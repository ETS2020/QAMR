// Benchmark "FAU" written by ABC on Fri Jul 31 16:17:42 2020
...
module FAU ( 
  ...
  assign z9 = x00 & ~x26 & (~new_n67_ | (new_n62_ & x29));
  assign new_n62_ = (x27 | x28) & ((~x31 & x33) | (x30 & new_n63_ & x31));
  assign new_n63_ = ~x33 & (new_n66_ | (x15 & (new_n65_ | (~new_n64_ & x16))));
  assign new_n64_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n65_ = x11 & ~x16 & x17 & x18 & x19;
  assign new_n66_ = x17 & x18 & x19 & x10 & ~x15 & x16;
  assign new_n67_ = (new_n75_ | ((x30 | ~new_n63_ | x31) & (~x31 | ~x33))) & (new_n68_ | ~x33);
