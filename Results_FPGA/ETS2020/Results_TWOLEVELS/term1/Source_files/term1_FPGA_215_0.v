// Benchmark "FAU" written by ABC on Fri Jul 31 16:20:18 2020
...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (~new_n69_ | (new_n65_ & x29));
  assign new_n65_ = (x27 | x28) & (x30 ? x32 : (x31 & ~new_n66_ & ~x32));
  ...
  assign new_n69_ = (new_n77_ | (x30 ? (~x31 | new_n66_ | x32) : ~x32)) & (new_n70_ | ~x32);
  ...
  assign new_n75_ = ~x14 & ~x19;
  assign new_n76_ = x31 & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n77_ = x29 & (x27 | x28);
  assign z9 = x00 & ~x26 & (new_n80_ | new_n81_ | (new_n79_ & x29));
  assign new_n79_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n66_ & ~x33));
  assign new_n80_ = ~new_n77_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n66_ & ~x33));
  assign new_n81_ = x33 & (new_n71_ | new_n72_ | ~new_n82_ | new_n73_);
  assign new_n82_ = ~new_n74_ & new_n83_ & (x30 | ~x31) & (~x30 | x31);
