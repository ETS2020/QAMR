// Benchmark "FAU" written by ABC on Fri Jul 31 16:15:13 2020
...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (new_n61_ | new_n63_ | (new_n57_ & x29));
  assign new_n57_ = (x27 | x28) & (x30 ? x32 : (x31 & ~new_n58_ & ~x32));
  ...
  assign new_n61_ = ~new_n62_ & (x30 ? (x31 & ~new_n58_ & ~x32) : x32);
