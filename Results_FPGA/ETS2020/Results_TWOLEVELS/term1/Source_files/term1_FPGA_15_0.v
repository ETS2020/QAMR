// Benchmark "FAU" written by ABC on Fri Jul 31 16:15:10 2020
...
module FAU ( 
  ...
  assign new_n58_ = ~new_n59_ & x01 & (~x02 | ~x03) & new_n61_ & x25;
  assign new_n59_ = (x19 | x24) & new_n60_ & (x18 | x23);
  assign new_n60_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n61_ = ~x26 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign z8 = x00 & ~x26 & (~new_n67_ | (new_n63_ & x29));
  assign new_n63_ = (x27 | x28) & (x30 ? x32 : (x31 & ~new_n64_ & ~x32));
  ...
  assign new_n67_ = (new_n75_ | (x30 ? (~x31 | new_n64_ | x32) : ~x32)) & (new_n68_ | ~x32);
  ...
  assign new_n73_ = ~x14 & ~x19;
  assign new_n74_ = x31 & (~x17 | ~x18 | ~x19 | ~x15 | ~x16);
  assign new_n75_ = x29 & (x27 | x28);
  assign z9 = x00 & ~x26 & (new_n78_ | new_n79_ | (new_n77_ & x29));
  assign new_n77_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n64_ & ~x33));
  assign new_n78_ = ~new_n75_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n64_ & ~x33));
  assign new_n79_ = x33 & (new_n69_ | new_n70_ | ~new_n80_ | new_n71_);
  assign new_n80_ = ~new_n72_ & new_n81_ & (x30 | ~x31) & (~x30 | x31);
