// Benchmark "FAU" written by ABC on Thu Jul 30 14:28:08 2020
...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n32_, new_n34_, new_n35_;
  assign z03 = new_n28_ & ~x13;
  assign new_n28_ = x05 & ~x04 & ~x03 & x00 & ~x01 & ~x02;
  ...
  assign new_n34_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n35_ | ~x13);
