// Benchmark "FAU" written by ABC on Thu Jul 30 19:33:53 2020
...
module FAU ( 
  ...
  wire new_n28_, new_n29_, new_n34_, new_n35_, new_n37_, new_n39_;
  ...
  assign z6 = ~x07 & ~x10 & (new_n34_ | new_n35_);
  assign new_n34_ = (~x00 | ~x08) & ((~x01 & (x02 | (~x03 & x09))) | (~x02 & x03 & ~x09));
