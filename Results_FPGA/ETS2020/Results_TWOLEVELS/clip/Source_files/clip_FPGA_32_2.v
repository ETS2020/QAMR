// Benchmark "FAU" written by ABC on Thu Jul 30 20:38:01 2020
...
module FAU ( 
  ...
  assign new_n30_ = (x3 | (x4 ? (x7 | ~x8) : ~x7)) & (x4 | ~x7 | (~x8 & (x6 | x8 | ~x3 | ~x5))) & (~x4 | x6 | x7);
  assign new_n31_ = x2 & x6 & ((~x4 & x7 & x8) | (~x3 & (x4 ? (~x7 & x8) : x7)));
  assign z2 = (x3 & (new_n33_ | ~new_n37_)) | (~new_n41_ & ~x3) | (new_n45_ & x0);
  assign new_n33_ = ~x5 & ((~new_n34_ & x6) | new_n36_ | (x0 & ~new_n35_ & ~x6));
  assign new_n34_ = (x0 | ~x8 | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7)))) & (~x7 | x8 | (x1 & ~x2));
  assign new_n35_ = ~x8 & (~x4 | ~x7) & (~x2 | (~x4 & ~x7));
  assign new_n36_ = ~x4 & ~x8 & (~x1 | (~x2 & x7) | (x2 & ~x7));
  assign new_n37_ = x8 ? new_n40_ : (~new_n39_ & (new_n38_ | ~x0));
  assign new_n38_ = (x1 | (x4 & (~x6 | ~x7))) & (x4 | ~x6 | ~x7) & (~x2 | ((~x6 | ~x7) & (x4 | ~x5 | x7)));
  assign new_n39_ = ~x6 & ((~x1 & (~x7 | (~x4 & x5 & x7))) | (~x4 & ~x7) | (~x2 & (~x7 | (~x4 & x5))));
  assign new_n40_ = (~x1 | ((~x0 | x2 | (x7 ? ~x4 : ~x6)) & (~x2 | x6 | (~x4 & ~x7)))) & (~x4 | ((x6 | ~x7) & (~x0 | ~x6 | x7)));
  ...
  assign z4 = new_n49_ | (x5 & (~new_n47_ | (~x4 & (new_n51_ | ~new_n52_))));
  assign new_n47_ = (x7 | ((x1 | (x8 & (~x2 | x3 | ~x8))) & (x2 | (x3 & x8)))) & new_n48_ & (x3 | x8);
  assign new_n48_ = x0 & ~x6;
  assign new_n49_ = ~x0 & x6 & ((x3 & ~x8) | (~x5 & ~new_n50_ & (x3 ^ ~x8)));
  assign new_n50_ = (~x4 | x7) & (~x1 | x2 | (~x4 & x7));
  assign new_n51_ = ~x1 & ((x2 & ~x3) | (x7 & ~x8 & x3 & ~x6));
  assign new_n52_ = (x2 | (x3 & (~x3 | x6 | x8))) & (x7 | (x3 & (~x3 | x8 | ~x0 | ~x2)));
  assign z3 = 1'b0;
endmodule
