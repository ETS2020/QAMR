...
module FAU ( 
  ...
  assign z1 = new_n23_ | ~new_n27_ | (x1 & ~new_n30_ & (~x4 ^ x7));
  assign new_n23_ = x0 & ((~new_n24_ & x6) | new_n25_ | (~x5 & ~new_n26_ & ~x6));
  assign new_n24_ = (~x1 | x2 | (x4 ^ x7)) & (~x2 | (~x4 ^ x7));
  assign new_n25_ = ~x1 & ((x4 & ~x7) | (~x4 & x5 & x7 & ~x8));
  assign new_n26_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x2 | (~x4 & ~x7))));
  assign new_n27_ = (new_n28_ | ((x1 | (x5 & x6)) & (x2 | x6) & (~x2 | x5 | ~x6))) & (new_n29_ | (x1 & (~x2 | ~x6)));
  assign new_n28_ = ~x4 ^ x7;
  assign new_n29_ = (x4 | ~x7 | ~x8) & (x3 | (x4 ? (x7 | ~x8) : ~x7));
  assign new_n30_ = x2 ? x6 : (~x6 | (x5 & (x3 | ~x8)));
  assign z4 = (x5 & (new_n32_ | new_n33_ | ~x0 | x6)) | (~x0 & ~new_n34_ & x6);
  assign new_n32_ = ~x3 & ((~x1 & x2 & (~x4 | (~x7 & x8))) | (~x2 & (~x4 | ~x7)) | ~x8 | (~x4 & ~x7));
  assign new_n33_ = ~x8 & ((~x1 & (~x7 | (x0 & ~x4 & x7))) | (~x4 & ~x7) | (~x2 & (~x4 | ~x7)));
