// Benchmark "FAU" written by ABC on Thu Jul 30 14:38:41 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n54_, new_n56_, new_n59_, new_n60_, new_n61_,
    new_n63_, new_n64_, new_n65_, new_n67_, new_n68_;
  ...
  assign new_n54_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = x19 & ~x18 & x17 & new_n56_ & ~x08;
  assign new_n56_ = ~x07 & ~x06 & ~x05 & x04 & z17 & ~x03;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n59_ | new_n61_);
  assign new_n59_ = new_n60_ & ~x11 & x12 & ~x01 & x02;
  ...
  assign z11 = ~x00 & ~x22 & (new_n67_ | new_n68_);
  assign new_n67_ = new_n64_ & ~x14 & x15 & ~x16 & x20 & ~x21;
