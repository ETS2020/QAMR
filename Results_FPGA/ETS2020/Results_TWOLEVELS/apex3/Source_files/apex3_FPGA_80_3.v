...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n386_, new_n388_, new_n389_, new_n390_, new_n392_, new_n396_,
    new_n398_, new_n402_, new_n405_;
  ...
  assign new_n388_ = new_n348_ & new_n150_ & ~x50 & x51;
  assign new_n389_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n390_ = x48 & ~x49 & ~x53 & (x50 ? (x51 ^ x52) : (~x51 & x52));
  assign z36 = x53 & new_n392_ & x52;
  assign new_n392_ = ~x51 & ~x50 & new_n341_ & x49;
  ...
  assign z41 = ~x50 & (new_n398_ | (new_n348_ & new_n188_ & x49 & ~x51));
  assign new_n398_ = x51 & x52 & x53 & ~x46 & x47 & ~x49;
  assign z42 = x53 & new_n384_ & x52;
  assign z43 = x53 & new_n384_ & ~x52;
  assign z44 = ~x46 & new_n402_ & ~x47;
  assign new_n402_ = x48 & ~x49 & ((x50 & x51 & ~x52) | (~x51 & x52 & (x50 | (~x50 & x53))));
