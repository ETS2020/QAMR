// Benchmark "FAU" written by ABC on Sun Aug  2 08:56:49 2020
...
module FAU ( 
  ...
  assign z49 = (~x48 & (new_n380_ | (new_n317_ & ~x46 & x47 & ~x49))) | (new_n317_ & x46 & ~x47 & x48 & ~x49);
  assign new_n380_ = ~new_n381_ & ~x50;
  assign new_n381_ = (x47 | ((~x46 | ~x49 | ~x52 | (~x51 ^ x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z16 = 1'b0;
