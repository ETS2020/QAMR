...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n338_, new_n339_, new_n343_, new_n344_, new_n346_, new_n348_,
    new_n350_, new_n352_, new_n353_, new_n354_, new_n356_, new_n360_,
    new_n362_, new_n363_, new_n367_, new_n370_, new_n372_, new_n374_,
    new_n375_, new_n376_;
  ...
  assign z22 = (~new_n337_ & ~x46) | (new_n336_ & ~x48 & x49 & x46 & ~x47);
  assign new_n336_ = new_n321_ & ~x52 & ~x53;
  assign new_n337_ = x47 ? (~x49 | x51 | ~new_n339_ | ~x52) : (new_n338_ | x52);
  assign new_n338_ = x48 ? (~x49 | x50 | ~x51 | ~x53) : (x53 | (x49 ? (x50 | x51) : (~x50 | ~x51)));
  ...
  assign new_n343_ = (x48 | ~x49 | (x51 ? x50 : (x50 ? (x52 ^ x53) : (~x52 | ~x53)))) & (~x51 | ~x52 | x53 | ~x48 | x49 | x50);
  ...
  assign new_n348_ = (~x46 | x48 | ~x50 | ~x51 | ~x52 | ~x53) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n350_ & ~x52;
  assign new_n350_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z35 = (~x46 & new_n354_ & ~x47) | (x49 & (new_n352_ | (new_n353_ & ~x46)));
  assign new_n352_ = x46 & ~x47 & ~x48 & new_n322_ & ~x50 & x51;
  ...
  assign new_n356_ = ~x51 & ~x50 & new_n318_ & x49;
  ...
  assign z48 = ~x53 & ~x52 & x51 & new_n372_ & ~x50;
  assign new_n372_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n374_ | (new_n376_ & ~x46 & x47 & ~x49))) | (new_n376_ & x48 & ~x49 & x46 & ~x47);
  assign new_n374_ = ~new_n375_ & ~x50;
  assign new_n375_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign new_n376_ = new_n321_ & new_n120_;
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
