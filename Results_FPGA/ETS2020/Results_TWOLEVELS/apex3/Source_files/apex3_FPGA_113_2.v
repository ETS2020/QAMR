...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n359_, new_n361_, new_n362_, new_n363_, new_n365_, new_n368_,
    new_n370_, new_n371_, new_n373_, new_n374_, new_n377_, new_n379_,
    new_n380_;
  ...
  assign z27 = x53 & new_n346_ & ~x52;
  assign new_n346_ = ~x51 & ~x50 & ~x49 & x48 & ~x46 & ~x47;
  assign z28 = ~x46 & ~new_n348_ & x47;
  assign new_n348_ = (~x49 | ((x50 | ((~x51 | ((x48 | x52 | ~x53) & (~x52 | (~x48 & (x48 | x53))))) & (x48 | x51 | x52 | x53))) & (x48 | ~x50 | ~x51 | ~x52 | x53))) & (~x51 | ~x52 | ~x53 | x48 | ~x50);
  assign z29 = new_n350_ & x53;
  assign new_n350_ = new_n351_ & ~x52;
  assign new_n351_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & ((~new_n354_ & ~x48) | (new_n353_ & x46 & x48 & ~x49));
  assign new_n353_ = new_n162_ & ~x50 & x51;
  assign new_n354_ = (new_n355_ | x51) & (~x46 | ~x49 | x50 | new_n356_ | ~x51);
  assign new_n355_ = (~x49 | (x46 ? ((~x52 | ~x53) & (~x50 | x52 | x53)) : (x50 | x52))) & (x46 | x49 | ~x50 | (x52 & (~x52 | x53)));
  assign new_n356_ = ~x52 & (x52 | (~x24 & x53 & (x24 | ~x53)));
  assign z33 = new_n350_ & ~x53;
  assign z34 = ~x46 & new_n359_ & x47;
  assign new_n359_ = x49 & ~x50 & ~x51 & ((~x48 & x52 & ~x53) | (~x52 & (x48 | x53)));
  assign z35 = (~new_n361_ & x49) | (~x46 & ~x47 & x48 & new_n363_ & ~x49);
  assign new_n361_ = (~new_n362_ | x46) & (~new_n353_ | ~x46 | x47 | x48);
  assign new_n362_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n363_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z37 = ~x53 & ~x52 & new_n365_ & ~x51;
  assign new_n365_ = ~x50 & x49 & x48 & ~x46 & ~x47;
  assign z38 = ~x53 & ~x52 & new_n365_ & x51;
  ...
  assign new_n370_ = ~x51 & ((x49 & x50 & ~x46 & x47) | (x46 & ~x47 & ~x49 & ~x50 & x53));
  assign new_n371_ = x50 & ((x49 & ~x53) | (x51 & (x53 | (~x49 & ~x53))));
  assign z41 = ~x50 & ((~x46 & new_n373_ & x47) | (new_n374_ & x46 & ~x47 & ~x48));
  assign new_n373_ = ~x49 & new_n110_ & x51;
  assign new_n374_ = ~x52 & ~x53 & x49 & ~x51;
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n323_ & x49;
  assign z47 = ~x46 & new_n377_ & ~x47;
  assign new_n377_ = x48 & ~x49 & ~x50 & x51 & ~x52 & ~x53;
  assign z49 = (~x48 & (new_n379_ | (new_n317_ & ~x46 & x47 & ~x49))) | (new_n317_ & x46 & ~x47 & x48 & ~x49);
  assign new_n379_ = ~new_n380_ & ~x50;
  assign new_n380_ = (x47 | ((~x46 | ~x49 | ~x52 | (~x51 ^ x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z16 = 1'b0;
