// Benchmark "FAU" written by ABC on Sun Aug  2 08:57:18 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n360_, new_n362_, new_n363_, new_n364_, new_n366_, new_n369_,
  ...
  assign z26 = ~x51 & ~new_n346_ & x52;
  assign new_n346_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & new_n348_ & ~x52;
  assign new_n348_ = ~x51 & ~x50 & ~x49 & x48 & ~x46 & ~x47;
  assign z28 = ~x46 & ~new_n350_ & x47;
  assign new_n350_ = (~x49 | ((x50 | ((~x51 | ((x48 | x52 | ~x53) & (~x52 | (~x48 & (x48 | x53))))) & (x48 | x51 | x52 | x53))) & (x48 | ~x50 | ~x51 | ~x52 | x53))) & (~x51 | ~x52 | ~x53 | x48 | ~x50);
  assign z29 = new_n352_ & x53;
  assign new_n352_ = new_n353_ & ~x52;
  assign new_n353_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n355_ | (~x48 & (new_n356_ | (new_n357_ & x46))));
  assign new_n355_ = new_n162_ & ~x50 & x51 & x46 & x48 & ~x49;
  assign new_n356_ = ~x51 & ((x49 & (x46 ? ((x52 & x53) | (x50 & ~x52 & ~x53)) : (~x50 & ~x52))) | (~x46 & ~x49 & x50 & (~x52 | (x52 & ~x53))));
  assign new_n357_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z33 = new_n352_ & ~x53;
  assign z34 = ~x46 & new_n360_ & x47;
  assign new_n360_ = x49 & ~x50 & ~x51 & ((~x48 & x52 & ~x53) | (~x52 & (x48 | x53)));
  assign z35 = (x49 & (new_n362_ | (new_n363_ & ~x46))) | (~x46 & new_n364_ & ~x47);
  assign new_n362_ = x46 & ~x47 & ~x48 & new_n162_ & ~x50 & x51;
  assign new_n363_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n364_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z37 = ~x53 & ~x52 & new_n366_ & ~x51;
  ...
  assign new_n371_ = ~x51 & ((x49 & x50 & ~x46 & x47) | (x46 & ~x47 & ~x49 & ~x50 & x53));
  assign new_n372_ = x50 & ((x49 & ~x53) | (x51 & (x53 | (~x49 & ~x53))));
  assign z41 = ~x50 & ((~x46 & new_n374_ & x47) | (new_n375_ & x46 & ~x47 & ~x48));
  assign new_n374_ = ~x49 & new_n110_ & x51;
  assign new_n375_ = ~x52 & ~x53 & x49 & ~x51;
