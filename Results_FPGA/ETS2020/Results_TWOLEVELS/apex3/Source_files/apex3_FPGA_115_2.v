// Benchmark "FAU" written by ABC on Sun Aug  2 08:52:58 2020
...
module FAU ( 
  ...
  assign z48 = ~x53 & ~x52 & x51 & new_n382_ & ~x50;
  assign new_n382_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n384_ | (new_n317_ & ~x46 & x47 & ~x49))) | (new_n317_ & x46 & ~x47 & x48 & ~x49);
  assign new_n384_ = ~new_n385_ & ~x50;
  assign new_n385_ = (x47 | ((~x46 | ~x49 | ~x52 | (~x51 ^ x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z16 = 1'b0;
