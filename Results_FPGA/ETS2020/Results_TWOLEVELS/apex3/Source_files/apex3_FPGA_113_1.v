...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n375_, new_n377_, new_n379_, new_n380_, new_n381_;
  ...
  assign new_n247_ = (new_n248_ | ~x51) & ~new_n259_ & (~x46 | (new_n256_ & (new_n253_ | x51)));
  ...
  assign new_n253_ = (new_n254_ | x49) & (x48 | ~x49 | x50 | (x52 & (~x52 | x53)));
  assign new_n254_ = (new_n255_ | ~x48) & (~new_n120_ | x50 | ~x14 | x48);
  assign new_n255_ = x50 ? (x04 ? (x52 | x53) : ~x52) : (x53 | (x52 ? x16 : ~x20));
  assign new_n256_ = (new_n257_ | x48) & (~new_n161_ | ~x48 | x49);
  assign new_n257_ = (~x52 | x53 | ~x36 | x50) & (~x49 | x52 | new_n258_ | ~x53);
  assign new_n258_ = x50 ? ~x06 : x24;
  assign new_n259_ = ~x48 & x50 & ~new_n260_ & ~x51;
  assign new_n260_ = (x52 | ~x53) & (~x49 | ~x52 | x53 | x10 | x11 | x25);
  assign z07 = new_n298_ | (~x46 & ((~new_n262_ & ~x53) | ~new_n291_ | (~new_n282_ & x53)));
  assign new_n262_ = new_n271_ & (x52 | (new_n263_ & (new_n281_ | ~x01)));
  ...
  assign new_n271_ = new_n280_ & (new_n274_ | ~x52) & (~x47 | (~new_n279_ & (new_n272_ | ~x52)));
  assign new_n272_ = ~new_n273_ & (~x05 | ~x48 | x51);
  assign new_n273_ = ~x49 & (x50 | (~x31 & ~x51) | (x27 & x48));
  assign new_n274_ = (~x48 | (x50 ? new_n276_ : new_n275_)) & ~new_n277_ & (new_n278_ | x48);
  assign new_n275_ = (x49 | (x51 & (x47 | ~x51))) & (x47 | ((~x20 | x51) & (x34 | ~x49 | ~x51)));
  assign new_n276_ = (~x03 | ~x51) & (~x49 | (~x51 & (~x29 | x47)));
  assign new_n277_ = ~x47 & ((~x48 & x51 & (~x49 ^ ~x50)) | (~x50 & ~x51 & ~x32 & ~x49));
  assign new_n278_ = (~x30 | ~x50) & (~x49 | x51 | (x14 & ~x50));
  assign new_n279_ = x49 & ((x52 & (x48 ? (~x50 ^ ~x51) : x50)) | (~x48 & ((~x50 & ~x51) | (~x11 & x50 & x51))));
  assign new_n280_ = (x47 | ~x50 | ((x07 | ~x48 | ~x49 | ~x51) & (x48 | x49 | x51))) & (x50 | ~x51 | x48 | x49);
  assign new_n281_ = (~x48 | ~x49 | x50) & (x49 | ~x50 | ~x51 | ~x26 | ~x47);
  ...
  assign new_n357_ = x46 & ~x47 & ~x48 & new_n323_ & ~x50 & x51;
  assign new_n358_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n359_ = x48 & ~x49 & ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z36 = x53 & new_n361_ & x52;
  assign new_n361_ = ~x51 & ~x50 & new_n319_ & x49;
  assign z37 = ~x53 & new_n361_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n319_ & x49;
  ...
  assign z49 = (~new_n379_ & ~x48) | (new_n322_ & new_n120_ & new_n338_ & x48 & ~x49);
  assign new_n379_ = (new_n381_ | x50) & (~new_n380_ | ~new_n120_ | ~x50 | x51);
