// Benchmark "FAU" written by ABC on Sun Aug  2 08:52:33 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n326_, new_n327_, new_n329_, new_n330_, new_n331_, new_n334_,
    new_n336_, new_n337_, new_n338_, new_n340_, new_n343_, new_n345_,
    new_n346_, new_n348_, new_n349_, new_n352_, new_n354_, new_n356_,
    new_n357_;
  ...
  assign z25 = ~x46 & new_n318_ & ~x47;
  assign new_n318_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n320_ & x52;
  assign new_n320_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & new_n322_ & ~x52;
  assign new_n322_ = ~x51 & ~x50 & ~x49 & x48 & ~x46 & ~x47;
  assign z28 = ~x46 & ~new_n324_ & x47;
  assign new_n324_ = (x48 | ((~x51 | ((~x49 | x50 | x52 | ~x53) & (~x52 | (x53 ? ~x50 : ~x49)))) & (~x49 | x50 | x51 | x52 | x53))) & (~x48 | ~x49 | x50 | ~x51 | ~x52);
  assign z29 = new_n326_ & x53;
  assign new_n326_ = new_n327_ & ~x52;
  assign new_n327_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n329_ | (~x48 & (new_n330_ | (new_n331_ & x46))));
  assign new_n329_ = new_n127_ & new_n136_ & x46 & x48 & ~x49;
  assign new_n330_ = ~x51 & ((x49 & (x46 ? ((x52 & x53) | (x50 & ~x52 & ~x53)) : (~x50 & ~x52))) | (~x46 & ~x49 & x50 & (~x52 | (x52 & ~x53))));
  assign new_n331_ = x49 & ~x50 & x51 & (x52 | (x24 & x53) | (~x52 & (~x53 | (~x24 & x53))));
  assign z33 = new_n326_ & ~x53;
  assign z34 = ~x46 & new_n334_ & x47;
  assign new_n334_ = x49 & ~x50 & ~x51 & ((~x52 & (x48 | x53)) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n336_ & x49) | (~x46 & ~x47 & x48 & new_n338_ & ~x49);
  assign new_n336_ = (~new_n337_ | x46) & (~new_n127_ | ~new_n136_ | ~x46 | x47 | x48);
  assign new_n337_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n338_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z37 = ~x53 & ~x52 & new_n340_ & ~x51;
  assign new_n340_ = ~x50 & x49 & x48 & ~x46 & ~x47;
  assign z38 = ~x53 & ~x52 & new_n340_ & x51;
  assign z39 = ~x46 & ~x47 & new_n343_ & x48;
  assign new_n343_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((new_n345_ & x48) | (~x46 & x47 & new_n346_ & ~x48));
  assign new_n345_ = ~x51 & ((~x46 & x47 & x49 & x50) | (x46 & ~x47 & ~x49 & ~x50 & x53));
  assign new_n346_ = x50 & ((x49 & ~x53) | (x51 & (x53 | (~x49 & ~x53))));
  assign z41 = ~x50 & ((~x46 & new_n348_ & x47) | (new_n349_ & x46 & ~x47 & ~x48));
  assign new_n348_ = ~x49 & new_n135_ & x51;
  assign new_n349_ = new_n129_ & x49 & ~x51;
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n296_ & x49;
  assign z47 = ~x46 & new_n352_ & ~x47;
  assign new_n352_ = x48 & ~x49 & ~x50 & new_n129_ & x51;
  assign z48 = ~x53 & ~x52 & x51 & new_n354_ & ~x50;
  assign new_n354_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n356_ | (new_n290_ & ~x46 & x47 & ~x49))) | (new_n290_ & x46 & ~x47 & x48 & ~x49);
