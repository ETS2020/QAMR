// Benchmark "FAU" written by ABC on Sun Aug  2 08:56:59 2020
...
module FAU ( 
  ...
  assign new_n344_ = (x48 | ~x49 | (x51 ? x50 : (x50 ? (x52 ^ x53) : (~x52 | ~x53)))) & (~x51 | ~x52 | x53 | ~x48 | x49 | x50);
  ...
  assign z35 = (~x46 & new_n355_ & ~x47) | (x49 & (new_n353_ | (new_n354_ & ~x46)));
  assign new_n353_ = x46 & ~x47 & ~x48 & new_n322_ & ~x50 & x51;
  ...
  assign new_n357_ = ~x51 & ~x50 & new_n318_ & x49;
  ...
  assign z40 = ~x52 & ((new_n363_ & x48) | (~x46 & x47 & new_n364_ & ~x48));
  assign new_n363_ = ~x51 & ((~x46 & x47 & x49 & x50) | (x46 & ~x47 & ~x49 & ~x50 & x53));
  assign new_n364_ = x50 & ((x49 & ~x53) | (x51 & (x53 | (~x49 & ~x53))));
  ...
  assign z49 = (~new_n375_ & ~x48) | (new_n321_ & new_n120_ & new_n337_ & x48 & ~x49);
  assign new_n375_ = (new_n377_ | x50) & (~new_n376_ | ~new_n120_ | ~x50 | x51);
  assign new_n376_ = ~x46 & x47 & ~x49;
  assign new_n377_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
