...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n338_, new_n340_, new_n343_, new_n346_, new_n347_, new_n349_,
    new_n350_, new_n353_, new_n357_, new_n359_, new_n360_;
  ...
  assign z14 = ~x53 & ~x52 & ~x51 & new_n303_ & x50;
  assign new_n303_ = x49 & x48 & ~x46 & ~x47;
  assign z15 = (~new_n305_ & ~x47) | (~x46 & (new_n308_ | (new_n309_ & x47)));
  assign new_n305_ = (new_n306_ | ~x50) & (~x48 | x49 | new_n307_ | x50);
  assign new_n306_ = (~x52 | ((~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (x51 | x53 | ~x46 | x49))) & (~x46 | ~x48 | x49 | x51 | x52);
  assign new_n307_ = x51 ? (~x52 | ~x53) : (x52 | (x46 ^ x53));
  assign new_n308_ = new_n145_ & x51 & x48 & ~x49 & x50;
  assign new_n309_ = ~x50 & ((x51 & ~x52 & x48 & ~x49) | (x52 & ~x53 & x49 & ~x51));
  assign z16 = (~new_n311_ & ~x48) | (new_n136_ & new_n145_ & new_n167_ & x48 & x49);
  assign new_n311_ = (~new_n312_ | x49) & (x46 | ~x47 | ~new_n313_ | ~x49);
  assign new_n312_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x46 & ~x50 & ~x51 & x53))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n313_ = x50 & ~x52 & (~x53 | (x51 & (x43 | (~x43 & x53))));
  assign z17 = ~x47 & new_n315_ & ~x49;
  assign new_n315_ = x52 & ((~x53 & ((~x46 & ~x48 & x50 & x51) | (x46 & x48 & ~x50 & ~x51))) | (~x46 & ~x48 & ~x50 & x51 & x53));
  assign z19 = x46 ? new_n318_ : (new_n317_ | (~new_n320_ & ~x49));
  assign new_n317_ = new_n137_ & ~x50 & ~x51 & ~x47 & ~x48 & x49;
  assign new_n318_ = ~x47 & ~x48 & x49 & ~new_n319_ & ~x53;
  assign new_n319_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n320_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n322_ & ~x47;
  assign new_n322_ = x48 & x49 & ~x50 & x51 & (x52 ^ x53);
  assign z21 = x51 & ((new_n324_ & x46 & ~x47 & ~x48) | (new_n325_ & ~x46 & x47 & x48));
  assign new_n324_ = new_n137_ & ~x49 & ~x50;
  assign new_n325_ = new_n145_ & x49 & x50;
  assign z24 = ~x48 & new_n327_ & x49;
  assign new_n327_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (x50 & ~x51 & ~x46 & x47));
  assign z25 = ~x46 & new_n329_ & ~x47;
  assign new_n329_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n331_ & x52;
  assign new_n331_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z28 = ~x46 & ~new_n333_ & x47;
  assign new_n333_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x48 | x50 | x52 | ~x53))) & (x48 | x50 | x51 | x52 | x53))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n335_ & ~x52;
  assign new_n335_ = x51 & x50 & x49 & new_n167_ & x48;
  assign z31 = new_n337_ & ~x53;
  assign new_n337_ = new_n338_ & x52;
  ...
  assign z36 = x53 & x52 & ~x51 & new_n303_ & ~x50;
