// Benchmark "FAU" written by ABC on Sun Aug  2 09:00:10 2020
...
module FAU ( 
  ...
  assign z49 = (~new_n374_ & ~x48) | (new_n321_ & new_n120_ & new_n337_ & x48 & ~x49);
  assign new_n374_ = (new_n376_ | x50) & (~new_n375_ | ~new_n120_ | ~x50 | x51);
  assign new_n375_ = ~x46 & x47 & ~x49;
  assign new_n376_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
