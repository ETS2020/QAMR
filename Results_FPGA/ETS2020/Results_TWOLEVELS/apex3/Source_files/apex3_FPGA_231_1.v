// Benchmark "FAU" written by ABC on Sun Aug  2 08:59:56 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n339_, new_n340_, new_n341_, new_n344_, new_n347_, new_n348_,
    new_n350_, new_n352_, new_n354_, new_n356_, new_n357_, new_n358_,
    new_n360_, new_n364_, new_n366_, new_n367_, new_n371_, new_n374_,
    new_n376_, new_n378_, new_n379_, new_n380_;
  ...
  assign z13 = x53 & new_n318_ & x52;
  assign new_n318_ = ~x51 & ~x50 & ~x49 & ~x48 & ~x46 & ~x47;
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n320_ & x49;
  assign new_n320_ = x48 & ~x46 & ~x47;
  assign z16 = new_n322_ | (~x48 & ((new_n325_ & ~x49) | (new_n326_ & ~x46)));
  assign new_n322_ = new_n323_ & new_n324_ & ~x46 & x47 & x48 & x49;
  assign new_n323_ = x50 & ~x51;
  assign new_n324_ = x52 & ~x53;
  assign new_n325_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x46 & ~x50 & ~x51 & x53))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n326_ = x47 & x49 & x50 & ~x52 & (x51 | ~x53);
  ...
  assign new_n330_ = (x49 | ~x51 | ((~x48 | x53 | (x50 ^ ~x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n331_ = x50 & ~x53 & ((~x48 & (~x51 ^ ~x52)) | (x23 & x48 & ~x51 & ~x52));
  assign z20 = ~x46 & new_n333_ & ~x47;
  assign new_n333_ = x48 & x49 & ~x50 & x51 & (x52 ^ x53);
  assign z21 = x51 & ((new_n335_ & x46 & ~x47 & ~x48) | (new_n336_ & ~x46 & x47 & x48));
  assign new_n335_ = new_n143_ & ~x49 & ~x50;
  assign new_n336_ = new_n324_ & x49 & x50;
  assign z22 = new_n338_ | (~x46 & (x47 ? new_n341_ : new_n340_));
  assign new_n338_ = new_n323_ & ~x52 & ~x53 & new_n339_ & ~x48 & x49;
  assign new_n339_ = x46 & ~x47;
  assign new_n340_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n341_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n324_ & x51;
  ...
  assign z30 = ~x47 & (x46 ? ~new_n347_ : new_n348_);
  assign new_n347_ = (x48 | ~x49 | (x51 ? x50 : (x50 ? (x52 ^ x53) : (~x52 | ~x53)))) & (~x51 | ~x52 | x53 | ~x48 | x49 | x50);
  assign new_n348_ = ~x48 & ~x51 & (x49 ? (~x50 & ~x52) : (x50 & (~x52 | ~x53)));
  assign z31 = ~x53 & new_n350_ & x52;
  assign new_n350_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z32 = ~x47 & ~new_n352_ & x49;
  assign new_n352_ = (~x46 | x48 | ~x50 | ~x51 | ~x52 | ~x53) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n354_ & ~x52;
  assign new_n354_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z35 = (~x46 & new_n358_ & ~x47) | (x49 & (new_n356_ | (new_n357_ & ~x46)));
  assign new_n356_ = x46 & ~x47 & ~x48 & new_n324_ & ~x50 & x51;
  assign new_n357_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n358_ = x48 & ~x49 & ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z36 = x53 & new_n360_ & x52;
  assign new_n360_ = ~x51 & ~x50 & new_n320_ & x49;
  ...
  assign new_n367_ = x50 & ((x49 & ~x53) | (x51 & (x53 | (~x49 & ~x53))));
  assign z42 = x53 & new_n350_ & x52;
  assign z43 = x53 & new_n350_ & ~x52;
  assign z44 = ~x46 & new_n371_ & ~x47;
  assign new_n371_ = x48 & ~x49 & ((~x51 & x52 & x53) | (x50 & (~x51 ^ ~x52)));
  ...
  assign z49 = (~new_n378_ & ~x48) | (new_n323_ & new_n120_ & new_n339_ & x48 & ~x49);
  assign new_n378_ = (new_n380_ | x50) & (~new_n379_ | ~new_n120_ | ~x50 | x51);
  assign new_n379_ = ~x46 & x47 & ~x49;
  assign new_n380_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
