...
module FAU ( 
  ...
  assign new_n175_ = (x48 | (~new_n176_ & (~new_n178_ | ~x49))) & (~new_n177_ | x37 | ~x48 | x49);
  assign new_n176_ = x41 & ~x50 & new_n127_ & ~x51;
  assign new_n177_ = new_n121_ & ~x50 & ~x51;
  assign new_n178_ = x51 & (x50 ? ((~x03 & x52 & x53) | (~x35 & ~x52 & ~x53)) : (~x52 | x53));
  assign new_n179_ = new_n180_ & (x48 | ~x49 | x50 | ~x53) & (x49 | ~x50 | x53 | ~x04 | ~x48);
  ...
  assign z04 = (~x46 & (new_n192_ | ~new_n205_)) | (~x47 & (new_n214_ | new_n222_));
  assign new_n192_ = x50 & (~new_n193_ | (x47 & (new_n202_ | new_n203_ | ~new_n204_)));
  ...
  assign new_n203_ = x52 & ((~x48 & ~x53) | (x48 & ~x51 & x53) | (~x48 & x53 & (x49 ^ ~x51)) | (x48 & (x49 ? (x51 | ~x53) : (x51 & (~x45 | ~x53)))));
  assign new_n204_ = (x52 | ((x53 | (x48 ? (~x49 | ~x51) : (~x49 & (x49 | ~x51)))) & (~x48 | (x51 & (x43 | ~x51 | ~x53))) & (x48 | x49 | ~x53))) & (~x43 | ~x49 | ~x51);
  ...
  assign new_n214_ = x51 & (x50 ? (~new_n215_ | (~new_n221_ & x52)) : ~new_n218_);
  assign new_n215_ = (new_n216_ | ~x46) & (~new_n121_ | ~x49 | x35 | x48);
  assign new_n216_ = (x49 | ((~x48 | (~x53 & (x52 | x53))) & (~new_n217_ | x28 | x52 | ~x53))) & (x48 | x52 | (new_n217_ & ~x28 & ~x49 & x53));
  assign new_n217_ = ~x22 & ~x25;
  assign new_n218_ = (new_n219_ | x48) & (~new_n220_ | ~x46);
  assign new_n219_ = (~x46 | (x49 ? (x52 ? ~x53 : (~x24 & x53)) : (~x52 & (x52 | x53)))) & (~x16 | ~x52 | ~x53);
  assign new_n220_ = ~x49 & ~x52 & ~x53 & (x37 | (~x38 & ~x43));
  assign new_n221_ = (x03 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49))) & (~x46 | x48 | x53 | (~x21 & ~x49));
  assign new_n222_ = ~x51 & (new_n223_ | (x46 & (~new_n225_ | (~new_n224_ & ~x52))));
  assign new_n223_ = new_n121_ & ~x50 & ~x37 & x48 & ~x49;
  ...
  assign new_n235_ = x52 ? ((~x48 | ~x50) & (x46 | x48 | (x50 & (~x16 | ~x50)))) : (x46 ? (x48 ? new_n154_ : x50) : x48);
  ...
  assign new_n298_ = ~new_n221_ & x50;
  ...
  assign new_n332_ = new_n112_ & ~x47 & new_n127_ & ~x50 & ~x51;
  ...
  assign z22 = (~x46 & (x47 ? new_n341_ : new_n340_)) | (new_n339_ & new_n112_ & x46 & ~x47);
  assign new_n339_ = new_n121_ & x50 & ~x51;
  ...
  assign new_n375_ = new_n121_ & x49 & ~x51;
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n323_ & x49;
  assign z47 = ~x46 & new_n378_ & ~x47;
  assign new_n378_ = x48 & ~x49 & ~x50 & new_n121_ & x51;
