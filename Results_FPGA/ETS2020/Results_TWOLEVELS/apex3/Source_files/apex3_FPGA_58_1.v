...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n311_, new_n312_, new_n313_, new_n315_, new_n317_, new_n319_,
    ...
    new_n374_, new_n376_, new_n377_, new_n378_;
  ...
  assign new_n155_ = (~x01 | (~x49 & (~x47 | x51))) & (x43 | ~x49) & (x47 | (~x49 & (x40 | x49 | ~x51)));
  ...
  assign z07 = new_n298_ | (~x46 & ((~new_n261_ & ~x53) | ~new_n291_ | (~new_n282_ & x53)));
  assign new_n261_ = (new_n262_ | x52) & (new_n273_ | ~x47) & new_n281_ & (new_n276_ | ~x52);
  assign new_n262_ = ~new_n263_ & new_n267_ & (x48 | (x47 ? new_n265_ : new_n272_));
  assign new_n263_ = ~new_n264_ & x01;
  assign new_n264_ = (~x48 | ~x49 | x50) & (x49 | ~x50 | ~x51 | ~x26 | ~x47);
  assign new_n265_ = (new_n266_ | x50) & (~x49 | (x51 & (~x11 | ~x50))) & (~x50 | ((~x28 | x51) & (x49 | (x28 & ~x51))));
  assign new_n266_ = (x09 | x49 | x51) & (x20 | ~x49 | ~x51);
  assign new_n267_ = new_n271_ & (~x48 | ((new_n268_ | ~x50) & ~new_n269_ & (new_n270_ | x50)));
  assign new_n268_ = (~x08 | x51) & (~x47 | (x51 & (x49 | ~x51 | (x01 & x26))));
  assign new_n269_ = ~x51 & (x49 | (x37 & ~x47 & ~x50));
  assign new_n270_ = (x43 | ~x49) & (x47 | (~x49 & (~x40 | x49 | ~x51)));
  assign new_n271_ = (x49 | ~x51 | ~x05 | ~x47) & (~x50 | x51 | ~x18 | ~x49);
  assign new_n272_ = (x25 | (x49 ? (x50 | x51) : (~x50 | ~x51))) & (~x50 | ~x51 | ~x35 | ~x49);
  assign new_n273_ = ~new_n274_ & (~x52 | (~new_n275_ & (~x05 | ~x48 | x51)));
  assign new_n274_ = x49 & ((x52 & (x48 ? (~x50 ^ ~x51) : x50)) | (~x48 & ((~x50 & ~x51) | (~x11 & x50 & x51))));
  ...
  assign new_n281_ = (x47 | ~x50 | ((x07 | ~x48 | ~x49 | ~x51) & (x48 | x49 | x51))) & (x50 | ~x51 | x48 | x49);
  assign new_n282_ = (x47 | (new_n283_ & (new_n289_ | x48))) & ~new_n286_ & (~x47 | ~new_n290_ | ~x48);
  assign new_n283_ = ~new_n284_ & (x50 | ~x51 | ~x52 | ~x17 | ~x49);
  assign new_n284_ = x48 & ((new_n285_ & x49) | (~x50 & x51 & ~x03 & ~x49));
  assign new_n285_ = ~x52 & ((x19 & ~x50 & x51) | (x50 & (x51 ? x41 : x29)));
  assign new_n286_ = ~new_n287_ & x52;
  assign new_n287_ = ~new_n288_ & (x49 | x50 | x51 | ~x13 | x48);
  assign new_n288_ = x47 & x50 & x51 & (x48 ? (x49 | (x45 & ~x49)) : x49);
  assign new_n289_ = (x14 | ((x49 | ~x50 | ~x51) & (x51 | x52 | ~x49 | x50))) & (x50 | ((~x52 | (x16 & x51)) & (~x49 | ~x51)));
  assign new_n290_ = ~x49 & ~x51 & ~x52 & (x50 ? x43 : (x38 | ~x43));
  assign new_n291_ = (new_n292_ | ~x47) & (~new_n297_ | ~x42 | x47 | ~x48);
  assign new_n292_ = (new_n295_ | ~x50) & (new_n293_ | x51);
  assign new_n293_ = (x49 | new_n294_ | x52) & (~x49 | x50 | ~x52 | ~x38 | x48);
  assign new_n294_ = x48 ? (x50 ? x26 : x01) : (~x50 | (x00 & x23));
  assign new_n295_ = x48 ? (new_n296_ | ~x52) : (~x51 | (x43 ? (x49 | x52) : ~x49));
  assign new_n296_ = (~x02 | ~x49) & (x45 | x49 | ~x51);
  assign new_n297_ = x51 & x52 & x49 & x50;
  assign new_n298_ = ~x47 & (~new_n303_ | (x46 & (new_n299_ | (~new_n308_ & ~x48))));
  assign new_n299_ = ~x49 & (x48 ? ~new_n301_ : (~new_n302_ | (~new_n300_ & x50)));
  assign new_n300_ = (x53 | (x21 & (~x21 | ~x51 | ~x52))) & ~new_n174_ & (~x52 | (~x27 & (x51 | ~x53)));
  assign new_n301_ = (~x04 | ((x50 | ~x52 | ~x53) & (x52 | x53 | ~x50 | x51))) & (x51 | ((~x53 | (x52 & (x50 | ~x52))) & (x50 | ~x52 | x53))) & (~x51 | ~x52 | ((x50 | (x04 & x53)) & (~x03 | ~x50 | x53)));
  assign new_n302_ = (x51 | x53) & (x50 | ~x53 | (x51 ? (x52 & (~x39 | ~x52)) : (x52 & (~x14 | ~x52))));
  assign new_n303_ = x52 ? new_n304_ : ((new_n306_ | x49) & (x48 | new_n307_ | ~x49));
  assign new_n304_ = (~x26 | ~x48 | x49 | x50 | x51) & (x48 | ~x49 | new_n305_ | ~x50);
  assign new_n305_ = (x03 | ~x51 | ~x53) & (x10 | x11 | x25 | x51 | x53);
  assign new_n306_ = (~x48 | x50 | ~x53 | (x29 & ~x51)) & (x33 | x48 | x51 | x53);
  assign new_n307_ = (~x50 | ((x35 | ~x51 | x53) & (~x37 | x51 | ~x53))) & (~x51 | x53 | x41 | x50);
  assign new_n308_ = ~new_n309_ & (~x50 | x52 | (x51 ? x53 : ~x41));
  assign new_n309_ = x49 & ((x50 & ~x51 & ~x52) | (~x53 & ((~x50 & (~x51 ^ x52)) | (x51 & (~x20 | ~x52)))));
  assign z08 = (~x46 & new_n313_ & x47) | (~x47 & ((~new_n311_ & x50) | (new_n312_ & ~x46)));
  assign new_n311_ = (x52 | ((x48 | ((~x46 | ((~x51 | x53) & (x49 | x51 | ~x53))) & (x46 | ~x49 | x51 | ~x53))) & (x46 | ~x48 | x49 | ~x51 | x53))) & (x51 | ~x52 | ~x53 | x46 | ~x48 | x49);
  assign new_n312_ = ~x49 & ~x50 & ((~x52 & x53 & x48 & x51) | (x52 & ~x53 & ~x48 & ~x51));
  assign new_n313_ = ~x48 & x52 & ~x53 & (x49 ? (x50 & ~x51) : (~x50 & x51));
  assign z09 = ~x46 & new_n315_ & ~x51;
  assign new_n315_ = x53 & ((x47 & x48 & x49 & x50 & x52) | (~x47 & ~x48 & ~x49 & ~x50 & ~x52));
  assign z12 = ~x46 & ~new_n317_ & x47;
  assign new_n317_ = x48 ? (~x53 | ((~x49 | ((x51 | x52) & (x50 | ~x51 | ~x52))) & (x49 | x50 | x51 | ~x52))) : ((~x51 | ((~x50 | x52 | ~x53) & (~x49 | ~x52 | (~x50 ^ ~x53)))) & (~x49 | x51 | x53 | (x50 & x52)));
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n319_ & x49;
  assign new_n319_ = x48 & ~x46 & ~x47;
  assign z16 = new_n321_ | (~x48 & ((new_n324_ & ~x49) | (new_n325_ & ~x46)));
  assign new_n321_ = new_n322_ & new_n323_ & ~x46 & x47 & x48 & x49;
  ...
  assign new_n334_ = new_n143_ & ~x49 & ~x50;
  assign new_n335_ = new_n323_ & x49 & x50;
  assign z22 = new_n337_ | (~x46 & (x47 ? new_n340_ : new_n339_));
  assign new_n337_ = new_n322_ & ~x52 & ~x53 & new_n338_ & ~x48 & x49;
  ...
  assign new_n355_ = x46 & ~x47 & ~x48 & new_n323_ & ~x50 & x51;
  ...
  assign new_n359_ = ~x51 & ~x50 & new_n319_ & x49;
  ...
  assign z49 = (~new_n376_ & ~x48) | (new_n322_ & new_n120_ & new_n338_ & x48 & ~x49);
