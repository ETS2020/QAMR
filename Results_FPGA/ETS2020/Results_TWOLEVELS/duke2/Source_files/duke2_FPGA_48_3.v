...
module FAU ( 
  ...
  assign new_n90_ = (x09 | (x07 ? (~x08 | (~x05 ^ x15)) : (x08 | (~x05 ^ x15)))) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z09 = (~x17 & (new_n104_ | (~new_n92_ & x18))) | (new_n105_ & ~x15 & x17 & ~x18);
  assign new_n92_ = ~new_n103_ & (x07 | (~new_n100_ & ((~new_n93_ & ~new_n102_) | x15)));
  ...
  assign new_n103_ = x05 & x08 & ~x15 & (x07 | ~x12);
  assign new_n104_ = new_n106_ & new_n105_ & x04 & ~x05;
  assign new_n105_ = ~x07 & ~x09;
  assign new_n106_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign z10 = (~x09 & (x07 ? ~new_n109_ : ~new_n108_)) | (x08 & new_n110_ & x09);
  assign new_n108_ = (~x05 | ((~x17 | x18) & (x06 | x08 | x15 | x17 | ~x18))) & (x15 | ~x17 | x18) & (x05 | ~x15 | ((~x17 | x18) & (x06 | x08 | x17 | ~x18)));
  assign new_n109_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n110_ = ~x15 & ~x17 & x18 & (x05 ^ ~x07);
  ...
  assign new_n114_ = ~new_n116_ & (x15 | (x08 ? (~new_n82_ | x14) : new_n115_));
  ...
  assign new_n143_ = ~x21 & (x04 ? (new_n144_ & ~x12) : ~new_n117_);
  ...
  assign new_n154_ = (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign new_n168_ = ~x21 & (new_n169_ | (~new_n117_ & ~x04));
  ...
  assign new_n177_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
