...
module FAU ( 
  ...
  assign z20 = ~x07 & ~x17 & (new_n148_ | (~x09 & (new_n142_ | new_n147_)));
  assign new_n142_ = x18 & (new_n143_ | (~x05 & new_n146_ & ~x06));
  ...
  assign new_n147_ = new_n108_ & x04 & ~x05 & x12;
  ...
  assign new_n160_ = ~x21 & (new_n161_ | (~new_n121_ & ~x04));
  ...
  assign new_n169_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n92_ & x21));
