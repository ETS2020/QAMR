...
module FAU ( 
  ...
  assign z09 = (~x17 & (new_n105_ | (~new_n93_ & x18))) | (new_n106_ & ~x15 & x17 & ~x18);
  assign new_n93_ = ~new_n104_ & (x07 | (~new_n101_ & ((~new_n94_ & ~new_n103_) | x15)));
  ...
  assign new_n104_ = x05 & x08 & ~x15 & (x07 | ~x12);
  assign new_n105_ = new_n107_ & new_n106_ & x04 & ~x05;
  assign new_n106_ = ~x07 & ~x09;
  assign new_n107_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign z10 = (~x09 & (x07 ? ~new_n110_ : ~new_n109_)) | (x08 & new_n111_ & x09);
  assign new_n109_ = (~x05 | ((~x17 | x18) & (x06 | x08 | x15 | x17 | ~x18))) & (x15 | ~x17 | x18) & (x05 | ~x15 | ((~x17 | x18) & (x06 | x08 | x17 | ~x18)));
  ...
  assign new_n149_ = ~x21 & (x04 ? (new_n150_ & ~x12) : ~new_n118_);
  ...
  assign z28 = (~x17 & (new_n185_ | (~new_n179_ & x18))) | (~x09 & x17 & ~new_n187_ & ~x18);
  assign new_n179_ = (~x08 | ((new_n180_ | x05) & (new_n184_ | x07))) & (x05 | x07 | ~new_n183_ | x08);
  assign new_n180_ = ~new_n181_ & (x07 | x09 | ~x10 | ~new_n182_ | ~x12);
  assign new_n181_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n182_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n183_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
  ...
  assign new_n187_ = x05 ? x07 : (~x15 | (x07 & x19));
  assign z02 = 1'b0;
  assign z08 = 1'b0;
  assign z11 = 1'b0;
  assign z19 = 1'b0;
