...
module FAU ( 
  ...
  assign new_n126_ = (~x06 | (~new_n127_ & (~x12 | new_n128_ | x16))) & ~new_n89_ & (x06 | ~x12 | new_n128_ | ~x16);
  assign new_n127_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n128_ = x13 & (x02 | ~x11);
  assign new_n129_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n133_ | (~x05 & (new_n95_ | (~new_n131_ & ~x07))));
  assign new_n131_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n132_ | ~x18);
  assign new_n132_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n133_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n135_ & x18;
  assign new_n135_ = (x14 | x15 | (~new_n136_ & ~new_n79_)) & (x08 | ~x15 | ~x19);
  assign new_n136_ = x12 & ((~new_n137_ & ~x06) | (new_n138_ & x06 & x08 & x10));
  assign new_n137_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  assign new_n138_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n141_ | new_n147_);
  assign new_n141_ = ~x09 & (new_n142_ | (new_n109_ & x04 & ~x05 & x12));
  assign new_n142_ = x18 & (new_n145_ | (~x21 & (x04 ? new_n143_ : ~new_n120_)));
  assign new_n143_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n144_ : ~x06));
  assign new_n144_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n145_ = ~x05 & new_n146_ & ~x06;
  ...
  assign new_n150_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
