...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n106_, new_n107_, new_n110_, new_n112_;
  ...
  assign z08 = x14 & ~x20;
  assign z09 = (new_n90_ & x05) | (~x07 & (new_n89_ | (~new_n80_ & ~x17)));
  assign new_n80_ = ~new_n87_ & (~x18 | (x08 ? (~new_n81_ & ~new_n82_) : ~new_n85_));
  assign new_n81_ = ~new_n59_ & (new_n72_ | (~x11 & x15 & x02 & ~x05));
  assign new_n82_ = ~x09 & (new_n84_ | (x02 & x13 & new_n83_ & ~x14));
  assign new_n83_ = ~x15 & ~x21 & (x12 ? ~x05 : (x04 | ~x10));
  assign new_n84_ = x05 & x21;
  assign new_n85_ = ~x09 & ~x15 & (x05 ? ~x19 : new_n86_);
  assign new_n86_ = ~x21 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  assign new_n87_ = new_n88_ & ~x09 & x12 & x04 & ~x05;
  assign new_n88_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n89_ = ~x09 & ~x15 & x17 & ~x18;
  assign new_n90_ = x08 & ~x15 & ~x17 & x18 & (~x04 | x07);
  ...
  assign z14 = (new_n100_ & ~x05) | (~x17 & (new_n98_ | (new_n97_ & x08)));
