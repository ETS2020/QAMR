...
module FAU ( 
  ...
  assign z08 = x14 & ~x20;
  assign z09 = (~x17 & (new_n110_ | (~new_n98_ & x18))) | (new_n111_ & ~x15 & x17 & ~x18);
  assign new_n98_ = ~new_n109_ & (x07 | (~new_n106_ & ((~new_n99_ & ~new_n108_) | x15)));
  ...
  assign new_n109_ = x05 & x08 & ~x15 & (x07 | ~x12);
  assign new_n110_ = new_n112_ & new_n111_ & x04 & ~x05;
