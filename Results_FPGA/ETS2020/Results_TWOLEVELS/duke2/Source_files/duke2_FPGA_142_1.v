// Benchmark "FAU" written by ABC on Thu Jul 30 16:55:23 2020
...
module FAU ( 
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n112_ | (~x07 & ((new_n114_ & ~x09) | (~new_n99_ & ~x17)));
  assign new_n99_ = ~new_n109_ & (~x18 | (~new_n107_ & (x15 | (~new_n100_ & ~new_n111_))));
  ...
  assign new_n103_ = ~x05 & ((~new_n104_ & x06) | (new_n105_ & x02));
  ...
  assign new_n136_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign z20 = ~x07 & ~x17 & (new_n144_ | new_n150_);
  assign new_n144_ = ~x09 & (new_n145_ | (new_n110_ & x04 & ~x05 & x12));
  assign new_n145_ = x18 & (new_n148_ | (~x21 & (x04 ? new_n146_ : ~new_n123_)));
  assign new_n146_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n147_ : ~x06));
  assign new_n147_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n148_ = ~x05 & new_n149_ & ~x06;
  assign new_n149_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n150_ = new_n151_ & x04 & x05 & x08;
  assign new_n151_ = ~x15 & x18 & x09 & ~x12;
  assign z21 = ~x17 & ~new_n153_ & x18;
  assign new_n153_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n155_ & x18;
  assign new_n155_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign new_n168_ = ~x21 & (new_n169_ | (~new_n123_ & ~x04));
  assign new_n169_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n170_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n171_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n179_ | (~new_n173_ & x18))) | (~x09 & x17 & ~new_n181_ & ~x18);
  assign new_n173_ = (~x08 | ((new_n174_ | x05) & (new_n178_ | x07))) & (x05 | x07 | ~new_n177_ | x08);
  assign new_n174_ = ~new_n175_ & (x07 | x09 | ~x10 | ~new_n176_ | ~x12);
  assign new_n175_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n176_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n177_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
  ...
  assign new_n181_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
