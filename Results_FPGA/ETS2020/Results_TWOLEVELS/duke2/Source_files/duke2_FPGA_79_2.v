// Benchmark "FAU" written by ABC on Thu Jul 30 16:55:02 2020
...
module FAU ( 
  ...
  assign new_n99_ = ~new_n101_ & (x15 | (x08 ? (~new_n82_ | x14) : new_n100_));
  ...
  assign z24 = ~x09 & ~x17 & (new_n139_ | new_n143_);
  assign new_n139_ = ~x07 & (new_n140_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n140_ = ~x21 & ((x04 & ~new_n141_ & ~x15) | (x08 & new_n142_ & x15));
  assign new_n141_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  assign new_n142_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n143_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n145_ & ~x05;
  assign new_n145_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z27 = new_n147_ | (new_n152_ & new_n69_ & x03 & ~x05);
  assign new_n147_ = ~x09 & ((~x17 & ~new_n148_ & x18) | (~x05 & x17 & ~new_n151_ & ~x18));
  assign new_n148_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n149_ & (~x05 | x08 | x15 | ~x19));
  assign new_n149_ = ~x21 & (new_n150_ | (~new_n102_ & ~x04));
  assign new_n150_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n151_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n152_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n160_ | (~new_n154_ & x18))) | (~x09 & x17 & ~new_n162_ & ~x18);
  assign new_n154_ = (~x08 | ((new_n155_ | x05) & (new_n159_ | x07))) & (x05 | x07 | ~new_n158_ | x08);
  assign new_n155_ = ~new_n156_ & (x07 | x09 | ~x10 | ~new_n157_ | ~x12);
  assign new_n156_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n157_ = ~x14 & ~x15 & ~x21 & (x02 | x11 | ~x13);
  assign new_n158_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
  assign new_n159_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n160_ = new_n161_ & ~x05;
  assign new_n161_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n162_ = x05 ? x07 : (~x15 | (x07 & x19));
  assign z01 = 1'b0;
  assign z09 = 1'b0;
  assign z11 = 1'b0;
  assign z18 = 1'b0;
