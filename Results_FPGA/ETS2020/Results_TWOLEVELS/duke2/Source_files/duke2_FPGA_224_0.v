...
module FAU ( 
  ...
  assign z14 = (new_n98_ & ~x05) | (~x17 & (new_n87_ | (new_n97_ & x08)));
  assign new_n97_ = x18 & (x07 ? (~x19 & (~x05 ^ ~x15)) : new_n71_);
  assign new_n98_ = ~x09 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z18 = ~x05 & ~x07 & ~x09 & new_n100_ & ~x17;
  assign new_n100_ = x18 & ((~x14 & ~new_n101_ & ~x15) | (~x08 & x15 & x19));
  assign new_n101_ = (new_n102_ | ~x02) & (~x12 | (~new_n104_ & (new_n103_ | x06)));
  assign new_n102_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n103_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n104_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z22 = ~x17 & ~new_n107_ & x18;
  assign new_n107_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | ~x15);
