...
module FAU ( 
  ...
  assign z17 = ~x09 & (new_n147_ | (~x05 & (new_n97_ | (~new_n145_ & ~x07))));
  ...
  assign new_n149_ = (x14 | x15 | (~new_n150_ & ~new_n81_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n194_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
