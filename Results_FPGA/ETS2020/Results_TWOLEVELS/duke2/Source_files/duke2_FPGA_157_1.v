...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n80_ & ~x05) | (new_n90_ & new_n66_ & x04 & x05));
  assign new_n80_ = (x07 | ((x17 | new_n81_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n81_ = ~new_n62_ & (x15 | (~new_n88_ & (x14 | (~new_n82_ & new_n84_))));
  ...
  assign new_n92_ = (x15 | (~new_n103_ & ((~new_n93_ & ~new_n102_) | x07))) & (~new_n100_ | x07);
  ...
  assign new_n97_ = (x02 | x08 | ~x11) & (~x02 | ~x08 | x10 | ~x13 | x14);
  ...
  assign new_n130_ = (~x06 | (~new_n131_ & (~x12 | new_n132_ | x16))) & ~new_n85_ & (x06 | ~x12 | new_n132_ | ~x16);
  assign new_n131_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n132_ = x13 & (x02 | ~x11);
  assign new_n133_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n135_ | new_n138_);
  ...
  assign z18 = ~x05 & ~x07 & ~x09 & new_n140_ & ~x17;
  assign new_n140_ = x18 & ((~x14 & ~new_n141_ & ~x15) | (~x08 & x15 & x19));
  assign new_n141_ = (new_n142_ | ~x02) & (~x12 | (~new_n144_ & (new_n143_ | x06)));
  assign new_n142_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n143_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n144_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n154_ | (~new_n147_ & ~x09));
  assign new_n147_ = ~new_n151_ & (~x18 | (~new_n148_ & (x05 | ~new_n153_ | x06)));
  assign new_n148_ = ~x21 & (x04 ? (new_n149_ & ~x12) : ~new_n116_);
  ...
  assign z27 = new_n172_ | (new_n177_ & new_n66_ & x03 & ~x05);
