// Benchmark "FAU" written by ABC on Thu Jul 30 16:55:32 2020
...
module FAU ( 
  ...
  assign z08 = x14 & ~x20;
  assign z09 = (new_n91_ & x05) | (~x07 & (new_n90_ | (~new_n81_ & ~x17)));
  assign new_n81_ = ~new_n88_ & (~x18 | (x08 ? (~new_n82_ & ~new_n83_) : ~new_n86_));
  assign new_n82_ = ~new_n59_ & (new_n72_ | (~x11 & x15 & x02 & ~x05));
  assign new_n83_ = ~x09 & (new_n85_ | (x02 & x13 & new_n84_ & ~x14));
  assign new_n84_ = ~x15 & ~x21 & (x12 ? ~x05 : (x04 | ~x10));
  assign new_n85_ = x05 & x21;
  assign new_n86_ = ~x09 & ~x15 & (x05 ? ~x19 : new_n87_);
  assign new_n87_ = ~x21 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  assign new_n88_ = new_n89_ & ~x09 & x12 & x04 & ~x05;
  assign new_n89_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n90_ = ~x09 & ~x15 & x17 & ~x18;
  assign new_n91_ = x08 & ~x15 & ~x17 & x18 & (~x04 | x07);
  assign z10 = z13 | (~x17 & ~new_n93_ & x18);
  assign new_n93_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x06 | x07 | x08 | x09))) & (x05 | x07 | ~x08 | ~x09))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign z13 = ~x09 & x17 & ~x18 & (~x07 | (~x05 & x07));
  assign z11 = new_n96_ & ~x18;
  assign new_n96_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z14 = (new_n101_ & ~x05) | (~x17 & (new_n99_ | (new_n98_ & x08)));
  assign new_n98_ = x18 & (x07 ? (~x19 & (~x05 ^ ~x15)) : new_n71_);
  ...
  assign z22 = ~x17 & ~new_n111_ & x18;
  assign new_n111_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = new_n113_ & x18;
  assign new_n113_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
