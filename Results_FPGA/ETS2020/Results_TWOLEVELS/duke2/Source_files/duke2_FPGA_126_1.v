...
module FAU ( 
  ...
  assign new_n57_ = (~x05 | (x07 & x15)) & (x05 | (~x07 ^ ~x15)) & (x00 | x07 | ~x15);
  ...
  assign z02 = ~x17 & ((~new_n69_ & ~x09) | (new_n75_ & x08));
  assign new_n69_ = (x05 | (x07 ? new_n73_ : (new_n74_ | ~x18))) & (x07 | new_n70_ | ~x18);
  ...
  assign z09 = new_n112_ | (~x07 & ((~new_n99_ & ~x17) | (new_n113_ & ~x09)));
  ...
  assign new_n112_ = x05 & x08 & ~x15 & ~x17 & ~new_n56_ & x18;
  ...
  assign new_n119_ = ~new_n121_ & (x15 | (x08 ? (~new_n91_ | x14) : new_n120_));
  ...
  assign new_n127_ = ~x14 & ~x21 & ((~new_n128_ & x06) | new_n91_ | (new_n130_ & ~x06));
  assign new_n128_ = (~x02 | ((x10 | ~x13) & (~x04 | x12))) & (~new_n129_ | ~x12);
  assign new_n129_ = ~x16 & (~x13 | (~x02 & x11));
  assign new_n130_ = x12 & x16 & (~x13 | (~x02 & x11));
  assign new_n131_ = x09 & ~new_n56_ & ~x15;
  assign z17 = ~x09 & (new_n135_ | (~x05 & (new_n97_ | (~new_n133_ & ~x07))));
  assign new_n133_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n134_ | ~x18);
  assign new_n134_ = ~new_n61_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n135_ = new_n66_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n143_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n149_ = ~x07 & (new_n150_ | (~x05 & ~x08 & ~x15 & x18));
  ...
  assign new_n160_ = ~x21 & (new_n161_ | (~new_n122_ & ~x04));
  assign new_n161_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n162_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n163_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n171_ | (~new_n165_ & x18))) | (~x09 & x17 & ~new_n173_ & ~x18);
  assign new_n165_ = (~x08 | ((new_n166_ | x05) & (new_n170_ | x07))) & (x05 | x07 | ~new_n169_ | x08);
  assign new_n166_ = ~new_n167_ & (x07 | x09 | ~x10 | ~new_n168_ | ~x12);
  assign new_n167_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n168_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n169_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
  ...
  assign new_n173_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
