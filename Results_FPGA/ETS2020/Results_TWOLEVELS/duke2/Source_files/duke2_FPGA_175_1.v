...
module FAU ( 
  ...
  assign new_n165_ = ~x21 & (new_n166_ | (~new_n122_ & ~x04));
  assign new_n166_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n167_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n168_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n176_ | (~new_n170_ & x18))) | (~x09 & x17 & ~new_n178_ & ~x18);
  assign new_n170_ = (~x08 | ((new_n171_ | x05) & (new_n175_ | x07))) & (x05 | x07 | ~new_n174_ | x08);
  assign new_n171_ = ~new_n172_ & (x07 | x09 | ~x10 | ~new_n173_ | ~x12);
  assign new_n172_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n173_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n174_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n92_ & x21));
  ...
  assign new_n178_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
