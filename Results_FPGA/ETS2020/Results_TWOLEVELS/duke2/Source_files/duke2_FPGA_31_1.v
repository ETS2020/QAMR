...
module FAU ( 
  ...
  assign new_n75_ = x07 ? ~x05 : ((x04 | ~x05 | ~x12 | (~x09 & x21)) & x05 & x12);
  ...
  assign new_n99_ = ~new_n101_ & (x15 | (x08 ? (~new_n89_ | x14) : new_n100_));
  assign new_n100_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n101_ = x11 & x15 & ~x02 & x08;
  assign new_n102_ = (~x05 | ~x08 | x11 | ~x15) & (x08 | ~x12 | x15 | x05 | x06);
  ...
  assign new_n109_ = (~x06 | (~new_n110_ & (~x12 | new_n111_ | x16))) & ~new_n89_ & (x06 | ~x12 | new_n111_ | ~x16);
  assign new_n110_ = x02 & (~x10 | (x04 & ~x12));
  assign new_n111_ = x13 & (x02 | ~x11);
  assign new_n112_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n116_ | (~x05 & (new_n95_ | (~new_n114_ & ~x07))));
  assign new_n114_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n115_ | ~x18);
  assign new_n115_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n116_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n118_ & x18;
  assign new_n118_ = (x14 | x15 | (~new_n119_ & ~new_n79_)) & (x08 | ~x15 | ~x19);
  assign new_n119_ = x12 & ((~new_n120_ & ~x06) | (new_n121_ & x06 & x08 & x10));
  assign new_n120_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  ...
  assign new_n134_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n136_ & x18;
  assign new_n136_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z24 = ~x09 & ~x17 & (new_n138_ | new_n142_);
  assign new_n138_ = ~x07 & (new_n139_ | (~x05 & ~x08 & ~x15 & x18));
  ...
  assign z27 = new_n147_ | (new_n152_ & ~x07 & x08 & x03 & ~x05);
  assign new_n147_ = ~x09 & ((~x17 & ~new_n148_ & x18) | (~x05 & x17 & ~new_n151_ & ~x18));
  assign new_n148_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n149_ & (x15 | ~x19 | ~x05 | x08));
  ...
  assign new_n158_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n92_ & x21));
  ...
  assign new_n162_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
