// Benchmark "FAU" written by ABC on Thu Jul 30 16:55:29 2020
...
module FAU ( 
  ...
  assign new_n170_ = ~x21 & (new_n171_ | (~new_n123_ & ~x04));
  assign new_n171_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n172_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n173_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n181_ | (~new_n175_ & x18))) | (~x09 & x17 & ~new_n183_ & ~x18);
  assign new_n175_ = (~x08 | ((new_n176_ | x05) & (new_n180_ | x07))) & (x05 | x07 | ~new_n179_ | x08);
  assign new_n176_ = ~new_n177_ & (x07 | x09 | ~x10 | ~new_n178_ | ~x12);
  assign new_n177_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  ...
  assign new_n183_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
