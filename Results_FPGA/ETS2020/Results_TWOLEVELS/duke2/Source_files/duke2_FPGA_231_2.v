...
module FAU ( 
  ...
  assign new_n64_ = (x02 | (~x06 & (~x08 | ~x11 | ~x15 | x21))) & (~x06 | (x11 & (x08 | ~x15))) & (x06 | x08 | ~x15);
  ...
  assign new_n94_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  ...
  assign z17 = ~x09 & ((~new_n125_ & ~x05) | (new_n128_ & new_n70_ & ~x04 & x05));
  ...
  assign z22 = ~x17 & ~new_n141_ & x18;
  assign new_n141_ = (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = new_n143_ & x18;
  assign new_n143_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n145_ | new_n149_);
  assign new_n145_ = ~x07 & (new_n146_ | (~x05 & ~x08 & ~x15 & x18));
  ...
  assign z27 = new_n154_ | (new_n159_ & new_n70_ & x03 & ~x05);
  assign new_n154_ = ~x09 & ((~x17 & ~new_n155_ & x18) | (~x05 & x17 & ~new_n158_ & ~x18));
  assign new_n155_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n156_ & (~x05 | x08 | x15 | ~x19));
  assign new_n156_ = ~x21 & (new_n157_ | (~new_n104_ & ~x04));
  assign new_n157_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n158_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n159_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n167_ | (~new_n161_ & x18))) | (~x09 & x17 & ~new_n169_ & ~x18);
  assign new_n161_ = (~x08 | ((new_n162_ | x05) & (new_n166_ | x07))) & (x05 | x07 | ~new_n165_ | x08);
  assign new_n162_ = ~new_n163_ & (x07 | x09 | ~x10 | ~new_n164_ | ~x12);
  assign new_n163_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n164_ = ~x14 & ~x15 & ~x21 & (x02 | x11 | ~x13);
  assign new_n165_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n87_ & x21));
  ...
  assign new_n169_ = x05 ? x07 : (~x15 | (x07 & x19));
  assign z01 = 1'b0;
  assign z08 = 1'b0;
  assign z09 = 1'b0;
  assign z18 = 1'b0;
