...
module FAU ( 
  ...
  assign new_n88_ = (~x00 | ~x15 | ~x17 | x18) & (x17 | ~x18 | (~new_n62_ & (new_n89_ | x15)));
  ...
  assign new_n102_ = ~new_n113_ & (x07 | (~new_n110_ & ((~new_n103_ & ~new_n112_) | x15)));
  ...
  assign z12 = ~x09 & ((~new_n121_ & ~x07) | (new_n117_ & ~x05 & x07));
  ...
  assign new_n154_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n158_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign new_n162_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18);
  ...
  assign new_n180_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
  ...
  assign new_n184_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
  assign z14 = 1'b0;
