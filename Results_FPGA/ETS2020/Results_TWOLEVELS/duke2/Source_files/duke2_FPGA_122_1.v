...
module FAU ( 
  ...
  assign z13 = new_n125_ & ~x09;
  assign new_n125_ = x17 & ~x18 & ((~x05 & (x07 | (~x07 & (~x15 | (x00 & x15))))) | (~x07 & (x05 | (~x00 & x15))));
  ...
  assign z17 = ~x09 & (new_n137_ | (~x05 & (new_n95_ | (~new_n135_ & ~x07))));
  ...
  assign new_n139_ = (x14 | x15 | (~new_n140_ & ~new_n79_)) & (x08 | ~x15 | ~x19);
  assign new_n140_ = x12 & ((~new_n141_ & ~x06) | (new_n142_ & x06 & x08 & x10));
  assign new_n141_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  assign new_n142_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n145_ | new_n151_);
  assign new_n145_ = ~x09 & (new_n146_ | (new_n109_ & x04 & ~x05 & x12));
  assign new_n146_ = x18 & (new_n149_ | (~x21 & (x04 ? new_n147_ : ~new_n122_)));
  assign new_n147_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n148_ : ~x06));
  assign new_n148_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n149_ = ~x05 & new_n150_ & ~x06;
