// Benchmark "FAU" written by ABC on Thu Jul 30 16:55:31 2020
...
module FAU ( 
  ...
  assign new_n87_ = (~x00 | ~x15 | ~x17 | x18) & (x17 | ~x18 | (~new_n62_ & (new_n88_ | x15)));
  ...
  assign new_n98_ = (x09 | (x07 ? (~x08 | (~x05 ^ x15)) : (x08 | (~x05 ^ x15)))) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20;
  assign z09 = new_n115_ | (~x17 & (new_n113_ | (~new_n101_ & x18)));
  assign new_n101_ = ~new_n112_ & (x07 | (~new_n109_ & ((~new_n102_ & ~new_n111_) | x15)));
  ...
  assign new_n147_ = ~x21 & (x04 ? (new_n148_ & ~x12) : ~new_n125_);
  ...
  assign new_n153_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  assign z21 = ~x17 & ~new_n155_ & x18;
  assign new_n155_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n157_ & x18;
  assign new_n157_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z24 = ~x09 & ~x17 & (new_n159_ | new_n163_);
  assign new_n159_ = ~x07 & (new_n160_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n160_ = ~x21 & ((x04 & ~new_n161_ & ~x15) | (x08 & new_n162_ & x15));
  assign new_n161_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18);
  ...
  assign z27 = new_n167_ | (new_n172_ & ~x07 & x08 & x03 & ~x05);
  assign new_n167_ = ~x09 & ((~x17 & ~new_n168_ & x18) | (~x05 & x17 & ~new_n171_ & ~x18));
  assign new_n168_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n169_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n169_ = ~x21 & (new_n170_ | (~new_n125_ & ~x04));
  assign new_n170_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n171_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n172_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n180_ | (~new_n174_ & x18))) | (~x09 & x17 & ~new_n182_ & ~x18);
  assign new_n174_ = (~x08 | ((new_n175_ | x05) & (new_n179_ | x07))) & (x05 | x07 | ~new_n178_ | x08);
  assign new_n175_ = ~new_n176_ & (x07 | x09 | ~x10 | ~new_n177_ | ~x12);
  assign new_n176_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n177_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n178_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
  assign new_n179_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n180_ = new_n181_ & ~x05;
  assign new_n181_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n182_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
