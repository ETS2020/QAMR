...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n86_ & ~x05) | (new_n95_ & new_n65_ & x04 & x05));
  ...
  assign new_n88_ = new_n63_ & x11 & x15 & ~x21;
  ...
  assign new_n117_ = (x17 | ~new_n118_ | ~x18) & (~x15 | ~x17 | x18 | ~x00 | x05);
  assign new_n118_ = ~x21 & ((~new_n122_ & ~x04) | (~new_n119_ & ~x05) | (new_n123_ & x04 & x05));
  assign new_n119_ = ~new_n121_ & (x15 | (x08 ? (~new_n90_ | x14) : new_n120_));
  ...
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n133_ & x18;
  assign new_n133_ = (x14 | x15 | (~new_n134_ & ~new_n79_)) & (x08 | ~x15 | ~x19);
  assign new_n134_ = x12 & ((~new_n135_ & ~x06) | (new_n136_ & x06 & x08 & x10));
  assign new_n135_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  assign new_n136_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n139_ | new_n145_);
  assign new_n139_ = ~x09 & (new_n140_ | (new_n109_ & x04 & ~x05 & x12));
  assign new_n140_ = x18 & (new_n143_ | (~x21 & (x04 ? new_n141_ : ~new_n122_)));
  assign new_n141_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n142_ : ~x06));
  assign new_n142_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n143_ = ~x05 & new_n144_ & ~x06;
  ...
  assign new_n148_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n150_ & x18;
  assign new_n150_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign z27 = new_n159_ | (new_n164_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n161_ = ~x21 & (new_n162_ | (~new_n122_ & ~x04));
  assign new_n162_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n163_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n164_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n172_ | (~new_n166_ & x18))) | (~x09 & x17 & ~new_n174_ & ~x18);
  assign new_n166_ = (~x08 | ((new_n167_ | x05) & (new_n171_ | x07))) & (x05 | x07 | ~new_n170_ | x08);
  assign new_n167_ = ~new_n168_ & (x07 | x09 | ~x10 | ~new_n169_ | ~x12);
  assign new_n168_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n169_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n170_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
  ...
  assign new_n174_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
