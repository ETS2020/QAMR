// Benchmark "FAU" written by ABC on Thu Jul 30 16:55:07 2020
...
module FAU ( 
  ...
  assign z12 = ~x09 & ((~new_n114_ & ~x07) | (new_n121_ & ~x05 & x07));
  ...
  assign new_n135_ = (~x06 | (~new_n136_ & (~x12 | new_n137_ | x16))) & ~new_n83_ & (x06 | ~x12 | new_n137_ | ~x16);
  assign new_n136_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n137_ = x13 & (x02 | ~x11);
  assign new_n138_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n142_ | (~x05 & (new_n89_ | (~new_n140_ & ~x07))));
  assign new_n140_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n141_ | ~x18);
  assign new_n141_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n142_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n144_ & x18;
  assign new_n144_ = (x14 | x15 | (~new_n145_ & ~new_n73_)) & (x08 | ~x15 | ~x19);
  assign new_n145_ = x12 & ((~new_n146_ & ~x06) | (new_n147_ & x06 & x08 & x10));
  assign new_n146_ = (x04 | x08 | ~x21) & (~new_n78_ | ~x08 | ~x10);
  ...
  assign new_n150_ = ~x21 & (x04 ? (new_n151_ & ~x12) : ~new_n119_);
  ...
  assign new_n167_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
