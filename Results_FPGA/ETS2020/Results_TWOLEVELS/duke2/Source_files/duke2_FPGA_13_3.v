// Benchmark "FAU" written by ABC on Thu Jul 30 16:54:42 2020
...
module FAU ( 
  ...
  assign z12 = ~x09 & ((~new_n115_ & ~x07) | (new_n122_ & ~x05 & x07));
  ...
  assign new_n136_ = (~x06 | (~new_n137_ & (~x12 | new_n138_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n138_ | ~x16);
  assign new_n137_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n138_ = x13 & (x02 | ~x11);
  assign new_n139_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n143_ | (~x05 & (new_n88_ | (~new_n141_ & ~x07))));
  ...
  assign new_n145_ = (x14 | x15 | (~new_n146_ & ~new_n72_)) & (x08 | ~x15 | ~x19);
  assign new_n146_ = x12 & ((~new_n147_ & ~x06) | (new_n148_ & x06 & x08 & x10));
  assign new_n147_ = (x04 | x08 | ~x21) & (~new_n77_ | ~x08 | ~x10);
  ...
  assign new_n168_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  ...
  assign new_n186_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
