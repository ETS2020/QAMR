...
module FAU ( 
  ...
  assign new_n82_ = (~x17 | x18 | ((x05 | (x15 & (~x00 | ~x15))) & ~x05 & (x00 | ~x15))) & (~x05 | x08 | x15 | x17 | ~x18);
  ...
  assign new_n92_ = (~x00 | ~x15 | ~x17 | x18) & (x17 | ~x18 | (~new_n62_ & (new_n93_ | x15)));
  ...
  assign new_n128_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  ...
  assign new_n145_ = (x04 | x08 | ~x21) & (~new_n90_ | ~x08 | ~x10);
  ...
  assign new_n156_ = new_n72_ & x04 & ~x15 & x18 & x09 & ~x12;
  assign z21 = ~x17 & ~new_n158_ & x18;
  assign new_n158_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign z27 = new_n171_ | (new_n176_ & new_n66_ & x03 & ~x05);
  ...
  assign z28 = (~x17 & (new_n184_ | (~new_n178_ & x18))) | (~x09 & x17 & ~new_n186_ & ~x18);
  ...
  assign new_n180_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n181_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n182_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n98_ & x21));
  ...
  assign new_n186_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z04 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
