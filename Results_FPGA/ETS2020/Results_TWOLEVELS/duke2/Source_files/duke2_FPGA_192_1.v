// Benchmark "FAU" written by ABC on Thu Jul 30 16:55:39 2020
...
module FAU ( 
  ...
  assign new_n127_ = (~x06 | (~new_n128_ & (~x12 | new_n129_ | x16))) & ~new_n90_ & (x06 | ~x12 | new_n129_ | ~x16);
  assign new_n128_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n129_ = x13 & (x02 | ~x11);
  assign new_n130_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n134_ | (~x05 & (new_n96_ | (~new_n132_ & ~x07))));
  ...
  assign new_n136_ = (x14 | x15 | (~new_n137_ & ~new_n80_)) & (x08 | ~x15 | ~x19);
  assign new_n137_ = x12 & ((~new_n138_ & ~x06) | (new_n139_ & x06 & x08 & x10));
  assign new_n138_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  assign new_n139_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n142_ | new_n148_);
  assign new_n142_ = ~x09 & (new_n143_ | (new_n110_ & x04 & ~x05 & x12));
  ...
  assign new_n155_ = ~x07 & (new_n156_ | (~x05 & ~x08 & ~x15 & x18));
  ...
  assign new_n164_ = ~x21 & (new_n165_ | (~new_n121_ & ~x04));
  ...
  assign new_n173_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
  ...
  assign new_n177_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
