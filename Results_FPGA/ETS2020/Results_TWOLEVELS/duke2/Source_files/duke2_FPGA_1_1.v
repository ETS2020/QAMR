...
module FAU ( 
  ...
  assign new_n100_ = ~new_n111_ & (x07 | (~new_n108_ & ((~new_n101_ & ~new_n110_) | x15)));
  ...
  assign z17 = ~x09 & (new_n137_ | (~x05 & (new_n96_ | (~new_n135_ & ~x07))));
  ...
  assign new_n139_ = (x14 | x15 | (~new_n140_ & ~new_n80_)) & (x08 | ~x15 | ~x19);
  assign new_n140_ = x12 & ((~new_n141_ & ~x06) | (new_n142_ & x06 & x08 & x10));
  assign new_n141_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  ...
  assign new_n146_ = ~x21 & (x04 ? (new_n147_ & ~x12) : ~new_n124_);
  ...
  assign new_n152_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n168_ = ~x21 & (new_n169_ | (~new_n124_ & ~x04));
