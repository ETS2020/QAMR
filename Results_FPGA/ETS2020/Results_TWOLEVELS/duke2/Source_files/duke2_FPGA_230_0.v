...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n106_, new_n107_, new_n110_, new_n112_, new_n115_, new_n116_,
  ...
  assign z10 = (~new_n92_ & ~x15) | (~x09 & (new_n95_ | (~x05 & ~new_n94_ & x15)));
  assign new_n92_ = (x17 | new_n93_ | ~x18) & (x09 | ~x17 | x18 | x05 | ~x07);
  assign new_n93_ = (~x05 | ((~x07 | ~x08) & (x06 | x07 | x08 | x09))) & (x05 | x07 | ~x08 | ~x09);
  assign new_n94_ = (~x17 | x18) & (x06 | x07 | x08 | x17 | ~x18);
  assign new_n95_ = ~x07 & x17 & ~x18;
  assign z11 = new_n97_ & ~x18;
  assign new_n97_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z13 = ~x09 & x17 & ~x18 & (~x07 | (~x05 & (x15 | (x07 & ~x15))));
  assign z14 = (new_n101_ & ~x05) | (~x17 & (new_n87_ | (new_n100_ & x08)));
  assign new_n100_ = x18 & (x07 ? (~x19 & (~x05 ^ ~x15)) : new_n71_);
  assign new_n101_ = ~x09 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | (~x15 & x17))));
  ...
  assign new_n110_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign new_n119_ = new_n120_ & new_n61_ & x03 & ~x05;
