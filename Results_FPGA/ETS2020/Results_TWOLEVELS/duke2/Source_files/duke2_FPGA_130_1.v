// Benchmark "FAU" written by ABC on Thu Jul 30 16:55:19 2020
...
module FAU ( 
  ...
  assign new_n125_ = (~x06 | (~new_n126_ & (~x12 | new_n127_ | x16))) & ~new_n89_ & (x06 | ~x12 | new_n127_ | ~x16);
  assign new_n126_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n127_ = x13 & (x02 | ~x11);
  assign new_n128_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n132_ | (~x05 & (new_n95_ | (~new_n130_ & ~x07))));
  assign new_n130_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n131_ | ~x18);
  assign new_n131_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n132_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n134_ & x18;
  assign new_n134_ = (x14 | x15 | (~new_n135_ & ~new_n79_)) & (x08 | ~x15 | ~x19);
  assign new_n135_ = x12 & ((~new_n136_ & ~x06) | (new_n137_ & x06 & x08 & x10));
  assign new_n136_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  assign new_n137_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n140_ | new_n146_);
  assign new_n140_ = ~x09 & (new_n141_ | (new_n108_ & x04 & ~x05 & x12));
  assign new_n141_ = x18 & (new_n144_ | (~x21 & (x04 ? new_n142_ : ~new_n119_)));
  assign new_n142_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n143_ : ~x06));
  assign new_n143_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n144_ = ~x05 & new_n145_ & ~x06;
  assign new_n145_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n146_ = new_n147_ & x04 & x05 & x08;
  assign new_n147_ = ~x15 & x18 & x09 & ~x12;
  assign z21 = ~x17 & ~new_n149_ & x18;
  assign new_n149_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n151_ & x18;
  assign new_n151_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z24 = ~x09 & ~x17 & (new_n153_ | new_n157_);
  assign new_n153_ = ~x07 & (new_n154_ | (~x05 & ~x08 & ~x15 & x18));
  ...
  assign z28 = (~x17 & (new_n174_ | (~new_n168_ & x18))) | (~x09 & x17 & ~new_n176_ & ~x18);
  assign new_n168_ = (~x08 | ((new_n169_ | x05) & (new_n173_ | x07))) & (x05 | x07 | ~new_n172_ | x08);
  assign new_n169_ = ~new_n170_ & (x07 | x09 | ~x10 | ~new_n171_ | ~x12);
  assign new_n170_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n171_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n172_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n92_ & x21));
  ...
  assign new_n176_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
