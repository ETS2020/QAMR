...
module FAU ( 
  ...
  assign z10 = new_n116_ | (new_n119_ & x08);
  assign new_n116_ = ~x09 & ((~new_n117_ & ~x07) | (~x05 & x07 & x17 & ~x18));
  assign new_n117_ = (~x05 | ((~x17 | x18) & (~new_n118_ | x15 | x17 | ~x18))) & (x05 | (x15 ? ((~new_n118_ | x17 | ~x18) & (~x00 | ~x17 | x18)) : (~x17 | x18))) & (~x17 | x18 | x00 | ~x15);
  ...
  assign new_n134_ = (~x06 | (~new_n135_ & (~x12 | new_n136_ | x16))) & ~new_n90_ & (x06 | ~x12 | new_n136_ | ~x16);
  assign new_n135_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n136_ = x13 & (x02 | ~x11);
  assign new_n137_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n141_ | (~x05 & (new_n96_ | (~new_n139_ & ~x07))));
  assign new_n139_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n140_ | ~x18);
  assign new_n140_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n141_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n143_ & x18;
  assign new_n143_ = (x14 | x15 | (~new_n144_ & ~new_n80_)) & (x08 | ~x15 | ~x19);
  assign new_n144_ = x12 & ((~new_n145_ & ~x06) | (new_n146_ & x06 & x08 & x10));
  assign new_n145_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  assign new_n146_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n149_ | new_n155_);
  assign new_n149_ = ~x09 & (new_n150_ | (new_n110_ & x04 & ~x05 & x12));
  assign new_n150_ = x18 & (new_n153_ | (~x21 & (x04 ? new_n151_ : ~new_n128_)));
  assign new_n151_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n152_ : ~x06));
  assign new_n152_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n153_ = ~x05 & new_n154_ & ~x06;
  ...
  assign new_n188_ = (~x05 | x07) & (~x15 | ((x00 | x07) & (x05 | (x19 & (~x00 | x07)))));
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z13 = 1'b0;
  assign z14 = 1'b0;
