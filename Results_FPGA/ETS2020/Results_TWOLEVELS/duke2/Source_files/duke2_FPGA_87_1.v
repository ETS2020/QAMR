...
module FAU ( 
  ...
  assign z10 = new_n114_ | (new_n117_ & x08);
  assign new_n114_ = ~x09 & ((~new_n115_ & ~x07) | (~x05 & x07 & x17 & ~x18));
  assign new_n115_ = (~x05 | ((~x17 | x18) & (~new_n116_ | x15 | x17 | ~x18))) & (x05 | (x15 ? ((~new_n116_ | x17 | ~x18) & (~x00 | ~x17 | x18)) : (~x17 | x18))) & (~x17 | x18 | x00 | ~x15);
  ...
  assign z12 = ~x09 & ((~new_n121_ & ~x07) | (new_n112_ & ~x05 & x07));
  ...
  assign new_n126_ = (~x05 | ~x08 | x11 | ~x15) & (x08 | ~x12 | x15 | x05 | x06);
  ...
  assign new_n132_ = (~x06 | (~new_n133_ & (~x12 | new_n134_ | x16))) & ~new_n89_ & (x06 | ~x12 | new_n134_ | ~x16);
  assign new_n133_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n134_ = x13 & (x02 | ~x11);
  assign new_n135_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n139_ | (~x05 & (new_n95_ | (~new_n137_ & ~x07))));
  ...
  assign new_n141_ = (x14 | x15 | (~new_n142_ & ~new_n79_)) & (x08 | ~x15 | ~x19);
  assign new_n142_ = x12 & ((~new_n143_ & ~x06) | (new_n144_ & x06 & x08 & x10));
  assign new_n143_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  assign new_n144_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n147_ | new_n153_);
  assign new_n147_ = ~x09 & (new_n148_ | (new_n108_ & x04 & ~x05 & x12));
  assign new_n148_ = x18 & (new_n151_ | (~x21 & (x04 ? new_n149_ : ~new_n126_)));
  assign new_n149_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n150_ : ~x06));
