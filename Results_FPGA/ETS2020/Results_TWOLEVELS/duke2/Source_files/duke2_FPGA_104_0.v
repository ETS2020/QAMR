...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n69_, new_n70_, new_n71_, new_n72_, new_n74_, new_n75_, new_n79_,
    new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_, new_n86_,
    new_n87_, new_n88_, new_n90_, new_n93_, new_n95_, new_n96_, new_n98_,
  ...
  assign z04 = ~x14 & ~x20;
  assign z08 = x14 & ~x20;
  assign z09 = new_n88_ | (~x17 & (new_n85_ | (x18 & (new_n79_ | new_n87_))));
  assign new_n79_ = ~x07 & (x08 ? (new_n80_ | (~new_n81_ & ~x09)) : (new_n83_ & ~x09));
  assign new_n80_ = ~new_n59_ & (new_n72_ | (~x11 & x15 & x02 & ~x05));
  assign new_n81_ = (~x05 | ~x21) & (~x02 | ~x13 | ~new_n82_ | x14);
  assign new_n82_ = ~x15 & ~x21 & (x12 ? ~x05 : (x04 | ~x10));
  assign new_n83_ = ~x15 & (x05 ? ~x19 : new_n84_);
  assign new_n84_ = ~x21 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  assign new_n85_ = new_n86_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n86_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n87_ = x05 & x08 & ~x15 & (~x04 | x07);
  assign new_n88_ = ~x07 & ~x09 & ~x15 & x17 & ~x18;
  assign z10 = z13 | (~x17 & ~new_n90_ & x18);
  assign new_n90_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign z13 = ~x09 & x17 & ~x18 & (~x07 | (~x05 & x07));
  assign z11 = new_n93_ & ~x18;
  assign new_n93_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z14 = (new_n96_ & ~x05) | (~x17 & (new_n85_ | (new_n95_ & x08)));
