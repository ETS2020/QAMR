...
module FAU ( 
  ...
  assign z09 = (~x17 & (new_n109_ | (~new_n97_ & x18))) | (new_n110_ & ~x15 & x17 & ~x18);
  assign new_n97_ = ~new_n108_ & (x07 | (~new_n105_ & ((~new_n98_ & ~new_n107_) | x15)));
  ...
  assign new_n108_ = x05 & x08 & ~x15 & (x07 | ~x12);
  assign new_n109_ = new_n111_ & new_n110_ & x04 & ~x05;
