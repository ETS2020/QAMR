...
module FAU ( 
  ...
  assign z08 = x14 & ~x20;
  assign z09 = (~x17 & (new_n111_ | (~new_n99_ & x18))) | (new_n112_ & ~x15 & x17 & ~x18);
  assign new_n99_ = ~new_n110_ & (x07 | (~new_n107_ & ((~new_n100_ & ~new_n109_) | x15)));
  ...
  assign new_n111_ = new_n113_ & new_n112_ & x04 & ~x05;
  ...
  assign z12 = ~x09 & ((~new_n117_ & ~x07) | (new_n124_ & ~x05 & x07));
