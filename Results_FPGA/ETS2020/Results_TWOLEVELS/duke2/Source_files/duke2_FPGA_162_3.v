...
module FAU ( 
  ...
  assign new_n117_ = ~new_n119_ & (x15 | (x08 ? (~new_n83_ | x14) : new_n118_));
  ...
  assign z28 = (~x17 & (new_n187_ | (~new_n181_ & x18))) | (~x09 & x17 & ~new_n189_ & ~x18);
  ...
  assign new_n185_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
