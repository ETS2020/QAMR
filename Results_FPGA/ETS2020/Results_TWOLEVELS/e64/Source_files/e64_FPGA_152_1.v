// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:11 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n351_, new_n352_, new_n353_, new_n354_, new_n357_;
  ...
  assign new_n164_ = new_n165_ & ~x62;
  assign new_n165_ = ~x60 & ~x59 & ~x58 & new_n166_ & ~x57 & ~x61;
  assign new_n166_ = ~x56 & ~x55 & new_n167_ & ~x54;
  assign new_n167_ = ~x51 & ~x50 & ~x49 & new_n168_ & ~x48 & ~x53;
  assign new_n168_ = ~x47 & ~x46 & ~x45 & new_n169_ & ~x43;
  assign new_n169_ = ~x41 & ~x40 & ~x39 & new_n170_ & ~x37 & ~x42;
  assign new_n170_ = ~x34 & ~x33 & ~x31 & new_n171_ & ~x30 & ~x35;
  assign new_n171_ = ~x28 & ~x26 & ~x25 & new_n172_ & ~x24 & x29;
  assign new_n172_ = ~x18 & ~x17 & ~x15 & new_n173_ & ~x14 & ~x22;
  assign new_n173_ = new_n154_ & ~x11;
  assign z21 = ~x62 & ~x60 & new_n175_ & ~x58;
  assign new_n175_ = ~x50 & ~x47 & ~x46 & new_n176_ & ~x43 & ~x56;
  assign new_n176_ = ~x40 & ~x39 & ~x37 & new_n177_ & ~x30 & ~x41;
  assign new_n177_ = ~x28 & ~x26 & ~x25 & new_n178_ & ~x24 & x29;
  assign new_n178_ = ~x18 & ~x15 & ~x14 & new_n179_ & ~x11 & ~x22;
  assign new_n179_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z23 = ~x64 & ~x63 & ~x62 & new_n181_ & ~x61;
  ...
  assign new_n187_ = ~x25 & ~x24 & ~x22 & new_n188_ & ~x21 & ~x26;
  assign new_n188_ = ~x18 & ~x17 & x16 & ~x15 & new_n189_ & ~x14;
  assign new_n189_ = new_n173_ & ~x12;
  ...
  assign z26 = new_n194_ & ~x64;
  assign new_n194_ = ~x62 & ~x61 & ~x60 & new_n195_ & ~x59 & ~x63;
  assign new_n195_ = ~x57 & ~x56 & ~x55 & new_n196_ & ~x54 & ~x58;
  assign new_n196_ = ~x52 & ~x51 & ~x50 & new_n197_ & ~x49 & ~x53;
  assign new_n197_ = ~x47 & ~x46 & ~x45 & new_n198_ & ~x43 & ~x48;
  assign new_n198_ = ~x41 & ~x40 & ~x39 & new_n199_ & ~x37 & ~x42;
  assign new_n199_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n200_ & x32;
  assign new_n200_ = ~x31 & ~x30 & x29 & ~x28 & new_n201_ & ~x26;
  assign new_n201_ = ~x24 & ~x22 & ~x21 & new_n152_ & ~x20 & ~x25;
  assign z27 = ~x64 & ~x63 & new_n203_ & ~x62;
  ...
  assign new_n208_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n209_ & x29;
  assign new_n209_ = ~x26 & ~x25 & ~x24 & new_n210_ & ~x22 & ~x28;
  assign new_n210_ = ~x20 & ~x18 & ~x17 & new_n211_ & ~x16 & ~x21;
  assign new_n211_ = ~x15 & ~x14 & x13 & new_n173_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n213_ & ~x50;
  assign new_n213_ = ~x43 & ~x40 & ~x39 & new_n214_ & ~x37 & ~x46;
  assign new_n214_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n216_ & ~x61;
  assign new_n216_ = ~x59 & ~x58 & ~x57 & new_n217_ & ~x56 & ~x60;
  assign new_n217_ = ~x55 & ~x54 & ~x53 & x52 & new_n218_ & ~x51;
  assign new_n218_ = ~x49 & ~x48 & ~x47 & new_n219_ & ~x46 & ~x50;
  assign new_n219_ = ~x43 & ~x42 & ~x41 & new_n220_ & ~x40 & ~x45;
  assign new_n220_ = ~x37 & ~x36 & ~x35 & new_n221_ & ~x34 & ~x39;
  assign new_n221_ = ~x33 & ~x31 & ~x30 & x29 & new_n222_ & ~x28;
  assign new_n222_ = ~x25 & ~x24 & ~x22 & new_n223_ & ~x21 & ~x26;
  assign new_n223_ = ~x18 & ~x17 & ~x15 & new_n189_ & ~x14;
  assign z31 = ~x64 & ~x63 & new_n225_ & ~x62;
  assign new_n225_ = ~x60 & ~x59 & ~x58 & new_n226_ & ~x57 & ~x61;
  assign new_n226_ = ~x55 & ~x54 & ~x53 & new_n227_ & ~x51 & ~x56;
  ...
  assign new_n231_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n223_ & x21;
  assign z34 = new_n233_ & x58;
  assign new_n233_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z37 = ~x64 & new_n235_ & ~x63;
  ...
  assign new_n240_ = ~x34 & ~x33 & ~x32 & new_n241_ & ~x31 & ~x35;
  assign new_n241_ = ~x30 & x29 & ~x28 & ~x26 & new_n242_ & ~x25;
  assign new_n242_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n152_ & x19;
  assign z38 = ~x62 & ~x61 & new_n244_ & ~x60;
  assign new_n244_ = ~x58 & ~x56 & ~x55 & new_n245_ & ~x51 & x59;
  assign new_n245_ = ~x47 & ~x46 & ~x43 & new_n246_ & ~x42 & ~x50;
  assign new_n246_ = ~x41 & ~x40 & new_n247_ & ~x39;
  assign new_n247_ = ~x37 & ~x35 & ~x30 & x29 & new_n248_ & ~x28;
  assign new_n248_ = ~x25 & ~x24 & ~x22 & new_n249_ & ~x18 & ~x26;
  assign new_n249_ = ~x15 & ~x14 & ~x11 & new_n250_ & ~x10;
  assign new_n250_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n252_ & ~x61;
  assign new_n252_ = ~x58 & ~x56 & ~x55 & new_n253_ & ~x51 & ~x60;
  assign new_n253_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n246_ & x42;
  assign z40 = ~x62 & ~x61 & new_n255_ & ~x60;
  assign new_n255_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n256_ & x54;
  assign new_n256_ = ~x51 & ~x50 & new_n257_ & ~x47;
  assign new_n257_ = ~x43 & ~x42 & ~x41 & new_n258_ & ~x40 & ~x46;
  assign new_n258_ = ~x37 & ~x35 & ~x34 & new_n259_ & ~x33 & ~x39;
  assign new_n259_ = ~x30 & x29 & ~x28 & new_n260_ & ~x26;
  assign new_n260_ = ~x24 & ~x22 & ~x18 & new_n261_ & ~x17 & ~x25;
  assign new_n261_ = ~x14 & ~x11 & ~x10 & new_n250_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n263_ & ~x58 & ~x62;
  assign new_n263_ = ~x55 & ~x51 & ~x50 & new_n264_ & ~x47 & ~x56;
  assign new_n264_ = ~x43 & ~x42 & ~x41 & new_n265_ & ~x40 & ~x46;
  assign new_n265_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n259_ & x33;
  assign z42 = ~x62 & new_n267_ & ~x61;
  assign new_n267_ = ~x59 & ~x58 & ~x56 & new_n268_ & ~x55 & ~x60;
  assign new_n268_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n168_ & x49;
  assign z43 = new_n270_ & ~x62;
  assign new_n270_ = ~x60 & ~x59 & ~x58 & new_n271_ & ~x56 & ~x61;
  assign new_n271_ = ~x54 & ~x53 & ~x51 & new_n272_ & ~x50 & ~x55;
  assign new_n272_ = ~x46 & ~x45 & ~x43 & new_n273_ & ~x42 & ~x47;
  assign new_n273_ = ~x40 & ~x39 & ~x37 & new_n274_ & ~x35 & ~x41;
  assign new_n274_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n275_ & x29;
  assign new_n275_ = ~x26 & ~x25 & ~x24 & new_n276_ & ~x22 & ~x28;
  assign new_n276_ = ~x17 & ~x15 & ~x14 & new_n277_ & ~x11 & ~x18;
  assign new_n277_ = ~x09 & ~x08 & ~x07 & new_n278_ & ~x06 & ~x10;
  assign new_n278_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n280_ & ~x58 & ~x62;
  assign new_n280_ = ~x55 & ~x54 & ~x53 & new_n281_ & ~x51 & ~x56;
  assign new_n281_ = ~x47 & ~x46 & ~x45 & new_n282_ & ~x43 & ~x50;
  ...
  assign new_n286_ = ~x10 & ~x09 & ~x08 & new_n287_ & ~x07 & ~x11;
  ...
  assign new_n291_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n259_ & x34;
  ...
  assign new_n298_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n250_ & x09;
  ...
  assign new_n304_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n249_ & x17;
  ...
  assign new_n309_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n259_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n311_ & ~x59;
  assign new_n311_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n256_ & x53;
  assign z50 = new_n313_ & ~x62;
  assign new_n313_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n166_ & x57;
  assign z51 = ~x62 & ~x61 & new_n315_ & ~x60;
  assign new_n315_ = ~x58 & ~x56 & ~x55 & new_n316_ & ~x54 & ~x59;
  assign new_n316_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n168_ & x48;
  ...
  assign new_n325_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n173_ & x12;
  ...
  assign new_n335_ = ~x17 & ~x16 & ~x15 & new_n189_ & ~x14 & ~x18;
