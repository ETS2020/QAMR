// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:24 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n263_, new_n264_, new_n268_, new_n269_, new_n270_, new_n271_,
    ...
    new_n330_, new_n331_, new_n333_, new_n336_, new_n337_, new_n339_,
  ...
  assign new_n201_ = ~x37 & ~x30 & x29 & ~x28 & new_n193_ & x26;
  assign z17 = ~x62 & new_n203_ & ~x60;
  assign new_n203_ = ~x56 & ~x50 & ~x47 & new_n204_ & ~x46 & ~x58;
  assign new_n204_ = ~x40 & ~x39 & ~x37 & new_n205_ & ~x30 & ~x43;
  assign new_n205_ = ~x28 & ~x25 & ~x24 & new_n206_ & ~x15 & x29;
  assign new_n206_ = ~x11 & ~x10 & ~x08 & x03 & ~x07 & ~x14;
  assign z18 = new_n208_ & x62;
  assign new_n208_ = ~x58 & ~x56 & ~x50 & new_n209_ & ~x47 & ~x60;
  assign new_n209_ = ~x43 & ~x40 & ~x39 & new_n210_ & ~x37 & ~x46;
  assign new_n210_ = ~x30 & x29 & ~x28 & ~x25 & new_n211_ & ~x24;
  ...
  assign new_n233_ = ~x18 & new_n234_ & ~x17;
  assign new_n234_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z23 = ~x64 & new_n236_ & ~x63;
  assign new_n236_ = ~x61 & ~x60 & ~x59 & new_n237_ & ~x58 & ~x62;
  assign new_n237_ = ~x56 & ~x55 & ~x54 & new_n238_ & ~x53 & ~x57;
  assign new_n238_ = ~x51 & ~x50 & ~x49 & new_n239_ & ~x48 & ~x52;
  assign new_n239_ = ~x46 & ~x45 & ~x43 & new_n240_ & ~x42 & ~x47;
  assign new_n240_ = ~x40 & ~x39 & ~x37 & new_n241_ & ~x36 & ~x41;
  assign new_n241_ = ~x34 & ~x33 & ~x31 & new_n242_ & ~x30 & ~x35;
  assign new_n242_ = ~x28 & ~x26 & ~x25 & new_n243_ & ~x24 & x29;
  assign new_n243_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n234_ & x16;
  assign z28 = ~x60 & ~x58 & new_n245_ & ~x50;
  assign new_n245_ = ~x43 & ~x40 & ~x39 & new_n246_ & ~x37 & ~x46;
  assign new_n246_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n248_ & ~x46;
  assign new_n248_ = ~x43 & ~x40 & new_n196_ & ~x39;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n250_ & ~x61;
  assign new_n250_ = ~x59 & ~x58 & ~x57 & new_n251_ & ~x56 & ~x60;
  assign new_n251_ = ~x55 & ~x54 & ~x53 & x52 & new_n252_ & ~x51;
  ...
  assign new_n256_ = ~x25 & ~x24 & ~x22 & new_n233_ & ~x21 & ~x26;
  assign z31 = ~x64 & ~x63 & new_n258_ & ~x62;
  assign new_n258_ = ~x60 & ~x59 & ~x58 & new_n259_ & ~x57 & ~x61;
  assign new_n259_ = ~x55 & ~x54 & ~x53 & new_n260_ & ~x51 & ~x56;
  ...
  assign new_n264_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n233_ & x21;
  assign z32 = ~x58 & ~x50 & new_n248_ & x46;
  ...
  assign new_n277_ = ~x40 & ~x39 & ~x37 & new_n215_ & ~x35 & ~x41;
  ...
  assign z44 = ~x61 & ~x60 & ~x59 & new_n302_ & ~x58 & ~x62;
  assign new_n302_ = ~x55 & ~x54 & ~x53 & new_n303_ & ~x51 & ~x56;
  assign new_n303_ = ~x47 & ~x46 & ~x45 & new_n304_ & ~x43 & ~x50;
  assign new_n304_ = ~x41 & ~x40 & ~x39 & new_n305_ & ~x37 & ~x42;
  assign new_n305_ = ~x34 & ~x33 & ~x31 & new_n306_ & ~x30 & ~x35;
  assign new_n306_ = ~x28 & ~x26 & ~x25 & new_n307_ & ~x24 & x29;
  assign new_n307_ = ~x18 & ~x17 & ~x15 & new_n308_ & ~x14 & ~x22;
  assign new_n308_ = ~x10 & ~x09 & ~x08 & new_n309_ & ~x07 & ~x11;
  assign new_n309_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n311_ & ~x59;
  assign new_n311_ = ~x56 & ~x55 & ~x51 & new_n312_ & ~x50 & ~x58;
  assign new_n312_ = ~x46 & ~x43 & ~x42 & new_n313_ & ~x41 & ~x47;
  assign new_n313_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n294_ & x34;
  assign z46 = ~x62 & new_n315_ & ~x61;
  ...
  assign new_n320_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n285_ & x09;
  assign z47 = ~x62 & new_n322_ & ~x61;
  ...
  assign new_n326_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n284_ & x17;
  assign z48 = ~x62 & ~x61 & new_n328_ & ~x60;
  assign new_n328_ = ~x58 & ~x56 & ~x55 & new_n329_ & ~x54 & ~x59;
  assign new_n329_ = ~x51 & ~x50 & ~x47 & new_n330_ & ~x46 & ~x53;
  assign new_n330_ = ~x42 & ~x41 & ~x40 & new_n331_ & ~x39 & ~x43;
  assign new_n331_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n294_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n333_ & ~x59;
  assign new_n333_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n291_ & x53;
  ...
  assign new_n337_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n215_ & x35;
  ...
  assign new_n346_ = ~x21 & x20 & ~x18 & ~x17 & new_n234_ & ~x16;
  ...
  assign z61 = ~x60 & ~x58 & ~x56 & new_n353_ & ~x50;
  assign new_n353_ = ~x46 & ~x43 & ~x40 & new_n354_ & ~x39 & ~x47;
  assign new_n354_ = ~x37 & ~x30 & x29 & ~x28 & new_n355_ & ~x25;
  assign new_n355_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
