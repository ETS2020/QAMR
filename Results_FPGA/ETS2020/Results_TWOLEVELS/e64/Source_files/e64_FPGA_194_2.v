...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n258_, new_n259_, new_n260_, new_n261_, new_n265_, new_n267_,
    ...
    new_n340_, new_n341_, new_n344_, new_n345_, new_n347_, new_n348_,
  ...
  assign z22 = ~x64 & ~x63 & ~x62 & new_n232_ & ~x61;
  assign new_n232_ = ~x59 & ~x58 & ~x57 & new_n233_ & ~x56 & ~x60;
  assign new_n233_ = ~x54 & ~x53 & ~x51 & new_n234_ & ~x50 & ~x55;
  ...
  assign new_n238_ = ~x24 & ~x22 & ~x18 & new_n239_ & ~x17 & ~x25;
  assign new_n239_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z23 = ~x64 & new_n241_ & ~x63;
  assign new_n241_ = ~x61 & ~x60 & ~x59 & new_n242_ & ~x58 & ~x62;
  assign new_n242_ = ~x56 & ~x55 & ~x54 & new_n243_ & ~x53 & ~x57;
  assign new_n243_ = ~x51 & ~x50 & ~x49 & new_n244_ & ~x48 & ~x52;
  assign new_n244_ = ~x46 & ~x45 & ~x43 & new_n245_ & ~x42 & ~x47;
  assign new_n245_ = ~x40 & ~x39 & ~x37 & new_n246_ & ~x36 & ~x41;
  assign new_n246_ = ~x34 & ~x33 & ~x31 & new_n247_ & ~x30 & ~x35;
  assign new_n247_ = ~x28 & ~x26 & ~x25 & new_n248_ & ~x24 & x29;
  assign new_n248_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n239_ & x16;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n250_ & ~x46;
  assign new_n250_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n251_ & x29;
  assign new_n251_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n253_ & ~x46;
  assign new_n253_ = ~x43 & ~x40 & new_n202_ & ~x39;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n255_ & ~x60 & ~x64;
  assign new_n255_ = ~x58 & ~x57 & ~x56 & new_n256_ & ~x55 & ~x59;
  assign new_n256_ = ~x53 & ~x51 & ~x50 & new_n257_ & ~x49 & ~x54;
  assign new_n257_ = ~x47 & ~x46 & ~x45 & new_n258_ & ~x43 & ~x48;
  assign new_n258_ = ~x41 & ~x40 & ~x39 & new_n259_ & ~x37 & ~x42;
  assign new_n259_ = ~x35 & ~x34 & ~x33 & new_n260_ & ~x31 & ~x36;
  assign new_n260_ = ~x30 & x29 & ~x28 & ~x26 & new_n261_ & ~x25;
  assign new_n261_ = ~x24 & ~x22 & x21 & ~x18 & new_n239_ & ~x17;
  assign z32 = ~x58 & ~x50 & new_n253_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n202_ & x39;
  assign z34 = new_n265_ & x58;
  assign new_n265_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n267_ & ~x60;
  assign new_n267_ = ~x56 & ~x55 & ~x51 & new_n268_ & ~x50 & ~x58;
  assign new_n268_ = ~x46 & ~x43 & ~x41 & new_n269_ & ~x40 & ~x47;
  assign new_n269_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n270_ & x29;
  assign new_n270_ = ~x26 & ~x25 & ~x24 & new_n271_ & ~x22 & ~x28;
  assign new_n271_ = ~x15 & ~x14 & ~x11 & new_n272_ & ~x10 & ~x18;
  assign new_n272_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n274_ & ~x62;
  assign new_n274_ = ~x60 & ~x58 & ~x56 & new_n275_ & ~x55 & x61;
  assign new_n275_ = ~x50 & ~x47 & ~x46 & new_n276_ & ~x43 & ~x51;
  assign new_n276_ = ~x40 & ~x39 & ~x37 & new_n221_ & ~x35 & ~x41;
  ...
  assign new_n337_ = ~x42 & ~x41 & ~x40 & new_n338_ & ~x39;
  assign new_n338_ = ~x35 & ~x34 & ~x33 & new_n339_ & ~x31 & ~x37;
  assign new_n339_ = ~x30 & x29 & ~x28 & new_n340_ & ~x26;
  assign new_n340_ = ~x25 & ~x24 & ~x22 & new_n341_ & ~x18;
  assign new_n341_ = ~x17 & ~x15 & ~x14 & new_n161_ & ~x11;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n275_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n344_ & ~x56;
  assign new_n344_ = ~x50 & ~x47 & ~x46 & new_n345_ & ~x43 & ~x51;
  assign new_n345_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n221_ & x35;
  assign z56 = ~x64 & ~x63 & new_n347_ & ~x62;
  assign new_n347_ = ~x60 & ~x59 & ~x58 & new_n348_ & ~x57 & ~x61;
  assign new_n348_ = ~x55 & ~x54 & ~x53 & new_n349_ & ~x52 & ~x56;
  assign new_n349_ = ~x50 & ~x49 & ~x48 & new_n350_ & ~x47 & ~x51;
  assign new_n350_ = ~x45 & ~x43 & ~x42 & new_n351_ & ~x41 & ~x46;
  assign new_n351_ = ~x39 & ~x37 & ~x36 & new_n352_ & ~x35 & ~x40;
  assign new_n352_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n353_ & x29;
  assign new_n353_ = ~x26 & ~x25 & ~x24 & new_n354_ & ~x22 & ~x28;
  assign new_n354_ = ~x21 & x20 & ~x18 & ~x17 & new_n239_ & ~x16;
