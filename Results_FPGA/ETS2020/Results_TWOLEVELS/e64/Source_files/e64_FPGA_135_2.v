...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n353_, new_n354_, new_n357_, new_n358_, new_n359_, new_n361_,
  ...
  assign new_n236_ = ~x18 & new_n237_ & ~x17;
  ...
  assign new_n254_ = ~x43 & ~x40 & new_n199_ & ~x39;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n256_ & ~x61;
  ...
  assign new_n262_ = ~x25 & ~x24 & ~x22 & new_n236_ & ~x21 & ~x26;
  ...
  assign new_n270_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n236_ & x21;
  ...
  assign new_n285_ = ~x40 & ~x39 & ~x37 & new_n218_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n287_ & ~x60;
  assign new_n287_ = ~x58 & ~x56 & ~x55 & new_n288_ & ~x51 & x59;
  assign new_n288_ = ~x47 & ~x46 & ~x43 & new_n289_ & ~x42 & ~x50;
  assign new_n289_ = ~x41 & ~x40 & new_n290_ & ~x39;
  assign new_n290_ = ~x37 & ~x35 & ~x30 & x29 & new_n291_ & ~x28;
  assign new_n291_ = ~x25 & ~x24 & ~x22 & new_n292_ & ~x18 & ~x26;
  assign new_n292_ = ~x15 & ~x14 & ~x11 & new_n293_ & ~x10;
  assign new_n293_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n295_ & ~x61;
  assign new_n295_ = ~x58 & ~x56 & ~x55 & new_n296_ & ~x51 & ~x60;
  assign new_n296_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n289_ & x42;
  assign z40 = ~x62 & ~x61 & new_n298_ & ~x60;
  assign new_n298_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n299_ & x54;
  assign new_n299_ = ~x51 & ~x50 & new_n300_ & ~x47;
  assign new_n300_ = ~x43 & ~x42 & ~x41 & new_n301_ & ~x40 & ~x46;
  assign new_n301_ = ~x37 & ~x35 & ~x34 & new_n302_ & ~x33 & ~x39;
  assign new_n302_ = ~x30 & x29 & ~x28 & new_n303_ & ~x26;
  assign new_n303_ = ~x24 & ~x22 & ~x18 & new_n304_ & ~x17 & ~x25;
  assign new_n304_ = ~x14 & ~x11 & ~x10 & new_n293_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n306_ & ~x58 & ~x62;
  assign new_n306_ = ~x55 & ~x51 & ~x50 & new_n307_ & ~x47 & ~x56;
  assign new_n307_ = ~x43 & ~x42 & ~x41 & new_n308_ & ~x40 & ~x46;
  assign new_n308_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n302_ & x33;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n310_ & ~x58 & ~x62;
  assign new_n310_ = ~x55 & ~x54 & ~x53 & new_n311_ & ~x51 & ~x56;
  assign new_n311_ = ~x47 & ~x46 & ~x45 & new_n312_ & ~x43 & ~x50;
  assign new_n312_ = ~x41 & ~x40 & ~x39 & new_n313_ & ~x37 & ~x42;
  assign new_n313_ = ~x34 & ~x33 & ~x31 & new_n314_ & ~x30 & ~x35;
  assign new_n314_ = ~x28 & ~x26 & ~x25 & new_n315_ & ~x24 & x29;
  assign new_n315_ = ~x18 & ~x17 & ~x15 & new_n316_ & ~x14 & ~x22;
  assign new_n316_ = ~x10 & ~x09 & ~x08 & new_n317_ & ~x07 & ~x11;
  assign new_n317_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n319_ & ~x59;
  assign new_n319_ = ~x56 & ~x55 & ~x51 & new_n320_ & ~x50 & ~x58;
  assign new_n320_ = ~x46 & ~x43 & ~x42 & new_n321_ & ~x41 & ~x47;
  assign new_n321_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n302_ & x34;
  assign z46 = ~x62 & new_n323_ & ~x61;
  ...
  assign new_n328_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n293_ & x09;
  assign z47 = ~x62 & new_n330_ & ~x61;
  assign new_n330_ = ~x59 & ~x58 & ~x56 & new_n331_ & ~x55 & ~x60;
  ...
  assign new_n334_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n292_ & x17;
  assign z48 = ~x62 & ~x61 & new_n336_ & ~x60;
  assign new_n336_ = ~x58 & ~x56 & ~x55 & new_n337_ & ~x54 & ~x59;
  assign new_n337_ = ~x51 & ~x50 & ~x47 & new_n338_ & ~x46 & ~x53;
  assign new_n338_ = ~x42 & ~x41 & ~x40 & new_n339_ & ~x39 & ~x43;
  assign new_n339_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n302_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n341_ & ~x59;
  assign new_n341_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n299_ & x53;
  ...
  assign new_n345_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n218_ & x35;
  ...
  assign new_n354_ = ~x21 & x20 & ~x18 & ~x17 & new_n237_ & ~x16;
