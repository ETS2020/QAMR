...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n263_, new_n264_, new_n265_, new_n266_, new_n270_, new_n272_,
    ...
    new_n316_, new_n317_, new_n318_, new_n319_, new_n323_, new_n324_,
  ...
  assign z23 = ~x63 & ~x62 & new_n221_ & ~x61 & ~x64;
  assign new_n221_ = ~x60 & ~x58 & ~x57 & new_n222_ & ~x56 & ~x59;
  assign new_n222_ = ~x55 & ~x53 & ~x52 & new_n223_ & ~x51 & ~x54;
  assign new_n223_ = ~x50 & ~x48 & ~x47 & new_n224_ & ~x46 & ~x49;
  assign new_n224_ = ~x45 & ~x42 & ~x41 & new_n225_ & ~x40 & ~x43;
  assign new_n225_ = ~x39 & ~x36 & ~x35 & new_n226_ & ~x34 & ~x37;
  assign new_n226_ = ~x33 & ~x31 & ~x30 & x29 & new_n227_ & ~x28;
  assign new_n227_ = ~x26 & ~x24 & ~x22 & new_n228_ & ~x21 & ~x25;
  ...
  assign new_n255_ = ~x15 & ~x14 & x13 & new_n212_ & ~x12;
  assign z29 = ~x58 & ~x50 & new_n257_ & ~x46 & x60;
  assign new_n257_ = ~x43 & ~x40 & new_n193_ & ~x39;
  assign z30 = ~x64 & ~x63 & new_n259_ & ~x62;
  ...
  assign new_n266_ = ~x21 & ~x17 & ~x15 & new_n229_ & ~x14 & ~x18;
  ...
  assign new_n272_ = x61 & ~x58 & ~x56 & new_n273_ & ~x55 & ~x60;
  assign new_n273_ = ~x51 & ~x47 & ~x46 & new_n274_ & ~x43 & ~x50;
  assign new_n274_ = ~x41 & ~x39 & ~x37 & new_n216_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n276_ & ~x63;
  assign new_n276_ = ~x62 & ~x60 & ~x59 & new_n277_ & ~x58 & ~x61;
  assign new_n277_ = ~x57 & ~x55 & ~x54 & new_n278_ & ~x53 & ~x56;
  assign new_n278_ = ~x52 & ~x50 & ~x49 & new_n279_ & ~x48 & ~x51;
  assign new_n279_ = ~x47 & ~x45 & ~x43 & new_n280_ & ~x42 & ~x46;
  assign new_n280_ = ~x41 & ~x39 & ~x37 & new_n281_ & ~x36 & ~x40;
  assign new_n281_ = ~x35 & ~x33 & ~x32 & new_n282_ & ~x31 & ~x34;
  ...
  assign new_n286_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n207_ & x49;
  assign z43 = new_n288_ & ~x62;
  assign new_n288_ = ~x61 & ~x59 & ~x58 & new_n289_ & ~x56 & ~x60;
  assign new_n289_ = ~x55 & ~x53 & ~x51 & new_n290_ & ~x50 & ~x54;
  assign new_n290_ = ~x47 & ~x45 & ~x43 & new_n291_ & ~x42 & ~x46;
  assign new_n291_ = ~x41 & ~x39 & ~x37 & new_n292_ & ~x35 & ~x40;
  assign new_n292_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n293_ & x29;
  assign new_n293_ = ~x28 & ~x25 & ~x24 & new_n294_ & ~x22 & ~x26;
  assign new_n294_ = ~x18 & ~x15 & ~x14 & new_n295_ & ~x11 & ~x17;
  assign new_n295_ = ~x10 & ~x08 & ~x07 & new_n296_ & ~x06 & ~x09;
  assign new_n296_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n298_ & ~x58 & ~x61;
  assign new_n298_ = ~x56 & ~x54 & ~x53 & new_n299_ & ~x51 & ~x55;
  assign new_n299_ = ~x50 & ~x46 & ~x45 & new_n300_ & ~x43 & ~x47;
  assign new_n300_ = ~x42 & ~x40 & ~x39 & new_n301_ & ~x37 & ~x41;
  assign new_n301_ = ~x35 & ~x33 & ~x31 & new_n302_ & ~x30 & ~x34;
  assign new_n302_ = x29 & ~x26 & ~x25 & new_n303_ & ~x24 & ~x28;
  assign new_n303_ = ~x22 & ~x17 & ~x15 & new_n304_ & ~x14 & ~x18;
  assign new_n304_ = ~x11 & ~x09 & ~x08 & new_n305_ & ~x07 & ~x10;
  assign new_n305_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n307_ & ~x62;
  assign new_n307_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n205_ & x57;
  assign z51 = ~x62 & ~x61 & new_n309_ & ~x60;
  assign new_n309_ = ~x59 & ~x56 & ~x55 & new_n310_ & ~x54 & ~x58;
  assign new_n310_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n207_ & x48;
  assign z52 = new_n312_ & ~x64;
  assign new_n312_ = ~x63 & ~x61 & ~x60 & new_n313_ & ~x59 & ~x62;
  assign new_n313_ = ~x58 & ~x56 & ~x55 & new_n314_ & ~x54 & ~x57;
  assign new_n314_ = ~x53 & ~x50 & ~x49 & new_n315_ & ~x48 & ~x51;
  ...
  assign new_n319_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n212_ & x12;
  assign z53 = ~x64 & new_n203_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n273_ & x55;
  assign z55 = ~x60 & ~x58 & new_n323_ & ~x56 & ~x62;
  assign new_n323_ = ~x51 & ~x47 & ~x46 & new_n324_ & ~x43 & ~x50;
  assign new_n324_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n216_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n326_ & ~x60 & ~x63;
  assign new_n326_ = ~x59 & ~x57 & ~x56 & new_n327_ & ~x55 & ~x58;
  assign new_n327_ = ~x54 & ~x52 & ~x51 & new_n328_ & ~x50 & ~x53;
  assign new_n328_ = ~x49 & ~x47 & ~x46 & new_n329_ & ~x45 & ~x48;
  assign new_n329_ = ~x43 & ~x41 & ~x40 & new_n330_ & ~x39 & ~x42;
  assign new_n330_ = ~x37 & ~x35 & ~x34 & new_n331_ & ~x33 & ~x36;
  assign new_n331_ = ~x31 & ~x30 & x29 & ~x28 & new_n332_ & ~x26;
  assign new_n332_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n333_ & x20;
  assign new_n333_ = ~x18 & ~x16 & ~x15 & new_n229_ & ~x14 & ~x17;
