...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    new_n139_, new_n140_, new_n146_, new_n148_, new_n149_, new_n150_,
  ...
  assign z15 = ~x58 & new_n146_ & ~x43;
  assign new_n146_ = ~x37 & x29 & ~x28 & ~x15 & x10 & ~x14;
  assign z17 = ~x62 & new_n148_ & ~x60;
  assign new_n148_ = ~x56 & ~x50 & ~x47 & new_n149_ & ~x46 & ~x58;
  assign new_n149_ = ~x40 & ~x39 & ~x37 & new_n150_ & ~x30 & ~x43;
  assign new_n150_ = ~x28 & ~x25 & ~x24 & new_n151_ & ~x15 & x29;
  assign new_n151_ = ~x11 & ~x10 & ~x08 & x03 & ~x07 & ~x14;
  assign z19 = new_n153_ & x64;
  assign new_n153_ = ~x62 & ~x61 & ~x60 & new_n154_ & ~x59;
  assign new_n154_ = ~x57 & ~x56 & ~x55 & new_n155_ & ~x54 & ~x58;
  assign new_n155_ = ~x51 & ~x50 & ~x49 & new_n156_ & ~x48 & ~x53;
  assign new_n156_ = ~x47 & ~x46 & ~x45 & new_n157_ & ~x43;
  assign new_n157_ = ~x41 & ~x40 & ~x39 & new_n158_ & ~x37 & ~x42;
  assign new_n158_ = ~x34 & ~x33 & ~x31 & new_n159_ & ~x30 & ~x35;
  assign new_n159_ = ~x28 & ~x26 & ~x25 & new_n160_ & ~x24 & x29;
  assign new_n160_ = ~x18 & ~x17 & ~x15 & new_n161_ & ~x14 & ~x22;
  assign new_n161_ = new_n162_ & ~x11;
  assign new_n162_ = ~x09 & ~x08 & ~x07 & new_n163_ & ~x06 & ~x10;
  assign new_n163_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z21 = ~x62 & ~x60 & new_n165_ & ~x58;
  assign new_n165_ = ~x50 & ~x47 & ~x46 & new_n166_ & ~x43 & ~x56;
  assign new_n166_ = ~x40 & ~x39 & ~x37 & new_n167_ & ~x30 & ~x41;
  assign new_n167_ = ~x28 & ~x26 & ~x25 & new_n168_ & ~x24 & x29;
  assign new_n168_ = ~x18 & ~x15 & ~x14 & new_n169_ & ~x11 & ~x22;
  assign new_n169_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n171_ & ~x61;
  assign new_n171_ = ~x59 & ~x58 & ~x57 & new_n172_ & ~x56 & ~x60;
  assign new_n172_ = ~x54 & ~x53 & ~x51 & new_n173_ & ~x50 & ~x55;
  assign new_n173_ = ~x48 & ~x47 & ~x46 & new_n174_ & ~x45 & ~x49;
  assign new_n174_ = ~x42 & ~x41 & ~x40 & new_n175_ & ~x39 & ~x43;
  assign new_n175_ = ~x37 & x36 & ~x35 & ~x34 & new_n176_ & ~x33;
  assign new_n176_ = ~x31 & ~x30 & x29 & ~x28 & new_n177_ & ~x26;
  assign new_n177_ = ~x24 & ~x22 & ~x18 & new_n178_ & ~x17 & ~x25;
  assign new_n178_ = ~x15 & ~x14 & ~x12 & new_n162_ & ~x11;
  assign z23 = ~x64 & new_n180_ & ~x63;
  assign new_n180_ = ~x61 & ~x60 & ~x59 & new_n181_ & ~x58 & ~x62;
  assign new_n181_ = ~x56 & ~x55 & ~x54 & new_n182_ & ~x53 & ~x57;
  assign new_n182_ = ~x51 & ~x50 & ~x49 & new_n183_ & ~x48 & ~x52;
  assign new_n183_ = ~x46 & ~x45 & ~x43 & new_n184_ & ~x42 & ~x47;
  assign new_n184_ = ~x40 & ~x39 & ~x37 & new_n185_ & ~x36 & ~x41;
  assign new_n185_ = ~x34 & ~x33 & ~x31 & new_n186_ & ~x30 & ~x35;
  assign new_n186_ = ~x28 & ~x26 & ~x25 & new_n187_ & ~x24 & x29;
  assign new_n187_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n178_ & x16;
  ...
  assign z26 = ~x64 & ~x63 & ~x62 & new_n192_ & ~x61;
  ...
  assign new_n200_ = ~x14 & ~x13 & ~x12 & new_n162_ & ~x11 & ~x15;
  assign z27 = ~x64 & ~x63 & new_n202_ & ~x62;
  assign new_n202_ = ~x60 & ~x59 & ~x58 & new_n203_ & ~x57 & ~x61;
  assign new_n203_ = ~x55 & ~x54 & ~x53 & new_n204_ & ~x52 & ~x56;
  assign new_n204_ = ~x50 & ~x49 & ~x48 & new_n205_ & ~x47 & ~x51;
  assign new_n205_ = ~x45 & ~x43 & ~x42 & new_n206_ & ~x41 & ~x46;
  assign new_n206_ = ~x39 & ~x37 & ~x36 & new_n207_ & ~x35 & ~x40;
  assign new_n207_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n208_ & x29;
  assign new_n208_ = ~x26 & ~x25 & ~x24 & new_n209_ & ~x22 & ~x28;
  assign new_n209_ = ~x20 & ~x18 & ~x17 & new_n210_ & ~x16 & ~x21;
  assign new_n210_ = ~x15 & ~x14 & x13 & ~x12 & new_n162_ & ~x11;
  ...
  assign new_n222_ = ~x22 & ~x21 & ~x18 & new_n178_ & ~x17;
  ...
  assign new_n230_ = ~x24 & ~x22 & x21 & ~x18 & new_n178_ & ~x17;
  assign z34 = new_n232_ & x58;
  assign new_n232_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n234_ & ~x60;
  assign new_n234_ = ~x56 & ~x55 & ~x51 & new_n235_ & ~x50 & ~x58;
  assign new_n235_ = ~x46 & ~x43 & ~x41 & new_n236_ & ~x40 & ~x47;
  assign new_n236_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n237_ & x29;
  assign new_n237_ = ~x26 & ~x25 & ~x24 & new_n238_ & ~x22 & ~x28;
  assign new_n238_ = ~x15 & ~x14 & ~x11 & new_n239_ & ~x10 & ~x18;
  assign new_n239_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z37 = ~x63 & ~x62 & ~x61 & new_n241_ & ~x60 & ~x64;
  assign new_n241_ = ~x58 & ~x57 & ~x56 & new_n242_ & ~x55 & ~x59;
  assign new_n242_ = ~x53 & ~x52 & ~x51 & new_n243_ & ~x50 & ~x54;
  assign new_n243_ = ~x48 & ~x47 & ~x46 & new_n244_ & ~x45 & ~x49;
  assign new_n244_ = ~x42 & ~x41 & ~x40 & new_n245_ & ~x39 & ~x43;
  assign new_n245_ = ~x36 & ~x35 & ~x34 & new_n246_ & ~x33 & ~x37;
  assign new_n246_ = ~x32 & ~x31 & ~x30 & x29 & new_n247_ & ~x28;
  assign new_n247_ = ~x25 & ~x24 & ~x22 & new_n248_ & ~x21 & ~x26;
  assign new_n248_ = ~x20 & x19 & ~x18 & ~x17 & new_n200_ & ~x16;
  ...
  assign new_n274_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n156_ & x49;
  ...
  assign new_n320_ = ~x56 & ~x55 & new_n155_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n322_ & ~x60;
  assign new_n322_ = ~x58 & ~x56 & ~x55 & new_n323_ & ~x54 & ~x59;
  assign new_n323_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n156_ & x48;
  ...
  assign new_n332_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n161_ & x12;
  assign z53 = ~x64 & new_n153_ & x63;
  ...
  assign new_n338_ = ~x25 & ~x24 & ~x22 & new_n339_ & ~x18;
  ...
  assign new_n349_ = ~x21 & x20 & ~x18 & ~x17 & new_n178_ & ~x16;
