...
module FAU ( 
  ...
  assign new_n161_ = ~x55 & ~x54 & ~x53 & ~x51 & new_n162_ & ~x50;
  assign new_n162_ = ~x49 & ~x48 & ~x47 & ~x46 & new_n163_ & ~x45;
  assign new_n163_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n164_ & ~x39;
  assign new_n164_ = ~x37 & x36 & ~x35 & ~x34 & new_n165_ & ~x33;
  assign new_n165_ = ~x31 & ~x30 & x29 & ~x28 & new_n166_ & ~x26;
  assign new_n166_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n167_ & ~x17;
  assign new_n167_ = ~x15 & ~x14 & ~x12 & new_n151_ & ~x11;
  assign z23 = ~x64 & new_n169_ & ~x63;
  assign new_n169_ = ~x62 & ~x61 & ~x60 & ~x59 & new_n170_ & ~x58;
  assign new_n170_ = ~x57 & ~x56 & ~x55 & ~x54 & new_n171_ & ~x53;
  assign new_n171_ = ~x52 & ~x51 & ~x50 & ~x49 & new_n172_ & ~x48;
  assign new_n172_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n173_ & ~x42;
  assign new_n173_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n174_ & ~x36;
  assign new_n174_ = ~x35 & ~x34 & ~x33 & ~x31 & new_n175_ & ~x30;
  assign new_n175_ = x29 & ~x28 & ~x26 & ~x25 & new_n176_ & ~x24;
  assign new_n176_ = ~x22 & ~x21 & ~x18 & new_n167_ & x16 & ~x17;
  ...
  assign new_n189_ = ~x15 & ~x14 & ~x13 & ~x12 & new_n151_ & ~x11;
  ...
  assign new_n199_ = ~x15 & ~x14 & x13 & ~x12 & new_n151_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n201_ & ~x50;
  assign new_n201_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n202_ & ~x37;
  assign new_n202_ = x29 & new_n203_ & x25 & ~x28;
  assign new_n203_ = ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & ~x61 & new_n205_ & ~x60;
  assign new_n205_ = ~x59 & ~x58 & ~x57 & ~x56 & new_n206_ & ~x55;
  assign new_n206_ = ~x54 & ~x53 & x52 & ~x51 & new_n207_ & ~x50;
  assign new_n207_ = ~x49 & ~x48 & ~x47 & ~x46 & new_n208_ & ~x45;
  assign new_n208_ = ~x43 & ~x42 & ~x41 & new_n209_ & ~x40;
  assign new_n209_ = ~x39 & ~x37 & ~x36 & ~x35 & new_n210_ & ~x34;
  assign new_n210_ = ~x33 & ~x31 & new_n211_ & x29 & ~x30;
  assign new_n211_ = ~x28 & ~x26 & ~x25 & new_n212_ & ~x24;
  assign new_n212_ = ~x22 & ~x21 & ~x18 & new_n167_ & ~x17;
  assign z32 = ~x58 & ~x50 & x46 & ~x43 & new_n214_ & ~x40;
  assign new_n214_ = ~x39 & ~x37 & x29 & new_n203_ & ~x28;
  assign z35 = ~x62 & ~x61 & new_n216_ & ~x60;
  assign new_n216_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n217_ & ~x50;
  assign new_n217_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n218_ & ~x40;
  assign new_n218_ = ~x39 & ~x37 & ~x35 & new_n219_ & x29 & ~x30;
  ...
  assign new_n256_ = ~x54 & ~x53 & ~x51 & new_n145_ & x49 & ~x50;
  ...
  assign new_n270_ = ~x40 & ~x39 & ~x37 & new_n247_ & x34 & ~x35;
  ...
  assign new_n277_ = ~x15 & ~x14 & ~x11 & new_n238_ & x09 & ~x10;
  ...
  assign new_n283_ = ~x25 & ~x24 & ~x22 & new_n237_ & x17 & ~x18;
  ...
  assign new_n305_ = ~x18 & ~x17 & ~x15 & new_n150_ & x12 & ~x14;
  ...
  assign new_n315_ = ~x21 & x20 & ~x18 & ~x17 & new_n167_ & ~x16;
  ...
  assign z62 = ~x60 & ~x58 & ~x56 & new_n331_ & x47 & ~x50;
  ...
  assign new_n337_ = ~x43 & ~x40 & ~x39 & new_n333_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
