// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:32 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n291_, new_n295_, new_n297_, new_n298_, new_n299_, new_n300_,
    ...
    new_n374_, new_n376_, new_n378_, new_n379_, new_n381_, new_n382_,
  ...
  assign z26 = new_n252_ & ~x64;
  assign new_n252_ = ~x62 & ~x61 & ~x60 & new_n253_ & ~x59 & ~x63;
  assign new_n253_ = ~x57 & ~x56 & ~x55 & new_n254_ & ~x54 & ~x58;
  assign new_n254_ = ~x52 & ~x51 & ~x50 & new_n255_ & ~x49 & ~x53;
  assign new_n255_ = ~x47 & ~x46 & ~x45 & new_n256_ & ~x43 & ~x48;
  assign new_n256_ = ~x41 & ~x40 & ~x39 & new_n257_ & ~x37 & ~x42;
  assign new_n257_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n258_ & x32;
  assign new_n258_ = ~x31 & ~x30 & x29 & ~x28 & new_n259_ & ~x26;
  assign new_n259_ = ~x24 & ~x22 & ~x21 & new_n260_ & ~x20 & ~x25;
  assign new_n260_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n262_ & ~x62;
  assign new_n262_ = ~x60 & ~x59 & ~x58 & new_n263_ & ~x57 & ~x61;
  assign new_n263_ = ~x55 & ~x54 & ~x53 & new_n264_ & ~x52 & ~x56;
  assign new_n264_ = ~x50 & ~x49 & ~x48 & new_n265_ & ~x47 & ~x51;
  assign new_n265_ = ~x45 & ~x43 & ~x42 & new_n266_ & ~x41 & ~x46;
  assign new_n266_ = ~x39 & ~x37 & ~x36 & new_n267_ & ~x35 & ~x40;
  assign new_n267_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n268_ & x29;
  assign new_n268_ = ~x26 & ~x25 & ~x24 & new_n269_ & ~x22 & ~x28;
  assign new_n269_ = ~x21 & ~x20 & ~x18 & new_n270_ & ~x17;
  assign new_n270_ = ~x16 & ~x15 & ~x14 & x13 & new_n228_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n272_ & ~x50;
  assign new_n272_ = ~x43 & ~x40 & ~x39 & new_n273_ & ~x37 & ~x46;
  assign new_n273_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n275_ & ~x46;
  assign new_n275_ = ~x43 & ~x40 & new_n202_ & ~x39;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n277_ & ~x61;
  ...
  assign new_n283_ = ~x25 & ~x24 & ~x22 & new_n250_ & ~x21 & ~x26;
  ...
  assign new_n291_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n250_ & x21;
  assign z32 = ~x58 & ~x50 & new_n275_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n202_ & x39;
  assign z34 = new_n295_ & x58;
  assign new_n295_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n297_ & ~x60;
  assign new_n297_ = ~x56 & ~x55 & ~x51 & new_n298_ & ~x50 & ~x58;
  assign new_n298_ = ~x46 & ~x43 & ~x41 & new_n299_ & ~x40 & ~x47;
  assign new_n299_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n300_ & x29;
  assign new_n300_ = ~x26 & ~x25 & ~x24 & new_n301_ & ~x22 & ~x28;
  assign new_n301_ = ~x15 & ~x14 & ~x11 & new_n302_ & ~x10 & ~x18;
  assign new_n302_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n304_ & ~x62;
  assign new_n304_ = ~x60 & ~x58 & ~x56 & new_n305_ & ~x55 & x61;
  assign new_n305_ = ~x50 & ~x47 & ~x46 & new_n306_ & ~x43 & ~x51;
  assign new_n306_ = ~x40 & ~x39 & ~x37 & new_n232_ & ~x35 & ~x41;
  assign z37 = ~x64 & new_n308_ & ~x63;
  assign new_n308_ = ~x61 & ~x60 & ~x59 & new_n309_ & ~x58 & ~x62;
  assign new_n309_ = ~x56 & ~x55 & ~x54 & new_n310_ & ~x53 & ~x57;
  assign new_n310_ = ~x51 & ~x50 & ~x49 & new_n311_ & ~x48 & ~x52;
  assign new_n311_ = ~x46 & ~x45 & ~x43 & new_n312_ & ~x42 & ~x47;
  assign new_n312_ = ~x40 & ~x39 & ~x37 & new_n313_ & ~x36 & ~x41;
  assign new_n313_ = ~x34 & ~x33 & ~x32 & new_n314_ & ~x31 & ~x35;
  assign new_n314_ = ~x30 & x29 & ~x28 & ~x26 & new_n315_ & ~x25;
  assign new_n315_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n260_ & x19;
  assign z38 = ~x62 & ~x61 & new_n317_ & ~x60;
  assign new_n317_ = ~x58 & ~x56 & ~x55 & new_n318_ & ~x51 & x59;
  assign new_n318_ = ~x47 & ~x46 & ~x43 & new_n319_ & ~x42 & ~x50;
  assign new_n319_ = ~x41 & ~x40 & new_n320_ & ~x39;
  assign new_n320_ = ~x37 & ~x35 & ~x30 & x29 & new_n321_ & ~x28;
  assign new_n321_ = ~x25 & ~x24 & ~x22 & new_n322_ & ~x18 & ~x26;
  assign new_n322_ = ~x15 & ~x14 & ~x11 & new_n323_ & ~x10;
  assign new_n323_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n325_ & ~x61;
  assign new_n325_ = ~x58 & ~x56 & ~x55 & new_n326_ & ~x51 & ~x60;
  assign new_n326_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n319_ & x42;
  assign z40 = ~x62 & ~x61 & new_n328_ & ~x60;
  assign new_n328_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n329_ & x54;
  assign new_n329_ = ~x51 & ~x50 & new_n330_ & ~x47;
  assign new_n330_ = ~x43 & ~x42 & ~x41 & new_n331_ & ~x40 & ~x46;
  assign new_n331_ = ~x37 & ~x35 & ~x34 & new_n332_ & ~x33 & ~x39;
  assign new_n332_ = ~x30 & x29 & ~x28 & new_n333_ & ~x26;
  assign new_n333_ = ~x24 & ~x22 & ~x18 & new_n334_ & ~x17 & ~x25;
  assign new_n334_ = ~x14 & ~x11 & ~x10 & new_n323_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n336_ & ~x58 & ~x62;
  assign new_n336_ = ~x55 & ~x51 & ~x50 & new_n337_ & ~x47 & ~x56;
  assign new_n337_ = ~x43 & ~x42 & ~x41 & new_n338_ & ~x40 & ~x46;
  assign new_n338_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n332_ & x33;
  assign z42 = ~x62 & new_n340_ & ~x61;
  assign new_n340_ = ~x59 & ~x58 & ~x56 & new_n341_ & ~x55 & ~x60;
  assign new_n341_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n223_ & x49;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n343_ & ~x58 & ~x62;
  assign new_n343_ = ~x55 & ~x54 & ~x53 & new_n344_ & ~x51 & ~x56;
  assign new_n344_ = ~x47 & ~x46 & ~x45 & new_n345_ & ~x43 & ~x50;
  assign new_n345_ = ~x41 & ~x40 & ~x39 & new_n346_ & ~x37 & ~x42;
  assign new_n346_ = ~x34 & ~x33 & ~x31 & new_n347_ & ~x30 & ~x35;
  assign new_n347_ = ~x28 & ~x26 & ~x25 & new_n348_ & ~x24 & x29;
  assign new_n348_ = ~x18 & ~x17 & ~x15 & new_n349_ & ~x14 & ~x22;
  assign new_n349_ = ~x10 & ~x09 & ~x08 & new_n350_ & ~x07 & ~x11;
  assign new_n350_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n352_ & ~x59;
  assign new_n352_ = ~x56 & ~x55 & ~x51 & new_n353_ & ~x50 & ~x58;
  assign new_n353_ = ~x46 & ~x43 & ~x42 & new_n354_ & ~x41 & ~x47;
  assign new_n354_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n332_ & x34;
  assign z46 = ~x62 & new_n356_ & ~x61;
  assign new_n356_ = ~x59 & ~x58 & ~x56 & new_n357_ & ~x55 & ~x60;
  assign new_n357_ = ~x50 & ~x47 & ~x46 & new_n358_ & ~x43 & ~x51;
  assign new_n358_ = ~x41 & ~x40 & ~x39 & new_n359_ & ~x37 & ~x42;
  assign new_n359_ = ~x35 & ~x30 & x29 & ~x28 & new_n360_ & ~x26;
  assign new_n360_ = ~x24 & ~x22 & ~x18 & new_n361_ & ~x17 & ~x25;
  assign new_n361_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n323_ & x09;
  assign z47 = ~x62 & new_n363_ & ~x61;
  ...
  assign new_n367_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n322_ & x17;
  assign z48 = ~x62 & ~x61 & new_n369_ & ~x60;
  assign new_n369_ = ~x58 & ~x56 & ~x55 & new_n370_ & ~x54 & ~x59;
  assign new_n370_ = ~x51 & ~x50 & ~x47 & new_n371_ & ~x46 & ~x53;
  assign new_n371_ = ~x42 & ~x41 & ~x40 & new_n372_ & ~x39 & ~x43;
  assign new_n372_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n332_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n374_ & ~x59;
  assign new_n374_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n329_ & x53;
  assign z50 = new_n376_ & ~x62;
  assign new_n376_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n221_ & x57;
  assign z51 = ~x62 & ~x61 & new_n378_ & ~x60;
  assign new_n378_ = ~x58 & ~x56 & ~x55 & new_n379_ & ~x54 & ~x59;
  assign new_n379_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n223_ & x48;
  assign z52 = new_n381_ & ~x64;
  assign new_n381_ = ~x62 & ~x61 & ~x60 & new_n382_ & ~x59 & ~x63;
  assign new_n382_ = ~x57 & ~x56 & ~x55 & new_n383_ & ~x54 & ~x58;
  assign new_n383_ = ~x51 & ~x50 & ~x49 & new_n384_ & ~x48 & ~x53;
  ...
  assign new_n388_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n228_ & x12;
  assign z53 = ~x64 & new_n219_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n305_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n392_ & ~x56;
  assign new_n392_ = ~x50 & ~x47 & ~x46 & new_n393_ & ~x43 & ~x51;
  assign new_n393_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n232_ & x35;
