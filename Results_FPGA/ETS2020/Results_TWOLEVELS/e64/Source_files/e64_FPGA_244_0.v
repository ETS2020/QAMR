...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n285_, new_n289_, new_n291_, new_n292_, new_n293_, new_n294_,
    ...
    new_n345_, new_n349_, new_n350_, new_n352_, new_n353_, new_n354_,
    new_n355_, new_n356_, new_n357_, new_n358_, new_n359_, new_n361_,
    new_n362_, new_n363_, new_n364_, new_n365_, new_n367_, new_n368_,
    new_n369_, new_n372_, new_n373_, new_n374_, new_n376_, new_n377_,
    new_n378_;
  ...
  assign new_n292_ = ~x47 & ~x43 & ~x41 & new_n293_ & ~x40 & ~x46;
  assign new_n293_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n294_ & x29;
  assign new_n294_ = ~x28 & ~x25 & ~x24 & new_n295_ & ~x22 & ~x26;
  assign new_n295_ = ~x18 & ~x14 & ~x11 & new_n296_ & ~x10 & ~x15;
  assign new_n296_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n298_ & ~x62;
  assign new_n298_ = x61 & ~x58 & ~x56 & new_n299_ & ~x55 & ~x60;
  assign new_n299_ = ~x51 & ~x47 & ~x46 & new_n300_ & ~x43 & ~x50;
  assign new_n300_ = ~x41 & ~x39 & ~x37 & new_n218_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n302_ & ~x63;
  assign new_n302_ = ~x62 & ~x60 & ~x59 & new_n303_ & ~x58 & ~x61;
  assign new_n303_ = ~x57 & ~x55 & ~x54 & new_n304_ & ~x53 & ~x56;
  assign new_n304_ = ~x52 & ~x50 & ~x49 & new_n305_ & ~x48 & ~x51;
  assign new_n305_ = ~x47 & ~x45 & ~x43 & new_n306_ & ~x42 & ~x46;
  assign new_n306_ = ~x41 & ~x39 & ~x37 & new_n307_ & ~x36 & ~x40;
  assign new_n307_ = ~x35 & ~x33 & ~x32 & new_n308_ & ~x31 & ~x34;
  assign new_n308_ = ~x30 & ~x28 & ~x26 & new_n309_ & ~x25 & x29;
  assign new_n309_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n262_ & x19;
  assign z42 = ~x62 & new_n311_ & ~x61;
  assign new_n311_ = ~x60 & ~x58 & ~x56 & new_n312_ & ~x55 & ~x59;
  assign new_n312_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n209_ & x49;
  assign z43 = new_n314_ & ~x62;
  assign new_n314_ = ~x61 & ~x59 & ~x58 & new_n315_ & ~x56 & ~x60;
  assign new_n315_ = ~x55 & ~x53 & ~x51 & new_n316_ & ~x50 & ~x54;
  ...
  assign new_n320_ = ~x18 & ~x15 & ~x14 & new_n321_ & ~x11 & ~x17;
  assign new_n321_ = ~x10 & ~x08 & ~x07 & new_n322_ & ~x06 & ~x09;
  assign new_n322_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n324_ & ~x58 & ~x61;
  assign new_n324_ = ~x56 & ~x54 & ~x53 & new_n325_ & ~x51 & ~x55;
  assign new_n325_ = ~x50 & ~x46 & ~x45 & new_n326_ & ~x43 & ~x47;
  assign new_n326_ = ~x42 & ~x40 & ~x39 & new_n327_ & ~x37 & ~x41;
  assign new_n327_ = ~x35 & ~x33 & ~x31 & new_n328_ & ~x30 & ~x34;
  assign new_n328_ = x29 & ~x26 & ~x25 & new_n329_ & ~x24 & ~x28;
  assign new_n329_ = ~x22 & ~x17 & ~x15 & new_n330_ & ~x14 & ~x18;
  assign new_n330_ = ~x11 & ~x09 & ~x08 & new_n331_ & ~x07 & ~x10;
  assign new_n331_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n333_ & ~x62;
  assign new_n333_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n207_ & x57;
  assign z51 = ~x62 & ~x61 & new_n335_ & ~x60;
  assign new_n335_ = ~x59 & ~x56 & ~x55 & new_n336_ & ~x54 & ~x58;
  assign new_n336_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n209_ & x48;
  assign z52 = new_n338_ & ~x64;
  assign new_n338_ = ~x63 & ~x61 & ~x60 & new_n339_ & ~x59 & ~x62;
  assign new_n339_ = ~x58 & ~x56 & ~x55 & new_n340_ & ~x54 & ~x57;
  assign new_n340_ = ~x53 & ~x50 & ~x49 & new_n341_ & ~x48 & ~x51;
  assign new_n341_ = ~x47 & ~x45 & ~x43 & new_n342_ & ~x42 & ~x46;
  assign new_n342_ = ~x41 & ~x39 & ~x37 & new_n343_ & ~x35 & ~x40;
  assign new_n343_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n344_ & x29;
  assign new_n344_ = ~x28 & ~x25 & ~x24 & new_n345_ & ~x22 & ~x26;
  assign new_n345_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n214_ & x12;
  assign z53 = ~x64 & new_n205_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n299_ & x55;
  assign z55 = ~x60 & ~x58 & new_n349_ & ~x56 & ~x62;
  assign new_n349_ = ~x51 & ~x47 & ~x46 & new_n350_ & ~x43 & ~x50;
  assign new_n350_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n218_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n352_ & ~x60 & ~x63;
  assign new_n352_ = ~x59 & ~x57 & ~x56 & new_n353_ & ~x55 & ~x58;
  assign new_n353_ = ~x54 & ~x52 & ~x51 & new_n354_ & ~x50 & ~x53;
  assign new_n354_ = ~x49 & ~x47 & ~x46 & new_n355_ & ~x45 & ~x48;
  assign new_n355_ = ~x43 & ~x41 & ~x40 & new_n356_ & ~x39 & ~x42;
  assign new_n356_ = ~x37 & ~x35 & ~x34 & new_n357_ & ~x33 & ~x36;
  assign new_n357_ = ~x31 & ~x30 & x29 & ~x28 & new_n358_ & ~x26;
  assign new_n358_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n359_ & x20;
  assign new_n359_ = ~x18 & ~x16 & ~x15 & new_n237_ & ~x14 & ~x17;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n361_ & ~x50 & ~x60;
  assign new_n361_ = ~x47 & ~x43 & ~x41 & new_n362_ & ~x40 & ~x46;
  assign new_n362_ = ~x39 & ~x37 & ~x30 & x29 & new_n363_ & ~x28;
  assign new_n363_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n364_ & x18;
  assign new_n364_ = ~x15 & new_n365_ & ~x14;
  assign new_n365_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x60 & ~x58 & new_n367_ & ~x56 & ~x62;
  assign new_n367_ = ~x50 & ~x46 & ~x43 & new_n368_ & ~x41 & ~x47;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n372_ & ~x47 & ~x58;
  assign new_n372_ = ~x46 & ~x40 & ~x39 & new_n373_ & ~x37 & ~x43;
  assign new_n373_ = ~x30 & ~x28 & ~x25 & new_n374_ & ~x24 & x29;
  assign new_n374_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n376_ & ~x50 & ~x60;
  assign new_n376_ = ~x47 & ~x43 & ~x40 & new_n377_ & ~x39 & ~x46;
  assign new_n377_ = ~x37 & ~x30 & x29 & ~x28 & new_n378_ & ~x25;
  assign new_n378_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z00 = 1'b0;
  assign z10 = 1'b0;
  assign z17 = 1'b0;
  assign z31 = 1'b0;
