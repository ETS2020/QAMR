...
module FAU ( 
  ...
  assign z12 = ~x60 & ~x58 & ~x56 & new_n181_ & ~x50 & ~x62;
  assign new_n181_ = ~x46 & ~x43 & ~x41 & new_n182_ & ~x40 & ~x47;
  assign new_n182_ = ~x39 & ~x37 & ~x30 & x29 & new_n183_ & ~x28;
  assign new_n183_ = ~x25 & ~x24 & ~x15 & new_n184_ & ~x14 & ~x26;
  assign new_n184_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & x06;
  assign z13 = new_n186_ & ~x62;
  assign new_n186_ = ~x58 & ~x56 & ~x50 & new_n187_ & ~x47 & ~x60;
  ...
  assign new_n195_ = ~x37 & ~x30 & x29 & ~x28 & new_n189_ & x26;
  ...
  assign z23 = ~x64 & new_n220_ & ~x63;
  assign new_n220_ = ~x61 & ~x60 & ~x59 & new_n221_ & ~x58 & ~x62;
  assign new_n221_ = ~x56 & ~x55 & ~x54 & new_n222_ & ~x53 & ~x57;
  assign new_n222_ = ~x51 & ~x50 & ~x49 & new_n223_ & ~x48 & ~x52;
  assign new_n223_ = ~x46 & ~x45 & ~x43 & new_n224_ & ~x42 & ~x47;
  assign new_n224_ = ~x40 & ~x39 & ~x37 & new_n225_ & ~x36 & ~x41;
  assign new_n225_ = ~x34 & ~x33 & ~x31 & new_n226_ & ~x30 & ~x35;
  assign new_n226_ = ~x28 & ~x26 & ~x25 & new_n227_ & ~x24 & x29;
  assign new_n227_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n228_ & x16;
  assign new_n228_ = ~x15 & ~x14 & ~x12 & new_n152_ & ~x11;
  ...
  assign new_n236_ = ~x43 & ~x40 & new_n192_ & ~x39;
  ...
  assign new_n244_ = ~x24 & ~x22 & x21 & ~x18 & new_n228_ & ~x17;
  ...
  assign new_n259_ = ~x40 & ~x39 & ~x37 & new_n209_ & ~x35 & ~x41;
  ...
  assign z45 = ~x62 & ~x61 & ~x60 & new_n294_ & ~x59;
  assign new_n294_ = ~x56 & ~x55 & ~x51 & new_n295_ & ~x50 & ~x58;
  assign new_n295_ = ~x46 & ~x43 & ~x42 & new_n296_ & ~x41 & ~x47;
  assign new_n296_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n276_ & x34;
  assign z46 = ~x62 & new_n298_ & ~x61;
  ...
  assign new_n303_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n267_ & x09;
  assign z47 = ~x62 & new_n305_ & ~x61;
  ...
  assign new_n309_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n266_ & x17;
  assign z48 = ~x62 & ~x61 & new_n311_ & ~x60;
  assign new_n311_ = ~x58 & ~x56 & ~x55 & new_n312_ & ~x54 & ~x59;
  assign new_n312_ = ~x51 & ~x50 & ~x47 & new_n313_ & ~x46 & ~x53;
  assign new_n313_ = ~x42 & ~x41 & ~x40 & new_n314_ & ~x39 & ~x43;
  assign new_n314_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n276_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n316_ & ~x59;
  assign new_n316_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n273_ & x53;
  ...
  assign new_n320_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n209_ & x35;
  ...
  assign new_n329_ = ~x21 & x20 & ~x18 & ~x17 & new_n228_ & ~x16;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n192_ & x40;
  assign z60 = ~x58 & ~x56 & ~x50 & new_n332_ & ~x47 & ~x60;
  assign new_n332_ = ~x43 & ~x40 & ~x39 & new_n333_ & ~x37 & ~x46;
  assign new_n333_ = ~x30 & x29 & ~x28 & ~x25 & new_n334_ & ~x24;
  assign new_n334_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
