...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n352_, new_n355_, new_n356_, new_n358_, new_n359_, new_n360_,
  ...
  assign new_n237_ = ~x18 & new_n238_ & ~x17;
  assign new_n238_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z23 = ~x64 & new_n240_ & ~x63;
  assign new_n240_ = ~x61 & ~x60 & ~x59 & new_n241_ & ~x58 & ~x62;
  assign new_n241_ = ~x56 & ~x55 & ~x54 & new_n242_ & ~x53 & ~x57;
  assign new_n242_ = ~x51 & ~x50 & ~x49 & new_n243_ & ~x48 & ~x52;
  assign new_n243_ = ~x46 & ~x45 & ~x43 & new_n244_ & ~x42 & ~x47;
  assign new_n244_ = ~x40 & ~x39 & ~x37 & new_n245_ & ~x36 & ~x41;
  assign new_n245_ = ~x34 & ~x33 & ~x31 & new_n246_ & ~x30 & ~x35;
  assign new_n246_ = ~x28 & ~x26 & ~x25 & new_n247_ & ~x24 & x29;
  assign new_n247_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n238_ & x16;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n249_ & ~x46;
  assign new_n249_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n250_ & x29;
  assign new_n250_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  ...
  assign new_n255_ = ~x43 & ~x40 & new_n200_ & ~x39;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n257_ & ~x61;
  assign new_n257_ = ~x59 & ~x58 & ~x57 & new_n258_ & ~x56 & ~x60;
  assign new_n258_ = ~x55 & ~x54 & ~x53 & x52 & new_n259_ & ~x51;
  ...
  assign new_n263_ = ~x25 & ~x24 & ~x22 & new_n237_ & ~x21 & ~x26;
  assign z31 = ~x64 & ~x63 & new_n265_ & ~x62;
  assign new_n265_ = ~x60 & ~x59 & ~x58 & new_n266_ & ~x57 & ~x61;
  assign new_n266_ = ~x55 & ~x54 & ~x53 & new_n267_ & ~x51 & ~x56;
  ...
  assign new_n271_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n237_ & x21;
  ...
  assign z35 = ~x62 & ~x61 & new_n277_ & ~x60;
  assign new_n277_ = ~x56 & ~x55 & ~x51 & new_n278_ & ~x50 & ~x58;
  assign new_n278_ = ~x46 & ~x43 & ~x41 & new_n279_ & ~x40 & ~x47;
  assign new_n279_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n280_ & x29;
  assign new_n280_ = ~x26 & ~x25 & ~x24 & new_n281_ & ~x22 & ~x28;
  assign new_n281_ = ~x15 & ~x14 & ~x11 & new_n282_ & ~x10 & ~x18;
  assign new_n282_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n284_ & ~x62;
  assign new_n284_ = ~x60 & ~x58 & ~x56 & new_n285_ & ~x55 & x61;
  assign new_n285_ = ~x50 & ~x47 & ~x46 & new_n286_ & ~x43 & ~x51;
  assign new_n286_ = ~x40 & ~x39 & ~x37 & new_n219_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n288_ & ~x60;
  assign new_n288_ = ~x58 & ~x56 & ~x55 & new_n289_ & ~x51 & x59;
  assign new_n289_ = ~x47 & ~x46 & ~x43 & new_n290_ & ~x42 & ~x50;
  assign new_n290_ = ~x41 & ~x40 & new_n291_ & ~x39;
  assign new_n291_ = ~x37 & ~x35 & ~x30 & x29 & new_n292_ & ~x28;
  assign new_n292_ = ~x25 & ~x24 & ~x22 & new_n293_ & ~x18 & ~x26;
  assign new_n293_ = ~x15 & ~x14 & ~x11 & new_n294_ & ~x10;
  assign new_n294_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n296_ & ~x61;
  assign new_n296_ = ~x58 & ~x56 & ~x55 & new_n297_ & ~x51 & ~x60;
  assign new_n297_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n290_ & x42;
  assign z40 = ~x62 & ~x61 & new_n299_ & ~x60;
  assign new_n299_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n300_ & x54;
  assign new_n300_ = ~x51 & ~x50 & new_n301_ & ~x47;
  assign new_n301_ = ~x43 & ~x42 & ~x41 & new_n302_ & ~x40 & ~x46;
  assign new_n302_ = ~x37 & ~x35 & ~x34 & new_n303_ & ~x33 & ~x39;
  assign new_n303_ = ~x30 & x29 & ~x28 & new_n304_ & ~x26;
  assign new_n304_ = ~x24 & ~x22 & ~x18 & new_n305_ & ~x17 & ~x25;
  assign new_n305_ = ~x14 & ~x11 & ~x10 & new_n294_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n307_ & ~x58 & ~x62;
  assign new_n307_ = ~x55 & ~x51 & ~x50 & new_n308_ & ~x47 & ~x56;
  assign new_n308_ = ~x43 & ~x42 & ~x41 & new_n309_ & ~x40 & ~x46;
  assign new_n309_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n303_ & x33;
  assign z43 = new_n311_ & ~x62;
  assign new_n311_ = ~x60 & ~x59 & ~x58 & new_n312_ & ~x56 & ~x61;
  assign new_n312_ = ~x54 & ~x53 & ~x51 & new_n313_ & ~x50 & ~x55;
  ...
  assign new_n317_ = ~x17 & ~x15 & ~x14 & new_n318_ & ~x11 & ~x18;
  assign new_n318_ = ~x09 & ~x08 & ~x07 & new_n319_ & ~x06 & ~x10;
  assign new_n319_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n321_ & ~x58 & ~x62;
  assign new_n321_ = ~x55 & ~x54 & ~x53 & new_n322_ & ~x51 & ~x56;
  assign new_n322_ = ~x47 & ~x46 & ~x45 & new_n323_ & ~x43 & ~x50;
  assign new_n323_ = ~x41 & ~x40 & ~x39 & new_n324_ & ~x37 & ~x42;
  assign new_n324_ = ~x34 & ~x33 & ~x31 & new_n325_ & ~x30 & ~x35;
  assign new_n325_ = ~x28 & ~x26 & ~x25 & new_n326_ & ~x24 & x29;
  assign new_n326_ = ~x18 & ~x17 & ~x15 & new_n327_ & ~x14 & ~x22;
  assign new_n327_ = ~x10 & ~x09 & ~x08 & new_n328_ & ~x07 & ~x11;
  ...
  assign new_n331_ = ~x46 & ~x43 & ~x42 & new_n332_ & ~x41 & ~x47;
  assign new_n332_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n303_ & x34;
  assign z46 = ~x62 & new_n334_ & ~x61;
