...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n351_, new_n353_, new_n356_, new_n357_, new_n359_, new_n360_,
  ...
  assign new_n168_ = x38 & new_n156_ & ~x37;
  ...
  assign new_n177_ = ~x22 & new_n159_ & ~x21;
  ...
  assign z15 = ~x58 & new_n189_ & ~x43;
  assign new_n189_ = ~x37 & x29 & ~x28 & ~x15 & x10 & ~x14;
  assign z16 = ~x60 & ~x58 & ~x56 & new_n191_ & ~x50 & ~x62;
  assign new_n191_ = ~x46 & ~x43 & ~x40 & new_n192_ & ~x39 & ~x47;
  assign new_n192_ = ~x37 & ~x30 & x29 & ~x28 & new_n184_ & x26;
  assign z17 = ~x62 & new_n194_ & ~x60;
  assign new_n194_ = ~x56 & ~x50 & ~x47 & new_n195_ & ~x46 & ~x58;
  assign new_n195_ = ~x40 & ~x39 & ~x37 & new_n196_ & ~x30 & ~x43;
  assign new_n196_ = ~x28 & ~x25 & ~x24 & new_n197_ & ~x15 & x29;
  assign new_n197_ = ~x11 & ~x10 & ~x08 & x03 & ~x07 & ~x14;
  ...
  assign z20 = ~x62 & ~x60 & new_n204_ & ~x58;
  assign new_n204_ = ~x56 & x51 & ~x50 & ~x47 & new_n205_ & ~x46;
  assign new_n205_ = ~x41 & ~x40 & ~x39 & new_n206_ & ~x37 & ~x43;
  assign new_n206_ = ~x30 & x29 & new_n207_ & ~x28;
  assign new_n207_ = ~x25 & ~x24 & ~x22 & new_n208_ & ~x18 & ~x26;
  assign new_n208_ = ~x15 & ~x14 & ~x11 & new_n209_ & ~x10;
  assign new_n209_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  ...
  assign new_n221_ = ~x40 & ~x39 & ~x37 & x36 & new_n222_ & ~x35;
  ...
  assign new_n225_ = ~x15 & new_n226_ & ~x14;
  assign new_n226_ = ~x12 & new_n161_ & ~x11;
  ...
  assign new_n235_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n225_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n237_ & ~x43 & ~x60;
  ...
  assign new_n250_ = ~x22 & ~x21 & ~x20 & new_n251_ & ~x18 & ~x24;
  assign new_n251_ = ~x17 & ~x16 & ~x15 & ~x14 & new_n226_ & x13;
  ...
  assign new_n256_ = ~x43 & ~x40 & new_n187_ & ~x39;
  ...
  assign new_n264_ = ~x25 & ~x24 & ~x22 & new_n224_ & ~x21 & ~x26;
  ...
  assign new_n272_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n224_ & x21;
  ...
  assign new_n287_ = ~x40 & ~x39 & ~x37 & new_n206_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n289_ & ~x60;
  assign new_n289_ = ~x58 & ~x56 & ~x55 & new_n290_ & ~x51 & x59;
  assign new_n290_ = ~x47 & ~x46 & ~x43 & new_n291_ & ~x42 & ~x50;
  assign new_n291_ = ~x41 & ~x40 & new_n292_ & ~x39;
  assign new_n292_ = ~x37 & ~x35 & ~x30 & x29 & new_n293_ & ~x28;
  assign new_n293_ = ~x25 & ~x24 & ~x22 & new_n294_ & ~x18 & ~x26;
  assign new_n294_ = ~x15 & ~x14 & ~x11 & new_n295_ & ~x10;
  assign new_n295_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n297_ & ~x61;
  assign new_n297_ = ~x58 & ~x56 & ~x55 & new_n298_ & ~x51 & ~x60;
  assign new_n298_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n291_ & x42;
  assign z40 = ~x62 & ~x61 & new_n300_ & ~x60;
  assign new_n300_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n301_ & x54;
  assign new_n301_ = ~x51 & ~x50 & new_n302_ & ~x47;
  assign new_n302_ = ~x43 & ~x42 & ~x41 & new_n303_ & ~x40 & ~x46;
  assign new_n303_ = ~x37 & ~x35 & ~x34 & new_n304_ & ~x33 & ~x39;
  assign new_n304_ = ~x30 & x29 & ~x28 & new_n305_ & ~x26;
  assign new_n305_ = ~x24 & ~x22 & ~x18 & new_n306_ & ~x17 & ~x25;
  assign new_n306_ = ~x14 & ~x11 & ~x10 & new_n295_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n308_ & ~x58 & ~x62;
  assign new_n308_ = ~x55 & ~x51 & ~x50 & new_n309_ & ~x47 & ~x56;
  assign new_n309_ = ~x43 & ~x42 & ~x41 & new_n310_ & ~x40 & ~x46;
  assign new_n310_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n304_ & x33;
  ...
  assign z44 = ~x61 & ~x60 & ~x59 & new_n322_ & ~x58 & ~x62;
  assign new_n322_ = ~x55 & ~x54 & ~x53 & new_n323_ & ~x51 & ~x56;
  assign new_n323_ = ~x47 & ~x46 & ~x45 & new_n324_ & ~x43 & ~x50;
  assign new_n324_ = ~x41 & ~x40 & ~x39 & new_n325_ & ~x37 & ~x42;
  assign new_n325_ = ~x34 & ~x33 & ~x31 & new_n326_ & ~x30 & ~x35;
  assign new_n326_ = ~x28 & ~x26 & ~x25 & new_n327_ & ~x24 & x29;
  assign new_n327_ = ~x18 & ~x17 & ~x15 & new_n328_ & ~x14 & ~x22;
  assign new_n328_ = ~x10 & ~x09 & ~x08 & new_n329_ & ~x07 & ~x11;
  assign new_n329_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n331_ & ~x59;
  assign new_n331_ = ~x56 & ~x55 & ~x51 & new_n332_ & ~x50 & ~x58;
  assign new_n332_ = ~x46 & ~x43 & ~x42 & new_n333_ & ~x41 & ~x47;
  assign new_n333_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n304_ & x34;
  assign z46 = ~x62 & new_n335_ & ~x61;
  ...
  assign new_n338_ = ~x35 & ~x30 & x29 & ~x28 & new_n339_ & ~x26;
  assign new_n339_ = ~x24 & ~x22 & ~x18 & new_n340_ & ~x17 & ~x25;
  assign new_n340_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n295_ & x09;
  assign z47 = ~x62 & new_n342_ & ~x61;
  assign new_n342_ = ~x59 & ~x58 & ~x56 & new_n343_ & ~x55 & ~x60;
  assign new_n343_ = ~x50 & ~x47 & ~x46 & new_n344_ & ~x43 & ~x51;
  assign new_n344_ = ~x41 & ~x40 & ~x39 & new_n345_ & ~x37 & ~x42;
  assign new_n345_ = ~x35 & ~x30 & x29 & ~x28 & new_n346_ & ~x26;
  assign new_n346_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n294_ & x17;
  assign z48 = ~x62 & ~x61 & new_n348_ & ~x60;
  assign new_n348_ = ~x58 & ~x56 & ~x55 & new_n349_ & ~x54 & ~x59;
  assign new_n349_ = ~x51 & ~x50 & ~x47 & new_n350_ & ~x46 & ~x53;
  assign new_n350_ = ~x42 & ~x41 & ~x40 & new_n351_ & ~x39 & ~x43;
  assign new_n351_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n304_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n353_ & ~x59;
  assign new_n353_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n301_ & x53;
  ...
  assign new_n357_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n206_ & x35;
  assign z56 = ~x64 & ~x63 & new_n359_ & ~x62;
  assign new_n359_ = ~x60 & ~x59 & ~x58 & new_n360_ & ~x57 & ~x61;
  assign new_n360_ = ~x55 & ~x54 & ~x53 & new_n361_ & ~x52 & ~x56;
  assign new_n361_ = ~x50 & ~x49 & ~x48 & new_n362_ & ~x47 & ~x51;
  assign new_n362_ = ~x45 & ~x43 & ~x42 & new_n363_ & ~x41 & ~x46;
  assign new_n363_ = ~x39 & ~x37 & ~x36 & new_n364_ & ~x35 & ~x40;
  assign new_n364_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n365_ & x29;
  assign new_n365_ = ~x26 & ~x25 & ~x24 & new_n366_ & ~x22 & ~x28;
  assign new_n366_ = ~x21 & x20 & ~x18 & ~x17 & new_n225_ & ~x16;
