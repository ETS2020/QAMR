...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n347_, new_n348_, new_n350_, new_n351_, new_n352_;
  ...
  assign new_n260_ = ~x43 & ~x40 & new_n193_ & ~x39;
  ...
  assign new_n269_ = ~x21 & ~x17 & ~x15 & new_n229_ & ~x14 & ~x18;
  assign z32 = ~x58 & ~x50 & new_n260_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n193_ & x39;
  assign z36 = new_n273_ & ~x62;
  assign new_n273_ = x61 & ~x58 & ~x56 & new_n274_ & ~x55 & ~x60;
  assign new_n274_ = ~x51 & ~x47 & ~x46 & new_n275_ & ~x43 & ~x50;
  assign new_n275_ = ~x41 & ~x39 & ~x37 & new_n216_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n277_ & ~x63;
  assign new_n277_ = ~x62 & ~x60 & ~x59 & new_n278_ & ~x58 & ~x61;
  assign new_n278_ = ~x57 & ~x55 & ~x54 & new_n279_ & ~x53 & ~x56;
  assign new_n279_ = ~x52 & ~x50 & ~x49 & new_n280_ & ~x48 & ~x51;
  assign new_n280_ = ~x47 & ~x45 & ~x43 & new_n281_ & ~x42 & ~x46;
  assign new_n281_ = ~x41 & ~x39 & ~x37 & new_n282_ & ~x36 & ~x40;
  assign new_n282_ = ~x35 & ~x33 & ~x32 & new_n283_ & ~x31 & ~x34;
  assign new_n283_ = ~x30 & ~x28 & ~x26 & new_n284_ & ~x25 & x29;
  assign new_n284_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n245_ & x19;
  assign z42 = ~x62 & new_n286_ & ~x61;
  assign new_n286_ = ~x60 & ~x58 & ~x56 & new_n287_ & ~x55 & ~x59;
  assign new_n287_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n207_ & x49;
  assign z43 = new_n289_ & ~x62;
  assign new_n289_ = ~x61 & ~x59 & ~x58 & new_n290_ & ~x56 & ~x60;
  assign new_n290_ = ~x55 & ~x53 & ~x51 & new_n291_ & ~x50 & ~x54;
  assign new_n291_ = ~x47 & ~x45 & ~x43 & new_n292_ & ~x42 & ~x46;
  assign new_n292_ = ~x41 & ~x39 & ~x37 & new_n293_ & ~x35 & ~x40;
  assign new_n293_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n294_ & x29;
  assign new_n294_ = ~x28 & ~x25 & ~x24 & new_n295_ & ~x22 & ~x26;
  assign new_n295_ = ~x18 & ~x15 & ~x14 & new_n296_ & ~x11 & ~x17;
  assign new_n296_ = ~x10 & ~x08 & ~x07 & new_n297_ & ~x06 & ~x09;
  assign new_n297_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n299_ & ~x58 & ~x61;
  assign new_n299_ = ~x56 & ~x54 & ~x53 & new_n300_ & ~x51 & ~x55;
  assign new_n300_ = ~x50 & ~x46 & ~x45 & new_n301_ & ~x43 & ~x47;
  assign new_n301_ = ~x42 & ~x40 & ~x39 & new_n302_ & ~x37 & ~x41;
  assign new_n302_ = ~x35 & ~x33 & ~x31 & new_n303_ & ~x30 & ~x34;
  assign new_n303_ = x29 & ~x26 & ~x25 & new_n304_ & ~x24 & ~x28;
  assign new_n304_ = ~x22 & ~x17 & ~x15 & new_n305_ & ~x14 & ~x18;
  assign new_n305_ = ~x11 & ~x09 & ~x08 & new_n306_ & ~x07 & ~x10;
  assign new_n306_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n308_ & ~x62;
  assign new_n308_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n205_ & x57;
  assign z51 = ~x62 & ~x61 & new_n310_ & ~x60;
  assign new_n310_ = ~x59 & ~x56 & ~x55 & new_n311_ & ~x54 & ~x58;
  assign new_n311_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n207_ & x48;
  ...
  assign new_n320_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n212_ & x12;
  ...
  assign z61 = ~x58 & ~x56 & new_n350_ & ~x50 & ~x60;
  assign new_n350_ = ~x47 & ~x43 & ~x40 & new_n351_ & ~x39 & ~x46;
  assign new_n351_ = ~x37 & ~x30 & x29 & ~x28 & new_n352_ & ~x25;
  assign new_n352_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z00 = 1'b0;
  assign z10 = 1'b0;
  assign z15 = 1'b0;
  assign z17 = 1'b0;
