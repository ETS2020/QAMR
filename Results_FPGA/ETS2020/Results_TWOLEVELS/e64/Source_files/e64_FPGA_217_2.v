// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:30 2020
...
module FAU ( 
  ...
  assign z35 = ~x62 & ~x61 & new_n247_ & ~x60;
  assign new_n247_ = ~x56 & ~x55 & ~x51 & new_n248_ & ~x50 & ~x58;
  assign new_n248_ = ~x46 & ~x43 & ~x41 & new_n249_ & ~x40 & ~x47;
  assign new_n249_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n250_ & x29;
  assign new_n250_ = ~x26 & ~x25 & ~x24 & new_n251_ & ~x22 & ~x28;
  assign new_n251_ = ~x15 & ~x14 & ~x11 & new_n252_ & ~x10 & ~x18;
  ...
  assign new_n256_ = ~x40 & ~x39 & ~x37 & new_n207_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n258_ & ~x60;
  assign new_n258_ = ~x58 & ~x56 & ~x55 & new_n259_ & ~x51 & x59;
  assign new_n259_ = ~x47 & ~x46 & ~x43 & new_n260_ & ~x42 & ~x50;
  assign new_n260_ = ~x41 & ~x40 & new_n261_ & ~x39;
  assign new_n261_ = ~x37 & ~x35 & ~x30 & x29 & new_n262_ & ~x28;
  assign new_n262_ = ~x25 & ~x24 & ~x22 & new_n263_ & ~x18 & ~x26;
  assign new_n263_ = ~x15 & ~x14 & ~x11 & new_n264_ & ~x10;
  assign new_n264_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n266_ & ~x61;
  assign new_n266_ = ~x58 & ~x56 & ~x55 & new_n267_ & ~x51 & ~x60;
  assign new_n267_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n260_ & x42;
  assign z40 = ~x62 & ~x61 & new_n269_ & ~x60;
  assign new_n269_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n270_ & x54;
  assign new_n270_ = ~x51 & ~x50 & new_n271_ & ~x47;
  assign new_n271_ = ~x43 & ~x42 & ~x41 & new_n272_ & ~x40 & ~x46;
  assign new_n272_ = ~x37 & ~x35 & ~x34 & new_n273_ & ~x33 & ~x39;
  assign new_n273_ = ~x30 & x29 & ~x28 & new_n274_ & ~x26;
  assign new_n274_ = ~x24 & ~x22 & ~x18 & new_n275_ & ~x17 & ~x25;
  assign new_n275_ = ~x14 & ~x11 & ~x10 & new_n264_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n277_ & ~x58 & ~x62;
  assign new_n277_ = ~x55 & ~x51 & ~x50 & new_n278_ & ~x47 & ~x56;
  assign new_n278_ = ~x43 & ~x42 & ~x41 & new_n279_ & ~x40 & ~x46;
  assign new_n279_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n273_ & x33;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n281_ & ~x59;
  assign new_n281_ = ~x56 & ~x55 & ~x51 & new_n282_ & ~x50 & ~x58;
  assign new_n282_ = ~x46 & ~x43 & ~x42 & new_n283_ & ~x41 & ~x47;
  assign new_n283_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n273_ & x34;
  assign z46 = ~x62 & new_n285_ & ~x61;
  ...
  assign new_n290_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n264_ & x09;
  assign z47 = ~x62 & new_n292_ & ~x61;
  ...
  assign new_n296_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n263_ & x17;
  assign z48 = ~x62 & ~x61 & new_n298_ & ~x60;
  assign new_n298_ = ~x58 & ~x56 & ~x55 & new_n299_ & ~x54 & ~x59;
  assign new_n299_ = ~x51 & ~x50 & ~x47 & new_n300_ & ~x46 & ~x53;
  assign new_n300_ = ~x42 & ~x41 & ~x40 & new_n301_ & ~x39 & ~x43;
  assign new_n301_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n273_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n303_ & ~x59;
  assign new_n303_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n270_ & x53;
  ...
  assign new_n307_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n207_ & x35;
