...
module FAU ( 
  ...
  assign z30 = ~x63 & ~x62 & ~x61 & new_n205_ & ~x60 & ~x64;
  ...
  assign new_n210_ = ~x33 & ~x31 & ~x30 & new_n211_ & x29;
  assign new_n211_ = ~x28 & ~x26 & ~x25 & new_n212_ & ~x24;
  assign new_n212_ = ~x22 & ~x21 & ~x18 & new_n177_ & ~x17;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n214_ & ~x60 & ~x64;
  assign new_n214_ = ~x58 & ~x57 & ~x56 & new_n215_ & ~x55 & ~x59;
  assign new_n215_ = ~x53 & ~x51 & ~x50 & new_n216_ & ~x49 & ~x54;
  ...
  assign new_n220_ = ~x24 & ~x22 & x21 & ~x18 & new_n177_ & ~x17;
  ...
  assign z37 = ~x63 & ~x62 & ~x61 & new_n229_ & ~x60 & ~x64;
  assign new_n229_ = ~x58 & ~x57 & ~x56 & new_n230_ & ~x55 & ~x59;
  assign new_n230_ = ~x53 & ~x52 & ~x51 & new_n231_ & ~x50 & ~x54;
  assign new_n231_ = ~x48 & ~x47 & ~x46 & new_n232_ & ~x45 & ~x49;
  assign new_n232_ = ~x42 & ~x41 & ~x40 & new_n233_ & ~x39 & ~x43;
  assign new_n233_ = ~x36 & ~x35 & ~x34 & new_n234_ & ~x33 & ~x37;
  assign new_n234_ = ~x32 & ~x31 & ~x30 & x29 & new_n235_ & ~x28;
  assign new_n235_ = ~x25 & ~x24 & ~x22 & new_n236_ & ~x21 & ~x26;
  assign new_n236_ = ~x20 & x19 & ~x18 & ~x17 & new_n190_ & ~x16;
  ...
  assign new_n262_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n160_ & x49;
  ...
  assign new_n308_ = ~x56 & ~x55 & new_n159_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n310_ & ~x60;
  assign new_n310_ = ~x58 & ~x56 & ~x55 & new_n311_ & ~x54 & ~x59;
  assign new_n311_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n160_ & x48;
  ...
  assign new_n320_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n165_ & x12;
