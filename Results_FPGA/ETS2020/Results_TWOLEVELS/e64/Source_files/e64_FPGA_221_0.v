...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n357_, new_n358_, new_n360_, new_n361_, new_n362_;
  ...
  assign z08 = ~x63 & ~x62 & new_n166_ & ~x61 & ~x64;
  assign new_n166_ = ~x60 & ~x58 & ~x57 & new_n167_ & ~x56 & ~x59;
  assign new_n167_ = ~x55 & ~x53 & ~x52 & new_n168_ & ~x51 & ~x54;
  assign new_n168_ = ~x50 & ~x48 & ~x47 & new_n169_ & ~x46 & ~x49;
  assign new_n169_ = ~x45 & ~x42 & ~x41 & new_n170_ & ~x40 & ~x43;
  assign new_n170_ = ~x39 & ~x37 & ~x36 & new_n160_ & ~x35 & x38;
  assign z10 = ~x37 & x29 & ~x15 & x28;
  assign z11 = x37 & ~x15 & x29;
  assign z12 = ~x62 & ~x58 & ~x56 & new_n174_ & ~x50 & ~x60;
  assign new_n174_ = ~x47 & ~x43 & ~x41 & new_n175_ & ~x40 & ~x46;
  assign new_n175_ = ~x39 & ~x37 & ~x30 & x29 & new_n176_ & ~x28;
  assign new_n176_ = ~x26 & ~x24 & ~x15 & new_n177_ & ~x14 & ~x25;
  ...
  assign new_n187_ = ~x37 & ~x28 & ~x15 & x10 & ~x14 & x29;
  ...
  assign new_n192_ = ~x60 & ~x56 & ~x50 & new_n193_ & ~x47 & ~x58;
  assign new_n193_ = ~x46 & ~x40 & ~x39 & new_n194_ & ~x37 & ~x43;
  assign new_n194_ = ~x30 & ~x28 & ~x25 & new_n195_ & ~x24 & x29;
  ...
  assign new_n200_ = ~x53 & ~x50 & ~x49 & new_n201_ & ~x48 & ~x51;
  assign new_n201_ = ~x46 & ~x45 & new_n202_ & ~x43 & ~x47;
  assign new_n202_ = ~x42 & ~x40 & ~x39 & new_n203_ & ~x37 & ~x41;
  assign new_n203_ = ~x35 & ~x33 & ~x31 & new_n204_ & ~x30 & ~x34;
  assign new_n204_ = x29 & ~x26 & ~x25 & new_n205_ & ~x24 & ~x28;
  assign new_n205_ = ~x22 & ~x17 & ~x15 & new_n206_ & ~x14 & ~x18;
  assign new_n206_ = new_n152_ & ~x11;
  assign z20 = ~x62 & ~x60 & new_n208_ & ~x58;
  assign new_n208_ = ~x56 & ~x50 & ~x47 & new_n209_ & ~x46 & x51;
  assign new_n209_ = ~x43 & ~x40 & ~x39 & new_n210_ & ~x37 & ~x41;
  assign new_n210_ = ~x30 & x29 & new_n211_ & ~x28;
  assign new_n211_ = ~x26 & ~x24 & ~x22 & new_n212_ & ~x18 & ~x25;
  assign new_n212_ = ~x14 & ~x11 & new_n213_ & ~x10 & ~x15;
  assign new_n213_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  assign z21 = ~x62 & ~x60 & new_n215_ & ~x58;
  assign new_n215_ = ~x56 & ~x47 & ~x46 & new_n216_ & ~x43 & ~x50;
  assign new_n216_ = ~x41 & ~x39 & ~x37 & new_n217_ & ~x30 & ~x40;
  assign new_n217_ = x29 & ~x26 & ~x25 & new_n218_ & ~x24 & ~x28;
  assign new_n218_ = ~x22 & ~x15 & ~x14 & new_n219_ & ~x11 & ~x18;
  assign new_n219_ = ~x10 & ~x07 & ~x06 & x00 & ~x03 & ~x08;
  ...
  assign new_n269_ = ~x43 & ~x40 & new_n185_ & ~x39;
  ...
  assign new_n285_ = ~x41 & ~x39 & ~x37 & new_n210_ & ~x35 & ~x40;
  ...
  assign new_n294_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n254_ & x19;
  assign z42 = ~x62 & new_n296_ & ~x61;
  assign new_n296_ = ~x60 & ~x58 & ~x56 & new_n297_ & ~x55 & ~x59;
  assign new_n297_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n201_ & x49;
  ...
  assign z44 = ~x62 & ~x60 & ~x59 & new_n309_ & ~x58 & ~x61;
  assign new_n309_ = ~x56 & ~x54 & ~x53 & new_n310_ & ~x51 & ~x55;
  assign new_n310_ = ~x50 & ~x46 & ~x45 & new_n311_ & ~x43 & ~x47;
  assign new_n311_ = ~x42 & ~x40 & ~x39 & new_n312_ & ~x37 & ~x41;
  assign new_n312_ = ~x35 & ~x33 & ~x31 & new_n313_ & ~x30 & ~x34;
  assign new_n313_ = x29 & ~x26 & ~x25 & new_n314_ & ~x24 & ~x28;
  assign new_n314_ = ~x22 & ~x17 & ~x15 & new_n315_ & ~x14 & ~x18;
  assign new_n315_ = ~x11 & ~x09 & ~x08 & new_n316_ & ~x07 & ~x10;
  assign new_n316_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n318_ & ~x62;
  assign new_n318_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n199_ & x57;
  assign z51 = ~x62 & ~x61 & new_n320_ & ~x60;
  assign new_n320_ = ~x59 & ~x56 & ~x55 & new_n321_ & ~x54 & ~x58;
  assign new_n321_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n201_ & x48;
  assign z52 = new_n323_ & ~x64;
  assign new_n323_ = ~x63 & ~x61 & ~x60 & new_n324_ & ~x59 & ~x62;
  assign new_n324_ = ~x58 & ~x56 & ~x55 & new_n325_ & ~x54 & ~x57;
  assign new_n325_ = ~x53 & ~x50 & ~x49 & new_n326_ & ~x48 & ~x51;
  assign new_n326_ = ~x47 & ~x45 & ~x43 & new_n327_ & ~x42 & ~x46;
  assign new_n327_ = ~x41 & ~x39 & ~x37 & new_n328_ & ~x35 & ~x40;
  assign new_n328_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n329_ & x29;
  assign new_n329_ = ~x28 & ~x25 & ~x24 & new_n330_ & ~x22 & ~x26;
  assign new_n330_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n206_ & x12;
  assign z53 = ~x64 & new_n197_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n284_ & x55;
  assign z55 = ~x60 & ~x58 & new_n334_ & ~x56 & ~x62;
  assign new_n334_ = ~x51 & ~x47 & ~x46 & new_n335_ & ~x43 & ~x50;
  assign new_n335_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n210_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n337_ & ~x60 & ~x63;
  assign new_n337_ = ~x59 & ~x57 & ~x56 & new_n338_ & ~x55 & ~x58;
  assign new_n338_ = ~x54 & ~x52 & ~x51 & new_n339_ & ~x50 & ~x53;
  assign new_n339_ = ~x49 & ~x47 & ~x46 & new_n340_ & ~x45 & ~x48;
  assign new_n340_ = ~x43 & ~x41 & ~x40 & new_n341_ & ~x39 & ~x42;
  assign new_n341_ = ~x37 & ~x35 & ~x34 & new_n342_ & ~x33 & ~x36;
  assign new_n342_ = ~x31 & ~x30 & x29 & ~x28 & new_n343_ & ~x26;
  assign new_n343_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n344_ & x20;
  assign new_n344_ = ~x18 & ~x16 & ~x15 & new_n229_ & ~x14 & ~x17;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n356_ & ~x47 & ~x58;
  assign new_n356_ = ~x46 & ~x40 & ~x39 & new_n357_ & ~x37 & ~x43;
  assign new_n357_ = ~x30 & ~x28 & ~x25 & new_n358_ & ~x24 & x29;
  assign new_n358_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n360_ & ~x50 & ~x60;
  assign new_n360_ = ~x47 & ~x43 & ~x40 & new_n361_ & ~x39 & ~x46;
  assign new_n361_ = ~x37 & ~x30 & x29 & ~x28 & new_n362_ & ~x25;
  assign new_n362_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z00 = 1'b0;
  assign z09 = 1'b0;
  assign z17 = 1'b0;
  assign z31 = 1'b0;
