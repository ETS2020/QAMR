// Benchmark "FAU" written by ABC on Thu Jul 30 15:25:33 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n396_, new_n397_, new_n398_, new_n399_, new_n400_, new_n404_,
  ...
  assign new_n261_ = ~x24 & ~x22 & ~x21 & new_n262_ & ~x20 & ~x25;
  assign new_n262_ = ~x18 & ~x17 & new_n160_ & ~x16;
  ...
  assign new_n271_ = ~x21 & ~x20 & ~x18 & new_n272_ & ~x17;
  assign new_n272_ = ~x16 & ~x15 & ~x14 & x13 & new_n227_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n274_ & ~x50;
  assign new_n274_ = ~x43 & ~x40 & ~x39 & new_n275_ & ~x37 & ~x46;
  ...
  assign new_n317_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n262_ & x19;
  ...
  assign z43 = new_n345_ & ~x62;
  assign new_n345_ = ~x60 & ~x59 & ~x58 & new_n346_ & ~x56 & ~x61;
  assign new_n346_ = ~x54 & ~x53 & ~x51 & new_n347_ & ~x50 & ~x55;
  assign new_n347_ = ~x46 & ~x45 & ~x43 & new_n348_ & ~x42 & ~x47;
  assign new_n348_ = ~x40 & ~x39 & ~x37 & new_n349_ & ~x35 & ~x41;
  assign new_n349_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n350_ & x29;
  assign new_n350_ = ~x26 & ~x25 & ~x24 & new_n351_ & ~x22 & ~x28;
  assign new_n351_ = ~x17 & ~x15 & ~x14 & new_n352_ & ~x11 & ~x18;
  assign new_n352_ = ~x09 & ~x08 & ~x07 & new_n353_ & ~x06 & ~x10;
  assign new_n353_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n355_ & ~x58 & ~x62;
  assign new_n355_ = ~x55 & ~x54 & ~x53 & new_n356_ & ~x51 & ~x56;
  assign new_n356_ = ~x47 & ~x46 & ~x45 & new_n357_ & ~x43 & ~x50;
  assign new_n357_ = ~x41 & ~x40 & ~x39 & new_n358_ & ~x37 & ~x42;
  assign new_n358_ = ~x34 & ~x33 & ~x31 & new_n359_ & ~x30 & ~x35;
  assign new_n359_ = ~x28 & ~x26 & ~x25 & new_n360_ & ~x24 & x29;
  assign new_n360_ = ~x18 & ~x17 & ~x15 & new_n361_ & ~x14 & ~x22;
  assign new_n361_ = ~x10 & ~x09 & ~x08 & new_n362_ & ~x07 & ~x11;
  ...
  assign new_n366_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n334_ & x34;
  assign z46 = ~x62 & new_n368_ & ~x61;
  assign new_n368_ = ~x59 & ~x58 & ~x56 & new_n369_ & ~x55 & ~x60;
  assign new_n369_ = ~x50 & ~x47 & ~x46 & new_n370_ & ~x43 & ~x51;
  assign new_n370_ = ~x41 & ~x40 & ~x39 & new_n371_ & ~x37 & ~x42;
  assign new_n371_ = ~x35 & ~x30 & x29 & ~x28 & new_n372_ & ~x26;
  assign new_n372_ = ~x24 & ~x22 & ~x18 & new_n373_ & ~x17 & ~x25;
  assign new_n373_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n325_ & x09;
  assign z47 = ~x62 & new_n375_ & ~x61;
  ...
  assign new_n379_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n324_ & x17;
  assign z48 = ~x62 & ~x61 & new_n381_ & ~x60;
  assign new_n381_ = ~x58 & ~x56 & ~x55 & new_n382_ & ~x54 & ~x59;
  assign new_n382_ = ~x51 & ~x50 & ~x47 & new_n383_ & ~x46 & ~x53;
  assign new_n383_ = ~x42 & ~x41 & ~x40 & new_n384_ & ~x39 & ~x43;
  assign new_n384_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n334_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n386_ & ~x59;
  assign new_n386_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n331_ & x53;
  assign z50 = new_n388_ & ~x62;
  assign new_n388_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n220_ & x57;
  assign z51 = ~x62 & ~x61 & new_n390_ & ~x60;
  assign new_n390_ = ~x58 & ~x56 & ~x55 & new_n391_ & ~x54 & ~x59;
  assign new_n391_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n222_ & x48;
  assign z52 = new_n393_ & ~x64;
  assign new_n393_ = ~x62 & ~x61 & ~x60 & new_n394_ & ~x59 & ~x63;
  assign new_n394_ = ~x57 & ~x56 & ~x55 & new_n395_ & ~x54 & ~x58;
  assign new_n395_ = ~x51 & ~x50 & ~x49 & new_n396_ & ~x48 & ~x53;
  ...
  assign new_n400_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n227_ & x12;
  assign z53 = ~x64 & new_n218_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n307_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n404_ & ~x56;
  assign new_n404_ = ~x50 & ~x47 & ~x46 & new_n405_ & ~x43 & ~x51;
  assign new_n405_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n231_ & x35;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n407_ & ~x50 & ~x62;
  assign new_n407_ = ~x46 & ~x43 & ~x41 & new_n408_ & ~x40 & ~x47;
  assign new_n408_ = ~x39 & ~x37 & ~x30 & x29 & new_n409_ & ~x28;
  assign new_n409_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n410_ & x18;
  assign new_n410_ = ~x15 & new_n411_ & ~x14;
  assign new_n411_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n413_ & ~x56;
  assign new_n413_ = ~x47 & ~x46 & ~x43 & new_n414_ & ~x41 & ~x50;
  assign new_n414_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n415_ & x29;
  assign new_n415_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n410_ & x22;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n201_ & x40;
  assign z60 = ~x58 & ~x56 & ~x50 & new_n418_ & ~x47 & ~x60;
  assign new_n418_ = ~x43 & ~x40 & ~x39 & new_n419_ & ~x37 & ~x46;
  assign new_n419_ = ~x30 & x29 & ~x28 & ~x25 & new_n420_ & ~x24;
  assign new_n420_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n422_ & ~x50;
  assign new_n422_ = ~x46 & ~x43 & ~x40 & new_n423_ & ~x39 & ~x47;
  assign new_n423_ = ~x37 & ~x30 & x29 & ~x28 & new_n424_ & ~x25;
  assign new_n424_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n426_ & x47;
  assign new_n426_ = new_n427_ & ~x46;
  assign new_n427_ = ~x40 & ~x39 & ~x37 & new_n428_ & ~x30 & ~x43;
  assign new_n428_ = x29 & new_n429_ & ~x28;
  assign new_n429_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n426_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n432_ & ~x46;
