// Benchmark "FAU" written by ABC on Thu Jul 30 15:25:46 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n285_, new_n289_, new_n291_, new_n292_, new_n293_, new_n295_,
    new_n296_, new_n297_, new_n298_, new_n299_, new_n300_, new_n301_,
    new_n302_, new_n304_, new_n305_, new_n307_, new_n308_, new_n309_,
    new_n310_, new_n311_, new_n312_, new_n313_, new_n314_, new_n315_,
    new_n317_, new_n318_, new_n319_, new_n320_, new_n321_, new_n322_,
    new_n323_, new_n324_, new_n326_, new_n328_, new_n329_, new_n331_,
    new_n332_, new_n333_, new_n334_, new_n335_, new_n336_, new_n337_,
    new_n338_, new_n342_, new_n343_, new_n345_, new_n346_, new_n347_,
  ...
  assign new_n291_ = x61 & ~x58 & ~x56 & new_n292_ & ~x55 & ~x60;
  assign new_n292_ = ~x51 & ~x47 & ~x46 & new_n293_ & ~x43 & ~x50;
  assign new_n293_ = ~x41 & ~x39 & ~x37 & new_n218_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n295_ & ~x63;
  assign new_n295_ = ~x62 & ~x60 & ~x59 & new_n296_ & ~x58 & ~x61;
  assign new_n296_ = ~x57 & ~x55 & ~x54 & new_n297_ & ~x53 & ~x56;
  assign new_n297_ = ~x52 & ~x50 & ~x49 & new_n298_ & ~x48 & ~x51;
  assign new_n298_ = ~x47 & ~x45 & ~x43 & new_n299_ & ~x42 & ~x46;
  assign new_n299_ = ~x41 & ~x39 & ~x37 & new_n300_ & ~x36 & ~x40;
  assign new_n300_ = ~x35 & ~x33 & ~x32 & new_n301_ & ~x31 & ~x34;
  assign new_n301_ = ~x30 & ~x28 & ~x26 & new_n302_ & ~x25 & x29;
  assign new_n302_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n262_ & x19;
  assign z42 = ~x62 & new_n304_ & ~x61;
  assign new_n304_ = ~x60 & ~x58 & ~x56 & new_n305_ & ~x55 & ~x59;
  assign new_n305_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n209_ & x49;
  assign z43 = new_n307_ & ~x62;
  assign new_n307_ = ~x61 & ~x59 & ~x58 & new_n308_ & ~x56 & ~x60;
  assign new_n308_ = ~x55 & ~x53 & ~x51 & new_n309_ & ~x50 & ~x54;
  assign new_n309_ = ~x47 & ~x45 & ~x43 & new_n310_ & ~x42 & ~x46;
  assign new_n310_ = ~x41 & ~x39 & ~x37 & new_n311_ & ~x35 & ~x40;
  assign new_n311_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n312_ & x29;
  assign new_n312_ = ~x28 & ~x25 & ~x24 & new_n313_ & ~x22 & ~x26;
  assign new_n313_ = ~x18 & ~x15 & ~x14 & new_n314_ & ~x11 & ~x17;
  assign new_n314_ = ~x10 & ~x08 & ~x07 & new_n315_ & ~x06 & ~x09;
  assign new_n315_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n317_ & ~x58 & ~x61;
  assign new_n317_ = ~x56 & ~x54 & ~x53 & new_n318_ & ~x51 & ~x55;
  assign new_n318_ = ~x50 & ~x46 & ~x45 & new_n319_ & ~x43 & ~x47;
  assign new_n319_ = ~x42 & ~x40 & ~x39 & new_n320_ & ~x37 & ~x41;
  assign new_n320_ = ~x35 & ~x33 & ~x31 & new_n321_ & ~x30 & ~x34;
  assign new_n321_ = x29 & ~x26 & ~x25 & new_n322_ & ~x24 & ~x28;
  assign new_n322_ = ~x22 & ~x17 & ~x15 & new_n323_ & ~x14 & ~x18;
  assign new_n323_ = ~x11 & ~x09 & ~x08 & new_n324_ & ~x07 & ~x10;
  assign new_n324_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n326_ & ~x62;
  assign new_n326_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n207_ & x57;
  assign z51 = ~x62 & ~x61 & new_n328_ & ~x60;
  assign new_n328_ = ~x59 & ~x56 & ~x55 & new_n329_ & ~x54 & ~x58;
  assign new_n329_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n209_ & x48;
  assign z52 = new_n331_ & ~x64;
  assign new_n331_ = ~x63 & ~x61 & ~x60 & new_n332_ & ~x59 & ~x62;
  assign new_n332_ = ~x58 & ~x56 & ~x55 & new_n333_ & ~x54 & ~x57;
  assign new_n333_ = ~x53 & ~x50 & ~x49 & new_n334_ & ~x48 & ~x51;
  assign new_n334_ = ~x47 & ~x45 & ~x43 & new_n335_ & ~x42 & ~x46;
  assign new_n335_ = ~x41 & ~x39 & ~x37 & new_n336_ & ~x35 & ~x40;
  assign new_n336_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n337_ & x29;
  assign new_n337_ = ~x28 & ~x25 & ~x24 & new_n338_ & ~x22 & ~x26;
  assign new_n338_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n214_ & x12;
  assign z53 = ~x64 & new_n205_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n292_ & x55;
  assign z55 = ~x60 & ~x58 & new_n342_ & ~x56 & ~x62;
  assign new_n342_ = ~x51 & ~x47 & ~x46 & new_n343_ & ~x43 & ~x50;
  assign new_n343_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n218_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n345_ & ~x60 & ~x63;
  assign new_n345_ = ~x59 & ~x57 & ~x56 & new_n346_ & ~x55 & ~x58;
  assign new_n346_ = ~x54 & ~x52 & ~x51 & new_n347_ & ~x50 & ~x53;
  assign new_n347_ = ~x49 & ~x47 & ~x46 & new_n348_ & ~x45 & ~x48;
  assign new_n348_ = ~x43 & ~x41 & ~x40 & new_n349_ & ~x39 & ~x42;
  assign new_n349_ = ~x37 & ~x35 & ~x34 & new_n350_ & ~x33 & ~x36;
  assign new_n350_ = ~x31 & ~x30 & x29 & ~x28 & new_n351_ & ~x26;
  assign new_n351_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n352_ & x20;
  assign new_n352_ = ~x18 & ~x16 & ~x15 & new_n237_ & ~x14 & ~x17;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n354_ & ~x50 & ~x60;
  assign new_n354_ = ~x47 & ~x43 & ~x41 & new_n355_ & ~x40 & ~x46;
  ...
  assign z58 = ~x60 & ~x58 & new_n360_ & ~x56 & ~x62;
  assign new_n360_ = ~x50 & ~x46 & ~x43 & new_n361_ & ~x41 & ~x47;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n365_ & ~x47 & ~x58;
  assign new_n365_ = ~x46 & ~x40 & ~x39 & new_n366_ & ~x37 & ~x43;
  assign new_n366_ = ~x30 & ~x28 & ~x25 & new_n367_ & ~x24 & x29;
  assign new_n367_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n369_ & ~x50 & ~x60;
  assign new_n369_ = ~x47 & ~x43 & ~x40 & new_n370_ & ~x39 & ~x46;
  assign new_n370_ = ~x37 & ~x30 & x29 & ~x28 & new_n371_ & ~x25;
  assign new_n371_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z10 = 1'b0;
  assign z17 = 1'b0;
