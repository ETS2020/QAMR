...
module FAU ( 
  ...
  assign new_n168_ = ~x61 & ~x60 & ~x59 & new_n169_ & ~x58 & ~x62;
  assign new_n169_ = ~x56 & ~x55 & ~x54 & new_n170_ & ~x53 & ~x57;
  assign new_n170_ = ~x51 & ~x50 & ~x49 & new_n171_ & ~x48 & ~x52;
  assign new_n171_ = ~x46 & ~x45 & ~x43 & new_n172_ & ~x42 & ~x47;
  assign new_n172_ = ~x40 & ~x39 & ~x37 & new_n173_ & ~x36 & ~x41;
  assign new_n173_ = ~x34 & ~x33 & ~x31 & new_n174_ & ~x30 & ~x35;
  assign new_n174_ = ~x28 & ~x26 & ~x25 & new_n175_ & ~x24 & x29;
  assign new_n175_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n176_ & x16;
  assign new_n176_ = ~x15 & ~x14 & ~x12 & new_n165_ & ~x11;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n178_ & ~x43 & ~x60;
  assign new_n178_ = ~x40 & ~x39 & ~x37 & x29 & new_n179_ & ~x28;
  assign new_n179_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z26 = ~x64 & ~x63 & ~x62 & new_n181_ & ~x61;
  ...
  assign new_n187_ = ~x26 & ~x25 & ~x24 & new_n188_ & ~x22 & ~x28;
  assign new_n188_ = ~x20 & ~x18 & ~x17 & new_n189_ & ~x16 & ~x21;
  assign new_n189_ = ~x14 & ~x13 & ~x12 & new_n165_ & ~x11 & ~x15;
  assign z27 = ~x64 & ~x63 & new_n191_ & ~x62;
  ...
  assign new_n199_ = ~x15 & ~x14 & x13 & ~x12 & new_n165_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n201_ & ~x50;
  assign new_n201_ = ~x43 & ~x40 & ~x39 & new_n202_ & ~x37 & ~x46;
  assign new_n202_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n204_ & ~x60 & ~x64;
  assign new_n204_ = ~x58 & ~x57 & ~x56 & new_n205_ & ~x55 & ~x59;
  assign new_n205_ = ~x54 & ~x53 & x52 & ~x51 & new_n206_ & ~x50;
  assign new_n206_ = ~x48 & ~x47 & ~x46 & new_n207_ & ~x45 & ~x49;
  assign new_n207_ = ~x43 & ~x42 & ~x41 & new_n208_ & ~x40;
  assign new_n208_ = ~x37 & ~x36 & ~x35 & new_n209_ & ~x34 & ~x39;
  assign new_n209_ = ~x33 & ~x31 & ~x30 & new_n210_ & x29;
  assign new_n210_ = ~x28 & ~x26 & ~x25 & new_n211_ & ~x24;
  assign new_n211_ = ~x22 & ~x21 & ~x18 & new_n176_ & ~x17;
  ...
  assign new_n227_ = ~x20 & x19 & ~x18 & ~x17 & new_n189_ & ~x16;
  ...
  assign new_n253_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n159_ & x49;
  ...
  assign new_n299_ = ~x56 & ~x55 & new_n158_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n301_ & ~x60;
  assign new_n301_ = ~x58 & ~x56 & ~x55 & new_n302_ & ~x54 & ~x59;
  assign new_n302_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n159_ & x48;
  ...
  assign new_n311_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n164_ & x12;
  assign z53 = ~x64 & new_n156_ & x63;
  assign z55 = ~x60 & ~x58 & ~x56 & new_n314_ & ~x51 & ~x62;
  assign new_n314_ = ~x47 & ~x46 & ~x43 & new_n315_ & ~x41 & ~x50;
  assign new_n315_ = ~x40 & ~x39 & ~x37 & x35 & new_n316_ & ~x30;
  assign new_n316_ = ~x28 & ~x26 & ~x25 & new_n317_ & ~x24 & x29;
  assign new_n317_ = ~x18 & ~x15 & ~x14 & new_n318_ & ~x11 & ~x22;
  assign new_n318_ = ~x10 & ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  ...
  assign new_n327_ = ~x21 & x20 & ~x18 & ~x17 & new_n176_ & ~x16;
