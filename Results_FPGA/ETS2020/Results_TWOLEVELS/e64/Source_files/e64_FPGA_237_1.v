...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n351_, new_n353_, new_n354_, new_n355_, new_n356_, new_n359_;
  ...
  assign new_n169_ = ~x50 & ~x47 & ~x46 & new_n170_ & ~x43 & ~x56;
  assign new_n170_ = ~x40 & ~x39 & ~x37 & new_n171_ & ~x30 & ~x41;
  assign new_n171_ = ~x28 & ~x26 & ~x25 & new_n172_ & ~x24 & x29;
  assign new_n172_ = ~x18 & ~x15 & ~x14 & new_n173_ & ~x11 & ~x22;
  assign new_n173_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n175_ & ~x61;
  assign new_n175_ = ~x59 & ~x58 & ~x57 & new_n176_ & ~x56 & ~x60;
  assign new_n176_ = ~x54 & ~x53 & ~x51 & new_n177_ & ~x50 & ~x55;
  assign new_n177_ = ~x48 & ~x47 & ~x46 & new_n178_ & ~x45 & ~x49;
  assign new_n178_ = ~x42 & ~x41 & ~x40 & new_n179_ & ~x39 & ~x43;
  assign new_n179_ = ~x37 & x36 & ~x35 & ~x34 & new_n180_ & ~x33;
  assign new_n180_ = ~x31 & ~x30 & x29 & ~x28 & new_n181_ & ~x26;
  assign new_n181_ = ~x24 & ~x22 & ~x18 & new_n182_ & ~x17 & ~x25;
  assign new_n182_ = ~x15 & ~x14 & ~x12 & new_n166_ & ~x11;
  ...
  assign new_n204_ = ~x14 & ~x13 & ~x12 & new_n166_ & ~x11 & ~x15;
  ...
  assign new_n213_ = ~x20 & ~x18 & ~x17 & new_n214_ & ~x16 & ~x21;
  ...
  assign z30 = ~x63 & ~x62 & ~x61 & new_n219_ & ~x60 & ~x64;
  assign new_n219_ = ~x58 & ~x57 & ~x56 & new_n220_ & ~x55 & ~x59;
  assign new_n220_ = ~x54 & ~x53 & x52 & ~x51 & new_n221_ & ~x50;
  assign new_n221_ = ~x48 & ~x47 & ~x46 & new_n222_ & ~x45 & ~x49;
  assign new_n222_ = ~x43 & ~x42 & ~x41 & new_n223_ & ~x40;
  assign new_n223_ = ~x37 & ~x36 & ~x35 & new_n224_ & ~x34 & ~x39;
  assign new_n224_ = ~x33 & ~x31 & ~x30 & new_n225_ & x29;
  assign new_n225_ = ~x28 & ~x26 & ~x25 & new_n226_ & ~x24;
  assign new_n226_ = ~x22 & ~x21 & ~x18 & new_n182_ & ~x17;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n228_ & ~x60 & ~x64;
  ...
  assign new_n232_ = ~x35 & ~x34 & ~x33 & new_n233_ & ~x31 & ~x36;
  assign new_n233_ = ~x30 & x29 & ~x28 & ~x26 & new_n234_ & ~x25;
  assign new_n234_ = ~x24 & ~x22 & x21 & ~x18 & new_n182_ & ~x17;
  assign z34 = new_n236_ & x58;
  assign new_n236_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n238_ & ~x60;
  assign new_n238_ = ~x56 & ~x55 & ~x51 & new_n239_ & ~x50 & ~x58;
  assign new_n239_ = ~x46 & ~x43 & ~x41 & new_n240_ & ~x40 & ~x47;
  assign new_n240_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n241_ & x29;
  assign new_n241_ = ~x26 & ~x25 & ~x24 & new_n242_ & ~x22 & ~x28;
  assign new_n242_ = ~x15 & ~x14 & ~x11 & new_n243_ & ~x10 & ~x18;
  assign new_n243_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z37 = ~x63 & ~x62 & ~x61 & new_n245_ & ~x60 & ~x64;
  assign new_n245_ = ~x58 & ~x57 & ~x56 & new_n246_ & ~x55 & ~x59;
  assign new_n246_ = ~x53 & ~x52 & ~x51 & new_n247_ & ~x50 & ~x54;
  assign new_n247_ = ~x48 & ~x47 & ~x46 & new_n248_ & ~x45 & ~x49;
  assign new_n248_ = ~x42 & ~x41 & ~x40 & new_n249_ & ~x39 & ~x43;
  assign new_n249_ = ~x36 & ~x35 & ~x34 & new_n250_ & ~x33 & ~x37;
  assign new_n250_ = ~x32 & ~x31 & ~x30 & x29 & new_n251_ & ~x28;
  assign new_n251_ = ~x25 & ~x24 & ~x22 & new_n252_ & ~x21 & ~x26;
  assign new_n252_ = ~x20 & x19 & ~x18 & ~x17 & new_n204_ & ~x16;
  assign z38 = ~x62 & ~x61 & new_n254_ & ~x60;
  assign new_n254_ = ~x58 & ~x56 & ~x55 & new_n255_ & ~x51 & x59;
  assign new_n255_ = ~x47 & ~x46 & ~x43 & new_n256_ & ~x42 & ~x50;
  assign new_n256_ = ~x41 & ~x40 & new_n257_ & ~x39;
  assign new_n257_ = ~x37 & ~x35 & ~x30 & x29 & new_n258_ & ~x28;
  assign new_n258_ = ~x25 & ~x24 & ~x22 & new_n259_ & ~x18 & ~x26;
  assign new_n259_ = ~x15 & ~x14 & ~x11 & new_n260_ & ~x10;
  assign new_n260_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n262_ & ~x61;
  assign new_n262_ = ~x58 & ~x56 & ~x55 & new_n263_ & ~x51 & ~x60;
  assign new_n263_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n256_ & x42;
  assign z40 = ~x62 & ~x61 & new_n265_ & ~x60;
  assign new_n265_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n266_ & x54;
  assign new_n266_ = ~x51 & ~x50 & new_n267_ & ~x47;
  ...
  assign new_n271_ = ~x14 & ~x11 & ~x10 & new_n260_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n273_ & ~x58 & ~x62;
  assign new_n273_ = ~x55 & ~x51 & ~x50 & new_n274_ & ~x47 & ~x56;
  assign new_n274_ = ~x43 & ~x42 & ~x41 & new_n275_ & ~x40 & ~x46;
  assign new_n275_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n269_ & x33;
  assign z42 = ~x62 & new_n277_ & ~x61;
  assign new_n277_ = ~x59 & ~x58 & ~x56 & new_n278_ & ~x55 & ~x60;
  assign new_n278_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n160_ & x49;
  assign z43 = new_n280_ & ~x62;
  assign new_n280_ = ~x60 & ~x59 & ~x58 & new_n281_ & ~x56 & ~x61;
  assign new_n281_ = ~x54 & ~x53 & ~x51 & new_n282_ & ~x50 & ~x55;
  assign new_n282_ = ~x46 & ~x45 & ~x43 & new_n283_ & ~x42 & ~x47;
  assign new_n283_ = ~x40 & ~x39 & ~x37 & new_n284_ & ~x35 & ~x41;
  assign new_n284_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n285_ & x29;
  assign new_n285_ = ~x26 & ~x25 & ~x24 & new_n286_ & ~x22 & ~x28;
  assign new_n286_ = ~x17 & ~x15 & ~x14 & new_n287_ & ~x11 & ~x18;
  assign new_n287_ = ~x09 & ~x08 & ~x07 & new_n288_ & ~x06 & ~x10;
  assign new_n288_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  ...
  assign new_n292_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n269_ & x34;
  ...
  assign new_n298_ = ~x24 & ~x22 & ~x18 & new_n299_ & ~x17 & ~x25;
  assign new_n299_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n260_ & x09;
  ...
  assign new_n305_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n259_ & x17;
  assign z48 = ~x62 & ~x61 & new_n307_ & ~x60;
  assign new_n307_ = ~x58 & ~x56 & ~x55 & new_n308_ & ~x54 & ~x59;
  assign new_n308_ = ~x51 & ~x50 & ~x47 & new_n309_ & ~x46 & ~x53;
  assign new_n309_ = ~x42 & ~x41 & ~x40 & new_n310_ & ~x39 & ~x43;
  assign new_n310_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n269_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n312_ & ~x59;
  assign new_n312_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n266_ & x53;
  assign z50 = new_n314_ & ~x62;
  assign new_n314_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n315_ & x57;
  assign new_n315_ = ~x56 & ~x55 & new_n159_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n317_ & ~x60;
  assign new_n317_ = ~x58 & ~x56 & ~x55 & new_n318_ & ~x54 & ~x59;
  assign new_n318_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n160_ & x48;
  ...
  assign new_n327_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n165_ & x12;
  assign z53 = ~x64 & new_n157_ & x63;
  assign z56 = ~x64 & ~x63 & new_n330_ & ~x62;
  assign new_n330_ = ~x60 & ~x59 & ~x58 & new_n331_ & ~x57 & ~x61;
  assign new_n331_ = ~x55 & ~x54 & ~x53 & new_n332_ & ~x52 & ~x56;
  assign new_n332_ = ~x50 & ~x49 & ~x48 & new_n333_ & ~x47 & ~x51;
  assign new_n333_ = ~x45 & ~x43 & ~x42 & new_n334_ & ~x41 & ~x46;
  assign new_n334_ = ~x39 & ~x37 & ~x36 & new_n335_ & ~x35 & ~x40;
  assign new_n335_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n336_ & x29;
  assign new_n336_ = ~x26 & ~x25 & ~x24 & new_n337_ & ~x22 & ~x28;
  assign new_n337_ = ~x21 & x20 & ~x18 & ~x17 & new_n182_ & ~x16;
  ...
  assign z60 = ~x58 & ~x56 & ~x50 & new_n349_ & ~x47 & ~x60;
  assign new_n349_ = ~x43 & ~x40 & ~x39 & new_n350_ & ~x37 & ~x46;
  assign new_n350_ = ~x30 & x29 & ~x28 & ~x25 & new_n351_ & ~x24;
  assign new_n351_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n353_ & x47;
  assign new_n353_ = new_n354_ & ~x46;
  assign new_n354_ = ~x40 & ~x39 & ~x37 & new_n355_ & ~x30 & ~x43;
  ...
  assign new_n359_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n355_ & x30;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
