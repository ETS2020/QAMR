...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n269_, new_n273_, new_n275_, new_n276_, new_n277_, new_n278_,
    ...
    new_n358_, new_n359_, new_n362_, new_n363_, new_n365_, new_n366_,
  ...
  assign new_n235_ = ~x18 & new_n236_ & ~x17;
  ...
  assign new_n261_ = ~x25 & ~x24 & ~x22 & new_n235_ & ~x21 & ~x26;
  ...
  assign new_n269_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n235_ & x21;
  ...
  assign new_n284_ = ~x40 & ~x39 & ~x37 & new_n217_ & ~x35 & ~x41;
  ...
  assign z45 = ~x62 & ~x61 & ~x60 & new_n328_ & ~x59;
  assign new_n328_ = ~x56 & ~x55 & ~x51 & new_n329_ & ~x50 & ~x58;
  assign new_n329_ = ~x46 & ~x43 & ~x42 & new_n330_ & ~x41 & ~x47;
  assign new_n330_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n301_ & x34;
  assign z46 = ~x62 & new_n332_ & ~x61;
  ...
  assign new_n337_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n292_ & x09;
  assign z47 = ~x62 & new_n339_ & ~x61;
  ...
  assign new_n343_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n291_ & x17;
  assign z48 = ~x62 & ~x61 & new_n345_ & ~x60;
  assign new_n345_ = ~x58 & ~x56 & ~x55 & new_n346_ & ~x54 & ~x59;
  assign new_n346_ = ~x51 & ~x50 & ~x47 & new_n347_ & ~x46 & ~x53;
  assign new_n347_ = ~x42 & ~x41 & ~x40 & new_n348_ & ~x39 & ~x43;
  assign new_n348_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n301_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n350_ & ~x59;
  assign new_n350_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n298_ & x53;
  assign z53 = ~x64 & x63 & ~x62 & ~x61 & new_n352_ & ~x60;
  assign new_n352_ = ~x58 & ~x57 & ~x56 & new_n353_ & ~x55 & ~x59;
  assign new_n353_ = ~x53 & ~x51 & ~x50 & new_n354_ & ~x49 & ~x54;
  assign new_n354_ = ~x47 & ~x46 & ~x45 & new_n355_ & ~x43 & ~x48;
  assign new_n355_ = ~x42 & ~x41 & ~x40 & new_n356_ & ~x39;
  assign new_n356_ = ~x35 & ~x34 & ~x33 & new_n357_ & ~x31 & ~x37;
  assign new_n357_ = ~x30 & x29 & ~x28 & new_n358_ & ~x26;
  assign new_n358_ = ~x25 & ~x24 & ~x22 & new_n359_ & ~x18;
  assign new_n359_ = ~x17 & ~x15 & ~x14 & new_n161_ & ~x11;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n283_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n362_ & ~x56;
  assign new_n362_ = ~x50 & ~x47 & ~x46 & new_n363_ & ~x43 & ~x51;
  assign new_n363_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n217_ & x35;
  assign z56 = ~x64 & ~x63 & new_n365_ & ~x62;
  assign new_n365_ = ~x60 & ~x59 & ~x58 & new_n366_ & ~x57 & ~x61;
  assign new_n366_ = ~x55 & ~x54 & ~x53 & new_n367_ & ~x52 & ~x56;
  assign new_n367_ = ~x50 & ~x49 & ~x48 & new_n368_ & ~x47 & ~x51;
  assign new_n368_ = ~x45 & ~x43 & ~x42 & new_n369_ & ~x41 & ~x46;
  assign new_n369_ = ~x39 & ~x37 & ~x36 & new_n370_ & ~x35 & ~x40;
  assign new_n370_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n371_ & x29;
  assign new_n371_ = ~x26 & ~x25 & ~x24 & new_n372_ & ~x22 & ~x28;
  assign new_n372_ = ~x21 & x20 & ~x18 & ~x17 & new_n236_ & ~x16;
