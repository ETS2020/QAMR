// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:34 2020
...
module FAU ( 
  ...
  assign new_n164_ = ~x54 & ~x53 & ~x51 & new_n165_ & ~x50 & ~x55;
  assign new_n165_ = ~x48 & ~x47 & ~x46 & new_n166_ & ~x45 & ~x49;
  assign new_n166_ = ~x42 & ~x41 & ~x40 & new_n167_ & ~x39 & ~x43;
  assign new_n167_ = ~x37 & x36 & ~x35 & ~x34 & new_n168_ & ~x33;
  assign new_n168_ = ~x31 & ~x30 & x29 & ~x28 & new_n169_ & ~x26;
  assign new_n169_ = ~x24 & ~x22 & ~x18 & new_n170_ & ~x17 & ~x25;
  assign new_n170_ = ~x15 & ~x14 & ~x12 & new_n160_ & ~x11;
  ...
  assign new_n179_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n170_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n181_ & ~x43 & ~x60;
  assign new_n181_ = ~x40 & ~x39 & ~x37 & x29 & new_n182_ & ~x28;
  assign new_n182_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z26 = ~x64 & ~x63 & ~x62 & new_n184_ & ~x61;
  ...
  assign new_n191_ = ~x20 & ~x18 & ~x17 & new_n192_ & ~x16 & ~x21;
  assign new_n192_ = ~x14 & ~x13 & ~x12 & new_n160_ & ~x11 & ~x15;
  assign z27 = ~x64 & ~x63 & new_n194_ & ~x62;
  assign new_n194_ = ~x60 & ~x59 & ~x58 & new_n195_ & ~x57 & ~x61;
  assign new_n195_ = ~x55 & ~x54 & ~x53 & new_n196_ & ~x52 & ~x56;
  assign new_n196_ = ~x50 & ~x49 & ~x48 & new_n197_ & ~x47 & ~x51;
  assign new_n197_ = ~x45 & ~x43 & ~x42 & new_n198_ & ~x41 & ~x46;
  assign new_n198_ = ~x39 & ~x37 & ~x36 & new_n199_ & ~x35 & ~x40;
  assign new_n199_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n200_ & x29;
  assign new_n200_ = ~x26 & ~x25 & ~x24 & new_n201_ & ~x22 & ~x28;
  assign new_n201_ = ~x20 & ~x18 & ~x17 & new_n202_ & ~x16 & ~x21;
  assign new_n202_ = ~x15 & ~x14 & x13 & ~x12 & new_n160_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n204_ & ~x50;
  assign new_n204_ = ~x43 & ~x40 & ~x39 & new_n205_ & ~x37 & ~x46;
  assign new_n205_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  ...
  assign new_n214_ = ~x22 & ~x21 & ~x18 & new_n170_ & ~x17;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n216_ & ~x60 & ~x64;
  assign new_n216_ = ~x58 & ~x57 & ~x56 & new_n217_ & ~x55 & ~x59;
  assign new_n217_ = ~x53 & ~x51 & ~x50 & new_n218_ & ~x49 & ~x54;
  assign new_n218_ = ~x47 & ~x46 & ~x45 & new_n219_ & ~x43 & ~x48;
  assign new_n219_ = ~x41 & ~x40 & ~x39 & new_n220_ & ~x37 & ~x42;
  assign new_n220_ = ~x35 & ~x34 & ~x33 & new_n221_ & ~x31 & ~x36;
  assign new_n221_ = ~x30 & x29 & ~x28 & ~x26 & new_n222_ & ~x25;
  assign new_n222_ = ~x24 & ~x22 & x21 & ~x18 & new_n170_ & ~x17;
  assign z34 = new_n224_ & x58;
  assign new_n224_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n226_ & ~x60;
  assign new_n226_ = ~x56 & ~x55 & ~x51 & new_n227_ & ~x50 & ~x58;
  assign new_n227_ = ~x46 & ~x43 & ~x41 & new_n228_ & ~x40 & ~x47;
  assign new_n228_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n229_ & x29;
  assign new_n229_ = ~x26 & ~x25 & ~x24 & new_n230_ & ~x22 & ~x28;
  assign new_n230_ = ~x15 & ~x14 & ~x11 & new_n231_ & ~x10 & ~x18;
  assign new_n231_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z37 = ~x63 & ~x62 & ~x61 & new_n233_ & ~x60 & ~x64;
  assign new_n233_ = ~x58 & ~x57 & ~x56 & new_n234_ & ~x55 & ~x59;
  assign new_n234_ = ~x53 & ~x52 & ~x51 & new_n235_ & ~x50 & ~x54;
  assign new_n235_ = ~x48 & ~x47 & ~x46 & new_n236_ & ~x45 & ~x49;
  assign new_n236_ = ~x42 & ~x41 & ~x40 & new_n237_ & ~x39 & ~x43;
  assign new_n237_ = ~x36 & ~x35 & ~x34 & new_n238_ & ~x33 & ~x37;
  assign new_n238_ = ~x32 & ~x31 & ~x30 & x29 & new_n239_ & ~x28;
  assign new_n239_ = ~x25 & ~x24 & ~x22 & new_n240_ & ~x21 & ~x26;
  assign new_n240_ = ~x20 & x19 & ~x18 & ~x17 & new_n192_ & ~x16;
  assign z38 = ~x62 & ~x61 & new_n242_ & ~x60;
  assign new_n242_ = ~x58 & ~x56 & ~x55 & new_n243_ & ~x51 & x59;
  assign new_n243_ = ~x47 & ~x46 & ~x43 & new_n244_ & ~x42 & ~x50;
  ...
  assign new_n250_ = ~x58 & ~x56 & ~x55 & new_n251_ & ~x51 & ~x60;
  ...
  assign new_n256_ = ~x37 & ~x35 & ~x34 & new_n257_ & ~x33 & ~x39;
  assign new_n257_ = ~x30 & x29 & ~x28 & new_n258_ & ~x26;
  assign new_n258_ = ~x24 & ~x22 & ~x18 & new_n259_ & ~x17 & ~x25;
  assign new_n259_ = ~x14 & ~x11 & ~x10 & new_n248_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n261_ & ~x58 & ~x62;
  assign new_n261_ = ~x55 & ~x51 & ~x50 & new_n262_ & ~x47 & ~x56;
  assign new_n262_ = ~x43 & ~x42 & ~x41 & new_n263_ & ~x40 & ~x46;
  assign new_n263_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n257_ & x33;
  assign z42 = ~x62 & new_n265_ & ~x61;
  assign new_n265_ = ~x59 & ~x58 & ~x56 & new_n266_ & ~x55 & ~x60;
  assign new_n266_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n154_ & x49;
  ...
  assign new_n312_ = ~x56 & ~x55 & new_n153_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n314_ & ~x60;
  assign new_n314_ = ~x58 & ~x56 & ~x55 & new_n315_ & ~x54 & ~x59;
  assign new_n315_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n154_ & x48;
  ...
  assign new_n324_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n159_ & x12;
  ...
  assign new_n334_ = ~x21 & x20 & ~x18 & ~x17 & new_n170_ & ~x16;
  ...
  assign new_n347_ = ~x40 & ~x39 & ~x37 & new_n348_ & ~x30 & ~x43;
