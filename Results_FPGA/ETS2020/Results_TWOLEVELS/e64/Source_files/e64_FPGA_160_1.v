...
module FAU ( 
  ...
  assign new_n147_ = ~x57 & ~x56 & ~x55 & new_n148_ & ~x54 & ~x58;
  assign new_n148_ = ~x51 & ~x50 & ~x49 & new_n149_ & ~x48 & ~x53;
  assign new_n149_ = ~x47 & ~x46 & ~x45 & new_n150_ & ~x43;
  assign new_n150_ = ~x41 & ~x40 & ~x39 & new_n151_ & ~x37 & ~x42;
  assign new_n151_ = ~x34 & ~x33 & ~x31 & new_n152_ & ~x30 & ~x35;
  assign new_n152_ = ~x28 & ~x26 & ~x25 & new_n153_ & ~x24 & x29;
  assign new_n153_ = ~x18 & ~x17 & ~x15 & new_n154_ & ~x14 & ~x22;
  assign new_n154_ = new_n155_ & ~x11;
  assign new_n155_ = ~x09 & ~x08 & ~x07 & new_n156_ & ~x06 & ~x10;
  assign new_n156_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z21 = ~x62 & ~x60 & new_n158_ & ~x58;
  assign new_n158_ = ~x50 & ~x47 & ~x46 & new_n159_ & ~x43 & ~x56;
  assign new_n159_ = ~x40 & ~x39 & ~x37 & new_n160_ & ~x30 & ~x41;
  assign new_n160_ = ~x28 & ~x26 & ~x25 & new_n161_ & ~x24 & x29;
  assign new_n161_ = ~x18 & ~x15 & ~x14 & new_n162_ & ~x11 & ~x22;
  assign new_n162_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  ...
  assign new_n167_ = ~x46 & ~x45 & ~x43 & new_n168_ & ~x42 & ~x47;
  assign new_n168_ = ~x40 & ~x39 & ~x37 & new_n169_ & ~x36 & ~x41;
  assign new_n169_ = ~x34 & ~x33 & ~x31 & new_n170_ & ~x30 & ~x35;
  assign new_n170_ = ~x28 & ~x26 & ~x25 & new_n171_ & ~x24 & x29;
  assign new_n171_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n172_ & x16;
  assign new_n172_ = ~x15 & ~x14 & ~x12 & new_n155_ & ~x11;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n174_ & ~x43 & ~x60;
  ...
  assign new_n181_ = ~x37 & ~x36 & ~x35 & new_n182_ & ~x34 & ~x39;
  assign new_n182_ = ~x33 & x32 & ~x31 & ~x30 & new_n183_ & x29;
  assign new_n183_ = ~x26 & ~x25 & ~x24 & new_n184_ & ~x22 & ~x28;
  assign new_n184_ = ~x20 & ~x18 & ~x17 & new_n185_ & ~x16 & ~x21;
  assign new_n185_ = ~x14 & ~x13 & ~x12 & new_n155_ & ~x11 & ~x15;
  assign z27 = ~x64 & ~x63 & new_n187_ & ~x62;
  assign new_n187_ = ~x60 & ~x59 & ~x58 & new_n188_ & ~x57 & ~x61;
  assign new_n188_ = ~x55 & ~x54 & ~x53 & new_n189_ & ~x52 & ~x56;
  assign new_n189_ = ~x50 & ~x49 & ~x48 & new_n190_ & ~x47 & ~x51;
  assign new_n190_ = ~x45 & ~x43 & ~x42 & new_n191_ & ~x41 & ~x46;
  assign new_n191_ = ~x39 & ~x37 & ~x36 & new_n192_ & ~x35 & ~x40;
  assign new_n192_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n193_ & x29;
  assign new_n193_ = ~x26 & ~x25 & ~x24 & new_n194_ & ~x22 & ~x28;
  assign new_n194_ = ~x20 & ~x18 & ~x17 & new_n195_ & ~x16 & ~x21;
  assign new_n195_ = ~x15 & ~x14 & x13 & ~x12 & new_n155_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n197_ & ~x50;
  assign new_n197_ = ~x43 & ~x40 & ~x39 & new_n198_ & ~x37 & ~x46;
  assign new_n198_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n200_ & ~x60 & ~x64;
  ...
  assign new_n207_ = ~x22 & ~x21 & ~x18 & new_n172_ & ~x17;
  ...
  assign new_n215_ = ~x24 & ~x22 & x21 & ~x18 & new_n172_ & ~x17;
  ...
  assign new_n233_ = ~x20 & x19 & ~x18 & ~x17 & new_n185_ & ~x16;
  ...
  assign new_n259_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n149_ & x49;
  ...
  assign new_n305_ = ~x56 & ~x55 & new_n148_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n307_ & ~x60;
  assign new_n307_ = ~x58 & ~x56 & ~x55 & new_n308_ & ~x54 & ~x59;
  assign new_n308_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n149_ & x48;
  ...
  assign new_n317_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n154_ & x12;
  assign z53 = ~x64 & new_n146_ & x63;
  ...
  assign new_n327_ = ~x21 & x20 & ~x18 & ~x17 & new_n172_ & ~x16;
