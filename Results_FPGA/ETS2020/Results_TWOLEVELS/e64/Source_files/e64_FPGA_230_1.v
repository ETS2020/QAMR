...
module FAU ( 
  ...
  assign z23 = ~x64 & new_n158_ & ~x63;
  assign new_n158_ = ~x61 & ~x60 & ~x59 & new_n159_ & ~x58 & ~x62;
  assign new_n159_ = ~x56 & ~x55 & ~x54 & new_n160_ & ~x53 & ~x57;
  assign new_n160_ = ~x51 & ~x50 & ~x49 & new_n161_ & ~x48 & ~x52;
  assign new_n161_ = ~x46 & ~x45 & ~x43 & new_n162_ & ~x42 & ~x47;
  assign new_n162_ = ~x40 & ~x39 & ~x37 & new_n163_ & ~x36 & ~x41;
  assign new_n163_ = ~x34 & ~x33 & ~x31 & new_n164_ & ~x30 & ~x35;
  assign new_n164_ = ~x28 & ~x26 & ~x25 & new_n165_ & ~x24 & x29;
  assign new_n165_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n166_ & x16;
  assign new_n166_ = ~x15 & ~x14 & ~x12 & new_n155_ & ~x11;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n168_ & ~x43 & ~x60;
  assign new_n168_ = ~x40 & ~x39 & ~x37 & x29 & new_n169_ & ~x28;
  assign new_n169_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n171_ & ~x46;
  assign new_n171_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n172_ & x29;
  assign new_n172_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = ~x64 & ~x63 & ~x62 & new_n174_ & ~x61;
  ...
  assign new_n180_ = ~x26 & ~x25 & ~x24 & new_n181_ & ~x22 & ~x28;
  assign new_n181_ = ~x20 & ~x18 & ~x17 & new_n182_ & ~x16 & ~x21;
  assign new_n182_ = ~x14 & ~x13 & ~x12 & new_n155_ & ~x11 & ~x15;
  assign z27 = ~x64 & ~x63 & new_n184_ & ~x62;
  ...
  assign new_n187_ = ~x45 & ~x43 & ~x42 & new_n188_ & ~x41 & ~x46;
  assign new_n188_ = ~x39 & ~x37 & ~x36 & new_n189_ & ~x35 & ~x40;
  ...
  assign new_n192_ = ~x15 & ~x14 & x13 & ~x12 & new_n155_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n194_ & ~x50;
  assign new_n194_ = ~x43 & ~x40 & ~x39 & new_n195_ & ~x37 & ~x46;
  assign new_n195_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n197_ & ~x60 & ~x64;
  ...
  assign new_n200_ = ~x43 & ~x42 & ~x41 & new_n201_ & ~x40;
  assign new_n201_ = ~x37 & ~x36 & ~x35 & new_n202_ & ~x34 & ~x39;
  assign new_n202_ = ~x33 & ~x31 & ~x30 & new_n203_ & x29;
  assign new_n203_ = ~x28 & ~x26 & ~x25 & new_n204_ & ~x24;
  assign new_n204_ = ~x22 & ~x21 & ~x18 & new_n166_ & ~x17;
  ...
  assign new_n212_ = ~x24 & ~x22 & x21 & ~x18 & new_n166_ & ~x17;
  assign z34 = new_n214_ & x58;
  assign new_n214_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  ...
  assign new_n230_ = ~x20 & x19 & ~x18 & ~x17 & new_n182_ & ~x16;
  ...
  assign new_n256_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n149_ & x49;
  ...
  assign new_n302_ = ~x56 & ~x55 & new_n148_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n304_ & ~x60;
  assign new_n304_ = ~x58 & ~x56 & ~x55 & new_n305_ & ~x54 & ~x59;
  assign new_n305_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n149_ & x48;
  ...
  assign new_n314_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n154_ & x12;
  ...
  assign new_n324_ = ~x21 & x20 & ~x18 & ~x17 & new_n166_ & ~x16;
