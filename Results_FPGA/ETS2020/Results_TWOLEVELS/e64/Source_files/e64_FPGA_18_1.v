...
module FAU ( 
  ...
  assign z17 = ~x62 & new_n162_ & ~x60;
  assign new_n162_ = ~x56 & ~x50 & ~x47 & new_n163_ & ~x46 & ~x58;
  assign new_n163_ = ~x40 & ~x39 & ~x37 & new_n164_ & ~x30 & ~x43;
  assign new_n164_ = ~x28 & ~x25 & ~x24 & new_n165_ & ~x15 & x29;
  assign new_n165_ = ~x11 & ~x10 & ~x08 & x03 & ~x07 & ~x14;
  assign z19 = new_n167_ & x64;
  assign new_n167_ = ~x62 & ~x61 & ~x60 & new_n168_ & ~x59;
  assign new_n168_ = ~x57 & ~x56 & ~x55 & new_n169_ & ~x54 & ~x58;
  assign new_n169_ = ~x51 & ~x50 & ~x49 & new_n170_ & ~x48 & ~x53;
  assign new_n170_ = ~x47 & ~x46 & ~x45 & new_n171_ & ~x43;
  assign new_n171_ = ~x41 & ~x40 & ~x39 & new_n172_ & ~x37 & ~x42;
  assign new_n172_ = ~x34 & ~x33 & ~x31 & new_n173_ & ~x30 & ~x35;
  assign new_n173_ = ~x28 & ~x26 & ~x25 & new_n174_ & ~x24 & x29;
  assign new_n174_ = ~x18 & ~x17 & ~x15 & new_n175_ & ~x14 & ~x22;
  assign new_n175_ = new_n176_ & ~x11;
  assign new_n176_ = ~x09 & ~x08 & ~x07 & new_n177_ & ~x06 & ~x10;
  assign new_n177_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  ...
  assign new_n186_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n187_ & x16;
  assign new_n187_ = ~x15 & ~x14 & ~x12 & new_n176_ & ~x11;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n189_ & ~x43 & ~x60;
  assign new_n189_ = ~x40 & ~x39 & ~x37 & x29 & new_n190_ & ~x28;
  assign new_n190_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n192_ & ~x46;
  assign new_n192_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n193_ & x29;
  assign new_n193_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = ~x64 & ~x63 & ~x62 & new_n195_ & ~x61;
  ...
  assign new_n203_ = ~x14 & ~x13 & ~x12 & new_n176_ & ~x11 & ~x15;
  ...
  assign new_n213_ = ~x15 & ~x14 & x13 & ~x12 & new_n176_ & ~x11;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n215_ & ~x60 & ~x64;
  assign new_n215_ = ~x58 & ~x57 & ~x56 & new_n216_ & ~x55 & ~x59;
  assign new_n216_ = ~x54 & ~x53 & x52 & ~x51 & new_n217_ & ~x50;
  assign new_n217_ = ~x48 & ~x47 & ~x46 & new_n218_ & ~x45 & ~x49;
  assign new_n218_ = ~x43 & ~x42 & ~x41 & new_n219_ & ~x40;
  assign new_n219_ = ~x37 & ~x36 & ~x35 & new_n220_ & ~x34 & ~x39;
  assign new_n220_ = ~x33 & ~x31 & ~x30 & new_n221_ & x29;
  assign new_n221_ = ~x28 & ~x26 & ~x25 & new_n222_ & ~x24;
  assign new_n222_ = ~x22 & ~x21 & ~x18 & new_n187_ & ~x17;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n224_ & ~x60 & ~x64;
  assign new_n224_ = ~x58 & ~x57 & ~x56 & new_n225_ & ~x55 & ~x59;
  assign new_n225_ = ~x53 & ~x51 & ~x50 & new_n226_ & ~x49 & ~x54;
  assign new_n226_ = ~x47 & ~x46 & ~x45 & new_n227_ & ~x43 & ~x48;
  assign new_n227_ = ~x41 & ~x40 & ~x39 & new_n228_ & ~x37 & ~x42;
  assign new_n228_ = ~x35 & ~x34 & ~x33 & new_n229_ & ~x31 & ~x36;
  assign new_n229_ = ~x30 & x29 & ~x28 & ~x26 & new_n230_ & ~x25;
  assign new_n230_ = ~x24 & ~x22 & x21 & ~x18 & new_n187_ & ~x17;
  assign z35 = ~x62 & ~x61 & new_n232_ & ~x60;
  assign new_n232_ = ~x56 & ~x55 & ~x51 & new_n233_ & ~x50 & ~x58;
  assign new_n233_ = ~x46 & ~x43 & ~x41 & new_n234_ & ~x40 & ~x47;
  assign new_n234_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n235_ & x29;
  assign new_n235_ = ~x26 & ~x25 & ~x24 & new_n236_ & ~x22 & ~x28;
  assign new_n236_ = ~x15 & ~x14 & ~x11 & new_n237_ & ~x10 & ~x18;
  assign new_n237_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z37 = ~x63 & ~x62 & ~x61 & new_n239_ & ~x60 & ~x64;
  assign new_n239_ = ~x58 & ~x57 & ~x56 & new_n240_ & ~x55 & ~x59;
  assign new_n240_ = ~x53 & ~x52 & ~x51 & new_n241_ & ~x50 & ~x54;
  assign new_n241_ = ~x48 & ~x47 & ~x46 & new_n242_ & ~x45 & ~x49;
  assign new_n242_ = ~x42 & ~x41 & ~x40 & new_n243_ & ~x39 & ~x43;
  assign new_n243_ = ~x36 & ~x35 & ~x34 & new_n244_ & ~x33 & ~x37;
  assign new_n244_ = ~x32 & ~x31 & ~x30 & x29 & new_n245_ & ~x28;
  assign new_n245_ = ~x25 & ~x24 & ~x22 & new_n246_ & ~x21 & ~x26;
  assign new_n246_ = ~x20 & x19 & ~x18 & ~x17 & new_n203_ & ~x16;
  ...
  assign new_n272_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n170_ & x49;
  ...
  assign new_n318_ = ~x56 & ~x55 & new_n169_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n320_ & ~x60;
  assign new_n320_ = ~x58 & ~x56 & ~x55 & new_n321_ & ~x54 & ~x59;
  assign new_n321_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n170_ & x48;
  ...
  assign new_n330_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n175_ & x12;
  assign z53 = ~x64 & new_n167_ & x63;
  ...
  assign new_n340_ = ~x21 & x20 & ~x18 & ~x17 & new_n187_ & ~x16;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n342_ & ~x50 & ~x62;
  assign new_n342_ = ~x46 & ~x43 & ~x41 & new_n343_ & ~x40 & ~x47;
  assign new_n343_ = ~x39 & ~x37 & ~x30 & x29 & new_n344_ & ~x28;
  assign new_n344_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n345_ & x18;
  assign new_n345_ = ~x15 & new_n346_ & ~x14;
  assign new_n346_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n348_ & ~x56;
  assign new_n348_ = ~x47 & ~x46 & ~x43 & new_n349_ & ~x41 & ~x50;
  assign new_n349_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n350_ & x29;
  assign new_n350_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n345_ & x22;
