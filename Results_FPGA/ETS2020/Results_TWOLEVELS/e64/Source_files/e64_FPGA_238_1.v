...
module FAU ( 
  ...
  assign z12 = ~x60 & ~x58 & ~x56 & new_n143_ & ~x50 & ~x62;
  assign new_n143_ = ~x46 & ~x43 & ~x41 & new_n144_ & ~x40 & ~x47;
  assign new_n144_ = ~x39 & ~x37 & ~x30 & x29 & new_n145_ & ~x28;
  assign new_n145_ = ~x25 & ~x24 & ~x15 & new_n146_ & ~x14 & ~x26;
  ...
  assign z22 = ~x64 & ~x63 & ~x62 & new_n165_ & ~x61;
  assign new_n165_ = ~x59 & ~x58 & ~x57 & new_n166_ & ~x56 & ~x60;
  assign new_n166_ = ~x54 & ~x53 & ~x51 & new_n167_ & ~x50 & ~x55;
  ...
  assign new_n171_ = ~x24 & ~x22 & ~x18 & new_n172_ & ~x17 & ~x25;
  assign new_n172_ = ~x15 & ~x14 & ~x12 & new_n162_ & ~x11;
  assign z23 = ~x64 & new_n174_ & ~x63;
  assign new_n174_ = ~x61 & ~x60 & ~x59 & new_n175_ & ~x58 & ~x62;
  assign new_n175_ = ~x56 & ~x55 & ~x54 & new_n176_ & ~x53 & ~x57;
  assign new_n176_ = ~x51 & ~x50 & ~x49 & new_n177_ & ~x48 & ~x52;
  assign new_n177_ = ~x46 & ~x45 & ~x43 & new_n178_ & ~x42 & ~x47;
  assign new_n178_ = ~x40 & ~x39 & ~x37 & new_n179_ & ~x36 & ~x41;
  assign new_n179_ = ~x34 & ~x33 & ~x31 & new_n180_ & ~x30 & ~x35;
  assign new_n180_ = ~x28 & ~x26 & ~x25 & new_n181_ & ~x24 & x29;
  assign new_n181_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n172_ & x16;
  ...
  assign new_n194_ = ~x14 & ~x13 & ~x12 & new_n162_ & ~x11 & ~x15;
  ...
  assign new_n204_ = ~x15 & ~x14 & x13 & ~x12 & new_n162_ & ~x11;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n206_ & ~x60 & ~x64;
  assign new_n206_ = ~x58 & ~x57 & ~x56 & new_n207_ & ~x55 & ~x59;
  assign new_n207_ = ~x53 & ~x51 & ~x50 & new_n208_ & ~x49 & ~x54;
  assign new_n208_ = ~x47 & ~x46 & ~x45 & new_n209_ & ~x43 & ~x48;
  assign new_n209_ = ~x41 & ~x40 & ~x39 & new_n210_ & ~x37 & ~x42;
  assign new_n210_ = ~x35 & ~x34 & ~x33 & new_n211_ & ~x31 & ~x36;
  assign new_n211_ = ~x30 & x29 & ~x28 & ~x26 & new_n212_ & ~x25;
  assign new_n212_ = ~x24 & ~x22 & x21 & ~x18 & new_n172_ & ~x17;
  ...
  assign z37 = ~x63 & ~x62 & ~x61 & new_n221_ & ~x60 & ~x64;
  assign new_n221_ = ~x58 & ~x57 & ~x56 & new_n222_ & ~x55 & ~x59;
  assign new_n222_ = ~x53 & ~x52 & ~x51 & new_n223_ & ~x50 & ~x54;
  assign new_n223_ = ~x48 & ~x47 & ~x46 & new_n224_ & ~x45 & ~x49;
  assign new_n224_ = ~x42 & ~x41 & ~x40 & new_n225_ & ~x39 & ~x43;
  assign new_n225_ = ~x36 & ~x35 & ~x34 & new_n226_ & ~x33 & ~x37;
  assign new_n226_ = ~x32 & ~x31 & ~x30 & x29 & new_n227_ & ~x28;
  assign new_n227_ = ~x25 & ~x24 & ~x22 & new_n228_ & ~x21 & ~x26;
  assign new_n228_ = ~x20 & x19 & ~x18 & ~x17 & new_n194_ & ~x16;
  assign z38 = ~x62 & ~x61 & new_n230_ & ~x60;
  assign new_n230_ = ~x58 & ~x56 & ~x55 & new_n231_ & ~x51 & x59;
  assign new_n231_ = ~x47 & ~x46 & ~x43 & new_n232_ & ~x42 & ~x50;
  ...
  assign new_n238_ = ~x58 & ~x56 & ~x55 & new_n239_ & ~x51 & ~x60;
  assign new_n239_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n232_ & x42;
  ...
  assign new_n277_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n245_ & x34;
  ...
  assign new_n284_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n236_ & x09;
  ...
  assign new_n290_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n235_ & x17;
  ...
  assign new_n295_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n245_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n297_ & ~x59;
  assign new_n297_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n242_ & x53;
  assign z50 = new_n299_ & ~x62;
  assign new_n299_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n300_ & x57;
  assign new_n300_ = ~x56 & ~x55 & new_n155_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n302_ & ~x60;
  assign new_n302_ = ~x58 & ~x56 & ~x55 & new_n303_ & ~x54 & ~x59;
  assign new_n303_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n156_ & x48;
  assign z52 = new_n305_ & ~x64;
  assign new_n305_ = ~x62 & ~x61 & ~x60 & new_n306_ & ~x59 & ~x63;
  assign new_n306_ = ~x57 & ~x56 & ~x55 & new_n307_ & ~x54 & ~x58;
  assign new_n307_ = ~x51 & ~x50 & ~x49 & new_n308_ & ~x48 & ~x53;
  ...
  assign new_n312_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n161_ & x12;
  ...
  assign new_n322_ = ~x21 & x20 & ~x18 & ~x17 & new_n172_ & ~x16;
