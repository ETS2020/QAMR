...
module FAU ( 
  ...
  wire new_n137_, new_n138_, new_n139_, new_n140_, new_n142_, new_n143_,
    ...
    new_n313_, new_n315_, new_n317_, new_n318_, new_n320_, new_n321_,
  ...
  assign new_n154_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n155_ & ~x48;
  assign new_n155_ = ~x47 & ~x46 & ~x45 & new_n156_ & ~x43;
  assign new_n156_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n157_ & ~x37;
  assign new_n157_ = ~x35 & ~x34 & ~x33 & ~x31 & new_n158_ & ~x30;
  assign new_n158_ = x29 & ~x28 & ~x26 & ~x25 & new_n159_ & ~x24;
  assign new_n159_ = ~x22 & ~x18 & ~x17 & ~x15 & new_n160_ & ~x14;
  ...
  assign new_n170_ = ~x60 & ~x59 & ~x58 & ~x57 & new_n171_ & ~x56;
  assign new_n171_ = ~x55 & ~x54 & ~x53 & ~x51 & new_n172_ & ~x50;
  assign new_n172_ = ~x49 & ~x48 & ~x47 & ~x46 & new_n173_ & ~x45;
  assign new_n173_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n174_ & ~x39;
  assign new_n174_ = ~x37 & x36 & ~x35 & ~x34 & new_n175_ & ~x33;
  assign new_n175_ = ~x31 & ~x30 & x29 & ~x28 & new_n176_ & ~x26;
  assign new_n176_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n177_ & ~x17;
  assign new_n177_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z23 = ~x64 & new_n179_ & ~x63;
  assign new_n179_ = ~x62 & ~x61 & ~x60 & ~x59 & new_n180_ & ~x58;
  assign new_n180_ = ~x57 & ~x56 & ~x55 & ~x54 & new_n181_ & ~x53;
  assign new_n181_ = ~x52 & ~x51 & ~x50 & ~x49 & new_n182_ & ~x48;
  assign new_n182_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n183_ & ~x42;
  assign new_n183_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n184_ & ~x36;
  assign new_n184_ = ~x35 & ~x34 & ~x33 & ~x31 & new_n185_ & ~x30;
  assign new_n185_ = x29 & ~x28 & ~x26 & ~x25 & new_n186_ & ~x24;
  assign new_n186_ = ~x22 & ~x21 & ~x18 & new_n177_ & x16 & ~x17;
  ...
  assign new_n199_ = ~x33 & x32 & ~x31 & new_n200_ & x29 & ~x30;
  assign new_n200_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n201_ & ~x22;
  assign new_n201_ = ~x21 & ~x20 & ~x18 & ~x17 & new_n202_ & ~x16;
  assign new_n202_ = ~x15 & ~x14 & ~x13 & ~x12 & new_n161_ & ~x11;
  ...
  assign new_n230_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n231_ & ~x31;
  ...
  assign new_n237_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n238_ & ~x40;
  assign new_n238_ = ~x39 & ~x37 & ~x35 & new_n239_ & x29 & ~x30;
  assign new_n239_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n240_ & ~x22;
  assign new_n240_ = ~x18 & ~x15 & ~x14 & ~x11 & new_n241_ & ~x10;
  assign new_n241_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z37 = ~x64 & ~x63 & ~x62 & ~x61 & new_n243_ & ~x60;
  assign new_n243_ = ~x59 & ~x58 & ~x57 & ~x56 & new_n244_ & ~x55;
  assign new_n244_ = ~x54 & ~x53 & ~x52 & ~x51 & new_n245_ & ~x50;
  assign new_n245_ = ~x49 & ~x48 & ~x47 & ~x46 & new_n246_ & ~x45;
  assign new_n246_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n247_ & ~x39;
  assign new_n247_ = ~x37 & ~x36 & ~x35 & ~x34 & new_n248_ & ~x33;
  assign new_n248_ = ~x32 & ~x31 & ~x30 & x29 & new_n249_ & ~x28;
  assign new_n249_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n250_ & ~x21;
  assign new_n250_ = ~x20 & x19 & ~x18 & ~x17 & new_n202_ & ~x16;
  ...
  assign new_n261_ = ~x50 & ~x47 & ~x46 & new_n254_ & x42 & ~x43;
  assign z40 = ~x62 & ~x61 & new_n263_ & ~x60;
  assign new_n263_ = ~x59 & ~x58 & ~x56 & new_n264_ & x54 & ~x55;
  ...
  assign new_n272_ = ~x54 & ~x53 & ~x51 & new_n155_ & x49 & ~x50;
  ...
  assign new_n278_ = ~x34 & ~x33 & ~x31 & new_n279_ & x29 & ~x30;
  ...
  assign z44 = ~x62 & ~x61 & ~x60 & ~x59 & new_n284_ & ~x58;
  ...
  assign new_n293_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n294_ & ~x50;
  assign new_n294_ = ~x47 & ~x46 & ~x43 & ~x42 & new_n295_ & ~x41;
  assign new_n295_ = ~x40 & ~x39 & ~x37 & new_n267_ & x34 & ~x35;
  ...
  assign new_n302_ = ~x15 & ~x14 & ~x11 & new_n258_ & x09 & ~x10;
  ...
  assign new_n308_ = ~x25 & ~x24 & ~x22 & new_n257_ & x17 & ~x18;
  ...
  assign new_n313_ = ~x37 & ~x35 & ~x34 & new_n267_ & x31 & ~x33;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n315_ & ~x59;
  assign new_n315_ = ~x58 & ~x56 & ~x55 & new_n264_ & x53 & ~x54;
  assign z50 = new_n317_ & ~x62;
  assign new_n317_ = ~x61 & ~x60 & ~x59 & new_n318_ & x57 & ~x58;
  assign new_n318_ = ~x56 & ~x55 & new_n154_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n320_ & ~x60;
  assign new_n320_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n321_ & ~x54;
  assign new_n321_ = ~x53 & ~x51 & ~x50 & new_n155_ & x48 & ~x49;
  assign z52 = new_n323_ & ~x64;
  assign new_n323_ = ~x63 & ~x62 & ~x61 & ~x60 & new_n324_ & ~x59;
  assign new_n324_ = ~x58 & ~x57 & ~x56 & ~x55 & new_n325_ & ~x54;
  assign new_n325_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n326_ & ~x48;
  ...
  assign new_n330_ = ~x18 & ~x17 & ~x15 & new_n160_ & x12 & ~x14;
  assign z53 = new_n152_ & x63 & ~x64;
  assign z56 = ~x64 & ~x63 & new_n333_ & ~x62;
  assign new_n333_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n334_ & ~x57;
  assign new_n334_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n335_ & ~x52;
  assign new_n335_ = ~x51 & ~x50 & ~x49 & ~x48 & new_n336_ & ~x47;
  assign new_n336_ = ~x46 & ~x45 & ~x43 & ~x42 & new_n337_ & ~x41;
  assign new_n337_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n338_ & ~x35;
  assign new_n338_ = ~x34 & ~x33 & ~x31 & new_n339_ & x29 & ~x30;
  assign new_n339_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n340_ & ~x22;
  assign new_n340_ = ~x21 & x20 & ~x18 & ~x17 & new_n177_ & ~x16;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n342_ & ~x50;
  assign new_n342_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n343_ & ~x40;
  assign new_n343_ = ~x39 & ~x37 & ~x30 & x29 & new_n344_ & ~x28;
  assign new_n344_ = ~x26 & ~x25 & ~x24 & new_n345_ & x18 & ~x22;
  ...
  assign new_n349_ = ~x40 & ~x39 & ~x37 & new_n350_ & x29 & ~x30;
  assign new_n350_ = ~x28 & ~x26 & ~x25 & new_n345_ & x22 & ~x24;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n352_ & x47 & ~x50;
  assign new_n352_ = new_n353_ & ~x46;
  assign new_n353_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n354_ & ~x30;
  ...
  assign new_n358_ = ~x43 & ~x40 & ~x39 & new_n354_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
