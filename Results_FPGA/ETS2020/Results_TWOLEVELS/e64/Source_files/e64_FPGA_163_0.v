// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:14 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n271_, new_n272_, new_n273_, new_n274_, new_n278_, new_n280_,
  ...
  assign z23 = ~x63 & ~x62 & new_n218_ & ~x61 & ~x64;
  assign new_n218_ = ~x60 & ~x58 & ~x57 & new_n219_ & ~x56 & ~x59;
  assign new_n219_ = ~x55 & ~x53 & ~x52 & new_n220_ & ~x51 & ~x54;
  assign new_n220_ = ~x50 & ~x48 & ~x47 & new_n221_ & ~x46 & ~x49;
  assign new_n221_ = ~x45 & ~x42 & ~x41 & new_n222_ & ~x40 & ~x43;
  assign new_n222_ = ~x39 & ~x36 & ~x35 & new_n223_ & ~x34 & ~x37;
  assign new_n223_ = ~x33 & ~x31 & ~x30 & x29 & new_n224_ & ~x28;
  assign new_n224_ = ~x26 & ~x24 & ~x22 & new_n225_ & ~x21 & ~x25;
  assign new_n225_ = ~x18 & ~x17 & x16 & ~x15 & new_n226_ & ~x14;
  assign new_n226_ = new_n209_ & ~x12;
  assign z24 = ~x60 & ~x50 & ~x46 & new_n228_ & ~x43 & ~x58;
  assign new_n228_ = ~x40 & ~x39 & ~x37 & x29 & new_n229_ & ~x28;
  assign new_n229_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x58 & ~x50 & new_n231_ & ~x46 & ~x60;
  assign new_n231_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n232_ & x29;
  assign new_n232_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n234_ & ~x64;
  assign new_n234_ = ~x63 & ~x61 & ~x60 & new_n235_ & ~x59 & ~x62;
  assign new_n235_ = ~x58 & ~x56 & ~x55 & new_n236_ & ~x54 & ~x57;
  assign new_n236_ = ~x53 & ~x51 & ~x50 & new_n237_ & ~x49 & ~x52;
  ...
  assign new_n241_ = ~x25 & ~x22 & ~x21 & new_n242_ & ~x20 & ~x24;
  assign new_n242_ = ~x18 & ~x17 & new_n151_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n244_ & ~x62;
  assign new_n244_ = ~x61 & ~x59 & ~x58 & new_n245_ & ~x57 & ~x60;
  assign new_n245_ = ~x56 & ~x54 & ~x53 & new_n246_ & ~x52 & ~x55;
  assign new_n246_ = ~x51 & ~x49 & ~x48 & new_n247_ & ~x47 & ~x50;
  assign new_n247_ = ~x46 & ~x43 & ~x42 & new_n248_ & ~x41 & ~x45;
  assign new_n248_ = ~x40 & ~x37 & ~x36 & new_n249_ & ~x35 & ~x39;
  assign new_n249_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n250_ & x29;
  assign new_n250_ = ~x28 & ~x25 & ~x24 & new_n251_ & ~x22 & ~x26;
  assign new_n251_ = ~x21 & ~x18 & ~x17 & new_n252_ & ~x16 & ~x20;
  assign new_n252_ = ~x15 & ~x14 & x13 & new_n209_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n254_ & ~x50;
  assign new_n254_ = ~x46 & ~x40 & ~x39 & new_n255_ & ~x37 & ~x43;
  assign new_n255_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = ~x58 & ~x50 & new_n257_ & ~x46 & x60;
  assign new_n257_ = ~x43 & ~x40 & new_n188_ & ~x39;
  ...
  assign new_n265_ = ~x26 & ~x24 & ~x22 & new_n266_ & ~x21 & ~x25;
  assign new_n266_ = ~x17 & ~x15 & new_n226_ & ~x14 & ~x18;
  assign z31 = ~x64 & ~x63 & new_n268_ & ~x62;
  assign new_n268_ = ~x61 & ~x59 & ~x58 & new_n269_ & ~x57 & ~x60;
  assign new_n269_ = ~x56 & ~x54 & ~x53 & new_n270_ & ~x51 & ~x55;
  assign new_n270_ = ~x50 & ~x48 & ~x47 & new_n271_ & ~x46 & ~x49;
  assign new_n271_ = ~x45 & ~x42 & ~x41 & new_n272_ & ~x40 & ~x43;
  assign new_n272_ = ~x39 & ~x36 & ~x35 & new_n273_ & ~x34 & ~x37;
  assign new_n273_ = ~x33 & ~x31 & ~x30 & x29 & new_n274_ & ~x28;
  assign new_n274_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n266_ & x21;
  ...
  assign new_n282_ = ~x41 & ~x39 & ~x37 & new_n213_ & ~x35 & ~x40;
  ...
  assign new_n291_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n242_ & x19;
  assign z42 = ~x62 & new_n293_ & ~x61;
  assign new_n293_ = ~x60 & ~x58 & ~x56 & new_n294_ & ~x55 & ~x59;
  assign new_n294_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n204_ & x49;
  ...
  assign new_n315_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n202_ & x57;
  assign z51 = ~x62 & ~x61 & new_n317_ & ~x60;
  assign new_n317_ = ~x59 & ~x56 & ~x55 & new_n318_ & ~x54 & ~x58;
  assign new_n318_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n204_ & x48;
  ...
  assign new_n327_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n209_ & x12;
  ...
  assign new_n332_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n213_ & x35;
  ...
  assign new_n341_ = ~x18 & ~x16 & ~x15 & new_n226_ & ~x14 & ~x17;
