...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n334_, new_n336_, new_n337_, new_n338_, new_n339_, new_n342_;
  ...
  assign new_n150_ = ~x57 & ~x56 & ~x55 & new_n151_ & ~x54 & ~x58;
  assign new_n151_ = ~x51 & ~x50 & ~x49 & new_n152_ & ~x48 & ~x53;
  assign new_n152_ = ~x47 & ~x46 & ~x45 & new_n153_ & ~x43;
  assign new_n153_ = ~x41 & ~x40 & ~x39 & new_n154_ & ~x37 & ~x42;
  assign new_n154_ = ~x34 & ~x33 & ~x31 & new_n155_ & ~x30 & ~x35;
  assign new_n155_ = ~x28 & ~x26 & ~x25 & new_n156_ & ~x24 & x29;
  assign new_n156_ = ~x18 & ~x17 & ~x15 & new_n157_ & ~x14 & ~x22;
  assign new_n157_ = new_n158_ & ~x11;
  assign new_n158_ = ~x09 & ~x08 & ~x07 & new_n159_ & ~x06 & ~x10;
  assign new_n159_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n161_ & ~x61;
  assign new_n161_ = ~x59 & ~x58 & ~x57 & new_n162_ & ~x56 & ~x60;
  assign new_n162_ = ~x54 & ~x53 & ~x51 & new_n163_ & ~x50 & ~x55;
  assign new_n163_ = ~x48 & ~x47 & ~x46 & new_n164_ & ~x45 & ~x49;
  assign new_n164_ = ~x42 & ~x41 & ~x40 & new_n165_ & ~x39 & ~x43;
  assign new_n165_ = ~x37 & x36 & ~x35 & ~x34 & new_n166_ & ~x33;
  assign new_n166_ = ~x31 & ~x30 & x29 & ~x28 & new_n167_ & ~x26;
  assign new_n167_ = ~x24 & ~x22 & ~x18 & new_n168_ & ~x17 & ~x25;
  assign new_n168_ = ~x15 & ~x14 & ~x12 & new_n158_ & ~x11;
  assign z23 = ~x64 & new_n170_ & ~x63;
  assign new_n170_ = ~x61 & ~x60 & ~x59 & new_n171_ & ~x58 & ~x62;
  assign new_n171_ = ~x56 & ~x55 & ~x54 & new_n172_ & ~x53 & ~x57;
  assign new_n172_ = ~x51 & ~x50 & ~x49 & new_n173_ & ~x48 & ~x52;
  assign new_n173_ = ~x46 & ~x45 & ~x43 & new_n174_ & ~x42 & ~x47;
  assign new_n174_ = ~x40 & ~x39 & ~x37 & new_n175_ & ~x36 & ~x41;
  assign new_n175_ = ~x34 & ~x33 & ~x31 & new_n176_ & ~x30 & ~x35;
  assign new_n176_ = ~x28 & ~x26 & ~x25 & new_n177_ & ~x24 & x29;
  assign new_n177_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n168_ & x16;
  ...
  assign new_n190_ = ~x14 & ~x13 & ~x12 & new_n158_ & ~x11 & ~x15;
  ...
  assign new_n200_ = ~x15 & ~x14 & x13 & ~x12 & new_n158_ & ~x11;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n202_ & ~x60 & ~x64;
  assign new_n202_ = ~x58 & ~x57 & ~x56 & new_n203_ & ~x55 & ~x59;
  assign new_n203_ = ~x53 & ~x51 & ~x50 & new_n204_ & ~x49 & ~x54;
  assign new_n204_ = ~x47 & ~x46 & ~x45 & new_n205_ & ~x43 & ~x48;
  assign new_n205_ = ~x41 & ~x40 & ~x39 & new_n206_ & ~x37 & ~x42;
  assign new_n206_ = ~x35 & ~x34 & ~x33 & new_n207_ & ~x31 & ~x36;
  assign new_n207_ = ~x30 & x29 & ~x28 & ~x26 & new_n208_ & ~x25;
  assign new_n208_ = ~x24 & ~x22 & x21 & ~x18 & new_n168_ & ~x17;
  ...
  assign z37 = ~x63 & ~x62 & ~x61 & new_n219_ & ~x60 & ~x64;
  assign new_n219_ = ~x58 & ~x57 & ~x56 & new_n220_ & ~x55 & ~x59;
  assign new_n220_ = ~x53 & ~x52 & ~x51 & new_n221_ & ~x50 & ~x54;
  assign new_n221_ = ~x48 & ~x47 & ~x46 & new_n222_ & ~x45 & ~x49;
  assign new_n222_ = ~x42 & ~x41 & ~x40 & new_n223_ & ~x39 & ~x43;
  assign new_n223_ = ~x36 & ~x35 & ~x34 & new_n224_ & ~x33 & ~x37;
  assign new_n224_ = ~x32 & ~x31 & ~x30 & x29 & new_n225_ & ~x28;
  assign new_n225_ = ~x25 & ~x24 & ~x22 & new_n226_ & ~x21 & ~x26;
  assign new_n226_ = ~x20 & x19 & ~x18 & ~x17 & new_n190_ & ~x16;
  assign z38 = ~x62 & ~x61 & new_n228_ & ~x60;
  assign new_n228_ = ~x58 & ~x56 & ~x55 & new_n229_ & ~x51 & x59;
  assign new_n229_ = ~x47 & ~x46 & ~x43 & new_n230_ & ~x42 & ~x50;
  ...
  assign new_n236_ = ~x58 & ~x56 & ~x55 & new_n237_ & ~x51 & ~x60;
  ...
  assign new_n242_ = ~x37 & ~x35 & ~x34 & new_n243_ & ~x33 & ~x39;
  assign new_n243_ = ~x30 & x29 & ~x28 & new_n244_ & ~x26;
  assign new_n244_ = ~x24 & ~x22 & ~x18 & new_n245_ & ~x17 & ~x25;
  assign new_n245_ = ~x14 & ~x11 & ~x10 & new_n234_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n247_ & ~x58 & ~x62;
  assign new_n247_ = ~x55 & ~x51 & ~x50 & new_n248_ & ~x47 & ~x56;
  assign new_n248_ = ~x43 & ~x42 & ~x41 & new_n249_ & ~x40 & ~x46;
  assign new_n249_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n243_ & x33;
  assign z42 = ~x62 & new_n251_ & ~x61;
  assign new_n251_ = ~x59 & ~x58 & ~x56 & new_n252_ & ~x55 & ~x60;
  assign new_n252_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n152_ & x49;
  assign z43 = new_n254_ & ~x62;
  assign new_n254_ = ~x60 & ~x59 & ~x58 & new_n255_ & ~x56 & ~x61;
  assign new_n255_ = ~x54 & ~x53 & ~x51 & new_n256_ & ~x50 & ~x55;
  assign new_n256_ = ~x46 & ~x45 & ~x43 & new_n257_ & ~x42 & ~x47;
  assign new_n257_ = ~x40 & ~x39 & ~x37 & new_n258_ & ~x35 & ~x41;
  assign new_n258_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n259_ & x29;
  assign new_n259_ = ~x26 & ~x25 & ~x24 & new_n260_ & ~x22 & ~x28;
  assign new_n260_ = ~x17 & ~x15 & ~x14 & new_n261_ & ~x11 & ~x18;
  assign new_n261_ = ~x09 & ~x08 & ~x07 & new_n262_ & ~x06 & ~x10;
  assign new_n262_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n264_ & ~x58 & ~x62;
  assign new_n264_ = ~x55 & ~x54 & ~x53 & new_n265_ & ~x51 & ~x56;
  assign new_n265_ = ~x47 & ~x46 & ~x45 & new_n266_ & ~x43 & ~x50;
  assign new_n266_ = ~x41 & ~x40 & ~x39 & new_n267_ & ~x37 & ~x42;
  assign new_n267_ = ~x34 & ~x33 & ~x31 & new_n268_ & ~x30 & ~x35;
  assign new_n268_ = ~x28 & ~x26 & ~x25 & new_n269_ & ~x24 & x29;
  assign new_n269_ = ~x18 & ~x17 & ~x15 & new_n270_ & ~x14 & ~x22;
  assign new_n270_ = ~x10 & ~x09 & ~x08 & new_n271_ & ~x07 & ~x11;
  ...
  assign new_n298_ = ~x56 & ~x55 & new_n151_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n300_ & ~x60;
  assign new_n300_ = ~x58 & ~x56 & ~x55 & new_n301_ & ~x54 & ~x59;
  assign new_n301_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n152_ & x48;
  ...
  assign new_n310_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n157_ & x12;
  assign z53 = ~x64 & new_n149_ & x63;
  ...
  assign new_n320_ = ~x21 & x20 & ~x18 & ~x17 & new_n168_ & ~x16;
