...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n355_, new_n358_, new_n359_, new_n361_, new_n362_, new_n363_,
  ...
  assign new_n240_ = ~x18 & new_n241_ & ~x17;
  assign new_n241_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z23 = ~x64 & new_n243_ & ~x63;
  assign new_n243_ = ~x61 & ~x60 & ~x59 & new_n244_ & ~x58 & ~x62;
  assign new_n244_ = ~x56 & ~x55 & ~x54 & new_n245_ & ~x53 & ~x57;
  assign new_n245_ = ~x51 & ~x50 & ~x49 & new_n246_ & ~x48 & ~x52;
  assign new_n246_ = ~x46 & ~x45 & ~x43 & new_n247_ & ~x42 & ~x47;
  assign new_n247_ = ~x40 & ~x39 & ~x37 & new_n248_ & ~x36 & ~x41;
  assign new_n248_ = ~x34 & ~x33 & ~x31 & new_n249_ & ~x30 & ~x35;
  assign new_n249_ = ~x28 & ~x26 & ~x25 & new_n250_ & ~x24 & x29;
  assign new_n250_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n241_ & x16;
  ...
  assign new_n258_ = ~x43 & ~x40 & new_n203_ & ~x39;
  ...
  assign new_n266_ = ~x25 & ~x24 & ~x22 & new_n240_ & ~x21 & ~x26;
  ...
  assign new_n274_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n240_ & x21;
  ...
  assign new_n289_ = ~x40 & ~x39 & ~x37 & new_n222_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n291_ & ~x60;
  assign new_n291_ = ~x58 & ~x56 & ~x55 & new_n292_ & ~x51 & x59;
  assign new_n292_ = ~x47 & ~x46 & ~x43 & new_n293_ & ~x42 & ~x50;
  assign new_n293_ = ~x41 & ~x40 & new_n294_ & ~x39;
  assign new_n294_ = ~x37 & ~x35 & ~x30 & x29 & new_n295_ & ~x28;
  assign new_n295_ = ~x25 & ~x24 & ~x22 & new_n296_ & ~x18 & ~x26;
  assign new_n296_ = ~x15 & ~x14 & ~x11 & new_n297_ & ~x10;
  assign new_n297_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n299_ & ~x61;
  assign new_n299_ = ~x58 & ~x56 & ~x55 & new_n300_ & ~x51 & ~x60;
  assign new_n300_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n293_ & x42;
  assign z40 = ~x62 & ~x61 & new_n302_ & ~x60;
  assign new_n302_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n303_ & x54;
  assign new_n303_ = ~x51 & ~x50 & new_n304_ & ~x47;
  assign new_n304_ = ~x43 & ~x42 & ~x41 & new_n305_ & ~x40 & ~x46;
  assign new_n305_ = ~x37 & ~x35 & ~x34 & new_n306_ & ~x33 & ~x39;
  assign new_n306_ = ~x30 & x29 & ~x28 & new_n307_ & ~x26;
  assign new_n307_ = ~x24 & ~x22 & ~x18 & new_n308_ & ~x17 & ~x25;
  assign new_n308_ = ~x14 & ~x11 & ~x10 & new_n297_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n310_ & ~x58 & ~x62;
  assign new_n310_ = ~x55 & ~x51 & ~x50 & new_n311_ & ~x47 & ~x56;
  assign new_n311_ = ~x43 & ~x42 & ~x41 & new_n312_ & ~x40 & ~x46;
  assign new_n312_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n306_ & x33;
  ...
  assign z44 = ~x61 & ~x60 & ~x59 & new_n324_ & ~x58 & ~x62;
  assign new_n324_ = ~x55 & ~x54 & ~x53 & new_n325_ & ~x51 & ~x56;
  assign new_n325_ = ~x47 & ~x46 & ~x45 & new_n326_ & ~x43 & ~x50;
  assign new_n326_ = ~x41 & ~x40 & ~x39 & new_n327_ & ~x37 & ~x42;
  assign new_n327_ = ~x34 & ~x33 & ~x31 & new_n328_ & ~x30 & ~x35;
  assign new_n328_ = ~x28 & ~x26 & ~x25 & new_n329_ & ~x24 & x29;
  assign new_n329_ = ~x18 & ~x17 & ~x15 & new_n330_ & ~x14 & ~x22;
  assign new_n330_ = ~x10 & ~x09 & ~x08 & new_n331_ & ~x07 & ~x11;
  assign new_n331_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n333_ & ~x59;
  assign new_n333_ = ~x56 & ~x55 & ~x51 & new_n334_ & ~x50 & ~x58;
  assign new_n334_ = ~x46 & ~x43 & ~x42 & new_n335_ & ~x41 & ~x47;
  assign new_n335_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n306_ & x34;
  assign z46 = ~x62 & new_n337_ & ~x61;
  ...
  assign new_n342_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n297_ & x09;
  assign z47 = ~x62 & new_n344_ & ~x61;
  ...
  assign new_n347_ = ~x35 & ~x30 & x29 & ~x28 & new_n348_ & ~x26;
  assign new_n348_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n296_ & x17;
  assign z48 = ~x62 & ~x61 & new_n350_ & ~x60;
  assign new_n350_ = ~x58 & ~x56 & ~x55 & new_n351_ & ~x54 & ~x59;
  assign new_n351_ = ~x51 & ~x50 & ~x47 & new_n352_ & ~x46 & ~x53;
  assign new_n352_ = ~x42 & ~x41 & ~x40 & new_n353_ & ~x39 & ~x43;
  assign new_n353_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n306_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n355_ & ~x59;
  assign new_n355_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n303_ & x53;
  ...
  assign new_n359_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n222_ & x35;
  assign z56 = ~x64 & ~x63 & new_n361_ & ~x62;
  assign new_n361_ = ~x60 & ~x59 & ~x58 & new_n362_ & ~x57 & ~x61;
  assign new_n362_ = ~x55 & ~x54 & ~x53 & new_n363_ & ~x52 & ~x56;
  assign new_n363_ = ~x50 & ~x49 & ~x48 & new_n364_ & ~x47 & ~x51;
  assign new_n364_ = ~x45 & ~x43 & ~x42 & new_n365_ & ~x41 & ~x46;
  assign new_n365_ = ~x39 & ~x37 & ~x36 & new_n366_ & ~x35 & ~x40;
  assign new_n366_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n367_ & x29;
  assign new_n367_ = ~x26 & ~x25 & ~x24 & new_n368_ & ~x22 & ~x28;
  assign new_n368_ = ~x21 & x20 & ~x18 & ~x17 & new_n241_ & ~x16;
