// Benchmark "FAU" written by ABC on Thu Jul 30 15:25:43 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n248_, new_n249_, new_n250_, new_n251_, new_n255_, new_n256_,
  ...
  assign z22 = ~x64 & ~x63 & ~x62 & new_n225_ & ~x61;
  assign new_n225_ = ~x59 & ~x58 & ~x57 & new_n226_ & ~x56 & ~x60;
  assign new_n226_ = ~x54 & ~x53 & ~x51 & new_n227_ & ~x50 & ~x55;
  ...
  assign new_n231_ = ~x24 & ~x22 & ~x18 & new_n232_ & ~x17 & ~x25;
  ...
  assign new_n243_ = ~x43 & ~x40 & new_n200_ & ~x39;
  ...
  assign new_n251_ = ~x24 & ~x22 & x21 & ~x18 & new_n232_ & ~x17;
  ...
  assign z36 = new_n262_ & ~x62;
  assign new_n262_ = ~x60 & ~x58 & ~x56 & new_n263_ & ~x55 & x61;
  assign new_n263_ = ~x50 & ~x47 & ~x46 & new_n264_ & ~x43 & ~x51;
  assign new_n264_ = ~x40 & ~x39 & ~x37 & new_n214_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n266_ & ~x60;
  assign new_n266_ = ~x58 & ~x56 & ~x55 & new_n267_ & ~x51 & x59;
  assign new_n267_ = ~x47 & ~x46 & ~x43 & new_n268_ & ~x42 & ~x50;
  assign new_n268_ = ~x41 & ~x40 & new_n269_ & ~x39;
  assign new_n269_ = ~x37 & ~x35 & ~x30 & x29 & new_n270_ & ~x28;
  assign new_n270_ = ~x25 & ~x24 & ~x22 & new_n271_ & ~x18 & ~x26;
  assign new_n271_ = ~x15 & ~x14 & ~x11 & new_n272_ & ~x10;
  assign new_n272_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n274_ & ~x61;
  assign new_n274_ = ~x58 & ~x56 & ~x55 & new_n275_ & ~x51 & ~x60;
  ...
  assign new_n278_ = ~x51 & ~x50 & new_n279_ & ~x47;
  assign new_n279_ = ~x43 & ~x42 & ~x41 & new_n280_ & ~x40 & ~x46;
  assign new_n280_ = ~x37 & ~x35 & ~x34 & new_n281_ & ~x33 & ~x39;
  assign new_n281_ = ~x30 & x29 & ~x28 & new_n282_ & ~x26;
  assign new_n282_ = ~x24 & ~x22 & ~x18 & new_n283_ & ~x17 & ~x25;
  assign new_n283_ = ~x14 & ~x11 & ~x10 & new_n272_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n285_ & ~x58 & ~x62;
  assign new_n285_ = ~x55 & ~x51 & ~x50 & new_n286_ & ~x47 & ~x56;
  assign new_n286_ = ~x43 & ~x42 & ~x41 & new_n287_ & ~x40 & ~x46;
  assign new_n287_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n281_ & x33;
  assign z43 = new_n289_ & ~x62;
  assign new_n289_ = ~x60 & ~x59 & ~x58 & new_n290_ & ~x56 & ~x61;
  assign new_n290_ = ~x54 & ~x53 & ~x51 & new_n291_ & ~x50 & ~x55;
  assign new_n291_ = ~x46 & ~x45 & ~x43 & new_n292_ & ~x42 & ~x47;
  assign new_n292_ = ~x40 & ~x39 & ~x37 & new_n293_ & ~x35 & ~x41;
  assign new_n293_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n294_ & x29;
  assign new_n294_ = ~x26 & ~x25 & ~x24 & new_n295_ & ~x22 & ~x28;
  assign new_n295_ = ~x17 & ~x15 & ~x14 & new_n296_ & ~x11 & ~x18;
  assign new_n296_ = ~x09 & ~x08 & ~x07 & new_n297_ & ~x06 & ~x10;
  assign new_n297_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  ...
  assign new_n301_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n281_ & x34;
  ...
  assign new_n308_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n272_ & x09;
  ...
  assign new_n314_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n271_ & x17;
  ...
  assign new_n319_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n281_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n321_ & ~x59;
  assign new_n321_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n278_ & x53;
  ...
  assign new_n325_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n214_ & x35;
  ...
  assign new_n334_ = ~x21 & x20 & ~x18 & ~x17 & new_n232_ & ~x16;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n200_ & x40;
  assign z60 = ~x58 & ~x56 & ~x50 & new_n337_ & ~x47 & ~x60;
  assign new_n337_ = ~x43 & ~x40 & ~x39 & new_n338_ & ~x37 & ~x46;
  assign new_n338_ = ~x30 & x29 & ~x28 & ~x25 & new_n339_ & ~x24;
  assign new_n339_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
