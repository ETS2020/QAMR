// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:04 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n344_, new_n345_, new_n346_, new_n347_, new_n350_;
  ...
  assign z22 = ~x64 & ~x63 & ~x62 & new_n169_ & ~x61;
  assign new_n169_ = ~x59 & ~x58 & ~x57 & new_n170_ & ~x56 & ~x60;
  assign new_n170_ = ~x54 & ~x53 & ~x51 & new_n171_ & ~x50 & ~x55;
  assign new_n171_ = ~x48 & ~x47 & ~x46 & new_n172_ & ~x45 & ~x49;
  assign new_n172_ = ~x42 & ~x41 & ~x40 & new_n173_ & ~x39 & ~x43;
  assign new_n173_ = ~x37 & x36 & ~x35 & ~x34 & new_n174_ & ~x33;
  assign new_n174_ = ~x31 & ~x30 & x29 & ~x28 & new_n175_ & ~x26;
  assign new_n175_ = ~x24 & ~x22 & ~x18 & new_n176_ & ~x17 & ~x25;
  assign new_n176_ = ~x15 & ~x14 & ~x12 & new_n160_ & ~x11;
  assign z23 = ~x64 & new_n178_ & ~x63;
  assign new_n178_ = ~x61 & ~x60 & ~x59 & new_n179_ & ~x58 & ~x62;
  assign new_n179_ = ~x56 & ~x55 & ~x54 & new_n180_ & ~x53 & ~x57;
  assign new_n180_ = ~x51 & ~x50 & ~x49 & new_n181_ & ~x48 & ~x52;
  assign new_n181_ = ~x46 & ~x45 & ~x43 & new_n182_ & ~x42 & ~x47;
  assign new_n182_ = ~x40 & ~x39 & ~x37 & new_n183_ & ~x36 & ~x41;
  assign new_n183_ = ~x34 & ~x33 & ~x31 & new_n184_ & ~x30 & ~x35;
  assign new_n184_ = ~x28 & ~x26 & ~x25 & new_n185_ & ~x24 & x29;
  assign new_n185_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n176_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n187_ & ~x43 & ~x60;
  assign new_n187_ = ~x40 & ~x39 & ~x37 & x29 & new_n188_ & ~x28;
  assign new_n188_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z26 = ~x64 & ~x63 & ~x62 & new_n190_ & ~x61;
  ...
  assign new_n198_ = ~x14 & ~x13 & ~x12 & new_n160_ & ~x11 & ~x15;
  assign z27 = ~x64 & ~x63 & new_n200_ & ~x62;
  assign new_n200_ = ~x60 & ~x59 & ~x58 & new_n201_ & ~x57 & ~x61;
  assign new_n201_ = ~x55 & ~x54 & ~x53 & new_n202_ & ~x52 & ~x56;
  assign new_n202_ = ~x50 & ~x49 & ~x48 & new_n203_ & ~x47 & ~x51;
  assign new_n203_ = ~x45 & ~x43 & ~x42 & new_n204_ & ~x41 & ~x46;
  assign new_n204_ = ~x39 & ~x37 & ~x36 & new_n205_ & ~x35 & ~x40;
  assign new_n205_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n206_ & x29;
  assign new_n206_ = ~x26 & ~x25 & ~x24 & new_n207_ & ~x22 & ~x28;
  assign new_n207_ = ~x20 & ~x18 & ~x17 & new_n208_ & ~x16 & ~x21;
  assign new_n208_ = ~x15 & ~x14 & x13 & ~x12 & new_n160_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n210_ & ~x50;
  assign new_n210_ = ~x43 & ~x40 & ~x39 & new_n211_ & ~x37 & ~x46;
  assign new_n211_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n213_ & ~x60 & ~x64;
  assign new_n213_ = ~x58 & ~x57 & ~x56 & new_n214_ & ~x55 & ~x59;
  assign new_n214_ = ~x54 & ~x53 & x52 & ~x51 & new_n215_ & ~x50;
  assign new_n215_ = ~x48 & ~x47 & ~x46 & new_n216_ & ~x45 & ~x49;
  assign new_n216_ = ~x43 & ~x42 & ~x41 & new_n217_ & ~x40;
  assign new_n217_ = ~x37 & ~x36 & ~x35 & new_n218_ & ~x34 & ~x39;
  assign new_n218_ = ~x33 & ~x31 & ~x30 & new_n219_ & x29;
  assign new_n219_ = ~x28 & ~x26 & ~x25 & new_n220_ & ~x24;
  assign new_n220_ = ~x22 & ~x21 & ~x18 & new_n176_ & ~x17;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n222_ & ~x60 & ~x64;
  assign new_n222_ = ~x58 & ~x57 & ~x56 & new_n223_ & ~x55 & ~x59;
  assign new_n223_ = ~x53 & ~x51 & ~x50 & new_n224_ & ~x49 & ~x54;
  assign new_n224_ = ~x47 & ~x46 & ~x45 & new_n225_ & ~x43 & ~x48;
  assign new_n225_ = ~x41 & ~x40 & ~x39 & new_n226_ & ~x37 & ~x42;
  assign new_n226_ = ~x35 & ~x34 & ~x33 & new_n227_ & ~x31 & ~x36;
  assign new_n227_ = ~x30 & x29 & ~x28 & ~x26 & new_n228_ & ~x25;
  assign new_n228_ = ~x24 & ~x22 & x21 & ~x18 & new_n176_ & ~x17;
  assign z34 = new_n230_ & x58;
  assign new_n230_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  ...
  assign new_n246_ = ~x20 & x19 & ~x18 & ~x17 & new_n198_ & ~x16;
  ...
  assign new_n272_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n154_ & x49;
  ...
  assign z45 = ~x62 & ~x61 & ~x60 & new_n284_ & ~x59;
  assign new_n284_ = ~x56 & ~x55 & ~x51 & new_n285_ & ~x50 & ~x58;
  assign new_n285_ = ~x46 & ~x43 & ~x42 & new_n286_ & ~x41 & ~x47;
  assign new_n286_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n263_ & x34;
  assign z46 = ~x62 & new_n288_ & ~x61;
  ...
  assign new_n293_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n254_ & x09;
  assign z47 = ~x62 & new_n295_ & ~x61;
  ...
  assign new_n299_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n253_ & x17;
  assign z48 = ~x62 & ~x61 & new_n301_ & ~x60;
  assign new_n301_ = ~x58 & ~x56 & ~x55 & new_n302_ & ~x54 & ~x59;
  assign new_n302_ = ~x51 & ~x50 & ~x47 & new_n303_ & ~x46 & ~x53;
  assign new_n303_ = ~x42 & ~x41 & ~x40 & new_n304_ & ~x39 & ~x43;
  assign new_n304_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n263_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n306_ & ~x59;
  assign new_n306_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n260_ & x53;
  assign z51 = ~x62 & ~x61 & new_n308_ & ~x60;
  assign new_n308_ = ~x58 & ~x56 & ~x55 & new_n309_ & ~x54 & ~x59;
  assign new_n309_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n154_ & x48;
  assign z52 = new_n311_ & ~x64;
  assign new_n311_ = ~x62 & ~x61 & ~x60 & new_n312_ & ~x59 & ~x63;
  assign new_n312_ = ~x57 & ~x56 & ~x55 & new_n313_ & ~x54 & ~x58;
  assign new_n313_ = ~x51 & ~x50 & ~x49 & new_n314_ & ~x48 & ~x53;
  assign new_n314_ = ~x46 & ~x45 & ~x43 & new_n315_ & ~x42 & ~x47;
  assign new_n315_ = ~x40 & ~x39 & ~x37 & new_n316_ & ~x35 & ~x41;
  assign new_n316_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n317_ & x29;
  assign new_n317_ = ~x26 & ~x25 & ~x24 & new_n318_ & ~x22 & ~x28;
  assign new_n318_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n159_ & x12;
  ...
  assign new_n328_ = ~x21 & x20 & ~x18 & ~x17 & new_n176_ & ~x16;
