...
module FAU ( 
  ...
  assign z34 = new_n267_ & x58;
  assign new_n267_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  ...
  assign new_n276_ = ~x60 & ~x58 & ~x56 & new_n277_ & ~x55 & x61;
  assign new_n277_ = ~x50 & ~x47 & ~x46 & new_n278_ & ~x43 & ~x51;
  assign new_n278_ = ~x40 & ~x39 & ~x37 & new_n220_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n280_ & ~x60;
  assign new_n280_ = ~x58 & ~x56 & ~x55 & new_n281_ & ~x51 & x59;
  assign new_n281_ = ~x47 & ~x46 & ~x43 & new_n282_ & ~x42 & ~x50;
  assign new_n282_ = ~x41 & ~x40 & new_n283_ & ~x39;
  assign new_n283_ = ~x37 & ~x35 & ~x30 & x29 & new_n284_ & ~x28;
  assign new_n284_ = ~x25 & ~x24 & ~x22 & new_n285_ & ~x18 & ~x26;
  assign new_n285_ = ~x15 & ~x14 & ~x11 & new_n286_ & ~x10;
  assign new_n286_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n288_ & ~x61;
  assign new_n288_ = ~x58 & ~x56 & ~x55 & new_n289_ & ~x51 & ~x60;
  assign new_n289_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n282_ & x42;
  assign z40 = ~x62 & ~x61 & new_n291_ & ~x60;
  assign new_n291_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n292_ & x54;
  assign new_n292_ = ~x51 & ~x50 & new_n293_ & ~x47;
  assign new_n293_ = ~x43 & ~x42 & ~x41 & new_n294_ & ~x40 & ~x46;
  assign new_n294_ = ~x37 & ~x35 & ~x34 & new_n295_ & ~x33 & ~x39;
  assign new_n295_ = ~x30 & x29 & ~x28 & new_n296_ & ~x26;
  assign new_n296_ = ~x24 & ~x22 & ~x18 & new_n297_ & ~x17 & ~x25;
  assign new_n297_ = ~x14 & ~x11 & ~x10 & new_n286_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n299_ & ~x58 & ~x62;
  assign new_n299_ = ~x55 & ~x51 & ~x50 & new_n300_ & ~x47 & ~x56;
  assign new_n300_ = ~x43 & ~x42 & ~x41 & new_n301_ & ~x40 & ~x46;
  assign new_n301_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n295_ & x33;
  assign z43 = new_n303_ & ~x62;
  assign new_n303_ = ~x60 & ~x59 & ~x58 & new_n304_ & ~x56 & ~x61;
  assign new_n304_ = ~x54 & ~x53 & ~x51 & new_n305_ & ~x50 & ~x55;
  ...
  assign new_n309_ = ~x17 & ~x15 & ~x14 & new_n310_ & ~x11 & ~x18;
  assign new_n310_ = ~x09 & ~x08 & ~x07 & new_n311_ & ~x06 & ~x10;
  assign new_n311_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n313_ & ~x58 & ~x62;
  assign new_n313_ = ~x55 & ~x54 & ~x53 & new_n314_ & ~x51 & ~x56;
  assign new_n314_ = ~x47 & ~x46 & ~x45 & new_n315_ & ~x43 & ~x50;
  assign new_n315_ = ~x41 & ~x40 & ~x39 & new_n316_ & ~x37 & ~x42;
  assign new_n316_ = ~x34 & ~x33 & ~x31 & new_n317_ & ~x30 & ~x35;
  assign new_n317_ = ~x28 & ~x26 & ~x25 & new_n318_ & ~x24 & x29;
  assign new_n318_ = ~x18 & ~x17 & ~x15 & new_n319_ & ~x14 & ~x22;
  assign new_n319_ = ~x10 & ~x09 & ~x08 & new_n320_ & ~x07 & ~x11;
  assign new_n320_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n322_ & ~x59;
  assign new_n322_ = ~x56 & ~x55 & ~x51 & new_n323_ & ~x50 & ~x58;
  assign new_n323_ = ~x46 & ~x43 & ~x42 & new_n324_ & ~x41 & ~x47;
  assign new_n324_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n295_ & x34;
  assign z46 = ~x62 & new_n326_ & ~x61;
  ...
  assign new_n331_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n286_ & x09;
  assign z47 = ~x62 & new_n333_ & ~x61;
  ...
  assign new_n337_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n285_ & x17;
  assign z48 = ~x62 & ~x61 & new_n339_ & ~x60;
  assign new_n339_ = ~x58 & ~x56 & ~x55 & new_n340_ & ~x54 & ~x59;
  assign new_n340_ = ~x51 & ~x50 & ~x47 & new_n341_ & ~x46 & ~x53;
  assign new_n341_ = ~x42 & ~x41 & ~x40 & new_n342_ & ~x39 & ~x43;
  assign new_n342_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n295_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n344_ & ~x59;
  assign new_n344_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n292_ & x53;
  assign z50 = ~x62 & ~x61 & new_n346_ & ~x60;
  assign new_n346_ = ~x59 & ~x58 & x57 & ~x56 & new_n347_ & ~x55;
  assign new_n347_ = ~x53 & ~x51 & ~x50 & new_n348_ & ~x49 & ~x54;
  assign new_n348_ = ~x47 & ~x46 & ~x45 & new_n349_ & ~x43 & ~x48;
  assign new_n349_ = ~x42 & ~x41 & ~x40 & new_n350_ & ~x39;
  assign new_n350_ = ~x35 & ~x34 & ~x33 & new_n351_ & ~x31 & ~x37;
  assign new_n351_ = ~x30 & x29 & ~x28 & new_n352_ & ~x26;
  assign new_n352_ = ~x25 & ~x24 & ~x22 & new_n353_ & ~x18;
  assign new_n353_ = ~x17 & ~x15 & ~x14 & new_n161_ & ~x11;
  ...
  assign new_n357_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n220_ & x35;
  ...
  assign new_n366_ = ~x21 & x20 & ~x18 & ~x17 & new_n238_ & ~x16;
