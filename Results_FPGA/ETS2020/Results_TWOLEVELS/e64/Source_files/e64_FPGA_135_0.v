...
module FAU ( 
  ...
  assign z30 = ~x64 & ~x63 & new_n261_ & ~x62;
  assign new_n261_ = ~x61 & ~x59 & ~x58 & new_n262_ & ~x57 & ~x60;
  assign new_n262_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n263_ & x52;
  ...
  assign new_n268_ = ~x21 & ~x17 & ~x15 & new_n231_ & ~x14 & ~x18;
  ...
  assign new_n276_ = ~x41 & ~x39 & ~x37 & new_n218_ & ~x35 & ~x40;
  ...
  assign new_n285_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n247_ & x19;
  assign z42 = ~x62 & new_n287_ & ~x61;
  assign new_n287_ = ~x60 & ~x58 & ~x56 & new_n288_ & ~x55 & ~x59;
  assign new_n288_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n209_ & x49;
  ...
  assign z44 = ~x62 & ~x60 & ~x59 & new_n300_ & ~x58 & ~x61;
  assign new_n300_ = ~x56 & ~x54 & ~x53 & new_n301_ & ~x51 & ~x55;
  assign new_n301_ = ~x50 & ~x46 & ~x45 & new_n302_ & ~x43 & ~x47;
  assign new_n302_ = ~x42 & ~x40 & ~x39 & new_n303_ & ~x37 & ~x41;
  assign new_n303_ = ~x35 & ~x33 & ~x31 & new_n304_ & ~x30 & ~x34;
  assign new_n304_ = x29 & ~x26 & ~x25 & new_n305_ & ~x24 & ~x28;
  assign new_n305_ = ~x22 & ~x17 & ~x15 & new_n306_ & ~x14 & ~x18;
  assign new_n306_ = ~x11 & ~x09 & ~x08 & new_n307_ & ~x07 & ~x10;
  assign new_n307_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n309_ & ~x62;
  assign new_n309_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n207_ & x57;
  assign z51 = ~x62 & ~x61 & new_n311_ & ~x60;
  assign new_n311_ = ~x59 & ~x56 & ~x55 & new_n312_ & ~x54 & ~x58;
  assign new_n312_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n209_ & x48;
  ...
  assign new_n321_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n214_ & x12;
  ...
  assign new_n326_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n218_ & x35;
  ...
  assign new_n335_ = ~x18 & ~x16 & ~x15 & new_n231_ & ~x14 & ~x17;
