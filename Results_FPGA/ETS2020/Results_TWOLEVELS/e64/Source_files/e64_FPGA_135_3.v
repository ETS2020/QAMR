...
module FAU ( 
  ...
  assign new_n390_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n222_ & x57;
  assign z51 = ~x62 & ~x61 & new_n392_ & ~x60;
  assign new_n392_ = ~x58 & ~x56 & ~x55 & new_n393_ & ~x54 & ~x59;
  assign new_n393_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n224_ & x48;
  ...
  assign new_n402_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n229_ & x12;
  ...
  assign new_n407_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n233_ & x35;
