...
module FAU ( 
  ...
  assign new_n228_ = ~x56 & ~x47 & ~x46 & new_n229_ & ~x43 & ~x50;
  assign new_n229_ = ~x41 & ~x39 & ~x37 & new_n230_ & ~x30 & ~x40;
  assign new_n230_ = x29 & ~x26 & ~x25 & new_n231_ & ~x24 & ~x28;
  assign new_n231_ = ~x22 & ~x15 & ~x14 & new_n232_ & ~x11 & ~x18;
  assign new_n232_ = ~x10 & ~x07 & ~x06 & x00 & ~x03 & ~x08;
  assign z22 = ~x64 & new_n234_ & ~x63;
  assign new_n234_ = ~x62 & ~x60 & ~x59 & new_n235_ & ~x58 & ~x61;
  assign new_n235_ = ~x57 & ~x55 & ~x54 & new_n236_ & ~x53 & ~x56;
  assign new_n236_ = ~x51 & ~x49 & ~x48 & new_n237_ & ~x47 & ~x50;
  assign new_n237_ = ~x46 & ~x43 & ~x42 & new_n238_ & ~x41 & ~x45;
  assign new_n238_ = ~x40 & ~x39 & ~x37 & x36 & new_n239_ & ~x35;
  assign new_n239_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n240_ & x29;
  assign new_n240_ = ~x28 & ~x25 & ~x24 & new_n241_ & ~x22 & ~x26;
  assign new_n241_ = ~x17 & ~x15 & new_n242_ & ~x14 & ~x18;
  assign new_n242_ = new_n219_ & ~x12;
  assign z23 = ~x63 & ~x62 & new_n244_ & ~x61 & ~x64;
  assign new_n244_ = ~x60 & ~x58 & ~x57 & new_n245_ & ~x56 & ~x59;
  assign new_n245_ = ~x55 & ~x53 & ~x52 & new_n246_ & ~x51 & ~x54;
  assign new_n246_ = ~x50 & ~x48 & ~x47 & new_n247_ & ~x46 & ~x49;
  assign new_n247_ = ~x45 & ~x42 & ~x41 & new_n248_ & ~x40 & ~x43;
  assign new_n248_ = ~x39 & ~x36 & ~x35 & new_n249_ & ~x34 & ~x37;
  assign new_n249_ = ~x33 & ~x31 & ~x30 & x29 & new_n250_ & ~x28;
  assign new_n250_ = ~x26 & ~x24 & ~x22 & new_n251_ & ~x21 & ~x25;
  assign new_n251_ = ~x18 & ~x17 & x16 & ~x15 & new_n242_ & ~x14;
  assign z24 = ~x60 & ~x50 & ~x46 & new_n253_ & ~x43 & ~x58;
  assign new_n253_ = ~x40 & ~x39 & ~x37 & x29 & new_n254_ & ~x28;
  assign new_n254_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x58 & ~x50 & new_n256_ & ~x46 & ~x60;
  assign new_n256_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n257_ & x29;
  assign new_n257_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n259_ & ~x64;
  assign new_n259_ = ~x63 & ~x61 & ~x60 & new_n260_ & ~x59 & ~x62;
  assign new_n260_ = ~x58 & ~x56 & ~x55 & new_n261_ & ~x54 & ~x57;
  assign new_n261_ = ~x53 & ~x51 & ~x50 & new_n262_ & ~x49 & ~x52;
  assign new_n262_ = ~x48 & ~x46 & ~x45 & new_n263_ & ~x43 & ~x47;
  assign new_n263_ = ~x42 & ~x40 & ~x39 & new_n264_ & ~x37 & ~x41;
  assign new_n264_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n265_ & x32;
  assign new_n265_ = ~x31 & ~x30 & x29 & ~x28 & new_n266_ & ~x26;
  assign new_n266_ = ~x25 & ~x22 & ~x21 & new_n267_ & ~x20 & ~x24;
  assign new_n267_ = ~x18 & ~x17 & new_n151_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n269_ & ~x62;
  assign new_n269_ = ~x61 & ~x59 & ~x58 & new_n270_ & ~x57 & ~x60;
  assign new_n270_ = ~x56 & ~x54 & ~x53 & new_n271_ & ~x52 & ~x55;
  ...
  assign new_n276_ = ~x21 & ~x18 & ~x17 & new_n277_ & ~x16 & ~x20;
  ...
  assign new_n282_ = ~x43 & ~x40 & new_n193_ & ~x39;
  ...
  assign new_n290_ = ~x26 & ~x24 & ~x22 & new_n241_ & ~x21 & ~x25;
  assign z32 = ~x58 & ~x50 & new_n282_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n193_ & x39;
  assign z36 = new_n294_ & ~x62;
  assign new_n294_ = x61 & ~x58 & ~x56 & new_n295_ & ~x55 & ~x60;
  assign new_n295_ = ~x51 & ~x47 & ~x46 & new_n296_ & ~x43 & ~x50;
  assign new_n296_ = ~x41 & ~x39 & ~x37 & new_n223_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n298_ & ~x63;
  assign new_n298_ = ~x62 & ~x60 & ~x59 & new_n299_ & ~x58 & ~x61;
  assign new_n299_ = ~x57 & ~x55 & ~x54 & new_n300_ & ~x53 & ~x56;
  assign new_n300_ = ~x52 & ~x50 & ~x49 & new_n301_ & ~x48 & ~x51;
  assign new_n301_ = ~x47 & ~x45 & ~x43 & new_n302_ & ~x42 & ~x46;
  assign new_n302_ = ~x41 & ~x39 & ~x37 & new_n303_ & ~x36 & ~x40;
  assign new_n303_ = ~x35 & ~x33 & ~x32 & new_n304_ & ~x31 & ~x34;
  assign new_n304_ = ~x30 & ~x28 & ~x26 & new_n305_ & ~x25 & x29;
  assign new_n305_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n267_ & x19;
  assign z42 = ~x62 & new_n307_ & ~x61;
  assign new_n307_ = ~x60 & ~x58 & ~x56 & new_n308_ & ~x55 & ~x59;
  assign new_n308_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n214_ & x49;
  assign z43 = new_n310_ & ~x62;
  assign new_n310_ = ~x61 & ~x59 & ~x58 & new_n311_ & ~x56 & ~x60;
  assign new_n311_ = ~x55 & ~x53 & ~x51 & new_n312_ & ~x50 & ~x54;
  ...
  assign new_n316_ = ~x18 & ~x15 & ~x14 & new_n317_ & ~x11 & ~x17;
  assign new_n317_ = ~x10 & ~x08 & ~x07 & new_n318_ & ~x06 & ~x09;
  assign new_n318_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n320_ & ~x58 & ~x61;
  assign new_n320_ = ~x56 & ~x54 & ~x53 & new_n321_ & ~x51 & ~x55;
  assign new_n321_ = ~x50 & ~x46 & ~x45 & new_n322_ & ~x43 & ~x47;
  assign new_n322_ = ~x42 & ~x40 & ~x39 & new_n323_ & ~x37 & ~x41;
  assign new_n323_ = ~x35 & ~x33 & ~x31 & new_n324_ & ~x30 & ~x34;
  assign new_n324_ = x29 & ~x26 & ~x25 & new_n325_ & ~x24 & ~x28;
  assign new_n325_ = ~x22 & ~x17 & ~x15 & new_n326_ & ~x14 & ~x18;
  assign new_n326_ = ~x11 & ~x09 & ~x08 & new_n327_ & ~x07 & ~x10;
  assign new_n327_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n329_ & ~x62;
  assign new_n329_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n212_ & x57;
  assign z51 = ~x62 & ~x61 & new_n331_ & ~x60;
  assign new_n331_ = ~x59 & ~x56 & ~x55 & new_n332_ & ~x54 & ~x58;
  assign new_n332_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n214_ & x48;
  assign z52 = new_n334_ & ~x64;
  assign new_n334_ = ~x63 & ~x61 & ~x60 & new_n335_ & ~x59 & ~x62;
  assign new_n335_ = ~x58 & ~x56 & ~x55 & new_n336_ & ~x54 & ~x57;
  assign new_n336_ = ~x53 & ~x50 & ~x49 & new_n337_ & ~x48 & ~x51;
  assign new_n337_ = ~x47 & ~x45 & ~x43 & new_n338_ & ~x42 & ~x46;
  assign new_n338_ = ~x41 & ~x39 & ~x37 & new_n339_ & ~x35 & ~x40;
  assign new_n339_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n340_ & x29;
  assign new_n340_ = ~x28 & ~x25 & ~x24 & new_n341_ & ~x22 & ~x26;
  assign new_n341_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n219_ & x12;
  assign z53 = ~x64 & new_n210_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n295_ & x55;
  assign z55 = ~x60 & ~x58 & new_n345_ & ~x56 & ~x62;
  assign new_n345_ = ~x51 & ~x47 & ~x46 & new_n346_ & ~x43 & ~x50;
  assign new_n346_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n223_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n348_ & ~x60 & ~x63;
  assign new_n348_ = ~x59 & ~x57 & ~x56 & new_n349_ & ~x55 & ~x58;
  assign new_n349_ = ~x54 & ~x52 & ~x51 & new_n350_ & ~x50 & ~x53;
  assign new_n350_ = ~x49 & ~x47 & ~x46 & new_n351_ & ~x45 & ~x48;
  assign new_n351_ = ~x43 & ~x41 & ~x40 & new_n352_ & ~x39 & ~x42;
  assign new_n352_ = ~x37 & ~x35 & ~x34 & new_n353_ & ~x33 & ~x36;
  assign new_n353_ = ~x31 & ~x30 & x29 & ~x28 & new_n354_ & ~x26;
  assign new_n354_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n355_ & x20;
  assign new_n355_ = ~x18 & ~x16 & ~x15 & new_n242_ & ~x14 & ~x17;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n357_ & ~x50 & ~x60;
  assign new_n357_ = ~x47 & ~x43 & ~x41 & new_n358_ & ~x40 & ~x46;
  ...
  assign z58 = ~x60 & ~x58 & new_n363_ & ~x56 & ~x62;
  assign new_n363_ = ~x50 & ~x46 & ~x43 & new_n364_ & ~x41 & ~x47;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n368_ & ~x47 & ~x58;
  assign new_n368_ = ~x46 & ~x40 & ~x39 & new_n369_ & ~x37 & ~x43;
  assign new_n369_ = ~x30 & ~x28 & ~x25 & new_n370_ & ~x24 & x29;
  assign new_n370_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n372_ & ~x50 & ~x60;
  assign new_n372_ = ~x47 & ~x43 & ~x40 & new_n373_ & ~x39 & ~x46;
  assign new_n373_ = ~x37 & ~x30 & x29 & ~x28 & new_n374_ & ~x25;
  assign new_n374_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z00 = 1'b0;
  assign z10 = 1'b0;
  assign z31 = 1'b0;
  assign z34 = 1'b0;
