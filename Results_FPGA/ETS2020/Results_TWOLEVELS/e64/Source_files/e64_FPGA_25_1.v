...
module FAU ( 
  ...
  assign z19 = new_n150_ & x64;
  assign new_n150_ = ~x62 & ~x61 & ~x60 & new_n151_ & ~x59;
  assign new_n151_ = ~x57 & ~x56 & ~x55 & new_n152_ & ~x54 & ~x58;
  assign new_n152_ = ~x51 & ~x50 & ~x49 & new_n153_ & ~x48 & ~x53;
  assign new_n153_ = ~x47 & ~x46 & ~x45 & new_n154_ & ~x43;
  assign new_n154_ = ~x41 & ~x40 & ~x39 & new_n155_ & ~x37 & ~x42;
  assign new_n155_ = ~x34 & ~x33 & ~x31 & new_n156_ & ~x30 & ~x35;
  assign new_n156_ = ~x28 & ~x26 & ~x25 & new_n157_ & ~x24 & x29;
  assign new_n157_ = ~x18 & ~x17 & ~x15 & new_n158_ & ~x14 & ~x22;
  assign new_n158_ = new_n159_ & ~x11;
  assign new_n159_ = ~x09 & ~x08 & ~x07 & new_n160_ & ~x06 & ~x10;
  assign new_n160_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z21 = ~x62 & ~x60 & new_n162_ & ~x58;
  assign new_n162_ = ~x50 & ~x47 & ~x46 & new_n163_ & ~x43 & ~x56;
  assign new_n163_ = ~x40 & ~x39 & ~x37 & new_n164_ & ~x30 & ~x41;
  assign new_n164_ = ~x28 & ~x26 & ~x25 & new_n165_ & ~x24 & x29;
  assign new_n165_ = ~x18 & ~x15 & ~x14 & new_n166_ & ~x11 & ~x22;
  assign new_n166_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  ...
  assign new_n175_ = ~x15 & ~x14 & ~x12 & new_n159_ & ~x11;
  ...
  assign new_n197_ = ~x14 & ~x13 & ~x12 & new_n159_ & ~x11 & ~x15;
  ...
  assign new_n207_ = ~x15 & ~x14 & x13 & ~x12 & new_n159_ & ~x11;
  ...
  assign new_n271_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n153_ & x49;
  ...
  assign new_n285_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n262_ & x34;
  ...
  assign new_n292_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n253_ & x09;
  ...
  assign new_n298_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n252_ & x17;
  ...
  assign new_n320_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n158_ & x12;
  assign z53 = ~x64 & new_n150_ & x63;
  ...
  assign new_n330_ = ~x21 & x20 & ~x18 & ~x17 & new_n175_ & ~x16;
