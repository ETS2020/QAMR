...
module FAU ( 
  ...
  wire new_n137_, new_n138_, new_n139_, new_n140_, new_n142_, new_n143_,
    ...
    new_n328_, new_n330_, new_n331_, new_n332_, new_n333_, new_n336_;
  assign z04 = x15 & x29;
  ...
  assign z30 = ~x64 & ~x63 & ~x62 & ~x61 & new_n201_ & ~x60;
  ...
  assign new_n206_ = ~x33 & ~x31 & new_n207_ & x29 & ~x30;
  assign new_n207_ = ~x28 & ~x26 & ~x25 & new_n208_ & ~x24;
  assign new_n208_ = ~x22 & ~x21 & ~x18 & new_n167_ & ~x17;
  assign z35 = ~x62 & ~x61 & new_n210_ & ~x60;
  assign new_n210_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n211_ & ~x50;
  assign new_n211_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n212_ & ~x40;
  assign new_n212_ = ~x39 & ~x37 & ~x35 & new_n213_ & x29 & ~x30;
  ...
  assign new_n224_ = ~x20 & x19 & ~x18 & ~x17 & new_n189_ & ~x16;
  ...
  assign new_n250_ = ~x54 & ~x53 & ~x51 & new_n145_ & x49 & ~x50;
  ...
  assign new_n296_ = ~x56 & ~x55 & new_n144_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n298_ & ~x60;
  assign new_n298_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n299_ & ~x54;
  assign new_n299_ = ~x53 & ~x51 & ~x50 & new_n145_ & x48 & ~x49;
  ...
  assign new_n308_ = ~x18 & ~x17 & ~x15 & new_n150_ & x12 & ~x14;
  ...
  assign new_n318_ = ~x21 & x20 & ~x18 & ~x17 & new_n167_ & ~x16;
  ...
  assign z62 = ~x60 & ~x58 & ~x56 & new_n330_ & x47 & ~x50;
  ...
  assign new_n336_ = ~x43 & ~x40 & ~x39 & new_n332_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
