...
module FAU ( 
  ...
  assign z21 = ~x62 & ~x60 & new_n168_ & ~x58;
  assign new_n168_ = ~x50 & ~x47 & ~x46 & new_n169_ & ~x43 & ~x56;
  assign new_n169_ = ~x40 & ~x39 & ~x37 & new_n170_ & ~x30 & ~x41;
  assign new_n170_ = ~x28 & ~x26 & ~x25 & new_n171_ & ~x24 & x29;
  assign new_n171_ = ~x18 & ~x15 & ~x14 & new_n172_ & ~x11 & ~x22;
  assign new_n172_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n174_ & ~x61;
  assign new_n174_ = ~x59 & ~x58 & ~x57 & new_n175_ & ~x56 & ~x60;
  assign new_n175_ = ~x54 & ~x53 & ~x51 & new_n176_ & ~x50 & ~x55;
  ...
  assign new_n180_ = ~x24 & ~x22 & ~x18 & new_n181_ & ~x17 & ~x25;
  assign new_n181_ = ~x15 & ~x14 & ~x12 & new_n165_ & ~x11;
  assign z23 = ~x64 & new_n183_ & ~x63;
  assign new_n183_ = ~x61 & ~x60 & ~x59 & new_n184_ & ~x58 & ~x62;
  assign new_n184_ = ~x56 & ~x55 & ~x54 & new_n185_ & ~x53 & ~x57;
  assign new_n185_ = ~x51 & ~x50 & ~x49 & new_n186_ & ~x48 & ~x52;
  assign new_n186_ = ~x46 & ~x45 & ~x43 & new_n187_ & ~x42 & ~x47;
  assign new_n187_ = ~x40 & ~x39 & ~x37 & new_n188_ & ~x36 & ~x41;
  assign new_n188_ = ~x34 & ~x33 & ~x31 & new_n189_ & ~x30 & ~x35;
  assign new_n189_ = ~x28 & ~x26 & ~x25 & new_n190_ & ~x24 & x29;
  assign new_n190_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n181_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n192_ & ~x43 & ~x60;
  ...
  assign new_n203_ = ~x14 & ~x13 & ~x12 & new_n165_ & ~x11 & ~x15;
  ...
  assign new_n213_ = ~x15 & ~x14 & x13 & ~x12 & new_n165_ & ~x11;
  ...
  assign new_n225_ = ~x22 & ~x21 & ~x18 & new_n181_ & ~x17;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n227_ & ~x60 & ~x64;
  assign new_n227_ = ~x58 & ~x57 & ~x56 & new_n228_ & ~x55 & ~x59;
  assign new_n228_ = ~x53 & ~x51 & ~x50 & new_n229_ & ~x49 & ~x54;
  assign new_n229_ = ~x47 & ~x46 & ~x45 & new_n230_ & ~x43 & ~x48;
  assign new_n230_ = ~x41 & ~x40 & ~x39 & new_n231_ & ~x37 & ~x42;
  assign new_n231_ = ~x35 & ~x34 & ~x33 & new_n232_ & ~x31 & ~x36;
  assign new_n232_ = ~x30 & x29 & ~x28 & ~x26 & new_n233_ & ~x25;
  assign new_n233_ = ~x24 & ~x22 & x21 & ~x18 & new_n181_ & ~x17;
  assign z35 = ~x62 & ~x61 & new_n235_ & ~x60;
  assign new_n235_ = ~x56 & ~x55 & ~x51 & new_n236_ & ~x50 & ~x58;
  assign new_n236_ = ~x46 & ~x43 & ~x41 & new_n237_ & ~x40 & ~x47;
  assign new_n237_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n238_ & x29;
  assign new_n238_ = ~x26 & ~x25 & ~x24 & new_n239_ & ~x22 & ~x28;
  assign new_n239_ = ~x15 & ~x14 & ~x11 & new_n240_ & ~x10 & ~x18;
  assign new_n240_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z37 = ~x63 & ~x62 & ~x61 & new_n242_ & ~x60 & ~x64;
  assign new_n242_ = ~x58 & ~x57 & ~x56 & new_n243_ & ~x55 & ~x59;
  assign new_n243_ = ~x53 & ~x52 & ~x51 & new_n244_ & ~x50 & ~x54;
  assign new_n244_ = ~x48 & ~x47 & ~x46 & new_n245_ & ~x45 & ~x49;
  assign new_n245_ = ~x42 & ~x41 & ~x40 & new_n246_ & ~x39 & ~x43;
  assign new_n246_ = ~x36 & ~x35 & ~x34 & new_n247_ & ~x33 & ~x37;
  assign new_n247_ = ~x32 & ~x31 & ~x30 & x29 & new_n248_ & ~x28;
  assign new_n248_ = ~x25 & ~x24 & ~x22 & new_n249_ & ~x21 & ~x26;
  assign new_n249_ = ~x20 & x19 & ~x18 & ~x17 & new_n203_ & ~x16;
  ...
  assign new_n275_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n159_ & x49;
  ...
  assign new_n321_ = ~x56 & ~x55 & new_n158_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n323_ & ~x60;
  assign new_n323_ = ~x58 & ~x56 & ~x55 & new_n324_ & ~x54 & ~x59;
  assign new_n324_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n159_ & x48;
  ...
  assign new_n333_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n164_ & x12;
  ...
  assign new_n343_ = ~x21 & x20 & ~x18 & ~x17 & new_n181_ & ~x16;
