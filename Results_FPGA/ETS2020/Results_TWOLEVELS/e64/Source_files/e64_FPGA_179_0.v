// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:19 2020
...
module FAU ( 
  ...
  assign z30 = ~x64 & ~x63 & new_n262_ & ~x62;
  assign new_n262_ = ~x61 & ~x59 & ~x58 & new_n263_ & ~x57 & ~x60;
  assign new_n263_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n264_ & x52;
  assign new_n264_ = ~x51 & ~x49 & ~x48 & new_n265_ & ~x47 & ~x50;
  assign new_n265_ = ~x46 & ~x43 & ~x42 & new_n266_ & ~x41 & ~x45;
  assign new_n266_ = ~x40 & ~x37 & ~x36 & new_n267_ & ~x35 & ~x39;
  assign new_n267_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n268_ & x29;
  assign new_n268_ = ~x28 & ~x25 & ~x24 & new_n269_ & ~x22 & ~x26;
  assign new_n269_ = ~x21 & ~x17 & ~x15 & new_n232_ & ~x14 & ~x18;
  assign z32 = ~x58 & ~x50 & new_n260_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n194_ & x39;
  assign z34 = new_n273_ & x58;
  assign new_n273_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z36 = new_n275_ & ~x62;
  assign new_n275_ = x61 & ~x58 & ~x56 & new_n276_ & ~x55 & ~x60;
  assign new_n276_ = ~x51 & ~x47 & ~x46 & new_n277_ & ~x43 & ~x50;
  assign new_n277_ = ~x41 & ~x39 & ~x37 & new_n219_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n279_ & ~x63;
  assign new_n279_ = ~x62 & ~x60 & ~x59 & new_n280_ & ~x58 & ~x61;
  assign new_n280_ = ~x57 & ~x55 & ~x54 & new_n281_ & ~x53 & ~x56;
  assign new_n281_ = ~x52 & ~x50 & ~x49 & new_n282_ & ~x48 & ~x51;
  assign new_n282_ = ~x47 & ~x45 & ~x43 & new_n283_ & ~x42 & ~x46;
  assign new_n283_ = ~x41 & ~x39 & ~x37 & new_n284_ & ~x36 & ~x40;
  assign new_n284_ = ~x35 & ~x33 & ~x32 & new_n285_ & ~x31 & ~x34;
  assign new_n285_ = ~x30 & ~x28 & ~x26 & new_n286_ & ~x25 & x29;
  assign new_n286_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n248_ & x19;
  assign z42 = ~x62 & new_n288_ & ~x61;
  assign new_n288_ = ~x60 & ~x58 & ~x56 & new_n289_ & ~x55 & ~x59;
  assign new_n289_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n210_ & x49;
  ...
  assign new_n310_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n208_ & x57;
  assign z51 = ~x62 & ~x61 & new_n312_ & ~x60;
  assign new_n312_ = ~x59 & ~x56 & ~x55 & new_n313_ & ~x54 & ~x58;
  assign new_n313_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n210_ & x48;
  assign z52 = new_n315_ & ~x64;
  assign new_n315_ = ~x63 & ~x61 & ~x60 & new_n316_ & ~x59 & ~x62;
  assign new_n316_ = ~x58 & ~x56 & ~x55 & new_n317_ & ~x54 & ~x57;
  assign new_n317_ = ~x53 & ~x50 & ~x49 & new_n318_ & ~x48 & ~x51;
  assign new_n318_ = ~x47 & ~x45 & ~x43 & new_n319_ & ~x42 & ~x46;
  assign new_n319_ = ~x41 & ~x39 & ~x37 & new_n320_ & ~x35 & ~x40;
  assign new_n320_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n321_ & x29;
  assign new_n321_ = ~x28 & ~x25 & ~x24 & new_n322_ & ~x22 & ~x26;
  assign new_n322_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n215_ & x12;
