...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n343_, new_n344_, new_n345_, new_n346_, new_n349_;
  ...
  assign z08 = ~x64 & ~x63 & ~x62 & new_n144_ & ~x61;
  assign new_n144_ = ~x59 & ~x58 & ~x57 & new_n145_ & ~x56 & ~x60;
  assign new_n145_ = ~x54 & ~x53 & ~x52 & new_n146_ & ~x51 & ~x55;
  assign new_n146_ = ~x49 & ~x48 & ~x47 & new_n147_ & ~x46 & ~x50;
  assign new_n147_ = ~x43 & ~x42 & ~x41 & new_n148_ & ~x40 & ~x45;
  assign new_n148_ = ~x39 & x38 & ~x37 & ~x36 & new_n149_ & ~x35;
  ...
  assign new_n163_ = new_n164_ & ~x62;
  ...
  assign new_n177_ = ~x45 & ~x43 & ~x42 & new_n178_ & ~x41 & ~x46;
  assign new_n178_ = ~x40 & ~x39 & ~x37 & x36 & new_n179_ & ~x35;
  assign new_n179_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n180_ & x29;
  assign new_n180_ = ~x26 & ~x25 & ~x24 & new_n181_ & ~x22 & ~x28;
  assign new_n181_ = ~x18 & ~x17 & ~x15 & new_n182_ & ~x14;
  assign new_n182_ = new_n172_ & ~x12;
  assign z23 = ~x64 & ~x63 & ~x62 & new_n184_ & ~x61;
  ...
  assign new_n189_ = ~x33 & ~x31 & ~x30 & x29 & new_n190_ & ~x28;
  assign new_n190_ = ~x25 & ~x24 & ~x22 & new_n191_ & ~x21 & ~x26;
  assign new_n191_ = ~x18 & ~x17 & x16 & ~x15 & new_n182_ & ~x14;
  ...
  assign z26 = new_n199_ & ~x64;
  assign new_n199_ = ~x62 & ~x61 & ~x60 & new_n200_ & ~x59 & ~x63;
  assign new_n200_ = ~x57 & ~x56 & ~x55 & new_n201_ & ~x54 & ~x58;
  assign new_n201_ = ~x52 & ~x51 & ~x50 & new_n202_ & ~x49 & ~x53;
  assign new_n202_ = ~x47 & ~x46 & ~x45 & new_n203_ & ~x43 & ~x48;
  assign new_n203_ = ~x41 & ~x40 & ~x39 & new_n204_ & ~x37 & ~x42;
  assign new_n204_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n205_ & x32;
  assign new_n205_ = ~x31 & ~x30 & x29 & ~x28 & new_n206_ & ~x26;
  assign new_n206_ = ~x24 & ~x22 & ~x21 & new_n152_ & ~x20 & ~x25;
  ...
  assign new_n227_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n181_ & x21;
  assign z34 = new_n229_ & x58;
  assign new_n229_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z37 = ~x64 & new_n231_ & ~x63;
  ...
  assign new_n236_ = ~x34 & ~x33 & ~x32 & new_n237_ & ~x31 & ~x35;
  assign new_n237_ = ~x30 & x29 & ~x28 & ~x26 & new_n238_ & ~x25;
  assign new_n238_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n152_ & x19;
  ...
  assign new_n309_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n165_ & x57;
  ...
  assign z56 = ~x63 & ~x62 & ~x61 & new_n324_ & ~x60 & ~x64;
  assign new_n324_ = ~x58 & ~x57 & ~x56 & new_n325_ & ~x55 & ~x59;
  assign new_n325_ = ~x53 & ~x52 & ~x51 & new_n326_ & ~x50 & ~x54;
  assign new_n326_ = ~x48 & ~x47 & ~x46 & new_n327_ & ~x45 & ~x49;
  assign new_n327_ = ~x42 & ~x41 & ~x40 & new_n328_ & ~x39 & ~x43;
  assign new_n328_ = ~x36 & ~x35 & ~x34 & new_n329_ & ~x33 & ~x37;
  assign new_n329_ = ~x31 & ~x30 & x29 & ~x28 & new_n330_ & ~x26;
  assign new_n330_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n331_ & x20;
  assign new_n331_ = ~x17 & ~x16 & ~x15 & new_n182_ & ~x14 & ~x18;
