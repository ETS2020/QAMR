// Benchmark "FAU" written by ABC on Thu Jul 30 15:26:06 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n271_, new_n272_, new_n273_, new_n277_, new_n279_, new_n280_,
    ...
    new_n359_, new_n361_, new_n363_, new_n364_, new_n365_, new_n367_,
    new_n368_, new_n370_, new_n371_, new_n372_, new_n373_, new_n374_,
    new_n375_, new_n376_, new_n377_, new_n379_, new_n382_, new_n383_,
    new_n385_, new_n386_, new_n387_, new_n388_, new_n389_, new_n391_,
    new_n392_, new_n393_, new_n396_, new_n397_, new_n398_, new_n400_,
    new_n401_, new_n402_, new_n403_, new_n406_;
  ...
  assign z21 = ~x62 & ~x60 & new_n226_ & ~x58;
  assign new_n226_ = ~x50 & ~x47 & ~x46 & new_n227_ & ~x43 & ~x56;
  assign new_n227_ = ~x40 & ~x39 & ~x37 & new_n228_ & ~x30 & ~x41;
  assign new_n228_ = ~x28 & ~x26 & ~x25 & new_n229_ & ~x24 & x29;
  assign new_n229_ = ~x18 & ~x15 & ~x14 & new_n230_ & ~x11 & ~x22;
  assign new_n230_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n232_ & ~x46;
  assign new_n232_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n233_ & x29;
  assign new_n233_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n235_ & ~x64;
  assign new_n235_ = ~x62 & ~x61 & ~x60 & new_n236_ & ~x59 & ~x63;
  assign new_n236_ = ~x57 & ~x56 & ~x55 & new_n237_ & ~x54 & ~x58;
  assign new_n237_ = ~x52 & ~x51 & ~x50 & new_n238_ & ~x49 & ~x53;
  assign new_n238_ = ~x47 & ~x46 & ~x45 & new_n239_ & ~x43 & ~x48;
  assign new_n239_ = ~x41 & ~x40 & ~x39 & new_n240_ & ~x37 & ~x42;
  assign new_n240_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n241_ & x32;
  assign new_n241_ = ~x31 & ~x30 & x29 & ~x28 & new_n242_ & ~x26;
  assign new_n242_ = ~x24 & ~x22 & ~x21 & new_n243_ & ~x20 & ~x25;
  assign new_n243_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n245_ & ~x62;
  assign new_n245_ = ~x60 & ~x59 & ~x58 & new_n246_ & ~x57 & ~x61;
  assign new_n246_ = ~x55 & ~x54 & ~x53 & new_n247_ & ~x52 & ~x56;
  assign new_n247_ = ~x50 & ~x49 & ~x48 & new_n248_ & ~x47 & ~x51;
  assign new_n248_ = ~x45 & ~x43 & ~x42 & new_n249_ & ~x41 & ~x46;
  assign new_n249_ = ~x39 & ~x37 & ~x36 & new_n250_ & ~x35 & ~x40;
  assign new_n250_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n251_ & x29;
  assign new_n251_ = ~x26 & ~x25 & ~x24 & new_n252_ & ~x22 & ~x28;
  assign new_n252_ = ~x21 & ~x20 & ~x18 & new_n253_ & ~x17;
  assign new_n253_ = ~x16 & ~x15 & ~x14 & x13 & new_n254_ & ~x12;
  assign new_n254_ = new_n161_ & ~x11;
  assign z29 = x60 & ~x58 & ~x50 & new_n256_ & ~x46;
  assign new_n256_ = ~x43 & ~x40 & new_n202_ & ~x39;
  ...
  assign new_n265_ = ~x17 & ~x15 & ~x14 & new_n254_ & ~x12 & ~x18;
  assign z31 = ~x64 & ~x63 & new_n267_ & ~x62;
  assign new_n267_ = ~x60 & ~x59 & ~x58 & new_n268_ & ~x57 & ~x61;
  assign new_n268_ = ~x55 & ~x54 & ~x53 & new_n269_ & ~x51 & ~x56;
  ...
  assign new_n273_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n265_ & x21;
  ...
  assign new_n288_ = ~x40 & ~x39 & ~x37 & new_n221_ & ~x35 & ~x41;
  assign z37 = ~x64 & new_n290_ & ~x63;
  assign new_n290_ = ~x61 & ~x60 & ~x59 & new_n291_ & ~x58 & ~x62;
  assign new_n291_ = ~x56 & ~x55 & ~x54 & new_n292_ & ~x53 & ~x57;
  assign new_n292_ = ~x51 & ~x50 & ~x49 & new_n293_ & ~x48 & ~x52;
  assign new_n293_ = ~x46 & ~x45 & ~x43 & new_n294_ & ~x42 & ~x47;
  assign new_n294_ = ~x40 & ~x39 & ~x37 & new_n295_ & ~x36 & ~x41;
  assign new_n295_ = ~x34 & ~x33 & ~x32 & new_n296_ & ~x31 & ~x35;
  assign new_n296_ = ~x30 & x29 & ~x28 & ~x26 & new_n297_ & ~x25;
  assign new_n297_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n243_ & x19;
  assign z38 = ~x62 & ~x61 & new_n299_ & ~x60;
  assign new_n299_ = ~x58 & ~x56 & ~x55 & new_n300_ & ~x51 & x59;
  assign new_n300_ = ~x47 & ~x46 & ~x43 & new_n301_ & ~x42 & ~x50;
  assign new_n301_ = ~x41 & ~x40 & new_n302_ & ~x39;
  assign new_n302_ = ~x37 & ~x35 & ~x30 & x29 & new_n303_ & ~x28;
  assign new_n303_ = ~x25 & ~x24 & ~x22 & new_n304_ & ~x18 & ~x26;
  assign new_n304_ = ~x15 & ~x14 & ~x11 & new_n305_ & ~x10;
  assign new_n305_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n307_ & ~x61;
  assign new_n307_ = ~x58 & ~x56 & ~x55 & new_n308_ & ~x51 & ~x60;
  assign new_n308_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n301_ & x42;
  assign z40 = ~x62 & ~x61 & new_n310_ & ~x60;
  assign new_n310_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n311_ & x54;
  assign new_n311_ = ~x51 & ~x50 & new_n312_ & ~x47;
  assign new_n312_ = ~x43 & ~x42 & ~x41 & new_n313_ & ~x40 & ~x46;
  assign new_n313_ = ~x37 & ~x35 & ~x34 & new_n314_ & ~x33 & ~x39;
  assign new_n314_ = ~x30 & x29 & ~x28 & new_n315_ & ~x26;
  assign new_n315_ = ~x24 & ~x22 & ~x18 & new_n316_ & ~x17 & ~x25;
  assign new_n316_ = ~x14 & ~x11 & ~x10 & new_n305_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n318_ & ~x58 & ~x62;
  assign new_n318_ = ~x55 & ~x51 & ~x50 & new_n319_ & ~x47 & ~x56;
  assign new_n319_ = ~x43 & ~x42 & ~x41 & new_n320_ & ~x40 & ~x46;
  assign new_n320_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n314_ & x33;
  assign z42 = ~x62 & new_n322_ & ~x61;
  assign new_n322_ = ~x59 & ~x58 & ~x56 & new_n323_ & ~x55 & ~x60;
  assign new_n323_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n324_ & x49;
  assign new_n324_ = ~x47 & ~x46 & ~x45 & new_n325_ & ~x43;
  assign new_n325_ = ~x41 & ~x40 & ~x39 & new_n326_ & ~x37 & ~x42;
  assign new_n326_ = ~x34 & ~x33 & ~x31 & new_n327_ & ~x30 & ~x35;
  assign new_n327_ = ~x28 & ~x26 & ~x25 & new_n328_ & ~x24 & x29;
  assign new_n328_ = ~x18 & ~x17 & ~x15 & new_n254_ & ~x14 & ~x22;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n330_ & ~x58 & ~x62;
  assign new_n330_ = ~x55 & ~x54 & ~x53 & new_n331_ & ~x51 & ~x56;
  assign new_n331_ = ~x47 & ~x46 & ~x45 & new_n332_ & ~x43 & ~x50;
  assign new_n332_ = ~x41 & ~x40 & ~x39 & new_n333_ & ~x37 & ~x42;
  assign new_n333_ = ~x34 & ~x33 & ~x31 & new_n334_ & ~x30 & ~x35;
  assign new_n334_ = ~x28 & ~x26 & ~x25 & new_n335_ & ~x24 & x29;
  assign new_n335_ = ~x18 & ~x17 & ~x15 & new_n336_ & ~x14 & ~x22;
  assign new_n336_ = ~x10 & ~x09 & ~x08 & new_n337_ & ~x07 & ~x11;
  assign new_n337_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n339_ & ~x59;
  assign new_n339_ = ~x56 & ~x55 & ~x51 & new_n340_ & ~x50 & ~x58;
  assign new_n340_ = ~x46 & ~x43 & ~x42 & new_n341_ & ~x41 & ~x47;
  assign new_n341_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n314_ & x34;
  assign z46 = ~x62 & new_n343_ & ~x61;
  assign new_n343_ = ~x59 & ~x58 & ~x56 & new_n344_ & ~x55 & ~x60;
  assign new_n344_ = ~x50 & ~x47 & ~x46 & new_n345_ & ~x43 & ~x51;
  assign new_n345_ = ~x41 & ~x40 & ~x39 & new_n346_ & ~x37 & ~x42;
  assign new_n346_ = ~x35 & ~x30 & x29 & ~x28 & new_n347_ & ~x26;
  assign new_n347_ = ~x24 & ~x22 & ~x18 & new_n348_ & ~x17 & ~x25;
  assign new_n348_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n305_ & x09;
  assign z47 = ~x62 & new_n350_ & ~x61;
  assign new_n350_ = ~x59 & ~x58 & ~x56 & new_n351_ & ~x55 & ~x60;
  assign new_n351_ = ~x50 & ~x47 & ~x46 & new_n352_ & ~x43 & ~x51;
  assign new_n352_ = ~x41 & ~x40 & ~x39 & new_n353_ & ~x37 & ~x42;
  assign new_n353_ = ~x35 & ~x30 & x29 & ~x28 & new_n354_ & ~x26;
  assign new_n354_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n304_ & x17;
  assign z48 = ~x62 & ~x61 & new_n356_ & ~x60;
  assign new_n356_ = ~x58 & ~x56 & ~x55 & new_n357_ & ~x54 & ~x59;
  assign new_n357_ = ~x51 & ~x50 & ~x47 & new_n358_ & ~x46 & ~x53;
  assign new_n358_ = ~x42 & ~x41 & ~x40 & new_n359_ & ~x39 & ~x43;
  assign new_n359_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n314_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n361_ & ~x59;
  assign new_n361_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n311_ & x53;
  assign z50 = new_n363_ & ~x62;
  assign new_n363_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n364_ & x57;
  assign new_n364_ = ~x56 & ~x55 & new_n365_ & ~x54;
  assign new_n365_ = ~x51 & ~x50 & ~x49 & new_n324_ & ~x48 & ~x53;
  assign z51 = ~x62 & ~x61 & new_n367_ & ~x60;
  assign new_n367_ = ~x58 & ~x56 & ~x55 & new_n368_ & ~x54 & ~x59;
  assign new_n368_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n324_ & x48;
  assign z52 = new_n370_ & ~x64;
  assign new_n370_ = ~x62 & ~x61 & ~x60 & new_n371_ & ~x59 & ~x63;
  assign new_n371_ = ~x57 & ~x56 & ~x55 & new_n372_ & ~x54 & ~x58;
  assign new_n372_ = ~x51 & ~x50 & ~x49 & new_n373_ & ~x48 & ~x53;
  ...
  assign new_n377_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n254_ & x12;
  assign z53 = ~x64 & x63 & new_n379_ & ~x62;
  assign new_n379_ = ~x60 & ~x59 & ~x58 & new_n364_ & ~x57 & ~x61;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n287_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n382_ & ~x56;
  assign new_n382_ = ~x50 & ~x47 & ~x46 & new_n383_ & ~x43 & ~x51;
  assign new_n383_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n221_ & x35;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n385_ & ~x50 & ~x62;
  assign new_n385_ = ~x46 & ~x43 & ~x41 & new_n386_ & ~x40 & ~x47;
  assign new_n386_ = ~x39 & ~x37 & ~x30 & x29 & new_n387_ & ~x28;
  assign new_n387_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n388_ & x18;
  assign new_n388_ = ~x15 & new_n389_ & ~x14;
  assign new_n389_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n391_ & ~x56;
  assign new_n391_ = ~x47 & ~x46 & ~x43 & new_n392_ & ~x41 & ~x50;
  assign new_n392_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n393_ & x29;
  assign new_n393_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n388_ & x22;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n202_ & x40;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n396_ & ~x50;
  assign new_n396_ = ~x46 & ~x43 & ~x40 & new_n397_ & ~x39 & ~x47;
  assign new_n397_ = ~x37 & ~x30 & x29 & ~x28 & new_n398_ & ~x25;
  assign new_n398_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n400_ & x47;
  assign new_n400_ = new_n401_ & ~x46;
  assign new_n401_ = ~x40 & ~x39 & ~x37 & new_n402_ & ~x30 & ~x43;
  assign new_n402_ = x29 & new_n403_ & ~x28;
  assign new_n403_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n400_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n406_ & ~x46;
  assign new_n406_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n402_ & x30;
  assign z04 = 1'b0;
  assign z19 = 1'b0;
  assign z22 = 1'b0;
  assign z23 = 1'b0;
