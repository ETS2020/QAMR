...
module FAU ( 
  ...
  assign z12 = ~x60 & ~x58 & ~x56 & new_n159_ & ~x50 & ~x62;
  assign new_n159_ = ~x46 & ~x43 & ~x41 & new_n160_ & ~x40 & ~x47;
  ...
  assign z19 = x64 & new_n164_ & ~x62;
  assign new_n164_ = ~x60 & ~x59 & ~x58 & new_n165_ & ~x57 & ~x61;
  assign new_n165_ = ~x56 & ~x55 & new_n166_ & ~x54;
  ...
  assign new_n172_ = new_n154_ & ~x11;
  assign z21 = ~x62 & ~x60 & new_n174_ & ~x58;
  assign new_n174_ = ~x50 & ~x47 & ~x46 & new_n175_ & ~x43 & ~x56;
  assign new_n175_ = ~x40 & ~x39 & ~x37 & new_n176_ & ~x30 & ~x41;
  assign new_n176_ = ~x28 & ~x26 & ~x25 & new_n177_ & ~x24 & x29;
  assign new_n177_ = ~x18 & ~x15 & ~x14 & new_n178_ & ~x11 & ~x22;
  assign new_n178_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & new_n180_ & ~x63;
  assign new_n180_ = ~x61 & ~x60 & ~x59 & new_n181_ & ~x58 & ~x62;
  assign new_n181_ = ~x56 & ~x55 & ~x54 & new_n182_ & ~x53 & ~x57;
  assign new_n182_ = ~x50 & ~x49 & ~x48 & new_n183_ & ~x47 & ~x51;
  assign new_n183_ = ~x45 & ~x43 & ~x42 & new_n184_ & ~x41 & ~x46;
  assign new_n184_ = ~x40 & ~x39 & ~x37 & x36 & new_n185_ & ~x35;
  assign new_n185_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n186_ & x29;
  assign new_n186_ = ~x26 & ~x25 & ~x24 & new_n187_ & ~x22 & ~x28;
  assign new_n187_ = ~x18 & ~x17 & ~x15 & new_n188_ & ~x14;
  assign new_n188_ = new_n172_ & ~x12;
  assign z23 = ~x64 & ~x63 & ~x62 & new_n190_ & ~x61;
  ...
  assign new_n195_ = ~x33 & ~x31 & ~x30 & x29 & new_n196_ & ~x28;
  assign new_n196_ = ~x25 & ~x24 & ~x22 & new_n197_ & ~x21 & ~x26;
  assign new_n197_ = ~x18 & ~x17 & x16 & ~x15 & new_n188_ & ~x14;
  ...
  assign z26 = new_n205_ & ~x64;
  assign new_n205_ = ~x62 & ~x61 & ~x60 & new_n206_ & ~x59 & ~x63;
  assign new_n206_ = ~x57 & ~x56 & ~x55 & new_n207_ & ~x54 & ~x58;
  assign new_n207_ = ~x52 & ~x51 & ~x50 & new_n208_ & ~x49 & ~x53;
  assign new_n208_ = ~x47 & ~x46 & ~x45 & new_n209_ & ~x43 & ~x48;
  assign new_n209_ = ~x41 & ~x40 & ~x39 & new_n210_ & ~x37 & ~x42;
  assign new_n210_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n211_ & x32;
  assign new_n211_ = ~x31 & ~x30 & x29 & ~x28 & new_n212_ & ~x26;
  assign new_n212_ = ~x24 & ~x22 & ~x21 & new_n152_ & ~x20 & ~x25;
  ...
  assign new_n222_ = ~x15 & ~x14 & x13 & new_n172_ & ~x12;
  ...
  assign new_n233_ = ~x25 & ~x24 & ~x22 & new_n187_ & ~x21 & ~x26;
  assign z34 = new_n235_ & x58;
  assign new_n235_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n237_ & ~x60;
  assign new_n237_ = ~x56 & ~x55 & ~x51 & new_n238_ & ~x50 & ~x58;
  assign new_n238_ = ~x46 & ~x43 & ~x41 & new_n239_ & ~x40 & ~x47;
  assign new_n239_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n240_ & x29;
  assign new_n240_ = ~x26 & ~x25 & ~x24 & new_n241_ & ~x22 & ~x28;
  assign new_n241_ = ~x15 & ~x14 & ~x11 & new_n242_ & ~x10 & ~x18;
  assign new_n242_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z37 = ~x64 & new_n244_ & ~x63;
  assign new_n244_ = ~x61 & ~x60 & ~x59 & new_n245_ & ~x58 & ~x62;
  assign new_n245_ = ~x56 & ~x55 & ~x54 & new_n246_ & ~x53 & ~x57;
  assign new_n246_ = ~x51 & ~x50 & ~x49 & new_n247_ & ~x48 & ~x52;
  assign new_n247_ = ~x46 & ~x45 & ~x43 & new_n248_ & ~x42 & ~x47;
  assign new_n248_ = ~x40 & ~x39 & ~x37 & new_n249_ & ~x36 & ~x41;
  assign new_n249_ = ~x34 & ~x33 & ~x32 & new_n250_ & ~x31 & ~x35;
  assign new_n250_ = ~x30 & x29 & ~x28 & ~x26 & new_n251_ & ~x25;
  assign new_n251_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n152_ & x19;
  ...
  assign new_n277_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n167_ & x49;
  ...
  assign new_n291_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n268_ & x34;
  ...
  assign new_n298_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n259_ & x09;
  ...
  assign new_n304_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n258_ & x17;
  ...
  assign new_n309_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n268_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n311_ & ~x59;
  assign new_n311_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n265_ & x53;
  assign z50 = new_n313_ & ~x62;
  assign new_n313_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n165_ & x57;
  assign z51 = ~x62 & ~x61 & new_n315_ & ~x60;
  assign new_n315_ = ~x58 & ~x56 & ~x55 & new_n316_ & ~x54 & ~x59;
  assign new_n316_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n167_ & x48;
  ...
  assign new_n325_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n172_ & x12;
  ...
  assign new_n334_ = ~x17 & ~x16 & ~x15 & new_n188_ & ~x14 & ~x18;
