...
module FAU ( 
  ...
  assign new_n146_ = ~x37 & ~x28 & ~x15 & x10 & ~x14 & x29;
  assign z17 = ~x62 & new_n148_ & ~x60;
  assign new_n148_ = ~x58 & ~x50 & ~x47 & new_n149_ & ~x46 & ~x56;
  assign new_n149_ = ~x43 & ~x39 & ~x37 & new_n150_ & ~x30 & ~x40;
  assign new_n150_ = x29 & ~x25 & ~x24 & new_n151_ & ~x15 & ~x28;
  assign new_n151_ = ~x14 & ~x10 & ~x08 & x03 & ~x07 & ~x11;
  assign z19 = new_n153_ & x64;
  assign new_n153_ = ~x61 & ~x60 & new_n154_ & ~x59 & ~x62;
  assign new_n154_ = ~x58 & ~x56 & ~x55 & new_n155_ & ~x54 & ~x57;
  assign new_n155_ = ~x53 & ~x50 & ~x49 & new_n156_ & ~x48 & ~x51;
  assign new_n156_ = ~x46 & ~x45 & new_n157_ & ~x43 & ~x47;
  assign new_n157_ = ~x42 & ~x40 & ~x39 & new_n158_ & ~x37 & ~x41;
  assign new_n158_ = ~x35 & ~x33 & ~x31 & new_n159_ & ~x30 & ~x34;
  assign new_n159_ = x29 & ~x26 & ~x25 & new_n160_ & ~x24 & ~x28;
  assign new_n160_ = ~x22 & ~x17 & ~x15 & new_n161_ & ~x14 & ~x18;
  assign new_n161_ = new_n162_ & ~x11;
  assign new_n162_ = ~x10 & ~x08 & ~x07 & new_n163_ & ~x06 & ~x09;
  assign new_n163_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z21 = ~x62 & ~x60 & new_n165_ & ~x58;
  assign new_n165_ = ~x56 & ~x47 & ~x46 & new_n166_ & ~x43 & ~x50;
  assign new_n166_ = ~x41 & ~x39 & ~x37 & new_n167_ & ~x30 & ~x40;
  assign new_n167_ = x29 & ~x26 & ~x25 & new_n168_ & ~x24 & ~x28;
  assign new_n168_ = ~x22 & ~x15 & ~x14 & new_n169_ & ~x11 & ~x18;
  assign new_n169_ = ~x10 & ~x07 & ~x06 & x00 & ~x03 & ~x08;
  assign z22 = ~x63 & ~x62 & new_n171_ & ~x61 & ~x64;
  assign new_n171_ = ~x60 & ~x58 & ~x57 & new_n172_ & ~x56 & ~x59;
  assign new_n172_ = ~x55 & ~x53 & ~x51 & new_n173_ & ~x50 & ~x54;
  assign new_n173_ = ~x49 & ~x47 & ~x46 & new_n174_ & ~x45 & ~x48;
  assign new_n174_ = ~x43 & ~x41 & ~x40 & new_n175_ & ~x39 & ~x42;
  assign new_n175_ = ~x37 & ~x35 & ~x34 & new_n176_ & ~x33 & x36;
  assign new_n176_ = ~x31 & ~x30 & x29 & ~x28 & new_n177_ & ~x26;
  assign new_n177_ = ~x25 & ~x22 & ~x18 & new_n178_ & ~x17 & ~x24;
  assign new_n178_ = ~x14 & ~x12 & new_n162_ & ~x11 & ~x15;
  assign z23 = ~x64 & new_n180_ & ~x63;
  assign new_n180_ = ~x62 & ~x60 & ~x59 & new_n181_ & ~x58 & ~x61;
  assign new_n181_ = ~x57 & ~x55 & ~x54 & new_n182_ & ~x53 & ~x56;
  assign new_n182_ = ~x52 & ~x50 & ~x49 & new_n183_ & ~x48 & ~x51;
  assign new_n183_ = ~x47 & ~x45 & ~x43 & new_n184_ & ~x42 & ~x46;
  assign new_n184_ = ~x41 & ~x39 & ~x37 & new_n185_ & ~x36 & ~x40;
  ...
  assign z26 = ~x63 & ~x62 & new_n189_ & ~x61 & ~x64;
  assign new_n189_ = ~x60 & ~x58 & ~x57 & new_n190_ & ~x56 & ~x59;
  assign new_n190_ = ~x55 & ~x53 & ~x52 & new_n191_ & ~x51 & ~x54;
  assign new_n191_ = ~x50 & ~x48 & ~x47 & new_n192_ & ~x46 & ~x49;
  assign new_n192_ = ~x45 & ~x42 & ~x41 & new_n193_ & ~x40 & ~x43;
  assign new_n193_ = ~x39 & ~x36 & ~x35 & new_n194_ & ~x34 & ~x37;
  assign new_n194_ = ~x33 & x32 & ~x31 & ~x30 & new_n195_ & x29;
  assign new_n195_ = ~x28 & ~x25 & ~x24 & new_n196_ & ~x22 & ~x26;
  assign new_n196_ = ~x21 & ~x18 & ~x17 & new_n197_ & ~x16 & ~x20;
  assign new_n197_ = ~x15 & ~x13 & ~x12 & new_n162_ & ~x11 & ~x14;
  assign z27 = ~x64 & ~x63 & new_n199_ & ~x62;
  assign new_n199_ = ~x61 & ~x59 & ~x58 & new_n200_ & ~x57 & ~x60;
  assign new_n200_ = ~x56 & ~x54 & ~x53 & new_n201_ & ~x52 & ~x55;
  assign new_n201_ = ~x51 & ~x49 & ~x48 & new_n202_ & ~x47 & ~x50;
  assign new_n202_ = ~x46 & ~x43 & ~x42 & new_n203_ & ~x41 & ~x45;
  assign new_n203_ = ~x40 & ~x37 & ~x36 & new_n204_ & ~x35 & ~x39;
  assign new_n204_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n205_ & x29;
  assign new_n205_ = ~x28 & ~x25 & ~x24 & new_n206_ & ~x22 & ~x26;
  assign new_n206_ = ~x21 & ~x18 & ~x17 & new_n207_ & ~x16 & ~x20;
  assign new_n207_ = ~x15 & ~x14 & x13 & ~x12 & new_n162_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n209_ & ~x50;
  assign new_n209_ = ~x46 & ~x40 & ~x39 & new_n210_ & ~x37 & ~x43;
  assign new_n210_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x62 & ~x61 & new_n212_ & ~x60 & ~x63;
  assign new_n212_ = ~x59 & ~x57 & ~x56 & new_n213_ & ~x55 & ~x58;
  assign new_n213_ = ~x54 & ~x53 & x52 & ~x51 & new_n214_ & ~x50;
  assign new_n214_ = ~x49 & ~x47 & ~x46 & new_n215_ & ~x45 & ~x48;
  assign new_n215_ = ~x42 & ~x41 & new_n216_ & ~x40 & ~x43;
  assign new_n216_ = ~x39 & ~x36 & ~x35 & new_n217_ & ~x34 & ~x37;
  assign new_n217_ = ~x33 & ~x31 & ~x30 & new_n218_ & x29;
  assign new_n218_ = ~x26 & ~x25 & new_n219_ & ~x24 & ~x28;
  assign new_n219_ = ~x21 & ~x18 & new_n178_ & ~x17 & ~x22;
  assign z31 = ~x64 & ~x62 & ~x61 & new_n221_ & ~x60 & ~x63;
  assign new_n221_ = ~x59 & ~x57 & ~x56 & new_n222_ & ~x55 & ~x58;
  assign new_n222_ = ~x54 & ~x51 & ~x50 & new_n223_ & ~x49 & ~x53;
  assign new_n223_ = ~x48 & ~x46 & ~x45 & new_n224_ & ~x43 & ~x47;
  assign new_n224_ = ~x42 & ~x40 & ~x39 & new_n225_ & ~x37 & ~x41;
  assign new_n225_ = ~x36 & ~x34 & ~x33 & new_n226_ & ~x31 & ~x35;
  assign new_n226_ = ~x30 & ~x28 & ~x26 & new_n227_ & ~x25 & x29;
  assign new_n227_ = ~x24 & ~x22 & x21 & ~x18 & new_n178_ & ~x17;
  ...
  assign z37 = ~x64 & ~x62 & ~x61 & new_n238_ & ~x60 & ~x63;
  assign new_n238_ = ~x59 & ~x57 & ~x56 & new_n239_ & ~x55 & ~x58;
  assign new_n239_ = ~x54 & ~x52 & ~x51 & new_n240_ & ~x50 & ~x53;
  assign new_n240_ = ~x49 & ~x47 & ~x46 & new_n241_ & ~x45 & ~x48;
  assign new_n241_ = ~x43 & ~x41 & ~x40 & new_n242_ & ~x39 & ~x42;
  assign new_n242_ = ~x37 & ~x35 & ~x34 & new_n243_ & ~x33 & ~x36;
  assign new_n243_ = ~x32 & ~x31 & ~x30 & x29 & new_n244_ & ~x28;
  assign new_n244_ = ~x26 & ~x24 & ~x22 & new_n245_ & ~x21 & ~x25;
  assign new_n245_ = ~x20 & ~x18 & ~x17 & new_n197_ & ~x16 & x19;
  assign z38 = ~x62 & ~x61 & new_n247_ & ~x60;
  assign new_n247_ = x59 & ~x56 & ~x55 & new_n248_ & ~x51 & ~x58;
  assign new_n248_ = ~x50 & ~x46 & ~x43 & new_n249_ & ~x42 & ~x47;
  assign new_n249_ = ~x41 & ~x40 & new_n250_ & ~x39;
  assign new_n250_ = ~x37 & ~x35 & ~x30 & x29 & new_n251_ & ~x28;
  assign new_n251_ = ~x26 & ~x24 & ~x22 & new_n252_ & ~x18 & ~x25;
  assign new_n252_ = ~x14 & ~x11 & new_n253_ & ~x10 & ~x15;
  assign new_n253_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n255_ & ~x61;
  assign new_n255_ = ~x60 & ~x56 & ~x55 & new_n256_ & ~x51 & ~x58;
  ...
  assign new_n260_ = ~x46 & ~x42 & ~x41 & new_n261_ & ~x40 & ~x43;
  assign new_n261_ = ~x39 & ~x35 & ~x34 & new_n262_ & ~x33 & ~x37;
  assign new_n262_ = ~x30 & x29 & ~x28 & new_n263_ & ~x26;
  assign new_n263_ = ~x25 & ~x22 & ~x18 & new_n264_ & ~x17 & ~x24;
  assign new_n264_ = ~x15 & ~x11 & ~x10 & new_n253_ & ~x09 & ~x14;
  assign z41 = ~x62 & ~x60 & ~x59 & new_n266_ & ~x58 & ~x61;
  assign new_n266_ = ~x56 & ~x51 & ~x50 & new_n267_ & ~x47 & ~x55;
  assign new_n267_ = ~x46 & ~x42 & ~x41 & new_n268_ & ~x40 & ~x43;
  assign new_n268_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n262_ & x33;
  assign z42 = ~x62 & new_n270_ & ~x61;
  assign new_n270_ = ~x60 & ~x58 & ~x56 & new_n271_ & ~x55 & ~x59;
  assign new_n271_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n156_ & x49;
  assign z43 = new_n273_ & ~x62;
  assign new_n273_ = ~x61 & ~x59 & ~x58 & new_n274_ & ~x56 & ~x60;
  assign new_n274_ = ~x55 & ~x53 & ~x51 & new_n275_ & ~x50 & ~x54;
  assign new_n275_ = ~x47 & ~x45 & ~x43 & new_n276_ & ~x42 & ~x46;
  assign new_n276_ = ~x41 & ~x39 & ~x37 & new_n277_ & ~x35 & ~x40;
  assign new_n277_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n278_ & x29;
  assign new_n278_ = ~x28 & ~x25 & ~x24 & new_n279_ & ~x22 & ~x26;
  assign new_n279_ = ~x18 & ~x15 & ~x14 & new_n280_ & ~x11 & ~x17;
  assign new_n280_ = ~x10 & ~x08 & ~x07 & new_n281_ & ~x06 & ~x09;
  ...
  assign new_n317_ = ~x56 & ~x55 & new_n155_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n319_ & ~x60;
  assign new_n319_ = ~x59 & ~x56 & ~x55 & new_n320_ & ~x54 & ~x58;
  assign new_n320_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n156_ & x48;
  ...
  assign new_n329_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n161_ & x12;
  assign z53 = ~x64 & new_n153_ & x63;
  assign z56 = ~x64 & ~x63 & new_n332_ & ~x62;
  assign new_n332_ = ~x61 & ~x59 & ~x58 & new_n333_ & ~x57 & ~x60;
  assign new_n333_ = ~x56 & ~x54 & ~x53 & new_n334_ & ~x52 & ~x55;
  assign new_n334_ = ~x51 & ~x49 & ~x48 & new_n335_ & ~x47 & ~x50;
  assign new_n335_ = ~x46 & ~x43 & ~x42 & new_n336_ & ~x41 & ~x45;
  assign new_n336_ = ~x40 & ~x37 & ~x36 & new_n337_ & ~x35 & ~x39;
  assign new_n337_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n338_ & x29;
  assign new_n338_ = ~x28 & ~x25 & ~x24 & new_n339_ & ~x22 & ~x26;
  assign new_n339_ = ~x21 & ~x18 & ~x17 & new_n178_ & ~x16 & x20;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n341_ & ~x50 & ~x60;
  assign new_n341_ = ~x47 & ~x43 & ~x41 & new_n342_ & ~x40 & ~x46;
  ...
  assign z58 = ~x60 & ~x58 & new_n347_ & ~x56 & ~x62;
  assign new_n347_ = ~x50 & ~x46 & ~x43 & new_n348_ & ~x41 & ~x47;
