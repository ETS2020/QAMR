...
module FAU ( 
  ...
  assign z08 = ~x63 & ~x62 & ~x61 & new_n163_ & ~x60 & ~x64;
  assign new_n163_ = ~x58 & ~x57 & ~x56 & new_n164_ & ~x55 & ~x59;
  assign new_n164_ = ~x53 & ~x52 & ~x51 & new_n165_ & ~x50 & ~x54;
  assign new_n165_ = ~x48 & ~x47 & ~x46 & new_n166_ & ~x45 & ~x49;
  assign new_n166_ = ~x42 & ~x41 & ~x40 & new_n167_ & ~x39 & ~x43;
  assign new_n167_ = x38 & new_n160_ & ~x37;
  assign z09 = ~x64 & ~x63 & ~x62 & new_n169_ & ~x61;
  assign new_n169_ = ~x59 & ~x58 & ~x57 & new_n170_ & ~x56 & ~x60;
  assign new_n170_ = ~x54 & ~x53 & ~x52 & new_n171_ & ~x51 & ~x55;
  assign new_n171_ = ~x49 & ~x48 & ~x47 & new_n172_ & ~x46 & ~x50;
  assign new_n172_ = ~x43 & ~x42 & ~x41 & new_n173_ & ~x40 & ~x45;
  assign new_n173_ = ~x37 & ~x36 & ~x35 & new_n174_ & ~x34 & ~x39;
  assign new_n174_ = ~x33 & ~x32 & ~x31 & ~x30 & new_n175_ & x29;
  assign new_n175_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n176_ & x23;
  assign new_n176_ = ~x22 & new_n150_ & ~x21;
