...
module FAU ( 
  ...
  assign new_n272_ = ~x15 & ~x14 & x13 & new_n220_ & ~x12;
  assign z29 = ~x58 & ~x50 & new_n274_ & ~x46 & x60;
  assign new_n274_ = ~x43 & ~x40 & new_n194_ & ~x39;
  ...
  assign new_n298_ = ~x41 & ~x39 & ~x37 & new_n224_ & ~x35 & ~x40;
  ...
  assign new_n307_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n262_ & x19;
  assign z42 = ~x62 & new_n309_ & ~x61;
  assign new_n309_ = ~x60 & ~x58 & ~x56 & new_n310_ & ~x55 & ~x59;
  assign new_n310_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n215_ & x49;
  ...
  assign new_n322_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n213_ & x57;
  assign z51 = ~x62 & ~x61 & new_n324_ & ~x60;
  assign new_n324_ = ~x59 & ~x56 & ~x55 & new_n325_ & ~x54 & ~x58;
  assign new_n325_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n215_ & x48;
  ...
  assign new_n334_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n220_ & x12;
  assign z53 = ~x64 & new_n211_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n297_ & x55;
  assign z55 = ~x60 & ~x58 & new_n338_ & ~x56 & ~x62;
  assign new_n338_ = ~x51 & ~x47 & ~x46 & new_n339_ & ~x43 & ~x50;
  assign new_n339_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n224_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n341_ & ~x60 & ~x63;
  assign new_n341_ = ~x59 & ~x57 & ~x56 & new_n342_ & ~x55 & ~x58;
  assign new_n342_ = ~x54 & ~x52 & ~x51 & new_n343_ & ~x50 & ~x53;
  assign new_n343_ = ~x49 & ~x47 & ~x46 & new_n344_ & ~x45 & ~x48;
  assign new_n344_ = ~x43 & ~x41 & ~x40 & new_n345_ & ~x39 & ~x42;
  assign new_n345_ = ~x37 & ~x35 & ~x34 & new_n346_ & ~x33 & ~x36;
  assign new_n346_ = ~x31 & ~x30 & x29 & ~x28 & new_n347_ & ~x26;
  assign new_n347_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n348_ & x20;
  assign new_n348_ = ~x18 & ~x16 & ~x15 & new_n237_ & ~x14 & ~x17;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n350_ & ~x50 & ~x60;
  assign new_n350_ = ~x47 & ~x43 & ~x41 & new_n351_ & ~x40 & ~x46;
  ...
  assign z58 = ~x60 & ~x58 & new_n356_ & ~x56 & ~x62;
  assign new_n356_ = ~x50 & ~x46 & ~x43 & new_n357_ & ~x41 & ~x47;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n361_ & ~x47 & ~x58;
  assign new_n361_ = ~x46 & ~x40 & ~x39 & new_n362_ & ~x37 & ~x43;
  assign new_n362_ = ~x30 & ~x28 & ~x25 & new_n363_ & ~x24 & x29;
  assign new_n363_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n365_ & ~x50 & ~x60;
  assign new_n365_ = ~x47 & ~x43 & ~x40 & new_n366_ & ~x39 & ~x46;
  assign new_n366_ = ~x37 & ~x30 & x29 & ~x28 & new_n367_ & ~x25;
  assign new_n367_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z00 = 1'b0;
  assign z21 = 1'b0;
  assign z28 = 1'b0;
  assign z35 = 1'b0;
