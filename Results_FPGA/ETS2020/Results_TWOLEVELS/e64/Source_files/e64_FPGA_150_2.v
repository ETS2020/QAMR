...
module FAU ( 
  ...
  assign z28 = ~x60 & ~x58 & new_n255_ & ~x50;
  assign new_n255_ = ~x43 & ~x40 & ~x39 & new_n256_ & ~x37 & ~x46;
  assign new_n256_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n258_ & ~x46;
  assign new_n258_ = ~x43 & ~x40 & new_n201_ & ~x39;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n260_ & ~x60 & ~x64;
  assign new_n260_ = ~x58 & ~x57 & ~x56 & new_n261_ & ~x55 & ~x59;
  assign new_n261_ = ~x53 & ~x51 & ~x50 & new_n262_ & ~x49 & ~x54;
  assign new_n262_ = ~x47 & ~x46 & ~x45 & new_n263_ & ~x43 & ~x48;
  assign new_n263_ = ~x41 & ~x40 & ~x39 & new_n264_ & ~x37 & ~x42;
  assign new_n264_ = ~x35 & ~x34 & ~x33 & new_n265_ & ~x31 & ~x36;
  assign new_n265_ = ~x30 & x29 & ~x28 & ~x26 & new_n266_ & ~x25;
  assign new_n266_ = ~x24 & ~x22 & x21 & ~x18 & new_n238_ & ~x17;
  assign z32 = ~x58 & ~x50 & new_n258_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n201_ & x39;
  assign z35 = ~x62 & ~x61 & new_n270_ & ~x60;
  assign new_n270_ = ~x56 & ~x55 & ~x51 & new_n271_ & ~x50 & ~x58;
  assign new_n271_ = ~x46 & ~x43 & ~x41 & new_n272_ & ~x40 & ~x47;
  assign new_n272_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n273_ & x29;
  assign new_n273_ = ~x26 & ~x25 & ~x24 & new_n274_ & ~x22 & ~x28;
  assign new_n274_ = ~x15 & ~x14 & ~x11 & new_n275_ & ~x10 & ~x18;
  assign new_n275_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n277_ & ~x62;
  assign new_n277_ = ~x60 & ~x58 & ~x56 & new_n278_ & ~x55 & x61;
  assign new_n278_ = ~x50 & ~x47 & ~x46 & new_n279_ & ~x43 & ~x51;
  assign new_n279_ = ~x40 & ~x39 & ~x37 & new_n220_ & ~x35 & ~x41;
  ...
  assign new_n304_ = ~x60 & ~x59 & ~x58 & new_n305_ & ~x56 & ~x61;
  assign new_n305_ = ~x54 & ~x53 & ~x51 & new_n306_ & ~x50 & ~x55;
  ...
  assign new_n310_ = ~x17 & ~x15 & ~x14 & new_n311_ & ~x11 & ~x18;
  assign new_n311_ = ~x09 & ~x08 & ~x07 & new_n312_ & ~x06 & ~x10;
  assign new_n312_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n314_ & ~x58 & ~x62;
  assign new_n314_ = ~x55 & ~x54 & ~x53 & new_n315_ & ~x51 & ~x56;
  assign new_n315_ = ~x47 & ~x46 & ~x45 & new_n316_ & ~x43 & ~x50;
  assign new_n316_ = ~x41 & ~x40 & ~x39 & new_n317_ & ~x37 & ~x42;
  assign new_n317_ = ~x34 & ~x33 & ~x31 & new_n318_ & ~x30 & ~x35;
  assign new_n318_ = ~x28 & ~x26 & ~x25 & new_n319_ & ~x24 & x29;
  assign new_n319_ = ~x18 & ~x17 & ~x15 & new_n320_ & ~x14 & ~x22;
  assign new_n320_ = ~x10 & ~x09 & ~x08 & new_n321_ & ~x07 & ~x11;
  assign new_n321_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n323_ & ~x59;
  assign new_n323_ = ~x56 & ~x55 & ~x51 & new_n324_ & ~x50 & ~x58;
  assign new_n324_ = ~x46 & ~x43 & ~x42 & new_n325_ & ~x41 & ~x47;
  assign new_n325_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n296_ & x34;
  assign z46 = ~x62 & new_n327_ & ~x61;
  ...
  assign new_n332_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n287_ & x09;
  assign z47 = ~x62 & new_n334_ & ~x61;
  ...
  assign new_n338_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n286_ & x17;
  assign z48 = ~x62 & ~x61 & new_n340_ & ~x60;
  assign new_n340_ = ~x58 & ~x56 & ~x55 & new_n341_ & ~x54 & ~x59;
  assign new_n341_ = ~x51 & ~x50 & ~x47 & new_n342_ & ~x46 & ~x53;
  assign new_n342_ = ~x42 & ~x41 & ~x40 & new_n343_ & ~x39 & ~x43;
  assign new_n343_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n296_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n345_ & ~x59;
  assign new_n345_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n293_ & x53;
  ...
  assign new_n349_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n220_ & x35;
  assign z56 = ~x64 & ~x63 & new_n351_ & ~x62;
  assign new_n351_ = ~x60 & ~x59 & ~x58 & new_n352_ & ~x57 & ~x61;
  assign new_n352_ = ~x55 & ~x54 & ~x53 & new_n353_ & ~x52 & ~x56;
  assign new_n353_ = ~x50 & ~x49 & ~x48 & new_n354_ & ~x47 & ~x51;
  assign new_n354_ = ~x45 & ~x43 & ~x42 & new_n355_ & ~x41 & ~x46;
  assign new_n355_ = ~x39 & ~x37 & ~x36 & new_n356_ & ~x35 & ~x40;
  assign new_n356_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n357_ & x29;
  assign new_n357_ = ~x26 & ~x25 & ~x24 & new_n358_ & ~x22 & ~x28;
  assign new_n358_ = ~x21 & x20 & ~x18 & ~x17 & new_n238_ & ~x16;
