// Benchmark "FAU" written by ABC on Sat Aug  1 17:32:25 2020
...
module FAU ( 
  ...
  assign z17 = x33 & (x07 | (~x32 & ((~new_n194_ & ~x36) | (new_n211_ & ~x07))));
  ...
  assign new_n206_ = ~x31 & ~x35 & x38 & (new_n207_ | (new_n108_ & ~x09));
  ...
  assign new_n210_ = x34 & ~x35 & ~x37 & x38 & ~new_n135_ & x39;
  assign new_n211_ = ~x34 & ~new_n212_ & x36;
  assign new_n212_ = (new_n133_ | ~x00) & (new_n141_ | x40);
  assign z21 = ~x33 | (~x07 & ((~new_n220_ & ~x35) | (~new_n214_ & ~x34)));
  assign new_n214_ = (~x36 | ((new_n215_ | ~x35) & ~new_n217_ & ~x32)) & (~x35 | (~new_n219_ & ~x32));
  assign new_n215_ = (~x37 | (~new_n216_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n216_ = ~x00 & (new_n162_ | (~x05 & x38));
  assign new_n217_ = new_n218_ & ~x00;
  assign new_n218_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n219_ = ~x00 & ~x05 & x37 & x38 & x39 & ~x40;
  assign new_n220_ = (~x34 | new_n221_ | x36) & (~new_n162_ | ~x32 | ~x36 | x37);
  assign new_n221_ = new_n222_ & (x00 | x05 | x37 | new_n83_ | x38);
  assign new_n222_ = ~x32 & (~new_n83_ | ~x38 | x06 | ~x37);
  assign z23 = x33 & (x07 | (~x32 & (new_n251_ | ~new_n224_ | new_n246_)));
  assign new_n224_ = (x35 | (~new_n225_ & new_n240_)) & (x34 | (~new_n245_ & (new_n244_ | ~x35)));
  assign new_n225_ = ~x36 & (new_n239_ | ~new_n236_ | (~x05 & (new_n226_ | new_n233_)));
  assign new_n226_ = x38 & (~new_n230_ | (~x34 & (~new_n232_ | (new_n227_ & ~x07))));
  assign new_n227_ = ~x31 & (new_n109_ | (~x09 & (new_n228_ | (~new_n229_ & ~x40))));
  assign new_n228_ = x37 & x39;
  assign new_n229_ = ~x39 & (~x15 | x16 | x37 | (~x11 & ~x12));
  assign new_n230_ = ~new_n231_ & (~new_n127_ | ~new_n187_ | x07 | x28 | x29);
  assign new_n231_ = x15 & ~x37 & x39 & ~x40 & (~x11 | ~x12);
  assign new_n232_ = ~x31 & (x39 | ~x40 | (~x29 & ~x30));
  assign new_n233_ = ~x34 & ((~x07 & new_n234_ & ~x09) | (x31 & ~x37));
  assign new_n234_ = x15 & ~x16 & new_n235_ & ~x31;
  assign new_n235_ = (x11 | x12) & ((~x37 & x39) | (~x38 & x40));
  assign new_n236_ = (~x40 | ((new_n238_ | ~x34) & (x37 | ~x38))) & (~x34 | ((~x38 | x40) & (~x37 | new_n237_ | x38)));
  assign new_n237_ = ~x39 & (x07 | new_n135_ | x39);
  assign new_n238_ = (~x37 | x38 | x39) & (x07 | (x37 ? (~x38 | x39) : (x38 | ~x39)));
  assign new_n239_ = (new_n89_ | ~x15) & ((~x37 & x38) | (~x34 & ~x38 & x39));
  assign new_n240_ = (new_n241_ | x34) & (new_n243_ | ~x36);
  assign new_n241_ = ~new_n242_ & (~new_n228_ | x05 | ~x31);
  assign new_n242_ = ~x38 & x40 & (new_n89_ | ~x15);
  assign new_n243_ = (x34 | ((~x37 | (~x39 & (x38 | ~x40))) & (x37 | x39) & (~x38 | x40))) & (x38 | x39 | x40 | x07 | ~x34 | x37);
  assign new_n244_ = (~x37 | ((x07 | x40 | (x36 ? (x38 | ~x39) : (~x38 | x39))) & (x36 | x38 | ~x39))) & (x37 | ((~x36 | (x38 & (~x38 | x39 | ~x40))) & (x38 | x39) & (~x38 | ~x39 | x40))) & (x36 | ~x38 | ~x40);
  assign new_n245_ = ~x38 & ((x37 & ((~x36 & ~x39) | (~x05 & x39 & ~x40))) | (x36 & ~x37 & x40));
  assign new_n246_ = x00 & ((~new_n247_ & ~x01) | (~new_n250_ & ~x34));
  assign new_n247_ = (new_n249_ | x04) & (~x02 | x03 | ~x04 | new_n248_ | x07);
  assign new_n248_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n83_ | x38);
  assign new_n249_ = (x36 | x37 | ~x34 | x35) & (~x37 | ~x38 | x34 | ~x36);
  assign new_n250_ = x35 ? (x40 | ((x38 | x39) & (x36 | ~x37 | ~x39))) : (~x36 | ~x40);
  assign new_n251_ = x05 & (new_n252_ | (~x34 & ~x35 & (~x36 | x40)));
  assign new_n252_ = ~x00 & ((~x35 & ~x36 & ~x37) | (~x34 & x37 & x38));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n257_ : ~new_n254_);
  assign new_n254_ = ~new_n195_ & ~new_n210_ & (x34 | (~new_n256_ & (new_n255_ | x05)));
  assign new_n255_ = ~new_n206_ & (~new_n97_ | ~x15);
  assign new_n256_ = x35 & x37 & x38 & ~x39 & ~x40;
  assign new_n257_ = (new_n212_ | x34) & (~new_n162_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & ~new_n259_ & x33;
  assign new_n259_ = x36 ? new_n263_ : (~new_n260_ & (x05 | new_n255_ | x34));
  assign new_n260_ = ~x38 & (new_n92_ | (~x35 & (new_n196_ | (~new_n261_ & x34))));
  assign new_n261_ = (x05 | ~x15 | ~new_n85_ | ~x37) & (~new_n262_ | ~x00);
  assign new_n262_ = ~x01 & x02 & ~x03 & x04 & ~new_n83_ & ~x37;
  assign new_n263_ = (~new_n162_ | ~x34 | x35 | x37) & (x34 | (~new_n266_ & (~x35 | new_n264_ | ~x37)));
  assign new_n264_ = (x38 | ~x39 | x40) & (~new_n265_ | x03 | ~x04 | ~x38);
  assign new_n265_ = x00 & ~x01 & x02;
  assign new_n266_ = new_n267_ & x10 & x27 & ~x35;
  assign new_n267_ = ~x39 & ~x40 & ~x37 & x38;
  assign z26 = ~x07 & ~x32 & ~new_n269_ & x33;
  assign new_n269_ = (new_n270_ | x35) & (~x00 | x34 | ~x35 | ~new_n136_ | ~x36);
  assign new_n270_ = (new_n271_ | new_n135_) & (~new_n162_ | ~x34 | ~x36 | x37);
  assign new_n271_ = (new_n272_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n272_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign z27 = ~x07 & ~x32 & x33 & (new_n284_ | (new_n274_ & ~x05));
  assign new_n274_ = ~x36 & (new_n283_ | (x15 & ~new_n275_ & ~new_n89_));
  assign new_n275_ = x34 ? (~new_n282_ | x35) : ((x31 | new_n279_ | x35) & (new_n276_ | ~x35));
  assign new_n276_ = (x38 | new_n277_ | x39) & (x37 | ~x38 | new_n278_ | ~x39);
  assign new_n277_ = (~x40 | (x24 & (new_n94_ | ~x37))) & (x37 | (x24 & (new_n95_ | x40)));
  assign new_n278_ = (x21 | (~new_n157_ & (~x22 | ~x24 | x40))) & x22 & x24 & (~x21 | ~x22 | x23 | x40);
  assign new_n279_ = ~new_n281_ & (new_n280_ | x16);
  assign new_n280_ = (x17 | ((x37 | ~x38 | ~x39 | ~x40) & (~x37 | x38 | x39))) & (x09 | ((x37 | (~x39 & (~x38 | x40))) & (x38 | (~x40 & (~x37 | x39)))));
  assign new_n281_ = ~x09 & ~x17 & ((x38 & x39) | (x37 & ~x38 & ~x39));
  assign new_n282_ = x37 & ~x38 & x39 & x40 & (~x22 | (~x21 & x22));
  assign new_n283_ = ~x09 & ~x31 & ~x34 & ~x35 & new_n108_ & x38;
  assign new_n284_ = new_n285_ & ~x34 & x35 & x36;
  assign new_n285_ = x37 & ~x38 & x39 & ~x40;
  assign z28 = ~x07 & ~x32 & x33 & (new_n287_ | new_n288_);
  assign new_n287_ = x00 & ~x01 & x02 & ~x03 & ~new_n248_ & x04;
  assign new_n288_ = new_n289_ & x10 & x27 & ~x34 & ~x35;
  assign new_n289_ = x36 & ~x37 & x38 & ~x39 & ~x40;
  assign z29 = ~x07 & ~x32 & x33 & (new_n284_ | (new_n291_ & ~x05));
  assign new_n291_ = ~x36 & (new_n292_ | (x15 & ~x21 & new_n296_ & x22));
  assign new_n292_ = ~x34 & (new_n293_ | (~x31 & ~x35 & new_n207_ & x38));
  assign new_n293_ = ~x40 & (new_n295_ | (x15 & ~x21 & new_n294_ & x22));
  assign new_n294_ = x24 & x35 & ~x37 & ~new_n89_ & (~x38 ^ x39);
  assign new_n295_ = ~x31 & ~x35 & x37 & ~x38 & ~new_n198_ & x39;
  assign new_n296_ = x34 & ~x35 & x37 & new_n297_ & ~x38;
  assign new_n297_ = x39 & ~new_n89_ & x40;
  assign z31 = ~x07 & ~x32 & x33 & (new_n307_ | (~new_n299_ & ~x34));
  assign new_n299_ = (new_n300_ | ~x35) & (~new_n267_ | ~x10 | ~x27 | x35 | ~x36);
  assign new_n300_ = ~new_n305_ & (x05 | ~x15 | ~new_n301_ | x36);
  assign new_n301_ = ~new_n89_ & ((new_n302_ & ~x38) | (~x37 & new_n304_ & x38));
  assign new_n302_ = ~x39 & ((~x24 & ~x37) | (x40 & (~x24 | (new_n303_ & ~x21))));
  assign new_n303_ = x22 & ~x23 & x37 & ((x18 & x19) | (x09 & (x18 | x19)));
  assign new_n304_ = x39 & (~x24 | (x21 & x22 & ~x23 & ~x40));
  assign new_n305_ = new_n306_ & x00 & ~x01 & x02 & ~x03;
  assign new_n306_ = x04 & x36 & x37 & x38;
  assign new_n307_ = x00 & ~x01 & x02 & ~x03 & new_n308_ & x04;
  assign new_n308_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n83_ & ~x38;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
