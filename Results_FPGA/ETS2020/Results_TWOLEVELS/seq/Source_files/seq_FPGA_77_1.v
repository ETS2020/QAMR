// Benchmark "FAU" written by ABC on Sat Aug  1 17:33:03 2020
...
module FAU ( 
  ...
  assign new_n499_ = x34 ? (x35 | new_n521_ | x36) : (x35 ? new_n500_ : new_n511_);
  assign new_n500_ = x37 ? ((new_n509_ | ~x36) & (x05 | ~new_n501_ | x36)) : new_n504_;
  assign new_n501_ = ~x38 & ~x39 & ~new_n502_ & x40;
  assign new_n502_ = (~x15 | ~x22 | ~x24 | new_n503_ | new_n95_) & (x13 | (~new_n95_ & x15));
  assign new_n503_ = ~x21 & (x21 | new_n174_ | ~x23);
  assign new_n504_ = x36 ? ((x39 | (x38 & (~x38 | ~x40))) & (~x38 | ~x39 | (x40 & (~x06 | ~x40)))) : (~new_n505_ & (~x38 | x39 | x40) & (x38 | ~x39 | ~x40));
  assign new_n505_ = ~x05 & ((new_n508_ & ~x13) | (x15 & new_n506_ & x22));
  assign new_n506_ = x24 & ~new_n95_ & ((new_n507_ & x38) | (new_n167_ & x21 & ~x38));
  assign new_n507_ = x39 & (x21 ? (x23 | x40) : (x40 & (x09 | x18)));
  assign new_n508_ = ~new_n88_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n509_ = (~new_n510_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n510_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n167_ & x01 & ~x38));
  assign new_n511_ = (new_n520_ | ~x36) & (x05 | x31 | new_n512_ | x36);
  assign new_n512_ = ~new_n315_ & ~new_n513_ & new_n519_ & (x37 | (~new_n516_ & ~new_n517_));
  assign new_n513_ = x15 & ((~new_n514_ & x09) | (x16 & new_n152_ & x17));
  assign new_n514_ = x37 ? (x38 | x39 | new_n104_ | new_n154_) : (~x38 | new_n515_ | ~x39);
  assign new_n515_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n516_ = x38 & ~x39 & ~new_n88_ & ~x40;
  assign new_n517_ = x39 & (new_n518_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n518_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n519_ = (x38 | new_n88_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n520_ = (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n285_ | ~x40))))) & (x39 | x40 | ~x37 | x38);
  assign new_n521_ = x38 ? ((x39 | (~x40 & (x37 | x40))) & (~x39 | ~x40 | ~x06 | ~x37)) : new_n522_;
  assign new_n522_ = ~new_n523_ & (x01 | x02 | new_n418_ | x03);
  assign new_n523_ = x39 & x40 & (~x37 | (~x05 & ~new_n307_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~new_n525_ & ~x32));
  assign new_n525_ = ~new_n548_ & (x34 | (~new_n533_ & ~new_n545_ & (new_n526_ | ~x37)));
  assign new_n526_ = (x35 | new_n527_ | x36) & (~x36 | (x38 ? new_n529_ : ~new_n531_));
  assign new_n527_ = x05 ? ~x38 : (x31 | ~new_n528_ | x38);
  assign new_n528_ = ~x39 & ((new_n244_ & x15) | new_n95_ | ~x15);
  assign new_n529_ = x00 ? (~new_n530_ | x01) : (~x05 | (~new_n121_ & ~x35));
  assign new_n530_ = ~x02 & ~x03 & ((x04 & x35) | (new_n121_ & ~x04 & ~x35));
  assign new_n531_ = ~x39 & (x35 ? (new_n532_ | (x06 & x40)) : ~x40);
  assign new_n532_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n533_ = x39 & (~new_n540_ | (x38 & (new_n544_ | (~new_n534_ & ~x37))));
  assign new_n534_ = (x35 | (x36 ? (~new_n539_ & x40) : new_n535_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n535_ = ~new_n538_ & (~x15 | (~new_n537_ & (x05 | new_n536_ | x31)));
  assign new_n536_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n300_));
  assign new_n537_ = x11 & x12 & x14 & ~new_n145_ & x40;
  assign new_n538_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n539_ = new_n422_ & ~x03 & ~x04 & x40;
  assign new_n540_ = (x35 | ((new_n541_ | x36) & (~new_n543_ | ~x11 | ~x36))) & (~new_n543_ | ~x35 | x36);
  assign new_n541_ = x05 ? x38 : (x31 | new_n542_ | x37);
  assign new_n542_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n95_ & x15));
  assign new_n543_ = ~x37 & ~x38 & x40;
  assign new_n544_ = x05 & ((~x00 & ((~x36 & ~x40) | (~x37 & x40 & ~x35 & x36))) | (~x36 & ~x37 & (x35 | ~x40)));
  assign new_n545_ = ~x36 & (new_n547_ | (~x35 & (new_n437_ | (new_n546_ & ~x05))));
  assign new_n546_ = ~x31 & ~new_n88_ & ((~x38 & x40) | (~x39 & ~x40 & ~x37 & x38));
  assign new_n547_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n548_ = ~x35 & ~x36 & (new_n551_ | (~new_n549_ & ~x38));
  assign new_n549_ = (~new_n112_ | ~x05 | ~x37) & (x37 | new_n112_ | (~new_n550_ & (x00 | ~x05)));
  assign new_n550_ = new_n422_ & ~x03 & x04 & x34;
  assign new_n551_ = x34 & x37 & x38 & ((~x39 & ~x40) | (x06 & x39 & x40));
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
