// Benchmark "FAU" written by ABC on Sat Aug  1 17:33:14 2020
...
module FAU ( 
  ...
  assign new_n161_ = x21 & ~x37 & new_n162_ & ~x38;
  ...
  assign z13 = x33 & (x07 | (~x32 & ~x34 & new_n192_ & x35));
  assign new_n192_ = ~x37 & ((~x07 & ~x36 & (x38 ? (~x39 & ~x40) : (x39 & x40))) | (x36 & ~x38 & ~x39));
  ...
  assign z19 = ~x07 & ~x32 & ~new_n214_ & x33;
  assign new_n214_ = x38 ? new_n218_ : ((new_n215_ | x35) & (x34 | ~new_n222_ | ~x35));
  assign new_n215_ = ~new_n216_ & (x34 | ~x36 | ~new_n162_ | ~x37);
  assign new_n216_ = ~x01 & ~x02 & ~x03 & new_n217_ & x34;
  assign new_n217_ = ~x36 & ((x00 & x04 & ~x37 & (~x39 | ~x40)) | (~x39 & ~x40 & ~x04 & x37));
  assign new_n218_ = (~new_n221_ | ~x06) & (x34 | new_n219_ | ~x35);
  assign new_n219_ = (~new_n220_ | x03 | ~x04 | ~x36 | ~x37) & (~new_n162_ | x36 | x37);
  assign new_n220_ = x00 & ~x01 & ~x02;
  assign new_n221_ = x39 & x40 & ((~x36 & x37 & x34 & ~x35) | (x36 & ~x37 & ~x34 & x35));
  assign new_n222_ = x40 & (x36 ? (x37 & (x06 | x39)) : (~x37 & x39));
  assign z21 = ~x33 | (~x07 & ((~new_n230_ & ~x35) | (~new_n224_ & ~x34)));
  assign new_n224_ = (~x36 | ((new_n225_ | ~x35) & ~new_n227_ & ~x32)) & (~x35 | (~new_n229_ & ~x32));
  assign new_n225_ = (~x37 | (~new_n226_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n226_ = ~x00 & (x38 ? ~x05 : new_n162_);
  assign new_n227_ = new_n228_ & ~x00;
  assign new_n228_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n229_ = ~x00 & ~x05 & x37 & x38 & x39 & ~x40;
  assign new_n230_ = (~x34 | new_n231_ | x36) & (~new_n233_ | ~x32 | ~x36 | x37);
  assign new_n231_ = new_n232_ & (x00 | x05 | x37 | new_n83_ | x38);
  assign new_n232_ = ~x32 & (~new_n83_ | ~x38 | x06 | ~x37);
  assign new_n233_ = new_n162_ & ~x38;
  assign z23 = x33 & (x07 | (~x32 & (new_n262_ | ~new_n235_ | new_n257_)));
  assign new_n235_ = (x35 | (~new_n236_ & new_n251_)) & (x34 | (~new_n256_ & (new_n255_ | ~x35)));
  assign new_n236_ = ~x36 & (new_n250_ | ~new_n247_ | (~x05 & (new_n237_ | new_n244_)));
  assign new_n237_ = x38 & (~new_n241_ | (~x34 & (~new_n243_ | (new_n238_ & ~x07))));
  assign new_n238_ = ~x31 & (new_n109_ | (~x09 & (new_n239_ | (~new_n240_ & ~x40))));
  assign new_n239_ = x37 & x39;
  assign new_n240_ = ~x39 & (~x15 | x16 | x37 | (~x11 & ~x12));
  assign new_n241_ = ~new_n242_ & (~new_n127_ | ~new_n187_ | x07 | x28 | x29);
  assign new_n242_ = x15 & ~x37 & x39 & ~x40 & (~x11 | ~x12);
  assign new_n243_ = ~x31 & (x39 | ~x40 | (~x29 & ~x30));
  assign new_n244_ = ~x34 & ((~x07 & new_n245_ & ~x09) | (x31 & ~x37));
  assign new_n245_ = x15 & ~x16 & new_n246_ & ~x31;
  assign new_n246_ = (x11 | x12) & ((~x37 & x39) | (~x38 & x40));
  assign new_n247_ = (~x40 | ((new_n249_ | ~x34) & (x37 | ~x38))) & (~x34 | ((~x38 | x40) & (~x37 | new_n248_ | x38)));
  assign new_n248_ = ~x39 & (x07 | new_n135_ | x39);
  assign new_n249_ = (~x37 | x38 | x39) & (x07 | (x37 ? (~x38 | x39) : (x38 | ~x39)));
  assign new_n250_ = (new_n89_ | ~x15) & ((~x37 & x38) | (~x34 & ~x38 & x39));
  assign new_n251_ = (new_n252_ | x34) & (new_n254_ | ~x36);
  assign new_n252_ = ~new_n253_ & (~new_n239_ | x05 | ~x31);
  assign new_n253_ = ~x38 & x40 & (new_n89_ | ~x15);
  assign new_n254_ = (x34 | ((~x37 | (~x39 & (x38 | ~x40))) & (x37 | x39) & (~x38 | x40))) & (x38 | x39 | x40 | x07 | ~x34 | x37);
  assign new_n255_ = (~x37 | ((x07 | x40 | (x36 ? (x38 | ~x39) : (~x38 | x39))) & (x36 | x38 | ~x39))) & (x37 | ((~x36 | (x38 & (~x38 | x39 | ~x40))) & (x38 | x39) & (~x38 | ~x39 | x40))) & (x36 | ~x38 | ~x40);
  assign new_n256_ = ~x38 & ((x37 & ((~x36 & ~x39) | (~x05 & x39 & ~x40))) | (x36 & ~x37 & x40));
  assign new_n257_ = x00 & ((~new_n258_ & ~x01) | (~new_n261_ & ~x34));
  assign new_n258_ = (new_n260_ | x04) & (~x02 | x03 | ~x04 | new_n259_ | x07);
  assign new_n259_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n83_ | x38);
  assign new_n260_ = (x36 | x37 | ~x34 | x35) & (~x37 | ~x38 | x34 | ~x36);
  assign new_n261_ = x35 ? (x40 | ((x38 | x39) & (x36 | ~x37 | ~x39))) : (~x36 | ~x40);
  assign new_n262_ = x05 & (new_n263_ | (~x34 & ~x35 & (~x36 | x40)));
  assign new_n263_ = ~x00 & ((~x35 & ~x36 & ~x37) | (~x34 & x37 & x38));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n268_ : ~new_n265_);
  assign new_n265_ = ~new_n195_ & ~new_n210_ & (x34 | (~new_n267_ & (new_n266_ | x05)));
  assign new_n266_ = ~new_n206_ & (~new_n97_ | ~x15);
  assign new_n267_ = new_n162_ & x38 & x35 & x37;
  assign new_n268_ = (new_n212_ | x34) & (~new_n233_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & ~new_n270_ & x33;
  assign new_n270_ = x36 ? new_n274_ : (~new_n271_ & (x05 | new_n266_ | x34));
  assign new_n271_ = ~x38 & (new_n92_ | (~x35 & (new_n196_ | (~new_n272_ & x34))));
  assign new_n272_ = (x05 | ~x15 | ~new_n85_ | ~x37) & (~new_n273_ | ~x00);
  assign new_n273_ = ~x01 & x02 & ~x03 & x04 & ~new_n83_ & ~x37;
  assign new_n274_ = (~new_n233_ | ~x34 | x35 | x37) & (x34 | (~new_n275_ & (~x35 | new_n277_ | ~x37)));
  assign new_n275_ = new_n276_ & x10 & x27 & ~x35;
  assign new_n276_ = new_n162_ & ~x37 & x38;
  assign new_n277_ = (x38 | ~x39 | x40) & (~new_n278_ | x03 | ~x04 | ~x38);
  assign new_n278_ = x00 & ~x01 & x02;
  assign z26 = ~x07 & ~x32 & ~new_n280_ & x33;
  assign new_n280_ = (new_n281_ | x35) & (~x00 | x34 | ~x35 | ~new_n136_ | ~x36);
  assign new_n281_ = (new_n282_ | new_n135_) & (~new_n233_ | ~x34 | ~x36 | x37);
  assign new_n282_ = (new_n283_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n283_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign z27 = ~x07 & ~x32 & x33 & (new_n295_ | (new_n285_ & ~x05));
  assign new_n285_ = ~x36 & (new_n294_ | (x15 & ~new_n286_ & ~new_n89_));
  assign new_n286_ = x34 ? (~new_n293_ | x35) : ((x31 | new_n290_ | x35) & (new_n287_ | ~x35));
  assign new_n287_ = (x38 | new_n288_ | x39) & (x37 | ~x38 | new_n289_ | ~x39);
  assign new_n288_ = (~x40 | (x24 & (new_n94_ | ~x37))) & (x37 | (x24 & (new_n95_ | x40)));
  assign new_n289_ = (x21 | (~new_n157_ & (~x22 | ~x24 | x40))) & x22 & x24 & (~x21 | ~x22 | x23 | x40);
  assign new_n290_ = ~new_n292_ & (new_n291_ | x16);
  assign new_n291_ = (x17 | ((x37 | ~x38 | ~x39 | ~x40) & (~x37 | x38 | x39))) & (x09 | ((x37 | (~x39 & (~x38 | x40))) & (x38 | (~x40 & (~x37 | x39)))));
  assign new_n292_ = ~x09 & ~x17 & ((x38 & x39) | (x37 & ~x38 & ~x39));
  assign new_n293_ = x37 & ~x38 & x39 & x40 & (~x22 | (~x21 & x22));
  assign new_n294_ = ~x09 & ~x31 & ~x34 & ~x35 & new_n108_ & x38;
  assign new_n295_ = new_n296_ & ~x34 & x35 & x36;
  assign new_n296_ = x37 & ~x38 & x39 & ~x40;
  assign z28 = ~x07 & ~x32 & x33 & (new_n298_ | new_n299_);
  assign new_n298_ = x00 & ~x01 & x02 & ~x03 & ~new_n259_ & x04;
  assign new_n299_ = new_n300_ & x36 & ~x37 & new_n162_ & x38;
  assign new_n300_ = x10 & x27 & ~x34 & ~x35;
  assign z29 = ~x07 & ~x32 & x33 & (new_n295_ | (new_n302_ & ~x05));
  assign new_n302_ = ~x36 & (new_n303_ | (x15 & ~x21 & new_n307_ & x22));
  assign new_n303_ = ~x34 & (new_n304_ | (~x31 & ~x35 & new_n207_ & x38));
  assign new_n304_ = ~x40 & (new_n306_ | (x15 & ~x21 & new_n305_ & x22));
  assign new_n305_ = x24 & x35 & ~x37 & ~new_n89_ & (~x38 ^ x39);
  assign new_n306_ = ~x31 & ~x35 & x37 & ~x38 & ~new_n198_ & x39;
  assign new_n307_ = x34 & ~x35 & x37 & new_n308_ & ~x38;
  assign new_n308_ = x39 & ~new_n89_ & x40;
  assign z31 = ~x07 & ~x32 & x33 & (new_n318_ | (~new_n310_ & ~x34));
  assign new_n310_ = (new_n311_ | ~x35) & (~new_n276_ | ~x10 | ~x27 | x35 | ~x36);
  assign new_n311_ = ~new_n316_ & (x05 | ~x15 | ~new_n312_ | x36);
  assign new_n312_ = ~new_n89_ & ((new_n313_ & ~x38) | (~x37 & new_n315_ & x38));
  assign new_n313_ = ~x39 & ((~x24 & ~x37) | (x40 & (~x24 | (new_n314_ & ~x21))));
  assign new_n314_ = x22 & ~x23 & x37 & ((x18 & x19) | (x09 & (x18 | x19)));
  assign new_n315_ = x39 & (~x24 | (x21 & x22 & ~x23 & ~x40));
  assign new_n316_ = new_n317_ & x00 & ~x01 & x02 & ~x03;
  assign new_n317_ = x04 & x36 & x37 & x38;
  assign new_n318_ = x00 & ~x01 & x02 & ~x03 & new_n319_ & x04;
  assign new_n319_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n83_ & ~x38;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
