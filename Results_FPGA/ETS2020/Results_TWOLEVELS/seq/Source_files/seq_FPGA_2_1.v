// Benchmark "FAU" written by ABC on Sat Aug  1 17:29:17 2020
...
module FAU ( 
  ...
  assign z13 = x33 & (x07 | (~x07 & ~x32 & new_n337_ & ~x34));
  assign new_n337_ = x35 & ~x37 & ((~x38 & (x36 ? ~x39 : (x39 & x40))) | (~x39 & ~x40 & ~x36 & x38));
  assign z15 = x07 & x33;
  assign z16 = ~x07 & ~x32 & x33 & (new_n347_ | (~new_n340_ & ~x34));
  assign new_n340_ = (new_n341_ | ~x36) & (~new_n121_ | ~x38 | ~x35 | x36 | ~x37);
  assign new_n341_ = (new_n342_ | x35) & (~new_n346_ | ~x35 | ~x37 | ~new_n167_ | x38);
  assign new_n342_ = ~new_n345_ & (~x38 | (~new_n343_ & (~x00 | ~new_n344_ | x01)));
  assign new_n343_ = new_n167_ & x37;
  assign new_n344_ = ~x02 & ~x03 & ~x04 & x40 & (~x37 ^ ~x39);
  assign new_n345_ = ~x37 & ~x38 & (~x39 | (~x11 & ~x12 & x40));
  assign new_n346_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n347_ = x34 & ~x35 & ~x36 & new_n119_ & x37 & x38;
  assign z17 = x33 & (x07 | (~x07 & ~new_n349_ & ~x32));
  assign new_n349_ = (x34 | new_n368_ | ~x36) & (x36 | (~new_n350_ & new_n358_));
  assign new_n350_ = ~x38 & (new_n351_ | (~x05 & new_n357_ & x15));
  assign new_n351_ = ~x35 & (new_n356_ | (x34 & (new_n352_ | new_n354_)));
  assign new_n352_ = x02 & ((x37 & ~x39) | (x00 & new_n353_ & ~x01));
  assign new_n353_ = ~x03 & x04 & ~new_n112_ & ~x37;
  assign new_n354_ = x37 & (new_n355_ | (~x39 & (x01 | x03 | x04)));
  assign new_n355_ = ~x05 & x15 & x39 & x40 & ~new_n95_ & ~new_n213_;
  assign new_n356_ = ~x05 & ~x31 & ~new_n89_ & ~x34;
  assign new_n357_ = ~x34 & x35 & ~x39 & ~new_n218_ & ~new_n95_;
  assign new_n358_ = ~new_n367_ & (x05 | x34 | (~new_n366_ & (~new_n359_ | ~x15)));
  assign new_n359_ = ~new_n95_ & (new_n365_ | (x38 & (new_n364_ | (~new_n360_ & ~x37))));
  assign new_n360_ = ~new_n362_ & (~x39 | (~new_n361_ & (~x35 | (~new_n277_ & x24))));
  assign new_n361_ = new_n104_ & ~x31 & ~x35 & x40;
  assign new_n362_ = ~x09 & (new_n363_ | (x35 & x39 & ~x18 & ~x21));
  assign new_n363_ = ~x16 & ~x31 & ~x35 & ~x40;
  assign new_n364_ = ~x09 & ~x17 & ~x31 & ~x35 & x39;
  assign new_n365_ = ~x35 & ~x37 & x39 & ~x09 & ~x16 & ~x31;
  assign new_n366_ = ~x31 & new_n115_ & ~x35;
  assign new_n367_ = x34 & ~x35 & ~x37 & x38 & ~new_n128_ & x39;
  assign new_n368_ = (new_n371_ | x40) & (~x00 | (~new_n133_ & (new_n369_ | ~x38)));
  assign new_n369_ = ~new_n370_ & (x35 | ~x40 | new_n128_ | (x37 ^ ~x39));
  assign new_n370_ = x04 & x35 & x37 & ~x01 & x02 & ~x03;
  assign new_n371_ = (x38 | ~x39 | ~x35 | ~x37) & (~x10 | ~x27 | x35 | x37 | ~x38 | x39);
  assign z18 = ~x07 & x33 & ((~new_n373_ & ~x34) | (~x32 & new_n408_ & x34));
  assign new_n373_ = ~new_n400_ & (x32 | (~new_n374_ & new_n386_));
  assign new_n374_ = x40 & (x38 ? (x35 ? ~new_n379_ : ~new_n375_) : ~new_n382_);
  assign new_n375_ = x36 ? ((~new_n378_ | ~x00) & (~x37 | ~x39) & (x37 | x39)) : new_n376_;
  assign new_n376_ = (~new_n377_ | ~x11) & (x05 | x31 | new_n180_ | x39);
  assign new_n377_ = x12 & x14 & x15 & ~x37 & ~new_n145_ & x39;
  assign new_n378_ = ~x01 & ~x02 & ~x03 & ~x04 & (~x37 ^ ~x39);
  assign new_n379_ = x37 ? (x36 & (~x00 | x01 | x04 | ~x36)) : new_n380_;
  assign new_n380_ = x39 & (x05 | ~x15 | ~new_n381_ | ~x21);
  assign new_n381_ = x22 & x24 & ~x36 & ~new_n95_ & x39;
  assign new_n382_ = x35 ? (new_n383_ | x36) : (new_n385_ | ~x36);
  assign new_n383_ = (~x37 | ~x39) & (x05 | x39 | (~new_n384_ & (x13 | new_n88_ | x37)));
  assign new_n384_ = x15 & x24 & ~new_n95_ & (~x37 | (x21 & x22 & x37));
  assign new_n385_ = ~x37 & (x11 | x37 | (x12 & (~x12 | ~x39)));
  assign new_n386_ = new_n390_ & (x40 | (x37 ? (new_n395_ & new_n399_) : new_n387_));
  assign new_n387_ = (~x36 | ~x38 | ~x39) & (x39 | (~new_n388_ & (x35 | ~x36 | new_n138_ | ~x38)));
  assign new_n388_ = ~x05 & x15 & x21 & new_n389_ & x22;
  assign new_n389_ = x24 & x35 & ~x36 & ~new_n95_ & ~x38;
  assign new_n390_ = (new_n391_ | x37) & (~new_n394_ | ~x38 | ~x39 | x36 | ~x37);
  assign new_n391_ = (~x35 | ((~x36 | x38 | x39) & (~x39 | (~new_n392_ & (~x36 | x38))))) & (x35 | ~x36 | x38 | x39);
  assign new_n392_ = ~x05 & x15 & x21 & new_n393_ & x22;
  assign new_n393_ = x23 & x24 & ~x36 & x38 & (x11 | x12);
  assign new_n394_ = ~x05 & x09 & ~x31 & ~x35;
  assign new_n395_ = x35 ? new_n396_ : (x38 | new_n398_ | ~x39);
  assign new_n396_ = (x36 | ~x38 | x39) & (~x00 | ((x36 | ~x38 | ~x39) & (~new_n397_ | x38 | x39 | ~x04 | ~x36)));
  assign new_n397_ = x01 & ~x02 & ~x03;
  assign new_n398_ = ~x36 & (x05 | x31 | new_n180_ | x36);
  assign new_n399_ = x35 ? ((x36 | x38) & (~x00 | x01 | x04 | ~x36 | ~x38)) : (~x36 | ~x38);
  assign new_n400_ = ~x35 & ~x36 & ((~new_n401_ & x15) | new_n407_ | x32);
  assign new_n401_ = (new_n402_ | (~x09 & ~x16)) & (~x09 | ~x11 | new_n405_ | ~x12);
  assign new_n402_ = (~new_n403_ | x05) & (~new_n148_ | ~new_n404_ | ~x17 | ~x37);
  assign new_n403_ = ~x31 & ~new_n95_ & (x38 ? (~x39 & ~x40) : (~x37 | (x39 & x40)));
  assign new_n404_ = ~x38 & ~x39;
  assign new_n405_ = ~new_n406_ & (~new_n127_ | ~x14 | ~x16);
  assign new_n406_ = ~x05 & ~x31 & ~x37 & ~x40;
  assign new_n407_ = ~x05 & ~x31 & ~x39 & ~x40 & (~x37 ^ x38);
  assign new_n408_ = ~x35 & ((~new_n409_ & ~x36) | (x36 & ~x37 & new_n167_ & ~x38));
  assign new_n409_ = x38 ? ((new_n188_ | x37) & (x39 | ~x40) & (~x37 | x40)) : new_n410_;
  assign new_n410_ = (new_n411_ | ~x39) & (x01 | x04 | new_n413_ | x39);
  assign new_n411_ = x37 ? (~new_n412_ & x40) : (~x40 & (~x00 | x01 | x04 | x40));
  assign new_n412_ = ~x05 & x15 & x21 & x22 & ~new_n95_ & x40;
  assign new_n413_ = (~x00 | x37) & (x02 | x03 | ~x37 | ~x40);
  assign z19 = ~x07 & ~x32 & x33 & (x38 ? ~new_n419_ : ~new_n415_);
  assign new_n415_ = (x34 | ~new_n418_ | ~x35) & (x35 | (~new_n416_ & (~new_n343_ | x34 | ~x36)));
  assign new_n416_ = ~x01 & ~x02 & ~x03 & x34 & ~new_n417_ & ~x36;
  assign new_n417_ = (x04 | ~x37 | x39 | x40) & (~x00 | ~x04 | x37 | (x39 & x40));
  assign new_n418_ = x40 & (x36 ? (x37 & (x39 | (x06 & ~x39))) : (~x37 & x39));
  assign new_n419_ = (~new_n422_ | ~x06) & (x34 | new_n420_ | ~x35);
  assign new_n420_ = (~new_n421_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n167_ | x36 | x37);
  assign new_n421_ = x00 & ~x01 & ~x02;
  assign new_n422_ = x39 & x40 & ((x34 & ~x35 & ~x36 & x37) | (~x34 & x35 & x36 & ~x37));
  assign z20 = ~x07 & ~x32 & x33 & (new_n443_ | (~new_n424_ & ~x36));
  assign new_n424_ = (new_n425_ | x35) & (x34 | (~new_n442_ & (new_n439_ | ~x35)));
  assign new_n425_ = (new_n426_ | x38) & (x34 | (~new_n438_ & ~new_n431_ & ~new_n436_));
  assign new_n426_ = ~new_n427_ & ~new_n430_ & (x05 | x31 | new_n429_ | x34);
  assign new_n427_ = ~x37 & ((new_n428_ & ~x05) | (~x00 & ~new_n112_ & x05));
  assign new_n428_ = ~x34 & (x31 | (~x31 & ~new_n88_ & x39));
  assign new_n429_ = (~x40 | (~new_n95_ & x15)) & (~x37 | x39 | ((~new_n244_ | ~x15) & ~new_n95_ & x15));
  assign new_n430_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n88_ & x40));
  assign new_n431_ = ~x05 & (x31 ? (~new_n434_ | new_n149_) : (~new_n432_ & ~x37));
  assign new_n432_ = (~x39 | (~new_n299_ & (~x40 | (~new_n433_ & new_n88_)))) & (~x38 | x39 | new_n88_ | x40);
  assign new_n433_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n434_ = ~new_n104_ & new_n300_ & ~new_n119_ & ~new_n435_ & x14 & x15;
  assign new_n435_ = x38 & ~x39;
  assign new_n436_ = x05 & (~new_n437_ | new_n149_);
  assign new_n437_ = ~new_n104_ & new_n300_ & x14 & ~new_n435_ & x15;
  assign new_n438_ = x37 & (x05 ? x38 : (x31 & x39));
  assign new_n439_ = (x05 | new_n88_ | new_n441_) & (new_n440_ | (~x05 & (x05 | new_n88_ | ~x13)));
  assign new_n440_ = ~new_n126_ & (~new_n121_ | x38);
  assign new_n441_ = (x13 | ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))))) & (~x13 | x37 | x38 | x39);
  assign new_n442_ = x05 & ((~x37 & (x38 ? (x39 & ~x40) : ~x39)) | (x39 & ~x40 & ~x00 & x38));
  assign new_n443_ = ~x34 & x36 & (new_n446_ | (x40 & (new_n444_ | new_n445_)));
  ...
  assign new_n449_ = ~x36 & ((~new_n450_ & ~x35) | (x05 & ~new_n455_ & ~x32));
  assign new_n450_ = (~x05 | x32 | (new_n454_ & ~new_n149_)) & ~x32 & (x05 | new_n451_ | x31);
  assign new_n451_ = (new_n452_ | ~x15) & (x39 | x40 | (x37 ^ x38));
  assign new_n452_ = (~x09 | ~x11 | ~x12 | x37 | x40) & (~new_n453_ | (~x11 & ~x12));
  assign new_n453_ = (x09 | x16) & (x38 ? (~x39 & ~x40) : (~x37 | (x39 & x40)));
  assign new_n454_ = (~x38 | (~x37 & x39)) & new_n148_ & x15 & ~new_n104_ & (x38 | ~x39);
  assign new_n455_ = (x37 | (x38 ? (~x39 | x40) : x39)) & (~x39 | x40 | x00 | ~x38) & (~x35 | ((x38 | x39 | ~x40) & (x37 | ~x38 | ~x39)));
  ...
  assign new_n459_ = (x38 | (~new_n351_ & ~new_n465_)) & ~new_n367_ & (new_n460_ | x34);
  assign new_n460_ = (new_n461_ | x05) & (~new_n114_ | ~x35 | ~x37);
  assign new_n461_ = ~new_n366_ & (~x15 | new_n95_ | (~new_n462_ & ~new_n365_));
  assign new_n462_ = x38 & (new_n364_ | (~x37 & (new_n362_ | (~new_n463_ & x39))));
  ...
  assign new_n466_ = ~new_n95_ & ((~new_n273_ & x40) | (~x37 & (~x24 | (x24 & ~new_n213_ & ~x40))));
  assign new_n467_ = (new_n368_ | x34) & (~x34 | x35 | x37 | ~new_n167_ | x38);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n472_ : ~new_n469_);
  assign new_n469_ = (x05 | new_n461_ | x34) & (x38 | (~new_n465_ & ~new_n470_));
  assign new_n470_ = ~x35 & (new_n356_ | (x34 & (new_n211_ | (new_n471_ & x00))));
  assign new_n471_ = ~x01 & new_n353_ & x02;
  ...
  assign z28 = ~x07 & ~x32 & x33 & (new_n477_ | new_n479_);
  assign new_n477_ = x00 & ~x01 & x02 & ~x03 & ~new_n478_ & x04;
  assign new_n478_ = (~x34 | x35 | x36 | x37 | new_n112_ | x38) & (x34 | ~x35 | ~x36 | ~x37 | ~x38);
  ...
  assign new_n513_ = ~new_n315_ & ~new_n514_ & new_n520_ & (x37 | (~new_n517_ & ~new_n518_));
  ...
  assign new_n521_ = (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n285_ | ~x40))))) & (x39 | x40 | ~x37 | x38);
  assign new_n522_ = x38 ? ((x39 | (~x40 & (x37 | x40))) & (~x39 | ~x40 | ~x06 | ~x37)) : new_n523_;
  assign new_n523_ = ~new_n524_ & (x01 | x02 | new_n417_ | x03);
  assign new_n524_ = x39 & x40 & (~x37 | (~x05 & ~new_n307_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~new_n526_ & ~x32));
  assign new_n526_ = ~new_n549_ & (x34 | (~new_n534_ & ~new_n546_ & (new_n527_ | ~x37)));
  assign new_n527_ = (x35 | new_n528_ | x36) & (~x36 | (x38 ? new_n530_ : ~new_n532_));
  assign new_n528_ = x05 ? ~x38 : (x31 | ~new_n529_ | x38);
  assign new_n529_ = ~x39 & ((new_n244_ & x15) | new_n95_ | ~x15);
  assign new_n530_ = x00 ? (~new_n531_ | x01) : (~x05 | (~new_n121_ & ~x35));
  assign new_n531_ = ~x02 & ~x03 & ((x04 & x35) | (new_n121_ & ~x04 & ~x35));
  assign new_n532_ = ~x39 & (x35 ? (new_n533_ | (x06 & x40)) : ~x40);
  assign new_n533_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n534_ = x39 & (~new_n541_ | (x38 & (new_n545_ | (~new_n535_ & ~x37))));
  assign new_n535_ = (x35 | (x36 ? (~new_n540_ & x40) : new_n536_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n536_ = ~new_n539_ & (~x15 | (~new_n538_ & (x05 | new_n537_ | x31)));
  assign new_n537_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n300_));
  assign new_n538_ = x11 & x12 & x14 & ~new_n145_ & x40;
  assign new_n539_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n540_ = new_n421_ & ~x03 & ~x04 & x40;
  assign new_n541_ = (x35 | ((new_n542_ | x36) & (~new_n544_ | ~x11 | ~x36))) & (~new_n544_ | ~x35 | x36);
  assign new_n542_ = x05 ? x38 : (x31 | new_n543_ | x37);
  assign new_n543_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n95_ & x15));
  assign new_n544_ = ~x37 & ~x38 & x40;
  assign new_n545_ = x05 & ((~x00 & ((~x36 & ~x40) | (~x37 & x40 & ~x35 & x36))) | (~x36 & ~x37 & (x35 | ~x40)));
  assign new_n546_ = ~x36 & (new_n548_ | (~x35 & (new_n436_ | (new_n547_ & ~x05))));
  assign new_n547_ = ~x31 & ~new_n88_ & ((~x38 & x40) | (~x39 & ~x40 & ~x37 & x38));
  assign new_n548_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n549_ = ~x35 & ~x36 & (new_n552_ | (~new_n550_ & ~x38));
  assign new_n550_ = (~new_n112_ | ~x05 | ~x37) & (x37 | new_n112_ | (~new_n551_ & (x00 | ~x05)));
  assign new_n551_ = new_n421_ & ~x03 & x04 & x34;
  assign new_n552_ = x34 & x37 & x38 & ((~x39 & ~x40) | (x06 & x39 & x40));
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
  assign z14 = 1'b0;
