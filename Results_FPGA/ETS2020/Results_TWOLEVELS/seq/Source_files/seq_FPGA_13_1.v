// Benchmark "FAU" written by ABC on Sat Aug  1 17:29:49 2020
...
module FAU ( 
  ...
  assign new_n343_ = (new_n344_ | ~x36) & (~new_n121_ | ~x38 | ~x35 | x36 | ~x37);
  assign new_n344_ = (new_n345_ | x35) & (~new_n349_ | ~x35 | ~x37 | ~new_n167_ | x38);
  assign new_n345_ = ~new_n348_ & (~x38 | (~new_n346_ & (~x00 | ~new_n347_ | x01)));
  assign new_n346_ = new_n167_ & x37;
  assign new_n347_ = ~x02 & ~x03 & ~x04 & x40 & (~x37 ^ ~x39);
  assign new_n348_ = ~x37 & ~x38 & (~x39 | (~x11 & ~x12 & x40));
  assign new_n349_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n350_ = x34 & ~x35 & ~x36 & new_n119_ & x37 & x38;
  assign z17 = x33 & (x07 | (~x07 & ~new_n352_ & ~x32));
  assign new_n352_ = (x34 | new_n371_ | ~x36) & (x36 | (~new_n353_ & new_n361_));
  assign new_n353_ = ~x38 & (new_n354_ | (~x05 & new_n360_ & x15));
  assign new_n354_ = ~x35 & (new_n359_ | (x34 & (new_n355_ | new_n357_)));
  assign new_n355_ = x02 & ((x37 & ~x39) | (x00 & new_n356_ & ~x01));
  assign new_n356_ = ~x03 & x04 & ~new_n112_ & ~x37;
  assign new_n357_ = x37 & (new_n358_ | (~x39 & (x01 | x03 | x04)));
  assign new_n358_ = ~x05 & x15 & x39 & x40 & ~new_n95_ & ~new_n213_;
  assign new_n359_ = ~x05 & ~x31 & ~new_n89_ & ~x34;
  assign new_n360_ = ~x34 & x35 & ~x39 & ~new_n218_ & ~new_n95_;
  assign new_n361_ = ~new_n370_ & (x05 | x34 | (~new_n369_ & (~new_n362_ | ~x15)));
  assign new_n362_ = ~new_n95_ & (new_n368_ | (x38 & (new_n367_ | (~new_n363_ & ~x37))));
  assign new_n363_ = ~new_n365_ & (~x39 | (~new_n364_ & (~x35 | (~new_n277_ & x24))));
  assign new_n364_ = new_n104_ & ~x31 & ~x35 & x40;
  assign new_n365_ = ~x09 & (new_n366_ | (x35 & x39 & ~x18 & ~x21));
  assign new_n366_ = ~x16 & ~x31 & ~x35 & ~x40;
  assign new_n367_ = ~x09 & ~x17 & ~x31 & ~x35 & x39;
  assign new_n368_ = ~x35 & ~x37 & x39 & ~x09 & ~x16 & ~x31;
  assign new_n369_ = ~x31 & new_n115_ & ~x35;
  assign new_n370_ = x34 & ~x35 & ~x37 & x38 & ~new_n128_ & x39;
  assign new_n371_ = (new_n374_ | x40) & (~x00 | (~new_n133_ & (new_n372_ | ~x38)));
  assign new_n372_ = ~new_n373_ & (x35 | ~x40 | new_n128_ | (x37 ^ ~x39));
  assign new_n373_ = x04 & x35 & x37 & ~x01 & x02 & ~x03;
  assign new_n374_ = (x38 | ~x39 | ~x35 | ~x37) & (~x10 | ~x27 | x35 | x37 | ~x38 | x39);
  assign z18 = ~x07 & x33 & ((~new_n376_ & ~x34) | (~x32 & new_n411_ & x34));
  assign new_n376_ = ~new_n403_ & (x32 | (~new_n377_ & new_n389_));
  assign new_n377_ = x40 & (x38 ? (x35 ? ~new_n382_ : ~new_n378_) : ~new_n385_);
  assign new_n378_ = x36 ? ((~new_n381_ | ~x00) & (~x37 | ~x39) & (x37 | x39)) : new_n379_;
  assign new_n379_ = (~new_n380_ | ~x11) & (x05 | x31 | new_n180_ | x39);
  assign new_n380_ = x12 & x14 & x15 & ~x37 & ~new_n145_ & x39;
  assign new_n381_ = ~x01 & ~x02 & ~x03 & ~x04 & (~x37 ^ ~x39);
  assign new_n382_ = x37 ? (x36 & (~x00 | x01 | x04 | ~x36)) : new_n383_;
  assign new_n383_ = x39 & (x05 | ~x15 | ~new_n384_ | ~x21);
  assign new_n384_ = x22 & x24 & ~x36 & ~new_n95_ & x39;
  assign new_n385_ = x35 ? (new_n386_ | x36) : (new_n388_ | ~x36);
  assign new_n386_ = (~x37 | ~x39) & (x05 | x39 | (~new_n387_ & (x13 | new_n88_ | x37)));
  assign new_n387_ = x15 & x24 & ~new_n95_ & (~x37 | (x21 & x22 & x37));
  assign new_n388_ = ~x37 & (x11 | x37 | (x12 & (~x12 | ~x39)));
  assign new_n389_ = new_n393_ & (x40 | (x37 ? (new_n398_ & new_n402_) : new_n390_));
  assign new_n390_ = (~x36 | ~x38 | ~x39) & (x39 | (~new_n391_ & (x35 | ~x36 | new_n138_ | ~x38)));
  assign new_n391_ = ~x05 & x15 & x21 & new_n392_ & x22;
  assign new_n392_ = x24 & x35 & ~x36 & ~new_n95_ & ~x38;
  assign new_n393_ = (new_n394_ | x37) & (~new_n397_ | ~x38 | ~x39 | x36 | ~x37);
  assign new_n394_ = (~x35 | ((~x36 | x38 | x39) & (~x39 | (~new_n395_ & (~x36 | x38))))) & (x35 | ~x36 | x38 | x39);
  assign new_n395_ = ~x05 & x15 & x21 & new_n396_ & x22;
  assign new_n396_ = x23 & x24 & ~x36 & x38 & (x11 | x12);
  assign new_n397_ = ~x05 & x09 & ~x31 & ~x35;
  assign new_n398_ = x35 ? new_n399_ : (x38 | new_n401_ | ~x39);
  assign new_n399_ = (x36 | ~x38 | x39) & (~x00 | ((x36 | ~x38 | ~x39) & (~new_n400_ | x38 | x39 | ~x04 | ~x36)));
  assign new_n400_ = x01 & ~x02 & ~x03;
  assign new_n401_ = ~x36 & (x05 | x31 | new_n180_ | x36);
  assign new_n402_ = x35 ? ((x36 | x38) & (~x00 | x01 | x04 | ~x36 | ~x38)) : (~x36 | ~x38);
  assign new_n403_ = ~x35 & ~x36 & ((~new_n404_ & x15) | new_n410_ | x32);
  assign new_n404_ = (new_n405_ | (~x09 & ~x16)) & (~x09 | ~x11 | new_n408_ | ~x12);
  assign new_n405_ = (~new_n406_ | x05) & (~new_n148_ | ~new_n407_ | ~x17 | ~x37);
  assign new_n406_ = ~x31 & ~new_n95_ & (x38 ? (~x39 & ~x40) : (~x37 | (x39 & x40)));
  assign new_n407_ = ~x38 & ~x39;
  assign new_n408_ = ~new_n409_ & (~new_n127_ | ~x14 | ~x16);
  assign new_n409_ = ~x05 & ~x31 & ~x37 & ~x40;
  assign new_n410_ = ~x05 & ~x31 & ~x39 & ~x40 & (~x37 ^ x38);
  assign new_n411_ = ~x35 & ((~new_n412_ & ~x36) | (x36 & ~x37 & new_n167_ & ~x38));
  assign new_n412_ = x38 ? ((new_n188_ | x37) & (x39 | ~x40) & (~x37 | x40)) : new_n413_;
  assign new_n413_ = (new_n414_ | ~x39) & (x01 | x04 | new_n416_ | x39);
  assign new_n414_ = x37 ? (~new_n415_ & x40) : (~x40 & (~x00 | x01 | x04 | x40));
  assign new_n415_ = ~x05 & x15 & x21 & x22 & ~new_n95_ & x40;
  assign new_n416_ = (~x00 | x37) & (x02 | x03 | ~x37 | ~x40);
  assign z19 = ~x07 & ~x32 & x33 & (x38 ? ~new_n422_ : ~new_n418_);
  assign new_n418_ = (x34 | ~new_n421_ | ~x35) & (x35 | (~new_n419_ & (~new_n346_ | x34 | ~x36)));
  assign new_n419_ = ~x01 & ~x02 & ~x03 & x34 & ~new_n420_ & ~x36;
  assign new_n420_ = (x04 | ~x37 | x39 | x40) & (~x00 | ~x04 | x37 | (x39 & x40));
  assign new_n421_ = x40 & (x36 ? (x37 & (x39 | (x06 & ~x39))) : (~x37 & x39));
  assign new_n422_ = (~new_n425_ | ~x06) & (x34 | new_n423_ | ~x35);
  assign new_n423_ = (~new_n424_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n167_ | x36 | x37);
  assign new_n424_ = x00 & ~x01 & ~x02;
  assign new_n425_ = x39 & x40 & ((x34 & ~x35 & ~x36 & x37) | (~x34 & x35 & x36 & ~x37));
  assign z20 = ~x07 & ~x32 & x33 & (new_n446_ | (~new_n427_ & ~x36));
  assign new_n427_ = (new_n428_ | x35) & (x34 | (~new_n445_ & (new_n442_ | ~x35)));
  assign new_n428_ = (new_n429_ | x38) & (x34 | (~new_n441_ & ~new_n434_ & ~new_n439_));
  assign new_n429_ = ~new_n430_ & ~new_n433_ & (x05 | x31 | new_n432_ | x34);
  assign new_n430_ = ~x37 & ((new_n431_ & ~x05) | (~x00 & ~new_n112_ & x05));
  assign new_n431_ = ~x34 & (x31 | (~x31 & ~new_n88_ & x39));
  assign new_n432_ = (~x40 | (~new_n95_ & x15)) & (~x37 | x39 | ((~new_n244_ | ~x15) & ~new_n95_ & x15));
  assign new_n433_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n88_ & x40));
  assign new_n434_ = ~x05 & (x31 ? (~new_n437_ | new_n149_) : (~new_n435_ & ~x37));
  assign new_n435_ = (~x39 | (~new_n299_ & (~x40 | (~new_n436_ & new_n88_)))) & (~x38 | x39 | new_n88_ | x40);
  assign new_n436_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n437_ = ~new_n104_ & new_n300_ & ~new_n119_ & ~new_n438_ & x14 & x15;
  assign new_n438_ = x38 & ~x39;
  assign new_n439_ = x05 & (~new_n440_ | new_n149_);
  assign new_n440_ = ~new_n104_ & new_n300_ & x14 & ~new_n438_ & x15;
  assign new_n441_ = x37 & (x05 ? x38 : (x31 & x39));
  assign new_n442_ = (x05 | new_n88_ | new_n444_) & (new_n443_ | (~x05 & (x05 | new_n88_ | ~x13)));
  assign new_n443_ = ~new_n126_ & (~new_n121_ | x38);
  assign new_n444_ = (x13 | ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))))) & (~x13 | x37 | x38 | x39);
  assign new_n445_ = x05 & ((~x37 & (x38 ? (x39 & ~x40) : ~x39)) | (x39 & ~x40 & ~x00 & x38));
  assign new_n446_ = ~x34 & x36 & (new_n449_ | (x40 & (new_n447_ | new_n448_)));
  assign new_n447_ = ~x00 & x05 & x38 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n448_ = x11 & ~x35 & ~x37 & ~x38 & x39;
  assign new_n449_ = x35 & x37 & x38 & ~x00 & x05;
  assign z22 = ~x07 & x33 & (new_n451_ | (x05 & new_n460_ & ~x32));
  assign new_n451_ = ~x34 & (new_n452_ | (~x00 & x05 & new_n459_ & ~x32));
  assign new_n452_ = ~x36 & ((~new_n453_ & ~x35) | (x05 & ~new_n458_ & ~x32));
  assign new_n453_ = (~x05 | x32 | (new_n457_ & ~new_n149_)) & ~x32 & (x05 | new_n454_ | x31);
  ...
  assign new_n457_ = (~x38 | (~x37 & x39)) & new_n148_ & x15 & ~new_n104_ & (x38 | ~x39);
  assign new_n458_ = (x37 | (x38 ? (~x39 | x40) : x39)) & (~x39 | x40 | x00 | ~x38) & (~x35 | ((x38 | x39 | ~x40) & (x37 | ~x38 | ~x39)));
  assign new_n459_ = x36 & x38 & ((x37 & (x35 | (~x39 & x40))) | (x39 & x40 & ~x35 & ~x37));
  assign new_n460_ = ~x35 & ~x36 & ~x38 & ((new_n112_ & x37) | (~x00 & ~new_n112_ & ~x37));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n470_ : ~new_n462_);
  assign new_n462_ = (x38 | (~new_n354_ & ~new_n468_)) & ~new_n370_ & (new_n463_ | x34);
  assign new_n463_ = (new_n464_ | x05) & (~new_n114_ | ~x35 | ~x37);
  assign new_n464_ = ~new_n369_ & (~x15 | new_n95_ | (~new_n465_ & ~new_n368_));
  assign new_n465_ = x38 & (new_n367_ | (~x37 & (new_n365_ | (~new_n466_ & x39))));
  assign new_n466_ = (~new_n104_ | x31 | x35 | ~x40) & (~x35 | (x24 & (new_n467_ | ~x24)));
  assign new_n467_ = x22 & (x40 | (x21 & (~x21 | ~x22 | x23)));
  assign new_n468_ = ~x05 & x15 & ~x34 & x35 & new_n469_ & ~x39;
  assign new_n469_ = ~new_n95_ & ((~new_n273_ & x40) | (~x37 & (~x24 | (x24 & ~new_n213_ & ~x40))));
  assign new_n470_ = (new_n371_ | x34) & (~x34 | x35 | x37 | ~new_n167_ | x38);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n475_ : ~new_n472_);
  assign new_n472_ = (x05 | new_n464_ | x34) & (x38 | (~new_n468_ & ~new_n473_));
  assign new_n473_ = ~x35 & (new_n359_ | (x34 & (new_n211_ | (new_n474_ & x00))));
  assign new_n474_ = ~x01 & new_n356_ & x02;
  assign new_n475_ = (new_n476_ | x34) & (~x34 | x35 | x37 | ~new_n167_ | x38);
  assign new_n476_ = (~new_n477_ | ~x35) & (~new_n167_ | ~new_n153_ | ~x10 | ~x27 | x35);
  assign new_n477_ = x37 & ((new_n119_ & ~x38) | (new_n478_ & ~x03 & x04 & x38));
  assign new_n478_ = x00 & ~x01 & x02;
  assign z28 = ~x07 & ~x32 & x33 & (new_n480_ | new_n482_);
  assign new_n480_ = x00 & ~x01 & x02 & ~x03 & ~new_n481_ & x04;
  assign new_n481_ = (~x34 | x35 | x36 | x37 | new_n112_ | x38) & (x34 | ~x35 | ~x36 | ~x37 | ~x38);
  assign new_n482_ = new_n138_ & ~x34 & ~x35 & new_n114_ & x36 & ~x37;
  assign z30 = ~x07 & ~x32 & x33 & (new_n484_ | new_n482_);
  assign new_n484_ = ~x05 & x15 & ~x36 & ~new_n485_ & ~new_n95_;
  assign new_n485_ = (~x34 | ~new_n488_ | x35) & (~x24 | x34 | new_n486_ | ~x35);
  assign new_n486_ = (x38 | new_n487_ | x39) & (x37 | ~x38 | new_n467_ | ~x39);
  assign new_n487_ = (x22 | (x37 ^ x40)) & (x21 | ((x37 | x40) & (~x22 | x23 | ~x37 | new_n174_ | ~x40)));
  assign new_n488_ = x37 & ~x38 & x39 & ~new_n213_ & x40;
  assign z31 = ~x07 & ~x32 & x33 & (new_n498_ | (~new_n490_ & ~x34));
  assign new_n490_ = (new_n491_ | ~x35) & (~new_n167_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  assign new_n491_ = ~new_n496_ & (x05 | ~x15 | x36 | new_n492_ | new_n95_);
  assign new_n492_ = (x38 | x39 | (~new_n493_ & (x24 | x37))) & (x37 | ~x38 | ~x39 | (~new_n495_ & x24));
  assign new_n493_ = x40 & (~x24 | (~x21 & x22 & ~x23 & new_n494_ & x24));
  assign new_n494_ = ~new_n174_ & x37;
  assign new_n495_ = new_n213_ & ~x23 & x24 & ~x40;
  assign new_n496_ = new_n497_ & x00 & ~x01 & x02 & ~x03;
  assign new_n497_ = x04 & x36 & x37 & x38;
  assign new_n498_ = x00 & ~x01 & x02 & ~x03 & new_n499_ & x04;
  assign new_n499_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n112_ & ~x38;
  assign z32 = ~x40 & ~x39 & x38 & new_n501_ & x37;
  assign new_n501_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z33 = x33 ? (x07 | (~x07 & ~new_n503_ & ~x32)) : x32;
  assign new_n503_ = x34 ? (x35 | new_n525_ | x36) : (x35 ? new_n504_ : new_n515_);
  assign new_n504_ = x37 ? ((new_n513_ | ~x36) & (x05 | ~new_n505_ | x36)) : new_n508_;
  assign new_n505_ = ~x38 & ~x39 & ~new_n506_ & x40;
  assign new_n506_ = (~x15 | ~x22 | ~x24 | new_n507_ | new_n95_) & (x13 | (~new_n95_ & x15));
  assign new_n507_ = ~x21 & (x21 | new_n174_ | ~x23);
  assign new_n508_ = x36 ? ((x39 | (x38 & (~x38 | ~x40))) & (~x38 | ~x39 | (x40 & (~x06 | ~x40)))) : (~new_n509_ & (~x38 | x39 | x40) & (x38 | ~x39 | ~x40));
  assign new_n509_ = ~x05 & ((new_n512_ & ~x13) | (x15 & new_n510_ & x22));
  assign new_n510_ = x24 & ~new_n95_ & ((new_n511_ & x38) | (new_n167_ & x21 & ~x38));
  assign new_n511_ = x39 & (x21 ? (x23 | x40) : (x40 & (x09 | x18)));
  assign new_n512_ = ~new_n88_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n513_ = (~new_n514_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n514_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n167_ & x01 & ~x38));
  assign new_n515_ = (new_n524_ | ~x36) & (x05 | x31 | new_n516_ | x36);
  assign new_n516_ = ~new_n315_ & ~new_n517_ & new_n523_ & (x37 | (~new_n520_ & ~new_n521_));
  assign new_n517_ = x15 & ((~new_n518_ & x09) | (x16 & new_n152_ & x17));
  assign new_n518_ = x37 ? (x38 | x39 | new_n104_ | new_n154_) : (~x38 | new_n519_ | ~x39);
  assign new_n519_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n520_ = x38 & ~x39 & ~new_n88_ & ~x40;
  assign new_n521_ = x39 & (new_n522_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n522_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n523_ = (x38 | new_n88_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n524_ = (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n285_ | ~x40))))) & (x39 | x40 | ~x37 | x38);
  assign new_n525_ = x38 ? ((x39 | (~x40 & (x37 | x40))) & (~x39 | ~x40 | ~x06 | ~x37)) : new_n526_;
  assign new_n526_ = ~new_n527_ & (x01 | x02 | new_n420_ | x03);
  assign new_n527_ = x39 & x40 & (~x37 | (~x05 & ~new_n307_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~new_n529_ & ~x32));
  assign new_n529_ = ~new_n552_ & (x34 | (~new_n537_ & ~new_n549_ & (new_n530_ | ~x37)));
  assign new_n530_ = (x35 | new_n531_ | x36) & (~x36 | (x38 ? new_n533_ : ~new_n535_));
  assign new_n531_ = x05 ? ~x38 : (x31 | ~new_n532_ | x38);
  assign new_n532_ = ~x39 & ((new_n244_ & x15) | new_n95_ | ~x15);
  assign new_n533_ = x00 ? (~new_n534_ | x01) : (~x05 | (~new_n121_ & ~x35));
  assign new_n534_ = ~x02 & ~x03 & ((x04 & x35) | (new_n121_ & ~x04 & ~x35));
  assign new_n535_ = ~x39 & (x35 ? (new_n536_ | (x06 & x40)) : ~x40);
  assign new_n536_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n537_ = x39 & (~new_n544_ | (x38 & (new_n548_ | (~new_n538_ & ~x37))));
  assign new_n538_ = (x35 | (x36 ? (~new_n543_ & x40) : new_n539_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n539_ = ~new_n542_ & (~x15 | (~new_n541_ & (x05 | new_n540_ | x31)));
  assign new_n540_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n300_));
  assign new_n541_ = x11 & x12 & x14 & ~new_n145_ & x40;
  assign new_n542_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n543_ = new_n424_ & ~x03 & ~x04 & x40;
  assign new_n544_ = (x35 | ((new_n545_ | x36) & (~new_n547_ | ~x11 | ~x36))) & (~new_n547_ | ~x35 | x36);
  assign new_n545_ = x05 ? x38 : (x31 | new_n546_ | x37);
  assign new_n546_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n95_ & x15));
  assign new_n547_ = ~x37 & ~x38 & x40;
  assign new_n548_ = x05 & ((~x00 & ((~x36 & ~x40) | (~x37 & x40 & ~x35 & x36))) | (~x36 & ~x37 & (x35 | ~x40)));
  assign new_n549_ = ~x36 & (new_n551_ | (~x35 & (new_n439_ | (new_n550_ & ~x05))));
  assign new_n550_ = ~x31 & ~new_n88_ & ((~x38 & x40) | (~x39 & ~x40 & ~x37 & x38));
  assign new_n551_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n552_ = ~x35 & ~x36 & (new_n555_ | (~new_n553_ & ~x38));
  assign new_n553_ = (~new_n112_ | ~x05 | ~x37) & (x37 | new_n112_ | (~new_n554_ & (x00 | ~x05)));
  assign new_n554_ = new_n424_ & ~x03 & x04 & x34;
