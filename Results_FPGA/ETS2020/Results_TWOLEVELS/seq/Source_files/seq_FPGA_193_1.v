// Benchmark "FAU" written by ABC on Sat Aug  1 17:38:48 2020
...
module FAU ( 
  ...
  assign z33 = x33 ? (x07 | (~x07 & ~new_n496_ & ~x32)) : x32;
  assign new_n496_ = x34 ? (x35 | new_n518_ | x36) : (x35 ? new_n497_ : new_n508_);
  assign new_n497_ = x37 ? ((new_n506_ | ~x36) & (x05 | ~new_n498_ | x36)) : new_n501_;
  assign new_n498_ = ~x38 & ~x39 & ~new_n499_ & x40;
  assign new_n499_ = (~x15 | ~x22 | ~x24 | new_n500_ | new_n95_) & (x13 | (~new_n95_ & x15));
  assign new_n500_ = ~x21 & (x21 | new_n174_ | ~x23);
  assign new_n501_ = x36 ? ((x39 | (x38 & (~x38 | ~x40))) & (~x38 | ~x39 | (x40 & (~x06 | ~x40)))) : (~new_n502_ & (~x38 | x39 | x40) & (x38 | ~x39 | ~x40));
  assign new_n502_ = ~x05 & ((new_n505_ & ~x13) | (x15 & new_n503_ & x22));
  assign new_n503_ = x24 & ~new_n95_ & ((new_n504_ & x38) | (new_n167_ & x21 & ~x38));
  assign new_n504_ = x39 & (x21 ? (x23 | x40) : (x40 & (x09 | x18)));
  assign new_n505_ = ~new_n88_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n506_ = (~new_n507_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n507_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n167_ & x01 & ~x38));
  assign new_n508_ = (new_n517_ | ~x36) & (x05 | x31 | new_n509_ | x36);
  assign new_n509_ = ~new_n315_ & ~new_n510_ & new_n516_ & (x37 | (~new_n513_ & ~new_n514_));
  assign new_n510_ = x15 & ((~new_n511_ & x09) | (x16 & new_n152_ & x17));
  assign new_n511_ = x37 ? (x38 | x39 | new_n104_ | new_n154_) : (~x38 | new_n512_ | ~x39);
  assign new_n512_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n513_ = x38 & ~x39 & ~new_n88_ & ~x40;
  assign new_n514_ = x39 & (new_n515_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n515_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n516_ = (x38 | new_n88_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n517_ = (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n285_ | ~x40))))) & (x39 | x40 | ~x37 | x38);
  assign new_n518_ = x38 ? ((x39 | (~x40 & (x37 | x40))) & (~x39 | ~x40 | ~x06 | ~x37)) : new_n519_;
  assign new_n519_ = ~new_n520_ & (x01 | x02 | new_n415_ | x03);
  assign new_n520_ = x39 & x40 & (~x37 | (~x05 & ~new_n307_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~new_n522_ & ~x32));
  assign new_n522_ = ~new_n545_ & (x34 | (~new_n530_ & ~new_n542_ & (new_n523_ | ~x37)));
  assign new_n523_ = (x35 | new_n524_ | x36) & (~x36 | (x38 ? new_n526_ : ~new_n528_));
  assign new_n524_ = x05 ? ~x38 : (x31 | ~new_n525_ | x38);
  assign new_n525_ = ~x39 & ((new_n244_ & x15) | new_n95_ | ~x15);
  assign new_n526_ = x00 ? (~new_n527_ | x01) : (~x05 | (~new_n121_ & ~x35));
  assign new_n527_ = ~x02 & ~x03 & ((x04 & x35) | (new_n121_ & ~x04 & ~x35));
  assign new_n528_ = ~x39 & (x35 ? (new_n529_ | (x06 & x40)) : ~x40);
  assign new_n529_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n530_ = x39 & (~new_n537_ | (x38 & (new_n541_ | (~new_n531_ & ~x37))));
  assign new_n531_ = (x35 | (x36 ? (~new_n536_ & x40) : new_n532_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n532_ = ~new_n535_ & (~x15 | (~new_n534_ & (x05 | new_n533_ | x31)));
  assign new_n533_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n300_));
  assign new_n534_ = x11 & x12 & x14 & ~new_n145_ & x40;
  assign new_n535_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n536_ = new_n419_ & ~x03 & ~x04 & x40;
  assign new_n537_ = (x35 | ((new_n538_ | x36) & (~new_n540_ | ~x11 | ~x36))) & (~new_n540_ | ~x35 | x36);
  assign new_n538_ = x05 ? x38 : (x31 | new_n539_ | x37);
  assign new_n539_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n95_ & x15));
  assign new_n540_ = ~x37 & ~x38 & x40;
  assign new_n541_ = x05 & ((~x00 & ((~x36 & ~x40) | (~x37 & x40 & ~x35 & x36))) | (~x36 & ~x37 & (x35 | ~x40)));
  assign new_n542_ = ~x36 & (new_n544_ | (~x35 & (new_n434_ | (new_n543_ & ~x05))));
  assign new_n543_ = ~x31 & ~new_n88_ & ((~x38 & x40) | (~x39 & ~x40 & ~x37 & x38));
  ...
  assign new_n547_ = new_n419_ & ~x03 & x04 & x34;
