// Benchmark "FAU" written by ABC on Sat Aug  1 17:31:28 2020
...
module FAU ( 
  ...
  assign new_n357_ = ~new_n359_ & (~x39 | (~new_n358_ & (~x35 | (~new_n277_ & x24))));
  ...
  assign new_n399_ = (~new_n400_ | x05) & (~new_n148_ | ~new_n401_ | ~x17 | ~x37);
  assign new_n400_ = ~x31 & ~new_n95_ & (x38 ? (~x39 & ~x40) : (~x37 | (x39 & x40)));
  assign new_n401_ = ~x38 & ~x39;
  assign new_n402_ = ~new_n403_ & (~new_n127_ | ~x14 | ~x16);
  ...
  assign new_n426_ = (~x40 | (~new_n95_ & x15)) & (~x37 | x39 | ((~new_n244_ | ~x15) & ~new_n95_ & x15));
  assign new_n427_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n88_ & x40));
  assign new_n428_ = ~x05 & (x31 ? (~new_n431_ | new_n149_) : (~new_n429_ & ~x37));
  assign new_n429_ = (~x39 | (~new_n299_ & (~x40 | (~new_n430_ & new_n88_)))) & (~x38 | x39 | new_n88_ | x40);
  assign new_n430_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n431_ = ~new_n104_ & new_n300_ & ~new_n119_ & ~new_n432_ & x14 & x15;
  assign new_n432_ = x38 & ~x39;
  assign new_n433_ = x05 & (~new_n434_ | new_n149_);
  assign new_n434_ = ~new_n104_ & new_n300_ & x14 & ~new_n432_ & x15;
  assign new_n435_ = x37 & (x05 ? x38 : (x31 & x39));
  assign new_n436_ = (x05 | new_n88_ | new_n438_) & (new_n437_ | (~x05 & (x05 | new_n88_ | ~x13)));
  assign new_n437_ = ~new_n126_ & (~new_n121_ | x38);
  assign new_n438_ = (x13 | ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))))) & (~x13 | x37 | x38 | x39);
  ...
  assign new_n446_ = ~x36 & ((~new_n447_ & ~x35) | (x05 & ~new_n452_ & ~x32));
  assign new_n447_ = (~x05 | x32 | (new_n451_ & ~new_n149_)) & ~x32 & (x05 | new_n448_ | x31);
  ...
  assign new_n451_ = (~x38 | (~x37 & x39)) & new_n148_ & x15 & ~new_n104_ & (x38 | ~x39);
  assign new_n452_ = (x37 | (x38 ? (~x39 | x40) : x39)) & (~x39 | x40 | x00 | ~x38) & (~x35 | ((x38 | x39 | ~x40) & (x37 | ~x38 | ~x39)));
  ...
  assign new_n456_ = (x38 | (~new_n348_ & ~new_n462_)) & ~new_n364_ & (new_n457_ | x34);
  assign new_n457_ = (new_n458_ | x05) & (~new_n114_ | ~x35 | ~x37);
  assign new_n458_ = ~new_n363_ & (~x15 | new_n95_ | (~new_n459_ & ~new_n362_));
  assign new_n459_ = x38 & (new_n361_ | (~x37 & (new_n359_ | (~new_n460_ & x39))));
  ...
  assign new_n463_ = ~new_n95_ & ((~new_n273_ & x40) | (~x37 & (~x24 | (x24 & ~new_n213_ & ~x40))));
  assign new_n464_ = (new_n365_ | x34) & (~x34 | x35 | x37 | ~new_n167_ | x38);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n469_ : ~new_n466_);
  assign new_n466_ = (x05 | new_n458_ | x34) & (x38 | (~new_n462_ & ~new_n467_));
  assign new_n467_ = ~x35 & (new_n353_ | (x34 & (new_n211_ | (new_n468_ & x00))));
  assign new_n468_ = ~x01 & new_n350_ & x02;
  ...
  assign z33 = x33 ? (x07 | (~x07 & ~new_n497_ & ~x32)) : x32;
  assign new_n497_ = x34 ? (x35 | new_n519_ | x36) : (x35 ? new_n498_ : new_n509_);
  assign new_n498_ = x37 ? ((new_n507_ | ~x36) & (x05 | ~new_n499_ | x36)) : new_n502_;
  assign new_n499_ = ~x38 & ~x39 & ~new_n500_ & x40;
  assign new_n500_ = (~x15 | ~x22 | ~x24 | new_n501_ | new_n95_) & (x13 | (~new_n95_ & x15));
  assign new_n501_ = ~x21 & (x21 | new_n174_ | ~x23);
  assign new_n502_ = x36 ? ((x39 | (x38 & (~x38 | ~x40))) & (~x38 | ~x39 | (x40 & (~x06 | ~x40)))) : (~new_n503_ & (~x38 | x39 | x40) & (x38 | ~x39 | ~x40));
  assign new_n503_ = ~x05 & ((new_n506_ & ~x13) | (x15 & new_n504_ & x22));
  assign new_n504_ = x24 & ~new_n95_ & ((new_n505_ & x38) | (new_n167_ & x21 & ~x38));
  assign new_n505_ = x39 & (x21 ? (x23 | x40) : (x40 & (x09 | x18)));
  assign new_n506_ = ~new_n88_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n507_ = (~new_n508_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n508_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n167_ & x01 & ~x38));
  assign new_n509_ = (new_n518_ | ~x36) & (x05 | x31 | new_n510_ | x36);
  assign new_n510_ = ~new_n315_ & ~new_n511_ & new_n517_ & (x37 | (~new_n514_ & ~new_n515_));
  assign new_n511_ = x15 & ((~new_n512_ & x09) | (x16 & new_n152_ & x17));
  assign new_n512_ = x37 ? (x38 | x39 | new_n104_ | new_n154_) : (~x38 | new_n513_ | ~x39);
  assign new_n513_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n514_ = x38 & ~x39 & ~new_n88_ & ~x40;
  assign new_n515_ = x39 & (new_n516_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n516_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n517_ = (x38 | new_n88_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n518_ = (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n285_ | ~x40))))) & (x39 | x40 | ~x37 | x38);
  assign new_n519_ = x38 ? ((x39 | (~x40 & (x37 | x40))) & (~x39 | ~x40 | ~x06 | ~x37)) : new_n520_;
  assign new_n520_ = ~new_n521_ & (x01 | x02 | new_n414_ | x03);
  assign new_n521_ = x39 & x40 & (~x37 | (~x05 & ~new_n307_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~new_n523_ & ~x32));
  assign new_n523_ = ~new_n546_ & (x34 | (~new_n531_ & ~new_n543_ & (new_n524_ | ~x37)));
  assign new_n524_ = (x35 | new_n525_ | x36) & (~x36 | (x38 ? new_n527_ : ~new_n529_));
  assign new_n525_ = x05 ? ~x38 : (x31 | ~new_n526_ | x38);
  assign new_n526_ = ~x39 & ((new_n244_ & x15) | new_n95_ | ~x15);
  assign new_n527_ = x00 ? (~new_n528_ | x01) : (~x05 | (~new_n121_ & ~x35));
  assign new_n528_ = ~x02 & ~x03 & ((x04 & x35) | (new_n121_ & ~x04 & ~x35));
  assign new_n529_ = ~x39 & (x35 ? (new_n530_ | (x06 & x40)) : ~x40);
  assign new_n530_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n531_ = x39 & (~new_n538_ | (x38 & (new_n542_ | (~new_n532_ & ~x37))));
  assign new_n532_ = (x35 | (x36 ? (~new_n537_ & x40) : new_n533_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n533_ = ~new_n536_ & (~x15 | (~new_n535_ & (x05 | new_n534_ | x31)));
  assign new_n534_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n300_));
  assign new_n535_ = x11 & x12 & x14 & ~new_n145_ & x40;
  assign new_n536_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n537_ = new_n418_ & ~x03 & ~x04 & x40;
  assign new_n538_ = (x35 | ((new_n539_ | x36) & (~new_n541_ | ~x11 | ~x36))) & (~new_n541_ | ~x35 | x36);
  assign new_n539_ = x05 ? x38 : (x31 | new_n540_ | x37);
  assign new_n540_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n95_ & x15));
  assign new_n541_ = ~x37 & ~x38 & x40;
  assign new_n542_ = x05 & ((~x00 & ((~x36 & ~x40) | (~x37 & x40 & ~x35 & x36))) | (~x36 & ~x37 & (x35 | ~x40)));
  assign new_n543_ = ~x36 & (new_n545_ | (~x35 & (new_n433_ | (new_n544_ & ~x05))));
  assign new_n544_ = ~x31 & ~new_n88_ & ((~x38 & x40) | (~x39 & ~x40 & ~x37 & x38));
  assign new_n545_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n546_ = ~x35 & ~x36 & (new_n549_ | (~new_n547_ & ~x38));
  assign new_n547_ = (~new_n112_ | ~x05 | ~x37) & (x37 | new_n112_ | (~new_n548_ & (x00 | ~x05)));
  assign new_n548_ = new_n418_ & ~x03 & x04 & x34;
