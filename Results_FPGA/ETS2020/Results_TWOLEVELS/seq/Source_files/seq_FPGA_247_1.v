...
module FAU ( 
  ...
  assign z13 = x33 & (x07 | (~x07 & ~x32 & new_n340_ & ~x34));
  assign new_n340_ = x35 & ~x37 & ((~x38 & (x36 ? ~x39 : (x39 & x40))) | (~x39 & ~x40 & ~x36 & x38));
  assign z15 = x07 & x33;
  ...
  assign z28 = ~x07 & ~x32 & x33 & (new_n482_ | (new_n480_ & x00));
  assign new_n480_ = ~x01 & x02 & ~x03 & ~new_n481_ & x04;
  assign new_n481_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n112_ | x38);
