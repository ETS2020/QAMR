...
module FAU ( 
  ...
  assign new_n317_ = (x34 | ~new_n326_ | ~x36) & (x36 | ((new_n318_ | x05) & (~new_n328_ | ~x34)));
  ...
  assign new_n328_ = ~x35 & ((~x37 & (x38 ? ~x39 : (x39 & x40))) | (x37 & x38 & ~x39 & x40));
  ...
  assign new_n357_ = (new_n358_ | x35) & (~new_n362_ | ~new_n297_ | ~x35 | ~x37);
  ...
  assign new_n410_ = (~new_n297_ | ~x36 | x37) & (new_n411_ | x36);
  ...
  assign new_n431_ = ~x38 & ((~new_n432_ & ~x37) | new_n436_ | (new_n434_ & ~x05));
  assign new_n432_ = (~new_n433_ | x05) & (x00 | new_n87_ | ~x05);
  assign new_n433_ = ~x34 & (x31 | (~x31 & ~new_n86_ & x39));
  assign new_n434_ = ~x31 & ~x34 & (new_n158_ | (new_n435_ & x37));
  assign new_n435_ = ~x39 & ((x15 & ~new_n145_ & ~new_n154_) | new_n92_ | ~x15);
  ...
  assign new_n438_ = (~x39 | (~new_n305_ & (~x40 | (~new_n439_ & new_n86_)))) & (~x38 | x39 | new_n86_ | x40);
  assign new_n439_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  ...
  assign new_n518_ = ~x35 & ((~new_n519_ & ~x36) | (new_n297_ & x34 & x36 & ~x37));
  ...
  assign new_n539_ = (new_n381_ | x34) & (~new_n297_ | ~x34 | x35 | x37);
  ...
  assign new_n544_ = (~new_n297_ | ~x34 | x35 | x37) & (x34 | (~new_n546_ & (~x35 | new_n545_ | ~x37)));
  ...
  assign new_n548_ = (new_n549_ | new_n123_) & (~new_n297_ | ~x34 | ~x36 | x37);
  ...
  assign new_n557_ = ~x09 & ~x17 & (new_n298_ | new_n122_);
  ...
  assign new_n568_ = ~x36 & ((~new_n569_ & ~x34) | (x15 & new_n324_ & ~x21));
  ...
  assign new_n601_ = ~new_n92_ & ((x38 & ~new_n506_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  ...
  assign new_n616_ = ~new_n617_ & (x01 | x02 | new_n424_ | x03);
  ...
  assign new_n621_ = (x35 | (x36 ? new_n398_ : new_n622_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n634_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n435_ & ~x38));
  ...
  assign new_n642_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n399_ | ~new_n525_) & (x00 | ~x05)));
