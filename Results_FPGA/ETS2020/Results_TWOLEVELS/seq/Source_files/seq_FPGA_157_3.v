...
module FAU ( 
  ...
  assign z29 = ~x07 & ~x32 & x33 & (new_n569_ | (new_n571_ & ~x05));
  ...
  assign new_n579_ = ~new_n92_ & (new_n566_ | (x24 & ~x34 & ~new_n580_ & x35));
  ...
  assign new_n605_ = ~new_n92_ & ((x38 & ~new_n513_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  ...
  assign new_n620_ = ~new_n621_ & (x01 | x02 | new_n431_ | x03);
  ...
  assign new_n625_ = (x35 | (x36 ? new_n405_ : new_n626_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n646_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n406_ | ~new_n532_) & (x00 | ~x05)));
