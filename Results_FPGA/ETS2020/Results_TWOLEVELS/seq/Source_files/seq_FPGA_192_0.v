...
module FAU ( 
  ...
  assign z13 = x33 & (x07 | (~x32 & ~x34 & new_n189_ & x35));
  assign new_n189_ = ~x37 & ((~x07 & ~x36 & (x38 ? (~x39 & ~x40) : (x39 & x40))) | (x36 & ~x38 & ~x39));
  assign z14 = x33 & (x07 | (~x32 & ~x34 & new_n191_ & x35));
  assign new_n191_ = ~new_n192_ & ~x37;
  assign new_n192_ = (x07 | x36 | (x38 ? (x39 | x40) : (~x39 | ~x40))) & (~x13 | ~x36 | x38 | x39);
  ...
  assign new_n259_ = (~x34 | x35 | x36 | x37 | new_n83_ | x38) & (x34 | ~x35 | ~x36 | ~x37 | ~x38);
