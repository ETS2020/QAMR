// Benchmark "FAU" written by ABC on Sat Aug  1 17:34:18 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n338_, new_n340_, new_n341_, new_n344_, new_n345_, new_n346_,
  ...
  assign new_n338_ = ~x40 & ((x36 & x37 & x38 & ~x34 & x35) | (x34 & ~x35 & ~x36 & ~x37 & ~x38));
  ...
  assign z15 = x07 & x33;
  assign z16 = ~x07 & ~x32 & x33 & (new_n351_ | (~new_n344_ & ~x34));
  assign new_n344_ = (new_n345_ | ~x36) & (~new_n121_ | ~x38 | ~x35 | x36 | ~x37);
  assign new_n345_ = (new_n346_ | x35) & (~new_n350_ | ~x35 | ~x37 | ~new_n167_ | x38);
  assign new_n346_ = ~new_n349_ & (~x38 | (~new_n347_ & (~x00 | ~new_n348_ | x01)));
  assign new_n347_ = new_n167_ & x37;
  assign new_n348_ = ~x02 & ~x03 & ~x04 & x40 & (~x37 ^ ~x39);
  assign new_n349_ = ~x37 & ~x38 & (~x39 | (~x11 & ~x12 & x40));
  assign new_n350_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n351_ = x34 & ~x35 & ~x36 & new_n119_ & x37 & x38;
  assign z17 = x33 & (x07 | (~x07 & ~new_n353_ & ~x32));
  assign new_n353_ = (x34 | new_n372_ | ~x36) & (x36 | (~new_n354_ & new_n362_));
  assign new_n354_ = ~x38 & (new_n355_ | (~x05 & new_n361_ & x15));
  assign new_n355_ = ~x35 & (new_n360_ | (x34 & (new_n356_ | new_n358_)));
  assign new_n356_ = x02 & ((x37 & ~x39) | (x00 & new_n357_ & ~x01));
  assign new_n357_ = ~x03 & x04 & ~new_n112_ & ~x37;
  assign new_n358_ = x37 & (new_n359_ | (~x39 & (x01 | x03 | x04)));
  assign new_n359_ = ~x05 & x15 & x39 & x40 & ~new_n95_ & ~new_n213_;
  assign new_n360_ = ~x05 & ~x31 & ~new_n89_ & ~x34;
  assign new_n361_ = ~x34 & x35 & ~x39 & ~new_n218_ & ~new_n95_;
  assign new_n362_ = ~new_n371_ & (x05 | x34 | (~new_n370_ & (~new_n363_ | ~x15)));
  assign new_n363_ = ~new_n95_ & (new_n369_ | (x38 & (new_n368_ | (~new_n364_ & ~x37))));
  assign new_n364_ = ~new_n366_ & (~x39 | (~new_n365_ & (~x35 | (~new_n277_ & x24))));
  assign new_n365_ = new_n104_ & ~x31 & ~x35 & x40;
  assign new_n366_ = ~x09 & (new_n367_ | (x35 & x39 & ~x18 & ~x21));
  assign new_n367_ = ~x16 & ~x31 & ~x35 & ~x40;
  assign new_n368_ = ~x09 & ~x17 & ~x31 & ~x35 & x39;
  assign new_n369_ = ~x35 & ~x37 & x39 & ~x09 & ~x16 & ~x31;
  assign new_n370_ = ~x31 & new_n115_ & ~x35;
  assign new_n371_ = x34 & ~x35 & ~x37 & x38 & ~new_n128_ & x39;
  assign new_n372_ = (new_n375_ | x40) & (~x00 | (~new_n133_ & (new_n373_ | ~x38)));
  assign new_n373_ = ~new_n374_ & (x35 | ~x40 | new_n128_ | (x37 ^ ~x39));
  assign new_n374_ = x04 & x35 & x37 & ~x01 & x02 & ~x03;
  assign new_n375_ = (x38 | ~x39 | ~x35 | ~x37) & (~x10 | ~x27 | x35 | x37 | ~x38 | x39);
  assign z18 = ~x07 & x33 & ((~new_n377_ & ~x34) | (~x32 & new_n412_ & x34));
  assign new_n377_ = ~new_n404_ & (x32 | (~new_n378_ & new_n390_));
  assign new_n378_ = x40 & (x38 ? (x35 ? ~new_n383_ : ~new_n379_) : ~new_n386_);
  assign new_n379_ = x36 ? ((~new_n382_ | ~x00) & (~x37 | ~x39) & (x37 | x39)) : new_n380_;
  assign new_n380_ = (~new_n381_ | ~x11) & (x05 | x31 | new_n180_ | x39);
  assign new_n381_ = x12 & x14 & x15 & ~x37 & ~new_n145_ & x39;
  assign new_n382_ = ~x01 & ~x02 & ~x03 & ~x04 & (~x37 ^ ~x39);
  assign new_n383_ = x37 ? (x36 & (~x00 | x01 | x04 | ~x36)) : new_n384_;
  assign new_n384_ = x39 & (x05 | ~x15 | ~new_n385_ | ~x21);
  assign new_n385_ = x22 & x24 & ~x36 & ~new_n95_ & x39;
  assign new_n386_ = x35 ? (new_n387_ | x36) : (new_n389_ | ~x36);
  assign new_n387_ = (~x37 | ~x39) & (x05 | x39 | (~new_n388_ & (x13 | new_n88_ | x37)));
  assign new_n388_ = x15 & x24 & ~new_n95_ & (~x37 | (x21 & x22 & x37));
  assign new_n389_ = ~x37 & (x11 | x37 | (x12 & (~x12 | ~x39)));
  assign new_n390_ = new_n394_ & (x40 | (x37 ? (new_n399_ & new_n403_) : new_n391_));
  assign new_n391_ = (~x36 | ~x38 | ~x39) & (x39 | (~new_n392_ & (x35 | ~x36 | new_n138_ | ~x38)));
  assign new_n392_ = ~x05 & x15 & x21 & new_n393_ & x22;
  assign new_n393_ = x24 & x35 & ~x36 & ~new_n95_ & ~x38;
  assign new_n394_ = (new_n395_ | x37) & (~new_n398_ | ~x38 | ~x39 | x36 | ~x37);
  assign new_n395_ = (~x35 | ((~x36 | x38 | x39) & (~x39 | (~new_n396_ & (~x36 | x38))))) & (x35 | ~x36 | x38 | x39);
  assign new_n396_ = ~x05 & x15 & x21 & new_n397_ & x22;
  assign new_n397_ = x23 & x24 & ~x36 & x38 & (x11 | x12);
  assign new_n398_ = ~x05 & x09 & ~x31 & ~x35;
  assign new_n399_ = x35 ? new_n400_ : (x38 | new_n402_ | ~x39);
  assign new_n400_ = (x36 | ~x38 | x39) & (~x00 | ((x36 | ~x38 | ~x39) & (~new_n401_ | x38 | x39 | ~x04 | ~x36)));
  assign new_n401_ = x01 & ~x02 & ~x03;
  assign new_n402_ = ~x36 & (x05 | x31 | new_n180_ | x36);
  assign new_n403_ = x35 ? ((x36 | x38) & (~x00 | x01 | x04 | ~x36 | ~x38)) : (~x36 | ~x38);
  assign new_n404_ = ~x35 & ~x36 & ((~new_n405_ & x15) | new_n411_ | x32);
  assign new_n405_ = (new_n406_ | (~x09 & ~x16)) & (~x09 | ~x11 | new_n409_ | ~x12);
  assign new_n406_ = (~new_n407_ | x05) & (~new_n148_ | ~new_n408_ | ~x17 | ~x37);
  assign new_n407_ = ~x31 & ~new_n95_ & (x38 ? (~x39 & ~x40) : (~x37 | (x39 & x40)));
  assign new_n408_ = ~x38 & ~x39;
  assign new_n409_ = ~new_n410_ & (~new_n127_ | ~x14 | ~x16);
  assign new_n410_ = ~x05 & ~x31 & ~x37 & ~x40;
  assign new_n411_ = ~x05 & ~x31 & ~x39 & ~x40 & (~x37 ^ x38);
  assign new_n412_ = ~x35 & ((~new_n413_ & ~x36) | (x36 & ~x37 & new_n167_ & ~x38));
  assign new_n413_ = x38 ? ((new_n188_ | x37) & (x39 | ~x40) & (~x37 | x40)) : new_n414_;
  assign new_n414_ = (new_n415_ | ~x39) & (x01 | x04 | new_n417_ | x39);
  assign new_n415_ = x37 ? (~new_n416_ & x40) : (~x40 & (~x00 | x01 | x04 | x40));
  assign new_n416_ = ~x05 & x15 & x21 & x22 & ~new_n95_ & x40;
  assign new_n417_ = (~x00 | x37) & (x02 | x03 | ~x37 | ~x40);
  assign z19 = ~x07 & ~x32 & x33 & (x38 ? ~new_n423_ : ~new_n419_);
  assign new_n419_ = (x34 | ~new_n422_ | ~x35) & (x35 | (~new_n420_ & (~new_n347_ | x34 | ~x36)));
  assign new_n420_ = ~x01 & ~x02 & ~x03 & x34 & ~new_n421_ & ~x36;
  assign new_n421_ = (x04 | ~x37 | x39 | x40) & (~x00 | ~x04 | x37 | (x39 & x40));
  assign new_n422_ = x40 & (x36 ? (x37 & (x39 | (x06 & ~x39))) : (~x37 & x39));
  assign new_n423_ = (~new_n426_ | ~x06) & (x34 | new_n424_ | ~x35);
  assign new_n424_ = (~new_n425_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n167_ | x36 | x37);
  assign new_n425_ = x00 & ~x01 & ~x02;
  assign new_n426_ = x39 & x40 & ((x34 & ~x35 & ~x36 & x37) | (~x34 & x35 & x36 & ~x37));
  assign z20 = ~x07 & ~x32 & x33 & (new_n447_ | (~new_n428_ & ~x36));
  assign new_n428_ = (new_n429_ | x35) & (x34 | (~new_n446_ & (new_n443_ | ~x35)));
  assign new_n429_ = (new_n430_ | x38) & (x34 | (~new_n442_ & ~new_n435_ & ~new_n440_));
  assign new_n430_ = ~new_n431_ & ~new_n434_ & (x05 | x31 | new_n433_ | x34);
  assign new_n431_ = ~x37 & ((new_n432_ & ~x05) | (~x00 & ~new_n112_ & x05));
  assign new_n432_ = ~x34 & (x31 | (~x31 & ~new_n88_ & x39));
  assign new_n433_ = (~x40 | (~new_n95_ & x15)) & (~x37 | x39 | ((~new_n244_ | ~x15) & ~new_n95_ & x15));
  assign new_n434_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n88_ & x40));
  assign new_n435_ = ~x05 & (x31 ? (~new_n438_ | new_n149_) : (~new_n436_ & ~x37));
  assign new_n436_ = (~x39 | (~new_n299_ & (~x40 | (~new_n437_ & new_n88_)))) & (~x38 | x39 | new_n88_ | x40);
  assign new_n437_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n438_ = ~new_n104_ & new_n300_ & ~new_n119_ & ~new_n439_ & x14 & x15;
  assign new_n439_ = x38 & ~x39;
  assign new_n440_ = x05 & (~new_n441_ | new_n149_);
  assign new_n441_ = ~new_n104_ & new_n300_ & x14 & ~new_n439_ & x15;
  assign new_n442_ = x37 & (x05 ? x38 : (x31 & x39));
  assign new_n443_ = (x05 | new_n88_ | new_n445_) & (new_n444_ | (~x05 & (x05 | new_n88_ | ~x13)));
  assign new_n444_ = ~new_n126_ & (~new_n121_ | x38);
  assign new_n445_ = (x13 | ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))))) & (~x13 | x37 | x38 | x39);
  assign new_n446_ = x05 & ((~x37 & (x38 ? (x39 & ~x40) : ~x39)) | (x39 & ~x40 & ~x00 & x38));
  assign new_n447_ = ~x34 & x36 & (new_n450_ | (x40 & (new_n448_ | new_n449_)));
  assign new_n448_ = ~x00 & x05 & x38 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n449_ = x11 & ~x35 & ~x37 & ~x38 & x39;
  assign new_n450_ = x35 & x37 & x38 & ~x00 & x05;
  assign z22 = ~x07 & x33 & (new_n452_ | (x05 & new_n461_ & ~x32));
  assign new_n452_ = ~x34 & (new_n453_ | (~x00 & x05 & new_n460_ & ~x32));
  assign new_n453_ = ~x36 & ((~new_n454_ & ~x35) | (x05 & ~new_n459_ & ~x32));
  assign new_n454_ = (~x05 | x32 | (new_n458_ & ~new_n149_)) & ~x32 & (x05 | new_n455_ | x31);
  ...
  assign new_n458_ = (~x38 | (~x37 & x39)) & new_n148_ & x15 & ~new_n104_ & (x38 | ~x39);
  assign new_n459_ = (x37 | (x38 ? (~x39 | x40) : x39)) & (~x39 | x40 | x00 | ~x38) & (~x35 | ((x38 | x39 | ~x40) & (x37 | ~x38 | ~x39)));
  assign new_n460_ = x36 & x38 & ((x37 & (x35 | (~x39 & x40))) | (x39 & x40 & ~x35 & ~x37));
  assign new_n461_ = ~x35 & ~x36 & ~x38 & ((new_n112_ & x37) | (~x00 & ~new_n112_ & ~x37));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n471_ : ~new_n463_);
  assign new_n463_ = (x38 | (~new_n355_ & ~new_n469_)) & ~new_n371_ & (new_n464_ | x34);
  assign new_n464_ = (new_n465_ | x05) & (~new_n114_ | ~x35 | ~x37);
  assign new_n465_ = ~new_n370_ & (~x15 | new_n95_ | (~new_n466_ & ~new_n369_));
  assign new_n466_ = x38 & (new_n368_ | (~x37 & (new_n366_ | (~new_n467_ & x39))));
  ...
  assign new_n470_ = ~new_n95_ & ((~new_n273_ & x40) | (~x37 & (~x24 | (x24 & ~new_n213_ & ~x40))));
  assign new_n471_ = (new_n372_ | x34) & (~x34 | x35 | x37 | ~new_n167_ | x38);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n476_ : ~new_n473_);
  assign new_n473_ = (x05 | new_n465_ | x34) & (x38 | (~new_n469_ & ~new_n474_));
  assign new_n474_ = ~x35 & (new_n360_ | (x34 & (new_n211_ | (new_n475_ & x00))));
  assign new_n475_ = ~x01 & new_n357_ & x02;
  assign new_n476_ = (new_n477_ | x34) & (~x34 | x35 | x37 | ~new_n167_ | x38);
  assign new_n477_ = (~new_n478_ | ~x35) & (~new_n167_ | ~new_n153_ | ~x10 | ~x27 | x35);
  assign new_n478_ = x37 & ((new_n119_ & ~x38) | (new_n479_ & ~x03 & x04 & x38));
  assign new_n479_ = x00 & ~x01 & x02;
  assign z28 = ~x07 & ~x32 & x33 & (new_n483_ | (new_n481_ & x00));
  assign new_n481_ = ~x01 & x02 & ~x03 & ~new_n482_ & x04;
  assign new_n482_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n112_ | x38);
  assign new_n483_ = new_n138_ & ~x34 & ~x35 & new_n114_ & x36 & ~x37;
  assign z30 = ~x07 & ~x32 & x33 & (new_n485_ | new_n483_);
  assign new_n485_ = ~x05 & x15 & ~x36 & ~new_n486_ & ~new_n95_;
  ...
  assign new_n491_ = (new_n492_ | ~x35) & (~new_n167_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  assign new_n492_ = ~new_n497_ & (x05 | ~x15 | x36 | new_n493_ | new_n95_);
  assign new_n493_ = (x38 | x39 | (~new_n494_ & (x24 | x37))) & (x37 | ~x38 | ~x39 | (~new_n496_ & x24));
  assign new_n494_ = x40 & (~x24 | (~x21 & x22 & ~x23 & new_n495_ & x24));
  assign new_n495_ = ~new_n174_ & x37;
  assign new_n496_ = new_n213_ & ~x23 & x24 & ~x40;
  assign new_n497_ = new_n498_ & x00 & ~x01 & x02 & ~x03;
  assign new_n498_ = x04 & x36 & x37 & x38;
  assign new_n499_ = x00 & ~x01 & x02 & ~x03 & new_n500_ & x04;
  assign new_n500_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n112_ & ~x38;
  ...
  assign new_n506_ = ~x21 & (x21 | new_n174_ | ~x23);
  ...
  assign new_n509_ = x24 & ~new_n95_ & ((new_n510_ & x38) | (new_n167_ & x21 & ~x38));
  ...
  assign new_n513_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n167_ & x01 & ~x38));
  assign new_n514_ = (new_n523_ | ~x36) & (x05 | x31 | new_n515_ | x36);
  assign new_n515_ = ~new_n315_ & ~new_n516_ & new_n522_ & (x37 | (~new_n519_ & ~new_n520_));
  assign new_n516_ = x15 & ((~new_n517_ & x09) | (x16 & new_n152_ & x17));
  ...
  assign new_n523_ = (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n285_ | ~x40))))) & (x39 | x40 | ~x37 | x38);
  assign new_n524_ = x38 ? ((x39 | (~x40 & (x37 | x40))) & (~x39 | ~x40 | ~x06 | ~x37)) : new_n525_;
  assign new_n525_ = ~new_n526_ & (x01 | x02 | new_n421_ | x03);
  assign new_n526_ = x39 & x40 & (~x37 | (~x05 & ~new_n307_ & x37));
  ...
  assign new_n531_ = ~x39 & ((new_n244_ & x15) | new_n95_ | ~x15);
  assign new_n532_ = x00 ? (~new_n533_ | x01) : (~x05 | (~new_n121_ & ~x35));
  assign new_n533_ = ~x02 & ~x03 & ((x04 & x35) | (new_n121_ & ~x04 & ~x35));
  ...
  assign new_n539_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n300_));
  assign new_n540_ = x11 & x12 & x14 & ~new_n145_ & x40;
  assign new_n541_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n542_ = new_n425_ & ~x03 & ~x04 & x40;
  assign new_n543_ = (x35 | ((new_n544_ | x36) & (~new_n546_ | ~x11 | ~x36))) & (~new_n546_ | ~x35 | x36);
  ...
  assign new_n548_ = ~x36 & (new_n550_ | (~x35 & (new_n440_ | (new_n549_ & ~x05))));
  assign new_n549_ = ~x31 & ~new_n88_ & ((~x38 & x40) | (~x39 & ~x40 & ~x37 & x38));
  ...
  assign new_n553_ = new_n425_ & ~x03 & x04 & x34;
