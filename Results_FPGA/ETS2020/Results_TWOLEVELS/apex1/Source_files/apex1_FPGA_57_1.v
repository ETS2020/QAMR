// Benchmark "FAU" written by ABC on Sat Aug  1 11:08:02 2020
...
module FAU ( 
  ...
  assign new_n398_ = x28 & x26 & ~x21 & new_n183_ & x20;
  assign z22 = (~new_n400_ & x30) | new_n434_ | (~x30 & (x29 ? ~new_n421_ : ~new_n437_));
  assign new_n400_ = ~new_n217_ & (new_n401_ | x21) & (~x21 | (x19 ? new_n418_ : new_n410_));
  assign new_n401_ = (x29 | (x18 ? new_n405_ : new_n402_)) & (new_n407_ | ~x18) & (x18 | new_n409_ | ~x29);
  assign new_n402_ = x19 ? ~new_n404_ : (~new_n287_ & new_n403_);
  ...
  assign new_n407_ = x19 ? (~x29 | (~new_n298_ & (new_n264_ | x20))) : new_n408_;
  ...
  assign new_n421_ = (x18 | (new_n431_ & (new_n422_ | x20))) & ~new_n155_ & (new_n427_ | ~x18);
  assign new_n422_ = ~new_n193_ & ~new_n426_ & (x19 | (~new_n425_ & (new_n423_ | x28)));
  assign new_n423_ = (new_n269_ | x21) & (x09 | ~x21 | ~x22 | ~new_n424_ | x38);
  assign new_n424_ = ~x41 & (x39 ? x42 : (~x42 & (x40 | (~x40 & (x43 ^ x44)))));
  assign new_n425_ = x21 & x23 & new_n361_ & ~x31;
  assign new_n426_ = new_n327_ & x22 & ~x28 & ~x38 & ~x09 & x21;
  assign new_n427_ = x20 ? new_n428_ : ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28));
  assign new_n428_ = new_n430_ & (x28 | ((new_n429_ | x19) & (new_n154_ | ~x21) & (~x19 | x21)));
  assign new_n429_ = (~x11 | ~x21 | ~x25) & (~x17 | x21 | ~x26);
  assign new_n430_ = (~x19 | (~x21 & (x27 | ~x28 | ~x04 | x21))) & (x19 | x21 | ~x26 | ~x28);
  ...
  assign new_n436_ = ~x20 & x22 & ~x28 & ~new_n165_ & x29;
  ...
  assign new_n446_ = (new_n447_ | ~x30) & (~new_n233_ | ~x21 | x27 | x30);
  ...
  assign new_n452_ = x30 & (x20 ? ~new_n149_ : ~new_n202_);
  ...
  assign new_n462_ = (~x28 | x29 | new_n463_ | ~x30) & (x20 | x28 | ~x29 | new_n269_ | x30);
  ...
  assign new_n468_ = (new_n469_ | ~x20) & (~x19 | (~new_n419_ & new_n474_)) & (x19 | ~new_n475_ | x20);
  assign new_n469_ = new_n473_ & (x28 | (~new_n472_ & (new_n470_ | x29)));
  assign new_n470_ = ~new_n471_ & (~x00 | x10 | x15 | x19 | ~x25);
  assign new_n471_ = x05 & (x19 ? x22 : x18);
  assign new_n472_ = x11 & ~x19 & x29 & (x25 | x26);
  assign new_n473_ = x18 ? (~x19 | (~x22 & ~x29)) : (x19 | ~x29);
  assign new_n474_ = x18 ? (x20 | (~x22 & ~x26)) : (~x28 | ~x29);
  assign new_n475_ = x28 & (x18 ? ~x29 : x22);
  ...
  assign new_n480_ = ~x30 & ((~x19 & x23) | (~x28 & (new_n481_ | (x19 & (x22 | x23)))));
  assign new_n481_ = new_n482_ & ~x09 & x22 & ~x38 & ~x39;
  assign new_n482_ = ~x40 & ~x41 & ~x42 & ~x43 & ~x44;
  ...
  assign new_n486_ = (~new_n143_ | x21 | ~x27 | x30) & (~x30 | (~new_n488_ & (new_n487_ | ~x21)));
  assign new_n487_ = x19 ? (~x18 & (~new_n108_ | ~new_n109_ | x18)) : (~new_n102_ & (x18 | ~x24));
  assign new_n488_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n489_ = (new_n490_ | x20) & (~new_n140_ | x18 | ~x19 | ~x21);
  assign new_n490_ = (new_n491_ | x19) & (~new_n113_ | ~new_n156_ | ~x18 | ~x19 | x21);
  assign new_n491_ = (x03 | x18 | new_n119_ | x21) & (~new_n110_ | x28 | ~x18 | ~x21);
  ...
  assign new_n496_ = (new_n497_ | ~x00) & (~new_n135_ | ~new_n249_ | x00 | x04 | ~x18);
  assign new_n497_ = (new_n498_ | ~x20) & (~x18 | ~x19 | new_n118_ | x20);
  assign new_n498_ = (x18 | ~x19 | ~x22 | ~x28) & (x17 | ~x18 | x19 | ~x26 | x28);
  assign z31 = ~x21 & x28 & (new_n502_ | (~new_n500_ & x00));
  assign new_n500_ = (~new_n501_ | ~x18) & (~new_n135_ | x18 | ~new_n113_ | ~x22);
  assign new_n501_ = x26 & ~x29 & x30 & (x19 ^ x20);
  assign new_n502_ = new_n114_ & ~x00 & ~x04 & new_n113_ & x20 & ~x27;
  assign z32 = ~x30 & new_n504_ & ~x29;
  assign new_n504_ = ~x28 & ~x27 & x21 & new_n505_ & ~x14;
  ...
  assign z34 = x18 ? (~new_n528_ | (~new_n516_ & x20)) : (~new_n510_ | new_n523_);
  assign new_n510_ = (new_n511_ | ~x29) & (x21 | ~x28 | x29 | new_n515_ | x30);
  assign new_n511_ = (~new_n164_ | x09) & (x30 | ((~new_n514_ | ~x19) & (x09 | ~new_n512_ | x19)));
  ...
  assign new_n516_ = (new_n517_ | x21) & (x11 | x19 | ~new_n522_ | ~x21);
  assign new_n517_ = x30 ? new_n518_ : new_n520_;
  ...
  assign new_n522_ = ~x28 & x29 & x30 & (x25 | x26);
  assign new_n523_ = x30 & ((~new_n527_ & ~x28) | (~new_n524_ & ~x29));
  assign new_n524_ = (~x28 | ((new_n525_ | x21) & (~x00 | ~x19 | ~x21))) & (~x19 | ~x21 | new_n526_ | x28);
  assign new_n525_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n526_ = ~x24 & (~x10 | ~x25) & ~x26;
  assign new_n527_ = (~x22 | ((~x21 | (x19 ? (~x20 | ~x29) : (x20 | (~x09 & ~x29)))) & (~x20 | x21 | ~x29))) & (x19 | x21 | ~x29);
  assign new_n528_ = (~new_n392_ | ~new_n137_ | x19) & (new_n529_ | x20);
  assign new_n529_ = ~new_n530_ & (~new_n110_ | ~new_n130_ | ~x00 | ~x19 | x21);
  assign new_n530_ = (x28 ? (~x29 & ~x30) : (x29 & x30)) & (x19 ? (~x21 & x26) : x21);
  assign z35 = x30 ? ~new_n532_ : (new_n551_ | (~x21 & (new_n556_ | new_n558_)));
  assign new_n532_ = ~new_n549_ & (x29 | (new_n542_ & (new_n533_ | x18)));
  assign new_n533_ = x19 ? new_n534_ : (new_n539_ & (new_n537_ | ~x20));
  assign new_n534_ = x21 ? (~new_n535_ & (~x01 | ~new_n168_ | x20)) : new_n536_;
  assign new_n535_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n536_ = x20 ? (~x22 | (x28 & (~x28 | (x02 & ~x03)))) : (~x22 & ~x23);
  assign new_n537_ = (x21 | (~new_n538_ & ~x24)) & (~x00 | ~x21 | (new_n96_ & ~x22 & ~x24));
  assign new_n538_ = x28 & ((x03 & ~x06) | (~x02 & (~x06 | (x00 & ~x03))));
  assign new_n539_ = (x21 | ~x23 | x28) & (x20 | (x21 ? new_n541_ : (~new_n540_ & x28)));
  assign new_n540_ = ~x03 & (~x02 | (x00 & x02 & x28));
  assign new_n541_ = ~x23 & (x09 | ~x22 | x28);
  assign new_n542_ = (new_n543_ | new_n118_) & ~new_n545_ & (~x18 | (~new_n547_ & ~new_n548_));
  assign new_n543_ = ~new_n544_ & (~new_n108_ | ~x00 | ~new_n252_ | ~x21 | x28);
  assign new_n544_ = x18 & x19 & ~x20 & ~x21;
  assign new_n545_ = new_n546_ & ~x15 & ~x19 & x00 & ~x05;
  assign new_n546_ = x20 & x21 & x26 & ~x28;
  ...
  assign new_n551_ = x29 & (new_n555_ | (x21 & (~new_n554_ | (~new_n552_ & ~x19))));
  assign new_n552_ = (x18 | ~x20) & (x28 | (new_n553_ & (~x18 | (x20 & (~x11 | ~x20 | ~x25)))));
  assign new_n553_ = ~new_n243_ & (~new_n257_ | x41 | ~x42 | x38 | ~x39);
  assign new_n554_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n154_ | x28)));
  assign new_n555_ = new_n114_ & x20 & ~x27 & ~x28;
  assign new_n556_ = ~x03 & (new_n557_ | (new_n114_ & x20 & x27 & ~x29));
  assign new_n557_ = x00 & ~x05 & ~x18 & new_n253_ & ~x19 & ~x20;
  assign new_n558_ = x29 & ((x00 & new_n560_ & ~x18) | (x18 & (new_n562_ | (~new_n559_ & x00))));
  assign new_n559_ = (~x19 | new_n118_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n560_ = ~new_n561_ & x20;
  assign new_n561_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n562_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign z36 = (~new_n571_ & x21) | (~x30 & ((~new_n564_ & ~x21) | new_n581_ | (~new_n577_ & x21)));
  assign new_n564_ = ~new_n556_ & new_n567_ & (~x18 | (new_n565_ & (new_n570_ | ~x26)));
  assign new_n565_ = (~x19 | (~new_n566_ & (~new_n521_ | ~x20))) & (~new_n365_ | x14 | x19 | x20);
  assign new_n566_ = x00 & ((~x20 & ~new_n118_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n567_ = (new_n568_ | x29) & (~x00 | x18 | ~x20 | new_n561_ | ~x29);
  assign new_n568_ = (x14 | new_n569_ | x27) & (x18 | new_n515_ | ~x28);
  ...
  assign new_n573_ = (new_n526_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
  assign new_n574_ = new_n183_ & ~x11 & x20 & x25 & x29;
  assign new_n575_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n576_ = x16 ? x08 : x07;
  assign new_n577_ = x29 ? (new_n554_ & (new_n578_ | x19)) : new_n580_;
  assign new_n578_ = (x18 | ~x20) & (x28 | (x20 ? new_n313_ : (~x18 & (x09 | ~new_n579_ | x18))));
  assign new_n579_ = x22 & ~x38 & ~x41 & (x39 ? x42 : (x40 & ~x42));
  assign new_n580_ = (~new_n183_ | x20 | ~x28) & (~new_n505_ | x14 | x27 | x28);
  assign new_n581_ = x19 & x20 & ((new_n582_ & ~x18) | (new_n253_ & x18 & ~x27));
  assign new_n582_ = x22 & x28 & ~new_n576_ & ~x29;
  assign z37 = (~new_n584_ & x30) | new_n638_ | (~x30 & (x29 ? ~new_n614_ : ~new_n630_));
  assign new_n584_ = ~new_n217_ & new_n604_ & (x29 | (~new_n585_ & new_n594_));
  ...
  assign new_n591_ = ~new_n535_ & (x28 | (new_n592_ & ~x25));
  assign new_n592_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n593_ = (new_n541_ | x20) & (~x00 | ~x20 | (new_n96_ & ~x22 & ~x24));
  assign new_n594_ = ~new_n600_ & (~x20 | (~new_n598_ & (x28 | (~new_n595_ & ~new_n603_))));
  assign new_n595_ = x21 & (new_n471_ | (~x19 & (new_n597_ | (new_n596_ & x00))));
  assign new_n596_ = ~x15 & ((x25 & (~x10 | (~x05 & x10))) | (~x05 & (x22 | x26)));
  assign new_n597_ = ~x05 & x15 & x18;
  assign new_n598_ = ~new_n599_ & x18;
  assign new_n599_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21 | (~x27 & (x27 | ~x28)));
  assign new_n600_ = x18 & ~x20 & (new_n601_ | ~new_n602_);
  assign new_n601_ = x00 & ((x26 & x28 & x19 & ~x21) | (~x19 & x21 & ~x28));
  assign new_n602_ = (x19 | ~x21 | ~x28) & (x21 | (~x25 & (~x19 | (~x22 & (~x26 | x28)))));
  assign new_n603_ = x18 & ~x21 & (x19 ? ~x27 : x26);
  assign new_n604_ = new_n610_ & (~x29 | (new_n608_ & (x28 | (~new_n605_ & new_n606_))));
  assign new_n605_ = ~x19 & (x21 ? ~new_n416_ : (~x18 | (new_n243_ & ~x17 & x18)));
  assign new_n606_ = (~new_n207_ | x20 | ~x18 | ~x19) & (~x20 | ((~new_n393_ | x18) & (new_n607_ | ~x19)));
  assign new_n607_ = x18 ? (x21 | x27 | (~x05 & (~x00 | x05))) : (~x21 | ~x22);
  assign new_n608_ = (~x20 | ~x21 | x18 | x19) & (~x19 | (~new_n609_ & (~x18 | (x20 ? ~x21 : (new_n202_ | x21)))));
  ...
  assign new_n614_ = new_n619_ & (x18 | (new_n627_ & (x20 | (new_n615_ & ~new_n193_))));
  assign new_n615_ = (x19 | ~x21 | ~x23) & (x28 | (~new_n616_ & (x19 | new_n618_ | x21)));
  assign new_n616_ = ~x09 & x21 & x22 & ~x38 & ~new_n617_ & ~x41;
  assign new_n617_ = (x39 | x42 | (x40 ? x19 : ((x43 | x44) & (x19 | (~x43 ^ x44))))) & (x19 | ~x39 | ~x42);
  assign new_n618_ = ~x03 & ~x05 & (~x00 | x03 | x05);
  assign new_n619_ = ~new_n155_ & (~x18 | (~new_n626_ & (new_n625_ | x20) & (new_n620_ | ~x20)));
  assign new_n620_ = ~new_n621_ & ~new_n624_ & (x28 | (~new_n622_ & ~new_n623_));
  assign new_n621_ = ~x19 & ~x21 & x26 & x28;
  assign new_n622_ = x21 & x25 & (~x11 | (x11 & ~x19));
  assign new_n623_ = ~x21 & (x19 | (~x19 & x26 & (x17 | (x00 & ~x17))));
  assign new_n624_ = x19 & (x21 | (~x21 & ~x27 & x28 & (x04 | (~x00 & ~x04))));
  assign new_n625_ = x19 ? (x21 | ((~x26 | ~x28) & (~x00 | (~new_n133_ & (~x26 | x28))))) : (~x21 | x28);
  ...
  assign new_n630_ = (~x20 | (~new_n631_ & (new_n633_ | x21))) & new_n635_ & (new_n580_ | ~x21);
  assign new_n631_ = x19 & ((new_n439_ & x18) | (x28 & (x18 ? new_n115_ : new_n632_)));
  assign new_n632_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n633_ = (new_n634_ | x18) & (~x17 | ~x18 | ~new_n130_ | x19);
  ...
  assign new_n638_ = ~x19 & x21 & (new_n639_ | (~x09 & new_n436_ & ~x18));
  assign new_n639_ = x20 & ((x18 & x28) | (~x10 & ~x18 & x25));
  assign z38 = (~new_n641_ & ~x00) | (~x01 & ~x18 & new_n654_ & x19);
  assign new_n641_ = (x29 | (~new_n648_ & (new_n642_ | ~x30))) & (x21 | new_n649_ | ~x29);
  ...
  assign new_n645_ = (~x21 | x28 | (~new_n108_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n646_ = new_n137_ & x20 & ~x05 & ~x15 & ~x18;
  assign new_n647_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n648_ = new_n143_ & x20 & ~x21 & x27;
  ...
  assign new_n652_ = (~x19 | new_n264_ | x20) & (~x20 | ((~new_n156_ | x19) & (~new_n249_ | x04 | ~x19)));
  assign new_n653_ = new_n114_ & ~x05 & new_n171_ & x20 & ~x27;
  assign new_n654_ = ~x20 & ~new_n149_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n660_ & x29) | (x19 & (~new_n656_ | (~new_n665_ & ~x18)));
  assign new_n656_ = (~new_n169_ | ~x27 | x29 | ~x30) & (~x29 | (~new_n659_ & (new_n657_ | x30)));
  assign new_n657_ = (new_n658_ | ~x20) & (~x18 | x20 | ~new_n130_ | x21);
  assign new_n658_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n249_ | ~x04 | x21)));
  assign new_n659_ = x18 & ~x20 & ~x21 & ~new_n202_ & x30;
  assign new_n660_ = (~x20 | ((~new_n663_ | x19) & (new_n661_ | x30))) & (x19 | new_n664_ | x30);
  assign new_n661_ = (new_n662_ | ~x21) & (~new_n183_ | ~new_n130_ | x21);
  assign new_n662_ = (~x18 | new_n154_ | x28) & (x19 | (x18 & (new_n313_ | x28)));
  assign new_n663_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n664_ = (x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20);
  assign new_n665_ = x21 ? new_n667_ : (~new_n666_ & (~x29 | new_n296_ | x30));
  assign new_n666_ = x02 & ~x03 & x20 & new_n110_ & x22 & x28;
  assign new_n667_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n149_ | ~x30);
