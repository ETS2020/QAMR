// Benchmark "FAU" written by ABC on Sat Aug  1 11:11:02 2020
...
module FAU ( 
  ...
  assign new_n440_ = (new_n441_ | ~x30) & (~new_n233_ | ~x21 | x27 | x30);
  ...
  assign new_n446_ = x30 & (x20 ? ~new_n149_ : ~new_n202_);
  ...
  assign new_n456_ = (~x28 | x29 | new_n457_ | ~x30) & (x20 | x28 | ~x29 | new_n269_ | x30);
  ...
  assign new_n480_ = (~new_n143_ | x21 | ~x27 | x30) & (~x30 | (~new_n482_ & (new_n481_ | ~x21)));
  assign new_n481_ = x19 ? (~x18 & (~new_n108_ | ~new_n109_ | x18)) : (~new_n102_ & (x18 | ~x24));
  assign new_n482_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n483_ = (new_n484_ | x20) & (~new_n140_ | x18 | ~x19 | ~x21);
  assign new_n484_ = (new_n485_ | x19) & (~new_n113_ | ~new_n156_ | ~x18 | ~x19 | x21);
  assign new_n485_ = (x03 | x18 | new_n119_ | x21) & (~new_n110_ | x28 | ~x18 | ~x21);
  ...
  assign new_n490_ = (new_n491_ | ~x00) & (~new_n135_ | ~new_n249_ | x00 | x04 | ~x18);
  assign new_n491_ = (new_n492_ | ~x20) & (~x18 | ~x19 | new_n118_ | x20);
  assign new_n492_ = (x18 | ~x19 | ~x22 | ~x28) & (x17 | ~x18 | x19 | ~x26 | x28);
  assign z31 = ~x21 & x28 & (new_n496_ | (~new_n494_ & x00));
  assign new_n494_ = (~new_n495_ | ~x18) & (~new_n135_ | x18 | ~new_n113_ | ~x22);
  ...
  assign new_n505_ = (~new_n164_ | x09) & (x30 | ((~new_n508_ | ~x19) & (x09 | ~new_n506_ | x19)));
  ...
  assign new_n522_ = (~new_n392_ | ~new_n137_ | x19) & (new_n523_ | x20);
  assign new_n523_ = ~new_n524_ & (~new_n110_ | ~new_n130_ | ~x00 | ~x19 | x21);
  ...
  assign new_n531_ = (x21 | (~new_n532_ & ~x24)) & (~x00 | ~x21 | (new_n96_ & ~x22 & ~x24));
  ...
  assign new_n536_ = (new_n537_ | new_n118_) & ~new_n539_ & (~x18 | (~new_n541_ & ~new_n542_));
  assign new_n537_ = ~new_n538_ & (~new_n108_ | ~x00 | ~new_n252_ | ~x21 | x28);
  ...
  assign new_n547_ = ~new_n243_ & (~new_n257_ | x41 | ~x42 | x38 | ~x39);
  assign new_n548_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n154_ | x28)));
  assign new_n549_ = new_n114_ & x20 & ~x27 & ~x28;
  assign new_n550_ = ~x03 & (new_n551_ | (new_n114_ & x20 & x27 & ~x29));
  assign new_n551_ = x00 & ~x05 & ~x18 & new_n253_ & ~x19 & ~x20;
  ...
  assign new_n559_ = (~x19 | (~new_n560_ & (~new_n515_ | ~x20))) & (~new_n365_ | x14 | x19 | x20);
  assign new_n560_ = x00 & ((~x20 & ~new_n118_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n568_ = new_n183_ & ~x11 & x20 & x25 & x29;
  ...
  assign new_n572_ = (x18 | ~x20) & (x28 | (x20 ? new_n313_ : (~x18 & (x09 | ~new_n573_ | x18))));
  assign new_n573_ = x22 & ~x38 & ~x41 & (x39 ? x42 : (x40 & ~x42));
  assign new_n574_ = (~new_n183_ | x20 | ~x28) & (~new_n499_ | x14 | x27 | x28);
  assign new_n575_ = x19 & x20 & ((new_n576_ & ~x18) | (new_n253_ & x18 & ~x27));
  assign new_n576_ = x22 & x28 & ~new_n570_ & ~x29;
  assign z37 = (~new_n578_ & x30) | new_n632_ | (~x30 & (x29 ? ~new_n608_ : ~new_n624_));
  assign new_n578_ = ~new_n217_ & new_n598_ & (x29 | (~new_n579_ & new_n588_));
  ...
  assign new_n587_ = (new_n535_ | x20) & (~x00 | ~x20 | (new_n96_ & ~x22 & ~x24));
  ...
  assign new_n599_ = ~x19 & (x21 ? ~new_n412_ : (~x18 | (new_n243_ & ~x17 & x18)));
  assign new_n600_ = (~new_n207_ | x20 | ~x18 | ~x19) & (~x20 | ((~new_n393_ | x18) & (new_n601_ | ~x19)));
  assign new_n601_ = x18 ? (x21 | x27 | (~x05 & (~x00 | x05))) : (~x21 | ~x22);
  assign new_n602_ = (~x20 | ~x21 | x18 | x19) & (~x19 | (~new_n603_ & (~x18 | (x20 ? ~x21 : (new_n202_ | x21)))));
  ...
  assign new_n608_ = new_n613_ & (x18 | (new_n621_ & (x20 | (new_n609_ & ~new_n193_))));
  ...
  assign new_n613_ = ~new_n155_ & (~x18 | (~new_n620_ & (new_n619_ | x20) & (new_n614_ | ~x20)));
  ...
  assign new_n619_ = x19 ? (x21 | ((~x26 | ~x28) & (~x00 | (~new_n133_ & (~x26 | x28))))) : (~x21 | x28);
  ...
  assign new_n625_ = x19 & ((new_n435_ & x18) | (x28 & (x18 ? new_n115_ : new_n626_)));
  assign new_n626_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n627_ = (new_n628_ | x18) & (~x17 | ~x18 | ~new_n130_ | x19);
  ...
  assign new_n639_ = (~x21 | x28 | (~new_n108_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n640_ = new_n137_ & x20 & ~x05 & ~x15 & ~x18;
  assign new_n641_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n642_ = new_n143_ & x20 & ~x21 & x27;
  ...
  assign new_n646_ = (~x19 | new_n264_ | x20) & (~x20 | ((~new_n156_ | x19) & (~new_n249_ | x04 | ~x19)));
  assign new_n647_ = new_n114_ & ~x05 & new_n171_ & x20 & ~x27;
  assign new_n648_ = ~x20 & ~new_n149_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n654_ & x29) | (x19 & (~new_n650_ | (~new_n659_ & ~x18)));
  assign new_n650_ = (~new_n169_ | ~x27 | x29 | ~x30) & (~x29 | (~new_n653_ & (new_n651_ | x30)));
  assign new_n651_ = (new_n652_ | ~x20) & (~x18 | x20 | ~new_n130_ | x21);
  assign new_n652_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n249_ | ~x04 | x21)));
  assign new_n653_ = x18 & ~x20 & ~x21 & ~new_n202_ & x30;
  assign new_n654_ = (~x20 | ((~new_n657_ | x19) & (new_n655_ | x30))) & (x19 | new_n658_ | x30);
  assign new_n655_ = (new_n656_ | ~x21) & (~new_n183_ | ~new_n130_ | x21);
  assign new_n656_ = (~x18 | new_n154_ | x28) & (x19 | (x18 & (new_n313_ | x28)));
  assign new_n657_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n658_ = (x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20);
  assign new_n659_ = x21 ? new_n661_ : (~new_n660_ & (~x29 | new_n296_ | x30));
  assign new_n660_ = x02 & ~x03 & x20 & new_n110_ & x22 & x28;
  assign new_n661_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n149_ | ~x30);
