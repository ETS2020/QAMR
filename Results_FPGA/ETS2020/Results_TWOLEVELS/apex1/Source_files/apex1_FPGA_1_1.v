...
module FAU ( 
  ...
  assign new_n506_ = (~new_n164_ | x09) & (x30 | ((~new_n509_ | ~x19) & (x09 | ~new_n507_ | x19)));
  ...
  assign new_n523_ = (~new_n392_ | ~new_n137_ | x19) & (new_n524_ | x20);
  assign new_n524_ = ~new_n525_ & (~new_n110_ | ~new_n130_ | ~x00 | ~x19 | x21);
  ...
  assign new_n529_ = x21 ? (~new_n530_ & (~x01 | ~new_n168_ | x20)) : new_n531_;
  assign new_n530_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n531_ = x20 ? (~x22 | (x28 & (~x28 | (x02 & ~x03)))) : (~x22 & ~x23);
  assign new_n532_ = (x21 | (~new_n533_ & ~x24)) & (~x00 | ~x21 | (new_n96_ & ~x22 & ~x24));
  ...
  assign new_n537_ = (new_n538_ | new_n118_) & ~new_n540_ & (~x18 | (~new_n542_ & ~new_n543_));
  assign new_n538_ = ~new_n539_ & (~new_n108_ | ~x00 | ~new_n252_ | ~x21 | x28);
  ...
  assign new_n548_ = ~new_n243_ & (~new_n257_ | x41 | ~x42 | x38 | ~x39);
  assign new_n549_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n154_ | x28)));
  assign new_n550_ = new_n114_ & x20 & ~x27 & ~x28;
  assign new_n551_ = ~x03 & (new_n552_ | (new_n114_ & x20 & x27 & ~x29));
  assign new_n552_ = x00 & ~x05 & ~x18 & new_n253_ & ~x19 & ~x20;
  assign new_n553_ = x29 & ((x00 & new_n555_ & ~x18) | (x18 & (new_n557_ | (~new_n554_ & x00))));
  assign new_n554_ = (~x19 | new_n118_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  ...
  assign new_n560_ = (~x19 | (~new_n561_ & (~new_n516_ | ~x20))) & (~new_n365_ | x14 | x19 | x20);
  assign new_n561_ = x00 & ((~x20 & ~new_n118_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n575_ = (~new_n183_ | x20 | ~x28) & (~new_n576_ | x14 | x27 | x28);
  ...
  assign new_n589_ = (new_n536_ | x20) & (~x00 | ~x20 | (new_n96_ & ~x22 & ~x24));
  ...
  assign new_n601_ = ~x19 & (x21 ? ~new_n416_ : (~x18 | (new_n243_ & ~x17 & x18)));
  ...
  assign new_n627_ = x19 & ((new_n439_ & x18) | (x28 & (x18 ? new_n115_ : new_n628_)));
  ...
  assign new_n634_ = ~x19 & x21 & (new_n635_ | (~x09 & new_n436_ & ~x18));
