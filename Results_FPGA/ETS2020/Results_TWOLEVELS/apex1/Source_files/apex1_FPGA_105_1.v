...
module FAU ( 
  ...
  assign z34 = x18 ? (~new_n526_ | (~new_n515_ & x20)) : (~new_n509_ | new_n522_);
  assign new_n509_ = (new_n510_ | ~x29) & (x21 | ~x28 | x29 | new_n514_ | x30);
  assign new_n510_ = (~new_n164_ | x09) & (x30 | ((~new_n513_ | ~x19) & (x09 | ~new_n511_ | x19)));
  ...
  assign z35 = x30 ? ~new_n530_ : (new_n548_ | (~x21 & (new_n553_ | new_n555_)));
  assign new_n530_ = ~new_n546_ & (x29 | (new_n540_ & (new_n531_ | x18)));
  ...
  assign new_n535_ = (x21 | (~new_n536_ & ~x24)) & (~x00 | ~x21 | (new_n102_ & ~x22 & ~x24));
  ...
  assign new_n543_ = new_n372_ & new_n156_ & x00 & ~x05 & ~x15 & ~x19;
  ...
  assign new_n562_ = (~x19 | (~new_n563_ & (~new_n520_ | ~x20))) & (~new_n366_ | x14 | x19 | x20);
  ...
  assign new_n571_ = x20 & x25 & x29 & new_n183_ & ~x11;
  ...
  assign new_n591_ = (new_n539_ | x20) & (~x00 | ~x20 | (new_n102_ & ~x22 & ~x24));
  assign new_n592_ = ~new_n598_ & (~x20 | (~new_n596_ & (x28 | (~new_n593_ & ~new_n601_))));
  assign new_n593_ = x21 & (new_n473_ | (~x19 & (new_n595_ | (new_n594_ & x00))));
  ...
  assign new_n603_ = ~x19 & (x21 ? ~new_n418_ : (~x18 | (new_n243_ & ~x17 & x18)));
  assign new_n604_ = (~x18 | ~x19 | ~new_n207_ | x20) & (~x20 | ((~new_n393_ | x18) & (new_n605_ | ~x19)));
  assign new_n605_ = x18 ? (x21 | x27 | (~x05 & (~x00 | x05))) : (~x21 | ~x22);
  assign new_n606_ = (~x20 | ~x21 | x18 | x19) & (~x19 | (~new_n607_ & (~x18 | (x20 ? ~x21 : (new_n202_ | x21)))));
  assign new_n607_ = x28 & ((~x18 & (x21 | (x20 & ~x21 & x22))) | (~x21 & ~x27 & x18 & x20));
  ...
  assign new_n629_ = x19 & ((new_n441_ & x18) | (x28 & (x18 ? new_n115_ : new_n630_)));
  ...
  assign new_n636_ = ~x19 & x21 & (new_n637_ | (~x09 & new_n438_ & ~x18));
  ...
  assign new_n660_ = (~x18 | new_n154_ | x28) & (x19 | (x18 & (new_n314_ | x28)));
  assign new_n661_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n662_ = (x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20);
  assign new_n663_ = x21 ? new_n665_ : (~new_n664_ & (~x29 | new_n297_ | x30));
