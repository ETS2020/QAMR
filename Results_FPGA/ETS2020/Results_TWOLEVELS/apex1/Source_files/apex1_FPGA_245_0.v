...
module FAU ( 
  ...
  assign new_n354_ = ~x20 & x22 & ~x28 & new_n247_ & ~x38;
  assign new_n355_ = new_n124_ & x00 & ~x21 & x22 & x28;
  assign new_n356_ = ~x09 & ~x19 & ~x20 & x21 & new_n357_ & x22;
  assign new_n357_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n164_ | x39)))) | x38 | (~x39 & x42));
  ...
  assign new_n367_ = x26 & ((x17 & ~x30 & (x28 ^ x29)) | (~x29 & x30 & x00 & x28));
