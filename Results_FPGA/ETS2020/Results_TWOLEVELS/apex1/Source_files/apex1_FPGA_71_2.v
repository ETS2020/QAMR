// Benchmark "FAU" written by ABC on Sat Aug  1 11:08:36 2020
...
module FAU ( 
  ...
  assign z21 = ~x30 & new_n249_ & x29;
  assign new_n249_ = x28 & x26 & ~x21 & x20 & x18 & ~x19;
  ...
  assign new_n255_ = (~x19 | (x20 ? (~new_n153_ & (new_n228_ | ~x18)) : (~x22 & (~new_n153_ | ~x18)))) & (~new_n153_ | ~x18 | ~x20);
  assign new_n256_ = (x20 | ~x23) & (~x22 | ~x28 | (x02 & ~x03 & (~x02 | x03 | ~x20)));
  assign new_n257_ = (~x18 | x20 | ~x25) & (~x29 | (~new_n258_ & ~new_n260_));
  assign new_n258_ = ~x28 & (x18 ? ~new_n259_ : (new_n176_ | ~x19));
  ...
  assign new_n272_ = (~x01 | new_n143_ | ~x19) & (x19 | x28 | (~x03 & ~x05));
  assign new_n273_ = (~new_n215_ | x31) & ~x19 & ~x31 & ~x34;
  assign new_n274_ = x19 ? ~new_n275_ : ((~x20 | ~x24) & (~new_n240_ | ~x21));
  assign new_n275_ = x22 & (x21 | (x05 & x20 & ~x21 & ~x28));
  ...
  assign new_n280_ = new_n235_ & x18 & new_n129_ & ~x21;
  ...
  assign new_n288_ = ~new_n216_ & x29;
  assign new_n289_ = ~new_n143_ & ((x18 & ~x19 & x20 & ~x21) | (~x18 & new_n290_ & x19));
  assign new_n290_ = ~x28 & ~x29 & ((x20 & ~x21) | (x01 & ~x20 & x21));
  assign z26 = ~x21 & ~x28 & ~x29 & ~new_n292_ & x30;
  assign new_n292_ = (~x19 | ~x20 | (x18 ? x27 : ~x22)) & (x18 | x19 | (x20 & ~x23));
  assign z29 = x00 & ((~new_n294_ & x20) | new_n304_ | (~new_n302_ & ~x20));
  assign new_n294_ = ~new_n298_ & (x29 | (~new_n297_ & (~x30 | (~new_n295_ & ~new_n301_))));
  assign new_n295_ = x21 & ((~x19 & (new_n101_ | (~x18 & x24))) | new_n296_ | (x18 & x19));
  assign new_n296_ = new_n108_ & ~x18 & x22 & ~x28;
  assign new_n297_ = new_n114_ & x03 & ~x21 & x27 & ~x30;
  assign new_n298_ = ~x21 & ~x28 & x29 & (new_n299_ | new_n300_);
  assign new_n299_ = ~x05 & x19 & (x18 ? (~x27 & x30) : (x22 & ~x30));
  assign new_n300_ = ~x19 & ~x30 & ((~x18 & x23) | (x17 & x18 & x26));
  assign new_n301_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n302_ = (new_n303_ | x19) & (~new_n113_ | ~new_n153_ | ~x18 | ~x19 | x21);
  assign new_n303_ = (x03 | x18 | new_n118_ | x21) & (~x18 | ~x21 | ~new_n109_ | x28);
  assign new_n304_ = new_n109_ & x28 & ~x18 & x19 & x21;
  assign z31 = ~x21 & x28 & (new_n307_ | (x00 & (new_n306_ | new_n308_)));
  assign new_n306_ = new_n113_ & x22 & ~x18 & x19 & x20;
  assign new_n307_ = new_n113_ & x20 & ~x27 & new_n114_ & ~x00 & ~x04;
  assign new_n308_ = x18 & x26 & ~x29 & x30 & (x19 ^ x20);
  assign z32 = ~x30 & new_n310_ & ~x29;
  assign new_n310_ = ~x28 & ~x27 & x21 & ~x14 & ~x12 & ~x13;
  assign z35 = x30 ? (new_n340_ | (~x29 & (new_n312_ | ~new_n320_))) : ~new_n327_;
  assign new_n312_ = ~x18 & (x21 ? ~new_n313_ : (x19 ? ~new_n319_ : ~new_n316_));
  assign new_n313_ = (new_n315_ | x20) & (~x00 | ((new_n314_ | ~x20) & (~x19 | ~x28)));
  assign new_n314_ = (new_n94_ | x19) & (~x22 | (x19 & (x05 | x15 | x28)));
  assign new_n315_ = (x19 | ~x23) & (x28 | ((x09 | x19 | ~x22) & (~x01 | ~x19 | (~x22 & ~x23))));
  assign new_n316_ = (new_n317_ | ~x28) & (~x20 | ~x24) & (~x23 | x28) & (x20 | (~new_n318_ & x28));
  assign new_n317_ = (~x00 | x03 | (~x02 ^ x20)) & (x06 | ~x20 | (x02 & ~x03));
  assign new_n318_ = ~x02 & ~x03;
  assign new_n319_ = (x20 | ~x23) & (~x22 | (x28 ? new_n234_ : ~x20));
  assign new_n320_ = ~new_n326_ & (new_n323_ | ~x00) & (~x10 | new_n321_ | ~x25);
  assign new_n321_ = (x20 | x21 | ~x18 | ~x19) & (~new_n322_ | ~x21 | x28 | x19 | ~x20);
  assign new_n322_ = new_n108_ & x00;
  assign new_n323_ = (new_n324_ | x19) & (~x18 | ~x19 | ((~x20 | ~x21) & (~new_n129_ | x20 | x21)));
  assign new_n324_ = (~x20 | (~new_n325_ & (~x18 | x21 | ~x26 | ~x28))) & (~x18 | x20 | ~x21 | x28);
  assign new_n325_ = ~x05 & ~x15 & x21 & ~x28 & (x22 | x26);
  assign new_n326_ = ~x21 & ((x18 & ((new_n153_ & x20) | (x19 & (x20 | (new_n153_ & ~x20))))) | (x19 & ~x20 & x22));
  assign new_n327_ = (x21 | (~new_n328_ & ~new_n331_)) & (~x29 | (~new_n339_ & (new_n336_ | ~x21)));
  assign new_n328_ = ~x03 & (new_n329_ | (new_n330_ & x00 & ~x05 & ~x18));
  assign new_n329_ = new_n114_ & x20 & x27 & ~x29;
  assign new_n330_ = ~x28 & x29 & ~x19 & ~x20;
  assign new_n331_ = x29 & ((~new_n332_ & x00) | (new_n335_ & ~x00 & ~x04 & x18));
  assign new_n332_ = (~x20 | ((new_n333_ | x18) & (~new_n153_ | ~x18 | x19))) & (~x18 | ~x19 | new_n334_ | x20);
  assign new_n333_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n334_ = ~x22 & (~x10 | ~x25) & (~x26 | x28);
  assign new_n335_ = new_n152_ & x19 & x20;
  assign new_n336_ = (~x18 | (x19 ? ~x20 : (x20 | x28))) & (new_n337_ | x28) & (x18 | (x19 ? ~x28 : ~x20));
  assign new_n337_ = (x19 | new_n164_ | ~x20) & (~x22 | (~new_n338_ & ~x20));
  assign new_n338_ = ~x09 & ~x19 & ~x38 & x39 & ~x41 & x42;
  assign new_n339_ = x18 & x19 & x20 & ~x27 & (~x28 | (x04 & x28));
  assign new_n340_ = x19 & x20 & new_n341_ & ~x21;
  assign new_n341_ = x29 & ((~x18 & x22 & x28) | (~x27 & ~x28 & x05 & x18));
  assign z36 = (~new_n360_ & x21) | (~x30 & (~new_n351_ | (~new_n343_ & ~x21)));
  assign new_n343_ = ~new_n328_ & ~new_n331_ & ~new_n344_;
  assign new_n344_ = ~x29 & (~new_n347_ | (x18 & (x19 ? ~new_n350_ : ~new_n345_)));
  assign new_n345_ = (~new_n129_ | ~x17 | ~x20) & (~new_n346_ | x14 | x20);
  assign new_n346_ = ~x27 & ~x28;
  assign new_n347_ = ~new_n349_ & (x14 | new_n348_ | x27);
  assign new_n348_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n349_ = ~x18 & x28 & (~x19 | (x20 & x22));
  assign new_n350_ = x20 ? ((x27 | ~x28) & (~x00 | ~x03 | ~x27)) : (~x26 | ~x28);
  assign new_n351_ = (~new_n355_ | ~x19) & (~x21 | (x29 ? new_n352_ : new_n358_));
  assign new_n352_ = (x19 | ((new_n353_ | x28) & (x18 | ~x20))) & (~x20 | ~x22 | x28) & (~x19 | (x18 ? ~x20 : ~x28));
  assign new_n353_ = (~new_n354_ | x09) & (new_n164_ | ~x20) & (~x18 | x20);
  assign new_n354_ = x22 & ~x38 & ~x41 & (x39 ? x42 : (x40 & ~x42));
  assign new_n355_ = x20 & ((new_n356_ & ~x18) | (x18 & ~x27 & ~x28 & x29));
  assign new_n356_ = x22 & x28 & ~new_n357_ & ~x29;
  assign new_n357_ = x16 ? x08 : x07;
  assign new_n358_ = ~new_n359_ & (x20 | ~x28 | ~x18 | x19);
  assign new_n359_ = ~x12 & ~x13 & ~x14 & ~x27 & ~x28;
  assign new_n360_ = (new_n361_ | x28) & (~x18 | x19 | ~x20 | new_n357_ | ~x28);
  assign new_n361_ = ~new_n364_ & (x29 | ~x30 | (~new_n363_ & (new_n362_ | x18)));
  assign new_n362_ = (new_n94_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
  assign new_n363_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n364_ = x20 & x25 & x29 & ~x11 & x18 & ~x19;
  assign z37 = ~new_n395_ | (x30 & (new_n289_ | ~new_n381_ | (~new_n366_ & ~x29)));
  assign new_n366_ = (x18 | (x21 ? new_n370_ : new_n367_)) & new_n378_ & (new_n374_ | ~x18);
  assign new_n367_ = (new_n369_ | ~x28) & (new_n368_ | x19) & (~x23 | (x19 ? x20 : x28));
  assign new_n368_ = x20 ? (~x22 & ~x24 & ~x26) : (~new_n318_ & x28);
  assign new_n369_ = (~x02 | x03 | ((~x19 | ~x20 | ~x22) & (~x00 | x19 | x20))) & ((x02 & ~x03) | (x19 ? ~x22 : ~x20));
  assign new_n370_ = (~x20 | (~new_n371_ & ~new_n372_)) & (new_n373_ | ~x19) & (x19 | x20 | ~x23);
  assign new_n371_ = x00 & ~new_n94_ & ~x19;
  assign new_n372_ = x22 & ((x00 & (~x19 | (~x05 & ~x15 & ~x28))) | (x19 & ~x28 & (x05 | (~x05 & x15))));
  assign new_n373_ = x28 ? ~x00 : (~x25 & ~x24 & ~x26);
  assign new_n374_ = (new_n375_ | ~x20) & (new_n377_ | x20) & (~x19 | ~x22);
  assign new_n375_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21) & (x28 | ((x21 | ~x26) & (x19 | new_n376_ | ~x21)));
  assign new_n376_ = x05 ? (~x10 & x25) : ~x15;
  assign new_n377_ = (~x00 | ((~x26 | ~x28 | ~x19 | x21) & (x19 | ~x21 | x28))) & (x19 | ~x21 | ~x28) & (~x26 | x28 | ~x19 | x21);
  assign new_n378_ = ~new_n379_ & (~x19 | x21 | (x20 ? ~new_n153_ : ~x22));
  assign new_n379_ = x00 & ~x05 & ~x15 & ~x19 & new_n380_ & x20;
  assign new_n380_ = x21 & ~x28 & (x22 | x26 | (x10 & x25));
  assign new_n381_ = new_n386_ & (x28 | (new_n393_ & (~x20 | (new_n382_ & ~new_n390_))));
  assign new_n382_ = ~new_n383_ & (~x29 | (~new_n385_ & (x18 | x21 | ~x22)));
  assign new_n383_ = x05 & (new_n384_ | (~x10 & ~x19 & x21 & x25));
  assign new_n384_ = x18 & x19 & ~x21 & ~x27 & x29;
  assign new_n385_ = ~x19 & ((x21 & (x25 | x26)) | (~x17 & x18 & ~x21 & x26));
  assign new_n386_ = (new_n387_ | ~x18) & (new_n389_ | ~x22);
  assign new_n387_ = (x20 | ~x25 | (~x19 & x21)) & (~x19 | ((~x21 | ~x26) & (~new_n388_ | ~x20 | x21)));
  assign new_n388_ = ~x27 & x28 & x29;
  assign new_n389_ = (x20 | ((~x21 | ~x28 | x18 | x19) & (~x18 | (x21 & (~x19 | ~x21))))) & (x21 | ~x28 | ~x29 | x18 | ~x19 | ~x20);
  assign new_n390_ = x00 & (new_n391_ | (new_n392_ & new_n114_ & ~x05));
  assign new_n391_ = ~x10 & ~x15 & ~x19 & x21 & x25;
  assign new_n392_ = ~x21 & ~x27 & x29;
  assign new_n393_ = (~new_n394_ | x18) & (~new_n235_ | ~x18 | x21 | ~x26 | ~x29);
  assign new_n394_ = ~x19 & ((~x21 & x29) | (~x20 & x22));
  assign new_n395_ = ~new_n414_ & (x30 | (x29 ? (~new_n396_ & new_n402_) : new_n407_));
  assign new_n396_ = ~x21 & (x18 ? (new_n401_ | (~new_n400_ & x19)) : ~new_n397_);
  assign new_n397_ = x19 ? (~new_n398_ & (~x01 | x20 | ~x23)) : new_n399_;
  assign new_n398_ = x22 & (x20 ? ((x05 & ~x28) | (x00 & (x28 | (~x05 & ~x28)))) : x01);
  assign new_n399_ = ~x28 & (x28 | ((~x00 | ((~x20 | ~x23) & (x03 | x05 | x20))) & (x20 | (~x03 & ~x05))));
  assign new_n400_ = (~x00 | x20 | (~new_n117_ & ~x22)) & (x00 | x04 | ~new_n152_ | ~x20);
  assign new_n401_ = x26 & ((x17 & ~x19 & x20 & ~x28) | ((x28 | (x00 & ~x28)) & (~x19 ^ ~x20)));
  assign new_n402_ = ~new_n403_ & (~x21 | (~new_n406_ & (x09 | ~new_n277_ | x19)));
  assign new_n403_ = x20 & (new_n404_ | ~new_n405_);
  assign new_n404_ = ~x28 & (x19 ? x18 : (x21 & (x25 | x26)));
  assign new_n405_ = (x18 | x19 | ~x24) & (~x04 | ~x18 | ~x19 | x27 | ~x28);
  assign new_n406_ = ~x18 & ((~x20 & x23) | (x19 & x22));
  assign new_n407_ = (new_n358_ | ~x21) & new_n412_ & (x21 | (new_n410_ & (new_n408_ | x19)));
  assign new_n408_ = ~new_n409_ & (~x28 | (x18 & (~x20 | ~x26 | ~x17 | ~x18)));
  assign new_n409_ = ~x14 & ~x27 & (x18 ? (~x20 & ~x28) : (x20 & ~x23));
  assign new_n410_ = (~x18 | new_n411_ | ~x19) & (~new_n346_ | ~x13 | x14);
  assign new_n411_ = x20 ? (x27 ? (x03 & (~x00 | ~x03)) : ~x28) : (~x26 | ~x28);
  assign new_n412_ = (~new_n346_ | ~x14) & (~new_n413_ | x18 | ~x19);
  assign new_n413_ = x20 & x22 & x28;
  assign new_n414_ = x21 & (new_n288_ | new_n415_);
  assign new_n415_ = ~x19 & x20 & ((x18 & x28) | (~x10 & ~x18 & x25));
  assign z38 = new_n430_ | (~x00 & ((~new_n417_ & ~x29) | (~x21 & ~new_n425_ & x29)));
  assign new_n417_ = ~new_n424_ & (new_n418_ | ~x30);
  assign new_n418_ = (x19 | (x18 ? new_n421_ : new_n419_)) & ~new_n423_ & (new_n422_ | ~x19);
  assign new_n419_ = (~x20 | new_n420_ | ~x21) & (x03 | x21 | ~x28 | (~x02 ^ ~x20));
  assign new_n420_ = ~x22 & ~x24 & ~x25 & ~x26;
  assign new_n421_ = (~x21 | x28 | (~new_n108_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n422_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n423_ = ~x05 & ~x15 & ~x18 & x20 & x21 & x22;
  assign new_n424_ = new_n114_ & x03 & x20 & ~x21 & x27;
  assign new_n425_ = ~new_n429_ & (x30 | (x18 ? new_n426_ : new_n427_));
  assign new_n426_ = (~x19 | new_n181_ | x20) & (~x20 | ((~new_n153_ | x19) & (~new_n152_ | x04 | ~x19)));
  assign new_n427_ = ~new_n428_ & (~x20 | (x19 ? (~x22 | ~x28) : (~x23 | x28)));
  assign new_n428_ = ~x05 & ((x19 & x20 & x22) | (~x03 & ~x19 & ~x20 & ~x28));
  assign new_n429_ = new_n114_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n430_ = ~x01 & ~x18 & x19 & new_n142_ & ~x20;
  assign z39 = (~new_n438_ & x29) | (x19 & (x18 ? ~new_n432_ : ~new_n435_));
  assign new_n432_ = (new_n433_ | ~x29) & (~x27 | x29 | ~x30 | ~x20 | x21);
  assign new_n433_ = (new_n434_ | x30) & (x20 | x21 | new_n206_ | ~x30);
  assign new_n434_ = (~new_n129_ | x20 | x21) & (~x20 | (~x21 & (~new_n152_ | ~x04)));
  assign new_n435_ = x21 ? new_n238_ : (~new_n436_ & (~x29 | new_n437_ | x30));
  assign new_n436_ = x02 & ~x03 & x20 & new_n109_ & x22 & x28;
  assign new_n437_ = (~x01 | x20 | (~x22 & ~x23)) & (~x05 | ~x20 | ~x22 | x28);
  assign new_n438_ = ~new_n441_ & (x19 | ((new_n439_ | x30) & (~new_n440_ | ~x20)));
  assign new_n439_ = (~x18 | ((x20 | ~x21 | x28) & (~x26 | ~x28 | ~x20 | x21))) & (x18 | (x21 ? ~x20 : ~x28)) & (~x20 | ~x21 | x28 | (~x25 & ~x26));
  assign new_n440_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n441_ = x20 & x21 & x22 & ~x28 & ~x30;
  assign z40 = ~x28 & ((x05 & new_n444_ & x18) | (~x18 & (new_n443_ | (~new_n446_ & x05))));
  assign new_n443_ = new_n113_ & ~x21 & x03 & ~x19 & ~x20;
  assign new_n444_ = x20 & ~new_n445_ & x30;
  assign new_n445_ = (x19 | ~x21 | x29 | (~x10 & x25)) & (x27 | ~x29 | ~x19 | x21);
  assign new_n446_ = (~x19 | ~x20 | ~x22 | (x21 ? (x29 | ~x30) : (~x29 | x30))) & (x19 | x20 | x21 | ~x29 | x30);
  assign z43 = ~x18 & new_n448_ & ~x19;
  assign new_n448_ = x20 & ~x21 & ~x29 & x30 & (x22 | x24);
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
