// Benchmark "FAU" written by ABC on Sat Aug  1 11:08:53 2020
...
module FAU ( 
  ...
  assign new_n198_ = x26 & ~x28 & ~x17 & ~x19;
  ...
  assign new_n209_ = ~x20 & x21 & ~new_n94_ & x30;
  ...
  assign z15 = (~x21 & (x29 ? ~new_n261_ : ~new_n285_)) | new_n292_ | (~new_n270_ & x21);
  ...
  assign new_n285_ = (~x18 | ~new_n291_ | ~x19) & (~x30 | (x18 ? new_n290_ : new_n286_));
  assign new_n286_ = x19 ? ~new_n289_ : (~new_n287_ & ~new_n288_);
  assign new_n287_ = x20 & x24;
  assign new_n288_ = x28 & ((x00 & ~x03 & (x02 ^ x20)) | (x06 & x20 & (~x02 | x03)));
  assign new_n289_ = x22 & (~x20 | (x02 & ~x03 & x20 & x28));
  assign new_n290_ = (~x19 | (x20 ? ~x27 : ~new_n156_)) & (~new_n156_ | ~x20 | ~x17 | x19);
  assign new_n291_ = x20 & ~x30 & ((~x27 & x28) | (x00 & x03 & x27));
  assign new_n292_ = ~x28 & ~new_n293_ & ~x30;
  assign new_n293_ = (~x14 | x27 | x29) & (~new_n114_ | ~x20 | ~x27 | ~x29);
  ...
  assign new_n297_ = (~x01 | new_n149_ | x20) & (~new_n109_ | ~x05 | ~x20);
  ...
  assign new_n304_ = x18 & ~x20 & ((~new_n118_ & x30) | (x26 & (x28 ^ x30)));
  ...
  assign new_n308_ = ~x29 & (x18 ? (new_n156_ & x20) : (new_n288_ | (x20 & x22)));
  assign new_n309_ = x18 & x20 & (x22 | (new_n253_ & ~x17 & x26));
  assign new_n310_ = ~x18 & ~x20 & ~x28 & ~new_n269_ & x29;
  assign new_n311_ = x18 ? (~x26 | ~x28 | (~x29 & (~x17 | x29))) : (~x24 | ~x29);
  assign new_n312_ = (~new_n316_ | x18) & (~x29 | ((~new_n315_ | x18) & (new_n313_ | x30)));
  assign new_n313_ = (x28 | (~new_n231_ & (new_n314_ | ~x20))) & (x18 | ~x20 | ~x26);
  assign new_n314_ = ~x26 & (~x11 | ~x18 | ~x25);
  assign new_n315_ = ~x20 & x22 & ~x28 & (x30 | (~new_n165_ & ~x09));
  ...
  assign new_n326_ = ~x30 & (new_n327_ | (x18 & ~new_n154_ & x20));
  ...
  assign new_n333_ = x18 ? (~new_n336_ & (~new_n135_ | ~x27 | ~x30)) : (new_n334_ | ~x30);
  assign new_n334_ = x19 ? new_n335_ : ~new_n287_;
  ...
  assign new_n341_ = x30 & ((x22 & (x18 ? x19 : (~x19 & x28))) | (x18 & ~new_n94_ & x19));
  assign new_n342_ = ~new_n343_ & ~new_n149_;
  assign new_n343_ = (x18 | ~x19 | x20 | ~new_n344_ | ~x21) & (~x20 | x21 | ~x30 | ~x18 | x19);
  assign new_n344_ = ~x28 & ((x29 & ~x30) | (x01 & ~x29 & x30));
  assign new_n345_ = x30 ? new_n160_ : new_n346_;
  ...
  assign new_n349_ = (~x20 | ~x26 | ~new_n110_ | x28) & (new_n149_ | ((~new_n110_ | ~x20 | x28) & (x20 | (~new_n350_ & ~new_n110_))));
  assign new_n350_ = new_n113_ & x01;
  ...
  assign new_n364_ = (new_n365_ | ~x29) & (~new_n233_ | ~new_n366_);
  assign new_n365_ = (~x18 | x19 | x20 | x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n154_ | x28)));
  assign new_n366_ = ~x27 & ~x28 & ~x29;
  assign new_n367_ = ~x19 & ~x20 & ~x29 & x30 & (x28 | (x00 & ~x28));
  assign z19 = (~new_n369_ & x18) | ~new_n387_ | (~x19 & (new_n382_ | (new_n395_ & ~x18)));
  assign new_n369_ = ~new_n379_ & ~new_n370_ & ~new_n373_ & ~new_n380_ & (~new_n381_ | ~x29);
  assign new_n370_ = x25 & (new_n371_ | (new_n141_ & new_n372_ & ~x11));
  assign new_n371_ = new_n110_ & ~x21 & new_n251_ & x10;
  ...
  assign new_n377_ = ~x19 & ((x23 & x30) | (new_n141_ & x17 & x26));
  assign new_n378_ = x19 & ~x20 & x26 & (x28 ? (~x29 & ~x30) : x30);
  assign new_n379_ = x22 & ((new_n141_ & x20 & x21) | (x19 & ~x20 & new_n110_ & ~x21));
  assign new_n380_ = new_n110_ & x21 & ~x28 & x00 & ~x19 & ~x20;
  assign new_n381_ = ~x30 & ((~x19 & ~x20 & x21 & ~x28) | (x19 & x20 & (x21 | (x27 & ~x28))));
  assign new_n382_ = x29 & (new_n383_ | (new_n372_ & new_n340_ & x26));
  assign new_n383_ = ~x18 & ((~x21 & ~x28 & x30) | (~x30 & (new_n384_ | (~x21 & (new_n287_ | x28)))));
  assign new_n384_ = x21 & (x20 | new_n386_ | ((new_n385_ | (new_n275_ & new_n276_)) & ~x20));
  assign new_n385_ = ~x33 & ~x34 & x35 & x23 & ~x31 & ~x32;
  assign new_n386_ = x23 & ~x31 & (x32 | x33);
  assign new_n387_ = (new_n388_ | x18) & (~new_n113_ | ~x22 | ~new_n372_ | ~x19);
  ...
  assign new_n395_ = ~new_n396_ & x30;
  ...
  assign new_n400_ = x28 & x26 & ~x21 & new_n183_ & x20;
  assign z22 = (~new_n402_ & x30) | new_n436_ | (~x30 & (x29 ? ~new_n423_ : ~new_n439_));
  assign new_n402_ = ~new_n217_ & (new_n403_ | x21) & (~x21 | (x19 ? new_n420_ : new_n412_));
  assign new_n403_ = (x29 | (x18 ? new_n407_ : new_n404_)) & (new_n409_ | ~x18) & (x18 | new_n411_ | ~x29);
  assign new_n404_ = x19 ? ~new_n406_ : (~new_n288_ & new_n405_);
  ...
  assign new_n409_ = x19 ? (~x29 | (~new_n299_ & (new_n264_ | x20))) : new_n410_;
  ...
  assign new_n423_ = (x18 | (new_n433_ & (new_n424_ | x20))) & ~new_n155_ & (new_n429_ | ~x18);
  assign new_n424_ = ~new_n193_ & ~new_n428_ & (x19 | (~new_n427_ & (new_n425_ | x28)));
  assign new_n425_ = (new_n269_ | x21) & (x09 | ~x21 | ~x22 | ~new_n426_ | x38);
  assign new_n426_ = ~x41 & (x39 ? x42 : (~x42 & (x40 | (~x40 & (x43 ^ x44)))));
  assign new_n427_ = x21 & x23 & new_n362_ & ~x31;
  assign new_n428_ = new_n328_ & x22 & ~x28 & ~x38 & ~x09 & x21;
  assign new_n429_ = x20 ? new_n430_ : ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28));
  assign new_n430_ = new_n432_ & (x28 | ((new_n431_ | x19) & (new_n154_ | ~x21) & (~x19 | x21)));
  assign new_n431_ = (~x11 | ~x21 | ~x25) & (~x17 | x21 | ~x26);
  assign new_n432_ = (~x19 | (~x21 & (x27 | ~x28 | ~x04 | x21))) & (x19 | x21 | ~x26 | ~x28);
  ...
  assign new_n436_ = ~x18 & new_n437_ & ~x19;
  assign new_n437_ = x21 & ((new_n438_ & ~x09) | (~x10 & x20 & x25));
  assign new_n438_ = ~x20 & x22 & ~x28 & ~new_n165_ & x29;
  ...
  assign new_n454_ = x30 & (x20 ? ~new_n149_ : ~new_n202_);
  ...
  assign new_n464_ = (~x28 | x29 | new_n465_ | ~x30) & (x20 | x28 | ~x29 | new_n269_ | x30);
  ...
  assign z28 = (x21 & (~new_n478_ | (~new_n470_ & x30))) | (~x19 & ~new_n485_ & ~x21);
  assign new_n470_ = (new_n471_ | ~x20) & (~x19 | (~new_n421_ & new_n476_)) & (x19 | ~new_n477_ | x20);
  assign new_n471_ = new_n475_ & (x28 | (~new_n474_ & (new_n472_ | x29)));
  assign new_n472_ = ~new_n473_ & (~x00 | x10 | x15 | x19 | ~x25);
  assign new_n473_ = x05 & (x19 ? x22 : x18);
  assign new_n474_ = x11 & ~x19 & x29 & (x25 | x26);
  assign new_n475_ = x18 ? (~x19 | (~x22 & ~x29)) : (x19 | ~x29);
  assign new_n476_ = x18 ? (x20 | (~x22 & ~x26)) : (~x28 | ~x29);
  assign new_n477_ = x28 & (x18 ? ~x29 : x22);
  ...
  assign new_n488_ = (~new_n143_ | x21 | ~x27 | x30) & (~x30 | (~new_n490_ & (new_n489_ | ~x21)));
  assign new_n489_ = x19 ? (~x18 & (~new_n108_ | ~new_n109_ | x18)) : (~new_n102_ & (x18 | ~x24));
  assign new_n490_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n491_ = (new_n492_ | x20) & (~new_n140_ | x18 | ~x19 | ~x21);
  assign new_n492_ = (new_n493_ | x19) & (~new_n113_ | ~new_n156_ | ~x18 | ~x19 | x21);
  assign new_n493_ = (x03 | x18 | new_n119_ | x21) & (~new_n110_ | x28 | ~x18 | ~x21);
  ...
  assign new_n498_ = (new_n499_ | ~x00) & (~new_n135_ | ~new_n249_ | x00 | x04 | ~x18);
  assign new_n499_ = (new_n500_ | ~x20) & (~x18 | ~x19 | new_n118_ | x20);
  assign new_n500_ = (x18 | ~x19 | ~x22 | ~x28) & (x17 | ~x18 | x19 | ~x26 | x28);
  assign z31 = ~x21 & x28 & (new_n504_ | (~new_n502_ & x00));
  assign new_n502_ = (~new_n503_ | ~x18) & (~new_n135_ | x18 | ~new_n113_ | ~x22);
  assign new_n503_ = x26 & ~x29 & x30 & (x19 ^ x20);
  assign new_n504_ = new_n114_ & ~x00 & ~x04 & new_n113_ & x20 & ~x27;
  assign z32 = ~x30 & new_n506_ & ~x29;
  assign new_n506_ = ~x28 & ~x27 & x21 & new_n507_ & ~x14;
  ...
  assign z34 = x18 ? (~new_n530_ | (~new_n518_ & x20)) : (~new_n512_ | new_n525_);
  assign new_n512_ = (new_n513_ | ~x29) & (x21 | ~x28 | x29 | new_n517_ | x30);
  assign new_n513_ = (~new_n164_ | x09) & (x30 | ((~new_n516_ | ~x19) & (x09 | ~new_n514_ | x19)));
  ...
  assign new_n518_ = (new_n519_ | x21) & (x11 | x19 | ~new_n524_ | ~x21);
  assign new_n519_ = x30 ? new_n520_ : new_n522_;
  assign new_n520_ = (new_n521_ | ~x00) & (~x19 | x27 | ~x28 | x29);
  assign new_n521_ = (x19 | ~x26 | ~x28 | x29) & (x05 | ~x19 | x27 | x28 | ~x29);
  assign new_n522_ = (~new_n523_ | ~x19) & (~x17 | x19 | ~x26 | (~x28 ^ x29));
  assign new_n523_ = ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n524_ = ~x28 & x29 & x30 & (x25 | x26);
  assign new_n525_ = x30 & ((~new_n529_ & ~x28) | (~new_n526_ & ~x29));
  assign new_n526_ = (~x28 | ((new_n527_ | x21) & (~x00 | ~x19 | ~x21))) & (~x19 | ~x21 | new_n528_ | x28);
  assign new_n527_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n528_ = ~x24 & ~x26 & (~x10 | ~x25);
  assign new_n529_ = (~x22 | ((~x21 | (x19 ? (~x20 | ~x29) : (x20 | (~x09 & ~x29)))) & (~x20 | x21 | ~x29))) & (x19 | x21 | ~x29);
  assign new_n530_ = (~new_n392_ | ~new_n137_ | x19) & (new_n531_ | x20);
  assign new_n531_ = ~new_n532_ & (~new_n110_ | ~new_n130_ | ~x00 | ~x19 | x21);
  assign new_n532_ = (x28 ? (~x29 & ~x30) : (x29 & x30)) & (x19 ? (~x21 & x26) : x21);
  assign z35 = x30 ? ~new_n534_ : (new_n552_ | (~x21 & (new_n557_ | new_n559_)));
  assign new_n534_ = ~new_n550_ & (x29 | (new_n544_ & (new_n535_ | x18)));
  assign new_n535_ = x19 ? new_n536_ : (new_n541_ & (new_n539_ | ~x20));
  assign new_n536_ = x21 ? (~new_n537_ & (~x01 | ~new_n168_ | x20)) : new_n538_;
  assign new_n537_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n538_ = x20 ? (~x22 | (x28 & (~x28 | (x02 & ~x03)))) : (~x22 & ~x23);
  assign new_n539_ = (x21 | (~new_n540_ & ~x24)) & (~x00 | ~x21 | (new_n94_ & ~x22 & ~x24));
  ...
  assign new_n544_ = (new_n545_ | new_n118_) & ~new_n547_ & (~x18 | (~new_n548_ & ~new_n549_));
  assign new_n545_ = ~new_n546_ & (~new_n108_ | ~x00 | ~new_n252_ | ~x21 | x28);
  assign new_n546_ = x18 & x19 & ~x20 & ~x21;
  assign new_n547_ = new_n372_ & new_n156_ & x00 & ~x05 & ~x15 & ~x19;
  ...
  assign new_n552_ = x29 & (new_n556_ | (x21 & (~new_n555_ | (~new_n553_ & ~x19))));
  assign new_n553_ = (x18 | ~x20) & (x28 | (new_n554_ & (~x18 | (x20 & (~x11 | ~x20 | ~x25)))));
  assign new_n554_ = ~new_n243_ & (~new_n257_ | x41 | ~x42 | x38 | ~x39);
  assign new_n555_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n154_ | x28)));
  assign new_n556_ = new_n114_ & x20 & ~x27 & ~x28;
  assign new_n557_ = ~x03 & (new_n558_ | (new_n114_ & x20 & x27 & ~x29));
  assign new_n558_ = x00 & ~x05 & ~x18 & new_n253_ & ~x19 & ~x20;
  assign new_n559_ = x29 & ((x00 & new_n561_ & ~x18) | (x18 & (new_n563_ | (~new_n560_ & x00))));
  assign new_n560_ = (~x19 | new_n118_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n561_ = ~new_n562_ & x20;
  assign new_n562_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n563_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign z36 = (~new_n572_ & x21) | (~x30 & ((~new_n565_ & ~x21) | new_n582_ | (~new_n578_ & x21)));
  assign new_n565_ = ~new_n557_ & new_n568_ & (~x18 | (new_n566_ & (new_n571_ | ~x26)));
  assign new_n566_ = (~x19 | (~new_n567_ & (~new_n523_ | ~x20))) & (~new_n366_ | x14 | x19 | x20);
  assign new_n567_ = x00 & ((~x20 & ~new_n118_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n568_ = (new_n569_ | x29) & (~x00 | x18 | ~x20 | new_n562_ | ~x29);
  assign new_n569_ = (x14 | new_n570_ | x27) & (x18 | new_n517_ | ~x28);
  ...
  assign new_n574_ = (new_n528_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
  assign new_n575_ = new_n183_ & ~x11 & x20 & x25 & x29;
  assign new_n576_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n577_ = x16 ? x08 : x07;
  assign new_n578_ = x29 ? (new_n555_ & (new_n579_ | x19)) : new_n581_;
  assign new_n579_ = (x18 | ~x20) & (x28 | (x20 ? new_n314_ : (~x18 & (x09 | ~new_n580_ | x18))));
  assign new_n580_ = x22 & ~x38 & ~x41 & (x39 ? x42 : (x40 & ~x42));
  assign new_n581_ = (~new_n183_ | x20 | ~x28) & (~new_n507_ | x14 | x27 | x28);
  assign new_n582_ = x19 & x20 & ((new_n583_ & ~x18) | (new_n253_ & x18 & ~x27));
  assign new_n583_ = x22 & x28 & ~new_n577_ & ~x29;
  assign z37 = (~new_n585_ & x30) | new_n639_ | (~x30 & (x29 ? ~new_n615_ : ~new_n631_));
  assign new_n585_ = ~new_n217_ & new_n605_ & (x29 | (~new_n586_ & new_n595_));
  ...
  assign new_n592_ = ~new_n537_ & (x28 | (new_n593_ & ~x25));
  assign new_n593_ = (x05 | ~x15 | ~x20 | ~x22) & ~x24 & ~x26;
  assign new_n594_ = (new_n543_ | x20) & (~x00 | ~x20 | (new_n94_ & ~x22 & ~x24));
  assign new_n595_ = ~new_n601_ & (~x20 | (~new_n599_ & (x28 | (~new_n596_ & ~new_n604_))));
  assign new_n596_ = x21 & (new_n473_ | (~x19 & (new_n598_ | (new_n597_ & x00))));
  assign new_n597_ = ~x15 & ((x25 & (~x10 | (~x05 & x10))) | (~x05 & (x22 | x26)));
  assign new_n598_ = ~x05 & x15 & x18;
  assign new_n599_ = ~new_n600_ & x18;
  assign new_n600_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21 | (~x27 & (x27 | ~x28)));
  assign new_n601_ = x18 & ~x20 & (new_n602_ | ~new_n603_);
  assign new_n602_ = x00 & ((x26 & x28 & x19 & ~x21) | (~x19 & x21 & ~x28));
  assign new_n603_ = (x19 | ~x21 | ~x28) & (x21 | (~x25 & (~x19 | (~x22 & (~x26 | x28)))));
  assign new_n604_ = x18 & ~x21 & (x19 ? ~x27 : x26);
  assign new_n605_ = new_n611_ & (~x29 | (new_n609_ & (x28 | (~new_n606_ & new_n607_))));
  assign new_n606_ = ~x19 & (x21 ? ~new_n418_ : (~x18 | (new_n243_ & ~x17 & x18)));
  assign new_n607_ = (~new_n207_ | x20 | ~x18 | ~x19) & (~x20 | ((~new_n393_ | x18) & (new_n608_ | ~x19)));
  assign new_n608_ = x18 ? (x21 | x27 | (~x05 & (~x00 | x05))) : (~x21 | ~x22);
  assign new_n609_ = (~x20 | ~x21 | x18 | x19) & (~x19 | (~new_n610_ & (~x18 | (x20 ? ~x21 : (new_n202_ | x21)))));
  ...
  assign new_n615_ = new_n620_ & (x18 | (new_n628_ & (x20 | (new_n616_ & ~new_n193_))));
  assign new_n616_ = (x19 | ~x21 | ~x23) & (x28 | (~new_n617_ & (x19 | new_n619_ | x21)));
  ...
  assign new_n620_ = ~new_n155_ & (~x18 | (~new_n627_ & (new_n626_ | x20) & (new_n621_ | ~x20)));
  assign new_n621_ = ~new_n622_ & ~new_n625_ & (x28 | (~new_n623_ & ~new_n624_));
  assign new_n622_ = x26 & x28 & ~x19 & ~x21;
  ...
  assign new_n626_ = x19 ? (x21 | ((~x26 | ~x28) & (~x00 | (~new_n133_ & (~x26 | x28))))) : (~x21 | x28);
  ...
  assign new_n632_ = x19 & ((new_n441_ & x18) | (x28 & (x18 ? new_n115_ : new_n633_)));
  assign new_n633_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n634_ = (new_n635_ | x18) & (~x17 | ~x18 | ~new_n130_ | x19);
  assign new_n635_ = (~x22 | ~x28) & (x23 | x27 | x14 | x19);
  ...
  assign new_n639_ = ~x19 & x21 & (new_n640_ | (~x09 & new_n438_ & ~x18));
  ...
  assign new_n646_ = (~x21 | x28 | (~new_n108_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n647_ = new_n137_ & x20 & ~x05 & ~x15 & ~x18;
  assign new_n648_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n649_ = new_n143_ & x20 & ~x21 & x27;
  ...
  assign new_n653_ = (~x19 | new_n264_ | x20) & (~x20 | ((~new_n156_ | x19) & (~new_n249_ | x04 | ~x19)));
  assign new_n654_ = new_n114_ & ~x05 & new_n171_ & x20 & ~x27;
  assign new_n655_ = ~x20 & ~new_n149_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n661_ & x29) | (x19 & (~new_n657_ | (~new_n666_ & ~x18)));
  assign new_n657_ = (~new_n169_ | ~x27 | x29 | ~x30) & (~x29 | (~new_n660_ & (new_n658_ | x30)));
  assign new_n658_ = (new_n659_ | ~x20) & (~x18 | x20 | ~new_n130_ | x21);
  assign new_n659_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n249_ | ~x04 | x21)));
  assign new_n660_ = x18 & ~x20 & ~x21 & ~new_n202_ & x30;
  assign new_n661_ = (~x20 | ((~new_n664_ | x19) & (new_n662_ | x30))) & (x19 | new_n665_ | x30);
  assign new_n662_ = (new_n663_ | ~x21) & (~new_n183_ | ~new_n130_ | x21);
  assign new_n663_ = (~x18 | new_n154_ | x28) & (x19 | (x18 & (new_n314_ | x28)));
  assign new_n664_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n665_ = (x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20);
  assign new_n666_ = x21 ? new_n668_ : (~new_n667_ & (~x29 | new_n297_ | x30));
  assign new_n667_ = x02 & ~x03 & x20 & new_n110_ & x22 & x28;
  assign new_n668_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n149_ | ~x30);
