// Benchmark "FAU" written by ABC on Sat Aug  1 11:11:07 2020
...
module FAU ( 
  ...
  assign new_n302_ = x30 & (x20 ? ~new_n108_ : ~new_n119_);
  ...
  assign new_n310_ = (~x28 | x29 | new_n213_ | ~x30) & (x20 | x28 | ~x29 | new_n196_ | x30);
  ...
  assign new_n323_ = ~x20 & (new_n324_ | (~x18 & (new_n325_ | (new_n254_ & new_n326_))));
  assign new_n324_ = new_n167_ & x28 & ~x29 & x30;
  assign new_n325_ = ~x19 & ((x23 & x29 & ~x30) | (x22 & x28 & x30));
  assign new_n326_ = x29 & ~x30 & ~x38 & ~x09 & x22 & ~x28;
  assign new_n327_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n108_ & ~x30;
  ...
  assign new_n333_ = (new_n334_ | ~x00) & (~new_n124_ | ~new_n126_ | x00 | x04 | ~x18);
  assign new_n334_ = (new_n335_ | ~x20) & (~x18 | ~x19 | new_n230_ | x20);
  ...
  assign new_n346_ = ~x20 & x22 & ~x28 & new_n247_ & ~x38;
  assign new_n347_ = new_n124_ & x00 & ~x21 & x22 & x28;
  assign new_n348_ = ~x09 & ~x19 & ~x20 & x21 & new_n349_ & x22;
  assign new_n349_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n164_ | x39)))) | x38 | (~x39 & x42));
