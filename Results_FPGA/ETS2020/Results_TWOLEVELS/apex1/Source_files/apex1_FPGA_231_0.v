// Benchmark "FAU" written by ABC on Sat Aug  1 11:15:06 2020
...
module FAU ( 
  ...
  assign new_n304_ = x30 & (x20 ? ~new_n106_ : ~new_n117_);
  ...
  assign new_n312_ = (~x28 | x29 | new_n211_ | ~x30) & (x20 | x28 | ~x29 | new_n194_ | x30);
  ...
  assign new_n325_ = ~x20 & (new_n326_ | (~x18 & (new_n327_ | (new_n252_ & new_n328_))));
  assign new_n326_ = new_n165_ & x28 & ~x29 & x30;
  assign new_n327_ = ~x19 & ((x23 & x29 & ~x30) | (x22 & x28 & x30));
  assign new_n328_ = x29 & ~x30 & ~x38 & ~x09 & x22 & ~x28;
  assign new_n329_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n106_ & ~x30;
  ...
  assign new_n335_ = (new_n336_ | ~x00) & (~new_n122_ | ~new_n124_ | x00 | x04 | ~x18);
  assign new_n336_ = (new_n337_ | ~x20) & (~x18 | ~x19 | new_n228_ | x20);
  ...
  assign new_n350_ = ~x20 & x22 & ~x28 & new_n245_ & ~x38;
  assign new_n351_ = new_n122_ & x00 & ~x21 & x22 & x28;
  assign new_n352_ = ~x09 & ~x19 & ~x20 & x21 & new_n353_ & x22;
  assign new_n353_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n162_ | x39)))) | x38 | (~x39 & x42));
