// Benchmark "FAU" written by ABC on Sat Aug  1 11:10:35 2020
...
module FAU ( 
  ...
  assign new_n417_ = new_n366_ & new_n115_ & ~x09 & x29 & ~x30 & ~x38;
  ...
  assign z31 = ~x21 & x28 & (new_n435_ | (x00 & (new_n434_ | new_n436_)));
  assign new_n434_ = ~x18 & x19 & x20 & new_n119_ & x22;
  assign new_n435_ = new_n120_ & ~x00 & ~x04 & new_n119_ & x20 & ~x27;
  assign new_n436_ = x18 & x26 & ~x29 & x30 & (x19 ^ x20);
  assign z32 = ~x30 & new_n438_ & ~x29;
  assign new_n438_ = ~x28 & ~x27 & x21 & ~x14 & ~x12 & ~x13;
  assign z33 = x18 & x19 & x20 & ~new_n440_ & ~x21;
  assign new_n440_ = x27 ? (x29 | (~x30 & (~x00 | ~x03 | x30))) : (new_n441_ | ~x29);
  assign new_n441_ = (~x05 | x28 | ~x30) & (~x28 | (~x30 & (~x04 | x30)));
  assign z34 = x18 ? (x30 ? ~new_n454_ : ~new_n459_) : (~new_n447_ | (~new_n443_ & x30));
  assign new_n443_ = (new_n446_ | x28) & (new_n444_ | x29);
  assign new_n444_ = (~x28 | ((~x00 | ~x19 | ~x21) & (new_n445_ | x21))) & (~x19 | ~x21 | new_n94_ | x28);
  assign new_n445_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n446_ = (~x22 | ((~x21 | (x19 ? (~x20 | ~x29) : (x20 | (~x09 & ~x29)))) & (~x20 | x21 | ~x29))) & (x19 | x21 | ~x29);
  ...
  assign new_n451_ = ~x20 & x21 & x22 & ~new_n281_ & ~x28;
  assign new_n452_ = x28 & (x21 | (x00 & x20 & ~x21 & x22));
  assign new_n453_ = x19 & (~x20 | ~x22);
  assign new_n454_ = (x28 | new_n455_ | ~x29) & (x21 | ~x28 | new_n458_ | x29);
  assign new_n455_ = x19 ? (new_n457_ | x21) : (new_n456_ | ~x21);
  assign new_n456_ = x20 & ~x22 & (x11 | (~x26 & (~x20 | ~x25)));
  assign new_n457_ = (x20 | ~x26) & (~x00 | x05 | ~x20 | x27);
  assign new_n458_ = (~x19 | ~x20 | x27) & (~x00 | ~x26 | (~x19 ^ x20));
  assign new_n459_ = (x21 | ((new_n460_ | ~x20) & (~x19 | x20 | ~new_n462_ | ~x26))) & (~new_n462_ | ~x21 | x19 | x20);
  assign new_n460_ = (~new_n461_ | ~x19) & (~x17 | x19 | ~x26 | (~x28 ^ x29));
  assign new_n461_ = ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n462_ = x28 & ~x29;
  assign z35 = x30 ? ~new_n464_ : ((~new_n484_ & ~x21) | (~new_n491_ & x29));
  assign new_n464_ = ~new_n482_ & (x29 | (new_n475_ & (new_n465_ | x18)));
  assign new_n465_ = x19 ? new_n466_ : (new_n472_ & (new_n470_ | ~x20));
  assign new_n466_ = x21 ? (~new_n467_ & ~new_n468_) : new_n469_;
  assign new_n467_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n468_ = x01 & ~x20 & ~x28 & (x22 | x23);
  assign new_n469_ = x20 ? (~x22 | (x28 & (~x28 | (x02 & ~x03)))) : (~x22 & ~x23);
  assign new_n470_ = (x21 | (~new_n471_ & ~x24)) & (~x00 | ~x21 | (new_n95_ & ~x22 & ~x24));
  assign new_n471_ = x28 & ((x03 & ~x06) | (~x02 & (~x06 | (x00 & ~x03))));
  assign new_n472_ = (x21 | ~x23 | x28) & (x20 | (x21 ? new_n474_ : (~new_n473_ & x28)));
  assign new_n473_ = ~x03 & (~x02 | (x00 & x02 & x28));
  assign new_n474_ = ~x23 & (x09 | ~x22 | x28);
  assign new_n475_ = (new_n476_ | new_n124_) & ~new_n478_ & (~x18 | (~new_n480_ & ~new_n481_));
  assign new_n476_ = ~new_n477_ & (~new_n114_ | ~x00 | ~new_n319_ | x19 | ~x20);
  assign new_n477_ = x18 & x19 & ~x20 & ~x21;
  assign new_n478_ = new_n479_ & ~x15 & ~x19 & x00 & ~x05;
  assign new_n479_ = x20 & x21 & x26 & ~x28;
  assign new_n480_ = x00 & (x19 ? ((x20 & x21) | (x26 & x28 & ~x20 & ~x21)) : ((x20 & ~x21 & x26 & x28) | (~x20 & x21 & ~x28)));
  assign new_n481_ = ~x21 & ((x20 & ((~x28 & (x19 ? ~x27 : x26)) | (x19 & (x27 | (~x27 & x28))))) | (x19 & ~x20 & x26 & ~x28));
  assign new_n482_ = x19 & x20 & new_n483_ & ~x21;
  assign new_n483_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  assign new_n484_ = ~new_n485_ & (~x29 | ((~new_n490_ | ~x18) & (new_n487_ | ~x00)));
  assign new_n485_ = ~x03 & (new_n486_ | (new_n120_ & x20 & x27 & ~x29));
  assign new_n486_ = x00 & ~x05 & ~x18 & new_n320_ & ~x28 & x29;
  assign new_n487_ = (~x20 | ((new_n488_ | x18) & (~new_n172_ | ~x18 | x19))) & (~x18 | ~x19 | new_n489_ | x20);
  assign new_n488_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n489_ = ~x22 & (~x10 | ~x25) & (~x26 | x28);
  assign new_n490_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n491_ = (~new_n496_ | ~x18 | ~x19) & (~x21 | (new_n495_ & (new_n492_ | x19)));
  assign new_n492_ = (x18 | ~x20) & (x28 | (new_n493_ & (~x18 | (x20 & (~x11 | ~x20 | ~x25)))));
  assign new_n493_ = (~x20 | ~x26) & (~new_n494_ | x09 | x18 | x20 | ~x22);
  assign new_n494_ = ~x38 & x39 & ~x41 & x42;
  assign new_n495_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n161_ | x28)));
  assign new_n496_ = x20 & ~x27 & ~x28;
  assign z36 = new_n498_ | (x21 & ((new_n518_ & x18) | (new_n514_ & ~x28)));
  assign new_n498_ = ~x30 & ((~x21 & (new_n485_ | ~new_n499_)) | new_n511_ | (~new_n506_ & x21));
  assign new_n499_ = x29 ? (~new_n505_ & (new_n487_ | ~x00)) : (~new_n500_ & new_n503_);
  assign new_n500_ = x18 & (x19 ? ~new_n502_ : ~new_n501_);
  assign new_n501_ = (~x17 | ~x20 | ~x26 | ~x28) & (x14 | x20 | x27 | x28);
  assign new_n502_ = x20 ? ((x27 | ~x28) & (~x00 | ~x03 | ~x27)) : (~x26 | ~x28);
  assign new_n503_ = (x14 | new_n504_ | x27) & (x18 | new_n453_ | ~x28);
  assign new_n504_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n505_ = ~x00 & ~x04 & x18 & new_n217_ & x19 & x20;
  assign new_n506_ = x29 ? (new_n495_ & (new_n507_ | x19)) : new_n509_;
  assign new_n507_ = (x18 | ~x20) & (x28 | (x20 ? new_n279_ : (~x18 & (x09 | ~new_n508_ | x18))));
  ...
  assign new_n511_ = x19 & ~new_n512_ & x20;
  assign new_n512_ = (x18 | ~x22 | ~x28 | new_n513_ | x29) & (~x18 | x27 | x28 | ~x29);
  assign new_n513_ = x16 ? x08 : x07;
  assign new_n514_ = x30 & (new_n517_ | (~x29 & (new_n516_ | (~new_n515_ & ~x18))));
  assign new_n515_ = (new_n94_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
  assign new_n516_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n517_ = ~x11 & x18 & ~x19 & x20 & x25 & x29;
  assign new_n518_ = ~x19 & x20 & ~new_n513_ & x28;
  assign z37 = new_n576_ | (~new_n551_ & ~x30) | (x30 & (~new_n520_ | new_n188_));
  ...
  assign new_n527_ = ~new_n467_ & (x28 | (~new_n528_ & ~x25 & ~x24 & ~x26));
  assign new_n528_ = x20 & x22 & (x05 | (~x05 & x15));
  assign new_n529_ = (new_n474_ | x20) & (~x00 | ~x20 | (new_n95_ & ~x22 & ~x24));
  ...
  assign new_n532_ = x10 & ((x05 & x18) | (x00 & ~x05 & ~x15 & x25));
  ...
  assign new_n541_ = new_n547_ & (~x29 | (new_n545_ & (~x18 | (new_n542_ & ~new_n168_))));
  assign new_n542_ = ~new_n169_ & (~new_n165_ | ~x19) & (x28 | (x19 ? ~new_n544_ : new_n543_));
  assign new_n543_ = (x20 | ~x21) & (x17 | ~x20 | x21 | ~x26);
  assign new_n544_ = ~x21 & (x20 ? (~x27 & (x05 | (x00 & ~x05))) : x26);
  assign new_n545_ = ~new_n546_ & (x19 | ~x20 | ~x21 | new_n167_ | x28);
  ...
  assign new_n552_ = ~x20 & (new_n153_ | new_n556_ | (~x28 & (new_n553_ | new_n555_)));
  ...
  assign new_n557_ = ~new_n171_ & (~x18 | (~new_n564_ & (new_n563_ | x20) & (new_n558_ | ~x20)));
  ...
  assign new_n561_ = ~x21 & (x19 | (~x19 & x26 & (x00 | x17)));
  ...
  assign new_n565_ = (~x20 | (~new_n566_ & (new_n568_ | x21))) & new_n570_ & (new_n509_ | ~x21);
  assign new_n566_ = x19 & ((new_n378_ & x18) | (x28 & (x18 ? new_n121_ : new_n567_)));
  ...
  assign new_n590_ = (~x19 | new_n229_ | x20) & (~x20 | ((~new_n172_ | x19) & (~new_n217_ | x04 | ~x19)));
  assign new_n591_ = new_n120_ & ~x05 & new_n176_ & x20 & ~x27;
  assign new_n592_ = ~x20 & ~new_n154_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  ...
  assign new_n596_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n217_ | ~x04 | x21)));
  assign new_n597_ = x18 & ~x20 & ~x21 & ~new_n218_ & x30;
  assign new_n598_ = x18 & x20 & ~x21;
  assign new_n599_ = (~x20 | ((~new_n602_ | x19) & (new_n600_ | x30))) & (x19 | new_n603_ | x30);
  assign new_n600_ = (new_n601_ | ~x21) & (~x18 | x19 | ~new_n136_ | x21);
  assign new_n601_ = (~x18 | new_n161_ | x28) & (x19 | (x18 & (new_n279_ | x28)));
  assign new_n602_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n603_ = (x18 | x21 | ~x28) & (~x18 | x20 | ~x21 | x28);
  assign new_n604_ = x21 ? new_n606_ : (~new_n605_ & (~x29 | new_n262_ | x30));
  assign new_n605_ = new_n116_ & x22 & x28 & x02 & ~x03 & x20;
  assign new_n606_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n154_ | ~x30);
  assign z40 = ~x28 & ((~new_n608_ & ~x18) | (x05 & x18 & new_n610_ & x20));
  assign new_n608_ = (new_n609_ | ~x05) & (~new_n119_ | x21 | ~new_n320_ | ~x03);
