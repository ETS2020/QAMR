// Benchmark "FAU" written by ABC on Sat Aug  1 11:12:03 2020
...
module FAU ( 
  ...
  assign new_n296_ = x28 & x26 & ~x21 & new_n167_ & x20;
  ...
  assign new_n316_ = (~x28 | x29 | new_n213_ | ~x30) & (x20 | x28 | ~x29 | new_n196_ | x30);
  ...
  assign new_n329_ = ~x20 & (new_n330_ | (~x18 & (new_n331_ | (new_n254_ & new_n332_))));
  assign new_n330_ = new_n167_ & x28 & ~x29 & x30;
  assign new_n331_ = ~x19 & ((x23 & x29 & ~x30) | (x22 & x28 & x30));
  assign new_n332_ = x29 & ~x30 & ~x38 & ~x09 & x22 & ~x28;
  assign new_n333_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n108_ & ~x30;
  ...
  assign new_n339_ = (new_n340_ | ~x00) & (~new_n124_ | ~new_n126_ | x00 | x04 | ~x18);
  assign new_n340_ = (new_n341_ | ~x20) & (~x18 | ~x19 | new_n230_ | x20);
  ...
  assign new_n352_ = ~x20 & x22 & ~x28 & new_n247_ & ~x38;
  assign new_n353_ = new_n124_ & x00 & ~x21 & x22 & x28;
  assign new_n354_ = ~x09 & ~x19 & ~x20 & x21 & new_n355_ & x22;
  assign new_n355_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n164_ | x39)))) | x38 | (~x39 & x42));
  ...
  assign new_n365_ = x26 & ((x17 & ~x30 & (x28 ^ x29)) | (~x29 & x30 & x00 & x28));
