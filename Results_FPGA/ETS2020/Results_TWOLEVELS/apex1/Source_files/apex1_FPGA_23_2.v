// Benchmark "FAU" written by ABC on Sat Aug  1 11:06:39 2020
...
module FAU ( 
  ...
  assign new_n297_ = x21 & ((~x19 & (new_n101_ | (~x18 & x24))) | new_n298_ | (x18 & x19));
  assign new_n298_ = new_n108_ & ~x18 & x22 & ~x28;
  assign new_n299_ = new_n114_ & x03 & ~x21 & x27 & ~x30;
  ...
  assign new_n304_ = (new_n305_ | x19) & (~new_n113_ | ~new_n153_ | ~x18 | ~x19 | x21);
  assign new_n305_ = (x03 | x18 | new_n118_ | x21) & (~x18 | ~x21 | ~new_n109_ | x28);
  assign new_n306_ = new_n109_ & x28 & ~x18 & x19 & x21;
  assign z31 = ~x21 & x28 & (new_n309_ | (x00 & (new_n308_ | new_n310_)));
  assign new_n308_ = new_n113_ & x22 & ~x18 & x19 & x20;
  assign new_n309_ = new_n113_ & x20 & ~x27 & new_n114_ & ~x00 & ~x04;
  ...
  assign new_n347_ = (~new_n129_ | ~x17 | ~x20) & (~new_n348_ | x14 | x20);
  ...
  assign new_n355_ = (~new_n356_ | x09) & (new_n164_ | ~x20) & (~x18 | x20);
  ...
  assign new_n380_ = ~new_n381_ & (~x19 | x21 | (x20 ? ~new_n153_ : ~x22));
  ...
  assign new_n392_ = x00 & (new_n393_ | (new_n394_ & new_n114_ & ~x05));
  assign new_n393_ = ~x10 & ~x15 & ~x19 & x21 & x25;
  assign new_n394_ = ~x21 & ~x27 & x29;
  assign new_n395_ = (~new_n396_ | x18) & (~new_n235_ | ~x18 | x21 | ~x26 | ~x29);
  ...
  assign new_n402_ = (~x00 | x20 | (~new_n117_ & ~x22)) & (x00 | x04 | ~new_n152_ | ~x20);
  ...
  assign new_n423_ = (~x21 | x28 | (~new_n108_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n424_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n425_ = ~x05 & ~x15 & ~x18 & x20 & x21 & x22;
  assign new_n426_ = new_n114_ & x03 & x20 & ~x21 & x27;
  assign new_n427_ = ~new_n431_ & (x30 | (x18 ? new_n428_ : new_n429_));
  assign new_n428_ = (~x19 | new_n181_ | x20) & (~x20 | ((~new_n153_ | x19) & (~new_n152_ | x04 | ~x19)));
  assign new_n429_ = ~new_n430_ & (~x20 | (x19 ? (~x22 | ~x28) : (~x23 | x28)));
  assign new_n430_ = ~x05 & ((x19 & x20 & x22) | (~x03 & ~x19 & ~x20 & ~x28));
  assign new_n431_ = new_n114_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n432_ = ~x01 & ~x18 & x19 & new_n142_ & ~x20;
  assign z39 = (~new_n440_ & x29) | (x19 & (x18 ? ~new_n434_ : ~new_n437_));
  assign new_n434_ = (new_n435_ | ~x29) & (~x27 | x29 | ~x30 | ~x20 | x21);
  assign new_n435_ = (new_n436_ | x30) & (x20 | x21 | new_n206_ | ~x30);
  assign new_n436_ = (~new_n129_ | x20 | x21) & (~x20 | (~x21 & (~new_n152_ | ~x04)));
  assign new_n437_ = x21 ? new_n238_ : (~new_n438_ & (~x29 | new_n439_ | x30));
  assign new_n438_ = x02 & ~x03 & x20 & new_n109_ & x22 & x28;
  ...
  assign new_n445_ = new_n113_ & ~x21 & x03 & ~x19 & ~x20;
