// Benchmark "FAU" written by ABC on Sat Aug  1 11:15:13 2020
...
module FAU ( 
  ...
  assign z34 = x18 ? (~new_n525_ | (~new_n513_ & x20)) : (~new_n507_ | new_n520_);
  assign new_n507_ = (new_n508_ | ~x29) & (x21 | ~x28 | x29 | new_n512_ | x30);
  assign new_n508_ = (~new_n164_ | x09) & (x30 | ((~new_n511_ | ~x19) & (x09 | ~new_n509_ | x19)));
  ...
  assign new_n513_ = (new_n514_ | x21) & (x11 | x19 | ~new_n519_ | ~x21);
  assign new_n514_ = x30 ? new_n515_ : new_n517_;
  ...
  assign new_n519_ = ~x28 & x29 & x30 & (x25 | x26);
  assign new_n520_ = x30 & ((~new_n524_ & ~x28) | (~new_n521_ & ~x29));
  assign new_n521_ = (~x28 | ((new_n522_ | x21) & (~x00 | ~x19 | ~x21))) & (~x19 | ~x21 | new_n523_ | x28);
  assign new_n522_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n523_ = ~x24 & (~x10 | ~x25) & ~x26;
  assign new_n524_ = (~x22 | ((~x21 | (x19 ? (~x20 | ~x29) : (x20 | (~x09 & ~x29)))) & (~x20 | x21 | ~x29))) & (x19 | x21 | ~x29);
  assign new_n525_ = (~new_n392_ | ~new_n137_ | x19) & (new_n526_ | x20);
  assign new_n526_ = ~new_n527_ & (~new_n110_ | ~new_n130_ | ~x00 | ~x19 | x21);
  assign new_n527_ = (x28 ? (~x29 & ~x30) : (x29 & x30)) & (x19 ? (~x21 & x26) : x21);
  assign z35 = x30 ? ~new_n529_ : (new_n548_ | (~x21 & (new_n553_ | new_n555_)));
  assign new_n529_ = ~new_n546_ & (x29 | (new_n539_ & (new_n530_ | x18)));
  assign new_n530_ = x19 ? new_n531_ : (new_n536_ & (new_n534_ | ~x20));
  assign new_n531_ = x21 ? (~new_n532_ & (~x01 | ~new_n168_ | x20)) : new_n533_;
  assign new_n532_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n533_ = x20 ? (~x22 | (x28 & (~x28 | (x02 & ~x03)))) : (~x22 & ~x23);
  assign new_n534_ = (x21 | (~new_n535_ & ~x24)) & (~x00 | ~x21 | (new_n96_ & ~x22 & ~x24));
  assign new_n535_ = x28 & ((x03 & ~x06) | (~x02 & (~x06 | (x00 & ~x03))));
  assign new_n536_ = (x21 | ~x23 | x28) & (x20 | (x21 ? new_n538_ : (~new_n537_ & x28)));
  assign new_n537_ = ~x03 & (~x02 | (x00 & x02 & x28));
  assign new_n538_ = ~x23 & (x09 | ~x22 | x28);
  assign new_n539_ = (new_n540_ | new_n118_) & ~new_n542_ & (~x18 | (~new_n544_ & ~new_n545_));
  assign new_n540_ = ~new_n541_ & (~new_n108_ | ~x00 | ~new_n252_ | ~x21 | x28);
  assign new_n541_ = x18 & x19 & ~x20 & ~x21;
  assign new_n542_ = new_n543_ & ~x15 & ~x19 & x00 & ~x05;
  assign new_n543_ = x20 & x21 & x26 & ~x28;
  ...
  assign new_n547_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  assign new_n548_ = x29 & (new_n552_ | (x21 & (~new_n551_ | (~new_n549_ & ~x19))));
  assign new_n549_ = (x18 | ~x20) & (x28 | (new_n550_ & (~x18 | (x20 & (~x11 | ~x20 | ~x25)))));
  assign new_n550_ = ~new_n243_ & (~new_n257_ | x41 | ~x42 | x38 | ~x39);
  assign new_n551_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n154_ | x28)));
  assign new_n552_ = new_n114_ & x20 & ~x27 & ~x28;
  assign new_n553_ = ~x03 & (new_n554_ | (new_n114_ & x20 & x27 & ~x29));
  assign new_n554_ = x00 & ~x05 & ~x18 & new_n253_ & ~x19 & ~x20;
  assign new_n555_ = x29 & ((x00 & new_n557_ & ~x18) | (x18 & (new_n559_ | (~new_n556_ & x00))));
  assign new_n556_ = (~x19 | new_n118_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n557_ = ~new_n558_ & x20;
  assign new_n558_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n559_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign z36 = (~new_n568_ & x21) | (~x30 & ((~new_n561_ & ~x21) | new_n579_ | (~new_n574_ & x21)));
  assign new_n561_ = ~new_n553_ & new_n564_ & (~x18 | (new_n562_ & (new_n567_ | ~x26)));
  assign new_n562_ = (~x19 | (~new_n563_ & (~new_n518_ | ~x20))) & (~new_n365_ | x14 | x19 | x20);
  assign new_n563_ = x00 & ((~x20 & ~new_n118_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n564_ = (new_n565_ | x29) & (~x00 | x18 | ~x20 | new_n558_ | ~x29);
  assign new_n565_ = (x14 | new_n566_ | x27) & (x18 | new_n512_ | ~x28);
  assign new_n566_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n567_ = (((~x19 | x20) & (~x17 | x19 | ~x20)) | ((~x28 | x29) & (~x00 | x28 | ~x29))) & (~x20 | x28 | ~x29 | ~x00 | x17 | x19);
  assign new_n568_ = (~new_n569_ | x28) & (~x18 | x19 | ~x20 | new_n573_ | ~x28);
  assign new_n569_ = x30 & (new_n571_ | (~x29 & (new_n572_ | (~new_n570_ & ~x18))));
  assign new_n570_ = (new_n523_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
  assign new_n571_ = new_n183_ & ~x11 & x20 & x25 & x29;
  assign new_n572_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n573_ = x16 ? x08 : x07;
  assign new_n574_ = x29 ? (new_n551_ & (new_n575_ | x19)) : new_n577_;
  assign new_n575_ = (x18 | ~x20) & (x28 | (x20 ? new_n313_ : (~x18 & (x09 | ~new_n576_ | x18))));
  assign new_n576_ = x22 & ~x38 & ~x41 & (x39 ? x42 : (x40 & ~x42));
  assign new_n577_ = (~new_n183_ | x20 | ~x28) & (~new_n578_ | x14 | x27 | x28);
  assign new_n578_ = ~x12 & ~x13;
  ...
  assign new_n589_ = ~new_n532_ & (x28 | (new_n590_ & ~x25));
  assign new_n590_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n591_ = (new_n538_ | x20) & (~x00 | ~x20 | (new_n96_ & ~x22 & ~x24));
  assign new_n592_ = ~new_n598_ & (~x20 | (~new_n596_ & (x28 | (~new_n593_ & ~new_n601_))));
  assign new_n593_ = x21 & (new_n471_ | (~x19 & (new_n595_ | (new_n594_ & x00))));
  ...
  assign new_n603_ = ~x19 & (x21 ? ~new_n416_ : (~x18 | (new_n243_ & ~x17 & x18)));
  ...
  assign new_n629_ = x19 & ((new_n439_ & x18) | (x28 & (x18 ? new_n115_ : new_n630_)));
  ...
  assign new_n636_ = ~x19 & x21 & (new_n637_ | (~x09 & new_n436_ & ~x18));
