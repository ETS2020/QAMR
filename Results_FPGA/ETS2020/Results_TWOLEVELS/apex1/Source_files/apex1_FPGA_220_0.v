// Benchmark "FAU" written by ABC on Sat Aug  1 11:14:39 2020
...
module FAU ( 
  ...
  assign new_n304_ = x30 & (x20 ? ~new_n110_ : ~new_n121_);
  ...
  assign new_n312_ = (~x28 | x29 | new_n215_ | ~x30) & (x20 | x28 | ~x29 | new_n198_ | x30);
  ...
  assign new_n325_ = ~x20 & (new_n326_ | (~x18 & (new_n327_ | (new_n256_ & new_n328_))));
  assign new_n326_ = new_n169_ & x28 & ~x29 & x30;
  assign new_n327_ = ~x19 & ((x23 & x29 & ~x30) | (x22 & x28 & x30));
  assign new_n328_ = x29 & ~x30 & ~x38 & ~x09 & x22 & ~x28;
  assign new_n329_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n110_ & ~x30;
  ...
  assign new_n335_ = (new_n336_ | ~x00) & (~new_n126_ | ~new_n128_ | x00 | x04 | ~x18);
  assign new_n336_ = (new_n337_ | ~x20) & (~x18 | ~x19 | new_n232_ | x20);
  ...
  assign new_n348_ = ~x20 & x22 & ~x28 & new_n249_ & ~x38;
  assign new_n349_ = new_n126_ & x00 & ~x21 & x22 & x28;
  assign new_n350_ = ~x09 & ~x19 & ~x20 & x21 & new_n351_ & x22;
  assign new_n351_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n166_ | x39)))) | x38 | (~x39 & x42));
