...
module FAU ( 
  ...
  assign z34 = x18 ? ~new_n359_ : (new_n348_ | ~new_n352_);
  assign new_n348_ = x30 & ((~new_n351_ & ~x28) | (~new_n349_ & ~x29));
  assign new_n349_ = (~x28 | ((~x00 | ~x19 | ~x21) & (new_n350_ | x21))) & (~x19 | ~x21 | new_n94_ | x28);
  assign new_n350_ = (~x00 | x03 | x19 | (x02 ^ ~x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n351_ = (~x22 | ((~x21 | (x19 ? (~x20 | ~x29) : (x20 | (~x09 & ~x29)))) & (~x20 | x21 | ~x29))) & (x19 | x21 | ~x29);
  assign new_n352_ = (~new_n358_ | x21) & (~x29 | (~new_n356_ & (new_n353_ | x30)));
  assign new_n353_ = ~new_n355_ & (~x21 | ((~x19 | ~x28) & (x09 | ~new_n354_ | x19)));
  assign new_n354_ = ~x20 & x22 & ~x28 & new_n249_ & ~x38;
  assign new_n355_ = new_n126_ & x00 & ~x21 & x22 & x28;
  assign new_n356_ = ~x09 & ~x19 & ~x20 & x21 & new_n357_ & x22;
  assign new_n357_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n166_ | x39)))) | x38 | (~x39 & x42));
  assign new_n358_ = x28 & ~x29 & ~x30 & (~x19 | (x20 & x22));
  assign new_n359_ = x19 ? (new_n360_ | x21) : ((new_n365_ | ~x21) & (~x20 | ~new_n367_ | x21));
  assign new_n360_ = new_n363_ & (new_n361_ | ~x00);
  assign new_n361_ = (~new_n362_ | x28 | ~x29 | ~x30) & (x20 | ~x26 | ~x28 | x29);
  assign new_n362_ = ~x05 & x20 & ~x27;
  assign new_n363_ = (~x28 | ((~new_n364_ | ~x20) & (x29 | x30 | x20 | ~x26))) & (x20 | ~x26 | x28 | ~x29 | ~x30);
  assign new_n364_ = ~x27 & (~x29 | (~x00 & ~x04 & x29 & ~x30));
  assign new_n365_ = (x28 | ~x29 | new_n366_ | ~x30) & (x29 | x30 | x20 | ~x28);
  assign new_n366_ = x20 & ~x22 & (x11 | (~x25 & (~x20 | ~x26)));
  assign new_n367_ = x26 & ((x17 & ~x30 & (x28 ^ x29)) | (x00 & x28 & ~x29 & x30));
  assign z40 = ~x28 & ((~x18 & (new_n372_ | (~new_n371_ & x05))) | (x05 & new_n369_ & x18));
  assign new_n369_ = x20 & ~new_n370_ & x30;
  assign new_n370_ = (x19 | ~x21 | x29 | (~x10 & x25)) & (x27 | ~x29 | ~x19 | x21);
  assign new_n371_ = (~x19 | ~x20 | ~x22 | (x21 ? (x29 | ~x30) : (~x29 | x30))) & (x19 | x20 | x21 | ~x29 | x30);
  assign new_n372_ = ~x21 & x29 & ~x30 & x03 & ~x19 & ~x20;
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n374_ & x21;
  assign new_n374_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
  assign z02 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
