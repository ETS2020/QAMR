// Benchmark "FAU" written by ABC on Sat Aug  1 11:08:58 2020
...
module FAU ( 
  ...
  assign new_n386_ = (new_n387_ | ~x30) & (~new_n247_ | ~x21 | x27 | x30);
  ...
  assign new_n392_ = x30 & (x20 ? ~new_n154_ : ~new_n218_);
  ...
  assign new_n402_ = (~x28 | x29 | new_n403_ | ~x30) & (x20 | x28 | ~x29 | new_n234_ | x30);
  ...
  assign new_n415_ = ~new_n416_ & (~x19 | (~new_n419_ & (~x30 | (~new_n359_ & new_n420_))));
  assign new_n416_ = ~x20 & ((new_n146_ & x18 & ~x19) | (~x18 & (new_n417_ | (~new_n418_ & ~x19))));
  assign new_n417_ = new_n368_ & new_n115_ & ~x09 & x29 & ~x30 & ~x38;
  assign new_n418_ = (~x22 | ~x28 | ~x30) & (~x23 | ~x29 | x30);
  assign new_n419_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n154_ & ~x30;
  assign new_n420_ = x18 ? (x20 | (~x22 & ~x26)) : (~x28 | ~x29);
  assign new_n421_ = (new_n422_ | ~x30) & (~new_n143_ | ~x24 | ~x29 | x30);
  assign new_n422_ = x18 ? (x20 | (~x22 & ~x25)) : (~x20 | x29 | (~x22 & ~x26));
  assign z29 = x00 & (~new_n427_ | (x20 & (new_n430_ | (~new_n424_ & ~x29))));
  assign new_n424_ = (~x30 | (~new_n426_ & (new_n425_ | ~x21))) & (~new_n149_ | x21 | ~x27 | x30);
  assign new_n425_ = x19 ? (~x18 & (~new_n114_ | ~new_n115_ | x18)) : (~new_n108_ & (x18 | ~x24));
  assign new_n426_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n427_ = (new_n428_ | x20) & (~new_n146_ | x18 | ~x19 | ~x21);
  assign new_n428_ = (new_n429_ | x19) & (~new_n119_ | ~new_n172_ | ~x18 | ~x19 | x21);
  assign new_n429_ = (x03 | x18 | new_n125_ | x21) & (~x18 | ~x21 | ~new_n116_ | x28);
  ...
  assign new_n434_ = x00 & ((~new_n435_ & x20) | (x18 & x19 & ~new_n124_ & ~x20));
  assign new_n435_ = (x18 | ~x19 | ~x22 | ~x28) & (x17 | ~x18 | x19 | ~x26 | x28);
  assign new_n436_ = ~x00 & ~x04 & x18 & new_n217_ & x19 & x20;
  assign z31 = ~x21 & x28 & (new_n439_ | (x00 & (new_n438_ | new_n440_)));
  assign new_n438_ = ~x18 & x19 & x20 & new_n119_ & x22;
  assign new_n439_ = new_n120_ & ~x00 & ~x04 & new_n119_ & x20 & ~x27;
  ...
  assign new_n451_ = ~x20 & x21 & x22 & ~new_n282_ & ~x28;
  ...
  assign new_n479_ = (new_n480_ | new_n124_) & ~new_n482_ & (~x18 | (~new_n484_ & ~new_n485_));
  assign new_n480_ = ~new_n481_ & (~new_n114_ | ~x00 | ~new_n321_ | x19 | ~x20);
  ...
  assign new_n492_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n161_ | x28)));
  assign new_n493_ = new_n120_ & x20 & ~x27 & ~x28;
  assign new_n494_ = ~x03 & (new_n495_ | (new_n120_ & x20 & x27 & ~x29));
  assign new_n495_ = new_n322_ & new_n275_ & x00 & ~x05 & ~x18;
  assign new_n496_ = x29 & ((x00 & new_n498_ & ~x18) | (x18 & (new_n500_ | (~new_n497_ & x00))));
  assign new_n497_ = (~x19 | new_n124_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  ...
  assign new_n503_ = (~x19 | (~new_n504_ & (~new_n465_ | ~x20))) & (~new_n307_ | x14 | x19 | x20);
  assign new_n504_ = x00 & ((~x20 & ~new_n124_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n516_ = (x18 | ~x20) & (x28 | (x20 ? new_n280_ : (~x18 & (x09 | ~new_n517_ | x18))));
  ...
  assign new_n520_ = x19 & x20 & ((new_n521_ & ~x18) | (new_n275_ & x18 & ~x27));
  assign new_n521_ = x22 & x28 & ~new_n514_ & ~x29;
  assign z37 = new_n579_ | (~new_n554_ & ~x30) | (x30 & (~new_n523_ | new_n188_));
  ...
  assign new_n539_ = new_n136_ & ~x21 & x00 & x18;
  assign new_n540_ = x18 & ~x21 & x26;
  assign new_n541_ = x18 & x19 & (~x21 | (x00 & x21));
  assign new_n542_ = x18 & ~new_n543_ & ~x20;
  assign new_n543_ = (~x00 | ((~x19 | x21 | ~x26 | ~x28) & (x19 | ~x21 | x28))) & (x19 | ~x21 | ~x28) & (new_n348_ | x21);
  assign new_n544_ = new_n550_ & (~x29 | (new_n548_ & (~x18 | (new_n545_ & ~new_n168_))));
  assign new_n545_ = ~new_n169_ & (~new_n165_ | ~x19) & (x28 | (x19 ? ~new_n547_ : new_n546_));
  assign new_n546_ = (x20 | ~x21) & (x17 | ~x20 | x21 | ~x26);
  assign new_n547_ = ~x21 & (x20 ? (~x27 & (x05 | (x00 & ~x05))) : x26);
  assign new_n548_ = ~new_n549_ & (x19 | ~x20 | ~x21 | new_n167_ | x28);
  ...
  assign new_n555_ = ~x20 & (new_n153_ | new_n559_ | (~x28 & (new_n556_ | new_n558_)));
  ...
  assign new_n560_ = ~new_n171_ & (~x18 | (~new_n567_ & (new_n566_ | x20) & (new_n561_ | ~x20)));
  ...
  assign new_n566_ = x19 ? (x21 | ((~x26 | ~x28) & (~x00 | (~new_n139_ & (~x26 | x28))))) : (~x21 | x28);
  assign new_n567_ = x22 & ((x20 & x21 & ~x28) | (x00 & x19 & ~x20 & ~x21));
  assign new_n568_ = (~x20 | (~new_n569_ & (new_n571_ | x21))) & new_n573_ & (new_n518_ | ~x21);
  assign new_n569_ = x19 & ((new_n380_ & x18) | (x28 & (x18 ? new_n121_ : new_n570_)));
  assign new_n570_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n571_ = (new_n572_ | x18) & (~x17 | ~x18 | ~new_n136_ | x19);
  ...
  assign new_n579_ = ~x19 & x21 & (new_n580_ | (~x09 & new_n382_ & ~x18));
  ...
  assign new_n586_ = (~x21 | x28 | (~new_n114_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n587_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n588_ = ~x05 & ~x15 & ~x18 & x20 & x21 & x22;
  assign new_n589_ = new_n149_ & x20 & ~x21 & x27;
  ...
  assign new_n593_ = (~x19 | new_n229_ | x20) & (~x20 | ((~new_n172_ | x19) & (~new_n217_ | x04 | ~x19)));
  assign new_n594_ = new_n120_ & ~x05 & new_n176_ & x20 & ~x27;
  assign new_n595_ = ~x20 & ~new_n154_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n602_ & x29) | (x19 & (~new_n597_ | (~new_n607_ & ~x18)));
  assign new_n597_ = (~new_n601_ | ~x27 | x29 | ~x30) & (~x29 | (~new_n600_ & (new_n598_ | x30)));
  assign new_n598_ = (new_n599_ | ~x20) & (~x18 | x20 | ~new_n136_ | x21);
  assign new_n599_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n217_ | ~x04 | x21)));
  assign new_n600_ = x18 & ~x20 & ~x21 & ~new_n218_ & x30;
  assign new_n601_ = x18 & x20 & ~x21;
  assign new_n602_ = (~x20 | ((~new_n605_ | x19) & (new_n603_ | x30))) & (x19 | new_n606_ | x30);
  assign new_n603_ = (new_n604_ | ~x21) & (~x18 | x19 | ~new_n136_ | x21);
  assign new_n604_ = (~x18 | new_n161_ | x28) & (x19 | (x18 & (new_n280_ | x28)));
  assign new_n605_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n606_ = (x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20);
  assign new_n607_ = x21 ? new_n609_ : (~new_n608_ & (~x29 | new_n262_ | x30));
  assign new_n608_ = new_n116_ & x22 & x28 & x02 & ~x03 & x20;
  assign new_n609_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n154_ | ~x30);
  assign z40 = ~x28 & ((~new_n611_ & ~x18) | (x05 & x18 & new_n613_ & x20));
  assign new_n611_ = (new_n612_ | ~x05) & (~new_n119_ | x21 | ~new_n322_ | ~x03);
