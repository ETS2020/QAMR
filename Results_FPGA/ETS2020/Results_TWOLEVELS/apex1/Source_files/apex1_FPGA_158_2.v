// Benchmark "FAU" written by ABC on Sat Aug  1 11:12:08 2020
...
module FAU ( 
  ...
  assign z06 = (x20 & (new_n113_ | (~new_n102_ & x00))) | (x00 & new_n118_ & ~x20);
  ...
  assign new_n192_ = (~x22 | (~x21 & (x21 | ~x29))) & (new_n98_ | ~x21) & (x21 | (~new_n193_ & (~x25 | ~x29)));
  ...
  assign new_n282_ = (x19 | (~new_n104_ & (x18 | ~x24))) & (~x18 | ~x19) & (~new_n110_ | ~new_n111_ | x18);
  ...
  assign new_n324_ = (x19 | new_n148_ | ~x20) & (~x22 | (~new_n325_ & ~x20));
  ...
  assign new_n364_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21) & (x28 | ((x19 | new_n365_ | ~x21) & (x21 | ~x26)));
  ...
  assign new_n375_ = x21 & x25 & ~x10 & ~x19;
