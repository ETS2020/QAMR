// Benchmark "FAU" written by ABC on Sat Aug  1 11:13:02 2020
...
module FAU ( 
  ...
  assign new_n297_ = x21 & ((~x19 & (new_n104_ | (~x18 & x24))) | new_n298_ | (x18 & x19));
  ...
  assign new_n306_ = new_n111_ & x28 & ~x18 & x19 & x21;
  assign z31 = ~x21 & x28 & (new_n309_ | (x00 & (new_n308_ | new_n310_)));
  assign new_n308_ = new_n115_ & x22 & ~x18 & x19 & x20;
  ...
  assign new_n341_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  ...
  assign new_n345_ = (~new_n131_ | ~x17 | ~x20) & (~new_n346_ | x14 | x20);
  ...
  assign new_n353_ = (~new_n354_ | x09) & (new_n166_ | ~x20) & (~x18 | x20);
  ...
  assign new_n375_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21) & (x28 | ((x19 | new_n376_ | ~x21) & (x21 | ~x26)));
  assign new_n376_ = x05 ? (~x10 & x25) : ~x15;
  assign new_n377_ = (~x00 | ((~x26 | ~x28 | ~x19 | x21) & (x19 | ~x21 | x28))) & (x19 | ~x21 | ~x28) & (~x26 | x28 | ~x19 | x21);
  assign new_n378_ = ~new_n379_ & (~x19 | x21 | (x20 ? ~new_n155_ : ~x22));
  ...
  assign new_n390_ = x00 & (new_n391_ | (new_n392_ & new_n116_ & ~x05));
  assign new_n391_ = ~x10 & ~x15 & ~x19 & x21 & x25;
  assign new_n392_ = ~x21 & ~x27 & x29;
  assign new_n393_ = (~new_n394_ | x18) & (~new_n237_ | ~x18 | x21 | ~x26 | ~x29);
  ...
  assign new_n400_ = (~x00 | x20 | (~new_n119_ & ~x22)) & (x00 | x04 | ~new_n154_ | ~x20);
  ...
  assign new_n421_ = (~x21 | x28 | (~new_n110_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n422_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n423_ = ~x05 & ~x15 & ~x18 & x20 & x21 & x22;
  assign new_n424_ = new_n116_ & x03 & x20 & ~x21 & x27;
  assign new_n425_ = ~new_n429_ & (x30 | (x18 ? new_n426_ : new_n427_));
  assign new_n426_ = (~x19 | new_n183_ | x20) & (~x20 | ((~new_n155_ | x19) & (~new_n154_ | x04 | ~x19)));
  assign new_n427_ = ~new_n428_ & (~x20 | (x19 ? (~x22 | ~x28) : (~x23 | x28)));
  assign new_n428_ = ~x05 & ((x19 & x20 & x22) | (~x03 & ~x19 & ~x20 & ~x28));
  assign new_n429_ = new_n116_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n430_ = ~x01 & ~x18 & x19 & new_n144_ & ~x20;
  assign z39 = (~new_n438_ & x29) | (x19 & (x18 ? ~new_n432_ : ~new_n435_));
  assign new_n432_ = (new_n433_ | ~x29) & (~x27 | x29 | ~x30 | ~x20 | x21);
  assign new_n433_ = (new_n434_ | x30) & (x20 | x21 | new_n208_ | ~x30);
  assign new_n434_ = (~new_n131_ | x20 | x21) & (~x20 | (~x21 & (~new_n154_ | ~x04)));
  assign new_n435_ = x21 ? new_n240_ : (~new_n436_ & (~x29 | new_n437_ | x30));
  assign new_n436_ = x02 & ~x03 & x20 & new_n111_ & x22 & x28;
  ...
  assign new_n443_ = new_n115_ & ~x21 & x03 & ~x19 & ~x20;
