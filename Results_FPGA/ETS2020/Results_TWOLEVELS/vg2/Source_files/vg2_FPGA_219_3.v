// Benchmark "FAU" written by ABC on Thu Jul 30 14:47:42 2020
...
module FAU ( 
  ...
  assign z3 = (~new_n62_ & ~x24) | (x24 & ~new_n65_ & (x05 | x13)) | (~x05 & ~new_n69_ & ~x13);
  assign new_n62_ = x01 ? (~x03 | ~x06 | ~new_n63_ | ~x08) : (x03 | x06 | ~new_n64_ | x08);
  assign new_n63_ = x11 & x14 & ~new_n43_ & x20;
  assign new_n64_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
