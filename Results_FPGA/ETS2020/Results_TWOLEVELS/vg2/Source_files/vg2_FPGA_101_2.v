...
module FAU ( 
  ...
  assign z3 = (~new_n58_ & ~x24) | (x24 & ~new_n61_ & (x05 | x13)) | (~x05 & ~new_n65_ & ~x13);
  assign new_n58_ = x01 ? (~x03 | ~x06 | ~new_n59_ | ~x08) : (x03 | x06 | ~new_n60_ | x08);
  assign new_n59_ = x11 & x14 & ~new_n39_ & x20;
  assign new_n60_ = ~x11 & ~x14 & ~new_n42_ & ~x20;
  ...
  assign new_n65_ = (~new_n67_ | x06 | x08 | x01 | x03) & (~new_n66_ | ~x06 | ~x08 | ~x01 | ~x03);
