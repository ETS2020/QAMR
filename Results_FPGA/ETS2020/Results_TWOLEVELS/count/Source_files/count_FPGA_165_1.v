...
module FAU ( 
  ...
  assign new_n74_ = new_n60_ & new_n68_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n76_ & x16) | x18 | (~x04 & ~x16);
  assign new_n76_ = (~x30 | (new_n60_ & new_n68_ & ~x27 & ~x28 & ~x29)) & (~new_n60_ | ~new_n68_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n79_ | (~new_n78_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n78_ = new_n60_ & new_n68_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = ~new_n88_ | (x16 & ((~new_n82_ & x33) | (new_n65_ & new_n86_)));
  assign new_n86_ = new_n87_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n87_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n88_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n91_ | (x16 & ((new_n65_ & new_n90_) | (x34 & (~new_n65_ | ~new_n86_))));
