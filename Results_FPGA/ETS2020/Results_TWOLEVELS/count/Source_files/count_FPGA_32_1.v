...
module FAU ( 
  ...
  assign z13 = ~new_n84_ | (x16 & (new_n81_ | (x32 & (~new_n62_ | ~new_n79_))));
  assign new_n79_ = new_n80_ & ~x25 & ~x26 & ~x27;
  ...
  assign z14 = ~new_n88_ | (x16 & ((~new_n81_ & x33) | (new_n65_ & new_n86_)));
  assign new_n86_ = new_n87_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n87_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n88_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n91_ | (x16 & ((x34 & (~new_n65_ | ~new_n86_)) | (new_n65_ & new_n90_)));
