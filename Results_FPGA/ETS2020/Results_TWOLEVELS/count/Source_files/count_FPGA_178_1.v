...
module FAU ( 
  ...
  assign new_n62_ = new_n55_ & ~x21 & ~x22 & ~x23 & ~x24;
  ...
  assign new_n72_ = new_n58_ & new_n73_ & ~x26 & ~x27 & ~x28;
  assign new_n73_ = ~x23 & ~x24 & ~x25;
  assign z10 = (x16 & (new_n75_ | (~new_n72_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n75_ = new_n60_ & new_n67_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n77_ & x16) | x18 | (~x04 & ~x16);
  assign new_n77_ = (~x30 | (new_n60_ & new_n67_ & ~x27 & ~x28 & ~x29)) & (~new_n60_ | ~new_n67_ | x29 | x30 | x27 | x28);
  assign z12 = ~new_n81_ | (x16 & ((~new_n79_ & x31) | (new_n62_ & new_n80_)));
  assign new_n79_ = new_n60_ & new_n67_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n80_ = new_n70_ & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n81_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n85_ | (x16 & ((new_n62_ & new_n83_) | (x32 & (~new_n62_ | ~new_n80_))));
  assign new_n83_ = new_n84_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n84_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n85_ = ~x18 & (x02 | x16);
  assign z15 = ~new_n90_ | (x16 & ((new_n64_ & new_n89_) | (x34 & (~new_n64_ | ~new_n87_))));
  assign new_n87_ = new_n88_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n88_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n89_ = new_n88_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
