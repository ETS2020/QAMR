// Benchmark "FAU" written by ABC on Thu Jul 30 16:49:22 2020
...
module FAU ( 
  ...
  assign new_n77_ = (~x30 | (new_n60_ & new_n68_ & ~x27 & ~x28 & ~x29)) & (~new_n60_ | ~new_n68_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n80_ | (~new_n79_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n79_ = new_n60_ & new_n68_ & ~x29 & ~x30 & ~x27 & ~x28;
