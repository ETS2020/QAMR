...
module FAU ( 
  ...
  assign new_n75_ = (~x30 | (new_n60_ & new_n68_ & ~x27 & ~x28 & ~x29)) & (~new_n60_ | ~new_n68_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n78_ | (~new_n77_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n77_ = new_n60_ & new_n68_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n78_ = new_n55_ & new_n63_ & new_n79_ & ~x25 & ~x26 & ~x27;
  assign new_n79_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n81_ | (~new_n78_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n81_ = new_n55_ & new_n63_ & new_n82_ & new_n83_;
  assign new_n82_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n83_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n87_ | (x16 & ((~new_n81_ & x33) | (new_n65_ & new_n85_)));
  assign new_n85_ = new_n86_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n86_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n87_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n90_ | (x16 & ((new_n65_ & new_n89_) | (x34 & (~new_n65_ | ~new_n85_))));
  assign new_n89_ = new_n86_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
