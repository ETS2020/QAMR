// Benchmark "FAU" written by ABC on Thu Jul 30 16:49:04 2020
...
module FAU ( 
  ...
  assign new_n67_ = new_n57_ & new_n68_ & ~x22 & ~x23;
  assign new_n68_ = ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n70_ | (~new_n67_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n70_ = new_n59_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  ...
  assign new_n77_ = (~x30 | (new_n63_ & new_n68_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n68_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n80_ | (~new_n79_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n79_ = new_n63_ & new_n68_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n80_ = new_n56_ & new_n62_ & new_n81_ & ~x25 & ~x26 & ~x27;
  assign new_n81_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n83_ | (~new_n80_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n83_ = new_n56_ & new_n62_ & new_n84_ & new_n85_;
