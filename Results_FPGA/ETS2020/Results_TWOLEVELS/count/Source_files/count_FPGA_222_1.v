// Benchmark "FAU" written by ABC on Thu Jul 30 16:49:25 2020
...
module FAU ( 
  ...
  assign new_n62_ = (new_n60_ | ~x24) & (~new_n55_ | ~new_n63_);
  ...
  assign z14 = (x16 & (new_n87_ | (~new_n83_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n87_ = new_n56_ & new_n66_ & new_n88_ & new_n89_;
  assign new_n88_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n89_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n92_ | (x16 & ((new_n65_ & new_n91_) | (~new_n87_ & x34)));
