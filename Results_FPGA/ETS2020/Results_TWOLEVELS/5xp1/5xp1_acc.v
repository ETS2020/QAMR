// Benchmark "FAU" written by ABC on Mon Jul 27 15:05:31 2020
...
module FAU ( 
  ...
  assign new_n23_ = (x0 | (((x2 & x3) | (x6 & (x1 | x4))) & (x1 | x6))) & (x4 | x6);
  assign z2 = (~new_n25_ & ~x6) | new_n27_ | (~new_n26_ & x6);
  assign new_n25_ = x4 ? ((x2 | (x0 & (x3 | x5))) & (x1 | x5) & (x0 | (x3 & x5))) : ((~x1 | ((~x0 | (~x2 & ~x3)) & (~x2 | ~x3 | ~x5))) & (~x0 | ~x5));
  assign new_n26_ = x4 ? ((~x1 | (~x0 & ~x5)) & (~x0 | (~x2 & ~x5))) : ((x0 | x5) & (x1 | ((x2 | x5) & (x0 | (x2 & x3)))));
  assign new_n27_ = ~x0 & ~x1 & x2 & x3 & x4 & x5;
