// Benchmark "FAU" written by ABC on Sat Aug 29 06:49:45 2020
...
module FAU ( 
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n361_ : ~new_n356_)) : ~new_n339_;
  assign new_n339_ = ~new_n354_ & (new_n112_ | (x70 ? new_n350_ : (~new_n340_ & ~new_n346_)));
  assign new_n340_ = x68 & ~x69 & (x65 ? (~new_n343_ & ~x71) : (~new_n341_ & x71));
  assign new_n341_ = (~x12 | (~new_n342_ & x00)) & (~x00 | new_n342_ | x12);
  assign new_n342_ = ~x13 & ~x14 & ~x15;
  assign new_n343_ = (new_n126_ | ~x60) & (new_n344_ | ~x72) & (new_n345_ | x72);
  assign new_n344_ = (x73 | (x74 ? ~x55 : ~x56)) & (~x52 | ~x73 | x74);
  assign new_n345_ = (~x73 | (x74 ? ~x57 : ~x58)) & (~x59 | x73 | ~x74);
  assign new_n346_ = x65 & ~x68 & x69 & ~new_n347_ & x71;
  assign new_n347_ = (new_n126_ | ~x28) & (new_n348_ | ~x72) & (new_n349_ | x72);
  assign new_n348_ = (x73 | (x74 ? ~x23 : ~x24)) & (~x20 | ~x73 | x74);
  assign new_n349_ = (~x73 | (x74 ? ~x25 : ~x26)) & (~x27 | x73 | ~x74);
  assign new_n350_ = x65 ? (x68 | ~x69 | (~new_n351_ & new_n352_)) : (~x68 | ~new_n353_ | x69);
  assign new_n351_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n352_ = x71 ? (x72 ? new_n344_ : new_n345_) : (x72 ? new_n348_ : new_n349_);
  assign new_n353_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n354_ = x65 & ~x66 & ~x67 & x68 & ~new_n355_ & ~x69;
  assign new_n355_ = x70 ? ~new_n353_ : (~x71 | ((~x12 | (~new_n342_ & x00)) & (~x00 | new_n342_ | x12)));
  assign new_n356_ = x68 ? (~new_n358_ | x69) : (x67 ? new_n359_ : (new_n357_ | ~x69));
  assign new_n357_ = (new_n347_ | (~x70 ^ x71)) & (~x70 | new_n343_ | ~x71);
  assign new_n358_ = ~x70 & ~x71 & (x67 ? x44 : ~new_n343_);
  assign new_n359_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n360_ | ~x70);
  assign new_n360_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n361_ = ~x67 & ((~new_n359_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n386_ : ~new_n379_)) : ~new_n363_;
  assign new_n363_ = ((~x66 & ~x67) | (~new_n364_ & ~new_n374_)) & (~x65 | x66 | ~new_n378_ | x67);
  ...
  assign new_n366_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n367_ = x61 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n372_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n373_ = ~x72 & ((x73 & (x74 ? x26 : x27)) | (x28 & ~x73 & x74));
  assign new_n374_ = x70 & (x65 ? (~x68 & ~new_n375_ & x69) : (x68 & new_n377_ & ~x69));
  assign new_n375_ = ~new_n376_ & (x71 | (~new_n372_ & ~new_n373_)) & (~x71 | (~new_n368_ & ~new_n369_));
  assign new_n376_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n377_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n378_ = x68 & ~x69 & (x70 ? new_n377_ : new_n366_);
  assign new_n379_ = x68 ? (~new_n383_ | x69) : (x67 ? new_n384_ : (new_n380_ | ~x69));
  assign new_n380_ = ((new_n382_ & ~new_n371_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n381_ & ~new_n367_));
  assign new_n381_ = ~new_n368_ & ~new_n369_;
  assign new_n382_ = ~new_n372_ & ~new_n373_;
  assign new_n383_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n381_ | new_n367_));
  assign new_n384_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n385_ | ~x70);
  assign new_n385_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n386_ = ~x67 & ((~new_n384_ & ~x68) | (new_n108_ & x45 & x68));
  assign z15 = x68 ? (~new_n399_ & ~x69) : (x64 ? new_n388_ : new_n398_);
  assign new_n388_ = ~x65 & (x66 ? (~new_n396_ & ~x67) : (x67 ? ~new_n396_ : (~new_n389_ & x69)));
  assign new_n389_ = (new_n390_ | (~x70 ^ x71)) & (~x70 | new_n393_ | ~x71);
  assign new_n390_ = (new_n126_ | ~x31) & (new_n391_ | ~x72) & (new_n392_ | x72);
  assign new_n391_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n392_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n393_ = (new_n126_ | ~x63) & (new_n394_ | ~x72) & (new_n395_ | x72);
  assign new_n394_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n395_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n396_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n397_ | ~x70);
  assign new_n397_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n398_ = x65 & x69 & ~new_n389_ & ~new_n112_;
  assign new_n399_ = x64 ? (~new_n401_ | x65) : ((new_n400_ | new_n112_) & (~new_n402_ | ~x65));
  assign new_n400_ = (x70 | ((~x65 | new_n393_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n401_ = ~x70 & ~x71 & ((~x66 & ~new_n393_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n402_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z14 = 1'b0;
endmodule
