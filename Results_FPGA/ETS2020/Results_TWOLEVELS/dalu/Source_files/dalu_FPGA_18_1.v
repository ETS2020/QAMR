// Benchmark "FAU" written by ABC on Sat Aug 29 05:33:52 2020
...
module FAU ( 
  ...
  assign new_n190_ = x66 & ~x67 & ((~new_n188_ & ~x68) | (new_n108_ & x36 & x68));
  assign z05 = x64 ? (~x65 & (new_n203_ | new_n208_)) : ~new_n192_;
  ...
  assign new_n271_ = (new_n126_ | ~x57) & (new_n272_ | ~x72) & (new_n273_ | x72);
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n307_ : ~new_n302_)) : ~new_n286_;
  assign new_n286_ = ~new_n300_ & (new_n112_ | (x70 ? new_n296_ : (~new_n287_ & ~new_n292_)));
  assign new_n287_ = x68 & ~x69 & (x65 ? (~new_n288_ & ~x71) : new_n291_);
  assign new_n288_ = (new_n126_ | ~x60) & (new_n289_ | ~x72) & (new_n290_ | x72);
  assign new_n289_ = (x73 | (x74 ? ~x55 : ~x56)) & (~x52 | ~x73 | x74);
  assign new_n290_ = (~x73 | (x74 ? ~x57 : ~x58)) & (~x59 | x73 | ~x74);
  assign new_n291_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  assign new_n292_ = x65 & ~x68 & x69 & ~new_n293_ & x71;
  assign new_n293_ = (new_n126_ | ~x28) & (new_n294_ | ~x72) & (new_n295_ | x72);
  assign new_n294_ = (x73 | (x74 ? ~x23 : ~x24)) & (~x20 | ~x73 | x74);
  assign new_n295_ = (~x73 | (x74 ? ~x25 : ~x26)) & (~x27 | x73 | ~x74);
  assign new_n296_ = x65 ? (x68 | ~x69 | (~new_n297_ & new_n298_)) : (~x68 | ~new_n299_ | x69);
  assign new_n297_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n298_ = x71 ? (x72 ? new_n289_ : new_n290_) : (x72 ? new_n294_ : new_n295_);
  assign new_n299_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n300_ = x65 & new_n301_ & ~x66;
  assign new_n301_ = ~x67 & x68 & ~x69 & (x70 ? new_n299_ : new_n291_);
  assign new_n302_ = x68 ? (~new_n304_ | x69) : (x67 ? new_n305_ : (new_n303_ | ~x69));
  assign new_n303_ = (new_n293_ | (~x70 ^ x71)) & (~x70 | new_n288_ | ~x71);
  assign new_n304_ = ~x70 & ~x71 & (x67 ? x44 : ~new_n288_);
  assign new_n305_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n306_ | ~x70);
  assign new_n306_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n307_ = ~x67 & ((~new_n305_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n330_ : ~new_n325_)) : ~new_n309_;
  assign new_n309_ = ~new_n323_ & (new_n112_ | (x70 ? new_n319_ : (~new_n310_ & ~new_n315_)));
  assign new_n310_ = x68 & ~x69 & (x65 ? (~new_n311_ & ~x71) : new_n314_);
  assign new_n311_ = (new_n126_ | ~x61) & (new_n312_ | ~x72) & (new_n313_ | x72);
  assign new_n312_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n313_ = (~x73 | (x74 ? ~x58 : ~x59)) & (~x60 | x73 | ~x74);
  assign new_n314_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n315_ = x65 & ~x68 & x69 & ~new_n316_ & x71;
  assign new_n316_ = (new_n126_ | ~x29) & (new_n317_ | ~x72) & (new_n318_ | x72);
  assign new_n317_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n318_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n319_ = x65 ? (x68 | ~x69 | (~new_n320_ & new_n321_)) : (~x68 | ~new_n322_ | x69);
  assign new_n320_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n321_ = x71 ? (x72 ? new_n312_ : new_n313_) : (x72 ? new_n317_ : new_n318_);
  assign new_n322_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n323_ = x65 & new_n324_ & ~x66;
  assign new_n324_ = ~x67 & x68 & ~x69 & (x70 ? new_n322_ : new_n314_);
  assign new_n325_ = x68 ? (~new_n327_ | x69) : (x67 ? new_n328_ : (new_n326_ | ~x69));
  assign new_n326_ = (new_n316_ | (~x70 ^ x71)) & (~x70 | new_n311_ | ~x71);
  assign new_n327_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n311_);
  assign new_n328_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n329_ | ~x70);
  assign new_n329_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n330_ = ~x67 & ((~new_n328_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n353_ : ~new_n348_)) : ~new_n332_;
  assign new_n332_ = ~new_n346_ & (new_n112_ | (x70 ? new_n342_ : (~new_n333_ & ~new_n338_)));
  assign new_n333_ = x68 & ~x69 & (x65 ? (~new_n334_ & ~x71) : (~new_n337_ & x71));
  assign new_n334_ = (new_n126_ | ~x62) & (new_n335_ | ~x72) & (new_n336_ | x72);
  assign new_n335_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n336_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n337_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n338_ = x65 & ~x68 & x69 & ~new_n339_ & x71;
  assign new_n339_ = (new_n126_ | ~x30) & (new_n340_ | ~x72) & (new_n341_ | x72);
  assign new_n340_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n341_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n342_ = x65 ? (x68 | ~x69 | (~new_n343_ & new_n344_)) : (~x68 | ~new_n345_ | x69);
  assign new_n343_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n344_ = x71 ? (x72 ? new_n335_ : new_n336_) : (x72 ? new_n340_ : new_n341_);
  assign new_n345_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n346_ = x65 & ~x66 & ~x67 & x68 & ~new_n347_ & ~x69;
  assign new_n347_ = x70 ? ~new_n345_ : (new_n337_ | ~x71);
  assign new_n348_ = x68 ? (~new_n350_ | x69) : (x67 ? new_n351_ : (new_n349_ | ~x69));
  assign new_n349_ = (new_n339_ | (~x70 ^ x71)) & (~x70 | new_n334_ | ~x71);
  assign new_n350_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n334_);
  assign new_n351_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n352_ | ~x70);
  assign new_n352_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n353_ = ~x67 & ((~new_n351_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x68 ? (~new_n366_ & ~x69) : (x64 ? new_n355_ : new_n365_);
  assign new_n355_ = ~x65 & (x66 ? (~new_n363_ & ~x67) : (x67 ? ~new_n363_ : (~new_n356_ & x69)));
  assign new_n356_ = (new_n357_ | (~x70 ^ x71)) & (~x70 | new_n360_ | ~x71);
  assign new_n357_ = (new_n126_ | ~x31) & (new_n358_ | ~x72) & (new_n359_ | x72);
  assign new_n358_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n359_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n360_ = (new_n126_ | ~x63) & (new_n361_ | ~x72) & (new_n362_ | x72);
  assign new_n361_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n362_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n363_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n364_ | ~x70);
  assign new_n364_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n365_ = x65 & x69 & ~new_n356_ & ~new_n112_;
  assign new_n366_ = x64 ? (~new_n368_ | x65) : ((new_n367_ | new_n112_) & (~new_n369_ | ~x65));
  assign new_n367_ = (x70 | ((~x65 | new_n360_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n368_ = ~x70 & ~x71 & ((~x66 & ~new_n360_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n369_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z10 = 1'b0;
  assign z11 = 1'b0;
endmodule
