...
module FAU ( 
  ...
  assign new_n268_ = (~x09 | (~new_n157_ & x00)) & (~x00 | new_n157_ | x09);
  assign new_n269_ = (~x41 | (~new_n160_ & x32)) & (~x32 | new_n160_ | x41);
  ...
  assign z10 = x64 ? (~new_n302_ & ~x65) : (new_n285_ | (x65 & new_n309_ & ~x66));
  assign new_n285_ = ~new_n112_ & (x70 ? ~new_n297_ : (new_n286_ | new_n293_));
  assign new_n286_ = x68 & ~x69 & (x65 ? (~new_n289_ & ~x71) : new_n287_);
  assign new_n287_ = x71 & ((x10 & (new_n288_ | ~x00)) | (x00 & ~new_n288_ & ~x10));
  assign new_n288_ = ~x11 & ~x12 & ~x13 & ~x14 & ~x15;
  assign new_n289_ = ~new_n290_ & (new_n292_ | x72) & (new_n291_ | ~x72);
  ...
  assign new_n294_ = (~x26 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n295_ | ~x72) & (new_n296_ | x72);
  assign new_n295_ = (x73 | (x74 ? ~x21 : ~x22)) & (~x18 | ~x73 | x74);
  assign new_n296_ = (~x73 | (x74 ? ~x23 : ~x24)) & (~x25 | x73 | ~x74);
  assign new_n297_ = x65 ? (x68 | ~x69 | (new_n298_ & ~new_n301_)) : (~x68 | ~new_n299_ | x69);
  assign new_n298_ = x71 ? (x72 ? new_n291_ : new_n292_) : (x72 ? new_n295_ : new_n296_);
  ...
  assign new_n302_ = x66 ? (new_n308_ | x67) : (x68 ? ~new_n307_ : new_n303_);
  assign new_n303_ = x67 ? new_n304_ : (~x69 | (~new_n306_ & (new_n294_ | new_n193_)));
  assign new_n304_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x58 | ~x69) & (new_n305_ | ~x70);
  assign new_n305_ = (~x42 | ~x71) & (~x26 | x69 | x71);
  assign new_n306_ = x70 & x71 & (new_n290_ | (~new_n292_ & ~x72) | (~new_n291_ & x72));
  assign new_n307_ = ~x69 & ~x70 & ~x71 & (x67 ? x42 : ~new_n289_);
  assign new_n308_ = (~new_n108_ | ~x42 | ~x68) & (new_n304_ | x68);
  assign new_n309_ = ~x67 & x68 & ~x69 & (x70 ? new_n299_ : new_n287_);
  ...
  assign new_n330_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n331_ | ~x70);
  assign new_n331_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n332_ = ~x67 & ((~new_n330_ & ~x68) | (new_n108_ & x46 & x68));
  ...
  assign new_n342_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n343_ | ~x70);
  assign new_n343_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n344_ = x65 & x69 & ~new_n335_ & ~new_n112_;
  assign new_n345_ = x64 ? (~new_n347_ | x65) : ((new_n346_ | new_n112_) & (~new_n348_ | ~x65));
