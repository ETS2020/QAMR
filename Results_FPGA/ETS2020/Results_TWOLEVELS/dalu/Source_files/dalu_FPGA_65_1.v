// Benchmark "FAU" written by ABC on Sat Aug 29 05:50:34 2020
...
module FAU ( 
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n288_ : ~new_n283_)) : ~new_n266_;
  assign new_n266_ = ~new_n281_ & (new_n112_ | (x70 ? new_n277_ : (~new_n267_ & ~new_n273_)));
  assign new_n267_ = x68 & ~x69 & (x65 ? (~new_n270_ & ~x71) : (~new_n268_ & x71));
  assign new_n268_ = (~x00 | new_n269_ | x13) & (~x13 | (~new_n269_ & x00));
  assign new_n269_ = ~x14 & ~x15;
  assign new_n270_ = (~x61 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n271_ | ~x72) & (new_n272_ | x72);
  assign new_n271_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n272_ = (~x73 | (x74 ? ~x58 : ~x59)) & (~x60 | x73 | ~x74);
  assign new_n273_ = x65 & ~x68 & x69 & ~new_n274_ & x71;
  assign new_n274_ = (~x29 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n275_ | ~x72) & (new_n276_ | x72);
  assign new_n275_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n276_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n277_ = x65 ? (x68 | ~x69 | (new_n278_ & ~new_n279_)) : (~x68 | ~new_n280_ | x69);
  assign new_n278_ = x71 ? (x72 ? new_n271_ : new_n272_) : (x72 ? new_n275_ : new_n276_);
  assign new_n279_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n280_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n281_ = x65 & ~x66 & ~x67 & x68 & ~new_n282_ & ~x69;
  assign new_n282_ = x70 ? ~new_n280_ : (~x71 | ((~x13 | (~new_n269_ & x00)) & (~x00 | new_n269_ | x13)));
  assign new_n283_ = x68 ? (~new_n285_ | x69) : (x67 ? new_n286_ : (new_n284_ | ~x69));
  assign new_n284_ = (new_n274_ | (~x70 ^ x71)) & (~x70 | new_n270_ | ~x71);
  assign new_n285_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n270_);
  assign new_n286_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n287_ | ~x70);
  assign new_n287_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n288_ = ~x67 & ((~new_n286_ & ~x68) | (new_n108_ & x45 & x68));
  ...
  assign new_n297_ = (~x30 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n298_ | ~x72) & (new_n299_ | x72);
  ...
  assign new_n301_ = x71 ? (x72 ? new_n293_ : new_n294_) : (x72 ? new_n298_ : new_n299_);
  assign new_n302_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x62 : x30);
  ...
  assign new_n315_ = (~x31 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n316_ | ~x72) & (new_n317_ | x72);
  assign new_n316_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n317_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n318_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n319_ | ~x72) & (new_n320_ | x72);
