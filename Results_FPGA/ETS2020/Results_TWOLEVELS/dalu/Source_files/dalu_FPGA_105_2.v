// Benchmark "FAU" written by ABC on Sat Aug 29 06:05:32 2020
...
module FAU ( 
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n166_ : ~new_n159_)) : ~new_n143_;
  assign new_n143_ = ((~new_n144_ & ~new_n154_) | (~x66 & ~x67)) & (~x65 | x66 | ~new_n158_ | x67);
  assign new_n144_ = ~x70 & ((x68 & ~new_n145_ & ~x69) | (x65 & ~x68 & new_n150_ & x69));
  assign new_n145_ = x65 ? (x71 | (~new_n147_ & ~new_n148_ & ~new_n149_)) : ~new_n146_;
  assign new_n146_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n147_ = x61 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n148_ = x72 & ((~x73 & (x74 ? x56 : x57)) | (x53 & x73 & ~x74));
  assign new_n149_ = ~x72 & ((x73 & (x74 ? x58 : x59)) | (x60 & ~x73 & x74));
  assign new_n150_ = x71 & (new_n151_ | new_n152_ | new_n153_);
  assign new_n151_ = x29 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n152_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n153_ = ~x72 & ((x73 & (x74 ? x26 : x27)) | (x28 & ~x73 & x74));
  assign new_n154_ = x70 & (x65 ? (~x68 & ~new_n155_ & x69) : (x68 & new_n157_ & ~x69));
  assign new_n155_ = ~new_n156_ & (~x71 | (~new_n148_ & ~new_n149_)) & (x71 | (~new_n152_ & ~new_n153_));
  assign new_n156_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n157_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n158_ = x68 & ~x69 & (x70 ? new_n157_ : new_n146_);
  assign new_n159_ = x68 ? (~new_n163_ | x69) : (x67 ? new_n164_ : (new_n160_ | ~x69));
  assign new_n160_ = ((~x70 ^ x71) | (new_n162_ & ~new_n151_)) & (~x70 | ~x71 | (new_n161_ & ~new_n147_));
  assign new_n161_ = ~new_n148_ & ~new_n149_;
  assign new_n162_ = ~new_n152_ & ~new_n153_;
  assign new_n163_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n161_ | new_n147_));
  assign new_n164_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n165_ | ~x70) & (x70 | x71 | ~x61 | ~x69);
  assign new_n165_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n166_ = ~x67 & ((~new_n164_ & ~x68) | (new_n118_ & ~x69 & x45 & x68));
  assign z15 = x68 ? (~new_n179_ & ~x69) : (x64 ? new_n168_ : new_n178_);
  assign new_n168_ = ~x65 & (x66 ? (~new_n176_ & ~x67) : (x67 ? ~new_n176_ : (~new_n169_ & x69)));
  assign new_n169_ = (new_n170_ | (~x70 ^ x71)) & (~x70 | new_n173_ | ~x71);
  assign new_n170_ = (~x31 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n171_ | ~x72) & (new_n172_ | x72);
  assign new_n171_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n172_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n173_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n174_ | ~x72) & (new_n175_ | x72);
  assign new_n174_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n175_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n176_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n177_ | ~x70) & (x70 | x71 | ~x63 | ~x69);
  assign new_n177_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n178_ = x65 & x69 & ~new_n169_ & ~new_n111_;
  assign new_n179_ = x64 ? (~new_n181_ | x65) : ((new_n180_ | new_n111_) & (~new_n182_ | ~x65));
  assign new_n180_ = (x70 | ((~x65 | new_n173_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n181_ = ~x70 & ~x71 & ((x47 & (x66 ^ x67)) | (~x66 & ~new_n173_ & ~x67));
  assign new_n182_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
