// Benchmark "FAU" written by ABC on Sat Aug 29 06:44:26 2020
...
module FAU ( 
  ...
  assign new_n118_ = x71 & ((x10 & (new_n119_ | ~x00)) | (x00 & ~new_n119_ & ~x10));
  assign new_n119_ = ~x13 & ~x14 & ~x15 & ~x11 & ~x12;
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n190_ : ~new_n183_)) : ~new_n167_;
  assign new_n167_ = ((~new_n168_ & ~new_n178_) | (~x66 & ~x67)) & (~x65 | x66 | ~new_n182_ | x67);
  assign new_n168_ = ~x70 & ((x68 & ~new_n169_ & ~x69) | (x65 & ~x68 & new_n174_ & x69));
  assign new_n169_ = x65 ? (x71 | (~new_n171_ & ~new_n172_ & ~new_n173_)) : ~new_n170_;
  assign new_n170_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  assign new_n171_ = x60 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n172_ = x72 & ((~x73 & (x74 ? x55 : x56)) | (x52 & x73 & ~x74));
  assign new_n173_ = ~x72 & ((x73 & (x74 ? x57 : x58)) | (x59 & ~x73 & x74));
  assign new_n174_ = x71 & (new_n175_ | new_n176_ | new_n177_);
  assign new_n175_ = x28 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n176_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n177_ = ~x72 & ((x73 & (x74 ? x25 : x26)) | (x27 & ~x73 & x74));
  assign new_n178_ = x70 & (x65 ? (~x68 & ~new_n179_ & x69) : (x68 & new_n181_ & ~x69));
  assign new_n179_ = ~new_n180_ & (~x71 | (~new_n172_ & ~new_n173_)) & (x71 | (~new_n176_ & ~new_n177_));
  assign new_n180_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n181_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n182_ = x68 & ~x69 & (x70 ? new_n181_ : new_n170_);
  assign new_n183_ = x68 ? (~new_n187_ | x69) : (x67 ? new_n188_ : (new_n184_ | ~x69));
  assign new_n184_ = ((~x70 ^ x71) | (new_n186_ & ~new_n175_)) & (~x70 | ~x71 | (new_n185_ & ~new_n171_));
  assign new_n185_ = ~new_n172_ & ~new_n173_;
  assign new_n186_ = ~new_n176_ & ~new_n177_;
  assign new_n187_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n185_ | new_n171_));
  assign new_n188_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n189_ | ~x70) & (~x60 | ~x69 | x70 | x71);
  assign new_n189_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n190_ = ~x67 & ((~new_n188_ & ~x68) | (x44 & x68 & new_n114_ & ~x69));
  assign z13 = x64 ? (~x65 & (x66 ? new_n213_ : ~new_n208_)) : ~new_n192_;
  assign new_n192_ = ~new_n206_ & (new_n132_ | (x70 ? new_n202_ : (~new_n193_ & ~new_n198_)));
  assign new_n193_ = x68 & ~x69 & (x65 ? (~new_n194_ & ~x71) : new_n197_);
  assign new_n194_ = (new_n97_ | ~x61) & (new_n195_ | ~x72) & (new_n196_ | x72);
  assign new_n195_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n196_ = (~x73 | (x74 ? ~x58 : ~x59)) & (~x60 | x73 | ~x74);
  assign new_n197_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n198_ = x65 & ~x68 & x69 & ~new_n199_ & x71;
  assign new_n199_ = (new_n97_ | ~x29) & (new_n200_ | ~x72) & (new_n201_ | x72);
  assign new_n200_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n201_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n202_ = x65 ? (x68 | ~x69 | (~new_n203_ & new_n204_)) : (~x68 | ~new_n205_ | x69);
  assign new_n203_ = ~new_n97_ & (x71 ? x61 : x29);
  assign new_n204_ = x71 ? (x72 ? new_n195_ : new_n196_) : (x72 ? new_n200_ : new_n201_);
  assign new_n205_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n206_ = x65 & new_n207_ & ~x66;
  assign new_n207_ = ~x67 & x68 & ~x69 & (x70 ? new_n205_ : new_n197_);
  assign new_n208_ = x68 ? (~new_n210_ | x69) : (x67 ? new_n211_ : (new_n209_ | ~x69));
  assign new_n209_ = (new_n199_ | (~x70 ^ x71)) & (~x70 | new_n194_ | ~x71);
  assign new_n210_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n194_);
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n236_ : ~new_n231_)) : ~new_n215_;
  assign new_n215_ = ~new_n229_ & (new_n132_ | (x70 ? new_n225_ : (~new_n216_ & ~new_n221_)));
  assign new_n216_ = x68 & ~x69 & (x65 ? (~new_n217_ & ~x71) : (~new_n220_ & x71));
  assign new_n217_ = (new_n97_ | ~x62) & (new_n218_ | ~x72) & (new_n219_ | x72);
  assign new_n218_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n219_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n220_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n221_ = x65 & ~x68 & x69 & ~new_n222_ & x71;
  assign new_n222_ = (new_n97_ | ~x30) & (new_n223_ | ~x72) & (new_n224_ | x72);
  assign new_n223_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n224_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n225_ = x65 ? (x68 | ~x69 | (~new_n226_ & new_n227_)) : (~x68 | ~new_n228_ | x69);
  assign new_n226_ = ~new_n97_ & (x71 ? x62 : x30);
  assign new_n227_ = x71 ? (x72 ? new_n218_ : new_n219_) : (x72 ? new_n223_ : new_n224_);
  assign new_n228_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n229_ = x65 & ~x66 & ~x67 & x68 & ~new_n230_ & ~x69;
  assign new_n230_ = x70 ? ~new_n228_ : (new_n220_ | ~x71);
  assign new_n231_ = x68 ? (~new_n233_ | x69) : (x67 ? new_n234_ : (new_n232_ | ~x69));
  assign new_n232_ = (new_n222_ | (~x70 ^ x71)) & (~x70 | new_n217_ | ~x71);
  assign new_n233_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n217_);
  assign new_n234_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n235_ | ~x70) & (~x62 | ~x69 | x70 | x71);
  assign new_n235_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n236_ = ~x67 & ((~new_n234_ & ~x68) | (x46 & x68 & new_n114_ & ~x69));
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
