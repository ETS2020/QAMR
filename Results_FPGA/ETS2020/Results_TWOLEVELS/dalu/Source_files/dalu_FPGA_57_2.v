...
module FAU ( 
  ...
  assign z06 = x64 ? (~x65 & (x66 ? new_n113_ : ~new_n108_)) : ~new_n94_;
  ...
  assign new_n96_ = (new_n97_ | ~x22) & (new_n98_ | ~x72) & (new_n99_ | x72);
  assign new_n97_ = x72 ? (~x73 | ~x74) : (x73 | x74);
  assign new_n98_ = (x73 | (x74 ? ~x17 : ~x18)) & (~x16 | ~x73 | x74);
  assign new_n99_ = (~x73 | (x74 ? ~x19 : ~x20)) & (~x21 | x73 | ~x74);
  assign new_n100_ = (new_n97_ | ~x54) & (new_n101_ | ~x72) & (new_n102_ | x72);
  assign new_n101_ = (x73 | (x74 ? ~x49 : ~x50)) & (~x48 | ~x73 | x74);
  assign new_n102_ = (~x73 | (x74 ? ~x51 : ~x52)) & (~x53 | x73 | ~x74);
  assign new_n103_ = x68 & ~x69 & (x70 ? (~new_n106_ & ~x71) : (~new_n104_ & x71));
  assign new_n104_ = x00 ? (x06 | (new_n105_ & ~x04 & ~x05 & ~x07)) : ~x06;
  assign new_n105_ = ~x12 & ~x13 & ~x14 & ~x15;
  assign new_n106_ = x32 ? (x38 | (new_n107_ & ~x36 & ~x37 & ~x39)) : ~x38;
  ...
  assign new_n110_ = ~x69 & ~x70 & ~x71 & (x67 ? x38 : ~new_n100_);
  assign new_n111_ = (~x06 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n112_ | ~x70) & (~x54 | ~x69 | x70 | x71);
  assign new_n112_ = (~x38 | ~x71) & (~x22 | x69 | x71);
  assign new_n113_ = ~x67 & ((~new_n111_ & ~x68) | (x38 & x68 & new_n114_ & ~x69));
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n211_ : ~new_n206_)) : ~new_n190_;
  assign new_n190_ = ~new_n204_ & (new_n132_ | (x70 ? new_n200_ : (~new_n191_ & ~new_n196_)));
  assign new_n191_ = x68 & ~x69 & (x65 ? (~new_n192_ & ~x71) : new_n195_);
  assign new_n192_ = (new_n97_ | ~x61) & (new_n193_ | ~x72) & (new_n194_ | x72);
  assign new_n193_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n194_ = (~x73 | (x74 ? ~x58 : ~x59)) & (~x60 | x73 | ~x74);
  assign new_n195_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n196_ = x65 & ~x68 & x69 & ~new_n197_ & x71;
  assign new_n197_ = (new_n97_ | ~x29) & (new_n198_ | ~x72) & (new_n199_ | x72);
  assign new_n198_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n199_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n200_ = x65 ? (x68 | ~x69 | (~new_n201_ & new_n202_)) : (~x68 | ~new_n203_ | x69);
  assign new_n201_ = ~new_n97_ & (x71 ? x61 : x29);
  assign new_n202_ = x71 ? (x72 ? new_n193_ : new_n194_) : (x72 ? new_n198_ : new_n199_);
  assign new_n203_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n204_ = x65 & new_n205_ & ~x66;
  assign new_n205_ = ~x67 & x68 & ~x69 & (x70 ? new_n203_ : new_n195_);
  assign new_n206_ = x68 ? (~new_n208_ | x69) : (x67 ? new_n209_ : (new_n207_ | ~x69));
  assign new_n207_ = (new_n197_ | (~x70 ^ x71)) & (~x70 | new_n192_ | ~x71);
  assign new_n208_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n192_);
  assign new_n209_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n210_ | ~x70) & (~x61 | ~x69 | x70 | x71);
  assign new_n210_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n211_ = ~x67 & ((~new_n209_ & ~x68) | (x45 & x68 & new_n114_ & ~x69));
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
