// Benchmark "FAU" written by ABC on Sat Aug 29 06:10:23 2020
...
module FAU ( 
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n336_ : ~new_n331_)) : ~new_n314_;
  assign new_n314_ = ~new_n329_ & (new_n112_ | (x70 ? new_n324_ : (~new_n315_ & ~new_n320_)));
  assign new_n315_ = x68 & ~x69 & (x65 ? (~new_n317_ & ~x71) : (~new_n316_ & x71));
  assign new_n316_ = (~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11);
  assign new_n317_ = (new_n126_ | ~x59) & (new_n318_ | ~x72) & (new_n319_ | x72);
  ...
  assign new_n321_ = (new_n126_ | ~x27) & (new_n322_ | ~x72) & (new_n323_ | x72);
  ...
  assign new_n325_ = ~new_n126_ & (x71 ? x59 : x27);
  assign new_n326_ = x71 ? (x72 ? new_n318_ : new_n319_) : (x72 ? new_n322_ : new_n323_);
  ...
  assign new_n330_ = x70 ? (new_n328_ | x71) : (~x71 | ((~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11)));
  assign new_n331_ = x68 ? (~new_n333_ | x69) : (x67 ? new_n334_ : (new_n332_ | ~x69));
  assign new_n332_ = (new_n321_ | (~x70 ^ x71)) & (~x70 | new_n317_ | ~x71);
  assign new_n333_ = ~x70 & ~x71 & (x67 ? x43 : ~new_n317_);
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n361_ : ~new_n354_)) : ~new_n338_;
  ...
  assign new_n340_ = x65 ? (x71 | (~new_n342_ & ~new_n343_ & ~new_n344_)) : ~new_n341_;
  ...
  assign new_n353_ = x68 & ~x69 & (x70 ? new_n352_ : new_n341_);
  ...
  assign new_n358_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n356_ | new_n342_));
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n384_ : ~new_n379_)) : ~new_n363_;
  assign new_n363_ = ~new_n377_ & (new_n112_ | (x70 ? new_n373_ : (~new_n364_ & ~new_n369_)));
  assign new_n364_ = x68 & ~x69 & (x65 ? (~new_n365_ & ~x71) : (~new_n368_ & x71));
  assign new_n365_ = (new_n126_ | ~x62) & (new_n366_ | ~x72) & (new_n367_ | x72);
  assign new_n366_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n367_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n368_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n369_ = x65 & ~x68 & x69 & ~new_n370_ & x71;
  assign new_n370_ = (new_n126_ | ~x30) & (new_n371_ | ~x72) & (new_n372_ | x72);
  ...
  assign new_n374_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n375_ = x71 ? (x72 ? new_n366_ : new_n367_) : (x72 ? new_n371_ : new_n372_);
  assign new_n376_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n377_ = x65 & ~x66 & ~x67 & x68 & ~new_n378_ & ~x69;
  assign new_n378_ = x70 ? ~new_n376_ : (new_n368_ | ~x71);
  assign new_n379_ = x68 ? (~new_n381_ | x69) : (x67 ? new_n382_ : (new_n380_ | ~x69));
  assign new_n380_ = (new_n370_ | (~x70 ^ x71)) & (~x70 | new_n365_ | ~x71);
  assign new_n381_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n365_);
  assign new_n382_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n383_ | ~x70);
  assign new_n383_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n384_ = ~x67 & ((~new_n382_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x68 ? (~new_n397_ & ~x69) : (x64 ? new_n386_ : new_n396_);
  assign new_n386_ = ~x65 & (x66 ? (~new_n394_ & ~x67) : (x67 ? ~new_n394_ : (~new_n387_ & x69)));
  assign new_n387_ = (new_n388_ | (~x70 ^ x71)) & (~x70 | new_n391_ | ~x71);
  assign new_n388_ = (new_n126_ | ~x31) & (new_n389_ | ~x72) & (new_n390_ | x72);
  assign new_n389_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n390_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n391_ = (new_n126_ | ~x63) & (new_n392_ | ~x72) & (new_n393_ | x72);
  ...
  assign new_n396_ = x65 & x69 & ~new_n387_ & ~new_n112_;
  assign new_n397_ = x64 ? (~new_n399_ | x65) : ((new_n398_ | new_n112_) & (~new_n400_ | ~x65));
  assign new_n398_ = (x70 | ((~x65 | new_n391_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n399_ = ~x70 & ~x71 & ((~x66 & ~new_n391_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n400_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z13 = 1'b0;
endmodule
