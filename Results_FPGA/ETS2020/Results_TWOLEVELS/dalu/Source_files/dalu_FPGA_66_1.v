...
module FAU ( 
  ...
  assign new_n267_ = x68 & ~x69 & (x65 ? (~new_n268_ & ~x71) : new_n271_);
  ...
  assign new_n277_ = x71 ? (x72 ? new_n269_ : new_n270_) : (x72 ? new_n274_ : new_n275_);
  assign new_n278_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n279_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n280_ = x65 & new_n281_ & ~x66;
  assign new_n281_ = ~x67 & x68 & ~x69 & (x70 ? new_n279_ : new_n271_);
  assign new_n282_ = x68 ? (~new_n284_ | x69) : (x67 ? new_n285_ : (new_n283_ | ~x69));
  assign new_n283_ = (new_n273_ | (~x70 ^ x71)) & (~x70 | new_n268_ | ~x71);
  assign new_n284_ = ~x70 & ~x71 & (x67 ? x44 : ~new_n268_);
