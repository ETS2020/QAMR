// Benchmark "FAU" written by ABC on Sat Aug 29 05:39:40 2020
...
module FAU ( 
  ...
  assign new_n233_ = (~x55 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n234_ | ~x72) & (new_n235_ | x72);
  ...
  assign new_n270_ = (~x57 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n271_ | ~x72) & (new_n272_ | x72);
  ...
  assign new_n274_ = (~x25 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n275_ | ~x72) & (new_n276_ | x72);
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n306_ : ~new_n301_)) : ~new_n285_;
  assign new_n285_ = ~new_n299_ & (new_n112_ | (x70 ? new_n295_ : (~new_n286_ & ~new_n291_)));
  assign new_n286_ = x68 & ~x69 & (x65 ? (~new_n287_ & ~x71) : new_n290_);
  assign new_n287_ = (~x61 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n288_ | ~x72) & (new_n289_ | x72);
  assign new_n288_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n289_ = (~x73 | (x74 ? ~x58 : ~x59)) & (~x60 | x73 | ~x74);
  assign new_n290_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n291_ = x65 & ~x68 & x69 & ~new_n292_ & x71;
  assign new_n292_ = (~x29 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n293_ | ~x72) & (new_n294_ | x72);
  assign new_n293_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n294_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n295_ = x65 ? (x68 | ~x69 | (new_n296_ & ~new_n297_)) : (~x68 | ~new_n298_ | x69);
  assign new_n296_ = x71 ? (x72 ? new_n288_ : new_n289_) : (x72 ? new_n293_ : new_n294_);
  assign new_n297_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n298_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n299_ = x65 & new_n300_ & ~x66;
  assign new_n300_ = ~x67 & x68 & ~x69 & (x70 ? new_n298_ : new_n290_);
  assign new_n301_ = x68 ? (~new_n303_ | x69) : (x67 ? new_n304_ : (new_n302_ | ~x69));
  assign new_n302_ = (new_n292_ | (~x70 ^ x71)) & (~x70 | new_n287_ | ~x71);
  assign new_n303_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n287_);
  assign new_n304_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n305_ | ~x70);
  assign new_n305_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n306_ = ~x67 & ((~new_n304_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n329_ : ~new_n324_)) : ~new_n308_;
  assign new_n308_ = ~new_n322_ & (new_n112_ | (x70 ? new_n318_ : (~new_n309_ & ~new_n314_)));
  assign new_n309_ = x68 & ~x69 & (x65 ? (~new_n310_ & ~x71) : (~new_n313_ & x71));
  assign new_n310_ = (~x62 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n311_ | ~x72) & (new_n312_ | x72);
  assign new_n311_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n312_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n313_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n314_ = x65 & ~x68 & x69 & ~new_n315_ & x71;
  assign new_n315_ = (~x30 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n316_ | ~x72) & (new_n317_ | x72);
  assign new_n316_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n317_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n318_ = x65 ? (x68 | ~x69 | (new_n319_ & ~new_n320_)) : (~x68 | ~new_n321_ | x69);
  assign new_n319_ = x71 ? (x72 ? new_n311_ : new_n312_) : (x72 ? new_n316_ : new_n317_);
  assign new_n320_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x62 : x30);
  assign new_n321_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n322_ = x65 & ~x66 & ~x67 & x68 & ~new_n323_ & ~x69;
  assign new_n323_ = x70 ? ~new_n321_ : (new_n313_ | ~x71);
  assign new_n324_ = x68 ? (~new_n326_ | x69) : (x67 ? new_n327_ : (new_n325_ | ~x69));
  assign new_n325_ = (new_n315_ | (~x70 ^ x71)) & (~x70 | new_n310_ | ~x71);
  assign new_n326_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n310_);
  assign new_n327_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n328_ | ~x70);
  assign new_n328_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n329_ = ~x67 & ((~new_n327_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x68 ? (~new_n342_ & ~x69) : (x64 ? new_n331_ : new_n341_);
  assign new_n331_ = ~x65 & (x66 ? (~new_n339_ & ~x67) : (x67 ? ~new_n339_ : (~new_n332_ & x69)));
  assign new_n332_ = (new_n333_ | (~x70 ^ x71)) & (~x70 | new_n336_ | ~x71);
  assign new_n333_ = (~x31 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n334_ | ~x72) & (new_n335_ | x72);
  assign new_n334_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n335_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n336_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n337_ | ~x72) & (new_n338_ | x72);
  assign new_n337_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n338_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n339_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n340_ | ~x70);
  assign new_n340_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n341_ = x65 & x69 & ~new_n332_ & ~new_n112_;
  assign new_n342_ = x64 ? (~new_n344_ | x65) : ((new_n343_ | new_n112_) & (~new_n345_ | ~x65));
  assign new_n343_ = (x70 | ((~x65 | new_n336_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n344_ = ~x70 & ~x71 & ((~x66 & ~new_n336_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n345_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
endmodule
