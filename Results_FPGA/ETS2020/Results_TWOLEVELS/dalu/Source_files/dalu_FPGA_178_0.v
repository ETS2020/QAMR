...
module FAU ( 
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n336_ : ~new_n329_)) : ~new_n313_;
  assign new_n313_ = ((~x66 & ~x67) | (~new_n314_ & ~new_n324_)) & (~x65 | x66 | ~new_n328_ | x67);
  assign new_n314_ = ~x70 & ((x68 & ~new_n315_ & ~x69) | (x65 & ~x68 & new_n320_ & x69));
  assign new_n315_ = x65 ? (x71 | (~new_n317_ & ~new_n318_ & ~new_n319_)) : (new_n316_ | ~x71);
  assign new_n316_ = (~x11 | (x00 & (x14 | x15 | x12 | x13))) & (~x00 | x11 | (~x14 & ~x15 & ~x12 & ~x13));
  assign new_n317_ = x59 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n325_ = ~new_n326_ & (x71 | (~new_n322_ & ~new_n323_)) & (~x71 | (~new_n318_ & ~new_n319_));
  assign new_n326_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x59 : x27);
  assign new_n327_ = ~x71 & ((x43 & (new_n124_ | ~x32)) | (x32 & ~new_n124_ & ~x43));
  assign new_n328_ = x68 & ~x69 & (x70 ? new_n327_ : (~new_n316_ & x71));
  assign new_n329_ = x68 ? (~new_n333_ | x69) : (x67 ? new_n334_ : (new_n330_ | ~x69));
  assign new_n330_ = ((new_n332_ & ~new_n321_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n331_ & ~new_n317_));
  assign new_n331_ = ~new_n318_ & ~new_n319_;
  assign new_n332_ = ~new_n322_ & ~new_n323_;
  assign new_n333_ = ~x70 & ~x71 & (x67 ? x43 : (~new_n331_ | new_n317_));
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n361_ : ~new_n354_)) : ~new_n338_;
  ...
  assign new_n342_ = x61 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n343_ = x72 & ((~x73 & (x74 ? x56 : x57)) | (x53 & x73 & ~x74));
  assign new_n344_ = ~x72 & ((x73 & (x74 ? x58 : x59)) | (x60 & ~x73 & x74));
  ...
  assign new_n358_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n356_ | new_n342_));
