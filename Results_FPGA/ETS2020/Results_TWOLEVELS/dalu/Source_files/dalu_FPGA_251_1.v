// Benchmark "FAU" written by ABC on Sat Aug 29 06:52:44 2020
...
module FAU ( 
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n338_ : ~new_n331_)) : ~new_n315_;
  ...
  assign new_n317_ = x65 ? (x71 | (~new_n319_ & ~new_n320_ & ~new_n321_)) : ~new_n318_;
  ...
  assign new_n323_ = x28 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n324_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n325_ = ~x72 & ((x73 & (x74 ? x25 : x26)) | (x27 & ~x73 & x74));
  ...
  assign new_n328_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n329_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n330_ = x68 & ~x69 & (x70 ? new_n329_ : new_n318_);
  ...
  assign new_n335_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n333_ | new_n319_));
  ...
  assign new_n342_ = (new_n126_ | ~x61) & (new_n343_ | ~x72) & (new_n344_ | x72);
  ...
  assign new_n347_ = (new_n126_ | ~x29) & (new_n348_ | ~x72) & (new_n349_ | x72);
  ...
  assign new_n351_ = ~new_n126_ & (x71 ? x61 : x29);
