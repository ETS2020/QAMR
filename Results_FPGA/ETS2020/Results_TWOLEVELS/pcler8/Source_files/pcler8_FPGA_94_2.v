...
module FAU ( 
  ...
  assign z14 = x08 ? x05 : (x09 & ~new_n58_ & ~x10);
  assign new_n58_ = (~x24 | (new_n59_ & x22 & ~new_n60_ & x23)) & (~new_n59_ | ~x22 | ~x23 | x24);
  assign new_n59_ = x19 & x20 & x21;
  assign new_n60_ = x16 & x25 & x26;
  assign z15 = x08 ? x06 : (x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (~x25 | (new_n59_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n59_ | ~new_n63_ | ~x24 | x25);
