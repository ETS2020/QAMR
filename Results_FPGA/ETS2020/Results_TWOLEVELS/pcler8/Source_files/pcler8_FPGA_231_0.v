...
module FAU ( 
  ...
  assign z06 = x05 & x08;
  assign z07 = x06 & x08;
  assign z10 = x08 ? x01 : (x09 & ~new_n52_ & ~x10);
  assign new_n52_ = x20 ? (x19 & (~new_n53_ | ~x12 | ~x21 | ~x22)) : ~x19;
  ...
  assign z16 = x08 ? x07 : (new_n61_ & x09);
  assign new_n61_ = ~x10 & ((new_n64_ & new_n65_) | ((~new_n62_ | ~new_n63_) & x26));
  assign new_n62_ = x20 & x21 & ~x18 & x19;
