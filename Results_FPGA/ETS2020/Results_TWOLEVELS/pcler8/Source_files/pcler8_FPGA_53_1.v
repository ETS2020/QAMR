...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n53_, new_n54_, new_n56_, new_n58_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n65_, new_n66_, new_n68_, new_n69_, new_n70_,
    new_n72_, new_n74_, new_n75_, new_n76_, new_n77_, new_n78_;
  ...
  assign z13 = x08 ? x04 : (x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x23 | (new_n63_ & x21 & ~new_n66_ & x22)) & (~new_n63_ | ~x21 | ~x22 | x23);
  assign new_n66_ = x15 & x24 & x25 & x26;
  assign z14 = x08 ? x05 : (x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x24 | (new_n69_ & x22 & ~new_n70_ & x23)) & (~new_n69_ | ~x22 | ~x23 | x24);
  assign new_n69_ = x19 & x20 & x21;
  assign new_n70_ = x16 & x25 & x26;
  assign z15 = x08 ? x06 : (x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x25 | (new_n69_ & new_n59_ & x24 & (~x17 | ~x26))) & (~new_n69_ | ~new_n59_ | ~x24 | x25);
  assign z16 = x08 ? x07 : (new_n74_ & x09);
  assign new_n74_ = ~x10 & ((new_n77_ & new_n78_) | (x26 & (~new_n75_ | ~new_n76_)));
  assign new_n75_ = ~x18 & x19 & x20 & x21;
