...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n53_, new_n54_, new_n56_, new_n58_, new_n59_, new_n61_,
  ...
  assign new_n58_ = x09 & ~x10 & ((x21 & (~x19 | new_n59_ | ~x20)) | (x19 & x20 & ~x21));
  assign new_n59_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z13 = x08 ? x04 : (x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x23 | (x19 & x20 & x21 & ~new_n62_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  ...
  assign new_n68_ = (~x25 | (new_n65_ & new_n69_ & x24 & (~x17 | ~x26))) & (~new_n65_ | ~new_n69_ | ~x24 | x25);
  assign new_n69_ = x22 & x23;
  assign z16 = x08 ? x07 : (new_n71_ & x09);
  assign new_n71_ = ~x10 & ((new_n74_ & new_n75_) | (x26 & (~new_n72_ | ~new_n73_)));
