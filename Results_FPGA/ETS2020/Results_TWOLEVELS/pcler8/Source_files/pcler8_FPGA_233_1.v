...
module FAU ( 
  ...
  assign new_n62_ = (~x22 | (x19 & x20 & ~new_n63_ & x21)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n63_ = x14 & x23 & x24 & x25 & x26;
  assign z15 = x08 ? x06 : (x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x25 | (new_n66_ & new_n59_ & x24 & (~x17 | ~x26))) & (~new_n66_ | ~new_n59_ | ~x24 | x25);
