// Benchmark "FAU" written by ABC on Thu Jul 30 15:06:29 2020
...
module FAU ( 
  ...
  assign z12 = x08 ? x03 : (new_n61_ & x09);
  assign new_n61_ = ~x10 & ((x22 & (~x19 | ~x20 | new_n62_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n62_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = x08 ? x04 : (x09 & ~new_n64_ & ~x10);
  assign new_n64_ = (~x23 | (x19 & x20 & x21 & ~new_n65_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  ...
  assign new_n71_ = (~x25 | (new_n68_ & new_n72_ & x24 & (~x17 | ~x26))) & (~new_n68_ | ~new_n72_ | ~x24 | x25);
