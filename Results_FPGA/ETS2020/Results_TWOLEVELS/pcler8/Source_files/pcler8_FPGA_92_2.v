// Benchmark "FAU" written by ABC on Thu Jul 30 15:06:19 2020
...
module FAU ( 
  ...
  assign z12 = x08 ? x03 : (new_n59_ & x09);
  assign new_n59_ = ~x10 & ((x22 & (~x19 | ~x20 | new_n60_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n60_ = x14 & x23 & x24 & x25 & x26;
  ...
  assign z16 = x08 ? x07 : (new_n69_ & x09);
  assign new_n69_ = ~x10 & ((new_n72_ & new_n73_) | (x26 & (~new_n70_ | ~new_n71_)));
  assign new_n70_ = ~x18 & x19 & x20 & x21;
