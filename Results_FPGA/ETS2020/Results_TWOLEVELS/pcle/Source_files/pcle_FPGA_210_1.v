...
module FAU ( 
  ...
  assign z6 = x08 ? x05 : (x09 & ~new_n39_ & ~x10);
  assign new_n39_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = x08 ? x06 : (new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x17 & (~new_n42_ | ~x14 | ~x15 | ~x16)) | (new_n42_ & x16 & ~x17 & x14 & x15));
  assign new_n42_ = x11 & x12 & x13;
  assign z8 = x08 ? x07 : (x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x18 | (new_n42_ & new_n47_)) & (~new_n45_ | ~new_n46_ | ~x17 | x18);
