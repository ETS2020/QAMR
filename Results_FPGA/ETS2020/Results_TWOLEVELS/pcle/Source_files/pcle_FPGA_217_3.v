...
module FAU ( 
  ...
  assign z7 = x08 ? x06 : (new_n42_ & x09);
  assign new_n42_ = ~x10 & ((x17 & (~new_n43_ | ~x14 | ~x15 | ~x16)) | (new_n43_ & x16 & ~x17 & x14 & x15));
  assign new_n43_ = x11 & x12 & x13;
  assign z8 = x08 ? x07 : (x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (~x18 | (new_n43_ & new_n48_)) & (~new_n46_ | ~new_n47_ | ~x17 | x18);
