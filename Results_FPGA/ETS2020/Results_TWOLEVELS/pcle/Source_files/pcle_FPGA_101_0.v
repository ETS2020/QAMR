// Benchmark "FAU" written by ABC on Thu Jul 30 14:43:20 2020
...
module FAU ( 
  ...
  assign z8 = x08 ? x07 : (x09 & ~x10 & (new_n41_ | new_n43_));
  assign new_n41_ = x18 & (~new_n42_ | ~x11 | ~x12 | ~x13);
  assign new_n42_ = x14 & x15 & x16 & x17;
  assign new_n43_ = new_n44_ & x15 & x16 & x17 & ~x18;
