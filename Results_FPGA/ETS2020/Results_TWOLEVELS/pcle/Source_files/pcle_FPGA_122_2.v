...
module FAU ( 
  ...
  wire new_n33_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_;
  ...
  assign z8 = x08 ? x07 : (x09 & ~new_n38_ & ~x10);
  assign new_n38_ = (~x18 | (new_n36_ & new_n40_)) & (~new_n41_ | ~new_n39_ | ~x17 | x18);
