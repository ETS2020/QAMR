...
module FAU ( 
  ...
  wire new_n32_, new_n34_, new_n35_, new_n37_, new_n38_, new_n39_, new_n40_;
  ...
  assign z8 = x08 ? x07 : (x09 & ~new_n37_ & ~x10);
  assign new_n37_ = (~x18 | (new_n35_ & new_n39_)) & (~new_n40_ | ~new_n38_ | ~x17 | x18);
