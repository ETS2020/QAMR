...
module FAU ( 
  ...
  assign new_n66_ = (~x24 | (new_n60_ & ~x21 & ~x22 & ~x23)) & (~new_n60_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? (new_n68_ | new_n69_) : (x18 ? x06 : x14);
  assign new_n68_ = x25 & (~new_n60_ | x21 | x22 | x23 | x24);
  assign new_n69_ = new_n62_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ~new_n71_ : (x18 ? x07 : x15);
  assign new_n71_ = (~x26 | (new_n62_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n62_ | x22 | x23 | x24 | x25 | x26);
