// Benchmark "FAU" written by ABC on Thu Jul 30 21:04:37 2020
...
module FAU ( 
  ...
  assign new_n65_ = x25 & (~new_n63_ | x21 | x22 | x23 | x24);
  assign new_n66_ = new_n67_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n67_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z16 = x16 ? ~new_n69_ : (x18 ? x07 : x15);
  assign new_n69_ = (~x26 | (new_n67_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n67_ | x22 | x23 | x24 | x25 | x26);
