// Benchmark "FAU" written by ABC on Thu Jul 30 21:05:04 2020
...
module FAU ( 
  ...
  assign new_n63_ = (~new_n61_ | x21 | x22 | x23 | x24) & x25;
  assign new_n64_ = new_n65_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n65_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z16 = x16 ? ~new_n67_ : (x18 ? x07 : x15);
  assign new_n67_ = ((new_n65_ & ~x22 & ~x23 & ~x24 & ~x25) | ~x26) & (~new_n65_ | x22 | x23 | x24 | x25 | x26);
