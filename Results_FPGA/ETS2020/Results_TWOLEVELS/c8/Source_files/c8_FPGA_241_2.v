// Benchmark "FAU" written by ABC on Thu Jul 30 21:06:23 2020
...
module FAU ( 
  ...
  assign new_n65_ = ((~x17 & ~x19 & ~x20 & ~x21 & ~x22) | ~x23) & (x17 | x19 | x20 | x21 | x22 | x23);
  ...
  assign new_n69_ = x25 & (~new_n59_ | x21 | x22 | x23 | x24);
  assign new_n70_ = new_n61_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ~new_n72_ : (x18 ? x07 : x15);
