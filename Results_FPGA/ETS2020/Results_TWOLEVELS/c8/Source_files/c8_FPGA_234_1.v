...
module FAU ( 
  ...
  assign new_n63_ = (~x24 | (new_n57_ & ~x21 & ~x22 & ~x23)) & (~new_n57_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? (new_n65_ | new_n66_) : (x18 ? x06 : x14);
  assign new_n65_ = (~new_n57_ | x21 | x22 | x23 | x24) & x25;
  assign new_n66_ = new_n59_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ~new_n68_ : (x18 ? x07 : x15);
  assign new_n68_ = ((new_n59_ & ~x22 & ~x23 & ~x24 & ~x25) | ~x26) & (~new_n59_ | x22 | x23 | x24 | x25 | x26);
