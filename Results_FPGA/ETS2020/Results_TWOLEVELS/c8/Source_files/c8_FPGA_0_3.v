...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n58_, new_n59_, new_n61_, new_n63_, new_n65_,
    new_n67_, new_n68_, new_n70_, new_n72_, new_n73_;
  ...
  assign z11 = x16 ? (new_n59_ | (~new_n57_ & x21)) : ~new_n58_;
  ...
  assign z13 = x16 ? ~new_n63_ : (x18 ? x04 : x12);
  assign new_n63_ = ((~x17 & ~x19 & ~x20 & ~x21 & ~x22) | ~x23) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? ~new_n65_ : (x18 ? x05 : x13);
  assign new_n65_ = (~x24 | (new_n57_ & ~x21 & ~x22 & ~x23)) & (~new_n57_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? (new_n67_ | new_n68_) : (x18 ? x06 : x14);
  assign new_n67_ = x25 & (~new_n57_ | x21 | x22 | x23 | x24);
  assign new_n68_ = new_n59_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ~new_n70_ : (x18 ? x07 : x15);
  assign new_n70_ = (~x26 | (new_n59_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n59_ | x22 | x23 | x24 | x25 | x26);
