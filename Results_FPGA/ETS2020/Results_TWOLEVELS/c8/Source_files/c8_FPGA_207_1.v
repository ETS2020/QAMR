...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n56_, new_n58_, new_n59_, new_n60_, new_n62_, new_n64_, new_n66_,
    new_n67_, new_n69_;
  ...
  assign new_n64_ = (~x24 | (new_n58_ & ~x21 & ~x22 & ~x23)) & (~new_n58_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? (new_n66_ | new_n67_) : (x18 ? x06 : x14);
  assign new_n66_ = x25 & (~new_n58_ | x21 | x22 | x23 | x24);
  assign new_n67_ = new_n60_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ~new_n69_ : (x18 ? x07 : x15);
  assign new_n69_ = (~x26 | (new_n60_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n60_ | x22 | x23 | x24 | x25 | x26);
  assign z03 = 1'b0;
  assign z09 = 1'b0;
  assign z12 = 1'b0;
  assign z17 = 1'b0;
