...
module FAU ( 
  ...
  assign z14 = x16 ? ((x24 & (~new_n61_ | ~new_n62_)) | (new_n61_ & new_n64_)) : ~new_n63_;
  assign new_n61_ = ~x17 & ~x19 & ~x20;
  assign new_n62_ = ~x21 & ~x22 & ~x23;
  assign new_n63_ = x18 ? ~x05 : ~x13;
  assign new_n64_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z16 = x16 ? ((new_n66_ & new_n69_) | (x26 & (~new_n66_ | ~new_n68_))) : ~new_n67_;
