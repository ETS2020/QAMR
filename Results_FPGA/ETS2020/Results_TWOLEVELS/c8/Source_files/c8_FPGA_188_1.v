...
module FAU ( 
  ...
  assign z14 = x16 ? ((x24 & (~new_n60_ | ~new_n61_)) | (new_n60_ & new_n63_)) : ~new_n62_;
  assign new_n60_ = ~x17 & ~x19 & ~x20;
  assign new_n61_ = ~x21 & ~x22 & ~x23;
  assign new_n62_ = x18 ? ~x05 : ~x13;
  assign new_n63_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z16 = x16 ? ((new_n65_ & new_n68_) | (x26 & (~new_n65_ | ~new_n67_))) : ~new_n66_;
  assign new_n65_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n66_ = x18 ? ~x07 : ~x15;
  assign new_n67_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n68_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z17 = x16 & ((x17 & x27) | (new_n68_ & new_n70_ & ~x17 & x19));
