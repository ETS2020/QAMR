// Benchmark "FAU" written by ABC on Thu Jul 30 21:06:22 2020
...
module FAU ( 
  ...
  assign new_n64_ = x25 & (~new_n56_ | x21 | x22 | x23 | x24);
  assign new_n65_ = new_n58_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ~new_n67_ : (x18 ? x07 : x15);
  assign new_n67_ = (~x26 | (new_n58_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n58_ | x22 | x23 | x24 | x25 | x26);
