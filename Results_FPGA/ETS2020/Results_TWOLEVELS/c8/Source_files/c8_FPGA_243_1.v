// Benchmark "FAU" written by ABC on Thu Jul 30 21:06:24 2020
...
module FAU ( 
  ...
  assign new_n62_ = (~x24 | (new_n57_ & ~x21 & ~x22 & ~x23)) & (~new_n57_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? (new_n64_ | new_n65_) : (x18 ? x06 : x14);
  assign new_n64_ = x25 & (~new_n57_ | x21 | x22 | x23 | x24);
