// Benchmark "FAU" written by ABC on Fri Jul 31 07:53:11 2020
...
module FAU ( 
  ...
  wire new_n48_, new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_,
    new_n58_, new_n62_, new_n64_, new_n66_, new_n68_, new_n70_, new_n71_,
  ...
  assign z05 = ~x08 & ~x13;
  assign z06 = ~x08 & x14;
  assign z08 = new_n52_ | new_n58_ | (x23 & (x24 | x25)) | (~new_n54_ & x25);
  assign new_n52_ = ~new_n53_ & ~x17;
  assign new_n53_ = ~x25 & (x18 | x19 | ~x21 | ~x22 | ~x24);
  assign new_n54_ = new_n55_ & ~x22 & ~x24 & (~new_n56_ | ~new_n57_);
  assign new_n55_ = x18 & x19 & ~x21;
  assign new_n56_ = x17 & x18 & x19 & ~x20;
  assign new_n57_ = ~x21 & ~x22 & ~x23 & ~x24;
  ...
  assign z14 = (~new_n56_ & x21) | ~new_n64_ | new_n66_ | x15;
  ...
  assign z18 = (x25 & (~new_n56_ | ~new_n57_)) | ~new_n64_ | x15 | (new_n56_ & new_n76_);
