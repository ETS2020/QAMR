// Benchmark "FAU" written by ABC on Fri Jul 31 07:54:49 2020
...
module FAU ( 
  ...
  wire new_n49_, new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_,
    new_n59_, new_n64_, new_n66_, new_n68_, new_n70_, new_n71_, new_n73_,
  ...
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n64_ | (new_n59_ & new_n64_) | (x17 & x18 & x19 & ~x20);
  assign new_n64_ = ~x07 & ~x15;
  assign z14 = (~new_n56_ & x21) | ~new_n64_ | new_n66_ | (new_n59_ & new_n64_);
  assign new_n66_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n66_ & x22) | ~new_n64_ | new_n68_ | (new_n59_ & new_n64_);
  assign new_n68_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n68_ & x23) | ~new_n64_ | new_n70_ | (new_n59_ & new_n64_);
  assign new_n70_ = new_n71_ & x17 & x18 & x19;
  assign new_n71_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (x17 & new_n74_ & x18) | ~new_n73_ | (~new_n70_ & x24);
  assign new_n73_ = ~x07 & ~x15 & (~new_n59_ | x07 | x15);
  assign new_n74_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n76_ | ~new_n64_ | new_n77_ | (new_n59_ & new_n64_);
  assign new_n76_ = x25 & (~new_n56_ | x23 | x24 | x21 | x22);
  assign new_n77_ = new_n56_ & ~x23 & ~x24 & ~x25 & ~x21 & ~x22;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
