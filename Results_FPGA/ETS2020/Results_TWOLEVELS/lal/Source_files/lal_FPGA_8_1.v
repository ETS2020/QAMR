// Benchmark "FAU" written by ABC on Fri Jul 31 07:50:37 2020
...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n53_, new_n57_, new_n58_, new_n59_, new_n60_,
    new_n61_, new_n62_, new_n67_, new_n69_, new_n70_, new_n72_, new_n74_,
  ...
  assign z13 = (~new_n67_ & x20) | x07 | x15 | new_n61_ | (new_n51_ & ~x07 & ~x15);
  assign new_n67_ = x17 & x18 & x19;
  assign z15 = new_n70_ | x07 | x15 | new_n69_ | (new_n51_ & ~x07 & ~x15);
  assign new_n69_ = new_n67_ & ~x20 & ~x21 & ~x22;
  assign new_n70_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n69_ & x23) | x07 | x15 | new_n72_ | (new_n51_ & ~x07 & ~x15);
  assign new_n72_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (x17 & new_n75_ & x18) | ~new_n74_ | (~new_n72_ & x24);
  assign new_n74_ = ~x07 & ~x15 & (~new_n51_ | x07 | x15);
  assign new_n75_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n77_ | x07 | x15 | new_n78_ | (new_n51_ & ~x07 & ~x15);
  assign new_n77_ = x25 & (~new_n61_ | x21 | x22 | x23 | x24);
  assign new_n78_ = new_n61_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z14 = 1'b0;
  assign z02 = x16;
