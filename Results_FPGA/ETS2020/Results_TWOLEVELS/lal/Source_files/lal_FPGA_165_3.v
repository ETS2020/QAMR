...
module FAU ( 
  ...
  assign z14 = (~new_n62_ & x21) | x07 | x15 | new_n69_ | (new_n51_ & ~x07 & ~x15);
  assign new_n69_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n69_ & x22) | x07 | x15 | new_n71_ | (new_n51_ & ~x07 & ~x15);
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n71_ & x23) | x07 | x15 | new_n73_ | (new_n51_ & ~x07 & ~x15);
  ...
  assign z18 = new_n79_ | x07 | x15 | new_n80_ | (new_n51_ & ~x07 & ~x15);
