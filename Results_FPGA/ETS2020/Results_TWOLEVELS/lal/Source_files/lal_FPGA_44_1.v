...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n52_, new_n60_, new_n63_, new_n64_, new_n66_,
  ...
  assign z12 = new_n60_ & ~x07;
  assign new_n60_ = ~x15 & (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n50_ | x15 | (x19 & ~x20 & x17 & x18);
  assign z14 = (~new_n63_ & x21) | ~new_n50_ | new_n64_ | x15;
  assign new_n63_ = x17 & x18 & x19 & ~x20;
  assign new_n64_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n64_ & x22) | ~new_n50_ | new_n66_ | x15;
  assign new_n66_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n66_ & x23) | ~new_n50_ | new_n68_ | x15;
  assign new_n68_ = new_n69_ & x17 & x18 & x19;
  assign new_n69_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n68_ & x24) | ~new_n50_ | new_n71_ | x15;
  assign new_n71_ = new_n63_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n71_ & x25) | ~new_n50_ | new_n73_ | x15;
  assign new_n73_ = new_n63_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z00 = 1'b0;
  assign z08 = 1'b0;
  assign z02 = x16;
endmodule
