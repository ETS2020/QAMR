// Benchmark "FAU" written by ABC on Fri Jul 31 07:51:36 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n53_, new_n56_, new_n62_, new_n64_, new_n65_,
    new_n66_;
  assign z00 = x08 & ~x16;
  ...
  assign z07 = ~x06 | x08;
  assign z08 = x25 | (x24 & (x23 | (x21 & ~new_n56_ & x22)));
  assign new_n56_ = ~x20 & (x17 | x18 | x19);
  ...
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n62_ | (new_n50_ & new_n62_) | (x19 & ~x20 & x17 & x18);
  assign new_n62_ = ~x07 & ~x15;
  assign z18 = (x25 & (~new_n64_ | ~new_n65_)) | ~new_n62_ | (new_n50_ & new_n62_) | (new_n64_ & new_n66_);
