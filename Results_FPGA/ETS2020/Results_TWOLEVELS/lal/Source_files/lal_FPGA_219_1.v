// Benchmark "FAU" written by ABC on Fri Jul 31 07:54:40 2020
...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n52_, new_n57_, new_n58_, new_n59_, new_n60_,
    new_n61_, new_n62_, new_n63_, new_n67_, new_n70_, new_n72_, new_n74_,
  ...
  assign z14 = (~new_n61_ & x21) | ~new_n50_ | new_n70_ | x15;
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n70_ & x22) | ~new_n50_ | new_n72_ | x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n72_ & x23) | ~new_n50_ | new_n74_ | x15;
  assign new_n74_ = new_n75_ & x17 & x18 & x19;
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (x17 & new_n77_ & x18) | ~new_n78_ | (~new_n74_ & x24);
  assign new_n77_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n78_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign z18 = (x25 & (~new_n61_ | ~new_n62_)) | ~new_n50_ | x15 | (new_n61_ & new_n80_);
