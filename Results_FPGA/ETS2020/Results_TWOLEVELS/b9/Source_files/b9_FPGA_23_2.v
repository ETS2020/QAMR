// Benchmark "FAU" written by ABC on Sun Aug  2 14:03:51 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n71_, new_n72_, new_n73_, new_n77_, new_n79_;
  ...
  assign z11 = ~x09 & ~x30 & (new_n73_ | (~new_n71_ & ~new_n72_));
  assign new_n71_ = x29 & x39 & x40;
  assign new_n72_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n73_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  assign z15 = x34 & x27 & x12 & x26;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n77_ | (x08 & (new_n71_ | (~x27 & ~x28 & x35)));
  assign new_n77_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  ...
  assign z14 = 1'b0;
  assign z16 = 1'b0;
  assign z19 = ~x09 & ~x30 & (new_n73_ | (~new_n71_ & ~new_n72_));
endmodule
