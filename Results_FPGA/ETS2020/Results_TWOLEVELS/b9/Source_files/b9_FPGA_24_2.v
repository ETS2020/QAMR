// Benchmark "FAU" written by ABC on Sun Aug  2 14:03:55 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n70_, new_n71_, new_n74_, new_n75_, new_n76_, new_n81_,
    new_n83_;
  ...
  assign z18 = ~new_n81_ | (x08 & (new_n74_ | (~x27 & ~x28 & x35)));
  assign new_n81_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & (new_n83_ | (~x08 & (~x27 | ~x35)));
  assign new_n83_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z04 = 1'b0;
  assign z10 = 1'b0;
