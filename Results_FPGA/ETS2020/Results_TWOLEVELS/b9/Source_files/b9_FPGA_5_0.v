// Benchmark "FAU" written by ABC on Sun Aug  2 14:02:46 2020
...
module FAU ( 
  ...
  assign z12 = new_n79_ | ((new_n66_ | ~x27) & (x04 | ~x39 | ~x40));
  assign new_n79_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n83_ | (~x04 & new_n82_ & ~x13))) | (~x04 & new_n81_ & ~x13);
