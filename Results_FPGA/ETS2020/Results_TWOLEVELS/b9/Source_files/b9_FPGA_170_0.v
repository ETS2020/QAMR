// Benchmark "FAU" written by ABC on Sun Aug  2 14:12:55 2020
...
module FAU ( 
  ...
  assign z13 = (x27 & (new_n84_ | (~x04 & new_n83_ & ~x13))) | (~x04 & new_n82_ & ~x13);
  assign new_n82_ = x39 & x40 & (x30 | x32);
  assign new_n83_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n84_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  ...
  assign z18 = ~new_n95_ | (x08 & ((new_n94_ & ~x27) | (z08 & x29)));
