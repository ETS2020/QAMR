// Benchmark "FAU" written by ABC on Sun Aug  2 14:14:20 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n89_, new_n90_, new_n94_, new_n95_, new_n97_;
  ...
  assign z18 = ~new_n95_ | (~new_n94_ & x08);
  assign new_n94_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
