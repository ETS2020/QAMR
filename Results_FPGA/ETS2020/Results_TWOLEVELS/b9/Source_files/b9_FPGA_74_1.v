// Benchmark "FAU" written by ABC on Sun Aug  2 14:07:04 2020
...
module FAU ( 
  ...
  assign z18 = ~new_n101_ | (x08 & ((new_n100_ & ~x27) | (z08 & x29)));
  assign new_n100_ = ~x28 & x35;
  assign new_n101_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & (new_n103_ | (~x08 & (~x27 | ~x35)));
  assign new_n103_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
  assign z06 = 1'b0;
  assign z15 = 1'b0;
  assign z17 = 1'b0;
