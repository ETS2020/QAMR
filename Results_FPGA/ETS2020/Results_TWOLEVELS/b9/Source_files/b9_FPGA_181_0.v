...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n77_,
    ...
    new_n89_, new_n91_, new_n92_, new_n93_, new_n94_, new_n99_, new_n100_,
    new_n102_, new_n103_;
  ...
  assign z12 = new_n85_ | ((new_n66_ | ~x27) & (~new_n71_ | x04));
  ...
  assign z18 = ~new_n100_ | (x08 & ((new_n99_ & ~x27) | (new_n71_ & x29)));
  assign new_n99_ = ~x28 & x35;
  assign new_n100_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = ~x09 & ~x30 & (new_n103_ | (~new_n102_ & (~new_n71_ | ~x29)));
  assign new_n102_ = (~x04 | ~x27) & ~x28 & x35;
