// Benchmark "FAU" written by ABC on Sun Aug  2 14:09:59 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n66_, new_n67_, new_n70_, new_n71_, new_n72_, new_n77_, new_n79_;
  assign z05 = x37 | (x27 & x28);
  assign z07 = x03 & (new_n67_ | (new_n66_ & ~x31));
  assign new_n66_ = ~x33 & (x15 | ~x17) & ((x00 & ~x25) | ~x38);
  assign new_n67_ = ~x14 & (x00 | x25 | ~x38);
  assign z08 = x39 & x40;
  ...
  assign z18 = ~new_n77_ | (x08 & (new_n70_ | (~x27 & ~x28 & x35)));
