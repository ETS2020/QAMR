...
module FAU ( 
  ...
  assign z11 = ~x09 & ~x30 & (new_n82_ | (~new_n81_ & (~new_n80_ | ~x29)));
  assign new_n80_ = x39 & x40;
  assign new_n81_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n82_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n84_ | ((new_n66_ | ~x27) & (~new_n80_ | x04));
  ...
  assign z18 = ~new_n99_ | (x08 & ((new_n98_ & ~x27) | (new_n80_ & x29)));
  ...
  assign z09 = 1'b0;
  assign z20 = 1'b0;
  assign z19 = ~x09 & ~x30 & (new_n82_ | (~new_n81_ & (~new_n80_ | ~x29)));
endmodule
