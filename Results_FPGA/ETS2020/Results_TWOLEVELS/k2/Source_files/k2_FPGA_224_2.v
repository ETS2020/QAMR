...
module FAU ( 
  ...
  assign new_n225_ = ~x29 & ((x19 & (x27 | (~x27 & ~x28))) | (~x17 & ~x19 & x26 & ~x28));
  ...
  assign new_n254_ = new_n115_ & ~x28 & ~x11 & x20 & x21;
  assign new_n255_ = (~x29 | new_n256_ | x30) & (~new_n257_ | x29 | ~x30 | ~x21 | x28);
  assign new_n256_ = (~x20 | ((~x21 | ~x22 | x28) & (~x19 | (~x21 & (~x27 | x28))))) & (x19 | x20 | ~x21 | x28);
  ...
  assign new_n359_ = (x21 | ((new_n360_ | ~x20) & (~new_n362_ | ~x26 | ~x19 | x20))) & (x19 | x20 | ~new_n362_ | ~x21);
  ...
  assign new_n375_ = (x20 | x21 | ~x18 | ~x19) & (~new_n376_ | ~x21 | x28 | x19 | ~x20);
  ...
  assign new_n429_ = (~x20 | ~x22 | x05 | ~x15) & ~x24 & ~x26;
