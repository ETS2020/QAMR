// Benchmark "FAU" written by ABC on Fri Jul 31 17:22:47 2020
...
module FAU ( 
  ...
  assign z34 = (~new_n345_ & ~x18) | new_n366_ | (x18 & (x30 ? ~new_n357_ : ~new_n362_));
  assign new_n345_ = ~new_n346_ & (new_n350_ | ~x29) & (x21 | ~x28 | ~new_n356_ | x29);
  ...
  assign new_n366_ = new_n112_ & x29 & x30 & ~x19 & ~x20 & x21;
  ...
  assign new_n375_ = x19 ? (x20 ? ~new_n271_ : ~x23) : (~new_n376_ & new_n377_);
  ...
  assign new_n379_ = new_n111_ & x00;
  ...
  assign new_n396_ = new_n118_ & x20 & ~x27 & ~x28;
  ...
  assign new_n401_ = (~x19 | (~new_n402_ & (~new_n364_ | ~x20))) & (~new_n238_ | x14 | x19 | x20);
  assign new_n402_ = x00 & ((~x20 & ~new_n121_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n416_ = ~new_n210_ & (x12 | x13 | x14 | x27 | x28);
  ...
  assign new_n425_ = (~x20 | x21 | ~x18 | x19) & (~new_n239_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  ...
  assign new_n432_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n433_ = x20 ? (~new_n437_ & (x28 | (~new_n434_ & ~new_n441_))) : new_n439_;
  assign new_n434_ = x21 & (new_n308_ | (~x19 & (new_n436_ | (new_n435_ & x00))));
  ...
  assign new_n442_ = new_n447_ & (~x29 | (new_n178_ & (x28 | (~new_n443_ & ~new_n445_))));
  assign new_n443_ = ~x19 & (x21 ? ~new_n444_ : ~new_n176_);
  ...
  assign new_n451_ = new_n456_ & (x18 | (new_n463_ & (x20 | (new_n452_ & ~new_n168_))));
  ...
  assign new_n471_ = (new_n472_ | x18) & (~x17 | ~x18 | ~new_n133_ | x19);
