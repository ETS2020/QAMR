// Benchmark "FAU" written by ABC on Fri Jul 31 17:18:44 2020
...
module FAU ( 
  ...
  assign z22 = (~new_n284_ & x30) | new_n316_ | (~x30 & (x29 ? ~new_n304_ : ~new_n319_));
  assign new_n284_ = ~new_n191_ & (new_n285_ | x21) & (~x21 | (x19 ? new_n301_ : new_n295_));
  assign new_n285_ = (x29 | (x18 ? new_n293_ : new_n286_)) & (~new_n294_ | ~x18) & (new_n289_ | ~x29);
  assign new_n286_ = (x19 | (~new_n229_ & new_n287_)) & (~x23 | x28) & (new_n288_ | ~x19);
  assign new_n287_ = x20 ? (~x22 & ~x24) : x28;
  assign new_n288_ = (x28 | (~x22 & (~x20 | ~x26))) & (~x20 | ~x22 | ~x28 | (x02 & ~x03 & (~x02 | x03)));
  assign new_n289_ = ~new_n292_ & (x28 | (x18 ? new_n291_ : new_n290_));
  assign new_n290_ = x19 & (~x20 | ~x22);
  assign new_n291_ = (~x20 | ~x26 | x17 | x19) & (~x19 | ((x20 | ~x26) & (~x05 | ~x20 | x27)));
  assign new_n292_ = x19 & ((x22 & x28 & ~x18 & x20) | (x18 & (x20 ? (~x27 & x28) : x22)));
  assign new_n293_ = (~x19 | (x20 ? (~x27 & (x27 | x28)) : (~x22 & (~x26 | x28)))) & (x19 | ~x20 | ~x26 | x28);
  assign new_n294_ = ~x20 & x25;
  assign new_n295_ = new_n300_ & (x28 | (new_n298_ & (x29 | (new_n296_ & ~new_n299_))));
  assign new_n296_ = ~new_n297_ & (~x20 | ~x25 | ~x05 | x10);
  assign new_n297_ = x09 & ~x18 & ~x20 & x22 & x33;
  assign new_n298_ = (~x29 | ((~new_n161_ | ~x20) & (x18 | x20 | ~x22) & (~x18 | (x20 & ~x22)))) & (x18 | x20 | new_n148_ | ~x22);
  assign new_n299_ = x00 & ((x18 & ~x20) | (~x10 & ~x15 & x20 & x25));
  assign new_n300_ = (x20 | (x18 ? (~x28 | x29) : ((~x23 | x29) & (~x22 | ~x28)))) & (x18 | ~x20 | ~x29);
  assign new_n301_ = new_n302_ & (~x29 | (x18 ? ~x20 : (~x28 & (~x20 | ~x22 | x28))));
  assign new_n302_ = (~x25 | (~new_n303_ & (~x18 | x20))) & (~x18 | x20 | (~x22 & ~x26));
  assign new_n303_ = ~x10 & ~x18 & ~x28 & ~x29;
  assign new_n304_ = (x18 | (new_n313_ & (new_n305_ | x20))) & (new_n310_ | ~x18) & (~new_n315_ | ~x20);
  assign new_n305_ = (~new_n306_ | ~x19) & ~new_n309_ & (x28 | (~new_n308_ & (new_n307_ | x19)));
  assign new_n306_ = ~new_n131_ & (x21 ? ~x28 : x01);
  assign new_n307_ = (new_n228_ | x21) & (x09 | ~x21 | ~x22 | ~new_n240_ | x38);
  assign new_n308_ = new_n243_ & new_n242_ & x22 & ~x09 & x21;
  assign new_n309_ = x21 & x23 & (x31 | x34 | (new_n245_ & ~x31));
  ...
  assign new_n313_ = x19 ? new_n314_ : ((~new_n274_ | ~x21) & (~x20 | (~x21 & (x21 | ~x24))));
  assign new_n314_ = (~x21 | ~x28) & (~x05 | ~x20 | x21 | ~x22 | x28);
  assign new_n315_ = x21 & ~x28 & (x22 | (~new_n162_ & ~x19));
  assign new_n316_ = ~x18 & ~x19 & ~new_n317_ & x21;
  assign new_n317_ = (x09 | x20 | ~new_n318_ | ~x22) & (x10 | ~x20 | ~x25);
  assign new_n318_ = ~x28 & x29 & (x38 | (~new_n130_ & ~x38));
  assign new_n319_ = (~x14 | x27 | x28) & (~x18 | (~new_n321_ & (new_n320_ | ~x28)));
  ...
  assign new_n333_ = ~x20 & (x18 ? new_n336_ : (new_n275_ | (new_n334_ & x29)));
  assign new_n334_ = ~x30 & ((~x19 & x23) | (~x28 & (new_n335_ | (x19 & (x22 | x23)))));
  assign new_n335_ = new_n243_ & new_n242_ & ~x09 & x22;
  ...
  assign new_n354_ = (new_n355_ | ~x00) & (~new_n149_ | ~new_n151_ | x00 | x04 | ~x18);
  ...
  assign new_n358_ = (~new_n359_ | ~x18) & (~new_n149_ | x18 | ~new_n117_ | ~x22);
  ...
  assign new_n369_ = ~x20 & x22 & ~x28 & new_n240_ & ~x38;
  assign new_n370_ = new_n149_ & x00 & ~x21 & x22 & x28;
  assign new_n371_ = ~x09 & ~x19 & ~x20 & x21 & new_n372_ & x22;
  assign new_n372_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n187_ | x39)))) | x38 | (~x39 & x42));
  assign new_n373_ = x28 & ~x29 & ~new_n290_ & ~x30;
  ...
  assign new_n382_ = x30 & ((~new_n383_ & x00) | (new_n203_ & ~x20 & x26));
  ...
  assign new_n389_ = ~new_n390_ & (~new_n118_ | ~x20 | ~x27 | x29);
  assign new_n390_ = x00 & ~x05 & ~x18 & new_n203_ & ~x19 & ~x20;
  assign new_n391_ = (new_n393_ | ~x26) & ~new_n395_ & (~x19 | (~new_n392_ & ~new_n394_));
  assign new_n392_ = x00 & ((x03 & x20 & x27 & ~x29) | (~x20 & ~new_n121_ & x29));
  ...
  assign new_n397_ = (x18 | new_n290_ | ~x28) & (x14 | new_n398_ | x27);
  ...
  assign new_n413_ = x19 & x20 & ((new_n414_ & ~x18) | (new_n203_ & x18 & ~x27));
  ...
  assign new_n427_ = new_n118_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n428_ = x20 & ((~x19 & x26 & ~x28) | (~x04 & x19 & ~x27 & x28));
  assign new_n429_ = x19 & ~x20 & (x22 | x25 | (x26 & ~x28));
  assign new_n430_ = ~x20 & ~new_n131_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n432_ & x19) | (x29 & (new_n442_ | (~new_n438_ & ~x19)));
  assign new_n432_ = x18 ? ((new_n436_ | x21) & (~new_n117_ | ~x20 | ~x21)) : new_n433_;
  assign new_n433_ = x21 ? new_n435_ : (~new_n434_ & (~x29 | new_n216_ | x30));
  assign new_n434_ = x02 & ~x03 & x20 & new_n114_ & x22 & x28;
  assign new_n435_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n131_ | ~x30);
  assign new_n436_ = x20 ? ((~new_n114_ | ~x27) & (~new_n116_ | ~x04 | x27)) : ~new_n437_;
  assign new_n437_ = x29 & ((~new_n144_ & x30) | (x26 & x28 & ~x30));
  assign new_n438_ = (new_n439_ | ~x20) & (x30 | ((x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20)));
  assign new_n439_ = (x18 | (x21 ? x30 : (x28 | ~x30))) & (~x21 | x28 | new_n162_ | x30) & (new_n440_ | ~x18);
  assign new_n440_ = (~new_n441_ | x21) & (~x11 | ~x21 | ~new_n138_ | ~x25);
  assign new_n441_ = x26 & ((x28 & ~x30) | (~x17 & ~x28 & x30));
  assign new_n442_ = x20 & x21 & new_n138_ & x22;
