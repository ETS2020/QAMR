// Benchmark "FAU" written by ABC on Fri Jul 31 17:22:22 2020
...
module FAU ( 
  ...
  assign new_n331_ = ~x20 & (x18 ? new_n334_ : (new_n275_ | (new_n332_ & x29)));
  assign new_n332_ = ~x30 & ((~x19 & x23) | (~x28 & (new_n333_ | (x19 & (x22 | x23)))));
  assign new_n333_ = new_n243_ & new_n242_ & ~x09 & x22;
  ...
  assign new_n341_ = x19 ? (~x18 & (~new_n112_ | ~new_n113_ | x18)) : (~new_n105_ & (x18 | ~x24));
  assign new_n342_ = new_n118_ & x03;
  assign new_n343_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n344_ = ~new_n347_ & (x20 | (~new_n346_ & (new_n345_ | x19)));
  assign new_n345_ = (x03 | x18 | new_n122_ | x21) & (~x18 | ~x21 | ~new_n114_ | x28);
  assign new_n346_ = new_n117_ & x26 & ~x28 & x18 & x19 & ~x21;
  assign new_n347_ = ~x18 & x19 & x21 & new_n114_ & x28;
  ...
  assign new_n352_ = (new_n353_ | ~x00) & (~new_n149_ | ~new_n151_ | x00 | x04 | ~x18);
  assign new_n353_ = (new_n354_ | ~x20) & (~x18 | ~x19 | new_n121_ | x20);
  assign new_n354_ = (x18 | ~x19 | ~x22 | ~x28) & (x17 | ~x18 | x19 | ~x26 | x28);
  assign z31 = ~x21 & x28 & (new_n358_ | (~new_n356_ & x00));
  assign new_n356_ = (~new_n357_ | ~x18) & (~new_n149_ | x18 | ~new_n117_ | ~x22);
  assign new_n357_ = x26 & ~x29 & x30 & (x19 ^ x20);
  assign new_n358_ = new_n118_ & ~x00 & ~x04 & new_n117_ & x20 & ~x27;
  ...
  assign new_n367_ = ~x20 & x22 & ~x28 & new_n240_ & ~x38;
  assign new_n368_ = new_n149_ & x00 & ~x21 & x22 & x28;
  assign new_n369_ = ~x09 & ~x19 & ~x20 & x21 & new_n370_ & x22;
  assign new_n370_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n187_ | x39)))) | x38 | (~x39 & x42));
  ...
  assign new_n380_ = x30 & ((~new_n381_ & x00) | (new_n203_ & ~x20 & x26));
  ...
  assign new_n387_ = ~new_n388_ & (~new_n118_ | ~x20 | ~x27 | x29);
  assign new_n388_ = x00 & ~x05 & ~x18 & new_n203_ & ~x19 & ~x20;
  assign new_n389_ = (new_n391_ | ~x26) & ~new_n393_ & (~x19 | (~new_n390_ & ~new_n392_));
  assign new_n390_ = x00 & ((x03 & x20 & x27 & ~x29) | (~x20 & ~new_n121_ & x29));
  ...
  assign new_n411_ = x19 & x20 & ((new_n412_ & ~x18) | (new_n203_ & x18 & ~x27));
  ...
  assign new_n418_ = (~x21 | x28 | (~new_n112_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  ...
  assign new_n425_ = new_n118_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n426_ = x20 & ((~x19 & x26 & ~x28) | (~x04 & x19 & ~x27 & x28));
  assign new_n427_ = x19 & ~x20 & (x22 | x25 | (x26 & ~x28));
  assign new_n428_ = ~x20 & ~new_n131_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n430_ & x19) | (x29 & (new_n440_ | (~new_n436_ & ~x19)));
  assign new_n430_ = x18 ? ((new_n434_ | x21) & (~new_n117_ | ~x20 | ~x21)) : new_n431_;
  assign new_n431_ = x21 ? new_n433_ : (~new_n432_ & (~x29 | new_n216_ | x30));
  assign new_n432_ = x02 & ~x03 & x20 & new_n114_ & x22 & x28;
  assign new_n433_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n131_ | ~x30);
  assign new_n434_ = x20 ? ((~new_n114_ | ~x27) & (~new_n116_ | ~x04 | x27)) : ~new_n435_;
  assign new_n435_ = x29 & ((~new_n144_ & x30) | (x26 & x28 & ~x30));
  assign new_n436_ = (new_n437_ | ~x20) & (x30 | ((x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20)));
  assign new_n437_ = (x18 | (x21 ? x30 : (x28 | ~x30))) & (~x21 | x28 | new_n162_ | x30) & (new_n438_ | ~x18);
  assign new_n438_ = (~new_n439_ | x21) & (~x11 | ~x21 | ~new_n138_ | ~x25);
  assign new_n439_ = x26 & ((x28 & ~x30) | (~x17 & ~x28 & x30));
  assign new_n440_ = x20 & x21 & new_n138_ & x22;
  ...
  assign new_n444_ = new_n117_ & ~x21 & x03 & ~x19 & ~x20;
