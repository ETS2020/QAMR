// Benchmark "FAU" written by ABC on Fri Jul 31 17:21:59 2020
...
module FAU ( 
  ...
  assign new_n357_ = (x21 | ((new_n358_ | ~x20) & (~new_n360_ | ~x26 | ~x19 | x20))) & (x19 | x20 | ~new_n360_ | ~x21);
  assign new_n358_ = (~new_n359_ | ~x19) & (~x17 | x19 | ~x26 | (x28 ^ ~x29));
  assign new_n359_ = ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n360_ = x28 & ~x29;
  assign new_n361_ = new_n106_ & x29 & x30 & ~x19 & ~x20 & x21;
  ...
  assign new_n370_ = x19 ? (x20 ? ~new_n265_ : ~x23) : (~new_n371_ & new_n372_);
  ...
  assign new_n374_ = new_n105_ & x00;
  ...
  assign new_n391_ = new_n112_ & x20 & ~x27 & ~x28;
  ...
  assign new_n396_ = (~x19 | (~new_n397_ & (~new_n359_ | ~x20))) & (~new_n232_ | x14 | x19 | x20);
  assign new_n397_ = x00 & ((~x20 & ~new_n115_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n411_ = ~new_n204_ & (x12 | x13 | x14 | x27 | x28);
  ...
  assign new_n420_ = (~x20 | x21 | ~x18 | x19) & (~new_n233_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  ...
  assign new_n429_ = x21 & (new_n302_ | (~x19 & (new_n431_ | (new_n430_ & x00))));
  ...
  assign new_n437_ = new_n442_ & (~x29 | (new_n172_ & (x28 | (~new_n438_ & ~new_n440_))));
  assign new_n438_ = ~x19 & (x21 ? ~new_n439_ : ~new_n170_);
  ...
  assign new_n446_ = new_n451_ & (x18 | (new_n458_ & (x20 | (new_n447_ & ~new_n162_))));
  ...
  assign new_n466_ = (new_n467_ | x18) & (~new_n127_ | x19 | ~x17 | ~x18);
