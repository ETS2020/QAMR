...
module FAU ( 
  ...
  assign z34 = (~new_n335_ & ~x18) | new_n357_ | (x18 & (x30 ? ~new_n348_ : ~new_n353_));
  assign new_n335_ = ~new_n336_ & (new_n341_ | ~x29) & (x21 | ~x28 | ~new_n347_ | x29);
  assign new_n336_ = x30 & ((~new_n340_ & ~x28) | (~new_n337_ & ~x29));
  assign new_n337_ = (~x28 | ((new_n338_ | x21) & (~x00 | ~x19 | ~x21))) & (~x19 | ~x21 | new_n339_ | x28);
  assign new_n338_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n339_ = ~x24 & ~x26 & (~x10 | ~x25);
  ...
  assign new_n365_ = ~x22 & ~x24 & (~x10 | ~x25) & ~x26;
  ...
  assign new_n369_ = (x20 | x21 | ~x18 | ~x19) & (~new_n370_ | ~x21 | x28 | x19 | ~x20);
  ...
  assign new_n410_ = (new_n339_ | ~x19) & (x20 | ~x22 | ~x33 | ~x09 | x19);
  ...
  assign new_n423_ = (x05 | ~x15 | ~x20 | ~x22) & ~x24 & ~x26;
  ...
  assign new_n462_ = (new_n463_ | x18) & (~x17 | ~x18 | ~new_n127_ | x19);
  assign new_n463_ = (~x22 | ~x28) & (x23 | x27 | x14 | x19);
