// Benchmark "FAU" written by ABC on Fri Jul 31 17:23:14 2020
...
module FAU ( 
  ...
  assign new_n279_ = (~x30 | ((new_n121_ | x29) & (~x26 | x28))) & (~x26 | ~x28 | x29 | x30);
  ...
  assign new_n311_ = x21 & x23 & ((new_n245_ & ~x31) | x31 | x34);
  ...
  assign new_n366_ = ~x20 & x22 & ~x28 & new_n240_ & ~x38;
  assign new_n367_ = new_n149_ & x00 & ~x21 & x22 & x28;
  assign new_n368_ = ~x09 & ~x19 & ~x20 & x21 & new_n369_ & x22;
  assign new_n369_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n187_ | x39)))) | x38 | (~x39 & x42));
  assign new_n370_ = x28 & ~x29 & ~new_n292_ & ~x30;
  ...
  assign new_n379_ = x30 & ((~new_n380_ & x00) | (new_n203_ & ~x20 & x26));
  ...
  assign z36 = (~new_n404_ & x21) | (~x30 & ((~new_n385_ & ~x21) | new_n410_ | (~new_n397_ & x21)));
  assign new_n385_ = (new_n386_ | x03) & new_n393_ & (new_n388_ | ~x18);
  assign new_n386_ = ~new_n387_ & (~new_n118_ | ~x20 | ~x27 | x29);
  assign new_n387_ = x00 & ~x05 & ~x18 & new_n203_ & ~x19 & ~x20;
  assign new_n388_ = (new_n390_ | ~x26) & ~new_n392_ & (~x19 | (~new_n389_ & ~new_n391_));
  assign new_n389_ = x00 & ((x03 & x20 & x27 & ~x29) | (~x20 & ~new_n121_ & x29));
  assign new_n390_ = (((~x19 | x20) & (~x17 | x19 | ~x20)) | ((~x28 | x29) & (~x00 | x28 | ~x29))) & (~x20 | x28 | ~x29 | ~x00 | x17 | x19);
  assign new_n391_ = x20 & ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n392_ = ~x14 & ~x19 & ~x20 & ~x27 & ~x28 & ~x29;
  assign new_n393_ = (new_n394_ | x29) & (~x00 | x18 | ~x20 | new_n396_ | ~x29);
  assign new_n394_ = (x18 | new_n292_ | ~x28) & (x14 | new_n395_ | x27);
  assign new_n395_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n396_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n397_ = x29 ? new_n398_ : new_n402_;
  assign new_n398_ = (x19 | ((new_n399_ | x28) & (x18 | ~x20))) & (~x20 | ~x22 | x28) & (~x19 | (x18 ? ~x20 : ~x28));
  assign new_n399_ = new_n401_ & (x09 | ~x22 | ~new_n400_ | x38);
  assign new_n400_ = ~x41 & ((x39 & x42) | (~x18 & ~x20 & ~x39 & x40 & ~x42));
  assign new_n401_ = (~x18 | (x20 & (~x11 | ~x20 | ~x25))) & (~x20 | (~x26 & (x11 | ~x25)));
  assign new_n402_ = ~new_n403_ & (x20 | ~x28 | ~x18 | x19);
  assign new_n403_ = ~x12 & ~x13 & ~x14 & ~x27 & ~x28;
  assign new_n404_ = (~new_n405_ | x28) & (~x18 | x19 | ~x20 | new_n409_ | ~x28);
  ...
  assign new_n410_ = x19 & x20 & ((new_n411_ & ~x18) | (new_n203_ & x18 & ~x27));
  assign new_n411_ = x22 & x28 & ~new_n409_ & ~x29;
  assign z38 = (~new_n413_ & ~x00) | (~x01 & ~x18 & new_n427_ & x19);
  assign new_n413_ = (x29 | (~new_n420_ & (new_n414_ | ~x30))) & (x21 | new_n421_ | ~x29);
  assign new_n414_ = (x19 | (x18 ? new_n417_ : new_n415_)) & ~new_n419_ & (new_n418_ | ~x19);
  assign new_n415_ = (~x20 | new_n416_ | ~x21) & (x03 | x21 | ~x28 | (~x02 ^ ~x20));
  assign new_n416_ = ~x22 & ~x24 & ~x25 & ~x26;
  assign new_n417_ = (~x21 | x28 | (~new_n112_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n418_ = x18 ? ((x20 | x21 | ~x26 | ~x28) & (~x20 | ~x21 | ~x24)) : (~x21 | ~x28);
  assign new_n419_ = ~x05 & ~x15 & ~x18 & x20 & x21 & x22;
  assign new_n420_ = new_n344_ & x20 & ~x21 & x27;
  assign new_n421_ = ~new_n424_ & (x30 | (x18 ? (~new_n425_ & ~new_n426_) : new_n422_));
  assign new_n422_ = ~new_n423_ & (~x20 | (x19 ? (~x22 | ~x28) : (~x23 | x28)));
  assign new_n423_ = ~x05 & ((x19 & x20 & x22) | (~x03 & ~x19 & ~x20 & ~x28));
  assign new_n424_ = new_n118_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n425_ = x20 & ((~x19 & x26 & ~x28) | (~x04 & x19 & ~x27 & x28));
  assign new_n426_ = x19 & ~x20 & (x22 | x25 | (x26 & ~x28));
  assign new_n427_ = ~x20 & ~new_n131_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n429_ & x19) | (x29 & (new_n439_ | (~new_n435_ & ~x19)));
  assign new_n429_ = x18 ? ((new_n433_ | x21) & (~new_n117_ | ~x20 | ~x21)) : new_n430_;
  assign new_n430_ = x21 ? new_n432_ : (~new_n431_ & (~x29 | new_n216_ | x30));
  assign new_n431_ = x02 & ~x03 & x20 & new_n114_ & x22 & x28;
  assign new_n432_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n131_ | ~x30);
  assign new_n433_ = x20 ? ((~new_n114_ | ~x27) & (~new_n116_ | ~x04 | x27)) : ~new_n434_;
  assign new_n434_ = x29 & ((~new_n144_ & x30) | (x26 & x28 & ~x30));
  assign new_n435_ = (new_n436_ | ~x20) & (x30 | ((x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20)));
  assign new_n436_ = (x18 | (x21 ? x30 : (x28 | ~x30))) & (~x21 | x28 | new_n162_ | x30) & (new_n437_ | ~x18);
  assign new_n437_ = (~new_n438_ | x21) & (~x11 | ~x21 | ~new_n138_ | ~x25);
  assign new_n438_ = x26 & ((x28 & ~x30) | (~x17 & ~x28 & x30));
  assign new_n439_ = new_n138_ & x22 & x20 & x21;
  assign z40 = ~x28 & ((~x18 & (new_n443_ | (~new_n444_ & x05))) | (x05 & new_n441_ & x18));
  assign new_n441_ = x20 & ~new_n442_ & x30;
  assign new_n442_ = (x27 | ~x29 | ~x19 | x21) & (x19 | ~x21 | new_n338_ | x29);
  assign new_n443_ = new_n117_ & ~x21 & x03 & ~x19 & ~x20;
  assign new_n444_ = (~x19 | ~x20 | ~x22 | (x21 ? (x29 | ~x30) : (~x29 | x30))) & (x19 | x20 | x21 | ~x29 | x30);
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n446_ & x21;
  assign new_n446_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
