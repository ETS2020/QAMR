// Benchmark "FAU" written by ABC on Fri Jul 31 17:18:39 2020
...
module FAU ( 
  ...
  assign z34 = x18 ? ~new_n377_ : (~new_n366_ | new_n373_);
  assign new_n366_ = (~new_n372_ | x21) & (~x29 | (~new_n370_ & (new_n367_ | x30)));
  assign new_n367_ = ~new_n369_ & (~x21 | ((~x19 | ~x28) & (x09 | ~new_n368_ | x19)));
  assign new_n368_ = ~x20 & x22 & ~x28 & new_n240_ & ~x38;
  assign new_n369_ = new_n149_ & x00 & ~x21 & x22 & x28;
  assign new_n370_ = ~x09 & ~x19 & ~x20 & x21 & new_n371_ & x22;
  assign new_n371_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n187_ | x39)))) | x38 | (~x39 & x42));
  assign new_n372_ = x28 & ~x29 & ~new_n292_ & ~x30;
  ...
  assign new_n381_ = x30 & ((~new_n382_ & x00) | (new_n203_ & ~x20 & x26));
  ...
  assign z36 = (~new_n406_ & x21) | (~x30 & ((~new_n387_ & ~x21) | new_n412_ | (~new_n399_ & x21)));
  assign new_n387_ = (new_n388_ | x03) & new_n395_ & (new_n390_ | ~x18);
  assign new_n388_ = ~new_n389_ & (~new_n118_ | ~x20 | ~x27 | x29);
  assign new_n389_ = x00 & ~x05 & ~x18 & new_n203_ & ~x19 & ~x20;
  ...
  assign new_n395_ = (new_n396_ | x29) & (~x00 | x18 | ~x20 | new_n398_ | ~x29);
  assign new_n396_ = (x18 | new_n292_ | ~x28) & (x14 | new_n397_ | x27);
  assign new_n397_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n398_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n399_ = x29 ? new_n400_ : new_n404_;
  assign new_n400_ = (x19 | ((new_n401_ | x28) & (x18 | ~x20))) & (~x20 | ~x22 | x28) & (~x19 | (x18 ? ~x20 : ~x28));
  assign new_n401_ = new_n403_ & (x09 | ~x22 | ~new_n402_ | x38);
  assign new_n402_ = ~x41 & ((x39 & x42) | (~x18 & ~x20 & ~x39 & x40 & ~x42));
  assign new_n403_ = (~x18 | (x20 & (~x11 | ~x20 | ~x25))) & (~x20 | (~x26 & (x11 | ~x25)));
  assign new_n404_ = ~new_n405_ & (x20 | ~x28 | ~x18 | x19);
  assign new_n405_ = ~x12 & ~x13 & ~x14 & ~x27 & ~x28;
  assign new_n406_ = (~new_n407_ | x28) & (~x18 | x19 | ~x20 | new_n411_ | ~x28);
  assign new_n407_ = x30 & (new_n410_ | (~x29 & (new_n409_ | (~new_n408_ & ~x18))));
  assign new_n408_ = (new_n94_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
  assign new_n409_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n410_ = x20 & x25 & x29 & ~x11 & x18 & ~x19;
  assign new_n411_ = x16 ? x08 : x07;
  assign new_n412_ = x19 & x20 & ((new_n413_ & ~x18) | (new_n203_ & x18 & ~x27));
  assign new_n413_ = x22 & x28 & ~new_n411_ & ~x29;
  assign z38 = (~new_n415_ & ~x00) | (~x01 & ~x18 & new_n429_ & x19);
  assign new_n415_ = (x29 | (~new_n422_ & (new_n416_ | ~x30))) & (x21 | new_n423_ | ~x29);
  ...
  assign new_n419_ = (~x21 | x28 | (~new_n112_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n420_ = x18 ? ((x20 | x21 | ~x26 | ~x28) & (~x20 | ~x21 | ~x24)) : (~x21 | ~x28);
  assign new_n421_ = ~x05 & ~x15 & ~x18 & x20 & x21 & x22;
  assign new_n422_ = new_n346_ & x20 & ~x21 & x27;
  assign new_n423_ = ~new_n426_ & (x30 | (x18 ? (~new_n427_ & ~new_n428_) : new_n424_));
  assign new_n424_ = ~new_n425_ & (~x20 | (x19 ? (~x22 | ~x28) : (~x23 | x28)));
  assign new_n425_ = ~x05 & ((x19 & x20 & x22) | (~x03 & ~x19 & ~x20 & ~x28));
  assign new_n426_ = new_n118_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n427_ = x20 & ((~x19 & x26 & ~x28) | (~x04 & x19 & ~x27 & x28));
  assign new_n428_ = x19 & ~x20 & (x22 | x25 | (x26 & ~x28));
  assign new_n429_ = ~x20 & ~new_n131_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n431_ & x19) | (x29 & (new_n441_ | (~new_n437_ & ~x19)));
  assign new_n431_ = x18 ? ((new_n435_ | x21) & (~new_n117_ | ~x20 | ~x21)) : new_n432_;
  assign new_n432_ = x21 ? new_n434_ : (~new_n433_ & (~x29 | new_n216_ | x30));
  assign new_n433_ = x02 & ~x03 & x20 & new_n114_ & x22 & x28;
  assign new_n434_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n131_ | ~x30);
  assign new_n435_ = x20 ? ((~new_n114_ | ~x27) & (~new_n116_ | ~x04 | x27)) : ~new_n436_;
  assign new_n436_ = x29 & ((~new_n144_ & x30) | (x26 & x28 & ~x30));
  assign new_n437_ = (new_n438_ | ~x20) & (x30 | ((x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20)));
  assign new_n438_ = (x18 | (x21 ? x30 : (x28 | ~x30))) & (~x21 | x28 | new_n162_ | x30) & (new_n439_ | ~x18);
  assign new_n439_ = (~new_n440_ | x21) & (~x11 | ~x21 | ~new_n138_ | ~x25);
  assign new_n440_ = x26 & ((x28 & ~x30) | (~x17 & ~x28 & x30));
  assign new_n441_ = x20 & x21 & new_n138_ & x22;
  assign z40 = ~x28 & ((~x18 & (new_n445_ | (~new_n446_ & x05))) | (x05 & new_n443_ & x18));
  assign new_n443_ = x20 & ~new_n444_ & x30;
  assign new_n444_ = (x27 | ~x29 | ~x19 | x21) & (x19 | ~x21 | new_n340_ | x29);
