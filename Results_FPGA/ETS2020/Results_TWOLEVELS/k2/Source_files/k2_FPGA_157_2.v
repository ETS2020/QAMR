// Benchmark "FAU" written by ABC on Fri Jul 31 17:21:11 2020
...
module FAU ( 
  ...
  assign new_n326_ = ~new_n329_ & (x20 | (~new_n328_ & (new_n327_ | x19)));
  assign new_n327_ = (x03 | x18 | new_n122_ | x21) & (~x18 | ~x21 | ~new_n113_ | x28);
  assign new_n328_ = x18 & x19 & ~x21 & new_n117_ & x26 & ~x28;
  assign new_n329_ = ~x18 & x19 & x21 & new_n113_ & x28;
  ...
  assign z35 = x30 ? ~new_n371_ : ~new_n391_;
  assign new_n371_ = ~new_n389_ & (x29 | (~new_n381_ & new_n383_ & (new_n372_ | x18)));
  assign new_n372_ = x21 ? (~new_n375_ & (new_n373_ | ~x19)) : new_n378_;
  ...
  assign new_n381_ = x10 & x25 & (new_n382_ | (new_n118_ & ~x20 & ~x21));
  assign new_n382_ = new_n111_ & x00 & x21 & ~x28 & ~x19 & x20;
  assign new_n383_ = x20 ? (~new_n387_ & (new_n384_ | x19)) : (~new_n388_ & (~new_n386_ | ~x19));
  ...
  assign new_n387_ = x18 & x19 & (~x21 | (x00 & x21));
  assign new_n388_ = x18 & ((x26 & ~x28 & x19 & ~x21) | (x00 & ((~x19 & x21 & ~x28) | (x26 & x28 & x19 & ~x21))));
  assign new_n389_ = x19 & x20 & new_n390_ & ~x21;
  assign new_n390_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  assign new_n391_ = (x21 | (~new_n392_ & (new_n395_ | ~x29))) & (~x29 | (~new_n402_ & (new_n399_ | ~x21)));
  assign new_n392_ = ~x03 & (new_n393_ | (new_n394_ & x00 & ~x05 & ~x18));
  assign new_n393_ = new_n118_ & x20 & x27 & ~x29;
  assign new_n394_ = ~x19 & ~x20 & ~x28 & x29;
  assign new_n395_ = (~x18 | (~new_n397_ & (new_n396_ | ~x00))) & (~x00 | x18 | new_n398_ | ~x20);
  assign new_n396_ = (~x19 | new_n121_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n397_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n398_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n399_ = (new_n400_ | ~x20) & (x19 | x28 | (~new_n401_ & (~x18 | x20))) & (x18 | ~x19 | ~x28);
  assign new_n400_ = (~x18 | (~x19 & (~x22 | x28))) & (~x19 | ~x22) & (x19 | (x18 & (x28 | (~x25 & ~x26))));
  assign new_n401_ = x39 & ~x41 & x42 & ~x09 & x22 & ~x38;
  assign new_n402_ = new_n118_ & x20 & ~x27 & ~x28;
  assign z36 = (~new_n421_ & x21) | (~x30 & (~new_n412_ | (~new_n404_ & ~x21)));
  assign new_n404_ = ~new_n392_ & new_n407_ & (~x18 | (new_n405_ & (new_n411_ | ~x26)));
  assign new_n405_ = (~x19 | (~new_n406_ & (~new_n367_ | ~x20))) & (~new_n238_ | x14 | x19 | x20);
  assign new_n406_ = x00 & ((~x20 & ~new_n121_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n407_ = (new_n408_ | x29) & (~x00 | x18 | ~x20 | new_n398_ | ~x29);
  assign new_n408_ = ~new_n410_ & (x14 | new_n409_ | x27);
  assign new_n409_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n410_ = ~x18 & x28 & (~x19 | (x20 & x22));
  assign new_n411_ = (((~x28 | x29) & (~x00 | x28 | ~x29)) | ((~x17 | x19 | ~x20) & (~x19 | x20))) & (~x20 | x28 | ~x29 | ~x00 | x17 | x19);
  assign new_n412_ = (~new_n417_ | ~x19) & (~x21 | (x29 ? new_n413_ : new_n420_));
  assign new_n413_ = (x19 | ((x18 | ~x20) & (new_n414_ | x28))) & (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | ~x22) & (~x18 | (~x19 & (~x22 | x28)))));
  assign new_n414_ = new_n416_ & (x09 | ~x22 | ~new_n415_ | x38);
  assign new_n415_ = ~x41 & ((x39 & x42) | (~x18 & ~x20 & ~x39 & x40 & ~x42));
  assign new_n416_ = x20 ? (~x25 & ~x26) : ~x18;
  assign new_n417_ = x20 & ((new_n418_ & ~x18) | (~x28 & x29 & x18 & ~x27));
  assign new_n418_ = x22 & x28 & ~new_n419_ & ~x29;
  assign new_n419_ = x16 ? x08 : x07;
  assign new_n420_ = ~new_n210_ & (x12 | x13 | x14 | x27 | x28);
  assign new_n421_ = (~new_n422_ | x28) & (~x18 | x19 | ~x20 | new_n419_ | ~x28);
  assign new_n422_ = x30 & (new_n425_ | (~x29 & (new_n424_ | (~new_n423_ & ~x18))));
  assign new_n423_ = (new_n94_ | ~x19) & (x20 | ~x22 | ~x33 | ~x09 | x19);
  assign new_n424_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n425_ = x20 & x25 & x29 & ~x11 & x18 & ~x19;
  assign z37 = (~new_n427_ & x30) | new_n480_ | (~x30 & (x29 ? ~new_n455_ : ~new_n470_));
  assign new_n427_ = ~new_n428_ & new_n446_ & (x29 | (~new_n430_ & new_n437_));
  assign new_n428_ = ~new_n429_ & (x22 | x23);
  assign new_n429_ = (~x20 | x21 | ~x18 | x19) & (~new_n239_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  assign new_n430_ = ~x18 & (x21 ? (new_n375_ | new_n435_) : ~new_n431_);
  assign new_n431_ = (new_n432_ | ~x28) & ~new_n433_ & new_n434_;
  assign new_n432_ = (~x02 | x03 | ((~x19 | ~x20 | ~x22) & (~x00 | x19 | x20))) & (~x20 | (x02 & ~x03) | (x19 & (~x19 | ~x22)));
  assign new_n433_ = x20 & ((~x19 & x24) | ((x22 | x26) & (~x19 | (x19 & ~x28))));
  assign new_n434_ = (~x23 | x28) & (x20 | (x19 ? ~x23 : (x28 & (x02 | x03))));
  assign new_n435_ = x19 & (new_n374_ | (~x28 & (~new_n436_ | x25)));
  assign new_n436_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n437_ = x20 ? (~new_n441_ & (x28 | (~new_n438_ & ~new_n445_))) : new_n443_;
  assign new_n438_ = x21 & (new_n308_ | (~x19 & (new_n440_ | (new_n439_ & x00))));
  assign new_n439_ = ~x15 & ((x25 & (~x10 | (~x05 & x10))) | (~x05 & (x22 | x26)));
  assign new_n440_ = ~x05 & x15 & x18;
  assign new_n441_ = ~new_n442_ & x18;
  assign new_n442_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21 | (~x27 & (x27 | ~x28)));
  assign new_n443_ = (~new_n386_ | ~x19) & (new_n444_ | ~x18);
  assign new_n444_ = (~x00 | ((x19 | ~x21 | x28) & (~x26 | ~x28 | ~x19 | x21))) & (x19 | ~x21 | ~x28) & (x21 | (~x25 & (~x19 | ~x26 | x28)));
  assign new_n445_ = x18 & ~x21 & (x19 ? ~x27 : x26);
  assign new_n446_ = new_n451_ & (~x29 | (new_n178_ & (x28 | (~new_n447_ & ~new_n449_))));
  assign new_n447_ = ~x19 & (x21 ? ~new_n448_ : ~new_n176_);
  assign new_n448_ = (~x20 | (x11 ? (~x25 & ~x26) : (~x18 | ~x25))) & (~x18 | (~x22 & (x11 | ~x26))) & (x20 | (~x18 & ~x22));
  assign new_n449_ = x19 & (x18 ? new_n450_ : (x20 & x22));
  assign new_n450_ = ~x21 & (x20 ? (~x27 & (x05 | (x00 & ~x05))) : x26);
  assign new_n451_ = (x20 | ((new_n453_ | x19) & (~x18 | ~new_n454_ | ~x19))) & (~x18 | ~new_n452_ | ~x19);
  assign new_n452_ = x21 & (x22 | x26);
  assign new_n453_ = x18 ? (x21 | (~x22 & ~x25)) : (~x21 | ~x22 | (~x28 & (~x09 | x28)));
  assign new_n454_ = x21 & x25;
  assign new_n455_ = new_n460_ & (x18 | (new_n467_ & (x20 | (new_n456_ & ~new_n168_))));
  assign new_n456_ = (x19 | ~x21 | ~x23) & (x28 | (~new_n457_ & (x19 | new_n459_ | x21)));
  assign new_n457_ = ~x09 & x21 & x22 & ~x38 & new_n458_ & ~x39;
  assign new_n458_ = ~x41 & ~x42 & (x40 ? ~x19 : ((~x43 & ~x44) | (~x19 & (~x43 ^ ~x44))));
  assign new_n459_ = ~x03 & ~x05 & (~x00 | x03 | x05);
  assign new_n460_ = ~new_n461_ & (new_n465_ | ~x21) & (~x18 | (new_n463_ & ~new_n466_));
  assign new_n461_ = x25 & ((new_n462_ & x19 & ~x20 & ~x21) | (x21 & ~x28 & ~x19 & x20));
  assign new_n462_ = x00 & x10 & x18;
  assign new_n463_ = (x21 | (~new_n397_ & ~new_n464_)) & (~x19 | ~x20 | x28) & (~x21 | (x19 ? ~x20 : (x20 | x28)));
  assign new_n464_ = x26 & (x28 ? (x19 ^ x20) : ((x17 & ~x19 & x20) | (x00 & ((x19 & ~x20) | (~x17 & ~x19 & x20)))));
  assign new_n465_ = x19 ? (~x20 | ~x22) : (x28 | (~new_n401_ & (~x20 | ~x26)));
  assign new_n466_ = x22 & ((x20 & x21 & ~x28) | (x00 & x19 & ~x20 & ~x21));
  assign new_n467_ = (~x20 | (x19 ? (~new_n469_ | x21) : (~x21 & (new_n468_ | x21)))) & (~x28 | (~x19 ^ ~x21));
  assign new_n468_ = ~x24 & (~x00 | ~x23 | x28);
  assign new_n469_ = x22 & ((x05 & ~x28) | (x00 & (x28 | (~x05 & ~x28))));
  assign new_n470_ = (~x20 | (~new_n471_ & (new_n475_ | x21))) & new_n477_ & (new_n420_ | ~x21);
  assign new_n471_ = ~new_n472_ & x19;
  assign new_n472_ = (~x28 | (x18 ? (x21 | x27) : ~new_n473_)) & (~x18 | x21 | new_n474_ | ~x27);
  assign new_n473_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n474_ = x03 & (~x00 | ~x03);
  assign new_n475_ = (new_n476_ | x18) & (~x17 | ~x18 | ~new_n133_ | x19);
  ...
  assign new_n480_ = ~x19 & x21 & (new_n482_ | (new_n481_ & ~x09));
  assign new_n481_ = ~x18 & ~x20 & x22 & ~x28 & ~new_n357_ & x29;
  assign new_n482_ = x20 & ((x18 & x28) | (~x10 & ~x18 & x25));
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n484_ & x21;
  assign new_n484_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
