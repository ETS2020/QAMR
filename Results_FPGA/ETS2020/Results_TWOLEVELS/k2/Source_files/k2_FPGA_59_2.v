// Benchmark "FAU" written by ABC on Fri Jul 31 17:18:31 2020
...
module FAU ( 
  ...
  wire new_n93_, new_n94_, new_n95_, new_n97_, new_n98_, new_n100_,
    ...
    new_n474_, new_n475_, new_n477_, new_n479_;
  ...
  assign z06 = (x20 & (new_n113_ | (~new_n102_ & x00))) | (x00 & new_n117_ & ~x20);
  assign new_n102_ = x19 ? (~new_n108_ & (new_n106_ | x21)) : (~new_n103_ & (~new_n112_ | x21));
  assign new_n103_ = ~x29 & x30 & (x21 ? new_n104_ : (~new_n105_ & x28));
  ...
  assign z11 = (~new_n144_ & x21) | new_n160_ | (~new_n154_ & ~x21);
  assign new_n144_ = (x28 | ((new_n149_ | x20) & (new_n145_ | ~x29))) & (new_n153_ | ~x29);
  assign new_n145_ = ~new_n146_ & (x19 | ((new_n148_ | ~x30) & (~x20 | ~x26 | x30)));
  assign new_n146_ = x18 & x20 & ~x30 & (new_n147_ | x22);
  assign new_n147_ = ~x11 & x25;
  assign new_n148_ = (~x20 | (x11 ? (~x25 & ~x26) : (~x18 | ~x25))) & (~x18 | (~x22 & (x11 | ~x26)));
  ...
  assign new_n153_ = (x18 | (x19 ? ~x28 : ~x20)) & (~x19 | ~x20 | x30 | (~x18 & ~x22));
  ...
  assign new_n160_ = ~x18 & x19 & x20 & new_n110_ & x29 & x30;
  ...
  assign new_n185_ = ~x20 & x21 & ~new_n98_ & x30;
  ...
  assign new_n235_ = (x20 | x28 | ~x18 | x19) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | x28 | (~new_n147_ & ~x22))));
  ...
  assign z19 = (~new_n246_ & x18) | (~new_n266_ & x30) | (~new_n258_ & x29);
  ...
  assign new_n263_ = (x18 | ~x28) & (~x20 | ~x22);
  ...
  assign new_n300_ = (~x00 | ~x03 | ~x27 | x29 | x30) & (x27 | new_n301_ | ~x29);
  ...
  assign new_n316_ = new_n317_ & ~x09 & x22 & ~x38 & ~x39;
  ...
  assign new_n322_ = x19 ? (~x18 & (~new_n109_ | ~new_n110_ | x18)) : (~new_n104_ & (x18 | ~x24));
  ...
  assign z34 = (~new_n342_ & ~x18) | new_n363_ | (x18 & (x30 ? ~new_n354_ : ~new_n359_));
  assign new_n342_ = ~new_n343_ & (new_n347_ | ~x29) & (x21 | ~x28 | ~new_n353_ | x29);
  assign new_n343_ = x30 & ((~new_n346_ & ~x28) | (~new_n344_ & ~x29));
  assign new_n344_ = (~x28 | ((~x00 | ~x19 | ~x21) & (new_n345_ | x21))) & (~x19 | ~x21 | new_n94_ | x28);
  assign new_n345_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n346_ = (x19 | ((x21 | ~x29) & (~x09 | x20 | ~x21 | ~x22))) & (~x19 | ~x20 | ~x22 | ~x29);
  assign new_n347_ = (x30 | ((~new_n352_ | ~x19) & (x09 | ~new_n348_ | x19))) & (x09 | ~new_n350_ | x19);
  assign new_n348_ = ~x20 & x21 & x22 & ~x28 & new_n349_ & ~x38;
  assign new_n349_ = ~x39 & ~x41 & ~x42 & (x40 | (~x40 & (~x43 ^ ~x44)));
  assign new_n350_ = ~x20 & x21 & x22 & ~new_n351_ & ~x28;
  assign new_n351_ = ~x38 & ~x41 & (x39 | ~x42) & (~x39 | x42);
  assign new_n352_ = x28 & (x21 | (x00 & x20 & ~x21 & x22));
  assign new_n353_ = ~x30 & (~x19 | (x20 & x22));
  assign new_n354_ = (x28 | new_n355_ | ~x29) & (x21 | ~x28 | new_n358_ | x29);
  assign new_n355_ = x19 ? (new_n357_ | x21) : (new_n356_ | ~x21);
  assign new_n356_ = x20 & ~x22 & (x11 | (~x26 & (~x20 | ~x25)));
  assign new_n357_ = (x20 | ~x26) & (~x20 | x27 | ~x00 | x05);
  assign new_n358_ = (~x00 | ~x26 | (~x19 ^ x20)) & (~x19 | ~x20 | x27);
  assign new_n359_ = (x21 | ((new_n360_ | ~x20) & (~new_n362_ | ~x26 | ~x19 | x20))) & (~new_n362_ | ~x21 | x19 | x20);
  assign new_n360_ = (~new_n361_ | ~x19) & (~x17 | x19 | ~x26 | (x28 ^ ~x29));
  assign new_n361_ = ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n362_ = x28 & ~x29;
  assign new_n363_ = new_n110_ & x29 & x30 & ~x19 & ~x20 & x21;
  assign z35 = x30 ? (new_n394_ | (~new_n365_ & ~x29)) : ~new_n382_;
  assign new_n365_ = ~new_n366_ & ~new_n377_ & ~new_n380_ & (~x10 | new_n375_ | ~x25);
  assign new_n366_ = ~x18 & (x21 ? (new_n369_ | (~new_n367_ & x19)) : ~new_n372_);
  assign new_n367_ = ~new_n368_ & (~x01 | x20 | x28 | (~x22 & ~x23));
  assign new_n368_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n369_ = ~x19 & ((~new_n370_ & ~x20) | (x00 & ~new_n371_ & x20));
  assign new_n370_ = ~x23 & (x09 | ~x22 | x28);
  assign new_n371_ = ~x22 & ~x24 & ~x26 & (~x10 | ~x25);
  assign new_n372_ = x19 ? (x20 ? ~new_n269_ : ~x23) : (~new_n373_ & new_n374_);
  assign new_n373_ = x28 & ((x00 & ~x03 & (x02 ^ x20)) | (~x06 & x20 & (~x02 | x03)));
  assign new_n374_ = (x20 | (x28 & (x02 | x03))) & (~x23 | x28) & (~x20 | ~x24);
  assign new_n375_ = (~x18 | ~x19 | x20 | x21) & (~new_n376_ | ~x21 | x28 | x19 | ~x20);
  assign new_n376_ = new_n109_ & x00;
  assign new_n377_ = x20 & ((~new_n378_ & ~x19) | (x18 & x19 & (~x21 | (x00 & x21))));
  assign new_n378_ = (x28 | ((~new_n379_ | ~x00) & (~x18 | x21 | ~x26))) & (~x00 | ~x18 | x21 | ~x26 | ~x28);
  assign new_n379_ = ~x05 & ~x15 & x21 & (x22 | x26);
  assign new_n380_ = ~x20 & ((~new_n381_ & x18) | (x19 & ~x21 & x22));
  assign new_n381_ = (~x00 | ((~x26 | ~x28 | ~x19 | x21) & (x19 | ~x21 | x28))) & (~x26 | x28 | ~x19 | x21);
  assign new_n382_ = (x21 | (~new_n383_ & (new_n386_ | ~x29))) & (~x29 | (~new_n393_ & (new_n390_ | ~x21)));
  assign new_n383_ = ~x03 & (new_n384_ | (new_n385_ & x00 & ~x05 & ~x18));
  assign new_n384_ = new_n116_ & x20 & x27 & ~x29;
  assign new_n385_ = ~x19 & ~x20 & ~x28 & x29;
  assign new_n386_ = (~x18 | (~new_n388_ & (new_n387_ | ~x00))) & (~x00 | x18 | new_n389_ | ~x20);
  assign new_n387_ = (~x19 | new_n119_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n388_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n389_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n390_ = (new_n391_ | ~x20) & (x19 | x28 | (~new_n392_ & (~x18 | x20))) & (x18 | ~x19 | ~x28);
  assign new_n391_ = (~x18 | (~x19 & (~x22 | x28))) & (~x19 | ~x22) & (x19 | (x18 & (x28 | (~x25 & ~x26))));
  assign new_n392_ = x39 & ~x41 & x42 & ~x09 & x22 & ~x38;
  assign new_n393_ = new_n116_ & x20 & ~x27 & ~x28;
  assign new_n394_ = x19 & x20 & new_n395_ & ~x21;
  assign new_n395_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  assign z36 = (~new_n414_ & x21) | (~x30 & (~new_n405_ | (~new_n397_ & ~x21)));
  assign new_n397_ = ~new_n383_ & new_n400_ & (~x18 | (new_n398_ & (new_n404_ | ~x26)));
  assign new_n398_ = (~x19 | (~new_n399_ & (~new_n361_ | ~x20))) & (~new_n236_ | x14 | x19 | x20);
  assign new_n399_ = x00 & ((~x20 & ~new_n119_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n400_ = (new_n401_ | x29) & (~x00 | x18 | ~x20 | new_n389_ | ~x29);
  assign new_n401_ = ~new_n403_ & (x14 | new_n402_ | x27);
  assign new_n402_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n403_ = ~x18 & x28 & (~x19 | (x20 & x22));
  assign new_n404_ = (((~x28 | x29) & (~x00 | x28 | ~x29)) | ((~x17 | x19 | ~x20) & (~x19 | x20))) & (~x20 | x28 | ~x29 | ~x00 | x17 | x19);
  assign new_n405_ = (~new_n410_ | ~x19) & (~x21 | (x29 ? new_n406_ : new_n413_));
  assign new_n406_ = (x19 | ((x18 | ~x20) & (new_n407_ | x28))) & (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | ~x22) & (~x18 | (~x19 & (~x22 | x28)))));
  assign new_n407_ = new_n409_ & (x09 | ~x22 | ~new_n408_ | x38);
  assign new_n408_ = ~x41 & ((x39 & x42) | (~x18 & ~x20 & ~x39 & x40 & ~x42));
  assign new_n409_ = x20 ? (~x25 & ~x26) : ~x18;
  assign new_n410_ = x20 & ((new_n411_ & ~x18) | (~x28 & x29 & x18 & ~x27));
  assign new_n411_ = x22 & x28 & ~new_n412_ & ~x29;
  assign new_n412_ = x16 ? x08 : x07;
  assign new_n413_ = ~new_n208_ & (x12 | x13 | x14 | x27 | x28);
  assign new_n414_ = (~new_n415_ | x28) & (~x18 | x19 | ~x20 | new_n412_ | ~x28);
  assign new_n415_ = x30 & (new_n418_ | (~x29 & (new_n417_ | (~new_n416_ & ~x18))));
  assign new_n416_ = (new_n94_ | ~x19) & (x20 | ~x22 | ~x33 | ~x09 | x19);
  assign new_n417_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n418_ = x20 & x25 & x29 & ~x11 & x18 & ~x19;
  assign z37 = (~new_n420_ & x30) | new_n473_ | (~x30 & (x29 ? ~new_n448_ : ~new_n463_));
  assign new_n420_ = ~new_n421_ & new_n439_ & (x29 | (~new_n423_ & new_n430_));
  assign new_n421_ = ~new_n422_ & (x22 | x23);
  assign new_n422_ = (~x20 | x21 | ~x18 | x19) & (~new_n237_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  assign new_n423_ = ~x18 & (x21 ? (new_n369_ | new_n428_) : ~new_n424_);
  assign new_n424_ = (new_n425_ | ~x28) & ~new_n426_ & new_n427_;
  assign new_n425_ = (~x02 | x03 | ((~x19 | ~x20 | ~x22) & (~x00 | x19 | x20))) & (~x20 | (x02 & ~x03) | (x19 & (~x19 | ~x22)));
  assign new_n426_ = x20 & ((~x19 & x24) | ((x22 | x26) & (~x19 | (x19 & ~x28))));
  assign new_n427_ = (~x23 | x28) & (x20 | (x19 ? ~x23 : (x28 & (x02 | x03))));
  assign new_n428_ = x19 & (new_n368_ | (~x28 & (~new_n429_ | x25)));
  assign new_n429_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n430_ = x20 ? (~new_n434_ & (x28 | (~new_n431_ & ~new_n438_))) : new_n436_;
  assign new_n431_ = x21 & (new_n306_ | (~x19 & (new_n433_ | (new_n432_ & x00))));
  assign new_n432_ = ~x15 & ((x25 & (~x10 | (~x05 & x10))) | (~x05 & (x22 | x26)));
  assign new_n433_ = ~x05 & x15 & x18;
  assign new_n434_ = ~new_n435_ & x18;
  assign new_n435_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21 | (~x27 & (x27 | ~x28)));
  assign new_n436_ = (new_n437_ | ~x18) & (~x19 | x21 | ~x22);
  assign new_n437_ = (~x00 | ((x19 | ~x21 | x28) & (~x26 | ~x28 | ~x19 | x21))) & (x19 | ~x21 | ~x28) & (x21 | (~x25 & (~x19 | ~x26 | x28)));
  assign new_n438_ = x18 & ~x21 & (x19 ? ~x27 : x26);
  assign new_n439_ = new_n444_ & (~x29 | (new_n176_ & (x28 | (~new_n440_ & ~new_n442_))));
  assign new_n440_ = ~x19 & (x21 ? ~new_n441_ : ~new_n174_);
  assign new_n441_ = (~x20 | (x11 ? (~x25 & ~x26) : (~x18 | ~x25))) & (x20 | (~x18 & ~x22)) & (~x18 | (~x22 & (x11 | ~x26)));
  assign new_n442_ = x19 & (x18 ? new_n443_ : (x20 & x22));
  assign new_n443_ = ~x21 & (x20 ? (~x27 & (x05 | (x00 & ~x05))) : x26);
  assign new_n444_ = (x20 | ((new_n446_ | x19) & (~x18 | ~new_n447_ | ~x19))) & (~x18 | ~new_n445_ | ~x19);
  assign new_n445_ = x21 & (x22 | x26);
  assign new_n446_ = x18 ? (x21 | (~x22 & ~x25)) : (~x21 | ~x22 | (~x28 & (~x09 | x28)));
  assign new_n447_ = x21 & x25;
  assign new_n448_ = new_n453_ & (x18 | (new_n460_ & (x20 | (new_n449_ & ~new_n166_))));
  assign new_n449_ = (x19 | ~x21 | ~x23) & (x28 | (~new_n450_ & (x19 | new_n452_ | x21)));
  assign new_n450_ = ~x09 & x21 & x22 & ~x38 & new_n451_ & ~x39;
  assign new_n451_ = ~x41 & ~x42 & (x40 ? ~x19 : ((~x43 & ~x44) | (~x19 & (~x43 ^ ~x44))));
  assign new_n452_ = ~x03 & ~x05 & (~x00 | x03 | x05);
  assign new_n453_ = ~new_n454_ & (new_n458_ | ~x21) & (~x18 | (new_n456_ & ~new_n459_));
  assign new_n454_ = x25 & ((new_n455_ & x19 & ~x20 & ~x21) | (x21 & ~x28 & ~x19 & x20));
  assign new_n455_ = x00 & x10 & x18;
  assign new_n456_ = (x21 | (~new_n388_ & ~new_n457_)) & (~x19 | ~x20 | x28) & (~x21 | (x19 ? ~x20 : (x20 | x28)));
  assign new_n457_ = x26 & (x28 ? (x19 ^ x20) : ((x17 & ~x19 & x20) | (x00 & ((x19 & ~x20) | (~x17 & ~x19 & x20)))));
  assign new_n458_ = x19 ? (~x20 | ~x22) : (x28 | (~new_n392_ & (~x20 | ~x26)));
  assign new_n459_ = x22 & ((x20 & x21 & ~x28) | (x00 & x19 & ~x20 & ~x21));
  assign new_n460_ = (~x20 | (x19 ? (~new_n462_ | x21) : (~x21 & (new_n461_ | x21)))) & (~x28 | (~x19 ^ ~x21));
  assign new_n461_ = ~x24 & (~x00 | ~x23 | x28);
  assign new_n462_ = x22 & ((x05 & ~x28) | (x00 & (x28 | (~x05 & ~x28))));
  assign new_n463_ = (~x20 | (~new_n464_ & (new_n468_ | x21))) & new_n470_ & (new_n413_ | ~x21);
  assign new_n464_ = ~new_n465_ & x19;
  assign new_n465_ = (~x28 | (x18 ? (x21 | x27) : ~new_n466_)) & (~x18 | x21 | new_n467_ | ~x27);
  assign new_n466_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n467_ = x03 & (~x00 | ~x03);
  assign new_n468_ = (new_n469_ | x18) & (~x17 | ~x18 | ~new_n131_ | x19);
  assign new_n469_ = (~x22 | ~x28) & (x14 | x19 | x23 | x27);
  assign new_n470_ = (~x14 | x27 | x28) & (x21 | ((new_n472_ | ~x28) & (x14 | x27 | new_n471_ | x28)));
  assign new_n471_ = ~x13 & (~x18 | x19 | x20);
  assign new_n472_ = (x18 | x19) & (~x18 | ~x19 | x20 | ~x26);
  assign new_n473_ = ~x19 & x21 & (new_n475_ | (new_n474_ & ~x09));
  assign new_n474_ = ~x18 & ~x20 & x22 & ~x28 & ~new_n351_ & x29;
  assign new_n475_ = x20 & ((x18 & x28) | (~x10 & ~x18 & x25));
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n477_ & x21;
  assign new_n477_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
  assign z43 = ~x18 & new_n479_ & ~x19;
  assign new_n479_ = x20 & ~x21 & ~x29 & x30 & (x22 | x24);
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
  assign z10 = 1'b0;
