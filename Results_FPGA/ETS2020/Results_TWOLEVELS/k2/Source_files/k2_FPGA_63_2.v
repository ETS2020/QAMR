// Benchmark "FAU" written by ABC on Fri Jul 31 17:18:38 2020
...
module FAU ( 
  ...
  assign new_n105_ = (x02 | x03 | x18) & (~x18 | ~x26);
  ...
  assign z35 = x30 ? ~new_n369_ : ~new_n389_;
  assign new_n369_ = ~new_n387_ & (x29 | (~new_n379_ & new_n381_ & (new_n370_ | x18)));
  assign new_n370_ = x21 ? (~new_n373_ & (new_n371_ | ~x19)) : new_n376_;
  ...
  assign new_n379_ = x10 & x25 & (new_n380_ | (new_n116_ & ~x20 & ~x21));
  assign new_n380_ = new_n109_ & x00 & x21 & ~x28 & ~x19 & x20;
  assign new_n381_ = x20 ? (~new_n385_ & (new_n382_ | x19)) : (~new_n386_ & (~new_n384_ | ~x19));
  ...
  assign new_n385_ = x18 & x19 & (~x21 | (x00 & x21));
  assign new_n386_ = x18 & ((x26 & ~x28 & x19 & ~x21) | (x00 & ((~x19 & x21 & ~x28) | (x26 & x28 & x19 & ~x21))));
  assign new_n387_ = x19 & x20 & new_n388_ & ~x21;
  assign new_n388_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  assign new_n389_ = (x21 | (~new_n390_ & (new_n393_ | ~x29))) & (~x29 | (~new_n400_ & (new_n397_ | ~x21)));
  assign new_n390_ = ~x03 & (new_n391_ | (new_n392_ & x00 & ~x05 & ~x18));
  assign new_n391_ = new_n116_ & x20 & x27 & ~x29;
  assign new_n392_ = ~x19 & ~x20 & ~x28 & x29;
  assign new_n393_ = (~x18 | (~new_n395_ & (new_n394_ | ~x00))) & (~x00 | x18 | new_n396_ | ~x20);
  assign new_n394_ = (~x19 | new_n119_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n395_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n396_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n397_ = (new_n398_ | ~x20) & (x19 | x28 | (~new_n399_ & (~x18 | x20))) & (x18 | ~x19 | ~x28);
  assign new_n398_ = (~x18 | (~x19 & (~x22 | x28))) & (~x19 | ~x22) & (x19 | (x18 & (x28 | (~x25 & ~x26))));
  assign new_n399_ = x39 & ~x41 & x42 & ~x09 & x22 & ~x38;
  assign new_n400_ = new_n116_ & x20 & ~x27 & ~x28;
  assign z36 = (~new_n419_ & x21) | (~x30 & (~new_n410_ | (~new_n402_ & ~x21)));
  assign new_n402_ = ~new_n390_ & new_n405_ & (~x18 | (new_n403_ & (new_n409_ | ~x26)));
  assign new_n403_ = (~x19 | (~new_n404_ & (~new_n365_ | ~x20))) & (~new_n236_ | x14 | x19 | x20);
  assign new_n404_ = x00 & ((~x20 & ~new_n119_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n405_ = (new_n406_ | x29) & (~x00 | x18 | ~x20 | new_n396_ | ~x29);
  ...
  assign new_n418_ = ~new_n208_ & (x12 | x13 | x14 | x27 | x28);
  ...
  assign new_n427_ = (~x20 | x21 | ~x18 | x19) & (~new_n237_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  assign new_n428_ = ~x18 & (x21 ? (new_n373_ | new_n433_) : ~new_n429_);
  ...
  assign new_n433_ = x19 & (new_n372_ | (~x28 & (~new_n434_ | x25)));
  assign new_n434_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n435_ = x20 ? (~new_n439_ & (x28 | (~new_n436_ & ~new_n443_))) : new_n441_;
  assign new_n436_ = x21 & (new_n306_ | (~x19 & (new_n438_ | (new_n437_ & x00))));
  ...
  assign new_n441_ = (~new_n384_ | ~x19) & (new_n442_ | ~x18);
  assign new_n442_ = (~x00 | ((x19 | ~x21 | x28) & (~x26 | ~x28 | ~x19 | x21))) & (x19 | ~x21 | ~x28) & (x21 | (~x25 & (~x19 | ~x26 | x28)));
  assign new_n443_ = x18 & ~x21 & (x19 ? ~x27 : x26);
  assign new_n444_ = new_n449_ & (~x29 | (new_n176_ & (x28 | (~new_n445_ & ~new_n447_))));
  assign new_n445_ = ~x19 & (x21 ? ~new_n446_ : ~new_n174_);
  ...
  assign new_n453_ = new_n458_ & (x18 | (new_n465_ & (x20 | (new_n454_ & ~new_n166_))));
  ...
  assign new_n461_ = (x21 | (~new_n395_ & ~new_n462_)) & (~x19 | ~x20 | x28) & (~x21 | (x19 ? ~x20 : (x20 | x28)));
  assign new_n462_ = x26 & (x28 ? (x19 ^ x20) : ((x17 & ~x19 & x20) | (x00 & ((x19 & ~x20) | (~x17 & ~x19 & x20)))));
  assign new_n463_ = x19 ? (~x20 | ~x22) : (x28 | (~new_n399_ & (~x20 | ~x26)));
  ...
  assign new_n473_ = (new_n474_ | x18) & (~new_n131_ | x19 | ~x17 | ~x18);
  ...
  assign new_n479_ = ~x18 & ~x20 & x22 & ~x28 & ~new_n355_ & x29;
