...
module FAU ( 
  ...
  assign z34 = (~new_n337_ & ~x18) | new_n358_ | (x18 & (x30 ? ~new_n349_ : ~new_n354_));
  assign new_n337_ = ~new_n338_ & (new_n342_ | ~x29) & (x21 | ~x28 | ~new_n348_ | x29);
  assign new_n338_ = x30 & ((~new_n341_ & ~x28) | (~new_n339_ & ~x29));
  assign new_n339_ = (~x28 | ((~x00 | ~x19 | ~x21) & (new_n340_ | x21))) & (~x19 | ~x21 | new_n94_ | x28);
  ...
  assign new_n358_ = new_n110_ & x29 & x30 & ~x19 & ~x20 & x21;
  ...
  assign new_n367_ = x19 ? (x20 ? ~new_n269_ : ~x23) : (~new_n368_ & new_n369_);
  ...
  assign new_n371_ = new_n109_ & x00;
  ...
  assign new_n388_ = new_n116_ & x20 & ~x27 & ~x28;
  ...
  assign new_n393_ = (~x19 | (~new_n394_ & (~new_n356_ | ~x20))) & (~new_n236_ | x14 | x19 | x20);
  assign new_n394_ = x00 & ((~x20 & ~new_n119_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n417_ = (~x20 | x21 | ~x18 | x19) & (~new_n237_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  ...
  assign new_n426_ = x21 & (new_n306_ | (~x19 & (new_n428_ | (new_n427_ & x00))));
  ...
  assign new_n434_ = new_n439_ & (~x29 | (new_n176_ & (x28 | (~new_n435_ & ~new_n437_))));
  assign new_n435_ = ~x19 & (x21 ? ~new_n436_ : ~new_n174_);
  ...
  assign new_n443_ = new_n448_ & (x18 | (new_n455_ & (x20 | (new_n444_ & ~new_n166_))));
  ...
  assign new_n463_ = (new_n464_ | x18) & (~x17 | ~x18 | ~new_n131_ | x19);
