// Benchmark "FAU" written by ABC on Fri Jul 31 17:23:19 2020
...
module FAU ( 
  ...
  assign new_n132_ = new_n107_ & ~x28 & x21 & x22;
  ...
  assign new_n250_ = ~x11 & x20 & x21 & new_n111_ & ~x28;
  ...
  assign z34 = (~new_n336_ & ~x18) | new_n358_ | (x18 & (x30 ? ~new_n349_ : ~new_n354_));
  assign new_n336_ = ~new_n337_ & (new_n342_ | ~x29) & (x21 | ~x28 | ~new_n348_ | x29);
  assign new_n337_ = x30 & ((~new_n341_ & ~x28) | (~new_n338_ & ~x29));
  assign new_n338_ = (~x28 | ((new_n339_ | x21) & (~x00 | ~x19 | ~x21))) & (~x19 | ~x21 | new_n340_ | x28);
  assign new_n339_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n340_ = ~x24 & ~x26 & (~x10 | ~x25);
  assign new_n341_ = (x19 | ((x21 | ~x29) & (~x09 | x20 | ~x21 | ~x22))) & (~x19 | ~x20 | ~x22 | ~x29);
  assign new_n342_ = (x30 | ((~new_n347_ | ~x19) & (x09 | ~new_n343_ | x19))) & (x09 | ~new_n345_ | x19);
  assign new_n343_ = ~x20 & x21 & x22 & ~x28 & new_n344_ & ~x38;
  assign new_n344_ = ~x39 & ~x41 & ~x42 & (x40 | (~x40 & (~x43 ^ ~x44)));
  assign new_n345_ = ~x20 & x21 & x22 & ~new_n346_ & ~x28;
  assign new_n346_ = ~x38 & ~x41 & (x39 | ~x42) & (~x39 | x42);
  assign new_n347_ = x28 & (x21 | (x00 & x20 & ~x21 & x22));
  assign new_n348_ = ~x30 & (~x19 | (x20 & x22));
  assign new_n349_ = (x28 | new_n350_ | ~x29) & (x21 | ~x28 | new_n353_ | x29);
  assign new_n350_ = x19 ? (new_n352_ | x21) : (new_n351_ | ~x21);
  assign new_n351_ = x20 & ~x22 & (x11 | (~x26 & (~x20 | ~x25)));
  assign new_n352_ = (x20 | ~x26) & (~x20 | x27 | ~x00 | x05);
  assign new_n353_ = (~x00 | ~x26 | (~x19 ^ x20)) & (~x19 | ~x20 | x27);
  assign new_n354_ = (x21 | ((new_n355_ | ~x20) & (~new_n357_ | ~x26 | ~x19 | x20))) & (~new_n357_ | ~x21 | x19 | x20);
  assign new_n355_ = (~new_n356_ | ~x19) & (~x17 | x19 | ~x26 | (x28 ^ ~x29));
  assign new_n356_ = ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n357_ = x28 & ~x29;
  assign new_n358_ = new_n106_ & x29 & x30 & ~x19 & ~x20 & x21;
  assign z35 = x30 ? (new_n389_ | (~new_n360_ & ~x29)) : ~new_n377_;
  assign new_n360_ = ~new_n361_ & ~new_n372_ & ~new_n375_ & (~x10 | new_n370_ | ~x25);
  assign new_n361_ = ~x18 & (x21 ? (new_n364_ | (~new_n362_ & x19)) : ~new_n367_);
  assign new_n362_ = ~new_n363_ & (~x01 | x20 | x28 | (~x22 & ~x23));
  assign new_n363_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n364_ = ~x19 & ((~new_n365_ & ~x20) | (x00 & ~new_n366_ & x20));
  assign new_n365_ = ~x23 & (x09 | ~x22 | x28);
  assign new_n366_ = ~x22 & ~x24 & (~x10 | ~x25) & ~x26;
  assign new_n367_ = x19 ? (x20 ? ~new_n265_ : ~x23) : (~new_n368_ & new_n369_);
  assign new_n368_ = x28 & ((x00 & ~x03 & (x02 ^ x20)) | (~x06 & x20 & (~x02 | x03)));
  assign new_n369_ = (x20 | (x28 & (x02 | x03))) & (~x23 | x28) & (~x20 | ~x24);
  assign new_n370_ = (~x18 | ~x19 | x20 | x21) & (~new_n371_ | ~x21 | x28 | x19 | ~x20);
  assign new_n371_ = new_n105_ & x00;
  assign new_n372_ = x20 & ((~new_n373_ & ~x19) | (x18 & x19 & (~x21 | (x00 & x21))));
  assign new_n373_ = (x28 | ((~new_n374_ | ~x00) & (~x18 | x21 | ~x26))) & (~x00 | ~x18 | x21 | ~x26 | ~x28);
  assign new_n374_ = ~x05 & ~x15 & x21 & (x22 | x26);
  assign new_n375_ = ~x20 & ((~new_n376_ & x18) | (x19 & ~x21 & x22));
  assign new_n376_ = (~x00 | ((~x26 | ~x28 | ~x19 | x21) & (x19 | ~x21 | x28))) & (~x26 | x28 | ~x19 | x21);
  assign new_n377_ = (x21 | (~new_n378_ & (new_n381_ | ~x29))) & (~x29 | (~new_n388_ & (new_n385_ | ~x21)));
  assign new_n378_ = ~x03 & (new_n379_ | (new_n380_ & x00 & ~x05 & ~x18));
  assign new_n379_ = new_n112_ & x20 & x27 & ~x29;
  assign new_n380_ = ~x19 & ~x20 & ~x28 & x29;
  assign new_n381_ = (~x18 | (~new_n383_ & (new_n382_ | ~x00))) & (~x00 | x18 | new_n384_ | ~x20);
  assign new_n382_ = (~x19 | new_n115_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n383_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n384_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n385_ = (new_n386_ | ~x20) & (x19 | x28 | (~new_n387_ & (~x18 | x20))) & (x18 | ~x19 | ~x28);
  assign new_n386_ = (~x18 | (~x19 & (~x22 | x28))) & (~x19 | ~x22) & (x19 | (x18 & (x28 | (~x25 & ~x26))));
  assign new_n387_ = x39 & ~x41 & x42 & ~x09 & x22 & ~x38;
  assign new_n388_ = new_n112_ & x20 & ~x27 & ~x28;
  assign new_n389_ = x19 & x20 & new_n390_ & ~x21;
  assign new_n390_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  assign z36 = (~new_n409_ & x21) | (~x30 & (~new_n400_ | (~new_n392_ & ~x21)));
  assign new_n392_ = ~new_n378_ & new_n395_ & (~x18 | (new_n393_ & (new_n399_ | ~x26)));
  assign new_n393_ = (~x19 | (~new_n394_ & (~new_n356_ | ~x20))) & (~new_n232_ | x14 | x19 | x20);
  assign new_n394_ = x00 & ((~x20 & ~new_n115_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n395_ = (new_n396_ | x29) & (~x00 | x18 | ~x20 | new_n384_ | ~x29);
  assign new_n396_ = ~new_n398_ & (x14 | new_n397_ | x27);
  assign new_n397_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n398_ = ~x18 & x28 & (~x19 | (x20 & x22));
  assign new_n399_ = (((~x28 | x29) & (~x00 | x28 | ~x29)) | ((~x17 | x19 | ~x20) & (~x19 | x20))) & (~x20 | x28 | ~x29 | ~x00 | x17 | x19);
  assign new_n400_ = (~new_n405_ | ~x19) & (~x21 | (x29 ? new_n401_ : new_n408_));
  assign new_n401_ = (x19 | ((x18 | ~x20) & (new_n402_ | x28))) & (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | ~x22) & (~x18 | (~x19 & (~x22 | x28)))));
  assign new_n402_ = new_n404_ & (x09 | ~x22 | ~new_n403_ | x38);
  assign new_n403_ = ~x41 & ((x39 & x42) | (~x18 & ~x20 & ~x39 & x40 & ~x42));
  assign new_n404_ = x20 ? (~x25 & ~x26) : ~x18;
  assign new_n405_ = x20 & ((new_n406_ & ~x18) | (~x28 & x29 & x18 & ~x27));
  assign new_n406_ = x22 & x28 & ~new_n407_ & ~x29;
  assign new_n407_ = x16 ? x08 : x07;
  assign new_n408_ = ~new_n204_ & (x12 | x13 | x14 | x27 | x28);
  assign new_n409_ = (~new_n410_ | x28) & (~x18 | x19 | ~x20 | new_n407_ | ~x28);
  assign new_n410_ = x30 & (new_n413_ | (~x29 & (new_n412_ | (~new_n411_ & ~x18))));
  assign new_n411_ = (new_n340_ | ~x19) & (x20 | ~x22 | ~x33 | ~x09 | x19);
  assign new_n412_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n413_ = x20 & x25 & x29 & ~x11 & x18 & ~x19;
  assign z37 = (~new_n415_ & x30) | new_n468_ | (~x30 & (x29 ? ~new_n443_ : ~new_n458_));
  assign new_n415_ = ~new_n416_ & new_n434_ & (x29 | (~new_n418_ & new_n425_));
  assign new_n416_ = ~new_n417_ & (x22 | x23);
  assign new_n417_ = (~x20 | x21 | ~x18 | x19) & (~new_n233_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  assign new_n418_ = ~x18 & (x21 ? (new_n364_ | new_n423_) : ~new_n419_);
  assign new_n419_ = (new_n420_ | ~x28) & ~new_n421_ & new_n422_;
  assign new_n420_ = (~x02 | x03 | ((~x19 | ~x20 | ~x22) & (~x00 | x19 | x20))) & (~x20 | (x02 & ~x03) | (x19 & (~x19 | ~x22)));
  assign new_n421_ = x20 & ((~x19 & x24) | ((x22 | x26) & (~x19 | (x19 & ~x28))));
  assign new_n422_ = (~x23 | x28) & (x20 | (x19 ? ~x23 : (x28 & (x02 | x03))));
  assign new_n423_ = x19 & (new_n363_ | (~x28 & (~new_n424_ | x25)));
  assign new_n424_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n425_ = x20 ? (~new_n429_ & (x28 | (~new_n426_ & ~new_n433_))) : new_n431_;
  assign new_n426_ = x21 & (new_n302_ | (~x19 & (new_n428_ | (new_n427_ & x00))));
  assign new_n427_ = ~x15 & ((x25 & (~x10 | (~x05 & x10))) | (~x05 & (x22 | x26)));
  assign new_n428_ = ~x05 & x15 & x18;
  assign new_n429_ = ~new_n430_ & x18;
  assign new_n430_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21 | (~x27 & (x27 | ~x28)));
  assign new_n431_ = (new_n432_ | ~x18) & (~x19 | x21 | ~x22);
  assign new_n432_ = (~x00 | ((x19 | ~x21 | x28) & (~x26 | ~x28 | ~x19 | x21))) & (x19 | ~x21 | ~x28) & (x21 | (~x25 & (~x19 | ~x26 | x28)));
  assign new_n433_ = x18 & ~x21 & (x19 ? ~x27 : x26);
  assign new_n434_ = new_n439_ & (~x29 | (new_n172_ & (x28 | (~new_n435_ & ~new_n437_))));
  assign new_n435_ = ~x19 & (x21 ? ~new_n436_ : ~new_n170_);
  assign new_n436_ = (~x20 | (x11 ? (~x25 & ~x26) : (~x18 | ~x25))) & (x20 | (~x18 & ~x22)) & (~x18 | (~x22 & (x11 | ~x26)));
  assign new_n437_ = x19 & (x18 ? new_n438_ : (x20 & x22));
  assign new_n438_ = ~x21 & (x20 ? (~x27 & (x05 | (x00 & ~x05))) : x26);
  assign new_n439_ = (x20 | ((new_n441_ | x19) & (~x18 | ~new_n442_ | ~x19))) & (~x18 | ~new_n440_ | ~x19);
  assign new_n440_ = x21 & (x22 | x26);
  assign new_n441_ = x18 ? (x21 | (~x22 & ~x25)) : (~x21 | ~x22 | (~x28 & (~x09 | x28)));
  assign new_n442_ = x21 & x25;
  assign new_n443_ = new_n448_ & (x18 | (new_n455_ & ((new_n444_ & ~new_n162_) | x20)));
  assign new_n444_ = (x19 | ~x21 | ~x23) & (x28 | (~new_n445_ & (x19 | new_n447_ | x21)));
  assign new_n445_ = ~x09 & x21 & x22 & ~x38 & new_n446_ & ~x39;
  assign new_n446_ = ~x41 & ~x42 & (x40 ? ~x19 : ((~x43 & ~x44) | (~x19 & (~x43 ^ ~x44))));
  assign new_n447_ = ~x03 & ~x05 & (~x00 | x03 | x05);
  assign new_n448_ = ~new_n449_ & (new_n453_ | ~x21) & (~x18 | (new_n451_ & ~new_n454_));
  assign new_n449_ = x25 & ((new_n450_ & x19 & ~x20 & ~x21) | (x21 & ~x28 & ~x19 & x20));
  assign new_n450_ = x00 & x10 & x18;
  assign new_n451_ = (x21 | (~new_n383_ & ~new_n452_)) & (~x19 | ~x20 | x28) & (~x21 | (x19 ? ~x20 : (x20 | x28)));
  assign new_n452_ = x26 & (x28 ? (x19 ^ x20) : ((x17 & ~x19 & x20) | (x00 & ((x19 & ~x20) | (~x17 & ~x19 & x20)))));
  assign new_n453_ = x19 ? (~x20 | ~x22) : (x28 | (~new_n387_ & (~x20 | ~x26)));
  assign new_n454_ = x22 & ((x20 & x21 & ~x28) | (x00 & x19 & ~x20 & ~x21));
  ...
  assign new_n458_ = (~x20 | (~new_n459_ & (new_n463_ | x21))) & new_n465_ & (new_n408_ | ~x21);
  assign new_n459_ = ~new_n460_ & x19;
  assign new_n460_ = (~x28 | (x18 ? (x21 | x27) : ~new_n461_)) & (~x18 | x21 | new_n462_ | ~x27);
  assign new_n461_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n462_ = x03 & (~x00 | ~x03);
  assign new_n463_ = (new_n464_ | x18) & (~x17 | ~x18 | ~new_n127_ | x19);
  assign new_n464_ = (~x22 | ~x28) & (x14 | x19 | x23 | x27);
  assign new_n465_ = (~x14 | x27 | x28) & (x21 | ((new_n467_ | ~x28) & (x14 | x27 | new_n466_ | x28)));
  assign new_n466_ = ~x13 & (~x18 | x19 | x20);
  assign new_n467_ = (x18 | x19) & (~x18 | ~x19 | x20 | ~x26);
  assign new_n468_ = ~x19 & x21 & (new_n470_ | (new_n469_ & ~x09));
  assign new_n469_ = ~x18 & ~x20 & x22 & ~x28 & ~new_n346_ & x29;
  assign new_n470_ = x20 & ((x18 & x28) | (~x10 & ~x18 & x25));
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n472_ & x21;
  assign new_n472_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
  assign z43 = ~x18 & new_n474_ & ~x19;
  assign new_n474_ = x20 & ~x21 & ~x29 & x30 & (x22 | x24);
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
