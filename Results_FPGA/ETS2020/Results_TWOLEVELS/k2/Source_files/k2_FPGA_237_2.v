// Benchmark "FAU" written by ABC on Fri Jul 31 17:23:23 2020
...
module FAU ( 
  ...
  assign z11 = (~new_n146_ & x21) | new_n162_ | (~new_n156_ & ~x21);
  assign new_n146_ = (x28 | ((new_n151_ | x20) & (new_n147_ | ~x29))) & (new_n155_ | ~x29);
  assign new_n147_ = ~new_n148_ & (x19 | ((new_n150_ | ~x30) & (~x20 | ~x26 | x30)));
  assign new_n148_ = x18 & x20 & ~x30 & (new_n149_ | x22);
  ...
  assign new_n162_ = ~x18 & x19 & x20 & new_n112_ & x29 & x30;
  ...
  assign new_n187_ = ~x20 & x21 & ~new_n100_ & x30;
  ...
  assign new_n227_ = ~x29 & ((x19 & (x27 | (~x27 & ~x28))) | (~x17 & ~x19 & x26 & ~x28));
  ...
  assign new_n237_ = (x20 | x28 | ~x18 | x19) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | x28 | (~new_n149_ & ~x22))));
  ...
  assign z19 = (~new_n248_ & x18) | (~new_n268_ & x30) | (~new_n260_ & x29);
  ...
  assign new_n258_ = (~x20 | ((~x21 | ~x22 | x28) & (~x19 | (~x21 & (~x27 | x28))))) & (x19 | x20 | ~x21 | x28);
  ...
  assign new_n302_ = (~x00 | ~x03 | ~x27 | x29 | x30) & (x27 | new_n303_ | ~x29);
  ...
  assign new_n318_ = new_n319_ & ~x09 & x22 & ~x38 & ~x39;
  ...
  assign new_n363_ = new_n112_ & x29 & x30 & ~x19 & ~x20 & x21;
  ...
  assign new_n372_ = x19 ? (x20 ? ~new_n271_ : ~x23) : (~new_n373_ & new_n374_);
  ...
  assign new_n376_ = new_n111_ & x00;
  ...
  assign new_n393_ = new_n118_ & x20 & ~x27 & ~x28;
  ...
  assign new_n398_ = (~x19 | (~new_n399_ & (~new_n361_ | ~x20))) & (~new_n238_ | x14 | x19 | x20);
  assign new_n399_ = x00 & ((~x20 & ~new_n121_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n413_ = ~new_n210_ & (x12 | x13 | x14 | x27 | x28);
  ...
  assign new_n422_ = (~x20 | x21 | ~x18 | x19) & (~new_n239_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  ...
  assign new_n431_ = x21 & (new_n308_ | (~x19 & (new_n433_ | (new_n432_ & x00))));
  ...
  assign new_n439_ = new_n444_ & (~x29 | (new_n178_ & (x28 | (~new_n440_ & ~new_n442_))));
  assign new_n440_ = ~x19 & (x21 ? ~new_n441_ : ~new_n176_);
  ...
  assign new_n448_ = new_n453_ & (x18 | (new_n460_ & (x20 | (new_n449_ & ~new_n168_))));
  ...
  assign new_n468_ = (new_n469_ | x18) & (~x17 | ~x18 | ~new_n133_ | x19);
