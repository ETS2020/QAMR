// Benchmark "FAU" written by ABC on Fri Jul 31 17:23:27 2020
...
module FAU ( 
  ...
  assign new_n362_ = new_n112_ & x29 & x30 & ~x19 & ~x20 & x21;
  ...
  assign new_n371_ = x19 ? (x20 ? ~new_n271_ : ~x23) : (~new_n372_ & new_n373_);
  ...
  assign new_n375_ = new_n111_ & x00;
  ...
  assign new_n392_ = new_n118_ & x20 & ~x27 & ~x28;
  ...
  assign new_n397_ = (~x19 | (~new_n398_ & (~new_n360_ | ~x20))) & (~new_n238_ | x14 | x19 | x20);
  assign new_n398_ = x00 & ((~x20 & ~new_n121_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n412_ = ~new_n210_ & (x12 | x13 | x14 | x27 | x28);
  ...
  assign new_n421_ = (~x20 | x21 | ~x18 | x19) & (~new_n239_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  ...
  assign new_n430_ = x21 & (new_n308_ | (~x19 & (new_n432_ | (new_n431_ & x00))));
  ...
  assign new_n438_ = new_n443_ & (~x29 | (new_n178_ & (x28 | (~new_n439_ & ~new_n441_))));
  assign new_n439_ = ~x19 & (x21 ? ~new_n440_ : ~new_n176_);
  assign new_n440_ = (~x20 | (x11 ? (~x25 & ~x26) : (~x18 | ~x25))) & (x20 | (~x18 & ~x22)) & (~x18 | (~x22 & (x11 | ~x26)));
  ...
  assign new_n447_ = new_n452_ & (x18 | (new_n459_ & (x20 | (new_n448_ & ~new_n168_))));
  ...
  assign new_n467_ = (new_n468_ | x18) & (~x17 | ~x18 | ~new_n133_ | x19);
