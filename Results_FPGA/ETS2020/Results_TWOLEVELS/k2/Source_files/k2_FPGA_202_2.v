// Benchmark "FAU" written by ABC on Fri Jul 31 17:22:25 2020
...
module FAU ( 
  ...
  assign z32 = ~x30 & new_n341_ & ~x29;
  assign new_n341_ = ~x28 & ~x27 & x21 & ~x14 & ~x12 & ~x13;
  assign z33 = x18 & x19 & x20 & ~new_n343_ & ~x21;
  assign new_n343_ = x27 ? (x29 | (~x30 & (~x00 | ~x03 | x30))) : (new_n344_ | ~x29);
  assign new_n344_ = (~x05 | x28 | ~x30) & (~x28 | (~x30 & (~x04 | x30)));
  assign z34 = (~new_n346_ & ~x18) | new_n367_ | (x18 & (x30 ? ~new_n358_ : ~new_n363_));
  assign new_n346_ = ~new_n347_ & (new_n351_ | ~x29) & (x21 | ~x28 | ~new_n357_ | x29);
  assign new_n347_ = x30 & ((~new_n350_ & ~x28) | (~new_n348_ & ~x29));
  assign new_n348_ = (~x28 | ((~x00 | ~x19 | ~x21) & (new_n349_ | x21))) & (~x19 | ~x21 | new_n94_ | x28);
  assign new_n349_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n350_ = (x19 | ((x21 | ~x29) & (~x09 | x20 | ~x21 | ~x22))) & (~x19 | ~x20 | ~x22 | ~x29);
  assign new_n351_ = (x30 | ((~new_n356_ | ~x19) & (x09 | ~new_n352_ | x19))) & (x09 | ~new_n354_ | x19);
  assign new_n352_ = ~x20 & x21 & x22 & ~x28 & new_n353_ & ~x38;
  assign new_n353_ = ~x39 & ~x41 & ~x42 & (x40 | (~x40 & (~x43 ^ ~x44)));
  assign new_n354_ = ~x20 & x21 & x22 & ~new_n355_ & ~x28;
  assign new_n355_ = ~x38 & ~x41 & (x39 | ~x42) & (~x39 | x42);
  assign new_n356_ = x28 & (x21 | (x00 & x20 & ~x21 & x22));
  assign new_n357_ = ~x30 & (~x19 | (x20 & x22));
  assign new_n358_ = (x28 | new_n359_ | ~x29) & (x21 | ~x28 | new_n362_ | x29);
  assign new_n359_ = x19 ? (new_n361_ | x21) : (new_n360_ | ~x21);
  assign new_n360_ = x20 & ~x22 & (x11 | (~x26 & (~x20 | ~x25)));
  assign new_n361_ = (x20 | ~x26) & (~x20 | x27 | ~x00 | x05);
  assign new_n362_ = (~x00 | ~x26 | (~x19 ^ x20)) & (~x19 | ~x20 | x27);
  assign new_n363_ = (x21 | ((new_n364_ | ~x20) & (~new_n366_ | ~x26 | ~x19 | x20))) & (x19 | x20 | ~new_n366_ | ~x21);
  assign new_n364_ = (~new_n365_ | ~x19) & (~x17 | x19 | ~x26 | (x28 ^ ~x29));
  assign new_n365_ = ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n366_ = x28 & ~x29;
  assign new_n367_ = new_n110_ & x29 & x30 & ~x19 & ~x20 & x21;
  assign z35 = x30 ? (new_n398_ | (~new_n369_ & ~x29)) : ~new_n386_;
  assign new_n369_ = ~new_n370_ & ~new_n381_ & ~new_n384_ & (~x10 | new_n379_ | ~x25);
  assign new_n370_ = ~x18 & (x21 ? (new_n373_ | (~new_n371_ & x19)) : ~new_n376_);
  assign new_n371_ = ~new_n372_ & (~x01 | x20 | x28 | (~x22 & ~x23));
  assign new_n372_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n373_ = ~x19 & ((~new_n374_ & ~x20) | (x00 & ~new_n375_ & x20));
  assign new_n374_ = ~x23 & (x09 | ~x22 | x28);
  assign new_n375_ = ~x22 & ~x24 & ~x26 & (~x10 | ~x25);
  assign new_n376_ = x19 ? (x20 ? ~new_n269_ : ~x23) : (~new_n377_ & new_n378_);
  assign new_n377_ = x28 & ((x00 & ~x03 & (x02 ^ x20)) | (~x06 & x20 & (~x02 | x03)));
  assign new_n378_ = (x20 | (x28 & (x02 | x03))) & (~x23 | x28) & (~x20 | ~x24);
  assign new_n379_ = (x20 | x21 | ~x18 | ~x19) & (~new_n380_ | ~x21 | x28 | x19 | ~x20);
  assign new_n380_ = new_n109_ & x00;
  assign new_n381_ = x20 & ((~new_n382_ & ~x19) | (x18 & x19 & (~x21 | (x00 & x21))));
  assign new_n382_ = (x28 | ((~new_n383_ | ~x00) & (~x18 | x21 | ~x26))) & (~x00 | ~x18 | x21 | ~x26 | ~x28);
  assign new_n383_ = ~x05 & ~x15 & x21 & (x22 | x26);
  assign new_n384_ = ~x20 & ((~new_n385_ & x18) | (x19 & ~x21 & x22));
  assign new_n385_ = (~x00 | ((~x26 | ~x28 | ~x19 | x21) & (x19 | ~x21 | x28))) & (~x26 | x28 | ~x19 | x21);
  ...
  assign new_n397_ = new_n116_ & x20 & ~x27 & ~x28;
  assign new_n398_ = x19 & x20 & new_n399_ & ~x21;
  assign new_n399_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  assign z36 = (~new_n418_ & x21) | (~x30 & (~new_n409_ | (~new_n401_ & ~x21)));
  assign new_n401_ = ~new_n387_ & new_n404_ & (~x18 | (new_n402_ & (new_n408_ | ~x26)));
  assign new_n402_ = (~x19 | (~new_n403_ & (~new_n365_ | ~x20))) & (~new_n236_ | x14 | x19 | x20);
  assign new_n403_ = x00 & ((~x20 & ~new_n119_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n404_ = (new_n405_ | x29) & (~x00 | x18 | ~x20 | new_n393_ | ~x29);
  assign new_n405_ = ~new_n407_ & (x14 | new_n406_ | x27);
  assign new_n406_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n407_ = ~x18 & x28 & (~x19 | (x20 & x22));
  assign new_n408_ = (((~x28 | x29) & (~x00 | x28 | ~x29)) | ((~x17 | x19 | ~x20) & (~x19 | x20))) & (~x20 | x28 | ~x29 | ~x00 | x17 | x19);
  assign new_n409_ = (~new_n414_ | ~x19) & (~x21 | (x29 ? new_n410_ : new_n417_));
  assign new_n410_ = (x19 | ((x18 | ~x20) & (new_n411_ | x28))) & (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | ~x22) & (~x18 | (~x19 & (~x22 | x28)))));
  assign new_n411_ = new_n413_ & (x09 | ~x22 | ~new_n412_ | x38);
  assign new_n412_ = ~x41 & ((x39 & x42) | (~x18 & ~x20 & ~x39 & x40 & ~x42));
  assign new_n413_ = x20 ? (~x25 & ~x26) : ~x18;
  assign new_n414_ = x20 & ((new_n415_ & ~x18) | (~x28 & x29 & x18 & ~x27));
  assign new_n415_ = x22 & x28 & ~new_n416_ & ~x29;
  assign new_n416_ = x16 ? x08 : x07;
  assign new_n417_ = ~new_n208_ & (x12 | x13 | x14 | x27 | x28);
  assign new_n418_ = (~new_n419_ | x28) & (~x18 | x19 | ~x20 | new_n416_ | ~x28);
  assign new_n419_ = x30 & (new_n422_ | (~x29 & (new_n421_ | (~new_n420_ & ~x18))));
  assign new_n420_ = (new_n94_ | ~x19) & (x20 | ~x22 | ~x33 | ~x09 | x19);
  assign new_n421_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n422_ = x20 & x25 & x29 & ~x11 & x18 & ~x19;
  assign z37 = (~new_n424_ & x30) | new_n477_ | (~x30 & (x29 ? ~new_n452_ : ~new_n467_));
  assign new_n424_ = ~new_n425_ & new_n443_ & (x29 | (~new_n427_ & new_n434_));
  assign new_n425_ = ~new_n426_ & (x22 | x23);
  assign new_n426_ = (~x20 | x21 | ~x18 | x19) & (~new_n237_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  assign new_n427_ = ~x18 & (x21 ? (new_n373_ | new_n432_) : ~new_n428_);
  assign new_n428_ = (new_n429_ | ~x28) & ~new_n430_ & new_n431_;
  assign new_n429_ = (~x02 | x03 | ((~x19 | ~x20 | ~x22) & (~x00 | x19 | x20))) & (~x20 | (x02 & ~x03) | (x19 & (~x19 | ~x22)));
  assign new_n430_ = x20 & ((~x19 & x24) | ((x22 | x26) & (~x19 | (x19 & ~x28))));
  assign new_n431_ = (~x23 | x28) & (x20 | (x19 ? ~x23 : (x28 & (x02 | x03))));
  assign new_n432_ = x19 & (new_n372_ | (~x28 & (~new_n433_ | x25)));
  assign new_n433_ = (~x20 | ~x22 | x05 | ~x15) & ~x24 & ~x26;
  assign new_n434_ = x20 ? (~new_n438_ & (x28 | (~new_n435_ & ~new_n442_))) : new_n440_;
  assign new_n435_ = x21 & (new_n306_ | (~x19 & (new_n437_ | (new_n436_ & x00))));
  assign new_n436_ = ~x15 & ((x25 & (~x10 | (~x05 & x10))) | (~x05 & (x22 | x26)));
  assign new_n437_ = ~x05 & x15 & x18;
  assign new_n438_ = ~new_n439_ & x18;
  assign new_n439_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21 | (~x27 & (x27 | ~x28)));
  assign new_n440_ = (new_n441_ | ~x18) & (~x19 | x21 | ~x22);
  assign new_n441_ = (~x00 | ((x19 | ~x21 | x28) & (~x26 | ~x28 | ~x19 | x21))) & (x19 | ~x21 | ~x28) & (x21 | (~x25 & (~x19 | ~x26 | x28)));
  assign new_n442_ = x18 & ~x21 & (x19 ? ~x27 : x26);
  assign new_n443_ = new_n448_ & (~x29 | (new_n176_ & (x28 | (~new_n444_ & ~new_n446_))));
  assign new_n444_ = ~x19 & (x21 ? ~new_n445_ : ~new_n174_);
  assign new_n445_ = (~x20 | (x11 ? (~x25 & ~x26) : (~x18 | ~x25))) & (~x18 | (~x22 & (x11 | ~x26))) & (x20 | (~x18 & ~x22));
  assign new_n446_ = x19 & (x18 ? new_n447_ : (x20 & x22));
  assign new_n447_ = ~x21 & (x20 ? (~x27 & (x05 | (x00 & ~x05))) : x26);
  assign new_n448_ = (x20 | ((new_n450_ | x19) & (~x18 | ~new_n451_ | ~x19))) & (~x18 | ~new_n449_ | ~x19);
  assign new_n449_ = x21 & (x22 | x26);
  assign new_n450_ = x18 ? (x21 | (~x22 & ~x25)) : (~x21 | ~x22 | (~x28 & (~x09 | x28)));
  assign new_n451_ = x21 & x25;
  assign new_n452_ = new_n457_ & (x18 | (new_n464_ & (x20 | (new_n453_ & ~new_n166_))));
  assign new_n453_ = (x19 | ~x21 | ~x23) & (x28 | (~new_n454_ & (x19 | new_n456_ | x21)));
  assign new_n454_ = ~x09 & x21 & x22 & ~x38 & new_n455_ & ~x39;
  assign new_n455_ = ~x41 & ~x42 & (x40 ? ~x19 : ((~x43 & ~x44) | (~x19 & (~x43 ^ ~x44))));
  assign new_n456_ = ~x03 & ~x05 & (~x00 | x03 | x05);
  assign new_n457_ = ~new_n458_ & (new_n462_ | ~x21) & (~x18 | (new_n460_ & ~new_n463_));
  assign new_n458_ = x25 & ((new_n459_ & x19 & ~x20 & ~x21) | (x21 & ~x28 & ~x19 & x20));
  assign new_n459_ = x00 & x10 & x18;
  assign new_n460_ = (x21 | (~new_n392_ & ~new_n461_)) & (~x19 | ~x20 | x28) & (~x21 | (x19 ? ~x20 : (x20 | x28)));
  assign new_n461_ = x26 & (x28 ? (x19 ^ x20) : ((x17 & ~x19 & x20) | (x00 & ((x19 & ~x20) | (~x17 & ~x19 & x20)))));
  assign new_n462_ = x19 ? (~x20 | ~x22) : (x28 | (~new_n396_ & (~x20 | ~x26)));
  assign new_n463_ = x22 & ((x20 & x21 & ~x28) | (x00 & x19 & ~x20 & ~x21));
  assign new_n464_ = (~x20 | (x19 ? (~new_n466_ | x21) : (~x21 & (new_n465_ | x21)))) & (~x28 | (x19 ^ x21));
  assign new_n465_ = ~x24 & (~x00 | ~x23 | x28);
  assign new_n466_ = x22 & ((x05 & ~x28) | (x00 & (x28 | (~x05 & ~x28))));
  assign new_n467_ = (~x20 | (~new_n468_ & (new_n472_ | x21))) & new_n474_ & (new_n417_ | ~x21);
  assign new_n468_ = ~new_n469_ & x19;
  assign new_n469_ = (~x28 | (x18 ? (x21 | x27) : ~new_n470_)) & (~x18 | x21 | new_n471_ | ~x27);
  assign new_n470_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n471_ = x03 & (~x00 | ~x03);
  assign new_n472_ = (new_n473_ | x18) & (~x17 | ~x18 | ~new_n131_ | x19);
  assign new_n473_ = (~x22 | ~x28) & (x23 | x27 | x14 | x19);
  assign new_n474_ = (~x14 | x27 | x28) & (x21 | ((new_n476_ | ~x28) & (x14 | x27 | new_n475_ | x28)));
  assign new_n475_ = ~x13 & (~x18 | x19 | x20);
  assign new_n476_ = (x18 | x19) & (~x18 | ~x19 | x20 | ~x26);
  assign new_n477_ = ~x19 & x21 & (new_n479_ | (new_n478_ & ~x09));
  assign new_n478_ = ~x18 & ~x20 & x22 & ~x28 & ~new_n355_ & x29;
  assign new_n479_ = x20 & ((x18 & x28) | (~x10 & ~x18 & x25));
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n481_ & x21;
  assign new_n481_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
  assign z43 = ~x18 & new_n483_ & ~x19;
  assign new_n483_ = x20 & ~x21 & ~x29 & x30 & (x22 | x24);
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z10 = 1'b0;
