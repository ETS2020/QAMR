// Benchmark "FAU" written by ABC on Fri Jul 31 17:17:53 2020
...
module FAU ( 
  ...
  assign z34 = x18 ? ~new_n379_ : (~new_n368_ | new_n375_);
  assign new_n368_ = (~new_n374_ | x21) & (~x29 | (~new_n372_ & (new_n369_ | x30)));
  assign new_n369_ = ~new_n371_ & (~x21 | ((~x19 | ~x28) & (x09 | ~new_n370_ | x19)));
  assign new_n370_ = ~x20 & x22 & ~x28 & new_n240_ & ~x38;
  assign new_n371_ = new_n149_ & x00 & ~x21 & x22 & x28;
  assign new_n372_ = ~x09 & ~x19 & ~x20 & x21 & new_n373_ & x22;
  assign new_n373_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n187_ | x39)))) | x38 | (~x39 & x42));
  assign new_n374_ = x28 & ~x29 & ~new_n294_ & ~x30;
  ...
  assign new_n383_ = x30 & ((~new_n384_ & x00) | (new_n203_ & ~x20 & x26));
  ...
  assign z36 = (~new_n408_ & x21) | (~x30 & ((~new_n389_ & ~x21) | new_n414_ | (~new_n401_ & x21)));
  assign new_n389_ = (new_n390_ | x03) & new_n397_ & (new_n392_ | ~x18);
  assign new_n390_ = ~new_n391_ & (~new_n118_ | ~x20 | ~x27 | x29);
  assign new_n391_ = x00 & ~x05 & ~x18 & new_n203_ & ~x19 & ~x20;
  assign new_n392_ = (new_n394_ | ~x26) & ~new_n396_ & (~x19 | (~new_n393_ & ~new_n395_));
  assign new_n393_ = x00 & ((x03 & x20 & x27 & ~x29) | (~x20 & ~new_n121_ & x29));
  ...
  assign new_n397_ = (new_n398_ | x29) & (~x00 | x18 | ~x20 | new_n400_ | ~x29);
  assign new_n398_ = (x18 | new_n294_ | ~x28) & (x14 | new_n399_ | x27);
  assign new_n399_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n400_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n401_ = x29 ? new_n402_ : new_n406_;
  assign new_n402_ = (x19 | ((new_n403_ | x28) & (x18 | ~x20))) & (~x20 | ~x22 | x28) & (~x19 | (x18 ? ~x20 : ~x28));
  assign new_n403_ = new_n405_ & (x09 | ~x22 | ~new_n404_ | x38);
  assign new_n404_ = ~x41 & ((x39 & x42) | (~x18 & ~x20 & ~x39 & x40 & ~x42));
  assign new_n405_ = (~x18 | (x20 & (~x11 | ~x20 | ~x25))) & (~x20 | (~x26 & (x11 | ~x25)));
  assign new_n406_ = ~new_n407_ & (x20 | ~x28 | ~x18 | x19);
  assign new_n407_ = ~x12 & ~x13 & ~x14 & ~x27 & ~x28;
  assign new_n408_ = (~new_n409_ | x28) & (~x18 | x19 | ~x20 | new_n413_ | ~x28);
  ...
  assign new_n414_ = x19 & x20 & ((new_n415_ & ~x18) | (new_n203_ & x18 & ~x27));
  assign new_n415_ = x22 & x28 & ~new_n413_ & ~x29;
  assign z38 = (~new_n417_ & ~x00) | (~x01 & ~x18 & new_n431_ & x19);
  assign new_n417_ = (x29 | (~new_n424_ & (new_n418_ | ~x30))) & (x21 | new_n425_ | ~x29);
  ...
  assign new_n421_ = (~x21 | x28 | (~new_n112_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n422_ = x18 ? ((x20 | x21 | ~x26 | ~x28) & (~x20 | ~x21 | ~x24)) : (~x21 | ~x28);
  assign new_n423_ = ~x05 & ~x15 & ~x18 & x20 & x21 & x22;
  assign new_n424_ = new_n348_ & x20 & ~x21 & x27;
  assign new_n425_ = ~new_n428_ & (x30 | (x18 ? (~new_n429_ & ~new_n430_) : new_n426_));
  assign new_n426_ = ~new_n427_ & (~x20 | (x19 ? (~x22 | ~x28) : (~x23 | x28)));
  assign new_n427_ = ~x05 & ((x19 & x20 & x22) | (~x03 & ~x19 & ~x20 & ~x28));
  assign new_n428_ = new_n118_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n429_ = x20 & ((~x19 & x26 & ~x28) | (~x04 & x19 & ~x27 & x28));
  assign new_n430_ = x19 & ~x20 & (x22 | x25 | (x26 & ~x28));
  assign new_n431_ = ~x20 & ~new_n131_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n433_ & x19) | (x29 & (new_n443_ | (~new_n439_ & ~x19)));
  assign new_n433_ = x18 ? ((new_n437_ | x21) & (~new_n117_ | ~x20 | ~x21)) : new_n434_;
  assign new_n434_ = x21 ? new_n436_ : (~new_n435_ & (~x29 | new_n216_ | x30));
  assign new_n435_ = x02 & ~x03 & x20 & new_n114_ & x22 & x28;
  assign new_n436_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n131_ | ~x30);
  assign new_n437_ = x20 ? ((~new_n114_ | ~x27) & (~new_n116_ | ~x04 | x27)) : ~new_n438_;
  assign new_n438_ = x29 & ((~new_n144_ & x30) | (x26 & x28 & ~x30));
  assign new_n439_ = (new_n440_ | ~x20) & (x30 | ((x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20)));
  assign new_n440_ = (x18 | (x21 ? x30 : (x28 | ~x30))) & (~x21 | x28 | new_n162_ | x30) & (new_n441_ | ~x18);
  assign new_n441_ = (~new_n442_ | x21) & (~x11 | ~x21 | ~new_n138_ | ~x25);
  assign new_n442_ = x26 & ((x28 & ~x30) | (~x17 & ~x28 & x30));
  assign new_n443_ = x20 & x21 & new_n138_ & x22;
  assign z40 = ~x28 & ((~x18 & (new_n447_ | (~new_n448_ & x05))) | (x05 & new_n445_ & x18));
  assign new_n445_ = x20 & ~new_n446_ & x30;
  assign new_n446_ = (x27 | ~x29 | ~x19 | x21) & (x19 | ~x21 | new_n342_ | x29);
  assign new_n447_ = new_n117_ & ~x21 & x03 & ~x19 & ~x20;
  assign new_n448_ = (~x19 | ~x20 | ~x22 | (x21 ? (x29 | ~x30) : (~x29 | x30))) & (x19 | x20 | x21 | ~x29 | x30);
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n450_ & x21;
  assign new_n450_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
