...
module FAU ( 
  ...
  assign z34 = (~new_n343_ & ~x18) | new_n364_ | (x18 & (x30 ? ~new_n355_ : ~new_n360_));
  assign new_n343_ = ~new_n344_ & (new_n348_ | ~x29) & (x21 | ~x28 | ~new_n354_ | x29);
  ...
  assign new_n364_ = new_n112_ & x29 & x30 & ~x19 & ~x20 & x21;
  ...
  assign new_n372_ = ~x22 & ~x24 & ~x26 & (~x10 | ~x25);
  assign new_n373_ = x19 ? (x20 ? ~new_n271_ : ~x23) : (~new_n374_ & new_n375_);
  assign new_n374_ = x28 & ((x00 & ~x03 & (x02 ^ x20)) | (~x06 & x20 & (~x02 | x03)));
  assign new_n375_ = (x20 | (x28 & (x02 | x03))) & (~x23 | x28) & (~x20 | ~x24);
  assign new_n376_ = (~x18 | ~x19 | x20 | x21) & (~new_n377_ | ~x21 | x28 | x19 | ~x20);
  assign new_n377_ = new_n111_ & x00;
  ...
  assign new_n394_ = new_n118_ & x20 & ~x27 & ~x28;
  ...
  assign new_n399_ = (~x19 | (~new_n400_ & (~new_n362_ | ~x20))) & (~new_n238_ | x14 | x19 | x20);
  assign new_n400_ = x00 & ((~x20 & ~new_n121_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n423_ = (~x20 | x21 | ~x18 | x19) & (~new_n239_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  ...
  assign new_n430_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n431_ = x20 ? (~new_n435_ & (x28 | (~new_n432_ & ~new_n439_))) : new_n437_;
  assign new_n432_ = x21 & (new_n308_ | (~x19 & (new_n434_ | (new_n433_ & x00))));
  ...
  assign new_n440_ = new_n445_ & (~x29 | (new_n178_ & (x28 | (~new_n441_ & ~new_n443_))));
  assign new_n441_ = ~x19 & (x21 ? ~new_n442_ : ~new_n176_);
  ...
  assign new_n449_ = new_n454_ & (x18 | (new_n461_ & (x20 | (new_n450_ & ~new_n168_))));
  ...
  assign new_n469_ = (new_n470_ | x18) & (~x17 | ~x18 | ~new_n133_ | x19);
  assign new_n470_ = (~x22 | ~x28) & (x14 | x19 | x23 | x27);
