// Benchmark "FAU" written by ABC on Fri Jul 31 17:17:45 2020
...
module FAU ( 
  ...
  assign z06 = (x20 & (new_n109_ | (~new_n97_ & x00))) | (x00 & new_n113_ & ~x20);
  assign new_n97_ = x19 ? (~new_n104_ & (new_n102_ | x21)) : (~new_n98_ & (~new_n108_ | x21));
  assign new_n98_ = ~x29 & x30 & (x21 ? new_n99_ : (~new_n101_ & x28));
  ...
  assign new_n110_ = ~x21 & ~x27 & new_n111_ & x28;
  ...
  assign new_n135_ = new_n136_ & x20 & x27 & ~x29 & ~x30;
  assign new_n136_ = new_n112_ & x03;
  assign new_n137_ = (~new_n138_ | ~x28 | x29 | ~x30) & (~x20 | ~x23 | x28 | ~x29 | x30);
  assign new_n138_ = x02 & ~x03 & ~x20;
  assign z11 = (~new_n140_ & x21) | new_n156_ | (~new_n150_ & ~x21);
  assign new_n140_ = (x28 | ((new_n145_ | x20) & (new_n141_ | ~x29))) & (new_n149_ | ~x29);
  assign new_n141_ = ~new_n142_ & (x19 | ((new_n144_ | ~x30) & (~x20 | ~x26 | x30)));
  assign new_n142_ = x18 & x20 & ~x30 & (new_n143_ | x22);
  assign new_n143_ = ~x11 & x25;
  assign new_n144_ = (~x20 | (x11 ? (~x25 & ~x26) : (~x18 | ~x25))) & (~x18 | (~x22 & (x11 | ~x26)));
  ...
  assign new_n149_ = (x18 | (x19 ? ~x28 : ~x20)) & (~x19 | ~x20 | x30 | (~x18 & ~x22));
  assign new_n150_ = x18 ? ((new_n151_ | ~x20) & (~x19 | ~new_n154_ | x20)) : (~new_n155_ | x19);
  assign new_n151_ = (new_n152_ | x30) & (~x19 | ~x27 | x29 | ~x30);
  assign new_n152_ = (~x17 | x19 | ~x26 | (x28 ^ ~x29)) & (~x19 | new_n153_ | x29);
  assign new_n153_ = x27 ? x03 : ~x28;
  assign new_n154_ = x26 & (x28 ? (~x29 & ~x30) : (x29 & x30));
  assign new_n155_ = x29 & (~x28 ^ ~x30);
  assign new_n156_ = ~x18 & x19 & x20 & new_n106_ & x29 & x30;
  ...
  assign new_n166_ = (~x20 | ~x21 | ~x22) & (x19 | ((x20 | ~x21) & (~x17 | ~x20 | x21 | ~x26)));
  ...
  assign new_n170_ = x18 & (~x20 | ~x26 | x17 | ~x18);
  ...
  assign new_n181_ = ~x20 & x21 & ~new_n100_ & x30;
  ...
  assign new_n202_ = (~x20 | (new_n167_ & (~x18 | (~x19 & (~x22 | x28))))) & (x20 | x28 | ~x18 | x19);
  ...
  assign new_n231_ = (x20 | x28 | ~x18 | x19) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | x28 | (~new_n143_ & ~x22))));
  ...
  assign z19 = (~new_n242_ & x18) | (~new_n262_ & x30) | (~new_n254_ & x29);
  ...
  assign new_n256_ = ~x18 & (x20 | new_n258_ | (~x20 & (new_n257_ | (new_n198_ & new_n199_))));
  ...
  assign new_n267_ = x21 & x22 & x28 & ~x19 & ~x20;
  ...
  assign new_n296_ = (~x00 | ~x03 | ~x27 | x29 | x30) & (x27 | new_n297_ | ~x29);
  ...
  assign new_n312_ = new_n313_ & ~x09 & x22 & ~x38 & ~x39;
  ...
  assign new_n318_ = x19 ? (~x18 & (~new_n105_ | ~new_n106_ | x18)) : (~new_n99_ & (x18 | ~x24));
  ...
  assign new_n322_ = (x03 | x18 | new_n116_ | x21) & (~x18 | ~x21 | ~new_n107_ | x28);
  ...
  assign z33 = x18 & x19 & x20 & ~new_n333_ & ~x21;
  assign new_n333_ = x27 ? (x29 | (~x30 & (~x00 | ~x03 | x30))) : (new_n334_ | ~x29);
  assign new_n334_ = (~x05 | x28 | ~x30) & (~x28 | (~x30 & (~x04 | x30)));
  assign z34 = (~new_n336_ & ~x18) | new_n357_ | (x18 & (x30 ? ~new_n348_ : ~new_n353_));
  assign new_n336_ = ~new_n337_ & (new_n341_ | ~x29) & (x21 | ~x28 | ~new_n347_ | x29);
  assign new_n337_ = x30 & ((~new_n340_ & ~x28) | (~new_n338_ & ~x29));
  assign new_n338_ = (~x28 | ((~x00 | ~x19 | ~x21) & (new_n339_ | x21))) & (~x19 | ~x21 | new_n94_ | x28);
  assign new_n339_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n340_ = (x19 | ((x21 | ~x29) & (~x09 | x20 | ~x21 | ~x22))) & (~x19 | ~x20 | ~x22 | ~x29);
  assign new_n341_ = (x30 | ((~new_n346_ | ~x19) & (x09 | ~new_n342_ | x19))) & (x09 | ~new_n344_ | x19);
  ...
  assign new_n347_ = ~x30 & (~x19 | (x20 & x22));
  assign new_n348_ = (x28 | new_n349_ | ~x29) & (x21 | ~x28 | new_n352_ | x29);
  assign new_n349_ = x19 ? (new_n351_ | x21) : (new_n350_ | ~x21);
  assign new_n350_ = x20 & ~x22 & (x11 | (~x26 & (~x20 | ~x25)));
  assign new_n351_ = (x20 | ~x26) & (~x20 | x27 | ~x00 | x05);
  assign new_n352_ = (~x00 | ~x26 | (~x19 ^ x20)) & (~x19 | ~x20 | x27);
  assign new_n353_ = (x21 | ((new_n354_ | ~x20) & (~new_n356_ | ~x26 | ~x19 | x20))) & (x19 | x20 | ~new_n356_ | ~x21);
  assign new_n354_ = (~new_n355_ | ~x19) & (~x17 | x19 | ~x26 | (x28 ^ ~x29));
  assign new_n355_ = ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n356_ = x28 & ~x29;
  assign new_n357_ = new_n106_ & x29 & x30 & ~x19 & ~x20 & x21;
  assign z35 = x30 ? (new_n388_ | (~new_n359_ & ~x29)) : ~new_n376_;
  assign new_n359_ = ~new_n360_ & ~new_n371_ & ~new_n374_ & (~x10 | new_n369_ | ~x25);
  assign new_n360_ = ~x18 & (x21 ? (new_n363_ | (~new_n361_ & x19)) : ~new_n366_);
  assign new_n361_ = ~new_n362_ & (~x01 | x20 | x28 | (~x22 & ~x23));
  assign new_n362_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n363_ = ~x19 & ((~new_n364_ & ~x20) | (x00 & ~new_n365_ & x20));
  assign new_n364_ = ~x23 & (x09 | ~x22 | x28);
  assign new_n365_ = ~x22 & ~x24 & ~x26 & (~x10 | ~x25);
  assign new_n366_ = x19 ? (x20 ? ~new_n265_ : ~x23) : (~new_n367_ & new_n368_);
  assign new_n367_ = x28 & ((x00 & ~x03 & (x02 ^ x20)) | (~x06 & x20 & (~x02 | x03)));
  assign new_n368_ = (x20 | (x28 & (x02 | x03))) & (~x23 | x28) & (~x20 | ~x24);
  assign new_n369_ = (~x18 | ~x19 | x20 | x21) & (~new_n370_ | ~x21 | x28 | x19 | ~x20);
  assign new_n370_ = new_n105_ & x00;
  assign new_n371_ = x20 & ((~new_n372_ & ~x19) | (x18 & x19 & (~x21 | (x00 & x21))));
  assign new_n372_ = (x28 | ((~new_n373_ | ~x00) & (~x18 | x21 | ~x26))) & (~x00 | ~x18 | x21 | ~x26 | ~x28);
  assign new_n373_ = ~x05 & ~x15 & x21 & (x22 | x26);
  assign new_n374_ = ~x20 & ((~new_n375_ & x18) | (x19 & ~x21 & x22));
  assign new_n375_ = (~x00 | ((~x26 | ~x28 | ~x19 | x21) & (x19 | ~x21 | x28))) & (~x26 | x28 | ~x19 | x21);
  assign new_n376_ = (x21 | (~new_n377_ & (new_n380_ | ~x29))) & (~x29 | (~new_n387_ & (new_n384_ | ~x21)));
  assign new_n377_ = ~x03 & (new_n378_ | (new_n379_ & x00 & ~x05 & ~x18));
  assign new_n378_ = new_n112_ & x20 & x27 & ~x29;
  assign new_n379_ = ~x19 & ~x20 & ~x28 & x29;
  assign new_n380_ = (~x18 | (~new_n382_ & (new_n381_ | ~x00))) & (~x00 | x18 | new_n383_ | ~x20);
  assign new_n381_ = (~x19 | new_n115_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n382_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n383_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n384_ = (new_n385_ | ~x20) & (x19 | x28 | (~new_n386_ & (~x18 | x20))) & (x18 | ~x19 | ~x28);
  assign new_n385_ = (~x18 | (~x19 & (~x22 | x28))) & (~x19 | ~x22) & (x19 | (x18 & (x28 | (~x25 & ~x26))));
  assign new_n386_ = x39 & ~x41 & x42 & ~x09 & x22 & ~x38;
  assign new_n387_ = new_n112_ & x20 & ~x27 & ~x28;
  assign new_n388_ = x19 & x20 & new_n389_ & ~x21;
  assign new_n389_ = x29 & ((~x18 & x22 & x28) | (x05 & x18 & ~x27 & ~x28));
  assign z36 = (~new_n408_ & x21) | (~x30 & (~new_n399_ | (~new_n391_ & ~x21)));
  assign new_n391_ = ~new_n377_ & new_n394_ & (~x18 | (new_n392_ & (new_n398_ | ~x26)));
  assign new_n392_ = (~x19 | (~new_n393_ & (~new_n355_ | ~x20))) & (~new_n232_ | x14 | x19 | x20);
  assign new_n393_ = x00 & ((~x20 & ~new_n115_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n394_ = (new_n395_ | x29) & (~x00 | x18 | ~x20 | new_n383_ | ~x29);
  assign new_n395_ = ~new_n397_ & (x14 | new_n396_ | x27);
  assign new_n396_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n397_ = ~x18 & x28 & (~x19 | (x20 & x22));
  assign new_n398_ = (((~x28 | x29) & (~x00 | x28 | ~x29)) | ((~x17 | x19 | ~x20) & (~x19 | x20))) & (~x20 | x28 | ~x29 | ~x00 | x17 | x19);
  assign new_n399_ = (~new_n404_ | ~x19) & (~x21 | (x29 ? new_n400_ : new_n407_));
  assign new_n400_ = (x19 | ((x18 | ~x20) & (new_n401_ | x28))) & (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | ~x22) & (~x18 | (~x19 & (~x22 | x28)))));
  assign new_n401_ = new_n403_ & (x09 | ~x22 | ~new_n402_ | x38);
  assign new_n402_ = ~x41 & ((x39 & x42) | (~x18 & ~x20 & ~x39 & x40 & ~x42));
  assign new_n403_ = x20 ? (~x25 & ~x26) : ~x18;
  assign new_n404_ = x20 & ((new_n405_ & ~x18) | (~x28 & x29 & x18 & ~x27));
  assign new_n405_ = x22 & x28 & ~new_n406_ & ~x29;
  assign new_n406_ = x16 ? x08 : x07;
  assign new_n407_ = ~new_n204_ & (x12 | x13 | x14 | x27 | x28);
  assign new_n408_ = (~new_n409_ | x28) & (~x18 | x19 | ~x20 | new_n406_ | ~x28);
  assign new_n409_ = x30 & (new_n412_ | (~x29 & (new_n411_ | (~new_n410_ & ~x18))));
  assign new_n410_ = (new_n94_ | ~x19) & (x20 | ~x22 | ~x33 | ~x09 | x19);
  assign new_n411_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n412_ = x20 & x25 & x29 & ~x11 & x18 & ~x19;
  assign z37 = (~new_n414_ & x30) | new_n467_ | (~x30 & (x29 ? ~new_n442_ : ~new_n457_));
  assign new_n414_ = ~new_n415_ & new_n433_ & (x29 | (~new_n417_ & new_n424_));
  assign new_n415_ = ~new_n416_ & (x22 | x23);
  assign new_n416_ = (~x20 | x21 | ~x18 | x19) & (~new_n233_ | x20 | ~x21 | ~x01 | x18 | ~x19);
  assign new_n417_ = ~x18 & (x21 ? (new_n363_ | new_n422_) : ~new_n418_);
  assign new_n418_ = (new_n419_ | ~x28) & ~new_n420_ & new_n421_;
  assign new_n419_ = (~x02 | x03 | ((~x19 | ~x20 | ~x22) & (~x00 | x19 | x20))) & (~x20 | (x02 & ~x03) | (x19 & (~x19 | ~x22)));
  assign new_n420_ = x20 & ((~x19 & x24) | ((x22 | x26) & (~x19 | (x19 & ~x28))));
  assign new_n421_ = (~x23 | x28) & (x20 | (x19 ? ~x23 : (x28 & (x02 | x03))));
  assign new_n422_ = x19 & (new_n362_ | (~x28 & (~new_n423_ | x25)));
  assign new_n423_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
  assign new_n424_ = x20 ? (~new_n428_ & (x28 | (~new_n425_ & ~new_n432_))) : new_n430_;
  assign new_n425_ = x21 & (new_n302_ | (~x19 & (new_n427_ | (new_n426_ & x00))));
  assign new_n426_ = ~x15 & ((x25 & (~x10 | (~x05 & x10))) | (~x05 & (x22 | x26)));
  assign new_n427_ = ~x05 & x15 & x18;
  assign new_n428_ = ~new_n429_ & x18;
  assign new_n429_ = (~x00 | ((~x19 | ~x21) & (x19 | x21 | ~x26 | ~x28))) & (~x19 | x21 | (~x27 & (x27 | ~x28)));
  assign new_n430_ = (new_n431_ | ~x18) & (~x19 | x21 | ~x22);
  assign new_n431_ = (~x00 | ((x19 | ~x21 | x28) & (~x26 | ~x28 | ~x19 | x21))) & (x19 | ~x21 | ~x28) & (x21 | (~x25 & (~x19 | ~x26 | x28)));
  assign new_n432_ = x18 & ~x21 & (x19 ? ~x27 : x26);
  assign new_n433_ = new_n438_ & (~x29 | (new_n172_ & (x28 | (~new_n434_ & ~new_n436_))));
  assign new_n434_ = ~x19 & (x21 ? ~new_n435_ : ~new_n170_);
  assign new_n435_ = (~x20 | (x11 ? (~x25 & ~x26) : (~x18 | ~x25))) & (x20 | (~x18 & ~x22)) & (~x18 | (~x22 & (x11 | ~x26)));
  assign new_n436_ = x19 & (x18 ? new_n437_ : (x20 & x22));
  assign new_n437_ = ~x21 & (x20 ? (~x27 & (x05 | (x00 & ~x05))) : x26);
  assign new_n438_ = (x20 | ((new_n440_ | x19) & (~x18 | ~new_n441_ | ~x19))) & (~x18 | ~new_n439_ | ~x19);
  assign new_n439_ = x21 & (x22 | x26);
  assign new_n440_ = x18 ? (x21 | (~x22 & ~x25)) : (~x21 | ~x22 | (~x28 & (~x09 | x28)));
  assign new_n441_ = x21 & x25;
  assign new_n442_ = new_n447_ & (x18 | (new_n454_ & (x20 | (new_n443_ & ~new_n162_))));
  assign new_n443_ = (x19 | ~x21 | ~x23) & (x28 | (~new_n444_ & (x19 | new_n446_ | x21)));
  assign new_n444_ = ~x09 & x21 & x22 & ~x38 & new_n445_ & ~x39;
  assign new_n445_ = ~x41 & ~x42 & (x40 ? ~x19 : ((~x43 & ~x44) | (~x19 & (~x43 ^ ~x44))));
  assign new_n446_ = ~x03 & ~x05 & (~x00 | x03 | x05);
  assign new_n447_ = ~new_n448_ & (new_n452_ | ~x21) & (~x18 | (new_n450_ & ~new_n453_));
  assign new_n448_ = x25 & ((new_n449_ & x19 & ~x20 & ~x21) | (x21 & ~x28 & ~x19 & x20));
  assign new_n449_ = x00 & x10 & x18;
  assign new_n450_ = (x21 | (~new_n382_ & ~new_n451_)) & (~x19 | ~x20 | x28) & (~x21 | (x19 ? ~x20 : (x20 | x28)));
  assign new_n451_ = x26 & (x28 ? (x19 ^ x20) : ((x17 & ~x19 & x20) | (x00 & ((x19 & ~x20) | (~x17 & ~x19 & x20)))));
  assign new_n452_ = x19 ? (~x20 | ~x22) : (x28 | (~new_n386_ & (~x20 | ~x26)));
  assign new_n453_ = x22 & ((x20 & x21 & ~x28) | (x00 & x19 & ~x20 & ~x21));
  ...
  assign new_n457_ = (~x20 | (~new_n458_ & (new_n462_ | x21))) & new_n464_ & (new_n407_ | ~x21);
  assign new_n458_ = ~new_n459_ & x19;
  assign new_n459_ = (~x28 | (x18 ? (x21 | x27) : ~new_n460_)) & (~x18 | x21 | new_n461_ | ~x27);
  assign new_n460_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n461_ = x03 & (~x00 | ~x03);
  assign new_n462_ = (new_n463_ | x18) & (~new_n127_ | x19 | ~x17 | ~x18);
  assign new_n463_ = (~x22 | ~x28) & (x14 | x19 | x23 | x27);
  assign new_n464_ = (~x14 | x27 | x28) & (x21 | ((new_n466_ | ~x28) & (x14 | x27 | new_n465_ | x28)));
  assign new_n465_ = ~x13 & (~x18 | x19 | x20);
  assign new_n466_ = (x18 | x19) & (~x18 | ~x19 | x20 | ~x26);
  assign new_n467_ = ~x19 & x21 & (new_n469_ | (new_n468_ & ~x09));
  assign new_n468_ = ~x18 & ~x20 & x22 & ~x28 & ~new_n345_ & x29;
  assign new_n469_ = x20 & ((x18 & x28) | (~x10 & ~x18 & x25));
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n471_ & x21;
  assign new_n471_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
  assign z43 = ~x18 & new_n473_ & ~x19;
  assign new_n473_ = x20 & ~x21 & ~x29 & x30 & (x22 | x24);
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
