// Benchmark "FAU" written by ABC on Fri Jul 31 17:21:44 2020
...
module FAU ( 
  ...
  assign new_n381_ = (~x18 | ~x19 | x20 | x21) & (~new_n382_ | ~x21 | x28 | x19 | ~x20);
  ...
  assign new_n435_ = ~x24 & ~x26 & (~x20 | ~x22 | x05 | ~x15);
