// Benchmark "FAU" written by ABC on Fri Jul 31 17:20:40 2020
...
module FAU ( 
  ...
  assign new_n324_ = ~new_n327_ & (x20 | (~new_n326_ & (new_n325_ | x19)));
  assign new_n325_ = (x03 | x18 | new_n120_ | x21) & (~x18 | ~x21 | ~new_n111_ | x28);
  assign new_n326_ = x18 & x19 & ~x21 & new_n115_ & x26 & ~x28;
  assign new_n327_ = ~x18 & x19 & x21 & new_n111_ & x28;
  ...
  assign z35 = x30 ? ~new_n367_ : ~new_n387_;
  assign new_n367_ = ~new_n385_ & (x29 | (~new_n377_ & new_n379_ & (new_n368_ | x18)));
  assign new_n368_ = x21 ? (~new_n371_ & (new_n369_ | ~x19)) : new_n374_;
  ...
  assign new_n377_ = x10 & x25 & (new_n378_ | (new_n116_ & ~x20 & ~x21));
  assign new_n378_ = new_n109_ & x00 & x21 & ~x28 & ~x19 & x20;
  assign new_n379_ = x20 ? (~new_n383_ & (new_n380_ | x19)) : (~new_n384_ & (~new_n382_ | ~x19));
  ...
  assign new_n383_ = x18 & x19 & (~x21 | (x00 & x21));
  assign new_n384_ = x18 & ((x26 & ~x28 & x19 & ~x21) | (x00 & ((~x19 & x21 & ~x28) | (x26 & x28 & x19 & ~x21))));
  assign new_n385_ = x19 & x20 & new_n386_ & ~x21;
  assign new_n386_ = x29 & ((~x18 & x22 & x28) | (~x27 & ~x28 & x05 & x18));
  assign new_n387_ = (x21 | (~new_n388_ & (new_n391_ | ~x29))) & (~x29 | (~new_n398_ & (new_n395_ | ~x21)));
  assign new_n388_ = ~x03 & (new_n389_ | (new_n390_ & x00 & ~x05 & ~x18));
  assign new_n389_ = new_n116_ & x20 & x27 & ~x29;
  assign new_n390_ = ~x19 & ~x20 & ~x28 & x29;
  assign new_n391_ = (~x18 | (~new_n393_ & (new_n392_ | ~x00))) & (~x00 | x18 | new_n394_ | ~x20);
  assign new_n392_ = (~x19 | new_n119_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n393_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n394_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n395_ = (new_n396_ | ~x20) & (x19 | x28 | (~new_n397_ & (~x18 | x20))) & (x18 | ~x19 | ~x28);
  assign new_n396_ = (~x18 | (~x19 & (~x22 | x28))) & (~x19 | ~x22) & (x19 | (x18 & (x28 | (~x25 & ~x26))));
  assign new_n397_ = x39 & ~x41 & x42 & ~x09 & x22 & ~x38;
  assign new_n398_ = new_n116_ & x20 & ~x27 & ~x28;
  assign z36 = (~new_n417_ & x21) | (~x30 & (~new_n408_ | (~new_n400_ & ~x21)));
  assign new_n400_ = ~new_n388_ & new_n403_ & (~x18 | (new_n401_ & (new_n407_ | ~x26)));
  assign new_n401_ = (~x19 | (~new_n402_ & (~new_n363_ | ~x20))) & (~new_n236_ | x14 | x19 | x20);
  assign new_n402_ = x00 & ((~x20 & ~new_n119_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n403_ = (new_n404_ | x29) & (~x00 | x18 | ~x20 | new_n394_ | ~x29);
  ...
  assign new_n419_ = (new_n94_ | ~x19) & (x20 | ~x22 | ~x33 | ~x09 | x19);
  ...
  assign new_n426_ = ~x18 & (x21 ? (new_n371_ | new_n431_) : ~new_n427_);
  ...
  assign new_n431_ = x19 & (new_n370_ | (~x28 & (~new_n432_ | x25)));
  assign new_n432_ = (~x20 | ~x22 | x05 | ~x15) & ~x24 & ~x26;
  ...
  assign new_n439_ = (new_n440_ | ~x18) & (~new_n382_ | ~x19);
  ...
  assign new_n459_ = (x21 | (~new_n393_ & ~new_n460_)) & (~x19 | ~x20 | x28) & (~x21 | (x19 ? ~x20 : (x20 | x28)));
  assign new_n460_ = x26 & (x28 ? (x19 ^ x20) : ((x17 & ~x19 & x20) | (x00 & ((x19 & ~x20) | (~x17 & ~x19 & x20)))));
  assign new_n461_ = x19 ? (~x20 | ~x22) : (x28 | (~new_n397_ & (~x20 | ~x26)));
  ...
  assign new_n477_ = ~x18 & ~x20 & x22 & ~x28 & ~new_n353_ & x29;
