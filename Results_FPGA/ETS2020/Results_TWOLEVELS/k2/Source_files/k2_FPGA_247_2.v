// Benchmark "FAU" written by ABC on Fri Jul 31 17:23:39 2020
...
module FAU ( 
  ...
  assign new_n173_ = x28 & ((~x18 & (x21 | (x20 & ~x21 & x22))) | (~x21 & ~x27 & x18 & x20));
  ...
  assign new_n231_ = (x20 | x28 | ~x18 | x19) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | x28 | (~new_n154_ & ~x22))));
  ...
  assign new_n259_ = (~x20 | ~x22) & (x18 | ~x28);
  ...
  assign new_n396_ = x29 & ((~x18 & x22 & x28) | (~x27 & ~x28 & x05 & x18));
