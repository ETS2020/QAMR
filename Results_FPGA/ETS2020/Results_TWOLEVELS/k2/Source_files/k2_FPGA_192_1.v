// Benchmark "FAU" written by ABC on Fri Jul 31 17:22:08 2020
...
module FAU ( 
  ...
  assign new_n104_ = x19 ? (~new_n111_ & (new_n109_ | x21)) : new_n105_;
  ...
  assign new_n147_ = (x19 | new_n148_ | ~x22) & (~x01 | ~x19 | x29 | (~x22 & ~x23));
  ...
  assign new_n177_ = x22 & (x29 | (~x33 & x39 & x09 & ~x31));
  ...
  assign new_n261_ = x30 & ((x22 & (x18 ? x19 : (~x19 & x28))) | (x18 & ~new_n100_ & x19));
  ...
  assign z20 = x30 & x29 & new_n284_ & ~x28;
  assign new_n284_ = x26 & ~x21 & x20 & ~x19 & ~x17 & x18;
  assign z21 = ~x30 & new_n286_ & x29;
  assign new_n286_ = x28 & x26 & ~x21 & x20 & x18 & ~x19;
  assign z22 = (~new_n288_ & x30) | new_n320_ | (~x30 & (x29 ? ~new_n308_ : ~new_n323_));
  assign new_n288_ = ~new_n191_ & (new_n289_ | x21) & (~x21 | (x19 ? new_n305_ : new_n299_));
  assign new_n289_ = (x29 | (x18 ? new_n297_ : new_n290_)) & (~new_n298_ | ~x18) & (new_n293_ | ~x29);
  assign new_n290_ = (x19 | (~new_n229_ & new_n291_)) & (~x23 | x28) & (new_n292_ | ~x19);
  ...
  assign new_n302_ = (~x29 | ((~new_n161_ | ~x20) & (x18 | x20 | ~x22) & (~x18 | (x20 & ~x22)))) & (x18 | x20 | new_n148_ | ~x22);
  ...
  assign new_n310_ = ~new_n131_ & (x21 ? ~x28 : x01);
  assign new_n311_ = (new_n228_ | x21) & (x09 | ~x21 | ~x22 | ~new_n240_ | x38);
  assign new_n312_ = new_n243_ & new_n242_ & x22 & ~x09 & x21;
  assign new_n313_ = x21 & x23 & (x31 | x34 | (new_n245_ & ~x31));
  ...
  assign new_n317_ = x19 ? new_n318_ : ((~new_n274_ | ~x21) & (~x20 | (~x21 & (x21 | ~x24))));
  assign new_n318_ = (~x21 | ~x28) & (~x05 | ~x20 | x21 | ~x22 | x28);
  assign new_n319_ = x21 & ~x28 & (x22 | (~new_n162_ & ~x19));
  assign new_n320_ = ~x18 & ~x19 & ~new_n321_ & x21;
  assign new_n321_ = (x09 | x20 | ~new_n322_ | ~x22) & (x10 | ~x20 | ~x25);
  assign new_n322_ = ~x28 & x29 & (x38 | (~new_n130_ & ~x38));
  ...
  assign new_n337_ = ~x20 & (x18 ? new_n340_ : (new_n275_ | (new_n338_ & x29)));
  assign new_n338_ = ~x30 & ((~x19 & x23) | (~x28 & (new_n339_ | (x19 & (x22 | x23)))));
  assign new_n339_ = new_n243_ & new_n242_ & ~x09 & x22;
  ...
  assign new_n347_ = x19 ? (~x18 & (~new_n112_ | ~new_n113_ | x18)) : (~new_n106_ & (x18 | ~x24));
  assign new_n348_ = new_n118_ & x03;
  assign new_n349_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n350_ = ~new_n353_ & (x20 | (~new_n352_ & (new_n351_ | x19)));
  assign new_n351_ = (x03 | x18 | new_n122_ | x21) & (~x18 | ~x21 | ~new_n114_ | x28);
  assign new_n352_ = new_n117_ & x26 & ~x28 & x18 & x19 & ~x21;
  assign new_n353_ = new_n114_ & x28 & ~x18 & x19 & x21;
  ...
  assign new_n358_ = (new_n359_ | ~x00) & (~new_n149_ | ~new_n151_ | x00 | x04 | ~x18);
  ...
  assign new_n362_ = (~new_n363_ | ~x18) & (~new_n149_ | x18 | ~new_n117_ | ~x22);
  ...
  assign new_n373_ = ~x20 & x22 & ~x28 & new_n240_ & ~x38;
  assign new_n374_ = new_n149_ & x00 & ~x21 & x22 & x28;
  assign new_n375_ = ~x09 & ~x19 & ~x20 & x21 & new_n376_ & x22;
  assign new_n376_ = ~x28 & ((~x38 & (x41 | (~x41 & ~x42 & (new_n187_ | x39)))) | x38 | (~x39 & x42));
  ...
  assign new_n386_ = x30 & ((~new_n387_ & x00) | (new_n203_ & ~x20 & x26));
  ...
  assign new_n393_ = ~new_n394_ & (~new_n118_ | ~x20 | ~x27 | x29);
  assign new_n394_ = x00 & ~x05 & ~x18 & new_n203_ & ~x19 & ~x20;
  assign new_n395_ = (new_n397_ | ~x26) & ~new_n399_ & (~x19 | (~new_n396_ & ~new_n398_));
  assign new_n396_ = x00 & ((x03 & x20 & x27 & ~x29) | (~x20 & ~new_n121_ & x29));
  ...
  assign new_n417_ = x19 & x20 & ((new_n418_ & ~x18) | (new_n203_ & x18 & ~x27));
  ...
  assign new_n424_ = (~x21 | x28 | (~new_n112_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  ...
  assign new_n434_ = ~x20 & ~new_n131_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n436_ & x19) | (x29 & (new_n446_ | (~new_n442_ & ~x19)));
  assign new_n436_ = x18 ? ((new_n440_ | x21) & (~new_n117_ | ~x20 | ~x21)) : new_n437_;
  assign new_n437_ = x21 ? new_n439_ : (~new_n438_ & (~x29 | new_n216_ | x30));
  assign new_n438_ = x02 & ~x03 & x20 & new_n114_ & x22 & x28;
  assign new_n439_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n131_ | ~x30);
  assign new_n440_ = x20 ? ((~new_n114_ | ~x27) & (~new_n116_ | ~x04 | x27)) : ~new_n441_;
  assign new_n441_ = x29 & ((~new_n144_ & x30) | (x26 & x28 & ~x30));
  assign new_n442_ = (new_n443_ | ~x20) & (x30 | ((x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20)));
  assign new_n443_ = (x18 | (x21 ? x30 : (x28 | ~x30))) & (~x21 | x28 | new_n162_ | x30) & (new_n444_ | ~x18);
  assign new_n444_ = (~new_n445_ | x21) & (~x11 | ~x21 | ~new_n138_ | ~x25);
  assign new_n445_ = x26 & ((x28 & ~x30) | (~x17 & ~x28 & x30));
  assign new_n446_ = new_n138_ & x22 & x20 & x21;
  ...
  assign new_n450_ = new_n117_ & ~x21 & x03 & ~x19 & ~x20;
