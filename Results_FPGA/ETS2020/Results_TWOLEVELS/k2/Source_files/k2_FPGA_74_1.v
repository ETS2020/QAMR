...
module FAU ( 
  ...
  assign new_n287_ = (x29 | (x18 ? new_n295_ : new_n288_)) & (new_n291_ | ~x29) & (~new_n296_ | ~x18);
  ...
  assign z34 = x18 ? ~new_n381_ : (~new_n369_ | new_n376_);
  ...
  assign new_n376_ = x30 & ((~new_n377_ & ~x29) | (~new_n380_ & ~x28));
  assign new_n377_ = (~x28 | ((new_n378_ | x21) & (~x00 | ~x19 | ~x21))) & (~x19 | ~x21 | new_n379_ | x28);
  assign new_n378_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n379_ = ~x24 & (~x10 | ~x25) & ~x26;
  ...
  assign new_n400_ = (x18 | new_n292_ | ~x28) & (x14 | new_n401_ | x27);
  ...
  assign new_n412_ = (new_n379_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
