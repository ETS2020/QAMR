...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n41_, new_n42_, new_n43_, new_n45_, new_n47_, new_n49_,
    new_n51_, new_n52_;
  assign z02 = x04 & ~x06 & (~x16 | (x02 & ~x03));
  assign z03 = x04 & ((x02 & ~x03) | ~x16) & (x06 ^ x07);
  assign z04 = new_n39_ & x04;
  assign new_n39_ = ((x02 & ~x03) | ~x16) & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08));
  assign z05 = new_n41_ | (~new_n42_ & x09) | new_n43_ | ~x04;
  assign new_n41_ = x16 & (x03 | (~x02 & x04));
  assign new_n42_ = x06 & x07 & x08;
  assign new_n43_ = x06 & x07 & x08 & ~x09;
  assign z06 = new_n41_ | (~new_n43_ & x10) | new_n45_ | ~x04;
