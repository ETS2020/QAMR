// Benchmark "FAU" written by ABC on Wed Jul 29 06:54:46 2020
...
module FAU ( 
  ...
  assign z9 = (x33 | (~new_n58_ & new_n65_)) & new_n66_ & (new_n62_ | ~new_n63_ | ~new_n65_);
  ...
  assign new_n62_ = ~new_n61_ & (~x15 | ((~x12 | ~x18) & (~x17 | (~x13 & ~x18))));
  assign new_n63_ = x33 & (new_n64_ | x19) & (new_n60_ | x16) & (~new_n64_ | (x14 & ~x19));
  assign new_n64_ = x17 & x18 & x15 & x16;
