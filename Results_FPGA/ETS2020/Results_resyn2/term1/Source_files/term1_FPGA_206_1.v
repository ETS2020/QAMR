// Benchmark "FAU" written by ABC on Wed Jul 29 06:55:04 2020
...
module FAU ( 
  ...
  assign z7 = ~new_n50_ | (x29 & x27 & x28 & (~x30 | ~x31) & (x30 | x31)) | (x31 & (~x29 | ~x27 | ~x28));
  assign z8 = (x32 | (new_n56_ & new_n60_)) & new_n66_ & (~new_n60_ | ~new_n62_ | ~new_n65_);
  assign new_n56_ = x15 ? (x16 ? new_n59_ : (new_n58_ & x19)) : (new_n57_ & x19);
  assign new_n57_ = x10 & x16 & x17 & x18;
  assign new_n58_ = x11 & x17 & x18;
  assign new_n59_ = x17 ? (x18 ? (x14 & ~x19) : (x13 & x19)) : (x19 & x12 & x18);
  assign new_n60_ = new_n61_ & x31;
  ...
  assign new_n65_ = (x15 | (new_n57_ & x19)) & (x16 | (new_n58_ & x19));
  assign new_n66_ = x00 & ~x26;
  assign z9 = new_n68_ & (x33 | (new_n56_ & new_n73_));
  assign new_n68_ = new_n66_ & (new_n69_ | new_n61_ | ~new_n72_ | ~new_n70_ | ~new_n71_);
  assign new_n69_ = (~x17 | ~x18 | ~x10 | ~x16) & (~x15 | (~x16 & (~x11 | ~x17 | ~x18)));
  assign new_n70_ = x33 & (x14 | x19) & (x13 | x18);
  assign new_n71_ = (~x30 ^ x31) & (x17 | (x12 & x18));
