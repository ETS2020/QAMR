// Benchmark "FAU" written by ABC on Wed Jul 29 06:55:23 2020
...
module FAU ( 
  ...
  wire new_n47_, new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n56_,
  ...
  assign z7 = ~new_n49_ | (x31 & (~x29 | ~x27 | ~x28)) | (x29 & x27 & x28 & (x30 | x31) & (~x30 | ~x31));
  assign z8 = (x32 | (new_n54_ & new_n58_)) & new_n64_ & (~new_n58_ | ~new_n60_ | ~new_n63_);
  assign new_n54_ = x15 ? (x16 ? new_n57_ : (new_n56_ & x19)) : (new_n55_ & x19);
  assign new_n55_ = x10 & x16 & x17 & x18;
  assign new_n56_ = x11 & x17 & x18;
  assign new_n57_ = x17 ? (x18 ? (x14 & ~x19) : (x13 & x19)) : (x19 & x12 & x18);
  assign new_n58_ = new_n59_ & x31;
  ...
  assign new_n63_ = (x15 | (new_n55_ & x19)) & (x16 | (new_n56_ & x19));
  assign new_n64_ = x00 & ~x26;
  assign z9 = new_n66_ & (x33 | (new_n54_ & new_n71_));
  assign new_n66_ = new_n64_ & (new_n67_ | new_n59_ | ~new_n70_ | ~new_n68_ | ~new_n69_);
  assign new_n67_ = (~x17 | ~x18 | ~x10 | ~x16) & (~x15 | (~x16 & (~x11 | ~x17 | ~x18)));
  assign new_n68_ = x33 & (x14 | x19) & (x13 | x18);
  assign new_n69_ = (~x30 ^ x31) & (x17 | (x12 & x18));
  assign new_n70_ = x19 ^ (x15 & x16 & x17 & x18);
  assign new_n71_ = (x29 & (x27 | x28)) ? (x30 & x31) : (~x30 & ~x31);
  assign z1 = 1'b0;
  assign z4 = 1'b0;
  assign z5 = 1'b0;
  assign z6 = 1'b0;
