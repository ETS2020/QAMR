...
module FAU ( 
  ...
  assign z8 = (x32 | (new_n56_ & new_n60_)) & new_n66_ & (~new_n60_ | ~new_n62_);
  assign new_n56_ = ~new_n57_ & (~x15 | (~new_n58_ & (new_n59_ | ~x16)));
  assign new_n57_ = ~x15 & (~x19 | ~x17 | ~x18 | ~x10 | ~x16);
  assign new_n58_ = ~x16 & (~x19 | ~x11 | ~x17 | ~x18);
  ...
  assign new_n62_ = ~new_n57_ & ~new_n58_ & ~new_n63_ & new_n65_ & (~new_n64_ | ~x19);
  ...
  assign new_n68_ = new_n69_ & ~new_n57_ & (~x15 | (~new_n58_ & (new_n59_ | ~x16)));
  assign new_n69_ = (x29 & (x27 | x28)) ? (x30 & x31) : (~x30 & ~x31);
  assign new_n70_ = (x17 | (x12 & x18)) & new_n71_ & (x13 | x18);
  assign new_n71_ = x33 & (x14 | x19);
  assign new_n72_ = (~new_n64_ | ~x19) & (~new_n61_ | (x30 & x31)) & (new_n64_ | x19) & (new_n61_ | (~x30 & ~x31));
