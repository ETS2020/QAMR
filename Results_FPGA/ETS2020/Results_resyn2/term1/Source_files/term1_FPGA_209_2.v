// Benchmark "FAU" written by ABC on Wed Jul 29 06:55:05 2020
...
module FAU ( 
  ...
  wire new_n47_, new_n49_, new_n50_, new_n51_, new_n57_, new_n58_, new_n59_,
  ...
  assign z7 = ~new_n49_ | (x31 & (~x30 | ~x29 | ~x27 | ~x28)) | (~x31 & x30 & x29 & x27 & x28);
  assign z8 = new_n64_ & ((~new_n57_ & new_n60_ & new_n62_ & ~x32) | ((~new_n60_ | ~new_n61_) & x32));
  assign new_n57_ = x15 & (x16 ? ~new_n59_ : (~new_n58_ | ~x11));
  assign new_n58_ = x17 & x18 & x19;
  assign new_n59_ = x17 ? ((x18 | (x13 & x19)) & (x14 | x19) & (~x18 | ~x19)) : (x12 & x18 & x19);
  assign new_n60_ = x31 & (x15 | (new_n58_ & x10 & x16));
  assign new_n61_ = new_n63_ & (~new_n58_ | ~x15 | ~x16) & new_n62_ & (x16 | (new_n58_ & x11));
  assign new_n62_ = x30 ^ (x29 & (x27 | x28));
  assign new_n63_ = (x17 | (x12 & x18 & x19)) & (x14 | x19) & (x18 | (x13 & x19));
