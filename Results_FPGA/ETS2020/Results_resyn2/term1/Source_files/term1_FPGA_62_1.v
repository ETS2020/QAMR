// Benchmark "FAU" written by ABC on Wed Jul 29 06:54:06 2020
...
module FAU ( 
  ...
  assign new_n48_ = new_n50_ & (~new_n49_ | (~x15 & ~x20) | (~x19 & ~x24));
  assign new_n49_ = (x18 | x23) & (x17 | x22) & (x16 | x21);
  assign new_n50_ = (~x02 | ~x03) & ~x26 & x01 & x25;
  assign z4 = new_n48_ & (~x27 | ~x28) & (x27 | x28);
  assign z7 = ~new_n48_ | (~x31 ^ (~x27 | ~x28 | ~x29 | ~x30));
