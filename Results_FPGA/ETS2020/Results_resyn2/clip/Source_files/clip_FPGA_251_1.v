// Benchmark "FAU" written by ABC on Tue Jul 28 23:15:55 2020
...
module FAU ( 
  ...
  assign new_n20_ = ((x4 & x7) | (x3 & x8)) & new_n21_ & (x3 | x8);
  ...
  assign new_n36_ = (~new_n37_ | ~x3 | ~x0 | x5) & (~new_n38_ | ((~x3 | x5) & ~x0 & ~x2));
  assign new_n37_ = ~x6 & x7;
  assign new_n38_ = (x4 | ~x7) & (~x4 | x7) & (x2 ^ x6);
  ...
  assign new_n43_ = (~x7 | (((new_n44_ & (~x0 | x4)) | ~x3 | (~x0 & x5)) & (~new_n44_ | ~x4 | x3 | x0 | x5))) & ((~new_n44_ & ~x4) | (~x0 & x5) | x3 | x7);
  ...
  assign new_n54_ = (x4 | (x1 & ~x2)) & (~x7 | (x4 & x1 & ~x2));
  assign new_n55_ = x3 & (x0 | ~x5) & (x6 | (x0 & x7));
  assign new_n56_ = (x7 | (x2 & x4)) & new_n21_ & x3 & (x1 | x4);
  ...
  assign new_n62_ = x6 & x8 & ((~x4 & (~x1 | x2)) | (x7 & (~x4 | ~x1 | x2)));
