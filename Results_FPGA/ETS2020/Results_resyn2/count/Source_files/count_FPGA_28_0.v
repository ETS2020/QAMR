...
module FAU ( 
  ...
  wire new_n56_, new_n58_, new_n60_, new_n62_, new_n65_, new_n67_, new_n69_,
    new_n70_, new_n71_, new_n75_, new_n77_, new_n79_;
  ...
  assign z07 = (~new_n65_ & x16) | x18 | (~x08 & ~x16);
  ...
  assign z10 = (x16 & (new_n70_ | (~new_n69_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n69_ = ~x27 & ~x28 & new_n62_ & ~x26 & ~x24 & ~x25;
  assign new_n70_ = new_n71_ & new_n62_ & ~x24 & ~x25;
  assign new_n71_ = ~x27 & ~x28 & ~x26 & ~x29;
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n70_ ^ x30));
  assign z12 = x18 | (~x03 & ~x16) | (x16 & ((x31 & (~new_n70_ | x30)) | (new_n70_ & ~x30 & ~x31)));
  assign z13 = x18 | (~x02 & ~x16) | (x16 & ((x32 & (~new_n70_ | ~new_n75_)) | (new_n70_ & new_n75_ & ~x32)));
  assign new_n75_ = ~x30 & ~x31;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & ((x33 & (~new_n70_ | ~new_n77_)) | (new_n70_ & new_n77_ & ~x33)));
  assign new_n77_ = new_n75_ & ~x32;
  assign z15 = ~new_n79_ | ((~x34 | ~new_n70_ | ~new_n77_ | x33) & x16 & (x34 | (new_n70_ & new_n77_ & ~x33)));
  assign new_n79_ = ~x18 & (x00 | x16);
  assign z09 = 1'b0;
endmodule
