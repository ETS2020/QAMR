...
module FAU ( 
  ...
  assign z05 = (x16 & (new_n58_ ^ x24)) | x18 | (~x10 & ~x16);
  ...
  assign z09 = (x16 & ((x28 & (~new_n61_ | ~new_n65_)) | (new_n61_ & new_n65_ & ~x28))) | x18 | (~x06 & ~x16);
  assign new_n65_ = ~x26 & ~x27;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n69_ | (~new_n67_ & x29)));
  ...
  assign z13 = x18 | (~x02 & ~x16) | (~new_n73_ & x16);
