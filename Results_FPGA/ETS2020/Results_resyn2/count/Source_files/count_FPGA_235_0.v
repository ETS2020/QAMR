...
module FAU ( 
  ...
  assign z12 = x18 | (~x03 & ~x16) | (x16 & ((x31 & (~new_n69_ | x30)) | (new_n69_ & ~x30 & ~x31)));
  assign z13 = (x16 & ((x32 & (~new_n69_ | ~new_n72_)) | (new_n69_ & new_n72_ & ~x32))) | x18 | (~x02 & ~x16);
  assign new_n72_ = ~x30 & ~x31;
  assign z14 = (x16 & ((x33 & (~new_n69_ | ~new_n74_)) | (new_n69_ & new_n74_ & ~x33))) | x18 | (~x01 & ~x16);
  assign new_n74_ = new_n72_ & ~x32;
  assign z15 = ~new_n76_ | ((~x34 | ~new_n69_ | ~new_n74_ | x33) & x16 & (x34 | (new_n69_ & new_n74_ & ~x33)));
  assign new_n76_ = ~x18 & (x00 | x16);
  assign z09 = 1'b0;
  assign z10 = 1'b0;
endmodule
