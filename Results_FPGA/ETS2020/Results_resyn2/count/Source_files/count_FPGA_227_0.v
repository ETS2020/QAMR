...
module FAU ( 
  ...
  assign new_n57_ = (x19 | ((~x21 | ~x22) & (x21 | x22 | x17 | x20))) & (~x22 | (~x20 & ~x17 & ~x19));
  assign z04 = (~new_n59_ & x16) | x18 | (~x11 & ~x16);
  assign new_n59_ = (x20 | x17 | x19 | x23 | x21 | x22) & (~x23 | (~x22 & ~x21 & ~x20 & ~x17 & ~x19));
  ...
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n68_ ^ x30));
  assign new_n68_ = new_n61_ & new_n64_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & ((x31 & (~new_n68_ | x30)) | (new_n68_ & ~x30 & ~x31)));
  assign z13 = (x16 & ((x32 & (~new_n68_ | ~new_n71_)) | (new_n68_ & new_n71_ & ~x32))) | x18 | (~x02 & ~x16);
  assign new_n71_ = ~x30 & ~x31;
  assign z14 = (x16 & ((x33 & (~new_n68_ | ~new_n73_)) | (new_n68_ & new_n73_ & ~x33))) | x18 | (~x01 & ~x16);
  assign new_n73_ = new_n71_ & ~x32;
  assign z15 = ~new_n75_ | ((~x34 | ~new_n68_ | ~new_n73_ | x33) & x16 & (x34 | (new_n68_ & new_n73_ & ~x33)));
