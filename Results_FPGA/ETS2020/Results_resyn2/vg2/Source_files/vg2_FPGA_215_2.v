// Benchmark "FAU" written by ABC on Wed Jul 29 04:30:17 2020
...
module FAU ( 
  ...
  assign new_n40_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  ...
  assign z7 = (x05 & (x24 ? x18 : (x13 & x15))) | (new_n63_ & ~x24) | (x13 & x18 & x24) | (x15 & ~x05 & ~x13);
