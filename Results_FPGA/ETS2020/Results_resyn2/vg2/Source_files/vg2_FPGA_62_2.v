...
module FAU ( 
  ...
  assign new_n46_ = (~x21 | x02 | x10) & (~x05 | ~x13 | ~x15);
  ...
  assign new_n59_ = new_n60_ & ((new_n57_ & x18) | (new_n58_ & x07));
  assign new_n60_ = x24 & (x05 | x13);
  assign new_n61_ = ~x05 & ~x13 & ((new_n57_ & x15) | (new_n58_ & x19));
  assign z6 = (~new_n63_ & (x03 | (~new_n67_ & ~x11))) | (~new_n65_ & (~x03 | (~new_n68_ & x11)));
  assign new_n63_ = (~x05 | (x24 ? ~x07 : (~x13 | ~x19))) & (~new_n64_ | x24) & (~x19 | x05 | x13) & (~x13 | ~x07 | ~x24);
  assign new_n64_ = x00 & ~x02 & ~x10;
  assign new_n65_ = (~x05 | (x24 ? ~x18 : (~x13 | ~x15))) & (~new_n66_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n66_ = x21 & ~x02 & ~x10;
  assign new_n67_ = ~x06 & (x14 | ~x20);
