...
module FAU ( 
  ...
  assign z3 = (~new_n60_ & ~x24) | (~new_n63_ & x24 & (x05 | x13)) | (~new_n64_ & ~x05 & ~x13);
  assign new_n60_ = (~new_n61_ | new_n46_) & (~new_n62_ | new_n40_);
  assign new_n61_ = new_n44_ & x20 & x11 & x14;
  assign new_n62_ = new_n41_ & ~x20 & ~x01 & ~x03;
  assign new_n63_ = (~new_n62_ | ~x07) & (~new_n61_ | ~x18);
  assign new_n64_ = (~new_n61_ | ~x15) & (~new_n62_ | ~x19);
  assign z4 = (z5 & (x08 | (~new_n68_ & ~x16))) | (z7 & (~x08 | (~new_n69_ & x16)));
  assign z5 = (x05 & (x24 ? x07 : (x13 & x19))) | (new_n67_ & ~x24) | (x19 & ~x05 & ~x13) | (x13 & x07 & x24);
  assign new_n67_ = x00 & ~x02 & ~x10;
