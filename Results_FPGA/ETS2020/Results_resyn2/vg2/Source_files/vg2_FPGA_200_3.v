...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n41_, new_n42_, new_n44_, new_n45_,
  ...
  assign z4 = (~new_n36_ & (x08 | (~new_n53_ & ~x16))) | (z7 & (~x08 | (~new_n54_ & x16)));
  assign new_n53_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n54_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n36_ & (x03 | (~new_n56_ & ~x11))) | (z7 & (~x03 | (~new_n57_ & x11)));
