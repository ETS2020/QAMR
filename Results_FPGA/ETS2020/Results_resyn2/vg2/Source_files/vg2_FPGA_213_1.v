// Benchmark "FAU" written by ABC on Wed Jul 29 04:30:16 2020
...
module FAU ( 
  ...
  assign z4 = (~new_n36_ & (x08 | (~new_n61_ & ~x16))) | (z7 & (~x08 | (~new_n62_ & x16)));
  assign new_n61_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n62_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n36_ & (x03 | (~new_n64_ & ~x11))) | (z7 & (~x03 | (~new_n65_ & x11)));
