...
module FAU ( 
  ...
  assign z4 = (~new_n63_ & (~x08 | (~new_n67_ & x16))) | (~new_n65_ & (x08 | (~new_n68_ & ~x16)));
  assign new_n63_ = (~x05 | (x24 ? ~x18 : (~x13 | ~x15))) & (~new_n64_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n64_ = x21 & ~x02 & ~x10;
  assign new_n65_ = (~x05 | (x24 ? ~x07 : (~x13 | ~x19))) & (~new_n66_ | x24) & (~x13 | ~x07 | ~x24) & (~x19 | x05 | x13);
