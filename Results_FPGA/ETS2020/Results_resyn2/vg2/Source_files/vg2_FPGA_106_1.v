...
module FAU ( 
  ...
  assign z0 = ~new_n36_ & new_n39_ & new_n38_ & ~x01 & ~x03;
  ...
  assign z4 = (~new_n36_ & (x08 | (~new_n72_ & ~x16))) | (z7 & (~x08 | (~new_n73_ & x16)));
  assign new_n72_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n73_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n36_ & (x03 | (~new_n75_ & ~x11))) | (z7 & (~x03 | (~new_n76_ & x11)));
