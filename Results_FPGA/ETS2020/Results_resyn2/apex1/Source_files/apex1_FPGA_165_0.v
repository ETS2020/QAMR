// Benchmark "FAU" written by ABC on Wed Jul 29 15:44:42 2020
...
module FAU ( 
  ...
  assign new_n171_ = (x30 | ~x04 | ~x28) & (~x05 | x28 | ~x30);
  ...
  assign z33 = ~new_n189_ & x20 & new_n112_ & ~x21;
  assign new_n189_ = (new_n190_ | x27 | ~x29) & (~x27 | x29 | (~x30 & (~x00 | ~x03)));
  assign new_n190_ = (~x04 | ~x28) & (~x30 | (~x05 & ~x28));
  assign z35 = x30 ? ~new_n192_ : ((~new_n210_ & x29) | (new_n222_ & ~x21));
  assign new_n192_ = (x29 | (~new_n193_ & new_n203_)) & (new_n209_ | ~new_n208_ | x21 | ~x29);
  ...
  assign new_n203_ = (new_n207_ | ~x18) & ~new_n205_ & (new_n204_ | new_n119_);
  assign new_n204_ = (~x19 | x20 | ~x18 | x21) & (~new_n107_ | ~x21 | ~x00 | x19 | ~x20);
  assign new_n205_ = new_n141_ & new_n206_ & ~x05 & ~x15 & x00 & x21;
  assign new_n206_ = ~x19 & x20;
  assign new_n207_ = (~x00 | ((~x19 | ~x20) & (~x21 | x28 | x19 | x20))) & (x21 | ((~x19 | ~x20) & ((~x00 & x28) | ~x26 | (~x19 & ~x20))));
  assign new_n208_ = x19 & x20;
  assign new_n209_ = (x18 | ~x22 | ~x28) & (~x18 | x27 | ~x05 | x28);
  assign new_n210_ = ~new_n211_ & ~new_n217_ & (~new_n112_ | ~x20 | x27 | x28);
  assign new_n211_ = x21 & (~new_n215_ | (~x19 & (new_n212_ | new_n126_)));
  assign new_n212_ = ~x28 & (~new_n213_ | (new_n214_ & x39 & x42));
  assign new_n213_ = (~x20 | ~x26) & (~x18 | (x20 & (~x11 | ~x25)));
  assign new_n214_ = ~x20 & x22 & ~x41 & ~x09 & ~x38;
  assign new_n215_ = (~x28 | x18 | ~x19) & (~x20 | ((~x19 | (~x18 & ~x22)) & ((~new_n216_ & ~x22) | ~x18 | x28)));
  assign new_n216_ = ~x11 & x25;
  assign new_n217_ = ~x21 & (new_n219_ | (x18 & (new_n221_ | (~new_n218_ & x00))));
  assign new_n218_ = (new_n119_ | ~x19 | x20) & (~new_n141_ | (~x19 & ~x20) | (x19 & x20));
  assign new_n219_ = ~new_n220_ & new_n126_ & x00;
  assign new_n220_ = (x19 | ~x23 | x28) & (~x19 | ~x22 | (x05 & ~x28));
  assign new_n221_ = x20 & ~x27 & x28 & x19 & (~x00 | x04);
  assign new_n222_ = ~x03 & (new_n223_ | (x27 & ~x29 & new_n112_ & x20));
  assign new_n223_ = new_n153_ & x00 & ~x05 & ~x18 & ~x19 & ~x20;
  assign z36 = (~new_n225_ & x21) | (~x30 & (new_n230_ | (~new_n242_ & new_n208_)));
  assign new_n225_ = (new_n226_ | x28 | ~x30) & (~new_n229_ | ~new_n206_ | ~x18 | ~x28);
  assign new_n226_ = (x29 | (~new_n228_ & (new_n227_ | x18))) & (~new_n216_ | ~new_n206_ | ~x18 | ~x29);
  assign new_n227_ = (new_n94_ | ~x19) & (x20 | ~x22 | ~x33 | ~x09 | x19);
  assign new_n228_ = (x18 | x19) & (~x18 | ~x19) & (x18 | x22) & x20 & ~x05 & x15;
  assign new_n229_ = x16 ? ~x08 : ~x07;
  assign new_n230_ = (new_n231_ | ~x21) & ((~new_n234_ & x18) | new_n239_ | new_n222_ | x21);
  assign new_n231_ = ~new_n232_ & (~new_n215_ | ~x29 | (~x19 & (new_n233_ | new_n126_)));
  assign new_n232_ = ~new_n187_ & ~x29 & (x19 | x20 | ~x18 | ~x28);
  assign new_n233_ = ~x28 & (~new_n213_ | (new_n214_ & (x42 ? x39 : (~x39 & x40))));
  assign new_n234_ = (~x19 | (~new_n235_ & ~new_n237_)) & ~new_n236_ & (new_n238_ | ~x26);
  assign new_n235_ = x00 & ((~new_n119_ & ~x20 & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n236_ = new_n156_ & ~x29 & ~x14 & ~x27;
  assign new_n237_ = x20 & ~x27 & x28 & (~x29 | (~x00 & ~x04));
  assign new_n238_ = (((~x28 | x29) & (~x00 | x28 | ~x29)) | (~x17 & ~x19) | (~x19 & ~x20) | (x19 & x20)) & (~x00 | x19 | ~x20 | x17 | x28 | ~x29);
  assign new_n239_ = (new_n219_ | ~x29) & (new_n241_ | x29 | (~new_n240_ & ~x14 & ~x27));
  assign new_n240_ = (x18 | x19 | ~x20 | x23) & (~x13 | x28);
  assign new_n241_ = ~x18 & x28 & (~x19 | (x20 & x22));
  assign new_n242_ = (~x18 | x27 | x28 | ~x29) & (~new_n229_ | x29 | x18 | ~x22 | ~x28);
