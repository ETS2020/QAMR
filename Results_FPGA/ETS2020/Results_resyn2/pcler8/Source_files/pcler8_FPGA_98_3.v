...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n57_, new_n59_, new_n60_, new_n62_,
    new_n64_, new_n66_, new_n67_, new_n69_;
  assign z01 = x00 & x08;
  assign z03 = x02 & x08;
  assign z04 = x03 & x08;
  assign z05 = x04 & x08;
  ...
  assign z14 = z06 | (new_n53_ & (new_n64_ | (new_n62_ & x16)));
  assign new_n64_ = (x24 | (x19 & x20 & x21 & x22 & x23)) & (~x19 | ~x22 | ~x20 | ~x21 | ~x23 | ~x24);
  assign z15 = (x06 & x08) | ((~new_n66_ | new_n67_ | ~x25) & new_n53_ & (new_n66_ | x25));
  assign new_n66_ = x19 & x22 & x20 & x21 & x23 & x24;
  assign new_n67_ = x17 & x26;
  assign z16 = z08 | ((~new_n59_ | x18 | ~new_n69_ | ~x26) & new_n53_ & ((new_n69_ & new_n59_) | x26));
