// Benchmark "FAU" written by ABC on Wed Jul 29 04:34:21 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n61_, new_n63_,
    new_n65_, new_n67_, new_n68_, new_n70_;
  assign z01 = x00 & x08;
  assign z02 = x01 & x08;
  assign z03 = x02 & x08;
  assign z04 = x03 & x08;
  ...
  assign z15 = (x06 & x08) | ((~new_n67_ | new_n68_ | ~x25) & new_n54_ & (new_n67_ | x25));
  assign new_n67_ = x19 & x22 & x20 & x21 & x23 & x24;
  assign new_n68_ = x17 & x26;
  assign z16 = z08 | ((~new_n60_ | x18 | ~new_n70_ | ~x26) & new_n54_ & ((new_n70_ & new_n60_) | x26));
