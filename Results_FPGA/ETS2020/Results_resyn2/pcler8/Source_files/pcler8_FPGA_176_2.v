...
module FAU ( 
  ...
  assign z12 = z04 | ((~new_n63_ | (new_n64_ & x14)) & new_n48_ & ~new_n65_);
  assign new_n63_ = x19 & x20 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign new_n65_ = ~x22 & (~x21 | ~x19 | ~x20);
  assign z13 = z05 | ((~new_n63_ | ~x23 | (new_n49_ & x15)) & new_n48_ & (new_n63_ | x23));
  assign z14 = z06 | ((~new_n47_ | new_n68_ | ~x24) & new_n48_ & (new_n47_ | x24));
