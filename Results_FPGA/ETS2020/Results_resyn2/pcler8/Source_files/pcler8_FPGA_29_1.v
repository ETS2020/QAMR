...
module FAU ( 
  ...
  assign z12 = new_n62_ | (x03 & x08);
  assign new_n62_ = (new_n63_ | ~x21 | ~x19 | ~x20 | ~x22) & new_n48_ & ((x21 & x19 & x20) | x22);
  assign new_n63_ = x14 & x24 & x25 & x23 & x26;
  assign z14 = z06 | (~new_n65_ & new_n48_);
