...
module FAU ( 
  ...
  assign z07 = x06 & x08;
  assign z08 = x07 & x08;
  assign z09 = z01 | (new_n48_ & (~x19 | (new_n58_ & new_n59_)));
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign new_n59_ = x11 & x20 & x21 & x22;
  assign z10 = z02 | ((~x19 | ~x20 | (new_n58_ & new_n61_)) & new_n48_ & (x19 | x20));
  assign new_n61_ = x12 & x21 & x22;
  assign z11 = z03 | ((new_n63_ | ~x21 | ~x19 | ~x20) & new_n48_ & (x21 | (x19 & x20)));
  assign new_n63_ = x13 & x22 & x25 & x26 & x23 & x24;
  assign z12 = z04 | ((~new_n47_ | (new_n58_ & x14)) & new_n48_ & ~new_n65_);
