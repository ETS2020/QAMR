...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n156_, new_n172_, new_n173_, new_n181_, new_n191_, new_n192_,
  ...
  assign z43 = new_n181_ & x61 & ~x01 & ~x04;
  assign z44 = new_n181_ & x62 & ~x01 & ~x04;
  assign z45 = new_n181_ & x63 & ~x01 & ~x04;
  assign z47 = ~x01 & (new_n191_ | (new_n193_ & (x67 | x75)));
  assign new_n191_ = new_n192_ & (x07 | x52) & (x15 | ~x52);
  assign new_n192_ = ~x77 & ~x79 & x04 & x78;
  assign new_n193_ = (x81 ^ ~x84) & x79 & x77 & ~x78;
  assign z50 = ~x01 & (new_n195_ | (new_n193_ & x70));
  assign new_n195_ = new_n192_ & (x10 | x52) & (x18 | ~x52);
  assign z51 = ~x01 & (new_n197_ | (new_n193_ & x71));
  assign new_n197_ = new_n192_ & (x11 | x52) & (x19 | ~x52);
  assign z52 = ~x01 & (new_n199_ | (new_n193_ & x72));
  assign new_n199_ = new_n192_ & (x12 | x52) & (x20 | ~x52);
  assign z56 = (~new_n201_ & x79 & (~x77 | ~x78)) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n201_ = ~x76 & (x81 ^ ~x84);
  assign z57 = ~x02 & x03 & x00 & ~x01;
  assign z58 = ~x01 & ((~new_n204_ & x77) | (~x79 & (~x04 | (~x77 & x78))));
  assign new_n204_ = (~new_n207_ | ((~new_n205_ | ~new_n206_) & (x40 | ~x42))) & (~new_n208_ | ~x40 | x42);
  assign new_n205_ = ~x74 & x80 & x81 & ~x83;
  assign new_n206_ = ~x42 & x43 & x82 & x84;
  assign new_n207_ = x79 & x04 & x78;
  assign new_n208_ = ~x78 & ~x79;
  assign z61 = ~new_n210_ & new_n211_ & x80;
  assign new_n210_ = (x04 | ~x77 | ~x78) & ((~x77 & ~x78) | (x77 & x78) | (~x81 ^ ~x84));
  assign new_n211_ = ~x01 & x79;
  assign z63 = ~new_n210_ & new_n211_ & x82;
  assign z64 = ~x01 & (new_n192_ | (~new_n210_ & x79 & x83));
  assign z65 = ((x77 & x78) ? ~x04 : x81) & new_n211_ & x84 & (x77 | x78);
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z16 = 1'b0;
