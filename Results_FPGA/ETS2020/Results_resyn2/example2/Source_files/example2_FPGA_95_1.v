...
module FAU ( 
  ...
  wire new_n168_, new_n169_, new_n170_, new_n171_, new_n172_, new_n175_,
    ...
    new_n197_, new_n199_, new_n202_, new_n205_, new_n206_, new_n207_,
  ...
  assign z52 = ~x01 & (new_n199_ | (new_n195_ & (x20 | ~x52) & (x12 | x52)));
  assign new_n199_ = x72 & x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z55 = new_n178_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = new_n202_ | ~x00 | x01 | (~x77 & ~x78);
  assign new_n202_ = x79 & ((x76 & (~x77 | ~x78)) | ((~x81 | ~x84) & (x81 | x84) & (~x77 ^ ~x78)));
  assign z57 = x00 & ~x01 & ~x02 & x03;
  assign z58 = ~x01 & (new_n207_ | (~new_n205_ & x77 & (~x40 | ~x42)));
  assign new_n205_ = ~new_n206_ & (~new_n171_ | ~x79 | (~x42 & (~new_n169_ | ~new_n170_)));
  assign new_n206_ = ~x79 & x40 & ~x78;
  assign new_n207_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n209_ | new_n206_)));
  assign new_n209_ = new_n171_ & (x40 | ~x79 | (~x42 & (~new_n169_ | ~new_n170_)));
  assign z60 = ~x01 & (new_n168_ | ~new_n211_);
  assign new_n211_ = x79 ? ((x81 & x84) | (~x81 & ~x84) | (x77 ^ ~x78)) : x04;
  ...
  assign new_n215_ = x77 & (new_n216_ | (x04 & ~x42 & (~new_n169_ | ~new_n170_)));
  ...
  assign new_n221_ = (~x81 | (x77 ^ ~x78)) & ((~x77 & ~x78) | x04 | ~x77 | ~x78);
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
