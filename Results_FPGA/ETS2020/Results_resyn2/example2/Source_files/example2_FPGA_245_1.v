...
module FAU ( 
  ...
  wire new_n171_, new_n172_, new_n173_, new_n174_, new_n175_, new_n176_,
    ...
    new_n195_, new_n196_, new_n198_, new_n200_, new_n206_, new_n207_,
  ...
  assign z47 = ~x01 & (new_n195_ | (new_n196_ & (x15 | ~x52) & (x07 | x52)));
  assign new_n195_ = (x67 | x75) & x77 & ~x78 & ~new_n175_ & x79;
  assign new_n196_ = ~x77 & x78 & x04 & ~x79;
  assign z50 = ~x01 & (new_n198_ | (new_n196_ & (x18 | ~x52) & (x10 | x52)));
  assign new_n198_ = x70 & x77 & ~x78 & ~new_n175_ & x79;
  assign z52 = ~x01 & (new_n200_ | (new_n196_ & (x20 | ~x52) & (x12 | x52)));
  assign new_n200_ = x72 & x77 & ~x78 & ~new_n175_ & x79;
  ...
  assign new_n206_ = ~new_n207_ & (~new_n174_ | ~x79 | (~x42 & (~new_n172_ | ~new_n173_)));
  assign new_n207_ = ~x79 & x40 & ~x78;
  assign new_n208_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n210_ | new_n207_)));
  assign new_n210_ = new_n174_ & (x40 | ~x79 | (~x42 & (~new_n172_ | ~new_n173_)));
  assign z60 = ~x01 & (new_n171_ | ~new_n212_);
  assign new_n212_ = x79 ? (~new_n175_ | (x77 ^ ~x78)) : x04;
  assign z61 = ~new_n214_ & x80 & ~x01 & x79;
  assign new_n214_ = (x04 | ~x77 | ~x78) & (new_n175_ | (x77 ^ ~x78));
  assign z62 = ~x01 & (new_n218_ | (x78 & (new_n216_ | (x04 & ~x79))));
  assign new_n216_ = x77 & (new_n217_ | (x04 & ~x42 & (~new_n172_ | ~new_n173_)));
