...
module FAU ( 
  ...
  wire new_n173_, new_n174_, new_n175_, new_n176_, new_n177_, new_n180_,
    new_n182_, new_n183_, new_n185_, new_n187_, new_n200_, new_n201_,
    new_n202_, new_n204_, new_n206_, new_n208_, new_n210_, new_n212_,
    new_n216_, new_n219_, new_n220_, new_n221_, new_n223_, new_n225_,
    new_n227_, new_n229_, new_n230_, new_n231_, new_n235_;
  ...
  assign z52 = ~x01 & (new_n210_ | (new_n202_ & x72));
  assign new_n210_ = new_n201_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n212_ | (new_n202_ & x73));
  assign new_n212_ = new_n201_ & (x21 | ~x52) & (x13 | x52);
  assign z54 = new_n201_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n183_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = new_n216_ | ~x00 | x01 | (~x77 & ~x78);
  assign new_n216_ = x79 & ((x76 & (~x77 | ~x78)) | ((~x81 | ~x84) & (x81 | x84) & (~x77 ^ ~x78)));
  assign z57 = x00 & ~x01 & ~x02 & x03;
  assign z58 = ~x01 & (new_n221_ | (~new_n219_ & x77 & (~x40 | ~x42)));
  assign new_n219_ = ~new_n220_ & (~new_n176_ | ~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n220_ = ~x79 & x40 & ~x78;
  assign new_n221_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n223_ | new_n220_)));
  assign new_n223_ = new_n176_ & (x40 | ~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign z60 = ~x01 & (new_n173_ | ~new_n225_);
  assign new_n225_ = x79 ? ((x81 & x84) | (~x81 & ~x84) | (x77 ^ ~x78)) : x04;
  assign z61 = ~new_n227_ & x80 & ~x01 & x79;
  assign new_n227_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z62 = ~x01 & (new_n231_ | (x78 & (new_n229_ | (x04 & ~x79))));
  assign new_n229_ = x77 & (new_n230_ | (x04 & ~x42 & (~new_n174_ | ~new_n175_)));
  ...
  assign new_n235_ = (~x81 | (x77 ^ ~x78)) & ((~x77 & ~x78) | x04 | ~x77 | ~x78);
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z21 = 1'b0;
  assign z26 = 1'b0;
