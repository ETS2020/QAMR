...
module FAU ( 
  ...
  assign z50 = ~x01 & (new_n199_ | (new_n197_ & x70));
  assign new_n199_ = new_n196_ & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (new_n201_ | (new_n197_ & x71));
  assign new_n201_ = new_n196_ & (x19 | ~x52) & (x11 | x52);
  ...
  assign new_n210_ = ~new_n211_ & (~new_n170_ | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n211_ = ~x79 & x40 & ~x78;
  assign new_n212_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n214_ | new_n211_)));
  assign new_n214_ = new_n170_ & (x40 | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign z60 = ~x01 & (new_n167_ | new_n216_);
  assign new_n216_ = (~x79 | (x77 & ~x78) | (~x77 & x78)) & (~x04 | x79) & (~x79 | (x81 ^ x84));
  assign z62 = ~x01 & (new_n220_ | (x78 & (new_n218_ | (x04 & ~x79))));
  assign new_n218_ = x77 & (new_n219_ | (x04 & ~x42 & (~new_n168_ | ~new_n169_)));
