...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n178_, new_n181_,
    ...
    new_n209_, new_n211_, new_n213_, new_n215_, new_n220_, new_n221_,
  ...
  assign new_n175_ = x84 & x82 & ~x83;
  assign new_n176_ = x43 & ~x74 & x80 & x81;
  ...
  assign z49 = ~x01 & (new_n209_ | (new_n207_ & x69));
  assign new_n209_ = new_n206_ & (x17 | ~x52) & (x09 | x52);
  assign z51 = ~x01 & (new_n211_ | (new_n207_ & x71));
  assign new_n211_ = new_n206_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (new_n213_ | (new_n207_ & x72));
  assign new_n213_ = new_n206_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n215_ | (new_n207_ & x73));
  assign new_n215_ = new_n206_ & (x21 | ~x52) & (x13 | x52);
  assign z54 = new_n206_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n181_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z57 = x00 & ~x01 & ~x02 & x03;
  assign z59 = new_n221_ & (~x79 | (new_n177_ & (new_n220_ | x40)));
  assign new_n220_ = ~x42 & (~new_n175_ | ~new_n176_);
  assign new_n221_ = ~x01 & (~x04 | (x77 & (x40 | x78)));
  assign z60 = ~x01 & (new_n174_ | ~new_n223_);
  assign new_n223_ = (x04 | x79) & (~x79 | (~x77 ^ x78) | (x81 & x84) | (~x81 & ~x84));
  assign z61 = ~new_n225_ & x80 & ~x01 & x79;
  assign new_n225_ = ((~x77 ^ x78) | (~x81 ^ ~x84)) & (~x78 | x04 | ~x77);
  assign z62 = ~x01 & (new_n228_ | (new_n230_ & (~new_n229_ | (~new_n227_ & x04))));
  assign new_n227_ = x79 & (x42 | (new_n175_ & new_n176_));
  assign new_n228_ = x77 & ~x78 & x79 & x81 & x84;
  assign new_n229_ = x77 & (~x81 | x04 | ~x79);
  assign new_n230_ = x78 & ((x79 & x81 & x84) | x77 | (x04 & ~x79));
  assign z63 = ~new_n225_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & (new_n206_ | (~new_n225_ & x79 & x83));
