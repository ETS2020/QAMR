...
module FAU ( 
  ...
  assign new_n220_ = ~new_n221_ & (~new_n178_ | ~x79 | (~x42 & (~new_n176_ | ~new_n177_)));
  assign new_n221_ = ~x79 & x40 & ~x78;
  assign new_n222_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n224_ | new_n221_)));
  assign new_n224_ = new_n178_ & (x40 | ~x79 | (~x42 & (~new_n176_ | ~new_n177_)));
  assign z60 = ~x01 & (new_n175_ | ~new_n226_);
  ...
  assign new_n230_ = x77 & (new_n231_ | (x04 & ~x42 & (~new_n176_ | ~new_n177_)));
