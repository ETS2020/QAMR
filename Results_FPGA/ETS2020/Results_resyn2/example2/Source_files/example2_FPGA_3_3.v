...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n178_, new_n181_,
    ...
    new_n208_, new_n210_, new_n212_, new_n214_, new_n219_, new_n220_,
    new_n221_, new_n223_, new_n225_, new_n227_, new_n229_, new_n230_,
    new_n231_, new_n235_;
  ...
  assign z49 = ~x01 & (new_n208_ | (new_n206_ & x69));
  assign new_n208_ = new_n205_ & (x17 | ~x52) & (x09 | x52);
  assign z51 = ~x01 & (new_n210_ | (new_n206_ & x71));
  assign new_n210_ = new_n205_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (new_n212_ | (new_n206_ & x72));
  assign new_n212_ = new_n205_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n214_ | (new_n206_ & x73));
  assign new_n214_ = new_n205_ & (x21 | ~x52) & (x13 | x52);
  ...
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n223_ | new_n220_)));
  ...
  assign z64 = ~x01 & (new_n205_ | (~new_n227_ & x79 & x83));
