...
module FAU ( 
  ...
  wire new_n154_, new_n156_, new_n167_, new_n168_, new_n169_, new_n170_,
    ...
    new_n198_, new_n200_, new_n202_, new_n205_, new_n208_, new_n209_,
  ...
  assign new_n205_ = (~x76 | (x77 & x78)) & (x01 | (x81 & x84) | (~x81 & ~x84) | (~x77 ^ x78));
  ...
  assign new_n220_ = (x04 | ~x77 | ~x78) & (~x81 | (x77 ^ ~x78));
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
