// Benchmark "FAU" written by ABC on Wed Jul 29 08:49:53 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n156_, new_n170_, new_n171_, new_n172_, new_n173_,
    ...
    new_n200_, new_n202_, new_n204_, new_n206_, new_n208_, new_n212_,
  ...
  assign z34 = new_n189_ & new_n177_ & x52;
  ...
  assign z39 = new_n189_ & new_n177_ & x57;
  ...
  assign z51 = ~x01 & (new_n206_ | (new_n200_ & x71));
  assign new_n206_ = new_n199_ & (x19 | ~x52) & (x11 | x52);
  assign z53 = ~x01 & (new_n208_ | (new_n200_ & x73));
  assign new_n208_ = new_n199_ & (x21 | ~x52) & (x13 | x52);
  ...
  assign new_n215_ = ~new_n216_ & (~new_n173_ | ~x79 | (~x42 & (~new_n171_ | ~new_n172_)));
  assign new_n216_ = ~x79 & x40 & ~x78;
  assign new_n217_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n219_ | new_n216_)));
  assign new_n219_ = new_n173_ & (x40 | ~x79 | (~x42 & (~new_n171_ | ~new_n172_)));
  assign z60 = ~x01 & (new_n170_ | new_n221_);
  assign new_n221_ = (~x79 | (x77 & ~x78) | (~x77 & x78)) & (~x04 | x79) & (~x79 | (x81 ^ x84));
  assign z62 = ~x01 & (new_n225_ | (x78 & (new_n223_ | (x04 & ~x79))));
  assign new_n223_ = x77 & (new_n224_ | (x04 & ~x42 & (~new_n171_ | ~new_n172_)));
