...
module FAU ( 
  ...
  assign new_n209_ = ~new_n210_ & (~new_n170_ | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n210_ = ~x79 & x40 & ~x78;
  assign new_n211_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n213_ | new_n210_)));
  assign new_n213_ = new_n170_ & (x40 | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign z60 = ~x01 & (new_n167_ | new_n215_);
  assign new_n215_ = (~x79 | (x77 & ~x78) | (~x77 & x78)) & (~x79 | (x81 ^ x84)) & (~x04 | x79);
  assign z62 = ~x01 & (new_n219_ | (x78 & (new_n217_ | (x04 & ~x79))));
  assign new_n217_ = x77 & (new_n218_ | (x04 & ~x42 & (~new_n168_ | ~new_n169_)));
