...
module FAU ( 
  ...
  wire new_n173_, new_n174_, new_n175_, new_n176_, new_n177_, new_n180_,
    ...
    new_n225_, new_n227_, new_n228_, new_n229_;
  ...
  assign z52 = ~x01 & (new_n208_ | (new_n200_ & x72));
  assign new_n208_ = new_n199_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n210_ | (new_n200_ & x73));
  assign new_n210_ = new_n199_ & (x21 | ~x52) & (x13 | x52);
  assign z54 = new_n199_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n183_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = new_n214_ | ~x00 | x01 | (~x77 & ~x78);
  assign new_n214_ = x79 & ((x76 & (~x77 | ~x78)) | ((x77 ^ x78) & (~x81 | ~x84) & (x81 | x84)));
  assign z57 = x00 & ~x01 & ~x02 & x03;
  assign z58 = ~x01 & (new_n219_ | (~new_n217_ & x77 & (~x40 | ~x42)));
  assign new_n217_ = ~new_n218_ & (~new_n176_ | ~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n218_ = ~x79 & x40 & ~x78;
  assign new_n219_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n221_ | new_n218_)));
  assign new_n221_ = new_n176_ & (x40 | ~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign z60 = ~x01 & (new_n173_ | ~new_n223_);
  assign new_n223_ = x79 ? ((~x77 ^ x78) | (x81 & x84) | (~x81 & ~x84)) : x04;
  assign z61 = new_n225_ & x80 & ~x01 & x79;
  assign new_n225_ = (~x77 ^ x78) ? (~x04 & x77) : (x81 ^ ~x84);
  assign z62 = ~x01 & (new_n229_ | (x78 & (new_n227_ | (x04 & ~x79))));
  assign new_n227_ = x77 & (new_n228_ | (x04 & ~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n228_ = x81 & ~x04 & x79;
  assign new_n229_ = x81 & x84 & x79 & (x77 ^ x78);
  assign z63 = new_n225_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & (new_n199_ | (new_n225_ & x79 & x83));
  assign z07 = 1'b0;
  assign z09 = 1'b0;
  assign z13 = 1'b0;
  assign z26 = 1'b0;
