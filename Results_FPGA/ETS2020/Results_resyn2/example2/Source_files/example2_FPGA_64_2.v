...
module FAU ( 
  ...
  wire new_n172_, new_n174_, new_n175_, new_n183_, new_n195_, new_n196_,
    ...
    new_n209_, new_n212_, new_n214_, new_n216_, new_n220_;
  ...
  assign new_n195_ = (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign new_n196_ = x78 & ~x79 & x04 & ~x77;
  assign new_n197_ = x52 ? x15 : x07;
  assign z48 = ~x01 & (new_n199_ | (new_n196_ & (x16 | ~x52) & (x08 | x52)));
  assign new_n199_ = x68 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z49 = ~x01 & (new_n201_ | (new_n196_ & (x17 | ~x52) & (x09 | x52)));
  assign new_n201_ = x69 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z50 = ~x01 & (new_n203_ | (new_n196_ & (x18 | ~x52) & (x10 | x52)));
  assign new_n203_ = x70 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z51 = ~x01 & (new_n205_ | (new_n196_ & (x19 | ~x52) & (x11 | x52)));
  assign new_n205_ = x71 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z52 = ~x01 & (new_n207_ | (new_n196_ & (x20 | ~x52) & (x12 | x52)));
  assign new_n207_ = x72 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z53 = ~x01 & (new_n209_ | (new_n196_ & (x21 | ~x52) & (x13 | x52)));
  assign new_n209_ = x73 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z54 = new_n196_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n212_ & x77 & x78 & ~x80 & ~x82;
  assign new_n212_ = x79 & x83 & ~x01 & ~x04 & ~x81 & x84;
  assign z56 = (~new_n214_ & x79 & (~x77 | ~x78)) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n214_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z61 = ~new_n216_ & x80 & ~x01 & x79;
  assign new_n216_ = ((~x81 & x84) | (x81 & ~x84) | (~x77 & ~x78) | (x77 & x78)) & (x04 | ~x77 | ~x78);
