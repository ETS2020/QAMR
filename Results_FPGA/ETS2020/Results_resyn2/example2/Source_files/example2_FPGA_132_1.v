...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n178_, new_n180_,
    ...
    new_n202_, new_n204_, new_n208_, new_n211_, new_n212_, new_n213_,
  ...
  assign new_n211_ = ~new_n212_ & (~new_n177_ | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign new_n212_ = ~x79 & x40 & ~x78;
  assign new_n213_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n215_ | new_n212_)));
  assign new_n215_ = new_n177_ & (x40 | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign z60 = ~x01 & (new_n174_ | ~new_n217_);
  ...
  assign new_n221_ = x77 & (new_n222_ | (x04 & ~x42 & (~new_n175_ | ~new_n176_)));
  assign new_n222_ = x81 & ~x04 & x79;
  assign new_n223_ = (x77 ^ x78) & x79 & x81 & x84;
  assign z63 = ~new_n219_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & (new_n200_ | (~new_n219_ & x79 & x83));
