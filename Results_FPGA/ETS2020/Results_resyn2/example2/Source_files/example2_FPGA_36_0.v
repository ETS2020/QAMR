...
module FAU ( 
  ...
  wire new_n154_, new_n156_, new_n167_, new_n168_, new_n169_, new_n170_,
    new_n174_, new_n175_, new_n184_, new_n186_, new_n193_, new_n194_,
  ...
  assign new_n205_ = ~new_n206_ & (~new_n170_ | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n206_ = ~x79 & x40 & ~x78;
  assign new_n207_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n209_ | new_n206_)));
  assign new_n209_ = new_n170_ & (x40 | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign z60 = ~x01 & (new_n167_ | new_n211_);
  assign new_n211_ = (~x79 | (x77 & ~x78) | (~x77 & x78)) & (~x79 | (x81 ^ x84)) & (~x04 | x79);
  assign z62 = ~x01 & (new_n215_ | (x78 & (new_n213_ | (x04 & ~x79))));
  assign new_n213_ = x77 & (new_n214_ | (x04 & ~x42 & (~new_n168_ | ~new_n169_)));
