// Benchmark "FAU" written by ABC on Wed Jul 29 08:49:05 2020
...
module FAU ( 
  ...
  assign z33 = new_n174_ & ~new_n183_;
  assign new_n183_ = ((new_n175_ & (~x81 | x83) & (x81 | ~x83)) | (~new_n175_ & (~x81 ^ ~x83)) | ~x05 | ~x42) & (x42 | ~x51 | (~new_n175_ ^ ~x81));
  assign z35 = new_n185_ & new_n174_ & x53;
  assign new_n185_ = (~new_n175_ ^ x81) ^ (x42 & x83);
  assign z37 = new_n185_ & new_n174_ & x55;
  assign z38 = new_n185_ & new_n174_ & x56;
  assign z39 = new_n185_ & new_n174_ & x57;
  assign z41 = new_n185_ & new_n174_ & x59;
  assign z42 = new_n185_ & new_n174_ & x60;
  assign z43 = new_n185_ & new_n174_ & x61;
  assign z46 = new_n185_ & new_n174_ & x64;
  ...
  assign z56 = (~new_n210_ & x79) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n210_ = (~x76 | (x77 & x78)) & (x01 | (x81 & x84) | (~x81 & ~x84) | (~x77 ^ x78));
  ...
  assign new_n225_ = (x04 | ~x77 | ~x78) & (~x81 | (x77 ^ ~x78));
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
