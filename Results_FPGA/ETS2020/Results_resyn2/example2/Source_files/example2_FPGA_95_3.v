...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n178_, new_n181_,
    ...
    new_n235_, new_n236_, new_n237_, new_n241_;
  ...
  assign z50 = ~x01 & (new_n214_ | (new_n208_ & x70));
  assign new_n214_ = new_n207_ & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (new_n216_ | (new_n208_ & x71));
  assign new_n216_ = new_n207_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (new_n218_ | (new_n208_ & x72));
  assign new_n218_ = new_n207_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n220_ | (new_n208_ & x73));
  assign new_n220_ = new_n207_ & (x21 | ~x52) & (x13 | x52);
  assign z54 = new_n207_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n181_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z57 = x00 & ~x01 & ~x02 & x03;
  assign z58 = ~x01 & (new_n227_ | (~new_n225_ & x77 & (~x40 | ~x42)));
  assign new_n225_ = ~new_n226_ & (~new_n177_ | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign new_n226_ = ~x79 & x40 & ~x78;
  assign new_n227_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n229_ | new_n226_)));
  assign new_n229_ = new_n177_ & (x40 | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign z60 = ~x01 & (new_n174_ | ~new_n231_);
  assign new_n231_ = (x04 | x79) & (~x79 | (~x77 ^ x78) | (x81 & x84) | (~x81 & ~x84));
  assign z61 = ~new_n233_ & x80 & ~x01 & x79;
  assign new_n233_ = ((~x77 ^ x78) | (~x81 ^ ~x84)) & (~x78 | x04 | ~x77);
  assign z62 = ~x01 & (new_n237_ | (x78 & (new_n235_ | (x04 & ~x79))));
  assign new_n235_ = x77 & (new_n236_ | (x04 & ~x42 & (~new_n175_ | ~new_n176_)));
  assign new_n236_ = x81 & ~x04 & x79;
  assign new_n237_ = x81 & x84 & x79 & (x77 ^ x78);
  assign z63 = ~new_n233_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & (new_n207_ | (~new_n233_ & x79 & x83));
  assign z65 = ~new_n241_ & x84 & ~x01 & x79;
  assign new_n241_ = (~x81 | (~x77 ^ x78)) & (~x78 | x04 | ~x77);
  assign z19 = 1'b0;
  assign z20 = 1'b0;
  assign z24 = 1'b0;
  assign z37 = 1'b0;
