...
module FAU ( 
  ...
  assign z23 = ~new_n178_ | (x05 & ~x04 & ~x79);
  ...
  assign z56 = (x79 & ((x76 & (~x77 | ~x78)) | (new_n175_ & (x77 ^ x78)))) | ~new_n178_ | (~x77 & ~x78);
  assign z57 = new_n178_ & ~x02 & x03;
  ...
  assign new_n215_ = x79 ? (~new_n175_ | (x77 ^ ~x78)) : x04;
  assign z61 = ~new_n217_ & x80 & ~x01 & x79;
  assign new_n217_ = (x04 | ~x77 | ~x78) & (new_n175_ | (x77 ^ ~x78));
