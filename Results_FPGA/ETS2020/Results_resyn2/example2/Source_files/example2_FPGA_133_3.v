...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n178_, new_n181_,
    new_n182_, new_n191_, new_n193_, new_n202_, new_n203_, new_n204_,
  ...
  assign new_n181_ = x77 & x78 & ~x04 & ~x01 & x79;
  ...
  assign new_n191_ = ((new_n182_ & (~x81 | x83) & (x81 | ~x83)) | ~x05 | ~x42 | (~new_n182_ & (~x81 ^ ~x83))) & (x42 | ~x51 | (~new_n182_ ^ ~x81));
