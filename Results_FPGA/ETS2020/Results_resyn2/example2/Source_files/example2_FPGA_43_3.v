...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n178_, new_n181_,
    new_n182_, new_n191_, new_n193_, new_n207_, new_n208_, new_n209_,
    new_n211_, new_n213_, new_n215_, new_n217_, new_n219_, new_n224_,
    new_n225_, new_n226_, new_n228_, new_n230_, new_n232_, new_n234_,
    new_n235_, new_n236_, new_n240_;
  ...
  assign z46 = ~new_n193_ & new_n181_ & x64;
  assign z47 = ~x01 & (new_n207_ | (new_n209_ & (x67 | x75)));
  assign new_n207_ = new_n208_ & (x15 | ~x52) & (x07 | x52);
  assign new_n208_ = ~x77 & x78 & x04 & ~x79;
  assign new_n209_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z48 = ~x01 & (new_n211_ | (new_n209_ & x68));
  assign new_n211_ = new_n208_ & (x16 | ~x52) & (x08 | x52);
  assign z49 = ~x01 & (new_n213_ | (new_n209_ & x69));
  assign new_n213_ = new_n208_ & (x17 | ~x52) & (x09 | x52);
  assign z51 = ~x01 & (new_n215_ | (new_n209_ & x71));
  assign new_n215_ = new_n208_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (new_n217_ | (new_n209_ & x72));
  assign new_n217_ = new_n208_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n219_ | (new_n209_ & x73));
  assign new_n219_ = new_n208_ & (x21 | ~x52) & (x13 | x52);
  ...
  assign new_n224_ = ~new_n225_ & (~new_n177_ | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign new_n225_ = ~x79 & x40 & ~x78;
  assign new_n226_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n228_ | new_n225_)));
  assign new_n228_ = new_n177_ & (x40 | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign z60 = ~x01 & (new_n174_ | ~new_n230_);
  ...
  assign new_n234_ = x77 & (new_n235_ | (x04 & ~x42 & (~new_n175_ | ~new_n176_)));
