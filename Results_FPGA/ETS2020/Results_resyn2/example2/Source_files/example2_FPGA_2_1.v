...
module FAU ( 
  ...
  wire new_n173_, new_n174_, new_n175_, new_n176_, new_n177_, new_n180_,
    ...
    new_n202_, new_n204_, new_n206_, new_n208_, new_n211_, new_n214_,
  ...
  assign z48 = ~x01 & (new_n199_ | (new_n200_ & (x16 | ~x52) & (x08 | x52)));
  assign new_n199_ = x68 & x77 & ~x78 & x79 & (~x81 ^ x84);
  assign new_n200_ = ~x77 & x78 & x04 & ~x79;
  assign z49 = ~x01 & (new_n202_ | (new_n200_ & (x17 | ~x52) & (x09 | x52)));
  assign new_n202_ = x69 & x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z50 = ~x01 & (new_n204_ | (new_n200_ & (x18 | ~x52) & (x10 | x52)));
  assign new_n204_ = x70 & x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z51 = ~x01 & (new_n206_ | (new_n200_ & (x19 | ~x52) & (x11 | x52)));
  assign new_n206_ = x71 & x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z52 = ~x01 & (new_n208_ | (new_n200_ & (x20 | ~x52) & (x12 | x52)));
  assign new_n208_ = x72 & x77 & ~x78 & x79 & (~x81 ^ x84);
  ...
  assign new_n222_ = (x04 | ~x77 | ~x78) & ((x77 ^ ~x78) | (~x81 ^ ~x84));
