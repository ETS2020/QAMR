...
module FAU ( 
  ...
  assign new_n210_ = ~new_n211_ & (~new_n171_ | ~x79 | (~x42 & (~new_n169_ | ~new_n170_)));
  assign new_n211_ = ~x79 & x40 & ~x78;
  assign new_n212_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n214_ | new_n211_)));
  assign new_n214_ = new_n171_ & (x40 | ~x79 | (~x42 & (~new_n169_ | ~new_n170_)));
  assign z60 = ~x01 & (new_n168_ | ~new_n216_);
