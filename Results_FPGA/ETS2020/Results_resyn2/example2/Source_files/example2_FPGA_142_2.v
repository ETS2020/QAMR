...
module FAU ( 
  ...
  assign z49 = ~x01 & (new_n198_ | (new_n195_ & (x17 | ~x52) & (x09 | x52)));
  assign new_n198_ = x69 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z50 = ~x01 & (new_n200_ | (new_n195_ & (x18 | ~x52) & (x10 | x52)));
  assign new_n200_ = x70 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z51 = ~x01 & (new_n202_ | (new_n195_ & (x19 | ~x52) & (x11 | x52)));
  assign new_n202_ = x71 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z52 = ~x01 & (new_n204_ | (new_n195_ & (x20 | ~x52) & (x12 | x52)));
  assign new_n204_ = x72 & (x81 | ~x84) & (~x81 | x84) & x79 & x77 & ~x78;
  assign z54 = new_n195_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n207_ & x77 & x78 & ~x80 & ~x82;
  assign new_n207_ = x79 & x83 & ~x01 & ~x04 & ~x81 & x84;
  assign z56 = (~new_n209_ & x79 & (~x77 | ~x78)) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n209_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z61 = ~new_n211_ & x80 & ~x01 & x79;
  assign new_n211_ = ((~x81 & x84) | (x81 & ~x84) | (~x77 & ~x78) | (x77 & x78)) & (x04 | ~x77 | ~x78);
