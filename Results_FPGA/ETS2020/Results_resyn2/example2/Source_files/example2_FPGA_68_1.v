// Benchmark "FAU" written by ABC on Wed Jul 29 08:49:00 2020
...
module FAU ( 
  ...
  assign z35 = new_n187_ & new_n183_ & x53;
  ...
  assign z49 = ~x01 & (new_n204_ | (new_n200_ & x69));
  assign new_n204_ = new_n199_ & (x17 | ~x52) & (x09 | x52);
  assign z50 = ~x01 & (new_n206_ | (new_n200_ & x70));
  assign new_n206_ = new_n199_ & (x18 | ~x52) & (x10 | x52);
  assign z55 = new_n183_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = new_n209_ | ~x00 | x01 | (~x77 & ~x78);
  assign new_n209_ = x79 & ((x76 & (~x77 | ~x78)) | ((~x81 | ~x84) & (x81 | x84) & (~x77 ^ ~x78)));
  assign z57 = x00 & ~x01 & ~x02 & x03;
  assign z58 = ~x01 & (new_n214_ | (~new_n212_ & x77 & (~x40 | ~x42)));
  assign new_n212_ = ~new_n213_ & (~new_n176_ | ~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n213_ = ~x79 & x40 & ~x78;
  assign new_n214_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n216_ | new_n213_)));
  assign new_n216_ = new_n176_ & (x40 | ~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign z60 = ~x01 & (new_n173_ | ~new_n218_);
  assign new_n218_ = x79 ? ((x81 & x84) | (~x81 & ~x84) | (x77 ^ ~x78)) : x04;
  assign z61 = ~new_n220_ & x80 & ~x01 & x79;
  assign new_n220_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z62 = ~x01 & (new_n224_ | (x78 & (new_n222_ | (x04 & ~x79))));
  assign new_n222_ = x77 & (new_n223_ | (x04 & ~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n223_ = x81 & ~x04 & x79;
  assign new_n224_ = (x77 ^ x78) & x79 & x81 & x84;
  assign z63 = ~new_n220_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & (new_n199_ | (~new_n220_ & x79 & x83));
  assign z65 = ~new_n228_ & x84 & ~x01 & x79;
  assign new_n228_ = (~x81 | (x77 ^ ~x78)) & ((~x77 & ~x78) | x04 | ~x77 | ~x78);
  assign z07 = 1'b0;
  assign z08 = 1'b0;
  assign z13 = 1'b0;
  assign z26 = 1'b0;
