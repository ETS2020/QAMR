...
module FAU ( 
  ...
  wire new_n157_, new_n174_, new_n175_, new_n176_, new_n177_, new_n178_,
    new_n180_, new_n182_, new_n183_, new_n185_, new_n187_, new_n198_,
  ...
  assign z22 = ~x01 & (new_n174_ | (~new_n157_ & ~new_n178_ & ~x41 & x79));
  ...
  assign new_n185_ = ((new_n182_ & (x81 | ~x83) & (~x81 | x83)) | ~x05 | ~x42 | (~new_n182_ & (x81 ^ x83))) & (x42 | ~x51 | (~new_n182_ ^ ~x81));
  ...
  assign z47 = ~x01 & (new_n199_ | (new_n198_ & (x67 | x75)));
  assign new_n198_ = ~new_n178_ & x79 & x77 & ~x78;
  assign new_n199_ = new_n200_ & (x15 | ~x52) & (x07 | x52);
  assign new_n200_ = x78 & ~x79 & x04 & ~x77;
  assign z49 = ~x01 & (new_n202_ | (new_n198_ & x69));
  assign new_n202_ = new_n200_ & (x17 | ~x52) & (x09 | x52);
  assign z50 = ~x01 & (new_n204_ | (new_n198_ & x70));
  assign new_n204_ = new_n200_ & (x18 | ~x52) & (x10 | x52);
  assign z52 = ~x01 & (new_n206_ | (new_n198_ & x72));
  assign new_n206_ = new_n200_ & (x20 | ~x52) & (x12 | x52);
  assign z54 = new_n200_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n183_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = (x79 & ((x76 & (~x77 | ~x78)) | (new_n178_ & (x77 ^ x78)))) | ~new_n210_ | (~x77 & ~x78);
  assign new_n210_ = x00 & ~x01;
  assign z57 = new_n210_ & ~x02 & x03;
  assign z58 = ~x01 & ((~new_n213_ & x77) | (~x79 & (~x04 | (~x77 & x78))));
  assign new_n213_ = ~new_n215_ & (~new_n214_ | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign new_n214_ = (~x40 | ~x42) & x04 & x78;
  assign new_n215_ = x40 & ~x42 & ~x78 & ~x79;
  assign z59 = ~x01 & ((~x04 & ~x79) | (~new_n217_ & x77));
  assign new_n217_ = ~new_n218_ & (~new_n177_ | (x79 & (x42 | (new_n175_ & new_n176_))));
  assign new_n218_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & (new_n174_ | ~new_n220_);
  assign new_n220_ = x79 ? (~new_n178_ | (x77 ^ ~x78)) : x04;
  assign z61 = new_n222_ & x80 & ~x01 & x79;
  assign new_n222_ = (x77 ^ ~x78) ? (~x04 & x77) : ~new_n178_;
