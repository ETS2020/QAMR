// Benchmark "FAU" written by ABC on Wed Jul 29 08:48:33 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n156_, new_n167_, new_n168_, new_n169_, new_n170_,
    ...
    new_n199_, new_n201_, new_n204_, new_n207_, new_n208_, new_n209_,
    new_n211_, new_n213_, new_n215_, new_n216_, new_n217_;
  ...
  assign new_n207_ = ~new_n208_ & (~new_n170_ | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n208_ = ~x79 & x40 & ~x78;
  assign new_n209_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n211_ | new_n208_)));
  assign new_n211_ = new_n170_ & (x40 | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign z60 = ~x01 & (new_n167_ | new_n213_);
  assign new_n213_ = (~x79 | (x77 & ~x78) | (~x77 & x78)) & (~x79 | (x81 ^ x84)) & (~x04 | x79);
  assign z62 = ~x01 & (new_n217_ | (x78 & (new_n215_ | (x04 & ~x79))));
  assign new_n215_ = x77 & (new_n216_ | (x04 & ~x42 & (~new_n168_ | ~new_n169_)));
