// Benchmark "FAU" written by ABC on Wed Jul 29 08:49:19 2020
...
module FAU ( 
  ...
  wire new_n170_, new_n171_, new_n172_, new_n173_, new_n174_, new_n175_,
    ...
    new_n197_, new_n198_, new_n200_, new_n202_, new_n206_, new_n208_,
  ...
  assign z22 = ~x01 & (new_n170_ | (~new_n174_ & ~new_n175_ & ~x41 & x79));
  ...
  assign new_n174_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  ...
  assign z31 = ~x42 & x49 & new_n180_ & (new_n179_ ^ ~x81);
  ...
  assign z38 = new_n186_ & new_n180_ & x56;
  ...
  assign z47 = ~x01 & (new_n197_ | (new_n198_ & (x15 | ~x52) & (x07 | x52)));
  assign new_n197_ = (x67 | x75) & ~new_n175_ & x79 & x77 & ~x78;
  assign new_n198_ = ~x77 & x78 & x04 & ~x79;
  assign z50 = ~x01 & (new_n200_ | (new_n198_ & (x18 | ~x52) & (x10 | x52)));
  assign new_n200_ = x70 & ~new_n175_ & x77 & ~x78 & x79;
  assign z52 = ~x01 & (new_n202_ | (new_n198_ & (x20 | ~x52) & (x12 | x52)));
  assign new_n202_ = x72 & ~new_n175_ & x77 & ~x78 & x79;
  assign z54 = new_n198_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n180_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = (x79 & ((x76 & (~x77 | ~x78)) | (new_n175_ & (~x77 ^ ~x78)))) | ~new_n206_ | (~x77 & ~x78);
  assign new_n206_ = x00 & ~x01;
  assign z58 = ~x01 & (new_n210_ | (~new_n208_ & x77 & (~x40 | ~x42)));
  assign new_n208_ = ~new_n209_ & (~new_n173_ | ~x79 | (~x42 & (~new_n171_ | ~new_n172_)));
  assign new_n209_ = ~x79 & x40 & ~x78;
  assign new_n210_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | ((new_n212_ | new_n209_) & x77));
  assign new_n212_ = new_n173_ & (x40 | ~x79 | (~x42 & (~new_n171_ | ~new_n172_)));
  assign z60 = ~x01 & (new_n170_ | ~new_n214_);
  ...
  assign new_n218_ = x77 & (new_n219_ | (x04 & ~x42 & (~new_n171_ | ~new_n172_)));
