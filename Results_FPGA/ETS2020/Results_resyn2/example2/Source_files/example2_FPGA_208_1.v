...
module FAU ( 
  ...
  assign new_n214_ = ~new_n215_ & (~new_n174_ | ~x79 | (~x42 & (~new_n172_ | ~new_n173_)));
  assign new_n215_ = ~x79 & x40 & ~x78;
  assign new_n216_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((x77 & (new_n218_ | new_n215_)) | (~x04 & ~x79));
  assign new_n218_ = new_n174_ & (x40 | ~x79 | (~x42 & (~new_n172_ | ~new_n173_)));
  assign z60 = ~x01 & (new_n171_ | ~new_n220_);
  ...
  assign new_n224_ = x77 & (new_n225_ | (x04 & ~x42 & (~new_n172_ | ~new_n173_)));
  assign new_n225_ = x81 & ~x04 & x79;
  assign new_n226_ = (x77 ^ x78) & x79 & x81 & x84;
  assign z63 = ~new_n222_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & (new_n196_ | (~new_n222_ & x79 & x83));
