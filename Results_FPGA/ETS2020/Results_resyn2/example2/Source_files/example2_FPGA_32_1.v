...
module FAU ( 
  ...
  assign z50 = ~x01 & (new_n201_ | (new_n199_ & x70));
  assign new_n201_ = new_n198_ & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (new_n203_ | (new_n199_ & x71));
  assign new_n203_ = new_n198_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (new_n205_ | (new_n199_ & x72));
  assign new_n205_ = new_n198_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n207_ | (new_n199_ & x73));
  assign new_n207_ = new_n198_ & (x21 | ~x52) & (x13 | x52);
