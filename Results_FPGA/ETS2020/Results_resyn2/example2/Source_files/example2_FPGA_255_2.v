...
module FAU ( 
  ...
  assign new_n194_ = x79 & (x81 ^ ~x84) & x77 & ~x78;
  assign z49 = ~x01 & (new_n196_ | (new_n194_ & x69));
  assign new_n196_ = new_n193_ & (x09 | x52) & (x17 | ~x52);
  assign z50 = ~x01 & (new_n198_ | (new_n194_ & x70));
  assign new_n198_ = new_n193_ & (x10 | x52) & (x18 | ~x52);
  assign z51 = ~x01 & (new_n200_ | (new_n194_ & x71));
  assign new_n200_ = new_n193_ & (x11 | x52) & (x19 | ~x52);
  assign z52 = ~x01 & (new_n202_ | (new_n194_ & x72));
  assign new_n202_ = new_n193_ & (x12 | x52) & (x20 | ~x52);
  assign z54 = new_n193_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z56 = (~new_n205_ & x79 & (~x77 | ~x78)) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n205_ = ~x76 & (x81 ^ ~x84);
  assign z60 = ~x01 & (new_n209_ | ((new_n207_ | ~x79) & x04 & x78));
  assign new_n207_ = (~new_n208_ | x83 | ~x80 | ~x81) & ~x42 & x77;
  assign new_n208_ = x43 & ~x74 & x82 & x84;
  assign new_n209_ = (~x79 | (~x81 ^ ~x84)) & (x79 ? (~x77 ^ ~x78) : ~x04);
