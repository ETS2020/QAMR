// Benchmark "FAU" written by ABC on Wed Jul 29 08:49:22 2020
...
module FAU ( 
  ...
  assign z56 = (~new_n207_ & x79) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n207_ = (~x76 | (x77 & x78)) & (x01 | (x81 & x84) | (~x81 & ~x84) | (~x77 ^ x78));
