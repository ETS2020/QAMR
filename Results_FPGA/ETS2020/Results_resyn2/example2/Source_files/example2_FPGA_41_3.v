// Benchmark "FAU" written by ABC on Wed Jul 29 08:48:47 2020
...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n178_, new_n181_,
    new_n182_, new_n191_, new_n193_, new_n206_, new_n207_, new_n208_,
  ...
  assign new_n223_ = ~new_n224_ & (~new_n177_ | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign new_n224_ = ~x79 & x40 & ~x78;
  assign new_n225_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n227_ | new_n224_)));
  assign new_n227_ = new_n177_ & (x40 | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign z60 = ~x01 & (new_n174_ | ~new_n229_);
  ...
  assign new_n233_ = x77 & (new_n234_ | (x04 & ~x42 & (~new_n175_ | ~new_n176_)));
