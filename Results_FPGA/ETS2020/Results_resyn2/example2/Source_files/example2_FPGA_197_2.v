...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n172_, new_n174_, new_n175_, new_n183_, new_n191_, new_n192_,
    new_n193_, new_n195_, new_n197_, new_n199_, new_n202_, new_n204_,
    new_n208_;
  ...
  assign z52 = ~x01 & (new_n199_ | (new_n192_ & (x12 | x52) & (x20 | ~x52)));
  assign new_n199_ = x72 & (x81 ^ ~x84) & x79 & x77 & ~x78;
  assign z54 = new_n192_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z56 = (~new_n202_ & x79 & (~x77 | ~x78)) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n202_ = ~x76 & (x81 ^ ~x84);
  assign z61 = ~new_n204_ & x80 & ~x01 & x79;
  assign new_n204_ = ((x81 ^ x84) | (~x77 & ~x78) | (x77 & x78)) & (x04 | ~x77 | ~x78);
  assign z63 = ~new_n204_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & (new_n192_ | (~new_n204_ & x79 & x83));
  assign z65 = ~new_n208_ & x84 & ~x01 & x79;
  assign new_n208_ = (x04 | ~x77 | ~x78) & (~x81 | (~x77 & ~x78) | (x77 & x78));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z12 = 1'b0;
  assign z18 = 1'b0;
