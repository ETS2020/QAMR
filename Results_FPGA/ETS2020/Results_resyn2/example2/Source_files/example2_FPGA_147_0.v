...
module FAU ( 
  ...
  wire new_n154_, new_n156_, new_n167_, new_n168_, new_n169_, new_n170_,
    ...
    new_n199_, new_n201_, new_n203_, new_n205_, new_n208_, new_n211_,
  ...
  assign z36 = new_n186_ & new_n174_ & x54;
  ...
  assign new_n211_ = ~new_n212_ & (~new_n170_ | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n212_ = ~x79 & x40 & ~x78;
  assign new_n213_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n215_ | new_n212_)));
  assign new_n215_ = new_n170_ & (x40 | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign z60 = ~x01 & (new_n167_ | new_n217_);
  assign new_n217_ = (~x79 | (x77 & ~x78) | (~x77 & x78)) & (~x79 | (x81 ^ x84)) & (~x04 | x79);
  assign z62 = ~x01 & (new_n221_ | (x78 & (new_n219_ | (x04 & ~x79))));
  assign new_n219_ = x77 & (new_n220_ | (x04 & ~x42 & (~new_n168_ | ~new_n169_)));
