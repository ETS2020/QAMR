...
module FAU ( 
  ...
  assign z51 = ~x01 & (new_n201_ | (new_n196_ & (x11 | x52) & (x19 | ~x52)));
  assign new_n201_ = x71 & (x81 ^ ~x84) & x79 & x77 & ~x78;
  assign z52 = ~x01 & (new_n203_ | (new_n196_ & (x12 | x52) & (x20 | ~x52)));
  assign new_n203_ = x72 & (x81 ^ ~x84) & x79 & x77 & ~x78;
  assign z53 = ~x01 & (new_n205_ | (new_n196_ & (x13 | x52) & (x21 | ~x52)));
