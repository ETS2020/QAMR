...
module FAU ( 
  ...
  wire new_n173_, new_n174_, new_n175_, new_n176_, new_n177_, new_n180_,
    ...
    new_n215_, new_n218_, new_n219_, new_n220_, new_n222_, new_n224_,
    new_n226_, new_n228_, new_n229_, new_n230_, new_n234_;
  ...
  assign z45 = new_n187_ & new_n183_ & x63;
  ...
  assign z49 = ~x01 & (new_n203_ | (new_n201_ & x69));
  assign new_n203_ = new_n200_ & (x17 | ~x52) & (x09 | x52);
  assign z50 = ~x01 & (new_n205_ | (new_n201_ & x70));
  assign new_n205_ = new_n200_ & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (new_n207_ | (new_n201_ & x71));
  assign new_n207_ = new_n200_ & (x19 | ~x52) & (x11 | x52);
  ...
  assign new_n218_ = ~new_n219_ & (~new_n176_ | ~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n219_ = ~x79 & x40 & ~x78;
  assign new_n220_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n222_ | new_n219_)));
  assign new_n222_ = new_n176_ & (x40 | ~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign z60 = ~x01 & (new_n173_ | ~new_n224_);
  ...
  assign new_n228_ = x77 & (new_n229_ | (x04 & ~x42 & (~new_n174_ | ~new_n175_)));
