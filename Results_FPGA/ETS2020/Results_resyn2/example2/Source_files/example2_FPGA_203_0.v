// Benchmark "FAU" written by ABC on Wed Jul 29 08:50:02 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n154_, new_n157_, new_n167_, new_n168_, new_n169_, new_n170_,
    new_n174_, new_n175_, new_n184_, new_n186_, new_n196_, new_n197_,
  ...
  assign z22 = ~x01 & (new_n167_ | (new_n157_ & ~x41 & (~x81 ^ x84)));
  ...
  assign new_n212_ = ~new_n213_ & (~new_n170_ | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n213_ = ~x79 & x40 & ~x78;
  assign new_n214_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n216_ | new_n213_)));
  assign new_n216_ = new_n170_ & (x40 | ~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign z60 = ~x01 & (new_n167_ | ~new_n218_);
  assign new_n218_ = x79 ? ((~x77 ^ x78) | (x81 & x84) | (~x81 & ~x84)) : x04;
  assign z62 = ~x01 & (new_n222_ | (x78 & (new_n220_ | (x04 & ~x79))));
  assign new_n220_ = x77 & (new_n221_ | (x04 & ~x42 & (~new_n168_ | ~new_n169_)));
