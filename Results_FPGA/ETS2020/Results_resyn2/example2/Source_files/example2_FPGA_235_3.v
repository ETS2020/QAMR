...
module FAU ( 
  ...
  assign z58 = ~x01 & ((~x79 & (~x04 | (~x77 & x78))) | (~new_n222_ & x77));
  assign new_n222_ = ~new_n224_ & (~new_n223_ | ~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  ...
  assign z62 = ~x01 & (new_n231_ | (new_n233_ & (~new_n232_ | (~new_n230_ & x04))));
  assign new_n230_ = x79 & (x42 | (new_n175_ & new_n176_));
  assign new_n231_ = x77 & ~x78 & x79 & x81 & x84;
  assign new_n232_ = x77 & (~x81 | x04 | ~x79);
  assign new_n233_ = x78 & ((x79 & x81 & x84) | x77 | (x04 & ~x79));
  assign z63 = ~new_n228_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & (new_n206_ | (~new_n228_ & x79 & x83));
