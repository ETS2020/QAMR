...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n52_, new_n54_, new_n56_, new_n58_, new_n60_, new_n62_;
  ...
  assign new_n56_ = (~x22 | (new_n54_ & ~x21)) & (~new_n54_ | x21 | x22);
  assign z13 = (~new_n58_ & x16) | ((x04 | ~x18) & ~x16 & (x12 | x18));
  assign new_n58_ = (~x23 | (new_n54_ & ~x21 & ~x22)) & (~new_n54_ | x23 | x21 | x22);
  assign z14 = (~new_n60_ & x16) | ((x05 | ~x18) & ~x16 & (x13 | x18));
  assign new_n60_ = (~x24 | (new_n54_ & ~x23 & ~x21 & ~x22)) & (~new_n54_ | x21 | x22 | x23 | x24);
  assign z15 = (~new_n62_ & x16) | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign new_n62_ = (~x25 | (new_n54_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n54_ | x23 | x21 | x22 | x24 | x25);
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
