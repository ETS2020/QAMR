...
module FAU ( 
  ...
  assign new_n59_ = (~x24 | (new_n57_ & ~x22 & ~x23)) & (~new_n60_ | x22 | x23 | x21 | x24);
  assign new_n60_ = ~x20 & ~x17 & ~x19;
  assign z15 = ((x06 & x18) | x16 | (x14 & ~x18)) & (new_n62_ | new_n63_ | ~x16);
  assign new_n62_ = x25 & (~new_n60_ | x22 | x23 | x21 | x24);
