...
module FAU ( 
  ...
  assign new_n58_ = (~x23 | (new_n56_ & ~x22)) & (~new_n56_ | x22 | x23);
  assign z14 = ((x05 | ~x18) & ~x16 & (x13 | x18)) | (~new_n60_ & x16);
  assign new_n60_ = (~x24 | (new_n54_ & ~x20 & ~x21 & ~x22 & ~x23)) & (~new_n54_ | x20 | x22 | x23 | x21 | x24);
  assign z15 = ((x06 & x18) | x16 | (x14 & ~x18)) & (new_n62_ | new_n64_ | ~x16);
  assign new_n62_ = x25 & (~new_n63_ | ~new_n54_ | x20);
