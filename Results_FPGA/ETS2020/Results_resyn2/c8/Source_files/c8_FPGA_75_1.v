...
module FAU ( 
  ...
  assign new_n62_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x20 | x17 | x19 | x21 | x22);
  assign z13 = ((new_n64_ & ~x23) | ~x16 | (~new_n64_ & x23)) & ((x04 & x18) | x16 | (x12 & ~x18));
  assign new_n64_ = ~x20 & ~x17 & ~x19 & ~x21 & ~x22;
  assign z15 = (x16 & (new_n66_ | new_n68_)) | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign new_n66_ = x25 & (~new_n67_ | x20 | x17 | x19);
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n68_ = new_n69_ & ~x20 & ~x21 & ~x17 & ~x19;
  ...
  assign new_n72_ = new_n69_ & ~x20 & ~x21 & ~x26 & ~x17 & x19;
  assign z14 = 1'b0;
  assign z08 = x27;
endmodule
