...
module FAU ( 
  ...
  assign new_n61_ = (~x25 | (new_n55_ & ~x20 & new_n62_ & ~x21 & ~x22)) & (~new_n55_ | x20 | x21 | ~new_n62_ | x22 | x25);
  assign new_n62_ = ~x23 & ~x24;
  assign z16 = ((new_n64_ & ~x26) | ~x16 | (~new_n64_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign new_n64_ = new_n59_ & new_n62_ & ~x22 & ~x25;
  assign z17 = x16 & (new_n66_ | (x17 & x27));
  assign new_n66_ = new_n67_ & new_n62_ & ~x22 & ~x25;
