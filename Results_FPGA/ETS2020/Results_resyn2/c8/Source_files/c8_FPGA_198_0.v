...
module FAU ( 
  ...
  assign z13 = ((x04 | ~x18) & ~x16 & (x12 | x18)) | ((new_n59_ | x23) & x16 & (~new_n59_ | ~x23));
  assign new_n59_ = new_n57_ & ~x21 & ~x22;
  assign z15 = (~new_n61_ & x16) | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign new_n61_ = (~x25 | (new_n57_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n57_ | x21 | x23 | x24 | x22 | x25);
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z12 = 1'b0;
