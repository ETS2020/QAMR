// Benchmark "FAU" written by ABC on Tue Jul 28 21:49:13 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n57_, new_n59_, new_n61_, new_n63_, new_n64_, new_n66_;
  ...
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n63_ & x16);
  assign new_n63_ = (~x25 | (new_n57_ & ~x20 & new_n64_ & ~x21 & ~x22)) & (~new_n57_ | x20 | x21 | ~new_n64_ | x22 | x25);
  assign new_n64_ = ~x23 & ~x24;
  assign z16 = ((new_n66_ & ~x26) | ~x16 | (~new_n66_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign new_n66_ = new_n61_ & new_n64_ & ~x22 & ~x25;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
  assign z13 = 1'b0;
  assign z14 = 1'b0;
