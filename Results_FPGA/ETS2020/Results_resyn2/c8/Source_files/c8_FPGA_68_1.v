// Benchmark "FAU" written by ABC on Tue Jul 28 21:48:02 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n55_, new_n57_, new_n59_, new_n60_, new_n61_, new_n62_, new_n65_;
  ...
  assign z15 = ((x06 & x18) | x16 | (x14 & ~x18)) & (new_n59_ | new_n61_ | ~x16);
  assign new_n59_ = x25 & (~new_n60_ | x20 | x17 | x19);
  assign new_n60_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n61_ = new_n57_ & new_n62_;
  assign new_n62_ = ~x23 & ~x24 & ~x22 & ~x25;
  assign z16 = ((new_n61_ & ~x26) | ~x16 | (~new_n61_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign z17 = (new_n65_ | x17) & x16 & (~x17 | x27);
  assign new_n65_ = new_n62_ & ~x20 & ~x21 & x19 & ~x26;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
  assign z09 = 1'b0;
