// Benchmark "FAU" written by ABC on Tue Jul 28 21:48:34 2020
...
module FAU ( 
  ...
  assign z14 = new_n61_ | (x16 & ((x24 & (~new_n56_ | ~new_n60_)) | (new_n56_ & new_n60_ & ~x24)));
  assign new_n60_ = ~x22 & ~x23;
  assign new_n61_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = ~new_n63_ & ((x25 & (~new_n56_ | ~new_n60_ | x24)) | ~x16 | (new_n56_ & new_n60_ & ~x24 & ~x25));
  assign new_n63_ = (~x06 | ~x18) & ~x16 & (~x14 | x18);
  assign z16 = ~new_n66_ & ((~x26 & new_n56_ & new_n65_) | ~x16 | (x26 & (~new_n56_ | ~new_n65_)));
  assign new_n65_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n66_ = (~x07 | ~x18) & ~x16 & (~x15 | x18);
  assign z17 = (x17 | (new_n65_ & new_n68_)) & x16 & (~x17 | x27);
  assign new_n68_ = x19 & ~x26 & ~x20 & ~x21;
  assign z01 = 1'b0;
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
