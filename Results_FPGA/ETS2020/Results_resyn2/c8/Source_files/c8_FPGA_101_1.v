...
module FAU ( 
  ...
  assign new_n63_ = (~x25 | (new_n55_ & ~x20 & new_n64_ & ~x21 & ~x24)) & (~new_n55_ | x20 | x21 | ~new_n64_ | x24 | x25);
  assign new_n64_ = ~x22 & ~x23;
  assign z16 = ((new_n66_ & ~x26) | ~x16 | (~new_n66_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign new_n66_ = new_n59_ & new_n64_ & ~x24 & ~x25;
  assign z17 = x16 & (new_n68_ | (x17 & x27));
  assign new_n68_ = new_n69_ & new_n64_ & ~x24 & ~x25;
