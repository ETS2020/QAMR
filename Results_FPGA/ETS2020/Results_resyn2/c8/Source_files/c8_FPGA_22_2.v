// Benchmark "FAU" written by ABC on Tue Jul 28 21:47:46 2020
...
module FAU ( 
  ...
  assign z13 = ((x04 | ~x18) & ~x16 & (x12 | x18)) | (~new_n59_ & x16);
  ...
  assign z15 = ((x06 & x18) | x16 | (x14 & ~x18)) & (new_n63_ | new_n65_ | ~x16);
  assign new_n63_ = x25 & (~new_n64_ | ~new_n55_ | x20);
