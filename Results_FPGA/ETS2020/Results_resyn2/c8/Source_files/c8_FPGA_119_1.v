...
module FAU ( 
  ...
  assign new_n59_ = (~x25 | (new_n55_ & ~x20 & new_n60_ & ~x21 & ~x24)) & (~new_n55_ | x20 | x21 | ~new_n60_ | x24 | x25);
  assign new_n60_ = ~x22 & ~x23;
  assign z16 = ((new_n62_ & ~x26) | ~x16 | (~new_n62_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign new_n62_ = new_n63_ & new_n55_ & ~x20 & ~x21;
  assign new_n63_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z17 = x16 & (new_n65_ | (x17 & x27));
  assign new_n65_ = new_n63_ & ~x20 & ~x21 & ~x26 & ~x17 & x19;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
