...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n57_, new_n59_, new_n61_, new_n62_, new_n64_, new_n65_, new_n67_;
  ...
  assign new_n59_ = (~x21 | (new_n57_ & ~x20)) & (~new_n57_ | x20 | x21);
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n61_ & x16);
  assign new_n61_ = (~x25 | (new_n57_ & ~x20 & new_n62_ & ~x21 & ~x24)) & (~new_n57_ | x20 | x21 | ~new_n62_ | x24 | x25);
  assign new_n62_ = ~x22 & ~x23;
  assign z16 = ((new_n64_ & ~x26) | ~x16 | (~new_n64_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign new_n64_ = new_n65_ & new_n57_ & ~x20 & ~x21;
  assign new_n65_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z17 = x16 & (new_n67_ | (x17 & x27));
  assign new_n67_ = new_n65_ & ~x20 & ~x21 & ~x26 & ~x17 & x19;
  assign z06 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
  assign z14 = 1'b0;
