// Benchmark "FAU" written by ABC on Tue Jul 28 21:48:54 2020
...
module FAU ( 
  ...
  assign new_n65_ = (~x24 | (new_n66_ & ~x17 & ~x19 & ~x20 & ~x21)) & (x20 | x17 | x19 | ~new_n66_ | x21 | x24);
  assign new_n66_ = ~x22 & ~x23;
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n68_ & x16);
  assign new_n68_ = (~x25 | (new_n57_ & ~x20 & new_n66_ & ~x21 & ~x24)) & (~new_n57_ | x20 | x21 | ~new_n66_ | x24 | x25);
  ...
  assign z17 = (new_n73_ | x17) & x16 & (~x17 | x27);
  assign new_n73_ = new_n71_ & ~x20 & ~x21 & x19 & ~x26;
  assign z09 = 1'b0;
  assign z08 = x27;
endmodule
