...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n56_, new_n57_, new_n58_, new_n61_, new_n63_, new_n65_, new_n66_,
    new_n67_, new_n70_;
  ...
  assign new_n61_ = (~x23 | (new_n58_ & ~x22)) & (~new_n58_ | x22 | x23);
  assign z14 = (~new_n63_ & x16) | ((x05 | ~x18) & ~x16 & (x13 | x18));
  assign new_n63_ = (~x24 | (new_n58_ & ~x22 & ~x23)) & (~new_n57_ | x22 | x23 | x21 | x24);
  assign z15 = ((x06 & x18) | x16 | (x14 & ~x18)) & (new_n65_ | new_n66_ | ~x16);
  assign new_n65_ = x25 & (~new_n57_ | x22 | x23 | x21 | x24);
