...
module FAU ( 
  ...
  assign z13 = ((x04 | ~x18) & ~x16 & (x12 | x18)) | (~new_n58_ & x16);
  assign new_n58_ = (~x23 | (~x22 & new_n54_ & ~x20 & ~x21)) & (~new_n54_ | x20 | x21 | x22 | x23);
  assign z14 = ((x05 | ~x18) & ~x16 & (x13 | x18)) | (~new_n60_ & x16);
  assign new_n60_ = (~x24 | (new_n61_ & new_n54_ & ~x20 & ~x21)) & (~new_n54_ | x20 | ~new_n61_ | x21 | x24);
  assign new_n61_ = ~x22 & ~x23;
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n63_ & x16);
  assign new_n63_ = (~x25 | (new_n54_ & ~x20 & new_n61_ & ~x21 & ~x24)) & (~new_n61_ | ~new_n54_ | x20 | x21 | x24 | x25);
  assign z17 = x16 & ((x17 & x27) | (new_n65_ & ~x26 & ~x17 & x19));
  assign new_n65_ = new_n61_ & ~x20 & ~x21 & ~x24 & ~x25;
  assign z00 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
