...
module FAU ( 
  ...
  assign new_n59_ = (~x24 | (new_n55_ & ~x20 & ~x21 & ~x22 & ~x23)) & (~new_n55_ | x20 | x22 | x23 | x21 | x24);
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n61_ & x16);
  assign new_n61_ = (~x25 | (new_n55_ & ~x20 & new_n62_ & ~x21 & ~x24)) & (~new_n55_ | x20 | x21 | ~new_n62_ | x24 | x25);
  assign new_n62_ = ~x22 & ~x23;
  assign z16 = ((new_n64_ & ~x26) | ~x16 | (~new_n64_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign new_n64_ = new_n65_ & new_n62_ & ~x24 & ~x25;
