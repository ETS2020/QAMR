...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n57_, new_n59_, new_n61_, new_n63_, new_n64_, new_n66_, new_n68_,
    new_n69_, new_n71_;
  ...
  assign new_n61_ = (~x23 | (~x22 & new_n57_ & ~x20 & ~x21)) & (~new_n57_ | x20 | x21 | x22 | x23);
  assign z14 = ((x05 | ~x18) & ~x16 & (x13 | x18)) | (~new_n63_ & x16);
  assign new_n63_ = (~x24 | (new_n64_ & new_n57_ & ~x20 & ~x21)) & (~new_n57_ | x20 | ~new_n64_ | x21 | x24);
  assign new_n64_ = ~x22 & ~x23;
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n66_ & x16);
  assign new_n66_ = (~x25 | (new_n57_ & ~x20 & new_n64_ & ~x21 & ~x24)) & (~new_n57_ | x20 | x21 | ~new_n64_ | x24 | x25);
  ...
  assign new_n71_ = new_n69_ & ~x20 & ~x21 & ~x26 & ~x17 & x19;
  assign z05 = 1'b0;
  assign z12 = 1'b0;
  assign z08 = x27;
endmodule
