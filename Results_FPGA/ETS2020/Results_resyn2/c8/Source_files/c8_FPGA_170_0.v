...
module FAU ( 
  ...
  assign z12 = ~new_n58_ & ((x22 & (~new_n56_ | x21)) | ~x16 | (new_n56_ & ~x21 & ~x22));
  assign new_n58_ = (~x03 | ~x18) & ~x16 & (~x11 | x18);
  assign z14 = (~new_n60_ & x16) | ((x05 | ~x18) & ~x16 & (x13 | x18));
  assign new_n60_ = (~x24 | (new_n56_ & ~x23 & ~x21 & ~x22)) & (~new_n56_ | x23 | x24 | x21 | x22);
  assign z15 = (~new_n62_ & x16) | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign new_n62_ = (~x25 | (new_n56_ & ~x23 & ~x24 & ~x21 & ~x22)) & (~new_n56_ | x23 | x21 | x22 | x24 | x25);
  assign z00 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
