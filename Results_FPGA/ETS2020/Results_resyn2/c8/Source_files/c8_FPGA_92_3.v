// Benchmark "FAU" written by ABC on Tue Jul 28 21:48:10 2020
...
module FAU ( 
  ...
  assign z13 = new_n63_ | (x16 & ((x23 & (~new_n61_ | x22)) | (new_n61_ & ~x22 & ~x23)));
  assign new_n63_ = (x04 | ~x18) & ~x16 & (x12 | x18);
  assign z14 = ~new_n65_ & ((~x24 & new_n61_ & ~x22 & ~x23) | ~x16 | (x24 & (~new_n61_ | x22 | x23)));
  assign new_n65_ = (~x05 | ~x18) & ~x16 & (~x13 | x18);
  assign z16 = new_n68_ | ((x26 | (new_n61_ & new_n67_)) & x16 & (~x26 | ~new_n61_ | ~new_n67_));
  assign new_n67_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n68_ = (x07 | ~x18) & ~x16 & (x15 | x18);
  assign z17 = x16 & ((new_n67_ & new_n70_) | (x17 & x27));
