// Benchmark "FAU" written by ABC on Tue Jul 28 21:47:40 2020
...
module FAU ( 
  ...
  assign z11 = ((x02 | ~x18) & ~x16 & (x10 | x18)) | (x16 & (new_n56_ ^ x21));
  assign new_n56_ = ~x20 & ~x17 & ~x19;
  assign z15 = (~new_n58_ & x16) | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign new_n58_ = (~x25 | (new_n56_ & ~x22 & ~x23 & ~x21 & ~x24)) & (~new_n56_ | x21 | x22 | x23 | x24 | x25);
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z09 = 1'b0;
