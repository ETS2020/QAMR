...
module FAU ( 
  ...
  assign z14 = ((x05 | ~x18) & ~x16 & (x13 | x18)) | (~new_n60_ & x16);
  assign new_n60_ = (~x24 | (new_n61_ & ~x17 & ~x19 & ~x20 & ~x21)) & (x20 | x17 | x19 | ~new_n61_ | x21 | x24);
  assign new_n61_ = ~x22 & ~x23;
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n63_ & x16);
  assign new_n63_ = (~x25 | (new_n54_ & ~x20 & new_n61_ & ~x21 & ~x24)) & (~new_n54_ | x20 | x21 | ~new_n61_ | x24 | x25);
  ...
  assign new_n68_ = new_n66_ & ~x20 & ~x21 & x19 & ~x26;
  assign z02 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
