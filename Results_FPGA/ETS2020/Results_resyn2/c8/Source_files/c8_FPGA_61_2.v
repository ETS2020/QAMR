// Benchmark "FAU" written by ABC on Tue Jul 28 21:47:59 2020
...
module FAU ( 
  ...
  assign new_n63_ = (~x24 | (new_n55_ & ~x20 & ~x21 & ~x22 & ~x23)) & (~new_n55_ | x20 | x22 | x23 | x21 | x24);
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n65_ & x16);
  assign new_n65_ = (~x25 | (new_n55_ & ~x20 & new_n66_ & ~x21 & ~x24)) & (~new_n55_ | x20 | x21 | ~new_n66_ | x24 | x25);
  assign new_n66_ = ~x22 & ~x23;
  assign z16 = ((new_n68_ & ~x26) | ~x16 | (~new_n68_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign new_n68_ = new_n59_ & new_n66_ & ~x24 & ~x25;
