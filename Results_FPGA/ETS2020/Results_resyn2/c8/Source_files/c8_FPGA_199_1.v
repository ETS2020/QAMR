...
module FAU ( 
  ...
  assign z13 = ((x04 | ~x18) & ~x16 & (x12 | x18)) | ((new_n60_ | x23) & x16 & (~new_n60_ | ~x23));
  assign new_n60_ = new_n56_ & ~x20 & ~x21 & ~x22;
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n62_ & x16);
  assign new_n62_ = (~x25 | (new_n56_ & ~x20 & new_n63_ & ~x21 & ~x22)) & (~new_n56_ | x20 | x21 | ~new_n63_ | x22 | x25);
  assign new_n63_ = ~x23 & ~x24;
  assign z16 = ((new_n65_ & ~x26) | ~x16 | (~new_n65_ & x26)) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign new_n65_ = new_n66_ & new_n56_ & ~x20 & ~x21;
  assign new_n66_ = ~x23 & ~x24 & ~x22 & ~x25;
  assign z17 = x16 & (new_n68_ | (x17 & x27));
  assign new_n68_ = new_n66_ & ~x20 & ~x21 & ~x26 & ~x17 & x19;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z12 = 1'b0;
  assign z14 = 1'b0;
