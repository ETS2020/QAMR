...
module FAU ( 
  ...
  assign z11 = (~new_n54_ & x16) | ((x02 | ~x18) & ~x16 & (x10 | x18));
  assign new_n54_ = (~x21 | (~x20 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21);
  assign z12 = (~new_n56_ & x16) | ((x03 | ~x18) & ~x16 & (x11 | x18));
  assign new_n56_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x20 | x17 | x19 | x21 | x22);
  assign z13 = ((new_n58_ & ~x23) | ~x16 | (~new_n58_ & x23)) & ((x04 & x18) | x16 | (x12 & ~x18));
  ...
  assign new_n62_ = new_n63_ & ~x20 & ~x21 & ~x17 & ~x19;
