...
module FAU ( 
  ...
  assign new_n215_ = ((~x012 & ~x052) | (~x036 & ~x076)) & x020 & x068;
  assign new_n216_ = (((x012 | x036) & (x052 | x076)) | ~x004 | ~x084) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & (new_n218_ | new_n225_ | ~new_n231_);
  assign new_n218_ = x005 & ((~new_n219_ & ~x053) | (x085 & ~x013 & ~x037));
  assign new_n219_ = ~new_n224_ & (x077 | (~new_n220_ & new_n223_ & new_n221_ & new_n222_));
  assign new_n220_ = ~x069 & (x109 | x117 | (~x093 & (x101 | x125)));
  assign new_n221_ = ~x085 & (~x125 | x021 | x117);
  assign new_n222_ = (~x029 | (x013 & x021)) & ((x013 & x021) | (~x061 & ~x093));
  assign new_n223_ = (~x117 | (x037 & (x109 | ~x125))) & (x037 | (~x109 & (x061 | ~x101)));
  assign new_n224_ = x013 & ~x037 & ~x061 & x125;
  assign new_n225_ = ~x085 & (new_n230_ | (~x053 & (new_n226_ | (~new_n228_ & ~x077))));
  assign new_n226_ = (x109 | x117) & (x013 | (~x077 & (new_n227_ | x021)));
  assign new_n227_ = x029 & (~x061 | ~x093);
  assign new_n228_ = (~x069 | (~x061 & ~x093 & (x021 | ~x029))) & (~new_n229_ | ~x029 | (x061 & x093));
  assign new_n229_ = (x101 | x125) & (~x013 | ~x021);
  assign new_n230_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
  assign new_n231_ = (((x013 | x053) & (x037 | x077)) | ~x021 | ~x069) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & (new_n233_ | ~new_n246_ | (~new_n240_ & ~x086));
  assign new_n233_ = x006 & ((~new_n234_ & ~x054) | (x086 & ~x014 & ~x038));
  assign new_n234_ = ~new_n239_ & (x078 | (~new_n235_ & new_n238_ & new_n236_ & new_n237_));
  assign new_n235_ = ~x070 & (x110 | x118 | (~x094 & (x102 | x126)));
  assign new_n236_ = ~x086 & (~x126 | x022 | x118);
  assign new_n237_ = (~x030 | (x014 & x022)) & ((x014 & x022) | (~x062 & ~x094));
  assign new_n238_ = (~x118 | (x038 & (x110 | ~x126))) & (x038 | (~x110 & (x062 | ~x102)));
  assign new_n239_ = x014 & ~x038 & ~x062 & x126;
  assign new_n240_ = (x054 | (~new_n241_ & (new_n243_ | x078))) & (new_n245_ | ~x038 | x078);
  assign new_n241_ = (x110 | x118) & (x014 | (~x078 & (new_n242_ | x022)));
  assign new_n242_ = x030 & (~x062 | ~x094);
  assign new_n243_ = (~x070 | (~x062 & ~x094 & (x022 | ~x030))) & (~new_n244_ | ~x030 | (x062 & x094));
  assign new_n244_ = (x102 | x126) & (~x014 | ~x022);
  assign new_n245_ = ~x062 & ~x094 & (~x030 | (x014 & x022));
  assign new_n246_ = (((x014 | x054) & (x038 | x078)) | ~x022 | ~x070) & (~x038 | ~x054) & (~x014 | ~x078);
  assign z07 = 1'b0;
  assign z08 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
