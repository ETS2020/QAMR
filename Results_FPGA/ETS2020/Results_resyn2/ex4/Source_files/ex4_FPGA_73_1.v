...
module FAU ( 
  ...
  assign z13 = ~x045 & (new_n215_ | ~new_n229_ | (~new_n222_ & ~x085));
  ...
  assign new_n217_ = ~x069 & ((~x093 & (x101 | x125)) | x109 | x117);
  assign new_n218_ = ~x085 & (~x125 | x021 | x117);
  assign new_n219_ = (~x029 | (x013 & x021)) & ((~x061 & ~x093) | (x013 & x021));
  assign new_n220_ = (~x117 | (x037 & (x109 | ~x125))) & (x037 | (~x109 & (x061 | ~x101)));
  assign new_n221_ = x013 & ~x037 & ~x061 & x125;
  assign new_n222_ = ~new_n226_ & (x053 | (~new_n223_ & (new_n228_ | (~x109 & ~x117))));
  assign new_n223_ = ~x077 & (new_n224_ | (new_n225_ & x029 & (~x013 | ~x021)));
  assign new_n224_ = x069 & ((~x021 & x029) | x061 | x093);
  assign new_n225_ = (x101 | x125) & (~x061 | ~x093);
  assign new_n226_ = ~new_n227_ & x037 & ~x077;
  assign new_n227_ = ~x061 & ~x093 & (~x029 | (x013 & x021));
  assign new_n228_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
  assign new_n229_ = (((x037 | x077) & (x013 | x053)) | ~x021 | ~x069) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & (new_n231_ | ~new_n244_ | (~new_n238_ & ~x086));
  assign new_n231_ = x006 & ((~new_n232_ & ~x054) | (x086 & ~x014 & ~x038));
  assign new_n232_ = ~new_n237_ & (x078 | (~new_n233_ & new_n236_ & new_n234_ & new_n235_));
  assign new_n233_ = ~x070 & ((~x094 & (x102 | x126)) | x110 | x118);
  assign new_n234_ = ~x086 & (~x126 | x022 | x118);
  assign new_n235_ = (~x030 | (x014 & x022)) & ((~x062 & ~x094) | (x014 & x022));
  assign new_n236_ = (~x118 | (x038 & (x110 | ~x126))) & (x038 | (~x110 & (x062 | ~x102)));
  assign new_n237_ = x014 & ~x038 & ~x062 & x126;
  assign new_n238_ = (x054 | (~new_n239_ & (new_n241_ | x078))) & (new_n243_ | ~x038 | x078);
  assign new_n239_ = (x110 | x118) & (x014 | (~x078 & (new_n240_ | x022)));
  assign new_n240_ = x030 & (~x062 | ~x094);
  assign new_n241_ = (~x070 | (~x062 & ~x094 & (x022 | ~x030))) & (~new_n242_ | ~x030 | (x062 & x094));
  assign new_n242_ = (x102 | x126) & (~x014 | ~x022);
  assign new_n243_ = ~x062 & ~x094 & (~x030 | (x014 & x022));
  assign new_n244_ = (((x038 | x078) & (x014 | x054)) | ~x022 | ~x070) & (~x038 | ~x054) & (~x014 | ~x078);
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z15 = 1'b0;
