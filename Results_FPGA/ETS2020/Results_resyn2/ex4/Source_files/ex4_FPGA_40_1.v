// Benchmark "FAU" written by ABC on Wed Jul 29 15:28:56 2020
...
module FAU ( 
  ...
  assign new_n226_ = ((~x011 & ~x035) | (~x051 & ~x075)) & x003 & x083;
  assign new_n227_ = (((x035 | x075) & (x011 | x051)) | ~x019 | ~x067) & (~x035 | ~x051) & (~x011 | ~x075);
