// Benchmark "FAU" written by ABC on Wed Jul 29 15:29:19 2020
...
module FAU ( 
  ...
  assign new_n220_ = ((~x009 & ~x033) | (~x049 & ~x073)) & x001 & x081;
  assign new_n221_ = (((x033 | x073) & (x009 | x049)) | ~x017 | ~x065) & (~x033 | ~x049) & (~x009 | ~x073);
  ...
  assign new_n230_ = (((x012 | x036) & (x052 | x076)) | ~x004 | ~x084) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & (new_n232_ | new_n239_ | ~new_n245_);
  ...
  assign new_n236_ = (~x029 | (x013 & x021)) & ((x013 & x021) | (~x061 & ~x093));
  assign new_n237_ = (~x117 | (x037 & (x109 | ~x125))) & (x037 | (~x109 & (x061 | ~x101)));
  assign new_n238_ = x013 & ~x037 & ~x061 & x125;
  assign new_n239_ = ~x085 & (new_n244_ | (~x053 & (new_n240_ | (~new_n242_ & ~x077))));
  ...
  assign new_n244_ = x037 & ~x077 & (~new_n183_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n249_ = ~x070 & (x110 | x118 | (~x094 & (x102 | x126)));
  assign new_n250_ = ~x086 & (~x126 | x022 | x118);
  assign new_n251_ = (~x030 | (x014 & x022)) & ((x014 & x022) | (~x062 & ~x094));
