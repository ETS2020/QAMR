...
module FAU ( 
  ...
  assign new_n172_ = (((~x012 | ~x052) & (~x036 | ~x076)) | x020 | x068) & (x012 | x076) & (x036 | x052);
  ...
  assign z10 = ~x042 & (new_n191_ | ~new_n192_);
  assign new_n191_ = ((~x010 & ~x050) | (~x034 & ~x074)) & x018 & x066;
  assign new_n192_ = (((x010 | x034) & (x050 | x074)) | ~x002 | ~x082) & (~x034 | ~x050) & (~x010 | ~x074);
  ...
  assign new_n206_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
