// Benchmark "FAU" written by ABC on Wed Jul 29 15:30:25 2020
...
module FAU ( 
  ...
  assign new_n229_ = ((~x012 & ~x036) | (~x052 & ~x076)) & x004 & x084;
  assign new_n230_ = (((x036 | x076) & (x012 | x052)) | ~x020 | ~x068) & (~x036 | ~x052) & (~x012 | ~x076);
