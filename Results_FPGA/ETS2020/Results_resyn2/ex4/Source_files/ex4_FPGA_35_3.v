// Benchmark "FAU" written by ABC on Wed Jul 29 15:28:49 2020
...
module FAU ( 
  ...
  assign new_n223_ = ((~x010 & ~x034) | (~x050 & ~x074)) & x002 & x082;
  assign new_n224_ = (((x034 | x074) & (x010 | x050)) | ~x018 | ~x066) & (~x034 | ~x050) & (~x010 | ~x074);
