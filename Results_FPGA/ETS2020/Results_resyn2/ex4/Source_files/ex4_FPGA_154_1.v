// Benchmark "FAU" written by ABC on Wed Jul 29 15:30:59 2020
...
module FAU ( 
  ...
  assign new_n163_ = (((~x009 | ~x049) & (~x033 | ~x073)) | x017 | x065) & (x009 | x073) & (x033 | x049);
  ...
  assign new_n203_ = ((~x010 & ~x050) | (~x034 & ~x074)) & x018 & x066;
  ...
  assign new_n207_ = (((x011 | x051) & (x035 | x075)) | ~x019 | ~x067) & (~x035 | ~x051) & (~x011 | ~x075);
  ...
  assign new_n224_ = x037 & ~x077 & (~new_n183_ | (x029 & (~x013 | ~x021)));
