// Benchmark "FAU" written by ABC on Wed Jul 29 15:29:20 2020
...
module FAU ( 
  ...
  assign new_n203_ = ((~x033 & ~x073) | (~x009 & ~x049)) & x017 & x065;
  ...
  assign new_n209_ = ((~x011 & ~x035) | (~x051 & ~x075)) & x003 & x083;
  assign new_n210_ = (((x035 | x075) & (x011 | x051)) | ~x019 | ~x067) & (~x035 | ~x051) & (~x011 | ~x075);
