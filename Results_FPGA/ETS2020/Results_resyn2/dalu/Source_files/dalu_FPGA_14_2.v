// Benchmark "FAU" written by ABC on Sat Aug  1 17:28:20 2020
...
module FAU ( 
  ...
  assign new_n196_ = (~x73 | (x21 & x74) | (x22 & ~x74)) & ~x72 & (x73 | (x23 & x74));
  ...
  assign new_n235_ = new_n232_ & x71;
  ...
  assign new_n248_ = (new_n249_ | x72) & ~new_n250_ & (new_n165_ | ~x60);
  assign new_n249_ = (~x59 | x73 | ~x74) & ((~x57 & x74) | ~x73 | (~x58 & ~x74));
  assign new_n250_ = ((x56 & ~x74) | x73 | (x55 & x74)) & x72 & (~x73 | (x52 & ~x74));
  assign new_n251_ = (new_n252_ | x72) & ~new_n253_ & (new_n165_ | ~x28);
  assign new_n252_ = (~x27 | x73 | ~x74) & ((~x25 & x74) | ~x73 | (~x26 & ~x74));
  ...
  assign new_n262_ = ~x70 & (~new_n235_ | new_n251_);
  ...
  assign new_n277_ = ~new_n278_ & ~x70 & (~new_n235_ | new_n280_);
