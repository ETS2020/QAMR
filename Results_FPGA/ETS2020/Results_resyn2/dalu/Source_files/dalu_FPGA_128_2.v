// Benchmark "FAU" written by ABC on Sat Aug  1 17:33:41 2020
...
module FAU ( 
  ...
  assign new_n133_ = ~x44 & ~x47 & ~x45 & ~x46;
  assign new_n134_ = (~new_n135_ | ~new_n98_ | x04) & ~x70 & x71;
  assign new_n135_ = ~x12 & ~x15 & ~x13 & ~x14;
  ...
  assign new_n226_ = (~x58 | x73 | ~x74) & ((~x56 & x74) | ~x73 | (~x57 & ~x74));
  assign new_n227_ = ~new_n228_ & ~new_n229_ & (new_n165_ | ~x27);
  assign new_n228_ = x72 & ((~x73 & (x74 ? x22 : x23)) | (x19 & x73 & ~x74));
  assign new_n229_ = ~x72 & ((x26 & ~x73 & x74) | ((x24 | ~x74) & x73 & (x25 | x74)));
  ...
  assign new_n259_ = (x44 | (x32 & (x47 | x45 | x46))) & ~x71 & (~x44 | ~x32 | (~x47 & ~x45 & ~x46));
  assign new_n260_ = new_n108_ & ((~new_n248_ & x65 & ~x71) | (new_n261_ & ~x65 & x71));
  assign new_n261_ = ~x12 ^ (~x00 | (~x15 & ~x13 & ~x14));
  assign new_n262_ = ~x70 & (new_n251_ | ~new_n235_);
  assign new_n263_ = ~x64 & (~new_n236_ | ((~new_n259_ | ~x70) & (~new_n261_ | x70 | ~x71)));
  assign z14 = ~new_n265_ & (~x64 | (~x65 & (new_n279_ | (~new_n278_ & new_n106_))));
  assign new_n265_ = (new_n266_ | new_n274_ | new_n106_) & ~x64 & (~new_n236_ | new_n277_);
  assign new_n266_ = new_n273_ & ((new_n267_ & x71) | ~new_n232_ | (new_n270_ & ~x71));
  assign new_n267_ = (new_n268_ | x72) & ~new_n269_ & (new_n165_ | ~x62);
  assign new_n268_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n269_ = x72 & (~x73 | (x54 & ~x74)) & (x73 | (x74 ? x57 : x58));
  assign new_n270_ = ~new_n271_ & ~new_n272_ & (new_n165_ | ~x30);
  assign new_n271_ = ~x72 & ((x29 & ~x73 & x74) | (x73 & (x74 ? x27 : x28)));
  assign new_n272_ = x72 & (~x73 | (x22 & ~x74)) & (x73 | (x74 ? x25 : x26));
  assign new_n273_ = x70 & (~new_n231_ | (~x46 & (~x32 | ~x47)) | x71 | (x46 & x32 & x47));
  assign new_n274_ = new_n275_ & (~new_n108_ | ((new_n267_ | ~x65 | x71) & (~new_n276_ | x65 | ~x71)));
  assign new_n275_ = ~x70 & (~new_n235_ | (~new_n271_ & ~new_n272_ & (new_n165_ | ~x30)));
  assign new_n276_ = ~x14 ^ (~x00 | ~x15);
  assign new_n277_ = (~new_n276_ | x70 | ~x71) & (~x70 | (~x46 & (~x32 | ~x47)) | x71 | (x46 & x32 & x47));
  assign new_n278_ = (x68 | ~x69 | ((new_n267_ | ~x70 | ~x71) & (new_n270_ | (x70 ^ ~x71)))) & (new_n267_ | x70 | x71 | ~x68 | x69);
  assign new_n279_ = ((new_n111_ & x46) | (~new_n280_ & ~x68)) & (x66 | x67) & (~x66 | ~x67);
  assign new_n280_ = (new_n281_ | ~x70) & (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69);
  assign new_n281_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
