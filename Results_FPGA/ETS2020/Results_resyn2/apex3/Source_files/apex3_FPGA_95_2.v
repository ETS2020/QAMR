// Benchmark "FAU" written by ABC on Wed Jul 29 21:27:18 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n307_, new_n309_, new_n312_, new_n313_, new_n314_, new_n315_,
    ...
    new_n344_, new_n347_, new_n349_, new_n350_, new_n352_, new_n354_,
    new_n361_, new_n363_, new_n368_, new_n370_;
  ...
  assign z14 = new_n254_ & ~x46 & x48 & new_n152_ & x50 & ~x52;
  assign z15 = x50 ? (new_n318_ | (~new_n315_ & ~x47)) : ~new_n312_;
  assign new_n312_ = (new_n314_ | x46) & (~new_n313_ | ~x46 | x47 | (~x51 ^ ~x52));
  assign new_n313_ = x53 & x48 & ~x49;
  assign new_n314_ = (~x47 | ((~x49 | x51 | ~x52 | x53) & (x49 | ~x51 | ~x48 | x52))) & ((x51 ? (~x52 | ~x53) : (x52 | x53)) | ~x48 | x47 | x49);
  assign new_n315_ = (new_n316_ | ~x52) & (~new_n317_ | (x52 & (x04 | x53)));
  assign new_n316_ = (~x51 | ((~x53 | x48 | ~x49) & (x49 | x53 | ~x46 | ~x48))) & (x49 | x51 | x53 | ~x46 | (~x04 & x48));
  assign new_n317_ = x48 & ~x49 & x46 & ~x51;
  assign new_n318_ = new_n207_ & x51 & ~x49 & ~x46 & x48;
  assign z16 = (~new_n320_ & ~x48) | (new_n323_ & x49 & x52 & x48 & ~x53);
  assign new_n320_ = (new_n322_ | x49 | ~x52) & (~new_n210_ | ~x49 | new_n321_ | ~x50 | x52);
  assign new_n321_ = ~x51 & x53;
  assign new_n322_ = (x47 | ((x50 | ~x53 | x46 | x51) & ((~x51 ^ x53) | ~x46 | (~x50 & x53) | (x50 & ~x53)))) & (x46 | ~x47 | x53 | ~x50 | ~x51);
  assign new_n323_ = new_n210_ & x50 & ~x51;
  assign z17 = ~new_n325_ & x52 & ~x47 & ~x49;
  assign new_n325_ = (~x46 | ~x48 | x50 | x51 | x53) & ((~x50 ^ x53) | ~x51 | x46 | x48);
  assign z18 = new_n327_ | (~new_n329_ & x46 & ~x47);
  assign new_n327_ = (x48 | (x51 ^ x52)) & new_n328_ & (~x48 | (x23 & ~x51 & ~x52));
  assign new_n328_ = new_n210_ & ~x53 & ~x49 & x50;
  assign new_n329_ = (x51 | x52 | ~x53 | x48 | ~x49 | x50) & ((~x53 & (~x50 ^ x52)) | (~x48 & (~x50 | ~x52)) | x49 | ~x51 | (x48 & x53));
  assign z20 = (~x52 ^ ~x53) & new_n331_ & x51;
  assign new_n331_ = new_n254_ & ~x50 & ~x46 & x48;
  assign z21 = x51 & (new_n333_ | (new_n334_ & x46 & ~x47 & ~x48));
  assign new_n333_ = new_n141_ & ~x46 & new_n207_ & x47 & x48;
  assign new_n334_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = new_n337_ | (~x46 & (new_n336_ | (~new_n338_ & ~x47 & ~x52)));
  assign new_n336_ = (x48 ^ x50) & new_n309_ & x47 & x49;
  assign new_n337_ = new_n138_ & x46 & ~x47 & new_n152_ & x50 & ~x52;
  assign new_n338_ = (~x48 | ~x53 | ~x51 | ~x49 | x50) & ((~x50 & x51) | (x49 & x50) | x48 | x53 | (~x49 & ~x51));
  assign z23 = new_n210_ & ~x49 & x50 & new_n207_ & x51;
  assign z24 = ~new_n341_ & new_n140_ & x49 & ~x53;
  assign new_n341_ = (~x50 | x51 | x46 | ~x47) & (~x46 | x47 | x50 | ~x51);
  assign z25 = new_n331_ & (x51 | x53) & (x51 | x52) & (~x51 | ~x52);
  assign z26 = ~new_n344_ & ~x51 & x52;
  assign new_n344_ = (~x53 | x49 | ~x50 | x46 | ~x47) & (~x46 | ~x49 | x50 | x53 | x47 | x48);
  assign z27 = new_n334_ & ~x47 & x48 & ~x46 & ~x51;
  assign z28 = new_n210_ & ~new_n347_;
  assign new_n347_ = (~x49 | ((~x51 | ((x52 | ~x53 | x48 | x50) & (~x52 | ((x48 | x53) & (~x48 | x50) & (x48 | ~x50))))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z30 = ~x47 & ((~new_n350_ & ~x48) | (new_n349_ & new_n247_ & x46 & x48));
  ...
  assign z31 = new_n352_ & new_n207_;
  assign new_n352_ = ~x48 & ~x46 & ~x47 & new_n118_ & x51;
  ...
  assign z36 = new_n309_ & new_n331_;
  assign z37 = new_n254_ & new_n159_ & ~x51 & ~x50 & ~x46 & x48;
  assign z38 = new_n159_ & new_n331_ & x51;
  assign z39 = new_n361_ & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign new_n361_ = new_n313_ & ~x52 & ~x46 & ~x47;
  assign z40 = ~x52 & ((~new_n363_ & ~x51) | (new_n210_ & ~x48 & x50 & x51));
  assign new_n363_ = ((~x48 & x53) | ~x49 | ~x50 | x46 | ~x47) & (~x53 | ~x48 | x50 | x49 | ~x46 | x47);
  assign z42 = new_n352_ & new_n133_;
  assign z43 = new_n352_ & ~x52 & x53;
  assign z46 = new_n133_ & new_n210_ & x49 & x48 & x50 & x51;
  assign z47 = new_n368_ & ~x50 & x48 & ~x49;
  assign new_n368_ = ~x46 & ~x47 & new_n159_ & x51;
  assign z48 = new_n370_ & new_n159_ & x27 & ~x43;
  assign new_n370_ = ~x49 & x51 & new_n210_ & ~x48 & ~x50;
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
