// Benchmark "FAU" written by ABC on Wed Jul 29 21:30:57 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n340_, new_n341_, new_n344_, new_n350_, new_n352_, new_n356_;
  ...
  assign new_n136_ = ((x03 & x52 & ~x53) | ~x51 | (~x52 & x53)) & x50 & ((~x52 & x04 & ~x53) | x51 | (x52 & x53));
  ...
  assign new_n155_ = (~new_n156_ | ~x49) & (new_n157_ | x50);
  assign new_n156_ = ~x52 & ~x53;
  assign new_n157_ = ((~x37 & ~x53) | x49 | x51 | (x52 & x53)) & (~x19 | x52 | ~x49 | ~x51);
  assign new_n158_ = ~new_n159_ & ~x48 & ((~new_n164_ & ~x53) | new_n163_ | ~x47);
  assign new_n159_ = (new_n160_ | ~x49 | ~x50) & ~x47 & (x49 | x50 | ~new_n122_ | ~x53);
  ...
  assign new_n181_ = ((~new_n182_ & x48) | x49 | (~new_n183_ & ~x48 & ~x52)) & x46 & (~x49 | (~x48 & ~x52));
  assign new_n182_ = (~x51 | x52) & (x04 | x51 | (x52 & x53));
  ...
  assign new_n210_ = (new_n211_ | ~x51) & (new_n212_ | x50 | x51);
  assign new_n211_ = (x53 | ~new_n110_ | x52) & (~x50 | x53) & (~x53 | ((x04 | ~x52) & (x50 | x52) & (~x50 | ~x52)));
  ...
  assign new_n246_ = ~new_n247_ & (new_n253_ | x48) & (new_n254_ | ~x48 | ~x50);
  assign new_n247_ = ~x46 & (new_n250_ | (~x50 & (new_n248_ | new_n252_)));
  assign new_n248_ = ~new_n249_ & x49 & x51;
  assign new_n249_ = (~x12 | x52 | x53) & (~x52 | ~x53 | ~x17 | x47);
  assign new_n250_ = new_n251_ & ~x20 & new_n174_ & x50 & ~x51;
  ...
  assign z06 = new_n277_ | (~x46 & ((~new_n256_ & ~x52) | ~new_n272_ | (~new_n290_ & x52)));
  assign new_n256_ = ~new_n257_ & (new_n262_ | ~x53) & (~new_n271_ | ~new_n135_ | x53);
  assign new_n257_ = x51 & ((~new_n258_ & x47) | (~new_n260_ & ~x47 & ~x53));
  ...
  assign new_n262_ = (new_n263_ | ~x48) & ~new_n267_ & (new_n268_ | new_n270_ | x48);
  ...
  assign new_n267_ = new_n118_ & x47 & ~x51;
  assign new_n268_ = (~x47 | (new_n269_ & (x49 | ~x50) & (~x49 | x50))) & x51 & ((~x49 & x50) | (x49 & ~x50) | x47 | (x44 & x49));
  assign new_n269_ = x49 ? ~x43 : x29;
  assign new_n270_ = (x14 | x47) & x49 & ~x50 & ~x51;
  assign new_n271_ = ~x50 & ~x51 & (x25 | x47);
  assign new_n272_ = ~new_n275_ & (x48 | ((new_n276_ | x14) & (new_n273_ | ~x52)));
  assign new_n273_ = (~new_n267_ | ~x38) & (new_n274_ | ~x50);
  assign new_n274_ = ((x53 & (~x20 | x47)) | ~x49 | (~x47 & x51)) & ((~x51 & ~x25 & ~x47) | x49 | x53 | (x47 & x51));
  assign new_n275_ = new_n118_ & ~x15 & ~x47 & x48 & ~x51 & x53;
  assign new_n276_ = (x47 | ~x50 | x49 | ~x51 | ~x53) & (x53 | ~x52 | ~x49 | x51);
  assign new_n277_ = ~x47 & (new_n285_ | (~new_n278_ & x51));
  assign new_n278_ = (new_n279_ | ~x46 | x52) & (new_n283_ | ~x52 | (new_n179_ & x50));
  assign new_n279_ = ~new_n282_ & (x49 | ((new_n281_ | ~x53) & (new_n280_ | x50 | x53)));
  assign new_n280_ = x48 & ~x37 & (x38 | x43);
  assign new_n281_ = ~x48 & x50 & (x28 | x22 | x25);
  assign new_n282_ = x53 & ~x48 & x49 & (x06 | ~x50) & (~x24 | x50);
  assign new_n283_ = ~new_n284_ & ~x50 & (x48 | x53 | ~x25 | x49);
  assign new_n284_ = x46 & ((~x53 & ~x48 & x49) | (~x49 & ((~x48 & (x39 | ~x53)) | (~x04 & x48) | (x48 & ~x53))));
  assign new_n285_ = x46 & ~x51 & ((~new_n286_ & new_n289_) | (new_n135_ & ~new_n288_));
  assign new_n286_ = (new_n287_ | x53) & ~x50 & (x48 | ~x52 | ~x14 | ~x53);
  assign new_n287_ = (~x36 | x48 | ~x52) & ((~x20 & ~x52) | ~x48 | (x16 & x52));
  assign new_n288_ = (x50 | x53) & (x52 | ~x53) & (x10 | x25 | x11 | ~x52 | x53);
  assign new_n289_ = ~x49 & ((x48 & (x52 ^ (x04 & ~x53))) | ~x50 | (x53 & ~x48 & ~x52));
  assign new_n290_ = ~new_n293_ & (~x48 | (~new_n291_ & (x53 | (~new_n294_ & new_n295_))));
  assign new_n291_ = x51 & (new_n292_ | (~x49 & x50 & ~x45 & x47));
  assign new_n292_ = ((x42 & x49 & x50) | x47 | (~x50 & ~x03 & ~x49)) & x53 & (~x47 | (~x49 & x50) | (x49 & ~x50));
  assign new_n293_ = ((~x31 & ~x49) | ~x47 | (x49 & ~x50)) & new_n148_ & (x47 | (~x32 & ~x49 & ~x50));
  assign new_n294_ = (x50 | ((x27 | x49) & (x47 | (x34 & x49)))) & x51 & (~x47 | ~x49 | ~x50);
  assign new_n295_ = ((~x47 & x50) | x49 | x51) & (x47 | ~x49 | ((~x29 | ~x50) & (~x20 | x50 | x51)));
  assign z09 = ~new_n297_ & x53 & ~x46 & ~x51;
  assign new_n297_ = (~x47 | ~x48 | ~x49 | ~x50 | ~x52) & (x47 | x48 | x49 | x50 | x52);
  assign z10 = ~new_n299_ & ~x46 & ~x49;
  assign new_n299_ = (x47 | ((x50 | ~x51 | (x48 ? (x52 ^ ~x53) : (x52 | x53))) & (x48 | ~x50 | x51 | ~x52 | ~x53))) & (~x51 | ~x52 | x53 | ~x47 | x48 | x50);
  assign z11 = new_n301_ | (new_n304_ & (x49 ? x50 : x51));
  assign new_n301_ = ~x47 & ((~new_n303_ & x51) | (new_n302_ & ~x46 & ~x49));
  assign new_n302_ = ~x48 & new_n174_ & x50 & ~x51;
  assign new_n303_ = (x48 | (((~x50 & ~x53) | (~x52 & x53) | (~x49 & x52) | ~x46 | (x49 & x50)) & ((x50 ^ x52) | x46 | x49 | x53))) & (~x48 | (x52 ^ ~x53) | x50 | x46 | x49);
  assign new_n304_ = new_n207_ & x52 & (~x50 | ~x51) & ~x48 & ~x53;
  assign z12 = new_n207_ & ~new_n306_;
  assign new_n306_ = ((x51 & ~x52) | (x50 & x52) | x53 | x48 | ~x49) & ((((~x51 & x52) | (x51 & ~x52) | ~x48 | (x50 & x52)) & x49 & (x48 | ~x50 | ~x51)) | ~x53 | ((x51 | ~x52 | ~x48 | x50) & ~x49 & (x48 | ~x50 | ~x51 | x52)));
  assign z13 = ~x48 & ~x46 & ~x47 & new_n308_ & ~x49 & ~x50;
  assign new_n308_ = new_n174_ & ~x51;
  assign z14 = new_n310_ & new_n251_ & ~x46 & x48;
  assign new_n310_ = new_n148_ & x50 & ~x52;
  assign z16 = (~new_n312_ & ~x48) | (new_n315_ & x49 & x52 & x48 & ~x53);
  assign new_n312_ = (new_n314_ | x49 | ~x52) & (~new_n207_ | ~x49 | new_n313_ | ~x50 | x52);
  assign new_n313_ = ~x51 & x53;
  assign new_n314_ = (x47 | ((x50 | ~x53 | x46 | x51) & ((~x51 ^ x53) | ~x46 | (~x50 & x53) | (x50 & ~x53)))) & (x46 | ~x47 | x53 | ~x50 | ~x51);
  assign new_n315_ = new_n207_ & x50 & ~x51;
  assign z17 = new_n240_ & ((x46 & x48 & ~x50 & ~x51 & ~x53) | ((x50 ^ x53) & x51 & ~x46 & ~x48));
  assign z18 = new_n318_ | (new_n129_ & ~new_n320_);
  assign new_n318_ = (x48 | (x51 ^ x52)) & new_n319_ & (~x48 | (x23 & ~x51 & ~x52));
  assign new_n319_ = new_n207_ & ~x53 & ~x49 & x50;
  assign new_n320_ = (x48 | ~x49 | x50 | x51 | x52 | ~x53) & (((x48 | ~x53) & (~x50 ^ x52)) | x49 | ~x51 | ((~x50 | ~x52) & (~x48 | x53)));
  assign z20 = (~x52 ^ ~x53) & x51 & new_n322_ & new_n251_ & ~x46;
  assign new_n322_ = x48 & ~x50;
  assign z21 = x51 & (new_n324_ | (new_n325_ & x46 & ~x47 & ~x48));
  assign new_n324_ = new_n153_ & ~x46 & new_n204_ & x47 & x48;
  assign new_n325_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~new_n327_ & ~x46) | (new_n310_ & new_n135_ & x46 & ~x47);
  assign new_n327_ = ~new_n328_ & ((~x48 ^ x50) | ~new_n308_ | ~x47 | ~x49);
  ...
  assign z24 = new_n332_ & ((~x50 & x51 & x46 & ~x47) | (x50 & ~x51 & ~x46 & x47));
  assign new_n332_ = x49 & ~x53 & ~x48 & x52;
  assign z25 = new_n322_ & new_n251_ & ~x46 & (~x51 | ~x52) & (x51 | (x52 & x53));
  assign z26 = ~new_n335_ & ~x51 & x52;
  assign new_n335_ = (~x53 | x49 | ~x50 | x46 | ~x47) & (~x46 | ~x49 | x50 | x53 | x47 | x48);
  assign z27 = new_n325_ & ~x47 & x48 & ~x46 & ~x51;
  assign z28 = new_n207_ & ~new_n338_;
  assign new_n338_ = (~x49 | ((~x51 | ((x52 | ~x53 | x48 | x50) & (~x52 | ((x48 | x53) & (~x48 | x50) & (x48 | ~x50))))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z30 = ~x47 & ((~new_n341_ & ~x48) | (new_n340_ & new_n245_ & x46 & x48));
  assign new_n340_ = ~x50 & x51 & x52;
  assign new_n341_ = (x51 | ((x46 | (((x52 & x53) | x49 | ~x50) & (~x49 | x50 | x52))) & ((x52 & ~x53) | (~x52 & x53) | (~x50 & ~x53) | ~x46 | ~x49))) & (x50 | ~x51 | ~x46 | ~x49);
  assign z31 = ~x48 & ~x46 & ~x47 & new_n118_ & new_n204_ & x51;
  assign z32 = new_n251_ & ~new_n344_;
  assign new_n344_ = (~x46 | x48 | ~x50 | ~x51 | ~x52 | ~x53) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = x48 & new_n207_ & x49 & new_n156_ & x50 & x51;
  assign z36 = new_n308_ & new_n322_ & new_n251_ & ~x46;
  assign z37 = new_n251_ & new_n322_ & ~x46 & new_n156_ & ~x51;
  assign z38 = new_n156_ & x51 & new_n322_ & new_n251_ & ~x46;
  assign z39 = new_n350_ & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign new_n350_ = x48 & ~x49 & ~x52 & x53 & ~x46 & ~x47;
  assign z40 = ~x52 & ((~new_n352_ & ~x51) | (~x48 & x50 & new_n207_ & x51));
  assign new_n352_ = ((~x48 & x53) | ~x49 | ~x50 | x46 | ~x47) & (~x53 | ~x48 | x50 | x49 | ~x46 | x47);
  assign z46 = x48 & new_n207_ & x49 & x50 & new_n174_ & x51;
  assign z47 = ~x50 & x48 & ~x49 & new_n184_ & ~x46 & ~x47;
  assign z48 = new_n356_ & new_n156_ & x27 & ~x43;
  assign new_n356_ = ~x49 & x51 & new_n207_ & ~x48 & ~x50;
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
