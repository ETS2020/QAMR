// Benchmark "FAU" written by ABC on Wed Jul 29 21:23:41 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n331_, new_n334_, new_n336_, new_n338_, new_n339_, new_n342_,
    new_n345_, new_n350_, new_n352_, new_n354_, new_n358_;
  ...
  assign z06 = (~new_n255_ & ~x46) | (~x47 & (new_n289_ | (~new_n283_ & x51)));
  assign new_n255_ = new_n278_ & (new_n272_ | ~x52) & (x52 | (new_n264_ & (new_n256_ | ~x53)));
  assign new_n256_ = new_n261_ & (~x48 | (new_n259_ & (new_n257_ | ~x47)));
  assign new_n257_ = new_n258_ & (x51 | (~x50 & (~new_n142_ | ~x01)));
  assign new_n258_ = (~x49 | (~x01 & x51)) & (x43 | ~x50) & (x49 | x50 | ~x21 | ~x51);
  assign new_n259_ = (~x50 | ((x41 | ~x49 | ~x51) & (~x29 | x49 | x51))) & ((x29 & x50) | (~new_n260_ & (~x49 | x51)));
  assign new_n260_ = ~x47 & ~x50 & (x19 | ~x49);
  assign new_n261_ = (~new_n118_ | ~x47 | x51) & (x48 | (new_n263_ & (new_n262_ | ~x47 | ~x51)));
  assign new_n262_ = (~x49 | x50) & (x49 | ~x50) & (~x43 | ~x49) & (x29 | x49);
  assign new_n263_ = (x51 | (x49 & ~x50 & (x14 | x47))) & ((~x49 & x50) | (x49 & ~x50) | x47 | (x44 & x49));
  assign new_n264_ = ~new_n271_ & (~x51 | (~new_n268_ & (~x47 | (~new_n265_ & ~new_n267_))));
  assign new_n265_ = (~x01 | (new_n266_ & (~x26 | x49))) & x48 & (new_n266_ | (x43 & x49));
  assign new_n266_ = x50 & ~x53;
  assign new_n267_ = ~x50 & ~x53 & new_n135_ & ~x20;
  assign new_n268_ = new_n270_ & ((~new_n269_ & ~x48) | (x40 & ~x50 & x48 & ~x49));
  assign new_n269_ = (~x25 | x49 | ~x50) & ((~x35 & x50) | ~x49 | (~x41 & ~x50));
  assign new_n270_ = ~x47 & ~x53;
  assign new_n271_ = new_n135_ & ~x53 & (x25 | x47) & ~x50 & ~x51;
  ...
  assign new_n275_ = ((~x31 & ~x49) | ~x47 | (x49 & ~x50)) & new_n148_ & (x47 | (~x32 & ~x49 & ~x50));
  ...
  assign new_n280_ = (~x49 | (~x47 & x51) | (x53 & (~x20 | x47))) & ((~x51 & ~x25 & ~x47) | x49 | x53 | (x47 & x51));
  assign new_n281_ = new_n118_ & ~x15 & ~x47 & x48 & ~x51 & x53;
  assign new_n282_ = (x47 | ~x50 | x49 | ~x51 | ~x53) & (x53 | ~x52 | ~x49 | x51);
  assign new_n283_ = (new_n284_ | ~x46 | x52) & (new_n287_ | ~x52 | (new_n179_ & x50));
  ...
  assign new_n299_ = (new_n300_ | ~x51) & (~new_n174_ | ~x50 | x51 | ~new_n122_ | x46);
  assign new_n300_ = (x48 | (((~x50 & ~x53) | (~x52 & x53) | (~x49 & x52) | ~x46 | (x49 & x50)) & ((x50 ^ x52) | x46 | x49 | x53))) & ((~x52 ^ x53) | ~x48 | x50 | x46 | x49);
  assign new_n301_ = new_n207_ & x52 & (~x50 | ~x51) & ~x48 & ~x53;
  assign z12 = new_n207_ & ~new_n303_;
  ...
  assign new_n305_ = new_n174_ & ~x51;
  assign z14 = new_n307_ & new_n251_ & ~x46 & x48;
  assign new_n307_ = new_n148_ & x50 & ~x52;
  assign z16 = (~new_n309_ & ~x48) | (new_n312_ & x49 & x52 & x48 & ~x53);
  assign new_n309_ = (new_n311_ | x49 | ~x52) & (~new_n207_ | ~x49 | new_n310_ | ~x50 | x52);
  assign new_n310_ = ~x51 & x53;
  assign new_n311_ = (x47 | ((x50 | ~x53 | x46 | x51) & ((~x51 ^ x53) | ~x46 | (~x50 & x53) | (x50 & ~x53)))) & (x46 | ~x47 | x53 | ~x50 | ~x51);
  assign new_n312_ = new_n207_ & x50 & ~x51;
  assign z17 = new_n240_ & ((x46 & x48 & ~x50 & ~x51 & ~x53) | ((x50 ^ x53) & x51 & ~x46 & ~x48));
  assign z18 = (new_n129_ & ~new_n316_) | (new_n315_ & (x48 | (~x51 ^ ~x52)));
  assign new_n315_ = new_n266_ & new_n207_ & ~x49 & (~x48 | (new_n124_ & x23));
  ...
  assign z22 = (~new_n323_ & ~x46) | (new_n307_ & new_n135_ & x46 & ~x47);
  ...
  assign z29 = new_n336_ & ~x52 & x53;
  assign new_n336_ = new_n207_ & x49 & x48 & x50 & x51;
  assign z30 = ~x47 & ((~new_n339_ & ~x48) | (new_n338_ & new_n245_ & x46 & x48));
  ...
  assign z32 = new_n251_ & ~new_n342_;
  assign new_n342_ = (x51 | x52 | x53 | x50 | x46 | ~x48) & (~x51 | ~x52 | ~x53 | ~x50 | ~x46 | x48);
  assign z33 = new_n336_ & new_n156_;
  assign z34 = new_n345_ & (x52 ^ (x48 | x53));
  assign new_n345_ = ~x46 & new_n118_ & x47 & ~x51;
  ...
  assign z41 = ~x50 & (new_n354_ | (new_n207_ & ~x49 & new_n174_ & x51));
  assign new_n354_ = new_n148_ & x49 & ~x52 & x46 & ~x47 & ~x48;
  assign z46 = new_n336_ & new_n174_;
  assign z47 = ~x50 & x48 & ~x49 & new_n184_ & ~x46 & ~x47;
  assign z48 = new_n358_ & new_n156_ & x27 & ~x43;
  assign new_n358_ = ~x49 & x51 & new_n207_ & ~x48 & ~x50;
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
