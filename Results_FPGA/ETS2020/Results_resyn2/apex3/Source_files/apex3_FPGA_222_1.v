// Benchmark "FAU" written by ABC on Wed Jul 29 21:32:29 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n439_, new_n440_, new_n441_, new_n452_, new_n453_;
  ...
  assign new_n303_ = new_n325_ & (new_n319_ | ~x52) & (x52 | (new_n313_ & (new_n304_ | ~x53)));
  ...
  assign z12 = new_n119_ & ~new_n402_;
  assign new_n402_ = (~x53 | ((~x48 | (((x51 & ~x52) | (~x51 & x52) | ~x49 | (x50 & x52)) & (x49 | x50 | x51 | ~x52))) & (x48 | ~x50 | ~x51 | (~x49 & x52)))) & (x53 | x48 | ~x49 | (x51 & ~x52) | (x50 & x52));
  assign z14 = new_n404_ & new_n135_ & x50 & ~x52;
  assign new_n404_ = ~x46 & ~x47 & x48 & x49;
  assign z15 = x50 ? ~new_n407_ : (new_n406_ | (~new_n409_ & ~x46));
  assign new_n406_ = new_n192_ & x53 & new_n129_ & (~x51 ^ x52);
  assign new_n407_ = (new_n408_ | x47) & (~new_n192_ | ~x51 | ~new_n201_ | x46);
  assign new_n408_ = (~x51 | ~x52 | x48 | ~x49 | ~x53) & (~x46 | x49 | ((~x48 | x51 | x52) & (~x52 | x53 | (~x48 & x51))));
  assign new_n409_ = (~x47 | ((~x49 | x51 | ~x52 | x53) & (x52 | ~x51 | ~x48 | x49))) & (x49 | x47 | ~x48 | (x52 ^ x53) | (x51 ^ x52));
  assign z16 = (~new_n411_ & ~x48) | (new_n119_ & new_n298_ & new_n201_ & x48 & x49);
  assign new_n411_ = (new_n412_ | x49 | ~x52) & (~new_n119_ | ~x49 | new_n330_ | ~x50 | x52);
  ...
  assign new_n416_ = ~x47 & x49 & ~x51 & new_n169_ & ~x48 & ~x50;
  assign new_n417_ = new_n129_ & (~x51 ^ ~x52) & new_n153_ & ~x53 & (~x50 ^ x52);
  assign new_n418_ = (~x47 | (((x50 ? (x51 | x52) : (~x51 | ~x52)) | ~x48 | ~x53) & (x48 | ~x50 | ~x51 | x52 | x53))) & (x47 | x48 | ((~x52 | x53 | x50 | ~x51) & ((x52 & x53) | (~x52 & ~x53) | ~x50 | (x51 ^ ~x52))));
  assign z20 = new_n404_ & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & (new_n421_ | (new_n422_ & x46 & ~x47 & ~x48));
  assign new_n421_ = new_n201_ & ~x46 & x48 & x49 & x47 & x50;
  assign new_n422_ = new_n169_ & ~x49 & ~x50;
  assign z22 = (new_n427_ & x50) | (~x46 & (new_n424_ | (new_n426_ & (x48 ^ x50))));
  assign new_n424_ = ~new_n425_ & ~x47 & ~x52;
  assign new_n425_ = (~x48 | ~x51 | ~x53 | ~x49 | x50) & ((x49 ^ ~x51) | x48 | x53 | (x49 ^ ~x50));
  assign new_n426_ = x47 & x49 & new_n181_ & ~x51;
  assign new_n427_ = new_n248_ & new_n299_ & new_n135_ & ~x52;
  ...
  assign new_n431_ = (~x49 | ((~x51 | ((x52 | ~x53 | x48 | x50) & (~x52 | ((x48 | x53) & (x48 | ~x50) & (~x48 | x50))))) & (x48 | x50 | x52 | x51 | x53))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = new_n169_ & new_n119_ & x51 & x50 & x48 & x49;
  assign z31 = new_n201_ & new_n153_ & x51 & ~x50 & ~x46 & ~x47;
  assign z32 = new_n299_ & ~new_n435_;
  ...
  assign new_n439_ = x46 & ~x47 & ~x48 & new_n201_ & ~x50 & x51;
  assign new_n440_ = ~x46 & ~x51 & x50 & x53;
  assign new_n441_ = ~x46 & ~x49 & ~x47 & x48;
  assign z37 = new_n404_ & new_n135_ & ~x50 & ~x52;
  assign z39 = new_n169_ & new_n441_ & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & (new_n427_ | (new_n119_ & ~x49 & new_n181_ & x51));
  assign z42 = new_n181_ & new_n153_ & x51 & ~x50 & ~x46 & ~x47;
  assign z43 = new_n169_ & new_n153_ & x51 & ~x50 & ~x46 & ~x47;
  assign z44 = new_n441_ & ((x50 & (~x51 ^ ~x52)) | (x53 & ~x50 & ~x51 & x52));
  ...
  assign z49 = (~new_n452_ & ~x48) | (new_n181_ & new_n298_ & new_n129_ & x48 & ~x49);
  assign new_n452_ = (new_n453_ | x50) & (~new_n119_ | x49 | ~new_n181_ | ~x50 | x51);
  assign new_n453_ = (~x51 | ~x52 | ~x53 | x49 | x46 | ~x47) & (x47 | ((x46 | x52 | ~x53 | x49 | ~x51) & (~x49 | ~x52 | ~x46 | (~x51 ^ x53))));
  assign z02 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
  assign z18 = 1'b0;
