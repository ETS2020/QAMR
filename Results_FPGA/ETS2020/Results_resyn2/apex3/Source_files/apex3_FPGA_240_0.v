// Benchmark "FAU" written by ABC on Wed Jul 29 21:33:13 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n358_, new_n359_, new_n360_, new_n364_, new_n370_, new_n371_;
  ...
  assign new_n146_ = x01 & ((new_n111_ & x26 & ~x49) | (new_n147_ & new_n144_));
  ...
  assign new_n203_ = ~x50 & x51 & new_n123_ & ~x38 & ~x43;
  ...
  assign new_n238_ = new_n113_ & ((~x32 & ~x47 & ~x49 & ~x50) | ((~x31 | x49) & x47 & (~x49 | ~x50)));
  assign new_n239_ = (x50 | ((x34 | x47) & (x49 | (x27 & x47)))) & x51 & (~x47 | ~x49 | ~x50);
  assign new_n240_ = (x47 | ~x49 | ((~x29 | ~x50) & (~x20 | x50 | x51))) & ((~x47 & x50) | x49 | x51);
  ...
  assign new_n251_ = ~x49 & ((x53 & (new_n252_ | x48 | ~x50)) | ((~new_n121_ | ~x48) & ~x50 & ~x53));
  ...
  assign new_n272_ = ((x49 & ~x52) | (~x50 & (~x05 | x52))) & (~new_n273_ | ((x20 | x52) & x49 & ~x50));
  ...
  assign new_n301_ = (x51 | x52) & ((x20 & x50) | ~x49 | ~x51);
  ...
  assign new_n309_ = (new_n310_ | ~x48 | x50) & (~new_n113_ | x48 | (~x50 & (x33 | x52)));
  assign new_n310_ = (~new_n266_ | ~x26) & (~new_n185_ | x29);
  ...
  assign new_n315_ = (x51 | x53) & (~x51 | ~x53) & new_n114_ & (~x49 | x51);
  ...
  assign z11 = (~new_n321_ & ~x47) | (new_n324_ & (x49 ? (x50 & ~x51) : (~x50 & x51)));
  ...
  assign new_n324_ = new_n110_ & x52 & ~x48 & ~x53;
  ...
  assign new_n329_ = (new_n330_ | x46) & (~new_n328_ | ~x53 | new_n117_ | ~x46 | x47);
  ...
  assign z18 = (new_n114_ & ~new_n336_) | (new_n335_ & (~x48 | (new_n147_ & x23)));
  ...
  assign new_n339_ = new_n114_ & (~x51 ^ ~x52) & new_n340_ & (~x50 | x52) & (x50 | ~x52);
  ...
  assign new_n345_ = new_n147_ & x49 & ~x53 & new_n114_ & ~x48 & x50;
  assign new_n346_ = (x48 | x53 | (x49 ? (x50 | x51) : (~x50 | ~x51))) & (~x49 | ~x51 | ~x53 | ~x48 | x50);
  assign z25 = ~new_n113_ & new_n117_ & ~x46 & new_n138_ & ~x47 & x48;
  ...
  assign z29 = new_n185_ & new_n110_ & new_n169_ & x48 & x49;
  ...
  assign z41 = ~x50 & (new_n364_ | (new_n110_ & ~x49 & new_n132_ & x51));
  assign new_n364_ = new_n349_ & new_n147_ & x49 & ~x53;
  assign z42 = new_n132_ & new_n139_ & ~x48 & new_n138_ & x51;
  assign z43 = new_n185_ & new_n139_ & ~x48 & new_n138_ & x51;
  assign z44 = new_n359_ & new_n117_ & (new_n132_ | x50);
  assign z46 = new_n132_ & new_n110_ & new_n169_ & x48 & x49;
  assign z49 = (~x48 & (new_n370_ | (new_n322_ & new_n110_ & ~x49))) | (new_n322_ & new_n114_ & x48 & ~x49);
  assign new_n370_ = ~new_n371_ & ~x50;
  assign new_n371_ = (~x51 | ~x52 | ~x53 | x49 | x46 | ~x47) & ((x46 & (~x49 | ~x52 | (x51 ^ ~x53))) | x47 | (~x46 & (x52 | ~x53 | x49 | ~x51)));
  assign z01 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z12 = 1'b0;
