// Benchmark "FAU" written by ABC on Wed Jul 29 21:33:38 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n333_, new_n335_, new_n336_, new_n339_, new_n341_, new_n346_,
    new_n348_, new_n352_;
  ...
  assign z02 = new_n131_ | (~x46 & ((~new_n140_ & x48) | (~new_n163_ & ~new_n159_ & ~x48)));
  assign new_n131_ = ~x47 & (new_n138_ | (~new_n132_ & x46));
  ...
  assign new_n138_ = new_n139_ & x50 & x51 & new_n135_ & x03;
  assign new_n139_ = x52 & x53;
  assign new_n140_ = (new_n148_ | ~x52) & (new_n153_ | x52) & (new_n141_ | ~x47) & (new_n156_ | x47);
  assign new_n141_ = (~new_n146_ | (~new_n142_ & ~x52)) & ~new_n147_ & (new_n144_ | ~x01);
  assign new_n142_ = (x50 | x51 | ~new_n143_ | ~x01) & (~x50 | ~x51 | (~x53 & (~x01 | ~x26)));
  assign new_n143_ = ~x38 & x43;
  assign new_n144_ = ~new_n145_ & (~new_n143_ | x51 | x52 | ~x53);
  ...
  assign new_n163_ = (new_n164_ | x53) & x47 & (new_n165_ | ~new_n154_ | ~x53);
  ...
  assign z04 = (~new_n167_ & x50) | (~new_n192_ & ~x50) | (~new_n206_ & new_n161_ & new_n207_);
  assign new_n167_ = ~new_n177_ & (x46 | (new_n168_ & ~new_n185_ & (new_n190_ | x52)));
  ...
  assign new_n174_ = (~x49 | (new_n139_ & ~x51)) & ~x20 & (x48 | x49);
  ...
  assign new_n178_ = x52 & ((~new_n179_ & x51) | (x46 & ~x51 & (new_n180_ | ~x48)));
  assign new_n179_ = (x03 | ((~x53 | x48 | ~x49) & (x49 | x53 | ~x46 | ~x48))) & (((~x48 | x49) & (x53 | (~x21 & ~x49))) | ~x46 | (x48 & ~x53));
  assign new_n180_ = ~x49 & (x04 | x53);
  ...
  assign new_n184_ = new_n157_ & x51;
  ...
  assign new_n189_ = x49 & x52 & x29 & ~x47 & x48;
  ...
  assign new_n197_ = (x46 | x48 | ~new_n139_ | x51) & (~x51 | (~new_n198_ & (~new_n139_ | x39 | ~x46 | x48)));
  ...
  assign new_n205_ = (~x49 ^ x51) & (x13 | x49) & new_n139_ & (~x48 | x49);
  ...
  assign new_n214_ = (~x51 | (x53 ? x42 : ~x39)) & new_n154_ & (~x29 | x51 | x53);
  ...
  assign new_n247_ = (new_n248_ | x50) & (~new_n251_ | x20 | ~new_n139_ | ~x50 | x51);
  ...
  assign new_n273_ = ((~x31 & ~x49) | ~x47 | (x49 & ~x50)) & new_n149_ & (x47 | (~x32 & ~x49 & ~x50));
  assign new_n274_ = ((x47 & (x27 | x49)) | x50 | (x34 & x49)) & x51 & (~x50 | ~x47 | ~x49);
  ...
  assign new_n287_ = x46 & ~x51 & ((~new_n288_ & ~x49) | (~new_n292_ & ~x48 & x49));
  assign new_n288_ = (new_n289_ | x50) & (((~x48 | (x04 & ~x53)) & (x52 | (~x48 & ~x53))) | ~x50 | (~x52 & x48 & (~x04 | x53)));
  assign new_n289_ = (new_n291_ | x53) & (~new_n290_ | ~x14 | ~x53);
  ...
  assign new_n298_ = (new_n299_ | ~x51) & (~new_n139_ | ~x50 | x51 | ~new_n122_ | x46);
  ...
  assign new_n304_ = new_n139_ & ~x51;
  assign z14 = new_n306_ & new_n251_ & ~x46 & x48;
  assign new_n306_ = new_n149_ & x50 & ~x52;
  assign z16 = new_n309_ | (~x48 & (new_n308_ | (~new_n310_ & ~x49 & x52)));
  assign new_n308_ = new_n207_ & x49 & x50 & ~x52 & (x51 | ~x53);
  assign new_n309_ = new_n204_ & x50 & ~x51 & x48 & new_n207_ & x49;
  ...
  assign new_n315_ = (x51 | x52 | ~x53 | x48 | ~x49 | x50) & (x49 | ~x51 | ((~x48 | x53 | (x50 & x52) | (~x50 & ~x52)) & (~x52 | ~x53 | x48 | ~x50)));
  assign z20 = (~x52 ^ ~x53) & new_n317_ & x51;
  assign new_n317_ = new_n251_ & ~x50 & ~x46 & x48;
  assign z21 = x51 & (new_n319_ | (new_n320_ & x46 & ~x47 & ~x48));
  assign new_n319_ = new_n154_ & ~x46 & new_n204_ & x47 & x48;
  assign new_n320_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~new_n322_ & ~x46) | (new_n306_ & new_n135_ & x46 & ~x47);
  assign new_n322_ = ~new_n323_ & ((~x48 ^ x50) | ~new_n304_ | ~x47 | ~x49);
  ...
  assign z24 = ((x46 & ~x47) | (x50 & ~x51)) & new_n327_ & (~x46 | x51) & new_n290_ & (x47 | ~x50);
  assign new_n327_ = x49 & ~x53;
  ...
  assign new_n339_ = (x51 | x52 | x53 | x50 | x46 | ~x48) & (~x46 | x48 | ~x52 | ~x53 | ~x50 | ~x51);
  assign z34 = new_n341_ & (x52 ^ (x48 | x53));
  assign new_n341_ = ~x46 & new_n118_ & x47 & ~x51;
  assign z36 = new_n304_ & new_n317_;
  assign z37 = new_n251_ & new_n157_ & ~x51 & ~x50 & ~x46 & x48;
  assign z38 = new_n157_ & new_n317_ & x51;
  assign z39 = new_n346_ & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign new_n346_ = x48 & ~x49 & ~x52 & x53 & ~x46 & ~x47;
  assign z40 = ~x52 & ((~new_n348_ & ~x51) | (~x48 & x50 & new_n207_ & x51));
  assign new_n348_ = (~x53 | ~x48 | x50 | x49 | ~x46 | x47) & ((~x48 & x53) | ~x49 | ~x50 | x46 | ~x47);
  assign z46 = x48 & new_n207_ & x49 & new_n139_ & x50 & x51;
  assign z47 = ~x50 & x48 & ~x49 & new_n184_ & ~x46 & ~x47;
  assign z48 = new_n352_ & new_n157_ & x27 & ~x43;
  assign new_n352_ = ~x49 & x51 & new_n207_ & ~x48 & ~x50;
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
