// Benchmark "FAU" written by ABC on Tue Jul 28 23:25:22 2020
...
module FAU ( 
  ...
  assign z4 = x9 & ((~new_n71_ & ~x5) | ~new_n83_ | (~new_n76_ & x5));
  assign new_n71_ = ~new_n72_ & (new_n75_ | ~x4) & (~x6 | x7 | x8);
  assign new_n72_ = x0 & (new_n73_ | new_n74_);
  assign new_n73_ = (~x8 | (x2 & x7)) & (x1 | (x3 & x4));
  assign new_n74_ = x6 & ((x7 & x3 & x4) | (~x2 & ~x7) | (~x4 & ~x8));
  assign new_n75_ = (~x2 | ((~new_n21_ | x0) & (~x3 | x8))) & (~new_n21_ | x1 | ~x3);
  assign new_n76_ = (new_n77_ | x3) & (new_n82_ | ~x4) & (new_n81_ | ~x1 | ~x3);
  assign new_n77_ = ~new_n78_ & ~new_n79_ & ~new_n80_;
  assign new_n78_ = (~x7 | (~x0 & ~x2 & ~x8)) & (x0 ^ ~x2) & ~x1 & (x6 | ~x8);
  assign new_n79_ = ((x0 & x2) | x4 | (~x2 & ~x8)) & ~x6 & ((~x4 & x7) | ~x0 | ~x2);
  assign new_n80_ = (x1 | (x0 & ~x2)) & x7 & ~x4 & x6;
  assign new_n81_ = (~new_n21_ | (~x0 ^ ~x2)) & (x0 | x2 | x4 | x8);
  assign new_n82_ = (x1 | (x0 & (x2 | x6))) & (x7 | (x6 & (~x2 | ~x3)));
  assign new_n83_ = (new_n86_ | ~x0) & (new_n84_ | ~x1);
  assign new_n84_ = (~x7 | ((~x6 | ~x4 | x5) & ((x4 & x5) | ~x3 | x6))) & (x5 | (~new_n85_ & (x3 | ~x6 | x7)));
  assign new_n85_ = ~x8 & x2 & x4;
  assign new_n86_ = (new_n87_ | x4 | ~x7) & (~x1 | x6 | x7 | x8);
  assign new_n87_ = (x3 | ~x6 | x8) & (~x1 | (x8 & (x2 | ~x6)));
  assign z2 = 1'b0;
  assign z3 = 1'b0;
  assign z5 = 1'b0;
endmodule
