// Benchmark "FAU" written by ABC on Tue Jul 28 23:26:36 2020
...
module FAU ( 
  ...
  assign new_n39_ = (new_n40_ | x3) & (new_n41_ | ~new_n42_ | ~x3 | ~x4);
  assign new_n40_ = ((x8 & (~x2 | ~x7)) | ~x0 | (x6 & ~x8)) & (x6 | x8 | ~x2 | ~x4);
  assign new_n41_ = x8 & (~x0 | x2);
  ...
  assign z2 = x1 ^ ~x3;
  assign z3 = x1 & x3;
  assign z4 = x9 & ((~new_n64_ & ~x5) | ~new_n75_ | (~new_n69_ & x5));
  assign new_n64_ = ~new_n65_ & (~x6 | x7 | x8) & (new_n68_ | ~x4);
  assign new_n65_ = x0 & (new_n66_ | new_n67_);
  assign new_n66_ = (~x8 | (x2 & x7)) & (x1 | (x3 & x4));
  assign new_n67_ = x6 & ((x7 & x3 & x4) | (~x2 & ~x7) | (~x4 & ~x8));
  assign new_n68_ = (~x2 | ((~new_n42_ | x0) & (~x3 | x8))) & (~new_n42_ | x1 | ~x3);
  assign new_n69_ = ~new_n72_ & (new_n74_ | ~x4) & (x3 | (new_n70_ & ~new_n73_));
  assign new_n70_ = ~new_n71_ & ((~x1 & (~x0 | x2)) | ~new_n30_ | ~x7);
  assign new_n71_ = (~x7 | (~x0 & ~x2 & ~x8)) & ~x1 & (x6 | ~x8) & (~x0 ^ x2);
  assign new_n72_ = z3 & ((new_n42_ & (x0 ^ ~x2)) | (~x4 & ~x0 & ~x2 & ~x8));
  assign new_n73_ = ~x6 & ((~x4 & x7 & x0 & x2) | (~x2 & ~x8) | (x4 & (~x0 | ~x2)));
  assign new_n74_ = (x1 | (x0 & (x2 | x6))) & (x7 | (x6 & (~x2 | ~x3)));
  assign new_n75_ = (new_n76_ | ~x1) & (new_n78_ | ~x0);
  assign new_n76_ = (~x7 | ((~x6 | ~x4 | x5) & (~x3 | x6 | (x4 & x5)))) & (x5 | (~new_n77_ & (x3 | ~x6 | x7)));
  assign new_n77_ = ~x8 & x2 & x4;
  assign new_n78_ = (new_n79_ | x4 | ~x7) & (~x1 | x6 | x7 | x8);
