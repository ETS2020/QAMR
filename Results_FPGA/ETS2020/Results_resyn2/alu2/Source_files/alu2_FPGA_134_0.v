// Benchmark "FAU" written by ABC on Tue Jul 28 23:26:14 2020
...
module FAU ( 
  ...
  assign new_n33_ = ((x8 & (~x2 | ~x4)) | ~x0 | (~x8 & (x5 | ~x7))) & (~x2 | ~x4 | ~x7 | x8);
  ...
  assign new_n42_ = (new_n43_ | ~x6 | ~x7) & (new_n44_ | x7 | x6 | ~x9);
  assign new_n43_ = (~x4 | (~x0 & (~x5 | x8))) & x9 & (x0 | x4 | x5);
  assign new_n44_ = ~x8 & ((~x2 & x5) | x0 | (x2 & x4));
  ...
  assign new_n61_ = ((~new_n62_ & x8) | new_n63_ | ~x9) & ~x3 & (new_n50_ | x9);
  assign new_n62_ = (x0 | ~x5) & ((x7 & (~x2 | x4)) | (x0 & ~x2) | ~x6 | (~x0 & x2));
  assign new_n63_ = x2 & ~x4 & ~x0 & x5;
