// Benchmark "FAU" written by ABC on Tue Jul 28 23:26:12 2020
...
module FAU ( 
  ...
  assign new_n68_ = ~new_n71_ & (new_n73_ | ~x4) & (x3 | (new_n69_ & ~new_n72_));
  assign new_n69_ = ~new_n70_ & ((~x1 & (~x0 | x2)) | ~new_n30_ | ~x7);
  assign new_n70_ = (~x7 | (~x0 & ~x2 & ~x8)) & ~x1 & (x6 | ~x8) & (~x0 ^ x2);
  assign new_n71_ = z3 & ((new_n42_ & (x0 ^ ~x2)) | (~x4 & ~x0 & ~x2 & ~x8));
  assign new_n72_ = ~x6 & ((~x4 & x7 & x0 & x2) | (~x2 & ~x8) | (x4 & (~x0 | ~x2)));
