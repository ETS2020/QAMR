// Benchmark "FAU" written by ABC on Wed Jul 29 06:10:17 2020
...
module FAU ( 
  ...
  assign z08 = x14 & ~x20;
  assign z09 = (~x17 & (new_n116_ | (x18 & (new_n110_ | new_n118_)))) | (new_n120_ & x17 & ~x18);
  ...
  assign z10 = new_n124_ | (~new_n122_ & ~x09 & (new_n123_ | new_n83_ | ~x07));
  assign new_n122_ = ~x07 & (~x17 | x18) & (new_n85_ | x17 | ~x18 | x06 | x08);
  assign new_n123_ = new_n84_ & x19 & x08 & x05 & ~x15;
  ...
  assign z15 = x05 & new_n120_ & x17 & ~x18;
  ...
  assign z17 = ~x09 & ((~new_n147_ & ~x05) | (new_n68_ & new_n107_));
  assign new_n147_ = (~x17 | x18 | ~x07 | x15) & (x07 | (~new_n148_ & (~x17 | x18 | ~x00 | ~x15)));
  assign new_n148_ = new_n149_ & ((new_n119_ & x06) | (~x04 & ~x06 & x12));
  assign new_n149_ = (~x14 | ~x21) & new_n84_ & ~x08 & ~x15;
  ...
  assign new_n162_ = new_n63_ & x09 & x18 & x08 & x05 & ~x15;
  assign z22 = new_n84_ & ~new_n164_;
  ...
  assign new_n174_ = ~x07 & ((new_n78_ & x15) | (new_n115_ & x12 & ~x15));
  assign new_n175_ = ~new_n176_ & ~x07 & ~x08 & ~x05 & ~x09;
  assign new_n176_ = (~x15 | x19) & (new_n104_ | x14 | x15 | ~x21);
  assign new_n177_ = (~x13 | x02 | x11) & new_n178_ & new_n56_ & ~x21;
  assign new_n178_ = ~x07 & ~x09 & x10 & x12;
  assign new_n179_ = x15 & ((~new_n78_ & ~x02) | x07 | ~x11);
