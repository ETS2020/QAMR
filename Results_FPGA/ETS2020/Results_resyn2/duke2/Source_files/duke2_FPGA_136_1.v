...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n92_, new_n93_, new_n95_, new_n97_, new_n100_, new_n101_,
  ...
  assign new_n57_ = ~x07 & x18 & (new_n62_ | (~new_n58_ & ~x09 & ~x15));
  ...
  assign new_n62_ = ~x02 & x11 & x08 & x15 & (x09 | ~x21);
  assign new_n63_ = new_n64_ & x18 & ~x21 & ~x09 & ~x11 & x15;
  assign new_n64_ = ~x04 & x08 & x05 & ~x07;
  assign new_n65_ = ~x09 & ~x18 & x02 & x07 & x11 & x15;
  assign z04 = ~x14 & ~x20;
  assign z08 = x14 & ~x20;
  assign z10 = (new_n69_ & (x09 | (x05 & ~x19))) | (~new_n71_ & ~new_n73_ & ~x09);
  assign new_n69_ = x08 & ~x15 & (~x05 | x07) & new_n70_ & (x05 | ~x07);
  assign new_n70_ = ~x17 & x18;
  assign new_n71_ = (~new_n72_ | ~x19 | x17 | ~x18) & x07 & (x18 | x05 | ~x17);
  assign new_n72_ = x08 & x05 & ~x15;
  assign new_n73_ = ((~x05 ^ x15) | ~new_n74_ | x17 | ~x18) & ~x07 & (~x17 | x18);
  ...
  assign new_n83_ = new_n64_ & x18 & ~x21 & ~x17 & ~x11 & x15;
  assign z19 = ~x05 & ~x07 & ~x15 & x17 & ~x09 & ~x18;
  assign z20 = ~x07 & ~x17 & (new_n93_ | (~new_n86_ & new_n92_));
  assign new_n86_ = new_n89_ & (x21 | (~new_n87_ & (new_n91_ | x04)));
  assign new_n87_ = new_n60_ & ~x15 & (x05 ? x08 : (new_n88_ | (~x06 & ~x08)));
  ...
  assign new_n93_ = new_n72_ & new_n60_ & x09 & x18;
  assign z21 = new_n70_ & ~new_n95_;
  assign new_n95_ = (x07 | ((x08 | x15 | x09 | ~x05 | ~x06) & ((x06 & (~x09 | ~x08 | x15)) | x05 | (~x06 & (x08 | x09 | ~x15))))) & (x09 | x05 | ~x07 | ~x08 | ~x15);
  assign z22 = new_n70_ & ~new_n97_;
  assign new_n97_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x08 | x15 | x09 | ~x05 | ~x06) & (x05 | ((~x09 | ~x08 | x15) & (~x06 | x08 | x09 | ~x15)))));
  assign z23 = new_n70_ & ~x05 & ~x07 & x09 & x08 & ~x15;
  ...
  assign z27 = (~new_n107_ & ~x09) | (new_n112_ & x09 & x08 & ~x15);
  assign new_n107_ = ~new_n110_ & (~new_n109_ | (new_n111_ & (new_n108_ | x21)));
  assign new_n108_ = (new_n91_ | x04) & (~new_n103_ | ~x06 | ~x02 | x11);
  assign new_n109_ = new_n70_ & (~x07 | ((~x05 ^ ~x15) & x08 & x19));
  assign new_n110_ = (x07 ? ~x15 : (x00 & x15)) & ~x18 & ~x05 & x17;
  assign new_n111_ = ~x07 & (~x05 | x15 | x08 | ~x19);
  assign new_n112_ = new_n70_ & x19 & x03 & ~x05 & ~x07;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
