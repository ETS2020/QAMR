...
module FAU ( 
  ...
  assign z03 = (~new_n81_ & ~new_n86_ & ~x09) | (new_n87_ & new_n85_ & x09 & ~x15);
  assign new_n81_ = (new_n82_ | ~new_n83_) & ~new_n84_ & x07;
  ...
  assign z10 = new_n124_ | ((new_n122_ | new_n84_ | ~x07) & ~new_n123_ & ~x09);
  assign new_n122_ = new_n85_ & x19 & x08 & x05 & ~x15;
  assign new_n123_ = ~x07 & (~x17 | x18) & (new_n82_ | x17 | ~x18 | x06 | x08);
  assign new_n124_ = (~x05 | (x07 & (x09 | ~x19))) & new_n83_ & (x05 | x09) & ~x15 & (x05 | ~x07);
  assign z12 = ~new_n126_ & ~x09;
  assign new_n126_ = (~new_n84_ | ~x07 | x15) & (x07 | ((new_n127_ | ~new_n107_) & (~new_n84_ | ~x00 | ~x15)));
  assign new_n127_ = (new_n128_ | x05) & ~new_n130_ & (~x05 | ~x08 | ~new_n64_ | x15);
  assign new_n128_ = (~new_n62_ | ~x08 | ~x15) & (x15 | ((new_n129_ | x08) & (~new_n100_ | ~x08 | x14)));
  ...
  assign new_n134_ = (new_n135_ | x07 | (~x09 & x21)) & (new_n82_ | ~x07 | x19);
  ...
  assign z16 = new_n83_ & ((~new_n140_ & ~x05) | (~new_n57_ & x09 & x05 & ~x15));
  ...
  assign z17 = ~x09 & ((~new_n146_ & ~x05) | (new_n66_ & new_n107_));
  assign new_n146_ = (~x07 | x15 | ~x17 | x18) & (x07 | (~new_n147_ & (~x17 | x18 | ~x00 | ~x15)));
  assign new_n147_ = ~new_n148_ & (~x14 | ~x21) & new_n85_ & ~x08 & ~x15;
  ...
  assign z21 = new_n85_ & ~new_n163_;
  assign new_n163_ = (x07 | ((~x05 | x08 | ~x06 | x09 | x15) & ((x06 & (~x08 | ~x09 | x15)) | x05 | (~x06 & (x08 | x09 | ~x15))))) & (x09 | ~x07 | ~x08 | x05 | ~x15);
  assign z22 = new_n85_ & ~new_n165_;
  assign new_n165_ = (~x07 | ~x08 | x05 | ~x15) & (x07 | ((~x05 | x08 | ~x06 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)))));
  assign z25 = new_n67_ & ~x05 & ~x17 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z27 = (new_n172_ & new_n85_ & x19) | (~x09 & (new_n171_ | (~new_n168_ & new_n85_)));
  assign new_n168_ = (x07 | (~new_n169_ & (~x05 | x08 | x15 | ~x19))) & ((x05 ^ ~x15) | ~x19 | ~x07 | ~x08);
  assign new_n169_ = ~x21 & (new_n130_ | new_n170_);
  assign new_n170_ = ~x05 & ~x15 & x02 & ~x11 & x06 & ~x08;
  assign new_n171_ = new_n84_ & (x15 ? (x00 & ~x07) : x07);
  assign new_n172_ = new_n87_ & x03 & x09 & ~x15;
  assign z28 = (~x17 & (new_n180_ | (~new_n174_ & x18))) | (~new_n181_ & ~x09 & x17 & ~x18);
  assign new_n174_ = (~x08 | (~new_n175_ & (new_n178_ | x07))) & (new_n179_ | ~new_n136_ | x07 | x08);
  assign new_n175_ = ~x05 & (new_n177_ | (new_n176_ & (~x13 | x02 | x11)));
  assign new_n176_ = new_n56_ & ~x21 & ~x07 & ~x09 & x10 & x12;
  assign new_n177_ = x15 & (x07 | ~x11 | (~x02 & (x09 | ~x21)));
  assign new_n178_ = (~new_n115_ | ~x12 | x15) & (~x15 | x09 | ~x21);
  assign new_n179_ = (~x15 | x19) & (new_n104_ | x14 | x15 | ~x21);
  assign new_n180_ = new_n138_ & x07 & x15 & (~x02 | ~x11);
