// Benchmark "FAU" written by ABC on Wed Jul 29 06:09:00 2020
...
module FAU ( 
  ...
  assign z08 = x14 & ~x20;
  assign z09 = (~x09 & x17 & new_n118_ & ~x07) | (~x17 & (new_n109_ | (new_n117_ & ~x07 & ~x09)));
  assign new_n109_ = x18 & ((new_n64_ & ~new_n116_) | (~new_n110_ & ~x15));
  assign new_n110_ = ~new_n115_ & (x07 | (~new_n111_ & (x09 | (~new_n112_ & ~new_n113_))));
  assign new_n111_ = new_n75_ & x05 & x08;
  assign new_n112_ = ~x08 & ((x05 & ~x19) | (~new_n101_ & ~x05 & ~x21));
  assign new_n113_ = new_n114_ & ((x04 & ~x12) | (~x05 & (~x10 | x12)));
  assign new_n114_ = x08 & ~x21 & x02 & x13 & ~x14;
  assign new_n115_ = (x07 | ~x12) & x05 & x08;
  assign new_n116_ = (~x05 | x09 | ~x21) & (x05 | ~x15 | ~x02 | x11 | (~x09 & x21));
  assign new_n117_ = ~x14 & x04 & x12 & new_n118_ & ~x05 & ~x21;
  assign new_n118_ = ~x15 & ~x18;
  assign z10 = new_n120_ | (~new_n123_ & ~x09 & (new_n122_ | new_n79_ | ~x07));
  assign new_n120_ = new_n121_ & ((x09 & ~x05 & ~x07) | (x05 & x07 & (x09 | ~x19)));
  assign new_n121_ = ~x15 & ~x17 & x08 & x18;
  assign new_n122_ = new_n80_ & x19 & x08 & x05 & ~x15;
  assign new_n123_ = ~x07 & (~x17 | x18) & (new_n81_ | x17 | ~x18 | x06 | x08);
  assign z11 = ~x18 & x01 & x07 & new_n125_ & ~x09 & ~x17;
  assign new_n125_ = ~x05 & ~x15;
  assign z12 = ~x09 & ((~x07 & (new_n127_ | (new_n79_ & x00 & x15))) | (new_n79_ & x07 & ~x15));
  assign new_n127_ = new_n103_ & ((~new_n128_ & ~x05) | new_n130_ | (new_n104_ & x08));
  assign new_n128_ = (~new_n60_ | ~x08 | ~x15) & (x15 | ((~new_n97_ | ~x08 | x14) & (new_n129_ | x08)));
  assign new_n129_ = new_n101_ & (~x06 | ~x02 | x11);
  assign new_n130_ = ~new_n131_ & ~x04;
  assign new_n131_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | ~x12 | x08 | x15);
  ...
  assign new_n135_ = (new_n81_ | ~x07 | x19) & (new_n136_ | x07 | (~x09 & x21));
  assign new_n136_ = ~new_n104_ & (~new_n60_ | x05 | ~x15);
  assign new_n137_ = ~x18 & ~x05 & ~x09;
  assign new_n138_ = (~x07 | ~x15) & (x14 | x21 | x07 | ~x12 | ~x04 | x15);
  assign z15 = x05 & ~x09 & x17 & new_n118_ & ~x07;
  assign z16 = ~new_n141_ & ~new_n146_ & ~x17 & x08 & x18;
  assign new_n141_ = (new_n142_ | x07 | x15) & ~x05 & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n142_ = (~x09 | x19) & (new_n143_ | x09 | x14 | x21);
  assign new_n143_ = (~x06 | (~new_n145_ & (new_n144_ | ~x12 | x16))) & ~new_n97_ & (new_n144_ | ~x16 | x06 | ~x12);
  assign new_n144_ = x13 & (x02 | ~x11);
  assign new_n145_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n146_ = x05 & ((~x07 & x12) | ~x09 | x15);
  assign z17 = ~x09 & ((~new_n148_ & ~x05) | (new_n63_ & new_n103_));
  assign new_n148_ = (~x17 | x18 | ~x07 | x15) & (x07 | (~new_n149_ & (~x17 | x18 | ~x00 | ~x15)));
  assign new_n149_ = ~new_n150_ & (~x14 | ~x21) & new_n80_ & ~x08 & ~x15;
  assign new_n150_ = x06 ? (~x02 | x11) : (x04 | ~x12);
  assign z18 = new_n92_ & ((~new_n152_ & ~x14 & ~x15) | (x19 & ~x08 & x15));
  assign new_n152_ = ~new_n90_ & (~x12 | (~new_n154_ & (new_n153_ | x06)));
  assign new_n153_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x10 | ~x08 | x21);
  assign new_n154_ = x10 & x08 & ~x21 & x06 & ~x13 & x16;
  assign z19 = ~x05 & ~x09 & x17 & new_n118_ & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n161_ | (~x09 & (new_n157_ | new_n117_)));
  assign new_n157_ = x18 & ((~new_n158_ & ~x21) | (new_n160_ & (x04 ^ x12)));
  assign new_n158_ = ~new_n130_ & (new_n159_ | (x05 & ~x08) | ~new_n58_ | x15);
  assign new_n159_ = (new_n144_ | ~x10 | ~x08 | x14) & ~x05 & (x06 | x08);
  assign new_n160_ = ~x05 & ~x06 & ~x14 & x21 & ~x08 & ~x15;
  assign new_n161_ = x08 & x05 & ~x15 & new_n58_ & x09 & x18;
  assign z21 = new_n80_ & ~new_n163_;
  assign new_n163_ = (x07 | ((~x05 | x08 | ~x06 | x09 | x15) & ((x06 & (~x08 | ~x09 | x15)) | x05 | (~x06 & (x08 | x09 | ~x15))))) & (x09 | x05 | ~x07 | ~x08 | ~x15);
  assign z22 = new_n80_ & ~new_n165_;
  assign new_n165_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | x08 | ~x06 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)))));
  assign z23 = new_n121_ & x09 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n172_ | (~new_n168_ & ~x07));
  assign new_n168_ = (new_n169_ | x21) & (~x18 | ~new_n125_ | x08);
  assign new_n169_ = (new_n170_ | ~x04 | x15) & (~new_n171_ | (~new_n60_ & (x04 | ~x05)));
  assign new_n170_ = (~x05 | x12 | ~x08 | ~x18) & (x14 | x18 | x05 | ~x12);
  assign new_n171_ = (~x05 | ~x11) & x18 & x08 & x15;
  assign new_n172_ = new_n118_ & ~x05 & x08 & x01 & x07;
  assign z25 = new_n80_ & ~x05 & ~x07 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = (new_n179_ & new_n80_ & x19) | (~x09 & (new_n180_ | (~new_n176_ & new_n80_)));
  assign new_n176_ = (x07 | (~new_n177_ & (x15 | ~x19 | ~x05 | x08))) & (~x07 | ~x19 | ~x08 | (x05 ^ ~x15));
  assign new_n177_ = ~x21 & (new_n130_ | new_n178_);
  assign new_n178_ = new_n125_ & ~x08 & x06 & x02 & ~x11;
  assign new_n179_ = new_n82_ & x03 & x09 & ~x15;
  assign new_n180_ = (x07 | (x00 & x15)) & new_n79_ & (~x07 | ~x15);
  assign z28 = (~new_n182_ & ~x17) | (z13 & ~new_n125_ & (~x07 | ~x19));
  assign new_n182_ = ~new_n190_ & (~x18 | (~new_n187_ & (~x08 | (~new_n183_ & ~new_n189_))));
  assign new_n183_ = ~x05 & (new_n186_ | (new_n184_ & (~x13 | x02 | x11)));
  assign new_n184_ = new_n185_ & ~x21 & ~x14 & ~x15;
  assign new_n185_ = ~x07 & ~x09 & x10 & x12;
  assign new_n186_ = x15 & (x07 | ~x11 | (~x02 & (x09 | ~x21)));
  assign new_n187_ = ~new_n188_ & ~x05 & ~x09 & ~x07 & ~x08;
  assign new_n188_ = (~x15 | x19) & (new_n101_ | ~x21 | x14 | x15);
  assign new_n189_ = ~x07 & ((x21 & ~x09 & x15) | (new_n75_ & x05 & ~x15));
  assign new_n190_ = new_n61_ & ~x18 & ~new_n62_ & ~x05 & x07;
  assign z00 = 1'b0;
endmodule
