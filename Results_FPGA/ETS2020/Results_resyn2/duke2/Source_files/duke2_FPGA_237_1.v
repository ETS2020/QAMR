...
module FAU ( 
  ...
  assign new_n63_ = ~x04 & ~x07 & x05 & x08;
  assign new_n64_ = x07 & x15 & ~x09 & ~x18 & x02 & x11;
  assign z04 = ~x14 & ~x20;
  assign z07 = new_n67_ & ~new_n68_;
  assign new_n67_ = ~x17 & x18;
  assign new_n68_ = ((x05 ^ ~x15) | x09 | (~x07 ^ ~x08)) & (~x09 | ~x08 | x15 | ~x16 | x05 | x07);
  assign z08 = x14 & ~x20;
  assign z10 = new_n71_ | (((~x05 & x09) | (x07 & (x09 | ~x19))) & new_n75_ & (x05 | ~x07));
  assign new_n71_ = (new_n72_ | ~x07 | (new_n74_ & ~x05)) & ~x09 & (new_n73_ | new_n74_ | x07);
  assign new_n72_ = new_n67_ & x19 & x08 & x05 & ~x15;
  assign new_n73_ = (~x05 ^ ~x15) & new_n67_ & ~x06 & ~x08;
  assign new_n74_ = x17 & ~x18;
  assign new_n75_ = new_n67_ & x08 & ~x15;
  assign z11 = new_n77_ & ~x09 & ~x17;
  assign new_n77_ = ~x05 & ~x15 & ~x18 & x01 & x07;
  assign z15 = x05 & ~x15 & new_n74_ & ~x07 & ~x09;
  assign z17 = ~x09 & (new_n80_ | new_n83_);
  assign new_n80_ = ~x05 & ((~x07 & (new_n81_ | (new_n74_ & x00 & x15))) | (new_n74_ & x07 & ~x15));
  ...
  assign z19 = ~x05 & ~x15 & new_n74_ & ~x07 & ~x09;
  ...
  assign new_n94_ = new_n95_ & x08 & x05 & ~x15;
  assign new_n95_ = x09 & x18 & x04 & ~x12;
  assign z21 = new_n67_ & ~new_n97_;
  assign new_n97_ = (x07 | ((~x05 | x15 | x09 | ~x06 | x08) & ((x06 & (~x09 | ~x08 | x15)) | x05 | (~x06 & (x08 | x09 | ~x15))))) & (x09 | ~x07 | ~x08 | x05 | ~x15);
  assign z22 = new_n67_ & ~new_n99_;
  assign new_n99_ = (~x07 | ~x08 | x05 | ~x15) & (x07 | ((~x05 | x15 | x09 | ~x06 | x08) & (x05 | ((~x09 | ~x08 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = new_n75_ & ~x07 & ~x05 & x09;
  ...
  assign new_n104_ = ~x05 & ~x15 & x12 & ~x14 & x04 & ~x18;
  ...
  assign new_n110_ = ~x21 & (new_n111_ | (~new_n92_ & ~x04));
  assign new_n111_ = ~x05 & ~x08 & ~x15 & x06 & x02 & ~x11;
  assign new_n112_ = new_n74_ & (x07 | (x00 & x15)) & ~x05 & (~x07 | ~x15);
