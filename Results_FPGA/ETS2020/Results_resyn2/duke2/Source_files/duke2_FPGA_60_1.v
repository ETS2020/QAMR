// Benchmark "FAU" written by ABC on Wed Jul 29 06:09:18 2020
...
module FAU ( 
  ...
  assign z10 = (~new_n85_ & ~new_n87_ & ~x09) | (new_n89_ & (x09 | (x05 & ~x19)));
  assign new_n85_ = (new_n86_ | x06 | x17 | x08 | ~x18) & ~x07 & (~x17 | x18);
  assign new_n86_ = x05 ^ ~x15;
  assign new_n87_ = (~new_n88_ | ~x19 | x17 | ~x18) & x07 & (x18 | x05 | ~x17);
  assign new_n88_ = x08 & x05 & ~x15;
  assign new_n89_ = new_n82_ & x08 & ~x15 & (~x05 | x07) & (x05 | ~x07);
  assign z11 = new_n91_ & ~x17 & x01 & ~x15;
  assign new_n91_ = ~x05 & x07 & ~x09 & ~x18;
  assign z13 = (~x05 | ~x07) & x17 & ~x09 & ~x18;
  assign z15 = x05 & ~x07 & ~x15 & x17 & ~x09 & ~x18;
  assign z17 = ~x09 & (new_n98_ | (~new_n95_ & ~x05));
  assign new_n95_ = (~x07 | x15 | ~x17 | x18) & (x07 | (~new_n96_ & (~x17 | x18 | ~x00 | ~x15)));
  assign new_n96_ = new_n97_ & ~x08 & ~x15 & new_n82_ & (~x14 | ~x21);
  assign new_n97_ = x06 ? (x02 & ~x11) : (~x04 & x12);
  assign new_n98_ = new_n66_ & ~x17 & x18 & ~x21;
  ...
  assign new_n105_ = ~x05 & ~x06 & ~x14 & x21 & ~x08 & ~x15;
  assign new_n106_ = ~new_n55_ & ~x18;
  assign new_n107_ = new_n88_ & ~x12 & x18 & x04 & x09;
  assign z21 = new_n82_ & ~new_n109_;
  assign new_n109_ = (x07 | ((~x06 | x08 | x09 | ~x05 | x15) & ((x06 & (~x09 | ~x08 | x15)) | x05 | (~x06 & (x08 | x09 | ~x15))))) & (x09 | ~x07 | ~x08 | x05 | ~x15);
  assign z22 = new_n82_ & ~new_n111_;
  assign new_n111_ = (~x07 | ~x08 | x05 | ~x15) & (x07 | ((~x06 | x08 | x09 | ~x05 | x15) & (x05 | ((~x09 | ~x08 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign new_n125_ = (x07 ? ~x15 : (x00 & x15)) & ~x18 & ~x05 & x17;
