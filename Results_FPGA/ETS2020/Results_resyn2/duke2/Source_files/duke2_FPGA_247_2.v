...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n59_, new_n60_, new_n61_,
    ...
    new_n143_, new_n144_, new_n145_, new_n146_, new_n147_, new_n151_,
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n112_ | (~x17 & (new_n108_ | (x18 & (new_n103_ | new_n111_))));
  assign new_n103_ = ~x15 & ((~new_n104_ & ~x07) | ((x07 | ~x12) & x05 & x08));
  assign new_n104_ = (~new_n61_ | ~x05 | ~x08) & (x09 | (~new_n105_ & (x19 | ~x05 | x08)));
  assign new_n105_ = ~x21 & (new_n107_ | (~x05 & (new_n106_ | (~new_n93_ & ~x08))));
  assign new_n106_ = (~x10 | x12) & x02 & x13 & x08 & ~x14;
  assign new_n107_ = x04 & ~x12 & x08 & ~x14 & x02 & x13;
  assign new_n108_ = new_n109_ & ~x09 & ~x14 & ~x21;
  assign new_n109_ = ~x05 & x12 & new_n110_ & x04 & ~x18;
  assign new_n110_ = ~x07 & ~x15;
  assign new_n111_ = new_n68_ & (new_n62_ ? x05 : (~x05 & x15 & x02 & ~x11));
  assign new_n112_ = new_n110_ & new_n96_ & ~x09;
  assign z11 = ~x18 & x01 & x07 & new_n56_ & ~x05 & ~x09;
  assign z12 = ~x09 & ((new_n95_ & ~x05) | (~new_n115_ & ~x07));
  assign new_n115_ = ~new_n116_ & (~new_n96_ | x05 | ~x00 | ~x15);
  assign new_n116_ = ~x21 & ~x17 & x18 & (~new_n119_ | (~new_n117_ & ~x05));
  assign new_n117_ = (~new_n72_ | ~x08 | ~x15) & (x15 | ((new_n118_ | x08) & (~new_n91_ | ~x08 | x14)));
  assign new_n118_ = (x06 | ~x04 | x12) & (~x06 | (x02 & x11) | (~x02 & ~x11));
  assign new_n119_ = (new_n120_ | x04) & (~new_n98_ | ~x08);
  assign new_n120_ = (x11 | ~x15 | ~x05 | ~x08) & (x06 | ~x12 | x05 | x08 | x15);
  assign z13 = (~x05 | ~x07) & new_n96_ & ~x09;
  assign z14 = (~new_n123_ & ~x17) | (new_n126_ & ((~x01 & x07) | (x17 & (x07 | x15))));
  assign new_n123_ = (~new_n126_ | new_n127_) & (new_n124_ | ~x08 | ~x18);
  assign new_n124_ = (~x07 | x19 | (~x05 ^ x15)) & (new_n125_ | new_n62_ | x07);
  assign new_n125_ = ~new_n98_ & (~new_n72_ | x05 | ~x15);
  assign new_n126_ = ~x18 & ~x05 & ~x09;
  assign new_n127_ = (~x07 | ~x15) & (x07 | ~x12 | ~x04 | x15 | x14 | x21);
  assign z15 = new_n112_ & x05;
  assign z16 = ~new_n130_ & ~new_n135_ & ~x17 & x08 & x18;
  assign new_n130_ = (new_n131_ | x07 | x15) & ~x05 & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n131_ = (~x09 | x19) & (new_n132_ | x09 | x14 | x21);
  assign new_n132_ = (~x06 | (~new_n134_ & (new_n133_ | ~x12 | x16))) & ~new_n91_ & (new_n133_ | ~x16 | x06 | ~x12);
  assign new_n133_ = x13 & (x02 | ~x11);
  assign new_n134_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n135_ = x05 & ((~x07 & x12) | ~x09 | x15);
  assign z18 = ~new_n137_ & ~x09 & new_n57_ & ~x17 & x18;
  assign new_n137_ = (~x19 | x08 | ~x15) & ((~new_n84_ & ~new_n138_) | x14 | x15);
  assign new_n138_ = (new_n139_ | x06 | (new_n80_ & ~x04)) & x12 & (new_n81_ | ~x06);
  assign new_n139_ = ~x13 & ~x16 & x10 & x08 & ~x21;
  assign z21 = ~new_n141_ & ~x17 & x18;
  assign new_n141_ = (x07 | (((~x06 & (x08 | x09 | ~x15)) | x05 | (x06 & (~x08 | ~x09 | x15))) & (~x06 | x09 | ~x05 | x08 | x15))) & (x09 | ~x15 | ~x08 | x05 | ~x07);
  assign z24 = ~x09 & ~x17 & (new_n147_ | (~new_n143_ & ~x07));
  assign new_n143_ = (new_n144_ | x21) & (~x18 | x05 | x08 | x15);
  assign new_n144_ = (new_n146_ | ~x04 | x15) & (~new_n145_ | (x05 & (x04 | x11)));
  assign new_n145_ = (new_n72_ | x05) & x15 & x08 & x18;
  assign new_n146_ = (~x08 | ~x18 | ~x05 | x12) & (x05 | ~x12 | x14 | x18);
  assign new_n147_ = x08 & ~x05 & x07 & ~x18 & x01 & ~x15;
  assign z25 = new_n57_ & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z28 = new_n158_ | (~x17 & (new_n151_ | new_n159_));
  assign new_n151_ = x18 & (new_n156_ | (x08 & (new_n152_ | (~new_n155_ & ~x07))));
  assign new_n152_ = ~x05 & (new_n153_ | (new_n154_ & (~x13 | x02 | x11)));
  assign new_n153_ = x15 & ((~new_n62_ & ~x02) | x07 | ~x11);
  assign new_n154_ = new_n110_ & x10 & x12 & ~x21 & ~x09 & ~x14;
  assign new_n155_ = (~new_n61_ | ~x05 | x15) & (~x21 | x09 | ~x15);
  assign new_n156_ = ~new_n157_ & new_n57_ & ~x08 & ~x09;
  assign new_n157_ = (~x15 | x19) & (new_n93_ | x14 | x15 | ~x21);
  assign new_n158_ = z13 & (x05 | (x15 & (~x07 | ~x19)));
  assign new_n159_ = new_n126_ & (~x02 | ~x11) & x07 & x15;
  assign z01 = 1'b0;
  assign z10 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
