// Benchmark "FAU" written by ABC on Wed Jul 29 04:15:08 2020
...
module FAU ( 
  ...
  assign z6 = new_n39_ | (x05 & x08);
  assign new_n39_ = (~x16 | ~x15 | ~new_n31_ | ~x14) & new_n33_ & (x16 | (new_n31_ & x14 & x15));
  assign z8 = (x07 & x08) | (~new_n41_ & new_n33_);
  assign new_n41_ = (~x18 | (new_n31_ & x14 & x15 & x16 & x17)) & (~new_n31_ | ~x14 | ~x16 | ~x17 | ~x15 | x18);
  assign z2 = 1'b0;
  assign z7 = 1'b0;
endmodule
