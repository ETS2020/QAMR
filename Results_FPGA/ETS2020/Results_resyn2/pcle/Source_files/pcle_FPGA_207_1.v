...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n41_, new_n43_, new_n44_;
  ...
  assign z7 = (x06 & x08) | ((~new_n41_ | ~x17) & new_n34_ & (new_n41_ | x17));
  assign new_n41_ = x15 & x16 & new_n32_ & new_n33_;
  assign z8 = new_n44_ | (new_n34_ & ((~new_n43_ & x18) | (new_n41_ & x17 & ~x18)));
  assign new_n43_ = new_n32_ & x13 & x15 & x16 & x14 & x17;
