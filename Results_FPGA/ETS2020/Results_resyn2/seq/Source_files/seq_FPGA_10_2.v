// Benchmark "FAU" written by ABC on Thu Jul 30 00:54:12 2020
...
module FAU ( 
  ...
  assign z12 = ~new_n311_ & new_n143_ & ~x00 & x05 & x08 & ~x40;
  assign new_n311_ = (~x37 | ~x38 | ~x36 | x34 | ~x35) & (x37 | x38 | x36 | ~x34 | x35);
  assign z13 = x33 & (new_n313_ | x07);
  assign new_n313_ = (~x38 | ~x40) & ~x32 & (~x39 | x40) & new_n314_ & (x36 | x38 | x39) & (~x36 | (~x38 & ~x39));
  assign new_n314_ = new_n302_ & ~x37;
  assign z14 = x33 & (x07 | (~new_n316_ & new_n314_ & ~x32));
  assign new_n316_ = (x36 | (x38 ? (x39 | x40) : (~x39 | ~x40))) & (x38 | x39 | ~x13 | ~x36);
  assign z15 = x07 & x33;
  assign z16 = new_n143_ & (new_n319_ | (new_n184_ & new_n93_ & x37 & x39));
  assign new_n319_ = ~x34 & ((~new_n320_ & x36) | (new_n160_ & ~x36 & x35 & x37));
  assign new_n320_ = (new_n321_ | x35) & (~new_n324_ | ~x35 | ~new_n87_ | ~new_n88_);
  assign new_n321_ = (x37 | x38 | (x39 & (~new_n102_ | ~x40))) & (new_n322_ | (x39 & (x37 | ~x40)) | ~x38 | (~x37 & ~x39));
  assign new_n322_ = x40 & (x04 | ~new_n211_ | ~new_n323_);
  assign new_n323_ = ~x02 & ~x03;
  assign new_n324_ = x00 & ~x02 & x01 & ~x03 & x04;
  assign z17 = x33 & (x07 | (~x32 & (new_n326_ | (~new_n341_ & new_n223_))));
  assign new_n326_ = ~x36 & (new_n327_ | new_n340_ | (~x38 & (new_n334_ | new_n339_)));
  assign new_n327_ = new_n135_ & ((new_n111_ & new_n98_) | (~new_n328_ & new_n126_));
  assign new_n328_ = ~new_n333_ & (~x38 | (~new_n332_ & (x37 | (~new_n329_ & ~new_n331_))));
  assign new_n329_ = ~x09 & (new_n330_ | (new_n98_ & ~x16 & ~x40));
  assign new_n330_ = ~x18 & ~x21 & x35 & x39;
  assign new_n331_ = x39 & (new_n103_ | x35) & (new_n262_ | new_n103_ | ~x22 | ~x24);
  assign new_n332_ = new_n98_ & x39 & ~x09 & ~x17;
  assign new_n333_ = ~x37 & x39 & new_n98_ & new_n105_;
  assign new_n334_ = ~x35 & (new_n338_ | (~new_n335_ & x34));
  assign new_n335_ = (~x02 | (~new_n337_ & (~x37 | x39))) & (~x37 | (~new_n256_ & (new_n336_ | x39)));
  assign new_n336_ = new_n83_ & ~x03;
  assign new_n337_ = new_n211_ & ~x03 & x04 & ~new_n121_ & ~x37;
  assign new_n338_ = ~new_n125_ & new_n130_ & ~x34;
  assign new_n339_ = new_n189_ & new_n126_ & ~x05 & new_n302_ & ~x39;
  assign new_n340_ = new_n138_ & ~new_n82_ & new_n166_;
  assign new_n341_ = ~new_n343_ & (~x00 | (~new_n85_ & (~x38 | (~new_n81_ & ~new_n342_))));
  assign new_n342_ = new_n84_ & x37 & x04 & x02 & ~x03;
  assign new_n343_ = ~x40 & ((x37 & ~x38 & x35 & x39) | (~x35 & ~x37 & new_n92_ & x38 & ~x39));
  assign z18 = ~x07 & x33 & (new_n367_ | (~new_n345_ & ~x32));
  assign new_n345_ = ~new_n346_ & ((~new_n351_ & ~x38) | x34 | (~new_n359_ & ~new_n363_ & x38));
  assign new_n346_ = new_n166_ & (new_n349_ | (new_n348_ & (new_n347_ | new_n350_ | x38)));
  assign new_n347_ = x39 & ((x37 & ~x40) | ((new_n140_ | ~x37) & (x40 | (new_n83_ & x00))));
  assign new_n348_ = ~x36 & (~x38 | (x37 ? (~x39 | ~x40) : (new_n82_ | ~x39)));
  assign new_n349_ = x36 & ~x37 & new_n87_ & ~x38;
  assign new_n350_ = new_n83_ & ~x39 & ((x00 & ~x37) | (new_n323_ & x37 & x40));
  assign new_n351_ = (new_n352_ | ~new_n355_) & (~new_n358_ | (~x39 & (new_n357_ | ~x37)));
  assign new_n352_ = ~new_n353_ & x37 & (~new_n142_ | ~x35 | (new_n140_ & x24));
  assign new_n353_ = (~new_n130_ | ~new_n178_ | ~x39) & ~x35 & (~new_n354_ | ~x15 | x39);
  assign new_n354_ = x14 & x11 & x12 & ((x16 & x17) | (x09 & (x16 | x17)));
  assign new_n355_ = ~x36 & (~new_n356_ | ((~new_n122_ | ~x40) & (~new_n155_ | (~new_n141_ & ~x40))));
  assign new_n356_ = x35 & ~x39 & ~x05 & ~x37;
  assign new_n357_ = ~x40 & x00 & x01 & new_n323_ & x04 & x35;
  assign new_n358_ = (~x37 | x35 | (~x39 & ~x40)) & x36 & (x37 | (~x35 & (x11 | ~x40)));
  assign new_n359_ = ~new_n360_ & ~x35 & (~new_n362_ | (~new_n361_ & x40));
  assign new_n360_ = (new_n322_ | (~x37 ^ x39)) & (x37 | x39 | (new_n92_ & ~x40)) & x36 & (~x37 | ~x39);
  assign new_n361_ = (~new_n130_ | new_n112_ | x39) & (~new_n354_ | ~x39 | ~x15 | x37);
  assign new_n362_ = ~x36 & (~x37 | ~x39 | ~new_n130_ | ~x09);
  assign new_n363_ = ~new_n365_ & x35 & (~new_n366_ | (new_n364_ & new_n126_ & ~x05));
  assign new_n364_ = new_n141_ & x39 & x24 & ~x36 & (x23 | x40);
  assign new_n365_ = (x36 | (new_n200_ & ~x00)) & x37 & (~new_n83_ | ~x00);
  assign new_n366_ = ~x37 & ((x39 ^ ~x40) | (~x36 & ~x40));
  assign new_n367_ = ~x34 & ~x35 & ~x36 & (x32 | (~new_n368_ & new_n130_));
  assign new_n368_ = (new_n369_ | ~x15) & (~new_n87_ | (~x37 ^ ~x38));
  assign new_n369_ = ~new_n370_ & (~new_n99_ | ~x09 | x37 | x40);
  assign new_n370_ = ~new_n102_ & ~new_n105_ & ((~x37 & ~x38) | (x38 & ~x39 & ~x40) | (~x38 & x39 & x40));
  assign z19 = ~new_n372_ & new_n143_ & (new_n379_ | ~x38 | (~new_n377_ & new_n302_));
  assign new_n372_ = (new_n373_ | x35) & ~x38 & (new_n376_ | ~x40 | x34 | ~x35);
  assign new_n373_ = (~new_n374_ | ~new_n290_) & (~new_n223_ | ~new_n87_ | ~x37);
  assign new_n374_ = ~new_n375_ & new_n323_ & ~x01;
  assign new_n375_ = (~x00 | ~x04 | x37 | (x39 & x40)) & (x04 | ~x37 | x39 | x40);
  assign new_n376_ = (~x36 | ~x37 | (~x06 & ~x39)) & (~x39 | x36 | x37);
  assign new_n377_ = (x36 | x40 | x37 | x39) & (~new_n378_ | x01 | ~x36 | ~x37);
  assign new_n378_ = ~x03 & x04 & x00 & ~x02;
  assign new_n379_ = ((~x36 & x34 & ~x35) | (~x37 & ~x34 & x35)) & new_n121_ & x06 & (x36 | x37);
  assign z21 = ~x33 | (~x07 & (new_n381_ | (~new_n384_ & ~x34)));
  assign new_n381_ = ~x35 & ((new_n349_ & x32) | (~new_n382_ & new_n290_));
  assign new_n382_ = (~new_n383_ | new_n121_ | x37 | x38) & ~x32 & (~new_n121_ | x06 | ~x37 | ~x38);
  assign new_n383_ = ~x00 & ~x05;
  assign new_n384_ = (new_n385_ | ~x35 | ~x36) & (~new_n383_ | new_n387_) & (~x32 | (~x35 & ~x36));
  assign new_n385_ = (x06 | x37 | ~x38 | ~x39 | ~x40) & ((~new_n386_ & (x38 | ~x40)) | ~x37 | ((x06 | x39) & ~x38 & x40));
  assign new_n386_ = (~x05 | ~x38) & ~x00 & (x38 | ~x39);
  assign new_n387_ = (~x35 | ~x37 | ~x39 | ~x38 | x40) & (~x36 | (x37 & x39) | ~x38 | ~x40 | (x35 & ~x37) | (~x37 & ~x39));
  assign z24 = (~new_n394_ | (~new_n389_ & ~x34)) & new_n143_ & (~new_n396_ | (~new_n341_ & ~x34));
  assign new_n389_ = (new_n390_ | x05) & (~new_n87_ | ~x38 | ~x35 | ~x37);
  assign new_n390_ = (~new_n111_ | ~new_n98_) & (new_n391_ | ~new_n126_);
  assign new_n391_ = ~new_n333_ & (~x38 | (~new_n332_ & (x37 | (~new_n329_ & ~new_n392_))));
  assign new_n392_ = (new_n103_ | ~new_n393_) & x39 & (new_n103_ | x35);
  assign new_n393_ = x22 & x24 & (x40 | (x21 & x23));
  assign new_n394_ = ~new_n340_ & ~x36 & (x38 | (~new_n334_ & ~new_n395_));
  assign new_n395_ = new_n260_ & new_n126_ & ~x05 & new_n302_ & ~x39;
  assign new_n396_ = x36 & (~new_n166_ | x37 | ~new_n87_ | x38);
  assign z25 = ~new_n398_ & new_n143_ & (~new_n396_ | (~new_n400_ & ~x34));
  assign new_n398_ = (new_n390_ | ~new_n135_) & ~x36 & (x38 | (~new_n399_ & ~new_n395_));
  assign new_n399_ = ~x35 & (new_n338_ | (x34 & (new_n209_ | (new_n337_ & x02))));
  assign new_n400_ = (new_n401_ | ~x35 | ~x37) & (~new_n93_ | x35 | ~new_n92_ | x37 | x39);
  assign new_n401_ = x38 ? (~new_n211_ | ~x04 | ~x02 | x03) : ~new_n200_;
  assign z26 = new_n143_ & (new_n403_ | (new_n85_ & new_n222_));
  assign new_n403_ = ~x35 & ((new_n349_ & x34) | (~new_n82_ & ~new_n404_));
  assign new_n404_ = (~new_n290_ | ~x37 | x38 | x39) & (~x38 | ((~new_n290_ | x37 | ~x39) & (~new_n222_ | ~x40 | (x37 ^ ~x39))));
  assign z28 = new_n143_ & (new_n406_ | (new_n408_ & new_n92_ & ~x40));
  assign new_n406_ = new_n407_ & (~new_n121_ | (x37 & x38 & new_n302_ & x36));
  assign new_n407_ = ~new_n311_ & new_n211_ & x04 & x02 & ~x03;
  assign new_n408_ = x38 & ~x39 & new_n223_ & ~x35 & ~x37;
  assign z29 = new_n143_ & ((new_n199_ & new_n302_ & x36) | (~new_n410_ & ~x05 & ~x36));
  assign new_n410_ = (new_n411_ | x34) & (~new_n413_ | ~new_n287_ | new_n102_ | ~x40);
  assign new_n411_ = (~new_n160_ | ~new_n98_ | ~new_n112_) & (x40 | (~new_n412_ & (~new_n287_ | ~new_n98_ | ~new_n112_)));
  assign new_n412_ = new_n155_ & new_n114_ & ~x21 & x22 & (~x38 ^ x39);
  assign new_n413_ = ~x21 & x22 & new_n166_ & x15;
  assign z32 = new_n415_ & new_n143_ & ~x36;
  assign new_n415_ = new_n302_ & ~x39 & ~x40 & x37 & x38;
  assign z33 = (x32 | x33) & ((~x32 & (new_n417_ | new_n435_)) | x07 | ~x33);
  assign new_n417_ = ~x34 & (new_n426_ | ~x35) & (new_n418_ | x35 | (~new_n434_ & x36));
  assign new_n418_ = new_n130_ & ~x36 & (new_n419_ | ~new_n424_ | (~new_n126_ & ~new_n425_));
  assign new_n419_ = x15 & (new_n422_ | (~new_n420_ & x09));
  assign new_n420_ = (x37 | ~x38 | ~x39 | (x40 ? ~new_n421_ : new_n99_)) & (~new_n421_ | x39 | ~x37 | x38);
  assign new_n421_ = (x16 | x17) & (x11 | x12) & (~x14 | ~x11 | ~x12);
  assign new_n422_ = new_n423_ & ((~x39 & x37 & ~x38) | (x39 & x40 & ~x37 & x38));
  assign new_n423_ = x16 & x17 & (x11 | x12) & (~x14 | ~x11 | ~x12);
  assign new_n424_ = (~new_n205_ | ((~x38 | x39 | ~x40) & (~x37 | x38 | ~x39 | x40))) & (~x37 | ~x39 | ~x09 | ~x38);
  assign new_n425_ = (x38 | (~x40 & (~x37 | x39))) & (((~x09 | x15) & x38 & x39 & ~x40) | x37 | (~x39 & (~x38 | x40)));
  assign new_n426_ = (new_n429_ | ~new_n433_) & (new_n427_ | ~x37 | (~new_n432_ & x36));
  assign new_n427_ = new_n428_ & (new_n122_ | (x22 & (new_n133_ | x21)));
  assign new_n428_ = (new_n122_ | new_n155_) & ~x05 & ~x36 & new_n142_ & ~x38;
  assign new_n429_ = ~x05 & ~x36 & (new_n430_ | (~new_n431_ & new_n155_ & x22));
  assign new_n430_ = new_n122_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n431_ = (~x38 | ~x39 | (new_n101_ & ~x21) | (~x40 & (~x21 | ~x23))) & (~x21 | x38 | x39 | x40);
  assign new_n432_ = ((~x06 & ~x39) | x38 | ~x40) & (~new_n378_ | (x01 ? (x38 | x39 | x40) : ~x38));
  assign new_n433_ = (~x36 | ((~x38 | ~x06 | ~x40) & (x39 | (x38 & ~x40)) & (~x39 | ~x38 | x40))) & ~x37 & (x36 | (x38 ? (x39 | x40) : (~x39 | ~x40)));
  assign new_n434_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (new_n92_ & ~x40)) & ((x38 ^ ~x40) | ~x39 | (new_n102_ & x40))));
  assign new_n435_ = new_n436_ & (new_n374_ | x38 | (new_n121_ & (new_n289_ | ~x37)));
  assign new_n436_ = new_n184_ & (~x38 | ((~x37 | x40) & (~x39 | (x06 & x37))));
  assign z34 = x33 & (x07 | (~x32 & (new_n438_ | new_n459_)));
  assign new_n438_ = ~x34 & (~new_n451_ | (x39 & (~new_n447_ | (~new_n439_ & x38))));
  assign new_n439_ = ~new_n445_ & (x37 | (~new_n440_ & ~new_n446_));
  assign new_n440_ = (new_n444_ | x36 | (~new_n441_ & x15)) & ~x35 & (~new_n322_ | ~x36);
  assign new_n441_ = ~new_n443_ & (new_n442_ | ~x40 | ((~x16 | ~x17) & (~x09 | (~x16 & ~x17))));
  assign new_n442_ = (~x14 | ~x11 | ~x12) & (x05 | x31 | (~x11 & ~x12));
  assign new_n443_ = x09 & ~x05 & ~x31 & ~x40 & (~x11 | ~x12);
  assign new_n444_ = new_n130_ & x09 & ~x40 & ~x13 & ~x15;
  assign new_n445_ = x05 & ((x35 & ~x36 & ~x37) | (~x00 & ((~x36 & ~x40) | (x36 & ~x37 & ~x35 & x40))));
  assign new_n446_ = x35 & x36 & x06 & x40;
  assign new_n447_ = (~new_n450_ | ~x35 | x36 | x37) & (x35 | ((new_n448_ | x36) & (~new_n450_ | ~x11 | ~x36 | x37)));
  assign new_n448_ = (~x05 | (x38 & x40)) & (new_n449_ | x31 | x05 | x37);
  assign new_n449_ = (~x13 | ~x09 | x15) & (new_n93_ | (~new_n102_ & x15));
  assign new_n450_ = ~x38 & x40;
  assign new_n451_ = (new_n455_ | x36) & (~x37 | ((new_n452_ | ~x36) & (new_n458_ | x35 | x36)));
  assign new_n452_ = ~new_n453_ & (((~new_n324_ | x40) & x35 & (~x06 | ~x40)) | ~new_n172_ | (~x35 & x40));
  assign new_n453_ = (new_n454_ | (~x00 & x05)) & x38 & (new_n142_ | x35);
  assign new_n454_ = (~x04 ^ x35) & x00 & ~x01 & ~x02 & ~x03;
  assign new_n455_ = ~new_n457_ & (x35 | (~new_n456_ & (new_n151_ | ~x05)));
  assign new_n456_ = ~new_n126_ & new_n130_ & ((~x37 & ~x40 & x38 & ~x39) | (~x38 & x40));
  assign new_n457_ = ~x39 & ((x35 & ~x37 & x38 & ~x40) | (x05 & ~x38 & (~x37 | (x35 & x40))));
  assign new_n458_ = (~x05 | ~x38) & ((new_n126_ & ~new_n149_) | x05 | x31 | x38 | x39);
  assign new_n459_ = ~x35 & ~x36 & (new_n462_ | (~new_n460_ & ~x38));
  assign new_n460_ = (new_n121_ | x37 | (~new_n461_ & (x00 | ~x05))) & (~x05 | ~new_n121_ | ~x37);
  assign new_n461_ = new_n211_ & new_n323_ & x04 & x34;
  assign new_n462_ = x34 & x37 & x38 & ((~x39 & ~x40) | (x06 & x39 & x40));
  assign z07 = 1'b0;
  assign z20 = 1'b0;
  assign z22 = 1'b0;
  assign z23 = 1'b0;
