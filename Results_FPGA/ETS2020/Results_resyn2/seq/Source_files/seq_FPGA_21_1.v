// Benchmark "FAU" written by ABC on Thu Jul 30 00:54:26 2020
...
module FAU ( 
  ...
  assign z16 = new_n142_ & (new_n319_ | (new_n186_ & new_n104_ & x37 & x39));
  assign new_n319_ = ~x34 & ((~new_n320_ & x36) | (new_n103_ & ~x36 & new_n99_ & x38));
  assign new_n320_ = (new_n321_ | x35) & (~new_n281_ | ~x01 | ~new_n323_ | ~x35 | ~x37);
  assign new_n321_ = (~x38 | (~new_n322_ & (~x37 | x39 | x40))) & (x37 | x38 | (x39 & (~new_n85_ | ~x40)));
  assign new_n322_ = new_n128_ & x00 & x40 & (~x37 ^ ~x39);
  assign new_n323_ = new_n324_ & new_n325_;
  assign new_n324_ = ~x02 & ~x03;
  assign new_n325_ = x00 & x04;
  assign z17 = x33 & (x07 | (~x32 & (new_n327_ | (~new_n342_ & new_n229_))));
  assign new_n327_ = ~x36 & (new_n328_ | new_n341_ | (~x38 & (new_n336_ | new_n340_)));
  assign new_n328_ = new_n123_ & ((new_n98_ & new_n89_) | (~new_n329_ & new_n95_));
  assign new_n329_ = ~new_n334_ & (~x38 | (~new_n335_ & (x37 | (~new_n330_ & ~new_n332_))));
  assign new_n330_ = ~x09 & (new_n331_ | (~x18 & ~x21 & x35 & x39));
  assign new_n331_ = ~x16 & ~x40 & ~x31 & ~x35;
  assign new_n332_ = x39 & (new_n87_ | (x35 & (~new_n213_ | new_n333_)));
  assign new_n333_ = (~x21 | (~x23 & ~x40)) & (~x40 | x09 | x18);
  assign new_n334_ = new_n89_ & new_n90_ & ~x37 & x39;
  assign new_n335_ = ~x35 & x39 & ~x31 & ~x09 & ~x17;
  assign new_n336_ = ~x35 & (new_n338_ | (x34 & (new_n337_ | (~new_n339_ & x02))));
  assign new_n337_ = x37 & (new_n208_ | (~x39 & (x03 | x01 | x04)));
  assign new_n338_ = (new_n114_ | new_n116_) & new_n118_ & ~x34;
  assign new_n339_ = (~x37 | x39) & (x03 | ~x04 | (x39 & x40) | ~new_n111_ | x37);
  assign new_n340_ = ~new_n211_ & new_n95_ & new_n123_ & x35 & ~x39;
  assign new_n341_ = new_n215_ & ~new_n128_ & new_n130_;
  assign new_n342_ = (new_n344_ | x40) & (~x00 | (~new_n135_ & (new_n343_ | ~x38)));
  assign new_n343_ = (~new_n207_ | ~x37 | x01 | ~x35) & (~x40 | ~new_n133_ | x35);
  assign new_n344_ = (~x37 | ~x39 | ~x35 | x38) & (~new_n141_ | x35 | x37 | ~x38 | x39);
  assign z18 = new_n371_ & ((~new_n346_ & ~x32) | (~new_n368_ & new_n372_ & ~x34));
  assign new_n346_ = ~new_n347_ & (x34 | ((new_n353_ | ~x38) & (new_n361_ | new_n365_ | x38)));
  assign new_n347_ = new_n130_ & (new_n348_ | (new_n352_ & (new_n349_ | new_n350_ | x38)));
  assign new_n348_ = new_n281_ & x36 & ~x37;
  assign new_n349_ = x39 & ((x37 & ~x40) | ((new_n235_ | x40) & (new_n126_ | ~x37)));
  assign new_n350_ = ~new_n351_ & ~x01 & ~x04 & ~x39;
  assign new_n351_ = (~x00 | x37) & (~new_n324_ | ~x37 | ~x40);
  assign new_n352_ = ~x36 & (~x38 | (x37 ? (~x39 | ~x40) : (new_n128_ | ~x39)));
  assign new_n353_ = (new_n354_ | new_n359_ | ~x35) & (new_n356_ | x35 | (~new_n322_ & new_n360_));
  assign new_n354_ = (~new_n355_ | ~new_n268_ | ~x39) & ~x37 & ((~x39 ^ x40) | (~x36 & x39));
  assign new_n355_ = new_n95_ & ~x05 & ~x36;
  assign new_n356_ = (new_n357_ | ~x40) & ~x36 & (~new_n358_ | ~x09 | ~x39);
  assign new_n357_ = (~x39 | ~new_n158_ | ~x15 | x37) & (~new_n118_ | ~new_n100_ | x39);
  assign new_n358_ = new_n118_ & x37;
  assign new_n359_ = (~x00 | (x36 & (x01 | x04))) & x37 & (new_n178_ | x36);
  assign new_n360_ = (x37 | x39 | (new_n141_ & ~x40)) & (~x39 | (~x37 & x40)) & x36 & (~x37 | x40);
  assign new_n361_ = new_n362_ & (new_n364_ | ~x37 | (~new_n125_ & new_n99_ & x35));
  assign new_n362_ = ~x36 & (new_n363_ | x05 | x37 | ~x35 | x39);
  assign new_n363_ = (~x40 | new_n95_ | x13) & ((~new_n127_ & ~x40) | ~new_n95_ | ~x24);
  assign new_n364_ = (~new_n158_ | ~new_n180_) & ~x35 & (~new_n118_ | ~new_n178_ | ~new_n100_);
  assign new_n365_ = new_n367_ & (~x37 | (~new_n366_ & (new_n137_ | x35)));
  assign new_n366_ = new_n325_ & x35 & ~x39 & new_n324_ & x01 & ~x40;
  assign new_n367_ = (~x40 | x11 | x37) & x36 & (x37 | (~x35 & x39));
  assign new_n368_ = ~x32 & (~new_n118_ | (~new_n369_ & (~new_n137_ | (~x37 ^ ~x38))));
  ...
  assign z20 = new_n142_ & ((~new_n374_ & ~x36) | (~new_n386_ & ~x34 & x36));
  assign new_n374_ = (x34 | (new_n378_ & (new_n375_ | x35))) & (new_n382_ | x35 | x38);
  assign new_n375_ = (new_n376_ | x31 | x05 | x37) & ~new_n377_ & (new_n150_ | (~x05 & ~x31));
  assign new_n376_ = (~x39 | (~new_n292_ & (~x40 | (new_n95_ & (~new_n148_ | ~x38))))) & (new_n95_ | ~x38 | x39 | x40);
  assign new_n377_ = (x38 | (x39 & (~x05 | ~x40))) & (x05 | x31) & (x37 | ~x39 | ~x40);
  assign new_n378_ = (new_n380_ | ~x05) & (~x35 | (~new_n379_ & (new_n381_ | new_n95_ | x05)));
  assign new_n379_ = (new_n93_ | new_n267_) & (x05 | (~new_n95_ & x13));
  assign new_n380_ = (x39 | x37 | x38) & (x00 | ~x38 | ~x39 | x40);
  assign new_n381_ = x13 ? (x39 | x37 | x38) : ((x39 | ~x40 | ~x37 | x38) & (x37 | (x38 ? ~x39 : (x39 | x40))));
  assign new_n382_ = (new_n383_ | ~new_n118_ | x34) & ~new_n385_ & (new_n384_ | x37);
  assign new_n383_ = (~new_n147_ | ~x37 | x39) & (new_n95_ | (~x40 & (~x37 | x39)));
  assign new_n384_ = (~new_n312_ | (x39 & x40)) & (~new_n123_ | (~x31 & (new_n95_ | ~x39)));
  assign new_n385_ = (x05 | (~new_n95_ & x34)) & x39 & (~x34 | (x37 & x40));
  assign new_n386_ = (new_n387_ | ~x40) & (~new_n103_ | ~new_n312_ | ~x38);
  assign new_n387_ = (~new_n312_ | ~x38 | (x35 & x39) | (x37 ^ ~x39)) & (x38 | ~x39 | x37 | ~x11 | x35);
  assign z22 = new_n371_ & (new_n392_ | (~x34 & (new_n394_ | (~new_n389_ & ~x36))));
  assign new_n389_ = (new_n391_ | ~x05 | x32) & (x35 | (new_n368_ & (new_n390_ | ~x05)));
  assign new_n390_ = new_n150_ & (~x38 ^ x39) & (~x39 | (~x37 & x40));
  assign new_n391_ = new_n380_ & (~x35 | (~new_n93_ & ~new_n267_));
  assign new_n392_ = (~new_n110_ ^ x37) & new_n393_ & ~x38 & (~x00 | x37);
  assign new_n393_ = new_n372_ & x05 & ~x32;
  assign new_n394_ = new_n395_ & (x37 | (~x35 & x39)) & new_n312_ & x36 & (x35 | ~x37 | ~x39);
  assign new_n395_ = (x35 | x40) & ~x32 & x38;
  assign z23 = x33 & (x07 | (~x32 & (new_n428_ | (~new_n397_ & ~x34))));
  assign new_n397_ = (x38 | (new_n406_ & (new_n398_ | ~new_n427_))) & ~new_n424_ & (new_n411_ | ~x38);
  assign new_n398_ = (new_n399_ | ~x15) & new_n405_ & ((~new_n358_ & ~x35) | (~new_n85_ & x15));
  assign new_n399_ = ~new_n404_ & (~x37 | ((new_n400_ | x05) & (~new_n158_ | x35)));
  assign new_n400_ = (~new_n89_ | new_n403_) & (new_n85_ | ((new_n401_ | ~new_n402_) & (~new_n89_ | new_n115_)));
  assign new_n401_ = ~x24 & (x21 | ((x18 | x19) & (x09 | (x18 & x19))));
  assign new_n402_ = x35 & x40;
  assign new_n403_ = ((~x11 & ~x12) | (x11 & x12) | (~x16 & ~x17) | (~x09 & (~x16 | ~x17))) & (x14 | ~x11 | ~x12);
  assign new_n404_ = (~x37 | (~x24 & x40)) & ~x05 & ~new_n85_ & x35;
  assign new_n405_ = ~x36 & ((~x35 & x37) | (~x05 & (~x37 | x40)));
  assign new_n406_ = ~new_n410_ & (x35 | (~new_n407_ & ~new_n409_));
  assign new_n407_ = (new_n408_ | x05 | (x31 & ~x37)) & ~x36 & (~x05 | x39);
  assign new_n408_ = ((new_n90_ & x40) | ~new_n95_ | (x37 & ~x40)) & ~x31 & (x39 | x40);
  assign new_n409_ = (x39 | (new_n85_ & ~x37)) & x36 & (x37 | x40);
  assign new_n410_ = (~x36 | ~x37 | ~x40) & (x36 | x37) & x35 & x39;
  assign new_n411_ = new_n419_ & (new_n423_ | x35 | (~new_n412_ & new_n418_));
  assign new_n412_ = new_n417_ & (~new_n415_ | (~x37 & (new_n414_ | (~new_n413_ & x15))));
  assign new_n413_ = (new_n192_ | ~x39) & (~new_n194_ | ((x09 | x40) & (x17 | ~x39 | ~x40)));
  assign new_n414_ = ~new_n95_ & ~x40 & (~x39 | (new_n203_ & ~x13));
  assign new_n415_ = (x09 | ~x39 | (~new_n416_ & ~x37 & x40)) & ~x31 & (x39 | ~x40);
  assign new_n416_ = ~x17 & x15 & (x11 | x12);
  assign new_n417_ = ~x05 & (~x31 | ~x39);
  assign new_n418_ = ~new_n219_ & ~x36 & (~x05 | (~x37 & x39));
  assign new_n419_ = ~new_n421_ & (new_n420_ | ~new_n422_);
  assign new_n420_ = (~x00 | (~new_n134_ & x36)) & x37 & (new_n178_ | x36) & (~x36 | x00 | ~x05);
  assign new_n421_ = (~x36 | (x40 & x37 & ~x39)) & new_n312_ & (x36 | (x39 & ~x40));
  assign new_n422_ = x35 & (x37 | (~x36 & x39) | (~x39 & x40) | (x39 & ~x40));
  assign new_n423_ = x40 & (x37 ^ x39) & (x00 | ~x05 | x37 | ~x40) & x36 & (~x00 | ~x40);
  assign new_n424_ = (new_n425_ | ~new_n118_) & (x39 | (~new_n150_ & ~new_n118_)) & new_n372_ & (~new_n150_ | ~new_n426_);
  assign new_n425_ = ~x37 & ((new_n203_ & x13) | (new_n95_ ? new_n90_ : x40));
  assign new_n426_ = x40 & (x05 | (x31 & ~x37));
  assign new_n427_ = ~x39 & (~x36 | ~x37 | (x35 ? (~x40 & x00 & x37) : x40));
  assign new_n428_ = ~x35 & ((new_n348_ & x34) | (new_n429_ & (new_n431_ | x38)));
  assign new_n429_ = ~x36 & (new_n430_ | ~x38 | (x34 & (~new_n110_ | ~x37)));
  assign new_n430_ = new_n253_ & new_n110_ & ~x05 & ~x31 & x15 & ~x37;
  assign new_n431_ = ~new_n432_ & ((~new_n109_ & x34) | x37 | (~new_n110_ & new_n312_));
  assign new_n432_ = (~x34 | (new_n128_ & ~x40)) & x37 & (~x39 | (~x34 & (~x05 | ~x40)));
  assign z24 = (~new_n439_ | (~new_n434_ & ~x34)) & new_n142_ & (~new_n442_ | (~new_n342_ & ~x34));
  assign new_n434_ = (new_n435_ | x05) & (~new_n103_ | ~new_n137_ | ~x38);
  assign new_n435_ = (~new_n98_ | ~new_n89_) & (new_n436_ | ~new_n95_);
  assign new_n436_ = ~new_n334_ & (~x38 | (~new_n335_ & (x37 | (~new_n330_ & ~new_n437_))));
  assign new_n437_ = x39 & (new_n87_ | (x35 & (~new_n213_ | new_n438_)));
  assign new_n438_ = ~x40 & (~x21 | ~x23);
  assign new_n439_ = ~new_n341_ & ~x36 & (x38 | (~new_n336_ & ~new_n440_));
  assign new_n440_ = ~new_n441_ & new_n95_ & new_n123_ & x35 & ~x39;
  assign new_n441_ = (x37 | (x24 & (new_n127_ | x40))) & (~x40 | (x24 & (new_n265_ | ~x37)));
  assign new_n442_ = x36 & (~new_n281_ | ~new_n130_ | x37);
  assign z25 = ~new_n446_ & new_n142_ & (~new_n444_ | (~new_n435_ & new_n123_));
  assign new_n444_ = ~x36 & (x38 | (~new_n440_ & (x35 | (~new_n338_ & ~new_n445_))));
  assign new_n445_ = x34 & ((new_n208_ & x37) | (new_n207_ & ~new_n110_ & new_n111_ & ~x37));
  assign new_n446_ = new_n442_ & (x34 | (~new_n448_ & (new_n447_ | ~new_n103_)));
  assign new_n447_ = (~new_n178_ | x38) & (~new_n111_ | ~x02 | ~x38 | x03 | ~x04);
  assign new_n448_ = ~x40 & new_n141_ & ~x35 & ~x37 & x38 & ~x39;
  assign z26 = new_n142_ & (new_n450_ | (new_n135_ & x36 & x00 & ~x34));
  assign new_n450_ = ~x35 & ((~new_n451_ & ~new_n128_) | (new_n348_ & x34));
  assign new_n451_ = (new_n452_ | ~x38) & (~new_n129_ | ~x34 | x36);
  assign new_n452_ = (x37 | ~x39 | ~x34 | x36) & (~x36 | ~x00 | x34 | ~x40 | (~x37 ^ x39));
  assign z27 = new_n142_ & (new_n454_ | (new_n217_ & x36 & new_n178_ & new_n179_));
  assign new_n454_ = ~x05 & ~x36 & (new_n459_ | (new_n95_ & (new_n455_ | new_n458_)));
  assign new_n455_ = ~x34 & ((x35 & (new_n264_ | new_n212_)) | (~new_n456_ & ~x31 & ~x35));
  assign new_n456_ = (new_n457_ | x16) & ((~new_n94_ & ~new_n129_) | x09 | x17);
  assign new_n457_ = (x17 | (x39 & (x37 | ~x40)) | (~x37 & ~x38) | (x38 & ~x39)) & (x09 | ((x38 | (~x40 & (~x37 | x39))) & (x37 | (~x39 & (~x38 | x40)))));
  assign new_n458_ = new_n130_ & new_n179_ & new_n110_ & ~new_n127_;
  assign new_n459_ = new_n101_ & ~x34 & new_n89_ & x38;
  assign z28 = new_n142_ & (new_n463_ | (~new_n461_ & new_n462_));
  assign new_n461_ = (~x37 | ~x38 | ~x36 | x34 | ~x35) & (new_n110_ | x37 | x38 | x36 | ~x34 | x35);
  assign new_n462_ = new_n111_ & new_n207_;
  assign new_n463_ = new_n141_ & ~x35 & new_n307_ & new_n137_ & x38;
  assign z30 = new_n142_ & (new_n463_ | (~new_n465_ & new_n355_));
  assign new_n465_ = ~new_n458_ & (new_n466_ | (new_n286_ & ~x22) | ~new_n217_ | ~x24);
  assign new_n466_ = ~new_n467_ & x22 & (~new_n215_ | ~new_n438_);
  assign new_n467_ = new_n155_ & ~x21 & (new_n468_ | (~x37 & ~x40));
  assign new_n468_ = (x18 | x19) & (x09 | (x18 & x19)) & ~x23 & x37 & x40;
  assign z31 = new_n142_ & (new_n474_ | (~new_n470_ & ~x34));
  assign new_n470_ = (~new_n448_ | ~x36) & (~x35 | (~new_n473_ & (new_n471_ | ~new_n355_)));
  assign new_n471_ = ~new_n472_ & (~new_n215_ | (x24 & (~new_n127_ | x23 | x40)));
  assign new_n472_ = new_n155_ & ((~new_n269_ & ~x24) | (new_n468_ & ~x21 & x22));
  assign new_n473_ = new_n462_ & x36 & x37 & x38;
  assign new_n474_ = new_n462_ & ~new_n110_ & new_n186_ & ~x37 & ~x38;
  assign z33 = (x32 & (x07 | ~x33)) | (~x32 & x33 & (new_n492_ | x07 | (~new_n476_ & new_n484_)));
  assign new_n476_ = x35 & ((new_n483_ & (new_n477_ | x36)) | (new_n480_ & (new_n482_ | ~x36)));
  assign new_n477_ = (~x38 | x39 | x40) & (x38 | ~x39 | ~x40) & (x05 | (~new_n478_ & (~new_n112_ | (x38 ? ~x39 : (x39 | x40)))));
  assign new_n478_ = ~new_n479_ & new_n213_ & new_n95_;
  assign new_n479_ = (~x38 | ~x39 | ((new_n214_ | ~x40) & (~x21 | (~x23 & ~x40)))) & (~x21 | x38 | x39 | x40);
  assign new_n480_ = x37 & (~new_n481_ | (~new_n112_ & ~new_n265_));
  assign new_n481_ = (new_n95_ ? x24 : ~x13) & new_n267_ & ~x05 & ~x36;
  assign new_n482_ = ((~x06 & ~x39) | x38 | ~x40) & (~new_n323_ | (x01 ? (x38 | x39 | x40) : ~x38));
  assign new_n483_ = ~x37 & (~x36 | ((x39 | (x38 & ~x40)) & ((~x06 & x40) | ~x38 | ~x39)));
  assign new_n484_ = ~x34 & (new_n490_ | x35 | (~new_n485_ & new_n118_ & ~x36));
  assign new_n485_ = (new_n488_ | ~x15) & new_n486_ & (new_n489_ | x37);
  assign new_n486_ = new_n487_ & (new_n95_ | x38 | (~x40 & (~x37 | x39)));
  assign new_n487_ = (~new_n199_ | ((~x38 | x39 | ~x40) & (~x39 | x40 | ~x37 | x38))) & (~x37 | ~x38 | ~x09 | ~x39);
  assign new_n488_ = (~new_n152_ | ~new_n148_) & (~new_n215_ | ~x09 | new_n151_ | x40);
  assign new_n489_ = (new_n95_ | ~x38 | x39 | x40) & (new_n95_ | ~x39 | (~new_n203_ & x38 & ~x40));
  assign new_n490_ = ~new_n491_ & x36 & (new_n281_ | ~x37);
  assign new_n491_ = (~x39 | (x38 & x40) | (~x38 & (new_n85_ | ~x40))) & ~x37 & (~x38 | x39 | (new_n141_ & ~x40));
  assign new_n492_ = new_n493_ & (~new_n494_ | (new_n110_ & (new_n297_ | ~x37)));
  assign new_n493_ = new_n186_ & (~x38 | ((~x37 | x40) & (~x39 | (x06 & x37))));
  assign new_n494_ = ~x38 & (new_n495_ | ~new_n324_ | x01);
  assign new_n495_ = (~x00 | ~x04 | x37 | (x39 & x40)) & (x04 | x39 | ~x37 | x40);
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z15 = 1'b0;
