// Benchmark "FAU" written by ABC on Thu Jul 30 00:55:22 2020
...
module FAU ( 
  ...
  assign z10 = new_n199_ & ~x36 & (new_n193_ | (new_n107_ & new_n198_));
  assign new_n193_ = new_n197_ & (new_n194_ | (new_n107_ & new_n99_ & ~x38));
  assign new_n194_ = ~new_n195_ & ~new_n196_ & x35 & x24 & ~x34;
  assign new_n195_ = (x39 | ~x40 | ~x37 | x38) & ((~x38 & (x39 | x40)) | x37 | (x38 & ~x39));
  assign new_n196_ = ~x23 & ~x40 & (x38 | x39 | x40);
  assign new_n197_ = ~new_n85_ & ~x05 & x15 & new_n151_ & (x20 | x25);
  assign new_n198_ = (~x38 | ~x39) & (x38 | x39) & ~x37 & (x38 | x40);
  assign new_n199_ = x33 & ~x07 & ~x32;
  assign z11 = new_n199_ & ~x36 & (new_n177_ | (~new_n201_ & new_n191_));
  assign new_n201_ = ~new_n202_ & (~x15 | (~new_n184_ & (~new_n187_ | ~new_n119_ | ~new_n189_)));
  assign new_n202_ = new_n145_ & ~x31 & ~x35 & x38 & ~x39 & x40;
  ...
  assign z15 = x07 & x33;
  assign z19 = ~new_n212_ & new_n199_ & ((~new_n217_ & new_n208_) | new_n219_ | ~x38);
  assign new_n212_ = (new_n213_ | x35) & ~x38 & (new_n216_ | ~x40 | x34 | ~x35);
  assign new_n213_ = ~new_n214_ & (x34 | ~x36 | x39 | ~x37 | x40);
  assign new_n214_ = new_n215_ & ((x00 & x04 & ~x37 & (~x39 | ~x40)) | (x37 & ~x40 & ~x04 & ~x39));
  assign new_n215_ = x34 & ~x36 & ~x03 & ~x01 & ~x02;
  assign new_n216_ = (~x39 | x36 | x37) & (~x36 | ~x37 | (~x06 & ~x39));
  assign new_n217_ = (~new_n127_ | x36 | x37) & (~new_n218_ | ~x36 | ~x37 | x03 | ~x04);
  assign new_n218_ = x00 & ~x01 & ~x02;
  assign new_n219_ = ((~x36 & x34 & ~x35) | (~x37 & ~x34 & x35)) & (x36 | x37) & new_n99_ & x06;
  assign z20 = new_n199_ & ((~new_n238_ & ~x34 & x36) | (~x36 & (new_n221_ | (~new_n234_ & ~x34))));
  ...
  assign new_n232_ = (new_n233_ | ~x39) & (~new_n205_ | x37 | (x39 & x40));
  assign new_n233_ = (~x05 | (x34 & (~x37 | ~x40))) & (~x34 | ~x37 | new_n83_ | ~x40);
  assign new_n234_ = (~x05 | (new_n235_ & (new_n237_ | ~x35))) & (~new_n236_ | new_n237_ | ~x35);
  assign new_n235_ = ~new_n93_ & (x00 | ~new_n162_ | ~x38);
  assign new_n236_ = ~new_n83_ & (~new_n195_ | x13);
  assign new_n237_ = (x05 | (x13 & (x37 | x38 | x39))) & ((~x38 & (x39 | ~x40)) | (x37 & x38) | (x38 & ~x39));
  assign new_n238_ = (new_n239_ | ~x40) & (~x35 | ~x37 | ~new_n205_ | ~x38);
  assign new_n239_ = (((~x37 | x39) & (x35 | x37 | ~x39)) | ~new_n205_ | ~x38) & (x38 | ~x39 | x37 | ~x11 | x35);
  assign z21 = ~x33 | (~x07 & ((~new_n241_ & ~x35) | (~new_n245_ & ~x34)));
  assign new_n241_ = (~new_n242_ | ~x32) & (~x34 | x36 | (~new_n243_ & ~new_n244_ & ~x32));
  assign new_n242_ = x36 & ~x37 & new_n127_ & ~x38;
  assign new_n243_ = ~x00 & ~x05 & ~x38 & ~new_n99_ & ~x37;
  assign new_n244_ = x37 & x38 & new_n99_ & ~x06;
  assign new_n245_ = (~x36 | (~new_n248_ & (new_n246_ | ~x35))) & ~new_n249_ & (~x32 | (~x35 & ~x36));
  assign new_n246_ = (~x37 | ((x06 | ~x40 | x38 | x39) & (~new_n247_ | (~x38 & (x39 | x40))))) & (x06 | ~x39 | ~x40 | x37 | ~x38);
  assign new_n247_ = ~x00 & (~x05 | ~x38);
  assign new_n248_ = new_n209_ & ~x00 & ~x05 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n249_ = ~x00 & new_n162_ & x38 & ~x05 & x35 & x37;
  assign z22 = ~x07 & x33 & (new_n260_ | (~new_n251_ & ~new_n258_ & ~x34));
  assign new_n251_ = (new_n252_ | x35) & ~x36 & (new_n257_ | ~x05 | x32);
  assign new_n252_ = new_n256_ & (~new_n228_ | (~new_n253_ & (~new_n127_ | (x37 & ~x38) | (~x37 & x38))));
  assign new_n253_ = x15 & (new_n254_ | (~x37 & ~x40 & new_n225_ & x09));
  assign new_n254_ = ~new_n85_ & ~new_n255_ & ((~x38 & x39 & x40) | (~x37 & ~x38) | (x38 & ~x39 & ~x40));
  assign new_n255_ = ~x09 & ~x16;
  assign new_n256_ = ~x32 & (~x05 | (new_n89_ & new_n86_ & (x38 ^ ~x39)));
  assign new_n257_ = (x37 | x38 | x39) & (x00 | ~x38 | ~x39 | x40) & (~x35 | (~x38 & (x39 | ~x40)) | (x37 & x38) | (x38 & ~x39));
  assign new_n258_ = x36 & (new_n259_ | x32 | ~new_n205_ | ~x38);
  assign new_n259_ = (~x37 | (~x35 & (x39 | ~x40))) & (~x40 | x35 | x37 | ~x39);
  assign new_n260_ = new_n261_ & ((~x00 & ~x37 & (~x39 | ~x40)) | (x39 & x37 & x40));
  assign new_n261_ = x05 & ~x38 & ~x35 & ~x32 & ~x36;
  assign z23 = x33 & (x07 | (~x32 & (new_n263_ | (~new_n298_ & ~x35))));
  assign new_n263_ = ~x34 & ((~new_n264_ & ~new_n278_) | (~new_n295_ & ~x35 & ~x36));
  assign new_n264_ = (new_n265_ | new_n277_ | x35) & (new_n273_ | ~x35) & ~new_n276_ & x38;
  assign new_n265_ = new_n271_ & (~new_n272_ | (new_n269_ & (x37 | (~new_n266_ & ~new_n268_))));
  assign new_n266_ = x15 & ((~new_n137_ & x39) | (~new_n267_ & ~new_n85_ & ~x16));
  assign new_n267_ = (x09 | x40) & (x17 | ~x39 | ~x40);
  assign new_n268_ = ~x40 & ((new_n143_ & ~x13) | (~new_n83_ & ~x39));
  assign new_n269_ = ~x31 & (x39 | ~x40) & (x09 | ~x39 | (~new_n270_ & ~x37 & x40));
  assign new_n270_ = ~x17 & x15 & (x11 | x12);
  assign new_n271_ = (~new_n158_ | ~new_n102_ | ~x39) & ~x36 & (~x05 | (~x37 & x39));
  assign new_n272_ = ~x05 & (~x31 | ~x39);
  assign new_n273_ = (new_n274_ | ~x37 | (~x00 & ~x36 & x39 & ~x40)) & (x37 | (~x39 & ~x40) | (x36 & x39 & x40));
  assign new_n274_ = (new_n205_ | ~new_n275_) & x36 & (~new_n205_ | new_n275_);
  assign new_n275_ = x00 & ~x01 & (~x04 | (x02 & ~x03));
  assign new_n276_ = new_n205_ & ((~x36 & x39 & ~x40) | (x37 & ~x39 & x36 & x40));
  assign new_n277_ = (~x05 | ~x39 | ~x40) & (~x37 ^ ~x39) & ~x00 & x36 & x40;
  assign new_n278_ = ~new_n288_ & new_n294_ & (~new_n292_ | (~new_n279_ & new_n286_));
  assign new_n279_ = x15 & (new_n285_ | (~x05 & (new_n284_ | (~new_n280_ & x37))));
  assign new_n280_ = (~new_n122_ | ~new_n281_) & (new_n85_ | ((~new_n189_ | new_n282_) & (~new_n122_ | new_n283_)));
  assign new_n281_ = ~x14 & x11 & x12;
  assign new_n282_ = ~x24 & (x21 | (x18 & x19) | (x09 & (x18 | x19)));
  assign new_n283_ = x11 & x12 & (x16 | x17) & (x09 | (x16 & x17));
  assign new_n284_ = ~new_n85_ & x35 & (~x37 | (~x24 & x40));
  assign new_n285_ = ~new_n101_ & new_n86_ & ~x35 & x37;
  assign new_n286_ = ~new_n287_ & ~x36 & ((~x35 & x37) | (~x05 & (~x37 | x40)));
  assign new_n287_ = ~new_n83_ & ~x05 & ((~x31 & ~x35 & x37) | (x35 & (~x37 | x40)));
  assign new_n288_ = new_n290_ & ((~new_n289_ & ~new_n291_ & ~x05) | x36 | (x05 & x39));
  assign new_n289_ = (~x39 | (new_n83_ & (~x37 | x40))) & ~x31 & (~x40 | (new_n83_ & ~new_n255_));
  assign new_n290_ = ~x35 & (~x36 | ((x37 | x40) & (x39 | (new_n85_ & ~x37))));
  assign new_n291_ = x31 & x37;
  assign new_n292_ = ~x39 & (~new_n293_ | (~x35 & x40) | (x00 & x35 & ~x40));
  assign new_n293_ = x36 & x37;
  assign new_n294_ = ~x38 & ((x36 & x37 & (~x37 | x40)) | (~x36 & ~x37) | ~x35 | ~x39);
  assign new_n295_ = ~new_n227_ & (x05 | ~x39 | ((~x31 | ~x37) & (new_n296_ | x31 | x37)));
  assign new_n296_ = (~new_n83_ | ~new_n255_) & ~new_n297_ & (new_n83_ | ~x40);
  assign new_n297_ = x09 & x13 & ~x15;
  assign new_n298_ = (~new_n242_ | ~x34) & (x36 | (new_n301_ & (new_n299_ | x38)));
  assign new_n299_ = (new_n300_ | ~x37) & (~new_n205_ | new_n99_ | x37);
  assign new_n300_ = (~x05 | ~x39 | ~x40) & (~x34 | ((new_n106_ | x39) & (x05 | ~x39) & (~x39 | x40) & (x39 | ~x40)));
  assign new_n301_ = (~x38 | (~new_n302_ & (new_n99_ | ~x34))) & ((~new_n99_ & ~new_n275_) | ~x34 | x37);
  assign new_n302_ = new_n281_ & ~x31 & ~x37 & new_n99_ & ~x05 & x15;
  assign z26 = new_n199_ & (new_n304_ | (new_n307_ & ~new_n308_));
  assign new_n304_ = ~x35 & (new_n305_ | (new_n242_ & x34));
  assign new_n305_ = ~new_n106_ & ((~new_n306_ & x38) | (new_n139_ & x34 & ~x36));
  assign new_n306_ = (x37 | ~x39 | ~x34 | x36) & (x34 | ~x36 | ~x00 | ~x40 | (x37 ^ ~x39));
  assign new_n307_ = new_n293_ & ~x38 & ~x40 & new_n208_ & x00 & ~x39;
  assign new_n308_ = ~x03 & x04 & x01 & ~x02;
  assign z27 = new_n199_ & ((~new_n310_ & ~x05 & ~x36) | (new_n190_ & new_n208_ & x36));
  assign new_n310_ = (new_n311_ | ~new_n83_) & (~new_n317_ | ~x39 | (~x37 & x40));
  assign new_n311_ = ~new_n316_ & (x34 | (~new_n314_ & (~x35 | (~new_n154_ & ~new_n312_))));
  assign new_n312_ = new_n94_ & (~x37 | x40) & (~x24 | (~new_n151_ & (~x40 | (~new_n313_ & x37))));
  assign new_n313_ = x22 & x23 & ((x18 & x19) | (x09 & (x18 | x19)));
  assign new_n314_ = new_n122_ & ((~new_n315_ & ~x09) | (~new_n185_ & ~x16 & ~x17));
  assign new_n315_ = (x17 | ((~x37 | x38 | x39) & (~x38 | ~x39))) & (x16 | ((x38 | (~x40 & (~x37 | x39))) & (x37 | (~x39 & (~x38 | x40)))));
  assign new_n316_ = ~new_n151_ & x37 & new_n107_ & new_n99_ & ~x38;
  assign new_n317_ = ~x34 & ~x35 & ~x31 & ~x09 & x38;
  assign z29 = new_n199_ & ((~new_n319_ & ~x05 & ~x36) | (new_n190_ & new_n208_ & x36));
  assign new_n319_ = (new_n320_ | x34) & (~new_n175_ | ~x15 | x21);
  assign new_n320_ = (~new_n322_ | ((~x38 | x39 | ~x40) & (~x39 | x40 | ~x37 | x38))) & (~new_n321_ | x37 | (~x38 ^ ~x39));
  assign new_n321_ = new_n92_ & ~x21 & x22 & x35 & ~x40;
  assign new_n322_ = ~new_n117_ & new_n122_;
  assign z30 = new_n199_ & (new_n324_ | (new_n329_ & ~x34 & ~x35));
  assign new_n324_ = new_n83_ & ~x05 & ~x36 & (new_n325_ | new_n316_);
  assign new_n325_ = ~new_n326_ & (~new_n195_ | x22) & x35 & x24 & ~x34;
  assign new_n326_ = (new_n327_ | x21) & x22 & (~new_n119_ | ~x21 | x23 | x40);
  assign new_n327_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | (~new_n328_ & (x37 | x40)));
  assign new_n328_ = ((x18 & x19) | (x09 & (x18 | x19))) & ~x23 & x37 & x40;
  assign new_n329_ = new_n125_ & x36 & new_n127_ & ~x37 & x38;
  assign z31 = new_n199_ & (new_n336_ | (~new_n331_ & ~x34 & (new_n329_ | x35)));
  assign new_n331_ = ~new_n332_ & x35 & (~new_n335_ | ~x36 | ~x37 | ~x38);
  assign new_n332_ = new_n83_ & ~x05 & ~x36 & (new_n334_ | (~new_n333_ & new_n94_));
  assign new_n333_ = (~new_n328_ | ~x24 | x21 | ~x22) & (x24 | (x37 & ~x40));
  assign new_n334_ = new_n119_ & (~x24 | (new_n151_ & ~x23 & ~x40));
  assign new_n335_ = x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n336_ = new_n335_ & new_n107_ & ~x36 & ~x38 & ~new_n99_ & ~x37;
  assign z34 = x33 & (x07 | (~new_n338_ & ~x32));
  assign new_n338_ = (new_n339_ | x35 | x36) & (x34 | (~new_n343_ & new_n354_));
  assign new_n339_ = (new_n340_ | x38) & (new_n342_ | ~x34 | ~x37 | ~x38);
  assign new_n340_ = ((~new_n341_ & (x00 | ~x05)) | x37 | (x39 & x40)) & (~x05 | ~x39 | ~x37 | ~x40);
  assign new_n341_ = new_n218_ & x34 & ~x03 & x04;
  assign new_n342_ = (x39 | x40) & (~x06 | ~x39 | ~x40);
  assign new_n343_ = x39 & (~new_n350_ | (x38 & (new_n353_ | (~new_n344_ & ~x37))));
  assign new_n344_ = ~new_n349_ & (~new_n348_ | (new_n347_ & (~x15 | (~new_n345_ & ~new_n346_))));
  assign new_n345_ = new_n158_ & (new_n86_ | (~new_n85_ & new_n228_));
  assign new_n346_ = new_n228_ & x09 & ~new_n225_ & ~x40;
  assign new_n347_ = ~x36 & (~new_n143_ | x13 | ~new_n228_ | x40);
  assign new_n348_ = ~x35 & ((new_n106_ & x00) | ~x36 | ~x40);
  assign new_n349_ = x35 & x36 & x06 & x40;
  assign new_n350_ = (~new_n352_ | ~x35 | x36 | x37) & (x35 | ((new_n351_ | x36) & (~new_n352_ | ~x11 | ~x36 | x37)));
  assign new_n351_ = (~x05 | (x38 & x40)) & (~new_n229_ | (~new_n297_ & (new_n83_ | (x38 & ~x40))));
  assign new_n352_ = ~x38 & x40;
  assign new_n353_ = x05 & ((x35 & ~x36 & ~x37) | ((~x40 | (x36 & ~x37)) & ~x00 & (~x36 | (~x35 & x40))));
  assign new_n354_ = ~new_n358_ & (x36 | (~new_n362_ & (x35 | (~new_n355_ & new_n356_))));
  assign new_n355_ = x37 & ((x05 & x38) | (new_n231_ & ~x38 & ~x05 & ~x31));
  assign new_n356_ = ~new_n357_ & (~x05 | ((~x38 | x39) & new_n86_ & new_n87_));
  assign new_n357_ = ~new_n83_ & new_n228_ & ((~x39 & ~x40 & ~x37 & x38) | (~x38 & x40));
  assign new_n358_ = new_n293_ & (new_n361_ | (~new_n359_ & x38));
  assign new_n359_ = (~new_n205_ | (~x35 & (x39 | ~x40))) & (~new_n360_ | (~x35 & (x04 | x39)) | (~x04 & (x35 | ~x40)));
  assign new_n360_ = ~x03 & x00 & ~x01 & ~x02;
  assign new_n361_ = ((new_n308_ & x00 & ~x40) | ~x35 | (x06 & x40)) & new_n94_ & (x35 | ~x40);
  assign new_n362_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & x38 & ~x37 & ~x40));
  assign z00 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
