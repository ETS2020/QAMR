// Benchmark "FAU" written by ABC on Thu Jul 30 00:54:47 2020
...
module FAU ( 
  ...
  assign new_n155_ = ((~x35 & (~new_n156_ | x35 | ~x40)) | x37 | (x38 & x40)) & (x35 | ~x38 | ~x37 | ~x40);
  ...
  assign z13 = x33 & (x07 | (new_n310_ & new_n216_ & ~new_n174_ & ~x07 & ~x32));
  ...
  assign z20 = new_n138_ & ((~new_n375_ & ~x34 & x36) | (~x36 & (new_n370_ | (~new_n363_ & ~x34))));
  ...
  assign new_n372_ = ~new_n374_ & (x37 | (~new_n373_ & (new_n111_ | ~new_n308_)));
  assign new_n373_ = ~x05 & ~x34 & (x31 | (~new_n99_ & x39));
  assign new_n374_ = x39 & ((x05 & (~x34 | (x37 & x40))) | (~new_n99_ & x37 & x34 & x40));
  assign new_n375_ = (new_n376_ | ~x40) & (~new_n102_ | ~new_n308_ | ~x38);
  assign new_n376_ = (~new_n308_ | ~x38 | (x35 & x39) | (x37 ^ ~x39)) & (x38 | ~x39 | x37 | ~x11 | x35);
  assign z22 = new_n361_ & (new_n383_ | (~x34 & (new_n381_ | (~new_n378_ & ~x36))));
  assign new_n378_ = (new_n380_ | ~x05 | x32) & (x35 | (new_n358_ & (new_n379_ | ~x05)));
  assign new_n379_ = new_n146_ & (~x38 ^ x39) & (~x39 | (~x37 & x40));
  assign new_n380_ = (x39 | x37 | x38) & (x00 | ~x38 | ~x39 | x40) & (~x35 | ((~x40 | x38 | x39) & (x37 | ~x38 | ~x39)));
  assign new_n381_ = new_n382_ & (x37 | (~x35 & x39)) & new_n308_ & x36 & (x35 | ~x37 | ~x39);
  assign new_n382_ = (x35 | x40) & ~x32 & x38;
  assign new_n383_ = new_n384_ & ((new_n111_ & x37) | (~x00 & ~new_n111_ & ~x37));
  ...
  assign new_n387_ = (new_n388_ | ~x15) & new_n394_ & ((~new_n345_ & ~x35) | (~new_n85_ & x15));
  assign new_n388_ = ~new_n393_ & (~x37 | ((new_n389_ | x05) & (~new_n154_ | x35)));
  assign new_n389_ = (~new_n89_ | new_n392_) & (new_n85_ | ((new_n390_ | ~new_n391_) & (~new_n89_ | new_n114_)));
  ...
  assign new_n395_ = (new_n399_ | ~x35 | ~x39) & (x35 | (~new_n396_ & ~new_n398_));
  assign new_n396_ = (new_n397_ | x05 | (x31 & ~x37)) & ~x36 & (~x05 | x39);
  assign new_n397_ = ~x31 & (x39 | x40) & ((new_n90_ & x40) | ~new_n99_ | (x37 & ~x40));
  ...
  assign new_n402_ = (new_n189_ | ~x39) & (~new_n191_ | ((x09 | x40) & (x17 | ~x39 | ~x40)));
  assign new_n403_ = ~new_n99_ & ~x40 & (~x39 | (new_n201_ & ~x13));
  assign new_n404_ = (x09 | ~x39 | (~new_n405_ & ~x37 & x40)) & ~x31 & (x39 | ~x40);
  assign new_n405_ = ~x17 & x15 & (x11 | x12);
  assign new_n406_ = ~x05 & (~x31 | ~x39);
  assign new_n407_ = ~new_n218_ & ~x36 & (~x05 | (~x37 & x39));
  assign new_n408_ = (new_n409_ | ~x37) & (x37 | (~x39 ^ x40)) & (x37 | x36 | ~x39);
  assign new_n409_ = (~x00 | (~new_n109_ & x36)) & (new_n174_ | x36) & (~x36 | x00 | ~x05);
  assign new_n410_ = (~x36 | (x40 & x37 & ~x39)) & new_n308_ & (x36 | (x39 & ~x40));
  assign new_n411_ = (x37 ^ x39) & (~x05 | ~x39) & x40 & ~x00 & x36;
  assign new_n412_ = (~new_n117_ | (~new_n415_ & ~x37)) & new_n413_ & (x39 | (~new_n146_ & ~new_n117_));
  assign new_n413_ = ~x35 & ~x36 & (~new_n146_ | ~new_n414_);
  assign new_n414_ = x40 & (x05 | (x31 & ~x37));
  assign new_n415_ = (~new_n201_ | ~x13) & (new_n99_ ? ~new_n90_ : ~x40);
  assign new_n416_ = ~x39 & (~x36 | ~x37 | (x35 ? (~x40 & x00 & x37) : x40));
  assign new_n417_ = ~x35 & (new_n421_ | (new_n418_ & (x38 | (~new_n420_ & ~new_n422_))));
  assign new_n418_ = ~x36 & (new_n419_ | ~x38 | (x34 & (~new_n111_ | ~x37)));
  assign new_n419_ = new_n264_ & new_n111_ & ~x05 & ~x31 & x15 & ~x37;
  assign new_n420_ = (~x34 | (~new_n108_ & ~new_n111_)) & ~x37 & (new_n111_ | ~new_n308_);
  assign new_n421_ = x34 & new_n133_ & x36 & ~x37;
  assign new_n422_ = (~x34 | (new_n126_ & ~x40)) & x37 & (~x39 | (~x34 & (~x05 | ~x40)));
  assign z24 = (~new_n429_ | (~new_n424_ & ~x34)) & new_n138_ & (~new_n431_ | (~new_n333_ & ~x34));
  assign new_n424_ = (new_n425_ | x05) & (~new_n102_ | ~new_n181_ | ~x38);
  assign new_n425_ = (~new_n94_ | ~new_n89_) & (new_n426_ | ~new_n99_);
  assign new_n426_ = ~new_n325_ & (~x38 | (~new_n326_ & (x37 | (~new_n321_ & ~new_n427_))));
  assign new_n427_ = x39 & (new_n87_ | (x35 & (~new_n212_ | new_n428_)));
  assign new_n428_ = ~x40 & (~x21 | ~x23);
  assign new_n429_ = ~new_n332_ & ~x36 & (x38 | (~new_n327_ & ~new_n430_));
  assign new_n430_ = ~new_n250_ & new_n99_ & ~x05 & ~x34 & x35 & ~x39;
  assign new_n431_ = x36 & (~new_n133_ | ~new_n128_ | x37);
  assign z25 = ~new_n436_ & new_n138_ & (~new_n433_ | (~new_n425_ & ~x05 & ~x34));
  assign new_n433_ = ~x36 & (x38 | (~new_n434_ & ~new_n430_));
  assign new_n434_ = ~x35 & ((~new_n112_ & new_n117_ & ~x34) | (x34 & (new_n203_ | new_n435_)));
  assign new_n435_ = new_n207_ & x02 & ~new_n111_ & ~x37 & ~x03 & x04;
  assign new_n436_ = new_n431_ & (x34 | (~new_n438_ & (new_n437_ | ~new_n102_)));
  assign new_n437_ = (~new_n174_ | x38) & (~new_n207_ | ~x02 | ~x38 | x03 | ~x04);
  assign new_n438_ = ~x40 & new_n137_ & ~x35 & ~x37 & x38 & ~x39;
  assign z27 = new_n138_ & (new_n440_ | (new_n216_ & x36 & new_n174_ & new_n175_));
  assign new_n440_ = new_n348_ & (new_n445_ | (new_n99_ & (new_n444_ | (~new_n441_ & ~x34))));
  assign new_n441_ = (~x35 | (~new_n211_ & (new_n250_ | ~new_n151_))) & (new_n442_ | x31 | x35);
  assign new_n442_ = (new_n443_ | x16) & ((~new_n100_ & ~new_n193_) | x09 | x17);
  assign new_n443_ = (x17 | (x39 & (x37 | ~x40)) | (~x37 & ~x38) | (x38 & ~x39)) & (x09 | ((x38 | (~x40 & (~x37 | x39))) & (x37 | (~x39 & (~x38 | x40)))));
  assign new_n444_ = new_n128_ & new_n175_ & new_n111_ & ~new_n125_;
  assign new_n445_ = new_n97_ & ~x34 & new_n89_ & x38;
  assign z28 = new_n138_ & (new_n449_ | (~new_n447_ & new_n448_));
  assign new_n447_ = (~x37 | ~x38 | ~x36 | x34 | ~x35) & (new_n111_ | x37 | x38 | x36 | ~x34 | x35);
  assign new_n448_ = new_n206_ & new_n207_;
  assign new_n449_ = new_n137_ & ~x35 & new_n303_ & new_n181_ & x38;
  assign z30 = new_n138_ & (new_n449_ | (~new_n451_ & new_n347_));
  assign new_n451_ = ~new_n444_ & (new_n452_ | (new_n282_ & ~x22) | ~new_n216_ | ~x24);
  assign new_n452_ = ~new_n453_ & x22 & (~new_n214_ | ~new_n428_);
  assign new_n453_ = new_n151_ & ~x21 & (new_n454_ | (~x37 & ~x40));
  assign new_n454_ = (x18 | x19) & (x09 | (x18 & x19)) & new_n237_ & ~x23;
  assign z31 = new_n138_ & (new_n459_ | (~x34 & (new_n456_ | (new_n438_ & x36))));
  assign new_n456_ = x35 & ((~new_n457_ & new_n347_) | (new_n448_ & new_n228_ & x36));
  assign new_n457_ = ~new_n458_ & (~new_n214_ | (x24 & (~new_n125_ | x23 | x40)));
  assign new_n458_ = new_n151_ & ((new_n454_ & ~x21 & x22) | (~new_n253_ & ~x24));
  assign new_n459_ = new_n448_ & ~new_n111_ & new_n183_ & ~x37 & ~x38;
  assign z33 = (x32 & (x07 | ~x33)) | (~x32 & x33 & (new_n461_ | x07 | (~new_n476_ & new_n479_)));
  assign new_n461_ = (new_n462_ | ~x35) & ~x34 & (new_n470_ | x35 | (~new_n475_ & x36));
  assign new_n462_ = ((~new_n463_ & ~x36) | x37 | (~new_n469_ & x36)) & (new_n465_ | ~x37 | (~new_n467_ & x36));
  assign new_n463_ = (~x38 | x39 | x40) & (x38 | ~x39 | ~x40) & (x05 | (~new_n464_ & (~new_n110_ | (x38 ? ~x39 : (x39 | x40)))));
  assign new_n464_ = new_n212_ & new_n99_ & ((new_n100_ & ~new_n213_) | (new_n133_ & x21));
  assign new_n465_ = (new_n466_ | (~new_n99_ & ~x13)) & new_n252_ & new_n348_ & (new_n99_ ? x24 : ~x13);
  assign new_n466_ = ~new_n121_ & x22;
  assign new_n467_ = ((~x06 & ~x39) | x38 | ~x40) & ((x01 & (x38 | x39 | x40)) | ~new_n468_ | (~x01 & ~x38));
  assign new_n468_ = ~x02 & ~x03 & x00 & x04;
  assign new_n469_ = (x39 | (x38 & ~x40)) & (~x38 | ~x39 | (~x06 & x40));
  assign new_n470_ = new_n117_ & ~x36 & (~new_n471_ | new_n474_ | (~new_n473_ & x15));
  assign new_n471_ = new_n472_ & (new_n99_ | x38 | (~x40 & (~x37 | x39)));
  assign new_n472_ = (~new_n197_ | ((~x38 | x39 | ~x40) & (~x39 | x40 | ~x37 | x38))) & (~x37 | ~x38 | ~x09 | ~x39);
  assign new_n473_ = (~new_n148_ | ~new_n144_) & (~new_n214_ | ~x09 | new_n147_ | x40);
  assign new_n474_ = ~x37 & ((~new_n99_ & x38 & ~x39 & ~x40) | (~new_n99_ & x39 & (new_n201_ | ~x38 | x40)));
  assign new_n475_ = (x37 | ((~x38 | x39 | (new_n137_ & ~x40)) & (~x39 | (x38 & x40) | (~x38 & (new_n85_ | ~x40))))) & (x40 | ~x37 | x38 | x39);
  assign new_n476_ = new_n477_ & (~new_n111_ | (~new_n292_ & x37));
  assign new_n477_ = ~x38 & (new_n478_ | x01 | x02 | x03);
  assign new_n478_ = (~x00 | ~x04 | x37 | (x39 & x40)) & (x04 | x39 | ~x37 | x40);
  assign new_n479_ = new_n183_ & (~x38 | ((~x37 | x40) & (~x39 | (x06 & x37))));
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z14 = 1'b0;
