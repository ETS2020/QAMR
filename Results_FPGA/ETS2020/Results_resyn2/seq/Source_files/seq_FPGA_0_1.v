// Benchmark "FAU" written by ABC on Thu Jul 30 00:53:59 2020
...
module FAU ( 
  ...
  assign z13 = x33 & (x07 | (new_n307_ & ~x07 & ~x32 & ~new_n174_ & new_n216_));
  assign new_n307_ = (~x36 | (~x38 & ~x39)) & (x36 | x38 | x39) & ~x37 & (~x38 | ~x40);
  assign z14 = x33 & (new_n309_ | x07);
  assign new_n309_ = (x36 | (x38 & ~x39 & ~x40) | (~x38 & x39 & x40)) & new_n310_ & (~x36 | (x13 & ~x38 & ~x39));
  assign new_n310_ = new_n216_ & ~x32 & ~x37;
  assign z16 = new_n138_ & (new_n312_ | (new_n183_ & new_n103_ & x37 & x39));
  assign new_n312_ = ~x34 & ((~new_n313_ & x36) | (new_n102_ & ~x36 & new_n95_ & x38));
  assign new_n313_ = (new_n314_ | x35) & (~new_n316_ | ~new_n133_ | ~x35 | ~x37);
  assign new_n314_ = (~x38 | (~new_n315_ & (~x37 | x39 | x40))) & (x37 | x38 | (x39 & (~new_n85_ | ~x40)));
  assign new_n315_ = new_n126_ & (~x37 ^ ~x39) & x00 & x40;
  assign new_n316_ = x00 & x04 & x01 & ~x02 & ~x03;
  assign z17 = x33 & (x07 | (~x32 & (new_n318_ | (~new_n333_ & new_n229_))));
  assign new_n318_ = ~x36 & (new_n319_ | new_n332_ | (~x38 & (new_n327_ | new_n331_)));
  assign new_n319_ = ~x05 & ~x34 & ((new_n94_ & new_n89_) | (~new_n320_ & new_n99_));
  assign new_n320_ = ~new_n325_ & (~x38 | (~new_n326_ & (x37 | (~new_n321_ & ~new_n323_))));
  assign new_n321_ = ~x09 & (new_n322_ | (~x18 & ~x21 & x35 & x39));
  assign new_n322_ = ~x16 & ~x40 & ~x31 & ~x35;
  assign new_n323_ = x39 & (new_n87_ | (x35 & (~new_n212_ | new_n324_)));
  assign new_n324_ = (~x21 | (~x23 & ~x40)) & (~x40 | x09 | x18);
  assign new_n325_ = new_n89_ & new_n90_ & ~x37 & x39;
  assign new_n326_ = ~x35 & x39 & ~x31 & ~x09 & ~x17;
  assign new_n327_ = ~x35 & ((~new_n328_ & x34) | (~new_n112_ & new_n117_ & ~x34));
  assign new_n328_ = (~x02 | (~new_n329_ & (~x37 | x39))) & (~x37 | (~new_n204_ & (new_n330_ | x39)));
  assign new_n329_ = new_n207_ & ~new_n111_ & ~x37 & ~x03 & x04;
  assign new_n330_ = ~x03 & ~x01 & ~x04;
  assign new_n331_ = ~new_n210_ & new_n99_ & ~x05 & ~x34 & x35 & ~x39;
  assign new_n332_ = new_n214_ & ~new_n126_ & new_n128_;
  assign new_n333_ = (new_n335_ | x40) & (~x00 | (~new_n132_ & (new_n334_ | ~x38)));
  assign new_n334_ = (~new_n206_ | ~x37 | x01 | ~x35) & (~x40 | ~new_n131_ | x35);
  assign new_n335_ = (~x37 | x38 | ~x35 | ~x39) & (~new_n137_ | x35 | x37 | ~x38 | x39);
  assign z18 = new_n361_ & (new_n357_ | (~x32 & (new_n337_ | new_n341_)));
  assign new_n337_ = new_n128_ & ((~new_n338_ & ~x36) | (new_n133_ & x36 & ~x37));
  assign new_n338_ = ~new_n339_ & ((~x37 & ~new_n126_ & x39) | ~x38 | (x37 & x39 & x40));
  assign new_n339_ = new_n340_ & ((x39 & (new_n124_ | ~x40)) | ~x37 | (new_n126_ & ~x39 & x40));
  assign new_n340_ = ~x38 & (new_n111_ | x37 | (new_n207_ & ~x04));
  assign new_n341_ = ~x34 & ((~new_n342_ & x38) | ((new_n351_ | ~new_n353_) & ~new_n355_ & ~x38));
  assign new_n342_ = (new_n343_ | x35 | (~new_n315_ & new_n349_)) & (new_n346_ | new_n350_ | ~x35);
  assign new_n343_ = (new_n344_ | ~x40) & ~x36 & (~new_n345_ | ~x09 | ~x39);
  assign new_n344_ = (~x39 | ~new_n154_ | ~x15 | x37) & (~new_n117_ | ~new_n96_ | x39);
  assign new_n345_ = new_n117_ & x37;
  assign new_n346_ = (~new_n347_ | ~new_n251_ | ~x39) & ~x37 & ((~x39 ^ x40) | (~x36 & x39));
  assign new_n347_ = new_n99_ & new_n348_;
  assign new_n348_ = ~x05 & ~x36;
  assign new_n349_ = (x37 | x39 | (new_n137_ & ~x40)) & (~x39 | (~x37 & x40)) & x36 & (~x37 | x40);
  assign new_n350_ = (~x00 | (x36 & (x01 | x04))) & x37 & (new_n174_ | x36);
  assign new_n351_ = ~new_n352_ & x37 & (new_n123_ | ~new_n95_ | ~x35);
  assign new_n352_ = (~new_n154_ | ~new_n176_) & ~x35 & (~new_n117_ | ~new_n174_ | ~new_n96_);
  assign new_n353_ = ~x36 & (new_n354_ | x05 | x37 | ~x35 | x39);
  assign new_n354_ = (~x40 | new_n99_ | x13) & ((~new_n125_ & ~x40) | ~new_n99_ | ~x24);
  assign new_n355_ = new_n356_ & (~x37 | ((x35 | (~x39 & ~x40)) & (~new_n316_ | x40 | ~x35 | x39)));
  assign new_n356_ = (~x40 | x11 | x37) & x36 & (x37 | (~x35 & x39));
  assign new_n357_ = ~new_n358_ & ~x34 & ~x35 & ~x36;
  assign new_n358_ = ~x32 & (~new_n117_ | (~new_n359_ & (~new_n181_ | (~x37 ^ ~x38))));
  assign new_n359_ = x15 & (new_n360_ | (new_n147_ & x09 & ~x37 & ~x40));
  assign new_n360_ = ~new_n85_ & ~new_n90_ & ((~x37 & ~x38) | (x38 & ~x39 & ~x40) | (~x38 & x39 & x40));
  assign new_n361_ = ~x07 & x33;
  assign z20 = new_n138_ & ((~new_n376_ & ~x34 & x36) | (~x36 & (new_n370_ | (~new_n363_ & ~x34))));
  assign new_n363_ = (new_n364_ | x35) & ~new_n369_ & (new_n367_ | ~x35);
  assign new_n364_ = (new_n365_ | x31 | x05 | x37) & ~new_n366_ & (new_n146_ | (~x05 & ~x31));
  assign new_n365_ = (~x39 | (~new_n287_ & (~x40 | (new_n99_ & (~new_n144_ | ~x38))))) & (new_n99_ | ~x38 | x39 | x40);
  assign new_n366_ = (x38 | (x39 & (~x05 | ~x40))) & (x05 | x31) & (x37 | ~x39 | ~x40);
  assign new_n367_ = (new_n368_ | (~x05 & (new_n99_ | ~x13))) & (new_n99_ | x05 | (x13 ? ~new_n280_ : new_n282_));
  assign new_n368_ = ~new_n252_ & (~new_n100_ | x37);
  assign new_n369_ = x05 & (new_n280_ | (~x00 & new_n174_ & x38));
  assign new_n370_ = ~x35 & ~x38 & (~new_n372_ | (~new_n371_ & new_n117_ & ~x34));
  assign new_n371_ = (~new_n143_ | ~x37 | x39) & (new_n99_ | (~x40 & (~x37 | x39)));
  assign new_n372_ = ~new_n374_ & (x37 | (~new_n373_ & (new_n111_ | ~new_n375_)));
  assign new_n373_ = ~x05 & ~x34 & (x31 | (~new_n99_ & x39));
  assign new_n374_ = x39 & ((x05 & (~x34 | (x37 & x40))) | (~new_n99_ & x37 & x34 & x40));
  assign new_n375_ = ~x00 & x05;
  assign new_n376_ = (new_n377_ | ~x40) & (~new_n102_ | ~new_n375_ | ~x38);
  assign new_n377_ = (~new_n375_ | ~x38 | (x35 & x39) | (x37 ^ ~x39)) & (x38 | ~x39 | x37 | ~x11 | x35);
  assign z22 = new_n361_ & (new_n384_ | (~x34 & (new_n382_ | (~new_n379_ & ~x36))));
  assign new_n379_ = (new_n381_ | ~x05 | x32) & (x35 | (new_n358_ & (new_n380_ | ~x05)));
  assign new_n380_ = new_n146_ & (~x38 ^ x39) & (~x39 | (~x37 & x40));
  assign new_n381_ = (x39 | x37 | x38) & (x00 | ~x38 | ~x39 | x40) & (~x35 | ((~x40 | x38 | x39) & (x37 | ~x38 | ~x39)));
  assign new_n382_ = new_n383_ & (x37 | (~x35 & x39)) & new_n375_ & x36 & (x35 | ~x37 | ~x39);
  assign new_n383_ = (x35 | x40) & ~x32 & x38;
  assign new_n384_ = new_n385_ & ((new_n111_ & x37) | (~x00 & ~new_n111_ & ~x37));
  assign new_n385_ = x05 & ~x32 & ~x38 & ~x35 & ~x36;
  assign z23 = x33 & (x07 | (~x32 & (new_n418_ | (~new_n387_ & ~x34))));
  assign new_n387_ = ~new_n413_ & (new_n401_ | ~x38) & (x38 | (new_n396_ & (new_n388_ | ~new_n417_)));
  assign new_n388_ = (new_n389_ | ~x15) & new_n395_ & ((~new_n345_ & ~x35) | (~new_n85_ & x15));
  assign new_n389_ = ~new_n394_ & (~x37 | ((new_n390_ | x05) & (~new_n154_ | x35)));
  assign new_n390_ = (~new_n89_ | new_n393_) & (new_n85_ | ((new_n391_ | ~new_n392_) & (~new_n89_ | new_n114_)));
  assign new_n391_ = ~x24 & (x21 | ((x18 | x19) & (x09 | (x18 & x19))));
  assign new_n392_ = x35 & x40;
  assign new_n393_ = ((~x11 & ~x12) | (x11 & x12) | (~x16 & ~x17) | (~x09 & (~x16 | ~x17))) & (x14 | ~x11 | ~x12);
  assign new_n394_ = (~x37 | (~x24 & x40)) & ~x05 & ~new_n85_ & x35;
  assign new_n395_ = ~x36 & ((~x35 & x37) | (~x05 & (~x37 | x40)));
  assign new_n396_ = (new_n400_ | ~x35 | ~x39) & (x35 | (~new_n397_ & ~new_n399_));
  assign new_n397_ = (new_n398_ | x05 | (x31 & ~x37)) & ~x36 & (~x05 | x39);
  assign new_n398_ = ~x31 & (x39 | x40) & ((new_n90_ & x40) | ~new_n99_ | (x37 & ~x40));
  assign new_n399_ = (x39 | (new_n85_ & ~x37)) & x36 & (x37 | x40);
  assign new_n400_ = x36 ? (x37 & x40) : ~x37;
  assign new_n401_ = ~new_n411_ & (new_n409_ | ~x35) & (new_n412_ | x35 | (~new_n402_ & new_n408_));
  assign new_n402_ = new_n407_ & (~new_n405_ | (~x37 & (new_n404_ | (~new_n403_ & x15))));
  assign new_n403_ = (new_n189_ | ~x39) & (~new_n191_ | ((x09 | x40) & (x17 | ~x39 | ~x40)));
  assign new_n404_ = ~new_n99_ & ~x40 & (~x39 | (new_n201_ & ~x13));
  assign new_n405_ = (x09 | ~x39 | (~new_n406_ & ~x37 & x40)) & ~x31 & (x39 | ~x40);
  assign new_n406_ = ~x17 & x15 & (x11 | x12);
  assign new_n407_ = ~x05 & (~x31 | ~x39);
  assign new_n408_ = ~new_n218_ & ~x36 & (~x05 | (~x37 & x39));
  assign new_n409_ = (new_n410_ | ~x37) & (x37 | (~x39 ^ x40)) & (x37 | x36 | ~x39);
  assign new_n410_ = (~x00 | (~new_n109_ & x36)) & (new_n174_ | x36) & (~x36 | x00 | ~x05);
  assign new_n411_ = (~x36 | (x40 & x37 & ~x39)) & new_n375_ & (x36 | (x39 & ~x40));
  assign new_n412_ = (x37 ^ x39) & (~x05 | ~x39) & x40 & ~x00 & x36;
  assign new_n413_ = (~new_n117_ | (~new_n416_ & ~x37)) & new_n414_ & (x39 | (~new_n146_ & ~new_n117_));
  assign new_n414_ = ~x35 & ~x36 & (~new_n146_ | ~new_n415_);
  assign new_n415_ = x40 & (x05 | (x31 & ~x37));
  assign new_n416_ = (~new_n201_ | ~x13) & (new_n99_ ? ~new_n90_ : ~x40);
  assign new_n417_ = ~x39 & (~x36 | ~x37 | (x35 ? (~x40 & x00 & x37) : x40));
  assign new_n418_ = ~x35 & (new_n422_ | (new_n419_ & (x38 | (~new_n421_ & ~new_n423_))));
  assign new_n419_ = ~x36 & (new_n420_ | ~x38 | (x34 & (~new_n111_ | ~x37)));
  assign new_n420_ = new_n264_ & new_n111_ & ~x05 & ~x31 & x15 & ~x37;
  assign new_n421_ = (~x34 | (~new_n108_ & ~new_n111_)) & ~x37 & (new_n111_ | ~new_n375_);
  assign new_n422_ = x34 & new_n133_ & x36 & ~x37;
  assign new_n423_ = (~x34 | (new_n126_ & ~x40)) & x37 & (~x39 | (~x34 & (~x05 | ~x40)));
  assign z24 = (~new_n430_ | (~new_n425_ & ~x34)) & new_n138_ & (~new_n432_ | (~new_n333_ & ~x34));
  assign new_n425_ = (new_n426_ | x05) & (~new_n102_ | ~new_n181_ | ~x38);
  assign new_n426_ = (~new_n94_ | ~new_n89_) & (new_n427_ | ~new_n99_);
  assign new_n427_ = ~new_n325_ & (~x38 | (~new_n326_ & (x37 | (~new_n321_ & ~new_n428_))));
  assign new_n428_ = x39 & (new_n87_ | (x35 & (~new_n212_ | new_n429_)));
  assign new_n429_ = ~x40 & (~x21 | ~x23);
  assign new_n430_ = ~new_n332_ & ~x36 & (x38 | (~new_n327_ & ~new_n431_));
  assign new_n431_ = ~new_n250_ & new_n99_ & ~x05 & ~x34 & x35 & ~x39;
  assign new_n432_ = x36 & (~new_n133_ | ~new_n128_ | x37);
  assign z25 = ~new_n437_ & new_n138_ & (~new_n434_ | (~new_n426_ & ~x05 & ~x34));
  assign new_n434_ = ~x36 & (x38 | (~new_n435_ & ~new_n431_));
  assign new_n435_ = ~x35 & ((~new_n112_ & new_n117_ & ~x34) | (x34 & (new_n203_ | new_n436_)));
  assign new_n436_ = new_n207_ & x02 & ~new_n111_ & ~x37 & ~x03 & x04;
  assign new_n437_ = new_n432_ & (x34 | (~new_n439_ & (new_n438_ | ~new_n102_)));
  assign new_n438_ = (~new_n174_ | x38) & (~new_n207_ | ~x02 | ~x38 | x03 | ~x04);
  assign new_n439_ = ~x40 & new_n137_ & ~x35 & ~x37 & x38 & ~x39;
  assign z27 = new_n138_ & (new_n441_ | (new_n216_ & x36 & new_n174_ & new_n175_));
  assign new_n441_ = new_n348_ & (new_n446_ | (new_n99_ & (new_n445_ | (~new_n442_ & ~x34))));
  assign new_n442_ = (~x35 | (~new_n211_ & (new_n250_ | ~new_n151_))) & (new_n443_ | x31 | x35);
  assign new_n443_ = (new_n444_ | x16) & ((~new_n100_ & ~new_n193_) | x09 | x17);
  assign new_n444_ = (x17 | (x39 & (x37 | ~x40)) | (~x37 & ~x38) | (x38 & ~x39)) & (x09 | ((x38 | (~x40 & (~x37 | x39))) & (x37 | (~x39 & (~x38 | x40)))));
  assign new_n445_ = new_n128_ & new_n175_ & new_n111_ & ~new_n125_;
  assign new_n446_ = new_n97_ & ~x34 & new_n89_ & x38;
  assign z28 = new_n138_ & (new_n450_ | (~new_n448_ & new_n449_));
  assign new_n448_ = (x36 | ~x34 | x35 | new_n111_ | x37 | x38) & (~x37 | ~x38 | ~x36 | x34 | ~x35);
  assign new_n449_ = new_n206_ & new_n207_;
  assign new_n450_ = new_n137_ & ~x35 & new_n303_ & new_n181_ & x38;
  assign z30 = new_n138_ & (new_n450_ | (~new_n452_ & new_n347_));
  assign new_n452_ = ~new_n445_ & (new_n453_ | (new_n282_ & ~x22) | ~new_n216_ | ~x24);
  assign new_n453_ = ~new_n454_ & x22 & (~new_n214_ | ~new_n429_);
  assign new_n454_ = new_n151_ & ~x21 & (new_n455_ | (~x37 & ~x40));
  assign new_n455_ = (x18 | x19) & (x09 | (x18 & x19)) & new_n237_ & ~x23;
  assign z31 = new_n138_ & (new_n460_ | (~x34 & (new_n457_ | (new_n439_ & x36))));
  assign new_n457_ = x35 & ((~new_n458_ & new_n347_) | (new_n449_ & new_n228_ & x36));
  assign new_n458_ = ~new_n459_ & (~new_n214_ | (x24 & (~new_n125_ | x23 | x40)));
  assign new_n459_ = new_n151_ & ((new_n455_ & ~x21 & x22) | (~new_n253_ & ~x24));
  assign new_n460_ = new_n449_ & new_n183_ & ~new_n111_ & ~x37 & ~x38;
  assign z33 = (x32 & (x07 | ~x33)) | (~x32 & x33 & (new_n462_ | x07 | (~new_n477_ & new_n480_)));
  assign new_n462_ = (new_n463_ | ~x35) & ~x34 & (new_n471_ | x35 | (~new_n476_ & x36));
  assign new_n463_ = ((~new_n464_ & ~x36) | x37 | (~new_n470_ & x36)) & (new_n466_ | ~x37 | (~new_n468_ & x36));
  assign new_n464_ = (~x38 | x39 | x40) & (x38 | ~x39 | ~x40) & (x05 | (~new_n465_ & (~new_n110_ | (x38 ? ~x39 : (x39 | x40)))));
  assign new_n465_ = new_n212_ & new_n99_ & ((new_n100_ & ~new_n213_) | (new_n133_ & x21));
  assign new_n466_ = (new_n467_ | (~new_n99_ & ~x13)) & new_n252_ & new_n348_ & (new_n99_ ? x24 : ~x13);
  assign new_n467_ = ~new_n121_ & x22;
  assign new_n468_ = ((~x06 & ~x39) | x38 | ~x40) & ((x01 & (x38 | x39 | x40)) | ~new_n469_ | (~x01 & ~x38));
  assign new_n469_ = ~x02 & ~x03 & x00 & x04;
  assign new_n470_ = (x39 | (x38 & ~x40)) & (~x38 | ~x39 | (~x06 & x40));
  assign new_n471_ = new_n117_ & ~x36 & (~new_n472_ | new_n475_ | (~new_n474_ & x15));
  assign new_n472_ = new_n473_ & (new_n99_ | x38 | (~x40 & (~x37 | x39)));
  assign new_n473_ = (~new_n197_ | ((~x38 | x39 | ~x40) & (~x39 | x40 | ~x37 | x38))) & (~x37 | ~x38 | ~x09 | ~x39);
  assign new_n474_ = (~new_n148_ | ~new_n144_) & (~new_n214_ | ~x09 | new_n147_ | x40);
  assign new_n475_ = ~x37 & ((~new_n99_ & x38 & ~x39 & ~x40) | (~new_n99_ & x39 & (new_n201_ | ~x38 | x40)));
  assign new_n476_ = (x37 | ((~x38 | x39 | (new_n137_ & ~x40)) & (~x39 | (x38 & x40) | (~x38 & (new_n85_ | ~x40))))) & (x40 | ~x37 | x38 | x39);
  assign new_n477_ = new_n478_ & (~new_n111_ | (~new_n292_ & x37));
  assign new_n478_ = ~x38 & (new_n479_ | x01 | x02 | x03);
  assign new_n479_ = (~x00 | ~x04 | x37 | (x39 & x40)) & (x04 | x39 | ~x37 | x40);
  assign new_n480_ = new_n183_ & (~x38 | ((~x37 | x40) & (~x39 | (x06 & x37))));
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
