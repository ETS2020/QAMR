...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n77_, new_n78_, new_n79_,
    new_n83_, new_n84_;
  ...
  assign z14 = (~x27 | (~new_n79_ & (new_n77_ | ~new_n78_))) & (~new_n78_ | (~x30 & ~x32));
  assign new_n77_ = x28 & (~x35 | ~x36);
  assign new_n78_ = x39 & x40 & ~x04 & ~x13;
  assign new_n79_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  ...
  assign z15 = 1'b0;
  assign z05 = ~z06;
  assign z13 = (x27 & (new_n79_ | (~new_n77_ & new_n78_))) | (new_n78_ & (x30 | x32));
