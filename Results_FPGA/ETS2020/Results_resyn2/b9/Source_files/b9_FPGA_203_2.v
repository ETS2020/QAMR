// Benchmark "FAU" written by ABC on Tue Jul 28 22:41:48 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n75_, new_n76_,
    new_n77_, new_n78_, new_n79_, new_n82_, new_n83_, new_n84_;
  ...
  assign z10 = new_n79_ | (~x04 & ((new_n77_ & (~new_n75_ | new_n76_)) | (new_n76_ & new_n78_)));
  assign new_n75_ = ~x30 & ~x32;
  assign new_n76_ = x27 & (x36 | (~x28 & x35));
  assign new_n77_ = x05 & x39 & x40;
  assign new_n78_ = x07 & (~x39 | ~x40);
  assign new_n79_ = x37 & x06 & x27;
  assign z12 = ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z14 = (~x27 | (~new_n84_ & (new_n82_ | ~new_n83_))) & (new_n75_ | ~new_n83_);
  ...
  assign z19 = 1'b0;
  assign z20 = 1'b0;
  assign z13 = (x27 & (new_n84_ | (~new_n82_ & new_n83_))) | (~new_n75_ & new_n83_);
endmodule
