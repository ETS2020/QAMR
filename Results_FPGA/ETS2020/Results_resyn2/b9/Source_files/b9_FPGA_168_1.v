...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n74_, new_n77_, new_n78_,
    new_n80_, new_n81_, new_n84_, new_n85_, new_n86_, new_n87_;
  ...
  assign z08 = x39 & x40;
  assign z10 = (new_n78_ & (new_n77_ | (~new_n69_ & x27))) | (x37 & x06 & x27);
  assign new_n77_ = x39 & x40 & (x30 | x32);
  assign new_n78_ = (x07 | (x39 & x40)) & ~x04 & (x05 | ~x39 | ~x40);
  ...
  assign z13 = new_n84_ | (x27 & (new_n85_ | (~new_n86_ & new_n87_)));
  assign new_n84_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
