...
module FAU ( 
  ...
  assign z10 = new_n80_ | (new_n79_ & ((new_n78_ & (new_n69_ | ~new_n70_)) | (new_n69_ & x07)));
  ...
  assign z14 = (~x27 | (~new_n85_ & (new_n83_ | ~new_n84_))) & (new_n70_ | ~new_n84_);
  ...
  assign z20 = 1'b0;
  assign z05 = ~z06;
  assign z13 = (x27 & (new_n85_ | (~new_n83_ & new_n84_))) | (~new_n70_ & new_n84_);
endmodule
