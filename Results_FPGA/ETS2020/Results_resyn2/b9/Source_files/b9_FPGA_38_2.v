// Benchmark "FAU" written by ABC on Tue Jul 28 22:40:43 2020
...
module FAU ( 
  ...
  assign z10 = new_n80_ | (new_n79_ & ((new_n78_ & ~new_n70_) | (new_n69_ & (new_n78_ | x07))));
  ...
  assign z13 = new_n86_ | (x27 & ((~new_n83_ & new_n84_) | (~new_n65_ & new_n85_)));
  assign new_n83_ = x28 & (~x35 | ~x36);
  assign new_n84_ = x39 & x40 & ~x04 & ~x13;
  assign new_n85_ = x20 & ~x18 & ~x19;
  assign new_n86_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (~new_n85_ & (~new_n84_ | (new_n70_ & new_n83_))) | (~new_n88_ & (~new_n84_ | (new_n70_ & ~new_n89_)));
