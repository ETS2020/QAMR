...
module FAU ( 
  ...
  assign z14 = ~new_n88_ & (~x27 | (~new_n87_ & (new_n85_ | ~new_n86_)));
  ...
  assign z20 = ~new_n93_ & (~x27 | ~x35) & ~x09 & ~x30;
  assign new_n93_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z08 = 1'b0;
  assign z11 = 1'b0;
  assign z18 = 1'b0;
  assign z19 = 1'b0;
  assign z05 = ~z06;
  assign z13 = new_n88_ | (x27 & (new_n87_ | (~new_n85_ & new_n86_)));
endmodule
