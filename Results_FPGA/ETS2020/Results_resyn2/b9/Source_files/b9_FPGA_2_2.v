// Benchmark "FAU" written by ABC on Tue Jul 28 22:40:29 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n79_,
    new_n80_, new_n83_, new_n84_, new_n85_, new_n86_, new_n91_;
  ...
  assign z10 = new_n80_ | (new_n79_ & ((z08 & ~new_n70_) | (new_n69_ & (z08 | x07))));
  assign new_n79_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n80_ = x37 & x06 & x27;
  assign z12 = ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z14 = ~new_n86_ & (~x27 | (~new_n85_ & (new_n83_ | ~new_n84_)));
  ...
  assign z18 = 1'b0;
  assign z19 = 1'b0;
  assign z13 = new_n86_ | (x27 & (new_n85_ | (~new_n83_ & new_n84_)));
endmodule
