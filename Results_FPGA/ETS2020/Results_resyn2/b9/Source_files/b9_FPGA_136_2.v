...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n77_,
    new_n80_, new_n81_, new_n82_, new_n84_, new_n85_, new_n88_, new_n89_,
  ...
  assign z10 = new_n82_ | (new_n81_ & ((new_n80_ & ~new_n70_) | (new_n69_ & (new_n80_ | x07))));
  assign new_n80_ = x39 & x40;
  assign new_n81_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n82_ = x37 & x06 & x27;
  assign z11 = new_n85_ & (new_n84_ | ~x08);
  assign new_n84_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
