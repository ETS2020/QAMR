// Benchmark "FAU" written by ABC on Tue Jul 28 22:40:40 2020
...
module FAU ( 
  ...
  assign new_n65_ = (x35 | x36) & ~x04 & x39 & x40;
  ...
  assign z08 = x39 & x40;
  assign z10 = new_n81_ | (~x04 & ((new_n79_ & (new_n69_ | ~new_n70_)) | (new_n69_ & new_n80_)));
  assign new_n79_ = x05 & x39 & x40;
  assign new_n80_ = x07 & (~x39 | ~x40);
  assign new_n81_ = x37 & x06 & x27;
  assign z11 = new_n84_ & (~new_n83_ | (x27 & (~z08 | ~x29)));
  assign new_n83_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n84_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
