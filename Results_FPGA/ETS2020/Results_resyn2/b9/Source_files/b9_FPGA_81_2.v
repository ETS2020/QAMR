...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n76_, new_n80_,
    new_n81_, new_n82_, new_n85_, new_n86_, new_n87_;
  ...
  assign z14 = (~x27 | (~new_n87_ & (new_n85_ | ~new_n86_))) & (~new_n86_ | (~x30 & ~x32));
  assign new_n85_ = x28 & (~x35 | ~x36);
  assign new_n86_ = x39 & x40 & ~x04 & ~x13;
  assign new_n87_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  ...
  assign z20 = 1'b0;
  assign z05 = ~z06;
  assign z13 = (x27 & (new_n87_ | (~new_n85_ & new_n86_))) | (new_n86_ & (x30 | x32));
endmodule
