...
module FAU ( 
  ...
  assign z13 = new_n88_ | (x27 & ((~new_n85_ & new_n86_) | (~new_n65_ & new_n87_)));
  assign new_n85_ = x28 & (~x35 | ~x36);
  assign new_n86_ = x39 & x40 & ~x04 & ~x13;
  assign new_n87_ = x20 & ~x18 & ~x19;
  assign new_n88_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (~new_n87_ & (~new_n86_ | (new_n70_ & new_n85_))) | (~new_n90_ & (~new_n86_ | (new_n70_ & ~new_n91_)));
  ...
  assign new_n96_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
