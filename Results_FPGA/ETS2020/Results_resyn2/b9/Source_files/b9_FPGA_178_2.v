// Benchmark "FAU" written by ABC on Tue Jul 28 22:41:38 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n76_,
    new_n79_, new_n80_, new_n81_, new_n84_, new_n85_, new_n86_, new_n87_,
    new_n89_, new_n90_, new_n93_, new_n94_;
  ...
  assign z10 = new_n81_ | (new_n80_ & ((new_n79_ & ~new_n70_) | (new_n69_ & (new_n79_ | x07))));
  assign new_n79_ = x39 & x40;
  assign new_n80_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n81_ = x37 & x06 & x27;
  assign z12 = ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = new_n87_ | (x27 & ((~new_n84_ & new_n85_) | (~new_n65_ & new_n86_)));
  assign new_n84_ = x28 & (~x35 | ~x36);
  assign new_n85_ = x39 & x40 & ~x04 & ~x13;
  assign new_n86_ = x20 & ~x18 & ~x19;
  assign new_n87_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (~new_n86_ & (~new_n85_ | (new_n70_ & new_n84_))) | (~new_n89_ & (~new_n85_ | (new_n70_ & ~new_n90_)));
  ...
  assign new_n94_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z04 = 1'b0;
  assign z08 = 1'b0;
  assign z11 = 1'b0;
  assign z15 = 1'b0;
