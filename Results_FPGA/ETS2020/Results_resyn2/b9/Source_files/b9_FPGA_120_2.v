...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n75_, new_n78_,
    new_n79_, new_n80_, new_n83_, new_n84_, new_n85_;
  ...
  assign z10 = new_n80_ | (new_n79_ & (new_n78_ | (~new_n69_ & x39 & x40)));
  assign new_n78_ = x07 & x27 & (x36 | (~x28 & x35));
  assign new_n79_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n80_ = x37 & x06 & x27;
  assign z12 = ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z14 = (~x27 | (~new_n85_ & (new_n83_ | ~new_n84_))) & (~new_n84_ | (~x30 & ~x32));
  ...
  assign z19 = 1'b0;
  assign z20 = 1'b0;
  assign z13 = (x27 & (new_n85_ | (~new_n83_ & new_n84_))) | (new_n84_ & (x30 | x32));
endmodule
