// Benchmark "FAU" written by ABC on Tue Jul 28 22:41:08 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n75_, new_n77_,
    new_n78_, new_n79_, new_n81_, new_n82_, new_n85_, new_n86_, new_n87_,
    new_n89_, new_n90_;
  ...
  assign z10 = new_n79_ | (new_n78_ & ((new_n77_ & (new_n69_ | ~new_n70_)) | (new_n69_ & x07)));
  assign new_n77_ = x39 & x40;
  assign new_n78_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n79_ = x37 & x06 & x27;
  assign z11 = new_n82_ & (~new_n81_ | (x27 & (~new_n77_ | ~x29)));
  assign new_n81_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n82_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  ...
  assign z17 = 1'b0;
  assign z05 = ~z06;
  assign z18 = ~new_n82_ | (new_n81_ & (~x27 | (new_n77_ & x29)));
  assign z19 = new_n82_ & (~new_n81_ | (x27 & (~new_n77_ | ~x29)));
endmodule
