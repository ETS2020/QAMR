...
module FAU ( 
  ...
  assign z16 = (~x23 & new_n68_ & new_n71_) | ~new_n63_ | (x23 & (~new_n68_ | ~new_n71_));
  assign new_n71_ = ~x21 & ~x22;
  assign z18 = (~x24 & ~x25 & ~x23 & new_n68_ & new_n71_) | ~new_n63_ | (x25 & (~new_n71_ | x24 | ~new_n68_ | x23));
  assign z00 = 1'b0;
  assign z17 = 1'b0;
  assign z02 = x16;
endmodule
