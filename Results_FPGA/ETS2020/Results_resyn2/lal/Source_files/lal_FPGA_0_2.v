...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n53_, new_n58_, new_n61_, new_n63_;
  assign z00 = x08 & ~x16;
  ...
  assign z16 = (new_n63_ & ~x23) | ~new_n58_ | (~new_n63_ & x23);
  assign new_n63_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = (~x24 & new_n63_ & ~x23) | ~new_n58_ | (x24 & (~new_n63_ | x23));
  assign z18 = (~x25 & ~x24 & new_n63_ & ~x23) | ~new_n58_ | (x25 & (x24 | ~new_n63_ | x23));
  assign z07 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
  assign z14 = 1'b0;
