...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n53_, new_n57_, new_n59_, new_n62_;
  assign z00 = x08 & ~x16;
  ...
  assign z14 = (~new_n59_ & x21) | ~new_n57_ | (new_n59_ & ~x21);
  assign new_n59_ = x17 & x18 & x19 & ~x20;
  assign z15 = (x22 & (~new_n59_ | x21)) | ~new_n57_ | (new_n59_ & ~x21 & ~x22);
  assign z16 = (new_n62_ & ~x23) | ~new_n57_ | (~new_n62_ & x23);
  assign new_n62_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = (~x24 & new_n62_ & ~x23) | ~new_n57_ | (x24 & (~new_n62_ | x23));
  assign z18 = (~x25 & ~x24 & new_n62_ & ~x23) | ~new_n57_ | (x25 & (x24 | ~new_n62_ | x23));
  assign z07 = 1'b0;
  assign z09 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
