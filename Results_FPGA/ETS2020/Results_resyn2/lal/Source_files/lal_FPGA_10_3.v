// Benchmark "FAU" written by ABC on Wed Jul 29 04:49:35 2020
...
module FAU ( 
  ...
  assign z14 = (~new_n66_ & x21) | ~new_n63_ | (new_n66_ & ~x21);
  assign new_n66_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n66_ | x21)) | ~new_n63_ | (new_n66_ & ~x21 & ~x22);
  assign z16 = (x23 & (~new_n66_ | ~new_n69_)) | ~new_n63_ | (~x23 & new_n66_ & new_n69_);
  assign new_n69_ = ~x21 & ~x22;
  assign z17 = (x24 & (x23 | ~new_n66_ | x21 | x22)) | ~new_n63_ | (new_n66_ & ~x23 & ~x24 & ~x21 & ~x22);
  assign z18 = (~x24 & ~x25 & ~x23 & new_n66_ & new_n69_) | ~new_n63_ | (x25 & (~new_n69_ | x24 | ~new_n66_ | x23));
  assign z05 = 1'b0;
  assign z11 = 1'b0;
  assign z13 = 1'b0;
  assign z02 = x16;
