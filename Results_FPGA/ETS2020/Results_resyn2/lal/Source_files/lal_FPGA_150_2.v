// Benchmark "FAU" written by ABC on Wed Jul 29 04:50:32 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n49_, new_n52_, new_n55_, new_n58_, new_n61_;
  ...
  assign z14 = (~new_n58_ & x21) | ~new_n55_ | (new_n58_ & ~x21);
  assign new_n58_ = x17 & x18 & x19 & ~x20;
  assign z15 = (x22 & (~new_n58_ | x21)) | ~new_n55_ | (new_n58_ & ~x21 & ~x22);
  assign z16 = (new_n61_ & ~x23) | ~new_n55_ | (~new_n61_ & x23);
  assign new_n61_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = (~x24 & new_n61_ & ~x23) | ~new_n55_ | (x24 & (~new_n61_ | x23));
  assign z18 = (~x25 & ~x24 & new_n61_ & ~x23) | ~new_n55_ | (x25 & (x24 | ~new_n61_ | x23));
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
