...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n83_, new_n91_, new_n94_, new_n100_,
    new_n102_, new_n110_, new_n111_, new_n113_, new_n114_, new_n115_,
  ...
  assign z25 = ~x2 & ~x0 & x1 & new_n102_ & ~x3 & ~x4;
  ...
  assign z30 = new_n83_ & x2 & ~x3 & ~x4 & x0 & x1;
  ...
  assign new_n113_ = new_n115_ & (x4 | (new_n114_ & (~new_n100_ | ~x0) & ~x5 & (new_n100_ | x0)));
  ...
  assign z39 = ~new_n132_ | new_n135_ | (~x5 & (new_n94_ | (~new_n134_ & ~x4)));
  assign new_n132_ = (~new_n100_ | ~x0) & ((~x0 & ~x3) | (x0 & x3) | (~x4 & (~x0 | ~x2))) & ~new_n133_ & (~x4 | (~x0 & x2 & x3));
  assign new_n133_ = ~x4 & x5 & (x6 | ~x3 | x7);
  assign new_n134_ = x6 & (~x2 | (x0 & (~x7 | x1 | ~x3)));
  ...
  assign z41 = (~new_n146_ & (new_n144_ | ~x0)) | (~x4 & (~new_n145_ | (~new_n143_ & x0)));
  assign new_n143_ = (~new_n83_ | x1 | x2) & (~x3 | ~x1 | ~x5);
  assign new_n144_ = ((x3 & (~new_n100_ | x4)) | ~x1 | (x2 & ~x3)) & (x1 | x2 | ~x3 | ~x5);
  assign new_n145_ = (x5 | (x6 ? (~x3 | x7) : x1)) & (x0 | (~x5 & ~x7));
  assign new_n146_ = ~x1 & x3 & ~x4 & (~x0 | ~x2);
  assign z43 = (~new_n149_ & ~x4) | (~new_n110_ & x4) | new_n148_ | new_n135_;
  ...
  assign new_n151_ = (~x3 | ~x4) & (x1 | x3 | (~new_n102_ & ~x4));
  assign new_n152_ = (~x0 | (x3 & (~new_n83_ | x1 | x4))) & (~x1 | (x5 & (x3 | ~x4)));
  assign new_n153_ = new_n154_ & (~x0 | (x3 & (~new_n83_ | x1 | x4)));
  assign new_n154_ = (x1 | ~x3 | ~x5) & (x0 | ((x1 | x3) & (~x6 | x4 | x5)));
  assign new_n155_ = (new_n156_ | x4) & ~z18 & (~x0 | (~new_n157_ & ~new_n74_ & ~x4));
  assign new_n156_ = ~x5 & (x1 | x6) & (~x6 | ~x3 | x7);
  ...
  assign z48 = ~new_n169_ | (~new_n80_ & ~new_n74_ & ~x4);
  assign new_n169_ = ~x0 & ~x1 & ~x2 & x3;
  assign z49 = (~new_n74_ & ~x4) | ~x2 | x0 | x1 | (x3 & x4);
  assign z50 = ~new_n118_ | x2 | x5 | (x0 & (~x1 | ~x3));
  assign z51 = (new_n174_ | ~x0 | ~x1) & (~new_n173_ | x0 | (x2 & x4));
  assign new_n173_ = ~x1 & x3 & (new_n74_ | x4);
  assign new_n174_ = ((~x2 & x3) | (~x4 & (x5 | x6))) & (x3 | ~x5 | x2 | ~x6 | ~x7);
  assign z52 = (x3 & (x0 | (x2 & x4))) | (~x3 & ~x1 & ~x2) | (~x0 & x1) | (~new_n74_ & ~x4);
  assign z53 = ~new_n179_ | (~x4 & (~new_n178_ | (~new_n177_ & x5)));
  assign new_n177_ = new_n165_ & (((~x0 | ~x1) & ~x2 & ~x3) | (~x0 & ~x1) | (x0 & x2));
  assign new_n178_ = (x5 | ~x6) & (x2 | x5 | ((~x0 | x1) & x3));
  assign new_n179_ = ((~x2 & ~x4 & (x0 | (~x3 & x5))) | x1 | (x2 & (~x0 | ~x3) & (x0 | x3))) & (~x1 | x2 | x3 | ~x4) & (~x2 | ((~x0 | x3) & ((~x4 & x5) | x0 | ~x3)));
  assign z54 = (~new_n181_ & ~x1) | ~new_n184_ | (~new_n183_ & new_n185_);
  assign new_n181_ = (x4 | ((x5 | x6) & (~new_n182_ | ~x5 | ~x6))) & (x2 | x3) & (~x2 | ~x3 | ~x5);
  assign new_n182_ = x0 & x7;
  assign new_n183_ = ((x5 & (~new_n165_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n184_ = (~x0 | (~new_n157_ & ~x4)) & ((~x6 & ~x0 & ~x5) | x4 | (x7 & x5 & x6));
  assign new_n185_ = ~x0 & ((x4 & (~x2 | (~x1 & ~x5))) | ~x3 | (~x2 & ~x5));
  assign z55 = ~new_n188_ | (~x4 & ((~new_n187_ & x5) | (~x1 & ~x5) | (~x5 & x6)));
  assign new_n187_ = (x1 | ~x2 | x3) & new_n165_ & x0 & (x2 | ~x3);
  assign new_n188_ = (new_n189_ | ~x2) & (x1 | (~x4 & (x0 | x3))) & ((x0 & x3) | x2 | (~x0 & x1));
  assign new_n189_ = (x1 | ~x3 | ~x5) & (~x0 | (~x4 & (x5 | x6)));
  assign z56 = (~x4 & (new_n193_ | ~new_n191_ | new_n194_)) | (~new_n196_ & (new_n195_ | x4));
  assign new_n191_ = (new_n192_ | x5) & (~x5 | (x6 & x7)) & (x6 | (~x0 & x1));
  assign new_n192_ = x2 ? (x1 | ~x3) : x3;
  assign new_n193_ = ~x2 & ((~x0 & x1) | (x0 & ~x1 & x3)) & (x5 | (x0 & ~x1 & x3));
  assign new_n194_ = x6 & ((x3 & ~x7) | (~x5 & ~x0 & x2));
  assign new_n195_ = (x0 | (x1 ? ~x5 : (~x2 | x3))) & (x2 | ((x0 | ~x1) & (~x0 | x1 | ~x3))) & (~x0 | ~x3 | (x1 ? x7 : x5));
  assign new_n196_ = x3 & ~x2 & ~x0 & x1;
  assign z57 = new_n198_ | (~new_n200_ & new_n201_) | new_n203_ | (new_n91_ & ~x3);
  assign new_n198_ = x0 & (new_n199_ | ~x3);
  assign new_n199_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (~x7 | x4 | ~x6))))) & (x1 | x2 | x4 | ~x5 | x6);
  assign new_n200_ = ~x4 & x5 & ((x2 & x3) | (x1 & (~new_n165_ | x2)));
  assign new_n201_ = ~x0 & (new_n202_ | x2 | x3);
  assign new_n202_ = x1 & ~x4 & (x5 | (x6 & ~x7));
  assign new_n203_ = ~x4 & ((~new_n165_ & x5) | (new_n204_ & x1 & x3 & ~x5));
  assign new_n204_ = x2 & x6;
  assign z58 = ~new_n208_ | (~x4 & (~new_n206_ | (~new_n207_ & ~x5)));
  assign new_n206_ = (x0 | (~new_n204_ & ~x5)) & (new_n165_ | ~x5) & (~new_n91_ | ~x3 | ~x5);
  assign new_n207_ = (~x6 | ~x7 | ~x0 | x1 | (x2 & ~x3)) & ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (x6 | (~x0 & x1));
  assign new_n208_ = (((x0 | ~x4) & ~x1 & (~x2 | ~x5)) | ~x3 | (x1 & x2)) & (~x0 | ~x4) & (x3 | (~x0 & ~x4 & (x1 ? x5 : x2)));
  assign z59 = (~new_n210_ & x3) | new_n214_ | new_n215_ | new_n216_ | (~new_n213_ & ~x3);
  assign new_n210_ = new_n212_ & (new_n211_ | x5);
  assign new_n211_ = (x0 | ~x2) & (x4 | ((x1 | x2 | ~x0 | x6) & ((~x1 & ~x7) | ~x2 | ~x6)));
  assign new_n212_ = (x0 | x2 | ~x4) & (~x1 | (~x4 & x6));
  assign new_n213_ = (~x0 | (x1 & (~new_n118_ | ~x2 | x5))) & (x5 | ~x2 | x0 | ~x1) & (x2 | (~x0 & ~x4));
  assign new_n214_ = ~x5 & ((x0 & new_n91_ & (x4 | (x6 & x7))) | (~x4 & ~x0 & ~x6));
  assign new_n215_ = (~x0 | (~new_n74_ & ~x4)) & (~x7 | (x2 & x4));
  assign new_n216_ = (~x4 | (x0 & ~x1 & ~x2)) & x5 & (x4 | x7);
  assign z60 = (~x1 | x3 | ~x0 | ~x4) & ((~x2 ^ ~x3) | ~new_n80_ | x1 | x0 | x4);
  assign z61 = ~new_n173_ | ~x0 | ~x2;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z15 = 1'b0;
  assign z36 = 1'b0;
