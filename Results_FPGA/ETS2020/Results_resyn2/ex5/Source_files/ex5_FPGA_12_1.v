// Benchmark "FAU" written by ABC on Wed Jul 29 11:55:54 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n77_, new_n79_, new_n81_, new_n82_, new_n84_, new_n85_, new_n94_,
    ...
    new_n153_, new_n155_, new_n158_, new_n160_, new_n161_, new_n164_,
  ...
  assign z08 = new_n84_ & x0 & new_n85_ & ~x4 & x1 & x5;
  ...
  assign z25 = new_n94_ & ~x4 & new_n82_ & ~x0 & x1;
  assign new_n94_ = ~x7 & ~x5 & x6;
  assign z26 = new_n84_ & ~x5 & x0 & x2 & ~x3 & ~x4;
  assign z27 = new_n94_ & ~x3 & ~x4 & ~x0 & x1 & x2;
  assign z28 = new_n84_ & ~x4 & x0 & new_n79_ & ~x1 & ~x5;
  assign z29 = new_n99_ & new_n82_ & ~x4 & x7 & ~x0 & ~x1;
  assign new_n99_ = ~x5 & ~x6;
  assign z32 = ~new_n101_ | (~x4 & (~new_n104_ | (new_n77_ & x0) | x5 | (~new_n77_ & ~x0)));
  ...
  assign new_n107_ = (~x0 | (x6 & (~new_n108_ | ~x7))) & new_n109_ & ~new_n82_ & (x0 | ~x7);
  ...
  assign new_n134_ = (x7 | ~x5 | x6) & (x5 | ~x6 | ~x7 | new_n85_ | ~x0 | x1);
  assign z43 = new_n136_ | new_n138_ | new_n120_ | new_n139_;
  assign new_n136_ = (new_n137_ | x7) & ~x4 & (~x0 | x5 | (x3 & ~x7));
  assign new_n137_ = (x2 | x3 | x5 | ~x6) & (x6 | (~x0 & ~x5));
  assign new_n138_ = x0 & ((new_n77_ & ~x4) | (new_n99_ & x2));
  assign new_n139_ = x4 & ((~x0 & (~x2 ^ ~x3)) | (x0 & x2) | (x1 & (~x2 | x3)));
  assign z44 = (~x0 ^ x4) | (~new_n99_ & ~x4) | ~new_n108_ | x3;
  assign z45 = new_n147_ | new_n148_ | ((new_n145_ | ~new_n146_) & (new_n142_ | ~new_n143_));
  assign new_n142_ = x0 & (~x3 | (~x5 & new_n84_ & ~x4));
  assign new_n143_ = (~new_n94_ | x1 | x3) & new_n144_ & (~x1 | x5);
  assign new_n144_ = ~x2 & (x0 | ~x4);
  assign new_n145_ = ~x1 & (x5 | (new_n84_ & ~x4));
  assign new_n146_ = (~new_n103_ | x0 | x5) & x2 & (x3 | (~x0 & x1));
  assign new_n147_ = x0 & (new_n99_ | (x7 & x1 & x3));
  assign new_n148_ = (~new_n109_ | x4) & (x0 | ~x4 | (new_n79_ & ~x1 & ~x5));
  assign z46 = ~new_n150_ & (new_n153_ | new_n152_ | new_n77_ | ~x0);
  assign new_n150_ = new_n82_ & ~x0 & x1 & (x4 | (~new_n151_ & ~x0 & ~x5));
  assign new_n151_ = x1 & ~x7 & ~x2 & ~x3 & ~x5 & x6;
  assign new_n152_ = (x5 | ~x6 | (new_n108_ & x7)) & (~x5 | x7 | (x3 & ~x6));
  assign new_n153_ = (x0 | ~x1 | x2 | x3) & (~x3 | x4 | ((~x1 | x7) & x0 & (x1 | x2)));
  assign z48 = (~new_n81_ & new_n155_) | ~new_n108_ | x0 | ~x3;
  assign new_n155_ = ~x4 & (x5 | x6);
  assign z49 = ~x2 | (~new_n99_ & ~x4) | x0 | x1 | (x3 & x4);
  assign z50 = ~new_n158_ | (x0 & (~x1 | ~x3));
  assign new_n158_ = ~x2 & ~x4 & new_n84_ & ~x5;
  assign z51 = (new_n155_ | ~new_n161_) & (~new_n160_ | (new_n155_ & (~new_n84_ | x2 | ~x5)));
  assign new_n160_ = x0 & x1 & (x2 | ~x3);
  assign new_n161_ = (~x2 | ~x4) & x3 & ~x0 & ~x1;
  assign z52 = (x3 & (x0 | (x2 & x4))) | (~new_n99_ & ~x4) | (~x0 & x1) | (~x1 & ~x2 & ~x3);
  assign z55 = ~new_n165_ | (~x4 & ((~new_n164_ & x5) | (~x5 & x6) | (~x1 & ~x5)));
  assign new_n164_ = (x3 | x1 | ~x2) & new_n84_ & x0 & (x2 | ~x3);
  assign new_n165_ = (~x0 | (x2 ? new_n155_ : x3)) & (x1 | (new_n166_ & (x0 | (x2 & x3))));
  assign new_n166_ = ~x4 & (~x5 | ~x2 | ~x3);
  assign z56 = (~new_n171_ & (new_n170_ | x4)) | (~x4 & (~new_n168_ | new_n172_));
  assign new_n168_ = (x2 | ((~x3 | ~x0 | x1) & (x0 | ~x1 | ~x5))) & new_n169_ & ((x2 & ~x3) | (~x2 & x3) | x5 | (x1 & x3));
  assign new_n169_ = (x6 | (~x0 & x1)) & (~x5 | (x6 & x7));
  assign new_n170_ = (x2 | ((x0 | ~x1) & (~x3 | ~x0 | x1))) & (x0 | ((x3 | x1 | ~x2) & (~x1 | ~x5))) & (~x0 | ~x3 | (x1 ? x7 : x5));
  assign new_n171_ = x1 & ~x2 & ~x0 & x3;
  assign new_n172_ = (~x5 | (x3 & ~x7)) & x6 & ((~x0 & x2) | (x3 & ~x7));
  assign z57 = (x0 & (new_n176_ | ~x3)) | (~new_n174_ & ~x0) | new_n175_ | (new_n108_ & ~x3);
  assign new_n174_ = (x4 | (~new_n77_ & (x2 | ~x5))) & (x1 | x3) & ((~x4 & x5) | (~x2 & ~x3));
  assign new_n175_ = ~x4 & ((x5 & (~x6 | ~x7)) | (x1 & ~x5 & new_n79_ & x6));
  assign new_n176_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (x2 | x6 | x1 | x4 | ~x5);
  assign z58 = new_n180_ | (~x4 & ((~new_n178_ & ~x5) | ~new_n181_ | (~new_n179_ & x5)));
  assign new_n178_ = (~new_n79_ | ~x6) & (~new_n108_ | ~x0 | ~x7);
  assign new_n179_ = (~new_n108_ | ~x3) & x0 & x7;
  assign new_n180_ = (x4 | (((~x1 & ~x2) | x3 | x0 | (x1 & ~x5)) & ((~x1 & x2 & x5) | ~x3 | (x1 & ~x2)))) & (~x2 | ~x3 | x0 | ~x1);
