...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n91_, new_n96_, new_n102_, new_n105_, new_n107_, new_n108_,
  ...
  assign z06 = new_n74_ & ~x4 & new_n80_ & ~x0 & x2;
  ...
  assign z14 = new_n87_ & new_n80_ & x0 & ~x2;
  assign z15 = x2 & ~x0 & x1 & new_n91_ & x3 & ~x4;
  assign z18 = new_n80_ & ~x0 & x2 & x4 & ~x5;
  assign z20 = new_n96_ & x0 & ~x4 & ~x5 & ~x3 & ~x6;
  assign new_n96_ = ~x1 & ~x2;
  assign z21 = new_n74_ & ~x4 & new_n80_ & x0 & ~x2;
  assign z22 = new_n96_ & x0 & new_n85_ & ~x4 & ~x5;
  assign z24 = new_n78_ & ~x3 & new_n96_ & ~x4 & ~x0 & ~x5;
  ...
  assign new_n107_ = new_n109_ & (x4 | (new_n108_ & (~new_n78_ | ~x0) & ~x5 & (new_n78_ | x0)));
  ...
  assign z40 = (~new_n129_ & (new_n130_ | x1)) | ((new_n131_ | ~new_n132_) & ~x5);
  ...
  assign new_n132_ = (~x1 | x2) & (~x0 | ((x2 | ~x6 | ~x7) & (x2 ? x6 : ~x4)));
  assign z41 = (~x4 & (~new_n136_ | (~new_n134_ & x0))) | ~new_n135_ | new_n137_;
  assign new_n134_ = (~new_n85_ | x5 | x1 | x2) & (~x1 | ~x3 | ~x5);
  ...
  assign z42 = ~new_n139_ | (x0 & (new_n84_ | (new_n141_ & x7)));
  ...
  assign new_n143_ = ~new_n125_ & (~x0 | ((~new_n74_ | ~x2) & (~new_n78_ | x4)));
  ...
  assign new_n148_ = new_n149_ & (x5 | (~x1 & (~new_n78_ | x3)));
  ...
  assign new_n153_ = x4 & (x0 | (x2 & ~x5 & ~x1 & x3));
  assign z47 = (new_n155_ | x0) & (~new_n87_ | ~x2 | ~x3 | ~x0 | ~x1);
  assign new_n155_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x1 | x2 | ~x6 | ~x7 | x4 | x5);
  assign z48 = ~new_n96_ | ~new_n144_ | (~new_n91_ & new_n157_);
  assign new_n157_ = ~x4 & (x5 | x6);
  assign z51 = ~new_n159_ & ((~new_n74_ & ~x4) | ~new_n144_ | x1 | (x2 & x4));
  assign new_n159_ = (~new_n157_ | (new_n82_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  assign z53 = ~new_n163_ | (~x4 & (~new_n162_ | (~new_n161_ & x5)));
  assign new_n161_ = new_n85_ & (x1 | ~x3 | ~x0 | x2) & ((~x0 & ~x2 & ~x3) | ~x1 | (x0 & x2));
  assign new_n162_ = (x5 | ~x6) & (x2 | x5 | ((~x0 | x1) & x3));
  assign new_n163_ = ((x1 & (~x0 | x3) & (x0 | ~x3)) | ~x2 | (~x4 & x5 & ~x0 & x3)) & ((~x4 & (x1 | x0 | (~x3 & x5))) | x2 | (x1 & x3));
  assign z54 = new_n165_ | ~new_n168_ | (~new_n167_ & new_n169_);
  assign new_n165_ = ~x1 & ((~new_n166_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n166_ = (x5 | x6) & (~x5 | ~x6 | ~x7 | ~x0 | (x2 & x3));
  assign new_n167_ = ((x5 & (~new_n85_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n168_ = (~x0 | (~x4 & (~new_n141_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n169_ = ~x0 & ((~x1 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n173_ & ~x1) | new_n171_ | (~new_n172_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n171_ = x0 & (x2 | ~x3) & (~new_n157_ | ~x2);
  assign new_n172_ = (~x2 | x1 | x3) & new_n82_ & x0 & (x2 | ~x3);
  assign new_n173_ = (x2 | (x3 & (~x0 | ~x4) & (x0 | (~x3 & x5)))) & (~x2 | ~x3 | ~x5) & (x0 | ~x2 | (x3 & ~x4));
  ...
  assign z58 = new_n182_ | (~x4 & (~new_n180_ | (~new_n181_ & ~x5)));
  assign new_n180_ = (~x5 | (x6 & x7 & (~new_n80_ | ~x0 | x2))) & (x0 | (~x5 & (~x2 | ~x6)));
  ...
  assign new_n184_ = ((x0 & (~new_n85_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
  ...
  assign z60 = new_n190_ | new_n191_;
  assign new_n190_ = (x1 | ((~x4 | (x2 & ~x0 & x3)) & (~new_n91_ | (x3 & (x4 | (x0 & ~x2)))))) & (x3 | ~x0 | ~x4);
  assign new_n191_ = ~x1 & ((~x2 & (x0 ? x4 : (x3 | ~x5))) | (~x3 & (x2 | x4)) | (x0 & (x2 | ~x3)));
