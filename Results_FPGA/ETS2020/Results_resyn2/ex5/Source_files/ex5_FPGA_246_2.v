...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n81_, new_n83_, new_n84_, new_n86_, new_n91_,
    ...
    new_n150_, new_n151_, new_n153_, new_n155_, new_n158_, new_n160_,
  ...
  assign z14 = new_n91_ & x0 & new_n81_ & x3 & ~x4;
  assign new_n91_ = ~x1 & ~x2;
  assign z15 = x2 & ~x0 & x1 & new_n81_ & x3 & ~x4;
  assign z18 = x4 & ~x5 & ~x1 & x3 & ~x0 & x2;
  assign z20 = new_n91_ & x0 & ~x4 & ~x5 & ~x3 & ~x6;
  assign z22 = new_n91_ & x0 & new_n84_ & ~x4 & ~x5;
  assign z24 = new_n78_ & ~x3 & new_n91_ & ~x4 & ~x0 & ~x5;
  ...
  assign new_n114_ = (x4 | (~x5 & (~x2 | (~x0 & (x1 | x3))))) & (~x0 | x1 | x2 | x5);
  ...
  assign z42 = ~new_n137_ | (x0 & (new_n83_ | (new_n139_ & x7)));
  ...
  assign new_n150_ = ~new_n151_ & (~x0 | (~new_n74_ & (~new_n139_ | ~x7)));
  assign new_n151_ = x4 & (x0 | (~x1 & x3 & x2 & ~x5));
  assign z47 = (new_n153_ | x0) & (~new_n86_ | ~x2 | ~x3 | ~x0 | ~x1);
  assign new_n153_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x1 | x2 | ~x6 | ~x7 | x4 | x5);
  assign z48 = ~new_n91_ | ~new_n142_ | (~new_n81_ & new_n155_);
  assign new_n155_ = ~x4 & (x5 | x6);
  assign z49 = (~new_n74_ & ~x4) | (x3 & x4) | ~x2 | x0 | x1;
  assign z51 = ~new_n158_ & ((~new_n74_ & ~x4) | ~new_n142_ | x1 | (x2 & x4));
  assign new_n158_ = (~new_n155_ | (new_n81_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  ...
  assign new_n163_ = ((~x2 & ~x4 & (x0 | (~x3 & x5))) | x1 | (x2 & (~x0 ^ ~x3))) & (~x2 | (x0 ^ ~x3) | (x5 & x3 & ~x4)) & (x2 | ~x4 | ~x1 | x3);
  ...
  assign new_n168_ = (~x0 | (~x4 & (~new_n139_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n169_ = ~x0 & ((~x1 & x2 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n173_ & ~x1) | new_n171_ | (~new_n172_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n171_ = x0 & (x2 | ~x3) & (~new_n155_ | ~x2);
