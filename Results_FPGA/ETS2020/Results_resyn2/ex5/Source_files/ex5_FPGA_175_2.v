...
module FAU ( 
  ...
  assign new_n130_ = (~x1 | x2) & (~x0 | ((x2 | ~x6 | ~x7) & (x2 ? x6 : ~x4)));
  ...
  assign z53 = ~new_n164_ | (~x4 & (~new_n163_ | (~new_n162_ & x5)));
  assign new_n162_ = new_n85_ & (x1 | ~x3 | ~x0 | x2) & ((~x0 & ~x2 & ~x3) | ~x1 | (x0 & x2));
  assign new_n163_ = (x5 | ~x6) & (x2 | x5 | ((~x0 | x1) & x3));
  assign new_n164_ = ((~x2 & ~x4 & (x0 | (~x3 & x5))) | x1 | (x2 & (~x0 ^ ~x3))) & (x2 | ~x4 | ~x1 | x3) & (~x2 | (x0 ^ ~x3) | (x5 & x3 & ~x4));
  assign z54 = new_n166_ | ~new_n169_ | (~new_n168_ & new_n170_);
  assign new_n166_ = ~x1 & ((~new_n167_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n167_ = (x5 | x6) & (~x5 | ~x6 | ~x7 | ~x0 | (x2 & x3));
  ...
  assign new_n174_ = (x2 | (x3 & (~x0 | ~x4) & (x0 | (~x3 & x5)))) & (~x2 | ~x3 | ~x5) & (x0 | ~x2 | (x3 & ~x4));
  ...
  assign z58 = new_n183_ | (~x4 & (~new_n181_ | (~new_n182_ & ~x5)));
  assign new_n181_ = (~x5 | (x6 & x7 & (~new_n80_ | ~x0 | x2))) & (x0 | (~x5 & (~x2 | ~x6)));
  ...
  assign z60 = new_n191_ | new_n192_;
  assign new_n191_ = (x1 | ((~x4 | (x2 & ~x0 & x3)) & (~new_n91_ | (x3 & (x4 | (x0 & ~x2)))))) & (x3 | ~x0 | ~x4);
  assign new_n192_ = ~x1 & ((~x2 & (x0 ? x4 : (x3 | ~x5))) | (~x3 & (x2 | x4)) | (x0 & (x2 | ~x3)));
