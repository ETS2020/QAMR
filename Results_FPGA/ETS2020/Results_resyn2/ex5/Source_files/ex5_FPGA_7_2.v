...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n94_, new_n99_, new_n104_, new_n106_, new_n107_, new_n108_,
  ...
  assign z07 = new_n82_ & ~x2 & ~x0 & x1 & ~x3 & ~x4;
  ...
  assign z13 = new_n82_ & ~x2 & ~x0 & x1 & x3 & ~x4;
  ...
  assign z22 = new_n85_ & ~x4 & ~x5 & new_n94_ & x0;
  ...
  assign new_n131_ = (~x1 | x2) & (~x0 | ((x2 | ~x6 | ~x7) & (x2 ? x6 : ~x4)));
  ...
  assign new_n138_ = new_n139_ & ((x2 & (x0 | ~x6)) | x5 | (x0 & ~x1));
  ...
  assign z47 = (new_n154_ | x0) & (~new_n87_ | ~x2 | ~x3 | ~x0 | ~x1);
  assign new_n154_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x1 | x2 | ~x6 | ~x7 | x4 | x5);
  assign z48 = ~new_n94_ | ~new_n143_ | (~new_n82_ & ~new_n74_ & ~x4);
  assign z51 = ~new_n157_ & (new_n158_ | ~x0 | ~x1);
  assign new_n157_ = (new_n74_ | x4) & new_n143_ & ~x1 & (~x2 | ~x4);
  assign new_n158_ = ((~x2 & x3) | (~x4 & (x5 | x6))) & (x2 | ~x6 | ~x7 | x3 | ~x5);
  assign z53 = ~new_n162_ | (~x4 & (~new_n161_ | (~new_n160_ & x5)));
  assign new_n160_ = new_n85_ & (x1 | ~x3 | ~x0 | x2) & ((~x0 & ~x2 & ~x3) | ~x1 | (x0 & x2));
  assign new_n161_ = (x5 | ~x6) & (x2 | x5 | ((~x0 | x1) & x3));
  assign new_n162_ = ((x1 & (~x0 | x3) & (x0 | ~x3)) | ~x2 | (~x4 & x5 & ~x0 & x3)) & ((~x4 & (x1 | x0 | (~x3 & x5))) | x2 | (x1 & x3));
  assign z54 = new_n164_ | ~new_n167_ | (~new_n166_ & new_n168_);
  assign new_n164_ = ~x1 & ((~new_n165_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n165_ = (x5 | x6) & (~x7 | ~x5 | ~x6 | ~x0 | (x2 & x3));
  assign new_n166_ = ((x5 & (~new_n85_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n167_ = (~x0 | (~x4 & (~new_n140_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n168_ = ~x0 & ((~x1 & x2 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n172_ & ~x1) | new_n170_ | (~new_n171_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n170_ = x0 & (x2 | ~x3) & (~x2 | new_n74_ | x4);
  assign new_n171_ = (~x2 | x1 | x3) & new_n85_ & x5 & x0 & (x2 | ~x3);
  assign new_n172_ = (x2 | (x3 & (~x0 | ~x4) & (x0 | (~x3 & x5)))) & (~x2 | ~x3 | ~x5) & (x0 | ~x2 | (x3 & ~x4));
  ...
  assign z58 = new_n181_ | (~x4 & (~new_n179_ | (~new_n180_ & ~x5)));
  assign new_n179_ = (~x5 | (x6 & x7 & (~new_n80_ | ~x0 | x2))) & (x0 | (~x5 & (~x2 | ~x6)));
  ...
  assign new_n183_ = ((x0 & (~new_n85_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
  ...
  assign z60 = new_n189_ | new_n190_;
  assign new_n189_ = (x1 | ((~x4 | (x2 & ~x0 & x3)) & (~new_n82_ | (x3 & (x4 | (x0 & ~x2)))))) & (x3 | ~x0 | ~x4);
  assign new_n190_ = ~x1 & ((~x2 & (x0 ? x4 : (x3 | ~x5))) | (~x3 & (x2 | x4)) | (x0 & (x2 | ~x3)));
