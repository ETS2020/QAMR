...
module FAU ( 
  ...
  wire new_n74_, new_n76_, new_n78_, new_n82_, new_n83_, new_n85_, new_n87_,
    new_n91_, new_n94_, new_n98_, new_n100_, new_n102_, new_n107_,
    ...
    new_n163_, new_n165_, new_n166_, new_n167_, new_n169_, new_n172_,
  ...
  assign new_n85_ = x2 & ~x5 & x6 & ~x4 & x7;
  assign z10 = new_n76_ & new_n87_ & x2 & ~x0 & x1;
  assign new_n87_ = x6 & x7;
  assign z11 = new_n76_ & new_n87_ & x0 & ~x2 & x1 & ~x3;
  assign z12 = new_n76_ & new_n87_ & x0 & ~x1 & x2 & ~x3;
  assign z13 = new_n91_ & new_n82_ & x3 & ~x4;
  assign new_n91_ = x7 & x5 & x6;
  assign z14 = new_n76_ & new_n87_ & x0 & ~x2 & ~x1 & x3;
  assign z18 = new_n94_ & ~x1 & ~x5 & x2 & x4;
  assign new_n94_ = ~x0 & x3;
  assign z20 = ~x2 & x0 & ~x1 & ~x3 & new_n74_ & ~x4;
  assign z21 = new_n74_ & ~x4 & ~x1 & x3 & x0 & ~x2;
  assign z22 = new_n98_ & x0 & ~x5 & x6 & ~x4 & x7;
  assign new_n98_ = ~x1 & ~x2;
  assign z24 = new_n78_ & ~x4 & new_n100_ & ~x0 & ~x1 & ~x5;
  assign new_n100_ = ~x2 & ~x3;
  assign z25 = new_n82_ & new_n102_ & ~x3 & ~x4;
  assign new_n102_ = ~x7 & ~x5 & x6;
  assign z26 = new_n85_ & x0 & ~x3;
  assign z27 = x2 & ~x0 & x1 & new_n102_ & ~x3 & ~x4;
  ...
  assign new_n109_ = new_n111_ & (x4 | (new_n110_ & (~new_n78_ | ~x0) & ~x5 & (new_n78_ | x0)));
  ...
  assign new_n116_ = (new_n117_ | ~x6) & (~x5 | (~x7 & (x3 | x6))) & (x0 | ~x7) & (x5 | x6);
  assign new_n117_ = (x7 | (~x0 & ~x5)) & (~x2 | x5 | ((~x1 | ~x3) & (~x0 | ~x7)));
  assign new_n118_ = (x4 | (~x5 & (~x2 | (~x0 & (x1 | x3))))) & (~x0 | x2 | x1 | x5);
  ...
  assign new_n125_ = new_n126_ & ((~new_n85_ & ~x1) | ~x3 | (~new_n76_ & x1 & ~x7));
  ...
  assign z39 = (~new_n135_ & x0) | ~new_n133_ | new_n136_;
  assign new_n133_ = new_n134_ & (~x5 | (x3 & ~x6 & ~x7));
  assign new_n134_ = ~x4 & (x0 | x5 | (x1 & ~x2 & x6));
  assign new_n135_ = (x5 | ((x1 | ~x2) & x6)) & (~x2 | x3) & (~x6 | x7);
  ...
  assign z41 = ~new_n145_ | new_n147_ | (~x4 & (~new_n146_ | (~new_n144_ & x0)));
  ...
  assign z42 = ~new_n149_ | (x0 & (new_n151_ | (new_n85_ & ~x3)));
  assign new_n149_ = new_n150_ & ((x2 & (x0 | ~x6)) | (x0 & ~x1) | x5);
  assign new_n150_ = (~x5 | (~x6 & ~x7)) & ~x4 & (x5 | x6) & (~x0 | ~x6 | x7);
  assign new_n151_ = x1 & x3 & x7;
  assign z43 = (~new_n154_ & ~x4) | ~new_n153_ | (x4 & (x1 | (~new_n94_ ^ ~x2)));
  assign new_n153_ = ~new_n136_ & (~x0 | ((~new_n74_ | ~x2) & (~new_n78_ | x4)));
  ...
  assign new_n186_ = (x3 | x1 | ~x2) & new_n83_ & x0 & (x2 | ~x3);
  ...
  assign new_n196_ = new_n83_ & x0 & (x1 | ~x3 | ~x0 | x2);
  ...
  assign new_n199_ = (~x0 | (~new_n85_ & x1)) & (x2 | (~x0 & ~x4)) & (x5 | ~x2 | x0 | ~x1);
  ...
  assign z60 = new_n206_ | new_n207_;
  assign new_n206_ = (x1 | ((~x4 | (x2 & ~x0 & x3)) & (~new_n91_ | (x3 & (x4 | (x0 & ~x2)))))) & (x3 | ~x0 | ~x4);
  assign new_n207_ = ~x1 & ((~x2 & (x0 ? x4 : (x3 | ~x5))) | (~x3 & (x2 | x4)) | (x0 & (x2 | ~x3)));
