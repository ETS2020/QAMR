...
module FAU ( 
  ...
  wire new_n74_, new_n76_, new_n80_, new_n83_, new_n85_, new_n87_, new_n91_,
    ...
    new_n159_, new_n163_, new_n165_, new_n166_, new_n167_, new_n168_,
  ...
  assign z22 = new_n99_ & new_n96_ & x0;
  ...
  assign new_n109_ = new_n96_ & x0 & (x6 ? x7 : ~x3);
  assign new_n110_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 ^ (x6 & ~x7));
  ...
  assign z39 = ~new_n127_ | (~new_n130_ & x0);
  assign new_n127_ = ~new_n128_ & new_n129_ & (~x5 | (~x6 & x3 & ~x7));
  assign new_n128_ = x1 & ((~x2 & ~x5) | (x3 & x0 & x7));
  assign new_n129_ = ~x4 & (x0 | x5 | (x1 & ~x2 & x6));
  assign new_n130_ = (x5 | (x6 & (~x2 | ~x3 | x1 | ~x6 | ~x7))) & (~x2 | x3) & (~x6 | x7);
  ...
  assign new_n137_ = (~new_n85_ | x5 | x1 | x2) & (~x1 | ~x3 | ~x5);
  ...
  assign z43 = (~new_n146_ & ~x4) | ~new_n144_ | (x4 & ((new_n145_ & ~x2) | x1 | (~new_n145_ & x2)));
  assign new_n144_ = ~new_n128_ & (~x0 | ((~new_n80_ | x4) & (~new_n74_ | ~x2)));
  assign new_n145_ = ~x0 & x3;
  assign new_n146_ = (x5 | ((x0 | (~x2 & x6)) & (~x6 | ~x3 | x7))) & (x0 | ~x7) & (~x5 | (~x6 & ~x7));
  assign z44 = x1 | x2 | x3 | (~new_n74_ & ~x4) | (~x0 & ~x4) | (x0 & x4);
  assign z45 = (~new_n149_ & ~x2) | (~new_n151_ & x2) | ~new_n153_ | (~new_n120_ & ~x4);
  assign new_n149_ = new_n150_ & (x5 | (~x1 & (~new_n80_ | x3)));
  assign new_n150_ = (~x0 | x4 | x5 | ~x6 | ~x7) & (~x0 | x3) & (x0 | ~x4);
  assign new_n151_ = new_n152_ & (x1 | (~x5 & (~new_n85_ | x4)));
  assign new_n152_ = (x0 | x5 | x4 | ~x6) & (x3 | (~x0 & x1));
  assign new_n153_ = ~new_n155_ & (~x0 | (~new_n74_ & (~new_n154_ | ~x7)));
  assign new_n154_ = x1 & x3;
  assign new_n155_ = x4 & (x0 | (~x1 & x3 & x2 & ~x5));
  assign z47 = ~new_n157_ & (x0 | ((new_n159_ | ~x1 | ~x2) & (~new_n99_ | x1 | x2)));
  assign new_n157_ = new_n158_ & x2 & x3 & x0 & x7;
  assign new_n158_ = ~x4 & x5 & x1 & x6;
  assign new_n159_ = ~x4 & (x5 | x6);
  assign z48 = ~new_n96_ | ~new_n145_ | (~new_n83_ & new_n159_);
  assign z49 = (~new_n74_ & ~x4) | (x3 & x4) | ~x2 | x0 | x1;
  assign z51 = ~new_n163_ & ((~new_n74_ & ~x4) | ~new_n145_ | x1 | (x2 & x4));
  assign new_n163_ = (~new_n159_ | (new_n83_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  ...
  assign z54 = new_n170_ | ~new_n173_ | (~new_n172_ & new_n174_);
  assign new_n170_ = ~x1 & ((~new_n171_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n171_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7);
  assign new_n172_ = ((x5 & (~new_n85_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n173_ = (~x0 | (~x4 & (~new_n154_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n174_ = ~x0 & ((~x1 & x2 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n178_ & ~x1) | new_n176_ | (~new_n177_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n176_ = x0 & (x2 | ~x3) & (~new_n159_ | ~x2);
  ...
  assign new_n183_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (x1 | x2 | x4 | ~x5 | x6);
  assign z58 = new_n187_ | (~new_n185_ & ~x4);
  assign new_n185_ = (new_n186_ | x5) & ((new_n166_ & x0) | (~x5 & (x0 | ~x2 | ~x6)));
  assign new_n186_ = (~x6 | (x2 & ~x3) | ~x0 | x1 | ~x7) & (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x6 | (~x0 & x1));
  ...
  assign new_n190_ = (~x4 | (x0 ? (x1 | x2) : ~x2)) & new_n192_ & (new_n191_ | x4);
  assign new_n191_ = ~x5 & (x0 | x6);
  assign new_n192_ = (~x0 | x1 | x2 | ~x6) & (x7 | (x0 & (x4 | ~x6)));
  assign new_n193_ = (x0 | ~x2) & (x4 | ((~x6 | ~x1 | ~x2) & ((x2 & (~x6 | ~x7)) | ~x0 | x1 | (~x2 & x6))));
