...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n78_, new_n79_, new_n82_, new_n84_, new_n85_, new_n96_,
  ...
  assign z10 = new_n79_ & new_n85_ & x2 & ~x0 & x1;
  assign z11 = x1 & ~x2 & new_n79_ & new_n85_ & x0 & ~x3;
  assign z12 = new_n79_ & new_n85_ & x0 & ~x3 & ~x1 & x2;
  assign z13 = ~x2 & ~x0 & x1 & new_n82_ & x3 & ~x4;
  assign z14 = new_n79_ & new_n85_ & x0 & ~x1 & ~x2 & x3;
  ...
  assign z24 = new_n78_ & ~x3 & ~x0 & ~x5 & new_n96_ & ~x4;
  ...
  assign z40 = (~x5 & (new_n130_ | ~new_n131_)) | (~new_n129_ & (new_n132_ | x1));
  assign new_n129_ = ~new_n78_ & ~x5 & x0 & ~x4;
  assign new_n130_ = ~x4 & ((~x0 & (~x6 | (x3 & ~x7))) | (x3 & (x1 | (x0 & x6))));
  assign new_n131_ = (~x1 | x2) & (~x0 | ((x2 | ~x6 | ~x7) & (x2 | ~x4) & (~x2 | x6)));
  assign new_n132_ = (x0 | ((~x3 | ((~x2 | ~x4) & (x4 | x5 | x7))) & (x5 | x7 | x2 | x3))) & (~x4 | x2 | (~x0 & x3));
  ...
  assign new_n154_ = new_n79_ & x1 & x6;
  assign new_n155_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x1 | x2 | ~x6 | ~x7 | x4 | x5);
  assign z48 = ~new_n96_ | ~new_n144_ | (~new_n82_ & new_n157_);
  ...
  assign new_n164_ = ((x1 & (~x0 | x3) & (x0 | ~x3)) | ~x2 | (~x4 & x5 & ~x0 & x3)) & ((~x4 & (x0 | x1 | (~x3 & x5))) | x2 | (x1 & x3));
  assign z54 = (~new_n166_ & new_n170_) | ~new_n169_ | (~new_n167_ & ~x1);
  assign new_n166_ = ((x5 & (~new_n85_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n167_ = ~new_n168_ & (x2 | x3) & (~x2 | ~x3 | ~x5);
  assign new_n168_ = (~x5 | (x6 & x7)) & (x0 | ~x5) & ~x4 & (x5 | ~x6);
  assign new_n169_ = (~x0 | (~x4 & (~new_n141_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n170_ = ~x0 & ((~x1 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n174_ & ~x1) | new_n172_ | (~new_n173_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n172_ = x0 & (x2 | ~x3) & (~new_n157_ | ~x2);
  assign new_n173_ = (~x2 | x1 | x3) & new_n82_ & x0 & (x2 | ~x3);
  assign new_n174_ = ((x0 & x2) | (x3 & ~x4)) & (x0 | x2) & (~x2 | ~x3 | ~x5);
  assign z57 = new_n176_ | ~new_n181_ | (~new_n182_ & new_n183_);
  assign new_n176_ = ~x4 & (~new_n180_ | (new_n179_ & (new_n177_ | ~new_n178_)));
  assign new_n177_ = ~x1 & (~x2 | ~x3);
  assign new_n178_ = ~x4 & x5 & (x2 | ~x6 | ~x7);
  assign new_n179_ = ~x0 & (x5 | (x6 & ~x7));
  assign new_n180_ = (~x5 | (x6 & x7)) & (~x2 | ~x6 | x5 | ~x1 | ~x3);
  assign new_n181_ = (x3 | (~x0 & (x1 | x2))) & ((new_n178_ & (x1 | (x2 & x3))) | x0 | (~x2 & ~x3));
  assign new_n182_ = x1 & ((~x2 & x4) | (~x5 & ((~x2 & ~x6) | (~x4 & x6 & x7))));
  assign new_n183_ = x0 & (~x5 | x6 | x2 | x1 | x4);
  assign z58 = new_n187_ | (~new_n185_ & ~x4);
  assign new_n185_ = (new_n186_ | x5) & (new_n162_ | ~x5) & (x0 | (~x5 & (~x2 | ~x6)));
  assign new_n186_ = (~x0 | x1 | (x2 & ~x3) | ~x6 | ~x7) & ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (x6 | (~x0 & x1));
  assign new_n187_ = ((~x3 & ((x1 & ~x5) | x0 | (~x1 & ~x2))) | x4 | (x3 & (x1 | x2) & (~x1 | ~x2) & (~x2 | x5))) & (~x1 | ~x2 | x0 | ~x3);
  assign z59 = (x3 & (~new_n193_ | (~new_n192_ & ~x5))) | ~new_n190_ | (~new_n189_ & ~x3);
  assign new_n189_ = ((x0 & (~new_n85_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
  assign new_n190_ = new_n191_ & (~x6 | x2 | ~x0 | x1) & (~x4 | (x0 & x2) | (~x2 & (~x0 | x1)));
  assign new_n191_ = (x7 | (x0 & (x4 | ~x6))) & (x4 | (~x5 & (x0 | x6)));
  assign new_n192_ = (x0 | ~x2) & (x4 | ((~x6 | ~x1 | ~x2) & ((x2 & (~x6 | ~x7)) | ~x0 | x1 | (~x2 & x6))));
  assign new_n193_ = (~x1 | (~x4 & x6)) & (~x4 | x0 | x2);
  assign z60 = (x3 | ((~new_n82_ | x0 | x2 | x1 | x4) & (~x4 | ~x0 | ~x1))) & (~new_n82_ | x0 | x1 | ~x2 | ~x3 | x4);
  assign z61 = new_n157_ | ~x0 | ~x2 | x1 | ~x3;
