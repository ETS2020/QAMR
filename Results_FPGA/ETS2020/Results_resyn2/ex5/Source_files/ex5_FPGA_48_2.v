// Benchmark "FAU" written by ABC on Wed Jul 29 11:56:17 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n77_, new_n80_, new_n82_, new_n83_, new_n85_, new_n93_,
    new_n97_, new_n98_, new_n104_, new_n106_, new_n107_, new_n108_,
  ...
  assign z20 = new_n93_ & x0 & ~x1 & ~x2;
  assign new_n93_ = ~x4 & ~x5 & ~x3 & ~x6;
  assign z21 = new_n74_ & ~x4 & x0 & ~x1 & ~x2 & x3;
  assign z22 = x0 & ~x1 & ~x2 & new_n83_ & ~x4 & ~x5;
  assign z24 = new_n97_ & new_n98_ & ~x2 & ~x3;
  assign new_n97_ = ~x0 & ~x1 & ~x4 & ~x5;
  ...
  assign new_n106_ = new_n108_ & (x4 | (new_n107_ & (~new_n98_ | ~x0) & ~x5 & (new_n98_ | x0)));
  ...
  assign z40 = (~new_n128_ & (new_n129_ | x1)) | (~x5 & (new_n130_ | ~new_n131_));
  assign new_n128_ = ~new_n98_ & x0 & ~x4 & ~x5;
  ...
  assign new_n133_ = (~new_n83_ | x5 | x1 | x2) & (~x1 | ~x3 | ~x5);
  ...
  assign z42 = ~new_n138_ | (x0 & (new_n82_ | (new_n140_ & x7)));
  ...
  assign new_n142_ = ~new_n124_ & (~x0 | ((~new_n74_ | ~x2) & (~new_n98_ | x4)));
  ...
  assign new_n147_ = new_n148_ & (x5 | (~x1 & (~new_n98_ | x3)));
  ...
  assign z47 = (new_n154_ | x0) & (~new_n85_ | ~x2 | ~x3 | ~x0 | ~x1);
  assign new_n154_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x1 | x2 | x4 | x5 | ~x6 | ~x7);
  assign z48 = (~new_n80_ & new_n156_) | ~new_n143_ | x1 | x2;
  assign new_n156_ = ~x4 & (x5 | x6);
  assign z51 = ~new_n158_ & ((~new_n74_ & ~x4) | ~new_n143_ | x1 | (x2 & x4));
  assign new_n158_ = (~new_n156_ | (new_n80_ & ~x2)) & x1 & x0 & (x2 | ~x3);
