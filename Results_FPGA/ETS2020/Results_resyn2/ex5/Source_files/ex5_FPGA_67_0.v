...
module FAU ( 
  ...
  assign z12 = new_n88_ & x2 & new_n85_ & ~x3;
  assign new_n88_ = x0 & ~x1;
  assign z15 = x3 & new_n85_ & x2 & ~x0 & x1;
  assign z16 = new_n85_ & new_n91_ & x0 & ~x2;
  ...
  assign new_n97_ = new_n88_ & ~x2 & ~x5;
  assign z21 = new_n97_ & new_n99_ & ~x4;
  ...
  assign new_n110_ = ((x2 & (~x0 | x6)) | x5 | (x0 & ~x1 & ~x2)) & (x4 | (~x5 & x0 & ~x6));
  assign z33 = ((x1 | ((~x2 ^ x3) & (~x2 | x5))) & (~x1 | ~x2) & (~x1 | x3)) | (~x3 & (~x2 | (new_n112_ & ~x1 & x5))) | ((x3 | ~x5) & ~x1 & ~x2) | ~new_n113_ | (x2 & ~x5 & x1 & x3);
  assign new_n112_ = x0 & x7;
  assign new_n113_ = ~x4 & x7 & x0 & x6;
  assign z34 = (~new_n97_ | (~x4 & (~x6 | ~x7))) & (new_n115_ | x4 | x7);
  assign new_n115_ = (~x3 | ~x5 | x6) & (x0 | x5 | x1 | ~x2 | x3 | ~x6);
  assign z35 = ~x4 | (x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (~x2 | x3)) | (~x0 & ((x2 ^ x3) | (~x1 & x2 & ~x5)));
  assign z36 = (~new_n97_ & (new_n120_ | x4)) | (~x4 & (~new_n118_ | (~new_n121_ & x0)));
  assign new_n118_ = (x6 ? (~x3 | x7) : x1) & new_n119_ & (x0 | ~x7);
  assign new_n119_ = (x2 | x3) & ~x5;
  assign new_n120_ = (x1 | (x0 & x2)) & (~x0 | ((x2 | x3) & (x7 | ~x1 | ~x3)));
  assign new_n121_ = x6 & (x1 | x2 | ~x7);
  assign z37 = (~z04 & (new_n124_ | ~x0)) | (x0 & (~new_n123_ | (~new_n125_ & x3)));
  assign new_n123_ = (~new_n86_ | x1 | x2 | x5) & (~x4 | (~x2 & (x1 | x2 | x5)));
  assign new_n124_ = (x2 | (x1 & x3) | (~x1 & (~x3 | ~x5))) & (~x3 | (~x4 & ~x6) | (~x1 & x5) | (x1 & x4));
  assign new_n125_ = (~x1 | (~x7 & (x4 | ~x5))) & (x4 | x5 | ~x2 | ~x6 | ~x7);
  assign z38 = new_n128_ | ~new_n129_ | (~x4 & (new_n127_ | x5));
  assign new_n127_ = (x3 | (((x0 & ~x1 & ~x2) | ~x0 | ~x7) & (x0 | ~x6 | x7))) & ((x6 & ((x1 & x2) | ~x7)) | ~x0 | ((~x3 | x6) & x0 & ~x1 & ~x2));
  assign new_n128_ = ~x2 & ((x1 & ~x5) | (x4 & (~x0 | (x1 & ~x3))));
  assign new_n129_ = (~x2 | ((~x0 | x1) & x3)) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  assign z42 = new_n131_ | x4;
  assign new_n131_ = (~x5 | x6 | x7) & (~x7 | (x2 & ~x3) | ~new_n88_ | x5 | ~x6);
  assign z44 = (~x4 & (x5 | ~x0 | x6)) | ~new_n133_ | (x0 & x4);
  assign new_n133_ = ~x1 & ~x2 & ~x3;
  assign z46 = (~new_n135_ & ~x4) | (~new_n138_ & (new_n137_ | x4));
  assign new_n135_ = (new_n136_ | ~x0) & ((~x5 & (~new_n104_ | x0)) | (~new_n99_ & x0 & ~x7));
  ...
  assign z50 = (~new_n91_ & x0) | x2 | x5 | ~new_n86_ | x4;
  ...
  assign new_n149_ = (~x1 | ((~x0 | ~x3) & (x2 | (~x3 & x4)))) & ((~x2 & (x4 | (~x0 & (x3 | ~x5)))) | (x0 & x2) | ((~x3 | x4 | ~x5) & x2 & (~x1 | x3)));
  ...
  assign new_n156_ = ~new_n157_ & new_n158_ & ((x2 ^ x3) | x5 | (x1 & x3));
  assign new_n157_ = x6 & ((x3 & ~x7) | (x2 & ~x0 & ~x5));
  assign new_n158_ = (~x5 | (x6 & x7)) & (x6 | (~x0 & x1));
