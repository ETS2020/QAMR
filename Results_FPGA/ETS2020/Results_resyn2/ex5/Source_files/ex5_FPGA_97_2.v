...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n78_, new_n81_, new_n83_, new_n84_, new_n86_, new_n91_,
  ...
  assign z20 = new_n91_ & ~x4 & ~x5 & ~x3 & ~x6;
  assign z21 = new_n91_ & new_n74_ & x3 & ~x4;
  assign z22 = new_n91_ & new_n84_ & ~x4 & ~x5;
  assign z24 = new_n98_ & ~x1 & ~x3 & ~x2 & ~x7;
  assign new_n98_ = ~x4 & x6 & ~x0 & ~x5;
  ...
  assign new_n105_ = (x2 | ((~x0 | x4 | x5 | x6) & ((~x0 & x3) | ~x4 | ~x5))) & (~x4 | ~x5 | x0 | ~x2 | ~x3);
  ...
  assign new_n132_ = (x0 | ((x5 | x7 | x2 | x3) & ((~x4 & (x5 | x7)) | ~x3 | (~x2 & x4)))) & (~x4 | x2 | (~x0 & x3));
  ...
  assign z42 = ~new_n139_ | (x0 & (new_n83_ | (x7 & x1 & x3)));
  assign new_n139_ = new_n140_ & ((x0 & (~x1 | x2)) | x5 | (x2 & ~x6));
  assign new_n140_ = ~x4 & (x5 | x6) & (~x0 | ~x6 | x7) & (~x5 | (~x6 & ~x7));
  assign z43 = (~new_n143_ & ~x4) | new_n142_ | new_n125_ | (~new_n144_ & x4);
  assign new_n142_ = x0 & ((new_n78_ & ~x4) | (new_n74_ & x2));
  assign new_n143_ = (x5 | ((x0 | (~x2 & x6)) & (~x6 | ~x3 | x7))) & (x0 | ~x7) & (~x5 | (~x6 & ~x7));
  assign new_n144_ = ~x1 & ((~x0 & x2 & x3) | (~x2 & (x0 | ~x3)));
  assign z44 = ~new_n146_ | x1 | (x0 ? (~new_n74_ | x4) : ~x4);
  assign new_n146_ = ~x2 & ~x3;
  assign z45 = (~new_n148_ & x2) | (~new_n150_ & ~x2) | ~new_n152_ | (~new_n118_ & ~x4);
  assign new_n148_ = new_n149_ & (x1 | (~x5 & (~new_n84_ | x4)));
  assign new_n149_ = (x0 | x5 | x4 | ~x6) & (x3 | (~x0 & x1));
  assign new_n150_ = new_n151_ & (x5 | (~x1 & (~new_n78_ | x3)));
  assign new_n151_ = (~x0 | x4 | x5 | ~x6 | ~x7) & (~x0 | x3) & (x0 | ~x4);
  assign new_n152_ = ~new_n153_ & (~x0 | (~new_n74_ & (~x7 | ~x1 | ~x3)));
  assign new_n153_ = x4 & (x0 | (~x1 & x3 & x2 & ~x5));
  assign z47 = (new_n155_ | x0) & (~new_n86_ | ~x2 | ~x3 | ~x0 | ~x1);
  assign new_n155_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x1 | x2 | x4 | x5 | ~x6 | ~x7);
  assign z48 = (new_n157_ & ~new_n81_) | x1 | x2 | x0 | ~x3;
  assign new_n157_ = ~new_n74_ & ~x4;
  assign z49 = (~new_n74_ & ~x4) | (x3 & x4) | ~x2 | x0 | x1;
  assign z51 = (new_n161_ | ~x0 | ~x1) & (new_n160_ | x1 | x0 | ~x3);
  assign new_n160_ = x4 ? x2 : ~new_n74_;
  assign new_n161_ = ((~x2 & x3) | (~x4 & (x5 | x6))) & (x3 | ~x5 | ~x7 | x2 | ~x6);
  assign z53 = ~new_n166_ | (~x4 & (~new_n165_ | (~new_n163_ & x5)));
  assign new_n163_ = new_n164_ & (~x1 | (x2 ? x0 : (~x0 & ~x3)));
  assign new_n164_ = x6 & x7 & (~x0 | x1 | x2 | ~x3);
  assign new_n165_ = (x5 | ~x6) & (x2 | x5 | ((~x0 | x1) & x3));
  assign new_n166_ = (x1 | ((~x2 | (x0 & ~x3) | (~x0 & x3)) & (x2 | ~x4) & (x0 | x2 | (~x3 & x5)))) & (x2 | ~x4 | ~x1 | x3) & ((x0 ^ ~x3) | ~x2 | (x5 & x3 & ~x4));
  assign z55 = (~new_n168_ & ~x4 & (~new_n74_ | ~x1)) | new_n169_ | (~new_n170_ & ~x1);
  assign new_n168_ = (x3 | x1 | ~x2) & new_n84_ & x5 & x0 & (x2 | ~x3);
  assign new_n169_ = x0 & (x2 | ~x3) & (~x2 | new_n74_ | x4);
  assign new_n170_ = (~x2 | ~x3 | ~x5) & (x0 | x2) & ((x0 & x2) | (x3 & ~x4));
  assign z57 = new_n172_ | ~new_n175_ | (x0 & (new_n177_ | ~x3));
  assign new_n172_ = (~new_n173_ | (~x1 & (~x2 | ~x3))) & ~x0 & (new_n174_ | x2 | x3);
  assign new_n173_ = ~x4 & x5 & (x2 | ~x6 | ~x7);
  assign new_n174_ = x1 & ~x4 & (x5 | (x6 & ~x7));
  assign new_n175_ = (new_n176_ | x4) & (~new_n146_ | x1);
  assign new_n176_ = (~x5 | (x6 & x7)) & (x5 | ~x1 | ~x3 | ~x2 | ~x6);
  assign new_n177_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (x2 | x6 | x1 | x4 | ~x5);
  assign z58 = new_n181_ | (~new_n179_ & ~x4);
  assign new_n179_ = (new_n180_ | x5) & ((x0 & (new_n164_ | ~x5)) | (~x5 & (~x2 | ~x6)));
  assign new_n180_ = (~x0 | x1 | (x2 & ~x3) | ~x6 | ~x7) & (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x6 | (~x0 & x1));
  assign new_n181_ = (x4 | ((x0 | x3 | (~x1 & ~x2) | (x1 & ~x5)) & ((~x1 & x2 & x5) | ~x3 | (x1 & ~x2)))) & (~x1 | ~x2 | x0 | ~x3);
  assign z59 = (x3 & (~new_n188_ | (~new_n187_ & ~x5))) | ~new_n184_ | (~new_n183_ & ~x3);
  assign new_n183_ = ((x0 & (~new_n84_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
  assign new_n184_ = (~x4 | (x0 ? (x1 | x2) : ~x2)) & new_n186_ & (new_n185_ | x4);
  assign new_n185_ = ~x5 & (x0 | x6);
  assign new_n186_ = (~x0 | x1 | x2 | ~x6) & (x7 | (x0 & (x4 | ~x6)));
  assign new_n187_ = (x0 | ~x2) & (x4 | ((~x6 | ~x1 | ~x2) & ((x2 & (~x6 | ~x7)) | ~x0 | x1 | (~x2 & x6))));
  assign new_n188_ = (~x1 | (~x4 & x6)) & (~x4 | x0 | x2);
  assign z60 = (~x4 | ~x0 | ~x1 | x3) & ((~x2 ^ ~x3) | ~new_n81_ | x4 | x0 | x1);
