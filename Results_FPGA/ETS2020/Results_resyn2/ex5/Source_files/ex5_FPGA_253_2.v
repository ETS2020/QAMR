...
module FAU ( 
  ...
  wire new_n74_, new_n77_, new_n79_, new_n81_, new_n83_, new_n84_, new_n86_,
    new_n87_, new_n98_, new_n105_, new_n107_, new_n108_, new_n109_,
  ...
  assign z07 = new_n81_ & ~x3 & ~x4 & ~x2 & ~x0 & x1;
  ...
  assign z22 = new_n84_ & ~x2 & x0 & ~x1;
  assign z24 = new_n79_ & new_n98_;
  assign new_n98_ = ~x1 & ~x2 & ~x5 & ~x4 & ~x0 & ~x3;
  ...
  assign new_n105_ = ((~x0 & (x2 | x3) & (~x2 | ~x3 | ~x5)) | (x0 & x2) | ~x4 | (~x2 & ~x5)) & (x2 | x6 | ~x0 | x4 | x5);
  ...
  assign z33 = (~x5 & x1 & x3) | ~new_n112_ | ~x0 | ~x7 | (~x1 & x5);
  assign new_n112_ = x2 & ~x4 & x6;
  assign z34 = new_n116_ | (~new_n114_ & ~x4);
  assign new_n114_ = (new_n115_ | ~x6) & (~x5 | (~x7 & (x3 | x6))) & (x5 | x6) & (x0 | ~x7);
  assign new_n115_ = (x7 | (~x0 & ~x5)) & (((~x1 | ~x3) & (~x0 | ~x7)) | ~x2 | x5);
  assign new_n116_ = (x4 | (~x5 & (~x2 | (~x0 & (x1 | x3))))) & (~x0 | x1 | x2 | x5);
  ...
  assign new_n121_ = (~x0 | ((~x2 | x3) & (x1 | x2 | x5))) & (x4 | (x0 & ~x1 & x2));
  ...
  assign new_n127_ = ~x4 & (~x5 | (~x6 & ~x7 & (x3 | x6)));
  assign z40 = (~new_n129_ & (new_n130_ | x1)) | (~x5 & (new_n131_ | ~new_n132_));
  assign new_n129_ = ~new_n79_ & x0 & ~x4 & ~x5;
  assign new_n130_ = (x0 | ((~x3 | ((~x2 | ~x4) & (x4 | x5 | x7))) & (x5 | x7 | x2 | x3))) & (~x4 | x2 | (~x0 & x3));
  ...
  assign new_n134_ = ~new_n120_ & (~x3 | ((x0 | ~x4) & (~x1 | (~x4 & x6))));
  assign new_n135_ = (x5 | ~x6 | x1 | x2 | ~x7) & (~x1 | ~x3 | ~x5);
  ...
  assign new_n139_ = new_n140_ & ((x0 & (~x1 | x2)) | x5 | (x2 & ~x6));
  assign new_n140_ = ~x4 & (x5 | x6) & (~x0 | ~x6 | x7) & (~x5 | (~x6 & ~x7));
  assign new_n141_ = x1 & x3;
  assign z43 = (~new_n145_ & ~x4) | ~new_n143_ | (x4 & (x1 | (~new_n144_ ^ ~x2)));
  assign new_n143_ = ~new_n125_ & (~x0 | ((~new_n74_ | ~x2) & (~new_n79_ | x4)));
  assign new_n144_ = ~x0 & x3;
  assign new_n145_ = (x5 | ((x0 | (~x2 & x6)) & (~x6 | ~x3 | x7))) & (x0 | ~x7) & (~x5 | (~x6 & ~x7));
  assign z44 = x1 | x2 | x3 | (~new_n74_ & ~x4) | (~x0 & ~x4) | (x0 & x4);
  assign z45 = (~new_n148_ & ~new_n151_) | new_n153_ | z18 | (~new_n154_ & x0);
  assign new_n148_ = (new_n149_ | x1) & new_n150_ & (x3 | (~x0 & x1));
  assign new_n149_ = ~x5 & (x4 | ~x6 | ~x7);
  assign new_n150_ = x2 & (x0 | x5 | x4 | ~x6);
  assign new_n151_ = (~x0 | (x3 & (~new_n84_ | x1))) & new_n152_ & (~new_n77_ | x1 | x3);
  assign new_n152_ = (~x1 | x5) & ~x2 & (x0 | ~x4);
  assign new_n153_ = ~new_n118_ & ~x4;
  assign new_n154_ = new_n155_ & (~new_n141_ | ~x7);
  assign new_n155_ = ~x4 & (x5 | x6);
  assign z47 = (new_n157_ | x0) & (~new_n86_ | ~x0 | ~x1 | ~x2 | ~x3);
  assign new_n157_ = (new_n155_ | ~x1 | ~x2) & (x2 | ~new_n84_ | x1);
  assign z48 = (~new_n81_ & new_n155_) | ~new_n144_ | x1 | x2;
  assign z51 = ~new_n160_ & ((~new_n74_ & ~x4) | ~new_n144_ | x1 | (x2 & x4));
  assign new_n160_ = (~new_n155_ | (new_n81_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  ...
  assign new_n165_ = ((x1 & (~x0 | x3) & (x0 | ~x3)) | ~x2 | (~x4 & x5 & ~x0 & x3)) & ((~x4 & (x0 | x1 | (~x3 & x5))) | x2 | (x1 & x3));
  ...
  assign new_n169_ = ((x5 & (~new_n87_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n170_ = (~x0 | (~x4 & (~new_n141_ | ~x7))) & (x4 | ((x5 | ~x6) & ((x6 & x7) | (~x0 & ~x5))));
  assign new_n171_ = ~x0 & ((~x1 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n175_ & ~x1) | new_n173_ | (~new_n174_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n173_ = (~new_n155_ | ~x2) & x0 & (x2 | ~x3);
  assign new_n174_ = (x3 | x1 | ~x2) & new_n81_ & x0 & (x2 | ~x3);
  assign new_n175_ = ((x0 & x2) | (x3 & ~x4)) & (x0 | x2) & (~x2 | ~x3 | ~x5);
  assign z57 = (x0 & (new_n180_ | ~x3)) | ~new_n178_ | (~new_n177_ & ~x0);
  assign new_n177_ = (x4 | (~new_n79_ & (x2 | ~x5))) & (x1 | x3) & ((~x4 & x5) | (~x2 & ~x3));
  ...
  assign z58 = new_n184_ | (~new_n182_ & ~x4);
  assign new_n182_ = (new_n183_ | x5) & ((~x5 & (~x2 | ~x6)) | (x0 & (new_n163_ | ~x5)));
  assign new_n183_ = (~x0 | x1 | (x2 & ~x3) | ~x6 | ~x7) & ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (x6 | (~x0 & x1));
  assign new_n184_ = (x4 | (((x1 & ~x5) | (~x1 & ~x2) | x0 | x3) & ((x2 & ~x1 & x5) | ~x3 | (x1 & ~x2)))) & (~x1 | ~x2 | x0 | ~x3);
  assign z59 = (x3 & (~new_n192_ | (~new_n191_ & ~x5))) | ~new_n187_ | (~new_n186_ & ~x3);
  assign new_n186_ = ((x0 & (~new_n87_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
  assign new_n187_ = (new_n188_ | x5) & new_n190_ & (new_n189_ | ~x5);
  assign new_n188_ = (x6 | x0 | x4) & (~x0 | x1 | x2 | (~x4 & (~x6 | ~x7)));
  assign new_n189_ = x4 & (~x0 | x1 | x2);
  assign new_n190_ = (~x2 | x0 | ~x4) & (x7 | (x0 & (x4 | ~x6)));
  ...
  assign z61 = new_n155_ | x1 | ~x3 | ~x0 | ~x2;
