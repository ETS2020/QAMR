...
module FAU ( 
  ...
  assign new_n122_ = (x5 | (x6 & (~x2 | ~x3 | x1 | ~x6 | ~x7))) & (~x2 | x3) & (~x6 | x7);
  ...
  assign z51 = ~new_n156_ & ((~new_n74_ & ~x4) | ~new_n142_ | x1 | (x2 & x4));
  assign new_n156_ = (~new_n151_ | (new_n80_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  ...
  assign new_n161_ = ((x1 & (~x0 | x3) & (x0 | ~x3)) | ~x2 | (~x4 & x5 & ~x0 & x3)) & ((~x4 & (x0 | x1 | (~x3 & x5))) | x2 | (x1 & x3));
  ...
  assign new_n165_ = ((x5 & (~new_n83_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n166_ = (~x0 | (~x4 & (~new_n139_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n167_ = ~x0 & ((~x1 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n171_ & ~x1) | new_n169_ | (~new_n170_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n169_ = x0 & (x2 | ~x3) & (~new_n151_ | ~x2);
  assign new_n170_ = (~x2 | x1 | x3) & new_n80_ & x0 & (x2 | ~x3);
  assign new_n171_ = ((x0 & x2) | (x3 & ~x4)) & (x0 | x2) & (~x2 | ~x3 | ~x5);
  ...
  assign new_n179_ = (~x0 | x1 | (x2 & ~x3) | ~x6 | ~x7) & ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (x6 | (~x0 & x1));
  ...
  assign new_n182_ = ((x0 & (~new_n83_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
