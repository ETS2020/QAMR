...
module FAU ( 
  ...
  wire new_n74_, new_n77_, new_n81_, new_n83_, new_n84_, new_n87_, new_n91_,
    ...
    new_n157_, new_n159_, new_n162_, new_n164_, new_n165_, new_n166_,
  ...
  assign new_n166_ = (x5 | ~x6) & ((~new_n91_ & x3) | x2 | x5);
  assign new_n167_ = ((~x2 & ~x4 & (x0 | (~x3 & x5))) | x1 | (x2 & (~x0 ^ ~x3))) & (x3 | ~x1 | x2 | ~x4) & ((x5 & x3 & ~x4) | ~x2 | (x0 ^ ~x3));
  assign z54 = (~new_n169_ & new_n173_) | ~new_n172_ | (~new_n170_ & ~x1);
  assign new_n169_ = ((x5 & (~new_n84_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n170_ = ~new_n171_ & (x2 | x3) & (~x2 | ~x3 | ~x5);
  assign new_n171_ = (~x5 | (x6 & x7)) & (x0 | ~x5) & ~x4 & (x5 | ~x6);
  assign new_n172_ = (~x0 | (~x4 & (~new_n141_ | ~x7))) & ((~x5 & ~x0 & ~x6) | x4 | (x5 & x6 & x7));
  ...
  assign z59 = (x3 & (~new_n192_ | (~new_n191_ & ~x5))) | ~new_n188_ | (~new_n193_ & ~x5);
  assign new_n188_ = ~new_n189_ & new_n190_ & (x3 | ((~x0 | (x1 & x2)) & (~x2 | x0 | ~x1)));
  assign new_n189_ = x5 & (~x4 | (x0 & ~x1 & ~x2));
  assign new_n190_ = ((~x2 & x3) | ~x4 | (x0 & x2)) & ((x7 & (~x0 | x3)) | (x0 & (x4 | ~x6)));
  assign new_n191_ = (x0 | ~x2) & (x4 | ((x6 | ~x0 | x1 | x2) & (~x2 | ~x6 | (~x1 & ~x7))));
  assign new_n192_ = (~x1 | (~x4 & x6)) & (~x4 | x0 | x2);
  assign new_n193_ = (x4 | x0 | x6) & (~x0 | x1 | x2 | (~x4 & (~x6 | ~x7)));
  assign z60 = (x3 | ((~x4 | ~x0 | ~x1) & (~new_n81_ | x2 | x0 | x1 | x4))) & (~new_n81_ | ~x3 | x4 | x0 | x1 | ~x2);
  assign z61 = new_n159_ | ~x3 | ~x0 | x1 | ~x2;
