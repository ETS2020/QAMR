...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n77_, new_n80_, new_n82_, new_n83_, new_n85_, new_n96_,
    new_n98_, new_n104_, new_n106_, new_n107_, new_n108_, new_n109_,
  ...
  assign z07 = new_n80_ & ~x2 & ~x0 & x1 & ~x3 & ~x4;
  ...
  assign z24 = new_n77_ & new_n96_;
  assign new_n96_ = ~x1 & ~x2 & ~x5 & ~x4 & ~x0 & ~x3;
  assign z25 = new_n98_ & ~x2 & ~x0 & x1 & ~x3 & ~x4;
  ...
  assign new_n104_ = ((~x0 & (x2 | x3) & (~x2 | ~x3 | ~x5)) | (~x2 & ~x5) | ~x4 | (x0 & x2)) & (~x0 | x4 | x5 | x2 | x6);
  ...
  assign new_n115_ = (x4 | (~x5 & (~x2 | (~x0 & (x1 | x3))))) & (~x0 | x1 | x2 | x5);
  ...
  assign new_n120_ = (~x0 | ((~x2 | x3) & (x1 | x2 | x5))) & (x4 | (x0 & ~x1 & x2));
  ...
  assign new_n133_ = ~new_n119_ & (~x3 | ((x0 | ~x4) & (~x1 | (~x4 & x6))));
  assign new_n134_ = (x5 | ~x6 | x1 | x2 | ~x7) & (~x1 | ~x3 | ~x5);
  ...
  assign z45 = (~new_n147_ & ~x2) | (~new_n150_ & x2) | ~new_n152_ | (~new_n117_ & ~x4);
  assign new_n147_ = (new_n148_ | ~x0) & ~new_n149_ & (x0 | ~x4) & (~x1 | x5);
  assign new_n148_ = x3 & (x1 | x4 | x5 | ~x6 | ~x7);
  assign new_n149_ = ~x1 & ~x3 & ~x7 & ~x5 & x6;
  assign new_n150_ = new_n151_ & (x1 | (~x5 & (~new_n83_ | x4)));
  assign new_n151_ = (x0 | x5 | x4 | ~x6) & (x3 | (~x0 & x1));
  assign new_n152_ = ~new_n153_ & (~x0 | (~new_n74_ & (~new_n140_ | ~x7)));
  assign new_n153_ = x4 & (x0 | (~x1 & x3 & x2 & ~x5));
  assign z47 = (new_n155_ | x0) & (~new_n85_ | ~x2 | ~x3 | ~x0 | ~x1);
  assign new_n155_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x2 | x1 | x4 | x5 | ~x6 | ~x7);
  assign z48 = (~new_n80_ & new_n157_) | ~new_n143_ | x1 | x2;
  assign new_n157_ = ~x4 & (x5 | x6);
  assign z51 = ~new_n159_ & ((~new_n74_ & ~x4) | ~new_n143_ | x1 | (x2 & x4));
  assign new_n159_ = (~new_n157_ | (new_n80_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  ...
  assign new_n173_ = (x3 | x1 | ~x2) & new_n80_ & x0 & (x2 | ~x3);
  ...
  assign new_n181_ = (new_n182_ | x5) & ((~x5 & (~x2 | ~x6)) | (x0 & (new_n162_ | ~x5)));
  ...
  assign new_n185_ = ((x0 & (~new_n83_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
