// Benchmark "FAU" written by ABC on Wed Jul 29 11:57:09 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n76_, new_n78_, new_n80_, new_n81_, new_n83_, new_n85_, new_n90_,
    new_n93_, new_n97_, new_n99_, new_n101_, new_n102_, new_n103_,
    ...
    new_n151_, new_n152_, new_n154_, new_n157_, new_n159_, new_n160_,
  ...
  assign z06 = z00 & ~x1 & new_n78_ & x2;
  assign new_n78_ = ~x0 & x3;
  assign z08 = new_n80_ & x0 & new_n81_ & x2 & ~x3;
  assign new_n80_ = x6 & x7;
  assign new_n81_ = ~x4 & x1 & x5;
  assign z11 = new_n83_ & ~x4 & ~x3 & x0 & x1;
  assign new_n83_ = new_n80_ & ~x2 & x5;
  assign z13 = ~x2 & ~x0 & x1 & new_n85_ & x3 & ~x4;
  assign new_n85_ = x7 & x5 & x6;
  assign z15 = new_n85_ & x3 & ~x4 & x2 & ~x0 & x1;
  assign z16 = new_n83_ & x3 & ~x4 & x0 & x1;
  assign z17 = ~x2 & x4 & ~x5 & x0 & ~x1;
  assign z19 = new_n90_ & ~x1 & ~x0 & x4;
  assign new_n90_ = ~x2 & ~x3;
  assign z23 = new_n78_ & ~x1 & ~x2 & x5;
  assign z25 = ~x2 & ~x0 & x1 & new_n93_ & ~x3 & ~x4;
  assign new_n93_ = ~x7 & ~x5 & x6;
  assign z26 = new_n80_ & ~x5 & x0 & x2 & ~x3 & ~x4;
  assign z27 = x2 & ~x0 & x1 & new_n93_ & ~x3 & ~x4;
  assign z28 = new_n80_ & ~x4 & x0 & new_n97_ & ~x1 & ~x5;
  assign new_n97_ = x2 & x3;
  assign z29 = new_n99_ & new_n90_ & ~x4 & x7 & ~x0 & ~x1;
  ...
  assign new_n107_ = (~x0 | (x6 & (~new_n108_ | ~x7))) & new_n109_ & ~new_n90_ & (x0 | ~x7);
  assign new_n108_ = ~x1 & ~x2;
  assign new_n109_ = ~x5 & (x6 ? (~x3 | x7) : x1);
  assign new_n110_ = x0 ? ((~x2 | x3) & (~x7 | ~x1 | ~x3)) : ~x1;
  assign new_n111_ = ((x2 & ~x3) | ~x0 | x1 | (~x2 & ~x4) | (~x2 & ~x5)) & (~x4 | (x0 & (~x1 | (x2 & ~x3))));
  assign z37 = (x0 & (~new_n113_ | (~new_n117_ & x3))) | ~new_n115_ | (~new_n114_ & ~x0);
  assign new_n113_ = (~x2 | ~x4) & (x1 | x5 | x2 | (~new_n80_ & ~x4));
  assign new_n114_ = (~x4 | (x2 & (x1 | x5))) & (new_n93_ | x4) & ((~x1 & ~x2) | x3);
  assign new_n115_ = (new_n116_ | ~x3) & (~z00 | x1) & ((x1 & ~x2) | x3 | (~x0 & x2));
  assign new_n116_ = (~x1 | (~x4 & x6)) & (~x5 | x1 | ~x2);
  assign new_n117_ = (~x1 | (~x7 & (x4 | ~x5))) & (x1 | ~x2 | x5 | x4 | ~x6 | ~x7);
  assign z39 = (~new_n119_ & x0) | new_n120_ | ~new_n122_ | (~new_n121_ & ~x0 & ~x5);
  assign new_n119_ = (x5 | (x6 & (x1 | ~x2))) & (~x6 | x7) & (~x2 | x3);
  ...
  assign new_n124_ = (new_n125_ | x1) & (~x0 | x4 | new_n76_ | x5);
  ...
  assign new_n129_ = (x1 | x2 | ~new_n80_ | x5) & (~x3 | ~x1 | ~x5);
  assign new_n130_ = new_n110_ & (~x3 | ((x0 | ~x4) & (~x1 | (~x4 & x6))));
  assign new_n131_ = (x0 | (~x5 & ~x7)) & (x5 | (x1 & ~x6) | (x6 & (~x3 | x7)));
  assign new_n132_ = ~x1 & ((~x2 & ~x3) | ((x2 | (x4 & ~x5)) & (~x0 | x3) & (x0 | ~x3)));
  ...
  assign new_n136_ = x0 & ((new_n76_ & ~x4) | (new_n99_ & x2));
  assign new_n137_ = (x0 | ~x7) & ((x5 & ~x6 & ~x7) | ((x0 | (~x2 & x6)) & ~x5 & (~x6 | ~x3 | x7)));
  assign new_n138_ = (x0 | (x2 ^ ~x3)) & (~x0 | ~x2) & (~x1 | (x2 & ~x3));
  assign z44 = (~x0 ^ x4) | (~new_n99_ & ~x4) | ~new_n108_ | x3;
  assign z45 = new_n146_ | new_n147_ | ((new_n141_ | ~new_n142_) & (new_n144_ | ~new_n145_));
  assign new_n141_ = x0 & (~x3 | (~x5 & new_n80_ & ~x4));
  assign new_n142_ = (~new_n93_ | x1 | x3) & new_n143_ & (~x1 | x5);
  assign new_n143_ = ~x2 & (x0 | ~x4);
  assign new_n144_ = ~x1 & (x5 | (new_n80_ & ~x4));
  assign new_n145_ = (~new_n103_ | x0 | x5) & x2 & (x3 | (~x0 & x1));
  assign new_n146_ = x0 & (new_n99_ | (x7 & x1 & x3));
  assign new_n147_ = (~new_n109_ | x4) & (x0 | ~x4 | (new_n97_ & ~x1 & ~x5));
  assign z46 = (new_n149_ | ~new_n90_ | x0 | ~x1) & (~new_n151_ | (~new_n152_ & (~new_n90_ | x0 | ~x1)));
  ...
  assign z48 = ~new_n78_ | ~new_n108_ | (~new_n85_ & new_n154_);
  assign new_n154_ = ~x4 & (x5 | x6);
  assign z49 = ~x2 | (~new_n99_ & ~x4) | x0 | x1 | (x3 & x4);
  assign z50 = ~new_n157_ | (x0 & (~x1 | ~x3));
  assign new_n157_ = ~x2 & ~x4 & new_n80_ & ~x5;
  assign z51 = (new_n154_ | ~new_n160_) & (~new_n159_ | (~new_n83_ & new_n154_));
  assign new_n159_ = x0 & x1 & (x2 | ~x3);
  assign new_n160_ = (~x2 | ~x4) & x3 & ~x0 & ~x1;
  assign z52 = (x3 & (x0 | (x2 & x4))) | (~new_n99_ & ~x4) | (~x0 & x1) | (~x1 & ~x2 & ~x3);
  assign z55 = ~new_n164_ | (~x4 & ((~new_n163_ & x5) | (~x5 & x6) | (~x1 & ~x5)));
  assign new_n163_ = (x3 | x1 | ~x2) & new_n80_ & x0 & (x2 | ~x3);
  ...
  assign new_n173_ = (x4 | (~new_n76_ & (x2 | ~x5))) & (x1 | x3) & ((~x4 & x5) | (~x2 & ~x3));
  assign new_n174_ = ~x4 & ((x5 & (~x6 | ~x7)) | (x1 & ~x5 & new_n97_ & x6));
  assign new_n175_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (x2 | x6 | x1 | x4 | ~x5);
  assign z58 = new_n179_ | (~x4 & ((~new_n177_ & ~x5) | ~new_n180_ | (~new_n178_ & x5)));
  assign new_n177_ = (~new_n97_ | ~x6) & (~new_n108_ | ~x0 | ~x7);
  assign new_n178_ = x0 & x7 & (~new_n108_ | ~x3);
  assign new_n179_ = (x4 | (((~x1 & ~x2) | x3 | x0 | (x1 & ~x5)) & ((~x1 & x2 & x5) | ~x3 | (x1 & ~x2)))) & (~x1 | ~x2 | x0 | ~x3);
  assign new_n180_ = x6 ? ((x0 | ~x2) & (~x3 | x7)) : (~x0 & x1);
  assign z60 = (~x4 | x3 | ~x0 | ~x1) & ((~x2 ^ ~x3) | ~new_n85_ | x0 | x1 | x4);
  assign z61 = new_n154_ | ~x2 | ~x3 | ~x0 | x1;
  assign z62 = new_n154_ | x3 | ~x0 | ~x1;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z07 = 1'b0;
