...
module FAU ( 
  ...
  wire new_n74_, new_n77_, new_n79_, new_n82_, new_n83_, new_n85_, new_n86_,
    new_n89_, new_n91_, new_n96_, new_n101_, new_n108_, new_n110_,
  ...
  assign z24 = new_n79_ & new_n101_;
  assign new_n101_ = ~x1 & ~x2 & ~x5 & ~x4 & ~x0 & ~x3;
  ...
  assign new_n108_ = ((~x0 & (x2 | x3) & (~x2 | ~x3 | ~x5)) | (~x2 & ~x5) | ~x4 | (x0 & x2)) & (x2 | x6 | ~x0 | x4 | x5);
  ...
  assign new_n119_ = ((~x1 & x2 & ~x3) | x5 | (x0 & (~x1 | x2))) & (~x4 | (x0 & ~x1 & ~x2 & ~x5));
  ...
  assign new_n124_ = (~x0 | ((x1 | x2 | x5) & (~x2 | x3))) & (x4 | (x0 & ~x1 & x2));
  ...
  assign new_n130_ = ~x4 & (~x5 | (~x6 & ~x7 & (x3 | x6)));
  assign z40 = (~new_n132_ & (new_n133_ | x1)) | (~x5 & (new_n134_ | ~new_n135_));
  assign new_n132_ = ~new_n79_ & x0 & ~x4 & ~x5;
  assign new_n133_ = ((~x4 & (x5 | x7)) | (~x2 & x4) | x0 | (x2 & ~x3)) & (~x4 | x2 | (~x0 & x3));
  assign new_n134_ = ~x4 & ((~x0 & (~x6 | (x3 & ~x7))) | (x3 & (x1 | (x0 & x6))));
  assign new_n135_ = (~x1 | x2) & (~x0 | ((x2 | ~x6 | ~x7) & (x2 | ~x4) & (~x2 | x6)));
  assign z41 = ~new_n137_ | new_n140_ | (~x4 & (~new_n139_ | (~new_n138_ & x0)));
  assign new_n137_ = ~new_n123_ & (~x3 | ((x0 | ~x4) & (~x1 | (~x4 & x6))));
  assign new_n138_ = (x5 | ~x6 | x1 | x2 | ~x7) & (~x1 | ~x3 | ~x5);
  ...
  assign z43 = (~new_n147_ & ~x4) | new_n146_ | new_n128_ | (~new_n148_ & x4);
  assign new_n146_ = x0 & ((new_n74_ & x2) | (new_n79_ & ~x4));
  assign new_n147_ = (x5 | ((x0 | (~x2 & x6)) & (~x6 | ~x3 | x7))) & (x0 | ~x7) & (~x5 | (~x6 & ~x7));
  assign new_n148_ = ~x1 & (x2 ^ (x0 | ~x3));
  assign z44 = ~new_n89_ | x1 | (~new_n74_ & ~x4) | (x0 & x4) | (~x0 & ~x4);
  ...
  assign new_n155_ = (~x4 | (~new_n96_ & ~x0)) & (new_n156_ | ~x0) & (new_n121_ | x4);
  assign new_n156_ = (x4 | x5 | x6) & (~x7 | ~x1 | ~x3);
  assign z48 = (~new_n82_ & new_n158_) | x1 | x2 | x0 | ~x3;
  assign new_n158_ = ~new_n74_ & ~x4;
  assign z51 = (new_n160_ | ~x0 | ~x1) & (new_n158_ | new_n161_ | x1 | x0 | ~x3);
  assign new_n160_ = ((~x2 & x3) | (~x4 & (x5 | x6))) & (~x5 | ~x6 | x2 | x3 | ~x7);
  assign new_n161_ = x2 & x4;
  assign z53 = ~new_n165_ | (~x4 & (new_n163_ | (~new_n74_ & (~new_n82_ | new_n164_))));
  assign new_n163_ = (new_n91_ | ~x3) & ~x2 & ~x5;
  assign new_n164_ = ((x0 & x1) | x2 | x3) & (x0 | x1) & (~x0 | ~x2);
  assign new_n165_ = ((~x2 & ~x4 & (x0 | (~x3 & x5))) | x1 | (x2 & (~x0 ^ ~x3))) & (x2 | ~x4 | ~x1 | x3) & (~x2 | (x0 ^ ~x3) | (x5 & x3 & ~x4));
  ...
  assign new_n170_ = (~x0 | (~x4 & (~new_n144_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n171_ = ~x0 & ((~x1 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = new_n173_ | new_n175_ | (x0 & (x2 | ~x3) & (~new_n158_ | ~x2));
  ...
  assign z57 = new_n177_ | (~new_n179_ & new_n180_) | new_n181_ | (new_n89_ & ~x1);
  assign new_n177_ = x0 & (new_n178_ | ~x3);
  assign new_n178_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (~x5 | x6 | x2 | x1 | x4);
  assign new_n179_ = ~x4 & x5 & ((x2 & x3) | (x1 & (~new_n83_ | x2)));
  assign new_n180_ = ~x0 & (~new_n89_ | (x1 & ~x4 & (new_n79_ | x5)));
  assign new_n181_ = ~x4 & ((x5 & (~x6 | ~x7)) | (new_n144_ & ~x5 & x2 & x6));
  assign z58 = new_n186_ | (~new_n183_ & ~x4);
  assign new_n183_ = (new_n184_ | x5) & ((x0 & (new_n185_ | ~x5)) | (~x5 & (~x2 | ~x6)));
  ...
  assign z60 = (x3 | ((~new_n194_ | x2 | x1 | x4) & (~x1 | ~x0 | ~x4))) & (~new_n194_ | ~x3 | x4 | x1 | ~x2);
