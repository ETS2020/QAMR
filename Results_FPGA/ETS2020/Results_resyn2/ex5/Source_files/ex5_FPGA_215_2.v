...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n78_, new_n81_, new_n82_, new_n84_, new_n85_, new_n88_,
    new_n90_, new_n93_, new_n96_, new_n98_, new_n103_, new_n108_,
  ...
  assign new_n84_ = new_n85_ & new_n82_ & ~x4 & ~x5;
  assign new_n85_ = x2 & ~x3;
  assign z10 = x2 & ~x0 & x1 & new_n82_ & ~x4 & x5;
  assign z11 = new_n88_ & new_n82_ & ~x4 & x5;
  assign new_n88_ = x0 & x1 & ~x2 & ~x3;
  assign z12 = new_n82_ & ~x4 & x5 & new_n85_ & new_n90_;
  assign new_n90_ = x0 & ~x1;
  assign z13 = ~x2 & ~x0 & x1 & new_n81_ & x3 & ~x4;
  assign z14 = new_n93_ & new_n82_ & ~x4 & x5;
  assign new_n93_ = x0 & ~x1 & ~x2 & x3;
  assign z15 = x2 & ~x0 & x1 & new_n81_ & x3 & ~x4;
  assign z18 = new_n96_ & x4;
  assign new_n96_ = ~x5 & ~x1 & x3 & ~x0 & x2;
  assign z20 = new_n98_ & x0 & ~x4 & ~x5 & ~x3 & ~x6;
  assign new_n98_ = ~x1 & ~x2;
  assign z21 = new_n93_ & new_n74_ & ~x4;
  assign z22 = new_n98_ & x0 & new_n82_ & ~x4 & ~x5;
  assign z24 = new_n78_ & ~x3 & ~x0 & ~x5 & new_n98_ & ~x4;
  ...
  assign new_n108_ = ((~x0 & (x2 | x3) & (~x2 | ~x3 | ~x5)) | ~x4 | (x0 & x2) | (~x2 & ~x5)) & (~x0 | x4 | x5 | x2 | x6);
  ...
  assign new_n130_ = (x5 | (x6 & (x1 | ~x3 | ~x2 | ~x6 | ~x7))) & (~x6 | x7) & (~x2 | x3);
  ...
  assign new_n137_ = (~new_n82_ | x5 | x1 | x2) & (~x1 | ~x3 | ~x5);
  ...
  assign z43 = (~new_n148_ & ~x4) | ~new_n146_ | (x4 & ((new_n147_ & ~x2) | x1 | (~new_n147_ & x2)));
  assign new_n146_ = ~new_n128_ & (~x0 | ((~new_n74_ | ~x2) & (~new_n78_ | x4)));
  ...
  assign new_n151_ = (~x4 | (~new_n96_ & ~x0)) & (new_n121_ | x4) & (~x0 | (~new_n144_ & (~new_n74_ | x4)));
  assign new_n152_ = new_n153_ & (x5 | (~x1 & (~new_n78_ | x3)));
  assign new_n153_ = (~x0 | x4 | x5 | ~x6 | ~x7) & (~x0 | x3) & (x0 | ~x4);
  assign new_n154_ = new_n155_ & (x1 | (~x5 & (~new_n82_ | x4)));
  assign new_n155_ = (x0 | x5 | x4 | ~x6) & (x3 | (~x0 & x1));
  assign z48 = ~new_n98_ | ~new_n147_ | (~new_n81_ & new_n157_);
  ...
  assign z53 = ~new_n165_ | (~x4 & (new_n163_ | (~new_n74_ & (~new_n81_ | new_n164_))));
  assign new_n163_ = (new_n90_ | ~x3) & ~x2 & ~x5;
  assign new_n164_ = ((x0 & x1) | x2 | x3) & (x0 | x1) & (~x0 | ~x2);
  ...
  assign new_n170_ = (~x0 | (~new_n144_ & ~x4)) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  ...
  assign new_n177_ = (x4 | (~new_n78_ & (x2 | ~x5))) & (x1 | x3) & ((~x2 & ~x3) | (~x4 & x5));
  ...
  assign new_n183_ = (~x0 | x1 | ~x6 | ~x7 | (x2 & ~x3)) & ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (x6 | (~x0 & x1));
  ...
  assign new_n186_ = ((x0 & (~new_n82_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
  ...
  assign z60 = (x3 | ((~x4 | ~x0 | ~x1) & (~new_n192_ | x2 | x1 | x4))) & (~new_n192_ | x1 | ~x2 | ~x3 | x4);
