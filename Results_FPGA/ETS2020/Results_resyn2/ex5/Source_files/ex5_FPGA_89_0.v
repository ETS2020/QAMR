// Benchmark "FAU" written by ABC on Wed Jul 29 11:56:44 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_, new_n91_,
    new_n95_, new_n97_, new_n99_, new_n100_, new_n105_, new_n110_,
  ...
  assign z08 = new_n80_ & x5 & x6;
  assign new_n80_ = x2 & ~x3 & x0 & x1 & ~x4 & x7;
  assign z09 = new_n82_ & x2 & ~x3 & ~x0 & ~x1;
  ...
  assign z33 = ((x1 | ((~x2 ^ x3) & (~x2 | x5))) & (~x1 | ~x2) & (~x1 | x3)) | (~x3 & (~x2 | (new_n113_ & ~x1 & x5))) | ((x3 | ~x5) & ~x1 & ~x2) | ~new_n114_ | (x2 & ~x5 & x1 & x3);
  assign new_n113_ = x0 & x7;
  assign new_n114_ = x0 & x6 & ~x4 & x7;
  assign z34 = (~new_n97_ | (~x4 & (~x6 | ~x7))) & (new_n116_ | x4 | x7);
  assign new_n116_ = (~x3 | ~x5 | x6) & (x0 | x5 | x1 | ~x2 | x3 | ~x6);
  assign z35 = ~x4 | (x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (~x2 | x3)) | (~x0 & ((x2 ^ x3) | (~x1 & x2 & ~x5)));
  assign z36 = (~new_n97_ & (new_n122_ | x4)) | (~x4 & (~new_n120_ | (~new_n119_ & x0)));
  assign new_n119_ = x6 & (~new_n99_ | ~x7);
  assign new_n120_ = (x6 ? (~x3 | x7) : x1) & new_n121_ & (x0 | ~x7);
  assign new_n121_ = (x2 | x3) & ~x5;
  assign new_n122_ = (x1 | (x0 & x2)) & (~x0 | ((x2 | x3) & (x7 | ~x1 | ~x3)));
  assign z37 = (~z04 & (new_n125_ | ~x0)) | (x0 & (~new_n124_ | (~new_n126_ & x3)));
  assign new_n124_ = (~new_n85_ | x1 | x2 | x5) & (~x4 | (~x2 & (x1 | x2 | x5)));
  assign new_n125_ = (x2 | (x1 & x3) | (~x1 & (~x3 | ~x5))) & ((x4 ? x1 : ~x6) | ~x3 | (~x1 & x5));
  assign new_n126_ = (~x1 | (~x7 & (x4 | ~x5))) & (x4 | x5 | ~x2 | ~x6 | ~x7);
  assign z38 = new_n129_ | ~new_n130_ | (~x4 & (new_n128_ | x5));
  assign new_n128_ = (x3 | (((x0 & ~x1 & ~x2) | ~x0 | ~x7) & (x0 | ~x6 | x7))) & ((x6 & ((x1 & x2) | ~x7)) | ~x0 | ((~x3 | x6) & x0 & ~x1 & ~x2));
  assign new_n129_ = ~x2 & ((x1 & ~x5) | (x4 & (~x0 | (x1 & ~x3))));
  assign new_n130_ = (~x2 | ((~x0 | x1) & x3)) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  assign z42 = new_n132_ | x4;
  assign new_n132_ = (~x5 | x6 | x7) & (~x7 | (x2 & ~x3) | ~new_n87_ | x5 | ~x6);
  assign z44 = (~x4 & (x5 | ~x0 | x6)) | ~new_n99_ | x3 | (x0 & x4);
  assign z46 = (~new_n135_ & ~x4) | (~new_n138_ & (new_n137_ | x4));
  assign new_n135_ = (new_n136_ | ~x0) & ((~x5 & (~new_n105_ | x0)) | (~new_n100_ & x0 & ~x7));
  ...
  assign new_n140_ = (~x3 | ((x1 | ~x0 | x2) & (~x2 | x5))) & (x5 | x2 | ~x0 | x1) & new_n85_ & (x0 | (~x2 & ~x5));
  ...
  assign new_n147_ = new_n85_ & ((x0 ? x2 : ~x1) | ((~x0 | ~x1) & ~x2 & ~x3));
  assign new_n148_ = (x5 | ~x6) & (x2 | x5 | (~new_n87_ & x3));
  assign new_n149_ = (~x1 | ((~x0 | ~x3) & (x2 | (~x3 & x4)))) & ((~x2 & (x4 | (~x0 & (x3 | ~x5)))) | (x0 & x2) | ((x4 | ~x3 | ~x5) & x2 & (~x1 | x3)));
  assign z54 = ~new_n152_ | (new_n155_ & (new_n151_ | x3 | (x2 & x4)));
  assign new_n151_ = x1 & (x2 ? ~x5 : (new_n85_ & ~x4 & x5));
  assign new_n152_ = ~new_n153_ & ~new_n154_ & (x1 | (x2 ^ x3) | (x2 & ~x5));
  assign new_n153_ = ~x4 & ((~x1 & ((~x5 & ~x6) | (x5 & x6 & x0 & x7))) | (~x5 & (x0 | x6)) | (x5 & (~x6 | ~x7)));
  assign new_n154_ = x0 & (x4 | (x7 & x1 & x3));
  assign new_n155_ = ~x0 & ((~x5 & ~x1 & x4) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z56 = (~x4 & (~new_n157_ | new_n162_)) | (x0 & x4) | (~new_n160_ & ~new_n163_);
  assign new_n157_ = (new_n158_ | ~x6) & ~new_n159_ & (new_n84_ | x6) & (~x5 | (x6 & x7));
  ...
  assign new_n165_ = (~x0 | (x1 & (~new_n85_ | ~x2 | x4 | x5))) & (x5 | ~x2 | x0 | ~x1) & (x2 | (~x0 & ~x4));
