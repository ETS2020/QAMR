...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n76_, new_n78_, new_n80_, new_n81_, new_n83_, new_n84_, new_n90_,
    new_n94_, new_n98_, new_n100_, new_n102_, new_n103_, new_n104_,
  ...
  assign z28 = new_n98_ & x6 & new_n90_ & ~x5 & ~x4 & x7;
  assign new_n98_ = x2 & x3;
  assign z29 = new_n100_ & new_n81_ & ~x4 & x7 & ~x0 & ~x1;
  assign new_n100_ = ~x5 & ~x6;
  assign z32 = ~new_n102_ | ((new_n105_ | ~x5) & ~x2 & (x1 | x4));
  assign new_n102_ = new_n104_ & (x4 | (new_n103_ & (~new_n76_ | ~x0) & ~x5 & (new_n76_ | x0)));
  assign new_n103_ = ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (x2 | (x6 & ~x7) | ~x0 | x1 | (x3 & ~x6));
  assign new_n104_ = (~x2 | (x3 & (~x0 | x1))) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  assign new_n105_ = x4 & (~x0 | (x1 & ~x3));
  assign z35 = ((~x5 | ~x2 | ~x3) & ~x0 & (x2 | x3)) | (x0 & (x2 | ~x5)) | x1 | ~x4;
  assign z36 = ~new_n111_ | ~new_n112_ | (~new_n108_ & ~x4);
  assign new_n108_ = (~x0 | (x6 & (~new_n109_ | ~x7))) & new_n110_ & ~new_n81_ & (x0 | ~x7);
  assign new_n109_ = ~x1 & ~x2;
  assign new_n110_ = ~x5 & (x6 ? (~x3 | x7) : x1);
  assign new_n111_ = x0 ? ((~x2 | x3) & (~x7 | ~x1 | ~x3)) : ~x1;
  assign new_n112_ = ((x2 & ~x3) | ~x0 | x1 | (~x2 & ~x4) | (~x2 & ~x5)) & (~x4 | (x0 & (~x1 | (x2 & ~x3))));
  assign z37 = (x0 & (~new_n114_ | (~new_n118_ & x3))) | ~new_n116_ | (~new_n115_ & ~x0);
  assign new_n114_ = (~x2 | ~x4) & (x1 | x5 | x2 | (~new_n83_ & ~x4));
  assign new_n115_ = (~x4 | (x2 & (x1 | x5))) & (new_n94_ | x4) & ((~x1 & ~x2) | x3);
  assign new_n116_ = (x1 | (~z00 & (x2 | x3))) & (new_n117_ | ~x3) & (x3 | ~x0 | ~x2);
  assign new_n117_ = (~x1 | (~x4 & x6)) & (~x5 | x1 | ~x2);
  assign new_n118_ = (~x1 | ((x4 | ~x5) & ~x7)) & (x1 | ~x2 | x5 | x4 | ~x6 | ~x7);
  assign z38 = ~new_n102_ | (~x2 & (new_n105_ | (x1 & ~x5)));
  ...
  assign new_n126_ = (new_n127_ | x1) & (~x0 | x4 | new_n76_ | x5);
  ...
  assign z41 = ~new_n132_ | ~new_n111_ | (~x4 & (~new_n134_ | (~new_n131_ & x0)));
  assign new_n131_ = (x1 | x2 | ~new_n83_ | x5) & (~x3 | ~x1 | ~x5);
  assign new_n132_ = ~new_n133_ & (~x3 | ((x0 | ~x4) & (~x1 | (~x4 & x6))));
  assign new_n133_ = (x2 | ~x3 | (x4 & ~x5)) & (x3 | ~x0 | ~x2) & ~x1 & (x0 | ~x3);
  ...
  assign new_n137_ = x0 & ((new_n100_ & x2) | (new_n76_ & ~x4));
  assign new_n138_ = (x0 | ~x7) & ((~x7 & x5 & ~x6) | ((x0 | (~x2 & x6)) & ~x5 & (~x6 | ~x3 | x7)));
  assign new_n139_ = (x0 | (x2 ^ ~x3)) & (~x0 | ~x2) & (~x1 | (x2 & ~x3));
  assign z44 = (~x0 ^ x4) | (~new_n100_ & ~x4) | ~new_n109_ | x3;
  assign z45 = new_n148_ | new_n149_ | (~new_n145_ & (new_n142_ | ~new_n143_));
  ...
  assign new_n148_ = x0 & (new_n100_ | (x7 & x1 & x3));
  assign new_n149_ = (~new_n110_ | x4) & (x0 | ~x4 | (new_n98_ & ~x1 & ~x5));
  assign z46 = (new_n151_ | ~new_n81_ | x0 | ~x1) & (~new_n153_ | (~new_n154_ & (~new_n81_ | x0 | ~x1)));
  assign new_n151_ = ~x4 & (x0 | x5 | (new_n152_ & x1 & ~x7));
  assign new_n152_ = ~x3 & ~x2 & x6;
  assign new_n153_ = (((~new_n109_ | ~x7) & ~x5 & x6) | ((~x3 | x6) & x5 & ~x7)) & x0 & (~x6 | x7);
  assign new_n154_ = x3 & ~x4 & ((x1 & ~x7) | ~x0 | (~x1 & ~x2));
  assign z48 = ~new_n78_ | ~new_n109_ | (~new_n80_ & new_n156_);
  assign new_n156_ = ~x4 & (x5 | x6);
  assign z49 = ~x2 | (~new_n100_ & ~x4) | x0 | x1 | (x3 & x4);
  ...
  assign z52 = (x3 & (x0 | (x2 & x4))) | (~new_n100_ & ~x4) | (~x0 & x1) | (~x1 & ~x2 & ~x3);
