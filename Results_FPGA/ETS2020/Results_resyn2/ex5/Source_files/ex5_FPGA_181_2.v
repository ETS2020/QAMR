...
module FAU ( 
  ...
  wire new_n74_, new_n77_, new_n79_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n98_, new_n105_, new_n107_, new_n108_, new_n109_, new_n110_,
  ...
  assign z45 = (~new_n148_ & ~x2) | (~new_n151_ & x2) | ~new_n153_ | (~new_n118_ & ~x4);
  assign new_n148_ = (new_n149_ | ~x0) & ~new_n150_ & (x0 | ~x4) & (~x1 | x5);
  assign new_n149_ = x3 & (x1 | x4 | x5 | ~x6 | ~x7);
  assign new_n150_ = ~x1 & ~x3 & ~x7 & ~x5 & x6;
  assign new_n151_ = new_n152_ & (x1 | (~x5 & (~new_n85_ | x4)));
  assign new_n152_ = (x0 | x5 | x4 | ~x6) & (x3 | (~x0 & x1));
  assign new_n153_ = ~new_n154_ & (~x0 | (~new_n74_ & (~new_n141_ | ~x7)));
  assign new_n154_ = x4 & (x0 | (~x1 & x3 & x2 & ~x5));
  assign z47 = (new_n156_ | x0) & (~new_n87_ | ~x2 | ~x3 | ~x0 | ~x1);
  assign new_n156_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x2 | x1 | x4 | x5 | ~x6 | ~x7);
  assign z48 = (~new_n82_ & new_n158_) | ~new_n144_ | x1 | x2;
  assign new_n158_ = ~x4 & (x5 | x6);
  assign z51 = ~new_n160_ & ((~new_n74_ & ~x4) | ~new_n144_ | x1 | (x2 & x4));
  assign new_n160_ = (~new_n158_ | (new_n82_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  ...
  assign new_n173_ = x0 & (x2 | ~x3) & (~new_n158_ | ~x2);
  assign new_n174_ = (x3 | x1 | ~x2) & new_n82_ & x0 & (x2 | ~x3);
  ...
  assign new_n184_ = (x4 | (((x1 & ~x5) | (~x1 & ~x2) | x0 | x3) & ((~x1 & x2 & x5) | ~x3 | (x1 & ~x2)))) & (~x1 | ~x2 | x0 | ~x3);
