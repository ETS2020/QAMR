...
module FAU ( 
  ...
  assign new_n114_ = ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (~x0 | x1 | x2 | (x3 & ~x6) | (x6 & ~x7));
  ...
  assign z39 = new_n132_ | ~new_n134_ | ~new_n136_;
  assign new_n132_ = ~x5 & ((~new_n133_ & ~x4) | (~x2 & ~x0 & ~x1));
  assign new_n133_ = x6 & (~x2 | (x0 & (~x7 | x1 | ~x3)));
  assign new_n134_ = new_n135_ & (x4 | ~x5 | (~x7 & x3 & ~x6));
  assign new_n135_ = (~x4 | (x2 & x3)) & (~x0 | (~x4 & (~x6 | x7)));
  assign new_n136_ = ~new_n137_ & ((x3 & ~x4) | ~x2 | (x0 & x3) | (~x0 & ~x3));
  assign new_n137_ = x1 & ((~x2 & ~x5) | (x3 & x0 & x7));
  assign z40 = new_n139_ | (~x5 & ((~new_n141_ & x0) | new_n142_ | new_n143_));
  assign new_n139_ = (new_n140_ | x1) & (new_n101_ | x4 | ~x0 | x5);
  ...
  assign z43 = (~new_n152_ & ~x4) | new_n151_ | new_n137_ | (~new_n110_ & x4);
  assign new_n151_ = x0 & ((new_n74_ & x2) | (new_n101_ & ~x4));
  assign new_n152_ = (x5 | ((~x6 | ~x3 | x7) & (x0 | (~x2 & x6)))) & (~x5 | ~x6) & (~x7 | (x0 & ~x5));
  assign z45 = (~new_n154_ & ~x2) | ~new_n157_ | (x2 & (~new_n161_ | (~new_n156_ & x0)));
  assign new_n154_ = (~x0 | (x3 & (~new_n83_ | x4))) & ~new_n155_ & (x0 | ~x4);
  assign new_n155_ = ~x5 & (x1 | (~x3 & x6 & ~x7));
  assign new_n156_ = x3 & (~new_n83_ | x1 | x4);
  assign new_n157_ = ~new_n159_ & ~z18 & (~x0 | (new_n160_ & (~new_n158_ | ~x7)));
  assign new_n158_ = x1 & x3;
  assign new_n159_ = ~x4 & (x5 | (~x1 & ~x6) | (x6 & x3 & ~x7));
  ...
  assign z48 = (~new_n80_ & new_n160_) | x2 | ~x3 | x0 | x1;
  assign z49 = ~x2 | x0 | x1 | (x4 ? x3 : ~new_n74_);
  assign z50 = (~new_n158_ & x0) | ~new_n118_ | x2 | x5;
  assign z51 = (~new_n171_ & ~x4) | (~x1 & ((x4 & (x0 | x2 | ~x3)) | ((x0 | ~x3) & (x2 | ~x3)))) | (x1 & (~x0 | (~x2 & x3)));
  assign new_n171_ = (~x5 | (~new_n172_ & x0 & x6 & x7)) & ~new_n173_ & (x5 | ~x6);
  assign new_n172_ = x1 & (x2 | x3);
  assign new_n173_ = x0 & ~x2 & ~x1 & x3;
  assign z52 = (x3 & (x0 | (x2 & x4))) | (~x3 & ~x1 & ~x2) | (~x0 & x1) | (~new_n74_ & ~x4);
  assign z53 = ~new_n178_ | (~x4 & (~new_n177_ | (~new_n176_ & x5)));
  assign new_n176_ = new_n164_ & ((~x0 & (~x1 | (~x2 & ~x3))) | (~x1 & ~x3) | (x0 & x2));
  assign new_n177_ = (x5 | ~x6) & (x2 | x5 | ((~x0 | x1) & x3));
  assign new_n178_ = ((~x2 & ~x4 & (x0 | (~x3 & x5))) | x1 | (x2 & (~x0 | ~x3) & (x0 | x3))) & (~x1 | x2 | x3 | ~x4) & (~x2 | (x0 & x3) | (~x0 & ~x3) | (~x0 & ~x4 & x5));
  assign z54 = (~new_n180_ & ~x1) | ~new_n183_ | (~new_n182_ & new_n184_);
  assign new_n180_ = (x4 | ((x5 | x6) & (~new_n181_ | ~x5 | ~x6))) & (x2 | x3) & (~x2 | ~x3 | ~x5);
  assign new_n181_ = x0 & x7;
  assign new_n182_ = ((x5 & (~new_n164_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n183_ = (~x0 | (~x4 & (~new_n158_ | ~x7))) & ((~x6 & ~x0 & ~x5) | x4 | (x7 & x5 & x6));
  assign new_n184_ = ~x0 & ((x4 & ~x1 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = ~new_n187_ | (~x4 & ((~new_n186_ & x5) | (~x1 & ~x5) | (~x5 & x6)));
  assign new_n186_ = new_n164_ & x0 & (x2 | ~x3) & (x1 | ~x2 | x3);
  assign new_n187_ = (new_n188_ | ~x2) & (x1 | (~x4 & (x0 | x3))) & ((x0 & x3) | x2 | (~x0 & x1));
  assign new_n188_ = (x1 | ~x3 | ~x5) & (~x0 | (~x4 & (x5 | x6)));
  assign z56 = ((~new_n190_ | new_n193_) & ~x4) | (~new_n195_ & (new_n194_ | x4));
  assign new_n190_ = ~new_n191_ & new_n192_ & ((x2 & (x1 | ~x3)) | x5 | (~x2 & x3));
  assign new_n191_ = x6 & ((x3 & ~x7) | (~x5 & ~x0 & x2));
  assign new_n192_ = (~x5 | (x6 & x7)) & (x6 | (~x0 & x1));
  assign new_n193_ = ~x2 & ((~x0 & x1) | (x0 & ~x1 & x3)) & (x5 | (x0 & ~x1 & x3));
  assign new_n194_ = (x0 | (x1 ? ~x5 : (~x2 | x3))) & (x2 | ((x0 | ~x1) & (~x0 | x1 | ~x3))) & (~x0 | ~x3 | (x1 ? x7 : x5));
  assign new_n195_ = x3 & ~x2 & ~x0 & x1;
  assign z57 = (x0 & (new_n201_ | ~x3)) | ~new_n199_ | (~new_n197_ & ~new_n198_ & ~x0);
  assign new_n197_ = ~x4 & x5 & ((x2 & x3) | (x1 & (~new_n164_ | x2)));
  assign new_n198_ = new_n94_ & (~x1 | x4 | (~new_n101_ & ~x5));
  assign new_n199_ = (new_n200_ | x4) & (x3 | x1 | x2);
  assign new_n200_ = (~x5 | (x6 & x7)) & (~x2 | ~x6 | ~x1 | ~x3 | x5);
  assign new_n201_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (~x7 | x4 | ~x6))))) & (x1 | x2 | x4 | ~x5 | x6);
  assign z58 = ~new_n206_ | (~new_n203_ & (x0 | ~x4));
  assign new_n203_ = (new_n204_ | x5) & new_n205_ & (~new_n173_ | ~x5);
  assign new_n204_ = (~x6 | ~x7 | ~x0 | x1 | (x2 & ~x3)) & ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (x6 | (~x0 & x1));
  assign new_n205_ = (x0 | (~x5 & (~x2 | ~x6))) & ~x4 & (~x5 | (x6 & x7));
  assign new_n206_ = (x3 | (~x0 & ~x4 & (x1 ? x5 : x2))) & (~x3 | (x1 & x2) | ((x0 | ~x4) & ~x1 & (~x2 | ~x5)));
  assign z59 = (x3 & (~new_n213_ | (~new_n212_ & ~x5))) | ~new_n209_ | (~new_n208_ & ~x3);
  assign new_n208_ = (~x0 | (x1 & (~new_n118_ | ~x2 | x5))) & (x0 | ~x1 | ~x2 | x5) & (x2 | (~x0 & ~x4));
