...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n76_, new_n78_, new_n80_, new_n81_, new_n83_, new_n84_, new_n94_,
    ...
    new_n153_, new_n157_, new_n159_, new_n160_, new_n163_, new_n164_,
  ...
  assign z18 = ~x0 & ~x5 & ~x1 & x2 & x3 & x4;
  assign z19 = ~x0 & x4 & new_n81_ & ~x1;
  assign z23 = x5 & ~x0 & ~x1 & ~x2 & x3;
  assign z25 = new_n94_ & ~x4 & new_n81_ & ~x0 & x1;
  assign new_n94_ = ~x7 & ~x5 & x6;
  assign z26 = new_n83_ & ~x5 & x0 & x2 & ~x3 & ~x4;
  assign z27 = new_n94_ & ~x3 & ~x4 & ~x0 & x1 & x2;
  assign z28 = new_n83_ & ~x4 & x0 & new_n78_ & ~x1 & ~x5;
  assign z29 = new_n99_ & new_n81_ & ~x5 & ~x6;
  assign new_n99_ = ~x0 & ~x1 & ~x4 & x7;
  assign z32 = ~new_n101_ | (~x4 & (~new_n104_ | (new_n76_ & x0) | x5 | (~new_n76_ & ~x0)));
  assign new_n101_ = (new_n102_ | x2) & (~x1 | (x0 & (new_n103_ | ~x3))) & (~x2 | ((~x0 | x1) & x3));
  assign new_n102_ = (~x1 | x5) & (~x4 | ((x5 | ~x0 | x1) & x0 & (~x1 | x3)));
  assign new_n103_ = ~x4 & x6;
  assign new_n104_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x2 | (x6 & ~x7) | ~x0 | x1 | (x3 & ~x6));
  assign z35 = ((~x5 | ~x2 | ~x3) & ~x0 & (x2 | x3)) | (x0 & (x2 | ~x5)) | x1 | ~x4;
  assign z36 = ~new_n110_ | ~new_n111_ | (~new_n107_ & ~x4);
  assign new_n107_ = (~x0 | (x6 & (~new_n108_ | ~x7))) & new_n109_ & ~new_n81_ & (x0 | ~x7);
  ...
  assign new_n113_ = (~x2 | ~x4) & (x1 | x5 | x2 | (~new_n83_ & ~x4));
  assign new_n114_ = (~x4 | (x2 & (x1 | x5))) & (new_n94_ | x4) & ((~x1 & ~x2) | x3);
  ...
  assign new_n124_ = (new_n125_ | x1) & (new_n76_ | x5 | ~x0 | x4);
  ...
  assign new_n129_ = (x1 | x2 | ~new_n83_ | x5) & (~x3 | ~x1 | ~x5);
  ...
  assign new_n134_ = (x7 | ~x5 | x6) & (x5 | ~x6 | ~x7 | new_n84_ | ~x0 | x1);
  ...
  assign z44 = (~x0 ^ x4) | new_n140_ | ~new_n108_ | x3;
  assign new_n140_ = ~x4 & (x5 | x6);
  assign z45 = new_n147_ | new_n148_ | ((new_n145_ | ~new_n146_) & (new_n142_ | ~new_n143_));
  assign new_n142_ = x0 & (~x3 | (~x5 & new_n83_ & ~x4));
  assign new_n143_ = (~new_n94_ | x1 | x3) & new_n144_ & (~x1 | x5);
  assign new_n144_ = ~x2 & (x0 | ~x4);
  assign new_n145_ = ~x1 & (x5 | (new_n83_ & ~x4));
  assign new_n146_ = (~new_n103_ | x0 | x5) & x2 & (x3 | (~x0 & x1));
  assign new_n147_ = (~new_n109_ | x4) & ((new_n78_ & ~x1 & ~x5) | x0 | ~x4);
  assign new_n148_ = x0 & ((~x5 & ~x6) | (x7 & x1 & x3));
  assign z46 = (new_n150_ | ~new_n81_ | x0 | ~x1) & (~new_n152_ | (~new_n153_ & (~new_n81_ | x0 | ~x1)));
  assign new_n150_ = ~x4 & (x0 | x5 | (new_n151_ & x1 & ~x7));
  assign new_n151_ = ~x3 & ~x2 & x6;
  assign new_n152_ = (((~new_n108_ | ~x7) & ~x5 & x6) | ((~x3 | x6) & x5 & ~x7)) & x0 & (~x6 | x7);
  assign new_n153_ = x3 & ~x4 & ((x1 & ~x7) | ~x0 | (~x1 & ~x2));
  assign z48 = (~new_n80_ & new_n140_) | x0 | x1 | x2 | ~x3;
  assign z49 = new_n140_ | ~x2 | x0 | x1 | (x3 & x4);
  assign z50 = ~new_n157_ | (x0 & (~x1 | ~x3));
  assign new_n157_ = ~x2 & ~x4 & new_n83_ & ~x5;
  assign z51 = (new_n140_ | ~new_n160_) & (~new_n159_ | (new_n140_ & (~new_n83_ | x2 | ~x5)));
  assign new_n159_ = x0 & x1 & (x2 | ~x3);
  assign new_n160_ = (~x2 | ~x4) & x3 & ~x0 & ~x1;
  assign z52 = (x3 & (x0 | (x2 & x4))) | new_n140_ | (~x0 & x1) | (~x1 & ~x2 & ~x3);
  assign z55 = ~new_n164_ | (~x4 & ((~new_n163_ & x5) | (~x1 & ~x5) | (~x5 & x6)));
  assign new_n163_ = (x3 | x1 | ~x2) & new_n83_ & x0 & (x2 | ~x3);
  assign new_n164_ = (~x0 | (x2 ? new_n140_ : x3)) & (x1 | (new_n165_ & (x0 | (x2 & x3))));
  ...
  assign new_n169_ = (x2 | ((x0 | ~x1) & (~x3 | ~x0 | x1))) & (x0 | ((x3 | x1 | ~x2) & (~x1 | ~x5))) & (~x0 | ~x3 | (x1 ? x7 : x5));
  ...
  assign new_n173_ = (x4 | (~new_n76_ & (x2 | ~x5))) & (x1 | x3) & ((~x2 & ~x3) | (~x4 & x5));
  assign new_n174_ = ~x4 & ((x5 & (~x6 | ~x7)) | (x1 & ~x5 & new_n78_ & x6));
  assign new_n175_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (x2 | x6 | x1 | x4 | ~x5);
  assign z58 = new_n179_ | (~x4 & ((~new_n177_ & ~x5) | ~new_n180_ | (~new_n178_ & x5)));
  assign new_n177_ = (~new_n78_ | ~x6) & (~new_n108_ | ~x0 | ~x7);
