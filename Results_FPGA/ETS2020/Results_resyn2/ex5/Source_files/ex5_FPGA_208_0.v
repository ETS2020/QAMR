...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n78_, new_n80_, new_n83_, new_n84_, new_n86_, new_n87_,
    new_n88_, new_n90_, new_n94_, new_n98_, new_n100_, new_n104_,
    ...
    new_n144_, new_n145_, new_n150_, new_n151_, new_n152_, new_n154_,
  ...
  assign new_n83_ = new_n84_ & x0 & x1 & ~x4 & x7;
  assign new_n84_ = x2 & ~x3;
  assign z10 = new_n86_ & new_n88_ & x2;
  assign new_n86_ = new_n87_ & ~x4 & x5;
  assign new_n87_ = x6 & x7;
  assign new_n88_ = ~x0 & x1;
  assign z12 = new_n90_ & x2 & new_n86_ & ~x3;
  assign new_n90_ = x0 & ~x1;
  assign z14 = new_n90_ & ~x2 & new_n87_ & ~x4 & x3 & x5;
  assign z15 = new_n88_ & x2 & new_n87_ & ~x4 & x3 & x5;
  assign z16 = new_n86_ & new_n94_ & x0 & ~x2;
  ...
  assign z22 = new_n78_ & x7 & ~x4 & ~x1 & x0 & ~x2;
  ...
  assign z33 = ((x1 | ((~x2 ^ x3) & (~x2 | x5))) & (~x1 | ~x2) & (~x1 | x3)) | (~x3 & (~x2 | (new_n114_ & ~x1 & x5))) | (x2 & ~x5 & x1 & x3) | ~new_n114_ | ~new_n115_ | (~x1 & ~x2 & (x3 | ~x5));
  assign new_n114_ = x0 & x7;
  assign new_n115_ = ~x4 & x6;
  assign z34 = (~new_n117_ | (~x4 & (~x6 | ~x7))) & (new_n118_ | x4 | x7);
  assign new_n117_ = new_n90_ & ~x2 & ~x5;
  assign new_n118_ = (~x3 | ~x5 | x6) & (x0 | x5 | x1 | ~x2 | x3 | ~x6);
  assign z35 = ~x4 | (x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (~x2 | x3)) | (~x0 & ((x2 ^ x3) | (~x1 & x2 & ~x5)));
  assign z36 = (~new_n117_ & (new_n124_ | x4)) | (~new_n121_ & ~x4);
  assign new_n121_ = (new_n122_ | ~x0) & ~new_n123_ & ~new_n98_ & ~x5 & (x0 | ~x7);
  assign new_n122_ = x6 & (x1 | x2 | ~x7);
  assign new_n123_ = x6 ? (x3 & ~x7) : ~x1;
  assign new_n124_ = (x1 | (x0 & x2)) & ((x3 & (~x1 | x7)) | ~x0 | (x2 & ~x3));
  assign z37 = (~new_n126_ & x0) | (~new_n128_ & (new_n129_ | ~x0));
  assign new_n126_ = (~new_n127_ | (~x1 & (x4 | x5 | ~new_n87_ | ~x2))) & (~x2 | ~x4) & ((~new_n87_ & ~x4) | x1 | x2 | x5);
  assign new_n127_ = x3 & ((~x4 & x5) | ~x1 | x7);
  assign new_n128_ = x3 & ~x5 & new_n80_ & ~x4;
  assign new_n129_ = (x2 | (x1 & x3) | (~x1 & (~x3 | ~x5))) & ((x4 ? x1 : ~x6) | ~x3 | (~x1 & x5));
  ...
  assign z46 = new_n137_ | new_n140_;
  assign new_n137_ = ~x4 & ((~new_n138_ & x0) | (~new_n139_ & ((new_n106_ & ~x0) | x5)));
  assign new_n138_ = (~x6 | x7) & (x5 | (x6 & (x1 | x2 | ~x7)));
  assign new_n139_ = (~x3 | x6) & x0 & ~x7;
  assign new_n140_ = (new_n141_ | x4) & (~x1 | x3 | x0 | x2);
  assign new_n141_ = (~x1 | ((x0 | ~x5) & (x7 | ~x0 | ~x3))) & (~x3 | (x0 ? (x1 | x2) : ~x5));
  assign z47 = ~new_n145_ | (~new_n143_ & ~new_n144_ & ~x4);
  assign new_n143_ = (~x3 | ((x1 | ~x0 | x2) & (~x2 | x5))) & (x2 | ~x0 | x1 | x5) & new_n87_ & (x0 | (~x2 & ~x5));
  assign new_n144_ = (new_n98_ | ~x6) & x1 & ~x0 & ~x5;
  assign new_n145_ = (x2 | ((x0 ? x3 : ~x4) & (~x1 | x5) & (~x1 | ~x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 & ~x4 & ~x5));
  assign z49 = (x4 ? x3 : ~new_n74_) | x0 | x1 | ~x2;
  assign z50 = (~new_n94_ & x0) | x2 | x5 | ~new_n87_ | x4;
  ...
  assign new_n151_ = (x5 | ~x6) & (x2 | x5 | (~new_n90_ & x3));
  ...
  assign z56 = (~x4 & (~new_n160_ | new_n165_)) | (~new_n163_ & ~new_n166_) | (x0 & x4);
  assign new_n160_ = (new_n161_ | ~x6) & ~new_n162_ & (new_n88_ | x6) & (~x5 | (x6 & x7));
  ...
  assign new_n168_ = (~x0 | (x1 & (x4 | x5 | ~new_n87_ | ~x2))) & (x2 | (~x0 & ~x4)) & (x5 | ~x2 | x0 | ~x1);
  assign new_n169_ = (~x4 | ((x1 | ~x0 | x2) & (x0 | ~x2))) & new_n171_ & (new_n170_ | x4);
