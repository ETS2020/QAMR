...
module FAU ( 
  ...
  wire new_n74_, new_n81_, new_n83_, new_n85_, new_n86_, new_n88_, new_n90_,
    new_n96_, new_n97_, new_n99_, new_n101_, new_n105_, new_n110_,
  ...
  assign z09 = new_n83_ & ~x0 & ~x3 & ~x1 & x2;
  ...
  assign new_n99_ = new_n88_ & ~x2 & ~x5;
  assign z21 = new_n97_ & x0 & new_n101_ & ~x4 & ~x5;
  assign new_n101_ = x3 & ~x6;
  assign z22 = new_n83_ & ~x1 & x0 & ~x2;
  assign z24 = x6 & ~x7 & new_n96_ & ~x5 & ~x0 & ~x4;
  assign z25 = new_n105_ & ~x0 & ~x4;
  assign new_n105_ = x1 & ~x5 & x6 & ~x7 & ~x2 & ~x3;
  assign z28 = new_n88_ & x2 & new_n86_ & x3 & ~x4 & ~x5;
  assign z29 = ~x6 & x7 & new_n96_ & ~x5 & ~x0 & ~x4;
  assign z30 = new_n81_ & ~x5 & x6;
  assign z31 = new_n110_ | ~new_n111_;
  assign new_n110_ = x4 & ((((~x1 & x3) | (~x2 ^ ~x3)) & ~x0 & ((~x2 ^ ~x3) | (x2 & ~x5))) | (x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (~x2 | x3)));
  ...
  assign new_n116_ = (x6 | ~x3 | ~x5) & (x3 | x1 | ~x2 | ~x6 | x0 | x5);
  assign z35 = ~x4 | (((~x1 & x3) | (~x2 ^ ~x3)) & ~x0 & ((~x2 ^ ~x3) | (x2 & ~x5))) | (x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (~x2 | x3));
  assign z36 = (~new_n99_ & (new_n122_ | x4)) | (~x4 & (new_n119_ | ~new_n120_));
  assign new_n119_ = x0 & (~x6 | (new_n97_ & x7));
  assign new_n120_ = (~x6 | ~x3 | x7) & new_n121_ & (x1 | x6) & (x0 | ~x7);
  ...
  assign new_n125_ = (x2 | (x1 & x3) | (~x1 & (~x3 | ~x5))) & ((~x1 & ~x4 & ~x6) | (x1 & (x4 | ~x6)) | ~x3 | (~x1 & x5));
  assign new_n126_ = (~x1 | (~x7 & (x4 | ~x5))) & (~x2 | x5 | x4 | ~x6 | ~x7);
  ...
  assign new_n132_ = (~x5 | x6 | x7) & (~x7 | (x2 & ~x3) | ~new_n88_ | x5 | ~x6);
  assign z44 = (~x4 & (x5 | ~x0 | x6)) | ~new_n96_ | (x0 & x4);
  ...
  assign new_n145_ = new_n86_ & ~x4 & ~x2 & ~x5;
  ...
  assign new_n149_ = (x5 | ~x6) & ((~new_n88_ & x3) | x2 | x5);
  ...
  assign z56 = (~new_n157_ & ~new_n163_) | ((~new_n159_ | ~new_n161_) & (x0 | ~x4));
  assign new_n157_ = new_n158_ & (x0 | ((~x2 | (~x4 & x5)) & (x1 | x2 | x5)));
  assign new_n158_ = (~x1 | ~x0 | ~x7) & x3 & ((x0 & ~x2) | x1 | ~x5);
  assign new_n159_ = new_n160_ & ((~x2 ^ ~x3) | x5 | (x1 & x3));
  assign new_n160_ = (x6 | (~x0 & x1)) & ~x4 & (~x5 | (x6 & x7));
  assign new_n161_ = ~new_n162_ & (((~x0 | ~x3) & (~x5 | x0 | ~x1)) | x2 | (x0 & x1));
  ...
  assign new_n165_ = (~x0 | (x1 & (~x2 | x5 | ~new_n86_ | x4))) & (x5 | ~x2 | x0 | ~x1) & (x2 | (~x0 & ~x4));
  ...
  assign new_n169_ = (x0 | ~x2) & (x4 | ((~x2 | ~x6 | (~x1 & ~x7)) & (x6 | ~x0 | x1 | x2)));
  assign new_n170_ = (~x1 | (~x4 & x6)) & (x2 | x0 | ~x4);
