// Benchmark "FAU" written by ABC on Wed Jul 29 11:57:43 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n80_, new_n83_, new_n91_, new_n94_, new_n100_,
  ...
  assign z22 = x0 & ~x2 & new_n83_ & ~x1 & ~x4;
  ...
  assign z31 = ~new_n109_ | (x4 & (~new_n108_ | (~x5 & (x0 | x3))));
  assign new_n108_ = (x0 | x2 | ~x3) & ~x1 & (~x2 | (~x0 & x3));
  assign new_n109_ = ((x2 & (~x0 | x6)) | x5 | (x0 & ~x1 & ~x2)) & (x4 | (x0 & ~x5 & ~x6));
  assign z32 = ~new_n111_ | ((new_n114_ | ~x5) & ~x2 & (x1 | x4));
  assign new_n111_ = new_n113_ & (x4 | (new_n112_ & (~new_n100_ | ~x0) & ~x5 & (new_n100_ | x0)));
  assign new_n112_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n113_ = (~x2 | ((~x0 | x1) & x3)) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  assign new_n114_ = x4 & (~x0 | (x1 & ~x3));
  assign z33 = ((~x1 | ~x5) & (~x1 | x3) & (x1 | x5)) | ~new_n116_ | ~x0 | ~x2;
  assign new_n116_ = x7 & ~x4 & x6;
  assign z34 = new_n118_ | (~z17 & (~new_n120_ | (~new_n119_ & x6)));
  assign new_n118_ = (x1 | ~x2 | x3) & ~x5 & (~x0 | (x1 & ~x2));
  assign new_n119_ = (x7 | (~x0 & ~x5)) & (~x2 | x5 | ((~x1 | ~x3) & (~x0 | ~x7)));
  assign new_n120_ = ~x4 & ((x6 & (~x7 | (x0 & ~x5))) | (~x7 & x3 & x5));
  assign z35 = ~x4 | ~new_n108_ | (~x5 & (x0 | x3));
  ...
  assign z43 = (~new_n149_ & ~x4) | new_n148_ | new_n135_ | (~new_n108_ & x4);
  assign new_n148_ = x0 & ((new_n74_ & x2) | (new_n100_ & ~x4));
  assign new_n149_ = (x5 | ((~x6 | ~x3 | x7) & (x0 | (~x2 & x6)))) & (~x5 | ~x6) & (~x7 | (x0 & ~x5));
  assign z44 = (~x4 & (x6 | ~x0 | x5)) | (x0 & x4) | ~new_n91_ | x3;
  assign z45 = (~new_n152_ & ~x2) | ~new_n155_ | (x2 & (~new_n157_ | (~new_n154_ & x0)));
  assign new_n152_ = (~x0 | (x3 & (~new_n83_ | x4))) & ~new_n153_ & (x0 | ~x4);
  assign new_n153_ = ~x5 & (x1 | (~x3 & x6 & ~x7));
  assign new_n154_ = x3 & (~new_n83_ | x1 | x4);
  assign new_n155_ = (x4 | (new_n145_ & ~x5)) & ~z18 & (new_n156_ | ~x0);
  ...
  assign new_n159_ = (x0 | (x1 & ~x3 & ~x2 & x6)) & (~new_n116_ | (~x1 & (~x2 | x3)));
  assign new_n160_ = (x0 | ~x4) & (x4 | ~x5 | x3 | x6 | ~x0 | x7);
  assign new_n161_ = x1 & ((x0 & x3 & x7) | (~x0 & ~x3 & x2 & ~x5));
  ...
  assign new_n167_ = (x2 | ((~x4 | (x0 & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (x1 | ~x2 | (x3 & ~x4 & ~x5)) & (x2 | ~x1 | x5) & (~x0 | (~x4 & (~x2 | x3)));
  ...
  assign z52 = (x3 & (x0 | (x2 & x4))) | (~x1 & ~x2 & ~x3) | (~x0 & x1) | (~new_n74_ & ~x4);
  ...
  assign z54 = new_n182_ | ~new_n186_ | (~new_n184_ & new_n188_);
  assign new_n182_ = ~x1 & (new_n183_ | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n183_ = ~x4 & ((~x5 & ~x6) | (x5 & x6 & x0 & x7));
  assign new_n184_ = ((~new_n185_ & x5) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n185_ = x7 & ~x2 & x6;
  assign new_n186_ = (~x0 | (~new_n187_ & ~x4)) & ((~x6 & ~x0 & ~x5) | x4 | (x7 & x5 & x6));
  assign new_n187_ = x1 & x3 & x7;
  assign new_n188_ = ~x0 & ((x4 & ~x1 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n190_ & ~x4) | new_n191_ | (~x1 & (x4 | (~x0 & ~x3)));
  assign new_n190_ = (~x5 | (new_n174_ & (x2 | ~x3) & (x1 | ~x2 | x3))) & (x1 | x5) & (x5 | ~x6);
  assign new_n191_ = ((~new_n169_ & x0) | ~x2 | (~x1 & x3 & x5)) & ((~x0 & ~x1) | x2 | (x0 & ~x3));
  assign z56 = (~new_n198_ & (new_n197_ | x4)) | (~x4 & (~new_n193_ | ~new_n195_));
  assign new_n193_ = new_n194_ & (x2 | (x0 & ~x3) | (~x0 & ~x1) | (x0 & x1) | (~x5 & (~x0 | x1 | ~x3)));
  assign new_n194_ = (~x5 | (x6 & x7)) & (x6 | (~x0 & x1));
  assign new_n195_ = ~new_n196_ & (x5 | (x2 ? (x1 | ~x3) : x3));
  assign new_n196_ = x6 & ((x3 & ~x7) | (~x5 & ~x0 & x2));
  assign new_n197_ = ((~x1 & (~x2 | x3)) | x0 | (x1 & ~x5)) & (x2 | (x0 & ~x3) | (~x0 & ~x1) | (x0 & x1)) & (~x0 | ~x3 | (x1 ? x7 : x5));
  assign new_n198_ = x3 & ~x2 & ~x0 & x1;
  assign z57 = (x0 & (new_n203_ | ~x3)) | (~new_n200_ & ~x0) | new_n201_ | (new_n91_ & ~x3);
  assign new_n200_ = (x4 | (~new_n100_ & (x2 | ~x5))) & (x1 | x3) & ((~x2 & ~x3) | (~x4 & x5));
  assign new_n201_ = ~new_n202_ & ~x4;
  assign new_n202_ = (~x5 | (x6 & x7)) & (~x1 | x5 | ~x2 | ~x3 | ~x6);
  assign new_n203_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (~x7 | x4 | ~x6))))) & (x1 | x2 | x4 | ~x5 | x6);
  assign z58 = ~new_n207_ | (~x4 & (~new_n205_ | (~new_n206_ & ~x5)));
  assign new_n205_ = (~x5 | ~new_n132_ | ~x0 | x2) & (~x5 | (x6 & x7)) & (x0 | (~x5 & (~x2 | ~x6)));
  assign new_n206_ = (x1 | (x2 & ~x3) | ~x0 | ~x6 | ~x7) & (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x6 | (~x0 & x1));
  assign new_n207_ = (x3 | ((~x1 | x5) & (x1 | x2) & ~x0 & ~x4)) & (~x0 | ~x4) & (((x0 | ~x4) & ~x1 & (~x2 | ~x5)) | ~x3 | (x1 & x2));
  assign z59 = (~new_n209_ & x3) | new_n213_ | new_n214_ | new_n215_ | (~new_n212_ & ~x3);
  assign new_n209_ = new_n211_ & (new_n210_ | x5);
  assign new_n210_ = (x0 | ~x2) & (x4 | ((x1 | x2 | ~x0 | x6) & (~x2 | ~x6 | (~x1 & ~x7))));
  assign new_n211_ = (x0 | x2 | ~x4) & (~x1 | (~x4 & x6));
  assign new_n212_ = (~x0 | (x1 & (~new_n116_ | ~x2 | x5))) & (x0 | ~x1 | ~x2 | x5) & (x2 | (~x0 & ~x4));
  assign new_n213_ = ~x5 & ((x0 & new_n91_ & (x4 | (x6 & x7))) | (~x4 & ~x0 & ~x6));
  assign new_n214_ = (~x7 | (x2 & x4)) & (~x0 | (~new_n74_ & ~x4));
  assign new_n215_ = (~x4 | (x0 & ~x1 & ~x2)) & x5 & (x4 | x7);
  assign z60 = (~x1 | x3 | ~x0 | ~x4) & ((x2 ^ x3) | ~new_n80_ | x1 | x0 | x4);
  assign z61 = new_n169_ | ~x0 | ~new_n132_ | ~x2;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z15 = 1'b0;
  assign z25 = 1'b0;
