// Benchmark "FAU" written by ABC on Wed Jul 29 11:56:56 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n81_, new_n82_, new_n84_, new_n86_, new_n87_, new_n89_,
    new_n91_, new_n92_, new_n96_, new_n99_, new_n102_, new_n107_,
    new_n112_, new_n113_, new_n115_, new_n117_, new_n118_, new_n121_,
  ...
  assign z09 = ~x5 & x6 & ~x4 & x7 & new_n82_ & new_n84_;
  ...
  assign z20 = ~x3 & ~x4 & ~x5 & new_n92_ & ~x6;
  assign z21 = new_n92_ & new_n102_ & ~x4 & ~x5;
  assign new_n102_ = x3 & ~x6;
  assign z22 = new_n92_ & ~x4 & x7 & ~x5 & x6;
  assign z23 = new_n99_ & x3 & x5;
  assign z24 = x6 & ~x7 & new_n99_ & ~x3 & ~x4 & ~x5;
  assign z25 = new_n107_ & ~x0 & ~x4;
  assign new_n107_ = x1 & ~x5 & x6 & ~x7 & ~x2 & ~x3;
  assign z28 = new_n89_ & x2 & new_n87_ & x3 & ~x4 & ~x5;
  assign z29 = new_n99_ & ~x3 & ~x4 & ~x5 & ~x6 & x7;
  assign z30 = new_n81_ & ~x5 & x6;
  assign z31 = new_n112_ | ~new_n113_;
  assign new_n112_ = x4 & ((~x0 & ((~x2 ^ ~x3) | (~x1 & x3 & ~x5))) | (x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (~x2 | x3)));
  assign new_n113_ = ((x0 & ~x1 & ~x2) | (~x0 & x2) | x5 | (x2 & x6)) & (x4 | (x0 & ~x5 & ~x6));
  assign z33 = ~new_n115_ | (x5 ? ~x1 : (x1 & x3));
  assign new_n115_ = ~x4 & x6 & x2 & x0 & x7;
  assign z34 = (new_n117_ | x4 | x7) & (~new_n118_ | (~x4 & (~x6 | ~x7)));
  assign new_n117_ = (x6 | ~x3 | ~x5) & (x0 | x5 | ~x2 | x3 | x1 | ~x6);
  assign new_n118_ = x0 & ~x1 & ~x2 & ~x5;
  assign z35 = ~x4 | (~x0 & ((~x2 ^ ~x3) | (~x1 & x3 & ~x5))) | (x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (~x2 | x3));
  assign z36 = (~new_n96_ & (new_n123_ | x4)) | (~x4 & (~new_n121_ | new_n124_));
  ...
  assign z44 = (~x4 & (~new_n74_ | ~x0)) | ~new_n132_ | (x0 & x4);
  assign z46 = (~new_n138_ & ~x4) | ((new_n140_ | x4) & (~new_n141_ | ~x1 | x3));
  assign new_n138_ = (new_n139_ | ~x0) & ((~x5 & (~new_n107_ | x0)) | (~new_n102_ & x0 & ~x7));
  assign new_n139_ = (~x6 | x7) & (x5 | (x6 & (x1 | x2 | ~x7)));
  assign new_n140_ = (~x5 | x0 | ~x1) & (((x1 | x2) & x0 & (~x1 | x7)) | ~x3 | (~x0 & ~x5));
  assign new_n141_ = ~x0 & ~x2;
  assign z47 = ~new_n145_ | ((~new_n87_ | new_n143_) & ~new_n144_ & ~x4);
  assign new_n143_ = ((x0 & ~x1) | x2 | x5) & ((x3 & (~x5 | (~x1 & ~x2))) | ~x0 | (~x2 & ~x5));
  assign new_n144_ = (~x6 | (~x2 & ~x3)) & x1 & ~x0 & ~x5;
  assign new_n145_ = (x2 | (~x4 & (~x0 | x3) & (~x1 | (~x3 & x5)))) & ((x3 & ~x4 & (x1 | ~x5)) | ~x2 | (~x0 & x1));
  assign z49 = ~new_n84_ | ~x2 | (x4 ? x3 : ~new_n74_);
  assign z50 = ~new_n148_ | (x0 & (~x1 | ~x3));
  assign new_n148_ = new_n87_ & ~x4 & ~x2 & ~x5;
  assign z52 = (x3 & (x0 | (x2 & x4))) | (~new_n74_ & ~x4) | (~x0 & x1) | (~x3 & ~x1 & ~x2);
  assign z53 = new_n153_ | (~x4 & (~new_n152_ | (~new_n151_ & x5)));
  assign new_n151_ = new_n87_ & (((~x0 | ~x1) & ~x2 & ~x3) | (x0 & x2) | (~x0 & ~x1));
  assign new_n152_ = (x5 | ~x6) & (x2 | x5 | (~new_n89_ & x3));
  assign new_n153_ = (~x1 | ((~x0 | ~x3) & (x2 | (~x3 & x4)))) & ((~x2 & (x4 | (~x0 & (x3 | ~x5)))) | (x0 & x2) | ((x4 | ~x3 | ~x5) & x2 & (~x1 | x3)));
  assign z56 = new_n159_ | (x0 & x4) | (~x4 & (~new_n155_ | ~new_n157_));
  assign new_n155_ = ~new_n156_ & ((~x2 ^ ~x3) | x5 | (x1 & x3));
  assign new_n156_ = x6 & ((x3 & ~x7) | (~x5 & ~x0 & x2));
  assign new_n157_ = ~new_n158_ & (x2 | ((~x5 | x0 | ~x1) & (~x3 | ~x0 | x1)));
  assign new_n158_ = (~x6 | ~x7) & (x5 | (~x6 & (x0 | ~x1)));
  assign new_n159_ = ~new_n161_ & (~new_n160_ | ~x3 | (new_n141_ & ~x1 & ~x5));
  assign new_n160_ = ((~x4 & x5) | x0 | ~x2) & (~x1 | ~x0 | ~x7) & ((x0 & ~x2) | x1 | ~x5);
  assign new_n161_ = (~x2 | ~x1 | x5) & (x1 | x2) & ~x3 & ~x0 & ~x4;
  assign z59 = (~new_n163_ & x3) | ~new_n166_ | new_n167_ | (~new_n165_ & ~x3);
  assign new_n163_ = (new_n164_ | x5) & (~new_n141_ | ~x4) & (~x1 | (~x4 & x6));
  assign new_n164_ = (x0 | ~x2) & (x4 | ((x6 | ~x0 | x1 | x2) & (~x2 | ~x6 | (~x1 & ~x7))));
  assign new_n165_ = (~x0 | (x1 & (x4 | x5 | ~new_n87_ | ~x2))) & (x0 | ~x2 | ~x1 | x5) & (x2 | (~x0 & ~x4));
  assign new_n166_ = (x4 | (~x5 & (x0 | x6))) & (~new_n92_ | ~x6) & (x7 | (x0 & (x4 | ~x6)));
  assign new_n167_ = x4 & (x2 ? ~x0 : (x0 & ~x1));
