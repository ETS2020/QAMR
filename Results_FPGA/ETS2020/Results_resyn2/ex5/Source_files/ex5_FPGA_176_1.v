...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n78_, new_n81_, new_n82_, new_n84_, new_n85_, new_n94_,
  ...
  assign z28 = new_n84_ & ~x4 & x0 & new_n98_ & ~x1 & ~x5;
  assign new_n98_ = x2 & x3;
  assign z29 = new_n75_ & new_n82_ & ~x0 & ~x1 & ~x4 & x7;
  ...
  assign new_n106_ = (~x0 | (x6 & (~new_n107_ | ~x7))) & new_n108_ & ~new_n82_ & (x0 | ~x7);
  assign new_n107_ = ~x1 & ~x2;
  assign new_n108_ = ~x5 & (x6 ? (~x3 | x7) : x1);
  assign new_n109_ = x0 ? ((~x2 | x3) & (~x7 | ~x1 | ~x3)) : ~x1;
  assign new_n110_ = (~x0 | x1 | (x2 & ~x3) | (~x2 & ~x5) | (~x2 & ~x4)) & (~x4 | (x0 & (~x1 | (x2 & ~x3))));
  assign z37 = (x0 & (~new_n112_ | (~new_n116_ & x3))) | ~new_n114_ | (~new_n113_ & ~x0);
  assign new_n112_ = (~x2 | ~x4) & (x1 | x5 | x2 | (~new_n84_ & ~x4));
  assign new_n113_ = (~x4 | (x2 & (x1 | x5))) & (new_n94_ | x4) & ((~x1 & ~x2) | x3);
  assign new_n114_ = (x1 | (~z00 & (x2 | x3))) & (new_n115_ | ~x3) & (x3 | ~x0 | ~x2);
  ...
  assign new_n123_ = (new_n124_ | x1) & (~x0 | x4 | new_n78_ | x5);
  ...
  assign z41 = ~new_n129_ | ~new_n109_ | (~x4 & (~new_n131_ | (~new_n128_ & x0)));
  assign new_n128_ = (x1 | x2 | ~new_n84_ | x5) & (~x3 | ~x1 | ~x5);
  ...
  assign new_n135_ = x0 & ((new_n78_ & ~x4) | (new_n75_ & x2));
  assign new_n136_ = (x0 | ~x7) & ((x5 & ~x6 & ~x7) | ((x0 | (~x2 & x6)) & ~x5 & (~x6 | ~x3 | x7)));
  assign new_n137_ = (x0 | (x2 ^ ~x3)) & (~x0 | ~x2) & (~x1 | (x2 & ~x3));
  assign z44 = (~x0 ^ x4) | (~new_n75_ & ~x4) | ~new_n107_ | x3;
  assign z45 = new_n145_ | new_n146_ | ((new_n143_ | ~new_n144_) & (new_n140_ | ~new_n141_));
  assign new_n140_ = x0 & (~x3 | (~x5 & new_n84_ & ~x4));
  assign new_n141_ = (~new_n94_ | x1 | x3) & new_n142_ & (~x1 | x5);
  assign new_n142_ = ~x2 & (x0 | ~x4);
  assign new_n143_ = ~x1 & (x5 | (new_n84_ & ~x4));
  assign new_n144_ = (~new_n103_ | x0 | x5) & x2 & (x3 | (~x0 & x1));
  assign new_n145_ = x0 & (new_n75_ | (x7 & x1 & x3));
  assign new_n146_ = (~new_n108_ | x4) & (x0 | ~x4 | (new_n98_ & ~x1 & ~x5));
  assign z46 = (new_n148_ | ~new_n82_ | x0 | ~x1) & (~new_n150_ | (~new_n151_ & (~new_n82_ | x0 | ~x1)));
  ...
  assign z48 = (~new_n81_ & new_n153_) | x0 | x1 | x2 | ~x3;
  assign new_n153_ = ~x4 & (x5 | x6);
  assign z49 = ~x2 | (~new_n75_ & ~x4) | x0 | x1 | (x3 & x4);
  assign z50 = ~new_n156_ | (x0 & (~x1 | ~x3));
  assign new_n156_ = ~x2 & ~x4 & new_n84_ & ~x5;
  assign z51 = (new_n153_ | ~new_n159_) & (~new_n158_ | (new_n153_ & (~new_n84_ | x2 | ~x5)));
  ...
  assign new_n168_ = (x2 | ((x0 | ~x1) & (~x0 | x1 | ~x3))) & (x0 | ((x3 | x1 | ~x2) & (~x1 | ~x5))) & (~x0 | ~x3 | (x1 ? x7 : x5));
  ...
  assign new_n172_ = (x4 | (~new_n78_ & (x2 | ~x5))) & (x1 | x3) & ((~x2 & ~x3) | (~x4 & x5));
  assign new_n173_ = ~x4 & ((x5 & (~x6 | ~x7)) | (x1 & ~x5 & new_n98_ & x6));
  assign new_n174_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (x2 | x6 | x1 | x4 | ~x5);
  assign z58 = new_n178_ | (~x4 & ((~new_n176_ & ~x5) | ~new_n179_ | (~new_n177_ & x5)));
  assign new_n176_ = (~new_n98_ | ~x6) & (~new_n107_ | ~x0 | ~x7);
