...
module FAU ( 
  ...
  assign new_n152_ = x1 & (x2 ? ~x5 : (new_n86_ & ~x4 & x5));
  ...
  assign new_n158_ = (new_n159_ | ~x6) & ~new_n160_ & (new_n85_ | x6) & (~x5 | (x6 & x7));
  ...
  assign new_n166_ = (~x0 | (x1 & (~new_n86_ | ~x2 | x4 | x5))) & (x5 | ~x2 | x0 | ~x1) & (x2 | (~x0 & ~x4));
