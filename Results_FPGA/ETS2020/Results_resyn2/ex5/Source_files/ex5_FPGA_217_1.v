...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n78_, new_n80_, new_n82_, new_n83_, new_n84_, new_n85_,
    new_n87_, new_n90_, new_n97_, new_n102_, new_n103_, new_n104_,
  ...
  assign z07 = new_n82_ & new_n84_;
  assign new_n82_ = new_n83_ & ~x0 & x1;
  assign new_n83_ = ~x2 & ~x3;
  assign new_n84_ = new_n85_ & ~x4 & x5;
  assign new_n85_ = x6 & x7;
  assign z08 = new_n84_ & new_n87_ & x2 & ~x3;
  assign new_n87_ = x0 & x1;
  assign z11 = ~x3 & ~x4 & x5 & new_n87_ & new_n85_ & ~x2;
  assign z13 = new_n84_ & new_n90_;
  assign new_n90_ = x1 & ~x2 & ~x0 & x3;
  assign z15 = new_n84_ & new_n80_ & ~x0 & x1;
  assign z16 = new_n84_ & new_n87_ & ~x2 & x3;
  assign z17 = ~x2 & x4 & x0 & ~x1 & ~x5;
  assign z19 = new_n83_ & ~x1 & ~x0 & x4;
  ...
  assign z32 = ~new_n102_ | (~x4 & (~new_n105_ | (new_n78_ & x0) | x5 | (~new_n78_ & ~x0)));
  ...
  assign new_n115_ = (~x4 | (x2 & (x1 | x5))) & (new_n97_ | x4) & ((~x1 & ~x2) | x3);
  assign new_n116_ = (new_n117_ | ~x3) & (~z00 | x1) & ((~x0 & x2) | x3 | (x1 & ~x2));
  assign new_n117_ = (~x1 | (~x4 & x6)) & (~x5 | x1 | ~x2);
  assign new_n118_ = (~x1 | (~x7 & (x4 | ~x5))) & (x1 | ~x2 | x5 | x4 | ~x6 | ~x7);
  ...
  assign new_n125_ = (new_n126_ | x1) & (~x0 | x4 | new_n78_ | x5);
  ...
  assign z42 = x4 | ((~x5 | x6 | x7) & (~new_n135_ | x5 | ~x6 | ~x7));
  ...
  assign new_n139_ = (x0 | (x2 ^ ~x3)) & (~x1 | (x2 & ~x3)) & (~x0 | ~x2);
  assign z44 = (~x0 ^ x4) | (~new_n75_ & ~x4) | ~new_n109_ | x3;
  assign z45 = new_n147_ | new_n148_ | ((new_n145_ | ~new_n146_) & (new_n142_ | ~new_n143_));
  assign new_n142_ = x0 & (~x3 | (~x5 & new_n85_ & ~x4));
  assign new_n143_ = (~new_n97_ | x1 | x3) & new_n144_ & (~x1 | x5);
  assign new_n144_ = ~x2 & (x0 | ~x4);
  assign new_n145_ = ~x1 & (x5 | (new_n85_ & ~x4));
  assign new_n146_ = (~new_n104_ | x0 | x5) & x2 & (x3 | (~x0 & x1));
  assign new_n147_ = x0 & (new_n75_ | (x7 & x1 & x3));
  assign new_n148_ = (~new_n110_ | x4) & ((new_n80_ & ~x1 & ~x5) | x0 | ~x4);
  assign z46 = (~new_n82_ | new_n150_) & (~new_n152_ | (~new_n82_ & ~new_n153_));
  assign new_n150_ = ~x4 & (x0 | x5 | (new_n151_ & x1 & ~x7));
  assign new_n151_ = ~x3 & ~x2 & x6;
  assign new_n152_ = (((~new_n109_ | ~x7) & ~x5 & x6) | ((~x3 | x6) & x5 & ~x7)) & x0 & (~x6 | x7);
  assign new_n153_ = x3 & ~x4 & ((x1 & ~x7) | ~x0 | (~x1 & ~x2));
  assign z48 = (new_n155_ & ~new_n156_) | x2 | ~x3 | x0 | x1;
  assign new_n155_ = ~x4 & (x5 | x6);
  assign new_n156_ = x7 & x5 & x6;
  assign z49 = ~x2 | (~new_n75_ & ~x4) | x0 | x1 | (x3 & x4);
  assign z50 = ~new_n159_ | (x0 & (~x1 | ~x3));
  assign new_n159_ = ~x2 & ~x4 & new_n85_ & ~x5;
  assign z51 = (new_n155_ | ~new_n162_) & (~new_n161_ | (new_n155_ & (~new_n85_ | x2 | ~x5)));
  assign new_n161_ = new_n87_ & (x2 | ~x3);
  ...
  assign new_n165_ = (x3 | x1 | ~x2) & new_n85_ & x0 & (x2 | ~x3);
  assign new_n166_ = (~x0 | (x2 ? new_n155_ : x3)) & (x1 | (new_n167_ & (x0 | (x2 & x3))));
  assign new_n167_ = ~x4 & (~x5 | ~x2 | ~x3);
  assign z56 = (~new_n90_ & (new_n171_ | x4)) | (~x4 & (~new_n169_ | new_n172_));
  assign new_n169_ = (x2 | ((~x3 | ~x0 | x1) & (x0 | ~x1 | ~x5))) & new_n170_ & ((x2 & ~x3) | (~x2 & x3) | x5 | (x1 & x3));
  assign new_n170_ = (x6 | (~x0 & x1)) & (~x5 | (x6 & x7));
  assign new_n171_ = (x2 | ((x0 | ~x1) & (~x0 | x1 | ~x3))) & (x0 | ((~x1 | ~x5) & (x3 | x1 | ~x2))) & (~x0 | ~x3 | (x1 ? x7 : x5));
  ...
  assign new_n175_ = ~x4 & ((x5 & (~x6 | ~x7)) | (x1 & ~x5 & new_n80_ & x6));
  assign new_n176_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (x2 | x6 | x1 | x4 | ~x5);
  assign z58 = new_n180_ | (~x4 & ((~new_n178_ & ~x5) | ~new_n181_ | (~new_n179_ & x5)));
  assign new_n178_ = (~new_n80_ | ~x6) & (~new_n109_ | ~x0 | ~x7);
  assign new_n179_ = x0 & x7 & (~new_n109_ | ~x3);
  assign new_n180_ = (x0 | ~x1 | ~x2 | ~x3) & (x4 | (((~x1 & ~x2) | x3 | x0 | (x1 & ~x5)) & ((~x1 & x2 & x5) | ~x3 | (x1 & ~x2))));
  assign new_n181_ = x6 ? ((x0 | ~x2) & (~x3 | x7)) : (~x0 & x1);
  assign z60 = (~x4 | ~x0 | ~x1 | x3) & ((~x2 ^ ~x3) | ~new_n156_ | x0 | x1 | x4);
  assign z61 = new_n155_ | ~x2 | ~x3 | ~x0 | x1;
