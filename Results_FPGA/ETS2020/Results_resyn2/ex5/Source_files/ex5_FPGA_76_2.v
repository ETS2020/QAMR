// Benchmark "FAU" written by ABC on Wed Jul 29 11:56:36 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n78_, new_n81_, new_n83_, new_n84_, new_n86_, new_n93_,
  ...
  assign z20 = ~x3 & ~x6 & ~x4 & new_n93_ & ~x2 & ~x5;
  assign new_n93_ = x0 & ~x1;
  assign z21 = ~x4 & new_n93_ & ~x2 & ~x5 & x3 & ~x6;
  assign z22 = new_n84_ & ~x4 & ~x5 & x0 & ~x1 & ~x2;
  assign z24 = new_n97_ & new_n78_ & ~x3;
  assign new_n97_ = ~x0 & ~x5 & ~x4 & ~x1 & ~x2;
  ...
  assign new_n107_ = (~x3 | x6) & ((x3 & (~x7 | (x1 & x2))) | (x0 & ~x1 & ~x2 & (~x6 | x7)));
  ...
  assign new_n115_ = (x5 | ~x0 | x1 | x2) & (x4 | (~x5 & (~x2 | (~x0 & (x1 | x3)))));
  ...
  assign new_n123_ = ~new_n124_ & new_n125_ & (~x5 | (~x7 & x3 & ~x6));
  ...
  assign z47 = (new_n154_ | x0) & (~new_n86_ | ~x0 | ~x1 | ~x2 | ~x3);
  assign new_n154_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x1 | x2 | x4 | x5 | ~x6 | ~x7);
  assign z48 = (~new_n81_ & new_n156_) | ~new_n143_ | x1 | x2;
  ...
  assign new_n162_ = x6 & x7 & (~x3 | ~x0 | x1 | x2);
  assign new_n163_ = (x5 | ~x6) & ((~new_n93_ & x3) | x2 | x5);
  ...
  assign new_n176_ = (x4 | (~new_n78_ & (x2 | ~x5))) & (x1 | x3) & ((~x2 & ~x3) | (~x4 & x5));
  assign new_n177_ = (new_n178_ | x4) & (x1 | x2 | x3);
  assign new_n178_ = (~x5 | (x6 & x7)) & (~x2 | ~x6 | ~x3 | ~x1 | x5);
  assign new_n179_ = (~x1 | ((x2 | ~x4) & (x5 | ((x2 | x6) & (x4 | ~x6 | ~x7))))) & (x2 | ~x5 | x6 | x1 | x4);
  assign z58 = new_n184_ | ((new_n181_ | new_n183_) & ~x4);
  assign new_n181_ = ~new_n182_ & ~x5 & (~x1 | x0 | x6);
  assign new_n182_ = (~x0 | x1 | ~x7 | (x2 & ~x3)) & x6 & (~x3 | (x7 & (~x1 | ~x2)));
  assign new_n183_ = (~new_n162_ | ~x0) & (x5 | (~x0 & x2 & x6));
  assign new_n184_ = (~x1 | ~x2 | x0 | ~x3) & ((~x3 & ((x1 & ~x5) | x0 | (~x1 & ~x2))) | x4 | (x3 & (x1 | x2) & (~x1 | ~x2) & (~x2 | x5)));
  assign z59 = (x3 & (~new_n190_ | (~new_n189_ & ~x5))) | ~new_n187_ | (~new_n186_ & ~x3);
  assign new_n186_ = ((x0 & (~new_n84_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
  assign new_n187_ = new_n188_ & (~x6 | x2 | ~x0 | x1) & (~x4 | (x0 & x2) | (~x2 & (~x0 | x1)));
  ...
  assign z61 = new_n156_ | ~new_n93_ | ~x2 | ~x3;
