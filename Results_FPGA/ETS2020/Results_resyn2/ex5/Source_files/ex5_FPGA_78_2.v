// Benchmark "FAU" written by ABC on Wed Jul 29 11:56:37 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n97_, new_n99_, new_n104_, new_n106_, new_n107_, new_n108_,
  ...
  assign z06 = new_n80_ & x3 & ~x4 & ~x5;
  assign new_n80_ = ~x0 & ~x1 & x2 & ~x6;
  ...
  assign z22 = x0 & ~x1 & ~x2 & new_n85_ & ~x4 & ~x5;
  assign z24 = new_n97_ & new_n78_ & ~x4 & ~x5;
  ...
  assign new_n126_ = (x5 | (x6 & (x1 | ~x3 | ~x2 | ~x6 | ~x7))) & (~x2 | x3) & (~x6 | x7);
  ...
  assign z42 = ~new_n138_ | (x0 & (new_n84_ | (new_n140_ & x7)));
  ...
  assign new_n148_ = (~x0 | x4 | x5 | ~x6 | ~x7) & (~x0 | x3) & (x0 | ~x4);
  assign new_n149_ = new_n150_ & (x1 | (~x5 & (~new_n85_ | x4)));
  assign new_n150_ = (x0 | x5 | x4 | ~x6) & (x3 | (~x0 & x1));
  assign new_n151_ = ~new_n152_ & (~x0 | (~new_n74_ & (~new_n140_ | ~x7)));
  assign new_n152_ = x4 & (x0 | (x2 & ~x5 & ~x1 & x3));
  assign z47 = ~new_n156_ | (~new_n154_ & ~new_n155_ & ~x4);
  assign new_n154_ = ((~x2 & ~x5) | (x0 & (~x3 | ((x1 | x2) & x5)))) & new_n85_ & (x5 | x2 | ~x0 | x1);
  assign new_n155_ = ((~x2 & ~x3) | ~x6) & x1 & ~x0 & ~x5;
  assign new_n156_ = (x2 | ((~x4 | (x0 & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (x1 | ~x2 | (x3 & ~x4 & ~x5)) & (x2 | ~x1 | x5) & (~x0 | (~x4 & (~x2 | x3)));
  assign z48 = (~new_n82_ & new_n158_) | ~new_n143_ | x1 | x2;
  assign new_n158_ = ~x4 & (x5 | x6);
  assign z49 = (~new_n74_ & ~x4) | (x3 & x4) | ~x2 | x0 | x1;
  assign z51 = ~new_n161_ & ((~new_n74_ & ~x4) | ~new_n143_ | x1 | (x2 & x4));
  assign new_n161_ = (~new_n158_ | (new_n82_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  ...
  assign new_n165_ = (x5 | ~x6) & (x2 | x5 | ((~x0 | x1) & x3));
  assign new_n166_ = ((~x2 & ~x4 & (x0 | (~x3 & x5))) | x1 | (x2 & (~x0 ^ ~x3))) & (x2 | ~x4 | ~x1 | x3) & (~x2 | (x0 ^ ~x3) | (x5 & x3 & ~x4));
  assign z54 = new_n168_ | ~new_n171_ | (~new_n170_ & new_n172_);
  assign new_n168_ = ~x1 & ((~new_n169_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n169_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7);
  assign new_n170_ = ((x5 & (~new_n85_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n171_ = (~x0 | (~x4 & (~new_n140_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n172_ = ~x0 & ((~x1 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n176_ & ~x1) | new_n174_ | (~new_n175_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n174_ = x0 & (x2 | ~x3) & (~new_n158_ | ~x2);
  assign new_n175_ = (~x2 | x1 | x3) & new_n82_ & x0 & (x2 | ~x3);
  assign new_n176_ = ((x3 & ~x4) | (x0 & x2)) & (x0 | x2) & (~x2 | ~x3 | ~x5);
  assign z57 = (x0 & (new_n181_ | ~x3)) | ~new_n179_ | (~new_n178_ & ~x0);
  assign new_n178_ = (x4 | (~new_n78_ & (x2 | ~x5))) & (x1 | x3) & ((~x2 & ~x3) | (~x4 & x5));
  ...
  assign z59 = (x3 & (~new_n191_ | (~new_n190_ & ~x5))) | ~new_n188_ | (~new_n187_ & ~x3);
  assign new_n187_ = ((x0 & (~new_n85_ | x4)) | x5 | ~x1 | ~x2) & (x2 | ~x4) & (~x0 | (x1 & x2));
  assign new_n188_ = new_n189_ & (~x6 | x2 | ~x0 | x1) & (~x4 | (x0 & x2) | (~x2 & (~x0 | x1)));
  assign new_n189_ = (x7 | (x0 & (x4 | ~x6))) & (x4 | (~x5 & (x0 | x6)));
  assign new_n190_ = (x0 | ~x2) & (x4 | ((~x1 | ~x2 | ~x6) & (~x0 | x1 | (x2 ? (~x6 | ~x7) : x6))));
  assign new_n191_ = (~x1 | (~x4 & x6)) & (~x4 | x0 | x2);
  assign z60 = (~new_n87_ | x0 | x1 | (~x2 ^ ~x3)) & (~x0 | ~x4 | ~x1 | x3);
  assign z61 = new_n158_ | ~x0 | x1 | ~x2 | ~x3;
