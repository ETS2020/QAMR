...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n78_, new_n81_, new_n83_, new_n84_, new_n92_, new_n97_,
  ...
  assign z11 = x1 & ~x2 & new_n83_ & x0 & ~x3;
  assign z12 = ~x1 & x2 & new_n83_ & x0 & ~x3;
  assign z13 = ~x2 & ~x0 & x1 & new_n81_ & x3 & ~x4;
  assign z14 = new_n83_ & x0 & ~x1 & ~x2 & x3;
  assign z15 = x2 & ~x0 & x1 & new_n81_ & x3 & ~x4;
  assign z18 = x4 & ~x5 & ~x1 & x3 & ~x0 & x2;
  assign z20 = new_n92_ & x0 & ~x4 & ~x5 & ~x3 & ~x6;
  assign new_n92_ = ~x1 & ~x2;
  assign z21 = new_n74_ & ~x4 & x0 & ~x1 & ~x2 & x3;
  assign z22 = new_n92_ & x0 & new_n84_ & ~x4 & ~x5;
  assign z24 = new_n78_ & ~x3 & new_n92_ & ~x4 & ~x0 & ~x5;
  assign z25 = new_n97_ & ~x2 & ~x0 & x1;
  assign new_n97_ = ~x3 & ~x4 & ~x7 & ~x5 & x6;
  assign z26 = new_n84_ & ~x5 & ~x3 & ~x4 & x0 & x2;
  assign z27 = new_n97_ & x2 & ~x0 & x1;
  assign z30 = new_n101_ & x0 & x1;
  assign new_n101_ = x2 & ~x3 & new_n84_ & ~x4 & ~x5;
  assign z31 = new_n103_ | x1;
  assign new_n103_ = ((~x0 & (x2 | x3) & (~x5 | ~x2 | ~x3)) | ~x4 | (x0 & x2) | (~x2 & ~x5)) & (~x0 | x4 | x5 | x2 | x6);
  ...
  assign z33 = (~x5 & x1 & x3) | ~new_n110_ | (~x1 & x5) | ~x0 | ~x7;
  ...
  assign new_n118_ = (~x0 | ((~x2 | x3) & (x5 | x1 | x2))) & (x4 | (x0 & ~x1 & x2));
  assign new_n119_ = x0 ? ((~x2 | x3) & (~x7 | ~x1 | ~x3)) : ~x1;
  assign z38 = ~new_n105_ | (~x2 & (new_n108_ | (x1 & ~x5)));
  assign z39 = (~new_n122_ & x0) | new_n123_ | ~new_n125_ | (~new_n124_ & ~x0 & ~x5);
  assign new_n122_ = (x5 | (x6 & (~x2 | ~x3 | x1 | ~x6 | ~x7))) & (~x6 | x7) & (~x2 | x3);
  assign new_n123_ = x1 & ((~x2 & ~x5) | (x3 & x0 & x7));
  assign new_n124_ = x1 & ~x2 & x6;
  assign new_n125_ = ~x4 & (~x5 | (~x6 & ~x7 & (x3 | x6)));
  assign z40 = (~new_n127_ & (new_n128_ | x1)) | ((new_n129_ | ~new_n130_) & ~x5);
  assign new_n127_ = ~new_n78_ & x0 & ~x4 & ~x5;
  assign new_n128_ = ((~x4 & (x5 | x7)) | (~x2 & x4) | x0 | (x2 & ~x3)) & (~x4 | x2 | (~x0 & x3));
  assign new_n129_ = ~x4 & ((~x0 & (~x6 | (x3 & ~x7))) | (x3 & (x1 | (x0 & x6))));
  assign new_n130_ = (~x1 | x2) & (~x0 | ((x2 | ~x6 | ~x7) & (x2 | ~x4) & (~x2 | x6)));
  assign z41 = (~x4 & (~new_n135_ | (~new_n132_ & x0))) | ~new_n134_ | new_n136_;
  assign new_n132_ = (~new_n133_ | ~x5) & (~new_n92_ | ~new_n84_ | x5);
  ...
  assign z42 = ~new_n138_ | (x0 & (new_n101_ | (new_n133_ & x7)));
  assign new_n138_ = new_n139_ & ((x0 & (~x1 | x2)) | x5 | (x2 & ~x6));
  assign new_n139_ = ~x4 & (x5 | x6) & (~x0 | ~x6 | x7) & (~x5 | (~x6 & ~x7));
  assign z43 = (~new_n143_ & ~x4) | ~new_n141_ | (x4 & (x1 | (~new_n142_ ^ ~x2)));
  ...
  assign new_n150_ = ~new_n151_ & (~x0 | (~new_n74_ & (~new_n133_ | ~x7)));
  assign new_n151_ = x4 & (x0 | (~x1 & x3 & x2 & ~x5));
  assign z47 = (new_n153_ | x0) & (~new_n83_ | ~x2 | ~x3 | ~x0 | ~x1);
  assign new_n153_ = (~x1 | ~x2 | (~x4 & (x5 | x6))) & (x1 | x2 | ~x6 | ~x7 | x4 | x5);
  assign z48 = ~new_n92_ | ~new_n142_ | (~new_n81_ & new_n155_);
  assign new_n155_ = ~x4 & (x5 | x6);
  assign z51 = ~new_n157_ & ((~new_n74_ & ~x4) | ~new_n142_ | x1 | (x2 & x4));
  assign new_n157_ = (~new_n155_ | (new_n81_ & ~x2)) & x1 & x0 & (x2 | ~x3);
  ...
  assign new_n162_ = ((x1 & (~x0 | x3) & (x0 | ~x3)) | ~x2 | (~x4 & x5 & ~x0 & x3)) & ((~x4 & (x0 | x1 | (~x3 & x5))) | x2 | (x1 & x3));
  assign z54 = new_n164_ | ~new_n167_ | (~new_n166_ & new_n168_);
  assign new_n164_ = ~x1 & ((~new_n165_ & ~x4) | (~x2 & ~x3) | (x5 & x2 & x3));
  assign new_n165_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7);
  assign new_n166_ = ((x5 & (~new_n84_ | x2)) | ~x1 | (~x2 & (x4 | ~x5))) & ~x3 & (~x2 | ~x4);
  assign new_n167_ = (~x0 | (~x4 & (~new_n133_ | ~x7))) & (x4 | (x5 ? (x6 & x7) : (~x0 & ~x6)));
  assign new_n168_ = ~x0 & ((~x1 & x4 & ~x5) | ~x3 | (~x2 & (x4 | ~x5)));
  assign z55 = (~new_n172_ & ~x1) | new_n170_ | (~new_n171_ & ~x4 & (~new_n74_ | ~x1));
  assign new_n170_ = x0 & (x2 | ~x3) & (~new_n155_ | ~x2);
  assign new_n171_ = (~x2 | x1 | x3) & new_n81_ & x0 & (x2 | ~x3);
  assign new_n172_ = ((x0 & x2) | (x3 & ~x4)) & (x0 | x2) & (~x5 | ~x2 | ~x3);
  ...
  assign new_n180_ = ((x2 & ~x3) | ~x0 | x1 | ~x6 | ~x7) & ((x7 & (~x1 | ~x2)) | ~x3 | ~x6) & (x6 | (~x0 & x1));
  ...
  assign z60 = (~new_n83_ | x0 | x1 | (~x2 ^ ~x3)) & (~x0 | ~x4 | ~x1 | x3);
