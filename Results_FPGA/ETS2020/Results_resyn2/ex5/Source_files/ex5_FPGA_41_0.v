...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n81_, new_n83_, new_n85_, new_n86_, new_n87_, new_n89_,
    new_n93_, new_n97_, new_n99_, new_n105_, new_n110_, new_n111_,
  ...
  assign z09 = new_n83_ & ~x0 & ~x1 & x2 & ~x3;
  assign new_n83_ = ~x4 & x7 & ~x5 & x6;
  assign z10 = new_n85_ & new_n87_ & x2;
  assign new_n85_ = new_n86_ & ~x4 & x5;
  assign new_n86_ = x6 & x7;
  assign new_n87_ = ~x0 & x1;
  assign z12 = new_n89_ & x2 & new_n85_ & ~x3;
  assign new_n89_ = x0 & ~x1;
  assign z14 = new_n89_ & ~x2 & new_n86_ & ~x4 & x3 & x5;
  assign z15 = new_n87_ & x2 & new_n86_ & ~x4 & x3 & x5;
  assign z16 = new_n85_ & new_n93_ & x0 & ~x2;
  ...
  assign z21 = x0 & ~x1 & ~x2 & new_n74_ & x3 & ~x4;
  ...
  assign z28 = new_n89_ & x2 & new_n83_ & x3;
  ...
  assign z34 = (~new_n99_ | (~x4 & (~x6 | ~x7))) & (new_n116_ | x4 | x7);
  assign new_n116_ = (~x3 | ~x5 | x6) & (x0 | x5 | x1 | ~x2 | x3 | ~x6);
  assign z35 = ~x4 | (x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (~x2 | x3)) | (~x0 & ((x2 ^ x3) | (~x1 & x2 & ~x5)));
  assign z36 = (~new_n99_ & (new_n121_ | x4)) | (~x4 & (~new_n119_ | (~new_n122_ & x0)));
  assign new_n119_ = (x6 ? (~x3 | x7) : x1) & new_n120_ & (x0 | ~x7);
  assign new_n120_ = (x2 | x3) & ~x5;
  assign new_n121_ = (x1 | (x0 & x2)) & (~x0 | ((x2 | x3) & (x7 | ~x1 | ~x3)));
  assign new_n122_ = x6 & (x1 | x2 | ~x7);
  assign z37 = (~new_n126_ & (new_n125_ | ~x0)) | (x0 & (~new_n124_ | (~new_n127_ & x3)));
  assign new_n124_ = (~new_n86_ | x1 | x2 | x5) & (~x4 | (~x2 & (x1 | x2 | x5)));
  assign new_n125_ = (x2 | (x1 & x3) | (~x1 & (~x3 | ~x5))) & (~x3 | (~x4 & ~x6) | (x1 & x4) | (~x1 & x5));
  assign new_n126_ = x6 & ~x7 & x3 & ~x4 & ~x5;
  ...
  assign new_n133_ = (x7 | ~x5 | x6) & (~x7 | (x2 & ~x3) | ~new_n89_ | x5 | ~x6);
  ...
  assign new_n143_ = (~x3 | ((x1 | ~x0 | x2) & (~x2 | x5))) & (x5 | x2 | ~x0 | x1) & new_n86_ & (x0 | (~x2 & ~x5));
  ...
  assign z50 = (~new_n93_ & x0) | x2 | x5 | ~new_n86_ | x4;
  assign z52 = (x3 & (x0 | (x2 & x4))) | (~new_n74_ & ~x4) | (~x0 & x1) | (~x3 & ~x1 & ~x2);
  assign z53 = new_n152_ | (~x4 & (~new_n151_ | (~new_n150_ & x5)));
  assign new_n150_ = new_n86_ & ((x0 ? x2 : ~x1) | ((~x0 | ~x1) & ~x2 & ~x3));
  assign new_n151_ = (x5 | ~x6) & (x2 | x5 | (~new_n89_ & x3));
  assign new_n152_ = (~x1 | ((~x0 | ~x3) & (x2 | (~x3 & x4)))) & ((~x2 & (x4 | (~x0 & (x3 | ~x5)))) | (x0 & x2) | ((x4 | ~x3 | ~x5) & x2 & (~x1 | x3)));
  assign z54 = ~new_n155_ | new_n157_ | (~new_n154_ & ~x0);
  assign new_n154_ = (x3 | ((~x2 | ~x4) & (~x1 | (x2 ? x5 : (~new_n86_ | x4 | ~x5))))) & ((x2 & (~x4 | x5)) | (x1 & x2) | ~x3 | (~x4 & x5));
  assign new_n155_ = (~new_n156_ | x1) & (~x0 | (~x4 & (~x7 | ~x1 | ~x3)));
  assign new_n156_ = (~x2 | x5) & (x2 ^ ~x3);
  assign new_n157_ = ~x4 & ((~x1 & ((~x5 & ~x6) | (x5 & x6 & x0 & x7))) | (~x5 & (x0 | x6)) | (x5 & (~x6 | ~x7)));
  assign z56 = (~x4 & (~new_n159_ | new_n164_)) | (x0 & x4) | (~new_n162_ & ~new_n165_);
  assign new_n159_ = (new_n160_ | ~x6) & ~new_n161_ & (new_n87_ | x6) & (~x5 | (x6 & x7));
  ...
  assign new_n164_ = (x0 | x1) & ~x2 & (~x0 | x3) & (~x0 | ~x1) & (x0 | x5);
  assign new_n165_ = (~x1 | ~x2 | x5) & ~x0 & ~x4 & ~x3 & (x1 | x2);
  assign z59 = (x3 & (~new_n172_ | (~new_n171_ & ~x5))) | ~new_n168_ | (~new_n167_ & ~x3);
  assign new_n167_ = (~x0 | (x1 & (~new_n86_ | ~x2 | x4 | x5))) & (x5 | ~x2 | x0 | ~x1) & (x2 | (~x0 & ~x4));
