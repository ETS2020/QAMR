// Benchmark "FAU" written by ABC on Wed Jul 29 03:30:14 2020
...
module FAU ( 
  ...
  assign z09 = new_n62_ & (new_n61_ | (new_n60_ & x20 & ~x15 & ~x16));
  assign new_n60_ = ~x13 & ~x14 & ~x11 & x12 & ~x01 & x02;
  assign new_n61_ = x18 & ~x19 & x01 & ~x20;
  assign new_n62_ = ~x22 & ~x00 & ~x21;
  assign z10 = ~x00 & ((new_n60_ & new_n64_) | (new_n61_ & x21 & x22));
