// Benchmark "FAU" written by ABC on Wed Jul 29 03:30:36 2020
...
module FAU ( 
  ...
  assign z09 = new_n59_ & (new_n58_ | (new_n57_ & x20 & ~x15 & ~x16));
  assign new_n57_ = ~x01 & x02 & ~x13 & ~x14 & ~x11 & x12;
  assign new_n58_ = x18 & ~x19 & x01 & ~x20;
  assign new_n59_ = ~x22 & ~x00 & ~x21;
  assign z10 = ~x00 & ((new_n57_ & new_n61_) | (new_n58_ & x21 & x22));
  assign new_n61_ = x15 & x16 & ~x22 & x20 & ~x21;
