...
module FAU ( 
  ...
  assign z09 = new_n60_ & (new_n59_ | (new_n58_ & x20 & ~x15 & ~x16));
  assign new_n58_ = ~x01 & x02 & ~x13 & ~x14 & ~x11 & x12;
  assign new_n59_ = x18 & ~x19 & x01 & ~x20;
  assign new_n60_ = ~x22 & ~x00 & ~x21;
  assign z10 = ~x00 & ((new_n58_ & new_n62_) | (new_n59_ & x21 & x22));
