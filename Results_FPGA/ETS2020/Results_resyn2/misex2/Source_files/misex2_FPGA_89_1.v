// Benchmark "FAU" written by ABC on Wed Jul 29 03:30:28 2020
...
module FAU ( 
  ...
  assign z06 = x00 & x01 & x02 & x10 & ~x09 & x11;
  ...
  assign z12 = x09 & ~x24 & (new_n64_ | new_n65_);
  assign new_n64_ = x00 & x01 & (~x02 | ~x10);
