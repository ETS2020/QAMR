...
module FAU ( 
  ...
  assign z12 = (new_n57_ | new_n58_) & x09 & ~x24;
  assign new_n57_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign new_n58_ = x00 & x01 & (~x02 | ~x10);
  assign z13 = new_n60_ & x17;
  assign new_n60_ = ~x02 & ~x19 & ~x00 & ~x01;
  assign z14 = new_n60_ & ~x09 & ~x10 & ~x17 & ~x18;
