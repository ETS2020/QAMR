// Benchmark "FAU" written by ABC on Wed Jul 29 03:30:15 2020
...
module FAU ( 
  ...
  assign z04 = x01 & x00 & x02 & new_n52_ & x10 & ~x11;
  assign new_n52_ = ~x09 & ~x12;
  assign z07 = x00 & x02 & (~x01 | (new_n52_ & x10 & x11));
  assign z08 = new_n55_ & z17 & x19 & x17 & ~x18;
  assign new_n55_ = ~x07 & ~x08 & ~x05 & ~x06 & ~x03 & x04;
  assign z17 = x02 & ~x00 & ~x01;
  assign z11 = (new_n60_ | (new_n58_ & new_n59_)) & ~x00 & ~x22;
  assign new_n58_ = x15 & ~x16 & x20 & ~x21;
  assign new_n59_ = ~x01 & x02 & ~x13 & ~x14 & ~x11 & x12;
  assign new_n60_ = x01 & x18 & x21 & ~x19 & ~x20;
  assign z12 = new_n63_ & ((~new_n62_ & ~x00 & ~x01) | ((~x02 | ~x10) & x00 & x01));
  assign new_n62_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n63_ = x09 & ~x24;
