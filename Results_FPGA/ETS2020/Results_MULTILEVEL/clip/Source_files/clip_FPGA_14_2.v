// Benchmark "FAU" written by ABC on Wed Aug  5 00:20:06 2020
...
module FAU ( 
  ...
  assign z3 = x0 ? (~new_n57_ | (~new_n64_ & ~x3)) : (new_n61_ | ~new_n65_);
  assign new_n57_ = x6 ? (new_n60_ | ~x8) : ((new_n59_ | x5) & (new_n58_ | x8));
  assign new_n58_ = (x1 | (x4 & x7)) & (x4 | x7) & (x2 | (x7 & (x4 | ~x5)));
  assign new_n59_ = (~x4 | (~x2 & ~x7) | (~x3 & ~x8)) & (~x2 | ~x7 | ~x8) & (~x3 | (~x8 & (~x1 | ~x7)));
  assign new_n60_ = (x4 | ~x7) & ((x1 & ~x2) | (x4 & ~x7));
  assign new_n61_ = x1 & (x2 ? (new_n63_ & ~x6) : (~x5 & new_n62_ & x6));
  assign new_n62_ = (~x4 ^ x7) & (x3 | (~x3 & ~x8));
  assign new_n63_ = (x3 | x8) & (x4 | x7);
  assign new_n64_ = (~x2 | (x7 ? x8 : x4)) & (x2 | (x7 ? x4 : x6)) & (x6 | (x8 & (x1 | x7))) & (~x6 | ~x8) & (x1 | (x4 & (~x7 | x8)));
  assign new_n65_ = (~x4 | ((~x3 | ((x6 | ~x7) & (x7 | ~x8 | x5 | ~x6))) & (x6 | ~x7 | ~x8) & (x3 | x5 | ~x6 | x7 | x8))) & (~x3 | ((x6 | ~x8) & (x5 | ~x6 | x8)));
  assign z4 = 1'b0;
endmodule
