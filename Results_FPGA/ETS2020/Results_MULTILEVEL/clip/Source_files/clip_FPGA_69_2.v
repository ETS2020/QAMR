// Benchmark "FAU" written by ABC on Wed Aug  5 00:20:24 2020
...
module FAU ( 
  ...
  assign z2 = (~new_n33_ & ~x8) | (~new_n40_ & x8) | (x0 & new_n47_ & x3);
  ...
  assign new_n40_ = (new_n44_ | x3) & ~new_n41_ & (~x3 | (~new_n46_ & (~new_n45_ | ~x1)));
  assign new_n41_ = ~x6 & (~new_n43_ | (new_n42_ & x2));
  assign new_n42_ = (x4 | x7) & ((x0 & ~x5) | (x1 & x3));
  assign new_n43_ = (~x0 | x5 | (~x3 & (~x4 | ~x7))) & (~x3 | ~x4 | ~x7);
  assign new_n44_ = (~x2 | (x7 ? ~x6 : x4)) & (x2 | (x7 ? x4 : x6)) & (x1 | (x4 & (~x6 | ~x7) & (x6 | x7)));
  assign new_n45_ = ~x2 & ((x0 & (x7 ? x4 : x6)) | (~x5 & x6 & (x4 | ~x7)));
  assign new_n46_ = x4 & x6 & ~x7 & (x0 | (~x0 & ~x5));
  assign new_n47_ = ~x5 & ~x6 & ((x4 & (x2 | x7)) | (x1 & x7));
  assign z3 = x0 ? (~new_n49_ | (~new_n56_ & ~x3)) : (new_n53_ | ~new_n57_);
  assign new_n49_ = x6 ? (new_n52_ | ~x8) : ((new_n51_ | x5) & (new_n50_ | x8));
  assign new_n50_ = (x1 | (x4 & x7)) & (x4 | x7) & (x2 | (x7 & (x4 | ~x5)));
  assign new_n51_ = (~x4 | (~x2 & ~x7) | (~x3 & ~x8)) & (~x3 | (~x8 & (~x1 | ~x7))) & (~x2 | ~x7 | ~x8);
  assign new_n52_ = (x4 | ~x7) & ((x4 & ~x7) | (x1 & ~x2));
  assign new_n53_ = x1 & (x2 ? (new_n55_ & ~x6) : (~x5 & new_n54_ & x6));
  assign new_n54_ = (~x4 ^ x7) & (x3 | (~x3 & ~x8));
  assign new_n55_ = (x3 | x8) & (x4 | x7);
  assign new_n56_ = (~x2 | (x7 ? x8 : x4)) & (x2 | (x7 ? x4 : x6)) & (x6 | (x8 & (x1 | x7))) & (~x6 | ~x8) & (x1 | (x4 & (~x7 | x8)));
  assign new_n57_ = (~x4 | ((~x3 | ((x6 | ~x7) & (x7 | ~x8 | x5 | ~x6))) & (x6 | ~x7 | ~x8) & (x3 | x5 | ~x6 | x7 | x8))) & (~x3 | ((x6 | ~x8) & (x5 | ~x6 | x8)));
  assign z0 = 1'b0;
  assign z4 = 1'b0;
endmodule
