...
module FAU ( 
  ...
  assign z3 = x0 ? (~new_n25_ | (~new_n33_ & ~x3)) : ~new_n29_;
  ...
  assign new_n29_ = new_n32_ & (~x1 | (x2 ? (~new_n31_ | x6) : ~new_n30_));
  assign new_n30_ = ~x5 & x6 & (~x4 ^ x7) & (x3 | (~x3 & ~x8));
  assign new_n31_ = (x3 | x8) & (x4 | x7);
  assign new_n32_ = (~x4 | ((~x3 | ((x6 | ~x7) & (x7 | ~x8 | x5 | ~x6))) & (x6 | ~x7 | ~x8) & (x3 | x5 | ~x6 | x7 | x8))) & (~x3 | ((x6 | ~x8) & (x5 | ~x6 | x8)));
  assign new_n33_ = (~x2 | (x7 ? x8 : x4)) & (x2 | (x7 ? x4 : x6)) & (x6 | (x8 & (x1 | x7))) & (~x6 | ~x8) & (x1 | (x4 & (~x7 | x8)));
  assign z1 = 1'b0;
  assign z2 = 1'b0;
  assign z4 = 1'b0;
endmodule
