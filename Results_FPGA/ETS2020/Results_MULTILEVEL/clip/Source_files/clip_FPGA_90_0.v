...
module FAU ( 
  ...
  assign z4 = (x5 & (new_n51_ | new_n49_ | ~x0 | x6)) | (~x0 & ~x5 & ~new_n52_ & x6);
  assign new_n49_ = ~x8 & (~new_n50_ | (~x1 & (~x7 | (x0 & ~x4 & x7))));
  assign new_n50_ = (x2 | x7) & (~x0 | x4 | (x2 ? (~x3 | x7) : x6));
  assign new_n51_ = ~x3 & ((x1 & ~x2 & (x7 ? ~x4 : x8)) | (~x1 & (x4 ? (~x7 & x8) : x7)) | ~x8 | (~x4 & ~x7));
  assign new_n52_ = (~x1 | x2 | (x4 ^ x7) | (~x3 & (x3 | x8))) & (~x3 | (x8 & (~x4 | x7 | ~x8))) & (x7 | x8 | x3 | ~x4);
  assign z0 = 1'b0;
  assign z3 = 1'b0;
endmodule
