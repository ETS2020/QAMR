// Benchmark "FAU" written by ABC on Fri Aug  7 04:27:30 2020
...
module FAU ( 
  ...
  assign new_n427_ = new_n428_ & ~x05 & ~x06 & new_n429_ & ~x07 & ~x08;
  assign new_n428_ = ~x02 & ~x03;
  assign new_n429_ = ~x10 & ~x11 & ~x12;
  assign z09 = (new_n471_ & x03) | (~x13 & (~new_n453_ | (~new_n431_ & x06)));
  assign new_n431_ = ~new_n445_ & ~new_n451_ & (~x04 | (~new_n432_ & ~new_n442_ & ~new_n450_));
  assign new_n432_ = x11 & ((~new_n433_ & ~x03) | new_n440_ | (new_n437_ & x00));
  assign new_n433_ = (~x00 | ~new_n436_ | x05) & (~x05 | ((new_n434_ | ~x07) & (~new_n435_ | ~x00)));
  assign new_n434_ = (~x00 | ~x02 | x08 | ~x12) & (x02 | ~x08 | x09 | x10 | x12);
  assign new_n435_ = x02 & ~x07 & x12 & (x08 | x09);
  assign new_n436_ = x12 & (x08 ? (x10 ? ~x09 : ~x07) : (x09 & x10));
  assign new_n437_ = x12 & (new_n439_ | (new_n438_ & x03));
  assign new_n438_ = (x02 ? ~x01 : x05) & (x07 ? ~x08 : (x08 | x09));
  assign new_n439_ = ~x01 & x02 & x08 & ~x09 & x10;
  assign new_n440_ = new_n194_ & ~x05 & ~x07 & new_n441_ & x10 & ~x12;
  assign new_n441_ = ~x08 & x09;
  assign new_n442_ = x00 & x12 & (new_n443_ | (~x07 & new_n444_ & x08));
  assign new_n443_ = ~new_n412_ & ((x02 & (x03 ? ~x01 : x05)) | (~x03 & ~x05) | (~x02 & x03 & x05));
  assign new_n444_ = x10 & ((~x01 & x03 & (x02 | (x05 & x09))) | (~x03 & (x05 ? x02 : x09)));
  assign new_n445_ = x03 & ~x04 & (new_n446_ | (x00 & new_n449_ & x01));
  assign new_n446_ = x11 & ((new_n448_ & x00) | (new_n447_ & x02));
  assign new_n447_ = ~x05 & ~x12 & ((~x07 & ~x08 & x09 & x10) | (~x09 & ~x10 & x07 & x08));
  assign new_n448_ = x01 & x12 & (x08 ? (~x07 | (~x09 & x10)) : (x09 & x10));
  assign new_n449_ = x12 & (x09 ? (x08 ? (~x07 ^ ~x10) : ~x10) : (x10 & ~x11));
  assign new_n450_ = new_n441_ & new_n429_ & x05 & ~x07 & x02 & x03;
  assign new_n451_ = x00 & x01 & ~x02 & x05 & ~new_n452_ & x12;
  assign new_n452_ = (~x08 | ((x09 | ~x10 | ~x11) & (x07 | ((x03 | ~x11) & (~x09 | ~x10))))) & (x09 | ~x10 | x11) & (~x09 | ((~x07 | x10) & (x08 | (x10 & (~x10 | ~x11)))));
  assign new_n453_ = (x06 | (~new_n470_ & (new_n454_ | ~x07))) & (~x00 | ~new_n462_ | ~x07);
  assign new_n454_ = ~new_n460_ & (~x00 | ~x12 | (~new_n455_ & (new_n458_ | ~x10)));
  assign new_n455_ = x11 & (new_n457_ | (~new_n456_ & ~x09));
  assign new_n456_ = (~x01 | ((x02 | ~x05) & (~x03 | x04 | ~x08))) & (~x04 | ((~x02 | (x03 ? x01 : ~x05)) & (x02 | ~x03 | ~x05) & (x03 | x05 | ~x08)));
  assign new_n457_ = x04 & x10 & (x02 ? (x03 ? ~x01 : x05) : (x03 & x05));
  assign new_n458_ = (new_n459_ | ~x01) & (x03 | ~x04 | x05 | ~x09);
  assign new_n459_ = (~x03 | x04 | ~x08) & (x02 | ~x05 | ~x09);
  assign new_n460_ = new_n428_ & new_n461_ & new_n418_ & x10 & x11 & ~x12;
  assign new_n461_ = ~x04 & ~x05;
  assign new_n462_ = x12 & (new_n463_ | new_n468_ | (x10 & (new_n465_ | new_n467_)));
  assign new_n463_ = ~new_n464_ & ((x10 & ~x11) | (~x08 & ~x09 & x11));
  assign new_n464_ = (x03 | ~x04 | x05) & (~x01 | x02 | ~x05);
  assign new_n465_ = x03 & ((~new_n466_ & x04) | (x01 & ~x04 & (~x08 | (x08 & ~x11))));
  assign new_n466_ = (x02 | ~x05 | (x09 & x11)) & (x01 | ~x02 | x11);
  assign new_n467_ = x02 & ~x03 & x04 & ~new_n216_ & x05;
  assign new_n468_ = new_n469_ & x01 & new_n34_ & ~x08;
  assign new_n469_ = x03 & ~x04;
  assign new_n470_ = new_n428_ & new_n461_ & new_n429_ & ~x07 & ~x08;
  assign new_n471_ = ~x12 & ((new_n487_ & x01) | (x13 & (new_n482_ | (~new_n472_ & x01))));
  assign new_n472_ = (~x07 | (~new_n473_ & new_n476_)) & (~x08 | (~new_n481_ & (new_n480_ | x07)));
  assign new_n473_ = x05 & (new_n474_ | ~new_n475_);
  assign new_n474_ = ~x02 & ((~x09 & x10 & x11) | (x04 & (x10 ? ~x11 : x09)));
  assign new_n475_ = (~x09 | (x06 & (x04 | ~x06)) | (x08 & (~x08 | x10))) & (x04 | ~x10 | (x11 & (~x06 | x09)));
  assign new_n476_ = (~new_n479_ | x05) & (~x10 | (~new_n478_ & (new_n477_ | x05)));
  assign new_n477_ = x02 ? (~x04 | (x11 & (x08 | ~x11))) : (~x06 | (x11 & (x09 | ~x11)));
  assign new_n478_ = ~x02 & x06 & ~x08 & x09;
  assign new_n479_ = x09 & ~x10 & (x02 ? x04 : x06);
  assign new_n480_ = (~x04 | new_n165_ | (x02 ^ ~x05)) & (new_n83_ | ((x04 | ~x05) & (x02 | x05 | ~x06)));
  assign new_n481_ = x04 & ~x09 & x10 & (x02 ^ x05);
  assign new_n482_ = x02 & (new_n483_ | (new_n486_ & x05));
  assign new_n483_ = ~x01 & ((~new_n328_ & ~new_n484_) | (~x08 & ~new_n485_ & x10));
  assign new_n484_ = (~x08 | ((x09 | ~x10) & (x07 | (x09 ? ~x10 : ~x11)))) & (~x07 | (x10 ? x11 : ~x09));
  assign new_n485_ = (~x05 | ~x07) & (~x06 | ~x11 | ((x04 | ~x07) & (~x04 | x05 | x07 | ~x09)));
  assign new_n486_ = ~x06 & ((~x09 & x11 & ~x07 & x08) | (x10 & (x07 ? (~x09 | ~x11) : x08)));
  assign new_n487_ = x02 & ~new_n488_ & x06;
  assign new_n488_ = (x04 | ~new_n490_ | x05) & (~new_n441_ | ~new_n489_ | ~x04 | ~x05 | x07);
  assign new_n489_ = ~x10 & ~x11;
  assign new_n490_ = x11 & ((~x07 & ~x08 & x09 & x10) | (~x09 & ~x10 & x07 & x08));
  assign z10 = new_n499_ | (x11 & (new_n504_ | (x03 & (new_n492_ | new_n502_))));
  assign new_n492_ = x02 & ((~x04 & (new_n496_ | (~new_n493_ & x01))) | (~x01 & new_n497_ & x04));
  assign new_n493_ = ~new_n494_ & (~x07 | ~x08 | new_n495_ | x10);
  assign new_n494_ = ~x05 & x06 & ~x07 & new_n441_ & x10 & ~x12;
  assign new_n495_ = (x00 | ~x05 | ~x12 | x13 | (~x06 ^ x09)) & (x09 | x12 | x05 | ~x06);
  assign new_n496_ = ~x05 & x06 & ~x12 & ~new_n403_ & ~x13;
  assign new_n497_ = ~x05 & new_n498_ & x06;
  assign new_n498_ = x08 & ~x10 & ~x12 & x13 & (x07 ^ x09);
  assign new_n499_ = new_n500_ & new_n428_ & ~x05 & ~x06 & ~x07;
  assign new_n500_ = new_n501_ & ~x08 & ~x11 & ~x12 & ~x13;
  assign new_n501_ = ~x09 & ~x10;
  assign new_n502_ = ~x02 & x04 & ~x05 & new_n503_ & x06;
  assign new_n503_ = x08 & ~x10 & ~x12 & ~x13 & (x07 ^ x09);
  assign new_n504_ = ~x02 & ~x03 & x09 & x10 & new_n505_ & ~x12;
  assign new_n505_ = ~x13 & ((x04 & x05 & x06 & ~x07 & ~x08) | (~x04 & ~x05 & ~x06 & x07 & x08));
  assign z12 = new_n526_ | (x11 & (x03 ? ~new_n507_ : (~new_n520_ & ~x13)));
  assign new_n507_ = x02 ? (~new_n516_ & (new_n508_ | ~x07)) : ~new_n518_;
  assign new_n508_ = ~new_n513_ & (~x08 | (~new_n509_ & (~x06 | new_n515_ | x12)));
  assign new_n509_ = x01 & (new_n512_ | (x05 & (new_n511_ | (~new_n510_ & ~x13))));
  assign new_n510_ = (x00 | x04 | x10 | ~x12 | (~x06 ^ x09)) & (~x00 | ~x04 | ~x06 | ~x09 | ~x10);
  assign new_n511_ = x04 & x06 & x09 & x10 & ~x12;
  assign new_n512_ = ~x09 & ~x10 & ~x12 & ~x04 & ~x05 & x06;
  assign new_n513_ = ~x04 & ~x05 & new_n514_ & ~x06;
  assign new_n514_ = ~x08 & ~x09 & ~x10 & ~x12 & (~x01 | ~x13);
  assign new_n515_ = (~x04 | ((~x10 | x13 | ~x05 | ~x09) & (x01 | x05 | x09 | x10 | ~x13))) & (x04 | x05 | x09 | x10 | x13);
  assign new_n516_ = ~x05 & x06 & ~x07 & new_n517_ & x09;
  assign new_n517_ = ~x12 & ((~x01 & x04 & x13 & (x08 ^ x10)) | (~x04 & ~x08 & x10 & (x01 | ~x13)));
  assign new_n518_ = x04 & ~x05 & new_n519_ & x06;
  assign new_n519_ = ~x12 & ~x13 & ((~x09 & ~x10 & x07 & x08) | (~x07 & x09 & (x08 ^ x10)));
  assign new_n520_ = ~new_n523_ & (~x10 | (~new_n521_ & (x02 | ~new_n525_ | ~x09)));
  assign new_n521_ = new_n522_ & ~x00 & x01 & new_n461_ & x02;
  assign new_n522_ = x06 & ~x07 & ~x08 & ~x09 & x12;
  assign new_n523_ = new_n524_ & ~x02 & x04 & x05 & x06;
  assign new_n524_ = x07 & x08 & ~x09 & ~x10 & ~x12;
  assign new_n525_ = ~x12 & ((~x04 & ~x05 & ~x06 & x07 & x08) | (x04 & ((~x05 & ~x06 & x07 & x08) | (~x07 & ~x08 & x05 & x06))));
  assign new_n526_ = ~x07 & ~x08 & ~x10 & ~x11 & ~new_n527_ & ~x12;
  assign new_n527_ = (~x02 | ~new_n528_ | ~x03) & (x02 | x03 | x05 | x06 | x13);
  assign new_n528_ = x04 & x05 & x06 & x09 & (x01 | ~x13);
  assign z13 = (~new_n569_ & ~x12) | (~x13 & (~new_n546_ | (~new_n530_ & x12)));
  assign new_n530_ = (new_n531_ | ~x09) & ~new_n538_ & new_n542_ & ~new_n545_ & (new_n534_ | x09);
  assign new_n531_ = (new_n532_ | ~x06) & (x03 | (~new_n461_ & (x06 | x10))) & (x06 | new_n533_ | x10);
  assign new_n532_ = (x00 | (~new_n469_ & (~new_n178_ | ~x07 | ~x08))) & (x01 | ~x07 | ~new_n178_ | ~x08);
  assign new_n533_ = ~x00 & x02 & ~x04;
  assign new_n534_ = (new_n535_ | ~x00) & ~new_n537_ & (x00 | ~x03 | x04 | x06);
  assign new_n535_ = ~new_n536_ & (~x06 | ~x07 | ~x08 | x10);
  assign new_n536_ = x01 & x02 & x03 & x04 & x05;
  assign new_n537_ = ~x10 & ((~x07 & ~x08) | (x06 & x07 & x08 & (~x02 | ~x03)));
  assign new_n538_ = x03 & (new_n539_ | (~new_n541_ & x04) | (~x00 & ~x04 & x10));
  assign new_n539_ = ~new_n540_ & (~x07 | ~x08);
  assign new_n540_ = (x00 | x04) & (~x00 | ~x01 | ~x02 | ~x04 | ~x05);
  assign new_n541_ = (x01 | x02 | x05) & (~x00 | ~x01 | ~x02 | ~x05 | (new_n178_ & x06));
  assign new_n542_ = new_n543_ & (x01 | (x02 ? (x04 | x05) : (x03 | ~x05)));
  assign new_n543_ = (x06 | (~new_n489_ & x07)) & (x03 | new_n544_ | x04);
  assign new_n544_ = (x05 | (x02 & ~x07 & x11)) & (~x00 | ~x01 | ~x02);
  assign new_n545_ = ~x00 & (~x01 | (~x04 & ~x05 & x08));
  assign new_n546_ = (new_n547_ | ~x07) & (new_n567_ | x07) & (x12 | (~new_n557_ & ~new_n563_));
  assign new_n547_ = (new_n548_ | ~x10) & (new_n556_ | x10) & (~x04 | new_n553_ | ~x06);
  assign new_n548_ = (x02 | (~new_n549_ & ~new_n550_)) & ~new_n552_ & (x04 | (~new_n549_ & (~new_n551_ | ~x02)));
  assign new_n549_ = x06 & x08 & x09 & x11;
  assign new_n550_ = ~x03 & x05 & ~x12;
  assign new_n551_ = ~x05 & ~x12;
  assign new_n552_ = x06 & x08 & x09 & x11 & (~x03 | ~x05);
  assign new_n553_ = ~new_n555_ & (~x02 | (~new_n554_ & (~new_n501_ | ~x08)));
  assign new_n554_ = ~x11 & ~x12 & x03 & x05;
  assign new_n555_ = x09 & ~x12 & ~x02 & ~x05;
  assign new_n556_ = (x09 | x11) & (~new_n428_ | ~x09 | x12);
  assign new_n557_ = x02 & (new_n558_ | new_n559_ | (new_n562_ & ~x07 & x09));
  assign new_n558_ = ~x04 & ~x05 & (new_n35_ | new_n266_);
  assign new_n559_ = x04 & ((new_n561_ & x03) | (~new_n560_ & ~x07));
  assign new_n560_ = (x08 | ~x11) & (~x03 | ~x05 | ~x06 | ~x10);
  assign new_n561_ = x05 & x06 & (~x09 | (x11 & (~x08 | ~x10)));
  assign new_n562_ = ~x10 & x11;
  assign new_n563_ = ~x02 & (~new_n565_ | (~x07 & (new_n564_ | (~x03 & x08))));
  assign new_n564_ = x04 & ~x05 & (new_n34_ | (x08 & x10));
  assign new_n565_ = ~new_n566_ & (~new_n82_ | ~new_n154_);
  assign new_n566_ = ~x03 & ((x10 & ~x11) | (~x05 & ~x08 & x11));
  assign new_n567_ = x08 ? ~new_n489_ : new_n568_;
  assign new_n568_ = (~x03 | (x06 & (x09 | ~x11))) & (~x09 | ~x10 | x11) & (x09 | new_n461_ | ~x11);
  assign new_n569_ = (new_n570_ | x02) & (new_n574_ | ~x07) & new_n593_ & (new_n584_ | x07);
  assign new_n570_ = (x03 | (x04 ? (~x05 | x06) : ~x06)) & new_n572_ & (new_n571_ | x04);
  assign new_n571_ = x07 ? ~new_n501_ : ~new_n238_;
  assign new_n572_ = (new_n573_ | ~x05) & (x01 | ~x13) & (~x03 | x05 | x06);
  assign new_n573_ = (~x07 | ~x08 | ~x09 | ~x10 | ~x11) & (x07 | x10 | x11);
  assign new_n574_ = (new_n583_ | x03) & ~new_n575_ & new_n579_ & (new_n577_ | ~x01);
  assign new_n575_ = ~new_n576_ & ~x06;
  assign new_n576_ = (~x04 | x09 | x10) & (~x02 | ~x08 | ~x09 | ~x10 | ~x11);
  assign new_n577_ = (~new_n578_ | ~x02) & (x10 | ~x13 | ~x04 | x09);
  assign new_n578_ = x03 & ((~x04 & ~x05 & x09) | (x04 & x05 & x06 & ~x11));
  assign new_n579_ = ~new_n582_ & (~x13 | (~new_n581_ & (new_n580_ | ~x08)));
  assign new_n580_ = (x01 | ((~x09 | ~x10 | ~x11) & (x04 | x09 | x10))) & (~x09 | ~x10 | ~x11 | (x04 & x05));
  assign new_n581_ = ~x01 & x04 & ~x05 & x09;
  assign new_n582_ = x05 & ~x09 & ~x10 & (x02 | x03);
  assign new_n583_ = (x05 | x09 | x10) & (~x08 | ~x09 | ~x10 | ~x11 | ~x13);
  assign new_n584_ = ~new_n592_ & (new_n585_ | ~x01) & ~new_n587_ & ~new_n588_ & new_n590_;
  assign new_n585_ = ~new_n586_ & (~x13 | ((~new_n35_ | x05) & (~new_n238_ | ~x04)));
  assign new_n586_ = x02 & x03 & x08 & (x04 ? (x05 & x06) : ~x05);
  assign new_n587_ = ~x04 & ((new_n35_ & x06) | (~x01 & ~x08 & x13));
  assign new_n588_ = x13 & ((new_n489_ & ~x06) | (~x01 & (new_n489_ | new_n589_)));
  assign new_n589_ = x04 & ~x05 & ~x09;
  assign new_n590_ = (~x05 | new_n591_ | ~x11) & (x08 | ((x05 | ~x06 | x10) & (~x10 | x11)));
  assign new_n591_ = (~x03 | x08) & (~x09 | x10);
  assign new_n592_ = ~x03 & ((x09 & ~x10 & x13) | (x02 & ~x08));
  assign new_n593_ = ~new_n594_ & (new_n598_ | ~x06) & (~new_n501_ | x11 | ~x13);
  assign new_n594_ = ~x05 & ((new_n597_ & ~x01) | (~x04 & (new_n596_ | (~new_n595_ & x01))));
  assign new_n595_ = (x06 | ~x13) & (x09 | ~x10 | ~x02 | ~x03);
  assign new_n596_ = ~x06 & (x10 ? ~x09 : x08);
  assign new_n597_ = x13 & ((~x06 & x09) | (x04 & x10 & (x08 | ~x09)));
  assign new_n598_ = (x08 | (~new_n501_ & ~new_n599_)) & (~x01 | ~new_n600_ | ~x02);
  assign new_n599_ = x01 & x02 & x03 & x04 & x05 & x11;
  assign new_n600_ = x03 & x04 & x05 & (~x09 | (~x10 & x11));
  assign z11 = 1'b0;
endmodule
