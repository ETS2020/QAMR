// Benchmark "FAU" written by ABC on Fri Aug  7 04:26:18 2020
...
module FAU ( 
  ...
  assign new_n398_ = new_n399_ & ~x05 & ~x06 & new_n400_ & ~x07 & ~x08;
  assign new_n399_ = ~x02 & ~x03;
  assign new_n400_ = ~x10 & ~x11 & ~x12;
  assign z09 = (new_n442_ & x03) | (~x13 & (~new_n424_ | (~new_n402_ & x06)));
  assign new_n402_ = ~new_n416_ & ~new_n422_ & (~x04 | (~new_n403_ & ~new_n413_ & ~new_n421_));
  assign new_n403_ = x11 & ((~new_n404_ & ~x03) | new_n411_ | (new_n408_ & x00));
  assign new_n404_ = (~x00 | ~new_n407_ | x05) & (~x05 | ((new_n405_ | ~x07) & (~new_n406_ | ~x00)));
  assign new_n405_ = (~x00 | ~x02 | x08 | ~x12) & (x02 | ~x08 | x09 | x10 | x12);
  assign new_n406_ = x02 & ~x07 & x12 & (x08 | x09);
  assign new_n407_ = x12 & (x08 ? (x10 ? ~x09 : ~x07) : (x09 & x10));
  assign new_n408_ = x12 & (new_n410_ | (new_n409_ & x03));
  assign new_n409_ = (x02 ? ~x01 : x05) & (x07 ? ~x08 : (x08 | x09));
  assign new_n410_ = ~x01 & x02 & x08 & ~x09 & x10;
  assign new_n411_ = new_n194_ & ~x05 & ~x07 & new_n412_ & x10 & ~x12;
  assign new_n412_ = ~x08 & x09;
  assign new_n413_ = x00 & x12 & (new_n414_ | (~x07 & new_n415_ & x08));
  assign new_n414_ = ~new_n383_ & ((x02 & (x03 ? ~x01 : x05)) | (~x03 & ~x05) | (~x02 & x03 & x05));
  assign new_n415_ = x10 & ((~x01 & x03 & (x02 | (x05 & x09))) | (~x03 & (x05 ? x02 : x09)));
  assign new_n416_ = x03 & ~x04 & (new_n417_ | (x00 & new_n420_ & x01));
  assign new_n417_ = x11 & ((new_n419_ & x00) | (new_n418_ & x02));
  assign new_n418_ = ~x05 & ~x12 & ((~x07 & ~x08 & x09 & x10) | (~x09 & ~x10 & x07 & x08));
  assign new_n419_ = x01 & x12 & (x08 ? (~x07 | (~x09 & x10)) : (x09 & x10));
  assign new_n420_ = x12 & (x09 ? (x08 ? (~x07 ^ ~x10) : ~x10) : (x10 & ~x11));
  assign new_n421_ = new_n412_ & new_n400_ & x05 & ~x07 & x02 & x03;
  assign new_n422_ = x00 & x01 & ~x02 & x05 & ~new_n423_ & x12;
  assign new_n423_ = (~x08 | ((x09 | ~x10 | ~x11) & (x07 | ((x03 | ~x11) & (~x09 | ~x10))))) & (x09 | ~x10 | x11) & (~x09 | ((~x07 | x10) & (x08 | (x10 & (~x10 | ~x11)))));
  assign new_n424_ = ~new_n431_ & (x06 | (~new_n441_ & (~x07 | (~new_n425_ & ~new_n439_))));
  assign new_n425_ = x00 & x12 & (new_n426_ | (~new_n429_ & x10));
  assign new_n426_ = x11 & ((new_n428_ & x04) | (~new_n427_ & ~x09));
  assign new_n427_ = (~x01 | ((x02 | ~x05) & (~x03 | x04 | ~x08))) & (~x04 | ((~x02 | (x03 ? x01 : ~x05)) & (x02 | ~x03 | ~x05) & (x03 | x05 | ~x08)));
  assign new_n428_ = x10 & (x02 ? (x03 ? ~x01 : x05) : (x03 & x05));
  assign new_n429_ = (new_n430_ | ~x01) & (x03 | ~x04 | x05 | ~x09);
  assign new_n430_ = (~x03 | x04 | ~x08) & (x02 | ~x05 | ~x09);
  assign new_n431_ = x00 & x07 & x12 & (new_n432_ | ~new_n434_);
  assign new_n432_ = ~new_n433_ & ((x10 & ~x11) | (~x08 & ~x09 & x11));
  assign new_n433_ = (x03 | ~x04 | x05) & (~x01 | x02 | ~x05);
  assign new_n434_ = ~new_n438_ & (~x10 | (~new_n437_ & (~x03 | (~new_n435_ & ~new_n436_))));
  assign new_n435_ = x01 & ~x04 & (~x08 | (x08 & ~x11));
  assign new_n436_ = x04 & ((~x02 & x05 & (~x09 | ~x11)) | (~x01 & x02 & ~x11));
  assign new_n437_ = x02 & ~x03 & x04 & x05 & (~x09 | ~x11);
  assign new_n438_ = ~x08 & ~x09 & x11 & x01 & x03 & ~x04;
  assign new_n439_ = new_n399_ & new_n440_ & new_n389_ & x10 & x11 & ~x12;
  assign new_n440_ = ~x04 & ~x05;
  assign new_n441_ = new_n399_ & new_n440_ & new_n400_ & ~x07 & ~x08;
  assign new_n442_ = ~x12 & ((new_n458_ & x01) | (x13 & (new_n453_ | (~new_n443_ & x01))));
  assign new_n443_ = (~x07 | (~new_n444_ & new_n447_)) & (~x08 | (~new_n452_ & (new_n451_ | x07)));
  assign new_n444_ = x05 & (new_n445_ | ~new_n446_);
  assign new_n445_ = ~x02 & ((~x09 & x10 & x11) | (x04 & (x10 ? ~x11 : x09)));
  assign new_n446_ = (~x09 | (x06 & (x04 | ~x06)) | (x08 & (~x08 | x10))) & (x04 | ~x10 | (x11 & (~x06 | x09)));
  assign new_n447_ = (~new_n450_ | x05) & (~x10 | (~new_n449_ & (new_n448_ | x05)));
  assign new_n448_ = x02 ? (~x04 | (x11 & (x08 | ~x11))) : (~x06 | (x11 & (x09 | ~x11)));
  assign new_n449_ = ~x02 & x06 & ~x08 & x09;
  assign new_n450_ = x09 & ~x10 & (x02 ? x04 : x06);
  assign new_n451_ = (~x04 | new_n165_ | (x02 ^ ~x05)) & (new_n83_ | ((x04 | ~x05) & (x02 | x05 | ~x06)));
  assign new_n452_ = x04 & ~x09 & x10 & (x02 ^ x05);
  assign new_n453_ = x02 & (new_n454_ | (new_n457_ & x05));
  assign new_n454_ = ~x01 & ((~new_n300_ & ~new_n455_) | (~x08 & ~new_n456_ & x10));
  assign new_n455_ = (~x07 | (x10 ? x11 : ~x09)) & (~x08 | ((x09 | ~x10) & (x07 | (x09 ? ~x10 : ~x11))));
  assign new_n456_ = (~x05 | ~x07) & (~x06 | ~x11 | ((x04 | ~x07) & (~x04 | x05 | x07 | ~x09)));
  assign new_n457_ = ~x06 & ((~x09 & x11 & ~x07 & x08) | (x10 & (x07 ? (~x09 | ~x11) : x08)));
  assign new_n458_ = x02 & ~new_n459_ & x06;
  assign new_n459_ = (x04 | ~new_n461_ | x05) & (~new_n412_ | ~new_n460_ | ~x04 | ~x05 | x07);
  assign new_n460_ = ~x10 & ~x11;
  assign new_n461_ = x11 & ((~x07 & ~x08 & x09 & x10) | (~x09 & ~x10 & x07 & x08));
  assign z10 = new_n470_ | (x11 & (new_n475_ | (x03 & (new_n463_ | new_n473_))));
  assign new_n463_ = x02 & ((~x04 & (new_n467_ | (~new_n464_ & x01))) | (~x01 & new_n468_ & x04));
  assign new_n464_ = ~new_n465_ & (~x07 | ~x08 | new_n466_ | x10);
  assign new_n465_ = ~x05 & x06 & ~x07 & new_n412_ & x10 & ~x12;
  assign new_n466_ = (x00 | ~x05 | ~x12 | x13 | (~x06 ^ x09)) & (x09 | x12 | x05 | ~x06);
  assign new_n467_ = ~x05 & x06 & ~x12 & ~new_n374_ & ~x13;
  assign new_n468_ = ~x05 & new_n469_ & x06;
  assign new_n469_ = x08 & ~x10 & ~x12 & x13 & (x07 ^ x09);
  assign new_n470_ = new_n471_ & new_n399_ & ~x05 & ~x06 & ~x07;
  assign new_n471_ = new_n472_ & ~x08 & ~x11 & ~x12 & ~x13;
  assign new_n472_ = ~x09 & ~x10;
  assign new_n473_ = ~x02 & x04 & ~x05 & new_n474_ & x06;
  assign new_n474_ = x08 & ~x10 & ~x12 & ~x13 & (x07 ^ x09);
  assign new_n475_ = ~x02 & ~x03 & x09 & x10 & new_n476_ & ~x12;
  assign new_n476_ = ~x13 & ((x04 & x05 & x06 & ~x07 & ~x08) | (~x04 & ~x05 & ~x06 & x07 & x08));
  assign z12 = new_n497_ | (x11 & (x03 ? ~new_n478_ : (~new_n491_ & ~x13)));
  assign new_n478_ = x02 ? (~new_n487_ & (new_n479_ | ~x07)) : ~new_n489_;
  ...
  assign new_n483_ = ~x09 & ~x10 & ~x12 & ~x04 & ~x05 & x06;
  assign new_n484_ = ~x04 & ~x05 & new_n485_ & ~x06;
  assign new_n485_ = ~x08 & ~x09 & ~x10 & ~x12 & (~x01 | ~x13);
  assign new_n486_ = (~x04 | ((~x10 | x13 | ~x05 | ~x09) & (x01 | x05 | x09 | x10 | ~x13))) & (x04 | x05 | x09 | x10 | x13);
  assign new_n487_ = ~x05 & x06 & ~x07 & new_n488_ & x09;
  assign new_n488_ = ~x12 & ((~x01 & x04 & x13 & (x08 ^ x10)) | (~x04 & ~x08 & x10 & (x01 | ~x13)));
  assign new_n489_ = x04 & ~x05 & new_n490_ & x06;
  assign new_n490_ = ~x12 & ~x13 & ((~x09 & ~x10 & x07 & x08) | (~x07 & x09 & (x08 ^ x10)));
  assign new_n491_ = ~new_n494_ & (~x10 | (~new_n492_ & (x02 | ~new_n496_ | ~x09)));
  assign new_n492_ = new_n493_ & ~x00 & x01 & new_n440_ & x02;
  assign new_n493_ = x06 & ~x07 & ~x08 & ~x09 & x12;
  assign new_n494_ = new_n495_ & ~x02 & x04 & x05 & x06;
  assign new_n495_ = x07 & x08 & ~x09 & ~x10 & ~x12;
  assign new_n496_ = ~x12 & ((~x04 & ~x05 & ~x06 & x07 & x08) | (x04 & ((~x05 & ~x06 & x07 & x08) | (~x07 & ~x08 & x05 & x06))));
  assign new_n497_ = ~x07 & ~x08 & ~x10 & ~x11 & ~new_n498_ & ~x12;
  assign new_n498_ = (~x02 | ~new_n499_ | ~x03) & (x02 | x03 | x05 | x06 | x13);
  assign new_n499_ = x04 & x05 & x06 & x09 & (x01 | ~x13);
  assign z13 = (~new_n541_ & ~x12) | (~x13 & (~new_n518_ | (~new_n501_ & x12)));
  assign new_n501_ = (new_n502_ | ~x09) & ~new_n510_ & new_n514_ & ~new_n517_ & (new_n506_ | x09);
  assign new_n502_ = (new_n503_ | ~x06) & (x03 | (~new_n440_ & (x06 | x10))) & (x06 | new_n505_ | x10);
  assign new_n503_ = (x00 | (~new_n504_ & (~new_n178_ | ~x07 | ~x08))) & (x01 | ~x07 | ~new_n178_ | ~x08);
  assign new_n504_ = x03 & ~x04;
  assign new_n505_ = ~x00 & x02 & ~x04;
  assign new_n506_ = (new_n507_ | ~x00) & ~new_n509_ & (x00 | ~x03 | x04 | x06);
  assign new_n507_ = ~new_n508_ & (~x06 | ~x07 | ~x08 | x10);
  assign new_n508_ = x01 & x02 & x03 & x04 & x05;
  assign new_n509_ = ~x10 & ((~x07 & ~x08) | (x06 & x07 & x08 & (~x02 | ~x03)));
  assign new_n510_ = x03 & (new_n511_ | (~new_n513_ & x04) | (~x00 & ~x04 & x10));
  assign new_n511_ = ~new_n512_ & (~x07 | ~x08);
  assign new_n512_ = (x00 | x04) & (~x00 | ~x01 | ~x02 | ~x04 | ~x05);
  assign new_n513_ = (x01 | x02 | x05) & (~x00 | ~x01 | ~x02 | ~x05 | (new_n178_ & x06));
  assign new_n514_ = new_n515_ & (x01 | (x02 ? (x04 | x05) : (x03 | ~x05)));
  assign new_n515_ = (x06 | (~new_n460_ & x07)) & (x03 | new_n516_ | x04);
  assign new_n516_ = (x05 | (x02 & ~x07 & x11)) & (~x00 | ~x01 | ~x02);
  assign new_n517_ = ~x00 & (~x01 | (~x04 & ~x05 & x08));
  assign new_n518_ = (new_n519_ | ~x07) & (new_n539_ | x07) & (x12 | (~new_n529_ & ~new_n535_));
  assign new_n519_ = (new_n520_ | ~x10) & (new_n528_ | x10) & (~x04 | new_n525_ | ~x06);
  assign new_n520_ = (x02 | (~new_n521_ & ~new_n522_)) & ~new_n524_ & (x04 | (~new_n521_ & (~new_n523_ | ~x02)));
  assign new_n521_ = x06 & x08 & x09 & x11;
  assign new_n522_ = ~x03 & x05 & ~x12;
  assign new_n523_ = ~x05 & ~x12;
  assign new_n524_ = x06 & x08 & x09 & x11 & (~x03 | ~x05);
  assign new_n525_ = ~new_n527_ & (~x02 | (~new_n526_ & (~new_n472_ | ~x08)));
  assign new_n526_ = ~x11 & ~x12 & x03 & x05;
  assign new_n527_ = x09 & ~x12 & ~x02 & ~x05;
  assign new_n528_ = (x09 | x11) & (~new_n399_ | ~x09 | x12);
  assign new_n529_ = x02 & (new_n530_ | new_n531_ | (new_n534_ & ~x07 & x09));
  assign new_n530_ = ~x04 & ~x05 & (new_n35_ | new_n266_);
  assign new_n531_ = x04 & ((new_n533_ & x03) | (~new_n532_ & ~x07));
  assign new_n532_ = (x08 | ~x11) & (~x03 | ~x05 | ~x06 | ~x10);
  assign new_n533_ = x05 & x06 & (~x09 | (x11 & (~x08 | ~x10)));
  assign new_n534_ = ~x10 & x11;
  assign new_n535_ = ~x02 & (~new_n537_ | (~x07 & (new_n536_ | (~x03 & x08))));
  assign new_n536_ = x04 & ~x05 & (new_n34_ | (x08 & x10));
  assign new_n537_ = ~new_n538_ & (~new_n82_ | ~new_n154_);
  assign new_n538_ = ~x03 & ((x10 & ~x11) | (~x05 & ~x08 & x11));
  assign new_n539_ = x08 ? ~new_n460_ : new_n540_;
  assign new_n540_ = (~x03 | (x06 & (x09 | ~x11))) & (~x09 | ~x10 | x11) & (x09 | new_n440_ | ~x11);
  assign new_n541_ = (new_n542_ | x02) & (new_n546_ | ~x07) & new_n565_ & (new_n556_ | x07);
  assign new_n542_ = (x03 | (x04 ? (~x05 | x06) : ~x06)) & new_n544_ & (new_n543_ | x04);
  assign new_n543_ = x07 ? ~new_n472_ : ~new_n238_;
  assign new_n544_ = (new_n545_ | ~x05) & (x01 | ~x13) & (~x03 | x05 | x06);
  assign new_n545_ = (~x07 | ~x08 | ~x09 | ~x10 | ~x11) & (x07 | x10 | x11);
  assign new_n546_ = (new_n555_ | x03) & ~new_n547_ & new_n551_ & (new_n549_ | ~x01);
  assign new_n547_ = ~new_n548_ & ~x06;
  assign new_n548_ = (~x04 | x09 | x10) & (~x02 | ~x08 | ~x09 | ~x10 | ~x11);
  assign new_n549_ = (~new_n550_ | ~x02) & (x10 | ~x13 | ~x04 | x09);
  assign new_n550_ = x03 & ((~x04 & ~x05 & x09) | (x04 & x05 & x06 & ~x11));
  assign new_n551_ = ~new_n554_ & (~x13 | (~new_n553_ & (new_n552_ | ~x08)));
  assign new_n552_ = (x01 | ((~x09 | ~x10 | ~x11) & (x04 | x09 | x10))) & (~x09 | ~x10 | ~x11 | (x04 & x05));
  assign new_n553_ = ~x01 & x04 & ~x05 & x09;
  assign new_n554_ = x05 & ~x09 & ~x10 & (x02 | x03);
  assign new_n555_ = (x05 | x09 | x10) & (~x08 | ~x09 | ~x10 | ~x11 | ~x13);
  assign new_n556_ = ~new_n564_ & (new_n557_ | ~x01) & ~new_n559_ & ~new_n560_ & new_n562_;
  assign new_n557_ = ~new_n558_ & (~x13 | ((~new_n35_ | x05) & (~new_n238_ | ~x04)));
  assign new_n558_ = x02 & x03 & x08 & (x04 ? (x05 & x06) : ~x05);
  assign new_n559_ = ~x04 & ((new_n35_ & x06) | (~x01 & ~x08 & x13));
  assign new_n560_ = x13 & ((new_n460_ & ~x06) | (~x01 & (new_n460_ | new_n561_)));
  assign new_n561_ = x04 & ~x05 & ~x09;
  assign new_n562_ = (~x05 | new_n563_ | ~x11) & (x08 | ((x05 | ~x06 | x10) & (~x10 | x11)));
  assign new_n563_ = (~x03 | x08) & (~x09 | x10);
  assign new_n564_ = ~x03 & ((x09 & ~x10 & x13) | (x02 & ~x08));
  assign new_n565_ = ~new_n566_ & (new_n570_ | ~x06) & (~new_n472_ | x11 | ~x13);
  assign new_n566_ = ~x05 & ((new_n569_ & ~x01) | (~x04 & (new_n568_ | (~new_n567_ & x01))));
  assign new_n567_ = (x06 | ~x13) & (x09 | ~x10 | ~x02 | ~x03);
  assign new_n568_ = ~x06 & (x10 ? ~x09 : x08);
  assign new_n569_ = x13 & ((~x06 & x09) | (x04 & x10 & (x08 | ~x09)));
  assign new_n570_ = (x08 | (~new_n472_ & ~new_n571_)) & (~x01 | ~new_n572_ | ~x02);
  assign new_n571_ = x01 & x02 & x03 & x04 & x05 & x11;
  assign new_n572_ = x03 & x04 & x05 & (~x09 | (~x10 & x11));
  assign z05 = 1'b0;
  assign z11 = 1'b0;
endmodule
