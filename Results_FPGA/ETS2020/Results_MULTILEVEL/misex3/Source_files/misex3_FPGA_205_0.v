...
module FAU ( 
  ...
  assign z07 = x11 & ((~new_n139_ & ~x12) | (~x13 & (x12 ? ~new_n107_ : ~new_n131_)));
  ...
  assign new_n131_ = ~new_n132_ & (new_n138_ | (x07 ? (x10 ? (x08 & x09) : ~x09) : (~x08 | (x09 & ~x10))));
  assign new_n132_ = x05 & (~new_n133_ | (~x09 & (new_n136_ | (~new_n137_ & x02))));
  assign new_n133_ = (~x07 | (~new_n134_ & ~new_n135_) | (x10 ? x08 : ~x09)) & (~new_n134_ | x07 | ~x08 | ~x10);
  assign new_n134_ = ~x02 & x03;
  assign new_n135_ = x02 & ~x03 & x06;
  assign new_n136_ = x03 & ((~x04 & ~x07 & x08) | (~x02 & ((x07 & x10) | (x04 & ~x07 & x08))));
  assign new_n137_ = (x03 | ((~x06 | x07 | ~x08) & (~x04 | ~x07 | ~x10))) & (x04 | ~x07 | ~x10);
  assign new_n138_ = (x02 | ~x03 | x04 | ~x06) & (~x02 | ~x04 | x05);
  assign new_n139_ = ~new_n140_ & ~new_n153_ & ~new_n160_ & (~x10 | (new_n143_ & ~new_n157_));
  assign new_n140_ = ~new_n141_ & (x07 ? (~x08 & x10) : (x08 & ~x09));
  assign new_n141_ = (new_n142_ | ~x13) & (~x02 | ~x05 | x06);
  assign new_n142_ = (~x01 | ((x04 | ~x05 | x06) & (x03 | ~x04 | x05))) & (~x06 | ((~x02 | ((x03 | x04) & (x01 | (~x05 & (~x03 | x04))))) & (~x03 | x05 | ~x01 | x02)));
  assign new_n143_ = (new_n152_ | ~x05) & (~x13 | (~new_n144_ & (new_n148_ | ~x01)));
  assign new_n144_ = x02 & (x07 ? (new_n146_ | (~new_n145_ & x01)) : new_n147_);
  assign new_n145_ = (x03 | ~x06 | x09) & (~x03 | ~x04 | x05 | x08);
  assign new_n146_ = x05 & ~x09 & (~x04 | (~x01 & x04));
  assign new_n147_ = x08 & ((~x01 & x05) | (~x03 & ~x04 & x06));
  assign new_n148_ = ~new_n151_ & (x02 | (~new_n150_ & (new_n149_ | ~x06)));
  assign new_n149_ = (~x03 | ((x07 | ~x08) & (x05 | ~x07 | x09))) & (~x04 | ((~x07 | x09) & (~x05 | x07 | ~x08)));
  assign new_n150_ = x07 & ~x09 & x03 & x05;
  assign new_n151_ = ~x03 & x04 & x06 & x07 & ~x08;
  assign new_n152_ = (~x02 | x03 | x07 | ~x08) & ((~x07 ^ x08) | ((~x01 | x02 | ~x03) & (~x02 | x04)));
  assign new_n153_ = x13 & ((new_n154_ & x07) | (x01 & ~x07 & new_n156_ & x08));
  assign new_n154_ = x09 & ~new_n155_ & ~x10;
  assign new_n155_ = (~x06 | ((~x01 | (x03 ? x02 : ~x04)) & (~x02 | ((x03 | x04) & (x01 | (x04 & ~x05)))))) & (~x01 | (x04 ? (x05 | (~x02 & x03)) : (~x05 | x06)));
  assign new_n156_ = ~x09 & ((x02 & x04 & ~x05) | (x05 & (x03 ? (~x04 | (~x02 & x04)) : (x04 & x06))));
  assign new_n157_ = (new_n159_ | (~new_n158_ & x01)) & (x07 ? ~x09 : x08);
  assign new_n158_ = (~x04 | x05 | (~x02 & (x03 | ~x13))) & (x06 | ~x13 | x04 | ~x05);
  assign new_n159_ = x02 & ((x05 & ~x06) | (~x01 & ~x04 & x06 & x13));
  assign new_n160_ = x05 & x07 & new_n161_ & x09;
  assign new_n161_ = ~x10 & ((x01 & ~x02 & x03) | (x02 & (~x06 | (~x04 & x06))));
  assign z11 = (~new_n163_ & x11) | (new_n176_ & new_n177_ & ~x11 & ~x12 & ~x13);
  assign new_n163_ = ~new_n174_ & (~x06 | (~new_n172_ & (~x03 | (~new_n164_ & ~new_n170_))));
  assign new_n164_ = ~x12 & (x02 ? (new_n165_ | new_n167_) : (new_n169_ & x04));
  assign new_n165_ = x07 & ~new_n166_ & x08;
  assign new_n166_ = ((~x01 & x13) | ((~x04 | ~x05 | ~x09 | ~x10) & (x04 | x05 | x09 | x10))) & (x01 | ~x04 | x05 | x09 | x10 | ~x13);
  assign new_n167_ = new_n168_ & ~x01 & x04 & ~x05 & ~x07;
  assign new_n168_ = ~x08 & x09 & x10 & x13;
  assign new_n169_ = ~x05 & ~x13 & ((~x07 & ~x08 & x09 & x10) | (x07 & x08 & ~x09 & ~x10));
  assign new_n170_ = x01 & x02 & x05 & x07 & new_n171_ & x08;
  assign new_n171_ = ~x13 & ((x00 & x04 & x09 & x10) | (~x00 & ~x04 & ~x09 & ~x10 & x12));
  assign new_n172_ = new_n173_ & ~x02 & ~x03 & x04 & x05 & ~x07;
  assign new_n173_ = ~x08 & x09 & x10 & ~x12 & ~x13;
  assign new_n174_ = new_n175_ & ~x02 & ~x03 & x04 & ~x05 & ~x06;
  assign new_n175_ = x07 & x08 & x09 & x10 & ~x12 & ~x13;
  assign new_n176_ = ~x02 & ~x03 & ~x04 & ~x05 & ~x06;
  assign new_n177_ = ~x07 & ~x08 & ~x10;
  assign z12 = new_n198_ | (x11 & (x03 ? ~new_n179_ : (~new_n192_ & ~x13)));
  assign new_n179_ = x02 ? (~new_n188_ & (new_n180_ | ~x07)) : ~new_n190_;
  assign new_n180_ = ~new_n185_ & (~x08 | (~new_n181_ & (~x06 | new_n187_ | x12)));
  assign new_n181_ = x01 & (new_n184_ | (x05 & (new_n183_ | (~new_n182_ & ~x13))));
  assign new_n182_ = (x00 | x04 | x10 | ~x12 | (~x06 ^ x09)) & (~x00 | ~x04 | ~x06 | ~x09 | ~x10);
  assign new_n183_ = x04 & x06 & x09 & x10 & ~x12;
  assign new_n184_ = ~x09 & ~x10 & ~x12 & ~x04 & ~x05 & x06;
  assign new_n185_ = ~x04 & ~x05 & new_n186_ & ~x06;
  assign new_n186_ = ~x08 & ~x09 & ~x10 & ~x12 & (~x01 | ~x13);
  assign new_n187_ = (~x04 | ((x01 | x05 | x09 | x10 | ~x13) & (~x10 | x13 | ~x05 | ~x09))) & (x04 | x05 | x09 | x10 | x13);
  assign new_n188_ = ~x05 & x06 & ~x07 & new_n189_ & x09;
  assign new_n189_ = ~x12 & ((~x01 & x04 & x13 & (x08 ^ x10)) | (~x04 & ~x08 & x10 & (x01 | ~x13)));
  assign new_n190_ = x04 & ~x05 & new_n191_ & x06;
  assign new_n191_ = ~x12 & ~x13 & ((x07 & x08 & ~x09 & ~x10) | (~x07 & x09 & (x08 ^ x10)));
  assign new_n192_ = ~new_n195_ & (~x10 | (~new_n193_ & (x02 | ~new_n197_ | ~x09)));
  assign new_n193_ = new_n194_ & ~x00 & x01 & x02 & ~x04 & ~x05;
  assign new_n194_ = ~x08 & ~x09 & x12 & x06 & ~x07;
  assign new_n195_ = new_n196_ & ~x02 & x04 & x05 & x06;
  assign new_n196_ = x07 & x08 & ~x09 & ~x10 & ~x12;
  assign new_n197_ = ~x12 & ((~x04 & ~x05 & ~x06 & x07 & x08) | (x04 & ((~x05 & ~x06 & x07 & x08) | (x05 & x06 & ~x07 & ~x08))));
  assign new_n198_ = ~x07 & ~x08 & ~x10 & ~x11 & ~new_n199_ & ~x12;
  assign new_n199_ = (~x02 | ~new_n200_ | ~x03) & (x02 | x03 | x05 | x06 | x13);
  assign new_n200_ = x04 & x05 & x06 & x09 & (x01 | ~x13);
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
