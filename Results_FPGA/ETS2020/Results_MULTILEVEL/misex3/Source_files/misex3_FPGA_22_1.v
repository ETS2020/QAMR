// Benchmark "FAU" written by ABC on Fri Aug  7 04:21:12 2020
...
module FAU ( 
  ...
  assign new_n371_ = new_n372_ & ~x05 & ~x06 & new_n373_ & ~x07 & ~x08;
  assign new_n372_ = ~x02 & ~x03;
  assign new_n373_ = ~x10 & ~x11 & ~x12;
  assign z09 = (new_n415_ & x03) | (~x13 & (~new_n397_ | (~new_n375_ & x06)));
  assign new_n375_ = ~new_n389_ & ~new_n395_ & (~x04 | (~new_n376_ & ~new_n386_ & ~new_n394_));
  ...
  assign new_n384_ = new_n191_ & ~x05 & ~x07 & new_n385_ & x10 & ~x12;
  assign new_n385_ = ~x08 & x09;
  assign new_n386_ = x00 & x12 & (new_n387_ | (~x07 & new_n388_ & x08));
  assign new_n387_ = ~new_n356_ & ((x02 & (x03 ? ~x01 : x05)) | (~x03 & ~x05) | (~x02 & x03 & x05));
  ...
  assign new_n394_ = new_n385_ & new_n373_ & x05 & ~x07 & x02 & x03;
  assign new_n395_ = x00 & x01 & ~x02 & x05 & ~new_n396_ & x12;
  assign new_n396_ = (~x08 | ((x09 | ~x10 | ~x11) & (x07 | ((x03 | ~x11) & (~x09 | ~x10))))) & (x09 | ~x10 | x11) & (~x09 | ((~x07 | x10) & (x08 | (x10 & (~x10 | ~x11)))));
  assign new_n397_ = (x06 | (~new_n414_ & (new_n398_ | ~x07))) & (~x00 | ~new_n406_ | ~x07);
  assign new_n398_ = ~new_n404_ & (~x00 | ~x12 | (~new_n399_ & (new_n402_ | ~x10)));
  assign new_n399_ = x11 & (new_n401_ | (~new_n400_ & ~x09));
  assign new_n400_ = (~x01 | ((x02 | ~x05) & (~x03 | x04 | ~x08))) & (~x04 | ((~x02 | (x03 ? x01 : ~x05)) & (x02 | ~x03 | ~x05) & (x03 | x05 | ~x08)));
  assign new_n401_ = x04 & x10 & (x02 ? (x03 ? ~x01 : x05) : (x03 & x05));
  assign new_n402_ = (new_n403_ | ~x01) & (x03 | ~x04 | x05 | ~x09);
  assign new_n403_ = (~x03 | x04 | ~x08) & (x02 | ~x05 | ~x09);
  assign new_n404_ = new_n372_ & new_n405_ & new_n362_ & x10 & x11 & ~x12;
  assign new_n405_ = ~x04 & ~x05;
  assign new_n406_ = x12 & (new_n407_ | new_n412_ | (x10 & (new_n409_ | new_n411_)));
  assign new_n407_ = ~new_n408_ & ((x10 & ~x11) | (~x08 & ~x09 & x11));
  assign new_n408_ = (x03 | ~x04 | x05) & (~x01 | x02 | ~x05);
  assign new_n409_ = x03 & ((~new_n410_ & x04) | (x01 & ~x04 & (~x08 | (x08 & ~x11))));
  assign new_n410_ = (x02 | ~x05 | (x09 & x11)) & (x01 | ~x02 | x11);
  assign new_n411_ = x02 & ~x03 & x04 & ~new_n213_ & x05;
  assign new_n412_ = new_n413_ & x01 & new_n34_ & ~x08;
  assign new_n413_ = x03 & ~x04;
  assign new_n414_ = new_n372_ & new_n405_ & new_n373_ & ~x07 & ~x08;
  ...
  assign new_n427_ = ~x01 & ((~new_n325_ & ~new_n428_) | (~x08 & ~new_n429_ & x10));
  ...
  assign new_n432_ = (x04 | ~new_n434_ | x05) & (~new_n385_ | ~new_n433_ | ~x04 | ~x05 | x07);
  assign new_n433_ = ~x10 & ~x11;
  assign new_n434_ = x11 & ((~x07 & ~x08 & x09 & x10) | (~x09 & ~x10 & x07 & x08));
  assign z10 = new_n443_ | (x11 & (new_n448_ | (x03 & (new_n436_ | new_n446_))));
  assign new_n436_ = x02 & ((~x04 & (new_n440_ | (~new_n437_ & x01))) | (~x01 & new_n441_ & x04));
  assign new_n437_ = ~new_n438_ & (~x07 | ~x08 | new_n439_ | x10);
  assign new_n438_ = ~x05 & x06 & ~x07 & new_n385_ & x10 & ~x12;
  assign new_n439_ = (x00 | ~x05 | ~x12 | x13 | (~x06 ^ x09)) & (x09 | x12 | x05 | ~x06);
  assign new_n440_ = ~x05 & x06 & ~x12 & ~new_n347_ & ~x13;
  assign new_n441_ = ~x05 & new_n442_ & x06;
  assign new_n442_ = x08 & ~x10 & ~x12 & x13 & (x07 ^ x09);
  assign new_n443_ = new_n444_ & new_n372_ & ~x05 & ~x06 & ~x07;
  assign new_n444_ = new_n445_ & ~x08 & ~x11 & ~x12 & ~x13;
  assign new_n445_ = ~x09 & ~x10;
  assign new_n446_ = ~x02 & x04 & ~x05 & new_n447_ & x06;
  assign new_n447_ = x08 & ~x10 & ~x12 & ~x13 & (x07 ^ x09);
  assign new_n448_ = ~x02 & ~x03 & x09 & x10 & new_n449_ & ~x12;
  assign new_n449_ = ~x13 & ((x04 & x05 & x06 & ~x07 & ~x08) | (~x04 & ~x05 & ~x06 & x07 & x08));
  assign z12 = new_n470_ | (x11 & (x03 ? ~new_n451_ : (~new_n464_ & ~x13)));
  assign new_n451_ = x02 ? (~new_n460_ & (new_n452_ | ~x07)) : ~new_n462_;
  assign new_n452_ = ~new_n457_ & (~x08 | (~new_n453_ & (~x06 | new_n459_ | x12)));
  assign new_n453_ = x01 & (new_n456_ | (x05 & (new_n455_ | (~new_n454_ & ~x13))));
  assign new_n454_ = (x00 | x04 | x10 | ~x12 | (~x06 ^ x09)) & (~x00 | ~x04 | ~x06 | ~x09 | ~x10);
  assign new_n455_ = x04 & x06 & x09 & x10 & ~x12;
  assign new_n456_ = ~x09 & ~x10 & ~x12 & ~x04 & ~x05 & x06;
  assign new_n457_ = ~x04 & ~x05 & new_n458_ & ~x06;
  assign new_n458_ = ~x08 & ~x09 & ~x10 & ~x12 & (~x01 | ~x13);
  assign new_n459_ = (~x04 | ((~x10 | x13 | ~x05 | ~x09) & (x01 | x05 | x09 | x10 | ~x13))) & (x04 | x05 | x09 | x10 | x13);
  assign new_n460_ = ~x05 & x06 & ~x07 & new_n461_ & x09;
  assign new_n461_ = ~x12 & ((~x01 & x04 & x13 & (x08 ^ x10)) | (~x04 & ~x08 & x10 & (x01 | ~x13)));
  assign new_n462_ = x04 & ~x05 & new_n463_ & x06;
  assign new_n463_ = ~x12 & ~x13 & ((~x09 & ~x10 & x07 & x08) | (~x07 & x09 & (x08 ^ x10)));
  assign new_n464_ = ~new_n467_ & (~x10 | (~new_n465_ & (x02 | ~new_n469_ | ~x09)));
  assign new_n465_ = new_n466_ & ~x00 & x01 & new_n405_ & x02;
  assign new_n466_ = x06 & ~x07 & ~x08 & ~x09 & x12;
  assign new_n467_ = new_n468_ & ~x02 & x04 & x05 & x06;
  assign new_n468_ = x07 & x08 & ~x09 & ~x10 & ~x12;
  assign new_n469_ = ~x12 & ((~x04 & ~x05 & ~x06 & x07 & x08) | (x04 & ((~x05 & ~x06 & x07 & x08) | (~x07 & ~x08 & x05 & x06))));
  assign new_n470_ = ~x07 & ~x08 & ~x10 & ~x11 & ~new_n471_ & ~x12;
  assign new_n471_ = (~x02 | ~new_n472_ | ~x03) & (x02 | x03 | x05 | x06 | x13);
  assign new_n472_ = x04 & x05 & x06 & x09 & (x01 | ~x13);
  assign z13 = (~new_n513_ & ~x12) | (~x13 & (~new_n490_ | (~new_n474_ & x12)));
  assign new_n474_ = (new_n475_ | ~x09) & ~new_n482_ & new_n486_ & ~new_n489_ & (new_n478_ | x09);
  assign new_n475_ = (new_n476_ | ~x06) & (x03 | (~new_n405_ & (x06 | x10))) & (x06 | new_n477_ | x10);
  assign new_n476_ = (x00 | (~new_n413_ & (~new_n175_ | ~x07 | ~x08))) & (x01 | ~x07 | ~new_n175_ | ~x08);
  assign new_n477_ = ~x00 & x02 & ~x04;
  assign new_n478_ = (new_n479_ | ~x00) & ~new_n481_ & (x00 | ~x03 | x04 | x06);
  assign new_n479_ = ~new_n480_ & (~x06 | ~x07 | ~x08 | x10);
  assign new_n480_ = x01 & x02 & x03 & x04 & x05;
  assign new_n481_ = ~x10 & ((~x07 & ~x08) | (x06 & x07 & x08 & (~x02 | ~x03)));
  assign new_n482_ = x03 & (new_n483_ | (~new_n485_ & x04) | (~x00 & ~x04 & x10));
  assign new_n483_ = ~new_n484_ & (~x07 | ~x08);
  assign new_n484_ = (x00 | x04) & (~x00 | ~x01 | ~x02 | ~x04 | ~x05);
  assign new_n485_ = (x01 | x02 | x05) & (~x00 | ~x01 | ~x02 | ~x05 | (new_n175_ & x06));
  assign new_n486_ = new_n487_ & (x01 | (x02 ? (x04 | x05) : (x03 | ~x05)));
  assign new_n487_ = (x06 | (~new_n433_ & x07)) & (x03 | new_n488_ | x04);
  assign new_n488_ = (~x00 | ~x01 | ~x02) & (x05 | (x02 & ~x07 & x11));
  assign new_n489_ = ~x00 & (~x01 | (~x04 & ~x05 & x08));
  assign new_n490_ = (new_n491_ | ~x07) & (new_n511_ | x07) & (x12 | (~new_n501_ & ~new_n507_));
  assign new_n491_ = (new_n492_ | ~x10) & (new_n500_ | x10) & (~x04 | new_n497_ | ~x06);
  assign new_n492_ = (x02 | (~new_n493_ & ~new_n494_)) & ~new_n496_ & (x04 | (~new_n493_ & (~new_n495_ | ~x02)));
  assign new_n493_ = x06 & x08 & x09 & x11;
  assign new_n494_ = ~x03 & x05 & ~x12;
  assign new_n495_ = ~x05 & ~x12;
  assign new_n496_ = x06 & x08 & x09 & x11 & (~x03 | ~x05);
  assign new_n497_ = ~new_n499_ & (~x02 | (~new_n498_ & (~new_n445_ | ~x08)));
  assign new_n498_ = ~x11 & ~x12 & x03 & x05;
  assign new_n499_ = x09 & ~x12 & ~x02 & ~x05;
  assign new_n500_ = (x09 | x11) & (~new_n372_ | ~x09 | x12);
  assign new_n501_ = x02 & (new_n502_ | new_n503_ | (new_n506_ & ~x07 & x09));
  assign new_n502_ = ~x04 & ~x05 & (new_n35_ | new_n263_);
  assign new_n503_ = x04 & ((new_n505_ & x03) | (~new_n504_ & ~x07));
  assign new_n504_ = (x08 | ~x11) & (~x03 | ~x05 | ~x06 | ~x10);
  assign new_n505_ = x05 & x06 & (~x09 | (x11 & (~x08 | ~x10)));
  assign new_n506_ = ~x10 & x11;
  assign new_n507_ = ~x02 & (~new_n509_ | (~x07 & (new_n508_ | (~x03 & x08))));
  assign new_n508_ = x04 & ~x05 & (new_n34_ | (x08 & x10));
  assign new_n509_ = ~new_n510_ & (~new_n79_ | ~new_n151_);
  assign new_n510_ = ~x03 & ((x10 & ~x11) | (~x05 & ~x08 & x11));
  assign new_n511_ = x08 ? ~new_n433_ : new_n512_;
  assign new_n512_ = (~x03 | (x06 & (x09 | ~x11))) & (~x09 | ~x10 | x11) & (x09 | new_n405_ | ~x11);
  assign new_n513_ = (new_n514_ | x02) & (new_n518_ | ~x07) & new_n537_ & (new_n528_ | x07);
  assign new_n514_ = (x03 | (x04 ? (~x05 | x06) : ~x06)) & new_n516_ & (new_n515_ | x04);
  assign new_n515_ = x07 ? ~new_n445_ : ~new_n235_;
  assign new_n516_ = (new_n517_ | ~x05) & (x01 | ~x13) & (~x03 | x05 | x06);
  assign new_n517_ = (~x07 | ~x08 | ~x09 | ~x10 | ~x11) & (x07 | x10 | x11);
  assign new_n518_ = (new_n527_ | x03) & ~new_n519_ & new_n523_ & (new_n521_ | ~x01);
  assign new_n519_ = ~new_n520_ & ~x06;
  assign new_n520_ = (~x04 | x09 | x10) & (~x02 | ~x08 | ~x09 | ~x10 | ~x11);
  assign new_n521_ = (~new_n522_ | ~x02) & (x10 | ~x13 | ~x04 | x09);
  assign new_n522_ = x03 & ((~x04 & ~x05 & x09) | (x04 & x05 & x06 & ~x11));
  assign new_n523_ = ~new_n526_ & (~x13 | (~new_n525_ & (new_n524_ | ~x08)));
  assign new_n524_ = (x01 | ((~x09 | ~x10 | ~x11) & (x04 | x09 | x10))) & (~x09 | ~x10 | ~x11 | (x04 & x05));
  assign new_n525_ = ~x01 & x04 & ~x05 & x09;
  assign new_n526_ = x05 & ~x09 & ~x10 & (x02 | x03);
  assign new_n527_ = (x05 | x09 | x10) & (~x08 | ~x09 | ~x10 | ~x11 | ~x13);
  assign new_n528_ = ~new_n536_ & (new_n529_ | ~x01) & ~new_n531_ & ~new_n532_ & new_n534_;
  assign new_n529_ = ~new_n530_ & (~x13 | ((~new_n35_ | x05) & (~new_n235_ | ~x04)));
  assign new_n530_ = x02 & x03 & x08 & (x04 ? (x05 & x06) : ~x05);
  assign new_n531_ = ~x04 & ((new_n35_ & x06) | (~x01 & ~x08 & x13));
  assign new_n532_ = x13 & ((new_n433_ & ~x06) | (~x01 & (new_n433_ | new_n533_)));
  assign new_n533_ = x04 & ~x05 & ~x09;
  assign new_n534_ = (~x05 | new_n535_ | ~x11) & (x08 | ((x05 | ~x06 | x10) & (~x10 | x11)));
  assign new_n535_ = (~x03 | x08) & (~x09 | x10);
  assign new_n536_ = ~x03 & ((x09 & ~x10 & x13) | (x02 & ~x08));
  assign new_n537_ = ~new_n538_ & (new_n542_ | ~x06) & (~new_n445_ | x11 | ~x13);
  assign new_n538_ = ~x05 & ((new_n541_ & ~x01) | (~x04 & (new_n540_ | (~new_n539_ & x01))));
  assign new_n539_ = (x06 | ~x13) & (x09 | ~x10 | ~x02 | ~x03);
  assign new_n540_ = ~x06 & (x10 ? ~x09 : x08);
  assign new_n541_ = x13 & ((~x06 & x09) | (x04 & x10 & (x08 | ~x09)));
  assign new_n542_ = (x08 | (~new_n445_ & ~new_n543_)) & (~x01 | ~new_n544_ | ~x02);
  assign new_n543_ = x01 & x02 & x03 & x04 & x05 & x11;
  assign new_n544_ = x03 & x04 & x05 & (~x09 | (~x10 & x11));
  assign z07 = 1'b0;
  assign z11 = 1'b0;
endmodule
