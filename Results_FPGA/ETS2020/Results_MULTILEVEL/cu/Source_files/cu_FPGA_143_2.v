// Benchmark "FAU" written by ABC on Tue Aug  4 23:10:06 2020
...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n32_, new_n34_, new_n36_, new_n37_;
  assign z02 = new_n28_ & ~x13;
  assign new_n28_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z03 = new_n30_ & ~x13;
  assign new_n30_ = x05 & ~x04 & ~x03 & x00 & ~x01 & ~x02;
