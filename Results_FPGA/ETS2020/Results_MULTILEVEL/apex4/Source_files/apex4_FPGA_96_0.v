...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_, new_n37_,
    ...
    new_n217_, new_n218_, new_n220_, new_n221_, new_n222_;
  ...
  assign z11 = (~new_n147_ & ~x4) | (~new_n161_ & ~x1) | (~new_n155_ & x4);
  assign new_n147_ = (new_n154_ | (x7 ^ x8)) & (new_n151_ | ~x3) & (new_n148_ | x3);
  assign new_n148_ = x6 ? new_n150_ : new_n149_;
  assign new_n149_ = ((~x2 ^ x7) | ((x0 | ~x5 | ~x8) & (~x0 | ~x1 | x5 | x8))) & (x5 | (x0 ? ((x1 | x2 | (x7 & x8)) & (x7 | ~x8 | ~x1 | ~x2)) : (x1 & (~x7 | x8 | ~x1 | x2)))) & (x1 | ((~x0 | (x2 ? (~x5 | ~x7) : (x7 | x8))) & (~x5 | ~x7 | x8 | x0 | ~x2)));
  assign new_n150_ = x1 ? ((x7 | x8 | x0 | ~x5) & (~x0 | x2 | (x5 ? ~x7 : (x7 | ~x8)))) : ((x5 | ~x7 | ~x8 | ~x0 | x2) & (~x2 | ((x0 | x5) & (x7 | (x0 ? (x5 & (~x5 | x8)) : (~x5 | x8))))));
  assign new_n151_ = (new_n152_ | ~x2) & (~x0 | new_n153_ | x2);
  assign new_n152_ = ((~x7 ^ x8) | ((~x0 | (x1 ? (x5 | ~x6) : (~x5 | x6))) & (~x5 | ~x6 | x0 | x1))) & (~x0 | ((x6 | x7 | x8 | ~x1 | x5) & (x1 | ~x5 | ~x6 | ~x7 | ~x8))) & (x0 | ((x1 | ~x5 | ~x6 | x7 | x8) & (~x1 | ~x7 | (x5 ? (~x6 | x8) : x6))));
  assign new_n153_ = (~x7 | (x1 ? (x5 ? (x6 | x8) : (~x6 | ~x8)) : (x5 | ~x6))) & (x1 | x7 | ((~x6 | (~x5 & (x5 | ~x8))) & (x5 | x6 | x8)));
  assign new_n154_ = (x3 | ~x5 | ~x6 | ~x0 | ~x1 | ~x2) & (x0 | ((~x3 | x5 | ~x6 | ~x1 | x2) & (x1 | ~x2 | x3 | ~x5 | x6)));
  assign new_n155_ = x0 ? (x6 ? new_n159_ : new_n160_) : new_n156_;
  assign new_n156_ = (new_n157_ | ~x2) & (~x1 | new_n158_ | x2);
  assign new_n157_ = x1 ? ((x6 | ((~x7 | ~x8 | x3 | ~x5) & (~x3 | (x5 ? ~x7 : (x7 | ~x8))))) & (x3 | ~x6 | ((x5 | ~x7 | x8) & (x7 | (~x8 & (~x5 | x8)))))) : (((x6 ? (x7 | x8) : (~x7 | ~x8)) | (~x3 ^ x5)) & (~x6 | ((x3 | x5 | x7) & (~x7 | (x3 ? (~x5 | ~x8) : (x5 | x8))))));
  assign new_n158_ = x3 ? ((x7 | (x5 ? (x6 ^ x8) : x6)) & (~x6 | ~x7 | (x5 & x8))) : (x6 | (x5 ? x7 : (~x7 & (x7 | ~x8))));
  assign new_n159_ = x2 ? ((~x5 | ((~x1 | (x3 ? (~x7 & (x7 | ~x8)) : ~x7)) & (x1 | x3 | x7 | ~x8))) & (~x3 | x5 | (x1 ? (x7 | x8) : ~x7))) : ((x3 | ((~x7 | (x1 ? (x5 | x8) : (x5 ^ x8))) & (~x1 | x7 | (x5 & x8)))) & (x5 | x7 | x8 | ~x1 | ~x3));
  assign new_n160_ = (x1 | ((x2 | ~x3 | ~x5 | x7 | x8) & (x5 | ((~x7 | ~x8 | x2 | x3) & (~x2 | ((x7 | ~x8) & (x3 | ~x7 | x8))))))) & (x2 | ~x3 | ~x5 | ~x7 | ~x8) & (~x1 | (x2 ? (x7 | (x3 ? (x5 | ~x8) : ~x5)) : ((~x3 | (x5 ? (~x8 & (~x7 | x8)) : (~x7 | ~x8))) & (~x7 | ~x8 | x3 | ~x5))));
  assign new_n161_ = (x0 | x2) & (~new_n90_ | x5 | x6 | ~x0 | ~x2 | ~x3);
  assign z12 = ~new_n163_ | (~new_n169_ & x0) | new_n185_ | (~new_n177_ & ~x0);
  assign new_n163_ = x3 ? ((~new_n167_ | ~x1) & (x0 | ~new_n168_ | x1)) : new_n164_;
  assign new_n164_ = (new_n165_ | x1) & (~new_n166_ | ~x0 | ~x1 | x2);
  assign new_n165_ = (~x5 | x6 | ~x7 | x0 | ~x2 | x4) & (~x0 | ~x4 | ((~x6 | x7 | ~x2 | ~x5) & (x6 | ~x7 | x2 | x5)));
  assign new_n166_ = x6 & x7 & ~x4 & x5;
  assign new_n167_ = ~x5 & ((x0 & ((x6 & x7 & ~x2 & ~x4) | (~x6 & ~x7 & x2 & x4))) | (x4 & ~x6 & ~x7 & ~x0 & ~x2));
  assign new_n168_ = x2 & x5 & (x4 ? (x6 & x7) : (~x6 & ~x7));
  assign new_n169_ = (new_n176_ | (~x7 ^ x8)) & (new_n173_ | ~x7) & (new_n170_ | x7);
  assign new_n170_ = x1 ? new_n171_ : new_n172_;
  assign new_n171_ = (x8 | ((~x2 | x3 | x4 | ~x5) & (x2 | ~x3 | ~x4 | x5))) & (~x2 | ((~x5 | (x3 ? (~x6 | ~x8) : (~x4 | x6))) & (x3 | ~x4 | x5 | ~x6)));
  assign new_n172_ = (x3 | ((~x5 | ~x6 | x8 | x2 | ~x4) & (~x2 | ((x4 | x5) & (~x4 | ~x5 | x6 | ~x8))))) & (x2 | ~x3 | x8 | (x4 ? (~x5 ^ x6) : (x5 | x6)));
  assign new_n173_ = (new_n174_ | ~x5) & (x2 | ~x3 | ~new_n175_ | x5);
  assign new_n174_ = (~x6 | ((~x3 | ((x1 | ~x2 | ~x4 | x8) & (~x1 | (x2 ? ~x4 : (x4 | ~x8))))) & (x1 | x2 | x3 | ~x8))) & (x3 | x6 | ((~x1 | x4 | (~x8 & (x2 | x8))) & (x1 | x2 | ~x4 | ~x8)));
  assign new_n175_ = x8 & (x1 ? ~x6 : (x4 & x6));
  assign new_n176_ = (x4 | x5 | ~x6 | x1 | ~x2 | ~x3) & (x6 | ((x1 | ~x2 | ~x3 | x4 | ~x5) & (~x1 | ((x2 | x3 | x4 | x5) & (~x4 | ~x5 | ~x2 | ~x3)))));
  assign new_n177_ = (new_n178_ | ~x2) & (new_n181_ | x3) & (x1 | x2) & (~x1 | ~new_n184_ | ~x3);
  assign new_n178_ = x3 ? new_n180_ : new_n179_;
  assign new_n179_ = (x8 | ((~x1 | x4 | ~x5 | x6 | x7) & (~x1 | ~x4 | x5 | ~x7) & (x1 | x7 | (~x4 ^ x5)))) & (x5 | (x1 ? (x7 | ~x8 | (~x4 ^ x6)) : (x4 | ~x6))) & (x4 | ~x5 | x6 | x7 | ~x8);
  assign new_n180_ = (~x5 | (x1 ? (~x7 | (x4 ? x6 : x8)) : ((~x7 | ~x8 | ~x4 | x6) & (x7 | x8 | x4 | ~x6)))) & (~x1 | ~x4 | x5 | ~x6 | ~x7);
  assign new_n181_ = (new_n182_ | x6) & (~x1 | x2 | x4 | new_n183_ | ~x6);
  assign new_n182_ = (x1 | x5 | (x4 & (x7 | ~x8))) & (x2 | x4 | ~x5 | ((~x7 | ~x8) & (~x1 | x7 | x8)));
  assign new_n183_ = x5 ? (x7 | x8) : (~x7 | ~x8);
  assign new_n184_ = ~x4 & ((~x7 & ((x6 & (x8 ? x5 : ~x2)) | (~x2 & ~x5 & ~x6 & ~x8))) | (~x2 & ~x5 & ~x6 & x7 & x8));
  assign new_n185_ = new_n186_ & new_n42_ & ~x5 & x6;
  assign new_n186_ = x1 & x2 & ~x3 & x4;
  assign z13 = (~new_n188_ & ~x7) | (~new_n194_ & x7) | (new_n201_ & ~x0);
  assign new_n188_ = x6 ? (x0 ? new_n192_ : new_n193_) : new_n189_;
  assign new_n189_ = x2 ? new_n190_ : new_n191_;
  assign new_n190_ = x1 ? (x0 ? ((x3 | ~x4 | x5) & (~x5 | (x3 ? ~x8 : (x4 | x8)))) : (x5 | ~x8 | (x3 & (~x3 | ~x4)))) : (x0 ? ((x4 | x5) & (~x5 | ~x8 | x3 | ~x4)) : (x8 | (x3 ? (x4 | ~x5) : (~x4 ^ x5))));
  assign new_n191_ = (x8 | (x0 ? (~x4 | ((x1 | x3 | ~x5) & (~x3 | x5))) : (~x1 | x4 | (~x3 & (x3 | ~x5))))) & (x4 | ~x5 | ~x8 | x0 | ~x1 | ~x3);
  assign new_n192_ = x1 ? ((~x2 | ~x4 | x5) & (x4 | (x2 ? (x3 ? (~x5 | ~x8) : (x5 | x8)) : (x3 ? (~x5 | x8) : (x5 | ~x8))))) : ((x5 | ((~x2 | ~x8 | (~x3 ^ x4)) & (x2 | ~x3 | ~x4 | x8))) & (x2 | ~x4 | ~x5 | (~x3 & (x3 | x8))));
  assign new_n193_ = x3 ? (x4 | ((~x5 | (x1 ? x2 : (~x2 | ~x8))) & (x5 | x8 | x1 | ~x2))) : ((~x2 | ((x4 | (x1 ? (~x5 & (x5 | ~x8)) : (~x5 | x8))) & (x5 | ~x8 | x1 | ~x4))) & (~x1 | x2 | x8 | (x4 ^ x5)));
  assign new_n194_ = new_n195_ & (~x3 | (x1 ? new_n199_ : ~new_n200_));
  assign new_n195_ = (~new_n198_ | ~x0) & (x3 | ((new_n196_ | ~x1) & (~x0 | ~new_n197_ | x1)));
  assign new_n196_ = x4 ? ((~x0 | x2 | ~x5 | ~x6 | ~x8) & (x5 | x6 | x8 | x0 | ~x2)) : ((~x6 | (x0 ? (x2 ? (~x5 | ~x8) : x5) : (x2 ? (~x5 | x8) : (x5 | ~x8)))) & (x2 | x6 | (x0 ? (~x5 | x8) : x5)));
  assign new_n197_ = ~x2 & ((~x4 & x5 & ~x6 & x8) | (x6 & (x4 ? ~x5 : (x5 & x8))));
  assign new_n198_ = ~x2 & x5 & ~x6 & x8 & (~x1 ^ ~x4);
  assign new_n199_ = (x4 | (x0 ? (x2 | (x5 ? (x6 ^ x8) : (x6 | ~x8))) : ((~x2 | x8 | (~x5 ^ x6)) & (~x6 | ~x8 | x2 | x5)))) & (~x2 | ~x4 | (x0 ? (x8 | (~x5 ^ x6)) : x5));
  assign new_n200_ = x2 & ((x4 & ((x5 & (x0 ? ~x8 : (~x6 & x8))) | (x6 & x8 & ~x0 & ~x5))) | (x0 & ~x4 & ~x5 & ~x8));
  assign new_n201_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & (~x6 | (x2 & x6))));
  assign z15 = ~x0 & (~new_n203_ | (~new_n210_ & x5) | (new_n211_ & ~x1));
  assign new_n203_ = ~new_n204_ & (new_n207_ | x1) & (~new_n166_ | ~new_n209_ | ~x1);
  assign new_n204_ = ~x5 & ((~new_n205_ & ~x6) | (x2 & ~x3 & ~new_n206_ & x6));
  assign new_n205_ = (x7 | ((x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))) & (x1 | x3 | ~x8))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n206_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n207_ = (~x2 | ~x3 | ~new_n208_ | ~x5) & x2 & (x3 | x4 | x7);
  assign new_n208_ = ~x6 & x7 & ~x8;
  assign new_n209_ = ~x2 & x3;
  assign new_n210_ = x4 ? ((x1 | ~x2 | ~x3 | x6 | x7) & (~x1 | x2 | x3 | ~x6 | ~x7)) : ((~x3 | ((x6 | x7 | x1 | ~x2) & (~x1 | x2 | (~x6 ^ x7)))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n211_ = x2 & x4 & ~x5 & x6 & (x3 | (~x3 & ~x7));
  assign z16 = ~x0 & (~new_n215_ | (~x8 & (~new_n213_ | ~new_n218_)));
  assign new_n213_ = (~new_n214_ | x1) & (~new_n106_ | ~x6 | x7 | ~new_n209_ | ~x1);
  assign new_n214_ = x2 & ~x3 & ((x6 & x7 & x4 & ~x5) | (~x4 & x5 & x7) | (x4 & ~x5 & ~x7));
  assign new_n215_ = (x1 | x2) & (x3 | ((new_n217_ | x1) & (new_n216_ | x5)));
  assign new_n216_ = (~x6 | ((x1 | ~x2 | x4) & (x7 | ~x8 | (x1 ? (~x2 ^ x4) : (~x2 | ~x4))))) & (x1 | x6 | (x4 & (x7 | ~x8) & (~x2 | ~x4 | ~x7)));
  assign new_n217_ = (x4 | x7) & (~x2 | ~x5 | ~x7 | ~x8 | (x4 & (~x4 | ~x6)));
  assign new_n218_ = (~x4 | ~x6 | ~x7 | ~x1 | x2 | x3) & (x4 | x6 | x7 | x1 | ~x2 | ~x3);
