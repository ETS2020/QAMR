...
module FAU ( 
  ...
  assign z14 = x1 ? ~new_n186_ : ~new_n193_;
  assign new_n186_ = (new_n187_ | x3) & ~new_n190_ & (~x3 | (x2 ? new_n192_ : new_n191_));
  assign new_n187_ = x0 ? new_n189_ : new_n188_;
  assign new_n188_ = ((x6 ? (x7 | x8) : (~x7 | ~x8)) | (x2 ? (~x4 | ~x5) : (x4 | x5))) & (~x5 | ((x7 | (x2 ? (x4 ? (~x6 | ~x8) : (x6 | x8)) : (~x4 | (x6 & (~x6 | x8))))) & (~x6 | ~x7 | x8 | ~x2 | x4))) & (x5 | x6 | ((x2 | ~x4 | (~x7 & (x7 | ~x8))) & (x7 | ~x8 | ~x2 | x4)));
  assign new_n189_ = ((x4 ? ~x6 : (x6 | ~x8)) | (x2 ? (~x5 | ~x7) : (x5 | x7))) & (~x5 | ~x7 | ~x8 | x2 | ~x4) & (~x2 | x4 | x5 | x7 | x8) & (x5 | (x2 ? (x6 | x7 | (~x4 & (x4 | ~x8))) : (~x6 | ~x7 | (x4 & (~x4 | x8))))) & (~x6 | x7 | x8 | x2 | ~x4);
  assign new_n190_ = new_n42_ & x5 & x6 & ~x0 & x2 & ~x4;
  assign new_n191_ = x0 ? ((x4 | x5 | ~x6 | ~x7 | x8) & (~x5 | ((x7 | x8 | x4 | ~x6) & (x6 | ((~x7 | ~x8) & (~x4 | (~x8 & (~x7 | x8)))))))) : ((~x7 | ((~x4 | ~x6 | (x5 & x8)) & (x4 | x5 | x6 | ~x8))) & (~x5 | x7 | (x4 ? (x6 ^ x8) : x6)));
  assign new_n192_ = (x5 | ((~x0 | (x6 ? (~x7 ^ x8) : (x7 | x8))) & (x0 | x6 | ~x7) & (~x6 | ~x7 | x8 | x0 | x4))) & (x6 | x7 | ~x8 | ~x0 | x4 | ~x5);
  assign new_n193_ = (new_n202_ | (x4 ? (x5 | ~x7) : (~x5 | x7))) & new_n198_ & (new_n194_ | x5);
  assign new_n194_ = (new_n195_ | ~x3) & ~new_n197_ & (new_n196_ | x3);
  assign new_n195_ = (~x6 | ((~x2 | ((~x4 | ((x0 | x7 | x8) & (~x7 | (~x0 & (x0 | ~x8))))) & (x0 | x4 | x7 | x8))) & (~x0 | x2 | x4 | (~x7 & (x7 | ~x8))))) & (~x0 | x6 | ((~x4 | x7 | x8) & (~x2 | x4 | (~x7 ^ x8))));
  assign new_n196_ = x0 ? ((~x4 | (x2 ? (x6 ? (x7 | ~x8) : (~x7 | x8)) : (~x7 | (x6 ^ x8)))) & (x2 | x4 | (x6 ^ (x7 & x8)))) : ((x6 | x7 | ~x8) & (x4 | (x6 & (x7 | x8))));
  assign new_n197_ = ~x6 & ~x7 & x8 & x0 & x2 & x4;
  assign new_n198_ = (~x5 | (x0 ? new_n199_ : (new_n200_ | ~x2))) & (x2 | (~new_n201_ & x0));
  assign new_n199_ = x4 ? ((x8 | ((~x2 | (x3 ? (x6 | ~x7) : (~x6 | x7))) & (x6 | x7 | x2 | x3))) & (x2 | ~x3 | ~x6 | x7)) : (x2 ? ((x3 | (x6 ? (x7 | x8) : ~x7)) & (~x7 | ~x8 | ~x3 | ~x6)) : ((~x7 | ~x8 | x3 | x6) & (x7 | x8 | ~x3 | ~x6)));
  assign new_n200_ = (x6 | ~x7 | ~x8 | x3 | ~x4) & (~x6 | x8 | (x3 ? ~x7 : (~x4 | x7)));
  assign new_n201_ = ~x6 & ~x7 & ~x8 & x0 & ~x3 & ~x4;
  assign new_n202_ = (x0 | ~x2 | (x3 ? (x6 | ~x8) : (~x6 | x8))) & (~x0 | x2 | ~x3 | ~x6 | ~x8);
  assign z15 = ~x0 & (~new_n204_ | (~new_n210_ & x5) | (new_n211_ & ~x1));
  assign new_n204_ = ~new_n205_ & (new_n208_ | x1) & (~new_n150_ | ~x1 | x2 | ~x3);
  assign new_n205_ = ~x5 & ((~new_n206_ & ~x6) | (x2 & ~x3 & ~new_n207_ & x6));
  assign new_n206_ = (x7 | ((x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))) & (x1 | x3 | ~x8))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n207_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n208_ = (~x2 | ~x3 | ~new_n209_ | ~x5) & x2 & (x3 | x4 | x7);
  ...
  assign z17 = ~x0 & ((~new_n213_ & ~x1) | (~x2 & (~x1 | (~new_n215_ & x1))));
  assign new_n213_ = (new_n214_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
