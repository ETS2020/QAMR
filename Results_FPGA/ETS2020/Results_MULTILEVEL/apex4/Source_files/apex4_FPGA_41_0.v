// Benchmark "FAU" written by ABC on Wed Aug  5 23:28:57 2020
...
module FAU ( 
  ...
  assign z09 = (~new_n146_ & x0) | (~new_n154_ & ~x0) | (x1 & ~new_n161_ & ~x3);
  assign new_n146_ = (new_n147_ | ~x6) & (~new_n153_ | x2) & (x6 | (x2 ? new_n151_ : new_n152_));
  assign new_n147_ = (new_n148_ | ~x1) & ~new_n150_ & (new_n149_ | x1);
  assign new_n148_ = (~x5 | ((x2 | ~x3 | ~x4 | x7 | x8) & (~x2 | x3 | x4 | ~x7 | ~x8))) & (x5 | (x2 ? (x3 ? ~x4 : (x4 | (x7 ^ x8))) : ((~x3 | x4 | ~x7) & (x7 | (x3 ? ~x8 : ~x4))))) & (~x4 | ~x8 | x2 | x3) & (~x2 | ~x3 | x4 | x8);
  assign new_n149_ = (~x2 | (x3 ? (x4 ? (x5 ? (x7 | x8) : ~x8) : (x5 ? (x7 | ~x8) : (~x7 | x8))) : (x4 ? (x5 ? (x7 | x8) : ~x7) : (x5 | x7)))) & (x3 | ((x2 | ((~x7 | ~x8 | x4 | x5) & (~x4 | (x5 ? x8 : (~x7 | ~x8))))) & (x4 | (x5 ? (~x7 | x8) : (x7 | ~x8))))) & (x2 | ~x3 | x5 | (x4 ? (~x7 | ~x8) : x8));
  assign new_n150_ = ~x5 & ((~x3 & ((~x4 & x7 & ~x8) | (~x7 & x8 & ~x2 & x4))) | (x2 & x3 & ~x4 & ~x7 & ~x8));
  assign new_n151_ = ((~x1 ^ x5) | ((x3 | ~x4 | x7 | ~x8) & (~x7 | x8 | ~x3 | x4))) & (x1 | ((~x3 | ((~x4 | ~x5 | (x7 & (~x7 | x8))) & (~x7 | ~x8) & (x5 | (~x8 & (x4 | ~x7 | x8))))) & (x8 | ((~x4 | x5 | ~x7) & (x3 | ((~x5 | x7) & (~x4 | (x5 ^ x7)))))))) & (~x1 | (x3 ? ((~x7 | ~x8 | x4 | x5) & (~x4 | x8 | (~x5 & (x5 | x7)))) : (x4 | (x5 ? (x7 & (~x7 | ~x8)) : x7))));
  assign new_n152_ = (x4 | ((~x3 | ((~x1 | x7 | (~x5 ^ x8)) & (~x7 | (x1 & (~x5 | ~x8))))) & (x1 | ((x3 | x5 | x8) & (~x7 | (x8 ? x3 : ~x5)))) & (~x1 | x3 | x5 | ~x7 | x8))) & (~x1 | ~x3 | ~x5 | x7 | ~x8) & (~x4 | ((~x3 | ((x5 | ~x7 | ~x8) & (~x1 | (x7 ? x8 : x5)))) & (x1 | x3 | ~x7 | (x5 ^ x8))));
  assign new_n153_ = ~x7 & ((~x1 & x3 & (x4 ? (~x5 & x8) : x5)) | (x1 & ~x3 & ~x4 & ~x5 & ~x8));
  assign new_n154_ = (new_n155_ | ~x2) & (~x1 | (new_n160_ & (new_n159_ | x2)));
  assign new_n155_ = (new_n156_ | x8) & new_n158_ & (new_n157_ | ~x8);
  assign new_n156_ = x5 ? (x3 ? ((~x6 | (~x4 ^ ~x7)) & (x1 | ~x4 | x6)) : ((x1 | (x4 ? (x6 & (~x6 | x7)) : x6)) & (~x6 | ~x7 | ~x1 | x4))) : (x6 ? ((x1 | x3 | ~x4) & (~x1 | ~x3 | x4) & (~x4 | (x1 ? (x3 | x7) : (~x3 | ~x7)))) : ((~x1 | ((x4 | x7) & (x3 | ~x4 | ~x7))) & (x1 | ~x3 | ~x4 | x7)));
  assign new_n157_ = (~x1 | ((x4 | ((~x6 | x7 | x3 | x5) & (~x3 | ~x7 | (~x6 & (~x5 | x6))))) & (x3 | ~x4 | (x5 ? ~x6 : (x6 ^ x7))))) & (x5 | ((x1 | ((x3 | ~x7 | (x4 & (~x4 | ~x6))) & (x7 | (~x6 & (~x3 | ~x4 | x6))))) & (~x3 | ~x6 | (~x4 ^ x7)))) & (~x4 | x7 | ((x3 | ~x5 | x6) & (x1 | (x3 ? (~x5 | x6) : ~x6))));
  assign new_n158_ = (~x1 | ~x3 | (~x5 ^ x7) | (x4 ^ x6)) & (x1 | x3 | x4 | x5 | ~x6);
  assign new_n159_ = (x7 | (x4 ? ((x3 | x5 | ~x8) & (~x3 | ~x5 | x8) & (x6 | ~x8 | ~x3 | x5) & (x3 | ~x6 | x8)) : (((~x5 ^ x6) | (~x3 & (x3 | x8))) & (x3 | ~x6 | (~x5 ^ x8)) & (~x3 | x5 | x6 | x8)))) & (x4 | (x3 ? (x6 | (x5 ? (~x7 | x8) : ~x8)) : (~x6 | ~x7 | (x5 & (~x5 | ~x8))))) & (~x4 | ~x7 | ((x5 | (x3 ? (~x6 & (x6 | x8)) : ~x6)) & (x3 | ~x5 | ~x6)));
  assign new_n160_ = (~x8 | ((~x3 | ((~x4 | x6 | ~x7) & (x4 | ~x5 | ~x6 | x7))) & (x3 | x4 | ~x5 | x6 | ~x7))) & (x6 | x7 | x8 | x3 | ~x4 | ~x5);
  assign new_n161_ = (x5 | ((~x2 | ((~x7 | x8 | x4 | x6) & (x7 | ~x8 | ~x4 | ~x6))) & (~x7 | ~x8 | ~x4 | x6))) & (~x2 | x4 | ~x5 | x6 | ~x7 | x8);
  assign z10 = new_n163_ | new_n166_ | ~new_n181_ | (~new_n175_ & x0);
  assign new_n163_ = (~x5 ^ x8) & (new_n164_ | (new_n165_ & x0));
  assign new_n164_ = new_n131_ & x3 & x4 & ~x0 & ~x1 & x2;
  assign new_n165_ = ~x2 & x6 & ((~x4 & ~x7 & ~x1 & x3) | (x1 & ~x3 & x4 & x7));
  assign new_n166_ = ~x3 & ((~new_n167_ & x4) | (~new_n174_ & ~x6) | (~new_n170_ & ~x4));
  assign new_n167_ = x2 ? new_n168_ : new_n169_;
  assign new_n168_ = (x0 | (x8 ? ((x1 | ((~x6 | x7) & (x5 | (x6 & (~x6 | ~x7))))) & (x6 | x7 | ~x1 | x5)) : ((x6 | (x1 ? ~x7 : ~x5)) & (x5 | ~x6 | (x1 & (~x1 | ~x7)))))) & (~x6 | x7 | ~x8 | ~x1 | x5) & (~x0 | (x1 ? ((~x5 | (x6 ? ~x7 : (x7 | ~x8))) & (~x8 | ((~x6 | ~x7) & (x5 | x6 | x7)))) : ((~x7 | x8 | ~x5 | x6) & (x5 | (x6 ? ~x8 : (x7 | x8))))));
  assign new_n169_ = (~x6 | (((x7 ^ x8) | (x0 ? (x1 | ~x5) : (~x1 | x5))) & (x0 | ~x1 | x5 | (~x7 ^ x8)))) & (~x0 | x5 | x6 | x8) & (~x1 | ((~x0 | ~x5 | x8) & (x6 | ~x7 | (x0 ? (x5 & (~x5 | ~x8)) : x5))));
  assign new_n170_ = (new_n171_ | ~x0) & ~new_n173_ & (new_n172_ | x0);
  assign new_n171_ = (x5 | ((x1 | (x2 ? ((x7 | x8) & (~x6 | ~x7 | ~x8)) : (x6 ? x8 : (~x7 | ~x8)))) & (~x1 | ~x2 | ~x6 | x7 | ~x8) & (x6 | ((~x1 | (x2 ? x7 : (~x7 | x8))) & (x2 | x7 | x8))))) & (~x5 | (x7 ? ((~x2 | (x1 & (~x1 | ~x6 | x8))) & (~x1 | x2 | (x6 ^ x8))) : (x1 ? (~x2 | x6) : ~x6))) & (x7 | ~x8 | x1 | x6);
  assign new_n172_ = (~x8 | ((~x2 | x6 | (x7 ? ~x1 : ~x5)) & (~x1 | x2 | (x5 ? (x7 & (~x6 | ~x7)) : (~x6 | ~x7))))) & (~x1 | x8 | ((~x7 | ((x5 | ~x6) & (x2 | (~x5 ^ ~x6)))) & (~x5 | (x6 ? x7 : x2))));
  assign new_n173_ = x1 & ~x8 & ((~x2 & ((~x5 & x6 & x7) | (~x6 & ~x7))) | (x2 & ~x5 & ~x6 & x7));
  assign new_n174_ = (x1 | ~x2 | (x0 ? (~x7 | ~x8) : (~x5 | x7))) & (x5 | x7 | x8 | ~x1 | x2);
  assign new_n175_ = (new_n176_ | ~x1) & (~new_n180_ | ~x3) & (x1 | (new_n179_ & (new_n178_ | ~x3)));
  assign new_n176_ = (new_n177_ | ~x3) & (x2 | ~x4 | ~new_n42_ | ~x5);
  assign new_n177_ = x5 ? ((~x4 | ((x7 | ~x8 | ~x2 | ~x6) & (~x7 | x8 | x2 | x6))) & (x2 | ((x6 | x7 | ~x8) & (x4 | ~x7 | x8))) & (~x2 | ((x6 | x7) & (x4 | ~x6 | (x8 & (x7 | ~x8)))))) : ((x4 | ((x2 | x7 | x8) & (~x7 | (x2 ? (x6 ^ x8) : (~x6 | x8))))) & (~x2 | ~x4 | x7 | ~x8));
  assign new_n178_ = (~x7 | (x2 ? (~x4 | (x5 ? (x6 | x8) : (x6 & (~x6 | x8)))) : ((x4 | (x6 & (x5 | ~x6 | ~x8))) & (~x4 | x5 | ~x6 | ~x8)))) & (~x4 | (x2 ? (~x5 | x7 | (~x6 ^ x8)) : (x6 | ~x8)));
  assign new_n179_ = x2 ? ((x4 | ~x5 | ~x6 | ~x7 | x8) & (x6 | x7 | ~x8 | ~x4 | x5)) : (~x5 | x6 | ~x7 | (~x4 ^ ~x8));
  assign new_n180_ = ~x6 & ((~x2 & ~x5 & ~x8 & (~x4 ^ ~x7)) | (x2 & ~x4 & x5 & x7));
  assign new_n181_ = (x0 | (~new_n185_ & (new_n182_ | ~x2))) & (~x2 | new_n188_ | ~x8);
  assign new_n182_ = (new_n183_ | ~x6) & (~x3 | new_n184_ | x6);
  assign new_n183_ = (~x5 | ((~x3 | ((x1 | ~x7 | ~x8) & (x7 | (x1 ? (~x4 & (x4 | x8)) : (x4 | x8))))) & (~x4 | ~x7 | (~x1 ^ ~x8)))) & (~x3 | x5 | x8 | ((~x1 | ~x4 | ~x7) & (x4 | (~x7 & (x1 | x7)))));
  assign new_n184_ = x5 ? (x7 | x8 | (~x1 & (x1 | ~x4))) : ((~x7 & (x7 | x8)) | (x1 ^ x4));
  assign new_n185_ = x1 & (new_n187_ | (~new_n186_ & ~x2));
  assign new_n186_ = (x4 | x5 | ~x6 | ~x7 | x8) & (~x3 | (x4 ? (~x5 | x7 | (x6 & (~x6 | ~x8))) : (x5 ? (~x6 | ~x7) : (x6 ? (x7 | ~x8) : (~x7 | x8)))));
  assign new_n187_ = x6 & ~x7 & ~x8 & x3 & x4 & ~x5;
  assign new_n188_ = x1 ? ((x4 | ~x5 | ~x7) & (~x3 | x5 | (x4 ? (x6 | ~x7) : x7))) : ((~x6 | ~x7 | ~x4 | ~x5) & (x5 | x6 | x7 | ~x3 | x4));
  assign z12 = ~new_n190_ | (~new_n197_ & x0) | new_n213_ | (~new_n205_ & ~x0);
  assign new_n190_ = x3 ? ((~new_n195_ | ~x1) & (x0 | ~new_n196_ | x1)) : new_n191_;
  assign new_n191_ = (new_n194_ | x1) & (~new_n192_ | ~new_n193_ | ~x0 | ~x1 | x2);
  assign new_n192_ = x6 & x7;
  assign new_n193_ = ~x4 & x5;
  assign new_n194_ = (~x5 | x6 | ~x7 | x0 | ~x2 | x4) & (~x0 | ~x4 | ((~x6 | x7 | ~x2 | ~x5) & (x6 | ~x7 | x2 | x5)));
  assign new_n195_ = ~x5 & ((x0 & ((x6 & x7 & ~x2 & ~x4) | (~x6 & ~x7 & x2 & x4))) | (x4 & ~x6 & ~x7 & ~x0 & ~x2));
  assign new_n196_ = x2 & x5 & (x4 ? (x6 & x7) : (~x6 & ~x7));
  assign new_n197_ = (new_n204_ | (~x7 ^ x8)) & (new_n201_ | ~x7) & (new_n198_ | x7);
  assign new_n198_ = x1 ? new_n199_ : new_n200_;
  assign new_n199_ = (x8 | ((~x2 | x3 | x4 | ~x5) & (x2 | ~x3 | ~x4 | x5))) & (~x2 | ((~x5 | (x3 ? (~x6 | ~x8) : (~x4 | x6))) & (x3 | ~x4 | x5 | ~x6)));
  assign new_n200_ = (x3 | ((~x5 | ~x6 | x8 | x2 | ~x4) & (~x2 | ((x4 | x5) & (~x4 | ~x5 | x6 | ~x8))))) & (x2 | ~x3 | x8 | (x4 ? (~x5 ^ x6) : (x5 | x6)));
  assign new_n201_ = (new_n202_ | ~x5) & (x2 | ~x3 | ~new_n203_ | x5);
  assign new_n202_ = (~x6 | ((~x3 | ((x1 | ~x2 | ~x4 | x8) & (~x1 | (x2 ? ~x4 : (x4 | ~x8))))) & (x1 | x2 | x3 | ~x8))) & (x3 | x6 | ((~x1 | x4 | (~x8 & (x2 | x8))) & (x1 | x2 | ~x4 | ~x8)));
  assign new_n203_ = x8 & (x1 ? ~x6 : (x4 & x6));
  assign new_n204_ = (x4 | x5 | ~x6 | x1 | ~x2 | ~x3) & (x6 | ((x1 | ~x2 | ~x3 | x4 | ~x5) & (~x1 | ((x2 | x3 | x4 | x5) & (~x4 | ~x5 | ~x2 | ~x3)))));
  assign new_n205_ = (new_n206_ | ~x2) & (new_n209_ | x3) & (x1 | x2) & (~x1 | ~new_n212_ | ~x3);
  assign new_n206_ = x3 ? new_n208_ : new_n207_;
  assign new_n207_ = (x8 | ((~x1 | x4 | ~x5 | x6 | x7) & (~x1 | ~x4 | x5 | ~x7) & (x1 | x7 | (~x4 ^ x5)))) & (x5 | (x1 ? (x7 | ~x8 | (~x4 ^ x6)) : (x4 | ~x6))) & (x4 | ~x5 | x6 | x7 | ~x8);
  assign new_n208_ = (~x5 | (x1 ? (~x7 | (x4 ? x6 : x8)) : ((~x7 | ~x8 | ~x4 | x6) & (x7 | x8 | x4 | ~x6)))) & (~x1 | ~x4 | x5 | ~x6 | ~x7);
  assign new_n209_ = (new_n210_ | x6) & (~x1 | x2 | x4 | new_n211_ | ~x6);
  assign new_n210_ = (x1 | x5 | (x4 & (x7 | ~x8))) & (x2 | x4 | ~x5 | ((~x7 | ~x8) & (~x1 | x7 | x8)));
  assign new_n211_ = x5 ? (x7 | x8) : (~x7 | ~x8);
  assign new_n212_ = ~x4 & ((~x7 & ((x6 & (x8 ? x5 : ~x2)) | (~x2 & ~x5 & ~x6 & ~x8))) | (~x2 & ~x5 & ~x6 & x7 & x8));
  assign new_n213_ = new_n90_ & x1 & x2 & new_n42_ & ~x5 & x6;
  assign z13 = (~new_n215_ & ~x7) | (~new_n221_ & x7) | (new_n228_ & ~x0);
  assign new_n215_ = x6 ? (x0 ? new_n219_ : new_n220_) : new_n216_;
  assign new_n216_ = x2 ? new_n217_ : new_n218_;
  assign new_n217_ = x1 ? (x0 ? ((x3 | ~x4 | x5) & (~x5 | (x3 ? ~x8 : (x4 | x8)))) : (x5 | ~x8 | (x3 & (~x3 | ~x4)))) : (x0 ? ((x4 | x5) & (~x5 | ~x8 | x3 | ~x4)) : (x8 | (x3 ? (x4 | ~x5) : (~x4 ^ x5))));
  assign new_n218_ = (x8 | (x0 ? (~x4 | ((x1 | x3 | ~x5) & (~x3 | x5))) : (~x1 | x4 | (~x3 & (x3 | ~x5))))) & (x4 | ~x5 | ~x8 | x0 | ~x1 | ~x3);
  assign new_n219_ = x1 ? ((~x2 | ~x4 | x5) & (x4 | (x2 ? (x3 ? (~x5 | ~x8) : (x5 | x8)) : (x3 ? (~x5 | x8) : (x5 | ~x8))))) : ((x5 | ((x2 | ~x3 | ~x4 | x8) & (~x2 | ~x8 | (~x3 ^ x4)))) & (x2 | ~x4 | ~x5 | (~x3 & (x3 | x8))));
  assign new_n220_ = x3 ? (x4 | ((~x5 | (x1 ? x2 : (~x2 | ~x8))) & (x5 | x8 | x1 | ~x2))) : ((~x2 | ((x4 | (x1 ? (~x5 & (x5 | ~x8)) : (~x5 | x8))) & (x5 | ~x8 | x1 | ~x4))) & (~x1 | x2 | x8 | (x4 ^ x5)));
  assign new_n221_ = new_n222_ & (~x3 | (x1 ? new_n226_ : ~new_n227_));
  assign new_n222_ = (~new_n225_ | ~x0) & (x3 | ((new_n223_ | ~x1) & (~x0 | ~new_n224_ | x1)));
  assign new_n223_ = x4 ? ((~x0 | x2 | ~x5 | ~x6 | ~x8) & (x5 | x6 | x8 | x0 | ~x2)) : ((~x6 | (x0 ? (x2 ? (~x5 | ~x8) : x5) : (x2 ? (~x5 | x8) : (x5 | ~x8)))) & (x2 | x6 | (x0 ? (~x5 | x8) : x5)));
  assign new_n224_ = ~x2 & ((~x4 & x5 & ~x6 & x8) | (x6 & (x4 ? ~x5 : (x5 & x8))));
  assign new_n225_ = ~x2 & x5 & ~x6 & x8 & (~x1 ^ ~x4);
  assign new_n226_ = (x4 | (x0 ? (x2 | (x5 ? (x6 ^ x8) : (x6 | ~x8))) : ((~x2 | x8 | (~x5 ^ x6)) & (~x6 | ~x8 | x2 | x5)))) & (~x2 | ~x4 | (x0 ? (x8 | (~x5 ^ x6)) : x5));
  assign new_n227_ = x2 & ((x4 & ((x5 & (x0 ? ~x8 : (~x6 & x8))) | (x6 & x8 & ~x0 & ~x5))) | (x0 & ~x4 & ~x5 & ~x8));
  assign new_n228_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & (~x6 | (x2 & x6))));
  assign z15 = ~x0 & (~new_n233_ | ~new_n230_ | new_n236_);
  assign new_n230_ = (new_n231_ | x1) & (~new_n192_ | ~new_n193_ | ~x1 | x2 | ~x3);
  assign new_n231_ = (~x2 | ~new_n232_ | ~x3) & x2 & (x3 | x4 | x7);
  assign new_n232_ = x5 & ~x6 & x7 & ~x8;
  assign new_n233_ = (new_n234_ | ~x5) & (x1 | ~x2 | ~x4 | ~new_n235_ | x5);
  assign new_n234_ = x4 ? ((x1 | ~x2 | ~x3 | x6 | x7) & (~x1 | x2 | x3 | ~x6 | ~x7)) : ((~x3 | ((x6 | x7 | x1 | ~x2) & (~x1 | x2 | (~x6 ^ x7)))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n235_ = x6 & (x3 | (~x3 & ~x7));
  assign new_n236_ = ~x5 & ((~new_n237_ & ~x6) | (x2 & ~x3 & ~new_n238_ & x6));
  assign new_n237_ = (x7 | ((x1 | x3 | ~x8) & (x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n238_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign z17 = ~x0 & ((~new_n240_ & ~x1) | (~x2 & (~x1 | (~new_n242_ & x1))));
  assign new_n240_ = (new_n241_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n241_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n242_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
