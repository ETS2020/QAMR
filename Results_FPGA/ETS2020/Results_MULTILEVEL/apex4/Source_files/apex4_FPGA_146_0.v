// Benchmark "FAU" written by ABC on Wed Aug  5 23:31:31 2020
...
module FAU ( 
  ...
  assign new_n64_ = new_n65_ & new_n39_ & ~x7 & ~x8;
  assign new_n65_ = x1 & ~x2 & ~x3 & x4;
  assign z07 = (~new_n67_ & x0) | (~new_n91_ & x7) | (~x0 & (~new_n80_ | new_n89_));
  assign new_n67_ = (new_n68_ | x8) & ~new_n77_ & (~x8 | (new_n72_ & new_n79_));
  assign new_n68_ = (new_n69_ | x1) & ~new_n71_ & (new_n70_ | ~x1);
  ...
  assign new_n72_ = (new_n74_ | x4) & (new_n75_ | ~x4) & (~new_n76_ | ~new_n73_ | ~x5);
  ...
  assign new_n76_ = x1 & ~x2 & x3;
  assign new_n77_ = new_n78_ & x1 & ~x2 & ~x3;
  assign new_n78_ = x4 & ~x5 & x6 & ~x7;
  assign new_n79_ = (x4 | ((~x1 | ((~x5 | ~x7 | ~x2 | x3) & (x2 | ~x3 | x5 | x7))) & (x1 | ~x2 | ~x3 | x5 | x7))) & (x1 | ~x4 | ((x5 | ~x7 | x2 | x3) & (~x5 | x7 | ~x2 | ~x3)));
  assign new_n80_ = new_n81_ & (new_n83_ | ~x6) & (x6 | (x5 ? new_n87_ : new_n88_));
  assign new_n81_ = (~new_n82_ | x1) & (~new_n76_ | ~new_n73_ | ~x4 | ~x5);
  assign new_n82_ = x2 & x7 & ((x3 & x4 & (~x5 ^ x6)) | (~x3 & ~x4 & x5 & ~x6));
  ...
  assign new_n89_ = ~new_n90_ & (x6 ? (x7 & ~x8) : (~x7 & x8));
  assign new_n90_ = (~x1 | x3 | ~x4 | x5) & (x1 | ~x2 | ~x3 | x4 | ~x5);
  assign new_n91_ = (~x1 | ~new_n92_ | x3) & (~new_n93_ | x1 | ~x2 | ~x3);
  assign new_n92_ = ~x4 & ~x8 & (x2 ? (x5 & ~x6) : (~x5 & x6));
  assign new_n93_ = x4 & x5 & ~x6 & x8;
  assign z10 = new_n95_ | new_n98_ | ~new_n113_ | (~new_n107_ & x0);
  assign new_n95_ = (~x5 ^ x8) & (new_n96_ | (new_n97_ & x0));
  assign new_n96_ = new_n73_ & x3 & x4 & ~x0 & ~x1 & x2;
  ...
  assign new_n103_ = (x5 | ((x1 | (x2 ? ((x7 | x8) & (~x6 | ~x7 | ~x8)) : (x6 ? x8 : (~x7 | ~x8)))) & (x6 | ((~x1 | (x2 ? x7 : (~x7 | x8))) & (x2 | x7 | x8))) & (~x1 | ~x2 | ~x6 | x7 | ~x8))) & (~x5 | (x7 ? ((~x2 | (x1 & (~x1 | ~x6 | x8))) & (~x1 | x2 | (x6 ^ x8))) : (x1 ? (~x2 | x6) : ~x6))) & (x7 | ~x8 | x1 | x6);
  ...
  assign new_n144_ = new_n145_ & new_n42_ & ~x5 & x6;
  assign new_n145_ = x1 & x2 & ~x3 & x4;
  assign z15 = ~x0 & (~new_n147_ | (~new_n153_ & x5) | (new_n154_ & ~x1));
  assign new_n147_ = ~new_n148_ & (~new_n76_ | ~new_n125_) & (new_n151_ | x1);
  assign new_n148_ = ~x5 & ((~new_n149_ & ~x6) | (x2 & ~x3 & ~new_n150_ & x6));
  assign new_n149_ = (x7 | ((x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))) & (x1 | x3 | ~x8))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n150_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n151_ = (~x2 | ~x3 | ~new_n152_ | ~x5) & x2 & (x3 | x4 | x7);
  assign new_n152_ = ~x6 & x7 & ~x8;
  assign new_n153_ = x4 ? ((x1 | ~x2 | ~x3 | x6 | x7) & (~x1 | x2 | x3 | ~x6 | ~x7)) : ((~x3 | ((~x1 | x2 | (~x6 ^ x7)) & (x6 | x7 | x1 | ~x2))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n154_ = x2 & x4 & ~x5 & x6 & (x3 | (~x3 & ~x7));
  assign z17 = ~x0 & ((~new_n156_ & ~x1) | (~x2 & (~x1 | (~new_n158_ & x1))));
  assign new_n156_ = (new_n157_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n157_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n158_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
