...
module FAU ( 
  ...
  assign z07 = (~new_n92_ & x0) | new_n114_ | (~x0 & (~new_n103_ | new_n117_));
  assign new_n92_ = ~new_n93_ & ~new_n97_ & (~new_n102_ | ~x1 | x2 | x3);
  assign new_n93_ = ~x8 & ((~new_n94_ & ~x1) | new_n96_ | (~new_n95_ & x1));
  ...
  assign new_n97_ = x8 & (~new_n98_ | (~new_n99_ & ~x4) | new_n101_ | (~new_n100_ & x4));
  assign new_n98_ = (x4 | ((~x1 | ((~x5 | ~x7 | ~x2 | x3) & (x2 | ~x3 | x5 | x7))) & (x1 | ~x2 | ~x3 | x5 | x7))) & (x1 | ~x4 | ((x5 | ~x7 | x2 | x3) & (~x5 | x7 | ~x2 | ~x3)));
  ...
  assign new_n101_ = x5 & ~x6 & ~x7 & x1 & ~x2 & x3;
  assign new_n102_ = x4 & ~x5 & x6 & ~x7;
  assign new_n103_ = new_n104_ & (new_n108_ | ~x6) & (x6 | (x5 ? new_n112_ : new_n113_));
  assign new_n104_ = (x1 | ~new_n107_ | ~x2) & (~new_n105_ | ~new_n106_ | ~x1 | x2 | ~x3);
  assign new_n105_ = ~x6 & ~x7;
  assign new_n106_ = x4 & x5;
  assign new_n107_ = x7 & ((x3 & x4 & (x5 ^ ~x6)) | (~x3 & ~x4 & x5 & ~x6));
  ...
  assign new_n114_ = x7 & ((x1 & new_n116_ & ~x3) | (new_n115_ & ~x1 & x2 & x3));
  assign new_n115_ = new_n106_ & ~x6 & x8;
  assign new_n116_ = ~x4 & ~x8 & (x2 ? (x5 & ~x6) : (~x5 & x6));
  assign new_n117_ = ~new_n118_ & (x6 ? (x7 & ~x8) : (~x7 & x8));
  assign new_n118_ = (~x1 | x3 | ~x4 | x5) & (x1 | ~x2 | ~x3 | x4 | ~x5);
  assign z10 = new_n120_ | new_n123_ | ~new_n138_ | (~new_n132_ & x0);
  assign new_n120_ = (~x5 ^ x8) & (new_n121_ | (new_n122_ & x0));
  assign new_n121_ = new_n105_ & x3 & x4 & ~x0 & ~x1 & x2;
  ...
  assign new_n128_ = (x5 | ((x1 | (x2 ? ((x7 | x8) & (~x6 | ~x7 | ~x8)) : (x6 ? x8 : (~x7 | ~x8)))) & (~x1 | ~x2 | ~x6 | x7 | ~x8) & (x6 | ((~x1 | (x2 ? x7 : (~x7 | x8))) & (x2 | x7 | x8))))) & (~x5 | (x7 ? ((~x2 | (x1 & (~x1 | ~x6 | x8))) & (~x1 | x2 | (x6 ^ x8))) : (x1 ? (~x2 | x6) : ~x6))) & (x7 | ~x8 | x1 | x6);
  ...
  assign z13 = (~new_n171_ & ~x7) | (~new_n177_ & x7) | (new_n184_ & ~x0);
  assign new_n171_ = x6 ? (x0 ? new_n175_ : new_n176_) : new_n172_;
  assign new_n172_ = x2 ? new_n173_ : new_n174_;
  assign new_n173_ = x1 ? (x0 ? ((x3 | ~x4 | x5) & (~x5 | (x3 ? ~x8 : (x4 | x8)))) : (x5 | ~x8 | (x3 & (~x3 | ~x4)))) : (x0 ? ((x4 | x5) & (~x5 | ~x8 | x3 | ~x4)) : (x8 | (x3 ? (x4 | ~x5) : (~x4 ^ x5))));
  assign new_n174_ = (x8 | (x0 ? (~x4 | ((x1 | x3 | ~x5) & (~x3 | x5))) : (~x1 | x4 | (~x3 & (x3 | ~x5))))) & (x4 | ~x5 | ~x8 | x0 | ~x1 | ~x3);
  assign new_n175_ = x1 ? ((~x2 | ~x4 | x5) & (x4 | (x2 ? (x3 ? (~x5 | ~x8) : (x5 | x8)) : (x3 ? (~x5 | x8) : (x5 | ~x8))))) : ((x5 | ((~x2 | ~x8 | (~x3 ^ x4)) & (x2 | ~x3 | ~x4 | x8))) & (x2 | ~x4 | ~x5 | (~x3 & (x3 | x8))));
  assign new_n176_ = x3 ? (x4 | ((~x5 | (x1 ? x2 : (~x2 | ~x8))) & (x5 | x8 | x1 | ~x2))) : ((~x2 | ((x4 | (x1 ? (~x5 & (x5 | ~x8)) : (~x5 | x8))) & (x5 | ~x8 | x1 | ~x4))) & (~x1 | x2 | x8 | (x4 ^ x5)));
  assign new_n177_ = new_n178_ & (~x3 | (x1 ? new_n182_ : ~new_n183_));
  assign new_n178_ = (~new_n181_ | ~x0) & (x3 | ((new_n179_ | ~x1) & (~x0 | ~new_n180_ | x1)));
  assign new_n179_ = x4 ? ((~x0 | x2 | ~x5 | ~x6 | ~x8) & (x5 | x6 | x8 | x0 | ~x2)) : ((~x6 | (x0 ? (x2 ? (~x5 | ~x8) : x5) : (x2 ? (~x5 | x8) : (x5 | ~x8)))) & (x2 | x6 | (x0 ? (~x5 | x8) : x5)));
  assign new_n180_ = ~x2 & ((~x4 & x5 & ~x6 & x8) | (x6 & (x4 ? ~x5 : (x5 & x8))));
  assign new_n181_ = ~x2 & x5 & ~x6 & x8 & (~x1 ^ ~x4);
  assign new_n182_ = (x4 | (x0 ? (x2 | (x5 ? (x6 ^ x8) : (x6 | ~x8))) : ((~x2 | x8 | (~x5 ^ x6)) & (~x6 | ~x8 | x2 | x5)))) & (~x2 | ~x4 | (x0 ? (x8 | (~x5 ^ x6)) : x5));
  assign new_n183_ = x2 & ((x4 & ((x5 & (x0 ? ~x8 : (~x6 & x8))) | (x6 & x8 & ~x0 & ~x5))) | (x0 & ~x4 & ~x5 & ~x8));
  assign new_n184_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & (~x6 | (x2 & x6))));
  assign z15 = ~x0 & (~new_n186_ | (~new_n192_ & x5) | (new_n193_ & ~x1));
  assign new_n186_ = ~new_n187_ & (new_n190_ | x1) & (~new_n150_ | ~x1 | x2 | ~x3);
  assign new_n187_ = ~x5 & ((~new_n188_ & ~x6) | (x2 & ~x3 & ~new_n189_ & x6));
  assign new_n188_ = (x7 | ((x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))) & (x1 | x3 | ~x8))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n189_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n190_ = (~x2 | ~x3 | ~new_n191_ | ~x5) & x2 & (x3 | x4 | x7);
  assign new_n191_ = ~x6 & x7 & ~x8;
  assign new_n192_ = x4 ? ((x1 | ~x2 | ~x3 | x6 | x7) & (~x1 | x2 | x3 | ~x6 | ~x7)) : ((~x3 | ((x6 | x7 | x1 | ~x2) & (~x1 | x2 | (~x6 ^ x7)))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n193_ = x2 & x4 & ~x5 & x6 & (x3 | (~x3 & ~x7));
  assign z17 = ~x0 & ((~new_n195_ & ~x1) | (~x2 & (~x1 | (~new_n197_ & x1))));
  assign new_n195_ = (new_n196_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n196_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n197_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
