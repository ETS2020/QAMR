...
module FAU ( 
  ...
  assign z11 = (~new_n155_ & ~x4) | (~new_n169_ & ~x1) | (~new_n163_ & x4);
  assign new_n155_ = (new_n162_ | (x7 ^ x8)) & (new_n159_ | ~x3) & (new_n156_ | x3);
  assign new_n156_ = x6 ? new_n158_ : new_n157_;
  assign new_n157_ = ((x2 ^ ~x7) | ((x0 | ~x5 | ~x8) & (~x0 | ~x1 | x5 | x8))) & (x5 | (x0 ? ((x1 | x2 | (x7 & x8)) & (x7 | ~x8 | ~x1 | ~x2)) : (x1 & (~x7 | x8 | ~x1 | x2)))) & (x1 | ((~x0 | (x2 ? (~x5 | ~x7) : (x7 | x8))) & (~x5 | ~x7 | x8 | x0 | ~x2)));
  assign new_n158_ = x1 ? ((~x0 | x2 | (x5 ? ~x7 : (x7 | ~x8))) & (x7 | x8 | x0 | ~x5)) : ((x5 | ~x7 | ~x8 | ~x0 | x2) & (~x2 | ((x0 | x5) & (x7 | (x0 ? (x5 & (~x5 | x8)) : (~x5 | x8))))));
  assign new_n159_ = (new_n160_ | ~x2) & (~x0 | new_n161_ | x2);
  assign new_n160_ = ((~x7 ^ x8) | ((~x5 | ~x6 | x0 | x1) & (~x0 | (x1 ? (x5 | ~x6) : (~x5 | x6))))) & (~x0 | ((~x6 | ~x7 | ~x8 | x1 | ~x5) & (x6 | x7 | x8 | ~x1 | x5))) & (x0 | ((x1 | ~x5 | ~x6 | x7 | x8) & (~x1 | ~x7 | (x5 ? (~x6 | x8) : x6))));
  assign new_n161_ = (~x7 | (x1 ? (x5 ? (x6 | x8) : (~x6 | ~x8)) : (x5 | ~x6))) & (x1 | x7 | ((~x6 | (~x5 & (x5 | ~x8))) & (x5 | x6 | x8)));
  assign new_n162_ = (x3 | ~x5 | ~x6 | ~x0 | ~x1 | ~x2) & (x0 | ((~x3 | x5 | ~x6 | ~x1 | x2) & (x1 | ~x2 | x3 | ~x5 | x6)));
  assign new_n163_ = x0 ? (x6 ? new_n167_ : new_n168_) : new_n164_;
  assign new_n164_ = (new_n165_ | ~x2) & (~x1 | new_n166_ | x2);
  assign new_n165_ = x1 ? ((x6 | ((~x7 | ~x8 | x3 | ~x5) & (~x3 | (x5 ? ~x7 : (x7 | ~x8))))) & (x3 | ~x6 | ((x5 | ~x7 | x8) & (x7 | (~x8 & (~x5 | x8)))))) : (((x6 ? (x7 | x8) : (~x7 | ~x8)) | (~x3 ^ x5)) & (~x6 | ((x3 | x5 | x7) & (~x7 | (x3 ? (~x5 | ~x8) : (x5 | x8))))));
  assign new_n166_ = x3 ? ((x7 | (x5 ? (x6 ^ x8) : x6)) & (~x6 | ~x7 | (x5 & x8))) : (x6 | (x5 ? x7 : (~x7 & (x7 | ~x8))));
  assign new_n167_ = x2 ? ((~x5 | ((~x1 | (x3 ? (~x7 & (x7 | ~x8)) : ~x7)) & (x1 | x3 | x7 | ~x8))) & (~x3 | x5 | (x1 ? (x7 | x8) : ~x7))) : ((x3 | ((~x7 | (x1 ? (x5 | x8) : (~x5 ^ ~x8))) & (~x1 | x7 | (x5 & x8)))) & (x5 | x7 | x8 | ~x1 | ~x3));
  assign new_n168_ = (x1 | ((x2 | ~x3 | ~x5 | x7 | x8) & (x5 | ((~x2 | ((x7 | ~x8) & (x3 | ~x7 | x8))) & (~x7 | ~x8 | x2 | x3))))) & (~x5 | ~x7 | ~x8 | x2 | ~x3) & (~x1 | (x2 ? (x7 | (x3 ? (x5 | ~x8) : ~x5)) : ((~x3 | (x5 ? (~x8 & (~x7 | x8)) : (~x7 | ~x8))) & (~x7 | ~x8 | x3 | ~x5))));
  assign new_n169_ = (x0 | x2) & (~new_n89_ | x5 | x6 | ~x0 | ~x2 | ~x3);
  assign z14 = x1 ? ~new_n171_ : (new_n186_ | ~new_n182_ | (~new_n178_ & ~x5));
  assign new_n171_ = (new_n172_ | x3) & ~new_n175_ & (~x3 | (x2 ? new_n177_ : new_n176_));
  assign new_n172_ = x0 ? new_n174_ : new_n173_;
  assign new_n173_ = ((x6 ? (x7 | x8) : (~x7 | ~x8)) | (x2 ? (~x4 | ~x5) : (x4 | x5))) & (~x5 | ((x7 | (x2 ? (x4 ? (~x6 | ~x8) : (x6 | x8)) : (~x4 | (x6 & (~x6 | x8))))) & (~x6 | ~x7 | x8 | ~x2 | x4))) & (x5 | x6 | ((x2 | ~x4 | (~x7 & (x7 | ~x8))) & (x7 | ~x8 | ~x2 | x4)));
  assign new_n174_ = ((x4 ? ~x6 : (x6 | ~x8)) | (x2 ? (~x5 | ~x7) : (x5 | x7))) & (x2 | ~x4 | ~x5 | ~x7 | ~x8) & (~x2 | x4 | x5 | x7 | x8) & (~x6 | x7 | x8 | x2 | ~x4) & (x5 | (x2 ? (x6 | x7 | (~x4 & (x4 | ~x8))) : (~x6 | ~x7 | (x4 & (~x4 | x8)))));
  assign new_n175_ = ~x0 & x2 & ~x4 & new_n44_ & x5 & x6;
  assign new_n176_ = x0 ? ((x4 | x5 | ~x6 | ~x7 | x8) & (~x5 | ((x7 | x8 | x4 | ~x6) & (x6 | ((~x7 | ~x8) & (~x4 | (~x8 & (~x7 | x8)))))))) : ((~x7 | ((~x4 | ~x6 | (x5 & x8)) & (x4 | x5 | x6 | ~x8))) & (~x5 | x7 | (x4 ? (~x6 ^ ~x8) : x6)));
  assign new_n177_ = (x5 | ((x0 | x6 | ~x7) & (~x0 | (x6 ? (~x7 ^ x8) : (x7 | x8))) & (~x6 | ~x7 | x8 | x0 | x4))) & (x6 | x7 | ~x8 | ~x0 | x4 | ~x5);
  assign new_n178_ = (new_n180_ | ~x3) & ~new_n179_ & (new_n181_ | x3);
  assign new_n179_ = new_n44_ & ~x6 & x0 & x2 & x4;
  assign new_n180_ = (~x6 | ((~x2 | ((~x4 | ((x0 | x7 | x8) & (~x7 | (~x0 & (x0 | ~x8))))) & (x0 | x4 | x7 | x8))) & (~x0 | x2 | x4 | (~x7 & (x7 | ~x8))))) & (~x0 | x6 | ((~x4 | x7 | x8) & (~x2 | x4 | (~x7 ^ x8))));
  assign new_n181_ = x0 ? ((~x4 | (x2 ? (x6 ? (x7 | ~x8) : (~x7 | x8)) : (~x7 | (~x6 ^ ~x8)))) & (x2 | x4 | (x6 ^ (x7 & x8)))) : ((x6 | x7 | ~x8) & (x4 | (x6 & (x7 | x8))));
  assign new_n182_ = (~x5 | (x0 ? new_n184_ : (new_n185_ | ~x2))) & (x2 | (~new_n183_ & x0));
  assign new_n183_ = new_n89_ & ~x6 & x0 & ~x3 & ~x4;
  assign new_n184_ = x4 ? ((x2 | ~x3 | ~x6 | x7) & (x8 | ((x6 | x7 | x2 | x3) & (~x2 | (x3 ? (x6 | ~x7) : (~x6 | x7)))))) : (x2 ? ((x3 | (x6 ? (x7 | x8) : ~x7)) & (~x7 | ~x8 | ~x3 | ~x6)) : ((~x7 | ~x8 | x3 | x6) & (x7 | x8 | ~x3 | ~x6)));
  assign new_n185_ = (x6 | ~x7 | ~x8 | x3 | ~x4) & (~x6 | x8 | (x3 ? ~x7 : (~x4 | x7)));
  assign new_n186_ = ~new_n187_ & (x4 ? (~x5 & x7) : (x5 & ~x7));
  assign new_n187_ = (x0 | ~x2 | (x3 ? (x6 | ~x8) : (~x6 | x8))) & (~x0 | x2 | ~x3 | ~x6 | ~x8);
  assign z16 = ~x0 & (~new_n192_ | (~x8 & (~new_n189_ | ~new_n195_)));
  assign new_n189_ = (x1 | ~x2 | new_n190_ | x3) & (~new_n191_ | ~x1 | x2 | ~x3);
  assign new_n190_ = (x4 | ~x5 | ~x7) & (~x4 | x5 | x7) & (~x6 | ~x7 | ~x4 | x5);
  assign new_n191_ = x4 & x5 & x6 & ~x7;
  assign new_n192_ = (x1 | x2) & (x3 | ((new_n194_ | x1) & (new_n193_ | x5)));
  assign new_n193_ = (~x6 | ((x1 | ~x2 | x4) & (x7 | ~x8 | (x1 ? (~x2 ^ x4) : (~x2 | ~x4))))) & (x1 | x6 | (x4 & (x7 | ~x8) & (~x2 | ~x4 | ~x7)));
  assign new_n194_ = (x4 | x7) & (~x2 | ~x5 | ~x7 | ~x8 | (x4 & (~x4 | ~x6)));
  assign new_n195_ = (x4 | x6 | x7 | x1 | ~x2 | ~x3) & (~x4 | ~x6 | ~x7 | ~x1 | x2 | x3);
  assign z17 = ~x0 & ((~new_n197_ & ~x1) | (~x2 & (~x1 | (~new_n199_ & x1))));
  assign new_n197_ = (new_n198_ | x3) & (~new_n44_ | ~new_n40_ | ~x2 | ~x3 | x4);
  assign new_n198_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n199_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z18 = ~x0 & (~new_n201_ | (~x8 & (x1 ? new_n205_ : ~new_n206_)));
  assign new_n201_ = ~new_n204_ & (~x3 | (~new_n203_ & (new_n202_ | ~x8)));
  assign new_n202_ = x1 ? (x2 | ((x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | (~x6 ^ x7)))) : (~x2 | ~x4 | (x5 ? (x6 | x7) : ~x6));
  assign new_n203_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n204_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & ~x6));
  assign new_n205_ = ~x2 & ((x6 & ((x3 & ~x4 & x5 & ~x7) | (~x3 & (x4 ? (~x5 & x7) : (x5 & ~x7))))) | (x3 & ~x6 & (x4 ? (~x5 & ~x7) : (x5 ^ ~x7))));
  assign new_n206_ = (x5 | ((x3 | ((x4 | x7) & (~x6 | ~x7 | ~x2 | ~x4))) & (~x2 | ~x3 | (x4 ? ~x6 : (x6 | x7))))) & (~x2 | ~x3 | ~x5 | x6 | (~x4 & (x4 | ~x7)));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
