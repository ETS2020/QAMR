...
module FAU ( 
  ...
  assign z17 = ~x0 & ((~new_n247_ & ~x1) | (~x2 & (~x1 | (~new_n249_ & x1))));
  assign new_n247_ = (new_n248_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n248_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n249_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z18 = ~x0 & (~new_n251_ | (~x8 & (x1 ? new_n255_ : ~new_n256_)));
  assign new_n251_ = ~new_n254_ & (~x3 | (~new_n253_ & (new_n252_ | ~x8)));
  assign new_n252_ = x1 ? (x2 | ((x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | (~x6 ^ x7)))) : (~x2 | ~x4 | (x5 ? (x6 | x7) : ~x6));
  assign new_n253_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n254_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & ~x6));
  assign new_n255_ = ~x2 & ((x6 & ((x3 & ~x4 & x5 & ~x7) | (~x3 & (x4 ? (~x5 & x7) : (x5 & ~x7))))) | (x3 & ~x6 & (x4 ? (~x5 & ~x7) : (x5 ^ ~x7))));
  assign new_n256_ = (x5 | ((x3 | ((x4 | x7) & (~x6 | ~x7 | ~x2 | ~x4))) & (~x2 | ~x3 | (x4 ? ~x6 : (x6 | x7))))) & (~x2 | ~x3 | ~x5 | x6 | (~x4 & (x4 | ~x7)));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z06 = 1'b0;
  assign z12 = 1'b0;
