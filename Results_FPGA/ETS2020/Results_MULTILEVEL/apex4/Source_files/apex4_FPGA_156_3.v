// Benchmark "FAU" written by ABC on Wed Aug  5 23:31:46 2020
...
module FAU ( 
  ...
  assign new_n184_ = (~new_n187_ | x1) & (~new_n185_ | ~x1 | ~new_n186_ | x6 | x7);
  assign new_n185_ = ~x2 & x3;
  assign new_n186_ = x4 & x5;
  assign new_n187_ = x2 & x7 & ((x3 & x4 & (~x5 ^ x6)) | (~x3 & ~x4 & x5 & ~x6));
  ...
  assign new_n227_ = (x4 | ((~x3 | ((~x1 | x7 | (~x5 ^ x8)) & (~x7 | (x1 & (~x5 | ~x8))))) & (x1 | ((x3 | x5 | x8) & (~x7 | (x8 ? x3 : ~x5)))) & (~x1 | x3 | x5 | ~x7 | x8))) & (~x4 | ((~x3 | ((x5 | ~x7 | ~x8) & (~x1 | (x7 ? x8 : x5)))) & (x1 | x3 | ~x7 | (x5 ^ x8)))) & (~x1 | ~x3 | ~x5 | x7 | ~x8);
  ...
  assign z11 = (~new_n238_ & ~x4) | (~new_n252_ & ~x1) | (~new_n246_ & x4);
  assign new_n238_ = (new_n245_ | (x7 ^ x8)) & (new_n242_ | ~x3) & (new_n239_ | x3);
  assign new_n239_ = x6 ? new_n241_ : new_n240_;
  assign new_n240_ = ((~x2 ^ x7) | ((x0 | ~x5 | ~x8) & (~x0 | ~x1 | x5 | x8))) & (x5 | (x0 ? ((x1 | x2 | (x7 & x8)) & (x7 | ~x8 | ~x1 | ~x2)) : (x1 & (~x7 | x8 | ~x1 | x2)))) & (x1 | ((~x0 | (x2 ? (~x5 | ~x7) : (x7 | x8))) & (~x5 | ~x7 | x8 | x0 | ~x2)));
  assign new_n241_ = x1 ? ((x7 | x8 | x0 | ~x5) & (~x0 | x2 | (x5 ? ~x7 : (x7 | ~x8)))) : ((x5 | ~x7 | ~x8 | ~x0 | x2) & (~x2 | ((x0 | x5) & (x7 | (x0 ? (x5 & (~x5 | x8)) : (~x5 | x8))))));
  assign new_n242_ = (new_n243_ | ~x2) & (~x0 | new_n244_ | x2);
  assign new_n243_ = ((~x7 ^ x8) | ((~x5 | ~x6 | x0 | x1) & (~x0 | (x1 ? (x5 | ~x6) : (~x5 | x6))))) & (~x0 | ((x1 | ~x5 | ~x6 | ~x7 | ~x8) & (x6 | x7 | x8 | ~x1 | x5))) & (x0 | ((x1 | ~x5 | ~x6 | x7 | x8) & (~x1 | ~x7 | (x5 ? (~x6 | x8) : x6))));
  assign new_n244_ = (~x7 | (x1 ? (x5 ? (x6 | x8) : (~x6 | ~x8)) : (x5 | ~x6))) & (x1 | x7 | ((~x6 | (~x5 & (x5 | ~x8))) & (x5 | x6 | x8)));
  assign new_n245_ = (x3 | ~x5 | ~x6 | ~x0 | ~x1 | ~x2) & (x0 | ((~x3 | x5 | ~x6 | ~x1 | x2) & (x1 | ~x2 | x3 | ~x5 | x6)));
  assign new_n246_ = x0 ? (x6 ? new_n250_ : new_n251_) : new_n247_;
  assign new_n247_ = (new_n248_ | ~x2) & (~x1 | new_n249_ | x2);
  assign new_n248_ = x1 ? ((x6 | ((~x7 | ~x8 | x3 | ~x5) & (~x3 | (x5 ? ~x7 : (x7 | ~x8))))) & (x3 | ~x6 | ((x5 | ~x7 | x8) & (x7 | (~x8 & (~x5 | x8)))))) : (((x6 ? (x7 | x8) : (~x7 | ~x8)) | (~x3 ^ x5)) & (~x6 | ((x3 | x5 | x7) & (~x7 | (x3 ? (~x5 | ~x8) : (x5 | x8))))));
  assign new_n249_ = x3 ? ((x7 | (x5 ? (x6 ^ x8) : x6)) & (~x6 | ~x7 | (x5 & x8))) : (x6 | (x5 ? x7 : (~x7 & (x7 | ~x8))));
  assign new_n250_ = x2 ? ((~x5 | ((~x1 | (x3 ? (~x7 & (x7 | ~x8)) : ~x7)) & (x1 | x3 | x7 | ~x8))) & (~x3 | x5 | (x1 ? (x7 | x8) : ~x7))) : ((x3 | ((~x7 | (x1 ? (x5 | x8) : (x5 ^ x8))) & (~x1 | x7 | (x5 & x8)))) & (x5 | x7 | x8 | ~x1 | ~x3));
  assign new_n251_ = (x1 | ((x2 | ~x3 | ~x5 | x7 | x8) & (x5 | ((~x7 | ~x8 | x2 | x3) & (~x2 | ((x7 | ~x8) & (x3 | ~x7 | x8))))))) & (x2 | ~x3 | ~x5 | ~x7 | ~x8) & (~x1 | (x2 ? (x7 | (x3 ? (x5 | ~x8) : ~x5)) : ((~x3 | (x5 ? (~x8 & (~x7 | x8)) : (~x7 | ~x8))) & (~x7 | ~x8 | x3 | ~x5))));
  assign new_n252_ = (x0 | x2) & (~new_n113_ | x5 | x6 | ~x0 | ~x2 | ~x3);
  assign z12 = ~new_n254_ | (~new_n261_ & x0) | new_n277_ | (~new_n269_ & ~x0);
  assign new_n254_ = x3 ? ((~new_n259_ | ~x1) & (x0 | ~new_n260_ | x1)) : new_n255_;
  assign new_n255_ = (new_n258_ | x1) & (~new_n256_ | ~new_n257_ | ~x0 | ~x1 | x2);
  assign new_n256_ = x6 & x7;
  assign new_n257_ = ~x4 & x5;
  assign new_n258_ = (~x5 | x6 | ~x7 | x0 | ~x2 | x4) & (~x0 | ~x4 | ((~x6 | x7 | ~x2 | ~x5) & (x6 | ~x7 | x2 | x5)));
  assign new_n259_ = ~x5 & ((x0 & ((x6 & x7 & ~x2 & ~x4) | (~x6 & ~x7 & x2 & x4))) | (x4 & ~x6 & ~x7 & ~x0 & ~x2));
  assign new_n260_ = x2 & x5 & (x4 ? (x6 & x7) : (~x6 & ~x7));
  assign new_n261_ = (new_n268_ | (~x7 ^ x8)) & (new_n265_ | ~x7) & (new_n262_ | x7);
  assign new_n262_ = x1 ? new_n263_ : new_n264_;
  assign new_n263_ = (x8 | ((~x2 | x3 | x4 | ~x5) & (x2 | ~x3 | ~x4 | x5))) & (~x2 | ((~x5 | (x3 ? (~x6 | ~x8) : (~x4 | x6))) & (x3 | ~x4 | x5 | ~x6)));
  assign new_n264_ = (x3 | ((~x5 | ~x6 | x8 | x2 | ~x4) & (~x2 | ((x4 | x5) & (~x4 | ~x5 | x6 | ~x8))))) & (x2 | ~x3 | x8 | (x4 ? (~x5 ^ x6) : (x5 | x6)));
  assign new_n265_ = (new_n266_ | ~x5) & (x2 | ~x3 | ~new_n267_ | x5);
  assign new_n266_ = (~x6 | ((~x3 | ((x1 | ~x2 | ~x4 | x8) & (~x1 | (x2 ? ~x4 : (x4 | ~x8))))) & (x1 | x2 | x3 | ~x8))) & (x3 | x6 | ((~x1 | x4 | (~x8 & (x2 | x8))) & (x1 | x2 | ~x4 | ~x8)));
  assign new_n267_ = x8 & (x1 ? ~x6 : (x4 & x6));
  assign new_n268_ = (x4 | x5 | ~x6 | x1 | ~x2 | ~x3) & (x6 | ((x1 | ~x2 | ~x3 | x4 | ~x5) & (~x1 | ((x2 | x3 | x4 | x5) & (~x4 | ~x5 | ~x2 | ~x3)))));
  assign new_n269_ = (new_n270_ | ~x2) & (new_n273_ | x3) & (x1 | x2) & (~x1 | ~new_n276_ | ~x3);
  assign new_n270_ = x3 ? new_n272_ : new_n271_;
  assign new_n271_ = (x8 | ((~x1 | x4 | ~x5 | x6 | x7) & (~x1 | ~x4 | x5 | ~x7) & (x1 | x7 | (~x4 ^ x5)))) & (x5 | (x1 ? (x7 | ~x8 | (~x4 ^ x6)) : (x4 | ~x6))) & (x4 | ~x5 | x6 | x7 | ~x8);
  assign new_n272_ = (~x5 | (x1 ? (~x7 | (x4 ? x6 : x8)) : ((~x7 | ~x8 | ~x4 | x6) & (x7 | x8 | x4 | ~x6)))) & (~x1 | ~x4 | x5 | ~x6 | ~x7);
  assign new_n273_ = (new_n275_ | x6) & (~x1 | x2 | x4 | new_n274_ | ~x6);
  assign new_n274_ = x5 ? (x7 | x8) : (~x7 | ~x8);
  assign new_n275_ = (x1 | x5 | (x4 & (x7 | ~x8))) & (x2 | x4 | ~x5 | ((~x7 | ~x8) & (~x1 | x7 | x8)));
  assign new_n276_ = ~x4 & ((~x7 & ((~x2 & ~x5 & ~x6 & ~x8) | (x6 & (x8 ? x5 : ~x2)))) | (~x2 & ~x5 & ~x6 & x7 & x8));
  assign new_n277_ = new_n114_ & x1 & x2 & new_n42_ & ~x5 & x6;
  assign z13 = (~new_n279_ & ~x7) | (~new_n285_ & x7) | (new_n292_ & ~x0);
  assign new_n279_ = x6 ? (x0 ? new_n283_ : new_n284_) : new_n280_;
  assign new_n280_ = x2 ? new_n281_ : new_n282_;
  assign new_n281_ = x1 ? (x0 ? ((x3 | ~x4 | x5) & (~x5 | (x3 ? ~x8 : (x4 | x8)))) : (x5 | ~x8 | (x3 & (~x3 | ~x4)))) : (x0 ? ((x4 | x5) & (~x5 | ~x8 | x3 | ~x4)) : (x8 | (x3 ? (x4 | ~x5) : (~x4 ^ x5))));
  assign new_n282_ = (x8 | (x0 ? (~x4 | ((x1 | x3 | ~x5) & (~x3 | x5))) : (~x1 | x4 | (~x3 & (x3 | ~x5))))) & (x4 | ~x5 | ~x8 | x0 | ~x1 | ~x3);
  assign new_n283_ = x1 ? ((~x2 | ~x4 | x5) & (x4 | (x2 ? (x3 ? (~x5 | ~x8) : (x5 | x8)) : (x3 ? (~x5 | x8) : (x5 | ~x8))))) : ((x5 | ((x2 | ~x3 | ~x4 | x8) & (~x2 | ~x8 | (~x3 ^ x4)))) & (x2 | ~x4 | ~x5 | (~x3 & (x3 | x8))));
  assign new_n284_ = x3 ? (x4 | ((~x5 | (x1 ? x2 : (~x2 | ~x8))) & (x5 | x8 | x1 | ~x2))) : ((~x2 | ((x4 | (x1 ? (~x5 & (x5 | ~x8)) : (~x5 | x8))) & (x5 | ~x8 | x1 | ~x4))) & (~x1 | x2 | x8 | (x4 ^ x5)));
  assign new_n285_ = new_n286_ & (~x3 | (x1 ? new_n290_ : ~new_n291_));
  assign new_n286_ = (~new_n289_ | ~x0) & (x3 | ((new_n287_ | ~x1) & (~x0 | ~new_n288_ | x1)));
  assign new_n287_ = x4 ? ((~x0 | x2 | ~x5 | ~x6 | ~x8) & (x5 | x6 | x8 | x0 | ~x2)) : ((~x6 | (x0 ? (x2 ? (~x5 | ~x8) : x5) : (x2 ? (~x5 | x8) : (x5 | ~x8)))) & (x2 | x6 | (x0 ? (~x5 | x8) : x5)));
  assign new_n288_ = ~x2 & ((~x4 & x5 & ~x6 & x8) | (x6 & (x4 ? ~x5 : (x5 & x8))));
  assign new_n289_ = ~x2 & x5 & ~x6 & x8 & (~x1 ^ ~x4);
  assign new_n290_ = (x4 | (x0 ? (x2 | (x5 ? (x6 ^ x8) : (x6 | ~x8))) : ((~x2 | x8 | (~x5 ^ x6)) & (~x6 | ~x8 | x2 | x5)))) & (~x2 | ~x4 | (x0 ? (x8 | (~x5 ^ x6)) : x5));
  assign new_n291_ = x2 & ((x4 & ((x5 & (x0 ? ~x8 : (~x6 & x8))) | (x6 & x8 & ~x0 & ~x5))) | (x0 & ~x4 & ~x5 & ~x8));
  assign new_n292_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & (~x6 | (x2 & x6))));
  assign z14 = x1 ? ~new_n294_ : (new_n309_ | ~new_n305_ | (~new_n301_ & ~x5));
  assign new_n294_ = (new_n295_ | x3) & ~new_n298_ & (~x3 | (x2 ? new_n300_ : new_n299_));
  assign new_n295_ = x0 ? new_n297_ : new_n296_;
  assign new_n296_ = ((x6 ? (x7 | x8) : (~x7 | ~x8)) | (x2 ? (~x4 | ~x5) : (x4 | x5))) & (~x5 | ((x7 | (x2 ? (x4 ? (~x6 | ~x8) : (x6 | x8)) : (~x4 | (x6 & (~x6 | x8))))) & (~x6 | ~x7 | x8 | ~x2 | x4))) & (x5 | x6 | ((x2 | ~x4 | (~x7 & (x7 | ~x8))) & (x7 | ~x8 | ~x2 | x4)));
  assign new_n297_ = ((x4 ? ~x6 : (x6 | ~x8)) | (x2 ? (~x5 | ~x7) : (x5 | x7))) & (~x5 | ~x7 | ~x8 | x2 | ~x4) & (~x2 | x4 | x5 | x7 | x8) & (~x6 | x7 | x8 | x2 | ~x4) & (x5 | (x2 ? (x6 | x7 | (~x4 & (x4 | ~x8))) : (~x6 | ~x7 | (x4 & (~x4 | x8)))));
  assign new_n298_ = new_n42_ & x5 & x6 & ~x0 & x2 & ~x4;
  assign new_n299_ = x0 ? ((x4 | x5 | ~x6 | ~x7 | x8) & (~x5 | ((x7 | x8 | x4 | ~x6) & (x6 | ((~x7 | ~x8) & (~x4 | (~x8 & (~x7 | x8)))))))) : ((~x7 | ((~x4 | ~x6 | (x5 & x8)) & (x4 | x5 | x6 | ~x8))) & (~x5 | x7 | (x4 ? (x6 ^ x8) : x6)));
  assign new_n300_ = (x5 | ((x0 | x6 | ~x7) & (~x0 | (x6 ? (~x7 ^ x8) : (x7 | x8))) & (~x6 | ~x7 | x8 | x0 | x4))) & (x6 | x7 | ~x8 | ~x0 | x4 | ~x5);
  assign new_n301_ = (new_n303_ | ~x3) & ~new_n302_ & (new_n304_ | x3);
  assign new_n302_ = new_n42_ & ~x6 & x0 & x2 & x4;
  assign new_n303_ = (~x6 | ((~x2 | ((~x4 | ((~x7 | (~x0 & (x0 | ~x8))) & (x0 | x7 | x8))) & (x0 | x4 | x7 | x8))) & (~x0 | x2 | x4 | (~x7 & (x7 | ~x8))))) & (~x0 | x6 | ((~x4 | x7 | x8) & (~x2 | x4 | (~x7 ^ x8))));
  assign new_n304_ = x0 ? ((~x4 | (x2 ? (x6 ? (x7 | ~x8) : (~x7 | x8)) : (~x7 | (x6 ^ x8)))) & (x2 | x4 | (x6 ^ (x7 & x8)))) : ((x6 | x7 | ~x8) & (x4 | (x6 & (x7 | x8))));
  assign new_n305_ = (~x5 | (x0 ? new_n307_ : (new_n308_ | ~x2))) & (x2 | (~new_n306_ & x0));
  assign new_n306_ = new_n113_ & ~x6 & x0 & ~x3 & ~x4;
  assign new_n307_ = x4 ? ((x2 | ~x3 | ~x6 | x7) & (x8 | ((x6 | x7 | x2 | x3) & (~x2 | (x3 ? (x6 | ~x7) : (~x6 | x7)))))) : (x2 ? ((x3 | (x6 ? (x7 | x8) : ~x7)) & (~x7 | ~x8 | ~x3 | ~x6)) : ((~x7 | ~x8 | x3 | x6) & (x7 | x8 | ~x3 | ~x6)));
  assign new_n308_ = (x6 | ~x7 | ~x8 | x3 | ~x4) & (~x6 | x8 | (x3 ? ~x7 : (~x4 | x7)));
  assign new_n309_ = ~new_n310_ & (x4 ? (~x5 & x7) : (x5 & ~x7));
  assign new_n310_ = (x0 | ~x2 | (x3 ? (x6 | ~x8) : (~x6 | x8))) & (~x0 | x2 | ~x3 | ~x6 | ~x8);
  assign z15 = ~x0 & (~new_n312_ | (~new_n318_ & x5) | (new_n319_ & ~x1));
  assign new_n312_ = ~new_n313_ & (new_n316_ | x1) & (~new_n256_ | ~new_n257_ | ~new_n185_ | ~x1);
  assign new_n313_ = ~x5 & ((~new_n314_ & ~x6) | (x2 & ~x3 & ~new_n315_ & x6));
  assign new_n314_ = (x7 | ((x1 | x3 | ~x8) & (x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n315_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n316_ = (~x2 | ~new_n317_ | ~x3) & x2 & (x3 | x4 | x7);
  assign new_n317_ = x5 & ~x6 & x7 & ~x8;
  assign new_n318_ = x4 ? ((x1 | ~x2 | ~x3 | x6 | x7) & (~x1 | x2 | x3 | ~x6 | ~x7)) : ((~x3 | ((x6 | x7 | x1 | ~x2) & (~x1 | x2 | (~x6 ^ x7)))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n319_ = x2 & x4 & ~x5 & x6 & (x3 | (~x3 & ~x7));
  assign z16 = ~x0 & (~new_n323_ | (~x8 & (~new_n321_ | ~new_n326_)));
  assign new_n321_ = (~new_n322_ | x1) & (~new_n185_ | ~x1 | ~new_n186_ | ~x6 | x7);
  assign new_n322_ = x2 & ~x3 & ((x6 & x7 & x4 & ~x5) | (~x4 & x5 & x7) | (x4 & ~x5 & ~x7));
  assign new_n323_ = (x1 | x2) & (x3 | ((new_n325_ | x1) & (new_n324_ | x5)));
  assign new_n324_ = (~x6 | ((x1 | ~x2 | x4) & (x7 | ~x8 | (x1 ? (~x2 ^ x4) : (~x2 | ~x4))))) & (x1 | x6 | (x4 & (x7 | ~x8) & (~x2 | ~x4 | ~x7)));
  assign new_n325_ = (x4 | x7) & (~x2 | ~x5 | ~x7 | ~x8 | (x4 & (~x4 | ~x6)));
  assign new_n326_ = (x4 | x6 | x7 | x1 | ~x2 | ~x3) & (~x4 | ~x6 | ~x7 | ~x1 | x2 | x3);
  assign z17 = ~x0 & ((~new_n328_ & ~x1) | (~x2 & (~x1 | (~new_n330_ & x1))));
  assign new_n328_ = (new_n329_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n329_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n330_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z18 = ~x0 & (~new_n332_ | (~x8 & (x1 ? new_n336_ : ~new_n337_)));
  assign new_n332_ = ~new_n335_ & (~x3 | (~new_n333_ & (new_n334_ | ~x8)));
  assign new_n333_ = new_n189_ & x1 & new_n256_ & x5;
  assign new_n334_ = x1 ? (x2 | ((x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | (~x6 ^ x7)))) : (~x2 | ~x4 | (x5 ? (x6 | x7) : ~x6));
  assign new_n335_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & ~x6));
  assign new_n336_ = ~x2 & ((x6 & ((x5 & ~x7 & x3 & ~x4) | (~x3 & (x4 ? (~x5 & x7) : (x5 & ~x7))))) | (x3 & ~x6 & (x4 ? (~x5 & ~x7) : (~x5 ^ x7))));
  assign new_n337_ = (x5 | ((x3 | ((x4 | x7) & (~x6 | ~x7 | ~x2 | ~x4))) & (~x2 | ~x3 | (x4 ? ~x6 : (x6 | x7))))) & (~x2 | ~x3 | ~x5 | x6 | (~x4 & (x4 | ~x7)));
  assign z00 = 1'b0;
  assign z10 = 1'b0;
endmodule
