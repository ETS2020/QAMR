// Benchmark "FAU" written by ABC on Wed Aug  5 23:28:16 2020
...
module FAU ( 
  ...
  assign new_n233_ = new_n42_ & x5 & x6 & ~x0 & x2 & ~x4;
  ...
  assign z16 = ~x0 & (~new_n250_ | (~x8 & (~new_n247_ | ~new_n253_)));
  assign new_n247_ = (x1 | ~x2 | new_n249_ | x3) & (~new_n248_ | ~x1 | x2 | ~x3);
  assign new_n248_ = new_n134_ & x6 & ~x7;
  assign new_n249_ = (~x4 | x5 | x7) & (x4 | ~x5 | ~x7) & (~x6 | ~x7 | ~x4 | x5);
  assign new_n250_ = (x1 | x2) & (x3 | ((new_n252_ | x1) & (new_n251_ | x5)));
  assign new_n251_ = (~x6 | ((x1 | ~x2 | x4) & (x7 | ~x8 | (x1 ? (~x2 ^ x4) : (~x2 | ~x4))))) & (x1 | x6 | (x4 & (x7 | ~x8) & (~x2 | ~x4 | ~x7)));
  assign new_n252_ = (x4 | x7) & (~x2 | ~x5 | ~x7 | ~x8 | (x4 & (~x4 | ~x6)));
  assign new_n253_ = (x4 | x6 | x7 | x1 | ~x2 | ~x3) & (~x4 | ~x6 | ~x7 | ~x1 | x2 | x3);
  assign z17 = ~x0 & ((~new_n255_ & ~x1) | (~x2 & (~x1 | (~new_n257_ & x1))));
  assign new_n255_ = (new_n256_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n256_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n257_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z18 = ~x0 & (~new_n259_ | (~x8 & (x1 ? new_n263_ : ~new_n264_)));
  assign new_n259_ = ~new_n262_ & (~x3 | (~new_n261_ & (new_n260_ | ~x8)));
  assign new_n260_ = x1 ? (x2 | ((x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | (~x6 ^ x7)))) : (~x2 | ~x4 | (x5 ? (x6 | x7) : ~x6));
  assign new_n261_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n262_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & ~x6));
  assign new_n263_ = ~x2 & ((x6 & ((x3 & ~x4 & x5 & ~x7) | (~x3 & (x4 ? (~x5 & x7) : (x5 & ~x7))))) | (x3 & ~x6 & (x4 ? (~x5 & ~x7) : (x5 ^ ~x7))));
  assign new_n264_ = (x5 | ((x3 | ((x4 | x7) & (~x6 | ~x7 | ~x2 | ~x4))) & (~x2 | ~x3 | (x4 ? ~x6 : (x6 | x7))))) & (~x2 | ~x3 | ~x5 | x6 | (~x4 & (x4 | ~x7)));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z06 = 1'b0;
  assign z12 = 1'b0;
