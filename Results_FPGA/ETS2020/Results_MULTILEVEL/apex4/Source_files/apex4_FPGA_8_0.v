...
module FAU ( 
  ...
  assign new_n189_ = (~x2 | ~new_n190_ | ~x3) & x2 & (x3 | x4 | x7);
  assign new_n190_ = x5 & ~x6 & x7 & ~x8;
  ...
  assign z17 = ~x0 & ((~new_n194_ & ~x1) | (~x2 & (~x1 | (~new_n196_ & x1))));
  assign new_n194_ = (new_n195_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n195_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n196_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
