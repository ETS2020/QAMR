...
module FAU ( 
  ...
  assign z15 = ~x0 & (~new_n170_ | (~new_n176_ & x5) | (new_n177_ & ~x1));
  assign new_n170_ = ~new_n171_ & (new_n174_ | x1) & (~new_n149_ | ~x1 | x2 | ~x3);
  assign new_n171_ = ~x5 & ((~new_n172_ & ~x6) | (x2 & ~x3 & ~new_n173_ & x6));
  assign new_n172_ = (x7 | ((x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))) & (x1 | x3 | ~x8))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n173_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n174_ = (~x2 | ~new_n175_ | ~x3) & x2 & (x3 | x4 | x7);
  assign new_n175_ = x5 & ~x6 & x7 & ~x8;
  assign new_n176_ = x4 ? ((~x1 | x2 | x3 | ~x6 | ~x7) & (x1 | ~x2 | ~x3 | x6 | x7)) : ((~x3 | ((~x1 | x2 | (~x6 ^ x7)) & (x6 | x7 | x1 | ~x2))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n177_ = x2 & x4 & ~x5 & x6 & (x3 | (~x3 & ~x7));
  assign z16 = ~x0 & (~new_n182_ | (~x8 & (~new_n179_ | ~new_n185_)));
  assign new_n179_ = (x1 | ~x2 | new_n180_ | x3) & (~new_n181_ | ~x1 | x2 | ~x3);
  assign new_n180_ = (~x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | ~x7) & (~x4 | x5 | x7);
  assign new_n181_ = x4 & x5 & x6 & ~x7;
  assign new_n182_ = (x1 | x2) & (x3 | ((new_n184_ | x1) & (new_n183_ | x5)));
  assign new_n183_ = (~x6 | ((x1 | ~x2 | x4) & (x7 | ~x8 | (x1 ? (~x2 ^ x4) : (~x2 | ~x4))))) & (x1 | x6 | (x4 & (x7 | ~x8) & (~x2 | ~x4 | ~x7)));
  assign new_n184_ = (x4 | x7) & (~x2 | ~x5 | ~x7 | ~x8 | (x4 & (~x4 | ~x6)));
  assign new_n185_ = (~x4 | ~x6 | ~x7 | ~x1 | x2 | x3) & (x4 | x6 | x7 | x1 | ~x2 | ~x3);
