...
module FAU ( 
  ...
  assign z16 = ~x0 & (~new_n215_ | (~x8 & (~new_n212_ | ~new_n218_)));
  assign new_n212_ = (x1 | ~x2 | new_n214_ | x3) & (~new_n213_ | ~x1 | x2 | ~x3);
  assign new_n213_ = new_n132_ & x6 & ~x7;
  assign new_n214_ = (~x6 | ~x7 | ~x4 | x5) & (~x4 | x5 | x7) & (x4 | ~x5 | ~x7);
