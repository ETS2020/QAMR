// Benchmark "FAU" written by ABC on Wed Aug  5 23:31:08 2020
...
module FAU ( 
  ...
  assign z14 = x1 ? ~new_n161_ : ~new_n168_;
  assign new_n161_ = (new_n162_ | x3) & ~new_n165_ & (~x3 | (x2 ? new_n167_ : new_n166_));
  assign new_n162_ = x0 ? new_n164_ : new_n163_;
  assign new_n163_ = ((x6 ? (x7 | x8) : (~x7 | ~x8)) | (x2 ? (~x4 | ~x5) : (x4 | x5))) & (~x5 | ((x7 | (x2 ? (x4 ? (~x6 | ~x8) : (x6 | x8)) : (~x4 | (x6 & (~x6 | x8))))) & (~x6 | ~x7 | x8 | ~x2 | x4))) & (x5 | x6 | ((x2 | ~x4 | (~x7 & (x7 | ~x8))) & (x7 | ~x8 | ~x2 | x4)));
  assign new_n164_ = ((x4 ? ~x6 : (x6 | ~x8)) | (x2 ? (~x5 | ~x7) : (x5 | x7))) & (~x5 | ~x7 | ~x8 | x2 | ~x4) & (~x2 | x4 | x5 | x7 | x8) & (x5 | (x2 ? (x6 | x7 | (~x4 & (x4 | ~x8))) : (~x6 | ~x7 | (x4 & (~x4 | x8))))) & (~x6 | x7 | x8 | x2 | ~x4);
  assign new_n165_ = new_n42_ & x5 & x6 & ~x0 & x2 & ~x4;
  assign new_n166_ = x0 ? ((x4 | x5 | ~x6 | ~x7 | x8) & (~x5 | ((x7 | x8 | x4 | ~x6) & (x6 | ((~x7 | ~x8) & (~x4 | (~x8 & (~x7 | x8)))))))) : ((~x7 | ((~x4 | ~x6 | (x5 & x8)) & (x4 | x5 | x6 | ~x8))) & (~x5 | x7 | (x4 ? (x6 ^ x8) : x6)));
  assign new_n167_ = (x5 | ((~x0 | (x6 ? (~x7 ^ x8) : (x7 | x8))) & (x0 | x6 | ~x7) & (~x6 | ~x7 | x8 | x0 | x4))) & (x6 | x7 | ~x8 | ~x0 | x4 | ~x5);
  assign new_n168_ = (new_n177_ | (x4 ? (x5 | ~x7) : (~x5 | x7))) & new_n173_ & (new_n169_ | x5);
  assign new_n169_ = (new_n170_ | ~x3) & ~new_n172_ & (new_n171_ | x3);
  assign new_n170_ = (~x6 | ((~x2 | ((~x4 | ((x0 | x7 | x8) & (~x7 | (~x0 & (x0 | ~x8))))) & (x0 | x4 | x7 | x8))) & (~x0 | x2 | x4 | (~x7 & (x7 | ~x8))))) & (~x0 | x6 | ((~x4 | x7 | x8) & (~x2 | x4 | (~x7 ^ x8))));
  assign new_n171_ = x0 ? ((~x4 | (x2 ? (x6 ? (x7 | ~x8) : (~x7 | x8)) : (~x7 | (x6 ^ x8)))) & (x2 | x4 | (x6 ^ (x7 & x8)))) : ((x6 | x7 | ~x8) & (x4 | (x6 & (x7 | x8))));
  assign new_n172_ = ~x6 & ~x7 & x8 & x0 & x2 & x4;
  assign new_n173_ = (~x5 | (x0 ? new_n174_ : (new_n175_ | ~x2))) & (x2 | (~new_n176_ & x0));
  assign new_n174_ = x4 ? ((x8 | ((~x2 | (x3 ? (x6 | ~x7) : (~x6 | x7))) & (x6 | x7 | x2 | x3))) & (x2 | ~x3 | ~x6 | x7)) : (x2 ? ((x3 | (x6 ? (x7 | x8) : ~x7)) & (~x7 | ~x8 | ~x3 | ~x6)) : ((~x7 | ~x8 | x3 | x6) & (x7 | x8 | ~x3 | ~x6)));
  assign new_n175_ = (x6 | ~x7 | ~x8 | x3 | ~x4) & (~x6 | x8 | (x3 ? ~x7 : (~x4 | x7)));
  assign new_n176_ = ~x6 & ~x7 & ~x8 & x0 & ~x3 & ~x4;
  assign new_n177_ = (x0 | ~x2 | (x3 ? (x6 | ~x8) : (~x6 | x8))) & (~x0 | x2 | ~x3 | ~x6 | ~x8);
  assign z15 = ~x0 & (~new_n179_ | (~new_n185_ & x5) | (new_n186_ & ~x1));
  assign new_n179_ = ~new_n180_ & (new_n183_ | x1) & (~new_n125_ | ~x1 | x2 | ~x3);
  assign new_n180_ = ~x5 & ((~new_n181_ & ~x6) | (x2 & ~x3 & ~new_n182_ & x6));
  assign new_n181_ = (x7 | ((x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))) & (x1 | x3 | ~x8))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n182_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n183_ = (~x2 | ~x3 | ~new_n184_ | ~x5) & x2 & (x3 | x4 | x7);
  assign new_n184_ = ~x6 & x7 & ~x8;
  assign new_n185_ = x4 ? ((x1 | ~x2 | ~x3 | x6 | x7) & (~x1 | x2 | x3 | ~x6 | ~x7)) : ((~x3 | ((x6 | x7 | x1 | ~x2) & (~x1 | x2 | (~x6 ^ x7)))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n186_ = x2 & x4 & ~x5 & x6 & (x3 | (~x3 & ~x7));
