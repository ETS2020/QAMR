...
module FAU ( 
  ...
  assign z15 = ~x0 & (~new_n197_ | (~new_n203_ & x5) | (new_n204_ & ~x1));
  assign new_n197_ = ~new_n198_ & (new_n201_ | x1) & (~new_n176_ | ~x1 | x2 | ~x3);
  assign new_n198_ = ~x5 & ((~new_n199_ & ~x6) | (x2 & ~x3 & ~new_n200_ & x6));
  assign new_n199_ = (x7 | ((x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))) & (x1 | x3 | ~x8))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n200_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n201_ = (~x2 | ~x3 | ~new_n202_ | ~x5) & x2 & (x3 | x4 | x7);
  assign new_n202_ = ~x6 & x7 & ~x8;
  assign new_n203_ = x4 ? ((x1 | ~x2 | ~x3 | x6 | x7) & (~x1 | x2 | x3 | ~x6 | ~x7)) : ((~x3 | ((~x1 | x2 | (~x6 ^ x7)) & (x6 | x7 | x1 | ~x2))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n204_ = x2 & x4 & ~x5 & x6 & (x3 | (~x3 & ~x7));
  assign z17 = ~x0 & ((~new_n206_ & ~x1) | (~x2 & (~x1 | (~new_n208_ & x1))));
  assign new_n206_ = (new_n207_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n207_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n208_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
