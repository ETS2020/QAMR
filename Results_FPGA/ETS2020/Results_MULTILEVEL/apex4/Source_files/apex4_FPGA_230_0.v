// Benchmark "FAU" written by ABC on Wed Aug  5 23:33:33 2020
...
module FAU ( 
  ...
  assign z18 = ~x0 & (~new_n199_ | (~x8 & (x1 ? new_n203_ : ~new_n204_)));
  assign new_n199_ = ~new_n202_ & (~x3 | (~new_n201_ & (new_n200_ | ~x8)));
  assign new_n200_ = x1 ? (x2 | ((x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | (~x6 ^ x7)))) : (~x2 | ~x4 | (x5 ? (x6 | x7) : ~x6));
  assign new_n201_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n202_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & ~x6));
  assign new_n203_ = ~x2 & ((x6 & ((x5 & ~x7 & x3 & ~x4) | (~x3 & (x4 ? (~x5 & x7) : (x5 & ~x7))))) | (x3 & ~x6 & (x4 ? (~x5 & ~x7) : (~x5 ^ x7))));
  assign new_n204_ = (x5 | ((x3 | ((x4 | x7) & (~x6 | ~x7 | ~x2 | ~x4))) & (~x2 | ~x3 | (x4 ? ~x6 : (x6 | x7))))) & (~x2 | ~x3 | ~x5 | x6 | (~x4 & (x4 | ~x7)));
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
