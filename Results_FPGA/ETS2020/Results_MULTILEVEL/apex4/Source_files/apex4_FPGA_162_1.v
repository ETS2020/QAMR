...
module FAU ( 
  ...
  assign z13 = (~new_n198_ & ~x7) | (new_n211_ & ~x0) | (~new_n204_ & x7);
  ...
  assign new_n201_ = (x8 | (x0 ? (~x4 | ((~x3 | x5) & (x1 | x3 | ~x5))) : (~x1 | x4 | (~x3 & (x3 | ~x5))))) & (x4 | ~x5 | ~x8 | x0 | ~x1 | ~x3);
  ...
  assign new_n206_ = x4 ? ((~x5 | ~x6 | ~x8 | ~x0 | x2) & (x5 | x6 | x8 | x0 | ~x2)) : ((~x6 | (x0 ? (x2 ? (~x5 | ~x8) : x5) : (x2 ? (~x5 | x8) : (x5 | ~x8)))) & (x2 | x6 | (x0 ? (~x5 | x8) : x5)));
  ...
  assign z14 = x1 ? ~new_n213_ : (new_n228_ | ~new_n224_ | (~new_n220_ & ~x5));
  assign new_n213_ = (new_n214_ | x3) & ~new_n217_ & (~x3 | (x2 ? new_n219_ : new_n218_));
  assign new_n214_ = x0 ? new_n216_ : new_n215_;
  assign new_n215_ = ((x6 ? (x7 | x8) : (~x7 | ~x8)) | (x2 ? (~x4 | ~x5) : (x4 | x5))) & (~x5 | ((x7 | (x2 ? (x4 ? (~x6 | ~x8) : (x6 | x8)) : (~x4 | (x6 & (~x6 | x8))))) & (~x6 | ~x7 | x8 | ~x2 | x4))) & (x5 | x6 | ((x2 | ~x4 | (~x7 & (x7 | ~x8))) & (x7 | ~x8 | ~x2 | x4)));
  assign new_n216_ = ((x4 ? ~x6 : (x6 | ~x8)) | (x2 ? (~x5 | ~x7) : (x5 | x7))) & (x2 | ~x4 | ~x5 | ~x7 | ~x8) & (~x2 | x4 | x5 | x7 | x8) & (~x6 | x7 | x8 | x2 | ~x4) & (x5 | (x2 ? (x6 | x7 | (~x4 & (x4 | ~x8))) : (~x6 | ~x7 | (x4 & (~x4 | x8)))));
  assign new_n217_ = ~x0 & x2 & ~x4 & new_n44_ & x5 & x6;
  assign new_n218_ = x0 ? ((x4 | x5 | ~x6 | ~x7 | x8) & (~x5 | ((x7 | x8 | x4 | ~x6) & (x6 | ((~x7 | ~x8) & (~x4 | (~x8 & (~x7 | x8)))))))) : ((~x7 | ((~x4 | ~x6 | (x5 & x8)) & (x4 | x5 | x6 | ~x8))) & (~x5 | x7 | (x4 ? (~x6 ^ ~x8) : x6)));
  assign new_n219_ = (x5 | ((x0 | x6 | ~x7) & (~x0 | (x6 ? (~x7 ^ x8) : (x7 | x8))) & (~x6 | ~x7 | x8 | x0 | x4))) & (x6 | x7 | ~x8 | ~x0 | x4 | ~x5);
  assign new_n220_ = (new_n222_ | ~x3) & ~new_n221_ & (new_n223_ | x3);
  assign new_n221_ = new_n44_ & ~x6 & x0 & x2 & x4;
  assign new_n222_ = (~x6 | ((~x2 | ((~x4 | ((x0 | x7 | x8) & (~x7 | (~x0 & (x0 | ~x8))))) & (x0 | x4 | x7 | x8))) & (~x0 | x2 | x4 | (~x7 & (x7 | ~x8))))) & (~x0 | x6 | ((~x4 | x7 | x8) & (~x2 | x4 | (~x7 ^ x8))));
  assign new_n223_ = x0 ? ((~x4 | (x2 ? (x6 ? (x7 | ~x8) : (~x7 | x8)) : (~x7 | (~x6 ^ ~x8)))) & (x2 | x4 | (x6 ^ (x7 & x8)))) : ((x6 | x7 | ~x8) & (x4 | (x6 & (x7 | x8))));
  assign new_n224_ = (~x5 | (x0 ? new_n226_ : (new_n227_ | ~x2))) & (x2 | (~new_n225_ & x0));
  assign new_n225_ = new_n89_ & ~x6 & x0 & ~x3 & ~x4;
  assign new_n226_ = x4 ? ((x2 | ~x3 | ~x6 | x7) & (x8 | ((x6 | x7 | x2 | x3) & (~x2 | (x3 ? (x6 | ~x7) : (~x6 | x7)))))) : (x2 ? ((x3 | (x6 ? (x7 | x8) : ~x7)) & (~x7 | ~x8 | ~x3 | ~x6)) : ((~x7 | ~x8 | x3 | x6) & (x7 | x8 | ~x3 | ~x6)));
  assign new_n227_ = (x6 | ~x7 | ~x8 | x3 | ~x4) & (~x6 | x8 | (x3 ? ~x7 : (~x4 | x7)));
  assign new_n228_ = ~new_n229_ & (x4 ? (~x5 & x7) : (x5 & ~x7));
  assign new_n229_ = (x0 | ~x2 | (x3 ? (x6 | ~x8) : (~x6 | x8))) & (~x0 | x2 | ~x3 | ~x6 | ~x8);
  assign z17 = ~x0 & ((~new_n231_ & ~x1) | (~x2 & (~x1 | (~new_n233_ & x1))));
  assign new_n231_ = (new_n232_ | x3) & (~new_n44_ | ~new_n40_ | ~x2 | ~x3 | x4);
  assign new_n232_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n233_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z18 = ~x0 & (~new_n235_ | (~x8 & (x1 ? new_n239_ : ~new_n240_)));
  assign new_n235_ = ~new_n238_ & (~x3 | (~new_n237_ & (new_n236_ | ~x8)));
  assign new_n236_ = x1 ? (x2 | ((x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | (~x6 ^ x7)))) : (~x2 | ~x4 | (x5 ? (x6 | x7) : ~x6));
  assign new_n237_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n238_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & ~x6));
  assign new_n239_ = ~x2 & ((x6 & ((x3 & ~x4 & x5 & ~x7) | (~x3 & (x4 ? (~x5 & x7) : (x5 & ~x7))))) | (x3 & ~x6 & (x4 ? (~x5 & ~x7) : (x5 ^ ~x7))));
  assign new_n240_ = (x5 | ((x3 | ((x4 | x7) & (~x6 | ~x7 | ~x2 | ~x4))) & (~x2 | ~x3 | (x4 ? ~x6 : (x6 | x7))))) & (~x2 | ~x3 | ~x5 | x6 | (~x4 & (x4 | ~x7)));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
