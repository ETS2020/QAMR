// Benchmark "FAU" written by ABC on Wed Aug  5 23:32:38 2020
...
module FAU ( 
  ...
  assign z16 = ~x0 & (~new_n265_ | (~x8 & (~new_n262_ | ~new_n268_)));
  assign new_n262_ = (x1 | ~x2 | new_n264_ | x3) & (~new_n263_ | ~x1 | x2 | ~x3);
  assign new_n263_ = new_n134_ & x6 & ~x7;
  assign new_n264_ = (~x4 | x5 | x7) & (x4 | ~x5 | ~x7) & (~x6 | ~x7 | ~x4 | x5);
  assign new_n265_ = (x1 | x2) & (x3 | ((new_n267_ | x1) & (new_n266_ | x5)));
  assign new_n266_ = (~x6 | ((x1 | ~x2 | x4) & (x7 | ~x8 | (x1 ? (~x2 ^ x4) : (~x2 | ~x4))))) & (x1 | x6 | (x4 & (x7 | ~x8) & (~x2 | ~x4 | ~x7)));
  assign new_n267_ = (x4 | x7) & (~x2 | ~x5 | ~x7 | ~x8 | (x4 & (~x4 | ~x6)));
  assign new_n268_ = (x4 | x6 | x7 | x1 | ~x2 | ~x3) & (~x4 | ~x6 | ~x7 | ~x1 | x2 | x3);
  assign z17 = ~x0 & ((~new_n270_ & ~x1) | (~x2 & (~x1 | (~new_n272_ & x1))));
  assign new_n270_ = (new_n271_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n271_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n272_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z18 = ~x0 & (~new_n274_ | (~x8 & (x1 ? new_n278_ : ~new_n279_)));
  assign new_n274_ = ~new_n277_ & (~x3 | (~new_n276_ & (new_n275_ | ~x8)));
  assign new_n275_ = x1 ? (x2 | ((x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | (~x6 ^ x7)))) : (~x2 | ~x4 | (x5 ? (x6 | x7) : ~x6));
  assign new_n276_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n277_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & ~x6));
  assign new_n278_ = ~x2 & ((x6 & ((x3 & ~x4 & x5 & ~x7) | (~x3 & (x4 ? (~x5 & x7) : (x5 & ~x7))))) | (x3 & ~x6 & (x4 ? (~x5 & ~x7) : (x5 ^ ~x7))));
  assign new_n279_ = (x5 | ((x3 | ((x4 | x7) & (~x6 | ~x7 | ~x2 | ~x4))) & (~x2 | ~x3 | (x4 ? ~x6 : (x6 | x7))))) & (~x2 | ~x3 | ~x5 | x6 | (~x4 & (x4 | ~x7)));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z06 = 1'b0;
  assign z12 = 1'b0;
