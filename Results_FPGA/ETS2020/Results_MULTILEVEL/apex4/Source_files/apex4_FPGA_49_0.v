...
module FAU ( 
  ...
  assign z12 = ~new_n118_ | (~new_n124_ & x0) | new_n140_ | (~new_n132_ & ~x0);
  assign new_n118_ = x3 ? ((~new_n122_ | ~x1) & (x0 | ~new_n123_ | x1)) : new_n119_;
  assign new_n119_ = (new_n120_ | x1) & (~new_n121_ | ~x0 | ~x1 | x2);
  assign new_n120_ = (~x5 | x6 | ~x7 | x0 | ~x2 | x4) & (~x0 | ~x4 | ((x6 | ~x7 | x2 | x5) & (~x6 | x7 | ~x2 | ~x5)));
  assign new_n121_ = x6 & x7 & ~x4 & x5;
  assign new_n122_ = ~x5 & ((x0 & ((x6 & x7 & ~x2 & ~x4) | (~x6 & ~x7 & x2 & x4))) | (x4 & ~x6 & ~x7 & ~x0 & ~x2));
  assign new_n123_ = x2 & x5 & (x4 ? (x6 & x7) : (~x6 & ~x7));
  assign new_n124_ = (new_n131_ | (~x7 ^ x8)) & (new_n128_ | ~x7) & (new_n125_ | x7);
  assign new_n125_ = x1 ? new_n126_ : new_n127_;
  assign new_n126_ = (x8 | ((~x2 | x3 | x4 | ~x5) & (x2 | ~x3 | ~x4 | x5))) & (~x2 | ((~x5 | (x3 ? (~x6 | ~x8) : (~x4 | x6))) & (x3 | ~x4 | x5 | ~x6)));
  assign new_n127_ = (x3 | ((~x5 | ~x6 | x8 | x2 | ~x4) & (~x2 | ((x4 | x5) & (~x4 | ~x5 | x6 | ~x8))))) & (x2 | ~x3 | x8 | (x4 ? (~x5 ^ x6) : (x5 | x6)));
  assign new_n128_ = (new_n129_ | ~x5) & (x2 | ~x3 | ~new_n130_ | x5);
  assign new_n129_ = (~x6 | ((~x3 | ((x1 | ~x2 | ~x4 | x8) & (~x1 | (x2 ? ~x4 : (x4 | ~x8))))) & (x1 | x2 | x3 | ~x8))) & (x3 | x6 | ((~x1 | x4 | (~x8 & (x2 | x8))) & (x1 | x2 | ~x4 | ~x8)));
  assign new_n130_ = x8 & (x1 ? ~x6 : (x4 & x6));
  assign new_n131_ = (x4 | x5 | ~x6 | x1 | ~x2 | ~x3) & (x6 | ((x1 | ~x2 | ~x3 | x4 | ~x5) & (~x1 | ((x2 | x3 | x4 | x5) & (~x4 | ~x5 | ~x2 | ~x3)))));
  assign new_n132_ = (new_n133_ | ~x2) & (new_n136_ | x3) & (x1 | x2) & (~x1 | ~new_n139_ | ~x3);
  assign new_n133_ = x3 ? new_n135_ : new_n134_;
  assign new_n134_ = (x8 | ((~x1 | x4 | ~x5 | x6 | x7) & (~x1 | ~x4 | x5 | ~x7) & (x1 | x7 | (~x4 ^ x5)))) & (x5 | (x1 ? (x7 | ~x8 | (~x4 ^ x6)) : (x4 | ~x6))) & (x4 | ~x5 | x6 | x7 | ~x8);
  assign new_n135_ = (~x5 | (x1 ? (~x7 | (x4 ? x6 : x8)) : ((~x7 | ~x8 | ~x4 | x6) & (x7 | x8 | x4 | ~x6)))) & (~x1 | ~x4 | x5 | ~x6 | ~x7);
  assign new_n136_ = (new_n137_ | x6) & (~x1 | x2 | x4 | new_n138_ | ~x6);
  assign new_n137_ = (x1 | x5 | (x4 & (x7 | ~x8))) & (x2 | x4 | ~x5 | ((~x7 | ~x8) & (~x1 | x7 | x8)));
  assign new_n138_ = x5 ? (x7 | x8) : (~x7 | ~x8);
  assign new_n139_ = ~x4 & ((~x7 & ((x6 & (x8 ? x5 : ~x2)) | (~x2 & ~x5 & ~x6 & ~x8))) | (~x2 & ~x5 & ~x6 & x7 & x8));
  assign new_n140_ = new_n90_ & x1 & x2 & new_n42_ & ~x5 & x6;
  assign z13 = (~new_n142_ & ~x7) | (~new_n148_ & x7) | (new_n155_ & ~x0);
  assign new_n142_ = x6 ? (x0 ? new_n146_ : new_n147_) : new_n143_;
  assign new_n143_ = x2 ? new_n144_ : new_n145_;
  assign new_n144_ = x1 ? (x0 ? ((x3 | ~x4 | x5) & (~x5 | (x3 ? ~x8 : (x4 | x8)))) : (x5 | ~x8 | (x3 & (~x3 | ~x4)))) : (x0 ? ((x4 | x5) & (~x5 | ~x8 | x3 | ~x4)) : (x8 | (x3 ? (x4 | ~x5) : (~x4 ^ x5))));
  assign new_n145_ = (x8 | (x0 ? (~x4 | ((x1 | x3 | ~x5) & (~x3 | x5))) : (~x1 | x4 | (~x3 & (x3 | ~x5))))) & (x4 | ~x5 | ~x8 | x0 | ~x1 | ~x3);
  assign new_n146_ = x1 ? ((~x2 | ~x4 | x5) & (x4 | (x2 ? (x3 ? (~x5 | ~x8) : (x5 | x8)) : (x3 ? (~x5 | x8) : (x5 | ~x8))))) : ((x5 | ((x2 | ~x3 | ~x4 | x8) & (~x2 | ~x8 | (~x3 ^ x4)))) & (x2 | ~x4 | ~x5 | (~x3 & (x3 | x8))));
  assign new_n147_ = x3 ? (x4 | ((~x5 | (x1 ? x2 : (~x2 | ~x8))) & (x5 | x8 | x1 | ~x2))) : ((~x2 | ((x4 | (x1 ? (~x5 & (x5 | ~x8)) : (~x5 | x8))) & (x5 | ~x8 | x1 | ~x4))) & (~x1 | x2 | x8 | (x4 ^ x5)));
  assign new_n148_ = new_n149_ & (~x3 | (x1 ? new_n153_ : ~new_n154_));
  assign new_n149_ = (~new_n152_ | ~x0) & (x3 | ((new_n150_ | ~x1) & (~x0 | ~new_n151_ | x1)));
  assign new_n150_ = x4 ? ((~x0 | x2 | ~x5 | ~x6 | ~x8) & (x5 | x6 | x8 | x0 | ~x2)) : ((~x6 | (x0 ? (x2 ? (~x5 | ~x8) : x5) : (x2 ? (~x5 | x8) : (x5 | ~x8)))) & (x2 | x6 | (x0 ? (~x5 | x8) : x5)));
  assign new_n151_ = ~x2 & ((~x4 & x5 & ~x6 & x8) | (x6 & (x4 ? ~x5 : (x5 & x8))));
  assign new_n152_ = ~x2 & x5 & ~x6 & x8 & (~x1 ^ ~x4);
  assign new_n153_ = (x4 | (x0 ? (x2 | (x5 ? (x6 ^ x8) : (x6 | ~x8))) : ((~x2 | x8 | (~x5 ^ x6)) & (~x6 | ~x8 | x2 | x5)))) & (~x2 | ~x4 | (x0 ? (x8 | (~x5 ^ x6)) : x5));
  assign new_n154_ = x2 & ((x4 & ((x5 & (x0 ? ~x8 : (~x6 & x8))) | (x6 & x8 & ~x0 & ~x5))) | (x0 & ~x4 & ~x5 & ~x8));
  assign new_n155_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & (~x6 | (x2 & x6))));
  assign z15 = ~x0 & (~new_n157_ | (~new_n163_ & x5) | (new_n164_ & ~x1));
  assign new_n157_ = ~new_n158_ & (new_n161_ | x1) & (~new_n121_ | ~x1 | x2 | ~x3);
  assign new_n158_ = ~x5 & ((~new_n159_ & ~x6) | (x2 & ~x3 & ~new_n160_ & x6));
  assign new_n159_ = (x7 | ((x8 | ((~x1 | x2 | ~x3) & (x1 | ~x2 | x3 | ~x4))) & (x1 | x3 | ~x8))) & (x1 | x3 | (x4 & (~x2 | ~x4 | ~x7)));
  assign new_n160_ = (~x1 | x4 | x7 | ~x8) & (x1 | (x4 & (~x4 | ~x7 | x8)));
  assign new_n161_ = (~x2 | ~x3 | ~new_n162_ | ~x5) & x2 & (x3 | x4 | x7);
  assign new_n162_ = ~x6 & x7 & ~x8;
  assign new_n163_ = x4 ? ((~x1 | x2 | x3 | ~x6 | ~x7) & (x1 | ~x2 | ~x3 | x6 | x7)) : ((~x3 | ((x6 | x7 | x1 | ~x2) & (~x1 | x2 | (~x6 ^ x7)))) & (x1 | ~x2 | x3 | ~x7));
  assign new_n164_ = x2 & x4 & ~x5 & x6 & (x3 | (~x3 & ~x7));
  assign z16 = ~x0 & (~new_n169_ | (~x8 & (~new_n166_ | ~new_n172_)));
  assign new_n166_ = (x1 | ~x2 | new_n167_ | x3) & (~new_n168_ | ~x1 | x2 | ~x3);
  assign new_n167_ = (~x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | ~x7) & (~x4 | x5 | x7);
  assign new_n168_ = x4 & x5 & x6 & ~x7;
  assign new_n169_ = (x1 | x2) & (x3 | ((new_n171_ | x1) & (new_n170_ | x5)));
  assign new_n170_ = (~x6 | ((x1 | ~x2 | x4) & (x7 | ~x8 | (x1 ? (~x2 ^ x4) : (~x2 | ~x4))))) & (x1 | x6 | (x4 & (x7 | ~x8) & (~x2 | ~x4 | ~x7)));
  assign new_n171_ = (x4 | x7) & (~x2 | ~x5 | ~x7 | ~x8 | (x4 & (~x4 | ~x6)));
  assign new_n172_ = (~x4 | ~x6 | ~x7 | ~x1 | x2 | x3) & (x4 | x6 | x7 | x1 | ~x2 | ~x3);
  assign z17 = ~x0 & ((~new_n174_ & ~x1) | (~x2 & (~x1 | (~new_n176_ & x1))));
  assign new_n174_ = (new_n175_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n175_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n176_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
