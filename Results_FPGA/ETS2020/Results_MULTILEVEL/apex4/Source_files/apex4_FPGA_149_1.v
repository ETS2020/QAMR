// Benchmark "FAU" written by ABC on Wed Aug  5 23:31:35 2020
...
module FAU ( 
  ...
  assign z07 = (~new_n120_ & x0) | (~new_n143_ & x7) | (~x0 & (~new_n131_ | new_n141_));
  ...
  assign new_n132_ = (x1 | ~new_n134_ | ~x2) & (~new_n133_ | ~x1 | x2 | ~x3);
  assign new_n133_ = ~x6 & ~x7 & x4 & x5;
  assign new_n134_ = x7 & ((x3 & x4 & (x5 ^ ~x6)) | (x5 & ~x6 & ~x3 & ~x4));
  ...
  assign new_n143_ = (~x1 | ~new_n144_ | x3) & (~new_n145_ | x1 | ~x2 | ~x3);
  assign new_n144_ = ~x4 & ~x8 & (x2 ? (x5 & ~x6) : (~x5 & x6));
  assign new_n145_ = x4 & x5 & ~x6 & x8;
  ...
  assign new_n161_ = x4 ? ((x6 | ((x1 | (x3 ? (~x7 | x8) : ~x8)) & (x7 | x8 | ~x1 | ~x3))) & (~x1 | ~x6 | (x3 ? ~x7 : (x7 | x8)))) : ((~x1 | ((~x6 | ~x7 | ~x8) & (x3 | x7 | x8))) & (~x7 | x8 | ~x3 | ~x6) & (x1 | x3 | (~x6 & (~x7 | ~x8))));
  assign new_n162_ = (x8 | ((~x6 | ~x7 | x3 | x4) & (~x3 | (x4 ? x6 : (~x6 | x7))))) & (x7 | ~x8 | (x6 ? (~x3 & (x3 | x4)) : x3));
  assign new_n163_ = x4 & ((x2 & ~x3 & ~x7 & (x6 ^ ~x8)) | (x6 & x7 & ~x8 & ~x2 & x3));
  assign new_n164_ = ((x3 ? (x6 | ~x8) : (~x6 | x8)) | (x1 ? (x2 | x4) : (~x2 | ~x4))) & (~x1 | (x4 ? (x2 ? (~x6 | (~x3 & (x3 | x8))) : (x6 | (x3 & (~x3 | x8)))) : ((~x2 | (x3 ? (~x6 | x8) : (~x8 & (x6 | x8)))) & (~x3 | ~x6 | (~x8 & (x2 | x8)))))) & (x4 | ~x6 | ~x8 | ~x2 | x3);
  ...
  assign new_n174_ = (x4 | ((~x3 | ((~x1 | x7 | (x5 ^ ~x8)) & (~x7 | (x1 & (~x5 | ~x8))))) & (x1 | ((x3 | x5 | x8) & (~x7 | (x8 ? x3 : ~x5)))) & (~x1 | x3 | x5 | ~x7 | x8))) & (~x4 | ((~x3 | ((x5 | ~x7 | ~x8) & (~x1 | (x7 ? x8 : x5)))) & (x1 | x3 | ~x7 | (~x5 ^ ~x8)))) & (~x1 | ~x3 | ~x5 | x7 | ~x8);
  ...
  assign new_n183_ = (x5 | ((~x2 | ((~x7 | x8 | x4 | x6) & (x7 | ~x8 | ~x4 | ~x6))) & (~x7 | ~x8 | ~x4 | x6))) & (x6 | ~x7 | x8 | ~x2 | x4 | ~x5);
  assign z11 = (~new_n185_ & ~x4) | (~new_n199_ & ~x1) | (~new_n193_ & x4);
  assign new_n185_ = (new_n192_ | (x7 ^ x8)) & (new_n189_ | ~x3) & (new_n186_ | x3);
  assign new_n186_ = x6 ? new_n188_ : new_n187_;
  assign new_n187_ = ((x2 ^ ~x7) | ((x0 | ~x5 | ~x8) & (~x0 | ~x1 | x5 | x8))) & (x5 | (x0 ? ((x1 | x2 | (x7 & x8)) & (x7 | ~x8 | ~x1 | ~x2)) : (x1 & (~x7 | x8 | ~x1 | x2)))) & (x1 | ((~x0 | (x2 ? (~x5 | ~x7) : (x7 | x8))) & (~x5 | ~x7 | x8 | x0 | ~x2)));
  assign new_n188_ = x1 ? ((x7 | x8 | x0 | ~x5) & (~x0 | x2 | (x5 ? ~x7 : (x7 | ~x8)))) : ((x5 | ~x7 | ~x8 | ~x0 | x2) & (~x2 | ((x0 | x5) & (x7 | (x0 ? (x5 & (~x5 | x8)) : (~x5 | x8))))));
  assign new_n189_ = (new_n190_ | ~x2) & (~x0 | new_n191_ | x2);
  assign new_n190_ = ((~x7 ^ x8) | ((~x5 | ~x6 | x0 | x1) & (~x0 | (x1 ? (x5 | ~x6) : (~x5 | x6))))) & (~x0 | ((x1 | ~x5 | ~x6 | ~x7 | ~x8) & (x6 | x7 | x8 | ~x1 | x5))) & (x0 | ((x1 | ~x5 | ~x6 | x7 | x8) & (~x1 | ~x7 | (x5 ? (~x6 | x8) : x6))));
  assign new_n191_ = (~x7 | (x1 ? (x5 ? (x6 | x8) : (~x6 | ~x8)) : (x5 | ~x6))) & (x1 | x7 | ((~x6 | (~x5 & (x5 | ~x8))) & (x5 | x6 | x8)));
  assign new_n192_ = (x3 | ~x5 | ~x6 | ~x0 | ~x1 | ~x2) & (x0 | ((~x3 | x5 | ~x6 | ~x1 | x2) & (x1 | ~x2 | x3 | ~x5 | x6)));
  assign new_n193_ = x0 ? (x6 ? new_n197_ : new_n198_) : new_n194_;
  assign new_n194_ = (new_n195_ | ~x2) & (~x1 | new_n196_ | x2);
  assign new_n195_ = x1 ? ((x6 | ((~x7 | ~x8 | x3 | ~x5) & (~x3 | (x5 ? ~x7 : (x7 | ~x8))))) & (x3 | ~x6 | ((x5 | ~x7 | x8) & (x7 | (~x8 & (~x5 | x8)))))) : (((x6 ? (x7 | x8) : (~x7 | ~x8)) | (~x3 ^ x5)) & (~x6 | ((x3 | x5 | x7) & (~x7 | (x3 ? (~x5 | ~x8) : (x5 | x8))))));
  assign new_n196_ = x3 ? ((x7 | (x5 ? (x6 ^ x8) : x6)) & (~x6 | ~x7 | (x5 & x8))) : (x6 | (x5 ? x7 : (~x7 & (x7 | ~x8))));
  assign new_n197_ = x2 ? ((~x5 | ((~x1 | (x3 ? (~x7 & (x7 | ~x8)) : ~x7)) & (x1 | x3 | x7 | ~x8))) & (~x3 | x5 | (x1 ? (x7 | x8) : ~x7))) : ((x3 | ((~x7 | (x1 ? (x5 | x8) : (~x5 ^ ~x8))) & (~x1 | x7 | (x5 & x8)))) & (x5 | x7 | x8 | ~x1 | ~x3));
  assign new_n198_ = (x1 | ((x2 | ~x3 | ~x5 | x7 | x8) & (x5 | ((~x7 | ~x8 | x2 | x3) & (~x2 | ((x7 | ~x8) & (x3 | ~x7 | x8))))))) & (x2 | ~x3 | ~x5 | ~x7 | ~x8) & (~x1 | (x2 ? (x7 | (x3 ? (x5 | ~x8) : ~x5)) : ((~x3 | (x5 ? (~x8 & (~x7 | x8)) : (~x7 | ~x8))) & (~x7 | ~x8 | x3 | ~x5))));
  assign new_n199_ = (x0 | x2) & (~new_n88_ | x5 | x6 | ~x0 | ~x2 | ~x3);
  assign z14 = x1 ? ~new_n201_ : (new_n216_ | ~new_n212_ | (~new_n208_ & ~x5));
  assign new_n201_ = (new_n202_ | x3) & ~new_n205_ & (~x3 | (x2 ? new_n207_ : new_n206_));
  assign new_n202_ = x0 ? new_n204_ : new_n203_;
  assign new_n203_ = ((x6 ? (x7 | x8) : (~x7 | ~x8)) | (x2 ? (~x4 | ~x5) : (x4 | x5))) & (~x5 | ((x7 | (x2 ? (x4 ? (~x6 | ~x8) : (x6 | x8)) : (~x4 | (x6 & (~x6 | x8))))) & (~x6 | ~x7 | x8 | ~x2 | x4))) & (x5 | x6 | ((x2 | ~x4 | (~x7 & (x7 | ~x8))) & (x7 | ~x8 | ~x2 | x4)));
  assign new_n204_ = ((x4 ? ~x6 : (x6 | ~x8)) | (x2 ? (~x5 | ~x7) : (x5 | x7))) & (~x5 | ~x7 | ~x8 | x2 | ~x4) & (~x2 | x4 | x5 | x7 | x8) & (~x6 | x7 | x8 | x2 | ~x4) & (x5 | (x2 ? (x6 | x7 | (~x4 & (x4 | ~x8))) : (~x6 | ~x7 | (x4 & (~x4 | x8)))));
  assign new_n205_ = new_n42_ & x5 & x6 & ~x0 & x2 & ~x4;
  assign new_n206_ = x0 ? ((x4 | x5 | ~x6 | ~x7 | x8) & (~x5 | ((x7 | x8 | x4 | ~x6) & (x6 | ((~x7 | ~x8) & (~x4 | (~x8 & (~x7 | x8)))))))) : ((~x7 | ((~x4 | ~x6 | (x5 & x8)) & (x4 | x5 | x6 | ~x8))) & (~x5 | x7 | (x4 ? (~x6 ^ ~x8) : x6)));
  assign new_n207_ = (x5 | ((x0 | x6 | ~x7) & (~x0 | (x6 ? (~x7 ^ x8) : (x7 | x8))) & (~x6 | ~x7 | x8 | x0 | x4))) & (x6 | x7 | ~x8 | ~x0 | x4 | ~x5);
  assign new_n208_ = (new_n210_ | ~x3) & ~new_n209_ & (new_n211_ | x3);
  assign new_n209_ = new_n42_ & ~x6 & x0 & x2 & x4;
  assign new_n210_ = (~x6 | ((~x2 | ((~x4 | ((~x7 | (~x0 & (x0 | ~x8))) & (x0 | x7 | x8))) & (x0 | x4 | x7 | x8))) & (~x0 | x2 | x4 | (~x7 & (x7 | ~x8))))) & (~x0 | x6 | ((~x4 | x7 | x8) & (~x2 | x4 | (~x7 ^ x8))));
  assign new_n211_ = x0 ? ((~x4 | (x2 ? (x6 ? (x7 | ~x8) : (~x7 | x8)) : (~x7 | (~x6 ^ ~x8)))) & (x2 | x4 | (x6 ^ (x7 & x8)))) : ((x6 | x7 | ~x8) & (x4 | (x6 & (x7 | x8))));
  assign new_n212_ = (~x5 | (x0 ? new_n214_ : (new_n215_ | ~x2))) & (x2 | (~new_n213_ & x0));
  assign new_n213_ = new_n88_ & ~x6 & x0 & ~x3 & ~x4;
  assign new_n214_ = x4 ? ((x2 | ~x3 | ~x6 | x7) & (x8 | ((x6 | x7 | x2 | x3) & (~x2 | (x3 ? (x6 | ~x7) : (~x6 | x7)))))) : (x2 ? ((x3 | (x6 ? (x7 | x8) : ~x7)) & (~x7 | ~x8 | ~x3 | ~x6)) : ((~x7 | ~x8 | x3 | x6) & (x7 | x8 | ~x3 | ~x6)));
  assign new_n215_ = (x6 | ~x7 | ~x8 | x3 | ~x4) & (~x6 | x8 | (x3 ? ~x7 : (~x4 | x7)));
  assign new_n216_ = ~new_n217_ & (x4 ? (~x5 & x7) : (x5 & ~x7));
  assign new_n217_ = (x0 | ~x2 | (x3 ? (x6 | ~x8) : (~x6 | x8))) & (~x0 | x2 | ~x3 | ~x6 | ~x8);
  assign z17 = ~x0 & ((~new_n219_ & ~x1) | (~x2 & (~x1 | (~new_n221_ & x1))));
  assign new_n219_ = (new_n220_ | x3) & (~new_n42_ | ~new_n39_ | ~x2 | ~x3 | x4);
  assign new_n220_ = (~x2 | ((x4 | x5 | ~x6) & (~x7 | (x4 ? (~x6 | (~x5 ^ ~x8)) : (~x5 | x6))))) & (x4 | (x7 & (x5 | x6)));
  assign new_n221_ = (~x4 | (x3 ? ((~x7 | ~x8 | x5 | x6) & (x7 | x8 | ~x5 | ~x6)) : (~x6 | ~x8 | (x5 ^ x7)))) & (~x6 | x7 | x8 | x3 | x4 | ~x5);
  assign z18 = ~x0 & (~new_n223_ | (~x8 & (x1 ? new_n227_ : ~new_n228_)));
  assign new_n223_ = ~new_n226_ & (~x3 | (~new_n225_ & (new_n224_ | ~x8)));
  assign new_n224_ = x1 ? (x2 | ((x6 | ~x7 | ~x4 | x5) & (x4 | ~x5 | (~x6 ^ x7)))) : (~x2 | ~x4 | (x5 ? (x6 | x7) : ~x6));
  assign new_n225_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n226_ = ~x1 & (~x2 | (~x3 & ~x4 & ~x5 & ~x6));
  assign new_n227_ = ~x2 & ((x6 & ((x3 & ~x4 & x5 & ~x7) | (~x3 & (x4 ? (~x5 & x7) : (x5 & ~x7))))) | (x3 & ~x6 & (x4 ? (~x5 & ~x7) : (x5 ^ ~x7))));
  assign new_n228_ = (x5 | ((x3 | ((x4 | x7) & (~x6 | ~x7 | ~x2 | ~x4))) & (~x2 | ~x3 | (x4 ? ~x6 : (x6 | x7))))) & (~x2 | ~x3 | ~x5 | x6 | (~x4 & (x4 | ~x7)));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z06 = 1'b0;
  assign z10 = 1'b0;
