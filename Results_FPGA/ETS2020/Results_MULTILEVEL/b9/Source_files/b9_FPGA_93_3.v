...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n77_, new_n78_,
    ...
    new_n89_, new_n93_, new_n94_, new_n96_, new_n97_, new_n99_;
  ...
  assign z18 = ~new_n94_ | (x08 & (new_n93_ | (~x27 & ~x28 & x35)));
  assign new_n93_ = x29 & x39 & x40;
  assign new_n94_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = ~x09 & ~x30 & (new_n97_ | (~new_n93_ & ~new_n96_));
  assign new_n96_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n97_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
