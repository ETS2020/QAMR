...
module FAU ( 
  ...
  assign z12 = new_n81_ | ((new_n66_ | ~x27) & (~z08 | x04));
  assign new_n81_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n84_ | (~x04 & new_n83_ & ~x13))) | (~x04 & new_n85_ & ~x13);
  ...
  assign z18 = ~new_n95_ | (x08 & ((z08 & x29) | (new_n69_ & ~x27)));
