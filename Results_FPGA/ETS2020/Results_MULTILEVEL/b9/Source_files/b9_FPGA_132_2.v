// Benchmark "FAU" written by ABC on Wed Aug  5 00:28:25 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n73_, new_n75_,
  ...
  assign z10 = new_n78_ | (~x04 & (new_n77_ | (x27 & ~new_n75_ & ~new_n76_)));
  assign new_n75_ = ~x36 & (x28 | ~x35);
  assign new_n76_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n77_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n78_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & (new_n82_ | (~new_n80_ & ~new_n81_));
  assign new_n80_ = x29 & x39 & x40;
  assign new_n81_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n82_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  ...
  assign z18 = ~new_n98_ | (x08 & (new_n80_ | (~x27 & ~x28 & x35)));
  ...
  assign z08 = 1'b0;
  assign z09 = 1'b0;
  assign z19 = ~x09 & ~x30 & (new_n82_ | (~new_n80_ & ~new_n81_));
endmodule
