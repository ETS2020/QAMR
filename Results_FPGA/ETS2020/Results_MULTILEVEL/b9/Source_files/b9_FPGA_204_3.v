// Benchmark "FAU" written by ABC on Wed Aug  5 00:28:49 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n77_, new_n78_,
    ...
    new_n89_, new_n94_, new_n95_, new_n97_, new_n98_, new_n100_;
  ...
  assign z18 = ~new_n95_ | (x08 & (new_n94_ | (~x27 & ~x28 & x35)));
  assign new_n94_ = x29 & x39 & x40;
  assign new_n95_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = ~x09 & ~x30 & (new_n98_ | (~new_n94_ & ~new_n97_));
  assign new_n97_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n98_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
