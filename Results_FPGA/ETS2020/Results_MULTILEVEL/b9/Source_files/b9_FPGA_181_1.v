...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n70_, new_n75_, new_n76_, new_n78_,
  ...
  assign z10 = new_n81_ | (~x04 & (new_n80_ | (x27 & ~new_n78_ & ~new_n79_)));
  assign new_n78_ = ~x36 & (x28 | ~x35);
  assign new_n79_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n80_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n81_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & (new_n84_ | (~new_n83_ & (~z08 | ~x29)));
  assign new_n83_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n84_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n86_ | ((new_n66_ | ~x27) & (~z08 | x04));
  ...
  assign z17 = 1'b0;
  assign z05 = ~z06;
  assign z19 = ~x09 & ~x30 & (new_n84_ | (~new_n83_ & (~z08 | ~x29)));
endmodule
