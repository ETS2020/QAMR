// Benchmark "FAU" written by ABC on Wed Aug  5 00:27:48 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n70_, new_n73_, new_n74_, new_n76_,
    new_n77_, new_n78_, new_n79_, new_n81_, new_n82_, new_n84_, new_n86_,
    new_n87_, new_n88_, new_n90_, new_n91_, new_n92_, new_n93_, new_n97_,
    new_n98_, new_n100_;
  ...
  assign z11 = ~x09 & ~x30 & (new_n82_ | (~new_n81_ & (~z08 | ~x29)));
  assign new_n81_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n82_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n84_ | ((new_n66_ | ~x27) & (~z08 | x04));
  ...
  assign z09 = 1'b0;
  assign z15 = 1'b0;
  assign z19 = ~x09 & ~x30 & (new_n82_ | (~new_n81_ & (~z08 | ~x29)));
endmodule
