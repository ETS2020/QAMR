...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n77_, new_n78_,
    new_n79_, new_n81_, new_n82_, new_n84_, new_n86_, new_n87_, new_n88_,
    new_n90_, new_n91_, new_n92_, new_n93_, new_n97_, new_n98_, new_n100_;
  ...
  assign new_n82_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
