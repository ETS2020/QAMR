...
module FAU ( 
  ...
  assign z18 = ~new_n93_ | (x08 & (new_n92_ | (~x27 & ~x28 & x35)));
  assign new_n92_ = x29 & x39 & x40;
  assign new_n93_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = ~x09 & ~x30 & (new_n96_ | (~new_n92_ & ~new_n95_));
  assign new_n95_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n96_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
