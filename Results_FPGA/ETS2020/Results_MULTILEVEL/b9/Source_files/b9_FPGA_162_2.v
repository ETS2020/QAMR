// Benchmark "FAU" written by ABC on Wed Aug  5 00:28:35 2020
...
module FAU ( 
  ...
  assign z11 = ~x09 & ~x30 & (new_n85_ | (~new_n83_ & ~new_n84_));
  assign new_n83_ = x29 & x39 & x40;
  assign new_n84_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n85_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n87_ | ((new_n66_ | ~x27) & (x04 | ~x39 | ~x40));
  ...
  assign z18 = ~new_n101_ | (x08 & (new_n83_ | (~x27 & ~x28 & x35)));
  ...
  assign z06 = 1'b0;
  assign z08 = 1'b0;
  assign z19 = ~x09 & ~x30 & (new_n85_ | (~new_n83_ & ~new_n84_));
endmodule
