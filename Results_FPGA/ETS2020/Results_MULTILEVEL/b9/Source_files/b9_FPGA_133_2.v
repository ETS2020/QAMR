// Benchmark "FAU" written by ABC on Wed Aug  5 00:28:26 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n73_, new_n74_, new_n75_,
    new_n76_, new_n78_, new_n79_, new_n80_, new_n82_, new_n84_, new_n85_,
    new_n86_, new_n88_, new_n89_, new_n90_, new_n91_, new_n95_, new_n97_;
  ...
  assign z10 = new_n76_ | (~x04 & (new_n75_ | (x27 & ~new_n73_ & ~new_n74_)));
  assign new_n73_ = ~x36 & (x28 | ~x35);
  assign new_n74_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n75_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n76_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & (new_n80_ | (~new_n78_ & ~new_n79_));
  assign new_n78_ = x29 & x39 & x40;
  assign new_n79_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n80_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n82_ | ((new_n66_ | ~x27) & (x04 | ~x39 | ~x40));
  assign new_n82_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  ...
  assign new_n86_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = (~new_n88_ & (new_n89_ | ~new_n90_)) | new_n91_ | (~new_n90_ & (new_n66_ | ~x27));
  assign new_n88_ = ~x18 & ~x19 & x20;
  assign new_n89_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n90_ = x39 & x40 & ~x04 & ~x13;
  assign new_n91_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n95_ | (x08 & (new_n78_ | (~x27 & ~x28 & x35)));
  ...
  assign z08 = 1'b0;
  assign z15 = 1'b0;
  assign z19 = ~x09 & ~x30 & (new_n80_ | (~new_n78_ & ~new_n79_));
endmodule
