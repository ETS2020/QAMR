...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n41_, new_n43_, new_n45_, new_n46_, new_n47_, new_n49_,
  ...
  assign z07 = ~new_n45_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n45_ = (new_n47_ | ~x11) & x04 & (~new_n46_ | x09 | x10 | x11);
  assign new_n46_ = x06 & x07 & x08;
  assign new_n47_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = ~new_n49_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n49_ = (~x12 | (new_n46_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n46_ | x11 | x12 | x09 | x10);
  ...
  assign z10 = x04 & ((x06 & new_n55_ & x07) | (new_n37_ & x14));
  assign new_n55_ = x08 & ~x09 & ~new_n37_ & ~new_n56_;
