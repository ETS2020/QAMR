...
module FAU ( 
  ...
  assign z43 = (~new_n151_ & x4) | new_n126_ | new_n152_ | (~new_n153_ & ~x4);
  ...
  assign new_n157_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n124_ | x4 | x5)))));
  ...
  assign z54 = (~new_n169_ & ~x0) | new_n170_ | ~new_n172_;
  assign new_n169_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n140_ | ~x5))));
  assign new_n170_ = ~x1 & ((~new_n171_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n171_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n172_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n161_ & ~x4));
  assign z57 = (x0 & (~new_n174_ | ~x3)) | ~new_n181_ | (~x0 & (~new_n178_ | new_n183_));
  assign new_n174_ = (new_n175_ | x5) & ~new_n176_ & (new_n177_ | ~x5) & (~new_n124_ | x4);
  assign new_n175_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n176_ = x2 & (x4 | (~x1 & x3));
  assign new_n177_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n178_ = ~new_n179_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n180_ & ~x3));
  assign new_n179_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n180_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n181_ = (x1 | x2 | x3) & (new_n182_ | x4);
  assign new_n182_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n183_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z60 = new_n186_ | ~new_n187_ | (~x4 & (~x5 | (~new_n185_ & x5)));
  assign new_n185_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n186_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n187_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z62 = ~new_n189_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n189_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
  assign z16 = 1'b0;
