// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:21 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  ...
  assign new_n179_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n132_ | ~x5))));
  ...
  assign new_n194_ = ~new_n121_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n211_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x0 | x1 | ~x2) & (~x1 | x6))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
