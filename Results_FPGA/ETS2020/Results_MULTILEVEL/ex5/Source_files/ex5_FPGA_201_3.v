// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:59 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    new_n92_, new_n94_, new_n106_, new_n110_, new_n113_, new_n114_,
  ...
  assign z46 = new_n197_ | ~new_n198_ | (~x4 & (~new_n195_ | (~new_n194_ & ~x0)));
  assign new_n194_ = ~x5 & (~new_n146_ | x5 | ~x1 | x2 | x3);
  assign new_n195_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n196_ | ~x6 | ~x7)))));
  assign new_n196_ = ~x1 & ~x2;
  assign new_n197_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n198_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n202_ | (~x4 & (~new_n200_ | (~new_n201_ & ~x5)));
  assign new_n200_ = (~x0 | ~x6 | (x7 & (~new_n196_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n201_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n202_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  assign z48 = ~new_n204_ | new_n207_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n204_ = new_n206_ & (x2 | ((x1 | x3) & (~x0 | (~new_n205_ & x3))));
  assign new_n205_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n206_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n207_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n209_ | ~new_n210_ | (~x3 & (new_n196_ | new_n151_));
  assign new_n209_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n210_ = ~new_n211_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n211_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z50 = (~new_n213_ & x0) | (~new_n214_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n213_ = (x1 | ((~x2 | ~x3) & (~new_n185_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n217_ = x5 ? new_n218_ : (~x6 & (~new_n92_ | x2 | ~x3 | x6));
  assign new_n218_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n223_ | ~new_n221_ | (x3 & (new_n220_ | new_n222_ | new_n151_));
  assign new_n220_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n221_ = ~new_n182_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n222_ = x1 & (x4 | ~x6);
  assign new_n223_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n227_ | (~x4 & (x5 ? ~new_n226_ : ~new_n225_));
  assign new_n225_ = ~x6 & (x2 | (x3 & (~new_n92_ | ~x3 | x6)));
  ...
  assign new_n229_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n163_ | ~x5))));
  assign new_n230_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n231_ & ~x4));
  assign new_n231_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n232_ = (~x0 | (~new_n190_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n234_ | (~x4 & (x5 ? ~new_n236_ : (x6 | (~x1 & ~x6))));
  assign new_n234_ = ~new_n235_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n235_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n236_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z57 = (~new_n238_ & x0) | ~new_n245_ | (~x0 & (~new_n242_ | new_n247_));
  assign new_n238_ = x3 & (new_n239_ | x5) & ~new_n240_ & ~new_n175_ & (new_n241_ | ~x5);
  assign new_n239_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n240_ = x2 & (x4 | (~x1 & x3));
  assign new_n241_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n242_ = ~new_n243_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n244_ & ~x3));
  assign new_n243_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n244_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n245_ = (x1 | x2 | x3) & (new_n246_ | x4);
  assign new_n246_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n247_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z58 = ~new_n252_ | (~new_n249_ & ~x4);
  assign new_n249_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n250_ | x5) & (~x5 | (x6 & (new_n251_ | ~x6)));
  assign new_n250_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n251_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n252_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n254_ | new_n255_ | new_n265_ | new_n256_ | new_n259_ | new_n263_;
  assign new_n254_ = ~new_n151_ & (x0 | ~x2 | ~x4);
  assign new_n255_ = x5 & ((~x4 & x7) | (new_n92_ & ~x2 & x4));
  assign new_n256_ = x3 & (~new_n258_ | (~new_n257_ & ~x5));
  assign new_n257_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n258_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n259_ = ~x3 & ((~new_n260_ & ~x0) | new_n261_ | (~new_n262_ & x0));
  assign new_n260_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n261_ = ~x2 & (x0 | (x1 & x4));
  assign new_n262_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n263_ = ~new_n264_ & ~x5;
  assign new_n264_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n265_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n268_ | ~new_n269_ | (~x4 & (~x5 | (~new_n267_ & x5)));
  assign new_n267_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n268_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n269_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n272_ | (~x4 & ((~new_n271_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n271_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n272_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z00 = 1'b0;
  assign z13 = 1'b0;
  assign z24 = 1'b0;
  assign z56 = 1'b0;
