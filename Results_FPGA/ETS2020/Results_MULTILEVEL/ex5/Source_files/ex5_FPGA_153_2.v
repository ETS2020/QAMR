...
module FAU ( 
  ...
  assign z43 = (~new_n157_ & x4) | new_n130_ | new_n155_ | (~new_n158_ & ~x4);
  assign new_n155_ = x0 & (new_n156_ | (x2 & ~x5 & ~x6));
  ...
  assign new_n162_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n128_ | x4 | x5)))));
  assign new_n163_ = new_n164_ & (~x0 | (x3 & (~new_n161_ | x1 | ~x3 | x4)));
  assign new_n164_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n165_ = (new_n167_ | x4) & ((~z00 & ~new_n166_) | ~x0);
  assign new_n166_ = x1 & x3 & x7;
  assign new_n167_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  assign new_n168_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z48 = ~new_n170_ | new_n173_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n170_ = new_n172_ & (x2 | ((x1 | x3) & (~x0 | (~new_n171_ & x3))));
  assign new_n171_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n172_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n173_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z50 = (~new_n175_ & x0) | (~new_n176_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n175_ = (x1 | ((~x2 | ~x3) & (~new_n161_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n183_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n144_ | ~x5))));
  assign new_n184_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n185_ & ~x4));
  assign new_n185_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n186_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n166_ & ~x4));
  assign z57 = (~new_n188_ & x0) | ~new_n195_ | (~x0 & (~new_n192_ | new_n197_));
  assign new_n188_ = x3 & (new_n189_ | x5) & ~new_n190_ & ~new_n156_ & (new_n191_ | ~x5);
  assign new_n189_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n190_ = x2 & (x4 | (~x1 & x3));
  assign new_n191_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n192_ = ~new_n193_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n194_ & ~x3));
  assign new_n193_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n194_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n195_ = (x1 | x2 | x3) & (new_n196_ | x4);
  assign new_n196_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n197_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  ...
  assign new_n203_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z04 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
