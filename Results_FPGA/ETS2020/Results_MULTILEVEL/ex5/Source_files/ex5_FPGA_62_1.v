// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:20 2020
...
module FAU ( 
  ...
  assign new_n168_ = ~new_n143_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n176_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n134_ | ~x5))));
  ...
  assign new_n192_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
