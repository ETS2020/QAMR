...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n92_,
    new_n95_, new_n101_, new_n102_, new_n104_, new_n105_, new_n106_,
  ...
  assign z44 = new_n130_ | ~new_n132_ | (x1 & (~x0 | (~x2 & ~x5)));
  assign new_n130_ = x3 & (x4 ? ~x0 : new_n131_);
  assign new_n131_ = ~x6 & ((x5 & ~x7) | (x0 & ~x1 & ~x2 & ~x5));
  assign new_n132_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n133_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n133_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign z46 = new_n139_ | ~new_n140_ | (~x4 & (~new_n137_ | (~new_n135_ & ~x0)));
  assign new_n135_ = ~x5 & (~new_n136_ | ~x1 | x5 | ~x6 | x7);
  assign new_n136_ = ~x2 & ~x3;
  assign new_n137_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n138_ | ~x6 | ~x7)))));
  assign new_n138_ = ~x1 & ~x2;
  assign new_n139_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n140_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n144_ | (~x4 & (~new_n142_ | (~new_n143_ & ~x5)));
  assign new_n142_ = (~x0 | ~x6 | (x7 & (~new_n138_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n143_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n144_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  assign z48 = ~new_n146_ | new_n149_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n146_ = new_n148_ & (x2 | ((x1 | x3) & (~x0 | (~new_n147_ & x3))));
  assign new_n147_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n148_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n149_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n151_ | ~new_n152_ | (~x3 & (new_n138_ | new_n120_));
  assign new_n151_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n152_ = ~new_n153_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n153_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z51 = (~new_n155_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n155_ = x5 ? new_n156_ : new_n157_;
  assign new_n156_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n157_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n162_ | ~new_n160_ | (x3 & (new_n159_ | new_n161_ | new_n120_));
  assign new_n159_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n160_ = ~new_n133_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n170_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n171_ & ~x4));
  ...
  assign new_n179_ = (new_n180_ | ~x6) & (~x5 | x6) & (x5 | (~new_n136_ & (x6 | (~x0 & x1))));
  assign new_n180_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  ...
  assign z59 = ~new_n189_ | new_n199_ | new_n200_ | new_n190_ | new_n193_ | new_n197_;
  assign new_n189_ = ~new_n120_ & (x0 | ~x2 | ~x4);
  assign new_n190_ = x3 & (~new_n192_ | (~new_n191_ & ~x5));
  assign new_n191_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n192_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n193_ = ~x3 & ((~new_n194_ & ~x0) | new_n195_ | (~new_n196_ & x0));
  assign new_n194_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n195_ = ~x2 & (x0 | (x1 & x4));
  assign new_n196_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n197_ = ~new_n198_ & ~x5;
  assign new_n198_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n199_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
  ...
  assign z61 = ~new_n207_ | (~x4 & ((~new_n206_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n206_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n207_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n209_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n209_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
