// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:29 2020
...
module FAU ( 
  ...
  assign new_n205_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z49 = new_n207_ | ~new_n208_ | (~x3 & (new_n194_ | new_n148_));
  ...
  assign new_n211_ = (x1 | ((~x2 | ~x3) & (~new_n182_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n221_ | ~new_n219_ | (x3 & (new_n218_ | new_n220_ | new_n148_));
  assign new_n218_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n219_ = ~new_n179_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n227_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n160_ | ~x5))));
  assign new_n228_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n229_ & ~x4));
  assign new_n229_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n230_ = (~x0 | (~new_n187_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n236_ = (new_n237_ | ~x6) & (~x5 | x6) & (x5 | (~new_n192_ & (x6 | (~x0 & x1))));
  ...
  assign new_n241_ = x3 & (new_n242_ | x5) & ~new_n243_ & ~new_n172_ & (new_n244_ | ~x5);
  ...
  assign new_n248_ = (new_n249_ | x4) & (~new_n192_ | x1);
  ...
  assign new_n257_ = ~new_n148_ & (x0 | ~x2 | ~x4);
