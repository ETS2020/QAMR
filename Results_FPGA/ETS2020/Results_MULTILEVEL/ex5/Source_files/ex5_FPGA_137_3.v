...
module FAU ( 
  ...
  assign z49 = new_n200_ | ~new_n201_ | (~x3 & (new_n192_ | new_n146_));
  ...
  assign new_n204_ = (x1 | ((~x2 | ~x3) & (~new_n180_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n213_ | ~new_n212_ | (x3 & (new_n211_ | new_n146_ | new_n214_));
  assign new_n211_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n212_ = ~new_n177_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n213_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign new_n214_ = x1 & (x4 | ~x6);
  assign z54 = (~new_n216_ & ~x0) | new_n217_ | ~new_n219_;
  assign new_n216_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n158_ | ~x5))));
  assign new_n217_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n218_ & ~x4));
  assign new_n218_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n219_ = (~x0 | (~new_n185_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n225_ = (new_n226_ | ~x6) & (~x5 | x6) & (x5 | (~new_n190_ & (x6 | (~x0 & x1))));
  ...
  assign new_n230_ = x3 & (new_n231_ | x5) & ~new_n232_ & ~new_n170_ & (new_n233_ | ~x5);
  ...
  assign new_n237_ = (new_n238_ | x4) & (~new_n190_ | x1);
  ...
  assign new_n246_ = ~new_n146_ & (x0 | ~x2 | ~x4);
