...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n99_, new_n103_,
  ...
  assign z52 = (~new_n167_ & ~x0) | ~new_n165_ | (x3 & (~new_n164_ | (new_n168_ & x0)));
  assign new_n164_ = ~new_n130_ & (~x1 | (~x4 & x6));
  assign new_n165_ = (new_n166_ | x4) & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n166_ = (~x5 | (~x7 & (x3 | x6 | x7))) & (~x6 | (x5 & (~x5 | x7)));
  assign new_n167_ = ~x1 & (~x2 | ~x3 | ~x4);
  assign new_n168_ = ~x1 & (x2 | (~x2 & ~x4 & ~x5 & ~x6));
  ...
  assign new_n174_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n156_ & ~x4));
  assign z57 = (x0 & (~new_n176_ | ~x3)) | ~new_n183_ | (~x0 & (~new_n180_ | new_n185_));
  assign new_n176_ = (new_n177_ | x5) & ~new_n178_ & (new_n179_ | ~x5) & (~new_n125_ | x4);
