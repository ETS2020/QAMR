...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n90_,
    new_n92_, new_n94_, new_n97_, new_n104_, new_n107_, new_n113_,
  ...
  assign z44 = new_n182_ | ~new_n180_ | (x3 & (x4 ? ~x0 : new_n179_));
  assign new_n179_ = ~x6 & ((x5 & ~x7) | (new_n90_ & ~x2 & ~x5));
  assign new_n180_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n181_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n181_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign new_n182_ = x1 & (~x0 | (~x2 & ~x5));
  ...
  assign new_n218_ = x5 ? new_n219_ : (~x6 & (~new_n90_ | x2 | ~x3 | x6));
  ...
  assign new_n261_ = x5 & ((~x4 & x7) | (new_n90_ & ~x2 & x4));
