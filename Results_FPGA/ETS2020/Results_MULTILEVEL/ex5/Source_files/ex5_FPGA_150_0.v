...
module FAU ( 
  ...
  assign new_n162_ = x0 & (~x3 | (new_n141_ & ~x1 & ~x4));
  assign new_n163_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n136_ | x4 | x5)))));
  assign new_n164_ = new_n165_ & (~x0 | (x3 & (~new_n141_ | x1 | ~x3 | x4)));
  ...
  assign new_n170_ = ~x5 & (~new_n136_ | x5 | ~new_n171_ | ~x1);
  ...
  assign new_n190_ = (x1 | ((~x2 | ~x3) & (~new_n141_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n194_ = x5 ? new_n195_ : (~x6 & (~new_n88_ | x2 | ~x3 | x6));
  ...
  assign new_n202_ = ~x6 & (x2 | (x3 & (~new_n88_ | ~x3 | x6)));
  ...
  assign new_n206_ = ~new_n207_ & (~x0 | (x2 ? (~new_n75_ & ~x4) : x3));
  ...
  assign new_n231_ = x5 & ((~x4 & x7) | (new_n88_ & ~x2 & x4));
  ...
  assign new_n249_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n251_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n251_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z02 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z14 = 1'b0;
