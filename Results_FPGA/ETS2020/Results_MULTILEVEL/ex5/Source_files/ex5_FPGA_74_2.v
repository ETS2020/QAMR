...
module FAU ( 
  ...
  assign z38 = new_n108_ | new_n111_ | new_n112_ | new_n118_;
  ...
  assign new_n149_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n123_ | x4 | x5)))));
  ...
  assign new_n162_ = (x1 | ((~x2 | ~x3) & (~new_n148_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n170_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n153_ & ~x4));
  assign z57 = (x0 & (~new_n172_ | ~x3)) | ~new_n179_ | (~x0 & (~new_n176_ | new_n181_));
  assign new_n172_ = (new_n173_ | x5) & ~new_n174_ & (new_n175_ | ~x5) & (~new_n123_ | x4);
  ...
  assign z60 = new_n189_ | ~new_n190_ | (~x4 & (~x5 | (~new_n188_ & x5)));
  assign new_n188_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n189_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n190_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z62 = ~new_n192_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n192_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
  assign z23 = 1'b0;
