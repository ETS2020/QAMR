// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:53 2020
...
module FAU ( 
  ...
  assign z44 = new_n135_ | ~new_n137_ | (x1 & (~x0 | (~x2 & ~x5)));
  assign new_n135_ = x3 & (x4 ? ~x0 : new_n136_);
  assign new_n136_ = ~x6 & ((x5 & ~x7) | (x0 & ~x1 & ~x2 & ~x5));
  assign new_n137_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n138_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n138_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign z46 = new_n143_ | ~new_n144_ | (~x4 & (~new_n140_ | (~new_n142_ & ~x0)));
  assign new_n140_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n141_ | ~x6 | ~x7)))));
  assign new_n141_ = ~x1 & ~x2;
  assign new_n142_ = ~x5 & (~x1 | x2 | x3 | x5 | ~x6 | x7);
  ...
  assign new_n146_ = (~x0 | ~x6 | (x7 & (~new_n141_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  ...
  assign z49 = new_n155_ | ~new_n156_ | (~x3 & (new_n141_ | new_n125_));
  ...
  assign z59 = ~new_n180_ | new_n181_ | new_n191_ | new_n182_ | new_n185_ | new_n189_;
  assign new_n180_ = ~new_n125_ & (x0 | ~x2 | ~x4);
  assign new_n181_ = x5 & ((~x4 & x7) | (new_n88_ & ~x2 & x4));
  assign new_n182_ = x3 & (~new_n184_ | (~new_n183_ & ~x5));
  assign new_n183_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n184_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n185_ = ~x3 & ((~new_n186_ & ~x0) | new_n187_ | (~new_n188_ & x0));
  assign new_n186_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n187_ = ~x2 & (x0 | (x1 & x4));
  assign new_n188_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n189_ = ~new_n190_ & ~x5;
  assign new_n190_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
