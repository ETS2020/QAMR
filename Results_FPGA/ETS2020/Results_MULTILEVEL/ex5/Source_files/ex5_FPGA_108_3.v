...
module FAU ( 
  ...
  assign z49 = new_n204_ | ~new_n205_ | (~x3 & (new_n196_ | new_n150_));
  ...
  assign new_n208_ = (x1 | ((~x2 | ~x3) & (~new_n184_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n212_ = x5 ? new_n213_ : (~x6 & (~new_n91_ | x2 | ~x3 | x6));
  assign new_n213_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n218_ | ~new_n217_ | (~new_n215_ & x3);
  assign new_n215_ = ~new_n216_ & ~new_n150_ & (~x1 | (~x4 & x6));
  assign new_n216_ = x0 & ~x1 & (x2 | (~x2 & ~x4 & ~x5 & ~x6));
  assign new_n217_ = ~new_n181_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n218_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n222_ | (~x4 & (x5 ? ~new_n221_ : ~new_n220_));
  assign new_n220_ = ~x6 & (x2 | (x3 & (~new_n91_ | ~x3 | x6)));
  ...
  assign new_n224_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n162_ | ~x5))));
  assign new_n225_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n226_ & ~x4));
  assign new_n226_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n227_ = (~x0 | (~new_n189_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n233_ = (new_n234_ | ~x6) & (~x5 | x6) & (x5 | (~new_n194_ & (x6 | (~x0 & x1))));
  ...
  assign new_n238_ = x3 & (new_n239_ | x5) & ~new_n240_ & ~new_n174_ & (new_n241_ | ~x5);
  ...
  assign new_n245_ = (new_n246_ | x4) & (~new_n194_ | x1);
