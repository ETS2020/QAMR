// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:36 2020
...
module FAU ( 
  ...
  assign new_n196_ = x5 ? new_n197_ : (~x6 & (~new_n84_ | x2 | ~x3 | x6));
  ...
  assign new_n204_ = ~x6 & (x2 | (x3 & (~new_n84_ | ~x3 | x6)));
  ...
  assign new_n238_ = x5 & ((~x4 & x7) | (new_n84_ & ~x2 & x4));
