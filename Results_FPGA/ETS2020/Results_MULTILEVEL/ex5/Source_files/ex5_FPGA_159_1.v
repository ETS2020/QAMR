...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n92_,
    ...
    new_n209_, new_n210_, new_n212_, new_n213_, new_n215_;
  ...
  assign z52 = new_n169_ | ~new_n167_ | (x3 & (new_n166_ | new_n168_ | new_n120_));
  ...
  assign new_n175_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n131_ | ~x5))));
  ...
  assign new_n185_ = (new_n186_ | ~x6) & (~x5 | x6) & (x5 | (~new_n143_ & (x6 | (~x0 & x1))));
