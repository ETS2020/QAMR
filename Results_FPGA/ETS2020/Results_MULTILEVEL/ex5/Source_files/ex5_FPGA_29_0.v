// Benchmark "FAU" written by ABC on Thu Aug  6 04:05:56 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n78_, new_n80_, new_n83_, new_n85_, new_n86_, new_n94_, new_n96_,
  ...
  assign new_n137_ = (~x1 | ~x3 | ~x5) & (~new_n138_ | x1 | x2);
  ...
  assign z45 = ((new_n160_ | ~new_n161_) & ~x2) | new_n166_ | ~new_n164_ | (~new_n162_ & x2);
  assign new_n160_ = x0 & (~x3 | (new_n138_ & ~x1 & ~x4));
  assign new_n161_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n133_ | x4 | x5)))));
  assign new_n162_ = new_n163_ & (~x0 | (x3 & (~new_n138_ | x1 | ~x3 | x4)));
  assign new_n163_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n164_ = ~new_n165_ & (~x0 | (~z00 & (~x1 | ~x3 | ~x7)));
  assign new_n165_ = ~x4 & ((~x7 & ((x3 & (~x5 ^ ~x6)) | (x5 & (x6 | (~x3 & ~x6))))) | (x5 & x7) | (~x1 & ~x5 & ~x6));
  assign new_n166_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z46 = new_n172_ | ~new_n173_ | (~x4 & (~new_n170_ | (~new_n168_ & ~x0)));
  assign new_n168_ = ~x5 & (~new_n133_ | x5 | ~new_n169_ | ~x1);
  assign new_n169_ = ~x2 & ~x3;
  assign new_n170_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n171_ | ~x6 | ~x7)))));
  assign new_n171_ = ~x1 & ~x2;
  assign new_n172_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n173_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n177_ | (~x4 & (~new_n175_ | (~new_n176_ & ~x5)));
  assign new_n175_ = (~x0 | ~x6 | (x7 & (~new_n171_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n176_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n177_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  assign z48 = ~new_n179_ | new_n182_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n179_ = new_n181_ & (x2 | ((x1 | x3) & (~x0 | (~new_n180_ & x3))));
  assign new_n180_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n181_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n182_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = ~new_n185_ | (~new_n184_ & ~x3) | (x0 & (x4 | (new_n150_ & ~x4)));
  assign new_n184_ = ~new_n171_ & (x6 | x7 | x4 | ~x5);
  assign new_n185_ = ~new_n186_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n186_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z50 = (~new_n188_ & x0) | (~new_n189_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n188_ = (x1 | ((~x2 | ~x3) & (~new_n138_ | x2 | x4))) & x3 & ~x4 & (~new_n150_ | x4);
  assign new_n189_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n190_;
  assign new_n190_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z51 = (~new_n192_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n192_ = x5 ? new_n193_ : (~x6 & (~new_n86_ | x2 | ~x3 | x6));
  assign new_n193_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n198_ | ~new_n197_ | (~new_n195_ & x3);
  assign new_n195_ = ~new_n196_ & (~x1 | (~x4 & x6)) & (x4 | ~x5 | x6 | x7);
  assign new_n196_ = x0 & ~x1 & (x2 | (~x2 & ~x4 & ~x5 & ~x6));
  assign new_n197_ = ~new_n158_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n198_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n202_ | (~x4 & (x5 ? ~new_n201_ : ~new_n200_));
  assign new_n200_ = ~x6 & (x2 | (x3 & (~new_n86_ | ~x3 | x6)));
  assign new_n201_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n202_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (x3 | ~x4 | ~x1 | x2);
  assign z55 = ~new_n204_ | (~x4 & (x5 ? ~new_n206_ : (x6 | (~x1 & ~x6))));
  assign new_n204_ = ~new_n205_ & (~x0 | (x2 ? (~new_n150_ & ~x4) : x3));
  ...
  assign new_n208_ = (new_n209_ | ~x6) & (~x5 | x6) & (x5 | (~new_n169_ & (x6 | (~x0 & x1))));
  ...
  assign new_n213_ = x3 & (new_n214_ | x5) & ~new_n215_ & ~new_n151_ & (new_n216_ | ~x5);
  ...
  assign new_n220_ = (new_n221_ | x4) & (~new_n169_ | x1);
  ...
  assign new_n229_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
  ...
  assign new_n239_ = (x0 | ~x2 | ~x4) & (x4 | ~x5 | x6 | x7);
  ...
  assign new_n247_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n249_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n249_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
