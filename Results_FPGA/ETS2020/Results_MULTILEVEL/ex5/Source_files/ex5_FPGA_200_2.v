...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n89_, new_n91_,
  ...
  assign z40 = (~new_n128_ & ~x3) | ~new_n134_ | (~new_n130_ & ~x5);
  assign new_n128_ = (x0 | x1 | ~x2) & (~x1 | x2 | ~x4) & (~new_n129_ | x4 | ~x5);
  ...
  assign z43 = (~new_n152_ & x4) | new_n126_ | new_n153_ | (~new_n154_ & ~x4);
  ...
  assign new_n158_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n124_ | x4 | x5)))));
  ...
  assign new_n170_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n141_ | ~x5))));
  assign new_n171_ = ~x1 & ((~new_n172_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n172_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n173_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n162_ & ~x4));
  assign z57 = (x0 & (~new_n175_ | ~x3)) | ~new_n182_ | (~x0 & (~new_n179_ | new_n184_));
  assign new_n175_ = (new_n176_ | x5) & ~new_n177_ & (~new_n124_ | x4) & (new_n178_ | ~x5);
  ...
  assign new_n187_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n189_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n189_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z04 = 1'b0;
  assign z11 = 1'b0;
  assign z13 = 1'b0;
  assign z16 = 1'b0;
