// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:31 2020
...
module FAU ( 
  ...
  assign z39 = new_n152_ | new_n146_ | ~new_n149_;
  assign new_n146_ = ~x5 & ((~new_n148_ & ~x4) | (new_n147_ & ~x0));
  assign new_n147_ = ~x1 & ~x2;
  assign new_n148_ = x0 ? (x6 & (x1 | ~x2 | ~x3 | ~x6 | ~x7)) : (x6 & (~x2 | ~x6));
  ...
  assign new_n178_ = x0 & (new_n179_ | (new_n74_ & x2));
  ...
  assign new_n185_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n186_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  ...
  assign new_n193_ = (new_n195_ | x4) & (~x0 | (~new_n194_ & (~new_n74_ | x4)));
  assign new_n194_ = x1 & x3 & x7;
  assign new_n195_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  assign new_n196_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z46 = new_n201_ | ~new_n202_ | (~x4 & (~new_n200_ | (~new_n198_ & ~x0)));
  assign new_n198_ = ~x5 & (~new_n150_ | x5 | ~new_n199_ | ~x1);
  assign new_n199_ = ~x2 & ~x3;
  assign new_n200_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n147_ | ~x6 | ~x7)))));
  ...
  assign new_n204_ = (~x0 | ~x6 | (x7 & (~new_n147_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  ...
  assign z49 = new_n213_ | ~new_n214_ | (~x3 & (new_n147_ | new_n155_));
  ...
  assign new_n217_ = (x1 | ((~x2 | ~x3) & (~new_n189_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  assign new_n218_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n219_;
  assign new_n219_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z52 = new_n224_ | ~new_n222_ | (x3 & (new_n221_ | new_n223_ | new_n155_));
  assign new_n221_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n222_ = ~new_n186_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n230_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n167_ | ~x5))));
  assign new_n231_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n232_ & ~x4));
  assign new_n232_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n233_ = (~x0 | (~new_n194_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n239_ = (new_n240_ | ~x6) & (~x5 | x6) & (x5 | (~new_n199_ & (x6 | (~x0 & x1))));
  ...
  assign new_n244_ = x3 & (new_n245_ | x5) & ~new_n246_ & ~new_n179_ & (new_n247_ | ~x5);
  ...
  assign new_n251_ = (new_n252_ | x4) & (~new_n199_ | x1);
  ...
  assign new_n260_ = ~new_n155_ & (x0 | ~x2 | ~x4);
