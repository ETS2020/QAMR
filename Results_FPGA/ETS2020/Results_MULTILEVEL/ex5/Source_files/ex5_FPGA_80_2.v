...
module FAU ( 
  ...
  assign new_n138_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n139_ | ~x3) & (x0 | ~x1);
  assign new_n139_ = (~x1 | x6) & (~x4 | (x0 & ~x1));
  ...
  assign z43 = (~new_n148_ & x4) | new_n123_ | new_n149_ | (~new_n150_ & ~x4);
  ...
  assign new_n154_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n121_ | x4 | x5)))));
  ...
  assign z54 = (~new_n166_ & ~x0) | new_n167_ | ~new_n169_;
  assign new_n166_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n137_ | ~x5))));
  assign new_n167_ = ~x1 & ((~new_n168_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n168_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n169_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n158_ & ~x4));
  assign z56 = (~new_n171_ & ~x4) | ~new_n174_ | (~new_n173_ & x3);
  assign new_n171_ = (new_n172_ | ~x6) & (~x5 | x6) & (x5 | ((x2 | x3) & (new_n83_ | x6)));
  assign new_n172_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n173_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n174_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (x0 & (~new_n176_ | ~x3)) | ~new_n183_ | (~x0 & (~new_n180_ | new_n185_));
  assign new_n176_ = (new_n177_ | x5) & ~new_n178_ & (new_n179_ | ~x5) & (~new_n121_ | x4);
