// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:04 2020
...
module FAU ( 
  ...
  assign z49 = new_n202_ | ~new_n203_ | (~x3 & (new_n189_ | new_n143_));
  ...
  assign new_n206_ = (x1 | ((~x2 | ~x3) & (~new_n177_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n215_ | ~new_n214_ | (x3 & (new_n213_ | new_n143_ | new_n216_));
  assign new_n213_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n214_ = ~new_n174_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n222_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n155_ | ~x5))));
  assign new_n223_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n224_ & ~x4));
  assign new_n224_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n225_ = (~x0 | (~new_n182_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n231_ = (new_n232_ | ~x6) & (~x5 | x6) & (x5 | (~new_n187_ & (x6 | (~x0 & x1))));
  ...
  assign new_n236_ = x3 & (new_n237_ | x5) & ~new_n238_ & ~new_n167_ & (new_n239_ | ~x5);
  ...
  assign new_n243_ = (new_n244_ | x4) & (~new_n187_ | x1);
  ...
  assign new_n252_ = ~new_n143_ & (x0 | ~x2 | ~x4);
