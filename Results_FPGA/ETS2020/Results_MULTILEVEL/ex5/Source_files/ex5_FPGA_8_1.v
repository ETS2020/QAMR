...
module FAU ( 
  ...
  assign new_n133_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  ...
  assign new_n162_ = x5 ? new_n163_ : (~x6 & (~new_n88_ | x2 | ~x3 | x6));
  ...
  assign new_n170_ = ~x6 & (x2 | (x3 & (~new_n88_ | ~x3 | x6)));
  ...
  assign new_n195_ = x5 & ((~x4 & x7) | (new_n88_ & ~x2 & x4));
