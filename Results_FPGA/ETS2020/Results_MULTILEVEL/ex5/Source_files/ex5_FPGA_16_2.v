...
module FAU ( 
  ...
  assign z43 = (~new_n142_ & x4) | new_n122_ | new_n143_ | (~new_n144_ & ~x4);
  ...
  assign new_n148_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n120_ | x4 | x5)))));
  ...
  assign new_n165_ = x5 ? new_n166_ : (~x6 & (~new_n90_ | x2 | ~x3 | x6));
  assign new_n166_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z54 = (~new_n168_ & ~x0) | new_n169_ | ~new_n171_;
  assign new_n168_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n136_ | ~x5))));
  assign new_n169_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n170_ & ~x4));
  assign new_n170_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n171_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n152_ & ~x4));
  assign z56 = (~new_n173_ & ~x4) | ~new_n176_ | (~new_n175_ & x3);
  assign new_n173_ = (new_n174_ | ~x6) & (~x5 | x6) & (x5 | ((x2 | x3) & (new_n82_ | x6)));
  ...
  assign new_n178_ = (new_n179_ | x5) & ~new_n180_ & (new_n181_ | ~x5) & (~new_n120_ | x4);
  ...
  assign new_n183_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  ...
  assign z61 = ~new_n190_ | (~x4 & ((~new_n189_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n189_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n190_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n192_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n192_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z04 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
