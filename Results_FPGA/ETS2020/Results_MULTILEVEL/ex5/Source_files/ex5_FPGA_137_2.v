...
module FAU ( 
  ...
  assign new_n170_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (x3 | ~x4 | ~x1 | x2);
  ...
  assign new_n176_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n155_ & ~x4));
  assign z57 = (x0 & (~new_n178_ | ~x3)) | ~new_n185_ | (~x0 & (~new_n182_ | new_n187_));
  assign new_n178_ = (new_n179_ | x5) & ~new_n180_ & (new_n181_ | ~x5) & (~new_n125_ | x4);
