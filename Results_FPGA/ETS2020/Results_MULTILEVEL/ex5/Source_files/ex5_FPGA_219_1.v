...
module FAU ( 
  ...
  assign z41 = (~x4 & (~new_n137_ | (~new_n136_ & x0))) | ~new_n134_ | new_n138_;
  assign new_n134_ = (new_n135_ | ~x0) & (x0 | ~x1) & (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6)));
  assign new_n135_ = (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n136_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | x5 | ~x6 | ~x7);
  ...
  assign new_n142_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4))) & (new_n143_ | x4);
  assign new_n143_ = (~x5 | (~x7 & (x3 | x6 | x7))) & (~x6 | (x5 & (~x5 | x7)));
  ...
  assign z49 = new_n156_ | ~new_n157_ | (~x3 & (new_n148_ | new_n124_));
  ...
  assign z53 = ~new_n166_ | (~x4 & (x5 ? ~new_n164_ : ~new_n165_));
  assign new_n164_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n165_ = ~x6 & (x2 | (x3 & (~x0 | x1 | ~x3 | x6)));
  assign new_n166_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z55 = ~new_n168_ | (~x4 & (x5 ? ~new_n170_ : (x6 | (~x1 & ~x6))));
  assign new_n168_ = ~new_n169_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n169_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n170_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n172_ & ~x4) | ~new_n175_ | (~new_n174_ & x3);
  assign new_n172_ = (new_n173_ | ~x6) & (~x5 | x6) & (x5 | (~new_n146_ & (x6 | (~x0 & x1))));
  assign new_n173_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n174_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n175_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z58 = ~new_n180_ | (~new_n177_ & ~x4);
  assign new_n177_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n178_ | x5) & (~x5 | (x6 & (new_n179_ | ~x6)));
  assign new_n178_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n179_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n180_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n182_ | new_n192_ | new_n193_ | new_n183_ | new_n186_ | new_n190_;
  assign new_n182_ = ~new_n124_ & (x0 | ~x2 | ~x4);
  assign new_n183_ = x3 & (~new_n185_ | (~new_n184_ & ~x5));
  assign new_n184_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n185_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n186_ = ~x3 & ((~new_n187_ & ~x0) | new_n188_ | (~new_n189_ & x0));
  assign new_n187_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n188_ = ~x2 & (x0 | (x1 & x4));
  assign new_n189_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n190_ = ~new_n191_ & ~x5;
  assign new_n191_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n192_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
  assign new_n193_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n196_ | ~new_n197_ | (~x4 & (~x5 | (~new_n195_ & x5)));
  assign new_n195_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n196_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n197_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n200_ | (~x4 & ((~new_n199_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n199_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n200_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n202_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n202_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z04 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
