...
module FAU ( 
  ...
  assign new_n137_ = x3 & (x4 ? ~x0 : (~new_n138_ & ~x6));
  assign new_n138_ = (~x5 | x7) & (~x0 | x1 | x2 | x5);
  ...
  assign z52 = new_n165_ | ~new_n163_ | (x3 & (new_n162_ | new_n164_ | new_n120_));
  assign new_n162_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n163_ = ~new_n140_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n171_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n131_ | ~x5))));
  ...
  assign new_n181_ = (new_n182_ | ~x6) & (~x5 | x6) & (x5 | (~new_n143_ & (x6 | (~x0 & x1))));
  ...
  assign new_n191_ = ~new_n120_ & (x0 | ~x2 | ~x4);
