...
module FAU ( 
  ...
  assign new_n158_ = x0 & (~x3 | (new_n142_ & ~x1 & ~x4));
  assign new_n159_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n137_ | x4 | x5)))));
  assign new_n160_ = new_n161_ & (~x0 | (x3 & (~new_n142_ | x1 | ~x3 | x4)));
  ...
  assign new_n166_ = ~x5 & (~new_n137_ | x5 | ~new_n167_ | ~x1);
  ...
  assign new_n186_ = (x1 | ((~x2 | ~x3) & (~new_n142_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n190_ = x5 ? new_n191_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  ...
  assign new_n198_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign new_n202_ = ~new_n203_ & (~x0 | (x2 ? (~new_n75_ & ~x4) : x3));
  ...
  assign new_n227_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
  ...
  assign z60 = new_n241_ | ~new_n242_ | (~x4 & (~x5 | (~new_n240_ & x5)));
  assign new_n240_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n241_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n242_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n245_ | (~x4 & ((~new_n244_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n244_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n245_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n247_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n247_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
