...
module FAU ( 
  ...
  assign new_n171_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n176_ | ~new_n174_ | (x3 & (new_n173_ | new_n175_ | new_n122_));
  assign new_n173_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n174_ = ~new_n147_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n175_ = x1 & (x4 | ~x6);
  assign new_n176_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n180_ | (~x4 & (x5 ? ~new_n178_ : ~new_n179_));
  assign new_n178_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n179_ = ~x6 & (x2 | (x3 & (~x0 | x1 | ~x3 | x6)));
  ...
  assign new_n182_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n133_ | ~x5))));
  ...
  assign new_n192_ = (new_n193_ | ~x6) & (~x5 | x6) & (x5 | (~new_n150_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n202_ | new_n212_ | new_n213_ | new_n203_ | new_n206_ | new_n210_;
  assign new_n202_ = ~new_n122_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n212_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
