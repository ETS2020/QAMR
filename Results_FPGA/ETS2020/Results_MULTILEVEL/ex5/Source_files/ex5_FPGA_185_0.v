...
module FAU ( 
  ...
  assign z45 = ((new_n161_ | ~new_n162_) & ~x2) | new_n167_ | ~new_n165_ | (~new_n163_ & x2);
  assign new_n161_ = x0 & (~x3 | (new_n139_ & ~x1 & ~x4));
  assign new_n162_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n134_ | x4 | x5)))));
  assign new_n163_ = new_n164_ & (~x0 | (x3 & (~new_n139_ | x1 | ~x3 | x4)));
  assign new_n164_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n165_ = ~new_n166_ & (~x0 | (~z00 & (~x1 | ~x3 | ~x7)));
  ...
  assign new_n169_ = ~x5 & (~new_n134_ | x5 | ~new_n170_ | ~x1);
  ...
  assign z49 = ~new_n186_ | (~new_n185_ & ~x3) | (x0 & (x4 | (new_n151_ & ~x4)));
  ...
  assign new_n189_ = (x1 | ((~x2 | ~x3) & (~new_n139_ | x2 | x4))) & x3 & ~x4 & (~new_n151_ | x4);
  ...
  assign new_n193_ = x5 ? new_n194_ : (~x6 & (~new_n86_ | x2 | ~x3 | x6));
  ...
  assign new_n198_ = ~new_n159_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n199_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n203_ | (~x4 & (x5 ? ~new_n202_ : ~new_n201_));
  assign new_n201_ = ~x6 & (x2 | (x3 & (~new_n86_ | ~x3 | x6)));
  ...
  assign z55 = ~new_n205_ | (~x4 & (x5 ? ~new_n207_ : (x6 | (~x1 & ~x6))));
  assign new_n205_ = ~new_n206_ & (~x0 | (x2 ? (~new_n151_ & ~x4) : x3));
  assign new_n206_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n207_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n209_ & ~x4) | ~new_n212_ | (~new_n211_ & x3);
  assign new_n209_ = (new_n210_ | ~x6) & (~x5 | x6) & (x5 | (~new_n170_ & (x6 | (~x0 & x1))));
  assign new_n210_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n211_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n212_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (~new_n214_ & x0) | ~new_n221_ | (~x0 & (~new_n218_ | new_n223_));
  assign new_n214_ = x3 & (new_n215_ | x5) & ~new_n216_ & ~new_n152_ & (new_n217_ | ~x5);
  assign new_n215_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n216_ = x2 & (x4 | (~x1 & x3));
  assign new_n217_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n218_ = ~new_n219_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n220_ & ~x3));
  assign new_n219_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n220_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n221_ = (new_n222_ | x4) & (~new_n170_ | x1);
  assign new_n222_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n223_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z58 = ~new_n228_ | (~new_n225_ & ~x4);
  assign new_n225_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n226_ | x5) & (~x5 | (x6 & (new_n227_ | ~x6)));
  assign new_n226_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n227_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n228_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n240_ | new_n230_ | new_n241_ | new_n231_ | new_n234_ | new_n238_;
  assign new_n230_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
  assign new_n231_ = x3 & (~new_n233_ | (~new_n232_ & ~x5));
  assign new_n232_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n233_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n234_ = ~x3 & ((~new_n235_ & ~x0) | new_n236_ | (~new_n237_ & x0));
  assign new_n235_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n236_ = ~x2 & (x0 | (x1 & x4));
  assign new_n237_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n238_ = ~new_n239_ & ~x5;
  assign new_n239_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n240_ = (x0 | ~x2 | ~x4) & (x4 | ~x5 | x6 | x7);
  assign new_n241_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n244_ | ~new_n245_ | (~x4 & (~x5 | (~new_n243_ & x5)));
  assign new_n243_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n244_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n245_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
