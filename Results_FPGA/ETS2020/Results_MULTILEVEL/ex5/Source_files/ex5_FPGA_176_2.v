// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:41 2020
...
module FAU ( 
  ...
  assign new_n166_ = (new_n167_ | x5) & ~new_n168_ & (new_n169_ | ~x5) & (~new_n117_ | x4);
  ...
  assign new_n182_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z02 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
