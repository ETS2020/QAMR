...
module FAU ( 
  ...
  assign new_n173_ = (~x0 | (~new_n156_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n181_ = (new_n182_ | x5) & ~new_n183_ & (~new_n125_ | x4) & (new_n184_ | ~x5);
  ...
  assign new_n201_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
  assign z24 = 1'b0;
