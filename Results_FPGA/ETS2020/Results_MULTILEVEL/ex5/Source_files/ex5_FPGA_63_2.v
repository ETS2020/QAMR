// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:21 2020
...
module FAU ( 
  ...
  assign z40 = (~new_n127_ & ~x3) | ~new_n133_ | (~new_n129_ & ~x5);
  assign new_n127_ = (x0 | x1 | ~x2) & (~x1 | x2 | ~x4) & (~new_n128_ | x4 | ~x5);
  ...
  assign new_n169_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n140_ | ~x5))));
  ...
  assign new_n174_ = (new_n175_ | x5) & ~new_n176_ & (~new_n123_ | x4) & (new_n177_ | ~x5);
