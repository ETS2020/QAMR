...
module FAU ( 
  ...
  assign new_n167_ = (x1 | ((~x2 | ~x3) & (~new_n158_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n168_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n169_;
  assign new_n169_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n171_ & ~x0) | new_n172_ | ~new_n174_;
  assign new_n171_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n142_ | ~x5))));
  assign new_n172_ = ~x1 & ((~new_n173_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n173_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n174_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n163_ & ~x4));
  assign z57 = (x0 & (~new_n176_ | ~x3)) | ~new_n183_ | (~x0 & (~new_n180_ | new_n185_));
  assign new_n176_ = (new_n177_ | x5) & ~new_n178_ & (new_n179_ | ~x5) & (~new_n126_ | x4);
