...
module FAU ( 
  ...
  assign z35 = x4 ? ~new_n111_ : ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7))));
  assign new_n111_ = (~x0 | (~x2 & (x1 | x2 | x5))) & (~x1 | (~x3 & (x2 | x3))) & (x0 | (x2 ? (x3 & (x1 | ~x3 | x5)) : ~x3));
  ...
  assign new_n138_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  ...
  assign new_n184_ = (new_n185_ | ~x6) & (~x5 | x6) & (x5 | (~new_n141_ & (x6 | (~x0 & x1))));
