...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    ...
    new_n250_, new_n251_, new_n252_, new_n254_, new_n255_;
  ...
  assign new_n211_ = ~new_n212_ & ~new_n146_ & (~x1 | (~x4 & x6));
  assign new_n212_ = x0 & ~x1 & (x2 | (~x2 & ~x4 & ~x5 & ~x6));
  assign new_n213_ = ~new_n177_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n220_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n158_ | ~x5))));
  ...
  assign new_n234_ = x3 & (new_n235_ | x5) & ~new_n236_ & ~new_n170_ & (new_n237_ | ~x5);
  ...
  assign new_n255_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z00 = 1'b0;
  assign z23 = 1'b0;
  assign z37 = 1'b0;
  assign z48 = 1'b0;
