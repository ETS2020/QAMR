...
module FAU ( 
  ...
  assign new_n146_ = x0 & ((x2 & ~x5 & ~x6) | (~x4 & x6 & ~x7));
  ...
  assign new_n164_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  ...
  assign new_n171_ = (~x0 | (~new_n155_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z57 = (x0 & (~new_n173_ | ~x3)) | ~new_n180_ | (~x0 & (~new_n177_ | new_n182_));
  assign new_n173_ = (new_n174_ | x5) & ~new_n175_ & (new_n176_ | ~x5) & (~new_n124_ | x4);
