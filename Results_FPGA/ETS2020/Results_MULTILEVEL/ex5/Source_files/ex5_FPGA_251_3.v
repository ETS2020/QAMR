...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    new_n92_, new_n94_, new_n103_, new_n106_, new_n112_, new_n113_,
  ...
  assign z38 = new_n115_ | new_n118_ | new_n119_ | new_n129_;
  ...
  assign z40 = new_n138_ | ~new_n144_ | (~new_n140_ & ~x5);
  assign new_n138_ = ~x3 & ((~x0 & ~x1 & x2) | new_n139_ | (x1 & ~x2 & x4));
  assign new_n139_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n140_ = ~new_n141_ & ~new_n143_ & (new_n142_ | ~x0);
  assign new_n141_ = x1 & (~x2 | (x2 & x3 & ~x4 & x6));
  assign new_n142_ = (~x2 | (x6 & (x4 | ~x6 | ~x7 | x1 | ~x3))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n143_ = ~x4 & ((~x0 & ~x6) | (x3 & x6 & ~x7));
  assign new_n144_ = ~new_n145_ & ~new_n146_ & ~new_n147_ & ~new_n148_;
  assign new_n145_ = x0 & (x4 ? x2 : (x6 & ~x7));
  assign new_n146_ = x1 & (~x0 | (x3 & x4));
  assign new_n147_ = ~x0 & ((~x4 & x7) | (~x2 & x3 & x4));
  assign new_n148_ = ~x4 & x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  assign z41 = ~new_n152_ | new_n155_ | (~x4 & (~new_n154_ | (~new_n150_ & x0)));
  assign new_n150_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | ~new_n151_ | x5);
  assign new_n151_ = x6 & x7;
  assign new_n152_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n153_ | ~x3) & (x0 | ~x1);
  assign new_n153_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  assign new_n154_ = (x0 | (~x5 & ~x7)) & (x5 | ((x1 | x6) & (~x3 | ~x6 | x7)));
  assign new_n155_ = ~x1 & ((x0 & (x2 ? x3 : (x4 & ~x5))) | (~x3 & (~x2 | (~x0 & x2))));
  ...
  assign z43 = (~new_n164_ & x4) | new_n136_ | new_n162_ | (~new_n165_ & ~x4);
  ...
  assign new_n174_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n134_ | x4 | x5)))));
  ...
  assign new_n182_ = ~x5 & (~new_n134_ | x5 | ~new_n183_ | ~x1);
  ...
  assign z48 = ~new_n193_ | new_n196_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n193_ = new_n195_ & (x2 | ((x1 | x3) & (~x0 | (~new_n194_ & x3))));
  assign new_n194_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n195_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n196_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z49 = new_n198_ | ~new_n199_ | (~x3 & (new_n185_ | new_n139_));
  ...
  assign new_n202_ = (x1 | ((~x2 | ~x3) & (~new_n173_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n218_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n151_ | ~x5))));
  assign new_n219_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n220_ & ~x4));
  assign new_n220_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n221_ = (~x0 | (~new_n178_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n227_ = (new_n228_ | ~x6) & (~x5 | x6) & (x5 | (~new_n183_ & (x6 | (~x0 & x1))));
  ...
  assign new_n232_ = x3 & (new_n233_ | x5) & ~new_n234_ & ~new_n163_ & (new_n235_ | ~x5);
  ...
  assign new_n239_ = (new_n240_ | x4) & (~new_n183_ | x1);
  ...
  assign new_n248_ = ~new_n139_ & (x0 | ~x2 | ~x4);
  assign new_n249_ = x5 & ((~x4 & x7) | (new_n92_ & ~x2 & x4));
