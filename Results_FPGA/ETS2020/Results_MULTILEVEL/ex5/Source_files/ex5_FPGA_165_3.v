...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n90_,
    new_n92_, new_n94_, new_n97_, new_n105_, new_n108_, new_n114_,
  ...
  assign new_n204_ = (x1 | ((~x2 | ~x3) & (~new_n179_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n208_ = x5 ? new_n209_ : (~x6 & (~new_n90_ | x2 | ~x3 | x6));
  assign new_n209_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n214_ | ~new_n213_ | (~new_n211_ & x3);
  assign new_n211_ = ~new_n212_ & ~new_n145_ & (~x1 | (~x4 & x6));
  assign new_n212_ = x0 & ~x1 & (x2 | (~x2 & ~x4 & ~x5 & ~x6));
  assign new_n213_ = ~new_n176_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n214_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n218_ | (~x4 & (x5 ? ~new_n217_ : ~new_n216_));
  assign new_n216_ = ~x6 & (x2 | (x3 & (~new_n90_ | ~x3 | x6)));
  ...
  assign new_n220_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n157_ | ~x5))));
  assign new_n221_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n222_ & ~x4));
  assign new_n222_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n223_ = (~x0 | (~new_n184_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign z56 = (~new_n229_ & ~x4) | ~new_n232_ | (~new_n231_ & x3);
  assign new_n229_ = (new_n230_ | ~x6) & (~x5 | x6) & (x5 | (~new_n189_ & (x6 | (~x0 & x1))));
  assign new_n230_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n231_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n232_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (~new_n234_ & x0) | ~new_n241_ | (~x0 & (~new_n238_ | new_n243_));
  assign new_n234_ = x3 & (new_n235_ | x5) & ~new_n236_ & ~new_n169_ & (new_n237_ | ~x5);
  ...
  assign new_n241_ = (new_n242_ | x4) & (~new_n189_ | x1);
  ...
  assign new_n250_ = ~new_n145_ & (x0 | ~x2 | ~x4);
  assign new_n251_ = x5 & ((~x4 & x7) | (new_n90_ & ~x2 & x4));
