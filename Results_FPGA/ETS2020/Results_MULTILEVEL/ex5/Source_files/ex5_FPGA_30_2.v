// Benchmark "FAU" written by ABC on Thu Aug  6 04:05:57 2020
...
module FAU ( 
  ...
  wire new_n80_, new_n82_, new_n83_, new_n85_, new_n88_, new_n90_, new_n92_,
    new_n101_, new_n104_, new_n108_, new_n109_, new_n111_, new_n112_,
    new_n113_, new_n114_, new_n115_, new_n118_, new_n120_, new_n121_,
  ...
  assign new_n104_ = ~x5 & ~x4 & ~x3 & x0 & x2 & x6;
  assign z27 = ~x7 & x6 & ~x5 & ~x4 & new_n88_ & ~x3;
  assign z30 = x7 & x6 & new_n85_ & ~x5;
  assign z31 = (~x4 & (x5 | (~x5 & (x6 | (~x0 & ~x6))))) | new_n108_ | (~new_n109_ & ~x5);
  assign new_n108_ = x4 & ((x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (x3 | (~x2 & ~x3))) | (~x0 & (x2 ? (~x3 | (~x1 & x3 & ~x5)) : x3)));
  assign new_n109_ = (x2 | (~x1 & (x0 | x1))) & (~x0 | ~x2 | x6);
  assign z32 = new_n111_ | new_n113_ | new_n114_ | new_n115_;
  assign new_n111_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | (~new_n112_ & ~x5) | (~x7 & (x6 ? (x0 | x5) : x5)) | (x5 & x7));
  assign new_n112_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n113_ = ~x2 & ((x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3) | (x0 & ~x1 & ~x5))) | (x1 & ~x5));
  assign new_n114_ = x2 & (x0 ? (~x3 | (~x1 & x3)) : (~x1 & ~x3));
  assign new_n115_ = x1 & (~x0 | (x3 & (x4 | ~x6)));
  assign z35 = new_n108_ | (~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7)))));
  assign z38 = new_n111_ | new_n114_ | new_n115_ | new_n118_;
  ...
  assign z43 = (~new_n145_ & x4) | new_n125_ | new_n146_ | (~new_n147_ & ~x4);
  ...
  assign new_n151_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n123_ | x4 | x5)))));
  ...
  assign new_n168_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n139_ | ~x5))));
  ...
  assign new_n173_ = (new_n174_ | ~x6) & (~x5 | x6) & (x5 | ((x2 | x3) & (new_n83_ | x6)));
  ...
  assign new_n178_ = (new_n179_ | x5) & ~new_n180_ & (new_n181_ | ~x5) & (~new_n123_ | x4);
