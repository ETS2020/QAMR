...
module FAU ( 
  ...
  assign z40 = new_n123_ | ~new_n129_ | (~new_n125_ & ~x5);
  ...
  assign z41 = ~new_n135_ | new_n139_ | (~x4 & (~new_n138_ | (~new_n137_ & x0)));
  assign new_n135_ = (new_n136_ | ~x0) & (x0 | ~x1) & (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6)));
  assign new_n136_ = (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n137_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | x5 | ~x6 | ~x7);
  ...
  assign z43 = (~new_n146_ & x4) | new_n147_ | new_n148_ | (~new_n149_ & ~x4);
  assign new_n146_ = (x0 | (~x2 ^ x3)) & (~x1 | (~x3 & (x2 | x3))) & (~x0 | ~x2);
  assign new_n147_ = x1 & ((~x2 & ~x5) | (x0 & x3 & x7));
  assign new_n148_ = x0 & ((x2 & ~x5 & ~x6) | (~x4 & x6 & ~x7));
  ...
  assign z46 = new_n159_ | ~new_n160_ | (~x4 & (~new_n156_ | (~new_n158_ & ~x0)));
  assign new_n156_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n157_ | ~x6 | ~x7)))));
  assign new_n157_ = ~x1 & ~x2;
  assign new_n158_ = ~x5 & (~x1 | x2 | x3 | x5 | ~x6 | x7);
  ...
  assign new_n162_ = (~x0 | ~x6 | (x7 & (~new_n157_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  ...
  assign z49 = new_n166_ | ~new_n167_ | (~x3 & (new_n157_ | new_n124_));
  ...
  assign z52 = new_n177_ | ~new_n175_ | (x3 & (new_n174_ | new_n176_ | new_n124_));
  assign new_n174_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n175_ = ~new_n154_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n206_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n208_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n208_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x0 | x1 | ~x2) & (~x1 | x6))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
