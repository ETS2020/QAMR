...
module FAU ( 
  ...
  wire new_n74_, new_n77_, new_n79_, new_n81_, new_n83_, new_n84_, new_n86_,
    new_n93_, new_n96_, new_n102_, new_n103_, new_n105_, new_n106_,
  ...
  assign z46 = new_n147_ | ~new_n148_ | (~x4 & (~new_n145_ | (~new_n143_ & ~x0)));
  assign new_n143_ = ~x5 & (~new_n144_ | ~x1 | x5 | ~x6 | x7);
  assign new_n144_ = ~x2 & ~x3;
  assign new_n145_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n146_ | ~x6 | ~x7)))));
  assign new_n146_ = ~x1 & ~x2;
  assign new_n147_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n148_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n152_ | (~x4 & (~new_n150_ | (~new_n151_ & ~x5)));
  assign new_n150_ = (~x0 | ~x6 | (x7 & (~new_n146_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n151_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n152_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((~x1 | x3) & (x0 | (~x3 & (x1 | x3))))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  assign z48 = ~new_n154_ | new_n157_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n154_ = new_n156_ & (x2 | ((x1 | x3) & (~x0 | (~new_n155_ & x3))));
  assign new_n155_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n156_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n157_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n159_ | ~new_n160_ | (~x3 & (new_n146_ | new_n121_));
  assign new_n159_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n160_ = ~new_n161_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n161_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z51 = (~new_n163_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n163_ = x5 ? new_n164_ : (~x6 & (~new_n84_ | x2 | ~x3 | x6));
  assign new_n164_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n169_ | ~new_n167_ | (x3 & (new_n166_ | new_n168_ | new_n121_));
  assign new_n166_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n167_ = ~new_n141_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n168_ = x1 & (x4 | ~x6);
  assign new_n169_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n173_ | (~x4 & (x5 ? ~new_n172_ : ~new_n171_));
  assign new_n171_ = ~x6 & (x2 | (x3 & (~new_n84_ | ~x3 | x6)));
  assign new_n172_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n173_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n176_ | ~new_n178_ | (~new_n175_ & ~x0);
  assign new_n175_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n132_ | ~x5))));
  assign new_n176_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n177_ & ~x4));
  assign new_n177_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n178_ = (~x0 | (~new_n179_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign new_n179_ = x1 & x3 & x7;
  assign z55 = ~new_n181_ | (~x4 & (x5 ? ~new_n183_ : (x6 | (~x1 & ~x6))));
  assign new_n181_ = ~new_n182_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n182_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n183_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n185_ & ~x4) | ~new_n188_ | (~new_n187_ & x3);
  assign new_n185_ = (new_n186_ | ~x6) & (~x5 | x6) & (x5 | (~new_n144_ & (x6 | (~x0 & x1))));
  assign new_n186_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n187_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n188_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  ...
  assign z59 = ~new_n195_ | new_n196_ | new_n206_ | new_n197_ | new_n200_ | new_n204_;
  assign new_n195_ = ~new_n121_ & (x0 | ~x2 | ~x4);
  assign new_n196_ = x5 & ((~x4 & x7) | (new_n84_ & ~x2 & x4));
  assign new_n197_ = x3 & (~new_n199_ | (~new_n198_ & ~x5));
  assign new_n198_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n199_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n200_ = ~x3 & ((~new_n201_ & ~x0) | new_n202_ | (~new_n203_ & x0));
  assign new_n201_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n202_ = ~x2 & (x0 | (x1 & x4));
  assign new_n203_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n204_ = ~new_n205_ & ~x5;
  assign new_n205_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n206_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
