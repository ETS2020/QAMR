...
module FAU ( 
  ...
  assign z39 = new_n129_ | new_n124_ | ~new_n126_;
  assign new_n124_ = ~x5 & ((~x0 & ~x1 & ~x2) | (~new_n125_ & ~x4));
  assign new_n125_ = x0 ? (x6 & (x1 | ~x2 | ~x3 | ~x6 | ~x7)) : (x6 & (~x2 | ~x6));
  ...
  assign z40 = new_n131_ | ~new_n137_ | (~new_n133_ & ~x5);
  ...
  assign z43 = (~new_n148_ & x4) | new_n129_ | new_n149_ | (~new_n150_ & ~x4);
  ...
  assign new_n154_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n127_ | x4 | x5)))));
  assign new_n155_ = new_n156_ & (~x0 | (x3 & (~new_n153_ | x1 | ~x3 | x4)));
  assign new_n156_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n157_ = ~new_n159_ & ((~z00 & ~new_n158_) | ~x0);
  assign new_n158_ = x1 & x3 & x7;
  assign new_n159_ = ~x4 & ((~x7 & ((x3 & (~x5 ^ ~x6)) | (x5 & (x6 | (~x3 & ~x6))))) | (x5 & x7) | (~x1 & ~x5 & ~x6));
  ...
  assign new_n165_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  ...
  assign new_n171_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n172_ | ~x5))));
  ...
  assign new_n183_ = (new_n184_ | x5) & ~new_n185_ & (new_n186_ | ~x5) & (~new_n127_ | x4);
  ...
  assign new_n188_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  ...
  assign new_n194_ = ~new_n132_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n201_ = x1 & (~x2 | x4 | x5 | ~x6 | ~x7);
