...
module FAU ( 
  ...
  assign z20 = ~x6 & ~x5 & ~x4 & new_n84_ & ~x2 & ~x3;
  ...
  assign z44 = new_n147_ | ~new_n145_ | (x3 & (x4 ? ~x0 : new_n144_));
  assign new_n144_ = ~x6 & ((x5 & ~x7) | (new_n84_ & ~x2 & ~x5));
  assign new_n145_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n146_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n146_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign new_n147_ = x1 & (~x0 | (~x2 & ~x5));
  ...
  assign new_n169_ = x5 ? new_n170_ : (~x6 & (~new_n84_ | x2 | ~x3 | x6));
  ...
  assign new_n177_ = ~x6 & (x2 | (x3 & (~new_n84_ | ~x3 | x6)));
  ...
  assign new_n202_ = x5 & ((~x4 & x7) | (new_n84_ & ~x2 & x4));
