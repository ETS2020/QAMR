...
module FAU ( 
  ...
  assign z32 = new_n109_ | new_n111_ | ~new_n112_;
  ...
  assign new_n112_ = (~x2 | (x0 ? (x3 & (x1 | ~x3)) : (x1 | x3))) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  assign z35 = new_n106_ | (~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7)))));
  assign z39 = new_n120_ | ~new_n117_ | (~new_n115_ & ~x5);
  assign new_n115_ = (x4 | (x0 ? (x6 & (~new_n116_ | x1 | ~x2)) : (x6 & (~x2 | ~x6)))) & (x0 | x1 | x2);
  ...
  assign z54 = new_n163_ | ~new_n165_ | (~new_n161_ & ~x0);
