...
module FAU ( 
  ...
  assign new_n170_ = ~x6 & (x2 | (x3 & (~new_n90_ | ~x3 | x6)));
  assign new_n171_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n172_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (x3 | ~x4 | ~x1 | x2);
  assign z54 = (~new_n174_ & ~x0) | new_n176_ | ~new_n178_;
  assign new_n174_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n175_ | ~x5))));
  assign new_n175_ = x6 & x7;
  assign new_n176_ = ~x1 & ((~new_n177_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n177_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n178_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n157_ & ~x4));
  assign z57 = (x0 & (~new_n180_ | ~x3)) | ~new_n187_ | (~x0 & (~new_n184_ | new_n189_));
  assign new_n180_ = (new_n181_ | x5) & ~new_n182_ & (new_n183_ | ~x5) & (~new_n127_ | x4);
