...
module FAU ( 
  ...
  assign z38 = new_n119_ | new_n122_ | new_n123_ | new_n133_;
  ...
  assign new_n156_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n157_ | ~x3) & (x0 | ~x1);
  assign new_n157_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  ...
  assign new_n200_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
