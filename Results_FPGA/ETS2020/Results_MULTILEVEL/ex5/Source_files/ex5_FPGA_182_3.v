// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:45 2020
...
module FAU ( 
  ...
  assign z38 = new_n118_ | new_n121_ | new_n122_ | new_n132_;
  ...
  assign new_n155_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n156_ | ~x3) & (x0 | ~x1);
  assign new_n156_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  ...
  assign new_n199_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z49 = new_n201_ | ~new_n202_ | (~x3 & (new_n188_ | new_n142_));
  ...
  assign new_n205_ = (x1 | ((~x2 | ~x3) & (~new_n176_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n214_ | ~new_n213_ | (x3 & (new_n212_ | new_n142_ | new_n215_));
  assign new_n212_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n213_ = ~new_n173_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n221_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n154_ | ~x5))));
  assign new_n222_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n223_ & ~x4));
  assign new_n223_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n224_ = (~x0 | (~new_n181_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n230_ = (new_n231_ | ~x6) & (~x5 | x6) & (x5 | (~new_n186_ & (x6 | (~x0 & x1))));
  ...
  assign new_n235_ = x3 & (new_n236_ | x5) & ~new_n237_ & ~new_n166_ & (new_n238_ | ~x5);
  ...
  assign new_n242_ = (new_n243_ | x4) & (~new_n186_ | x1);
  ...
  assign new_n251_ = ~new_n142_ & (x0 | ~x2 | ~x4);
