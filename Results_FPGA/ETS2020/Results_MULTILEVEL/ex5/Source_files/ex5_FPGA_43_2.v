...
module FAU ( 
  ...
  assign new_n169_ = (x1 | ((~x2 | ~x3) & (~new_n160_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n174_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n175_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z54 = (~new_n177_ & ~x0) | new_n178_ | ~new_n180_;
  assign new_n177_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n144_ | ~x5))));
  assign new_n178_ = ~x1 & ((~new_n179_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n179_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n180_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n165_ & ~x4));
  assign z56 = (~new_n182_ & ~x4) | ~new_n185_ | (~new_n184_ & x3);
  assign new_n182_ = (new_n183_ | ~x6) & (~x5 | x6) & (x5 | ((x2 | x3) & (new_n82_ | x6)));
  ...
  assign new_n187_ = (new_n188_ | x5) & ~new_n189_ & (new_n190_ | ~x5) & (~new_n128_ | x4);
