...
module FAU ( 
  ...
  assign z54 = (~new_n168_ & ~x0) | new_n170_ | ~new_n172_;
  assign new_n168_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n169_ | ~x5))));
  assign new_n169_ = x6 & x7;
  assign new_n170_ = ~x1 & ((~new_n171_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n171_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n172_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n155_ & ~x4));
  assign z57 = (x0 & (~new_n174_ | ~x3)) | ~new_n181_ | (~x0 & (~new_n178_ | new_n183_));
  assign new_n174_ = (new_n175_ | x5) & ~new_n176_ & (new_n177_ | ~x5) & (~new_n125_ | x4);
