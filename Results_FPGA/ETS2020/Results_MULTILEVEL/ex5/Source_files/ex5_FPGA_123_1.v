// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:03 2020
...
module FAU ( 
  ...
  assign z49 = new_n161_ | ~new_n162_ | (~x3 & (new_n153_ | new_n123_));
  ...
  assign new_n165_ = x5 ? new_n166_ : new_n167_;
  assign new_n166_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n167_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n172_ | ~new_n170_ | (x3 & (new_n169_ | new_n171_ | new_n123_));
  assign new_n169_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n170_ = ~new_n148_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n171_ = x1 & (x4 | ~x6);
  assign new_n172_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n176_ | (~x4 & (x5 ? ~new_n174_ : ~new_n175_));
  assign new_n174_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n175_ = ~x6 & (x2 | (x3 & (~x0 | x1 | ~x3 | x6)));
  ...
  assign new_n178_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n134_ | ~x5))));
  ...
  assign new_n188_ = (new_n189_ | ~x6) & (~x5 | x6) & (x5 | (~new_n151_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n193_ | new_n203_ | new_n204_ | new_n194_ | new_n197_ | new_n201_;
  assign new_n193_ = ~new_n123_ & (x0 | ~x2 | ~x4);
  assign new_n194_ = x3 & (~new_n196_ | (~new_n195_ & ~x5));
  assign new_n195_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n196_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n197_ = ~x3 & ((~new_n198_ & ~x0) | new_n199_ | (~new_n200_ & x0));
  assign new_n198_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n199_ = ~x2 & (x0 | (x1 & x4));
  assign new_n200_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n201_ = ~new_n202_ & ~x5;
  assign new_n202_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n203_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
  ...
  assign z61 = ~new_n211_ | (~x4 & ((~new_n210_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n210_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n211_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n213_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n213_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
