...
module FAU ( 
  ...
  assign new_n173_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n174_ | ~x5))));
  assign new_n174_ = x6 & x7;
  assign new_n175_ = ~x1 & ((~new_n176_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n176_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n177_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n160_ & ~x4));
  assign z56 = (~new_n179_ & ~x4) | ~new_n183_ | (~new_n182_ & x3);
  assign new_n179_ = (new_n181_ | ~x6) & (~x5 | x6) & (x5 | (~new_n180_ & (x6 | (~x0 & x1))));
  ...
  assign z57 = (x0 & (~new_n185_ | ~x3)) | ~new_n192_ | (~x0 & (~new_n189_ | new_n194_));
  assign new_n185_ = (new_n186_ | x5) & ~new_n187_ & (new_n188_ | ~x5) & (~new_n130_ | x4);
  assign new_n186_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n187_ = x2 & (x4 | (~x1 & x3));
  assign new_n188_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n189_ = ~new_n190_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n191_ & ~x3));
  assign new_n190_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n191_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n192_ = (new_n193_ | x4) & (~new_n180_ | x1);
  assign new_n193_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n194_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  ...
  assign new_n205_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z05 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
