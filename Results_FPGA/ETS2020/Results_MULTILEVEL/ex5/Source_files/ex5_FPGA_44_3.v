// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:07 2020
...
module FAU ( 
  ...
  assign z46 = new_n190_ | ~new_n191_ | (~x4 & (~new_n188_ | (~new_n187_ & ~x0)));
  assign new_n187_ = ~x5 & (~new_n139_ | x5 | ~x1 | x2 | x3);
  ...
  assign z48 = ~new_n197_ | new_n200_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n197_ = new_n199_ & (x2 | ((x1 | x3) & (~x0 | (~new_n198_ & x3))));
  assign new_n198_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n199_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n200_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n202_ | ~new_n203_ | (~x3 & (new_n189_ | new_n144_));
  ...
  assign new_n206_ = (x1 | ((~x2 | ~x3) & (~new_n178_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n222_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n156_ | ~x5))));
  assign new_n223_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n224_ & ~x4));
  assign new_n224_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n225_ = (~x0 | (~new_n183_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n231_ = x3 & (new_n232_ | x5) & ~new_n233_ & ~new_n168_ & (new_n234_ | ~x5);
  ...
  assign new_n238_ = (x1 | x2 | x3) & (new_n239_ | x4);
  ...
  assign new_n247_ = ~new_n144_ & (x0 | ~x2 | ~x4);
