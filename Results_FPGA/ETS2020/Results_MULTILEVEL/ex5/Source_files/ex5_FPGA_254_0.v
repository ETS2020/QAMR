...
module FAU ( 
  ...
  assign new_n153_ = x0 & ((new_n137_ & ~x4) | (new_n154_ & x2));
  ...
  assign new_n160_ = (~x0 | (~x4 & (~new_n154_ | ~x2))) & ~new_n161_ & (x0 | ((~new_n154_ | x4) & (~x2 | x3 | ~x4)));
  ...
  assign z49 = ~new_n188_ | (~new_n187_ & ~x3) | (x0 & (x4 | (new_n154_ & ~x4)));
  ...
  assign new_n191_ = (x1 | ((~x2 | ~x3) & (~new_n142_ | x2 | x4))) & x3 & ~x4 & (~new_n154_ | x4);
  ...
  assign new_n207_ = ~new_n208_ & (~x0 | (x2 ? (~new_n154_ & ~x4) : x3));
  ...
  assign z58 = ~new_n219_ | (~new_n216_ & ~x4);
  assign new_n216_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n217_ | x5) & (~x5 | (x6 & (new_n218_ | ~x6)));
  assign new_n217_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n218_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n219_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
