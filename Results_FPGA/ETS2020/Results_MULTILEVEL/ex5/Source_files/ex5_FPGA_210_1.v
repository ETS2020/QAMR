// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:05 2020
...
module FAU ( 
  ...
  assign z20 = ~x6 & ~x5 & ~x4 & new_n88_ & ~x2 & ~x3;
  ...
  assign z49 = new_n168_ | ~new_n169_ | (~x3 & (new_n155_ | new_n125_));
  ...
  assign z52 = new_n178_ | ~new_n176_ | (x3 & (new_n175_ | new_n177_ | new_n125_));
  ...
  assign new_n184_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n136_ | ~x5))));
  ...
  assign new_n200_ = x5 & ((~x4 & x7) | (new_n88_ & ~x2 & x4));
