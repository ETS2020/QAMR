...
module FAU ( 
  ...
  assign z36 = ~new_n126_ | (~x4 & ((~new_n128_ & ~x5) | x5 | (~x0 & x7)));
  assign new_n126_ = (new_n127_ | ~x0) & (x0 | ~x1) & (~x4 | ((~x1 | (~x3 & (x2 | x3))) & (x0 | (~x2 & (x2 | (~x3 & (x1 | x3)))))));
  assign new_n127_ = (x1 | (x2 ? ~x3 : (~x4 | ~x5))) & (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n128_ = (~x0 | (x6 & (~x6 | ~x7 | x1 | x2))) & (x1 | x6) & (x2 | x3) & (~x3 | ~x6 | x7);
  assign z37 = (~new_n130_ & ~x0) | ~new_n132_ | (~x3 & (x2 ? x0 : ~x1));
  assign new_n130_ = (new_n131_ | x4) & (x1 | ~x2 | (x3 & (~x3 | ~x4 | x5))) & (~x4 | (x3 & (x2 | ~x3)));
  assign new_n131_ = ~x5 & ~x7 & (x5 | (x6 & (~x1 | x3 | ~x6 | x7)));
  assign new_n132_ = new_n135_ & (~x0 | (new_n134_ & (new_n133_ | ~x3)));
  assign new_n133_ = (~x1 | (~x7 & (x4 | ~x5))) & (x5 | ~x6 | ~x7 | x1 | ~x2 | x4);
  assign new_n134_ = (~x2 | ~x4) & (x1 | x2 | x5 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n135_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x1 | x4 | x5 | x6);
  assign z38 = new_n116_ | new_n119_ | new_n120_ | new_n137_;
  ...
  assign new_n199_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x0 | x3) & (~x1 | ~x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z52 = new_n215_ | ~new_n213_ | (x3 & (new_n212_ | new_n214_ | new_n147_));
  assign new_n212_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n213_ = ~new_n178_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n214_ = x1 & (x4 | ~x6);
  ...
  assign new_n224_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n186_ & ~x4));
