...
module FAU ( 
  ...
  assign z45 = (~x2 & (new_n155_ | ~new_n157_)) | new_n163_ | ~new_n160_ | (~new_n158_ & x2);
  ...
  assign new_n165_ = ~x5 & (~new_n134_ | x5 | ~new_n166_ | ~x1);
  ...
  assign new_n185_ = (x1 | ((~x2 | ~x3) & (~new_n156_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n194_ = ~new_n153_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign z54 = (~new_n201_ & ~x0) | new_n202_ | ~new_n204_;
  assign new_n201_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n139_ | ~x5))));
  assign new_n202_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n203_ & ~x4));
  assign new_n203_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n204_ = (~x0 | (~new_n161_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n210_ = (new_n211_ | ~x6) & (~x5 | x6) & (x5 | (~new_n166_ & (x6 | (~x0 & x1))));
  ...
  assign new_n215_ = x3 & (new_n216_ | x5) & ~new_n217_ & ~new_n146_ & (new_n218_ | ~x5);
  ...
  assign new_n222_ = (new_n223_ | x4) & (~new_n166_ | x1);
