...
module FAU ( 
  ...
  assign z32 = new_n108_ | new_n110_ | ~new_n111_;
  ...
  assign new_n111_ = (~x2 | (x0 ? (x3 & (x1 | ~x3)) : (x1 | x3))) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  assign z35 = new_n105_ | (~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7)))));
  assign z39 = new_n119_ | ~new_n116_ | (~new_n114_ & ~x5);
  assign new_n114_ = (x4 | (x0 ? (x6 & (~new_n115_ | x1 | ~x2)) : (x6 & (~x2 | ~x6)))) & (x0 | x1 | x2);
  ...
  assign new_n134_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (x0 | ~x1) & (new_n135_ | ~x3);
  ...
  assign z54 = new_n168_ | ~new_n170_ | (~new_n167_ & ~x0);
  assign new_n167_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n133_ | ~x5))));
  assign new_n168_ = ~x1 & ((~new_n169_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n169_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n170_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n154_ & ~x4));
