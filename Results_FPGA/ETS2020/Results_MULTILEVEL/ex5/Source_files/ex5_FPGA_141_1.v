// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:16 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n94_,
    ...
    new_n210_, new_n212_, new_n213_, new_n215_;
  ...
  assign z40 = new_n119_ | (~new_n121_ & ~x5) | new_n127_ | ~new_n125_ | new_n128_;
  ...
  assign new_n125_ = (x0 | ((x2 | ~x3 | ~x4) & (x4 | ~x7))) & (~new_n126_ | x4);
  ...
  assign z49 = new_n163_ | ~new_n164_ | (~x3 & (new_n150_ | new_n120_));
  ...
  assign new_n167_ = x5 ? new_n168_ : new_n169_;
  assign new_n168_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n169_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n174_ | ~new_n172_ | (x3 & (new_n171_ | new_n173_ | new_n120_));
  assign new_n171_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n172_ = ~new_n145_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n173_ = x1 & (x4 | ~x6);
  assign new_n174_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n178_ | (~x4 & (x5 ? ~new_n176_ : ~new_n177_));
  assign new_n176_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n177_ = ~x6 & (x2 | (x3 & (~x0 | x1 | ~x3 | x6)));
  assign new_n178_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n181_ | ~new_n183_ | (~new_n180_ & ~x0);
  assign new_n180_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n131_ | ~x5))));
  assign new_n181_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n182_ & ~x4));
  assign new_n182_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n183_ = (~x0 | (~new_n184_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign new_n184_ = x1 & x3 & x7;
  assign z55 = ~new_n186_ | (~x4 & (x5 ? ~new_n188_ : (x6 | (~x1 & ~x6))));
  assign new_n186_ = ~new_n187_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n187_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n188_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n190_ & ~x4) | ~new_n193_ | (~new_n192_ & x3);
  assign new_n190_ = (new_n191_ | ~x6) & (~x5 | x6) & (x5 | (~new_n148_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n195_ | new_n205_ | new_n206_ | new_n196_ | new_n199_ | new_n203_;
  assign new_n195_ = ~new_n120_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n205_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
  assign new_n206_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n209_ | ~new_n210_ | (~x4 & (~x5 | (~new_n208_ & x5)));
  assign new_n208_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n209_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n210_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n213_ | (~x4 & ((~new_n212_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n212_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n213_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n215_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n215_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
