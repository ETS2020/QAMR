...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n78_, new_n80_, new_n82_, new_n85_, new_n87_, new_n89_, new_n98_,
  ...
  assign z50 = (~new_n141_ & x0) | (~new_n143_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n141_ = (new_n142_ | x1) & x3 & ~z00 & ~x4;
  assign new_n142_ = (~x2 | ~x3) & (x2 | x4 | x5 | ~x6 | ~x7);
  assign new_n143_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n144_;
  assign new_n144_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n146_ & ~x0) | new_n148_ | ~new_n150_;
  assign new_n146_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n147_ | ~x5))));
  assign new_n147_ = x6 & x7;
  assign new_n148_ = ~x1 & ((~new_n149_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n149_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n150_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n151_ & ~x4));
  assign new_n151_ = x1 & x3 & x7;
  assign z56 = (~new_n153_ & ~x4) | ~new_n157_ | (~new_n156_ & x3);
  assign new_n153_ = (new_n155_ | ~x6) & (~x5 | x6) & (x5 | (~new_n154_ & (x6 | (~x0 & x1))));
  assign new_n154_ = ~x2 & ~x3;
  assign new_n155_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n156_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n157_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (x0 & (~new_n159_ | ~x3)) | ~new_n166_ | (~x0 & (~new_n163_ | new_n168_));
  assign new_n159_ = (new_n160_ | x5) & ~new_n161_ & (new_n162_ | ~x5) & (~new_n117_ | x4);
  assign new_n160_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n161_ = x2 & (x4 | (~x1 & x3));
  assign new_n162_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n163_ = ~new_n164_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n165_ & ~x3));
  assign new_n164_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n165_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n166_ = (new_n167_ | x4) & (~new_n154_ | x1);
  assign new_n167_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n168_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z60 = new_n171_ | ~new_n172_ | (~x4 & (~x5 | (~new_n170_ & x5)));
  assign new_n170_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n171_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n172_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z62 = ~new_n174_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n174_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
