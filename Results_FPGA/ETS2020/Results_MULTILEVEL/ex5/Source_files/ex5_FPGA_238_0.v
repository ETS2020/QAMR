// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:25 2020
...
module FAU ( 
  ...
  assign new_n234_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
  ...
  assign new_n252_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n254_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n254_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z04 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
