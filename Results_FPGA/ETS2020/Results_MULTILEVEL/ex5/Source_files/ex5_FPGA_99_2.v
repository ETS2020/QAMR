...
module FAU ( 
  ...
  assign new_n134_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n135_ | ~x3) & (x0 | ~x1);
  assign new_n135_ = (~x1 | x6) & (~x4 | (x0 & ~x1));
  ...
  assign z43 = (~new_n144_ & x4) | new_n119_ | new_n145_ | (~new_n146_ & ~x4);
  ...
  assign new_n150_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n117_ | x4 | x5)))));
  assign new_n151_ = new_n152_ & (~x0 | (x3 & (~new_n149_ | x1 | ~x3 | x4)));
  assign new_n152_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n153_ = (new_n155_ | x4) & ((~z00 & ~new_n154_) | ~x0);
  assign new_n154_ = x1 & x3 & x7;
  assign new_n155_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  assign new_n156_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z50 = (~new_n158_ & x0) | (~new_n159_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n158_ = (x1 | ((~x2 | ~x3) & (~new_n149_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n159_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n160_;
  assign new_n160_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n162_ & ~x0) | new_n163_ | ~new_n165_;
  assign new_n162_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n133_ | ~x5))));
  assign new_n163_ = ~x1 & ((~new_n164_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n164_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n165_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n154_ & ~x4));
  assign z57 = (x0 & (~new_n167_ | ~x3)) | ~new_n174_ | (~x0 & (~new_n171_ | new_n176_));
  assign new_n167_ = (new_n168_ | x5) & ~new_n169_ & (new_n170_ | ~x5) & (~new_n117_ | x4);
  assign new_n168_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n169_ = x2 & (x4 | (~x1 & x3));
  assign new_n170_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n171_ = ~new_n172_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n173_ & ~x3));
  assign new_n172_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n173_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n174_ = (x1 | x2 | x3) & (new_n175_ | x4);
  assign new_n175_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n176_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
