...
module FAU ( 
  ...
  wire new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n90_, new_n101_,
    ...
    new_n185_, new_n186_, new_n187_, new_n189_;
  assign z00 = ~x4 & ~x5 & ~x6;
  assign z01 = ~x7 & ~x5 & ~x6;
  ...
  assign new_n167_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n150_ & ~x4));
  assign z57 = (x0 & (~new_n169_ | ~x3)) | ~new_n176_ | (~x0 & (~new_n173_ | new_n178_));
  assign new_n169_ = (new_n170_ | x5) & ~new_n171_ & (new_n172_ | ~x5) & (~new_n120_ | x4);
