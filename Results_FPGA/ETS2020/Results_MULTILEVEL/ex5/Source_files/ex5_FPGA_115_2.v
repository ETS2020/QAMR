...
module FAU ( 
  ...
  assign z43 = (~new_n147_ & x4) | new_n134_ | new_n148_ | (~new_n149_ & ~x4);
  ...
  assign new_n153_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n132_ | x4 | x5)))));
  ...
  assign new_n177_ = (new_n178_ | x5) & ~new_n179_ & (new_n180_ | ~x5) & (~new_n132_ | x4);
  ...
  assign new_n182_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
