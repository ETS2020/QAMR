// Benchmark "FAU" written by ABC on Thu Aug  6 04:05:55 2020
...
module FAU ( 
  ...
  assign z46 = new_n189_ | ~new_n190_ | (~x4 & (~new_n187_ | (~new_n186_ & ~x0)));
  assign new_n186_ = ~x5 & (~new_n138_ | x5 | ~x1 | x2 | x3);
  ...
  assign z49 = new_n201_ | ~new_n202_ | (~x3 & (new_n188_ | new_n143_));
  ...
  assign new_n205_ = (x1 | ((~x2 | ~x3) & (~new_n177_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n221_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n155_ | ~x5))));
  assign new_n222_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n223_ & ~x4));
  assign new_n223_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n224_ = (~x0 | (~new_n182_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign z57 = (~new_n230_ & x0) | ~new_n237_ | (~x0 & (~new_n234_ | new_n239_));
  assign new_n230_ = x3 & (new_n231_ | x5) & ~new_n232_ & ~new_n167_ & (new_n233_ | ~x5);
  assign new_n231_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n232_ = x2 & (x4 | (~x1 & x3));
  assign new_n233_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n234_ = ~new_n235_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n236_ & ~x3));
  assign new_n235_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n236_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n237_ = (x1 | x2 | x3) & (new_n238_ | x4);
  assign new_n238_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n239_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z58 = ~new_n244_ | (~new_n241_ & ~x4);
  assign new_n241_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n242_ | x5) & (~x5 | (x6 & (new_n243_ | ~x6)));
  assign new_n242_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n243_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n244_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n246_ | new_n247_ | new_n257_ | new_n248_ | new_n251_ | new_n255_;
  assign new_n246_ = ~new_n143_ & (x0 | ~x2 | ~x4);
  assign new_n247_ = x5 & ((~x4 & x7) | (new_n91_ & ~x2 & x4));
  assign new_n248_ = x3 & (~new_n250_ | (~new_n249_ & ~x5));
  assign new_n249_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n250_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n251_ = ~x3 & ((~new_n252_ & ~x0) | new_n253_ | (~new_n254_ & x0));
  assign new_n252_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n253_ = ~x2 & (x0 | (x1 & x4));
  assign new_n254_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n255_ = ~new_n256_ & ~x5;
  assign new_n256_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n257_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n260_ | ~new_n261_ | (~x4 & (~x5 | (~new_n259_ & x5)));
  assign new_n259_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n260_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n261_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n264_ | (~x4 & ((~new_n263_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n263_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n264_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z13 = 1'b0;
  assign z23 = 1'b0;
