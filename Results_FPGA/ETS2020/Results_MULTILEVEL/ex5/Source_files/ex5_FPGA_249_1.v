...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n77_, new_n79_, new_n81_, new_n83_, new_n85_, new_n86_,
    new_n88_, new_n95_, new_n98_, new_n104_, new_n105_, new_n106_,
  ...
  assign new_n107_ = (~x2 | (x0 ? (x3 & (x1 | ~x3)) : (x1 | x3))) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  ...
  assign new_n118_ = (~x0 | (x6 & (~x6 | ~x7 | x1 | x2))) & (x1 | x6) & (x2 | x3) & (~x3 | ~x6 | x7);
  ...
  assign z40 = new_n127_ | (~new_n129_ & ~x5) | new_n135_ | ~new_n133_ | new_n136_;
  assign new_n127_ = ~x3 & ((~x0 & ~x1 & x2) | new_n128_ | (x1 & ~x2 & x4));
  assign new_n128_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n129_ = ~new_n130_ & ~new_n132_ & (new_n131_ | ~x0);
  assign new_n130_ = x1 & (~x2 | (x2 & x3 & ~x4 & x6));
  assign new_n131_ = (~x2 | (x6 & (x4 | ~x6 | ~x7 | x1 | ~x3))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n132_ = ~x4 & ((~x0 & ~x6) | (x3 & x6 & ~x7));
  assign new_n133_ = (x0 | ((x4 | ~x7) & (x2 | ~x3 | ~x4))) & (~new_n134_ | x4);
  ...
  assign new_n164_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = new_n171_ | ~new_n172_ | (~x3 & (new_n158_ | new_n128_));
  ...
  assign z51 = (~new_n175_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n175_ = x5 ? new_n176_ : (~x6 & (~new_n86_ | x2 | ~x3 | x6));
  assign new_n176_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n181_ | ~new_n179_ | (x3 & (new_n178_ | new_n180_ | new_n128_));
  assign new_n178_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n179_ = ~new_n153_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n180_ = x1 & (x4 | ~x6);
  assign new_n181_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n185_ | (~x4 & (x5 ? ~new_n184_ : ~new_n183_));
  assign new_n183_ = ~x6 & (x2 | (x3 & (~new_n86_ | ~x3 | x6)));
  assign new_n184_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  ...
  assign new_n187_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n139_ | ~x5))));
  ...
  assign new_n197_ = (new_n198_ | ~x6) & (~x5 | x6) & (x5 | (~new_n156_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n207_ | new_n208_ | new_n218_ | new_n209_ | new_n212_ | new_n216_;
  assign new_n207_ = ~new_n128_ & (x0 | ~x2 | ~x4);
  assign new_n208_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
  assign new_n209_ = x3 & (~new_n211_ | (~new_n210_ & ~x5));
  assign new_n210_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n211_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n212_ = ~x3 & ((~new_n213_ & ~x0) | new_n214_ | (~new_n215_ & x0));
  assign new_n213_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n214_ = ~x2 & (x0 | (x1 & x4));
  assign new_n215_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n216_ = ~new_n217_ & ~x5;
  assign new_n217_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
