// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:18 2020
...
module FAU ( 
  ...
  assign z36 = ~new_n107_ | (~x4 & ((~new_n109_ & ~x5) | x5 | (~x0 & x7)));
  assign new_n107_ = (new_n108_ | ~x0) & (x0 | ~x1) & (~x4 | ((~x1 | (~x3 & (x2 | x3))) & (x0 | (~x2 & (x2 | (~x3 & (x1 | x3)))))));
  assign new_n108_ = (x1 | (x2 ? ~x3 : (~x4 | ~x5))) & (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n109_ = (~x0 | (x6 & (~x6 | ~x7 | x1 | x2))) & (x1 | x6) & (x2 | x3) & (~x3 | ~x6 | x7);
  assign z37 = (~new_n111_ & ~x0) | ~new_n113_ | (~x3 & (x2 ? x0 : ~x1));
  assign new_n111_ = (new_n112_ | x4) & (x1 | ~x2 | (x3 & (~x3 | ~x4 | x5))) & (~x4 | (x3 & (x2 | ~x3)));
  assign new_n112_ = ~x5 & ~x7 & (x5 | (x6 & (~x1 | x3 | ~x6 | x7)));
  assign new_n113_ = new_n116_ & (~x0 | (new_n115_ & (new_n114_ | ~x3)));
  assign new_n114_ = (~x1 | (~x7 & (x4 | ~x5))) & (x5 | ~x6 | ~x7 | x1 | ~x2 | x4);
  assign new_n115_ = (~x2 | ~x4) & (x1 | x2 | x5 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n116_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x5 | x6 | x1 | x4);
  assign z40 = new_n118_ | ~new_n124_ | new_n127_ | (~new_n120_ & ~x5);
  ...
  assign new_n124_ = (~x1 | (x0 & (~x3 | ~x4))) & (new_n125_ | x0) & (~new_n126_ | x4);
  assign new_n125_ = (x4 | ~x7) & (x2 | ~x3 | ~x4);
  assign new_n126_ = x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  assign new_n127_ = x0 & (x4 ? x2 : (x6 & ~x7));
  ...
  assign z44 = new_n136_ | ~new_n138_ | (x1 & (~x0 | (~x2 & ~x5)));
  assign new_n136_ = x3 & (x4 ? ~x0 : new_n137_);
  assign new_n137_ = ~x6 & ((x5 & ~x7) | (x0 & ~x1 & ~x2 & ~x5));
  assign new_n138_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n139_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n139_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign z46 = new_n144_ | ~new_n145_ | (~x4 & (~new_n141_ | (~new_n143_ & ~x0)));
  assign new_n141_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n142_ | ~x6 | ~x7)))));
  assign new_n142_ = ~x1 & ~x2;
  assign new_n143_ = ~x5 & (~x1 | x2 | x3 | x5 | ~x6 | x7);
  ...
  assign new_n147_ = (~x0 | ~x6 | (x7 & (~new_n142_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n148_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n149_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((~x1 | x3) & (x0 | (~x3 & (x1 | x3))))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = new_n156_ | ~new_n157_ | (~x3 & (new_n142_ | new_n119_));
  ...
  assign new_n160_ = x5 ? new_n161_ : new_n162_;
  assign new_n161_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n162_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n167_ | ~new_n165_ | (x3 & (new_n164_ | new_n166_ | new_n119_));
  assign new_n164_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n165_ = ~new_n139_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n166_ = x1 & (x4 | ~x6);
  assign new_n167_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n171_ | (~x4 & (x5 ? ~new_n169_ : ~new_n170_));
  assign new_n169_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n170_ = ~x6 & (x2 | (x3 & (~x0 | x1 | ~x3 | x6)));
  assign new_n171_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n174_ | ~new_n176_ | (~new_n173_ & ~x0);
  assign new_n173_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n130_ | ~x5))));
  ...
  assign new_n183_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n184_ | x5) & (~x5 | (x6 & (new_n185_ | ~x6)));
  assign new_n184_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n185_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n186_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n188_ | new_n198_ | new_n199_ | new_n189_ | new_n192_ | new_n196_;
  assign new_n188_ = ~new_n119_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n198_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
  assign new_n199_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n202_ | ~new_n203_ | (~x4 & (~x5 | (~new_n201_ & x5)));
  assign new_n201_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n202_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n203_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
