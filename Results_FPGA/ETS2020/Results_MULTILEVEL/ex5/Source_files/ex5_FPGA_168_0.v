// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:35 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n81_, new_n84_, new_n86_, new_n87_, new_n97_, new_n99_,
  ...
  assign z45 = ((new_n163_ | ~new_n165_) & ~x2) | new_n171_ | ~new_n168_ | (~new_n166_ & x2);
  assign new_n163_ = x0 & (~x3 | (new_n164_ & ~x1 & ~x4));
  assign new_n164_ = ~x5 & x6 & x7;
  assign new_n165_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n136_ | x4 | x5)))));
  assign new_n166_ = new_n167_ & (~x0 | (x3 & (~new_n164_ | x1 | ~x3 | x4)));
  assign new_n167_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n168_ = ~new_n170_ & (~x0 | (~z00 & ~new_n169_));
  ...
  assign new_n173_ = ~x5 & (~new_n136_ | x5 | ~new_n174_ | ~x1);
  ...
  assign z49 = ~new_n190_ | (~new_n189_ & ~x3) | (x0 & (x4 | (new_n153_ & ~x4)));
  ...
  assign new_n193_ = (x1 | ((~x2 | ~x3) & (~new_n164_ | x2 | x4))) & x3 & ~x4 & (~new_n153_ | x4);
  ...
  assign new_n197_ = x5 ? new_n198_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  ...
  assign new_n202_ = ~new_n161_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n203_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n207_ | (~x4 & (x5 ? ~new_n206_ : ~new_n205_));
  assign new_n205_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign z54 = (~new_n209_ & ~x0) | new_n210_ | ~new_n212_;
  assign new_n209_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n141_ | ~x5))));
  assign new_n210_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n211_ & ~x4));
  assign new_n211_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n212_ = (~x0 | (~new_n169_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n214_ | (~x4 & (x5 ? ~new_n216_ : (x6 | (~x1 & ~x6))));
  assign new_n214_ = ~new_n215_ & (~x0 | (x2 ? (~new_n153_ & ~x4) : x3));
  assign new_n215_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n216_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n218_ & ~x4) | ~new_n221_ | (~new_n220_ & x3);
  assign new_n218_ = (new_n219_ | ~x6) & (~x5 | x6) & (x5 | (~new_n174_ & (x6 | (~x0 & x1))));
  assign new_n219_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n220_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n221_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (~new_n223_ & x0) | ~new_n230_ | (~x0 & (~new_n227_ | new_n232_));
  assign new_n223_ = x3 & (new_n224_ | x5) & ~new_n225_ & ~new_n154_ & (new_n226_ | ~x5);
  assign new_n224_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n225_ = x2 & (x4 | (~x1 & x3));
  assign new_n226_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n227_ = ~new_n228_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n229_ & ~x3));
  assign new_n228_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n229_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n230_ = (new_n231_ | x4) & (~new_n174_ | x1);
  assign new_n231_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n232_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z58 = ~new_n237_ | (~new_n234_ & ~x4);
  assign new_n234_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n235_ | x5) & (~x5 | (x6 & (new_n236_ | ~x6)));
  assign new_n235_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n236_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n237_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n249_ | new_n239_ | new_n250_ | new_n240_ | new_n243_ | new_n247_;
  assign new_n239_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
  assign new_n240_ = x3 & (~new_n242_ | (~new_n241_ & ~x5));
  assign new_n241_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n242_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n243_ = ~x3 & ((~new_n244_ & ~x0) | new_n245_ | (~new_n246_ & x0));
  assign new_n244_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n245_ = ~x2 & (x0 | (x1 & x4));
  assign new_n246_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n247_ = ~new_n248_ & ~x5;
  assign new_n248_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n249_ = (x0 | ~x2 | ~x4) & (x4 | ~x5 | x6 | x7);
  assign new_n250_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n253_ | ~new_n254_ | (~x4 & (~x5 | (~new_n252_ & x5)));
  assign new_n252_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n253_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n254_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n257_ | (~x4 & ((~new_n256_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n256_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n257_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n259_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n259_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z14 = 1'b0;
