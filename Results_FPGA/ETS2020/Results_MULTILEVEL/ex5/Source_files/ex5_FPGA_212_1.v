...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    ...
    new_n195_, new_n196_, new_n197_, new_n198_, new_n200_;
  ...
  assign z41 = (~x4 & (~new_n133_ | (~new_n132_ & x0))) | ~new_n130_ | new_n134_;
  assign new_n130_ = (new_n131_ | ~x0) & (x0 | ~x1) & (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6)));
  assign new_n131_ = (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n132_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | x5 | ~x6 | ~x7);
  assign new_n133_ = (x0 | (~x5 & ~x7)) & (x5 | ((x1 | x6) & (~x3 | ~x6 | x7)));
  assign new_n134_ = ~x1 & ((x0 & (x2 ? x3 : (x4 & ~x5))) | (~x3 & (~x2 | (~x0 & x2))));
  assign z44 = new_n139_ | ~new_n137_ | (x3 & (x4 ? ~x0 : new_n136_));
  assign new_n136_ = ~x6 & ((x5 & ~x7) | (new_n85_ & ~x2 & ~x5));
  assign new_n137_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n138_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n138_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign new_n139_ = x1 & (~x0 | (~x2 & ~x5));
  assign z46 = new_n145_ | ~new_n146_ | (~x4 & (~new_n143_ | (~new_n141_ & ~x0)));
  assign new_n141_ = ~x5 & (~new_n142_ | ~x1 | x5 | ~x6 | x7);
  assign new_n142_ = ~x2 & ~x3;
  assign new_n143_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n144_ | ~x6 | ~x7)))));
  assign new_n144_ = ~x1 & ~x2;
  assign new_n145_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n146_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n150_ | (~x4 & (~new_n148_ | (~new_n149_ & ~x5)));
  assign new_n148_ = (~x0 | ~x6 | (x7 & (~new_n144_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n149_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n150_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign new_n155_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n157_ | ~new_n158_ | (~x3 & (new_n144_ | new_n120_));
  assign new_n157_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n158_ = ~new_n159_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n159_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z51 = (~new_n161_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n161_ = x5 ? new_n162_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  assign new_n162_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n167_ | ~new_n165_ | (x3 & (new_n164_ | new_n166_ | new_n120_));
  assign new_n164_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n165_ = ~new_n138_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n166_ = x1 & (x4 | ~x6);
  assign new_n167_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n171_ | (~x4 & (x5 ? ~new_n170_ : ~new_n169_));
  assign new_n169_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  assign new_n170_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n171_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z55 = ~new_n173_ | (~x4 & (x5 ? ~new_n175_ : (x6 | (~x1 & ~x6))));
  assign new_n173_ = ~new_n174_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n174_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n175_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n177_ & ~x4) | ~new_n180_ | (~new_n179_ & x3);
  assign new_n177_ = (new_n178_ | ~x6) & (~x5 | x6) & (x5 | (~new_n142_ & (x6 | (~x0 & x1))));
  assign new_n178_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n179_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n180_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  ...
  assign new_n187_ = ~new_n120_ & (x0 | ~x2 | ~x4);
  assign new_n188_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
  ...
  assign new_n200_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z06 = 1'b0;
