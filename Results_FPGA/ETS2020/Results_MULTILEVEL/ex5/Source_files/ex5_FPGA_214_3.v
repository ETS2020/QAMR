...
module FAU ( 
  ...
  assign z39 = new_n150_ | new_n144_ | ~new_n147_;
  assign new_n144_ = ~x5 & ((~new_n146_ & ~x4) | (new_n145_ & ~x0));
  assign new_n145_ = ~x1 & ~x2;
  assign new_n146_ = x0 ? (x6 & (x1 | ~x2 | ~x3 | ~x6 | ~x7)) : (x6 & (~x2 | ~x6));
  ...
  assign z46 = new_n198_ | ~new_n199_ | (~x4 & (~new_n197_ | (~new_n196_ & ~x0)));
  assign new_n196_ = ~x5 & (~new_n148_ | x5 | ~x1 | x2 | x3);
  assign new_n197_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n145_ | ~x6 | ~x7)))));
  ...
  assign new_n201_ = (~x0 | ~x6 | (x7 & (~new_n145_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  ...
  assign z49 = new_n210_ | ~new_n211_ | (~x3 & (new_n145_ | new_n153_));
  ...
  assign new_n214_ = (x1 | ((~x2 | ~x3) & (~new_n187_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
