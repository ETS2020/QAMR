...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    ...
    new_n263_, new_n264_, new_n265_, new_n267_, new_n268_;
  ...
  assign z49 = new_n205_ | ~new_n206_ | (~x3 & (new_n197_ | new_n152_));
  ...
  assign new_n209_ = (x1 | ((~x2 | ~x3) & (~new_n186_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n219_ | ~new_n217_ | (x3 & (new_n216_ | new_n218_ | new_n152_));
  assign new_n216_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n217_ = ~new_n183_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n225_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n164_ | ~x5))));
  assign new_n226_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n227_ & ~x4));
  assign new_n227_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n228_ = (~x0 | (~new_n191_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n234_ = x3 & (new_n235_ | x5) & ~new_n236_ & ~new_n176_ & (new_n237_ | ~x5);
  ...
  assign new_n250_ = ~new_n152_ & (x0 | ~x2 | ~x4);
