...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n78_, new_n80_, new_n81_, new_n83_, new_n86_, new_n88_, new_n97_,
  ...
  assign z38 = new_n104_ | new_n107_ | new_n108_ | new_n111_;
  assign new_n111_ = ~x2 & ((x1 & ~x5) | (x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3))));
  assign z39 = new_n118_ | ~new_n115_ | (~new_n113_ & ~x5);
  assign new_n113_ = (x0 | x1 | x2) & (x4 | (x0 ? (x6 & (~new_n114_ | x1 | ~x2)) : (x6 & (~x2 | ~x6))));
  assign new_n114_ = x3 & x6 & x7;
  assign new_n115_ = (~x2 | (x0 ? x3 : (~x3 | ~x4))) & (~x0 | (~x4 & (~new_n116_ | x4))) & (~new_n117_ | x4) & (x0 | ~x4 | (x3 & (x2 | ~x3)));
  assign new_n116_ = x6 & ~x7;
  assign new_n117_ = x5 & (x7 | (~x7 & (x6 | (~x3 & ~x6))));
  assign new_n118_ = x1 & ((~x2 & ~x5) | (x0 & x3 & x7));
  assign z40 = new_n120_ | new_n122_ | new_n126_ | new_n127_ | new_n128_ | new_n129_;
  assign new_n120_ = ~x3 & ((~x0 & ~x1 & x2) | new_n121_ | (x1 & ~x2 & x4));
  assign new_n121_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n122_ = ~x5 & (new_n123_ | new_n125_ | (~new_n124_ & x0));
  assign new_n123_ = x1 & (~x2 | (x2 & x3 & ~x4 & x6));
  assign new_n124_ = (~x2 | (x6 & (x1 | ~x3 | x4 | ~x6 | ~x7))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n125_ = ~x4 & ((~x0 & ~x6) | (x3 & x6 & ~x7));
  assign new_n126_ = x0 & (x4 ? x2 : new_n116_);
  assign new_n127_ = x1 & (~x0 | (x3 & x4));
  assign new_n128_ = ~x0 & ((~x4 & x7) | (~x2 & x3 & x4));
  assign new_n129_ = ~x4 & x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  assign z41 = ~new_n133_ | new_n136_ | (~x4 & (~new_n135_ | (~new_n131_ & x0)));
  ...
  assign z43 = (~new_n143_ & x4) | new_n118_ | new_n144_ | (~new_n145_ & ~x4);
  ...
  assign z45 = ((new_n147_ | ~new_n149_) & ~x2) | new_n155_ | ~new_n152_ | (~new_n150_ & x2);
  assign new_n147_ = x0 & (~x3 | (new_n148_ & ~x1 & ~x4));
  assign new_n148_ = ~x5 & x6 & x7;
  assign new_n149_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n116_ | x4 | x5)))));
  assign new_n150_ = new_n151_ & (~x0 | (x3 & (~new_n148_ | x1 | ~x3 | x4)));
  assign new_n151_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n152_ = (new_n154_ | x4) & ((~z00 & ~new_n153_) | ~x0);
  assign new_n153_ = x1 & x3 & x7;
  assign new_n154_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  assign new_n155_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z50 = (~new_n157_ & x0) | (~new_n158_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n157_ = (x1 | ((~x2 | ~x3) & (~new_n148_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n158_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n159_;
  assign new_n159_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n161_ & ~x0) | new_n162_ | ~new_n164_;
  assign new_n161_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n132_ | ~x5))));
  assign new_n162_ = ~x1 & ((~new_n163_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n163_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n164_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n153_ & ~x4));
  assign z56 = (~new_n166_ & ~x4) | ~new_n169_ | (~new_n168_ & x3);
  assign new_n166_ = (new_n167_ | ~x6) & (~x5 | x6) & (x5 | ((x2 | x3) & (new_n81_ | x6)));
  assign new_n167_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n168_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n169_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (x0 & (~new_n171_ | ~x3)) | ~new_n178_ | (~x0 & (~new_n175_ | new_n180_));
  assign new_n171_ = (new_n172_ | x5) & ~new_n173_ & (new_n174_ | ~x5) & (~new_n116_ | x4);
  ...
  assign new_n182_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n183_ | x5) & (~x5 | (x6 & (new_n184_ | ~x6)));
  assign new_n183_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n184_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n185_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z60 = new_n188_ | ~new_n189_ | (~x4 & (~x5 | (~new_n187_ & x5)));
  assign new_n187_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n188_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n189_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z62 = ~new_n191_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n191_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
