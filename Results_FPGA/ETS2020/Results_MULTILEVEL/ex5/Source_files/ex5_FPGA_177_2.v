// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:42 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n80_, new_n82_, new_n85_, new_n87_, new_n89_, new_n99_, new_n103_,
  ...
  assign z47 = new_n152_ | ~new_n155_;
  assign new_n152_ = ~x4 & ((~new_n153_ & ~x5) | (x0 & ~new_n154_ & x6) | (x5 & (~x0 | ~x6)));
  assign new_n153_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n154_ = x7 & (x1 | x2 | ~x3 | ~x5 | ~x7);
  assign new_n155_ = (x5 | ((x0 | x1 | ~x2 | ~x3 | ~x4) & (~x1 | x2))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x0 | x3) & (~x1 | ~x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign new_n160_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z50 = (~new_n162_ & x0) | (~new_n163_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n162_ = (x1 | ((~x2 | ~x3) & (~new_n143_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n163_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n164_;
  assign new_n164_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n166_ & ~x0) | new_n168_ | ~new_n170_;
  assign new_n166_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n167_ | ~x5))));
  assign new_n167_ = x6 & x7;
  assign new_n168_ = ~x1 & ((~new_n169_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n169_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n170_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n148_ & ~x4));
  assign z57 = (x0 & (~new_n172_ | ~x3)) | ~new_n179_ | (~x0 & (~new_n176_ | new_n181_));
  assign new_n172_ = (new_n173_ | x5) & ~new_n174_ & (new_n175_ | ~x5) & (~new_n118_ | x4);
  ...
  assign new_n179_ = (x1 | x2 | x3) & (new_n180_ | x4);
  ...
  assign z62 = ~new_n187_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n187_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z07 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
