...
module FAU ( 
  ...
  assign z49 = new_n199_ | ~new_n200_ | (~x3 & (new_n191_ | new_n146_));
  ...
  assign new_n203_ = (x1 | ((~x2 | ~x3) & (~new_n180_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n212_ | ~new_n211_ | (x3 & (new_n210_ | new_n146_ | new_n213_));
  assign new_n210_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n211_ = ~new_n177_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n219_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n158_ | ~x5))));
  assign new_n220_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n221_ & ~x4));
  assign new_n221_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n222_ = (~x0 | (~new_n185_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n228_ = x3 & (new_n229_ | x5) & ~new_n230_ & ~new_n170_ & (new_n231_ | ~x5);
  ...
  assign new_n235_ = (x1 | x2 | x3) & (new_n236_ | x4);
