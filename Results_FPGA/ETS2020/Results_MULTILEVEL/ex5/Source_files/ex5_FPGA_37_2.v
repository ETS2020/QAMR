...
module FAU ( 
  ...
  assign z43 = (~new_n145_ & x4) | new_n120_ | new_n146_ | (~new_n147_ & ~x4);
  ...
  assign new_n151_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n118_ | x4 | x5)))));
  assign new_n152_ = new_n153_ & (~x0 | (x3 & (~new_n150_ | x1 | ~x3 | x4)));
  assign new_n153_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n154_ = (new_n156_ | x4) & ((~z00 & ~new_n155_) | ~x0);
  assign new_n155_ = x1 & x3 & x7;
  assign new_n156_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  ...
  assign new_n162_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z50 = (~new_n164_ & x0) | (~new_n165_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n164_ = (x1 | ((~x2 | ~x3) & (~new_n150_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n165_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n166_;
  assign new_n166_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n168_ & ~x0) | new_n169_ | ~new_n171_;
  assign new_n168_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n134_ | ~x5))));
  assign new_n169_ = ~x1 & ((~new_n170_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n170_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n171_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n155_ & ~x4));
  ...
  assign new_n180_ = (x1 | x2 | x3) & (new_n181_ | x4);
  assign new_n181_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n182_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z61 = ~new_n185_ | (~x4 & ((~new_n184_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n184_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n185_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n187_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n187_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z11 = 1'b0;
