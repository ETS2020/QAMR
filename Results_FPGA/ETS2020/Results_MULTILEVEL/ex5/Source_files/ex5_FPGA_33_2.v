...
module FAU ( 
  ...
  wire new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n90_, new_n100_,
    ...
    new_n190_, new_n192_, new_n193_, new_n194_, new_n196_;
  assign z00 = ~x4 & ~x5 & ~x6;
  assign z01 = ~x7 & ~x5 & ~x6;
  ...
  assign z43 = (~new_n140_ & x4) | new_n121_ | new_n141_ | (~new_n142_ & ~x4);
  ...
  assign new_n146_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n119_ | x4 | x5)))));
  ...
  assign new_n154_ = ~x5 & (~new_n119_ | x5 | ~new_n155_ | ~x1);
  ...
  assign new_n166_ = (x1 | ((~x2 | ~x3) & (~new_n145_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n174_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n150_ & ~x4));
  assign z56 = (~new_n176_ & ~x4) | ~new_n179_ | (~new_n178_ & x3);
  assign new_n176_ = (new_n177_ | ~x6) & (~x5 | x6) & (x5 | (~new_n155_ & (x6 | (~x0 & x1))));
  ...
  assign z57 = (x0 & (~new_n181_ | ~x3)) | ~new_n188_ | (~x0 & (~new_n185_ | new_n190_));
  assign new_n181_ = (new_n182_ | x5) & ~new_n183_ & (~new_n119_ | x4) & (new_n184_ | ~x5);
  assign new_n182_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n183_ = x2 & (x4 | (~x1 & x3));
  assign new_n184_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n185_ = ~new_n186_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n187_ & ~x3));
  assign new_n186_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n187_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n188_ = (new_n189_ | x4) & (~new_n155_ | x1);
  assign new_n189_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n190_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
