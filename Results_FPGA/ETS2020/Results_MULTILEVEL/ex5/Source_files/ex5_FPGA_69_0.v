// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:25 2020
...
module FAU ( 
  ...
  assign z43 = (~new_n155_ & x4) | new_n139_ | new_n153_ | (~new_n156_ & ~x4);
  assign new_n153_ = x0 & (new_n154_ | (new_n75_ & x2));
  ...
  assign new_n160_ = (~x0 | (~x4 & (~new_n75_ | ~x2))) & ~new_n161_ & (x0 | ((~new_n75_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n161_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign z45 = ((new_n163_ | ~new_n164_) & ~x2) | new_n169_ | ~new_n167_ | (~new_n165_ & x2);
  assign new_n163_ = x0 & (~x3 | (new_n142_ & ~x1 & ~x4));
  assign new_n164_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n137_ | x4 | x5)))));
  assign new_n165_ = new_n166_ & (~x0 | (x3 & (~new_n142_ | x1 | ~x3 | x4)));
  ...
  assign new_n171_ = ~x5 & (~new_n137_ | x5 | ~new_n172_ | ~x1);
  ...
  assign z49 = ~new_n188_ | (~new_n187_ & ~x3) | (x0 & (x4 | (new_n75_ & ~x4)));
  ...
  assign new_n191_ = (x1 | ((~x2 | ~x3) & (~new_n142_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n195_ = x5 ? new_n196_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  ...
  assign new_n203_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign new_n232_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
