...
module FAU ( 
  ...
  assign new_n103_ = (~x2 | (x0 ? (x3 & (x1 | ~x3)) : (x1 | x3))) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  ...
  assign new_n129_ = (~x1 | (x0 & (~x3 | ~x4))) & (~new_n131_ | x4) & (new_n130_ | x0);
  ...
  assign z52 = new_n158_ | ~new_n156_ | (x3 & (new_n155_ | new_n157_ | new_n124_));
  assign new_n155_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n156_ = ~new_n137_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n157_ = x1 & (x4 | ~x6);
  assign new_n158_ = ~x0 & (x1 | (x2 & x3 & x4));
  ...
  assign new_n168_ = (new_n169_ | ~x6) & (~x5 | x6) & (x5 | (~new_n140_ & (x6 | (~x0 & x1))));
  ...
  assign new_n178_ = ~new_n124_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n196_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n198_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n198_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
