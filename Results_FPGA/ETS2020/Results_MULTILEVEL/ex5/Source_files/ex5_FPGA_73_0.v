// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:28 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n80_, new_n82_, new_n85_, new_n87_, new_n88_, new_n97_,
  ...
  assign z43 = (~new_n154_ & x4) | new_n138_ | new_n152_ | (~new_n155_ & ~x4);
  assign new_n152_ = x0 & (new_n153_ | (new_n75_ & x2));
  ...
  assign new_n159_ = (~x0 | (~x4 & (~new_n75_ | ~x2))) & ~new_n160_ & (x0 | ((~new_n75_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n160_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign z45 = ((new_n162_ | ~new_n164_) & ~x2) | new_n170_ | ~new_n167_ | (~new_n165_ & x2);
  ...
  assign new_n167_ = ~new_n169_ & ((~z00 & ~new_n168_) | ~x0);
  ...
  assign new_n172_ = ~x5 & (~new_n136_ | x5 | ~new_n173_ | ~x1);
  ...
  assign new_n192_ = (x1 | ((~x2 | ~x3) & (~new_n163_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n196_ = x5 ? new_n197_ : (~x6 & (~new_n88_ | x2 | ~x3 | x6));
  ...
  assign new_n204_ = ~x6 & (x2 | (x3 & (~new_n88_ | ~x3 | x6)));
  ...
  assign new_n208_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n141_ | ~x5))));
  ...
  assign new_n213_ = ~new_n214_ & (~x0 | (x2 ? (~new_n75_ & ~x4) : x3));
  ...
  assign new_n238_ = x5 & ((~x4 & x7) | (new_n88_ & ~x2 & x4));
  ...
  assign new_n256_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n258_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n258_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z02 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z14 = 1'b0;
