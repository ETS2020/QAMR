...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n86_, new_n87_, new_n89_,
    ...
    new_n205_, new_n207_, new_n208_, new_n210_;
  ...
  assign new_n144_ = x0 & ((x2 & ~x5 & ~x6) | (~x4 & x6 & ~x7));
  ...
  assign z49 = new_n163_ | ~new_n164_ | (~x3 & (new_n155_ | new_n124_));
  ...
  assign new_n194_ = ~new_n124_ & (x0 | ~x2 | ~x4);
