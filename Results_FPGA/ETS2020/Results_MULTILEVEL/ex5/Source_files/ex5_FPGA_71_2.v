...
module FAU ( 
  ...
  assign z54 = (~new_n157_ & ~x0) | new_n158_ | ~new_n160_;
  assign new_n157_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n132_ | ~x5))));
  assign new_n158_ = ~x1 & ((~new_n159_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n159_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n160_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n161_ & ~x4));
  assign new_n161_ = x1 & x3 & x7;
  assign z57 = (x0 & (~new_n163_ | ~x3)) | ~new_n170_ | (~x0 & (~new_n167_ | new_n172_));
  assign new_n163_ = (new_n164_ | x5) & ~new_n165_ & (new_n166_ | ~x5) & (~new_n116_ | x4);
