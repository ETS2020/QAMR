...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n90_,
    ...
    new_n257_, new_n258_, new_n259_, new_n261_, new_n262_;
  ...
  assign z52 = new_n221_ | ~new_n220_ | (~new_n218_ & x3);
  assign new_n218_ = ~new_n219_ & ~new_n153_ & (~x1 | (~x4 & x6));
  assign new_n219_ = x0 & ~x1 & (x2 | (~x2 & ~x4 & ~x5 & ~x6));
  assign new_n220_ = ~new_n184_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
