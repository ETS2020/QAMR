...
module FAU ( 
  ...
  assign z43 = (~new_n135_ & x4) | new_n122_ | new_n136_ | (~new_n137_ & ~x4);
  ...
  assign new_n141_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n120_ | x4 | x5)))));
  ...
  assign new_n158_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n159_ | ~x5))));
  assign new_n159_ = x6 & x7;
  assign new_n160_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n161_ & ~x4));
  ...
  assign new_n169_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
