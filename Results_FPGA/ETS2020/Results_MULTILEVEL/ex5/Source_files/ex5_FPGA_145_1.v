// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:19 2020
...
module FAU ( 
  ...
  assign z49 = new_n162_ | ~new_n163_ | (~x3 & (new_n149_ | new_n124_));
  ...
  assign new_n166_ = x5 ? new_n167_ : new_n168_;
  assign new_n167_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n168_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n173_ | ~new_n171_ | (x3 & (new_n170_ | new_n172_ | new_n124_));
  assign new_n170_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n171_ = ~new_n144_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n172_ = x1 & (x4 | ~x6);
  assign new_n173_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n177_ | (~x4 & (x5 ? ~new_n175_ : ~new_n176_));
  assign new_n175_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n176_ = ~x6 & (x2 | (x3 & (~x0 | x1 | ~x3 | x6)));
  ...
  assign new_n179_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n135_ | ~x5))));
