...
module FAU ( 
  ...
  assign new_n152_ = (~x1 | ~x3 | ~x5) & (~new_n153_ | x1 | x2);
  ...
  assign z45 = (~x2 & (new_n175_ | ~new_n176_)) | new_n181_ | ~new_n179_ | (~new_n177_ & x2);
  assign new_n175_ = x0 & (~x3 | (new_n153_ & ~x1 & ~x4));
  assign new_n176_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n136_ | x4 | x5)))));
  assign new_n177_ = new_n178_ & (~x0 | (x3 & (~new_n153_ | x1 | ~x3 | x4)));
  assign new_n178_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n179_ = ~new_n180_ & (~x0 | (~z00 & (~x1 | ~x3 | ~x7)));
  ...
  assign z48 = ~new_n194_ | new_n197_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n194_ = new_n196_ & (x2 | ((x1 | x3) & (~x0 | (~new_n195_ & x3))));
  assign new_n195_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n196_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n197_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = (x0 & (x4 | (new_n165_ & ~x4))) | new_n199_ | (~new_n200_ & ~x0) | (~new_n201_ & ~x4);
  assign new_n199_ = ~x3 & (new_n186_ | new_n141_);
  assign new_n200_ = (x1 | x2 | (x5 & (~x3 | ~x5))) & ~x1 & (~x2 | ~x3 | ~x4);
  assign new_n201_ = (~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)));
  assign z50 = (~new_n203_ & x0) | (~new_n204_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n203_ = (x1 | ((~x2 | ~x3) & (~new_n153_ | x2 | x4))) & x3 & ~x4 & (~new_n165_ | x4);
  ...
  assign new_n207_ = x5 ? new_n208_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  assign new_n208_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n213_ | ~new_n211_ | (x3 & (new_n210_ | new_n212_ | new_n141_));
  assign new_n210_ = x0 & ~x1 & (x2 | (new_n165_ & ~x2 & ~x4));
  assign new_n211_ = ~new_n173_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n212_ = x1 & (x4 | ~x6);
  assign new_n213_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n217_ | (~x4 & (x5 ? ~new_n216_ : ~new_n215_));
  assign new_n215_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  ...
  assign new_n219_ = ~new_n220_ & (~x0 | (x2 ? (~new_n165_ & ~x4) : x3));
  ...
  assign new_n228_ = x3 & (new_n229_ | x5) & ~new_n230_ & ~new_n166_ & (new_n231_ | ~x5);
  ...
  assign new_n245_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
  ...
  assign new_n262_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n264_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n264_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
