...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n90_,
    ...
    new_n261_, new_n262_, new_n264_, new_n265_, new_n267_;
  ...
  assign new_n247_ = ~new_n143_ & (x0 | ~x2 | ~x4);
  ...
  assign z62 = ~new_n267_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n267_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z13 = 1'b0;
  assign z18 = 1'b0;
