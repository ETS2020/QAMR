...
module FAU ( 
  ...
  wire new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n89_, new_n98_,
    ...
    new_n181_, new_n183_, new_n184_, new_n185_, new_n187_;
  assign z00 = ~x4 & ~x5 & ~x6;
  assign z01 = ~x7 & ~x5 & ~x6;
  ...
  assign z56 = (~new_n161_ & ~x4) | ~new_n165_ | (~new_n164_ & x3);
  assign new_n161_ = (new_n163_ | ~x6) & (~x5 | x6) & (x5 | (~new_n162_ & (x6 | (~x0 & x1))));
  assign new_n162_ = ~x2 & ~x3;
  assign new_n163_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n164_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n165_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  ...
  assign new_n174_ = (new_n175_ | x4) & (~new_n162_ | x1);
