...
module FAU ( 
  ...
  assign z52 = new_n173_ | ~new_n171_ | (x3 & (new_n170_ | new_n172_ | new_n123_));
  assign new_n170_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n171_ = ~new_n148_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n179_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n134_ | ~x5))));
  ...
  assign new_n189_ = (new_n190_ | ~x6) & (~x5 | x6) & (x5 | (~new_n151_ & (x6 | (~x0 & x1))));
  ...
  assign new_n199_ = ~new_n123_ & (x0 | ~x2 | ~x4);
