...
module FAU ( 
  ...
  assign z43 = (~new_n140_ & x4) | new_n141_ | new_n142_ | (~new_n143_ & ~x4);
  assign new_n140_ = (x0 | (~x2 ^ x3)) & (~x1 | (~x3 & (x2 | x3))) & (~x0 | ~x2);
  assign new_n141_ = x1 & ((~x2 & ~x5) | (x0 & x3 & x7));
  assign new_n142_ = x0 & ((x2 & ~x5 & ~x6) | (~x4 & x6 & ~x7));
  ...
  assign z49 = new_n166_ | ~new_n167_ | (~x3 & (new_n153_ | new_n122_));
  ...
  assign z52 = new_n177_ | ~new_n175_ | (x3 & (new_n174_ | new_n176_ | new_n122_));
