...
module FAU ( 
  ...
  assign z20 = ~x6 & ~x5 & new_n91_ & ~x3 & ~x4;
  assign z21 = ~x6 & ~x5 & ~x4 & new_n91_ & x3;
  assign z22 = x7 & x6 & new_n91_ & ~x4 & ~x5;
  ...
  assign new_n144_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n145_ | ~x3) & (x0 | ~x1);
  assign new_n145_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  ...
  assign z43 = (~new_n155_ & x4) | new_n129_ | new_n154_ | (~new_n156_ & ~x4);
  assign new_n154_ = x0 & ((new_n127_ & ~x4) | (new_n74_ & x2));
  ...
  assign new_n163_ = (new_n165_ | x4) & (~x0 | (~new_n164_ & (~new_n74_ | x4)));
  ...
  assign new_n173_ = (x1 | ((~x2 | ~x3) & (~new_n159_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  assign new_n174_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n175_;
  assign new_n175_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z51 = (~new_n177_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n177_ = x5 ? new_n178_ : new_n179_;
  assign new_n178_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n179_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z54 = (~new_n181_ & ~x0) | new_n182_ | ~new_n184_;
  assign new_n181_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n143_ | ~x5))));
  assign new_n182_ = ~x1 & ((~new_n183_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n183_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n184_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n164_ & ~x4));
  ...
  assign z57 = (x0 & (~new_n190_ | ~x3)) | ~new_n197_ | (~x0 & (~new_n194_ | new_n199_));
  assign new_n190_ = (new_n191_ | x5) & ~new_n192_ & (new_n193_ | ~x5) & (~new_n127_ | x4);
  assign new_n191_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n192_ = x2 & (x4 | (~x1 & x3));
  assign new_n193_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n194_ = ~new_n195_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n196_ & ~x3));
  assign new_n195_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n196_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n197_ = (x1 | x2 | x3) & (new_n198_ | x4);
  assign new_n198_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n199_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  ...
  assign z62 = ~new_n205_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n205_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z04 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
  assign z16 = 1'b0;
