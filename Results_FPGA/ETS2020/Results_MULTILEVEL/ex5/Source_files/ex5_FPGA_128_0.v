...
module FAU ( 
  ...
  wire new_n75_, new_n80_, new_n82_, new_n85_, new_n87_, new_n88_, new_n91_,
    ...
    new_n250_, new_n252_, new_n253_, new_n255_;
  assign z00 = ~x4 & ~x5 & ~x6;
  ...
  assign z43 = (~new_n151_ & x4) | new_n140_ | new_n149_ | (~new_n152_ & ~x4);
  assign new_n149_ = x0 & (new_n150_ | (new_n75_ & x2));
  ...
  assign new_n156_ = (~x0 | (~x4 & (~new_n75_ | ~x2))) & ~new_n157_ & (x0 | ((~new_n75_ | x4) & (~x2 | x3 | ~x4)));
  ...
  assign new_n161_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n138_ | x4 | x5)))));
  assign new_n162_ = new_n163_ & (~x0 | (x3 & (~new_n160_ | x1 | ~x3 | x4)));
  assign new_n163_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n164_ = ~new_n166_ & ((~z00 & ~new_n165_) | ~x0);
  ...
  assign new_n169_ = ~x5 & (~new_n138_ | x5 | ~new_n170_ | ~x1);
  ...
  assign new_n189_ = (x1 | ((~x2 | ~x3) & (~new_n160_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n193_ = x5 ? new_n194_ : (~x6 & (~new_n88_ | x2 | ~x3 | x6));
  ...
  assign new_n201_ = ~x6 & (x2 | (x3 & (~new_n88_ | ~x3 | x6)));
  ...
  assign new_n205_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n143_ | ~x5))));
  ...
  assign new_n210_ = ~new_n211_ & (~x0 | (x2 ? (~new_n75_ & ~x4) : x3));
  ...
  assign new_n235_ = x5 & ((~x4 & x7) | (new_n88_ & ~x2 & x4));
  ...
  assign new_n253_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n255_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n255_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z15 = 1'b0;
