// Benchmark "FAU" written by ABC on Thu Aug  6 04:05:37 2020
...
module FAU ( 
  ...
  assign new_n152_ = (x1 | ((~x2 | ~x3) & (~new_n143_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n164_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n148_ & ~x4));
