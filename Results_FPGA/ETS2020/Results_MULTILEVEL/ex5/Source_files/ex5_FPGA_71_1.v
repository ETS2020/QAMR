...
module FAU ( 
  ...
  assign new_n140_ = ~x6 & ((x5 & ~x7) | (new_n86_ & ~x2 & ~x5));
  ...
  assign z45 = ((new_n145_ | ~new_n147_) & ~x2) | new_n152_ | ~new_n150_ | (~new_n148_ & x2);
  assign new_n145_ = x0 & (~x3 | (new_n146_ & ~x1 & ~x4));
  assign new_n146_ = ~x5 & x6 & x7;
  assign new_n147_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n130_ | x4 | x5)))));
  assign new_n148_ = new_n149_ & (~x0 | (x3 & (~new_n146_ | x1 | ~x3 | x4)));
  assign new_n149_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n150_ = ~new_n151_ & (~x0 | (~z00 & (~x1 | ~x3 | ~x7)));
  ...
  assign new_n154_ = ~x5 & (~new_n155_ | ~x1 | ~new_n130_ | x5);
  ...
  assign z49 = (x0 & (x4 | (new_n75_ & ~x4))) | new_n170_ | (~new_n171_ & ~x0) | (~new_n172_ & ~x4);
  assign new_n170_ = ~x3 & (new_n157_ | new_n124_);
  assign new_n171_ = (x1 | x2 | (x5 & (~x3 | ~x5))) & ~x1 & (~x2 | ~x3 | ~x4);
  assign new_n172_ = (~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)));
  assign z51 = (~new_n174_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n174_ = x5 ? new_n175_ : (~x6 & (~new_n86_ | x2 | ~x3 | x6));
  assign new_n175_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n180_ | ~new_n178_ | (x3 & (new_n177_ | new_n179_ | new_n124_));
  ...
  assign new_n182_ = ~x6 & (x2 | (x3 & (~new_n86_ | ~x3 | x6)));
  ...
  assign new_n200_ = ~new_n124_ & (x0 | ~x2 | ~x4);
