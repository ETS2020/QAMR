...
module FAU ( 
  ...
  assign new_n123_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x1 | x4 | x5 | x6);
  assign z38 = new_n107_ | new_n110_ | new_n111_ | new_n125_;
  assign new_n125_ = ~x2 & ((x1 & ~x5) | (x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3))));
  assign z39 = new_n132_ | ~new_n129_ | (~new_n127_ & ~x5);
  assign new_n127_ = (x0 | x1 | x2) & (x4 | (x0 ? (x6 & (~new_n128_ | x1 | ~x2)) : (x6 & (~x2 | ~x6))));
  assign new_n128_ = x3 & x6 & x7;
  assign new_n129_ = (~x2 | (x0 ? x3 : (~x3 | ~x4))) & (~x0 | (~x4 & (~new_n130_ | x4))) & (~new_n131_ | x4) & (x0 | ~x4 | (x3 & (x2 | ~x3)));
  assign new_n130_ = x6 & ~x7;
  assign new_n131_ = x5 & (x7 | (~x7 & (x6 | (~x3 & ~x6))));
  assign new_n132_ = x1 & ((~x2 & ~x5) | (x0 & x3 & x7));
  assign z40 = new_n134_ | new_n136_ | new_n140_ | new_n141_ | new_n142_ | new_n143_;
  assign new_n134_ = ~x3 & ((~x0 & ~x1 & x2) | new_n135_ | (x1 & ~x2 & x4));
  assign new_n135_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n136_ = ~x5 & (new_n137_ | new_n139_ | (~new_n138_ & x0));
  assign new_n137_ = x1 & (~x2 | (x2 & x3 & ~x4 & x6));
  assign new_n138_ = (~x2 | (x6 & (x4 | ~x6 | ~x7 | x1 | ~x3))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n139_ = ~x4 & ((~x0 & ~x6) | (x3 & x6 & ~x7));
  assign new_n140_ = x0 & (x4 ? x2 : new_n130_);
  assign new_n141_ = x1 & (~x0 | (x3 & x4));
  assign new_n142_ = ~x0 & ((~x4 & x7) | (~x2 & x3 & x4));
  assign new_n143_ = ~x4 & x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  ...
  assign z43 = (~new_n150_ & x4) | new_n132_ | new_n151_ | (~new_n152_ & ~x4);
  assign new_n150_ = (x0 | (~x2 ^ x3)) & (~x1 | (~x3 & (x2 | x3))) & (~x0 | ~x2);
  assign new_n151_ = x0 & ((~x4 & x6 & ~x7) | (x2 & ~x5 & ~x6));
  assign new_n152_ = (~x5 | (~x7 & (~x6 | x7))) & (x0 | ~x7) & (x5 | ((~x3 | ~x6 | x7) & (x0 | (x6 & (~x2 | ~x6)))));
  assign z45 = ((new_n154_ | ~new_n156_) & ~x2) | new_n162_ | ~new_n159_ | (~new_n157_ & x2);
  assign new_n154_ = x0 & (~x3 | (new_n155_ & ~x1 & ~x4));
  assign new_n155_ = ~x5 & x6 & x7;
  assign new_n156_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n130_ | x4 | x5)))));
  assign new_n157_ = new_n158_ & (~x0 | (x3 & (~new_n155_ | x1 | ~x3 | x4)));
  assign new_n158_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n159_ = (new_n161_ | x4) & ((~z00 & ~new_n160_) | ~x0);
  assign new_n160_ = x1 & x3 & x7;
  assign new_n161_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  ...
  assign new_n169_ = (x1 | ((~x2 | ~x3) & (~new_n155_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n175_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (x3 | ~x4 | ~x1 | x2);
  assign z54 = (~new_n177_ & ~x0) | new_n179_ | ~new_n181_;
  assign new_n177_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n178_ | ~x5))));
  assign new_n178_ = x6 & x7;
  assign new_n179_ = ~x1 & ((~new_n180_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n180_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n181_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n160_ & ~x4));
  assign z57 = (x0 & (~new_n183_ | ~x3)) | ~new_n190_ | (~x0 & (~new_n187_ | new_n192_));
  assign new_n183_ = (new_n184_ | x5) & ~new_n185_ & (new_n186_ | ~x5) & (~new_n130_ | x4);
