...
module FAU ( 
  ...
  assign z44 = new_n161_ | ~new_n159_ | (x3 & (x4 ? ~x0 : new_n158_));
  assign new_n158_ = ~x6 & ((x5 & ~x7) | (new_n85_ & ~x2 & ~x5));
  assign new_n159_ = (~x0 | (~x4 & (~new_n153_ | ~x2))) & ~new_n160_ & (x0 | ((~new_n153_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n160_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign new_n161_ = x1 & (~x0 | (~x2 & ~x5));
  ...
  assign new_n200_ = ~new_n160_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n232_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
  ...
  assign new_n245_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
  assign z08 = 1'b0;
