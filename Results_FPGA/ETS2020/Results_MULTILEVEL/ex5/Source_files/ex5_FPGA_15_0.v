...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n79_, new_n81_, new_n84_, new_n86_, new_n87_, new_n96_,
    ...
    new_n234_, new_n235_, new_n237_, new_n238_, new_n240_;
  assign z00 = ~x4 & ~x5 & ~x6;
  ...
  assign z45 = (~x2 & (new_n156_ | ~new_n157_)) | new_n162_ | ~new_n160_ | (~new_n158_ & x2);
  assign new_n156_ = x0 & (~x3 | (new_n140_ & ~x1 & ~x4));
  assign new_n157_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n135_ | x4 | x5)))));
  assign new_n158_ = new_n159_ & (~x0 | (x3 & (~new_n140_ | x1 | ~x3 | x4)));
  ...
  assign new_n164_ = ~x5 & (~new_n135_ | x5 | ~new_n165_ | ~x1);
  ...
  assign z49 = ~new_n181_ | (~new_n180_ & ~x3) | (x0 & (x4 | (new_n75_ & ~x4)));
  ...
  assign new_n184_ = (x1 | ((~x2 | ~x3) & (~new_n140_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n188_ = x5 ? new_n189_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  ...
  assign new_n196_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign new_n200_ = ~new_n201_ & (~x0 | (x2 ? (~new_n75_ & ~x4) : x3));
  ...
  assign z59 = ~new_n230_ | new_n220_ | new_n231_ | new_n221_ | new_n224_ | new_n228_;
  assign new_n220_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
  assign new_n221_ = x3 & (~new_n223_ | (~new_n222_ & ~x5));
  assign new_n222_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n223_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n224_ = ~x3 & ((~new_n225_ & ~x0) | new_n226_ | (~new_n227_ & x0));
  assign new_n225_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n226_ = ~x2 & (x0 | (x1 & x4));
  assign new_n227_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n228_ = ~new_n229_ & ~x5;
  assign new_n229_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n230_ = (x0 | ~x2 | ~x4) & (x4 | ~x5 | x6 | x7);
  assign new_n231_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n234_ | ~new_n235_ | (~x4 & (~x5 | (~new_n233_ & x5)));
  assign new_n233_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n234_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n235_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n238_ | (~x4 & ((~new_n237_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n237_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n238_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n240_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n240_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
