...
module FAU ( 
  ...
  wire new_n78_, new_n80_, new_n83_, new_n85_, new_n86_, new_n89_, new_n98_,
    ...
    new_n235_, new_n236_, new_n238_, new_n239_, new_n241_;
  assign z00 = ~x4 & ~x5 & ~x6;
  ...
  assign z43 = (~new_n147_ & x4) | new_n148_ | new_n144_ | (~new_n149_ & ~x4);
  ...
  assign new_n153_ = (~x0 | (~x4 & (~new_n145_ | ~x2))) & ~new_n154_ & (x0 | ((~new_n145_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n154_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign z45 = ((new_n156_ | ~new_n157_) & ~x2) | new_n163_ | ~new_n161_ | (~new_n159_ & x2);
  assign new_n156_ = x0 & (~x3 | (new_n133_ & ~x1 & ~x4));
  assign new_n157_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n158_ | x4 | x5)))));
  assign new_n158_ = x6 & ~x7;
  assign new_n159_ = new_n160_ & (~x0 | (x3 & (~new_n133_ | x1 | ~x3 | x4)));
  ...
  assign new_n165_ = ~x5 & (~new_n158_ | x5 | ~new_n166_ | ~x1);
  ...
  assign z49 = ~new_n182_ | (~new_n181_ & ~x3) | (x0 & (x4 | (new_n145_ & ~x4)));
  ...
  assign new_n185_ = (x1 | ((~x2 | ~x3) & (~new_n133_ | x2 | x4))) & x3 & ~x4 & (~new_n145_ | x4);
  ...
  assign new_n194_ = ~new_n154_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n201_ = ~new_n202_ & (~x0 | (x2 ? (~new_n145_ & ~x4) : x3));
  ...
  assign new_n210_ = x3 & (new_n211_ | x5) & ~new_n212_ & ~new_n146_ & (new_n213_ | ~x5);
  ...
  assign z59 = ~new_n231_ | new_n221_ | new_n232_ | new_n222_ | new_n225_ | new_n229_;
  assign new_n221_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
  assign new_n222_ = x3 & (~new_n224_ | (~new_n223_ & ~x5));
  assign new_n223_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n224_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n225_ = ~x3 & ((~new_n226_ & ~x0) | new_n227_ | (~new_n228_ & x0));
  assign new_n226_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n227_ = ~x2 & (x0 | (x1 & x4));
  assign new_n228_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n229_ = ~new_n230_ & ~x5;
  assign new_n230_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n231_ = (x0 | ~x2 | ~x4) & (x4 | ~x5 | x6 | x7);
  assign new_n232_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n235_ | ~new_n236_ | (~x4 & (~x5 | (~new_n234_ & x5)));
  assign new_n234_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n235_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n236_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n239_ | (~x4 & ((~new_n238_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n238_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n239_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n241_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n241_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
