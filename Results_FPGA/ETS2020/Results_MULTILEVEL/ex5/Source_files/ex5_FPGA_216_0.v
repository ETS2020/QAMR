...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n79_, new_n81_, new_n84_, new_n86_, new_n87_, new_n97_,
  ...
  assign z39 = (x1 & (new_n138_ | (~x2 & ~x5))) | ~new_n135_ | (~new_n133_ & ~x5);
  ...
  assign new_n149_ = (~x0 | (~x4 & (~new_n75_ | ~x2))) & ~new_n150_ & (x0 | ((~new_n75_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n150_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  ...
  assign new_n154_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n136_ | x4 | x5)))));
  ...
  assign z46 = new_n166_ | ~new_n167_ | (~x4 & (~new_n164_ | (~new_n162_ & ~x0)));
  assign new_n162_ = ~x5 & (~new_n136_ | x5 | ~new_n163_ | ~x1);
  assign new_n163_ = ~x2 & ~x3;
  assign new_n164_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n165_ | ~x6 | ~x7)))));
  assign new_n165_ = ~x1 & ~x2;
  assign new_n166_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n167_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n171_ | (~x4 & (~new_n169_ | (~new_n170_ & ~x5)));
  assign new_n169_ = (~x0 | ~x6 | (x7 & (~new_n165_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n170_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n171_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  assign z48 = (x1 & (new_n138_ | ~x0)) | ~new_n173_ | new_n176_;
  assign new_n173_ = new_n175_ & (x2 | ((x1 | x3) & (~x0 | (~new_n174_ & x3))));
  assign new_n174_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n175_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n176_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = ~new_n179_ | (~new_n178_ & ~x3) | (x0 & (x4 | (new_n75_ & ~x4)));
  assign new_n178_ = ~new_n165_ & (x6 | x7 | x4 | ~x5);
  assign new_n179_ = ~new_n180_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n180_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z50 = (~new_n182_ & x0) | (~new_n183_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n182_ = (x1 | ((~x2 | ~x3) & (~new_n153_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n191_ = ~new_n150_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n201_ = (~x0 | (~new_n158_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n203_ | (~x4 & (x5 ? ~new_n205_ : (x6 | (~x1 & ~x6))));
  assign new_n203_ = ~new_n204_ & (~x0 | (x2 ? (~new_n75_ & ~x4) : x3));
  ...
  assign new_n207_ = (new_n208_ | ~x6) & (~x5 | x6) & (x5 | (~new_n163_ & (x6 | (~x0 & x1))));
  ...
  assign z57 = (~new_n212_ & x0) | ~new_n220_ | (~x0 & (~new_n217_ | new_n222_));
  assign new_n212_ = x3 & (new_n214_ | x5) & ~new_n215_ & ~new_n213_ & (new_n216_ | ~x5);
  ...
  assign new_n218_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n219_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n220_ = (new_n221_ | x4) & (~new_n163_ | x1);
