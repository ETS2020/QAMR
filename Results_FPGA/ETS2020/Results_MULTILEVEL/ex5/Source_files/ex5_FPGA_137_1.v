// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:13 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n89_, new_n97_, new_n104_, new_n105_, new_n107_, new_n108_,
  ...
  assign new_n170_ = x5 ? new_n171_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  ...
  assign new_n178_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  ...
  assign z54 = new_n183_ | ~new_n185_ | (~new_n182_ & ~x0);
  assign new_n182_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n134_ | ~x5))));
  ...
  assign new_n203_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
