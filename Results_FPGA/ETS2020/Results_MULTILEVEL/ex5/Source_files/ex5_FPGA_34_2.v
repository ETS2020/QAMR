// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:00 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n99_, new_n103_,
    ...
    new_n191_, new_n193_, new_n194_, new_n195_, new_n197_;
  assign z00 = ~x4 & ~x5 & ~x6;
  assign z01 = ~x7 & ~x5 & ~x6;
  ...
  assign new_n117_ = (x5 | (x6 & (~x1 | x3 | ~x6 | x7))) & ~x5 & ~x7;
  ...
  assign z38 = new_n106_ | new_n109_ | new_n110_ | new_n123_;
  ...
  assign z43 = (~new_n150_ & x4) | new_n130_ | new_n148_ | (~new_n151_ & ~x4);
  assign new_n148_ = x0 & (new_n149_ | (x2 & ~x5 & ~x6));
  ...
  assign new_n155_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n128_ | x4 | x5)))));
  assign new_n156_ = new_n157_ & (~x0 | (x3 & (~new_n154_ | x1 | ~x3 | x4)));
  assign new_n157_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n158_ = ~new_n160_ & ((~z00 & ~new_n159_) | ~x0);
  ...
  assign new_n172_ = x5 ? new_n173_ : new_n174_;
  assign new_n173_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n174_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z54 = (~new_n176_ & ~x0) | new_n178_ | ~new_n180_;
  assign new_n176_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n177_ | ~x5))));
  assign new_n177_ = x6 & x7;
  assign new_n178_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n179_ & ~x4));
  assign new_n179_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n180_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n159_ & ~x4));
  assign z57 = (~new_n182_ & x0) | ~new_n189_ | (~x0 & (~new_n186_ | new_n191_));
  assign new_n182_ = x3 & (new_n183_ | x5) & ~new_n184_ & ~new_n149_ & (new_n185_ | ~x5);
  assign new_n183_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n184_ = x2 & (x4 | (~x1 & x3));
  assign new_n185_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n186_ = ~new_n187_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n188_ & ~x3));
  assign new_n187_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n188_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n189_ = (x1 | x2 | x3) & (new_n190_ | x4);
  assign new_n190_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n191_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
