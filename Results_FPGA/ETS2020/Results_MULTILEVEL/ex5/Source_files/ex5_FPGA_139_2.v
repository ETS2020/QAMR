...
module FAU ( 
  ...
  assign z56 = (~new_n171_ & ~x4) | ~new_n175_ | (~new_n174_ & x3);
  assign new_n171_ = (new_n173_ | ~x6) & (~x5 | x6) & (x5 | (~new_n172_ & (x6 | (~x0 & x1))));
  ...
  assign z57 = (x0 & (~new_n177_ | ~x3)) | ~new_n184_ | (~x0 & (~new_n181_ | new_n186_));
  assign new_n177_ = (new_n178_ | x5) & ~new_n179_ & (new_n180_ | ~x5) & (~new_n122_ | x4);
  assign new_n178_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n179_ = x2 & (x4 | (~x1 & x3));
  assign new_n180_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n181_ = ~new_n182_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n183_ & ~x3));
  assign new_n182_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n183_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n184_ = (new_n185_ | x4) & (~new_n172_ | x1);
  assign new_n185_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n186_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
