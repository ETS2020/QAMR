...
module FAU ( 
  ...
  assign new_n168_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z50 = (~new_n170_ & x0) | (~new_n171_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n170_ = (x1 | ((~x2 | ~x3) & (~new_n156_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n171_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n172_;
  assign new_n172_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n174_ & ~x0) | new_n175_ | ~new_n177_;
  assign new_n174_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n140_ | ~x5))));
  assign new_n175_ = ~x1 & ((~new_n176_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n176_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n177_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n161_ & ~x4));
  assign z57 = (x0 & (~new_n179_ | ~x3)) | ~new_n186_ | (~x0 & (~new_n183_ | new_n188_));
  assign new_n179_ = (new_n180_ | x5) & ~new_n181_ & (new_n182_ | ~x5) & (~new_n124_ | x4);
