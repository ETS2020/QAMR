...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n81_, new_n84_, new_n86_, new_n88_, new_n99_, new_n103_,
    ...
    new_n191_, new_n192_, new_n193_, new_n194_, new_n196_;
  assign z00 = ~x4 & ~x5 & ~x6;
  assign z01 = ~x7 & ~x5 & ~x6;
  ...
  assign z40 = new_n129_ | new_n131_ | new_n135_ | new_n136_ | new_n137_ | new_n138_;
  assign new_n129_ = ~x3 & ((~x0 & ~x1 & x2) | new_n130_ | (x1 & ~x2 & x4));
  assign new_n130_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n131_ = ~x5 & (new_n132_ | new_n134_ | (~new_n133_ & x0));
  ...
  assign new_n135_ = x0 & (x4 ? x2 : new_n125_);
  ...
  assign new_n142_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n143_ | ~x3) & (x0 | ~x1);
  assign new_n143_ = (~x1 | x6) & (~x4 | (x0 & ~x1));
  ...
  assign z43 = (~new_n152_ & x4) | new_n127_ | new_n153_ | (~new_n154_ & ~x4);
  assign new_n152_ = (x0 | (~x2 ^ x3)) & (~x1 | (~x3 & (x2 | x3))) & (~x0 | ~x2);
  assign new_n153_ = x0 & ((~x4 & x6 & ~x7) | (x2 & ~x5 & ~x6));
  ...
  assign new_n158_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n125_ | x4 | x5)))));
  assign new_n159_ = new_n160_ & (~x0 | (x3 & (~new_n157_ | x1 | ~x3 | x4)));
  assign new_n160_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n161_ = (new_n163_ | x4) & ((~z00 & ~new_n162_) | ~x0);
  assign new_n162_ = x1 & x3 & x7;
  assign new_n163_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  ...
  assign new_n169_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z50 = (~new_n171_ & x0) | (~new_n172_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n171_ = (x1 | ((~x2 | ~x3) & (~new_n157_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n172_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n173_;
  assign new_n173_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n175_ & ~x0) | new_n176_ | ~new_n178_;
  assign new_n175_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n141_ | ~x5))));
  assign new_n176_ = ~x1 & ((~new_n177_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n177_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n178_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n162_ & ~x4));
  assign z57 = (x0 & (~new_n180_ | ~x3)) | ~new_n187_ | (~x0 & (~new_n184_ | new_n189_));
  assign new_n180_ = (new_n181_ | x5) & ~new_n182_ & (new_n183_ | ~x5) & (~new_n125_ | x4);
  ...
  assign new_n196_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
