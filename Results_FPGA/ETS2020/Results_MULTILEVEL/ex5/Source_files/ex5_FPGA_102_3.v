...
module FAU ( 
  ...
  assign z49 = new_n197_ | ~new_n198_ | (~x3 & (new_n189_ | new_n144_));
  ...
  assign new_n201_ = (x1 | ((~x2 | ~x3) & (~new_n178_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n217_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n156_ | ~x5))));
  assign new_n218_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n219_ & ~x4));
  assign new_n219_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n220_ = (~x0 | (~new_n183_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n226_ = x3 & (new_n227_ | x5) & ~new_n228_ & ~new_n168_ & (new_n229_ | ~x5);
  ...
  assign new_n233_ = (x1 | x2 | x3) & (new_n234_ | x4);
