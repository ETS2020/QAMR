...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    new_n92_, new_n94_, new_n104_, new_n107_, new_n112_, new_n113_,
    ...
    new_n268_, new_n269_, new_n270_, new_n272_, new_n273_;
  ...
  assign z37 = (~new_n129_ & ~x0) | ~new_n131_ | (~x3 & (x2 ? x0 : ~x1));
  assign new_n129_ = (new_n130_ | x4) & (x1 | ~x2 | (x3 & (~x3 | ~x4 | x5))) & (~x4 | (x3 & (x2 | ~x3)));
  assign new_n130_ = (x5 | (x6 & (~x1 | x3 | ~x6 | x7))) & ~x5 & ~x7;
  assign new_n131_ = new_n134_ & (~x0 | (new_n133_ & (new_n132_ | ~x3)));
  assign new_n132_ = (~x1 | (~x7 & (x4 | ~x5))) & (x5 | ~x6 | ~x7 | x1 | ~x2 | x4);
  assign new_n133_ = (~x2 | ~x4) & (x1 | x2 | x5 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n134_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x1 | x4 | x5 | x6);
  assign z38 = new_n115_ | new_n118_ | new_n119_ | new_n136_;
  ...
  assign new_n159_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n160_ | ~x3) & (x0 | ~x1);
  assign new_n160_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  ...
  assign z46 = new_n193_ | ~new_n194_ | (~x4 & (~new_n191_ | (~new_n189_ & ~x0)));
  assign new_n189_ = ~x5 & (~new_n141_ | x5 | ~new_n190_ | ~x1);
  ...
  assign new_n203_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z49 = new_n205_ | ~new_n206_ | (~x3 & (new_n192_ | new_n146_));
  ...
  assign new_n209_ = (x1 | ((~x2 | ~x3) & (~new_n180_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n219_ | ~new_n217_ | (x3 & (new_n216_ | new_n218_ | new_n146_));
  assign new_n216_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n217_ = ~new_n177_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n225_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n158_ | ~x5))));
  assign new_n226_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n227_ & ~x4));
  assign new_n227_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n228_ = (~x0 | (~new_n185_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n234_ = (new_n235_ | ~x6) & (~x5 | x6) & (x5 | (~new_n190_ & (x6 | (~x0 & x1))));
  ...
  assign new_n239_ = x3 & (new_n240_ | x5) & ~new_n241_ & ~new_n170_ & (new_n242_ | ~x5);
  ...
  assign new_n246_ = (new_n247_ | x4) & (~new_n190_ | x1);
  ...
  assign new_n255_ = ~new_n146_ & (x0 | ~x2 | ~x4);
