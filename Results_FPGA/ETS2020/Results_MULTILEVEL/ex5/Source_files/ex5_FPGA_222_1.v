...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n86_, new_n88_,
    new_n90_, new_n96_, new_n103_, new_n104_, new_n106_, new_n107_,
  ...
  assign new_n138_ = ~x6 & ((x5 & ~x7) | (new_n86_ & ~x2 & ~x5));
  ...
  assign new_n189_ = ~new_n122_ & (x0 | ~x2 | ~x4);
  assign new_n190_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
