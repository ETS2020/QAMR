...
module FAU ( 
  ...
  wire new_n78_, new_n80_, new_n83_, new_n85_, new_n86_, new_n94_, new_n96_,
    ...
    new_n246_, new_n248_, new_n249_, new_n251_;
  assign z00 = ~x4 & ~x5 & ~x6;
  ...
  assign z31 = (~x4 & (x5 | (~x5 & (x6 | (~x0 & ~x6))))) | (~new_n100_ & x4) | (~new_n101_ & ~x5);
  assign new_n100_ = (~x0 | (~x2 & (x1 | x2 | x5))) & (~x1 | (~x3 & (x2 | x3))) & (x0 | (x2 ? (x3 & (x1 | ~x3 | x5)) : ~x3));
  ...
  assign z38 = new_n103_ | new_n106_ | new_n107_ | new_n127_;
  ...
  assign new_n157_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  ...
  assign new_n235_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
