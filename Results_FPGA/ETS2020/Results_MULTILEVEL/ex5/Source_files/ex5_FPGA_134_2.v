// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:11 2020
...
module FAU ( 
  ...
  assign new_n122_ = (~x2 | (x0 ? x3 : (~x3 | ~x4))) & (~x0 | (~new_n123_ & ~x4)) & (~new_n124_ | x4) & (x0 | ~x4 | (x3 & (x2 | ~x3)));
  ...
  assign new_n133_ = x0 & (new_n123_ | (x2 & x4));
  ...
  assign z43 = (~new_n144_ & x4) | new_n125_ | new_n143_ | (~new_n145_ & ~x4);
  assign new_n143_ = x0 & (new_n123_ | (x2 & ~x5 & ~x6));
  ...
  assign new_n153_ = (~x2 | ~x3) & (x5 | ~x6 | ~x7 | x2 | x4);
  ...
  assign z57 = (~new_n164_ & x0) | ~new_n171_ | (~x0 & (~new_n168_ | new_n173_));
  assign new_n164_ = x3 & (new_n165_ | x5) & ~new_n166_ & ~new_n123_ & (new_n167_ | ~x5);
  ...
  assign z61 = ~new_n176_ | (~x4 & ((~new_n175_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n175_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n176_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n178_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n178_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
  assign z23 = 1'b0;
