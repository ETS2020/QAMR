...
module FAU ( 
  ...
  assign new_n179_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n144_ | x4 | x5)))));
  ...
  assign new_n187_ = ~x5 & (~new_n144_ | x5 | ~x1 | x2 | x3);
  ...
  assign z49 = new_n202_ | ~new_n203_ | (~x3 & (new_n189_ | new_n149_));
  ...
  assign z52 = new_n217_ | ~new_n214_ | (x3 & (new_n213_ | new_n216_ | new_n149_));
  assign new_n213_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n214_ = (new_n215_ | x4) & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n215_ = (~x5 | (~x7 & (x3 | x6 | x7))) & (~x6 | (x5 & (~x5 | x7)));
  ...
  assign new_n223_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n161_ | ~x5))));
  assign new_n224_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n225_ & ~x4));
  assign new_n225_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n226_ = (~x0 | (~new_n183_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n232_ = x3 & (new_n233_ | x5) & ~new_n234_ & ~new_n173_ & (new_n235_ | ~x5);
  ...
  assign new_n248_ = ~new_n149_ & (x0 | ~x2 | ~x4);
