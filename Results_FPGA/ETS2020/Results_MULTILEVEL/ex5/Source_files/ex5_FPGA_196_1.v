// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:55 2020
...
module FAU ( 
  ...
  assign z46 = new_n149_ | ~new_n150_ | (~x4 & (~new_n146_ | (~new_n148_ & ~x0)));
  assign new_n146_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n147_ | ~x6 | ~x7)))));
  assign new_n147_ = ~x1 & ~x2;
  assign new_n148_ = ~x5 & (~x1 | x2 | x3 | x5 | ~x6 | x7);
  ...
  assign new_n152_ = (~x0 | ~x6 | (x7 & (~new_n147_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  ...
  assign z49 = new_n161_ | ~new_n162_ | (~x3 & (new_n147_ | new_n124_));
  ...
  assign new_n165_ = x5 ? new_n166_ : (~x6 & (~new_n86_ | x2 | ~x3 | x6));
  ...
  assign new_n177_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n135_ | ~x5))));
  ...
  assign new_n193_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
