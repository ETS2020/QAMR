...
module FAU ( 
  ...
  assign z49 = new_n202_ | ~new_n203_ | (~x3 & (new_n198_ | new_n152_));
  ...
  assign new_n206_ = (x1 | ((~x2 | ~x3) & (~new_n186_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n216_ | ~new_n214_ | (x3 & (new_n213_ | new_n215_ | new_n152_));
  assign new_n213_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n214_ = ~new_n183_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n222_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n164_ | ~x5))));
  assign new_n223_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n224_ & ~x4));
  assign new_n224_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n225_ = (~x0 | (~new_n191_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n231_ = (new_n232_ | ~x6) & (~x5 | x6) & (x5 | (~new_n196_ & (x6 | (~x0 & x1))));
  ...
  assign new_n236_ = x3 & (new_n237_ | x5) & ~new_n238_ & ~new_n176_ & (new_n239_ | ~x5);
  ...
  assign new_n243_ = (new_n244_ | x4) & (~new_n196_ | x1);
  ...
  assign new_n252_ = ~new_n152_ & (x0 | ~x2 | ~x4);
