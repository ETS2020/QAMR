...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n86_, new_n87_, new_n89_,
    new_n97_, new_n104_, new_n105_, new_n106_, new_n107_, new_n109_,
  ...
  assign z41 = (~x4 & (~new_n141_ | (~new_n140_ & x0))) | ~new_n138_ | new_n142_;
  assign new_n138_ = (new_n139_ | ~x0) & (x0 | ~x1) & (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6)));
  assign new_n139_ = (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n140_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | x5 | ~x6 | ~x7);
  ...
  assign new_n163_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = new_n170_ | ~new_n171_ | (~x3 & (new_n157_ | new_n128_));
  ...
  assign new_n174_ = x5 ? new_n175_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  assign new_n175_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n180_ | ~new_n178_ | (x3 & (new_n177_ | new_n179_ | new_n128_));
  assign new_n177_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n178_ = ~new_n152_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n179_ = x1 & (x4 | ~x6);
  assign new_n180_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n184_ | (~x4 & (x5 ? ~new_n183_ : ~new_n182_));
  assign new_n182_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign new_n190_ = (new_n191_ | ~x6) & (~x5 | x6) & (x5 | (~new_n155_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n200_ | new_n201_ | new_n211_ | new_n202_ | new_n205_ | new_n209_;
  assign new_n200_ = ~new_n128_ & (x0 | ~x2 | ~x4);
  assign new_n201_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
  ...
  assign z60 = new_n214_ | ~new_n215_ | (~x4 & (~x5 | (~new_n213_ & x5)));
  assign new_n213_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n214_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n215_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n218_ | (~x4 & ((~new_n217_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n217_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n218_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n220_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n220_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
