// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:29 2020
...
module FAU ( 
  ...
  assign z49 = new_n204_ | ~new_n205_ | (~x3 & (new_n196_ | new_n151_));
  ...
  assign new_n208_ = (x1 | ((~x2 | ~x3) & (~new_n185_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n218_ | ~new_n216_ | (x3 & (new_n215_ | new_n217_ | new_n151_));
  assign new_n215_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n216_ = ~new_n182_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n224_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n163_ | ~x5))));
  assign new_n225_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n226_ & ~x4));
  assign new_n226_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n227_ = (~x0 | (~new_n190_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n233_ = x3 & (new_n234_ | x5) & ~new_n235_ & ~new_n175_ & (new_n236_ | ~x5);
  ...
  assign new_n249_ = ~new_n151_ & (x0 | ~x2 | ~x4);
  assign new_n250_ = x5 & ((~x4 & x7) | (new_n91_ & ~x2 & x4));
