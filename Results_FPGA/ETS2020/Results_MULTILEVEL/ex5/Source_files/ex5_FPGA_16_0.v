...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n77_, new_n79_, new_n82_, new_n84_, new_n85_, new_n93_, new_n97_,
  ...
  assign z31 = (~x4 & (x5 | (~x5 & (x6 | (~x0 & ~x6))))) | new_n97_ | (~new_n98_ & ~x5);
  assign new_n97_ = x4 & ((x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (x3 | (~x2 & ~x3))) | (~x0 & (x2 ? (~x3 | (~x1 & x3 & ~x5)) : x3)));
  assign new_n98_ = (x2 | (~x1 & (x0 | x1))) & (~x0 | ~x2 | x6);
  assign z32 = new_n100_ | new_n102_ | new_n103_ | new_n104_;
  assign new_n100_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | (~new_n101_ & ~x5) | (~x7 & (x6 ? (x0 | x5) : x5)) | (x5 & x7));
  assign new_n101_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n102_ = ~x2 & ((x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3) | (x0 & ~x1 & ~x5))) | (x1 & ~x5));
  assign new_n103_ = x2 & (x0 ? (~x3 | (~x1 & x3)) : (~x1 & ~x3));
  assign new_n104_ = x1 & (~x0 | (x3 & (x4 | ~x6)));
  ...
  assign z35 = new_n97_ | (~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7)))));
  ...
  assign z38 = new_n100_ | new_n103_ | new_n104_ | new_n125_;
  ...
  assign new_n134_ = (~x1 | ~x3 | ~x5) & (~new_n135_ | x1 | x2);
  ...
  assign z43 = (~new_n149_ & x4) | new_n132_ | new_n146_ | (~new_n150_ & ~x4);
  ...
  assign new_n157_ = x0 & (~x3 | (new_n135_ & ~x1 & ~x4));
  assign new_n158_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n130_ | x4 | x5)))));
  assign new_n159_ = new_n160_ & (~x0 | (x3 & (~new_n135_ | x1 | ~x3 | x4)));
  ...
  assign new_n165_ = ~x5 & (~new_n130_ | x5 | ~new_n166_ | ~x1);
  ...
  assign new_n185_ = (x1 | ((~x2 | ~x3) & (~new_n135_ | x2 | x4))) & x3 & ~x4 & (~new_n147_ | x4);
  ...
  assign new_n189_ = x5 ? new_n190_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  ...
  assign new_n197_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  ...
  assign new_n226_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
