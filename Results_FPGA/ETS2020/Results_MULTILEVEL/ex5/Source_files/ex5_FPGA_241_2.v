...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n90_, new_n101_,
    ...
    new_n184_, new_n186_, new_n187_, new_n188_, new_n190_;
  assign z00 = ~x4 & ~x5 & ~x6;
  assign z01 = ~x7 & ~x5 & ~x6;
  ...
  assign z38 = new_n108_ | new_n111_ | new_n112_ | new_n115_;
  ...
  assign new_n137_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n138_ | ~x3) & (x0 | ~x1);
  assign new_n138_ = (~x1 | x6) & (~x4 | (x0 & ~x1));
  ...
  assign z43 = (~new_n147_ & x4) | new_n122_ | new_n148_ | (~new_n149_ & ~x4);
  ...
  assign new_n153_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n120_ | x4 | x5)))));
  assign new_n154_ = new_n155_ & (~x0 | (x3 & (~new_n152_ | x1 | ~x3 | x4)));
  assign new_n155_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n156_ = (new_n158_ | x4) & ((~z00 & ~new_n157_) | ~x0);
  assign new_n157_ = x1 & x3 & x7;
  assign new_n158_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  assign new_n159_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z50 = (~new_n161_ & x0) | (~new_n162_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n161_ = (x1 | ((~x2 | ~x3) & (~new_n152_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n162_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n163_;
  assign new_n163_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n165_ & ~x0) | new_n166_ | ~new_n168_;
  assign new_n165_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n136_ | ~x5))));
  assign new_n166_ = ~x1 & ((~new_n167_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n167_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n168_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n157_ & ~x4));
  assign z57 = (x0 & (~new_n170_ | ~x3)) | ~new_n177_ | (~x0 & (~new_n174_ | new_n179_));
  assign new_n170_ = (new_n171_ | x5) & ~new_n172_ & (new_n173_ | ~x5) & (~new_n120_ | x4);
  ...
  assign new_n190_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z05 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
