...
module FAU ( 
  ...
  wire new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n99_, new_n103_,
    ...
    new_n176_, new_n178_, new_n179_, new_n180_, new_n182_;
  assign z00 = ~x4 & ~x5 & ~x6;
  assign z01 = ~x7 & ~x5 & ~x6;
  ...
  assign new_n167_ = (new_n168_ | x5) & ~new_n169_ & (new_n170_ | ~x5) & (~new_n118_ | x4);
  ...
  assign z60 = new_n179_ | ~new_n180_ | (~x4 & (~x5 | (~new_n178_ & x5)));
  assign new_n178_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n179_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n180_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
