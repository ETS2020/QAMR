...
module FAU ( 
  ...
  assign new_n219_ = x5 ? new_n220_ : (~x6 & (~new_n91_ | x2 | ~x3 | x6));
  ...
  assign new_n227_ = ~x6 & (x2 | (x3 & (~new_n91_ | ~x3 | x6)));
  ...
  assign new_n262_ = x5 & ((~x4 & x7) | (new_n91_ & ~x2 & x4));
