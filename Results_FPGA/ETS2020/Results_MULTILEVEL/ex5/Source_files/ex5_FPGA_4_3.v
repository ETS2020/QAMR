...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    new_n92_, new_n94_, new_n96_, new_n107_, new_n110_, new_n115_,
  ...
  assign z49 = new_n208_ | ~new_n209_ | (~x3 & (new_n199_ | new_n153_));
  ...
  assign new_n212_ = (x1 | ((~x2 | ~x3) & (~new_n187_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n222_ | ~new_n220_ | (x3 & (new_n219_ | new_n221_ | new_n153_));
  ...
  assign new_n228_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n165_ | ~x5))));
  assign new_n229_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n230_ & ~x4));
  assign new_n230_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n231_ = (~x0 | (~new_n192_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n237_ = (new_n238_ | ~x6) & (~x5 | x6) & (x5 | (~new_n197_ & (x6 | (~x0 & x1))));
  ...
  assign new_n242_ = x3 & (new_n243_ | x5) & ~new_n244_ & ~new_n177_ & (new_n245_ | ~x5);
  ...
  assign new_n249_ = (new_n250_ | x4) & (~new_n197_ | x1);
  ...
  assign new_n258_ = ~new_n153_ & (x0 | ~x2 | ~x4);
