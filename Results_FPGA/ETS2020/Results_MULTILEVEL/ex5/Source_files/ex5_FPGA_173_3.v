...
module FAU ( 
  ...
  assign z43 = (~new_n168_ & x4) | new_n147_ | new_n166_ | (~new_n169_ & ~x4);
  ...
  assign new_n178_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n145_ | x4 | x5)))));
  ...
  assign new_n186_ = ~x5 & (~new_n145_ | x5 | ~new_n187_ | ~x1);
  ...
  assign z49 = new_n197_ | ~new_n198_ | (~x3 & (new_n189_ | new_n150_));
  ...
  assign z52 = new_n211_ | ~new_n209_ | (x3 & (new_n208_ | new_n210_ | new_n150_));
  assign new_n208_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n209_ = ~new_n174_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n210_ = x1 & (x4 | ~x6);
  ...
  assign z54 = (~new_n217_ & ~x0) | new_n219_ | ~new_n221_;
  assign new_n217_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n218_ | ~x5))));
  assign new_n218_ = x6 & x7;
  assign new_n219_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n220_ & ~x4));
  assign new_n220_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n221_ = (~x0 | (~new_n182_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n227_ = (new_n228_ | ~x6) & (~x5 | x6) & (x5 | (~new_n187_ & (x6 | (~x0 & x1))));
  ...
  assign new_n232_ = x3 & (new_n233_ | x5) & ~new_n234_ & ~new_n167_ & (new_n235_ | ~x5);
  ...
  assign new_n239_ = (new_n240_ | x4) & (~new_n187_ | x1);
  ...
  assign z62 = ~new_n268_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n268_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z00 = 1'b0;
  assign z04 = 1'b0;
  assign z13 = 1'b0;
  assign z23 = 1'b0;
