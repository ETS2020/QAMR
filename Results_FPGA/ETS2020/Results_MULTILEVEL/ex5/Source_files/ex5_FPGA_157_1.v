...
module FAU ( 
  ...
  assign z35 = x4 ? ~new_n107_ : ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7))));
  assign new_n107_ = (~x0 | (~x2 & (x1 | x2 | x5))) & (~x1 | (~x3 & (x2 | x3))) & (x0 | (x2 ? (x3 & (x1 | ~x3 | x5)) : ~x3));
  ...
  assign z49 = new_n158_ | ~new_n159_ | (~x3 & (new_n150_ | new_n121_));
  ...
  assign new_n167_ = ~new_n145_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n179_ = (new_n180_ | ~x6) & (~x5 | x6) & (x5 | (~new_n148_ & (x6 | (~x0 & x1))));
