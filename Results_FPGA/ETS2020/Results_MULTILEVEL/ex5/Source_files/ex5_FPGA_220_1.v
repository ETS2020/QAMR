// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:12 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n89_,
    ...
    new_n188_, new_n190_, new_n191_, new_n192_, new_n194_;
  ...
  assign z46 = new_n139_ | ~new_n140_ | (~x4 & (~new_n136_ | (~new_n138_ & ~x0)));
  assign new_n136_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n137_ | ~x6 | ~x7)))));
  assign new_n137_ = ~x1 & ~x2;
  assign new_n138_ = ~x5 & (~x1 | x2 | x3 | x5 | ~x6 | x7);
  ...
  assign new_n142_ = (~x0 | ~x6 | (x7 & (~new_n137_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  ...
  assign z49 = new_n151_ | ~new_n152_ | (~x3 & (new_n137_ | new_n121_));
  ...
  assign z58 = ~new_n175_ | (~new_n172_ & ~x4);
  assign new_n172_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n173_ | x5) & (~x5 | (x6 & (new_n174_ | ~x6)));
  assign new_n173_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n174_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n175_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n177_ | new_n187_ | new_n188_ | new_n178_ | new_n181_ | new_n185_;
  assign new_n177_ = ~new_n121_ & (x0 | ~x2 | ~x4);
  assign new_n178_ = x3 & (~new_n180_ | (~new_n179_ & ~x5));
  assign new_n179_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n180_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n181_ = ~x3 & ((~new_n182_ & ~x0) | new_n183_ | (~new_n184_ & x0));
  assign new_n182_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n183_ = ~x2 & (x0 | (x1 & x4));
  assign new_n184_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n185_ = ~new_n186_ & ~x5;
  assign new_n186_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n187_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
  assign new_n188_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  ...
  assign new_n194_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z02 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
