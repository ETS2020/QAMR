...
module FAU ( 
  ...
  assign new_n123_ = (~x1 | (~x7 & (x4 | ~x5))) & (x1 | ~x2 | x4 | x5 | ~x6 | ~x7);
  assign new_n124_ = (~x2 | ~x4) & (x1 | x2 | x5 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n125_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x1 | x4 | x5 | x6);
  assign z38 = new_n109_ | new_n112_ | new_n113_ | new_n127_;
  ...
  assign z40 = new_n136_ | new_n138_ | new_n142_ | new_n143_ | new_n144_ | new_n145_;
  assign new_n136_ = ~x3 & ((~x0 & ~x1 & x2) | new_n137_ | (x1 & ~x2 & x4));
  assign new_n137_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n138_ = ~x5 & (new_n139_ | new_n141_ | (~new_n140_ & x0));
  assign new_n139_ = x1 & (~x2 | (x2 & x3 & ~x4 & x6));
  assign new_n140_ = (~x2 | (x6 & (x4 | ~x6 | ~x7 | x1 | ~x3))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n141_ = ~x4 & ((~x0 & ~x6) | (x3 & x6 & ~x7));
  assign new_n142_ = x0 & (x4 ? x2 : new_n132_);
  assign new_n143_ = x1 & (~x0 | (x3 & x4));
  assign new_n144_ = ~x0 & ((~x4 & x7) | (~x2 & x3 & x4));
  assign new_n145_ = ~x4 & x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  ...
  assign z43 = (~new_n152_ & x4) | new_n134_ | new_n153_ | (~new_n154_ & ~x4);
  ...
  assign new_n158_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n132_ | x4 | x5)))));
  ...
  assign new_n166_ = (x1 | ((~x2 | ~x3) & (~new_n157_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n174_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n162_ & ~x4));
  assign z56 = (~new_n176_ & ~x4) | ~new_n180_ | (~new_n179_ & x3);
  assign new_n176_ = (new_n178_ | ~x6) & (~x5 | x6) & (x5 | (~new_n177_ & (x6 | (~x0 & x1))));
  ...
  assign new_n182_ = (new_n183_ | x5) & ~new_n184_ & (new_n185_ | ~x5) & (~new_n132_ | x4);
  ...
  assign new_n189_ = (new_n190_ | x4) & (~new_n177_ | x1);
  ...
  assign new_n194_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n196_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n196_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
  assign z24 = 1'b0;
