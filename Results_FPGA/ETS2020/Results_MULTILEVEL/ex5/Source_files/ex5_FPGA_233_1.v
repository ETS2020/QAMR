...
module FAU ( 
  ...
  assign z49 = new_n155_ | ~new_n156_ | (~x3 & (new_n147_ | new_n123_));
  ...
  assign z52 = new_n166_ | ~new_n164_ | (x3 & (new_n163_ | new_n165_ | new_n123_));
  assign new_n163_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n164_ = ~new_n142_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n176_ = (new_n177_ | ~x6) & (~x5 | x6) & (x5 | (~new_n145_ & (x6 | (~x0 & x1))));
  ...
  assign new_n186_ = ~new_n123_ & (x0 | ~x2 | ~x4);
