// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:06 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n89_, new_n95_, new_n102_, new_n103_, new_n105_, new_n106_,
    ...
    new_n201_, new_n203_, new_n204_, new_n205_, new_n207_;
  ...
  assign z21 = ~x5 & ~x4 & new_n85_ & ~x2 & x3 & ~x6;
  ...
  assign z46 = new_n151_ | ~new_n152_ | (~x4 & (~new_n148_ | (~new_n150_ & ~x0)));
  assign new_n148_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n149_ | ~x6 | ~x7)))));
  assign new_n149_ = ~x1 & ~x2;
  assign new_n150_ = ~x5 & (~x1 | x2 | x3 | x5 | ~x6 | x7);
  ...
  assign new_n154_ = (~x0 | ~x6 | (x7 & (~new_n149_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  ...
  assign z49 = new_n163_ | ~new_n164_ | (~x3 & (new_n149_ | new_n121_));
  ...
  assign new_n167_ = x5 ? new_n168_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  assign new_n168_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n173_ | ~new_n171_ | (x3 & (new_n170_ | new_n172_ | new_n121_));
  assign new_n170_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n171_ = ~new_n146_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign z58 = ~new_n188_ | (~new_n185_ & ~x4);
  assign new_n185_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n186_ | x5) & (~x5 | (x6 & (new_n187_ | ~x6)));
  assign new_n186_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n187_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n188_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n190_ | new_n191_ | new_n201_ | new_n192_ | new_n195_ | new_n199_;
  assign new_n190_ = ~new_n121_ & (x0 | ~x2 | ~x4);
  assign new_n191_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
  assign new_n192_ = x3 & (~new_n194_ | (~new_n193_ & ~x5));
  assign new_n193_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n194_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n195_ = ~x3 & ((~new_n196_ & ~x0) | new_n197_ | (~new_n198_ & x0));
  assign new_n196_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n197_ = ~x2 & (x0 | (x1 & x4));
  assign new_n198_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n199_ = ~new_n200_ & ~x5;
  assign new_n200_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n201_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  ...
  assign new_n207_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x0 | x1 | ~x2) & (~x1 | x6))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
