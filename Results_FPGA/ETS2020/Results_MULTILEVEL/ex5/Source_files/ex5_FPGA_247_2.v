...
module FAU ( 
  ...
  assign new_n155_ = (new_n157_ | x4) & (~x0 | (~new_n156_ & (x4 | x5 | x6)));
  ...
  assign z50 = (~new_n165_ & x0) | (~new_n167_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n165_ = (new_n166_ | x1) & x3 & ~x4 & (x4 | x5 | x6);
  assign new_n166_ = (~x2 | ~x3) & (x2 | x4 | x5 | ~x6 | ~x7);
