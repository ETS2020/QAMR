// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:32 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n93_,
  ...
  assign new_n143_ = x3 & (x4 ? ~x0 : (~new_n144_ & ~x6));
  assign new_n144_ = (~x5 | x7) & (~x0 | x1 | x2 | x5);
  ...
  assign z52 = new_n171_ | ~new_n169_ | (x3 & (new_n168_ | new_n170_ | new_n121_));
  assign new_n168_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n169_ = ~new_n146_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n177_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n132_ | ~x5))));
  ...
  assign new_n187_ = (new_n188_ | ~x6) & (~x5 | x6) & (x5 | (~new_n149_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n197_ | new_n207_ | new_n208_ | new_n198_ | new_n201_ | new_n205_;
  assign new_n197_ = ~new_n121_ & (x0 | ~x2 | ~x4);
  assign new_n198_ = x3 & (~new_n200_ | (~new_n199_ & ~x5));
  assign new_n199_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n200_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n201_ = ~x3 & ((~new_n202_ & ~x0) | new_n203_ | (~new_n204_ & x0));
  assign new_n202_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n203_ = ~x2 & (x0 | (x1 & x4));
  assign new_n204_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n205_ = ~new_n206_ & ~x5;
  assign new_n206_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n207_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
