...
module FAU ( 
  ...
  wire new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n90_, new_n92_,
    new_n94_, new_n104_, new_n107_, new_n108_, new_n110_, new_n111_,
  ...
  assign z31 = (~x4 & (x5 | (~x5 & (x6 | (~x0 & ~x6))))) | new_n107_ | (~new_n108_ & ~x5);
  assign new_n107_ = x4 & ((x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (x3 | (~x2 & ~x3))) | (~x0 & (x2 ? (~x3 | (~x1 & x3 & ~x5)) : x3)));
  assign new_n108_ = (x2 | (~x1 & (x0 | x1))) & (~x0 | ~x2 | x6);
  assign z32 = new_n110_ | new_n112_ | new_n113_ | new_n114_;
  assign new_n110_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | (~new_n111_ & ~x5) | (~x7 & (x6 ? (x0 | x5) : x5)) | (x5 & x7));
  assign new_n111_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n112_ = ~x2 & ((x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3) | (x0 & ~x1 & ~x5))) | (x1 & ~x5));
  assign new_n113_ = x2 & (x0 ? (~x3 | (~x1 & x3)) : (~x1 & ~x3));
  assign new_n114_ = x1 & (~x0 | (x3 & (x4 | ~x6)));
  assign z35 = new_n107_ | (~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7)))));
  assign z38 = new_n110_ | new_n113_ | new_n114_ | new_n117_;
  ...
  assign z43 = (~new_n137_ & x4) | new_n124_ | new_n138_ | (~new_n139_ & ~x4);
  ...
  assign new_n143_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n122_ | x4 | x5)))));
  ...
  assign new_n160_ = x5 ? new_n161_ : (~x6 & (~new_n90_ | x2 | ~x3 | x6));
  assign new_n161_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  ...
  assign new_n165_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n166_ & ~x4));
  assign new_n166_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n167_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n147_ & ~x4));
  ...
  assign new_n175_ = (new_n176_ | x5) & ~new_n177_ & (new_n178_ | ~x5) & (~new_n122_ | x4);
