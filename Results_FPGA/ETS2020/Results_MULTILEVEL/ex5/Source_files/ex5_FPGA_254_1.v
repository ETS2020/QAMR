...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n89_, new_n96_, new_n99_, new_n104_, new_n105_, new_n106_,
    ...
    new_n222_, new_n224_, new_n225_, new_n227_;
  assign z00 = new_n74_ & ~x4;
  assign new_n74_ = ~x5 & ~x6;
  assign z01 = new_n74_ & ~x7;
  assign z02 = ~x7 & ~x6 & ~x3 & ~x4 & x5;
  assign z08 = x7 & new_n78_ & x6;
  ...
  assign z49 = new_n162_ | ~new_n163_ | (~x3 & (new_n149_ | new_n128_));
  ...
  assign new_n166_ = x5 ? new_n167_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  assign new_n167_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n173_ | ~new_n170_ | (x3 & (new_n169_ | new_n172_ | new_n128_));
  assign new_n169_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n170_ = (new_n171_ | x4) & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n171_ = (~x5 | (~x7 & (x3 | x6 | x7))) & (~x6 | (x5 & (~x5 | x7)));
  ...
  assign new_n179_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n140_ | ~x5))));
  ...
  assign z57 = (~new_n194_ & x0) | ~new_n202_ | (~x0 & (~new_n199_ | new_n204_));
  assign new_n194_ = x3 & (new_n196_ | x5) & ~new_n197_ & ~new_n195_ & (new_n198_ | ~x5);
  assign new_n195_ = ~x4 & x6 & ~x7;
  assign new_n196_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n197_ = x2 & (x4 | (~x1 & x3));
  assign new_n198_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x6 | ~x7 | ~x3 | x4)));
  assign new_n199_ = ~new_n200_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n201_ & ~x3));
  assign new_n200_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n201_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n202_ = (new_n203_ | x4) & (~new_n147_ | x1);
  assign new_n203_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n204_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z58 = ~new_n209_ | (~new_n206_ & ~x4);
  assign new_n206_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n207_ | x5) & (~x5 | (x6 & (new_n208_ | ~x6)));
  assign new_n207_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n208_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n209_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n211_ | new_n212_ | new_n222_ | new_n213_ | new_n216_ | new_n220_;
  assign new_n211_ = ~new_n128_ & (x0 | ~x2 | ~x4);
  assign new_n212_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
  assign new_n213_ = x3 & (~new_n215_ | (~new_n214_ & ~x5));
  assign new_n214_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n215_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n216_ = ~x3 & ((~new_n217_ & ~x0) | new_n218_ | (~new_n219_ & x0));
  assign new_n217_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n218_ = ~x2 & (x0 | (x1 & x4));
  assign new_n219_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n220_ = ~new_n221_ & ~x5;
  assign new_n221_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n222_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
