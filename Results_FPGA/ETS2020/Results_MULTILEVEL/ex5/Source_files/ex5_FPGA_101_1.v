...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n86_, new_n88_, new_n94_,
    new_n97_, new_n103_, new_n104_, new_n105_, new_n106_, new_n108_,
    ...
    new_n211_, new_n213_, new_n214_, new_n216_;
  ...
  assign new_n106_ = (~x2 | (x0 ? (x3 & (x1 | ~x3)) : (x1 | x3))) & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  ...
  assign z40 = new_n126_ | ~new_n132_ | new_n135_ | (~new_n128_ & ~x5);
  ...
  assign new_n132_ = (~x1 | (x0 & (~x3 | ~x4))) & (~new_n134_ | x4) & (new_n133_ | x0);
  assign new_n133_ = (x4 | ~x7) & (x2 | ~x3 | ~x4);
  ...
  assign z49 = new_n158_ | ~new_n159_ | (~x3 & (new_n145_ | new_n127_));
  ...
  assign new_n162_ = x5 ? new_n163_ : new_n164_;
  assign new_n163_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n164_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n169_ | ~new_n167_ | (x3 & (new_n166_ | new_n168_ | new_n127_));
  assign new_n166_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n167_ = ~new_n140_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n168_ = x1 & (x4 | ~x6);
  assign new_n169_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n173_ | (~x4 & (x5 ? ~new_n171_ : ~new_n172_));
  assign new_n171_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n172_ = ~x6 & (x2 | (x3 & (~x0 | x1 | ~x3 | x6)));
  assign new_n173_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n177_ | ~new_n179_ | (~new_n175_ & ~x0);
  assign new_n175_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n176_ | ~x5))));
  ...
  assign new_n186_ = (new_n187_ | ~x6) & (~x5 | x6) & (x5 | (~new_n143_ & (x6 | (~x0 & x1))));
  ...
  assign new_n196_ = ~new_n127_ & (x0 | ~x2 | ~x4);
