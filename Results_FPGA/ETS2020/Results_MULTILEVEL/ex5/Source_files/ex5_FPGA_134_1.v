...
module FAU ( 
  ...
  wire new_n75_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
    ...
    new_n215_, new_n217_, new_n218_, new_n219_, new_n221_;
  assign z00 = ~x4 & ~x5 & ~x6;
  ...
  assign z10 = x7 & x6 & x5 & new_n80_ & ~x4;
  ...
  assign z27 = ~x7 & x6 & ~x5 & ~x4 & new_n80_ & ~x3;
  assign z28 = x7 & x6 & ~x5 & ~x4 & new_n84_ & x3;
  assign z29 = x7 & new_n94_ & ~x6;
  assign z30 = x7 & x6 & new_n78_ & ~x5;
  ...
  assign new_n110_ = (~x0 | (x6 & (x1 | x2 | ~x6 | ~x7))) & (x1 | x6) & (x2 | x3) & (~x3 | ~x6 | x7);
  ...
  assign new_n137_ = ~x6 & ((x5 & ~x7) | (new_n85_ & ~x2 & ~x5));
  assign new_n138_ = (~x0 | (~x4 & (~new_n75_ | ~x2))) & ~new_n139_ & (x0 | ((~new_n75_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n139_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign new_n140_ = x1 & (~x0 | (~x2 & ~x5));
  assign z45 = (~new_n142_ & ~x2) | new_n150_ | ~new_n147_ | (x2 & (new_n146_ | ~new_n151_));
  assign new_n142_ = (new_n143_ | ~x0) & ~new_n144_ & (new_n145_ | x0);
  assign new_n143_ = x3 & (x5 | ~x6 | ~x7 | x1 | x4);
  assign new_n144_ = x1 & (~x5 | (~x3 & x4));
  assign new_n145_ = (~x3 | ~x4) & (x1 | x3 | (~x4 & (x4 | x5 | ~x6 | x7)));
  assign new_n146_ = x0 & (~x3 | (~x1 & x3 & ~x4 & new_n131_ & ~x5));
  ...
  assign new_n162_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((~x1 | x3) & (x0 | (~x3 & (x1 | x3))))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = (x0 & (x4 | (new_n75_ & ~x4))) | new_n169_ | (~new_n170_ & ~x0) | (~new_n171_ & ~x4);
  assign new_n169_ = ~x3 & (new_n156_ | new_n120_);
  assign new_n170_ = (x1 | x2 | (x5 & (~x3 | ~x5))) & ~x1 & (~x2 | ~x3 | ~x4);
  assign new_n171_ = (~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)));
  assign z51 = (~new_n173_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n173_ = x5 ? new_n174_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  assign new_n174_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n179_ | ~new_n177_ | (x3 & (new_n176_ | new_n178_ | new_n120_));
  assign new_n176_ = x0 & ~x1 & (x2 | (new_n75_ & ~x2 & ~x4));
  assign new_n177_ = ~new_n139_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n178_ = x1 & (x4 | ~x6);
  assign new_n179_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n183_ | (~x4 & (x5 ? ~new_n182_ : ~new_n181_));
  assign new_n181_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  assign new_n182_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n183_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n186_ | ~new_n188_ | (~new_n185_ & ~x0);
  assign new_n185_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n131_ | ~x5))));
  assign new_n186_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n187_ & ~x4));
  assign new_n187_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n188_ = (~x0 | (~new_n148_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n190_ | (~x4 & (x5 ? ~new_n192_ : (x6 | (~x1 & ~x6))));
  assign new_n190_ = ~new_n191_ & (~x0 | (x2 ? (~new_n75_ & ~x4) : x3));
  ...
  assign new_n194_ = (new_n195_ | ~x6) & (~x5 | x6) & (x5 | (~new_n154_ & (x6 | (~x0 & x1))));
  ...
  assign new_n204_ = ~new_n120_ & (x0 | ~x2 | ~x4);
  assign new_n205_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
