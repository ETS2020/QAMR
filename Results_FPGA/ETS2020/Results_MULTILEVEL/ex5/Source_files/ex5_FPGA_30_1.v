...
module FAU ( 
  ...
  assign z49 = new_n151_ | ~new_n152_ | (~x3 & (new_n142_ | new_n121_));
  ...
  assign new_n155_ = x5 ? new_n156_ : (~x6 & (~new_n86_ | x2 | ~x3 | x6));
  assign new_n156_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n161_ | ~new_n159_ | (x3 & (new_n158_ | new_n160_ | new_n121_));
  assign new_n158_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n159_ = ~new_n139_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n160_ = x1 & (x4 | ~x6);
  assign new_n161_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n165_ | (~x4 & (x5 ? ~new_n164_ : ~new_n163_));
  assign new_n163_ = ~x6 & (x2 | (x3 & (~new_n86_ | ~x3 | x6)));
  ...
  assign z54 = new_n169_ | ~new_n171_ | (~new_n167_ & ~x0);
  ...
  assign new_n171_ = (~x0 | (~new_n172_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n183_ = ~new_n121_ & (x0 | ~x2 | ~x4);
  assign new_n184_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
  ...
  assign new_n201_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n203_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n203_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x0 | x1 | ~x2) & (~x1 | x6))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z02 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
