// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:29 2020
...
module FAU ( 
  ...
  assign z37 = (~new_n131_ & ~x0) | ~new_n133_ | (~x3 & (x2 ? x0 : ~x1));
  assign new_n131_ = (new_n132_ | x4) & (x1 | ~x2 | (x3 & (~x3 | ~x4 | x5))) & (~x4 | (x3 & (x2 | ~x3)));
  assign new_n132_ = (x5 | (x6 & (~x1 | x3 | ~x6 | x7))) & ~x5 & ~x7;
  assign new_n133_ = new_n136_ & (~x0 | (new_n135_ & (new_n134_ | ~x3)));
  assign new_n134_ = (~x1 | (~x7 & (x4 | ~x5))) & (x5 | ~x6 | ~x7 | x1 | ~x2 | x4);
  assign new_n135_ = (~x2 | ~x4) & (x1 | x2 | x5 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n136_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x1 | x4 | x5 | x6);
  assign z38 = new_n117_ | new_n120_ | new_n121_ | new_n138_;
  assign new_n138_ = ~x2 & ((x1 & ~x5) | (x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3))));
  assign z39 = new_n145_ | ~new_n142_ | (~new_n140_ & ~x5);
  assign new_n140_ = (x0 | x1 | x2) & (x4 | (x0 ? (x6 & (~new_n141_ | x1 | ~x2)) : (x6 & (~x2 | ~x6))));
  assign new_n141_ = x3 & x6 & x7;
  assign new_n142_ = (~x2 | (x0 ? x3 : (~x3 | ~x4))) & (~x0 | (~x4 & (~new_n143_ | x4))) & (~new_n144_ | x4) & (x0 | ~x4 | (x3 & (x2 | ~x3)));
  assign new_n143_ = x6 & ~x7;
  assign new_n144_ = x5 & (x7 | (~x7 & (x6 | (~x3 & ~x6))));
  assign new_n145_ = x1 & ((~x2 & ~x5) | (x0 & x3 & x7));
  assign z40 = new_n147_ | ~new_n153_ | (~new_n149_ & ~x5);
  assign new_n147_ = ~x3 & ((~x0 & ~x1 & x2) | new_n148_ | (x1 & ~x2 & x4));
  assign new_n148_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n149_ = ~new_n150_ & ~new_n152_ & (new_n151_ | ~x0);
  assign new_n150_ = x1 & (~x2 | (x2 & x3 & ~x4 & x6));
  assign new_n151_ = (~x2 | (x6 & (x4 | ~x6 | ~x7 | x1 | ~x3))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n152_ = ~x4 & ((~x0 & ~x6) | (x3 & x6 & ~x7));
  assign new_n153_ = ~new_n154_ & ~new_n155_ & ~new_n156_ & ~new_n157_;
  assign new_n154_ = x0 & (x4 ? x2 : (x6 & ~x7));
  assign new_n155_ = x1 & (~x0 | (x3 & x4));
  assign new_n156_ = ~x0 & ((~x4 & x7) | (~x2 & x3 & x4));
  assign new_n157_ = ~x4 & x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  assign z41 = ~new_n161_ | new_n164_ | (~x4 & (~new_n163_ | (~new_n159_ & x0)));
  assign new_n159_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | ~new_n160_ | x5);
  assign new_n160_ = x6 & x7;
  assign new_n161_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n162_ | ~x3) & (x0 | ~x1);
  assign new_n162_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  assign new_n163_ = (x0 | (~x5 & ~x7)) & (x5 | ((x1 | x6) & (~x3 | ~x6 | x7)));
  assign new_n164_ = ~x1 & ((x0 & (x2 ? x3 : (x4 & ~x5))) | (~x3 & (~x2 | (~x0 & x2))));
  assign z42 = (~new_n166_ & ~x2) | new_n167_ | ~new_n169_ | (~new_n168_ & x2);
  assign new_n166_ = (x0 | ~x3 | ~x4) & ((~x1 & (x0 | x1)) | (x5 & (x3 | ~x4)));
  assign new_n167_ = x3 & (x0 ? (x1 & x7) : (x2 & x4));
  assign new_n168_ = (x0 | (x4 ? x3 : (x5 | ~x6))) & (x5 | ~x6 | ~x7 | ~x0 | x3 | x4);
  assign new_n169_ = x4 ? ~x0 : ((~x0 | (x6 ? x7 : x5)) & (~x5 | (~x7 & (~x6 | x7))) & (x0 | x5 | x6));
  assign z43 = (~new_n173_ & x4) | new_n145_ | new_n171_ | (~new_n174_ & ~x4);
  assign new_n171_ = x0 & (new_n172_ | (new_n74_ & x2));
  assign new_n172_ = ~x4 & x6 & ~x7;
  assign new_n173_ = (x0 | (~x2 ^ x3)) & (~x1 | (~x3 & (x2 | x3))) & (~x0 | ~x2);
  assign new_n174_ = (~x5 | (~x7 & (~x6 | x7))) & (x0 | ~x7) & (x5 | ((~x3 | ~x6 | x7) & (x0 | (x6 & (~x2 | ~x6)))));
  assign z44 = new_n176_ | ~new_n178_ | (x1 & (~x0 | (~x2 & ~x5)));
  assign new_n176_ = x3 & (x4 ? ~x0 : new_n177_);
  assign new_n177_ = ~x6 & ((x5 & ~x7) | (x0 & ~x1 & ~x2 & ~x5));
  assign new_n178_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n179_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n179_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign z45 = ((new_n181_ | ~new_n183_) & ~x2) | new_n189_ | ~new_n186_ | (~new_n184_ & x2);
  assign new_n181_ = x0 & (~x3 | (new_n182_ & ~x1 & ~x4));
  assign new_n182_ = ~x5 & x6 & x7;
  assign new_n183_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n143_ | x4 | x5)))));
  assign new_n184_ = new_n185_ & (~x0 | (x3 & (~new_n182_ | x1 | ~x3 | x4)));
  assign new_n185_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n186_ = (new_n188_ | x4) & (~x0 | (~new_n187_ & (~new_n74_ | x4)));
  assign new_n187_ = x1 & x3 & x7;
  assign new_n188_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  assign new_n189_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z46 = new_n195_ | ~new_n196_ | (~x4 & (~new_n193_ | (~new_n191_ & ~x0)));
  assign new_n191_ = ~x5 & (~new_n143_ | x5 | ~new_n192_ | ~x1);
  ...
  assign z49 = new_n202_ | ~new_n203_ | (~x3 & (new_n194_ | new_n148_));
  assign new_n202_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n203_ = ~new_n204_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n204_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z50 = (~new_n206_ & x0) | (~new_n207_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n206_ = (x1 | ((~x2 | ~x3) & (~new_n182_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  assign new_n207_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n208_;
  assign new_n208_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z51 = (~new_n210_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n210_ = x5 ? new_n211_ : (~x6 & (~new_n92_ | x2 | ~x3 | x6));
  assign new_n211_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n216_ | ~new_n214_ | (x3 & (new_n213_ | new_n215_ | new_n148_));
  assign new_n213_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n214_ = ~new_n179_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n215_ = x1 & (x4 | ~x6);
  assign new_n216_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n220_ | (~x4 & (x5 ? ~new_n219_ : ~new_n218_));
  assign new_n218_ = ~x6 & (x2 | (x3 & (~new_n92_ | ~x3 | x6)));
  assign new_n219_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n220_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (x3 | ~x4 | ~x1 | x2);
  assign z54 = (~new_n222_ & ~x0) | new_n223_ | ~new_n225_;
  assign new_n222_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n160_ | ~x5))));
  assign new_n223_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n224_ & ~x4));
  assign new_n224_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n225_ = (~x0 | (~new_n187_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n227_ | (~x4 & (x5 ? ~new_n229_ : (x6 | (~x1 & ~x6))));
  assign new_n227_ = ~new_n228_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n228_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n229_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n231_ & ~x4) | ~new_n234_ | (~new_n233_ & x3);
  assign new_n231_ = (new_n232_ | ~x6) & (~x5 | x6) & (x5 | (~new_n192_ & (x6 | (~x0 & x1))));
  assign new_n232_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n233_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n234_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (~new_n236_ & x0) | ~new_n243_ | (~x0 & (~new_n240_ | new_n245_));
  assign new_n236_ = x3 & (new_n237_ | x5) & ~new_n238_ & ~new_n172_ & (new_n239_ | ~x5);
  ...
  assign new_n243_ = (new_n244_ | x4) & (~new_n192_ | x1);
  ...
  assign new_n252_ = ~new_n148_ & (x0 | ~x2 | ~x4);
