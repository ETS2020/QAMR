...
module FAU ( 
  ...
  assign z40 = (~new_n131_ & ~x3) | ~new_n137_ | (~new_n133_ & ~x5);
  assign new_n131_ = (x0 | x1 | ~x2) & (~x1 | x2 | ~x4) & (~new_n132_ | x4 | ~x5);
  ...
  assign new_n149_ = x0 & ((x2 & ~x5 & ~x6) | (~x4 & x6 & ~x7));
  ...
  assign new_n170_ = (~x0 | (~new_n158_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n178_ = (new_n179_ | x5) & ~new_n180_ & (new_n181_ | ~x5) & (~new_n127_ | x4);
