...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n86_, new_n88_,
    new_n90_, new_n99_, new_n102_, new_n108_, new_n109_, new_n111_,
  ...
  assign new_n119_ = (x1 | x2 | x5 | (~x4 & (x4 | ~x6 | ~x7))) & (~x2 | ~x4);
  ...
  assign new_n136_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  ...
  assign new_n170_ = x5 ? new_n171_ : (~x6 & (~new_n86_ | x2 | ~x3 | x6));
  assign new_n171_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n176_ | ~new_n174_ | (x3 & (new_n173_ | new_n175_ | new_n123_));
  assign new_n173_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n174_ = ~new_n148_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n175_ = x1 & (x4 | ~x6);
  assign new_n176_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n180_ | (~x4 & (x5 ? ~new_n179_ : ~new_n178_));
  assign new_n178_ = ~x6 & (x2 | (x3 & (~new_n86_ | ~x3 | x6)));
  assign new_n179_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n180_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = (~new_n182_ & ~x0) | new_n183_ | ~new_n185_;
  assign new_n182_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n134_ | ~x5))));
  assign new_n183_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n184_ & ~x4));
  assign new_n184_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n185_ = (~x0 | (~new_n186_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign new_n186_ = x1 & x3 & x7;
  assign z55 = ~new_n188_ | (~x4 & (x5 ? ~new_n190_ : (x6 | (~x1 & ~x6))));
  assign new_n188_ = ~new_n189_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n189_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n190_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n192_ & ~x4) | ~new_n195_ | (~new_n194_ & x3);
  assign new_n192_ = (new_n193_ | ~x6) & (~x5 | x6) & (x5 | (~new_n151_ & (x6 | (~x0 & x1))));
  assign new_n193_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n194_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n195_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  ...
  assign new_n202_ = ~new_n123_ & (x0 | ~x2 | ~x4);
  assign new_n203_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
