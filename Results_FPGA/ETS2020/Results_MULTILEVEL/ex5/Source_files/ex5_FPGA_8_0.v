...
module FAU ( 
  ...
  assign z44 = new_n159_ | ~new_n157_ | (x3 & (x4 ? ~x0 : new_n156_));
  assign new_n156_ = ~x6 & ((x5 & ~x7) | (new_n84_ & ~x2 & ~x5));
  assign new_n157_ = (~x0 | (~x4 & (~new_n151_ | ~x2))) & ~new_n158_ & (x0 | ((~new_n151_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n158_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign new_n159_ = x1 & (~x0 | (~x2 & ~x5));
  ...
  assign new_n198_ = ~new_n158_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n243_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
