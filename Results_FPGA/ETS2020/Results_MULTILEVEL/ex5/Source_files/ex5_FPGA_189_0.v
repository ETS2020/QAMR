...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n76_, new_n78_, new_n81_, new_n83_, new_n84_, new_n86_, new_n96_,
    ...
    new_n262_, new_n264_, new_n265_, new_n267_;
  assign z00 = ~x4 & ~x5 & ~x6;
  ...
  assign z40 = new_n140_ | ~new_n146_ | (~new_n142_ & ~x5);
  assign new_n140_ = ~x3 & ((~x0 & ~x1 & x2) | new_n141_ | (x1 & ~x2 & x4));
  assign new_n141_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n142_ = ~new_n143_ & ~new_n145_ & (new_n144_ | ~x0);
  assign new_n143_ = x1 & (~x2 | (x2 & x3 & ~x4 & x6));
  assign new_n144_ = (~x2 | (x6 & (x4 | ~x6 | ~x7 | x1 | ~x3))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n145_ = ~x4 & ((~x0 & ~x6) | (x3 & x6 & ~x7));
  assign new_n146_ = ~new_n147_ & ~new_n148_ & ~new_n149_ & ~new_n150_;
  assign new_n147_ = x0 & (x4 ? x2 : (x6 & ~x7));
  assign new_n148_ = x1 & (~x0 | (x3 & x4));
  assign new_n149_ = ~x0 & ((~x4 & x7) | (~x2 & x3 & x4));
  assign new_n150_ = ~x4 & x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  assign z41 = ~new_n154_ | new_n157_ | (~x4 & (~new_n156_ | (~new_n152_ & x0)));
  assign new_n152_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | ~new_n153_ | x5);
  assign new_n153_ = x6 & x7;
  assign new_n154_ = (new_n155_ | ~x0) & (x0 | ~x1) & (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6)));
  assign new_n155_ = (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n156_ = (x0 | (~x5 & ~x7)) & (x5 | ((x1 | x6) & (~x3 | ~x6 | x7)));
  assign new_n157_ = ~x1 & ((x0 & (x2 ? x3 : (x4 & ~x5))) | (~x3 & (~x2 | (~x0 & x2))));
  assign z42 = (~new_n159_ & ~x2) | new_n160_ | ~new_n162_ | (~new_n161_ & x2);
  assign new_n159_ = (x0 | ~x3 | ~x4) & ((~x1 & (x0 | x1)) | (x5 & (x3 | ~x4)));
  assign new_n160_ = x3 & (x0 ? (x1 & x7) : (x2 & x4));
  assign new_n161_ = (x0 | (x4 ? x3 : (x5 | ~x6))) & (x5 | ~x6 | ~x7 | ~x0 | x3 | x4);
  assign new_n162_ = x4 ? ~x0 : ((~x0 | (x6 ? x7 : x5)) & (~x5 | (~x7 & (~x6 | x7))) & (x0 | x5 | x6));
  assign z43 = (~new_n167_ & x4) | new_n138_ | new_n164_ | (~new_n168_ & ~x4);
  ...
  assign new_n172_ = (~x0 | (~x4 & (~new_n165_ | ~x2))) & ~new_n173_ & (x0 | ((~new_n165_ | x4) & (~x2 | x3 | ~x4)));
  ...
  assign z49 = (x0 & (x4 | (new_n165_ & ~x4))) | new_n201_ | (~new_n202_ & ~x0) | (~new_n203_ & ~x4);
  assign new_n201_ = ~x3 & (new_n188_ | new_n141_);
  assign new_n202_ = (x1 | x2 | (x5 & (~x3 | ~x5))) & ~x1 & (~x2 | ~x3 | ~x4);
  assign new_n203_ = (~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)));
  assign z50 = (~new_n205_ & x0) | (~new_n206_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n205_ = (x1 | ((~x2 | ~x3) & (~new_n176_ | x2 | x4))) & x3 & ~x4 & (~new_n165_ | x4);
  ...
  assign new_n209_ = x5 ? new_n210_ : (~x6 & (~new_n84_ | x2 | ~x3 | x6));
  assign new_n210_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n215_ | ~new_n213_ | (x3 & (new_n212_ | new_n214_ | new_n141_));
  assign new_n212_ = x0 & ~x1 & (x2 | (new_n165_ & ~x2 & ~x4));
  ...
  assign new_n217_ = ~x6 & (x2 | (x3 & (~new_n84_ | ~x3 | x6)));
  ...
  assign new_n221_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n153_ | ~x5))));
  ...
  assign new_n226_ = ~new_n227_ & (~x0 | (x2 ? (~new_n165_ & ~x4) : x3));
  ...
  assign new_n251_ = ~new_n141_ & (x0 | ~x2 | ~x4);
  assign new_n252_ = x5 & ((~x4 & x7) | (new_n84_ & ~x2 & x4));
  ...
  assign new_n265_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n267_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n267_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
