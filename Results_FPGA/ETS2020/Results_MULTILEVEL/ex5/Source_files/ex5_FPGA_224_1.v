...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n86_, new_n88_, new_n95_,
    ...
    new_n196_, new_n197_, new_n199_, new_n200_, new_n202_;
  ...
  assign z52 = new_n165_ | ~new_n163_ | (x3 & (new_n162_ | new_n164_ | new_n121_));
  assign new_n162_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n163_ = ~new_n141_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n171_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n132_ | ~x5))));
  ...
  assign z59 = ~new_n186_ | new_n196_ | new_n197_ | new_n187_ | new_n190_ | new_n194_;
  assign new_n186_ = ~new_n121_ & (x0 | ~x2 | ~x4);
  assign new_n187_ = x3 & (~new_n189_ | (~new_n188_ & ~x5));
  assign new_n188_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n189_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n190_ = ~x3 & ((~new_n191_ & ~x0) | new_n192_ | (~new_n193_ & x0));
  assign new_n191_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n192_ = ~x2 & (x0 | (x1 & x4));
  assign new_n193_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n194_ = ~new_n195_ & ~x5;
  assign new_n195_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n196_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
