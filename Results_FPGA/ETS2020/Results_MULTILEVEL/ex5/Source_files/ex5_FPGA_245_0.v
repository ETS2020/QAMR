...
module FAU ( 
  ...
  assign z38 = new_n126_ | ~new_n128_ | (x2 & (x0 ? (~x3 | (~x1 & x3)) : (~x1 & ~x3)));
  assign new_n126_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | (~new_n127_ & ~x5) | (x5 & x7) | (~x7 & (x6 ? (x0 | x5) : x5)));
  assign new_n127_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n128_ = ~new_n129_ & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  assign new_n129_ = ~x2 & ((x1 & ~x5) | (x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3))));
  assign z39 = new_n136_ | ~new_n133_ | (~new_n131_ & ~x5);
  assign new_n131_ = (x4 | (x0 ? (x6 & (~new_n132_ | x1 | ~x2)) : (x6 & (~x2 | ~x6)))) & (x0 | x1 | x2);
  ...
  assign new_n205_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n208_ | ~new_n210_ | (~new_n207_ & ~x0);
