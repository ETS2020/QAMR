...
module FAU ( 
  ...
  assign z40 = new_n119_ | ~new_n125_ | (~new_n121_ & ~x5);
  ...
  assign z43 = (~new_n138_ & x4) | new_n139_ | new_n140_ | (~new_n141_ & ~x4);
  assign new_n138_ = (x0 | (~x2 ^ x3)) & (~x1 | (~x3 & (x2 | x3))) & (~x0 | ~x2);
  assign new_n139_ = x1 & ((~x2 & ~x5) | (x0 & x3 & x7));
  assign new_n140_ = x0 & ((x2 & ~x5 & ~x6) | (~x4 & x6 & ~x7));
  ...
  assign z49 = new_n164_ | ~new_n165_ | (~x3 & (new_n151_ | new_n120_));
  ...
  assign z52 = new_n175_ | ~new_n173_ | (x3 & (new_n172_ | new_n174_ | new_n120_));
  ...
  assign new_n201_ = ~new_n120_ & (x0 | ~x2 | ~x4);
