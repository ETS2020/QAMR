// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:18 2020
...
module FAU ( 
  ...
  wire new_n77_, new_n79_, new_n82_, new_n84_, new_n85_, new_n88_, new_n96_,
    new_n98_, new_n102_, new_n103_, new_n105_, new_n106_, new_n108_,
    ...
    new_n240_, new_n241_, new_n243_, new_n244_, new_n246_;
  assign z00 = ~x4 & ~x5 & ~x6;
  ...
  assign z38 = new_n124_ | ~new_n126_ | (x2 & (x0 ? (~x3 | (~x1 & x3)) : (~x1 & ~x3)));
  assign new_n124_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | (~new_n125_ & ~x5) | (x5 & x7) | (~x7 & (x6 ? (x0 | x5) : x5)));
  assign new_n125_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n126_ = ~new_n127_ & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  ...
  assign z43 = (~new_n146_ & x4) | new_n134_ | new_n143_ | (~new_n147_ & ~x4);
  assign new_n143_ = x0 & (new_n145_ | (new_n144_ & x2));
  ...
  assign new_n151_ = (~x0 | (~x4 & (~new_n144_ | ~x2))) & ~new_n152_ & (x0 | ((~new_n144_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n152_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign z45 = (~x2 & (new_n154_ | ~new_n156_)) | new_n162_ | ~new_n159_ | (~new_n157_ & x2);
  assign new_n154_ = x0 & (~x3 | (new_n155_ & ~x1 & ~x4));
  assign new_n155_ = ~x5 & x6 & x7;
  assign new_n156_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n132_ | x4 | x5)))));
  assign new_n157_ = new_n158_ & (~x0 | (x3 & (~new_n155_ | x1 | ~x3 | x4)));
  assign new_n158_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n159_ = ~new_n161_ & (~x0 | (~z00 & ~new_n160_));
  ...
  assign new_n164_ = ~x5 & (~new_n132_ | x5 | ~new_n165_ | ~x1);
  ...
  assign z49 = ~new_n181_ | (~new_n180_ & ~x3) | (x0 & (x4 | (new_n144_ & ~x4)));
  ...
  assign new_n184_ = (x1 | ((~x2 | ~x3) & (~new_n155_ | x2 | x4))) & x3 & ~x4 & (~new_n144_ | x4);
  ...
  assign new_n188_ = x5 ? new_n189_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  ...
  assign new_n193_ = ~new_n152_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n194_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n198_ | (~x4 & (x5 ? ~new_n197_ : ~new_n196_));
  assign new_n196_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  assign new_n197_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n198_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n201_ | ~new_n203_ | (~new_n200_ & ~x0);
  assign new_n200_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n137_ | ~x5))));
  assign new_n201_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n202_ & ~x4));
  assign new_n202_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n203_ = (~x0 | (~new_n160_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n205_ | (~x4 & (x5 ? ~new_n207_ : (x6 | (~x1 & ~x6))));
  assign new_n205_ = ~new_n206_ & (~x0 | (x2 ? (~new_n144_ & ~x4) : x3));
  ...
  assign new_n209_ = (new_n210_ | ~x6) & (~x5 | x6) & (x5 | (~new_n165_ & (x6 | (~x0 & x1))));
  ...
  assign new_n214_ = x3 & (new_n215_ | x5) & ~new_n216_ & ~new_n145_ & (new_n217_ | ~x5);
  ...
  assign new_n219_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
  assign new_n220_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n221_ = (new_n222_ | x4) & (~new_n165_ | x1);
  ...
  assign new_n230_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
