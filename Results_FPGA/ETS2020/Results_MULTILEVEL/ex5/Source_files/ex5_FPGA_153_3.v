...
module FAU ( 
  ...
  assign z38 = new_n118_ | new_n121_ | new_n122_ | new_n133_;
  ...
  assign new_n146_ = (~x2 | (x6 & (x1 | ~x3 | x4 | ~x6 | ~x7))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  ...
  assign z43 = (~new_n167_ & x4) | new_n140_ | new_n166_ | (~new_n168_ & ~x4);
  assign new_n166_ = x0 & ((new_n138_ & ~x4) | (new_n74_ & x2));
  ...
  assign new_n177_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n138_ | x4 | x5)))));
  ...
  assign new_n185_ = ~x5 & (~new_n138_ | x5 | ~new_n186_ | ~x1);
  ...
  assign z49 = new_n196_ | ~new_n197_ | (~x3 & (new_n188_ | new_n143_));
  assign new_n196_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n197_ = ~new_n198_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n198_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z50 = (~new_n200_ & x0) | (~new_n201_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n200_ = (x1 | ((~x2 | ~x3) & (~new_n176_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  assign new_n201_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n202_;
  assign new_n202_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z51 = (~new_n204_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n204_ = x5 ? new_n205_ : (~x6 & (~new_n92_ | x2 | ~x3 | x6));
  assign new_n205_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n209_ | ~new_n208_ | (x3 & (new_n207_ | new_n143_ | new_n210_));
  assign new_n207_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n208_ = ~new_n173_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n209_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign new_n210_ = x1 & (x4 | ~x6);
  assign z53 = ~new_n214_ | (~x4 & (x5 ? ~new_n213_ : ~new_n212_));
  assign new_n212_ = ~x6 & (x2 | (x3 & (~new_n92_ | ~x3 | x6)));
  assign new_n213_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n214_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (x3 | ~x4 | ~x1 | x2);
  assign z54 = (~new_n216_ & ~x0) | new_n217_ | ~new_n219_;
  assign new_n216_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n155_ | ~x5))));
  assign new_n217_ = ~x1 & ((~new_n218_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n218_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n219_ = (~x0 | (~new_n181_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n221_ | (~x4 & (x5 ? ~new_n223_ : (x6 | (~x1 & ~x6))));
  assign new_n221_ = ~new_n222_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n222_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n223_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n225_ & ~x4) | ~new_n228_ | (~new_n227_ & x3);
  assign new_n225_ = (new_n226_ | ~x6) & (~x5 | x6) & (x5 | (~new_n186_ & (x6 | (~x0 & x1))));
  assign new_n226_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n227_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n228_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (x0 & (~new_n230_ | ~x3)) | ~new_n237_ | (~x0 & (~new_n234_ | new_n239_));
  assign new_n230_ = (new_n231_ | x5) & ~new_n232_ & (new_n233_ | ~x5) & (~new_n138_ | x4);
  ...
  assign new_n237_ = (new_n238_ | x4) & (~new_n186_ | x1);
  ...
  assign new_n247_ = x5 & ((~x4 & x7) | (new_n92_ & ~x2 & x4));
  ...
  assign new_n254_ = x1 & (~x2 | x4 | x5 | ~x6 | ~x7);
