...
module FAU ( 
  ...
  assign z44 = new_n174_ | ~new_n172_ | (x3 & (x4 ? ~x0 : new_n171_));
  assign new_n171_ = ~x6 & ((x5 & ~x7) | (new_n91_ & ~x2 & ~x5));
  assign new_n172_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n173_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n173_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign new_n174_ = x1 & (~x0 | (~x2 & ~x5));
  ...
  assign new_n209_ = ~new_n173_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
