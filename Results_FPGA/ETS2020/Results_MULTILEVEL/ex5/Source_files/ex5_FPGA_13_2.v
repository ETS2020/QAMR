// Benchmark "FAU" written by ABC on Thu Aug  6 04:05:45 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n81_, new_n82_, new_n84_, new_n87_, new_n89_, new_n99_,
  ...
  assign z41 = ~new_n135_ | new_n138_ | (~x4 & (~new_n137_ | (~new_n133_ & x0)));
  assign new_n133_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | ~new_n134_ | x5);
  assign new_n134_ = x6 & x7;
  assign new_n135_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n136_ | ~x3) & (x0 | ~x1);
  assign new_n136_ = (~x1 | x6) & (~x4 | (x0 & ~x1));
  assign new_n137_ = (x0 | (~x5 & ~x7)) & (x5 | ((x1 | x6) & (~x3 | ~x6 | x7)));
  assign new_n138_ = ~x1 & ((x0 & (x2 ? x3 : (x4 & ~x5))) | (~x3 & (~x2 | (~x0 & x2))));
  assign z43 = (~new_n140_ & x4) | new_n120_ | new_n141_ | (~new_n142_ & ~x4);
  ...
  assign new_n146_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n118_ | x4 | x5)))));
  ...
  assign z54 = (~new_n158_ & ~x0) | new_n159_ | ~new_n161_;
  assign new_n158_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n134_ | ~x5))));
  assign new_n159_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n160_ & ~x4));
  assign new_n160_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n161_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n150_ & ~x4));
  assign z56 = (~new_n163_ & ~x4) | ~new_n166_ | (~new_n165_ & x3);
  assign new_n163_ = (new_n164_ | ~x6) & (~x5 | x6) & (x5 | ((x2 | x3) & (new_n82_ | x6)));
  assign new_n164_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n165_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n166_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  ...
  assign z60 = new_n180_ | ~new_n181_ | (~x4 & (~x5 | (~new_n179_ & x5)));
  assign new_n179_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n180_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n181_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z62 = ~new_n183_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n183_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z04 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
