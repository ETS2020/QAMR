// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:08 2020
...
module FAU ( 
  ...
  assign new_n164_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n136_ | ~x5))));
  assign new_n165_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n166_ & ~x4));
  assign new_n166_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n167_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n152_ & ~x4));
  assign z56 = (~new_n169_ & ~x4) | ~new_n172_ | (~new_n171_ & x3);
  assign new_n169_ = (new_n170_ | ~x6) & (~x5 | x6) & (x5 | ((x2 | x3) & (new_n82_ | x6)));
  assign new_n170_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n171_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n172_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (x0 & (~new_n174_ | ~x3)) | ~new_n181_ | (~x0 & (~new_n178_ | new_n183_));
  assign new_n174_ = (new_n175_ | x5) & ~new_n176_ & (new_n177_ | ~x5) & (~new_n120_ | x4);
  ...
  assign new_n179_ = x5 & x6 & x7 & x1 & ~x2 & ~x4;
