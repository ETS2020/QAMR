...
module FAU ( 
  ...
  wire new_n74_, new_n76_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_,
    new_n87_, new_n94_, new_n101_, new_n102_, new_n104_, new_n105_,
    ...
    new_n208_, new_n209_, new_n211_, new_n212_, new_n214_;
  ...
  assign z52 = new_n173_ | ~new_n171_ | (x3 & (new_n170_ | new_n172_ | new_n120_));
  ...
  assign new_n179_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n131_ | ~x5))));
