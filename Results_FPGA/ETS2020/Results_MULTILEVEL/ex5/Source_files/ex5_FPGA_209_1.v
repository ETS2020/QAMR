...
module FAU ( 
  ...
  assign new_n160_ = x5 ? new_n161_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  assign new_n161_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n166_ | ~new_n164_ | (x3 & (new_n163_ | new_n165_ | new_n124_));
  assign new_n163_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n164_ = ~new_n143_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign z59 = ~new_n177_ | new_n178_ | new_n188_ | new_n179_ | new_n182_ | new_n186_;
  assign new_n177_ = ~new_n124_ & (x0 | ~x2 | ~x4);
  assign new_n178_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
  ...
  assign new_n195_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n197_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n197_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
