// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:04 2020
...
module FAU ( 
  ...
  assign new_n192_ = x5 ? new_n193_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  ...
  assign new_n200_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  ...
  assign new_n224_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
