...
module FAU ( 
  ...
  wire new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n101_,
    ...
    new_n189_, new_n191_, new_n192_, new_n193_, new_n195_;
  assign z00 = ~x4 & ~x5 & ~x6;
  assign z01 = ~x7 & ~x5 & ~x6;
  ...
  assign z38 = new_n104_ | new_n107_ | new_n108_ | new_n119_;
  ...
  assign new_n172_ = (~x0 | (~new_n155_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n180_ = (new_n181_ | x5) & ~new_n182_ & (~new_n124_ | x4) & (new_n183_ | ~x5);
