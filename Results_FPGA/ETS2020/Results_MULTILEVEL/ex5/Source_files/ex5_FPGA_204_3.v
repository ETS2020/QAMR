...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n90_,
    new_n92_, new_n94_, new_n97_, new_n106_, new_n109_, new_n115_,
  ...
  assign new_n133_ = (x5 | (x6 & (~x1 | x3 | ~x6 | x7))) & ~x5 & ~x7;
  ...
  assign z38 = new_n118_ | new_n121_ | new_n122_ | new_n139_;
  ...
  assign new_n162_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n163_ | ~x3) & (x0 | ~x1);
  assign new_n163_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  ...
  assign new_n206_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z49 = new_n208_ | ~new_n209_ | (~x3 & (new_n195_ | new_n149_));
  ...
  assign new_n216_ = x5 ? new_n217_ : (~x6 & (~new_n90_ | x2 | ~x3 | x6));
  assign new_n217_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n222_ | ~new_n220_ | (x3 & (new_n219_ | new_n221_ | new_n149_));
  ...
  assign new_n224_ = ~x6 & (x2 | (x3 & (~new_n90_ | ~x3 | x6)));
  ...
  assign new_n228_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n161_ | ~x5))));
  ...
  assign new_n242_ = x3 & (new_n243_ | x5) & ~new_n244_ & ~new_n173_ & (new_n245_ | ~x5);
  ...
  assign new_n258_ = ~new_n149_ & (x0 | ~x2 | ~x4);
  assign new_n259_ = x5 & ((~x4 & x7) | (new_n90_ & ~x2 & x4));
