// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:12 2020
...
module FAU ( 
  ...
  assign z43 = (~new_n169_ & x4) | new_n148_ | new_n167_ | (~new_n170_ & ~x4);
  ...
  assign new_n179_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n146_ | x4 | x5)))));
  ...
  assign new_n187_ = ~x5 & (~new_n146_ | x5 | ~new_n188_ | ~x1);
  ...
  assign z48 = ~new_n198_ | new_n201_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n198_ = new_n200_ & (x2 | ((x1 | x3) & (~x0 | (~new_n199_ & x3))));
  assign new_n199_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n200_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n201_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n203_ | ~new_n204_ | (~x3 & (new_n190_ | new_n151_));
  ...
  assign new_n207_ = (x1 | ((~x2 | ~x3) & (~new_n178_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n217_ | ~new_n215_ | (x3 & (new_n214_ | new_n216_ | new_n151_));
  assign new_n214_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n215_ = ~new_n175_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign z54 = (~new_n223_ & ~x0) | new_n225_ | ~new_n227_;
  assign new_n223_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n224_ | ~x5))));
  assign new_n224_ = x6 & x7;
  assign new_n225_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n226_ & ~x4));
  assign new_n226_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n227_ = (~x0 | (~new_n183_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign z56 = (~new_n233_ & ~x4) | ~new_n236_ | (~new_n235_ & x3);
  assign new_n233_ = (new_n234_ | ~x6) & (~x5 | x6) & (x5 | (~new_n188_ & (x6 | (~x0 & x1))));
  assign new_n234_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n235_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n236_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (~new_n238_ & x0) | ~new_n245_ | (~x0 & (~new_n242_ | new_n247_));
  assign new_n238_ = x3 & (new_n239_ | x5) & ~new_n240_ & ~new_n168_ & (new_n241_ | ~x5);
  ...
  assign new_n245_ = (new_n246_ | x4) & (~new_n188_ | x1);
  ...
  assign new_n255_ = x5 & ((~x4 & x7) | (new_n91_ & ~x2 & x4));
