...
module FAU ( 
  ...
  assign z35 = x4 ? ~new_n112_ : ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7))));
  assign new_n112_ = (~x0 | (~x2 & (x1 | x2 | x5))) & (~x1 | (~x3 & (x2 | x3))) & (x0 | (x2 ? (x3 & (x1 | ~x3 | x5)) : ~x3));
  ...
  assign new_n145_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  ...
  assign z49 = new_n163_ | ~new_n164_ | (~x3 & (new_n150_ | new_n126_));
  ...
  assign new_n184_ = (new_n185_ | ~x6) & (~x5 | x6) & (x5 | (~new_n148_ & (x6 | (~x0 & x1))));
  ...
  assign new_n194_ = ~new_n126_ & (x0 | ~x2 | ~x4);
