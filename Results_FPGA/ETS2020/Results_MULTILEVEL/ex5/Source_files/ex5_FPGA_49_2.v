...
module FAU ( 
  ...
  assign z40 = (~new_n124_ & ~x3) | ~new_n130_ | (~new_n126_ & ~x5);
  assign new_n124_ = (x0 | x1 | ~x2) & (~x1 | x2 | ~x4) & (~new_n125_ | x4 | ~x5);
  ...
  assign z43 = (~new_n148_ & x4) | new_n122_ | new_n149_ | (~new_n150_ & ~x4);
  ...
  assign new_n154_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n120_ | x4 | x5)))));
  ...
  assign new_n171_ = (new_n172_ | x5) & ~new_n173_ & (~new_n120_ | x4) & (new_n174_ | ~x5);
