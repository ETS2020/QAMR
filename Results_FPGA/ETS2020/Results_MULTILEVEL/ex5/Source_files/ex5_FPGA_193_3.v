// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:53 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    ...
    new_n271_, new_n272_, new_n274_, new_n275_;
  ...
  assign z46 = new_n200_ | ~new_n201_ | (~x4 & (~new_n198_ | (~new_n197_ & ~x0)));
  assign new_n197_ = ~x5 & (~new_n149_ | x5 | ~x1 | x2 | x3);
  ...
  assign z49 = new_n212_ | ~new_n213_ | (~x3 & (new_n199_ | new_n154_));
  ...
  assign new_n216_ = (x1 | ((~x2 | ~x3) & (~new_n188_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n226_ | ~new_n224_ | (x3 & (new_n223_ | new_n225_ | new_n154_));
  assign new_n223_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n224_ = ~new_n185_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n232_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n166_ | ~x5))));
  assign new_n233_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n234_ & ~x4));
  assign new_n234_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n235_ = (~x0 | (~new_n193_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n241_ = x3 & (new_n242_ | x5) & ~new_n243_ & ~new_n178_ & (new_n244_ | ~x5);
  ...
  assign new_n248_ = (x1 | x2 | x3) & (new_n249_ | x4);
  ...
  assign new_n257_ = ~new_n154_ & (x0 | ~x2 | ~x4);
