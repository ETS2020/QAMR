// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:28 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    ...
    new_n264_, new_n265_, new_n266_, new_n268_, new_n269_;
  ...
  assign new_n190_ = ~x5 & (~new_n142_ | x5 | ~new_n191_ | ~x1);
  ...
  assign z49 = new_n201_ | ~new_n202_ | (~x3 & (new_n193_ | new_n147_));
  assign new_n201_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n202_ = ~new_n203_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n203_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z50 = (~new_n205_ & x0) | (~new_n206_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n205_ = (x1 | ((~x2 | ~x3) & (~new_n181_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  assign new_n206_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n207_;
  assign new_n207_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z51 = (~new_n209_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n209_ = x5 ? new_n210_ : (~x6 & (~new_n92_ | x2 | ~x3 | x6));
  assign new_n210_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n214_ | ~new_n213_ | (x3 & (new_n212_ | new_n147_ | new_n215_));
  assign new_n212_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n213_ = ~new_n178_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n214_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign new_n215_ = x1 & (x4 | ~x6);
  assign z53 = ~new_n219_ | (~x4 & (x5 ? ~new_n218_ : ~new_n217_));
  assign new_n217_ = ~x6 & (x2 | (x3 & (~new_n92_ | ~x3 | x6)));
  assign new_n218_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n219_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (x3 | ~x4 | ~x1 | x2);
  assign z54 = (~new_n221_ & ~x0) | new_n222_ | ~new_n224_;
  assign new_n221_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n159_ | ~x5))));
  assign new_n222_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n223_ & ~x4));
  assign new_n223_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n224_ = (~x0 | (~new_n186_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n226_ | (~x4 & (x5 ? ~new_n228_ : (x6 | (~x1 & ~x6))));
  assign new_n226_ = ~new_n227_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n227_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n228_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n230_ & ~x4) | ~new_n233_ | (~new_n232_ & x3);
  assign new_n230_ = (new_n231_ | ~x6) & (~x5 | x6) & (x5 | (~new_n191_ & (x6 | (~x0 & x1))));
  ...
  assign new_n235_ = x3 & (new_n236_ | x5) & ~new_n237_ & ~new_n171_ & (new_n238_ | ~x5);
  ...
  assign new_n242_ = (new_n243_ | x4) & (~new_n191_ | x1);
  ...
  assign new_n251_ = ~new_n147_ & (x0 | ~x2 | ~x4);
