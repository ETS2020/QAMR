// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:40 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n89_, new_n99_,
  ...
  assign z39 = new_n120_ | ~new_n117_ | (~new_n115_ & ~x5);
  assign new_n115_ = (x0 | x1 | x2) & (x4 | (x0 ? (x6 & (~new_n116_ | x1 | ~x2)) : (x6 & (~x2 | ~x6))));
  assign new_n116_ = x3 & x6 & x7;
  ...
  assign z40 = new_n122_ | new_n124_ | new_n128_ | new_n129_ | new_n130_ | new_n131_;
  assign new_n122_ = ~x3 & ((~x0 & ~x1 & x2) | new_n123_ | (x1 & ~x2 & x4));
  assign new_n123_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n124_ = ~x5 & (new_n125_ | new_n127_ | (~new_n126_ & x0));
  ...
  assign new_n128_ = x0 & (x4 ? x2 : new_n118_);
  ...
  assign z43 = (~new_n138_ & x4) | new_n120_ | new_n139_ | (~new_n140_ & ~x4);
  ...
  assign new_n144_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n118_ | x4 | x5)))));
  ...
  assign z51 = (~new_n161_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n161_ = x5 ? new_n162_ : (~x6 & (~new_n89_ | x2 | ~x3 | x6));
  assign new_n162_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  ...
  assign new_n168_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n148_ & ~x4));
  assign z57 = (x0 & (~new_n170_ | ~x3)) | ~new_n177_ | (~x0 & (~new_n174_ | new_n179_));
  assign new_n170_ = (new_n171_ | x5) & ~new_n172_ & (new_n173_ | ~x5) & (~new_n118_ | x4);
  ...
  assign z61 = ~new_n191_ | (~x4 & ((~new_n190_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n190_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n191_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n193_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n193_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z04 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
