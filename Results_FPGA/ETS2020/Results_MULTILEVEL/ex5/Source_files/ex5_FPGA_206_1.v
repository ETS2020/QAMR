...
module FAU ( 
  ...
  assign z38 = new_n125_ | ~new_n127_ | (x2 & (x0 ? (~x3 | (~x1 & x3)) : (~x1 & ~x3)));
  assign new_n125_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | (~new_n126_ & ~x5) | (x5 & x7) | (~x7 & (x6 ? (x0 | x5) : x5)));
  assign new_n126_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n127_ = ~new_n128_ & (~x1 | (x0 & (~x3 | (~x4 & x6))));
  assign new_n128_ = ~x2 & ((x1 & ~x5) | (x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3))));
  assign z40 = new_n130_ | ~new_n136_ | new_n139_ | (~new_n132_ & ~x5);
  assign new_n130_ = ~x3 & ((~x0 & ~x1 & x2) | new_n131_ | (x1 & ~x2 & x4));
  assign new_n131_ = ~x4 & x5 & ~x6 & ~x7;
  assign new_n132_ = ~new_n133_ & ~new_n135_ & (new_n134_ | ~x0);
  assign new_n133_ = x1 & (~x2 | (x2 & x3 & ~x4 & x6));
  assign new_n134_ = (~x2 | (x6 & (x4 | ~x6 | ~x7 | x1 | ~x3))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n135_ = ~x4 & ((x3 & x6 & ~x7) | (~x0 & ~x6));
  assign new_n136_ = (~x1 | (x0 & (~x3 | ~x4))) & (new_n137_ | x0) & (~new_n138_ | x4);
  assign new_n137_ = (x4 | ~x7) & (x2 | ~x3 | ~x4);
  assign new_n138_ = x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  assign new_n139_ = x0 & (x4 ? x2 : (x6 & ~x7));
  ...
  assign new_n155_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = new_n162_ | ~new_n163_ | (~x3 & (new_n149_ | new_n131_));
  ...
  assign new_n166_ = x5 ? new_n167_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  assign new_n167_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n172_ | ~new_n170_ | (x3 & (new_n169_ | new_n171_ | new_n131_));
  assign new_n169_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n170_ = ~new_n144_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n171_ = x1 & (x4 | ~x6);
  assign new_n172_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n176_ | (~x4 & (x5 ? ~new_n175_ : ~new_n174_));
  assign new_n174_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign z54 = new_n180_ | ~new_n182_ | (~new_n178_ & ~x0);
  assign new_n178_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n179_ | ~x5))));
  ...
  assign new_n189_ = (new_n190_ | ~x6) & (~x5 | x6) & (x5 | (~new_n147_ & (x6 | (~x0 & x1))));
  ...
  assign new_n199_ = ~new_n131_ & (x0 | ~x2 | ~x4);
  assign new_n200_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
