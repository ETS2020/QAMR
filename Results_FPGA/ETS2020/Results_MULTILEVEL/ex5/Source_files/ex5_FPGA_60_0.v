...
module FAU ( 
  ...
  assign z43 = (~new_n153_ & x4) | new_n137_ | new_n151_ | (~new_n154_ & ~x4);
  assign new_n151_ = x0 & (new_n152_ | (new_n75_ & x2));
  ...
  assign new_n158_ = (~x0 | (~x4 & (~new_n75_ | ~x2))) & ~new_n159_ & (x0 | ((~new_n75_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n159_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign z45 = ((new_n161_ | ~new_n162_) & ~x2) | new_n167_ | ~new_n165_ | (~new_n163_ & x2);
  assign new_n161_ = x0 & (~x3 | (new_n140_ & ~x1 & ~x4));
  assign new_n162_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n135_ | x4 | x5)))));
  assign new_n163_ = new_n164_ & (~x0 | (x3 & (~new_n140_ | x1 | ~x3 | x4)));
  ...
  assign new_n169_ = ~x5 & (~new_n135_ | x5 | ~new_n170_ | ~x1);
  ...
  assign z49 = ~new_n186_ | (~new_n185_ & ~x3) | (x0 & (x4 | (new_n75_ & ~x4)));
  ...
  assign new_n189_ = (x1 | ((~x2 | ~x3) & (~new_n140_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n193_ = x5 ? new_n194_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  ...
  assign new_n201_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign new_n205_ = ~new_n206_ & (~x0 | (x2 ? (~new_n75_ & ~x4) : x3));
  ...
  assign new_n225_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
  ...
  assign z61 = ~new_n239_ | (~x4 & ((~new_n238_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n238_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n239_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n241_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n241_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
