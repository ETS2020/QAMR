...
module FAU ( 
  ...
  assign z38 = new_n109_ | new_n112_ | new_n113_ | new_n123_;
  ...
  assign new_n145_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n146_ | ~x3) & (x0 | ~x1);
  assign new_n146_ = (~x1 | x6) & (~x4 | (x0 & ~x1));
  ...
  assign z43 = (~new_n155_ & x4) | new_n130_ | new_n156_ | (~new_n157_ & ~x4);
  assign new_n155_ = (x0 | (~x2 ^ x3)) & (~x1 | (~x3 & (x2 | x3))) & (~x0 | ~x2);
  assign new_n156_ = x0 & ((~x4 & x6 & ~x7) | (x2 & ~x5 & ~x6));
  ...
  assign new_n161_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n128_ | x4 | x5)))));
  assign new_n162_ = new_n163_ & (~x0 | (x3 & (~new_n160_ | x1 | ~x3 | x4)));
  assign new_n163_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n164_ = (new_n166_ | x4) & ((~z00 & ~new_n165_) | ~x0);
  assign new_n165_ = x1 & x3 & x7;
  assign new_n166_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  assign new_n167_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z48 = ~new_n169_ | new_n172_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n169_ = new_n171_ & (x2 | ((x1 | x3) & (~x0 | (~new_n170_ & x3))));
  assign new_n170_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n171_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n172_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z50 = (~new_n174_ & x0) | (~new_n175_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n174_ = (x1 | ((~x2 | ~x3) & (~new_n160_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n175_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n176_;
  assign new_n176_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n178_ & ~x0) | new_n179_ | ~new_n181_;
  assign new_n178_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n144_ | ~x5))));
  assign new_n179_ = ~x1 & ((~new_n180_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n180_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n181_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n165_ & ~x4));
