...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n76_, new_n78_, new_n80_, new_n82_, new_n83_, new_n92_, new_n96_,
  ...
  assign z06 = new_n76_ & ~x6;
  assign new_n76_ = ~x5 & ~x4 & x3 & x2 & ~x0 & ~x1;
  ...
  assign z31 = (~x4 & (x5 | (~x5 & (x6 | (~x0 & ~x6))))) | new_n96_ | (~new_n97_ & ~x5);
  assign new_n96_ = x4 & ((x0 & (x2 | (~x1 & ~x2 & ~x5))) | (x1 & (x3 | (~x2 & ~x3))) | (~x0 & (x2 ? (~x3 | (~x1 & x3 & ~x5)) : x3)));
  assign new_n97_ = (x2 | (~x1 & (x0 | x1))) & (~x0 | ~x2 | x6);
  assign z32 = new_n99_ | new_n101_ | new_n102_ | new_n103_;
  assign new_n99_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | (~new_n100_ & ~x5) | (~x7 & (x6 ? (x0 | x5) : x5)) | (x5 & x7));
  assign new_n100_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n101_ = ~x2 & ((x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3) | (x0 & ~x1 & ~x5))) | (x1 & ~x5));
  assign new_n102_ = x2 & (x0 ? (~x3 | (~x1 & x3)) : (~x1 & ~x3));
  assign new_n103_ = x1 & (~x0 | (x3 & (x4 | ~x6)));
  ...
  assign z35 = new_n96_ | (~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7)))));
  ...
  assign new_n115_ = (~x0 | (x6 & (x1 | x2 | ~x6 | ~x7))) & (x1 | x6) & (x2 | x3) & (~x3 | ~x6 | x7);
  ...
  assign new_n122_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x1 | x4 | x5 | x6);
  assign z38 = new_n99_ | new_n102_ | new_n103_ | new_n124_;
  assign new_n124_ = ~x2 & ((x1 & ~x5) | (x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3))));
  assign z39 = new_n131_ | ~new_n128_ | (~new_n126_ & ~x5);
  assign new_n126_ = (x0 | x1 | x2) & (x4 | (x0 ? (x6 & (~new_n127_ | x1 | ~x2)) : (x6 & (~x2 | ~x6))));
  assign new_n127_ = x3 & x6 & x7;
  assign new_n128_ = (~x2 | (x0 ? x3 : (~x3 | ~x4))) & (~x0 | (~x4 & (~new_n129_ | x4))) & (~new_n130_ | x4) & (x0 | ~x4 | (x3 & (x2 | ~x3)));
  assign new_n129_ = x6 & ~x7;
  assign new_n130_ = x5 & (x7 | (~x7 & (x6 | (~x3 & ~x6))));
  assign new_n131_ = x1 & ((~x2 & ~x5) | (x0 & x3 & x7));
  assign z41 = ~new_n135_ | new_n138_ | (~x4 & (~new_n137_ | (~new_n133_ & x0)));
  assign new_n133_ = (~x1 | ~x3 | ~x5) & (~new_n134_ | x1 | x2);
  ...
  assign z43 = (~new_n148_ & x4) | new_n131_ | new_n145_ | (~new_n149_ & ~x4);
  ...
  assign new_n156_ = x0 & (~x3 | (new_n134_ & ~x1 & ~x4));
  assign new_n157_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n129_ | x4 | x5)))));
  assign new_n158_ = new_n159_ & (~x0 | (x3 & (~new_n134_ | x1 | ~x3 | x4)));
  ...
  assign new_n164_ = ~x5 & (~new_n129_ | x5 | ~new_n165_ | ~x1);
  ...
  assign new_n184_ = (x1 | ((~x2 | ~x3) & (~new_n134_ | x2 | x4))) & x3 & ~x4 & (~new_n146_ | x4);
  ...
  assign new_n188_ = x5 ? new_n189_ : (~x6 & (~new_n83_ | x2 | ~x3 | x6));
  ...
  assign new_n196_ = ~x6 & (x2 | (x3 & (~new_n83_ | ~x3 | x6)));
  ...
  assign new_n225_ = x5 & ((~x4 & x7) | (new_n83_ & ~x2 & x4));
  ...
  assign new_n243_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n245_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n245_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
