...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n76_, new_n78_, new_n81_, new_n83_, new_n84_, new_n92_, new_n94_,
  ...
  assign z59 = ~new_n227_ | new_n217_ | new_n228_ | new_n218_ | new_n221_ | new_n225_;
  assign new_n217_ = x5 & ((~x4 & x7) | (new_n84_ & ~x2 & x4));
  assign new_n218_ = x3 & (~new_n220_ | (~new_n219_ & ~x5));
  assign new_n219_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n220_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n221_ = ~x3 & ((~new_n222_ & ~x0) | new_n223_ | (~new_n224_ & x0));
  assign new_n222_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n223_ = ~x2 & (x0 | (x1 & x4));
  assign new_n224_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n225_ = ~new_n226_ & ~x5;
  assign new_n226_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n227_ = (x0 | ~x2 | ~x4) & (x4 | ~x5 | x6 | x7);
  assign new_n228_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z61 = ~new_n231_ | (~x4 & ((~new_n230_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n230_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n231_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n233_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n233_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
