...
module FAU ( 
  ...
  assign new_n155_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n127_ | x4 | x5)))));
  ...
  assign new_n163_ = (x1 | ((~x2 | ~x3) & (~new_n154_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n164_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n165_;
  assign new_n165_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z54 = (~new_n167_ & ~x0) | new_n168_ | ~new_n170_;
  assign new_n167_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n143_ | ~x5))));
  assign new_n168_ = ~x1 & ((~new_n169_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n169_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n170_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n159_ & ~x4));
  assign z56 = (~new_n172_ & ~x4) | ~new_n175_ | (~new_n174_ & x3);
  assign new_n172_ = (new_n173_ | ~x6) & (~x5 | x6) & (x5 | ((x2 | x3) & (new_n83_ | x6)));
  ...
  assign new_n177_ = (new_n178_ | x5) & ~new_n179_ & (new_n180_ | ~x5) & (~new_n127_ | x4);
