...
module FAU ( 
  ...
  wire new_n74_, new_n78_, new_n80_, new_n82_, new_n85_, new_n87_, new_n89_,
    new_n90_, new_n92_, new_n94_, new_n105_, new_n108_, new_n114_,
  ...
  assign new_n94_ = x5 & ~x4 & new_n90_ & ~x2 & x3;
  ...
  assign z49 = new_n204_ | ~new_n205_ | (~x3 & (new_n191_ | new_n145_));
  ...
  assign new_n208_ = (x1 | ((~x2 | ~x3) & (~new_n179_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n224_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n157_ | ~x5))));
  assign new_n225_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n226_ & ~x4));
  assign new_n226_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n227_ = (~x0 | (~new_n184_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n233_ = (new_n234_ | ~x6) & (~x5 | x6) & (x5 | (~new_n189_ & (x6 | (~x0 & x1))));
  ...
  assign new_n238_ = x3 & (new_n239_ | x5) & ~new_n240_ & ~new_n169_ & (new_n241_ | ~x5);
  ...
  assign new_n245_ = (new_n246_ | x4) & (~new_n189_ | x1);
  ...
  assign new_n254_ = ~new_n145_ & (x0 | ~x2 | ~x4);
  assign new_n255_ = x5 & ((~x4 & x7) | (new_n90_ & ~x2 & x4));
