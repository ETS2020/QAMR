...
module FAU ( 
  ...
  assign z46 = new_n191_ | ~new_n192_ | (~x4 & (~new_n189_ | (~new_n188_ & ~x0)));
  assign new_n188_ = ~x5 & (~new_n140_ | x5 | ~x1 | x2 | x3);
  ...
  assign z49 = new_n203_ | ~new_n204_ | (~x3 & (new_n190_ | new_n145_));
  ...
  assign new_n207_ = (x1 | ((~x2 | ~x3) & (~new_n179_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n216_ | ~new_n215_ | (x3 & (new_n214_ | new_n145_ | new_n217_));
  assign new_n214_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n215_ = ~new_n176_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n216_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign new_n217_ = x1 & (x4 | ~x6);
  ...
  assign new_n223_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n157_ | ~x5))));
  assign new_n224_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n225_ & ~x4));
  assign new_n225_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n226_ = (~x0 | (~new_n184_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n232_ = x3 & (new_n233_ | x5) & ~new_n234_ & ~new_n169_ & (new_n235_ | ~x5);
  ...
  assign new_n248_ = ~new_n145_ & (x0 | ~x2 | ~x4);
