// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:56 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
  ...
  assign z40 = (~new_n123_ & ~x3) | ~new_n129_ | (~new_n125_ & ~x5);
  assign new_n123_ = (x0 | x1 | ~x2) & (~x1 | x2 | ~x4) & (~new_n124_ | x4 | ~x5);
  ...
  assign z43 = (~new_n141_ & x4) | new_n121_ | new_n140_ | (~new_n142_ & ~x4);
  assign new_n140_ = x0 & ((new_n119_ & ~x4) | (new_n75_ & x2));
  ...
  assign new_n144_ = x3 & (x4 ? ~x0 : (~new_n145_ & ~x6));
  assign new_n145_ = (~x5 | x7) & (~x0 | x1 | x2 | x5);
  assign new_n146_ = (~x0 | (~x4 & (~new_n75_ | ~x2))) & (new_n147_ | x4) & (x0 | ((~new_n75_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n147_ = (~x5 | (~x7 & (x3 | x6 | x7))) & (~x6 | (x5 & (~x5 | x7)));
  assign z45 = ((new_n149_ | ~new_n151_) & ~x2) | new_n157_ | ~new_n154_ | (~new_n152_ & x2);
  assign new_n149_ = x0 & (~x3 | (new_n150_ & ~x1 & ~x4));
  assign new_n150_ = ~x5 & x6 & x7;
  assign new_n151_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n119_ | x4 | x5)))));
  assign new_n152_ = new_n153_ & (~x0 | (x3 & (~new_n150_ | x1 | ~x3 | x4)));
  assign new_n153_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n154_ = ~new_n156_ & ((~z00 & ~new_n155_) | ~x0);
  assign new_n155_ = x1 & x3 & x7;
  assign new_n156_ = ~x4 & ((~x7 & ((x3 & (~x5 ^ ~x6)) | (x5 & (x6 | (~x3 & ~x6))))) | (x5 & x7) | (~x1 & ~x5 & ~x6));
  assign new_n157_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z50 = (~new_n159_ & x0) | (~new_n160_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n159_ = (x1 | ((~x2 | ~x3) & (~new_n150_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n167_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n155_ & ~x4));
  assign z56 = (~new_n169_ & ~x4) | ~new_n173_ | (~new_n172_ & x3);
  assign new_n169_ = (new_n171_ | ~x6) & (~x5 | x6) & (x5 | (~new_n170_ & (x6 | (~x0 & x1))));
  ...
  assign z57 = (x0 & (~new_n175_ | ~x3)) | ~new_n182_ | (~x0 & (~new_n179_ | new_n184_));
  assign new_n175_ = (new_n176_ | x5) & ~new_n177_ & (~new_n119_ | x4) & (new_n178_ | ~x5);
  assign new_n176_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n177_ = x2 & (x4 | (~x1 & x3));
  assign new_n178_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n179_ = ~new_n180_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n181_ & ~x3));
  assign new_n180_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n181_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n182_ = (new_n183_ | x4) & (~new_n170_ | x1);
  assign new_n183_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n184_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z60 = new_n187_ | ~new_n188_ | (~x4 & (~x5 | (~new_n186_ & x5)));
  assign new_n186_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n187_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n188_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z62 = ~new_n190_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n190_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z04 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
