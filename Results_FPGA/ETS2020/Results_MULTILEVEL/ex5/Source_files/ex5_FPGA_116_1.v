// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:58 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n86_, new_n88_, new_n96_,
    new_n99_, new_n105_, new_n106_, new_n108_, new_n109_, new_n110_,
    ...
    new_n213_, new_n215_, new_n216_, new_n218_;
  ...
  assign z40 = new_n123_ | (~new_n125_ & ~x5) | new_n131_ | ~new_n129_ | new_n132_;
  ...
  assign new_n129_ = (x0 | ((x2 | ~x3 | ~x4) & (x4 | ~x7))) & (~new_n130_ | x4);
  ...
  assign new_n153_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = new_n160_ | ~new_n161_ | (~x3 & (new_n147_ | new_n124_));
  ...
  assign new_n164_ = x5 ? new_n165_ : new_n166_;
  assign new_n165_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n166_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n171_ | ~new_n169_ | (x3 & (new_n168_ | new_n170_ | new_n124_));
  assign new_n168_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n169_ = ~new_n142_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n170_ = x1 & (x4 | ~x6);
  assign new_n171_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n175_ | (~x4 & (x5 ? ~new_n173_ : ~new_n174_));
  assign new_n173_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n174_ = ~x6 & (x2 | (x3 & (~x0 | x1 | ~x3 | x6)));
  assign new_n175_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n179_ | ~new_n181_ | (~new_n177_ & ~x0);
  assign new_n177_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n178_ | ~x5))));
  ...
  assign new_n188_ = (new_n189_ | ~x6) & (~x5 | x6) & (x5 | (~new_n145_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n198_ | new_n208_ | new_n209_ | new_n199_ | new_n202_ | new_n206_;
  assign new_n198_ = ~new_n124_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n208_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
  ...
  assign z62 = ~new_n218_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n218_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
