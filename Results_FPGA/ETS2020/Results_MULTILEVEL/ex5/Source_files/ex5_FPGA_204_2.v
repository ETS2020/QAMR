// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:01 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_, new_n103_,
  ...
  assign z38 = new_n106_ | new_n109_ | new_n110_ | new_n117_;
  ...
  assign new_n130_ = (~x2 | (x6 & (x1 | ~x3 | x4 | ~x6 | ~x7))) & (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7)));
  ...
  assign new_n151_ = (new_n153_ | x4) & ((~z00 & ~new_n152_) | ~x0);
  assign new_n152_ = x1 & x3 & x7;
  assign new_n153_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  assign new_n154_ = x4 & (x0 | (~x0 & ~x1 & x2 & x3 & ~x5));
  assign z50 = (~new_n156_ & x0) | (~new_n157_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n156_ = (x1 | ((~x2 | ~x3) & (~new_n147_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n164_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n152_ & ~x4));
  assign z57 = (x0 & (~new_n166_ | ~x3)) | ~new_n173_ | (~x0 & (~new_n170_ | new_n175_));
  assign new_n166_ = (new_n167_ | x5) & ~new_n168_ & (new_n169_ | ~x5) & (~new_n122_ | x4);
  assign new_n167_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n168_ = x2 & (x4 | (~x1 & x3));
  assign new_n169_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n170_ = ~new_n171_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n172_ & ~x3));
  assign new_n171_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n172_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n173_ = (x1 | x2 | x3) & (new_n174_ | x4);
  assign new_n174_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n175_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z60 = new_n178_ | ~new_n179_ | (~x4 & (~x5 | (~new_n177_ & x5)));
  assign new_n177_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n178_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n179_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
