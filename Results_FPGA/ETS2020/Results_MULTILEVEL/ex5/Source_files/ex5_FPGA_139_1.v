...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n94_,
    new_n97_, new_n100_, new_n104_, new_n105_, new_n107_, new_n108_,
  ...
  assign z25 = ~x7 & x6 & ~x5 & new_n85_ & ~x3 & ~x4;
  ...
  assign z41 = (~x4 & (~new_n136_ | (~new_n135_ & x0))) | ~new_n133_ | new_n137_;
  assign new_n133_ = (new_n134_ | ~x0) & (x0 | ~x1) & (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6)));
  assign new_n134_ = (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n135_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | x5 | ~x6 | ~x7);
  ...
  assign z46 = new_n147_ | ~new_n148_ | (~x4 & (~new_n144_ | (~new_n146_ & ~x0)));
  assign new_n144_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n145_ | ~x6 | ~x7)))));
  assign new_n145_ = ~x1 & ~x2;
  assign new_n146_ = ~x5 & (~x1 | x2 | x3 | x5 | ~x6 | x7);
  ...
  assign new_n150_ = (~x0 | ~x6 | (x7 & (~new_n145_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n151_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n152_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  assign z49 = new_n154_ | ~new_n155_ | (~x3 & (new_n145_ | new_n123_));
  ...
  assign z52 = new_n165_ | ~new_n163_ | (x3 & (new_n162_ | new_n164_ | new_n123_));
  ...
  assign z55 = ~new_n171_ | (~x4 & (x5 ? ~new_n173_ : (x6 | (~x1 & ~x6))));
  assign new_n171_ = ~new_n172_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n172_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n173_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  ...
  assign z59 = ~new_n180_ | new_n190_ | new_n191_ | new_n181_ | new_n184_ | new_n188_;
  assign new_n180_ = ~new_n123_ & (x0 | ~x2 | ~x4);
  assign new_n181_ = x3 & (~new_n183_ | (~new_n182_ & ~x5));
  assign new_n182_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n183_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n184_ = ~x3 & ((~new_n185_ & ~x0) | new_n186_ | (~new_n187_ & x0));
  assign new_n185_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n186_ = ~x2 & (x0 | (x1 & x4));
  assign new_n187_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n188_ = ~new_n189_ & ~x5;
  assign new_n189_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
