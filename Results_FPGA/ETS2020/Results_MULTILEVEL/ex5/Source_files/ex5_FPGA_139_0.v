...
module FAU ( 
  ...
  assign z45 = (~x2 & (new_n158_ | ~new_n160_)) | new_n166_ | ~new_n163_ | (~new_n161_ & x2);
  assign new_n158_ = x0 & (~x3 | (new_n159_ & ~x1 & ~x4));
  assign new_n159_ = ~x5 & x6 & x7;
  assign new_n160_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n131_ | x4 | x5)))));
  assign new_n161_ = new_n162_ & (~x0 | (x3 & (~new_n159_ | x1 | ~x3 | x4)));
  assign new_n162_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n163_ = ~new_n165_ & (~x0 | (~z00 & ~new_n164_));
  ...
  assign new_n168_ = ~x5 & (~new_n131_ | x5 | ~new_n169_ | ~x1);
  ...
  assign z49 = ~new_n185_ | (~new_n184_ & ~x3) | (x0 & (x4 | (new_n148_ & ~x4)));
  ...
  assign new_n188_ = (x1 | ((~x2 | ~x3) & (~new_n159_ | x2 | x4))) & x3 & ~x4 & (~new_n148_ | x4);
  ...
  assign new_n197_ = ~new_n156_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign z54 = (~new_n204_ & ~x0) | new_n205_ | ~new_n207_;
  assign new_n204_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n136_ | ~x5))));
  assign new_n205_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n206_ & ~x4));
  assign new_n206_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n207_ = (~x0 | (~new_n164_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n209_ | (~x4 & (x5 ? ~new_n211_ : (x6 | (~x1 & ~x6))));
  assign new_n209_ = ~new_n210_ & (~x0 | (x2 ? (~new_n148_ & ~x4) : x3));
  ...
  assign new_n213_ = (new_n214_ | ~x6) & (~x5 | x6) & (x5 | (~new_n169_ & (x6 | (~x0 & x1))));
  ...
  assign new_n218_ = x3 & (new_n219_ | x5) & ~new_n220_ & ~new_n149_ & (new_n221_ | ~x5);
  ...
  assign new_n225_ = (new_n226_ | x4) & (~new_n169_ | x1);
  ...
  assign new_n234_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
