...
module FAU ( 
  ...
  assign z43 = (~new_n146_ & x4) | new_n126_ | new_n147_ | (~new_n148_ & ~x4);
  ...
  assign new_n152_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n124_ | x4 | x5)))));
  ...
  assign new_n170_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n171_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z54 = (~new_n173_ & ~x0) | new_n174_ | ~new_n176_;
  assign new_n173_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n140_ | ~x5))));
  assign new_n174_ = ~x1 & ((~new_n175_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n175_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (x2 ^ ~x3));
  assign new_n176_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n156_ & ~x4));
