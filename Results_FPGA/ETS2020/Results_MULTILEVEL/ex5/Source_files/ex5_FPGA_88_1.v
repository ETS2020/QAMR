...
module FAU ( 
  ...
  assign z49 = new_n158_ | ~new_n159_ | (~x3 & (new_n150_ | new_n125_));
  ...
  assign new_n174_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n136_ | ~x5))));
