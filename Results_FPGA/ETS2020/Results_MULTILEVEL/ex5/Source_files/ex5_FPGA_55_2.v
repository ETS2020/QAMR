// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:15 2020
...
module FAU ( 
  ...
  assign z54 = (~new_n164_ & ~x0) | new_n165_ | ~new_n167_;
  assign new_n164_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n135_ | ~x5))));
  assign new_n165_ = ~x1 & ((~new_n166_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n166_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n167_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n156_ & ~x4));
  assign z57 = (x0 & (~new_n169_ | ~x3)) | ~new_n176_ | (~x0 & (~new_n173_ | new_n178_));
  assign new_n169_ = (new_n170_ | x5) & ~new_n171_ & (new_n172_ | ~x5) & (~new_n119_ | x4);
  ...
  assign z61 = ~new_n181_ | (~x4 & ((~new_n180_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n180_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n181_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n183_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n183_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z04 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
