...
module FAU ( 
  ...
  assign new_n151_ = (x1 | ((~x2 | ~x3) & (~new_n142_ | x2 | x4))) & x3 & ~z00 & ~x4;
  ...
  assign new_n155_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n156_ | ~x5))));
  assign new_n156_ = x6 & x7;
  assign new_n157_ = ~x1 & ((~new_n158_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n158_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n159_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n147_ & ~x4));
  ...
  assign z60 = new_n173_ | ~new_n174_ | (~x4 & (~x5 | (~new_n172_ & x5)));
  assign new_n172_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n173_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n174_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z62 = ~new_n176_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n176_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
