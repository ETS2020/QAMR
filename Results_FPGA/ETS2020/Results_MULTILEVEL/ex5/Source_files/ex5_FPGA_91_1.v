...
module FAU ( 
  ...
  assign z49 = new_n164_ | ~new_n165_ | (~x3 & (new_n150_ | new_n123_));
  ...
  assign z52 = new_n175_ | ~new_n173_ | (x3 & (new_n172_ | new_n174_ | new_n123_));
  ...
  assign new_n203_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n205_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n205_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x0 | x1 | ~x2) & (~x1 | x6))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z04 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
