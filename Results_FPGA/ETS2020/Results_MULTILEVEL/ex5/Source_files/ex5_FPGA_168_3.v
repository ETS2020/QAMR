...
module FAU ( 
  ...
  assign new_n121_ = (x0 | (~x7 & (x5 | x6))) & (new_n122_ | ~x6) & (~x5 | (~x7 & (x3 | x6 | x7))) & (~x0 | x5 | x6);
  assign new_n122_ = (~x2 | x5 | ((~x0 | ~x7 | (x3 & (x1 | ~x3))) & (~x1 | ~x3))) & (x7 | (~x0 & ~x5));
  assign new_n123_ = (~x4 | ((~x0 | (~x2 & (x1 | x2 | ~x5))) & (~x1 | (~x3 & (x2 | x3))) & (x0 | (~x2 & (x2 | (~x3 & (x1 | x3))))))) & (x5 | ((~x1 | (x2 & (x0 | ~x2 | x3))) & (x0 | (x2 ? ~x3 : x1))));
  ...
  assign new_n133_ = (~x1 | (~x7 & (x4 | ~x5))) & (x1 | ~x2 | x4 | x5 | ~x6 | ~x7);
  assign new_n134_ = (~x2 | ~x4) & (x1 | x2 | x5 | (~x4 & (x4 | ~x6 | ~x7)));
  assign new_n135_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x1 | x4 | x5 | x6);
  assign z38 = new_n115_ | new_n118_ | new_n119_ | new_n137_;
  ...
  assign z43 = (~new_n171_ & x4) | new_n144_ | new_n170_ | (~new_n172_ & ~x4);
  assign new_n170_ = x0 & ((new_n142_ & ~x4) | (new_n74_ & x2));
  ...
  assign new_n181_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n142_ | x4 | x5)))));
  ...
  assign new_n189_ = ~x5 & (~new_n142_ | x5 | ~new_n190_ | ~x1);
  ...
  assign z52 = new_n214_ | ~new_n212_ | (x3 & (new_n211_ | new_n213_ | new_n147_));
  ...
  assign new_n221_ = ~x1 & ((~new_n222_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n222_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n223_ = (~x0 | (~new_n185_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n229_ = (new_n230_ | ~x6) & (~x5 | x6) & (x5 | (~new_n190_ & (x6 | (~x0 & x1))));
  ...
  assign z57 = (x0 & (~new_n234_ | ~x3)) | ~new_n241_ | (~x0 & (~new_n238_ | new_n243_));
  assign new_n234_ = (new_n235_ | x5) & ~new_n236_ & (new_n237_ | ~x5) & (~new_n142_ | x4);
  ...
  assign new_n241_ = (new_n242_ | x4) & (~new_n190_ | x1);
