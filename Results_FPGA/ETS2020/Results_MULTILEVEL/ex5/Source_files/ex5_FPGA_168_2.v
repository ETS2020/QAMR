...
module FAU ( 
  ...
  assign z43 = (~new_n145_ & x4) | new_n125_ | new_n143_ | (~new_n146_ & ~x4);
  assign new_n143_ = x0 & (new_n144_ | (x2 & ~x5 & ~x6));
  ...
  assign new_n150_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n123_ | x4 | x5)))));
  ...
  assign new_n161_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z50 = (~new_n163_ & x0) | (~new_n164_ & ~x4) | (~x0 & (x4 | ~x7));
  assign new_n163_ = (x1 | ((~x2 | ~x3) & (~new_n149_ | x2 | x4))) & x3 & ~z00 & ~x4;
  assign new_n164_ = x5 ? (~x7 & (x7 | (~x6 & (~x3 | x6)))) : new_n165_;
  assign new_n165_ = (~x3 | ~x6 | (x7 & (~x1 | ~x2))) & (x0 | (x6 & (~x2 | ~x6)));
  assign z51 = (~new_n167_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n167_ = x5 ? new_n168_ : (~x6 & (~new_n91_ | x2 | ~x3 | x6));
  assign new_n168_ = (~x0 | ((~x1 | (~x3 & (~x2 | x3 | ~x6 | ~x7))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  ...
  assign new_n174_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n154_ & ~x4));
  assign z57 = (~new_n176_ & x0) | ~new_n183_ | (~x0 & (~new_n180_ | new_n185_));
  assign new_n176_ = x3 & (new_n177_ | x5) & ~new_n178_ & ~new_n144_ & (new_n179_ | ~x5);
