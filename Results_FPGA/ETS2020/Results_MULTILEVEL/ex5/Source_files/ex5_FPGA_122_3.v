...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    new_n92_, new_n94_, new_n102_, new_n105_, new_n111_, new_n112_,
  ...
  assign new_n192_ = ~x5 & (~new_n144_ | x5 | ~new_n193_ | ~x1);
  ...
  assign z49 = new_n203_ | ~new_n204_ | (~x3 & (new_n195_ | new_n149_));
  ...
  assign new_n207_ = (x1 | ((~x2 | ~x3) & (~new_n183_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign new_n226_ = (~x0 | (~new_n188_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign z56 = (~new_n232_ & ~x4) | ~new_n235_ | (~new_n234_ & x3);
  assign new_n232_ = (new_n233_ | ~x6) & (~x5 | x6) & (x5 | (~new_n193_ & (x6 | (~x0 & x1))));
  assign new_n233_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n234_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n235_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (~new_n237_ & x0) | ~new_n244_ | (~x0 & (~new_n241_ | new_n246_));
  assign new_n237_ = x3 & (new_n238_ | x5) & ~new_n239_ & ~new_n173_ & (new_n240_ | ~x5);
  assign new_n238_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n239_ = x2 & (x4 | (~x1 & x3));
  assign new_n240_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n241_ = ~new_n242_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n243_ & ~x3));
  assign new_n242_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n243_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n244_ = (new_n245_ | x4) & (~new_n193_ | x1);
  assign new_n245_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n246_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z58 = ~new_n251_ | (~new_n248_ & ~x4);
  assign new_n248_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n249_ | x5) & (~x5 | (x6 & (new_n250_ | ~x6)));
  assign new_n249_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n250_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n251_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n253_ | new_n254_ | new_n264_ | new_n255_ | new_n258_ | new_n262_;
  assign new_n253_ = ~new_n149_ & (x0 | ~x2 | ~x4);
