...
module FAU ( 
  ...
  assign z41 = (~x4 & (~new_n127_ | (~new_n123_ & x0))) | ~new_n125_ | new_n128_;
  assign new_n123_ = (~x1 | ~x3 | ~x5) & (~new_n124_ | x1 | x2);
  assign new_n124_ = ~x5 & x6 & x7;
  assign new_n125_ = (new_n126_ | ~x0) & (x0 | ~x1) & (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6)));
  assign new_n126_ = (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n127_ = (x0 | (~x5 & ~x7)) & (x5 | ((x1 | x6) & (~x3 | ~x6 | x7)));
  assign new_n128_ = ~x1 & ((x0 & (x2 ? x3 : (x4 & ~x5))) | (~x3 & (~x2 | (~x0 & x2))));
  ...
  assign new_n135_ = ~x6 & ((x5 & ~x7) | (new_n88_ & ~x2 & ~x5));
  ...
  assign z47 = new_n140_ | ~new_n143_;
  assign new_n140_ = ~x4 & ((~new_n141_ & ~x5) | (x0 & ~new_n142_ & x6) | (x5 & (~x0 | ~x6)));
  assign new_n141_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n142_ = x7 & (x1 | x2 | ~x3 | ~x5 | ~x7);
  assign new_n143_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((~x1 | x3) & (x0 | (~x3 & (x1 | x3))))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = (x0 & (x4 | (new_n74_ & ~x4))) | ~new_n150_ | (~new_n152_ & ~x3);
  ...
  assign new_n154_ = (x1 | ((~x2 | ~x3) & (~new_n124_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n164_ | ~new_n163_ | (~new_n161_ & x3);
  assign new_n161_ = ~new_n162_ & (x4 | ~x5 | x6 | x7) & (~x1 | (~x4 & x6));
  assign new_n162_ = x0 & ~x1 & (x2 | (~x2 & ~x4 & ~x5 & ~x6));
  ...
  assign z59 = ~new_n195_ | new_n185_ | new_n196_ | new_n186_ | new_n189_ | new_n193_;
  assign new_n185_ = x5 & ((~x4 & x7) | (new_n88_ & ~x2 & x4));
  ...
  assign new_n195_ = (x0 | ~x2 | ~x4) & (x4 | ~x5 | x6 | x7);
  ...
  assign new_n202_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
  assign z14 = 1'b0;
