// Benchmark "FAU" written by ABC on Thu Aug  6 04:05:58 2020
...
module FAU ( 
  ...
  assign z59 = ~new_n253_ | new_n254_ | new_n264_ | new_n255_ | new_n258_ | new_n262_;
  assign new_n253_ = ~new_n154_ & (x0 | ~x2 | ~x4);
  assign new_n254_ = x5 & ((~x4 & x7) | (new_n92_ & ~x2 & x4));
  assign new_n255_ = x3 & (~new_n257_ | (~new_n256_ & ~x5));
  assign new_n256_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n257_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n258_ = ~x3 & ((~new_n259_ & ~x0) | new_n260_ | (~new_n261_ & x0));
  assign new_n259_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n260_ = ~x2 & (x0 | (x1 & x4));
  assign new_n261_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n262_ = ~new_n263_ & ~x5;
  assign new_n263_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n264_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n267_ | ~new_n268_ | (~x4 & (~x5 | (~new_n266_ & x5)));
  assign new_n266_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n267_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n268_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n271_ | (~x4 & ((~new_n270_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n270_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n271_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z00 = 1'b0;
  assign z48 = 1'b0;
  assign z58 = 1'b0;
  assign z62 = 1'b0;
