// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:01 2020
...
module FAU ( 
  ...
  assign z49 = new_n156_ | ~new_n157_ | (~x3 & (new_n142_ | new_n126_));
  ...
  assign z52 = new_n166_ | ~new_n164_ | (x3 & (new_n163_ | new_n165_ | new_n126_));
  assign new_n163_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n164_ = ~new_n139_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n165_ = x1 & (x4 | ~x6);
  assign new_n166_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n170_ | (~x4 & (x5 ? ~new_n169_ : ~new_n168_));
  assign new_n168_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign z59 = ~new_n188_ | new_n189_ | new_n199_ | new_n190_ | new_n193_ | new_n197_;
  assign new_n188_ = ~new_n126_ & (x0 | ~x2 | ~x4);
  assign new_n189_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
