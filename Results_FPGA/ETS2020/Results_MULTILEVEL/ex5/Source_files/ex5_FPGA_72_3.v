...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    ...
    new_n270_, new_n271_, new_n273_, new_n274_;
  ...
  assign z46 = new_n199_ | ~new_n200_ | (~x4 & (~new_n197_ | (~new_n196_ & ~x0)));
  assign new_n196_ = ~x5 & (~new_n148_ | x5 | ~x1 | x2 | x3);
  ...
  assign z49 = new_n211_ | ~new_n212_ | (~x3 & (new_n198_ | new_n153_));
  ...
  assign new_n215_ = (x1 | ((~x2 | ~x3) & (~new_n187_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n225_ | ~new_n223_ | (x3 & (new_n222_ | new_n224_ | new_n153_));
  assign new_n222_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n223_ = ~new_n184_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n231_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n165_ | ~x5))));
  assign new_n232_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n233_ & ~x4));
  assign new_n233_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n234_ = (~x0 | (~new_n192_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n240_ = x3 & (new_n241_ | x5) & ~new_n242_ & ~new_n177_ & (new_n243_ | ~x5);
  ...
  assign new_n247_ = (x1 | x2 | x3) & (new_n248_ | x4);
  ...
  assign new_n256_ = ~new_n153_ & (x0 | ~x2 | ~x4);
  assign new_n257_ = x5 & ((~x4 & x7) | (new_n92_ & ~x2 & x4));
