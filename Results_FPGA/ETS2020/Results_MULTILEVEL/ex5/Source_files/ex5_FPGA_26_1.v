...
module FAU ( 
  ...
  assign z44 = new_n140_ | ~new_n138_ | (x3 & (x4 ? ~x0 : new_n137_));
  assign new_n137_ = ~x6 & ((x5 & ~x7) | (new_n87_ & ~x2 & ~x5));
  ...
  assign new_n174_ = x3 ? ((x2 | (~x4 & x5)) & (~x4 | x5 | x1 | ~x2)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n131_ | ~x5))));
