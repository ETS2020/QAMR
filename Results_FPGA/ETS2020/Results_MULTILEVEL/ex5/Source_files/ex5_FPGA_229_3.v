// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:19 2020
...
module FAU ( 
  ...
  assign z41 = ~new_n160_ | new_n163_ | (~x4 & (~new_n162_ | (~new_n158_ & x0)));
  assign new_n158_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | ~new_n159_ | x5);
  assign new_n159_ = x6 & x7;
  assign new_n160_ = (new_n161_ | ~x0) & (x0 | ~x1) & (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6)));
  assign new_n161_ = (~x2 | x3) & (~x1 | ~x3 | ~x7);
  assign new_n162_ = (x0 | (~x5 & ~x7)) & (x5 | ((x1 | x6) & (~x3 | ~x6 | x7)));
  assign new_n163_ = ~x1 & ((x0 & (x2 ? x3 : (x4 & ~x5))) | (~x3 & (~x2 | (~x0 & x2))));
  ...
  assign z43 = (~new_n172_ & x4) | new_n144_ | new_n170_ | (~new_n173_ & ~x4);
  ...
  assign new_n182_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n142_ | x4 | x5)))));
  ...
  assign z46 = new_n193_ | ~new_n194_ | (~x4 & (~new_n191_ | (~new_n190_ & ~x0)));
  assign new_n190_ = ~x5 & (~new_n142_ | x5 | ~x1 | x2 | x3);
  assign new_n191_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n192_ | ~x6 | ~x7)))));
  assign new_n192_ = ~x1 & ~x2;
  assign new_n193_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n194_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n198_ | (~x4 & (~new_n196_ | (~new_n197_ & ~x5)));
  assign new_n196_ = (~x0 | ~x6 | (x7 & (~new_n192_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  ...
  assign z48 = ~new_n200_ | new_n203_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n200_ = new_n202_ & (x2 | ((x1 | x3) & (~x0 | (~new_n201_ & x3))));
  assign new_n201_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n202_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n203_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n205_ | ~new_n206_ | (~x3 & (new_n192_ | new_n147_));
  ...
  assign new_n209_ = (x1 | ((~x2 | ~x3) & (~new_n181_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n218_ | ~new_n217_ | (x3 & (new_n216_ | new_n147_ | new_n219_));
  assign new_n216_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n217_ = ~new_n178_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n218_ = ~x0 & (x1 | (x2 & x3 & x4));
  ...
  assign new_n225_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n159_ | ~x5))));
  assign new_n226_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n227_ & ~x4));
  assign new_n227_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n228_ = (~x0 | (~new_n186_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign z57 = (~new_n234_ & x0) | ~new_n241_ | (~x0 & (~new_n238_ | new_n243_));
  assign new_n234_ = x3 & (new_n235_ | x5) & ~new_n236_ & ~new_n171_ & (new_n237_ | ~x5);
  assign new_n235_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n236_ = x2 & (x4 | (~x1 & x3));
  assign new_n237_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n238_ = ~new_n239_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n240_ & ~x3));
  assign new_n239_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n240_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n241_ = (x1 | x2 | x3) & (new_n242_ | x4);
  assign new_n242_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n243_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z58 = ~new_n248_ | (~new_n245_ & ~x4);
  assign new_n245_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n246_ | x5) & (~x5 | (x6 & (new_n247_ | ~x6)));
  assign new_n246_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n247_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n248_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n250_ | new_n251_ | new_n261_ | new_n252_ | new_n255_ | new_n259_;
  assign new_n250_ = ~new_n147_ & (x0 | ~x2 | ~x4);
  assign new_n251_ = x5 & ((~x4 & x7) | (new_n92_ & ~x2 & x4));
  assign new_n252_ = x3 & (~new_n254_ | (~new_n253_ & ~x5));
  assign new_n253_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n254_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n255_ = ~x3 & ((~new_n256_ & ~x0) | new_n257_ | (~new_n258_ & x0));
  assign new_n256_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n257_ = ~x2 & (x0 | (x1 & x4));
  assign new_n258_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n259_ = ~new_n260_ & ~x5;
  assign new_n260_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n261_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n264_ | ~new_n265_ | (~x4 & (~x5 | (~new_n263_ & x5)));
  assign new_n263_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n264_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n265_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n268_ | (~x4 & ((~new_n267_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n267_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n268_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z00 = 1'b0;
  assign z37 = 1'b0;
  assign z56 = 1'b0;
  assign z62 = 1'b0;
