// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:05 2020
...
module FAU ( 
  ...
  wire new_n75_, new_n81_, new_n83_, new_n85_, new_n88_, new_n90_, new_n92_,
    new_n102_, new_n106_, new_n107_, new_n109_, new_n110_, new_n111_,
  ...
  assign z32 = new_n109_ | new_n111_ | new_n112_ | new_n113_;
  assign new_n109_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | (~new_n110_ & ~x5) | (~x7 & (x6 ? (x0 | x5) : x5)) | (x5 & x7));
  assign new_n110_ = (~x0 | x1 | x2 | (x6 ? ~x7 : x3)) & (~x3 | ~x6 | (x7 & (~x1 | ~x2)));
  assign new_n111_ = ~x2 & ((x4 & ((~x0 & (x3 | (~x1 & ~x3))) | (x1 & ~x3) | (x0 & ~x1 & ~x5))) | (x1 & ~x5));
  assign new_n112_ = x2 & (x0 ? (~x3 | (~x1 & x3)) : (~x1 & ~x3));
  assign new_n113_ = x1 & (~x0 | (x3 & (x4 | ~x6)));
  assign z35 = new_n106_ | (~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7)))));
  assign z38 = new_n109_ | new_n112_ | new_n113_ | new_n116_;
  ...
  assign z40 = (~new_n125_ & ~x3) | ~new_n131_ | (~new_n127_ & ~x5);
  assign new_n125_ = (x0 | x1 | ~x2) & (~x1 | x2 | ~x4) & (~new_n126_ | x4 | ~x5);
  ...
  assign new_n131_ = ~new_n132_ & ~new_n133_ & ~new_n134_ & ~new_n135_;
  ...
  assign z43 = (~new_n143_ & x4) | new_n123_ | new_n142_ | (~new_n144_ & ~x4);
  assign new_n142_ = x0 & ((new_n121_ & ~x4) | (new_n75_ & x2));
  ...
  assign new_n146_ = x3 & (x4 ? ~x0 : (~new_n147_ & ~x6));
  assign new_n147_ = (~x5 | x7) & (~x0 | x1 | x2 | x5);
  assign new_n148_ = (~x0 | (~x4 & (~new_n75_ | ~x2))) & (new_n149_ | x4) & (x0 | ((~new_n75_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n149_ = (~x5 | (~x7 & (x3 | x6 | x7))) & (~x6 | (x5 & (~x5 | x7)));
  ...
  assign new_n153_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n121_ | x4 | x5)))));
  ...
  assign new_n161_ = (x1 | ((~x2 | ~x3) & (~new_n152_ | x2 | x4))) & x3 & ~x4 & (~new_n75_ | x4);
  ...
  assign new_n165_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n166_ | ~x5))));
  assign new_n166_ = x6 & x7;
  assign new_n167_ = ~x1 & ((~new_n168_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n168_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n169_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n157_ & ~x4));
  assign z57 = (x0 & (~new_n171_ | ~x3)) | ~new_n178_ | (~x0 & (~new_n175_ | new_n180_));
  assign new_n171_ = (new_n172_ | x5) & ~new_n173_ & (~new_n121_ | x4) & (new_n174_ | ~x5);
  ...
  assign new_n191_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z16 = 1'b0;
  assign z23 = 1'b0;
