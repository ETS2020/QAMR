// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:16 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n86_, new_n87_, new_n89_,
    new_n91_, new_n100_, new_n103_, new_n109_, new_n110_, new_n112_,
  ...
  assign new_n125_ = (~x3 | (x1 ? (~x4 & x6) : (~x2 | ~x5))) & (x5 | x6 | x1 | x4);
  ...
  assign new_n132_ = ~x4 & ((x3 & x6 & ~x7) | (~x0 & ~x6));
  assign new_n133_ = (x0 | ((x2 | ~x3 | ~x4) & (x4 | ~x7))) & (~new_n134_ | x4);
  ...
  assign z44 = new_n146_ | ~new_n144_ | (x3 & (x4 ? ~x0 : new_n143_));
  assign new_n143_ = ~x6 & ((x5 & ~x7) | (new_n87_ & ~x2 & ~x5));
  assign new_n144_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n145_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n145_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign new_n146_ = x1 & (~x0 | (~x2 & ~x5));
  ...
  assign new_n157_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((x0 | (~x3 & (x1 | x3))) & (~x1 | x3))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = new_n164_ | ~new_n165_ | (~x3 & (new_n151_ | new_n128_));
  ...
  assign new_n168_ = x5 ? new_n169_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  assign new_n169_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n174_ | ~new_n172_ | (x3 & (new_n171_ | new_n173_ | new_n128_));
  ...
  assign z53 = ~new_n178_ | (~x4 & (x5 ? ~new_n177_ : ~new_n176_));
  assign new_n176_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign z54 = new_n182_ | ~new_n184_ | (~new_n180_ & ~x0);
  assign new_n180_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n181_ | ~x5))));
  ...
  assign new_n201_ = ~new_n128_ & (x0 | ~x2 | ~x4);
  assign new_n202_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
  ...
  assign new_n218_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
