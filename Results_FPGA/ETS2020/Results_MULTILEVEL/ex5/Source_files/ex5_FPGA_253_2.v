...
module FAU ( 
  ...
  assign z35 = x4 ? ~new_n108_ : ((x6 & (~x5 | (x5 & ~x7))) | (x5 & x7) | (~x6 & (~x5 | (x5 & ~x7))));
  assign new_n108_ = (~x0 | (~x2 & (x1 | x2 | x5))) & (~x1 | (~x3 & (x2 | x3))) & (x0 | (x2 ? (x3 & (x1 | ~x3 | x5)) : ~x3));
  assign z38 = new_n102_ | new_n105_ | new_n106_ | new_n110_;
  ...
  assign new_n144_ = ~new_n146_ & ((~z00 & ~new_n145_) | ~x0);
  ...
  assign new_n167_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x6 | ~x7 | ~x3 | x4)));
