...
module FAU ( 
  ...
  wire new_n74_, new_n76_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_,
    new_n87_, new_n96_, new_n103_, new_n104_, new_n106_, new_n107_,
  ...
  assign z07 = x7 & x6 & new_n76_ & x5;
  assign new_n76_ = ~x4 & ~x3 & ~x2 & ~x0 & x1;
  ...
  assign z40 = new_n121_ | (~new_n123_ & ~x5) | new_n129_ | ~new_n127_ | new_n130_;
  ...
  assign new_n127_ = (x0 | ((x2 | ~x3 | ~x4) & (x4 | ~x7))) & (~new_n128_ | x4);
  ...
  assign z44 = new_n144_ | ~new_n146_ | (x1 & (~x0 | (~x2 & ~x5)));
  assign new_n144_ = x3 & (x4 ? ~x0 : new_n145_);
  assign new_n145_ = ~x6 & ((x5 & ~x7) | (x0 & ~x1 & ~x2 & ~x5));
  assign new_n146_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n147_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n147_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign z46 = new_n153_ | ~new_n154_ | (~x4 & (~new_n151_ | (~new_n149_ & ~x0)));
  assign new_n149_ = ~x5 & (~new_n150_ | ~x1 | x5 | ~x6 | x7);
  assign new_n150_ = ~x2 & ~x3;
  assign new_n151_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n152_ | ~x6 | ~x7)))));
  assign new_n152_ = ~x1 & ~x2;
  assign new_n153_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n154_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n158_ | (~x4 & (~new_n156_ | (~new_n157_ & ~x5)));
  assign new_n156_ = (~x0 | ~x6 | (x7 & (~new_n152_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n157_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n158_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((~x1 | x3) & (x0 | (~x3 & (x1 | x3))))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign new_n163_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n165_ | ~new_n166_ | (~x3 & (new_n152_ | new_n122_));
  assign new_n165_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n166_ = ~new_n167_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n167_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z51 = (~new_n169_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n169_ = x5 ? new_n170_ : (~x6 & (~new_n85_ | x2 | ~x3 | x6));
  assign new_n170_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n175_ | ~new_n173_ | (x3 & (new_n172_ | new_n174_ | new_n122_));
  assign new_n172_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n173_ = ~new_n147_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n174_ = x1 & (x4 | ~x6);
  assign new_n175_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n179_ | (~x4 & (x5 ? ~new_n178_ : ~new_n177_));
  assign new_n177_ = ~x6 & (x2 | (x3 & (~new_n85_ | ~x3 | x6)));
  assign new_n178_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  ...
  assign new_n181_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n133_ | ~x5))));
  ...
  assign new_n191_ = (new_n192_ | ~x6) & (~x5 | x6) & (x5 | (~new_n150_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n201_ | new_n202_ | new_n212_ | new_n203_ | new_n206_ | new_n210_;
  assign new_n201_ = ~new_n122_ & (x0 | ~x2 | ~x4);
  assign new_n202_ = x5 & ((~x4 & x7) | (new_n85_ & ~x2 & x4));
  assign new_n203_ = x3 & (~new_n205_ | (~new_n204_ & ~x5));
  assign new_n204_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n205_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n206_ = ~x3 & ((~new_n207_ & ~x0) | new_n208_ | (~new_n209_ & x0));
  assign new_n207_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n208_ = ~x2 & (x0 | (x1 & x4));
  assign new_n209_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n210_ = ~new_n211_ & ~x5;
  assign new_n211_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
