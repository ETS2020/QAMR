...
module FAU ( 
  ...
  assign z38 = new_n116_ | new_n119_ | new_n120_ | new_n130_;
  ...
  assign new_n151_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | ~new_n152_ | x5);
  assign new_n152_ = x6 & x7;
  assign new_n153_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n154_ | ~x3) & (x0 | ~x1);
  assign new_n154_ = (~x1 | x6) & ((x0 & ~x1) | ~x4);
  ...
  assign z43 = (~new_n165_ & x4) | new_n137_ | new_n163_ | (~new_n166_ & ~x4);
  assign new_n163_ = x0 & (new_n164_ | (new_n74_ & x2));
  ...
  assign new_n183_ = ~x5 & (~new_n135_ | x5 | ~new_n184_ | ~x1);
  ...
  assign new_n197_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (x0 & ~x3) | (~x1 & x3 & x5));
  assign z49 = new_n199_ | ~new_n200_ | (~x3 & (new_n186_ | new_n140_));
  ...
  assign new_n203_ = (x1 | ((~x2 | ~x3) & (~new_n174_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n212_ | ~new_n211_ | (x3 & (new_n210_ | new_n140_ | new_n213_));
  assign new_n210_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n211_ = ~new_n171_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n219_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n152_ | ~x5))));
  assign new_n220_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n221_ & ~x4));
  assign new_n221_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n222_ = (~x0 | (~new_n179_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n228_ = (new_n229_ | ~x6) & (~x5 | x6) & (x5 | (~new_n184_ & (x6 | (~x0 & x1))));
  ...
  assign new_n233_ = x3 & (new_n234_ | x5) & ~new_n235_ & ~new_n164_ & (new_n236_ | ~x5);
  ...
  assign new_n240_ = (new_n241_ | x4) & (~new_n184_ | x1);
  ...
  assign new_n249_ = ~new_n140_ & (x0 | ~x2 | ~x4);
