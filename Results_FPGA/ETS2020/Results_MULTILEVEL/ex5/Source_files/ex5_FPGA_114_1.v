// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:57 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n86_, new_n88_,
    new_n90_, new_n97_, new_n100_, new_n106_, new_n107_, new_n109_,
  ...
  assign new_n90_ = x5 & ~x4 & new_n86_ & ~x2 & x3;
  ...
  assign new_n144_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n145_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  ...
  assign new_n156_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((~x1 | x3) & (x0 | (~x3 & (x1 | x3))))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  assign z48 = ~new_n158_ | new_n161_ | (x1 & (~x0 | (x0 & x3 & x7)));
  assign new_n158_ = new_n160_ & (x2 | ((x1 | x3) & (~x0 | (~new_n159_ & x3))));
  assign new_n159_ = ~x1 & x3 & ~x4 & x5 & x6 & x7;
  assign new_n160_ = (~x0 | (~x4 & (x4 | x5 | x6))) & (x4 | (x5 ? (x6 & (~x6 | x7)) : ~x6));
  assign new_n161_ = x2 & ((~x0 & (x3 ? ~x5 : ~x1)) | (~x1 & x3 & x5) | (x0 & ~x3));
  assign z49 = new_n163_ | ~new_n164_ | (~x3 & (new_n150_ | new_n125_));
  assign new_n163_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n164_ = ~new_n165_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n165_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z51 = (~new_n167_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n167_ = x5 ? new_n168_ : (~x6 & (~new_n86_ | x2 | ~x3 | x6));
  assign new_n168_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign z52 = new_n173_ | ~new_n171_ | (x3 & (new_n170_ | new_n172_ | new_n125_));
  assign new_n170_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n171_ = ~new_n145_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  assign new_n172_ = x1 & (x4 | ~x6);
  assign new_n173_ = ~x0 & (x1 | (x2 & x3 & x4));
  assign z53 = ~new_n177_ | (~x4 & (x5 ? ~new_n176_ : ~new_n175_));
  assign new_n175_ = ~x6 & (x2 | (x3 & (~new_n86_ | ~x3 | x6)));
  assign new_n176_ = x6 & (~x6 | (x7 & (~x7 | ((~x1 | (x2 ? x0 : (~x0 & (x0 | ~x3)))) & (~x0 | x1 | x2 | ~x3)))));
  assign new_n177_ = (x1 | (x2 ? (~x0 ^ ~x3) : ((~x4 | (~x0 & (x0 | x3))) & (x0 | (x5 & (~x3 | ~x5)))))) & (~x2 | (x0 ? x3 : (~x3 | (~x4 & x5)))) & (~x1 | x2 | x3 | ~x4);
  assign z54 = new_n180_ | ~new_n182_ | (~new_n179_ & ~x0);
  assign new_n179_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n136_ | ~x5))));
  assign new_n180_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n181_ & ~x4));
  assign new_n181_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n182_ = (~x0 | (~new_n183_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign new_n183_ = x1 & x3 & x7;
  assign z55 = ~new_n185_ | (~x4 & (x5 ? ~new_n187_ : (x6 | (~x1 & ~x6))));
  assign new_n185_ = ~new_n186_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n186_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n187_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n189_ & ~x4) | ~new_n192_ | (~new_n191_ & x3);
  assign new_n189_ = (new_n190_ | ~x6) & (~x5 | x6) & (x5 | (~new_n148_ & (x6 | (~x0 & x1))));
  assign new_n190_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n191_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n192_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z58 = ~new_n197_ | (~new_n194_ & ~x4);
  assign new_n194_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n195_ | x5) & (~x5 | (x6 & (new_n196_ | ~x6)));
  assign new_n195_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n196_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n197_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n199_ | new_n200_ | new_n210_ | new_n201_ | new_n204_ | new_n208_;
  assign new_n199_ = ~new_n125_ & (x0 | ~x2 | ~x4);
  assign new_n200_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
  ...
  assign new_n210_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n213_ | ~new_n214_ | (~x4 & (~x5 | (~new_n212_ & x5)));
  assign new_n212_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n213_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n214_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
