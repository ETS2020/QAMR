// Benchmark "FAU" written by ABC on Thu Aug  6 04:08:30 2020
...
module FAU ( 
  ...
  assign new_n141_ = (~x1 | ~x3 | ~x5) & (~new_n142_ | x1 | x2);
  ...
  assign new_n164_ = x0 & (~x3 | (new_n142_ & ~x1 & ~x4));
  assign new_n165_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n137_ | x4 | x5)))));
  assign new_n166_ = new_n167_ & (~x0 | (x3 & (~new_n142_ | x1 | ~x3 | x4)));
  ...
  assign new_n172_ = ~x5 & (~new_n137_ | x5 | ~new_n173_ | ~x1);
  ...
  assign z49 = ~new_n189_ | (~new_n188_ & ~x3) | (x0 & (x4 | (new_n154_ & ~x4)));
  ...
  assign new_n192_ = (x1 | ((~x2 | ~x3) & (~new_n142_ | x2 | x4))) & x3 & ~x4 & (~new_n154_ | x4);
  ...
  assign new_n196_ = x5 ? new_n197_ : (~x6 & (~new_n87_ | x2 | ~x3 | x6));
  ...
  assign new_n204_ = ~x6 & (x2 | (x3 & (~new_n87_ | ~x3 | x6)));
  ...
  assign new_n208_ = ~new_n209_ & (~x0 | (x2 ? (~new_n154_ & ~x4) : x3));
  ...
  assign new_n251_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n253_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n253_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z15 = 1'b0;
