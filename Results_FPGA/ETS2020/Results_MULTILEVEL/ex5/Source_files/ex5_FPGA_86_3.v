...
module FAU ( 
  ...
  assign z49 = new_n206_ | ~new_n207_ | (~x3 & (new_n197_ | new_n151_));
  ...
  assign new_n210_ = (x1 | ((~x2 | ~x3) & (~new_n185_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n220_ | ~new_n218_ | (x3 & (new_n217_ | new_n219_ | new_n151_));
  assign new_n217_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n218_ = ~new_n182_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n226_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n163_ | ~x5))));
  assign new_n227_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n228_ & ~x4));
  assign new_n228_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n229_ = (~x0 | (~new_n190_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n235_ = (new_n236_ | ~x6) & (~x5 | x6) & (x5 | (~new_n195_ & (x6 | (~x0 & x1))));
  ...
  assign new_n240_ = x3 & (new_n241_ | x5) & ~new_n242_ & ~new_n175_ & (new_n243_ | ~x5);
  ...
  assign new_n247_ = (new_n248_ | x4) & (~new_n195_ | x1);
  ...
  assign new_n256_ = ~new_n151_ & (x0 | ~x2 | ~x4);
