// Benchmark "FAU" written by ABC on Thu Aug  6 04:06:26 2020
...
module FAU ( 
  ...
  assign z41 = (~x4 & (~new_n138_ | (~new_n134_ & x0))) | ~new_n136_ | new_n139_;
  ...
  assign z44 = new_n146_ | ~new_n148_ | (x1 & (~x0 | (~x2 & ~x5)));
  assign new_n146_ = x3 & (x4 ? ~x0 : new_n147_);
  assign new_n147_ = ~x6 & ((x5 & ~x7) | (x0 & ~x1 & ~x2 & ~x5));
  assign new_n148_ = (~x0 | (~x4 & (~new_n74_ | ~x2))) & ~new_n149_ & (x0 | ((~new_n74_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n149_ = ~x4 & ((x5 & (x7 | (~x3 & ~x6 & ~x7))) | (x6 & (~x5 | (x5 & ~x7))));
  assign z46 = new_n155_ | ~new_n156_ | (~x4 & (~new_n153_ | (~new_n151_ & ~x0)));
  assign new_n151_ = ~x5 & (~new_n152_ | ~x1 | x5 | ~x6 | x7);
  assign new_n152_ = ~x2 & ~x3;
  assign new_n153_ = (~x5 | (~x7 & (~x3 | x6 | x7))) & (~x0 | ((~x6 | x7) & (x5 | (x6 & (~new_n154_ | ~x6 | ~x7)))));
  assign new_n154_ = ~x1 & ~x2;
  assign new_n155_ = x1 & ((x0 & x3 & x7) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n156_ = (~x0 | x3) & (x0 | ~x3 | (~x4 & x5)) & (~x0 | (~x4 & (x1 | ~x2 | ~x3))) & (x3 | ((x1 | x2) & (x0 | ~x2 | (x1 & ~x4))));
  assign z47 = ~new_n160_ | (~x4 & (~new_n158_ | (~new_n159_ & ~x5)));
  assign new_n158_ = (~x0 | ~x6 | (x7 & (~new_n154_ | ~x3 | ~x5 | ~x7))) & (~x5 | (x0 & x6));
  assign new_n159_ = x6 ? ((x1 | ((~x0 | ~x7 | (x2 & (~x2 | ~x3))) & (x0 | x2 | x3 | x7))) & (~x3 | x7) & (~x2 | (x0 & (~x1 | ~x3)))) : (~x0 & x1);
  assign new_n160_ = (x5 | ((~x1 | x2) & (x0 | x1 | ~x2 | ~x3 | ~x4))) & (x2 | ((~x4 | ((~x1 | x3) & (x0 | (~x3 & (x1 | x3))))) & (~x1 | ~x3) & (~x0 | x3))) & (~x0 | (~x4 & (~x2 | x3))) & (x1 | ~x2 | (x3 ? ~x5 : x0));
  ...
  assign z49 = new_n167_ | ~new_n168_ | (~x3 & (new_n154_ | new_n124_));
  assign new_n167_ = x0 & (x4 | (new_n74_ & ~x4));
  assign new_n168_ = ~new_n169_ & (x4 | ((~x6 | (x5 & (~x5 | x7))) & (~x5 | (~x7 & (~x3 | x6 | x7)))));
  assign new_n169_ = ~x0 & ((~x1 & ~x2 & (~x5 | (x3 & x5))) | x1 | (x2 & x3 & x4));
  assign z51 = (~new_n171_ & ~x4) | (x1 & (~x0 | (~x2 & x3))) | (x2 & (x0 ? (~x1 & x3) : (x3 ? x4 : ~x1))) | (~x1 & ((~x3 & (x0 | ~x2)) | (x0 & ~x2 & x4)));
  assign new_n171_ = x5 ? new_n172_ : new_n173_;
  assign new_n172_ = (~x0 | ((~x1 | (~x3 & (~x6 | ~x7 | ~x2 | x3))) & (x1 | x2 | ~x3 | ~x6 | ~x7))) & x0 & x6 & (~x6 | x7);
  assign new_n173_ = ~x6 & (~x0 | x1 | x2 | ~x3 | x6);
  assign z52 = new_n178_ | ~new_n176_ | (x3 & (new_n175_ | new_n177_ | new_n124_));
  assign new_n175_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n176_ = ~new_n149_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n184_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n135_ | ~x5))));
  ...
  assign new_n194_ = (new_n195_ | ~x6) & (~x5 | x6) & (x5 | (~new_n152_ & (x6 | (~x0 & x1))));
  ...
  assign z59 = ~new_n199_ | new_n209_ | new_n210_ | new_n200_ | new_n203_ | new_n207_;
  ...
  assign new_n209_ = x5 & ((~x4 & x7) | (x0 & ~x1 & ~x2 & x4));
