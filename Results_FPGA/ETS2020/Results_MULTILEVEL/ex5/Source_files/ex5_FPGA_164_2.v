// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:32 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n80_, new_n82_, new_n85_, new_n87_, new_n89_, new_n100_,
  ...
  assign z41 = ~new_n136_ | new_n139_ | (~x4 & (~new_n138_ | (~new_n134_ & x0)));
  assign new_n134_ = (~x1 | ~x3 | ~x5) & (x1 | x2 | ~new_n135_ | x5);
  assign new_n135_ = x6 & x7;
  assign new_n136_ = (~x0 | ((~x2 | x3) & (~x1 | ~x3 | ~x7))) & (new_n137_ | ~x3) & (x0 | ~x1);
  assign new_n137_ = (~x1 | x6) & (~x4 | (x0 & ~x1));
  assign new_n138_ = (x0 | (~x5 & ~x7)) & (x5 | ((x1 | x6) & (~x3 | ~x6 | x7)));
  assign new_n139_ = ~x1 & ((x0 & (x2 ? x3 : (x4 & ~x5))) | (~x3 & (~x2 | (~x0 & x2))));
  ...
  assign z43 = (~new_n146_ & x4) | new_n121_ | new_n147_ | (~new_n148_ & ~x4);
  ...
  assign new_n152_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n119_ | x4 | x5)))));
  assign new_n153_ = new_n154_ & (~x0 | (x3 & (~new_n151_ | x1 | ~x3 | x4)));
  assign new_n154_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n155_ = (new_n157_ | x4) & ((~z00 & ~new_n156_) | ~x0);
  assign new_n156_ = x1 & x3 & x7;
  assign new_n157_ = (x7 | ((~x3 | (~x5 ^ x6)) & (~x5 | (~x6 & (x3 | x6))))) & (~x5 | ~x7) & (x1 | x5 | x6);
  ...
  assign new_n169_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n135_ | ~x5))));
  assign new_n170_ = ~x1 & ((~new_n171_ & ~x4) | (~x2 & ~x3) | (x2 & x3 & x5));
  assign new_n171_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n172_ = (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6)))) & (~x0 | (~new_n156_ & ~x4));
  assign z57 = (x0 & (~new_n174_ | ~x3)) | ~new_n181_ | (~x0 & (~new_n178_ | new_n183_));
  assign new_n174_ = (new_n175_ | x5) & ~new_n176_ & (new_n177_ | ~x5) & (~new_n119_ | x4);
