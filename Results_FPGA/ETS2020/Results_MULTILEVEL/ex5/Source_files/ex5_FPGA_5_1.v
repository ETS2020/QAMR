// Benchmark "FAU" written by ABC on Thu Aug  6 04:05:40 2020
...
module FAU ( 
  ...
  assign z40 = new_n121_ | ~new_n127_ | new_n130_ | (~new_n123_ & ~x5);
  ...
  assign new_n127_ = (~x1 | (x0 & (~x3 | ~x4))) & (new_n128_ | x0) & (~new_n129_ | x4);
  assign new_n128_ = (x4 | ~x7) & (x2 | ~x3 | ~x4);
  assign new_n129_ = x5 & (x7 | (~x7 & (x6 | (x3 & ~x6))));
  assign new_n130_ = x0 & (x4 ? x2 : (x6 & ~x7));
  assign z41 = (~x4 & (~new_n136_ | (~new_n132_ & x0))) | ~new_n134_ | new_n137_;
  ...
  assign z49 = new_n155_ | ~new_n156_ | (~x3 & (new_n147_ | new_n122_));
  ...
  assign z54 = new_n172_ | ~new_n174_ | (~new_n171_ & ~x0);
  assign new_n171_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n133_ | ~x5))));
  assign new_n172_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n173_ & ~x4));
  assign new_n173_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n174_ = (~x0 | (~new_n175_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign new_n175_ = x1 & x3 & x7;
  assign z55 = ~new_n177_ | (~x4 & (x5 ? ~new_n179_ : (x6 | (~x1 & ~x6))));
  assign new_n177_ = ~new_n178_ & (~x0 | (x2 ? (~new_n74_ & ~x4) : x3));
  assign new_n178_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n179_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n181_ & ~x4) | ~new_n184_ | (~new_n183_ & x3);
  assign new_n181_ = (new_n182_ | ~x6) & (~x5 | x6) & (x5 | (~new_n145_ & (x6 | (~x0 & x1))));
  ...
  assign new_n186_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n187_ | x5) & (~x5 | (x6 & (new_n188_ | ~x6)));
  assign new_n187_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n188_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n189_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n191_ | new_n192_ | new_n202_ | new_n193_ | new_n196_ | new_n200_;
  assign new_n191_ = ~new_n122_ & (x0 | ~x2 | ~x4);
  assign new_n192_ = x5 & ((~x4 & x7) | (new_n87_ & ~x2 & x4));
  ...
  assign new_n202_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n205_ | ~new_n206_ | (~x4 & (~x5 | (~new_n204_ & x5)));
  assign new_n204_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n205_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n206_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n209_ | (~x4 & ((~new_n208_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n208_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n209_ = (~x3 | ((~x1 | x6) & ((x0 & ~x1) | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n211_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n211_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
