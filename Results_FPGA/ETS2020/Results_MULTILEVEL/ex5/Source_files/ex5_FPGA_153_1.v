...
module FAU ( 
  ...
  assign z52 = new_n159_ | ~new_n157_ | (x3 & (new_n156_ | new_n158_ | new_n121_));
  assign new_n156_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n157_ = ~new_n134_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n176_ = (new_n177_ | ~x6) & (~x5 | x6) & (x5 | (~new_n137_ & (x6 | (~x0 & x1))));
