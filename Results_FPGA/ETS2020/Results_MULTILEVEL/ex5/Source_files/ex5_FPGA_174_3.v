...
module FAU ( 
  ...
  wire new_n74_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    ...
    new_n271_, new_n272_, new_n273_, new_n275_, new_n276_;
  ...
  assign z49 = new_n208_ | ~new_n209_ | (~x3 & (new_n200_ | new_n154_));
  ...
  assign new_n212_ = (x1 | ((~x2 | ~x3) & (~new_n188_ | x2 | x4))) & x3 & ~x4 & (~new_n74_ | x4);
  ...
  assign z52 = new_n222_ | ~new_n220_ | (x3 & (new_n219_ | new_n221_ | new_n154_));
  assign new_n219_ = x0 & ~x1 & (x2 | (new_n74_ & ~x2 & ~x4));
  assign new_n220_ = ~new_n185_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n228_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n166_ | ~x5))));
  assign new_n229_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n230_ & ~x4));
  assign new_n230_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n231_ = (~x0 | (~new_n193_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  ...
  assign new_n237_ = (new_n238_ | ~x6) & (~x5 | x6) & (x5 | (~new_n198_ & (x6 | (~x0 & x1))));
  ...
  assign z57 = (~new_n242_ & x0) | ~new_n249_ | (~x0 & (~new_n246_ | new_n251_));
  assign new_n242_ = x3 & (new_n243_ | x5) & ~new_n244_ & ~new_n178_ & (new_n245_ | ~x5);
  ...
  assign new_n249_ = (new_n250_ | x4) & (~new_n198_ | x1);
  ...
  assign new_n258_ = ~new_n154_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n266_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
