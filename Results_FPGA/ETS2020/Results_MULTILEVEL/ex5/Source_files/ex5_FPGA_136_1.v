...
module FAU ( 
  ...
  assign new_n135_ = ~x6 & ((x5 & ~x7) | (new_n87_ & ~x2 & ~x5));
  ...
  assign new_n186_ = ~new_n125_ & (x0 | ~x2 | ~x4);
  ...
  assign new_n199_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
