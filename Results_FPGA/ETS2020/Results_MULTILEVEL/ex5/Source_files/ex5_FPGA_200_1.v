// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:58 2020
...
module FAU ( 
  ...
  assign z44 = new_n141_ | ~new_n139_ | (x3 & (x4 ? ~x0 : new_n142_));
  ...
  assign new_n169_ = ~new_n140_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign new_n215_ = (~x3 | (((x0 & ~x1) | ~x4) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4))) & (x0 | (~x1 & (x1 | ~x2 | x3)));
  assign z03 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
