// Benchmark "FAU" written by ABC on Thu Aug  6 04:07:15 2020
...
module FAU ( 
  ...
  assign z43 = (~new_n153_ & x4) | new_n136_ | new_n150_ | (~new_n154_ & ~x4);
  assign new_n150_ = x0 & (new_n152_ | (new_n151_ & x2));
  ...
  assign new_n158_ = (~x0 | (~x4 & (~new_n151_ | ~x2))) & ~new_n159_ & (x0 | ((~new_n151_ | x4) & (~x2 | x3 | ~x4)));
  assign new_n159_ = ~x4 & ((x6 & (~x5 | (x5 & ~x7))) | (x5 & (x7 | (~x3 & ~x6 & ~x7))));
  assign z45 = ((new_n161_ | ~new_n163_) & ~x2) | new_n169_ | ~new_n166_ | (~new_n164_ & x2);
  assign new_n161_ = x0 & (~x3 | (new_n162_ & ~x1 & ~x4));
  assign new_n162_ = ~x5 & x6 & x7;
  assign new_n163_ = (~x1 | (x5 & (x3 | ~x4))) & (x0 | ((~x3 | ~x4) & (x1 | x3 | (~x4 & (~new_n134_ | x4 | x5)))));
  assign new_n164_ = new_n165_ & (~x0 | (x3 & (~new_n162_ | x1 | ~x3 | x4)));
  assign new_n165_ = (x0 | ((x1 | x3) & (x4 | x5 | ~x6))) & (x1 | ~x3 | ~x5);
  assign new_n166_ = ~new_n168_ & (~x0 | (~z00 & ~new_n167_));
  assign new_n167_ = x1 & x3 & x7;
  ...
  assign new_n171_ = ~x5 & (~new_n134_ | x5 | ~new_n172_ | ~x1);
  ...
  assign z49 = ~new_n188_ | (~new_n187_ & ~x3) | (x0 & (x4 | (new_n151_ & ~x4)));
  ...
  assign new_n191_ = (x1 | ((~x2 | ~x3) & (~new_n162_ | x2 | x4))) & x3 & ~x4 & (~new_n151_ | x4);
  ...
  assign new_n200_ = ~new_n159_ & (x1 | x2 | (x3 & (~x0 | ~x4)));
  ...
  assign z54 = (~new_n207_ & ~x0) | new_n208_ | ~new_n210_;
  assign new_n207_ = x3 ? ((x2 | (~x4 & x5)) & (x1 | ~x2 | ~x4 | x5)) : ((~x2 | ~x4) & (~x1 | ((~x2 | x5) & (x2 | x4 | ~new_n139_ | ~x5))));
  assign new_n208_ = ~x1 & ((~x2 & ~x3) | (x2 & x3 & x5) | (~new_n209_ & ~x4));
  assign new_n209_ = (x5 | x6) & (~x0 | ~x5 | ~x6 | ~x7 | (~x2 ^ x3));
  assign new_n210_ = (~x0 | (~new_n167_ & ~x4)) & (x4 | (x5 ? (x6 & (~x6 | x7)) : (~x6 & (~x0 | x6))));
  assign z55 = ~new_n212_ | (~x4 & (x5 ? ~new_n214_ : (x6 | (~x1 & ~x6))));
  assign new_n212_ = ~new_n213_ & (~x0 | (x2 ? (~new_n151_ & ~x4) : x3));
  assign new_n213_ = ~x1 & (x2 ? ((x3 & x5) | (~x0 & (~x3 | (x3 & x4 & ~x5)))) : ((x0 & x4) | ~x3 | (~x0 & (~x5 | (x3 & x5)))));
  assign new_n214_ = x0 & x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? (x2 | ~x3) : (~x2 ^ x3)))));
  assign z56 = (~new_n216_ & ~x4) | ~new_n219_ | (~new_n218_ & x3);
  assign new_n216_ = (new_n217_ | ~x6) & (~x5 | x6) & (x5 | (~new_n172_ & (x6 | (~x0 & x1))));
  assign new_n217_ = (~x7 | ((x2 | (x0 ? (x1 | (x5 & (~x3 | ~x5))) : (~x1 | ~x5))) & (~x0 | x1 | ~x2 | ~x3 | x5))) & (~x5 | x7) & (x5 | ((~x3 | x7) & (x0 | ~x2)));
  assign new_n218_ = (x1 | ~x5 | (~x2 & (x0 | x2))) & (~x0 | ~x1 | ~x7) & (x0 | ~x2 | (~x4 & x5));
  assign new_n219_ = (x3 | (~x0 & (x0 | ~x2 | (~x4 & (~x1 | x5))) & (x2 | (x1 & (~x1 | ~x4))))) & (~x0 | ~x4) & (x0 | x1 | x2 | x5);
  assign z57 = (~new_n221_ & x0) | ~new_n228_ | (~x0 & (~new_n225_ | new_n230_));
  assign new_n221_ = x3 & (new_n222_ | x5) & ~new_n223_ & ~new_n152_ & (new_n224_ | ~x5);
  assign new_n222_ = (~x2 | x6) & (x1 | x2 | (~x4 & (x4 | (x6 ? ~x7 : ~x3))));
  assign new_n223_ = x2 & (x4 | (~x1 & x3));
  assign new_n224_ = x1 ? (~x3 | x4) : (x2 | (~x4 & (~x3 | x4 | ~x6 | ~x7)));
  assign new_n225_ = ~new_n226_ & (~x2 | ~x4) & (x2 | ~x3 | ~x4) & (x5 | (~new_n227_ & ~x3));
  assign new_n226_ = x1 & ~x2 & ~x4 & x5 & x6 & x7;
  assign new_n227_ = x1 & ~x3 & (x2 | (~x2 & ~x4 & x6 & ~x7));
  assign new_n228_ = (new_n229_ | x4) & (~new_n172_ | x1);
  assign new_n229_ = (~x5 | (x6 & (~x6 | x7))) & (~x1 | ~x2 | ~x3 | x5 | ~x6);
  assign new_n230_ = ~x1 & (x2 ? ~x3 : (x3 & x5));
  assign z58 = ~new_n235_ | (~new_n232_ & ~x4);
  assign new_n232_ = (x0 | (~x5 & (~x2 | x5 | ~x6))) & (new_n233_ | x5) & (~x5 | (x6 & (new_n234_ | ~x6)));
  assign new_n233_ = x6 ? ((~x0 | x1 | ~x7 | (x2 & (~x2 | ~x3))) & (~x3 | (x7 & (~x1 | ~x2)))) : (~x0 & x1);
  assign new_n234_ = x7 & (~x0 | x1 | x2 | ~x3 | ~x7);
  assign new_n235_ = (x3 | (~x0 & (x1 | x2) & (x0 | (~x4 & (~x1 | ~x2 | x5))))) & (~x3 | ((x0 | ~x4 | (x2 & (x1 | ~x2 | x5))) & (~x1 | x2) & (x1 | ~x2 | ~x5))) & (~x0 | ~x4) & (~x1 | x2 | x5);
  assign z59 = ~new_n247_ | new_n237_ | new_n248_ | new_n238_ | new_n241_ | new_n245_;
  assign new_n237_ = x5 & ((~x4 & x7) | (new_n86_ & ~x2 & x4));
  assign new_n238_ = x3 & (~new_n240_ | (~new_n239_ & ~x5));
  assign new_n239_ = (x0 | ~x2) & (x4 | ((~x0 | x1 | (x2 ? (~x6 | ~x7) : x6)) & (~x1 | ~x2 | ~x6)));
  assign new_n240_ = (~x1 | (~x4 & x6)) & (x0 | x2 | ~x4);
  assign new_n241_ = ~x3 & ((~new_n242_ & ~x0) | new_n243_ | (~new_n244_ & x0));
  assign new_n242_ = x1 ? (~x2 | x5) : (x2 | ~x4);
  assign new_n243_ = ~x2 & (x0 | (x1 & x4));
  assign new_n244_ = x1 & (x5 | ~x6 | ~x7 | ~x2 | x4);
  assign new_n245_ = ~new_n246_ & ~x5;
  assign new_n246_ = x0 ? (x1 | x2 | (~x4 & (x4 | ~x6 | ~x7))) : (x4 | x6);
  assign new_n247_ = (x0 | ~x2 | ~x4) & (x4 | ~x5 | x6 | x7);
  assign new_n248_ = ~x7 & (~x0 | (x0 & ~x4 & x6));
  assign z60 = new_n251_ | ~new_n252_ | (~x4 & (~x5 | (~new_n250_ & x5)));
  assign new_n250_ = x6 & (~x6 | (x7 & (~x0 | ~x7 | (x1 ? x3 : (x2 | ~x3)))));
  assign new_n251_ = ~x1 & ((x2 & (x0 ^ ~x3)) | (~x3 & (x0 | (~x0 & ~x2 & x4))) | (~x2 & (x0 ? x4 : (~x5 | (x3 & x5)))));
  assign new_n252_ = (x0 | (~x1 & (~x2 | ~x3 | ~x4))) & (~x1 | ~x3 | (~x4 & (~x0 | ~x7)));
  assign z61 = ~new_n255_ | (~x4 & ((~new_n254_ & ~x6) | (~x5 & x6) | (x5 & (x7 | (x6 & ~x7)))));
  assign new_n254_ = (x0 | x5) & (~x3 | ((~x5 | x7) & (~x0 | x1 | x2 | x5)));
  assign new_n255_ = (~x3 | ((~x1 | x6) & (~x4 | (x0 & ~x1)))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | x2 | x3) & (~x0 | (x2 ? x3 : (x3 & (x1 | ~x4))));
  assign z62 = ~new_n257_ | (~x4 & (x5 | (~x5 & (x6 | (~x1 & ~x6)))));
  assign new_n257_ = (~x3 | ((~x4 | (x0 & ~x1)) & (~x1 | x6) & (~x0 | x1 | ~x2))) & (x0 | (~x1 & (x1 | ~x2 | x3))) & (x1 | ((x3 | (~x0 & x2)) & (~x0 | x2 | ~x4)));
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
