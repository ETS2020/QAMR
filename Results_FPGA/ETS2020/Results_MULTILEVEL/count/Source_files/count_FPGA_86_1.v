...
module FAU ( 
  ...
  assign new_n83_ = new_n56_ & (x19 | (new_n66_ & new_n84_ & ~x25 & ~x26));
  assign new_n84_ = ~x27 & ~x28 & ~x29;
  assign new_n85_ = new_n86_ & ~x24 & ~x25 & ~x26 & new_n81_ & new_n87_;
  assign new_n86_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n87_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n91_ | (~new_n89_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n89_ = new_n56_ & (x19 | (new_n70_ & new_n90_));
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n56_ & new_n66_ & new_n92_ & ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n98_ | (x16 & ((~new_n95_ & x32) | (new_n94_ & new_n97_)));
  assign new_n94_ = new_n56_ & new_n66_;
  assign new_n95_ = new_n56_ & (x19 | (new_n70_ & new_n96_));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = new_n81_ & ~x25 & ~x26 & new_n87_ & ~x31 & ~x32;
  assign new_n98_ = ~x18 & (x02 | x16);
  assign z14 = (x16 & (new_n100_ | (new_n67_ & new_n102_))) | x18 | (~x01 & ~x16);
  assign new_n100_ = x33 & (~new_n56_ | (~x19 & (~new_n74_ | ~new_n101_)));
  assign new_n101_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = new_n103_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n105_ | (new_n67_ & new_n106_))) | x18 | (~x00 & ~x16);
  assign new_n105_ = x34 & (~new_n56_ | (~x19 & (~new_n74_ | ~new_n84_ | ~new_n103_)));
