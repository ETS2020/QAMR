...
module FAU ( 
  ...
  assign new_n60_ = (~x23 | (new_n55_ & (x19 | (~x21 & ~x22)))) & (~new_n55_ | x21 | x22 | x23);
  ...
  assign new_n73_ = new_n55_ & (x19 | (new_n63_ & new_n74_ & ~x24 & ~x25));
  assign new_n74_ = ~x26 & ~x27;
  assign new_n75_ = new_n76_ & ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n78_ | new_n80_));
  assign new_n78_ = x29 & (~new_n55_ | (~x19 & (~new_n64_ | ~new_n79_)));
  assign new_n79_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n80_ = new_n55_ & new_n63_ & new_n81_ & ~x24 & ~x25 & ~x26;
  assign new_n81_ = ~x27 & ~x28 & ~x29;
  assign z12 = (x16 & (new_n85_ | (~new_n83_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n83_ = new_n55_ & (x19 | (new_n70_ & new_n84_));
  assign new_n84_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n85_ = new_n55_ & new_n64_ & new_n86_ & new_n74_ & ~x25;
  assign new_n86_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n88_ | new_n90_));
  assign new_n88_ = x32 & (~new_n55_ | (~x19 & (~new_n70_ | ~new_n89_)));
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n90_ = new_n55_ & new_n64_ & new_n79_ & new_n91_;
  assign new_n91_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n93_ | (new_n67_ & new_n96_))) | x18 | (~x01 & ~x16);
  assign new_n93_ = x33 & (~new_n55_ | (~x19 & (~new_n94_ | ~new_n95_)));
  assign new_n94_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n95_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n96_ = new_n97_ & new_n74_ & ~x28 & ~x29;
  assign new_n97_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n99_ | (new_n67_ & new_n100_))) | x18 | (~x00 & ~x16);
  assign new_n99_ = x34 & (~new_n55_ | (~x19 & (~new_n94_ | ~new_n81_ | ~new_n97_)));
  assign new_n100_ = new_n101_ & new_n74_ & ~x28 & ~x29;
