// Benchmark "FAU" written by ABC on Wed Aug  5 00:11:22 2020
...
module FAU ( 
  ...
  assign new_n88_ = new_n85_ & new_n89_ & ~x24 & ~x25 & ~x26;
  ...
  assign new_n98_ = new_n82_ & new_n99_ & new_n56_ & new_n64_;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n101_ | (new_n65_ & new_n103_)));
  assign new_n101_ = x33 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n102_)));
  assign new_n102_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n103_ = new_n104_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n106_ | (new_n65_ & new_n107_)));
  assign new_n106_ = x34 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n84_ | ~new_n104_)));
