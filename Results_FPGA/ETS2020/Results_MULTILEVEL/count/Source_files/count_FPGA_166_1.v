...
module FAU ( 
  ...
  assign new_n70_ = (~x27 | (new_n56_ & (new_n71_ | x19))) & (~new_n72_ | ~new_n73_);
  ...
  assign new_n75_ = new_n56_ & (x19 | (new_n64_ & new_n76_ & ~x24 & ~x25));
  assign new_n76_ = ~x26 & ~x27;
  assign new_n77_ = new_n72_ & ~x23 & ~x24 & ~x25 & new_n78_ & ~x26;
  assign new_n78_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n82_ | (~new_n80_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n80_ = new_n56_ & (x19 | (new_n65_ & new_n81_));
  assign new_n81_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n82_ = new_n83_ & new_n84_ & ~x24 & ~x25 & ~x26;
  assign new_n83_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n84_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n87_ | (~new_n86_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n86_ = new_n56_ & (x19 | (new_n65_ & new_n84_ & ~x25 & ~x26));
  assign new_n87_ = new_n83_ & ~x24 & ~x25 & ~x26 & new_n78_ & new_n88_;
  assign new_n88_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n92_ | (~new_n90_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n90_ = new_n56_ & (x19 | (new_n91_ & new_n76_ & new_n88_ & ~x28));
  assign new_n91_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n92_ = new_n56_ & new_n65_ & new_n93_ & new_n76_ & ~x25;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n95_ | new_n97_));
  assign new_n95_ = x32 & (~new_n56_ | (~x19 & (~new_n91_ | ~new_n96_)));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = new_n56_ & new_n65_ & new_n81_ & new_n88_ & ~x31 & ~x32;
  assign z14 = (x16 & (new_n99_ | (new_n68_ & new_n101_))) | x18 | (~x01 & ~x16);
  ...
  assign z15 = (x16 & (new_n104_ | (new_n68_ & new_n105_))) | x18 | (~x00 & ~x16);
  assign new_n104_ = x34 & (~new_n56_ | (~x19 & (~new_n71_ | ~new_n84_ | ~new_n102_)));
