...
module FAU ( 
  ...
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n93_ | new_n95_));
  assign new_n93_ = x32 & (~new_n56_ | (~x19 & (~new_n70_ | ~new_n94_)));
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n95_ = new_n84_ & new_n96_ & new_n56_ & new_n66_;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n98_ | (new_n67_ & new_n100_)));
  assign new_n98_ = x33 & (~new_n56_ | (~x19 & (~new_n74_ | ~new_n99_)));
  assign new_n99_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n100_ = new_n101_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n103_ | (new_n67_ & new_n104_)));
  assign new_n103_ = x34 & (~new_n56_ | (~x19 & (~new_n74_ | ~new_n86_ | ~new_n101_)));
