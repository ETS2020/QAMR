...
module FAU ( 
  ...
  assign new_n90_ = new_n56_ & (x19 | (new_n65_ & new_n91_));
  assign new_n91_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n92_ = new_n87_ & new_n88_ & new_n82_ & new_n93_;
  assign new_n93_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n96_ | (~new_n95_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n95_ = new_n56_ & (x19 | (new_n71_ & new_n80_ & new_n93_ & ~x28));
  assign new_n96_ = new_n56_ & new_n65_ & new_n97_ & new_n80_ & ~x25;
  ...
  assign new_n101_ = new_n56_ & new_n65_ & new_n85_ & new_n93_ & ~x31 & ~x32;
  assign z14 = (x16 & (new_n103_ | (new_n68_ & new_n105_))) | x18 | (~x01 & ~x16);
  assign new_n103_ = x33 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n104_)));
  assign new_n104_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = new_n106_ & new_n80_ & ~x28 & ~x29;
