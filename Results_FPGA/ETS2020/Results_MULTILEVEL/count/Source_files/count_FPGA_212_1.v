// Benchmark "FAU" written by ABC on Wed Aug  5 00:11:55 2020
...
module FAU ( 
  ...
  assign new_n83_ = new_n56_ & (x19 | (new_n66_ & new_n81_ & ~x25 & ~x26));
  assign new_n84_ = new_n85_ & new_n86_ & new_n87_;
  ...
  assign new_n89_ = new_n56_ & (x19 | (new_n66_ & new_n87_ & ~x25 & ~x26));
  assign new_n90_ = new_n85_ & new_n86_ & new_n81_ & ~x29 & ~x30;
  assign z12 = (x16 & (new_n94_ | (~new_n92_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n92_ = new_n56_ & (x19 | (new_n70_ & new_n93_));
  assign new_n93_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n94_ = new_n56_ & new_n66_ & new_n95_ & ~x25 & ~x26 & ~x27;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z14 = (x16 & (new_n97_ | (new_n67_ & new_n99_))) | x18 | (~x01 & ~x16);
  assign new_n97_ = x33 & (~new_n56_ | (~x19 & (~new_n74_ | ~new_n98_)));
  assign new_n98_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n99_ = new_n100_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n102_ | (new_n67_ & new_n103_))) | x18 | (~x00 & ~x16);
  assign new_n102_ = x34 & (~new_n56_ | (~x19 & (~new_n74_ | ~new_n87_ | ~new_n100_)));
