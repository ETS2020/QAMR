...
module FAU ( 
  ...
  assign z09 = (x16 & (new_n80_ | (new_n82_ & new_n77_))) | x18 | (~x06 & ~x16);
  assign new_n80_ = x28 & (~new_n56_ | (~x19 & (~new_n64_ | ~new_n69_ | ~new_n81_)));
  assign new_n81_ = ~x26 & ~x27;
  assign new_n82_ = ~x26 & ~x27 & ~x28 & new_n69_ & ~x23;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n84_ | new_n86_));
  assign new_n84_ = x29 & (~new_n56_ | (~x19 & (~new_n65_ | ~new_n85_)));
  assign new_n85_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = new_n56_ & new_n64_ & new_n87_ & ~x24 & ~x25 & ~x26;
  assign new_n87_ = ~x27 & ~x28 & ~x29;
  assign z12 = (x16 & (new_n91_ | (~new_n89_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n89_ = new_n56_ & (x19 | (new_n72_ & new_n90_));
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n56_ & new_n65_ & new_n92_ & new_n81_ & ~x25;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n94_ | new_n96_));
  assign new_n94_ = x32 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n95_)));
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = new_n85_ & new_n97_ & new_n56_ & new_n65_;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n99_ | (new_n68_ & new_n101_)));
  assign new_n99_ = x33 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n100_)));
  assign new_n100_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = new_n102_ & new_n81_ & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n104_ | (new_n68_ & new_n105_)));
  assign new_n104_ = x34 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n87_ | ~new_n102_)));
