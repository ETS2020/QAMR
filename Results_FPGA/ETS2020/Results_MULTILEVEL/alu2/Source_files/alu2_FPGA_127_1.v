// Benchmark "FAU" written by ABC on Wed Aug  5 00:18:05 2020
...
module FAU ( 
  ...
  assign z4 = x9 & (new_n59_ | new_n66_ | new_n71_ | (~new_n74_ & x1));
  assign new_n59_ = x5 & (~new_n60_ | (~x3 & (new_n63_ | new_n64_ | new_n65_)));
  assign new_n60_ = (new_n61_ | ~x4) & (~x1 | new_n62_ | ~x3);
  assign new_n61_ = (x1 | (x0 & (x2 | x6))) & (x7 | (x6 & (~x2 | ~x3)));
  assign new_n62_ = (x0 | x2 | ((~x6 | x7) & (x4 | x8))) & (~x6 | x7 | ~x0 | ~x2);
  assign new_n63_ = ~x6 & ((~x2 & (x4 | ~x8)) | (~x0 & x4) | (~x4 & x7 & x0 & x2));
  assign new_n64_ = ~x1 & ((~x7 & (x0 ? (x2 & (x6 | ~x8)) : (~x2 & x6))) | (~x0 & ~x2 & ~x8));
  assign new_n65_ = ~x4 & x6 & x7 & (x1 | (x0 & ~x2));
  assign new_n66_ = x0 & (~new_n67_ | (~x5 & (new_n69_ | new_n70_)));
  assign new_n67_ = (x4 | new_n68_ | ~x7) & (~x1 | x6 | x7 | x8);
  assign new_n68_ = (~x1 | (x8 & (x2 | ~x6))) & (x3 | ~x6 | x8);
  assign new_n69_ = (~x8 | (x2 & x7)) & (x1 | (x3 & x4));
  assign new_n70_ = x6 & ((x3 & x4 & x7) | (~x4 & ~x8) | (~x2 & ~x7));
  assign new_n71_ = ~x5 & ((~new_n72_ & x4) | (x6 & ~x7 & ~x8));
  assign new_n72_ = (~x2 | ((~new_n73_ | x0) & (~x3 | x8))) & (~new_n73_ | x1 | ~x3);
  assign new_n73_ = x6 & ~x7;
  assign new_n74_ = (~x7 | ((~x4 | x5 | ~x6) & (~x3 | x6 | (x4 & x5)))) & (x5 | (~new_n75_ & (x3 | ~x6 | x7)));
  assign new_n75_ = x2 & x4 & ~x8;
