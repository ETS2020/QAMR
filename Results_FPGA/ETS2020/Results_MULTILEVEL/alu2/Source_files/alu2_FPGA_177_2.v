...
module FAU ( 
  ...
  assign z3 = x1 & x3;
  assign z4 = x9 & (new_n60_ | new_n67_ | new_n72_ | (~new_n75_ & x1));
  assign new_n60_ = x5 & (~new_n61_ | (~x3 & (new_n64_ | new_n65_ | new_n66_)));
  assign new_n61_ = (new_n62_ | ~x4) & (~x1 | new_n63_ | ~x3);
  assign new_n62_ = (x1 | (x0 & (x2 | x6))) & (x7 | (x6 & (~x2 | ~x3)));
  assign new_n63_ = (x0 | x2 | ((~x6 | x7) & (x4 | x8))) & (~x6 | x7 | ~x0 | ~x2);
  assign new_n64_ = ~x6 & ((~x2 & (x4 | ~x8)) | (~x0 & x4) | (~x4 & x7 & x0 & x2));
  assign new_n65_ = ~x1 & ((~x7 & (x0 ? (x2 & (x6 | ~x8)) : (~x2 & x6))) | (~x0 & ~x2 & ~x8));
  assign new_n66_ = ~x4 & x6 & x7 & (x1 | (x0 & ~x2));
  assign new_n67_ = x0 & (~new_n68_ | (~x5 & (new_n70_ | new_n71_)));
  assign new_n68_ = (x4 | new_n69_ | ~x7) & (~x1 | x6 | x7 | x8);
  assign new_n69_ = (~x1 | (x8 & (x2 | ~x6))) & (x3 | ~x6 | x8);
  assign new_n70_ = (~x8 | (x2 & x7)) & (x1 | (x3 & x4));
  assign new_n71_ = x6 & ((x3 & x4 & x7) | (~x4 & ~x8) | (~x2 & ~x7));
  assign new_n72_ = ~x5 & ((~new_n73_ & x4) | (x6 & ~x7 & ~x8));
  assign new_n73_ = (~x2 | ((~new_n74_ | x0) & (~x3 | x8))) & (~new_n74_ | x1 | ~x3);
  assign new_n74_ = x6 & ~x7;
  assign new_n75_ = (~x7 | ((~x4 | x5 | ~x6) & (~x3 | x6 | (x4 & x5)))) & (x5 | (~new_n76_ & (x3 | ~x6 | x7)));
  assign new_n76_ = x2 & x4 & ~x8;
