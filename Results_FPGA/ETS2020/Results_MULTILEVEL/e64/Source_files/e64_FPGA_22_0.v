...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n342_, new_n344_, new_n345_, new_n346_;
  ...
  assign z24 = ~x58 & ~x50 & ~x46 & new_n236_ & ~x43 & ~x60;
  assign new_n236_ = ~x40 & ~x39 & ~x37 & x29 & new_n237_ & ~x28;
  assign new_n237_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n239_ & ~x46;
  assign new_n239_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n240_ & x29;
  assign new_n240_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n242_ & ~x64;
  assign new_n242_ = ~x62 & ~x61 & ~x60 & new_n243_ & ~x59 & ~x63;
  assign new_n243_ = ~x57 & ~x56 & ~x55 & new_n244_ & ~x54 & ~x58;
  assign new_n244_ = ~x52 & ~x51 & ~x50 & new_n245_ & ~x49 & ~x53;
  assign new_n245_ = ~x47 & ~x46 & ~x45 & new_n246_ & ~x43 & ~x48;
  assign new_n246_ = ~x41 & ~x40 & ~x39 & new_n247_ & ~x37 & ~x42;
  assign new_n247_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n248_ & x32;
  assign new_n248_ = ~x31 & ~x30 & x29 & ~x28 & new_n249_ & ~x26;
  assign new_n249_ = ~x24 & ~x22 & ~x21 & new_n250_ & ~x20 & ~x25;
  assign new_n250_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z29 = x60 & ~x58 & ~x50 & new_n252_ & ~x46;
  assign new_n252_ = ~x43 & ~x40 & new_n200_ & ~x39;
  ...
  assign new_n260_ = ~x24 & ~x22 & x21 & ~x18 & new_n225_ & ~x17;
  ...
  assign new_n275_ = ~x34 & ~x33 & ~x32 & new_n276_ & ~x31 & ~x35;
  assign new_n276_ = ~x30 & x29 & ~x28 & ~x26 & new_n277_ & ~x25;
  assign new_n277_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n250_ & x19;
  ...
  assign new_n335_ = ~x60 & ~x59 & ~x58 & new_n336_ & ~x57 & ~x61;
  assign new_n336_ = ~x55 & ~x54 & ~x53 & new_n337_ & ~x52 & ~x56;
  assign new_n337_ = ~x50 & ~x49 & ~x48 & new_n338_ & ~x47 & ~x51;
  assign new_n338_ = ~x45 & ~x43 & ~x42 & new_n339_ & ~x41 & ~x46;
  assign new_n339_ = ~x39 & ~x37 & ~x36 & new_n340_ & ~x35 & ~x40;
  assign new_n340_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n341_ & x29;
  assign new_n341_ = ~x26 & ~x25 & ~x24 & new_n342_ & ~x22 & ~x28;
  assign new_n342_ = ~x21 & x20 & ~x18 & ~x17 & new_n225_ & ~x16;
  assign z60 = ~x58 & ~x56 & ~x50 & new_n344_ & ~x47 & ~x60;
  assign new_n344_ = ~x43 & ~x40 & ~x39 & new_n345_ & ~x37 & ~x46;
  assign new_n345_ = ~x30 & x29 & ~x28 & ~x25 & new_n346_ & ~x24;
  assign new_n346_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z11 = 1'b0;
