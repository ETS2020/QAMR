// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:55 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n398_, new_n402_, new_n403_, new_n405_, new_n406_, new_n407_,
    new_n408_, new_n409_, new_n410_, new_n411_, new_n412_, new_n414_,
    new_n415_, new_n416_, new_n417_, new_n418_, new_n420_, new_n421_,
    new_n422_, new_n425_, new_n426_, new_n427_, new_n429_, new_n430_,
  ...
  assign new_n298_ = ~x47 & ~x43 & ~x41 & new_n299_ & ~x40 & ~x46;
  assign new_n299_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n300_ & x29;
  assign new_n300_ = ~x28 & ~x25 & ~x24 & new_n301_ & ~x22 & ~x26;
  assign new_n301_ = ~x18 & ~x14 & ~x11 & new_n302_ & ~x10 & ~x15;
  assign new_n302_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n304_ & ~x62;
  assign new_n304_ = x61 & ~x58 & ~x56 & new_n305_ & ~x55 & ~x60;
  assign new_n305_ = ~x51 & ~x47 & ~x46 & new_n306_ & ~x43 & ~x50;
  assign new_n306_ = ~x41 & ~x39 & ~x37 & new_n224_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n308_ & ~x63;
  assign new_n308_ = ~x62 & ~x60 & ~x59 & new_n309_ & ~x58 & ~x61;
  assign new_n309_ = ~x57 & ~x55 & ~x54 & new_n310_ & ~x53 & ~x56;
  assign new_n310_ = ~x52 & ~x50 & ~x49 & new_n311_ & ~x48 & ~x51;
  assign new_n311_ = ~x47 & ~x45 & ~x43 & new_n312_ & ~x42 & ~x46;
  assign new_n312_ = ~x41 & ~x39 & ~x37 & new_n313_ & ~x36 & ~x40;
  assign new_n313_ = ~x35 & ~x33 & ~x32 & new_n314_ & ~x31 & ~x34;
  assign new_n314_ = ~x30 & ~x28 & ~x26 & new_n315_ & ~x25 & x29;
  assign new_n315_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n268_ & x19;
  assign z38 = ~x62 & ~x61 & new_n317_ & ~x60;
  assign new_n317_ = x59 & ~x56 & ~x55 & new_n318_ & ~x51 & ~x58;
  assign new_n318_ = ~x50 & ~x46 & ~x43 & new_n319_ & ~x42 & ~x47;
  assign new_n319_ = ~x41 & ~x40 & new_n320_ & ~x39;
  assign new_n320_ = ~x37 & ~x35 & ~x30 & x29 & new_n321_ & ~x28;
  assign new_n321_ = ~x26 & ~x24 & ~x22 & new_n322_ & ~x18 & ~x25;
  assign new_n322_ = ~x14 & ~x11 & new_n323_ & ~x10 & ~x15;
  assign new_n323_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n325_ & ~x61;
  assign new_n325_ = ~x60 & ~x56 & ~x55 & new_n326_ & ~x51 & ~x58;
  ...
  assign new_n330_ = ~x46 & ~x42 & ~x41 & new_n331_ & ~x40 & ~x43;
  assign new_n331_ = ~x39 & ~x35 & ~x34 & new_n332_ & ~x33 & ~x37;
  assign new_n332_ = ~x30 & x29 & ~x28 & new_n333_ & ~x26;
  assign new_n333_ = ~x25 & ~x22 & ~x18 & new_n334_ & ~x17 & ~x24;
  assign new_n334_ = ~x15 & ~x11 & ~x10 & new_n323_ & ~x09 & ~x14;
  assign z41 = ~x62 & ~x60 & ~x59 & new_n336_ & ~x58 & ~x61;
  assign new_n336_ = ~x56 & ~x51 & ~x50 & new_n337_ & ~x47 & ~x55;
  assign new_n337_ = ~x46 & ~x42 & ~x41 & new_n338_ & ~x40 & ~x43;
  assign new_n338_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n332_ & x33;
  assign z42 = ~x62 & new_n340_ & ~x61;
  assign new_n340_ = ~x60 & ~x58 & ~x56 & new_n341_ & ~x55 & ~x59;
  assign new_n341_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n215_ & x49;
  assign z43 = new_n343_ & ~x62;
  assign new_n343_ = ~x61 & ~x59 & ~x58 & new_n344_ & ~x56 & ~x60;
  assign new_n344_ = ~x55 & ~x53 & ~x51 & new_n345_ & ~x50 & ~x54;
  assign new_n345_ = ~x47 & ~x45 & ~x43 & new_n346_ & ~x42 & ~x46;
  assign new_n346_ = ~x41 & ~x39 & ~x37 & new_n347_ & ~x35 & ~x40;
  assign new_n347_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n348_ & x29;
  assign new_n348_ = ~x28 & ~x25 & ~x24 & new_n349_ & ~x22 & ~x26;
  assign new_n349_ = ~x18 & ~x15 & ~x14 & new_n350_ & ~x11 & ~x17;
  assign new_n350_ = ~x10 & ~x08 & ~x07 & new_n351_ & ~x06 & ~x09;
  assign new_n351_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n353_ & ~x58 & ~x61;
  ...
  assign new_n357_ = x29 & ~x26 & ~x25 & new_n358_ & ~x24 & ~x28;
  assign new_n358_ = ~x22 & ~x17 & ~x15 & new_n359_ & ~x14 & ~x18;
  assign new_n359_ = ~x11 & ~x09 & ~x08 & new_n360_ & ~x07 & ~x10;
  assign new_n360_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x61 & ~x60 & new_n362_ & ~x59 & ~x62;
  assign new_n362_ = ~x58 & ~x55 & ~x51 & new_n363_ & ~x50 & ~x56;
  assign new_n363_ = ~x47 & ~x43 & ~x42 & new_n364_ & ~x41 & ~x46;
  assign new_n364_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n332_ & x34;
  assign z46 = ~x62 & new_n366_ & ~x61;
  assign new_n366_ = ~x60 & ~x58 & ~x56 & new_n367_ & ~x55 & ~x59;
  assign new_n367_ = ~x51 & ~x47 & ~x46 & new_n368_ & ~x43 & ~x50;
  assign new_n368_ = ~x42 & ~x40 & ~x39 & new_n369_ & ~x37 & ~x41;
  assign new_n369_ = ~x35 & ~x30 & x29 & ~x28 & new_n370_ & ~x26;
  assign new_n370_ = ~x25 & ~x22 & ~x18 & new_n371_ & ~x17 & ~x24;
  assign new_n371_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n323_ & x09;
  assign z47 = ~x62 & new_n373_ & ~x61;
  assign new_n373_ = ~x60 & ~x58 & ~x56 & new_n374_ & ~x55 & ~x59;
  ...
  assign new_n377_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n322_ & x17;
  assign z48 = ~x62 & ~x61 & new_n379_ & ~x60;
  assign new_n379_ = ~x59 & ~x56 & ~x55 & new_n380_ & ~x54 & ~x58;
  assign new_n380_ = ~x53 & ~x50 & ~x47 & new_n381_ & ~x46 & ~x51;
  assign new_n381_ = ~x43 & ~x41 & ~x40 & new_n382_ & ~x39 & ~x42;
  assign new_n382_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n332_ & x31;
  assign z49 = ~x61 & ~x60 & new_n384_ & ~x59 & ~x62;
  assign new_n384_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n329_ & x53;
  assign z50 = new_n386_ & ~x62;
  assign new_n386_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n213_ & x57;
  assign z51 = ~x62 & ~x61 & new_n388_ & ~x60;
  assign new_n388_ = ~x59 & ~x56 & ~x55 & new_n389_ & ~x54 & ~x58;
  assign new_n389_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n215_ & x48;
  assign z52 = new_n391_ & ~x64;
  assign new_n391_ = ~x63 & ~x61 & ~x60 & new_n392_ & ~x59 & ~x62;
  assign new_n392_ = ~x58 & ~x56 & ~x55 & new_n393_ & ~x54 & ~x57;
  assign new_n393_ = ~x53 & ~x50 & ~x49 & new_n394_ & ~x48 & ~x51;
  assign new_n394_ = ~x47 & ~x45 & ~x43 & new_n395_ & ~x42 & ~x46;
  assign new_n395_ = ~x41 & ~x39 & ~x37 & new_n396_ & ~x35 & ~x40;
  assign new_n396_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n397_ & x29;
  assign new_n397_ = ~x28 & ~x25 & ~x24 & new_n398_ & ~x22 & ~x26;
  assign new_n398_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n220_ & x12;
  assign z53 = ~x64 & new_n211_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n305_ & x55;
  assign z55 = ~x60 & ~x58 & new_n402_ & ~x56 & ~x62;
  assign new_n402_ = ~x51 & ~x47 & ~x46 & new_n403_ & ~x43 & ~x50;
  assign new_n403_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n224_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n405_ & ~x60 & ~x63;
  assign new_n405_ = ~x59 & ~x57 & ~x56 & new_n406_ & ~x55 & ~x58;
  assign new_n406_ = ~x54 & ~x52 & ~x51 & new_n407_ & ~x50 & ~x53;
  assign new_n407_ = ~x49 & ~x47 & ~x46 & new_n408_ & ~x45 & ~x48;
  assign new_n408_ = ~x43 & ~x41 & ~x40 & new_n409_ & ~x39 & ~x42;
  assign new_n409_ = ~x37 & ~x35 & ~x34 & new_n410_ & ~x33 & ~x36;
  assign new_n410_ = ~x31 & ~x30 & x29 & ~x28 & new_n411_ & ~x26;
  assign new_n411_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n412_ & x20;
  assign new_n412_ = ~x18 & ~x16 & ~x15 & new_n243_ & ~x14 & ~x17;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n414_ & ~x50 & ~x60;
  assign new_n414_ = ~x47 & ~x43 & ~x41 & new_n415_ & ~x40 & ~x46;
  assign new_n415_ = ~x39 & ~x37 & ~x30 & x29 & new_n416_ & ~x28;
  assign new_n416_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n417_ & x18;
  assign new_n417_ = ~x15 & new_n418_ & ~x14;
  assign new_n418_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x60 & ~x58 & new_n420_ & ~x56 & ~x62;
  assign new_n420_ = ~x50 & ~x46 & ~x43 & new_n421_ & ~x41 & ~x47;
  assign new_n421_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n422_ & x29;
  assign new_n422_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n417_ & x22;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n194_ & x40;
  assign z60 = ~x60 & ~x56 & ~x50 & new_n425_ & ~x47 & ~x58;
  assign new_n425_ = ~x46 & ~x40 & ~x39 & new_n426_ & ~x37 & ~x43;
  assign new_n426_ = ~x30 & ~x28 & ~x25 & new_n427_ & ~x24 & x29;
  assign new_n427_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n429_ & ~x50 & ~x60;
  assign new_n429_ = ~x47 & ~x43 & ~x40 & new_n430_ & ~x39 & ~x46;
  assign new_n430_ = ~x37 & ~x30 & x29 & ~x28 & new_n431_ & ~x25;
  assign new_n431_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n433_ & x47;
  assign new_n433_ = new_n434_ & ~x46;
  assign new_n434_ = ~x43 & ~x39 & ~x37 & new_n435_ & ~x30 & ~x40;
  assign new_n435_ = x29 & new_n436_ & ~x28;
  assign new_n436_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n433_ & ~x50;
  assign z64 = ~x58 & ~x50 & new_n439_ & ~x46 & ~x60;
  assign new_n439_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n435_ & x30;
  assign z00 = 1'b0;
  assign z31 = 1'b0;
  assign z05 = x29;
endmodule
