...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n306_, new_n307_, new_n308_, new_n312_, new_n313_, new_n315_,
  ...
  assign z23 = ~x63 & ~x62 & ~x61 & new_n185_ & ~x60 & ~x64;
  ...
  assign new_n189_ = ~x36 & ~x35 & ~x34 & new_n190_ & ~x33 & ~x37;
  assign new_n190_ = ~x31 & ~x30 & x29 & ~x28 & new_n191_ & ~x26;
  assign new_n191_ = ~x24 & ~x22 & ~x21 & new_n192_ & ~x18 & ~x25;
  assign new_n192_ = ~x17 & x16 & ~x15 & ~x14 & new_n174_ & ~x12;
  ...
  assign new_n205_ = ~x15 & ~x14 & x13 & ~x12 & new_n175_ & ~x11;
  ...
  assign new_n214_ = ~x36 & ~x35 & ~x34 & new_n215_ & ~x33 & ~x37;
  assign new_n215_ = ~x31 & ~x30 & x29 & ~x28 & new_n216_ & ~x26;
  assign new_n216_ = ~x25 & ~x24 & ~x22 & new_n217_ & ~x21;
  assign new_n217_ = ~x17 & ~x15 & ~x14 & new_n174_ & ~x12 & ~x18;
  ...
  assign new_n222_ = ~x60 & ~x58 & ~x56 & new_n223_ & ~x55 & x61;
  assign new_n223_ = ~x50 & ~x47 & ~x46 & new_n224_ & ~x43 & ~x51;
  assign new_n224_ = ~x40 & ~x39 & ~x37 & new_n180_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n226_ & ~x60;
  assign new_n226_ = ~x58 & ~x56 & ~x55 & new_n227_ & ~x51 & x59;
  assign new_n227_ = ~x47 & ~x46 & ~x43 & new_n228_ & ~x42 & ~x50;
  ...
  assign new_n234_ = ~x58 & ~x56 & ~x55 & new_n235_ & ~x51 & ~x60;
  assign new_n235_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n228_ & x42;
  assign z40 = ~x62 & ~x61 & new_n237_ & ~x60;
  assign new_n237_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n238_ & x54;
  assign new_n238_ = ~x51 & ~x50 & new_n239_ & ~x47;
  assign new_n239_ = ~x43 & ~x42 & ~x41 & new_n240_ & ~x40 & ~x46;
  assign new_n240_ = ~x37 & ~x35 & ~x34 & new_n241_ & ~x33 & ~x39;
  assign new_n241_ = ~x30 & x29 & ~x28 & new_n242_ & ~x26;
  assign new_n242_ = ~x24 & ~x22 & ~x18 & new_n243_ & ~x17 & ~x25;
  assign new_n243_ = ~x14 & ~x11 & ~x10 & new_n232_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n245_ & ~x58 & ~x62;
  assign new_n245_ = ~x55 & ~x51 & ~x50 & new_n246_ & ~x47 & ~x56;
  assign new_n246_ = ~x43 & ~x42 & ~x41 & new_n247_ & ~x40 & ~x46;
  assign new_n247_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n241_ & x33;
  assign z42 = ~x62 & new_n249_ & ~x61;
  assign new_n249_ = ~x59 & ~x58 & ~x56 & new_n250_ & ~x55 & ~x60;
  assign new_n250_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n169_ & x49;
  assign z43 = new_n252_ & ~x62;
  assign new_n252_ = ~x60 & ~x59 & ~x58 & new_n253_ & ~x56 & ~x61;
  assign new_n253_ = ~x54 & ~x53 & ~x51 & new_n254_ & ~x50 & ~x55;
  assign new_n254_ = ~x46 & ~x45 & ~x43 & new_n255_ & ~x42 & ~x47;
  assign new_n255_ = ~x40 & ~x39 & ~x37 & new_n256_ & ~x35 & ~x41;
  assign new_n256_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n257_ & x29;
  assign new_n257_ = ~x26 & ~x25 & ~x24 & new_n258_ & ~x22 & ~x28;
  assign new_n258_ = ~x17 & ~x15 & ~x14 & new_n259_ & ~x11 & ~x18;
  assign new_n259_ = ~x09 & ~x08 & ~x07 & new_n260_ & ~x06 & ~x10;
  assign new_n260_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n262_ & ~x58 & ~x62;
  assign new_n262_ = ~x55 & ~x54 & ~x53 & new_n263_ & ~x51 & ~x56;
  assign new_n263_ = ~x47 & ~x46 & ~x45 & new_n264_ & ~x43 & ~x50;
  assign new_n264_ = ~x41 & ~x40 & ~x39 & new_n265_ & ~x37 & ~x42;
  assign new_n265_ = ~x34 & ~x33 & ~x31 & new_n266_ & ~x30 & ~x35;
  assign new_n266_ = ~x28 & ~x26 & ~x25 & new_n267_ & ~x24 & x29;
  assign new_n267_ = ~x18 & ~x17 & ~x15 & new_n268_ & ~x14 & ~x22;
  assign new_n268_ = ~x10 & ~x09 & ~x08 & new_n269_ & ~x07 & ~x11;
  ...
  assign new_n273_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n241_ & x34;
  ...
  assign new_n280_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n232_ & x09;
  ...
  assign new_n286_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n231_ & x17;
  ...
  assign new_n308_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n174_ & x12;
  ...
  assign new_n313_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n180_ & x35;
