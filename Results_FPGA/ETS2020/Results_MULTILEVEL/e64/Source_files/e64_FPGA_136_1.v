...
module FAU ( 
  ...
  assign z27 = ~x64 & ~x63 & new_n252_ & ~x62;
  assign new_n252_ = ~x60 & ~x59 & ~x58 & new_n253_ & ~x57 & ~x61;
  assign new_n253_ = ~x55 & ~x54 & ~x53 & new_n254_ & ~x52 & ~x56;
  assign new_n254_ = ~x50 & ~x49 & ~x48 & new_n255_ & ~x47 & ~x51;
  assign new_n255_ = ~x45 & ~x43 & ~x42 & new_n256_ & ~x41 & ~x46;
  assign new_n256_ = ~x39 & ~x37 & ~x36 & new_n257_ & ~x35 & ~x40;
  assign new_n257_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n258_ & x29;
  assign new_n258_ = ~x26 & ~x25 & ~x24 & new_n259_ & ~x22 & ~x28;
  assign new_n259_ = ~x20 & ~x18 & ~x17 & new_n260_ & ~x16 & ~x21;
  assign new_n260_ = ~x15 & ~x14 & x13 & new_n221_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n262_ & ~x50;
  assign new_n262_ = ~x43 & ~x40 & ~x39 & new_n263_ & ~x37 & ~x46;
  assign new_n263_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  ...
  assign new_n274_ = ~x25 & ~x24 & ~x22 & new_n243_ & ~x21 & ~x26;
  ...
  assign new_n282_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n243_ & x21;
  ...
  assign z37 = ~x63 & ~x62 & ~x61 & new_n299_ & ~x60 & ~x64;
  assign new_n299_ = ~x58 & ~x57 & ~x56 & new_n300_ & ~x55 & ~x59;
  assign new_n300_ = ~x53 & ~x52 & ~x51 & new_n301_ & ~x50 & ~x54;
  assign new_n301_ = ~x48 & ~x47 & ~x46 & new_n302_ & ~x45 & ~x49;
  assign new_n302_ = ~x42 & ~x41 & ~x40 & new_n303_ & ~x39 & ~x43;
  assign new_n303_ = ~x37 & ~x36 & ~x35 & new_n304_ & ~x34;
  assign new_n304_ = ~x33 & ~x32 & ~x31 & ~x30 & new_n305_ & x29;
  assign new_n305_ = ~x28 & ~x26 & ~x25 & new_n306_ & ~x24;
  assign new_n306_ = ~x22 & ~x21 & ~x20 & new_n307_ & x19;
  assign new_n307_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z42 = ~x62 & new_n309_ & ~x61;
  assign new_n309_ = ~x59 & ~x58 & ~x56 & new_n310_ & ~x55 & ~x60;
  assign new_n310_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n216_ & x49;
  assign z43 = new_n312_ & ~x62;
  assign new_n312_ = ~x60 & ~x59 & ~x58 & new_n313_ & ~x56 & ~x61;
  assign new_n313_ = ~x54 & ~x53 & ~x51 & new_n314_ & ~x50 & ~x55;
  ...
  assign new_n318_ = ~x17 & ~x15 & ~x14 & new_n319_ & ~x11 & ~x18;
  assign new_n319_ = ~x09 & ~x08 & ~x07 & new_n320_ & ~x06 & ~x10;
  assign new_n320_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z50 = new_n322_ & ~x62;
  assign new_n322_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n214_ & x57;
  assign z51 = ~x62 & ~x61 & new_n324_ & ~x60;
  assign new_n324_ = ~x58 & ~x56 & ~x55 & new_n325_ & ~x54 & ~x59;
  assign new_n325_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n216_ & x48;
  ...
  assign new_n334_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n221_ & x12;
  ...
  assign new_n339_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n225_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n341_ & ~x60 & ~x64;
  ...
  assign new_n346_ = ~x31 & ~x30 & x29 & ~x28 & new_n347_ & ~x26;
  assign new_n347_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n348_ & x20;
  assign new_n348_ = ~x17 & ~x16 & ~x15 & new_n244_ & ~x14 & ~x18;
