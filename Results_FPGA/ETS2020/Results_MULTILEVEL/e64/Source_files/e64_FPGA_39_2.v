...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n145_,
    ...
    new_n316_, new_n318_, new_n319_, new_n320_, new_n323_, new_n324_,
    new_n325_, new_n327_, new_n328_, new_n329_, new_n331_, new_n332_,
    new_n333_, new_n334_, new_n337_;
  assign z04 = x15 & x29;
  ...
  assign new_n194_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n195_ & ~x57;
  assign new_n195_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n196_ & ~x52;
  assign new_n196_ = ~x51 & ~x50 & ~x49 & ~x48 & new_n197_ & ~x47;
  assign new_n197_ = ~x46 & ~x45 & ~x43 & ~x42 & new_n198_ & ~x41;
  assign new_n198_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n199_ & ~x35;
  assign new_n199_ = ~x34 & ~x33 & ~x31 & new_n200_ & x29 & ~x30;
  assign new_n200_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n201_ & ~x22;
  assign new_n201_ = ~x21 & ~x20 & ~x18 & ~x17 & new_n202_ & ~x16;
  assign new_n202_ = ~x15 & ~x14 & x13 & ~x12 & new_n166_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n204_ & ~x50;
  assign new_n204_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n205_ & ~x37;
  assign new_n205_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & ~x61 & new_n207_ & ~x60;
  assign new_n207_ = ~x59 & ~x58 & ~x57 & ~x56 & new_n208_ & ~x55;
  assign new_n208_ = ~x54 & ~x53 & x52 & ~x51 & new_n209_ & ~x50;
  assign new_n209_ = ~x49 & ~x48 & ~x47 & ~x46 & new_n210_ & ~x45;
  assign new_n210_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n211_ & ~x39;
  assign new_n211_ = ~x37 & ~x36 & ~x35 & ~x34 & new_n212_ & ~x33;
  assign new_n212_ = ~x31 & ~x30 & x29 & ~x28 & new_n213_ & ~x26;
  assign new_n213_ = ~x25 & ~x24 & ~x22 & new_n214_ & ~x21;
  assign new_n214_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n165_ & ~x12;
  ...
  assign new_n221_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n171_ & ~x35;
  ...
  assign new_n247_ = ~x54 & ~x53 & ~x51 & new_n160_ & x49 & ~x50;
  ...
  assign new_n293_ = ~x56 & ~x55 & new_n159_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n295_ & ~x60;
  assign new_n295_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n296_ & ~x54;
  assign new_n296_ = ~x53 & ~x51 & ~x50 & new_n160_ & x48 & ~x49;
  ...
  assign new_n305_ = ~x18 & ~x17 & ~x15 & new_n165_ & x12 & ~x14;
  assign z53 = new_n157_ & x63 & ~x64;
  assign z54 = ~x62 & ~x60 & ~x58 & new_n220_ & x55 & ~x56;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n309_ & ~x56;
  assign new_n309_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n310_ & ~x43;
  assign new_n310_ = ~x41 & ~x40 & ~x39 & new_n171_ & x35 & ~x37;
  ...
  assign new_n314_ = ~x26 & ~x25 & ~x24 & new_n315_ & x18 & ~x22;
  ...
  assign new_n319_ = ~x40 & ~x39 & ~x37 & new_n320_ & x29 & ~x30;
  assign new_n320_ = ~x28 & ~x26 & ~x25 & new_n315_ & x22 & ~x24;
