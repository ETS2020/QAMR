...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n243_, new_n245_, new_n247_, new_n249_, new_n250_, new_n251_,
    ...
    new_n366_, new_n367_, new_n368_, new_n369_, new_n372_;
  ...
  assign z22 = ~x64 & ~x63 & ~x62 & new_n189_ & ~x61;
  assign new_n189_ = ~x59 & ~x58 & ~x57 & new_n190_ & ~x56 & ~x60;
  assign new_n190_ = ~x54 & ~x53 & ~x51 & new_n191_ & ~x50 & ~x55;
  ...
  assign new_n195_ = ~x24 & ~x22 & ~x18 & new_n196_ & ~x17 & ~x25;
  assign new_n196_ = ~x15 & ~x14 & ~x12 & new_n173_ & ~x11;
  assign z23 = ~x64 & new_n198_ & ~x63;
  assign new_n198_ = ~x61 & ~x60 & ~x59 & new_n199_ & ~x58 & ~x62;
  assign new_n199_ = ~x56 & ~x55 & ~x54 & new_n200_ & ~x53 & ~x57;
  assign new_n200_ = ~x51 & ~x50 & ~x49 & new_n201_ & ~x48 & ~x52;
  assign new_n201_ = ~x46 & ~x45 & ~x43 & new_n202_ & ~x42 & ~x47;
  assign new_n202_ = ~x40 & ~x39 & ~x37 & new_n203_ & ~x36 & ~x41;
  assign new_n203_ = ~x34 & ~x33 & ~x31 & new_n204_ & ~x30 & ~x35;
  assign new_n204_ = ~x28 & ~x26 & ~x25 & new_n205_ & ~x24 & x29;
  assign new_n205_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n196_ & x16;
  ...
  assign z25 = ~x60 & ~x58 & ~x50 & new_n210_ & ~x46;
  assign new_n210_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n211_ & x29;
  assign new_n211_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = ~x64 & ~x63 & ~x62 & new_n213_ & ~x61;
  ...
  assign new_n221_ = ~x14 & ~x13 & ~x12 & new_n173_ & ~x11 & ~x15;
  ...
  assign new_n231_ = ~x15 & ~x14 & x13 & ~x12 & new_n173_ & ~x11;
  ...
  assign new_n243_ = ~x22 & ~x21 & ~x18 & new_n196_ & ~x17;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n245_ & x39;
  assign new_n245_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  ...
  assign new_n251_ = ~x40 & ~x39 & ~x37 & new_n178_ & ~x35 & ~x41;
  ...
  assign z42 = ~x62 & new_n272_ & ~x61;
  assign new_n272_ = ~x59 & ~x58 & ~x56 & new_n273_ & ~x55 & ~x60;
  assign new_n273_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n167_ & x49;
  assign z43 = new_n275_ & ~x62;
  assign new_n275_ = ~x60 & ~x59 & ~x58 & new_n276_ & ~x56 & ~x61;
  assign new_n276_ = ~x54 & ~x53 & ~x51 & new_n277_ & ~x50 & ~x55;
  assign new_n277_ = ~x46 & ~x45 & ~x43 & new_n278_ & ~x42 & ~x47;
  assign new_n278_ = ~x40 & ~x39 & ~x37 & new_n279_ & ~x35 & ~x41;
  assign new_n279_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n280_ & x29;
  assign new_n280_ = ~x26 & ~x25 & ~x24 & new_n281_ & ~x22 & ~x28;
  assign new_n281_ = ~x17 & ~x15 & ~x14 & new_n282_ & ~x11 & ~x18;
  assign new_n282_ = ~x09 & ~x08 & ~x07 & new_n283_ & ~x06 & ~x10;
  assign new_n283_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n285_ & ~x58 & ~x62;
  assign new_n285_ = ~x55 & ~x54 & ~x53 & new_n286_ & ~x51 & ~x56;
  assign new_n286_ = ~x47 & ~x46 & ~x45 & new_n287_ & ~x43 & ~x50;
  ...
  assign new_n290_ = ~x18 & ~x17 & ~x15 & new_n291_ & ~x14 & ~x22;
  assign new_n291_ = ~x10 & ~x09 & ~x08 & new_n292_ & ~x07 & ~x11;
  assign new_n292_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  ...
  assign new_n296_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n268_ & x34;
  ...
  assign new_n303_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n259_ & x09;
  ...
  assign new_n309_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n258_ & x17;
  ...
  assign new_n331_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n172_ & x12;
  ...
  assign new_n336_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n178_ & x35;
  assign z56 = ~x64 & ~x63 & new_n338_ & ~x62;
  assign new_n338_ = ~x60 & ~x59 & ~x58 & new_n339_ & ~x57 & ~x61;
  assign new_n339_ = ~x55 & ~x54 & ~x53 & new_n340_ & ~x52 & ~x56;
  assign new_n340_ = ~x50 & ~x49 & ~x48 & new_n341_ & ~x47 & ~x51;
  assign new_n341_ = ~x45 & ~x43 & ~x42 & new_n342_ & ~x41 & ~x46;
  assign new_n342_ = ~x39 & ~x37 & ~x36 & new_n343_ & ~x35 & ~x40;
  assign new_n343_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n344_ & x29;
  assign new_n344_ = ~x26 & ~x25 & ~x24 & new_n345_ & ~x22 & ~x28;
  assign new_n345_ = ~x21 & x20 & ~x18 & ~x17 & new_n196_ & ~x16;
  ...
  assign z59 = ~x58 & ~x50 & ~x43 & new_n245_ & x40;
