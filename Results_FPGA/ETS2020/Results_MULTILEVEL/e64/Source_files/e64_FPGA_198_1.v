...
module FAU ( 
  ...
  assign new_n234_ = ~x18 & ~x15 & ~x14 & new_n218_ & ~x12 & ~x17;
  ...
  assign new_n256_ = ~x20 & ~x18 & new_n257_ & ~x17 & ~x21;
  ...
  assign new_n270_ = ~x26 & ~x24 & ~x22 & new_n234_ & ~x21 & ~x25;
  ...
  assign new_n293_ = ~x41 & ~x39 & ~x37 & new_n222_ & ~x35 & ~x40;
  ...
  assign z48 = ~x62 & ~x60 & ~x59 & new_n307_ & ~x58 & ~x61;
  assign new_n307_ = ~x56 & ~x54 & ~x53 & new_n308_ & ~x51 & ~x55;
  assign new_n308_ = ~x50 & ~x46 & ~x43 & new_n309_ & ~x42 & ~x47;
  assign new_n309_ = ~x41 & ~x39 & ~x37 & new_n310_ & ~x35 & ~x40;
  assign new_n310_ = ~x34 & ~x33 & x31 & ~x30 & new_n311_ & x29;
  assign new_n311_ = ~x26 & ~x25 & new_n312_ & ~x24 & ~x28;
  assign new_n312_ = ~x22 & ~x17 & ~x15 & new_n313_ & ~x14 & ~x18;
  assign new_n313_ = ~x10 & ~x09 & new_n314_ & ~x08 & ~x11;
  assign new_n314_ = ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z50 = new_n316_ & ~x62;
  assign new_n316_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n211_ & x57;
  assign z51 = ~x62 & ~x61 & new_n318_ & ~x60;
  assign new_n318_ = ~x59 & ~x56 & ~x55 & new_n319_ & ~x54 & ~x58;
  assign new_n319_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n213_ & x48;
  ...
  assign new_n328_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n218_ & x12;
  ...
  assign new_n333_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n222_ & x35;
