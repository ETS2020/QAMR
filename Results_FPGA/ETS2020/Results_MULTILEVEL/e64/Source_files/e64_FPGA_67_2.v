// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:16 2020
...
module FAU ( 
  ...
  assign new_n195_ = ~x43 & ~x40 & ~x39 & new_n196_ & x29 & ~x37;
  ...
  assign new_n203_ = ~x34 & ~x33 & ~x31 & new_n204_ & x29 & ~x30;
  assign new_n204_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n205_ & ~x22;
  assign new_n205_ = ~x21 & ~x20 & ~x18 & ~x17 & new_n206_ & ~x16;
  assign new_n206_ = ~x15 & ~x14 & x13 & ~x12 & new_n166_ & ~x11;
  ...
  assign new_n216_ = ~x33 & ~x31 & new_n217_ & x29 & ~x30;
  assign new_n217_ = ~x28 & ~x26 & ~x25 & new_n218_ & ~x24;
  assign new_n218_ = ~x22 & ~x21 & ~x18 & new_n190_ & ~x17;
  ...
  assign new_n225_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n171_ & ~x35;
  ...
  assign new_n236_ = ~x50 & ~x47 & ~x46 & new_n229_ & x42 & ~x43;
  assign z40 = ~x62 & ~x61 & new_n238_ & ~x60;
  assign new_n238_ = ~x59 & ~x58 & ~x56 & new_n239_ & x54 & ~x55;
  ...
  assign new_n244_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n233_ & ~x09;
  ...
  assign new_n248_ = ~x39 & ~x37 & ~x35 & new_n242_ & x33 & ~x34;
  assign z42 = ~x62 & new_n250_ & ~x61;
  assign new_n250_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n251_ & ~x55;
  assign new_n251_ = ~x54 & ~x53 & ~x51 & new_n160_ & x49 & ~x50;
  assign z43 = new_n253_ & ~x62;
  assign new_n253_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n254_ & ~x56;
  assign new_n254_ = ~x55 & ~x54 & ~x53 & ~x51 & new_n255_ & ~x50;
  assign new_n255_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n256_ & ~x42;
  assign new_n256_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n257_ & ~x35;
  assign new_n257_ = ~x34 & ~x33 & ~x31 & new_n258_ & x29 & ~x30;
  assign new_n258_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n259_ & ~x22;
  assign new_n259_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n260_ & ~x11;
  assign new_n260_ = ~x10 & ~x09 & ~x08 & ~x07 & new_n261_ & ~x06;
  assign new_n261_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x61 & ~x60 & ~x59 & new_n263_ & ~x58;
  assign new_n263_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n264_ & ~x51;
  assign new_n264_ = ~x50 & ~x47 & ~x46 & ~x45 & new_n265_ & ~x43;
  ...
  assign new_n268_ = ~x22 & ~x18 & ~x17 & ~x15 & new_n269_ & ~x14;
  assign new_n269_ = ~x11 & ~x10 & ~x09 & ~x08 & new_n270_ & ~x07;
  assign new_n270_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n272_ & ~x59;
  assign new_n272_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n273_ & ~x50;
  assign new_n273_ = ~x47 & ~x46 & ~x43 & ~x42 & new_n274_ & ~x41;
  assign new_n274_ = ~x40 & ~x39 & ~x37 & new_n242_ & x34 & ~x35;
  ...
  assign new_n280_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n281_ & ~x17;
  assign new_n281_ = ~x15 & ~x14 & ~x11 & new_n233_ & x09 & ~x10;
  assign z47 = ~x62 & new_n283_ & ~x61;
  assign new_n283_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n284_ & ~x55;
  assign new_n284_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n285_ & ~x43;
  assign new_n285_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n286_ & ~x37;
  assign new_n286_ = ~x35 & ~x30 & x29 & ~x28 & new_n287_ & ~x26;
  assign new_n287_ = ~x25 & ~x24 & ~x22 & new_n232_ & x17 & ~x18;
  assign z48 = ~x62 & ~x61 & new_n289_ & ~x60;
  assign new_n289_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n290_ & ~x54;
  assign new_n290_ = ~x53 & ~x51 & ~x50 & ~x47 & new_n291_ & ~x46;
  assign new_n291_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n292_ & ~x39;
  assign new_n292_ = ~x37 & ~x35 & ~x34 & new_n242_ & x31 & ~x33;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n294_ & ~x59;
  assign new_n294_ = ~x58 & ~x56 & ~x55 & new_n239_ & x53 & ~x54;
  assign z50 = new_n296_ & ~x62;
  assign new_n296_ = ~x61 & ~x60 & ~x59 & new_n297_ & x57 & ~x58;
  assign new_n297_ = ~x56 & ~x55 & new_n159_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n299_ & ~x60;
  assign new_n299_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n300_ & ~x54;
  assign new_n300_ = ~x53 & ~x51 & ~x50 & new_n160_ & x48 & ~x49;
  assign z52 = new_n302_ & ~x64;
  assign new_n302_ = ~x63 & ~x62 & ~x61 & ~x60 & new_n303_ & ~x59;
  assign new_n303_ = ~x58 & ~x57 & ~x56 & ~x55 & new_n304_ & ~x54;
  assign new_n304_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n305_ & ~x48;
  assign new_n305_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n306_ & ~x42;
  assign new_n306_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n307_ & ~x35;
  assign new_n307_ = ~x34 & ~x33 & ~x31 & new_n308_ & x29 & ~x30;
  assign new_n308_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n309_ & ~x22;
  assign new_n309_ = ~x18 & ~x17 & ~x15 & new_n165_ & x12 & ~x14;
  assign z53 = new_n157_ & x63 & ~x64;
  assign z54 = ~x62 & ~x60 & ~x58 & new_n224_ & x55 & ~x56;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n313_ & ~x56;
  assign new_n313_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n314_ & ~x43;
  assign new_n314_ = ~x41 & ~x40 & ~x39 & new_n171_ & x35 & ~x37;
  ...
  assign new_n323_ = ~x21 & x20 & ~x18 & ~x17 & new_n190_ & ~x16;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n325_ & ~x50;
  assign new_n325_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n326_ & ~x40;
  assign new_n326_ = ~x39 & ~x37 & ~x30 & x29 & new_n327_ & ~x28;
  assign new_n327_ = ~x26 & ~x25 & ~x24 & new_n328_ & x18 & ~x22;
  ...
  assign new_n332_ = ~x40 & ~x39 & ~x37 & new_n333_ & x29 & ~x30;
  assign new_n333_ = ~x28 & ~x26 & ~x25 & new_n328_ & x22 & ~x24;
