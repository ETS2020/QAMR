// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:40 2020
...
module FAU ( 
  ...
  assign new_n261_ = ~x43 & ~x40 & new_n192_ & ~x39;
  assign z30 = ~x63 & ~x62 & new_n263_ & ~x61 & ~x64;
  assign new_n263_ = ~x60 & ~x58 & ~x57 & new_n264_ & ~x56 & ~x59;
  assign new_n264_ = ~x55 & ~x54 & ~x53 & x52 & new_n265_ & ~x51;
  assign new_n265_ = ~x50 & ~x48 & ~x47 & new_n266_ & ~x46 & ~x49;
  assign new_n266_ = ~x45 & ~x42 & ~x41 & new_n267_ & ~x40 & ~x43;
  assign new_n267_ = ~x39 & ~x36 & ~x35 & new_n268_ & ~x34 & ~x37;
  assign new_n268_ = ~x33 & ~x31 & ~x30 & x29 & new_n269_ & ~x28;
  assign new_n269_ = ~x26 & ~x24 & ~x22 & new_n232_ & ~x21 & ~x25;
  ...
  assign new_n284_ = ~x47 & ~x43 & ~x41 & new_n285_ & ~x40 & ~x46;
  assign new_n285_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n286_ & x29;
  assign new_n286_ = ~x28 & ~x25 & ~x24 & new_n287_ & ~x22 & ~x26;
  assign new_n287_ = ~x18 & ~x14 & ~x11 & new_n288_ & ~x10 & ~x15;
  ...
  assign new_n292_ = ~x41 & ~x39 & ~x37 & new_n220_ & ~x35 & ~x40;
  ...
  assign new_n316_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n209_ & x57;
  assign z51 = ~x62 & ~x61 & new_n318_ & ~x60;
  assign new_n318_ = ~x59 & ~x56 & ~x55 & new_n319_ & ~x54 & ~x58;
  assign new_n319_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n211_ & x48;
  ...
  assign new_n328_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n216_ & x12;
  ...
  assign new_n333_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n220_ & x35;
  ...
  assign new_n342_ = ~x18 & ~x16 & ~x15 & new_n233_ & ~x14 & ~x17;
