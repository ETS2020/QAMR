// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:31 2020
...
module FAU ( 
  ...
  assign new_n204_ = ~x25 & ~x24 & new_n205_ & ~x22;
  assign new_n205_ = ~x17 & ~x15 & ~x14 & new_n181_ & ~x12 & ~x18;
  assign z23 = ~x63 & ~x62 & ~x61 & new_n207_ & ~x60 & ~x64;
  assign new_n207_ = ~x58 & ~x57 & ~x56 & new_n208_ & ~x55 & ~x59;
  assign new_n208_ = ~x53 & ~x52 & ~x51 & new_n209_ & ~x50 & ~x54;
  assign new_n209_ = ~x48 & ~x47 & ~x46 & new_n210_ & ~x45 & ~x49;
  assign new_n210_ = ~x42 & ~x41 & ~x40 & new_n211_ & ~x39 & ~x43;
  assign new_n211_ = ~x36 & ~x35 & ~x34 & new_n212_ & ~x33 & ~x37;
  assign new_n212_ = ~x31 & ~x30 & x29 & ~x28 & new_n213_ & ~x26;
  assign new_n213_ = ~x24 & ~x22 & ~x21 & new_n214_ & ~x18 & ~x25;
  assign new_n214_ = ~x17 & x16 & ~x15 & ~x14 & new_n181_ & ~x12;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n216_ & ~x46;
  ...
  assign new_n237_ = ~x31 & ~x30 & x29 & new_n238_ & ~x28;
  assign new_n238_ = ~x25 & ~x24 & ~x22 & new_n205_ & ~x21 & ~x26;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n240_ & ~x60 & ~x64;
  ...
  assign new_n244_ = ~x36 & ~x35 & ~x34 & new_n245_ & ~x33;
  assign new_n245_ = ~x31 & ~x30 & x29 & ~x28 & new_n246_ & ~x26;
  assign new_n246_ = ~x25 & ~x24 & ~x22 & new_n205_ & x21;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n248_ & x39;
  assign new_n248_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z34 = new_n250_ & x58;
  assign new_n250_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z36 = new_n252_ & ~x62;
  assign new_n252_ = ~x60 & ~x58 & ~x56 & new_n253_ & ~x55 & x61;
  assign new_n253_ = ~x50 & ~x47 & ~x46 & new_n254_ & ~x43 & ~x51;
  assign new_n254_ = ~x40 & ~x39 & ~x37 & new_n187_ & ~x35 & ~x41;
  ...
  assign new_n279_ = ~x59 & ~x58 & ~x56 & new_n280_ & ~x55 & ~x60;
  assign new_n280_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n176_ & x49;
  assign z43 = new_n282_ & ~x62;
  assign new_n282_ = ~x60 & ~x59 & ~x58 & new_n283_ & ~x56 & ~x61;
  assign new_n283_ = ~x54 & ~x53 & ~x51 & new_n284_ & ~x50 & ~x55;
  assign new_n284_ = ~x46 & ~x45 & ~x43 & new_n285_ & ~x42 & ~x47;
  assign new_n285_ = ~x40 & ~x39 & ~x37 & new_n286_ & ~x35 & ~x41;
  assign new_n286_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n287_ & x29;
  assign new_n287_ = ~x26 & ~x25 & ~x24 & new_n288_ & ~x22 & ~x28;
  assign new_n288_ = ~x17 & ~x15 & ~x14 & new_n289_ & ~x11 & ~x18;
  assign new_n289_ = ~x09 & ~x08 & ~x07 & new_n290_ & ~x06 & ~x10;
  ...
  assign new_n303_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n271_ & x34;
  ...
  assign new_n310_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n262_ & x09;
  ...
  assign new_n316_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n261_ & x17;
  ...
  assign new_n338_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n181_ & x12;
  ...
  assign new_n343_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n187_ & x35;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n345_ & ~x50 & ~x62;
  assign new_n345_ = ~x46 & ~x43 & ~x41 & new_n346_ & ~x40 & ~x47;
  assign new_n346_ = ~x39 & ~x37 & ~x30 & x29 & new_n347_ & ~x28;
  assign new_n347_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n348_ & x18;
  assign new_n348_ = ~x15 & new_n349_ & ~x14;
  assign new_n349_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n351_ & ~x56;
  assign new_n351_ = ~x47 & ~x46 & ~x43 & new_n352_ & ~x41 & ~x50;
  assign new_n352_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n353_ & x29;
  assign new_n353_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n348_ & x22;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n248_ & x40;
