...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n360_, new_n362_, new_n363_, new_n364_, new_n367_, new_n368_,
    new_n369_, new_n371_, new_n372_, new_n373_, new_n374_, new_n377_;
  ...
  assign new_n242_ = ~x17 & ~x15 & ~x14 & new_n226_ & ~x12 & ~x18;
  ...
  assign new_n267_ = ~x21 & ~x20 & ~x18 & new_n268_ & ~x17;
  assign new_n268_ = ~x16 & ~x15 & ~x14 & x13 & new_n226_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n270_ & ~x50;
  assign new_n270_ = ~x43 & ~x40 & ~x39 & new_n271_ & ~x37 & ~x46;
  assign new_n271_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n273_ & ~x46;
  assign new_n273_ = ~x43 & ~x40 & new_n200_ & ~x39;
  ...
  assign new_n281_ = ~x25 & ~x24 & ~x22 & new_n242_ & ~x21 & ~x26;
  ...
  assign new_n289_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n242_ & x21;
  ...
  assign new_n304_ = ~x40 & ~x39 & ~x37 & new_n230_ & ~x35 & ~x41;
  ...
  assign new_n313_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n258_ & x19;
  assign z42 = ~x62 & new_n315_ & ~x61;
  assign new_n315_ = ~x59 & ~x58 & ~x56 & new_n316_ & ~x55 & ~x60;
  assign new_n316_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n221_ & x49;
  assign z43 = new_n318_ & ~x62;
  assign new_n318_ = ~x60 & ~x59 & ~x58 & new_n319_ & ~x56 & ~x61;
  assign new_n319_ = ~x54 & ~x53 & ~x51 & new_n320_ & ~x50 & ~x55;
  ...
  assign new_n324_ = ~x17 & ~x15 & ~x14 & new_n325_ & ~x11 & ~x18;
  assign new_n325_ = ~x09 & ~x08 & ~x07 & new_n326_ & ~x06 & ~x10;
  assign new_n326_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n328_ & ~x58 & ~x62;
  assign new_n328_ = ~x55 & ~x54 & ~x53 & new_n329_ & ~x51 & ~x56;
  assign new_n329_ = ~x47 & ~x46 & ~x45 & new_n330_ & ~x43 & ~x50;
  assign new_n330_ = ~x41 & ~x40 & ~x39 & new_n331_ & ~x37 & ~x42;
  assign new_n331_ = ~x34 & ~x33 & ~x31 & new_n332_ & ~x30 & ~x35;
  assign new_n332_ = ~x28 & ~x26 & ~x25 & new_n333_ & ~x24 & x29;
  assign new_n333_ = ~x18 & ~x17 & ~x15 & new_n334_ & ~x14 & ~x22;
  assign new_n334_ = ~x10 & ~x09 & ~x08 & new_n335_ & ~x07 & ~x11;
  assign new_n335_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n337_ & ~x62;
  assign new_n337_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n219_ & x57;
  assign z51 = ~x62 & ~x61 & new_n339_ & ~x60;
  assign new_n339_ = ~x58 & ~x56 & ~x55 & new_n340_ & ~x54 & ~x59;
  assign new_n340_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n221_ & x48;
  assign z52 = new_n342_ & ~x64;
  assign new_n342_ = ~x62 & ~x61 & ~x60 & new_n343_ & ~x59 & ~x63;
  assign new_n343_ = ~x57 & ~x56 & ~x55 & new_n344_ & ~x54 & ~x58;
  assign new_n344_ = ~x51 & ~x50 & ~x49 & new_n345_ & ~x48 & ~x53;
  assign new_n345_ = ~x46 & ~x45 & ~x43 & new_n346_ & ~x42 & ~x47;
  assign new_n346_ = ~x40 & ~x39 & ~x37 & new_n347_ & ~x35 & ~x41;
  assign new_n347_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n348_ & x29;
  assign new_n348_ = ~x26 & ~x25 & ~x24 & new_n349_ & ~x22 & ~x28;
  assign new_n349_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n226_ & x12;
  assign z53 = ~x64 & new_n217_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n303_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n353_ & ~x56;
  assign new_n353_ = ~x50 & ~x47 & ~x46 & new_n354_ & ~x43 & ~x51;
  assign new_n354_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n230_ & x35;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n356_ & ~x50 & ~x62;
  assign new_n356_ = ~x46 & ~x43 & ~x41 & new_n357_ & ~x40 & ~x47;
  assign new_n357_ = ~x39 & ~x37 & ~x30 & x29 & new_n358_ & ~x28;
  assign new_n358_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n359_ & x18;
  assign new_n359_ = ~x15 & new_n360_ & ~x14;
  assign new_n360_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n362_ & ~x56;
  assign new_n362_ = ~x47 & ~x46 & ~x43 & new_n363_ & ~x41 & ~x50;
  assign new_n363_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n364_ & x29;
  assign new_n364_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n359_ & x22;
  ...
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n371_ & x47;
  assign new_n371_ = new_n372_ & ~x46;
  assign new_n372_ = ~x40 & ~x39 & ~x37 & new_n373_ & ~x30 & ~x43;
  assign new_n373_ = x29 & new_n374_ & ~x28;
  assign new_n374_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n371_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n377_ & ~x46;
  assign new_n377_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n373_ & x30;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
  assign z11 = 1'b0;
  assign z21 = 1'b0;
