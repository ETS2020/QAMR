// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:14 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n333_, new_n337_, new_n338_, new_n340_, new_n341_, new_n342_,
    new_n343_, new_n344_, new_n345_, new_n346_, new_n347_, new_n349_,
    new_n350_, new_n351_, new_n352_, new_n353_, new_n355_, new_n356_,
    new_n357_, new_n360_, new_n361_, new_n362_, new_n364_, new_n365_,
    new_n366_, new_n368_, new_n369_, new_n370_, new_n371_, new_n374_;
  ...
  assign z22 = ~x64 & ~x63 & ~x62 & new_n200_ & ~x61;
  assign new_n200_ = ~x59 & ~x58 & ~x57 & new_n201_ & ~x56 & ~x60;
  assign new_n201_ = ~x54 & ~x53 & ~x51 & new_n202_ & ~x50 & ~x55;
  assign new_n202_ = ~x48 & ~x47 & ~x46 & new_n203_ & ~x45 & ~x49;
  assign new_n203_ = ~x42 & ~x41 & ~x40 & new_n204_ & ~x39 & ~x43;
  assign new_n204_ = ~x37 & x36 & ~x35 & ~x34 & new_n205_ & ~x33;
  assign new_n205_ = ~x31 & ~x30 & x29 & ~x28 & new_n206_ & ~x26;
  assign new_n206_ = ~x24 & ~x22 & ~x18 & new_n207_ & ~x17 & ~x25;
  assign new_n207_ = ~x15 & ~x14 & ~x12 & new_n184_ & ~x11;
  assign z23 = ~x64 & new_n209_ & ~x63;
  assign new_n209_ = ~x61 & ~x60 & ~x59 & new_n210_ & ~x58 & ~x62;
  assign new_n210_ = ~x56 & ~x55 & ~x54 & new_n211_ & ~x53 & ~x57;
  assign new_n211_ = ~x51 & ~x50 & ~x49 & new_n212_ & ~x48 & ~x52;
  assign new_n212_ = ~x46 & ~x45 & ~x43 & new_n213_ & ~x42 & ~x47;
  assign new_n213_ = ~x40 & ~x39 & ~x37 & new_n214_ & ~x36 & ~x41;
  assign new_n214_ = ~x34 & ~x33 & ~x31 & new_n215_ & ~x30 & ~x35;
  assign new_n215_ = ~x28 & ~x26 & ~x25 & new_n216_ & ~x24 & x29;
  assign new_n216_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n207_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n218_ & ~x43 & ~x60;
  assign new_n218_ = ~x40 & ~x39 & ~x37 & x29 & new_n219_ & ~x28;
  assign new_n219_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n221_ & ~x46;
  assign new_n221_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n222_ & x29;
  assign new_n222_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z27 = ~x64 & ~x63 & new_n224_ & ~x62;
  assign new_n224_ = ~x60 & ~x59 & ~x58 & new_n225_ & ~x57 & ~x61;
  assign new_n225_ = ~x55 & ~x54 & ~x53 & new_n226_ & ~x52 & ~x56;
  assign new_n226_ = ~x50 & ~x49 & ~x48 & new_n227_ & ~x47 & ~x51;
  assign new_n227_ = ~x45 & ~x43 & ~x42 & new_n228_ & ~x41 & ~x46;
  assign new_n228_ = ~x39 & ~x37 & ~x36 & new_n229_ & ~x35 & ~x40;
  assign new_n229_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n230_ & x29;
  assign new_n230_ = ~x26 & ~x25 & ~x24 & new_n231_ & ~x22 & ~x28;
  assign new_n231_ = ~x20 & ~x18 & ~x17 & new_n232_ & ~x16 & ~x21;
  assign new_n232_ = ~x15 & ~x14 & x13 & ~x12 & new_n184_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n234_ & ~x50;
  assign new_n234_ = ~x43 & ~x40 & ~x39 & new_n235_ & ~x37 & ~x46;
  assign new_n235_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n237_ & ~x60 & ~x64;
  assign new_n237_ = ~x58 & ~x57 & ~x56 & new_n238_ & ~x55 & ~x59;
  assign new_n238_ = ~x54 & ~x53 & x52 & ~x51 & new_n239_ & ~x50;
  assign new_n239_ = ~x48 & ~x47 & ~x46 & new_n240_ & ~x45 & ~x49;
  assign new_n240_ = ~x43 & ~x42 & ~x41 & new_n241_ & ~x40;
  assign new_n241_ = ~x37 & ~x36 & ~x35 & new_n242_ & ~x34 & ~x39;
  assign new_n242_ = ~x33 & ~x31 & ~x30 & new_n243_ & x29;
  assign new_n243_ = ~x28 & ~x26 & ~x25 & new_n244_ & ~x24;
  assign new_n244_ = ~x22 & ~x21 & ~x18 & new_n207_ & ~x17;
  ...
  assign new_n251_ = ~x40 & ~x39 & ~x37 & new_n189_ & ~x35 & ~x41;
  ...
  assign z40 = new_n264_ & ~x62;
  assign new_n264_ = ~x60 & ~x59 & ~x58 & new_n265_ & ~x56 & ~x61;
  assign new_n265_ = ~x55 & x54 & ~x51 & ~x50 & new_n266_ & ~x47;
  ...
  assign new_n277_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n178_ & x49;
  ...
  assign new_n321_ = ~x56 & ~x55 & new_n177_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n323_ & ~x60;
  assign new_n323_ = ~x58 & ~x56 & ~x55 & new_n324_ & ~x54 & ~x59;
  assign new_n324_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n178_ & x48;
  ...
  assign new_n333_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n183_ & x12;
  ...
  assign new_n338_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n189_ & x35;
  ...
  assign new_n347_ = ~x21 & x20 & ~x18 & ~x17 & new_n207_ & ~x16;
  ...
  assign z60 = ~x58 & ~x56 & ~x50 & new_n360_ & ~x47 & ~x60;
  assign new_n360_ = ~x43 & ~x40 & ~x39 & new_n361_ & ~x37 & ~x46;
  assign new_n361_ = ~x30 & x29 & ~x28 & ~x25 & new_n362_ & ~x24;
  assign new_n362_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n364_ & ~x50;
  assign new_n364_ = ~x46 & ~x43 & ~x40 & new_n365_ & ~x39 & ~x47;
  assign new_n365_ = ~x37 & ~x30 & x29 & ~x28 & new_n366_ & ~x25;
  assign new_n366_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
