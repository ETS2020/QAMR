// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:34 2020
...
module FAU ( 
  ...
  assign z22 = ~x64 & ~x63 & ~x62 & new_n183_ & ~x61;
  assign new_n183_ = ~x59 & ~x58 & ~x57 & new_n184_ & ~x56 & ~x60;
  assign new_n184_ = ~x54 & ~x53 & ~x51 & new_n185_ & ~x50 & ~x55;
  assign new_n185_ = ~x48 & ~x47 & ~x46 & new_n186_ & ~x45 & ~x49;
  assign new_n186_ = ~x42 & ~x41 & ~x40 & new_n187_ & ~x39 & ~x43;
  assign new_n187_ = ~x37 & x36 & ~x35 & ~x34 & new_n188_ & ~x33;
  assign new_n188_ = ~x31 & ~x30 & x29 & ~x28 & new_n189_ & ~x26;
  assign new_n189_ = ~x24 & ~x22 & ~x18 & new_n190_ & ~x17 & ~x25;
  assign new_n190_ = ~x15 & ~x14 & ~x12 & new_n173_ & ~x11;
  assign z23 = ~x64 & new_n192_ & ~x63;
  assign new_n192_ = ~x61 & ~x60 & ~x59 & new_n193_ & ~x58 & ~x62;
  assign new_n193_ = ~x56 & ~x55 & ~x54 & new_n194_ & ~x53 & ~x57;
  assign new_n194_ = ~x51 & ~x50 & ~x49 & new_n195_ & ~x48 & ~x52;
  assign new_n195_ = ~x46 & ~x45 & ~x43 & new_n196_ & ~x42 & ~x47;
  assign new_n196_ = ~x40 & ~x39 & ~x37 & new_n197_ & ~x36 & ~x41;
  assign new_n197_ = ~x34 & ~x33 & ~x31 & new_n198_ & ~x30 & ~x35;
  assign new_n198_ = ~x28 & ~x26 & ~x25 & new_n199_ & ~x24 & x29;
  assign new_n199_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n190_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n201_ & ~x43 & ~x60;
  assign new_n201_ = ~x40 & ~x39 & ~x37 & x29 & new_n202_ & ~x28;
  assign new_n202_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n204_ & ~x46;
  assign new_n204_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n205_ & x29;
  assign new_n205_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  ...
  assign new_n215_ = ~x15 & ~x14 & x13 & ~x12 & new_n173_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n217_ & ~x50;
  assign new_n217_ = ~x43 & ~x40 & ~x39 & new_n218_ & ~x37 & ~x46;
  assign new_n218_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n220_ & ~x60 & ~x64;
  assign new_n220_ = ~x58 & ~x57 & ~x56 & new_n221_ & ~x55 & ~x59;
  assign new_n221_ = ~x54 & ~x53 & x52 & ~x51 & new_n222_ & ~x50;
  assign new_n222_ = ~x48 & ~x47 & ~x46 & new_n223_ & ~x45 & ~x49;
  assign new_n223_ = ~x43 & ~x42 & ~x41 & new_n224_ & ~x40;
  assign new_n224_ = ~x37 & ~x36 & ~x35 & new_n225_ & ~x34 & ~x39;
  assign new_n225_ = ~x33 & ~x31 & ~x30 & new_n226_ & x29;
  assign new_n226_ = ~x28 & ~x26 & ~x25 & new_n227_ & ~x24;
  assign new_n227_ = ~x22 & ~x21 & ~x18 & new_n190_ & ~x17;
  ...
  assign z35 = ~x62 & ~x61 & new_n233_ & ~x60;
  assign new_n233_ = ~x56 & ~x55 & ~x51 & new_n234_ & ~x50 & ~x58;
  assign new_n234_ = ~x46 & ~x43 & ~x41 & new_n235_ & ~x40 & ~x47;
  assign new_n235_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n236_ & x29;
  assign new_n236_ = ~x26 & ~x25 & ~x24 & new_n237_ & ~x22 & ~x28;
  assign new_n237_ = ~x15 & ~x14 & ~x11 & new_n238_ & ~x10 & ~x18;
  assign new_n238_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n240_ & ~x62;
  assign new_n240_ = ~x60 & ~x58 & ~x56 & new_n241_ & ~x55 & x61;
  assign new_n241_ = ~x50 & ~x47 & ~x46 & new_n242_ & ~x43 & ~x51;
  assign new_n242_ = ~x40 & ~x39 & ~x37 & new_n178_ & ~x35 & ~x41;
  ...
  assign new_n257_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n258_ & x33;
  assign new_n258_ = ~x30 & x29 & ~x28 & new_n259_ & ~x26;
  assign new_n259_ = ~x24 & ~x22 & ~x18 & new_n260_ & ~x17 & ~x25;
  assign new_n260_ = ~x14 & ~x11 & ~x10 & new_n250_ & ~x09 & ~x15;
  assign z42 = ~x62 & new_n262_ & ~x61;
  assign new_n262_ = ~x59 & ~x58 & ~x56 & new_n263_ & ~x55 & ~x60;
  assign new_n263_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n167_ & x49;
  assign z43 = new_n265_ & ~x62;
  assign new_n265_ = ~x60 & ~x59 & ~x58 & new_n266_ & ~x56 & ~x61;
  assign new_n266_ = ~x54 & ~x53 & ~x51 & new_n267_ & ~x50 & ~x55;
  assign new_n267_ = ~x46 & ~x45 & ~x43 & new_n268_ & ~x42 & ~x47;
  assign new_n268_ = ~x40 & ~x39 & ~x37 & new_n269_ & ~x35 & ~x41;
  assign new_n269_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n270_ & x29;
  assign new_n270_ = ~x26 & ~x25 & ~x24 & new_n271_ & ~x22 & ~x28;
  assign new_n271_ = ~x17 & ~x15 & ~x14 & new_n272_ & ~x11 & ~x18;
  assign new_n272_ = ~x09 & ~x08 & ~x07 & new_n273_ & ~x06 & ~x10;
  assign new_n273_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n275_ & ~x58 & ~x62;
  assign new_n275_ = ~x55 & ~x54 & ~x53 & new_n276_ & ~x51 & ~x56;
  assign new_n276_ = ~x47 & ~x46 & ~x45 & new_n277_ & ~x43 & ~x50;
  assign new_n277_ = ~x41 & ~x40 & ~x39 & new_n278_ & ~x37 & ~x42;
  assign new_n278_ = ~x34 & ~x33 & ~x31 & new_n279_ & ~x30 & ~x35;
  assign new_n279_ = ~x28 & ~x26 & ~x25 & new_n280_ & ~x24 & x29;
  assign new_n280_ = ~x18 & ~x17 & ~x15 & new_n281_ & ~x14 & ~x22;
  assign new_n281_ = ~x10 & ~x09 & ~x08 & new_n282_ & ~x07 & ~x11;
  assign new_n282_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  ...
  assign new_n286_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n258_ & x34;
  ...
  assign new_n293_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n250_ & x09;
  ...
  assign new_n299_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n249_ & x17;
  ...
  assign new_n304_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n258_ & x31;
  assign z49 = ~x62 & new_n306_ & ~x61;
  ...
  assign new_n309_ = ~x37 & ~x35 & ~x34 & new_n258_ & ~x33 & ~x39;
  assign z50 = new_n311_ & ~x62;
  assign new_n311_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n312_ & x57;
  assign new_n312_ = ~x56 & ~x55 & new_n166_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n314_ & ~x60;
  assign new_n314_ = ~x58 & ~x56 & ~x55 & new_n315_ & ~x54 & ~x59;
  assign new_n315_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n167_ & x48;
  assign z52 = new_n317_ & ~x64;
  assign new_n317_ = ~x62 & ~x61 & ~x60 & new_n318_ & ~x59 & ~x63;
  assign new_n318_ = ~x57 & ~x56 & ~x55 & new_n319_ & ~x54 & ~x58;
  assign new_n319_ = ~x51 & ~x50 & ~x49 & new_n320_ & ~x48 & ~x53;
  assign new_n320_ = ~x46 & ~x45 & ~x43 & new_n321_ & ~x42 & ~x47;
  assign new_n321_ = ~x40 & ~x39 & ~x37 & new_n322_ & ~x35 & ~x41;
  assign new_n322_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n323_ & x29;
  assign new_n323_ = ~x26 & ~x25 & ~x24 & new_n324_ & ~x22 & ~x28;
  assign new_n324_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n172_ & x12;
  assign z53 = ~x64 & new_n164_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n241_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n328_ & ~x56;
  assign new_n328_ = ~x50 & ~x47 & ~x46 & new_n329_ & ~x43 & ~x51;
  assign new_n329_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n178_ & x35;
  ...
  assign new_n338_ = ~x21 & x20 & ~x18 & ~x17 & new_n190_ & ~x16;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n340_ & ~x50 & ~x62;
  ...
  assign z58 = ~x62 & ~x60 & ~x58 & new_n346_ & ~x56;
