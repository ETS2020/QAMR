// Benchmark "FAU" written by ABC on Wed Aug  5 20:40:34 2020
...
module FAU ( 
  ...
  assign new_n214_ = ~x24 & ~x22 & ~x18 & new_n215_ & ~x17 & ~x25;
  assign new_n215_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z23 = ~x64 & new_n217_ & ~x63;
  assign new_n217_ = ~x61 & ~x60 & ~x59 & new_n218_ & ~x58 & ~x62;
  assign new_n218_ = ~x56 & ~x55 & ~x54 & new_n219_ & ~x53 & ~x57;
  assign new_n219_ = ~x51 & ~x50 & ~x49 & new_n220_ & ~x48 & ~x52;
  assign new_n220_ = ~x46 & ~x45 & ~x43 & new_n221_ & ~x42 & ~x47;
  assign new_n221_ = ~x40 & ~x39 & ~x37 & new_n222_ & ~x36 & ~x41;
  assign new_n222_ = ~x34 & ~x33 & ~x31 & new_n223_ & ~x30 & ~x35;
  assign new_n223_ = ~x28 & ~x26 & ~x25 & new_n224_ & ~x24 & x29;
  assign new_n224_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n215_ & x16;
  ...
  assign new_n237_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z28 = ~x60 & ~x58 & new_n239_ & ~x50;
  assign new_n239_ = ~x43 & ~x40 & ~x39 & new_n240_ & ~x37 & ~x46;
  assign new_n240_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n242_ & ~x46;
  assign new_n242_ = ~x43 & ~x40 & new_n195_ & ~x39;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n244_ & ~x60 & ~x64;
  ...
  assign new_n248_ = ~x35 & ~x34 & ~x33 & new_n249_ & ~x31 & ~x36;
  assign new_n249_ = ~x30 & x29 & ~x28 & ~x26 & new_n250_ & ~x25;
  assign new_n250_ = ~x24 & ~x22 & x21 & ~x18 & new_n215_ & ~x17;
  assign z32 = ~x58 & ~x50 & new_n242_ & x46;
  ...
  assign new_n283_ = ~x37 & ~x35 & ~x34 & new_n284_ & ~x33 & ~x39;
  assign new_n284_ = ~x30 & x29 & ~x28 & new_n285_ & ~x26;
  assign new_n285_ = ~x24 & ~x22 & ~x18 & new_n286_ & ~x17 & ~x25;
  assign new_n286_ = ~x14 & ~x11 & ~x10 & new_n275_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n288_ & ~x58 & ~x62;
  assign new_n288_ = ~x55 & ~x51 & ~x50 & new_n289_ & ~x47 & ~x56;
  assign new_n289_ = ~x43 & ~x42 & ~x41 & new_n290_ & ~x40 & ~x46;
  assign new_n290_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n284_ & x33;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n292_ & ~x58 & ~x62;
  assign new_n292_ = ~x55 & ~x54 & ~x53 & new_n293_ & ~x51 & ~x56;
  assign new_n293_ = ~x47 & ~x46 & ~x45 & new_n294_ & ~x43 & ~x50;
  assign new_n294_ = ~x41 & ~x40 & ~x39 & new_n295_ & ~x37 & ~x42;
  assign new_n295_ = ~x34 & ~x33 & ~x31 & new_n296_ & ~x30 & ~x35;
  assign new_n296_ = ~x28 & ~x26 & ~x25 & new_n297_ & ~x24 & x29;
  assign new_n297_ = ~x18 & ~x17 & ~x15 & new_n298_ & ~x14 & ~x22;
  assign new_n298_ = ~x10 & ~x09 & ~x08 & new_n299_ & ~x07 & ~x11;
  ...
  assign new_n303_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n284_ & x34;
  ...
  assign new_n310_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n275_ & x09;
  ...
  assign new_n316_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n274_ & x17;
  ...
  assign new_n321_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n284_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n323_ & ~x59;
  assign new_n323_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n281_ & x53;
  assign z56 = ~x64 & ~x63 & new_n325_ & ~x62;
  assign new_n325_ = ~x60 & ~x59 & ~x58 & new_n326_ & ~x57 & ~x61;
  assign new_n326_ = ~x55 & ~x54 & ~x53 & new_n327_ & ~x52 & ~x56;
  ...
  assign new_n332_ = ~x21 & x20 & ~x18 & ~x17 & new_n215_ & ~x16;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n334_ & ~x50;
  assign new_n334_ = ~x46 & ~x43 & ~x40 & new_n335_ & ~x39 & ~x47;
  assign new_n335_ = ~x37 & ~x30 & x29 & ~x28 & new_n336_ & ~x25;
  assign new_n336_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
