// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:52 2020
...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n145_,
    ...
    new_n319_, new_n320_, new_n324_, new_n325_, new_n327_, new_n328_,
  ...
  assign new_n186_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n187_ & ~x17;
  assign new_n187_ = ~x15 & ~x14 & ~x12 & new_n164_ & ~x11;
  assign z23 = ~x64 & new_n189_ & ~x63;
  assign new_n189_ = ~x62 & ~x61 & ~x60 & ~x59 & new_n190_ & ~x58;
  assign new_n190_ = ~x57 & ~x56 & ~x55 & ~x54 & new_n191_ & ~x53;
  assign new_n191_ = ~x52 & ~x51 & ~x50 & ~x49 & new_n192_ & ~x48;
  assign new_n192_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n193_ & ~x42;
  assign new_n193_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n194_ & ~x36;
  assign new_n194_ = ~x35 & ~x34 & ~x33 & ~x31 & new_n195_ & ~x30;
  assign new_n195_ = x29 & ~x28 & ~x26 & ~x25 & new_n196_ & ~x24;
  assign new_n196_ = ~x22 & ~x21 & ~x18 & new_n187_ & x16 & ~x17;
  ...
  assign new_n206_ = ~x34 & ~x33 & ~x31 & new_n207_ & x29 & ~x30;
  assign new_n207_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n208_ & ~x22;
  assign new_n208_ = ~x21 & ~x20 & ~x18 & ~x17 & new_n209_ & ~x16;
  assign new_n209_ = ~x15 & ~x14 & x13 & ~x12 & new_n164_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n211_ & ~x50;
  assign new_n211_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n212_ & ~x37;
  assign new_n212_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & ~x61 & new_n214_ & ~x60;
  ...
  assign new_n217_ = ~x43 & ~x42 & ~x41 & new_n218_ & ~x40;
  assign new_n218_ = ~x39 & ~x37 & ~x36 & ~x35 & new_n219_ & ~x34;
  assign new_n219_ = ~x33 & ~x31 & new_n220_ & x29 & ~x30;
  assign new_n220_ = ~x28 & ~x26 & ~x25 & new_n221_ & ~x24;
  assign new_n221_ = ~x22 & ~x21 & ~x18 & new_n187_ & ~x17;
  assign z33 = ~x58 & ~x50 & ~x43 & new_n223_ & x39 & ~x40;
  assign new_n223_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z34 = new_n225_ & x58;
  assign new_n225_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n227_ & ~x60;
  assign new_n227_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n228_ & ~x50;
  ...
  assign new_n234_ = x61 & ~x60 & ~x58 & ~x56 & new_n235_ & ~x55;
  assign new_n235_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n236_ & ~x43;
  assign new_n236_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n169_ & ~x35;
  ...
  assign new_n246_ = ~x60 & ~x58 & ~x56 & ~x55 & new_n247_ & ~x51;
  assign new_n247_ = ~x50 & ~x47 & ~x46 & new_n240_ & x42 & ~x43;
  assign z40 = ~x62 & ~x61 & new_n249_ & ~x60;
  assign new_n249_ = ~x59 & ~x58 & ~x56 & new_n250_ & x54 & ~x55;
  ...
  assign new_n255_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n244_ & ~x09;
  assign z41 = ~x62 & ~x61 & ~x60 & ~x59 & new_n257_ & ~x58;
  assign new_n257_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n258_ & ~x47;
  assign new_n258_ = ~x46 & ~x43 & ~x42 & ~x41 & new_n259_ & ~x40;
  assign new_n259_ = ~x39 & ~x37 & ~x35 & new_n253_ & x33 & ~x34;
  assign z42 = ~x62 & new_n261_ & ~x61;
  assign new_n261_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n262_ & ~x55;
  assign new_n262_ = ~x54 & ~x53 & ~x51 & new_n158_ & x49 & ~x50;
  ...
  assign new_n268_ = ~x34 & ~x33 & ~x31 & new_n269_ & x29 & ~x30;
  ...
  assign z44 = ~x62 & ~x61 & ~x60 & ~x59 & new_n274_ & ~x58;
  assign new_n274_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n275_ & ~x51;
  assign new_n275_ = ~x50 & ~x47 & ~x46 & ~x45 & new_n276_ & ~x43;
  ...
  assign new_n279_ = ~x22 & ~x18 & ~x17 & ~x15 & new_n280_ & ~x14;
  assign new_n280_ = ~x11 & ~x10 & ~x09 & ~x08 & new_n281_ & ~x07;
  assign new_n281_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n283_ & ~x59;
  assign new_n283_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n284_ & ~x50;
  assign new_n284_ = ~x47 & ~x46 & ~x43 & ~x42 & new_n285_ & ~x41;
  assign new_n285_ = ~x40 & ~x39 & ~x37 & new_n253_ & x34 & ~x35;
  assign z46 = ~x62 & new_n287_ & ~x61;
  assign new_n287_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n288_ & ~x55;
  assign new_n288_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n289_ & ~x43;
  ...
  assign new_n292_ = ~x15 & ~x14 & ~x11 & new_n244_ & x09 & ~x10;
  ...
  assign new_n298_ = ~x25 & ~x24 & ~x22 & new_n243_ & x17 & ~x18;
  assign z48 = ~x62 & ~x61 & new_n300_ & ~x60;
  assign new_n300_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n301_ & ~x54;
  assign new_n301_ = ~x53 & ~x51 & ~x50 & ~x47 & new_n302_ & ~x46;
  assign new_n302_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n303_ & ~x39;
  assign new_n303_ = ~x37 & ~x35 & ~x34 & new_n253_ & x31 & ~x33;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n305_ & ~x59;
  assign new_n305_ = ~x58 & ~x56 & ~x55 & new_n250_ & x53 & ~x54;
  assign z50 = new_n307_ & ~x62;
  assign new_n307_ = ~x61 & ~x60 & ~x59 & new_n308_ & x57 & ~x58;
  assign new_n308_ = ~x56 & ~x55 & new_n157_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n310_ & ~x60;
  assign new_n310_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n311_ & ~x54;
  assign new_n311_ = ~x53 & ~x51 & ~x50 & new_n158_ & x48 & ~x49;
  assign z52 = new_n313_ & ~x64;
  assign new_n313_ = ~x63 & ~x62 & ~x61 & ~x60 & new_n314_ & ~x59;
  assign new_n314_ = ~x58 & ~x57 & ~x56 & ~x55 & new_n315_ & ~x54;
  assign new_n315_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n316_ & ~x48;
  assign new_n316_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n317_ & ~x42;
  assign new_n317_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n318_ & ~x35;
  assign new_n318_ = ~x34 & ~x33 & ~x31 & new_n319_ & x29 & ~x30;
  assign new_n319_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n320_ & ~x22;
  assign new_n320_ = ~x18 & ~x17 & ~x15 & new_n163_ & x12 & ~x14;
  assign z53 = new_n155_ & x63 & ~x64;
  assign z54 = ~x62 & ~x60 & ~x58 & new_n235_ & x55 & ~x56;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n324_ & ~x56;
  assign new_n324_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n325_ & ~x43;
  assign new_n325_ = ~x41 & ~x40 & ~x39 & new_n169_ & x35 & ~x37;
  assign z56 = ~x64 & ~x63 & new_n327_ & ~x62;
  assign new_n327_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n328_ & ~x57;
  assign new_n328_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n329_ & ~x52;
  ...
  assign new_n332_ = ~x34 & ~x33 & ~x31 & new_n333_ & x29 & ~x30;
  assign new_n333_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n334_ & ~x22;
  assign new_n334_ = ~x21 & x20 & ~x18 & ~x17 & new_n187_ & ~x16;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n336_ & ~x50;
  assign new_n336_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n337_ & ~x40;
  assign new_n337_ = ~x39 & ~x37 & ~x30 & x29 & new_n338_ & ~x28;
  assign new_n338_ = ~x26 & ~x25 & ~x24 & new_n339_ & x18 & ~x22;
  ...
  assign new_n343_ = ~x40 & ~x39 & ~x37 & new_n344_ & x29 & ~x30;
  assign new_n344_ = ~x28 & ~x26 & ~x25 & new_n339_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n223_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n347_ & ~x47;
  assign new_n347_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n348_ & ~x37;
  assign new_n348_ = ~x30 & x29 & ~x28 & ~x25 & new_n349_ & ~x24;
  assign new_n349_ = ~x15 & ~x14 & ~x11 & ~x10 & x07 & ~x08;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n351_ & ~x50;
  assign new_n351_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n352_ & ~x39;
  assign new_n352_ = ~x37 & ~x30 & x29 & ~x28 & new_n353_ & ~x25;
  assign new_n353_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n355_ & x47 & ~x50;
  assign new_n355_ = new_n356_ & ~x46;
  assign new_n356_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n357_ & ~x30;
  ...
  assign new_n361_ = ~x43 & ~x40 & ~x39 & new_n357_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
