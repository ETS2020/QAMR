// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:45 2020
...
module FAU ( 
  ...
  assign new_n340_ = ~x21 & x20 & ~x18 & ~x17 & new_n226_ & ~x16;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n342_ & ~x50;
  assign new_n342_ = ~x46 & ~x43 & ~x40 & new_n343_ & ~x39 & ~x47;
  assign new_n343_ = ~x37 & ~x30 & x29 & ~x28 & new_n344_ & ~x25;
  assign new_n344_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z04 = 1'b0;
  assign z07 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
