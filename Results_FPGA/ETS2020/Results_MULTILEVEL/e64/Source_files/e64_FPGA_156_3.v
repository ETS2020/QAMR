// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:15 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n287_, new_n288_, new_n289_, new_n290_, new_n294_, new_n296_,
    ...
    new_n432_, new_n433_, new_n434_, new_n435_, new_n438_;
  ...
  assign new_n192_ = ~x56 & ~x50 & ~x47 & new_n193_ & ~x46 & ~x58;
  assign new_n193_ = ~x40 & ~x39 & ~x37 & new_n194_ & ~x30 & ~x43;
  assign new_n194_ = ~x28 & ~x25 & ~x24 & new_n195_ & ~x15 & x29;
  assign new_n195_ = ~x11 & ~x10 & ~x08 & x03 & ~x07 & ~x14;
  assign z18 = new_n197_ & x62;
  assign new_n197_ = ~x58 & ~x56 & ~x50 & new_n198_ & ~x47 & ~x60;
  assign new_n198_ = ~x43 & ~x40 & ~x39 & new_n199_ & ~x37 & ~x46;
  assign new_n199_ = ~x30 & x29 & ~x28 & ~x25 & new_n200_ & ~x24;
  ...
  assign new_n205_ = ~x51 & ~x50 & ~x49 & new_n206_ & ~x48 & ~x53;
  assign new_n206_ = ~x47 & ~x46 & ~x45 & new_n207_ & ~x43;
  assign new_n207_ = ~x41 & ~x40 & ~x39 & new_n208_ & ~x37 & ~x42;
  assign new_n208_ = ~x34 & ~x33 & ~x31 & new_n209_ & ~x30 & ~x35;
  assign new_n209_ = ~x28 & ~x26 & ~x25 & new_n210_ & ~x24 & x29;
  assign new_n210_ = ~x18 & ~x17 & ~x15 & new_n211_ & ~x14 & ~x22;
  assign new_n211_ = new_n143_ & ~x11;
  ...
  assign z22 = ~x64 & new_n226_ & ~x63;
  assign new_n226_ = ~x61 & ~x60 & ~x59 & new_n227_ & ~x58 & ~x62;
  assign new_n227_ = ~x56 & ~x55 & ~x54 & new_n228_ & ~x53 & ~x57;
  assign new_n228_ = ~x50 & ~x49 & ~x48 & new_n229_ & ~x47 & ~x51;
  assign new_n229_ = ~x45 & ~x43 & ~x42 & new_n230_ & ~x41 & ~x46;
  assign new_n230_ = ~x40 & ~x39 & ~x37 & x36 & new_n231_ & ~x35;
  assign new_n231_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n232_ & x29;
  assign new_n232_ = ~x26 & ~x25 & ~x24 & new_n233_ & ~x22 & ~x28;
  assign new_n233_ = ~x18 & ~x17 & ~x15 & new_n234_ & ~x14;
  assign new_n234_ = new_n211_ & ~x12;
  assign z23 = ~x64 & ~x63 & ~x62 & new_n236_ & ~x61;
  assign new_n236_ = ~x59 & ~x58 & ~x57 & new_n237_ & ~x56 & ~x60;
  assign new_n237_ = ~x54 & ~x53 & ~x52 & new_n238_ & ~x51 & ~x55;
  assign new_n238_ = ~x49 & ~x48 & ~x47 & new_n239_ & ~x46 & ~x50;
  assign new_n239_ = ~x43 & ~x42 & ~x41 & new_n240_ & ~x40 & ~x45;
  assign new_n240_ = ~x37 & ~x36 & ~x35 & new_n241_ & ~x34 & ~x39;
  assign new_n241_ = ~x33 & ~x31 & ~x30 & x29 & new_n242_ & ~x28;
  assign new_n242_ = ~x25 & ~x24 & ~x22 & new_n243_ & ~x21 & ~x26;
  assign new_n243_ = ~x18 & ~x17 & x16 & ~x15 & new_n234_ & ~x14;
  ...
  assign new_n259_ = ~x18 & ~x17 & new_n142_ & ~x16;
  ...
  assign new_n269_ = ~x15 & ~x14 & x13 & new_n211_ & ~x12;
  ...
  assign new_n274_ = ~x43 & ~x40 & new_n185_ & ~x39;
  ...
  assign new_n282_ = ~x25 & ~x24 & ~x22 & new_n233_ & ~x21 & ~x26;
  assign z31 = ~x64 & ~x63 & new_n284_ & ~x62;
  assign new_n284_ = ~x60 & ~x59 & ~x58 & new_n285_ & ~x57 & ~x61;
  assign new_n285_ = ~x55 & ~x54 & ~x53 & new_n286_ & ~x51 & ~x56;
  ...
  assign new_n290_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n233_ & x21;
  ...
  assign new_n297_ = ~x46 & ~x43 & ~x41 & new_n298_ & ~x40 & ~x47;
  assign new_n298_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n299_ & x29;
  assign new_n299_ = ~x26 & ~x25 & ~x24 & new_n300_ & ~x22 & ~x28;
  assign new_n300_ = ~x15 & ~x14 & ~x11 & new_n301_ & ~x10 & ~x18;
  assign new_n301_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n303_ & ~x62;
  assign new_n303_ = ~x60 & ~x58 & ~x56 & new_n304_ & ~x55 & x61;
  assign new_n304_ = ~x50 & ~x47 & ~x46 & new_n305_ & ~x43 & ~x51;
  assign new_n305_ = ~x40 & ~x39 & ~x37 & new_n215_ & ~x35 & ~x41;
  assign z37 = ~x64 & new_n307_ & ~x63;
  assign new_n307_ = ~x61 & ~x60 & ~x59 & new_n308_ & ~x58 & ~x62;
  assign new_n308_ = ~x56 & ~x55 & ~x54 & new_n309_ & ~x53 & ~x57;
  assign new_n309_ = ~x51 & ~x50 & ~x49 & new_n310_ & ~x48 & ~x52;
  assign new_n310_ = ~x46 & ~x45 & ~x43 & new_n311_ & ~x42 & ~x47;
  assign new_n311_ = ~x40 & ~x39 & ~x37 & new_n312_ & ~x36 & ~x41;
  assign new_n312_ = ~x34 & ~x33 & ~x32 & new_n313_ & ~x31 & ~x35;
  assign new_n313_ = ~x30 & x29 & ~x28 & ~x26 & new_n314_ & ~x25;
  assign new_n314_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n259_ & x19;
  assign z38 = ~x62 & ~x61 & new_n316_ & ~x60;
  assign new_n316_ = ~x58 & ~x56 & ~x55 & new_n317_ & ~x51 & x59;
  assign new_n317_ = ~x47 & ~x46 & ~x43 & new_n318_ & ~x42 & ~x50;
  assign new_n318_ = ~x41 & ~x40 & new_n319_ & ~x39;
  assign new_n319_ = ~x37 & ~x35 & ~x30 & x29 & new_n320_ & ~x28;
  assign new_n320_ = ~x25 & ~x24 & ~x22 & new_n321_ & ~x18 & ~x26;
  assign new_n321_ = ~x15 & ~x14 & ~x11 & new_n322_ & ~x10;
  assign new_n322_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n324_ & ~x61;
  assign new_n324_ = ~x58 & ~x56 & ~x55 & new_n325_ & ~x51 & ~x60;
  ...
  assign new_n329_ = ~x43 & ~x42 & ~x41 & new_n330_ & ~x40 & ~x46;
  assign new_n330_ = ~x37 & ~x35 & ~x34 & new_n331_ & ~x33 & ~x39;
  assign new_n331_ = ~x30 & x29 & ~x28 & new_n332_ & ~x26;
  assign new_n332_ = ~x24 & ~x22 & ~x18 & new_n333_ & ~x17 & ~x25;
  assign new_n333_ = ~x14 & ~x11 & ~x10 & new_n322_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n335_ & ~x58 & ~x62;
  assign new_n335_ = ~x55 & ~x51 & ~x50 & new_n336_ & ~x47 & ~x56;
  assign new_n336_ = ~x43 & ~x42 & ~x41 & new_n337_ & ~x40 & ~x46;
  assign new_n337_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n331_ & x33;
  assign z42 = ~x62 & new_n339_ & ~x61;
  assign new_n339_ = ~x59 & ~x58 & ~x56 & new_n340_ & ~x55 & ~x60;
  assign new_n340_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n206_ & x49;
  assign z43 = new_n342_ & ~x62;
  assign new_n342_ = ~x60 & ~x59 & ~x58 & new_n343_ & ~x56 & ~x61;
  assign new_n343_ = ~x54 & ~x53 & ~x51 & new_n344_ & ~x50 & ~x55;
  ...
  assign new_n348_ = ~x17 & ~x15 & ~x14 & new_n349_ & ~x11 & ~x18;
  assign new_n349_ = ~x09 & ~x08 & ~x07 & new_n350_ & ~x06 & ~x10;
  assign new_n350_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n352_ & ~x58 & ~x62;
  assign new_n352_ = ~x55 & ~x54 & ~x53 & new_n353_ & ~x51 & ~x56;
  assign new_n353_ = ~x47 & ~x46 & ~x45 & new_n354_ & ~x43 & ~x50;
  assign new_n354_ = ~x41 & ~x40 & ~x39 & new_n355_ & ~x37 & ~x42;
  assign new_n355_ = ~x34 & ~x33 & ~x31 & new_n356_ & ~x30 & ~x35;
  assign new_n356_ = ~x28 & ~x26 & ~x25 & new_n357_ & ~x24 & x29;
  assign new_n357_ = ~x18 & ~x17 & ~x15 & new_n358_ & ~x14 & ~x22;
  assign new_n358_ = ~x10 & ~x09 & ~x08 & new_n359_ & ~x07 & ~x11;
  assign new_n359_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n361_ & ~x59;
  assign new_n361_ = ~x56 & ~x55 & ~x51 & new_n362_ & ~x50 & ~x58;
  assign new_n362_ = ~x46 & ~x43 & ~x42 & new_n363_ & ~x41 & ~x47;
  assign new_n363_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n331_ & x34;
  assign z46 = ~x62 & new_n365_ & ~x61;
  assign new_n365_ = ~x59 & ~x58 & ~x56 & new_n366_ & ~x55 & ~x60;
  assign new_n366_ = ~x50 & ~x47 & ~x46 & new_n367_ & ~x43 & ~x51;
  assign new_n367_ = ~x41 & ~x40 & ~x39 & new_n368_ & ~x37 & ~x42;
  ...
  assign new_n378_ = ~x58 & ~x56 & ~x55 & new_n379_ & ~x54 & ~x59;
  assign new_n379_ = ~x51 & ~x50 & ~x47 & new_n380_ & ~x46 & ~x53;
  assign new_n380_ = ~x42 & ~x41 & ~x40 & new_n381_ & ~x39 & ~x43;
  ...
  assign new_n385_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n204_ & x57;
  assign z51 = ~x62 & ~x61 & new_n387_ & ~x60;
  assign new_n387_ = ~x58 & ~x56 & ~x55 & new_n388_ & ~x54 & ~x59;
  assign new_n388_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n206_ & x48;
  assign z52 = new_n390_ & ~x64;
  assign new_n390_ = ~x62 & ~x61 & ~x60 & new_n391_ & ~x59 & ~x63;
  assign new_n391_ = ~x57 & ~x56 & ~x55 & new_n392_ & ~x54 & ~x58;
  assign new_n392_ = ~x51 & ~x50 & ~x49 & new_n393_ & ~x48 & ~x53;
  ...
  assign new_n397_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n211_ & x12;
  ...
  assign new_n402_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n215_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n404_ & ~x60 & ~x64;
  assign new_n404_ = ~x58 & ~x57 & ~x56 & new_n405_ & ~x55 & ~x59;
  assign new_n405_ = ~x53 & ~x52 & ~x51 & new_n406_ & ~x50 & ~x54;
  assign new_n406_ = ~x48 & ~x47 & ~x46 & new_n407_ & ~x45 & ~x49;
  assign new_n407_ = ~x42 & ~x41 & ~x40 & new_n408_ & ~x39 & ~x43;
  assign new_n408_ = ~x36 & ~x35 & ~x34 & new_n409_ & ~x33 & ~x37;
  assign new_n409_ = ~x31 & ~x30 & x29 & ~x28 & new_n410_ & ~x26;
  assign new_n410_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n411_ & x20;
  assign new_n411_ = ~x17 & ~x16 & ~x15 & new_n234_ & ~x14 & ~x18;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n413_ & ~x50 & ~x62;
  assign new_n413_ = ~x46 & ~x43 & ~x41 & new_n414_ & ~x40 & ~x47;
  ...
  assign new_n419_ = ~x47 & ~x46 & ~x43 & new_n420_ & ~x41 & ~x50;
  ...
  assign z60 = ~x58 & ~x56 & ~x50 & new_n424_ & ~x47 & ~x60;
  assign new_n424_ = ~x43 & ~x40 & ~x39 & new_n425_ & ~x37 & ~x46;
  assign new_n425_ = ~x30 & x29 & ~x28 & ~x25 & new_n426_ & ~x24;
  assign new_n426_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n428_ & ~x50;
  assign new_n428_ = ~x46 & ~x43 & ~x40 & new_n429_ & ~x39 & ~x47;
  assign new_n429_ = ~x37 & ~x30 & x29 & ~x28 & new_n430_ & ~x25;
  assign new_n430_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n432_ & x47;
  assign new_n432_ = new_n433_ & ~x46;
  assign new_n433_ = ~x40 & ~x39 & ~x37 & new_n434_ & ~x30 & ~x43;
