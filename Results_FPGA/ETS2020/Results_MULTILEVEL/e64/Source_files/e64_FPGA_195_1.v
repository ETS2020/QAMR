// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:41 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n335_, new_n339_, new_n340_, new_n342_, new_n343_, new_n344_,
    new_n345_, new_n346_, new_n347_, new_n348_, new_n349_, new_n351_,
    new_n352_, new_n353_, new_n354_, new_n355_, new_n357_, new_n358_,
    new_n359_, new_n362_, new_n363_, new_n364_, new_n366_, new_n367_,
    new_n368_, new_n369_, new_n372_;
  ...
  assign new_n211_ = ~x62 & ~x61 & ~x60 & new_n212_ & ~x59;
  assign new_n212_ = ~x57 & ~x56 & ~x55 & new_n213_ & ~x54 & ~x58;
  ...
  assign z21 = ~x62 & ~x60 & new_n228_ & ~x58;
  assign new_n228_ = ~x50 & ~x47 & ~x46 & new_n229_ & ~x43 & ~x56;
  assign new_n229_ = ~x40 & ~x39 & ~x37 & new_n230_ & ~x30 & ~x41;
  assign new_n230_ = ~x28 & ~x26 & ~x25 & new_n231_ & ~x24 & x29;
  assign new_n231_ = ~x18 & ~x15 & ~x14 & new_n232_ & ~x11 & ~x22;
  assign new_n232_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  ...
  assign new_n241_ = ~x18 & ~x17 & ~x15 & new_n242_ & ~x14;
  assign new_n242_ = new_n219_ & ~x12;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n244_ & ~x43 & ~x60;
  assign new_n244_ = ~x40 & ~x39 & ~x37 & x29 & new_n245_ & ~x28;
  assign new_n245_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n247_ & ~x46;
  assign new_n247_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n248_ & x29;
  assign new_n248_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n250_ & ~x64;
  assign new_n250_ = ~x62 & ~x61 & ~x60 & new_n251_ & ~x59 & ~x63;
  assign new_n251_ = ~x57 & ~x56 & ~x55 & new_n252_ & ~x54 & ~x58;
  assign new_n252_ = ~x52 & ~x51 & ~x50 & new_n253_ & ~x49 & ~x53;
  assign new_n253_ = ~x47 & ~x46 & ~x45 & new_n254_ & ~x43 & ~x48;
  assign new_n254_ = ~x41 & ~x40 & ~x39 & new_n255_ & ~x37 & ~x42;
  assign new_n255_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n256_ & x32;
  assign new_n256_ = ~x31 & ~x30 & x29 & ~x28 & new_n257_ & ~x26;
  assign new_n257_ = ~x24 & ~x22 & ~x21 & new_n258_ & ~x20 & ~x25;
  assign new_n258_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n260_ & ~x62;
  assign new_n260_ = ~x60 & ~x59 & ~x58 & new_n261_ & ~x57 & ~x61;
  assign new_n261_ = ~x55 & ~x54 & ~x53 & new_n262_ & ~x52 & ~x56;
  assign new_n262_ = ~x50 & ~x49 & ~x48 & new_n263_ & ~x47 & ~x51;
  assign new_n263_ = ~x45 & ~x43 & ~x42 & new_n264_ & ~x41 & ~x46;
  assign new_n264_ = ~x39 & ~x37 & ~x36 & new_n265_ & ~x35 & ~x40;
  assign new_n265_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n266_ & x29;
  assign new_n266_ = ~x26 & ~x25 & ~x24 & new_n267_ & ~x22 & ~x28;
  assign new_n267_ = ~x20 & ~x18 & ~x17 & new_n268_ & ~x16 & ~x21;
  assign new_n268_ = ~x15 & ~x14 & x13 & new_n219_ & ~x12;
  assign z29 = x60 & ~x58 & ~x50 & new_n270_ & ~x46;
  assign new_n270_ = ~x43 & ~x40 & new_n196_ & ~x39;
  ...
  assign new_n278_ = ~x25 & ~x24 & ~x22 & new_n241_ & ~x21 & ~x26;
  ...
  assign new_n286_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n241_ & x21;
  ...
  assign new_n301_ = ~x40 & ~x39 & ~x37 & new_n223_ & ~x35 & ~x41;
  ...
  assign new_n310_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n258_ & x19;
  assign z42 = ~x62 & new_n312_ & ~x61;
  assign new_n312_ = ~x59 & ~x58 & ~x56 & new_n313_ & ~x55 & ~x60;
  assign new_n313_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n214_ & x49;
  assign z43 = new_n315_ & ~x62;
  assign new_n315_ = ~x60 & ~x59 & ~x58 & new_n316_ & ~x56 & ~x61;
  assign new_n316_ = ~x54 & ~x53 & ~x51 & new_n317_ & ~x50 & ~x55;
  ...
  assign new_n321_ = ~x17 & ~x15 & ~x14 & new_n322_ & ~x11 & ~x18;
  assign new_n322_ = ~x09 & ~x08 & ~x07 & new_n323_ & ~x06 & ~x10;
  assign new_n323_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z51 = ~x62 & ~x61 & new_n325_ & ~x60;
  assign new_n325_ = ~x58 & ~x56 & ~x55 & new_n326_ & ~x54 & ~x59;
  assign new_n326_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n214_ & x48;
  assign z52 = new_n328_ & ~x64;
  assign new_n328_ = ~x62 & ~x61 & ~x60 & new_n329_ & ~x59 & ~x63;
  assign new_n329_ = ~x57 & ~x56 & ~x55 & new_n330_ & ~x54 & ~x58;
  assign new_n330_ = ~x51 & ~x50 & ~x49 & new_n331_ & ~x48 & ~x53;
  ...
  assign new_n335_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n219_ & x12;
  assign z53 = ~x64 & new_n211_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n300_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n339_ & ~x56;
  assign new_n339_ = ~x50 & ~x47 & ~x46 & new_n340_ & ~x43 & ~x51;
  assign new_n340_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n223_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n342_ & ~x60 & ~x64;
  ...
  assign new_n349_ = ~x17 & ~x16 & ~x15 & new_n242_ & ~x14 & ~x18;
