// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:29 2020
...
module FAU ( 
  ...
  assign new_n214_ = ~x18 & new_n215_ & ~x17;
  assign new_n215_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n217_ & ~x46;
  assign new_n217_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n218_ & x29;
  assign new_n218_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n220_ & ~x64;
  assign new_n220_ = ~x62 & ~x61 & ~x60 & new_n221_ & ~x59 & ~x63;
  assign new_n221_ = ~x57 & ~x56 & ~x55 & new_n222_ & ~x54 & ~x58;
  assign new_n222_ = ~x52 & ~x51 & ~x50 & new_n223_ & ~x49 & ~x53;
  assign new_n223_ = ~x47 & ~x46 & ~x45 & new_n224_ & ~x43 & ~x48;
  assign new_n224_ = ~x41 & ~x40 & ~x39 & new_n225_ & ~x37 & ~x42;
  assign new_n225_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n226_ & x32;
  assign new_n226_ = ~x31 & ~x30 & x29 & ~x28 & new_n227_ & ~x26;
  assign new_n227_ = ~x24 & ~x22 & ~x21 & new_n228_ & ~x20 & ~x25;
  assign new_n228_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z29 = x60 & ~x58 & ~x50 & new_n230_ & ~x46;
  assign new_n230_ = ~x43 & ~x40 & new_n196_ & ~x39;
  assign z31 = ~x64 & ~x63 & new_n232_ & ~x62;
  assign new_n232_ = ~x60 & ~x59 & ~x58 & new_n233_ & ~x57 & ~x61;
  assign new_n233_ = ~x55 & ~x54 & ~x53 & new_n234_ & ~x51 & ~x56;
  ...
  assign new_n238_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n214_ & x21;
  assign z32 = ~x58 & ~x50 & new_n230_ & x46;
  assign z35 = ~x62 & ~x61 & new_n241_ & ~x60;
  assign new_n241_ = ~x56 & ~x55 & ~x51 & new_n242_ & ~x50 & ~x58;
  assign new_n242_ = ~x46 & ~x43 & ~x41 & new_n243_ & ~x40 & ~x47;
  assign new_n243_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n244_ & x29;
  assign new_n244_ = ~x26 & ~x25 & ~x24 & new_n245_ & ~x22 & ~x28;
  assign new_n245_ = ~x15 & ~x14 & ~x11 & new_n246_ & ~x10 & ~x18;
  assign new_n246_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = ~x62 & new_n248_ & x61;
  assign new_n248_ = ~x58 & ~x56 & ~x55 & new_n249_ & ~x51 & ~x60;
  assign new_n249_ = ~x47 & ~x46 & ~x43 & new_n250_ & ~x41 & ~x50;
  assign new_n250_ = ~x39 & ~x37 & ~x35 & new_n251_ & ~x30 & ~x40;
  ...
  assign z37 = ~x64 & new_n255_ & ~x63;
  assign new_n255_ = ~x61 & ~x60 & ~x59 & new_n256_ & ~x58 & ~x62;
  assign new_n256_ = ~x56 & ~x55 & ~x54 & new_n257_ & ~x53 & ~x57;
  assign new_n257_ = ~x51 & ~x50 & ~x49 & new_n258_ & ~x48 & ~x52;
  assign new_n258_ = ~x46 & ~x45 & ~x43 & new_n259_ & ~x42 & ~x47;
  assign new_n259_ = ~x40 & ~x39 & ~x37 & new_n260_ & ~x36 & ~x41;
  assign new_n260_ = ~x34 & ~x33 & ~x32 & new_n261_ & ~x31 & ~x35;
  assign new_n261_ = ~x30 & x29 & ~x28 & ~x26 & new_n262_ & ~x25;
  assign new_n262_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n228_ & x19;
  ...
  assign new_n318_ = ~x21 & x20 & ~x18 & ~x17 & new_n215_ & ~x16;
  assign z60 = ~x58 & ~x56 & ~x50 & new_n320_ & ~x47 & ~x60;
  assign new_n320_ = ~x43 & ~x40 & ~x39 & new_n321_ & ~x37 & ~x46;
  assign new_n321_ = ~x30 & x29 & ~x28 & ~x25 & new_n322_ & ~x24;
  assign new_n322_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
