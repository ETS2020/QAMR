...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n348_, new_n349_, new_n351_, new_n352_, new_n353_, new_n356_,
  ...
  assign new_n161_ = ~x56 & ~x50 & ~x47 & new_n162_ & ~x46 & ~x58;
  assign new_n162_ = ~x40 & ~x39 & ~x37 & new_n163_ & ~x30 & ~x43;
  assign new_n163_ = ~x28 & ~x25 & ~x24 & new_n164_ & ~x15 & x29;
  assign new_n164_ = ~x11 & ~x10 & ~x08 & x03 & ~x07 & ~x14;
  assign z18 = new_n166_ & x62;
  assign new_n166_ = ~x58 & ~x56 & ~x50 & new_n167_ & ~x47 & ~x60;
  assign new_n167_ = ~x43 & ~x40 & ~x39 & new_n168_ & ~x37 & ~x46;
  assign new_n168_ = ~x30 & x29 & ~x28 & ~x25 & new_n169_ & ~x24;
  assign new_n169_ = ~x15 & ~x14 & ~x11 & ~x10 & ~x07 & ~x08;
  assign z19 = new_n171_ & x64;
  assign new_n171_ = ~x62 & ~x61 & ~x60 & new_n172_ & ~x59;
  assign new_n172_ = ~x57 & ~x56 & ~x55 & new_n173_ & ~x54 & ~x58;
  assign new_n173_ = ~x51 & ~x50 & ~x49 & new_n174_ & ~x48 & ~x53;
  assign new_n174_ = ~x47 & ~x46 & ~x45 & new_n175_ & ~x43;
  assign new_n175_ = ~x41 & ~x40 & ~x39 & new_n176_ & ~x37 & ~x42;
  assign new_n176_ = ~x34 & ~x33 & ~x31 & new_n177_ & ~x30 & ~x35;
  assign new_n177_ = ~x28 & ~x26 & ~x25 & new_n178_ & ~x24 & x29;
  assign new_n178_ = ~x18 & ~x17 & ~x15 & new_n179_ & ~x14 & ~x22;
  ...
  assign new_n183_ = ~x56 & x51 & ~x50 & ~x47 & new_n184_ & ~x46;
  assign new_n184_ = ~x41 & ~x40 & ~x39 & new_n185_ & ~x37 & ~x43;
  assign new_n185_ = ~x30 & x29 & new_n186_ & ~x28;
  assign new_n186_ = ~x25 & ~x24 & ~x22 & new_n187_ & ~x18 & ~x26;
  assign new_n187_ = ~x15 & ~x14 & ~x11 & new_n188_ & ~x10;
  assign new_n188_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  assign z21 = ~x62 & ~x60 & new_n190_ & ~x58;
  assign new_n190_ = ~x50 & ~x47 & ~x46 & new_n191_ & ~x43 & ~x56;
  assign new_n191_ = ~x40 & ~x39 & ~x37 & new_n192_ & ~x30 & ~x41;
  assign new_n192_ = ~x28 & ~x26 & ~x25 & new_n193_ & ~x24 & x29;
  assign new_n193_ = ~x18 & ~x15 & ~x14 & new_n194_ & ~x11 & ~x22;
  assign new_n194_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n196_ & ~x61;
  assign new_n196_ = ~x59 & ~x58 & ~x57 & new_n197_ & ~x56 & ~x60;
  assign new_n197_ = ~x54 & ~x53 & ~x51 & new_n198_ & ~x50 & ~x55;
  ...
  assign new_n202_ = ~x24 & ~x22 & ~x18 & new_n203_ & ~x17 & ~x25;
  assign new_n203_ = ~x15 & ~x14 & ~x12 & new_n180_ & ~x11;
  assign z23 = ~x64 & new_n205_ & ~x63;
  assign new_n205_ = ~x61 & ~x60 & ~x59 & new_n206_ & ~x58 & ~x62;
  assign new_n206_ = ~x56 & ~x55 & ~x54 & new_n207_ & ~x53 & ~x57;
  assign new_n207_ = ~x51 & ~x50 & ~x49 & new_n208_ & ~x48 & ~x52;
  assign new_n208_ = ~x46 & ~x45 & ~x43 & new_n209_ & ~x42 & ~x47;
  assign new_n209_ = ~x40 & ~x39 & ~x37 & new_n210_ & ~x36 & ~x41;
  assign new_n210_ = ~x34 & ~x33 & ~x31 & new_n211_ & ~x30 & ~x35;
  assign new_n211_ = ~x28 & ~x26 & ~x25 & new_n212_ & ~x24 & x29;
  assign new_n212_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n203_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n214_ & ~x43 & ~x60;
  assign new_n214_ = ~x40 & ~x39 & ~x37 & x29 & new_n215_ & ~x28;
  assign new_n215_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  ...
  assign new_n227_ = ~x43 & ~x40 & ~x39 & new_n228_ & ~x37 & ~x46;
  assign new_n228_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n230_ & ~x60 & ~x64;
  ...
  assign new_n233_ = ~x43 & ~x42 & ~x41 & new_n234_ & ~x40;
  assign new_n234_ = ~x37 & ~x36 & ~x35 & new_n235_ & ~x34 & ~x39;
  assign new_n235_ = ~x33 & ~x31 & ~x30 & new_n236_ & x29;
  assign new_n236_ = ~x28 & ~x26 & ~x25 & new_n237_ & ~x24;
  assign new_n237_ = ~x22 & ~x21 & ~x18 & new_n203_ & ~x17;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n239_ & x39;
  assign new_n239_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z34 = new_n241_ & x58;
  assign new_n241_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z36 = new_n243_ & ~x62;
  assign new_n243_ = ~x60 & ~x58 & ~x56 & new_n244_ & ~x55 & x61;
  assign new_n244_ = ~x50 & ~x47 & ~x46 & new_n245_ & ~x43 & ~x51;
  assign new_n245_ = ~x40 & ~x39 & ~x37 & new_n185_ & ~x35 & ~x41;
  ...
  assign new_n271_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n174_ & x49;
  ...
  assign new_n317_ = ~x56 & ~x55 & new_n173_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n319_ & ~x60;
  assign new_n319_ = ~x58 & ~x56 & ~x55 & new_n320_ & ~x54 & ~x59;
  assign new_n320_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n174_ & x48;
  ...
  assign new_n329_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n179_ & x12;
  ...
  assign new_n334_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n185_ & x35;
  ...
  assign new_n343_ = ~x21 & x20 & ~x18 & ~x17 & new_n203_ & ~x16;
