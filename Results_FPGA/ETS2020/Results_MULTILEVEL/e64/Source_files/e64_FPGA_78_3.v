// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:24 2020
...
module FAU ( 
  ...
  assign new_n305_ = x61 & ~x58 & ~x56 & new_n306_ & ~x55 & ~x60;
  assign new_n306_ = ~x51 & ~x47 & ~x46 & new_n307_ & ~x43 & ~x50;
  assign new_n307_ = ~x41 & ~x39 & ~x37 & new_n224_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n309_ & ~x63;
  assign new_n309_ = ~x62 & ~x60 & ~x59 & new_n310_ & ~x58 & ~x61;
  assign new_n310_ = ~x57 & ~x55 & ~x54 & new_n311_ & ~x53 & ~x56;
  assign new_n311_ = ~x52 & ~x50 & ~x49 & new_n312_ & ~x48 & ~x51;
  assign new_n312_ = ~x47 & ~x45 & ~x43 & new_n313_ & ~x42 & ~x46;
  assign new_n313_ = ~x41 & ~x39 & ~x37 & new_n314_ & ~x36 & ~x40;
  assign new_n314_ = ~x35 & ~x33 & ~x32 & new_n315_ & ~x31 & ~x34;
  assign new_n315_ = ~x30 & ~x28 & ~x26 & new_n316_ & ~x25 & x29;
  assign new_n316_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n268_ & x19;
  assign z38 = ~x62 & ~x61 & new_n318_ & ~x60;
  assign new_n318_ = x59 & ~x56 & ~x55 & new_n319_ & ~x51 & ~x58;
  assign new_n319_ = ~x50 & ~x46 & ~x43 & new_n320_ & ~x42 & ~x47;
  assign new_n320_ = ~x41 & ~x40 & new_n321_ & ~x39;
  assign new_n321_ = ~x37 & ~x35 & ~x30 & x29 & new_n322_ & ~x28;
  assign new_n322_ = ~x26 & ~x24 & ~x22 & new_n323_ & ~x18 & ~x25;
  assign new_n323_ = ~x14 & ~x11 & new_n324_ & ~x10 & ~x15;
  assign new_n324_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n326_ & ~x61;
  assign new_n326_ = ~x60 & ~x56 & ~x55 & new_n327_ & ~x51 & ~x58;
  ...
  assign new_n331_ = ~x46 & ~x42 & ~x41 & new_n332_ & ~x40 & ~x43;
  assign new_n332_ = ~x39 & ~x35 & ~x34 & new_n333_ & ~x33 & ~x37;
  assign new_n333_ = ~x30 & x29 & ~x28 & new_n334_ & ~x26;
  assign new_n334_ = ~x25 & ~x22 & ~x18 & new_n335_ & ~x17 & ~x24;
  assign new_n335_ = ~x15 & ~x11 & ~x10 & new_n324_ & ~x09 & ~x14;
  assign z41 = ~x62 & ~x60 & ~x59 & new_n337_ & ~x58 & ~x61;
  assign new_n337_ = ~x56 & ~x51 & ~x50 & new_n338_ & ~x47 & ~x55;
  assign new_n338_ = ~x46 & ~x42 & ~x41 & new_n339_ & ~x40 & ~x43;
  assign new_n339_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n333_ & x33;
  assign z42 = ~x62 & new_n341_ & ~x61;
  assign new_n341_ = ~x60 & ~x58 & ~x56 & new_n342_ & ~x55 & ~x59;
  assign new_n342_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n215_ & x49;
  assign z43 = new_n344_ & ~x62;
  assign new_n344_ = ~x61 & ~x59 & ~x58 & new_n345_ & ~x56 & ~x60;
  assign new_n345_ = ~x55 & ~x53 & ~x51 & new_n346_ & ~x50 & ~x54;
  assign new_n346_ = ~x47 & ~x45 & ~x43 & new_n347_ & ~x42 & ~x46;
  assign new_n347_ = ~x41 & ~x39 & ~x37 & new_n348_ & ~x35 & ~x40;
  assign new_n348_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n349_ & x29;
  assign new_n349_ = ~x28 & ~x25 & ~x24 & new_n350_ & ~x22 & ~x26;
  assign new_n350_ = ~x18 & ~x15 & ~x14 & new_n351_ & ~x11 & ~x17;
  assign new_n351_ = ~x10 & ~x08 & ~x07 & new_n352_ & ~x06 & ~x09;
  assign new_n352_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n354_ & ~x58 & ~x61;
  ...
  assign new_n360_ = ~x11 & ~x09 & ~x08 & new_n361_ & ~x07 & ~x10;
  assign new_n361_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x61 & ~x60 & new_n363_ & ~x59 & ~x62;
  assign new_n363_ = ~x58 & ~x55 & ~x51 & new_n364_ & ~x50 & ~x56;
  assign new_n364_ = ~x47 & ~x43 & ~x42 & new_n365_ & ~x41 & ~x46;
  assign new_n365_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n333_ & x34;
  assign z46 = ~x62 & new_n367_ & ~x61;
  assign new_n367_ = ~x60 & ~x58 & ~x56 & new_n368_ & ~x55 & ~x59;
  assign new_n368_ = ~x51 & ~x47 & ~x46 & new_n369_ & ~x43 & ~x50;
  assign new_n369_ = ~x42 & ~x40 & ~x39 & new_n370_ & ~x37 & ~x41;
  assign new_n370_ = ~x35 & ~x30 & x29 & ~x28 & new_n371_ & ~x26;
  assign new_n371_ = ~x25 & ~x22 & ~x18 & new_n372_ & ~x17 & ~x24;
  ...
  assign new_n380_ = ~x59 & ~x56 & ~x55 & new_n381_ & ~x54 & ~x58;
  assign new_n381_ = ~x53 & ~x50 & ~x47 & new_n382_ & ~x46 & ~x51;
  assign new_n382_ = ~x43 & ~x41 & ~x40 & new_n383_ & ~x39 & ~x42;
  assign new_n383_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n333_ & x31;
  assign z49 = ~x61 & ~x60 & new_n385_ & ~x59 & ~x62;
  ...
  assign new_n392_ = ~x63 & ~x61 & ~x60 & new_n393_ & ~x59 & ~x62;
  assign new_n393_ = ~x58 & ~x56 & ~x55 & new_n394_ & ~x54 & ~x57;
  assign new_n394_ = ~x53 & ~x50 & ~x49 & new_n395_ & ~x48 & ~x51;
  assign new_n395_ = ~x47 & ~x45 & ~x43 & new_n396_ & ~x42 & ~x46;
  assign new_n396_ = ~x41 & ~x39 & ~x37 & new_n397_ & ~x35 & ~x40;
  assign new_n397_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n398_ & x29;
  assign new_n398_ = ~x28 & ~x25 & ~x24 & new_n399_ & ~x22 & ~x26;
  assign new_n399_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n220_ & x12;
  assign z53 = ~x64 & new_n211_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n306_ & x55;
  assign z55 = ~x60 & ~x58 & new_n403_ & ~x56 & ~x62;
  assign new_n403_ = ~x51 & ~x47 & ~x46 & new_n404_ & ~x43 & ~x50;
  assign new_n404_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n224_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n406_ & ~x60 & ~x63;
  assign new_n406_ = ~x59 & ~x57 & ~x56 & new_n407_ & ~x55 & ~x58;
  assign new_n407_ = ~x54 & ~x52 & ~x51 & new_n408_ & ~x50 & ~x53;
  assign new_n408_ = ~x49 & ~x47 & ~x46 & new_n409_ & ~x45 & ~x48;
  assign new_n409_ = ~x43 & ~x41 & ~x40 & new_n410_ & ~x39 & ~x42;
  assign new_n410_ = ~x37 & ~x35 & ~x34 & new_n411_ & ~x33 & ~x36;
  assign new_n411_ = ~x31 & ~x30 & x29 & ~x28 & new_n412_ & ~x26;
  assign new_n412_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n413_ & x20;
  assign new_n413_ = ~x18 & ~x16 & ~x15 & new_n243_ & ~x14 & ~x17;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n415_ & ~x50 & ~x60;
  assign new_n415_ = ~x47 & ~x43 & ~x41 & new_n416_ & ~x40 & ~x46;
  ...
  assign z58 = ~x60 & ~x58 & new_n421_ & ~x56 & ~x62;
  assign new_n421_ = ~x50 & ~x46 & ~x43 & new_n422_ & ~x41 & ~x47;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n426_ & ~x47 & ~x58;
  assign new_n426_ = ~x46 & ~x40 & ~x39 & new_n427_ & ~x37 & ~x43;
  assign new_n427_ = ~x30 & ~x28 & ~x25 & new_n428_ & ~x24 & x29;
  assign new_n428_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n430_ & ~x50 & ~x60;
  assign new_n430_ = ~x47 & ~x43 & ~x40 & new_n431_ & ~x39 & ~x46;
  assign new_n431_ = ~x37 & ~x30 & x29 & ~x28 & new_n432_ & ~x25;
  assign new_n432_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n434_ & x47;
  assign new_n434_ = new_n435_ & ~x46;
  assign new_n435_ = ~x43 & ~x39 & ~x37 & new_n436_ & ~x30 & ~x40;
  assign new_n436_ = x29 & new_n437_ & ~x28;
  assign new_n437_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n434_ & ~x50;
  assign z64 = ~x58 & ~x50 & new_n440_ & ~x46 & ~x60;
