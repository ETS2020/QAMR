// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:20 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n229_, new_n230_, new_n233_, new_n235_, new_n236_, new_n237_,
    ...
    new_n319_, new_n320_, new_n321_, new_n325_, new_n326_, new_n328_,
    new_n329_, new_n330_, new_n331_, new_n332_, new_n334_, new_n335_,
    new_n336_, new_n339_, new_n340_, new_n341_, new_n343_, new_n344_,
    new_n345_, new_n347_, new_n348_, new_n349_, new_n350_, new_n353_;
  ...
  assign z23 = ~x63 & ~x62 & ~x61 & new_n198_ & ~x60 & ~x64;
  ...
  assign new_n202_ = ~x36 & ~x35 & ~x34 & new_n203_ & ~x33 & ~x37;
  assign new_n203_ = ~x31 & ~x30 & x29 & ~x28 & new_n204_ & ~x26;
  assign new_n204_ = ~x24 & ~x22 & ~x21 & new_n205_ & ~x18 & ~x25;
  assign new_n205_ = ~x17 & x16 & ~x15 & ~x14 & new_n181_ & ~x12;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n207_ & ~x43 & ~x60;
  assign new_n207_ = ~x40 & ~x39 & ~x37 & x29 & new_n208_ & ~x28;
  assign new_n208_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  ...
  assign new_n218_ = ~x15 & ~x14 & x13 & ~x12 & new_n182_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n220_ & ~x50;
  assign new_n220_ = ~x43 & ~x40 & ~x39 & new_n221_ & ~x37 & ~x46;
  assign new_n221_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n223_ & ~x60 & ~x64;
  assign new_n223_ = ~x58 & ~x57 & ~x56 & new_n224_ & ~x55 & ~x59;
  assign new_n224_ = ~x54 & ~x53 & x52 & ~x51 & new_n225_ & ~x50;
  assign new_n225_ = ~x48 & ~x47 & ~x46 & new_n226_ & ~x45 & ~x49;
  assign new_n226_ = ~x42 & ~x41 & ~x40 & new_n227_ & ~x39 & ~x43;
  assign new_n227_ = ~x36 & ~x35 & ~x34 & new_n228_ & ~x33 & ~x37;
  assign new_n228_ = ~x31 & ~x30 & x29 & ~x28 & new_n229_ & ~x26;
  assign new_n229_ = ~x25 & ~x24 & ~x22 & new_n230_ & ~x21;
  assign new_n230_ = ~x17 & ~x15 & ~x14 & new_n181_ & ~x12 & ~x18;
  ...
  assign new_n235_ = ~x60 & ~x58 & ~x56 & new_n236_ & ~x55 & x61;
  assign new_n236_ = ~x50 & ~x47 & ~x46 & new_n237_ & ~x43 & ~x51;
  assign new_n237_ = ~x40 & ~x39 & ~x37 & new_n187_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n239_ & ~x60;
  assign new_n239_ = ~x58 & ~x56 & ~x55 & new_n240_ & ~x51 & x59;
  assign new_n240_ = ~x47 & ~x46 & ~x43 & new_n241_ & ~x42 & ~x50;
  assign new_n241_ = ~x41 & ~x40 & new_n242_ & ~x39;
  assign new_n242_ = ~x37 & ~x35 & ~x30 & x29 & new_n243_ & ~x28;
  assign new_n243_ = ~x25 & ~x24 & ~x22 & new_n244_ & ~x18 & ~x26;
  assign new_n244_ = ~x15 & ~x14 & ~x11 & new_n245_ & ~x10;
  assign new_n245_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n247_ & ~x61;
  assign new_n247_ = ~x58 & ~x56 & ~x55 & new_n248_ & ~x51 & ~x60;
  ...
  assign new_n252_ = ~x43 & ~x42 & ~x41 & new_n253_ & ~x40 & ~x46;
  assign new_n253_ = ~x37 & ~x35 & ~x34 & new_n254_ & ~x33 & ~x39;
  assign new_n254_ = ~x30 & x29 & ~x28 & new_n255_ & ~x26;
  assign new_n255_ = ~x24 & ~x22 & ~x18 & new_n256_ & ~x17 & ~x25;
  assign new_n256_ = ~x14 & ~x11 & ~x10 & new_n245_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n258_ & ~x58 & ~x62;
  assign new_n258_ = ~x55 & ~x51 & ~x50 & new_n259_ & ~x47 & ~x56;
  ...
  assign new_n263_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n176_ & x49;
  ...
  assign new_n286_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n254_ & x34;
  ...
  assign new_n293_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n245_ & x09;
  ...
  assign new_n299_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n244_ & x17;
  ...
  assign new_n304_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n254_ & x31;
  ...
  assign new_n309_ = ~x56 & ~x55 & new_n175_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n311_ & ~x60;
  assign new_n311_ = ~x58 & ~x56 & ~x55 & new_n312_ & ~x54 & ~x59;
  assign new_n312_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n176_ & x48;
  ...
  assign new_n321_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n181_ & x12;
  ...
  assign new_n326_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n187_ & x35;
