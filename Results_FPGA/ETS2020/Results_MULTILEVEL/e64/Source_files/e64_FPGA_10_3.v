// Benchmark "FAU" written by ABC on Wed Aug  5 20:40:39 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n286_, new_n287_, new_n288_, new_n292_, new_n294_, new_n295_,
    ...
    new_n414_, new_n415_, new_n417_, new_n418_, new_n419_, new_n422_,
  ...
  assign new_n257_ = ~x63 & ~x61 & ~x60 & new_n258_ & ~x59 & ~x62;
  assign new_n258_ = ~x58 & ~x56 & ~x55 & new_n259_ & ~x54 & ~x57;
  assign new_n259_ = ~x53 & ~x51 & ~x50 & new_n260_ & ~x49 & ~x52;
  assign new_n260_ = ~x48 & ~x46 & ~x45 & new_n261_ & ~x43 & ~x47;
  assign new_n261_ = ~x42 & ~x40 & ~x39 & new_n262_ & ~x37 & ~x41;
  assign new_n262_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n263_ & x32;
  assign new_n263_ = ~x31 & ~x30 & x29 & ~x28 & new_n264_ & ~x26;
  assign new_n264_ = ~x25 & ~x22 & ~x21 & new_n265_ & ~x20 & ~x24;
  assign new_n265_ = ~x18 & ~x17 & new_n151_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n267_ & ~x62;
  assign new_n267_ = ~x61 & ~x59 & ~x58 & new_n268_ & ~x57 & ~x60;
  assign new_n268_ = ~x56 & ~x54 & ~x53 & new_n269_ & ~x52 & ~x55;
  assign new_n269_ = ~x51 & ~x49 & ~x48 & new_n270_ & ~x47 & ~x50;
  assign new_n270_ = ~x46 & ~x43 & ~x42 & new_n271_ & ~x41 & ~x45;
  assign new_n271_ = ~x40 & ~x37 & ~x36 & new_n272_ & ~x35 & ~x39;
  assign new_n272_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n273_ & x29;
  assign new_n273_ = ~x28 & ~x25 & ~x24 & new_n274_ & ~x22 & ~x26;
  assign new_n274_ = ~x21 & ~x18 & ~x17 & new_n275_ & ~x16 & ~x20;
  assign new_n275_ = ~x15 & ~x14 & x13 & new_n220_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n277_ & ~x50;
  assign new_n277_ = ~x46 & ~x40 & ~x39 & new_n278_ & ~x37 & ~x43;
  assign new_n278_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = ~x58 & ~x50 & new_n280_ & ~x46 & x60;
  assign new_n280_ = ~x43 & ~x40 & new_n194_ & ~x39;
  assign z30 = ~x63 & ~x62 & new_n282_ & ~x61 & ~x64;
  assign new_n282_ = ~x60 & ~x58 & ~x57 & new_n283_ & ~x56 & ~x59;
  assign new_n283_ = ~x55 & ~x54 & ~x53 & x52 & new_n284_ & ~x51;
  assign new_n284_ = ~x50 & ~x48 & ~x47 & new_n285_ & ~x46 & ~x49;
  assign new_n285_ = ~x45 & ~x42 & ~x41 & new_n286_ & ~x40 & ~x43;
  assign new_n286_ = ~x39 & ~x36 & ~x35 & new_n287_ & ~x34 & ~x37;
  assign new_n287_ = ~x33 & ~x31 & ~x30 & x29 & new_n288_ & ~x28;
  assign new_n288_ = ~x26 & ~x24 & ~x22 & new_n242_ & ~x21 & ~x25;
  assign z32 = ~x58 & ~x50 & new_n280_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n194_ & x39;
  assign z34 = new_n292_ & x58;
  assign new_n292_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n294_ & ~x60;
  assign new_n294_ = ~x58 & ~x55 & ~x51 & new_n295_ & ~x50 & ~x56;
  assign new_n295_ = ~x47 & ~x43 & ~x41 & new_n296_ & ~x40 & ~x46;
  assign new_n296_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n297_ & x29;
  assign new_n297_ = ~x28 & ~x25 & ~x24 & new_n298_ & ~x22 & ~x26;
  assign new_n298_ = ~x18 & ~x14 & ~x11 & new_n299_ & ~x10 & ~x15;
  assign new_n299_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n301_ & ~x62;
  assign new_n301_ = x61 & ~x58 & ~x56 & new_n302_ & ~x55 & ~x60;
  assign new_n302_ = ~x51 & ~x47 & ~x46 & new_n303_ & ~x43 & ~x50;
  assign new_n303_ = ~x41 & ~x39 & ~x37 & new_n224_ & ~x35 & ~x40;
  ...
  assign new_n312_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n265_ & x19;
  ...
  assign new_n338_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n215_ & x49;
  ...
  assign new_n383_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n213_ & x57;
  assign z51 = ~x62 & ~x61 & new_n385_ & ~x60;
  assign new_n385_ = ~x59 & ~x56 & ~x55 & new_n386_ & ~x54 & ~x58;
  assign new_n386_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n215_ & x48;
  ...
  assign new_n395_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n220_ & x12;
  ...
  assign new_n400_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n224_ & x35;
  ...
  assign new_n409_ = ~x18 & ~x16 & ~x15 & new_n243_ & ~x14 & ~x17;
