// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:16 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n276_, new_n277_, new_n281_, new_n283_, new_n284_, new_n285_,
    ...
    new_n336_, new_n337_, new_n341_, new_n342_, new_n344_, new_n345_,
    new_n346_, new_n347_, new_n348_, new_n349_, new_n350_, new_n351_,
    new_n353_, new_n354_, new_n355_, new_n356_, new_n357_, new_n359_,
    new_n360_, new_n361_, new_n364_, new_n365_, new_n366_, new_n368_,
    new_n369_, new_n370_, new_n371_, new_n374_;
  ...
  assign new_n232_ = ~x18 & ~x17 & ~x15 & new_n233_ & ~x14;
  assign new_n233_ = new_n216_ & ~x12;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n235_ & ~x46;
  assign new_n235_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n236_ & x29;
  assign new_n236_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n238_ & ~x64;
  assign new_n238_ = ~x62 & ~x61 & ~x60 & new_n239_ & ~x59 & ~x63;
  assign new_n239_ = ~x57 & ~x56 & ~x55 & new_n240_ & ~x54 & ~x58;
  assign new_n240_ = ~x52 & ~x51 & ~x50 & new_n241_ & ~x49 & ~x53;
  assign new_n241_ = ~x47 & ~x46 & ~x45 & new_n242_ & ~x43 & ~x48;
  assign new_n242_ = ~x41 & ~x40 & ~x39 & new_n243_ & ~x37 & ~x42;
  assign new_n243_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n244_ & x32;
  assign new_n244_ = ~x31 & ~x30 & x29 & ~x28 & new_n245_ & ~x26;
  assign new_n245_ = ~x24 & ~x22 & ~x21 & new_n246_ & ~x20 & ~x25;
  assign new_n246_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n248_ & ~x62;
  assign new_n248_ = ~x60 & ~x59 & ~x58 & new_n249_ & ~x57 & ~x61;
  assign new_n249_ = ~x55 & ~x54 & ~x53 & new_n250_ & ~x52 & ~x56;
  assign new_n250_ = ~x50 & ~x49 & ~x48 & new_n251_ & ~x47 & ~x51;
  assign new_n251_ = ~x45 & ~x43 & ~x42 & new_n252_ & ~x41 & ~x46;
  assign new_n252_ = ~x39 & ~x37 & ~x36 & new_n253_ & ~x35 & ~x40;
  assign new_n253_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n254_ & x29;
  assign new_n254_ = ~x26 & ~x25 & ~x24 & new_n255_ & ~x22 & ~x28;
  assign new_n255_ = ~x20 & ~x18 & ~x17 & new_n256_ & ~x16 & ~x21;
  assign new_n256_ = ~x15 & ~x14 & x13 & new_n216_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n258_ & ~x50;
  assign new_n258_ = ~x43 & ~x40 & ~x39 & new_n259_ & ~x37 & ~x46;
  assign new_n259_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n261_ & ~x46;
  assign new_n261_ = ~x43 & ~x40 & new_n197_ & ~x39;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n263_ & ~x61;
  assign new_n263_ = ~x59 & ~x58 & ~x57 & new_n264_ & ~x56 & ~x60;
  assign new_n264_ = ~x55 & ~x54 & ~x53 & x52 & new_n265_ & ~x51;
  ...
  assign new_n269_ = ~x25 & ~x24 & ~x22 & new_n232_ & ~x21 & ~x26;
  assign z31 = ~x64 & ~x63 & new_n271_ & ~x62;
  assign new_n271_ = ~x60 & ~x59 & ~x58 & new_n272_ & ~x57 & ~x61;
  assign new_n272_ = ~x55 & ~x54 & ~x53 & new_n273_ & ~x51 & ~x56;
  ...
  assign new_n277_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n232_ & x21;
  assign z32 = ~x58 & ~x50 & new_n261_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n197_ & x39;
  assign z34 = new_n281_ & x58;
  assign new_n281_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n283_ & ~x60;
  assign new_n283_ = ~x56 & ~x55 & ~x51 & new_n284_ & ~x50 & ~x58;
  assign new_n284_ = ~x46 & ~x43 & ~x41 & new_n285_ & ~x40 & ~x47;
  assign new_n285_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n286_ & x29;
  assign new_n286_ = ~x26 & ~x25 & ~x24 & new_n287_ & ~x22 & ~x28;
  assign new_n287_ = ~x15 & ~x14 & ~x11 & new_n288_ & ~x10 & ~x18;
  assign new_n288_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  ...
  assign new_n301_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n246_ & x19;
  assign z42 = ~x62 & new_n303_ & ~x61;
  assign new_n303_ = ~x59 & ~x58 & ~x56 & new_n304_ & ~x55 & ~x60;
  assign new_n304_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n211_ & x49;
  assign z43 = new_n306_ & ~x62;
  assign new_n306_ = ~x60 & ~x59 & ~x58 & new_n307_ & ~x56 & ~x61;
  assign new_n307_ = ~x54 & ~x53 & ~x51 & new_n308_ & ~x50 & ~x55;
  assign new_n308_ = ~x46 & ~x45 & ~x43 & new_n309_ & ~x42 & ~x47;
  assign new_n309_ = ~x40 & ~x39 & ~x37 & new_n310_ & ~x35 & ~x41;
  assign new_n310_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n311_ & x29;
  assign new_n311_ = ~x26 & ~x25 & ~x24 & new_n312_ & ~x22 & ~x28;
  assign new_n312_ = ~x17 & ~x15 & ~x14 & new_n313_ & ~x11 & ~x18;
  assign new_n313_ = ~x09 & ~x08 & ~x07 & new_n314_ & ~x06 & ~x10;
  assign new_n314_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n316_ & ~x58 & ~x62;
  assign new_n316_ = ~x55 & ~x54 & ~x53 & new_n317_ & ~x51 & ~x56;
  assign new_n317_ = ~x47 & ~x46 & ~x45 & new_n318_ & ~x43 & ~x50;
  assign new_n318_ = ~x41 & ~x40 & ~x39 & new_n319_ & ~x37 & ~x42;
  assign new_n319_ = ~x34 & ~x33 & ~x31 & new_n320_ & ~x30 & ~x35;
  assign new_n320_ = ~x28 & ~x26 & ~x25 & new_n321_ & ~x24 & x29;
  assign new_n321_ = ~x18 & ~x17 & ~x15 & new_n322_ & ~x14 & ~x22;
  assign new_n322_ = ~x10 & ~x09 & ~x08 & new_n323_ & ~x07 & ~x11;
  assign new_n323_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n325_ & ~x62;
  assign new_n325_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n209_ & x57;
  assign z51 = ~x62 & ~x61 & new_n327_ & ~x60;
  assign new_n327_ = ~x58 & ~x56 & ~x55 & new_n328_ & ~x54 & ~x59;
  assign new_n328_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n211_ & x48;
  assign z52 = new_n330_ & ~x64;
  assign new_n330_ = ~x62 & ~x61 & ~x60 & new_n331_ & ~x59 & ~x63;
  assign new_n331_ = ~x57 & ~x56 & ~x55 & new_n332_ & ~x54 & ~x58;
  assign new_n332_ = ~x51 & ~x50 & ~x49 & new_n333_ & ~x48 & ~x53;
  ...
  assign new_n337_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n216_ & x12;
  assign z53 = ~x64 & new_n207_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n291_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n341_ & ~x56;
  assign new_n341_ = ~x50 & ~x47 & ~x46 & new_n342_ & ~x43 & ~x51;
  assign new_n342_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n220_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n344_ & ~x60 & ~x64;
  ...
  assign new_n351_ = ~x17 & ~x16 & ~x15 & new_n233_ & ~x14 & ~x18;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n353_ & ~x50 & ~x62;
  assign new_n353_ = ~x46 & ~x43 & ~x41 & new_n354_ & ~x40 & ~x47;
  ...
  assign z58 = ~x62 & ~x60 & ~x58 & new_n359_ & ~x56;
  assign new_n359_ = ~x47 & ~x46 & ~x43 & new_n360_ & ~x41 & ~x50;
  ...
  assign z60 = ~x58 & ~x56 & ~x50 & new_n364_ & ~x47 & ~x60;
  assign new_n364_ = ~x43 & ~x40 & ~x39 & new_n365_ & ~x37 & ~x46;
  assign new_n365_ = ~x30 & x29 & ~x28 & ~x25 & new_n366_ & ~x24;
  assign new_n366_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n368_ & x47;
  assign new_n368_ = new_n369_ & ~x46;
  assign new_n369_ = ~x40 & ~x39 & ~x37 & new_n370_ & ~x30 & ~x43;
  assign new_n370_ = x29 & new_n371_ & ~x28;
  assign new_n371_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n368_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n374_ & ~x46;
  assign new_n374_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n370_ & x30;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
  assign z12 = 1'b0;
  assign z15 = 1'b0;
