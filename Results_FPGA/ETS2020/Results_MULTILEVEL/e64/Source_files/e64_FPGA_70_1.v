...
module FAU ( 
  ...
  assign z45 = ~x62 & ~x61 & new_n334_ & ~x60;
  ...
  assign new_n354_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n219_ & x12;
  ...
  assign new_n359_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n223_ & x35;
  ...
  assign new_n368_ = ~x17 & ~x16 & ~x15 & new_n242_ & ~x14 & ~x18;
  ...
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n385_ & x47;
  assign new_n385_ = new_n386_ & ~x46;
  assign new_n386_ = ~x40 & ~x39 & ~x37 & new_n387_ & ~x30 & ~x43;
  assign new_n387_ = x29 & new_n388_ & ~x28;
  assign new_n388_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n385_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n391_ & ~x46;
  assign new_n391_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n387_ & x30;
  assign z04 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z15 = 1'b0;
