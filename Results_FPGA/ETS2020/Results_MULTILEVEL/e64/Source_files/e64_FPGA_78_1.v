...
module FAU ( 
  ...
  assign new_n235_ = ~x18 & ~x17 & new_n151_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n237_ & ~x62;
  assign new_n237_ = ~x60 & ~x59 & ~x58 & new_n238_ & ~x57 & ~x61;
  assign new_n238_ = ~x55 & ~x54 & ~x53 & new_n239_ & ~x52 & ~x56;
  assign new_n239_ = ~x50 & ~x49 & ~x48 & new_n240_ & ~x47 & ~x51;
  assign new_n240_ = ~x45 & ~x43 & ~x42 & new_n241_ & ~x41 & ~x46;
  assign new_n241_ = ~x39 & ~x37 & ~x36 & new_n242_ & ~x35 & ~x40;
  assign new_n242_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n243_ & x29;
  assign new_n243_ = ~x26 & ~x25 & ~x24 & new_n244_ & ~x22 & ~x28;
  assign new_n244_ = ~x21 & ~x20 & ~x18 & new_n245_ & ~x17;
  assign new_n245_ = ~x16 & ~x15 & ~x14 & x13 & new_n215_ & ~x12;
  ...
  assign new_n250_ = ~x43 & ~x40 & new_n251_ & ~x39;
  ...
  assign new_n260_ = ~x17 & ~x15 & ~x14 & new_n215_ & ~x12 & ~x18;
  ...
  assign new_n268_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n260_ & x21;
  ...
  assign new_n281_ = ~x40 & ~x39 & ~x37 & new_n219_ & ~x35 & ~x41;
  ...
  assign new_n288_ = ~x34 & ~x33 & ~x32 & new_n289_ & ~x31 & ~x35;
  assign new_n289_ = ~x30 & x29 & ~x28 & ~x26 & new_n290_ & ~x25;
  assign new_n290_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n235_ & x19;
  assign z42 = ~x62 & new_n292_ & ~x61;
  assign new_n292_ = ~x59 & ~x58 & ~x56 & new_n293_ & ~x55 & ~x60;
  assign new_n293_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n210_ & x49;
  ...
  assign new_n305_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n208_ & x57;
  assign z51 = ~x62 & ~x61 & new_n307_ & ~x60;
  assign new_n307_ = ~x58 & ~x56 & ~x55 & new_n308_ & ~x54 & ~x59;
  assign new_n308_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n210_ & x48;
  ...
  assign new_n317_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n215_ & x12;
  ...
  assign new_n322_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n219_ & x35;
  ...
  assign new_n335_ = ~x46 & ~x43 & ~x40 & new_n336_ & ~x39 & ~x47;
  assign new_n336_ = ~x37 & ~x30 & x29 & ~x28 & new_n337_ & ~x25;
  assign new_n337_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
