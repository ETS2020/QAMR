// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:27 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n248_, new_n249_, new_n253_, new_n254_, new_n255_, new_n256_,
  ...
  assign z21 = ~x62 & ~x60 & new_n201_ & ~x58;
  assign new_n201_ = ~x50 & ~x47 & ~x46 & new_n202_ & ~x43 & ~x56;
  assign new_n202_ = ~x40 & ~x39 & ~x37 & new_n203_ & ~x30 & ~x41;
  assign new_n203_ = ~x28 & ~x26 & ~x25 & new_n204_ & ~x24 & x29;
  assign new_n204_ = ~x18 & ~x15 & ~x14 & new_n205_ & ~x11 & ~x22;
  assign new_n205_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n207_ & ~x61;
  assign new_n207_ = ~x59 & ~x58 & ~x57 & new_n208_ & ~x56 & ~x60;
  assign new_n208_ = ~x54 & ~x53 & ~x51 & new_n209_ & ~x50 & ~x55;
  assign new_n209_ = ~x48 & ~x47 & ~x46 & new_n210_ & ~x45 & ~x49;
  assign new_n210_ = ~x42 & ~x41 & ~x40 & new_n211_ & ~x39 & ~x43;
  assign new_n211_ = ~x37 & x36 & ~x35 & ~x34 & new_n212_ & ~x33;
  assign new_n212_ = ~x31 & ~x30 & x29 & ~x28 & new_n213_ & ~x26;
  assign new_n213_ = ~x24 & ~x22 & ~x18 & new_n214_ & ~x17 & ~x25;
  assign new_n214_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z23 = ~x64 & new_n216_ & ~x63;
  assign new_n216_ = ~x61 & ~x60 & ~x59 & new_n217_ & ~x58 & ~x62;
  assign new_n217_ = ~x56 & ~x55 & ~x54 & new_n218_ & ~x53 & ~x57;
  assign new_n218_ = ~x51 & ~x50 & ~x49 & new_n219_ & ~x48 & ~x52;
  assign new_n219_ = ~x46 & ~x45 & ~x43 & new_n220_ & ~x42 & ~x47;
  assign new_n220_ = ~x40 & ~x39 & ~x37 & new_n221_ & ~x36 & ~x41;
  assign new_n221_ = ~x34 & ~x33 & ~x31 & new_n222_ & ~x30 & ~x35;
  assign new_n222_ = ~x28 & ~x26 & ~x25 & new_n223_ & ~x24 & x29;
  assign new_n223_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n214_ & x16;
  ...
  assign new_n231_ = ~x62 & ~x61 & ~x60 & new_n232_ & ~x59 & ~x63;
  assign new_n232_ = ~x57 & ~x56 & ~x55 & new_n233_ & ~x54 & ~x58;
  assign new_n233_ = ~x52 & ~x51 & ~x50 & new_n234_ & ~x49 & ~x53;
  ...
  assign new_n238_ = ~x24 & ~x22 & ~x21 & new_n239_ & ~x20 & ~x25;
  assign new_n239_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z29 = x60 & ~x58 & ~x50 & new_n241_ & ~x46;
  assign new_n241_ = ~x43 & ~x40 & new_n196_ & ~x39;
  ...
  assign new_n249_ = ~x24 & ~x22 & x21 & ~x18 & new_n214_ & ~x17;
  ...
  assign new_n267_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n239_ & x19;
  ...
  assign new_n332_ = ~x21 & x20 & ~x18 & ~x17 & new_n214_ & ~x16;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
