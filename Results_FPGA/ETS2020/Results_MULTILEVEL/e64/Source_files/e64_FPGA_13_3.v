...
module FAU ( 
  ...
  assign new_n164_ = x23 & ~x22 & new_n141_ & ~x21;
  ...
  assign new_n284_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n227_ & x21;
  ...
  assign new_n299_ = ~x40 & ~x39 & ~x37 & new_n209_ & ~x35 & ~x41;
  ...
  assign new_n308_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n253_ & x19;
  ...
  assign new_n334_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n200_ & x49;
  assign z43 = new_n336_ & ~x62;
  assign new_n336_ = ~x60 & ~x59 & ~x58 & new_n337_ & ~x56 & ~x61;
  assign new_n337_ = ~x54 & ~x53 & ~x51 & new_n338_ & ~x50 & ~x55;
  ...
  assign new_n342_ = ~x17 & ~x15 & ~x14 & new_n343_ & ~x11 & ~x18;
  assign new_n343_ = ~x09 & ~x08 & ~x07 & new_n344_ & ~x06 & ~x10;
  ...
  assign new_n379_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n198_ & x57;
  assign z51 = ~x62 & ~x61 & new_n381_ & ~x60;
  assign new_n381_ = ~x58 & ~x56 & ~x55 & new_n382_ & ~x54 & ~x59;
  assign new_n382_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n200_ & x48;
  ...
  assign new_n391_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n205_ & x12;
  ...
  assign new_n396_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n209_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n398_ & ~x60 & ~x64;
  assign new_n398_ = ~x58 & ~x57 & ~x56 & new_n399_ & ~x55 & ~x59;
  assign new_n399_ = ~x53 & ~x52 & ~x51 & new_n400_ & ~x50 & ~x54;
  assign new_n400_ = ~x48 & ~x47 & ~x46 & new_n401_ & ~x45 & ~x49;
  assign new_n401_ = ~x42 & ~x41 & ~x40 & new_n402_ & ~x39 & ~x43;
  assign new_n402_ = ~x36 & ~x35 & ~x34 & new_n403_ & ~x33 & ~x37;
  assign new_n403_ = ~x31 & ~x30 & x29 & ~x28 & new_n404_ & ~x26;
  assign new_n404_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n405_ & x20;
  assign new_n405_ = ~x17 & ~x16 & ~x15 & new_n228_ & ~x14 & ~x18;
