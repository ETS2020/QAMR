// Benchmark "FAU" written by ABC on Wed Aug  5 20:43:17 2020
...
module FAU ( 
  ...
  assign z21 = ~x62 & ~x60 & new_n211_ & ~x58;
  ...
  assign new_n214_ = ~x18 & ~x15 & ~x14 & new_n215_ & ~x11 & ~x22;
  assign new_n215_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n217_ & ~x61;
  assign new_n217_ = ~x59 & ~x58 & ~x57 & new_n218_ & ~x56 & ~x60;
  assign new_n218_ = ~x54 & ~x53 & ~x51 & new_n219_ & ~x50 & ~x55;
  ...
  assign new_n223_ = ~x24 & ~x22 & ~x18 & new_n224_ & ~x17 & ~x25;
  assign new_n224_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  assign z23 = ~x64 & new_n226_ & ~x63;
  assign new_n226_ = ~x61 & ~x60 & ~x59 & new_n227_ & ~x58 & ~x62;
  assign new_n227_ = ~x56 & ~x55 & ~x54 & new_n228_ & ~x53 & ~x57;
  assign new_n228_ = ~x51 & ~x50 & ~x49 & new_n229_ & ~x48 & ~x52;
  assign new_n229_ = ~x46 & ~x45 & ~x43 & new_n230_ & ~x42 & ~x47;
  assign new_n230_ = ~x40 & ~x39 & ~x37 & new_n231_ & ~x36 & ~x41;
  assign new_n231_ = ~x34 & ~x33 & ~x31 & new_n232_ & ~x30 & ~x35;
  assign new_n232_ = ~x28 & ~x26 & ~x25 & new_n233_ & ~x24 & x29;
  assign new_n233_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n224_ & x16;
  ...
  assign new_n249_ = ~x18 & ~x17 & new_n160_ & ~x16;
  ...
  assign new_n254_ = ~x43 & ~x40 & new_n201_ & ~x39;
  ...
  assign new_n262_ = ~x24 & ~x22 & x21 & ~x18 & new_n224_ & ~x17;
  assign z32 = ~x58 & ~x50 & new_n254_ & x46;
  assign z35 = ~x62 & ~x61 & new_n265_ & ~x60;
  assign new_n265_ = ~x56 & ~x55 & ~x51 & new_n266_ & ~x50 & ~x58;
  assign new_n266_ = ~x46 & ~x43 & ~x41 & new_n267_ & ~x40 & ~x47;
  assign new_n267_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n268_ & x29;
  assign new_n268_ = ~x26 & ~x25 & ~x24 & new_n269_ & ~x22 & ~x28;
  assign new_n269_ = ~x15 & ~x14 & ~x11 & new_n270_ & ~x10 & ~x18;
  assign new_n270_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z37 = ~x64 & new_n272_ & ~x63;
  ...
  assign new_n277_ = ~x34 & ~x33 & ~x32 & new_n278_ & ~x31 & ~x35;
  assign new_n278_ = ~x30 & x29 & ~x28 & ~x26 & new_n279_ & ~x25;
  assign new_n279_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n249_ & x19;
  assign z38 = ~x62 & ~x61 & new_n281_ & ~x60;
  assign new_n281_ = ~x58 & ~x56 & ~x55 & new_n282_ & ~x51 & x59;
  assign new_n282_ = ~x47 & ~x46 & ~x43 & new_n283_ & ~x42 & ~x50;
  assign new_n283_ = ~x41 & ~x40 & new_n284_ & ~x39;
  assign new_n284_ = ~x37 & ~x35 & ~x30 & x29 & new_n285_ & ~x28;
  assign new_n285_ = ~x25 & ~x24 & ~x22 & new_n286_ & ~x18 & ~x26;
  assign new_n286_ = ~x15 & ~x14 & ~x11 & new_n287_ & ~x10;
  assign new_n287_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n289_ & ~x61;
  assign new_n289_ = ~x58 & ~x56 & ~x55 & new_n290_ & ~x51 & ~x60;
  assign new_n290_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n283_ & x42;
  assign z40 = ~x62 & ~x61 & new_n292_ & ~x60;
  assign new_n292_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n293_ & x54;
  assign new_n293_ = ~x51 & ~x50 & new_n294_ & ~x47;
  assign new_n294_ = ~x43 & ~x42 & ~x41 & new_n295_ & ~x40 & ~x46;
  assign new_n295_ = ~x37 & ~x35 & ~x34 & new_n296_ & ~x33 & ~x39;
  assign new_n296_ = ~x30 & x29 & ~x28 & new_n297_ & ~x26;
  assign new_n297_ = ~x24 & ~x22 & ~x18 & new_n298_ & ~x17 & ~x25;
  assign new_n298_ = ~x14 & ~x11 & ~x10 & new_n287_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n300_ & ~x58 & ~x62;
  assign new_n300_ = ~x55 & ~x51 & ~x50 & new_n301_ & ~x47 & ~x56;
  assign new_n301_ = ~x43 & ~x42 & ~x41 & new_n302_ & ~x40 & ~x46;
  assign new_n302_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n296_ & x33;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n304_ & ~x58 & ~x62;
  assign new_n304_ = ~x55 & ~x54 & ~x53 & new_n305_ & ~x51 & ~x56;
  assign new_n305_ = ~x47 & ~x46 & ~x45 & new_n306_ & ~x43 & ~x50;
  assign new_n306_ = ~x41 & ~x40 & ~x39 & new_n307_ & ~x37 & ~x42;
  assign new_n307_ = ~x34 & ~x33 & ~x31 & new_n308_ & ~x30 & ~x35;
  assign new_n308_ = ~x28 & ~x26 & ~x25 & new_n309_ & ~x24 & x29;
  assign new_n309_ = ~x18 & ~x17 & ~x15 & new_n310_ & ~x14 & ~x22;
  assign new_n310_ = ~x10 & ~x09 & ~x08 & new_n311_ & ~x07 & ~x11;
  assign new_n311_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n313_ & ~x59;
  assign new_n313_ = ~x56 & ~x55 & ~x51 & new_n314_ & ~x50 & ~x58;
  assign new_n314_ = ~x46 & ~x43 & ~x42 & new_n315_ & ~x41 & ~x47;
  assign new_n315_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n296_ & x34;
  assign z46 = ~x62 & new_n317_ & ~x61;
  assign new_n317_ = ~x59 & ~x58 & ~x56 & new_n318_ & ~x55 & ~x60;
  ...
  assign new_n321_ = ~x24 & ~x22 & ~x18 & new_n322_ & ~x17 & ~x25;
  assign new_n322_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n287_ & x09;
  assign z47 = ~x62 & new_n324_ & ~x61;
  assign new_n324_ = ~x59 & ~x58 & ~x56 & new_n325_ & ~x55 & ~x60;
  ...
  assign new_n328_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n286_ & x17;
  assign z48 = ~x62 & ~x61 & new_n330_ & ~x60;
  assign new_n330_ = ~x58 & ~x56 & ~x55 & new_n331_ & ~x54 & ~x59;
  assign new_n331_ = ~x51 & ~x50 & ~x47 & new_n332_ & ~x46 & ~x53;
  assign new_n332_ = ~x42 & ~x41 & ~x40 & new_n333_ & ~x39 & ~x43;
  assign new_n333_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n296_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n335_ & ~x59;
  assign new_n335_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n293_ & x53;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n337_ & x55;
  assign new_n337_ = ~x50 & ~x47 & ~x46 & new_n338_ & ~x43 & ~x51;
  assign new_n338_ = ~x41 & ~x40 & ~x39 & new_n339_ & ~x37;
  assign new_n339_ = ~x35 & ~x30 & x29 & ~x28 & new_n340_ & ~x26;
  assign new_n340_ = ~x25 & ~x24 & ~x22 & new_n341_ & ~x18;
  assign new_n341_ = ~x15 & ~x14 & ~x11 & new_n342_ & ~x10;
  assign new_n342_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  ...
  assign new_n351_ = ~x21 & x20 & ~x18 & ~x17 & new_n224_ & ~x16;
