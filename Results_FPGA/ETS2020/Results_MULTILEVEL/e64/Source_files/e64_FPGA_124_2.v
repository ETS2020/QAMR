// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:54 2020
...
module FAU ( 
  ...
  assign new_n190_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n191_ & x16;
  assign new_n191_ = ~x15 & ~x14 & ~x12 & new_n173_ & ~x11;
  ...
  assign new_n204_ = ~x15 & ~x14 & x13 & ~x12 & new_n173_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n206_ & ~x50;
  assign new_n206_ = ~x43 & ~x40 & ~x39 & new_n207_ & ~x37 & ~x46;
  assign new_n207_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n209_ & ~x60 & ~x64;
  assign new_n209_ = ~x58 & ~x57 & ~x56 & new_n210_ & ~x55 & ~x59;
  assign new_n210_ = ~x54 & ~x53 & x52 & ~x51 & new_n211_ & ~x50;
  assign new_n211_ = ~x48 & ~x47 & ~x46 & new_n212_ & ~x45 & ~x49;
  assign new_n212_ = ~x43 & ~x42 & ~x41 & new_n213_ & ~x40;
  assign new_n213_ = ~x37 & ~x36 & ~x35 & new_n214_ & ~x34 & ~x39;
  assign new_n214_ = ~x33 & ~x31 & ~x30 & new_n215_ & x29;
  assign new_n215_ = ~x28 & ~x26 & ~x25 & new_n216_ & ~x24;
  assign new_n216_ = ~x22 & ~x21 & ~x18 & new_n191_ & ~x17;
  assign z31 = ~x63 & ~x62 & ~x61 & new_n218_ & ~x60 & ~x64;
  assign new_n218_ = ~x58 & ~x57 & ~x56 & new_n219_ & ~x55 & ~x59;
  assign new_n219_ = ~x53 & ~x51 & ~x50 & new_n220_ & ~x49 & ~x54;
  assign new_n220_ = ~x47 & ~x46 & ~x45 & new_n221_ & ~x43 & ~x48;
  assign new_n221_ = ~x41 & ~x40 & ~x39 & new_n222_ & ~x37 & ~x42;
  assign new_n222_ = ~x35 & ~x34 & ~x33 & new_n223_ & ~x31 & ~x36;
  assign new_n223_ = ~x30 & x29 & ~x28 & ~x26 & new_n224_ & ~x25;
  assign new_n224_ = ~x24 & ~x22 & x21 & ~x18 & new_n191_ & ~x17;
  ...
  assign new_n307_ = ~x56 & ~x55 & new_n166_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n309_ & ~x60;
  assign new_n309_ = ~x58 & ~x56 & ~x55 & new_n310_ & ~x54 & ~x59;
  assign new_n310_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n167_ & x48;
  ...
  assign new_n319_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n172_ & x12;
  ...
  assign new_n324_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n178_ & x35;
