// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:05 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n268_, new_n269_, new_n270_, new_n271_, new_n275_, new_n277_,
    ...
    new_n351_, new_n353_, new_n354_, new_n355_, new_n358_, new_n359_,
  ...
  assign new_n237_ = ~x18 & ~x17 & ~x15 & new_n238_ & ~x14;
  assign new_n238_ = new_n221_ & ~x12;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n240_ & ~x46;
  ...
  assign new_n245_ = ~x52 & ~x51 & ~x50 & new_n246_ & ~x49 & ~x53;
  ...
  assign new_n250_ = ~x24 & ~x22 & ~x21 & new_n251_ & ~x20 & ~x25;
  assign new_n251_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n253_ & ~x62;
  assign new_n253_ = ~x60 & ~x59 & ~x58 & new_n254_ & ~x57 & ~x61;
  assign new_n254_ = ~x55 & ~x54 & ~x53 & new_n255_ & ~x52 & ~x56;
  assign new_n255_ = ~x50 & ~x49 & ~x48 & new_n256_ & ~x47 & ~x51;
  assign new_n256_ = ~x45 & ~x43 & ~x42 & new_n257_ & ~x41 & ~x46;
  assign new_n257_ = ~x39 & ~x37 & ~x36 & new_n258_ & ~x35 & ~x40;
  assign new_n258_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n259_ & x29;
  assign new_n259_ = ~x26 & ~x25 & ~x24 & new_n260_ & ~x22 & ~x28;
  assign new_n260_ = ~x20 & ~x18 & ~x17 & new_n261_ & ~x16 & ~x21;
  assign new_n261_ = ~x15 & ~x14 & x13 & new_n221_ & ~x12;
  assign z29 = x60 & ~x58 & ~x50 & new_n263_ & ~x46;
  assign new_n263_ = ~x43 & ~x40 & new_n195_ & ~x39;
  ...
  assign new_n271_ = ~x25 & ~x24 & ~x22 & new_n237_ & ~x21 & ~x26;
  ...
  assign new_n286_ = ~x40 & ~x39 & ~x37 & new_n225_ & ~x35 & ~x41;
  assign z37 = ~x64 & new_n288_ & ~x63;
  assign new_n288_ = ~x61 & ~x60 & ~x59 & new_n289_ & ~x58 & ~x62;
  assign new_n289_ = ~x56 & ~x55 & ~x54 & new_n290_ & ~x53 & ~x57;
  assign new_n290_ = ~x51 & ~x50 & ~x49 & new_n291_ & ~x48 & ~x52;
  assign new_n291_ = ~x46 & ~x45 & ~x43 & new_n292_ & ~x42 & ~x47;
  assign new_n292_ = ~x40 & ~x39 & ~x37 & new_n293_ & ~x36 & ~x41;
  assign new_n293_ = ~x34 & ~x33 & ~x32 & new_n294_ & ~x31 & ~x35;
  assign new_n294_ = ~x30 & x29 & ~x28 & ~x26 & new_n295_ & ~x25;
  assign new_n295_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n251_ & x19;
  assign z42 = ~x62 & new_n297_ & ~x61;
  assign new_n297_ = ~x59 & ~x58 & ~x56 & new_n298_ & ~x55 & ~x60;
  assign new_n298_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n216_ & x49;
  assign z43 = new_n300_ & ~x62;
  assign new_n300_ = ~x60 & ~x59 & ~x58 & new_n301_ & ~x56 & ~x61;
  assign new_n301_ = ~x54 & ~x53 & ~x51 & new_n302_ & ~x50 & ~x55;
  ...
  assign new_n306_ = ~x17 & ~x15 & ~x14 & new_n307_ & ~x11 & ~x18;
  assign new_n307_ = ~x09 & ~x08 & ~x07 & new_n308_ & ~x06 & ~x10;
  assign new_n308_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  ...
  assign new_n319_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n214_ & x57;
  assign z51 = ~x62 & ~x61 & new_n321_ & ~x60;
  assign new_n321_ = ~x58 & ~x56 & ~x55 & new_n322_ & ~x54 & ~x59;
  assign new_n322_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n216_ & x48;
  ...
  assign new_n331_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n221_ & x12;
  ...
  assign new_n336_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n225_ & x35;
  ...
  assign new_n345_ = ~x17 & ~x16 & ~x15 & new_n238_ & ~x14 & ~x18;
