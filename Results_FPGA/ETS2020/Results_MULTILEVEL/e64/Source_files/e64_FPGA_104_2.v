// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:41 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n313_, new_n314_, new_n315_, new_n319_, new_n320_, new_n322_,
  ...
  assign new_n191_ = ~x61 & ~x60 & ~x59 & new_n192_ & ~x58 & ~x62;
  assign new_n192_ = ~x56 & ~x55 & ~x54 & new_n193_ & ~x53 & ~x57;
  assign new_n193_ = ~x51 & ~x50 & ~x49 & new_n194_ & ~x48 & ~x52;
  assign new_n194_ = ~x46 & ~x45 & ~x43 & new_n195_ & ~x42 & ~x47;
  assign new_n195_ = ~x40 & ~x39 & ~x37 & new_n196_ & ~x36 & ~x41;
  assign new_n196_ = ~x34 & ~x33 & ~x31 & new_n197_ & ~x30 & ~x35;
  assign new_n197_ = ~x28 & ~x26 & ~x25 & new_n198_ & ~x24 & x29;
  assign new_n198_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n199_ & x16;
  assign new_n199_ = ~x15 & ~x14 & ~x12 & new_n175_ & ~x11;
  ...
  assign new_n205_ = ~x55 & ~x54 & ~x53 & new_n206_ & ~x52 & ~x56;
  assign new_n206_ = ~x50 & ~x49 & ~x48 & new_n207_ & ~x47 & ~x51;
  assign new_n207_ = ~x45 & ~x43 & ~x42 & new_n208_ & ~x41 & ~x46;
  assign new_n208_ = ~x39 & ~x37 & ~x36 & new_n209_ & ~x35 & ~x40;
  assign new_n209_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n210_ & x29;
  assign new_n210_ = ~x26 & ~x25 & ~x24 & new_n211_ & ~x22 & ~x28;
  assign new_n211_ = ~x20 & ~x18 & ~x17 & new_n212_ & ~x16 & ~x21;
  assign new_n212_ = ~x15 & ~x14 & x13 & ~x12 & new_n175_ & ~x11;
  ...
  assign new_n224_ = ~x22 & ~x21 & ~x18 & new_n199_ & ~x17;
  ...
  assign new_n229_ = ~x60 & ~x58 & ~x56 & new_n230_ & ~x55 & x61;
  assign new_n230_ = ~x50 & ~x47 & ~x46 & new_n231_ & ~x43 & ~x51;
  assign new_n231_ = ~x40 & ~x39 & ~x37 & new_n180_ & ~x35 & ~x41;
  ...
  assign new_n257_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n169_ & x49;
  ...
  assign z44 = ~x61 & ~x60 & ~x59 & new_n269_ & ~x58 & ~x62;
  assign new_n269_ = ~x55 & ~x54 & ~x53 & new_n270_ & ~x51 & ~x56;
  assign new_n270_ = ~x47 & ~x46 & ~x45 & new_n271_ & ~x43 & ~x50;
  assign new_n271_ = ~x41 & ~x40 & ~x39 & new_n272_ & ~x37 & ~x42;
  assign new_n272_ = ~x34 & ~x33 & ~x31 & new_n273_ & ~x30 & ~x35;
  assign new_n273_ = ~x28 & ~x26 & ~x25 & new_n274_ & ~x24 & x29;
  assign new_n274_ = ~x18 & ~x17 & ~x15 & new_n275_ & ~x14 & ~x22;
  assign new_n275_ = ~x10 & ~x09 & ~x08 & new_n276_ & ~x07 & ~x11;
  ...
  assign new_n279_ = ~x46 & ~x43 & ~x42 & new_n280_ & ~x41 & ~x47;
  ...
  assign new_n295_ = ~x58 & ~x56 & ~x55 & new_n296_ & ~x54 & ~x59;
  assign new_n296_ = ~x51 & ~x50 & ~x47 & new_n297_ & ~x46 & ~x53;
  assign new_n297_ = ~x42 & ~x41 & ~x40 & new_n298_ & ~x39 & ~x43;
  assign new_n298_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n248_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n300_ & ~x59;
  assign new_n300_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n245_ & x53;
  assign z50 = new_n302_ & ~x62;
  assign new_n302_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n303_ & x57;
  assign new_n303_ = ~x56 & ~x55 & new_n168_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n305_ & ~x60;
  assign new_n305_ = ~x58 & ~x56 & ~x55 & new_n306_ & ~x54 & ~x59;
  assign new_n306_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n169_ & x48;
  ...
  assign new_n315_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n174_ & x12;
  ...
  assign new_n320_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n180_ & x35;
  ...
  assign new_n329_ = ~x21 & x20 & ~x18 & ~x17 & new_n199_ & ~x16;
