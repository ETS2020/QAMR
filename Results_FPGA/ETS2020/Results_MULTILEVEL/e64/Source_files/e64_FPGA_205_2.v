...
module FAU ( 
  ...
  assign z18 = new_n173_ & x62;
  assign new_n173_ = ~x58 & ~x56 & ~x50 & new_n174_ & ~x47 & ~x60;
  assign new_n174_ = ~x43 & ~x40 & ~x39 & new_n175_ & ~x37 & ~x46;
  assign new_n175_ = ~x30 & x29 & ~x28 & ~x25 & new_n176_ & ~x24;
  assign new_n176_ = ~x15 & ~x14 & ~x11 & ~x10 & ~x07 & ~x08;
  assign z19 = new_n178_ & x64;
  assign new_n178_ = ~x62 & ~x61 & ~x60 & new_n179_ & ~x59;
  assign new_n179_ = ~x57 & ~x56 & ~x55 & new_n180_ & ~x54 & ~x58;
  ...
  assign new_n210_ = ~x15 & ~x14 & ~x12 & new_n187_ & ~x11;
  ...
  assign new_n229_ = ~x15 & ~x14 & x13 & ~x12 & new_n187_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n231_ & ~x50;
  assign new_n231_ = ~x43 & ~x40 & ~x39 & new_n232_ & ~x37 & ~x46;
  assign new_n232_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x63 & ~x62 & ~x61 & new_n234_ & ~x60 & ~x64;
  assign new_n234_ = ~x58 & ~x57 & ~x56 & new_n235_ & ~x55 & ~x59;
  assign new_n235_ = ~x54 & ~x53 & x52 & ~x51 & new_n236_ & ~x50;
  assign new_n236_ = ~x48 & ~x47 & ~x46 & new_n237_ & ~x45 & ~x49;
  assign new_n237_ = ~x43 & ~x42 & ~x41 & new_n238_ & ~x40;
  assign new_n238_ = ~x37 & ~x36 & ~x35 & new_n239_ & ~x34 & ~x39;
  assign new_n239_ = ~x33 & ~x31 & ~x30 & new_n240_ & x29;
  assign new_n240_ = ~x28 & ~x26 & ~x25 & new_n241_ & ~x24;
  assign new_n241_ = ~x22 & ~x21 & ~x18 & new_n210_ & ~x17;
  ...
  assign new_n249_ = ~x40 & ~x39 & ~x37 & new_n192_ & ~x35 & ~x41;
  ...
  assign new_n275_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n181_ & x49;
  ...
  assign new_n321_ = ~x56 & ~x55 & new_n180_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n323_ & ~x60;
  assign new_n323_ = ~x58 & ~x56 & ~x55 & new_n324_ & ~x54 & ~x59;
  assign new_n324_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n181_ & x48;
  ...
  assign new_n333_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n186_ & x12;
  ...
  assign new_n338_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n192_ & x35;
  ...
  assign new_n347_ = ~x21 & x20 & ~x18 & ~x17 & new_n210_ & ~x16;
