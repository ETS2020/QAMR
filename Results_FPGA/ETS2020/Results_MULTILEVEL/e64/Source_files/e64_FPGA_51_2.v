// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:06 2020
...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n145_,
    ...
    new_n231_, new_n234_, new_n236_, new_n237_, new_n238_, new_n240_,
    ...
    new_n321_, new_n322_, new_n326_, new_n327_, new_n329_, new_n330_,
  ...
  assign z16 = ~x62 & ~x60 & new_n147_ & ~x58;
  assign new_n147_ = ~x56 & ~x50 & ~x47 & ~x46 & new_n148_ & ~x43;
  assign new_n148_ = ~x40 & ~x39 & ~x37 & new_n149_ & x29 & ~x30;
  assign new_n149_ = ~x28 & x26 & ~x25 & ~x24 & new_n150_ & ~x15;
  assign new_n150_ = ~x14 & ~x11 & ~x10 & ~x08 & ~x03 & ~x07;
  assign z17 = ~x62 & new_n152_ & ~x60;
  assign new_n152_ = ~x58 & ~x56 & ~x50 & ~x47 & new_n153_ & ~x46;
  assign new_n153_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n154_ & ~x30;
  assign new_n154_ = x29 & ~x28 & ~x25 & ~x24 & new_n155_ & ~x15;
  assign new_n155_ = ~x14 & ~x11 & ~x10 & ~x08 & x03 & ~x07;
  ...
  assign new_n163_ = ~x58 & ~x57 & ~x56 & ~x55 & new_n164_ & ~x54;
  assign new_n164_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n165_ & ~x48;
  assign new_n165_ = ~x47 & ~x46 & ~x45 & new_n166_ & ~x43;
  assign new_n166_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n167_ & ~x37;
  assign new_n167_ = ~x35 & ~x34 & ~x33 & ~x31 & new_n168_ & ~x30;
  assign new_n168_ = x29 & ~x28 & ~x26 & ~x25 & new_n169_ & ~x24;
  assign new_n169_ = ~x22 & ~x18 & ~x17 & ~x15 & new_n170_ & ~x14;
  ...
  assign new_n187_ = ~x62 & ~x61 & ~x60 & ~x59 & new_n188_ & ~x58;
  assign new_n188_ = ~x57 & ~x56 & ~x55 & ~x54 & new_n189_ & ~x53;
  assign new_n189_ = ~x52 & ~x51 & ~x50 & ~x49 & new_n190_ & ~x48;
  assign new_n190_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n191_ & ~x42;
  assign new_n191_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n192_ & ~x36;
  assign new_n192_ = ~x35 & ~x34 & ~x33 & ~x31 & new_n193_ & ~x30;
  assign new_n193_ = x29 & ~x28 & ~x26 & ~x25 & new_n194_ & ~x24;
  assign new_n194_ = ~x22 & ~x21 & ~x18 & new_n195_ & x16 & ~x17;
  assign new_n195_ = ~x15 & ~x14 & ~x12 & new_n171_ & ~x11;
  assign z24 = ~x60 & ~x58 & ~x50 & ~x46 & new_n197_ & ~x43;
  ...
  assign new_n200_ = ~x43 & ~x40 & ~x39 & new_n201_ & x29 & ~x37;
  ...
  assign new_n208_ = ~x34 & ~x33 & ~x31 & new_n209_ & x29 & ~x30;
  assign new_n209_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n210_ & ~x22;
  assign new_n210_ = ~x21 & ~x20 & ~x18 & ~x17 & new_n211_ & ~x16;
  assign new_n211_ = ~x15 & ~x14 & x13 & ~x12 & new_n171_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n213_ & ~x50;
  assign new_n213_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n214_ & ~x37;
  assign new_n214_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & ~x61 & new_n216_ & ~x60;
  ...
  assign new_n221_ = ~x33 & ~x31 & new_n222_ & x29 & ~x30;
  assign new_n222_ = ~x28 & ~x26 & ~x25 & new_n223_ & ~x24;
  assign new_n223_ = ~x22 & ~x21 & ~x18 & new_n195_ & ~x17;
  ...
  assign new_n229_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n230_ & ~x31;
  assign new_n230_ = ~x30 & x29 & ~x28 & ~x26 & new_n231_ & ~x25;
  assign new_n231_ = ~x24 & ~x22 & x21 & ~x18 & new_n195_ & ~x17;
  ...
  assign new_n238_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n176_ & ~x35;
  ...
  assign new_n249_ = ~x50 & ~x47 & ~x46 & new_n242_ & x42 & ~x43;
  assign z40 = ~x62 & ~x61 & new_n251_ & ~x60;
  assign new_n251_ = ~x59 & ~x58 & ~x56 & new_n252_ & x54 & ~x55;
  ...
  assign new_n261_ = ~x39 & ~x37 & ~x35 & new_n255_ & x33 & ~x34;
  assign z42 = ~x62 & new_n263_ & ~x61;
  assign new_n263_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n264_ & ~x55;
  assign new_n264_ = ~x54 & ~x53 & ~x51 & new_n165_ & x49 & ~x50;
  assign z43 = new_n266_ & ~x62;
  assign new_n266_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n267_ & ~x56;
  ...
  assign new_n270_ = ~x34 & ~x33 & ~x31 & new_n271_ & x29 & ~x30;
  ...
  assign z44 = ~x62 & ~x61 & ~x60 & ~x59 & new_n276_ & ~x58;
  assign new_n276_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n277_ & ~x51;
  assign new_n277_ = ~x50 & ~x47 & ~x46 & ~x45 & new_n278_ & ~x43;
  ...
  assign new_n282_ = ~x11 & ~x10 & ~x09 & ~x08 & new_n283_ & ~x07;
  assign new_n283_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n285_ & ~x59;
  assign new_n285_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n286_ & ~x50;
  assign new_n286_ = ~x47 & ~x46 & ~x43 & ~x42 & new_n287_ & ~x41;
  assign new_n287_ = ~x40 & ~x39 & ~x37 & new_n255_ & x34 & ~x35;
  assign z46 = ~x62 & new_n289_ & ~x61;
  assign new_n289_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n290_ & ~x55;
  assign new_n290_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n291_ & ~x43;
  ...
  assign new_n294_ = ~x15 & ~x14 & ~x11 & new_n246_ & x09 & ~x10;
  assign z47 = ~x62 & new_n296_ & ~x61;
  assign new_n296_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n297_ & ~x55;
  assign new_n297_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n298_ & ~x43;
  assign new_n298_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n299_ & ~x37;
  assign new_n299_ = ~x35 & ~x30 & x29 & ~x28 & new_n300_ & ~x26;
  assign new_n300_ = ~x25 & ~x24 & ~x22 & new_n245_ & x17 & ~x18;
  assign z48 = ~x62 & ~x61 & new_n302_ & ~x60;
  assign new_n302_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n303_ & ~x54;
  assign new_n303_ = ~x53 & ~x51 & ~x50 & ~x47 & new_n304_ & ~x46;
  assign new_n304_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n305_ & ~x39;
  assign new_n305_ = ~x37 & ~x35 & ~x34 & new_n255_ & x31 & ~x33;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n307_ & ~x59;
  assign new_n307_ = ~x58 & ~x56 & ~x55 & new_n252_ & x53 & ~x54;
  assign z50 = new_n309_ & ~x62;
  assign new_n309_ = ~x61 & ~x60 & ~x59 & new_n310_ & x57 & ~x58;
  assign new_n310_ = ~x56 & ~x55 & new_n164_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n312_ & ~x60;
  assign new_n312_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n313_ & ~x54;
  assign new_n313_ = ~x53 & ~x51 & ~x50 & new_n165_ & x48 & ~x49;
  assign z52 = new_n315_ & ~x64;
  assign new_n315_ = ~x63 & ~x62 & ~x61 & ~x60 & new_n316_ & ~x59;
  assign new_n316_ = ~x58 & ~x57 & ~x56 & ~x55 & new_n317_ & ~x54;
  assign new_n317_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n318_ & ~x48;
  assign new_n318_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n319_ & ~x42;
  assign new_n319_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n320_ & ~x35;
  assign new_n320_ = ~x34 & ~x33 & ~x31 & new_n321_ & x29 & ~x30;
  assign new_n321_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n322_ & ~x22;
  assign new_n322_ = ~x18 & ~x17 & ~x15 & new_n170_ & x12 & ~x14;
  assign z53 = new_n162_ & x63 & ~x64;
  assign z54 = ~x62 & ~x60 & ~x58 & new_n237_ & x55 & ~x56;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n326_ & ~x56;
  assign new_n326_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n327_ & ~x43;
  assign new_n327_ = ~x41 & ~x40 & ~x39 & new_n176_ & x35 & ~x37;
  assign z56 = ~x64 & ~x63 & new_n329_ & ~x62;
  assign new_n329_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n330_ & ~x57;
  assign new_n330_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n331_ & ~x52;
  assign new_n331_ = ~x51 & ~x50 & ~x49 & ~x48 & new_n332_ & ~x47;
  assign new_n332_ = ~x46 & ~x45 & ~x43 & ~x42 & new_n333_ & ~x41;
  assign new_n333_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n334_ & ~x35;
  assign new_n334_ = ~x34 & ~x33 & ~x31 & new_n335_ & x29 & ~x30;
  assign new_n335_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n336_ & ~x22;
  assign new_n336_ = ~x21 & x20 & ~x18 & ~x17 & new_n195_ & ~x16;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n338_ & ~x50;
  assign new_n338_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n339_ & ~x40;
  assign new_n339_ = ~x39 & ~x37 & ~x30 & x29 & new_n340_ & ~x28;
  assign new_n340_ = ~x26 & ~x25 & ~x24 & new_n341_ & x18 & ~x22;
  ...
  assign new_n345_ = ~x40 & ~x39 & ~x37 & new_n346_ & x29 & ~x30;
  assign new_n346_ = ~x28 & ~x26 & ~x25 & new_n341_ & x22 & ~x24;
  ...
  assign new_n353_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n354_ & ~x39;
  assign new_n354_ = ~x37 & ~x30 & x29 & ~x28 & new_n355_ & ~x25;
  assign new_n355_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n357_ & x47 & ~x50;
  assign new_n357_ = new_n358_ & ~x46;
  assign new_n358_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n359_ & ~x30;
  ...
  assign new_n363_ = ~x43 & ~x40 & ~x39 & new_n359_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
