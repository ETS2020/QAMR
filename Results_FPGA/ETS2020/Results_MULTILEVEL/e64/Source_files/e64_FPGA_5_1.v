...
module FAU ( 
  ...
  assign new_n230_ = ~x18 & ~x17 & new_n151_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n232_ & ~x62;
  assign new_n232_ = ~x60 & ~x59 & ~x58 & new_n233_ & ~x57 & ~x61;
  assign new_n233_ = ~x55 & ~x54 & ~x53 & new_n234_ & ~x52 & ~x56;
  assign new_n234_ = ~x50 & ~x49 & ~x48 & new_n235_ & ~x47 & ~x51;
  assign new_n235_ = ~x45 & ~x43 & ~x42 & new_n236_ & ~x41 & ~x46;
  assign new_n236_ = ~x39 & ~x37 & ~x36 & new_n237_ & ~x35 & ~x40;
  assign new_n237_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n238_ & x29;
  assign new_n238_ = ~x26 & ~x25 & ~x24 & new_n239_ & ~x22 & ~x28;
  assign new_n239_ = ~x21 & ~x20 & ~x18 & new_n240_ & ~x17;
  assign new_n240_ = ~x16 & ~x15 & ~x14 & x13 & new_n210_ & ~x12;
  ...
  assign new_n245_ = ~x43 & ~x40 & new_n246_ & ~x39;
  ...
  assign new_n255_ = ~x17 & ~x15 & ~x14 & new_n210_ & ~x12 & ~x18;
  ...
  assign new_n263_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n255_ & x21;
  ...
  assign new_n277_ = ~x40 & ~x39 & ~x37 & new_n214_ & ~x35 & ~x41;
  ...
  assign new_n286_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n230_ & x19;
  assign z42 = ~x62 & new_n288_ & ~x61;
  assign new_n288_ = ~x59 & ~x58 & ~x56 & new_n289_ & ~x55 & ~x60;
  assign new_n289_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n205_ & x49;
  ...
  assign new_n301_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n203_ & x57;
  assign z51 = ~x62 & ~x61 & new_n303_ & ~x60;
  assign new_n303_ = ~x58 & ~x56 & ~x55 & new_n304_ & ~x54 & ~x59;
  assign new_n304_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n205_ & x48;
  ...
  assign new_n313_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n210_ & x12;
