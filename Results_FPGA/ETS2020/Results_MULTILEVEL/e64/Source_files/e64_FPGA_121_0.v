// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:51 2020
...
module FAU ( 
  ...
  assign z21 = ~x62 & ~x60 & new_n209_ & ~x58;
  assign new_n209_ = ~x50 & ~x47 & ~x46 & new_n210_ & ~x43 & ~x56;
  assign new_n210_ = ~x40 & ~x39 & ~x37 & new_n211_ & ~x30 & ~x41;
  assign new_n211_ = ~x28 & ~x26 & ~x25 & new_n212_ & ~x24 & x29;
  assign new_n212_ = ~x18 & ~x15 & ~x14 & new_n213_ & ~x11 & ~x22;
  assign new_n213_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n215_ & ~x61;
  assign new_n215_ = ~x59 & ~x58 & ~x57 & new_n216_ & ~x56 & ~x60;
  assign new_n216_ = ~x54 & ~x53 & ~x51 & new_n217_ & ~x50 & ~x55;
  assign new_n217_ = ~x48 & ~x47 & ~x46 & new_n218_ & ~x45 & ~x49;
  assign new_n218_ = ~x42 & ~x41 & ~x40 & new_n219_ & ~x39 & ~x43;
  assign new_n219_ = ~x37 & x36 & ~x35 & ~x34 & new_n220_ & ~x33;
  assign new_n220_ = ~x31 & ~x30 & x29 & ~x28 & new_n221_ & ~x26;
  assign new_n221_ = ~x24 & ~x22 & ~x18 & new_n222_ & ~x17 & ~x25;
  assign new_n222_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11;
  ...
  assign new_n231_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n222_ & x16;
  ...
  assign new_n249_ = ~x43 & ~x40 & new_n194_ & ~x39;
  ...
  assign new_n257_ = ~x24 & ~x22 & x21 & ~x18 & new_n222_ & ~x17;
  ...
  assign new_n339_ = ~x21 & x20 & ~x18 & ~x17 & new_n222_ & ~x16;
