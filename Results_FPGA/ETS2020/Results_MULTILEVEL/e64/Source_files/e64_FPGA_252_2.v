// Benchmark "FAU" written by ABC on Wed Aug  5 20:43:18 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n339_, new_n340_, new_n344_, new_n345_, new_n347_, new_n348_,
  ...
  assign z08 = ~x63 & ~x62 & ~x61 & new_n154_ & ~x60 & ~x64;
  assign new_n154_ = ~x58 & ~x57 & ~x56 & new_n155_ & ~x55 & ~x59;
  assign new_n155_ = ~x53 & ~x52 & ~x51 & new_n156_ & ~x50 & ~x54;
  assign new_n156_ = ~x48 & ~x47 & ~x46 & new_n157_ & ~x45 & ~x49;
  assign new_n157_ = ~x42 & ~x41 & ~x40 & new_n158_ & ~x39 & ~x43;
  assign new_n158_ = ~x37 & ~x36 & ~x35 & new_n159_ & ~x34 & x38;
  assign new_n159_ = ~x33 & ~x32 & ~x31 & ~x30 & new_n160_ & x29;
  assign new_n160_ = ~x26 & ~x25 & ~x24 & new_n161_ & ~x23 & ~x28;
  assign new_n161_ = ~x21 & ~x20 & ~x19 & new_n162_ & ~x18 & ~x22;
  assign new_n162_ = ~x16 & ~x15 & ~x14 & new_n163_ & ~x13 & ~x17;
  assign new_n163_ = ~x12 & new_n164_ & ~x11;
  ...
  assign new_n217_ = ~x18 & ~x17 & ~x15 & new_n163_ & ~x14;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n219_ & ~x43 & ~x60;
  assign new_n219_ = ~x40 & ~x39 & ~x37 & x29 & new_n220_ & ~x28;
  assign new_n220_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z27 = new_n222_ & ~x64;
  assign new_n222_ = ~x62 & ~x61 & ~x60 & new_n223_ & ~x59 & ~x63;
  assign new_n223_ = ~x57 & ~x56 & ~x55 & new_n224_ & ~x54 & ~x58;
  assign new_n224_ = ~x52 & ~x51 & ~x50 & new_n225_ & ~x49 & ~x53;
  assign new_n225_ = ~x47 & ~x46 & ~x45 & new_n226_ & ~x43 & ~x48;
  assign new_n226_ = ~x41 & ~x40 & ~x39 & new_n227_ & ~x37 & ~x42;
  assign new_n227_ = ~x35 & ~x34 & ~x33 & new_n228_ & ~x31 & ~x36;
  assign new_n228_ = ~x30 & x29 & ~x28 & ~x26 & new_n229_ & ~x25;
  assign new_n229_ = ~x22 & ~x21 & ~x20 & new_n230_ & ~x18 & ~x24;
  assign new_n230_ = ~x17 & ~x16 & ~x15 & ~x14 & new_n163_ & x13;
  assign z28 = ~x60 & ~x58 & new_n232_ & ~x50;
  assign new_n232_ = ~x43 & ~x40 & ~x39 & new_n233_ & ~x37 & ~x46;
  assign new_n233_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n235_ & ~x61;
  assign new_n235_ = ~x59 & ~x58 & ~x57 & new_n236_ & ~x56 & ~x60;
  assign new_n236_ = ~x55 & ~x54 & ~x53 & x52 & new_n237_ & ~x51;
  ...
  assign new_n241_ = ~x25 & ~x24 & ~x22 & new_n217_ & ~x21 & ~x26;
  assign z31 = ~x64 & ~x63 & new_n243_ & ~x62;
  assign new_n243_ = ~x60 & ~x59 & ~x58 & new_n244_ & ~x57 & ~x61;
  assign new_n244_ = ~x55 & ~x54 & ~x53 & new_n245_ & ~x51 & ~x56;
  ...
  assign new_n249_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n217_ & x21;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n251_ & x39;
  assign new_n251_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z34 = new_n253_ & x58;
  assign new_n253_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z36 = new_n255_ & ~x62;
  assign new_n255_ = ~x60 & ~x58 & ~x56 & new_n256_ & ~x55 & x61;
  assign new_n256_ = ~x50 & ~x47 & ~x46 & new_n257_ & ~x43 & ~x51;
  assign new_n257_ = ~x40 & ~x39 & ~x37 & new_n199_ & ~x35 & ~x41;
  ...
  assign new_n283_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n190_ & x49;
  ...
  assign new_n328_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n188_ & x57;
  assign z51 = ~x62 & ~x61 & new_n330_ & ~x60;
  assign new_n330_ = ~x58 & ~x56 & ~x55 & new_n331_ & ~x54 & ~x59;
  assign new_n331_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n190_ & x48;
  ...
  assign new_n340_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n195_ & x12;
  ...
  assign new_n345_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n199_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n347_ & ~x60 & ~x64;
  ...
  assign new_n352_ = ~x31 & ~x30 & x29 & ~x28 & new_n353_ & ~x26;
  assign new_n353_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n354_ & x20;
  assign new_n354_ = ~x17 & ~x16 & ~x15 & new_n163_ & ~x14 & ~x18;
  ...
  assign z59 = ~x58 & ~x50 & ~x43 & new_n251_ & x40;
