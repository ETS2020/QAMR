// Benchmark "FAU" written by ABC on Wed Aug  5 20:40:38 2020
...
module FAU ( 
  ...
  assign z23 = ~x64 & ~x63 & ~x62 & ~x61 & new_n179_ & ~x60;
  ...
  assign new_n185_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n186_ & ~x18;
  assign new_n186_ = ~x17 & x16 & ~x15 & ~x14 & new_n162_ & ~x12;
  assign z24 = ~x60 & ~x58 & ~x50 & ~x46 & new_n188_ & ~x43;
  assign new_n188_ = ~x40 & ~x39 & ~x37 & x29 & new_n189_ & ~x28;
  assign new_n189_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z27 = ~x64 & ~x63 & new_n191_ & ~x62;
  assign new_n191_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n192_ & ~x57;
  assign new_n192_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n193_ & ~x52;
  assign new_n193_ = ~x51 & ~x50 & ~x49 & ~x48 & new_n194_ & ~x47;
  assign new_n194_ = ~x46 & ~x45 & ~x43 & ~x42 & new_n195_ & ~x41;
  assign new_n195_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n196_ & ~x35;
  assign new_n196_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n197_ & x29;
  assign new_n197_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n198_ & ~x22;
  assign new_n198_ = ~x21 & ~x20 & ~x18 & ~x17 & new_n199_ & ~x16;
  assign new_n199_ = ~x15 & ~x14 & x13 & ~x12 & new_n163_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n201_ & ~x50;
  assign new_n201_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n202_ & ~x37;
  assign new_n202_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & ~x61 & new_n204_ & ~x60;
  assign new_n204_ = ~x59 & ~x58 & ~x57 & ~x56 & new_n205_ & ~x55;
  assign new_n205_ = ~x54 & ~x53 & x52 & ~x51 & new_n206_ & ~x50;
  assign new_n206_ = ~x49 & ~x48 & ~x47 & ~x46 & new_n207_ & ~x45;
  assign new_n207_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n208_ & ~x39;
  assign new_n208_ = ~x37 & ~x36 & ~x35 & ~x34 & new_n209_ & ~x33;
  assign new_n209_ = ~x31 & ~x30 & x29 & ~x28 & new_n210_ & ~x26;
  assign new_n210_ = ~x25 & ~x24 & ~x22 & new_n211_ & ~x21;
  assign new_n211_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n162_ & ~x12;
  ...
  assign new_n219_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n168_ & ~x35;
  ...
  assign new_n230_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n223_ & x42;
  assign z40 = ~x62 & ~x61 & new_n232_ & ~x60;
  assign new_n232_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n233_ & x54;
  ...
  assign new_n242_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n236_ & x33;
  assign z42 = ~x62 & new_n244_ & ~x61;
  assign new_n244_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n245_ & ~x55;
  assign new_n245_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n157_ & x49;
  ...
  assign new_n268_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n236_ & x34;
  ...
  assign new_n275_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n227_ & x09;
  ...
  assign new_n281_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n226_ & x17;
  ...
  assign new_n303_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n162_ & x12;
  ...
  assign new_n308_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n168_ & x35;
  ...
  assign new_n312_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n313_ & x18;
  ...
  assign new_n317_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n318_ & x29;
  assign new_n318_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n313_ & x22;
  ...
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n329_ & x47;
  ...
  assign new_n335_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n331_ & x30;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
