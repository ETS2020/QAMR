...
module FAU ( 
  ...
  assign new_n312_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n206_ & x57;
  assign z51 = ~x62 & ~x61 & new_n314_ & ~x60;
  assign new_n314_ = ~x59 & ~x56 & ~x55 & new_n315_ & ~x54 & ~x58;
  assign new_n315_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n208_ & x48;
  ...
  assign new_n324_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n213_ & x12;
  ...
  assign new_n329_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n217_ & x35;
