// Benchmark "FAU" written by ABC on Wed Aug  5 20:43:15 2020
...
module FAU ( 
  ...
  assign z09 = ~x64 & ~x63 & ~x62 & new_n145_ & ~x61;
  ...
  assign new_n149_ = ~x37 & ~x36 & ~x35 & new_n150_ & ~x34 & ~x39;
  assign new_n150_ = ~x33 & ~x32 & ~x31 & ~x30 & new_n151_ & x29;
  assign new_n151_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n152_ & x23;
  assign new_n152_ = ~x21 & ~x20 & ~x19 & new_n153_ & ~x18 & ~x22;
  assign new_n153_ = ~x16 & ~x15 & ~x14 & new_n154_ & ~x13 & ~x17;
  assign new_n154_ = ~x12 & new_n155_ & ~x11;
  assign new_n155_ = ~x09 & ~x08 & ~x07 & new_n156_ & ~x06 & ~x10;
  assign new_n156_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z10 = ~x37 & x29 & ~x15 & x28;
  assign z11 = x37 & ~x15 & x29;
  assign z12 = ~x60 & ~x58 & ~x56 & new_n160_ & ~x50 & ~x62;
  assign new_n160_ = ~x46 & ~x43 & ~x41 & new_n161_ & ~x40 & ~x47;
  assign new_n161_ = ~x39 & ~x37 & ~x30 & x29 & new_n162_ & ~x28;
  assign new_n162_ = ~x25 & ~x24 & ~x15 & new_n163_ & ~x14 & ~x26;
  ...
  assign new_n169_ = ~x56 & ~x50 & ~x47 & new_n170_ & ~x46 & ~x58;
  assign new_n170_ = ~x40 & ~x39 & ~x37 & new_n171_ & ~x30 & ~x43;
  assign new_n171_ = ~x28 & ~x25 & ~x24 & new_n172_ & ~x15 & x29;
  assign new_n172_ = ~x11 & ~x10 & ~x08 & x03 & ~x07 & ~x14;
  assign z18 = new_n174_ & x62;
  assign new_n174_ = ~x58 & ~x56 & ~x50 & new_n175_ & ~x47 & ~x60;
  assign new_n175_ = ~x43 & ~x40 & ~x39 & new_n176_ & ~x37 & ~x46;
  ...
  assign new_n180_ = ~x60 & ~x59 & ~x58 & new_n181_ & ~x57 & ~x61;
  assign new_n181_ = ~x56 & ~x55 & new_n182_ & ~x54;
  assign new_n182_ = ~x51 & ~x50 & ~x49 & new_n183_ & ~x48 & ~x53;
  assign new_n183_ = ~x47 & ~x46 & ~x45 & new_n184_ & ~x43;
  assign new_n184_ = ~x41 & ~x40 & ~x39 & new_n185_ & ~x37 & ~x42;
  assign new_n185_ = ~x34 & ~x33 & ~x31 & new_n186_ & ~x30 & ~x35;
  assign new_n186_ = ~x28 & ~x26 & ~x25 & new_n187_ & ~x24 & x29;
  assign new_n187_ = ~x18 & ~x17 & ~x15 & new_n188_ & ~x14 & ~x22;
  assign new_n188_ = new_n155_ & ~x11;
  assign z20 = ~x62 & ~x60 & new_n190_ & ~x58;
  assign new_n190_ = ~x56 & x51 & ~x50 & ~x47 & new_n191_ & ~x46;
  assign new_n191_ = ~x41 & ~x40 & ~x39 & new_n192_ & ~x37 & ~x43;
  assign new_n192_ = ~x30 & x29 & new_n193_ & ~x28;
  assign new_n193_ = ~x25 & ~x24 & ~x22 & new_n194_ & ~x18 & ~x26;
  assign new_n194_ = ~x15 & ~x14 & ~x11 & new_n195_ & ~x10;
  assign new_n195_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  assign z21 = ~x62 & ~x60 & new_n197_ & ~x58;
  assign new_n197_ = ~x50 & ~x47 & ~x46 & new_n198_ & ~x43 & ~x56;
  assign new_n198_ = ~x40 & ~x39 & ~x37 & new_n199_ & ~x30 & ~x41;
  assign new_n199_ = ~x28 & ~x26 & ~x25 & new_n200_ & ~x24 & x29;
  assign new_n200_ = ~x18 & ~x15 & ~x14 & new_n201_ & ~x11 & ~x22;
  assign new_n201_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n203_ & ~x61;
  assign new_n203_ = ~x59 & ~x58 & ~x57 & new_n204_ & ~x56 & ~x60;
  assign new_n204_ = ~x54 & ~x53 & ~x51 & new_n205_ & ~x50 & ~x55;
  assign new_n205_ = ~x48 & ~x47 & ~x46 & new_n206_ & ~x45 & ~x49;
  assign new_n206_ = ~x42 & ~x41 & ~x40 & new_n207_ & ~x39 & ~x43;
  assign new_n207_ = ~x37 & x36 & ~x35 & ~x34 & new_n208_ & ~x33;
  assign new_n208_ = ~x31 & ~x30 & x29 & ~x28 & new_n209_ & ~x26;
  assign new_n209_ = ~x24 & ~x22 & ~x18 & new_n210_ & ~x17 & ~x25;
  assign new_n210_ = ~x15 & new_n154_ & ~x14;
  assign z23 = ~x64 & new_n212_ & ~x63;
  assign new_n212_ = ~x61 & ~x60 & ~x59 & new_n213_ & ~x58 & ~x62;
  assign new_n213_ = ~x56 & ~x55 & ~x54 & new_n214_ & ~x53 & ~x57;
  assign new_n214_ = ~x51 & ~x50 & ~x49 & new_n215_ & ~x48 & ~x52;
  assign new_n215_ = ~x46 & ~x45 & ~x43 & new_n216_ & ~x42 & ~x47;
  assign new_n216_ = ~x40 & ~x39 & ~x37 & new_n217_ & ~x36 & ~x41;
  assign new_n217_ = ~x34 & ~x33 & ~x31 & new_n218_ & ~x30 & ~x35;
  assign new_n218_ = ~x28 & ~x26 & ~x25 & new_n219_ & ~x24 & x29;
  assign new_n219_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n210_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n221_ & ~x43 & ~x60;
  assign new_n221_ = ~x40 & ~x39 & ~x37 & x29 & new_n222_ & ~x28;
  assign new_n222_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z27 = new_n224_ & ~x64;
  assign new_n224_ = ~x62 & ~x61 & ~x60 & new_n225_ & ~x59 & ~x63;
  assign new_n225_ = ~x57 & ~x56 & ~x55 & new_n226_ & ~x54 & ~x58;
  assign new_n226_ = ~x52 & ~x51 & ~x50 & new_n227_ & ~x49 & ~x53;
  assign new_n227_ = ~x47 & ~x46 & ~x45 & new_n228_ & ~x43 & ~x48;
  assign new_n228_ = ~x41 & ~x40 & ~x39 & new_n229_ & ~x37 & ~x42;
  assign new_n229_ = ~x35 & ~x34 & ~x33 & new_n230_ & ~x31 & ~x36;
  assign new_n230_ = ~x30 & x29 & ~x28 & ~x26 & new_n231_ & ~x25;
  assign new_n231_ = ~x22 & ~x21 & ~x20 & new_n232_ & ~x18 & ~x24;
  assign new_n232_ = ~x17 & ~x16 & ~x15 & ~x14 & new_n154_ & x13;
  assign z28 = ~x60 & ~x58 & new_n234_ & ~x50;
  assign new_n234_ = ~x43 & ~x40 & ~x39 & new_n235_ & ~x37 & ~x46;
  assign new_n235_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n237_ & ~x61;
  assign new_n237_ = ~x59 & ~x58 & ~x57 & new_n238_ & ~x56 & ~x60;
  assign new_n238_ = ~x55 & ~x54 & ~x53 & x52 & new_n239_ & ~x51;
  assign new_n239_ = ~x49 & ~x48 & ~x47 & new_n240_ & ~x46 & ~x50;
  assign new_n240_ = ~x43 & ~x42 & ~x41 & new_n241_ & ~x40 & ~x45;
  assign new_n241_ = ~x39 & ~x37 & ~x36 & new_n242_ & ~x35;
  assign new_n242_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n243_ & x29;
  assign new_n243_ = ~x28 & ~x26 & ~x25 & new_n244_ & ~x24;
  assign new_n244_ = ~x22 & ~x21 & ~x18 & new_n210_ & ~x17;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n165_ & x39;
  assign z34 = new_n247_ & x58;
  assign new_n247_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z36 = new_n249_ & ~x62;
  assign new_n249_ = ~x60 & ~x58 & ~x56 & new_n250_ & ~x55 & x61;
  assign new_n250_ = ~x50 & ~x47 & ~x46 & new_n251_ & ~x43 & ~x51;
  assign new_n251_ = ~x40 & ~x39 & ~x37 & new_n192_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n253_ & ~x60;
  assign new_n253_ = ~x58 & ~x56 & ~x55 & new_n254_ & ~x51 & x59;
  assign new_n254_ = ~x47 & ~x46 & ~x43 & new_n255_ & ~x42 & ~x50;
  assign new_n255_ = ~x41 & ~x40 & new_n256_ & ~x39;
  assign new_n256_ = ~x37 & ~x35 & ~x30 & x29 & new_n257_ & ~x28;
  ...
  assign z39 = ~x62 & new_n261_ & ~x61;
  assign new_n261_ = ~x58 & ~x56 & ~x55 & new_n262_ & ~x51 & ~x60;
  assign new_n262_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n255_ & x42;
  assign z40 = ~x62 & ~x61 & new_n264_ & ~x60;
  assign new_n264_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n265_ & x54;
  assign new_n265_ = ~x51 & ~x50 & new_n266_ & ~x47;
  assign new_n266_ = ~x43 & ~x42 & ~x41 & new_n267_ & ~x40 & ~x46;
  assign new_n267_ = ~x37 & ~x35 & ~x34 & new_n268_ & ~x33 & ~x39;
  assign new_n268_ = ~x30 & x29 & ~x28 & new_n269_ & ~x26;
  assign new_n269_ = ~x24 & ~x22 & ~x18 & new_n270_ & ~x17 & ~x25;
  assign new_n270_ = ~x14 & ~x11 & ~x10 & new_n259_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n272_ & ~x58 & ~x62;
  assign new_n272_ = ~x55 & ~x51 & ~x50 & new_n273_ & ~x47 & ~x56;
  assign new_n273_ = ~x43 & ~x42 & ~x41 & new_n274_ & ~x40 & ~x46;
  assign new_n274_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n268_ & x33;
  assign z42 = ~x62 & new_n276_ & ~x61;
  assign new_n276_ = ~x59 & ~x58 & ~x56 & new_n277_ & ~x55 & ~x60;
  assign new_n277_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n183_ & x49;
  ...
  assign z44 = ~x61 & ~x60 & ~x59 & new_n289_ & ~x58 & ~x62;
  assign new_n289_ = ~x55 & ~x54 & ~x53 & new_n290_ & ~x51 & ~x56;
  assign new_n290_ = ~x47 & ~x46 & ~x45 & new_n291_ & ~x43 & ~x50;
  assign new_n291_ = ~x41 & ~x40 & ~x39 & new_n292_ & ~x37 & ~x42;
  assign new_n292_ = ~x34 & ~x33 & ~x31 & new_n293_ & ~x30 & ~x35;
  assign new_n293_ = ~x28 & ~x26 & ~x25 & new_n294_ & ~x24 & x29;
  assign new_n294_ = ~x18 & ~x17 & ~x15 & new_n295_ & ~x14 & ~x22;
  assign new_n295_ = ~x10 & ~x09 & ~x08 & new_n296_ & ~x07 & ~x11;
  assign new_n296_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n298_ & ~x59;
  assign new_n298_ = ~x56 & ~x55 & ~x51 & new_n299_ & ~x50 & ~x58;
  assign new_n299_ = ~x46 & ~x43 & ~x42 & new_n300_ & ~x41 & ~x47;
  assign new_n300_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n268_ & x34;
  assign z46 = ~x62 & new_n302_ & ~x61;
  ...
  assign new_n307_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n259_ & x09;
  assign z47 = ~x62 & new_n309_ & ~x61;
  ...
  assign new_n313_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n258_ & x17;
  assign z48 = ~x62 & ~x61 & new_n315_ & ~x60;
  assign new_n315_ = ~x58 & ~x56 & ~x55 & new_n316_ & ~x54 & ~x59;
  assign new_n316_ = ~x51 & ~x50 & ~x47 & new_n317_ & ~x46 & ~x53;
  assign new_n317_ = ~x42 & ~x41 & ~x40 & new_n318_ & ~x39 & ~x43;
  assign new_n318_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n268_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n320_ & ~x59;
  assign new_n320_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n265_ & x53;
  assign z50 = new_n322_ & ~x62;
  assign new_n322_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n181_ & x57;
  assign z51 = ~x62 & ~x61 & new_n324_ & ~x60;
  assign new_n324_ = ~x58 & ~x56 & ~x55 & new_n325_ & ~x54 & ~x59;
  assign new_n325_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n183_ & x48;
  ...
  assign new_n334_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n188_ & x12;
  assign z53 = ~x64 & new_n179_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n250_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n338_ & ~x56;
  assign new_n338_ = ~x50 & ~x47 & ~x46 & new_n339_ & ~x43 & ~x51;
  assign new_n339_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n192_ & x35;
  ...
  assign new_n348_ = ~x21 & x20 & ~x18 & ~x17 & new_n210_ & ~x16;
