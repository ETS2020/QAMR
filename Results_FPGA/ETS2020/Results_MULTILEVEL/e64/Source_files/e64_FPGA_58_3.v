...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n285_, new_n286_, new_n290_, new_n292_, new_n293_, new_n294_,
  ...
  assign new_n264_ = ~x15 & ~x14 & x13 & new_n209_ & ~x12;
  ...
  assign z30 = ~x64 & ~x63 & ~x62 & new_n272_ & ~x61;
  ...
  assign new_n278_ = ~x25 & ~x24 & ~x22 & new_n231_ & ~x21 & ~x26;
  assign z31 = ~x64 & ~x63 & new_n280_ & ~x62;
  ...
  assign new_n286_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n231_ & x21;
  assign z32 = ~x58 & ~x50 & new_n269_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n270_ & x39;
  assign z34 = new_n290_ & x58;
  assign new_n290_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n292_ & ~x60;
  assign new_n292_ = ~x56 & ~x55 & ~x51 & new_n293_ & ~x50 & ~x58;
  assign new_n293_ = ~x46 & ~x43 & ~x41 & new_n294_ & ~x40 & ~x47;
  assign new_n294_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n295_ & x29;
  assign new_n295_ = ~x26 & ~x25 & ~x24 & new_n296_ & ~x22 & ~x28;
  assign new_n296_ = ~x15 & ~x14 & ~x11 & new_n297_ & ~x10 & ~x18;
  assign new_n297_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n299_ & ~x62;
  assign new_n299_ = ~x60 & ~x58 & ~x56 & new_n300_ & ~x55 & x61;
  assign new_n300_ = ~x50 & ~x47 & ~x46 & new_n301_ & ~x43 & ~x51;
  assign new_n301_ = ~x40 & ~x39 & ~x37 & new_n213_ & ~x35 & ~x41;
  assign z37 = ~x64 & new_n303_ & ~x63;
  ...
  assign new_n308_ = ~x34 & ~x33 & ~x32 & new_n309_ & ~x31 & ~x35;
  assign new_n309_ = ~x30 & x29 & ~x28 & ~x26 & new_n310_ & ~x25;
  assign new_n310_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n254_ & x19;
  assign z38 = ~x62 & ~x61 & new_n312_ & ~x60;
  assign new_n312_ = ~x58 & ~x56 & ~x55 & new_n313_ & ~x51 & x59;
  assign new_n313_ = ~x47 & ~x46 & ~x43 & new_n314_ & ~x42 & ~x50;
  assign new_n314_ = ~x41 & ~x40 & new_n315_ & ~x39;
  assign new_n315_ = ~x37 & ~x35 & ~x30 & x29 & new_n316_ & ~x28;
  assign new_n316_ = ~x25 & ~x24 & ~x22 & new_n317_ & ~x18 & ~x26;
  assign new_n317_ = ~x15 & ~x14 & ~x11 & new_n318_ & ~x10;
  assign new_n318_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n320_ & ~x61;
  assign new_n320_ = ~x58 & ~x56 & ~x55 & new_n321_ & ~x51 & ~x60;
  assign new_n321_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n314_ & x42;
  assign z40 = ~x62 & ~x61 & new_n323_ & ~x60;
  assign new_n323_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n324_ & x54;
  assign new_n324_ = ~x51 & ~x50 & new_n325_ & ~x47;
  assign new_n325_ = ~x43 & ~x42 & ~x41 & new_n326_ & ~x40 & ~x46;
  assign new_n326_ = ~x37 & ~x35 & ~x34 & new_n327_ & ~x33 & ~x39;
  assign new_n327_ = ~x30 & x29 & ~x28 & new_n328_ & ~x26;
  assign new_n328_ = ~x24 & ~x22 & ~x18 & new_n329_ & ~x17 & ~x25;
  assign new_n329_ = ~x14 & ~x11 & ~x10 & new_n318_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n331_ & ~x58 & ~x62;
  assign new_n331_ = ~x55 & ~x51 & ~x50 & new_n332_ & ~x47 & ~x56;
  assign new_n332_ = ~x43 & ~x42 & ~x41 & new_n333_ & ~x40 & ~x46;
  assign new_n333_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n327_ & x33;
  assign z42 = ~x62 & new_n335_ & ~x61;
  assign new_n335_ = ~x59 & ~x58 & ~x56 & new_n336_ & ~x55 & ~x60;
  assign new_n336_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n204_ & x49;
  assign z43 = new_n338_ & ~x62;
  assign new_n338_ = ~x60 & ~x59 & ~x58 & new_n339_ & ~x56 & ~x61;
  assign new_n339_ = ~x54 & ~x53 & ~x51 & new_n340_ & ~x50 & ~x55;
  ...
  assign new_n344_ = ~x17 & ~x15 & ~x14 & new_n345_ & ~x11 & ~x18;
  assign new_n345_ = ~x09 & ~x08 & ~x07 & new_n346_ & ~x06 & ~x10;
  ...
  assign new_n359_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n327_ & x34;
  ...
  assign new_n366_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n318_ & x09;
  ...
  assign new_n372_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n317_ & x17;
  ...
  assign new_n377_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n327_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n379_ & ~x59;
  assign new_n379_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n324_ & x53;
  assign z50 = new_n381_ & ~x62;
  assign new_n381_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n202_ & x57;
  assign z51 = ~x62 & ~x61 & new_n383_ & ~x60;
  assign new_n383_ = ~x58 & ~x56 & ~x55 & new_n384_ & ~x54 & ~x59;
  assign new_n384_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n204_ & x48;
  ...
  assign new_n393_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n209_ & x12;
  assign z53 = ~x64 & new_n200_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n300_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n397_ & ~x56;
  assign new_n397_ = ~x50 & ~x47 & ~x46 & new_n398_ & ~x43 & ~x51;
  assign new_n398_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n213_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n400_ & ~x60 & ~x64;
  assign new_n400_ = ~x58 & ~x57 & ~x56 & new_n401_ & ~x55 & ~x59;
  assign new_n401_ = ~x53 & ~x52 & ~x51 & new_n402_ & ~x50 & ~x54;
  assign new_n402_ = ~x48 & ~x47 & ~x46 & new_n403_ & ~x45 & ~x49;
  assign new_n403_ = ~x42 & ~x41 & ~x40 & new_n404_ & ~x39 & ~x43;
  assign new_n404_ = ~x36 & ~x35 & ~x34 & new_n405_ & ~x33 & ~x37;
  assign new_n405_ = ~x31 & ~x30 & x29 & ~x28 & new_n406_ & ~x26;
  assign new_n406_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n407_ & x20;
  assign new_n407_ = ~x17 & ~x16 & ~x15 & new_n232_ & ~x14 & ~x18;
