// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:05 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n237_, new_n240_, new_n242_, new_n243_, new_n244_, new_n246_,
    ...
    new_n327_, new_n328_, new_n332_, new_n333_, new_n335_, new_n336_,
    new_n337_, new_n338_, new_n339_, new_n340_, new_n341_, new_n342_,
    new_n344_, new_n345_, new_n346_, new_n347_, new_n348_, new_n350_,
    new_n351_, new_n352_, new_n355_, new_n356_, new_n357_, new_n359_,
  ...
  assign z16 = ~x62 & ~x60 & new_n156_ & ~x58;
  assign new_n156_ = ~x56 & ~x47 & ~x46 & new_n157_ & ~x43 & ~x50;
  assign new_n157_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n158_ & x29;
  assign new_n158_ = ~x28 & ~x25 & ~x24 & new_n159_ & ~x15 & x26;
  assign new_n159_ = ~x14 & ~x11 & ~x10 & ~x08 & ~x03 & ~x07;
  assign z17 = ~x62 & new_n161_ & ~x60;
  assign new_n161_ = ~x58 & ~x50 & ~x47 & new_n162_ & ~x46 & ~x56;
  assign new_n162_ = ~x43 & ~x39 & ~x37 & new_n163_ & ~x30 & ~x40;
  assign new_n163_ = x29 & ~x25 & ~x24 & new_n164_ & ~x15 & ~x28;
  assign new_n164_ = ~x14 & ~x10 & ~x08 & x03 & ~x07 & ~x11;
  assign z18 = new_n166_ & x62;
  assign new_n166_ = ~x60 & ~x56 & ~x50 & new_n167_ & ~x47 & ~x58;
  assign new_n167_ = ~x46 & ~x40 & ~x39 & new_n168_ & ~x37 & ~x43;
  assign new_n168_ = ~x30 & ~x28 & ~x25 & new_n169_ & ~x24 & x29;
  assign new_n169_ = ~x15 & ~x14 & ~x11 & ~x10 & ~x07 & ~x08;
  assign z19 = new_n171_ & x64;
  assign new_n171_ = ~x61 & ~x60 & new_n172_ & ~x59 & ~x62;
  assign new_n172_ = ~x58 & ~x56 & ~x55 & new_n173_ & ~x54 & ~x57;
  assign new_n173_ = ~x53 & ~x50 & ~x49 & new_n174_ & ~x48 & ~x51;
  assign new_n174_ = ~x46 & ~x45 & new_n175_ & ~x43 & ~x47;
  assign new_n175_ = ~x42 & ~x40 & ~x39 & new_n176_ & ~x37 & ~x41;
  assign new_n176_ = ~x35 & ~x33 & ~x31 & new_n177_ & ~x30 & ~x34;
  assign new_n177_ = x29 & ~x26 & ~x25 & new_n178_ & ~x24 & ~x28;
  assign new_n178_ = ~x22 & ~x17 & ~x15 & new_n179_ & ~x14 & ~x18;
  assign new_n179_ = new_n180_ & ~x11;
  assign new_n180_ = ~x10 & ~x08 & ~x07 & new_n181_ & ~x06 & ~x09;
  assign new_n181_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z20 = ~x62 & ~x60 & new_n183_ & ~x58;
  assign new_n183_ = ~x56 & ~x50 & ~x47 & new_n184_ & ~x46 & x51;
  assign new_n184_ = ~x43 & ~x40 & ~x39 & new_n185_ & ~x37 & ~x41;
  assign new_n185_ = ~x30 & x29 & new_n186_ & ~x28;
  assign new_n186_ = ~x26 & ~x24 & ~x22 & new_n187_ & ~x18 & ~x25;
  assign new_n187_ = ~x14 & ~x11 & new_n188_ & ~x10 & ~x15;
  assign new_n188_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  assign z21 = ~x62 & ~x60 & new_n190_ & ~x58;
  assign new_n190_ = ~x56 & ~x47 & ~x46 & new_n191_ & ~x43 & ~x50;
  assign new_n191_ = ~x41 & ~x39 & ~x37 & new_n192_ & ~x30 & ~x40;
  assign new_n192_ = x29 & ~x26 & ~x25 & new_n193_ & ~x24 & ~x28;
  assign new_n193_ = ~x22 & ~x15 & ~x14 & new_n194_ & ~x11 & ~x18;
  assign new_n194_ = ~x10 & ~x07 & ~x06 & x00 & ~x03 & ~x08;
  assign z22 = ~x63 & ~x62 & new_n196_ & ~x61 & ~x64;
  assign new_n196_ = ~x60 & ~x58 & ~x57 & new_n197_ & ~x56 & ~x59;
  assign new_n197_ = ~x55 & ~x53 & ~x51 & new_n198_ & ~x50 & ~x54;
  assign new_n198_ = ~x49 & ~x47 & ~x46 & new_n199_ & ~x45 & ~x48;
  assign new_n199_ = ~x43 & ~x41 & ~x40 & new_n200_ & ~x39 & ~x42;
  assign new_n200_ = ~x37 & ~x35 & ~x34 & new_n201_ & ~x33 & x36;
  assign new_n201_ = ~x31 & ~x30 & x29 & ~x28 & new_n202_ & ~x26;
  assign new_n202_ = ~x25 & ~x22 & ~x18 & new_n203_ & ~x17 & ~x24;
  assign new_n203_ = ~x14 & ~x12 & new_n180_ & ~x11 & ~x15;
  assign z23 = ~x64 & new_n205_ & ~x63;
  assign new_n205_ = ~x62 & ~x60 & ~x59 & new_n206_ & ~x58 & ~x61;
  assign new_n206_ = ~x57 & ~x55 & ~x54 & new_n207_ & ~x53 & ~x56;
  assign new_n207_ = ~x52 & ~x50 & ~x49 & new_n208_ & ~x48 & ~x51;
  assign new_n208_ = ~x47 & ~x45 & ~x43 & new_n209_ & ~x42 & ~x46;
  assign new_n209_ = ~x41 & ~x39 & ~x37 & new_n210_ & ~x36 & ~x40;
  assign new_n210_ = ~x35 & ~x33 & ~x31 & new_n211_ & ~x30 & ~x34;
  assign new_n211_ = x29 & ~x26 & ~x25 & new_n212_ & ~x24 & ~x28;
  assign new_n212_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n203_ & x16;
  assign z25 = ~x58 & ~x50 & new_n214_ & ~x46 & ~x60;
  assign new_n214_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n215_ & x29;
  assign new_n215_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z27 = ~x64 & ~x63 & new_n217_ & ~x62;
  assign new_n217_ = ~x61 & ~x59 & ~x58 & new_n218_ & ~x57 & ~x60;
  assign new_n218_ = ~x56 & ~x54 & ~x53 & new_n219_ & ~x52 & ~x55;
  assign new_n219_ = ~x51 & ~x49 & ~x48 & new_n220_ & ~x47 & ~x50;
  assign new_n220_ = ~x46 & ~x43 & ~x42 & new_n221_ & ~x41 & ~x45;
  assign new_n221_ = ~x40 & ~x37 & ~x36 & new_n222_ & ~x35 & ~x39;
  assign new_n222_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n223_ & x29;
  assign new_n223_ = ~x28 & ~x25 & ~x24 & new_n224_ & ~x22 & ~x26;
  assign new_n224_ = ~x21 & ~x18 & ~x17 & new_n225_ & ~x16 & ~x20;
  assign new_n225_ = ~x15 & ~x14 & x13 & ~x12 & new_n180_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n227_ & ~x50;
  assign new_n227_ = ~x46 & ~x40 & ~x39 & new_n228_ & ~x37 & ~x43;
  assign new_n228_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x62 & ~x61 & new_n230_ & ~x60 & ~x63;
  assign new_n230_ = ~x59 & ~x57 & ~x56 & new_n231_ & ~x55 & ~x58;
  assign new_n231_ = ~x54 & ~x53 & x52 & ~x51 & new_n232_ & ~x50;
  assign new_n232_ = ~x49 & ~x47 & ~x46 & new_n233_ & ~x45 & ~x48;
  assign new_n233_ = ~x42 & ~x41 & new_n234_ & ~x40 & ~x43;
  assign new_n234_ = ~x39 & ~x36 & ~x35 & new_n235_ & ~x34 & ~x37;
  assign new_n235_ = ~x33 & ~x31 & ~x30 & new_n236_ & x29;
  assign new_n236_ = ~x26 & ~x25 & new_n237_ & ~x24 & ~x28;
  assign new_n237_ = ~x21 & ~x18 & new_n203_ & ~x17 & ~x22;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n152_ & x39;
  assign z34 = new_n240_ & x58;
  assign new_n240_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z36 = new_n242_ & ~x62;
  assign new_n242_ = x61 & ~x58 & ~x56 & new_n243_ & ~x55 & ~x60;
  assign new_n243_ = ~x51 & ~x47 & ~x46 & new_n244_ & ~x43 & ~x50;
  assign new_n244_ = ~x41 & ~x39 & ~x37 & new_n185_ & ~x35 & ~x40;
  ...
  assign new_n270_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n174_ & x49;
  ...
  assign new_n316_ = ~x56 & ~x55 & new_n173_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n318_ & ~x60;
  assign new_n318_ = ~x59 & ~x56 & ~x55 & new_n319_ & ~x54 & ~x58;
  assign new_n319_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n174_ & x48;
  ...
  assign new_n328_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n179_ & x12;
  assign z53 = ~x64 & new_n171_ & x63;
  ...
  assign new_n333_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n185_ & x35;
  ...
  assign new_n342_ = ~x21 & ~x18 & ~x17 & new_n203_ & ~x16 & x20;
  ...
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n363_ & x47;
  assign new_n363_ = new_n364_ & ~x46;
  assign new_n364_ = ~x43 & ~x39 & ~x37 & new_n365_ & ~x30 & ~x40;
  assign new_n365_ = x29 & new_n366_ & ~x28;
  assign new_n366_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n363_ & ~x50;
  assign z64 = ~x58 & ~x50 & new_n369_ & ~x46 & ~x60;
  assign new_n369_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n365_ & x30;
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z08 = 1'b0;
