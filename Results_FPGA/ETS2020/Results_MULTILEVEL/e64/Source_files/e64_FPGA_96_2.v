...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n291_, new_n292_, new_n294_, new_n296_, new_n297_, new_n299_,
  ...
  assign new_n187_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n188_ & x16;
  assign new_n188_ = ~x14 & ~x12 & new_n170_ & ~x11 & ~x15;
  assign z24 = ~x60 & ~x50 & ~x46 & new_n190_ & ~x43 & ~x58;
  assign new_n190_ = ~x40 & ~x39 & ~x37 & x29 & new_n191_ & ~x28;
  assign new_n191_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x58 & ~x50 & new_n193_ & ~x46 & ~x60;
  assign new_n193_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n194_ & x29;
  assign new_n194_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z27 = ~x64 & ~x63 & new_n196_ & ~x62;
  assign new_n196_ = ~x61 & ~x59 & ~x58 & new_n197_ & ~x57 & ~x60;
  assign new_n197_ = ~x56 & ~x54 & ~x53 & new_n198_ & ~x52 & ~x55;
  assign new_n198_ = ~x51 & ~x49 & ~x48 & new_n199_ & ~x47 & ~x50;
  assign new_n199_ = ~x46 & ~x43 & ~x42 & new_n200_ & ~x41 & ~x45;
  assign new_n200_ = ~x40 & ~x37 & ~x36 & new_n201_ & ~x35 & ~x39;
  ...
  assign new_n204_ = ~x15 & ~x14 & x13 & ~x12 & new_n170_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n206_ & ~x50;
  assign new_n206_ = ~x46 & ~x40 & ~x39 & new_n207_ & ~x37 & ~x43;
  assign new_n207_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & new_n209_ & ~x58;
  assign new_n209_ = ~x50 & ~x43 & ~x40 & new_n152_ & ~x39 & ~x46;
  ...
  assign new_n218_ = ~x21 & ~x18 & new_n188_ & ~x17 & ~x22;
  ...
  assign new_n223_ = x61 & ~x58 & ~x56 & new_n224_ & ~x55 & ~x60;
  assign new_n224_ = ~x51 & ~x47 & ~x46 & new_n225_ & ~x43 & ~x50;
  assign new_n225_ = ~x41 & ~x39 & ~x37 & new_n175_ & ~x35 & ~x40;
  assign z38 = ~x62 & ~x61 & new_n227_ & ~x60;
  assign new_n227_ = x59 & ~x56 & ~x55 & new_n228_ & ~x51 & ~x58;
  assign new_n228_ = ~x50 & ~x46 & ~x43 & new_n229_ & ~x42 & ~x47;
  ...
  assign new_n235_ = ~x60 & ~x56 & ~x55 & new_n236_ & ~x51 & ~x58;
  ...
  assign new_n240_ = ~x46 & ~x42 & ~x41 & new_n241_ & ~x40 & ~x43;
  assign new_n241_ = ~x39 & ~x35 & ~x34 & new_n242_ & ~x33 & ~x37;
  assign new_n242_ = ~x30 & x29 & ~x28 & new_n243_ & ~x26;
  assign new_n243_ = ~x25 & ~x22 & ~x18 & new_n244_ & ~x17 & ~x24;
  assign new_n244_ = ~x15 & ~x11 & ~x10 & new_n233_ & ~x09 & ~x14;
  assign z41 = ~x62 & ~x60 & ~x59 & new_n246_ & ~x58 & ~x61;
  assign new_n246_ = ~x56 & ~x51 & ~x50 & new_n247_ & ~x47 & ~x55;
  ...
  assign new_n251_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n164_ & x49;
  assign z43 = new_n253_ & ~x62;
  assign new_n253_ = ~x61 & ~x59 & ~x58 & new_n254_ & ~x56 & ~x60;
  assign new_n254_ = ~x55 & ~x53 & ~x51 & new_n255_ & ~x50 & ~x54;
  assign new_n255_ = ~x47 & ~x45 & ~x43 & new_n256_ & ~x42 & ~x46;
  assign new_n256_ = ~x41 & ~x39 & ~x37 & new_n257_ & ~x35 & ~x40;
  assign new_n257_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n258_ & x29;
  assign new_n258_ = ~x28 & ~x25 & ~x24 & new_n259_ & ~x22 & ~x26;
  assign new_n259_ = ~x18 & ~x15 & ~x14 & new_n260_ & ~x11 & ~x17;
  assign new_n260_ = ~x10 & ~x08 & ~x07 & new_n261_ & ~x06 & ~x09;
  assign new_n261_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n263_ & ~x58 & ~x61;
  assign new_n263_ = ~x56 & ~x54 & ~x53 & new_n264_ & ~x51 & ~x55;
  assign new_n264_ = ~x50 & ~x46 & ~x45 & new_n265_ & ~x43 & ~x47;
  assign new_n265_ = ~x42 & ~x40 & ~x39 & new_n266_ & ~x37 & ~x41;
  assign new_n266_ = ~x35 & ~x33 & ~x31 & new_n267_ & ~x30 & ~x34;
  assign new_n267_ = x29 & ~x26 & ~x25 & new_n268_ & ~x24 & ~x28;
  assign new_n268_ = ~x22 & ~x17 & ~x15 & new_n269_ & ~x14 & ~x18;
  assign new_n269_ = ~x11 & ~x09 & ~x08 & new_n270_ & ~x07 & ~x10;
  assign new_n270_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x61 & ~x60 & new_n272_ & ~x59 & ~x62;
  assign new_n272_ = ~x58 & ~x55 & ~x51 & new_n273_ & ~x50 & ~x56;
  assign new_n273_ = ~x47 & ~x43 & ~x42 & new_n274_ & ~x41 & ~x46;
  assign new_n274_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n242_ & x34;
  assign z46 = ~x62 & new_n276_ & ~x61;
  assign new_n276_ = ~x60 & ~x58 & ~x56 & new_n277_ & ~x55 & ~x59;
  ...
  assign new_n280_ = ~x25 & ~x22 & ~x18 & new_n281_ & ~x17 & ~x24;
  ...
  assign new_n289_ = ~x59 & ~x56 & ~x55 & new_n290_ & ~x54 & ~x58;
  assign new_n290_ = ~x53 & ~x50 & ~x47 & new_n291_ & ~x46 & ~x51;
  assign new_n291_ = ~x43 & ~x41 & ~x40 & new_n292_ & ~x39 & ~x42;
  assign new_n292_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n242_ & x31;
  assign z49 = ~x61 & ~x60 & new_n294_ & ~x59 & ~x62;
  assign new_n294_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n239_ & x53;
  assign z50 = new_n296_ & ~x62;
  assign new_n296_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n297_ & x57;
  assign new_n297_ = ~x56 & ~x55 & new_n163_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n299_ & ~x60;
  assign new_n299_ = ~x59 & ~x56 & ~x55 & new_n300_ & ~x54 & ~x58;
  assign new_n300_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n164_ & x48;
  assign z52 = new_n302_ & ~x64;
  assign new_n302_ = ~x63 & ~x61 & ~x60 & new_n303_ & ~x59 & ~x62;
  assign new_n303_ = ~x58 & ~x56 & ~x55 & new_n304_ & ~x54 & ~x57;
  assign new_n304_ = ~x53 & ~x50 & ~x49 & new_n305_ & ~x48 & ~x51;
  assign new_n305_ = ~x47 & ~x45 & ~x43 & new_n306_ & ~x42 & ~x46;
  assign new_n306_ = ~x41 & ~x39 & ~x37 & new_n307_ & ~x35 & ~x40;
  assign new_n307_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n308_ & x29;
  assign new_n308_ = ~x28 & ~x25 & ~x24 & new_n309_ & ~x22 & ~x26;
  assign new_n309_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n169_ & x12;
  assign z53 = ~x64 & new_n161_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n224_ & x55;
  assign z55 = ~x60 & ~x58 & new_n313_ & ~x56 & ~x62;
  assign new_n313_ = ~x51 & ~x47 & ~x46 & new_n314_ & ~x43 & ~x50;
  assign new_n314_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n175_ & x35;
  ...
  assign new_n323_ = ~x21 & ~x18 & ~x17 & new_n188_ & ~x16 & x20;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n325_ & ~x50 & ~x60;
  assign new_n325_ = ~x47 & ~x43 & ~x41 & new_n326_ & ~x40 & ~x46;
  ...
  assign z58 = ~x60 & ~x58 & new_n331_ & ~x56 & ~x62;
  assign new_n331_ = ~x50 & ~x46 & ~x43 & new_n332_ & ~x41 & ~x47;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n336_ & ~x47 & ~x58;
  assign new_n336_ = ~x46 & ~x40 & ~x39 & new_n337_ & ~x37 & ~x43;
  assign new_n337_ = ~x30 & ~x28 & ~x25 & new_n338_ & ~x24 & x29;
  assign new_n338_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n340_ & ~x50 & ~x60;
  assign new_n340_ = ~x47 & ~x43 & ~x40 & new_n341_ & ~x39 & ~x46;
  assign new_n341_ = ~x37 & ~x30 & x29 & ~x28 & new_n342_ & ~x25;
  assign new_n342_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n344_ & x47;
  assign new_n344_ = new_n345_ & ~x46;
  assign new_n345_ = ~x43 & ~x39 & ~x37 & new_n346_ & ~x30 & ~x40;
  assign new_n346_ = x29 & new_n347_ & ~x28;
  assign new_n347_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n344_ & ~x50;
  assign z64 = ~x58 & ~x50 & new_n350_ & ~x46 & ~x60;
