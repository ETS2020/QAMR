// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:59 2020
...
module FAU ( 
  ...
  assign z23 = ~x64 & ~x63 & ~x62 & ~x61 & new_n180_ & ~x60;
  ...
  assign new_n186_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n187_ & ~x18;
  assign new_n187_ = ~x17 & x16 & ~x15 & ~x14 & new_n163_ & ~x12;
  ...
  assign new_n197_ = ~x34 & ~x33 & ~x31 & new_n198_ & x29 & ~x30;
  assign new_n198_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n199_ & ~x22;
  assign new_n199_ = ~x21 & ~x20 & ~x18 & ~x17 & new_n200_ & ~x16;
  assign new_n200_ = ~x15 & ~x14 & x13 & ~x12 & new_n164_ & ~x11;
  assign z28 = ~x60 & ~x58 & new_n202_ & ~x50;
  assign new_n202_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n203_ & ~x37;
  assign new_n203_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  ...
  assign new_n208_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n209_ & ~x39;
  assign new_n209_ = ~x37 & ~x36 & ~x35 & ~x34 & new_n210_ & ~x33;
  assign new_n210_ = ~x31 & ~x30 & x29 & ~x28 & new_n211_ & ~x26;
  assign new_n211_ = ~x25 & ~x24 & ~x22 & new_n212_ & ~x21;
  assign new_n212_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n163_ & ~x12;
