...
module FAU ( 
  ...
  assign z22 = ~x64 & new_n237_ & ~x63;
  assign new_n237_ = ~x61 & ~x60 & ~x59 & new_n238_ & ~x58 & ~x62;
  assign new_n238_ = ~x56 & ~x55 & ~x54 & new_n239_ & ~x53 & ~x57;
  assign new_n239_ = ~x50 & ~x49 & ~x48 & new_n240_ & ~x47 & ~x51;
  assign new_n240_ = ~x45 & ~x43 & ~x42 & new_n241_ & ~x41 & ~x46;
  assign new_n241_ = ~x40 & ~x39 & ~x37 & x36 & new_n242_ & ~x35;
  assign new_n242_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n243_ & x29;
  assign new_n243_ = ~x26 & ~x25 & ~x24 & new_n244_ & ~x22 & ~x28;
  assign new_n244_ = ~x17 & ~x15 & ~x14 & new_n228_ & ~x12 & ~x18;
  ...
  assign new_n283_ = ~x25 & ~x24 & ~x22 & new_n244_ & ~x21 & ~x26;
  ...
  assign new_n291_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n244_ & x21;
  ...
  assign new_n305_ = ~x40 & ~x39 & ~x37 & new_n232_ & ~x35 & ~x41;
  ...
  assign new_n314_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n260_ & x19;
  assign z42 = ~x62 & new_n316_ & ~x61;
  assign new_n316_ = ~x59 & ~x58 & ~x56 & new_n317_ & ~x55 & ~x60;
  assign new_n317_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n223_ & x49;
  assign z43 = new_n319_ & ~x62;
  assign new_n319_ = ~x60 & ~x59 & ~x58 & new_n320_ & ~x56 & ~x61;
  assign new_n320_ = ~x54 & ~x53 & ~x51 & new_n321_ & ~x50 & ~x55;
  ...
  assign new_n325_ = ~x17 & ~x15 & ~x14 & new_n326_ & ~x11 & ~x18;
  assign new_n326_ = ~x09 & ~x08 & ~x07 & new_n327_ & ~x06 & ~x10;
  assign new_n327_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n329_ & ~x58 & ~x62;
  assign new_n329_ = ~x55 & ~x54 & ~x53 & new_n330_ & ~x51 & ~x56;
  assign new_n330_ = ~x47 & ~x46 & ~x45 & new_n331_ & ~x43 & ~x50;
  assign new_n331_ = ~x41 & ~x40 & ~x39 & new_n332_ & ~x37 & ~x42;
  assign new_n332_ = ~x34 & ~x33 & ~x31 & new_n333_ & ~x30 & ~x35;
  assign new_n333_ = ~x28 & ~x26 & ~x25 & new_n334_ & ~x24 & x29;
  assign new_n334_ = ~x18 & ~x17 & ~x15 & new_n335_ & ~x14 & ~x22;
  assign new_n335_ = ~x10 & ~x09 & ~x08 & new_n336_ & ~x07 & ~x11;
  assign new_n336_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z50 = new_n338_ & ~x62;
  assign new_n338_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n221_ & x57;
  assign z51 = ~x62 & ~x61 & new_n340_ & ~x60;
  assign new_n340_ = ~x58 & ~x56 & ~x55 & new_n341_ & ~x54 & ~x59;
  assign new_n341_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n223_ & x48;
  assign z52 = new_n343_ & ~x64;
  assign new_n343_ = ~x62 & ~x61 & ~x60 & new_n344_ & ~x59 & ~x63;
  assign new_n344_ = ~x57 & ~x56 & ~x55 & new_n345_ & ~x54 & ~x58;
  assign new_n345_ = ~x51 & ~x50 & ~x49 & new_n346_ & ~x48 & ~x53;
  ...
  assign new_n350_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n228_ & x12;
  assign z53 = ~x64 & new_n219_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n304_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n354_ & ~x56;
  assign new_n354_ = ~x50 & ~x47 & ~x46 & new_n355_ & ~x43 & ~x51;
  assign new_n355_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n232_ & x35;
