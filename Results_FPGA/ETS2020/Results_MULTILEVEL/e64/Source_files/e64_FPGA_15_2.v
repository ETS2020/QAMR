...
module FAU ( 
  ...
  assign new_n205_ = ~x25 & ~x24 & new_n206_ & ~x22;
  assign new_n206_ = ~x17 & ~x15 & ~x14 & new_n182_ & ~x12 & ~x18;
  assign z23 = ~x63 & ~x62 & ~x61 & new_n208_ & ~x60 & ~x64;
  assign new_n208_ = ~x58 & ~x57 & ~x56 & new_n209_ & ~x55 & ~x59;
  assign new_n209_ = ~x53 & ~x52 & ~x51 & new_n210_ & ~x50 & ~x54;
  assign new_n210_ = ~x48 & ~x47 & ~x46 & new_n211_ & ~x45 & ~x49;
  assign new_n211_ = ~x42 & ~x41 & ~x40 & new_n212_ & ~x39 & ~x43;
  assign new_n212_ = ~x36 & ~x35 & ~x34 & new_n213_ & ~x33 & ~x37;
  assign new_n213_ = ~x31 & ~x30 & x29 & ~x28 & new_n214_ & ~x26;
  assign new_n214_ = ~x24 & ~x22 & ~x21 & new_n215_ & ~x18 & ~x25;
  assign new_n215_ = ~x17 & x16 & ~x15 & ~x14 & new_n182_ & ~x12;
  ...
  assign new_n238_ = ~x31 & ~x30 & x29 & new_n239_ & ~x28;
  assign new_n239_ = ~x25 & ~x24 & ~x22 & new_n206_ & ~x21 & ~x26;
  ...
  assign new_n245_ = ~x36 & ~x35 & ~x34 & new_n246_ & ~x33;
  assign new_n246_ = ~x31 & ~x30 & x29 & ~x28 & new_n247_ & ~x26;
  assign new_n247_ = ~x25 & ~x24 & ~x22 & new_n206_ & x21;
  ...
  assign z36 = new_n259_ & ~x62;
  assign new_n259_ = ~x60 & ~x58 & ~x56 & new_n260_ & ~x55 & x61;
  assign new_n260_ = ~x50 & ~x47 & ~x46 & new_n261_ & ~x43 & ~x51;
  assign new_n261_ = ~x40 & ~x39 & ~x37 & new_n188_ & ~x35 & ~x41;
  assign z38 = ~x62 & ~x61 & new_n263_ & ~x60;
  assign new_n263_ = ~x58 & ~x56 & ~x55 & new_n264_ & ~x51 & x59;
  assign new_n264_ = ~x47 & ~x46 & ~x43 & new_n265_ & ~x42 & ~x50;
  assign new_n265_ = ~x41 & ~x40 & new_n266_ & ~x39;
  assign new_n266_ = ~x37 & ~x35 & ~x30 & x29 & new_n267_ & ~x28;
  assign new_n267_ = ~x25 & ~x24 & ~x22 & new_n268_ & ~x18 & ~x26;
  assign new_n268_ = ~x15 & ~x14 & ~x11 & new_n269_ & ~x10;
  assign new_n269_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n271_ & ~x61;
  assign new_n271_ = ~x58 & ~x56 & ~x55 & new_n272_ & ~x51 & ~x60;
  assign new_n272_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n265_ & x42;
  assign z40 = ~x62 & ~x61 & new_n274_ & ~x60;
  assign new_n274_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n275_ & x54;
  assign new_n275_ = ~x51 & ~x50 & new_n276_ & ~x47;
  assign new_n276_ = ~x43 & ~x42 & ~x41 & new_n277_ & ~x40 & ~x46;
  assign new_n277_ = ~x37 & ~x35 & ~x34 & new_n278_ & ~x33 & ~x39;
  assign new_n278_ = ~x30 & x29 & ~x28 & new_n279_ & ~x26;
  assign new_n279_ = ~x24 & ~x22 & ~x18 & new_n280_ & ~x17 & ~x25;
  assign new_n280_ = ~x14 & ~x11 & ~x10 & new_n269_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n282_ & ~x58 & ~x62;
  assign new_n282_ = ~x55 & ~x51 & ~x50 & new_n283_ & ~x47 & ~x56;
  assign new_n283_ = ~x43 & ~x42 & ~x41 & new_n284_ & ~x40 & ~x46;
  assign new_n284_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n278_ & x33;
  assign z42 = ~x62 & new_n286_ & ~x61;
  assign new_n286_ = ~x59 & ~x58 & ~x56 & new_n287_ & ~x55 & ~x60;
  assign new_n287_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n177_ & x49;
  ...
  assign new_n301_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n278_ & x34;
  ...
  assign new_n308_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n269_ & x09;
  ...
  assign new_n314_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n268_ & x17;
  ...
  assign new_n336_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n182_ & x12;
  assign z53 = ~x64 & new_n174_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n260_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n340_ & ~x56;
  assign new_n340_ = ~x50 & ~x47 & ~x46 & new_n341_ & ~x43 & ~x51;
  assign new_n341_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n188_ & x35;
