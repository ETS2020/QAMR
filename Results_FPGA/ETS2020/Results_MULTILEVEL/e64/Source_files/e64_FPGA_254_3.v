...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n376_, new_n377_, new_n378_, new_n379_, new_n380_, new_n384_,
  ...
  assign z32 = new_n280_ & ~x58;
  assign new_n280_ = ~x50 & x46 & ~x43 & ~x40 & new_n281_ & ~x39;
  assign new_n281_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n281_ & x39;
  ...
  assign new_n288_ = ~x40 & ~x39 & ~x37 & new_n213_ & ~x35 & ~x41;
  ...
  assign new_n323_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n204_ & x49;
  assign z43 = new_n325_ & ~x62;
  assign new_n325_ = ~x60 & ~x59 & ~x58 & new_n326_ & ~x56 & ~x61;
  assign new_n326_ = ~x54 & ~x53 & ~x51 & new_n327_ & ~x50 & ~x55;
  ...
  assign new_n331_ = ~x17 & ~x15 & ~x14 & new_n332_ & ~x11 & ~x18;
  assign new_n332_ = ~x09 & ~x08 & ~x07 & new_n333_ & ~x06 & ~x10;
  assign new_n333_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n335_ & ~x58 & ~x62;
  assign new_n335_ = ~x55 & ~x54 & ~x53 & new_n336_ & ~x51 & ~x56;
  assign new_n336_ = ~x47 & ~x46 & ~x45 & new_n337_ & ~x43 & ~x50;
  assign new_n337_ = ~x41 & ~x40 & ~x39 & new_n338_ & ~x37 & ~x42;
  assign new_n338_ = ~x34 & ~x33 & ~x31 & new_n339_ & ~x30 & ~x35;
  assign new_n339_ = ~x28 & ~x26 & ~x25 & new_n340_ & ~x24 & x29;
  assign new_n340_ = ~x18 & ~x17 & ~x15 & new_n341_ & ~x14 & ~x22;
  assign new_n341_ = ~x10 & ~x09 & ~x08 & new_n342_ & ~x07 & ~x11;
  assign new_n342_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n344_ & ~x59;
  assign new_n344_ = ~x56 & ~x55 & ~x51 & new_n345_ & ~x50 & ~x58;
  assign new_n345_ = ~x46 & ~x43 & ~x42 & new_n346_ & ~x41 & ~x47;
  assign new_n346_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n314_ & x34;
  assign z46 = ~x62 & new_n348_ & ~x61;
  ...
  assign new_n353_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n305_ & x09;
  assign z47 = ~x62 & new_n355_ & ~x61;
  ...
  assign new_n359_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n304_ & x17;
  assign z48 = ~x62 & ~x61 & new_n361_ & ~x60;
  assign new_n361_ = ~x58 & ~x56 & ~x55 & new_n362_ & ~x54 & ~x59;
  assign new_n362_ = ~x51 & ~x50 & ~x47 & new_n363_ & ~x46 & ~x53;
  assign new_n363_ = ~x42 & ~x41 & ~x40 & new_n364_ & ~x39 & ~x43;
  assign new_n364_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n314_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n366_ & ~x59;
  assign new_n366_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n311_ & x53;
  assign z50 = new_n368_ & ~x62;
  assign new_n368_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n202_ & x57;
  assign z51 = ~x62 & ~x61 & new_n370_ & ~x60;
  assign new_n370_ = ~x58 & ~x56 & ~x55 & new_n371_ & ~x54 & ~x59;
  assign new_n371_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n204_ & x48;
  assign z52 = new_n373_ & ~x64;
  assign new_n373_ = ~x62 & ~x61 & ~x60 & new_n374_ & ~x59 & ~x63;
  assign new_n374_ = ~x57 & ~x56 & ~x55 & new_n375_ & ~x54 & ~x58;
  assign new_n375_ = ~x51 & ~x50 & ~x49 & new_n376_ & ~x48 & ~x53;
  ...
  assign new_n380_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n209_ & x12;
  ...
  assign new_n385_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n213_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n387_ & ~x60 & ~x64;
  assign new_n387_ = ~x58 & ~x57 & ~x56 & new_n388_ & ~x55 & ~x59;
  assign new_n388_ = ~x53 & ~x52 & ~x51 & new_n389_ & ~x50 & ~x54;
  assign new_n389_ = ~x48 & ~x47 & ~x46 & new_n390_ & ~x45 & ~x49;
  assign new_n390_ = ~x42 & ~x41 & ~x40 & new_n391_ & ~x39 & ~x43;
  assign new_n391_ = ~x36 & ~x35 & ~x34 & new_n392_ & ~x33 & ~x37;
  assign new_n392_ = ~x31 & ~x30 & x29 & ~x28 & new_n393_ & ~x26;
  assign new_n393_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n394_ & x20;
  assign new_n394_ = ~x17 & ~x16 & ~x15 & new_n232_ & ~x14 & ~x18;
  ...
  assign z59 = ~x58 & ~x50 & ~x43 & new_n281_ & x40;
