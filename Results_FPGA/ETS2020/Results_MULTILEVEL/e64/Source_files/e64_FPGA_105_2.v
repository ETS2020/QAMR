// Benchmark "FAU" written by ABC on Wed Aug  5 20:41:42 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n318_, new_n319_, new_n323_, new_n324_, new_n326_, new_n327_,
  ...
  assign new_n160_ = ~x58 & ~x56 & ~x50 & new_n161_ & ~x47 & ~x60;
  assign new_n161_ = ~x43 & ~x40 & ~x39 & new_n162_ & ~x37 & ~x46;
  assign new_n162_ = ~x30 & x29 & ~x28 & ~x25 & new_n163_ & ~x24;
  assign new_n163_ = ~x15 & ~x14 & ~x11 & ~x10 & ~x07 & ~x08;
  assign z19 = new_n165_ & x64;
  assign new_n165_ = ~x62 & ~x61 & ~x60 & new_n166_ & ~x59;
  assign new_n166_ = ~x57 & ~x56 & ~x55 & new_n167_ & ~x54 & ~x58;
  ...
  assign new_n174_ = ~x09 & ~x08 & ~x07 & new_n175_ & ~x06 & ~x10;
  assign new_n175_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z20 = ~x62 & ~x60 & new_n177_ & ~x58;
  assign new_n177_ = ~x56 & x51 & ~x50 & ~x47 & new_n178_ & ~x46;
  assign new_n178_ = ~x41 & ~x40 & ~x39 & new_n179_ & ~x37 & ~x43;
  assign new_n179_ = ~x30 & x29 & new_n180_ & ~x28;
  assign new_n180_ = ~x25 & ~x24 & ~x22 & new_n181_ & ~x18 & ~x26;
  assign new_n181_ = ~x15 & ~x14 & ~x11 & new_n182_ & ~x10;
  assign new_n182_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  assign z22 = ~x64 & ~x63 & ~x62 & new_n184_ & ~x61;
  assign new_n184_ = ~x59 & ~x58 & ~x57 & new_n185_ & ~x56 & ~x60;
  assign new_n185_ = ~x54 & ~x53 & ~x51 & new_n186_ & ~x50 & ~x55;
  assign new_n186_ = ~x48 & ~x47 & ~x46 & new_n187_ & ~x45 & ~x49;
  assign new_n187_ = ~x42 & ~x41 & ~x40 & new_n188_ & ~x39 & ~x43;
  assign new_n188_ = ~x37 & x36 & ~x35 & ~x34 & new_n189_ & ~x33;
  assign new_n189_ = ~x31 & ~x30 & x29 & ~x28 & new_n190_ & ~x26;
  assign new_n190_ = ~x24 & ~x22 & ~x18 & new_n191_ & ~x17 & ~x25;
  assign new_n191_ = ~x15 & ~x14 & ~x12 & new_n174_ & ~x11;
  assign z23 = ~x64 & new_n193_ & ~x63;
  assign new_n193_ = ~x61 & ~x60 & ~x59 & new_n194_ & ~x58 & ~x62;
  assign new_n194_ = ~x56 & ~x55 & ~x54 & new_n195_ & ~x53 & ~x57;
  assign new_n195_ = ~x51 & ~x50 & ~x49 & new_n196_ & ~x48 & ~x52;
  assign new_n196_ = ~x46 & ~x45 & ~x43 & new_n197_ & ~x42 & ~x47;
  assign new_n197_ = ~x40 & ~x39 & ~x37 & new_n198_ & ~x36 & ~x41;
  assign new_n198_ = ~x34 & ~x33 & ~x31 & new_n199_ & ~x30 & ~x35;
  assign new_n199_ = ~x28 & ~x26 & ~x25 & new_n200_ & ~x24 & x29;
  assign new_n200_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n191_ & x16;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n202_ & ~x43 & ~x60;
  ...
  assign new_n213_ = ~x15 & ~x14 & x13 & ~x12 & new_n174_ & ~x11;
  ...
  assign new_n225_ = ~x22 & ~x21 & ~x18 & new_n191_ & ~x17;
  ...
  assign new_n239_ = ~x40 & ~x39 & ~x37 & new_n179_ & ~x35 & ~x41;
  ...
  assign new_n261_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n168_ & x49;
  ...
  assign new_n284_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n256_ & x34;
  ...
  assign new_n291_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n247_ & x09;
  ...
  assign new_n297_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n246_ & x17;
  ...
  assign new_n319_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n173_ & x12;
  ...
  assign new_n324_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n179_ & x35;
  ...
  assign new_n333_ = ~x21 & x20 & ~x18 & ~x17 & new_n191_ & ~x16;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n335_ & ~x50 & ~x62;
  ...
  assign z58 = ~x62 & ~x60 & ~x58 & new_n341_ & ~x56;
  assign new_n341_ = ~x47 & ~x46 & ~x43 & new_n342_ & ~x41 & ~x50;
  ...
  assign z60 = ~x58 & ~x56 & ~x50 & new_n346_ & ~x47 & ~x60;
  assign new_n346_ = ~x43 & ~x40 & ~x39 & new_n347_ & ~x37 & ~x46;
  assign new_n347_ = ~x30 & x29 & ~x28 & ~x25 & new_n348_ & ~x24;
  assign new_n348_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
