...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n274_, new_n275_, new_n276_, new_n280_, new_n282_, new_n283_,
    ...
    new_n327_, new_n331_, new_n332_, new_n334_, new_n335_, new_n336_,
    new_n337_, new_n338_, new_n340_, new_n341_, new_n342_, new_n345_,
  ...
  assign new_n196_ = ~x37 & ~x30 & x29 & ~x28 & new_n192_ & x26;
  ...
  assign new_n204_ = ~x60 & ~x59 & ~x58 & new_n205_ & ~x57 & ~x61;
  assign new_n205_ = ~x56 & ~x55 & new_n206_ & ~x54;
  assign new_n206_ = ~x51 & ~x50 & ~x49 & new_n207_ & ~x48 & ~x53;
  assign new_n207_ = ~x47 & ~x46 & ~x45 & new_n208_ & ~x43;
  assign new_n208_ = ~x41 & ~x40 & ~x39 & new_n209_ & ~x37 & ~x42;
  assign new_n209_ = ~x34 & ~x33 & ~x31 & new_n210_ & ~x30 & ~x35;
  assign new_n210_ = ~x28 & ~x26 & ~x25 & new_n211_ & ~x24 & x29;
  assign new_n211_ = ~x18 & ~x17 & ~x15 & new_n212_ & ~x14 & ~x22;
  assign new_n212_ = new_n161_ & ~x11;
  ...
  assign new_n228_ = ~x17 & ~x15 & ~x14 & new_n212_ & ~x12 & ~x18;
  ...
  assign z27 = ~x64 & ~x63 & new_n246_ & ~x62;
  assign new_n246_ = ~x60 & ~x59 & ~x58 & new_n247_ & ~x57 & ~x61;
  assign new_n247_ = ~x55 & ~x54 & ~x53 & new_n248_ & ~x52 & ~x56;
  assign new_n248_ = ~x50 & ~x49 & ~x48 & new_n249_ & ~x47 & ~x51;
  assign new_n249_ = ~x45 & ~x43 & ~x42 & new_n250_ & ~x41 & ~x46;
  assign new_n250_ = ~x39 & ~x37 & ~x36 & new_n251_ & ~x35 & ~x40;
  assign new_n251_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n252_ & x29;
  assign new_n252_ = ~x26 & ~x25 & ~x24 & new_n253_ & ~x22 & ~x28;
  assign new_n253_ = ~x21 & ~x20 & ~x18 & new_n254_ & ~x17;
  assign new_n254_ = ~x16 & ~x15 & ~x14 & x13 & new_n212_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n256_ & ~x50;
  assign new_n256_ = ~x43 & ~x40 & ~x39 & new_n257_ & ~x37 & ~x46;
  assign new_n257_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n259_ & ~x46;
  assign new_n259_ = ~x43 & ~x40 & new_n260_ & ~x39;
  assign new_n260_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n262_ & ~x61;
  ...
  assign new_n268_ = ~x25 & ~x24 & ~x22 & new_n228_ & ~x21 & ~x26;
  ...
  assign new_n276_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n228_ & x21;
  assign z32 = ~x58 & ~x50 & new_n259_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n260_ & x39;
  ...
  assign new_n291_ = ~x40 & ~x39 & ~x37 & new_n216_ & ~x35 & ~x41;
  ...
  assign new_n300_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n244_ & x19;
  assign z42 = ~x62 & new_n302_ & ~x61;
  assign new_n302_ = ~x59 & ~x58 & ~x56 & new_n303_ & ~x55 & ~x60;
  assign new_n303_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n207_ & x49;
  ...
  assign new_n315_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n205_ & x57;
  assign z51 = ~x62 & ~x61 & new_n317_ & ~x60;
  assign new_n317_ = ~x58 & ~x56 & ~x55 & new_n318_ & ~x54 & ~x59;
  assign new_n318_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n207_ & x48;
  ...
  assign new_n327_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n212_ & x12;
  ...
  assign new_n332_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n216_ & x35;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n334_ & ~x50 & ~x62;
  assign new_n334_ = ~x46 & ~x43 & ~x41 & new_n335_ & ~x40 & ~x47;
  assign new_n335_ = ~x39 & ~x37 & ~x30 & x29 & new_n336_ & ~x28;
  assign new_n336_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n337_ & x18;
  assign new_n337_ = ~x15 & new_n338_ & ~x14;
  assign new_n338_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n340_ & ~x56;
  assign new_n340_ = ~x47 & ~x46 & ~x43 & new_n341_ & ~x41 & ~x50;
  assign new_n341_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n342_ & x29;
  assign new_n342_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n337_ & x22;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n260_ & x40;
