...
module FAU ( 
  ...
  assign z45 = ~x61 & ~x60 & new_n288_ & ~x59 & ~x62;
  assign new_n288_ = ~x58 & ~x55 & ~x51 & new_n289_ & ~x50 & ~x56;
  assign new_n289_ = ~x47 & ~x43 & ~x42 & new_n290_ & ~x41 & ~x46;
  assign new_n290_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n280_ & x34;
  assign z46 = ~x62 & new_n292_ & ~x61;
  assign new_n292_ = ~x60 & ~x58 & ~x56 & new_n293_ & ~x55 & ~x59;
  assign new_n293_ = ~x51 & ~x47 & ~x46 & new_n294_ & ~x43 & ~x50;
  assign new_n294_ = ~x42 & ~x40 & ~x39 & new_n295_ & ~x37 & ~x41;
  assign new_n295_ = ~x35 & ~x30 & x29 & ~x28 & new_n296_ & ~x26;
  assign new_n296_ = ~x25 & ~x22 & ~x18 & new_n297_ & ~x17 & ~x24;
  assign new_n297_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n271_ & x09;
  assign z47 = ~x62 & new_n299_ & ~x61;
  assign new_n299_ = ~x60 & ~x58 & ~x56 & new_n300_ & ~x55 & ~x59;
  assign new_n300_ = ~x51 & ~x47 & ~x46 & new_n301_ & ~x43 & ~x50;
  assign new_n301_ = ~x42 & ~x40 & ~x39 & new_n302_ & ~x37 & ~x41;
  assign new_n302_ = ~x35 & ~x30 & x29 & ~x28 & new_n303_ & ~x26;
  assign new_n303_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n270_ & x17;
  assign z48 = ~x62 & ~x61 & new_n305_ & ~x60;
  assign new_n305_ = ~x59 & ~x56 & ~x55 & new_n306_ & ~x54 & ~x58;
  assign new_n306_ = ~x53 & ~x50 & ~x47 & new_n307_ & ~x46 & ~x51;
  assign new_n307_ = ~x43 & ~x41 & ~x40 & new_n308_ & ~x39 & ~x42;
  assign new_n308_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n280_ & x31;
  assign z49 = ~x61 & ~x60 & new_n310_ & ~x59 & ~x62;
  assign new_n310_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n277_ & x53;
  assign z56 = ~x64 & ~x63 & new_n312_ & ~x62;
  assign new_n312_ = ~x61 & ~x59 & ~x58 & new_n313_ & ~x57 & ~x60;
  assign new_n313_ = ~x56 & ~x54 & ~x53 & new_n314_ & ~x52 & ~x55;
  assign new_n314_ = ~x51 & ~x49 & ~x48 & new_n315_ & ~x47 & ~x50;
  assign new_n315_ = ~x46 & ~x43 & ~x42 & new_n316_ & ~x41 & ~x45;
  assign new_n316_ = ~x40 & ~x37 & ~x36 & new_n317_ & ~x35 & ~x39;
  assign new_n317_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n318_ & x29;
  assign new_n318_ = ~x28 & ~x25 & ~x24 & new_n319_ & ~x22 & ~x26;
  assign new_n319_ = ~x21 & ~x18 & ~x17 & new_n211_ & ~x16 & x20;
  assign z00 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z15 = 1'b0;
