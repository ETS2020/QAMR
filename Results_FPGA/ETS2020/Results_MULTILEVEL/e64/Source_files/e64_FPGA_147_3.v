// Benchmark "FAU" written by ABC on Wed Aug  5 20:42:09 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n286_, new_n287_, new_n291_, new_n293_, new_n294_, new_n295_,
    ...
    new_n423_, new_n425_, new_n426_, new_n427_, new_n428_, new_n431_;
  ...
  assign z26 = new_n248_ & ~x64;
  assign new_n248_ = ~x62 & ~x61 & ~x60 & new_n249_ & ~x59 & ~x63;
  assign new_n249_ = ~x57 & ~x56 & ~x55 & new_n250_ & ~x54 & ~x58;
  assign new_n250_ = ~x52 & ~x51 & ~x50 & new_n251_ & ~x49 & ~x53;
  assign new_n251_ = ~x47 & ~x46 & ~x45 & new_n252_ & ~x43 & ~x48;
  assign new_n252_ = ~x41 & ~x40 & ~x39 & new_n253_ & ~x37 & ~x42;
  assign new_n253_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n254_ & x32;
  assign new_n254_ = ~x31 & ~x30 & x29 & ~x28 & new_n255_ & ~x26;
  assign new_n255_ = ~x24 & ~x22 & ~x21 & new_n256_ & ~x20 & ~x25;
  assign new_n256_ = ~x18 & ~x17 & new_n142_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n258_ & ~x62;
  assign new_n258_ = ~x60 & ~x59 & ~x58 & new_n259_ & ~x57 & ~x61;
  assign new_n259_ = ~x55 & ~x54 & ~x53 & new_n260_ & ~x52 & ~x56;
  assign new_n260_ = ~x50 & ~x49 & ~x48 & new_n261_ & ~x47 & ~x51;
  assign new_n261_ = ~x45 & ~x43 & ~x42 & new_n262_ & ~x41 & ~x46;
  assign new_n262_ = ~x39 & ~x37 & ~x36 & new_n263_ & ~x35 & ~x40;
  assign new_n263_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n264_ & x29;
  assign new_n264_ = ~x26 & ~x25 & ~x24 & new_n265_ & ~x22 & ~x28;
  assign new_n265_ = ~x20 & ~x18 & ~x17 & new_n266_ & ~x16 & ~x21;
  assign new_n266_ = ~x15 & ~x14 & x13 & new_n211_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n268_ & ~x50;
  assign new_n268_ = ~x43 & ~x40 & ~x39 & new_n269_ & ~x37 & ~x46;
  assign new_n269_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n271_ & ~x46;
  assign new_n271_ = ~x43 & ~x40 & new_n185_ & ~x39;
  ...
  assign new_n279_ = ~x25 & ~x24 & ~x22 & new_n233_ & ~x21 & ~x26;
  ...
  assign new_n287_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n233_ & x21;
  ...
  assign new_n302_ = ~x40 & ~x39 & ~x37 & new_n215_ & ~x35 & ~x41;
  ...
  assign new_n311_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n256_ & x19;
  assign z38 = ~x62 & ~x61 & new_n313_ & ~x60;
  assign new_n313_ = ~x58 & ~x56 & ~x55 & new_n314_ & ~x51 & x59;
  assign new_n314_ = ~x47 & ~x46 & ~x43 & new_n315_ & ~x42 & ~x50;
  assign new_n315_ = ~x41 & ~x40 & new_n316_ & ~x39;
  assign new_n316_ = ~x37 & ~x35 & ~x30 & x29 & new_n317_ & ~x28;
  assign new_n317_ = ~x25 & ~x24 & ~x22 & new_n318_ & ~x18 & ~x26;
  assign new_n318_ = ~x15 & ~x14 & ~x11 & new_n319_ & ~x10;
  assign new_n319_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n321_ & ~x61;
  assign new_n321_ = ~x58 & ~x56 & ~x55 & new_n322_ & ~x51 & ~x60;
  assign new_n322_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n315_ & x42;
  assign z40 = ~x62 & ~x61 & new_n324_ & ~x60;
  assign new_n324_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n325_ & x54;
  assign new_n325_ = ~x51 & ~x50 & new_n326_ & ~x47;
  assign new_n326_ = ~x43 & ~x42 & ~x41 & new_n327_ & ~x40 & ~x46;
  assign new_n327_ = ~x37 & ~x35 & ~x34 & new_n328_ & ~x33 & ~x39;
  assign new_n328_ = ~x30 & x29 & ~x28 & new_n329_ & ~x26;
  assign new_n329_ = ~x24 & ~x22 & ~x18 & new_n330_ & ~x17 & ~x25;
  assign new_n330_ = ~x14 & ~x11 & ~x10 & new_n319_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n332_ & ~x58 & ~x62;
  assign new_n332_ = ~x55 & ~x51 & ~x50 & new_n333_ & ~x47 & ~x56;
  assign new_n333_ = ~x43 & ~x42 & ~x41 & new_n334_ & ~x40 & ~x46;
  assign new_n334_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n328_ & x33;
  assign z42 = ~x62 & new_n336_ & ~x61;
  assign new_n336_ = ~x59 & ~x58 & ~x56 & new_n337_ & ~x55 & ~x60;
  assign new_n337_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n206_ & x49;
  assign z43 = new_n339_ & ~x62;
  assign new_n339_ = ~x60 & ~x59 & ~x58 & new_n340_ & ~x56 & ~x61;
  assign new_n340_ = ~x54 & ~x53 & ~x51 & new_n341_ & ~x50 & ~x55;
  assign new_n341_ = ~x46 & ~x45 & ~x43 & new_n342_ & ~x42 & ~x47;
  assign new_n342_ = ~x40 & ~x39 & ~x37 & new_n343_ & ~x35 & ~x41;
  assign new_n343_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n344_ & x29;
  assign new_n344_ = ~x26 & ~x25 & ~x24 & new_n345_ & ~x22 & ~x28;
  assign new_n345_ = ~x17 & ~x15 & ~x14 & new_n346_ & ~x11 & ~x18;
  assign new_n346_ = ~x09 & ~x08 & ~x07 & new_n347_ & ~x06 & ~x10;
  assign new_n347_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n349_ & ~x58 & ~x62;
  assign new_n349_ = ~x55 & ~x54 & ~x53 & new_n350_ & ~x51 & ~x56;
  assign new_n350_ = ~x47 & ~x46 & ~x45 & new_n351_ & ~x43 & ~x50;
  assign new_n351_ = ~x41 & ~x40 & ~x39 & new_n352_ & ~x37 & ~x42;
  assign new_n352_ = ~x34 & ~x33 & ~x31 & new_n353_ & ~x30 & ~x35;
  assign new_n353_ = ~x28 & ~x26 & ~x25 & new_n354_ & ~x24 & x29;
  assign new_n354_ = ~x18 & ~x17 & ~x15 & new_n355_ & ~x14 & ~x22;
  assign new_n355_ = ~x10 & ~x09 & ~x08 & new_n356_ & ~x07 & ~x11;
  assign new_n356_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n358_ & ~x59;
  assign new_n358_ = ~x56 & ~x55 & ~x51 & new_n359_ & ~x50 & ~x58;
  assign new_n359_ = ~x46 & ~x43 & ~x42 & new_n360_ & ~x41 & ~x47;
  assign new_n360_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n328_ & x34;
  assign z46 = ~x62 & new_n362_ & ~x61;
  assign new_n362_ = ~x59 & ~x58 & ~x56 & new_n363_ & ~x55 & ~x60;
  assign new_n363_ = ~x50 & ~x47 & ~x46 & new_n364_ & ~x43 & ~x51;
  assign new_n364_ = ~x41 & ~x40 & ~x39 & new_n365_ & ~x37 & ~x42;
  assign new_n365_ = ~x35 & ~x30 & x29 & ~x28 & new_n366_ & ~x26;
  assign new_n366_ = ~x24 & ~x22 & ~x18 & new_n367_ & ~x17 & ~x25;
  assign new_n367_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n319_ & x09;
  assign z47 = ~x62 & new_n369_ & ~x61;
  assign new_n369_ = ~x59 & ~x58 & ~x56 & new_n370_ & ~x55 & ~x60;
  assign new_n370_ = ~x50 & ~x47 & ~x46 & new_n371_ & ~x43 & ~x51;
  assign new_n371_ = ~x41 & ~x40 & ~x39 & new_n372_ & ~x37 & ~x42;
  assign new_n372_ = ~x35 & ~x30 & x29 & ~x28 & new_n373_ & ~x26;
  assign new_n373_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n318_ & x17;
  assign z48 = ~x62 & ~x61 & new_n375_ & ~x60;
  assign new_n375_ = ~x58 & ~x56 & ~x55 & new_n376_ & ~x54 & ~x59;
  assign new_n376_ = ~x51 & ~x50 & ~x47 & new_n377_ & ~x46 & ~x53;
  assign new_n377_ = ~x42 & ~x41 & ~x40 & new_n378_ & ~x39 & ~x43;
  assign new_n378_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n328_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n380_ & ~x59;
  assign new_n380_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n325_ & x53;
  assign z50 = new_n382_ & ~x62;
  assign new_n382_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n204_ & x57;
  assign z51 = ~x62 & ~x61 & new_n384_ & ~x60;
  assign new_n384_ = ~x58 & ~x56 & ~x55 & new_n385_ & ~x54 & ~x59;
  assign new_n385_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n206_ & x48;
  assign z52 = new_n387_ & ~x64;
  assign new_n387_ = ~x62 & ~x61 & ~x60 & new_n388_ & ~x59 & ~x63;
  assign new_n388_ = ~x57 & ~x56 & ~x55 & new_n389_ & ~x54 & ~x58;
  assign new_n389_ = ~x51 & ~x50 & ~x49 & new_n390_ & ~x48 & ~x53;
  ...
  assign new_n394_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n211_ & x12;
  assign z53 = ~x64 & new_n202_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n301_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n398_ & ~x56;
  assign new_n398_ = ~x50 & ~x47 & ~x46 & new_n399_ & ~x43 & ~x51;
  assign new_n399_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n215_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n401_ & ~x60 & ~x64;
  assign new_n401_ = ~x58 & ~x57 & ~x56 & new_n402_ & ~x55 & ~x59;
  assign new_n402_ = ~x53 & ~x52 & ~x51 & new_n403_ & ~x50 & ~x54;
  assign new_n403_ = ~x48 & ~x47 & ~x46 & new_n404_ & ~x45 & ~x49;
  assign new_n404_ = ~x42 & ~x41 & ~x40 & new_n405_ & ~x39 & ~x43;
  assign new_n405_ = ~x36 & ~x35 & ~x34 & new_n406_ & ~x33 & ~x37;
  assign new_n406_ = ~x31 & ~x30 & x29 & ~x28 & new_n407_ & ~x26;
  assign new_n407_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n408_ & x20;
  assign new_n408_ = ~x17 & ~x16 & ~x15 & new_n234_ & ~x14 & ~x18;
  ...
  assign z61 = ~x60 & ~x58 & ~x56 & new_n421_ & ~x50;
  assign new_n421_ = ~x46 & ~x43 & ~x40 & new_n422_ & ~x39 & ~x47;
  assign new_n422_ = ~x37 & ~x30 & x29 & ~x28 & new_n423_ & ~x25;
  assign new_n423_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n425_ & x47;
  assign new_n425_ = new_n426_ & ~x46;
  assign new_n426_ = ~x40 & ~x39 & ~x37 & new_n427_ & ~x30 & ~x43;
  assign new_n427_ = x29 & new_n428_ & ~x28;
  assign new_n428_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n425_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n431_ & ~x46;
  assign new_n431_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n427_ & x30;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z25 = 1'b0;
  assign z60 = 1'b0;
