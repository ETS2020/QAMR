// Benchmark "FAU" written by ABC on Thu Aug  6 17:02:05 2020
...
module FAU ( 
  ...
  assign new_n117_ = (x34 | (~new_n125_ & (new_n118_ | ~x36))) & (~new_n126_ | ~x34 | x35 | x36);
  assign new_n118_ = (new_n119_ | x35) & (~new_n124_ | ~new_n123_ | ~x35 | ~x37);
  assign new_n119_ = (~x38 | (~new_n120_ & (~x37 | x39 | x40))) & (x37 | x38 | (~new_n122_ & x39));
  assign new_n120_ = x00 & new_n121_ & ~x01;
  assign new_n121_ = ~x02 & ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n122_ = ~x11 & ~x12 & x40;
  assign new_n123_ = ~x38 & ~x39 & ~x40;
  assign new_n124_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n125_ = x38 & ~x39 & x40 & x35 & ~x36 & x37;
  assign new_n126_ = x37 & x38 & x39 & ~x40;
  assign z21 = ~x33 | (~x07 & ((~new_n128_ & ~x34) | (~new_n134_ & ~x35)));
  assign new_n128_ = (~x36 | ((new_n129_ | ~x35) & ~new_n131_ & ~x32)) & (~x35 | (~new_n133_ & ~x32));
  assign new_n129_ = (~x37 | (~new_n130_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n130_ = ~x00 & (new_n123_ | (~x05 & x38));
  assign new_n131_ = new_n132_ & ~x00;
  assign new_n132_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n133_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n134_ = (~x34 | new_n135_ | x36) & (~new_n123_ | ~x32 | ~x36 | x37);
  assign new_n135_ = new_n136_ & (x00 | x05 | x37 | new_n107_ | x38);
  assign new_n136_ = ~x32 & (~new_n107_ | ~x38 | x06 | ~x37);
  assign z26 = ~x07 & ~x32 & x33 & (new_n138_ | (new_n142_ & x00));
  assign new_n138_ = ~x35 & (new_n139_ | (new_n123_ & x34 & x36 & ~x37));
  assign new_n139_ = ~new_n140_ & (x01 | x02 | x03 | x04);
  assign new_n140_ = (new_n141_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n141_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n142_ = ~x34 & x35 & x36 & x37 & new_n143_ & ~x38;
  assign new_n143_ = ~x39 & ~x40 & (~x01 | x02 | x03 | ~x04);
  assign z32 = ~x40 & ~x39 & x38 & new_n145_ & x37;
  assign new_n145_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
