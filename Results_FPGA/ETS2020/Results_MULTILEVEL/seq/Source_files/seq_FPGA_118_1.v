// Benchmark "FAU" written by ABC on Thu Aug  6 16:58:49 2020
...
module FAU ( 
  ...
  assign z15 = x07 & x33;
  assign z16 = ~x07 & ~x32 & ~new_n150_ & x33;
  assign new_n150_ = (x34 | (~new_n157_ & (new_n151_ | ~x36))) & (~new_n158_ | ~x34 | x35 | x36);
  assign new_n151_ = (new_n152_ | x35) & (~new_n156_ | ~new_n131_ | ~x35 | ~x37);
  assign new_n152_ = (~x38 | (~new_n153_ & (~x37 | x39 | x40))) & (x37 | x38 | (~new_n155_ & x39));
  assign new_n153_ = x00 & new_n154_ & ~x01;
  assign new_n154_ = ~x02 & ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n155_ = ~x11 & ~x12 & x40;
  ...
  assign new_n162_ = ~x00 & (new_n131_ | (~x05 & x38));
  assign new_n163_ = new_n164_ & ~x00;
  assign new_n164_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n165_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n166_ = (~x34 | new_n167_ | x36) & (~new_n131_ | ~x32 | ~x36 | x37);
  assign new_n167_ = new_n168_ & (x00 | x05 | x37 | new_n139_ | x38);
  assign new_n168_ = ~x32 & (x06 | ~x37 | ~new_n139_ | ~x38);
  assign z26 = ~x07 & ~x32 & x33 & (new_n170_ | (new_n174_ & x00));
  assign new_n170_ = ~x35 & (new_n171_ | (new_n131_ & x34 & x36 & ~x37));
