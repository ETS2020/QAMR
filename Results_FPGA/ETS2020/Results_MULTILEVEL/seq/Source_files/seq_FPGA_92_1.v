// Benchmark "FAU" written by ABC on Thu Aug  6 16:57:56 2020
...
module FAU ( 
  ...
  assign z16 = ~x07 & ~x32 & x33 & (new_n169_ | new_n177_);
  assign new_n169_ = ~x34 & ((~new_n170_ & x36) | (new_n121_ & x35 & ~x36 & x37));
  assign new_n170_ = (new_n171_ | x35) & (~new_n176_ | ~new_n175_ | ~x35 | ~x37);
  assign new_n171_ = (~x38 | (~new_n172_ & (~x37 | x39 | x40))) & (x37 | x38 | (~new_n174_ & x39));
  assign new_n172_ = x00 & new_n173_ & ~x01;
  assign new_n173_ = ~x02 & ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n174_ = ~x11 & ~x12 & x40;
  assign new_n175_ = ~x38 & ~x39 & ~x40;
  assign new_n176_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n177_ = new_n178_ & x34 & ~x35 & ~x36;
  assign new_n178_ = x37 & x38 & x39 & ~x40;
  assign z21 = ~x33 | (~x07 & ((~new_n180_ & ~x34) | (~new_n186_ & ~x35)));
  assign new_n180_ = (~x36 | ((new_n181_ | ~x35) & ~new_n183_ & ~x32)) & (~x35 | (~new_n185_ & ~x32));
  assign new_n181_ = (~x37 | (~new_n182_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n182_ = ~x00 & (new_n175_ | (~x05 & x38));
  assign new_n183_ = new_n184_ & ~x00;
  assign new_n184_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n185_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n186_ = (~x34 | new_n187_ | x36) & (~new_n175_ | ~x32 | ~x36 | x37);
  assign new_n187_ = new_n188_ & (x00 | x05 | x37 | new_n89_ | x38);
  assign new_n188_ = ~x32 & (x06 | ~x37 | ~new_n89_ | ~x38);
  assign z26 = ~x07 & ~x32 & ~new_n190_ & x33;
  assign new_n190_ = (new_n191_ | x35) & (~x00 | x34 | ~x35 | ~new_n126_ | ~x36);
  assign new_n191_ = (new_n192_ | new_n85_) & (~new_n175_ | ~x34 | ~x36 | x37);
  assign new_n192_ = (new_n193_ | ~x38) & (~x37 | x38 | x39 | ~x34 | x36);
  assign new_n193_ = (x37 | ~x39 | ~x34 | x36) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign z32 = ~x40 & ~x39 & x38 & new_n195_ & x37;
  assign new_n195_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
