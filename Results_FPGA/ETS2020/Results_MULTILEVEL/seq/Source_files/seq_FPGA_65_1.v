// Benchmark "FAU" written by ABC on Thu Aug  6 16:57:00 2020
...
module FAU ( 
  ...
  assign z14 = ~new_n115_ & x33;
  assign new_n115_ = ~x07 & (x32 | x34 | ~x35 | new_n116_ | x37);
  assign new_n116_ = (x07 | x36 | (x38 ? (x39 | x40) : (~x39 | ~x40))) & (x38 | x39 | ~x13 | ~x36);
  ...
  assign z25 = ~x07 & ~x32 & ~new_n139_ & x33;
  assign new_n139_ = x36 ? new_n162_ : ((new_n140_ | x38) & (~new_n152_ | x05));
  assign new_n140_ = (~new_n141_ | x05) & (x35 | (~new_n149_ & (x05 | ~new_n144_ | x31)));
  assign new_n141_ = x15 & ~x34 & x35 & ~x39 & ~new_n142_ & ~new_n83_;
  assign new_n142_ = (x37 | (x24 & (~x24 | x40 | (x22 & (x21 | ~x22))))) & (~x40 | (x24 & (~x37 | ((new_n143_ | x21) & (x22 | ~x24)))));
  assign new_n143_ = (~x22 | x23 | ~x24 | ((~x18 | ~x19) & (~x09 | (~x18 & ~x19)))) & (x18 | x19) & (x09 | (x18 & x19));
  assign new_n144_ = ~x34 & (new_n148_ | (x37 & (new_n145_ | (new_n147_ & x15))));
  assign new_n145_ = x39 & ~new_n146_ & ~x40;
  assign new_n146_ = x28 ? (x29 | x30) : (~x29 | ~x30);
  assign new_n147_ = ~x39 & ~new_n83_ & ((~x16 & ~x17) | (~x09 & (~x16 | ~x17)));
  assign new_n148_ = ~x09 & x15 & ~x16 & ~new_n83_ & x40;
  assign new_n149_ = x34 & ((new_n151_ & x00) | (~x05 & new_n150_ & x15));
  assign new_n150_ = x37 & x39 & x40 & ~new_n83_ & (~x22 | (~x21 & x22));
  assign new_n151_ = ~x01 & x02 & ~x03 & x04 & ~new_n108_ & ~x37;
  assign new_n152_ = ~x34 & ((new_n153_ & x15) | (~x31 & new_n161_ & ~x35));
  assign new_n153_ = ~new_n83_ & (new_n159_ | (x38 & (new_n160_ | (~new_n154_ & ~x37))));
  assign new_n154_ = (x09 | (~new_n155_ & ~new_n156_)) & (~x39 | (~new_n157_ & ~new_n158_));
  assign new_n155_ = ~x18 & ~x21 & x35 & x39;
  assign new_n156_ = ~x16 & ~x31 & ~x35 & ~x40;
  assign new_n157_ = ~x16 & ~x17 & ~x31 & ~x35 & x40;
  assign new_n158_ = x35 & (~x24 | (x24 & (~x22 | (x22 & ~x40 & (~x21 | (x21 & ~x23))))));
  assign new_n159_ = ~x09 & ~x16 & ~x31 & ~x35 & ~x37 & x39;
  assign new_n160_ = ~x09 & ~x17 & ~x31 & ~x35 & x39;
  assign new_n161_ = x38 & ((~x39 & ~new_n146_ & x40) | (~x09 & x39 & (x37 | ~x40)));
  assign new_n162_ = (~new_n124_ | ~x34 | x35 | x37) & (x34 | (~new_n165_ & (~x35 | new_n163_ | ~x37)));
  assign new_n163_ = (x38 | ~x39 | x40) & (~new_n164_ | x03 | ~x04 | ~x38);
  assign new_n164_ = x00 & ~x01 & x02;
  assign new_n165_ = new_n166_ & x10 & x27 & ~x35;
  assign new_n166_ = ~x37 & x38 & ~x39 & ~x40;
  assign z26 = ~x07 & ~x32 & x33 & (new_n168_ | (new_n172_ & x00));
  assign new_n168_ = ~x35 & (new_n169_ | (new_n124_ & x34 & x36 & ~x37));
  assign new_n169_ = ~new_n170_ & (x01 | x02 | x03 | x04);
  assign new_n170_ = (new_n171_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n171_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n172_ = ~x34 & x35 & x36 & x37 & new_n173_ & ~x38;
  assign new_n173_ = ~x39 & ~x40 & (~x01 | x02 | x03 | ~x04);
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
