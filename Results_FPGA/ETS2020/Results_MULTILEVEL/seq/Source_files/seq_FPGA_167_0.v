// Benchmark "FAU" written by ABC on Thu Aug  6 17:00:30 2020
...
module FAU ( 
  ...
  assign new_n599_ = (~x15 | ~x22 | ~x24 | new_n600_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n600_ = ~x21 & (x21 | new_n174_ | ~x23);
  ...
  assign new_n603_ = ~new_n92_ & ((x38 & ~new_n510_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n604_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n605_ = (~new_n606_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n606_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n112_ & x01 & ~x38));
  assign new_n607_ = (new_n616_ | ~x36) & (x05 | x31 | new_n608_ | x36);
  assign new_n608_ = ~new_n320_ & ~new_n609_ & new_n615_ & (x37 | (~new_n612_ & ~new_n613_));
  assign new_n609_ = x15 & ((~new_n610_ & x09) | (x16 & new_n152_ & x17));
  assign new_n610_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n611_ | ~x39);
  assign new_n611_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n612_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n613_ = x39 & (new_n614_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n614_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n615_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n616_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n288_ | ~x40)))));
  ...
  assign new_n621_ = ~new_n633_ & ~new_n622_ & (x36 | (~new_n642_ & (new_n639_ | x35)));
  ...
  assign new_n625_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  assign new_n626_ = x11 & x12 & x14 & ~new_n145_ & x40;
  ...
  assign new_n644_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n403_ | ~new_n529_) & (x00 | ~x05)));
