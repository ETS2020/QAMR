// Benchmark "FAU" written by ABC on Thu Aug  6 17:02:11 2020
...
module FAU ( 
  ...
  assign new_n606_ = ~new_n92_ & ((x38 & ~new_n511_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  ...
  assign new_n621_ = ~new_n622_ & (x01 | x02 | new_n429_ | x03);
  ...
  assign new_n626_ = (x35 | (x36 ? new_n403_ : new_n627_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n639_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n440_ & ~x38));
  ...
  assign new_n647_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n404_ | ~new_n530_) & (x00 | ~x05)));
