...
module FAU ( 
  ...
  assign z15 = x07 & x33;
  assign z16 = ~x07 & ~x32 & ~new_n144_ & x33;
  assign new_n144_ = (x34 | (~new_n152_ & (new_n145_ | ~x36))) & (~new_n153_ | ~x34 | x35 | x36);
  assign new_n145_ = (new_n146_ | x35) & (~new_n151_ | ~new_n150_ | ~x35 | ~x37);
  assign new_n146_ = (~x38 | (~new_n147_ & (~x37 | x39 | x40))) & (x37 | x38 | (~new_n149_ & x39));
  assign new_n147_ = x00 & new_n148_ & ~x01;
  assign new_n148_ = ~x02 & ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n149_ = ~x11 & ~x12 & x40;
  ...
  assign new_n157_ = ~x00 & (new_n150_ | (~x05 & x38));
  assign new_n158_ = new_n159_ & ~x00;
  assign new_n159_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n160_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n161_ = (~x34 | new_n162_ | x36) & (~new_n150_ | ~x32 | ~x36 | x37);
  assign new_n162_ = new_n163_ & (x00 | x05 | x37 | new_n136_ | x38);
  assign new_n163_ = ~x32 & (~new_n136_ | ~x38 | x06 | ~x37);
  assign z26 = ~x07 & ~x32 & x33 & (new_n165_ | (new_n169_ & x00));
  assign new_n165_ = ~x35 & (new_n166_ | (new_n150_ & x34 & x36 & ~x37));
