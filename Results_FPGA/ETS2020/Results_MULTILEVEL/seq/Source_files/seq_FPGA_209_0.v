// Benchmark "FAU" written by ABC on Thu Aug  6 17:01:57 2020
...
module FAU ( 
  ...
  assign new_n603_ = ~new_n92_ & ((x38 & ~new_n508_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  ...
  assign new_n618_ = ~new_n619_ & (x01 | x02 | new_n426_ | x03);
  ...
  assign new_n623_ = (x35 | (x36 ? new_n400_ : new_n624_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n636_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n437_ & ~x38));
  ...
  assign new_n644_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n401_ | ~new_n527_) & (x00 | ~x05)));
