...
module FAU ( 
  ...
  assign z15 = x07 & x33;
  assign z16 = ~x07 & ~x32 & x33 & (new_n120_ | new_n128_);
  ...
  assign new_n128_ = x34 & ~x35 & ~x36 & new_n129_ & x37 & x38;
  ...
  assign new_n136_ = new_n129_ & x38 & ~x00 & ~x05 & x37;
  assign new_n137_ = (~x34 | new_n138_ | x36) & (~new_n126_ | ~x32 | ~x36 | x37);
  assign new_n138_ = new_n139_ & (x00 | x05 | x37 | new_n109_ | x38);
  assign new_n139_ = ~x32 & (~new_n109_ | ~x38 | x06 | ~x37);
  ...
  assign z27 = ~x07 & ~x32 & x33 & (new_n160_ | (new_n148_ & ~x05));
  assign new_n148_ = ~x36 & ((new_n149_ & x15) | (~x09 & new_n159_ & ~x31));
  assign new_n149_ = ~new_n83_ & (x34 ? (new_n158_ & ~x35) : (new_n155_ | (~new_n150_ & x35)));
  assign new_n150_ = (x37 | ~x38 | new_n151_ | ~x39) & (x38 | new_n153_ | x39);
  assign new_n151_ = (x21 | (~new_n152_ & (~x22 | ~x24 | x40))) & x24 & (~x24 | (x22 & (~x21 | ~x22 | x23 | x40)));
  assign new_n152_ = ~x09 & ~x18;
  assign new_n153_ = (x37 | (x24 & (~x24 | x40 | (x22 & (x21 | ~x22))))) & (~x40 | (x24 & (~x37 | ((new_n154_ | x21) & (x22 | ~x24)))));
  assign new_n154_ = (~x22 | x23 | ~x24 | ((~x18 | ~x19) & (~x09 | (~x18 & ~x19)))) & (x18 | x19) & (x09 | (x18 & x19));
  assign new_n155_ = ~x31 & ~x35 & (new_n157_ | (~new_n156_ & ~x16));
  assign new_n156_ = (x17 | ((~x37 | x38 | x39) & (~x39 | ~x40 | x37 | ~x38))) & (x09 | ((x38 | (~x40 & (~x37 | x39))) & (x37 | (~x39 & (~x38 | x40)))));
  assign new_n157_ = ~x09 & ~x17 & ((x38 & x39) | (x37 & ~x38 & ~x39));
  assign new_n158_ = x37 & ~x38 & x39 & x40 & (~x22 | (~x21 & x22));
  assign new_n159_ = ~x34 & ~x35 & x38 & x39 & (x37 | ~x40);
  assign new_n160_ = new_n129_ & x37 & ~x38 & ~x34 & x35 & x36;
