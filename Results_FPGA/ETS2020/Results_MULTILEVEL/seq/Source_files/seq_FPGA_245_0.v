// Benchmark "FAU" written by ABC on Thu Aug  6 17:03:11 2020
...
module FAU ( 
  ...
  assign new_n393_ = x11 & x12 & x14 & x15 & ~new_n145_ & ~x39;
  assign new_n394_ = ~x39 & (x39 | (x40 & (x05 | ~new_n395_ | ~x15)));
  assign new_n395_ = x21 & x22 & x24 & ~new_n92_ & x40;
  assign new_n396_ = ~x39 & ((new_n397_ & x15) | (new_n158_ & ~x13));
  ...
  assign new_n403_ = x12 & x14 & x15 & ~x37 & ~new_n145_ & x39;
  ...
  assign new_n436_ = ~x31 & ~x34 & (new_n158_ | (new_n437_ & x37));
  assign new_n437_ = ~x39 & ((x15 & ~new_n145_ & ~new_n154_) | new_n92_ | ~x15);
  ...
  assign new_n441_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n442_ = ~new_n149_ & new_n443_ & ~new_n205_ & new_n102_;
  ...
  assign new_n467_ = ~new_n149_ & (~x38 | (~x37 & x39)) & new_n468_ & (~x39 | (x38 & x40));
  ...
  assign new_n504_ = ~x37 & x39 & ~new_n145_ & x40;
  ...
  assign new_n515_ = x05 ? (new_n519_ & ~new_n149_) : (~new_n516_ & (~x31 | (new_n518_ & ~new_n149_)));
  assign new_n516_ = x39 & (x31 ? (x37 | ~x40) : (~new_n517_ & ~x37));
  assign new_n517_ = ~new_n491_ & ~new_n158_ & (~x09 | ~x13 | x15);
  ...
  assign new_n548_ = new_n112_ & new_n153_ & x10 & x27 & ~x35;
  ...
  assign z27 = ~x07 & ~x32 & x33 & (new_n564_ | (new_n555_ & ~x05));
  assign new_n555_ = ~x36 & (new_n556_ | (~x09 & ~x31 & new_n563_ & ~x34));
  assign new_n556_ = x15 & ~new_n92_ & (new_n561_ | (~new_n557_ & ~x34));
  ...
  assign new_n560_ = (x17 | ((~x37 | x38 | x39) & (~x39 | ~x40 | x37 | ~x38))) & (x09 | ((x38 | (~x40 & (~x37 | x39))) & (x37 | (~x39 & (~x38 | x40)))));
  assign new_n561_ = x34 & new_n562_ & ~x35;
  assign new_n562_ = x37 & ~x38 & x39 & x40 & (~x22 | (~x21 & x22));
  assign new_n563_ = ~x35 & x38 & x39 & (x37 | ~x40);
  assign new_n564_ = new_n198_ & ~x34 & x35 & x36;
  assign z28 = ~x07 & ~x32 & x33 & (new_n566_ | new_n568_);
  assign new_n566_ = x00 & ~x01 & x02 & ~x03 & ~new_n567_ & x04;
  assign new_n567_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n87_ | x38);
  assign new_n568_ = new_n138_ & ~x34 & ~x35 & new_n111_ & x36 & ~x37;
  assign z29 = ~x07 & ~x32 & x33 & (new_n564_ | (new_n570_ & ~x05));
  assign new_n570_ = ~x36 & ((~new_n571_ & ~x34) | (x15 & new_n324_ & ~x21));
  assign new_n571_ = (x31 | ~new_n575_ | x35) & (x40 | (~new_n572_ & (x31 | ~new_n574_ | x35)));
  assign new_n572_ = x15 & ~x21 & x22 & new_n573_ & x24;
  assign new_n573_ = x35 & ~x37 & ~new_n92_ & (~x38 ^ x39);
  assign new_n574_ = x37 & ~x38 & ~new_n90_ & x39;
  assign new_n575_ = x38 & ~x39 & ~new_n90_ & x40;
  assign z30 = ~x07 & ~x32 & x33 & (new_n577_ | new_n568_);
  assign new_n577_ = ~x05 & x15 & ~x36 & ~new_n578_ & ~new_n92_;
  assign new_n578_ = ~new_n561_ & (~x24 | x34 | new_n579_ | ~x35);
  assign new_n579_ = x22 ? new_n580_ : ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))));
  assign new_n580_ = (new_n581_ | x21) & (~new_n125_ | ~x38 | ~x21 | x23 | x37);
  assign new_n581_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n174_ | ~x40)));
  assign z31 = ~x07 & ~x32 & x33 & (new_n591_ | (~new_n583_ & ~x34));
  assign new_n583_ = (new_n584_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  assign new_n584_ = ~new_n589_ & (x05 | ~new_n585_ | ~x15);
  assign new_n585_ = ~x36 & ~new_n92_ & ((new_n586_ & ~x38) | (~x37 & new_n588_ & x38));
  assign new_n586_ = ~x39 & ((~x24 & ~x37) | (x40 & (new_n587_ | ~x24)));
  assign new_n587_ = ~x21 & x22 & ~x23 & x24 & ~new_n174_ & x37;
  assign new_n588_ = x39 & (~x24 | (x21 & x22 & ~x23 & x24 & ~x40));
  assign new_n589_ = new_n590_ & x00 & ~x01 & x02 & ~x03;
  ...
  assign new_n601_ = ~new_n92_ & ((x38 & ~new_n508_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  ...
  assign new_n606_ = ~new_n320_ & ~new_n607_ & new_n613_ & (x37 | (~new_n610_ & ~new_n611_));
  assign new_n607_ = x15 & ((~new_n608_ & x09) | (x16 & new_n152_ & x17));
  assign new_n608_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n609_ | ~x39);
  ...
  assign new_n616_ = ~new_n617_ & (x01 | x02 | new_n426_ | x03);
  assign new_n617_ = x39 & x40 & (~x37 | (~x05 & ~new_n312_ & x37));
  ...
  assign new_n621_ = (x35 | (x36 ? new_n400_ : new_n622_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n622_ = ~new_n625_ & (~x15 | (~new_n624_ & (x05 | new_n623_ | x31)));
  assign new_n623_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  assign new_n624_ = x11 & x12 & x14 & ~new_n145_ & x40;
  ...
  assign new_n632_ = x00 ? (~new_n633_ | x01) : (~x05 | (~new_n127_ & ~x35));
  assign new_n633_ = ~x02 & ~x03 & ((x04 & x35) | (new_n127_ & ~x04 & ~x35));
  assign new_n634_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n437_ & ~x38));
  assign new_n635_ = ~x39 & (x35 ? (new_n636_ | (x06 & x40)) : ~x40);
  assign new_n636_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n637_ = x05 ? (new_n638_ & ~new_n149_) : ~new_n639_;
  assign new_n638_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  ...
  assign new_n642_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n401_ | ~new_n527_) & (x00 | ~x05)));
