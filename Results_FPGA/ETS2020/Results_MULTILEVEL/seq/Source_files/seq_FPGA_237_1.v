...
module FAU ( 
  ...
  assign z16 = ~x07 & ~x32 & ~new_n116_ & x33;
  assign new_n116_ = (x34 | (~new_n124_ & (new_n117_ | ~x36))) & (~new_n125_ | ~x34 | x35 | x36);
  assign new_n117_ = (new_n118_ | x35) & (~new_n123_ | ~new_n122_ | ~x35 | ~x37);
  assign new_n118_ = (~x38 | (~new_n119_ & (~x37 | x39 | x40))) & (x37 | x38 | (~new_n121_ & x39));
  assign new_n119_ = x00 & new_n120_ & ~x01;
  assign new_n120_ = ~x02 & ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n121_ = ~x11 & ~x12 & x40;
  assign new_n122_ = ~x38 & ~x39 & ~x40;
  assign new_n123_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n124_ = x38 & ~x39 & x40 & x35 & ~x36 & x37;
  assign new_n125_ = x37 & x38 & x39 & ~x40;
  assign z21 = ~x33 | (~x07 & ((~new_n127_ & ~x34) | (~new_n133_ & ~x35)));
  assign new_n127_ = (~x36 | ((new_n128_ | ~x35) & ~new_n130_ & ~x32)) & (~x35 | (~new_n132_ & ~x32));
  assign new_n128_ = (~x37 | (~new_n129_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n129_ = ~x00 & (new_n122_ | (~x05 & x38));
  assign new_n130_ = new_n131_ & ~x00;
  assign new_n131_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n132_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n133_ = (~x34 | new_n134_ | x36) & (~new_n122_ | ~x32 | ~x36 | x37);
  assign new_n134_ = new_n135_ & (x00 | x05 | x37 | new_n107_ | x38);
  assign new_n135_ = ~x32 & (~new_n107_ | ~x38 | x06 | ~x37);
  assign z26 = ~x07 & ~x32 & x33 & (new_n137_ | (new_n141_ & x00));
  assign new_n137_ = ~x35 & (new_n138_ | (new_n122_ & x34 & x36 & ~x37));
  assign new_n138_ = ~new_n139_ & (x01 | x02 | x03 | x04);
  assign new_n139_ = (new_n140_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n140_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n141_ = ~x34 & x35 & x36 & x37 & new_n142_ & ~x38;
  assign new_n142_ = ~x39 & ~x40 & (~x01 | x02 | x03 | ~x04);
  assign z32 = ~x40 & ~x39 & x38 & new_n144_ & x37;
  assign new_n144_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
