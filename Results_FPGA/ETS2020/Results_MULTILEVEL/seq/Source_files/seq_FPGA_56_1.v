...
module FAU ( 
  ...
  assign z14 = ~new_n114_ & x33;
  assign new_n114_ = ~x07 & (x32 | x34 | ~x35 | new_n115_ | x37);
  assign new_n115_ = (x07 | x36 | (x38 ? (x39 | x40) : (~x39 | ~x40))) & (x38 | x39 | ~x13 | ~x36);
  assign z15 = x07 & x33;
  ...
  assign new_n136_ = new_n137_ & (x00 | x05 | x37 | new_n107_ | x38);
  assign new_n137_ = ~x32 & (~new_n107_ | ~x38 | x06 | ~x37);
  assign z26 = ~x07 & ~x32 & x33 & (new_n139_ | (new_n143_ & x00));
  assign new_n139_ = ~x35 & (new_n140_ | (new_n124_ & x34 & x36 & ~x37));
  assign new_n140_ = ~new_n141_ & (x01 | x02 | x03 | x04);
  assign new_n141_ = (new_n142_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n142_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n143_ = ~x34 & x35 & x36 & x37 & new_n144_ & ~x38;
  assign new_n144_ = ~x39 & ~x40 & (~x01 | x02 | x03 | ~x04);
  assign z32 = ~x40 & ~x39 & x38 & new_n146_ & x37;
  assign new_n146_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
