// Benchmark "FAU" written by ABC on Thu Aug  6 16:56:48 2020
...
module FAU ( 
  ...
  assign new_n368_ = x34 & ~x35 & ~x36 & new_n125_ & x37 & x38;
  assign z17 = x33 & (x07 | (~x07 & ~new_n370_ & ~x32));
  assign new_n370_ = (x34 | new_n386_ | ~x36) & (x36 | (~new_n371_ & ~new_n378_ & ~new_n390_));
  assign new_n371_ = ~x38 & ((new_n377_ & ~x05) | (~x35 & (new_n372_ | new_n373_)));
  assign new_n372_ = ~x05 & ~x31 & ~new_n88_ & ~x34;
  ...
  assign new_n377_ = x15 & ~x34 & x35 & ~x39 & ~new_n212_ & ~new_n92_;
  assign new_n378_ = ~x05 & ~x34 & (new_n379_ | (~x31 & new_n114_ & ~x35));
  assign new_n379_ = x15 & ~new_n92_ & (new_n385_ | (x38 & (new_n380_ | new_n384_)));
  ...
  assign new_n386_ = (new_n389_ | x40) & (~x00 | (~new_n130_ & (new_n387_ | ~x38)));
  assign new_n387_ = ~new_n388_ & (x35 | ~x40 | new_n123_ | (x37 ^ ~x39));
  assign new_n388_ = ~x01 & x02 & ~x03 & x04 & x35 & x37;
  ...
  assign z19 = ~x07 & ~x32 & x33 & (x38 ? ~new_n431_ : ~new_n427_);
  ...
  assign new_n432_ = (~new_n404_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n112_ | x36 | x37);
  ...
  assign new_n437_ = (~new_n438_ | x05) & (x00 | new_n87_ | ~x05);
  assign new_n438_ = ~x34 & (x31 | (~x31 & ~new_n86_ & x39));
  assign new_n439_ = ~x31 & ~x34 & (new_n158_ | (new_n440_ & x37));
  assign new_n440_ = ~x39 & ((x15 & ~new_n145_ & ~new_n154_) | new_n92_ | ~x15);
  assign new_n441_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n86_ & x40));
  assign new_n442_ = (new_n447_ | ~x37) & (new_n445_ | ~x05) & (x05 | (x31 ? new_n445_ : (new_n443_ | x37)));
  assign new_n443_ = (~x39 | (~new_n305_ & (~x40 | (~new_n444_ & new_n86_)))) & (~x38 | x39 | new_n86_ | x40);
  assign new_n444_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n445_ = ~new_n149_ & new_n446_ & ~new_n205_ & new_n102_;
  assign new_n446_ = x14 & x15 & (~x39 | x40) & (~x38 | x39);
  assign new_n447_ = x05 ? ~x38 : (~x31 | ~x39);
  assign new_n448_ = (new_n449_ | (~x05 & (x05 | new_n86_ | ~x13))) & (x05 | new_n86_ | new_n450_);
  assign new_n449_ = ~new_n121_ & (~new_n127_ | x38);
  ...
  assign new_n456_ = ~x37 & ~x38 & x39 & x11 & ~x35;
  assign z21 = ~x33 | (~x07 & ((~new_n458_ & ~x34) | (~new_n464_ & ~x35)));
  assign new_n458_ = (~x36 | (~new_n461_ & ~x32 & (new_n459_ | ~x35))) & (~x35 | (~new_n463_ & ~x32));
  assign new_n459_ = (~x37 | (~new_n460_ & (x06 | x38 | x39 | ~x40))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n460_ = ~x00 & (x38 ? ~x05 : new_n112_);
  assign new_n461_ = new_n462_ & ~x00;
  assign new_n462_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n463_ = new_n125_ & x38 & ~x00 & ~x05 & x37;
  assign new_n464_ = (~x34 | new_n465_ | x36) & (~new_n297_ | ~x32 | ~x36 | x37);
  assign new_n465_ = new_n466_ & (x00 | x05 | x37 | new_n87_ | x38);
  assign new_n466_ = ~x32 & (~new_n87_ | ~x38 | x06 | ~x37);
  assign z22 = ~x07 & x33 & (new_n474_ | (~new_n468_ & ~x34));
  assign new_n468_ = (new_n469_ | x36) & (x00 | ~x05 | x32 | ~new_n473_ | ~x36);
  assign new_n469_ = (~x05 | new_n472_ | x32) & (x35 | (new_n422_ & (~x05 | new_n470_ | x32)));
  assign new_n470_ = ~new_n149_ & (~x38 | (~x37 & x39)) & new_n471_ & (~x39 | (x38 & x40));
  assign new_n471_ = new_n102_ & x14 & ~new_n205_ & x15;
  assign new_n472_ = (x37 | x38 | x39) & (~x39 | x40 | x00 | ~x38) & (~x35 | ((x37 | ~x38 | ~x39) & (x38 | x39 | ~x40)));
  assign new_n473_ = x38 & ((x37 & (x35 | (~x39 & x40))) | (x39 & x40 & ~x35 & ~x37));
  assign new_n474_ = x05 & ~x32 & new_n475_ & ~x35;
  assign new_n475_ = ~x36 & ~x38 & ((new_n87_ & x37) | (~x00 & ~new_n87_ & ~x37));
  assign z23 = x33 & (x07 | (~x07 & ~x32 & (new_n523_ | (~new_n477_ & ~x34))));
  assign new_n477_ = (new_n478_ | x38) & (new_n498_ | ~x38) & (x35 | new_n518_ | x36);
  assign new_n478_ = (new_n479_ | x39) & (x35 | (~new_n492_ & ~new_n496_)) & (~x35 | new_n497_ | ~x39);
  assign new_n479_ = x36 ? new_n489_ : (~new_n491_ & new_n487_ & (new_n480_ | ~x15));
  assign new_n480_ = (~new_n486_ | x05) & (~x37 | (~new_n485_ & (x05 | (~new_n481_ & ~new_n484_))));
  assign new_n481_ = ~new_n92_ & (new_n482_ | (x35 & ~new_n483_ & x40));
  assign new_n482_ = ~x31 & ~x35 & ((~x16 & ~x17) | (~x09 & (~x16 | ~x17)));
  assign new_n483_ = (x21 | ((x09 | (x18 & x19)) & (x18 | x19) & (~x22 | ~x24 | ((~x18 | ~x19) & (~x09 | (~x18 & ~x19)))))) & (~x24 | (x22 & (~x21 | ~x22)));
  assign new_n484_ = ~x31 & ~x35 & ((x11 & x12 & ~x14) | (~new_n145_ & (~x11 ^ ~x12)));
  assign new_n485_ = x11 & x12 & x14 & ~new_n145_ & ~x35;
  assign new_n486_ = x35 & ~new_n92_ & (~x37 | (~x24 & x40));
  assign new_n487_ = (~new_n488_ | x05) & (~x35 | ~x37 | x40);
  assign new_n488_ = ~new_n86_ & ((x37 & (x13 ? (~x31 & ~x35) : (x35 ? x40 : ~x31))) | (x35 & (x13 ? (~x37 | x40) : ~x37)));
  assign new_n489_ = x35 ? (x37 & (~x00 | ~x37 | new_n490_ | x40)) : (x37 & (~x37 | ~x40));
  assign new_n490_ = x01 & ~x02 & ~x03 & x04 & (x03 | ~x04 | ~x01 | x02);
  assign new_n491_ = x05 & (~x37 | (x35 & x40));
  assign new_n492_ = ~x36 & (x05 ? x39 : (x31 ? ~x37 : ~new_n493_));
  assign new_n493_ = (~x40 | (~new_n494_ & new_n86_)) & (~x39 | (x37 ? (new_n495_ | x40) : new_n86_));
  assign new_n494_ = ~x09 & x15 & ~new_n92_ & ~x16;
  assign new_n495_ = (~x28 | (~x30 & (x29 | x30))) & (~x29 | x30) & (x29 | ~x30) & (x28 | (x29 ^ x30));
  assign new_n496_ = x36 & ((x37 & x39 & ~x40) | (x40 & (x37 ? x39 : (x11 ? x39 : (~x12 | (x12 & x39))))));
  assign new_n497_ = x36 ? (x37 & (~x37 | x40)) : ~x37;
  assign new_n498_ = ~new_n517_ & (new_n508_ | ~x35) & (x35 | (x36 ? new_n514_ : new_n499_));
  assign new_n499_ = (~x05 | (~x37 & x39)) & ~new_n506_ & (x05 | (x31 ? x39 : new_n500_));
  assign new_n500_ = new_n504_ & (x37 | (~new_n503_ & (~x15 | (~new_n501_ & ~new_n502_))));
  assign new_n501_ = ~new_n203_ & x39;
  assign new_n502_ = ~x16 & ~new_n92_ & ((~x17 & x39 & x40) | (~x09 & ~x40));
  assign new_n503_ = ~x40 & ((~x39 & (new_n92_ | ~x15)) | (x09 & ~x13 & ~x15 & x39));
  assign new_n504_ = (x39 | new_n495_ | ~x40) & (x09 | ~x39 | (~new_n505_ & ~x37 & x40));
  assign new_n505_ = x15 & ~x17 & (x11 | x12);
  assign new_n506_ = x11 & x12 & x14 & new_n507_ & x15;
  assign new_n507_ = ~x37 & x39 & ~new_n145_ & x40;
  assign new_n508_ = x37 ? new_n512_ : (x39 ? (x36 ? x40 : new_n509_) : ~x40);
  assign new_n509_ = ~x05 & (x05 | (~new_n92_ & x15 & (~x15 | new_n92_ | (new_n105_ & (new_n510_ | ~x24)))));
  assign new_n510_ = x22 & (~x22 | (new_n511_ & (x40 | (x21 & (~x21 | x23)))));
  assign new_n511_ = x21 ? (~x23 & ~x40) : (~x40 | (~x09 & ~x18));
  assign new_n512_ = (~x00 | (~new_n513_ & (x36 | ~x39 | x40))) & (x36 | (x39 & (~x39 | ~x40))) & (x00 | ~x05 | ~x36);
  assign new_n513_ = ~x01 & x36 & (~x04 | (x02 & ~x03 & x04));
  assign new_n514_ = ((~new_n515_ & x40) | (x37 ^ ~x39)) & (~x39 | (~x37 & (~new_n454_ | x37 | ~x40))) & (x37 | x39 | (~x40 & (new_n516_ | x40)));
  assign new_n515_ = x00 & x40 & (x01 | x02 | x03 | x04 | (~x01 & ~x02 & ~x03 & ~x04));
  assign new_n516_ = x10 & x27 & (~x10 | ~x27);
  assign new_n517_ = ~x00 & x05 & ((~x36 & x39 & ~x40) | (x36 & x37 & ~x39 & x40));
  assign new_n518_ = x05 ? (new_n522_ & ~new_n149_) : (~new_n519_ & (~x31 | (new_n521_ & ~new_n149_)));
  assign new_n519_ = x39 & (x31 ? (x37 | ~x40) : (~new_n520_ & ~x37));
  assign new_n520_ = ~new_n494_ & ~new_n158_ & (~x09 | ~x13 | x15);
  assign new_n521_ = ~new_n205_ & x11 & x12 & x14 & x15;
  assign new_n522_ = x14 & ~new_n125_ & x15 & ~new_n205_ & new_n102_;
  assign new_n523_ = ~x35 & ((~new_n524_ & ~x36) | (new_n297_ & x34 & x36 & ~x37));
  assign new_n524_ = x38 ? new_n525_ : (x37 ? new_n531_ : (~new_n528_ & ~new_n532_));
  assign new_n525_ = ~new_n526_ & (~new_n527_ | x05 | ~x11 | ~x12 | x14);
  assign new_n526_ = x34 & (x37 ? (~x39 | (x39 & ~x40)) : (new_n189_ | ~x39 | (~new_n123_ & x39)));
  assign new_n527_ = x15 & ~x31 & new_n87_ & ~x37;
  assign new_n528_ = ~new_n87_ & (new_n454_ | (new_n529_ & new_n530_));
  assign new_n529_ = x00 & ~x01 & x02;
  assign new_n530_ = ~x03 & x04 & x34;
  assign new_n531_ = (~x05 | ~x39 | ~x40) & (~x34 | (x39 ? (x40 & (x05 | ~x40)) : new_n221_));
  assign new_n532_ = x34 & ((x39 & (x40 | (x00 & ~x01 & ~x04 & ~x40))) | (x00 & ~x01 & ~x04 & ~x39));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n544_ : ~new_n534_);
  assign new_n534_ = new_n535_ & (x38 | (~new_n541_ & (x35 | (~new_n372_ & ~new_n373_))));
  assign new_n535_ = ~new_n390_ & (x34 | (~new_n540_ & (new_n536_ | x05)));
  assign new_n536_ = (x31 | ~new_n114_ | x35) & (~x15 | new_n537_ | new_n92_);
  assign new_n537_ = ~new_n385_ & (~x38 | (~new_n384_ & (x37 | (~new_n381_ & ~new_n538_))));
  ...
  assign new_n544_ = (new_n386_ | x34) & (~new_n297_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n549_ : ~new_n546_);
  assign new_n546_ = (x05 | new_n536_ | x34) & (x38 | (~new_n547_ & ~new_n541_));
  assign new_n547_ = ~x35 & (new_n372_ | (x34 & (new_n218_ | (new_n548_ & x00))));
  assign new_n548_ = ~x01 & x02 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n549_ = (~new_n297_ | ~x34 | x35 | x37) & (x34 | (~new_n551_ & (~x35 | new_n550_ | ~x37)));
  assign new_n550_ = (~new_n125_ | x38) & (~new_n529_ | x03 | ~x04 | ~x38);
  assign new_n551_ = new_n112_ & new_n153_ & x10 & x27 & ~x35;
  assign z26 = ~x07 & ~x32 & x33 & (new_n556_ | (~new_n553_ & ~x35));
  assign new_n553_ = (new_n554_ | new_n123_) & (~new_n297_ | ~x34 | ~x36 | x37);
  assign new_n554_ = (new_n555_ | ~x38) & (~new_n122_ | ~x34 | x36);
  ...
  assign new_n559_ = x15 & ~new_n92_ & (new_n564_ | (~new_n560_ & ~x34));
  assign new_n560_ = (new_n561_ | ~x35) & (x31 | x35 | (~new_n562_ & (new_n563_ | x16)));
  assign new_n561_ = (x38 | new_n543_ | x39) & (x37 | ~x38 | new_n214_ | ~x39);
  assign new_n562_ = ~x09 & ~x17 & (new_n298_ | new_n122_);
  ...
  assign new_n567_ = new_n198_ & ~x34 & x35 & x36;
  assign z28 = ~x07 & ~x32 & x33 & (new_n569_ | new_n571_);
  assign new_n569_ = x00 & ~x01 & x02 & ~x03 & ~new_n570_ & x04;
  assign new_n570_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n87_ | x38);
  assign new_n571_ = new_n138_ & ~x34 & ~x35 & new_n111_ & x36 & ~x37;
  ...
  assign new_n576_ = x35 & ~x37 & ~new_n92_ & (~x38 ^ x39);
  assign new_n577_ = x37 & ~x38 & ~new_n90_ & x39;
  assign new_n578_ = x38 & ~x39 & ~new_n90_ & x40;
  assign z30 = ~x07 & ~x32 & x33 & (new_n580_ | new_n571_);
  assign new_n580_ = ~x05 & x15 & ~x36 & ~new_n581_ & ~new_n92_;
  assign new_n581_ = ~new_n564_ & (~x24 | x34 | new_n582_ | ~x35);
  assign new_n582_ = x22 ? new_n583_ : ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))));
  assign new_n583_ = (new_n584_ | x21) & (~new_n125_ | ~x38 | ~x21 | x23 | x37);
  assign new_n584_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n174_ | ~x40)));
  assign z31 = ~x07 & ~x32 & x33 & (new_n594_ | (~new_n586_ & ~x34));
  assign new_n586_ = (new_n587_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  assign new_n587_ = ~new_n592_ & (x05 | ~new_n588_ | ~x15);
  assign new_n588_ = ~x36 & ~new_n92_ & ((new_n589_ & ~x38) | (~x37 & new_n591_ & x38));
  ...
  assign new_n592_ = new_n593_ & x00 & ~x01 & x02 & ~x03;
  assign new_n593_ = x04 & x36 & x37 & x38;
  assign new_n594_ = x00 & ~x01 & x02 & ~x03 & new_n595_ & x04;
  assign new_n595_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n87_ & ~x38;
  assign z33 = x33 ? (x07 | (~x07 & ~new_n597_ & ~x32)) : x32;
  assign new_n597_ = x34 ? (x35 | new_n618_ | x36) : (x35 ? new_n598_ : new_n608_);
  assign new_n598_ = x37 ? ((new_n606_ | ~x36) & (x05 | ~new_n599_ | x36)) : new_n602_;
  assign new_n599_ = ~x38 & ~x39 & ~new_n600_ & x40;
  assign new_n600_ = (~x15 | ~x22 | ~x24 | new_n601_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n601_ = ~x21 & (x21 | new_n174_ | ~x23);
  ...
  assign new_n604_ = ~new_n92_ & ((x38 & ~new_n511_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n605_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n606_ = (~new_n607_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n607_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n112_ & x01 & ~x38));
  assign new_n608_ = (new_n617_ | ~x36) & (x05 | x31 | new_n609_ | x36);
  assign new_n609_ = ~new_n320_ & ~new_n610_ & new_n616_ & (x37 | (~new_n613_ & ~new_n614_));
  assign new_n610_ = x15 & ((~new_n611_ & x09) | (x16 & new_n152_ & x17));
  assign new_n611_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n612_ | ~x39);
  assign new_n612_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n613_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n614_ = x39 & (new_n615_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n615_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n616_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n617_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n288_ | ~x40)))));
  assign new_n618_ = x38 ? ((~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39)) & (x37 | x39 | x40)) : new_n619_;
  assign new_n619_ = ~new_n620_ & (x01 | x02 | new_n429_ | x03);
  assign new_n620_ = x39 & x40 & (~x37 | (~x05 & ~new_n312_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~x32 & (new_n644_ | (~new_n622_ & ~x34))));
  assign new_n622_ = ~new_n634_ & ~new_n623_ & (x36 | (~new_n643_ & (new_n640_ | x35)));
  assign new_n623_ = x39 & (~new_n629_ | (x38 & (new_n633_ | (~new_n624_ & ~x37))));
  assign new_n624_ = (x35 | (x36 ? new_n403_ : new_n625_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n625_ = ~new_n628_ & (~x15 | (~new_n627_ & (x05 | new_n626_ | x31)));
  assign new_n626_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  assign new_n627_ = x11 & x12 & x14 & ~new_n145_ & x40;
  ...
  assign new_n631_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n92_ & x15));
  assign new_n632_ = ~x37 & ~x38 & x40;
  assign new_n633_ = x05 & ((x35 & ~x36 & ~x37) | (~x00 & ((~x36 & ~x40) | (~x35 & x36 & ~x37 & x40))));
  assign new_n634_ = x37 & (new_n637_ | (x36 & (x38 ? ~new_n635_ : new_n638_)));
  assign new_n635_ = x00 ? (~new_n636_ | x01) : (~x05 | (~new_n127_ & ~x35));
  assign new_n636_ = ~x02 & ~x03 & ((x04 & x35) | (new_n127_ & ~x04 & ~x35));
  assign new_n637_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n440_ & ~x38));
  assign new_n638_ = ~x39 & (x35 ? (new_n639_ | (x06 & x40)) : ~x40);
  assign new_n639_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n640_ = x05 ? (new_n641_ & ~new_n149_) : ~new_n642_;
  assign new_n641_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  assign new_n642_ = ~x31 & ~new_n86_ & ((~x38 & x40) | (~x37 & x38 & ~x39 & ~x40));
  assign new_n643_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n644_ = ~x35 & ~x36 & (new_n646_ | (~new_n645_ & ~x38));
  assign new_n645_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n404_ | ~new_n530_) & (x00 | ~x05)));
