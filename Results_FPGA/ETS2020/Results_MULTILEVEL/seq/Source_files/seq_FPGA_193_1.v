...
module FAU ( 
  ...
  assign z16 = ~x07 & ~x32 & ~new_n143_ & x33;
  assign new_n143_ = (x34 | (~new_n150_ & (new_n144_ | ~x36))) & (~new_n151_ | ~x34 | x35 | x36);
  assign new_n144_ = (new_n145_ | x35) & (~new_n149_ | ~new_n106_ | ~x35 | ~x37);
  assign new_n145_ = (~x38 | (~new_n146_ & (~x37 | x39 | x40))) & (x37 | x38 | (~new_n148_ & x39));
  assign new_n146_ = x00 & new_n147_ & ~x01;
  assign new_n147_ = ~x02 & ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n148_ = ~x11 & ~x12 & x40;
  assign new_n149_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n150_ = x38 & ~x39 & x40 & x35 & ~x36 & x37;
  assign new_n151_ = x39 & ~x40 & x37 & x38;
  assign z21 = ~x33 | (~x07 & ((~new_n153_ & ~x34) | (~new_n159_ & ~x35)));
  assign new_n153_ = (~x36 | ((new_n154_ | ~x35) & ~new_n156_ & ~x32)) & (~x35 | (~new_n158_ & ~x32));
  assign new_n154_ = (~x37 | (~new_n155_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n155_ = ~x00 & (new_n106_ | (~x05 & x38));
  assign new_n156_ = new_n157_ & ~x00;
  assign new_n157_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n158_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n159_ = (~x34 | new_n160_ | x36) & (~new_n106_ | ~x32 | ~x36 | x37);
  assign new_n160_ = new_n161_ & (x00 | x05 | x37 | new_n134_ | x38);
  assign new_n161_ = ~x32 & (x06 | ~x37 | ~new_n134_ | ~x38);
  assign z26 = ~x07 & ~x32 & x33 & (new_n163_ | (new_n167_ & x00));
  assign new_n163_ = ~x35 & (new_n164_ | (new_n106_ & x34 & x36 & ~x37));
  assign new_n164_ = ~new_n165_ & (x01 | x02 | x03 | x04);
  assign new_n165_ = (new_n166_ | ~x38) & (~x37 | x38 | x39 | ~x34 | x36);
  assign new_n166_ = (x37 | ~x39 | ~x34 | x36) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n167_ = ~x34 & x35 & x36 & x37 & new_n168_ & ~x38;
  assign new_n168_ = ~x39 & ~x40 & (x03 | ~x04 | ~x01 | x02);
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
