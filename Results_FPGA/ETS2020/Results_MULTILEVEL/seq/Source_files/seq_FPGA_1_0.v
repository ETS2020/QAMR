// Benchmark "FAU" written by ABC on Thu Aug  6 16:54:48 2020
...
module FAU ( 
  ...
  assign z33 = x33 ? (x07 | (~x07 & ~new_n599_ & ~x32)) : x32;
  assign new_n599_ = x34 ? (x35 | new_n620_ | x36) : (x35 ? new_n600_ : new_n610_);
  assign new_n600_ = x37 ? ((new_n608_ | ~x36) & (x05 | ~new_n601_ | x36)) : new_n604_;
  assign new_n601_ = ~x38 & ~x39 & ~new_n602_ & x40;
  assign new_n602_ = (~x15 | ~x22 | ~x24 | new_n603_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n603_ = ~x21 & (x21 | new_n174_ | ~x23);
  assign new_n604_ = x36 ? ((x39 | (x38 & (~x38 | ~x40))) & (~x38 | ~x39 | (x40 & (~x06 | ~x40)))) : (~new_n605_ & (x38 | ~x39 | ~x40) & (~x38 | x39 | x40));
  assign new_n605_ = ~x05 & (new_n607_ | (x15 & x22 & new_n606_ & x24));
  assign new_n606_ = ~new_n92_ & ((x38 & ~new_n513_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n607_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n608_ = (~new_n609_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n609_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n112_ & x01 & ~x38));
  assign new_n610_ = (new_n619_ | ~x36) & (x05 | x31 | new_n611_ | x36);
  assign new_n611_ = ~new_n320_ & ~new_n612_ & new_n618_ & (x37 | (~new_n615_ & ~new_n616_));
  assign new_n612_ = x15 & ((~new_n613_ & x09) | (x16 & new_n152_ & x17));
  assign new_n613_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n614_ | ~x39);
  assign new_n614_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n615_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n616_ = x39 & (new_n617_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n617_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n618_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n619_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n288_ | ~x40)))));
  assign new_n620_ = x38 ? ((~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39)) & (x37 | x39 | x40)) : new_n621_;
  assign new_n621_ = ~new_n622_ & (x01 | x02 | new_n431_ | x03);
  assign new_n622_ = x39 & x40 & (~x37 | (~x05 & ~new_n312_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~x32 & (new_n646_ | (~new_n624_ & ~x34))));
  assign new_n624_ = ~new_n636_ & ~new_n625_ & (x36 | (~new_n645_ & (new_n642_ | x35)));
  assign new_n625_ = x39 & (~new_n631_ | (x38 & (new_n635_ | (~new_n626_ & ~x37))));
  assign new_n626_ = (x35 | (x36 ? new_n405_ : new_n627_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n627_ = ~new_n630_ & (~x15 | (~new_n629_ & (x05 | new_n628_ | x31)));
  assign new_n628_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  ...
  assign new_n632_ = x05 ? (x38 & x40) : (x31 | new_n633_ | x37);
  assign new_n633_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n92_ & x15));
  assign new_n634_ = ~x37 & ~x38 & x40;
  assign new_n635_ = x05 & ((x35 & ~x36 & ~x37) | (~x00 & ((~x36 & ~x40) | (~x35 & x36 & ~x37 & x40))));
  assign new_n636_ = x37 & (new_n639_ | (x36 & (x38 ? ~new_n637_ : new_n640_)));
  assign new_n637_ = x00 ? (~new_n638_ | x01) : (~x05 | (~new_n127_ & ~x35));
  assign new_n638_ = ~x02 & ~x03 & ((x04 & x35) | (new_n127_ & ~x04 & ~x35));
  assign new_n639_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n442_ & ~x38));
  assign new_n640_ = ~x39 & (x35 ? (new_n641_ | (x06 & x40)) : ~x40);
  assign new_n641_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n642_ = x05 ? (new_n643_ & ~new_n149_) : ~new_n644_;
  assign new_n643_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  assign new_n644_ = ~x31 & ~new_n86_ & ((~x38 & x40) | (~x37 & x38 & ~x39 & ~x40));
  assign new_n645_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n646_ = ~x35 & ~x36 & (new_n648_ | (~new_n647_ & ~x38));
  assign new_n647_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n406_ | ~new_n532_) & (x00 | ~x05)));
