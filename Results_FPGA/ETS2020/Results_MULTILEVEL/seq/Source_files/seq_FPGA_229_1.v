// Benchmark "FAU" written by ABC on Thu Aug  6 17:02:38 2020
...
module FAU ( 
  ...
  assign z15 = x07 & x33;
  assign z16 = ~x07 & ~x32 & ~new_n117_ & x33;
  assign new_n117_ = (x34 | (~new_n126_ & (new_n118_ | ~x36))) & (~new_n127_ | ~x34 | x35 | x36);
  assign new_n118_ = (new_n119_ | x35) & (~new_n125_ | ~new_n124_ | ~x35 | ~x37);
  assign new_n119_ = ~new_n123_ & (~x38 | (~new_n120_ & (~x00 | ~new_n122_ | x01)));
  assign new_n120_ = new_n121_ & x37;
  assign new_n121_ = ~x39 & ~x40;
  assign new_n122_ = ~x02 & ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n123_ = ~x37 & ~x38 & (~x39 | (~x11 & ~x12 & x40));
  assign new_n124_ = new_n121_ & ~x38;
  assign new_n125_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n126_ = x38 & ~x39 & x40 & x35 & ~x36 & x37;
  assign new_n127_ = x37 & x38 & x39 & ~x40;
  assign z19 = ~x07 & ~x32 & x33 & (x38 ? ~new_n133_ : ~new_n129_);
  assign new_n129_ = (x35 | (~new_n130_ & (~new_n120_ | x34 | ~x36))) & (x34 | ~new_n132_ | ~x35);
  assign new_n130_ = ~x01 & ~x02 & ~x03 & new_n131_ & x34;
  assign new_n131_ = ~x36 & ((~x39 & ~x40 & ~x04 & x37) | (x00 & x04 & ~x37 & (~x39 | ~x40)));
  assign new_n132_ = x40 & (x36 ? (x37 & (x39 | (x06 & ~x39))) : (~x37 & x39));
  assign new_n133_ = (x34 | new_n134_ | ~x35) & (~new_n136_ | ~x06);
  assign new_n134_ = (~new_n135_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n121_ | x36 | x37);
  assign new_n135_ = x00 & ~x01 & ~x02;
  assign new_n136_ = x39 & x40 & ((x34 & ~x35 & ~x36 & x37) | (x36 & ~x37 & ~x34 & x35));
  assign z21 = ~x33 | (~x07 & ((~new_n138_ & ~x34) | (~new_n144_ & ~x35)));
  assign new_n138_ = (~x36 | ((new_n139_ | ~x35) & ~new_n141_ & ~x32)) & (~x35 | (~new_n143_ & ~x32));
  assign new_n139_ = (~x37 | (~new_n140_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n140_ = ~x00 & (x38 ? ~x05 : new_n121_);
  assign new_n141_ = new_n142_ & ~x00;
  assign new_n142_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n143_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n144_ = (~x34 | new_n145_ | x36) & (~new_n124_ | ~x32 | ~x36 | x37);
  assign new_n145_ = new_n146_ & (x00 | x05 | x37 | new_n107_ | x38);
  assign new_n146_ = ~x32 & (~new_n107_ | ~x38 | x06 | ~x37);
  assign z26 = ~x07 & ~x32 & x33 & (new_n148_ | (new_n152_ & x00));
  assign new_n148_ = ~x35 & (new_n149_ | (new_n124_ & x34 & x36 & ~x37));
  assign new_n149_ = ~new_n150_ & (x01 | x02 | x03 | x04);
  assign new_n150_ = (new_n151_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n151_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n152_ = ~x34 & x35 & x36 & x37 & new_n153_ & ~x38;
  assign new_n153_ = ~x39 & ~x40 & (~x01 | x02 | x03 | ~x04);
  assign z32 = ~x40 & ~x39 & x38 & new_n155_ & x37;
  assign new_n155_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
