// Benchmark "FAU" written by ABC on Thu Aug  6 17:01:05 2020
...
module FAU ( 
  ...
  assign new_n605_ = ~new_n92_ & ((x38 & ~new_n512_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  ...
  assign new_n620_ = ~new_n621_ & (x01 | x02 | new_n430_ | x03);
  ...
  assign new_n625_ = (x35 | (x36 ? new_n404_ : new_n626_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n638_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n441_ & ~x38));
  ...
  assign new_n646_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n405_ | ~new_n531_) & (x00 | ~x05)));
