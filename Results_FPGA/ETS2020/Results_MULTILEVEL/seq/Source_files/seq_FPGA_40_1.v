// Benchmark "FAU" written by ABC on Thu Aug  6 16:56:09 2020
...
module FAU ( 
  ...
  assign z26 = ~x07 & ~x32 & x33 & (new_n142_ | (new_n146_ & x00));
  assign new_n142_ = ~x35 & (new_n143_ | (new_n127_ & x34 & x36 & ~x37));
  assign new_n143_ = ~new_n144_ & (x01 | x02 | x03 | x04);
  assign new_n144_ = (new_n145_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n145_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n146_ = ~x34 & x35 & x36 & x37 & new_n147_ & ~x38;
  assign new_n147_ = ~x39 & ~x40 & (~x01 | x02 | x03 | ~x04);
  assign z31 = ~x07 & ~x32 & ~new_n149_ & x33;
  assign new_n149_ = (x34 | (~new_n150_ & (~new_n159_ | ~new_n160_))) & (~new_n157_ | ~x00);
  assign new_n150_ = x35 & (new_n155_ | (~x05 & x15 & new_n151_ & ~x36));
  assign new_n151_ = ~new_n83_ & ((~x38 & ~new_n152_ & ~x39) | (~x37 & x38 & ~new_n154_ & x39));
  assign new_n152_ = (x24 | x37) & (~x40 | (x24 & (x21 | ~new_n153_ | ~x22)));
  assign new_n153_ = ~x23 & x24 & x37 & ((x18 & x19) | (x09 & (x18 | x19)));
  assign new_n154_ = x24 & (~x21 | ~x22 | x23 | ~x24 | x40);
  assign new_n155_ = new_n156_ & x00 & ~x01 & x02 & ~x03;
  assign new_n156_ = x04 & x36 & x37 & x38;
  assign new_n157_ = ~x01 & x02 & ~x03 & x04 & new_n158_ & x34;
  assign new_n158_ = ~x35 & ~x36 & ~x37 & ~new_n108_ & ~x38;
  assign new_n159_ = ~x37 & x38 & ~x39 & ~x40;
  assign new_n160_ = x10 & x27 & ~x35 & x36;
  assign z32 = ~x40 & ~x39 & x38 & new_n162_ & x37;
  assign new_n162_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
