// Benchmark "FAU" written by ABC on Thu Aug  6 17:00:46 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n643_, new_n644_, new_n645_, new_n646_, new_n647_;
  ...
  assign new_n360_ = (new_n361_ | ~x36) & (~new_n127_ | ~x38 | ~x35 | x36 | ~x37);
  assign new_n361_ = (new_n362_ | x35) & (~new_n366_ | ~new_n297_ | ~x35 | ~x37);
  assign new_n362_ = ~new_n365_ & (~x38 | (~new_n363_ & (~x00 | ~new_n364_ | x01)));
  assign new_n363_ = new_n112_ & x37;
  assign new_n364_ = ~x02 & ~x03 & ~x04 & x40 & (~x37 ^ ~x39);
  assign new_n365_ = ~x37 & ~x38 & (~x39 | (~x11 & ~x12 & x40));
  assign new_n366_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign new_n367_ = x34 & ~x35 & ~x36 & new_n125_ & x37 & x38;
  assign z17 = x33 & (x07 | (~x07 & ~new_n369_ & ~x32));
  assign new_n369_ = (x34 | new_n385_ | ~x36) & (x36 | (~new_n370_ & ~new_n377_ & ~new_n389_));
  assign new_n370_ = ~x38 & ((new_n376_ & ~x05) | (~x35 & (new_n371_ | new_n372_)));
  assign new_n371_ = ~x05 & ~x31 & ~new_n88_ & ~x34;
  assign new_n372_ = x34 & ((~new_n374_ & x37) | (x02 & (new_n373_ | (x37 & ~x39))));
  assign new_n373_ = x00 & ~x01 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n374_ = ~new_n375_ & (x05 | ~new_n219_ | ~x15);
  assign new_n375_ = ~x39 & (x01 | x03 | x04);
  assign new_n376_ = x15 & ~x34 & x35 & ~x39 & ~new_n212_ & ~new_n92_;
  assign new_n377_ = ~x05 & ~x34 & (new_n378_ | (~x31 & new_n114_ & ~x35));
  assign new_n378_ = x15 & ~new_n92_ & (new_n384_ | (x38 & (new_n379_ | new_n383_)));
  assign new_n379_ = ~x37 & (new_n380_ | (x39 & (new_n106_ | (~new_n382_ & x35))));
  assign new_n380_ = ~x09 & (new_n381_ | (x35 & x39 & ~x18 & ~x21));
  assign new_n381_ = ~x16 & ~x31 & ~x35 & ~x40;
  assign new_n382_ = x24 & (~x24 | (x22 & (~x22 | (x21 ? (x23 | x40) : (x40 & (new_n177_ | ~x40))))));
  assign new_n383_ = ~x09 & ~x17 & ~x31 & ~x35 & x39;
  assign new_n384_ = ~x09 & ~x16 & ~x31 & ~x35 & ~x37 & x39;
  assign new_n385_ = (new_n388_ | x40) & (~x00 | (~new_n130_ & (new_n386_ | ~x38)));
  assign new_n386_ = ~new_n387_ & (x35 | ~x40 | new_n123_ | (x37 ^ ~x39));
  assign new_n387_ = ~x01 & x02 & ~x03 & x04 & x35 & x37;
  assign new_n388_ = (~x35 | ~x37 | x38 | ~x39) & (~x10 | ~x27 | x35 | x37 | ~x38 | x39);
  ...
  assign new_n397_ = x21 & x22 & x24 & ~new_n92_ & x40;
  assign new_n398_ = ~x39 & ((new_n399_ & x15) | (new_n158_ & ~x13));
  assign new_n399_ = x24 & ~new_n92_ & (x40 | (x21 & x22 & ~x40));
  assign new_n400_ = ~x35 & (x36 ? ~new_n401_ : (new_n406_ | (~new_n404_ & x40)));
  assign new_n401_ = (new_n402_ | (~x37 ^ x39)) & (~x37 | ~x39) & (x37 | x39 | (~x40 & (new_n138_ | x40)));
  ...
  assign new_n409_ = x22 & x24 & ~x36 & ~new_n92_ & (x23 | x40);
  ...
  assign new_n412_ = new_n167_ & x00 & x01 & new_n112_ & x04 & x35;
  assign new_n413_ = ~x11 & x40 & (~x12 | (x12 & x39));
  assign new_n414_ = (~new_n297_ | ~x36 | x37) & (new_n415_ | x36);
  assign new_n415_ = x38 ? (x37 ? (x39 & (~x39 | x40)) : (~new_n189_ & x39)) : new_n416_;
  assign new_n416_ = (~new_n418_ | x01) & (~x39 | (x37 ? new_n417_ : new_n419_));
  assign new_n417_ = x40 & (x05 | ~x15 | ~x21 | ~x22 | new_n92_ | ~x40);
  assign new_n418_ = ~x04 & ~x39 & ((x00 & ~x37) | (new_n167_ & x37 & x40));
  ...
  assign new_n426_ = (x35 | (~new_n427_ & (~new_n363_ | x34 | ~x36))) & (x34 | ~new_n429_ | ~x35);
  ...
  assign new_n431_ = (~new_n403_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n112_ | x36 | x37);
  ...
  assign new_n437_ = ~x34 & (x31 | (~x31 & ~new_n86_ & x39));
  assign new_n438_ = ~x31 & ~x34 & (new_n158_ | (new_n439_ & x37));
  assign new_n439_ = ~x39 & ((x15 & ~new_n145_ & ~new_n154_) | new_n92_ | ~x15);
  assign new_n440_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n86_ & x40));
  assign new_n441_ = (new_n446_ | ~x37) & (new_n444_ | ~x05) & (x05 | (x31 ? new_n444_ : (new_n442_ | x37)));
  assign new_n442_ = (~x39 | (~new_n305_ & (~x40 | (~new_n443_ & new_n86_)))) & (~x38 | x39 | new_n86_ | x40);
  assign new_n443_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n444_ = ~new_n149_ & new_n445_ & ~new_n205_ & new_n102_;
  assign new_n445_ = x14 & x15 & (~x39 | x40) & (~x38 | x39);
  assign new_n446_ = x05 ? ~x38 : (~x31 | ~x39);
  assign new_n447_ = (new_n448_ | (~x05 & (x05 | new_n86_ | ~x13))) & (x05 | new_n86_ | new_n449_);
  assign new_n448_ = ~new_n121_ & (~new_n127_ | x38);
  assign new_n449_ = (x38 | x39 | ~x13 | x37) & (x13 | ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40)))));
  assign new_n450_ = x05 & ((~x37 & ~x38 & ~x39) | (x39 & ~x40 & ~x00 & x38));
  assign new_n451_ = ~x34 & x36 & (new_n452_ | (x40 & (new_n454_ | new_n455_)));
  assign new_n452_ = new_n453_ & x35 & x37 & x38;
  assign new_n453_ = ~x00 & x05;
  assign new_n454_ = ~x00 & x05 & x38 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n455_ = ~x37 & ~x38 & x39 & x11 & ~x35;
  ...
  assign new_n459_ = ~x00 & (x38 ? ~x05 : new_n112_);
  assign new_n460_ = new_n461_ & ~x00;
  assign new_n461_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n462_ = new_n125_ & x38 & ~x00 & ~x05 & x37;
  assign new_n463_ = (~x34 | new_n464_ | x36) & (~new_n297_ | ~x32 | ~x36 | x37);
  assign new_n464_ = new_n465_ & (x00 | x05 | x37 | new_n87_ | x38);
  assign new_n465_ = ~x32 & (~new_n87_ | ~x38 | x06 | ~x37);
  assign z22 = ~x07 & x33 & (new_n473_ | (~new_n467_ & ~x34));
  assign new_n467_ = (new_n468_ | x36) & (x00 | ~x05 | x32 | ~new_n472_ | ~x36);
  assign new_n468_ = (~x05 | new_n471_ | x32) & (x35 | (new_n421_ & (~x05 | new_n469_ | x32)));
  assign new_n469_ = ~new_n149_ & (~x38 | (~x37 & x39)) & new_n470_ & (~x39 | (x38 & x40));
  assign new_n470_ = new_n102_ & x14 & ~new_n205_ & x15;
  assign new_n471_ = (x37 | x38 | x39) & (~x39 | x40 | x00 | ~x38) & (~x35 | ((x37 | ~x38 | ~x39) & (x38 | x39 | ~x40)));
  assign new_n472_ = x38 & ((x37 & (x35 | (~x39 & x40))) | (x39 & x40 & ~x35 & ~x37));
  assign new_n473_ = x05 & ~x32 & new_n474_ & ~x35;
  assign new_n474_ = ~x36 & ~x38 & ((new_n87_ & x37) | (~x00 & ~new_n87_ & ~x37));
  assign z23 = x33 & (x07 | (~x07 & ~x32 & (new_n522_ | (~new_n476_ & ~x34))));
  assign new_n476_ = (new_n477_ | x38) & (new_n497_ | ~x38) & (x35 | new_n517_ | x36);
  ...
  assign new_n480_ = ~new_n92_ & (new_n481_ | (x35 & ~new_n482_ & x40));
  ...
  assign new_n483_ = ~x31 & ~x35 & ((x11 & x12 & ~x14) | (~new_n145_ & (~x11 ^ ~x12)));
  assign new_n484_ = x11 & x12 & x14 & ~new_n145_ & ~x35;
  assign new_n485_ = x35 & ~new_n92_ & (~x37 | (~x24 & x40));
  assign new_n486_ = (~new_n487_ | x05) & (~x35 | ~x37 | x40);
  assign new_n487_ = ~new_n86_ & ((x37 & (x13 ? (~x31 & ~x35) : (x35 ? x40 : ~x31))) | (x35 & (x13 ? (~x37 | x40) : ~x37)));
  ...
  assign new_n492_ = (~x40 | (~new_n493_ & new_n86_)) & (~x39 | (x37 ? (new_n494_ | x40) : new_n86_));
  assign new_n493_ = ~x09 & x15 & ~new_n92_ & ~x16;
  ...
  assign new_n497_ = ~new_n516_ & (new_n507_ | ~x35) & (x35 | (x36 ? new_n513_ : new_n498_));
  ...
  assign new_n500_ = ~new_n203_ & x39;
  assign new_n501_ = ~x16 & ~new_n92_ & ((~x17 & x39 & x40) | (~x09 & ~x40));
  assign new_n502_ = ~x40 & ((~x39 & (new_n92_ | ~x15)) | (x09 & ~x13 & ~x15 & x39));
  ...
  assign new_n507_ = x37 ? new_n511_ : (x39 ? (x36 ? x40 : new_n508_) : ~x40);
  assign new_n508_ = ~x05 & (x05 | (~new_n92_ & x15 & (~x15 | new_n92_ | (new_n105_ & (new_n509_ | ~x24)))));
  assign new_n509_ = x22 & (~x22 | (new_n510_ & (x40 | (x21 & (~x21 | x23)))));
  assign new_n510_ = x21 ? (~x23 & ~x40) : (~x40 | (~x09 & ~x18));
  assign new_n511_ = (~x00 | (~new_n512_ & (x36 | ~x39 | x40))) & (x36 | (x39 & (~x39 | ~x40))) & (x00 | ~x05 | ~x36);
  assign new_n512_ = ~x01 & x36 & (~x04 | (x02 & ~x03 & x04));
  assign new_n513_ = ((~new_n514_ & x40) | (x37 ^ ~x39)) & (~x39 | (~x37 & (~new_n453_ | x37 | ~x40))) & (x37 | x39 | (~x40 & (new_n515_ | x40)));
  ...
  assign new_n517_ = x05 ? (new_n521_ & ~new_n149_) : (~new_n518_ & (~x31 | (new_n520_ & ~new_n149_)));
  assign new_n518_ = x39 & (x31 ? (x37 | ~x40) : (~new_n519_ & ~x37));
  assign new_n519_ = ~new_n493_ & ~new_n158_ & (~x09 | ~x13 | x15);
  assign new_n520_ = ~new_n205_ & x11 & x12 & x14 & x15;
  assign new_n521_ = x14 & ~new_n125_ & x15 & ~new_n205_ & new_n102_;
  assign new_n522_ = ~x35 & ((~new_n523_ & ~x36) | (new_n297_ & x34 & x36 & ~x37));
  assign new_n523_ = x38 ? new_n524_ : (x37 ? new_n530_ : (~new_n527_ & ~new_n531_));
  assign new_n524_ = ~new_n525_ & (~new_n526_ | x05 | ~x11 | ~x12 | x14);
  assign new_n525_ = x34 & (x37 ? (~x39 | (x39 & ~x40)) : (new_n189_ | ~x39 | (~new_n123_ & x39)));
  assign new_n526_ = x15 & ~x31 & new_n87_ & ~x37;
  assign new_n527_ = ~new_n87_ & (new_n453_ | (new_n528_ & new_n529_));
  assign new_n528_ = x00 & ~x01 & x02;
  assign new_n529_ = ~x03 & x04 & x34;
  assign new_n530_ = (~x05 | ~x39 | ~x40) & (~x34 | (x39 ? (x40 & (x05 | ~x40)) : new_n221_));
  assign new_n531_ = x34 & ((x39 & (x40 | (x00 & ~x01 & ~x04 & ~x40))) | (x00 & ~x01 & ~x04 & ~x39));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n543_ : ~new_n533_);
  assign new_n533_ = new_n534_ & (x38 | (~new_n540_ & (x35 | (~new_n371_ & ~new_n372_))));
  assign new_n534_ = ~new_n389_ & (x34 | (~new_n539_ & (new_n535_ | x05)));
  assign new_n535_ = (x31 | ~new_n114_ | x35) & (~x15 | new_n536_ | new_n92_);
  assign new_n536_ = ~new_n384_ & (~x38 | (~new_n383_ & (x37 | (~new_n380_ & ~new_n537_))));
  assign new_n537_ = x39 & (new_n106_ | new_n538_);
  assign new_n538_ = x35 & (~x24 | (x24 & (~x22 | (x22 & ~x40 & (~x21 | (x21 & ~x23))))));
  assign new_n539_ = new_n111_ & x35 & x37;
  assign new_n540_ = ~x05 & new_n541_ & x15;
  assign new_n541_ = ~x34 & x35 & ~x39 & ~new_n542_ & ~new_n92_;
  assign new_n542_ = (~x40 | (x24 & (~x37 | ((new_n97_ | x21) & (x22 | ~x24))))) & (x37 | (x24 & (~x24 | x40 | (x22 & (x21 | ~x22)))));
  assign new_n543_ = (new_n385_ | x34) & (~new_n297_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n548_ : ~new_n545_);
  assign new_n545_ = (x05 | new_n535_ | x34) & (x38 | (~new_n546_ & ~new_n540_));
  assign new_n546_ = ~x35 & (new_n371_ | (x34 & (new_n218_ | (new_n547_ & x00))));
  assign new_n547_ = ~x01 & x02 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n548_ = (~new_n297_ | ~x34 | x35 | x37) & (x34 | (~new_n550_ & (~x35 | new_n549_ | ~x37)));
  assign new_n549_ = (~new_n125_ | x38) & (~new_n528_ | x03 | ~x04 | ~x38);
  assign new_n550_ = new_n112_ & new_n153_ & x10 & x27 & ~x35;
  assign z26 = ~x07 & ~x32 & x33 & (new_n555_ | (~new_n552_ & ~x35));
  assign new_n552_ = (new_n553_ | new_n123_) & (~new_n297_ | ~x34 | ~x36 | x37);
  assign new_n553_ = (new_n554_ | ~x38) & (~new_n122_ | ~x34 | x36);
  ...
  assign new_n557_ = ~x36 & (new_n558_ | (~x09 & ~x31 & new_n565_ & ~x34));
  assign new_n558_ = x15 & ~new_n92_ & (new_n563_ | (~new_n559_ & ~x34));
  assign new_n559_ = (new_n560_ | ~x35) & (x31 | x35 | (~new_n561_ & (new_n562_ | x16)));
  assign new_n560_ = (x38 | new_n542_ | x39) & (x37 | ~x38 | new_n214_ | ~x39);
  assign new_n561_ = ~x09 & ~x17 & (new_n298_ | new_n122_);
  assign new_n562_ = (x17 | ((~x37 | x38 | x39) & (~x39 | ~x40 | x37 | ~x38))) & (x09 | ((x38 | (~x40 & (~x37 | x39))) & (x37 | (~x39 & (~x38 | x40)))));
  assign new_n563_ = x34 & new_n564_ & ~x35;
  assign new_n564_ = x37 & ~x38 & x39 & x40 & (~x22 | (~x21 & x22));
  assign new_n565_ = ~x35 & x38 & x39 & (x37 | ~x40);
  assign new_n566_ = new_n198_ & ~x34 & x35 & x36;
  assign z28 = ~x07 & ~x32 & x33 & (new_n568_ | new_n570_);
  assign new_n568_ = x00 & ~x01 & x02 & ~x03 & ~new_n569_ & x04;
  assign new_n569_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n87_ | x38);
  assign new_n570_ = new_n138_ & ~x34 & ~x35 & new_n111_ & x36 & ~x37;
  assign z29 = ~x07 & ~x32 & x33 & (new_n566_ | (new_n572_ & ~x05));
  assign new_n572_ = ~x36 & ((~new_n573_ & ~x34) | (x15 & new_n324_ & ~x21));
  assign new_n573_ = (x31 | ~new_n577_ | x35) & (x40 | (~new_n574_ & (x31 | ~new_n576_ | x35)));
  assign new_n574_ = x15 & ~x21 & x22 & new_n575_ & x24;
  assign new_n575_ = x35 & ~x37 & ~new_n92_ & (~x38 ^ x39);
  assign new_n576_ = x37 & ~x38 & ~new_n90_ & x39;
  assign new_n577_ = x38 & ~x39 & ~new_n90_ & x40;
  assign z30 = ~x07 & ~x32 & x33 & (new_n579_ | new_n570_);
  assign new_n579_ = ~x05 & x15 & ~x36 & ~new_n580_ & ~new_n92_;
  ...
  assign new_n583_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n174_ | ~x40)));
  assign z31 = ~x07 & ~x32 & x33 & (new_n593_ | (~new_n585_ & ~x34));
  assign new_n585_ = (new_n586_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  assign new_n586_ = ~new_n591_ & (x05 | ~new_n587_ | ~x15);
  assign new_n587_ = ~x36 & ~new_n92_ & ((new_n588_ & ~x38) | (~x37 & new_n590_ & x38));
  assign new_n588_ = ~x39 & ((~x24 & ~x37) | (x40 & (new_n589_ | ~x24)));
  assign new_n589_ = ~x21 & x22 & ~x23 & x24 & ~new_n174_ & x37;
  assign new_n590_ = x39 & (~x24 | (x21 & x22 & ~x23 & x24 & ~x40));
  assign new_n591_ = new_n592_ & x00 & ~x01 & x02 & ~x03;
  assign new_n592_ = x04 & x36 & x37 & x38;
  assign new_n593_ = x00 & ~x01 & x02 & ~x03 & new_n594_ & x04;
  assign new_n594_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n87_ & ~x38;
  assign z32 = ~x40 & ~x39 & x38 & new_n596_ & x37;
  assign new_n596_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z33 = x33 ? (x07 | (~x07 & ~new_n598_ & ~x32)) : x32;
  assign new_n598_ = x34 ? (x35 | new_n619_ | x36) : (x35 ? new_n599_ : new_n609_);
  assign new_n599_ = x37 ? ((new_n607_ | ~x36) & (x05 | ~new_n600_ | x36)) : new_n603_;
  assign new_n600_ = ~x38 & ~x39 & ~new_n601_ & x40;
  assign new_n601_ = (~x15 | ~x22 | ~x24 | new_n602_ | new_n92_) & (x13 | (~new_n92_ & x15));
  ...
  assign new_n605_ = ~new_n92_ & ((x38 & ~new_n510_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n606_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n607_ = (~new_n608_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n608_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n112_ & x01 & ~x38));
  ...
  assign new_n612_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n613_ | ~x39);
  assign new_n613_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n614_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n615_ = x39 & (new_n616_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n616_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n617_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  ...
  assign new_n620_ = ~new_n621_ & (x01 | x02 | new_n428_ | x03);
  ...
  assign new_n625_ = (x35 | (x36 ? new_n402_ : new_n626_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n638_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n439_ & ~x38));
  ...
  assign new_n642_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  assign new_n643_ = ~x31 & ~new_n86_ & ((~x38 & x40) | (~x37 & x38 & ~x39 & ~x40));
  assign new_n644_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n645_ = ~x35 & ~x36 & (new_n647_ | (~new_n646_ & ~x38));
  assign new_n646_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n403_ | ~new_n529_) & (x00 | ~x05)));
