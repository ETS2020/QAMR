// Benchmark "FAU" written by ABC on Thu Aug  6 16:58:33 2020
...
module FAU ( 
  ...
  assign new_n130_ = (x35 | ~x40 | new_n123_ | new_n131_) & (x01 | ~new_n132_ | ~x35);
  ...
  assign new_n285_ = ~new_n133_ & (~x38 | ((new_n286_ | ~x40) & (~new_n287_ | x01)));
  ...
  assign new_n299_ = ~new_n86_ & ~new_n300_;
  ...
  assign new_n302_ = new_n305_ & (~x39 | (x37 ? (~new_n182_ | x38) : new_n303_));
  assign new_n303_ = ~new_n304_ & (new_n86_ | (x13 ? (x38 & ~x40) : (x38 | ~x40)));
  assign new_n304_ = x09 & ((x13 & ~x15) | (x38 & ~x40 & (x15 ? ~new_n102_ : ~x13)));
  assign new_n305_ = ~new_n306_ & (~x38 | x39 | new_n180_ | ~x40);
  assign new_n306_ = ~new_n86_ & ((~x38 & ((x13 & (x40 | (x37 & ~x39))) | (~x13 & x37 & ~x39 & x40))) | (x13 & ~x37 & x38 & ~x39 & ~x40));
  assign new_n307_ = (~x37 | x38 | ~x39 | x40) & (x37 | ((~x38 | x39 | new_n138_ | x40) & (~x39 | ~x40 | ~x11 | x38)));
  assign new_n308_ = ~x36 & ~new_n309_ & x40;
  assign new_n309_ = (new_n310_ | ~x37) & (~new_n166_ | ~x38 | ~x39 | x04 | x37);
  ...
  assign new_n321_ = x24 & x35 & ~new_n92_ & (new_n298_ | (~new_n295_ & x40));
  ...
  assign new_n338_ = new_n249_ & ~x30 & ~x31;
  ...
  assign new_n347_ = (x31 | x35 | ~new_n207_ | ~x37) & (~new_n348_ | x37);
  ...
  assign z15 = x07 & x33;
  assign z16 = ~x07 & ~x32 & x33 & (new_n368_ | (~new_n362_ & ~x34));
  assign new_n362_ = (new_n363_ | ~x36) & (~new_n127_ | ~x38 | ~x35 | x36 | ~x37);
  assign new_n363_ = (new_n364_ | x35) & (~new_n367_ | ~x35 | ~x37 | ~new_n112_ | x38);
  assign new_n364_ = (~x38 | ((~new_n112_ | ~x37) & (~new_n365_ | ~x00))) & (x37 | new_n366_ | x38);
  assign new_n365_ = ~x01 & ~x02 & ~x03 & ~x04 & ~new_n131_ & x40;
  ...
  assign new_n370_ = (x36 | (~new_n371_ & ~new_n378_ & ~new_n390_)) & (x34 | new_n386_ | ~x36);
  ...
  assign new_n386_ = (new_n389_ | x40) & (~x00 | (~new_n133_ & (new_n387_ | ~x38)));
  assign new_n387_ = ~new_n388_ & (x35 | ~x40 | new_n123_ | new_n131_);
  ...
  assign new_n395_ = ~x31 & new_n182_ & x39;
  ...
  assign new_n399_ = ~x37 & ~x39 & (new_n400_ | (new_n158_ & ~x13));
  assign new_n400_ = x15 & x24 & ~new_n92_ & (x40 | (x21 & x22 & ~x40));
  assign new_n401_ = x37 ? (~new_n402_ & (x35 | (~x39 & (x39 | ~x40)))) : (~x35 & (x35 | (~new_n403_ & x39)));
  assign new_n402_ = new_n167_ & x00 & x01 & new_n112_ & x04 & x35;
  ...
  assign new_n408_ = ~x05 & ~x31 & ~new_n180_ & ~x39;
  assign new_n409_ = x37 ? (~new_n412_ & (x36 | (x39 & (~x39 | ~x40)))) : (x39 ? (~new_n410_ & (~x36 | x40)) : ~x40);
  assign new_n410_ = ~x05 & x15 & x21 & new_n411_ & x22;
  assign new_n411_ = x24 & ~x36 & ~new_n92_ & (x23 | x40);
  assign new_n412_ = x00 & ((~x01 & ~x04 & x36) | (new_n125_ & ~x36));
  assign new_n413_ = ((~new_n414_ & x40) | (~x37 ^ x39)) & (~x37 | ~x39) & (x37 | x39 | (~x40 & (new_n138_ | x40)));
  assign new_n414_ = new_n415_ & ~x03 & ~x04 & x40;
  assign new_n415_ = x00 & ~x01 & ~x02;
  assign new_n416_ = (x36 | (x38 ? new_n421_ : new_n417_)) & (~x36 | x37 | ~new_n112_ | x38);
  ...
  assign new_n421_ = x37 ? (x39 & (~x39 | x40)) : (~new_n189_ & x39);
  ...
  assign new_n434_ = (~new_n415_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n112_ | x36 | x37);
  assign new_n435_ = x39 & x40 & ((~x36 & x37 & x34 & ~x35) | (~x34 & x35 & x36 & ~x37));
  assign z20 = ~x07 & ~x32 & x33 & (new_n453_ | (~new_n437_ & ~x36));
  assign new_n437_ = (new_n449_ | x34) & (x35 | ((new_n438_ | x34) & (new_n444_ | x38)));
  assign new_n438_ = (new_n443_ | ~x37) & (new_n441_ | ~x05) & (x05 | (x31 ? new_n441_ : (new_n439_ | x37)));
  assign new_n439_ = (~x39 | (~new_n304_ & (~x40 | (~new_n440_ & new_n86_)))) & (~x38 | x39 | new_n86_ | x40);
  assign new_n440_ = x15 & new_n247_ & x38;
  assign new_n441_ = ~new_n149_ & new_n442_ & ~new_n205_ & new_n102_;
  assign new_n442_ = x14 & x15 & (~x39 | x40) & (~x38 | x39);
  assign new_n443_ = x05 ? ~x38 : (~x31 | ~x39);
  assign new_n444_ = ~new_n445_ & ~new_n448_ & (x05 | x31 | new_n447_ | x34);
  assign new_n445_ = ~x37 & ((new_n446_ & ~x05) | (~x00 & ~new_n87_ & x05));
  assign new_n446_ = ~x34 & (x31 | (~x31 & ~new_n86_ & x39));
  assign new_n447_ = (~x40 | (~new_n92_ & x15)) & (~x37 | x39 | ((~new_n247_ | ~x15) & ~new_n92_ & x15));
  assign new_n448_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n86_ & x40));
  assign new_n449_ = (new_n452_ | ~x05) & (~x35 | (~new_n450_ & (~new_n451_ | x05)));
  assign new_n450_ = (new_n121_ | (new_n127_ & ~x38)) & (x05 | (~x05 & ~new_n86_ & x13));
  assign new_n451_ = ~new_n86_ & ((~x13 & ((x37 & ~x38 & ~x39 & x40) | (~x37 & (x38 ? x39 : (~x39 & ~x40))))) | (x13 & ~x37 & ~x38 & ~x39));
  assign new_n452_ = (x37 | x38 | x39) & (~x39 | x40 | x00 | ~x38);
  ...
  assign new_n474_ = new_n452_ & (~x35 | (~new_n121_ & (~new_n127_ | x38)));
  ...
  assign new_n524_ = ~new_n205_ & new_n102_ & x14 & ~new_n125_ & x15;
  assign new_n525_ = ~x35 & (new_n534_ | (~x36 & (x38 ? ~new_n531_ : ~new_n526_)));
  assign new_n526_ = x37 ? new_n529_ : (~new_n530_ & (new_n87_ | (~new_n527_ & ~new_n455_)));
  ...
  assign new_n536_ = new_n537_ & (x38 | (~new_n543_ & (x35 | (~new_n372_ & ~new_n373_))));
  assign new_n537_ = ~new_n390_ & (x34 | (~new_n542_ & (new_n538_ | x05)));
  assign new_n538_ = (x31 | ~new_n114_ | x35) & (~x15 | new_n539_ | new_n92_);
  assign new_n539_ = ~new_n385_ & (~x38 | (~new_n384_ & (x37 | (~new_n381_ & ~new_n540_))));
  ...
  assign new_n546_ = (new_n386_ | x34) & (~x34 | x35 | x37 | ~new_n112_ | x38);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n551_ : ~new_n548_);
  assign new_n548_ = (x05 | new_n538_ | x34) & (x38 | (~new_n549_ & ~new_n543_));
  assign new_n549_ = ~x35 & (new_n372_ | (x34 & (new_n218_ | (new_n550_ & x00))));
  ...
  assign new_n554_ = x37 & ((new_n125_ & ~x38) | (new_n528_ & ~x03 & x04 & x38));
  assign z26 = ~x07 & ~x32 & ~new_n556_ & x33;
  assign new_n556_ = (x35 | (~new_n534_ & ~new_n557_)) & (~x00 | x34 | ~new_n559_ | ~x35);
  assign new_n557_ = ~new_n123_ & ((~new_n558_ & x38) | (new_n122_ & x34 & ~x36));
  assign new_n558_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (x37 ^ ~x39));
  assign new_n559_ = x36 & x37 & ~x38 & ~x39 & ~new_n134_ & ~x40;
  ...
  assign new_n564_ = (x38 | new_n545_ | x39) & (x37 | ~x38 | new_n214_ | ~x39);
  ...
  assign z31 = ~x07 & ~x32 & x33 & (new_n589_ | (new_n597_ & x00));
  assign new_n589_ = ~x34 & ((~new_n590_ & x35) | (new_n553_ & new_n138_ & ~x35 & x36));
  ...
  assign new_n607_ = ~new_n92_ & ((x38 & ~new_n513_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  ...
  assign new_n612_ = ~new_n319_ & ~new_n613_ & new_n619_ & (x37 | (~new_n616_ & ~new_n617_));
  ...
  assign new_n620_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n289_ | ~x40)))));
  assign new_n621_ = x38 ? ((~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39)) & (x37 | x39 | x40)) : new_n622_;
  assign new_n622_ = ~new_n623_ & (x01 | x02 | new_n431_ | x03);
  assign new_n623_ = x39 & x40 & (~x37 | (~x05 & ~new_n311_ & x37));
  assign z32 = 1'b0;
  assign z34 = 1'b0;
endmodule
