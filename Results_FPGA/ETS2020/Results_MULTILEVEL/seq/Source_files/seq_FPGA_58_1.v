...
module FAU ( 
  ...
  assign z08 = x33 & (x07 | (~x07 & ~x32 & ~x35 & ~new_n130_ & x40));
  assign new_n130_ = (~new_n131_ | x38 | ~x39 | ~x36 | x37) & (~x34 | x36 | ~x37 | ~x38 | x39);
  assign new_n131_ = ~x11 & x12 & ~x34;
  assign z10 = ~x07 & ~x32 & new_n133_ & x33;
  assign new_n133_ = ~x36 & (new_n138_ | (~x05 & x15 & new_n134_ & x21));
  assign new_n134_ = x22 & ~new_n135_ & ~new_n83_ & (x20 | x25);
  assign new_n135_ = (~x24 | x34 | new_n137_ | ~x35) & (~new_n136_ | x38 | ~x34 | x35);
  assign new_n136_ = x39 & x40;
  assign new_n137_ = (~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? (~x39 | (~x23 & ~x40)) : (x39 | x40)));
  assign new_n138_ = x34 & ~x35 & ~x37 & (x38 ? ~x39 : (x39 & x40));
  assign z12 = new_n140_ & ~x00;
  assign new_n140_ = x05 & ~x07 & x08 & ~x32 & new_n141_ & x33;
  assign new_n141_ = ~x40 & ((x36 & x37 & x38 & ~x34 & x35) | (~x36 & ~x37 & ~x38 & x34 & ~x35));
  assign z13 = x33 & (x07 | (~x07 & ~x32 & new_n143_ & ~x34));
  assign new_n143_ = x35 & ~x37 & ((~x38 & (x36 ? ~x39 : (x39 & x40))) | (~x39 & ~x40 & ~x36 & x38));
  assign z14 = ~new_n145_ & x33;
  assign new_n145_ = ~x07 & (x32 | x34 | ~x35 | new_n146_ | x37);
  assign new_n146_ = (x07 | x36 | (x38 ? (x39 | x40) : (~x39 | ~x40))) & (x38 | x39 | ~x13 | ~x36);
  assign z15 = x07 & x33;
  assign z16 = ~x07 & ~x32 & ~new_n149_ & x33;
  assign new_n149_ = (x34 | (~new_n157_ & (new_n150_ | ~x36))) & (~new_n158_ | ~x34 | x35 | x36);
  assign new_n150_ = (new_n151_ | x35) & (~new_n156_ | ~new_n155_ | ~x35 | ~x37);
  assign new_n151_ = (~x38 | (~new_n152_ & (~x37 | x39 | x40))) & (x37 | x38 | (~new_n154_ & x39));
  assign new_n152_ = x00 & new_n153_ & ~x01;
  assign new_n153_ = ~x02 & ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n154_ = ~x11 & ~x12 & x40;
  ...
  assign z21 = ~x33 | (~x07 & ((~new_n160_ & ~x34) | (~new_n166_ & ~x35)));
  ...
  assign new_n162_ = ~x00 & (new_n155_ | (~x05 & x38));
  assign new_n163_ = new_n164_ & ~x00;
  assign new_n164_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n165_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n166_ = (~x34 | new_n167_ | x36) & (~new_n155_ | ~x32 | ~x36 | x37);
  assign new_n167_ = new_n168_ & (x00 | x05 | x37 | new_n136_ | x38);
  assign new_n168_ = ~x32 & (~new_n136_ | ~x38 | x06 | ~x37);
  assign z26 = ~x07 & ~x32 & x33 & (new_n170_ | (new_n174_ & x00));
  assign new_n170_ = ~x35 & (new_n171_ | (new_n155_ & x34 & x36 & ~x37));
