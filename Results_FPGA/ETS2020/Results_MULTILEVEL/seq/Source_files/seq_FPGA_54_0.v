...
module FAU ( 
  ...
  assign new_n545_ = (~new_n297_ | ~x34 | x35 | x37) & (x34 | (~new_n547_ & (~x35 | new_n546_ | ~x37)));
  ...
  assign new_n593_ = x34 ? (x35 | new_n614_ | x36) : (x35 ? new_n594_ : new_n604_);
  assign new_n594_ = x37 ? ((new_n602_ | ~x36) & (x05 | ~new_n595_ | x36)) : new_n598_;
  assign new_n595_ = ~x38 & ~x39 & ~new_n596_ & x40;
  assign new_n596_ = (~x15 | ~x22 | ~x24 | new_n597_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n597_ = ~x21 & (x21 | new_n175_ | ~x23);
  assign new_n598_ = x36 ? ((x39 | (x38 & (~x38 | ~x40))) & (~x38 | ~x39 | (x40 & (~x06 | ~x40)))) : (~new_n599_ & (x38 | ~x39 | ~x40) & (~x38 | x39 | x40));
  assign new_n599_ = ~x05 & (new_n601_ | (x15 & x22 & new_n600_ & x24));
  assign new_n600_ = ~new_n92_ & ((x38 & ~new_n514_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n601_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n602_ = (~new_n603_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n603_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n113_ & x01 & ~x38));
  assign new_n604_ = (new_n613_ | ~x36) & (x05 | x31 | new_n605_ | x36);
  assign new_n605_ = ~new_n320_ & ~new_n606_ & new_n612_ & (x37 | (~new_n609_ & ~new_n610_));
  assign new_n606_ = x15 & ((~new_n607_ & x09) | (x16 & new_n153_ & x17));
  assign new_n607_ = x37 ? (x38 | x39 | new_n107_ | new_n155_) : (~x38 | new_n608_ | ~x39);
  assign new_n608_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n609_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n610_ = x39 & (new_n611_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n611_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n612_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n613_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n139_ | x40))) & (~x39 | (x38 ? x40 : (new_n288_ | ~x40)))));
  assign new_n614_ = x38 ? ((~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39)) & (x37 | x39 | x40)) : new_n615_;
  ...
  assign new_n618_ = ~new_n630_ & ~new_n619_ & (x36 | (~new_n639_ & (new_n636_ | x35)));
  assign new_n619_ = x39 & (~new_n625_ | (x38 & (new_n629_ | (~new_n620_ & ~x37))));
  assign new_n620_ = (x35 | (x36 ? new_n405_ : new_n621_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n641_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n406_ | ~new_n533_) & (x00 | ~x05)));
