// Benchmark "FAU" written by ABC on Thu Aug  6 17:00:44 2020
...
module FAU ( 
  ...
  assign new_n376_ = ~new_n377_ & (x05 | ~new_n219_ | ~x15);
  assign new_n377_ = ~x39 & (x01 | x03 | x04);
  assign new_n378_ = x15 & ~x34 & x35 & ~x39 & ~new_n212_ & ~new_n92_;
  ...
  assign new_n387_ = (new_n390_ | x40) & (~x00 | (~new_n130_ & (new_n388_ | ~x38)));
  assign new_n388_ = ~new_n389_ & (x35 | ~x40 | new_n123_ | (x37 ^ ~x39));
  ...
  assign new_n393_ = (x32 | (x34 ? (new_n416_ | x35) : new_n394_)) & (x34 | ~new_n422_ | x35);
  assign new_n394_ = x38 ? (~new_n402_ & ~new_n409_) : (x36 ? new_n413_ : new_n395_);
  assign new_n395_ = (~x37 | (x35 ? new_n398_ : new_n396_)) & (x05 | ~x35 | ~new_n400_ | x37);
  assign new_n396_ = ~new_n397_ & (x05 | x31 | ~new_n182_ | ~x39);
  assign new_n397_ = x11 & x12 & x14 & x15 & ~new_n145_ & ~x39;
  assign new_n398_ = ~x39 & (x39 | (x40 & (x05 | ~new_n399_ | ~x15)));
  assign new_n399_ = x21 & x22 & x24 & ~new_n92_ & x40;
  assign new_n400_ = ~x39 & ((new_n401_ & x15) | (new_n158_ & ~x13));
  assign new_n401_ = x24 & ~new_n92_ & (x40 | (x21 & x22 & ~x40));
  assign new_n402_ = ~x35 & (x36 ? ~new_n403_ : (new_n408_ | (~new_n406_ & x40)));
  ...
  assign new_n407_ = x12 & x14 & x15 & ~x37 & ~new_n145_ & x39;
  ...
  assign new_n433_ = (~new_n405_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n112_ | x36 | x37);
  ...
  assign new_n441_ = ~x39 & ((x15 & ~new_n145_ & ~new_n154_) | new_n92_ | ~x15);
  ...
  assign new_n445_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n446_ = ~new_n149_ & new_n447_ & ~new_n205_ & new_n102_;
  ...
  assign new_n465_ = (~x34 | new_n466_ | x36) & (~new_n297_ | ~x32 | ~x36 | x37);
  ...
  assign new_n470_ = (~x05 | new_n473_ | x32) & (x35 | (new_n423_ & (~x05 | new_n471_ | x32)));
  assign new_n471_ = ~new_n149_ & (~x38 | (~x37 & x39)) & new_n472_ & (~x39 | (x38 & x40));
  assign new_n472_ = new_n102_ & x14 & ~new_n205_ & x15;
  assign new_n473_ = (x37 | x38 | x39) & (~x39 | x40 | x00 | ~x38) & (~x35 | ((x37 | ~x38 | ~x39) & (x38 | x39 | ~x40)));
  assign new_n474_ = x38 & ((x37 & (x35 | (~x39 & x40))) | (x39 & x40 & ~x35 & ~x37));
  assign new_n475_ = x05 & ~x32 & new_n476_ & ~x35;
  assign new_n476_ = ~x36 & ~x38 & ((new_n87_ & x37) | (~x00 & ~new_n87_ & ~x37));
  ...
  assign new_n482_ = ~new_n92_ & (new_n483_ | (x35 & ~new_n484_ & x40));
  ...
  assign new_n487_ = x35 & ~new_n92_ & (~x37 | (~x24 & x40));
  assign new_n488_ = (~new_n489_ | x05) & (~x35 | ~x37 | x40);
  assign new_n489_ = ~new_n86_ & ((x37 & (x13 ? (~x31 & ~x35) : (x35 ? x40 : ~x31))) | (x35 & (x13 ? (~x37 | x40) : ~x37)));
  ...
  assign new_n494_ = (~x40 | (~new_n495_ & new_n86_)) & (~x39 | (x37 ? (new_n496_ | x40) : new_n86_));
  assign new_n495_ = ~x09 & x15 & ~new_n92_ & ~x16;
  ...
  assign new_n502_ = ~new_n203_ & x39;
  assign new_n503_ = ~x16 & ~new_n92_ & ((~x17 & x39 & x40) | (~x09 & ~x40));
  assign new_n504_ = ~x40 & ((~x39 & (new_n92_ | ~x15)) | (x09 & ~x13 & ~x15 & x39));
  ...
  assign new_n515_ = ((~new_n516_ & x40) | (x37 ^ ~x39)) & (~x39 | (~x37 & (~new_n455_ | x37 | ~x40))) & (x37 | x39 | (~x40 & (new_n517_ | x40)));
  ...
  assign new_n522_ = ~new_n205_ & x11 & x12 & x14 & x15;
  assign new_n523_ = x14 & ~new_n125_ & x15 & ~new_n205_ & new_n102_;
  ...
  assign new_n527_ = x34 & (x37 ? (~x39 | (x39 & ~x40)) : (new_n189_ | ~x39 | (~new_n123_ & x39)));
  assign new_n528_ = x15 & ~x31 & new_n87_ & ~x37;
  assign new_n529_ = ~new_n87_ & (new_n455_ | (new_n530_ & new_n531_));
  assign new_n530_ = x00 & ~x01 & x02;
  assign new_n531_ = ~x03 & x04 & x34;
  assign new_n532_ = (~x05 | ~x39 | ~x40) & (~x34 | (x39 ? (x40 & (x05 | ~x40)) : new_n221_));
  assign new_n533_ = x34 & ((x39 & (x40 | (x00 & ~x01 & ~x04 & ~x40))) | (x00 & ~x01 & ~x04 & ~x39));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n545_ : ~new_n535_);
  assign new_n535_ = new_n536_ & (x38 | (~new_n542_ & (x35 | (~new_n373_ & ~new_n374_))));
  assign new_n536_ = ~new_n391_ & (x34 | (~new_n541_ & (new_n537_ | x05)));
  assign new_n537_ = (x31 | ~new_n114_ | x35) & (~x15 | new_n538_ | new_n92_);
  assign new_n538_ = ~new_n386_ & (~x38 | (~new_n385_ & (x37 | (~new_n382_ & ~new_n539_))));
  ...
  assign new_n545_ = (new_n387_ | x34) & (~new_n297_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n550_ : ~new_n547_);
  assign new_n547_ = (x05 | new_n537_ | x34) & (x38 | (~new_n548_ & ~new_n542_));
  assign new_n548_ = ~x35 & (new_n373_ | (x34 & (new_n218_ | (new_n549_ & x00))));
  assign new_n549_ = ~x01 & x02 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n550_ = (~new_n297_ | ~x34 | x35 | x37) & (x34 | (~new_n552_ & (~x35 | new_n551_ | ~x37)));
  assign new_n551_ = (~new_n125_ | x38) & (~new_n530_ | x03 | ~x04 | ~x38);
  assign new_n552_ = new_n112_ & new_n153_ & x10 & x27 & ~x35;
  assign z26 = ~x07 & ~x32 & x33 & (new_n557_ | (~new_n554_ & ~x35));
  assign new_n554_ = (new_n555_ | new_n123_) & (~new_n297_ | ~x34 | ~x36 | x37);
  assign new_n555_ = (new_n556_ | ~x38) & (~new_n122_ | ~x34 | x36);
  assign new_n556_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (x37 ^ ~x39));
  assign new_n557_ = x00 & ~x34 & x35 & new_n131_ & x36;
  ...
  assign new_n562_ = (x38 | new_n544_ | x39) & (x37 | ~x38 | new_n214_ | ~x39);
  assign new_n563_ = ~x09 & ~x17 & (new_n298_ | new_n122_);
  ...
  assign new_n568_ = new_n198_ & ~x34 & x35 & x36;
  assign z28 = ~x07 & ~x32 & x33 & (new_n570_ | new_n572_);
  assign new_n570_ = x00 & ~x01 & x02 & ~x03 & ~new_n571_ & x04;
  assign new_n571_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n87_ | x38);
  assign new_n572_ = new_n138_ & ~x34 & ~x35 & new_n111_ & x36 & ~x37;
  assign z29 = ~x07 & ~x32 & x33 & (new_n568_ | (new_n574_ & ~x05));
  assign new_n574_ = ~x36 & ((~new_n575_ & ~x34) | (x15 & new_n324_ & ~x21));
  assign new_n575_ = (x31 | ~new_n579_ | x35) & (x40 | (~new_n576_ & (x31 | ~new_n578_ | x35)));
  assign new_n576_ = x15 & ~x21 & x22 & new_n577_ & x24;
  assign new_n577_ = x35 & ~x37 & ~new_n92_ & (~x38 ^ x39);
  assign new_n578_ = x37 & ~x38 & ~new_n90_ & x39;
  assign new_n579_ = x38 & ~x39 & ~new_n90_ & x40;
  assign z30 = ~x07 & ~x32 & x33 & (new_n581_ | new_n572_);
  assign new_n581_ = ~x05 & x15 & ~x36 & ~new_n582_ & ~new_n92_;
  assign new_n582_ = ~new_n565_ & (~x24 | x34 | new_n583_ | ~x35);
  assign new_n583_ = x22 ? new_n584_ : ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))));
  assign new_n584_ = (new_n585_ | x21) & (~new_n125_ | ~x38 | ~x21 | x23 | x37);
  assign new_n585_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n174_ | ~x40)));
  assign z31 = ~x07 & ~x32 & x33 & (new_n595_ | (~new_n587_ & ~x34));
  assign new_n587_ = (new_n588_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  assign new_n588_ = ~new_n593_ & (x05 | ~new_n589_ | ~x15);
  assign new_n589_ = ~x36 & ~new_n92_ & ((new_n590_ & ~x38) | (~x37 & new_n592_ & x38));
  assign new_n590_ = ~x39 & ((~x24 & ~x37) | (x40 & (new_n591_ | ~x24)));
  assign new_n591_ = ~x21 & x22 & ~x23 & x24 & ~new_n174_ & x37;
  assign new_n592_ = x39 & (~x24 | (x21 & x22 & ~x23 & x24 & ~x40));
  assign new_n593_ = new_n594_ & x00 & ~x01 & x02 & ~x03;
  assign new_n594_ = x04 & x36 & x37 & x38;
  assign new_n595_ = x00 & ~x01 & x02 & ~x03 & new_n596_ & x04;
  assign new_n596_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n87_ & ~x38;
  assign z32 = ~x40 & ~x39 & x38 & new_n598_ & x37;
  assign new_n598_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z33 = x33 ? (x07 | (~x07 & ~new_n600_ & ~x32)) : x32;
  assign new_n600_ = x34 ? (x35 | new_n621_ | x36) : (x35 ? new_n601_ : new_n611_);
  assign new_n601_ = x37 ? ((new_n609_ | ~x36) & (x05 | ~new_n602_ | x36)) : new_n605_;
  assign new_n602_ = ~x38 & ~x39 & ~new_n603_ & x40;
  assign new_n603_ = (~x15 | ~x22 | ~x24 | new_n604_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n604_ = ~x21 & (x21 | new_n174_ | ~x23);
  ...
  assign new_n607_ = ~new_n92_ & ((x38 & ~new_n512_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n608_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n609_ = (~new_n610_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n610_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n112_ & x01 & ~x38));
  assign new_n611_ = (new_n620_ | ~x36) & (x05 | x31 | new_n612_ | x36);
  assign new_n612_ = ~new_n320_ & ~new_n613_ & new_n619_ & (x37 | (~new_n616_ & ~new_n617_));
  assign new_n613_ = x15 & ((~new_n614_ & x09) | (x16 & new_n152_ & x17));
  assign new_n614_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n615_ | ~x39);
  assign new_n615_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n616_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n617_ = x39 & (new_n618_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n618_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n619_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n620_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n288_ | ~x40)))));
  assign new_n621_ = x38 ? ((~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39)) & (x37 | x39 | x40)) : new_n622_;
  assign new_n622_ = ~new_n623_ & (x01 | x02 | new_n430_ | x03);
  assign new_n623_ = x39 & x40 & (~x37 | (~x05 & ~new_n312_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~x32 & (new_n647_ | (~new_n625_ & ~x34))));
  assign new_n625_ = ~new_n637_ & ~new_n626_ & (x36 | (~new_n646_ & (new_n643_ | x35)));
  assign new_n626_ = x39 & (~new_n632_ | (x38 & (new_n636_ | (~new_n627_ & ~x37))));
  assign new_n627_ = (x35 | (x36 ? new_n404_ : new_n628_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n628_ = ~new_n631_ & (~x15 | (~new_n630_ & (x05 | new_n629_ | x31)));
  assign new_n629_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  assign new_n630_ = x11 & x12 & x14 & ~new_n145_ & x40;
  ...
  assign new_n648_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n405_ | ~new_n531_) & (x00 | ~x05)));
