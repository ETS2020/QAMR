...
module FAU ( 
  ...
  assign new_n394_ = x33 & ((~x32 & (x34 ? new_n417_ : ~new_n395_)) | (new_n423_ & ~x34));
  ...
  assign new_n417_ = ~x35 & ((~new_n418_ & ~x36) | (new_n297_ & x36 & ~x37));
  ...
  assign new_n423_ = ~x35 & ~new_n424_ & ~x36;
  ...
  assign new_n595_ = ~new_n92_ & ((x38 & ~new_n513_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  ...
  assign new_n610_ = ~new_n611_ & (x01 | x02 | new_n431_ | x03);
  ...
  assign new_n615_ = (x35 | (x36 ? new_n405_ : new_n616_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n628_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n442_ & ~x38));
  ...
  assign new_n636_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n406_ | ~new_n532_) & (x00 | ~x05)));
