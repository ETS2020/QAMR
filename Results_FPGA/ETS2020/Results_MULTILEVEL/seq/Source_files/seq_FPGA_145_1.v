// Benchmark "FAU" written by ABC on Thu Aug  6 16:59:45 2020
...
module FAU ( 
  ...
  assign z29 = ~x07 & ~x32 & ~new_n148_ & x33;
  assign new_n148_ = (~new_n157_ | x34 | ~x35 | ~x36) & (x05 | new_n149_ | x36);
  assign new_n149_ = (new_n150_ | x34) & (~x15 | x21 | ~x22 | ~new_n155_ | ~x34);
  assign new_n150_ = (x31 | ~new_n154_ | x35) & (x40 | (~new_n151_ & (x31 | ~new_n153_ | x35)));
  assign new_n151_ = x15 & ~x21 & x22 & new_n152_ & x24;
  assign new_n152_ = x35 & ~x37 & (x11 | x12) & (x38 ^ ~x39);
  assign new_n153_ = x37 & ~x38 & x39 & (x28 ? (~x29 & ~x30) : (x29 & x30));
  assign new_n154_ = x38 & ~x39 & x40 & (x28 ? (~x29 & ~x30) : (x29 & x30));
  assign new_n155_ = new_n156_ & ~x35;
  assign new_n156_ = x37 & ~x38 & x39 & x40 & (x11 | x12);
  assign new_n157_ = x37 & ~x38 & x39 & ~x40;
  assign z32 = ~x40 & ~x39 & x38 & new_n159_ & x37;
  assign new_n159_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
