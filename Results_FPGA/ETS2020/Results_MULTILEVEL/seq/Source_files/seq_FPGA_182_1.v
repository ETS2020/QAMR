...
module FAU ( 
  ...
  assign z28 = ~x07 & ~x32 & x33 & (new_n146_ | new_n148_);
  assign new_n146_ = x00 & ~x01 & x02 & ~x03 & ~new_n147_ & x04;
  assign new_n147_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n107_ | x38);
  assign new_n148_ = new_n149_ & ~x34 & ~x35 & x10 & x27;
  assign new_n149_ = x36 & ~x37 & x38 & ~x39 & ~x40;
