// Benchmark "FAU" written by ABC on Thu Aug  6 17:02:30 2020
...
module FAU ( 
  ...
  assign z16 = ~x07 & ~x32 & ~new_n119_ & x33;
  assign new_n119_ = (x34 | (~new_n127_ & (new_n120_ | ~x36))) & (~new_n128_ | ~x34 | x35 | x36);
  ...
  assign new_n135_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n136_ = (~x34 | new_n137_ | x36) & (~new_n125_ | ~x32 | ~x36 | x37);
  assign new_n137_ = new_n138_ & (x00 | x05 | x37 | new_n107_ | x38);
  assign new_n138_ = ~x32 & (~new_n107_ | ~x38 | x06 | ~x37);
  ...
  assign z32 = ~x40 & ~x39 & x38 & new_n147_ & x37;
  assign new_n147_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
