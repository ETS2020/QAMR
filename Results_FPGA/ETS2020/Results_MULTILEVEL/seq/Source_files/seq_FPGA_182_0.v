...
module FAU ( 
  ...
  assign z29 = ~x07 & ~x32 & x33 & (new_n566_ | (new_n568_ & ~x05));
  ...
  assign z30 = ~x07 & new_n575_ & ~x32;
  assign new_n575_ = x33 & (new_n580_ | (~x05 & x15 & new_n576_ & ~x36));
  assign new_n576_ = ~new_n92_ & (new_n563_ | (x24 & ~x34 & ~new_n577_ & x35));
  ...
  assign new_n582_ = (new_n583_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  ...
  assign new_n586_ = ~x21 & x22 & ~x23 & x24 & ~new_n174_ & x37;
  ...
  assign new_n597_ = ~x21 & (x21 | new_n174_ | ~x23);
  ...
  assign new_n600_ = ~new_n92_ & ((x38 & ~new_n510_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n601_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n602_ = (~new_n603_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n603_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n112_ & x01 & ~x38));
  ...
  assign new_n606_ = x15 & ((~new_n607_ & x09) | (x16 & new_n152_ & x17));
  assign new_n607_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n608_ | ~x39);
  ...
  assign new_n615_ = ~new_n616_ & (x01 | x02 | new_n428_ | x03);
  ...
  assign new_n620_ = (x35 | (x36 ? new_n402_ : new_n621_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n621_ = ~new_n624_ & (~x15 | (~new_n623_ & (x05 | new_n622_ | x31)));
  assign new_n622_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  assign new_n623_ = x11 & x12 & x14 & ~new_n145_ & x40;
  ...
  assign new_n633_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n439_ & ~x38));
  assign new_n634_ = ~x39 & (x35 ? (new_n635_ | (x06 & x40)) : ~x40);
  assign new_n635_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n636_ = x05 ? (new_n637_ & ~new_n149_) : ~new_n638_;
  assign new_n637_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  ...
  assign new_n641_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n403_ | ~new_n529_) & (x00 | ~x05)));
