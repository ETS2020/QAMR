// Benchmark "FAU" written by ABC on Thu Aug  6 16:55:21 2020
...
module FAU ( 
  ...
  assign new_n169_ = (x05 | (~new_n170_ & (x31 | ~new_n181_ | x35))) & (~new_n183_ | ~x35);
  assign new_n170_ = x40 & ((x35 & (new_n171_ | new_n175_)) | (~x31 & new_n178_ & ~x35));
  ...
  assign new_n176_ = x38 & x39 & ~new_n92_ & ~new_n177_;
  ...
  assign new_n183_ = x37 & (x38 ? (x39 & x40) : (~x39 & ~x40));
  assign new_n184_ = ~new_n161_ & (new_n185_ | ~x36);
  ...
  assign new_n187_ = x37 ? (new_n188_ | x38) : (~x38 | (~new_n112_ & ~new_n189_));
  ...
  assign new_n241_ = ~new_n92_ & (~x37 | (~x21 & x22 & x23 & ~new_n173_ & x37));
  ...
  assign new_n260_ = (x39 | x40) & (~new_n166_ | x04 | ~x39 | ~x40);
  ...
  assign z19 = ~x07 & ~x32 & x33 & (x38 ? ~new_n398_ : ~new_n394_);
  assign new_n394_ = (x35 | (~new_n395_ & (~new_n366_ | x34 | ~x36))) & (x34 | ~new_n397_ | ~x35);
  ...
  assign new_n398_ = (~new_n401_ | ~x06) & (x34 | new_n399_ | ~x35);
  assign new_n399_ = (~new_n400_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n112_ | x36 | x37);
  assign new_n400_ = x00 & ~x01 & ~x02;
  ...
  assign new_n405_ = (~new_n406_ | x05) & (x00 | new_n87_ | ~x05);
  assign new_n406_ = ~x34 & (x31 | (~x31 & ~new_n86_ & x39));
  assign new_n407_ = ~x31 & ~x34 & (new_n158_ | (new_n408_ & x37));
  assign new_n408_ = ~x39 & ((x15 & ~new_n145_ & ~new_n154_) | new_n92_ | ~x15);
  assign new_n409_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n86_ & x40));
  assign new_n410_ = (new_n415_ | ~x37) & (new_n413_ | ~x05) & (x05 | (x31 ? new_n413_ : (new_n411_ | x37)));
  assign new_n411_ = (~x38 | x39 | new_n86_ | x40) & (~x39 | (~new_n305_ & (~x40 | (~new_n412_ & new_n86_))));
  assign new_n412_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n413_ = ~new_n149_ & new_n414_ & ~new_n205_ & new_n102_;
  assign new_n414_ = x14 & x15 & (~x39 | x40) & (~x38 | x39);
  assign new_n415_ = x05 ? ~x38 : (~x31 | ~x39);
  assign new_n416_ = (new_n417_ | (~x05 & (x05 | new_n86_ | ~x13))) & (x05 | new_n86_ | new_n418_);
  assign new_n417_ = ~new_n121_ & (~new_n127_ | x38);
  ...
  assign z21 = ~x33 | (~x07 & ((~new_n426_ & ~x34) | (~new_n432_ & ~x35)));
  assign new_n426_ = (~x36 | (~new_n429_ & ~x32 & (new_n427_ | ~x35))) & (~x35 | (~new_n431_ & ~x32));
  assign new_n427_ = (~x37 | (~new_n428_ & (x06 | x38 | x39 | ~x40))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n428_ = ~x00 & (x38 ? ~x05 : new_n112_);
  assign new_n429_ = new_n430_ & ~x00;
  assign new_n430_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n431_ = new_n125_ & x38 & ~x00 & ~x05 & x37;
  assign new_n432_ = (~x34 | new_n433_ | x36) & (~new_n297_ | ~x32 | ~x36 | x37);
  assign new_n433_ = new_n434_ & (x00 | x05 | x37 | new_n87_ | x38);
  assign new_n434_ = ~x32 & (~new_n87_ | ~x38 | x06 | ~x37);
  assign z22 = ~x07 & x33 & (new_n436_ | (x05 & new_n446_ & ~x32));
  assign new_n436_ = ~x34 & (new_n437_ | (~x00 & x05 & new_n445_ & ~x32));
  assign new_n437_ = ~x36 & (new_n438_ | (x05 & ~new_n444_ & ~x32));
  assign new_n438_ = ~x35 & (x32 | (~x05 & ~new_n439_ & ~x31) | (x05 & ~new_n442_ & ~x32));
  ...
  assign new_n442_ = ~new_n149_ & (~x38 | (~x37 & x39)) & new_n443_ & (~x39 | (x38 & x40));
  assign new_n443_ = new_n102_ & x14 & ~new_n205_ & x15;
  assign new_n444_ = (x37 | x38 | x39) & (~x39 | x40 | x00 | ~x38) & (~x35 | ((x38 | x39 | ~x40) & (x37 | ~x38 | ~x39)));
  assign new_n445_ = x36 & x38 & ((x37 & (x35 | (~x39 & x40))) | (x39 & x40 & ~x35 & ~x37));
  assign new_n446_ = ~x35 & ~x36 & ~x38 & ((new_n87_ & x37) | (~x00 & ~new_n87_ & ~x37));
  assign z23 = x33 & (x07 | (~x07 & ~x32 & (new_n494_ | (~new_n448_ & ~x34))));
  assign new_n448_ = (new_n449_ | x38) & (new_n469_ | ~x38) & (x35 | new_n489_ | x36);
  assign new_n449_ = (new_n450_ | x39) & (x35 | (~new_n463_ & ~new_n467_)) & (~x35 | new_n468_ | ~x39);
  assign new_n450_ = x36 ? new_n460_ : (~new_n462_ & new_n458_ & (new_n451_ | ~x15));
  assign new_n451_ = (~new_n457_ | x05) & (~x37 | (~new_n456_ & (x05 | (~new_n452_ & ~new_n455_))));
  assign new_n452_ = ~new_n92_ & (new_n453_ | (x35 & ~new_n454_ & x40));
  assign new_n453_ = ~x31 & ~x35 & ((~x16 & ~x17) | (~x09 & (~x16 | ~x17)));
  assign new_n454_ = (x21 | ((x09 | (x18 & x19)) & (x18 | x19) & (~x22 | ~x24 | ((~x18 | ~x19) & (~x09 | (~x18 & ~x19)))))) & (~x24 | (x22 & (~x21 | ~x22)));
  assign new_n455_ = ~x31 & ~x35 & ((x11 & x12 & ~x14) | (~new_n145_ & (~x11 ^ ~x12)));
  assign new_n456_ = x11 & x12 & x14 & ~new_n145_ & ~x35;
  assign new_n457_ = x35 & ~new_n92_ & (~x37 | (~x24 & x40));
  assign new_n458_ = (~new_n459_ | x05) & (~x35 | ~x37 | x40);
  assign new_n459_ = ~new_n86_ & ((x37 & (x13 ? (~x31 & ~x35) : (x35 ? x40 : ~x31))) | (x35 & (x13 ? (~x37 | x40) : ~x37)));
  assign new_n460_ = x35 ? (x37 & (~x00 | ~x37 | new_n461_ | x40)) : (x37 & (~x37 | ~x40));
  assign new_n461_ = x01 & ~x02 & ~x03 & x04 & (x03 | ~x04 | ~x01 | x02);
  assign new_n462_ = x05 & (~x37 | (x35 & x40));
  assign new_n463_ = ~x36 & (x05 ? x39 : (x31 ? ~x37 : ~new_n464_));
  assign new_n464_ = (~x40 | (~new_n465_ & new_n86_)) & (~x39 | (x37 ? (new_n466_ | x40) : new_n86_));
  assign new_n465_ = ~x09 & x15 & ~new_n92_ & ~x16;
  ...
  assign new_n468_ = x36 ? (x37 & (~x37 | x40)) : ~x37;
  assign new_n469_ = ~new_n488_ & (new_n479_ | ~x35) & (x35 | (x36 ? new_n485_ : new_n470_));
  assign new_n470_ = (~x05 | (~x37 & x39)) & ~new_n477_ & (x05 | (x31 ? x39 : new_n471_));
  assign new_n471_ = new_n475_ & (x37 | (~new_n474_ & (~x15 | (~new_n472_ & ~new_n473_))));
  assign new_n472_ = ~new_n203_ & x39;
  assign new_n473_ = ~x16 & ~new_n92_ & ((~x17 & x39 & x40) | (~x09 & ~x40));
  assign new_n474_ = ~x40 & ((~x39 & (new_n92_ | ~x15)) | (x09 & ~x13 & ~x15 & x39));
  assign new_n475_ = (x39 | new_n466_ | ~x40) & (x09 | ~x39 | (~new_n476_ & ~x37 & x40));
  assign new_n476_ = x15 & ~x17 & (x11 | x12);
  assign new_n477_ = x11 & x12 & x14 & new_n478_ & x15;
  assign new_n478_ = ~x37 & x39 & ~new_n145_ & x40;
  assign new_n479_ = x37 ? new_n483_ : (x39 ? (x36 ? x40 : new_n480_) : ~x40);
  assign new_n480_ = ~x05 & (x05 | (~new_n92_ & x15 & (~x15 | new_n92_ | (new_n105_ & (new_n481_ | ~x24)))));
  assign new_n481_ = x22 & (~x22 | (new_n482_ & (x40 | (x21 & (~x21 | x23)))));
  assign new_n482_ = x21 ? (~x23 & ~x40) : (~x40 | (~x09 & ~x18));
  assign new_n483_ = (~x00 | (~new_n484_ & (x36 | ~x39 | x40))) & (x00 | ~x05 | ~x36) & (x36 | (x39 & (~x39 | ~x40)));
  assign new_n484_ = ~x01 & x36 & (~x04 | (x02 & ~x03 & x04));
  assign new_n485_ = ((~new_n486_ & x40) | (x37 ^ ~x39)) & (~x39 | (~x37 & (~new_n422_ | x37 | ~x40))) & (x37 | x39 | (~x40 & (new_n487_ | x40)));
  assign new_n486_ = x00 & x40 & (x01 | x02 | x03 | x04 | (~x01 & ~x02 & ~x03 & ~x04));
  assign new_n487_ = x10 & x27 & (~x10 | ~x27);
  assign new_n488_ = ~x00 & x05 & ((~x36 & x39 & ~x40) | (x36 & x37 & ~x39 & x40));
  assign new_n489_ = x05 ? (new_n493_ & ~new_n149_) : (~new_n490_ & (~x31 | (new_n492_ & ~new_n149_)));
  assign new_n490_ = x39 & (x31 ? (x37 | ~x40) : (~new_n491_ & ~x37));
  assign new_n491_ = ~new_n465_ & ~new_n158_ & (~x09 | ~x13 | x15);
  assign new_n492_ = ~new_n205_ & x11 & x12 & x14 & x15;
  assign new_n493_ = x14 & ~new_n125_ & x15 & ~new_n205_ & new_n102_;
  assign new_n494_ = ~x35 & ((~new_n495_ & ~x36) | (new_n297_ & x34 & x36 & ~x37));
  assign new_n495_ = x38 ? new_n496_ : (x37 ? new_n502_ : (~new_n499_ & ~new_n503_));
  assign new_n496_ = ~new_n497_ & (~new_n498_ | x05 | ~x11 | ~x12 | x14);
  assign new_n497_ = x34 & (x37 ? (~x39 | (x39 & ~x40)) : (new_n189_ | ~x39 | (~new_n123_ & x39)));
  assign new_n498_ = x15 & ~x31 & new_n87_ & ~x37;
  assign new_n499_ = ~new_n87_ & (new_n422_ | (new_n500_ & new_n501_));
  assign new_n500_ = x00 & ~x01 & x02;
  assign new_n501_ = ~x03 & x04 & x34;
  assign new_n502_ = (~x05 | ~x39 | ~x40) & (~x34 | (x39 ? (x40 & (x05 | ~x40)) : new_n221_));
  assign new_n503_ = x34 & ((x39 & (x40 | (x00 & ~x01 & ~x04 & ~x40))) | (x00 & ~x01 & ~x04 & ~x39));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n515_ : ~new_n505_);
  assign new_n505_ = new_n506_ & (x38 | (~new_n512_ & (x35 | (~new_n374_ & ~new_n375_))));
  assign new_n506_ = ~new_n392_ & (x34 | (~new_n511_ & (new_n507_ | x05)));
  assign new_n507_ = (x31 | ~new_n114_ | x35) & (~x15 | new_n508_ | new_n92_);
  assign new_n508_ = ~new_n387_ & (~x38 | (~new_n386_ & (x37 | (~new_n383_ & ~new_n509_))));
  assign new_n509_ = x39 & (new_n106_ | new_n510_);
  assign new_n510_ = x35 & (~x24 | (x24 & (~x22 | (x22 & ~x40 & (~x21 | (x21 & ~x23))))));
  assign new_n511_ = new_n111_ & x35 & x37;
  assign new_n512_ = ~x05 & new_n513_ & x15;
  assign new_n513_ = ~x34 & x35 & ~x39 & ~new_n514_ & ~new_n92_;
  assign new_n514_ = (~x40 | (x24 & (~x37 | ((new_n97_ | x21) & (x22 | ~x24))))) & (x37 | (x24 & (~x24 | x40 | (x22 & (x21 | ~x22)))));
  assign new_n515_ = (new_n388_ | x34) & (~new_n297_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n520_ : ~new_n517_);
  assign new_n517_ = (x05 | new_n507_ | x34) & (x38 | (~new_n518_ & ~new_n512_));
  assign new_n518_ = ~x35 & (new_n374_ | (x34 & (new_n218_ | (new_n519_ & x00))));
  assign new_n519_ = ~x01 & x02 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n520_ = (~new_n297_ | ~x34 | x35 | x37) & (x34 | (~new_n522_ & (~x35 | new_n521_ | ~x37)));
  assign new_n521_ = (~new_n125_ | x38) & (~new_n500_ | x03 | ~x04 | ~x38);
  assign new_n522_ = new_n112_ & new_n153_ & x10 & x27 & ~x35;
  assign z26 = ~x07 & ~x32 & x33 & (new_n527_ | (~new_n524_ & ~x35));
  assign new_n524_ = (new_n525_ | new_n123_) & (~new_n297_ | ~x34 | ~x36 | x37);
  assign new_n525_ = (new_n526_ | ~x38) & (~new_n122_ | ~x34 | x36);
  assign new_n526_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (x37 ^ ~x39));
  assign new_n527_ = x00 & ~x34 & x35 & new_n131_ & x36;
  assign z27 = ~x07 & ~x32 & x33 & (new_n538_ | (new_n529_ & ~x05));
  assign new_n529_ = ~x36 & (new_n530_ | (~x09 & ~x31 & new_n537_ & ~x34));
  assign new_n530_ = x15 & ~new_n92_ & (new_n535_ | (~new_n531_ & ~x34));
  assign new_n531_ = (new_n532_ | ~x35) & (x31 | x35 | (~new_n533_ & (new_n534_ | x16)));
  assign new_n532_ = (x38 | new_n514_ | x39) & (x37 | ~x38 | new_n214_ | ~x39);
  assign new_n533_ = ~x09 & ~x17 & (new_n298_ | new_n122_);
  assign new_n534_ = (x17 | ((~x37 | x38 | x39) & (~x39 | ~x40 | x37 | ~x38))) & (x09 | ((x38 | (~x40 & (~x37 | x39))) & (x37 | (~x39 & (~x38 | x40)))));
  assign new_n535_ = x34 & new_n536_ & ~x35;
  assign new_n536_ = x37 & ~x38 & x39 & x40 & (~x22 | (~x21 & x22));
  assign new_n537_ = ~x35 & x38 & x39 & (x37 | ~x40);
  assign new_n538_ = new_n198_ & ~x34 & x35 & x36;
  assign z28 = ~x07 & ~x32 & x33 & (new_n540_ | new_n542_);
  assign new_n540_ = x00 & ~x01 & x02 & ~x03 & ~new_n541_ & x04;
  assign new_n541_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n87_ | x38);
  assign new_n542_ = new_n138_ & ~x34 & ~x35 & new_n111_ & x36 & ~x37;
  assign z29 = ~x07 & ~x32 & x33 & (new_n538_ | (new_n544_ & ~x05));
  assign new_n544_ = ~x36 & ((~new_n545_ & ~x34) | (x15 & new_n324_ & ~x21));
  assign new_n545_ = (x31 | ~new_n549_ | x35) & (x40 | (~new_n546_ & (x31 | ~new_n548_ | x35)));
  assign new_n546_ = x15 & ~x21 & x22 & new_n547_ & x24;
  assign new_n547_ = x35 & ~x37 & ~new_n92_ & (~x38 ^ x39);
  assign new_n548_ = x37 & ~x38 & ~new_n90_ & x39;
  assign new_n549_ = x38 & ~x39 & ~new_n90_ & x40;
  assign z30 = ~x07 & ~x32 & x33 & (new_n551_ | new_n542_);
  assign new_n551_ = ~x05 & x15 & ~x36 & ~new_n552_ & ~new_n92_;
  assign new_n552_ = ~new_n535_ & (~x24 | x34 | new_n553_ | ~x35);
  assign new_n553_ = x22 ? new_n554_ : ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))));
  assign new_n554_ = (new_n555_ | x21) & (~new_n125_ | ~x38 | ~x21 | x23 | x37);
  assign new_n555_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n173_ | ~x40)));
  assign z31 = ~x07 & ~x32 & x33 & (new_n565_ | (~new_n557_ & ~x34));
  assign new_n557_ = (new_n558_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  assign new_n558_ = ~new_n563_ & (x05 | ~new_n559_ | ~x15);
  assign new_n559_ = ~x36 & ~new_n92_ & ((new_n560_ & ~x38) | (~x37 & new_n562_ & x38));
  assign new_n560_ = ~x39 & ((~x24 & ~x37) | (x40 & (new_n561_ | ~x24)));
  assign new_n561_ = ~x21 & x22 & ~x23 & x24 & ~new_n173_ & x37;
  assign new_n562_ = x39 & (~x24 | (x21 & x22 & ~x23 & x24 & ~x40));
  assign new_n563_ = new_n564_ & x00 & ~x01 & x02 & ~x03;
  assign new_n564_ = x04 & x36 & x37 & x38;
  assign new_n565_ = x00 & ~x01 & x02 & ~x03 & new_n566_ & x04;
  assign new_n566_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n87_ & ~x38;
  assign z33 = x33 ? (x07 | (~x07 & ~new_n568_ & ~x32)) : x32;
  assign new_n568_ = x34 ? (x35 | new_n589_ | x36) : (x35 ? new_n569_ : new_n579_);
  assign new_n569_ = x37 ? ((new_n577_ | ~x36) & (x05 | ~new_n570_ | x36)) : new_n573_;
  assign new_n570_ = ~x38 & ~x39 & ~new_n571_ & x40;
  assign new_n571_ = (~x15 | ~x22 | ~x24 | new_n572_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n572_ = ~x21 & (x21 | new_n173_ | ~x23);
  assign new_n573_ = x36 ? ((x39 | (x38 & (~x38 | ~x40))) & (~x38 | ~x39 | (x40 & (~x06 | ~x40)))) : (~new_n574_ & (x38 | ~x39 | ~x40) & (~x38 | x39 | x40));
  assign new_n574_ = ~x05 & (new_n576_ | (x15 & x22 & new_n575_ & x24));
  assign new_n575_ = ~new_n92_ & ((x38 & ~new_n482_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n576_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n577_ = (~new_n578_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n578_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n112_ & x01 & ~x38));
  assign new_n579_ = (new_n588_ | ~x36) & (x05 | x31 | new_n580_ | x36);
  assign new_n580_ = ~new_n320_ & ~new_n581_ & new_n587_ & (x37 | (~new_n584_ & ~new_n585_));
  assign new_n581_ = x15 & ((~new_n582_ & x09) | (x16 & new_n152_ & x17));
  assign new_n582_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n583_ | ~x39);
  assign new_n583_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n584_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n585_ = x39 & (new_n586_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n586_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n587_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n588_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n288_ | ~x40)))));
  assign new_n589_ = x38 ? ((~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39)) & (x37 | x39 | x40)) : new_n590_;
  assign new_n590_ = ~new_n591_ & (x01 | x02 | new_n396_ | x03);
  assign new_n591_ = x39 & x40 & (~x37 | (~x05 & ~new_n312_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~x32 & (new_n616_ | (~new_n593_ & ~x34))));
  assign new_n593_ = ~new_n606_ & ~new_n594_ & (x36 | (~new_n615_ & (new_n612_ | x35)));
  assign new_n594_ = x39 & (~new_n601_ | (x38 & (new_n605_ | (~new_n595_ & ~x37))));
  assign new_n595_ = (x35 | (x36 ? (~new_n600_ & x40) : new_n596_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n596_ = ~new_n599_ & (~x15 | (~new_n598_ & (x05 | new_n597_ | x31)));
  assign new_n597_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  assign new_n598_ = x11 & x12 & x14 & ~new_n145_ & x40;
  assign new_n599_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n600_ = new_n400_ & ~x03 & ~x04 & x40;
  assign new_n601_ = (x35 | ((new_n602_ | x36) & (~new_n604_ | ~x11 | ~x36))) & (~new_n604_ | ~x35 | x36);
  assign new_n602_ = x05 ? (x38 & x40) : (x31 | new_n603_ | x37);
  assign new_n603_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n92_ & x15));
  assign new_n604_ = ~x37 & ~x38 & x40;
  assign new_n605_ = x05 & ((x35 & ~x36 & ~x37) | (~x00 & ((~x36 & ~x40) | (~x35 & x36 & ~x37 & x40))));
  assign new_n606_ = x37 & (new_n609_ | (x36 & (x38 ? ~new_n607_ : new_n610_)));
  assign new_n607_ = x00 ? (~new_n608_ | x01) : (~x05 | (~new_n127_ & ~x35));
  assign new_n608_ = ~x02 & ~x03 & ((x04 & x35) | (new_n127_ & ~x04 & ~x35));
  assign new_n609_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n408_ & ~x38));
  assign new_n610_ = ~x39 & (x35 ? (new_n611_ | (x06 & x40)) : ~x40);
  assign new_n611_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n612_ = x05 ? (new_n613_ & ~new_n149_) : ~new_n614_;
  assign new_n613_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  assign new_n614_ = ~x31 & ~new_n86_ & ((~x38 & x40) | (~x37 & x38 & ~x39 & ~x40));
  assign new_n615_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n616_ = ~x35 & ~x36 & (new_n618_ | (~new_n617_ & ~x38));
  assign new_n617_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n400_ | ~new_n501_) & (x00 | ~x05)));
