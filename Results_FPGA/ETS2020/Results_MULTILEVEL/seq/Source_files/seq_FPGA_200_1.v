...
module FAU ( 
  ...
  assign z31 = ~x07 & ~x32 & ~new_n145_ & x33;
  assign new_n145_ = (x34 | (~new_n146_ & (~new_n155_ | ~new_n156_))) & (~new_n153_ | ~x00);
  assign new_n146_ = x35 & (new_n151_ | (~x05 & x15 & new_n147_ & ~x36));
  assign new_n147_ = ~new_n83_ & ((~x38 & ~new_n148_ & ~x39) | (~x37 & x38 & ~new_n150_ & x39));
  assign new_n148_ = (x24 | x37) & (~x40 | (x24 & (x21 | ~new_n149_ | ~x22)));
  assign new_n149_ = ~x23 & x24 & x37 & ((x18 & x19) | (x09 & (x18 | x19)));
  assign new_n150_ = x24 & (~x21 | ~x22 | x23 | ~x24 | x40);
  assign new_n151_ = new_n152_ & x00 & ~x01 & x02 & ~x03;
  assign new_n152_ = x04 & x36 & x37 & x38;
  assign new_n153_ = ~x01 & x02 & ~x03 & x04 & new_n154_ & x34;
  assign new_n154_ = ~x35 & ~x36 & ~x37 & ~new_n108_ & ~x38;
  assign new_n155_ = ~x37 & x38 & ~x39 & ~x40;
  assign new_n156_ = x10 & x27 & ~x35 & x36;
  assign z32 = ~x40 & ~x39 & x38 & new_n158_ & x37;
  assign new_n158_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
