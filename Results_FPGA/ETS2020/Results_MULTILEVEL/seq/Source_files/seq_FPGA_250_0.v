// Benchmark "FAU" written by ABC on Thu Aug  6 17:03:22 2020
...
module FAU ( 
  ...
  assign new_n359_ = (new_n360_ | ~x36) & (~new_n127_ | ~x38 | ~x35 | x36 | ~x37);
  assign new_n360_ = (new_n361_ | x35) & (~new_n365_ | ~new_n297_ | ~x35 | ~x37);
  ...
  assign z17 = x33 & (x07 | (~x07 & ~new_n368_ & ~x32));
  assign new_n368_ = (x34 | new_n384_ | ~x36) & (x36 | (~new_n369_ & ~new_n376_ & ~new_n388_));
  assign new_n369_ = ~x38 & ((new_n375_ & ~x05) | (~x35 & (new_n370_ | new_n371_)));
  assign new_n370_ = ~x05 & ~x31 & ~new_n88_ & ~x34;
  assign new_n371_ = x34 & ((~new_n373_ & x37) | (x02 & (new_n372_ | (x37 & ~x39))));
  assign new_n372_ = x00 & ~x01 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n373_ = ~new_n374_ & (x05 | ~new_n219_ | ~x15);
  assign new_n374_ = ~x39 & (x01 | x03 | x04);
  assign new_n375_ = x15 & ~x34 & x35 & ~x39 & ~new_n212_ & ~new_n92_;
  assign new_n376_ = ~x05 & ~x34 & (new_n377_ | (~x31 & new_n114_ & ~x35));
  assign new_n377_ = x15 & ~new_n92_ & (new_n383_ | (x38 & (new_n378_ | new_n382_)));
  ...
  assign new_n381_ = x24 & (~x24 | (x22 & (~x22 | (x21 ? (x23 | x40) : (x40 & (new_n177_ | ~x40))))));
  ...
  assign new_n385_ = ~new_n386_ & (x35 | ~x40 | new_n123_ | (x37 ^ ~x39));
  assign new_n386_ = ~x01 & x02 & ~x03 & x04 & x35 & x37;
  assign new_n387_ = (~x35 | ~x37 | x38 | ~x39) & (~x10 | ~x27 | x35 | x37 | ~x38 | x39);
  assign new_n388_ = x34 & ~x35 & ~x37 & x38 & ~new_n123_ & x39;
  assign z18 = ~x07 & ~new_n390_ & x33;
  assign new_n390_ = (x32 | (x34 ? (new_n413_ | x35) : new_n391_)) & (x34 | ~new_n419_ | x35);
  assign new_n391_ = x38 ? (~new_n399_ & ~new_n406_) : (x36 ? new_n410_ : new_n392_);
  assign new_n392_ = (~x37 | (x35 ? new_n395_ : new_n393_)) & (x05 | ~x35 | ~new_n397_ | x37);
  assign new_n393_ = ~new_n394_ & (x05 | x31 | ~new_n182_ | ~x39);
  assign new_n394_ = x11 & x12 & x14 & x15 & ~new_n145_ & ~x39;
  assign new_n395_ = ~x39 & (x39 | (x40 & (x05 | ~new_n396_ | ~x15)));
  assign new_n396_ = x21 & x22 & x24 & ~new_n92_ & x40;
  assign new_n397_ = ~x39 & ((new_n398_ & x15) | (new_n158_ & ~x13));
  assign new_n398_ = x24 & ~new_n92_ & (x40 | (x21 & x22 & ~x40));
  assign new_n399_ = ~x35 & (x36 ? ~new_n400_ : (new_n405_ | (~new_n403_ & x40)));
  assign new_n400_ = (new_n401_ | (~x37 ^ x39)) & (~x37 | ~x39) & (x37 | x39 | (~x40 & (new_n138_ | x40)));
  assign new_n401_ = x40 & (~new_n402_ | x03 | x04 | ~x40);
  assign new_n402_ = x00 & ~x01 & ~x02;
  assign new_n403_ = (~new_n404_ | ~x11) & (x05 | x31 | new_n180_ | x39);
  assign new_n404_ = x12 & x14 & x15 & ~x37 & ~new_n145_ & x39;
  ...
  assign new_n408_ = x22 & x24 & ~x36 & ~new_n92_ & (x23 | x40);
  ...
  assign new_n411_ = new_n167_ & x00 & x01 & new_n112_ & x04 & x35;
  assign new_n412_ = ~x11 & x40 & (~x12 | (x12 & x39));
  assign new_n413_ = (~new_n297_ | ~x36 | x37) & (new_n414_ | x36);
  assign new_n414_ = x38 ? (x37 ? (x39 & (~x39 | x40)) : (~new_n189_ & x39)) : new_n415_;
  assign new_n415_ = (~new_n417_ | x01) & (~x39 | (x37 ? new_n416_ : new_n418_));
  assign new_n416_ = x40 & (x05 | ~x15 | ~x21 | ~x22 | new_n92_ | ~x40);
  assign new_n417_ = ~x04 & ~x39 & ((x00 & ~x37) | (new_n167_ & x37 & x40));
  ...
  assign new_n425_ = (x35 | (~new_n426_ & (~new_n362_ | x34 | ~x36))) & (x34 | ~new_n428_ | ~x35);
  ...
  assign new_n430_ = (~new_n402_ | ~x36 | ~x37 | x03 | ~x04) & (~new_n112_ | x36 | x37);
  assign new_n431_ = x39 & x40 & ((~x36 & x37 & x34 & ~x35) | (~x34 & x35 & x36 & ~x37));
  ...
  assign new_n435_ = (~new_n436_ | x05) & (x00 | new_n87_ | ~x05);
  assign new_n436_ = ~x34 & (x31 | (~x31 & ~new_n86_ & x39));
  assign new_n437_ = ~x31 & ~x34 & (new_n158_ | (new_n438_ & x37));
  assign new_n438_ = ~x39 & ((x15 & ~new_n145_ & ~new_n154_) | new_n92_ | ~x15);
  assign new_n439_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n86_ & x40));
  assign new_n440_ = (new_n445_ | ~x37) & (new_n443_ | ~x05) & (x05 | (x31 ? new_n443_ : (new_n441_ | x37)));
  assign new_n441_ = (~x39 | (~new_n305_ & (~x40 | (~new_n442_ & new_n86_)))) & (~x38 | x39 | new_n86_ | x40);
  assign new_n442_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n443_ = ~new_n149_ & new_n444_ & ~new_n205_ & new_n102_;
  assign new_n444_ = x14 & x15 & (~x39 | x40) & (~x38 | x39);
  assign new_n445_ = x05 ? ~x38 : (~x31 | ~x39);
  assign new_n446_ = (new_n447_ | (~x05 & (x05 | new_n86_ | ~x13))) & (x05 | new_n86_ | new_n448_);
  assign new_n447_ = ~new_n121_ & (~new_n127_ | x38);
  ...
  assign new_n458_ = ~x00 & (x38 ? ~x05 : new_n112_);
  assign new_n459_ = new_n460_ & ~x00;
  assign new_n460_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n461_ = new_n125_ & x38 & ~x00 & ~x05 & x37;
  assign new_n462_ = (~x34 | new_n463_ | x36) & (~new_n297_ | ~x32 | ~x36 | x37);
  ...
  assign new_n467_ = (~x05 | new_n470_ | x32) & (x35 | (new_n420_ & (~x05 | new_n468_ | x32)));
  assign new_n468_ = ~new_n149_ & (~x38 | (~x37 & x39)) & new_n469_ & (~x39 | (x38 & x40));
  assign new_n469_ = new_n102_ & x14 & ~new_n205_ & x15;
  ...
  assign z23 = x33 & (x07 | (~x07 & ~x32 & (new_n521_ | (~new_n475_ & ~x34))));
  assign new_n475_ = (new_n476_ | x38) & (new_n496_ | ~x38) & (x35 | new_n516_ | x36);
  ...
  assign new_n479_ = ~new_n92_ & (new_n480_ | (x35 & ~new_n481_ & x40));
  ...
  assign new_n484_ = x35 & ~new_n92_ & (~x37 | (~x24 & x40));
  assign new_n485_ = (~new_n486_ | x05) & (~x35 | ~x37 | x40);
  assign new_n486_ = ~new_n86_ & ((x37 & (x13 ? (~x31 & ~x35) : (x35 ? x40 : ~x31))) | (x35 & (x13 ? (~x37 | x40) : ~x37)));
  ...
  assign new_n491_ = (~x40 | (~new_n492_ & new_n86_)) & (~x39 | (x37 ? (new_n493_ | x40) : new_n86_));
  assign new_n492_ = ~x09 & x15 & ~new_n92_ & ~x16;
  ...
  assign new_n496_ = ~new_n515_ & (new_n506_ | ~x35) & (x35 | (x36 ? new_n512_ : new_n497_));
  ...
  assign new_n499_ = ~new_n203_ & x39;
  assign new_n500_ = ~x16 & ~new_n92_ & ((~x17 & x39 & x40) | (~x09 & ~x40));
  assign new_n501_ = ~x40 & ((~x39 & (new_n92_ | ~x15)) | (x09 & ~x13 & ~x15 & x39));
  ...
  assign new_n507_ = ~x05 & (x05 | (~new_n92_ & x15 & (~x15 | new_n92_ | (new_n105_ & (new_n508_ | ~x24)))));
  ...
  assign new_n512_ = ((~new_n513_ & x40) | (x37 ^ ~x39)) & (~x39 | (~x37 & (~new_n452_ | x37 | ~x40))) & (x37 | x39 | (~x40 & (new_n514_ | x40)));
  ...
  assign new_n516_ = x05 ? (new_n520_ & ~new_n149_) : (~new_n517_ & (~x31 | (new_n519_ & ~new_n149_)));
  assign new_n517_ = x39 & (x31 ? (x37 | ~x40) : (~new_n518_ & ~x37));
  assign new_n518_ = ~new_n492_ & ~new_n158_ & (~x09 | ~x13 | x15);
  assign new_n519_ = ~new_n205_ & x11 & x12 & x14 & x15;
  assign new_n520_ = x14 & ~new_n125_ & x15 & ~new_n205_ & new_n102_;
  assign new_n521_ = ~x35 & ((~new_n522_ & ~x36) | (new_n297_ & x34 & x36 & ~x37));
  assign new_n522_ = x38 ? new_n523_ : (x37 ? new_n529_ : (~new_n526_ & ~new_n530_));
  assign new_n523_ = ~new_n524_ & (~new_n525_ | x05 | ~x11 | ~x12 | x14);
  assign new_n524_ = x34 & (x37 ? (~x39 | (x39 & ~x40)) : (new_n189_ | ~x39 | (~new_n123_ & x39)));
  assign new_n525_ = x15 & ~x31 & new_n87_ & ~x37;
  assign new_n526_ = ~new_n87_ & (new_n452_ | (new_n527_ & new_n528_));
  assign new_n527_ = x00 & ~x01 & x02;
  assign new_n528_ = ~x03 & x04 & x34;
  assign new_n529_ = (~x05 | ~x39 | ~x40) & (~x34 | (x39 ? (x40 & (x05 | ~x40)) : new_n221_));
  assign new_n530_ = x34 & ((x39 & (x40 | (x00 & ~x01 & ~x04 & ~x40))) | (x00 & ~x01 & ~x04 & ~x39));
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n542_ : ~new_n532_);
  assign new_n532_ = new_n533_ & (x38 | (~new_n539_ & (x35 | (~new_n370_ & ~new_n371_))));
  assign new_n533_ = ~new_n388_ & (x34 | (~new_n538_ & (new_n534_ | x05)));
  assign new_n534_ = (x31 | ~new_n114_ | x35) & (~x15 | new_n535_ | new_n92_);
  assign new_n535_ = ~new_n383_ & (~x38 | (~new_n382_ & (x37 | (~new_n379_ & ~new_n536_))));
  assign new_n536_ = x39 & (new_n106_ | new_n537_);
  assign new_n537_ = x35 & (~x24 | (x24 & (~x22 | (x22 & ~x40 & (~x21 | (x21 & ~x23))))));
  assign new_n538_ = new_n111_ & x35 & x37;
  assign new_n539_ = ~x05 & new_n540_ & x15;
  assign new_n540_ = ~x34 & x35 & ~x39 & ~new_n541_ & ~new_n92_;
  assign new_n541_ = (~x40 | (x24 & (~x37 | ((new_n97_ | x21) & (x22 | ~x24))))) & (x37 | (x24 & (~x24 | x40 | (x22 & (x21 | ~x22)))));
  assign new_n542_ = (new_n384_ | x34) & (~new_n297_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n547_ : ~new_n544_);
  assign new_n544_ = (x05 | new_n534_ | x34) & (x38 | (~new_n545_ & ~new_n539_));
  assign new_n545_ = ~x35 & (new_n370_ | (x34 & (new_n218_ | (new_n546_ & x00))));
  assign new_n546_ = ~x01 & x02 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n547_ = (~new_n297_ | ~x34 | x35 | x37) & (x34 | (~new_n549_ & (~x35 | new_n548_ | ~x37)));
  assign new_n548_ = (~new_n125_ | x38) & (~new_n527_ | x03 | ~x04 | ~x38);
  assign new_n549_ = new_n112_ & new_n153_ & x10 & x27 & ~x35;
  assign z26 = ~x07 & ~x32 & x33 & (new_n554_ | (~new_n551_ & ~x35));
  assign new_n551_ = (new_n552_ | new_n123_) & (~new_n297_ | ~x34 | ~x36 | x37);
  assign new_n552_ = (new_n553_ | ~x38) & (~new_n122_ | ~x34 | x36);
  assign new_n553_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (x37 ^ ~x39));
  assign new_n554_ = x00 & ~x34 & x35 & new_n131_ & x36;
  assign z27 = ~x07 & ~x32 & x33 & (new_n565_ | (new_n556_ & ~x05));
  assign new_n556_ = ~x36 & (new_n557_ | (~x09 & ~x31 & new_n564_ & ~x34));
  assign new_n557_ = x15 & ~new_n92_ & (new_n562_ | (~new_n558_ & ~x34));
  assign new_n558_ = (new_n559_ | ~x35) & (x31 | x35 | (~new_n560_ & (new_n561_ | x16)));
  assign new_n559_ = (x38 | new_n541_ | x39) & (x37 | ~x38 | new_n214_ | ~x39);
  assign new_n560_ = ~x09 & ~x17 & (new_n298_ | new_n122_);
  ...
  assign new_n565_ = new_n198_ & ~x34 & x35 & x36;
  assign z28 = ~x07 & ~x32 & x33 & (new_n567_ | new_n569_);
  assign new_n567_ = x00 & ~x01 & x02 & ~x03 & ~new_n568_ & x04;
  assign new_n568_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n87_ | x38);
  assign new_n569_ = new_n138_ & ~x34 & ~x35 & new_n111_ & x36 & ~x37;
  assign z29 = ~x07 & ~x32 & x33 & (new_n565_ | (new_n571_ & ~x05));
  assign new_n571_ = ~x36 & ((~new_n572_ & ~x34) | (x15 & new_n324_ & ~x21));
  assign new_n572_ = (x31 | ~new_n576_ | x35) & (x40 | (~new_n573_ & (x31 | ~new_n575_ | x35)));
  assign new_n573_ = x15 & ~x21 & x22 & new_n574_ & x24;
  assign new_n574_ = x35 & ~x37 & ~new_n92_ & (~x38 ^ x39);
  assign new_n575_ = x37 & ~x38 & ~new_n90_ & x39;
  assign new_n576_ = x38 & ~x39 & ~new_n90_ & x40;
  assign z30 = ~x07 & ~x32 & x33 & (new_n578_ | new_n569_);
  assign new_n578_ = ~x05 & x15 & ~x36 & ~new_n579_ & ~new_n92_;
  ...
  assign new_n582_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n174_ | ~x40)));
  assign z31 = ~x07 & ~x32 & x33 & (new_n592_ | (~new_n584_ & ~x34));
  assign new_n584_ = (new_n585_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  assign new_n585_ = ~new_n590_ & (x05 | ~new_n586_ | ~x15);
  assign new_n586_ = ~x36 & ~new_n92_ & ((new_n587_ & ~x38) | (~x37 & new_n589_ & x38));
  assign new_n587_ = ~x39 & ((~x24 & ~x37) | (x40 & (new_n588_ | ~x24)));
  assign new_n588_ = ~x21 & x22 & ~x23 & x24 & ~new_n174_ & x37;
  assign new_n589_ = x39 & (~x24 | (x21 & x22 & ~x23 & x24 & ~x40));
  assign new_n590_ = new_n591_ & x00 & ~x01 & x02 & ~x03;
  assign new_n591_ = x04 & x36 & x37 & x38;
  assign new_n592_ = x00 & ~x01 & x02 & ~x03 & new_n593_ & x04;
  assign new_n593_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n87_ & ~x38;
  assign z33 = x33 ? (x07 | (~x07 & ~new_n595_ & ~x32)) : x32;
  assign new_n595_ = x34 ? (x35 | new_n616_ | x36) : (x35 ? new_n596_ : new_n606_);
  assign new_n596_ = x37 ? ((new_n604_ | ~x36) & (x05 | ~new_n597_ | x36)) : new_n600_;
  assign new_n597_ = ~x38 & ~x39 & ~new_n598_ & x40;
  assign new_n598_ = (~x15 | ~x22 | ~x24 | new_n599_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n599_ = ~x21 & (x21 | new_n174_ | ~x23);
  assign new_n600_ = x36 ? ((x39 | (x38 & (~x38 | ~x40))) & (~x38 | ~x39 | (x40 & (~x06 | ~x40)))) : (~new_n601_ & (x38 | ~x39 | ~x40) & (~x38 | x39 | x40));
  assign new_n601_ = ~x05 & (new_n603_ | (x15 & x22 & new_n602_ & x24));
  assign new_n602_ = ~new_n92_ & ((x38 & ~new_n509_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n603_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  assign new_n604_ = (~new_n605_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n605_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n112_ & x01 & ~x38));
  assign new_n606_ = (new_n615_ | ~x36) & (x05 | x31 | new_n607_ | x36);
  assign new_n607_ = ~new_n320_ & ~new_n608_ & new_n614_ & (x37 | (~new_n611_ & ~new_n612_));
  assign new_n608_ = x15 & ((~new_n609_ & x09) | (x16 & new_n152_ & x17));
  assign new_n609_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n610_ | ~x39);
  assign new_n610_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n611_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n612_ = x39 & (new_n613_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n613_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n614_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  ...
  assign new_n618_ = x39 & x40 & (~x37 | (~x05 & ~new_n312_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~x32 & (new_n642_ | (~new_n620_ & ~x34))));
  assign new_n620_ = ~new_n632_ & ~new_n621_ & (x36 | (~new_n641_ & (new_n638_ | x35)));
  assign new_n621_ = x39 & (~new_n627_ | (x38 & (new_n631_ | (~new_n622_ & ~x37))));
  assign new_n622_ = (x35 | (x36 ? new_n401_ : new_n623_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n628_ = x05 ? (x38 & x40) : (x31 | new_n629_ | x37);
  assign new_n629_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n92_ & x15));
  assign new_n630_ = ~x37 & ~x38 & x40;
  assign new_n631_ = x05 & ((x35 & ~x36 & ~x37) | (~x00 & ((~x36 & ~x40) | (~x35 & x36 & ~x37 & x40))));
  assign new_n632_ = x37 & (new_n635_ | (x36 & (x38 ? ~new_n633_ : new_n636_)));
  assign new_n633_ = x00 ? (~new_n634_ | x01) : (~x05 | (~new_n127_ & ~x35));
  assign new_n634_ = ~x02 & ~x03 & ((x04 & x35) | (new_n127_ & ~x04 & ~x35));
  assign new_n635_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n438_ & ~x38));
  assign new_n636_ = ~x39 & (x35 ? (new_n637_ | (x06 & x40)) : ~x40);
  assign new_n637_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n638_ = x05 ? (new_n639_ & ~new_n149_) : ~new_n640_;
  assign new_n639_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  ...
  assign new_n643_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n402_ | ~new_n528_) & (x00 | ~x05)));
