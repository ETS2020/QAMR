// Benchmark "FAU" written by ABC on Thu Aug  6 16:56:27 2020
...
module FAU ( 
  ...
  assign z15 = x07 & x33;
  assign z21 = ~x33 | (~x07 & ((~new_n117_ & ~x34) | (~new_n124_ & ~x35)));
  assign new_n117_ = (~x36 | ((new_n118_ | ~x35) & ~new_n121_ & ~x32)) & (~x35 | (~new_n123_ & ~x32));
  assign new_n118_ = (~x37 | (~new_n119_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n119_ = ~x00 & (new_n120_ | (~x05 & x38));
  assign new_n120_ = ~x38 & ~x39 & ~x40;
  assign new_n121_ = new_n122_ & ~x00;
  assign new_n122_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n123_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n124_ = (~x34 | new_n125_ | x36) & (~new_n120_ | ~x32 | ~x36 | x37);
  assign new_n125_ = new_n126_ & (x00 | x05 | x37 | new_n107_ | x38);
  assign new_n126_ = ~x32 & (~new_n107_ | ~x38 | x06 | ~x37);
  assign z26 = ~x07 & ~x32 & x33 & (new_n128_ | (new_n132_ & x00));
  assign new_n128_ = ~x35 & (new_n129_ | (new_n120_ & x34 & x36 & ~x37));
  assign new_n129_ = ~new_n130_ & (x01 | x02 | x03 | x04);
  assign new_n130_ = (new_n131_ | ~x38) & (~x34 | x36 | ~x37 | x38 | x39);
  assign new_n131_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n132_ = ~x34 & x35 & x36 & x37 & new_n133_ & ~x38;
  assign new_n133_ = ~x39 & ~x40 & (~x01 | x02 | x03 | ~x04);
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
