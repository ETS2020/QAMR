// Benchmark "FAU" written by ABC on Thu Aug  6 16:58:11 2020
...
module FAU ( 
  ...
  assign z29 = ~x07 & ~x32 & ~new_n145_ & x33;
  assign new_n145_ = (~new_n154_ | x34 | ~x35 | ~x36) & (x05 | new_n146_ | x36);
  assign new_n146_ = (new_n147_ | x34) & (~x15 | x21 | ~x22 | ~new_n152_ | ~x34);
  assign new_n147_ = (x31 | ~new_n151_ | x35) & (x40 | (~new_n148_ & (x31 | ~new_n150_ | x35)));
  assign new_n148_ = x15 & ~x21 & x22 & new_n149_ & x24;
  assign new_n149_ = x35 & ~x37 & (x11 | x12) & (x38 ^ ~x39);
  assign new_n150_ = x37 & ~x38 & x39 & (x28 ? (~x29 & ~x30) : (x29 & x30));
  assign new_n151_ = x38 & ~x39 & x40 & (x28 ? (~x29 & ~x30) : (x29 & x30));
  assign new_n152_ = new_n153_ & ~x35;
  assign new_n153_ = x37 & ~x38 & x39 & x40 & (x11 | x12);
