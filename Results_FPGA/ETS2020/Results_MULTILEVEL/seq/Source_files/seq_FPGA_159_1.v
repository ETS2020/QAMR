...
module FAU ( 
  ...
  assign z30 = ~x07 & ~x32 & x33 & (new_n148_ | new_n156_);
  assign new_n148_ = ~x05 & x15 & ~x36 & ~new_n149_ & (x11 | x12);
  assign new_n149_ = (~x34 | ~new_n155_ | x35) & (~x24 | x34 | new_n150_ | ~x35);
  assign new_n150_ = x22 ? (~new_n153_ & (new_n151_ | x21)) : new_n154_;
  assign new_n151_ = (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n152_ | ~x40))) & (~x39 | x40 | x37 | ~x38);
  assign new_n152_ = (~x18 | ~x19) & (~x09 | (~x18 & ~x19));
  assign new_n153_ = x38 & x39 & ~x40 & x21 & ~x23 & ~x37;
  assign new_n154_ = (~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40)));
  assign new_n155_ = x37 & ~x38 & x39 & x40 & (~x22 | (~x21 & x22));
  assign new_n156_ = new_n157_ & ~x34 & ~x35 & x10 & x27;
  assign new_n157_ = x36 & ~x37 & x38 & ~x39 & ~x40;
