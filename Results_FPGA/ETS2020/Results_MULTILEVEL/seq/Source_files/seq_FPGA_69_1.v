// Benchmark "FAU" written by ABC on Thu Aug  6 16:57:09 2020
...
module FAU ( 
  ...
  assign z17 = x33 & (x07 | (~x07 & ~x32 & (new_n159_ | (~new_n132_ & ~x36))));
  assign new_n132_ = (new_n133_ | x38) & (x05 | new_n147_ | x34) & (~new_n157_ | ~x34);
  assign new_n133_ = (~new_n144_ | x05) & (x35 | (~new_n134_ & (x05 | ~new_n139_ | x31)));
  assign new_n134_ = x34 & ((~new_n136_ & x37) | (x02 & (new_n135_ | (x37 & ~x39))));
  assign new_n135_ = x00 & ~x01 & ~x03 & x04 & ~new_n108_ & ~x37;
  assign new_n136_ = (x05 | ~x15 | ~new_n137_ | ~x39) & (new_n138_ | x39);
  assign new_n137_ = x40 & (x11 | x12) & (~x22 | (~x21 & x22));
  assign new_n138_ = ~x01 & ~x03 & ~x04;
  assign new_n139_ = ~x34 & (new_n143_ | (x37 & (new_n140_ | (new_n142_ & x15))));
  assign new_n140_ = x39 & ~new_n141_ & ~x40;
  assign new_n141_ = x28 ? (x29 | x30) : (~x29 | ~x30);
  assign new_n142_ = ~x39 & ~new_n83_ & ((~x09 & (~x16 | ~x17)) | (~x16 & ~x17));
  assign new_n143_ = ~x09 & x15 & ~x16 & ~new_n83_ & x40;
  assign new_n144_ = x15 & ~x34 & x35 & ~x39 & ~new_n145_ & ~new_n83_;
  assign new_n145_ = (~x40 | (x24 & (~x37 | ((new_n146_ | x21) & (x22 | ~x24))))) & (x37 | (x24 & (~x24 | x40 | (x22 & (x21 | ~x22)))));
  assign new_n146_ = (x09 | (x18 & x19)) & (x18 | x19) & (~x22 | ~x24 | ((~x18 | ~x19) & (~x09 | (~x18 & ~x19))));
  assign new_n147_ = (~x15 | new_n148_ | new_n83_) & (x31 | ~new_n156_ | x35);
  assign new_n148_ = ~new_n155_ & (~x38 | (~new_n154_ & (x37 | (~new_n149_ & ~new_n151_))));
  assign new_n149_ = ~x09 & (new_n150_ | (x35 & x39 & ~x18 & ~x21));
  assign new_n150_ = ~x16 & ~x31 & ~x35 & ~x40;
  assign new_n151_ = x39 & (new_n152_ | (x35 & (~x24 | (~new_n153_ & x24))));
  assign new_n152_ = ~x16 & ~x17 & ~x31 & ~x35 & x40;
  assign new_n153_ = x22 & (~x22 | (x21 ? (x23 | x40) : (x40 & (~x40 | (~x09 & ~x18)))));
  assign new_n154_ = ~x09 & ~x17 & ~x31 & ~x35 & x39;
  assign new_n155_ = ~x09 & ~x16 & ~x31 & ~x35 & ~x37 & x39;
  assign new_n156_ = x38 & ((~x39 & ~new_n141_ & x40) | (~x09 & x39 & (x37 | ~x40)));
  assign new_n157_ = ~x35 & ~x37 & x38 & ~new_n158_ & x39;
  assign new_n158_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n159_ = ~x34 & x36 & ((~new_n160_ & x00) | (~new_n165_ & ~x40));
  assign new_n160_ = (~new_n161_ | ~x35) & (~x38 | (~new_n164_ & (x35 | ~new_n163_ | ~x40)));
  assign new_n161_ = x37 & new_n162_ & ~x38;
  assign new_n162_ = ~x39 & ~x40 & (~x01 | x02 | x03 | ~x04);
  assign new_n163_ = ~new_n158_ & (~x37 ^ ~x39);
  assign new_n164_ = ~x01 & x02 & ~x03 & x04 & x35 & x37;
  assign new_n165_ = (x38 | ~x39 | ~x35 | ~x37) & (x37 | ~x38 | x39 | ~x10 | ~x27 | x35);
  assign z21 = ~x33 | (~x07 & ((~new_n167_ & ~x34) | (~new_n173_ & ~x35)));
  assign new_n167_ = (~x36 | ((new_n168_ | ~x35) & ~new_n170_ & ~x32)) & (~x35 | (~new_n172_ & ~x32));
  assign new_n168_ = (~x37 | (~new_n169_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n169_ = ~x00 & (new_n127_ | (~x05 & x38));
  assign new_n170_ = new_n171_ & ~x00;
  assign new_n171_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n172_ = x38 & x39 & ~x40 & ~x00 & ~x05 & x37;
  assign new_n173_ = (~x34 | new_n174_ | x36) & (~new_n127_ | ~x32 | ~x36 | x37);
  assign new_n174_ = new_n175_ & (x00 | x05 | x37 | new_n108_ | x38);
  assign new_n175_ = ~x32 & (~new_n108_ | ~x38 | x06 | ~x37);
  assign z26 = ~x07 & ~x32 & ~new_n177_ & x33;
  assign new_n177_ = (new_n178_ | x35) & (~x00 | x34 | ~x35 | ~new_n161_ | ~x36);
  assign new_n178_ = (new_n179_ | new_n158_) & (~new_n127_ | ~x34 | ~x36 | x37);
