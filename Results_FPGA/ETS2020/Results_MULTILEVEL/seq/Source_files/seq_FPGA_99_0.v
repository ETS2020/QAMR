// Benchmark "FAU" written by ABC on Thu Aug  6 16:58:10 2020
...
module FAU ( 
  ...
  assign new_n323_ = x21 & x22 & x34 & new_n324_ & ~x35;
  ...
  assign z30 = ~x07 & ~x32 & x33 & (new_n574_ | new_n572_);
  assign new_n574_ = ~x05 & x15 & ~x36 & ~new_n575_ & ~new_n92_;
  assign new_n575_ = ~new_n565_ & (~x24 | x34 | new_n576_ | ~x35);
  assign new_n576_ = x22 ? new_n577_ : ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))));
  assign new_n577_ = (new_n578_ | x21) & (~new_n125_ | ~x38 | ~x21 | x23 | x37);
  assign new_n578_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n174_ | ~x40)));
  assign z31 = ~x07 & ~x32 & x33 & (new_n588_ | (~new_n580_ & ~x34));
  assign new_n580_ = (new_n581_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  ...
  assign new_n584_ = ~x21 & x22 & ~x23 & x24 & ~new_n174_ & x37;
  ...
  assign new_n591_ = x34 ? (x35 | new_n612_ | x36) : (x35 ? new_n592_ : new_n602_);
  assign new_n592_ = x37 ? ((new_n600_ | ~x36) & (x05 | ~new_n593_ | x36)) : new_n596_;
  assign new_n593_ = ~x38 & ~x39 & ~new_n594_ & x40;
  assign new_n594_ = (~x15 | ~x22 | ~x24 | new_n595_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n595_ = ~x21 & (x21 | new_n174_ | ~x23);
  ...
  assign new_n598_ = ~new_n92_ & ((x38 & ~new_n512_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n599_ = ~x13 & ~new_n86_ & (x38 ? x39 : (~x39 & ~x40));
  ...
  assign new_n603_ = ~new_n320_ & ~new_n604_ & new_n610_ & (x37 | (~new_n607_ & ~new_n608_));
  assign new_n604_ = x15 & ((~new_n605_ & x09) | (x16 & new_n152_ & x17));
  assign new_n605_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n606_ | ~x39);
  ...
  assign new_n614_ = x39 & x40 & (~x37 | (~x05 & ~new_n312_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~x32 & (new_n638_ | (~new_n616_ & ~x34))));
  assign new_n616_ = ~new_n628_ & ~new_n617_ & (x36 | (~new_n637_ & (new_n634_ | x35)));
  assign new_n617_ = x39 & (~new_n623_ | (x38 & (new_n627_ | (~new_n618_ & ~x37))));
  assign new_n618_ = (x35 | (x36 ? new_n404_ : new_n619_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n619_ = ~new_n622_ & (~x15 | (~new_n621_ & (x05 | new_n620_ | x31)));
  assign new_n620_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  assign new_n621_ = x11 & x12 & x14 & ~new_n145_ & x40;
  assign new_n622_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n623_ = (x35 | ((new_n624_ | x36) & (~new_n626_ | ~x11 | ~x36))) & (~new_n626_ | ~x35 | x36);
  assign new_n624_ = x05 ? (x38 & x40) : (x31 | new_n625_ | x37);
  assign new_n625_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n92_ & x15));
  ...
  assign new_n631_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n441_ & ~x38));
  assign new_n632_ = ~x39 & (x35 ? (new_n633_ | (x06 & x40)) : ~x40);
  assign new_n633_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n634_ = x05 ? (new_n635_ & ~new_n149_) : ~new_n636_;
  assign new_n635_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  assign new_n636_ = ~x31 & ~new_n86_ & ((~x38 & x40) | (~x37 & x38 & ~x39 & ~x40));
  assign new_n637_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n638_ = ~x35 & ~x36 & (new_n640_ | (~new_n639_ & ~x38));
  assign new_n639_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n405_ | ~new_n531_) & (x00 | ~x05)));
