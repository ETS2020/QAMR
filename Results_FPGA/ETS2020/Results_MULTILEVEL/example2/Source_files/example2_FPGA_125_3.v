...
module FAU ( 
  ...
  assign new_n231_ = x04 & x78 & x79 & (new_n232_ | (new_n179_ & new_n233_));
  ...
  assign new_n237_ = x78 & (~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n238_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n240_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n177_ | ~x79)));
