...
module FAU ( 
  ...
  wire new_n154_, new_n175_, new_n176_, new_n177_, new_n178_, new_n179_,
    ...
    new_n220_, new_n222_, new_n224_, new_n226_, new_n229_, new_n230_,
  ...
  assign z58 = ~x01 & (new_n233_ | (x77 & (new_n229_ | new_n232_)));
  assign new_n229_ = x04 & x78 & x79 & (new_n230_ | (new_n179_ & new_n231_));
  assign new_n230_ = ~x40 & x42;
  assign new_n231_ = ~x74 & x80 & ~x42 & x43;
  assign new_n232_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n233_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n236_ | (new_n235_ & x04))));
  assign new_n235_ = x78 & (~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n236_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n238_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n177_ | ~x79)));
  assign new_n238_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z61 = ~x01 & new_n240_ & x79;
  assign new_n240_ = x80 & (((~x81 ^ x84) & (~x77 ^ ~x78)) | (~x04 & x77 & x78));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n242_ : (new_n243_ | new_n244_))) | (new_n244_ & x77 & ~x78));
  assign new_n242_ = x04 ? (x79 & (x42 | (new_n178_ & new_n179_))) : (~x79 | ~x81);
  assign new_n243_ = x04 & ~x79;
  assign new_n244_ = x79 & x81 & x84;
  assign z64 = ~x01 & ((new_n246_ & x79) | (x04 & ~x77 & x78 & ~x79));
  assign new_n246_ = x83 & ((~x04 & x77 & x78) | ((~x81 ^ x84) & (~x77 ^ ~x78)));
