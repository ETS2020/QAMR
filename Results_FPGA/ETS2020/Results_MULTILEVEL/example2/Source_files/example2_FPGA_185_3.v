...
module FAU ( 
  ...
  assign new_n226_ = x04 & x78 & x79 & (new_n227_ | (new_n178_ & new_n228_));
  ...
  assign new_n232_ = x78 & (~x79 | (~x42 & (~new_n177_ | ~new_n178_)));
  assign new_n233_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n235_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n176_ | ~x79)));
  assign new_n235_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n237_ : (new_n238_ | new_n239_))) | (new_n239_ & x77 & ~x78));
  assign new_n237_ = x04 ? (x79 & (x42 | (new_n177_ & new_n178_))) : (~x79 | ~x81);
