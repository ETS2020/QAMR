...
module FAU ( 
  ...
  wire new_n154_, new_n175_, new_n176_, new_n177_, new_n178_, new_n179_,
    ...
    new_n219_, new_n221_, new_n223_, new_n225_, new_n227_, new_n230_,
  ...
  assign z53 = ~x01 & ((new_n215_ & x73) | (new_n223_ & x04));
  ...
  assign new_n230_ = x04 & x78 & x79 & (new_n231_ | (new_n179_ & new_n232_));
  ...
  assign new_n236_ = x78 & (~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n237_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n239_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n177_ | ~x79)));
