// Benchmark "FAU" written by ABC on Thu Aug  6 01:05:35 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n173_, new_n174_, new_n175_, new_n176_, new_n177_,
    ...
    new_n219_, new_n221_, new_n223_, new_n226_, new_n227_, new_n228_,
    new_n229_, new_n230_, new_n232_, new_n233_, new_n235_, new_n237_,
    new_n238_, new_n239_, new_n241_, new_n243_;
  ...
  assign new_n226_ = x04 & x78 & x79 & (new_n227_ | (new_n177_ & new_n228_));
  ...
  assign new_n232_ = x78 & (~x79 | (~x42 & (~new_n176_ | ~new_n177_)));
  assign new_n233_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n235_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n175_ | ~x79)));
  assign new_n235_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n237_ : (new_n238_ | new_n239_))) | (new_n239_ & x77 & ~x78));
  assign new_n237_ = x04 ? (x79 & (x42 | (new_n176_ & new_n177_))) : (~x79 | ~x81);
