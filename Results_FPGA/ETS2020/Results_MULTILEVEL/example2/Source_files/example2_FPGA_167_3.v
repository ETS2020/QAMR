...
module FAU ( 
  ...
  assign new_n235_ = x04 & x78 & x79 & (new_n236_ | (new_n181_ & new_n237_));
  ...
  assign new_n241_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n242_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n244_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n244_ = (x81 ^ x84) & (x77 ^ x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n246_ : (new_n247_ | new_n248_))) | (new_n248_ & x77 & ~x78));
  assign new_n246_ = x04 ? (x79 & (x42 | (new_n180_ & new_n181_))) : (~x79 | ~x81);
