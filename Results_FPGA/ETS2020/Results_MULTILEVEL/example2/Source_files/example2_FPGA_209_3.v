...
module FAU ( 
  ...
  assign new_n231_ = x04 & x78 & x79 & (new_n232_ | (new_n178_ & new_n233_));
  assign new_n232_ = ~x40 & x42;
  assign new_n233_ = ~x74 & x80 & ~x42 & x43;
  assign new_n234_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n235_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n238_ | (new_n237_ & x04))));
  assign new_n237_ = x78 & (~x79 | (~x42 & (~new_n177_ | ~new_n178_)));
  assign new_n238_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n228_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n176_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n241_ : (new_n242_ | new_n243_))) | (new_n243_ & x77 & ~x78));
  assign new_n241_ = x04 ? (x79 & (x42 | (new_n177_ & new_n178_))) : (~x79 | ~x81);
