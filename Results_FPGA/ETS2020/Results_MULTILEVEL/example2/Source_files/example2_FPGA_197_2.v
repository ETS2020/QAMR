...
module FAU ( 
  ...
  wire new_n164_, new_n165_, new_n166_, new_n167_, new_n168_, new_n170_,
    ...
    new_n218_, new_n220_, new_n221_, new_n224_, new_n226_, new_n227_,
    new_n228_, new_n231_;
  ...
  assign z49 = ~x01 & ((new_n201_ & x04) | (new_n202_ & x69));
  assign new_n201_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  ...
  assign new_n214_ = x04 & x78 & x79 & (new_n215_ | (new_n168_ & new_n216_));
  assign new_n215_ = ~x40 & x42;
  assign new_n216_ = ~x74 & x80 & ~x42 & x43;
  assign new_n217_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n218_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n221_ | (new_n220_ & x04))));
  assign new_n220_ = x78 & (~x79 | (~x42 & (~new_n167_ | ~new_n168_)));
  assign new_n221_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n211_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n166_ | ~x79)));
  ...
  assign new_n226_ = x04 ? (x79 & (x42 | (new_n167_ & new_n168_))) : (~x79 | ~x81);
