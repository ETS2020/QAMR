// Benchmark "FAU" written by ABC on Thu Aug  6 01:05:53 2020
...
module FAU ( 
  ...
  assign z51 = ~x01 & ((new_n192_ & x04) | (new_n190_ & x71));
  assign new_n192_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n194_ & x04) | (new_n190_ & x72));
  assign new_n194_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n196_ & x04) | (new_n190_ & x73));
