// Benchmark "FAU" written by ABC on Thu Aug  6 01:05:34 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n175_, new_n177_, new_n186_, new_n200_, new_n201_,
    ...
    new_n214_, new_n217_, new_n220_, new_n222_;
  ...
  assign z52 = ~x01 & ((new_n204_ & x72) | (new_n208_ & x04));
  assign new_n208_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n204_ & x73) | (new_n210_ & x04));
  assign new_n210_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  ...
  assign z64 = ~x01 & ((new_n220_ & x78 & ~x79) | (x79 & ~new_n217_ & x83));
