...
module FAU ( 
  ...
  assign z58 = ~x01 & (new_n239_ | (x77 & (new_n235_ | new_n238_)));
  assign new_n235_ = x04 & x78 & x79 & (new_n236_ | (new_n179_ & new_n237_));
  assign new_n236_ = ~x40 & x42;
  assign new_n237_ = ~x42 & x43 & ~x74 & x80;
  assign new_n238_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n239_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n242_ | (new_n241_ & x04))));
  assign new_n241_ = x78 & (~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n242_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n232_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n177_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n245_ : (new_n246_ | new_n247_))) | (new_n247_ & x77 & ~x78));
  assign new_n245_ = x04 ? (x79 & (x42 | (new_n178_ & new_n179_))) : (~x79 | ~x81);
  assign new_n246_ = x04 & ~x79;
  assign new_n247_ = x79 & x81 & x84;
  assign z64 = ~x01 & ((new_n249_ & x79) | (x04 & ~x77 & x78 & ~x79));
  assign new_n249_ = x83 & (((~x81 ^ x84) & (~x77 ^ ~x78)) | (~x04 & x77 & x78));
