...
module FAU ( 
  ...
  assign z50 = ~x01 & ((new_n214_ & x70) | (new_n216_ & x04));
  assign new_n216_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n214_ & x71) | (new_n218_ & x04));
  ...
  assign new_n223_ = x04 & x78 & x79 & (new_n224_ | (new_n177_ & new_n225_));
  ...
  assign new_n229_ = x78 & (~x79 | (~x42 & (~new_n176_ | ~new_n177_)));
  assign new_n230_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n232_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n175_ | ~x79)));
  ...
  assign new_n236_ = x04 ? (x79 & (x42 | (new_n176_ & new_n177_))) : (~x79 | ~x81);
