...
module FAU ( 
  ...
  wire new_n154_, new_n174_, new_n175_, new_n176_, new_n177_, new_n178_,
    ...
    new_n220_, new_n222_, new_n224_, new_n226_, new_n228_, new_n229_,
    new_n232_, new_n233_, new_n234_, new_n235_, new_n236_, new_n238_,
    new_n239_, new_n242_, new_n243_, new_n244_, new_n246_, new_n248_;
  ...
  assign z55 = x84 & x83 & ~x82 & new_n226_ & ~x81;
  assign new_n226_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z56 = (~new_n228_ & x79) | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  assign new_n228_ = (~new_n229_ | x01) & (~x76 | (x77 & x78));
  assign new_n229_ = (x81 ^ x84) & (x77 ^ x78);
  ...
  assign z60 = ~x01 & ((new_n229_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n176_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n242_ : (new_n243_ | new_n244_))) | (new_n244_ & x77 & ~x78));
  assign new_n242_ = x04 ? (x79 & (x42 | (new_n177_ & new_n178_))) : (~x79 | ~x81);
  assign new_n243_ = x04 & ~x79;
  assign new_n244_ = x79 & x81 & x84;
  assign z64 = ~x01 & ((new_n246_ & x79) | (x04 & ~x77 & x78 & ~x79));
  assign new_n246_ = x83 & (((~x81 ^ x84) & (~x77 ^ ~x78)) | (~x04 & x77 & x78));
  assign z65 = new_n248_ & ~x01;
  assign new_n248_ = x79 & x84 & (x77 ? (x78 ? ~x04 : x81) : (x78 & x81));
  assign z04 = 1'b0;
  assign z09 = 1'b0;
  assign z19 = 1'b0;
  assign z47 = 1'b0;
