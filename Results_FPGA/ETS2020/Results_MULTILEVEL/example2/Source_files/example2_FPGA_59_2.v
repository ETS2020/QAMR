...
module FAU ( 
  ...
  assign new_n215_ = x04 & x78 & x79 & (new_n216_ | (new_n169_ & new_n217_));
  ...
  assign new_n221_ = x78 & (~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n222_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n212_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n167_ | ~x79)));
  ...
  assign new_n227_ = x04 ? (x79 & (x42 | (new_n168_ & new_n169_))) : (~x79 | ~x81);
