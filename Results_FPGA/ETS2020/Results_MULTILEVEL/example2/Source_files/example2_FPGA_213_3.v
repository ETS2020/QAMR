...
module FAU ( 
  ...
  assign new_n242_ = x78 & (~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n243_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n233_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n177_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n246_ : (new_n247_ | new_n248_))) | (new_n248_ & x77 & ~x78));
  assign new_n246_ = x04 ? (x79 & (x42 | (new_n178_ & new_n179_))) : (~x79 | ~x81);
  assign new_n247_ = x04 & ~x79;
  assign new_n248_ = x79 & x81 & x84;
  assign z64 = ~x01 & ((new_n250_ & x79) | (x04 & ~x77 & x78 & ~x79));
  assign new_n250_ = x83 & (((~x81 ^ x84) & (~x77 ^ ~x78)) | (~x04 & x77 & x78));
