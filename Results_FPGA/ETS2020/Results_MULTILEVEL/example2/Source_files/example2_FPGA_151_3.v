...
module FAU ( 
  ...
  wire new_n154_, new_n173_, new_n174_, new_n175_, new_n176_, new_n177_,
    ...
    new_n196_, new_n210_, new_n211_, new_n213_, new_n214_, new_n216_,
    new_n218_, new_n220_, new_n222_, new_n224_, new_n226_, new_n228_,
    new_n229_, new_n232_, new_n233_, new_n234_, new_n235_, new_n236_,
    new_n238_, new_n239_, new_n242_, new_n243_, new_n244_, new_n246_,
    new_n248_;
  ...
  assign z47 = ~x01 & ((x04 & ~x77 & new_n210_ & x78) | (x77 & new_n211_ & ~x78));
  assign new_n210_ = ~x79 & (x52 ? x15 : x07);
  assign new_n211_ = x79 & (x81 ^ ~x84) & (x67 | x75);
  assign z48 = ~x01 & ((new_n213_ & x04) | (new_n214_ & x68));
  assign new_n213_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n214_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z49 = ~x01 & ((new_n214_ & x69) | (new_n216_ & x04));
  assign new_n216_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n214_ & x70) | (new_n218_ & x04));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n214_ & x71) | (new_n220_ & x04));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z53 = ~x01 & ((new_n214_ & x73) | (new_n222_ & x04));
  ...
  assign new_n232_ = x04 & x78 & x79 & (new_n233_ | (new_n177_ & new_n234_));
  ...
  assign new_n238_ = x78 & (~x79 | (~x42 & (~new_n176_ | ~new_n177_)));
  assign new_n239_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n229_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n175_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n242_ : (new_n243_ | new_n244_))) | (new_n244_ & x77 & ~x78));
  assign new_n242_ = x04 ? (x79 & (x42 | (new_n176_ & new_n177_))) : (~x79 | ~x81);
