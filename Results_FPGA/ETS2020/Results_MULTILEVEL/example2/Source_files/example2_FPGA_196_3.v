// Benchmark "FAU" written by ABC on Thu Aug  6 01:06:54 2020
...
module FAU ( 
  ...
  assign z49 = ~x01 & ((new_n208_ & x69) | (new_n210_ & x04));
  assign new_n210_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n208_ & x70) | (new_n212_ & x04));
  assign new_n212_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n208_ & x71) | (new_n214_ & x04));
  assign new_n214_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n208_ & x72) | (new_n216_ & x04));
  assign new_n216_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n208_ & x73) | (new_n218_ & x04));
  ...
  assign new_n228_ = x04 & x78 & x79 & (new_n229_ | (new_n175_ & new_n230_));
  ...
  assign new_n234_ = x78 & (~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n235_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n225_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n173_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n238_ : (new_n239_ | new_n240_))) | (new_n240_ & x77 & ~x78));
  assign new_n238_ = x04 ? (x79 & (x42 | (new_n174_ & new_n175_))) : (~x79 | ~x81);
