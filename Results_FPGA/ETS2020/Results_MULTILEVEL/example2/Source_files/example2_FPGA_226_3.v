...
module FAU ( 
  ...
  wire new_n154_, new_n174_, new_n175_, new_n176_, new_n177_, new_n180_,
    new_n182_, new_n191_, new_n192_, new_n193_, new_n195_, new_n196_,
    new_n210_, new_n211_, new_n213_, new_n215_, new_n217_, new_n219_,
    new_n221_, new_n223_, new_n225_, new_n226_, new_n229_, new_n230_,
    new_n231_, new_n232_, new_n233_, new_n235_, new_n236_, new_n239_,
    new_n240_, new_n241_, new_n243_, new_n245_;
  ...
  assign new_n229_ = x04 & x78 & x79 & (new_n230_ | (new_n176_ & new_n231_));
  ...
  assign new_n235_ = x78 & (~x79 | (~x42 & (~new_n175_ | ~new_n176_)));
  assign new_n236_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n226_ & x79) | (~x04 & ~x79) | (new_n174_ & x04));
