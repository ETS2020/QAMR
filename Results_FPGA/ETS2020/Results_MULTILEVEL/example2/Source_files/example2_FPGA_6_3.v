// Benchmark "FAU" written by ABC on Thu Aug  6 01:05:11 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n174_, new_n175_, new_n176_, new_n177_, new_n178_,
    ...
    new_n220_, new_n222_, new_n224_, new_n227_, new_n228_, new_n229_,
  ...
  assign new_n227_ = x04 & x78 & x79 & (new_n228_ | (new_n178_ & new_n229_));
  ...
  assign new_n233_ = x78 & (~x79 | (~x42 & (~new_n177_ | ~new_n178_)));
  assign new_n234_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n236_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n176_ | ~x79)));
  assign new_n236_ = (x81 ^ x84) & (x77 ^ x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n238_ : (new_n239_ | new_n240_))) | (new_n240_ & x77 & ~x78));
  assign new_n238_ = x04 ? (x79 & (x42 | (new_n177_ & new_n178_))) : (~x79 | ~x81);
