...
module FAU ( 
  ...
  assign z49 = ~x01 & ((new_n210_ & x04) | (new_n211_ & x69));
  assign new_n210_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  ...
  assign z53 = ~x01 & ((new_n211_ & x73) | (new_n217_ & x04));
  assign new_n217_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & new_n219_ & x04;
  assign new_n219_ = ~x77 & x78 & ~x79 & (x52 ? x22 : x14);
  ...
  assign z60 = ~x01 & ((new_n224_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n174_ | ~x79)));
  assign z61 = ~x01 & x79 & ~new_n237_ & x80;
  assign new_n237_ = ((~x81 ^ ~x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n239_ : (new_n240_ | new_n241_))) | (new_n241_ & x77 & ~x78));
  assign new_n239_ = x04 ? (x79 & (x42 | (new_n175_ & new_n176_))) : (~x79 | ~x81);
  assign new_n240_ = x04 & ~x79;
  assign new_n241_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n237_ & x82;
  assign z64 = ~x01 & ((new_n244_ & x78 & ~x79) | (x79 & ~new_n237_ & x83));
  assign new_n244_ = x04 & ~x77;
