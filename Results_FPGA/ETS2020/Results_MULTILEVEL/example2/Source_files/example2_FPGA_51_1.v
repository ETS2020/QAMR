...
module FAU ( 
  ...
  assign z37 = ~x01 & ~x04 & x55 & x77 & new_n180_ & x78;
  ...
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n199_ | (new_n198_ & x04))));
  assign new_n198_ = x78 & (~x79 | (~x42 & (~new_n171_ | ~new_n172_)));
  assign new_n199_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n201_ & x79) | (~x04 & ~x79) | (new_n170_ & x04));
  assign new_n201_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = ~x01 & x79 & ~new_n203_ & x80;
  assign new_n203_ = ((~x81 ^ ~x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n205_ : (new_n206_ | new_n207_))) | (new_n207_ & x77 & ~x78));
  assign new_n205_ = x04 ? (x79 & (x42 | (new_n171_ & new_n172_))) : (~x79 | ~x81);
  assign new_n206_ = x04 & ~x79;
  assign new_n207_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n203_ & x82;
  assign z64 = ~x01 & ((x79 & ~new_n203_ & x83) | (new_n210_ & x78 & ~x79));
  assign new_n210_ = x04 & ~x77;
