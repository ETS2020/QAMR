...
module FAU ( 
  ...
  wire new_n154_, new_n171_, new_n172_, new_n173_, new_n174_, new_n175_,
    ...
    new_n216_, new_n218_, new_n220_, new_n222_, new_n225_, new_n226_,
  ...
  assign new_n225_ = x04 & x78 & x79 & (new_n226_ | (new_n175_ & new_n227_));
  ...
  assign new_n231_ = x78 & (~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n232_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n234_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n173_ | ~x79)));
  assign new_n234_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n236_ : (new_n237_ | new_n238_))) | (new_n238_ & x77 & ~x78));
  assign new_n236_ = x04 ? (x79 & (x42 | (new_n174_ & new_n175_))) : (~x79 | ~x81);
