...
module FAU ( 
  ...
  wire new_n154_, new_n173_, new_n174_, new_n175_, new_n176_, new_n177_,
    ...
    new_n219_, new_n221_, new_n223_, new_n225_, new_n226_, new_n229_,
  ...
  assign z52 = ~x01 & ((new_n211_ & x72) | (new_n217_ & x04));
  assign new_n217_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n211_ & x73) | (new_n219_ & x04));
  ...
  assign z56 = (~new_n225_ & x79) | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  assign new_n225_ = (~new_n226_ | x01) & (~x76 | (x77 & x78));
  assign new_n226_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z57 = x03 & ~x02 & x00 & ~x01;
  assign z58 = ~x01 & (new_n233_ | (x77 & (new_n229_ | new_n232_)));
  assign new_n229_ = x04 & x78 & x79 & (new_n230_ | (new_n177_ & new_n231_));
  ...
  assign new_n235_ = x78 & (~x79 | (~x42 & (~new_n176_ | ~new_n177_)));
  assign new_n236_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n226_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n175_ | ~x79)));
