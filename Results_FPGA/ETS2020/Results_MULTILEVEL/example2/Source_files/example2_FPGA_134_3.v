...
module FAU ( 
  ...
  assign z53 = ~x01 & ((new_n214_ & x73) | (new_n220_ & x04));
  ...
  assign new_n227_ = x04 & x78 & x79 & (new_n228_ | (new_n180_ & new_n229_));
  ...
  assign new_n233_ = x78 & (~x79 | (~x42 & (~new_n179_ | ~new_n180_)));
  assign new_n234_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n236_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n178_ | ~x79)));
  assign new_n236_ = (x81 ^ x84) & (x77 ^ x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n238_ : (new_n239_ | new_n240_))) | (new_n240_ & x77 & ~x78));
  assign new_n238_ = x04 ? (x79 & (x42 | (new_n179_ & new_n180_))) : (~x79 | ~x81);
