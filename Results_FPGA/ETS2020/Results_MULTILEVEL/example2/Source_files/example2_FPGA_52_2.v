...
module FAU ( 
  ...
  wire new_n163_, new_n164_, new_n165_, new_n166_, new_n167_, new_n169_,
    ...
    new_n217_, new_n218_, new_n220_, new_n221_, new_n224_, new_n226_,
    new_n227_, new_n228_, new_n231_, new_n233_;
  ...
  assign new_n214_ = x04 & x78 & x79 & (new_n215_ | (new_n167_ & new_n216_));
  ...
  assign new_n220_ = x78 & (~x79 | (~x42 & (~new_n166_ | ~new_n167_)));
  assign new_n221_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n211_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n165_ | ~x79)));
  ...
  assign new_n226_ = x04 ? (x79 & (x42 | (new_n166_ & new_n167_))) : (~x79 | ~x81);
