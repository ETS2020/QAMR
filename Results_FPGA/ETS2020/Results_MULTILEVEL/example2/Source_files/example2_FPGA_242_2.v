// Benchmark "FAU" written by ABC on Thu Aug  6 01:07:19 2020
...
module FAU ( 
  ...
  assign new_n218_ = x04 & x78 & x79 & (new_n219_ | (new_n174_ & new_n220_));
  assign new_n219_ = ~x40 & x42;
  assign new_n220_ = ~x42 & x43 & ~x74 & x80;
  assign new_n221_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n222_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n225_ | (new_n224_ & x04))));
  assign new_n224_ = x78 & (~x79 | (~x42 & (~new_n173_ | ~new_n174_)));
  assign new_n225_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n227_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n172_ | ~x79)));
  ...
  assign new_n231_ = x04 ? (x79 & (x42 | (new_n173_ & new_n174_))) : (~x79 | ~x81);
