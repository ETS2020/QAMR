...
module FAU ( 
  ...
  assign new_n228_ = x04 & x78 & x79 & (new_n229_ | (new_n178_ & new_n230_));
  ...
  assign new_n234_ = x78 & (~x79 | (~x42 & (~new_n177_ | ~new_n178_)));
  assign new_n235_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n237_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n176_ | ~x79)));
