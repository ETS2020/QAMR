...
module FAU ( 
  ...
  assign z56 = (~new_n230_ & x79) | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  assign new_n230_ = (~new_n231_ | x01) & (~x76 | (x77 & x78));
  assign new_n231_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z57 = x03 & ~x02 & x00 & ~x01;
  assign z58 = ~x01 & (new_n238_ | (x77 & (new_n234_ | new_n237_)));
  assign new_n234_ = x04 & x78 & x79 & (new_n235_ | (new_n177_ & new_n236_));
  ...
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n241_ | (new_n240_ & x04))));
  assign new_n240_ = x78 & (~x79 | (~x42 & (~new_n176_ | ~new_n177_)));
  assign new_n241_ = x40 & (x78 ? x04 : ~x79);
  ...
  assign new_n244_ = x04 ? (x79 & (x42 | (new_n176_ & new_n177_))) : (~x79 | ~x81);
