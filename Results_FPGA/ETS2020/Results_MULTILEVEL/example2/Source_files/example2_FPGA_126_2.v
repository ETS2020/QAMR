...
module FAU ( 
  ...
  wire new_n165_, new_n166_, new_n167_, new_n168_, new_n169_, new_n171_,
    ...
    new_n220_, new_n222_, new_n224_, new_n225_, new_n226_, new_n229_,
    new_n231_;
  ...
  assign z50 = ~x01 & ((new_n200_ & x70) | (new_n202_ & x04));
  assign new_n202_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n200_ & x71) | (new_n204_ & x04));
  assign new_n204_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z54 = ~x01 & new_n206_ & x04;
  assign new_n206_ = ~x77 & x78 & ~x79 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & new_n208_ & ~x81;
  assign new_n208_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z57 = x03 & ~x02 & x00 & ~x01;
  assign z58 = ~x01 & (new_n215_ | (x77 & (new_n211_ | new_n214_)));
  assign new_n211_ = x04 & x78 & x79 & (new_n212_ | (new_n169_ & new_n213_));
  assign new_n212_ = ~x40 & x42;
  assign new_n213_ = ~x74 & x80 & ~x42 & x43;
  assign new_n214_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n215_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n218_ | (new_n217_ & x04))));
  assign new_n217_ = x78 & (~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n218_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n220_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n167_ | ~x79)));
  ...
  assign new_n224_ = x04 ? (x79 & (x42 | (new_n168_ & new_n169_))) : (~x79 | ~x81);
  assign new_n225_ = x04 & ~x79;
  assign new_n226_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n222_ & x82;
  assign z64 = ~x01 & ((new_n229_ & x78 & ~x79) | (x79 & ~new_n222_ & x83));
  assign new_n229_ = x04 & ~x77;
  assign z65 = new_n231_ & ~x01;
  assign new_n231_ = x79 & x84 & (x77 ? (x78 ? ~x04 : x81) : (x78 & x81));
  assign z00 = 1'b0;
  assign z03 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
