...
module FAU ( 
  ...
  wire new_n154_, new_n172_, new_n173_, new_n174_, new_n175_, new_n178_,
    ...
    new_n207_, new_n209_, new_n210_, new_n213_, new_n215_, new_n216_,
    new_n217_, new_n220_;
  ...
  assign new_n203_ = x04 & x78 & x79 & (new_n204_ | (new_n174_ & new_n205_));
  ...
  assign new_n209_ = x78 & (~x79 | (~x42 & (~new_n173_ | ~new_n174_)));
  assign new_n210_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n201_ & x79) | (~x04 & ~x79) | (new_n172_ & x04));
