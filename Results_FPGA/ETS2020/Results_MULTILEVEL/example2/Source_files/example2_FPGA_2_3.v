// Benchmark "FAU" written by ABC on Thu Aug  6 01:05:09 2020
...
module FAU ( 
  ...
  assign z52 = ~x01 & ((new_n214_ & x72) | (new_n222_ & x04));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n214_ & x73) | (new_n224_ & x04));
  ...
  assign z60 = ~x01 & ((new_n240_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n175_ | ~x79)));
