...
module FAU ( 
  ...
  assign z50 = ~x01 & ((new_n199_ & x04) | (new_n200_ & x70));
  assign new_n199_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign new_n200_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z51 = ~x01 & ((new_n200_ & x71) | (new_n202_ & x04));
  assign new_n202_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  ...
  assign new_n210_ = x04 & x78 & x79 & (new_n211_ | (new_n169_ & new_n212_));
  ...
  assign new_n216_ = x78 & (~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n217_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n207_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n167_ | ~x79)));
  ...
  assign new_n222_ = x04 ? (x79 & (x42 | (new_n168_ & new_n169_))) : (~x79 | ~x81);
