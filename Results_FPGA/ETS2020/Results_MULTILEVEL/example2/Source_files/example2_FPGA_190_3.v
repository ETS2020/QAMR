// Benchmark "FAU" written by ABC on Thu Aug  6 01:06:51 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n171_, new_n172_, new_n173_, new_n174_, new_n175_,
    new_n177_, new_n179_, new_n188_, new_n189_, new_n190_, new_n192_,
    new_n193_, new_n207_, new_n208_, new_n210_, new_n212_, new_n214_,
    new_n216_, new_n218_, new_n220_, new_n221_, new_n224_, new_n225_,
    new_n226_, new_n227_, new_n228_, new_n230_, new_n231_, new_n234_,
  ...
  assign z53 = ~x01 & ((new_n208_ & x73) | (new_n214_ & x04));
  assign new_n214_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & new_n216_ & x04;
  assign new_n216_ = ~x77 & x78 & ~x79 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & new_n218_ & ~x81;
  assign new_n218_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z56 = (~new_n220_ & x79) | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  assign new_n220_ = (~new_n221_ | x01) & (~x76 | (x77 & x78));
  assign new_n221_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z57 = x03 & ~x02 & x00 & ~x01;
  assign z58 = ~x01 & (new_n228_ | (x77 & (new_n224_ | new_n227_)));
  assign new_n224_ = x04 & x78 & x79 & (new_n225_ | (new_n175_ & new_n226_));
  assign new_n225_ = ~x40 & x42;
  assign new_n226_ = ~x74 & x80 & ~x42 & x43;
  assign new_n227_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n228_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n231_ | (new_n230_ & x04))));
  assign new_n230_ = x78 & (~x79 | (~x42 & (~new_n174_ | ~new_n175_)));
  assign new_n231_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n221_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n173_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n234_ : (new_n235_ | new_n236_))) | (new_n236_ & x77 & ~x78));
  assign new_n234_ = x04 ? (x79 & (x42 | (new_n174_ & new_n175_))) : (~x79 | ~x81);
