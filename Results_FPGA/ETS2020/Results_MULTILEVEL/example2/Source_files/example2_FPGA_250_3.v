...
module FAU ( 
  ...
  assign new_n231_ = x04 & x78 & x79 & (new_n232_ | (new_n174_ & new_n233_));
  ...
  assign new_n237_ = x78 & (~x79 | (~x42 & (~new_n173_ | ~new_n174_)));
  assign new_n238_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n228_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n172_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n241_ : (new_n242_ | new_n243_))) | (new_n243_ & x77 & ~x78));
  assign new_n241_ = x04 ? (x79 & (x42 | (new_n173_ & new_n174_))) : (~x79 | ~x81);
