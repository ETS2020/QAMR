// Benchmark "FAU" written by ABC on Thu Aug  6 01:05:45 2020
...
module FAU ( 
  ...
  wire new_n170_, new_n171_, new_n172_, new_n173_, new_n174_, new_n177_,
    ...
    new_n237_, new_n238_, new_n239_, new_n242_, new_n244_;
  ...
  assign new_n237_ = x04 ? (x79 & (x42 | (new_n173_ & new_n174_))) : (~x79 | ~x81);
  assign new_n238_ = x04 & ~x79;
  assign new_n239_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n235_ & x82;
  assign z64 = ~x01 & ((new_n242_ & x78 & ~x79) | (x79 & ~new_n235_ & x83));
  assign new_n242_ = x04 & ~x77;
