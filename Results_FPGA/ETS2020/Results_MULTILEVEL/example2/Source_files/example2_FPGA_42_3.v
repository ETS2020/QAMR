...
module FAU ( 
  ...
  assign new_n228_ = x04 & x78 & x79 & (new_n229_ | (new_n180_ & new_n230_));
  ...
  assign new_n234_ = x78 & (~x79 | (~x42 & (~new_n179_ | ~new_n180_)));
  assign new_n235_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n237_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n178_ | ~x79)));
  assign new_n237_ = (x81 ^ x84) & (x77 ^ x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n239_ : (new_n240_ | new_n241_))) | (new_n241_ & x77 & ~x78));
  assign new_n239_ = x04 ? (x79 & (x42 | (new_n179_ & new_n180_))) : (~x79 | ~x81);
