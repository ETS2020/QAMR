...
module FAU ( 
  ...
  assign new_n217_ = x04 & x78 & x79 & (new_n218_ | (new_n170_ & new_n219_));
  ...
  assign new_n223_ = x78 & (~x79 | (~x42 & (~new_n169_ | ~new_n170_)));
  assign new_n224_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n214_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n168_ | ~x79)));
