...
module FAU ( 
  ...
  assign z53 = ~x01 & ((new_n199_ & x73) | (new_n203_ & x04));
  ...
  assign new_n213_ = x04 & x78 & x79 & (new_n214_ | (new_n169_ & new_n215_));
  ...
  assign new_n219_ = x78 & (~x79 | (~x42 & (~new_n168_ | ~new_n169_)));
  assign new_n220_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n210_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n167_ | ~x79)));
  ...
  assign new_n225_ = x04 ? (x79 & (x42 | (new_n168_ & new_n169_))) : (~x79 | ~x81);
