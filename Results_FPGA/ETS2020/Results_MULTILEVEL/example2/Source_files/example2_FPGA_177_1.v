// Benchmark "FAU" written by ABC on Thu Aug  6 01:06:44 2020
...
module FAU ( 
  ...
  assign new_n209_ = x78 & (~x79 | (~x42 & (~new_n176_ | ~new_n177_)));
  assign new_n210_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n201_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n175_ | ~x79)));
  ...
  assign new_n215_ = x04 ? (x79 & (x42 | (new_n176_ & new_n177_))) : (~x79 | ~x81);
