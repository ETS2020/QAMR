// Benchmark "FAU" written by ABC on Thu Aug  6 01:06:50 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n243_, new_n244_, new_n245_, new_n247_, new_n249_;
  ...
  assign new_n232_ = x04 & x78 & x79 & (new_n233_ | (new_n181_ & new_n234_));
  ...
  assign new_n238_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n239_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n241_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n241_ = (x81 ^ x84) & (x77 ^ x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n243_ : (new_n244_ | new_n245_))) | (new_n245_ & x77 & ~x78));
  assign new_n243_ = x04 ? (x79 & (x42 | (new_n180_ & new_n181_))) : (~x79 | ~x81);
