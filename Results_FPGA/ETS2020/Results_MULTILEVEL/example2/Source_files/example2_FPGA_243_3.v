...
module FAU ( 
  ...
  assign new_n229_ = x04 & x78 & x79 & (new_n230_ | (new_n178_ & new_n231_));
  assign new_n230_ = ~x40 & x42;
  assign new_n231_ = ~x42 & x43 & ~x74 & x80;
  assign new_n232_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n233_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n236_ | (new_n235_ & x04))));
  assign new_n235_ = x78 & (~x79 | (~x42 & (~new_n177_ | ~new_n178_)));
  assign new_n236_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n226_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n176_ | ~x79)));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n239_ : (new_n240_ | new_n241_))) | (new_n241_ & x77 & ~x78));
  assign new_n239_ = x04 ? (x79 & (x42 | (new_n177_ & new_n178_))) : (~x79 | ~x81);
