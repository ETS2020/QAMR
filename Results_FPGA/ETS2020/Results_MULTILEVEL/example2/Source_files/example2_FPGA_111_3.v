...
module FAU ( 
  ...
  assign new_n227_ = x04 & x78 & x79 & (new_n228_ | (new_n179_ & new_n229_));
  ...
  assign new_n233_ = x78 & (~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n234_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n236_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n177_ | ~x79)));
