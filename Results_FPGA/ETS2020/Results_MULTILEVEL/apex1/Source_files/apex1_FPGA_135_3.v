// Benchmark "FAU" written by ABC on Wed Aug  5 08:22:40 2020
...
module FAU ( 
  ...
  assign new_n576_ = (~x00 | ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28))) & (x19 | ~x21 | ~x28) & (new_n382_ | x21);
  assign new_n577_ = new_n583_ & (~x29 | (new_n581_ & (x28 | (~new_n578_ & new_n579_))));
  assign new_n578_ = ~x19 & (x21 ? ~new_n393_ : (~x18 | (new_n246_ & ~x17 & x18)));
  ...
  assign new_n602_ = x19 & ((new_n413_ & x18) | (x28 & (x18 ? new_n117_ : new_n603_)));
  ...
  assign new_n612_ = x21 & (new_n613_ | (~x09 & new_n416_ & ~x18));
  ...
  assign new_n626_ = (~new_n385_ | ~x19) & (~x20 | ((~new_n158_ | x19) & (~new_n197_ | x04 | ~x19)));
