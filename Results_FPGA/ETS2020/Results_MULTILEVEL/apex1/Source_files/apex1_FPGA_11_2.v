...
module FAU ( 
  ...
  assign new_n169_ = (x20 | (x21 ? (~x22 | ~x28) : (x28 | x29))) & (x21 | x29 | ((~x23 | x28) & (~x20 | ~x22)));
  ...
  assign new_n178_ = x28 & x26 & ~x21 & new_n108_ & x20;
  ...
  assign z26 = ~x21 & ~x28 & ~x29 & ~new_n195_ & x30;
  assign new_n195_ = (~x19 | ~x20 | (x18 ? x27 : ~x22)) & (x18 | x19 | (x20 & ~x23));
  assign z27 = ~x21 & (x18 ? (x19 & ~new_n200_ & x20) : ~new_n197_);
  assign new_n197_ = x19 ? (~x20 | new_n199_ | ~x22) : new_n198_;
  assign new_n198_ = (~x28 | x29 | new_n122_ | ~x30) & (x20 | x28 | ~new_n119_ | ~x29);
