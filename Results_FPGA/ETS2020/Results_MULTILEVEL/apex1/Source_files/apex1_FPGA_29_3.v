// Benchmark "FAU" written by ABC on Wed Aug  5 08:21:19 2020
...
module FAU ( 
  ...
  wire new_n93_, new_n95_, new_n97_, new_n99_, new_n100_, new_n101_,
    ...
    new_n645_, new_n646_, new_n648_, new_n650_;
  ...
  assign new_n374_ = ~new_n220_ & (new_n375_ | x21) & (~x21 | (x19 ? new_n393_ : new_n385_));
  assign new_n375_ = (x29 | (x18 ? new_n379_ : new_n376_)) & (new_n381_ | ~x18) & (x18 | new_n384_ | ~x29);
  assign new_n376_ = x19 ? ~new_n378_ : (~new_n275_ & new_n377_);
  ...
  assign new_n381_ = x19 ? (~x29 | (~new_n265_ & ~new_n383_)) : new_n382_;
  ...
  assign new_n386_ = ~new_n387_ & ~new_n388_ & (~new_n229_ | ~x05 | x10);
  ...
  assign new_n396_ = (x18 | (new_n406_ & (new_n397_ | x20))) & ~new_n155_ & (new_n402_ | ~x18);
  assign new_n397_ = ~new_n210_ & ~new_n401_ & (x19 | (~new_n400_ & (new_n398_ | x28)));
  assign new_n398_ = (new_n278_ | x21) & (x09 | ~x21 | ~x22 | ~new_n399_ | x38);
  assign new_n399_ = ~x41 & (x39 ? x42 : (~x42 & (x40 | (~x40 & (x43 ^ x44)))));
  assign new_n400_ = x21 & x23 & new_n331_ & ~x31;
  assign new_n401_ = new_n296_ & x22 & ~x28 & ~x38 & ~x09 & x21;
  assign new_n402_ = x20 ? new_n403_ : ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28));
  assign new_n403_ = new_n405_ & (x28 | ((new_n404_ | x19) & (new_n154_ | ~x21) & (~x19 | x21)));
  ...
  assign new_n414_ = ~x20 & x22 & ~x28 & ~new_n165_ & x29;
  assign new_n415_ = new_n229_ & ~x10;
  ...
  assign new_n427_ = new_n184_ & x20;
  assign new_n428_ = x30 & (x20 ? ~new_n149_ : ~new_n198_);
  ...
  assign new_n437_ = (~x28 | x29 | new_n438_ | ~x30) & (x20 | x28 | ~x29 | new_n278_ | x30);
  ...
  assign new_n445_ = ~x28 & ((~new_n446_ & ~x29) | (x11 & ~new_n201_ & x29));
  ...
  assign new_n451_ = ~x20 & ((new_n140_ & x18 & ~x19) | (~x18 & (new_n452_ | (~new_n453_ & ~x19))));
  assign new_n452_ = new_n296_ & x29 & ~x30 & ~x38 & new_n109_ & ~x09;
  assign new_n453_ = (~x22 | ~x28 | ~x30) & (~x23 | ~x29 | x30);
  assign new_n454_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n149_ & ~x30;
  ...
  assign new_n459_ = (~new_n143_ | x21 | ~x27 | x30) & (~x30 | (~new_n461_ & (new_n460_ | ~x21)));
  assign new_n460_ = x19 ? (~x18 & (~new_n108_ | ~new_n109_ | x18)) : (~new_n101_ & (x18 | ~x24));
  assign new_n461_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n462_ = (new_n463_ | x20) & (~new_n140_ | x18 | ~x19 | ~x21);
  assign new_n463_ = (new_n464_ | x19) & (~new_n113_ | ~new_n156_ | ~x18 | ~x19 | x21);
  assign new_n464_ = (x03 | x18 | new_n119_ | x21) & (~new_n110_ | x28 | ~x18 | ~x21);
  ...
  assign new_n469_ = (new_n470_ | ~x00) & (~new_n135_ | ~new_n195_ | x00 | x04 | ~x18);
  assign new_n470_ = (new_n471_ | ~x20) & (~x18 | ~x19 | new_n118_ | x20);
  assign new_n471_ = (x18 | ~x19 | ~x22 | ~x28) & (x17 | ~x18 | x19 | ~x26 | x28);
  assign z31 = ~x21 & x28 & (new_n475_ | (~new_n473_ & x00));
  assign new_n473_ = (~new_n474_ | ~x18) & (~new_n135_ | x18 | ~new_n113_ | ~x22);
  assign new_n474_ = x26 & ~x29 & x30 & (x19 ^ x20);
  assign new_n475_ = new_n114_ & ~x00 & ~x04 & new_n113_ & x20 & ~x27;
  ...
  assign new_n483_ = (~new_n164_ | x09) & (x30 | ((~new_n486_ | ~x19) & (x09 | ~new_n484_ | x19)));
  ...
  assign new_n498_ = ~x19 & x21 & ~x28 & x29 & ~new_n201_ & x30;
  assign new_n499_ = (~new_n366_ | ~new_n137_ | x19) & (new_n500_ | x20);
  assign new_n500_ = ~new_n501_ & (~new_n110_ | ~new_n130_ | ~x00 | ~x19 | x21);
  ...
  assign new_n505_ = x21 ? (~new_n506_ & (~x01 | ~new_n168_ | x20)) : new_n507_;
  assign new_n506_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n507_ = x20 ? (~x22 | (x28 & (~x28 | (x02 & ~x03)))) : (~x22 & ~x23);
  assign new_n508_ = (x21 | (~new_n509_ & ~x24)) & (~x00 | ~x21 | (new_n102_ & ~x22 & ~x24));
  ...
  assign new_n513_ = (new_n514_ | new_n118_) & ~new_n516_ & (~x18 | (~new_n518_ & ~new_n519_));
  assign new_n514_ = ~new_n515_ & (~new_n350_ | ~new_n252_ | ~new_n108_ | ~x00);
  ...
  assign new_n524_ = ~new_n244_ & (~new_n257_ | x41 | ~x42 | x38 | ~x39);
  assign new_n525_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n154_ | x28)));
  assign new_n526_ = new_n114_ & x20 & ~x27 & ~x28;
  assign new_n527_ = ~x03 & (new_n528_ | (new_n114_ & x20 & x27 & ~x29));
  assign new_n528_ = new_n171_ & new_n253_ & x00 & ~x05 & ~x18;
  ...
  assign new_n536_ = (~x19 | (~new_n537_ & (~new_n497_ | ~x20))) & (~new_n335_ | x14 | x19 | x20);
  assign new_n537_ = x00 & ((~x20 & ~new_n118_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n549_ = (x18 | ~x20) & (x28 | (x20 ? new_n282_ : (~x18 & (x09 | ~new_n550_ | x18))));
  ...
  assign new_n553_ = x19 & x20 & ((new_n554_ & ~x18) | (new_n253_ & x18 & ~x27));
  assign new_n554_ = x22 & x28 & ~new_n547_ & ~x29;
  assign z37 = (x30 & (~new_n556_ | new_n220_)) | (~new_n587_ & ~x30) | (new_n612_ & ~x19);
  ...
  assign new_n565_ = (new_n512_ | x20) & (~x00 | ~x20 | (new_n102_ & ~x22 & ~x24));
  ...
  assign new_n572_ = new_n205_ & x18;
  assign new_n573_ = new_n130_ & ~x21 & x00 & x18;
  ...
  assign new_n578_ = ~x19 & (x21 ? ~new_n391_ : (~x18 | (new_n244_ & ~x17 & x18)));
  assign new_n579_ = (~new_n205_ | x20 | ~x18 | ~x19) & (~x20 | ((~new_n367_ | x18) & (new_n580_ | ~x19)));
  assign new_n580_ = x18 ? (x21 | x27 | (~x05 & (~x00 | x05))) : (~x21 | ~x22);
  assign new_n581_ = (~x20 | ~x21 | x18 | x19) & (~x19 | (~new_n582_ & (~x18 | (x20 ? ~x21 : (new_n198_ | x21)))));
  ...
  assign new_n588_ = ~x20 & (new_n210_ | new_n592_ | (~x28 & (new_n589_ | new_n591_)));
  ...
  assign new_n593_ = ~new_n155_ & (~x18 | (~new_n600_ & (new_n599_ | x20) & (new_n594_ | ~x20)));
  ...
  assign new_n599_ = x19 ? (x21 | ((~x26 | ~x28) & (~x00 | (~new_n133_ & (~x26 | x28))))) : (~x21 | x28);
  assign new_n600_ = x22 & ((x00 & x19 & ~x20 & ~x21) | (x20 & x21 & ~x28));
  assign new_n601_ = (~x20 | (~new_n602_ & (new_n604_ | x21))) & new_n606_ & (new_n551_ | ~x21);
  assign new_n602_ = x19 & ((new_n411_ & x18) | (x28 & (x18 ? new_n115_ : new_n603_)));
  assign new_n603_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n604_ = (new_n605_ | x18) & (~x17 | ~x18 | ~new_n130_ | x19);
  ...
  assign new_n619_ = (~x21 | x28 | (~new_n108_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n620_ = new_n137_ & x20 & ~x05 & ~x15 & ~x18;
  assign new_n621_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n622_ = new_n143_ & x20 & ~x21 & x27;
  ...
  assign new_n626_ = (~new_n383_ | ~x19) & (~x20 | ((~new_n156_ | x19) & (~new_n195_ | x04 | ~x19)));
  assign new_n627_ = new_n114_ & ~x05 & new_n172_ & x20 & ~x27;
  assign new_n628_ = ~x20 & ~new_n149_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n634_ & x29) | (x19 & (~new_n630_ | (~new_n639_ & ~x18)));
  assign new_n630_ = (~new_n169_ | ~x27 | x29 | ~x30) & (~x29 | (~new_n633_ & (new_n631_ | x30)));
  assign new_n631_ = (new_n632_ | ~x20) & (~x18 | x20 | ~new_n130_ | x21);
  assign new_n632_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n195_ | ~x04 | x21)));
  assign new_n633_ = x18 & ~x20 & ~x21 & ~new_n198_ & x30;
  assign new_n634_ = (~x20 | ((~new_n637_ | x19) & (new_n635_ | x30))) & (x19 | new_n638_ | x30);
  assign new_n635_ = (new_n636_ | ~x21) & (~x18 | x19 | ~new_n130_ | x21);
  assign new_n636_ = (~x18 | new_n154_ | x28) & (x19 | (x18 & (new_n282_ | x28)));
  assign new_n637_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n638_ = (x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20);
  assign new_n639_ = x21 ? new_n641_ : (~new_n640_ & (~x29 | new_n263_ | x30));
  assign new_n640_ = x02 & ~x03 & x20 & new_n110_ & x22 & x28;
  assign new_n641_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n149_ | ~x30);
  assign z40 = ~x28 & ((~new_n643_ & ~x18) | (x05 & x18 & new_n645_ & x20));
  assign new_n643_ = (new_n644_ | ~x05) & (~new_n113_ | x21 | ~new_n171_ | ~x03);
  ...
  assign z41 = x30 & ~x29 & ~x28 & x22 & new_n648_ & x21;
  assign new_n648_ = x20 & x19 & ~x18 & ~x15 & x00 & ~x05;
