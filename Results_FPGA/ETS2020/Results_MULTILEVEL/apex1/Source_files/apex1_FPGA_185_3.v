// Benchmark "FAU" written by ABC on Wed Aug  5 08:23:19 2020
...
module FAU ( 
  ...
  assign new_n374_ = x19 ? ~new_n376_ : (~new_n277_ & new_n375_);
  ...
  assign new_n379_ = x19 ? (~x29 | (~new_n267_ & ~new_n381_)) : new_n380_;
  ...
  assign new_n394_ = (x18 | (new_n404_ & (new_n395_ | x20))) & ~new_n157_ & (new_n400_ | ~x18);
  assign new_n395_ = ~new_n212_ & ~new_n399_ & (x19 | (~new_n398_ & (new_n396_ | x28)));
  assign new_n396_ = (new_n280_ | x21) & (x09 | ~x21 | ~x22 | ~new_n397_ | x38);
  assign new_n397_ = ~x41 & (x39 ? x42 : (~x42 & (x40 | (~x40 & (x43 ^ x44)))));
  assign new_n398_ = x21 & x23 & new_n333_ & ~x31;
  assign new_n399_ = new_n298_ & x22 & ~x28 & ~x38 & ~x09 & x21;
  assign new_n400_ = x20 ? new_n401_ : ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28));
  assign new_n401_ = new_n403_ & (x28 | ((new_n402_ | x19) & (new_n156_ | ~x21) & (~x19 | x21)));
  ...
  assign new_n412_ = ~x20 & x22 & ~x28 & ~new_n167_ & x29;
  ...
  assign new_n425_ = new_n186_ & x20;
  assign new_n426_ = x30 & (x20 ? ~new_n151_ : ~new_n200_);
  ...
  assign new_n435_ = (~x28 | x29 | new_n436_ | ~x30) & (x20 | x28 | ~x29 | new_n280_ | x30);
  ...
  assign new_n443_ = ~x28 & ((~new_n444_ & ~x29) | (x11 & ~new_n203_ & x29));
  ...
  assign new_n449_ = ~x20 & ((new_n142_ & x18 & ~x19) | (~x18 & (new_n450_ | (~new_n451_ & ~x19))));
  assign new_n450_ = new_n298_ & x29 & ~x30 & ~x38 & new_n111_ & ~x09;
  assign new_n451_ = (~x22 | ~x28 | ~x30) & (~x23 | ~x29 | x30);
  assign new_n452_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n151_ & ~x30;
  ...
  assign new_n457_ = (~new_n145_ | x21 | ~x27 | x30) & (~x30 | (~new_n459_ & (new_n458_ | ~x21)));
  assign new_n458_ = x19 ? (~x18 & (~new_n110_ | ~new_n111_ | x18)) : (~new_n104_ & (x18 | ~x24));
  assign new_n459_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n460_ = (new_n461_ | x20) & (~new_n142_ | x18 | ~x19 | ~x21);
  assign new_n461_ = (new_n462_ | x19) & (~new_n115_ | ~new_n158_ | ~x18 | ~x19 | x21);
  assign new_n462_ = (x03 | x18 | new_n121_ | x21) & (~new_n112_ | x28 | ~x18 | ~x21);
  ...
  assign new_n467_ = (new_n468_ | ~x00) & (~new_n137_ | ~new_n197_ | x00 | x04 | ~x18);
  assign new_n468_ = (new_n469_ | ~x20) & (~x18 | ~x19 | new_n120_ | x20);
  assign new_n469_ = (x18 | ~x19 | ~x22 | ~x28) & (x17 | ~x18 | x19 | ~x26 | x28);
  assign z31 = ~x21 & x28 & (new_n473_ | (~new_n471_ & x00));
  assign new_n471_ = (~new_n472_ | ~x18) & (~new_n137_ | x18 | ~new_n115_ | ~x22);
  assign new_n472_ = x26 & ~x29 & x30 & (x19 ^ x20);
  assign new_n473_ = new_n116_ & ~x00 & ~x04 & new_n115_ & x20 & ~x27;
  ...
  assign new_n481_ = (~new_n166_ | x09) & (x30 | ((~new_n484_ | ~x19) & (x09 | ~new_n482_ | x19)));
  ...
  assign new_n497_ = (~new_n368_ | ~new_n139_ | x19) & (new_n498_ | x20);
  assign new_n498_ = ~new_n499_ & (~new_n112_ | ~new_n132_ | ~x00 | ~x19 | x21);
  ...
  assign new_n503_ = x21 ? (~new_n504_ & (~x01 | ~new_n170_ | x20)) : new_n505_;
  ...
  assign new_n511_ = (new_n512_ | new_n120_) & ~new_n514_ & (~x18 | (~new_n516_ & ~new_n517_));
  assign new_n512_ = ~new_n513_ & (~new_n352_ | ~new_n254_ | ~new_n110_ | ~x00);
  ...
  assign new_n523_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n156_ | x28)));
  assign new_n524_ = new_n116_ & x20 & ~x27 & ~x28;
  assign new_n525_ = ~x03 & (new_n526_ | (new_n116_ & x20 & x27 & ~x29));
  assign new_n526_ = new_n173_ & new_n255_ & x00 & ~x05 & ~x18;
  assign new_n527_ = x29 & ((x00 & new_n529_ & ~x18) | (x18 & (new_n531_ | (~new_n528_ & x00))));
  assign new_n528_ = (~x19 | new_n120_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  ...
  assign new_n535_ = x00 & ((~x20 & ~new_n120_ & x29) | (x03 & x20 & x27 & ~x29));
  ...
  assign new_n571_ = new_n132_ & ~x21 & x00 & x18;
  ...
  assign new_n576_ = ~x19 & (x21 ? ~new_n389_ : (~x18 | (new_n246_ & ~x17 & x18)));
  assign new_n577_ = (~new_n207_ | x20 | ~x18 | ~x19) & (~x20 | ((~new_n369_ | x18) & (new_n578_ | ~x19)));
  ...
  assign new_n591_ = ~new_n157_ & (~x18 | (~new_n598_ & (new_n597_ | x20) & (new_n592_ | ~x20)));
  ...
  assign new_n597_ = x19 ? (x21 | ((~x26 | ~x28) & (~x00 | (~new_n135_ & (~x26 | x28))))) : (~x21 | x28);
  assign new_n598_ = x22 & ((x00 & x19 & ~x20 & ~x21) | (x20 & x21 & ~x28));
  assign new_n599_ = (~x20 | (~new_n600_ & (new_n602_ | x21))) & new_n604_ & (new_n549_ | ~x21);
  assign new_n600_ = x19 & ((new_n409_ & x18) | (x28 & (x18 ? new_n117_ : new_n601_)));
  assign new_n601_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n602_ = (new_n603_ | x18) & (~x17 | ~x18 | ~new_n132_ | x19);
  ...
  assign new_n617_ = (~x21 | x28 | (~new_n110_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  assign new_n618_ = new_n139_ & x20 & ~x05 & ~x15 & ~x18;
  assign new_n619_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  assign new_n620_ = new_n145_ & x20 & ~x21 & x27;
  ...
  assign new_n624_ = (~new_n381_ | ~x19) & (~x20 | ((~new_n158_ | x19) & (~new_n197_ | x04 | ~x19)));
  assign new_n625_ = new_n116_ & ~x05 & new_n174_ & x20 & ~x27;
  assign new_n626_ = ~x20 & ~new_n151_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n632_ & x29) | (x19 & (~new_n628_ | (~new_n637_ & ~x18)));
  assign new_n628_ = (~new_n171_ | ~x27 | x29 | ~x30) & (~x29 | (~new_n631_ & (new_n629_ | x30)));
  assign new_n629_ = (new_n630_ | ~x20) & (~x18 | x20 | ~new_n132_ | x21);
  ...
  assign new_n633_ = (new_n634_ | ~x21) & (~x18 | x19 | ~new_n132_ | x21);
  assign new_n634_ = (~x18 | new_n156_ | x28) & (x19 | (x18 & (new_n284_ | x28)));
  ...
  assign new_n638_ = x02 & ~x03 & x20 & new_n112_ & x22 & x28;
  assign new_n639_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n151_ | ~x30);
  assign z40 = ~x28 & ((~new_n641_ & ~x18) | (x05 & x18 & new_n643_ & x20));
  assign new_n641_ = (new_n642_ | ~x05) & (~new_n115_ | x21 | ~new_n173_ | ~x03);
