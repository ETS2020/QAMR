// Benchmark "FAU" written by ABC on Wed Aug  5 20:31:57 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n56_, new_n57_, new_n59_, new_n61_, new_n62_, new_n64_,
  ...
  assign new_n61_ = (~x21 | (x19 & ~new_n62_ & x20)) & (~x19 | ~x20 | x21);
  assign new_n62_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = x08 ? x03 : (x09 & ~new_n64_ & ~x10);
  assign new_n64_ = (~x22 | (x19 & x20 & ~new_n65_ & x21)) & (~x19 | ~x20 | ~x21 | x22);
  ...
  assign z14 = x08 ? x05 : (new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x24 & (~new_n71_ | ~x22 | new_n72_ | ~x23)) | (new_n71_ & x22 & x23 & ~x24));
