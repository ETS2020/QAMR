// Benchmark "FAU" written by ABC on Wed Aug  5 20:32:37 2020
...
module FAU ( 
  ...
  wire new_n47_, new_n55_, new_n56_, new_n58_, new_n60_, new_n61_, new_n62_,
    new_n64_, new_n65_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
  ...
  assign new_n71_ = (~x25 | (new_n68_ & new_n61_ & x24 & (~x17 | ~x26))) & (~new_n68_ | ~new_n61_ | ~x24 | x25);
