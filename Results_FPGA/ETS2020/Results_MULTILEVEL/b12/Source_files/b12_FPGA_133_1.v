...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n29_, new_n33_, new_n35_;
  ...
  assign z7 = (~new_n33_ & ~x01) | x07 | x10 | (~x08 & (x01 | ~x03));
  assign new_n33_ = (x02 | ~x03 | ~x09) & (x08 | x10 | ~x02 | x07);
  assign z8 = (~new_n35_ & x09) | x07 | x10 | (~x00 & ~x09);
  assign new_n35_ = x03 & ~x12 & ~x01 & ~x02;
  assign z0 = 1'b0;
  assign z1 = 1'b0;
  assign z3 = 1'b0;
  assign z6 = 1'b0;
