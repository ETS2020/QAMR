// Benchmark "FAU" written by ABC on Wed Aug  5 18:02:36 2020
...
module FAU ( 
  ...
  assign z4 = (~new_n36_ & (x08 | (~new_n40_ & ~x16))) | (~new_n38_ & (~x08 | (~new_n41_ & x16)));
  ...
  assign new_n40_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n41_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z0 = 1'b0;
  assign z1 = 1'b0;
  assign z2 = 1'b0;
  assign z3 = 1'b0;
