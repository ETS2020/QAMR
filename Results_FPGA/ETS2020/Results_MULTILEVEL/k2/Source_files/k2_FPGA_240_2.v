...
module FAU ( 
  ...
  assign new_n167_ = (x28 | ~x29 | x30 | ~x20 | ~x21) & (~x19 | x20 | x21 | x29 | ~x30);
  ...
  assign new_n171_ = x23 & ~x31 & ~x32 & ~x33 & ~x34 & x35;
  ...
  assign new_n207_ = (~x28 | x29 | new_n127_ | ~x30) & (x20 | x28 | ~new_n124_ | ~x29);
  ...
  assign new_n213_ = new_n103_ & ~x00 & ~x04 & new_n161_ & x20 & ~x27;
