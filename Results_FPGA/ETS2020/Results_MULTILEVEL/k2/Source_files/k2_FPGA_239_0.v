// Benchmark "FAU" written by ABC on Thu Aug  6 05:02:26 2020
...
module FAU ( 
  ...
  assign z24 = new_n413_ & x30;
  assign new_n413_ = ~x29 & x22 & ~x21 & x20 & ~x18 & ~x19;
  ...
  assign new_n424_ = ~new_n425_ & (~x19 | (~new_n428_ & (~x30 | (~new_n388_ & new_n429_))));
  ...
  assign z34 = x18 ? ~new_n455_ : (~new_n449_ | new_n464_);
  assign new_n449_ = (new_n450_ | ~x29) & (x21 | ~x28 | x29 | new_n454_ | x30);
  assign new_n450_ = (~new_n170_ | x09) & (x30 | ((~new_n453_ | ~x19) & (x09 | ~new_n451_ | x19)));
  assign new_n451_ = ~x20 & x21 & x22 & ~x28 & new_n452_ & ~x38;
  assign new_n452_ = ~x39 & ~x41 & ~x42 & (x40 | (~x40 & (x43 ^ x44)));
  assign new_n453_ = x28 & (x21 | (x00 & x20 & ~x21 & x22));
  assign new_n454_ = x19 & (~x20 | ~x22);
  assign new_n455_ = (~x20 | (~new_n456_ & (~new_n460_ | x11))) & ~new_n463_ & (new_n461_ | x20);
  assign new_n456_ = ~x21 & (x30 ? ~new_n457_ : (new_n193_ | (new_n459_ & x19)));
  assign new_n457_ = (new_n458_ | ~x00) & (~x19 | x27 | ~x28 | x29);
  assign new_n458_ = (x19 | ~x26 | ~x28 | x29) & (x05 | ~x19 | x27 | x28 | ~x29);
  assign new_n459_ = ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n460_ = ~x19 & x21 & ~x28 & x29 & ~new_n205_ & x30;
  assign new_n461_ = ~new_n462_ & (~new_n116_ | ~new_n136_ | ~x00 | ~x19 | x21);
  assign new_n462_ = (x28 ? (~x29 & ~x30) : (x29 & x30)) & (x19 ? (~x21 & x26) : x21);
  assign new_n463_ = ~x28 & x29 & x30 & ~x19 & x21 & x22;
  assign new_n464_ = x30 & ((~new_n467_ & ~x28) | (~new_n465_ & ~x29));
  assign new_n465_ = (~x19 | ~x21 | new_n94_ | x28) & (~x28 | ((~x00 | ~x19 | ~x21) & (new_n466_ | x21)));
  assign new_n466_ = (~x00 | x03 | x19 | (~x02 ^ x20)) & (~x19 | ~x20 | ~x22 | (x02 & ~x03));
  assign new_n467_ = (~x22 | ((~x21 | (x19 ? (~x20 | ~x29) : (x20 | (~x09 & ~x29)))) & (~x20 | x21 | ~x29))) & (x19 | x21 | ~x29);
  assign z35 = x30 ? (new_n498_ | (~x29 & (~new_n469_ | new_n489_))) : ~new_n476_;
  assign new_n469_ = (new_n470_ | new_n124_) & ~new_n472_ & (~x18 | (~new_n474_ & ~new_n475_));
  assign new_n470_ = (x20 | x21 | ~x18 | ~x19) & (~new_n471_ | ~x21 | x28 | x19 | ~x20);
  assign new_n471_ = new_n114_ & x00;
  assign new_n472_ = new_n473_ & new_n162_ & x20 & x21;
  assign new_n473_ = x00 & ~x05 & ~x15 & ~x19;
  assign new_n474_ = x00 & (x19 ? ((x20 & x21) | (x26 & x28 & ~x20 & ~x21)) : ((~x20 & x21 & ~x28) | (x20 & ~x21 & x26 & x28)));
  assign new_n475_ = ~x21 & ((x20 & ((~x28 & (x19 ? ~x27 : x26)) | (x19 & (x27 | (~x27 & x28))))) | (x19 & ~x20 & x26 & ~x28));
  assign new_n476_ = (new_n483_ | ~x29) & (x21 | (~new_n477_ & (new_n479_ | ~x29)));
  assign new_n477_ = ~x03 & (new_n478_ | (new_n120_ & x20 & x27 & ~x29));
  assign new_n478_ = x00 & ~x05 & ~x18 & new_n259_ & ~x19 & ~x20;
  assign new_n479_ = (~x18 | (~new_n481_ & (new_n480_ | ~x00))) & (~x00 | x18 | new_n482_ | ~x20);
  assign new_n480_ = (~x19 | new_n124_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n481_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n482_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n483_ = (~new_n488_ | ~x18 | ~x19) & (~x21 | (new_n487_ & (new_n484_ | x19)));
  assign new_n484_ = ~new_n143_ & (x28 | (~new_n485_ & ~new_n247_ & (~new_n253_ | ~new_n486_)));
  assign new_n485_ = x18 & (~x20 | (x11 & x20 & x25));
  assign new_n486_ = ~x38 & x39 & ~x41 & x42;
  assign new_n487_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n160_ | x28)));
  assign new_n488_ = x20 & ~x27 & ~x28;
  assign new_n489_ = ~x18 & (x19 ? ~new_n490_ : (~new_n495_ | (~new_n493_ & x20)));
  assign new_n490_ = x21 ? (~new_n491_ & (~x01 | ~new_n175_ | x20)) : new_n492_;
  ...
  assign new_n495_ = (x21 | ~x23 | x28) & (x20 | (x21 ? new_n497_ : (~new_n496_ & x28)));
  assign new_n496_ = ~x03 & (~x02 | (x00 & x02 & x28));
  assign new_n497_ = ~x23 & (x09 | ~x22 | x28);
  assign new_n498_ = x19 & x20 & ~x21 & ~new_n499_ & x29;
  assign new_n499_ = (x18 | ~x22 | ~x28) & (~x05 | ~x18 | x27 | x28);
  assign z36 = (~new_n508_ & x21) | (~x30 & ((~new_n501_ & ~x21) | new_n519_ | (~new_n514_ & x21)));
  assign new_n501_ = ~new_n477_ & new_n504_ & (~x18 | (new_n502_ & (new_n507_ | ~x26)));
  assign new_n502_ = (~x19 | (~new_n503_ & (~new_n459_ | ~x20))) & (~new_n366_ | x14 | x19 | x20);
  assign new_n503_ = x00 & ((~x20 & ~new_n124_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n504_ = (new_n505_ | x29) & (~x00 | x18 | ~x20 | new_n482_ | ~x29);
  assign new_n505_ = (x14 | new_n506_ | x27) & (x18 | new_n454_ | ~x28);
  assign new_n506_ = (~x13 | x28) & (x18 | x19 | ~x20 | x23);
  assign new_n507_ = (((~x19 | x20) & (~x17 | x19 | ~x20)) | ((~x28 | x29) & (~x00 | x28 | ~x29))) & (~x20 | x28 | ~x29 | ~x00 | x17 | x19);
  assign new_n508_ = (~new_n509_ | x28) & (~x18 | x19 | ~x20 | new_n513_ | ~x28);
  assign new_n509_ = x30 & (new_n511_ | (~x29 & (new_n512_ | (~new_n510_ & ~x18))));
  assign new_n510_ = (new_n94_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
  assign new_n511_ = x20 & x25 & x29 & new_n189_ & ~x11;
  assign new_n512_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n513_ = x16 ? x08 : x07;
  assign new_n514_ = x29 ? (new_n487_ & (new_n515_ | x19)) : new_n517_;
  assign new_n515_ = (x18 | ~x20) & (x28 | (x20 ? new_n314_ : (~x18 & (x09 | ~new_n516_ | x18))));
  assign new_n516_ = x22 & ~x38 & ~x41 & (x39 ? x42 : (x40 & ~x42));
  assign new_n517_ = ~new_n518_ & (~new_n189_ | x20 | ~x28);
  assign new_n518_ = ~x12 & ~x13 & ~x14 & ~x27 & ~x28;
  assign new_n519_ = x19 & x20 & ((new_n520_ & ~x18) | (new_n259_ & x18 & ~x27));
  assign new_n520_ = x22 & x28 & ~new_n513_ & ~x29;
  assign z37 = (x30 & (~new_n522_ | new_n222_)) | (~new_n555_ & ~x30) | (new_n580_ & ~x19);
  assign new_n522_ = new_n544_ & (x29 | (~new_n523_ & ~new_n542_ & (new_n532_ | ~x20)));
  assign new_n523_ = ~x18 & (x21 ? (x19 ? ~new_n529_ : ~new_n531_) : ~new_n524_);
  ...
  assign new_n529_ = ~new_n491_ & (x28 | (~new_n530_ & ~x25 & ~x24 & ~x26));
  assign new_n530_ = x20 & x22 & (x05 | (~x05 & x15));
  assign new_n531_ = (new_n497_ | x20) & (~x00 | ~x20 | (new_n100_ & ~x22 & ~x24));
  assign new_n532_ = ~new_n541_ & (x19 | (~new_n540_ & (x28 | (~new_n533_ & ~new_n538_))));
  assign new_n533_ = x21 & (new_n534_ | new_n535_ | new_n537_ | (new_n536_ & x00));
  assign new_n534_ = x10 & ((x05 & x18) | (~x15 & x25 & x00 & ~x05));
  assign new_n535_ = x05 & (x25 ? ~x10 : x18);
  assign new_n536_ = ~x15 & ((~x10 & x25) | (~x05 & (x22 | x26)));
  assign new_n537_ = ~x05 & x15 & x18;
  assign new_n538_ = new_n539_ & x18;
  assign new_n539_ = ~x21 & x26;
  assign new_n540_ = new_n136_ & ~x21 & x00 & x18;
  assign new_n541_ = x18 & x19 & (~x21 | (x00 & x21));
  assign new_n542_ = x18 & ~new_n543_ & ~x20;
  assign new_n543_ = (~x00 | ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28))) & (x19 | ~x21 | ~x28) & (new_n375_ | x21);
  assign new_n544_ = new_n551_ & (~x29 | (new_n549_ & (x28 | (~new_n545_ & new_n546_))));
  assign new_n545_ = ~x19 & (x21 ? ~new_n385_ : (~x18 | (new_n247_ & ~x17 & x18)));
  assign new_n546_ = (~x18 | ~x19 | ~new_n539_ | x20) & (~x20 | ((~new_n547_ | x18) & (new_n548_ | ~x19)));
  assign new_n547_ = ~x21 & x22;
  assign new_n548_ = x18 ? (x21 | x27 | (~x05 & (~x00 | x05))) : (~x21 | ~x22);
  assign new_n549_ = (~x20 | ~x21 | x18 | x19) & (~x19 | (~new_n550_ & (~x18 | (x20 ? ~x21 : (new_n202_ | x21)))));
  assign new_n550_ = x28 & ((~x18 & (x21 | (x20 & ~x21 & x22))) | (x18 & x20 & ~x21 & ~x27));
  assign new_n551_ = ~new_n554_ & (x20 | (~new_n553_ & (new_n552_ | ~x21)));
  assign new_n552_ = (~x22 | (x18 ? ~x19 : (x19 | (~x28 & (~x09 | x28))))) & (~x18 | ~x19 | ~x25);
  assign new_n553_ = x18 & ~x19 & ~x21 & (x22 | x25);
  assign new_n554_ = x18 & x19 & x21 & (x26 | (x20 & x22));
  assign new_n555_ = x29 ? (new_n561_ & (x18 | (~new_n556_ & new_n577_))) : new_n569_;
  assign new_n556_ = ~x20 & (new_n212_ | new_n560_ | (~x28 & (new_n557_ | new_n559_)));
  assign new_n557_ = ~x09 & x21 & x22 & ~x38 & ~new_n558_ & ~x41;
  assign new_n558_ = (x39 | x42 | (x40 ? x19 : ((x43 | x44) & (x19 | (~x43 ^ x44))))) & (x19 | ~x39 | ~x42);
  assign new_n559_ = ~x19 & ~x21 & (x03 | x05 | (x00 & ~x03 & ~x05));
  assign new_n560_ = ~x19 & x21 & x23;
  ...
  assign new_n569_ = (~x20 | (~new_n570_ & (new_n572_ | x21))) & new_n574_ & (new_n517_ | ~x21);
  assign new_n570_ = x19 & ((new_n405_ & x18) | (x28 & (x18 ? new_n121_ : new_n571_)));
  assign new_n571_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n572_ = (new_n573_ | x18) & (~x17 | ~x18 | ~new_n136_ | x19);
  assign new_n573_ = (~x22 | ~x28) & (x14 | x19 | x23 | x27);
  assign new_n574_ = (~x14 | x27 | x28) & (x21 | ((new_n576_ | ~x28) & (x14 | x27 | new_n575_ | x28)));
  assign new_n575_ = ~x13 & (~x18 | x19 | x20);
  assign new_n576_ = (x18 | x19) & (~x18 | ~x19 | x20 | ~x26);
  assign new_n577_ = (~x20 | (x19 ? (~new_n579_ | x21) : (~x21 & (new_n578_ | x21)))) & (~x28 | (~x19 ^ ~x21));
  assign new_n578_ = ~x24 & (~x00 | ~x23 | x28);
  assign new_n579_ = x22 & ((x05 & ~x28) | (x00 & (x28 | (~x05 & ~x28))));
  assign new_n580_ = x21 & (new_n581_ | (~x09 & new_n408_ & ~x18));
  ...
  assign new_n588_ = x18 ? ((~x20 | ~x21 | ~x24) & (x20 | x21 | ~x26 | ~x28)) : (~x21 | ~x28);
  ...
  assign new_n594_ = (~x19 | new_n267_ | x20) & (~x20 | ((~new_n162_ | x19) & (~new_n256_ | x04 | ~x19)));
  assign new_n595_ = new_n120_ & ~x05 & x20 & ~x27 & ~x28 & x30;
  assign new_n596_ = ~x20 & ~new_n155_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n602_ & x29) | (x19 & (~new_n598_ | (~new_n607_ & ~x18)));
  assign new_n598_ = (~new_n176_ | ~x27 | x29 | ~x30) & (~x29 | (~new_n601_ & (new_n599_ | x30)));
  assign new_n599_ = (new_n600_ | ~x20) & (~x18 | x20 | ~new_n136_ | x21);
  assign new_n600_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n256_ | ~x04 | x21)));
  assign new_n601_ = x18 & ~x20 & ~x21 & ~new_n202_ & x30;
  assign new_n602_ = (~x20 | ((~new_n605_ | x19) & (new_n603_ | x30))) & (x19 | new_n606_ | x30);
  assign new_n603_ = (new_n604_ | ~x21) & (~new_n189_ | ~new_n136_ | x21);
  assign new_n604_ = (~x18 | new_n160_ | x28) & (x19 | (x18 & (new_n314_ | x28)));
  ...
  assign z40 = ~x28 & ((~x18 & (new_n611_ | (~new_n614_ & x05))) | (x05 & new_n612_ & x18));
  assign new_n611_ = new_n119_ & ~x21 & x03 & ~x19 & ~x20;
  assign new_n612_ = x20 & ~new_n613_ & x30;
