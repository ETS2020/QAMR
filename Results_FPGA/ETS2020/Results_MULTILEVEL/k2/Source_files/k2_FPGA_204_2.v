// Benchmark "FAU" written by ABC on Thu Aug  6 05:02:00 2020
...
module FAU ( 
  ...
  wire new_n93_, new_n94_, new_n96_, new_n98_, new_n100_, new_n101_,
    ...
    new_n235_, new_n236_, new_n237_, new_n238_, new_n240_;
  ...
  assign z23 = ~x19 & new_n183_ & x20;
  assign new_n183_ = x21 & x26 & x29 & ~x30 & (~x18 | ~x28);
  assign z24 = x30 & ~x29 & x22 & ~x21 & new_n185_ & x20;
  assign new_n185_ = ~x18 & ~x19;
  assign z25 = ~new_n195_ | (~x29 & ((~new_n187_ & ~x28) | (~new_n192_ & x30)));
  assign new_n187_ = (new_n188_ | ~x30) & (~x13 | x14 | ~x21 | x27 | x30);
  assign new_n188_ = (new_n189_ | x21) & (x10 | ~x21 | new_n191_ | ~x25);
  assign new_n189_ = (x20 | (x18 ? (~x19 | ~x26) : x19)) & (new_n190_ | x18) & (~x18 | ~x20 | (x19 ? x27 : ~x26));
  assign new_n190_ = (~x23 | (x19 & (~x19 | ~x20))) & (~x19 | ~x20 | (~x22 & ~x26));
  assign new_n191_ = x19 ? x18 : (~x20 | (~x05 & (~x00 | x15)));
  assign new_n192_ = (x21 | (~new_n194_ & (new_n193_ | x20))) & (~new_n185_ | x20 | ~x21 | ~x23);
  assign new_n193_ = x18 ? (~x25 & (~x19 | ~x22)) : (~x19 | (~x22 & ~x23));
  assign new_n194_ = ~x18 & ~x19 & x20 & (x22 | x24 | x26);
  assign new_n195_ = (~x21 | (~new_n196_ & (~new_n197_ | ~x18 | ~x19))) & (~x18 | x19 | ~new_n198_ | x21);
  assign new_n196_ = ~x10 & x25 & ((x18 & x19 & ~x20 & x30) | (~x18 & ~x19 & x20));
  assign new_n197_ = x20 & x22 & x30;
  assign new_n198_ = x30 & (x20 ? (x22 | x23) : (x22 | x25));
  assign z27 = ~x21 & (x18 ? (x19 & ~new_n203_ & x20) : ~new_n200_);
  assign new_n200_ = x19 ? (~x20 | new_n202_ | ~x22) : new_n201_;
  assign new_n201_ = (~x28 | x29 | new_n122_ | ~x30) & (x20 | x28 | ~new_n119_ | ~x29);
  ...
  assign z28 = (x21 & (~new_n213_ | (~new_n206_ & x20))) | (~x19 & ~new_n223_ & ~x21);
  assign new_n206_ = ~new_n211_ & ~new_n207_ & (x19 | ~x25 | x10 | x18);
  assign new_n207_ = x30 & (x19 ? ~new_n210_ : (new_n208_ | (~x18 & x29)));
  assign new_n208_ = ~x28 & ((~new_n209_ & ~x29) | (x11 & x29 & (x25 | x26)));
  assign new_n209_ = (x10 | ~x25 | (~x05 & (~x00 | x15))) & (~x05 | ~x18 | (~x10 & x25));
  assign new_n210_ = (~x18 | (~x22 & ~x29)) & (~x05 | x18 | ~x22 | x28 | x29);
  assign new_n211_ = x28 & ~new_n212_ & (x16 ? x08 : x07);
  assign new_n212_ = (~x18 | x19) & (x18 | ~x19 | ~x22 | x29 | x30);
  assign new_n213_ = (new_n217_ | x20) & (~x19 | (~new_n214_ & (x18 | ~new_n222_ | x20)));
  assign new_n214_ = x30 & (new_n215_ | ~new_n216_);
  assign new_n215_ = x25 & (x10 ? (x18 & ~x20) : (x18 ? ~x20 : (~x28 & ~x29)));
  assign new_n216_ = x18 ? (x20 | (~x22 & ~x26)) : (~x28 | ~x29);
  assign new_n217_ = (x18 | ((~new_n220_ | ~new_n221_) & (new_n219_ | x19))) & (~new_n218_ | ~x18 | x19);
  assign new_n218_ = x28 & ~x29 & x30;
  assign new_n219_ = (~x22 | ~x28 | ~x30) & (~x23 | ~x29 | x30);
  assign new_n220_ = ~x39 & ~x40 & ~x41 & ~x42 & ~x43 & ~x44;
  assign new_n221_ = x29 & ~x30 & ~x38 & ~x09 & x22 & ~x28;
  assign new_n222_ = ~x28 & x29 & ~x30 & (x22 | x23);
  assign new_n223_ = (new_n224_ | ~x30) & (x18 | ~x20 | ~x24 | ~x29 | x30);
  assign new_n224_ = x18 ? (x20 | (~x22 & ~x25)) : (~x20 | x29 | (~x22 & ~x26));
  assign z31 = ~x21 & x28 & (new_n227_ | (x00 & (new_n226_ | new_n228_)));
  assign new_n226_ = new_n176_ & ~x18 & x19 & x20;
  assign new_n227_ = new_n147_ & ~x00 & ~x04 & new_n157_ & x20 & ~x27;
  ...
  assign new_n235_ = x03 & ~x19 & ~x20 & new_n157_ & ~x21;
  ...
  assign z43 = ~x18 & new_n240_ & ~x19;
  assign new_n240_ = x20 & ~x21 & ~x29 & x30 & (x22 | x24);
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z06 = 1'b0;
