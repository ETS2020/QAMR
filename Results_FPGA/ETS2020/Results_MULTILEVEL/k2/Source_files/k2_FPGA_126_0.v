// Benchmark "FAU" written by ABC on Thu Aug  6 05:01:00 2020
...
module FAU ( 
  ...
  assign new_n422_ = ~new_n423_ & (~x19 | (~new_n426_ & (~x30 | (~new_n390_ & new_n427_))));
  ...
  assign new_n539_ = (~x00 | ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28))) & (x19 | ~x21 | ~x28) & (new_n377_ | x21);
  assign new_n540_ = new_n547_ & (~x29 | (new_n545_ & (x28 | (~new_n541_ & new_n542_))));
  assign new_n541_ = ~x19 & (x21 ? ~new_n387_ : (~x18 | (new_n247_ & ~x17 & x18)));
  ...
  assign new_n566_ = x19 & ((new_n407_ & x18) | (x28 & (x18 ? new_n121_ : new_n567_)));
  ...
  assign new_n576_ = x21 & (new_n577_ | (~x09 & new_n410_ & ~x18));
