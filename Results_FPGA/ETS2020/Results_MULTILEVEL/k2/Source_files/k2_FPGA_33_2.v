// Benchmark "FAU" written by ABC on Thu Aug  6 04:59:50 2020
...
module FAU ( 
  ...
  assign new_n158_ = (~x23 | ~x30) & (x28 | ~x29 | x30 | ~x17 | ~x26);
  ...
  assign new_n173_ = (x20 | (x21 ? (~x22 | ~x28) : (x28 | x29))) & (x21 | x29 | ((~x23 | x28) & (~x20 | ~x22)));
  ...
  assign new_n203_ = (~x02 | x03 | ~x28 | x29 | ~x30) & (~x29 | x30 | ~x05 | x28);
  assign new_n204_ = (x27 | new_n205_ | ~x29) & (~x00 | ~x03 | ~x27 | x29 | x30);
  assign new_n205_ = (~x05 | x28 | ~x30) & (~x04 | ~x28 | x30);
  assign z31 = ~x21 & x28 & (new_n208_ | (x00 & (new_n207_ | new_n209_)));
  assign new_n207_ = new_n179_ & ~x18 & x19 & x20;
  assign new_n208_ = new_n151_ & ~x00 & ~x04 & new_n102_ & x20 & ~x27;
  assign new_n209_ = x18 & x26 & ~x29 & x30 & (~x19 ^ ~x20);
  ...
  assign z40 = ~x28 & ((~x18 & (new_n216_ | (~new_n219_ & x05))) | (x05 & new_n217_ & x18));
  assign new_n216_ = x03 & ~x19 & ~x20 & new_n102_ & ~x21;
  assign new_n217_ = x20 & ~new_n218_ & x30;
  assign new_n218_ = (x19 | ~x21 | x29 | (~x10 & x25)) & (~x19 | x21 | x27 | ~x29);
  assign new_n219_ = (~x19 | ~x20 | ~x22 | (x21 ? (x29 | ~x30) : (~x29 | x30))) & (x19 | x20 | x21 | ~x29 | x30);
