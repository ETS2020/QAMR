// Benchmark "FAU" written by ABC on Thu Aug  6 05:00:04 2020
...
module FAU ( 
  ...
  assign new_n417_ = ~x28 & ((~new_n418_ & ~x29) | (x11 & ~new_n205_ & x29));
  ...
  assign new_n423_ = ~x20 & ((new_n146_ & x18 & ~x19) | (~x18 & (new_n424_ | (~new_n425_ & ~x19))));
  assign new_n424_ = new_n328_ & new_n115_ & ~x09 & x29 & ~x30 & ~x38;
  assign new_n425_ = (~x22 | ~x28 | ~x30) & (~x23 | ~x29 | x30);
  assign new_n426_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n155_ & ~x30;
  assign new_n427_ = x18 ? (x20 | (~x22 & ~x26)) : (~x28 | ~x29);
  assign new_n428_ = (new_n429_ | ~x30) & (~new_n143_ | ~x24 | ~x29 | x30);
  assign new_n429_ = x18 ? (x20 | (~x22 & ~x25)) : (~x20 | x29 | (~x22 & ~x26));
  assign z29 = x00 & (~new_n434_ | (x20 & (new_n437_ | (~new_n431_ & ~x29))));
  assign new_n431_ = (~x30 | (~new_n433_ & (new_n432_ | ~x21))) & (~new_n149_ | x21 | ~x27 | x30);
  assign new_n432_ = x19 ? (~x18 & (~new_n114_ | ~new_n115_ | x18)) : (~new_n108_ & (x18 | ~x24));
  assign new_n433_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n434_ = (new_n435_ | x20) & (~new_n146_ | x18 | ~x19 | ~x21);
  assign new_n435_ = (new_n436_ | x19) & (~new_n119_ | ~new_n162_ | ~x18 | ~x19 | x21);
  assign new_n436_ = (x03 | x18 | new_n125_ | x21) & (~x18 | ~x21 | ~new_n116_ | x28);
  ...
  assign new_n441_ = (new_n442_ | ~x00) & (~new_n141_ | ~new_n256_ | x00 | x04 | ~x18);
  assign new_n442_ = (new_n443_ | ~x20) & (~x18 | ~x19 | new_n124_ | x20);
