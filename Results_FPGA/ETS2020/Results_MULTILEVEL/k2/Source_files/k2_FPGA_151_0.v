// Benchmark "FAU" written by ABC on Thu Aug  6 05:01:19 2020
...
module FAU ( 
  ...
  assign new_n371_ = x28 & x26 & ~x21 & new_n189_ & x20;
  ...
  assign z28 = (x21 & (~new_n426_ | (~new_n419_ & x20))) | (~x19 & ~new_n432_ & ~x21);
  assign new_n419_ = ~new_n424_ & ~new_n420_ & (x19 | ~x25 | x10 | x18);
  assign new_n420_ = x30 & (x19 ? ~new_n423_ : (new_n421_ | (~x18 & x29)));
  assign new_n421_ = ~x28 & ((~new_n422_ & ~x29) | (x11 & ~new_n205_ & x29));
  assign new_n422_ = (x10 | ~x25 | (~x05 & (~x00 | x15))) & (~x05 | ~x18 | (~x10 & x25));
  assign new_n423_ = (~x18 | (~x22 & ~x29)) & (~x05 | x18 | ~x22 | x28 | x29);
  assign new_n424_ = x28 & ~new_n425_ & (x16 ? x08 : x07);
  assign new_n425_ = (~x18 | x19) & (x18 | ~x19 | ~x22 | x29 | x30);
  assign new_n426_ = ~new_n427_ & (~x19 | (~new_n430_ & (~x30 | (~new_n392_ & new_n431_))));
  assign new_n427_ = ~x20 & ((new_n146_ & x18 & ~x19) | (~x18 & (new_n428_ | (~new_n429_ & ~x19))));
  assign new_n428_ = new_n328_ & new_n115_ & ~x09 & x29 & ~x30 & ~x38;
  assign new_n429_ = (~x22 | ~x28 | ~x30) & (~x23 | ~x29 | x30);
  assign new_n430_ = ~x18 & ~x20 & ~x28 & x29 & ~new_n155_ & ~x30;
  assign new_n431_ = x18 ? (x20 | (~x22 & ~x26)) : (~x28 | ~x29);
  assign new_n432_ = (new_n433_ | ~x30) & (~new_n143_ | ~x24 | ~x29 | x30);
  assign new_n433_ = x18 ? (x20 | (~x22 & ~x25)) : (~x20 | x29 | (~x22 & ~x26));
  assign z29 = x00 & (~new_n438_ | (x20 & (new_n441_ | (~new_n435_ & ~x29))));
  assign new_n435_ = (~x30 | (~new_n437_ & (new_n436_ | ~x21))) & (~new_n149_ | x21 | ~x27 | x30);
  assign new_n436_ = x19 ? (~x18 & (~new_n114_ | ~new_n115_ | x18)) : (~new_n108_ & (x18 | ~x24));
  assign new_n437_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n438_ = (new_n439_ | x20) & (~new_n146_ | x18 | ~x19 | ~x21);
  assign new_n439_ = (new_n440_ | x19) & (~new_n119_ | ~new_n162_ | ~x18 | ~x19 | x21);
  assign new_n440_ = (x03 | x18 | new_n125_ | x21) & (~x18 | ~x21 | ~new_n116_ | x28);
  assign new_n441_ = ~x21 & ~x28 & x29 & (new_n442_ | new_n443_);
  assign new_n442_ = ~x05 & x19 & (x18 ? (~x27 & x30) : (x22 & ~x30));
  assign new_n443_ = ~x19 & ~x30 & ((~x18 & x23) | (x17 & x18 & x26));
  assign z30 = ~x21 & x29 & ~new_n445_ & ~x30;
  assign new_n445_ = (new_n446_ | ~x00) & (~new_n141_ | ~new_n256_ | x00 | x04 | ~x18);
  assign new_n446_ = (new_n447_ | ~x20) & (~x18 | ~x19 | new_n124_ | x20);
  assign new_n447_ = (x18 | ~x19 | ~x22 | ~x28) & (x17 | ~x18 | x19 | ~x26 | x28);
  ...
  assign new_n452_ = (~new_n170_ | x09) & (x30 | ((~new_n455_ | ~x19) & (x09 | ~new_n453_ | x19)));
  ...
  assign new_n458_ = ~x21 & (x30 ? ~new_n459_ : (new_n193_ | (new_n461_ & x19)));
  ...
  assign new_n462_ = ~x19 & x21 & ~x28 & x29 & ~new_n205_ & x30;
  assign new_n463_ = ~new_n464_ & (~new_n116_ | ~new_n136_ | ~x00 | ~x19 | x21);
  ...
  assign z35 = x30 ? (new_n500_ | (~x29 & (~new_n471_ | new_n491_))) : ~new_n478_;
  assign new_n471_ = (new_n472_ | new_n124_) & ~new_n474_ & (~x18 | (~new_n476_ & ~new_n477_));
  assign new_n472_ = (x20 | x21 | ~x18 | ~x19) & (~new_n473_ | ~x21 | x28 | x19 | ~x20);
  assign new_n473_ = new_n114_ & x00;
  assign new_n474_ = new_n475_ & new_n162_ & x20 & x21;
  assign new_n475_ = x00 & ~x05 & ~x15 & ~x19;
  assign new_n476_ = x00 & (x19 ? ((x20 & x21) | (x26 & x28 & ~x20 & ~x21)) : ((~x20 & x21 & ~x28) | (x20 & ~x21 & x26 & x28)));
  assign new_n477_ = ~x21 & ((x20 & ((~x28 & (x19 ? ~x27 : x26)) | (x19 & (x27 | (~x27 & x28))))) | (x19 & ~x20 & x26 & ~x28));
  assign new_n478_ = (new_n485_ | ~x29) & (x21 | (~new_n479_ & (new_n481_ | ~x29)));
  assign new_n479_ = ~x03 & (new_n480_ | (new_n120_ & x20 & x27 & ~x29));
  assign new_n480_ = x00 & ~x05 & ~x18 & new_n259_ & ~x19 & ~x20;
  assign new_n481_ = (~x18 | (~new_n483_ & (new_n482_ | ~x00))) & (~x00 | x18 | new_n484_ | ~x20);
  assign new_n482_ = (~x19 | new_n124_ | x20) & (~x26 | x28 | (~x19 ^ x20));
  assign new_n483_ = x19 & x20 & ~x27 & x28 & (x04 | (~x00 & ~x04));
  assign new_n484_ = x19 ? (~x22 | (~x28 & (x05 | x28))) : (~x23 | x28);
  assign new_n485_ = (~new_n490_ | ~x18 | ~x19) & (~x21 | (new_n489_ & (new_n486_ | x19)));
  assign new_n486_ = ~new_n143_ & (x28 | (~new_n487_ & ~new_n247_ & (~new_n253_ | ~new_n488_)));
  assign new_n487_ = x18 & (~x20 | (x11 & x20 & x25));
  assign new_n488_ = ~x38 & x39 & ~x41 & x42;
  assign new_n489_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n160_ | x28)));
  assign new_n490_ = x20 & ~x27 & ~x28;
  assign new_n491_ = ~x18 & (x19 ? ~new_n492_ : (~new_n497_ | (~new_n495_ & x20)));
  assign new_n492_ = x21 ? (~new_n493_ & (~x01 | ~new_n175_ | x20)) : new_n494_;
  ...
  assign new_n497_ = (x21 | ~x23 | x28) & (x20 | (x21 ? new_n499_ : (~new_n498_ & x28)));
  assign new_n498_ = ~x03 & (~x02 | (x00 & x02 & x28));
  assign new_n499_ = ~x23 & (x09 | ~x22 | x28);
  ...
  assign new_n503_ = ~new_n479_ & new_n506_ & (~x18 | (new_n504_ & (new_n509_ | ~x26)));
  assign new_n504_ = (~x19 | (~new_n505_ & (~new_n461_ | ~x20))) & (~new_n366_ | x14 | x19 | x20);
  assign new_n505_ = x00 & ((~x20 & ~new_n124_ & x29) | (x03 & x20 & x27 & ~x29));
  assign new_n506_ = (new_n507_ | x29) & (~x00 | x18 | ~x20 | new_n484_ | ~x29);
  ...
  assign new_n513_ = x20 & x25 & x29 & new_n189_ & ~x11;
  assign new_n514_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n515_ = x16 ? x08 : x07;
  assign new_n516_ = x29 ? (new_n489_ & (new_n517_ | x19)) : new_n519_;
  assign new_n517_ = (x18 | ~x20) & (x28 | (x20 ? new_n314_ : (~x18 & (x09 | ~new_n518_ | x18))));
  assign new_n518_ = x22 & ~x38 & ~x41 & (x39 ? x42 : (x40 & ~x42));
  assign new_n519_ = ~new_n520_ & (~new_n189_ | x20 | ~x28);
  assign new_n520_ = ~x12 & ~x13 & ~x14 & ~x27 & ~x28;
  assign new_n521_ = x19 & x20 & ((new_n522_ & ~x18) | (new_n259_ & x18 & ~x27));
  assign new_n522_ = x22 & x28 & ~new_n515_ & ~x29;
  assign z37 = (x30 & (~new_n524_ | new_n222_)) | (~new_n557_ & ~x30) | (new_n582_ & ~x19);
  ...
  assign new_n531_ = ~new_n493_ & (x28 | (~new_n532_ & ~x25 & ~x24 & ~x26));
  assign new_n532_ = x20 & x22 & (x05 | (~x05 & x15));
  assign new_n533_ = (new_n499_ | x20) & (~x00 | ~x20 | (new_n100_ & ~x22 & ~x24));
  ...
  assign new_n542_ = new_n136_ & ~x21 & x00 & x18;
  assign new_n543_ = x18 & x19 & (~x21 | (x00 & x21));
  assign new_n544_ = x18 & ~new_n545_ & ~x20;
  assign new_n545_ = (~x00 | ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28))) & (x19 | ~x21 | ~x28) & (new_n379_ | x21);
  assign new_n546_ = new_n553_ & (~x29 | (new_n551_ & (x28 | (~new_n547_ & new_n548_))));
  assign new_n547_ = ~x19 & (x21 ? ~new_n389_ : (~x18 | (new_n247_ & ~x17 & x18)));
  ...
  assign new_n551_ = (~x20 | ~x21 | x18 | x19) & (~x19 | (~new_n552_ & (~x18 | (x20 ? ~x21 : (new_n202_ | x21)))));
  ...
  assign new_n558_ = ~x20 & (new_n212_ | new_n562_ | (~x28 & (new_n559_ | new_n561_)));
  ...
  assign new_n563_ = ~new_n161_ & (~x18 | (~new_n570_ & (new_n569_ | x20) & (new_n564_ | ~x20)));
  ...
  assign new_n569_ = x19 ? (x21 | ((~x26 | ~x28) & (~x00 | (~new_n139_ & (~x26 | x28))))) : (~x21 | x28);
  assign new_n570_ = x22 & ((x00 & x19 & ~x20 & ~x21) | (x20 & x21 & ~x28));
  assign new_n571_ = (~x20 | (~new_n572_ & (new_n574_ | x21))) & new_n576_ & (new_n519_ | ~x21);
  assign new_n572_ = x19 & ((new_n409_ & x18) | (x28 & (x18 ? new_n121_ : new_n573_)));
  assign new_n573_ = x22 & (x16 ? (~x08 | (x08 & x21)) : (~x07 | (x07 & x21)));
  assign new_n574_ = (new_n575_ | x18) & (~x17 | ~x18 | ~new_n136_ | x19);
  ...
  assign new_n582_ = x21 & (new_n583_ | (~x09 & new_n412_ & ~x18));
  ...
  assign new_n596_ = (~x19 | new_n267_ | x20) & (~x20 | ((~new_n162_ | x19) & (~new_n256_ | x04 | ~x19)));
  ...
  assign new_n600_ = (~new_n176_ | ~x27 | x29 | ~x30) & (~x29 | (~new_n603_ & (new_n601_ | x30)));
  assign new_n601_ = (new_n602_ | ~x20) & (~x18 | x20 | ~new_n136_ | x21);
  assign new_n602_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n256_ | ~x04 | x21)));
  assign new_n603_ = x18 & ~x20 & ~x21 & ~new_n202_ & x30;
  assign new_n604_ = (~x20 | ((~new_n607_ | x19) & (new_n605_ | x30))) & (x19 | new_n608_ | x30);
  assign new_n605_ = (new_n606_ | ~x21) & (~new_n189_ | ~new_n136_ | x21);
  assign new_n606_ = (~x18 | new_n160_ | x28) & (x19 | (x18 & (new_n314_ | x28)));
  assign new_n607_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n608_ = (x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20);
  assign new_n609_ = x21 ? new_n611_ : (~new_n610_ & (~x29 | new_n297_ | x30));
  assign new_n610_ = x02 & ~x03 & x20 & new_n116_ & x22 & x28;
  assign new_n611_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n155_ | ~x30);
  assign z40 = ~x28 & ((~x18 & (new_n613_ | (~new_n616_ & x05))) | (x05 & new_n614_ & x18));
  assign new_n613_ = new_n119_ & ~x21 & x03 & ~x19 & ~x20;
  assign new_n614_ = x20 & ~new_n615_ & x30;
  assign new_n615_ = (x19 | ~x21 | x29 | (~x10 & x25)) & (x27 | ~x29 | ~x19 | x21);
  assign new_n616_ = (~x19 | ~x20 | ~x22 | (x21 ? (x29 | ~x30) : (~x29 | x30))) & (x19 | x20 | x21 | ~x29 | x30);
