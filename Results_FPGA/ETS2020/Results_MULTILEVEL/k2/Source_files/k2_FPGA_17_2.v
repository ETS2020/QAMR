...
module FAU ( 
  ...
  assign new_n170_ = (x20 | (x21 ? (~x22 | ~x28) : (x28 | x29))) & (x21 | x29 | ((~x20 | ~x22) & (~x23 | x28)));
  ...
  assign z26 = ~x21 & ~x28 & ~x29 & ~new_n200_ & x30;
  assign new_n200_ = (~x19 | ~x20 | (x18 ? x27 : ~x22)) & (x18 | x19 | (x20 & ~x23));
  assign z27 = ~x21 & (x18 ? (x19 & ~new_n205_ & x20) : ~new_n202_);
  assign new_n202_ = x19 ? (~x20 | new_n204_ | ~x22) : new_n203_;
  assign new_n203_ = (~x28 | x29 | new_n122_ | ~x30) & (x20 | x28 | ~new_n119_ | ~x29);
  ...
  assign new_n208_ = new_n176_ & ~x18 & x19 & x20;
  assign new_n209_ = new_n147_ & ~x00 & ~x04 & new_n157_ & x20 & ~x27;
  ...
  assign new_n217_ = x03 & ~x19 & ~x20 & new_n157_ & ~x21;
