...
module FAU ( 
  ...
  assign new_n543_ = (~x00 | ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28))) & (x19 | ~x21 | ~x28) & (new_n379_ | x21);
  assign new_n544_ = new_n551_ & (~x29 | (new_n549_ & (x28 | (~new_n545_ & new_n546_))));
  assign new_n545_ = ~x19 & (x21 ? ~new_n389_ : (~x18 | (new_n247_ & ~x17 & x18)));
  ...
  assign new_n570_ = x19 & ((new_n409_ & x18) | (x28 & (x18 ? new_n121_ : new_n571_)));
  ...
  assign new_n580_ = x21 & (new_n581_ | (~x09 & new_n412_ & ~x18));
