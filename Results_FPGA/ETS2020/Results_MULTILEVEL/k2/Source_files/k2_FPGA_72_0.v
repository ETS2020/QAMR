// Benchmark "FAU" written by ABC on Thu Aug  6 05:00:19 2020
...
module FAU ( 
  ...
  assign new_n541_ = (~x00 | ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28))) & (x19 | ~x21 | ~x28) & (new_n375_ | x21);
  assign new_n542_ = new_n549_ & (~x29 | (new_n547_ & (x28 | (~new_n543_ & new_n544_))));
  assign new_n543_ = ~x19 & (x21 ? ~new_n385_ : (~x18 | (new_n247_ & ~x17 & x18)));
  ...
  assign new_n568_ = x19 & ((new_n405_ & x18) | (x28 & (x18 ? new_n121_ : new_n569_)));
  ...
  assign new_n578_ = x21 & (new_n579_ | (~x09 & new_n408_ & ~x18));
