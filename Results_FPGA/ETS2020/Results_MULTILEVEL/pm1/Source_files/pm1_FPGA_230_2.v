// Benchmark "FAU" written by ABC on Wed Aug  5 20:00:57 2020
...
module FAU ( 
  ...
  assign z09 = x00 & ~new_n36_ & ~x10;
  assign new_n36_ = x11 ? (~x12 | (x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04))))) : x12;
  assign z01 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
  assign z08 = 1'b0;
