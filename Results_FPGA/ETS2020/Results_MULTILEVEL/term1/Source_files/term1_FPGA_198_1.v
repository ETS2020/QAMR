...
module FAU ( 
  ...
  assign z9 = x00 & ~x26 & (~new_n70_ | (new_n65_ & x29));
  assign new_n65_ = (x27 | x28) & ((~x31 & x33) | (x30 & new_n66_ & x31));
  assign new_n66_ = ~x33 & (new_n69_ | (x15 & (new_n68_ | (~new_n67_ & x16))));
  ...
  assign new_n70_ = (new_n77_ | ((x30 | ~new_n66_ | x31) & (~x31 | ~x33))) & (new_n71_ | ~x33);
  ...
  assign new_n76_ = (x17 | (x12 & x18)) & (x13 | x18) & (x30 | ~x31) & (~x30 | x31);
