// Benchmark "FAU" written by ABC on Wed Aug  5 21:12:16 2020
...
module FAU ( 
  ...
  assign new_n55_ = ~new_n51_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = ~new_n57_ | (x31 & (~x27 | ~x28 | ~x29 | ~x30));
  assign new_n57_ = ~new_n58_ & x01 & (~x02 | ~x03) & new_n60_ & x25;
  assign new_n58_ = (x19 | x24) & new_n59_ & (x18 | x23);
  assign new_n59_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n60_ = ~x26 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign z8 = x00 & ~x26 & ((x31 & new_n62_ & ~x32) | (~new_n66_ & x32));
  assign new_n62_ = ~new_n63_ & ((x29 & ~x30 & (x27 | x28)) | (x30 & (~x29 | (~x27 & ~x28))));
