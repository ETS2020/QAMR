// Benchmark "FAU" written by ABC on Wed Aug  5 21:13:32 2020
...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & ((x31 & new_n51_ & ~x32) | (~new_n55_ & x32));
  assign new_n51_ = ~new_n52_ & ((x29 & (x27 | x28) & ~x30) | (x30 & (~x29 | (~x27 & ~x28))));
  ...
  assign new_n55_ = ~new_n61_ & ~new_n56_ & new_n57_ & ~new_n62_;
  assign new_n56_ = ~x15 & (~new_n54_ | ~x10 | ~x16);
  assign new_n57_ = ~new_n58_ & new_n59_ & new_n60_ & (x18 | (x13 & x19));
  assign new_n58_ = ~x17 & (~x12 | ~x18 | ~x19);
  assign new_n59_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n60_ = x31 & (x29 | x30) & (~x28 | ~x29 | ~x30);
  assign new_n61_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
