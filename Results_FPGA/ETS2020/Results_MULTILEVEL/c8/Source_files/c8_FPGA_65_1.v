// Benchmark "FAU" written by ABC on Tue Aug  4 23:30:46 2020
...
module FAU ( 
  ...
  assign new_n64_ = (~x24 | (new_n57_ & ~x21 & ~x22 & ~x23)) & (~new_n57_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? (new_n66_ | new_n67_) : (x18 ? x06 : x14);
  assign new_n66_ = x25 & (~new_n57_ | x21 | x22 | x23 | x24);
