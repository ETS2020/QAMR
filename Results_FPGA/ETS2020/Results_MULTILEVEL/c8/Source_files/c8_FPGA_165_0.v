// Benchmark "FAU" written by ABC on Tue Aug  4 23:31:31 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n54_, new_n56_, new_n58_, new_n60_, new_n61_;
  ...
  assign z11 = x16 ? ~new_n54_ : (x18 ? x02 : x10);
  assign new_n54_ = (~x21 | (~x17 & ~x19 & ~x20)) & (x17 | x19 | x20 | x21);
  ...
  assign new_n58_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z17 = x16 & ((x17 & x27) | (new_n61_ & new_n60_ & ~x17 & x19));
