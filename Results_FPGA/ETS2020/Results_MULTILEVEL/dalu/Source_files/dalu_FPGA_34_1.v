// Benchmark "FAU" written by ABC on Thu Aug  6 22:05:55 2020
...
module FAU ( 
  ...
  assign z05 = x64 ? (~x65 & (new_n202_ | new_n207_)) : ~new_n190_;
  assign new_n190_ = ((~x66 & ~x67) | (x65 ? new_n191_ : ~new_n199_)) & (~x65 | x66 | ~new_n199_ | x67);
  assign new_n191_ = x68 ? (x69 | x70 | new_n196_ | x71) : (~x69 | (~new_n192_ & (~x70 | new_n196_ | ~x71)));
  ...
  assign new_n203_ = x69 & (new_n192_ | (x70 & ~new_n196_ & x71));
  ...
  assign z06 = x64 ? (~x65 & (new_n223_ | new_n227_)) : (new_n209_ | (new_n222_ & x65));
  assign new_n209_ = ~new_n112_ & (x65 ? (x68 ? new_n218_ : new_n210_) : new_n219_);
  assign new_n210_ = x69 & ((~new_n211_ & (x70 ^ x71)) | (x70 & ~new_n215_ & x71));
  ...
  assign new_n215_ = (new_n212_ | ~x54) & ~new_n216_ & ~new_n217_;
  ...
  assign new_n223_ = ~x66 & (x68 ? new_n224_ : (x67 ? ~new_n225_ : new_n210_));
  ...
  assign new_n231_ = (new_n212_ | ~x23) & (new_n232_ | ~x72) & (new_n233_ | x72);
  assign new_n232_ = (x73 | (x74 ? ~x18 : ~x19)) & (~x16 | ~x73 | x74);
  assign new_n233_ = (~x73 | (x74 ? ~x20 : ~x21)) & (~x22 | x73 | ~x74);
  assign new_n234_ = (new_n212_ | ~x55) & ~new_n235_ & ~new_n236_;
  ...
  assign z09 = x64 ? (~x65 & (new_n261_ | new_n265_)) : (new_n248_ | (new_n259_ & x65));
  ...
  assign new_n250_ = (~x09 | (~new_n157_ & x00)) & (~x00 | new_n157_ | x09);
  assign new_n251_ = (~x41 | (~new_n160_ & x32)) & (~x32 | new_n160_ | x41);
  assign new_n252_ = (new_n212_ | ~x57) & ~new_n253_ & ~new_n254_;
  assign new_n253_ = x72 & ((~x73 & (x74 ? x52 : x53)) | (x49 & x73 & ~x74));
  assign new_n254_ = ~x72 & ((x73 & (x74 ? x54 : x55)) | (x56 & ~x73 & x74));
  assign new_n255_ = x69 & ((~new_n256_ & (x70 ^ x71)) | (x70 & ~new_n252_ & x71));
  assign new_n256_ = (new_n212_ | ~x25) & (new_n257_ | ~x72) & (new_n258_ | x72);
  ...
  assign new_n262_ = ~x69 & ~x70 & ~x71 & (x67 ? x41 : ~new_n252_);
  assign new_n263_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x57 | ~x69) & (new_n264_ | ~x70);
  assign new_n264_ = (~x41 | ~x71) & (~x25 | x69 | x71);
  assign new_n265_ = x66 & ~x67 & ((~new_n263_ & ~x68) | (new_n108_ & x41 & x68));
  assign z10 = x64 ? (~new_n283_ & ~x65) : (new_n267_ | (x65 & new_n290_ & ~x66));
  assign new_n267_ = ~new_n112_ & (x70 ? ~new_n278_ : (new_n268_ | new_n274_));
  assign new_n268_ = x68 & ~x69 & (x65 ? (~new_n271_ & ~x71) : new_n269_);
  assign new_n269_ = x71 & ((x10 & (~x00 | (new_n270_ & ~x11 & ~x12))) | (x00 & ~x10 & (~new_n270_ | x11 | x12)));
  assign new_n270_ = ~x13 & ~x14 & ~x15;
  assign new_n271_ = (new_n212_ | ~x58) & ~new_n272_ & ~new_n273_;
  assign new_n272_ = x72 & ((~x73 & (x74 ? x53 : x54)) | (x50 & x73 & ~x74));
  assign new_n273_ = ~x72 & ((x73 & (x74 ? x55 : x56)) | (x57 & ~x73 & x74));
  assign new_n274_ = x65 & ~x68 & x69 & ~new_n275_ & x71;
  assign new_n275_ = (new_n212_ | ~x26) & (new_n276_ | ~x72) & (new_n277_ | x72);
  assign new_n276_ = (x73 | (x74 ? ~x21 : ~x22)) & (~x18 | ~x73 | x74);
  assign new_n277_ = (~x73 | (x74 ? ~x23 : ~x24)) & (~x25 | x73 | ~x74);
  assign new_n278_ = x65 ? (x68 | ~x69 | (~new_n279_ & new_n280_)) : (~x68 | ~new_n281_ | x69);
  assign new_n279_ = ~new_n212_ & (x71 ? x58 : x26);
  assign new_n280_ = x71 ? (~new_n272_ & ~new_n273_) : (x72 ? new_n276_ : new_n277_);
  assign new_n281_ = ~x71 & ((x42 & (~x32 | (new_n282_ & ~x43 & ~x44))) | (x32 & ~x42 & (~new_n282_ | x43 | x44)));
  assign new_n282_ = ~x45 & ~x46 & ~x47;
  assign new_n283_ = x66 ? (new_n289_ | x67) : (x68 ? ~new_n288_ : new_n284_);
  assign new_n284_ = x67 ? new_n285_ : (~x69 | (~new_n287_ & (new_n275_ | new_n193_)));
  assign new_n285_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x58 | ~x69) & (new_n286_ | ~x70);
  assign new_n286_ = (~x42 | ~x71) & (~x26 | x69 | x71);
  assign new_n287_ = x70 & x71 & ((~new_n212_ & x58) | new_n272_ | new_n273_);
  assign new_n288_ = ~x69 & ~x70 & ~x71 & (x67 ? x42 : ~new_n271_);
  assign new_n289_ = (~new_n108_ | ~x42 | ~x68) & (new_n285_ | x68);
  assign new_n290_ = ~x67 & x68 & ~x69 & (x70 ? new_n281_ : new_n269_);
  assign z11 = x64 ? (~x65 & (x66 ? new_n315_ : ~new_n308_)) : ~new_n292_;
  assign new_n292_ = ((~x66 & ~x67) | (~new_n293_ & ~new_n303_)) & (~x65 | x66 | ~new_n307_ | x67);
  assign new_n293_ = ~x70 & ((x68 & ~new_n294_ & ~x69) | (x65 & ~x68 & new_n299_ & x69));
  assign new_n294_ = x65 ? (x71 | (~new_n296_ & ~new_n297_ & ~new_n298_)) : (new_n295_ | ~x71);
  assign new_n295_ = (~x11 | (x00 & (x14 | x15 | x12 | x13))) & (~x00 | x11 | (~x14 & ~x15 & ~x12 & ~x13));
  ...
  assign new_n303_ = x70 & (x65 ? (~x68 & ~new_n304_ & x69) : (x68 & new_n306_ & ~x69));
  assign new_n304_ = ~new_n305_ & (x71 | (~new_n301_ & ~new_n302_)) & (~x71 | (~new_n297_ & ~new_n298_));
  assign new_n305_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x59 : x27);
  assign new_n306_ = ~x71 & ((x43 & (new_n124_ | ~x32)) | (x32 & ~new_n124_ & ~x43));
  assign new_n307_ = x68 & ~x69 & (x70 ? new_n306_ : (~new_n295_ & x71));
  assign new_n308_ = x68 ? (~new_n312_ | x69) : (x67 ? new_n313_ : (new_n309_ | ~x69));
  assign new_n309_ = ((new_n311_ & ~new_n300_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n310_ & ~new_n296_));
  assign new_n310_ = ~new_n297_ & ~new_n298_;
  assign new_n311_ = ~new_n301_ & ~new_n302_;
  assign new_n312_ = ~x70 & ~x71 & (x67 ? x43 : (~new_n310_ | new_n296_));
  assign new_n313_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n314_ | ~x70);
  assign new_n314_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n315_ = ~x67 & ((~new_n313_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n338_ : ~new_n333_)) : ~new_n317_;
  assign new_n317_ = ~new_n331_ & (new_n112_ | (x70 ? new_n327_ : (~new_n318_ & ~new_n323_)));
  assign new_n318_ = x68 & ~x69 & (x65 ? (~new_n320_ & ~x71) : (~new_n319_ & x71));
  assign new_n319_ = (~x12 | (~new_n270_ & x00)) & (~x00 | new_n270_ | x12);
  assign new_n320_ = (new_n212_ | ~x60) & (new_n321_ | ~x72) & (new_n322_ | x72);
  ...
  assign new_n324_ = (new_n212_ | ~x28) & (new_n325_ | ~x72) & (new_n326_ | x72);
  assign new_n325_ = (x73 | (x74 ? ~x23 : ~x24)) & (~x20 | ~x73 | x74);
  assign new_n326_ = (~x73 | (x74 ? ~x25 : ~x26)) & (~x27 | x73 | ~x74);
  assign new_n327_ = x65 ? (x68 | ~x69 | (~new_n328_ & new_n329_)) : (~x68 | ~new_n330_ | x69);
  assign new_n328_ = ~new_n212_ & (x71 ? x60 : x28);
  assign new_n329_ = x71 ? (x72 ? new_n321_ : new_n322_) : (x72 ? new_n325_ : new_n326_);
  assign new_n330_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n331_ = x65 & ~x66 & ~x67 & x68 & ~new_n332_ & ~x69;
  assign new_n332_ = x70 ? ~new_n330_ : (~x71 | ((~x12 | (~new_n270_ & x00)) & (~x00 | new_n270_ | x12)));
  assign new_n333_ = x68 ? (~new_n335_ | x69) : (x67 ? new_n336_ : (new_n334_ | ~x69));
  assign new_n334_ = (new_n324_ | (~x70 ^ x71)) & (~x70 | new_n320_ | ~x71);
  assign new_n335_ = ~x70 & ~x71 & (x67 ? x44 : ~new_n320_);
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n361_ : ~new_n356_)) : ~new_n340_;
  assign new_n340_ = ~new_n354_ & (new_n112_ | (x70 ? new_n350_ : (~new_n341_ & ~new_n346_)));
  assign new_n341_ = x68 & ~x69 & (x65 ? (~new_n342_ & ~x71) : new_n345_);
  assign new_n342_ = (new_n212_ | ~x61) & (new_n343_ | ~x72) & (new_n344_ | x72);
  assign new_n343_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n344_ = (~x73 | (x74 ? ~x58 : ~x59)) & (~x60 | x73 | ~x74);
  assign new_n345_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n346_ = x65 & ~x68 & x69 & ~new_n347_ & x71;
  assign new_n347_ = (new_n212_ | ~x29) & (new_n348_ | ~x72) & (new_n349_ | x72);
  ...
  assign new_n351_ = ~new_n212_ & (x71 ? x61 : x29);
  assign new_n352_ = x71 ? (x72 ? new_n343_ : new_n344_) : (x72 ? new_n348_ : new_n349_);
  assign new_n353_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n354_ = x65 & new_n355_ & ~x66;
  assign new_n355_ = ~x67 & x68 & ~x69 & (x70 ? new_n353_ : new_n345_);
  assign new_n356_ = x68 ? (~new_n358_ | x69) : (x67 ? new_n359_ : (new_n357_ | ~x69));
  assign new_n357_ = (new_n347_ | (~x70 ^ x71)) & (~x70 | new_n342_ | ~x71);
  assign new_n358_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n342_);
  assign new_n359_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n360_ | ~x70);
  assign new_n360_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n361_ = ~x67 & ((~new_n359_ & ~x68) | (new_n108_ & x45 & x68));
  assign z08 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
endmodule
