// Benchmark "FAU" written by ABC on Thu Aug  6 22:05:43 2020
...
module FAU ( 
  ...
  assign z06 = x64 ? (~x65 & (new_n222_ | new_n226_)) : (new_n208_ | (new_n221_ & x65));
  assign new_n208_ = ~new_n112_ & (x65 ? (x68 ? new_n217_ : new_n209_) : new_n218_);
  assign new_n209_ = x69 & ((~new_n210_ & (x70 ^ x71)) | (x70 & ~new_n214_ & x71));
  assign new_n210_ = (new_n211_ | ~x22) & (new_n212_ | ~x72) & (new_n213_ | x72);
  assign new_n211_ = x72 ? (~x73 | ~x74) : (x73 | x74);
  assign new_n212_ = (x73 | (x74 ? ~x17 : ~x18)) & (~x16 | ~x73 | x74);
  assign new_n213_ = (~x73 | (x74 ? ~x19 : ~x20)) & (~x21 | x73 | ~x74);
  assign new_n214_ = (new_n211_ | ~x54) & ~new_n215_ & ~new_n216_;
  ...
  assign new_n222_ = ~x66 & (x68 ? new_n223_ : (x67 ? ~new_n224_ : new_n209_));
  ...
  assign new_n232_ = (new_n211_ | ~x56) & (new_n233_ | ~x72) & (new_n234_ | x72);
  ...
  assign new_n236_ = (new_n211_ | ~x24) & (new_n237_ | ~x72) & (new_n238_ | x72);
  ...
  assign z09 = x64 ? (~new_n260_ & ~x65) : ((new_n259_ & x65) | (~new_n247_ & ~new_n112_));
  assign new_n247_ = (~x68 | x69 | (x65 ? ~new_n250_ : new_n248_)) & (~x65 | x68 | new_n254_ | ~x69);
  assign new_n248_ = x70 ? (new_n249_ | x71) : (~x71 | ((~x00 | new_n157_ | x09) & (~x09 | (~new_n157_ & x00))));
  assign new_n249_ = (~x41 | (~new_n160_ & x32)) & (~x32 | new_n160_ | x41);
  assign new_n250_ = ~x70 & ~new_n251_ & ~x71;
  assign new_n251_ = (new_n211_ | ~x57) & (new_n252_ | ~x72) & (new_n253_ | x72);
  assign new_n252_ = (x73 | (x74 ? ~x52 : ~x53)) & (~x49 | ~x73 | x74);
  assign new_n253_ = (~x73 | (x74 ? ~x54 : ~x55)) & (~x56 | x73 | ~x74);
  assign new_n254_ = ~new_n255_ & (~new_n258_ | ~x70);
  assign new_n255_ = (x70 ^ x71) & ((~new_n211_ & x25) | new_n256_ | new_n257_);
  assign new_n256_ = x72 & ((~x73 & (x74 ? x20 : x21)) | (x17 & x73 & ~x74));
  assign new_n257_ = ~x72 & ((x73 & (x74 ? x22 : x23)) | (x24 & ~x73 & x74));
  assign new_n258_ = x71 & ((~new_n211_ & x57) | (~new_n253_ & ~x72) | (~new_n252_ & x72));
  assign new_n259_ = ~x66 & ~x67 & x68 & ~new_n248_ & ~x69;
  assign new_n260_ = x66 ? (new_n265_ | x67) : (x68 ? ~new_n264_ : new_n261_);
  assign new_n261_ = x67 ? new_n262_ : (~x69 | (~new_n255_ & (~new_n258_ | ~x70)));
  assign new_n262_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x57 | ~x69) & (new_n263_ | ~x70);
  assign new_n263_ = (~x41 | ~x71) & (~x25 | x69 | x71);
  assign new_n264_ = ~x69 & ~x70 & ~x71 & (x67 ? x41 : ~new_n251_);
  assign new_n265_ = (~new_n108_ | ~x41 | ~x68) & (new_n262_ | x68);
  assign z12 = x64 ? (~x65 & (x66 ? new_n288_ : ~new_n283_)) : ~new_n267_;
  assign new_n267_ = ~new_n281_ & (new_n112_ | (x70 ? new_n277_ : (~new_n268_ & ~new_n273_)));
  assign new_n268_ = x68 & ~x69 & (x65 ? (~new_n269_ & ~x71) : new_n272_);
  assign new_n269_ = (new_n211_ | ~x60) & (new_n270_ | ~x72) & (new_n271_ | x72);
  assign new_n270_ = (x73 | (x74 ? ~x55 : ~x56)) & (~x52 | ~x73 | x74);
  assign new_n271_ = (~x73 | (x74 ? ~x57 : ~x58)) & (~x59 | x73 | ~x74);
  assign new_n272_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  assign new_n273_ = x65 & ~x68 & x69 & ~new_n274_ & x71;
  assign new_n274_ = (new_n211_ | ~x28) & (new_n275_ | ~x72) & (new_n276_ | x72);
  assign new_n275_ = (x73 | (x74 ? ~x23 : ~x24)) & (~x20 | ~x73 | x74);
  assign new_n276_ = (~x73 | (x74 ? ~x25 : ~x26)) & (~x27 | x73 | ~x74);
  assign new_n277_ = x65 ? (x68 | ~x69 | (~new_n278_ & new_n279_)) : (~x68 | ~new_n280_ | x69);
  assign new_n278_ = ~new_n211_ & (x71 ? x60 : x28);
  assign new_n279_ = x71 ? (x72 ? new_n270_ : new_n271_) : (x72 ? new_n275_ : new_n276_);
  assign new_n280_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n281_ = x65 & new_n282_ & ~x66;
  assign new_n282_ = ~x67 & x68 & ~x69 & (x70 ? new_n280_ : new_n272_);
  assign new_n283_ = x68 ? (~new_n285_ | x69) : (x67 ? new_n286_ : (new_n284_ | ~x69));
  assign new_n284_ = (new_n274_ | (~x70 ^ x71)) & (~x70 | new_n269_ | ~x71);
  assign new_n285_ = ~x70 & ~x71 & (x67 ? x44 : ~new_n269_);
  assign new_n286_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n287_ | ~x70);
  assign new_n287_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n288_ = ~x67 & ((~new_n286_ & ~x68) | (new_n108_ & x44 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n311_ : ~new_n306_)) : ~new_n290_;
  assign new_n290_ = ~new_n304_ & (new_n112_ | (x70 ? new_n300_ : (~new_n291_ & ~new_n296_)));
  assign new_n291_ = x68 & ~x69 & (x65 ? (~new_n292_ & ~x71) : (~new_n295_ & x71));
  assign new_n292_ = (new_n211_ | ~x62) & (new_n293_ | ~x72) & (new_n294_ | x72);
  assign new_n293_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n294_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n295_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n296_ = x65 & ~x68 & x69 & ~new_n297_ & x71;
  assign new_n297_ = (new_n211_ | ~x30) & (new_n298_ | ~x72) & (new_n299_ | x72);
  assign new_n298_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n299_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n300_ = x65 ? (x68 | ~x69 | (~new_n301_ & new_n302_)) : (~x68 | ~new_n303_ | x69);
  assign new_n301_ = ~new_n211_ & (x71 ? x62 : x30);
  assign new_n302_ = x71 ? (x72 ? new_n293_ : new_n294_) : (x72 ? new_n298_ : new_n299_);
  assign new_n303_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n304_ = x65 & ~x66 & ~x67 & x68 & ~new_n305_ & ~x69;
  assign new_n305_ = x70 ? ~new_n303_ : (new_n295_ | ~x71);
  assign new_n306_ = x68 ? (~new_n308_ | x69) : (x67 ? new_n309_ : (new_n307_ | ~x69));
  assign new_n307_ = (new_n297_ | (~x70 ^ x71)) & (~x70 | new_n292_ | ~x71);
  assign new_n308_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n292_);
  assign new_n309_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n310_ | ~x70);
  assign new_n310_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n311_ = ~x67 & ((~new_n309_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x68 ? (~new_n324_ & ~x69) : (x64 ? new_n313_ : new_n323_);
  assign new_n313_ = ~x65 & (x66 ? (~new_n321_ & ~x67) : (x67 ? ~new_n321_ : (~new_n314_ & x69)));
  assign new_n314_ = (new_n315_ | (~x70 ^ x71)) & (~x70 | new_n318_ | ~x71);
  assign new_n315_ = (new_n211_ | ~x31) & (new_n316_ | ~x72) & (new_n317_ | x72);
  assign new_n316_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n317_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n318_ = (new_n211_ | ~x63) & (new_n319_ | ~x72) & (new_n320_ | x72);
  assign new_n319_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n320_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n321_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n322_ | ~x70);
  assign new_n322_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n323_ = x65 & x69 & ~new_n314_ & ~new_n112_;
  assign new_n324_ = x64 ? (~new_n326_ | x65) : ((new_n325_ | new_n112_) & (~new_n327_ | ~x65));
  assign new_n325_ = (x70 | ((~x65 | new_n318_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n326_ = ~x70 & ~x71 & ((~x66 & ~new_n318_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n327_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z13 = 1'b0;
