// Benchmark "FAU" written by ABC on Thu Aug  6 22:08:29 2020
...
module FAU ( 
  ...
  assign new_n297_ = ~new_n312_ & (new_n114_ | (x70 ? new_n308_ : (~new_n298_ & ~new_n304_)));
  ...
  assign new_n301_ = (new_n195_ | ~x61) & (new_n302_ | ~x72) & (new_n303_ | x72);
  ...
  assign new_n305_ = (new_n195_ | ~x29) & (new_n306_ | ~x72) & (new_n307_ | x72);
  ...
  assign new_n309_ = ~new_n195_ & (x71 ? x61 : x29);
  ...
  assign new_n319_ = ~x67 & ((~new_n317_ & ~x68) | (new_n110_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n342_ : ~new_n337_)) : ~new_n321_;
  assign new_n321_ = ~new_n335_ & (new_n114_ | (x70 ? new_n331_ : (~new_n322_ & ~new_n327_)));
  assign new_n322_ = x68 & ~x69 & (x65 ? (~new_n323_ & ~x71) : (~new_n326_ & x71));
  assign new_n323_ = (new_n195_ | ~x62) & (new_n324_ | ~x72) & (new_n325_ | x72);
  ...
  assign new_n328_ = (new_n195_ | ~x30) & (new_n329_ | ~x72) & (new_n330_ | x72);
  ...
  assign new_n332_ = ~new_n195_ & (x71 ? x62 : x30);
  ...
  assign new_n342_ = ~x67 & ((~new_n340_ & ~x68) | (new_n110_ & x46 & x68));
  assign z05 = 1'b0;
  assign z09 = 1'b0;
  assign z12 = 1'b0;
  assign z15 = 1'b0;
