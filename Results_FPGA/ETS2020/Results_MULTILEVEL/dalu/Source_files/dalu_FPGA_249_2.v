// Benchmark "FAU" written by ABC on Thu Aug  6 22:14:53 2020
...
module FAU ( 
  ...
  assign new_n231_ = (~x40 | (x32 & (~new_n123_ | ~new_n124_))) & (~x32 | x40 | (new_n123_ & new_n124_));
  assign new_n232_ = (new_n126_ | ~x56) & ~new_n233_ & ~new_n234_;
  assign new_n233_ = x72 & ((~x73 & (x74 ? x51 : x52)) | (x48 & x73 & ~x74));
  assign new_n234_ = ~x72 & ((x73 & (x74 ? x53 : x54)) | (x55 & ~x73 & x74));
  assign new_n235_ = x69 & ((~new_n236_ & (x70 ^ x71)) | (x70 & ~new_n232_ & x71));
  assign new_n236_ = (new_n126_ | ~x24) & (new_n237_ | ~x72) & (new_n238_ | x72);
  ...
  assign new_n243_ = (~x08 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x56 | ~x69) & (new_n244_ | ~x70);
  ...
  assign new_n249_ = (~x09 | (~new_n158_ & x00)) & (~x00 | new_n158_ | x09);
  assign new_n250_ = (~x41 | (~new_n161_ & x32)) & (~x32 | new_n161_ | x41);
  assign new_n251_ = (new_n126_ | ~x57) & (new_n252_ | ~x72) & (new_n253_ | x72);
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n317_ : ~new_n312_)) : ~new_n295_;
  assign new_n295_ = ~new_n310_ & (new_n112_ | (x70 ? new_n305_ : (~new_n296_ & ~new_n301_)));
  assign new_n296_ = x68 & ~x69 & (x65 ? (~new_n298_ & ~x71) : (~new_n297_ & x71));
  assign new_n297_ = (~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11);
  assign new_n298_ = (new_n126_ | ~x59) & (new_n299_ | ~x72) & (new_n300_ | x72);
  assign new_n299_ = (x73 | (x74 ? ~x54 : ~x55)) & (~x51 | ~x73 | x74);
  assign new_n300_ = (~x73 | (x74 ? ~x56 : ~x57)) & (~x58 | x73 | ~x74);
  assign new_n301_ = x65 & ~x68 & x69 & ~new_n302_ & x71;
  assign new_n302_ = (new_n126_ | ~x27) & (new_n303_ | ~x72) & (new_n304_ | x72);
  assign new_n303_ = (x73 | (x74 ? ~x22 : ~x23)) & (~x19 | ~x73 | x74);
  assign new_n304_ = (~x73 | (x74 ? ~x24 : ~x25)) & (~x26 | x73 | ~x74);
  assign new_n305_ = x65 ? (x68 | ~x69 | (~new_n306_ & new_n307_)) : (~x68 | ~new_n308_ | x69);
  assign new_n306_ = ~new_n126_ & (x71 ? x59 : x27);
  assign new_n307_ = x71 ? (x72 ? new_n299_ : new_n300_) : (x72 ? new_n303_ : new_n304_);
  assign new_n308_ = ~new_n309_ & ~x71;
  assign new_n309_ = (~x43 | (x32 & (x46 | x47 | x44 | x45))) & (~x32 | x43 | (~x46 & ~x47 & ~x44 & ~x45));
  assign new_n310_ = x65 & ~x66 & ~x67 & x68 & ~new_n311_ & ~x69;
  assign new_n311_ = x70 ? (new_n309_ | x71) : (~x71 | ((~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11)));
  assign new_n312_ = x68 ? (~new_n314_ | x69) : (x67 ? new_n315_ : (new_n313_ | ~x69));
  assign new_n313_ = (new_n302_ | (~x70 ^ x71)) & (~x70 | new_n298_ | ~x71);
  assign new_n314_ = ~x70 & ~x71 & (x67 ? x43 : ~new_n298_);
  assign new_n315_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n316_ | ~x70);
  assign new_n316_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n317_ = ~x67 & ((~new_n315_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n342_ : ~new_n335_)) : ~new_n319_;
  assign new_n319_ = ((~x66 & ~x67) | (~new_n320_ & ~new_n330_)) & (~x65 | x66 | ~new_n334_ | x67);
  assign new_n320_ = ~x70 & ((x68 & ~new_n321_ & ~x69) | (x65 & ~x68 & new_n326_ & x69));
  assign new_n321_ = x65 ? (x71 | (~new_n323_ & ~new_n324_ & ~new_n325_)) : ~new_n322_;
  assign new_n322_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  assign new_n323_ = x60 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n324_ = x72 & ((~x73 & (x74 ? x55 : x56)) | (x52 & x73 & ~x74));
  assign new_n325_ = ~x72 & ((x73 & (x74 ? x57 : x58)) | (x59 & ~x73 & x74));
  assign new_n326_ = x71 & (new_n327_ | new_n328_ | new_n329_);
  assign new_n327_ = x28 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n328_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n329_ = ~x72 & ((x73 & (x74 ? x25 : x26)) | (x27 & ~x73 & x74));
  assign new_n330_ = x70 & (x65 ? (~x68 & ~new_n331_ & x69) : (x68 & new_n333_ & ~x69));
  assign new_n331_ = ~new_n332_ & (x71 | (~new_n328_ & ~new_n329_)) & (~x71 | (~new_n324_ & ~new_n325_));
  assign new_n332_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n333_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n334_ = x68 & ~x69 & (x70 ? new_n333_ : new_n322_);
  assign new_n335_ = x68 ? (~new_n339_ | x69) : (x67 ? new_n340_ : (new_n336_ | ~x69));
  assign new_n336_ = ((new_n338_ & ~new_n327_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n337_ & ~new_n323_));
  assign new_n337_ = ~new_n324_ & ~new_n325_;
  assign new_n338_ = ~new_n328_ & ~new_n329_;
  assign new_n339_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n337_ | new_n323_));
  assign new_n340_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n341_ | ~x70);
  assign new_n341_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n342_ = ~x67 & ((~new_n340_ & ~x68) | (new_n108_ & x44 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n365_ : ~new_n360_)) : ~new_n344_;
  assign new_n344_ = ~new_n358_ & (new_n112_ | (x70 ? new_n354_ : (~new_n345_ & ~new_n350_)));
  assign new_n345_ = x68 & ~x69 & (x65 ? (~new_n346_ & ~x71) : (~new_n349_ & x71));
  assign new_n346_ = (new_n126_ | ~x62) & (new_n347_ | ~x72) & (new_n348_ | x72);
  assign new_n347_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n348_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n349_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n350_ = x65 & ~x68 & x69 & ~new_n351_ & x71;
  assign new_n351_ = (new_n126_ | ~x30) & (new_n352_ | ~x72) & (new_n353_ | x72);
  assign new_n352_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n353_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n354_ = x65 ? (x68 | ~x69 | (~new_n355_ & new_n356_)) : (~x68 | ~new_n357_ | x69);
  assign new_n355_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n356_ = x71 ? (x72 ? new_n347_ : new_n348_) : (x72 ? new_n352_ : new_n353_);
  assign new_n357_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n358_ = x65 & ~x66 & ~x67 & x68 & ~new_n359_ & ~x69;
  assign new_n359_ = x70 ? ~new_n357_ : (new_n349_ | ~x71);
  assign new_n360_ = x68 ? (~new_n362_ | x69) : (x67 ? new_n363_ : (new_n361_ | ~x69));
  assign new_n361_ = (new_n351_ | (~x70 ^ x71)) & (~x70 | new_n346_ | ~x71);
  assign new_n362_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n346_);
  assign new_n363_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n364_ | ~x70);
  assign new_n364_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n365_ = ~x67 & ((~new_n363_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x68 ? (~new_n378_ & ~x69) : (x64 ? new_n367_ : new_n377_);
  assign new_n367_ = ~x65 & (x66 ? (~new_n375_ & ~x67) : (x67 ? ~new_n375_ : (~new_n368_ & x69)));
  assign new_n368_ = (new_n369_ | (~x70 ^ x71)) & (~x70 | new_n372_ | ~x71);
  assign new_n369_ = (new_n126_ | ~x31) & (new_n370_ | ~x72) & (new_n371_ | x72);
  assign new_n370_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n371_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n372_ = (new_n126_ | ~x63) & (new_n373_ | ~x72) & (new_n374_ | x72);
  assign new_n373_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n374_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n375_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n376_ | ~x70);
  assign new_n376_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n377_ = x65 & x69 & ~new_n368_ & ~new_n112_;
  assign new_n378_ = x64 ? (~new_n380_ | x65) : ((new_n379_ | new_n112_) & (~new_n381_ | ~x65));
  assign new_n379_ = (x70 | ((~x65 | new_n372_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n380_ = ~x70 & ~x71 & ((~x66 & ~new_n372_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n381_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z07 = 1'b0;
  assign z13 = 1'b0;
endmodule
