// Benchmark "FAU" written by ABC on Thu Aug  6 22:08:37 2020
...
module FAU ( 
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n302_ : ~new_n295_)) : ~new_n279_;
  ...
  assign new_n282_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  assign new_n283_ = x60 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n284_ = x72 & ((x52 & x73 & ~x74) | (~x73 & (x74 ? x55 : x56)));
  assign new_n285_ = ~x72 & ((x73 & (x74 ? x57 : x58)) | (x59 & ~x73 & x74));
  assign new_n286_ = x71 & (new_n287_ | new_n288_ | new_n289_);
  assign new_n287_ = x28 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n292_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n293_ = ~x71 & ((x44 & (new_n215_ | ~x32)) | (x32 & ~new_n215_ & ~x44));
  ...
  assign new_n299_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n297_ | new_n283_));
  assign new_n300_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n301_ | ~x70);
  assign new_n301_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n302_ = ~x67 & ((~new_n300_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n325_ : ~new_n320_)) : ~new_n304_;
  assign new_n304_ = ~new_n318_ & (new_n112_ | (x70 ? new_n314_ : (~new_n305_ & ~new_n310_)));
  assign new_n305_ = x68 & ~x69 & (x65 ? (~new_n306_ & ~x71) : new_n309_);
  assign new_n306_ = (new_n175_ | ~x61) & (new_n307_ | ~x72) & (new_n308_ | x72);
  assign new_n307_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n308_ = (~x73 | (x74 ? ~x58 : ~x59)) & (~x60 | x73 | ~x74);
  assign new_n309_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n310_ = x65 & ~x68 & x69 & ~new_n311_ & x71;
  assign new_n311_ = (new_n175_ | ~x29) & (new_n312_ | ~x72) & (new_n313_ | x72);
  ...
  assign new_n315_ = ~new_n175_ & (x71 ? x61 : x29);
  assign new_n316_ = x71 ? (x72 ? new_n307_ : new_n308_) : (x72 ? new_n312_ : new_n313_);
  assign new_n317_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n318_ = x65 & new_n319_ & ~x66;
  assign new_n319_ = ~x67 & x68 & ~x69 & (x70 ? new_n317_ : new_n309_);
  assign new_n320_ = x68 ? (~new_n322_ | x69) : (x67 ? new_n323_ : (new_n321_ | ~x69));
  assign new_n321_ = (new_n311_ | (~x70 ^ x71)) & (~x70 | new_n306_ | ~x71);
  assign new_n322_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n306_);
  assign new_n323_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n324_ | ~x70);
  assign new_n324_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n325_ = ~x67 & ((~new_n323_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n348_ : ~new_n343_)) : ~new_n327_;
  assign new_n327_ = ~new_n341_ & (new_n112_ | (x70 ? new_n337_ : (~new_n328_ & ~new_n333_)));
  assign new_n328_ = x68 & ~x69 & (x65 ? (~new_n329_ & ~x71) : (~new_n332_ & x71));
  assign new_n329_ = (new_n175_ | ~x62) & (new_n330_ | ~x72) & (new_n331_ | x72);
  assign new_n330_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n331_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n332_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n333_ = x65 & ~x68 & x69 & ~new_n334_ & x71;
  assign new_n334_ = (new_n175_ | ~x30) & (new_n335_ | ~x72) & (new_n336_ | x72);
  assign new_n335_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n336_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n337_ = x65 ? (x68 | ~x69 | (~new_n338_ & new_n339_)) : (~x68 | ~new_n340_ | x69);
  assign new_n338_ = ~new_n175_ & (x71 ? x62 : x30);
  assign new_n339_ = x71 ? (x72 ? new_n330_ : new_n331_) : (x72 ? new_n335_ : new_n336_);
  assign new_n340_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n341_ = x65 & ~x66 & ~x67 & x68 & ~new_n342_ & ~x69;
  assign new_n342_ = x70 ? ~new_n340_ : (new_n332_ | ~x71);
  assign new_n343_ = x68 ? (~new_n345_ | x69) : (x67 ? new_n346_ : (new_n344_ | ~x69));
  assign new_n344_ = (new_n334_ | (~x70 ^ x71)) & (~x70 | new_n329_ | ~x71);
  assign new_n345_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n329_);
  assign new_n346_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n347_ | ~x70);
  assign new_n347_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n348_ = ~x67 & ((~new_n346_ & ~x68) | (new_n108_ & x46 & x68));
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z08 = 1'b0;
  assign z15 = 1'b0;
