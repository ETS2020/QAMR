// Benchmark "FAU" written by ABC on Thu Aug  6 22:06:52 2020
...
module FAU ( 
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n285_ : ~new_n280_)) : ~new_n264_;
  assign new_n264_ = ~new_n278_ & (new_n107_ | (x70 ? new_n274_ : (~new_n265_ & ~new_n270_)));
  assign new_n265_ = x68 & ~x69 & (x65 ? (~new_n266_ & ~x71) : (~new_n269_ & x71));
  assign new_n266_ = (~x62 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n267_ | ~x72) & (new_n268_ | x72);
  assign new_n267_ = (~x54 | ~x73 | x74) & (x73 | (x74 ? ~x57 : ~x58));
  assign new_n268_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n269_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n270_ = x65 & ~x68 & x69 & ~new_n271_ & x71;
  assign new_n271_ = (~x30 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n272_ | ~x72) & (new_n273_ | x72);
  assign new_n272_ = (~x22 | ~x73 | x74) & (x73 | (x74 ? ~x25 : ~x26));
  assign new_n273_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  ...
  assign new_n276_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x62 : x30);
  assign new_n277_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n278_ = x65 & ~x66 & ~x67 & x68 & ~new_n279_ & ~x69;
  assign new_n279_ = x70 ? ~new_n277_ : (new_n269_ | ~x71);
  assign new_n280_ = x68 ? (~new_n282_ | x69) : (x67 ? new_n283_ : (new_n281_ | ~x69));
  assign new_n281_ = (new_n271_ | (~x70 ^ x71)) & (~x70 | new_n266_ | ~x71);
  assign new_n282_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n266_);
  assign new_n283_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n284_ | ~x70) & (x70 | x71 | ~x62 | ~x69);
  assign new_n284_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n285_ = ~x67 & ((~new_n283_ & ~x68) | (new_n115_ & x46 & x68));
  assign z15 = x68 ? (~new_n298_ & ~x69) : (x64 ? new_n287_ : new_n297_);
  assign new_n287_ = ~x65 & (x66 ? (~new_n295_ & ~x67) : (x67 ? ~new_n295_ : (~new_n288_ & x69)));
  assign new_n288_ = (new_n289_ | (~x70 ^ x71)) & (~x70 | new_n292_ | ~x71);
  assign new_n289_ = (~x31 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n290_ | ~x72) & (new_n291_ | x72);
  assign new_n290_ = (~x23 | ~x73 | x74) & (x73 | (x74 ? ~x26 : ~x27));
  assign new_n291_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n292_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n293_ | ~x72) & (new_n294_ | x72);
  assign new_n293_ = (~x55 | ~x73 | x74) & (x73 | (x74 ? ~x58 : ~x59));
  assign new_n294_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n295_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n296_ | ~x70) & (x70 | x71 | ~x63 | ~x69);
  assign new_n296_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n297_ = x65 & x69 & ~new_n288_ & ~new_n107_;
  assign new_n298_ = x64 ? (~new_n300_ | x65) : ((new_n299_ | new_n107_) & (~new_n301_ | ~x65));
  assign new_n299_ = (x70 | ((~x65 | new_n292_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n300_ = ~x70 & ~x71 & ((~x66 & ~new_n292_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n301_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z06 = 1'b0;
