// Benchmark "FAU" written by ABC on Thu Aug  6 22:14:28 2020
...
module FAU ( 
  ...
  assign z15 = x68 ? (~new_n323_ & ~x69) : (x64 ? new_n312_ : new_n322_);
  assign new_n312_ = ~x65 & (x66 ? (~new_n320_ & ~x67) : (x67 ? ~new_n320_ : (~new_n313_ & x69)));
  assign new_n313_ = (new_n314_ | (~x70 ^ x71)) & (~x70 | new_n317_ | ~x71);
  assign new_n314_ = (~x31 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n315_ | ~x72) & (new_n316_ | x72);
  assign new_n315_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n316_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n317_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n318_ | ~x72) & (new_n319_ | x72);
  assign new_n318_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n319_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n320_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n321_ | ~x70);
  assign new_n321_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n322_ = x65 & x69 & ~new_n313_ & ~new_n112_;
  assign new_n323_ = x64 ? (~new_n325_ | x65) : ((new_n324_ | new_n112_) & (~new_n326_ | ~x65));
  assign new_n324_ = (x70 | ((~x65 | new_n317_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n325_ = ~x70 & ~x71 & ((~x66 & ~new_n317_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n326_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
  assign z14 = 1'b0;
