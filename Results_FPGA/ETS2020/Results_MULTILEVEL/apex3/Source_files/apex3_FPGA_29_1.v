...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n397_, new_n398_, new_n400_, new_n401_, new_n405_, new_n409_,
    new_n411_, new_n412_;
  ...
  assign new_n380_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n381_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  ...
  assign z35 = (~new_n391_ & x49) | (~x46 & ~x47 & x48 & new_n393_ & ~x49);
  assign new_n391_ = (~new_n392_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n392_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n393_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z39 = ~x46 & ~x47 & new_n395_ & x48;
  assign new_n395_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n397_ & ~x51) | (~x46 & new_n398_ & x47));
  assign new_n397_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n398_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n400_ & x47) | (new_n401_ & x46 & ~x47 & ~x48));
  assign new_n400_ = ~x49 & new_n139_ & x51;
  assign new_n401_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n384_ & x52;
  assign z43 = x53 & new_n384_ & ~x52;
  assign z44 = ~x46 & new_n405_ & ~x47;
  assign new_n405_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
