// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:18 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n382_, new_n385_, new_n387_, new_n389_, new_n391_, new_n395_,
    new_n396_, new_n399_, new_n401_;
  ...
  assign new_n391_ = ~x51 & ~x50 & new_n360_ & x49;
  ...
  assign new_n396_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z44 = ~x46 & new_n399_ & ~x47;
  assign new_n399_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
