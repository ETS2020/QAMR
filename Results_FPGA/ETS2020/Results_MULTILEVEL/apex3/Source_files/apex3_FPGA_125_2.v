// Benchmark "FAU" written by ABC on Wed Aug  5 13:55:09 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n391_, new_n393_, new_n395_, new_n399_, new_n401_, new_n402_,
    new_n405_, new_n407_;
  ...
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n356_ & ~x49;
  assign new_n356_ = ~x48 & ~x46 & ~x47;
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n358_ & x49;
  assign new_n358_ = x48 & ~x46 & ~x47;
  assign z15 = x50 ? ~new_n360_ : (x46 ? new_n365_ : ~new_n364_);
  assign new_n360_ = ~new_n363_ & (x47 | ((new_n361_ | ~x52) & (~new_n362_ | ~x46)));
  assign new_n361_ = (~x51 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n362_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n363_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n364_ = x47 ? ((~x51 | x52 | ~x48 | x49) & (~x49 | x51 | ~x52 | x53)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n365_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n367_ & ~x48) | (new_n370_ & x48 & x49 & ~x46 & x47);
  assign new_n367_ = (~new_n368_ | x49) & (x46 | ~x47 | ~new_n369_ | ~x49);
  assign new_n368_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n369_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n370_ = x52 & ~x53 & x50 & ~x51;
  assign z17 = ~x47 & new_n372_ & ~x49;
  assign new_n372_ = x52 & ((~x46 & ~x48 & x51 & (~x50 ^ ~x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n374_ & ~x47) : (x47 & new_n375_ & ~x49);
  assign new_n374_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n375_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  ...
  assign z25 = ~x46 & new_n386_ & ~x47;
  assign new_n386_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n358_ & ~x49;
  assign z28 = ~x46 & ~new_n389_ & x47;
  assign new_n389_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n391_ & x49;
  assign new_n391_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n393_ & x47;
  assign new_n393_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n395_ & x52;
  assign new_n395_ = ~x51 & ~x50 & new_n358_ & x49;
  ...
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n356_ & x49;
