// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:48 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n390_, new_n393_, new_n395_, new_n397_, new_n401_, new_n402_,
    new_n405_, new_n407_;
  ...
  assign new_n397_ = ~x51 & ~x50 & new_n360_ & x49;
  assign z37 = ~x53 & new_n397_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n360_ & x49;
  assign z40 = ~x52 & ((~new_n401_ & ~x51) | (~x46 & new_n402_ & x47));
  assign new_n401_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n402_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z44 = ~x46 & new_n405_ & ~x47;
  assign new_n405_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
