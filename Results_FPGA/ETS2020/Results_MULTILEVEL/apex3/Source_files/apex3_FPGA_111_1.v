...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n377_, new_n379_, new_n381_, new_n383_, new_n386_, new_n387_,
  ...
  assign new_n243_ = (~x46 | ((~x48 | (x53 ? x51 : ~x37)) & (x48 | (x51 ^ ~x53)) & (~new_n129_ | ~x51 | x53))) & (~x48 | ((x46 | ~x51) & (x37 | x51 | x53)));
  ...
  assign new_n266_ = ~x52 & ((x25 & (x46 | (~x46 & ~x53))) | (~x25 & ((~x46 & ~x53) | (new_n199_ & x46 & x53))) | (~x46 & x53) | (~new_n199_ & x46));
  assign new_n267_ = (x46 | ((~x16 | ~x52 | x53) & (x14 | ~x53))) & (~x52 | x53 | ~x21 | ~x46);
  assign new_n268_ = (x46 | x51 | ~x52 | ~x53) & (~x46 | x52 | (x53 & (x41 | x51 | ~x53)));
