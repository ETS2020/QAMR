...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n378_, new_n380_, new_n383_, new_n385_, new_n386_, new_n387_,
    new_n389_, new_n391_, new_n392_, new_n394_, new_n395_, new_n399_,
  ...
  assign new_n383_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n385_ & x49) | (~x46 & ~x47 & x48 & new_n387_ & ~x49);
  assign new_n385_ = (~new_n386_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n386_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n387_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  ...
  assign new_n392_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
