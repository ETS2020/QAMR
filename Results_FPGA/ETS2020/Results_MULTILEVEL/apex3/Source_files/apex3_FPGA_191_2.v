// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:00 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n354_, new_n356_, new_n358_, new_n359_, new_n360_, new_n362_,
    ...
    new_n404_, new_n405_, new_n408_, new_n410_;
  ...
  assign z08 = x46 ? (~x47 & new_n352_ & ~x48) : ((~new_n350_ & ~x48) | (~x47 & new_n351_ & x48));
  assign new_n350_ = (~x52 | x53 | ((~x47 | (x49 ? (~x50 | x51) : (x50 | ~x51))) & (x50 | x51 | x47 | x49))) & (x51 | x52 | ~x53 | x47 | ~x49 | ~x50);
  assign new_n351_ = ~x49 & ((x50 & (x51 ? (~x52 & ~x53) : (x52 & x53))) | (~x52 & x53 & ~x50 & x51));
  assign new_n352_ = x50 & ~x52 & ((x51 & ~x53) | (~x49 & ~x51 & x53));
  assign z09 = ~x46 & new_n354_ & ~x51;
  assign new_n354_ = x53 & ((x47 & x48 & x49 & x50 & x52) | (~x47 & ~x48 & ~x49 & ~x50 & ~x52));
  assign z10 = ~x46 & ~new_n356_ & ~x49;
  assign new_n356_ = (x47 | ((x48 | ~x50 | x51 | ~x52 | ~x53) & (x50 | ~x51 | (x48 ? (x52 ^ ~x53) : (x52 | x53))))) & (~x47 | x48 | x50 | ~x51 | ~x52 | x53);
  assign z11 = (~x46 & new_n360_ & x47) | (~x47 & (new_n358_ | (~new_n359_ & x51)));
  assign new_n358_ = new_n163_ & x50 & ~x51 & ~x46 & ~x48 & ~x49;
  assign new_n359_ = (x48 | (x46 ? ((~x52 | ~x53 | ~x49 | x50) & (x49 | ~x50 | x52 | x53)) : (x49 | x53 | (~x50 ^ ~x52)))) & (x46 | ~x48 | x49 | x50 | (x52 ^ ~x53));
  assign new_n360_ = ~x48 & x52 & ~x53 & (x49 ? (x50 & ~x51) : (~x50 & x51));
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n362_ & ~x49;
  assign new_n362_ = ~x48 & ~x46 & ~x47;
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n364_ & x49;
  assign new_n364_ = x48 & ~x46 & ~x47;
  assign z15 = x50 ? ~new_n366_ : (x46 ? new_n371_ : ~new_n370_);
  assign new_n366_ = ~new_n369_ & (x47 | ((new_n367_ | ~x52) & (~new_n368_ | ~x46)));
  assign new_n367_ = (~x51 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n368_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n369_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n370_ = x47 ? ((~x51 | x52 | ~x48 | x49) & (~x49 | x51 | ~x52 | x53)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n371_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n373_ & ~x48) | (new_n376_ & x48 & x49 & ~x46 & x47);
  assign new_n373_ = (~new_n374_ | x49) & (x46 | ~x47 | ~new_n375_ | ~x49);
  assign new_n374_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n375_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n376_ = x52 & ~x53 & x50 & ~x51;
  assign z17 = ~x47 & new_n378_ & ~x49;
  assign new_n378_ = x52 & ((~x46 & ~x48 & x51 & (~x50 ^ ~x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z19 = x46 ? (~x47 & new_n382_ & ~x48) : ~new_n380_;
  assign new_n380_ = (new_n381_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n381_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n382_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n384_ & ~x47;
  assign new_n384_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n386_ & x46 & ~x47 & ~x48) | (new_n387_ & ~x46 & x47 & x48));
  assign new_n386_ = new_n137_ & ~x49 & ~x50;
  assign new_n387_ = x52 & ~x53 & x49 & x50;
  assign z24 = ~x48 & new_n389_ & x49;
  assign new_n389_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n391_ & ~x47;
  assign new_n391_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n364_ & ~x49;
  assign z28 = ~x46 & ~new_n394_ & x47;
  assign new_n394_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n396_ & x49;
  ...
  assign new_n400_ = ~x51 & ~x50 & new_n364_ & x49;
  assign z37 = ~x53 & new_n400_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n364_ & x49;
  assign z40 = ~x52 & ((~new_n404_ & ~x51) | (~x46 & new_n405_ & x47));
  assign new_n404_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n405_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n362_ & x49;
  assign z44 = ~x46 & new_n408_ & ~x47;
  assign new_n408_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
