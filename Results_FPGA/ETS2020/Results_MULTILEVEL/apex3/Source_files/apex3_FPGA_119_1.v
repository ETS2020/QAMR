...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n367_, new_n368_, new_n369_, new_n372_, new_n374_, new_n376_,
    new_n378_, new_n379_, new_n380_, new_n382_, new_n384_, new_n387_,
  ...
  assign z16 = (~new_n352_ & ~x48) | (new_n355_ & ~x46 & x47 & x48 & x49);
  assign new_n352_ = (~new_n353_ | x49) & (x46 | ~x47 | ~new_n354_ | ~x49);
  assign new_n353_ = x52 & ((~x47 & ((~x51 & x53 & ~x46 & ~x50) | (x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n354_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n355_ = new_n251_ & x50 & ~x51;
