// Benchmark "FAU" written by ABC on Wed Aug  5 13:54:27 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n406_, new_n407_, new_n413_, new_n415_, new_n416_;
  ...
  assign z19 = x46 ? (~x47 & ~x48 & new_n365_ & x49) : ~new_n362_;
  assign new_n362_ = (new_n364_ | x49) & (~new_n363_ | ~new_n209_ | x47 | x48 | ~x49);
  ...
  assign new_n365_ = ~x53 & (x50 ? (~x51 & ~new_n366_ & x52) : (x51 & ~x52));
  assign new_n366_ = ~x10 & ~x11 & ~x25 & (x10 | x11 | x25);
  ...
  assign new_n370_ = new_n363_ & ~x49 & ~x50;
  assign new_n371_ = new_n251_ & x49 & x50;
  ...
  assign new_n386_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  ...
  assign z35 = (x49 & (new_n395_ | (new_n396_ & ~x46))) | (~x46 & new_n397_ & ~x47);
  assign new_n395_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n396_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n397_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
