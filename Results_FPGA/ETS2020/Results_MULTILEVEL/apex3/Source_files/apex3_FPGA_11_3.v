// Benchmark "FAU" written by ABC on Wed Aug  5 13:51:57 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n461_, new_n462_, new_n465_, new_n467_, new_n469_, new_n472_,
    new_n474_, new_n476_, new_n477_, new_n478_, new_n481_, new_n484_,
    new_n485_, new_n486_, new_n488_, new_n492_, new_n494_, new_n495_,
    new_n497_, new_n498_, new_n501_, new_n505_, new_n507_, new_n508_;
  ...
  assign new_n430_ = new_n329_ & ~x46 & ~x48 & ~x49;
  ...
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n434_ & ~x49;
  assign new_n434_ = ~x48 & ~x46 & ~x47;
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n436_ & x49;
  assign new_n436_ = x48 & ~x46 & ~x47;
  assign z15 = x50 ? ~new_n438_ : (x46 ? new_n443_ : ~new_n442_);
  assign new_n438_ = ~new_n439_ & (x47 | ((new_n440_ | ~x52) & (~new_n441_ | ~x46)));
  assign new_n439_ = new_n283_ & x51 & ~x46 & x48 & ~x49;
  assign new_n440_ = (~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n441_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n442_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n443_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n445_ & ~x48) | (new_n448_ & ~x46 & x47 & x48 & x49);
  assign new_n445_ = (~new_n446_ | x49) & (x46 | ~x47 | ~new_n447_ | ~x49);
  assign new_n446_ = x52 & ((~x47 & ((~x51 & x53 & ~x46 & ~x50) | (x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n447_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n448_ = new_n283_ & x50 & ~x51;
  assign z17 = ~x47 & new_n450_ & ~x49;
  assign new_n450_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n452_ & ~x47) : (x47 & new_n453_ & ~x49);
  assign new_n452_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n453_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z20 = ~x46 & new_n455_ & ~x47;
  assign new_n455_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n458_ & x46 & ~x47 & ~x48) | (new_n457_ & ~x46 & x47 & x48));
  assign new_n457_ = new_n283_ & x49 & x50;
  assign new_n458_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n462_ : new_n461_)) | (new_n460_ & new_n168_ & x46 & ~x47);
  assign new_n460_ = new_n112_ & x50 & ~x51;
  ...
  assign new_n469_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n436_ & ~x49;
  assign z28 = ~x46 & ~new_n472_ & x47;
  assign new_n472_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n474_ & ~x52;
  assign new_n474_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n476_ | (~x48 & (new_n477_ | (new_n478_ & x46))));
  assign new_n476_ = new_n283_ & new_n141_ & x46 & x48 & ~x49;
  assign new_n477_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n478_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & x52 & x51 & ~x50 & new_n434_ & x49;
  assign z32 = ~x47 & ~new_n481_ & x49;
  assign new_n481_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n474_ & ~x52;
  assign z35 = (~new_n484_ & x49) | (~x46 & ~x47 & x48 & new_n486_ & ~x49);
  assign new_n484_ = (~new_n485_ | x46) & (~new_n283_ | ~new_n141_ | ~x46 | x47 | x48);
  assign new_n485_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n486_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n488_ & x52;
  assign new_n488_ = ~x51 & ~x50 & new_n436_ & x49;
  assign z37 = ~x53 & new_n488_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n436_ & x49;
  assign z39 = ~x46 & ~x47 & new_n492_ & x48;
  assign new_n492_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n494_ & ~x51) | (~x46 & new_n495_ & x47));
  assign new_n494_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n495_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((new_n498_ & x46 & ~x47 & ~x48) | (~x46 & new_n497_ & x47));
  assign new_n497_ = ~x49 & new_n140_ & x51;
  assign new_n498_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n434_ & x49;
  assign z44 = ~x46 & new_n501_ & ~x47;
  assign new_n501_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n507_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
  assign new_n507_ = ~new_n508_ & ~x50;
  assign new_n508_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z08 = 1'b0;
  assign z09 = 1'b0;
  assign z12 = 1'b0;
  assign z19 = 1'b0;
