...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n300_, new_n303_, new_n305_, new_n307_, new_n310_, new_n312_,
    new_n314_, new_n315_, new_n316_, new_n318_, new_n321_, new_n323_,
    new_n324_, new_n325_, new_n327_, new_n331_, new_n333_, new_n334_,
    new_n336_, new_n342_, new_n343_;
  ...
  assign z17 = ~x47 & new_n285_ & ~x49;
  assign new_n285_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  ...
  assign z25 = ~x46 & new_n305_ & ~x47;
  assign new_n305_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n307_ & x52;
  assign new_n307_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n283_ & ~x49;
  assign z28 = ~x46 & ~new_n310_ & x47;
  assign new_n310_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n312_ & ~x52;
  assign new_n312_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n314_ | (~x48 & (new_n315_ | (new_n316_ & x46))));
  assign new_n314_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  ...
  assign z35 = (~x46 & new_n325_ & ~x47) | (x49 & (new_n323_ | (new_n324_ & ~x46)));
  assign new_n323_ = new_n296_ & new_n196_ & ~x50 & x51;
  assign new_n324_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n325_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n327_ & x52;
  assign new_n327_ = ~x51 & ~x50 & new_n283_ & x49;
  ...
  assign z41 = ~x50 & (new_n336_ | (new_n296_ & new_n112_ & x49 & ~x51));
  assign new_n336_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  ...
  assign z49 = (~x48 & (new_n342_ | (new_n214_ & ~x46 & x47 & ~x49))) | (new_n214_ & x48 & ~x49 & x46 & ~x47);
  assign new_n342_ = ~new_n343_ & ~x50;
  assign new_n343_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
