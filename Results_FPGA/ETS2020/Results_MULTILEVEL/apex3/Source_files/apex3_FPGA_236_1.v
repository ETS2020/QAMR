// Benchmark "FAU" written by ABC on Wed Aug  5 13:58:15 2020
...
module FAU ( 
  ...
  assign new_n377_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  ...
  assign new_n390_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n391_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n392_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
