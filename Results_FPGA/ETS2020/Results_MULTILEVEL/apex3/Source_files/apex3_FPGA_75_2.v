...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n373_, new_n375_, new_n376_, new_n378_, new_n381_, new_n383_,
    new_n385_, new_n387_, new_n388_, new_n389_, new_n390_, new_n392_,
    new_n396_, new_n397_, new_n400_, new_n402_;
  ...
  assign z16 = (~new_n362_ & ~x48) | (new_n365_ & x48 & x49 & ~x46 & x47);
  assign new_n362_ = (~new_n363_ | x49) & (x46 | ~x47 | ~new_n364_ | ~x49);
  assign new_n363_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n364_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n365_ = x52 & ~x53 & x50 & ~x51;
  assign z17 = ~x47 & new_n367_ & ~x49;
  assign new_n367_ = x52 & ((~x46 & ~x48 & x51 & (~x50 ^ ~x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z19 = x46 ? (~x47 & new_n371_ & ~x48) : ~new_n369_;
  assign new_n369_ = (new_n370_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n370_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n371_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  ...
  assign new_n375_ = new_n137_ & ~x49 & ~x50;
  assign new_n376_ = x52 & ~x53 & x49 & x50;
  assign z25 = ~x46 & new_n378_ & ~x47;
  assign new_n378_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n360_ & ~x49;
  assign z28 = ~x46 & ~new_n381_ & x47;
  assign new_n381_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n383_ & x49;
  assign new_n383_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n385_ & x47;
  assign new_n385_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n387_ & x49) | (~x46 & ~x47 & x48 & new_n390_ & ~x49);
  assign new_n387_ = (~new_n389_ | x46) & (~new_n388_ | ~x46 | x47 | x48);
  assign new_n388_ = ~x50 & x51 & x52 & ~x53;
  assign new_n389_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
