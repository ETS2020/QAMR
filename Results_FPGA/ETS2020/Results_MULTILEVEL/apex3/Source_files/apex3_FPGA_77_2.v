...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n379_, new_n381_, new_n382_, new_n384_, new_n386_, new_n388_,
  ...
  assign z11 = (~x46 & new_n355_ & x47) | (~x47 & (new_n352_ | (~new_n354_ & x51)));
  assign new_n352_ = new_n353_ & ~x46 & ~x48 & ~x49;
  assign new_n353_ = new_n163_ & x50 & ~x51;
  ...
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n359_ & x49;
  assign new_n359_ = x48 & ~x46 & ~x47;
  assign z15 = x50 ? ~new_n361_ : (x46 ? new_n366_ : ~new_n365_);
  assign new_n361_ = ~new_n364_ & (x47 | ((new_n362_ | ~x52) & (~new_n363_ | ~x46)));
  ...
  assign new_n364_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n365_ = x47 ? ((~x51 | x52 | ~x48 | x49) & (~x49 | x51 | ~x52 | x53)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n366_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n368_ & ~x48) | (new_n371_ & x48 & x49 & ~x46 & x47);
  assign new_n368_ = (~new_n369_ | x49) & (x46 | ~x47 | ~new_n370_ | ~x49);
  assign new_n369_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n370_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  ...
  assign new_n395_ = ~x51 & ~x50 & new_n359_ & x49;
  assign z37 = ~x53 & new_n395_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n359_ & x49;
  ...
  assign z49 = (~x48 & (new_n409_ | (new_n353_ & ~x46 & x47 & ~x49))) | (new_n353_ & x46 & ~x47 & x48 & ~x49);
