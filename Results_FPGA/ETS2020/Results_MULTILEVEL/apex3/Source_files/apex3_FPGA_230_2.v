// Benchmark "FAU" written by ABC on Wed Aug  5 13:58:05 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n390_, new_n392_, new_n395_, new_n397_, new_n399_, new_n401_,
    new_n405_, new_n407_, new_n408_, new_n411_, new_n413_;
  ...
  assign z09 = ~x46 & new_n350_ & ~x51;
  assign new_n350_ = x53 & ((x47 & x48 & x49 & x50 & x52) | (~x47 & ~x48 & ~x49 & ~x50 & ~x52));
  assign z10 = ~x46 & ~new_n352_ & ~x49;
  assign new_n352_ = (x47 | ((x48 | ~x50 | x51 | ~x52 | ~x53) & (x50 | ~x51 | (x48 ? (x52 ^ ~x53) : (x52 | x53))))) & (~x47 | x48 | x50 | ~x51 | ~x52 | x53);
  assign z11 = (~x46 & new_n356_ & x47) | (~x47 & (new_n354_ | (~new_n355_ & x51)));
  assign new_n354_ = new_n163_ & x50 & ~x51 & ~x46 & ~x48 & ~x49;
  assign new_n355_ = (x48 | (x46 ? ((~x52 | ~x53 | ~x49 | x50) & (x49 | ~x50 | x52 | x53)) : (x49 | x53 | (~x50 ^ ~x52)))) & (x46 | ~x48 | x49 | x50 | (x52 ^ ~x53));
  assign new_n356_ = ~x48 & x52 & ~x53 & (x49 ? (x50 & ~x51) : (~x50 & x51));
  assign z12 = ~x46 & ~new_n358_ & x47;
  assign new_n358_ = (~x53 | (x49 ? (x48 ? ((x51 | x52) & (x50 | ~x51 | ~x52)) : (~x50 | ~x51)) : ((x51 | ~x52 | ~x48 | x50) & (~x51 | x52 | x48 | ~x50)))) & (x48 | ~x49 | x53 | (x50 ? (x51 | x52) : (x51 & (~x51 | ~x52))));
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n360_ & ~x49;
  assign new_n360_ = ~x48 & ~x46 & ~x47;
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n362_ & x49;
  assign new_n362_ = x48 & ~x46 & ~x47;
  assign z15 = x50 ? ~new_n364_ : (x46 ? new_n369_ : ~new_n368_);
  assign new_n364_ = ~new_n367_ & (x47 | ((new_n365_ | ~x52) & (~new_n366_ | ~x46)));
  assign new_n365_ = (~x51 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n366_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n367_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n368_ = x47 ? ((~x51 | x52 | ~x48 | x49) & (~x49 | x51 | ~x52 | x53)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n369_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n371_ & ~x48) | (new_n374_ & x48 & x49 & ~x46 & x47);
  assign new_n371_ = (~new_n372_ | x49) & (x46 | ~x47 | ~new_n373_ | ~x49);
  assign new_n372_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n373_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n374_ = x52 & ~x53 & x50 & ~x51;
  assign z17 = ~x47 & new_n376_ & ~x49;
  assign new_n376_ = x52 & ((~x46 & ~x48 & x51 & (~x50 ^ ~x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n378_ & ~x47) : (x47 & new_n379_ & ~x49);
  assign new_n378_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n379_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & new_n383_ & ~x48) : ~new_n381_;
  assign new_n381_ = (new_n382_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n382_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n383_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n385_ & ~x47;
  assign new_n385_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n387_ & x46 & ~x47 & ~x48) | (new_n388_ & ~x46 & x47 & x48));
  assign new_n387_ = new_n137_ & ~x49 & ~x50;
  assign new_n388_ = x52 & ~x53 & x49 & x50;
  assign z24 = ~x48 & new_n390_ & x49;
  assign new_n390_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n392_ & ~x47;
  assign new_n392_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  ...
  assign z36 = x53 & new_n401_ & x52;
  assign new_n401_ = ~x51 & ~x50 & new_n362_ & x49;
  assign z37 = ~x53 & new_n401_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n362_ & x49;
  assign z39 = ~x46 & ~x47 & new_n405_ & x48;
  assign new_n405_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n407_ & ~x51) | (~x46 & new_n408_ & x47));
  assign new_n407_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n408_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n360_ & x49;
  assign z44 = ~x46 & new_n411_ & ~x47;
  assign new_n411_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
  assign z48 = ~x53 & ~x52 & x51 & new_n413_ & ~x50;
  assign new_n413_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
  assign z22 = 1'b0;
