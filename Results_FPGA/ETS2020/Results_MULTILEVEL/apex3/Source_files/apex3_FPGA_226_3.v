// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:59 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n460_, new_n463_, new_n465_, new_n467_, new_n470_, new_n472_,
    new_n474_, new_n475_, new_n476_, new_n479_, new_n482_, new_n484_,
  ...
  assign z15 = x50 ? ~new_n436_ : (x46 ? new_n441_ : ~new_n440_);
  assign new_n436_ = ~new_n437_ & (x47 | ((new_n438_ | ~x52) & (~new_n439_ | ~x46)));
  assign new_n437_ = new_n283_ & x51 & ~x46 & x48 & ~x49;
  ...
  assign new_n440_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n441_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  ...
  assign new_n446_ = new_n283_ & x50 & ~x51;
  ...
  assign new_n450_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n451_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z20 = ~x46 & new_n453_ & ~x47;
  assign new_n453_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n456_ & x46 & ~x47 & ~x48) | (new_n455_ & ~x46 & x47 & x48));
  assign new_n455_ = new_n283_ & x49 & x50;
  assign new_n456_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n460_ : new_n459_)) | (new_n458_ & new_n168_ & x46 & ~x47);
  ...
  assign new_n470_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n472_ & ~x52;
  assign new_n472_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n474_ | (~x48 & (new_n475_ | (new_n476_ & x46))));
  assign new_n474_ = new_n283_ & new_n141_ & x46 & x48 & ~x49;
  assign new_n475_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  ...
  assign new_n488_ = ~x51 & ~x50 & new_n434_ & x49;
