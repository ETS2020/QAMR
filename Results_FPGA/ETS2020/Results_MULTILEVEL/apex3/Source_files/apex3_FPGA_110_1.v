...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n403_, new_n407_, new_n411_, new_n413_, new_n414_;
  ...
  assign z20 = ~x46 & new_n374_ & ~x47;
  assign new_n374_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n377_ : new_n376_)) | (new_n378_ & new_n159_ & x46 & ~x47);
  assign new_n376_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n377_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  ...
  assign new_n387_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
