// Benchmark "FAU" written by ABC on Wed Aug  5 13:54:13 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n400_, new_n401_, new_n403_, new_n404_, new_n408_, new_n412_,
    new_n414_, new_n415_;
  ...
  assign new_n358_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n360_ & ~x47) : (x47 & new_n361_ & ~x49);
  assign new_n360_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n361_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? new_n364_ : (new_n363_ | (~new_n366_ & ~x49));
  assign new_n363_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n364_ = ~x47 & ~x48 & x49 & ~new_n365_ & ~x53;
  assign new_n365_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n366_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n368_ & ~x47;
  assign new_n368_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n371_ : new_n370_)) | (new_n372_ & new_n159_ & x46 & ~x47);
  assign new_n370_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n371_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n372_ = ~x52 & ~x53 & x50 & ~x51;
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n251_ & x51;
  assign z24 = ~x48 & new_n375_ & x49;
  assign new_n375_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z26 = ~x51 & ~new_n377_ & x52;
  assign new_n377_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z28 = ~x46 & ~new_n379_ & x47;
  assign new_n379_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n381_ & ~x52;
  assign new_n381_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n383_ | (~x48 & (new_n384_ | (new_n385_ & x46))));
  assign new_n383_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n384_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n385_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign z33 = ~x53 & new_n381_ & ~x52;
  assign z34 = ~x46 & new_n392_ & x47;
  assign new_n392_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n394_ & x49) | (~x46 & ~x47 & x48 & new_n396_ & ~x49);
  assign new_n394_ = (~new_n395_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n395_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n396_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  ...
  assign new_n401_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n403_ & x47) | (new_n404_ & x46 & ~x47 & ~x48));
  assign new_n403_ = ~x49 & new_n139_ & x51;
  assign new_n404_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n387_ & x52;
  assign z43 = x53 & new_n387_ & ~x52;
  assign z44 = ~x46 & new_n408_ & ~x47;
  assign new_n408_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n381_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n112_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n412_ & ~x50;
  assign new_n412_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n414_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n414_ = ~new_n415_ & ~x50;
  assign new_n415_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
