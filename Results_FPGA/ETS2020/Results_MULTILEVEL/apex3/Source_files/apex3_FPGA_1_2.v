...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n379_, new_n381_, new_n384_, new_n386_, new_n388_, new_n390_,
    new_n394_, new_n395_, new_n398_, new_n400_;
  ...
  assign new_n395_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n356_ & x49;
  assign z44 = ~x46 & new_n398_ & ~x47;
  assign new_n398_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
