// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:25 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n376_, new_n378_, new_n380_, new_n382_, new_n386_, new_n387_,
    new_n390_, new_n392_;
  ...
  assign z19 = x46 ? (~x47 & new_n366_ & ~x48) : ~new_n364_;
  assign new_n364_ = (new_n365_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n365_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n366_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n368_ & ~x47;
  assign new_n368_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n370_ & x46 & ~x47 & ~x48) | (new_n371_ & ~x46 & x47 & x48));
  assign new_n370_ = new_n137_ & ~x49 & ~x50;
  assign new_n371_ = x52 & ~x53 & x49 & x50;
  ...
  assign new_n378_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n380_ & x47;
  assign new_n380_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n382_ & x52;
  assign new_n382_ = ~x51 & ~x50 & new_n360_ & x49;
  assign z37 = ~x53 & new_n382_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n360_ & x49;
  assign z40 = ~x52 & ((~new_n386_ & ~x51) | (~x46 & new_n387_ & x47));
  assign new_n386_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n387_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z44 = ~x46 & new_n390_ & ~x47;
  assign new_n390_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
  assign z48 = ~x53 & ~x52 & x51 & new_n392_ & ~x50;
  assign new_n392_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
