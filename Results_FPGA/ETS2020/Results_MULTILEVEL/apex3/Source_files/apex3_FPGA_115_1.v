// Benchmark "FAU" written by ABC on Wed Aug  5 13:54:52 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n385_, new_n388_, new_n390_, new_n391_, new_n392_, new_n394_,
    new_n395_, new_n397_, new_n398_, new_n404_, new_n406_, new_n407_;
  ...
  assign z30 = ~x47 & (new_n379_ | (~x48 & (new_n380_ | (new_n381_ & x46))));
  assign new_n379_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n380_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n381_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n383_ & x52;
  assign new_n383_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z32 = ~x47 & ~new_n385_ & x49;
  assign new_n385_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  ...
  assign new_n390_ = (~new_n391_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n391_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n392_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z40 = ~x52 & ((~new_n394_ & ~x51) | (~x46 & new_n395_ & x47));
  assign new_n394_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n395_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n397_ & x47) | (new_n398_ & x46 & ~x47 & ~x48));
  assign new_n397_ = ~x49 & new_n139_ & x51;
  assign new_n398_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n383_ & x52;
  assign z43 = x53 & new_n383_ & ~x52;
