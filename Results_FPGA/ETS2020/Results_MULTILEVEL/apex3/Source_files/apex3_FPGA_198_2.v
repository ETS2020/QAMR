// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:11 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n401_, new_n403_, new_n407_, new_n410_, new_n412_, new_n414_,
    new_n415_;
  ...
  assign z11 = (~x46 & new_n361_ & x47) | (~x47 & (new_n358_ | (~new_n360_ & x51)));
  assign new_n358_ = new_n359_ & ~x46 & ~x48 & ~x49;
  assign new_n359_ = new_n163_ & x50 & ~x51;
  assign new_n360_ = (x48 | (x46 ? ((~x52 | ~x53 | ~x49 | x50) & (x49 | ~x50 | x52 | x53)) : (x49 | x53 | (~x50 ^ ~x52)))) & (x46 | ~x48 | x49 | x50 | (x52 ^ ~x53));
  assign new_n361_ = ~x48 & x52 & ~x53 & (x49 ? (x50 & ~x51) : (~x50 & x51));
  assign z12 = ~x46 & ~new_n363_ & x47;
  assign new_n363_ = (~x53 | (x49 ? (x48 ? ((x51 | x52) & (x50 | ~x51 | ~x52)) : (~x50 | ~x51)) : ((x51 | ~x52 | ~x48 | x50) & (~x51 | x52 | x48 | ~x50)))) & (x48 | ~x49 | x53 | (x50 ? (x51 | x52) : (x51 & (~x51 | ~x52))));
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n365_ & ~x49;
  assign new_n365_ = ~x48 & ~x46 & ~x47;
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n367_ & x49;
  assign new_n367_ = x48 & ~x46 & ~x47;
  assign z15 = x50 ? ~new_n369_ : (x46 ? new_n374_ : ~new_n373_);
  assign new_n369_ = ~new_n372_ & (x47 | ((new_n370_ | ~x52) & (~new_n371_ | ~x46)));
  assign new_n370_ = (~x51 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n371_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n372_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n373_ = x47 ? ((~x51 | x52 | ~x48 | x49) & (~x49 | x51 | ~x52 | x53)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n374_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n376_ & ~x48) | (new_n379_ & x48 & x49 & ~x46 & x47);
  assign new_n376_ = (~new_n377_ | x49) & (x46 | ~x47 | ~new_n378_ | ~x49);
  assign new_n377_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n378_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  ...
  assign new_n403_ = ~x51 & ~x50 & new_n367_ & x49;
  assign z37 = ~x53 & new_n403_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n367_ & x49;
  assign z39 = ~x46 & ~x47 & new_n407_ & x48;
  assign new_n407_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n365_ & x49;
  ...
  assign z49 = (~x48 & (new_n414_ | (new_n359_ & ~x46 & x47 & ~x49))) | (new_n359_ & x46 & ~x47 & x48 & ~x49);
  assign new_n414_ = ~new_n415_ & ~x50;
  assign new_n415_ = (x47 | ((~x46 | ~x49 | ~x52 | (~x51 ^ x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z18 = 1'b0;
  assign z22 = 1'b0;
