...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n354_, new_n356_, new_n358_, new_n360_, new_n362_, new_n363_,
    new_n364_, new_n365_, new_n366_, new_n367_, new_n369_, new_n371_,
    new_n372_, new_n374_, new_n375_, new_n376_, new_n378_, new_n380_,
    new_n381_, new_n383_, new_n385_, new_n387_, new_n390_, new_n392_,
    new_n394_, new_n396_, new_n400_, new_n402_, new_n403_, new_n406_,
    new_n408_;
  ...
  assign new_n350_ = (x47 | ((x48 | ~x50 | x51 | ~x52 | ~x53) & (x50 | ~x51 | (x48 ? (x52 ^ ~x53) : (x52 | x53))))) & (~x47 | x48 | x50 | ~x51 | ~x52 | x53);
  assign z11 = (~x46 & new_n354_ & x47) | (~x47 & (new_n352_ | (~new_n353_ & x51)));
  assign new_n352_ = new_n163_ & x50 & ~x51 & ~x46 & ~x48 & ~x49;
  assign new_n353_ = (x48 | (x46 ? ((~x52 | ~x53 | ~x49 | x50) & (x49 | ~x50 | x52 | x53)) : (x49 | x53 | (~x50 ^ ~x52)))) & (x46 | ~x48 | x49 | x50 | (x52 ^ ~x53));
  ...
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n358_ & ~x49;
  assign new_n358_ = ~x48 & ~x46 & ~x47;
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n360_ & x49;
  assign new_n360_ = x48 & ~x46 & ~x47;
  assign z15 = x50 ? ~new_n362_ : (x46 ? new_n367_ : ~new_n366_);
  assign new_n362_ = ~new_n365_ & (x47 | ((new_n363_ | ~x52) & (~new_n364_ | ~x46)));
  assign new_n363_ = (~x51 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n364_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n365_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n366_ = x47 ? ((~x51 | x52 | ~x48 | x49) & (~x49 | x51 | ~x52 | x53)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n367_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z17 = ~x47 & new_n369_ & ~x49;
  assign new_n369_ = x52 & ((~x46 & ~x48 & x51 & (~x50 ^ ~x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n371_ & ~x47) : (x47 & new_n372_ & ~x49);
  assign new_n371_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n372_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & new_n376_ & ~x48) : ~new_n374_;
  assign new_n374_ = (new_n375_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n375_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n376_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n378_ & ~x47;
  assign new_n378_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n380_ & x46 & ~x47 & ~x48) | (new_n381_ & ~x46 & x47 & x48));
  assign new_n380_ = new_n137_ & ~x49 & ~x50;
  assign new_n381_ = x52 & ~x53 & x49 & x50;
  ...
  assign new_n387_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n360_ & ~x49;
  assign z28 = ~x46 & ~new_n390_ & x47;
  assign new_n390_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n392_ & x49;
  assign new_n392_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n394_ & x47;
  assign new_n394_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n396_ & x52;
  assign new_n396_ = ~x51 & ~x50 & new_n360_ & x49;
  assign z37 = ~x53 & new_n396_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n360_ & x49;
  assign z39 = ~x46 & ~x47 & new_n400_ & x48;
  assign new_n400_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n402_ & ~x51) | (~x46 & new_n403_ & x47));
  assign new_n402_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n403_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z44 = ~x46 & new_n406_ & ~x47;
  assign new_n406_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
