// Benchmark "FAU" written by ABC on Wed Aug  5 13:56:08 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n477_, new_n479_, new_n480_, new_n481_, new_n483_, new_n487_,
    new_n489_, new_n490_, new_n492_, new_n493_, new_n496_, new_n500_,
    new_n502_, new_n503_;
  ...
  assign z21 = x51 & ((new_n453_ & x46 & ~x47 & ~x48) | (new_n452_ & ~x46 & x47 & x48));
  assign new_n452_ = new_n283_ & x49 & x50;
  assign new_n453_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n457_ : new_n456_)) | (new_n455_ & new_n168_ & x46 & ~x47);
  assign new_n455_ = new_n112_ & x50 & ~x51;
  ...
  assign new_n465_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n467_ & ~x52;
  assign new_n467_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n469_ | (~x48 & (new_n470_ | (new_n471_ & x46))));
  assign new_n469_ = new_n283_ & new_n141_ & x46 & x48 & ~x49;
  assign new_n470_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n471_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & x52 & x51 & ~x50 & new_n434_ & x49;
  assign z32 = ~x47 & ~new_n474_ & x49;
  assign new_n474_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n467_ & ~x52;
  assign z34 = ~x46 & new_n477_ & x47;
  assign new_n477_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n479_ & x49) | (~x46 & ~x47 & x48 & new_n481_ & ~x49);
  assign new_n479_ = (~new_n480_ | x46) & (~new_n283_ | ~new_n141_ | ~x46 | x47 | x48);
  assign new_n480_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n481_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n483_ & x52;
  assign new_n483_ = ~x51 & ~x50 & new_n436_ & x49;
  ...
  assign z40 = ~x52 & ((~new_n489_ & ~x51) | (~x46 & new_n490_ & x47));
  assign new_n489_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n490_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((new_n493_ & x46 & ~x47 & ~x48) | (~x46 & new_n492_ & x47));
  assign new_n492_ = ~x49 & new_n140_ & x51;
  assign new_n493_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n434_ & x49;
  assign z44 = ~x46 & new_n496_ & ~x47;
  assign new_n496_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n502_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
  assign new_n502_ = ~new_n503_ & ~x50;
