// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:13 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n308_, new_n310_, new_n312_, new_n315_, new_n317_, new_n318_,
    new_n319_, new_n321_, new_n324_, new_n326_, new_n327_, new_n328_,
    new_n330_, new_n334_, new_n336_, new_n337_, new_n339_, new_n343_,
    new_n347_, new_n348_;
  ...
  assign new_n308_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n310_ & ~x47;
  assign new_n310_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n312_ & x52;
  assign new_n312_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n283_ & ~x49;
  assign z29 = x53 & new_n315_ & ~x52;
  assign new_n315_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n317_ | (~x48 & (new_n318_ | (new_n319_ & x46))));
  assign new_n317_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  assign new_n318_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n319_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n321_ & x52;
  assign new_n321_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z33 = ~x53 & new_n315_ & ~x52;
  assign z34 = ~x46 & new_n324_ & x47;
  assign new_n324_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~x46 & new_n328_ & ~x47) | (x49 & (new_n326_ | (new_n327_ & ~x46)));
  assign new_n326_ = new_n301_ & new_n196_ & ~x50 & x51;
  assign new_n327_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n328_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n330_ & x52;
  assign new_n330_ = ~x51 & ~x50 & new_n283_ & x49;
  assign z37 = ~x53 & new_n330_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n283_ & x49;
  assign z39 = ~x46 & ~x47 & new_n334_ & x48;
  assign new_n334_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n336_ & ~x51) | (~x46 & new_n337_ & x47));
  assign new_n336_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n337_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & (new_n339_ | (new_n301_ & new_n112_ & x49 & ~x51));
  assign new_n339_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n321_ & x52;
  assign z43 = x53 & new_n321_ & ~x52;
  assign z44 = ~x46 & new_n343_ & ~x47;
  assign new_n343_ = x48 & ~x49 & ((x50 & (x51 ^ x52)) | (~x50 & ~x51 & x52 & x53));
  assign z46 = x53 & new_n315_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n111_ & ~x50;
  assign z49 = (~x48 & (new_n347_ | (new_n214_ & ~x46 & x47 & ~x49))) | (new_n214_ & x48 & ~x49 & x46 & ~x47);
  assign new_n347_ = ~new_n348_ & ~x50;
  assign new_n348_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
