...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n381_, new_n383_, new_n386_, new_n388_, new_n390_, new_n394_,
  ...
  assign new_n369_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n370_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & new_n374_ & ~x48) : ~new_n372_;
  assign new_n372_ = (new_n373_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n373_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n374_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n376_ & ~x47;
  assign new_n376_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n378_ & x46 & ~x47 & ~x48) | (new_n379_ & ~x46 & x47 & x48));
  assign new_n378_ = new_n137_ & ~x49 & ~x50;
  assign new_n379_ = x52 & ~x53 & x49 & x50;
  assign z24 = ~x48 & new_n381_ & x49;
  assign new_n381_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  ...
  assign z36 = x53 & new_n390_ & x52;
  assign new_n390_ = ~x51 & ~x50 & new_n358_ & x49;
  assign z37 = ~x53 & new_n390_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z39 = ~x46 & ~x47 & new_n394_ & x48;
  assign new_n394_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
