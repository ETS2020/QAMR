...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n391_, new_n392_, new_n393_, new_n394_, new_n396_, new_n400_,
    new_n402_, new_n403_, new_n405_, new_n407_, new_n409_;
  ...
  assign new_n356_ = ~new_n359_ & (x47 | ((new_n357_ | ~x52) & (~new_n358_ | ~x46)));
  assign new_n357_ = (~x51 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n358_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n359_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n360_ = x47 ? ((~x51 | x52 | ~x48 | x49) & (~x49 | x51 | ~x52 | x53)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n361_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n363_ & ~x48) | (new_n366_ & x48 & x49 & ~x46 & x47);
  assign new_n363_ = (~new_n364_ | x49) & (x46 | ~x47 | ~new_n365_ | ~x49);
  assign new_n364_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  ...
  assign new_n370_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n371_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & new_n375_ & ~x48) : ~new_n373_;
  assign new_n373_ = (new_n374_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n374_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n375_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  ...
  assign new_n379_ = new_n137_ & ~x49 & ~x50;
  assign new_n380_ = x52 & ~x53 & x49 & x50;
  ...
  assign z35 = (~new_n391_ & x49) | (~x46 & ~x47 & x48 & new_n394_ & ~x49);
  assign new_n391_ = (~new_n393_ | x46) & (~new_n392_ | ~x46 | x47 | x48);
  assign new_n392_ = ~x50 & x51 & x52 & ~x53;
  assign new_n393_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n394_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n396_ & x52;
  assign new_n396_ = ~x51 & ~x50 & new_n354_ & x49;
