// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:58 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n368_, new_n370_, new_n372_, new_n374_, new_n376_, new_n377_,
    new_n378_, new_n380_, new_n382_, new_n385_, new_n387_, new_n388_,
    new_n389_, new_n391_, new_n393_, new_n394_, new_n400_, new_n402_,
    new_n403_;
  ...
  assign z19 = x46 ? new_n359_ : (new_n358_ | (~new_n361_ & ~x49));
  assign new_n358_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n359_ = ~x47 & ~x48 & x49 & ~new_n360_ & ~x53;
  assign new_n360_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  ...
  assign z28 = ~x46 & ~new_n372_ & x47;
  assign new_n372_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n374_ & ~x52;
  assign new_n374_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n376_ | (~x48 & (new_n377_ | (new_n378_ & x46))));
  assign new_n376_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n377_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n378_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n380_ & x52;
  ...
  assign z33 = ~x53 & new_n374_ & ~x52;
  assign z34 = ~x46 & new_n385_ & x47;
  assign new_n385_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n387_ & x49) | (~x46 & ~x47 & x48 & new_n389_ & ~x49);
  assign new_n387_ = (~new_n388_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n388_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n389_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z39 = ~x46 & ~x47 & new_n391_ & x48;
  assign new_n391_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & ((~x46 & new_n393_ & x47) | (new_n394_ & x46 & ~x47 & ~x48));
  assign new_n393_ = ~x49 & new_n139_ & x51;
  assign new_n394_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n380_ & x52;
  assign z43 = x53 & new_n380_ & ~x52;
  assign z46 = x53 & new_n374_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n112_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n400_ & ~x50;
  assign new_n400_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n402_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n402_ = ~new_n403_ & ~x50;
  assign new_n403_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
