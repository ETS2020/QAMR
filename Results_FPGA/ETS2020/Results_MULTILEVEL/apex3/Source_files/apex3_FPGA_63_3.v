// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:23 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n495_, new_n497_, new_n498_, new_n500_, new_n501_, new_n504_,
  ...
  assign z35 = (~new_n487_ & x49) | (~x46 & ~x47 & x48 & new_n489_ & ~x49);
  assign new_n487_ = (~new_n488_ | x46) & (~new_n283_ | ~new_n141_ | ~x46 | x47 | x48);
  assign new_n488_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n489_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n491_ & x52;
  assign new_n491_ = ~x51 & ~x50 & new_n440_ & x49;
  ...
  assign z40 = ~x52 & ((~new_n497_ & ~x51) | (~x46 & new_n498_ & x47));
  assign new_n497_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n498_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((new_n501_ & x46 & ~x47 & ~x48) | (~x46 & new_n500_ & x47));
  assign new_n500_ = ~x49 & new_n140_ & x51;
  assign new_n501_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n438_ & x49;
  assign z44 = ~x46 & new_n504_ & ~x47;
  assign new_n504_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n510_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
