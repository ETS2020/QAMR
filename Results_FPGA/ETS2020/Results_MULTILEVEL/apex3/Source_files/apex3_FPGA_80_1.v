// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:51 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n367_, new_n368_, new_n371_, new_n373_, new_n375_, new_n377_,
    new_n378_, new_n379_, new_n381_, new_n383_, new_n386_, new_n387_,
  ...
  assign new_n356_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n357_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? new_n360_ : (new_n359_ | (~new_n362_ & ~x49));
  assign new_n359_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n360_ = ~x47 & ~x48 & x49 & ~new_n361_ & ~x53;
  assign new_n361_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n362_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n364_ & ~x47;
  assign new_n364_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n367_ : new_n366_)) | (new_n368_ & new_n159_ & x46 & ~x47);
  assign new_n366_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n367_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  ...
  assign z28 = ~x46 & ~new_n373_ & x47;
  assign new_n373_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n375_ & ~x52;
  assign new_n375_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n377_ | (~x48 & (new_n378_ | (new_n379_ & x46))));
  assign new_n377_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n378_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n379_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n381_ & x52;
  assign new_n381_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z32 = ~x47 & ~new_n383_ & x49;
  assign new_n383_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n375_ & ~x52;
  assign z35 = (~new_n386_ & x49) | (~x46 & ~x47 & x48 & new_n388_ & ~x49);
  assign new_n386_ = (~new_n387_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n387_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n388_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z39 = ~x46 & ~x47 & new_n390_ & x48;
  assign new_n390_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n392_ & ~x51) | (~x46 & new_n393_ & x47));
  assign new_n392_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n393_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n395_ & x47) | (new_n396_ & x46 & ~x47 & ~x48));
  assign new_n395_ = ~x49 & new_n139_ & x51;
  assign new_n396_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n381_ & x52;
  ...
  assign z49 = (~x48 & (new_n404_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n404_ = ~new_n405_ & ~x50;
  assign new_n405_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z14 = 1'b0;
