// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:01 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n377_, new_n379_, new_n381_, new_n382_, new_n383_, new_n385_,
    new_n387_, new_n390_, new_n392_, new_n393_, new_n394_, new_n396_,
    new_n398_, new_n399_, new_n405_, new_n407_, new_n408_;
  ...
  assign z19 = x46 ? (~x47 & ~x48 & new_n362_ & x49) : ~new_n359_;
  assign new_n359_ = (new_n361_ | x49) & (~new_n360_ | ~new_n209_ | x47 | x48 | ~x49);
  assign new_n360_ = ~x52 & x53;
  assign new_n361_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n362_ = ~x53 & (x50 ? (~x51 & ~new_n363_ & x52) : (x51 & ~x52));
  assign new_n363_ = ~x10 & ~x11 & ~x25 & (x10 | x11 | x25);
  assign z20 = ~x46 & new_n365_ & ~x47;
  assign new_n365_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & (new_n367_ | (new_n368_ & new_n360_ & ~x49 & ~x50));
  assign new_n367_ = new_n251_ & x49 & x50 & ~x46 & x47 & x48;
  ...
  assign new_n381_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  assign new_n382_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  ...
  assign new_n392_ = new_n368_ & new_n251_ & ~x50 & x51;
  assign new_n393_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n394_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  ...
  assign new_n398_ = ~x49 & new_n139_ & x51;
  assign new_n399_ = ~x52 & ~x53 & x49 & ~x51;
  ...
  assign z49 = (~x48 & (new_n407_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n407_ = ~new_n408_ & ~x50;
  assign new_n408_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z12 = 1'b0;
  assign z14 = 1'b0;
