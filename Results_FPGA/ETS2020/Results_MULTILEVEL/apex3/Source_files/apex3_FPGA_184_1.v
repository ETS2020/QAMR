...
module FAU ( 
  ...
  assign z19 = x46 ? (~x47 & ~x48 & new_n364_ & x49) : ~new_n361_;
  assign new_n361_ = (new_n363_ | x49) & (~new_n362_ | ~new_n209_ | x47 | x48 | ~x49);
  ...
  assign new_n364_ = ~x53 & (x50 ? (~x51 & ~new_n365_ & x52) : (x51 & ~x52));
  assign new_n365_ = ~x10 & ~x11 & ~x25 & (x10 | x11 | x25);
  assign z20 = ~x46 & new_n367_ & ~x47;
  assign new_n367_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & (new_n369_ | (new_n370_ & new_n362_ & ~x49 & ~x50));
  assign new_n369_ = new_n251_ & x49 & x50 & ~x46 & x47 & x48;
  ...
  assign new_n392_ = new_n370_ & new_n251_ & ~x50 & x51;
  ...
  assign new_n397_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
