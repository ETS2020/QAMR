...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n386_, new_n387_, new_n389_, new_n391_, new_n393_, new_n395_,
    ...
    new_n421_, new_n424_, new_n426_, new_n428_, new_n430_, new_n434_,
    new_n435_, new_n438_, new_n440_;
  ...
  assign new_n383_ = (x47 | ((x48 | ~x50 | x51 | ~x52 | ~x53) & (x50 | ~x51 | (x48 ? (x52 ^ ~x53) : (x52 | x53))))) & (~x51 | ~x52 | x53 | ~x47 | x48 | x50);
  assign z11 = (~x47 & (new_n385_ | (~new_n386_ & x51))) | (~x46 & new_n387_ & x47);
  assign new_n385_ = ~x46 & ~x48 & ~x49 & new_n139_ & x50 & ~x51;
  assign new_n386_ = (x48 | (x46 ? ((x49 | ~x50 | x52 | x53) & (~x49 | x50 | ~x52 | ~x53)) : (x49 | x53 | (~x50 ^ ~x52)))) & (x46 | ~x48 | x49 | x50 | (x52 ^ ~x53));
  ...
  assign z15 = x50 ? ~new_n395_ : (x46 ? new_n400_ : ~new_n399_);
  assign new_n395_ = ~new_n398_ & (x47 | ((~new_n397_ | ~x46) & (new_n396_ | ~x52)));
  assign new_n396_ = (~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n397_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n398_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n399_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n400_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n402_ & ~x48) | (new_n405_ & ~x46 & x47 & x48 & x49);
  ...
  assign new_n405_ = x52 & ~x53 & x50 & ~x51;
  ...
  assign new_n409_ = (new_n410_ | x49) & (~new_n172_ | ~new_n243_ | x47 | x48 | ~x49);
  assign new_n410_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n411_ = ~x53 & (x50 ? (~x51 & ~new_n412_ & x52) : (x51 & ~x52));
  assign new_n412_ = ~x10 & ~x11 & ~x25 & (x10 | x11 | x25);
  ...
  assign new_n416_ = new_n172_ & ~x49 & ~x50;
  assign new_n417_ = x52 & ~x53 & x49 & x50;
  assign z24 = ~x48 & new_n419_ & x49;
  assign new_n419_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  ...
  assign new_n424_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n426_ & x49;
  assign new_n426_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n428_ & x47;
  assign new_n428_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n430_ & x52;
  assign new_n430_ = ~x51 & ~x50 & new_n393_ & x49;
  assign z37 = ~x53 & new_n430_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n393_ & x49;
  assign z40 = ~x52 & ((~new_n434_ & ~x51) | (~x46 & new_n435_ & x47));
  assign new_n434_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n435_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n391_ & x49;
  assign z44 = ~x46 & new_n438_ & ~x47;
  assign new_n438_ = x48 & ~x49 & ((x50 & (x51 ^ x52)) | (~x50 & ~x51 & x52 & x53));
