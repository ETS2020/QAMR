// Benchmark "FAU" written by ABC on Wed Aug  5 13:55:41 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n380_, new_n381_, new_n383_, new_n385_, new_n388_, new_n390_,
    new_n392_, new_n394_, new_n398_, new_n399_, new_n402_, new_n404_;
  ...
  assign new_n388_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  ...
  assign new_n394_ = ~x51 & ~x50 & new_n358_ & x49;
  assign z37 = ~x53 & new_n394_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z40 = ~x52 & ((~new_n398_ & ~x51) | (~x46 & new_n399_ & x47));
  assign new_n398_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n399_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n356_ & x49;
  assign z44 = ~x46 & new_n402_ & ~x47;
  assign new_n402_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
  assign z48 = ~x53 & ~x52 & x51 & new_n404_ & ~x50;
  assign new_n404_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
  assign z09 = 1'b0;
