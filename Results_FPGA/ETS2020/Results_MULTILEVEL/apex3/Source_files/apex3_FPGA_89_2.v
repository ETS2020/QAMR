...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n392_, new_n396_, new_n397_, new_n399_, new_n401_, new_n404_;
  ...
  assign new_n385_ = (x48 | (~new_n387_ & (~x46 | ~new_n388_ | ~x49))) & (~new_n386_ | ~x46 | ~x48 | x49);
  assign new_n386_ = ~x50 & x51 & x52 & ~x53;
  assign new_n387_ = ~x51 & (x46 ? (x49 & (x50 ? (~x52 ^ x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n388_ = ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
