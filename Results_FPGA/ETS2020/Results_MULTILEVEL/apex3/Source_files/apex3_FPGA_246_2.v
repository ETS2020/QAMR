// Benchmark "FAU" written by ABC on Wed Aug  5 13:58:32 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n379_, new_n381_, new_n383_, new_n386_, new_n388_, new_n390_,
    new_n392_, new_n396_, new_n398_, new_n399_, new_n402_, new_n404_;
  ...
  assign z19 = x46 ? new_n374_ : (new_n376_ | (~new_n377_ & ~x49));
  assign new_n374_ = ~x47 & ~x48 & x49 & ~new_n375_ & ~x53;
  assign new_n375_ = x50 ? (x51 | new_n233_ | ~x52) : (~x51 | x52);
  assign new_n376_ = new_n126_ & ~x47 & new_n137_ & new_n210_;
  assign new_n377_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n379_ & ~x47;
  assign new_n379_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  ...
  assign new_n392_ = ~x51 & ~x50 & new_n358_ & x49;
  assign z37 = ~x53 & new_n392_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z39 = ~x46 & ~x47 & new_n396_ & x48;
  assign new_n396_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
