...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n420_, new_n422_, new_n425_, new_n427_, new_n429_, new_n431_,
    new_n435_, new_n437_, new_n438_, new_n441_, new_n443_;
  ...
  assign z11 = (~x47 & (new_n383_ | (~new_n384_ & x51))) | (~x46 & new_n385_ & x47);
  assign new_n383_ = ~x46 & ~x48 & ~x49 & new_n139_ & x50 & ~x51;
  ...
  assign new_n387_ = (~x53 | (x49 ? (x48 ? ((x51 | x52) & (x50 | ~x51 | ~x52)) : (~x50 | ~x51)) : ((x51 | ~x52 | ~x48 | x50) & (~x51 | x52 | x48 | ~x50)))) & (x48 | ~x49 | x53 | (x50 ? (x51 | x52) : (x51 & (~x51 | ~x52))));
  ...
  assign z15 = x50 ? ~new_n393_ : (x46 ? new_n398_ : ~new_n397_);
  assign new_n393_ = ~new_n396_ & (x47 | ((~new_n395_ | ~x46) & (new_n394_ | ~x52)));
  assign new_n394_ = (~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n395_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n396_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n397_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n398_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n400_ & ~x48) | (new_n403_ & ~x46 & x47 & x48 & x49);
  ...
  assign new_n402_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n403_ = x52 & ~x53 & x50 & ~x51;
  assign z17 = ~x47 & new_n405_ & ~x49;
  assign new_n405_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n407_ & ~x47) : (x47 & new_n408_ & ~x49);
  assign new_n407_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n408_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & ~x48 & new_n412_ & x49) : ~new_n410_;
  assign new_n410_ = (new_n411_ | x49) & (~new_n172_ | ~new_n243_ | x47 | x48 | ~x49);
  assign new_n411_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n412_ = ~x53 & (x50 ? (~x51 & ~new_n413_ & x52) : (x51 & ~x52));
  assign new_n413_ = ~x10 & ~x11 & ~x25 & (x10 | x11 | x25);
  ...
  assign new_n417_ = new_n172_ & ~x49 & ~x50;
  ...
  assign new_n425_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n427_ & x49;
  assign new_n427_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n429_ & x47;
  assign new_n429_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n431_ & x52;
  assign new_n431_ = ~x51 & ~x50 & new_n391_ & x49;
  assign z37 = ~x53 & new_n431_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n391_ & x49;
  ...
  assign new_n437_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n438_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n389_ & x49;
