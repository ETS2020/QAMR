...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n462_, new_n463_, new_n466_, new_n468_, new_n470_, new_n473_,
    new_n475_, new_n477_, new_n478_, new_n479_, new_n482_, new_n485_,
    new_n486_, new_n487_, new_n489_, new_n493_, new_n495_, new_n496_,
    new_n498_, new_n499_, new_n502_, new_n506_, new_n508_, new_n509_;
  ...
  assign new_n432_ = new_n329_ & ~x46 & ~x48 & ~x49;
  ...
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n438_ & ~x49;
  ...
  assign new_n443_ = new_n283_ & x51 & ~x46 & x48 & ~x49;
  assign new_n444_ = (~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n445_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n446_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  ...
  assign new_n452_ = new_n283_ & x50 & ~x51;
  ...
  assign z21 = x51 & ((new_n459_ & x46 & ~x47 & ~x48) | (new_n458_ & ~x46 & x47 & x48));
  assign new_n458_ = new_n283_ & x49 & x50;
  assign new_n459_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n463_ : new_n462_)) | (new_n461_ & new_n168_ & x46 & ~x47);
  assign new_n461_ = new_n112_ & x50 & ~x51;
  ...
  assign new_n473_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n475_ & ~x52;
  assign new_n475_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n477_ | (~x48 & (new_n478_ | (new_n479_ & x46))));
  assign new_n477_ = new_n283_ & new_n141_ & x46 & x48 & ~x49;
  ...
  assign new_n496_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((new_n499_ & x46 & ~x47 & ~x48) | (~x46 & new_n498_ & x47));
  assign new_n498_ = ~x49 & new_n140_ & x51;
  assign new_n499_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n438_ & x49;
  assign z44 = ~x46 & new_n502_ & ~x47;
  assign new_n502_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n508_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
