// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:58 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n368_, new_n369_, new_n370_, new_n373_, new_n375_, new_n377_,
    new_n378_, new_n379_, new_n381_, new_n383_, new_n386_, new_n388_,
    new_n389_, new_n390_, new_n392_, new_n394_, new_n395_, new_n399_,
  ...
  assign z22 = (~x46 & (x47 ? new_n369_ : new_n368_)) | (new_n370_ & new_n159_ & x46 & ~x47);
  ...
  assign z24 = ~x48 & new_n373_ & x49;
  assign new_n373_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z29 = x53 & new_n375_ & ~x52;
  assign new_n375_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n377_ | (~x48 & (new_n378_ | (new_n379_ & x46))));
  assign new_n377_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  ...
  assign z35 = (x49 & (new_n388_ | (new_n389_ & ~x46))) | (~x46 & new_n390_ & ~x47);
  assign new_n388_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n389_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n390_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z39 = ~x46 & ~x47 & new_n392_ & x48;
  assign new_n392_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & ((~x46 & new_n394_ & x47) | (new_n395_ & x46 & ~x47 & ~x48));
  assign new_n394_ = ~x49 & new_n139_ & x51;
  assign new_n395_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n381_ & x52;
  assign z43 = x53 & new_n381_ & ~x52;
  assign z44 = ~x46 & new_n399_ & ~x47;
  assign new_n399_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n405_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n405_ = ~new_n406_ & ~x50;
  assign new_n406_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
