// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:14 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n299_, new_n300_, new_n301_, new_n304_, new_n306_, new_n308_,
    new_n311_, new_n313_, new_n314_, new_n315_, new_n317_, new_n320_,
    new_n322_, new_n323_, new_n324_, new_n326_, new_n330_, new_n332_,
    new_n338_, new_n339_;
  ...
  assign z16 = (~new_n283_ & ~x48) | (new_n286_ & ~x46 & x47 & x48 & x49);
  assign new_n283_ = (~new_n284_ | x49) & (x46 | ~x47 | ~new_n285_ | ~x49);
  assign new_n284_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n285_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n286_ = new_n196_ & x50 & ~x51;
  assign z18 = x46 ? (~new_n288_ & ~x47) : (x47 & new_n289_ & ~x49);
  assign new_n288_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n289_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (x23 & x48 & ~x51 & ~x52));
  assign z19 = x46 ? new_n292_ : (new_n291_ | (~new_n294_ & ~x49));
  assign new_n291_ = new_n145_ & ~x50 & ~x51 & ~x47 & ~x48 & x49;
  assign new_n292_ = ~x47 & ~x48 & x49 & ~new_n293_ & ~x53;
  assign new_n293_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n294_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z21 = x51 & (new_n296_ | (new_n297_ & new_n145_ & ~x49 & ~x50));
  assign new_n296_ = new_n196_ & x49 & x50 & ~x46 & x47 & x48;
  assign new_n297_ = x46 & ~x47 & ~x48;
  assign z22 = new_n299_ | (~x46 & (x47 ? new_n301_ : new_n300_));
  assign new_n299_ = new_n112_ & x50 & ~x51 & new_n113_ & ~x48 & x49;
  assign new_n300_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n301_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n196_ & x51;
  assign z24 = ~x48 & new_n304_ & x49;
  assign new_n304_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  ...
  assign z29 = x53 & new_n311_ & ~x52;
  assign new_n311_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n313_ | (~x48 & (new_n314_ | (new_n315_ & x46))));
  assign new_n313_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  assign new_n314_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n315_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n317_ & x52;
  assign new_n317_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z33 = ~x53 & new_n311_ & ~x52;
  assign z34 = ~x46 & new_n320_ & x47;
  assign new_n320_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~x46 & new_n324_ & ~x47) | (x49 & (new_n322_ | (new_n323_ & ~x46)));
  assign new_n322_ = new_n297_ & new_n196_ & ~x50 & x51;
  assign new_n323_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n324_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n326_ & x52;
  assign new_n326_ = ~x51 & ~x50 & new_n281_ & x49;
  ...
  assign z41 = ~x50 & (new_n332_ | (new_n297_ & new_n112_ & x49 & ~x51));
  assign new_n332_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n317_ & x52;
  assign z43 = x53 & new_n317_ & ~x52;
  assign z46 = x53 & new_n311_ & x52;
