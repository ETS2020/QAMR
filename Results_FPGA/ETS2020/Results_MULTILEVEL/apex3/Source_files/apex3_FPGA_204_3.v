// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:22 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n452_, new_n454_, new_n456_, new_n457_, new_n459_, new_n460_,
    new_n461_, new_n464_, new_n466_, new_n468_, new_n471_, new_n473_,
    new_n475_, new_n476_, new_n477_, new_n480_, new_n483_, new_n484_,
    new_n485_, new_n487_, new_n491_, new_n493_, new_n494_, new_n496_,
    new_n497_, new_n500_, new_n504_, new_n506_, new_n507_;
  ...
  assign z20 = ~x46 & new_n454_ & ~x47;
  assign new_n454_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n457_ & x46 & ~x47 & ~x48) | (new_n456_ & ~x46 & x47 & x48));
  assign new_n456_ = new_n283_ & x49 & x50;
  assign new_n457_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n461_ : new_n460_)) | (new_n459_ & new_n168_ & x46 & ~x47);
  assign new_n459_ = new_n112_ & x50 & ~x51;
  assign new_n460_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n461_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  ...
  assign z28 = ~x46 & ~new_n471_ & x47;
  assign new_n471_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n473_ & ~x52;
  assign new_n473_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n475_ | (~x48 & (new_n476_ | (new_n477_ & x46))));
  assign new_n475_ = new_n283_ & new_n141_ & x46 & x48 & ~x49;
  assign new_n476_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n477_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign z35 = (~new_n483_ & x49) | (~x46 & ~x47 & x48 & new_n485_ & ~x49);
  assign new_n483_ = (~new_n484_ | x46) & (~new_n283_ | ~new_n141_ | ~x46 | x47 | x48);
  assign new_n484_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n485_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n487_ & x52;
  assign new_n487_ = ~x51 & ~x50 & new_n438_ & x49;
  ...
  assign z40 = ~x52 & ((~new_n493_ & ~x51) | (~x46 & new_n494_ & x47));
  assign new_n493_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n494_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((new_n497_ & x46 & ~x47 & ~x48) | (~x46 & new_n496_ & x47));
  assign new_n496_ = ~x49 & new_n140_ & x51;
  assign new_n497_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n436_ & x49;
  assign z44 = ~x46 & new_n500_ & ~x47;
  assign new_n500_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n473_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n134_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n504_ & ~x50;
  assign new_n504_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n506_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
  assign new_n506_ = ~new_n507_ & ~x50;
  assign new_n507_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z08 = 1'b0;
  assign z12 = 1'b0;
  assign z18 = 1'b0;
  assign z19 = 1'b0;
