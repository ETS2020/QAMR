// Benchmark "FAU" written by ABC on Wed Aug  5 13:54:05 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n389_, new_n392_, new_n394_, new_n395_, new_n396_, new_n400_,
    new_n404_, new_n406_, new_n407_;
  ...
  assign z19 = x46 ? new_n362_ : (new_n361_ | (~new_n364_ & ~x49));
  assign new_n361_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n362_ = ~x47 & ~x48 & x49 & ~new_n363_ & ~x53;
  assign new_n363_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n364_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n366_ & ~x47;
  assign new_n366_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  ...
  assign new_n383_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  ...
  assign z35 = (x49 & (new_n394_ | (new_n395_ & ~x46))) | (~x46 & new_n396_ & ~x47);
  assign new_n394_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n395_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n396_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z42 = x53 & new_n387_ & x52;
  assign z43 = x53 & new_n387_ & ~x52;
  assign z44 = ~x46 & new_n400_ & ~x47;
  assign new_n400_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n406_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n406_ = ~new_n407_ & ~x50;
  assign new_n407_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
