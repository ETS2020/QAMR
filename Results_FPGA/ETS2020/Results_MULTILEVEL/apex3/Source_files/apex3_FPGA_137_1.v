// Benchmark "FAU" written by ABC on Wed Aug  5 13:55:29 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n398_, new_n399_, new_n403_, new_n407_, new_n409_, new_n410_;
  ...
  assign new_n363_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z19 = x46 ? new_n366_ : (new_n365_ | (~new_n368_ & ~x49));
  assign new_n365_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n366_ = ~x47 & ~x48 & x49 & ~new_n367_ & ~x53;
  assign new_n367_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  ...
  assign z22 = (~x46 & (x47 ? new_n373_ : new_n372_)) | (new_n374_ & new_n159_ & x46 & ~x47);
  assign new_n372_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n373_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n374_ = ~x52 & ~x53 & x50 & ~x51;
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n251_ & x51;
  assign z24 = ~x48 & new_n377_ & x49;
  assign new_n377_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z29 = x53 & new_n379_ & ~x52;
  assign new_n379_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n381_ | (~x48 & (new_n382_ | (new_n383_ & x46))));
  assign new_n381_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  ...
  assign z35 = (~new_n392_ & x49) | (~x46 & ~x47 & x48 & new_n394_ & ~x49);
  assign new_n392_ = (~new_n393_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n393_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n394_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  ...
  assign new_n403_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n409_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n409_ = ~new_n410_ & ~x50;
  assign new_n410_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
