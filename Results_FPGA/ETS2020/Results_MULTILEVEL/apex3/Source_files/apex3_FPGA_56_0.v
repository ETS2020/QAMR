// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:11 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n334_, new_n336_, new_n337_, new_n339_, new_n345_, new_n346_;
  ...
  assign z16 = (~new_n287_ & ~x48) | (new_n290_ & ~x46 & x47 & x48 & x49);
  assign new_n287_ = (~new_n288_ | x49) & (x46 | ~x47 | ~new_n289_ | ~x49);
  assign new_n288_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n289_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n290_ = new_n196_ & x50 & ~x51;
  ...
  assign new_n330_ = ~x51 & ~x50 & new_n285_ & x49;
