// Benchmark "FAU" written by ABC on Wed Aug  5 13:56:55 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n380_, new_n382_, new_n383_, new_n385_, new_n387_, new_n390_,
    new_n392_, new_n394_, new_n396_, new_n400_, new_n401_, new_n404_,
    new_n406_;
  ...
  assign z40 = ~x52 & ((~new_n400_ & ~x51) | (~x46 & new_n401_ & x47));
  assign new_n400_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n401_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z44 = ~x46 & new_n404_ & ~x47;
  assign new_n404_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
  assign z48 = ~x53 & ~x52 & x51 & new_n406_ & ~x50;
  assign new_n406_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z08 = 1'b0;
  assign z09 = 1'b0;
