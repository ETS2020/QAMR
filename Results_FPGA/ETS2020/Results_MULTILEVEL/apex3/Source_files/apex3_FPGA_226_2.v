...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n389_, new_n391_, new_n392_, new_n394_, new_n396_, new_n399_,
    new_n401_, new_n403_, new_n407_, new_n408_, new_n411_, new_n413_;
  ...
  assign z16 = (~new_n375_ & ~x48) | (new_n378_ & x48 & x49 & ~x46 & x47);
  assign new_n375_ = (~new_n376_ | x49) & (x46 | ~x47 | ~new_n377_ | ~x49);
  ...
  assign new_n382_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n383_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & new_n387_ & ~x48) : ~new_n385_;
  assign new_n385_ = (new_n386_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n386_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n387_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  ...
  assign new_n391_ = new_n137_ & ~x49 & ~x50;
  assign new_n392_ = x52 & ~x53 & x49 & x50;
  ...
  assign new_n399_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n401_ & x49;
  assign new_n401_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z36 = x53 & new_n403_ & x52;
  assign new_n403_ = ~x51 & ~x50 & new_n366_ & x49;
