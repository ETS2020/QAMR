// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:40 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n472_, new_n474_, new_n476_, new_n477_, new_n478_, new_n481_,
    new_n484_, new_n485_, new_n486_, new_n488_, new_n492_, new_n493_,
    new_n495_, new_n496_, new_n499_, new_n503_, new_n505_, new_n506_;
  ...
  assign z40 = ~x52 & ((~new_n492_ & ~x51) | (~x46 & new_n493_ & x47));
  assign new_n492_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n493_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((new_n496_ & x46 & ~x47 & ~x48) | (~x46 & new_n495_ & x47));
  assign new_n495_ = ~x49 & new_n140_ & x51;
  assign new_n496_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n436_ & x49;
  assign z44 = ~x46 & new_n499_ & ~x47;
  assign new_n499_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n474_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n134_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n503_ & ~x50;
  assign new_n503_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n505_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
  assign new_n505_ = ~new_n506_ & ~x50;
  assign new_n506_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
  assign z19 = 1'b0;
