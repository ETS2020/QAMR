// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:22 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n383_, new_n385_, new_n387_, new_n388_, new_n389_, new_n391_,
    new_n393_, new_n396_, new_n398_, new_n399_, new_n400_, new_n402_,
    new_n404_, new_n405_, new_n409_, new_n413_, new_n415_, new_n416_;
  ...
  assign new_n383_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n385_ & ~x52;
  assign new_n385_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n387_ | (~x48 & (new_n388_ | (new_n389_ & x46))));
  assign new_n387_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  assign new_n388_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n389_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign new_n398_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n399_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n400_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z39 = ~x46 & ~x47 & new_n402_ & x48;
  assign new_n402_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & ((~x46 & new_n404_ & x47) | (new_n405_ & x46 & ~x47 & ~x48));
  assign new_n404_ = ~x49 & new_n139_ & x51;
  assign new_n405_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n391_ & x52;
  assign z43 = x53 & new_n391_ & ~x52;
  assign z44 = ~x46 & new_n409_ & ~x47;
  assign new_n409_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign new_n416_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z13 = 1'b0;
  assign z14 = 1'b0;
