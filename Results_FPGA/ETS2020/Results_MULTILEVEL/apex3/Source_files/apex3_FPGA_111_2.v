...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n381_, new_n383_, new_n385_, new_n388_, new_n390_, new_n391_,
    new_n392_, new_n393_, new_n395_, new_n397_, new_n399_, new_n403_,
  ...
  assign z30 = ~new_n390_ & ~x47;
  assign new_n390_ = (x48 | (~new_n392_ & (~x46 | ~new_n393_ | ~x49))) & (~new_n391_ | ~x46 | ~x48 | x49);
  assign new_n391_ = ~x50 & x51 & x52 & ~x53;
  assign new_n392_ = ~x51 & (x46 ? (x49 & (x50 ? (~x52 ^ x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n393_ = ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
