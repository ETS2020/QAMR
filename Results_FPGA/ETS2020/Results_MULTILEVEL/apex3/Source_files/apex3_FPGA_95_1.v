// Benchmark "FAU" written by ABC on Wed Aug  5 13:54:18 2020
...
module FAU ( 
  ...
  assign new_n402_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  ...
  assign z49 = (~x48 & (new_n413_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n413_ = ~new_n414_ & ~x50;
