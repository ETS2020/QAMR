...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n389_, new_n390_, new_n392_, new_n393_, new_n399_, new_n401_,
    new_n402_;
  ...
  assign z19 = x46 ? new_n355_ : (new_n354_ | (~new_n357_ & ~x49));
  assign new_n354_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n355_ = ~x47 & ~x48 & x49 & ~new_n356_ & ~x53;
  assign new_n356_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n357_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n359_ & ~x47;
  assign new_n359_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n362_ : new_n361_)) | (new_n363_ & new_n159_ & x46 & ~x47);
  ...
  assign new_n366_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z26 = ~x51 & ~new_n368_ & x52;
  assign new_n368_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z28 = ~x46 & ~new_n370_ & x47;
  assign new_n370_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  ...
  assign z40 = ~x52 & ((~new_n389_ & ~x51) | (~x46 & new_n390_ & x47));
  assign new_n389_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
