// Benchmark "FAU" written by ABC on Wed Aug  5 13:56:02 2020
...
module FAU ( 
  ...
  assign new_n385_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  ...
  assign z35 = (~new_n398_ & x49) | (~x46 & ~x47 & x48 & new_n400_ & ~x49);
  assign new_n398_ = (~new_n399_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n399_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n400_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
