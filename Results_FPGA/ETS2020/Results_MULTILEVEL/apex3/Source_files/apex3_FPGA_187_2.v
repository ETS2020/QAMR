...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n373_, new_n375_, new_n377_, new_n378_, new_n380_, new_n382_,
    new_n385_, new_n387_, new_n389_, new_n391_, new_n395_, new_n397_,
    new_n398_, new_n401_, new_n403_;
  ...
  assign z16 = (~new_n364_ & ~x48) | (new_n367_ & x48 & x49 & ~x46 & x47);
  assign new_n364_ = (~new_n365_ | x49) & (x46 | ~x47 | ~new_n366_ | ~x49);
  assign new_n365_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  ...
  assign z19 = x46 ? (~x47 & new_n373_ & ~x48) : ~new_n371_;
  assign new_n371_ = (new_n372_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n372_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n373_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n375_ & ~x47;
  assign new_n375_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n377_ & x46 & ~x47 & ~x48) | (new_n378_ & ~x46 & x47 & x48));
  assign new_n377_ = new_n137_ & ~x49 & ~x50;
  assign new_n378_ = x52 & ~x53 & x49 & x50;
  ...
  assign new_n391_ = ~x51 & ~x50 & new_n362_ & x49;
