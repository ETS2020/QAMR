...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n307_, new_n310_, new_n313_, new_n315_, new_n316_, new_n317_,
    new_n319_, new_n322_, new_n324_, new_n325_, new_n326_, new_n328_,
    new_n332_, new_n333_, new_n335_, new_n341_, new_n342_;
  ...
  assign new_n324_ = (x46 | ~x50 | ~new_n325_ | x51) & (~new_n303_ | ~new_n196_ | x50 | ~x51);
  assign new_n325_ = x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n326_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n328_ & x52;
  assign new_n328_ = ~x51 & ~x50 & new_n285_ & x49;
  assign z37 = ~x53 & new_n328_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n285_ & x49;
  assign z40 = ~x52 & ((~new_n332_ & ~x51) | (~x46 & new_n333_ & x47));
  assign new_n332_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n333_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & (new_n335_ | (new_n303_ & new_n112_ & x49 & ~x51));
  assign new_n335_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  ...
  assign z49 = (~x48 & (new_n341_ | (new_n214_ & ~x46 & x47 & ~x49))) | (new_n214_ & x48 & ~x49 & x46 & ~x47);
  assign new_n341_ = ~new_n342_ & ~x50;
  assign new_n342_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
