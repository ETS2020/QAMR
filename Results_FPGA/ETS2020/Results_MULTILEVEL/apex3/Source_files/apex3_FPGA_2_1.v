// Benchmark "FAU" written by ABC on Wed Aug  5 13:51:41 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n365_, new_n366_, new_n368_, new_n370_, new_n371_, new_n373_,
    new_n374_, new_n375_, new_n376_, new_n378_, new_n380_, new_n381_,
    new_n382_, new_n385_, new_n387_, new_n389_, new_n391_, new_n392_,
    new_n393_, new_n395_, new_n397_, new_n400_, new_n402_, new_n403_,
  ...
  assign z15 = x50 ? ~new_n356_ : (x46 ? new_n361_ : ~new_n360_);
  assign new_n356_ = ~new_n357_ & (x47 | ((new_n358_ | ~x52) & (~new_n359_ | ~x46)));
  assign new_n357_ = ~x46 & x48 & ~x49 & new_n251_ & x51;
  assign new_n358_ = (~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n359_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n360_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n361_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n363_ & ~x48) | (new_n366_ & ~x46 & x47 & x48 & x49);
  assign new_n363_ = (~new_n364_ | x49) & (x46 | ~x47 | ~new_n365_ | ~x49);
  assign new_n364_ = x52 & ((~x47 & ((~x51 & x53 & ~x46 & ~x50) | (x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n365_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n366_ = new_n251_ & x50 & ~x51;
  assign z17 = ~x47 & new_n368_ & ~x49;
  assign new_n368_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n370_ & ~x47) : (x47 & new_n371_ & ~x49);
  assign new_n370_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n371_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? new_n374_ : (new_n373_ | (~new_n376_ & ~x49));
  assign new_n373_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n374_ = ~x47 & ~x48 & x49 & ~new_n375_ & ~x53;
  assign new_n375_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n376_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n378_ & ~x47;
  assign new_n378_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n381_ : new_n380_)) | (new_n382_ & new_n159_ & x46 & ~x47);
  assign new_n380_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n381_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n382_ = ~x52 & ~x53 & x50 & ~x51;
  ...
  assign new_n387_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n389_ & ~x52;
  assign new_n389_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n391_ | (~x48 & (new_n392_ | (new_n393_ & x46))));
  assign new_n391_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n392_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  ...
  assign z33 = ~x53 & new_n389_ & ~x52;
  assign z34 = ~x46 & new_n400_ & x47;
  assign new_n400_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n402_ & x49) | (~x46 & ~x47 & x48 & new_n404_ & ~x49);
  assign new_n402_ = (~new_n403_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n403_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n404_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  ...
  assign new_n409_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n411_ & x47) | (new_n412_ & x46 & ~x47 & ~x48));
  assign new_n411_ = ~x49 & new_n139_ & x51;
  assign new_n412_ = ~x52 & ~x53 & x49 & ~x51;
