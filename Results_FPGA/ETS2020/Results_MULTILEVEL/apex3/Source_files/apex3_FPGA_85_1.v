// Benchmark "FAU" written by ABC on Wed Aug  5 13:54:00 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n389_, new_n390_, new_n394_, new_n398_, new_n400_, new_n401_;
  ...
  assign z19 = x46 ? new_n357_ : (new_n356_ | (~new_n359_ & ~x49));
  assign new_n356_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n357_ = ~x47 & ~x48 & x49 & ~new_n358_ & ~x53;
  assign new_n358_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  ...
  assign z22 = (~x46 & (x47 ? new_n364_ : new_n363_)) | (new_n365_ & new_n159_ & x46 & ~x47);
  assign new_n363_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n364_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  ...
  assign new_n370_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z29 = x53 & new_n372_ & ~x52;
  assign new_n372_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n374_ | (~x48 & (new_n375_ | (new_n376_ & x46))));
  assign new_n374_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n375_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n376_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n378_ & x52;
  assign new_n378_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z32 = ~x47 & ~new_n380_ & x49;
  assign new_n380_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n372_ & ~x52;
  assign z35 = (~new_n383_ & x49) | (~x46 & ~x47 & x48 & new_n385_ & ~x49);
  assign new_n383_ = (~new_n384_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n384_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n385_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z39 = ~x46 & ~x47 & new_n387_ & x48;
  assign new_n387_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & ((~x46 & new_n389_ & x47) | (new_n390_ & x46 & ~x47 & ~x48));
  assign new_n389_ = ~x49 & new_n139_ & x51;
  assign new_n390_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n378_ & x52;
  assign z43 = x53 & new_n378_ & ~x52;
  assign z44 = ~x46 & new_n394_ & ~x47;
  assign new_n394_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n372_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n112_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n398_ & ~x50;
  assign new_n398_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n400_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n400_ = ~new_n401_ & ~x50;
