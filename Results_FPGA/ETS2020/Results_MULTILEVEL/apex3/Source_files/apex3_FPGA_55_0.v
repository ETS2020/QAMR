// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:09 2020
...
module FAU ( 
  ...
  assign new_n310_ = new_n196_ & new_n140_ & x46 & x48 & ~x49;
  ...
  assign z35 = (~new_n319_ & x49) | (~x46 & ~x47 & x48 & new_n321_ & ~x49);
  assign new_n319_ = (x46 | ~x50 | ~new_n320_ | x51) & (~new_n296_ | ~new_n196_ | x50 | ~x51);
  assign new_n320_ = x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n321_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
