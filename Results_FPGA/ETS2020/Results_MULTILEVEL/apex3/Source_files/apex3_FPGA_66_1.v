// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:28 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n373_, new_n374_, new_n375_, new_n378_, new_n380_, new_n382_,
    new_n384_, new_n386_, new_n387_, new_n388_, new_n390_, new_n392_,
    new_n395_, new_n397_, new_n398_, new_n399_, new_n401_, new_n403_,
    new_n404_, new_n406_, new_n407_, new_n411_, new_n415_, new_n417_,
    new_n418_;
  ...
  assign z28 = ~x46 & ~new_n382_ & x47;
  assign new_n382_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n384_ & ~x52;
  assign new_n384_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n386_ | (~x48 & (new_n387_ | (new_n388_ & x46))));
  assign new_n386_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n387_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n388_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n390_ & x52;
  ...
  assign z33 = ~x53 & new_n384_ & ~x52;
  assign z34 = ~x46 & new_n395_ & x47;
  assign new_n395_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n397_ & x49) | (~x46 & ~x47 & x48 & new_n399_ & ~x49);
  assign new_n397_ = (~new_n398_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n398_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n399_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  ...
  assign new_n404_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n406_ & x47) | (new_n407_ & x46 & ~x47 & ~x48));
  assign new_n406_ = ~x49 & new_n139_ & x51;
  assign new_n407_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n390_ & x52;
  assign z43 = x53 & new_n390_ & ~x52;
  assign z44 = ~x46 & new_n411_ & ~x47;
  assign new_n411_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n384_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n112_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n415_ & ~x50;
  assign new_n415_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n417_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n417_ = ~new_n418_ & ~x50;
  assign new_n418_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
