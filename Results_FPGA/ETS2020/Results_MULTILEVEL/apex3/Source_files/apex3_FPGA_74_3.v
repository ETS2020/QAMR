// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:41 2020
...
module FAU ( 
  ...
  assign new_n170_ = (new_n171_ | ~x47) & (new_n177_ | ~x52) & (new_n183_ | x52) & (new_n181_ | x47);
  assign new_n171_ = ~new_n172_ & new_n176_ & (x49 | (x52 ? new_n175_ : new_n174_));
  assign new_n172_ = x01 & (new_n173_ | (new_n145_ & ~x51 & ~x52 & x53));
  ...
  assign new_n186_ = (~x49 | new_n187_ | ~x50) & (x49 | x50 | x51 | x52 | ~x53);
  ...
  assign z03 = (~new_n199_ & ~x46) | (~x47 & (new_n239_ | new_n241_ | (~new_n228_ & x46)));
  ...
  assign new_n228_ = (new_n229_ | x48) & (x49 | (~new_n238_ & (new_n235_ | ~x48)));
  ...
  assign new_n238_ = new_n112_ & x51 & ~x38 & ~x43 & ~x50;
  assign new_n239_ = ~x48 & x49 & ~new_n240_ & x51;
  assign new_n240_ = (~x50 | ((x03 | ~x52 | ~x53) & (x35 | x52 | x53))) & (x41 | x50 | x52 | x53);
  assign new_n241_ = new_n112_ & ~x50 & ~x51 & ~x37 & x48 & ~x49;
  assign z04 = (~new_n243_ & x50) | (new_n285_ & ~x46) | (~x50 & (new_n270_ | (~new_n279_ & ~x46)));
  assign new_n243_ = (new_n262_ | x47) & (x46 | (new_n249_ & (new_n244_ | ~x47)));
  ...
  assign new_n259_ = (~x48 | new_n260_ | ~x53) & (x49 | ~x51 | ~x14 | x48);
  assign new_n260_ = (x41 | ~x49 | ~x51) & (~x29 | x49 | x51);
  assign new_n261_ = ~x51 & ((~x08 & (x48 ? ~x47 : (x49 & x52))) | (~x52 & (x49 | (x08 & x48))) | (~x47 & ~x48 & ~x49 & x52));
  assign new_n262_ = ~new_n263_ & ~new_n267_ & (~new_n167_ | x35 | ~new_n112_ | ~x51);
  assign new_n263_ = x52 & ((~new_n264_ & x51) | (x46 & ~x51 & (new_n265_ | new_n266_)));
  assign new_n264_ = (x03 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | (x48 ? (x49 | ~x53) : (x53 | (~x49 & (~x21 | x49)))));
  assign new_n265_ = ~x49 & (~x48 | (x48 & (x53 | (x04 & ~x53))));
  assign new_n266_ = ~x48 & x49 & (x53 | (~x53 & (x10 | x11 | x25 | (~x10 & ~x11 & ~x25))));
  assign new_n267_ = x46 & ((~x48 & x49 & ~x52) | (~x49 & (x48 ? ~new_n268_ : (~new_n269_ & ~x52))));
  assign new_n268_ = (~x51 | x52) & (x04 | x51 | (x53 & (x52 | ~x53)));
  assign new_n269_ = (~x53 | ((~x41 | x51) & (x22 | x25 | x28 | ~x51))) & x53 & (~x51 | (~x22 & ~x25 & ~x28));
  assign new_n270_ = ~x47 & (new_n271_ | (~new_n275_ & x51) | (new_n278_ & new_n139_ & ~x51));
  ...
  assign new_n274_ = (~x46 | ((~x48 | (x53 ? x51 : ~x37)) & (~new_n129_ | ~x51 | x53) & (x48 | (x51 ^ ~x53)))) & (~x48 | ((x46 | ~x51) & (x37 | x51 | x53)));
  assign new_n275_ = (new_n276_ | ~x49) & (x39 | ~x46 | ~new_n139_ | x48);
  assign new_n276_ = x46 ? (x48 | (x52 ? ~x53 : (~x24 & x53))) : (x48 ? new_n277_ : (x52 | ~x53));
  assign new_n277_ = (x19 | x52 | ~x53) & (x34 | ~x52 | x53);
  assign new_n278_ = ~x46 & ~x48;
  assign new_n279_ = ~new_n284_ & (~x47 | ((new_n280_ | ~x51) & (~new_n283_ | ~new_n282_ | x51)));
  ...
  assign z05 = (~new_n332_ & ~x48) | (new_n330_ & x48) | (~new_n288_ & ~x48) | new_n325_ | (~new_n311_ & x48);
  assign new_n288_ = new_n301_ & (~x50 | ((new_n289_ | ~x49) & ~new_n111_ & (new_n296_ | x49)));
  ...
  assign new_n297_ = ~x52 & ((x25 & (x46 | (~x46 & ~x53))) | (~x25 & ((~x46 & ~x53) | (new_n231_ & x46 & x53))) | (~new_n231_ & x46) | (~x46 & x53));
  assign new_n298_ = (x46 | ((~x16 | ~x52 | x53) & (x14 | ~x53))) & (~x52 | x53 | ~x21 | ~x46);
  assign new_n299_ = (~x46 | x52 | (x53 & (x41 | x51 | ~x53))) & (x46 | x51 | ~x52 | ~x53);
  assign new_n300_ = ~x46 & x47 & x52 & (x51 ^ x53);
  assign new_n301_ = ~new_n310_ & (x50 | ((new_n302_ | x46) & (new_n308_ | x47)));
  assign new_n302_ = x53 ? (~new_n303_ & ~new_n304_ & ~new_n305_) : (~new_n306_ & ~new_n307_);
  ...
  assign new_n306_ = ~x51 & (x47 ? ((x49 & ~x52) | (x31 & ~x49 & x52)) : (x49 & x52));
  assign new_n307_ = ~x47 & ((~x49 & x52 & (x32 | x51)) | (x51 & ~x52 & x41 & x49));
  ...
  assign new_n310_ = new_n282_ & ~x49 & ~x51 & ~x36 & x46 & ~x47;
  ...
  assign new_n324_ = x50 & x51 & ((~x41 & x49 & ~x52 & x53) | (~x49 & x52 & ~x53));
  assign new_n325_ = ~x46 & (new_n326_ | (new_n329_ & ~x20 & ~x47 & x49));
  assign new_n326_ = ~x50 & (new_n327_ | (new_n328_ & x49));
  assign new_n327_ = x47 & ((x51 & ~x52 & ~x53) | (x52 & x53 & ~x13 & ~x49));
  ...
  assign new_n336_ = (~x47 | (~new_n337_ & new_n338_)) & new_n339_ & (new_n260_ | ~x50);
  ...
  assign new_n365_ = (x49 | (~new_n366_ & (~new_n163_ | x50))) & (x48 | ~new_n367_ | ~x49);
  ...
  assign new_n387_ = (~new_n388_ | ~x29 | ~x48) & (~x51 | (~new_n251_ & (~new_n389_ | x48)));
  ...
  assign new_n392_ = (x50 | (~new_n393_ & (~new_n159_ | ~x48 | x49))) & (x14 | x48 | ~new_n159_ | ~x49);
  ...
  assign new_n409_ = x47 & ((~new_n410_ & x50) | (new_n166_ & new_n159_ & ~x50));
  ...
  assign new_n424_ = ~new_n239_ & (x49 | (x48 ? ~new_n425_ : ~new_n426_));
  ...
  assign new_n445_ = new_n282_ & x51 & ~x46 & x48 & ~x49;
  ...
  assign new_n454_ = new_n282_ & x50 & ~x51;
  ...
  assign new_n463_ = new_n282_ & x49 & x50;
  assign new_n464_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n468_ : new_n467_)) | (new_n466_ & new_n167_ & x46 & ~x47);
  ...
  assign new_n482_ = new_n282_ & new_n140_ & x46 & x48 & ~x49;
  ...
  assign new_n490_ = (~new_n491_ | x46) & (~new_n282_ | ~new_n140_ | ~x46 | x47 | x48);
