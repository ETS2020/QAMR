// Benchmark "FAU" written by ABC on Wed Aug  5 13:58:37 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n414_, new_n420_, new_n422_, new_n423_;
  ...
  assign z40 = ~x52 & ((~new_n410_ & ~x51) | (~x46 & new_n411_ & x47));
  assign new_n410_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n411_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n413_ & x47) | (new_n414_ & x46 & ~x47 & ~x48));
  assign new_n413_ = ~x49 & new_n139_ & x51;
  assign new_n414_ = ~x52 & ~x53 & x49 & ~x51;
  ...
  assign z49 = (~x48 & (new_n422_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n422_ = ~new_n423_ & ~x50;
  assign new_n423_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z21 = 1'b0;
