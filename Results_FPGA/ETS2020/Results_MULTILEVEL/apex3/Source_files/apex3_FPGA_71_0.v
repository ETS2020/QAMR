// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:36 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n301_, new_n303_, new_n306_, new_n308_, new_n309_, new_n310_,
  ...
  assign z25 = ~x46 & new_n301_ & ~x47;
  assign new_n301_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n303_ & x52;
  assign new_n303_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n283_ & ~x49;
  assign z29 = x53 & new_n306_ & ~x52;
  assign new_n306_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n308_ | (~x48 & (new_n309_ | (new_n310_ & x46))));
  assign new_n308_ = new_n196_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n309_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n310_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n312_ & x52;
  assign new_n312_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z32 = ~x47 & ~new_n314_ & x49;
  assign new_n314_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n306_ & ~x52;
  ...
  assign z41 = ~x50 & (new_n332_ | (new_n294_ & new_n112_ & x49 & ~x51));
  assign new_n332_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n312_ & x52;
  assign z43 = x53 & new_n312_ & ~x52;
  assign z46 = x53 & new_n306_ & x52;
