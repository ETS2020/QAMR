// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:29 2020
...
module FAU ( 
  ...
  assign z19 = x46 ? new_n378_ : (new_n380_ | (~new_n381_ & ~x49));
  assign new_n378_ = ~x47 & ~x48 & x49 & ~new_n379_ & ~x53;
  assign new_n379_ = x50 ? (x51 | new_n233_ | ~x52) : (~x51 | x52);
  assign new_n380_ = new_n126_ & ~x47 & new_n137_ & new_n210_;
