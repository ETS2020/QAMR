...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n327_, new_n329_, new_n331_, new_n334_, new_n336_, new_n337_,
    new_n338_, new_n340_, new_n344_, new_n346_, new_n347_, new_n349_,
    new_n353_, new_n357_, new_n358_;
  ...
  assign z14 = ~x53 & ~x52 & ~x51 & new_n285_ & x50;
  assign new_n285_ = x49 & x48 & ~x46 & ~x47;
  ...
  assign z30 = ~x47 & (new_n325_ | (~x48 & (new_n326_ | (new_n327_ & x46))));
  assign new_n325_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  assign new_n326_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n327_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n329_ & x52;
  assign new_n329_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z32 = ~x47 & ~new_n331_ & x49;
  assign new_n331_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n323_ & ~x52;
  assign z34 = ~x46 & new_n334_ & x47;
  assign new_n334_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~x46 & new_n338_ & ~x47) | (x49 & (new_n336_ | (new_n337_ & ~x46)));
  assign new_n336_ = new_n310_ & new_n196_ & ~x50 & x51;
  assign new_n337_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n338_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n340_ & x52;
  assign new_n340_ = ~x51 & new_n285_ & ~x50;
  assign z37 = ~x53 & new_n340_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & new_n285_ & ~x50;
  assign z39 = ~x46 & ~x47 & new_n344_ & x48;
  assign new_n344_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n346_ & ~x51) | (~x46 & new_n347_ & x47));
  assign new_n346_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n347_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & (new_n349_ | (new_n310_ & new_n112_ & x49 & ~x51));
  assign new_n349_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n329_ & x52;
  assign z43 = x53 & new_n329_ & ~x52;
  assign z44 = ~x46 & new_n353_ & ~x47;
  assign new_n353_ = x48 & ~x49 & ((x50 & (x51 ^ x52)) | (~x50 & ~x51 & x52 & x53));
  assign z46 = x53 & new_n323_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n111_ & ~x50;
  assign z49 = (~x48 & (new_n357_ | (new_n214_ & ~x46 & x47 & ~x49))) | (new_n214_ & x48 & ~x49 & x46 & ~x47);
