// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:28 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n299_, new_n301_, new_n302_, new_n303_, new_n306_, new_n308_,
    new_n310_, new_n312_, new_n313_, new_n314_, new_n316_, new_n319_,
    new_n321_, new_n322_, new_n323_, new_n325_, new_n329_, new_n331_,
    new_n332_, new_n334_, new_n340_, new_n341_;
  ...
  assign z14 = ~x53 & ~x52 & ~x51 & new_n283_ & x50;
  assign new_n283_ = x49 & x48 & ~x46 & ~x47;
  assign z16 = (~new_n285_ & ~x48) | (new_n288_ & ~x46 & x47 & x48 & x49);
  assign new_n285_ = (~new_n286_ | x49) & (x46 | ~x47 | ~new_n287_ | ~x49);
  assign new_n286_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n287_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n288_ = new_n196_ & x50 & ~x51;
  assign z18 = x46 ? (~new_n290_ & ~x47) : (x47 & new_n291_ & ~x49);
  assign new_n290_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n291_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (x23 & x48 & ~x51 & ~x52));
  assign z19 = x46 ? new_n294_ : (new_n293_ | (~new_n296_ & ~x49));
  assign new_n293_ = new_n145_ & ~x50 & ~x51 & ~x47 & ~x48 & x49;
  assign new_n294_ = ~x47 & ~x48 & x49 & ~new_n295_ & ~x53;
  assign new_n295_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n296_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z21 = x51 & (new_n298_ | (new_n299_ & new_n145_ & ~x49 & ~x50));
  assign new_n298_ = new_n196_ & x49 & x50 & ~x46 & x47 & x48;
  assign new_n299_ = x46 & ~x47 & ~x48;
  assign z22 = new_n301_ | (~x46 & (x47 ? new_n303_ : new_n302_));
  assign new_n301_ = new_n112_ & x50 & ~x51 & new_n113_ & ~x48 & x49;
  assign new_n302_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n303_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n196_ & x51;
  assign z25 = ~x46 & new_n306_ & ~x47;
  assign new_n306_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n308_ & x52;
  assign new_n308_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z29 = x53 & new_n310_ & ~x52;
  assign new_n310_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n312_ | (~x48 & (new_n313_ | (new_n314_ & x46))));
  assign new_n312_ = new_n196_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n313_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n314_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n316_ & x52;
  assign new_n316_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z33 = ~x53 & new_n310_ & ~x52;
  assign z34 = ~x46 & new_n319_ & x47;
  assign new_n319_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n321_ & x49) | (~x46 & ~x47 & x48 & new_n323_ & ~x49);
  assign new_n321_ = (x46 | ~x50 | ~new_n322_ | x51) & (~new_n299_ | ~new_n196_ | x50 | ~x51);
  assign new_n322_ = x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n323_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n325_ & x52;
  assign new_n325_ = ~x51 & new_n283_ & ~x50;
  assign z37 = ~x53 & new_n325_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & new_n283_ & ~x50;
  assign z39 = ~x46 & ~x47 & new_n329_ & x48;
  assign new_n329_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n331_ & ~x51) | (~x46 & new_n332_ & x47));
  assign new_n331_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n332_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & (new_n334_ | (new_n299_ & new_n112_ & x49 & ~x51));
  assign new_n334_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n316_ & x52;
  assign z43 = x53 & new_n316_ & ~x52;
  assign z46 = x53 & new_n310_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n111_ & ~x50;
  assign z49 = (~x48 & (new_n340_ | (new_n214_ & ~x46 & x47 & ~x49))) | (new_n214_ & x48 & ~x49 & x46 & ~x47);
  assign new_n340_ = ~new_n341_ & ~x50;
  assign new_n341_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
