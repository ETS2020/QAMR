...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n379_, new_n381_, new_n382_, new_n384_, new_n387_, new_n389_,
  ...
  assign z19 = x46 ? (~x47 & new_n377_ & ~x48) : ~new_n375_;
  assign new_n375_ = (new_n376_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n376_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n377_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n379_ & ~x47;
  assign new_n379_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n381_ & x46 & ~x47 & ~x48) | (new_n382_ & ~x46 & x47 & x48));
  assign new_n381_ = new_n137_ & ~x49 & ~x50;
  assign new_n382_ = x52 & ~x53 & x49 & x50;
