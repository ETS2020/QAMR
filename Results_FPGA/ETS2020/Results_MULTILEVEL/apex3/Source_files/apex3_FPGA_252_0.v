// Benchmark "FAU" written by ABC on Wed Aug  5 13:58:41 2020
...
module FAU ( 
  ...
  assign new_n315_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  ...
  assign z35 = (~x46 & new_n326_ & ~x47) | (x49 & (new_n324_ | (new_n325_ & ~x46)));
  assign new_n324_ = new_n301_ & new_n196_ & ~x50 & x51;
  assign new_n325_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n326_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  ...
  assign z41 = ~x50 & (new_n334_ | (new_n301_ & new_n112_ & x49 & ~x51));
