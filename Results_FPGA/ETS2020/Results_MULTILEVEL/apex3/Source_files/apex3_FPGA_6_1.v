// Benchmark "FAU" written by ABC on Wed Aug  5 13:51:48 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n373_, new_n375_, new_n377_, new_n378_, new_n379_, new_n382_,
    new_n384_, new_n386_, new_n388_, new_n390_, new_n391_, new_n392_,
    new_n394_, new_n396_, new_n399_, new_n401_, new_n402_, new_n403_,
    new_n405_, new_n406_, new_n410_, new_n414_, new_n416_, new_n417_;
  ...
  assign z19 = x46 ? new_n371_ : (new_n370_ | (~new_n373_ & ~x49));
  assign new_n370_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n371_ = ~x47 & ~x48 & x49 & ~new_n372_ & ~x53;
  assign new_n372_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n373_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n375_ & ~x47;
  assign new_n375_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n378_ : new_n377_)) | (new_n379_ & new_n159_ & x46 & ~x47);
  assign new_n377_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n378_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n379_ = ~x52 & ~x53 & x50 & ~x51;
  ...
  assign new_n384_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z28 = ~x46 & ~new_n386_ & x47;
  assign new_n386_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n388_ & ~x52;
  assign new_n388_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n390_ | (~x48 & (new_n391_ | (new_n392_ & x46))));
  assign new_n390_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n391_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n392_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign z33 = ~x53 & new_n388_ & ~x52;
  assign z34 = ~x46 & new_n399_ & x47;
  assign new_n399_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n401_ & x49) | (~x46 & ~x47 & x48 & new_n403_ & ~x49);
  assign new_n401_ = (~new_n402_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n402_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n403_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z41 = ~x50 & ((~x46 & new_n405_ & x47) | (new_n406_ & x46 & ~x47 & ~x48));
  assign new_n405_ = ~x49 & new_n139_ & x51;
  assign new_n406_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n394_ & x52;
  assign z43 = x53 & new_n394_ & ~x52;
  assign z44 = ~x46 & new_n410_ & ~x47;
  assign new_n410_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n388_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n112_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n414_ & ~x50;
  assign new_n414_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n416_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n416_ = ~new_n417_ & ~x50;
  assign new_n417_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z13 = 1'b0;
  assign z14 = 1'b0;
