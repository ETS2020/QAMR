// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:03 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n374_, new_n376_, new_n378_, new_n381_, new_n383_, new_n385_,
    new_n387_, new_n391_, new_n392_, new_n395_, new_n397_;
  ...
  assign new_n362_ = x52 & ((~x46 & ~x48 & x51 & (~x50 ^ ~x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n364_ & ~x47) : (x47 & new_n365_ & ~x49);
  assign new_n364_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n365_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & new_n369_ & ~x48) : ~new_n367_;
  assign new_n367_ = (new_n368_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n368_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n369_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n371_ & ~x47;
  assign new_n371_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n373_ & x46 & ~x47 & ~x48) | (new_n374_ & ~x46 & x47 & x48));
  assign new_n373_ = new_n137_ & ~x49 & ~x50;
  assign new_n374_ = x52 & ~x53 & x49 & x50;
  assign z25 = ~x46 & new_n376_ & ~x47;
  assign new_n376_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  ...
  assign z36 = x53 & new_n387_ & x52;
  assign new_n387_ = ~x51 & ~x50 & new_n360_ & x49;
  assign z37 = ~x53 & new_n387_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n360_ & x49;
  assign z40 = ~x52 & ((~new_n391_ & ~x51) | (~x46 & new_n392_ & x47));
  assign new_n391_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n392_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z44 = ~x46 & new_n395_ & ~x47;
  assign new_n395_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
