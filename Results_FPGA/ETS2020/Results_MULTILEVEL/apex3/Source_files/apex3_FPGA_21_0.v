...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n301_, new_n302_, new_n305_, new_n307_, new_n309_, new_n312_,
    new_n314_, new_n316_, new_n317_, new_n318_, new_n320_, new_n323_,
    new_n325_, new_n326_, new_n327_, new_n329_, new_n333_, new_n335_,
    new_n336_, new_n338_, new_n344_, new_n345_;
  ...
  assign z21 = x51 & (new_n297_ | (new_n298_ & new_n145_ & ~x49 & ~x50));
  assign new_n297_ = new_n196_ & x49 & x50 & ~x46 & x47 & x48;
  assign new_n298_ = x46 & ~x47 & ~x48;
  assign z22 = new_n300_ | (~x46 & (x47 ? new_n302_ : new_n301_));
  assign new_n300_ = new_n112_ & x50 & ~x51 & new_n113_ & ~x48 & x49;
  assign new_n301_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n302_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n196_ & x51;
  assign z24 = ~x48 & new_n305_ & x49;
  assign new_n305_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n307_ & ~x47;
  assign new_n307_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  ...
  assign new_n312_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n314_ & ~x52;
  assign new_n314_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n316_ | (~x48 & (new_n317_ | (new_n318_ & x46))));
  assign new_n316_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  assign new_n317_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n318_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n320_ & x52;
  assign new_n320_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z33 = ~x53 & new_n314_ & ~x52;
  assign z34 = ~x46 & new_n323_ & x47;
  assign new_n323_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~x46 & new_n327_ & ~x47) | (x49 & (new_n325_ | (new_n326_ & ~x46)));
  assign new_n325_ = new_n298_ & new_n196_ & ~x50 & x51;
  assign new_n326_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n327_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n329_ & x52;
  assign new_n329_ = ~x51 & ~x50 & new_n285_ & x49;
  assign z37 = ~x53 & new_n329_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n285_ & x49;
  assign z39 = ~x46 & ~x47 & new_n333_ & x48;
  assign new_n333_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n335_ & ~x51) | (~x46 & new_n336_ & x47));
  assign new_n335_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n336_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & (new_n338_ | (new_n298_ & new_n112_ & x49 & ~x51));
  assign new_n338_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n320_ & x52;
  assign z43 = x53 & new_n320_ & ~x52;
