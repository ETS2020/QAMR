// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:23 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n383_, new_n385_, new_n387_, new_n389_, new_n390_, new_n391_,
    new_n393_, new_n395_, new_n398_, new_n400_, new_n401_, new_n402_,
    new_n404_, new_n406_, new_n407_, new_n409_, new_n410_, new_n414_,
  ...
  assign z15 = x50 ? ~new_n354_ : (x46 ? new_n359_ : ~new_n358_);
  assign new_n354_ = ~new_n355_ & (x47 | ((new_n356_ | ~x52) & (~new_n357_ | ~x46)));
  assign new_n355_ = ~x46 & x48 & ~x49 & new_n251_ & x51;
  assign new_n356_ = (~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n357_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n358_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n359_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n361_ & ~x48) | (new_n364_ & ~x46 & x47 & x48 & x49);
  assign new_n361_ = (~new_n362_ | x49) & (x46 | ~x47 | ~new_n363_ | ~x49);
  assign new_n362_ = x52 & ((~x47 & ((~x51 & x53 & ~x46 & ~x50) | (x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n363_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n364_ = new_n251_ & x50 & ~x51;
  assign z17 = ~x47 & new_n366_ & ~x49;
  assign new_n366_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n368_ & ~x47) : (x47 & new_n369_ & ~x49);
  assign new_n368_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n369_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? new_n372_ : (new_n371_ | (~new_n374_ & ~x49));
  assign new_n371_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n372_ = ~x47 & ~x48 & x49 & ~new_n373_ & ~x53;
  assign new_n373_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n374_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n376_ & ~x47;
  assign new_n376_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n379_ : new_n378_)) | (new_n380_ & new_n159_ & x46 & ~x47);
  ...
  assign z24 = ~x48 & new_n383_ & x49;
  assign new_n383_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z26 = ~x51 & ~new_n385_ & x52;
  assign new_n385_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z29 = x53 & new_n387_ & ~x52;
  assign new_n387_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n389_ | (~x48 & (new_n390_ | (new_n391_ & x46))));
  assign new_n389_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n390_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n391_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n393_ & x52;
  assign new_n393_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z32 = ~x47 & ~new_n395_ & x49;
  assign new_n395_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n387_ & ~x52;
  assign z34 = ~x46 & new_n398_ & x47;
  assign new_n398_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n400_ & x49) | (~x46 & ~x47 & x48 & new_n402_ & ~x49);
  assign new_n400_ = (~new_n401_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n401_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n402_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z39 = ~x46 & ~x47 & new_n404_ & x48;
  assign new_n404_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n406_ & ~x51) | (~x46 & new_n407_ & x47));
  assign new_n406_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n407_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n409_ & x47) | (new_n410_ & x46 & ~x47 & ~x48));
  assign new_n409_ = ~x49 & new_n139_ & x51;
  assign new_n410_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n393_ & x52;
  assign z43 = x53 & new_n393_ & ~x52;
  assign z44 = ~x46 & new_n414_ & ~x47;
  assign new_n414_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n420_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n420_ = ~new_n421_ & ~x50;
  assign new_n421_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z12 = 1'b0;
  assign z13 = 1'b0;
