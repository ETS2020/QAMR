// Benchmark "FAU" written by ABC on Wed Aug  5 13:54:19 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n320_, new_n321_, new_n323_, new_n326_, new_n328_, new_n329_,
    new_n330_, new_n332_, new_n336_, new_n338_, new_n339_, new_n341_,
    new_n347_, new_n348_;
  ...
  assign z28 = ~x46 & ~new_n315_ & x47;
  assign new_n315_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n317_ & ~x52;
  assign new_n317_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n319_ | (~x48 & (new_n320_ | (new_n321_ & x46))));
  assign new_n319_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  assign new_n320_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n321_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n323_ & x52;
  assign new_n323_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z33 = ~x53 & new_n317_ & ~x52;
  assign z34 = ~x46 & new_n326_ & x47;
  assign new_n326_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~x46 & new_n330_ & ~x47) | (x49 & (new_n328_ | (new_n329_ & ~x46)));
  assign new_n328_ = new_n301_ & new_n196_ & ~x50 & x51;
  assign new_n329_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n330_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n332_ & x52;
  assign new_n332_ = ~x51 & ~x50 & new_n283_ & x49;
  ...
  assign z40 = ~x52 & ((~new_n338_ & ~x51) | (~x46 & new_n339_ & x47));
  assign new_n338_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n339_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & (new_n341_ | (new_n301_ & new_n112_ & x49 & ~x51));
  assign new_n341_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n323_ & x52;
  assign z43 = x53 & new_n323_ & ~x52;
