// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:56 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n367_, new_n370_, new_n372_, new_n374_, new_n376_, new_n378_,
    new_n379_, new_n380_, new_n382_, new_n384_, new_n387_, new_n389_,
    new_n390_, new_n391_, new_n393_, new_n395_, new_n396_, new_n400_,
  ...
  assign z19 = x46 ? new_n361_ : (new_n360_ | (~new_n363_ & ~x49));
  assign new_n360_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n361_ = ~x47 & ~x48 & x49 & ~new_n362_ & ~x53;
  assign new_n362_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n363_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z22 = (~x46 & (x47 ? new_n366_ : new_n365_)) | (new_n367_ & new_n159_ & x46 & ~x47);
  assign new_n365_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n366_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n367_ = ~x52 & ~x53 & x50 & ~x51;
  ...
  assign new_n374_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n376_ & ~x52;
  assign new_n376_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n378_ | (~x48 & (new_n379_ | (new_n380_ & x46))));
  assign new_n378_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n379_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n380_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign z33 = ~x53 & new_n376_ & ~x52;
  assign z34 = ~x46 & new_n387_ & x47;
  assign new_n387_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n389_ & x49) | (~x46 & ~x47 & x48 & new_n391_ & ~x49);
  assign new_n389_ = (~new_n390_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n390_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n391_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  ...
  assign new_n407_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
