// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:45 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n390_, new_n393_, new_n395_, new_n397_, new_n399_, new_n403_,
    new_n405_, new_n406_, new_n409_, new_n411_;
  ...
  assign z18 = x46 ? (~new_n376_ & ~x47) : (x47 & new_n377_ & ~x49);
  assign new_n376_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n377_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & new_n381_ & ~x48) : ~new_n379_;
  assign new_n379_ = (new_n380_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n380_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n381_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n383_ & ~x47;
  assign new_n383_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n385_ & x46 & ~x47 & ~x48) | (new_n386_ & ~x46 & x47 & x48));
  assign new_n385_ = new_n137_ & ~x49 & ~x50;
  assign new_n386_ = x52 & ~x53 & x49 & x50;
  assign z24 = ~x48 & new_n388_ & x49;
  assign new_n388_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  ...
  assign new_n393_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n395_ & x49;
  assign new_n395_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n397_ & x47;
  assign new_n397_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n399_ & x52;
  assign new_n399_ = ~x51 & ~x50 & new_n360_ & x49;
  assign z37 = ~x53 & new_n399_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n360_ & x49;
  assign z39 = ~x46 & ~x47 & new_n403_ & x48;
  assign new_n403_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n405_ & ~x51) | (~x46 & new_n406_ & x47));
  assign new_n405_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n406_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z44 = ~x46 & new_n409_ & ~x47;
  assign new_n409_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
