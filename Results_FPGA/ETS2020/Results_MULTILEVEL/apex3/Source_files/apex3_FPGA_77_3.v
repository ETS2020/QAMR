// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:47 2020
...
module FAU ( 
  ...
  assign z05 = (~new_n332_ & ~x48) | (new_n330_ & x48) | (~new_n289_ & ~x48) | new_n326_ | (~new_n312_ & x48);
  ...
  assign new_n326_ = ~x46 & (new_n328_ | (~x50 & (new_n327_ | (new_n329_ & x49))));
  assign new_n327_ = x47 & (new_n134_ | (new_n140_ & ~x13 & ~x49));
  assign new_n328_ = new_n140_ & x50 & ~x51 & ~x20 & ~x47 & x49;
  assign new_n329_ = x51 & ((x12 & ~x52 & ~x53) | (x17 & ~x47 & x52 & x53));
  assign new_n330_ = ~new_n331_ & x50;
  assign new_n331_ = (x46 | ~x47 | ~x49 | (~x51 & (x51 | ~x52))) & (x49 | x51 | x52 | ~x04 | ~x46 | x47);
  ...
  assign new_n434_ = new_n140_ & x50 & ~x51 & ~x46 & ~x48 & ~x49;
