...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n389_, new_n390_, new_n392_, new_n394_, new_n397_, new_n399_,
    new_n401_, new_n403_, new_n407_, new_n410_, new_n412_;
  ...
  assign z11 = (~x46 & new_n358_ & x47) | (~x47 & (new_n356_ | (~new_n357_ & x51)));
  assign new_n356_ = new_n163_ & x50 & ~x51 & ~x46 & ~x48 & ~x49;
  assign new_n357_ = (x48 | (x46 ? ((~x52 | ~x53 | ~x49 | x50) & (x49 | ~x50 | x52 | x53)) : (x49 | x53 | (~x50 ^ ~x52)))) & (x46 | ~x48 | x49 | x50 | (x52 ^ ~x53));
  assign new_n358_ = ~x48 & x52 & ~x53 & (x49 ? (x50 & ~x51) : (~x50 & x51));
  assign z12 = ~x46 & ~new_n360_ & x47;
  assign new_n360_ = (~x53 | (x49 ? (x48 ? ((x51 | x52) & (x50 | ~x51 | ~x52)) : (~x50 | ~x51)) : ((x51 | ~x52 | ~x48 | x50) & (~x51 | x52 | x48 | ~x50)))) & (x48 | ~x49 | x53 | (x50 ? (x51 | x52) : (x51 & (~x51 | ~x52))));
  ...
  assign z18 = x46 ? (~new_n380_ & ~x47) : (x47 & new_n381_ & ~x49);
  assign new_n380_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n381_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? (~x47 & new_n385_ & ~x48) : ~new_n383_;
  assign new_n383_ = (new_n384_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n384_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n385_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n387_ & ~x47;
  assign new_n387_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n389_ & x46 & ~x47 & ~x48) | (new_n390_ & ~x46 & x47 & x48));
  assign new_n389_ = new_n137_ & ~x49 & ~x50;
  assign new_n390_ = x52 & ~x53 & x49 & x50;
  assign z24 = ~x48 & new_n392_ & x49;
  assign new_n392_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  ...
  assign new_n397_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n399_ & x49;
  assign new_n399_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n401_ & x47;
  assign new_n401_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n403_ & x52;
  assign new_n403_ = ~x51 & ~x50 & new_n364_ & x49;
  assign z37 = ~x53 & new_n403_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n364_ & x49;
  assign z39 = ~x46 & ~x47 & new_n407_ & x48;
  assign new_n407_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n362_ & x49;
  assign z44 = ~x46 & new_n410_ & ~x47;
  assign new_n410_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
  assign z48 = ~x53 & ~x52 & x51 & new_n412_ & ~x50;
  assign new_n412_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z00 = 1'b0;
  assign z05 = 1'b0;
  assign z10 = 1'b0;
  assign z22 = 1'b0;
