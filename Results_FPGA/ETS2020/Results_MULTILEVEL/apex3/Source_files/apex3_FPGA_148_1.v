...
module FAU ( 
  ...
  assign new_n389_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  ...
  assign z35 = (x49 & (new_n400_ | (new_n401_ & ~x46))) | (~x46 & new_n402_ & ~x47);
  assign new_n400_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n401_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n402_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
