// Benchmark "FAU" written by ABC on Wed Aug  5 13:56:44 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n368_, new_n369_, new_n372_, new_n374_, new_n376_, new_n378_,
    new_n379_, new_n380_, new_n382_, new_n384_, new_n387_, new_n388_,
    new_n389_, new_n391_, new_n393_, new_n394_, new_n396_, new_n397_,
    new_n401_, new_n405_, new_n407_, new_n408_;
  ...
  assign z22 = (~x46 & (x47 ? new_n368_ : new_n367_)) | (new_n369_ & new_n159_ & x46 & ~x47);
  ...
  assign new_n372_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  ...
  assign z40 = ~x52 & ((~new_n393_ & ~x51) | (~x46 & new_n394_ & x47));
  assign new_n393_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n394_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n396_ & x47) | (new_n397_ & x46 & ~x47 & ~x48));
  assign new_n396_ = ~x49 & new_n139_ & x51;
  assign new_n397_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n382_ & x52;
  assign z43 = x53 & new_n382_ & ~x52;
  assign z44 = ~x46 & new_n401_ & ~x47;
  assign new_n401_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign new_n408_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
