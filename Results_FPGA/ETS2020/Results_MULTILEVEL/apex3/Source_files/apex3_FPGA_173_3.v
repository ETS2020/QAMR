// Benchmark "FAU" written by ABC on Wed Aug  5 13:56:30 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n471_, new_n474_, new_n476_, new_n478_, new_n479_, new_n480_,
    new_n483_, new_n486_, new_n487_, new_n488_, new_n490_, new_n494_,
    new_n496_, new_n497_, new_n499_, new_n500_, new_n503_, new_n507_,
    new_n509_, new_n510_;
  ...
  assign new_n461_ = new_n283_ & x49 & x50;
  assign new_n462_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n466_ : new_n465_)) | (new_n464_ & new_n168_ & x46 & ~x47);
  assign new_n464_ = new_n112_ & x50 & ~x51;
  ...
  assign new_n471_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  ...
  assign new_n478_ = new_n283_ & new_n141_ & x46 & x48 & ~x49;
  ...
  assign z35 = (~new_n486_ & x49) | (~x46 & ~x47 & x48 & new_n488_ & ~x49);
  assign new_n486_ = (~new_n487_ | x46) & (~new_n283_ | ~new_n141_ | ~x46 | x47 | x48);
  assign new_n487_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n488_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n490_ & x52;
  assign new_n490_ = ~x51 & ~x50 & new_n440_ & x49;
  ...
  assign z40 = ~x52 & ((~new_n496_ & ~x51) | (~x46 & new_n497_ & x47));
  assign new_n496_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n497_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((new_n500_ & x46 & ~x47 & ~x48) | (~x46 & new_n499_ & x47));
  assign new_n499_ = ~x49 & new_n140_ & x51;
  assign new_n500_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n438_ & x49;
  assign z44 = ~x46 & new_n503_ & ~x47;
  assign new_n503_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n476_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n134_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n507_ & ~x50;
  assign new_n507_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n509_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
  assign new_n509_ = ~new_n510_ & ~x50;
