// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:08 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n462_, new_n463_, new_n464_, new_n467_, new_n469_, new_n471_,
    new_n474_, new_n476_, new_n478_, new_n479_, new_n480_, new_n483_,
    new_n486_, new_n488_, new_n489_, new_n490_, new_n492_, new_n496_,
    new_n498_, new_n499_, new_n501_, new_n502_, new_n505_, new_n509_,
    new_n511_, new_n512_;
  ...
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n436_ & ~x49;
  ...
  assign new_n440_ = ~new_n441_ & (x47 | ((new_n442_ | ~x52) & (~new_n443_ | ~x46)));
  assign new_n441_ = new_n283_ & x51 & ~x46 & x48 & ~x49;
  assign new_n442_ = (~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n443_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n444_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  ...
  assign new_n448_ = x52 & ((~x47 & ((~x51 & x53 & ~x46 & ~x50) | (x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n449_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n450_ = new_n283_ & x50 & ~x51;
  ...
  assign new_n454_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n455_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z20 = ~x46 & new_n457_ & ~x47;
  assign new_n457_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n460_ & x46 & ~x47 & ~x48) | (new_n459_ & ~x46 & x47 & x48));
  assign new_n459_ = new_n283_ & x49 & x50;
  assign new_n460_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n464_ : new_n463_)) | (new_n462_ & new_n168_ & x46 & ~x47);
  assign new_n462_ = new_n112_ & x50 & ~x51;
  ...
  assign z31 = ~x53 & x52 & x51 & ~x50 & new_n436_ & x49;
  ...
  assign z41 = ~x50 & ((new_n502_ & x46 & ~x47 & ~x48) | (~x46 & new_n501_ & x47));
  assign new_n501_ = ~x49 & new_n140_ & x51;
  assign new_n502_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n436_ & x49;
  assign z44 = ~x46 & new_n505_ & ~x47;
  assign new_n505_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n511_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
  assign new_n511_ = ~new_n512_ & ~x50;
  assign new_n512_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z08 = 1'b0;
  assign z09 = 1'b0;
  assign z19 = 1'b0;
  assign z43 = 1'b0;
