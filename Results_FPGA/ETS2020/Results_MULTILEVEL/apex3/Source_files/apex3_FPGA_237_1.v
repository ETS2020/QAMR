...
module FAU ( 
  ...
  assign z19 = x46 ? (~x47 & ~x48 & new_n361_ & x49) : ~new_n358_;
  assign new_n358_ = (new_n360_ | x49) & (~new_n359_ | ~new_n209_ | x47 | x48 | ~x49);
  ...
  assign z21 = x51 & ((new_n366_ & x46 & ~x47 & ~x48) | (new_n367_ & ~x46 & x47 & x48));
  assign new_n366_ = new_n359_ & ~x49 & ~x50;
  assign new_n367_ = new_n251_ & x49 & x50;
  ...
  assign z35 = (x49 & (new_n393_ | (new_n394_ & ~x46))) | (~x46 & new_n395_ & ~x47);
  assign new_n393_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n394_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n395_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
