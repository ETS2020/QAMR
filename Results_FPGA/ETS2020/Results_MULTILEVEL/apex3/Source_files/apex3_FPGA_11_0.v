// Benchmark "FAU" written by ABC on Wed Aug  5 13:51:56 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n301_, new_n303_, new_n305_, new_n308_, new_n310_, new_n312_,
    new_n313_, new_n314_, new_n316_, new_n319_, new_n321_, new_n322_,
    new_n323_, new_n325_, new_n329_, new_n331_, new_n337_, new_n338_;
  ...
  assign z18 = x46 ? (~new_n285_ & ~x47) : (x47 & new_n286_ & ~x49);
  assign new_n285_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n286_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (x23 & x48 & ~x51 & ~x52));
  assign z19 = x46 ? new_n289_ : (new_n288_ | (~new_n291_ & ~x49));
  assign new_n288_ = new_n145_ & ~x50 & ~x51 & ~x47 & ~x48 & x49;
  assign new_n289_ = ~x47 & ~x48 & x49 & ~new_n290_ & ~x53;
  assign new_n290_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n291_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z21 = x51 & (new_n293_ | (new_n294_ & new_n145_ & ~x49 & ~x50));
  assign new_n293_ = new_n196_ & x49 & x50 & ~x46 & x47 & x48;
  assign new_n294_ = x46 & ~x47 & ~x48;
  assign z22 = new_n296_ | (~x46 & (x47 ? new_n298_ : new_n297_));
  assign new_n296_ = new_n112_ & x50 & ~x51 & new_n113_ & ~x48 & x49;
  assign new_n297_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n298_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n196_ & x51;
  assign z24 = ~x48 & new_n301_ & x49;
  assign new_n301_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n303_ & ~x47;
  assign new_n303_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n305_ & x52;
  assign new_n305_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n283_ & ~x49;
  assign z28 = ~x46 & ~new_n308_ & x47;
  assign new_n308_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n310_ & ~x52;
  assign new_n310_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n312_ | (~x48 & (new_n313_ | (new_n314_ & x46))));
  assign new_n312_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  ...
  assign z35 = (~x46 & new_n323_ & ~x47) | (x49 & (new_n321_ | (new_n322_ & ~x46)));
  assign new_n321_ = new_n294_ & new_n196_ & ~x50 & x51;
  assign new_n322_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n323_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n325_ & x52;
  assign new_n325_ = ~x51 & ~x50 & new_n283_ & x49;
  ...
  assign z41 = ~x50 & (new_n331_ | (new_n294_ & new_n112_ & x49 & ~x51));
  assign new_n331_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  ...
  assign z49 = (~x48 & (new_n337_ | (new_n214_ & ~x46 & x47 & ~x49))) | (new_n214_ & x48 & ~x49 & x46 & ~x47);
  assign new_n337_ = ~new_n338_ & ~x50;
  assign new_n338_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
