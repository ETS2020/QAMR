// Benchmark "FAU" written by ABC on Wed Aug  5 13:51:38 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n393_, new_n395_, new_n397_, new_n401_, new_n403_, new_n404_,
    new_n407_, new_n409_;
  ...
  assign new_n362_ = (~x53 | (x49 ? (x48 ? ((x51 | x52) & (x50 | ~x51 | ~x52)) : (~x50 | ~x51)) : ((x51 | ~x52 | ~x48 | x50) & (~x51 | x52 | x48 | ~x50)))) & (x48 | ~x49 | x53 | (x50 ? (x51 | x52) : (x51 & (~x51 | ~x52))));
  assign z13 = x53 & x52 & ~x51 & ~x50 & new_n364_ & ~x49;
  assign new_n364_ = ~x48 & ~x46 & ~x47;
  assign z14 = ~x53 & ~x52 & ~x51 & x50 & new_n366_ & x49;
  assign new_n366_ = x48 & ~x46 & ~x47;
  assign z15 = x50 ? ~new_n368_ : (x46 ? new_n373_ : ~new_n372_);
  assign new_n368_ = ~new_n371_ & (x47 | ((new_n369_ | ~x52) & (~new_n370_ | ~x46)));
  assign new_n369_ = (~x51 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n370_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n371_ = x51 & x52 & ~x53 & ~x46 & x48 & ~x49;
  assign new_n372_ = x47 ? ((~x51 | x52 | ~x48 | x49) & (~x49 | x51 | ~x52 | x53)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n373_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z17 = ~x47 & new_n375_ & ~x49;
  assign new_n375_ = x52 & ((~x46 & ~x48 & x51 & (~x50 ^ ~x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z19 = x46 ? (~x47 & new_n379_ & ~x48) : ~new_n377_;
  assign new_n377_ = (new_n378_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n378_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n379_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n381_ & ~x47;
  assign new_n381_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n383_ & x46 & ~x47 & ~x48) | (new_n384_ & ~x46 & x47 & x48));
  assign new_n383_ = new_n137_ & ~x49 & ~x50;
  assign new_n384_ = x52 & ~x53 & x49 & x50;
  assign z24 = ~x48 & new_n386_ & x49;
  assign new_n386_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n388_ & ~x47;
  assign new_n388_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n366_ & ~x49;
  assign z28 = ~x46 & ~new_n391_ & x47;
  assign new_n391_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n393_ & x49;
  assign new_n393_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n395_ & x47;
  assign new_n395_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n397_ & x52;
  assign new_n397_ = ~x51 & ~x50 & new_n366_ & x49;
  assign z37 = ~x53 & new_n397_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n366_ & x49;
  assign z39 = ~x46 & ~x47 & new_n401_ & x48;
  assign new_n401_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n403_ & ~x51) | (~x46 & new_n404_ & x47));
  assign new_n403_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n404_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n364_ & x49;
  assign z44 = ~x46 & new_n407_ & ~x47;
  assign new_n407_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
