...
module FAU ( 
  ...
  assign new_n319_ = new_n196_ & new_n140_ & x46 & x48 & ~x49;
  ...
  assign z35 = (~new_n328_ & x49) | (~x46 & ~x47 & x48 & new_n330_ & ~x49);
  assign new_n328_ = (x46 | ~x50 | ~new_n329_ | x51) & (~new_n303_ | ~new_n196_ | x50 | ~x51);
  assign new_n329_ = x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n330_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
