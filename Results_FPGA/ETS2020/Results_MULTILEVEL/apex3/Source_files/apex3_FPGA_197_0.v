// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:09 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n317_, new_n319_, new_n321_, new_n324_, new_n326_, new_n327_,
    new_n328_, new_n330_, new_n333_, new_n335_, new_n336_, new_n337_,
    new_n339_, new_n343_, new_n345_, new_n346_, new_n348_, new_n352_,
    new_n356_, new_n357_;
  ...
  assign z17 = ~x47 & new_n299_ & ~x49;
  assign new_n299_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n301_ & ~x47) : (x47 & new_n302_ & ~x49);
  assign new_n301_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n302_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (x23 & x48 & ~x51 & ~x52));
  assign z19 = x46 ? new_n305_ : (new_n304_ | (~new_n307_ & ~x49));
  assign new_n304_ = new_n145_ & ~x50 & ~x51 & ~x47 & ~x48 & x49;
  assign new_n305_ = ~x47 & ~x48 & x49 & ~new_n306_ & ~x53;
  assign new_n306_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n307_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z21 = x51 & (new_n309_ | (new_n310_ & new_n145_ & ~x49 & ~x50));
  assign new_n309_ = new_n196_ & x49 & x50 & ~x46 & x47 & x48;
  assign new_n310_ = x46 & ~x47 & ~x48;
  assign z22 = new_n312_ | (~x46 & (x47 ? new_n314_ : new_n313_));
  assign new_n312_ = new_n112_ & x50 & ~x51 & new_n113_ & ~x48 & x49;
  assign new_n313_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n314_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n196_ & x51;
  assign z24 = ~x48 & new_n317_ & x49;
  assign new_n317_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n319_ & ~x47;
  assign new_n319_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  ...
  assign z30 = ~x47 & (new_n326_ | (~x48 & (new_n327_ | (new_n328_ & x46))));
  assign new_n326_ = x46 & x48 & ~x49 & new_n196_ & ~x50 & x51;
  assign new_n327_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n328_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n330_ & x52;
  assign new_n330_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z33 = ~x53 & new_n324_ & ~x52;
  assign z34 = ~x46 & new_n333_ & x47;
  assign new_n333_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~x46 & new_n337_ & ~x47) | (x49 & (new_n335_ | (new_n336_ & ~x46)));
  assign new_n335_ = new_n310_ & new_n196_ & ~x50 & x51;
  assign new_n336_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n337_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n339_ & x52;
  assign new_n339_ = ~x51 & ~x50 & new_n285_ & x49;
  assign z37 = ~x53 & new_n339_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n285_ & x49;
  assign z39 = ~x46 & ~x47 & new_n343_ & x48;
  assign new_n343_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n345_ & ~x51) | (~x46 & new_n346_ & x47));
  assign new_n345_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n346_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & (new_n348_ | (new_n310_ & new_n112_ & x49 & ~x51));
  assign new_n348_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n330_ & x52;
  assign z43 = x53 & new_n330_ & ~x52;
  assign z44 = ~x46 & new_n352_ & ~x47;
  assign new_n352_ = x48 & ~x49 & ((x50 & (x51 ^ x52)) | (~x50 & ~x51 & x52 & x53));
  assign z46 = x53 & new_n324_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n111_ & ~x50;
  assign z49 = (~x48 & (new_n356_ | (new_n214_ & ~x46 & x47 & ~x49))) | (new_n214_ & x48 & ~x49 & x46 & ~x47);
  assign new_n356_ = ~new_n357_ & ~x50;
  assign new_n357_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
