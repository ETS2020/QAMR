// Benchmark "FAU" written by ABC on Wed Aug  5 13:58:00 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n375_, new_n376_, new_n377_, new_n380_, new_n382_, new_n384_,
    new_n386_, new_n388_, new_n389_, new_n390_, new_n392_, new_n394_,
    new_n397_, new_n399_, new_n400_, new_n401_, new_n403_, new_n405_,
    new_n407_, new_n408_, new_n412_, new_n416_, new_n418_, new_n419_;
  ...
  assign z19 = x46 ? new_n369_ : (new_n368_ | (~new_n371_ & ~x49));
  assign new_n368_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n369_ = ~x47 & ~x48 & x49 & ~new_n370_ & ~x53;
  assign new_n370_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  ...
  assign z22 = (~x46 & (x47 ? new_n376_ : new_n375_)) | (new_n377_ & new_n159_ & x46 & ~x47);
  assign new_n375_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n376_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n377_ = ~x52 & ~x53 & x50 & ~x51;
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n251_ & x51;
  assign z24 = ~x48 & new_n380_ & x49;
  assign new_n380_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  ...
  assign new_n388_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n389_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  ...
  assign z33 = ~x53 & new_n386_ & ~x52;
  assign z34 = ~x46 & new_n397_ & x47;
  assign new_n397_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n399_ & x49) | (~x46 & ~x47 & x48 & new_n401_ & ~x49);
  assign new_n399_ = (~new_n400_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n400_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n401_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  ...
  assign z41 = ~x50 & ((~x46 & new_n407_ & x47) | (new_n408_ & x46 & ~x47 & ~x48));
  assign new_n407_ = ~x49 & new_n139_ & x51;
  assign new_n408_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n392_ & x52;
  assign z43 = x53 & new_n392_ & ~x52;
  assign z44 = ~x46 & new_n412_ & ~x47;
  assign new_n412_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n418_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n418_ = ~new_n419_ & ~x50;
  assign new_n419_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z16 = 1'b0;
