// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:17 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n397_, new_n398_, new_n402_, new_n406_, new_n408_, new_n409_;
  ...
  assign new_n376_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n378_ & ~x52;
  assign new_n378_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n380_ | (~x48 & (new_n381_ | (new_n382_ & x46))));
  assign new_n380_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  ...
  assign new_n391_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n392_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n393_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
