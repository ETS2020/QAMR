...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n394_, new_n396_, new_n398_, new_n401_, new_n403_, new_n404_,
    new_n405_, new_n407_, new_n409_, new_n410_, new_n414_, new_n418_,
    new_n420_, new_n421_;
  ...
  assign z24 = ~x48 & new_n384_ & x49;
  assign new_n384_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z26 = ~x51 & ~new_n386_ & x52;
  assign new_n386_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z28 = ~x46 & ~new_n388_ & x47;
  assign new_n388_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n390_ & ~x52;
  assign new_n390_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n392_ | (~x48 & (new_n393_ | (new_n394_ & x46))));
  assign new_n392_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n393_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n394_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n396_ & x52;
  ...
  assign z35 = (~new_n403_ & x49) | (~x46 & ~x47 & x48 & new_n405_ & ~x49);
  assign new_n403_ = (~new_n404_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n404_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n405_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  ...
  assign z42 = x53 & new_n396_ & x52;
  assign z43 = x53 & new_n396_ & ~x52;
  assign z44 = ~x46 & new_n414_ & ~x47;
  assign new_n414_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n390_ & x52;
