// Benchmark "FAU" written by ABC on Wed Aug  5 13:56:31 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n462_, new_n464_, new_n466_, new_n469_, new_n471_, new_n473_,
    new_n474_, new_n475_, new_n478_, new_n481_, new_n482_, new_n483_,
    new_n485_, new_n489_, new_n491_, new_n492_, new_n494_, new_n495_,
    new_n498_, new_n502_, new_n504_, new_n505_;
  ...
  assign z21 = x51 & ((new_n455_ & x46 & ~x47 & ~x48) | (new_n454_ & ~x46 & x47 & x48));
  assign new_n454_ = new_n283_ & x49 & x50;
  assign new_n455_ = ~x52 & x53 & ~x49 & ~x50;
  assign z22 = (~x46 & (x47 ? new_n459_ : new_n458_)) | (new_n457_ & new_n168_ & x46 & ~x47);
  assign new_n457_ = new_n112_ & x50 & ~x51;
  assign new_n458_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n459_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n283_ & x51;
  assign z24 = ~x48 & new_n462_ & x49;
  assign new_n462_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n464_ & ~x47;
  assign new_n464_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n466_ & x52;
  assign new_n466_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n436_ & ~x49;
  assign z28 = ~x46 & ~new_n469_ & x47;
  assign new_n469_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z29 = x53 & new_n471_ & ~x52;
  assign new_n471_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n473_ | (~x48 & (new_n474_ | (new_n475_ & x46))));
  assign new_n473_ = new_n283_ & new_n141_ & x46 & x48 & ~x49;
  assign new_n474_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n475_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign z35 = (~new_n481_ & x49) | (~x46 & ~x47 & x48 & new_n483_ & ~x49);
  assign new_n481_ = (~new_n482_ | x46) & (~new_n283_ | ~new_n141_ | ~x46 | x47 | x48);
  assign new_n482_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n483_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n485_ & x52;
  assign new_n485_ = ~x51 & ~x50 & new_n436_ & x49;
  assign z37 = ~x53 & new_n485_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n436_ & x49;
  assign z39 = ~x46 & ~x47 & new_n489_ & x48;
  assign new_n489_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z40 = ~x52 & ((~new_n491_ & ~x51) | (~x46 & new_n492_ & x47));
  assign new_n491_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n492_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((new_n495_ & x46 & ~x47 & ~x48) | (~x46 & new_n494_ & x47));
  assign new_n494_ = ~x49 & new_n140_ & x51;
  assign new_n495_ = new_n112_ & x49 & ~x51;
  assign z42 = x53 & x52 & x51 & ~x50 & new_n434_ & x49;
  assign z44 = ~x46 & new_n498_ & ~x47;
  assign new_n498_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n504_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x48 & ~x49 & x46 & ~x47);
  assign new_n504_ = ~new_n505_ & ~x50;
  assign new_n505_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z08 = 1'b0;
  assign z09 = 1'b0;
  assign z12 = 1'b0;
  assign z18 = 1'b0;
