// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:19 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n386_, new_n388_, new_n391_, new_n393_, new_n394_, new_n395_,
    new_n397_, new_n399_, new_n400_, new_n404_, new_n408_, new_n410_,
    new_n411_;
  ...
  assign z16 = (~new_n354_ & ~x48) | (new_n357_ & ~x46 & x47 & x48 & x49);
  assign new_n354_ = (~new_n355_ | x49) & (x46 | ~x47 | ~new_n356_ | ~x49);
  assign new_n355_ = x52 & ((~x47 & ((~x51 & x53 & ~x46 & ~x50) | (x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n356_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n357_ = new_n251_ & x50 & ~x51;
  assign z17 = ~x47 & new_n359_ & ~x49;
  assign new_n359_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n361_ & ~x47) : (x47 & new_n362_ & ~x49);
  assign new_n361_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n362_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? new_n365_ : (new_n364_ | (~new_n367_ & ~x49));
  assign new_n364_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n365_ = ~x47 & ~x48 & x49 & ~new_n366_ & ~x53;
  assign new_n366_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n367_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n369_ & ~x47;
  assign new_n369_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n372_ : new_n371_)) | (new_n373_ & new_n159_ & x46 & ~x47);
  assign new_n371_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n372_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n373_ = ~x52 & ~x53 & x50 & ~x51;
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n251_ & x51;
  assign z26 = ~x51 & ~new_n376_ & x52;
  assign new_n376_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z28 = ~x46 & ~new_n378_ & x47;
  assign new_n378_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n380_ & ~x52;
  assign new_n380_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n382_ | (~x48 & (new_n383_ | (new_n384_ & x46))));
  assign new_n382_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n383_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  ...
  assign z35 = (~new_n393_ & x49) | (~x46 & ~x47 & x48 & new_n395_ & ~x49);
  assign new_n393_ = (~new_n394_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n394_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n395_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z39 = ~x46 & ~x47 & new_n397_ & x48;
  assign new_n397_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & ((~x46 & new_n399_ & x47) | (new_n400_ & x46 & ~x47 & ~x48));
  assign new_n399_ = ~x49 & new_n139_ & x51;
  assign new_n400_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n386_ & x52;
  assign z43 = x53 & new_n386_ & ~x52;
  assign z44 = ~x46 & new_n404_ & ~x47;
  assign new_n404_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n410_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n410_ = ~new_n411_ & ~x50;
  assign new_n411_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
