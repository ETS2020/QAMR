// Benchmark "FAU" written by ABC on Wed Aug  5 13:56:04 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n389_, new_n391_, new_n394_, new_n396_, new_n397_, new_n398_,
    new_n399_, new_n401_, new_n403_, new_n405_, new_n409_, new_n411_,
    new_n412_, new_n415_, new_n417_;
  ...
  assign z30 = ~new_n396_ & ~x47;
  assign new_n396_ = (x48 | (~new_n398_ & (~x46 | ~new_n399_ | ~x49))) & (~new_n397_ | ~x46 | ~x48 | x49);
  assign new_n397_ = ~x50 & x51 & x52 & ~x53;
  assign new_n398_ = ~x51 & (x46 ? (x49 & (x50 ? (~x52 ^ x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n399_ = ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign new_n405_ = ~x51 & ~x50 & new_n364_ & x49;
  ...
  assign z40 = ~x52 & ((~new_n411_ & ~x51) | (~x46 & new_n412_ & x47));
  assign new_n411_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n412_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
