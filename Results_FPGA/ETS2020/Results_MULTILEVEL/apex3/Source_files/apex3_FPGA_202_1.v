// Benchmark "FAU" written by ABC on Wed Aug  5 13:57:18 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n386_, new_n387_, new_n389_, new_n391_, new_n394_, new_n396_,
    new_n397_, new_n398_, new_n400_, new_n402_, new_n403_, new_n408_,
    new_n410_, new_n411_;
  ...
  assign z26 = ~x51 & ~new_n379_ & x52;
  assign new_n379_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z28 = ~x46 & ~new_n381_ & x47;
  assign new_n381_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n383_ & ~x52;
  assign new_n383_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n385_ | (~x48 & (new_n386_ | (new_n387_ & x46))));
  assign new_n385_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n386_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n387_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign z33 = ~x53 & new_n383_ & ~x52;
  assign z34 = ~x46 & new_n394_ & x47;
  assign new_n394_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n396_ & x49) | (~x46 & ~x47 & x48 & new_n398_ & ~x49);
  assign new_n396_ = (~new_n397_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n397_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n398_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
