// Benchmark "FAU" written by ABC on Wed Aug  5 13:55:51 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n383_, new_n386_, new_n388_, new_n390_, new_n392_, new_n394_,
    new_n395_, new_n396_, new_n398_, new_n400_, new_n403_, new_n405_,
    new_n406_, new_n407_, new_n409_, new_n411_, new_n412_, new_n418_,
    new_n420_, new_n421_;
  ...
  assign z19 = x46 ? (~x47 & ~x48 & new_n373_ & x49) : ~new_n370_;
  assign new_n370_ = (new_n372_ | x49) & (~new_n371_ | ~new_n209_ | x47 | x48 | ~x49);
  ...
  assign new_n373_ = ~x53 & (x50 ? (~x51 & ~new_n374_ & x52) : (x51 & ~x52));
  assign new_n374_ = ~x10 & ~x11 & ~x25 & (x10 | x11 | x25);
  ...
  assign new_n378_ = new_n371_ & ~x49 & ~x50;
  assign new_n379_ = new_n251_ & x49 & x50;
  assign z22 = (~x46 & (x47 ? new_n382_ : new_n381_)) | (new_n383_ & new_n159_ & x46 & ~x47);
  assign new_n381_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n382_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n383_ = ~x52 & ~x53 & x50 & ~x51;
  ...
  assign new_n390_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n392_ & ~x52;
  assign new_n392_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n394_ | (~x48 & (new_n395_ | (new_n396_ & x46))));
  assign new_n394_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  assign new_n395_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  ...
  assign z35 = (x49 & (new_n405_ | (new_n406_ & ~x46))) | (~x46 & new_n407_ & ~x47);
  assign new_n405_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n406_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n407_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
