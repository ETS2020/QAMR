// Benchmark "FAU" written by ABC on Wed Aug  5 13:55:39 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n374_, new_n375_, new_n377_, new_n380_, new_n382_, new_n384_,
    new_n386_, new_n390_, new_n391_, new_n394_, new_n396_;
  ...
  assign z19 = x46 ? (~x47 & new_n370_ & ~x48) : ~new_n368_;
  assign new_n368_ = (new_n369_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n369_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n370_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n372_ & ~x47;
  assign new_n372_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n374_ & x46 & ~x47 & ~x48) | (new_n375_ & ~x46 & x47 & x48));
  assign new_n374_ = new_n137_ & ~x49 & ~x50;
  ...
  assign new_n380_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n382_ & x49;
  assign new_n382_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n384_ & x47;
  assign new_n384_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n386_ & x52;
  assign new_n386_ = ~x51 & ~x50 & new_n364_ & x49;
  assign z37 = ~x53 & new_n386_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n364_ & x49;
  assign z40 = ~x52 & ((~new_n390_ & ~x51) | (~x46 & new_n391_ & x47));
  assign new_n390_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n391_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n362_ & x49;
  assign z44 = ~x46 & new_n394_ & ~x47;
  assign new_n394_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
