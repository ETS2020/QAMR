// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:06 2020
...
module FAU ( 
  ...
  assign z17 = ~x47 & new_n365_ & ~x49;
  assign new_n365_ = x52 & ((~x46 & ~x48 & x51 & (x50 ^ x53)) | (x46 & x48 & ~x50 & ~x51 & ~x53));
  assign z18 = x46 ? (~new_n367_ & ~x47) : (x47 & new_n368_ & ~x49);
  assign new_n367_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n368_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
