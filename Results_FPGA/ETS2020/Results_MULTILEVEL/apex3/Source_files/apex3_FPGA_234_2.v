// Benchmark "FAU" written by ABC on Wed Aug  5 13:58:12 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n380_, new_n382_, new_n383_, new_n386_, new_n388_, new_n390_,
    new_n392_, new_n396_, new_n397_, new_n400_, new_n402_;
  ...
  assign new_n386_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  ...
  assign z36 = x53 & new_n392_ & x52;
  assign new_n392_ = ~x51 & ~x50 & new_n360_ & x49;
  assign z37 = ~x53 & new_n392_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n360_ & x49;
  assign z40 = ~x52 & ((~new_n396_ & ~x51) | (~x46 & new_n397_ & x47));
  assign new_n396_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n397_ = ~x48 & x50 & ((x11 & x49 & ~x53) | (x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))));
  assign z43 = x53 & ~x52 & x51 & ~x50 & new_n358_ & x49;
  assign z44 = ~x46 & new_n400_ & ~x47;
  assign new_n400_ = x48 & ~x49 & ((x52 & x53 & ~x50 & ~x51) | (x50 & (x51 ^ x52)));
