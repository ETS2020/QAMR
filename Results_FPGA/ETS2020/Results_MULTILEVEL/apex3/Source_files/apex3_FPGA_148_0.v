// Benchmark "FAU" written by ABC on Wed Aug  5 13:55:47 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n301_, new_n303_, new_n305_, new_n308_, new_n310_, new_n311_,
    new_n312_, new_n314_, new_n317_, new_n319_, new_n320_, new_n321_,
    new_n323_, new_n327_, new_n328_, new_n330_, new_n336_, new_n337_;
  ...
  assign new_n319_ = (x46 | ~x50 | ~new_n320_ | x51) & (~new_n294_ | ~new_n196_ | x50 | ~x51);
  assign new_n320_ = x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n321_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n323_ & x52;
  assign new_n323_ = ~x51 & ~x50 & new_n283_ & x49;
  assign z37 = ~x53 & new_n323_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n283_ & x49;
  assign z40 = ~x52 & ((~new_n327_ & ~x51) | (~x46 & new_n328_ & x47));
  assign new_n327_ = (x46 | ~x47 | ~x49 | ~x50 | (~x48 & (x48 | x53))) & (x49 | x50 | ~x53 | ~x46 | x47 | ~x48);
  assign new_n328_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & (new_n330_ | (new_n294_ & new_n112_ & x49 & ~x51));
  assign new_n330_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  ...
  assign z49 = (~x48 & (new_n336_ | (new_n214_ & ~x46 & x47 & ~x49))) | (new_n214_ & x48 & ~x49 & x46 & ~x47);
  assign new_n336_ = ~new_n337_ & ~x50;
  assign new_n337_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
