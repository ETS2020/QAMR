...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n394_, new_n397_, new_n399_, new_n400_, new_n401_, new_n403_,
    new_n405_, new_n406_, new_n408_, new_n409_, new_n413_, new_n417_,
    new_n419_, new_n420_;
  ...
  assign z19 = x46 ? new_n373_ : (new_n372_ | (~new_n375_ & ~x49));
  assign new_n372_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n373_ = ~x47 & ~x48 & x49 & ~new_n374_ & ~x53;
  assign new_n374_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n375_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n377_ & ~x47;
  assign new_n377_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n380_ : new_n379_)) | (new_n381_ & new_n159_ & x46 & ~x47);
  assign new_n379_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n380_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign new_n381_ = ~x52 & ~x53 & x50 & ~x51;
  ...
  assign new_n406_ = ~x48 & x50 & ((x51 & (~x49 | (x49 & (x53 | (~x11 & ~x53))))) | (x11 & x49 & ~x53));
  assign z41 = ~x50 & ((~x46 & new_n408_ & x47) | (new_n409_ & x46 & ~x47 & ~x48));
  assign new_n408_ = ~x49 & new_n139_ & x51;
  assign new_n409_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n392_ & x52;
  assign z43 = x53 & new_n392_ & ~x52;
  assign z44 = ~x46 & new_n413_ & ~x47;
  assign new_n413_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n419_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n419_ = ~new_n420_ & ~x50;
  assign new_n420_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (~x51 | ~x52 | ~x53 | x46 | ~x47 | x49);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z18 = 1'b0;
