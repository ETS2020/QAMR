...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n390_, new_n393_, new_n395_, new_n397_, new_n399_, new_n400_,
    new_n401_, new_n402_, new_n404_, new_n408_, new_n409_, new_n412_,
    new_n414_, new_n416_;
  ...
  assign z35 = (~new_n399_ & x49) | (~x46 & ~x47 & x48 & new_n402_ & ~x49);
  assign new_n399_ = (~new_n401_ | x46) & (~new_n400_ | ~x46 | x47 | x48);
  assign new_n400_ = ~x50 & x51 & x52 & ~x53;
  assign new_n401_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n402_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n404_ & x52;
  assign new_n404_ = ~x51 & ~x50 & new_n362_ & x49;
