...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n394_, new_n395_, new_n397_, new_n399_, new_n402_, new_n404_,
    new_n405_, new_n406_, new_n408_, new_n410_, new_n411_, new_n415_,
  ...
  assign new_n385_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z26 = ~x51 & ~new_n387_ & x52;
  assign new_n387_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z28 = ~x46 & ~new_n389_ & x47;
  assign new_n389_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (x48 | x49 | ~x50 | ~x51 | ~x52 | ~x53);
  assign z29 = x53 & new_n391_ & ~x52;
  assign new_n391_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n393_ | (~x48 & (new_n394_ | (new_n395_ & x46))));
  assign new_n393_ = new_n251_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n394_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n395_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  ...
  assign new_n404_ = (~new_n405_ | x46) & (~new_n251_ | ~new_n140_ | ~x46 | x47 | x48);
  assign new_n405_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n406_ = ~x53 & ((x50 & x51 & ~x52) | (~x51 & x52));
  assign z39 = ~x46 & ~x47 & new_n408_ & x48;
  assign new_n408_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & ((~x46 & new_n410_ & x47) | (new_n411_ & x46 & ~x47 & ~x48));
  assign new_n410_ = ~x49 & new_n139_ & x51;
  assign new_n411_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n397_ & x52;
  assign z43 = x53 & new_n397_ & ~x52;
  assign z44 = ~x46 & new_n415_ & ~x47;
  assign new_n415_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n391_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n112_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n419_ & ~x50;
  assign new_n419_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n421_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n421_ = ~new_n422_ & ~x50;
