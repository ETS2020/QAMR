// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:30 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n366_, new_n369_, new_n371_, new_n373_, new_n375_, new_n376_,
    new_n377_, new_n379_, new_n381_, new_n384_, new_n386_, new_n387_,
    new_n388_, new_n390_, new_n392_, new_n393_, new_n397_, new_n401_,
    new_n403_, new_n404_;
  ...
  assign new_n346_ = (x47 | ((x48 | ~x50 | x51 | ~x52 | ~x53) & (x50 | ~x51 | (x48 ? (x52 ^ ~x53) : (x52 | x53))))) & (~x47 | x48 | x50 | ~x51 | ~x52 | x53);
  assign z11 = (~x46 & new_n350_ & x47) | (~x47 & (new_n348_ | (~new_n349_ & x51)));
  assign new_n348_ = new_n297_ & ~x46 & ~x48 & ~x49;
  assign new_n349_ = (x48 | (x46 ? ((x49 | ~x50 | x52 | x53) & (~x49 | x50 | ~x52 | ~x53)) : (x49 | x53 | (~x50 ^ ~x52)))) & (x46 | ~x48 | x49 | x50 | (x52 ^ ~x53));
  assign new_n350_ = ~x48 & x52 & ~x53 & (x49 ? (x50 & ~x51) : (~x50 & x51));
  assign z12 = ~x46 & ~new_n352_ & x47;
  assign new_n352_ = (~x53 | (x49 ? (x48 ? ((x51 | x52) & (x50 | ~x51 | ~x52)) : (~x50 | ~x51)) : ((x51 | ~x52 | ~x48 | x50) & (~x51 | x52 | x48 | ~x50)))) & (x48 | ~x49 | x53 | (x50 ? (x51 | x52) : (x51 & (~x51 | ~x52))));
  assign z18 = x46 ? (~new_n354_ & ~x47) : (x47 & new_n355_ & ~x49);
  assign new_n354_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n355_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (~x51 & ~x52 & x23 & x48));
  assign z19 = x46 ? new_n358_ : (new_n357_ | (~new_n360_ & ~x49));
  assign new_n357_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n358_ = ~x47 & ~x48 & x49 & ~new_n359_ & ~x53;
  assign new_n359_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n360_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z20 = ~x46 & new_n362_ & ~x47;
  assign new_n362_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z22 = (~x46 & (x47 ? new_n365_ : new_n364_)) | (new_n366_ & new_n159_ & x46 & ~x47);
  assign new_n364_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  ...
  assign new_n371_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z29 = x53 & new_n373_ & ~x52;
  assign new_n373_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n375_ | (~x48 & (new_n376_ | (new_n377_ & x46))));
  assign new_n375_ = x46 & x48 & ~x49 & new_n251_ & ~x50 & x51;
  assign new_n376_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n377_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n379_ & x52;
  assign new_n379_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z32 = ~x47 & ~new_n381_ & x49;
  assign new_n381_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z33 = ~x53 & new_n373_ & ~x52;
  assign z34 = ~x46 & new_n384_ & x47;
  assign new_n384_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (x49 & (new_n386_ | (new_n387_ & ~x46))) | (~x46 & new_n388_ & ~x47);
  assign new_n386_ = x46 & ~x47 & ~x48 & new_n251_ & ~x50 & x51;
  assign new_n387_ = x50 & ~x51 & x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n388_ = x48 & ~x49 & ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z39 = ~x46 & ~x47 & new_n390_ & x48;
  assign new_n390_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & ((~x46 & new_n392_ & x47) | (new_n393_ & x46 & ~x47 & ~x48));
  assign new_n392_ = ~x49 & new_n139_ & x51;
  assign new_n393_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n379_ & x52;
  assign z43 = x53 & new_n379_ & ~x52;
  assign z44 = ~x46 & new_n397_ & ~x47;
  assign new_n397_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = x53 & new_n373_ & x52;
  assign z47 = ~x46 & ~x47 & x48 & ~x49 & new_n112_ & ~x50;
  assign z48 = ~x53 & ~x52 & x51 & new_n401_ & ~x50;
  assign new_n401_ = ~x49 & ~x48 & x47 & ~x46 & x27 & ~x43;
  assign z49 = (~x48 & (new_n403_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n403_ = ~new_n404_ & ~x50;
  assign new_n404_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z09 = 1'b0;
  assign z13 = 1'b0;
