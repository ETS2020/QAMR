...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n372_, new_n374_, new_n375_, new_n376_, new_n379_, new_n381_,
    new_n383_, new_n384_, new_n385_, new_n387_, new_n389_, new_n392_,
    new_n393_, new_n394_, new_n396_, new_n398_, new_n399_, new_n403_,
  ...
  assign z15 = x50 ? ~new_n352_ : (x46 ? new_n357_ : ~new_n356_);
  assign new_n352_ = ~new_n353_ & (x47 | ((new_n354_ | ~x52) & (~new_n355_ | ~x46)));
  assign new_n353_ = ~x46 & x48 & ~x49 & new_n251_ & x51;
  assign new_n354_ = (~x51 | ((x48 | ~x49 | ~x53) & (~x46 | ~x48 | x49 | x53))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  assign new_n355_ = x48 & ~x49 & ~x51 & ((~x04 & ~x53) | (~x52 & (x04 | (~x04 & x53))));
  assign new_n356_ = x47 ? ((~x48 | x49 | ~x51 | x52) & (~x52 | x53 | ~x49 | x51)) : (~x48 | x49 | (x51 ? (~x52 | ~x53) : (x52 | x53)));
  assign new_n357_ = ~x47 & x48 & ~x49 & x53 & (x51 ^ ~x52);
  assign z16 = (~new_n359_ & ~x48) | (new_n362_ & ~x46 & x47 & x48 & x49);
  assign new_n359_ = (~new_n360_ | x49) & (x46 | ~x47 | ~new_n361_ | ~x49);
  assign new_n360_ = x52 & ((~x47 & ((~x51 & x53 & ~x46 & ~x50) | (x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))))) | (~x46 & x47 & x50 & x51 & ~x53));
  assign new_n361_ = x50 & ~x52 & ((x51 & (x53 | (~x11 & ~x53))) | (~x53 & (x11 | ~x51)));
  assign new_n362_ = new_n251_ & x50 & ~x51;
  ...
  assign z19 = x46 ? new_n370_ : (new_n369_ | (~new_n372_ & ~x49));
  assign new_n369_ = new_n159_ & ~x47 & new_n209_ & ~x52 & x53;
  assign new_n370_ = ~x47 & ~x48 & x49 & ~new_n371_ & ~x53;
  assign new_n371_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n372_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z22 = (~x46 & (x47 ? new_n375_ : new_n374_)) | (new_n376_ & new_n159_ & x46 & ~x47);
  ...
  assign z24 = ~x48 & new_n379_ & x49;
  assign new_n379_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
