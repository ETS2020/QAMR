// Benchmark "FAU" written by ABC on Wed Aug  5 13:52:33 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n306_, new_n307_, new_n308_, new_n311_, new_n313_, new_n316_,
    new_n318_, new_n319_, new_n320_, new_n322_, new_n325_, new_n327_,
    new_n328_, new_n329_, new_n331_, new_n335_, new_n337_, new_n343_,
    new_n345_, new_n346_;
  ...
  assign z18 = x46 ? (~new_n295_ & ~x47) : (x47 & new_n296_ & ~x49);
  assign new_n295_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (~x52 | ~x53 | x48 | ~x50))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign new_n296_ = x50 & ~x53 & ((~x48 & (x51 ^ x52)) | (x23 & x48 & ~x51 & ~x52));
  assign z19 = x46 ? new_n299_ : (new_n298_ | (~new_n301_ & ~x49));
  assign new_n298_ = new_n145_ & ~x50 & ~x51 & ~x47 & ~x48 & x49;
  assign new_n299_ = ~x47 & ~x48 & x49 & ~new_n300_ & ~x53;
  assign new_n300_ = x50 ? (x51 | ~x52 | (~x10 & ~x11 & ~x25 & (x10 | x11 | x25))) : (~x51 | x52);
  assign new_n301_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign z21 = x51 & (new_n303_ | (new_n304_ & new_n145_ & ~x49 & ~x50));
  assign new_n303_ = new_n196_ & x49 & x50 & ~x46 & x47 & x48;
  assign new_n304_ = x46 & ~x47 & ~x48;
  assign z22 = new_n306_ | (~x46 & (x47 ? new_n308_ : new_n307_));
  assign new_n306_ = new_n112_ & x50 & ~x51 & new_n113_ & ~x48 & x49;
  assign new_n307_ = ~x52 & (x48 ? (x49 & ~x50 & x51 & x53) : (~x53 & (x49 ? (~x50 & ~x51) : (x50 & x51))));
  assign new_n308_ = x49 & ~x51 & x52 & x53 & (x48 ^ x50);
  assign z23 = ~x46 & x47 & ~x49 & x50 & new_n196_ & x51;
  assign z25 = ~x46 & new_n311_ & ~x47;
  assign new_n311_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n313_ & x52;
  assign new_n313_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n281_ & ~x49;
  assign z29 = x53 & new_n316_ & ~x52;
  assign new_n316_ = x51 & x50 & x49 & x48 & ~x46 & x47;
  assign z30 = ~x47 & (new_n318_ | (~x48 & (new_n319_ | (new_n320_ & x46))));
  assign new_n318_ = new_n196_ & new_n140_ & x46 & x48 & ~x49;
  assign new_n319_ = ~x51 & (x46 ? (x49 & (x50 ? (x52 ^ ~x53) : (x52 & x53))) : (x49 ? (~x50 & ~x52) : (x50 & (~x52 | (x52 & ~x53)))));
  assign new_n320_ = x49 & ~x50 & x51 & (x52 | (~x52 & (x24 | ~x53 | (~x24 & x53))));
  assign z31 = ~x53 & new_n322_ & x52;
  assign new_n322_ = x51 & ~x50 & x49 & ~x48 & ~x46 & ~x47;
  assign z33 = ~x53 & new_n316_ & ~x52;
  assign z34 = ~x46 & new_n325_ & x47;
  assign new_n325_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z35 = (~new_n327_ & x49) | (~x46 & ~x47 & x48 & new_n329_ & ~x49);
  assign new_n327_ = (x46 | ~x50 | ~new_n328_ | x51) & (~new_n304_ | ~new_n196_ | x50 | ~x51);
  assign new_n328_ = x53 & (x47 ? (~x48 & ~x52) : (x48 & x52));
  assign new_n329_ = ~x53 & ((~x51 & x52) | (x50 & x51 & ~x52));
  assign z36 = x53 & new_n331_ & x52;
  assign new_n331_ = ~x51 & ~x50 & new_n281_ & x49;
  assign z37 = ~x53 & new_n331_ & ~x52;
  assign z38 = ~x53 & ~x52 & x51 & ~x50 & new_n281_ & x49;
  assign z39 = ~x46 & ~x47 & new_n335_ & x48;
  assign new_n335_ = ~x49 & ~x52 & x53 & ((~x50 & x51) | (~x24 & x50 & ~x51));
  assign z41 = ~x50 & (new_n337_ | (new_n304_ & new_n112_ & x49 & ~x51));
  assign new_n337_ = ~x46 & x47 & ~x49 & new_n139_ & x51;
  assign z42 = x53 & new_n322_ & x52;
  assign z43 = x53 & new_n322_ & ~x52;
  assign z46 = x53 & new_n316_ & x52;
