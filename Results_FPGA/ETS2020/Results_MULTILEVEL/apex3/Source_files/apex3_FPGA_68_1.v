// Benchmark "FAU" written by ABC on Wed Aug  5 13:53:31 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n397_, new_n399_, new_n401_, new_n402_, new_n406_, new_n410_,
    new_n412_, new_n413_;
  ...
  assign z41 = ~x50 & ((~x46 & new_n401_ & x47) | (new_n402_ & x46 & ~x47 & ~x48));
  assign new_n401_ = ~x49 & new_n139_ & x51;
  assign new_n402_ = ~x52 & ~x53 & x49 & ~x51;
  assign z42 = x53 & new_n388_ & x52;
  assign z43 = x53 & new_n388_ & ~x52;
  assign z44 = ~x46 & new_n406_ & ~x47;
  assign new_n406_ = x48 & ~x49 & ((~x50 & ~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  ...
  assign z49 = (~x48 & (new_n412_ | (new_n297_ & ~x46 & x47 & ~x49))) | (new_n297_ & x48 & ~x49 & x46 & ~x47);
  assign new_n412_ = ~new_n413_ & ~x50;
  assign new_n413_ = (x47 | ((~x46 | ~x49 | ~x52 | (x51 ^ ~x53)) & (x46 | x49 | ~x51 | x52 | ~x53))) & (x46 | ~x47 | x49 | ~x51 | ~x52 | ~x53);
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z14 = 1'b0;
  assign z15 = 1'b0;
