// Benchmark "FAU" written by ABC on Wed Aug  5 13:58:30 2020
...
module FAU ( 
  ...
  assign z16 = (~new_n369_ & ~x48) | (new_n372_ & x48 & x49 & ~x46 & x47);
  assign new_n369_ = (~new_n370_ | x49) & (x46 | ~x47 | ~new_n371_ | ~x49);
  assign new_n370_ = x52 & ((~x47 & ((x46 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x51 & x53 & ~x46 & ~x50))) | (~x46 & x47 & x50 & x51 & ~x53));
  ...
  assign z19 = x46 ? (~x47 & new_n378_ & ~x48) : ~new_n376_;
  assign new_n376_ = (new_n377_ | x49) & (~new_n137_ | ~new_n210_ | x47 | x48 | ~x49);
  assign new_n377_ = x47 ? ((~x48 | ~x53 | (x50 ? (x51 | x52) : (~x51 | ~x52))) & (x48 | ~x50 | ~x51 | x52 | x53)) : (x48 | ((~x50 | (x51 ? (x52 | ~x53) : (~x52 | x53))) & (x50 | ~x51 | ~x52 | x53)));
  assign new_n378_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n233_ & x52) : (x51 & ~x52));
  assign z20 = ~x46 & new_n380_ & ~x47;
  assign new_n380_ = x48 & x49 & ~x50 & x51 & (~x52 ^ ~x53);
  assign z21 = x51 & ((new_n382_ & x46 & ~x47 & ~x48) | (new_n383_ & ~x46 & x47 & x48));
  assign new_n382_ = new_n137_ & ~x49 & ~x50;
  assign new_n383_ = x52 & ~x53 & x49 & x50;
  assign z24 = ~x48 & new_n385_ & x49;
  assign new_n385_ = x52 & ~x53 & ((~x50 & x51 & x46 & ~x47) | (~x46 & x47 & x50 & ~x51));
  assign z25 = ~x46 & new_n387_ & ~x47;
  assign new_n387_ = x48 & x49 & ~x50 & (x51 ? ~x52 : (x52 & x53));
  assign z26 = ~x51 & ~new_n389_ & x52;
  assign new_n389_ = (x46 | ~x47 | x49 | ~x50 | ~x53) & (~x46 | x47 | x48 | ~x49 | x50 | x53);
  assign z27 = x53 & ~x52 & ~x51 & ~x50 & new_n360_ & ~x49;
  assign z28 = ~x46 & ~new_n392_ & x47;
  assign new_n392_ = (~x49 | ((~x51 | ((~x52 | ((x48 | ~x50) & (~x48 | x50) & (x48 | x50 | x53))) & (x52 | ~x53 | x48 | x50))) & (x51 | x52 | x53 | x48 | x50))) & (~x51 | ~x52 | ~x53 | x48 | x49 | ~x50);
  assign z32 = ~x47 & ~new_n394_ & x49;
  assign new_n394_ = (~x51 | ~x52 | ~x53 | ~x46 | x48 | ~x50) & (x51 | x52 | x53 | x46 | ~x48 | x50);
  assign z34 = ~x46 & new_n396_ & x47;
  assign new_n396_ = x49 & ~x50 & ~x51 & ((~x52 & (x53 | (x48 & ~x53))) | (~x48 & x52 & ~x53));
  assign z36 = x53 & new_n398_ & x52;
  assign new_n398_ = ~x51 & ~x50 & new_n360_ & x49;
  assign z37 = ~x53 & new_n398_ & ~x52;
