// Benchmark "FAU" written by ABC on Wed Aug  5 19:57:59 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n51_, new_n53_, new_n56_, new_n57_, new_n58_, new_n60_,
  ...
  assign new_n56_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n57_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n58_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n60_ | new_n61_);
  assign new_n60_ = new_n57_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n61_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = new_n63_ & x09;
  assign new_n63_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n64_ & ~x01));
  assign new_n64_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
