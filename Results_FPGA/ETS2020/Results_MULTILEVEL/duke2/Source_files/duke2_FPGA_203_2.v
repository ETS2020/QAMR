...
module FAU ( 
  ...
  assign z20 = ~x07 & ~x17 & (new_n107_ | (~new_n99_ & ~x09));
  assign new_n99_ = ~new_n104_ & (~x18 | (~new_n100_ & (x05 | ~new_n106_ | x06)));
  assign new_n100_ = ~x21 & (x04 ? new_n101_ : ~new_n103_);
  assign new_n101_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n102_ : ~x06));
  assign new_n102_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n103_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n104_ = new_n105_ & x04 & ~x05 & x12;
  assign new_n105_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n106_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n107_ = new_n108_ & x04 & x05 & x08;
  assign new_n108_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign z27 = new_n117_ | (new_n122_ & ~x07 & x08 & x03 & ~x05);
  assign new_n117_ = ~x09 & ((~x17 & ~new_n118_ & x18) | (~x05 & x17 & ~new_n121_ & ~x18));
  assign new_n118_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n119_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n119_ = ~x21 & (new_n120_ | (~new_n103_ & ~x04));
  assign new_n120_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
