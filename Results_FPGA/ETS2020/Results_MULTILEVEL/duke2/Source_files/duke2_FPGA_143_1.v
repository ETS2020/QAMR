// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:04 2020
...
module FAU ( 
  ...
  assign new_n102_ = ~new_n104_ & (x15 | (x08 ? (~new_n82_ | x14) : new_n103_));
  assign new_n103_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n104_ = x11 & x15 & ~x02 & x08;
  assign new_n105_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  assign new_n106_ = x08 & ~x12 & ~x15;
  assign new_n107_ = ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n116_ : ~new_n111_);
  assign new_n111_ = (x07 | x15 | (x09 ? x19 : ~new_n112_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n112_ = ~x14 & ~new_n113_ & ~x21;
  assign new_n113_ = (~x06 | (~new_n114_ & (~x12 | new_n115_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n115_ | ~x16);
  assign new_n114_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n115_ = x13 & (x02 | ~x11);
  assign new_n116_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n120_ | (~x05 & (new_n88_ | (~new_n118_ & ~x07))));
  assign new_n118_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n119_ | ~x18);
  assign new_n119_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n120_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n122_ & x18;
  assign new_n122_ = (x14 | x15 | (~new_n123_ & ~new_n72_)) & (x08 | ~x15 | ~x19);
  assign new_n123_ = x12 & ((~new_n124_ & ~x06) | (new_n125_ & x06 & x08 & x10));
  assign new_n124_ = (x04 | x08 | ~x21) & (~new_n77_ | ~x08 | ~x10);
  assign new_n125_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n135_ | (~new_n128_ & ~x09));
  assign new_n128_ = ~new_n132_ & (~x18 | (~new_n129_ & (x05 | ~new_n134_ | x06)));
  assign new_n129_ = ~x21 & (x04 ? (new_n130_ & ~x12) : ~new_n105_);
  ...
  assign new_n152_ = ~x21 & (new_n153_ | (~new_n105_ & ~x04));
  ...
  assign new_n163_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
