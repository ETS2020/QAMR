...
module FAU ( 
  ...
  assign new_n90_ = (x09 | (~x05 ^ x15) | (~x07 ^ ~x08)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20;
  assign z09 = new_n107_ | (~x17 & (new_n105_ | (~new_n93_ & x18)));
  assign new_n93_ = (~new_n101_ | x07) & (x15 | (~new_n104_ & ((~new_n94_ & ~new_n103_) | x07)));
  assign new_n94_ = ~x09 & (new_n100_ | (~x21 & (new_n97_ | (new_n95_ & x04))));
  assign new_n95_ = ~new_n96_ & ~x12;
  assign new_n96_ = (x05 | x06 | x08) & (~x13 | x14 | ~x02 | ~x08);
  assign new_n97_ = ~x05 & ((~new_n98_ & x06) | (new_n99_ & x02));
  assign new_n98_ = (x02 | x08 | ~x11) & (x10 | ~x13 | x14 | ~x02 | ~x08);
  assign new_n99_ = x08 & x13 & ~x14 & (x10 ? x12 : ~x06);
  assign new_n100_ = x05 & ~x08 & ~x19;
  assign new_n101_ = ~new_n102_ & x08;
  assign new_n102_ = (~x02 | x05 | x11 | ~x15 | (~x09 & x21)) & (~x05 | x09 | ~x21);
  assign new_n103_ = ~x04 & x05 & x08 & x12 & (x09 | ~x21);
  assign new_n104_ = x05 & x08 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  assign new_n105_ = new_n106_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n106_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  ...
  assign new_n111_ = x05 ? ((~x17 | x18) & (x06 | x08 | x15 | x17 | ~x18)) : (x15 ? ((~x17 | x18) & (x06 | x08 | x17 | ~x18)) : (~x17 | x18));
  assign new_n112_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18 | ~x19);
  assign new_n113_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z12 = ~x09 & ((~new_n115_ & ~x07) | (new_n108_ & ~x05 & x07));
  ...
  assign new_n120_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  ...
  assign new_n142_ = ~x21 & (x04 ? (new_n143_ & ~x12) : ~new_n120_);
  ...
  assign new_n149_ = x09 & ~x12 & ~x15 & x18;
  assign z21 = ~x17 & ~new_n151_ & x18;
  assign new_n151_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n158_ = ~x07 & (new_n159_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n159_ = ~x21 & ((x04 & ~new_n160_ & ~x15) | (x08 & new_n161_ & x15));
  assign new_n160_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  ...
  assign z27 = new_n166_ | (new_n171_ & ~x07 & x08 & x03 & ~x05);
  assign new_n166_ = ~x09 & ((~x17 & ~new_n167_ & x18) | (~x05 & x17 & ~new_n170_ & ~x18));
  assign new_n167_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n168_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n168_ = ~x21 & (new_n169_ | (~new_n120_ & ~x04));
  assign new_n169_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n170_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n171_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n173_ | (new_n180_ & ~x05))) | (~x09 & new_n181_ & x17);
  assign new_n173_ = x18 & ((~new_n174_ & x08) | (~x05 & ~x07 & new_n179_ & ~x08));
  assign new_n174_ = (new_n178_ | x07) & (x05 | ((~new_n175_ | x07) & (new_n177_ | ~x15)));
  assign new_n175_ = ~x09 & x10 & new_n176_ & x12;
  assign new_n176_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n177_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n178_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n179_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
  assign new_n180_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n181_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z02 = 1'b0;
  assign z04 = 1'b0;
  assign z11 = 1'b0;
  assign z14 = 1'b0;
