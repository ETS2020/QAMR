...
module FAU ( 
  ...
  assign z23 = new_n146_ & x18;
  assign new_n146_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n148_ | new_n152_);
  assign new_n148_ = ~x07 & (new_n149_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n149_ = ~x21 & ((x04 & ~new_n150_ & ~x15) | (x08 & new_n151_ & x15));
  assign new_n150_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n151_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n152_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n155_ | (new_n160_ & ~x07 & x08 & x03 & ~x05);
  assign new_n155_ = ~x09 & ((~x17 & ~new_n156_ & x18) | (~x05 & x17 & ~new_n159_ & ~x18));
  assign new_n156_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n157_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n157_ = ~x21 & (new_n158_ | (~new_n126_ & ~x04));
  assign new_n158_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n159_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  ...
  assign new_n168_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
