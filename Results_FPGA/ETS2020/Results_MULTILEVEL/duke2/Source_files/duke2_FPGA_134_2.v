// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:00 2020
...
module FAU ( 
  ...
  assign z18 = ~x05 & ~x07 & ~x09 & new_n97_ & ~x17;
  assign new_n97_ = x18 & ((~x14 & ~new_n98_ & ~x15) | (~x08 & x15 & x19));
  assign new_n98_ = (new_n99_ | ~x02) & (~x12 | (~new_n101_ & (new_n100_ | x06)));
  assign new_n99_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n100_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n101_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z21 = ~x17 & ~new_n104_ & x18;
  assign new_n104_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n106_ & ~x07) | (~x05 & new_n107_ & x07));
  assign new_n106_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)));
  assign new_n107_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign new_n124_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
