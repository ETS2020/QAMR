// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:10 2020
...
module FAU ( 
  ...
  assign new_n80_ = (x14 | (~new_n73_ & new_n81_)) & (x08 | new_n85_ | x21);
  ...
  assign z09 = new_n104_ | (~x17 & (new_n102_ | (~new_n90_ & x18)));
  assign new_n90_ = (~new_n98_ | x07) & (x15 | (~new_n101_ & ((~new_n91_ & ~new_n100_) | x07)));
  assign new_n91_ = ~x09 & (new_n97_ | (~x21 & (new_n94_ | (new_n92_ & x04))));
  assign new_n92_ = ~new_n93_ & ~x12;
  assign new_n93_ = (x05 | x06 | x08) & (~x13 | x14 | ~x02 | ~x08);
  assign new_n94_ = ~x05 & ((~new_n95_ & x06) | (new_n96_ & x02));
  assign new_n95_ = (x02 | x08 | ~x11) & (x10 | ~x13 | x14 | ~x02 | ~x08);
  assign new_n96_ = x08 & x13 & ~x14 & (x10 ? x12 : ~x06);
  assign new_n97_ = x05 & ~x08 & ~x19;
  assign new_n98_ = ~new_n99_ & x08;
  assign new_n99_ = (~x02 | x05 | x11 | ~x15 | (~x09 & x21)) & (~x05 | x09 | ~x21);
  assign new_n100_ = ~x04 & x05 & x08 & x12 & (x09 | ~x21);
  assign new_n101_ = x05 & x08 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  assign new_n102_ = new_n103_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n103_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n104_ = ~x07 & new_n105_ & ~x09;
  assign new_n105_ = ~x15 & x17 & ~x18;
  assign z10 = new_n107_ | (x08 & new_n110_ & ~x15);
  assign new_n107_ = ~x09 & (x07 ? ~new_n109_ : ~new_n108_);
  assign new_n108_ = x05 ? ((~x17 | x18) & (x06 | x08 | x15 | x17 | ~x18)) : (x15 ? ((~x17 | x18) & (x06 | x08 | x17 | ~x18)) : (~x17 | x18));
  assign new_n109_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18 | ~x19);
  assign new_n110_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = new_n112_ & ~x18;
  assign new_n112_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n114_ & ~x07) | (new_n105_ & ~x05 & x07));
  assign new_n114_ = (x17 | ~new_n115_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n115_ = ~x21 & ((~new_n119_ & ~x04) | (~new_n116_ & ~x05) | (new_n120_ & x04 & x05));
  assign new_n116_ = ~new_n118_ & (x15 | (x08 ? (~new_n82_ | x14) : new_n117_));
  ...
  assign new_n127_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  ...
  assign new_n133_ = (~x06 | (~new_n134_ & (~x12 | new_n135_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n135_ | ~x16);
  assign new_n134_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n135_ = x13 & (x02 | ~x11);
  assign new_n136_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n140_ | (~x05 & (new_n88_ | (~new_n138_ & ~x07))));
  ...
  assign z20 = ~x07 & ~x17 & (new_n150_ | (~new_n143_ & ~x09));
  assign new_n143_ = ~new_n147_ & (~x18 | (~new_n144_ & (x05 | ~new_n149_ | x06)));
  assign new_n144_ = ~x21 & (x04 ? (new_n145_ & ~x12) : ~new_n119_);
  assign new_n145_ = ~x15 & (x05 ? x08 : (x08 ? (new_n146_ & x10) : ~x06));
  assign new_n146_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n147_ = new_n148_ & x04 & ~x05 & x12;
  ...
  assign z22 = ~x17 & x18 & ((~new_n155_ & ~x07) | (~x05 & new_n156_ & x07));
  assign new_n155_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n156_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign new_n163_ = ~x21 & (new_n164_ | (~new_n119_ & ~x04));
  ...
  assign new_n173_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n174_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
