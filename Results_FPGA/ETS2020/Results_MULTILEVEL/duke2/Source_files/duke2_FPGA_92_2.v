...
module FAU ( 
  ...
  assign z24 = ~x09 & ~x17 & (new_n118_ | new_n122_);
  assign new_n118_ = ~x07 & (new_n119_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n119_ = ~x21 & ((x04 & ~new_n120_ & ~x15) | (x08 & new_n121_ & x15));
  assign new_n120_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n121_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n122_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  ...
  assign new_n128_ = ~x21 & (new_n129_ | (~new_n109_ & ~x04));
