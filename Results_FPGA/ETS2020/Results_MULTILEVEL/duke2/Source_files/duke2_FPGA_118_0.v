...
module FAU ( 
  ...
  assign new_n130_ = (~x06 | (~new_n131_ & (~x12 | new_n132_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n132_ | ~x16);
  assign new_n131_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n132_ = x13 & (x02 | ~x11);
  assign new_n133_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n137_ | (~x05 & (new_n100_ | (~new_n135_ & ~x07))));
  ...
  assign new_n139_ = (x14 | x15 | (~new_n140_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n140_ = x12 & ((~new_n141_ & ~x06) | (new_n142_ & x06 & x08 & x10));
  assign new_n141_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
