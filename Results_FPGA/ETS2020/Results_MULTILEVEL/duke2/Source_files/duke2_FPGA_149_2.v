// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:08 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n70_, new_n73_, new_n74_, new_n75_, new_n76_, new_n78_, new_n81_,
    new_n82_, new_n83_, new_n84_, new_n85_, new_n86_, new_n87_, new_n91_,
  ...
  assign z21 = ~x17 & ~new_n91_ & x18;
  assign new_n91_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n93_ & ~x07) | (~x05 & new_n94_ & x07));
  assign new_n93_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  assign new_n94_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z24 = ~x09 & ~x17 & (new_n96_ | new_n100_);
  assign new_n96_ = ~x07 & (new_n97_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n97_ = ~x21 & ((x04 & ~new_n98_ & ~x15) | (x08 & new_n99_ & x15));
  assign new_n98_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n99_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n100_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  ...
  assign new_n107_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
