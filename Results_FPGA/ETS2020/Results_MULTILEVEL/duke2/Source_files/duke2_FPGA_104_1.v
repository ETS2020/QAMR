...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n185_, new_n186_, new_n187_, new_n188_, new_n189_;
  ...
  assign new_n119_ = ~new_n121_ & (x15 | (x08 ? (~new_n82_ | x14) : new_n120_));
  ...
  assign new_n137_ = (~x06 | (~new_n138_ & (~x12 | new_n139_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n139_ | ~x16);
  assign new_n138_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n139_ = x13 & (x02 | ~x11);
  assign new_n140_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n144_ | (~x05 & (new_n88_ | (~new_n142_ & ~x07))));
  ...
  assign new_n146_ = (x14 | x15 | (~new_n147_ & ~new_n72_)) & (x08 | ~x15 | ~x19);
  assign new_n147_ = x12 & ((~new_n148_ & ~x06) | (new_n149_ & x06 & x08 & x10));
  assign new_n148_ = (x04 | x08 | ~x21) & (~new_n77_ | ~x08 | ~x10);
  assign new_n149_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n159_ | (~new_n152_ & ~x09));
  assign new_n152_ = ~new_n156_ & (~x18 | (~new_n153_ & (x05 | ~new_n158_ | x06)));
  assign new_n153_ = ~x21 & (x04 ? (new_n154_ & ~x12) : ~new_n122_);
  ...
  assign new_n164_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign z27 = new_n174_ | (new_n179_ & ~x07 & x08 & x03 & ~x05);
  ...
  assign new_n176_ = ~x21 & (new_n177_ | (~new_n122_ & ~x04));
  ...
  assign new_n187_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
