// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:51 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n168_, new_n170_, new_n172_, new_n173_, new_n175_, new_n177_,
  ...
  assign new_n87_ = (x17 | ~x18 | (~new_n62_ & (new_n88_ | x15))) & (~x00 | ~x15 | ~x17 | x18);
  ...
  assign new_n127_ = ~new_n129_ & (x15 | (x08 ? (~new_n90_ | x14) : new_n128_));
  ...
  assign z14 = (~x17 & (new_n134_ | (~x05 & new_n138_ & ~x09))) | (~x05 & new_n140_ & ~x09);
  assign new_n134_ = new_n135_ & x08;
  ...
  assign new_n145_ = (~x06 | (~new_n146_ & (~x12 | new_n147_ | x16))) & ~new_n90_ & (x06 | ~x12 | new_n147_ | ~x16);
  assign new_n146_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n147_ = x13 & (x02 | ~x11);
  assign new_n148_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n152_ | (~x05 & (new_n96_ | (~new_n150_ & ~x07))));
  ...
  assign new_n154_ = (x14 | x15 | (~new_n155_ & ~new_n80_)) & (x08 | ~x15 | ~x19);
  assign new_n155_ = x12 & ((~new_n156_ & ~x06) | (new_n157_ & x06 & x08 & x10));
  assign new_n156_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  ...
  assign new_n161_ = ~x21 & (x04 ? (new_n162_ & ~x12) : ~new_n130_);
  ...
  assign new_n191_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
