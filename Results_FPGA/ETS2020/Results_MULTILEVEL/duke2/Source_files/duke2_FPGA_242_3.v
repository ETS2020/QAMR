// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:58 2020
...
module FAU ( 
  ...
  assign new_n132_ = (~x06 | (~new_n133_ & (~x12 | new_n134_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n134_ | ~x16);
  assign new_n133_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n134_ = x13 & (x02 | ~x11);
  assign new_n135_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n139_ | (~x05 & (new_n100_ | (~new_n137_ & ~x07))));
  ...
  assign new_n141_ = (x14 | x15 | (~new_n142_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n142_ = x12 & ((~new_n143_ & ~x06) | (new_n144_ & x06 & x08 & x10));
  assign new_n143_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  ...
  assign new_n162_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
