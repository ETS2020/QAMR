// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:53 2020
...
module FAU ( 
  ...
  assign new_n87_ = new_n66_ & x04 & x05 & new_n88_ & ~x12 & ~x15;
  ...
  assign new_n121_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  ...
  assign new_n135_ = new_n65_ & new_n88_ & ~x11 & x15;
  ...
  assign new_n139_ = (~new_n78_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  ...
  assign new_n177_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
