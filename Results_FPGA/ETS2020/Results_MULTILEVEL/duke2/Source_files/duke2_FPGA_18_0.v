...
module FAU ( 
  ...
  assign new_n131_ = (~x06 | (~new_n132_ & (~x12 | new_n133_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n133_ | ~x16);
  assign new_n132_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n133_ = x13 & (x02 | ~x11);
  assign new_n134_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n138_ | (~x05 & (new_n99_ | (~new_n136_ & ~x07))));
  ...
  assign new_n140_ = (x14 | x15 | (~new_n141_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n141_ = x12 & ((~new_n142_ & ~x06) | (new_n143_ & x06 & x08 & x10));
  assign new_n142_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n161_ = ~x21 & (new_n162_ | (~new_n126_ & ~x04));
  assign new_n162_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  ...
  assign new_n172_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
