...
module FAU ( 
  ...
  assign z28 = (~x17 & (new_n162_ | (new_n169_ & ~x05))) | (~x09 & new_n170_ & x17);
  assign new_n162_ = x18 & ((~new_n163_ & x08) | (~x05 & ~x07 & new_n168_ & ~x08));
  assign new_n163_ = (new_n167_ | x07) & (x05 | ((~new_n164_ | x07) & (new_n166_ | ~x15)));
  assign new_n164_ = ~x09 & x10 & new_n165_ & x12;
  assign new_n165_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n166_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n167_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n168_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
  assign new_n169_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n170_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z03 = 1'b0;
  assign z09 = 1'b0;
  assign z23 = 1'b0;
  assign z24 = 1'b0;
