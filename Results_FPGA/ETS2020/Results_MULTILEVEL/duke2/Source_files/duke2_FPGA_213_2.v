...
module FAU ( 
  ...
  assign z28 = (~x17 & (new_n121_ | (new_n129_ & ~x05))) | (~x09 & new_n130_ & x17);
  assign new_n121_ = x18 & ((~new_n122_ & x08) | (~x05 & ~x07 & new_n127_ & ~x08));
  assign new_n122_ = (x05 | ((~new_n123_ | x07) & (new_n125_ | ~x15))) & (new_n126_ | x07);
  assign new_n123_ = ~x09 & x10 & new_n124_ & x12;
  assign new_n124_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n125_ = (x02 | (~x09 & (~x11 | x21 | x07 | x09))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n126_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n127_ = ~x09 & ((x15 & ~x19) | (~x14 & new_n128_ & ~x15));
  assign new_n128_ = x21 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  assign new_n129_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n130_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
