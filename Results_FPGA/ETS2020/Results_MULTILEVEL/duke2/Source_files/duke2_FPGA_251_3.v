// Benchmark "FAU" written by ABC on Wed Aug  5 21:22:03 2020
...
module FAU ( 
  ...
  assign new_n140_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  ...
  assign new_n146_ = (~x06 | (~new_n147_ & (~x12 | new_n148_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n148_ | ~x16);
  assign new_n147_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n148_ = x13 & (x02 | ~x11);
  assign new_n149_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n153_ | (~x05 & (new_n99_ | (~new_n151_ & ~x07))));
  assign new_n151_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n152_ | ~x18);
  assign new_n152_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n153_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n163_ | (~new_n156_ & ~x09));
  assign new_n156_ = ~new_n160_ & (~x18 | (~new_n157_ & (x05 | ~new_n162_ | x06)));
  assign new_n157_ = ~x21 & (x04 ? (new_n158_ & ~x12) : ~new_n131_);
  ...
  assign new_n173_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n174_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n175_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n177_ & ~x05;
  assign new_n177_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z28 = (~x17 & (new_n179_ | (new_n186_ & ~x05))) | (~x09 & new_n187_ & x17);
  assign new_n179_ = x18 & ((~new_n180_ & x08) | (~x05 & ~x07 & new_n185_ & ~x08));
  assign new_n180_ = (new_n184_ | x07) & (x05 | ((~new_n181_ | x07) & (new_n183_ | ~x15)));
  assign new_n181_ = ~x09 & x10 & new_n182_ & x12;
  assign new_n182_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n183_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n184_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n185_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
  assign new_n186_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n187_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z07 = 1'b0;
  assign z18 = 1'b0;
  assign z23 = 1'b0;
  assign z26 = 1'b0;
