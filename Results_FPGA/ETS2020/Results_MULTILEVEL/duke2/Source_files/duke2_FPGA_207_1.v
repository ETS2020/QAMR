// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:39 2020
...
module FAU ( 
  ...
  assign new_n115_ = ~new_n117_ & (x15 | (x08 ? (~new_n83_ | x14) : new_n116_));
  ...
  assign new_n132_ = (~x06 | (~new_n133_ & (~x12 | new_n134_ | x16))) & ~new_n83_ & (x06 | ~x12 | new_n134_ | ~x16);
  assign new_n133_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n134_ = x13 & (x02 | ~x11);
  assign new_n135_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n139_ | (~x05 & (new_n89_ | (~new_n137_ & ~x07))));
  ...
  assign new_n141_ = (x14 | x15 | (~new_n142_ & ~new_n73_)) & (x08 | ~x15 | ~x19);
  assign new_n142_ = x12 & ((~new_n143_ & ~x06) | (new_n144_ & x06 & x08 & x10));
  assign new_n143_ = (x04 | x08 | ~x21) & (~new_n78_ | ~x08 | ~x10);
  assign new_n144_ = ~x13 & x16 & ~x21;
  assign z20 = ~x07 & ~x17 & (new_n153_ | (~new_n146_ & ~x09));
  assign new_n146_ = ~new_n150_ & (~x18 | (~new_n147_ & (x05 | ~new_n152_ | x06)));
  assign new_n147_ = ~x21 & (x04 ? (new_n148_ & ~x12) : ~new_n118_);
  assign new_n148_ = ~x15 & (x05 ? x08 : (x08 ? (new_n149_ & x10) : ~x06));
  assign new_n149_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n150_ = new_n151_ & x04 & ~x05 & x12;
  assign new_n151_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n152_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n153_ = new_n154_ & x04 & x05 & x08;
  assign new_n154_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n158_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign new_n163_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n164_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n164_ = ~x21 & (new_n165_ | (~new_n118_ & ~x04));
  assign new_n165_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n166_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n167_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n169_ | (new_n176_ & ~x05))) | (~x09 & new_n177_ & x17);
  assign new_n169_ = x18 & ((~new_n170_ & x08) | (~x05 & ~x07 & new_n175_ & ~x08));
  assign new_n170_ = (new_n174_ | x07) & (x05 | ((~new_n171_ | x07) & (new_n173_ | ~x15)));
  assign new_n171_ = ~x09 & x10 & new_n172_ & x12;
  assign new_n172_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n173_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n174_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n175_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
  assign new_n176_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n177_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z02 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
  assign z11 = 1'b0;
