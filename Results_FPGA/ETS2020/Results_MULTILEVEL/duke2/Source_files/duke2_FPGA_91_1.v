...
module FAU ( 
  ...
  assign new_n118_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  ...
  assign new_n142_ = (x14 | x15 | (~new_n143_ & ~new_n72_)) & (x08 | ~x15 | ~x19);
  assign new_n143_ = x12 & ((~new_n144_ & ~x06) | (new_n145_ & x06 & x08 & x10));
  assign new_n144_ = (x04 | x08 | ~x21) & (~new_n77_ | ~x08 | ~x10);
