...
module FAU ( 
  ...
  assign new_n156_ = ~x21 & (x04 ? (new_n157_ & ~x12) : ~new_n130_);
  ...
  assign new_n165_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n179_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
