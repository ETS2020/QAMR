...
module FAU ( 
  ...
  assign new_n84_ = ~x07 & ~x09 & new_n85_ & ~x15;
  ...
  assign z17 = ~new_n104_ & ~x09;
  assign new_n104_ = (new_n105_ | x05) & (~new_n108_ | x04 | ~x05 | x07 | ~x08);
  assign new_n105_ = (~new_n85_ | ~x07 | x15) & (x07 | ((~new_n85_ | ~x00 | ~x15) & (x08 | ~new_n106_ | x15)));
  assign new_n106_ = ~x17 & x18 & ~new_n107_ & (~x21 | (~x14 & x21));
  assign new_n107_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n108_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & new_n110_ & ~x17;
  assign new_n110_ = x18 & ((~x14 & ~new_n111_ & ~x15) | (~x08 & x15 & x19));
  assign new_n111_ = (new_n112_ | ~x02) & (~x12 | (~new_n114_ & (new_n113_ | x06)));
  assign new_n112_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n113_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n114_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
