// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:36 2020
...
module FAU ( 
  ...
  assign new_n139_ = (x14 | x15 | (~new_n140_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n140_ = x12 & ((~new_n141_ & ~x06) | (new_n142_ & x06 & x08 & x10));
  assign new_n141_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n146_ = ~x21 & (x04 ? (new_n147_ & ~x12) : ~new_n125_);
  ...
  assign new_n159_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign new_n166_ = ~x21 & (new_n167_ | (~new_n125_ & ~x04));
  ...
  assign new_n177_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
