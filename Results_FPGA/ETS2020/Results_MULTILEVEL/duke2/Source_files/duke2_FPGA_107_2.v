...
module FAU ( 
  ...
  assign z20 = ~x07 & ~x17 & (new_n92_ | (~x09 & (new_n84_ | new_n90_)));
  assign new_n84_ = x18 & (new_n87_ | (~x21 & (x04 ? new_n85_ : ~new_n89_)));
  assign new_n85_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n86_ : ~x06));
  assign new_n86_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n87_ = ~x05 & new_n88_ & ~x06;
  assign new_n88_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n89_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n90_ = new_n91_ & x04 & ~x05 & x12;
  assign new_n91_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n92_ = new_n93_ & x04 & x05 & x08;
  assign new_n93_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign z23 = new_n97_ & x18;
  assign new_n97_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z25 = new_n99_ & ~x05;
  assign new_n99_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z27 = new_n104_ | (~x09 & (new_n106_ | (~x17 & ~new_n101_ & x18)));
  assign new_n101_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n102_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n102_ = ~x21 & (new_n103_ | (~new_n89_ & ~x04));
