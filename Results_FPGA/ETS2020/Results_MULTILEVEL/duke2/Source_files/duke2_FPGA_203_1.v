// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:37 2020
...
module FAU ( 
  ...
  assign z09 = new_n103_ | (~x17 & (new_n101_ | (~new_n89_ & x18)));
  assign new_n89_ = (~new_n97_ | x07) & (x15 | (~new_n100_ & (x07 | (~new_n90_ & ~new_n99_))));
  assign new_n90_ = ~x09 & (new_n96_ | (~x21 & (new_n93_ | (new_n91_ & x04))));
  assign new_n91_ = ~new_n92_ & ~x12;
  assign new_n92_ = (x05 | x06 | x08) & (~x13 | x14 | ~x02 | ~x08);
  assign new_n93_ = ~x05 & ((new_n95_ & x02) | (~new_n94_ & x06));
  assign new_n94_ = (x02 | x08 | ~x11) & (x10 | ~x13 | x14 | ~x02 | ~x08);
  assign new_n95_ = x08 & x13 & ~x14 & (x10 ? x12 : ~x06);
  assign new_n96_ = x05 & ~x08 & ~x19;
  assign new_n97_ = ~new_n98_ & x08;
  assign new_n98_ = (~x02 | x05 | x11 | ~x15 | (~x09 & x21)) & (~x05 | x09 | ~x21);
  assign new_n99_ = ~x04 & x05 & x08 & x12 & (x09 | ~x21);
  assign new_n100_ = x05 & x08 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  assign new_n101_ = new_n102_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n102_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n103_ = ~x07 & new_n104_ & ~x09;
  assign new_n104_ = ~x15 & x17 & ~x18;
  assign z10 = new_n106_ | (x08 & new_n109_ & ~x15);
  assign new_n106_ = ~x09 & (x07 ? ~new_n108_ : ~new_n107_);
  assign new_n107_ = x05 ? ((~x17 | x18) & (x06 | x08 | x15 | x17 | ~x18)) : (x15 ? ((~x17 | x18) & (x06 | x08 | x17 | ~x18)) : (~x17 | x18));
  ...
  assign z12 = ~x09 & ((~new_n113_ & ~x07) | (new_n104_ & ~x05 & x07));
  assign new_n113_ = (x17 | ~new_n114_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n114_ = ~x21 & ((~new_n118_ & ~x04) | (~new_n115_ & ~x05) | (new_n119_ & x04 & x05));
  assign new_n115_ = ~new_n117_ & (x15 | (x08 ? (~new_n79_ | x14) : new_n116_));
  ...
  assign new_n124_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  ...
  assign new_n132_ = (~x06 | (~new_n133_ & (~x12 | new_n134_ | x16))) & ~new_n79_ & (x06 | ~x12 | new_n134_ | ~x16);
  assign new_n133_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n134_ = x13 & (x02 | ~x11);
  assign new_n135_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n139_ | (~x05 & (new_n85_ | (~new_n137_ & ~x07))));
  assign new_n137_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n138_ | ~x18);
  assign new_n138_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n139_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n141_ & x18;
  assign new_n141_ = (x14 | x15 | (~new_n142_ & ~new_n69_)) & (x08 | ~x15 | ~x19);
  assign new_n142_ = x12 & ((~new_n143_ & ~x06) | (new_n144_ & x06 & x08 & x10));
  assign new_n143_ = (x04 | x08 | ~x21) & (~new_n74_ | ~x08 | ~x10);
  ...
  assign new_n165_ = ~x21 & (new_n166_ | (~new_n118_ & ~x04));
  assign new_n166_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  ...
  assign new_n176_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n82_ & x21));
