...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n128_, new_n129_, new_n130_, new_n131_, new_n133_, new_n136_,
  ...
  assign z23 = new_n125_ & x18;
  assign new_n125_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n127_ | new_n131_);
  assign new_n127_ = ~x07 & (new_n128_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n128_ = ~x21 & ((x04 & ~new_n129_ & ~x15) | (x08 & new_n130_ & x15));
  assign new_n129_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n130_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n131_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n133_ & ~x05;
  assign new_n133_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  ...
  assign new_n138_ = ~x21 & (new_n139_ | (~new_n116_ & ~x04));
  assign new_n139_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
