// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:54 2020
...
module FAU ( 
  ...
  assign z17 = ~x09 & (new_n149_ | (~x05 & (new_n99_ | (~new_n147_ & ~x07))));
  ...
  assign new_n151_ = (x14 | x15 | (~new_n152_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n152_ = x12 & ((~new_n153_ & ~x06) | (new_n154_ & x06 & x08 & x10));
  assign new_n153_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n167_ = ~x21 & (new_n168_ | (~new_n128_ & ~x04));
  assign new_n168_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n169_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n170_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n172_ | (new_n179_ & ~x05))) | (~x09 & new_n180_ & x17);
  assign new_n172_ = x18 & ((~new_n173_ & x08) | (~x05 & ~x07 & new_n178_ & ~x08));
  assign new_n173_ = (new_n177_ | x07) & (x05 | ((~new_n174_ | x07) & (new_n176_ | ~x15)));
  assign new_n174_ = ~x09 & x10 & new_n175_ & x12;
  ...
  assign new_n178_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
