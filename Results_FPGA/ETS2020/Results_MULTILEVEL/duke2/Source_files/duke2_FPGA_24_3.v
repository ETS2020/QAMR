...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n93_, new_n94_, new_n96_, new_n99_, new_n100_, new_n101_,
  ...
  assign new_n78_ = ~x17 & x18 & ((~new_n83_ & x02) | new_n79_ | new_n81_);
  ...
  assign z06 = ~x09 & (new_n92_ | (~x05 & (new_n94_ | (~new_n85_ & ~x07))));
  assign new_n85_ = (x17 | ~x18 | (~new_n58_ & (new_n86_ | x15))) & (~x17 | x18 | ~x00 | ~x15);
  assign new_n86_ = (x14 | (~new_n79_ & new_n87_)) & (x08 | new_n91_ | x21);
  assign new_n87_ = (~x08 | x21 | (~new_n88_ & ~new_n89_)) & (~new_n90_ | x08 | x12 | ~x21);
  assign new_n88_ = (~x10 | (x04 & x10 & ~x12)) & (~x13 | (~x02 & x11 & x13));
  assign new_n89_ = ~x06 & ((x02 & ~x10 & x13) | (~x13 & ~x16 & x10 & x12));
  ...
  assign new_n94_ = x17 & ~x18 & x07 & ~x15;
  ...
  assign new_n108_ = ~new_n110_ & (x15 | (x08 ? (~new_n88_ | x14) : new_n109_));
  ...
  assign new_n118_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  ...
  assign new_n127_ = (~x06 | (~new_n128_ & (~x12 | new_n129_ | x16))) & ~new_n88_ & (x06 | ~x12 | new_n129_ | ~x16);
  assign new_n128_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n129_ = x13 & (x02 | ~x11);
  assign new_n130_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n134_ | (~x05 & (new_n94_ | (~new_n132_ & ~x07))));
  assign new_n132_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n133_ | ~x18);
  assign new_n133_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n134_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n144_ | (~new_n137_ & ~x09));
  assign new_n137_ = ~new_n141_ & (~x18 | (~new_n138_ & (x05 | ~new_n143_ | x06)));
  assign new_n138_ = ~x21 & (x04 ? (new_n139_ & ~x12) : ~new_n111_);
  ...
  assign new_n147_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign z28 = (~x17 & (new_n163_ | (new_n170_ & ~x05))) | (~x09 & new_n171_ & x17);
  assign new_n163_ = x18 & ((~new_n164_ & x08) | (~x05 & ~x07 & new_n169_ & ~x08));
  assign new_n164_ = (new_n168_ | x07) & (x05 | ((~new_n165_ | x07) & (new_n167_ | ~x15)));
  assign new_n165_ = ~x09 & x10 & new_n166_ & x12;
  assign new_n166_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n167_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n168_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n169_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n91_ & x21));
  assign new_n170_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n171_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z00 = 1'b0;
  assign z04 = 1'b0;
  assign z09 = 1'b0;
  assign z18 = 1'b0;
