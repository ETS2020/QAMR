...
module FAU ( 
  ...
  assign new_n88_ = (~new_n96_ | x07) & (x15 | (~new_n99_ & (x07 | (~new_n89_ & ~new_n98_))));
  ...
  assign new_n92_ = ~x05 & ((new_n94_ & x02) | (~new_n93_ & x06));
  ...
  assign new_n173_ = ~x21 & (new_n174_ | (~new_n117_ & ~x04));
  ...
  assign new_n184_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n82_ & x21));
