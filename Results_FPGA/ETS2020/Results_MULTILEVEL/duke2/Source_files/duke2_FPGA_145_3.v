...
module FAU ( 
  ...
  assign new_n112_ = ~new_n114_ & (x15 | (x08 ? (~new_n92_ | x14) : new_n113_));
  ...
  assign new_n171_ = ~x21 & (new_n172_ | (~new_n115_ & ~x04));
  ...
  assign new_n182_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n95_ & x21));
