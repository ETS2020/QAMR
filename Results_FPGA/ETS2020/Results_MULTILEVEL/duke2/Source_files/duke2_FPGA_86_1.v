...
module FAU ( 
  ...
  assign new_n113_ = (~x06 | (~new_n114_ & (~x12 | new_n115_ | x16))) & ~new_n83_ & (x06 | ~x12 | new_n115_ | ~x16);
  assign new_n114_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n115_ = x13 & (x02 | ~x11);
  assign new_n116_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n120_ | (~x05 & (new_n89_ | (~new_n118_ & ~x07))));
  ...
  assign new_n122_ = (x14 | x15 | (~new_n123_ & ~new_n73_)) & (x08 | ~x15 | ~x19);
  assign new_n123_ = x12 & ((~new_n124_ & ~x06) | (new_n125_ & x06 & x08 & x10));
  assign new_n124_ = (x04 | x08 | ~x21) & (~new_n78_ | ~x08 | ~x10);
  ...
  assign new_n154_ = ~x21 & (new_n155_ | (~new_n105_ & ~x04));
  ...
  assign new_n165_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
