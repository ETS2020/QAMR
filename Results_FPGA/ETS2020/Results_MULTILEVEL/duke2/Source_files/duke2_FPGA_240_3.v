...
module FAU ( 
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n112_ | (~x17 & (new_n110_ | (~new_n98_ & x18)));
  assign new_n98_ = (~new_n106_ | x07) & (x15 | (~new_n109_ & (x07 | (~new_n99_ & ~new_n108_))));
  ...
  assign new_n102_ = ~x05 & ((new_n104_ & x02) | (~new_n103_ & x06));
  ...
  assign new_n112_ = ~x07 & new_n113_ & ~x09;
  ...
  assign new_n133_ = (~x11 | ~x15 | x02 | x05) & (~x04 | ~x05 | x12 | x15);
  ...
  assign new_n142_ = (~x06 | (~new_n143_ & (~x12 | new_n144_ | x16))) & ~new_n87_ & (x06 | ~x12 | new_n144_ | ~x16);
  assign new_n143_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n144_ = x13 & (x02 | ~x11);
  assign new_n145_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n149_ | (~x05 & (new_n93_ | (~new_n147_ & ~x07))));
  assign new_n147_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n148_ | ~x18);
  assign new_n148_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n149_ = new_n61_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n151_ & x18;
  assign new_n151_ = (x14 | x15 | (~new_n152_ & ~new_n77_)) & (x08 | ~x15 | ~x19);
  assign new_n152_ = x12 & ((~new_n153_ & ~x06) | (new_n154_ & x06 & x08 & x10));
  assign new_n153_ = (x04 | x08 | ~x21) & (~new_n82_ | ~x08 | ~x10);
  ...
  assign new_n165_ = ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n186_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n90_ & x21));
