// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:19 2020
...
module FAU ( 
  ...
  assign z12 = ~x09 & ((~new_n95_ & ~x07) | (new_n102_ & ~x05 & x07));
  assign new_n95_ = (x17 | ~new_n96_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n96_ = ~x21 & ((~new_n100_ & ~x04) | (~new_n97_ & ~x05) | (new_n101_ & x04 & x05));
  assign new_n97_ = ~new_n99_ & (x15 | (x08 ? (~new_n79_ | x14) : new_n98_));
  assign new_n98_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n99_ = ~x02 & x08 & x11 & x15;
  assign new_n100_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n101_ = x08 & ~x12 & ~x15;
  assign new_n102_ = ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n110_ : ~new_n105_);
  assign new_n105_ = (x07 | x15 | (x09 ? x19 : ~new_n106_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n106_ = ~x14 & ~new_n107_ & ~x21;
  assign new_n107_ = (~x06 | (~new_n108_ & (~x12 | new_n109_ | x16))) & ~new_n79_ & (x06 | ~x12 | new_n109_ | ~x16);
  assign new_n108_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n109_ = x13 & (x02 | ~x11);
  assign new_n110_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n114_ | (~x05 & (new_n85_ | (~new_n112_ & ~x07))));
  assign new_n112_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n113_ | ~x18);
  assign new_n113_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n114_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n116_ & x18;
  assign new_n116_ = (x14 | x15 | (~new_n117_ & ~new_n69_)) & (x08 | ~x15 | ~x19);
  assign new_n117_ = x12 & ((~new_n118_ & ~x06) | (new_n119_ & x06 & x08 & x10));
  assign new_n118_ = (x04 | x08 | ~x21) & (~new_n74_ | ~x08 | ~x10);
  assign new_n119_ = ~x13 & x16 & ~x21;
  assign z20 = ~x07 & ~x17 & (new_n128_ | (~x09 & (new_n121_ | new_n126_)));
  assign new_n121_ = x18 & (new_n122_ | (~x05 & new_n125_ & ~x06));
  assign new_n122_ = ~x21 & (x04 ? (new_n123_ & ~x12) : ~new_n100_);
  assign new_n123_ = ~x15 & (x05 ? x08 : (x08 ? (new_n124_ & x10) : ~x06));
  assign new_n124_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n125_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n126_ = new_n127_ & x04 & ~x05 & x12;
  assign new_n127_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n128_ = new_n129_ & x04 & x05 & x08;
  assign new_n129_ = ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n133_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n134_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n137_ | (new_n142_ & ~x07 & x08 & x03 & ~x05);
  assign new_n137_ = ~x09 & ((~x17 & ~new_n138_ & x18) | (~x05 & x17 & ~new_n141_ & ~x18));
  assign new_n138_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n139_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n139_ = ~x21 & (new_n140_ | (~new_n100_ & ~x04));
  assign new_n140_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n141_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n142_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n144_ | (new_n151_ & ~x05))) | (~x09 & new_n152_ & x17);
  assign new_n144_ = x18 & ((~new_n145_ & x08) | (~x05 & ~x07 & new_n150_ & ~x08));
  assign new_n145_ = (new_n149_ | x07) & (x05 | ((~new_n146_ | x07) & (new_n148_ | ~x15)));
  assign new_n146_ = ~x09 & x10 & new_n147_ & x12;
  assign new_n147_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n148_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n149_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n150_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n82_ & x21));
  assign new_n151_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n152_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z09 = 1'b0;
  assign z11 = 1'b0;
