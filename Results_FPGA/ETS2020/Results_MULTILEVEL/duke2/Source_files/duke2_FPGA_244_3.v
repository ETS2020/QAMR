...
module FAU ( 
  ...
  assign new_n109_ = ~new_n111_ & (x15 | (x08 ? (~new_n91_ | x14) : new_n110_));
  ...
  assign new_n122_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  ...
  assign new_n128_ = (~x06 | (~new_n129_ & (~x12 | new_n130_ | x16))) & ~new_n91_ & (x06 | ~x12 | new_n130_ | ~x16);
  assign new_n129_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n130_ = x13 & (x02 | ~x11);
  assign new_n131_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n135_ | (~x05 & (new_n97_ | (~new_n133_ & ~x07))));
  ...
  assign new_n137_ = (x14 | x15 | (~new_n138_ & ~new_n81_)) & (x08 | ~x15 | ~x19);
  assign new_n138_ = x12 & ((~new_n139_ & ~x06) | (new_n140_ & x06 & x08 & x10));
  assign new_n139_ = (x04 | x08 | ~x21) & (~new_n86_ | ~x08 | ~x10);
  ...
  assign new_n144_ = ~x21 & (x04 ? (new_n145_ & ~x12) : ~new_n112_);
  ...
  assign new_n166_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
