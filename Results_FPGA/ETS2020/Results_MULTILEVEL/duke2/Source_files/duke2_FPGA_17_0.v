// Benchmark "FAU" written by ABC on Wed Aug  5 21:19:56 2020
...
module FAU ( 
  ...
  assign new_n122_ = ~new_n124_ & (x15 | (x08 ? (~new_n94_ | x14) : new_n123_));
  ...
  assign z17 = ~x09 & (new_n145_ | (~x05 & (new_n100_ | (~new_n143_ & ~x07))));
  ...
  assign new_n147_ = (x14 | x15 | (~new_n148_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n166_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign new_n186_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
