// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:54 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n153_, new_n155_, new_n157_, new_n158_, new_n160_, new_n163_,
  ...
  assign new_n118_ = ~new_n120_ & (x15 | (x08 ? (~new_n82_ | x14) : new_n119_));
  ...
  assign new_n135_ = (~x06 | (~new_n136_ & (~x12 | new_n137_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n137_ | ~x16);
  assign new_n136_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n137_ = x13 & (x02 | ~x11);
  assign new_n138_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n142_ | (~x05 & (new_n88_ | (~new_n140_ & ~x07))));
  ...
  assign new_n146_ = ~x21 & (x04 ? (new_n147_ & ~x12) : ~new_n121_);
  ...
  assign new_n155_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n175_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n176_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
