...
module FAU ( 
  ...
  assign new_n141_ = (~x06 | (~new_n142_ & (~x12 | new_n143_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n143_ | ~x16);
  assign new_n142_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n143_ = x13 & (x02 | ~x11);
  assign new_n144_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n148_ | (~x05 & (new_n100_ | (~new_n146_ & ~x07))));
  assign new_n146_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n147_ | ~x18);
  assign new_n147_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n148_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n150_ & x18;
  assign new_n150_ = (x14 | x15 | (~new_n151_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n151_ = x12 & ((~new_n152_ & ~x06) | (new_n153_ & x06 & x08 & x10));
  assign new_n152_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  ...
  assign new_n157_ = ~x21 & (x04 ? (new_n158_ & ~x12) : ~new_n128_);
