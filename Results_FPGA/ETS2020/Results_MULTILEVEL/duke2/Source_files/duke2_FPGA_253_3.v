...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n91_ & ~x05) | (new_n100_ & new_n65_ & x04 & x05));
  assign new_n91_ = (x07 | ((x17 | new_n92_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n92_ = ~new_n93_ & (x15 | (~new_n98_ & (x14 | (~new_n86_ & new_n94_))));
  ...
  assign z12 = ~x09 & ((~new_n110_ & ~x07) | (new_n117_ & ~x05 & x07));
  assign new_n110_ = (x17 | ~new_n111_ | ~x18) & (~x15 | ~x17 | x18 | ~x00 | x05);
  assign new_n111_ = ~x21 & ((~new_n115_ & ~x04) | (~new_n112_ & ~x05) | (new_n116_ & x04 & x05));
  assign new_n112_ = ~new_n114_ & (x15 | (x08 ? (~new_n95_ | x14) : new_n113_));
  assign new_n113_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n114_ = x11 & x15 & ~x02 & x08;
  assign new_n115_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n116_ = x08 & ~x12 & ~x15;
  assign new_n117_ = ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~x17 & (new_n120_ | (~x05 & new_n124_ & ~x09))) | (~x05 & new_n126_ & ~x09);
  assign new_n120_ = new_n121_ & x08;
  assign new_n121_ = x18 & (x07 ? new_n123_ : (~new_n122_ & (x09 | (~x09 & ~x21))));
  assign new_n122_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n123_ = ~x19 & (~x05 ^ ~x15);
  assign new_n124_ = ~x18 & (new_n125_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n125_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n126_ = ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  ...
  assign new_n131_ = (~x06 | (~new_n132_ & (~x12 | new_n133_ | x16))) & ~new_n95_ & (x06 | ~x12 | new_n133_ | ~x16);
  ...
  assign new_n143_ = ~x21 & (x04 ? (new_n144_ & ~x12) : ~new_n115_);
  ...
  assign new_n154_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)));
  ...
  assign new_n166_ = (x02 | (~x09 & (~x11 | x21 | x07 | x09))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n167_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n168_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
