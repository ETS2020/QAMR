// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:30 2020
...
module FAU ( 
  ...
  assign new_n139_ = (~x06 | (~new_n140_ & (~x12 | new_n141_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n141_ | ~x16);
  assign new_n140_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n141_ = x13 & (x02 | ~x11);
  assign new_n142_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n146_ | (~x05 & (new_n100_ | (~new_n144_ & ~x07))));
  ...
  assign new_n148_ = (x14 | x15 | (~new_n149_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n149_ = x12 & ((~new_n150_ & ~x06) | (new_n151_ & x06 & x08 & x10));
  assign new_n150_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  ...
  assign new_n155_ = ~x21 & (x04 ? (new_n156_ & ~x12) : ~new_n126_);
  ...
  assign new_n159_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n160_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n161_ = new_n162_ & x04 & x05 & x08;
  assign new_n162_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n188_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
