...
module FAU ( 
  ...
  assign z14 = (~x17 & (new_n130_ | (~x05 & new_n134_ & ~x09))) | (~x05 & new_n136_ & ~x09);
  assign new_n130_ = new_n131_ & x08;
  assign new_n131_ = x18 & (x07 ? new_n133_ : (~new_n132_ & (x09 | (~x09 & ~x21))));
  assign new_n132_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n133_ = ~x19 & (~x05 ^ ~x15);
  assign new_n134_ = ~x18 & (new_n135_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n135_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n136_ = ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  ...
  assign z17 = ~x09 & (new_n147_ | (~x05 & (new_n100_ | (~new_n145_ & ~x07))));
  assign new_n145_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n146_ | ~x18);
  assign new_n146_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n147_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n149_ & x18;
  assign new_n149_ = (x14 | x15 | (~new_n150_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n150_ = x12 & ((~new_n151_ & ~x06) | (new_n152_ & x06 & x08 & x10));
  assign new_n151_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  ...
  assign new_n156_ = ~x21 & (x04 ? (new_n157_ & ~x12) : ~new_n127_);
  ...
  assign z24 = ~x09 & ~x17 & (new_n170_ | new_n174_);
  assign new_n170_ = ~x07 & (new_n171_ | (~x15 & x18 & ~x05 & ~x08));
  ...
  assign new_n179_ = ~x21 & (new_n180_ | (~new_n127_ & ~x04));
