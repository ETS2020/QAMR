// Benchmark "FAU" written by ABC on Wed Aug  5 21:19:48 2020
...
module FAU ( 
  ...
  assign new_n125_ = ~new_n127_ & (x15 | (x08 ? (~new_n93_ | x14) : new_n126_));
  ...
  assign new_n134_ = (~x06 | (~new_n135_ & (~x12 | new_n136_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n136_ | ~x16);
  assign new_n135_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n136_ = x13 & (x02 | ~x11);
  assign new_n137_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n141_ | (~x05 & (new_n99_ | (~new_n139_ & ~x07))));
  ...
  assign new_n143_ = (x14 | x15 | (~new_n144_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n144_ = x12 & ((~new_n145_ & ~x06) | (new_n146_ & x06 & x08 & x10));
  assign new_n145_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n150_ = ~x21 & (x04 ? (new_n151_ & ~x12) : ~new_n128_);
  ...
  assign new_n159_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign new_n174_ = ~x21 & (new_n175_ | (~new_n128_ & ~x04));
