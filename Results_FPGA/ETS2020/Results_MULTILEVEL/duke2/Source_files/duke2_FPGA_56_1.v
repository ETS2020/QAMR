...
module FAU ( 
  ...
  assign new_n118_ = ~new_n120_ & (x15 | (x08 ? (~new_n81_ | x14) : new_n119_));
  ...
  assign new_n135_ = (~x06 | (~new_n136_ & (~x12 | new_n137_ | x16))) & ~new_n81_ & (x06 | ~x12 | new_n137_ | ~x16);
  assign new_n136_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n137_ = x13 & (x02 | ~x11);
  assign new_n138_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n142_ | (~x05 & (new_n87_ | (~new_n140_ & ~x07))));
  ...
  assign new_n171_ = ~x21 & (new_n172_ | (~new_n121_ & ~x04));
  ...
  assign new_n182_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n84_ & x21));
