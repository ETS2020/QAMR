...
module FAU ( 
  ...
  assign new_n128_ = ~new_n130_ & (x15 | (x08 ? (~new_n91_ | x14) : new_n129_));
  ...
  assign new_n165_ = new_n166_ & x04 & ~x05 & x12;
  assign new_n166_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n167_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n168_ = new_n169_ & x04 & x05 & x08;
  assign new_n169_ = x09 & ~x12 & ~x15 & x18;
  assign z21 = ~x17 & ~new_n171_ & x18;
  assign new_n171_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n173_ & ~x07) | (~x05 & new_n174_ & x07));
  assign new_n173_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign z28 = (~x17 & (new_n180_ | (new_n187_ & ~x05))) | (~x09 & new_n188_ & x17);
  assign new_n180_ = x18 & ((~new_n181_ & x08) | (~x05 & ~x07 & new_n186_ & ~x08));
  ...
  assign new_n184_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n185_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n186_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
