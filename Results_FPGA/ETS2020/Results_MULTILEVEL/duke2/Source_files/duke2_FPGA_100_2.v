...
module FAU ( 
  ...
  assign z27 = new_n117_ | (new_n123_ & ~x07 & x08 & x03 & ~x05);
  assign new_n117_ = ~x09 & ((~x17 & ~new_n118_ & x18) | (~x05 & x17 & ~new_n122_ & ~x18));
  assign new_n118_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n119_ & (~x05 | x08 | x15 | ~x19));
  assign new_n119_ = ~x21 & (new_n121_ | (~new_n120_ & ~x04));
  assign new_n120_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n121_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n122_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n123_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
