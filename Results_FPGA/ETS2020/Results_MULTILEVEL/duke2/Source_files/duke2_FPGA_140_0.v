...
module FAU ( 
  ...
  assign new_n143_ = (~x06 | (~new_n144_ & (~x12 | new_n145_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n145_ | ~x16);
  ...
  assign new_n152_ = (x14 | x15 | (~new_n153_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n193_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
