// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:49 2020
...
module FAU ( 
  ...
  assign new_n103_ = (~new_n111_ | x07) & (x15 | (~new_n114_ & ((~new_n104_ & ~new_n113_) | x07)));
  ...
  assign z14 = (~x17 & (new_n128_ | (~x05 & new_n132_ & ~x09))) | (~x05 & new_n134_ & ~x09);
  assign new_n128_ = new_n129_ & x08;
  assign new_n129_ = x18 & (x07 ? new_n131_ : (~new_n130_ & (x09 | (~x09 & ~x21))));
  assign new_n130_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n131_ = ~x19 & (~x05 ^ ~x15);
  assign new_n132_ = ~x18 & (new_n133_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n133_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n134_ = ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n142_ : ~new_n137_);
  assign new_n137_ = (x07 | x15 | (x09 ? x19 : ~new_n138_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n138_ = ~x14 & ~new_n139_ & ~x21;
  assign new_n139_ = (~x06 | (~new_n140_ & (~x12 | new_n141_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n141_ | ~x16);
  assign new_n140_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n141_ = x13 & (x02 | ~x11);
  assign new_n142_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n146_ | (~x05 & (new_n99_ | (~new_n144_ & ~x07))));
  assign new_n144_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n145_ | ~x18);
  assign new_n145_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n146_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n148_ & x18;
  assign new_n148_ = (x14 | x15 | (~new_n149_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n149_ = x12 & ((~new_n150_ & ~x06) | (new_n151_ & x06 & x08 & x10));
  assign new_n150_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n154_ = ~x21 & (x04 ? (new_n155_ & ~x12) : ~new_n125_);
  ...
  assign z27 = new_n172_ | (new_n177_ & ~x07 & x08 & x03 & ~x05);
  ...
  assign new_n174_ = ~x21 & (new_n175_ | (~new_n125_ & ~x04));
