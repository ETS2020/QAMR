...
module FAU ( 
  ...
  assign z27 = new_n178_ | (new_n183_ & ~x07 & x08 & x03 & ~x05);
  assign new_n178_ = ~x09 & ((~x17 & ~new_n179_ & x18) | (~x05 & x17 & ~new_n182_ & ~x18));
  assign new_n179_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n180_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n180_ = ~x21 & (new_n181_ | (~new_n128_ & ~x04));
