...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n96_ | (~x05 & (new_n98_ | (~new_n89_ & ~x07))));
  assign new_n89_ = (x17 | ~x18 | (~new_n62_ & (new_n90_ | x15))) & (~x00 | ~x15 | ~x17 | x18);
  ...
  assign new_n96_ = new_n66_ & x04 & x05 & new_n97_ & ~x12 & ~x15;
  ...
  assign new_n129_ = ~new_n131_ & (x15 | (x08 ? (~new_n92_ | x14) : new_n130_));
  ...
  assign new_n200_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n95_ & x21));
