...
module FAU ( 
  ...
  assign new_n118_ = (~x06 | (~new_n119_ & (~x12 | new_n120_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n120_ | ~x16);
  assign new_n119_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n120_ = x13 & (x02 | ~x11);
  assign new_n121_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n125_ | (~x05 & (new_n100_ | (~new_n123_ & ~x07))));
  assign new_n123_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n124_ | ~x18);
  assign new_n124_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n125_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n127_ & x18;
  assign new_n127_ = (x14 | x15 | (~new_n128_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n128_ = x12 & ((~new_n129_ & ~x06) | (new_n130_ & x06 & x08 & x10));
  assign new_n129_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  assign new_n130_ = ~x13 & x16 & ~x21;
  assign z20 = ~x07 & ~x17 & (new_n139_ | (~new_n132_ & ~x09));
  assign new_n132_ = ~new_n136_ & (~x18 | (~new_n133_ & (x05 | ~new_n138_ | x06)));
  assign new_n133_ = ~x21 & (x04 ? (new_n134_ & ~x12) : ~new_n112_);
  ...
  assign new_n146_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign new_n153_ = ~x21 & (new_n154_ | (~new_n112_ & ~x04));
