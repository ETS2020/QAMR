...
module FAU ( 
  ...
  assign new_n125_ = (~x06 | (~new_n126_ & (~x12 | new_n127_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n127_ | ~x16);
  assign new_n126_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n127_ = x13 & (x02 | ~x11);
  assign new_n128_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n132_ | (~x05 & (new_n88_ | (~new_n130_ & ~x07))));
  ...
  assign new_n136_ = ~x21 & (x04 ? (new_n137_ & ~x12) : ~new_n119_);
