...
module FAU ( 
  ...
  assign new_n71_ = (x15 | (~new_n82_ & ((~new_n72_ & ~new_n81_) | x07))) & (~new_n79_ | x07);
  ...
  assign new_n75_ = ~x05 & ((~new_n76_ & x06) | (new_n77_ & x02));
  ...
  assign new_n97_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  ...
  assign z20 = ~x07 & ~x17 & (new_n119_ | (~new_n111_ & ~x09));
  assign new_n111_ = ~new_n116_ & (~x18 | (~new_n112_ & (x05 | ~new_n118_ | x06)));
  assign new_n112_ = ~x21 & (x04 ? new_n113_ : ~new_n115_);
  assign new_n113_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n114_ : ~x06));
  assign new_n114_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n115_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n116_ = new_n117_ & x04 & ~x05 & x12;
  assign new_n117_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n118_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n119_ = new_n120_ & x04 & x05 & x08;
  assign new_n120_ = x09 & ~x12 & ~x15 & x18;
  assign z21 = ~x17 & ~new_n122_ & x18;
  assign new_n122_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z23 = new_n124_ & x18;
  assign new_n124_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n126_ | new_n130_);
  assign new_n126_ = ~x07 & (new_n127_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n127_ = ~x21 & ((x04 & ~new_n128_ & ~x15) | (x08 & new_n129_ & x15));
  assign new_n128_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n129_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n130_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n132_ & ~x05;
  assign new_n132_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n135_ | (new_n140_ & ~x07 & x08 & x03 & ~x05);
  assign new_n135_ = ~x09 & ((~x17 & ~new_n136_ & x18) | (~x05 & x17 & ~new_n139_ & ~x18));
  assign new_n136_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n137_ & (~x05 | x08 | x15 | ~x19));
  assign new_n137_ = ~x21 & (new_n138_ | (~new_n115_ & ~x04));
