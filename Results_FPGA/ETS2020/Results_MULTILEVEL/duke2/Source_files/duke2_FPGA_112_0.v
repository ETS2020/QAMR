...
module FAU ( 
  ...
  assign z27 = new_n156_ | (new_n161_ & ~x07 & x08 & x03 & ~x05);
  assign new_n156_ = ~x09 & ((~x17 & ~new_n157_ & x18) | (~x05 & x17 & ~new_n160_ & ~x18));
  assign new_n157_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n158_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n158_ = ~x21 & (new_n159_ | (~new_n125_ & ~x04));
  assign new_n159_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n160_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n161_ = x09 & ~x15 & ~x17 & x18 & x19;
  ...
  assign new_n168_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n169_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
