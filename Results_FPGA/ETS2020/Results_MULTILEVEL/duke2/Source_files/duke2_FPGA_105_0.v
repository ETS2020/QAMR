// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:44 2020
...
module FAU ( 
  ...
  assign z27 = new_n181_ | (new_n186_ & ~x07 & x08 & x03 & ~x05);
  ...
  assign z28 = (~x17 & (new_n188_ | (new_n195_ & ~x05))) | (~x09 & new_n196_ & x17);
  assign new_n188_ = x18 & ((~new_n189_ & x08) | (~x05 & ~x07 & new_n194_ & ~x08));
  assign new_n189_ = (new_n193_ | x07) & (x05 | ((~new_n190_ | x07) & (new_n192_ | ~x15)));
  ...
  assign new_n194_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
  assign new_n195_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n196_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z15 = 1'b0;
  assign z21 = 1'b0;
