// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:40 2020
...
module FAU ( 
  ...
  assign z12 = ~x09 & ((~new_n93_ & ~x07) | (new_n100_ & ~x05 & x07));
  assign new_n93_ = (x17 | ~new_n94_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n94_ = ~x21 & ((~new_n98_ & ~x04) | (~new_n95_ & ~x05) | (new_n99_ & x04 & x05));
  assign new_n95_ = ~new_n97_ & (x15 | (x08 ? (~new_n79_ | x14) : new_n96_));
  assign new_n96_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n97_ = ~x02 & x08 & x11 & x15;
  assign new_n98_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n99_ = x08 & ~x12 & ~x15;
  assign new_n100_ = ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~x17 & (new_n103_ | (~x05 & new_n107_ & ~x09))) | (~x05 & new_n109_ & ~x09);
  assign new_n103_ = new_n104_ & x08;
  assign new_n104_ = x18 & (x07 ? new_n106_ : (~new_n105_ & (x09 | (~x09 & ~x21))));
  assign new_n105_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n106_ = ~x19 & (x05 ^ x15);
  assign new_n107_ = ~x18 & (new_n108_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n108_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n109_ = ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  ...
  assign new_n114_ = (~x06 | (~new_n115_ & (~x12 | new_n116_ | x16))) & ~new_n79_ & (x06 | ~x12 | new_n116_ | ~x16);
  assign new_n115_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n116_ = x13 & (x02 | ~x11);
  assign new_n117_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n121_ | (~x05 & (new_n85_ | (~new_n119_ & ~x07))));
  assign new_n119_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n120_ | ~x18);
  assign new_n120_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n121_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n123_ & x18;
  assign new_n123_ = (x14 | x15 | (~new_n124_ & ~new_n69_)) & (x08 | ~x15 | ~x19);
  assign new_n124_ = x12 & ((~new_n125_ & ~x06) | (new_n126_ & x06 & x08 & x10));
  assign new_n125_ = (x04 | x08 | ~x21) & (~new_n74_ | ~x08 | ~x10);
  ...
  assign new_n130_ = ~x21 & (x04 ? (new_n131_ & ~x12) : ~new_n98_);
  ...
  assign z25 = new_n150_ & ~x05;
  assign new_n150_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  ...
  assign new_n154_ = ~x21 & (new_n155_ | (~new_n98_ & ~x04));
  assign new_n155_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  ...
  assign new_n165_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n82_ & x21));
