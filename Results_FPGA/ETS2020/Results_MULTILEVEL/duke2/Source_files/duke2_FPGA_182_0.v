// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:25 2020
...
module FAU ( 
  ...
  assign z17 = ~x09 & (new_n145_ | (~x05 & (new_n96_ | (~new_n143_ & ~x07))));
  assign new_n143_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n144_ | ~x18);
  assign new_n144_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n145_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n147_ & x18;
  assign new_n147_ = (x14 | x15 | (~new_n148_ & ~new_n80_)) & (x08 | ~x15 | ~x19);
  assign new_n148_ = x12 & ((~new_n149_ & ~x06) | (new_n150_ & x06 & x08 & x10));
  assign new_n149_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
