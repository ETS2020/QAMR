...
module FAU ( 
  ...
  assign new_n89_ = ~x07 & new_n90_ & ~x09;
  ...
  assign z12 = ~x09 & ((~new_n99_ & ~x07) | (new_n90_ & ~x05 & x07));
  assign new_n99_ = (x17 | ~new_n100_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n100_ = ~x21 & ((~new_n105_ & ~x04) | (~new_n101_ & ~x05) | (new_n106_ & x04 & x05));
  assign new_n101_ = ~new_n104_ & (x15 | (x08 ? (~new_n103_ | x14) : new_n102_));
  ...
  assign z14 = (~x17 & (new_n109_ | (~x05 & new_n113_ & ~x09))) | (~x05 & new_n115_ & ~x09);
  ...
  assign z21 = ~x17 & ~new_n119_ & x18;
  assign new_n119_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n121_ & ~x07) | (~x05 & new_n122_ & x07));
  assign new_n121_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)));
  assign new_n122_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign new_n129_ = ~x21 & (new_n130_ | (~new_n105_ & ~x04));
