...
module FAU ( 
  ...
  assign z27 = new_n148_ | (new_n153_ & ~x07 & x08 & x03 & ~x05);
  assign new_n148_ = ~x09 & ((~x17 & ~new_n149_ & x18) | (~x05 & x17 & ~new_n152_ & ~x18));
  assign new_n149_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n150_ & (x15 | ~x19 | ~x05 | x08));
