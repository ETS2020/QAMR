// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:17 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n103_, new_n106_, new_n107_, new_n108_, new_n109_, new_n111_,
  ...
  assign new_n134_ = (~x06 | (~new_n135_ & (~x12 | new_n136_ | x16))) & ~new_n95_ & (x06 | ~x12 | new_n136_ | ~x16);
  assign new_n135_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n136_ = x13 & (x02 | ~x11);
  assign new_n137_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n141_ | (~x05 & (new_n101_ | (~new_n139_ & ~x07))));
  assign new_n139_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n140_ | ~x18);
  assign new_n140_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n141_ = new_n65_ & new_n100_ & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n143_ & x18;
  assign new_n143_ = (x14 | x15 | (~new_n144_ & ~new_n85_)) & (x08 | ~x15 | ~x19);
  assign new_n144_ = x12 & ((~new_n145_ & ~x06) | (new_n146_ & x06 & x08 & x10));
  assign new_n145_ = (~new_n90_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n146_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n156_ | (~new_n149_ & ~x09));
  assign new_n149_ = ~new_n153_ & (~x18 | (~new_n150_ & (x05 | ~new_n155_ | x06)));
  assign new_n150_ = ~x21 & (x04 ? (new_n151_ & ~x12) : ~new_n118_);
  ...
  assign new_n156_ = new_n157_ & x04 & x05 & x08;
  assign new_n157_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign z27 = new_n168_ | (new_n173_ & new_n66_ & x03 & ~x05);
  ...
  assign new_n170_ = ~x21 & (new_n171_ | (~new_n118_ & ~x04));
  ...
  assign new_n181_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n98_ & x21));
