...
module FAU ( 
  ...
  assign z03 = (~new_n70_ & ~x09) | (new_n66_ & ~x05 & new_n69_ & x09 & ~x15);
  assign new_n69_ = ~x17 & x18;
  assign new_n70_ = x07 ? ((~x08 | x17 | ~x18 | (~x05 ^ x15)) & (x05 | ~x17 | x18)) : (x05 ? ((~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (~x17 | x18));
  assign z04 = ~x14 & ~x20;
  assign z05 = ~x05 & ~x07 & ~x09 & ~x14 & new_n73_ & ~x15;
  assign new_n73_ = ~x17 & x18 & (new_n74_ | new_n76_ | (~new_n78_ & ~x06));
  assign new_n74_ = ~new_n75_ & x02;
  assign new_n75_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n76_ = x06 & (new_n77_ | (~x02 & ~x08 & x11 & x21));
  assign new_n77_ = x08 & x10 & x12 & ~x13 & x16 & ~x21;
  assign new_n78_ = (x08 | ~x21 | (~x04 ^ x12)) & (~new_n79_ | ~x08 | ~x10 | ~x12);
  assign new_n79_ = ~x13 & ~x16 & ~x21;
  assign z06 = ~x09 & (new_n88_ | (~x05 & (new_n90_ | (~new_n81_ & ~x07))));
  assign new_n81_ = (x17 | ~x18 | (~new_n62_ & (new_n82_ | x15))) & (~x00 | ~x15 | ~x17 | x18);
  assign new_n82_ = (x14 | (~new_n76_ & new_n83_)) & (x08 | new_n87_ | x21);
  assign new_n83_ = (~x08 | x21 | (~new_n84_ & ~new_n85_)) & (~new_n86_ | x08 | x12 | ~x21);
  assign new_n84_ = (~x10 | (x04 & x10 & ~x12)) & (~x13 | (~x02 & x11 & x13));
  assign new_n85_ = ~x06 & ((x02 & ~x10 & x13) | (~x13 & ~x16 & x10 & x12));
  assign new_n86_ = x04 & ~x06;
  assign new_n87_ = (x02 | ~x06 | ~x11) & (~x04 | x06 | x12);
  assign new_n88_ = new_n66_ & x04 & x05 & new_n89_ & ~x12 & ~x15;
  assign new_n89_ = ~x17 & x18 & ~x21;
  assign new_n90_ = x07 & ~x15 & x17 & ~x18;
  assign z07 = ~x17 & ~new_n92_ & x18;
  ...
  assign new_n120_ = ~new_n122_ & (x15 | (x08 ? (~new_n84_ | x14) : new_n121_));
  ...
  assign new_n146_ = ~x21 & (x04 ? (new_n147_ & ~x12) : ~new_n123_);
  ...
  assign new_n157_ = ~x07 & (new_n158_ | (~x15 & x18 & ~x05 & ~x08));
  ...
  assign z27 = new_n164_ | (new_n169_ & new_n66_ & x03 & ~x05);
  ...
  assign new_n166_ = ~x21 & (new_n167_ | (~new_n123_ & ~x04));
  ...
  assign new_n177_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n87_ & x21));
