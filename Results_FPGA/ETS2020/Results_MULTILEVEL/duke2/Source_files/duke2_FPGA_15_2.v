...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n83_, new_n84_, new_n85_, new_n86_, new_n87_, new_n91_, new_n93_,
  ...
  assign z23 = new_n96_ & x18;
  assign new_n96_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n98_ | new_n102_);
  assign new_n98_ = ~x07 & (new_n99_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n99_ = ~x21 & ((x04 & ~new_n100_ & ~x15) | (x08 & new_n101_ & x15));
  assign new_n100_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n101_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n102_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n104_ & ~x05;
  assign new_n104_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  ...
  assign new_n109_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
