// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:26 2020
...
module FAU ( 
  ...
  assign new_n144_ = ~x21 & (x04 ? (new_n145_ & ~x12) : ~new_n122_);
  ...
  assign new_n162_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  ...
  assign new_n179_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
