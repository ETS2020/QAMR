// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:08 2020
...
module FAU ( 
  ...
  assign new_n125_ = ~x18 & (new_n126_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n126_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n127_ = ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  ...
  assign new_n131_ = (~x06 | (~new_n132_ & (~x12 | new_n133_ | x16))) & ~new_n79_ & (x06 | ~x12 | new_n133_ | ~x16);
  assign new_n132_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n133_ = x13 & (x02 | ~x11);
  assign new_n134_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n138_ | (~x05 & (new_n85_ | (~new_n136_ & ~x07))));
  assign new_n136_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n137_ | ~x18);
  assign new_n137_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n138_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n140_ & x18;
  assign new_n140_ = (x14 | x15 | (~new_n141_ & ~new_n69_)) & (x08 | ~x15 | ~x19);
  assign new_n141_ = x12 & ((~new_n142_ & ~x06) | (new_n143_ & x06 & x08 & x10));
  assign new_n142_ = (x04 | x08 | ~x21) & (~new_n74_ | ~x08 | ~x10);
  ...
  assign new_n147_ = ~x21 & (x04 ? (new_n148_ & ~x12) : ~new_n117_);
  ...
  assign new_n172_ = ~x21 & (new_n173_ | (~new_n117_ & ~x04));
  ...
  assign new_n183_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n82_ & x21));
