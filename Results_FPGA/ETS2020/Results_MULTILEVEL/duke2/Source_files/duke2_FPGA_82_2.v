...
module FAU ( 
  ...
  assign z27 = new_n120_ | (new_n125_ & ~x07 & x08 & x03 & ~x05);
  assign new_n120_ = ~x09 & ((~x17 & ~new_n121_ & x18) | (~x05 & x17 & ~new_n124_ & ~x18));
  assign new_n121_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n122_ & (~x05 | x08 | x15 | ~x19));
  assign new_n122_ = ~x21 & (new_n123_ | (~new_n106_ & ~x04));
