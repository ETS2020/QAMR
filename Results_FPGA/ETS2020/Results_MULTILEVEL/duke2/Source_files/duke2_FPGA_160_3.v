// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:14 2020
...
module FAU ( 
  ...
  assign new_n111_ = ~new_n113_ & (x15 | (x08 ? (~new_n91_ | x14) : new_n112_));
  ...
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n133_ : ~new_n128_);
  assign new_n128_ = (x07 | x15 | (x09 ? x19 : ~new_n129_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n129_ = ~x14 & ~new_n130_ & ~x21;
  assign new_n130_ = (~x06 | (~new_n131_ & (~x12 | new_n132_ | x16))) & ~new_n91_ & (x06 | ~x12 | new_n132_ | ~x16);
  assign new_n131_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n132_ = x13 & (x02 | ~x11);
  assign new_n133_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n137_ | (~x05 & (new_n97_ | (~new_n135_ & ~x07))));
  assign new_n135_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n136_ | ~x18);
  assign new_n136_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n137_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n139_ & x18;
  assign new_n139_ = (x14 | x15 | (~new_n140_ & ~new_n81_)) & (x08 | ~x15 | ~x19);
  assign new_n140_ = x12 & ((~new_n141_ & ~x06) | (new_n142_ & x06 & x08 & x10));
  assign new_n141_ = (x04 | x08 | ~x21) & (~new_n86_ | ~x08 | ~x10);
  ...
  assign new_n146_ = ~x21 & (x04 ? (new_n147_ & ~x12) : ~new_n114_);
  ...
  assign new_n152_ = new_n153_ & x04 & x05 & x08;
  assign new_n153_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n160_ = ~x07 & (new_n161_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n161_ = ~x21 & ((x04 & ~new_n162_ & ~x15) | (x08 & new_n163_ & x15));
  assign new_n162_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign new_n175_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
