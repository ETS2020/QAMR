...
module FAU ( 
  ...
  assign z03 = (~new_n69_ & ~x09) | (new_n65_ & ~x05 & new_n68_ & x09 & ~x15);
  ...
  assign z06 = ~x09 & ((~new_n80_ & ~x05) | (new_n89_ & new_n65_ & x04 & x05));
  assign new_n80_ = (x07 | ((x17 | new_n81_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n81_ = ~new_n82_ & (x15 | (~new_n87_ & (x14 | (~new_n75_ & new_n83_))));
  assign new_n82_ = new_n63_ & x11 & x15 & ~x21;
  ...
  assign new_n138_ = (~x06 | (~new_n139_ & (~x12 | new_n140_ | x16))) & ~new_n84_ & (x06 | ~x12 | new_n140_ | ~x16);
  ...
  assign new_n149_ = ~x21 & (x04 ? (new_n150_ & ~x12) : ~new_n123_);
  ...
  assign new_n160_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)));
  ...
  assign z27 = new_n174_ | (new_n179_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n187_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n88_ & x21));
