// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:09 2020
...
module FAU ( 
  ...
  assign new_n126_ = (~x06 | (~new_n127_ & (~x12 | new_n128_ | x16))) & ~new_n79_ & (x06 | ~x12 | new_n128_ | ~x16);
  assign new_n127_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n128_ = x13 & (x02 | ~x11);
  assign new_n129_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n133_ | (~x05 & (new_n85_ | (~new_n131_ & ~x07))));
  ...
  assign new_n135_ = (x14 | x15 | (~new_n136_ & ~new_n69_)) & (x08 | ~x15 | ~x19);
  assign new_n136_ = x12 & ((~new_n137_ & ~x06) | (new_n138_ & x06 & x08 & x10));
  assign new_n137_ = (x04 | x08 | ~x21) & (~new_n74_ | ~x08 | ~x10);
  ...
  assign new_n169_ = ~x21 & (new_n170_ | (~new_n119_ & ~x04));
  ...
  assign new_n180_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n82_ & x21));
