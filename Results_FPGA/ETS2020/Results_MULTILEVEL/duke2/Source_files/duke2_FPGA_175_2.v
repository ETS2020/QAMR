...
module FAU ( 
  ...
  assign z24 = ~x09 & ~x17 & (new_n110_ | new_n114_);
  assign new_n110_ = ~x07 & (new_n111_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n111_ = ~x21 & ((x04 & ~new_n112_ & ~x15) | (x08 & new_n113_ & x15));
  assign new_n112_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n113_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n114_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
