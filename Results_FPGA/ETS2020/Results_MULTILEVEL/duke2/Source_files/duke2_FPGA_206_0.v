// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:38 2020
...
module FAU ( 
  ...
  assign z17 = ~x09 & (new_n144_ | (~x05 & (new_n100_ | (~new_n142_ & ~x07))));
  ...
  assign new_n146_ = (x14 | x15 | (~new_n147_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n147_ = x12 & ((~new_n148_ & ~x06) | (new_n149_ & x06 & x08 & x10));
  assign new_n148_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  ...
  assign new_n173_ = ~x21 & (new_n174_ | (~new_n124_ & ~x04));
  ...
  assign new_n184_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
