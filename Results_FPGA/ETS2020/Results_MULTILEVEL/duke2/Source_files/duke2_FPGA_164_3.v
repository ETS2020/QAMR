// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:16 2020
...
module FAU ( 
  ...
  assign new_n136_ = new_n137_ & x08;
  assign new_n137_ = x18 & (x07 ? new_n139_ : (~new_n138_ & (x09 | (~x09 & ~x21))));
  ...
  assign new_n155_ = (x14 | x15 | (~new_n156_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n162_ = ~x21 & (x04 ? (new_n163_ & ~x12) : ~new_n132_);
  ...
  assign z28 = (~x17 & (new_n186_ | (new_n193_ & ~x05))) | (~x09 & new_n194_ & x17);
  assign new_n186_ = x18 & ((~new_n187_ & x08) | (~x05 & ~x07 & new_n192_ & ~x08));
  assign new_n187_ = (new_n191_ | x07) & (x05 | ((~new_n188_ | x07) & (new_n190_ | ~x15)));
  assign new_n188_ = ~x09 & x10 & new_n189_ & x12;
  ...
  assign new_n192_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
