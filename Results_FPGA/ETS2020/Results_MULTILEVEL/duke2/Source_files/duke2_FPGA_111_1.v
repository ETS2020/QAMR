// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:47 2020
...
module FAU ( 
  ...
  assign new_n129_ = (~x06 | (~new_n130_ & (~x12 | new_n131_ | x16))) & ~new_n83_ & (x06 | ~x12 | new_n131_ | ~x16);
  assign new_n130_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n131_ = x13 & (x02 | ~x11);
  assign new_n132_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n136_ | (~x05 & (new_n89_ | (~new_n134_ & ~x07))));
  ...
  assign new_n138_ = (x14 | x15 | (~new_n139_ & ~new_n73_)) & (x08 | ~x15 | ~x19);
  assign new_n139_ = x12 & ((~new_n140_ & ~x06) | (new_n141_ & x06 & x08 & x10));
  assign new_n140_ = (x04 | x08 | ~x21) & (~new_n78_ | ~x08 | ~x10);
  ...
  assign new_n145_ = ~x21 & (x04 ? (new_n146_ & ~x12) : ~new_n122_);
  ...
  assign new_n152_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n163_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  ...
  assign new_n170_ = ~x21 & (new_n171_ | (~new_n122_ & ~x04));
  ...
  assign new_n181_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
