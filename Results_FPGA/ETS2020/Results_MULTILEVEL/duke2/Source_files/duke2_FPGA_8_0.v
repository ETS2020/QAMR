...
module FAU ( 
  ...
  assign z17 = ~x09 & (new_n136_ | (~x05 & (new_n97_ | (~new_n134_ & ~x07))));
  ...
  assign new_n138_ = (x14 | x15 | (~new_n139_ & ~new_n81_)) & (x08 | ~x15 | ~x19);
  assign new_n139_ = x12 & ((~new_n140_ & ~x06) | (new_n141_ & x06 & x08 & x10));
  assign new_n140_ = (x04 | x08 | ~x21) & (~new_n86_ | ~x08 | ~x10);
  ...
  assign new_n144_ = ~x21 & (x04 ? (new_n145_ & ~x12) : ~new_n124_);
