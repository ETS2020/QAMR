...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n85_, new_n86_, new_n87_, new_n88_, new_n90_, new_n93_, new_n94_,
  ...
  assign new_n69_ = (x15 | (~new_n80_ & ((~new_n70_ & ~new_n79_) | x07))) & (~new_n77_ | x07);
  ...
  assign new_n73_ = ~x05 & ((~new_n74_ & x06) | (new_n75_ & x02));
  ...
  assign new_n95_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  ...
  assign z21 = ~x17 & ~new_n108_ & x18;
  assign new_n108_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n110_ & ~x07) | (~x05 & new_n111_ & x07));
  assign new_n110_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)));
  assign new_n111_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign z27 = new_n118_ | (new_n124_ & ~x07 & x08 & x03 & ~x05);
  assign new_n118_ = ~x09 & ((~x17 & ~new_n119_ & x18) | (~x05 & x17 & ~new_n123_ & ~x18));
  assign new_n119_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n120_ & (~x05 | x08 | x15 | ~x19));
  ...
  assign new_n123_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n124_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
