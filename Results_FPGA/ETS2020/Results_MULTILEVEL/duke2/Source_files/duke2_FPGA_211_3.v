...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n177_, new_n178_, new_n179_, new_n180_, new_n182_, new_n185_,
    new_n186_, new_n187_, new_n188_, new_n189_, new_n190_, new_n192_,
    new_n193_, new_n194_, new_n195_, new_n196_, new_n197_, new_n198_,
    new_n199_, new_n200_;
  assign z01 = ~x17 & (new_n60_ | (~x05 & (new_n63_ | (new_n54_ & ~x07))));
  ...
  assign z02 = ~x17 & ((new_n72_ & x08) | (~new_n65_ & ~x09));
  assign new_n65_ = (new_n66_ | ~x18) & (x05 | (x15 ? (new_n71_ | ~x18) : new_n69_));
  assign new_n66_ = (new_n67_ | ~x05) & (~new_n62_ | ~x15 | ~x21);
  assign new_n67_ = (x07 | (x08 ? (~x21 & (~new_n68_ | ~x15 | x21)) : x15)) & (~x07 | ~x08 | x15 | ~x19);
  assign new_n68_ = ~x04 & ~x11;
  assign new_n69_ = (~x01 | ~x07 | x18 | (~x08 & ~x16)) & (x07 | new_n70_ | ~x18);
  assign new_n70_ = x06 ? (x02 & x11) : (x04 & x12);
  assign new_n71_ = x08 ? ((~x07 | ~x19) & (~x11 | x21 | x02 | x07)) : x07;
  assign new_n72_ = x18 & ((~x15 & (x05 ? ~new_n73_ : ~x07)) | (~x05 & ~new_n74_ & x15));
  assign new_n73_ = (x04 | x07 | ~x12 | (~x09 & x21)) & x12 & (~x07 | (~x09 & x19));
  assign new_n74_ = (~x07 | (~x09 & x19)) & x11 & (x02 | ~x09);
  assign z03 = (~new_n77_ & ~x09) | (new_n62_ & ~x05 & new_n76_ & x09 & ~x15);
  ...
  assign new_n88_ = (x17 | ~x18 | (~new_n58_ & (new_n89_ | x15))) & (~x17 | x18 | ~x00 | ~x15);
  ...
  assign new_n95_ = new_n62_ & x04 & x05 & new_n96_ & ~x12 & ~x15;
  ...
  assign new_n135_ = (~x11 | ~x15 | x02 | x05) & (~x04 | ~x05 | x12 | x15);
  ...
  assign new_n150_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n151_ = new_n61_ & new_n96_ & ~x11 & x15;
  ...
  assign new_n155_ = (~new_n86_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  ...
  assign z27 = new_n185_ | (new_n190_ & new_n62_ & x03 & ~x05);
  ...
  assign new_n187_ = ~x21 & (new_n188_ | (~new_n129_ & ~x04));
  assign new_n188_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n189_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n190_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n192_ | (new_n199_ & ~x05))) | (~x09 & new_n200_ & x17);
  assign new_n192_ = x18 & ((~new_n193_ & x08) | (~x05 & ~x07 & new_n198_ & ~x08));
  ...
  assign new_n196_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n197_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n198_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
