...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n83_, new_n84_, new_n85_, new_n86_, new_n87_, new_n90_, new_n92_,
  ...
  assign z21 = ~x17 & ~new_n90_ & x18;
  assign new_n90_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z25 = new_n92_ & ~x05;
  assign new_n92_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n99_ | (~x09 & (new_n101_ | (~x17 & ~new_n95_ & x18)));
  assign new_n95_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n96_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n96_ = ~x21 & (new_n98_ | (~new_n97_ & ~x04));
  assign new_n97_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n98_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n99_ = new_n100_ & x03 & ~x05 & ~x07 & x08;
  assign new_n100_ = x09 & ~x15 & ~x17 & x18 & x19;
