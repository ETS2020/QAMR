...
module FAU ( 
  ...
  assign z20 = ~x07 & ~x17 & (new_n116_ | (~new_n108_ & ~x09));
  assign new_n108_ = ~new_n113_ & (~x18 | (~new_n109_ & (x05 | ~new_n115_ | x06)));
  assign new_n109_ = ~x21 & (x04 ? new_n110_ : ~new_n112_);
  assign new_n110_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n111_ : ~x06));
  assign new_n111_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n112_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n113_ = new_n114_ & x04 & ~x05 & x12;
  assign new_n114_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n115_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n116_ = new_n117_ & x04 & x05 & x08;
  assign new_n117_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n131_ = ~x21 & (new_n132_ | (~new_n112_ & ~x04));
