// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:35 2020
...
module FAU ( 
  ...
  assign z12 = ~x09 & ((~new_n107_ & ~x07) | (new_n114_ & ~x05 & x07));
  assign new_n107_ = (x17 | ~new_n108_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n108_ = ~x21 & ((~new_n112_ & ~x04) | (~new_n109_ & ~x05) | (new_n113_ & x04 & x05));
  assign new_n109_ = ~new_n111_ & (x15 | (x08 ? (~new_n94_ | x14) : new_n110_));
  assign new_n110_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n111_ = x11 & x15 & ~x02 & x08;
  assign new_n112_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n113_ = x08 & ~x12 & ~x15;
  assign new_n114_ = ~x15 & x17 & ~x18;
  assign z14 = (~x17 & (new_n116_ | (~x05 & new_n120_ & ~x09))) | (~x05 & new_n122_ & ~x09);
  ...
  assign new_n121_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  ...
  assign new_n126_ = (~x06 | (~new_n127_ & (~x12 | new_n128_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n128_ | ~x16);
  assign new_n127_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n128_ = x13 & (x02 | ~x11);
  assign new_n129_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n133_ | (~x05 & (new_n100_ | (~new_n131_ & ~x07))));
  ...
  assign new_n135_ = (x14 | x15 | (~new_n136_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n136_ = x12 & ((~new_n137_ & ~x06) | (new_n138_ & x06 & x08 & x10));
  assign new_n137_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  assign new_n138_ = ~x13 & x16 & ~x21;
  assign z20 = ~x07 & ~x17 & (new_n147_ | (~new_n140_ & ~x09));
  assign new_n140_ = ~new_n144_ & (~x18 | (~new_n141_ & (x05 | ~new_n146_ | x06)));
  assign new_n141_ = ~x21 & (x04 ? (new_n142_ & ~x12) : ~new_n112_);
  assign new_n142_ = ~x15 & (x05 ? x08 : (x08 ? (new_n143_ & x10) : ~x06));
  assign new_n143_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n144_ = new_n145_ & x04 & ~x05 & x12;
  assign new_n145_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n146_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n147_ = new_n148_ & x04 & x05 & x08;
  assign new_n148_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n162_ = ~x21 & (new_n163_ | (~new_n112_ & ~x04));
