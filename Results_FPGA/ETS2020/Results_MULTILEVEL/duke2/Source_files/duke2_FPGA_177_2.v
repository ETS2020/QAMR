...
module FAU ( 
  ...
  assign new_n102_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n104_ & ~x07) | (~x05 & new_n105_ & x07));
  assign new_n104_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)));
  assign new_n105_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign new_n122_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
