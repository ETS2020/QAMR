...
module FAU ( 
  ...
  assign z20 = ~x07 & ~x17 & (new_n111_ | (~new_n103_ & ~x09));
  assign new_n103_ = ~new_n108_ & (~x18 | (~new_n104_ & (x05 | ~new_n110_ | x06)));
  assign new_n104_ = ~x21 & (x04 ? new_n105_ : ~new_n107_);
  assign new_n105_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n106_ : ~x06));
  assign new_n106_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n107_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n108_ = new_n109_ & x04 & ~x05 & x12;
  assign new_n109_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n110_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n111_ = new_n112_ & x04 & x05 & x08;
  assign new_n112_ = ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n125_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n126_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n126_ = ~x21 & (new_n127_ | (~new_n107_ & ~x04));
