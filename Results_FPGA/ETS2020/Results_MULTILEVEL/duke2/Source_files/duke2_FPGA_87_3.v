...
module FAU ( 
  ...
  assign new_n140_ = ~x21 & (x04 ? (new_n141_ & ~x12) : ~new_n113_);
  ...
  assign new_n149_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n151_ & ~x07) | (~x05 & new_n152_ & x07));
  assign new_n151_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n152_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign new_n169_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
