// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:57 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n105_, new_n107_, new_n108_, new_n110_, new_n113_, new_n114_,
  ...
  assign z21 = ~x17 & ~new_n105_ & x18;
  assign new_n105_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n107_ & ~x07) | (~x05 & new_n108_ & x07));
  assign new_n107_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)));
  assign new_n108_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z25 = new_n110_ & ~x05;
  assign new_n110_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n113_ | (new_n119_ & ~x07 & x08 & x03 & ~x05);
  assign new_n113_ = ~x09 & ((~x17 & ~new_n114_ & x18) | (~x05 & x17 & ~new_n118_ & ~x18));
  assign new_n114_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n115_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n115_ = ~x21 & (new_n117_ | (~new_n116_ & ~x04));
  assign new_n116_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n117_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n118_ = (~x07 | x15) & (~x00 | x07 | ~x15);
