// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:48 2020
...
module FAU ( 
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n105_ | (~x17 & (new_n103_ | (~new_n91_ & x18)));
  assign new_n91_ = (~new_n99_ | x07) & (x15 | (~new_n102_ & ((~new_n92_ & ~new_n101_) | x07)));
  assign new_n92_ = ~x09 & (new_n98_ | (~x21 & (new_n95_ | (new_n93_ & x04))));
  assign new_n93_ = ~new_n94_ & ~x12;
  assign new_n94_ = (x05 | x06 | x08) & (~x13 | x14 | ~x02 | ~x08);
  assign new_n95_ = ~x05 & ((~new_n96_ & x06) | (new_n97_ & x02));
  assign new_n96_ = (x02 | x08 | ~x11) & (x10 | ~x13 | x14 | ~x02 | ~x08);
  assign new_n97_ = x08 & x13 & ~x14 & (x10 ? x12 : ~x06);
  assign new_n98_ = x05 & ~x08 & ~x19;
  assign new_n99_ = ~new_n100_ & x08;
  assign new_n100_ = (~x02 | x05 | x11 | ~x15 | (~x09 & x21)) & (~x05 | x09 | ~x21);
  assign new_n101_ = ~x04 & x05 & x08 & x12 & (x09 | ~x21);
  assign new_n102_ = x05 & x08 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  ...
  assign z12 = ~x09 & ((~new_n115_ & ~x07) | (new_n106_ & ~x05 & x07));
  assign new_n115_ = (x17 | ~new_n116_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n116_ = ~x21 & ((~new_n120_ & ~x04) | (~new_n117_ & ~x05) | (new_n121_ & x04 & x05));
  assign new_n117_ = ~new_n119_ & (x15 | (x08 ? (~new_n82_ | x14) : new_n118_));
  assign new_n118_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n119_ = x11 & x15 & ~x02 & x08;
  ...
  assign new_n126_ = (~x06 | (~new_n127_ & (~x12 | new_n128_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n128_ | ~x16);
  assign new_n127_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n128_ = x13 & (x02 | ~x11);
  assign new_n129_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n133_ | (~x05 & (new_n88_ | (~new_n131_ & ~x07))));
  assign new_n131_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n132_ | ~x18);
  assign new_n132_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n133_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z20 = ~x07 & ~x17 & (new_n142_ | (~new_n135_ & ~x09));
  assign new_n135_ = ~new_n139_ & (~x18 | (~new_n136_ & (x05 | ~new_n141_ | x06)));
  assign new_n136_ = ~x21 & (x04 ? (new_n137_ & ~x12) : ~new_n120_);
  ...
  assign new_n145_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n161_ = ~x21 & (new_n162_ | (~new_n120_ & ~x04));
  ...
  assign new_n171_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n172_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
