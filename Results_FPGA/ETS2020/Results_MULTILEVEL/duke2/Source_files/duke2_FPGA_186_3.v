// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:28 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n154_, new_n156_, new_n157_, new_n158_, new_n159_, new_n162_,
  ...
  assign new_n147_ = (~x06 | (~new_n148_ & (~x12 | new_n149_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n149_ | ~x16);
  assign new_n148_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n149_ = x13 & (x02 | ~x11);
  assign new_n150_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n154_ | (~x05 & (new_n100_ | (~new_n152_ & ~x07))));
