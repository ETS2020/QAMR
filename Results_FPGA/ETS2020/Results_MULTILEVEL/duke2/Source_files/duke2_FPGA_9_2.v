...
module FAU ( 
  ...
  assign z18 = ~x05 & ~x07 & ~x09 & new_n107_ & ~x17;
  assign new_n107_ = x18 & ((~x14 & ~new_n108_ & ~x15) | (~x08 & x15 & x19));
  assign new_n108_ = (new_n109_ | ~x02) & (~x12 | (~new_n111_ & (new_n110_ | x06)));
  assign new_n109_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n110_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n111_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z21 = ~x17 & ~new_n114_ & x18;
  assign new_n114_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign z27 = new_n127_ | (new_n133_ & ~x07 & x08 & x03 & ~x05);
  assign new_n127_ = ~x09 & ((~x17 & ~new_n128_ & x18) | (~x05 & x17 & ~new_n132_ & ~x18));
