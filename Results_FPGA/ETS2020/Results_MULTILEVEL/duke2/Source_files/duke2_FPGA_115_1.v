...
module FAU ( 
  ...
  assign new_n106_ = ~x07 & ~x09 & ~x15 & x17 & ~x18;
  ...
  assign new_n127_ = (~x06 | (~new_n128_ & (~x12 | new_n129_ | x16))) & ~new_n83_ & (x06 | ~x12 | new_n129_ | ~x16);
  assign new_n128_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n129_ = x13 & (x02 | ~x11);
  assign new_n130_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n134_ | (~x05 & (new_n89_ | (~new_n132_ & ~x07))));
  ...
  assign new_n136_ = (x14 | x15 | (~new_n137_ & ~new_n73_)) & (x08 | ~x15 | ~x19);
  assign new_n137_ = x12 & ((~new_n138_ & ~x06) | (new_n139_ & x06 & x08 & x10));
  assign new_n138_ = (x04 | x08 | ~x21) & (~new_n78_ | ~x08 | ~x10);
  assign new_n139_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n150_ | (~new_n142_ & ~x09));
  assign new_n142_ = ~new_n147_ & (~x18 | (~new_n143_ & (x05 | ~new_n149_ | x06)));
  assign new_n143_ = ~x21 & (x04 ? (new_n144_ & ~x12) : ~new_n146_);
  ...
  assign new_n169_ = ~x21 & (new_n170_ | (~new_n146_ & ~x04));
  ...
  assign new_n180_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
