...
module FAU ( 
  ...
  assign new_n115_ = ~new_n117_ & (x15 | (x08 ? (~new_n78_ | x14) : new_n116_));
  ...
  assign new_n133_ = (~x06 | (~new_n134_ & (~x12 | new_n135_ | x16))) & ~new_n78_ & (x06 | ~x12 | new_n135_ | ~x16);
  assign new_n134_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n135_ = x13 & (x02 | ~x11);
  assign new_n136_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n140_ | (~x05 & (new_n84_ | (~new_n138_ & ~x07))));
  ...
  assign new_n144_ = ~x21 & (x04 ? (new_n145_ & ~x12) : ~new_n118_);
  ...
  assign new_n171_ = ~x21 & (new_n172_ | (~new_n118_ & ~x04));
  ...
  assign new_n181_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n182_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n81_ & x21));
