...
module FAU ( 
  ...
  assign new_n120_ = (~x06 | (~new_n121_ & (~x12 | new_n122_ | x16))) & ~new_n83_ & (x06 | ~x12 | new_n122_ | ~x16);
  assign new_n121_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n122_ = x13 & (x02 | ~x11);
  assign new_n123_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n127_ | (~x05 & (new_n89_ | (~new_n125_ & ~x07))));
  assign new_n125_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n126_ | ~x18);
  assign new_n126_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n127_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n129_ & x18;
  assign new_n129_ = (x14 | x15 | (~new_n130_ & ~new_n73_)) & (x08 | ~x15 | ~x19);
  assign new_n130_ = x12 & ((~new_n131_ & ~x06) | (new_n132_ & x06 & x08 & x10));
  assign new_n131_ = (x04 | x08 | ~x21) & (~new_n78_ | ~x08 | ~x10);
  ...
  assign new_n136_ = ~x21 & (x04 ? (new_n137_ & ~x12) : ~new_n105_);
  ...
  assign new_n163_ = ~x21 & (new_n164_ | (~new_n105_ & ~x04));
