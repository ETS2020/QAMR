// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:23 2020
...
module FAU ( 
  ...
  assign new_n100_ = (~new_n108_ | x07) & (x15 | (~new_n111_ & (x07 | (~new_n101_ & ~new_n110_))));
  ...
  assign z12 = ~x09 & ((~new_n117_ & ~x07) | (new_n115_ & ~x05 & x07));
  ...
  assign new_n121_ = ~x02 & x08 & x11 & x15;
  ...
  assign new_n185_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
