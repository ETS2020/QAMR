// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:22 2020
...
module FAU ( 
  ...
  assign z17 = ~x09 & (new_n137_ | (~x05 & (new_n99_ | (~new_n135_ & ~x07))));
  assign new_n135_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n136_ | ~x18);
  assign new_n136_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n137_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z21 = ~x17 & ~new_n140_ & x18;
  assign new_n140_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n142_ & ~x07) | (~x05 & new_n143_ & x07));
  assign new_n142_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n143_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign z25 = new_n153_ & ~x05;
  assign new_n153_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z28 = (~x17 & (new_n156_ | (new_n163_ & ~x05))) | (~x09 & new_n164_ & x17);
  assign new_n156_ = x18 & ((~new_n157_ & x08) | (~x05 & ~x07 & new_n162_ & ~x08));
  assign new_n157_ = (new_n161_ | x07) & (x05 | ((~new_n158_ | x07) & (new_n160_ | ~x15)));
  assign new_n158_ = ~x09 & x10 & new_n159_ & x12;
  assign new_n159_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n160_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n161_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n162_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
