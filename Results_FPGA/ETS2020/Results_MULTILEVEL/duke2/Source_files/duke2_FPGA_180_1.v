...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n163_, new_n164_, new_n165_, new_n166_, new_n168_, new_n171_,
  ...
  assign new_n130_ = (~x06 | (~new_n131_ & (~x12 | new_n132_ | x16))) & ~new_n79_ & (x06 | ~x12 | new_n132_ | ~x16);
  assign new_n131_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n132_ = x13 & (x02 | ~x11);
  assign new_n133_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n137_ | (~x05 & (new_n85_ | (~new_n135_ & ~x07))));
  assign new_n135_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n136_ | ~x18);
  assign new_n136_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n137_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n139_ & x18;
  assign new_n139_ = (x14 | x15 | (~new_n140_ & ~new_n69_)) & (x08 | ~x15 | ~x19);
  assign new_n140_ = x12 & ((~new_n141_ & ~x06) | (new_n142_ & x06 & x08 & x10));
  assign new_n141_ = (x04 | x08 | ~x21) & (~new_n74_ | ~x08 | ~x10);
  ...
  assign new_n146_ = ~x21 & (x04 ? (new_n147_ & ~x12) : ~new_n116_);
  ...
  assign new_n173_ = ~x21 & (new_n174_ | (~new_n116_ & ~x04));
