...
module FAU ( 
  ...
  assign z07 = ~x17 & ~new_n88_ & x18;
  assign new_n88_ = (x09 | (~x05 ^ x15) | (x07 ^ x08)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20;
  assign z09 = new_n105_ | (~x17 & (new_n103_ | (~new_n91_ & x18)));
  assign new_n91_ = (x15 | (~new_n102_ & (x07 | (~new_n92_ & ~new_n101_)))) & (~new_n99_ | x07);
  ...
  assign new_n105_ = ~x07 & ~x09 & new_n106_ & ~x15;
  ...
  assign z12 = ~x09 & ((~new_n115_ & ~x07) | (new_n106_ & ~x15 & ~x05 & x07));
  assign new_n115_ = (x17 | ~new_n116_ | ~x18) & (~x15 | ~x17 | x18 | ~x00 | x05);
  assign new_n116_ = ~x21 & ((~new_n121_ & ~x04) | (~new_n117_ & ~x05) | (new_n122_ & x04 & x05));
  assign new_n117_ = ~new_n120_ & (x15 | (x08 ? (~new_n119_ | x14) : new_n118_));
  assign new_n118_ = (~x04 | x06 | x12) & (~x06 | (x02 ^ ~x11));
  assign new_n119_ = (~x10 | (x04 & x10 & ~x12)) & (~x13 | (~x02 & x11 & x13));
  assign new_n120_ = ~x02 & x08 & x11 & x15;
  ...
  assign new_n136_ = (~x06 | (~new_n137_ & (~x12 | new_n138_ | x16))) & ~new_n119_ & (x06 | ~x12 | new_n138_ | ~x16);
  assign new_n137_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n138_ = x13 & (x02 | ~x11);
  assign new_n139_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & ((~new_n141_ & ~x05) | (new_n144_ & new_n61_ & ~x04 & x05));
  assign new_n141_ = (~new_n106_ | ~x07 | x15) & (x07 | ((x08 | ~new_n142_ | x15) & (~new_n106_ | ~x00 | ~x15)));
  assign new_n142_ = ~x17 & x18 & ~new_n57_ & ~new_n143_;
  ...
  assign new_n151_ = ~new_n156_ & (~x18 | (~new_n152_ & (x05 | ~new_n155_ | x06)));
  ...
  assign new_n155_ = ~x08 & ~x14 & ~x15 & ~new_n86_ & x21;
  ...
  assign new_n163_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)));
  assign new_n164_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z25 = new_n166_ & ~x05;
  assign new_n166_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z28 = (~x17 & (new_n168_ | (new_n176_ & ~x05))) | (~x09 & new_n177_ & x17);
  assign new_n168_ = x18 & ((~new_n169_ & x08) | (~x05 & ~x07 & new_n174_ & ~x08));
  assign new_n169_ = (new_n173_ | x07) & (x05 | ((new_n172_ | ~x15) & (~new_n170_ | x07)));
  assign new_n170_ = ~x09 & x10 & new_n171_ & x12;
  assign new_n171_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n172_ = (x02 | (~x09 & (~x11 | x21 | x07 | x09))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n173_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n174_ = ~x09 & ((x15 & ~x19) | (~x14 & new_n175_ & ~x15));
  assign new_n175_ = x21 & ((x04 & ~x06 & ~x12) | (~x02 & x06 & x11));
