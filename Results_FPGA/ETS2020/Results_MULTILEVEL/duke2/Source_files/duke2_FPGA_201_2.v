...
module FAU ( 
  ...
  assign z23 = new_n107_ & x18;
  assign new_n107_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n109_ | new_n113_);
  assign new_n109_ = ~x07 & (new_n110_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n110_ = ~x21 & ((x04 & ~new_n111_ & ~x15) | (x08 & new_n112_ & x15));
  assign new_n111_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n112_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n113_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  ...
  assign new_n119_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n120_ & (x15 | ~x19 | ~x05 | x08));
