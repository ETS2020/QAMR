...
module FAU ( 
  ...
  assign z24 = ~x09 & ~x17 & (new_n150_ | new_n154_);
  assign new_n150_ = ~x07 & (new_n151_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n151_ = ~x21 & ((x04 & ~new_n152_ & ~x15) | (x08 & new_n153_ & x15));
  assign new_n152_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n153_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n154_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n156_ & ~x05;
  ...
  assign new_n165_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n89_ & x21));
