// Benchmark "FAU" written by ABC on Wed Aug  5 21:19:55 2020
...
module FAU ( 
  ...
  assign new_n134_ = (~x06 | (~new_n135_ & (~x12 | new_n136_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n136_ | ~x16);
  assign new_n135_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n136_ = x13 & (x02 | ~x11);
  assign new_n137_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n141_ | (~x05 & (new_n88_ | (~new_n139_ & ~x07))));
  ...
  assign new_n145_ = ~x21 & (x04 ? (new_n146_ & ~x12) : ~new_n119_);
  ...
  assign new_n154_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n161_ = ~x21 & (new_n162_ | (~new_n119_ & ~x04));
