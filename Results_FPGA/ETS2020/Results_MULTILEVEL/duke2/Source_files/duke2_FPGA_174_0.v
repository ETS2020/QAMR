// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:21 2020
...
module FAU ( 
  ...
  assign new_n146_ = ~x21 & (x04 ? (new_n147_ & ~x12) : ~new_n126_);
  ...
  assign new_n168_ = ~x21 & (new_n169_ | (~new_n126_ & ~x04));
  assign new_n169_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  ...
  assign new_n179_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
