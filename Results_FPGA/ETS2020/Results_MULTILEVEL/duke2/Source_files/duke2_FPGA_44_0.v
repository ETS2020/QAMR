// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:10 2020
...
module FAU ( 
  ...
  assign new_n107_ = ~new_n109_ & (x15 | (x08 ? (~new_n94_ | x14) : new_n108_));
  ...
  assign new_n119_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  ...
  assign new_n140_ = ~x21 & (x04 ? (new_n141_ & ~x12) : ~new_n110_);
  ...
  assign new_n162_ = ~x21 & (new_n163_ | (~new_n110_ & ~x04));
  ...
  assign new_n173_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
