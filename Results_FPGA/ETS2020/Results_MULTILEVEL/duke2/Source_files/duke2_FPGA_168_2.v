...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n99_, new_n100_, new_n102_, new_n104_, new_n105_, new_n107_,
  ...
  assign z20 = ~x07 & ~x17 & (new_n99_ | (~x09 & (new_n91_ | new_n97_)));
  assign new_n91_ = x18 & (new_n94_ | (~x21 & (x04 ? new_n92_ : ~new_n96_)));
  assign new_n92_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n93_ : ~x06));
  assign new_n93_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n94_ = ~x05 & new_n95_ & ~x06;
  assign new_n95_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n96_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n97_ = new_n98_ & x04 & ~x05 & x12;
  assign new_n98_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n99_ = new_n100_ & x04 & x05 & x08;
  assign new_n100_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n104_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  ...
  assign new_n117_ = ~x21 & (new_n118_ | (~new_n96_ & ~x04));
