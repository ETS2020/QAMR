...
module FAU ( 
  ...
  assign new_n128_ = (~x06 | (~new_n129_ & (~x12 | new_n130_ | x16))) & ~new_n82_ & (x06 | ~x12 | new_n130_ | ~x16);
  assign new_n129_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n130_ = x13 & (x02 | ~x11);
  assign new_n131_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n135_ | (~x05 & (new_n88_ | (~new_n133_ & ~x07))));
  ...
  assign new_n139_ = ~x21 & (x04 ? (new_n140_ & ~x12) : ~new_n121_);
  ...
  assign new_n158_ = ~x21 & (new_n159_ | (~new_n121_ & ~x04));
  assign new_n159_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  ...
  assign new_n169_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n85_ & x21));
