...
module FAU ( 
  ...
  assign new_n99_ = (~new_n107_ | x07) & (x15 | (~new_n110_ & ((~new_n100_ & ~new_n109_) | x07)));
  ...
  assign new_n163_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
