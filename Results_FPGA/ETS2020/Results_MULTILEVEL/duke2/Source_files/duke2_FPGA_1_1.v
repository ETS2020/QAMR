// Benchmark "FAU" written by ABC on Wed Aug  5 21:19:47 2020
...
module FAU ( 
  ...
  assign z20 = ~x07 & ~x17 & (new_n149_ | (~new_n142_ & ~x09));
  assign new_n142_ = ~new_n146_ & (~x18 | (~new_n143_ & (x05 | ~new_n148_ | x06)));
  assign new_n143_ = ~x21 & (x04 ? (new_n144_ & ~x12) : ~new_n118_);
  ...
  assign new_n150_ = x09 & ~x12 & ~x15 & x18;
  assign z21 = ~x17 & ~new_n152_ & x18;
  assign new_n152_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n154_ & ~x07) | (~x05 & new_n155_ & x07));
  assign new_n154_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign new_n168_ = ~x21 & (new_n169_ | (~new_n118_ & ~x04));
  ...
  assign new_n178_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
