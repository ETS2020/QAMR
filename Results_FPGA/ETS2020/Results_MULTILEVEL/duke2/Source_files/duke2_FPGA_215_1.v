// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:43 2020
...
module FAU ( 
  ...
  assign new_n114_ = ~new_n116_ & (x15 | (x08 ? (~new_n78_ | x14) : new_n115_));
  ...
  assign new_n132_ = (~x06 | (~new_n133_ & (~x12 | new_n134_ | x16))) & ~new_n78_ & (x06 | ~x12 | new_n134_ | ~x16);
  assign new_n133_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n134_ = x13 & (x02 | ~x11);
  assign new_n135_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n139_ | (~x05 & (new_n84_ | (~new_n137_ & ~x07))));
  ...
  assign new_n170_ = ~x21 & (new_n171_ | (~new_n117_ & ~x04));
  ...
  assign new_n181_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n81_ & x21));
