...
module FAU ( 
  ...
  assign new_n126_ = ~new_n128_ & (x15 | (x08 ? (~new_n89_ | x14) : new_n127_));
  ...
  assign new_n162_ = ~x15 & x18 & x09 & ~x12;
  assign z21 = ~x17 & ~new_n164_ & x18;
  assign new_n164_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n166_ & ~x07) | (~x05 & new_n167_ & x07));
  assign new_n166_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign new_n186_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n92_ & x21));
