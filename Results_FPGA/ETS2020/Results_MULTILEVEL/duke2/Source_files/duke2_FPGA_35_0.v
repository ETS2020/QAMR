...
module FAU ( 
  ...
  assign new_n138_ = (~x06 | (~new_n139_ & (~x12 | new_n140_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n140_ | ~x16);
  assign new_n139_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n140_ = x13 & (x02 | ~x11);
  assign new_n141_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n145_ | (~x05 & (new_n99_ | (~new_n143_ & ~x07))));
  ...
  assign new_n147_ = (x14 | x15 | (~new_n148_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n148_ = x12 & ((~new_n149_ & ~x06) | (new_n150_ & x06 & x08 & x10));
  assign new_n149_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
