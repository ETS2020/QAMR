...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n86_, new_n88_, new_n89_, new_n90_, new_n91_, new_n93_, new_n98_,
  ...
  assign z22 = ~x17 & x18 & ((~new_n100_ & ~x07) | (~x05 & new_n101_ & x07));
  assign new_n100_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)));
  assign new_n101_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z25 = new_n103_ & ~x05;
  assign new_n103_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n106_ | (new_n112_ & ~x07 & x08 & x03 & ~x05);
  assign new_n106_ = ~x09 & ((~x17 & ~new_n107_ & x18) | (~x05 & x17 & ~new_n111_ & ~x18));
  ...
  assign new_n110_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n111_ = (~x07 | x15) & (~x00 | x07 | ~x15);
