...
module FAU ( 
  ...
  assign new_n133_ = (~x06 | (~new_n134_ & (~x12 | new_n135_ | x16))) & ~new_n79_ & (x06 | ~x12 | new_n135_ | ~x16);
  assign new_n134_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n135_ = x13 & (x02 | ~x11);
  assign new_n136_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n140_ | (~x05 & (new_n85_ | (~new_n138_ & ~x07))));
  assign new_n138_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n139_ | ~x18);
  assign new_n139_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n140_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n142_ & x18;
  assign new_n142_ = (x14 | x15 | (~new_n143_ & ~new_n69_)) & (x08 | ~x15 | ~x19);
  assign new_n143_ = x12 & ((~new_n144_ & ~x06) | (new_n145_ & x06 & x08 & x10));
  assign new_n144_ = (x04 | x08 | ~x21) & (~new_n74_ | ~x08 | ~x10);
  ...
  assign new_n187_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n82_ & x21));
