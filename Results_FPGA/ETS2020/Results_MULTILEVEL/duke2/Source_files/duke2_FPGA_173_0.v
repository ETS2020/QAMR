// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:20 2020
...
module FAU ( 
  ...
  assign z17 = ~x09 & (new_n135_ | (~x05 & (new_n96_ | (~new_n133_ & ~x07))));
  ...
  assign new_n137_ = (x14 | x15 | (~new_n138_ & ~new_n80_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n144_ = ~x21 & (x04 ? (new_n145_ & ~x12) : ~new_n123_);
  ...
  assign new_n169_ = ~x21 & (new_n170_ | (~new_n123_ & ~x04));
  assign new_n170_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n171_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n172_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n174_ | (new_n181_ & ~x05))) | (~x09 & new_n182_ & x17);
  assign new_n174_ = x18 & ((~new_n175_ & x08) | (~x05 & ~x07 & new_n180_ & ~x08));
  assign new_n175_ = (new_n179_ | x07) & (x05 | ((~new_n176_ | x07) & (new_n178_ | ~x15)));
  assign new_n176_ = ~x09 & x10 & new_n177_ & x12;
  assign new_n177_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n178_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n179_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n180_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
  assign new_n181_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n182_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z00 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z13 = 1'b0;
