...
module FAU ( 
  ...
  assign new_n114_ = (~x06 | (~new_n115_ & (~x12 | new_n116_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n116_ | ~x16);
  assign new_n115_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n116_ = x13 & (x02 | ~x11);
  assign new_n117_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n121_ | (~x05 & (new_n99_ | (~new_n119_ & ~x07))));
  ...
  assign new_n123_ = (x14 | x15 | (~new_n124_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n124_ = x12 & ((~new_n125_ & ~x06) | (new_n126_ & x06 & x08 & x10));
  assign new_n125_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n130_ = ~x21 & (x04 ? (new_n131_ & ~x12) : ~new_n108_);
  ...
  assign new_n143_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign new_n152_ = ~x21 & (new_n153_ | (~new_n108_ & ~x04));
  assign new_n153_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  ...
  assign new_n163_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
