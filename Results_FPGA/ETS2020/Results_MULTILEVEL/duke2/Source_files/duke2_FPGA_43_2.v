...
module FAU ( 
  ...
  assign z24 = ~x09 & ~x17 & (new_n130_ | new_n134_);
  assign new_n130_ = ~x07 & (new_n131_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n131_ = ~x21 & ((x04 & ~new_n132_ & ~x15) | (x08 & new_n133_ & x15));
  assign new_n132_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n133_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n134_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n136_ & ~x05;
  assign new_n136_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n139_ | (new_n144_ & ~x07 & x08 & x03 & ~x05);
  assign new_n139_ = ~x09 & ((~x17 & ~new_n140_ & x18) | (~x05 & x17 & ~new_n143_ & ~x18));
  assign new_n140_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n141_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n141_ = ~x21 & (new_n142_ | (~new_n116_ & ~x04));
