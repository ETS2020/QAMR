...
module FAU ( 
  ...
  assign new_n127_ = (~x06 | (~new_n128_ & (~x12 | new_n129_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n129_ | ~x16);
  assign new_n128_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n129_ = x13 & (x02 | ~x11);
  assign new_n130_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n134_ | (~x05 & (new_n100_ | (~new_n132_ & ~x07))));
  ...
  assign new_n136_ = (x14 | x15 | (~new_n137_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n137_ = x12 & ((~new_n138_ & ~x06) | (new_n139_ & x06 & x08 & x10));
  assign new_n138_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  ...
  assign new_n143_ = ~x21 & (x04 ? (new_n144_ & ~x12) : ~new_n112_);
  ...
  assign new_n165_ = ~x21 & (new_n166_ | (~new_n112_ & ~x04));
  ...
  assign new_n176_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
