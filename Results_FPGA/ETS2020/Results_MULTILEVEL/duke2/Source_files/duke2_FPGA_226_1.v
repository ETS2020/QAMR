...
module FAU ( 
  ...
  assign z14 = (~x17 & (new_n111_ | (~x05 & new_n115_ & ~x09))) | (~x05 & new_n117_ & ~x09);
  assign new_n111_ = new_n112_ & x08;
  assign new_n112_ = x18 & (x07 ? new_n114_ : (~new_n113_ & (x09 | (~x09 & ~x21))));
  assign new_n113_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n114_ = ~x19 & (~x05 ^ ~x15);
  assign new_n115_ = ~x18 & (new_n116_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n116_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n117_ = ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  ...
  assign new_n136_ = ~x21 & (x04 ? (new_n137_ & ~x12) : ~new_n106_);
  ...
  assign new_n150_ = ~x07 & (new_n151_ | (~x15 & x18 & ~x05 & ~x08));
  ...
  assign new_n159_ = ~x21 & (new_n160_ | (~new_n106_ & ~x04));
  ...
  assign new_n170_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
