...
module FAU ( 
  ...
  assign new_n137_ = (~x06 | (~new_n138_ & (~x12 | new_n139_ | x16))) & ~new_n90_ & (x06 | ~x12 | new_n139_ | ~x16);
  assign new_n138_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n139_ = x13 & (x02 | ~x11);
  assign new_n140_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n144_ | (~x05 & (new_n96_ | (~new_n142_ & ~x07))));
  assign new_n142_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n143_ | ~x18);
  assign new_n143_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n144_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n146_ & x18;
  assign new_n146_ = (x14 | x15 | (~new_n147_ & ~new_n80_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n160_ = ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n173_ = ~x21 & (new_n174_ | (~new_n123_ & ~x04));
  ...
  assign new_n184_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
