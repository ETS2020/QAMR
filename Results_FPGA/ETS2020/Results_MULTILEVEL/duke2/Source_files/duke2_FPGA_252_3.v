...
module FAU ( 
  ...
  assign new_n144_ = ~new_n148_ & (~x18 | (~new_n145_ & (x05 | ~new_n150_ | x06)));
  assign new_n145_ = ~x21 & (x04 ? (new_n146_ & ~x12) : ~new_n113_);
  assign new_n146_ = ~x15 & (x05 ? x08 : (x08 ? (new_n147_ & x10) : ~x06));
  assign new_n147_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n148_ = new_n149_ & x04 & ~x05 & x12;
  assign new_n149_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n150_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n151_ = new_n152_ & x04 & x05 & x08;
  assign new_n152_ = ~x15 & x18 & x09 & ~x12;
  ...
  assign z22 = ~x17 & x18 & ((~new_n156_ & ~x07) | (~x05 & new_n157_ & x07));
  assign new_n156_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n157_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n159_ & x18;
  assign new_n159_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n161_ | new_n165_);
  assign new_n161_ = ~x07 & (new_n162_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n162_ = ~x21 & ((x04 & ~new_n163_ & ~x15) | (x08 & new_n164_ & x15));
  assign new_n163_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n164_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  ...
  assign new_n176_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
