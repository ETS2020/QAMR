...
module FAU ( 
  ...
  assign new_n129_ = (~x06 | (~new_n130_ & (~x12 | new_n131_ | x16))) & ~new_n79_ & (x06 | ~x12 | new_n131_ | ~x16);
  assign new_n130_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n131_ = x13 & (x02 | ~x11);
  assign new_n132_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n136_ | (~x05 & (new_n85_ | (~new_n134_ & ~x07))));
  ...
  assign new_n138_ = (x14 | x15 | (~new_n139_ & ~new_n69_)) & (x08 | ~x15 | ~x19);
  assign new_n139_ = x12 & ((~new_n140_ & ~x06) | (new_n141_ & x06 & x08 & x10));
  assign new_n140_ = (x04 | x08 | ~x21) & (~new_n74_ | ~x08 | ~x10);
  ...
  assign new_n144_ = ~x21 & (x04 ? (new_n145_ & ~x12) : ~new_n115_);
  ...
  assign new_n168_ = ~x21 & (new_n169_ | (~new_n115_ & ~x04));
