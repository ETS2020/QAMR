// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:38 2020
...
module FAU ( 
  ...
  assign z12 = ~x09 & ((~new_n106_ & ~x07) | (new_n113_ & ~x05 & x07));
  assign new_n106_ = (x17 | ~new_n107_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n107_ = ~x21 & ((~new_n111_ & ~x04) | (~new_n108_ & ~x05) | (new_n112_ & x04 & x05));
  assign new_n108_ = ~new_n110_ & (x15 | (x08 ? (~new_n93_ | x14) : new_n109_));
  assign new_n109_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n110_ = x11 & x15 & ~x02 & x08;
  assign new_n111_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n112_ = x08 & ~x12 & ~x15;
  ...
  assign new_n117_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  ...
  assign new_n125_ = (~x06 | (~new_n126_ & (~x12 | new_n127_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n127_ | ~x16);
  assign new_n126_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n127_ = x13 & (x02 | ~x11);
  assign new_n128_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n132_ | (~x05 & (new_n99_ | (~new_n130_ & ~x07))));
  ...
  assign new_n134_ = (x14 | x15 | (~new_n135_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n135_ = x12 & ((~new_n136_ & ~x06) | (new_n137_ & x06 & x08 & x10));
  assign new_n136_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n140_ = ~x21 & (x04 ? (new_n141_ & ~x12) : ~new_n111_);
  ...
  assign z27 = new_n158_ | (new_n163_ & ~x07 & x08 & x03 & ~x05);
  assign new_n158_ = ~x09 & ((~x17 & ~new_n159_ & x18) | (~x05 & x17 & ~new_n162_ & ~x18));
  assign new_n159_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n160_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n160_ = ~x21 & (new_n161_ | (~new_n111_ & ~x04));
  assign new_n161_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n162_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n163_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n165_ | (new_n172_ & ~x05))) | (~x09 & new_n173_ & x17);
  assign new_n165_ = x18 & ((~new_n166_ & x08) | (~x05 & ~x07 & new_n171_ & ~x08));
  assign new_n166_ = (new_n170_ | x07) & (x05 | ((~new_n167_ | x07) & (new_n169_ | ~x15)));
  assign new_n167_ = ~x09 & x10 & new_n168_ & x12;
  assign new_n168_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n169_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n170_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n171_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
  assign new_n172_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n173_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z04 = 1'b0;
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z13 = 1'b0;
