...
module FAU ( 
  ...
  assign new_n143_ = (~x06 | (~new_n144_ & (~x12 | new_n145_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n145_ | ~x16);
  assign new_n144_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n145_ = x13 & (x02 | ~x11);
  assign new_n146_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n150_ | (~x05 & (new_n100_ | (~new_n148_ & ~x07))));
  ...
  assign new_n152_ = (x14 | x15 | (~new_n153_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n153_ = x12 & ((~new_n154_ & ~x06) | (new_n155_ & x06 & x08 & x10));
  assign new_n154_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  ...
  assign new_n159_ = ~x21 & (x04 ? (new_n160_ & ~x12) : ~new_n129_);
