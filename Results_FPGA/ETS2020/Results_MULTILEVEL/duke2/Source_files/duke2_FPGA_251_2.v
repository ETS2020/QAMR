...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n127_, new_n129_, new_n132_, new_n133_, new_n134_, new_n135_,
    new_n136_, new_n137_;
  ...
  assign z22 = ~x17 & x18 & ((~new_n124_ & ~x07) | (~x05 & new_n125_ & x07));
  assign new_n124_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)));
  assign new_n125_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n127_ & x18;
  assign new_n127_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z25 = new_n129_ & ~x05;
  assign new_n129_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n132_ | (new_n137_ & ~x07 & x08 & x03 & ~x05);
  assign new_n132_ = ~x09 & ((~x17 & ~new_n133_ & x18) | (~x05 & x17 & ~new_n136_ & ~x18));
  assign new_n133_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n134_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n134_ = ~x21 & (new_n135_ | (~new_n115_ & ~x04));
