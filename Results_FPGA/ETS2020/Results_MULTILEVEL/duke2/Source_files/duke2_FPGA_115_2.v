...
module FAU ( 
  ...
  assign new_n88_ = ~x07 & new_n89_ & ~x09;
  ...
  assign z12 = ~x09 & ((~new_n98_ & ~x07) | (new_n89_ & ~x05 & x07));
  assign new_n98_ = (x17 | ~new_n99_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n99_ = ~x21 & ((~new_n104_ & ~x04) | (~new_n100_ & ~x05) | (new_n105_ & x04 & x05));
  assign new_n100_ = ~new_n103_ & (x15 | (x08 ? (~new_n102_ | x14) : new_n101_));
  ...
  assign new_n129_ = ~x21 & (new_n130_ | (~new_n104_ & ~x04));
