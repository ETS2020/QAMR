...
module FAU ( 
  ...
  assign new_n152_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n153_ = new_n61_ & new_n96_ & ~x11 & x15;
  ...
  assign new_n157_ = (~new_n86_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  ...
  assign z27 = new_n187_ | (new_n192_ & new_n62_ & x03 & ~x05);
  ...
  assign new_n200_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
