// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:53 2020
...
module FAU ( 
  ...
  assign new_n153_ = ~x21 & (x04 ? (new_n154_ & ~x12) : ~new_n123_);
  ...
  assign new_n178_ = ~x21 & (new_n179_ | (~new_n123_ & ~x04));
  ...
  assign new_n189_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n86_ & x21));
