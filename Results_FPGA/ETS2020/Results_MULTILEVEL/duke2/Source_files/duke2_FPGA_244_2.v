...
module FAU ( 
  ...
  assign z24 = ~x09 & ~x17 & (new_n119_ | new_n123_);
  assign new_n119_ = ~x07 & (new_n120_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n120_ = ~x21 & ((x04 & ~new_n121_ & ~x15) | (x08 & new_n122_ & x15));
  assign new_n121_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n122_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n123_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n125_ & ~x05;
  assign new_n125_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n128_ | (new_n134_ & ~x07 & x08 & x03 & ~x05);
  assign new_n128_ = ~x09 & ((~x17 & ~new_n129_ & x18) | (~x05 & x17 & ~new_n133_ & ~x18));
  assign new_n129_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n130_ & (x15 | ~x19 | ~x05 | x08));
  ...
  assign new_n133_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n134_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z05 = 1'b0;
  assign z06 = 1'b0;
