...
module FAU ( 
  ...
  assign new_n90_ = (~new_n98_ | x07) & (x15 | (~new_n101_ & (x07 | (~new_n91_ & ~new_n100_))));
  ...
  assign new_n94_ = ~x05 & ((new_n96_ & x02) | (~new_n95_ & x06));
  ...
  assign new_n116_ = ~new_n118_ & (x15 | (x08 ? (~new_n79_ | x14) : new_n117_));
  ...
  assign z24 = ~x09 & ~x17 & (new_n155_ | new_n159_);
  assign new_n155_ = ~x07 & (new_n156_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n156_ = ~x21 & ((x04 & ~new_n157_ & ~x15) | (x08 & new_n158_ & x15));
  assign new_n157_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  assign new_n158_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n159_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  ...
  assign new_n166_ = ~x21 & (new_n167_ | (~new_n119_ & ~x04));
  assign new_n167_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n168_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n169_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n171_ | (new_n178_ & ~x05))) | (~x09 & new_n179_ & x17);
  assign new_n171_ = x18 & ((~new_n172_ & x08) | (~x05 & ~x07 & new_n177_ & ~x08));
  assign new_n172_ = (new_n176_ | x07) & (x05 | ((~new_n173_ | x07) & (new_n175_ | ~x15)));
  assign new_n173_ = ~x09 & x10 & new_n174_ & x12;
  assign new_n174_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n175_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n176_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n177_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n82_ & x21));
  assign new_n178_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n179_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z19 = 1'b0;
  assign z20 = 1'b0;
