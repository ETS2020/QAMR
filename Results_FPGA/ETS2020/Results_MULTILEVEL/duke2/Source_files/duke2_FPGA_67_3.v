// Benchmark "FAU" written by ABC on Wed Aug  5 21:20:24 2020
...
module FAU ( 
  ...
  assign new_n172_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign z28 = (~x17 & (new_n185_ | (new_n192_ & ~x05))) | (~x09 & new_n193_ & x17);
  assign new_n185_ = x18 & ((~new_n186_ & x08) | (~x05 & ~x07 & new_n191_ & ~x08));
  assign new_n186_ = (new_n190_ | x07) & (x05 | ((~new_n187_ | x07) & (new_n189_ | ~x15)));
  assign new_n187_ = ~x09 & x10 & new_n188_ & x12;
  assign new_n188_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n189_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n190_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n191_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
  assign new_n192_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n193_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z07 = 1'b0;
  assign z08 = 1'b0;
  assign z15 = 1'b0;
  assign z26 = 1'b0;
