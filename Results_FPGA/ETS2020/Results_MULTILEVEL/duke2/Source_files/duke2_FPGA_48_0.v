...
module FAU ( 
  ...
  assign z12 = ~x09 & ((~new_n124_ & ~x07) | (new_n120_ & ~x05 & x07));
  ...
  assign new_n135_ = (~x06 | (~new_n136_ & (~x12 | new_n137_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n137_ | ~x16);
  ...
  assign new_n144_ = (x14 | x15 | (~new_n145_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n145_ = x12 & ((~new_n146_ & ~x06) | (new_n147_ & x06 & x08 & x10));
  assign new_n146_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  ...
  assign new_n150_ = ~x21 & (x04 ? (new_n151_ & ~x12) : ~new_n129_);
  ...
  assign new_n172_ = ~x21 & (new_n173_ | (~new_n129_ & ~x04));
  ...
  assign new_n183_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
