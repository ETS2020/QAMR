...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n167_, new_n168_, new_n169_, new_n170_, new_n172_;
  ...
  assign new_n93_ = ~new_n63_ & (x15 | (~new_n98_ & (x14 | (~new_n87_ & new_n94_))));
  ...
  assign new_n114_ = ~new_n116_ & (x15 | (x08 ? (~new_n95_ | x14) : new_n115_));
  ...
  assign new_n133_ = (~x06 | (~new_n134_ & (~x12 | new_n135_ | x16))) & ~new_n95_ & (x06 | ~x12 | new_n135_ | ~x16);
  assign new_n134_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n135_ = x13 & (x02 | ~x11);
  assign new_n136_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & ((~new_n138_ & ~x05) | (new_n141_ & new_n66_ & ~x04 & x05));
  assign new_n138_ = (new_n139_ | x07) & (~x17 | x18 | ~x07 | x15);
  assign new_n139_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n140_ | ~x18);
  assign new_n140_ = ~new_n61_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n141_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  ...
  assign new_n150_ = ~x21 & (x04 ? (new_n151_ & ~x12) : ~new_n117_);
  ...
  assign new_n161_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)));
