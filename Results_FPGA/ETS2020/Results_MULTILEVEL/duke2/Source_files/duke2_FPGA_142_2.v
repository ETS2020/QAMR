...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n70_, new_n73_, new_n74_, new_n75_, new_n76_, new_n78_, new_n82_,
    new_n83_, new_n84_, new_n85_, new_n86_, new_n89_, new_n91_, new_n92_,
  ...
  assign z18 = ~x05 & ~x07 & ~x09 & new_n82_ & ~x17;
  assign new_n82_ = x18 & ((~x14 & ~new_n83_ & ~x15) | (~x08 & x15 & x19));
  assign new_n83_ = (new_n84_ | ~x02) & (~x12 | (~new_n86_ & (new_n85_ | x06)));
  assign new_n84_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n85_ = (x04 | x08 | ~x21) & (x13 | x16 | x21 | ~x08 | ~x10);
  assign new_n86_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  ...
  assign new_n103_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
