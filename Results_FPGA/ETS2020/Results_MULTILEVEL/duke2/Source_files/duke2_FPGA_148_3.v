// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:07 2020
...
module FAU ( 
  ...
  assign new_n79_ = ~x17 & x18 & ((~new_n84_ & x02) | new_n80_ | new_n82_);
  ...
  assign new_n86_ = (x17 | ~x18 | (~new_n58_ & (new_n87_ | x15))) & (~x17 | x18 | ~x00 | ~x15);
  ...
  assign new_n101_ = x05 ? ((~x17 | x18) & (x06 | x08 | x15 | x17 | ~x18)) : (x15 ? ((~x17 | x18) & (x06 | x08 | x17 | ~x18)) : (~x17 | x18));
  ...
  assign new_n109_ = ~new_n111_ & (x15 | (x08 ? (~new_n89_ | x14) : new_n110_));
  assign new_n110_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n111_ = ~x02 & x08 & x11 & x15;
  assign new_n112_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n113_ = x08 & ~x12 & ~x15;
  assign new_n114_ = ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~x17 & (new_n117_ | (~x05 & new_n121_ & ~x09))) | (~x05 & new_n123_ & ~x09);
  assign new_n117_ = new_n118_ & x08;
  assign new_n118_ = x18 & (x07 ? new_n120_ : (~new_n119_ & (x09 | (~x09 & ~x21))));
  assign new_n119_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n120_ = ~x19 & (x05 ^ x15);
  assign new_n121_ = ~x18 & (new_n122_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n122_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n123_ = ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  ...
  assign new_n134_ = ~new_n56_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n135_ = new_n61_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n145_ | (~new_n138_ & ~x09));
  assign new_n138_ = ~new_n142_ & (~x18 | (~new_n139_ & (x05 | ~new_n144_ | x06)));
  assign new_n139_ = ~x21 & (x04 ? (new_n140_ & ~x12) : ~new_n112_);
  assign new_n140_ = ~x15 & (x05 ? x08 : (x08 ? (new_n141_ & x10) : ~x06));
  assign new_n141_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n142_ = new_n143_ & x04 & ~x05 & x12;
  assign new_n143_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n144_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n145_ = new_n146_ & x04 & x05 & x08;
  assign new_n146_ = ~x15 & x18 & x09 & ~x12;
  assign z21 = ~x17 & ~new_n148_ & x18;
  assign new_n148_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x09 | ~x15 | x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n157_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign new_n169_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n170_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n92_ & x21));
