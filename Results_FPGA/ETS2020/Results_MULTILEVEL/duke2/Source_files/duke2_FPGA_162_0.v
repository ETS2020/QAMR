// Benchmark "FAU" written by ABC on Wed Aug  5 21:21:15 2020
...
module FAU ( 
  ...
  assign new_n106_ = ~new_n108_ & (x15 | (x08 ? (~new_n94_ | x14) : new_n107_));
  assign new_n107_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n108_ = x11 & x15 & ~x02 & x08;
  ...
  assign new_n115_ = ~x14 & ~new_n116_ & ~x21;
  assign new_n116_ = (~x06 | (~new_n117_ & (~x12 | new_n118_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n118_ | ~x16);
  assign new_n117_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n118_ = x13 & (x02 | ~x11);
  assign new_n119_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n123_ | (~x05 & (new_n100_ | (~new_n121_ & ~x07))));
  assign new_n121_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n122_ | ~x18);
  assign new_n122_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n123_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n125_ & x18;
  assign new_n125_ = (x14 | x15 | (~new_n126_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n126_ = x12 & ((~new_n127_ & ~x06) | (new_n128_ & x06 & x08 & x10));
  assign new_n127_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  assign new_n128_ = ~x13 & x16 & ~x21;
  assign z20 = ~x07 & ~x17 & (new_n137_ | (~new_n130_ & ~x09));
  assign new_n130_ = ~new_n134_ & (~x18 | (~new_n131_ & (x05 | ~new_n136_ | x06)));
  assign new_n131_ = ~x21 & (x04 ? (new_n132_ & ~x12) : ~new_n109_);
  assign new_n132_ = ~x15 & (x05 ? x08 : (x08 ? (new_n133_ & x10) : ~x06));
  assign new_n133_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n134_ = new_n135_ & x04 & ~x05 & x12;
  assign new_n135_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n136_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n137_ = new_n138_ & x04 & x05 & x08;
  assign new_n138_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n144_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign z27 = new_n151_ | (new_n156_ & ~x07 & x08 & x03 & ~x05);
  assign new_n151_ = ~x09 & ((~x17 & ~new_n152_ & x18) | (~x05 & x17 & ~new_n155_ & ~x18));
  assign new_n152_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n153_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n153_ = ~x21 & (new_n154_ | (~new_n109_ & ~x04));
  assign new_n154_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n155_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n156_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n158_ | (new_n165_ & ~x05))) | (~x09 & new_n166_ & x17);
  assign new_n158_ = x18 & ((~new_n159_ & x08) | (~x05 & ~x07 & new_n164_ & ~x08));
  assign new_n159_ = (new_n163_ | x07) & (x05 | ((~new_n160_ | x07) & (new_n162_ | ~x15)));
  assign new_n160_ = ~x09 & x10 & new_n161_ & x12;
  assign new_n161_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n162_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n163_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n164_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
