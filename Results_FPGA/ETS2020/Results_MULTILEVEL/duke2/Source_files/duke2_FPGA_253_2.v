...
module FAU ( 
  ...
  assign new_n83_ = ~x07 & ~x09 & new_n84_ & ~x15;
  ...
  assign z17 = ~x09 & ((~new_n103_ & ~x05) | (new_n106_ & new_n58_ & ~x04 & x05));
  assign new_n103_ = (~new_n84_ | ~x07 | x15) & (x07 | ((~new_n84_ | ~x00 | ~x15) & (x08 | ~new_n104_ | x15)));
  assign new_n104_ = ~x17 & x18 & ~new_n105_ & (~x21 | (~x14 & x21));
  assign new_n105_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n106_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  ...
  assign new_n114_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  ...
  assign z27 = new_n121_ | (new_n127_ & new_n58_ & x03 & ~x05);
