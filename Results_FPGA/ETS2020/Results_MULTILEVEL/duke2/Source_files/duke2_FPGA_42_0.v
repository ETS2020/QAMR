...
module FAU ( 
  ...
  assign z17 = ~x09 & (new_n148_ | (~x05 & (new_n99_ | (~new_n146_ & ~x07))));
  ...
  assign new_n150_ = (x14 | x15 | (~new_n151_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n151_ = x12 & ((~new_n152_ & ~x06) | (new_n153_ & x06 & x08 & x10));
  assign new_n152_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
