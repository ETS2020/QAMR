...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n96_, new_n97_, new_n98_, new_n99_, new_n103_, new_n105_,
  ...
  assign z23 = new_n108_ & x18;
  assign new_n108_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z25 = new_n110_ & ~x05;
  assign new_n110_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z27 = new_n112_ | (new_n118_ & ~x07 & x08 & x03 & ~x05);
  assign new_n112_ = ~x09 & ((~x17 & ~new_n113_ & x18) | (~x05 & x17 & ~new_n117_ & ~x18));
  assign new_n113_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n114_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n114_ = ~x21 & (new_n116_ | (~new_n115_ & ~x04));
  assign new_n115_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n116_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n117_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n118_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z04 = 1'b0;
  assign z05 = 1'b0;
