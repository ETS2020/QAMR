...
module FAU ( 
  ...
  assign new_n119_ = (~x06 | (~new_n120_ & (~x12 | new_n121_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n121_ | ~x16);
  assign new_n120_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n121_ = x13 & (x02 | ~x11);
  assign new_n122_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n126_ | (~x05 & (new_n100_ | (~new_n124_ & ~x07))));
  ...
  assign new_n128_ = (x14 | x15 | (~new_n129_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  assign new_n129_ = x12 & ((~new_n130_ & ~x06) | (new_n131_ & x06 & x08 & x10));
  assign new_n130_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  assign new_n131_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n141_ | (~new_n134_ & ~x09));
  assign new_n134_ = ~new_n138_ & (~x18 | (~new_n135_ & (x05 | ~new_n140_ | x06)));
  assign new_n135_ = ~x21 & (x04 ? (new_n136_ & ~x12) : ~new_n112_);
  assign new_n136_ = ~x15 & (x05 ? x08 : (x08 ? (new_n137_ & x10) : ~x06));
  assign new_n137_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n138_ = new_n139_ & x04 & ~x05 & x12;
  assign new_n139_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n140_ = ~x08 & ~x14 & ~x15 & x21 & (x04 ^ x12);
  assign new_n141_ = new_n142_ & x04 & x05 & x08;
  assign new_n142_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n148_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign new_n156_ = ~x21 & (new_n157_ | (~new_n112_ & ~x04));
