...
module FAU ( 
  ...
  assign new_n113_ = ~new_n115_ & (x15 | (x08 ? (~new_n93_ | x14) : new_n114_));
  ...
  assign new_n126_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  ...
  assign z28 = (~x17 & (new_n147_ | (new_n154_ & ~x05))) | (~x09 & new_n155_ & x17);
  assign new_n147_ = x18 & ((~new_n148_ & x08) | (~x05 & ~x07 & new_n153_ & ~x08));
  assign new_n148_ = (new_n152_ | x07) & (x05 | ((~new_n149_ | x07) & (new_n151_ | ~x15)));
  assign new_n149_ = ~x09 & x10 & new_n150_ & x12;
  assign new_n150_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n151_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n152_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n153_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
  assign new_n154_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n155_ = ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
  assign z09 = 1'b0;
  assign z18 = 1'b0;
  assign z20 = 1'b0;
  assign z22 = 1'b0;
