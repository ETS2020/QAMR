...
module FAU ( 
  ...
  assign new_n38_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = x08 ? x06 : (new_n40_ & x09);
  assign new_n40_ = ~x10 & ((x17 & (~new_n41_ | ~x14 | ~x15 | ~x16)) | (new_n41_ & x14 & x15 & x16 & ~x17));
  assign new_n41_ = x11 & x12 & x13;
  assign z8 = x08 ? x07 : (x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x18 | (new_n41_ & new_n45_)) & (~new_n46_ | ~new_n44_ | ~x17 | x18);
  assign new_n44_ = x15 & x16;
