// Benchmark "FAU" written by ABC on Wed Aug  5 20:06:58 2020
...
module FAU ( 
  ...
  assign new_n39_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  ...
  assign new_n44_ = (~x18 | (new_n42_ & new_n46_)) & (~new_n47_ | ~new_n45_ | ~x17 | x18);
