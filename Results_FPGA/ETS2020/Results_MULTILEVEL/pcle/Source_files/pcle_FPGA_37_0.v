// Benchmark "FAU" written by ABC on Wed Aug  5 20:05:54 2020
...
module FAU ( 
  ...
  wire new_n31_, new_n35_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_;
  ...
  assign z8 = x08 ? x07 : (x09 & ~x10 & (new_n39_ | new_n41_));
  assign new_n39_ = x18 & (~new_n40_ | ~x11 | ~x12 | ~x13);
  assign new_n40_ = x14 & x15 & x16 & x17;
  assign new_n41_ = new_n42_ & x11 & x12 & x13 & x14;
  assign new_n42_ = x15 & x16 & x17 & ~x18;
  assign z5 = 1'b0;
  assign z6 = 1'b0;
  assign z7 = 1'b0;
endmodule
