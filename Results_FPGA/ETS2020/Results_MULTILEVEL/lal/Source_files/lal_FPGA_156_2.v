...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n52_, new_n55_, new_n56_, new_n57_, new_n58_,
    new_n59_, new_n60_, new_n64_, new_n66_, new_n68_, new_n70_, new_n71_,
    new_n73_, new_n74_, new_n76_, new_n77_;
  ...
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n64_ | (new_n50_ & new_n64_) | (x17 & x18 & x19 & ~x20);
  assign new_n64_ = ~x07 & ~x15;
  assign z14 = (~new_n59_ & x21) | ~new_n64_ | new_n66_ | (new_n50_ & new_n64_);
  assign new_n66_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n66_ & x22) | ~new_n64_ | new_n68_ | (new_n50_ & new_n64_);
  assign new_n68_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n68_ & x23) | ~new_n64_ | new_n70_ | (new_n50_ & new_n64_);
  ...
  assign z18 = new_n76_ | ~new_n64_ | new_n77_ | (new_n50_ & new_n64_);
