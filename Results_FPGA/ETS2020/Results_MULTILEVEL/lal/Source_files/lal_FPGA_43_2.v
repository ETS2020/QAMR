...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n53_, new_n58_, new_n59_, new_n60_, new_n61_,
    new_n62_, new_n63_, new_n67_, new_n69_, new_n71_, new_n73_, new_n74_,
  ...
  assign z14 = (~new_n62_ & x21) | ~new_n67_ | new_n69_ | (new_n51_ & new_n67_);
  ...
  assign new_n79_ = x25 & (~new_n62_ | x21 | x22 | x23 | x24);
  assign new_n80_ = new_n62_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z02 = x16;
endmodule
