// Benchmark "FAU" written by ABC on Wed Aug  5 21:04:06 2020
...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n53_, new_n58_, new_n59_, new_n60_, new_n61_,
    new_n62_, new_n63_, new_n68_, new_n70_, new_n72_, new_n74_, new_n75_,
  ...
  assign z14 = (~new_n62_ & x21) | ~new_n68_ | new_n70_ | (new_n51_ & new_n68_);
  ...
  assign new_n77_ = ~x07 & ~x15 & (~new_n51_ | x07 | x15);
  assign new_n78_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n80_ | ~new_n68_ | new_n81_ | (new_n51_ & new_n68_);
  assign new_n80_ = x25 & (~new_n62_ | x21 | x22 | x23 | x24);
  assign new_n81_ = new_n62_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z02 = 1'b0;
  assign z10 = 1'b0;
endmodule
