...
module FAU ( 
  ...
  assign z14 = (x21 & (~new_n71_ | ~x19 | x20)) | ~new_n69_ | (new_n51_ & new_n69_) | (new_n71_ & x19 & ~x20 & ~x21);
  assign new_n71_ = x17 & x18;
  assign z15 = new_n73_ | ~new_n69_ | new_n74_ | (new_n51_ & new_n69_);
  assign new_n73_ = x22 & (~new_n71_ | ~x19 | x20 | x21);
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = new_n76_ | ~new_n78_ | (x17 & new_n79_ & x18);
  assign new_n76_ = x24 & (~new_n77_ | ~x17 | ~x18 | ~x19);
