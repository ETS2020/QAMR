// Benchmark "FAU" written by ABC on Thu Aug  6 11:39:14 2020
...
module FAU ( 
  ...
  assign new_n224_ = ~x014 & (x078 | (~x022 & (new_n183_ | ~x030)));
  assign new_n225_ = ~x078 & ((new_n226_ & x030) | (x070 & (~new_n181_ | (~x022 & x030))));
  assign new_n226_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n227_ = x038 & ~x078 & (~new_n181_ | (x030 & (~x014 | ~x022)));
