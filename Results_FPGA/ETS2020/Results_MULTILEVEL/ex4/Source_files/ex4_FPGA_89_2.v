// Benchmark "FAU" written by ABC on Thu Aug  6 11:39:23 2020
...
module FAU ( 
  ...
  assign new_n189_ = x001 & x081 & ((~x009 & ~x033) | (~x049 & ~x073));
  assign new_n190_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = ~x042 & (new_n192_ | ~new_n193_);
  assign new_n192_ = x002 & x082 & ((~x010 & ~x034) | (~x050 & ~x074));
  assign new_n193_ = (~x018 | ~x066 | ((x010 | x050) & (x034 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z12 = ~x044 & (new_n195_ | ~new_n196_);
  assign new_n195_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign new_n196_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & ((~new_n198_ & x005) | ~new_n211_ | (~new_n206_ & ~x085));
  assign new_n198_ = (x053 | (~new_n199_ & (~new_n205_ | ~x013 | x037))) & (x013 | x037 | ~x085);
  assign new_n199_ = ~x077 & (new_n200_ | new_n201_ | new_n202_ | new_n203_ | ~new_n204_);
  assign new_n200_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n201_ = ~x069 & (x109 | x117 | (~x093 & (x101 | x125)));
  assign new_n202_ = x117 & (~x037 | (~x109 & x125));
  assign new_n203_ = ~x037 & (x109 | (~x061 & x101));
  assign new_n204_ = ~x085 & (x021 | x117 | ~x125);
  assign new_n205_ = ~x061 & x125;
  assign new_n206_ = ~new_n210_ & (x053 | (~new_n208_ & (new_n207_ | (~x109 & ~x117))));
  assign new_n207_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n208_ = ~x077 & ((x069 & (~new_n183_ | (~x021 & x029))) | (new_n209_ & x029));
  assign new_n209_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n210_ = x037 & ~x077 & (~new_n183_ | (x029 & (~x013 | ~x021)));
  assign new_n211_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z04 = 1'b0;
  assign z06 = 1'b0;
  assign z07 = 1'b0;
  assign z08 = 1'b0;
