...
module FAU ( 
  ...
  assign new_n192_ = x003 & x083 & ((~x011 & ~x035) | (~x051 & ~x075));
  assign new_n193_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  ...
  assign new_n204_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n205_ = ~x077 & ((x069 & (~new_n183_ | (~x021 & x029))) | (new_n206_ & x029));
  assign new_n206_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n207_ = x037 & ~x077 & (~new_n183_ | (x029 & (~x013 | ~x021)));
