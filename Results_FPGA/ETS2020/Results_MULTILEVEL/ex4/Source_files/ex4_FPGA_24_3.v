// Benchmark "FAU" written by ABC on Thu Aug  6 11:38:10 2020
...
module FAU ( 
  ...
  assign new_n247_ = ~x013 & (x077 | (~x021 & (new_n184_ | ~x029)));
  assign new_n248_ = ~x077 & ((new_n249_ & x029) | (x069 & (~new_n186_ | (~x021 & x029))));
  assign new_n249_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n250_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
