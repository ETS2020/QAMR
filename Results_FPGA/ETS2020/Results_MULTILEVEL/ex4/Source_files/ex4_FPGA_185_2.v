// Benchmark "FAU" written by ABC on Thu Aug  6 11:41:58 2020
...
module FAU ( 
  ...
  assign new_n195_ = x003 & x083 & ((~x011 & ~x035) | (~x051 & ~x075));
  assign new_n196_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
