// Benchmark "FAU" written by ABC on Thu Aug  6 11:39:31 2020
...
module FAU ( 
  ...
  assign new_n227_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n228_ = ~x077 & ((x069 & (~new_n183_ | (~x021 & x029))) | (new_n229_ & x029));
  assign new_n229_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n230_ = x037 & ~x077 & (~new_n183_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n242_ = ~x014 & (x078 | (~x022 & (new_n201_ | ~x030)));
  assign new_n243_ = ~x078 & ((x070 & (~new_n199_ | (~x022 & x030))) | (new_n244_ & x030));
  assign new_n244_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n245_ = x038 & ~x078 & (~new_n199_ | (x030 & (~x014 | ~x022)));
