// Benchmark "FAU" written by ABC on Thu Aug  6 11:37:55 2020
...
module FAU ( 
  ...
  assign new_n217_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n218_ = ~x077 & ((x069 & (~new_n183_ | (~x021 & x029))) | (new_n219_ & x029));
