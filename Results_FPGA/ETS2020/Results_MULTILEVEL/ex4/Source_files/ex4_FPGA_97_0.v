...
module FAU ( 
  ...
  assign new_n221_ = ~x014 & (x078 | (~x022 & (new_n180_ | ~x030)));
  assign new_n222_ = ~x078 & ((new_n223_ & x030) | (x070 & (~new_n178_ | (~x022 & x030))));
  assign new_n223_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n224_ = x038 & ~x078 & (~new_n178_ | (x030 & (~x014 | ~x022)));
