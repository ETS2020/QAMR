// Benchmark "FAU" written by ABC on Thu Aug  6 11:37:49 2020
...
module FAU ( 
  ...
  assign new_n238_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n239_ = ~x077 & ((new_n240_ & x029) | (x069 & (~new_n183_ | (~x021 & x029))));
