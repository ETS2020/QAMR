...
module FAU ( 
  ...
  assign z13 = ~x045 & ((~new_n218_ & x005) | ~new_n232_ | (~new_n226_ & ~x085));
  ...
  assign new_n226_ = ~new_n230_ & (x053 | (~new_n227_ & (new_n231_ | (~x109 & ~x117))));
  assign new_n227_ = ~x077 & ((new_n229_ & x029) | (x069 & (~new_n228_ | (~x021 & x029))));
  assign new_n228_ = ~x061 & ~x093;
  assign new_n229_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n230_ = x037 & ~x077 & (~new_n228_ | (x029 & (~x013 | ~x021)));
  assign new_n231_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
  assign new_n232_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & ((~new_n234_ & x006) | ~new_n247_ | (~new_n242_ & ~x086));
  ...
  assign new_n242_ = ~new_n246_ & (x054 | (~new_n244_ & (new_n243_ | (~x110 & ~x118))));
  assign new_n243_ = ~x014 & (x078 | (~x022 & (new_n183_ | ~x030)));
  assign new_n244_ = ~x078 & ((new_n245_ & x030) | (x070 & (~new_n181_ | (~x022 & x030))));
  assign new_n245_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n246_ = x038 & ~x078 & (~new_n181_ | (x030 & (~x014 | ~x022)));
  assign new_n247_ = (~x022 | ~x070 | ((x014 | x054) & (x038 | x078))) & (~x038 | ~x054) & (~x014 | ~x078);
  assign z01 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z15 = 1'b0;
