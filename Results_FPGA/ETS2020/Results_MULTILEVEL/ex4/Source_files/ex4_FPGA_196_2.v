...
module FAU ( 
  ...
  assign new_n220_ = ~x013 & (x077 | (~x021 & (new_n184_ | ~x029)));
  assign new_n221_ = ~x077 & ((x069 & (~new_n186_ | (~x021 & x029))) | (new_n222_ & x029));
  assign new_n222_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n223_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
