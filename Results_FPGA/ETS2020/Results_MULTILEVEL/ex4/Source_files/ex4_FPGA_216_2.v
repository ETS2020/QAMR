// Benchmark "FAU" written by ABC on Thu Aug  6 11:42:52 2020
...
module FAU ( 
  ...
  assign new_n214_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign new_n215_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  ...
  assign new_n226_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n227_ = ~x077 & ((x069 & (~new_n183_ | (~x021 & x029))) | (new_n228_ & x029));
