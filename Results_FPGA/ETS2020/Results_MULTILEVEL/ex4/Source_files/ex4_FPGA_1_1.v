// Benchmark "FAU" written by ABC on Thu Aug  6 11:37:39 2020
...
module FAU ( 
  ...
  assign z13 = ~x045 & ((~new_n212_ & x005) | ~new_n226_ | (~new_n220_ & ~x085));
  ...
  assign new_n220_ = ~new_n224_ & (x053 | (~new_n221_ & (new_n225_ | (~x109 & ~x117))));
  assign new_n221_ = ~x077 & ((new_n223_ & x029) | (x069 & (~new_n222_ | (~x021 & x029))));
  assign new_n222_ = ~x061 & ~x093;
  assign new_n223_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n224_ = x037 & ~x077 & (~new_n222_ | (x029 & (~x013 | ~x021)));
  assign new_n225_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
  assign new_n226_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & ((~new_n228_ & x006) | ~new_n241_ | (~new_n236_ & ~x086));
  ...
  assign new_n236_ = ~new_n240_ & (x054 | (~new_n238_ & (new_n237_ | (~x110 & ~x118))));
  assign new_n237_ = ~x014 & (x078 | (~x022 & (new_n183_ | ~x030)));
  assign new_n238_ = ~x078 & ((new_n239_ & x030) | (x070 & (~new_n181_ | (~x022 & x030))));
  assign new_n239_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n240_ = x038 & ~x078 & (~new_n181_ | (x030 & (~x014 | ~x022)));
  assign new_n241_ = (~x022 | ~x070 | ((x014 | x054) & (x038 | x078))) & (~x038 | ~x054) & (~x014 | ~x078);
  assign z01 = 1'b0;
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z10 = 1'b0;
