// Benchmark "FAU" written by ABC on Thu Aug  6 11:37:54 2020
...
module FAU ( 
  ...
  assign new_n244_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n245_ = ~x077 & ((new_n246_ & x029) | (x069 & (~new_n183_ | (~x021 & x029))));
  assign new_n246_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n247_ = x037 & ~x077 & (~new_n183_ | (x029 & (~x013 | ~x021)));
