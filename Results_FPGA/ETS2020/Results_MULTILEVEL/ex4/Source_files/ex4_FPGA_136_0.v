// Benchmark "FAU" written by ABC on Thu Aug  6 11:40:34 2020
...
module FAU ( 
  ...
  assign z12 = ~x044 & (new_n203_ | ~new_n204_);
  assign new_n203_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign new_n204_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
