// Benchmark "FAU" written by ABC on Thu Aug  6 11:37:58 2020
...
module FAU ( 
  ...
  assign new_n244_ = ~x013 & (x077 | (~x021 & (new_n184_ | ~x029)));
  assign new_n245_ = ~x077 & ((new_n246_ & x029) | (x069 & (~new_n186_ | (~x021 & x029))));
