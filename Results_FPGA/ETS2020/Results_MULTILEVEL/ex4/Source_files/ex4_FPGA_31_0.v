// Benchmark "FAU" written by ABC on Thu Aug  6 11:38:17 2020
...
module FAU ( 
  ...
  assign z09 = ~x041 & (new_n174_ | ~new_n175_);
  assign new_n174_ = x001 & x081 & ((~x009 & ~x033) | (~x049 & ~x073));
  assign new_n175_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = ~x042 & (new_n177_ | ~new_n178_);
  assign new_n177_ = x002 & x082 & ((~x010 & ~x034) | (~x050 & ~x074));
  assign new_n178_ = (~x018 | ~x066 | ((x010 | x050) & (x034 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = ~x043 & (new_n180_ | ~new_n181_);
  assign new_n180_ = x003 & x083 & ((~x011 & ~x035) | (~x051 & ~x075));
  assign new_n181_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = ~x044 & (new_n183_ | ~new_n184_);
  assign new_n183_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign new_n184_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z14 = ~x046 & ((~new_n186_ & x006) | ~new_n200_ | (~new_n194_ & ~x086));
  ...
  assign new_n195_ = ~x078 & ((x070 & (~new_n196_ | (~x022 & x030))) | (new_n197_ & x030));
