// Benchmark "FAU" written by ABC on Thu Aug  6 11:41:56 2020
...
module FAU ( 
  ...
  assign new_n242_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n243_ = ~x077 & ((new_n244_ & x029) | (x069 & (~new_n183_ | (~x021 & x029))));
  assign new_n244_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n245_ = x037 & ~x077 & (~new_n183_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n257_ = ~x014 & (x078 | (~x022 & (new_n201_ | ~x030)));
  assign new_n258_ = ~x078 & ((new_n259_ & x030) | (x070 & (~new_n199_ | (~x022 & x030))));
  assign new_n259_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n260_ = x038 & ~x078 & (~new_n199_ | (x030 & (~x014 | ~x022)));
