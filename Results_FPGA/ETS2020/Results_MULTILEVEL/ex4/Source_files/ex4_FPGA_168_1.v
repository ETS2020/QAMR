// Benchmark "FAU" written by ABC on Thu Aug  6 11:41:27 2020
...
module FAU ( 
  ...
  assign z08 = ~x040 & ((~new_n209_ & x000) | ~new_n224_ | (~new_n217_ & ~x072));
  ...
  assign new_n217_ = (new_n218_ | ~x064) & (x080 | (~new_n223_ & (new_n220_ | x048)));
  assign new_n218_ = (x032 | (~x016 & (~x024 | x048 | x080))) & (x048 | new_n219_ | x080);
  assign new_n219_ = ~x056 & ~x088;
  assign new_n220_ = (new_n221_ | (~x016 & (~x024 | (x056 & x088)))) & (~new_n222_ | ~x024);
  assign new_n221_ = ~x104 & ~x112;
  assign new_n222_ = (x096 | x120) & (~x008 | ~x016) & (~x056 | ~x088);
  assign new_n223_ = x032 & (~new_n219_ | (x024 & (~x008 | ~x016)));
  assign new_n224_ = (new_n225_ | ~x008) & (~x032 | ~x048) & (x008 | ~x016 | x048 | ~x064);
  assign new_n225_ = ~x072 & (x048 | new_n221_ | x080);
  assign z09 = ~x041 & (new_n227_ | ~new_n228_);
  ...
  assign new_n242_ = ~x013 & (x077 | (~x021 & (new_n184_ | ~x029)));
  assign new_n243_ = ~x077 & ((new_n244_ & x029) | (x069 & (~new_n186_ | (~x021 & x029))));
  assign new_n244_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n245_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n257_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n258_ = ~x078 & ((new_n259_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n259_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n260_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
