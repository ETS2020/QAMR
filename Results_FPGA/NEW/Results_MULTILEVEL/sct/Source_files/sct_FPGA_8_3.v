...
module FAU ( 
  ...
  assign new_n57_ = ~x09 & (new_n55_ | x00) & ((~x02 & ~x16) | (~x03 & (x02 | ~x16)));
  assign new_n58_ = ~x02 & x14 & x16;
  assign z11 = x02 & ~x03;
  assign z12 = ~x02 & x04 & (x03 | x16);
