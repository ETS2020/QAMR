...
module FAU ( 
  ...
  assign z03 = x04 & (~x08 | (x08 & ~x14)) & ~new_n40_ & (x06 ^ x07);
  assign z04 = x04 & ~new_n40_ & (x06 ? (x07 ? ~x08 : (x08 & ~x14)) : (x08 & ~x14));
  assign z05 = new_n44_ | (x09 & (~x08 | (~x14 & (~x06 | ~x07)))) | (x06 & x07 & x08 & ~x09 & ~x14);
  assign new_n44_ = ~new_n38_ & (new_n40_ | ~x04);
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x10 | (x08 & (x14 | (x06 & x07 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | x14);
  assign z07 = new_n44_ | ~new_n48_;
  assign new_n48_ = (~x11 | (x08 & (x14 | (new_n49_ & x06 & x07)))) & (~x06 | ~x07 | ~x08 | ~new_n49_ | x11 | x14);
  assign new_n49_ = ~x09 & ~x10;
  assign z08 = new_n44_ | (new_n52_ & new_n53_) | (x12 & (new_n51_ | ~x08));
  assign new_n51_ = ~x14 & (~x06 | ~x07 | x09 | x10 | x11);
  assign new_n52_ = x06 & x07 & x08 & ~x09;
  assign new_n53_ = ~x10 & ~x11 & ~x12 & ~x14;
  assign z09 = new_n44_ | new_n55_ | (x13 & (~x08 | (~new_n56_ & ~x14)));
  assign new_n55_ = new_n52_ & ~x12 & ~x13 & ~x14 & ~x10 & ~x11;
  assign new_n56_ = ~x10 & ~x11 & ~x12 & x06 & x07 & ~x09;
  assign z10 = x04 & ((new_n58_ & x06) | (~x08 & new_n40_ & x14));
