// Benchmark "FAU" written by ABC on Sat Aug  8 21:55:33 2020
...
module FAU ( 
  ...
  assign z01 = (~x04 & (x15 | (x05 & x13))) | (~x05 & (x15 | (x13 & ~x18)));
  ...
  assign new_n47_ = (~x10 | (x06 & x07 & x08 & ~x09)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  ...
  assign z09 = ((x13 | x15) & (new_n40_ | ~x04)) | new_n54_ | (~new_n52_ & x13);
  assign new_n54_ = new_n45_ & ~x10 & ~x11 & ~x12 & ~x13 & x15;
  ...
  assign new_n59_ = ~x12 & ~x13 & x15 & ((x02 & ~x03) | ~x16);
