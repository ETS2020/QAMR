...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n39_ & (x07 ? (~x17 & (x06 ^ x08)) : x08);
  ...
  assign new_n50_ = new_n51_ & ~x10 & ~x11 & ~x12 & ~x17;
  assign new_n51_ = x08 & ~x09 & x06 & x07;
  assign new_n52_ = ~x17 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n43_ | new_n54_ | (x13 & (~x07 | (~new_n55_ & ~x17)));
  assign new_n54_ = new_n51_ & ~x12 & ~x13 & ~x17 & ~x10 & ~x11;
  assign new_n55_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z10 = x04 & ((~x17 & (new_n57_ | (new_n39_ & x14))) | (~x07 & new_n39_ & x14));
