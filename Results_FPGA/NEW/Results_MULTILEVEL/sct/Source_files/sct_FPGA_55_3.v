...
module FAU ( 
  ...
  assign new_n48_ = (~x11 | new_n50_ | x17) & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x07 & x08;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = ((new_n40_ | ~x04) & (~x11 | (~x12 & ~x17))) | (~new_n52_ & ~x11) | (x11 & x12 & ~x17);
  assign new_n52_ = (~new_n49_ | x09 | x10 | x12) & (new_n50_ | ~x12);
  assign z09 = ((new_n40_ | ~x04) & (~x11 | (~x13 & ~x17))) | (~new_n54_ & ~x11) | (x11 & x13 & ~x17);
