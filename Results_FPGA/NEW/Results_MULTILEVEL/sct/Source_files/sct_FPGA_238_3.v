...
module FAU ( 
  ...
  assign z05 = (~new_n43_ & (~x13 | ~x16)) | (~x13 & ~new_n44_ & x16);
  assign new_n43_ = (~x09 | (x06 & x07 & x08)) & x04 & (~x08 | x09 | ~x06 | ~x07);
  assign new_n44_ = x02 & ~x03;
  assign z06 = (~x13 & ~new_n44_ & x16) | (~new_n46_ & (~x13 | ~x16));
  assign new_n46_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~x13 & ~new_n44_ & x16) | ((new_n50_ | new_n48_ | ~x04) & (~x13 | ~x16));
  assign new_n48_ = new_n49_ & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x06 & x07 & x08;
  assign new_n50_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = (~new_n52_ & (~x13 | ~x16)) | (~x13 & ~new_n44_ & x16);
  assign new_n52_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n49_ | x11 | x12 | x09 | x10);
  assign z09 = (~x04 & (~x13 | ~x16)) | (~x13 & (new_n54_ | (~new_n44_ & x16))) | (x13 & ~new_n54_ & ~x16);
  assign new_n54_ = new_n49_ & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & (new_n58_ | (x06 & new_n56_ & x07));
  assign new_n56_ = x08 & ~x09 & ((~new_n39_ & x00) | (new_n57_ & ~x10));
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = ~x13 & x14 & ~new_n44_ & x16;
