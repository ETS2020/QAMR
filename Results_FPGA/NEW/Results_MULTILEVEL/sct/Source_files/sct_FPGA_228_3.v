...
module FAU ( 
  ...
  assign new_n46_ = (~x10 | x13 | (x06 & x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ((new_n40_ | ~x04) & (~x10 | (~x11 & ~x13))) | (~new_n48_ & ~x10) | (x10 & x11 & ~x13);
  assign new_n48_ = (~x06 | ~x07 | ~x08 | x09 | x11) & (~x11 | (x06 & x07 & x08 & ~x09));
  assign z08 = ((new_n40_ | ~x04) & (~x10 | (~x12 & ~x13))) | (~new_n50_ & ~x10) | (x10 & x12 & ~x13);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x09 & ~x11)) & (~x06 | ~x07 | ~x08 | x09 | x11 | x12);
  assign z09 = new_n52_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n52_ = ~x10 & ((x13 & (~new_n53_ | x09 | x11 | x12)) | (new_n53_ & ~x09 & ~x11 & ~x12 & ~x13));
