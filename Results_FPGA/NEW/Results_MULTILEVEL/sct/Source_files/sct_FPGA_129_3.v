...
module FAU ( 
  ...
  assign z05 = ((~x08 | ~x13) & (new_n40_ | ~x04)) | (x09 & (~x08 | (~new_n44_ & ~x13))) | (new_n44_ & x08 & ~x09 & ~x13);
  assign new_n44_ = x06 & x07;
  assign z06 = ~new_n46_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n46_ = (~x10 | (x08 & (x13 | (x06 & x07 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | x13);
  assign z07 = ~new_n48_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n48_ = (~x11 | (x08 & (x13 | (new_n49_ & x06 & x07)))) & (~x06 | ~x07 | ~x08 | ~new_n49_ | x11 | x13);
  assign new_n49_ = ~x09 & ~x10;
  assign z08 = ~new_n51_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n51_ = (~x12 | (x08 & (x13 | (new_n44_ & new_n52_ & ~x09)))) & (~new_n44_ | ~x08 | x09 | ~new_n52_ | x12 | x13);
  assign new_n52_ = ~x10 & ~x11;
  assign z09 = x13 ? ~x08 : (~new_n54_ | new_n40_);
  ...
  assign new_n58_ = ~x00 & (x10 | x11 | x12);
