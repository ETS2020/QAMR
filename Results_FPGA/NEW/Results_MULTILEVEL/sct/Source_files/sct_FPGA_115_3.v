...
module FAU ( 
  ...
  assign z05 = (~new_n43_ & (~x05 | ~x06)) | (~x05 & ((x09 & (~x07 | ~x08)) | (x06 & x07 & x08 & ~x09))) | (~x06 & x09);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = ~new_n45_ | (~new_n43_ & (~x05 | ~x06));
  assign new_n45_ = (x05 | ((~x10 | (x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (x06 | ~x10);
  assign z07 = (~new_n43_ & (~x05 | ~x06)) | (~x06 & x11) | (~new_n47_ & ~x05);
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & (~new_n48_ | ~x06 | x09 | x10 | x11);
  assign new_n48_ = x07 & x08;
  assign z08 = (~new_n43_ & (~x05 | ~x06)) | (~x06 & x12) | (~new_n50_ & ~x05);
  assign new_n50_ = (~x12 | (new_n48_ & ~x09 & ~x10 & ~x11)) & (~new_n48_ | ~x06 | x11 | x12 | x09 | x10);
  assign z09 = (~new_n43_ & (~x05 | ~x06)) | (~x06 & x13) | (~new_n52_ & ~x05);
  ...
  assign z10 = x04 & ((~x05 & ((new_n56_ & x06) | (new_n39_ & x14))) | (~x06 & new_n39_ & x14));
