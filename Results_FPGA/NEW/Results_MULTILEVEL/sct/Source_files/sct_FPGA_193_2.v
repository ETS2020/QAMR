...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n40_ & (x07 ? (x15 & (x06 ^ x08)) : x08);
  ...
  assign new_n48_ = (~x11 | (x07 & (~x15 | (new_n49_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n49_ | x11 | ~x15);
  assign new_n49_ = ~x09 & ~x10;
  assign z08 = new_n44_ | new_n51_ | (x12 & (new_n53_ | ~x07));
  assign new_n51_ = new_n52_ & ~x12 & x15 & ~x10 & ~x11;
  assign new_n52_ = x08 & ~x09 & x06 & x07;
  assign new_n53_ = x15 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | new_n55_ | (x13 & (~x07 | (~new_n56_ & x15)));
  assign new_n55_ = new_n52_ & ~x12 & ~x13 & x15 & ~x10 & ~x11;
  assign new_n56_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x15 & (new_n58_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
