...
module FAU ( 
  ...
  wire new_n37_, new_n40_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    new_n52_, new_n53_, new_n56_, new_n57_;
  ...
  assign z06 = new_n47_ | (~new_n45_ & x10) | (new_n44_ & ~x09 & ~x10 & x13);
  assign new_n47_ = (x10 | x13) & (~x04 | ((~x02 | x03) & x16));
  assign z07 = new_n47_ | (~new_n49_ & x11) | (new_n44_ & new_n50_ & ~x11 & x13);
  assign new_n49_ = ~x10 & (~x13 | (x06 & x07 & x08 & ~x09));
  assign new_n50_ = ~x09 & ~x10;
  assign z08 = new_n47_ | (x12 & (new_n52_ | x10)) | (new_n45_ & new_n53_);
  assign new_n52_ = x13 & (~x06 | ~x07 | ~x08 | x09 | x11);
  assign new_n53_ = ~x10 & ~x11 & ~x12 & x13;
  assign z09 = new_n47_ | (x13 & (~new_n44_ | ~new_n50_ | x11 | x12));
  assign z10 = x04 & ~new_n37_ & (new_n57_ | (x00 & new_n56_ & x06));
