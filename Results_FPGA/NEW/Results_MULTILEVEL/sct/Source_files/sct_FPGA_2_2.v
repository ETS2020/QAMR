// Benchmark "FAU" written by ABC on Sat Aug  8 21:54:08 2020
...
module FAU ( 
  ...
  assign z06 = (~new_n44_ & (~x09 | (~x10 & x17))) | (~new_n46_ & ~x09) | (x09 & x10 & x17);
  assign new_n46_ = (~x10 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x10);
  assign z07 = (~new_n44_ & (~x09 | (~x11 & x17))) | (~new_n48_ & ~x09) | (x09 & x11 & x17);
  assign new_n48_ = (~x11 | (x06 & x07 & x08 & ~x10)) & (~x06 | ~x07 | ~x08 | x10 | x11);
  assign z08 = (~new_n44_ & (~x09 | (~x12 & x17))) | (~new_n50_ & ~x09) | (x09 & x12 & x17);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x10 & ~x11)) & (~x06 | ~x07 | ~x08 | x10 | x11 | x12);
  assign z09 = (~new_n44_ & (~x09 | (~x13 & x17))) | (~new_n52_ & ~x09) | (x09 & x13 & x17);
  ...
  assign new_n57_ = x16 & x17 & (~x02 | x03);
