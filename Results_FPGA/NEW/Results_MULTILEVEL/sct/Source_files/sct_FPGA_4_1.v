...
module FAU ( 
  ...
  assign new_n42_ = (~x02 | ((~x08 | (x03 & x16) | (x06 & (~x06 | x07))) & (x03 | ~x06 | ~x07 | x08))) & (x08 | x16 | ~x06 | ~x07);
  assign z05 = (~x04 & (x02 | ~x08)) | (~new_n44_ & x02) | (~x08 & (x09 | (~x02 & x16)));
  assign new_n44_ = (~x09 | (x06 & x07)) & ~new_n45_ & ~new_n46_;
  assign new_n45_ = x03 & x16;
  assign new_n46_ = x06 & x07 & x08 & ~x09;
  assign z06 = (~x04 & (x02 | ~x08)) | (~new_n48_ & x02) | (~x08 & (x10 | (~x02 & x16)));
  assign new_n48_ = (~x10 | (x06 & x07 & ~x09)) & ~new_n45_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x02 | ~x08)) | (~new_n50_ & x02) | (~x08 & (x11 | (~x02 & x16)));
  assign new_n50_ = (~x11 | (new_n51_ & x06 & x07)) & ~new_n45_ & ~new_n52_;
  assign new_n51_ = ~x09 & ~x10;
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x02 | ~x08)) | (~new_n54_ & x02) | (~x08 & (x12 | (~x02 & x16)));
  ...
  assign z09 = (~x04 & (x02 | ~x08)) | (~new_n58_ & x02) | (~x08 & (x13 | (~x02 & x16)));
  ...
  assign z10 = x04 & ((x02 & (new_n62_ | (new_n64_ & x03))) | (new_n64_ & ~x02 & ~x08));
