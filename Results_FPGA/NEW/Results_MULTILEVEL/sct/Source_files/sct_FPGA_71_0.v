// Benchmark "FAU" written by ABC on Sat Aug  8 21:54:38 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n40_, new_n44_, new_n46_, new_n48_, new_n52_;
  ...
  assign z05 = (~new_n44_ & (x09 | x11)) | (x09 & (~x06 | ~x07 | ~x08)) | (x06 & x07 & x08 & ~x09 & x11);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = (~new_n44_ & (x09 | x11)) | (x10 & (x09 | (~new_n46_ & x11))) | (new_n46_ & ~x09 & ~x10 & x11);
  assign new_n46_ = x06 & x07 & x08;
  assign z07 = (~new_n44_ & (x09 | x11)) | (x11 & (~new_n48_ | ~x08 | x09 | x10));
  assign new_n48_ = x06 & x07;
  assign z08 = ~new_n37_ & (new_n40_ | ~x04 | x12);
  assign z09 = ~new_n37_ & (new_n40_ | ~x04 | x13);
  assign z10 = x04 & ((x11 & (new_n52_ | (new_n40_ & x14))) | (x09 & new_n40_ & x14));
  assign new_n52_ = x00 & x06 & x07 & x08 & ~new_n40_ & ~x09;
