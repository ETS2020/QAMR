...
module FAU ( 
  ...
  assign new_n48_ = ~x09 & ((x11 & (~x06 | ~x07 | ~x08 | x10)) | (x06 & x07 & x08 & ~x10 & ~x11));
  assign z08 = ~new_n50_ | (~new_n44_ & (~x09 | (~x11 & ~x12)));
  assign new_n50_ = (x11 | ((~x09 | ~x12) & (~new_n51_ | x09 | x10 | x12))) & (x09 | new_n52_ | ~x12);
  assign new_n51_ = x06 & x07 & x08;
  assign new_n52_ = x06 & x07 & x08 & ~x10 & ~x11;
  assign z09 = ~new_n54_ | (~new_n44_ & (~x09 | (~x11 & ~x13)));
  assign new_n54_ = (x11 | ((~x09 | ~x13) & (~new_n51_ | x09 | x10 | x12 | x13))) & (x09 | ~x13 | (new_n51_ & ~x10 & ~x11 & ~x12));
  assign z10 = x04 & ((~x09 & (new_n56_ | (new_n40_ & x14))) | (~x11 & new_n40_ & x14));
  assign new_n56_ = x06 & x07 & x08 & ~new_n40_ & ~new_n57_;
