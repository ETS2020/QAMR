...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n39_ & (x06 ? (x07 ? (~x08 & ~x12) : x08) : x08);
  assign z05 = (~new_n43_ & (x08 | (~x09 & ~x12))) | (x08 & ((x09 & (~x06 | ~x07)) | (x06 & x07 & ~x09))) | (~x08 & x09 & ~x12);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = (~new_n43_ & (x08 | (~x10 & ~x12))) | (~new_n45_ & x08) | (~x08 & x10 & ~x12);
  assign new_n45_ = (~x10 | (x06 & x07 & ~x09)) & (~x06 | ~x07 | x09 | x10);
  assign z07 = (~new_n43_ & (x08 | (~x11 & ~x12))) | (~new_n47_ & x08) | (~x08 & x11 & ~x12);
  assign new_n47_ = (~x11 | (x06 & x07 & ~x09 & ~x10)) & (~x06 | ~x07 | x09 | x10 | x11);
  assign z08 = (~new_n49_ & x08) | (~new_n43_ & (x08 | ~x12));
  assign new_n49_ = (~x12 | (x06 & x07 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x07 | x09 | x10 | x11 | x12);
  assign z09 = (~new_n43_ & (x08 | (~x12 & ~x13))) | (~new_n51_ & ~x12) | (x08 & ~new_n53_ & x13);
  assign new_n51_ = (x08 | ~x13) & (~x06 | ~x07 | ~x08 | ~new_n52_ | x11 | x13);
  assign new_n52_ = ~x09 & ~x10;
  assign new_n53_ = x06 & x07 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x08 & (new_n55_ | (new_n39_ & x14))) | (~x12 & new_n39_ & x14));
