...
module FAU ( 
  ...
  assign z08 = ~new_n51_ | (~new_n38_ & (new_n40_ | ~x04));
  assign new_n51_ = (new_n49_ | ~x12) & (~new_n46_ | x10 | x11 | x12 | ~x14);
  assign z09 = ~new_n53_ | (~new_n38_ & (new_n40_ | ~x04));
  assign new_n53_ = (~x13 | (~x12 & (new_n49_ | ~x14))) & (~new_n46_ | ~new_n54_);
  assign new_n54_ = ~x10 & ~x11 & ~x12 & ~x13 & x14;
  assign z10 = x04 & (new_n56_ | (new_n40_ & x14));
  assign new_n56_ = x06 & x07 & x08 & (new_n54_ | new_n57_) & ~x09;
