// Benchmark "FAU" written by ABC on Sat Aug  8 21:55:21 2020
...
module FAU ( 
  ...
  assign z09 = ((x13 | ~x17) & (new_n40_ | ~x04)) | new_n54_ | (~new_n52_ & x13);
  assign new_n54_ = new_n45_ & ~x10 & ~x11 & ~x12 & ~x13 & ~x17;
  ...
  assign new_n59_ = ~x12 & ~x13 & ~x17 & (~x16 | (x02 & ~x03));
  assign z11 = ~new_n37_ & x02;
  assign z12 = x04 & ~new_n37_ & (x03 | (~x02 & x16));
  assign z13 = x04 & (~x17 | (x13 & x17));
