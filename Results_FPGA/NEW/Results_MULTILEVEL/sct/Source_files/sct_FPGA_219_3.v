...
module FAU ( 
  ...
  assign z06 = (~new_n44_ & (~x09 | (~x01 & ~x10))) | (~new_n46_ & ~x09) | (~x01 & x09 & x10);
  assign new_n46_ = (~x10 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x10);
  assign z07 = (~new_n44_ & (~x09 | (~x01 & ~x11))) | (~new_n48_ & ~x09) | (~x01 & x09 & x11);
  assign new_n48_ = (~x11 | (x06 & x07 & x08 & ~x10)) & (~x06 | ~x07 | ~x08 | x10 | x11);
  assign z08 = (~new_n44_ & (~x09 | (~x01 & ~x12))) | (~new_n50_ & ~x09) | (~x01 & x09 & x12);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x10 & ~x11)) & (~x06 | ~x07 | ~x08 | x10 | x11 | x12);
  assign z09 = (~new_n44_ & (~x09 | (~x01 & ~x13))) | (~new_n52_ & ~x09) | (~x01 & x09 & x13);
