...
module FAU ( 
  ...
  assign z08 = ~new_n49_ | (~new_n43_ & (x08 | x12));
  assign new_n49_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & (~new_n50_ | x11 | x12 | x09 | x10);
  assign new_n50_ = x06 & x07 & x08;
  assign z09 = (~new_n43_ & (x08 | x12)) | (~new_n52_ & x08) | (x12 & x13);
  assign new_n52_ = (~x13 | (x06 & x07 & new_n53_ & ~x09)) & (~x06 | ~x07 | x09 | ~new_n53_ | x12 | x13);
