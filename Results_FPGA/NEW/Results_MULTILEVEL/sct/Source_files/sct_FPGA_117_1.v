...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & (~x06 | ~x07 | ~x08)) | (x06 & x07 & x08 & ~x09 & ~x18);
  assign new_n44_ = ~new_n37_ & (new_n40_ | ~x04);
  assign z06 = new_n44_ | (x10 & (x09 | (~new_n46_ & ~x18))) | (new_n46_ & ~x09 & ~x10 & ~x18);
  assign new_n46_ = x06 & x07 & x08;
  assign z07 = new_n44_ | ~new_n48_;
  assign new_n48_ = (~x11 | (~x09 & (new_n49_ | x18))) & (~new_n46_ | x11 | x18 | x09 | x10);
  assign new_n49_ = x06 & x07 & x08 & ~x10;
  assign z08 = new_n44_ | (new_n52_ & new_n53_) | (x12 & (new_n51_ | x09));
  assign new_n51_ = ~x18 & (~x06 | ~x07 | ~x08 | x10 | x11);
  assign new_n52_ = x06 & x07 & x08 & ~x09;
  assign new_n53_ = ~x10 & ~x11 & ~x12 & ~x18;
  assign z09 = new_n44_ | new_n56_ | (x13 & (x09 | (~new_n55_ & ~x18)));
  assign new_n55_ = new_n46_ & ~x10 & ~x11 & ~x12;
  assign new_n56_ = new_n52_ & ~x10 & ~x11 & ~x12 & ~x13 & ~x18;
  assign z10 = x04 & ((~x18 & (new_n58_ | (new_n40_ & x14))) | (x09 & new_n40_ & x14));
