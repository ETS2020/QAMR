...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n39_ & (x06 ? (x07 ? (~x08 & ~x14) : x08) : x08);
  assign z05 = (~new_n43_ & (x08 | (~x09 & ~x14))) | (x08 & ((x09 & (~x06 | ~x07)) | (x06 & x07 & ~x09))) | (~x08 & x09 & ~x14);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = (~new_n43_ & (x08 | (~x10 & ~x14))) | (~new_n45_ & x08) | (~x08 & x10 & ~x14);
