...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & (~x06 | ~x07 | ~x08)) | (x06 & x07 & x08 & ~x09 & ~x17);
  assign new_n44_ = ~new_n37_ & (new_n40_ | ~x04);
  assign z06 = new_n44_ | (x10 & (x09 | (~new_n46_ & ~x17))) | (new_n46_ & ~x09 & ~x10 & ~x17);
  assign new_n46_ = x06 & x07 & x08;
  assign z07 = new_n44_ | ~new_n48_;
  assign new_n48_ = (~x11 | (~x09 & (new_n49_ | x17))) & (~new_n46_ | x11 | x17 | x09 | x10);
  ...
  assign z09 = new_n44_ | new_n56_ | (x13 & (x09 | (~new_n55_ & ~x17)));
  assign new_n55_ = new_n46_ & ~x10 & ~x11 & ~x12;
  assign new_n56_ = new_n52_ & ~x10 & ~x11 & ~x12 & ~x13 & ~x17;
  assign z10 = x04 & ((~x17 & (new_n58_ | (new_n40_ & x14))) | (x09 & new_n40_ & x14));
