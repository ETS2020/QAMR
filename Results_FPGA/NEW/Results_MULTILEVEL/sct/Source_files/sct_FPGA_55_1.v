...
module FAU ( 
  ...
  assign z06 = ~new_n37_ & (new_n40_ | new_n47_ | ~x04 | (~new_n45_ & x10));
  assign new_n47_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = ~new_n49_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n49_ = (new_n47_ | ~x11) & (~new_n44_ | x09 | x10 | x11 | x17);
  assign z08 = ~new_n51_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n51_ = (~new_n45_ | x10 | x11 | x12 | x17) & (~x12 | (~x11 & (new_n47_ | x17)));
  assign z09 = (~new_n37_ & (new_n40_ | ~x04)) | new_n54_ | (~new_n53_ & x13);
  assign new_n53_ = ~x11 & (x17 | (new_n44_ & ~x09 & ~x10 & ~x12));
