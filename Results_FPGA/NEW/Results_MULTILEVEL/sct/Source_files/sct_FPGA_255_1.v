// Benchmark "FAU" written by ABC on Sat Aug  8 21:55:43 2020
...
module FAU ( 
  ...
  assign z01 = (x01 | ~x08) & (x05 ? ~x04 : (x15 | ~x18));
  assign z02 = x04 & ~x06 & ~new_n39_ & (x01 | ~x08);
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = x04 & (x06 ^ x07) & ~new_n39_ & (~x08 | (x01 & x08));
  assign z04 = x04 & ~new_n39_ & ((x01 & x08 & (~x06 | (x06 & ~x07))) | (x06 & x07 & ~x08));
  assign z05 = (~new_n43_ & (x01 | ~x08)) | (~x08 & x09) | (x01 & ((x06 & x07) ? (x08 & ~x09) : x09));
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = ~new_n45_ | (~new_n43_ & (x01 | ~x08));
  assign new_n45_ = (~x01 | ((~x10 | (x06 & x07 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (x08 | ~x10);
  assign z07 = (~new_n43_ & (x01 | ~x08)) | (~new_n47_ & x01) | (~x08 & x11);
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & (~new_n49_ | x09 | x10 | x11);
  assign new_n48_ = x06 & x07;
  assign new_n49_ = x06 & x07 & x08;
  assign z08 = (~new_n43_ & (x01 | ~x08)) | (~new_n51_ & x01) | (~x08 & x12);
  assign new_n51_ = (~x12 | (new_n48_ & ~x09 & ~x10 & ~x11)) & (~new_n49_ | x09 | x10 | x11 | x12);
  assign z09 = (~new_n43_ & (x01 | ~x08)) | (~new_n53_ & x01) | (~x08 & x13);
  ...
  assign z10 = x04 & ((x01 & (new_n59_ | (new_n57_ & x06))) | (new_n59_ & ~x08));
