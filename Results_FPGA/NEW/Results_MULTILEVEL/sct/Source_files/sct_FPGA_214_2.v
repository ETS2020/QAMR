...
module FAU ( 
  ...
  assign new_n47_ = (~x10 | ~x13 | (x06 & x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ((new_n40_ | ~x04) & (~x10 | (~x11 & x13))) | (~new_n49_ & ~x10) | (x10 & x11 & x13);
  assign new_n49_ = (~x06 | ~x07 | ~x08 | x09 | x11) & (~x11 | (x06 & x07 & x08 & ~x09));
  assign z08 = ((new_n40_ | ~x04) & (~x10 | (~x12 & x13))) | (~new_n51_ & ~x10) | (x10 & x12 & x13);
  assign new_n51_ = (~x12 | (x06 & x07 & x08 & ~x09 & ~x11)) & (~x06 | ~x07 | ~x08 | x09 | x11 | x12);
  assign z09 = ((~x10 | x13) & (new_n40_ | ~x04)) | new_n54_ | (~new_n53_ & x13);
  assign new_n53_ = new_n44_ & ~x11 & ~x12 & ~x09 & ~x10;
