...
module FAU ( 
  ...
  assign z05 = ((new_n39_ | ~x04) & (x07 | x09)) | (x09 & (~x06 | ~x07 | ~x08)) | (x06 & x07 & x08 & ~x09);
  assign z06 = ((x07 | x09) & (new_n39_ | ~x04)) | (x09 & x10) | (x07 & (new_n44_ ? (~x09 & ~x10) : x10));
  assign new_n44_ = x06 & x08;
  assign z07 = ~new_n46_ | ((x07 | x09) & (new_n39_ | ~x04));
  assign new_n46_ = (~x07 | ((~x11 | (x06 & x08 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11))) & (~x09 | ~x11);
  assign z08 = ((x07 | x09) & (new_n39_ | ~x04)) | (x09 & x12) | (~new_n48_ & x07);
  assign new_n48_ = (~x12 | (new_n44_ & ~x10 & ~x11)) & (~new_n49_ | x10 | x11 | x12);
  assign new_n49_ = x06 & x08 & ~x09;
  assign z09 = ((x07 | x09) & (new_n39_ | ~x04)) | (x09 & x13) | (~new_n51_ & x07);
  assign new_n51_ = (~x13 | (new_n44_ & ~x10 & ~x11 & ~x12)) & (~new_n49_ | x10 | x11 | x12 | x13);
  assign z10 = x04 & ((x07 & (new_n53_ | (new_n39_ & x14))) | (x09 & new_n39_ & x14));
