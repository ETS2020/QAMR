// Benchmark "FAU" written by ABC on Thu Aug  6 21:10:28 2020
...
module FAU ( 
  ...
  assign z04 = z05 & x15;
  assign z05 = x29 & (x40 | ~x58);
  assign z06 = x14 & new_n174_ & ~x15;
  assign new_n174_ = ~x28 & x29 & ~x37 & ~x43 & (x40 | ~x58);
  assign z07 = new_n176_ & ~x15;
  assign new_n176_ = ~x28 & x29 & ~x37 & x43 & (x40 | ~x58);
  ...
  assign z10 = ~x15 & x28 & x29 & ~x37 & (x40 | ~x58);
  assign z11 = ~x15 & x29 & x37 & (x40 | ~x58);
  ...
  assign new_n315_ = x40 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
