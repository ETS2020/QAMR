// Benchmark "FAU" written by ABC on Thu Aug  6 21:12:16 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n453_, new_n454_, new_n455_, new_n456_, new_n459_;
  ...
  assign z04 = z05 & x15;
  assign z05 = x29 & (x48 | ~x58);
  assign z06 = x14 & new_n174_ & ~x15;
  assign new_n174_ = ~x28 & x29 & ~x37 & ~x43 & (x48 | ~x58);
  assign z07 = new_n176_ & ~x15;
  assign new_n176_ = ~x28 & x29 & ~x37 & x43 & (x48 | ~x58);
  ...
  assign z10 = ~x15 & x28 & x29 & ~x37 & (x48 | ~x58);
  assign z11 = ~x15 & x29 & x37 & (x48 | ~x58);
  ...
  assign z24 = ~x58 & ~x50 & ~x46 & new_n266_ & ~x43 & ~x60;
  assign new_n266_ = ~x40 & ~x39 & ~x37 & x29 & new_n267_ & ~x28;
  assign new_n267_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n269_ & ~x46;
  ...
  assign z28 = ~x60 & ~x58 & new_n292_ & ~x50;
  assign new_n292_ = ~x43 & ~x40 & ~x39 & new_n293_ & ~x37 & ~x46;
  assign new_n293_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n295_ & ~x46;
  assign new_n295_ = ~x43 & ~x40 & new_n206_ & ~x39;
  ...
  assign new_n303_ = ~x25 & ~x24 & ~x22 & new_n254_ & ~x21 & ~x26;
  ...
  assign new_n311_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n254_ & x21;
  assign z32 = ~x58 & ~x50 & new_n295_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n206_ & x39;
  assign z34 = x58 & new_n315_ & x48;
  assign new_n315_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n317_ & ~x60;
  assign new_n317_ = ~x56 & ~x55 & ~x51 & new_n318_ & ~x50 & ~x58;
  ...
  assign new_n321_ = ~x15 & ~x14 & ~x11 & new_n322_ & ~x10 & ~x18;
  assign new_n322_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n324_ & ~x62;
  assign new_n324_ = ~x60 & ~x58 & ~x56 & new_n325_ & ~x55 & x61;
  assign new_n325_ = ~x50 & ~x47 & ~x46 & new_n326_ & ~x43 & ~x51;
  assign new_n326_ = ~x40 & ~x39 & ~x37 & new_n236_ & ~x35 & ~x41;
  assign z37 = ~x64 & new_n328_ & ~x63;
  assign new_n328_ = ~x61 & ~x60 & ~x59 & new_n329_ & ~x58 & ~x62;
  assign new_n329_ = ~x56 & ~x55 & ~x54 & new_n330_ & ~x53 & ~x57;
  assign new_n330_ = ~x51 & ~x50 & ~x49 & new_n331_ & ~x48 & ~x52;
  assign new_n331_ = ~x46 & ~x45 & ~x43 & new_n332_ & ~x42 & ~x47;
  assign new_n332_ = ~x40 & ~x39 & ~x37 & new_n333_ & ~x36 & ~x41;
  assign new_n333_ = ~x34 & ~x33 & ~x32 & new_n334_ & ~x31 & ~x35;
  assign new_n334_ = ~x30 & x29 & ~x28 & ~x26 & new_n335_ & ~x25;
  assign new_n335_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n280_ & x19;
  assign z38 = ~x62 & ~x61 & new_n337_ & ~x60;
  assign new_n337_ = ~x58 & ~x56 & ~x55 & new_n338_ & ~x51 & x59;
  assign new_n338_ = ~x47 & ~x46 & ~x43 & new_n339_ & ~x42 & ~x50;
  assign new_n339_ = ~x41 & ~x40 & new_n340_ & ~x39;
  assign new_n340_ = ~x37 & ~x35 & ~x30 & x29 & new_n341_ & ~x28;
  assign new_n341_ = ~x25 & ~x24 & ~x22 & new_n342_ & ~x18 & ~x26;
  assign new_n342_ = ~x15 & ~x14 & ~x11 & new_n343_ & ~x10;
  assign new_n343_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n345_ & ~x61;
  assign new_n345_ = ~x58 & ~x56 & ~x55 & new_n346_ & ~x51 & ~x60;
  assign new_n346_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n339_ & x42;
  assign z40 = ~x62 & ~x61 & new_n348_ & ~x60;
  assign new_n348_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n349_ & x54;
  assign new_n349_ = ~x51 & ~x50 & new_n350_ & ~x47;
  assign new_n350_ = ~x43 & ~x42 & ~x41 & new_n351_ & ~x40 & ~x46;
  assign new_n351_ = ~x37 & ~x35 & ~x34 & new_n352_ & ~x33 & ~x39;
  assign new_n352_ = ~x30 & x29 & ~x28 & new_n353_ & ~x26;
  assign new_n353_ = ~x24 & ~x22 & ~x18 & new_n354_ & ~x17 & ~x25;
  assign new_n354_ = ~x14 & ~x11 & ~x10 & new_n343_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n356_ & ~x58 & ~x62;
  assign new_n356_ = ~x55 & ~x51 & ~x50 & new_n357_ & ~x47 & ~x56;
  assign new_n357_ = ~x43 & ~x42 & ~x41 & new_n358_ & ~x40 & ~x46;
  assign new_n358_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n352_ & x33;
  assign z42 = ~x62 & new_n360_ & ~x61;
  assign new_n360_ = ~x59 & ~x58 & ~x56 & new_n361_ & ~x55 & ~x60;
  assign new_n361_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n227_ & x49;
  assign z43 = new_n363_ & ~x62;
  assign new_n363_ = ~x60 & ~x59 & ~x58 & new_n364_ & ~x56 & ~x61;
  assign new_n364_ = ~x54 & ~x53 & ~x51 & new_n365_ & ~x50 & ~x55;
  assign new_n365_ = ~x46 & ~x45 & ~x43 & new_n366_ & ~x42 & ~x47;
  assign new_n366_ = ~x40 & ~x39 & ~x37 & new_n367_ & ~x35 & ~x41;
  assign new_n367_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n368_ & x29;
  assign new_n368_ = ~x26 & ~x25 & ~x24 & new_n369_ & ~x22 & ~x28;
  assign new_n369_ = ~x17 & ~x15 & ~x14 & new_n370_ & ~x11 & ~x18;
  assign new_n370_ = ~x09 & ~x08 & ~x07 & new_n371_ & ~x06 & ~x10;
  assign new_n371_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n373_ & ~x58 & ~x62;
  assign new_n373_ = ~x55 & ~x54 & ~x53 & new_n374_ & ~x51 & ~x56;
  assign new_n374_ = ~x47 & ~x46 & ~x45 & new_n375_ & ~x43 & ~x50;
  ...
  assign new_n378_ = ~x18 & ~x17 & ~x15 & new_n379_ & ~x14 & ~x22;
  assign new_n379_ = ~x10 & ~x09 & ~x08 & new_n380_ & ~x07 & ~x11;
  assign new_n380_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n382_ & ~x59;
  assign new_n382_ = ~x56 & ~x55 & ~x51 & new_n383_ & ~x50 & ~x58;
  assign new_n383_ = ~x46 & ~x43 & ~x42 & new_n384_ & ~x41 & ~x47;
  assign new_n384_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n352_ & x34;
  assign z46 = ~x62 & new_n386_ & ~x61;
  ...
  assign new_n391_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n343_ & x09;
  ...
  assign new_n397_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n342_ & x17;
  ...
  assign new_n402_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n352_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n404_ & ~x59;
  assign new_n404_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n349_ & x53;
  assign z50 = new_n406_ & ~x62;
  assign new_n406_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n225_ & x57;
  assign z51 = ~x62 & ~x61 & new_n408_ & ~x60;
  assign new_n408_ = ~x58 & ~x56 & ~x55 & new_n409_ & ~x54 & ~x59;
  assign new_n409_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n227_ & x48;
  ...
  assign new_n418_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n232_ & x12;
  ...
  assign new_n423_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n236_ & x35;
  ...
  assign new_n432_ = ~x17 & ~x16 & ~x15 & new_n255_ & ~x14 & ~x18;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n434_ & ~x50 & ~x62;
  assign new_n434_ = ~x46 & ~x43 & ~x41 & new_n435_ & ~x40 & ~x47;
  ...
  assign z58 = ~x62 & ~x60 & ~x58 & new_n440_ & ~x56;
  assign new_n440_ = ~x47 & ~x46 & ~x43 & new_n441_ & ~x41 & ~x50;
  assign new_n441_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n442_ & x29;
  assign new_n442_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n437_ & x22;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n206_ & x40;
  assign z60 = ~x58 & ~x56 & ~x50 & new_n445_ & ~x47 & ~x60;
  assign new_n445_ = ~x43 & ~x40 & ~x39 & new_n446_ & ~x37 & ~x46;
  assign new_n446_ = ~x30 & x29 & ~x28 & ~x25 & new_n447_ & ~x24;
  assign new_n447_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n449_ & ~x50;
  assign new_n449_ = ~x46 & ~x43 & ~x40 & new_n450_ & ~x39 & ~x47;
  assign new_n450_ = ~x37 & ~x30 & x29 & ~x28 & new_n451_ & ~x25;
  assign new_n451_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n453_ & x47;
  assign new_n453_ = new_n454_ & ~x46;
  assign new_n454_ = ~x40 & ~x39 & ~x37 & new_n455_ & ~x30 & ~x43;
  assign new_n455_ = x29 & new_n456_ & ~x28;
  assign new_n456_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n453_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n459_ & ~x46;
  assign new_n459_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n455_ & x30;
endmodule
