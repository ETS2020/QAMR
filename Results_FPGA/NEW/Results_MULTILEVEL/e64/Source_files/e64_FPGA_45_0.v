// Benchmark "FAU" written by ABC on Thu Aug  6 21:10:41 2020
...
module FAU ( 
  ...
  wire new_n135_, new_n140_, new_n141_, new_n142_, new_n143_, new_n144_,
    ...
    new_n250_, new_n251_, new_n254_;
  assign z04 = z05 & x15;
  assign z05 = x29 & (x43 | x59);
  assign z06 = new_n135_ & x59;
  assign new_n135_ = ~x43 & ~x37 & x29 & ~x28 & x14 & ~x15;
  assign z07 = x43 & ~x37 & x29 & ~x15 & ~x28;
  assign z10 = ~x15 & x28 & x29 & ~x37 & (x43 | x59);
  assign z11 = ~x15 & x29 & x37 & (x43 | x59);
  assign z12 = new_n140_ & ~x62;
  assign new_n140_ = ~x60 & x59 & ~x58 & ~x56 & new_n141_ & ~x50;
  ...
  assign new_n146_ = x59 & ~x58 & ~x56 & ~x50 & new_n147_ & ~x47;
  ...
  assign new_n165_ = x59 & ~x58 & ~x56 & ~x50 & new_n166_ & ~x47;
  ...
  assign z20 = ~x62 & ~x60 & x59 & new_n170_ & ~x58;
  ...
  assign z21 = ~x62 & ~x60 & x59 & new_n177_ & ~x58;
  ...
  assign z36 = ~x62 & x61 & new_n207_ & ~x60;
  assign new_n207_ = x59 & ~x58 & ~x56 & ~x55 & new_n208_ & ~x51;
  assign new_n208_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n209_ & ~x41;
  assign new_n209_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n173_ & ~x30;
  assign z38 = ~x62 & ~x61 & ~x60 & x59 & new_n211_ & ~x58;
  assign new_n211_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n212_ & ~x47;
  assign new_n212_ = ~x46 & ~x43 & ~x42 & ~x41 & new_n213_ & ~x40;
  assign new_n213_ = ~x39 & ~x37 & ~x35 & new_n214_ & x29 & ~x30;
  ...
  assign z39 = ~x62 & ~x61 & ~x60 & x59 & new_n218_ & ~x58;
  assign new_n218_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n219_ & ~x47;
  assign new_n219_ = ~x46 & ~x43 & x42 & ~x41 & new_n213_ & ~x40;
  assign z54 = ~x62 & new_n221_ & ~x60;
  assign new_n221_ = x59 & ~x58 & ~x56 & x55 & new_n208_ & ~x51;
  assign z55 = ~x62 & ~x60 & x59 & ~x58 & new_n223_ & ~x56;
  assign new_n223_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n224_ & ~x43;
  assign new_n224_ = ~x41 & ~x40 & ~x39 & new_n172_ & x35 & ~x37;
  assign z57 = new_n226_ & ~x62;
  assign new_n226_ = ~x60 & x59 & ~x58 & ~x56 & new_n227_ & ~x50;
  assign new_n227_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n228_ & ~x40;
  assign new_n228_ = ~x39 & ~x37 & ~x30 & x29 & new_n229_ & ~x28;
  assign new_n229_ = ~x26 & ~x25 & ~x24 & new_n230_ & x18 & ~x22;
  assign new_n230_ = ~x15 & new_n231_ & ~x14;
  assign new_n231_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & x59 & ~x58 & new_n233_ & ~x56;
  assign new_n233_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n234_ & ~x41;
  assign new_n234_ = ~x40 & ~x39 & ~x37 & new_n235_ & x29 & ~x30;
  assign new_n235_ = ~x28 & ~x26 & ~x25 & new_n230_ & x22 & ~x24;
  assign z59 = x59 & ~x58 & ~x50 & new_n152_ & x40 & ~x43;
  assign z60 = new_n238_ & ~x60;
  assign new_n238_ = x59 & ~x58 & ~x56 & ~x50 & new_n239_ & ~x47;
  ...
  assign z61 = ~x60 & x59 & ~x58 & ~x56 & new_n243_ & ~x50;
  assign new_n243_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n244_ & ~x39;
  assign new_n244_ = ~x37 & ~x30 & x29 & ~x28 & new_n245_ & ~x25;
  assign new_n245_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = new_n247_ & ~x60;
  assign new_n247_ = x59 & ~x58 & ~x56 & new_n248_ & x47 & ~x50;
  assign new_n248_ = new_n249_ & ~x46;
  assign new_n249_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n250_ & ~x30;
  assign new_n250_ = x29 & new_n251_ & ~x28;
  assign new_n251_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & x59 & ~x58 & x56 & new_n248_ & ~x50;
  assign z64 = ~x60 & x59 & ~x58 & ~x50 & new_n254_ & ~x46;
  assign new_n254_ = ~x43 & ~x40 & ~x39 & new_n250_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
