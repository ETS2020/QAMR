// Benchmark "FAU" written by ABC on Thu Aug  6 21:11:09 2020
...
module FAU ( 
  ...
  assign z10 = ~x15 & x28 & x29 & ~x37 & (~x03 | x43);
  ...
  assign z14 = ~x58 & x50 & new_n205_ & ~x43;
  assign new_n205_ = ~x37 & x29 & ~x28 & ~x15 & new_n206_ & ~x14;
  assign new_n206_ = ~x03 & ~x10;
  assign z15 = ~x58 & ~x43 & new_n208_ & ~x37;
  assign new_n208_ = x29 & ~x28 & ~x15 & ~x14 & ~x03 & x10;
  assign z16 = ~x60 & ~x58 & ~x56 & new_n210_ & ~x50 & ~x62;
  assign new_n210_ = ~x46 & ~x43 & ~x40 & new_n211_ & ~x39 & ~x47;
  assign new_n211_ = ~x37 & ~x30 & x29 & ~x28 & new_n202_ & x26;
  assign z18 = x62 & ~x60 & ~x58 & new_n213_ & ~x56;
  assign new_n213_ = ~x47 & ~x46 & ~x43 & new_n214_ & ~x40 & ~x50;
  assign new_n214_ = ~x39 & ~x37 & ~x30 & x29 & new_n202_ & ~x28;
  assign z19 = new_n216_ & x64;
  assign new_n216_ = new_n217_ & ~x62;
  assign new_n217_ = ~x60 & ~x59 & ~x58 & new_n218_ & ~x57 & ~x61;
  assign new_n218_ = ~x56 & ~x55 & new_n219_ & ~x54;
  assign new_n219_ = ~x51 & ~x50 & ~x49 & new_n220_ & ~x48 & ~x53;
  assign new_n220_ = ~x47 & ~x46 & ~x45 & new_n221_ & ~x43;
  assign new_n221_ = ~x41 & ~x40 & ~x39 & new_n222_ & ~x37 & ~x42;
  assign new_n222_ = ~x34 & ~x33 & ~x31 & new_n223_ & ~x30 & ~x35;
  assign new_n223_ = ~x28 & ~x26 & ~x25 & new_n224_ & ~x24 & x29;
  assign new_n224_ = ~x18 & ~x17 & ~x15 & new_n225_ & ~x14 & ~x22;
  assign new_n225_ = new_n161_ & ~x11;
  assign z20 = ~x62 & ~x60 & new_n227_ & ~x58;
  assign new_n227_ = ~x56 & x51 & ~x50 & ~x47 & new_n228_ & ~x46;
  assign new_n228_ = ~x41 & ~x40 & ~x39 & new_n229_ & ~x37 & ~x43;
  assign new_n229_ = ~x30 & x29 & new_n230_ & ~x28;
  assign new_n230_ = ~x25 & ~x24 & ~x22 & new_n231_ & ~x18 & ~x26;
  assign new_n231_ = ~x15 & ~x14 & ~x11 & new_n232_ & ~x10;
  assign new_n232_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  assign z21 = ~x62 & ~x60 & new_n234_ & ~x58;
  assign new_n234_ = ~x50 & ~x47 & ~x46 & new_n235_ & ~x43 & ~x56;
  assign new_n235_ = ~x40 & ~x39 & ~x37 & new_n236_ & ~x30 & ~x41;
  assign new_n236_ = ~x28 & ~x26 & ~x25 & new_n237_ & ~x24 & x29;
  assign new_n237_ = ~x18 & ~x15 & ~x14 & new_n238_ & ~x11 & ~x22;
  assign new_n238_ = ~x08 & ~x07 & ~x06 & x00 & ~x03 & ~x10;
  assign z22 = ~x64 & new_n240_ & ~x63;
  assign new_n240_ = ~x61 & ~x60 & ~x59 & new_n241_ & ~x58 & ~x62;
  assign new_n241_ = ~x56 & ~x55 & ~x54 & new_n242_ & ~x53 & ~x57;
  assign new_n242_ = ~x50 & ~x49 & ~x48 & new_n243_ & ~x47 & ~x51;
  assign new_n243_ = ~x45 & ~x43 & ~x42 & new_n244_ & ~x41 & ~x46;
  ...
  assign new_n247_ = ~x18 & ~x17 & ~x15 & new_n248_ & ~x14;
  assign new_n248_ = new_n225_ & ~x12;
  assign z23 = ~x64 & ~x63 & ~x62 & new_n250_ & ~x61;
  assign new_n250_ = ~x59 & ~x58 & ~x57 & new_n251_ & ~x56 & ~x60;
  assign new_n251_ = ~x54 & ~x53 & ~x52 & new_n252_ & ~x51 & ~x55;
  assign new_n252_ = ~x49 & ~x48 & ~x47 & new_n253_ & ~x46 & ~x50;
  assign new_n253_ = ~x43 & ~x42 & ~x41 & new_n254_ & ~x40 & ~x45;
  assign new_n254_ = ~x37 & ~x36 & ~x35 & new_n255_ & ~x34 & ~x39;
  assign new_n255_ = ~x33 & ~x31 & ~x30 & x29 & new_n256_ & ~x28;
  assign new_n256_ = ~x25 & ~x24 & ~x22 & new_n257_ & ~x21 & ~x26;
  assign new_n257_ = ~x18 & ~x17 & x16 & ~x15 & new_n248_ & ~x14;
  assign z24 = ~x58 & ~x50 & ~x46 & new_n259_ & ~x43 & ~x60;
  assign new_n259_ = ~x40 & ~x39 & ~x37 & x29 & new_n260_ & ~x28;
  assign new_n260_ = ~x25 & ~x24 & ~x15 & ~x14 & new_n206_ & x11;
  assign z25 = ~x58 & ~x50 & ~x46 & new_n262_ & ~x43 & ~x60;
  assign new_n262_ = ~x40 & ~x39 & ~x37 & x29 & new_n263_ & ~x28;
  assign new_n263_ = ~x25 & x24 & ~x15 & new_n206_ & ~x14;
  ...
  assign new_n283_ = ~x15 & ~x14 & x13 & new_n225_ & ~x12;
  assign z28 = ~x60 & ~x58 & ~x50 & new_n285_ & ~x46;
  assign new_n285_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n286_ & x29;
  assign new_n286_ = ~x28 & x25 & ~x15 & new_n206_ & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n288_ & ~x46;
  assign new_n288_ = ~x43 & ~x40 & new_n205_ & ~x39;
  ...
  assign new_n296_ = ~x25 & ~x24 & ~x22 & new_n247_ & ~x21 & ~x26;
  ...
  assign new_n308_ = ~x37 & x29 & ~x28 & ~x15 & ~x03 & ~x14;
  assign z35 = ~x62 & ~x61 & new_n310_ & ~x60;
  assign new_n310_ = ~x56 & ~x55 & ~x51 & new_n311_ & ~x50 & ~x58;
  assign new_n311_ = ~x46 & ~x43 & ~x41 & new_n312_ & ~x40 & ~x47;
  assign new_n312_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n313_ & x29;
  assign new_n313_ = ~x26 & ~x25 & ~x24 & new_n314_ & ~x22 & ~x28;
  assign new_n314_ = ~x15 & ~x14 & ~x11 & new_n315_ & ~x10 & ~x18;
  assign new_n315_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n317_ & ~x62;
  assign new_n317_ = ~x60 & ~x58 & ~x56 & new_n318_ & ~x55 & x61;
  assign new_n318_ = ~x50 & ~x47 & ~x46 & new_n319_ & ~x43 & ~x51;
  assign new_n319_ = ~x40 & ~x39 & ~x37 & new_n229_ & ~x35 & ~x41;
  assign z37 = ~x64 & new_n321_ & ~x63;
  assign new_n321_ = ~x61 & ~x60 & ~x59 & new_n322_ & ~x58 & ~x62;
  assign new_n322_ = ~x56 & ~x55 & ~x54 & new_n323_ & ~x53 & ~x57;
  assign new_n323_ = ~x51 & ~x50 & ~x49 & new_n324_ & ~x48 & ~x52;
  assign new_n324_ = ~x46 & ~x45 & ~x43 & new_n325_ & ~x42 & ~x47;
  assign new_n325_ = ~x40 & ~x39 & ~x37 & new_n326_ & ~x36 & ~x41;
  assign new_n326_ = ~x34 & ~x33 & ~x32 & new_n327_ & ~x31 & ~x35;
  ...
  assign new_n330_ = ~x58 & ~x56 & ~x55 & new_n331_ & ~x51 & x59;
  assign new_n331_ = ~x47 & ~x46 & ~x43 & new_n332_ & ~x42 & ~x50;
  assign new_n332_ = ~x41 & ~x40 & new_n333_ & ~x39;
  assign new_n333_ = ~x37 & ~x35 & ~x30 & x29 & new_n334_ & ~x28;
  assign new_n334_ = ~x25 & ~x24 & ~x22 & new_n335_ & ~x18 & ~x26;
  ...
  assign new_n344_ = ~x37 & ~x35 & ~x34 & new_n345_ & ~x33 & ~x39;
  assign new_n345_ = ~x30 & x29 & ~x28 & new_n346_ & ~x26;
  assign new_n346_ = ~x24 & ~x22 & ~x18 & new_n347_ & ~x17 & ~x25;
  assign new_n347_ = ~x14 & ~x11 & ~x10 & new_n336_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n349_ & ~x58 & ~x62;
  ...
  assign new_n354_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n220_ & x49;
  assign z43 = new_n356_ & ~x62;
  assign new_n356_ = ~x60 & ~x59 & ~x58 & new_n357_ & ~x56 & ~x61;
  assign new_n357_ = ~x54 & ~x53 & ~x51 & new_n358_ & ~x50 & ~x55;
  assign new_n358_ = ~x46 & ~x45 & ~x43 & new_n359_ & ~x42 & ~x47;
  assign new_n359_ = ~x40 & ~x39 & ~x37 & new_n360_ & ~x35 & ~x41;
  assign new_n360_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n361_ & x29;
  assign new_n361_ = ~x26 & ~x25 & ~x24 & new_n362_ & ~x22 & ~x28;
  assign new_n362_ = ~x17 & ~x15 & ~x14 & new_n363_ & ~x11 & ~x18;
  assign new_n363_ = ~x09 & ~x08 & ~x07 & new_n364_ & ~x06 & ~x10;
  assign new_n364_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n366_ & ~x58 & ~x62;
  assign new_n366_ = ~x55 & ~x54 & ~x53 & new_n367_ & ~x51 & ~x56;
  assign new_n367_ = ~x47 & ~x46 & ~x45 & new_n368_ & ~x43 & ~x50;
  assign new_n368_ = ~x41 & ~x40 & ~x39 & new_n369_ & ~x37 & ~x42;
  assign new_n369_ = ~x34 & ~x33 & ~x31 & new_n370_ & ~x30 & ~x35;
  assign new_n370_ = ~x28 & ~x26 & ~x25 & new_n371_ & ~x24 & x29;
  assign new_n371_ = ~x18 & ~x17 & ~x15 & new_n372_ & ~x14 & ~x22;
  assign new_n372_ = ~x10 & ~x09 & ~x08 & new_n373_ & ~x07 & ~x11;
  assign new_n373_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n375_ & ~x59;
  assign new_n375_ = ~x56 & ~x55 & ~x51 & new_n376_ & ~x50 & ~x58;
  assign new_n376_ = ~x46 & ~x43 & ~x42 & new_n377_ & ~x41 & ~x47;
  assign new_n377_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n345_ & x34;
  assign z46 = ~x62 & new_n379_ & ~x61;
  ...
  assign new_n384_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n336_ & x09;
  ...
  assign new_n390_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n335_ & x17;
  assign z48 = ~x62 & ~x61 & new_n392_ & ~x60;
  assign new_n392_ = ~x58 & ~x56 & ~x55 & new_n393_ & ~x54 & ~x59;
  assign new_n393_ = ~x51 & ~x50 & ~x47 & new_n394_ & ~x46 & ~x53;
  assign new_n394_ = ~x42 & ~x41 & ~x40 & new_n395_ & ~x39 & ~x43;
  assign new_n395_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n345_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n397_ & ~x59;
  assign new_n397_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n342_ & x53;
  assign z50 = new_n399_ & ~x62;
  assign new_n399_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n218_ & x57;
  assign z51 = ~x62 & ~x61 & new_n401_ & ~x60;
  assign new_n401_ = ~x58 & ~x56 & ~x55 & new_n402_ & ~x54 & ~x59;
  assign new_n402_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n220_ & x48;
  assign z52 = new_n404_ & ~x64;
  assign new_n404_ = ~x62 & ~x61 & ~x60 & new_n405_ & ~x59 & ~x63;
  assign new_n405_ = ~x57 & ~x56 & ~x55 & new_n406_ & ~x54 & ~x58;
  assign new_n406_ = ~x51 & ~x50 & ~x49 & new_n407_ & ~x48 & ~x53;
  assign new_n407_ = ~x46 & ~x45 & ~x43 & new_n408_ & ~x42 & ~x47;
  ...
  assign new_n411_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n225_ & x12;
  assign z53 = ~x64 & new_n216_ & x63;
  ...
  assign new_n416_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n229_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n418_ & ~x60 & ~x64;
  assign new_n418_ = ~x58 & ~x57 & ~x56 & new_n419_ & ~x55 & ~x59;
  assign new_n419_ = ~x53 & ~x52 & ~x51 & new_n420_ & ~x50 & ~x54;
  assign new_n420_ = ~x48 & ~x47 & ~x46 & new_n421_ & ~x45 & ~x49;
  assign new_n421_ = ~x42 & ~x41 & ~x40 & new_n422_ & ~x39 & ~x43;
  assign new_n422_ = ~x36 & ~x35 & ~x34 & new_n423_ & ~x33 & ~x37;
  assign new_n423_ = ~x31 & ~x30 & x29 & ~x28 & new_n424_ & ~x26;
  assign new_n424_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n425_ & x20;
  assign new_n425_ = ~x17 & ~x16 & ~x15 & new_n248_ & ~x14 & ~x18;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n427_ & ~x50 & ~x62;
  assign new_n427_ = ~x46 & ~x43 & ~x41 & new_n428_ & ~x40 & ~x47;
  assign new_n428_ = ~x39 & ~x37 & ~x30 & x29 & new_n429_ & ~x28;
  assign new_n429_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n430_ & x18;
  assign new_n430_ = ~x15 & new_n431_ & ~x14;
  assign new_n431_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n433_ & ~x56;
  assign new_n433_ = ~x47 & ~x46 & ~x43 & new_n434_ & ~x41 & ~x50;
  assign new_n434_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n435_ & x29;
  assign new_n435_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n430_ & x22;
  assign z59 = ~x58 & ~x50 & ~x43 & new_n205_ & x40;
  assign z60 = new_n438_ & ~x60;
  assign new_n438_ = ~x56 & ~x50 & ~x47 & new_n439_ & ~x46 & ~x58;
  assign new_n439_ = ~x40 & ~x39 & ~x37 & new_n440_ & ~x30 & ~x43;
  assign new_n440_ = ~x28 & ~x25 & ~x24 & new_n441_ & ~x15 & x29;
  assign new_n441_ = ~x14 & ~x11 & ~x10 & ~x08 & ~x03 & x07;
  assign z61 = ~x58 & ~x56 & ~x50 & new_n443_ & ~x47 & ~x60;
  assign new_n443_ = ~x43 & ~x40 & ~x39 & new_n444_ & ~x37 & ~x46;
  assign new_n444_ = ~x30 & x29 & ~x28 & ~x25 & new_n445_ & ~x24;
  assign new_n445_ = ~x15 & ~x14 & ~x11 & ~x10 & ~x03 & x08;
  ...
  assign new_n450_ = ~x24 & ~x15 & ~x14 & new_n206_ & ~x11;
