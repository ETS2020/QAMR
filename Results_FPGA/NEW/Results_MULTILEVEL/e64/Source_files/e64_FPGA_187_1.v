// Benchmark "FAU" written by ABC on Thu Aug  6 21:12:20 2020
...
module FAU ( 
  ...
  assign new_n323_ = ~x40 & ~x39 & ~x37 & new_n235_ & ~x35 & ~x41;
  ...
  assign new_n332_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n279_ & x19;
  ...
  assign new_n358_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n226_ & x49;
  ...
  assign new_n403_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n224_ & x57;
  assign z51 = ~x62 & ~x61 & new_n405_ & ~x60;
  assign new_n405_ = ~x58 & ~x56 & ~x55 & new_n406_ & ~x54 & ~x59;
  assign new_n406_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n226_ & x48;
  ...
  assign new_n420_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n235_ & x35;
  ...
  assign new_n429_ = ~x17 & ~x16 & ~x15 & new_n254_ & ~x14 & ~x18;
