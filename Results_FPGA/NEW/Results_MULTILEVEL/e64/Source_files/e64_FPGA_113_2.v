// Benchmark "FAU" written by ABC on Thu Aug  6 21:11:30 2020
...
module FAU ( 
  ...
  assign z04 = z05 & x15;
  assign z05 = x29 & (~x24 | x28);
  assign z06 = new_n174_ & ~x43;
  assign new_n174_ = ~x37 & x29 & ~x28 & ~x24 & x14 & ~x15;
  ...
  assign z11 = ~x15 & x29 & x37 & (~x24 | x28);
  ...
  assign new_n206_ = x29 & ~x28 & ~x24 & ~x15 & ~x10 & ~x14;
  assign z15 = ~x58 & ~x43 & new_n208_ & ~x37;
  assign new_n208_ = ~x28 & ~x24 & ~x15 & x10 & ~x14 & x29;
  ...
  assign new_n287_ = ~x15 & ~x14 & x13 & new_n232_ & ~x12;
  ...
  assign new_n300_ = ~x25 & ~x24 & ~x22 & new_n254_ & ~x21 & ~x26;
  ...
  assign new_n312_ = ~x37 & x29 & ~x28 & ~x24 & ~x14 & ~x15;
  ...
  assign new_n323_ = ~x40 & ~x39 & ~x37 & new_n236_ & ~x35 & ~x41;
  ...
  assign new_n358_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n227_ & x49;
  ...
  assign new_n403_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n225_ & x57;
  assign z51 = ~x62 & ~x61 & new_n405_ & ~x60;
  assign new_n405_ = ~x58 & ~x56 & ~x55 & new_n406_ & ~x54 & ~x59;
  assign new_n406_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n227_ & x48;
  ...
  assign new_n415_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n232_ & x12;
  ...
  assign new_n420_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n236_ & x35;
  ...
  assign new_n429_ = ~x17 & ~x16 & ~x15 & new_n255_ & ~x14 & ~x18;
