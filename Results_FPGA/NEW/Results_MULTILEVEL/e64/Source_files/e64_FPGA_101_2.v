// Benchmark "FAU" written by ABC on Thu Aug  6 21:11:20 2020
...
module FAU ( 
  ...
  assign z04 = z05 & x15;
  assign z05 = x29 & (~x36 | x43);
  assign z06 = new_n174_ & ~x43;
  assign new_n174_ = ~x37 & ~x36 & x29 & ~x28 & x14 & ~x15;
  ...
  assign new_n202_ = ~x36 & ~x30 & x29 & ~x28 & new_n203_ & ~x26;
  ...
  assign new_n221_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n222_ & ~x36;
  ...
  assign new_n230_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n231_ & ~x36;
  ...
  assign new_n237_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n238_ & ~x36;
  ...
  assign new_n244_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n245_ & ~x30;
  ...
  assign new_n256_ = ~x18 & ~x17 & x16 & ~x15 & new_n257_ & ~x14;
  assign new_n257_ = new_n234_ & ~x12;
  assign z24 = new_n259_ & ~x60;
  assign new_n259_ = ~x58 & ~x50 & ~x46 & ~x43 & new_n260_ & ~x40;
  assign new_n260_ = ~x39 & ~x37 & ~x36 & x29 & new_n261_ & ~x28;
  assign new_n261_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & ~x46 & new_n263_ & ~x43;
  assign new_n263_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n264_ & x29;
  assign new_n264_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n266_ & ~x64;
  assign new_n266_ = ~x63 & ~x62 & ~x61 & ~x60 & new_n267_ & ~x59;
  assign new_n267_ = ~x58 & ~x57 & ~x56 & ~x55 & new_n268_ & ~x54;
  assign new_n268_ = ~x53 & ~x52 & ~x51 & ~x50 & new_n269_ & ~x49;
  ...
  assign new_n273_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n274_ & ~x20;
  assign new_n274_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n276_ & ~x62;
  assign new_n276_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n277_ & ~x57;
  assign new_n277_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n278_ & ~x52;
  ...
  assign new_n284_ = ~x15 & ~x14 & x13 & new_n234_ & ~x12;
  assign z28 = ~x60 & ~x58 & ~x50 & new_n286_ & ~x46;
  assign new_n286_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n287_ & ~x36;
  assign new_n287_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n289_ & ~x46;
  assign new_n289_ = ~x43 & ~x40 & new_n206_ & ~x39;
  ...
  assign new_n298_ = ~x18 & ~x17 & ~x15 & new_n257_ & ~x14;
  assign z31 = ~x64 & ~x63 & new_n300_ & ~x62;
  assign new_n300_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n301_ & ~x57;
  assign new_n301_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n302_ & ~x51;
  ...
  assign new_n306_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n298_ & x21;
  assign z32 = ~x58 & ~x50 & new_n289_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n206_ & x39;
  assign z34 = x58 & new_n310_ & ~x43;
  assign new_n310_ = ~x37 & ~x36 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & ~x60 & new_n312_ & ~x58;
  assign new_n312_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n313_ & ~x47;
  assign new_n313_ = ~x46 & ~x43 & ~x41 & ~x40 & new_n314_ & ~x39;
  assign new_n314_ = ~x37 & ~x36 & ~x35 & ~x30 & new_n315_ & x29;
  ...
  assign new_n322_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n238_ & ~x35;
  assign z37 = ~x64 & new_n324_ & ~x63;
  assign new_n324_ = ~x62 & ~x61 & ~x60 & ~x59 & new_n325_ & ~x58;
  assign new_n325_ = ~x57 & ~x56 & ~x55 & ~x54 & new_n326_ & ~x53;
  assign new_n326_ = ~x52 & ~x51 & ~x50 & ~x49 & new_n327_ & ~x48;
  assign new_n327_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n328_ & ~x42;
  assign new_n328_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n329_ & ~x36;
  assign new_n329_ = ~x35 & ~x34 & ~x33 & ~x32 & new_n330_ & ~x31;
  assign new_n330_ = ~x30 & x29 & ~x28 & ~x26 & new_n331_ & ~x25;
  assign new_n331_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n274_ & x19;
  ...
  assign new_n336_ = ~x36 & ~x35 & ~x30 & x29 & new_n337_ & ~x28;
  ...
  assign new_n345_ = ~x51 & ~x50 & ~x47 & new_n346_ & ~x46;
  ...
  assign new_n349_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n350_ & ~x17;
  assign new_n350_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n339_ & ~x09;
  assign z41 = new_n352_ & ~x62;
  ...
  assign new_n355_ = ~x37 & ~x36 & ~x35 & ~x34 & new_n348_ & x33;
  assign z42 = ~x62 & new_n357_ & ~x61;
  assign new_n357_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n358_ & ~x55;
  assign new_n358_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n229_ & x49;
  assign z43 = ~x62 & new_n360_ & ~x61;
  assign new_n360_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n361_ & ~x55;
  assign new_n361_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n362_ & ~x47;
  assign new_n362_ = ~x46 & ~x45 & ~x43 & ~x42 & new_n363_ & ~x41;
  assign new_n363_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n364_ & ~x35;
  assign new_n364_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n365_ & x29;
  assign new_n365_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n366_ & ~x22;
  assign new_n366_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n367_ & ~x11;
  assign new_n367_ = ~x10 & ~x09 & ~x08 & ~x07 & new_n368_ & ~x06;
  assign new_n368_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = new_n370_ & ~x62;
  ...
  assign z45 = ~x62 & ~x61 & ~x60 & ~x59 & new_n380_ & ~x58;
  assign new_n380_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n381_ & ~x47;
  assign new_n381_ = ~x46 & ~x43 & ~x42 & ~x41 & new_n382_ & ~x40;
  assign new_n382_ = ~x39 & ~x37 & ~x36 & ~x35 & new_n348_ & x34;
  assign z46 = ~x62 & ~x61 & new_n384_ & ~x60;
  assign new_n384_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n385_ & ~x51;
  assign new_n385_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n386_ & ~x42;
  assign new_n386_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n387_ & ~x36;
  assign new_n387_ = ~x35 & ~x30 & x29 & ~x28 & new_n388_ & ~x26;
  assign new_n388_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n389_ & ~x17;
  assign new_n389_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n339_ & x09;
  ...
  assign new_n393_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n394_ & ~x36;
  assign new_n394_ = ~x35 & ~x30 & x29 & ~x28 & new_n395_ & ~x26;
  assign new_n395_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n338_ & x17;
  assign z48 = ~x62 & ~x61 & ~x60 & new_n397_ & ~x59;
  ...
  assign new_n400_ = ~x36 & ~x35 & ~x34 & ~x33 & new_n348_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n402_ & ~x59;
  assign new_n402_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n345_ & x53;
  assign z50 = new_n404_ & ~x62;
  assign new_n404_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n227_ & x57;
  assign z51 = ~x62 & ~x61 & new_n406_ & ~x60;
  assign new_n406_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n407_ & ~x54;
  assign new_n407_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n229_ & x48;
  assign z52 = ~x64 & new_n409_ & ~x63;
  assign new_n409_ = ~x62 & ~x61 & ~x60 & ~x59 & new_n410_ & ~x58;
  assign new_n410_ = ~x57 & ~x56 & ~x55 & ~x54 & new_n411_ & ~x53;
  assign new_n411_ = ~x51 & ~x50 & ~x49 & ~x48 & new_n412_ & ~x47;
  assign new_n412_ = ~x46 & ~x45 & ~x43 & ~x42 & new_n413_ & ~x41;
  assign new_n413_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n414_ & ~x35;
  assign new_n414_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n415_ & x29;
  assign new_n415_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n416_ & ~x22;
  assign new_n416_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n234_ & x12;
  assign z53 = ~x64 & new_n225_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n320_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & ~x56 & new_n420_ & ~x51;
  assign new_n420_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n421_ & ~x41;
  assign new_n421_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n238_ & x35;
  assign z56 = ~x64 & ~x63 & ~x62 & ~x61 & new_n423_ & ~x60;
  assign new_n423_ = ~x59 & ~x58 & ~x57 & ~x56 & new_n424_ & ~x55;
  assign new_n424_ = ~x54 & ~x53 & ~x52 & ~x51 & new_n425_ & ~x50;
  assign new_n425_ = ~x49 & ~x48 & ~x47 & ~x46 & new_n426_ & ~x45;
  assign new_n426_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n427_ & ~x39;
  assign new_n427_ = ~x37 & ~x36 & ~x35 & ~x34 & new_n428_ & ~x33;
  assign new_n428_ = ~x31 & ~x30 & x29 & ~x28 & new_n429_ & ~x26;
  assign new_n429_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n430_ & x20;
  assign new_n430_ = ~x18 & ~x17 & ~x16 & ~x15 & new_n257_ & ~x14;
  assign z57 = new_n432_ & ~x62;
  assign new_n432_ = ~x60 & ~x58 & ~x56 & ~x50 & new_n433_ & ~x47;
  assign new_n433_ = ~x46 & ~x43 & ~x41 & ~x40 & new_n434_ & ~x39;
  assign new_n434_ = ~x37 & ~x36 & ~x30 & x29 & new_n435_ & ~x28;
  assign new_n435_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n436_ & x18;
  assign new_n436_ = ~x15 & new_n437_ & ~x14;
  assign new_n437_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & ~x56 & new_n439_ & ~x50;
  assign new_n439_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n440_ & ~x40;
  assign new_n440_ = ~x39 & ~x37 & ~x36 & ~x30 & new_n441_ & x29;
