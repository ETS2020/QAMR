...
module FAU ( 
  ...
  assign z08 = new_n79_ | (x16 & ((~new_n77_ & x27) | (new_n63_ & new_n80_)));
  assign new_n77_ = new_n60_ & new_n78_ & ~x22 & ~x23;
  assign new_n78_ = ~x24 & ~x25 & ~x26;
  assign new_n79_ = ~new_n54_ & (x18 | (~x07 & ~x16));
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x30;
  assign z09 = new_n82_ | (x16 & ((new_n84_ & new_n66_) | (~new_n83_ & x28)));
  assign new_n82_ = ~new_n54_ & (x18 | (~x06 & ~x16));
  assign new_n83_ = ~x27 & (x30 | (new_n60_ & new_n78_ & ~x22 & ~x23));
  assign new_n84_ = new_n78_ & ~x27 & ~x28 & ~x30;
  assign z10 = (x16 & (new_n86_ | new_n88_)) | (~new_n54_ & (x18 | (~x05 & ~x16)));
  assign new_n86_ = x29 & (x27 | (~x30 & (~new_n63_ | ~new_n87_)));
  assign new_n87_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28;
  assign new_n88_ = new_n66_ & new_n78_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z11 = (~x04 & (x30 ? x27 : ~x16)) | (x16 & (new_n88_ | (x27 & x30))) | (x18 & (x27 | ~x30));
  assign z12 = (~new_n94_ & (x27 | ~x30)) | (x16 & ((x27 & x31) | (~new_n91_ & ~x30)));
  assign new_n91_ = (~x31 | (new_n63_ & new_n92_)) & (~new_n66_ | ~new_n78_ | ~new_n93_);
  assign new_n92_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n93_ = ~x27 & ~x28 & ~x29 & ~x31;
  assign new_n94_ = ~x18 & (x03 | x16);
  assign z13 = new_n96_ | (x16 & (new_n100_ | (~x30 & (new_n97_ | new_n98_))));
  assign new_n96_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n97_ = x32 & (~new_n66_ | ~new_n78_ | x28 | x29 | x31);
  assign new_n98_ = new_n59_ & new_n69_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign new_n100_ = x27 & x32;
  assign z14 = new_n102_ | (x16 & (new_n107_ | (~x30 & (new_n103_ | new_n104_))));
  assign new_n102_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n103_ = x33 & (~new_n66_ | ~new_n78_ | ~new_n99_);
  assign new_n104_ = new_n59_ & new_n69_ & new_n105_ & new_n106_;
  assign new_n105_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n106_ = ~x29 & ~x31 & ~x32 & ~x33;
  assign new_n107_ = x27 & x33;
  assign z15 = new_n109_ | (x16 & (new_n115_ | (~x30 & (new_n110_ | new_n112_))));
  assign new_n109_ = ~new_n54_ & (x18 | (~x00 & ~x16));
  assign new_n110_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n111_ | ~new_n106_);
  assign new_n111_ = ~x25 & ~x26 & ~x28;
