// Benchmark "FAU" written by ABC on Thu Aug  6 17:25:02 2020
...
module FAU ( 
  ...
  assign z09 = x18 | (~x15 & (x16 ? ~new_n79_ : ~x06));
  ...
  assign z13 = x18 | (~x15 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  ...
  assign z14 = x18 | (~x15 & (x16 ? (new_n99_ | new_n100_) : ~x01));
  ...
  assign z15 = x18 | (~x15 & (x16 ? ~new_n104_ : ~x00));
