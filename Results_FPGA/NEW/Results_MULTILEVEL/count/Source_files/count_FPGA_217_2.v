...
module FAU ( 
  ...
  assign z08 = x18 ? x31 : (x16 ? (new_n75_ | new_n77_) : ~x07);
  ...
  assign z09 = x18 ? x31 : (x16 ? (new_n80_ | new_n81_) : ~x06);
  ...
  assign z10 = x18 ? x31 : (x16 ? (new_n84_ | new_n85_) : ~x05);
  assign new_n84_ = x29 & (~new_n62_ | ~new_n82_);
  assign new_n85_ = new_n65_ & new_n76_ & new_n86_ & ~x27;
  assign new_n86_ = ~x28 & ~x29;
  assign z11 = x18 ? x31 : (x16 ? ~new_n88_ : ~x04);
  assign new_n88_ = (~x30 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n76_ | x27 | x28 | x29 | x30);
  assign z12 = new_n93_ | (~x18 & ((~x03 & ~x16) | (new_n90_ & new_n92_)));
  assign new_n90_ = new_n91_ & x16 & ~x17 & ~x19;
  assign new_n91_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n92_ = new_n78_ & ~x24 & ~x25 & new_n86_ & ~x30 & ~x31;
  assign new_n93_ = x31 & (x18 | (x16 & (~new_n65_ | ~new_n76_ | ~new_n94_)));
  assign new_n94_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = new_n100_ | (~x18 & (x16 ? (new_n96_ | new_n97_) : ~x02));
  assign new_n96_ = x32 & (~new_n65_ | ~new_n76_ | ~new_n94_);
  assign new_n97_ = new_n58_ & new_n68_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n100_ = x31 & (x18 | (x16 & x32));
  assign z14 = new_n107_ | (~x18 & (x16 ? (new_n102_ | new_n104_) : ~x01));
  assign new_n102_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n103_ | ~new_n78_ | x25);
  assign new_n103_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n104_ = new_n59_ & new_n71_ & new_n105_ & new_n106_;
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n107_ = x31 & (x18 | (x16 & x33));
  assign z15 = new_n113_ | (~x18 & (x16 ? (new_n109_ | new_n111_) : ~x00));
  assign new_n109_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n98_ | ~new_n110_);
  assign new_n110_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n111_ = new_n59_ & new_n71_ & new_n105_ & new_n112_;
  assign new_n112_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n113_ = x31 & (x18 | (x16 & x34));
endmodule
