// Benchmark "FAU" written by ABC on Thu Aug  6 17:24:48 2020
...
module FAU ( 
  ...
  assign z08 = x18 | (x32 & (x16 ? ~new_n76_ : ~x07));
  ...
  assign z13 = x18 | (x32 & (x16 ? ~new_n90_ : ~x02));
  assign z14 = x18 | (x32 & (x16 ? x33 : ~x01));
  assign z15 = x18 | (x32 & (x16 ? x34 : ~x00));
endmodule
