...
module FAU ( 
  ...
  assign z08 = x18 | (~x29 & (x16 ? (new_n75_ | new_n77_) : ~x07));
  ...
  assign z14 = x18 | (~x29 & (x16 ? (new_n95_ | new_n96_) : ~x01));
  ...
  assign z15 = x18 | (~x29 & (x16 ? (new_n100_ | new_n101_) : ~x00));
