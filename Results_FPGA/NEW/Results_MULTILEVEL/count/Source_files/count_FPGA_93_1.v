...
module FAU ( 
  ...
  assign z06 = x18 | (~x22 & (x16 ? ~new_n69_ : ~x09));
  ...
  assign z14 = x18 | (~x22 & (x16 ? (new_n96_ | new_n97_) : ~x01));
  ...
  assign z15 = x18 | (~x22 & (x16 ? (new_n101_ | new_n102_) : ~x00));
