...
module FAU ( 
  ...
  assign z08 = new_n77_ | (x16 & ((~new_n75_ & x27) | (new_n63_ & new_n78_)));
  assign new_n75_ = new_n60_ & new_n76_ & ~x22 & ~x23;
  assign new_n76_ = ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~new_n54_ & (x18 | (~x07 & ~x16));
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & x30;
  assign z09 = new_n80_ | (x16 & ((new_n82_ & new_n66_) | (~new_n81_ & x28)));
  assign new_n80_ = ~new_n54_ & (x18 | (~x06 & ~x16));
  assign new_n81_ = ~x27 & (~x30 | (new_n60_ & new_n76_ & ~x22 & ~x23));
  assign new_n82_ = new_n76_ & ~x27 & ~x28 & x30;
  assign z10 = (x16 & (new_n84_ | new_n86_)) | (~new_n54_ & (x18 | (~x05 & ~x16)));
  assign new_n84_ = x29 & (x27 | (x30 & (~new_n63_ | ~new_n85_)));
  assign new_n85_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28;
  assign new_n86_ = new_n66_ & new_n76_ & ~x27 & ~x28 & ~x29 & x30;
  assign z11 = ((x27 | x30) & (x18 | (~x04 & ~x16))) | (x16 & ~new_n88_ & x30);
  assign new_n88_ = new_n66_ & new_n76_ & ~x27 & ~x28 & ~x29;
