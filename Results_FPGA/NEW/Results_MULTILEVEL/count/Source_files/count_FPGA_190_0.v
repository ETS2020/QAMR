...
module FAU ( 
  ...
  assign z07 = ~new_n54_ & ((~new_n74_ & x16) | x18 | (~x08 & ~x16));
  assign new_n74_ = (~x26 | (new_n60_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n60_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = ~new_n54_ & ((x16 & (new_n76_ | new_n78_)) | x18 | (~x07 & ~x16));
  assign new_n76_ = x27 & (~new_n60_ | ~new_n77_ | x22 | x23);
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign new_n78_ = new_n63_ & new_n79_ & ~x23 & ~x24;
  assign new_n79_ = ~x25 & ~x26 & ~x27;
  assign z09 = ~new_n54_ & (~new_n83_ | (x16 & (new_n81_ | (~new_n78_ & x28))));
  assign new_n81_ = new_n63_ & new_n82_ & ~x26 & ~x27 & ~x28;
  assign new_n82_ = ~x23 & ~x24 & ~x25;
  assign new_n83_ = ~x18 & (x06 | x16);
  assign z10 = ~new_n54_ & (~new_n86_ | (x16 & (new_n85_ | (~new_n81_ & x29))));
  assign new_n85_ = new_n66_ & new_n77_ & ~x27 & ~x28 & ~x29;
  assign new_n86_ = ~x18 & (x05 | x16);
  assign z11 = ~new_n54_ & ((~new_n88_ & x16) | x18 | (~x04 & ~x16));
  assign new_n88_ = (~x30 | (new_n66_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n66_ | ~new_n77_ | x29 | x30 | x27 | x28);
  assign z12 = new_n93_ | (x16 & ((~new_n91_ & x31) | (new_n90_ & new_n94_)));
  assign new_n90_ = new_n59_ & new_n69_;
  assign new_n91_ = new_n66_ & new_n77_ & new_n92_;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n93_ = ~new_n54_ & (x18 | (~x03 & ~x16));
  assign new_n94_ = new_n95_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & x34;
  assign z13 = new_n97_ | (x16 & (new_n98_ | (new_n72_ & new_n99_)));
  assign new_n97_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n98_ = x32 & (x31 | (x34 & (~new_n66_ | ~new_n77_ | ~new_n92_)));
  assign new_n99_ = new_n100_ & ~x30 & ~x31 & ~x32 & x34;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z14 = new_n102_ | (x16 & ((new_n72_ & new_n105_) | (~new_n103_ & x33)));
  assign new_n102_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n103_ = ~x31 & (~x34 | (new_n59_ & new_n69_ & new_n79_ & new_n104_));
  assign new_n104_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n105_ = new_n100_ & ~x30 & ~x31 & ~x32 & ~x33 & x34;
  assign z15 = (~new_n108_ & (x31 | x34)) | (x16 & x34 & (~new_n72_ | ~new_n107_));
  assign new_n107_ = new_n100_ & ~x30 & ~x31 & ~x32 & ~x33;
