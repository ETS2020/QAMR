...
module FAU ( 
  ...
  assign z11 = x18 ? ~x33 : (x16 ? ~new_n86_ : ~x04);
  assign new_n86_ = (~x30 | (new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n75_ | x27 | x28 | x29 | x30);
  assign z12 = x18 ? ~x33 : (x16 ? (new_n88_ | new_n90_) : ~x03);
  assign new_n88_ = x31 & (~new_n65_ | ~new_n75_ | ~new_n89_ | x27 | x28);
  ...
  assign z13 = x18 ? ~x33 : (x16 ? (new_n94_ | new_n95_) : ~x02);
  assign new_n94_ = x32 & (~new_n91_ | ~new_n92_ | ~new_n58_ | ~new_n68_);
  assign new_n95_ = new_n58_ & new_n68_ & new_n96_ & new_n89_ & ~x31 & ~x32;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z14 = (~x33 & (new_n98_ | x18)) | (~x18 & (x16 ? (~new_n95_ & x33) : ~x01));
  assign new_n98_ = new_n96_ & new_n89_ & ~x31 & ~x32 & new_n68_ & new_n99_;
  assign new_n99_ = ~x19 & ~x20 & x16 & ~x17;
  assign z15 = (~x33 & (new_n101_ | x18)) | (~x18 & (x16 ? new_n103_ : ~x00));
  assign new_n101_ = new_n68_ & new_n99_ & new_n96_ & new_n102_;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32 & ~x34;
  assign new_n103_ = x34 & (~new_n104_ | ~new_n105_ | ~new_n59_ | ~new_n71_);
