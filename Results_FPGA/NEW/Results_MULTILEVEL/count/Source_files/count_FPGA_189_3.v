...
module FAU ( 
  ...
  assign new_n85_ = ~x13 & ((x18 & ~x28) | (x16 & x27 & x28));
  ...
  assign new_n91_ = ~x13 & ((x18 & ~x29) | (x16 & x27 & x29));
  ...
  assign new_n95_ = ~x13 & ((x18 & ~x30) | (x16 & x27 & x30));
  ...
  assign new_n104_ = ~x13 & ((x18 & ~x32) | (x16 & x27 & x32));
  ...
  assign new_n110_ = ~x13 & ((x18 & ~x33) | (x16 & x27 & x33));
  ...
  assign new_n116_ = ~x13 & ((x18 & ~x34) | (x16 & x27 & x34));
endmodule
