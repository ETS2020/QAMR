...
module FAU ( 
  ...
  assign new_n88_ = x31 & (~new_n65_ | ~new_n75_ | ~new_n89_ | x29 | x30);
  ...
  assign z14 = x18 | (~x33 & ((~x01 & ~x16) | (new_n99_ & new_n100_)));
  assign new_n99_ = new_n96_ & new_n97_;
  assign new_n100_ = new_n68_ & ~x19 & ~x20 & x16 & ~x17;
  assign z15 = x18 | (~x33 & (x16 ? (new_n102_ | new_n103_) : ~x00));
  assign new_n102_ = x34 & (~new_n96_ | ~new_n97_ | ~new_n58_ | ~new_n68_);
  assign new_n103_ = new_n59_ & new_n71_ & new_n74_ & new_n104_ & new_n105_;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x34;
endmodule
