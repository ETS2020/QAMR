...
module FAU ( 
  ...
  assign new_n83_ = new_n78_ & ~x27 & ~x28 & ~x31;
  assign z10 = new_n85_ | (x16 & (new_n87_ | (~new_n86_ & x29)));
  assign new_n85_ = ~new_n54_ & (x18 | (~x05 & ~x16));
  assign new_n86_ = ~x28 & (x31 | (new_n63_ & new_n80_ & ~x23 & ~x24));
  assign new_n87_ = new_n66_ & new_n78_ & ~x29 & ~x31 & ~x27 & ~x28;
  assign z11 = (x16 & (new_n89_ | new_n91_)) | (~new_n54_ & (x18 | (~x04 & ~x16)));
  assign new_n89_ = x30 & (x28 | (~x31 & (~new_n63_ | ~new_n90_)));
  assign new_n90_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n91_ = new_n59_ & new_n69_ & new_n80_ & new_n92_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z12 = (~x03 & (x31 ? x28 : ~x16)) | (x16 & (new_n91_ | (x28 & x31))) | (x18 & (x28 | ~x31));
  assign z13 = new_n95_ | (x16 & (new_n99_ | (~x31 & (new_n96_ | new_n97_))));
  assign new_n95_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n96_ = x32 & (~new_n66_ | ~new_n78_ | x27 | x29 | x30);
  assign new_n97_ = new_n59_ & new_n69_ & new_n80_ & new_n98_;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n99_ = x28 & x32;
  assign z14 = new_n101_ | (x16 & (new_n107_ | (~x31 & (new_n102_ | new_n104_))));
  assign new_n101_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n102_ = x33 & (~new_n66_ | ~new_n78_ | ~new_n103_);
  assign new_n103_ = ~x27 & ~x29 & ~x30 & ~x32;
  ...
  assign z15 = new_n109_ | (x16 & (new_n114_ | (~x31 & (new_n110_ | new_n111_))));
  assign new_n109_ = ~new_n54_ & (x18 | (~x00 & ~x16));
  assign new_n110_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n80_ | ~new_n106_);
  assign new_n111_ = new_n60_ & new_n73_ & new_n112_ & new_n113_;
  assign new_n112_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n113_ = ~x30 & ~x32 & ~x33 & ~x34;
