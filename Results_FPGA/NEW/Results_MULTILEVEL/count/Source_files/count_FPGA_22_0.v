...
module FAU ( 
  ...
  assign z12 = ~new_n54_ & (~new_n93_ | (x16 & (new_n91_ | (~new_n90_ & x31))));
  assign new_n90_ = new_n66_ & new_n77_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n91_ = new_n59_ & new_n69_ & new_n79_ & new_n92_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = ~x18 & (x03 | x16);
  assign z13 = new_n95_ | (x16 & ((~new_n91_ & x32) | (new_n72_ & new_n96_)));
  assign new_n95_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n96_ = new_n97_ & ~x30 & ~x31 & ~x32 & x34;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z14 = new_n99_ | (x16 & ((new_n72_ & new_n101_) | (~new_n100_ & x33)));
  assign new_n99_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n100_ = ~x32 & (~x34 | (new_n59_ & new_n69_ & new_n79_ & new_n92_));
  assign new_n101_ = new_n97_ & ~x30 & ~x31 & ~x32 & ~x33 & x34;
  assign z15 = (~new_n104_ & (x32 | x34)) | (x16 & x34 & (~new_n72_ | ~new_n103_));
  assign new_n103_ = new_n97_ & ~x30 & ~x31 & ~x32 & ~x33;
