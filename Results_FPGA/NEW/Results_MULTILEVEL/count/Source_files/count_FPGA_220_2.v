...
module FAU ( 
  ...
  assign z08 = (~x18 & (new_n78_ | (~x07 & ~x16))) | (x27 & (x18 | (~new_n77_ & x16)));
  assign new_n77_ = new_n59_ & new_n74_ & new_n75_;
  ...
  assign new_n81_ = (~x28 | (new_n59_ & new_n74_ & new_n75_)) & (~new_n62_ | ~new_n82_);
  ...
  assign z11 = (~x18 & (x16 ? ~new_n88_ : ~x04)) | (x27 & (x18 | (x16 & x30)));
  assign new_n88_ = (~x30 | (new_n62_ & new_n89_)) & (~new_n65_ | ~new_n75_ | ~new_n90_);
  assign new_n89_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n95_ | (~x18 & (x16 ? (new_n92_ | new_n93_) : ~x03));
  assign new_n92_ = x31 & (~new_n65_ | ~new_n75_ | x28 | x29 | x30);
  assign new_n93_ = new_n58_ & new_n68_ & new_n94_ & ~x25 & ~x26 & ~x27;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n95_ = x27 & (x18 | (x16 & x31));
  assign z13 = new_n101_ | (~x18 & (x16 ? (new_n97_ | new_n98_) : ~x02));
  assign new_n97_ = x32 & (~new_n65_ | ~new_n75_ | ~new_n94_);
  assign new_n98_ = new_n99_ & new_n100_ & new_n58_ & new_n68_;
  assign new_n99_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = x27 & (x18 | (x16 & x32));
  assign z14 = new_n108_ | (~x18 & (x16 ? (new_n103_ | new_n105_) : ~x01));
  assign new_n103_ = x33 & (~new_n104_ | ~new_n100_ | ~new_n58_ | ~new_n68_);
  assign new_n104_ = ~x25 & ~x26 & ~x28;
  assign new_n105_ = new_n106_ & new_n107_ & new_n59_ & new_n71_;
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n108_ = x27 & (x18 | (x16 & x33));
  assign z15 = new_n114_ | (~x18 & (x16 ? (new_n110_ | new_n112_) : ~x00));
  assign new_n110_ = x34 & (~new_n107_ | ~new_n111_ | ~new_n58_ | ~new_n68_);
  assign new_n111_ = ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n112_ = new_n106_ & new_n113_ & new_n59_ & new_n71_;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n114_ = x27 & (x18 | (x16 & x34));
endmodule
