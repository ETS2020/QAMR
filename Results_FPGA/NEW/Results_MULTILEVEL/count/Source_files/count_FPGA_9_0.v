...
module FAU ( 
  ...
  assign new_n55_ = x23 & (x16 ? ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)) : ~x14);
  assign z02 = x18 | (~new_n57_ & x23);
  assign new_n57_ = x16 ? ((~x21 | (~x17 & ~x19 & ~x20)) & (x17 | x19 | x20 | x21)) : x13;
  assign z03 = x18 | (x23 & (x16 ? ~new_n59_ : ~x12));
  assign new_n59_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z04 = x18 | (x23 & (x16 ? ~new_n61_ : ~x11));
  assign new_n61_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z05 = x18 | (x23 & (x16 ? x24 : ~x10));
  assign z06 = x18 | (x23 & (x16 ? x25 : ~x09));
  assign z07 = x18 | (x23 & (x16 ? x26 : ~x08));
  assign z08 = x18 | (x23 & (x16 ? x27 : ~x07));
  assign z09 = x18 | (x23 & (x16 ? x28 : ~x06));
  assign z10 = x18 | (x23 & (x16 ? x29 : ~x05));
  assign z11 = x18 | (x23 & (x16 ? x30 : ~x04));
  assign z12 = x18 | (x23 & (x16 ? x31 : ~x03));
  assign z13 = x18 | (x23 & (x16 ? x32 : ~x02));
  assign z14 = x18 | (x23 & (x16 ? x33 : ~x01));
