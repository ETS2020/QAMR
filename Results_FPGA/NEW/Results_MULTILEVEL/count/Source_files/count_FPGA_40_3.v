...
module FAU ( 
  ...
  assign z04 = (~x11 & (~x16 | x18)) | (x16 & ~x18 & (new_n64_ | (~new_n62_ & x23)));
  ...
  assign z13 = x18 ? ~x11 : (x16 ? (new_n93_ | new_n94_) : ~x02);
  ...
  assign z14 = x18 ? ~x11 : (x16 ? (new_n98_ | new_n99_) : ~x01);
  ...
  assign z15 = x18 ? ~x11 : (x16 ? ~new_n103_ : ~x00);
