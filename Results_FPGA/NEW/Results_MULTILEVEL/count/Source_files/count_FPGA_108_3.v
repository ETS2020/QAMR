...
module FAU ( 
  ...
  assign new_n91_ = (x04 | (x29 & x31)) & (~x18 | x31);
  assign new_n92_ = x18 & (~x29 | (~x30 & ~x31));
  assign new_n93_ = x29 & x30 & ~x31;
  assign z12 = ((~x29 | ~x31) & (x18 | (~x03 & ~x16))) | (x16 & ~new_n95_ & ~x29);
  assign new_n95_ = (~x31 | (new_n66_ & new_n90_)) & (~new_n66_ | ~new_n78_ | ~new_n96_);
  assign new_n96_ = ~x27 & ~x28 & ~x30 & ~x31;
  assign z13 = (~new_n102_ & ~x16) | new_n103_ | (x16 & (new_n98_ | (new_n101_ & ~x29)));
  assign new_n98_ = ~x31 & (new_n99_ | (new_n59_ & new_n69_ & new_n80_ & new_n100_));
  assign new_n99_ = x29 & x32;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n101_ = x32 & (~new_n66_ | ~new_n78_ | ~new_n96_);
  assign new_n102_ = (x02 | (x29 & x31)) & (~x18 | x31);
  assign new_n103_ = x18 & (~x29 | (~x31 & ~x32));
  assign z14 = (~new_n111_ & ~x16) | new_n112_ | (x16 & (new_n105_ | new_n109_));
  assign new_n105_ = ~x31 & (new_n106_ | (new_n59_ & new_n69_ & new_n107_ & new_n108_));
  assign new_n106_ = x29 & x33;
  assign new_n107_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n108_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n109_ = ~x29 & x33 & (~new_n59_ | ~new_n69_ | ~new_n80_ | ~new_n110_);
  assign new_n110_ = ~x28 & ~x30 & ~x31 & ~x32;
  assign new_n111_ = (x01 | (x29 & x31)) & (~x18 | x31);
  assign new_n112_ = x18 & (~x29 | (~x31 & ~x33));
  assign z15 = (~new_n120_ & ~x16) | new_n121_ | (x16 & (new_n114_ | new_n118_));
  assign new_n114_ = ~x31 & (new_n115_ | (new_n60_ & new_n73_ & new_n116_ & new_n117_));
  assign new_n115_ = x29 & x34;
  assign new_n116_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n117_ = ~x30 & ~x32 & ~x33 & ~x34;
  assign new_n118_ = ~x29 & x34 & (~new_n59_ | ~new_n69_ | ~new_n107_ | ~new_n119_);
  assign new_n119_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n120_ = (x00 | (x29 & x31)) & (~x18 | x31);
  assign new_n121_ = x18 & (~x29 | (~x31 & ~x34));
endmodule
