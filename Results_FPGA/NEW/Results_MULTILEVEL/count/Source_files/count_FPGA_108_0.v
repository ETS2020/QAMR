...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n58_, new_n59_, new_n60_, new_n62_, new_n63_,
    ...
    new_n85_, new_n87_, new_n88_, new_n89_, new_n90_, new_n92_;
  ...
  assign z10 = (~new_n85_ & (x29 | x31)) | (x16 & (new_n84_ | (~new_n80_ & x29)));
  assign new_n84_ = new_n66_ & new_n77_ & ~x27 & ~x28 & ~x29 & x31;
  assign new_n85_ = ~x18 & (x05 | x16);
  assign z11 = new_n87_ | (x16 & (new_n88_ | (new_n70_ & new_n89_)));
  assign new_n87_ = ~new_n54_ & (x18 | (~x04 & ~x16));
  assign new_n88_ = x30 & (x29 | (x31 & (~new_n63_ | ~new_n81_)));
  assign new_n89_ = new_n90_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & x31;
  assign z12 = ((x29 | x31) & (x18 | (~x03 & ~x16))) | (x16 & ~new_n92_ & x31);
  assign new_n92_ = new_n66_ & new_n77_ & ~x29 & ~x30 & ~x27 & ~x28;
