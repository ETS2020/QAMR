...
module FAU ( 
  ...
  assign z06 = x18 | (~x05 & (x16 ? ~new_n70_ : ~x09));
  ...
  assign z10 = x18 | (~x05 & (~new_n82_ | (x29 & (~new_n62_ | ~new_n80_))));
  assign new_n82_ = x16 & (~new_n65_ | ~new_n83_ | x27 | x28 | x29);
  assign new_n83_ = ~x24 & ~x25 & ~x26;
  assign z11 = x18 | (~x05 & (x16 ? ~new_n85_ : ~x04));
  assign new_n85_ = (~x30 | (new_n65_ & new_n83_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n83_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x05 & (x16 ? (new_n87_ | new_n89_) : ~x03));
  assign new_n87_ = x31 & (~new_n65_ | ~new_n83_ | ~new_n88_);
  ...
  assign z13 = x18 | (~x05 & (x16 ? (new_n93_ | new_n94_) : ~x02));
  ...
  assign z14 = x18 | (~x05 & (x16 ? (new_n98_ | new_n99_) : ~x01));
  ...
  assign z15 = x18 | (~x05 & (x16 ? ~new_n103_ : ~x00));
