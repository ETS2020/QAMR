...
module FAU ( 
  ...
  assign z01 = (~x19 & (x18 | (x16 & ~x17 & ~x20))) | (~x18 & (x16 ? ((x17 | x19) & x20) : ~x14));
  assign z02 = (~x19 & (new_n58_ | x18)) | (~new_n56_ & ~x18);
  assign new_n56_ = x16 ? (new_n57_ | ~x21) : x13;
  assign new_n57_ = ~x17 & ~x19 & ~x20;
  assign new_n58_ = x16 & ~x17 & ~x20 & ~x21;
  assign z03 = (~x19 & (new_n62_ | x18)) | (~x18 & (x16 ? new_n60_ : ~x12));
  assign new_n60_ = ~new_n61_ & x22;
  assign new_n61_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n62_ = x16 & ~x17 & ~x20 & ~x21 & ~x22;
  assign z04 = (~x19 & (new_n66_ | x18)) | (~x18 & (x16 ? new_n64_ : ~x11));
  assign new_n64_ = ~new_n65_ & x23;
  assign new_n65_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n66_ = x16 & ~x17 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = (~new_n70_ & ~x18) | (~x19 & (new_n68_ | x18));
  assign new_n68_ = new_n69_ & x16 & ~x17 & ~x20;
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n70_ = x16 ? (new_n71_ | ~x24) : x10;
  assign new_n71_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z06 = (~x19 & (new_n73_ | x18)) | (~x18 & (x16 ? new_n75_ : ~x09));
  ...
  assign z14 = (~x19 & (x18 | (new_n73_ & new_n104_))) | (~x18 & (new_n107_ | new_n108_));
  ...
  assign new_n110_ = ~x19 & (x18 | (new_n58_ & new_n74_ & new_n105_ & new_n111_));
