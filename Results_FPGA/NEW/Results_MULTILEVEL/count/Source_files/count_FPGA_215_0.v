// Benchmark "FAU" written by ABC on Thu Aug  6 17:25:53 2020
...
module FAU ( 
  ...
  assign z13 = x18 | (x00 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  ...
  assign z14 = x18 | (x00 & (x16 ? (new_n99_ | new_n100_) : ~x01));
  ...
  assign z15 = x18 | (x00 & ~new_n104_ & x16);
