...
module FAU ( 
  ...
  assign z05 = (x21 & (x18 | (x16 & x24))) | (~x18 & (x16 ? ~new_n67_ : ~x10));
  assign new_n67_ = (new_n68_ | ~x24) & (~new_n57_ | ~new_n69_);
  assign new_n68_ = ~x17 & ~x19 & ~x20 & ~x22 & ~x23;
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (x21 & (x18 | (x16 & x25))) | (~x18 & (x16 ? ~new_n71_ : ~x09));
  assign new_n71_ = (~new_n73_ | ~new_n74_) & (new_n72_ | ~x25);
  ...
  assign new_n76_ = (~x26 | (new_n57_ & new_n77_ & ~x24 & ~x25)) & (~new_n73_ | ~new_n77_ | x24 | x25 | x26);
  assign new_n77_ = ~x22 & ~x23;
  assign z08 = (x21 & (x18 | (x16 & x27))) | (~x18 & (x16 ? ~new_n79_ : ~x07));
  assign new_n79_ = (~x27 | (new_n64_ & new_n80_ & ~x25 & ~x26)) & (~new_n61_ | ~new_n80_ | x25 | x26 | x27);
  assign new_n80_ = ~x23 & ~x24;
  assign z09 = (x21 & (x18 | (x16 & x28))) | (~x18 & (x16 ? ~new_n82_ : ~x06));
  assign new_n82_ = (~x28 | (new_n64_ & new_n80_ & new_n83_)) & (~new_n61_ | ~new_n84_);
  assign new_n83_ = ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x21 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n86_ : ~x05));
  assign new_n86_ = (~x29 | (new_n68_ & new_n87_)) & (~new_n65_ | ~new_n88_);
  assign new_n87_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n88_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x21 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n90_ : ~x04));
  assign new_n90_ = (~x30 | (new_n68_ & new_n88_)) & (~new_n65_ | ~new_n91_ | ~new_n92_);
  assign new_n91_ = ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n97_ | (~x18 & (x16 ? (new_n94_ | new_n95_) : ~x03));
  assign new_n94_ = x31 & (~new_n72_ | ~new_n83_ | x28 | x29 | x30);
  assign new_n95_ = new_n83_ & new_n96_ & new_n57_ & new_n69_;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = x21 & (x18 | (x16 & x31));
  assign z13 = new_n103_ | (~x18 & (x16 ? (new_n99_ | new_n100_) : ~x02));
  assign new_n99_ = x32 & (~new_n72_ | ~new_n83_ | ~new_n96_);
  assign new_n100_ = new_n101_ & new_n102_ & new_n57_ & new_n69_;
  assign new_n101_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n103_ = x21 & (x18 | (x16 & x32));
  assign z14 = new_n110_ | (~x18 & (x16 ? (new_n105_ | new_n107_) : ~x01));
  assign new_n105_ = x33 & (~new_n106_ | ~new_n102_ | ~new_n57_ | ~new_n74_);
  assign new_n106_ = ~x26 & ~x27 & ~x28;
  assign new_n107_ = new_n108_ & new_n109_ & new_n73_ & new_n74_;
  assign new_n108_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n110_ = x21 & (x18 | (x16 & x33));
  assign z15 = new_n115_ | (~x18 & (x16 ? (new_n112_ | new_n113_) : ~x00));
  assign new_n112_ = x34 & (~new_n108_ | ~new_n109_ | ~new_n57_ | ~new_n74_);
  assign new_n113_ = new_n108_ & new_n114_ & new_n73_ & new_n74_;
  assign new_n114_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n115_ = x21 & (x18 | (x16 & x34));
endmodule
