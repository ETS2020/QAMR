...
module FAU ( 
  ...
  assign z11 = x18 | (~x30 & (new_n87_ | (~x04 & ~x16)));
  assign new_n87_ = new_n88_ & new_n89_ & ~x23 & ~x24 & ~x25;
  assign new_n88_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z12 = x18 | (~x30 & (x16 ? ~new_n91_ : ~x03));
  assign new_n91_ = (~x31 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n76_ | x27 | x28 | x29 | x31);
  assign z13 = x18 | (~x30 & (x16 ? (new_n93_ | new_n95_) : ~x02));
  assign new_n93_ = x32 & (~new_n65_ | ~new_n76_ | ~new_n94_ | x29 | x31);
  assign new_n94_ = ~x27 & ~x28;
  assign new_n95_ = new_n58_ & new_n68_ & new_n78_ & new_n96_;
  assign new_n96_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign z14 = x18 | (~x30 & (x16 ? (new_n98_ | new_n99_) : ~x01));
  ...
  assign new_n101_ = ~x29 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x30 & (x16 ? (new_n103_ | new_n104_) : ~x00));
  assign new_n103_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n100_ | ~new_n101_);
  assign new_n104_ = new_n59_ & new_n71_ & new_n89_ & new_n105_;
