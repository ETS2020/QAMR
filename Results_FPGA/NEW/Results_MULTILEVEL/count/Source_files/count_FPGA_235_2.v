// Benchmark "FAU" written by ABC on Thu Aug  6 17:26:01 2020
...
module FAU ( 
  ...
  assign z03 = x18 | (~x08 & (x16 ? ~new_n61_ : ~x12));
  assign new_n61_ = ~new_n62_ & (new_n59_ | ~x22);
  assign new_n62_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z04 = x18 | (~x08 & (x16 ? ~new_n64_ : ~x11));
  assign new_n64_ = ~new_n65_ & (new_n62_ | ~x23);
  assign new_n65_ = ~x21 & ~x22 & ~x23 & ~x17 & ~x19 & ~x20;
  assign z05 = x18 | (~x08 & (x16 ? ~new_n67_ : ~x10));
  assign new_n67_ = (new_n65_ | ~x24) & (~new_n58_ | ~new_n68_);
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = x18 | (~x08 & (x16 ? ~new_n70_ : ~x09));
  assign new_n70_ = (~x25 | (new_n58_ & new_n68_)) & (~new_n59_ | ~new_n71_);
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 | (~new_n73_ & ~x08);
  assign new_n73_ = (~x26 | (new_n59_ & new_n74_ & ~x24 & ~x25)) & x16 & (~new_n59_ | ~new_n74_ | x24 | x25 | x26);
  assign new_n74_ = ~x22 & ~x23;
  assign z08 = x18 | (~x08 & (x16 ? ~new_n76_ : ~x07));
  assign new_n76_ = (~x27 | (new_n59_ & new_n74_ & new_n77_)) & (~new_n62_ | ~new_n78_);
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x08 & (x16 ? ~new_n80_ : ~x06));
  assign new_n80_ = (~new_n62_ | ~new_n81_) & (~x28 | (new_n62_ & new_n78_));
  assign new_n81_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = x18 | (~x08 & (x16 ? (new_n83_ | new_n84_) : ~x05));
  assign new_n83_ = x29 & (~new_n62_ | ~new_n81_);
  assign new_n84_ = new_n65_ & new_n77_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x08 & (x16 ? ~new_n86_ : ~x04));
  assign new_n86_ = (~x30 | (new_n65_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n77_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x08 & (x16 ? (new_n88_ | new_n90_) : ~x03));
  assign new_n88_ = x31 & (~new_n65_ | ~new_n77_ | ~new_n89_);
  assign new_n89_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n90_ = new_n91_ & new_n92_ & new_n58_ & new_n68_;
  assign new_n91_ = ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x08 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n91_ | ~new_n92_ | ~new_n58_ | ~new_n68_);
  assign new_n95_ = new_n96_ & new_n97_ & new_n58_ & new_n68_;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x08 & (x16 ? (new_n99_ | new_n100_) : ~x01));
  assign new_n99_ = x33 & (~new_n96_ | ~new_n97_ | ~new_n58_ | ~new_n68_);
  assign new_n100_ = new_n101_ & new_n102_ & new_n59_ & new_n71_;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x08 & (x16 ? ~new_n104_ : ~x00));
  assign new_n104_ = (~x34 | (new_n101_ & new_n102_ & new_n59_ & new_n71_)) & (~new_n59_ | ~new_n71_ | ~new_n101_ | ~new_n105_);
