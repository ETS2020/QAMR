// Benchmark "FAU" written by ABC on Thu Aug  6 15:14:37 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n51_, new_n52_, new_n55_, new_n60_, new_n64_, new_n66_,
    new_n68_, new_n69_, new_n71_, new_n73_, new_n74_, new_n76_, new_n78_,
    new_n80_;
  assign z00 = x08 & ~new_n48_ & ~x16;
  assign new_n48_ = ~x12 & x25;
  ...
  assign z04 = ~x08 & ((~new_n55_ & (x12 | ~x25)) | (~x03 & x12) | (x03 & ~x12 & ~x25));
  ...
  assign z08 = (x24 & (new_n60_ | x23) & ~x25) | (x12 & x25);
  ...
  assign z12 = ~x07 & ~new_n48_ & new_n66_ & ~x15;
  assign new_n66_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = ~new_n48_ & (~new_n52_ | new_n69_ | x15 | (~new_n68_ & x20));
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = ~new_n48_ & (~new_n52_ | new_n71_ | x15 | (~new_n69_ & x21));
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n48_ & ((~new_n71_ & x22) | ~new_n52_ | new_n73_ | x15);
  assign new_n73_ = new_n68_ & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign z16 = ~new_n48_ & ((~new_n73_ & x23) | ~new_n52_ | new_n76_ | x15);
  assign new_n76_ = new_n68_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = ~new_n48_ & ((~new_n76_ & x24) | ~new_n78_ | ~new_n52_);
  assign new_n78_ = ~x15 & (~new_n69_ | ~new_n74_ | x23 | x24);
  assign z18 = ~new_n80_ | (~new_n48_ & ((x04 & x05) | x07 | x15));
  assign new_n80_ = (~x12 | ~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
