...
module FAU ( 
  ...
  assign z13 = x15 ? ~x00 : ~new_n66_;
  assign new_n66_ = (new_n67_ | ~x20) & ~new_n51_ & ~new_n68_ & ~x07;
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 ? ~x00 : ((~new_n68_ & x21) | new_n51_ | ~new_n70_);
  assign new_n70_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x00 : (new_n73_ | new_n51_ | new_n72_ | x07);
  assign new_n72_ = new_n67_ & ~x20 & ~x21 & ~x22;
  assign new_n73_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 ? ~x00 : (~new_n75_ | new_n51_ | (~new_n72_ & x23));
  assign new_n75_ = ~x07 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? ~x00 : (new_n77_ | new_n51_ | new_n78_ | x07);
  assign new_n77_ = x24 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign new_n78_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x00 : (~new_n80_ | new_n51_ | (~new_n78_ & x25));
  assign new_n80_ = ~x07 & (~new_n68_ | ~new_n81_);
