// Benchmark "FAU" written by ABC on Thu Aug  6 15:14:40 2020
...
module FAU ( 
  ...
  assign z01 = z03 | ((new_n51_ | x07) & (x15 | x24));
  ...
  assign z08 = (x24 & (new_n60_ | x23 | x25)) | (x15 & x25);
  assign new_n60_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = x24 & ~x15 & new_n51_ & ~x07;
  assign z10 = ~x07 & ~x15 & ~x17 & ~new_n51_ & x24;
  assign z11 = ~x07 & ~x15 & x24 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x07 & new_n65_ & ~x15;
  assign new_n65_ = x24 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n67_ & x24);
  assign new_n67_ = (~x20 | (x17 & x18 & x19)) & ~new_n51_ & ~x07 & (~x17 | ~x18 | ~x19 | x20);
  assign z14 = x15 | (~new_n69_ & x24);
  assign new_n69_ = (~x21 | (new_n70_ & x19 & ~x20)) & ~new_n51_ & ~x07 & (~new_n70_ | ~x19 | x20 | x21);
  assign new_n70_ = x17 & x18;
  assign z15 = x15 | (x24 & (new_n72_ | new_n51_ | new_n73_ | x07));
  assign new_n72_ = x22 & (~new_n70_ | ~x19 | x20 | x21);
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x24 & ((~new_n73_ & x23) | ~new_n75_ | new_n51_));
  assign new_n75_ = ~x07 & (~new_n76_ | ~x17 | ~x18 | ~x19);
  assign new_n76_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = x15 | (x24 & (~new_n78_ | ~new_n70_ | new_n51_ | x07));
  assign new_n78_ = x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z18 = x15 | (x24 & (new_n51_ | x07 | x25));
endmodule
