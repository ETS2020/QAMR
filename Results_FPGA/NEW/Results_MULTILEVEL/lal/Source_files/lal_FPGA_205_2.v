...
module FAU ( 
  ...
  assign z14 = x15 ? x24 : (new_n51_ | ~new_n70_ | (~new_n68_ & x21));
  assign new_n70_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? x24 : (new_n73_ | new_n51_ | new_n72_ | x07);
  assign new_n72_ = new_n67_ & ~x20 & ~x21 & ~x22;
  assign new_n73_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 ? x24 : ((~new_n72_ & x23) | ~new_n75_ | new_n51_);
  assign new_n75_ = ~x07 & (~new_n67_ | ~new_n76_);
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n79_ | (~x15 & (~new_n78_ | new_n51_));
  assign new_n78_ = ~x07 & (~new_n68_ | x21 | x22 | x23 | x24);
  assign new_n79_ = x24 & (~new_n76_ | ~x18 | ~x19 | x15 | ~x17);
  assign z18 = (x24 & (x15 | x25)) | (~x15 & (~new_n82_ | new_n51_ | (~new_n81_ & x25)));
  assign new_n81_ = new_n67_ & new_n76_;
  assign new_n82_ = ~x07 & (~new_n68_ | ~new_n83_);
