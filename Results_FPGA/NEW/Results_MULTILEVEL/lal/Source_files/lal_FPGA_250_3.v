...
module FAU ( 
  ...
  assign z01 = x07 ? ~x19 : (new_n52_ | (~x25 & (new_n50_ | ~x24)));
  ...
  assign new_n55_ = ~x20 & ~x23 & (x19 ? ~x07 : (x17 | x18));
  ...
  assign z08 = (~new_n63_ & (~x07 | ~x19)) | (new_n64_ & ~x17 & ~x18 & ~x19);
  ...
  assign z13 = (~x19 & (x07 | x20)) | (~x07 & ((~new_n70_ & x20) | new_n52_ | x15 | (new_n70_ & x19 & ~x20)));
  assign new_n70_ = x17 & x18;
  assign z14 = (~x19 & (x07 | x21)) | (~x07 & (~new_n72_ | new_n52_ | (~new_n73_ & x21)));
  assign new_n72_ = ~x15 & (~new_n70_ | ~x19 | x20 | x21);
  assign new_n73_ = x17 & x18 & ~x20;
  assign z15 = (~new_n75_ & ~x07) | (~x19 & (x07 | x22));
  assign new_n75_ = ~new_n76_ & ~new_n52_ & ~new_n77_ & ~x15;
  assign new_n76_ = x22 & (~x17 | ~x18 | x20 | x21);
  assign new_n77_ = ~x20 & ~x21 & ~x22 & x17 & x18 & x19;
  assign z16 = (~new_n79_ & ~x07) | (~x19 & (x07 | x23));
  assign new_n79_ = ~new_n81_ & ~new_n52_ & ~x15 & (~new_n80_ | ~new_n82_);
  assign new_n80_ = x17 & x18 & x19;
  assign new_n81_ = x23 & (~x17 | ~x18 | x20 | x21 | x22);
  assign new_n82_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = (~x19 & (x07 | x24)) | (~x07 & (~new_n85_ | new_n52_ | (~new_n84_ & x24)));
  assign new_n84_ = new_n73_ & ~x21 & ~x22 & ~x23;
  assign new_n85_ = ~x15 & (~new_n86_ | x21 | x22 | x23 | x24);
  assign new_n86_ = x17 & x18 & x19 & ~x20;
  assign z18 = new_n90_ | (~x07 & (new_n88_ | new_n52_ | new_n89_ | x15));
  assign new_n88_ = x25 & (~new_n73_ | x21 | x22 | x23 | x24);
  assign new_n89_ = new_n86_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n90_ = ~x19 & (x07 | x25);
endmodule
