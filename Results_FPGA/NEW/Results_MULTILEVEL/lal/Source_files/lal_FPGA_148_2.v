...
module FAU ( 
  ...
  assign z01 = ((~x04 | x15) & (x07 | (~new_n49_ & ~x25))) | (x04 & x05 & x15);
  ...
  assign z12 = ~x04 & ~x07 & ~x15 & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~x04 & ((~new_n65_ & x20) | new_n66_ | x07));
  assign new_n65_ = x17 & x18 & x19;
  assign new_n66_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~x04 & ((~new_n66_ & x21) | new_n68_ | x07));
  assign new_n68_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x04 & (new_n70_ | x07 | (~new_n68_ & x22)));
  assign new_n70_ = new_n65_ & new_n71_ & ~x20;
  assign new_n71_ = ~x21 & ~x22;
  assign z16 = x15 | (~x04 & ((~new_n70_ & x23) | new_n73_ | x07));
  assign new_n73_ = new_n65_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x04 & (~new_n75_ | (~new_n73_ & x24)));
  assign new_n75_ = ~x07 & (~new_n66_ | ~new_n71_ | x23 | x24);
  assign z18 = x15 | (~new_n77_ & ~x04);
