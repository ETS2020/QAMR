...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n56_, new_n61_, new_n62_,
    new_n66_, new_n68_, new_n70_, new_n72_, new_n74_, new_n75_, new_n76_,
    new_n78_, new_n80_, new_n81_, new_n82_, new_n84_, new_n85_;
  ...
  assign z08 = (~new_n61_ & (~x11 | ~x19)) | (new_n62_ & ~x17 & ~x18 & ~x19);
  ...
  assign new_n68_ = (~x04 | ~x05) & ((~x11 & x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n70_ | (~x11 & ((x17 & x18) ? (x19 & ~x20) : x20)) | (~x19 & x20);
  assign new_n70_ = ~new_n48_ & ((x04 & x05) | x07 | x15);
  assign z14 = new_n70_ | ~new_n72_;
  assign new_n72_ = (x11 | ((~x21 | (x17 & x18 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21))) & (x19 | ~x21);
  assign z15 = new_n70_ | (~new_n74_ & ~x11) | (~x19 & x22);
  assign new_n74_ = (~x22 | (new_n75_ & ~x20 & ~x21)) & (~new_n76_ | x20 | x21 | x22);
  assign new_n75_ = x17 & x18;
  assign new_n76_ = x17 & x18 & x19;
  assign z16 = new_n70_ | (~new_n78_ & ~x11) | (~x19 & x23);
  assign new_n78_ = (~x23 | (new_n75_ & ~x20 & ~x21 & ~x22)) & (~new_n76_ | x22 | x23 | x20 | x21);
  assign z17 = new_n70_ | (~new_n80_ & ~x11) | (~x19 & x24);
  assign new_n80_ = (~x24 | (new_n82_ & ~x21 & ~x22 & ~x23)) & (~new_n81_ | x23 | x24 | x21 | x22);
  assign new_n81_ = x17 & x18 & x19 & ~x20;
  assign new_n82_ = x17 & x18 & ~x20;
  assign z18 = new_n70_ | (~new_n84_ & ~x11) | (~x19 & x25);
  assign new_n84_ = (~x25 | (new_n82_ & new_n85_ & ~x23 & ~x24)) & (~new_n81_ | ~new_n85_ | x23 | x24 | x25);
