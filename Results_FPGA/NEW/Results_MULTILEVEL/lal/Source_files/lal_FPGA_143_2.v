...
module FAU ( 
  ...
  assign z13 = (x17 & (x15 | (x18 & x19 & ~x20))) | (~x15 & (~new_n51_ | (x20 & (~x17 | ~x18 | ~x19))));
  assign z14 = (x17 & (new_n72_ | x15)) | (~x15 & (~new_n51_ | (~new_n73_ & x21)));
  assign new_n72_ = x18 & x19 & ~x20 & ~x21;
  assign new_n73_ = x17 & x18 & x19 & ~x20;
  assign z15 = (x17 & (new_n75_ | x15)) | (~x15 & (~new_n51_ | new_n76_));
  assign new_n75_ = x18 & x19 & ~x20 & ~x21 & ~x22;
  assign new_n76_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (x17 & (new_n78_ | x15)) | (~x15 & (~new_n51_ | (~new_n80_ & x23)));
  assign new_n78_ = new_n79_ & ~x21 & ~x22 & ~x23;
  assign new_n79_ = x18 & x19 & ~x20;
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = (x17 & (x15 | (new_n79_ & new_n84_))) | (~x15 & (new_n82_ | ~new_n51_));
  assign new_n82_ = x24 & (~new_n83_ | ~x17 | ~x18 | ~x19);
  assign new_n83_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n84_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z18 = (x17 & (x15 | (new_n72_ & new_n87_))) | (~x15 & (new_n86_ | ~new_n51_));
