...
module FAU ( 
  ...
  assign z14 = x15 | (~x16 & (new_n51_ | ~new_n72_ | (~new_n70_ & x21)));
  assign new_n72_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x16 & (new_n75_ | new_n51_ | new_n74_ | x07));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (~x16 & ((~new_n74_ & x23) | ~new_n77_ | new_n51_));
  assign new_n77_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x16 & (new_n79_ | new_n51_ | new_n80_ | x07));
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x16 & ((~new_n80_ & x25) | ~new_n82_ | new_n51_));
