// Benchmark "FAU" written by ABC on Thu Aug  6 15:14:30 2020
...
module FAU ( 
  ...
  assign z00 = x08 & ~x16 & (~x07 | ~x13);
  assign z01 = x07 ? ~x13 : (new_n51_ | (~new_n49_ & ~x25));
  assign new_n49_ = x24 & (new_n50_ | x23);
  assign new_n50_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign new_n51_ = x04 & x05;
  assign z02 = x16 & (~x07 | ~x13);
  assign z03 = ~x25 & ~new_n49_ & (~x07 | ~x13);
  assign z04 = ~x08 & ~new_n55_ & (~x07 | ~x13);
  assign new_n55_ = new_n56_ & (x00 | ~x09) & (~x00 | x09) & (x01 | ~x10) & (~x01 | x10);
  assign new_n56_ = (x03 | ~x12) & (~x03 | x12) & (x02 | ~x11) & (~x02 | x11);
  assign z05 = ~x08 & ~x13;
  assign z06 = ~x08 & x14 & (~x07 | ~x13);
  assign z07 = (~x07 | ~x13) & (~x06 | x08);
  assign z08 = (~x07 | ~x13) & (x25 | (x24 & (new_n61_ | x23)));
