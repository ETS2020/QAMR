...
module FAU ( 
  ...
  assign z16 = x15 ? x25 : ((~new_n72_ & x23) | ~new_n75_ | new_n51_);
  assign new_n75_ = ~x07 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? x25 : (new_n77_ | ~new_n78_ | new_n51_);
  assign new_n77_ = x24 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign new_n78_ = ~x07 & (~new_n68_ | x21 | x22 | x23 | x24);
  assign z18 = new_n81_ | (~x15 & (new_n51_ | new_n80_ | x07));
  assign new_n80_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n81_ = x25 & (~new_n82_ | ~x18 | ~x19 | x15 | ~x17);
