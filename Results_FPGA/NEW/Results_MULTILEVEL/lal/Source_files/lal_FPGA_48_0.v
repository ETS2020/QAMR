...
module FAU ( 
  ...
  assign z14 = x15 | (x05 & (~new_n71_ | x04 | (~new_n69_ & x21)));
  assign new_n71_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x05 & (new_n74_ | x04 | new_n73_ | x07));
  assign new_n73_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (x05 & (~new_n76_ | x04 | (~new_n73_ & x23)));
  assign new_n76_ = ~x07 & (~new_n68_ | x22 | x23 | x20 | x21);
  assign z17 = x15 | (x05 & (new_n78_ | ~new_n79_ | x04));
