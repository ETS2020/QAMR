// Benchmark "FAU" written by ABC on Thu Aug  6 15:14:39 2020
...
module FAU ( 
  ...
  assign z04 = ~x08 & ~new_n54_ & (x15 | x16);
  ...
  assign z10 = ~x07 & ~x15 & x16 & ~new_n51_ & ~x17;
  assign z11 = ~x07 & ~x15 & x16 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x07 & new_n65_ & ~x15;
  assign new_n65_ = x16 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  ...
  assign z15 = x15 | (x16 & (new_n74_ | new_n51_ | new_n73_ | x07));
  ...
  assign z17 = x15 | (x16 & (new_n78_ | new_n51_ | new_n79_ | x07));
  assign new_n78_ = x24 & (~new_n68_ | x22 | x23 | x20 | x21);
  assign new_n79_ = new_n69_ & ~x23 & ~x24 & ~x21 & ~x22;
  assign z18 = x15 | (x16 & ((~new_n79_ & x25) | ~new_n81_ | new_n51_));
