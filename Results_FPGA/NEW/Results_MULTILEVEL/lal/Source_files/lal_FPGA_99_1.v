...
module FAU ( 
  ...
  assign z03 = ~x25 & ((~x22 & (~x23 | ~x24)) | (x16 & (~x24 | (~new_n50_ & ~x23))));
  ...
  assign z08 = (x16 & (x25 | (x24 & (new_n60_ | x23)))) | (~x22 & (x25 | (x23 & x24)));
  ...
  assign z15 = (~new_n75_ & (x16 | ~x22)) | new_n74_ | (x16 & ~new_n72_ & x22);
  assign new_n74_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign z16 = (~new_n75_ & (~x22 | (x16 & ~x23))) | (~x22 & (new_n77_ | (~new_n72_ & x23))) | (x16 & x22 & x23);
  assign new_n77_ = new_n68_ & ~x20 & ~x21 & ~x23;
  assign z17 = (~new_n75_ & (~x22 | (x16 & ~x24))) | (x16 & x22 & x24) | (~x22 & (new_n79_ | (~new_n77_ & x24)));
  assign new_n79_ = new_n68_ & ~x23 & ~x24 & ~x20 & ~x21;
  assign z18 = (~new_n75_ & (~x22 | (x16 & ~x25))) | (x16 & x22 & x25) | (~x22 & (new_n81_ | (~new_n79_ & x25)));
  assign new_n81_ = new_n70_ & ~x24 & ~x25 & ~x21 & ~x23;
  assign z02 = x16;
endmodule
