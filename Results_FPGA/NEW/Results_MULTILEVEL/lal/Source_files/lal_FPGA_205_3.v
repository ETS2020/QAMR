...
module FAU ( 
  ...
  assign z08 = (~x15 & (x25 | (x24 & (new_n60_ | x23)))) | (~x24 & x25);
  ...
  assign z16 = x15 ? ~x24 : (new_n75_ | new_n51_ | new_n76_ | x07);
  assign new_n75_ = x23 & (~new_n67_ | x20 | x21 | x22);
  assign new_n76_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~x24 & (new_n76_ | x15)) | (~x15 & (new_n51_ | x07 | (~new_n76_ & x24)));
  assign z18 = (~x24 & (new_n79_ | x15)) | (~x15 & (new_n80_ | new_n51_ | x07));
  assign new_n79_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x25;
