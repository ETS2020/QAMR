...
module FAU ( 
  ...
  assign z04 = ~x08 & ((~new_n56_ & (x03 | x04)) | (x03 & ~x12) | (~x03 & x04 & x12));
  ...
  assign new_n64_ = x04 ? x05 : ~x03;
  assign z11 = ~x07 & ~x15 & ~new_n64_ & (x17 ^ x18);
  assign z12 = ~x07 & ~x15 & ~new_n64_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n52_ | (~new_n68_ & ~new_n48_);
  assign new_n68_ = (new_n69_ | ~x20) & ~x07 & ~new_n70_ & ~x15;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = new_n52_ | (~new_n48_ & ((~new_n70_ & x21) | ~new_n72_ | x07));
  assign new_n72_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n52_ | (~new_n48_ & (new_n75_ | x07 | new_n74_ | x15));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = new_n52_ | (~new_n48_ & (~new_n77_ | x07 | (~new_n74_ & x23)));
  assign new_n77_ = ~x15 & (~new_n69_ | x22 | x23 | x20 | x21);
  assign z17 = new_n52_ | (~new_n48_ & (new_n79_ | ~new_n80_ | x07));
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = ~x15 & (~new_n70_ | x23 | x24 | x21 | x22);
  assign z18 = new_n52_ | (~new_n48_ & (new_n82_ | x07 | new_n83_ | x15));
