...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n51_, new_n54_, new_n55_, new_n60_, new_n64_, new_n66_,
  ...
  assign z03 = ~x19 & ~x25 & (new_n51_ | ~x24);
  ...
  assign z08 = x25 | (~x19 & ~new_n60_ & x24);
  assign new_n60_ = ~x23 & (~x21 | ~x22 | (~x20 & (x17 | x18)));
  ...
  assign new_n66_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18) & x25) | (x17 & x18 & ~x19));
  assign z13 = new_n68_ | (x20 & (~x19 | (~new_n69_ & x25))) | (new_n69_ & x19 & ~x20 & x25);
  assign new_n68_ = ~new_n48_ & ((x04 & x05) | x07 | x15);
  assign new_n69_ = x17 & x18;
  assign z14 = new_n68_ | ~new_n71_;
  assign new_n71_ = (~x21 | (x19 & (~x25 | (x17 & x18 & ~x20)))) & (~x17 | ~x18 | ~x19 | x20 | x21 | ~x25);
  assign z15 = new_n68_ | ~new_n73_;
  assign new_n73_ = (~x22 | (x19 & (~x25 | (new_n74_ & x17 & x18)))) & (~x17 | ~x18 | ~x19 | ~new_n74_ | x22 | ~x25);
  assign new_n74_ = ~x20 & ~x21;
  assign z16 = new_n68_ | ~new_n76_;
  assign new_n76_ = (~x23 | (x19 & (~x25 | (new_n69_ & new_n77_ & ~x20)))) & (~new_n69_ | ~x19 | x20 | ~new_n77_ | x23 | ~x25);
  assign new_n77_ = ~x21 & ~x22;
  assign z17 = new_n68_ | new_n79_ | (x24 & (~x19 | (~new_n81_ & x25)));
  assign new_n79_ = new_n80_ & new_n77_ & ~x23 & ~x24 & x25;
  assign new_n80_ = x17 & x18 & x19 & ~x20;
  assign new_n81_ = x17 & x18 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z18 = new_n68_ | (x25 & (~new_n80_ | ~new_n77_ | x23 | x24));
endmodule
