// Benchmark "FAU" written by ABC on Thu Aug  6 15:14:22 2020
...
module FAU ( 
  ...
  assign z01 = (~x12 | ~x15) & (new_n51_ | x07 | (~new_n49_ & ~x25));
  assign new_n49_ = x24 & (new_n50_ | x23);
  assign new_n50_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign new_n51_ = x04 & x05;
  assign z02 = x16 & (~x12 | ~x15);
  assign z03 = ~x25 & ~new_n49_ & (~x12 | ~x15);
  assign z04 = ~x08 & ((~new_n55_ & (~x12 | ~x15)) | (x03 & ~x12) | (~x03 & x12 & ~x15));
  ...
  assign z08 = (~x12 | ~x15) & (x25 | (x24 & (new_n60_ | x23)));
