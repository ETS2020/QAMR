...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n60_ | x23) & ~x25) | (~x20 & x25);
  ...
  assign z13 = (~new_n68_ & (~x20 | ~x25)) | (x20 & ~x25 & (~x17 | ~x18 | ~x19)) | (x17 & x18 & x19 & ~x20);
  assign new_n68_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign z14 = (~new_n68_ & (~x20 | (~x21 & ~x25))) | (~x20 & (new_n71_ | (~new_n70_ & x21))) | (x20 & x21 & ~x25);
  assign new_n70_ = x17 & x18 & x19;
  assign new_n71_ = x17 & x18 & x19 & ~x21;
  assign z15 = (~new_n68_ & (~x20 | (~x22 & ~x25))) | (~new_n73_ & ~x20) | (x20 & x22 & ~x25);
  assign new_n73_ = (~x22 | (x17 & x18 & x19 & ~x21)) & (~x17 | ~x18 | ~x19 | x21 | x22);
  assign z16 = (~new_n68_ & (~x20 | (~x23 & ~x25))) | (~new_n75_ & ~x20) | (x20 & x23 & ~x25);
  assign new_n75_ = (~x23 | (x17 & x18 & x19 & ~x21 & ~x22)) & (~x17 | ~x18 | ~x19 | x21 | x22 | x23);
  assign z17 = (~new_n68_ & (~x20 | (~x24 & ~x25))) | (~new_n77_ & ~x20) | (x20 & x24 & ~x25);
  assign new_n77_ = (~x24 | (new_n70_ & ~x21 & ~x22 & ~x23)) & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = (~new_n68_ & (~x20 | ~x25)) | (~x20 & (new_n80_ | (~new_n79_ & x25)));
