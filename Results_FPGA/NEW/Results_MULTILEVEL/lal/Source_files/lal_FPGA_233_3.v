...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n56_, new_n57_, new_n62_,
    new_n63_, new_n67_, new_n69_, new_n71_, new_n73_, new_n75_, new_n76_,
  ...
  assign z08 = (~new_n62_ & (~x13 | ~x19)) | (new_n63_ & ~x17 & ~x18 & ~x19);
  ...
  assign new_n69_ = (~x04 | ~x05) & ((~x13 & x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n71_ | (~x13 & ((x17 & x18) ? (x19 & ~x20) : x20)) | (~x19 & x20);
  assign new_n71_ = ~new_n48_ & ((x04 & x05) | x07 | x15);
  assign z14 = new_n71_ | ~new_n73_;
  assign new_n73_ = (x13 | ((~x21 | (x17 & x18 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21))) & (x19 | ~x21);
  assign z15 = new_n71_ | (~new_n75_ & ~x13) | (~x19 & x22);
  assign new_n75_ = (~x22 | (new_n76_ & ~x20 & ~x21)) & (~new_n77_ | x20 | x21 | x22);
  assign new_n76_ = x17 & x18;
  assign new_n77_ = x17 & x18 & x19;
  assign z16 = new_n71_ | (~new_n79_ & ~x13) | (~x19 & x23);
  assign new_n79_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & (~new_n77_ | x22 | x23 | x20 | x21);
  assign z17 = new_n71_ | (~new_n81_ & ~x13) | (~x19 & x24);
  assign new_n81_ = (~x24 | (new_n83_ & ~x21 & ~x22 & ~x23)) & (~new_n82_ | x23 | x24 | x21 | x22);
  assign new_n82_ = x17 & x18 & x19 & ~x20;
  assign new_n83_ = x17 & x18 & ~x20;
  assign z18 = new_n71_ | (~new_n85_ & ~x13) | (~x19 & x25);
  assign new_n85_ = (~x25 | (new_n83_ & new_n86_ & ~x23 & ~x24)) & (~new_n82_ | ~new_n86_ | x23 | x24 | x25);
