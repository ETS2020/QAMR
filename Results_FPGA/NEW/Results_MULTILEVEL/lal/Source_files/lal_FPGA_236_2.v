...
module FAU ( 
  ...
  assign z09 = ~x15 & ~x10 & new_n51_ & ~x07;
  assign z10 = ~x07 & ~x10 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = ~x07 & ~x10 & ~x15 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x07 & new_n65_ & ~x10;
  ...
  assign z14 = x15 | (~x10 & ((~new_n69_ & x21) | new_n51_ | ~new_n71_));
  assign new_n71_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x10 & (new_n74_ | new_n51_ | new_n73_ | x07));
  assign new_n73_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (~x10 & (~new_n76_ | new_n51_ | (~new_n73_ & x23)));
  assign new_n76_ = ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x10 & (new_n78_ | new_n51_ | new_n79_ | x07));
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x10 & (~new_n81_ | new_n51_ | (~new_n79_ & x25)));
