...
module FAU ( 
  ...
  assign z12 = ~x07 & ~x15 & x17 & x18 & ~new_n51_ & ~x19;
  assign z13 = x15 | (~x19 & (new_n51_ | x07 | x20));
  assign z14 = x15 | (~x19 & (new_n51_ | x07 | x21));
  assign z15 = x15 | (~x19 & (new_n51_ | x07 | x22));
  assign z16 = x15 | (~x19 & (new_n51_ | x07 | x23));
  assign z17 = x15 | (~x19 & (new_n51_ | x07 | x24));
  assign z18 = x15 | (~x19 & (new_n51_ | x07 | x25));
endmodule
