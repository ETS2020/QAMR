...
module FAU ( 
  ...
  assign new_n57_ = (x04 | ((~x13 | (x08 & ~x15)) & (~x10 | x15 | ~x00 | ~x08))) & (x10 | ~x13);
  assign z13 = ~new_n59_ & x12;
  assign new_n59_ = (x10 | ~x14) & (x04 | ((~x14 | (x01 & x08)) & (~x08 | ~x10 | ~x15)));
  assign z14 = x12 & ((~x04 & ((x10 & ~x15 & x02 & x08) | (~x08 & x15))) | (~x10 & x15));
  assign z15 = x12 & ((~new_n62_ & ~x04) | (~x10 & ~x14 & x16));
  assign new_n62_ = (x14 | ~x16 | (x08 & ~x15)) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = x12 & x17 & (~x10 | (~x04 & (~x08 | x15)));
  ...
  assign new_n69_ = (x10 | ~x20) & (x04 | ((~x20 | (x08 & ~x15)) & (~x07 | ~x08 | ~x10 | x15)));
endmodule
