...
module FAU ( 
  ...
  assign z02 = ~x11 & x12 & x13 & (x14 | (new_n47_ & x08));
  ...
  assign z12 = x12 & x13 & (~new_n47_ | x00 | ~x08);
  assign z13 = new_n58_ & x12;
  assign new_n58_ = x13 & ((x14 & (~x01 | ~x08 | ~x10)) | (x08 & x10 & x15));
  ...
  assign z16 = x12 & x13 & ((new_n47_ & x04 & x08) | (x17 & (~new_n47_ | ~x08)));
  assign z17 = x12 & x13 & ((new_n47_ & x05 & x08) | (x18 & (~new_n47_ | ~x08)));
  assign z18 = x12 & x13 & ((new_n47_ & x06 & x08) | (x19 & (~new_n47_ | ~x08)));
  assign z19 = x12 & x13 & ((new_n47_ & x07 & x08) | (x20 & (~new_n47_ | ~x08)));
endmodule
