...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n55_, new_n56_, new_n60_, new_n64_, new_n66_;
  ...
  assign new_n55_ = ~x15 & (x18 | (x08 & x10));
  assign new_n56_ = x10 & ~x15 & ~x18;
  assign z13 = x12 & ((x15 & (new_n45_ | x14)) | (x14 & (~new_n45_ | ~x01) & ~x18));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15 & ~x18));
  assign z15 = x12 & (new_n60_ | (new_n56_ & x03 & x08));
  assign new_n60_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & ~x18));
  assign z16 = x12 & ((~new_n55_ & x17) | (new_n56_ & x04 & x08));
  assign z17 = x12 & ((x05 & x08 & x10 & ~x15 & ~x18) | (x15 & x18));
  assign z18 = ~new_n64_ & x12;
  assign new_n64_ = (x18 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15))) & (~x15 | ~x19);
  assign z19 = ~new_n66_ & x12;
  assign new_n66_ = (x18 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15))) & (~x15 | ~x20);
  assign z04 = ~x18;
  assign z06 = x15;
endmodule
