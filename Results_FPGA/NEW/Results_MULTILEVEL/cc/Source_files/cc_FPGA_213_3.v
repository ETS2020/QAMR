...
module FAU ( 
  ...
  assign new_n65_ = (~x04 | ((~x17 | x19) & (~x08 | ~x10 | x15 | x17))) & (~x17 | x19 | (x08 & x10 & ~x15));
  assign z17 = x12 & ~new_n44_ & ((x18 & (~new_n58_ | ~x08)) | (new_n58_ & x05 & x08));
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (~x06 | ((x17 | ~x19) & (~x08 | ~x10 | x15 | x19))) & (x17 | ~x19 | (x08 & x10 & ~x15));
