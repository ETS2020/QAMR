...
module FAU ( 
  ...
  assign new_n56_ = (~x13 | (x15 ? ~x01 : (x08 & x10))) & (~x10 | x15 | ~x00 | ~x08);
  assign z13 = x12 & ((x01 & x15 & (new_n58_ | x14)) | (x14 & ~x15 & (~new_n58_ | ~x01)));
  ...
  assign z16 = x12 & ((~x15 & (new_n58_ ? x04 : x17)) | (x01 & x15 & x17));
  assign z17 = x12 & ((~x15 & (new_n58_ ? x05 : x18)) | (x01 & x15 & x18));
  assign z18 = x12 & ((~x15 & (new_n58_ ? x06 : x19)) | (x01 & x15 & x19));
  assign z19 = x12 & ((~x15 & (new_n58_ ? x07 : x20)) | (x01 & x15 & x20));
endmodule
