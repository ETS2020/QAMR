...
module FAU ( 
  ...
  assign z13 = x12 & ((~x09 & x15 & (new_n58_ | x14)) | (x14 & ~x15 & (~new_n58_ | ~x01)));
  assign new_n58_ = x08 & x10;
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (~x09 & x15 & (~x08 | ~x10)));
  assign z15 = x12 & (new_n61_ | (x10 & ~x15 & x03 & x08));
  assign new_n61_ = ~x14 & x16 & (x15 ? ~x09 : (~x08 | ~x10));
  assign z16 = x12 & ((~x15 & (new_n58_ ? x04 : x17)) | (~x09 & x15 & x17));
  assign z17 = x12 & ((~x15 & (new_n58_ ? x05 : x18)) | (~x09 & x15 & x18));
  assign z18 = x12 & ((~x15 & (new_n58_ ? x06 : x19)) | (~x09 & x15 & x19));
  assign z19 = x12 & ((~x15 & (new_n58_ ? x07 : x20)) | (~x09 & x15 & x20));
endmodule
