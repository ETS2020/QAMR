...
module FAU ( 
  ...
  assign z02 = x10 & ~x11 & x12 & (new_n46_ | x14);
  ...
  assign z11 = x10 & x14;
  assign z12 = x12 & (x10 ? (new_n46_ ? x00 : x13) : (x13 & ~x14));
  assign z13 = x10 & x12 & ((x15 & (x08 | x14)) | ((~x01 | ~x08) & x14));
  ...
  assign z19 = x12 & (x10 ? (new_n46_ ? x07 : x20) : (~x14 & x20));
endmodule
