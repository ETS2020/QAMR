...
module FAU ( 
  ...
  assign new_n56_ = (~x13 | ~x15) & (~x02 | ((~x13 | (x08 & x10)) & (~x10 | x15 | ~x00 | ~x08)));
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (~x15 | (~x14 & (~x08 | ~x10))) & (~x02 | ~x14 | (x01 & x08 & x10));
  ...
  assign new_n63_ = (~x15 | ~x17) & (~x02 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15)));
  assign z17 = ~new_n65_ & x12;
  assign new_n65_ = (~x15 | ~x18) & (~x02 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15)));
  assign z18 = ~new_n67_ & x12;
  assign new_n67_ = (~x15 | ~x19) & (~x02 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15)));
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = (~x15 | ~x20) & (~x02 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15)));
  assign z06 = x15;
endmodule
