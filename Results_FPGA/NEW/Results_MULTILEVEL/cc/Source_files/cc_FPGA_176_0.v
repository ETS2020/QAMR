...
module FAU ( 
  ...
  assign z12 = x12 & (x10 ? (new_n55_ ? x00 : x13) : (x13 & x14));
  ...
  assign z16 = x12 & (x10 ? (new_n55_ ? x04 : x17) : (x14 & x17));
  assign z17 = x12 & (x10 ? (new_n55_ ? x05 : x18) : (x14 & x18));
  assign z18 = x12 & (x10 ? (new_n55_ ? x06 : x19) : (x14 & x19));
  assign z19 = x12 & (x10 ? (new_n55_ ? x07 : x20) : (x14 & x20));
  assign z11 = x14;
endmodule
