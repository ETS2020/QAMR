...
module FAU ( 
  ...
  assign new_n68_ = x09 & ~x10 & ((~x13 & x19 & (x20 ^ x21)) | (~x19 & x21));
  assign z12 = z04 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x13 | ((~x22 | (x20 & ~new_n71_ & x21)) & (~x21 | x22 | ~x19 | ~x20))) & (x19 | ~x22);
  assign new_n71_ = x14 & x23 & new_n61_ & x24;
  assign z13 = z05 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (x19 | ~x23) & (x13 | (x22 ? ((~new_n74_ | ~x19) & (new_n62_ | ~x23)) : ~x23));
  assign new_n74_ = x20 & x21 & (~x23 | (new_n61_ & x15 & x24));
  assign z14 = z06 | (new_n76_ & ~x08);
  assign new_n76_ = x09 & ~x10 & ((~x19 & x24) | (~new_n77_ & ~x13));
  ...
  assign new_n80_ = ~x10 & ((~x19 & x25) | (~x13 & (new_n82_ | (~new_n81_ & x25))));
  assign new_n81_ = new_n66_ & x20 & x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = new_n62_ & x19 & x24 & ~x25 & x22 & x23;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n88_));
  assign new_n84_ = ~x13 & (new_n85_ | (x26 & (~new_n87_ | ~new_n62_ | x18)));
