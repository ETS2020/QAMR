// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:06 2020
...
module FAU ( 
  ...
  assign new_n63_ = x09 & ~x10 & (x19 ? (x20 ? (new_n64_ | ~x21) : x21) : x21);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x21 & (x19 ? (x20 & ~x22) : x22)) | (x19 & x22 & (~x20 | new_n67_ | ~x21)));
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~new_n49_ & ~new_n71_) | (~x08 & x09 & new_n69_ & ~x10);
  assign new_n69_ = x22 & (x19 ? ((x20 & x21 & (new_n70_ | ~x23)) | (x23 & (~x20 | ~x21))) : (x21 & x23));
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign new_n71_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x21 | ((x19 | ~x24) & (~new_n74_ | ~x19 | ~x20))) & (~x19 | ~x24 | (new_n75_ & x20 & x21));
  assign new_n74_ = x22 & x23 & ~x24;
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (new_n78_ | ~x21) & (~x19 | ~x25 | (new_n79_ & new_n80_));
  assign new_n78_ = (x19 | ~x25) & (~x19 | ~x20 | ~x22 | ~x23 | ~x24 | x25);
  assign new_n79_ = x20 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n82_ | new_n84_));
  assign new_n82_ = x21 & ((~x19 & x26) | (new_n83_ & x19 & x20 & x22));
  assign new_n83_ = x23 & x24 & x25 & ~x26;
  assign new_n84_ = x19 & x26 & (~new_n85_ | x18 | ~x20 | ~x21);
