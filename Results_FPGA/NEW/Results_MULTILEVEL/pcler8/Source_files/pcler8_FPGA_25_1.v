...
module FAU ( 
  ...
  assign new_n77_ = x09 & ~x10 & ((~x19 & x24) | (~new_n78_ & x16));
  assign new_n78_ = (~x24 | (new_n62_ & x22 & ~new_n61_ & x23)) & (~new_n62_ | ~x19 | ~x22 | ~x23 | x24);
  assign z15 = z07 | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((~x19 & x25) | (x16 & (new_n82_ | (~new_n81_ & x25))));
  ...
  assign new_n84_ = x16 & (new_n85_ | (x26 & (~new_n87_ | ~new_n62_ | x18)));
