...
module FAU ( 
  ...
  assign new_n69_ = ~new_n49_ & ((x03 & x08) | (new_n70_ & ~x08 & x09 & ~x10));
  ...
  assign new_n74_ = x22 ? (~new_n77_ & (~x19 | ~new_n76_ | ~x20)) : ~new_n75_;
  assign new_n75_ = x23 & x26;
  assign new_n76_ = x21 & (~x23 | (x25 & x26 & x15 & x24));
  assign new_n77_ = x23 & x26 & (~x19 | ~x20 | ~x21);
  assign z14 = z06 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x24 | (x23 & (new_n80_ | ~x26))) & (~new_n72_ | x24 | ~x26 | ~x22 | ~x23);
  assign new_n80_ = x19 & x20 & x21 & x22 & (~x16 | ~x25);
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x25 | (x23 & (new_n83_ | ~x26))) & (~new_n84_ | x25 | ~x26 | ~x23 | ~x24);
  assign new_n83_ = x21 & x22 & x24 & ~x17 & x19 & x20;
  assign new_n84_ = x19 & x20 & x21 & x22;
  assign z16 = z08 | (~x08 & x09 & new_n86_ & ~x10);
  assign new_n86_ = x26 & (~new_n87_ | x18 | ~x19 | ~x20 | ~x21);
