...
module FAU ( 
  ...
  assign new_n61_ = x19 ? (~x26 | (~new_n62_ & x20)) : ~x20;
  assign new_n62_ = x12 & x21 & x22 & x23 & x24 & x25;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & (x19 ? (x26 & (x20 ? (new_n65_ | ~x21) : x21)) : x21);
  assign new_n65_ = x13 & x22 & x23 & x24 & x25;
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (x19 & (~x26 | (x20 & ~new_n68_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x26);
  assign new_n68_ = x14 & x23 & x24 & x25;
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x19 | ~x23) & (~x26 | (x22 ? ((~new_n71_ | ~x19) & (new_n72_ | ~x23)) : ~x23));
  assign new_n71_ = x20 & x21 & (~x23 | (x15 & x24 & x25));
  assign new_n72_ = x20 & x21;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x24 | (x19 & (~x26 | (new_n72_ & new_n75_)))) & (~new_n72_ | ~x19 | ~new_n76_ | x24 | ~x26);
  assign new_n75_ = x22 & x23 & (~x16 | ~x25);
  assign new_n76_ = x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x25 | (x19 & (new_n80_ | ~x26))) & (~new_n81_ | ~new_n79_ | x25 | ~x26);
  assign new_n79_ = x23 & x24;
  assign new_n80_ = x22 & x23 & x24 & ~x17 & x20 & x21;
  assign new_n81_ = x19 & x20 & x21 & x22;
  assign z16 = z08 | (~x08 & x09 & new_n83_ & ~x10);
  assign new_n83_ = x26 & (~new_n84_ | ~new_n72_ | x18 | ~x19);
