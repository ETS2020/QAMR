...
module FAU ( 
  ...
  assign new_n73_ = ~x10 & ((x23 & ((~new_n74_ & x22) | new_n75_ | ~x22)) | (new_n74_ & x22 & ~x23 & ~x25));
  assign new_n74_ = x19 & x20 & x21;
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = x23 ? ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_)) : (~x24 | x25);
  assign new_n78_ = x19 & x20;
  assign new_n79_ = x21 & x22 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x21 & x22 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & ~new_n82_ & x23);
  assign new_n82_ = (~x25 | (new_n74_ & x22 & x24 & (~x17 | ~x26))) & (~new_n74_ | ~x22 | ~x24 | x25);
  assign z16 = z08 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (x25 | ~x26) & (~x23 | ((new_n86_ | ~x26) & (~new_n74_ | ~new_n85_ | ~x25 | x26)));
  assign new_n85_ = x22 & x24;
  assign new_n86_ = x21 & x22 & x24 & ~x18 & x19 & x20;
endmodule
