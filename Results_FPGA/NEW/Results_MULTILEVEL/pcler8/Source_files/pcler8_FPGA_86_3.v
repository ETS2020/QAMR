...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (~x19 | ~x24)) | (~x08 & x09 & ~x10 & ~x19);
  assign z10 = (x01 & ~new_n47_ & x08) | (new_n57_ & ~x08);
  assign new_n57_ = x09 & ~x10 & (x19 ? (~x20 & ~x24) : x20);
  assign z11 = (x02 & ~new_n47_ & x08) | (new_n59_ & ~x08);
  assign new_n59_ = x09 & ~x10 & (x19 ? (~x24 & (x20 ^ x21)) : x21);
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & ((x22 & (~x19 | (~x24 & (~x20 | ~x21)))) | (x19 & x20 & x21 & ~x22 & ~x24));
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x23 | (x19 & (x24 | (x22 & (~x22 | (x20 & x21)))))) & (~x22 | x23 | x24 | ~x19 | ~x20 | ~x21);
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (x19 | ~x24) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x24);
