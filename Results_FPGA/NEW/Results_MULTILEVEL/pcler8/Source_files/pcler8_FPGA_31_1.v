...
module FAU ( 
  ...
  assign z07 = x06 & x08;
  assign z08 = x07 & x08;
  assign z09 = x08 ? x00 : (x09 & ~x10 & ~new_n58_ & ~x14);
  assign new_n58_ = x19 & (~new_n59_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = x08 ? x01 : (x09 & ~x10 & ~new_n61_ & ~x14);
  assign new_n61_ = x19 ? (x20 & (~new_n59_ | ~x12 | ~x21 | ~x22)) : ~x20;
  assign z11 = x08 ? x02 : (new_n63_ & x09);
  assign new_n63_ = ~x10 & ~x14 & (x19 ? (x20 ? (new_n64_ | ~x21) : x21) : x21);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = x08 ? x03 : (new_n66_ & x09);
  assign new_n66_ = ~x10 & ~x14 & ((x22 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign z13 = x08 ? x04 : (x09 & ~x10 & ~new_n68_ & ~x14);
  assign new_n68_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n69_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = x08 ? x05 : (x09 & ~x10 & ~new_n71_ & ~x14);
  assign new_n71_ = (~x24 | (new_n72_ & x22 & ~new_n73_ & x23)) & (~new_n72_ | ~x22 | ~x23 | x24);
  assign new_n72_ = x19 & x20 & x21;
  assign new_n73_ = x16 & x25 & x26;
  assign z15 = x08 ? x06 : (x09 & ~x10 & ~new_n75_ & ~x14);
  ...
  assign new_n78_ = ~x14 & ((new_n81_ & new_n82_) | ((~new_n79_ | ~new_n80_) & x26));
