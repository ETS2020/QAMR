// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:33 2020
...
module FAU ( 
  ...
  assign z02 = x01 & x08 & (x19 | x25);
  assign z03 = x02 & x08 & (x19 | x25);
  assign z04 = x03 & x08 & (x19 | x25);
  assign z05 = x04 & x08 & (x19 | x25);
  assign z06 = x05 & x08 & (x19 | x25);
  assign z07 = x06 & x08 & (x19 | x25);
  assign z08 = x07 & x08 & (x19 | x25);
  assign z09 = z01 | (~x08 & x09 & ~x10 & ~new_n57_ & x25);
  assign new_n57_ = x19 & (~new_n58_ | ~x11 | ~new_n59_ | ~x24 | ~x26);
  assign new_n58_ = x20 & x21;
  assign new_n59_ = x22 & x23;
  assign z10 = z02 | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & (x19 ? (~x20 | (new_n62_ & new_n63_)) : (x20 & x25));
  assign new_n62_ = x12 & x21 & x22;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x19 ? (x20 ? (new_n66_ | ~x21) : x21) : (x21 & x25));
  ...
  assign new_n69_ = x25 & (~x19 | (x14 & x23 & x24 & x26));
  assign z13 = new_n71_ | (~x08 & x09 & ~x10 & ~new_n73_ & x22);
  assign new_n71_ = ~new_n72_ & (x19 | x25);
  assign new_n72_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n73_ = x19 ? ((~x20 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x20 & x21))) : (~x23 | ~x25);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (new_n76_ & ~x08);
  assign new_n76_ = x09 & ~x10 & (new_n79_ | (x24 & (new_n77_ | new_n78_)));
  assign new_n77_ = x25 & (~x19 | (x16 & x26));
  assign new_n78_ = x19 & (~x20 | ~x21 | ~x22 | ~x23);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((x25 & (~new_n82_ | ~new_n59_ | new_n83_ | ~x24)) | (new_n82_ & new_n59_ & x24 & ~x25));
  assign new_n82_ = x19 & x20 & x21;
  assign new_n83_ = x17 & x26;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n85_ | new_n86_));
  assign new_n85_ = x25 & ((~x19 & x26) | (new_n58_ & x19 & new_n59_ & x24 & ~x26));
  assign new_n86_ = x19 & x26 & (~new_n87_ | ~new_n58_ | x18);
