// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:41 2020
...
module FAU ( 
  ...
  assign new_n70_ = x26 & (~x19 | (x14 & x23 & x24 & x25));
  assign z13 = new_n72_ | (~x08 & x09 & ~x10 & ~new_n74_ & x22);
  assign new_n72_ = ~new_n73_ & (x19 | x26);
  assign new_n73_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n74_ = x19 ? ((~x20 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x20 & x21))) : (~x23 | ~x26);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x24 | (~new_n78_ & (~x19 | (new_n59_ & x22 & x23)))) & (~new_n59_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n78_ = x26 & (~x19 | (x16 & x25));
  assign z15 = z07 | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((x25 & (new_n82_ | new_n83_)) | (new_n81_ & new_n84_));
  assign new_n81_ = x19 & x20 & x21;
  assign new_n82_ = x26 & (x17 | ~x19);
  assign new_n83_ = x19 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & new_n86_ & x09);
  assign new_n86_ = ~x10 & ((new_n88_ & new_n89_) | (x26 & (~new_n60_ | ~new_n87_)));
