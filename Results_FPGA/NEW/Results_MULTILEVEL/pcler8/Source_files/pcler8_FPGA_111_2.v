...
module FAU ( 
  ...
  assign z12 = new_n68_ | (~new_n50_ & (x08 ? x03 : new_n69_));
  assign new_n68_ = new_n65_ & new_n66_ & ~x08 & x09 & ~x10 & x14;
  assign new_n69_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign z13 = new_n71_ | (~x08 & x09 & new_n73_ & ~x10);
  assign new_n71_ = ~new_n50_ & (x08 ? x04 : (new_n72_ & x09));
  assign new_n72_ = ~x10 & (x22 ? ((x23 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x23)) : x23);
  assign new_n73_ = x15 & x22 & x24 & x25 & ~new_n74_ & x26;
  assign new_n74_ = (x05 | ~x19 | ~x20 | ~x21) & (~x14 | ~x23);
  assign z14 = (x05 & x08 & x14) | (~x08 & x09 & ~x10 & ~new_n76_ & (~x05 | x14));
  assign new_n76_ = (~x24 | (new_n77_ & x22 & ~new_n78_ & x23)) & (~new_n77_ | ~x22 | ~x23 | x24);
  assign new_n77_ = x19 & x20 & x21;
  assign new_n78_ = x16 & x25 & x26;
  assign z15 = ~new_n50_ & (x08 ? x06 : (x09 & ~new_n80_ & ~x10));
  assign new_n80_ = (~x25 | (new_n77_ & new_n65_ & x24 & (~x17 | ~x26))) & (~new_n77_ | ~new_n65_ | ~x24 | x25);
  assign z16 = ~new_n50_ & (x08 ? x07 : (new_n82_ & x09));
