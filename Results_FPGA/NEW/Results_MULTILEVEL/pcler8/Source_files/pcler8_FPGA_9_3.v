...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n66_,
    new_n68_;
  ...
  assign new_n61_ = ~x10 & ((x22 & (~x21 | (~x25 & (~x19 | ~x20)))) | (x19 & x20 & x21 & ~x22 & ~x25));
  assign z13 = z05 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x23 | (x21 & (x25 | (x22 & ((x19 & x20) | ~x22))))) & (~x22 | x23 | x25 | ~x19 | ~x20 | ~x21);
  assign z14 = z06 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x24 | (x21 & (x25 | (new_n66_ & x19 & x20)))) & (~x19 | ~x20 | ~x21 | ~new_n66_ | x24 | x25);
  assign new_n66_ = x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (x21 | ~x25) & (~x19 | ~x20 | ~x21 | ~new_n66_ | ~x24 | x25);
