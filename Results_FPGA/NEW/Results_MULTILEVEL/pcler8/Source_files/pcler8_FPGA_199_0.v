// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:49 2020
...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n60_ & x19);
  assign new_n60_ = x20 & (~new_n61_ | ~x12 | ~x21 | ~x22);
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n63_ & x19);
  assign new_n63_ = x20 ? (x21 & (~new_n58_ | ~x13 | ~x22 | ~x23)) : ~x21;
  assign z12 = (x03 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n65_ & x19);
  assign new_n65_ = (~x22 | (x20 & x21 & (~new_n58_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n67_ & x19);
  assign new_n67_ = x22 ? ((~x20 | ~x21 | (~new_n68_ & x23)) & (~x23 | (x20 & x21))) : ~x23;
  assign new_n68_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n70_ & x19);
  assign new_n70_ = (~x24 | (x20 & x21 & x22 & ~new_n71_ & x23)) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n71_ = x16 & x25 & x26;
  assign z15 = (x06 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n73_ & x19);
  assign new_n73_ = (~x25 | (new_n74_ & x23 & x24 & (~x17 | ~x26))) & (~new_n74_ | ~x23 | ~x24 | x25);
  assign new_n74_ = x20 & x21 & x22;
  assign z16 = (x07 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n76_ & x19);
  assign new_n76_ = (~x26 | (new_n77_ & new_n78_)) & (~new_n74_ | ~new_n79_);
  assign new_n77_ = ~x18 & x20 & x21;
