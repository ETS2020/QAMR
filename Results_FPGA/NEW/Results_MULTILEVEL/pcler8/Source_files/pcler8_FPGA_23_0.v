...
module FAU ( 
  ...
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (x19 & ~x20 & x25));
  assign new_n62_ = x12 & x21 & x22;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (x19 ? (new_n66_ | ~x21) : x21) : (x21 & x25));
  ...
  assign new_n69_ = x25 & (~x20 | (x14 & x23 & x24 & x26));
  assign z13 = new_n71_ | (~x08 & x09 & ~x10 & ~new_n73_ & x22);
  assign new_n71_ = ~new_n72_ & (x20 | x25);
  assign new_n72_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n73_ = x20 ? ((~x19 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x19 & x21))) : (~x23 | ~x25);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~x10 & (new_n76_ | new_n78_));
  assign new_n76_ = x24 & ((x25 & (~x20 | (x16 & x26))) | (~new_n77_ & x20));
  ...
  assign new_n81_ = (~x25 | (new_n79_ & new_n82_ & x24 & (~x17 | ~x26))) & (~new_n79_ | ~new_n82_ | ~x24 | x25);
  assign new_n82_ = x22 & x23;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n85_));
  assign new_n84_ = x25 & ((~x20 & x26) | (new_n79_ & new_n82_ & x24 & ~x26));
  assign new_n85_ = x20 & x26 & (~new_n86_ | x18 | ~x19 | ~x21);
