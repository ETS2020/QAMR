...
module FAU ( 
  ...
  assign new_n65_ = new_n66_ & new_n48_ & ~x10 & x13 & x19;
  assign new_n66_ = x20 & x22 & x23 & x24 & x25 & x26;
  assign new_n67_ = x09 & ~x10 & (x19 ? (x20 ^ x21) : x21);
  assign z12 = new_n69_ | (~new_n50_ & (x08 ? x03 : new_n71_));
  assign new_n69_ = new_n70_ & new_n48_ & ~x10 & x14;
  assign new_n70_ = x22 & x23 & x24 & x25 & x26;
  assign new_n71_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x21 & ~x22 & x19 & x20));
  assign z13 = z05 | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((x23 & ((~new_n74_ & x22) | new_n75_ | ~x22)) | (new_n74_ & x22 & ~x23 & ~x26));
  assign new_n74_ = x19 & x20 & x21;
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = x23 ? ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_)) : (~x24 | x26);
  assign new_n78_ = x19 & x20;
  assign new_n79_ = x21 & x22 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x21 & x22 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = x23 ? ((~x25 | (new_n74_ & new_n83_)) & (~new_n74_ | ~new_n84_)) : (~x25 | x26);
  assign new_n83_ = x22 & x24 & (~x17 | ~x26);
  assign new_n84_ = x22 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & ~new_n86_ & x23);
  assign new_n86_ = (~new_n74_ | ~new_n88_) & (~x26 | (new_n87_ & new_n78_ & ~x18));
  assign new_n87_ = x21 & x22 & x24 & x25;
  assign new_n88_ = x22 & x24 & x25 & ~x26;
endmodule
