...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (~x19 | (new_n64_ & new_n65_))) | (x16 & x19 & ~x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x20 & (x19 ? (new_n68_ | ~x21) : x21)) | (x16 & ~x20 & x21));
  assign new_n68_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x20 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x19 | ~x21 | x22))) & (~x16 | x20 | ~x22);
  ...
  assign new_n75_ = (~x16 | x20 | ~x23) & (~x20 | ((~x19 | ~x21 | (~new_n76_ & x23)) & (~x23 | (x19 & x21))));
  assign new_n76_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~x10 & (new_n78_ | new_n80_));
  assign new_n78_ = x24 & ((x16 & (new_n61_ | ~x20)) | (~new_n79_ & x20));
  assign new_n79_ = x19 & x21 & x22 & x23;
  assign new_n80_ = x22 & x23 & ~x24 & x19 & x20 & x21;
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x20 | ((~x25 | (new_n83_ & new_n84_)) & (~new_n83_ | ~new_n85_))) & (~x16 | x20 | ~x25);
