...
module FAU ( 
  ...
  assign z11 = new_n65_ | (~new_n49_ & (x08 ? x02 : new_n67_));
  assign new_n65_ = new_n66_ & ~x08 & x09 & ~x10 & x13 & x19;
  assign new_n66_ = x20 & x22 & x23 & x24 & x25 & x26;
  assign new_n67_ = x09 & ~x10 & (x19 ? (x20 ^ x21) : x21);
  assign z12 = new_n69_ | (~new_n49_ & (x08 ? x03 : new_n71_));
  assign new_n69_ = new_n70_ & ~x08 & x09 & ~x10 & x14;
  ...
  assign new_n73_ = x22 ? ((~x19 | ~x20 | ~new_n74_ | ~x21) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n74_ = x25 & (~x23 | (x15 & x24 & x26));
  assign z14 = z06 | (~x08 & x09 & ~x10 & (new_n76_ | new_n78_));
  assign new_n76_ = x24 & ((~new_n77_ & x23) | (x25 & (~x23 | (x16 & x26))));
  ...
  assign new_n81_ = ~x10 & ((x25 & (~new_n79_ | ~new_n82_ | new_n83_ | ~x24)) | (new_n79_ & new_n82_ & x24 & ~x25));
  assign new_n82_ = x22 & x23;
  assign new_n83_ = x17 & x26;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n85_ | new_n86_));
  assign new_n85_ = x25 & ((~x23 & x26) | (new_n79_ & x22 & x23 & x24 & ~x26));
  assign new_n86_ = x23 & x26 & (~new_n87_ | x18 | ~x19 | ~x20);
