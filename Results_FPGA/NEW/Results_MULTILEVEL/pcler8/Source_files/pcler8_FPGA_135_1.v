// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:34 2020
...
module FAU ( 
  ...
  assign z09 = (~new_n59_ & (x18 | ~x20)) | (new_n61_ & new_n60_ & x11 & x18 & x20);
  ...
  assign new_n63_ = x09 & ~x10 & ((x18 & x20 & (new_n64_ | ~x19)) | (x19 & ~x20));
  ...
  assign new_n73_ = x09 & ~x10 & ((~x20 & x23) | (~new_n74_ & x18));
  ...
  assign new_n78_ = x18 & (new_n80_ | (x24 & (~new_n79_ | ~x19 | ~x21)));
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((~x20 & x25) | (x18 & (new_n84_ | (~new_n83_ & x25))));
  assign new_n83_ = new_n65_ & x19 & x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = new_n85_ & x19 & x20 & x21;
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign z16 = new_n87_ | (new_n88_ & new_n48_ & ~x10 & x18 & x19);
  assign new_n87_ = ~new_n50_ & ((x07 & x08) | (~x10 & x26 & ~x08 & x09));
  assign new_n88_ = new_n65_ & x20 & x23 & x24 & x25;
endmodule
