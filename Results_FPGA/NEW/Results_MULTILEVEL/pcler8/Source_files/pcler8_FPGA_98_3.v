...
module FAU ( 
  ...
  assign z10 = (new_n64_ & ~x08) | (x01 & x08 & ~x20);
  assign new_n64_ = x09 & ~x10 & ((~x01 & x20 & (new_n65_ | ~x19)) | (x19 & ~x20));
  assign new_n65_ = new_n66_ & x12 & x25 & x26 & x23 & x24;
  assign new_n66_ = x21 & x22;
  assign z11 = (x02 & x08 & (~x01 | (x01 & ~x20))) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((~x01 & x20 & (x19 ? (new_n69_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n69_ = new_n60_ & x13 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x20 | ~x22) & (x01 | ((~x22 | (x19 & ~new_n72_ & x21)) & (~x21 | x22 | ~x19 | ~x20)));
  assign new_n72_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (new_n74_ & ~x08);
  assign new_n74_ = x09 & ~x10 & ((~new_n75_ & ~x01) | (~x20 & x23));
  ...
  assign new_n78_ = (x20 | ~x24) & (x01 | (~new_n81_ & ((new_n79_ & new_n80_) | ~x24)));
  ...
  assign new_n83_ = ~x10 & ((~x20 & x25) | (~x01 & (new_n85_ | (~new_n84_ & x25))));
  ...
  assign new_n87_ = ~x01 & (new_n88_ | (new_n89_ & new_n66_ & x19 & x20));
