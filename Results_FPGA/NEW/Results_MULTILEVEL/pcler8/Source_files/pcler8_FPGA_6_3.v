// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:03 2020
...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n60_, new_n61_, new_n62_,
    new_n64_, new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n73_,
  ...
  assign new_n48_ = x19 & ~x13 & ~x10 & ~x08 & x09;
  assign z01 = new_n50_ & x00;
  assign new_n50_ = x08 & (~x13 | ~x20);
  ...
  assign z09 = (~new_n61_ & (~x13 | ~x20)) | (new_n59_ & new_n62_ & x11 & ~x13 & x20);
  ...
  assign new_n64_ = x09 & ~x10 & ((~x13 & x20 & (new_n65_ | ~x19)) | (x19 & ~x20));
  assign new_n65_ = new_n66_ & x12 & x25 & x26 & x23 & x24;
  assign new_n66_ = x21 & x22;
  assign z11 = z03 | (new_n68_ & ~x08);
  assign new_n68_ = x09 & ~x10 & ((~x20 & x21) | (~x13 & x20 & (x19 ^ x21)));
  assign z12 = z04 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x20 | ~x22) & (x13 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x21 | x22 | ~x19 | ~x20)));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (new_n73_ & ~x08);
  assign new_n73_ = x09 & ~x10 & ((~x20 & x23) | (~new_n74_ & ~x13));
  ...
  assign new_n77_ = (x20 | ~x24) & (x13 | (~new_n80_ & ((new_n78_ & new_n79_) | ~x24)));
  ...
  assign new_n82_ = ~x10 & ((~x20 & x25) | (~x13 & (new_n84_ | (~new_n83_ & x25))));
  assign new_n83_ = new_n66_ & x19 & x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x19 & x20 & x21 & new_n60_ & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n89_));
  assign new_n86_ = ~x13 & (new_n87_ | (new_n88_ & new_n66_ & x19 & x20));
  assign new_n87_ = x26 & (~new_n78_ | x18 | ~new_n60_ | ~x24 | ~x25);
