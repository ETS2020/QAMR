...
module FAU ( 
  ...
  assign new_n62_ = (~new_n63_ | ~new_n64_) & ((x21 & (~x21 | ~x23)) | (~x19 ^ x20));
  assign new_n63_ = x12 & x19 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & (x19 ? (x20 ? (new_n67_ | ~x21) : (x21 & x23)) : (x21 & x23));
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (x21 & (~x23 | (x19 & ~new_n70_ & x20)))) & (~x19 | ~x20 | ~x21 | x22 | ~x23);
  assign new_n70_ = x14 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~x10 & ~new_n72_ & x23);
  assign new_n72_ = (new_n73_ | ~x22) & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n73_ = x19 & x20 & x21;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x23 | ((~x24 | (new_n76_ & ~new_n77_ & x22)) & (~new_n76_ | ~x21 | ~x22 | x24))) & (x21 | ~x24);
  ...
  assign new_n83_ = (x21 | ~x26) & (~x23 | ((new_n84_ | ~x26) & (~new_n73_ | ~new_n85_)));
  assign new_n84_ = x22 & x24 & x25 & ~x18 & x19 & x20;
