...
module FAU ( 
  ...
  assign new_n76_ = ~x20 & ((x05 & x08) | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n82_ | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~new_n73_ | ~new_n81_) & (~x25 | (new_n79_ & new_n80_));
  assign new_n79_ = x19 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x20 & ((x06 & x08) | (~x08 & x09 & ~x10 & x25));
  assign z16 = (~x20 & ((x07 & x08) | (new_n89_ & ~x08 & x09))) | (~x08 & new_n84_ & x09);
