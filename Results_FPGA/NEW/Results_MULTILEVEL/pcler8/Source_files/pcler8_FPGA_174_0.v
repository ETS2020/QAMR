...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (x02 | x20)) | (~x08 & new_n61_ & x09);
  ...
  assign z12 = (x02 & (new_n71_ | (x03 & x08))) | (x20 & (x08 ? x03 : new_n69_));
  ...
  assign new_n73_ = ~new_n74_ & (x02 | x20);
  assign new_n74_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n75_ = (~x20 | ((~x19 | ~x21 | (~new_n76_ & x23)) & (~x23 | (x19 & x21)))) & (~x02 | x20 | ~x23);
