...
module FAU ( 
  ...
  assign new_n69_ = (~x20 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x21 | x22))) & (~x15 | x20 | ~x22);
  ...
  assign new_n74_ = (~x15 | ((x20 | ~x23) & (~new_n60_ | ~x19 | ~x20 | ~x21))) & (~x20 | ((~x19 | ~x21 | x23) & (~x23 | (x19 & x21))));
  ...
  assign new_n81_ = (~x20 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_))) & (~x15 | x20 | ~x25);
