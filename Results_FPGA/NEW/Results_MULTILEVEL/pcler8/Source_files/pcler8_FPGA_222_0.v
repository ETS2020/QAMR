...
module FAU ( 
  ...
  assign z06 = x05 & x08;
  assign z07 = x06 & x08 & (x20 | (x05 & (~x19 | ~x20)));
  ...
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (x05 & x19 & ~x20));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x20 & (x19 ? (new_n67_ | ~x21) : x21)) | (x05 & ~x20 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x20 | ((~x19 | ~x21 | x22) & (~x22 | (x19 & ~new_n70_ & x21)))) & (~x05 | x20 | ~x22);
  ...
  assign new_n74_ = (~x05 | x20 | ~x23) & (~x20 | ((~x19 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x19 & x21))));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = new_n79_ | (~x08 & x09 & ~x10 & ~new_n77_ & x20);
  assign new_n77_ = (~x24 | (x19 & x21 & x22 & ~new_n78_ & x23)) & (~x19 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = x05 & (x08 | (~x20 & x24 & x09 & ~x10));
  assign z15 = new_n81_ | (x20 & (x08 ? x06 : (new_n83_ & x09)));
  assign new_n81_ = ~new_n82_ & x05;
  assign new_n82_ = (~x06 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x25);
  ...
  assign new_n89_ = ~x10 & ((x26 & (~new_n90_ | ~new_n91_)) | (new_n84_ & new_n92_));
