...
module FAU ( 
  ...
  assign new_n62_ = x09 & ~x10 & (x20 ? (x25 & (new_n63_ | ~x19)) : x19);
  assign new_n63_ = x12 & x21 & x22 & x23 & x24 & x26;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (x25 & (x19 ? (new_n66_ | ~x21) : x21)) : x21);
  assign new_n66_ = x13 & x22 & x23 & x24 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x22 | (x20 & (~x25 | (x19 & ~new_n69_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x25);
  assign new_n69_ = x14 & x23 & x24 & x26;
  assign z13 = z05 | (~x08 & x09 & ~x10 & (new_n71_ | new_n73_));
  assign new_n71_ = x25 & (x22 ? ((new_n72_ & x19) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n72_ = x20 & x21 & (~x23 | (x15 & x24 & x26));
  assign new_n73_ = ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x24 | (x20 & (new_n77_ | ~x25))) & (~new_n78_ | ~new_n76_ | x24 | ~x25);
  assign new_n76_ = x22 & x23;
  assign new_n77_ = x19 & x21 & x22 & x23 & (~x16 | ~x26);
  assign new_n78_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & x09 & ~x10 & ~new_n80_ & x25);
  assign new_n80_ = new_n78_ & new_n76_ & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x25 | ((new_n83_ | ~x26) & (~new_n78_ | ~new_n84_))) & (x20 | ~x26);
  assign new_n83_ = x22 & x23 & x24 & ~x18 & x19 & x21;
  assign new_n84_ = x22 & x23 & x24 & ~x26;
endmodule
