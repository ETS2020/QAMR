// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:58 2020
...
module FAU ( 
  ...
  assign new_n58_ = (x19 | x22) & (~new_n59_ | ~x11 | ~x19 | ~new_n60_ | ~x22 | ~x23);
  ...
  assign new_n65_ = ~x10 & (x19 ? (x20 ? (new_n66_ | ~x21) : x21) : (x21 & ~x22));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~x10 & ~new_n68_ & x19);
  assign new_n68_ = (~x22 | (x20 & x21 & (~new_n60_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x19 | ~x22 | ((~x20 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x20 & x21)))) & (x22 | ~x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x19 | ((~x24 | (new_n59_ & ~new_n74_ & x23)) & (~new_n59_ | ~x22 | ~x23 | x24))) & (x22 | ~x24);
  assign new_n74_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & ((~x22 & x25) | (x19 & (new_n78_ | (~new_n77_ & x25))));
  assign new_n77_ = x20 & x21 & x23 & x24 & (~x17 | ~x26);
  assign new_n78_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (x22 | ~x26) & (~x19 | ((new_n82_ | ~x26) & (~new_n81_ | ~new_n83_)));
  assign new_n81_ = x20 & x21 & x22;
  assign new_n82_ = x23 & x24 & x25 & ~x18 & x20 & x21;
