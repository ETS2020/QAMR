...
module FAU ( 
  ...
  assign z09 = (x00 & ~new_n61_ & x08) | (~x08 & new_n58_ & x09);
  assign new_n58_ = ~x10 & ((~x07 & ~x19) | (new_n60_ & new_n59_ & x11 & x19));
  assign new_n59_ = x20 & x21;
  assign new_n60_ = x22 & x23 & x24 & x25 & x26;
  assign new_n61_ = x07 & (~x07 | ~x19);
  assign z10 = z02 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x19 & (~x20 | (new_n64_ & new_n65_))) | (~x07 & ~x19 & x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x19 & (x20 ? (new_n68_ | ~x21) : x21)) | (~x07 & ~x19 & x21));
  assign new_n68_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x19 | ((~x22 | (x20 & ~new_n71_ & x21)) & (~x20 | ~x21 | x22))) & (x07 | x19 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n73_ | (~x08 & x09 & ~x10 & ~new_n75_ & x22);
  assign new_n73_ = ~new_n74_ & (~x07 | x19);
  assign new_n74_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n75_ = (x07 | x19 | ~x23) & (~x19 | ((~x20 | ~x21 | (~new_n76_ & x23)) & (~x23 | (x20 & x21))));
  assign new_n76_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (x07 | x19 | ~x24) & (~x19 | ((~x24 | (new_n59_ & new_n79_)) & (~new_n59_ | ~new_n80_)));
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n61_ & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x07 | x19 | ~x25) & (~x19 | ((~x25 | (new_n83_ & new_n84_)) & (~new_n83_ | ~new_n85_)));
