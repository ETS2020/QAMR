...
module FAU ( 
  ...
  assign new_n62_ = x20 & (~x19 | (new_n60_ & new_n59_ & x12));
  assign z11 = z03 | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & (x19 ? (x20 & (new_n65_ | ~x21)) : x21);
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x20 & ((x22 & (new_n68_ | ~x21)) | (x19 & x21 & ~x22))) | (~x19 & x22));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x20 | (x22 ? ((x21 | ~x23) & (~x19 | ~x21 | (~new_n71_ & x23))) : ~x23)) & (x19 | ~x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((~x19 & x24) | (x20 & (new_n75_ | (~new_n74_ & x24))));
  assign new_n74_ = x21 & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x19 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n77_ & x09);
  assign new_n77_ = ~x10 & ((~x19 & x25) | (x20 & (new_n79_ | (~new_n78_ & x25))));
  assign new_n78_ = x21 & x22 & x23 & x24 & (~x17 | ~x26);
  ...
  assign new_n82_ = x23 & x24 & x25 & ~x18 & x21 & x22;
