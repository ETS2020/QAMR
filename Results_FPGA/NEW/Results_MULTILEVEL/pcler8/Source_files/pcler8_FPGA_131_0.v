...
module FAU ( 
  ...
  assign z02 = x01 & x08;
  assign z03 = x02 & x08 & (x20 | (x01 & (~x19 | ~x20)));
  ...
  assign z10 = new_n63_ | (~x08 & x09 & ~x10 & ~new_n61_ & x20);
  assign new_n61_ = x19 & (~new_n62_ | ~x12 | ~x21 | ~x22);
  assign new_n62_ = x23 & x24 & x25 & x26;
  assign new_n63_ = x01 & (x08 | (x09 & ~x10 & x19 & ~x20));
  assign z11 = (x01 & (new_n67_ | (x02 & x08))) | (x20 & (x08 ? x02 : new_n65_));
