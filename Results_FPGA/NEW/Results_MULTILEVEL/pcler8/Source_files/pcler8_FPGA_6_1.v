...
module FAU ( 
  ...
  assign new_n60_ = ~x08 & x09 & ~x10 & x11 & x13 & x20;
  ...
  assign new_n68_ = x09 & ~x10 & ((x13 & ~new_n69_ & x20) | (~x20 & x21));
  assign new_n69_ = (~x19 | ((~new_n61_ | ~new_n62_) & x21)) & (~x21 | (x19 & (~new_n62_ | ~new_n61_ | ~x12)));
  assign z12 = z04 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x13 | ((~x22 | (x19 & ~new_n72_ & x21)) & (~x21 | x22 | ~x19 | ~x20))) & (x20 | ~x22);
  assign new_n72_ = new_n62_ & x14 & x23;
  assign z13 = z05 | (new_n74_ & ~x08);
  assign new_n74_ = x09 & ~x10 & ((~x20 & x23) | (~new_n75_ & x13));
  ...
  assign new_n78_ = (x20 | ~x24) & (~x13 | (~new_n81_ & ((new_n79_ & new_n80_) | ~x24)));
  ...
  assign new_n83_ = ~x10 & ((~x20 & x25) | (x13 & (new_n85_ | (~new_n84_ & x25))));
  assign new_n84_ = new_n66_ & x19 & x23 & x24 & (~x17 | ~x26);
  assign new_n85_ = x19 & x20 & x21 & new_n61_ & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n87_ | new_n90_));
  assign new_n87_ = x13 & (new_n88_ | (new_n89_ & new_n66_ & x19 & x20));
  assign new_n88_ = x26 & (~new_n79_ | x18 | ~new_n61_ | ~x24 | ~x25);
