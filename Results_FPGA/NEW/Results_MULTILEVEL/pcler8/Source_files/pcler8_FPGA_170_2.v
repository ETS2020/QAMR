...
module FAU ( 
  ...
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (~x04 & x19 & ~x20));
  ...
  assign new_n73_ = x23 & ((~x04 & (~x22 | (~x20 & x22))) | (x20 & (~x22 | (x22 & (~x19 | ~x21)))));
