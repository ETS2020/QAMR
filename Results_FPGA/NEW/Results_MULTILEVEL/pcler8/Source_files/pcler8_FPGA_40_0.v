...
module FAU ( 
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n64_ | ~new_n63_ | ~x23 | ~x24))) & (~x19 | x20 | ~x23);
  ...
  assign new_n76_ = ~new_n77_ & (~x20 | ~x24 | (new_n78_ & x19 & x21));
  assign new_n77_ = x23 & ((~x20 & x24) | (x19 & x20 & x21 & x22 & ~x24));
  ...
  assign new_n85_ = x23 & ((~x20 & x26) | (new_n86_ & x19 & x20 & x21));
