...
module FAU ( 
  ...
  assign new_n74_ = (x15 | x20 | ~x23) & (~x20 | ((~x19 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x19 & x21))));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x15 | x20 | ~x24) & (~x20 | ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_)));
  assign new_n78_ = x19 & x21;
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x15 | x20 | ~x25) & (~x20 | ((~x25 | (new_n83_ & new_n84_)) & (~new_n83_ | ~new_n85_)));
