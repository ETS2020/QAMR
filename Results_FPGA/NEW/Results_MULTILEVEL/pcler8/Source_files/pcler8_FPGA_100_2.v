...
module FAU ( 
  ...
  assign new_n75_ = x23 & x25;
  assign new_n76_ = x21 & (~x23 | (x25 & x26 & x15 & x24));
  assign new_n77_ = x23 & x25 & (~x19 | ~x20 | ~x21);
  assign z14 = z06 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x24 | (x23 & (new_n80_ | ~x25))) & (~new_n72_ | x24 | ~x25 | ~x22 | ~x23);
  assign new_n80_ = x19 & x20 & x21 & x22 & (~x16 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~x10 & ~new_n82_ & x25);
  assign new_n82_ = new_n72_ & x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (~x25 | ((new_n85_ | ~x26) & (~new_n72_ | ~new_n86_))) & (x23 | ~x26);
