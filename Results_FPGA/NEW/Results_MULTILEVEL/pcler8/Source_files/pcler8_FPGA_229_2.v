...
module FAU ( 
  ...
  assign new_n62_ = x09 & ~x10 & (x20 ? (x23 & (new_n63_ | ~x19)) : x19);
  ...
  assign new_n68_ = (~x22 | (x20 & (~x23 | (x19 & ~new_n69_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x23);
  assign new_n69_ = x14 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~x10 & ~new_n71_ & x23);
  assign new_n71_ = (new_n72_ | ~x22) & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n72_ = x19 & x20 & x21;
  assign z14 = z06 | (~x08 & new_n74_ & x09);
  assign new_n74_ = ~x10 & ((x23 & (new_n76_ | (~new_n75_ & x24))) | (~x20 & x24));
  assign new_n75_ = x19 & x21 & x22 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21 & x22 & ~x24;
  assign z15 = z07 | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((x23 & (new_n80_ | (~new_n79_ & x25))) | (~x20 & x25));
  assign new_n79_ = x19 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n80_ = x19 & x20 & x21 & x22 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x20 | ~x26) & (~x23 | ((new_n83_ | ~x26) & (~new_n72_ | ~new_n84_)));
