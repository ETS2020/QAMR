// Benchmark "FAU" written by ABC on Thu Aug  6 18:50:03 2020
...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (~x19 | (new_n64_ & new_n65_))) | (~x13 & x19 & ~x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x20 | (x19 ? (x21 & (~new_n61_ | ~new_n60_ | ~x13)) : ~x21)) & (x13 | x20 | ~x21);
  ...
  assign new_n74_ = (x13 | x20 | ~x23) & (~x20 | ((~x19 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x19 & x21))));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x13 | x20 | ~x24) & (~x20 | ((~new_n78_ | ~new_n80_) & (~x24 | (new_n78_ & new_n79_))));
  assign new_n78_ = x19 & x21;
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x13 | x20 | ~x25) & (~x20 | ((~new_n83_ | ~new_n85_) & (~x25 | (new_n83_ & new_n84_))));
