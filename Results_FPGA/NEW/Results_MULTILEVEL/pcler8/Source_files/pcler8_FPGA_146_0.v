// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:36 2020
...
module FAU ( 
  ...
  assign z13 = new_n73_ | (new_n75_ & new_n48_ & ~x10 & x15 & x19);
  assign new_n73_ = ~new_n50_ & (x08 ? x04 : (new_n74_ & x09));
  assign new_n74_ = ~x10 & (x22 ? ((x23 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x23)) : x23);
  assign new_n75_ = x20 & x21 & x22 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (~new_n78_ & (~x16 | ~x24 | ~x26))) & (new_n79_ | ~x24);
  assign new_n78_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign new_n79_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x25 | (new_n83_ & new_n82_ & x24 & (~x17 | ~x26))) & (~new_n83_ | ~new_n82_ | ~x24 | x25);
  assign new_n82_ = x22 & x23;
  assign new_n83_ = x19 & x20 & x21;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n85_ | new_n86_));
  assign new_n85_ = x25 & ((~x24 & x26) | (new_n83_ & new_n82_ & x24 & ~x26));
  assign new_n86_ = x24 & x26 & (~new_n87_ | x18 | ~x19 | ~x20);
  assign new_n87_ = x21 & x22 & x23 & x25;
endmodule
