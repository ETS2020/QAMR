...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & (x19 ? (x20 ? (x23 & (new_n66_ | ~x21)) : x21) : x21);
  assign new_n66_ = x13 & x22 & x24 & x25 & x26;
  assign z12 = (~new_n49_ & (x08 ? x03 : new_n68_)) | (new_n70_ & ~x08);
  assign new_n68_ = x09 & ~x10 & ~new_n69_ & x22;
  assign new_n69_ = x19 & x20;
  assign new_n70_ = x09 & ~x10 & ((new_n71_ & x22) | (new_n69_ & x21 & ~x22));
  assign new_n71_ = x23 & (~x21 | (x25 & x26 & x14 & x24));
  ...
  assign new_n76_ = (~x23 | ((x21 | ~x24) & (~new_n69_ | ~x21 | ~x22 | x24))) & (~x21 | ~x24 | (new_n69_ & x22 & ~new_n77_ & x23));
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (new_n80_ | ~x23) & (~x21 | ~x25 | (new_n81_ & new_n82_ & x23));
  assign new_n80_ = (x21 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x24 | x25);
  assign new_n81_ = x19 & x20 & x22;
  assign new_n82_ = x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n86_));
  assign new_n84_ = x23 & ((~x21 & x26) | (new_n85_ & x19 & x20 & x21));
  assign new_n85_ = x22 & x24 & x25 & ~x26;
  assign new_n86_ = x21 & x26 & (~new_n87_ | ~new_n69_ | x18);
