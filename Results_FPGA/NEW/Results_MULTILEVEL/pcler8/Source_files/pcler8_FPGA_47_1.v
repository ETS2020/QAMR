...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x19 & (x20 ? (~x21 & ~x24) : x21)) | (x21 & (new_n66_ | ~x19)));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = x21 ? ((~x22 | (x19 & ~new_n69_ & x20)) & (~x19 | ~x20 | x22)) : (~x22 | x24);
  ...
  assign new_n73_ = x21 ? ((~x19 | ~x20 | (~new_n74_ & x23)) & (~x23 | (x19 & x20))) : (~x23 | x24);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~x10 & ~new_n76_ & x21);
  assign new_n76_ = (~x24 | (x19 & x20 & x22 & ~new_n77_ & x23)) & (~x19 | ~x20 | ~x22 | ~x23 | x24);
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x24 | ~x25) & (~x21 | ((new_n80_ | ~x25) & (~new_n81_ | ~x23 | ~x24 | x25)));
  assign new_n80_ = x19 & x20 & x22 & x23 & (~x17 | ~x26);
  assign new_n81_ = x19 & x20 & x22;
  assign z16 = z08 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x24 | ~x26) & (~x21 | ((new_n84_ | ~x26) & (~new_n81_ | ~new_n85_)));
