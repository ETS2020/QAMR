...
module FAU ( 
  ...
  assign new_n74_ = x26 & (~x23 | (x15 & x24 & x25));
  ...
  assign new_n81_ = (~x25 | (~new_n83_ & ~new_n84_)) & (~new_n79_ | ~new_n82_ | ~x24 | x25);
  assign new_n82_ = x22 & x23;
  assign new_n83_ = x26 & (x17 | ~x23);
  assign new_n84_ = x23 & (~x19 | ~x20 | ~x21 | ~x22 | ~x24);
  assign z16 = z08 | (~x08 & new_n86_ & x09);
  assign new_n86_ = ~x10 & ((new_n77_ & new_n89_) | (x26 & (~new_n87_ | ~new_n88_)));
