// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:31 2020
...
module FAU ( 
  ...
  assign new_n62_ = x09 & ~x10 & (x20 ? (x22 & (new_n63_ | ~x19)) : x19);
  assign new_n63_ = x24 & x25 & x26 & x12 & x21 & x23;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (x22 & (x19 ? (new_n66_ | ~x21) : x21)) : x21);
  assign new_n66_ = x13 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~x10 & ~new_n68_ & x22);
  assign new_n68_ = x19 & x20 & x21 & (~new_n60_ | ~x14 | ~x23);
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x22 | ((~x19 | ~x20 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x21)))) & (x20 | ~x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((x22 & (new_n75_ | (~new_n74_ & x24))) | (~x20 & x24));
  assign new_n74_ = x19 & x21 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x19 & x20 & x21 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n77_ & x09);
  assign new_n77_ = ~x10 & ((x22 & (new_n79_ | (~new_n78_ & x25))) | (~x20 & x25));
  assign new_n78_ = x19 & x21 & x23 & x24 & (~x17 | ~x26);
  assign new_n79_ = x19 & x20 & x21 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x20 | ~x26) & (~x22 | ((new_n83_ | ~x26) & (~new_n82_ | ~new_n84_)));
  assign new_n82_ = x19 & x20 & x21;
  assign new_n83_ = x23 & x24 & x25 & ~x18 & x19 & x21;
