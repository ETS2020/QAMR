...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x02 | (x02 & x19))) | (~x08 & new_n61_ & x09);
  ...
  assign new_n65_ = ~x10 & ((x19 & (x20 ? (new_n66_ | ~x21) : x21)) | (~x02 & ~x19 & x21));
  ...
  assign new_n72_ = ~new_n73_ & (~x02 | x19);
  assign new_n73_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n74_ = (~x19 | ((~x20 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x20 & x21)))) & (x02 | x19 | ~x23);
