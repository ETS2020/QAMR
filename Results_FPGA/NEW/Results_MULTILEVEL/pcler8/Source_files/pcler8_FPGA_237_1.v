...
module FAU ( 
  ...
  assign new_n58_ = ~x10 & ((~x19 & ~x20) | (new_n59_ & x11 & x19 & x20 & x21));
  assign new_n59_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & x09 & ~x10 & ~new_n61_ & x19);
  assign new_n61_ = x20 & (~new_n63_ | ~new_n62_ | ~x12);
  assign new_n62_ = x21 & x22;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x19 | ~x20 | (~new_n66_ & x21)) & (x20 | ~x21);
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x19 & ((x22 & (new_n69_ | ~x21)) | (x20 & x21 & ~x22))) | (~x20 & x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x19 | (x22 ? ((x21 | ~x23) & (~x20 | ~x21 | (~new_n72_ & x23))) : ~x23)) & (x20 | ~x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & new_n74_ & x09);
  assign new_n74_ = ~x10 & ((~x20 & x24) | (x19 & (new_n76_ | (~new_n75_ & x24))));
  assign new_n75_ = x21 & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((~x20 & x25) | (x19 & (new_n80_ | (~new_n79_ & x25))));
  assign new_n79_ = x21 & x22 & x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x20 | ~x26) & (~x19 | ((new_n83_ | ~x26) & (~new_n84_ | ~new_n62_ | ~x20)));
