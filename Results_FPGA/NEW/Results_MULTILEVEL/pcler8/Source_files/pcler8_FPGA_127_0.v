...
module FAU ( 
  ...
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (x17 & x19 & ~x20));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x20 & (x19 ? (new_n67_ | ~x21) : x21)) | (x17 & ~x20 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x20 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x21 | x22))) & (~x17 | x20 | ~x22);
  ...
  assign new_n74_ = (~x17 | x20 | ~x23) & (~x20 | ((~x19 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x19 & x21))));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x20 | ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_))) & (~x17 | x20 | ~x24);
  ...
  assign new_n88_ = x20 & ((new_n91_ & new_n92_) | (x26 & (~new_n89_ | ~new_n90_)));
  assign new_n89_ = ~x18 & x19 & x21;
  assign new_n90_ = x22 & x23 & x24 & x25;
  assign new_n91_ = x19 & x21 & x22;
  assign new_n92_ = x23 & x24 & x25 & ~x26;
  assign new_n93_ = x17 & ~x20 & x26;
endmodule
