...
module FAU ( 
  ...
  assign new_n57_ = x09 & ~x10 & (x19 ? ~x20 : (x20 & ~x22));
  assign z11 = (x02 & ~new_n47_ & x08) | (new_n59_ & ~x08);
  assign new_n59_ = x09 & ~x10 & (x20 ? (~x22 & (x19 ^ x21)) : x21);
  assign z12 = (x03 & ~new_n47_ & x08) | (new_n61_ & ~x08);
  assign new_n61_ = x09 & ~x10 & ((~x20 & x22) | (x19 & x20 & x21 & ~x22));
  assign z13 = (x04 & ~new_n47_ & x08) | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & x23 & (~x22 | (~x20 & x22));
