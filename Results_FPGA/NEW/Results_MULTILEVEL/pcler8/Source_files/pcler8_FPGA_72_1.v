...
module FAU ( 
  ...
  assign z06 = x05 & x08 & (~x20 | (x06 & x20));
  assign z07 = x06 & x08;
  ...
  assign new_n78_ = (x20 | ~x24) & (~x06 | (~new_n81_ & ((new_n79_ & new_n80_) | ~x24)));
  assign new_n79_ = x19 & x21;
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n81_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & (x08 | (x09 & ~new_n83_ & ~x10))) | (~x08 & x09 & new_n86_ & ~x10);
  assign new_n83_ = ~new_n84_ & (~x25 | (new_n85_ & new_n66_ & x19));
  ...
  assign new_n88_ = x06 & (new_n89_ | (new_n90_ & new_n66_ & x19 & x20));
  assign new_n89_ = x26 & (~new_n60_ | ~x24 | ~x25 | ~new_n79_ | x18);
