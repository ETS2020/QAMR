...
module FAU ( 
  ...
  assign z09 = (~new_n58_ & (x21 | ~x23)) | (new_n59_ & new_n60_ & x21 & x22 & x23);
  assign new_n58_ = (~x00 | ~x08) & (x08 | ~x09 | x10 | x19);
  assign new_n59_ = ~x08 & x09 & ~x10 & x11 & x20;
  assign new_n60_ = x24 & x25 & x26;
  assign z10 = (~new_n62_ & (x21 | ~x23)) | (new_n63_ & new_n60_ & x21 & x22 & x23);
  assign new_n62_ = x08 ? ~x01 : (~x09 | x10 | (~x19 ^ x20));
  assign new_n63_ = ~x08 & x09 & ~x10 & x12 & x19;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x19 & (x20 ? (~x21 & ~x23) : x21)) | (x21 & (new_n66_ | ~x19)));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = x21 ? ((~x22 | (x19 & ~new_n69_ & x20)) & (~x19 | ~x20 | x22)) : (~x22 | x23);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & new_n71_ & ~x10);
  assign new_n71_ = x21 & (x22 ? ((x19 & x20 & (new_n72_ | ~x23)) | (x23 & (~x19 | ~x20))) : x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (x23 | ~x24) & (~x21 | ((~x24 | (new_n75_ & ~new_n76_ & x22)) & (~new_n75_ | ~x22 | ~x23 | x24)));
  assign new_n75_ = x19 & x20;
  assign new_n76_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (x23 | ~x25) & (~x21 | ((new_n79_ | ~x25) & (~new_n80_ | ~x23 | ~x24 | x25)));
  assign new_n79_ = x19 & x20 & x22 & x24 & (~x17 | ~x26);
  assign new_n80_ = x19 & x20 & x22;
  assign z16 = z08 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x23 | ~x26) & (~x21 | ((new_n83_ | ~x26) & (~new_n80_ | ~new_n84_)));
  assign new_n83_ = x22 & x24 & x25 & ~x18 & x19 & x20;
