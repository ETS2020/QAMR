...
module FAU ( 
  ...
  assign z4 = ~x6 & x9 & (new_n37_ | ~new_n42_ | (~new_n40_ & x0));
  assign new_n37_ = x4 & (x5 ? ~new_n39_ : ~new_n38_);
  assign new_n38_ = (~x1 | ~x2 | x8) & (~x3 | ((~x2 | x8) & (~x0 | (x8 & (~x2 | ~x7)))));
  assign new_n39_ = x7 & ((x1 & x3) | (x0 & x2));
  assign new_n40_ = ((~new_n41_ & x8) | ((x3 | x4 | ~x5) & (~x1 | x5))) & (~x1 | x4 | x8);
  assign new_n41_ = x2 & x7;
  assign new_n42_ = ~new_n43_ & (~x1 | ~x3 | ~x7 | (x4 & x5));
  assign new_n43_ = ~x2 & x5 & ~x8 & (~x3 | (x1 & ~x4));
