...
module FAU ( 
  ...
  assign new_n352_ = ~new_n353_ & (x70 | ~x71 | ((~x00 | x14 | ~x15) & (~x14 | (x00 & x15))));
  assign new_n353_ = x70 & ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  ...
  assign new_n360_ = ~x69 & (new_n361_ | (~x66 & new_n353_ & ~x67));
  assign new_n361_ = ~x70 & ((~x71 & ~new_n349_ & (x66 | x67)) | (~x66 & ~x67 & ~new_n362_ & x71));
  assign new_n362_ = (~x00 | x14 | ~x15) & (~x14 | (x15 & (x00 | ~x15)));
  assign z15 = (~new_n364_ & ~x65) | (~x64 & x65 & x68 & ~new_n379_ & ~x69);
  assign new_n364_ = x64 ? (x66 ? (new_n376_ | x67) : new_n365_) : ~new_n377_;
  assign new_n365_ = x68 ? (~new_n373_ | x69) : (x67 ? new_n374_ : (new_n366_ | ~x69));
  assign new_n366_ = (new_n367_ | (~x70 ^ x71)) & (~x70 | new_n370_ | ~x71);
  assign new_n367_ = (new_n171_ | ~x31) & (new_n368_ | ~x72) & (new_n369_ | x72);
  assign new_n368_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n369_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n370_ = (new_n171_ | ~x63) & (new_n371_ | ~x72) & (new_n372_ | x72);
  assign new_n371_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n372_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n373_ = ~x70 & ~x71 & (x67 ? x47 : ~new_n370_);
  assign new_n374_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n375_ | ~x70);
  assign new_n375_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n376_ = (new_n374_ | x68) & (x69 | x70 | x71 | ~x47 | ~x68);
  assign new_n377_ = x68 & new_n378_ & ~x69;
  assign new_n378_ = ~new_n104_ & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n379_ = (~x47 | x66 | x67 | ~x70 | x71) & (new_n380_ | x70);
  assign new_n380_ = (x71 | new_n370_ | (~x66 & ~x67)) & (x67 | ~x71 | ~x15 | x66);
endmodule
