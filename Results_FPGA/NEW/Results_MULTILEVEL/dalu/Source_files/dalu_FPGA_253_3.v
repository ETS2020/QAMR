// Benchmark "FAU" written by ABC on Thu Aug  6 22:32:24 2020
...
module FAU ( 
  ...
  assign new_n106_ = (~x46 | ~x69) & (x70 ? x32 : x00);
  assign new_n107_ = (x46 | ~x69 | (x70 ? ~x00 : ~x48)) & (~x16 | x69 | ~x70);
  assign new_n108_ = ~x69 & ~x70 & ~x71;
  assign new_n109_ = (x46 | x68 | new_n110_ | ~x69) & (~new_n108_ | ~x48 | ~x68);
  assign new_n110_ = (~x16 | (~x70 ^ x71)) & (~x48 | ~x70 | ~x71);
  assign new_n111_ = ~x46 & x65 & ~x68 & x69 & ~new_n112_ & ~new_n110_;
  ...
  assign new_n125_ = ~x46 & x65 & new_n126_ & ~x68;
  ...
  assign new_n133_ = ~new_n127_ & ((~x46 & new_n134_ & ~x68) | (new_n108_ & x49 & x68));
  assign new_n134_ = ~new_n129_ & x69;
  assign new_n135_ = (x68 | (x71 ? ~new_n136_ : new_n137_)) & (~new_n108_ | ~x33 | ~x68);
  assign new_n136_ = (~x46 | ~x69) & (x70 ? x33 : x01);
  assign new_n137_ = (x46 | ~x69 | (x70 ? ~x01 : ~x49)) & (~x17 | x69 | ~x70);
  ...
  assign new_n146_ = ~x46 & x65 & new_n147_ & ~x68;
  ...
  assign new_n150_ = x70 ? ~new_n143_ : (new_n141_ | ~x71);
  assign new_n151_ = x66 ? (new_n156_ | x67) : (x68 ? ~new_n155_ : new_n152_);
  assign new_n152_ = (x46 | (x67 ? new_n153_ : ~new_n147_)) & (~new_n154_ | ~x67);
  ...
  assign new_n174_ = x66 ? (new_n176_ | x67) : (x67 ? new_n176_ : (~new_n175_ & (~new_n170_ | x46)));
  assign new_n175_ = x68 & new_n168_ & ~x69;
  assign new_n176_ = (x68 | (x71 ? ~new_n177_ : new_n178_)) & (~new_n108_ | ~x35 | ~x68);
  assign new_n177_ = (~x46 | ~x69) & (x70 ? x35 : x03);
  assign new_n178_ = (x46 | ~x69 | (x70 ? ~x03 : ~x51)) & (~x19 | x69 | ~x70);
  ...
  assign new_n182_ = (x46 | x68 | ~x69 | (~new_n183_ & ~new_n187_)) & (~x68 | ~new_n190_ | x69);
  ...
  assign new_n196_ = (~x46 | ~x69) & (x70 ? x36 : x04);
  assign new_n197_ = (x46 | ~x69 | (x70 ? ~x04 : ~x52)) & (~x20 | x69 | ~x70);
  ...
  assign new_n213_ = (~x46 | ~x69) & (x70 ? x37 : x05);
  assign new_n214_ = (x46 | ~x69 | (x70 ? ~x05 : ~x53)) & (~x21 | x69 | ~x70);
  assign z06 = new_n216_ | new_n229_;
  assign new_n216_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n217_ : new_n226_)) | (x65 & ~x66 & new_n226_ & ~x67));
  assign new_n217_ = (x46 | x68 | ~x69 | (~new_n218_ & ~new_n221_)) & (~x68 | ~new_n225_ | x69);
  ...
  assign new_n231_ = (~x46 | ~x69) & (x70 ? x38 : x06);
  assign new_n232_ = (x46 | ~x69 | (x70 ? ~x06 : ~x54)) & (~x22 | x69 | ~x70);
  assign z07 = new_n234_ | new_n247_;
  assign new_n234_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n235_ : new_n244_)) | (x65 & ~x66 & new_n244_ & ~x67));
  assign new_n235_ = (x46 | x68 | ~x69 | (~new_n236_ & ~new_n239_)) & (~x68 | ~new_n243_ | x69);
  ...
  assign new_n249_ = (~x46 | ~x69) & (x70 ? x39 : x07);
  assign new_n250_ = (x46 | ~x69 | (x70 ? ~x07 : ~x55)) & (~x23 | x69 | ~x70);
  assign z08 = x64 ? (~new_n265_ & ~x65) : ((~new_n252_ & ~new_n112_) | (new_n263_ & x65));
  assign new_n252_ = (~x68 | new_n253_ | x69) & (x46 | ~new_n259_ | ~x65);
  ...
  assign new_n265_ = x66 ? (new_n267_ | x67) : (x67 ? new_n267_ : (~new_n266_ & (~new_n259_ | x46)));
  assign new_n266_ = x68 & ~x69 & ~x70 & ~new_n256_ & ~x71;
  assign new_n267_ = (x68 | (x71 ? ~new_n268_ : new_n269_)) & (~new_n108_ | ~x40 | ~x68);
  assign new_n268_ = (~x46 | ~x69) & (x70 ? x40 : x08);
  assign new_n269_ = (x46 | ~x69 | (x70 ? ~x08 : ~x56)) & (~x24 | x69 | ~x70);
  assign z09 = x64 ? (~new_n285_ & ~x65) : ((~new_n271_ & ~new_n112_) | (new_n283_ & x65));
  assign new_n271_ = (~x68 | new_n272_ | x69) & (x46 | ~new_n278_ | ~x65);
  ...
  assign new_n285_ = x66 ? (new_n287_ | x67) : (x67 ? new_n287_ : (~new_n286_ & (~new_n278_ | x46)));
  assign new_n286_ = x68 & new_n275_ & ~x69;
  assign new_n287_ = (x68 | (x71 ? ~new_n288_ : new_n289_)) & (~new_n108_ | ~x41 | ~x68);
  assign new_n288_ = (~x46 | ~x69) & (x70 ? x41 : x09);
  assign new_n289_ = (x46 | ~x69 | (x70 ? ~x09 : ~x57)) & (~x25 | x69 | ~x70);
  assign z10 = x64 ? (~new_n310_ & ~x65) : (new_n291_ | (x65 & new_n317_ & ~x66));
  assign new_n291_ = ~new_n112_ & (x70 ? (new_n302_ | new_n307_) : (new_n292_ | new_n298_));
  ...
  assign new_n298_ = ~x46 & x65 & ~x68 & x69 & ~new_n299_ & x71;
  ...
  assign new_n302_ = ~x46 & (new_n305_ | (x65 & ~x68 & ~new_n303_ & x69));
  ...
  assign new_n305_ = new_n306_ & ~x44 & ~x45 & x42 & ~x43;
  assign new_n306_ = ~x47 & ~x65 & x68 & ~x69 & ~x71;
  assign new_n307_ = ~x65 & x68 & new_n308_ & ~x69;
  assign new_n308_ = ~x71 & (x32 ? (~x42 & (~new_n309_ | x43 | x44)) : x42);
  assign new_n309_ = ~x45 & ~x46 & ~x47;
  assign new_n310_ = x66 ? (new_n314_ | x67) : (x67 ? new_n314_ : (~new_n313_ & (~new_n311_ | x46)));
  assign new_n311_ = ~x68 & x69 & ((~new_n299_ & (x70 ^ x71)) | (x70 & ~new_n312_ & x71));
  assign new_n312_ = ~new_n296_ & ~new_n297_ & (new_n127_ | ~x58);
  assign new_n313_ = x68 & ~x69 & new_n295_ & ~x70;
  assign new_n314_ = (x68 | (x71 ? ~new_n315_ : new_n316_)) & (~new_n108_ | ~x42 | ~x68);
  assign new_n315_ = (~x46 | ~x69) & (x70 ? x42 : x10);
  assign new_n316_ = (x46 | ~x69 | (x70 ? ~x10 : ~x58)) & (~x26 | x69 | ~x70);
  assign new_n317_ = ~x67 & x68 & ~x69 & (x70 ? new_n318_ : new_n293_);
  assign new_n318_ = ~x71 & ((x42 & (~x32 | (new_n309_ & ~x43 & ~x44))) | (x32 & ~x42 & (~new_n309_ | x43 | x44)));
  assign z11 = x64 ? (~x65 & (x66 ? new_n347_ : ~new_n339_)) : ~new_n320_;
  assign new_n320_ = ~new_n337_ & (new_n112_ | (x70 ? (~new_n330_ & ~new_n335_) : new_n321_));
  assign new_n321_ = (~x68 | new_n322_ | x69) & (x46 | ~x65 | x68 | ~new_n327_ | ~x69);
  ...
  assign new_n330_ = ~x46 & (new_n333_ | (x65 & ~x68 & ~new_n331_ & x69));
  ...
  assign new_n333_ = new_n334_ & ~x45 & ~x47 & x43 & ~x44;
  assign new_n334_ = ~x69 & ~x71 & ~x65 & x68;
  assign new_n335_ = ~x65 & x68 & ~x69 & ~new_n336_ & ~x71;
  assign new_n336_ = x32 ? (new_n124_ | x43) : ~x43;
  assign new_n337_ = x65 & ~x66 & ~x67 & x68 & ~new_n338_ & ~x69;
  assign new_n338_ = x70 ? (x71 | ((~x43 | (~new_n124_ & x32)) & (~x32 | new_n124_ | x43))) : (new_n323_ | ~x71);
  assign new_n339_ = x67 ? new_n344_ : ((~new_n343_ | ~x68) & (x46 | ~new_n340_ | x68));
  assign new_n340_ = x69 & (new_n342_ | (~new_n184_ & (~new_n341_ | (~new_n127_ & x27))));
  assign new_n341_ = ~new_n328_ & ~new_n329_;
  assign new_n342_ = x70 & x71 & (new_n324_ | new_n325_ | new_n326_);
  assign new_n343_ = ~x69 & ~x70 & ~x71 & (new_n324_ | new_n325_ | new_n326_);
  assign new_n344_ = (x68 | (x71 ? ~new_n345_ : new_n346_)) & (~new_n108_ | ~x43 | ~x68);
  assign new_n345_ = (~x46 | ~x69) & (x70 ? x43 : x11);
  assign new_n346_ = (x46 | ~x69 | (x70 ? ~x11 : ~x59)) & (~x27 | x69 | ~x70);
  assign new_n347_ = ~new_n344_ & ~x67;
  assign z12 = x64 ? (~x65 & (x66 ? new_n375_ : ~new_n367_)) : ~new_n349_;
  assign new_n349_ = ~new_n365_ & (new_n112_ | (x70 ? (~new_n359_ & ~new_n363_) : new_n350_));
  assign new_n350_ = (~x68 | new_n351_ | x69) & (x46 | ~x65 | x68 | ~new_n356_ | ~x69);
  ...
  assign new_n356_ = x71 & (new_n357_ | new_n358_ | (~new_n127_ & x28));
  assign new_n357_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n358_ = ~x72 & ((x27 & ~x73 & x74) | (x73 & (x74 ? x25 : x26)));
  assign new_n359_ = ~x46 & (new_n362_ | (x65 & ~x68 & ~new_n360_ & x69));
  ...
  assign new_n362_ = new_n334_ & x44 & ~x45 & ~x47;
  assign new_n363_ = ~x65 & x68 & new_n364_ & ~x69;
  assign new_n364_ = ~x71 & (x32 ? (~new_n309_ & ~x44) : x44);
  assign new_n365_ = x65 & ~x66 & ~x67 & x68 & ~new_n366_ & ~x69;
  assign new_n366_ = x70 ? (x71 | ((~x44 | (~new_n309_ & x32)) & (~x32 | new_n309_ | x44))) : ~new_n352_;
  assign new_n367_ = x67 ? new_n372_ : ((~new_n371_ | ~x68) & (x46 | ~new_n368_ | x68));
  assign new_n368_ = x69 & (new_n370_ | (~new_n184_ & (~new_n369_ | (~new_n127_ & x28))));
  assign new_n369_ = ~new_n357_ & ~new_n358_;
  assign new_n370_ = x70 & x71 & (new_n353_ | new_n354_ | new_n355_);
  assign new_n371_ = ~x69 & ~x70 & ~x71 & (new_n353_ | new_n354_ | new_n355_);
  assign new_n372_ = (x68 | (x71 ? ~new_n373_ : new_n374_)) & (~new_n108_ | ~x44 | ~x68);
  assign new_n373_ = (~x46 | ~x69) & (x70 ? x44 : x12);
  assign new_n374_ = (x46 | ~x69 | (x70 ? ~x12 : ~x60)) & (~x28 | x69 | ~x70);
  assign new_n375_ = ~new_n372_ & ~x67;
  assign z13 = x64 ? (~x65 & (x66 ? new_n404_ : ~new_n396_)) : ~new_n377_;
  assign new_n377_ = ~new_n391_ & (new_n112_ | (x70 ? (~new_n387_ & ~new_n394_) : new_n378_));
  assign new_n378_ = (~x68 | new_n379_ | x69) & (x46 | ~x65 | x68 | ~new_n384_ | ~x69);
  ...
  assign new_n384_ = x71 & (new_n385_ | new_n386_ | (~new_n127_ & x29));
  assign new_n385_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n386_ = ~x72 & ((x28 & ~x73 & x74) | (x73 & (x74 ? x26 : x27)));
  assign new_n387_ = ~x46 & (new_n390_ | (x65 & ~x68 & ~new_n388_ & x69));
  ...
  assign new_n390_ = x68 & ~x69 & ~x71 & x45 & ~x47 & ~x65;
  assign new_n391_ = x65 & ~x66 & new_n392_ & ~x67;
  assign new_n392_ = x68 & ~x69 & (x70 ? (~new_n393_ & ~x71) : new_n380_);
  assign new_n393_ = (~x32 | x45 | (~x46 & ~x47)) & (~x45 | (x32 & (x46 | x47)));
  assign new_n394_ = ~x65 & new_n395_ & x68;
  assign new_n395_ = ~x69 & ~x71 & (x32 ? (~x45 & (x46 | x47)) : x45);
  assign new_n396_ = x67 ? new_n401_ : ((~new_n400_ | ~x68) & (x46 | ~new_n397_ | x68));
  assign new_n397_ = x69 & (new_n399_ | (~new_n184_ & (~new_n398_ | (~new_n127_ & x29))));
  assign new_n398_ = ~new_n385_ & ~new_n386_;
  assign new_n399_ = x70 & x71 & (new_n381_ | new_n382_ | new_n383_);
  assign new_n400_ = ~x69 & ~x70 & ~x71 & (new_n381_ | new_n382_ | new_n383_);
  assign new_n401_ = (x68 | (x71 ? ~new_n402_ : new_n403_)) & (~new_n108_ | ~x45 | ~x68);
  assign new_n402_ = (~x46 | ~x69) & (x70 ? x45 : x13);
  assign new_n403_ = (x46 | ~x69 | (x70 ? ~x13 : ~x61)) & (~x29 | x69 | ~x70);
  assign new_n404_ = ~new_n401_ & ~x67;
  assign z14 = x64 ? (~new_n421_ & ~x65) : ((~new_n406_ & ~new_n112_) | (new_n427_ & x65));
  assign new_n406_ = x70 ? (x46 ? ~new_n420_ : new_n416_) : (~new_n407_ & (~new_n412_ | x46));
  assign new_n407_ = x68 & ~x69 & (x65 ? (~new_n408_ & ~x71) : (~new_n411_ & x71));
  assign new_n408_ = (new_n127_ | ~x62) & (new_n410_ | x72) & (new_n409_ | ~x72);
  ...
  assign new_n413_ = (new_n127_ | ~x30) & (new_n415_ | x72) & (new_n414_ | ~x72);
  assign new_n414_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n415_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n416_ = ~new_n419_ & (~x65 | x68 | ~x69 | (~new_n417_ & new_n418_));
  assign new_n417_ = ~new_n127_ & (x71 ? x62 : x30);
  assign new_n418_ = x71 ? (x72 ? new_n409_ : new_n410_) : (x72 ? new_n414_ : new_n415_);
  assign new_n419_ = x68 & ~x69 & ~x71 & x32 & x47 & ~x65;
  assign new_n420_ = ~x65 & x68 & ~x69 & ~x71 & (~x32 | ~x47);
  assign new_n421_ = x66 ? (new_n424_ | x67) : (x67 ? new_n424_ : (~new_n423_ & (~new_n422_ | x46)));
  assign new_n422_ = ~x68 & x69 & ((~new_n413_ & (x70 ^ x71)) | (x70 & ~new_n408_ & x71));
  assign new_n423_ = x68 & ~x69 & ~x70 & ~new_n408_ & ~x71;
  assign new_n424_ = (~new_n426_ | x46) & (new_n425_ | x69);
  assign new_n425_ = (~x46 | (x68 ? (x70 | x71) : (~x70 | ~x71))) & (x68 | ((~x14 | x70 | ~x71) & (~x30 | ~x70 | x71)));
  assign new_n426_ = ~x68 & ((x14 & ((~x70 & x71) | (x69 & x70 & ~x71))) | (x62 & x69 & ~x70 & ~x71));
  assign new_n427_ = ~x66 & ~x67 & x68 & ~new_n428_ & ~x69;
  assign new_n428_ = x70 ? (new_n429_ | x71) : (~x71 | ((~x00 | x14 | ~x15) & (~x14 | (x15 & (x00 | ~x15)))));
  assign new_n429_ = (~x46 | (x32 & x47)) & (~x32 | x46 | ~x47);
  assign z15 = x68 ? (~new_n443_ & ~x69) : ~new_n431_;
  assign new_n431_ = (~x64 | ~new_n441_ | x65) & (x46 | (x64 ? (new_n432_ | x65) : (~new_n440_ | ~x65)));
  assign new_n432_ = x66 ? (new_n439_ | x67) : (x67 ? new_n439_ : (~x69 | (~new_n433_ & ~new_n436_)));
  assign new_n433_ = ~new_n184_ & (new_n434_ | new_n435_ | (~new_n127_ & x31));
  assign new_n434_ = x72 & ((~x73 & (x74 ? x26 : x27)) | (x23 & x73 & ~x74));
  assign new_n435_ = ~x72 & ((x30 & ~x73 & x74) | (x73 & (x74 ? x28 : x29)));
  assign new_n436_ = x70 & x71 & (new_n437_ | new_n438_ | (~new_n127_ & x63));
  assign new_n437_ = x72 & ((~x73 & (x74 ? x58 : x59)) | (x55 & x73 & ~x74));
  assign new_n438_ = ~x72 & ((x62 & ~x73 & x74) | (x73 & (x74 ? x60 : x61)));
  assign new_n439_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x47 | ~x70 | ~x71) & (x70 | x71 | ~x63 | ~x69);
  assign new_n440_ = x69 & ~new_n112_ & (new_n433_ | new_n436_);
  assign new_n441_ = ~x69 & ~new_n442_ & (~x66 ^ ~x67);
  assign new_n442_ = (~x70 | (x71 ? ~x47 : ~x31)) & (~x15 | x70 | ~x71);
  assign new_n443_ = x64 ? (~new_n446_ | x65) : ((new_n444_ | new_n112_) & (~new_n447_ | ~x65));
  assign new_n444_ = (x70 | ((~x65 | new_n445_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n445_ = ~new_n437_ & ~new_n438_ & (new_n127_ | ~x63);
