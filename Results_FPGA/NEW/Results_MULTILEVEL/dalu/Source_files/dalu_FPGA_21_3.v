// Benchmark "FAU" written by ABC on Thu Aug  6 22:30:24 2020
...
module FAU ( 
  ...
  assign new_n106_ = (~x31 | ~x69) & (x70 ? x32 : x00);
  assign new_n107_ = (x31 | ~x69 | (x70 ? ~x00 : ~x48)) & (~x16 | x69 | ~x70);
  assign new_n108_ = ~x69 & ~x70 & ~x71;
  assign new_n109_ = (x31 | x68 | new_n110_ | ~x69) & (~new_n108_ | ~x48 | ~x68);
  assign new_n110_ = (~x16 | (~x70 ^ x71)) & (~x48 | ~x70 | ~x71);
  assign new_n111_ = ~x31 & x65 & ~x68 & x69 & ~new_n112_ & ~new_n110_;
  ...
  assign new_n125_ = ~x31 & x65 & new_n126_ & ~x68;
  ...
  assign new_n133_ = ~new_n127_ & ((~x31 & new_n134_ & ~x68) | (new_n108_ & x49 & x68));
  assign new_n134_ = ~new_n129_ & x69;
  assign new_n135_ = (x68 | (x71 ? ~new_n136_ : new_n137_)) & (~new_n108_ | ~x33 | ~x68);
  assign new_n136_ = (~x31 | ~x69) & (x70 ? x33 : x01);
  assign new_n137_ = (x31 | ~x69 | (x70 ? ~x01 : ~x49)) & (~x17 | x69 | ~x70);
  ...
  assign new_n146_ = ~x31 & x65 & new_n147_ & ~x68;
  ...
  assign new_n152_ = (~new_n154_ | ~x67) & (x31 | (x67 ? new_n153_ : ~new_n147_));
  ...
  assign new_n157_ = (~x31 | ~x69) & (x70 ? x34 : x02);
  assign new_n158_ = (x31 | ~x69 | (x70 ? ~x02 : ~x50)) & (~x18 | x69 | ~x70);
  assign z03 = x64 ? (~new_n174_ & ~x65) : (new_n160_ | (new_n179_ & x65));
  assign new_n160_ = ~new_n112_ & (new_n161_ | (~x31 & new_n170_ & x65));
  ...
  assign new_n174_ = x66 ? (new_n176_ | x67) : (x67 ? new_n176_ : (~new_n175_ & (~new_n170_ | x31)));
  assign new_n175_ = x68 & new_n168_ & ~x69;
  assign new_n176_ = (x68 | (x71 ? ~new_n177_ : new_n178_)) & (~new_n108_ | ~x35 | ~x68);
  assign new_n177_ = (~x31 | ~x69) & (x70 ? x35 : x03);
  assign new_n178_ = (x31 | ~x69 | (x70 ? ~x03 : ~x51)) & (~x19 | x69 | ~x70);
  ...
  assign new_n182_ = (x31 | x68 | ~x69 | (~new_n183_ & ~new_n187_)) & (~x68 | ~new_n190_ | x69);
  ...
  assign new_n196_ = (~x31 | ~x69) & (x70 ? x36 : x04);
  assign new_n197_ = (x31 | ~x69 | (x70 ? ~x04 : ~x52)) & (~x20 | x69 | ~x70);
  assign z05 = new_n199_ | new_n211_;
  assign new_n199_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n200_ : new_n208_)) | (x65 & ~x66 & new_n208_ & ~x67));
  assign new_n200_ = (x31 | x68 | ~x69 | (~new_n201_ & ~new_n204_)) & (~x68 | ~new_n207_ | x69);
  ...
  assign new_n213_ = (~x31 | ~x69) & (x70 ? x37 : x05);
  assign new_n214_ = (x31 | ~x69 | (x70 ? ~x05 : ~x53)) & (~x21 | x69 | ~x70);
  assign z06 = new_n216_ | new_n229_;
  assign new_n216_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n217_ : new_n226_)) | (x65 & ~x66 & new_n226_ & ~x67));
  assign new_n217_ = (x31 | x68 | ~x69 | (~new_n218_ & ~new_n221_)) & (~x68 | ~new_n225_ | x69);
  ...
  assign new_n231_ = (~x31 | ~x69) & (x70 ? x38 : x06);
  assign new_n232_ = (x31 | ~x69 | (x70 ? ~x06 : ~x54)) & (~x22 | x69 | ~x70);
  assign z07 = new_n234_ | new_n247_;
  assign new_n234_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n235_ : new_n244_)) | (x65 & ~x66 & new_n244_ & ~x67));
  assign new_n235_ = (x31 | x68 | ~x69 | (~new_n236_ & ~new_n239_)) & (~x68 | ~new_n243_ | x69);
  ...
  assign new_n249_ = (~x31 | ~x69) & (x70 ? x39 : x07);
  assign new_n250_ = (x31 | ~x69 | (x70 ? ~x07 : ~x55)) & (~x23 | x69 | ~x70);
  assign z08 = x64 ? (~new_n265_ & ~x65) : ((~new_n252_ & ~new_n112_) | (new_n263_ & x65));
  assign new_n252_ = (~x68 | new_n253_ | x69) & (x31 | ~new_n259_ | ~x65);
  ...
  assign new_n265_ = x66 ? (new_n267_ | x67) : (x67 ? new_n267_ : (~new_n266_ & (~new_n259_ | x31)));
  assign new_n266_ = x68 & ~x69 & ~x70 & ~new_n256_ & ~x71;
  assign new_n267_ = (x68 | (x71 ? ~new_n268_ : new_n269_)) & (~new_n108_ | ~x40 | ~x68);
  assign new_n268_ = (~x31 | ~x69) & (x70 ? x40 : x08);
  assign new_n269_ = (x31 | ~x69 | (x70 ? ~x08 : ~x56)) & (~x24 | x69 | ~x70);
  assign z09 = x64 ? (~new_n285_ & ~x65) : ((~new_n271_ & ~new_n112_) | (new_n283_ & x65));
  assign new_n271_ = (~x68 | new_n272_ | x69) & (x31 | ~new_n278_ | ~x65);
  ...
  assign new_n285_ = x66 ? (new_n287_ | x67) : (x67 ? new_n287_ : (~new_n286_ & (~new_n278_ | x31)));
  assign new_n286_ = x68 & new_n275_ & ~x69;
  assign new_n287_ = (x68 | (x71 ? ~new_n288_ : new_n289_)) & (~new_n108_ | ~x41 | ~x68);
  assign new_n288_ = (~x31 | ~x69) & (x70 ? x41 : x09);
  assign new_n289_ = (x31 | ~x69 | (x70 ? ~x09 : ~x57)) & (~x25 | x69 | ~x70);
  ...
  assign new_n298_ = ~x31 & x65 & ~x68 & x69 & ~new_n299_ & x71;
  ...
  assign new_n302_ = (x31 | ~x65 | x68 | new_n303_ | ~x69) & (x65 | ~x68 | ~new_n305_ | x69);
  ...
  assign new_n307_ = x66 ? (new_n311_ | x67) : (x67 ? new_n311_ : (~new_n310_ & (~new_n308_ | x31)));
  ...
  assign new_n312_ = (~x31 | ~x69) & (x70 ? x42 : x10);
  assign new_n313_ = (x31 | ~x69 | (x70 ? ~x10 : ~x58)) & (~x26 | x69 | ~x70);
  assign new_n314_ = ~x67 & x68 & ~x69 & (x70 ? new_n305_ : new_n293_);
  assign z11 = x64 ? new_n334_ : (new_n332_ | (~new_n112_ & (new_n316_ | new_n327_)));
  assign new_n316_ = ~x70 & ((new_n317_ & x68) | (~x31 & x65 & new_n323_ & ~x68));
  ...
  assign new_n327_ = x70 & ((~x65 & new_n330_ & x68) | (~x31 & x65 & new_n328_ & ~x68));
  ...
  assign new_n335_ = (x31 | x68 | ~x69 | (~new_n336_ & ~new_n337_)) & (~x68 | ~new_n338_ | x69);
  ...
  assign new_n340_ = (~x31 | ~x69) & (x70 ? x43 : x11);
  assign new_n341_ = (x31 | ~x69 | (x70 ? ~x11 : ~x59)) & (~x27 | x69 | ~x70);
  assign z12 = x64 ? (~x65 & (x66 ? new_n367_ : ~new_n359_)) : ~new_n343_;
  assign new_n343_ = ~new_n357_ & (new_n112_ | (x70 ? new_n353_ : new_n344_));
  assign new_n344_ = (~x68 | new_n345_ | x69) & (x31 | ~x65 | x68 | ~new_n350_ | ~x69);
  ...
  assign new_n353_ = (x31 | ~x65 | x68 | new_n354_ | ~x69) & (x65 | ~x68 | ~new_n356_ | x69);
  ...
  assign new_n359_ = x67 ? new_n364_ : ((~new_n363_ | ~x68) & (x31 | ~new_n360_ | x68));
  ...
  assign new_n365_ = (~x31 | ~x69) & (x70 ? x44 : x12);
  assign new_n366_ = (x31 | ~x69 | (x70 ? ~x12 : ~x60)) & (~x28 | x69 | ~x70);
  assign new_n367_ = ~new_n364_ & ~x67;
  assign z13 = x64 ? new_n385_ : (new_n393_ | (~new_n112_ & (new_n369_ | new_n380_)));
  assign new_n369_ = ~x70 & ((new_n370_ & x68) | (~x31 & x65 & new_n376_ & ~x68));
  ...
  assign new_n380_ = x70 & ((~x65 & new_n383_ & x68) | (~x31 & x65 & new_n381_ & ~x68));
  ...
  assign new_n386_ = (x31 | x68 | ~x69 | (~new_n387_ & ~new_n388_)) & (~x68 | ~new_n389_ | x69);
  ...
  assign new_n391_ = (~x31 | ~x69) & (x70 ? x45 : x13);
  assign new_n392_ = (x31 | ~x69 | (x70 ? ~x13 : ~x61)) & (~x29 | x69 | ~x70);
  ...
  assign new_n402_ = ~x31 & x65 & ~x68 & x69 & ~new_n403_ & x71;
  ...
  assign new_n406_ = (x31 | ~x65 | x68 | new_n407_ | ~x69) & (x65 | ~x68 | ~new_n409_ | x69);
  ...
  assign new_n410_ = x66 ? (new_n413_ | x67) : (x67 ? new_n413_ : (~new_n412_ & (~new_n411_ | x31)));
  ...
  assign new_n414_ = (~x31 | ~x69) & (x70 ? x46 : x14);
  assign new_n415_ = (x31 | ~x69 | (x70 ? ~x14 : ~x62)) & (~x30 | x69 | ~x70);
  assign new_n416_ = ~x66 & ~x67 & x68 & ~new_n417_ & ~x69;
  assign new_n417_ = x70 ? ~new_n409_ : (~x71 | ((~x00 | x14 | ~x15) & (~x14 | (x15 & (x00 | ~x15)))));
  assign z15 = (~x65 & (x64 ? ~new_n419_ : (new_n436_ & x68))) | (~x64 & ~new_n431_ & x65);
  assign new_n419_ = x66 ? (new_n428_ | x67) : (x67 ? new_n428_ : (~new_n427_ & (~new_n420_ | x31)));
  assign new_n420_ = ~x68 & x69 & (new_n421_ | (x70 & ~new_n424_ & x71));
  assign new_n421_ = ~new_n184_ & (x72 ? ~new_n422_ : ~new_n423_);
  assign new_n422_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n423_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n424_ = (new_n127_ | ~x63) & (new_n426_ | x72) & (new_n425_ | ~x72);
  assign new_n425_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n426_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n427_ = x68 & ~x69 & ~x70 & ~new_n424_ & ~x71;
  assign new_n428_ = (x68 | (x71 ? ~new_n429_ : new_n430_)) & (~new_n108_ | ~x47 | ~x68);
  assign new_n429_ = (~x31 | ~x69) & (x70 ? x47 : x15);
  assign new_n430_ = x31 ? (x69 | ~x70) : (~x69 | (x70 ? ~x15 : ~x63));
  assign new_n431_ = (~x68 | new_n433_ | x69) & (x31 | x68 | ~x69 | new_n432_ | new_n112_);
  assign new_n432_ = ~new_n421_ & (~x70 | new_n424_ | ~x71);
  assign new_n433_ = ~new_n435_ & (x70 | (~new_n434_ & (x71 | new_n424_ | new_n112_)));
  assign new_n434_ = ~x67 & x71 & x15 & ~x66;
  assign new_n435_ = ~x67 & x70 & ~x71 & x47 & ~x66;
  assign new_n436_ = ~x69 & ~new_n112_ & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
endmodule
