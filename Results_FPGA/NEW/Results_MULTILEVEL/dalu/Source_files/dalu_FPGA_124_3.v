...
module FAU ( 
  ...
  assign new_n327_ = x70 & ((~x65 & new_n330_ & x68) | (~x15 & x65 & new_n328_ & ~x68));
  ...
  assign new_n380_ = x70 & ((~x65 & new_n383_ & x68) | (~x15 & x65 & new_n381_ & ~x68));
  ...
  assign z15 = (~new_n419_ & ~x65) | (~x64 & ~new_n433_ & x65);
  assign new_n419_ = x64 ? ((new_n430_ | (~x66 ^ x67)) & (x66 | new_n420_ | x67)) : ~new_n428_;
  assign new_n420_ = (x15 | x68 | ~x69 | (~new_n421_ & ~new_n424_)) & (~x68 | ~new_n427_ | x69);
  ...
  assign new_n427_ = ~x70 & ~x71 & (new_n425_ | new_n426_ | (~new_n127_ & x63));
  assign new_n428_ = x68 & new_n429_ & ~x69;
  assign new_n429_ = ~new_n112_ & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n430_ = (~new_n108_ | ~x47 | ~x68) & (x68 | (~new_n431_ & ~new_n432_));
  assign new_n431_ = ~x15 & ((x47 & x70 & x71) | (~x70 & ~x71 & x63 & x69));
  assign new_n432_ = ~x69 & ((x70 & (x71 ? x47 : x31)) | (x15 & ~x70 & x71));
  assign new_n433_ = (~x68 | x69 | (~new_n434_ & ~new_n437_)) & (x15 | x68 | ~new_n436_ | ~x69);
  assign new_n434_ = ~x70 & ((~x71 & ~new_n435_ & (x66 | x67)) | (x15 & ~x66 & ~x67 & x71));
  assign new_n435_ = ~new_n425_ & ~new_n426_ & (new_n127_ | ~x63);
  assign new_n436_ = ~new_n112_ & (new_n421_ | new_n424_);
  assign new_n437_ = ~x67 & x70 & ~x71 & x47 & ~x66;
endmodule
