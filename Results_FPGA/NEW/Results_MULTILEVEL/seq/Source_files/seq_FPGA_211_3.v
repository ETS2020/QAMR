...
module FAU ( 
  ...
  assign new_n227_ = (new_n228_ | ~x35) & (~new_n89_ | ~new_n255_ | x20) & (new_n244_ | x35);
  ...
  assign new_n244_ = (x20 | new_n254_ | ~x36) & (x05 | x36 | (~new_n245_ & new_n248_));
  ...
  assign new_n419_ = x35 & ((~x05 & ~new_n420_ & ~x36) | (~x20 & x36 & ~x38));
  ...
  assign new_n454_ = (~new_n455_ | ~x04 | x20 | ~x36 | ~x37) & (~new_n155_ | x36 | x37);
  ...
  assign new_n620_ = ~new_n621_ & (~new_n281_ | ~x04 | x20 | ~x36 | ~x37);
