...
module FAU ( 
  ...
  assign z00 = (x12 & (x03 | (x02 & (~x04 | x05)))) | (~x02 & (x03 | x04 | ~x05));
  ...
  assign new_n38_ = (x02 | ~x05 | x07 | x12 | new_n39_ | ~x13) & (~x02 | x05 | ~x12 | x13);
  ...
  assign z09 = x06 & x13 & (~x02 | x12);
  assign z10 = ~x03 & x06 & (~x02 | (~x05 & x12));
endmodule
