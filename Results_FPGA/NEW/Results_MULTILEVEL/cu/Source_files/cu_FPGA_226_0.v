// Benchmark "FAU" written by ABC on Thu Aug  6 17:17:14 2020
...
module FAU ( 
  ...
  assign z00 = x03 | (x09 & (x02 ? (~x04 | x05) : (x04 | ~x05)));
  assign z01 = ~x03 & x09 & (x02 ? (x04 & ~x05) : (~x04 & x05));
  ...
  assign z06 = ~x03 & x04 & ~new_n38_ & x09;
  ...
  assign new_n42_ = x04 & x09 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x06 & x13 & (x03 | x09);
  assign z10 = ~x03 & x06 & x09 & (~x02 | ~x05);
endmodule
