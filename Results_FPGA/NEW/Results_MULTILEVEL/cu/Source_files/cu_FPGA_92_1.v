...
module FAU ( 
  ...
  assign new_n36_ = (~new_n37_ | x02 | ~x05 | ~x00 | x01) & (~x02 | x05 | x13);
  assign new_n37_ = ~x12 & x13 & ~x07 & ~x09;
  assign new_n38_ = ~x02 & x05 & ~x07 & ~x12 & ~new_n39_ & x13;
  assign new_n39_ = (~x06 | (x00 ? (~x01 | x11) : (x01 | x08))) & (x10 | ((~x01 | x11) & (x00 | (~x01 & x08))));
  assign z08 = ~x03 & new_n41_ & x04;
  assign new_n41_ = (x06 | ~x10) & ((x02 & ~x05 & ~x13) | (~x12 & x13 & ~x02 & x05));
  assign z09 = x06 & x13;
