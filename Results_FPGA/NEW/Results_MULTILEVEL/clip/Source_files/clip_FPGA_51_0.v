...
module FAU ( 
  ...
  assign z1 = (~new_n26_ & (~x1 | (x2 & x6))) | (~new_n24_ & ~x6) | (x1 & ~x2 & ~new_n27_ & x6);
  assign new_n24_ = (~x1 | ~x2 | ((~x4 | ~x7) & (~x3 | x4 | x7))) & ~new_n25_ & ((x1 & x2) | ((x4 | ~x7) & (~x3 | ~x4 | x7)));
  assign new_n25_ = x0 & ~x5 & ((x7 & (x3 | x8)) | (x3 & (x4 | x8)));
  assign new_n26_ = (((x4 | ~x7) & (~x3 | ~x4 | x7)) | (~x0 & x5)) & (x4 | ~x7 | (x3 & ~x8));
  assign new_n27_ = ((~x0 & x5) | ((~x4 | ~x7) & (~x3 | x4 | x7))) & (~x7 | ~x8 | x3 | ~x4);
  assign z2 = new_n29_ | (~new_n32_ & ~x6) | (new_n34_ & ~x3);
  assign new_n29_ = (x0 | ~x5) & (new_n31_ | (~new_n30_ & x3));
  assign new_n30_ = (~x6 | (x8 ? ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))) : ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4))))) & (x1 | x4 | x8);
  assign new_n31_ = x4 & x7 & ~x8 & x1 & ~x2 & ~x3;
  assign new_n32_ = new_n33_ & (~x0 | x5 | (~x3 & (~x7 | ~x8)));
  assign new_n33_ = x3 ? (x8 ? ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))) : ((x4 | x7) & ((x4 & x7) | (x1 & x2)))) : (~x7 | x8 | (~x4 & (~x1 | ~x2)));
  ...
  assign new_n38_ = x5 & (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign new_n39_ = ~x4 & x8 & (~x1 | x2);
  assign new_n40_ = ~x5 & ((x1 & ~x2 & (x4 | ~x7)) | ~x8 | (x4 & ~x7));
  assign new_n41_ = (~x6 | ((x3 | ~x8) & (new_n43_ | (x3 & ~x8)))) & (x5 | x6) & (x3 | (~new_n42_ & (x6 | x8)));
