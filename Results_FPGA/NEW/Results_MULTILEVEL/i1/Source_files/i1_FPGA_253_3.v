...
module FAU ( 
  ...
  assign new_n45_ = (x00 | (x01 & x08)) & (x01 | x02 | ~new_n46_ | x03);
  assign new_n46_ = ~x04 & ~x05 & ~x06 & ~x07 & (~x08 ^ x09);
  assign z02 = x19 & (new_n50_ | (x00 & (x01 ? ~x08 : ~new_n48_)));
  assign new_n48_ = new_n49_ & ~x05 & ~x02 & ~x03 & ~x04;
  ...
  assign z05 = (~x01 & (x10 | (new_n55_ & new_n49_ & ~x08 & x19))) | (~x08 & x10);
  assign new_n55_ = ~x04 & ~x05 & ~x02 & ~x03;
  ...
  assign z15 = (~x01 | ~x08) & (x14 | x15 | x12 | x13);
endmodule
