...
module FAU ( 
  ...
  assign z00 = x00 & (x23 | ~x24);
  assign z01 = x19 & ~new_n45_ & (x23 | ~x24);
  assign new_n45_ = x00 & (x01 | x02 | ~new_n46_ | x03);
  assign new_n46_ = ~x04 & ~x05 & ~x06 & ~x07 & (~x08 ^ x09);
  assign z02 = x19 & (new_n48_ | new_n50_) & (x23 | ~x24);
  ...
  assign z03 = x20 & (x23 | ~x24);
  assign z04 = (x23 | ~x24) & (x20 | x21);
  assign z05 = (x23 | ~x24) & (new_n55_ | x10);
  assign new_n55_ = new_n51_ & ~x05 & ~x06 & ~x07 & ~x08 & x19;
  assign z06 = x19 & (x23 | ~x24);
  assign z07 = x24 & x18 & x23;
  assign z08 = x11 & (~x24 | (x23 & x24));
  ...
  assign z14 = x16 & ~x24;
  assign z15 = (x12 | x13 | x14 | x15) & (x23 | ~x24);
endmodule
