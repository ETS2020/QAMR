...
module FAU ( 
  ...
  assign z01 = x19 & ((~x00 & (x01 | ~x08)) | (new_n45_ & new_n46_));
  assign new_n45_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n46_ = ~x05 & ~x06 & ~x07 & ~x08 & ~x09;
  assign z02 = x00 & x19 & (x01 | (~new_n48_ & ~x08));
  assign new_n48_ = ~x02 & ~x03 & ~x04 & ~x05 & ~x06 & ~x07;
  assign z03 = x20 & (x01 | ~x08);
  assign z04 = (x20 | x21) & (x01 | ~x08);
  assign z05 = (~x08 & (x10 | (new_n45_ & new_n52_))) | (x01 & x10);
  assign new_n52_ = ~x05 & ~x06 & ~x07 & x19;
