// Benchmark "FAU" written by ABC on Thu Aug  6 17:32:26 2020
...
module FAU ( 
  ...
  assign z01 = (x27 ? ~x09 : ~x20) & (~x07 | ~x18);
  ...
  assign z09 = x16 ? (~new_n58_ & (~x07 | ~x18)) : ((x00 & ~x07 & x18) | (x08 & ~x18));
  assign new_n58_ = x17 ^ x19;
  assign z10 = x16 ? (~new_n60_ & (~x07 | ~x18)) : ((x01 & ~x07 & x18) | (x09 & ~x18));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n62_ & (~x07 | ~x18)) : ((x02 & ~x07 & x18) | (x10 & ~x18));
  assign new_n62_ = ~new_n64_ & (new_n63_ | ~x21);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z12 = x16 ? (~new_n66_ & (~x07 | ~x18)) : ((x03 & ~x07 & x18) | (x11 & ~x18));
  assign new_n66_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? (~new_n68_ & (~x07 | ~x18)) : ((x04 & ~x07 & x18) | (x12 & ~x18));
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n70_ & (~x07 | ~x18)) : ((x05 & ~x07 & x18) | (x13 & ~x18));
  ...
  assign z16 = (x16 & ~new_n76_ & (~x07 | ~x18)) | (x15 & ~x16 & ~x18);
