...
module FAU ( 
  ...
  assign z04 = (~x12 & (~x23 | (x25 & x27))) | (~x23 & ~x27);
  assign z05 = ~new_n49_ & (x27 ? ~x13 : ~x24);
  assign z06 = (~x14 & (x25 ? x27 : ~x23)) | (~x23 & ~x25 & ~x27);
  ...
  assign z12 = ~new_n49_ & (x16 ? (new_n68_ | (~new_n65_ & x22)) : ~new_n67_);
  assign new_n67_ = x18 ? ~x03 : ~x11;
  assign new_n68_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z13 = x16 ? ~new_n70_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n70_ = (~x23 | new_n68_ | ~x25) & (~new_n63_ | x21 | x22 | x23);
  assign z14 = x16 ? ~new_n72_ : (~new_n49_ & (x18 ? x05 : x13));
  assign new_n72_ = x23 ? (~x24 | ~x25) : (~new_n73_ & (new_n68_ | ~x24));
  assign new_n73_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x24;
  assign z15 = x16 ? ~new_n75_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n75_ = (~x25 | (new_n63_ & new_n77_)) & (~new_n65_ | ~new_n76_ | x24 | x25);
  assign new_n76_ = ~x22 & ~x23;
  assign new_n77_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z16 = x16 ? ((~new_n79_ & ~x23) | (x25 & x26)) : (~new_n80_ & (~x23 | x25));
  assign new_n79_ = (new_n73_ | ~x26) & (~new_n65_ | x22 | x24 | x25 | x26);
