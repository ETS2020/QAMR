// Benchmark "FAU" written by ABC on Thu Aug  6 17:31:36 2020
...
module FAU ( 
  ...
  assign z13 = x16 ? (~new_n68_ & (x18 | ~x27)) : ((x04 & x18) | (x12 & ~x18 & ~x27));
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n70_ & (x18 | ~x27)) : ((x05 & x18) | (x13 & ~x18 & ~x27));
  ...
  assign z17 = x16 & (x17 ? z08 : new_n78_);
  assign new_n78_ = x19 & ~x20 & ~x21 & new_n79_ & ~x22;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & (x18 | ~x27);
endmodule
