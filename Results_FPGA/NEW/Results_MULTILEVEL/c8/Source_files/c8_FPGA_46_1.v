// Benchmark "FAU" written by ABC on Thu Aug  6 17:31:41 2020
...
module FAU ( 
  ...
  assign z00 = (x27 ? ~x08 : ~x19) & (x04 | ~x18);
  assign z01 = (x27 ? ~x09 : ~x20) & (x04 | ~x18);
  assign z02 = (x27 ? ~x10 : ~x21) & (x04 | ~x18);
  assign z03 = (x27 ? ~x11 : ~x22) & (x04 | ~x18);
  assign z04 = (x27 ? ~x12 : ~x23) & (x04 | ~x18);
  assign z05 = (x27 ? ~x13 : ~x24) & (x04 | ~x18);
  assign z06 = (x27 ? ~x14 : ~x25) & (x04 | ~x18);
  assign z07 = (x27 ? ~x15 : ~x26) & (x04 | ~x18);
  assign z08 = x27 & (x04 | ~x18);
  assign z09 = x16 ? (~new_n58_ & (x04 | ~x18)) : ((x00 & x04 & x18) | (x08 & ~x18));
  assign new_n58_ = x17 ^ x19;
  assign z10 = x16 ? (~new_n60_ & (x04 | ~x18)) : ((x01 & x04 & x18) | (x09 & ~x18));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n62_ & (x04 | ~x18)) : ((x02 & x04 & x18) | (x10 & ~x18));
  assign new_n62_ = ~new_n64_ & (new_n63_ | ~x21);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z12 = x16 ? (~new_n66_ & (x04 | ~x18)) : ((x03 & x04 & x18) | (x11 & ~x18));
  assign new_n66_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? (~new_n68_ & (x04 | ~x18)) : (x18 ? x04 : x12);
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n70_ & (x04 | ~x18)) : ((x04 & x05 & x18) | (x13 & ~x18));
  ...
  assign new_n74_ = (~x04 | ~x06 | ~x18) & (~x14 | x18);
  assign z16 = x16 ? (~new_n76_ & (x04 | ~x18)) : ((x04 & x07 & x18) | (x15 & ~x18));
