// Benchmark "FAU" written by ABC on Thu Aug  6 17:32:20 2020
...
module FAU ( 
  ...
  assign z05 = (x12 & (x27 ? ~x13 : ~x24)) | (~x18 & ((~x24 & ~x27) | (~x12 & ~x13 & x27)));
  assign z06 = (x27 ? ~x14 : ~x25) & (x12 | ~x18);
  assign z07 = (x27 ? ~x15 : ~x26) & (x12 | ~x18);
  ...
  assign z11 = x16 ? (~new_n62_ & (x12 | ~x18)) : ((x02 & x12 & x18) | (x10 & ~x18));
  ...
  assign z13 = (x12 & (x16 ? ~new_n68_ : (x04 | ~x18))) | (x16 & ~new_n68_ & ~x18);
  ...
  assign z17 = x16 & ~new_n78_ & (x12 | ~x18);
