...
module FAU ( 
  ...
  assign z02 = (~x10 & x27 & (x21 | ~x22)) | (~x21 & ~x22 & ~x27);
  assign z03 = (~x22 & ~x27) | (~x11 & (~x22 | (x21 & x27)));
  ...
  assign new_n63_ = (~x21 | (~x17 & ~x19 & ~x20)) & (x17 | x19 | x20 | x21 | x22);
  assign z12 = x16 ? ~new_n65_ : (~new_n49_ & (x18 ? x03 : x11));
  assign new_n65_ = (x17 | x19 | x20 | x21 | x22) & (~x21 | ~x22);
  assign z13 = x16 ? ~new_n67_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n67_ = (~x21 | ~x23) & (x22 | ((~x23 | (~x17 & ~x19 & ~x20)) & (x17 | x19 | x20 | x21 | x23)));
  assign z14 = x16 ? ((x21 & x24) | (~new_n70_ & ~x22)) : (~new_n69_ & (x21 | ~x22));
  assign new_n69_ = x18 ? ~x05 : ~x13;
  assign new_n70_ = (~x24 | (~x17 & ~x19 & ~x20 & ~x23)) & (x17 | x19 | x20 | x21 | x23 | x24);
  assign z15 = x16 ? ~new_n72_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n72_ = (~x21 | ~x25) & (x22 | ((~new_n73_ | ~new_n75_) & (new_n74_ | ~x25)));
  assign new_n73_ = ~x17 & ~x19 & ~x20;
  assign new_n74_ = ~x17 & ~x19 & ~x20 & ~x23 & ~x24;
  assign new_n75_ = ~x24 & ~x25 & ~x21 & ~x23;
  assign z16 = x16 ? ((x21 & x26) | (~new_n77_ & ~x22)) : (~new_n79_ & (x21 | ~x22));
  assign new_n77_ = (~x26 | (new_n73_ & ~x23 & ~x24 & ~x25)) & (~new_n78_ | x23 | x24 | x25 | x26);
  assign new_n78_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n79_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & ((z08 & x17) | (new_n82_ & new_n81_ & ~x17 & x19));
