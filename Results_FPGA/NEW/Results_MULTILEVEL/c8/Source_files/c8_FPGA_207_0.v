...
module FAU ( 
  ...
  assign z13 = x16 ? (~new_n68_ & (x12 | x18)) : (x18 ? x04 : x12);
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n70_ & (x12 | x18)) : ((x05 & x18) | (x12 & x13 & ~x18));
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? ((new_n72_ | new_n73_) & (x12 | x18)) : ~new_n74_;
  assign new_n72_ = x25 & (~new_n63_ | x21 | x22 | x23 | x24);
  assign new_n73_ = new_n64_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n74_ = (~x06 | ~x18) & (~x12 | ~x14 | x18);
  assign z16 = x16 ? (~new_n76_ & (x12 | x18)) : ((x07 & x18) | (x12 & x15 & ~x18));
