...
module FAU ( 
  ...
  assign z09 = x16 ? (x17 ? (x19 & x27) : ~x19) : (~new_n57_ & (~x19 | x27));
  assign new_n57_ = x18 ? ~x00 : ~x08;
  assign z10 = x16 ? (x19 ? (x20 & x27) : (~x17 ^ x20)) : (~new_n59_ & (~x19 | x27));
  assign new_n59_ = x18 ? ~x01 : ~x09;
  assign z11 = x16 ? ~new_n62_ : (~new_n61_ & (x18 ? x02 : x10));
  assign new_n61_ = x19 & ~x27;
  assign new_n62_ = x19 ? (~x21 | ~x27) : ((~x21 | (~x17 & ~x20)) & (x17 | x20 | x21));
  assign z12 = x16 ? ~new_n64_ : (~new_n61_ & (x18 ? x03 : x11));
  assign new_n64_ = x19 ? (~x22 | ~x27) : (~new_n66_ & (new_n65_ | ~x22));
  assign new_n65_ = ~x17 & ~x20 & ~x21;
  assign new_n66_ = ~x21 & ~x22 & ~x17 & ~x20;
  assign z13 = x16 ? (x19 ? (x23 & x27) : ~new_n69_) : (~new_n68_ & (~x19 | x27));
  assign new_n68_ = x18 ? ~x04 : ~x12;
  assign new_n69_ = (~x23 | (~x21 & ~x22 & ~x17 & ~x20)) & (x17 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (x19 ? (x24 & x27) : ~new_n72_) : (~new_n71_ & (~x19 | x27));
  assign new_n71_ = x18 ? ~x05 : ~x13;
  assign new_n72_ = (~x24 | (~x17 & ~x20 & ~x21 & ~x22 & ~x23)) & (x17 | x20 | x21 | x22 | x23 | x24);
  assign z15 = x16 ? (x19 ? (x25 & x27) : ~new_n74_) : (~new_n75_ & (~x19 | x27));
  assign new_n74_ = (~x25 | (new_n65_ & ~x22 & ~x23 & ~x24)) & (~new_n65_ | x22 | x23 | x24 | x25);
  assign new_n75_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? (x19 ? (x26 & x27) : ~new_n77_) : (~new_n80_ & (~x19 | x27));
  assign new_n77_ = (~x26 | (new_n65_ & new_n78_)) & (~new_n66_ | ~new_n79_);
  assign new_n78_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n79_ = ~x25 & ~x26 & ~x23 & ~x24;
  assign new_n80_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & ~new_n82_ & x27;
  assign new_n82_ = ~x17 & (~new_n79_ | x21 | x22 | ~x19 | x20);
  assign z08 = x27;
endmodule
