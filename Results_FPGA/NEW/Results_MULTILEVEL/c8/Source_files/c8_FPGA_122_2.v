...
module FAU ( 
  ...
  assign new_n63_ = x17 ? (~x21 | ~x24) : ((x19 | x20 | x21) & (~x21 | (~x19 & ~x20)));
  ...
  assign new_n70_ = (~x24 | (new_n68_ & ~x17 & ~x21 & ~x22 & ~x23)) & (~new_n68_ | x17 | x21 | x22 | x23 | x24);
  assign z15 = x16 ? ((x24 & x25) | (~new_n72_ & ~x17)) : (~new_n74_ & (~x17 | x24));
  assign new_n72_ = (~x25 | (~x19 & ~x20 & new_n73_ & ~x21)) & (x19 | x20 | x21 | ~new_n73_ | x24 | x25);
  assign new_n73_ = ~x22 & ~x23;
  assign new_n74_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ~new_n76_ : (~new_n49_ & (x18 ? x07 : x15));
  assign new_n76_ = (~x24 | ~x26) & (x17 | ((~new_n77_ | ~new_n79_) & (new_n78_ | ~x26)));
  assign new_n77_ = ~x21 & ~x22 & ~x19 & ~x20;
  assign new_n78_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x25;
  assign new_n79_ = ~x25 & ~x26 & ~x23 & ~x24;
  assign z17 = x16 & (new_n81_ | (x17 & x24 & x27));
