...
module FAU ( 
  ...
  assign z12 = ~new_n57_ & (x16 ? (new_n67_ | (~new_n64_ & x22)) : ~new_n66_);
  assign new_n66_ = x18 ? ~x03 : ~x11;
  assign new_n67_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z13 = ~new_n57_ & (x16 ? ~new_n69_ : (x18 ? x04 : x12));
  assign new_n69_ = (new_n67_ | ~x23) & (~new_n62_ | x21 | x22 | x23);
  assign z14 = ~new_n57_ & (x16 ? ~new_n71_ : (x18 ? x05 : x13));
  assign new_n71_ = (~x24 | (new_n62_ & ~x21 & ~x22 & ~x23)) & (~new_n62_ | x21 | x22 | x23 | x24);
  assign z15 = ~new_n57_ & (x16 ? (new_n74_ | (~new_n73_ & x25)) : ~new_n75_);
  assign new_n73_ = new_n62_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n74_ = new_n64_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n75_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? (new_n77_ | (~new_n74_ & x26)) : (~new_n78_ & (x26 | x27));
  assign new_n77_ = new_n67_ & ~x23 & ~x24 & ~x25 & ~x26 & x27;
  assign new_n78_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & ~new_n80_ & x27;
  assign new_n80_ = ~x17 & (~new_n81_ | x23 | x24 | x25 | x26);
  assign new_n81_ = ~x21 & ~x22 & x19 & ~x20;
  assign z08 = x27;
endmodule
