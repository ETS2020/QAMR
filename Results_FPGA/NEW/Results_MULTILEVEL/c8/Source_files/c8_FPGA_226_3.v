...
module FAU ( 
  ...
  assign new_n74_ = (~x14 | x18) & (~x06 | x10 | ~x18);
  assign z16 = x16 ? (~new_n76_ & (~x10 | ~x18)) : ((x07 & ~x10 & x18) | (x15 & ~x18));
