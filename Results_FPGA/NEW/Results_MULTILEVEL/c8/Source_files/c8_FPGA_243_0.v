...
module FAU ( 
  ...
  assign z04 = (~x12 & (x24 | x25) & x27) | (~x23 & ~x27 & (x24 | (~x24 & x25)));
  assign z05 = (~x13 & x27 & (x24 | x25)) | (~x24 & x25 & ~x27);
  ...
  assign z12 = ~new_n49_ & (x16 ? ~new_n65_ : (x18 ? x03 : x11));
  ...
  assign z14 = x16 ? ((~new_n70_ & x24) | (new_n69_ & new_n72_)) : new_n71_;
  assign new_n69_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n70_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n71_ = (x24 | x25) & (x18 ? x05 : x13);
  assign new_n72_ = ~x22 & ~x23 & ~x24 & x25;
  assign z15 = x16 ? (x25 & (~new_n74_ | ~new_n76_)) : (~new_n75_ & (x24 | x25));
