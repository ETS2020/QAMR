...
module FAU ( 
  ...
  assign z04 = (~x12 & x27 & (x24 | ~x25)) | (~x23 & ~x27 & (x24 | (~x24 & ~x25)));
  ...
  assign z14 = x16 ? ~new_n69_ : (~new_n49_ & (x18 ? x05 : x13));
  assign new_n69_ = (new_n71_ | ~x24) & (~new_n70_ | x22 | x23 | x24 | x25);
  assign new_n70_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n71_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z15 = x16 ? ~new_n73_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n73_ = (~new_n70_ | x22 | x23 | x24 | x25) & (~x24 | ~x25);
  assign z16 = x16 ? ((x24 & x26) | (~new_n75_ & ~x25)) : (~new_n76_ & (x24 | ~x25));
  assign new_n75_ = (~new_n70_ | x22 | x23 | x24 | x26) & (new_n71_ | ~x26);
