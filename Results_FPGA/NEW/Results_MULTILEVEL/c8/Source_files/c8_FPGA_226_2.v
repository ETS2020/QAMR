// Benchmark "FAU" written by ABC on Thu Aug  6 17:32:24 2020
...
module FAU ( 
  ...
  assign z02 = (~x10 & (~x21 | x27)) | (x18 & ~x21 & ~x27);
  assign z03 = (~x10 | x18) & (x27 ? ~x11 : ~x22);
  assign z04 = (~x10 | x18) & (x27 ? ~x12 : ~x23);
  ...
  assign z11 = (x16 & ~new_n62_ & (~x10 | x18)) | (x02 & ~x16 & x18);
  ...
  assign z15 = x16 ? ((~x10 | x18) & (new_n72_ | new_n73_)) : ~new_n74_;
