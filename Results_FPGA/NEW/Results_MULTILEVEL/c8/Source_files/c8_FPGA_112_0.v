...
module FAU ( 
  ...
  assign z13 = x16 ? ~new_n65_ : ((x04 & x18) | (x12 & x17 & ~x18));
  assign new_n65_ = (~x17 | ~x23) & (~x18 | ((~x23 | (new_n66_ & ~x21 & ~x22)) & (x21 | x22 | x23 | ~new_n66_ | x17)));
  assign new_n66_ = ~x19 & ~x20;
  assign z14 = x16 ? ((~new_n68_ & x18) | (x17 & x24)) : ~new_n69_;
  assign new_n68_ = (~x24 | (new_n66_ & ~x21 & ~x22 & ~x23)) & (~new_n66_ | x17 | x21 | x22 | x23 | x24);
  assign new_n69_ = (~x05 | ~x18) & (~x13 | ~x17 | x18);
  assign z15 = x16 ? ((~new_n71_ & x18) | (x17 & x25)) : ~new_n74_;
  assign new_n71_ = (~x25 | (new_n73_ & ~x22 & ~x23 & ~x24)) & (~new_n72_ | x22 | x23 | x24 | x25);
  assign new_n72_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n73_ = ~x19 & ~x20 & ~x21;
  assign new_n74_ = (~x06 | ~x18) & (~x14 | ~x17 | x18);
  assign z16 = x16 ? ((~new_n76_ & x18) | (x17 & x26)) : ~new_n78_;
  assign new_n76_ = (~x26 | (new_n73_ & new_n77_ & ~x24 & ~x25)) & (~new_n72_ | ~new_n77_ | x24 | x25 | x26);
  assign new_n77_ = ~x22 & ~x23;
  assign new_n78_ = (~x07 | ~x18) & (~x15 | ~x17 | x18);
