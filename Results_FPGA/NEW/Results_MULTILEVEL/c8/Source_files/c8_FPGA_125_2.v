...
module FAU ( 
  ...
  assign z03 = (~x11 & x27 & (~x21 | x22)) | (~x21 & ~x22 & ~x27);
  ...
  assign new_n63_ = (~x21 | ~x22 | (~x17 & ~x19 & ~x20)) & (x20 | x21 | x17 | x19);
  ...
  assign new_n67_ = (x21 | ((~x23 | (~x17 & ~x19 & ~x20)) & (x17 | x19 | x20 | x22 | x23))) & (~x22 | ~x23);
  assign z14 = x16 ? ((~new_n70_ & ~x21) | (x22 & x24)) : (~new_n69_ & (~x21 | x22));
  assign new_n69_ = x18 ? ~x05 : ~x13;
  assign new_n70_ = (~x24 | (~x17 & ~x19 & ~x20 & ~x23)) & (x17 | x19 | x20 | x22 | x23 | x24);
  assign z15 = x16 ? ((x22 & x25) | (~new_n72_ & ~x21)) : (~new_n75_ & (~x21 | x22));
  ...
  assign z16 = x16 ? ((x22 & x26) | (~new_n77_ & ~x21)) : (~new_n79_ & (~x21 | x22));
