...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n53_, new_n59_, new_n61_, new_n63_, new_n65_, new_n71_, new_n72_;
  assign z00 = (~x08 & x27 & (x19 | x22)) | (~x19 & x22 & ~x27);
  assign z01 = (~x09 & x27 & (x19 | x22)) | (~x20 & ~x27 & (x19 | (~x19 & x22)));
  assign z02 = (~x10 & x27 & (x19 | x22)) | (~x21 & ~x27 & (x22 | (x19 & ~x22)));
  assign z03 = (~x11 & x27 & (x19 | x22)) | (x19 & ~x22 & ~x27);
  assign z04 = ~new_n53_ & (x27 ? ~x12 : ~x23);
  assign new_n53_ = ~x19 & ~x22;
  assign z05 = ~new_n53_ & (x27 ? ~x13 : ~x24);
  assign z06 = ~new_n53_ & (x27 ? ~x14 : ~x25);
  assign z07 = ~new_n53_ & (x27 ? ~x15 : ~x26);
  assign z08 = x27 & (x19 | x22);
  assign z09 = x16 ? (x17 ? x19 : (~x19 & x22)) : (~new_n59_ & (x19 | x22));
  ...
  assign z17 = x16 & ((z08 & x17) | (new_n72_ & new_n71_ & ~x17 & x19));
