...
module FAU ( 
  ...
  assign z10 = (~x17 & (x16 ? (~x19 & ~x20) : ~new_n59_)) | (x16 & x20 & (x17 | x19));
  assign new_n59_ = x18 ? ~x01 : ~x09;
  assign z11 = (~x17 & ((~new_n61_ & ~x16) | (x16 & ~x19 & ~x20 & ~x21))) | (x16 & x21 & (x17 | x19 | x20));
  assign new_n61_ = x18 ? ~x02 : ~x10;
  assign z12 = (~new_n63_ & ~x17) | (x16 & x22 & (~new_n65_ | x17 | x19));
  assign new_n63_ = (x16 | (x18 ? ~x03 : ~x11)) & (~new_n64_ | ~x16 | x19);
  assign new_n64_ = ~x20 & ~x21 & ~x22;
  assign new_n65_ = ~x20 & ~x21;
  assign z13 = (~new_n67_ & ~x17) | (x16 & x23 & (~new_n64_ | x17 | x19));
  assign new_n67_ = (x16 | (x18 ? ~x04 : ~x12)) & (~new_n68_ | ~new_n69_);
  assign new_n68_ = x16 & ~x19 & ~x20;
  assign new_n69_ = ~x21 & ~x22 & ~x23;
  assign z14 = (~new_n71_ & ~x17) | (x16 & x24 & (~new_n73_ | ~new_n69_));
  assign new_n71_ = (x16 | (x18 ? ~x05 : ~x13)) & (~new_n68_ | ~new_n72_);
  assign new_n72_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n73_ = ~x17 & ~x19 & ~x20;
  assign z15 = (~new_n75_ & ~x17) | (x16 & x25 & (~new_n73_ | ~new_n72_));
  assign new_n75_ = (x16 | (x18 ? ~x06 : ~x14)) & (~new_n76_ | ~new_n77_);
  assign new_n76_ = ~x20 & ~x21 & x16 & ~x19;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = (new_n79_ & x16) | (~x17 & ((~new_n80_ & ~x16) | (new_n76_ & new_n81_)));
  assign new_n79_ = x26 & (~new_n77_ | ~new_n65_ | x17 | x19);
  assign new_n80_ = x18 ? ~x07 : ~x15;
  assign new_n81_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z17 = x16 & ((x17 & x27) | (new_n81_ & new_n65_ & ~x17 & x19));
endmodule
