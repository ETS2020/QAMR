...
module FAU ( 
  ...
  assign z06 = (~x25 & ~x27) | (~x14 & (~x25 | (~x22 & x27)));
  ...
  assign new_n75_ = ~x22 & ((x25 & (~new_n63_ | x21 | x23 | x24)) | (new_n63_ & ~x21 & ~x23 & ~x24 & ~x25));
  assign z16 = x16 ? ((new_n78_ & ~x22) | (~new_n77_ & ~x25)) : (~new_n79_ & (~x22 | ~x25));
  assign new_n77_ = (~x22 | ~x26) & (~new_n65_ | x22 | x23 | x24 | x26);
  assign new_n78_ = x26 & (~new_n63_ | x21 | x23 | x24 | x25);
