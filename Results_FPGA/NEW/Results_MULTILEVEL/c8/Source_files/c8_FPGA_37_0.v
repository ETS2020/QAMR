...
module FAU ( 
  ...
  assign new_n49_ = ~x01 & ~x10;
  assign z01 = ~new_n49_ & (x27 ? ~x09 : ~x20);
  assign z02 = (x01 & (x27 ? ~x10 : ~x21)) | (x10 & ~x21 & ~x27);
  assign z03 = (x01 & ((~x10 & ~x11 & x27) | (~x22 & ~x27))) | (x10 & (x27 ? ~x11 : ~x22));
  ...
  assign z10 = x16 ? (~new_n61_ & (x01 | x10)) : ((x01 & (x09 | x18)) | (x09 & x10 & ~x18));
  assign new_n61_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n63_ & (x01 | x10)) : ((x10 & ~x18) | (x02 & (x10 | (x01 & x18))));
