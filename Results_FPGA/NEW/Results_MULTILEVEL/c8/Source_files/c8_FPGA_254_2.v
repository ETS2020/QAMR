...
module FAU ( 
  ...
  assign new_n62_ = (~x21 | ~x27 | (~x17 & ~x19 & ~x20)) & (x20 | x21 | x17 | x19);
  assign z12 = x16 ? ~new_n64_ : (~new_n57_ & (x18 ? x03 : x11));
  assign new_n64_ = x21 ? (~x22 | ~x27) : (~new_n66_ & (new_n65_ | ~x22));
  assign new_n65_ = ~x17 & ~x19 & ~x20;
  assign new_n66_ = ~x20 & ~x22 & ~x17 & ~x19;
  assign z13 = x16 ? (x21 ? (x23 & x27) : ~new_n69_) : (~new_n68_ & (~x21 | x27));
  assign new_n68_ = x18 ? ~x04 : ~x12;
  assign new_n69_ = (~x23 | (~x20 & ~x22 & ~x17 & ~x19)) & (x17 | x19 | x20 | x22 | x23);
  ...
  assign z16 = x16 ? (x21 ? (x26 & x27) : ~new_n77_) : (~new_n80_ & (~x21 | x27));
