// Benchmark "FAU" written by ABC on Thu Aug  6 17:31:45 2020
...
module FAU ( 
  ...
  assign z03 = (~x11 & (~x22 | (x25 & x27))) | (~x22 & ~x27);
  assign z04 = ~new_n49_ & (x27 ? ~x12 : ~x23);
  assign z05 = ~new_n49_ & (x27 ? ~x13 : ~x24);
  assign z06 = (~x14 & (x25 ? x27 : ~x22)) | (~x22 & ~x25 & ~x27);
  ...
  assign new_n67_ = (~x22 | ~x25 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? (x22 ? (x23 & x25) : ~new_n70_) : (~new_n69_ & (~x22 | x25));
  assign new_n69_ = x18 ? ~x04 : ~x12;
  assign new_n70_ = (x17 | x19 | x20 | x21 | x23) & (~x23 | (~x20 & ~x21 & ~x17 & ~x19));
  assign z14 = x16 ? (x22 ? (x24 & x25) : ~new_n73_) : (~new_n72_ & (~x22 | x25));
  assign new_n72_ = x18 ? ~x05 : ~x13;
  assign new_n73_ = (~x24 | (~x17 & ~x19 & ~x20 & ~x21 & ~x23)) & (x17 | x19 | x20 | x21 | x23 | x24);
  assign z15 = x16 ? ~new_n75_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n75_ = (~x25 | (new_n63_ & new_n76_)) & (~new_n65_ | ~new_n77_);
  assign new_n76_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n77_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign z16 = x16 ? ((x25 & x26) | (~new_n79_ & ~x22)) : (~new_n81_ & (~x22 | x25));
  assign new_n79_ = (new_n80_ | ~x26) & (~new_n65_ | x23 | x24 | x25 | x26);
  assign new_n80_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
