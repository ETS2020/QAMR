...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n53_, new_n59_, new_n61_, new_n63_, new_n70_, new_n71_;
  assign z00 = (~x08 & x27 & (x19 | x21)) | (~x19 & x21 & ~x27);
  assign z01 = (~x09 & x27 & (x19 | x21)) | (~x20 & ~x27 & (x19 | (~x19 & x21)));
  ...
  assign z10 = x16 ? ((x20 & (x19 | (x17 & x21))) | (~x17 & ~x19 & ~x20 & x21)) : (~new_n61_ & (x19 | x21));
  assign new_n61_ = x18 ? ~x01 : ~x09;
  assign z11 = x16 ? (x21 & (x17 | x19 | x20)) : (~new_n63_ & (x19 | x21));
  assign new_n63_ = x18 ? ~x02 : ~x10;
  assign z12 = ~new_n53_ & (x16 ? x22 : (x18 ? x03 : x11));
  ...
  assign z17 = x16 & ((x17 & ~new_n53_ & x27) | (new_n70_ & new_n71_));
