...
module FAU ( 
  ...
  assign z05 = (~x13 & (~x24 | (~x25 & x27))) | (~x24 & ~x27);
  assign z06 = (~x25 & ~x27) | (~x14 & (~x25 | (~x24 & x27)));
  ...
  assign z13 = ~new_n49_ & (x16 ? ~new_n69_ : (x18 ? x04 : x12));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? ~new_n71_ : (~new_n49_ & (x18 ? x05 : x13));
  assign new_n71_ = (~x24 | x25 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? new_n73_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n73_ = ~x24 & ((x25 & (~new_n63_ | x21 | x22 | x23)) | (new_n63_ & ~x23 & ~x25 & ~x21 & ~x22));
  assign z16 = x16 ? ((new_n76_ & ~x24) | (~new_n75_ & ~x25)) : (~new_n77_ & (~x24 | ~x25));
  assign new_n75_ = (~new_n65_ | x22 | x23 | x24 | x26) & (~x24 | ~x26);
  assign new_n76_ = x26 & (~new_n63_ | x21 | x22 | x23 | x25);
  assign new_n77_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & ((z08 & x17) | (new_n80_ & new_n79_ & ~x17 & x19));
