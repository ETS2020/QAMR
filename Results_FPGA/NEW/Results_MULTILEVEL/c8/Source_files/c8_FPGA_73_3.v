...
module FAU ( 
  ...
  assign new_n61_ = x17 ? (x18 | ~x21) : ((~x21 | (~x19 & ~x20)) & (x19 | x20 | x21));
  ...
  assign new_n67_ = x17 ? (x18 | ~x23) : ((~x23 | (new_n68_ & ~x21 & ~x22)) & (~new_n68_ | x21 | x22 | x23));
  ...
  assign z17 = x16 & (new_n81_ | (x17 & ~x18 & x27));
  assign new_n81_ = new_n82_ & ~x20 & ~x21 & ~x17 & x19;
  assign new_n82_ = ~x24 & ~x25 & ~x26 & ~x22 & ~x23;
endmodule
