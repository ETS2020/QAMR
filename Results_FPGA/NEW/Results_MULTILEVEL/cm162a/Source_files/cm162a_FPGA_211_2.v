...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & (~x09 | x12)) | (x03 & x08 & x09 & x12 & x13);
  ...
  assign z3 = new_n32_ | (x03 & ((new_n31_ & new_n34_) | (x12 & (~new_n31_ | ~new_n33_))));
  assign new_n31_ = x02 & x04 & ~x08;
  assign new_n32_ = (~x09 | x12) & (~x05 | (~x03 & ~x07));
  assign new_n33_ = ~x10 & ~x11 & (~x09 | ~x13);
  assign new_n34_ = ~x11 & ~x12 & ~x09 & ~x10;
