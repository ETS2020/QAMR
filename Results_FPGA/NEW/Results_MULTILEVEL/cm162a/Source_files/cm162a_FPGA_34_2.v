...
module FAU ( 
  ...
  assign z2 = (~new_n28_ & (~x06 | (x03 & x12))) | (~x05 & (~x06 | x12)) | (~x03 & ~x06);
  assign new_n28_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~new_n23_ & ~x10));
  assign z3 = (x03 & (new_n30_ | new_n32_)) | (~new_n24_ & (~x05 | (~x03 & ~x07)));
  assign new_n30_ = x02 & x04 & new_n31_ & ~x06;
  assign new_n31_ = ~x12 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
