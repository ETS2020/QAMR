...
module FAU ( 
  ...
  assign new_n22_ = (~x08 | (x02 & ~new_n23_ & x04)) & x05 & (~x02 | ~x04 | x08);
  assign new_n23_ = x09 & x13;
  assign z1 = (~new_n25_ & x03) | (~x01 & ~x03 & x05);
  ...
  assign new_n28_ = x11 & (~x02 | ~x04 | x08 | new_n23_ | x10);
  assign z3 = x03 ? (new_n32_ | ~x05 | (~new_n30_ & x04)) : (x05 & ~x07);
