...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = (~x05 & (x03 | ~x07)) | (~new_n22_ & x03) | (~x00 & ~x03 & ~x07);
  ...
  assign z2 = (~new_n27_ & x03) | (~x07 & (~x05 | (~x03 & ~x06)));
