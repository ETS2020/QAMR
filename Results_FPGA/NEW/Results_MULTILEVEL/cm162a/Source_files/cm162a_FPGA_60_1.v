...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n32_;
  assign z0 = (x03 & ((~new_n22_ & (x00 | ~x07)) | (~x05 & ~x07))) | (x00 & ~x05) | (~x00 & ~x03 & ~x07);
