...
module FAU ( 
  ...
  assign new_n25_ = (~x02 | ~x04 | x10 | (~new_n23_ & x08)) & (~x10 | ~x12 | (x02 & x04 & ~new_n23_ & ~x08));
  assign z2 = ~new_n27_ | (~x03 & ((~x06 & (~x10 | x12)) | (~x05 & x12)));
  assign new_n27_ = (new_n28_ | (x10 & (x11 | ~x12))) & (~x03 | (x10 ? (~x11 | ~x12) : new_n29_));
  assign new_n28_ = x05 & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
  assign new_n29_ = (~x11 | (x02 & x04 & ~x08 & (~x09 | ~x13))) & (~x02 | ~x04 | x08 | x11);
  assign z3 = (~new_n31_ & x03) | ((~x10 | x12) & (~x05 | (~x03 & ~x07)));
  assign new_n31_ = (~x02 | ~new_n32_ | ~x04) & (~x12 | (new_n33_ & x02 & x04 & ~x08));
  assign new_n32_ = ~x10 & ~x12 & ((~x08 & ~x11) | (x09 & x13));
