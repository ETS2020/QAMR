...
module FAU ( 
  ...
  assign z1 = (x03 & ((~x05 & ~x12) | (~new_n25_ & (x01 | ~x12)))) | (x01 & ~x05) | (~x01 & ~x03 & ~x12);
  ...
  assign new_n29_ = ~x12 & (new_n23_ | (~x08 & ~x10 & ~x11));
  assign new_n30_ = x01 & x12 & (~new_n31_ | ~x02 | ~x04 | x08);
  assign new_n31_ = ~x10 & ~x11 & (~x09 | ~x13);
  assign new_n32_ = (x01 | ~x12) & (~x05 | (~x03 & ~x07));
