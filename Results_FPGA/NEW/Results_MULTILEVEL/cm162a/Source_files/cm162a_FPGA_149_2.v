...
module FAU ( 
  ...
  assign z1 = (~x00 & (~x05 | (~x01 & ~x03))) | (~new_n25_ & x03);
  assign new_n25_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10))) & x05 & (~x10 | (x02 & x04 & ~new_n23_ & ~x08));
  assign z2 = (~new_n27_ & x03) | (~x00 & (~x05 | (~x03 & ~x06)));
  ...
  assign z3 = (~x00 & (~x05 | (~x03 & ~x07))) | (x03 & (new_n31_ | new_n33_ | ~x05));
