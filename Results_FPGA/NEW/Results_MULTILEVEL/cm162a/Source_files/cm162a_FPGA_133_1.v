...
module FAU ( 
  ...
  assign new_n24_ = (~x10 | (x02 & x04 & ~x08 & (~x09 | ~x13))) & (~x02 | ~x04 | x08 | x10 | x13);
  assign z2 = (~new_n26_ & x03) | ((x10 | ~x13) & (~x05 | (~x03 & ~x06)));
  assign new_n26_ = (~new_n28_ | ~x02) & (~x11 | (~x10 & (x13 | (new_n27_ & x02))));
  assign new_n27_ = x04 & ~x08;
  assign new_n28_ = x04 & ((x09 & x10 & x13) | (~x11 & ~x13 & ~x08 & ~x10));
  assign z3 = (~new_n30_ & x03) | ((x10 | ~x13) & (~x05 | (~x03 & ~x07)));
  assign new_n30_ = (~x02 | new_n31_ | ~x04) & (new_n32_ | ~x12);
  assign new_n31_ = (~x09 | ~x10 | ~x13) & (x08 | x10 | x11 | x12 | x13);
