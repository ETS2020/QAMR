...
module FAU ( 
  ...
  assign new_n24_ = (x05 | (x08 & (x10 | x13))) & (~x03 | (x08 ? (~x10 | x13) : new_n25_));
  ...
  assign new_n28_ = ~x13 & ((~x03 & (~x05 | ~x06)) | (x03 & x08 & x11) | (~x05 & ~x11));
  assign z3 = ~new_n33_ | (~new_n30_ & x03);
  assign new_n30_ = (x08 | ((new_n31_ | ~x04) & (new_n32_ | ~x12))) & (~x12 | x13 | (x04 & ~x08));
  assign new_n31_ = (~x02 | ((~x09 | ~x13) & (x10 | x11 | x12))) & (~x09 | ~x12 | ~x13);
  assign new_n32_ = x02 & x04 & ~x10 & ~x11;
  assign new_n33_ = (x03 | ((x05 | x13) & (x07 | (x08 & x13)))) & (x05 | (x08 & (x12 | x13)));
