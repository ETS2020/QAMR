...
module FAU ( 
  ...
  assign new_n70_ = ~new_n73_ & (x09 | ((new_n71_ | x05) & (~new_n75_ | x07)));
  ...
  assign new_n75_ = x18 & ((~x12 & (x05 | ~x06)) | (x05 & (~x08 | x21)));
  assign new_n76_ = (~x08 | ((new_n78_ | x05) & (x07 | new_n77_ | x09))) & (x08 | x09 | x05 | x07);
  assign new_n77_ = ~x21 & (x04 | x11);
  assign new_n78_ = x02 & ~x07 & x11;
  assign z03 = (~new_n80_ & ~x09) | (new_n82_ & x09 & ~x15 & ~x17 & x18);
  assign new_n80_ = (x17 | new_n81_ | ~x18) & (~x12 | ~x17 | x18 | (x05 & x07));
  ...
  assign z09 = (new_n117_ & ~x07) | (~x17 & x18 & (new_n110_ | (new_n116_ & ~x07)));
  assign new_n110_ = ~x15 & ((~new_n111_ & ~x09) | (x05 & ~new_n74_ & x08));
  ...
  assign z12 = ~x09 & (new_n105_ | (~x07 & (new_n104_ | (new_n125_ & ~x17))));
  ...
  assign z14 = (~new_n135_ & ~x17) | (new_n139_ & ~x05);
  ...
  assign new_n138_ = (~x07 | (x01 & ~x15)) & (~new_n74_ | x14 | x15 | x21);
  assign new_n139_ = ~x09 & x12 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n141_ & ~x18;
  assign new_n141_ = x17 & ~x15 & x12 & ~x09 & x05 & ~x07;
  ...
  assign z17 = ~x09 & (new_n149_ | (new_n67_ & new_n154_ & new_n68_ & ~x17));
  assign new_n149_ = ~x05 & (new_n153_ | (~x07 & (new_n152_ | (new_n150_ & ~x08))));
  assign new_n150_ = ~x15 & ~x17 & x18 & ~new_n151_ & (~x21 | (~x14 & x21));
  assign new_n151_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n152_ = x00 & x12 & x15 & x17 & ~x18;
  assign new_n153_ = x07 & x12 & ~x15 & x17 & ~x18;
  ...
  assign new_n167_ = new_n68_ & new_n154_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n171_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign z28 = (~new_n191_ & ~x17) | (~x09 & x12 & new_n205_ & x17);
