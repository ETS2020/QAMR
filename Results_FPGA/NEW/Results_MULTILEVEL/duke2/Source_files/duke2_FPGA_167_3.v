...
module FAU ( 
  ...
  assign new_n54_ = (x05 | (~new_n55_ & (x00 | ~x15 | ~x17))) & (x00 | ~x17 | (x07 & (~x05 | x15)));
  ...
  assign new_n72_ = x18 & ((~x05 & ~x07 & ~x08 & ~x09) | (~new_n73_ & x08));
  assign new_n73_ = (~new_n74_ | x07) & (x05 | (x02 & ~x07 & x11));
  assign new_n74_ = ~x09 & ((~x04 & ~x11) | x21);
  assign new_n75_ = x08 & x18 & (x05 ? ~new_n56_ : ~x07);
  assign z03 = (~new_n77_ & ~x09) | (new_n80_ & x09 & ~x15 & ~x17 & x18);
  assign new_n77_ = ~new_n78_ & (x17 | new_n79_ | ~x18);
  ...
  assign z06 = ~x09 & (new_n102_ | (~x07 & new_n92_ & ~x17));
  ...
  assign new_n102_ = ~x00 & ~x05 & x07 & ~x15 & x17 & ~x18;
  ...
  assign new_n107_ = (~new_n114_ | x07) & (x15 | (~new_n113_ & (new_n108_ | x09)));
  ...
  assign new_n113_ = x05 & ~new_n56_ & x08;
  ...
  assign new_n117_ = ~x00 & ~x07 & ~x09;
  assign z10 = (new_n120_ & x08) | (~x09 & (new_n78_ | (new_n119_ & ~x06)));
  assign new_n119_ = ~x07 & ~x08 & ~x17 & x18 & (x05 ^ x15);
  assign new_n120_ = ~x15 & ~x17 & x18 & (x05 ? x07 : (~x07 & x09));
  assign z11 = new_n122_ & ~x18;
  assign new_n122_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n102_ | (~x07 & ~x17 & new_n124_ & x18));
  assign new_n124_ = ~x21 & ((~new_n131_ & ~x04) | (~new_n125_ & ~x05) | (new_n130_ & x04));
  ...
  assign z14 = (~new_n134_ & ~x17) | (new_n138_ & ~x00);
  ...
  assign new_n137_ = (~x07 | (x01 & ~x15)) & (~new_n56_ | x14 | x15 | x21);
  ...
  assign z17 = ~x09 & (new_n151_ | (~x05 & ~new_n148_ & ~x15));
  assign new_n148_ = (x07 | x08 | x17 | ~new_n149_ | ~x18) & (x00 | ~x07 | ~x17 | x18);
  ...
  assign new_n157_ = x17 & ~x15 & ~x09 & ~x07 & ~x00 & ~x05;
  ...
  assign new_n165_ = x12 & ~x14 & ~x18 & ~x21;
  ...
  assign z27 = new_n187_ | (~x09 & (new_n102_ | (~x17 & ~new_n184_ & x18)));
  ...
  assign z28 = (~new_n190_ & ~x17) | (~x00 & ~x09 & new_n204_ & x17);
