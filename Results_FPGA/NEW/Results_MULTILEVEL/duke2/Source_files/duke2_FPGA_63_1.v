...
module FAU ( 
  ...
  assign new_n55_ = x13 & x17 & ((x05 & (~x07 | ~x15)) | (~x05 & x15 & (~x00 | x07)) | (~x07 & ~x15));
  ...
  assign new_n103_ = x15 & x17 & ~x18 & x00 & ~x05 & x13;
  ...
  assign new_n141_ = ~x09 & x13 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n143_ & ~x18;
  assign new_n143_ = x17 & ~x15 & x13 & ~x09 & x05 & ~x07;
  ...
  assign new_n154_ = x00 & x13 & x15 & x17 & ~x18;
  assign new_n155_ = x07 & x13 & ~x15 & x17 & ~x18;
  ...
  assign z19 = ~x18 & x17 & ~x15 & x13 & new_n76_ & ~x09;
  ...
  assign z26 = ~x20 & (x13 | ~x17) & (x14 | x21);
  ...
  assign z28 = (~new_n194_ & ~x17) | (~x09 & x13 & new_n208_ & x17);
