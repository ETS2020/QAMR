// Benchmark "FAU" written by ABC on Thu Aug  6 17:59:09 2020
...
module FAU ( 
  ...
  assign new_n54_ = (x07 | (~new_n55_ & (~x05 | ~x15 | ~x17))) & (x05 | ~x15 | ~x17 | (x00 & ~x07));
  assign new_n55_ = new_n56_ & x04 & ~x05 & x12;
  assign new_n56_ = ~x14 & ~x15 & ~x17 & ~x21;
  assign z01 = ~x17 & (new_n58_ | (new_n66_ & new_n68_ & ~x07 & x08));
  assign new_n58_ = ~x05 & (new_n65_ | (~x07 & ~new_n59_ & x18));
  ...
  assign z02 = ~x17 & (x15 ? new_n73_ : (new_n76_ | (~new_n70_ & ~x09)));
  ...
  assign new_n78_ = (x17 | ~x18 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (~x15 | ~x17 | x18 | (x05 & x07));
  ...
  assign z06 = ~x07 & ~x09 & (new_n101_ | (new_n91_ & ~x17));
  ...
  assign new_n94_ = (x06 | ((~x02 | x10) & (~x10 | ~x12 | x13 | x16))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  ...
  assign z09 = ~x17 & (new_n114_ | (x18 & (new_n106_ | (new_n113_ & ~x07))));
  assign new_n106_ = ~x15 & (new_n112_ | (~new_n107_ & ~x09));
  ...
  assign new_n113_ = x08 & ((new_n63_ & x05) | (x02 & ~x05 & ~x11 & ~new_n63_ & x15));
  assign new_n114_ = new_n115_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n115_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign z10 = z13 | (~x17 & ~new_n117_ & x18);
  assign new_n117_ = (x15 | ((~x05 | ((x06 | x07 | x08 | x09) & (~x07 | ~x08))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x15 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = new_n120_ & ~x18;
  assign new_n120_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x07 & ~x09 & (new_n101_ | (~x17 & new_n122_ & x18));
  assign new_n122_ = ~x21 & ((~new_n129_ & ~x04) | (new_n128_ & x04) | (~new_n123_ & ~x05));
  ...
  assign new_n128_ = x08 & ~x12 & ~x15 & (new_n125_ | x05);
  assign new_n129_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign z14 = new_n135_ | (~x17 & (new_n133_ | (x08 & ~new_n131_ & x18)));
  assign new_n131_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n63_ | new_n132_);
  assign new_n132_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n133_ = ~x05 & ~x09 & ~x18 & (new_n134_ | (~x01 & x07));
  assign new_n134_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n135_ = ~x05 & ~x09 & x15 & ~x18 & (x07 | x17);
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n141_ : ~new_n137_);
  ...
  assign z17 = ~x07 & ~x09 & (new_n146_ | (~new_n143_ & ~x05));
  assign new_n143_ = (x08 | x15 | x17 | ~new_n144_ | ~x18) & (~x17 | x18 | ~x00 | ~x15);
  assign new_n144_ = ~new_n145_ & (~x21 | (~x14 & x21));
  assign new_n145_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n146_ = new_n68_ & x08 & ~x11 & new_n67_ & x15 & ~x17;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n148_ & x18;
  assign new_n148_ = (x14 | x15 | (~new_n83_ & ~new_n149_)) & (x08 | ~x15 | ~x19);
  assign new_n149_ = x12 & ((~new_n150_ & ~x06) | (new_n87_ & x06 & x08 & x10));
  assign new_n150_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z20 = new_n152_ & ~x07;
  assign new_n152_ = ~x17 & (new_n159_ | (~x15 & (new_n157_ | (~new_n153_ & x18))));
  assign new_n153_ = (x09 | ((~new_n154_ | x05) & (~new_n155_ | ~x04))) & (~x04 | ~new_n156_ | ~x05);
  assign new_n154_ = ~x06 & ~x08 & ~new_n89_ & (~x14 | ~x21);
  assign new_n155_ = x08 & x10 & ~x12 & ~x14 & ~new_n140_ & ~x21;
  assign new_n156_ = x08 & ~new_n63_ & ~x12;
  assign new_n157_ = new_n158_ & x04 & ~x05 & ~x09;
  assign new_n158_ = ~x18 & ~x21 & x12 & ~x14;
  assign new_n159_ = new_n68_ & x08 & ~x09 & new_n67_ & ~x11 & x15;
  ...
  assign new_n163_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)))));
  ...
  assign new_n170_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  ...
  assign z27 = new_n176_ | (new_n181_ & x03 & ~x05 & ~x07 & x08);
  assign new_n176_ = ~x09 & ((~x17 & ~new_n177_ & x18) | (new_n180_ & x15 & x17 & ~x18));
  assign new_n177_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n178_ & (~x05 | x08 | x15 | ~x19));
  assign new_n178_ = ~x21 & (new_n179_ | (~new_n129_ & ~x04));
  assign new_n179_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n180_ = x00 & ~x05 & ~x07;
  assign new_n181_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n183_ & ~x17) | (~x09 & x15 & new_n197_ & x17);
  assign new_n183_ = (~new_n196_ | x05) & (~x18 | (~new_n194_ & (x05 | (~new_n184_ & new_n187_))));
  assign new_n184_ = ~new_n185_ & ~x02;
  assign new_n185_ = (~x08 | ~x15) & (~new_n186_ | ~x11 | x14 | x15 | ~x21);
  assign new_n186_ = ~x08 & ~x09 & x06 & ~x07;
  ...
  assign new_n197_ = ~x18 & (~x07 | (~x05 & ~x19));
  assign z15 = 1'b0;
  assign z19 = 1'b0;
endmodule
