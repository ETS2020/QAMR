...
module FAU ( 
  ...
  assign new_n55_ = x08 & x17 & ((x05 & (~x07 | ~x15)) | (~x05 & x15 & (~x00 | x07)) | (~x07 & ~x15));
  ...
  assign z02 = ~x17 & (x15 ? (~new_n74_ & x18) : ~new_n69_);
  ...
  assign new_n74_ = (x05 | x07 | x08 | x09) & (~x08 | ((new_n76_ | x05) & (x07 | new_n75_ | x09)));
  assign new_n75_ = ~x21 & (x04 | x11);
  assign new_n76_ = x02 & ~x07 & x11;
  assign z03 = (~new_n78_ & ~x09) | (new_n79_ & x09 & ~x15 & ~x17 & x18);
  assign new_n78_ = (x17 | ~x18 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (~x08 | ~x17 | x18 | (x05 & x07));
  assign new_n79_ = ~x05 & ~x07 & x08;
  assign z04 = ~x14 & ~x20 & (x08 | ~x17);
  ...
  assign z12 = ~x09 & (new_n103_ | (~x07 & (new_n101_ | (new_n125_ & ~x17))));
  ...
  assign z14 = (~new_n135_ & x08) | (~x05 & new_n139_ & ~x09);
  assign new_n135_ = (x17 | new_n136_ | ~x18) & (x05 | x09 | new_n138_ | x18);
  assign new_n136_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n64_ | new_n137_);
  assign new_n137_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n138_ = (~x15 | ~x17) & (~x07 | (~x15 & ~x17));
  assign new_n139_ = ~x17 & ~x18 & (new_n140_ | (x07 & (~x01 | x15)));
  assign new_n140_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign z15 = new_n142_ & ~x18;
  assign new_n142_ = x17 & ~x15 & ~x09 & x08 & x05 & ~x07;
  ...
  assign new_n150_ = (x07 | ((x08 | ~new_n151_ | x15) & (~x00 | ~x08 | ~new_n102_ | ~x15))) & (~x07 | ~x08 | ~new_n102_ | x15);
  ...
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & new_n159_ & x08;
  ...
  assign z28 = (~new_n192_ & ~x17) | (x08 & ~x09 & new_n206_ & x17);
