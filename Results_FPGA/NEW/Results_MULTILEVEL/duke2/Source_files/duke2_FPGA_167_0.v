...
module FAU ( 
  ...
  assign new_n78_ = (~x00 | x17 | new_n79_ | ~x18) & (~x17 | x18 | (x05 & x07));
  assign new_n79_ = (~x05 | x15 | (~x07 ^ ~x08)) & (~x08 | ~x15 | x05 | ~x07);
  assign new_n80_ = x00 & ~x05 & ~x07 & x08;
  assign z04 = ~x14 & (x00 | x17) & ~x20;
  assign z05 = x00 & ~x05 & ~x07 & ~x09 & new_n83_ & ~x14;
  ...
  assign z06 = ~x09 & (new_n102_ | (x00 & ~new_n91_ & ~x07));
  assign new_n91_ = (x17 | ~x18 | (~new_n100_ & (new_n92_ | x15))) & (x05 | ~x15 | ~x17 | x18);
  ...
  assign new_n96_ = (x06 | ((~x10 | ~x12 | x13 | x16) & (~x02 | x10))) & (x13 | (x10 & (~x06 | ~x10 | ~x12 | ~x16)));
  ...
  assign z07 = x00 & ~x17 & ~new_n104_ & x18;
  assign new_n104_ = (x09 | (~x07 ^ ~x08) | (x05 ^ ~x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & (x00 | x17) & ~x20;
  assign z09 = new_n117_ | (x00 & (new_n115_ | (~x17 & ~new_n107_ & x18)));
  ...
  assign new_n122_ = ~x15 & ~x09 & x07 & ~x05 & x00 & x01;
  assign z12 = ~x09 & (new_n102_ | (x00 & ~new_n124_ & ~x07));
  assign new_n124_ = (~new_n134_ | ~x17 | x18) & (x17 | ~x18 | x21 | (new_n125_ & ~new_n132_));
  ...
  assign new_n136_ = ~x17 & (new_n115_ | (x08 & ~new_n137_ & x18));
  ...
  assign z17 = ~x09 & (new_n102_ | (x00 & ~x07 & (new_n150_ | new_n153_)));
  assign new_n150_ = ~x05 & ((x15 & x17 & ~x18) | (~x08 & ~x15 & ~x17 & new_n151_ & x18));
  assign new_n151_ = ~new_n152_ & (~x21 | (~x14 & x21));
  assign new_n152_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n153_ = new_n154_ & x08 & ~x11 & new_n67_ & x15 & ~x17;
  assign new_n154_ = ~x04 & x05;
  assign z18 = x00 & ~x05 & ~x07 & ~x09 & new_n156_ & ~x17;
  assign new_n156_ = x18 & ((~x14 & ~new_n157_ & ~x15) | (~x08 & x15 & x19));
  assign new_n157_ = ~new_n84_ & (~x12 | (~new_n159_ & (new_n158_ | x06)));
