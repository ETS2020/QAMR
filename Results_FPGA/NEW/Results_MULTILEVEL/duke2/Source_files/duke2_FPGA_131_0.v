...
module FAU ( 
  ...
  assign new_n65_ = x11 & x13 & x15 & ~x18;
  ...
  assign new_n71_ = x01 & x07 & x13 & ~x18 & (x08 | x16);
  ...
  assign new_n79_ = (x17 | new_n80_ | ~x18) & (~x13 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n103_ = x00 & ~x05 & x13 & x15 & x17 & ~x18;
  assign new_n104_ = ~x05 & x07 & x13 & ~x15 & x17 & ~x18;
  assign z07 = ~x17 & ~new_n106_ & x18;
  assign new_n106_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20 & (x13 | x18);
  assign z09 = (new_n117_ & ~x07) | (~x17 & x18 & (new_n109_ | (new_n116_ & ~x07)));
  assign new_n109_ = ~x15 & (new_n115_ | (~new_n110_ & ~x09));
  ...
  assign new_n116_ = x08 & ((new_n63_ & x05) | (x02 & ~x05 & ~x11 & ~new_n63_ & x15));
  assign new_n117_ = ~x09 & x13 & ~x15 & ~new_n118_ & ~x18;
  ...
  assign z13 = ~x09 & x13 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = ~x18 & new_n123_ & ~x17;
  assign new_n123_ = ~x15 & x13 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n104_ | (~x07 & (new_n103_ | (new_n125_ & ~x17))));
  assign new_n125_ = x18 & ~x21 & (new_n131_ | new_n133_ | (~new_n126_ & ~x05));
  ...
  assign new_n133_ = x04 & x08 & ~x12 & ~x15 & (new_n128_ | x05);
  assign z14 = new_n135_ | (~x05 & new_n140_ & ~x09);
  assign new_n135_ = ~x17 & (new_n138_ | (x08 & ~new_n136_ & x18));
  assign new_n136_ = x07 ? (x19 | (x05 ^ ~x15)) : (new_n63_ | new_n137_);
  assign new_n137_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n138_ = new_n139_ & x04 & ~x05 & ~x07 & ~x09 & x12;
  assign new_n139_ = x13 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n140_ = x13 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n142_ & ~x18;
  assign new_n142_ = x17 & ~x15 & x13 & ~x09 & x05 & ~x07;
  ...
  assign z17 = ~x09 & (new_n150_ | (new_n67_ & new_n155_ & new_n68_ & ~x17));
  assign new_n150_ = ~x05 & (new_n154_ | (~x07 & (new_n153_ | (new_n151_ & ~x08))));
  assign new_n151_ = ~x15 & ~x17 & x18 & ~new_n152_ & (~x21 | (~x14 & x21));
  assign new_n152_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n153_ = x00 & x13 & x15 & x17 & ~x18;
  assign new_n154_ = x07 & x13 & ~x15 & x17 & ~x18;
  assign new_n155_ = ~x11 & x15;
  ...
  assign new_n165_ = x08 & x10 & ~x12 & ~x14 & ~new_n147_ & ~x21;
  assign new_n166_ = x08 & ~new_n63_ & ~x12;
  assign new_n167_ = new_n168_ & x04 & ~x05 & ~x09 & x12;
  assign new_n168_ = ~x18 & ~x21 & x13 & ~x14;
  assign new_n169_ = new_n68_ & new_n155_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign new_n208_ = ~x09 & x13 & x15 & ~x18 & (~x02 | ~x11);
