...
module FAU ( 
  ...
  assign new_n64_ = x10 & x11 & x15 & ~x18;
  ...
  assign new_n70_ = x01 & x07 & x10 & ~x18 & (x08 | x16);
  assign new_n71_ = x18 & (x06 ? (~x02 | ~x11) : (~x04 | ~x12));
  assign new_n72_ = x18 & (~x08 | x21);
  assign new_n73_ = (~x08 | ((x07 | new_n74_ | x09) & (new_n75_ | x05))) & (x08 | x09 | x05 | x07);
  ...
  assign new_n78_ = (x17 | new_n79_ | ~x18) & (~x10 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n102_ = x00 & ~x05 & x10 & x15 & x17 & ~x18;
  assign new_n103_ = ~x05 & x07 & x10 & ~x15 & x17 & ~x18;
  ...
  assign new_n108_ = (x17 | new_n109_ | ~x18) & (x07 | ~x10 | x18 | (~new_n114_ & ~x17));
  ...
  assign new_n122_ = ~x15 & x10 & ~x09 & x07 & x01 & ~x05;
  ...
  assign z17 = ~x09 & (new_n150_ | (new_n66_ & new_n155_ & new_n67_ & ~x17));
  ...
  assign new_n158_ = ~new_n84_ & (~x12 | ((new_n160_ | x06) & (~new_n88_ | ~new_n159_ | ~x06)));
  ...
  assign new_n165_ = ~x06 & ~x08 & ~new_n90_ & (~x14 | ~x21);
  assign new_n166_ = x08 & x10 & ~x12 & ~x14 & ~new_n147_ & ~x21;
  assign new_n167_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n168_ = new_n169_ & x04 & ~x05 & ~x09 & x10;
  assign new_n169_ = ~x18 & ~x21 & x12 & ~x14;
  assign new_n170_ = new_n67_ & new_n155_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign new_n179_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x10 | ~x12 | x14 | x18);
  assign new_n180_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n181_ = x01 & ~x05 & x07 & new_n159_ & ~x15 & ~x18;
  ...
  assign new_n187_ = ~x21 & (new_n130_ | new_n188_);
