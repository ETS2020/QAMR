...
module FAU ( 
  ...
  assign new_n108_ = (x17 | (~new_n114_ & (new_n109_ | ~x18))) & (~x17 | x18 | ~x06 | x07);
  ...
  assign z28 = (~x17 & (new_n192_ | new_n204_)) | (x06 & ~x09 & new_n206_ & x17);
  assign new_n192_ = x18 & (new_n202_ | (~x05 & (~new_n193_ | (~new_n200_ & ~x02))));
