...
module FAU ( 
  ...
  assign new_n80_ = x03 & ~x05 & ~x07 & x08;
  assign z04 = ~x14 & (x03 | x17) & ~x20;
  ...
  assign new_n97_ = (x06 | ((~x10 | ~x12 | x13 | x16) & (~x02 | x10))) & (x13 | (x10 & (~x06 | ~x10 | ~x12 | ~x16)));
  ...
  assign new_n195_ = new_n80_ & x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n196_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (x03 & ~new_n198_ & ~x17) | (~x09 & new_n212_ & x17);
  assign new_n198_ = (~new_n211_ | x05) & (~x18 | (~new_n209_ & (x05 | (~new_n199_ & new_n202_))));
  assign new_n199_ = ~new_n200_ & ~x02;
  assign new_n200_ = (~x08 | ~x15) & (~new_n201_ | x15 | ~x21 | ~x11 | x14);
  assign new_n201_ = ~x08 & ~x09 & x06 & ~x07;
  assign new_n202_ = (~new_n208_ | ~x08) & (x09 | ((new_n203_ | x07) & (~new_n207_ | ~x08)));
