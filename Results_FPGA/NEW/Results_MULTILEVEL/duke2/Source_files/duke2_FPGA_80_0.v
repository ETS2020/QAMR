...
module FAU ( 
  ...
  assign new_n65_ = x11 & x12 & x15 & ~x18;
  ...
  assign new_n71_ = x01 & x07 & x12 & ~x18 & (x08 | x16);
  ...
  assign new_n103_ = x00 & ~x05 & x12 & x15 & x17 & ~x18;
  ...
  assign new_n117_ = ~x09 & x12 & new_n118_ & ~x15;
  assign new_n118_ = ~x18 & (x17 | (x04 & ~x05 & ~x14 & ~x21));
  ...
  assign new_n123_ = ~x15 & x12 & ~x09 & x07 & x01 & ~x05;
  ...
  assign new_n140_ = x12 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n142_ & ~x18;
  assign new_n142_ = x17 & ~x15 & x12 & ~x09 & x05 & ~x07;
  ...
  assign new_n153_ = x15 & x17 & ~x18 & x00 & x12;
  assign new_n154_ = x07 & x12 & ~x15 & x17 & ~x18;
  ...
  assign new_n173_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)))));
  ...
  assign new_n181_ = ~x15 & ~x18 & x08 & x12;
  ...
  assign z28 = (~new_n194_ & ~x17) | (~x09 & x12 & new_n209_ & x17);
  ...
  assign new_n208_ = ~x09 & x12 & x15 & ~x18 & (~x02 | ~x11);
