...
module FAU ( 
  ...
  assign new_n54_ = ~x18 & ((~x05 & (new_n55_ | (x07 & x15 & x17))) | (x05 & x07 & ~x15 & x17));
  assign new_n55_ = new_n56_ & ~x14 & ~x15 & ~x17 & ~x21;
  ...
  assign new_n73_ = x18 & ((~x05 & ~x07 & ~x08 & ~x09) | (~new_n74_ & x08));
  assign new_n74_ = (~new_n75_ | x07) & (x05 | (x02 & ~x07 & x11));
  assign new_n75_ = ~x09 & (x21 | (~x04 & ~x11));
  assign new_n76_ = x08 & x18 & (x05 ? ~new_n56_ : ~x07);
  assign z03 = (~new_n78_ & ~x09) | (new_n79_ & x09 & ~x15 & ~x17 & x18);
  assign new_n78_ = (x17 | ~x18 | ((~x05 | x15 | (x07 ^ x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (x05 | ~x07 | ~x17 | x18);
  ...
  assign z06 = ~x09 & (new_n101_ | (~x07 & new_n91_ & ~x17));
  ...
  assign z09 = ~x17 & (new_n113_ | (x18 & (new_n106_ | (new_n112_ & ~x07))));
  assign new_n106_ = ~x15 & ((~new_n107_ & ~x09) | (x05 & ~new_n56_ & x08));
  ...
  assign new_n116_ = (x15 | ((~x05 | ((x06 | x07 | x08 | x09) & (~x07 | ~x08))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x05 & x07 & ~x09 & x17 & ~x18;
  assign z11 = new_n119_ & ~x18;
  assign new_n119_ = ~x17 & ~x15 & ~x09 & x01 & ~x05 & x07;
  assign z12 = ~x09 & (new_n101_ | (~x07 & ~x17 & new_n121_ & x18));
  ...
  assign z14 = (new_n133_ & ~x05) | (~x17 & (new_n113_ | (new_n130_ & x08)));
  assign new_n130_ = x18 & (x07 ? new_n132_ : (~new_n64_ & ~new_n131_));
  assign new_n131_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n132_ = ~x19 & (~x05 ^ ~x15);
  assign new_n133_ = x07 & ~x09 & ~x18 & (~x01 | x15 | x17);
  ...
  assign new_n137_ = (new_n61_ | (new_n138_ & (~x02 | ~x06))) & (~x12 | new_n138_ | (x06 ^ ~x16));
  assign new_n138_ = x13 & (x02 | ~x11);
  assign new_n139_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n141_ | (new_n67_ & new_n144_ & new_n68_ & ~x17));
  assign new_n141_ = ~x05 & ~x15 & (x07 ? (x17 & ~x18) : new_n142_);
  assign new_n142_ = ~x08 & ~x17 & x18 & ~new_n143_ & (~x21 | (~x14 & x21));
  assign new_n143_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n144_ = ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n146_ & x18;
  assign new_n146_ = (x14 | x15 | (~new_n83_ & ~new_n147_)) & (x08 | ~x15 | ~x19);
  assign new_n147_ = x12 & ((~new_n148_ & ~x06) | (new_n87_ & x06 & x08 & x10));
  assign new_n148_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z20 = new_n150_ & ~x07;
  assign new_n150_ = ~x17 & (new_n157_ | (~x15 & (new_n155_ | (~new_n151_ & x18))));
  assign new_n151_ = (x09 | ((~new_n152_ | x05) & (~new_n153_ | ~x04))) & (~x04 | ~new_n154_ | ~x05);
  assign new_n152_ = ~x06 & ~x08 & ~new_n89_ & (~x14 | ~x21);
  assign new_n153_ = x08 & x10 & ~x12 & ~x14 & ~new_n138_ & ~x21;
  assign new_n154_ = x08 & ~new_n64_ & ~x12;
  assign new_n155_ = new_n156_ & x04 & ~x05 & ~x09;
  assign new_n156_ = x12 & ~x14 & ~x18 & ~x21;
  assign new_n157_ = new_n68_ & new_n144_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n168_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  ...
  assign z27 = new_n177_ | (~x09 & (new_n101_ | (~x17 & ~new_n174_ & x18)));
  ...
  assign new_n177_ = new_n178_ & ~x07 & x08 & x03 & ~x05;
  assign new_n178_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n180_ & ~x17) | (new_n194_ & x15 & x17 & ~x18 & ~x19);
  assign new_n180_ = (~new_n193_ | x05) & (~x18 | (~new_n191_ & (x05 | (~new_n181_ & new_n184_))));
  assign new_n181_ = ~new_n182_ & ~x02;
  assign new_n182_ = (~x08 | ~x15) & (~new_n183_ | ~x11 | x14 | x15 | ~x21);
  assign new_n183_ = x06 & ~x07 & ~x08 & ~x09;
  assign new_n184_ = (~new_n190_ | ~x08) & (x09 | ((new_n185_ | x07) & (~new_n189_ | ~x08)));
  assign new_n185_ = x08 ? (~x10 | ~new_n188_ | ~x12) : (~new_n186_ & ~new_n187_);
  assign new_n186_ = x15 & ~x19;
  assign new_n187_ = ~x14 & ~x15 & x21 & x04 & ~x06 & ~x12;
