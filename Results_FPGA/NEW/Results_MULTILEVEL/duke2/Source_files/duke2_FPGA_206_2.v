...
module FAU ( 
  ...
  assign new_n54_ = (~x17 | new_n55_ | ~x21) & (~new_n56_ | x14 | x15 | x17 | x21);
  ...
  assign new_n78_ = x17 ? (x18 | ~x21 | (x05 & x07)) : (new_n79_ | ~x18);
  ...
  assign z09 = (~x17 & (new_n118_ | (~new_n110_ & x18))) | (new_n120_ & x17 & ~x18 & x21);
  ...
  assign z14 = (new_n142_ & ~x05) | (~x17 & ((new_n140_ & ~x05) | (new_n137_ & x08)));
  ...
  assign new_n142_ = ~x09 & ~x18 & x21 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n144_ & x21;
  ...
  assign new_n190_ = x17 & ~x18 & x21 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  ...
  assign new_n208_ = ~x18 & x21 & ((~x07 & (x05 | x15)) | (~x05 & x15 & ~x19));
endmodule
