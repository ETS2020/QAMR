...
module FAU ( 
  ...
  assign new_n71_ = x01 & x07 & ~x18 & ~x19 & (x08 | x16);
  ...
  assign new_n79_ = x17 ? (x18 | x19 | (x05 & x07)) : (new_n80_ | ~x18);
  ...
  assign new_n119_ = ~x09 & ~x15 & ~x18 & ~new_n120_ & ~x19;
  ...
  assign new_n141_ = ~x14 & ~x15 & ~x18 & ~x19 & ~x21;
  assign new_n142_ = ~x18 & ~x19 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  ...
  assign new_n162_ = (new_n163_ | ~x18) & (~new_n167_ | x19 | x21 | x14 | x18);
  ...
  assign new_n178_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x19 | x05 | ~x12);
  ...
  assign new_n189_ = x17 & ~x18 & ~x19 & ((x00 & ~x07 & x15) | (x07 & ~x15));
  assign new_n190_ = new_n191_ & x03 & ~x05 & ~x07 & x08;
  assign new_n191_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = new_n205_ | (~x17 & x18 & (new_n203_ | (~new_n193_ & ~x05)));
  assign new_n193_ = ~new_n194_ & (~new_n202_ | ~x08) & (x09 | (~new_n197_ & (~new_n201_ | ~x08)));
  assign new_n194_ = ~new_n195_ & ~x02;
  assign new_n195_ = (~x08 | ~x15) & (~new_n196_ | ~x11 | x14 | x15 | ~x21);
  assign new_n196_ = x06 & ~x07 & ~x08 & ~x09;
  assign new_n197_ = ~x07 & (x08 ? (x10 & new_n200_ & x12) : ~new_n198_);
  ...
  assign new_n205_ = ~x09 & ~x18 & ~new_n206_ & ~x19;
  assign new_n206_ = x05 ? (x07 | ~x17) : (~x15 | (~x17 & (~x07 | (x02 & x11))));
endmodule
