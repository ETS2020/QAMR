...
module FAU ( 
  ...
  assign z00 = ~x09 & ~x14 & ~new_n54_ & ~x18;
  assign new_n54_ = ~new_n55_ & (~new_n56_ | ~x04 | ~x12 | x15 | x21);
  ...
  assign new_n73_ = x18 & ((~new_n74_ & x08) | (new_n56_ & ~x08 & ~x09));
  assign new_n74_ = (~new_n75_ | x07) & (x05 | (x02 & ~x07 & x11));
  assign new_n75_ = ~x09 & (x21 | (~x04 & ~x11));
  assign new_n76_ = x08 & x18 & (x05 ? ~new_n77_ : ~x07);
  assign new_n77_ = x04 & ~x07 & x12;
  assign z03 = (~new_n79_ & ~x09) | (new_n81_ & x09 & ~x15 & ~x17 & x18);
  assign new_n79_ = (x17 | new_n80_ | ~x18) & (x14 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n103_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x14;
  assign new_n104_ = ~x05 & x07 & ~x14 & ~x15 & x17 & ~x18;
  assign z07 = ~x17 & ~new_n106_ & x18;
  assign new_n106_ = (x09 | (x07 ^ x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = ~x20 & x14 & ~x17;
  assign z09 = (new_n116_ & ~x07) | (~x17 & x18 & (new_n109_ | (new_n115_ & ~x07)));
  assign new_n109_ = ~x15 & ((~new_n110_ & ~x09) | (x05 & ~new_n77_ & x08));
  ...
  assign new_n116_ = ~x09 & ~x14 & new_n117_ & ~x15;
  assign new_n117_ = ~x18 & (x17 | (x04 & ~x05 & x12 & ~x21));
  ...
  assign z12 = ~x09 & (new_n104_ | (~x07 & (new_n103_ | (new_n124_ & ~x17))));
  ...
  assign z14 = (~new_n134_ & ~x17) | (new_n138_ & ~x05);
  ...
  assign new_n137_ = (~x07 | (x01 & ~x15)) & (~new_n77_ | x14 | x15 | x21);
  assign new_n138_ = ~x09 & ~x14 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n140_ & ~x18;
  assign new_n140_ = x17 & ~x15 & ~x14 & ~x09 & x05 & ~x07;
  ...
  assign z17 = ~x09 & (new_n148_ | (new_n67_ & new_n153_ & new_n68_ & ~x17));
  assign new_n148_ = ~x05 & (new_n152_ | (~x07 & (new_n151_ | (new_n149_ & ~x08))));
  assign new_n149_ = ~x15 & ~x17 & x18 & ~new_n150_ & (~x21 | (~x14 & x21));
  assign new_n150_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n151_ = x00 & ~x14 & x15 & x17 & ~x18;
  assign new_n152_ = x07 & ~x14 & ~x15 & x17 & ~x18;
  assign new_n153_ = ~x11 & x15;
  ...
  assign z19 = ~x18 & x17 & ~x15 & ~x14 & new_n56_ & ~x09;
  assign z20 = ~x07 & ~x17 & (new_n166_ | (~new_n160_ & ~x15));
  assign new_n160_ = (new_n161_ | ~x18) & (~new_n165_ | x18 | x21 | ~x12 | x14);
  assign new_n161_ = (x09 | ((~new_n162_ | x05) & (~new_n163_ | ~x04))) & (~x04 | ~new_n164_ | ~x05);
  assign new_n162_ = ~x06 & ~x08 & ~new_n91_ & (~x14 | ~x21);
  assign new_n163_ = x08 & x10 & ~x12 & ~x14 & ~new_n145_ & ~x21;
  assign new_n164_ = x08 & ~new_n64_ & ~x12;
  assign new_n165_ = x04 & ~x05 & ~x09;
  assign new_n166_ = new_n68_ & new_n153_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n170_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign z27 = new_n187_ | (~x09 & (new_n185_ | (~x17 & ~new_n182_ & x18)));
  ...
  assign new_n186_ = ~x14 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n187_ = new_n188_ & x03 & ~x05 & ~x07 & x08;
  assign new_n188_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n190_ & ~x17) | (~x09 & ~x14 & new_n204_ & x17);
  assign new_n190_ = (~new_n203_ | x05) & (~x18 | (~new_n201_ & (x05 | (~new_n191_ & new_n194_))));
  assign new_n191_ = ~new_n192_ & ~x02;
  assign new_n192_ = (~x08 | ~x15) & (~new_n193_ | ~x11 | x14 | x15 | ~x21);
  assign new_n193_ = ~x08 & ~x09 & x06 & ~x07;
