...
module FAU ( 
  ...
  assign new_n72_ = x18 & (new_n75_ | (x08 & (new_n73_ | ~new_n74_)));
  ...
  assign z06 = ~x09 & ((~new_n92_ & ~x07) | (new_n104_ & ~x05 & x07 & ~x15));
  ...
  assign new_n117_ = ~x09 & ~x15 & new_n118_ & ~x18;
  assign new_n118_ = ~x21 & (x17 | (x04 & ~x05 & x12 & ~x14));
  ...
  assign z12 = ~x09 & ~new_n125_ & ~x21;
  assign new_n125_ = (x07 | (~new_n137_ & (~new_n126_ | x17))) & (~new_n138_ | x05 | ~x07);
  assign new_n126_ = x18 & (new_n127_ | new_n135_ | (~x05 & (new_n129_ | ~new_n131_)));
  ...
  assign z14 = (new_n145_ & ~x05) | (~x17 & ((new_n143_ & ~x05) | (new_n140_ & x08)));
  assign new_n140_ = x18 & (x07 ? new_n142_ : (~new_n64_ & ~new_n141_));
  assign new_n141_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n142_ = ~x19 & (x05 ^ x15);
  assign new_n143_ = ~x09 & ~x18 & (new_n144_ | (x07 & (~x01 | x15)));
  assign new_n144_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n145_ = ~x09 & ~x18 & ~x21 & ((x15 & x17) | (x07 & (x15 | x17)));
  ...
  assign new_n155_ = (x07 | ((x08 | ~new_n156_ | x15) & (~new_n104_ | ~x00 | ~x15))) & (~new_n104_ | ~x07 | x15);
  ...
  assign new_n160_ = (x14 | x15 | (~new_n84_ & ~new_n161_)) & (x08 | ~x15 | ~x19);
  assign new_n161_ = x12 & ((~new_n162_ & ~x06) | (new_n88_ & x06 & x08 & x10));
  ...
  assign new_n167_ = ~x06 & ~x08 & ~new_n90_ & (~x14 | ~x21);
  ...
  assign new_n203_ = x04 & ~x06 & ~x12 & ~x14 & ~x15 & x21;
  ...
  assign new_n210_ = ~x18 & ~x21 & ((~x07 & (x05 | x15)) | (~x05 & x15 & ~x19));
endmodule
