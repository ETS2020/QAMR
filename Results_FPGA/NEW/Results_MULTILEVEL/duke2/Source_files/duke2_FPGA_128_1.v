...
module FAU ( 
  ...
  assign new_n55_ = x11 & x17 & ((x05 & (~x07 | ~x15)) | (~x05 & x15 & (~x00 | x07)) | (~x07 & ~x15));
  ...
  assign z02 = ~x17 & ((~new_n68_ & ~x05) | (x18 & (new_n73_ | (new_n76_ & x05))));
  assign new_n68_ = ~new_n72_ & (x09 | (~new_n71_ & (new_n69_ | x15)));
  assign new_n69_ = (~x01 | ~x07 | x18 | (~x08 & ~x16)) & (x07 | new_n70_ | ~x18);
  assign new_n70_ = x06 ? x02 : (x04 & x12);
  assign new_n71_ = ~x07 & x18 & ((~x11 & (x06 | x15)) | (~x08 & x15));
  assign new_n72_ = x08 & x18 & (x15 ? (~x02 | x07 | ~x11) : ~x07);
  assign new_n73_ = x08 & (~new_n75_ | (~new_n74_ & ~x04));
  assign new_n74_ = (x07 | x09 | x11 | ~x15) & (~x05 | x15);
  ...
  assign new_n78_ = (x17 | new_n79_ | ~x18) & (~x11 | ~x17 | x18 | (x05 & x07));
  ...
  assign z06 = ~x09 & (new_n104_ | (~x07 & (new_n102_ | (new_n92_ & ~x17))));
  assign new_n92_ = x18 & (new_n100_ | (~x15 & (new_n98_ | (~new_n93_ & ~x21))));
  assign new_n93_ = (x02 | new_n96_ | ~x11) & ~new_n97_ & (new_n94_ | ~x08);
  ...
  assign z12 = ~x09 & (new_n104_ | (~x07 & (new_n102_ | (new_n126_ & ~x17))));
  ...
  assign new_n133_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  assign new_n134_ = x04 & x08 & ~x12 & (new_n129_ | x05) & ~x15;
  assign z14 = (new_n141_ & ~x05) | (~x17 & ((new_n136_ & x08) | (new_n139_ & ~x05)));
  ...
  assign new_n139_ = ~x09 & ~x18 & (new_n140_ | (x07 & (~x01 | x15)));
  assign new_n140_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n141_ = ~x09 & x11 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  ...
  assign z17 = ~x09 & (new_n155_ | (~x05 & (new_n154_ | (~new_n151_ & ~x07))));
  assign new_n151_ = (x08 | ~new_n152_ | x15) & (~x00 | ~x11 | ~new_n103_ | ~x15);
  assign new_n152_ = ~x17 & x18 & ~new_n153_ & (~x21 | (~x14 & x21));
  assign new_n153_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n154_ = x07 & x11 & new_n103_ & ~x15;
  ...
  assign z19 = ~x18 & x17 & ~x15 & x11 & new_n116_ & ~x09;
  assign z20 = ~x07 & ~x17 & (new_n168_ | (~new_n162_ & ~x15));
  assign new_n162_ = (new_n163_ | ~x18) & (~new_n167_ | x18 | x21 | ~x12 | x14);
  assign new_n163_ = (x09 | ((~new_n165_ | ~x04) & (~new_n164_ | x05))) & (~x04 | ~new_n166_ | ~x05);
  assign new_n164_ = ~x06 & ~x08 & ~new_n90_ & (~x14 | ~x21);
  assign new_n165_ = x08 & x10 & ~x12 & ~x14 & ~new_n148_ & ~x21;
  assign new_n166_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n167_ = x04 & ~x05 & ~x09;
  assign new_n168_ = new_n169_ & ~x04 & x05 & x08 & ~x09;
  assign new_n169_ = ~x11 & x15 & x18 & ~x21;
  ...
  assign new_n173_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n116_ & x08;
  ...
  assign new_n178_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
