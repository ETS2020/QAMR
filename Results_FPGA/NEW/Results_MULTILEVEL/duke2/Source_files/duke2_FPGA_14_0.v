...
module FAU ( 
  ...
  assign new_n74_ = x08 & x18 & (x05 ? ~new_n75_ : ~x07);
  ...
  assign z09 = new_n119_ | (x19 & (new_n117_ | (new_n110_ & ~x17)));
  assign new_n110_ = x18 & ((~new_n111_ & ~x15) | (~x07 & ~new_n116_ & x08));
  assign new_n111_ = (x09 | (x05 ? (~x08 | ~x21) : ~new_n112_)) & (~x05 | new_n75_ | ~x08);
  assign new_n112_ = ~x07 & ~x21 & ((~new_n113_ & x04) | new_n114_ | new_n115_);
  ...
  assign new_n126_ = x18 & x19 & ~x21 & (~new_n127_ | (~new_n135_ & ~x04));
  assign new_n127_ = (~new_n134_ | ~x04) & (x05 | (new_n130_ & (~x04 | new_n128_ | x12)));
  assign new_n128_ = (x06 | x08 | x15) & (~new_n129_ | x02 | ~x08);
  assign new_n129_ = x11 & ~x14;
  ...
  assign new_n137_ = ~new_n138_ & (~x08 | ~x18 | new_n140_ | (~x09 & x21));
  ...
  assign z16 = x08 & ~x17 & x18 & x19 & (new_n145_ | new_n150_);
  ...
  assign new_n153_ = ~x17 & x18 & x19 & ~new_n154_ & (~x21 | (~x14 & x21));
  ...
  assign z24 = ~x09 & ~x17 & x19 & (new_n178_ | new_n182_);
  ...
  assign z27 = new_n187_ | (new_n193_ & x03 & ~x05 & ~x07 & x08);
  assign new_n187_ = ~x09 & (new_n192_ | (~x17 & x18 & ~new_n188_ & x19));
  assign new_n188_ = x07 ? (~x08 | (x05 ^ ~x15)) : (~new_n189_ & (~x05 | x08 | x15));
  assign new_n189_ = ~x21 & ((~new_n190_ & ~x04) | (new_n191_ & x02 & x06));
  assign new_n190_ = (x11 | ~x15 | ~x05 | ~x08) & (~x12 | x15 | x06 | x08);
  assign new_n191_ = ~x08 & ~x11 & ~x15;
  assign new_n192_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n193_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & ~new_n195_ & x19) | (~x09 & new_n207_ & x17);
  assign new_n195_ = (~x18 | ((new_n196_ | x05) & (~new_n204_ | x07))) & (x05 | ~new_n206_ | ~x07);
  assign new_n196_ = ~new_n197_ & ~new_n203_ & (x09 | (~new_n201_ & (new_n199_ | ~x21)));
  assign new_n197_ = ~x02 & ((x08 & x15) | (new_n198_ & new_n129_ & ~x15 & x21));
  assign new_n198_ = ~x08 & ~x09 & x06 & ~x07;
  assign new_n199_ = (~x08 | ~x15) & (~new_n200_ | x14 | x15 | x08 | x12);
  assign new_n200_ = x04 & ~x06 & ~x07;
  assign new_n201_ = ~x07 & x08 & x10 & new_n202_ & x12;
