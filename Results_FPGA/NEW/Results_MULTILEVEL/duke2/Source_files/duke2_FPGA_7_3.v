...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n102_ | (~x07 & (new_n101_ | (new_n91_ & ~x17))));
  ...
  assign new_n101_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x08;
  assign new_n102_ = ~x05 & x07 & ~x08 & ~x15 & x17 & ~x18;
  assign z07 = ~x17 & ~new_n104_ & x18;
  assign new_n104_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20 & (~x08 | ~x17);
  assign z09 = (~x17 & (new_n115_ | (~new_n107_ & x18))) | (new_n117_ & ~x15 & x17 & ~x18);
  assign new_n107_ = (x15 | (~new_n114_ & (new_n108_ | x09))) & (~new_n113_ | x07);
  ...
  assign z12 = ~x09 & (new_n102_ | (~x07 & (new_n101_ | (new_n124_ & ~x17))));
  ...
  assign z14 = (~x17 & ((new_n137_ & ~x05) | (new_n134_ & x08))) | (~x05 & new_n139_ & ~x08);
  ...
  assign new_n139_ = ~x09 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  ...
  assign z17 = ~x09 & (new_n152_ | (~x05 & ~new_n149_ & ~x08));
  assign new_n149_ = (x07 | ((x15 | x17 | ~new_n150_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n150_ = ~new_n151_ & (~x21 | (~x14 & x21));
  assign new_n151_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n152_ = new_n67_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n154_ & x18;
  assign new_n154_ = (x14 | x15 | (~new_n83_ & ~new_n155_)) & (x08 | ~x15 | ~x19);
  assign new_n155_ = x12 & ((~new_n156_ & ~x06) | (new_n87_ & x06 & x08 & x10));
  assign new_n156_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & new_n158_ & ~x08;
  assign new_n158_ = ~x05 & ~x07;
  assign z20 = new_n160_ & ~x07;
  assign new_n160_ = ~x17 & (new_n167_ | (~x15 & (new_n165_ | (~new_n161_ & x18))));
  assign new_n161_ = (x09 | ((~new_n162_ | x05) & (~new_n163_ | ~x04))) & (~x04 | ~new_n164_ | ~x05);
  assign new_n162_ = ~x06 & ~x08 & ~new_n89_ & (~x14 | ~x21);
  assign new_n163_ = x08 & x10 & ~x12 & ~x14 & ~new_n146_ & ~x21;
  assign new_n164_ = x08 & ~new_n64_ & ~x12;
  assign new_n165_ = new_n166_ & x04 & ~x05 & ~x09;
  assign new_n166_ = ~x18 & ~x21 & x12 & ~x14;
  ...
  assign new_n199_ = x04 & ~x06 & ~x12 & ~x14 & ~x15 & x21;
