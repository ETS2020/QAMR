...
module FAU ( 
  ...
  assign z02 = ~x17 & (x15 ? (~new_n72_ & x18) : (new_n67_ | new_n75_));
  assign new_n67_ = ~x09 & (x05 ? new_n71_ : (new_n68_ | (~new_n70_ & ~x02)));
  assign new_n68_ = ~x07 & x18 & (x06 ? ~x11 : ~new_n69_);
  assign new_n69_ = x04 & x12;
  assign new_n70_ = (~x01 | ~x07 | x18 | (~x08 & ~x16)) & (~x06 | x07 | ~x18);
  assign new_n71_ = ~x07 & x18 & (~x08 | x21);
  assign new_n72_ = (~x08 | ((x07 | new_n73_ | x09) & (new_n74_ | x05))) & (x08 | x09 | x05 | x07);
  assign new_n73_ = ~x21 & (x04 | x11);
  assign new_n74_ = x02 & ~x07 & x11;
  assign new_n75_ = x08 & x18 & (x05 ? (~x04 | x07 | ~x12) : ~x07);
  assign z03 = new_n77_ | (~x09 & (new_n79_ | new_n80_));
  assign new_n77_ = new_n78_ & ~x05 & x09 & ~x15 & ~x17 & x18;
  assign new_n78_ = ~x07 & x08;
  assign new_n79_ = ~x02 & x17 & ~x18 & (~x05 | ~x07);
  ...
  assign new_n117_ = x08 & ((new_n62_ & x05) | (x02 & ~x05 & ~x11 & ~new_n62_ & x15));
  assign new_n118_ = ~x02 & ~x07 & ~x09 & ~x15 & ~new_n119_ & ~x18;
  assign new_n119_ = ~x17 & (~x04 | x05 | ~x12 | x14 | x21);
  assign z10 = (new_n122_ & x08) | (~x09 & (new_n79_ | (new_n121_ & ~x06)));
  ...
  assign new_n126_ = x18 & ~x21 & ((~new_n132_ & ~x04) | new_n127_ | (new_n133_ & x04));
  assign new_n127_ = ~x05 & (new_n128_ | new_n131_ | (x04 & ~new_n130_ & ~x12));
  ...
  assign z17 = ~x09 & ((~new_n151_ & ~x05) | (new_n155_ & new_n78_ & ~x04 & x05));
  assign new_n151_ = (new_n152_ | x07) & (x02 | ~x07 | ~new_n104_ | x15);
  assign new_n152_ = (x08 | ~new_n153_ | x15) & (~x00 | x02 | ~new_n104_ | ~x15);
  ...
  assign z20 = ~x07 & ~x17 & (new_n172_ | (~new_n163_ & ~x15));
  assign new_n163_ = x04 ? new_n164_ : (x05 | ~new_n171_ | x06);
  assign new_n164_ = ~new_n169_ & (x09 | (~new_n165_ & ~new_n170_));
  assign new_n165_ = ~x14 & (new_n168_ | (~x21 & (new_n167_ | (~new_n166_ & ~x02))));
  assign new_n166_ = (~x08 | ~x10 | ~x11 | x12 | ~x18) & (x05 | ~x12 | x18);
  assign new_n167_ = x08 & x10 & ~x12 & ~x13 & x18;
  assign new_n168_ = ~x05 & ~x06 & ~x08 & ~x12 & x18;
  assign new_n169_ = x05 & x08 & ~x12 & ~new_n62_ & x18;
  assign new_n170_ = ~x05 & ~x06 & ~x08 & ~x12 & x18 & ~x21;
  assign new_n171_ = ~x08 & ~x09 & x12 & x18 & (~x14 | ~x21);
  ...
  assign new_n181_ = ~x21 & ((~x02 & ~new_n182_ & ~x05) | (new_n183_ & x05));
  assign new_n182_ = (~x08 | ~x11 | ~x15 | ~x18) & (~new_n69_ | x14 | x15 | x18);
  assign new_n183_ = x08 & x18 & (x04 ? (~x12 & ~x15) : (~x11 & x15));
  assign new_n184_ = new_n185_ & x01 & ~x02 & ~x05;
  assign new_n185_ = x07 & x08 & ~x15 & ~x18;
  assign z25 = new_n187_ & ~x05;
  assign new_n187_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (~x02 | x18) & (x14 | x21);
  assign z27 = (~new_n190_ & ~x09) | (new_n195_ & new_n78_ & x03 & ~x05);
  assign new_n190_ = x05 ? (x17 | new_n192_ | ~x18) : (~new_n194_ & (x17 | new_n191_ | ~x18));
  assign new_n191_ = (x07 | x08 | x15 | new_n154_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n192_ = (x07 | ((x08 | x15 | ~x19) & (~new_n193_ | x04 | ~x08))) & (~x07 | ~x08 | x15 | ~x19);
  assign new_n193_ = ~x11 & x15 & ~x21;
  assign new_n194_ = ~x02 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n195_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x02 & new_n211_ & ~x09) | (~new_n197_ & ~x17);
  assign new_n197_ = ~new_n210_ & (~x18 | (~new_n208_ & (x05 | (~new_n198_ & new_n201_))));
  ...
  assign new_n210_ = ~x02 & ~x05 & x07 & ~x09 & x15 & ~x18;
