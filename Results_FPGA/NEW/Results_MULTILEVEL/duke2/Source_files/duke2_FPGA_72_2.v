...
module FAU ( 
  ...
  assign z01 = ~x17 & ((~new_n56_ & ~x05) | (new_n63_ & new_n62_ & ~x04 & x05));
  ...
  assign z02 = ~x17 & (x15 ? new_n68_ : (new_n72_ | (~new_n65_ & ~x09)));
  assign new_n65_ = x05 ? (x07 | ~x18 | (x08 & ~x21)) : new_n66_;
  assign new_n66_ = (~x01 | ~x07 | x18 | (~x08 & ~x16)) & (x07 | new_n67_ | ~x18);
  assign new_n67_ = x06 ? (x02 & x11) : (x04 & x12);
  assign new_n68_ = x18 & ((~new_n69_ & x08) | (new_n71_ & ~x08 & ~x09));
  assign new_n69_ = (~new_n70_ | x07) & (x05 | (x02 & ~x07 & x11));
  assign new_n70_ = ~x09 & (x21 | (~x04 & ~x11));
  assign new_n71_ = ~x05 & ~x07;
  assign new_n72_ = x08 & x18 & (x05 ? (~x04 | x07 | ~x12) : ~x07);
  assign z03 = new_n74_ & ~x17;
  assign new_n74_ = x18 & ((~x05 & ~x07 & x08 & x09 & ~x15) | (~x09 & ((x05 & ~x15 & (x07 ^ ~x08)) | (x08 & x15 & ~x05 & x07))));
  assign z04 = ~x14 & ~x20 & (~x17 | x18);
  assign z05 = ~x05 & ~x07 & ~x09 & ~x14 & new_n77_ & ~x15;
  assign new_n77_ = ~x17 & x18 & (new_n78_ | (~new_n82_ & ~x06) | (~new_n80_ & x06));
  ...
  assign z06 = ~x07 & ~x09 & ~x17 & ~new_n85_ & x18;
  assign new_n85_ = ~new_n94_ & (x15 | (~new_n92_ & (x21 | (~new_n86_ & new_n88_))));
  assign new_n86_ = ~x02 & ~new_n87_ & x11;
  assign new_n87_ = (x05 | ~x06 | x08) & (~x04 | ~x08 | x12 | x14);
  assign new_n88_ = ~new_n91_ & (~x08 | (~new_n89_ & (x05 | new_n90_ | x14)));
  assign new_n89_ = x04 & ~x12 & (x05 | (~x13 & ~x14));
  assign new_n90_ = (x06 | ((~x02 | x10) & (x13 | x16 | ~x10 | ~x12))) & (x13 | (x10 & (~x06 | ~x10 | ~x12 | ~x16)));
  ...
  assign z09 = ~x17 & (new_n110_ | (x18 & (new_n108_ | (~new_n100_ & ~x15))));
  assign new_n100_ = ~new_n107_ & (x09 | (~new_n106_ & (x07 | (~new_n101_ & ~new_n105_))));
  ...
  assign new_n106_ = x05 & x08 & x21;
  assign new_n107_ = x05 & x08 & (~x04 | x07 | ~x12);
  assign new_n108_ = ~x07 & ~new_n109_ & x08;
  ...
  assign z12 = ~x07 & ~x09 & ~x17 & new_n117_ & x18;
  ...
  assign new_n146_ = (x14 | x15 | (~new_n78_ & ~new_n147_)) & (x08 | ~x15 | ~x19);
  ...
  assign z20 = ~x07 & ~x17 & (new_n151_ | new_n158_);
  assign new_n151_ = ~x15 & (new_n155_ | (x18 & (new_n157_ | (~new_n152_ & ~x09))));
  assign new_n152_ = (~new_n153_ | x05) & (~x04 | ~x08 | ~new_n154_ | ~x10);
  assign new_n153_ = ~x06 & ~x08 & (~x04 ^ ~x12) & (~x14 | ~x21);
  assign new_n154_ = ~x12 & ~x14 & ~x21 & (~x13 | (~x02 & x11));
  assign new_n155_ = new_n156_ & x04 & ~x05 & ~x09;
  assign new_n156_ = x12 & ~x14 & ~x18 & ~x21;
  assign new_n157_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign new_n158_ = new_n159_ & x08 & ~x09 & ~x04 & x05;
  assign new_n159_ = ~x11 & x15 & x18 & ~x21;
  assign z21 = ~x17 & ~new_n161_ & x18;
  assign new_n161_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n163_ & x18;
  assign new_n163_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign new_n168_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  ...
  assign new_n176_ = ~x21 & (new_n177_ | (~new_n119_ & ~x04));
  assign new_n177_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n178_ = new_n71_ & x03 & x08 & x09 & ~x15 & x19;
  assign z28 = ~x17 & ((new_n192_ & ~x05) | (x18 & (new_n190_ | (~new_n180_ & ~x05))));
  assign new_n180_ = ~new_n181_ & ~new_n189_ & (x09 | (~new_n188_ & (new_n184_ | x07)));
  ...
  assign new_n186_ = x04 & ~x06 & ~x12 & ~x14 & ~x15 & x21;
  assign new_n187_ = ~x14 & ~x15 & ~x21 & (x02 | x11 | ~x13);
  assign new_n188_ = x08 & x15 & x21;
  assign new_n189_ = x08 & x15 & (x07 | ~x11);
