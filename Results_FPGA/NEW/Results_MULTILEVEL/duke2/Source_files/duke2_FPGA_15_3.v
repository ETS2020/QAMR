...
module FAU ( 
  ...
  assign new_n55_ = ~x19 & ((x05 & (~x07 | ~x15)) | (~x07 & ~x15) | (~x05 & x15 & (~x00 | x07)));
  ...
  assign new_n78_ = x17 ? (x18 | x19 | (x05 & x07)) : (new_n79_ | ~x18);
  assign new_n79_ = (~x05 | x15 | (~x07 ^ ~x08)) & (~x08 | ~x15 | x05 | ~x07);
  assign new_n80_ = ~x05 & ~x07 & x08;
  assign z04 = ~x14 & ~x20 & (~x17 | ~x19);
  ...
  assign z06 = ~x09 & (new_n105_ | (~new_n92_ & ~x07));
  assign new_n92_ = ~new_n103_ & (x17 | ~x18 | (~new_n101_ & (new_n93_ | x15)));
  ...
  assign new_n103_ = new_n104_ & x00 & ~x05 & x15;
  assign new_n104_ = x17 & ~x18 & ~x19;
  assign new_n105_ = new_n104_ & ~x05 & x07 & ~x15;
  assign z07 = ~x17 & ~new_n107_ & x18;
  assign new_n107_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20 & (~x17 | ~x19);
  assign z09 = (~x17 & (new_n118_ | (~new_n110_ & x18))) | (new_n120_ & x17 & ~x18 & ~x19);
  assign new_n110_ = (x15 | (~new_n117_ & (new_n111_ | x09))) & (~new_n116_ | x07);
  ...
  assign new_n135_ = x04 & x08 & ~x12 & (new_n130_ | x05) & ~x15;
  assign z14 = (new_n142_ & ~x05) | (~x17 & ((new_n137_ & x08) | (new_n140_ & ~x05)));
  assign new_n137_ = x18 & (x07 ? new_n139_ : (~new_n64_ & ~new_n138_));
  assign new_n138_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n139_ = ~x19 & (~x05 ^ ~x15);
  assign new_n140_ = ~x09 & ~x18 & (new_n141_ | (x07 & (~x01 | x15)));
  assign new_n141_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n142_ = ~x09 & ~x18 & ~x19 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n144_ & ~x19;
  ...
  assign new_n152_ = (x07 | ((x08 | ~new_n153_ | x15) & (~new_n104_ | ~x00 | ~x15))) & (~new_n104_ | ~x07 | x15);
  assign new_n153_ = ~x17 & x18 & ~new_n154_ & (~x21 | (~x14 & x21));
  assign new_n154_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n155_ = new_n67_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  ...
  assign z19 = ~x19 & ~x18 & x17 & ~x15 & new_n75_ & ~x09;
  ...
  assign z26 = ~x20 & (x14 | x21) & (~x17 | ~x19);
  ...
  assign new_n190_ = x17 & ~x18 & ~x19 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n191_ = new_n192_ & x03 & ~x05 & ~x07 & x08;
  assign new_n192_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n194_ & ~x17) | (~x09 & new_n208_ & x17);
  ...
  assign new_n208_ = ~x18 & ~x19 & (x05 ? ~x07 : x15);
endmodule
