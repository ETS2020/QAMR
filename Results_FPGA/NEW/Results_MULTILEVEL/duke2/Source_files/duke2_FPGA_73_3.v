...
module FAU ( 
  ...
  assign new_n82_ = x17 ? ((x05 & x07) | x18) : (~x18 | ((~x05 | x15 | (~x07 ^ ~x08)) & (~x08 | ~x15 | x05 | ~x07)));
  ...
  assign new_n115_ = x04 & x12 & ~x14 & ~x18;
  ...
  assign new_n129_ = ~x07 & ~x17 & x18 & ~x21 & (new_n130_ | ~new_n132_);
  ...
  assign new_n181_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)))));
  ...
  assign z27 = (~new_n55_ & (new_n198_ | (~new_n195_ & ~x09))) | (~x07 & new_n200_ & ~x09);
  assign new_n195_ = (new_n196_ | x15) & (x05 | new_n197_ | ~x15);
  assign new_n196_ = (~x05 | x17 | ~x18 | ~x19 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x17 | x18);
  assign new_n197_ = (~x00 | x07 | ~x17 | x18) & (~x07 | ~x08 | x17 | ~x18 | ~x19);
  assign new_n198_ = new_n199_ & ~x07 & x08 & x03 & ~x05;
  assign new_n199_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n200_ = ~x17 & x18 & ~x21 & (new_n202_ | (~new_n201_ & ~x04));
  assign new_n201_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n202_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign z28 = new_n214_ | (~x17 & (new_n212_ | (x18 & (new_n204_ | new_n210_))));
  assign new_n204_ = x08 & (new_n207_ | (~x05 & (new_n205_ | (~new_n209_ & x15))));
  assign new_n205_ = ~x07 & ~x09 & x10 & new_n206_ & x12;
  assign new_n206_ = ~x14 & ~x15 & ~x21 & (x02 | x11 | ~x13);
  assign new_n207_ = ~x07 & ((new_n208_ & ~x04) | (new_n89_ & ~x09 & x15));
  assign new_n208_ = x05 & x12 & ~x15 & (~x21 | (x09 & ~x20));
  assign new_n209_ = ((x02 & ~x07 & x11) | (x20 & x21)) & (x09 | x20 | ~x21);
  assign new_n210_ = ~x05 & ~x07 & ~x08 & ~new_n211_ & ~x09;
  assign new_n211_ = (x20 | ((~x15 | x19) & (x14 | x15 | new_n98_ | ~x21))) & (~x15 | x19 | x21);
  assign new_n212_ = ~x05 & x07 & new_n213_ & ~x09;
  assign new_n213_ = x15 & ~x18 & ~new_n55_ & (~x02 | ~x11);
  assign new_n214_ = ~x09 & x17 & new_n215_ & ~x18;
  assign new_n215_ = ~new_n55_ & ((~x07 & (x05 | x15)) | (~x05 & x15 & ~x19));
endmodule
