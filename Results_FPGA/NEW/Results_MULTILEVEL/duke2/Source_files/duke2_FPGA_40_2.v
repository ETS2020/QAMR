...
module FAU ( 
  ...
  assign z02 = ~x17 & (x15 ? (~new_n75_ & x18) : (new_n71_ | new_n78_));
  assign new_n71_ = ~x09 & (x05 ? (new_n74_ & ~x07) : (new_n72_ | (new_n73_ & ~x07)));
  assign new_n72_ = x01 & x07 & ~x14 & ~x18 & (x08 | x16);
  assign new_n73_ = x18 & (x06 ? (~x02 | ~x11) : (~x04 | ~x12));
  assign new_n74_ = x18 & (~x08 | x21);
  assign new_n75_ = (~x08 | ((x07 | new_n76_ | x09) & (new_n77_ | x05))) & (x08 | x09 | x05 | x07);
  ...
  assign new_n80_ = (x17 | new_n81_ | ~x18) & (x14 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n104_ = x00 & ~x05 & ~x14 & x15 & x17 & ~x18;
  assign new_n105_ = ~x05 & x07 & ~x14 & ~x15 & x17 & ~x18;
  ...
  assign new_n118_ = ~x09 & ~x14 & new_n119_ & ~x15;
  assign new_n119_ = ~x18 & (x17 | (x04 & ~x05 & x12 & ~x21));
  ...
  assign new_n124_ = ~x15 & ~x14 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n105_ | (~x07 & (new_n104_ | (new_n126_ & ~x17))));
  assign new_n126_ = x18 & ~x21 & ((~new_n132_ & ~x04) | new_n127_ | (new_n133_ & x04));
  assign new_n127_ = ~x05 & (new_n129_ | new_n131_ | (x04 & ~new_n128_ & ~x12));
  assign new_n128_ = (x06 | x08 | x15) & (~new_n66_ | x02 | ~x08);
  ...
  assign z14 = (~new_n135_ & ~x17) | (~x05 & new_n140_ & ~x09);
  assign new_n135_ = ~new_n138_ & (~x08 | new_n136_ | ~x18);
  ...
  assign new_n140_ = ~x14 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  ...
  assign z17 = ~x09 & (new_n150_ | (new_n68_ & new_n155_ & new_n69_ & ~x17));
  ...
  assign new_n153_ = x00 & ~x14 & x15 & x17 & ~x18;
  assign new_n154_ = x07 & ~x14 & ~x15 & x17 & ~x18;
  ...
  assign new_n169_ = new_n69_ & new_n155_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n181_ = ~x15 & ~x18 & x08 & ~x14;
  ...
  assign new_n186_ = ~x09 & ((~x17 & ~new_n187_ & x18) | (new_n190_ & ~x05));
  assign new_n187_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n188_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n188_ = ~x21 & (new_n189_ | (~new_n132_ & ~x04));
  ...
  assign z28 = (~new_n193_ & ~x17) | (~x09 & ~x14 & new_n207_ & x17);
  assign new_n193_ = (~new_n205_ | x05) & (~x18 | (~new_n203_ & (x05 | (new_n194_ & ~new_n201_))));
  ...
  assign new_n201_ = ~x02 & ((x08 & x15) | (new_n202_ & new_n66_ & ~x15 & x21));
  assign new_n202_ = ~x08 & ~x09 & x06 & ~x07;
  assign new_n203_ = ~x07 & ~new_n204_ & x08;
  assign new_n204_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n205_ = new_n206_ & x07;
  assign new_n206_ = ~x09 & ~x14 & x15 & ~x18 & (~x02 | ~x11);
