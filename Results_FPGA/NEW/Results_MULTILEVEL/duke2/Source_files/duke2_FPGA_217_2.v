// Benchmark "FAU" written by ABC on Thu Aug  6 17:59:01 2020
...
module FAU ( 
  ...
  assign z02 = ~x17 & (new_n70_ | (new_n78_ & new_n66_ & ~x09 & ~x15));
  assign new_n70_ = x18 & (new_n71_ | new_n77_ | (x08 & (new_n75_ | ~new_n76_)));
  assign new_n71_ = ~x05 & (new_n72_ | (~new_n74_ & ~x07) | (x07 & x08 & x15));
  assign new_n72_ = ((x08 & x15) | (new_n73_ & ~x09 & ~x15)) & (~x02 | ~x11);
  assign new_n73_ = x06 & ~x07;
  assign new_n74_ = (x09 | ((x06 | x15 | (x04 & x12)) & (x08 | ~x15))) & (~x08 | x15);
  assign new_n75_ = ~x04 & ((~x07 & ~x09 & ~x11 & x15) | (x05 & ~x15));
  assign new_n76_ = (~x05 | x15 | (~x07 & x12)) & (~x15 | ~x21 | x07 | x09);
  assign new_n77_ = x05 & ~x07 & ~x09 & ~x15 & (~x08 | x21);
  assign new_n78_ = x01 & ~x05 & x07 & x08;
  assign z03 = (~new_n80_ & ~x09) | (new_n82_ & x09 & ~x15 & ~x17 & x18);
  assign new_n80_ = (x17 | new_n81_ | ~x18) & (x16 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n106_ = new_n105_ & ~x05 & x07 & ~x15;
  ...
  assign new_n119_ = ~x07 & ~x09 & ~x15 & ~x16 & ~new_n120_ & ~x18;
  ...
  assign z13 = ~x09 & ~x16 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = ~x18 & new_n125_ & ~x17;
  assign new_n125_ = ~x16 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n106_ | (~x07 & (new_n104_ | (new_n127_ & ~x17))));
  assign new_n127_ = x18 & ~x21 & (new_n134_ | new_n136_ | (~new_n128_ & ~x05));
  assign new_n128_ = (~x04 | new_n129_ | x12) & ~new_n133_ & (new_n131_ | x15);
  assign new_n129_ = (x06 | x08 | x15) & (~new_n130_ | x02 | ~x08);
  assign new_n130_ = x11 & ~x14;
  ...
  assign new_n136_ = x04 & x08 & ~x12 & ~x15 & (new_n132_ | x05);
  assign z14 = new_n138_ | (~x05 & new_n143_ & ~x09);
  ...
  assign new_n141_ = new_n142_ & x04 & ~x05 & ~x07 & ~x09 & x12;
  assign new_n142_ = ~x14 & ~x15 & ~x16 & ~x18 & ~x21;
  assign new_n143_ = ~x16 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n145_ & ~x18;
  assign new_n145_ = x17 & ~x16 & ~x15 & ~x09 & x05 & ~x07;
  ...
  assign new_n153_ = (x07 | ((x08 | ~new_n154_ | x15) & (~new_n105_ | ~x00 | ~x15))) & (~new_n105_ | ~x07 | x15);
  assign new_n154_ = ~x17 & x18 & ~new_n155_ & (~x21 | (~x14 & x21));
  assign new_n155_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n156_ = new_n68_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n158_ & x18;
  assign new_n158_ = (x14 | x15 | (~new_n86_ & ~new_n159_)) & (x08 | ~x15 | ~x19);
  assign new_n159_ = x12 & ((~new_n160_ & ~x06) | (new_n90_ & x06 & x08 & x10));
  assign new_n160_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x16 & ~x15 & new_n56_ & ~x09;
  assign z20 = ~x07 & ~x17 & (new_n169_ | (~new_n163_ & ~x15));
  assign new_n163_ = (new_n164_ | ~x18) & (~new_n168_ | x18 | x21 | x14 | x16);
  assign new_n164_ = (x09 | ((~new_n165_ | x05) & (~new_n166_ | ~x04))) & (~x04 | ~new_n167_ | ~x05);
  assign new_n165_ = ~x06 & ~x08 & ~new_n92_ & (~x14 | ~x21);
  assign new_n166_ = x08 & x10 & ~x12 & ~x14 & ~new_n150_ & ~x21;
  ...
  assign new_n174_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)))));
  ...
  assign new_n179_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x16 | x18 | x05 | ~x12);
  assign new_n180_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n181_ = x01 & ~x05 & x07 & new_n66_ & x08 & ~x15;
  ...
  assign new_n190_ = ~x16 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n191_ = new_n192_ & x03 & ~x05 & ~x07 & x08;
  assign new_n192_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n194_ | new_n205_)) | (~x09 & ~x16 & new_n207_ & x17);
  assign new_n194_ = x18 & (new_n203_ | (~x05 & (~new_n195_ | (~new_n202_ & ~x02))));
  assign new_n195_ = (~new_n201_ | ~x08) & (x09 | ((new_n196_ | x07) & (~new_n200_ | ~x08)));
