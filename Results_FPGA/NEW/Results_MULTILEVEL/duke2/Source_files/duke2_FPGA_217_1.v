...
module FAU ( 
  ...
  assign new_n79_ = ~x15 & x16 & ~x17 & x18;
  assign z04 = ~x14 & ~x20 & (x16 | ~x18);
  assign z05 = ~x05 & ~x07 & ~x09 & new_n82_ & ~x14;
  assign new_n82_ = ~x15 & x16 & ~x17 & x18 & (~new_n83_ | new_n86_);
  assign new_n83_ = x06 ? new_n84_ : (x08 | ~x21 | (x04 ^ ~x12));
  assign new_n84_ = (x02 | x08 | ~x11 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  assign new_n85_ = x12 & ~x13 & ~x21;
  assign new_n86_ = ~new_n87_ & x02;
  assign new_n87_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign z06 = ~x09 & (new_n99_ | (~x07 & (new_n89_ | (new_n96_ & x04))));
  assign new_n89_ = ~x05 & ((new_n90_ & x16) | (new_n95_ & x00 & x15));
  assign new_n90_ = ~x17 & x18 & (new_n91_ | (~x02 & new_n94_ & x08));
  assign new_n91_ = ~x15 & (x08 ? (~x14 & ~new_n93_ & ~x21) : (~new_n92_ & (~x21 | (~x14 & x21))));
  assign new_n92_ = (x02 | ~x06 | ~x11) & (~x04 | x06 | x12);
  assign new_n93_ = (x13 | (x10 & (~x06 | (~x04 & (~x10 | ~x12))))) & (~x02 | x06 | x10);
  assign new_n94_ = x11 & ~x21 & ((~x10 & ~x14) | x15);
  assign new_n95_ = x17 & ~x18;
  assign new_n96_ = x08 & ~x12 & ~x15 & x16 & new_n97_ & ~x17;
  assign new_n97_ = x18 & ~x21 & (x05 | (~new_n98_ & ~x14));
  assign new_n98_ = x13 & (x02 | ~x11);
  assign new_n99_ = ~x05 & x07 & new_n95_ & ~x15;
  assign z07 = x16 & new_n101_ & ~x17;
  assign new_n101_ = x18 & ((~x09 & (x07 ^ ~x08) & (~x05 ^ ~x15)) | (x08 & x09 & ~x15 & ~x05 & ~x07));
  assign z08 = x14 & ~x20 & (x16 | ~x18);
  assign z09 = new_n112_ | (x16 & ~x17 & ~new_n104_ & x18);
  assign new_n104_ = (~new_n110_ | x07) & (x15 | (~new_n111_ & (new_n105_ | x09)));
  ...
  assign new_n110_ = x08 & ((new_n63_ & x05) | (x02 & ~x05 & ~x11 & ~new_n63_ & x15));
  ...
  assign new_n120_ = (~x16 | x17 | ~new_n121_ | ~x18) & (~new_n132_ | ~x15 | ~x17 | x18);
  ...
  assign z14 = new_n134_ | (new_n139_ & ~x05);
  assign new_n134_ = ~x17 & (new_n137_ | (x08 & x16 & ~new_n135_ & x18));
  assign new_n135_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n63_ | new_n136_);
  ...
  assign new_n149_ = (x07 | ((~new_n95_ | ~x00 | ~x15) & (x08 | ~new_n150_ | x15))) & (~new_n95_ | ~x07 | x15);
  ...
  assign new_n156_ = ~new_n86_ & (new_n157_ | ~x12);
  assign new_n157_ = (x04 | x06 | x08 | ~x21) & (~x06 | ~x08 | ~x10 | x13 | x21);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n166_ | (~new_n160_ & ~x15));
  assign new_n160_ = ~new_n165_ & (~x16 | ~x18 | (~new_n164_ & (new_n161_ | x09)));
  assign new_n161_ = (~new_n163_ | x05) & (~x04 | ~x08 | ~new_n162_ | ~x10);
  assign new_n162_ = ~x12 & ~x14 & ~new_n98_ & ~x21;
  assign new_n163_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n164_ = x04 & x05 & x08 & ~new_n63_ & ~x12;
  assign new_n165_ = x04 & ~x05 & ~x09 & new_n56_ & ~x18 & ~x21;
  assign new_n166_ = new_n65_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign new_n174_ = ~new_n175_ & (x05 | x08 | x15 | ~x16 | ~x18);
  assign new_n175_ = ~x21 & ((x04 & ~new_n176_ & ~x15) | (x08 & new_n177_ & x15));
  assign new_n176_ = (~x05 | ~x08 | x12 | ~x16 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n177_ = x16 & x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  ...
  assign z27 = new_n188_ | (~x09 & (new_n190_ | (x16 & new_n183_ & ~x17)));
  assign new_n183_ = x18 & (x07 ? new_n187_ : ~new_n184_);
  assign new_n184_ = ~new_n186_ & (x21 | (~new_n122_ & ~new_n185_));
  assign new_n185_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n186_ = x05 & ~x08 & ~x15 & x19;
  assign new_n187_ = x08 & x19 & (~x05 ^ ~x15);
  assign new_n188_ = new_n189_ & x03 & ~x05 & ~x07 & x08 & x09;
  assign new_n189_ = ~x15 & x16 & ~x17 & x18 & x19;
  assign new_n190_ = ~x05 & x17 & ~x18 & ((x00 & ~x07 & x15) | (x07 & ~x15));
  assign z28 = (~x17 & (new_n204_ | (new_n192_ & x16))) | (~x09 & new_n206_ & x17);
