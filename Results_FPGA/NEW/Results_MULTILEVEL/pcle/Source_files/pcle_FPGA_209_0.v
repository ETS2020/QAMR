...
module FAU ( 
  ...
  assign z4 = (x03 & (x08 | (new_n39_ & x09 & ~x10))) | (~x08 & x09 & new_n40_ & ~x10);
  assign new_n39_ = ~x12 & x14;
  assign new_n40_ = x12 & ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14));
  assign z5 = (~new_n33_ & ~new_n42_) | (~x08 & x09 & new_n43_ & ~x10);
  assign new_n42_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x14 | ~x15);
  assign new_n43_ = x14 & ((x12 & ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15))) | (x03 & ~x12 & x15));
  assign z6 = (x03 & (new_n47_ | (x05 & x08))) | (x12 & (x08 ? x05 : new_n45_));
  ...
  assign z7 = (x03 & (new_n51_ | (x06 & x08))) | (x12 & (x08 ? x06 : new_n49_));
