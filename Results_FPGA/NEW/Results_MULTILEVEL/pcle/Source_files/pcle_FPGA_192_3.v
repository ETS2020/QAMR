...
module FAU ( 
  ...
  assign z2 = ~x10 & (x08 ? x01 : (x09 & (x11 ^ x12)));
  assign z3 = (x02 & x08 & (~x01 | (x01 & ~x10))) | (~x08 & x09 & ~new_n35_ & ~x10);
  assign new_n35_ = x11 ? (~x12 ^ x13) : ~x13;
  assign z4 = (~x08 & x09 & ~new_n37_ & ~x10) | (x03 & x08 & (~x01 | ~x10));
  assign new_n37_ = (~x14 | (x11 & x12 & x13)) & (~x11 | ~x12 | ~x13 | x14);
  assign z5 = (~x08 & x09 & ~new_n39_ & ~x10) | (x04 & x08 & (~x01 | ~x10));
  assign new_n39_ = x14 ? ((~x15 | (x11 & x12 & x13)) & (~x11 | ~x12 | ~x13 | x15)) : ~x15;
  assign z6 = (~x08 & x09 & ~new_n41_ & ~x10) | (x05 & x08 & (~x01 | ~x10));
  assign new_n41_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~x08 & x09 & ~new_n43_ & ~x10) | (x06 & x08 & (~x01 | ~x10));
  assign new_n43_ = (~x17 | (new_n44_ & x14 & x15 & x16)) & (~new_n44_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n44_ = x11 & x12 & x13;
  assign z8 = (~x08 & x09 & ~new_n46_ & ~x10) | (x07 & x08 & (~x01 | ~x10));
