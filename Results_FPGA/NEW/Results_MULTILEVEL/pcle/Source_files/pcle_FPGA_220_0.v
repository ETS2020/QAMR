...
module FAU ( 
  ...
  assign z4 = (x03 & (x08 | (new_n38_ & x09 & ~x10))) | (~x08 & x09 & new_n39_ & ~x10);
  assign new_n38_ = ~x11 & x14;
  assign new_n39_ = x11 & ((x14 & (~x12 | ~x13)) | (x12 & x13 & ~x14));
  assign z5 = new_n41_ | (~new_n43_ & (x03 | x11));
  assign new_n41_ = ~x08 & x09 & new_n42_ & ~x10;
  assign new_n42_ = x14 & ((x11 & ((x15 & (~x12 | ~x13)) | (x12 & x13 & ~x15))) | (x03 & ~x11 & x15));
  assign new_n43_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x14 | ~x15);
  assign z6 = (x03 & (new_n47_ | (x05 & x08))) | (x11 & (x08 ? x05 : new_n45_));
  assign new_n45_ = new_n46_ & x09;
  assign new_n46_ = ~x10 & ((x16 & (~x12 | ~x13 | ~x14 | ~x15)) | (x12 & x13 & x14 & x15 & ~x16));
  assign new_n47_ = ~x08 & x09 & ~x10 & ~x11 & x16;
  assign z7 = (x03 & (new_n51_ | (x06 & x08))) | (x11 & (x08 ? x06 : new_n49_));
