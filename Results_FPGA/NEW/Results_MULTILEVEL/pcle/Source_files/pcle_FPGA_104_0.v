...
module FAU ( 
  ...
  assign new_n43_ = (~x16 | (x11 & x12 & new_n44_ & x13)) & (~x11 | ~x12 | ~x13 | ~new_n44_ | x16 | ~x18);
  assign new_n44_ = x14 & x15;
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & (x16 ? ~new_n47_ : (x17 & x18));
  assign new_n47_ = (~x17 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x17);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & new_n49_ & x09);
  assign new_n49_ = ~x10 & ((new_n52_ & new_n53_) | (x18 & (~new_n50_ | ~new_n51_)));
