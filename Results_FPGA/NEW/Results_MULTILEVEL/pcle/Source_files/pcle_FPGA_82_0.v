...
module FAU ( 
  ...
  assign new_n43_ = (~x16 | (x11 & x12 & new_n44_ & x13)) & (~x11 | ~x12 | ~x13 | ~new_n44_ | x16 | ~x17);
  assign new_n44_ = x14 & x15;
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & new_n46_ & x09);
  ...
  assign new_n49_ = (~x17 | ((x16 | ~x18) & (~new_n47_ | ~x14 | ~x15 | ~x16 | x18))) & (~x16 | ~x18 | (new_n47_ & x14 & x15 & x17));
endmodule
