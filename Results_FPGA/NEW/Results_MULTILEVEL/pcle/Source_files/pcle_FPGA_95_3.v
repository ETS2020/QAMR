...
module FAU ( 
  ...
  assign z5 = (x04 & x08 & (~x03 | (x03 & ~x12))) | (new_n43_ & ~x08);
  assign new_n43_ = x09 & ~new_n44_ & ~x10;
  assign new_n44_ = (x03 | (x14 ? ((~x15 | (x11 & x13)) & (~x11 | ~x12 | ~x13 | x15)) : ~x15)) & (x12 | ~x15);
  assign z6 = (new_n46_ & ~x08) | (x05 & ~new_n34_ & x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & ~x03) | (~x12 & x16));
