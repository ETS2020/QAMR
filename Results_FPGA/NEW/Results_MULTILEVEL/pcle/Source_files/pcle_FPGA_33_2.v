...
module FAU ( 
  ...
  assign z2 = (x01 & x08 & (~x02 | (x02 & x11))) | (new_n34_ & ~x08);
  assign new_n34_ = x09 & ~x10 & ((~x02 & ~x11 & x12) | (x11 & ~x12));
  assign z3 = (new_n36_ & ~x08) | (x02 & x08 & x11);
  assign new_n36_ = x09 & ~x10 & ((x11 & (x12 ^ x13)) | (~x02 & ~x11 & x13));
  assign z4 = (~x02 & (new_n38_ | (x03 & x08))) | (x11 & (x08 ? x03 : new_n39_));
  assign new_n38_ = ~x08 & x09 & ~x10 & ~x11 & x14;
  assign new_n39_ = x09 & ~x10 & ((x14 & (~x12 | ~x13)) | (x12 & x13 & ~x14));
  assign z5 = new_n41_ | (~new_n43_ & (~x02 | x11));
  assign new_n41_ = ~x08 & x09 & new_n42_ & ~x10;
  assign new_n42_ = x14 & ((x11 & ((x15 & (~x12 | ~x13)) | (x12 & x13 & ~x15))) | (~x02 & ~x11 & x15));
  assign new_n43_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x14 | ~x15);
  assign z6 = (~x02 & (new_n47_ | (x05 & x08))) | (x11 & (x08 ? x05 : new_n45_));
  ...
  assign z7 = (~x02 & (new_n51_ | (x06 & x08))) | (x11 & (x08 ? x06 : new_n49_));
