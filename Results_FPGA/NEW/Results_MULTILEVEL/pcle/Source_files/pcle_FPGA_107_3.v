...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n35_, new_n37_, new_n39_;
  ...
  assign new_n35_ = x09 & ~x10 & (x12 ? (~x15 & (x11 ^ x13)) : x13);
  assign z4 = (x03 & ~new_n31_ & x08) | (~x08 & new_n37_ & x09);
  assign new_n37_ = ~x10 & ((x14 & (~x12 | (~x15 & (~x11 | ~x13)))) | (x11 & x12 & x13 & ~x14 & ~x15));
  assign z5 = (x04 & ~new_n31_ & x08) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & ((~x12 & x15) | (x11 & x12 & x13 & x14 & ~x15));
