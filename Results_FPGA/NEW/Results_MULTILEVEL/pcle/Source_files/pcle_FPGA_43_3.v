...
module FAU ( 
  ...
  assign z6 = ~new_n31_ & (x08 ? x05 : (x09 & ~new_n41_ & ~x10));
  assign new_n41_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x17 | x18 | (new_n44_ & x14 & x15 & x16)) & (~new_n44_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n44_ = x11 & x12 & x13;
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (x17 | ~x18) & (~new_n47_ | ~x15 | ~x16 | ~x17 | x18);
