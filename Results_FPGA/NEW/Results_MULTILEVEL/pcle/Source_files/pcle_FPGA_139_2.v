...
module FAU ( 
  ...
  assign new_n39_ = ~x10 & ((x14 & x15 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x14));
  ...
  assign new_n44_ = (~x15 | ((~x16 | (x11 & x12 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | x16))) & (x14 | ~x16);
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~x14 & x17) | (~new_n47_ & x15));
  assign new_n47_ = (~x17 | (x11 & x12 & x13 & x16)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x16 | x17);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (x14 | ~x18) & (~x15 | ((new_n50_ | ~x18) & (~new_n42_ | ~new_n51_)));
