// Benchmark "FAU" written by ABC on Thu Aug  6 15:04:32 2020
...
module FAU ( 
  ...
  assign new_n33_ = ~x13 & x17;
  assign z2 = ~new_n33_ & ~new_n35_;
  assign new_n35_ = x08 ? ~x01 : (~x09 | x10 | (~x11 ^ x12));
  assign z3 = (x02 & ~new_n33_ & x08) | (new_n37_ & ~x08);
  assign new_n37_ = x09 & ~x10 & (x11 ? (x12 ? (~x13 & ~x17) : x13) : x13);
  assign z4 = (x03 & ~new_n33_ & x08) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & (x13 ? ((x14 & (~x11 | ~x12)) | (x11 & x12 & ~x14)) : (x14 & ~x17));
  assign z5 = (~new_n33_ & ~new_n41_) | (~x08 & x09 & new_n42_ & ~x10);
  assign new_n41_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x14 | ~x15);
  assign new_n42_ = x14 & (x13 ? ((x15 & (~x11 | ~x12)) | (x11 & x12 & ~x15)) : (x15 & ~x17));
  assign z6 = (x05 & ~new_n33_ & x08) | (new_n44_ & ~x08);
  assign new_n44_ = x09 & ~x10 & (x13 ? ~new_n45_ : (x16 & ~x17));
  assign new_n45_ = (~x16 | (x11 & x12 & x14 & x15)) & (~x11 | ~x12 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & ~new_n48_ & x13;
  assign new_n48_ = (~x17 | (x11 & x12 & x14 & x15 & x16)) & (~x11 | ~x12 | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n50_ & ~x10);
  assign new_n50_ = (x17 | ~x18) & (~x13 | ((new_n52_ | ~x18) & (~new_n53_ | ~new_n51_ | ~x17 | x18)));
  assign new_n51_ = x15 & x16;
  assign new_n52_ = x11 & x12 & x14 & x15 & x16;
