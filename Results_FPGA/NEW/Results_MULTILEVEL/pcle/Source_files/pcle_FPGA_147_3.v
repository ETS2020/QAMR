...
module FAU ( 
  ...
  assign new_n39_ = (~x15 | (x12 & (x18 | (x14 & (~x14 | (x11 & x13)))))) & (~x14 | x15 | x18 | ~x11 | ~x12 | ~x13);
  ...
  assign z7 = (x06 & ~new_n31_ & x08) | (~x08 & new_n44_ & x09);
  ...
  assign new_n49_ = (x12 | ~x18) & (~new_n46_ | ~x15 | ~x16 | ~x17 | x18);
  assign z0 = 1'b0;
endmodule
