// Benchmark "FAU" written by ABC on Thu Aug  6 15:04:53 2020
...
module FAU ( 
  ...
  assign z7 = (x06 & x08 & (~x09 | x11)) | (~x08 & x09 & ~x10 & ~new_n43_ & x11);
  assign new_n43_ = (~x17 | (x12 & x13 & x14 & x15 & x16)) & (~x12 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & x08 & (~x09 | x11)) | (~x08 & x09 & ~x10 & ~new_n45_ & x11);
