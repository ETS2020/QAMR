...
module FAU ( 
  ...
  assign new_n39_ = x09 & ~x10 & ((x13 & (x11 ? (x12 & ~x14) : x14)) | (~x12 & x14));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & new_n41_ & x09);
  assign new_n41_ = ~x10 & ((~x12 & x15) | (x13 & (x14 ? (x11 ? (x12 & ~x15) : x15) : x15)));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (x12 | ~x16) & (~x13 | ((~x16 | (x11 & x14 & x15)) & (~x11 | ~x12 | ~x14 | ~x15 | x16)));
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n45_ & ~x08);
  assign new_n45_ = x09 & ~x10 & ((~x12 & x17) | (~new_n46_ & x13));
  assign new_n46_ = (~x17 | (x15 & x16 & x11 & x14)) & (~x15 | ~x16 | x17 | ~x11 | ~x12 | ~x14);
  ...
  assign new_n50_ = x18 & (~x11 | ~x14 | ~x15 | ~x16 | ~x17);
