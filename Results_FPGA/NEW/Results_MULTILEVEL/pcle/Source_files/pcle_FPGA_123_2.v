// Benchmark "FAU" written by ABC on Thu Aug  6 15:05:01 2020
...
module FAU ( 
  ...
  assign new_n35_ = x09 & ~x10 & (~x13 | (x13 & x18)) & (x11 ^ x12);
  assign z3 = (x02 & ~new_n33_ & x08) | (new_n37_ & ~x08);
  assign new_n37_ = x09 & ~x10 & (x11 ? (x12 ? ~x13 : (x13 & x18)) : (x13 & x18));
  assign z4 = (x03 & ~new_n33_ & x08) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & ((x14 & (~x13 | (~new_n40_ & x18))) | (new_n40_ & x13 & ~x14 & x18));
  assign new_n40_ = x11 & x12;
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n42_ & ~x10);
  assign new_n42_ = (~x15 | (x13 & (~x18 | (x14 & (~x14 | (x11 & x12)))))) & (~x11 | ~x12 | ~x13 | ~x14 | x15 | ~x18);
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x16 | (x13 & (~x18 | (new_n45_ & x11 & x12)))) & (~x11 | ~x12 | ~x13 | ~new_n45_ | x16 | ~x18);
  assign new_n45_ = x14 & x15;
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~x17 | (x13 & (~x18 | (new_n40_ & new_n48_ & x14)))) & (~new_n40_ | ~x13 | ~x14 | ~new_n48_ | x17 | ~x18);
  assign new_n48_ = x15 & x16;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & new_n50_ & ~x10);
  assign new_n50_ = x18 & (~new_n51_ | ~x11 | ~x12 | ~x13);
