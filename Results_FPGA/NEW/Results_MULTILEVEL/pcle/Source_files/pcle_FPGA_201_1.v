...
module FAU ( 
  ...
  assign z1 = (x00 & x07 & x08) | (~x08 & x09 & ~x10 & ~x11);
  assign z2 = (new_n34_ & ~x08) | (x01 & x07 & x08);
  assign new_n34_ = x09 & ~x10 & (x11 ^ x12);
  assign z3 = (new_n36_ & ~x08) | (x02 & x07 & x08);
  assign new_n36_ = x09 & ~x10 & (x11 ? (x12 ^ x13) : x13);
  assign z4 = (new_n38_ & ~x08) | (x03 & x07 & x08);
  assign new_n38_ = x09 & ~x10 & ((x14 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & x07 & x08) | (~x08 & new_n40_ & x09);
  assign new_n40_ = ~x10 & (x14 ? ((x15 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x15)) : x15);
  assign z6 = (x05 & x07 & x08) | (~x08 & x09 & ~new_n42_ & ~x10);
  assign new_n42_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & x07 & x08) | (~x08 & new_n44_ & x09);
