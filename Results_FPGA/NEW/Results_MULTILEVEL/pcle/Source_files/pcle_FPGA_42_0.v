...
module FAU ( 
  ...
  assign z5 = (~new_n33_ & ((x04 & x08) | (new_n41_ & ~x08 & x09))) | (~x08 & new_n42_ & x09);
  assign new_n41_ = ~x10 & ~x14 & x15;
  assign new_n42_ = ~x10 & x14 & ((x13 & ((~x12 & x15) | (x11 & x12 & ~x15))) | (x12 & x15 & (~x11 | ~x13)));
  ...
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x13) | (new_n48_ & x12));
  assign new_n47_ = (x12 | ~x17) & (~x15 | ~x16 | x17 | ~x11 | ~x12 | ~x14);
