...
module FAU ( 
  ...
  assign z02 = (~new_n155_ & x51) | (~new_n169_ & x00);
  ...
  assign new_n226_ = (~x00 | x48 | x51 | ~x53) & (~x51 | (~new_n227_ & (~x16 | x48 | x53)));
  ...
  assign new_n230_ = x49 & ((x51 & x52) | (x00 & ~x53));
  ...
  assign new_n298_ = ~x50 & ((x16 & x52 & ~x53) | (x20 & ~x52));
  ...
  assign new_n316_ = (x14 | ((~x00 | x51) & (x49 | ~x50 | ~x51))) & (new_n317_ | ~x51) & (~x00 | x51 | (x49 & ~x50));
  ...
  assign new_n328_ = x49 & ~x50 & ~x53 & x34 & x48;
  ...
  assign new_n363_ = (new_n382_ | x47) & (x46 | (new_n371_ & (new_n364_ | x48)));
  assign new_n364_ = (~x49 | (~new_n369_ & (new_n370_ | x51))) & (x51 | (~new_n365_ & new_n367_));
  assign new_n365_ = x52 & ((~new_n366_ & ~x50) | (~x53 & (x50 | (~x31 & x47))));
  assign new_n366_ = (x47 | (~x53 & (x32 | x49 | x53))) & (~x13 | x49 | ~x53);
  assign new_n367_ = (~new_n368_ | ~x47) & (~x50 | x53 | (~x18 & x49));
  assign new_n368_ = ~x52 & ((~x09 & ~x53) | (~x23 & ~x49 & x50));
  assign new_n369_ = ~x14 & ((~x51 & x52 & ~x53) | (~x47 & ~x50 & x53));
  assign new_n370_ = x53 ? ((~x38 | x50 | ~x52) & (~x50 | x52 | ~x37 | x47)) : ~x47;
  assign new_n371_ = ~new_n379_ & (x51 | (~new_n381_ & (~x48 | (~new_n372_ & new_n375_))));
  ...
  assign new_n386_ = x46 & ~x48 & ~x51 & (new_n125_ | (~new_n387_ & x50));
  ...
  assign new_n405_ = (~x00 | x48 | x51 | ~x52 | x53) & (~x48 | ~x51 | x52 | ~x53);
  ...
  assign z16 = (~new_n436_ & ~x48) | (new_n434_ & x00 & ~x46 & x47 & x48);
  ...
  assign new_n442_ = ~new_n443_ & (~new_n139_ | x50 | x51 | ~new_n210_ | ~x00);
  ...
  assign new_n476_ = (x48 | new_n477_ | ~x49) & (~x48 | x49 | x50 | ~new_n229_ | ~x51);
  ...
  assign new_n496_ = ~x52 & x53 & ((~x50 & x51) | (x00 & ~x24 & x50 & ~x51));
  ...
  assign z49 = (~new_n512_ & ~x48) | (new_n516_ & x00 & x46 & ~x47 & x48);
