...
module FAU ( 
  ...
  assign z0 = (~x04 & (~x00 | ~x05)) | (~x01 & (~x05 | (~new_n24_ & x04)));
  assign new_n24_ = (~x09 | (x02 & x03)) & (~x02 | ~x03 | x09);
  assign z1 = (~x04 & (~x01 | ~x05)) | (~new_n26_ & ~x01);
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & x05 & (~x02 | ~x03 | ~x04 | x09 | x11);
  assign z2 = (~x04 & (~x05 | ~x06)) | (~x01 & (~x05 | (~new_n28_ & x04)));
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~x04 & (~x05 | ~x07)) | (~x01 & (~x05 | (~new_n30_ & x04)));
  assign new_n30_ = (~x13 | (x02 & x03 & ~x09 & ~x11 & ~x12)) & (~x02 | ~x03 | x09 | x11 | x12 | x13);
  assign z4 = new_n32_ & x03;
  assign new_n32_ = x08 & x10 & x14 & (~x01 | ~x04) & x15;
endmodule
