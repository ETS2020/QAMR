...
module FAU ( 
  ...
  assign z2 = new_n28_ | (~x06 & (new_n29_ | ~new_n30_ | ~x04));
  assign new_n28_ = ~x03 & (~x05 | (x04 & x12));
  assign new_n29_ = x12 & (~x02 | x09 | x11);
  assign new_n30_ = x05 & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~new_n32_ & (~x03 | ~x06)) | (x04 & ((~x03 & x13) | (~new_n33_ & ~x06)));
  assign new_n32_ = x05 & (x04 | x07);
  assign new_n33_ = (~x13 | (~x11 & ~x12 & x02 & ~x09)) & (x11 | x12 | x13 | ~x02 | ~x03 | x09);
