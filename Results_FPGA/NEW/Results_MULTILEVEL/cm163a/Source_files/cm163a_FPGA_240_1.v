...
module FAU ( 
  ...
  assign z0 = ~new_n24_ & (x10 | ~x13);
  assign new_n24_ = (~x04 | ((~x09 | (x02 & x03)) & (~x02 | ~x03 | x09))) & x05 & (x00 | x04);
  assign z1 = (x10 | ~x13) & ((~new_n26_ & x04) | ~x05 | (~x01 & ~x04));
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = (x10 | ~x13) & ((~new_n28_ & x04) | ~x05 | (~x04 & ~x06));
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~new_n31_ & (x10 | ~x13)) | (x04 & (new_n32_ | (x10 & ~new_n30_ & x13)));
