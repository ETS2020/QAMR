...
module FAU ( 
  ...
  assign new_n28_ = (~x03 | ((~x01 | (x05 & (x02 | ~x04))) & (~x02 | x05))) & (~x02 | ~x04 | (x01 & x05 & x06));
  assign z2 = ~new_n30_ & ((~new_n31_ & ~new_n32_) | (~new_n33_ & ~x01));
  ...
  assign z4 = ~new_n30_ & (x07 ? ~x11 : (~x00 | (x00 & (~x08 | ~x09))));
  assign z5 = ~new_n30_ & (x00 | x07 | (~x00 & ~x07 & (x10 | x12 | ~x13)));
  assign z6 = ~x07 & ~x10 & ~new_n30_ & (new_n38_ | new_n39_);
  assign new_n38_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n39_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = ~new_n30_ & (~new_n41_ | (~x08 & (x01 | x02 | ~x03)));
  assign new_n41_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n30_ & ((~new_n43_ & x09) | x07 | x10 | (~x00 & ~x09));
