...
module FAU ( 
  ...
  assign new_n32_ = (x01 | x02 | x03 | ~x10) & (~x02 | x10);
  assign new_n33_ = ~x00 & ((~x02 & ~x03 & x07) | (~x07 & x09 & ~x10));
  assign new_n34_ = ~x07 & ~x08 & x09 & ~x10;
  assign z3 = (~x07 | ~x11) & (~x02 | ~x10) & (x00 | ~x12);
  assign z4 = x07 ? (~x11 & (~x02 | ~x10)) : (x00 ? (~new_n37_ & (~x02 | ~x10)) : (~x10 | (~x02 & x10)));
  assign new_n37_ = x08 & x09;
  assign z5 = ((~x02 | ~x10) & (x00 | x07)) | (~x00 & ~x07 & (x10 ? ~x02 : (x12 | ~x13)));
  assign z6 = ~x07 & (new_n40_ | new_n41_) & ~x10;
  assign new_n40_ = ~x02 & (~x00 | ~x08) & (x01 | (~x03 & x09) | (x03 & ~x09));
  assign new_n41_ = x02 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = (~x02 & (x10 | (~x01 & x03 & x09))) | (~new_n43_ & ~x10);
  assign new_n43_ = ~x07 & (x08 | (~x01 & ~x02 & x03));
  assign z8 = x10 ? ~x02 : ((~new_n45_ & x09) | x07 | (~x00 & ~x09));
