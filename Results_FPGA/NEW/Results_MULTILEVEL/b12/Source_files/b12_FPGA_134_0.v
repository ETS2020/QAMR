...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n30_, new_n32_, new_n35_, new_n38_;
  ...
  assign new_n32_ = (~x02 | (~x01 & ~x10)) & (x01 | x03 | ~x10);
  assign z3 = (~x07 | ~x11) & (x00 | ~x12) & (x01 | x10);
  assign z4 = x07 ? (~x11 & (x01 | x10)) : ((~new_n35_ & (x10 | (x00 & x01))) | (~x00 & (x01 | x10)));
  assign new_n35_ = x08 & x09;
  assign z5 = x10 | (x01 & ((~x00 & ~x07 & (x12 | ~x13)) | x00 | x07));
  assign z6 = new_n38_ & x01;
  assign new_n38_ = ~x07 & ~x10 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = x10 | (x01 & (x07 | ~x08));
  assign z8 = x10 | (x01 & (~x00 | x07 | x09));
endmodule
