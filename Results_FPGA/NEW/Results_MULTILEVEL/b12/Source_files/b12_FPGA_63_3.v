...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (~x13 | ~x14)) : ((~new_n37_ & (~x13 | (x00 & ~x14))) | (~x00 & (~x13 | ~x14)));
  assign new_n37_ = x08 & x09;
  assign z5 = ~x13 | (~x14 & (x00 | x07 | (~x00 & ~x07 & (x10 | x12))));
  assign z6 = ~x07 & ~x10 & (new_n42_ | (~new_n40_ & ~x00));
  assign new_n40_ = ~new_n41_ & (~x01 | (x14 & (x02 | x13)));
  assign new_n41_ = (~x14 | (~x01 & ~x13)) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n42_ = ~x08 & (new_n41_ | (x01 & (~x14 | (x00 & ~x13))));
