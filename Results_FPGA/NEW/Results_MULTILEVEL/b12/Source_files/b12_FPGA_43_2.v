...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (~x09 | x12)) : (~x09 | (x12 & (~x00 | ~x08)));
  assign z5 = x12 | (~x09 & (x07 | (~x07 & (x00 | x10 | ~x13))));
  ...
  assign z7 = (~new_n43_ & (x01 | x02 | ~x03)) | new_n44_ | (~x01 & ~x02 & new_n42_ & x03);
  assign new_n42_ = x09 & x12;
  assign new_n43_ = (x08 | (x09 & ~x12)) & (~x12 | (~x07 & ~x10));
  assign new_n44_ = ~x09 & (x07 | x10);
  assign z8 = x09 ? x12 : (~x00 | x07 | x10);
endmodule
