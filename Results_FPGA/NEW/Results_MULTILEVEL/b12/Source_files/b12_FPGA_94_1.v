...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (x08 | ~x12)) : (x00 ? (x08 ? ~x09 : ~x12) : (~x12 | (x08 & x12)));
  assign z5 = (x00 & (x08 | (~x07 & ~x08 & ~x12))) | (x07 & (x08 | ~x12)) | (~x00 & ~x07 & (x12 ? x08 : (x10 | ~x13)));
  ...
  assign z7 = ~new_n42_ | (~new_n41_ & (x08 | ~x12));
  assign new_n41_ = ~x07 & ~x10;
  assign new_n42_ = (~x09 | ((x08 | x12) & (x01 | x02 | ~x03 | ~x08))) & (x08 | x12 | (~x01 & ~x02 & x03));
  assign z8 = (~x09 & ((~new_n41_ & x08) | (~x00 & (x08 | ~x12)))) | (~x12 & (~new_n41_ | (~new_n44_ & x09))) | (x08 & x09 & x12);
