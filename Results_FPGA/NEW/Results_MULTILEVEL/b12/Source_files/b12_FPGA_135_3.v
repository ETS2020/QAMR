...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & (~x09 | ~x10)) | (~new_n32_ & ~x01);
  assign new_n31_ = (x00 | (~x02 & (x01 | x03 | ~x07))) & (~x02 | x07 | x08);
  assign new_n32_ = (x00 | ((x03 | x09 | ~x10) & (x07 | ~x09 | x10))) & (x07 | x08 | ((x03 | x09 | ~x10) & (~x09 | x10)));
  assign z3 = (~x09 | ~x10) & (~x07 | ~x11) & (x00 | ~x12);
  assign z4 = x07 ? (~x11 & (~x09 | ~x10)) : ((x00 & (~x09 | (~x08 & ~x10))) | (~x09 & x10) | (~x00 & ~x10));
  assign z5 = (x00 & (~x10 | (~x07 & ~x09))) | (~x07 & ((~x09 & x10) | (~x00 & ~x10 & (x12 | ~x13)))) | (x07 & (~x09 | ~x10));
  assign z6 = ~x07 & ~x10 & (new_n37_ | new_n38_);
  assign new_n37_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n38_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = x10 ? ~x09 : ~new_n40_;
  assign new_n40_ = (x08 | (~x01 & ~x02 & x03)) & ~x07 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x09 & (~x00 | x10)) | (~x10 & (x07 | (~new_n42_ & x09)));
