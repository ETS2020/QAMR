...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n34_, new_n37_;
  ...
  assign z4 = x07 ? (~x11 & (x02 | x10)) : ((~new_n34_ & (x10 | (x00 & x02))) | (~x00 & (x02 | x10)));
  assign new_n34_ = x08 & x09;
  assign z5 = x10 | (x02 & ((~x00 & ~x07 & (x12 | ~x13)) | x00 | x07));
  assign z6 = new_n37_ & x02;
  assign new_n37_ = ~x07 & ~x10 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = x10 | (x02 & (x07 | ~x08));
  assign z8 = x10 | (x02 & (~x00 | x07 | x09));
endmodule
