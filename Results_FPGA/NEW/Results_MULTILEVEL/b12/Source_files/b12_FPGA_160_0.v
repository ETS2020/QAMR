...
module FAU ( 
  ...
  assign z2 = x00 ? (new_n31_ & ~x07) : (x07 & (x02 | (~x01 & ~x03)));
  assign new_n31_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = (x00 & (~x07 | ~x11)) | (x07 & ~x11 & ~x12);
  assign z4 = (x00 & ~x07 & (~x08 | ~x09)) | (x07 & ~x11);
  assign z5 = x00 | x07;
  assign z6 = x00 & new_n36_ & ~x07;
  assign new_n36_ = ~x08 & ~x10 & (x01 | x02 | (~x03 & x09) | (x03 & ~x09));
