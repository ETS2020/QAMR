...
module FAU ( 
  ...
  assign z4 = (~x00 & (~x07 | (x07 & ~x11))) | (x12 & (x07 ? ~x11 : (~x08 | ~x09)));
  assign z5 = (x07 & (~x00 | (~x11 & x12))) | (x00 & x12) | (~new_n37_ & ~x07);
  assign new_n37_ = (x00 | (~x10 & ~x12 & x13)) & (~x12 | (x08 & x09));
  ...
  assign z7 = (~x00 | x12) & (new_n42_ | x07 | new_n43_ | x10);
  assign new_n42_ = ~x08 & (x01 | x02 | ~x03);
  assign new_n43_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = ((~x00 | x12) & (x07 | x10)) | (~new_n43_ & ~x00) | (x09 & x12);
endmodule
