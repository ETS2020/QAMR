// Benchmark "FAU" written by ABC on Wed Aug  5 21:23:32 2020
...
module FAU ( 
  ...
  assign new_n32_ = (x01 | (~x02 & (x03 | ~x10))) & (~x02 | ~x09);
  assign new_n33_ = (x00 | (x07 ? x03 : (~x09 | x10))) & (~x09 | x10 | x07 | x08);
  assign z3 = (~x07 | ~x11) & (~x01 | x09) & (x00 | ~x12);
  assign z4 = x07 ? (~x11 & (~x01 | x09)) : (x00 ? (x09 ? ~x08 : ~x01) : (~x01 | x09));
  assign z5 = (x00 & (x09 | (~x01 & ~x07 & ~x09))) | ((~x01 | x09) & (x07 | (~x00 & ~new_n37_ & ~x07)));
  ...
  assign z7 = ((~x01 | x09) & (x07 | x10)) | (~x01 & ~new_n42_ & ~x08) | (x09 & (x01 ? ~x08 : new_n42_));
  assign new_n42_ = ~x02 & x03;
  assign z8 = ((~x01 | x09) & (x07 | x10)) | (~new_n44_ & x09) | (~x00 & ~x01 & ~x09);
