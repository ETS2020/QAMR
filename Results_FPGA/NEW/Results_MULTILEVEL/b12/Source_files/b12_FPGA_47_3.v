...
module FAU ( 
  ...
  assign new_n30_ = x00 & (x04 | x07 | x08);
  ...
  assign z4 = (~x04 & ((x00 & ~x07 & (~x08 | ~x09)) | (x07 & ~x11))) | (~x00 & (~x07 | (x07 & ~x11)));
  assign z5 = (~x04 & (x00 | (x07 & ~x11))) | (~x00 & (x07 | (~new_n37_ & ~x07)));
  assign new_n37_ = ~x10 & ~x12 & x13;
  assign z6 = ~x07 & ~x10 & (x01 ? ~new_n40_ : new_n39_);
  assign new_n39_ = (~x00 | (~x04 & ~x08)) & (x02 | (x03 & ~x09) | (~x03 & x09));
  assign new_n40_ = x00 ? (x04 | x08) : (x02 & x14);
  assign z7 = (~x00 | ~x04) & (new_n42_ | ~new_n43_);
  assign new_n42_ = ~x08 & (x01 | x02 | ~x03);
  assign new_n43_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n45_ & (~x00 | (~x04 & x09))) | ((~x00 | ~x04) & (x07 | x10)) | (~x00 & ~x09);
