...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | (x02 ? (x04 | x14) : ~x01)) & (~x01 | ~x02 | x14 | (x04 & ~x05));
  assign z1 = ~x00 & ((new_n29_ & x02) | (x01 & ~x02 & x03));
  assign new_n29_ = ~x14 & (x03 | x04) & (~x01 | ~x05 | ~x06);
  ...
  assign new_n39_ = x02 ? x14 : (~x01 & (x03 | ~x09) & (~x03 | x09));
  assign z7 = new_n41_ | (~new_n42_ & ~x02) | (x02 & ~x08 & ~x14);
  assign new_n41_ = (~x02 | ~x14) & (x07 | x10);
  assign new_n42_ = (x08 | (~x01 & x03)) & (x01 | ~x03 | ~x09);
  assign z8 = (~x00 & (x02 ? ~x14 : ~x09)) | new_n41_ | (x09 & (x02 ? ~x14 : ~new_n44_));
