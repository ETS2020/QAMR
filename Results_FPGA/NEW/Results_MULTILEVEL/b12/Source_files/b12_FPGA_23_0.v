...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | ((~x02 | x04) & (~x01 | x02 | ~x14))) & (~x01 | ~x02 | (x04 & ~x05));
  assign z1 = ~x00 & ((new_n29_ & x02) | (x01 & ~x02 & x03 & x14));
  assign new_n29_ = (x03 | x04) & (~x01 | ~x05 | ~x06);
  assign z2 = (~new_n31_ & ~new_n32_) | (~x01 & ~new_n33_ & x14);
  ...
  assign new_n39_ = x14 & (~x00 | ~x08) & (x01 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = x00 ? x08 : (x01 & x14);
  assign z7 = new_n42_ | ~new_n43_;
  assign new_n42_ = (x07 | x10) & (x02 | x14);
  assign new_n43_ = (x08 | (~x02 & (~x14 | (~x01 & x03)))) & (x01 | x02 | ~x03 | ~x09 | ~x14);
  assign z8 = (~x00 & (x02 | (~x09 & x14))) | new_n42_ | (x09 & (x02 | (~new_n45_ & x14)));
