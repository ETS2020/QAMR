...
module FAU ( 
  ...
  assign z2 = ((new_n32_ | new_n33_) & ~x00) | (new_n34_ & ~x07);
  ...
  assign z4 = x07 ? (~x11 & (~x08 | ~x14)) : (~x08 | (~x14 & (~x00 | (x00 & ~x09))));
  assign z5 = (x00 & (~x14 | (~x07 & ~x08))) | (x07 & (~x08 | ~x14)) | (~x07 & ~new_n38_ & (~x08 | (~x00 & ~x14)));
  assign new_n38_ = ~x10 & ~x12 & x13;
  assign z6 = ~x07 & ~x10 & (new_n42_ | (~new_n40_ & ~new_n41_));
  assign new_n40_ = (x00 | x14) & (x01 | x08);
  assign new_n41_ = ~x02 & (x03 | ~x09) & (~x03 | x09);
  assign new_n42_ = x01 & ((~x00 & ~x14) | (~x08 & (x00 | ~x02)));
  assign z7 = ~new_n44_ | (~new_n27_ & (x07 | x10));
  assign new_n44_ = (~x09 | (x08 & (x01 | x02 | ~x03 | x14))) & (x08 | (~x01 & ~x02 & x03));
