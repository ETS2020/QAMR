...
module FAU ( 
  ...
  assign z5 = x12 | (x01 & (x00 | x07 | (~x00 & ~x07 & (x10 | ~x13))));
  assign z6 = ~x07 & ~x10 & (x01 ? ~new_n41_ : new_n40_);
  assign new_n40_ = x12 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n41_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n43_ | ((x07 | x10) & (x01 | x12));
  assign new_n43_ = (x08 | (~x01 & (~x12 | (~x02 & x03)))) & (x01 | x02 | ~x03 | ~x09 | ~x12);
  assign z8 = (x01 | x12) & (~x00 | x07 | x09 | x10);
endmodule
