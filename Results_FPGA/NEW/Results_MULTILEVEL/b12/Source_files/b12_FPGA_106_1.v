// Benchmark "FAU" written by ABC on Wed Aug  5 21:23:14 2020
...
module FAU ( 
  ...
  assign new_n39_ = ~x09 & (x02 | x03) & (~x00 | ~x08);
  assign new_n40_ = x00 ? x08 : (x02 & x14);
  assign z7 = (~new_n42_ & (x01 | ~x09)) | (~x08 & (x01 | (~x09 & (x02 | ~x03))));
  assign new_n42_ = ~x07 & ~x10;
  assign z8 = x09 ? x01 : (~new_n42_ | ~x00);
endmodule
