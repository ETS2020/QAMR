...
module FAU ( 
  ...
  assign z4 = ((~x08 | ~x09) & ((~x07 & ~x13) | (x00 & ~x11))) | (~x00 & (~x11 | (~x07 & ~x13))) | (x07 & ~x11);
  assign z5 = ~x13 | (~x11 & (x00 | x07 | (~x00 & (x10 | x12))));
  assign z6 = ~x07 & ~x10 & ~new_n27_ & (new_n39_ | new_n40_);
  ...
  assign z8 = ~new_n27_ & ((~new_n44_ & x09) | x07 | x10 | (~x00 & ~x09));
