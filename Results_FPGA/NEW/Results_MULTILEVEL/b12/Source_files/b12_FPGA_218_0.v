...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | ((~x02 | x04) & (~x01 | x02 | ~x09))) & (~x01 | ~x02 | (x04 & ~x05));
  ...
  assign z5 = (x00 & (x09 | (x02 & ~x07 & ~x09))) | ((x02 | x09) & (x07 | (~x00 & ~new_n36_ & ~x07)));
  assign new_n36_ = ~x10 & ~x12 & x13;
  assign z6 = ~x07 & ~x10 & (x02 ? ~new_n39_ : new_n38_);
  assign new_n38_ = x09 & (~x00 | ~x08) & (x01 | ~x03);
  assign new_n39_ = x00 ? x08 : (x01 & x14);
  assign z7 = (~new_n41_ & (x02 | x09)) | (~x01 & ~x02 & x03 & x09);
  assign new_n41_ = ~x07 & x08 & ~x10;
  assign z8 = ((x02 | x09) & (x07 | x10)) | (x02 & (~x00 | x09)) | (~new_n43_ & x09);
