...
module FAU ( 
  ...
  assign z06 = x046 & (new_n211_ | (~new_n215_ & x078) | (new_n225_ & ~x022));
  assign new_n211_ = ~new_n162_ & (new_n214_ | new_n212_ | (~x014 & ~x078));
  assign new_n212_ = x054 & (new_n213_ | (~x006 & ~x086 & (x038 | x078)));
  assign new_n213_ = ~x014 & x086 & (~x110 | ~x118);
  assign new_n214_ = ~x054 & (~x038 | (~x006 & x014 & ~x086));
  assign new_n215_ = ~new_n221_ & (x094 | (~new_n224_ & (~x054 | (~new_n216_ & ~new_n219_))));
  assign new_n216_ = x086 & (~new_n218_ | (~x030 & ~new_n217_ & x062));
  assign new_n217_ = x110 & x118 & ((~x014 & ~x022) | (x102 & x126));
  assign new_n218_ = x070 & (x022 | (x110 & x118));
  assign new_n219_ = new_n220_ & ~x006;
  assign new_n220_ = x070 & (x014 | x022 | (x062 & (~x102 | ~x126)));
  assign new_n221_ = ~x070 & (x054 ? (new_n222_ | (~new_n223_ & ~x006)) : ~x022);
  assign new_n222_ = x086 & (~x062 | (x022 & ~x030));
  assign new_n223_ = (~x022 | x126 | (~x110 & ~x118)) & (~x038 | (x102 & x110 & x118));
  assign new_n224_ = ~x038 & (x086 | (~x006 & x070));
  assign new_n225_ = ~x070 & (x054 ? (new_n226_ | x014 | x038 | ~x078) : ~x014);
  ...
  assign z14 = ~x046 & ((~new_n300_ & (~x070 | ~x094)) | (new_n314_ & ~x070) | (~new_n304_ & ~x094));
  ...
  assign new_n304_ = (~x070 | (~new_n313_ & (new_n305_ | x054))) & (x054 | new_n308_ | x078);
  assign new_n305_ = (x078 | (~new_n306_ & ~new_n307_)) & (~x022 | (x014 & x038 & ~x078));
  assign new_n306_ = x006 & ~x038 & (x110 | x118);
  assign new_n307_ = ~x086 & (x062 | (~x022 & x030));
  assign new_n308_ = (new_n309_ | new_n310_) & ~new_n312_ & (new_n311_ | ~x006);
  assign new_n309_ = ~x102 & ~x126;
  assign new_n310_ = (~x006 | x070) & (~x030 | x086 | (x022 & (x014 | x070)));
  assign new_n311_ = (x038 | ~x102) & (x022 | ~x126 | (x110 & x118));
  assign new_n312_ = x030 & ~x070 & ~x086 & (x110 | x118);
  assign new_n313_ = x022 & x054 & (x014 | ~x078);
  assign new_n314_ = ~x078 & (new_n319_ | (~x054 & (new_n315_ | (new_n318_ & x030))));
  assign new_n315_ = x006 & (new_n317_ | (~new_n309_ & (~x022 | ~x062)) | (~new_n316_ & ~x022));
  assign new_n316_ = ~x110 & ~x118;
  assign new_n317_ = (~x022 | (~x014 & ~x038)) & (x030 | x062 | x094);
  assign new_n318_ = ~x062 & ~x086 & (~new_n316_ | (~new_n309_ & (~x014 | ~x022)));
  assign new_n319_ = x038 & (new_n320_ | (~new_n309_ & x006));
