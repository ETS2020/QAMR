...
module FAU ( 
  ...
  assign z08 = ~x040 & (new_n246_ | ~new_n248_ | (~x048 & (new_n229_ | new_n242_)));
  assign new_n229_ = ~x080 & (new_n230_ | new_n233_ | (~x072 & (new_n236_ | new_n241_)));
  assign new_n230_ = (x104 | x112) & (x008 | (~x072 & (new_n231_ | ~new_n232_)));
  assign new_n231_ = x000 & (~x032 | ~x064);
  assign new_n232_ = ~x016 & (~x024 | x064 | (x056 & x088));
  assign new_n233_ = x064 & (new_n234_ | (~new_n235_ & ~x072) | (x016 & (~x008 | x072)));
  assign new_n234_ = ~x032 & (x016 | (x000 & ~x072 & x096));
  assign new_n235_ = ~x056 & ~x088 & (x016 | ~x024);
  assign new_n236_ = x000 & ((~new_n237_ & x024) | new_n238_ | new_n239_ | new_n240_);
  assign new_n237_ = x016 & (x008 | x064);
  assign new_n238_ = (x056 | x088) & (~x008 | ~x016);
  assign new_n239_ = ~x064 & (x096 | x120) & (~x016 | ~x056 | ~x088);
  assign new_n240_ = ~x016 & x120 & (~x104 | ~x112);
  assign new_n241_ = x024 & (x096 | x120) & ~new_n237_ & (~x056 | ~x088);
  assign new_n242_ = x070 & (~new_n243_ | new_n245_);
  assign new_n243_ = (~x000 | new_n244_ | x072) & (~x016 | ~x064 | (x008 & ~x072));
  assign new_n244_ = ~x080 & (x016 | ~x056 | x064);
  assign new_n245_ = ~x032 & ((x016 & x064) | (x000 & x080));
  assign new_n246_ = ~x008 & (new_n247_ | (x000 & x048 & x070 & x080));
  assign new_n247_ = x024 & x032 & ~x064 & ~x072 & ~x080;
  assign new_n248_ = (new_n249_ | (~x070 & x080)) & (~x032 | x072 | new_n235_ | x080);
  assign new_n249_ = (~x008 | (~x072 & (~x016 | ~x048 | ~x064))) & (~x048 | (~x032 & (~x016 | ~x064 | x072)));
  ...
  assign z14 = ~x046 & (new_n297_ | new_n300_ | (~x078 & ~new_n305_ & ~x080));
  assign new_n297_ = ~new_n165_ & ((~new_n299_ & x054) | (x014 & x078) | (~new_n298_ & ~x054));
  assign new_n298_ = (~x006 | ~x086 | (x038 & x078)) & (~x014 | new_n218_ | x086);
  assign new_n299_ = ~x038 & (~x006 | x014 | ~x086);
  assign new_n300_ = x070 & ((~new_n301_ & x022) | (~x054 & ~new_n302_ & ~x078));
  assign new_n301_ = x054 ? (~x014 & x078) : ((new_n218_ | x086) & x014 & x038 & ~x078);
  ...
  assign new_n306_ = ~new_n218_ & ((x022 & ~x086) | (~new_n307_ & ~x070));
