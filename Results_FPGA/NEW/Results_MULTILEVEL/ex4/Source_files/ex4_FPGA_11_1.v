...
module FAU ( 
  ...
  assign z03 = x043 & ((~new_n175_ & (x083 | ~x100)) | (~x003 & ~x083 & ~new_n176_ & ~x100));
  ...
  assign new_n242_ = ~x080 & ((~x016 & x024) | x056 | x088);
  ...
  assign z11 = ~x043 & ((~new_n271_ & (x083 | ~x100)) | (x003 & ~new_n272_ & x083));
  ...
  assign new_n312_ = ~x086 & ((~x022 & x030) | x062 | x094);
