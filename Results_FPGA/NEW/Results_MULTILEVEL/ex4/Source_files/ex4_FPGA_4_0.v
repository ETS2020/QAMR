// Benchmark "FAU" written by ABC on Thu Aug  6 18:29:51 2020
...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n204_ & (x070 | x077)) | (~new_n208_ & x077) | (new_n215_ & x070));
  ...
  assign z13 = ~x045 & (new_n287_ | (x070 & (~new_n278_ | (~new_n270_ & x005))));
  assign new_n270_ = ~new_n277_ & (x077 | (~new_n276_ & (x053 | (~new_n271_ & new_n274_))));
  assign new_n271_ = ~x069 & (new_n272_ | new_n273_ | (~x021 & (x109 | x117)));
  assign new_n272_ = (~x021 | (~x013 & ~x037)) & (x029 | x061 | x093);
  assign new_n273_ = (x101 | x125) & (~x021 | ~x061 | ~x093);
  assign new_n274_ = new_n275_ & (x021 | ~x125 | (x109 & x117));
  assign new_n275_ = ~x085 & (x037 | ~x069 | (~x101 & ~x109 & ~x117));
  assign new_n276_ = x037 & ~x069 & (x101 | x125);
  assign new_n277_ = ~x013 & x053 & x085;
  assign new_n278_ = new_n286_ & (x085 | (~new_n284_ & (x053 | (~new_n279_ & ~new_n281_))));
  assign new_n279_ = (x109 | x117) & (new_n280_ | x013);
  assign new_n280_ = ~x077 & (x021 | (x029 & ~x069 & (~x061 | ~x093)));
  assign new_n281_ = ~x077 & (new_n282_ | (x029 & new_n283_ & (x101 | x125)));
  assign new_n282_ = x069 & (x061 | x093 | (~x021 & x029));
  assign new_n283_ = (~x061 | ~x093) & (~x021 | (~x013 & ~x069));
  assign new_n284_ = x037 & ~new_n285_ & ~x077;
  assign new_n285_ = ~x061 & ~x093 & (~x029 | (x021 & (x013 | x069)));
  assign new_n286_ = (~x037 | ~x053) & (~x021 | ~x069 | (x053 ? (~x013 & x077) : (x013 & x037)));
  assign new_n287_ = x077 & (~new_n288_ | (x005 & x085 & (~x037 | x053)));
  assign new_n288_ = ~x013 & (~x037 | ~x053) & (~x021 | x053 | ~x069);
  assign z14 = ~x046 & (new_n290_ | new_n293_ | (x077 & ~new_n298_ & ~x078));
  assign new_n290_ = ~new_n162_ & ((~new_n292_ & x054) | (~new_n291_ & ~x054) | (x014 & x078));
  assign new_n291_ = (~x006 | ~x086 | (x038 & x078)) & (~x014 | new_n213_ | x086);
  assign new_n292_ = ~x038 & (~x006 | x014 | ~x086);
  assign new_n293_ = x070 & ((~new_n294_ & x022) | (~x054 & ~new_n295_ & ~x078));
  assign new_n294_ = x054 ? (~x014 & x078) : ((new_n213_ | x086) & x014 & x038 & ~x078);
  ...
  assign new_n299_ = ~new_n213_ & ((~new_n300_ & ~x070) | (x022 & ~x086));
  assign new_n300_ = (~x006 | x022) & (~x030 | x086 | (x062 & x094));
  assign new_n301_ = ~x070 & ((new_n304_ & ~x014) | (x006 & (new_n302_ | new_n303_)));
