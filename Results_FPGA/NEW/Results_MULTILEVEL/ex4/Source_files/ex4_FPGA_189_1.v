...
module FAU ( 
  ...
  assign z02 = x042 & ((~new_n170_ & (x066 | ~x070)) | (~x018 & ~x066 & ~new_n171_ & ~x070));
  ...
  assign z06 = x046 & (new_n209_ | new_n213_ | (x066 & ~new_n218_ & x078));
  ...
  assign z10 = ~x042 & ((~new_n259_ & (x066 | ~x070)) | (x018 & ~new_n260_ & x066));
  assign new_n259_ = (~x002 | ~x082 | (x010 ? (~x034 & x050) : (x034 & x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign new_n260_ = x010 ? x034 : (~x034 & x050 & x074);
  ...
  assign z14 = ~x046 & ((~new_n298_ & (x066 | ~x070)) | (~new_n302_ & x066) | (new_n308_ & ~x070));
