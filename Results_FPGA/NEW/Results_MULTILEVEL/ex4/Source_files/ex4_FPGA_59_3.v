...
module FAU ( 
  ...
  assign z06 = x046 & (new_n209_ | new_n213_ | (x078 & ~new_n218_ & ~x083));
  ...
  assign z11 = ~x043 & ((~new_n264_ & (~x070 | ~x083)) | (x003 & ~x070 & ~new_n265_ & x083));
  assign new_n264_ = (~x011 | (~x075 & (~x019 | x035 | ~x067))) & (~x035 | (~x051 & (x011 | ~x019 | ~x067))) & (x011 | ~x019 | ~x067 | (x051 & x075));
  assign new_n265_ = x011 ? (~x035 & x051) : (x035 & x075);
  ...
  assign z14 = ~x046 & ((~new_n298_ & (~x070 | ~x083)) | (~new_n302_ & ~x083) | (new_n308_ & ~x070));
