// Benchmark "FAU" written by ABC on Thu Aug  6 18:30:23 2020
...
module FAU ( 
  ...
  assign z08 = ~x040 & (~new_n247_ | (~x072 & (new_n237_ | new_n241_ | new_n254_)));
  assign new_n237_ = x064 & ((~new_n238_ & ~x048) | (x016 & ~new_n162_ & x048));
  assign new_n238_ = (~x088 | (~x000 & x080)) & (~x104 | ((new_n239_ | x080) & (new_n240_ | ~x000)));
  assign new_n239_ = ~x024 & ~x056;
  assign new_n240_ = x032 & ~x080 & (x112 | ~x120);
  assign new_n241_ = ~x048 & (new_n244_ | (~x080 & (new_n242_ | new_n246_)));
  assign new_n242_ = x024 & ((~x056 & (x104 | (~new_n243_ & x088))) | (~x088 & x104));
  assign new_n243_ = ~x112 & ((~x096 & ~x120) | (x008 & x016));
  assign new_n244_ = x000 & ((~x016 & (x088 | (~x064 & x104))) | (~new_n245_ & x088) | (~x064 & ~x088 & x104));
  assign new_n245_ = x008 & ~x080 & (x056 | (~x096 & ~x120));
  assign new_n246_ = x016 & (x104 | (x088 & x112));
  assign new_n247_ = (new_n250_ | x048) & (new_n162_ | (new_n248_ & ~new_n253_));
  assign new_n248_ = ~new_n249_ & (~x016 | x048 | ~x064 | (x032 & ~x072)) & (~x032 | ~x048);
  assign new_n249_ = ~x008 & ((x016 & ~x048 & x064) | (x000 & x048 & x080));
  assign new_n250_ = ~new_n251_ & (~x000 | (~new_n252_ & (~x016 | ~x064 | ~x104)));
  assign new_n251_ = x008 & ~x080 & (x104 | (x088 & x112));
  assign new_n252_ = ~x032 & x080 & (x088 | (x072 & x104));
  assign new_n253_ = x008 & (x072 | (x016 & x048 & x064));
  assign new_n254_ = x032 & ((~x080 & (x088 | (x056 & x104))) | (x000 & x088));
  ...
  assign z14 = ~x046 & ~new_n162_ & (new_n326_ | ~new_n321_ | (~new_n302_ & ~x054));
  assign new_n302_ = ~new_n303_ & ~new_n307_ & ~new_n320_ & (x078 | (~new_n311_ & new_n315_));
  assign new_n303_ = ~new_n304_ & ((~x078 & (new_n305_ | (~new_n306_ & ~x086))) | (x014 & ~x086));
  assign new_n304_ = ~x110 & ~x118;
  assign new_n305_ = x006 & (x070 ? ~x038 : ~x022);
  assign new_n306_ = ~x022 & (~x030 | x070 | (x062 & x094));
  assign new_n307_ = x070 & ((~new_n308_ & x022) | (~x078 & (new_n309_ | new_n310_)));
  assign new_n308_ = x014 & x038;
  assign new_n309_ = ~x086 & (x062 | x094 | (~x022 & x030));
  assign new_n310_ = x006 & ~x038 & x102;
  ...
  assign new_n315_ = ~new_n319_ & (x022 | (~new_n318_ & (~x126 | (~new_n316_ & ~new_n317_))));
  assign new_n316_ = x006 & (~x110 | ~x118);
  assign new_n317_ = x030 & ~x086 & (~x062 | ~x094);
  assign new_n318_ = x030 & ~x086 & x102 & (~x062 | ~x094);
  assign new_n319_ = x006 & x086;
  ...
  assign new_n324_ = ~x078 & (new_n309_ | (x006 & ~x070 & (x102 | x126)));
