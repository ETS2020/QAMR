// Benchmark "FAU" written by ABC on Thu Aug  6 18:29:58 2020
...
module FAU ( 
  ...
  assign z04 = x044 & ((~new_n180_ & (~x070 | ~x084)) | (~x004 & ~new_n181_ & ~x084));
  assign new_n180_ = (x012 | (x076 & (x020 | ~x036 | x068))) & (x036 | (x052 & (~x012 | x020 | x068))) & (~x012 | x020 | x068 | (~x052 & ~x076));
  assign new_n181_ = x012 ? (~x036 & ~x076) : (x036 & ~x052);
  ...
  assign z06 = x046 & (new_n209_ | new_n213_ | (x078 & ~new_n218_ & ~x084));
  assign new_n209_ = ~new_n162_ & ((~new_n212_ & ~x054) | (~x014 & ~x078) | (~new_n210_ & x054));
  ...
  assign new_n235_ = ~x080 & (x056 | x088 | (~x016 & x024));
  assign new_n236_ = x000 & ~x032 & x096;
  assign new_n237_ = ~x064 & ((new_n240_ & ~x008) | (x000 & (new_n238_ | new_n239_)));
  ...
  assign z12 = ~x044 & ((~new_n269_ & (~x070 | ~x084)) | (x004 & ~x070 & ~new_n270_ & x084));
  assign new_n269_ = (~x012 | (~x076 & (~x020 | x036 | ~x068))) & (~x036 | (~x052 & (x012 | ~x020 | ~x068))) & (x012 | ~x020 | ~x068 | (x052 & x076));
  assign new_n270_ = x012 ? (~x036 & x052) : (x036 & x076);
  ...
  assign z14 = ~x046 & ((~new_n298_ & (~x070 | ~x084)) | (~new_n302_ & ~x084) | (new_n308_ & ~x070));
