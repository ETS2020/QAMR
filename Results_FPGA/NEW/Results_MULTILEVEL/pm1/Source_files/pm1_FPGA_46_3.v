...
module FAU ( 
  ...
  assign z02 = ~x11 | (~x05 & x11);
  assign z03 = ~x11 | (~x05 & (~x09 | ~x12));
  assign z04 = ~x14 & (~x05 | ~x11);
  assign z05 = ~x13 & (~x05 | ~x11);
  assign z06 = x01 & ~new_n38_ & x09;
  assign new_n38_ = ((x05 & x11) | (x02 & x03 & x04)) & (x11 | ~x12);
  assign z07 = ~x15 & (~x05 | ~x11);
  assign z08 = ~x11 | (~x05 & (~new_n41_ | ~x00));
  ...
  assign z11 = x00 & ~x05 & ~x10 & ~new_n46_ & x11;
