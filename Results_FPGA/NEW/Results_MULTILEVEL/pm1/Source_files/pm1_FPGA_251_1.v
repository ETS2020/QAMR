// Benchmark "FAU" written by ABC on Sat Aug  8 21:52:58 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n39_, new_n42_, new_n46_, new_n47_;
  assign z00 = x12 | (~x14 & (x01 | x11));
  assign z01 = x12 ? x11 : ~x14;
  assign z02 = x12 ? ~new_n34_ : ~x14;
  ...
  assign z06 = x01 & x09 & ((~new_n39_ & (x12 | ~x14)) | (~x11 & x12));
  assign new_n39_ = x02 & x03 & x04;
  assign z07 = ~x15 & (x12 | ~x14);
  assign z08 = new_n42_ | ((x12 | ~x14) & (~x00 | x10 | ~x11));
  assign new_n42_ = x02 & x03 & x04 & x09 & x12;
  assign z09 = x00 & ~x10 & (x11 ? x12 : (~x12 & ~x14));
