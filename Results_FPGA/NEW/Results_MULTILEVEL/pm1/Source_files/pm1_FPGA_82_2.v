...
module FAU ( 
  ...
  assign z02 = (~x07 & (x11 | ~x12)) | (x12 & (~x11 | (x11 & (~new_n34_ | ~x08 | ~x09))));
  assign new_n34_ = x05 & x06;
  assign z03 = x12 ? ((new_n34_ & x07 & x08) | ~x09 | ~x11) : ~x07;
  assign z04 = ~x14 & (~x07 | x12);
  assign z05 = ~x13 & (~x07 | x12);
  assign z06 = x01 & x09 & ((~x11 & x12) | (~new_n39_ & (~x07 | x12)));
  assign new_n39_ = x02 & x03 & x04;
  assign z07 = ~x15 & (~x07 | x12);
  assign z08 = new_n42_ | ((~x07 | x12) & (~x00 | x10 | ~x11));
  assign new_n42_ = x02 & x03 & x04 & x09 & x12;
  assign z09 = x00 & ~x10 & ((x11 & x12) | (~x07 & ~x11 & ~x12));
