...
module FAU ( 
  ...
  assign z02 = ~x05 | (x11 & (~x06 | ~x07 | ~new_n34_ | ~x08));
  assign new_n34_ = x09 & x12;
  assign z03 = x11 ? (~new_n34_ | (x05 & x06 & x07 & x08)) : ~x05;
  assign z04 = ~x14 & (~x05 | x11);
  assign z05 = ~x13 & (~x05 | x11);
  assign z06 = x01 & x09 & ((~new_n39_ & (~x05 | x11)) | (~x05 & ~x11 & x12));
  assign new_n39_ = x02 & x03 & x04;
  assign z07 = ~x15 & (~x05 | x11);
  assign z08 = x11 ? (~new_n42_ | ~x00) : ~x05;
