...
module FAU ( 
  ...
  assign z02 = ~x11 | (x06 & (~x12 | (~new_n34_ & x11)));
  assign new_n34_ = x05 & x07 & x08 & x09;
  assign z03 = new_n36_ | ~x11;
  assign new_n36_ = x06 & ((x05 & x07 & x08) | ~x09 | ~x12);
  assign z04 = ~x14 & (x06 | ~x11);
  assign z05 = ~x13 & (x06 | ~x11);
  assign z06 = x01 & ~new_n40_ & x09;
  assign new_n40_ = (x11 | ~x12) & ((~x06 & x11) | (x02 & x03 & x04));
  assign z07 = ~x15 & (x06 | ~x11);
  assign z08 = ~x11 | (x06 & (~new_n43_ | ~x00));
  ...
  assign z11 = x00 & x06 & ~x10 & ~new_n48_ & x11;
