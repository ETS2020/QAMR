// Benchmark "FAU" written by ABC on Sat Aug  8 21:52:25 2020
...
module FAU ( 
  ...
  assign z04 = ~x14 & (x13 | (~x12 & ~x13));
  assign z05 = ~x12 & ~x13;
  assign z06 = x01 & ~new_n40_ & x09;
  assign new_n40_ = ((x12 & ~x13) | (x02 & x03 & x04)) & (x11 | ~x12 | ~x13);
  ...
  assign new_n48_ = x09 & x12 & x13 & (~x02 | ~x03 | ~x04);
