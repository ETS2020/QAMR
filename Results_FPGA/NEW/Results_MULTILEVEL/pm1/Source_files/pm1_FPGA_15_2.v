// Benchmark "FAU" written by ABC on Sat Aug  8 21:51:23 2020
...
module FAU ( 
  ...
  assign z08 = ~x11 | (~new_n42_ & x12);
  assign new_n42_ = x00 & ~x10 & (~x02 | ~x03 | ~x04 | ~x09);
  assign z09 = x00 & z01 & ~x10;
  assign z10 = x00 & new_n45_ & x09;
  assign new_n45_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = x00 & x01 & new_n45_ & x09;
