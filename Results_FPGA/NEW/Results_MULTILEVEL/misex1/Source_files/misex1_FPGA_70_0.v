...
module FAU ( 
  ...
  assign z1 = (~x2 & (((x5 | x6) & (x0 ? (~x1 & x3) : x1)) | (~x0 & ~x3 & x6))) | (~x0 & ~x1 & x2 & (x5 | (x3 & x6)));
  assign z2 = new_n21_ | (~new_n20_ & (x5 | x6));
  assign new_n20_ = (x0 | ~x1 | (~x3 & (x2 | ~x4))) & (~x0 | x1 | x2 | ~x3);
  assign new_n21_ = ~x0 & ~x1 & ~x3 & (x2 ? (~x5 & x6) : (x5 & ~x6));
  ...
  assign z5 = ((x5 | x6) & ((x0 & ~x1 & ~x2 & x3) | (~x0 & x1 & (~x2 | x3)))) | (x2 & ((~x0 & ((x3 & x6) | (~x1 & x5))) | (~x1 & ~x3 & (x5 | (x0 & x6))))) | (~x3 & x6 & ~x0 & ~x2);
