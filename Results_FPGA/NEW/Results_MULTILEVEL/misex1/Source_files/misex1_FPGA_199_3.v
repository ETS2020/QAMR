...
module FAU ( 
  ...
  assign z1 = (~new_n19_ & (~x6 | ~x7)) | (~x0 & ~x2 & ~x3 & x6 & ~x7);
  assign new_n19_ = (x0 | (x1 ? x2 : (~x2 | (~x3 & ~x5)))) & (~x0 | x1 | x2 | ~x3);
  assign z2 = (new_n22_ & ~x0) | (~new_n21_ & (~x6 | ~x7));
  assign new_n21_ = (~x0 | x1 | x2 | ~x3) & (x0 | ~x1 | (~x3 & (x2 | ~x4)));
  assign new_n22_ = ~x1 & ~x3 & ((~x5 & (~x6 | (x2 & ~x7))) | (~x2 & ~x6));
  ...
  assign z5 = (~new_n29_ & (~x6 | ~x7)) | (~x0 & ~x2 & ~x3 & x6 & ~x7);
