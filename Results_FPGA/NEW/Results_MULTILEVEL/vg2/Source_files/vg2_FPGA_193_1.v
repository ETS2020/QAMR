...
module FAU ( 
  ...
  assign z4 = ~new_n78_ | (z7 & (new_n86_ | ~x08));
  assign new_n78_ = (new_n79_ | (~x06 & x21)) & (~x00 | ~new_n83_ | x02);
  ...
  assign z7 = (~new_n85_ & (x06 | ~x21)) | (~x02 & x06 & ~x10 & x21 & ~x24);
  ...
  assign z6 = (~new_n90_ & ~x21) | (~new_n89_ & x06);
  assign new_n89_ = (new_n37_ | (~x03 & x11)) & (new_n64_ | (x03 & (~x11 | ~x14 | x20)));
  assign new_n90_ = (new_n37_ | (~x03 & (~new_n91_ | x11))) & (new_n85_ | (x03 & (x06 | ~x11)));
