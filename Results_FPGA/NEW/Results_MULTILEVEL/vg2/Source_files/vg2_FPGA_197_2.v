...
module FAU ( 
  ...
  assign z4 = (~new_n80_ & (~x08 | (~new_n83_ & x16))) | (z5 & (x08 | (~new_n82_ & ~x16)));
  assign z5 = (~new_n79_ & (~x02 | x03)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n79_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n80_ = ~new_n65_ & (new_n81_ | (x02 & ~x03));
  ...
  assign z6 = new_n94_ | (~x02 & (new_n85_ | new_n91_ | (new_n93_ & ~x05)));
  assign new_n85_ = ~x24 & (new_n90_ | new_n88_ | (new_n86_ & ~x11));
  assign new_n86_ = ~new_n87_ & ((x05 & x13 & x19) | (x00 & ~x10));
  assign new_n87_ = ~x06 & (x14 | ~x20);
  assign new_n88_ = ~x10 & (new_n89_ | (x00 & x03));
  assign new_n89_ = x11 & x21 & (~x06 | (x14 & ~x20));
  assign new_n90_ = ~x03 & ((x05 & x13 & x15) | (~x10 & x21));
  assign new_n91_ = x24 & ~new_n61_ & (new_n92_ | (~x03 & x18));
  assign new_n92_ = x07 & ~new_n87_ & ~x11;
  assign new_n93_ = ~x13 & ((~x11 & ~new_n87_ & x19) | (~x03 & x15));
  assign new_n94_ = x03 & ((x24 & ~new_n95_ & (x05 | x13)) | (~new_n96_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n95_ = ~x07 & (~x11 | ~x18 | (x06 & (~x14 | x20)));
  assign new_n96_ = ~x19 & (~x11 | ~x15 | (x06 & (~x14 | x20)));
  assign z7 = new_n65_ | (~new_n81_ & (x03 | (~x02 & ~x03)));
endmodule
