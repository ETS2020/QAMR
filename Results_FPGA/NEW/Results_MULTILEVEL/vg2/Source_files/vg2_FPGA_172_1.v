// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:53 2020
...
module FAU ( 
  ...
  assign z1 = (~x02 & (new_n40_ | new_n50_ | new_n57_)) | (x00 & (new_n40_ | new_n50_));
  ...
  assign new_n50_ = x24 & (x05 | x13) & (new_n53_ | (new_n41_ & new_n51_));
  ...
  assign z7 = (~new_n65_ & (x00 | ~x02)) | (~x02 & ~x10 & x21 & ~x24);
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (x00 & (new_n67_ | new_n72_)) | (~x02 & (new_n67_ | new_n72_ | (new_n76_ & ~x10)));
  ...
  assign z4 = (z5 & (x08 | (~new_n80_ & ~x16))) | (z7 & (~x08 | (~new_n79_ & x16)));
  assign new_n79_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n80_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z6 = (z5 & (x03 | (~new_n83_ & ~x11))) | (z7 & (~x03 | (~new_n82_ & x11)));
