...
module FAU ( 
  ...
  assign z7 = (~new_n74_ & (x02 | x06)) | (~x10 & x21 & ~x24 & ~x02 & x06);
  ...
  assign z6 = (~new_n81_ & x02) | (~new_n78_ & x06);
  assign new_n78_ = (new_n79_ | (~x03 & x11)) & (new_n60_ | (x03 & (~x11 | ~x14 | x20)));
  assign new_n79_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n80_ & (x05 | x13 | ~x19);
  assign new_n80_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n81_ = (new_n37_ | (~x03 & (~new_n82_ | x11))) & (new_n74_ | (x03 & (x06 | ~x11)));
