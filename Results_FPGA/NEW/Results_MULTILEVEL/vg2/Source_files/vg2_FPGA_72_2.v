...
module FAU ( 
  ...
  assign new_n43_ = ~new_n44_ & (~new_n48_ | ~new_n50_ | ~new_n51_ | ~x19 | x20);
  assign new_n44_ = new_n45_ & new_n47_ & x01 & x03 & x04 & x06;
  assign new_n45_ = new_n46_ & x16 & x17 & x14 & x15;
  assign new_n46_ = x23 & x24 & x20 & x22;
  assign new_n47_ = x11 & x12 & x08 & x09;
  assign new_n48_ = new_n49_ & ~x09 & ~x11 & ~x06 & ~x08;
  ...
  assign new_n53_ = new_n54_ & new_n49_ & ~x06 & x07 & ~x08 & ~x09;
  ...
  assign z7 = ~new_n66_ | (x05 & ((x18 & x24) | (new_n41_ & x15 & ~x24)));
  assign new_n66_ = (x04 | (~new_n67_ & ~new_n68_)) & (~x24 | (~new_n67_ & (~x13 | ~x18)));
  assign new_n67_ = ~x05 & ~x13 & x15;
  assign new_n68_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~x04 & (new_n79_ | (~new_n75_ & ~x24))) | (x24 & (new_n70_ | new_n79_));
  ...
  assign z4 = new_n84_ | new_n85_ | (new_n91_ & ~x04);
  assign new_n84_ = z5 & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  assign new_n85_ = x24 & ((~new_n86_ & (x05 | x13)) | (~x05 & ~new_n89_ & ~x13));
  assign new_n86_ = (~x18 | (x08 & (new_n87_ | ~x16))) & (~new_n88_ | ~new_n51_ | x16);
  assign new_n87_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n88_ = x04 & x07;
  assign new_n89_ = ~new_n90_ & (~x04 | x16 | ~new_n51_ | ~x19);
  assign new_n90_ = x15 & (~x08 | (x16 & (~x09 | (~x17 & x22))));
  assign new_n91_ = ~new_n92_ & (new_n68_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
