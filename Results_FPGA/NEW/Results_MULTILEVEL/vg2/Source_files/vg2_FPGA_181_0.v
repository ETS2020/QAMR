...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x02 | x09)) | (x00 & ~x02 & x09 & ~x10 & ~x24);
  ...
  assign z7 = (~new_n62_ & (x02 | x09)) | (~x02 & x09 & ~x10 & x21 & ~x24);
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (x09 & (new_n64_ | new_n69_ | new_n74_)) | (x02 & (new_n69_ | new_n78_));
  ...
  assign z4 = new_n80_ | (~new_n86_ & x02);
  assign new_n80_ = x09 & ((~new_n81_ & (x08 | ~x16)) | (~new_n83_ & (~x08 | (new_n85_ & x16))));
  ...
  assign new_n85_ = x22 & (~x17 | (~x04 & x23));
  assign new_n86_ = (new_n38_ | (~x08 & (~new_n87_ | x16))) & (new_n62_ | (x08 & (x09 | ~x16)));
