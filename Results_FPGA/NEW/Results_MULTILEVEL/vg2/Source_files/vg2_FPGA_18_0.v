...
module FAU ( 
  ...
  assign new_n50_ = ~x11 & ~x14 & ~x20 & ~new_n51_ & x22;
  ...
  assign new_n55_ = ~x08 & ~x11 & ~x14 & ~x20 & x22;
  assign new_n56_ = (~new_n57_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n58_ | x01 | x03 | x06 | x08);
  assign new_n57_ = x11 & x14 & x15 & x20;
  assign new_n58_ = ~x11 & ~x14 & x19 & ~x20 & x22;
  assign z4 = (~new_n42_ & ~new_n62_) | (~new_n37_ & ~new_n60_);
  assign new_n60_ = ((~x14 & ~x22) | (~x08 & (~x09 | x16))) & (~x14 | x16 | new_n61_ | x22);
  assign new_n61_ = ~x17 & (~x04 | x23);
  assign new_n62_ = (~x16 | new_n63_ | ~x22) & ((~x14 & ~x22) | (x08 & (x09 | ~x16)));
  assign new_n63_ = x17 & (x04 | ~x23);
  assign z5 = ~new_n37_ & (x14 | x22);
  assign z6 = ~new_n67_ | (~new_n66_ & (x14 | x22));
  assign new_n66_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n42_ | (x03 & (x06 | ~x11)));
  assign new_n67_ = (x24 | (~new_n68_ & (~x05 | new_n70_ | ~x13))) & (~x24 | new_n71_ | (~x05 & ~x13)) & (x05 | new_n70_ | x13);
  assign new_n68_ = ~x02 & ~new_n69_ & ~x10;
  assign new_n69_ = (x20 | ~x21 | ~x11 | ~x14) & (~x00 | x11 | x14 | ~x20 | ~x22);
  assign new_n70_ = (~x11 | ~x14 | ~x15 | x20) & (x11 | x14 | ~x19 | ~x20 | ~x22);
  assign new_n71_ = (~x11 | ~x14 | ~x18 | x20) & (~x07 | x11 | x14 | ~x20 | ~x22);
  assign z7 = ~new_n42_ & (x14 | x22);
endmodule
