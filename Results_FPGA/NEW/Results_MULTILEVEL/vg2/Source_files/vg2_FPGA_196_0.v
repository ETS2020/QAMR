// Benchmark "FAU" written by ABC on Sat Aug  8 22:08:04 2020
...
module FAU ( 
  ...
  assign z4 = (~new_n69_ & (new_n73_ | x08)) | new_n72_ | (z7 & (new_n74_ | ~x08));
  assign new_n69_ = (new_n70_ | (~x14 & ~x21)) & (~new_n39_ | x10 | ~x14 | x24);
  assign new_n70_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign z7 = new_n60_ | (~new_n56_ & (x14 | x21));
  ...
  assign z6 = ~new_n77_ | (~new_n69_ & (x03 | (x06 & ~x11)));
  assign new_n77_ = (~x24 | new_n78_ | (~x05 & ~x13)) & ~new_n82_ & (new_n81_ | (x05 ? (~x13 | x24) : x13));
  assign new_n78_ = (new_n79_ | ~x18) & (~x07 | x11 | ~new_n80_ | x14);
  assign new_n79_ = (~x11 | ~x14 | x20) & ((~x14 & ~x21) | (x03 & (x06 | ~x11)));
  assign new_n80_ = x20 & x21;
  assign new_n81_ = (new_n79_ | ~x15) & (x11 | x14 | ~new_n80_ | ~x19);
  assign new_n82_ = ~x02 & ~x10 & x21 & ~new_n83_ & ~x24;
  assign new_n83_ = (~x11 | (x06 & (~x14 | x20))) & ~x00 & x03;
endmodule
