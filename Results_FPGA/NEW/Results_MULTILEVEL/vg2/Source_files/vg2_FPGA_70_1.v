...
module FAU ( 
  ...
  assign new_n63_ = new_n64_ & ~x01 & ~x03 & ~x06 & x07;
  ...
  assign new_n70_ = new_n65_ & x20 & x21 & x11 & x14;
  assign new_n71_ = ~new_n66_ & (~x05 ^ x13);
  assign z4 = (~new_n80_ & x22) | ((~new_n73_ | new_n78_) & ~x24);
  assign new_n73_ = (x05 | x13 | (~new_n77_ & (new_n75_ | ~x19))) & (new_n75_ | (~new_n74_ & (~x05 | ~x13 | ~x19)));
  assign new_n74_ = new_n58_ & x00;
  assign new_n75_ = ~new_n76_ & ~x08;
  assign new_n76_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n77_ = x15 & (~x08 | (~x09 & x16));
  ...
  assign new_n81_ = (~x07 | ~x24 | (~x05 & ~x13)) & (x05 | x13 | ~x19);
