// Benchmark "FAU" written by ABC on Sat Aug  8 22:08:21 2020
...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (~x02 | ~x21)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z1 = (~x02 & (new_n40_ | new_n50_ | new_n57_)) | (~x21 & (new_n40_ | new_n50_));
  ...
  assign z7 = (~new_n65_ & (~x02 | ~x21)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~x02 & (new_n67_ | new_n72_ | (new_n76_ & ~x10))) | (~x21 & (new_n67_ | new_n72_));
