...
module FAU ( 
  ...
  assign z5 = (~x06 & ~x10 & ~x24 & x00 & ~x02) | (~new_n74_ & (x02 | ~x06));
  assign new_n74_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n61_ & (x02 | ~x06)) | (~x02 & ~x06 & ~x10 & x21 & ~x24);
  assign new_n76_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n77_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n82_ & x02) | (~new_n79_ & ~x06);
  assign new_n79_ = (new_n37_ | (~x03 & (x11 | x14 | ~x20))) & (new_n80_ | (x03 & ~x11));
  assign new_n80_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n81_ & (x05 | x13 | ~x15);
  assign new_n81_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n82_ = (new_n74_ | (~x03 & (~x06 | x11))) & (new_n61_ | (x03 & (~new_n83_ | ~x11)));
