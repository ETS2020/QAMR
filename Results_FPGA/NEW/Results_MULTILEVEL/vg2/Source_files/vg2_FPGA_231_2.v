...
module FAU ( 
  ...
  assign z4 = (~new_n79_ & ~new_n86_) | (~new_n84_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n79_ = (new_n37_ | ~x08) & (~new_n80_ | x16) & (new_n82_ | (~new_n83_ & x08));
  assign new_n80_ = ~new_n81_ & (new_n38_ | (x07 & x24 & (x05 | x13)));
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = ~new_n66_ & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n84_ = x15 ? ~new_n85_ : (x16 | new_n81_ | ~x19);
  assign new_n85_ = x20 & (new_n83_ | ~x08);
  assign new_n86_ = x15 & ~x20;
  assign z5 = ~new_n37_ & ~new_n86_;
  assign z6 = ~new_n89_ | (x24 & (x05 | x13) & (new_n95_ | ~new_n96_));
  assign new_n89_ = ~new_n90_ & (x02 | x10 | x24 | (~new_n93_ & new_n94_));
  assign new_n90_ = (x05 ? (x13 & ~x24) : ~x13) & (new_n92_ | (~new_n91_ & x19));
  assign new_n91_ = (~x03 | (x15 & ~x20)) & (x11 | ((~x06 | x15) & (x14 | ~x20)));
  assign new_n92_ = x15 & x20 & (~x03 | (~x06 & x11));
  assign new_n93_ = ~new_n86_ & ((x00 & (x03 | (x06 & ~x11))) | (x21 & (~x03 | (~x06 & x11))));
  assign new_n94_ = (~x00 | x11 | x14 | ~x20) & (~x11 | ~x14 | x15 | x20 | ~x21);
  assign new_n95_ = ~new_n86_ & ((x07 & (x03 | (x06 & ~x11))) | (x18 & (~x03 | (~x06 & x11))));
  assign new_n96_ = (~x07 | x11 | x14 | ~x20) & (~x11 | ~x14 | x15 | ~x18 | x20);
  assign z7 = (~new_n82_ & (~x15 | x20)) | (x15 & x20 & (x05 ? (x13 & ~x24) : ~x13));
endmodule
