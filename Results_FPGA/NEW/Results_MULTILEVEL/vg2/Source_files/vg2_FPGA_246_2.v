// Benchmark "FAU" written by ABC on Sat Aug  8 22:08:26 2020
...
module FAU ( 
  ...
  assign new_n57_ = ~new_n58_ & (~new_n53_ | ~new_n61_ | ~new_n56_ | ~x17 | ~x20);
  ...
  assign new_n63_ = x11 & x14 & z7 & x20;
  assign z7 = ~new_n65_ & (~x04 | x09);
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n66_ & (x05 | x13 | ~x15);
  assign new_n66_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = ~new_n68_ & (~x04 | x09);
  assign new_n68_ = (new_n69_ | x24) & (~x24 | new_n72_ | (~x05 & ~x13)) & (x05 | new_n76_ | x13);
  assign new_n69_ = x01 ? (~x03 | ~x06 | ~new_n70_ | ~x08) : (x03 | x06 | ~new_n71_ | x08);
  assign new_n70_ = x11 & x14 & ~new_n44_ & x20;
  assign new_n71_ = ~x11 & ~x14 & ~new_n47_ & ~x20;
  ...
  assign z4 = new_n80_ | (~new_n38_ & ~new_n82_);
  assign new_n80_ = ~new_n65_ & (new_n81_ | (~x08 & (~x04 | x09)));
  assign new_n81_ = x16 & ((~x04 & (~x09 | (x22 & x23))) | (x09 & ~x17 & x22));
  assign new_n82_ = (x04 | (~x08 & (x16 | ~x17 | x22))) & (~x09 | (~x08 & x16));
  assign z6 = (new_n84_ | new_n85_) & (~x04 | x09);
  assign new_n84_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n85_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
