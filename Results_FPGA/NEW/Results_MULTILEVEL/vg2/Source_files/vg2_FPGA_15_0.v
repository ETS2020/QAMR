...
module FAU ( 
  ...
  assign new_n50_ = ~x11 & ~x14 & x17 & ~new_n51_ & ~x20;
  ...
  assign new_n55_ = ~x08 & ~x11 & ~x14 & x17 & ~x20;
  assign new_n56_ = (~new_n57_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n58_ | x01 | x03 | x06 | x08);
  assign new_n57_ = x11 & x14 & x15 & x20;
  assign new_n58_ = ~x11 & ~x14 & x17 & x19 & ~x20;
  assign z4 = (~new_n42_ & ~new_n62_) | (~new_n37_ & ~new_n60_);
  assign new_n60_ = ((~x03 & ~x17) | (~x08 & (~x09 | x16))) & (~new_n61_ | x16);
  assign new_n61_ = ~x22 & (x17 | (x03 & x04 & ~x23));
  assign new_n62_ = (~new_n63_ | ~x16) & ((~x03 & ~x17) | (x08 & (x09 | ~x16)));
  assign new_n63_ = x22 & ((x03 & ~x17) | (~x04 & x17 & x23));
  assign z5 = ~new_n37_ & (x03 | x17);
  assign z6 = (~new_n37_ & (new_n66_ | x03)) | (~new_n42_ & (x03 ? new_n67_ : x17));
  assign new_n66_ = ~x11 & x17 & (x06 | (~x14 & x20));
  assign new_n67_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n42_ & (x03 | (~x03 & x17));
endmodule
