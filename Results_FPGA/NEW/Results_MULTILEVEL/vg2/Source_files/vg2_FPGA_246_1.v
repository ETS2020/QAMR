...
module FAU ( 
  ...
  assign new_n57_ = ~new_n58_ & (~new_n60_ | ~new_n61_ | ~new_n56_ | ~x19 | x20);
  assign new_n58_ = new_n50_ & new_n59_ & x15 & x16 & x12 & x14;
  assign new_n59_ = x22 & x23 & x17 & x20;
  assign new_n60_ = new_n54_ & ~x09 & ~x11 & ~x06 & ~x08;
  ...
  assign z4 = new_n80_ | (~new_n65_ & ~new_n82_);
  assign new_n80_ = ~new_n38_ & (new_n81_ | (x08 & (x04 | ~x09)));
