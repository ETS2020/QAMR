// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:30 2020
...
module FAU ( 
  ...
  assign z1 = ~new_n38_ & ((~new_n41_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n50_ & (x05 | x13)));
  ...
  assign new_n50_ = (~new_n42_ | ~new_n51_) & (~new_n46_ | ~new_n53_ | ~new_n54_ | ~new_n55_);
  ...
  assign z7 = ~new_n38_ & ~new_n59_;
  assign new_n59_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = ~new_n38_ & ((~new_n65_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n61_ & (x05 | x13)));
  ...
  assign z4 = ~new_n38_ & ((~new_n39_ & (new_n69_ | x08)) | (~new_n59_ & (new_n70_ | ~x08)));
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n70_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = ~new_n38_ & (new_n72_ | new_n73_);
  assign new_n72_ = ~new_n39_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n73_ = ~new_n59_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
