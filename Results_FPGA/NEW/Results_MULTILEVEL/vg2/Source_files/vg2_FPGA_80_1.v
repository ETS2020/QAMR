...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (x08 | (new_n77_ & ~x14))) | (~new_n63_ & (x08 ? new_n78_ : ~x14));
  ...
  assign new_n84_ = (x14 | ~x20 | ~x00 | x11) & (~x08 | ~x11 | ~x14 | x20 | ~x21);
  assign new_n85_ = (~x19 | ~x20 | x11 | x14) & (~x08 | ~x11 | ~x14 | ~x15 | x20);
  assign new_n86_ = (~x07 | x11 | x14 | ~x20) & (~x14 | ~x18 | x20 | ~x08 | ~x11);
