...
module FAU ( 
  ...
  assign new_n65_ = ~new_n66_ & (~new_n68_ | x01 | x03 | x06 | x08);
  ...
  assign z5 = (~x10 & ~x11 & ~x24 & x00 & ~x02) | (~new_n76_ & (x02 | ~x11));
  assign new_n76_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n63_ & (x02 | ~x11)) | (~x02 & ~x10 & ~x11 & x21 & ~x24);
  assign new_n78_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n79_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n81_ & ~x11) | (x02 & (new_n86_ | new_n88_));
  assign new_n81_ = new_n82_ & (new_n60_ | new_n85_);
  assign new_n82_ = (~x24 | new_n59_ | new_n83_) & (x02 | x10 | new_n84_ | x24);
  assign new_n83_ = (x03 | ~x18) & (~x07 | (~x03 & ~x06 & (x14 | ~x20)));
  assign new_n84_ = (~x00 | (~x03 & ~x06 & (x14 | ~x20))) & (x03 | ~x21);
  assign new_n85_ = (~x19 | (~x03 & ~x06 & (x14 | ~x20))) & (x03 | ~x15);
  assign new_n86_ = x24 & ~new_n59_ & ((x03 & x07) | (~new_n87_ & x18));
  assign new_n87_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n88_ = ~new_n60_ & ((x03 & x19) | (~new_n87_ & x15));
endmodule
