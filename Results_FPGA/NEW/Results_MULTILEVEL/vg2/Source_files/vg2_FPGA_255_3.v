// Benchmark "FAU" written by ABC on Sat Aug  8 22:08:30 2020
...
module FAU ( 
  ...
  assign new_n43_ = x06 & x11 & x14 & ~x16 & ~new_n44_ & x20;
  ...
  assign new_n48_ = x11 & x14 & ~x16 & ~new_n49_ & x20;
  ...
  assign new_n54_ = x11 & x14 & ~x16 & x18 & x20;
  assign new_n55_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n56_ = (~new_n57_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n58_ | x01 | x03 | x06 | x08);
  assign new_n57_ = x11 & x14 & x15 & ~x16 & x20;
  assign new_n58_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n62_ & (~x06 | ~x16)) | (new_n60_ & ~x16) | (~x06 & new_n61_ & x16);
  assign new_n60_ = ~new_n37_ & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n61_ = ~new_n44_ & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n62_ = (x24 | (~new_n63_ & (~x05 | new_n64_ | ~x13))) & (~x24 | new_n65_ | (~x05 & ~x13)) & (x05 | new_n64_ | x13);
  assign new_n63_ = ~x02 & ~x10 & (x08 ? x00 : x21);
  assign new_n64_ = x08 ? ~x19 : ~x15;
  assign new_n65_ = x08 ? ~x07 : ~x18;
  assign z5 = ~new_n37_ & (~x06 | ~x16);
  assign z6 = (~new_n70_ & (~x06 | ~x16)) | (new_n68_ & ~x11) | (new_n69_ & x11);
  assign new_n68_ = ~new_n37_ & (x06 ? ~x16 : (~x14 & x20));
  assign new_n69_ = ~new_n44_ & (~x06 | (x14 & ~x16 & ~x20));
  assign new_n70_ = (x24 | (~new_n71_ & (~x05 | new_n72_ | ~x13))) & (~x24 | new_n73_ | (~x05 & ~x13)) & (x05 | new_n72_ | x13);
  assign new_n71_ = ~x02 & ~x10 & (x03 ? x00 : x21);
  assign new_n72_ = x03 ? ~x19 : ~x15;
  assign new_n73_ = x03 ? ~x07 : ~x18;
  assign z7 = ~new_n44_ & (~x06 | ~x16);
endmodule
