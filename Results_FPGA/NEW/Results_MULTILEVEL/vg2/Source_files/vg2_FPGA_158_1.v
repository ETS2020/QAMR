...
module FAU ( 
  ...
  assign z6 = ~new_n82_ | (~new_n83_ & (x11 | ~x14));
  assign new_n82_ = x11 ? (new_n63_ | (x06 & (~x14 | x20))) : (x14 | new_n37_ | (~x06 & ~x20));
  assign new_n83_ = (x24 | (~new_n84_ & (~x05 | new_n85_ | ~x13))) & (~x24 | new_n86_ | (~x05 & ~x13)) & (x05 | new_n85_ | x13);
  assign new_n84_ = ~x02 & ~x10 & (x03 ? x00 : x21);
  assign new_n85_ = x03 ? ~x19 : ~x15;
  assign new_n86_ = x03 ? ~x07 : ~x18;
