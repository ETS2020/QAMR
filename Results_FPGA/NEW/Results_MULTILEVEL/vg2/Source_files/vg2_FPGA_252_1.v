...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n50_ | new_n57_;
  ...
  assign new_n50_ = x24 & ~new_n56_ & (new_n53_ | (new_n41_ & new_n51_));
  ...
  assign z4 = new_n81_ | new_n82_ | ~new_n86_;
  assign new_n81_ = z7 & (~x08 | (x16 & (~x09 | (~x17 & x22))));
  assign new_n82_ = (x05 ? (x13 & ~x24) : ~x13) & (new_n85_ | (~new_n83_ & x19));
  assign new_n83_ = (x22 | x23 | ~x04 | x16) & (new_n84_ | (~x02 & x23));
  assign new_n84_ = ~x08 & (x16 | (~x09 & (~x17 | x22)));
  assign new_n85_ = x02 & ~x04 & x15 & x16 & x22 & x23;
  assign new_n86_ = ~new_n87_ & (~x24 | new_n56_ | (~new_n89_ & (new_n83_ | ~x07)));
  assign new_n87_ = x00 & ~x02 & ~x10 & ~x23 & ~new_n88_ & ~x24;
  assign new_n88_ = ~x08 & (x16 | (~x09 & (x22 | (~x04 & ~x17))));
  assign new_n89_ = x02 & ~x04 & x16 & x18 & x22 & x23;
