...
module FAU ( 
  ...
  assign z7 = new_n48_ | (x21 & (new_n47_ | (~x02 & ~x10 & ~x24)));
  ...
  assign new_n53_ = x05 ? ~new_n54_ : (new_n55_ & (x13 | ~x19));
  assign new_n54_ = x21 & ((x13 & x19 & ~x24) | (x07 & x24));
  assign new_n55_ = (~x07 | ~x13 | ~x24) & (x10 | x24 | ~x00 | x02);
