// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:26 2020
...
module FAU ( 
  ...
  assign z7 = (~new_n44_ & (x19 | x21)) | (~x02 & ~x10 & x21 & ~x24);
  assign z3 = new_n61_ | new_n66_ | (~x01 & new_n65_ & ~x03);
  ...
  assign new_n66_ = new_n67_ & x01 & ~x02 & x03 & x06 & x08;
  assign new_n67_ = ~x10 & x11 & x14 & x20 & x21 & ~x24;
  assign z4 = (~new_n69_ & (x08 | (~new_n83_ & ~x16))) | ~new_n78_ | (new_n73_ & x16);
  assign new_n69_ = new_n70_ & ~new_n72_;
  assign new_n70_ = (~x07 | ~x24 | (~x19 & (~x13 | ~x21))) & (new_n71_ | ~x19);
  assign new_n71_ = (x05 | x13) & (~x00 | x02 | x10 | x24);
  assign new_n72_ = x05 & ((x07 & x21 & x24) | (x13 & x19 & ~x24));
  assign new_n73_ = ~new_n76_ & (new_n77_ | (~new_n74_ & x21));
  assign new_n74_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n75_ & (x05 | x13 | ~x15);
  assign new_n75_ = ~x02 & ~x10 & ~x24;
  assign new_n76_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n77_ = x08 & x18 & x19 & x24;
  assign new_n78_ = (~x21 | (~new_n79_ & (new_n81_ | x08))) & (new_n82_ | ~x19);
  assign new_n79_ = ~x24 & (new_n80_ | (~x02 & ~x10 & (x00 | ~x08)));
  assign new_n80_ = x05 & ~x08 & x13 & x15;
  assign new_n81_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n82_ = (~x05 | ((~x13 | ~x15 | x24) & (x08 | ~x18 | ~x24))) & (x05 | x13 | ~x15) & (x08 | ~x13 | ~x18 | ~x24);
  assign new_n83_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z6 = (~new_n69_ & (x03 | (~new_n91_ & ~x11))) | ~new_n87_ | (new_n85_ & x11);
  assign new_n85_ = ~new_n86_ & (~x06 | (x14 & ~x20));
  assign new_n86_ = (new_n74_ | ~x21) & (~x03 | ~x18 | ~x19 | ~x24);
  assign new_n87_ = (~x21 | (~new_n88_ & (new_n81_ | x03))) & (new_n90_ | ~x19);
  assign new_n88_ = ~x24 & (new_n89_ | (~x02 & ~x10 & (x00 | ~x03)));
  assign new_n89_ = x13 & x15 & ~x03 & x05;
  assign new_n90_ = (x03 | ~x18 | ~x24 | (~x05 & ~x13)) & (~x15 | (x05 ? (~x13 | x24) : x13));
