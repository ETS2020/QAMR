...
module FAU ( 
  ...
  assign z1 = new_n40_ | (new_n51_ & x24) | (~x02 & ~x10 & ~new_n58_ & ~x24);
  ...
  assign new_n51_ = ~new_n57_ & ((new_n41_ & new_n52_) | (new_n54_ & new_n55_));
  assign new_n52_ = new_n53_ & x22 & x23 & x18 & x20;
  assign new_n53_ = x12 & x14 & x16 & x17;
  assign new_n54_ = new_n46_ & ~x06 & x07 & ~x08 & ~x09;
  assign new_n55_ = new_n56_ & ~x11 & ~x12 & ~x14 & ~x16;
  assign new_n56_ = ~x17 & ~x20 & ~x22 & ~x23;
  assign new_n57_ = ~x05 & ~x13;
  assign new_n58_ = ~new_n59_ & (~new_n55_ | ~new_n61_ | ~x00 | x01 | x03);
  assign new_n59_ = new_n53_ & new_n60_ & new_n42_ & x01 & x03 & x04;
  ...
  assign z3 = (~x02 & (new_n67_ | new_n72_ | (new_n76_ & ~x10))) | (~x16 & (new_n67_ | new_n72_));
  assign new_n67_ = ~new_n50_ & (new_n68_ | (new_n70_ & new_n71_ & x15 & x20));
  assign new_n68_ = new_n69_ & ~x01 & ~x03 & ~x06 & ~x08;
  assign new_n69_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n70_ = x01 & x03 & x06 & x08;
  assign new_n71_ = x11 & x14;
  assign new_n72_ = x24 & ~new_n57_ & ((new_n74_ & new_n75_) | (new_n73_ & new_n70_));
  assign new_n73_ = new_n71_ & x18 & x20;
  ...
  assign z4 = (~x16 & (~new_n79_ | new_n86_)) | (~x02 & (~new_n83_ | new_n87_));
  assign new_n79_ = (~new_n80_ | ~x24) & (~x00 | x02 | x10 | new_n82_ | x24);
  assign new_n80_ = ~new_n57_ & ((~new_n81_ & x07) | (~x08 & x18));
  assign new_n81_ = ~x08 & ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n83_ = ~new_n84_ & (new_n50_ | ((~x15 | (~new_n85_ & x08)) & (~x08 | ~x19)));
  assign new_n84_ = ~x10 & ~x24 & ((x00 & x08) | (x21 & (new_n85_ | ~x08)));
  assign new_n85_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n86_ = ~new_n50_ & ((~x08 & x15) | (~new_n81_ & x19));
  assign new_n87_ = x24 & ~new_n57_ & ((x07 & x08) | (x18 & (new_n85_ | ~x08)));
