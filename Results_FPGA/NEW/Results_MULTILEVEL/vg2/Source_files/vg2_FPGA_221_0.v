...
module FAU ( 
  ...
  assign z1 = (x21 & (new_n49_ | (~new_n42_ & ~x24))) | (x24 & (new_n49_ | new_n58_));
  ...
  assign new_n61_ = new_n62_ & new_n57_ & ~x08 & ~x09 & ~x06 & x07;
  assign new_n62_ = new_n63_ & ~x14 & ~x16 & ~x11 & ~x12;
  assign new_n63_ = ~x17 & ~x20 & ~x22 & ~x23;
  assign z2 = new_n65_ & x01;
  assign new_n65_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n67_ & x05) | ~new_n69_ | (new_n68_ & ~x05);
  assign new_n67_ = (~x18 | ~x24) & (~x21 | x24 | ~x13 | ~x15);
  assign new_n68_ = ~x13 & x15 & (x21 | x24);
  assign new_n69_ = (~x13 | ~x18 | ~x24) & (~x21 | x24 | x02 | x10);
  assign z3 = (x21 & (new_n79_ | (~new_n76_ & ~x24))) | (x24 & (new_n71_ | new_n79_));
  ...
  assign new_n76_ = x01 ? (~x03 | ~x06 | ~new_n77_ | ~x08) : (x03 | x06 | ~new_n78_ | x08);
  assign new_n77_ = x11 & x14 & ~new_n45_ & x20;
  assign new_n78_ = ~x11 & ~x14 & ~new_n48_ & ~x20;
  ...
  assign z4 = new_n40_ | (~new_n84_ & (new_n86_ | x08)) | (z7 & (new_n85_ | ~x08));
  assign new_n84_ = ~new_n38_ & ~new_n39_ & (~x07 | ~x13 | ~x24);
  assign new_n85_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n86_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = new_n40_ | (~new_n84_ & (new_n89_ | x03)) | (z7 & (new_n88_ | ~x03));
