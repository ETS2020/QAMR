...
module FAU ( 
  ...
  assign new_n78_ = (new_n79_ | (~x01 & x21)) & (~x00 | ~new_n83_ | x02);
  ...
  assign z7 = (~new_n85_ & (x01 | ~x21)) | (x01 & ~x02 & ~x10 & x21 & ~x24);
  ...
  assign z6 = new_n89_ | new_n92_ | (~new_n90_ & (x01 | ~x21));
  assign new_n89_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = ~new_n91_ & (~x00 | x02 | ~x03 | x10 | x24);
