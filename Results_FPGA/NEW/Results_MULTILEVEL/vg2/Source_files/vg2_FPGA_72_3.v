...
module FAU ( 
  ...
  assign new_n42_ = x01 ? (~x03 | ~x04 | ~new_n46_ | ~x06) : (x03 | x04 | ~new_n43_ | x06);
  ...
  assign new_n56_ = ~x04 & ((x13 & x18 & x24) | (~x05 & ~x13 & x15));
