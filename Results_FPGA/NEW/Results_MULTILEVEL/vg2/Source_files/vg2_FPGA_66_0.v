// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:06 2020
...
module FAU ( 
  ...
  assign z7 = (~new_n46_ & x05) | (x21 & (~new_n47_ | (~x05 & ~x13 & x15)));
  ...
  assign z4 = (~new_n52_ & (new_n55_ | x08)) | new_n57_ | (z7 & (new_n56_ | ~x08));
  assign new_n52_ = new_n53_ & (~x07 | ~x24 | (~x05 & (~x13 | ~x21)));
  assign new_n53_ = (~x19 | ~x21 | x05 | x13) & (~x05 | x24 | (~new_n54_ & (~x13 | ~x19)));
  assign new_n54_ = x00 & ~x02 & ~x10;
  assign new_n55_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n56_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n57_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z6 = (~new_n52_ & (new_n59_ | x03)) | new_n57_ | (z7 & (new_n60_ | ~x03));
