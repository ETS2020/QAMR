...
module FAU ( 
  ...
  wire new_n36_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_, new_n44_,
    new_n45_, new_n47_, new_n48_, new_n50_, new_n53_, new_n54_, new_n55_,
  ...
  assign new_n43_ = ~x16 & ~x17 & ~x20 & ~x22 & z5 & ~x23;
  ...
  assign z4 = new_n58_ | (~new_n53_ & (new_n57_ | x08)) | (z7 & (new_n56_ | ~x08));
  assign new_n53_ = ~new_n54_ & (x05 | ((x13 | ~x19) & (~x07 | ~x13 | ~x24)));
  assign new_n54_ = ~x21 & (new_n55_ | (~x10 & ~x24 & x00 & ~x02));
  assign new_n55_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n56_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n57_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n58_ = x00 & ~x02 & ~x05 & x08 & ~x10 & ~x24;
  assign z6 = new_n62_ | (~new_n53_ & (new_n61_ | x03)) | (z7 & (new_n60_ | ~x03));
  assign new_n60_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n61_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n62_ = x00 & ~x02 & x03 & ~x05 & ~x10 & ~x24;
endmodule
