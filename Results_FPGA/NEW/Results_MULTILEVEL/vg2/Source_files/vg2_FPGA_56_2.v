...
module FAU ( 
  ...
  assign z3 = (~new_n68_ & (~x21 | x23)) | (new_n78_ & new_n79_ & x21 & x23 & ~x24);
  ...
  assign z4 = new_n81_ | (x23 & (new_n84_ | new_n89_ | (~new_n86_ & ~new_n88_)));
  assign new_n81_ = ~x21 & ((~new_n38_ & (new_n82_ | x08)) | (~new_n66_ & (new_n83_ | ~x08)));
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n83_ = x16 & (~x09 | (~x17 & x22));
  assign new_n84_ = ~new_n85_ & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  ...
  assign new_n89_ = x00 & ~x02 & x08 & ~x10 & ~x24;
  assign z6 = new_n91_ | new_n94_ | (~new_n92_ & (~x21 | x23));
