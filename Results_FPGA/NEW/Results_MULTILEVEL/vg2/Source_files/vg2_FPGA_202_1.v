// Benchmark "FAU" written by ABC on Sat Aug  8 22:08:07 2020
...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x00 | ~x21)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z1 = new_n64_ | (x00 & (~new_n47_ | (~new_n40_ & ~x24)));
  ...
  assign z7 = new_n69_ | (~new_n68_ & (x00 | ~x21));
  assign new_n68_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n69_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (x00 & (new_n76_ | new_n71_ | new_n79_)) | (~x21 & (new_n71_ | new_n83_));
  assign new_n71_ = x24 & ~new_n72_ & (x05 | x13);
  assign new_n72_ = ~new_n73_ & (~new_n75_ | ~new_n55_ | x01 | x03);
  ...
  assign new_n77_ = x08 & x11 & x14 & ~new_n43_ & x20;
  assign new_n78_ = ~x08 & ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign new_n79_ = ~x05 & ~new_n80_ & ~x13;
  assign new_n80_ = (~new_n81_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n82_ | x06 | x08 | x01 | x03);
  assign new_n81_ = x11 & x14 & x15 & x20;
  assign new_n82_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n83_ = ~new_n80_ & (x05 ? (x13 & ~x24) : ~x13);
  assign z4 = ~new_n85_ | (z5 & (new_n87_ | x08));
  assign new_n85_ = ~new_n69_ & ((~x00 & x21) | new_n68_ | (~new_n86_ & x08));
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n87_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = new_n89_ | new_n69_ | (new_n90_ & (x00 | ~x21));
  assign new_n89_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = ~new_n68_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
