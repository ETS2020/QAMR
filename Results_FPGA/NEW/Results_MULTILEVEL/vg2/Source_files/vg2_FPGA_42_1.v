...
module FAU ( 
  ...
  assign z4 = (~new_n38_ & (x08 | (new_n79_ & ~x12))) | (~new_n65_ & (x08 ? new_n80_ : ~x12));
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (x08 | ~x12) & (new_n82_ | new_n83_);
