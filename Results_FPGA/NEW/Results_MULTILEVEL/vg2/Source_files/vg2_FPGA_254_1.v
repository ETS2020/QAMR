...
module FAU ( 
  ...
  assign z1 = ~new_n48_ | (~new_n60_ & (new_n40_ | new_n44_));
  ...
  assign z7 = (~new_n64_ & (x02 | ~x08)) | (~x02 & ~x08 & ~x10 & x21 & ~x24);
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n66_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n73_ | (x24 & ~new_n70_ & (x05 | x13));
  assign new_n66_ = ~new_n67_ & (~new_n69_ | x06 | x08 | x01 | x03);
  assign new_n67_ = new_n68_ & x08 & x11 & x14 & x15 & x20;
  assign new_n68_ = x03 & x06 & x01 & x02;
  assign new_n69_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n70_ = ~new_n71_ & (~new_n72_ | x01 | x03 | x06 | ~x07);
  assign new_n71_ = new_n68_ & x08 & x11 & x14 & x18 & x20;
  assign new_n72_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n73_ = new_n74_ & x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n74_ = ~x14 & ~x20 & ~x24 & ~x08 & ~x10 & ~x11;
  assign z4 = (~new_n76_ & ~x08) | (x02 & (new_n83_ | (new_n81_ & x24)));
  assign new_n76_ = ~new_n77_ & ~new_n79_ & (new_n60_ | (~x15 & (~new_n80_ | x16)));
  assign new_n77_ = x24 & ~new_n59_ & (x18 | (new_n78_ & x07));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = ~x02 & ~x10 & ~x24 & (x21 | (new_n78_ & x00));
  assign new_n80_ = x19 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n81_ = ~new_n59_ & ((x07 & x08) | (x16 & ~new_n82_ & x18));
  assign new_n82_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n83_ = ~new_n60_ & ((x15 & ~new_n82_ & x16) | (x08 & x19));
