...
module FAU ( 
  ...
  assign z4 = new_n58_ | (~new_n52_ & (new_n57_ | x08)) | (z7 & (new_n56_ | ~x08));
  assign new_n52_ = ~new_n55_ & ~new_n53_ & (~x07 | ~x13 | ~x24);
  assign new_n53_ = ~x21 & (new_n54_ | (~x05 & ~x13 & x19));
  assign new_n54_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n55_ = x05 & ((x07 & ~x21 & x24) | (x13 & x19 & ~x24));
  assign new_n56_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n57_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n58_ = x00 & ~x02 & x08 & ~x10 & x13 & ~x24;
  assign z6 = new_n62_ | (~new_n52_ & (new_n61_ | x03)) | (z7 & (new_n60_ | ~x03));
