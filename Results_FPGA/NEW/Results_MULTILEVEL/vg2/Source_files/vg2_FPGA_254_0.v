...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x02 | x08)) | (x00 & ~x02 & x08 & ~x10 & ~x24);
  ...
  assign z3 = new_n71_ | (x24 & ~new_n69_ & (x05 | x13)) | (~new_n65_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n65_ = ~new_n66_ & (~new_n68_ | ~x11 | ~x14 | ~x15 | ~x20);
  assign new_n66_ = new_n67_ & ~x08 & ~x11 & ~x14 & x19 & ~x20;
  assign new_n67_ = ~x03 & ~x06 & ~x01 & x02;
  ...
  assign z4 = new_n79_ | (~new_n74_ & x08);
  assign new_n74_ = (~new_n75_ | ~x24) & ~new_n77_ & (x02 | x10 | new_n78_ | x24);
  assign new_n75_ = (x05 | x13) & (x07 | (x16 & ~new_n76_ & x18));
  assign new_n76_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n77_ = ~new_n50_ & (x19 | (x15 & ~new_n76_ & x16));
  assign new_n78_ = ~x00 & (~x16 | new_n76_ | ~x21);
  assign new_n79_ = x02 & ((x24 & ~new_n82_ & (x05 | x13)) | (~new_n80_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n80_ = (x08 | ~x15) & (x16 | new_n81_ | ~x19);
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = (~x07 | new_n81_ | x16) & (x08 | ~x18);
