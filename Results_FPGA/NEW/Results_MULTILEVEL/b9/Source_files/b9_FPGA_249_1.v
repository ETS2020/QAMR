...
module FAU ( 
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (x20 & ~x39))) | (x05 & x20 & x39 & x40));
  assign new_n84_ = x06 & ~new_n67_ & x37;
  assign new_n85_ = x05 & x20 & x39 & x40 & (x30 | x32);
  ...
  assign z12 = (x20 & (new_n91_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = x20 & ((new_n96_ & ~x04) | (x27 & (new_n93_ | (new_n95_ & ~x04))));
  ...
  assign z14 = new_n98_ | (~new_n101_ & x20) | (~x40 & (new_n94_ | ~x20 | ~x27));
  assign new_n98_ = (x18 | x19) & (~x40 | (x20 & (new_n99_ | ~new_n100_)));
