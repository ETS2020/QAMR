// Benchmark "FAU" written by ABC on Wed Aug  5 21:58:27 2020
...
module FAU ( 
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (~x14 & ~x39))) | (x05 & ~x14 & x39 & x40));
  assign new_n84_ = x06 & ~new_n67_ & x37;
  assign new_n85_ = ~x14 & x39 & x40 & (x30 | x32);
  ...
  assign z12 = (~x14 & (new_n91_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x27) | (~x04 & new_n85_ & ~x13);
  assign new_n93_ = (x14 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  ...
  assign new_n101_ = (new_n68_ | x40) & (x14 | (~new_n102_ & (new_n68_ | new_n100_)));
  ...
  assign z18 = (~new_n107_ & (~x14 | ~x40)) | (x08 & ~x14 & x29 & x39 & x40);
