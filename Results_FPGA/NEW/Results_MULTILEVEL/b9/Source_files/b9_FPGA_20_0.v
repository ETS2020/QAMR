...
module FAU ( 
  ...
  assign new_n65_ = ~x30 & ~x39;
  assign new_n66_ = x27 & (x37 | (x28 & x35));
  assign new_n67_ = x39 & x40 & (x10 | (x27 & (x35 | x36)));
  assign z01 = (~x04 & (x30 | x39)) | (~x30 & ~x32 & x39 & (new_n69_ | ~x27));
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = x39 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x30;
  ...
  assign new_n83_ = (~x07 | (x39 ? x40 : ~x30)) & (~x05 | ~x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & x39 & (new_n86_ | (~new_n87_ & ~x08));
  assign new_n86_ = (~x29 | ~x40) & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = (x39 & (new_n89_ | (~new_n66_ & (x04 | ~x40)))) | (x30 & ~new_n66_ & ~x39);
  ...
  assign new_n97_ = x39 ? (~new_n98_ & new_n99_) : ~x30;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x40;
  assign new_n100_ = (~x30 | new_n66_ | x39) & (~x39 | ((new_n66_ | new_n99_) & (~new_n101_ | x30)));
  ...
  assign z18 = x30 | (x39 & (new_n106_ | new_n87_ | x09));
  assign new_n106_ = x08 & ((x29 & x40) | (~x27 & ~x28 & x35));
  assign z20 = ~x09 & ~x30 & ~new_n108_ & x39;
  assign new_n108_ = (x08 | (x27 & x35)) & ((x29 & x40) | (x35 & (x27 | ~x28)));
  assign z19 = z11;
endmodule
