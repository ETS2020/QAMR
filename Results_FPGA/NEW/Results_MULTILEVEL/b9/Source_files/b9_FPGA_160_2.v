...
module FAU ( 
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : x26)) & (~x05 | ~x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = x40 ? (x29 & x39) : x26;
  assign new_n88_ = (x27 | (x26 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (~x26 & ~new_n66_ & ~x40);
  ...
  assign new_n95_ = x20 & ~x26 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : x26;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (x26 | new_n66_ | x40) & (~x40 | (~new_n102_ & (new_n66_ | new_n100_)));
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (~x26 | x40)));
