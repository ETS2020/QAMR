...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n78_,
    ...
    new_n111_;
  assign z00 = (~new_n65_ & (~x24 | ~x39)) | (~x04 & ~x15 & ~x24 & new_n67_ & x39);
  ...
  assign new_n69_ = x24 & x39;
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~x39 | (~x24 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x39 | (~x24 & ~x40))) | (x39 & x40 & x05 & ~x24));
  ...
  assign new_n88_ = x39 & (x24 | (x29 & x40));
  assign new_n89_ = (x27 | (x24 & x39)) & (x24 | (~x04 & ~x28 & x35));
  assign z12 = (~x24 & (new_n91_ | (~new_n66_ & (x04 | ~x40)))) | (~new_n66_ & ~x39);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x27) | (~x04 & new_n85_ & ~x13);
  assign new_n93_ = (x24 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x19 & x20 & ~x39 & (x37 | (x28 & x35));
  assign z14 = ~new_n101_ | ((x18 | x19 | ~x20) & (new_n98_ | ~x39));
  assign new_n98_ = ~x24 & (new_n99_ | ~new_n100_);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x40;
  assign new_n101_ = (new_n66_ | x39) & (x24 | (~new_n102_ & (new_n66_ | new_n100_)));
  ...
  assign z18 = (~new_n107_ & (~x24 | ~x39)) | (x08 & ~x24 & x29 & x39 & x40);
  ...
  assign new_n111_ = ~x08 & ((~x24 & (~x27 | ~x35)) | (~x27 & ~x39));
