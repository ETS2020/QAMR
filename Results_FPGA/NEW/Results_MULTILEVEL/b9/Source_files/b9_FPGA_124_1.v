...
module FAU ( 
  ...
  assign z02 = ~x40 | (x26 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (x26 & ~x39))) | (x05 & x26 & x39 & x40));
  assign new_n84_ = x06 & ~new_n67_ & x37;
  assign new_n85_ = x26 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & ((x04 & x27) | x28 | ~x35);
  assign new_n88_ = x40 & (~x26 | (x29 & x39));
  assign new_n89_ = (x27 | (~x26 & x40)) & (~x26 | (~x04 & ~x28 & x35));
  assign z12 = (x26 & (new_n91_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x27) | (~x04 & new_n85_ & ~x13);
  assign new_n93_ = (~new_n96_ | x18) & (~x26 | ((~new_n94_ | x04) & (~new_n95_ | x18)));
  ...
  assign new_n98_ = x26 & (new_n99_ | ~new_n100_);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (new_n68_ | x40) & (~x26 | (~new_n102_ & (new_n68_ | new_n100_)));
  ...
  assign z18 = (~new_n107_ & (x26 | ~x40)) | (x08 & x26 & x29 & x39 & x40);
  ...
  assign new_n111_ = ~x08 & ((x26 & (~x27 | ~x35)) | (~x27 & ~x40));
