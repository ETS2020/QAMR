...
module FAU ( 
  ...
  assign z01 = (~x04 & (x32 | x40)) | (~x30 & ~x32 & x40 & (new_n69_ | ~x27));
  ...
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : ~x32;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x32 | new_n66_ | x40) & (~x40 | ((new_n66_ | new_n100_) & (x30 | new_n102_ | x32)));
  assign new_n102_ = x27 & (~x28 | x35 | x37);
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (x32 | x40)));
