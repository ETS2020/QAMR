...
module FAU ( 
  ...
  assign z07 = x03 & ((~x33 & (new_n77_ | (~new_n78_ & ~x14))) | (~x14 & ~new_n78_ & x40));
  assign new_n77_ = ~x31 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  ...
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (~x33 & ~new_n66_ & ~x40);
  ...
  assign new_n95_ = x20 & ~x33 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : x33;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (x33 | new_n66_ | x40) & (~x40 | (~new_n102_ & (new_n66_ | new_n100_)));
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (~x33 | x40)));
