// Benchmark "FAU" written by ABC on Wed Aug  5 21:58:41 2020
...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x30 | x40)) | (~x30 & ~x32 & (new_n69_ | ~x27));
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : ~x30;
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : x30)) & (~x05 | ~x39 | ~x40);
  ...
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (~x30 & ~new_n66_ & ~x40);
  ...
  assign z18 = new_n105_ | (x30 & x40) | (~new_n106_ & ~x30);
  assign new_n105_ = x08 & (new_n87_ | (~x27 & ~x28 & ~x30 & x35));
  assign new_n106_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & (new_n108_ | (~x08 & (~x27 | ~x35)));
  assign new_n108_ = ~new_n87_ & (~x35 | (~x27 & x28));
