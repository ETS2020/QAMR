...
module FAU ( 
  ...
  assign new_n78_ = (x15 | ~x17) & ((x00 & (~x25 | ~x38)) | (~x38 & ~x40));
  assign new_n79_ = ~x14 & (x00 | (~x40 & (x25 | ~x38)));
  assign z08 = x40 & x00 & x39;
  assign z09 = x11 & x26 & x27 & ~new_n67_ & x34;
  assign z10 = (new_n85_ & x00) | (~new_n83_ & x27);
  assign new_n83_ = (x04 | new_n70_ | new_n84_) & (~x06 | new_n67_ | ~x37);
  assign new_n84_ = (~x00 | ((~x07 | x39) & (~x05 | ~x39 | ~x40))) & (~x07 | x40);
  assign new_n85_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & ((x04 & x27) | x28 | ~x35);
  assign new_n88_ = x40 & (~x00 | (x29 & x39));
  assign new_n89_ = (x27 | (~x00 & x40)) & (~x00 | (~x04 & ~x28 & x35));
  assign z12 = (x00 & (new_n91_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (new_n97_ & x00) | (~new_n93_ & x27);
  assign new_n93_ = (~x00 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  ...
  assign z14 = ~new_n102_ | ((new_n99_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n99_ = x00 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (new_n68_ | x40) & (~x00 | (~new_n103_ & (new_n68_ | new_n101_)));
  ...
  assign z18 = (~new_n108_ & (x00 | ~x40)) | (x00 & x08 & x29 & x39 & x40);
  ...
  assign new_n112_ = ~x08 & ((x00 & (~x27 | ~x35)) | (~x27 & ~x40));
