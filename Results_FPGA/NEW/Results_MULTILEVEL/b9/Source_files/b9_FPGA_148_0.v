...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x12;
  ...
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (x12 & ~new_n66_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x27 & ((x40 & (new_n92_ | new_n93_)) | (new_n93_ & x12)));
  ...
  assign new_n99_ = (~x12 | new_n66_ | x40) & (~x40 | (~new_n100_ & (new_n66_ | new_n98_)));
  ...
  assign new_n109_ = ~x08 & ((~x35 & x40) | (~x27 & (x12 | x40)));
