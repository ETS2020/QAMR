...
module FAU ( 
  ...
  assign z12 = new_n90_ | (~x27 & (~x10 | (x40 & (x04 | ~x39))));
  assign new_n90_ = ~x37 & ((~new_n91_ & (~x28 | ~x35)) | (~x10 & ~x35 & ~x36));
  assign new_n91_ = x40 ? (~x04 & x39) : x10;
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : x10;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n66_ | new_n99_))) & (x10 | new_n66_ | x40);
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (~x10 | x40)));
