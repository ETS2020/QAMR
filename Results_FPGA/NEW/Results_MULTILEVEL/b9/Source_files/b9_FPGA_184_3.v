...
module FAU ( 
  ...
  assign new_n65_ = (x10 | (~new_n66_ & ~x37 & (~x28 | ~x35))) & (x40 | (~x37 & (~x28 | ~x35)));
  ...
  assign new_n82_ = ~new_n69_ & ((x07 & (~x40 | (~x10 & ~x39))) | (x05 & ~x10 & x39 & x40));
  ...
  assign z12 = (~new_n67_ & ~x27) | (~new_n90_ & ~x37);
  assign new_n90_ = ((x28 & x35) | (x40 & (new_n91_ | x10))) & (x10 | x35 | x36);
  assign new_n91_ = ~x04 & x39;
  assign z13 = (~new_n93_ & x27) | (new_n97_ & ~x04);
  assign new_n93_ = (x10 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign new_n97_ = ~x10 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n102_ | ((x18 | x19 | ~x20) & (new_n99_ | ~x40));
  assign new_n99_ = ~x10 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (x10 | (~new_n103_ & (new_n101_ | new_n104_))) & (new_n104_ | x40);
  ...
  assign new_n113_ = ~x08 & ((~x27 & ~x40) | (~x10 & (~x27 | ~x35)));
