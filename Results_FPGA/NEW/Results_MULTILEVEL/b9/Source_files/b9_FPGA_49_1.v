...
module FAU ( 
  ...
  assign z07 = x03 & (new_n80_ | (x11 & new_n79_ & ~x31));
  ...
  assign z18 = ~new_n69_ & (~new_n104_ | (~new_n103_ & x08));
  assign new_n103_ = ~new_n88_ & (x27 | x28 | ~x35);
  assign new_n104_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & ~new_n106_ & ~new_n69_;
  assign new_n106_ = (x08 | (x27 & x35)) & (new_n88_ | (x35 & (x27 | ~x28)));
  assign z19 = ~x09 & ~x30 & ~new_n87_ & ~new_n69_;
endmodule
