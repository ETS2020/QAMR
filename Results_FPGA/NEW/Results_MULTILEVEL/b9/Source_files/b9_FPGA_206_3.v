// Benchmark "FAU" written by ABC on Wed Aug  5 21:58:53 2020
...
module FAU ( 
  ...
  assign z02 = ~x40 | (~x03 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z10 = (~new_n83_ & x27) | (new_n85_ & ~x03);
  ...
  assign z13 = (~new_n93_ & x27) | (new_n97_ & ~x03);
  assign new_n93_ = (x03 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  ...
  assign new_n99_ = ~x03 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (new_n68_ | x40) & (x03 | (~new_n103_ & (new_n68_ | new_n101_)));
