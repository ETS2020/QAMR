...
module FAU ( 
  ...
  assign z03 = ((x21 | x40) & (x27 ? (~x28 | ~x35) : ~x37)) | (~x21 & x40);
  assign z04 = x21 | (x40 & (x27 ? (~x28 | ~x35) : ~x37));
  ...
  assign new_n95_ = x20 & x21 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : ~x21;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x21 | new_n66_ | x40) & (~x40 | (~new_n102_ & (new_n66_ | new_n100_)));
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (x21 | x40)));
