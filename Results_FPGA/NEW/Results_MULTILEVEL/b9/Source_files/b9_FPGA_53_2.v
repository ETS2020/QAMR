...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x15;
  ...
  assign z07 = x03 & (new_n79_ | (~x31 & new_n80_ & ~x33));
  assign new_n79_ = ~x14 & ~new_n70_ & (x00 | x25 | ~x38);
  assign new_n80_ = (x15 ? x40 : ~x17) & (~x38 | (x00 & ~x25));
  assign z09 = x11 & x26 & x27 & ~new_n70_ & x34;
  assign z10 = (x27 & (new_n83_ | (~x04 & ~new_n71_ & ~new_n84_))) | (new_n85_ & ~x04);
  assign new_n83_ = x06 & ~new_n70_ & x37;
  assign new_n84_ = (~x07 | (x40 ? x39 : x15)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & ((x04 & x27) | x28 | ~x35);
  assign new_n88_ = x40 ? (x29 & x39) : x15;
  assign new_n89_ = (x27 | (x15 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~x15 & ~new_n92_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n96_ | (x27 & ((x40 & (new_n94_ | new_n95_)) | (new_n95_ & ~x15)));
  ...
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : x15;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (x15 | new_n92_ | x40) & (~x40 | (~new_n102_ & (new_n92_ | new_n100_)));
  ...
  assign z18 = (~new_n107_ & ~new_n70_) | (z08 & x08 & x29);
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (~x15 | x40)));
