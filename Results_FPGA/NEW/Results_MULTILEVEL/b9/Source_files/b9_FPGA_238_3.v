...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x32 | ~x40)) | (~x30 & ~x32 & (new_n70_ | ~x27));
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~x40 | (~x32 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n84_ = (~x07 | (x40 & (x32 | x39))) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = new_n86_ & ~x04 & x05 & x30;
  assign new_n86_ = ~x32 & x39 & x40;
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n90_ & ~x08));
  assign new_n88_ = ~new_n89_ & ((x04 & x27) | x28 | ~x35);
  assign new_n89_ = x40 & (x32 | (x29 & x39));
  assign new_n90_ = (x27 | (x32 & x40)) & (x32 | (~x04 & ~x28 & x35));
  assign z12 = (~x32 & (new_n92_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n94_ & x27) | (new_n86_ & ~x04 & ~x13 & x30);
  assign new_n94_ = (~new_n97_ | x18) & (x32 | ((~new_n95_ | x04) & (~new_n96_ | x18)));
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n97_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign z14 = (~new_n102_ & (~x40 | (~new_n99_ & ~x32))) | (~new_n68_ & ~x40) | (~new_n101_ & ~x32);
  assign new_n99_ = new_n100_ & (~x28 | x30 | (x35 & x36));
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (x30 | (x27 & (~x28 | x35 | x37))) & (new_n100_ | (x27 & (x37 | (x28 & x35))));
  ...
  assign z18 = (~new_n107_ & ~new_n67_) | (new_n86_ & x08 & x29);
  ...
  assign new_n111_ = ~x08 & ((~x32 & ~x35) | (~x27 & (~x32 | ~x40)));
