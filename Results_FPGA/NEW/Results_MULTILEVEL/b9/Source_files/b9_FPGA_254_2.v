...
module FAU ( 
  ...
  assign z11 = ~x09 & ~x30 & (new_n88_ | (new_n87_ & x40));
  assign new_n87_ = (~x29 | ~x39) & (~new_n70_ | (x04 & x27));
  assign new_n88_ = ~x08 & (~new_n70_ | x04 | ~x27);
  ...
  assign new_n105_ = ~x28 & x35 & ((~x04 & (x08 ? x40 : x27)) | (x08 & ~x27 & x40));
  assign new_n106_ = ((x08 & ~x40) | (~x09 & ~x30)) & (~x39 | ~x40 | ~x08 | ~x29);
  assign z20 = ~x09 & ~x30 & (new_n108_ | (~x08 & (~x27 | ~x35)));
  assign new_n108_ = x40 & (~x35 | (~x27 & x28)) & (~x29 | ~x39);
  assign z19 = ~x09 & ~x30 & (new_n88_ | (new_n87_ & x40));
endmodule
