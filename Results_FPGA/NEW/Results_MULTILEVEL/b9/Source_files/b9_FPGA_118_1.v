...
module FAU ( 
  ...
  assign z14 = (~new_n98_ & ((~new_n94_ & x27) | ~x40)) | (~x27 & ~x40) | (~new_n96_ & ~x37);
  assign new_n94_ = ~new_n95_ & ~x04 & ~x13 & x39;
  assign new_n95_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = (new_n97_ | (x28 & x35)) & (~x27 | ~x28 | x30 | x32 | x35);
  assign new_n97_ = x40 & (~x27 | (~x04 & ~x13 & x39));
  assign new_n98_ = ~x18 & ~x19 & x20;
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = x01 & x22 & ~x23 & (x27 | ~x40);
  assign z17 = x01 & x22 & x23 & ~x24 & (x27 | ~x40);
  assign z18 = ~new_n103_ | (~new_n104_ & x08);
  assign new_n103_ = ((~x27 & x40) | (~x09 & ~x30)) & (~new_n70_ | x04 | ~x27);
  assign new_n104_ = (~x39 | ~x40 | ~x27 | ~x29) & (x27 | x28 | ~x35 | x40);
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (x08 | (x27 ? x35 : x40)) & (x35 | (x40 & (new_n86_ | ~x27))) & (x27 | ~x28 | x40);
