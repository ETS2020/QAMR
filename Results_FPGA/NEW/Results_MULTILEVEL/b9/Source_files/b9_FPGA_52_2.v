...
module FAU ( 
  ...
  assign new_n77_ = (x15 | ~x17) & ((~x38 & (~x00 | x40)) | (x00 & ~x25 & x40));
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : x00)) & (~x05 | ~x39 | ~x40);
  ...
  assign z12 = (x40 & (new_n91_ | (~new_n66_ & (x04 | ~x39)))) | (~x00 & ~new_n66_ & ~x40);
  ...
  assign new_n94_ = x20 & (~x00 | x40) & (x37 | (x28 & x35));
  assign new_n95_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ~new_n100_ | (~new_n97_ & (x18 | x19 | ~x20));
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : x00;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (x00 | new_n66_ | x40) & (~x40 | (~new_n101_ & (new_n66_ | new_n99_)));
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (~x00 | x40)));
