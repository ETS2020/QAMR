...
module FAU ( 
  ...
  assign z02 = x39 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x24;
  ...
  assign z10 = (new_n84_ & ~x04) | (x27 & (new_n82_ | (~x04 & ~new_n69_ & ~new_n83_)));
  assign new_n82_ = x06 & ~new_n65_ & x37;
  assign new_n83_ = (~x07 | (x39 ? x40 : ~x24)) & (~x05 | ~x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = x39 ? (x29 & x40) : ~x24;
  assign new_n88_ = (x27 | (~x24 & ~x39)) & (~x39 | (~x04 & ~x28 & x35));
  assign z12 = (x39 & (new_n90_ | (~new_n66_ & (x04 | ~x40)))) | (x24 & ~new_n66_ & ~x39);
  ...
  assign new_n111_ = ~x08 & ((~x35 & x39) | (~x27 & (x24 | x39)));
