...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x25;
  ...
  assign new_n77_ = (x15 | ~x17) & ((~x38 & (x25 | x40)) | (x00 & ~x25 & x40));
  assign new_n78_ = ~x14 & (x25 | (x40 & (x00 | ~x38)));
  assign z08 = x39 & x40;
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : ~x25)) & (~x05 | ~x39 | ~x40);
  ...
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (x25 & ~new_n66_ & ~x40);
  ...
  assign new_n95_ = x20 & x25 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : ~x25;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x25 | new_n66_ | x40) & (~x40 | (~new_n102_ & (new_n66_ | new_n100_)));
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (x25 | x40)));
