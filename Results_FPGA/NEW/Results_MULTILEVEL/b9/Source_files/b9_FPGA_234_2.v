...
module FAU ( 
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (x40 ? ~x39 : ~x18)) | (x05 & x39 & x40));
  ...
  assign new_n88_ = x40 ? (x29 & x39) : x18;
  assign new_n89_ = (x27 | (x18 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n65_ & (x04 | ~x39)))) | (~x18 & ~new_n65_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n93_ | (~x04 & new_n94_ & ~x13))) | (~x04 & new_n85_ & ~x13);
  assign new_n93_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n94_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x40 & (new_n96_ | new_n98_)) | (~x18 & ~new_n100_ & ~x40);
  ...
  assign new_n100_ = ~new_n66_ & ~x19 & x20 & x27;
  ...
  assign new_n109_ = ~x08 & ((~x35 & x40) | (~x27 & (~x18 | x40)));
