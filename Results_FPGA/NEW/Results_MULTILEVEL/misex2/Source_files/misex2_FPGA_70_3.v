...
module FAU ( 
  ...
  assign z03 = ~x09 & ((new_n51_ & x00 & x01 & x02) | (new_n52_ & ~x00 & ~x01 & ~x02));
  ...
  assign new_n58_ = (x01 | (x09 & x18)) & (x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n63_ = ~x01 & x02 & ~x11 & x12 & new_n64_ & ~x13;
  assign new_n64_ = ~x14 & ~x15 & ~x16 & x20 & (~x09 | ~x18);
  assign new_n65_ = x01 & ~x09 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ((~x01 & new_n67_ & x02) | (new_n70_ & new_n69_ & x01));
  assign new_n67_ = ~x11 & x12 & ~x13 & ~x14 & new_n68_ & x15;
  assign new_n68_ = x16 & x20 & ~x21 & ~x22 & (~x09 | ~x18);
  assign new_n69_ = ~x09 & x18;
  assign new_n70_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & ~x22 & ((new_n74_ & new_n69_ & x01) | (new_n72_ & ~x01));
  assign new_n72_ = x02 & ~x11 & x12 & ~x13 & new_n73_ & ~x14;
  assign new_n73_ = x15 & ~x16 & x20 & ~x21 & (~x09 | ~x18);
  assign new_n74_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & new_n76_ & ~x18;
  assign new_n76_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n77_ & ~x01));
  assign new_n77_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~new_n79_ & ~x19;
  assign new_n79_ = x09 & x18;
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = ~new_n79_ & ((x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19));
  assign z16 = ~x00 & ~new_n79_ & x01;
  assign z17 = ~x00 & ~x01 & ~new_n79_ & x02;
endmodule
