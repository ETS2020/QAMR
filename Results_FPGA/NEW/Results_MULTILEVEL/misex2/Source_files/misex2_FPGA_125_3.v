...
module FAU ( 
  ...
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n47_ & x09;
  assign z03 = (~x00 & ~x01 & new_n51_ & ~x02) | (new_n52_ & x00 & x01 & x02 & ~x08);
  assign new_n51_ = ~x17 & x18 & ~x19 & (~x08 | ~x10);
  assign new_n52_ = x11 & x12 & ~x09 & x10;
  assign z04 = ~x12 & new_n54_ & ~x11;
  assign new_n54_ = x10 & ~x09 & ~x08 & x02 & x00 & x01;
  assign z05 = x10 & x09 & ~x08 & x02 & x00 & x01;
  assign z06 = new_n54_ & x11;
  assign z07 = x00 & ~new_n58_ & x02;
  assign new_n58_ = (x01 | (x08 & x10)) & (x08 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n47_ & ~x09;
  assign z15 = (~x02 & (~x08 | ~x10) & (x00 | (~x01 & x19))) | (x00 & x01 & ~x10);
