...
module FAU ( 
  ...
  assign new_n72_ = x18 & ~x19 & ~x20 & x21 & (x02 | x13);
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | (x02 ? x10 : ~x13)) : (new_n75_ | x01);
  assign new_n75_ = (~x13 | ((~x19 | ~x23) & (x02 | ~x17 | x19))) & (~x02 | ~x23);
