...
module FAU ( 
  ...
  assign new_n57_ = ~x07 & (~x01 | (x11 & ~x12 & ~x09 & x10));
  ...
  assign new_n64_ = x01 & x18 & ~x19 & ~x20 & (~x02 | ~x07);
  assign z10 = ~x00 & ((new_n67_ & new_n68_) | (x01 & new_n66_ & x18));
  assign new_n66_ = ~x19 & ~x20 & x21 & x22 & (~x02 | ~x07);
  assign new_n67_ = ~x01 & x02 & ~x07 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & ((new_n63_ & new_n71_) | (new_n70_ & x01));
  assign new_n70_ = x18 & ~x19 & ~x20 & x21 & (~x02 | ~x07);
  assign new_n71_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
  assign z12 = x09 & ~new_n73_ & ~x24;
  assign new_n73_ = x00 ? (~x01 | (x02 & (x07 | x10))) : (new_n74_ | x01);
  assign new_n74_ = x02 ? (x07 | ~x23) : (x19 ? ~x23 : ~x17);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & (~x02 | (x01 & ~x07 & ~x10))) | (~x01 & ~x02 & x19);
  assign z16 = ~x00 & x01 & (~x02 | ~x07);
