...
module FAU ( 
  ...
  assign z10 = ~x00 & x16 & (new_n69_ | new_n70_);
  assign new_n69_ = new_n66_ & ~x14 & x15 & x20 & ~x21 & ~x22;
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & ~x22 & (new_n72_ | (new_n66_ & new_n73_));
  assign new_n72_ = ~x19 & ~x20 & x21 & x01 & x16 & x18;
  assign new_n73_ = ~x14 & x15 & ~x16 & ~x18 & x20 & ~x21;
  assign z12 = x09 & ~x24 & ~new_n75_ & ~new_n52_;
