...
module FAU ( 
  ...
  assign z03 = (x00 & x01 & new_n46_ & x02) | (new_n48_ & ~x00 & ~x01 & ~x02);
  assign new_n46_ = ~x09 & x10 & x11 & ~new_n47_ & x12;
  assign new_n47_ = ~x17 & ~x18;
  assign new_n48_ = ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n50_ & x02;
  assign new_n50_ = ~x09 & x10 & ~x11 & ~new_n47_ & ~x12;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n47_ & x10;
  assign z06 = x00 & new_n53_ & x01;
  assign new_n53_ = x02 & ~x09 & x10 & ~new_n47_ & x11;
  assign z07 = x00 & x02 & ~new_n47_ & ~new_n55_;
  ...
  assign new_n69_ = x15 & ~x16 & x20 & ~x21 & (x17 | x18);
  assign new_n70_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n72_ & x01) : (~new_n73_ & ~x01));
  assign new_n72_ = ~new_n47_ & (~x02 | ~x10);
  assign new_n73_ = (~x17 | (~x23 & (x02 | x19))) & (~x18 | ~x23 | (~x02 & ~x19));
