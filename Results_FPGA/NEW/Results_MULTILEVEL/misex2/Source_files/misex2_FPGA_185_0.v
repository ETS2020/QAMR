...
module FAU ( 
  ...
  assign new_n57_ = x02 & ((~x01 & x12) | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = x19 & ~x18 & new_n59_ & x17;
  assign new_n59_ = x12 & ~x08 & ~x07 & ~x06 & new_n60_ & ~x05;
  ...
  assign new_n74_ = x12 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
