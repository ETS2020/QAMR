...
module FAU ( 
  ...
  assign new_n57_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x19);
  assign z09 = ~x00 & ~x19 & ~x21 & ~new_n59_ & ~x22;
  assign new_n59_ = (~new_n61_ | ~x01) & (~new_n60_ | x01 | ~x02 | x11 | ~x12);
  assign new_n60_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n61_ = x18 & ~x20;
  assign z10 = ~x00 & ~x19 & (new_n63_ | (new_n64_ & new_n65_));
  assign new_n63_ = x01 & x18 & ~x20 & x21 & x22;
  assign new_n64_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x19 & ~x22 & (new_n67_ | new_n68_);
  assign new_n67_ = new_n64_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n68_ = x01 & x18 & ~x20 & x21;
  assign z12 = new_n70_ & x09;
  assign new_n70_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (new_n71_ & ~x01));
  assign new_n71_ = ~x19 & (x02 ? x23 : x17);
