...
module FAU ( 
  ...
  assign new_n53_ = ~x16 & ~x17 & x18 & ~x19;
  ...
  assign new_n69_ = new_n70_ & x01 & ~x16 & x18;
  assign new_n70_ = ~x19 & ~x20 & x21 & x22;
  assign new_n71_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n72_ = x20 & ~x21 & ~x22 & x15 & x16 & ~x18;
  assign z11 = ~x00 & ~x16 & ~x22 & (new_n74_ | new_n75_);
  assign new_n74_ = new_n66_ & ~x13 & ~x14 & x15 & x20 & ~x21;
