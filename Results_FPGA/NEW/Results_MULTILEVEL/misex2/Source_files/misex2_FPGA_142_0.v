...
module FAU ( 
  ...
  assign new_n50_ = x06 & ~x17 & x18 & ~x19;
  ...
  assign new_n59_ = ~x01 & x02 & x06 & ~x11 & x12;
  ...
  assign new_n64_ = ~x01 & x02 & x06 & ~x11 & x12 & ~x13;
  ...
  assign new_n71_ = ~x01 & x06 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
