...
module FAU ( 
  ...
  assign z09 = ~x00 & ~x21 & ~new_n55_ & ~x22;
  assign new_n55_ = ~new_n57_ & (~new_n56_ | x01 | ~x02 | x11 | ~x12);
  assign new_n56_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n57_ = x01 & ~x10 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n59_ | (new_n61_ & new_n62_));
  assign new_n59_ = new_n60_ & x01 & ~x10 & x18;
  assign new_n60_ = ~x19 & ~x20 & x21 & x22;
  assign new_n61_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n62_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n64_ | new_n65_);
  assign new_n64_ = new_n61_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n65_ = x01 & ~x10 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (x01 & ~x10) : (~new_n67_ & ~x01));
  assign new_n67_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
