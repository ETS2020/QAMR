...
module FAU ( 
  ...
  assign new_n51_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | ~x19);
  ...
  assign new_n56_ = new_n57_ & ~x16 & x19 & x20 & ~x14 & ~x15;
  ...
  assign new_n62_ = x15 & x16 & x19 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n64_ | (new_n57_ & new_n65_));
  assign new_n64_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n65_ = ~x14 & x15 & ~x16 & x19 & x20 & ~x21;
  assign z12 = x09 & ~new_n67_ & ~x24;
  assign new_n67_ = (~x00 | ~x01 | (x02 & x10)) & (~x19 | ~x23 | x00 | x01);
