...
module FAU ( 
  ...
  assign z03 = ~x19 & ((new_n50_ & x00 & x01 & x02) | (~x00 & ~x01 & new_n51_ & ~x02));
  assign new_n50_ = ~x09 & x10 & x11 & x12;
  assign new_n51_ = ~x17 & x18;
  assign z04 = ~x19 & ~x12 & new_n53_ & ~x11;
  assign new_n53_ = x10 & ~x09 & x02 & x00 & x01;
  assign z05 = ~x19 & x10 & x09 & x02 & x00 & x01;
  assign z06 = ~x19 & new_n53_ & x11;
  assign z07 = x00 & ~new_n57_ & x02;
  assign new_n57_ = x01 & (x09 | ~x10 | ~x11 | x12 | x19);
  ...
  assign new_n73_ = (new_n74_ | x19) & (x00 | x01 | ~x23 | (~x02 & ~x19));
  assign new_n74_ = (~x00 | ~x01 | (x02 & x10)) & (x00 | x01 | x02 | ~x17);
