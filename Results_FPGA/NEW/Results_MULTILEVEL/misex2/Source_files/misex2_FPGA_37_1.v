...
module FAU ( 
  ...
  assign new_n58_ = x02 & ~x09 & x10 & ~new_n56_ & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | (~x12 & x18)) & (x09 | ~x10 | ~x11 | x12 | x18);
  assign z08 = x19 & new_n62_ & ~x18;
  assign new_n62_ = ~x08 & ~x07 & ~x06 & new_n63_ & ~x05 & x17;
  assign new_n63_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & x12 & ~x21 & ~new_n65_ & ~x22;
  assign new_n65_ = ~new_n67_ & (~new_n66_ | x16 | ~x20 | x14 | x15);
  assign new_n66_ = ~x01 & x02 & ~x11 & ~x13;
