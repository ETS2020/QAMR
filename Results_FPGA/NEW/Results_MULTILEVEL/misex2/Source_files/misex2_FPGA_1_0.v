// Benchmark "FAU" written by ABC on Thu Aug  6 15:08:39 2020
...
module FAU ( 
  ...
  assign new_n58_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | ~x15);
  ...
  assign new_n73_ = x15 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x17 & x15 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & ~x17 & x15 & new_n46_ & ~x10;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x15))) | (x15 & x19 & ~x01 & ~x02);
