...
module FAU ( 
  ...
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (~x16 | ~x21);
  ...
  assign z10 = ~x00 & (new_n69_ | (new_n71_ & x01 & ~x16 & x18));
  assign new_n69_ = new_n70_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n71_ = x21 & x22 & ~x19 & ~x20;
  assign z11 = ~x00 & ~x16 & ~x22 & (new_n73_ | new_n74_);
  assign new_n73_ = new_n66_ & ~x13 & ~x14 & x15 & x20 & ~x21;
