...
module FAU ( 
  ...
  assign new_n50_ = ~x09 & x10 & x11 & x12 & (~x19 | x22);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n53_ & x02;
  assign new_n53_ = ~x09 & x10 & ~x11 & ~x12 & (~x19 | x22);
  assign z05 = new_n55_ & x00;
  assign new_n55_ = x01 & x02 & x09 & x10 & (~x19 | x22);
  assign z06 = x00 & new_n57_ & x01;
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (~x19 | x22);
  assign z07 = x00 & x02 & ~new_n59_ & (~x19 | x22);
  assign new_n59_ = x01 & (~x11 | x12 | x09 | ~x10);
  assign z08 = x22 & new_n61_ & x19;
  ...
  assign new_n75_ = (~x02 | ~x10) & (~x19 | x22);
  assign new_n76_ = x19 ? (~x22 | ~x23) : (x02 ? ~x23 : ~x17);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & ((~x02 & (~x19 | (x01 & x22))) | (x01 & ~x10 & (~x19 | x22)))) | (~x01 & ~x02 & x19 & x22);
