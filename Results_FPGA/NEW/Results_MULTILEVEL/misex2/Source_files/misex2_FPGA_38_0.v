...
module FAU ( 
  ...
  assign z01 = ~x19 & ~x18 & ~x17 & x14 & new_n48_ & x10;
  assign new_n48_ = x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x19 & ~x18 & ~x17 & x14 & new_n48_ & ~x10;
  ...
  assign new_n58_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | ~x14);
  assign z08 = x19 & ~x18 & new_n60_ & x17;
  assign new_n60_ = x14 & ~x08 & ~x07 & ~x06 & new_n61_ & ~x05;
  ...
  assign new_n69_ = x14 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x17 & x14 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & ~x17 & x14 & new_n46_ & ~x10;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x14))) | (x14 & x19 & ~x01 & ~x02);
