...
module FAU ( 
  ...
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (x14 | x15);
  assign z09 = ~x00 & x01 & new_n65_ & x18;
  assign new_n65_ = ~x19 & ~x20 & ~x21 & ~new_n47_ & ~x22;
  ...
  assign new_n72_ = new_n68_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & ~new_n74_ & ~new_n47_;
  assign new_n74_ = x00 ? (~x01 | (x02 & x10)) : (new_n75_ | x01);
