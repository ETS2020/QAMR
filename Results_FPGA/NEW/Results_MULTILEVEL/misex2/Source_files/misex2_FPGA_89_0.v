...
module FAU ( 
  ...
  assign new_n50_ = x03 & ~x17 & x18 & ~x19;
  ...
  assign new_n57_ = (x01 | ~x03) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n61_ | (new_n59_ & new_n60_));
  assign new_n59_ = ~x01 & x02 & x03 & ~x11 & x12;
  ...
  assign new_n64_ = ~x01 & x02 & x03 & ~x11 & x12 & ~x13;
  ...
  assign new_n71_ = ~x01 & x03 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x03))) | (~x01 & ~x02 & x03 & x19);
  assign z16 = ~x00 & x01;
  assign z17 = x03 & x02 & ~x00 & ~x01;
  assign z08 = 1'b0;
endmodule
