...
module FAU ( 
  ...
  assign new_n62_ = (~new_n63_ | ~x01) & (~new_n64_ | x01 | ~x02 | x11 | ~x12);
  assign new_n63_ = x18 & ~x19 & ~x20 & (x02 | x04);
  assign new_n64_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n67_ & new_n68_) | (x01 & new_n66_ & x18));
  assign new_n66_ = ~x19 & ~x20 & x21 & x22 & (x02 | x04);
  assign new_n67_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n70_ | (new_n71_ & x01));
  assign new_n70_ = new_n67_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n71_ = x18 & ~x19 & ~x20 & x21 & (x02 | x04);
  assign z12 = x09 & ~new_n73_ & ~x24;
  assign new_n73_ = x00 ? (~x01 | (x02 ? x10 : ~x04)) : (new_n74_ | x01);
  assign new_n74_ = (~x04 | ((~x19 | ~x23) & (x02 | ~x17 | x19))) & (~x02 | ~x23);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & ((~x02 & x04) | (x01 & x02 & ~x10))) | (~x01 & ~x02 & x04 & x19);
  assign z16 = ~x00 & x01 & (x02 | x04);
endmodule
