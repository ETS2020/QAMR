...
module FAU ( 
  ...
  assign new_n73_ = x15 & ~x16 & x20 & ~x21 & (~x18 | ~x19);
  assign new_n74_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n76_ & x01) : (~new_n77_ & ~x01));
  assign new_n76_ = (~x02 | ~x10) & (~x18 | ~x19);
  assign new_n77_ = (x19 | (x02 ? ~x23 : ~x17)) & (x18 | ~x19 | ~x23);
