...
module FAU ( 
  ...
  assign new_n53_ = ~x05 & ~x17 & x18 & ~x19;
  ...
  assign new_n66_ = ~x14 & ~x15 & ~x16 & (~x05 | ~x18) & x20;
  assign new_n67_ = x01 & ~x05 & x18 & ~x19 & ~x20;
  ...
  assign new_n75_ = x15 & ~x16 & x20 & (~x05 | ~x18) & ~x21;
  assign new_n76_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & ~new_n78_ & ~new_n52_;
