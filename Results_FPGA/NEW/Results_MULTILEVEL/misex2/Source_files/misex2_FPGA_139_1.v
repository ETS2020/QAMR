...
module FAU ( 
  ...
  assign new_n53_ = ~x09 & x10 & ~x11 & ~new_n51_ & ~x12;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n51_ & x10;
  assign z06 = x00 & new_n56_ & x01;
  assign new_n56_ = x02 & ~x09 & x10 & ~new_n51_ & x11;
  assign z07 = x00 & x02 & ~new_n51_ & ~new_n58_;
  ...
  assign new_n64_ = ~x14 & ~x15 & ~x16 & x20 & (x17 | ~x18);
  ...
  assign new_n68_ = x16 & x20 & ~x21 & ~x22 & (x17 | ~x18);
