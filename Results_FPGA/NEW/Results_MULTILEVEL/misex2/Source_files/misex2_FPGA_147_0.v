...
module FAU ( 
  ...
  assign new_n46_ = x07 & ~x02 & ~x00 & ~x01;
  ...
  assign new_n50_ = x07 & ~x17 & x18 & ~x19;
  ...
  assign new_n63_ = x18 & ~x19 & ~x20 & (x02 | x07);
  ...
  assign new_n71_ = x18 & ~x19 & ~x20 & x21 & (x02 | x07);
  assign z12 = x09 & ~new_n73_ & ~x24;
  assign new_n73_ = x00 ? (~x01 | (x02 ? x10 : ~x07)) : (new_n74_ | x01);
  assign new_n74_ = (~x07 | ((~x19 | ~x23) & (x02 | ~x17 | x19))) & (~x02 | ~x23);
