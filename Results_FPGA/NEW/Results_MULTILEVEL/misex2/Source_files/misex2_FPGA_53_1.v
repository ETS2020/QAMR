...
module FAU ( 
  ...
  assign new_n61_ = ~x14 & ~x15 & ~x16 & ~x17 & x20;
  ...
  assign new_n69_ = ~x14 & x15 & ~x16 & ~x17 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (x00 ? new_n71_ : new_n72_);
  assign new_n71_ = x01 & (~x02 | ~x10);
  assign new_n72_ = ~x01 & ~x17 & x23 & (x02 | x19);
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & ~x17))) | (~x01 & ~x02 & ~x17 & x19);
  assign z16 = ~x00 & x01;
