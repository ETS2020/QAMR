...
module FAU ( 
  ...
  assign new_n51_ = ~x09 & x10 & x11 & x12 & (~x17 | x19);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n54_ & x02;
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12 & (~x17 | x19);
  assign z05 = new_n56_ & x00;
  assign new_n56_ = x01 & x02 & x09 & x10 & (~x17 | x19);
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (~x17 | x19);
  assign z07 = x00 & x02 & ~new_n60_ & (~x17 | x19);
  ...
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20 & (~x17 | x19);
  ...
  assign new_n70_ = x16 & x20 & ~x21 & ~x22 & (~x17 | x19);
  ...
  assign new_n75_ = x15 & ~x16 & x20 & ~x21 & (~x17 | x19);
  assign new_n76_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n79_ & x01) : (new_n78_ & ~x01));
  assign new_n78_ = x23 & (x19 | (x02 & ~x17));
  assign new_n79_ = (~x02 | ~x10) & (~x17 | x19);
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & (~x17 | x19) & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19);
  assign z16 = ~x00 & x01 & (~x17 | x19);
  assign z17 = ~x00 & ~x01 & x02 & (~x17 | x19);
  assign z13 = 1'b0;
endmodule
