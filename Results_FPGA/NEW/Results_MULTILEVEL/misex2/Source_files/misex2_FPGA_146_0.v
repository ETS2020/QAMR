...
module FAU ( 
  ...
  assign new_n72_ = x18 & ~x19 & ~x20 & x21 & (x02 | x12);
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | (x02 ? x10 : ~x12)) : (new_n75_ | x01);
  assign new_n75_ = (~x12 | ((~x19 | ~x23) & (x02 | ~x17 | x19))) & (~x02 | ~x23);
  assign z13 = ~x19 & x17 & x12 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & ~x17 & x12 & new_n46_ & ~x10;
  assign z15 = (x00 & ((~x02 & x12) | (x01 & x02 & ~x10))) | (~x01 & ~x02 & x12 & x19);
