// Benchmark "FAU" written by ABC on Thu Aug  6 15:08:45 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n49_, new_n53_, new_n55_, new_n56_, new_n57_,
  ...
  assign new_n53_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | ~x18);
  assign z09 = ~x00 & x18 & ~x21 & ~new_n55_ & ~x22;
  assign new_n55_ = (~new_n57_ | ~x01) & (~new_n56_ | x01 | ~x02 | x11 | ~x12);
  assign new_n56_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n57_ = ~x19 & ~x20;
  assign z10 = ~x00 & x18 & (new_n59_ | (new_n60_ & new_n61_));
  assign new_n59_ = x01 & ~x19 & ~x20 & x21 & x22;
  assign new_n60_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n61_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & x18 & ~x22 & (new_n63_ | new_n64_);
  assign new_n63_ = new_n60_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n64_ = x01 & ~x19 & ~x20 & x21;
  assign z12 = new_n66_ & x09;
  assign new_n66_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (new_n67_ & ~x01));
  assign new_n67_ = x18 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x18 & x17 & ~x02 & ~x00 & ~x01;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x18))) | (x18 & x19 & ~x01 & ~x02);
  assign z16 = ~x00 & x01;
  assign z17 = x18 & x02 & ~x00 & ~x01;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z08 = 1'b0;
