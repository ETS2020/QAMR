...
module FAU ( 
  ...
  assign z09 = ~x00 & ~x21 & ~new_n56_ & ~x22;
  assign new_n56_ = ~new_n58_ & (~new_n57_ | x01 | ~x02 | x11 | ~x12);
  assign new_n57_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n58_ = x01 & x09 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n60_ | (new_n62_ & new_n63_));
  assign new_n60_ = new_n61_ & x01 & x09 & x18;
  ...
  assign new_n66_ = x01 & x09 & x18 & ~x19 & ~x20 & x21;
