...
module FAU ( 
  ...
  assign z10 = ~x00 & x15 & (new_n65_ | new_n67_);
  assign new_n65_ = new_n66_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & x16 & x20 & ~x21 & ~x22;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & x15 & ~new_n69_ & ~x22;
  assign new_n69_ = ~new_n70_ & (~new_n71_ | x01 | ~x02 | x11 | ~x12);
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n71_ = ~x13 & ~x14 & ~x16 & x20 & ~x21;
  assign z12 = new_n73_ & x09;
  assign new_n73_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (new_n74_ & ~x01));
  assign new_n74_ = x15 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
