...
module FAU ( 
  ...
  assign new_n60_ = (x01 | (~x12 & x21)) & (x09 | ~x10 | ~x11 | x12 | x21);
  assign z08 = ~x00 & ~x01 & new_n62_ & x02;
  assign new_n62_ = ~x03 & x04 & ~x05 & ~x06 & new_n63_ & ~x07;
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (x12 | ~x21);
  ...
  assign z10 = ~x00 & x12 & (new_n69_ | new_n71_);
  assign new_n69_ = new_n70_ & ~x01 & x02 & ~x11 & ~x13 & ~x14;
  assign new_n70_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & x12 & ~new_n73_ & ~x22;
  assign new_n73_ = ~new_n74_ & (~new_n75_ | x11 | x13 | x01 | ~x02);
