...
module FAU ( 
  ...
  assign new_n63_ = x18 & ~x19 & ~x20 & (~x02 | ~x13);
  ...
  assign new_n71_ = x18 & ~x19 & ~x20 & x21 & (~x02 | ~x13);
  assign z12 = x09 & ~new_n73_ & ~x24;
  assign new_n73_ = x00 ? (~x01 | (x02 & (x10 | x13))) : (new_n74_ | x01);
  assign new_n74_ = x02 ? (x13 | ~x23) : (x19 ? ~x23 : ~x17);
