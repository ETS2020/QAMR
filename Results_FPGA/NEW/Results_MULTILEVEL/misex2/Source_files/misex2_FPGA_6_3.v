// Benchmark "FAU" written by ABC on Thu Aug  6 15:08:40 2020
...
module FAU ( 
  ...
  assign z04 = ~x21 & ~x12 & new_n53_ & ~x11;
  assign new_n53_ = x10 & ~x09 & x02 & x00 & x01;
  assign z05 = ~x21 & x10 & x09 & x02 & x00 & x01;
  assign z06 = ~x21 & new_n53_ & x11;
  assign z07 = x00 & new_n57_ & x02;
  assign new_n57_ = ~x21 & (~x01 | (~x09 & x10 & x11 & ~x12));
