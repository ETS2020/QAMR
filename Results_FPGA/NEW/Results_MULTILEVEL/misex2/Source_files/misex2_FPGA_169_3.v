...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n56_, new_n58_, new_n60_,
    new_n63_, new_n64_, new_n65_, new_n67_, new_n69_, new_n70_, new_n71_,
    new_n73_, new_n74_;
  ...
  assign new_n73_ = x00 ? (~x01 | x22 | (x02 & x10)) : (new_n74_ | x01);
