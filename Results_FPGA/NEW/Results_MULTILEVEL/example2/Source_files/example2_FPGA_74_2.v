...
module FAU ( 
  ...
  assign z16 = (x34 & ~x40 & (~x49 | x78)) | (x40 & x49 & x78);
  assign z17 = (x35 & ~x40 & (~x49 | x78)) | (x40 & x48 & (~x49 | (x49 & x78)));
  ...
  assign z58 = ~x01 & ((~new_n238_ & x78) | (new_n241_ & ~x49));
  ...
  assign new_n247_ = (x81 ^ x84) & ((~x77 & x78) | (~x49 & x77 & ~x78 & x79));
