...
module FAU ( 
  ...
  assign new_n234_ = (x77 | ((~x76 | (x78 & ~x79)) & (~x78 | ~x79 | (~x81 ^ x84)))) & (~x76 | x78 | ~x79);
  assign z57 = x00 & ~x01 & ~x02 & x03 & (x76 | x78);
  assign z58 = ~x01 & ((new_n240_ & x76) | (~new_n237_ & x78));
  ...
  assign new_n256_ = x84 & (x77 ? ((x76 & ~x78 & x81) | (~x04 & x78)) : (x78 & x81));
endmodule
