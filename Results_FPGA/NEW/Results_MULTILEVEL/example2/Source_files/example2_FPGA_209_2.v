...
module FAU ( 
  ...
  assign z20 = (x38 & ~x40 & (~x45 | x78)) | (x40 & x45 & x78);
  assign z21 = (x39 & ~x40 & (~x45 | x78)) | (x40 & x44 & (~x45 | (x45 & x78)));
  ...
  assign z58 = ~x01 & ((~new_n238_ & x78) | (new_n241_ & ~x45));
  ...
  assign new_n247_ = (x81 ^ x84) & ((~x77 & x78) | (~x45 & x77 & ~x78 & x79));
