...
module FAU ( 
  ...
  assign new_n154_ = ~x01 & x40 & (x78 ? (~x77 | x79) : x74);
  assign z01 = ~x01 & ((x74 & (~x79 | (~x77 & ~x78))) | (x78 & (x77 | ~x79)));
  assign z02 = ~x01 & ~new_n157_ & x79;
  assign new_n157_ = (~x75 | x77 | ~x78) & (~x66 | ~x74 | ~x77 | x78);
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (x78 ? (~x77 | x79) : x74);
  ...
  assign new_n184_ = x05 & ~x43 & ((x78 & (x77 | ~x79)) | (x74 & ~x79));
  ...
  assign z47 = ~x01 & ((x04 & new_n214_ & ~x77) | (x74 & new_n215_ & x77));
  ...
  assign new_n218_ = x74 & x77 & ~x78 & x79 & (x81 ^ ~x84);
  ...
  assign z56 = (~new_n234_ & (x74 | x78)) | (x79 & ~new_n235_ & (x78 ? ~x77 : x74)) | (x74 & ~x77 & ~x78);
  assign new_n234_ = x00 & ~x01;
  assign new_n235_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = x00 & ~x01 & ~x02 & x03 & (x74 | x78);
  assign z58 = ~x01 & ((new_n241_ & x74) | (~new_n238_ & x78));
  ...
  assign new_n241_ = ~x79 & (~x04 | (x40 & ~x42 & x77 & ~x78));
  assign z59 = ~x01 & (new_n244_ | (x04 & x77 & ~new_n243_ & x78));
  assign new_n243_ = ~x40 & (x42 | (new_n180_ & x43 & ~x74 & x80));
  assign new_n244_ = ~x79 & ((~x04 & (x74 | x78)) | (x77 & (x78 | (x40 & x74))));
  assign z60 = ~x01 & (new_n248_ | new_n246_ | new_n249_);
  assign new_n246_ = x78 & (~x79 | (x04 & ~x42 & ~new_n247_ & x77));
  assign new_n247_ = x82 & ~x83 & x84 & x43 & x80 & x81;
  assign new_n248_ = (x81 ^ x84) & ((x74 & x77 & ~x78 & x79) | (~x77 & x78));
  assign new_n249_ = x74 & ((x04 & ~x42 & x77 & x78) | (~x04 & ~x79));
  assign z61 = ~x01 & x79 & ~new_n251_ & x80;
  assign new_n251_ = ((~x81 ^ ~x84) | ((x77 | ~x78) & (~x74 | ~x77 | x78))) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n255_ | (x77 & (new_n253_ | (~new_n254_ & x74))));
  assign new_n253_ = x78 & (x04 ? (~new_n247_ & ~x42) : (x79 & x81));
  assign new_n254_ = (~x04 | x42 | ~x78) & (x78 | ~x79 | ~x81 | ~x84);
  assign new_n255_ = x78 & ((x04 & ~x79) | (x81 & x84 & ~x77 & x79));
  assign z63 = ~x01 & x79 & ~new_n251_ & x82;
  assign z64 = ~new_n258_ & ~x01;
  assign new_n258_ = (~x04 | x77 | ~x78 | x79) & (~x79 | new_n251_ | ~x83);
  assign z65 = ~x01 & new_n260_ & x79;
  assign new_n260_ = x84 & (x77 ? ((~x04 & x78) | (x74 & ~x78 & x81)) : (x78 & x81));
endmodule
