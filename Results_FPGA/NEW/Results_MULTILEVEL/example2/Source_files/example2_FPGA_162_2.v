...
module FAU ( 
  ...
  assign z00 = (x06 & ~x40 & (~x52 | x78)) | (x40 & ((~x01 & ~new_n154_ & ~x52) | (x52 & x78)));
  ...
  assign z04 = ~x01 & (x78 ? (~x77 | x79) : ~x52);
  ...
  assign z58 = ~x01 & ((~new_n238_ & x78) | (new_n241_ & ~x52));
  ...
  assign new_n247_ = (~x81 ^ ~x84) & ((~x77 & x78) | (~x52 & x77 & ~x78 & x79));
