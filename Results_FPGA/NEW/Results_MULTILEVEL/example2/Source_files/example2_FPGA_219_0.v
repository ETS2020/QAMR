...
module FAU ( 
  ...
  assign new_n187_ = x05 & ~x43 & ((x78 & (x77 | ~x79)) | (~x79 & x81));
  ...
  assign z60 = ~x01 & ((~new_n253_ & x81) | (~new_n250_ & x78));
  assign new_n250_ = (new_n251_ | x77) & x79 & (~x04 | x42 | new_n252_ | ~x77);
  assign new_n251_ = x81 ^ ~x84;
  assign new_n252_ = x43 & ~x74 & x80 & x81 & x82 & ~x83;
  assign new_n253_ = (x04 | x79) & (~x77 | ~x79 | x84 | (x78 & (~x04 | x42)));
  assign z61 = ~x01 & x79 & ~new_n255_ & x80;
  assign new_n255_ = x77 ? (x78 ? x04 : (~x81 | ~x84)) : (~x78 | (x81 ^ x84));
  assign z62 = ~x01 & (new_n257_ | (x04 & ~new_n179_ & x78));
