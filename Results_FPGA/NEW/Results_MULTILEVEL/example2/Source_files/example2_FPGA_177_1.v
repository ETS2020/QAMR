...
module FAU ( 
  ...
  assign new_n154_ = ~x01 & x40 & (~x78 | (x36 & (~x77 | x79)));
  assign z01 = ~x01 & ((x36 & (~x79 | (x77 & x78))) | (~x78 & (~x77 | ~x79)));
  assign z02 = ~x01 & ~new_n157_ & x79;
  assign new_n157_ = (~x36 | ~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & x52 & ~x01 & x36;
  assign z04 = ~x01 & (~x78 | (x36 & (~x77 | x79)));
  ...
  assign z22 = ~x01 & (new_n178_ | (x04 & new_n179_ & x36));
  ...
  assign z23 = ~new_n183_ & (x36 | ~x78);
  assign new_n183_ = x00 & ~x01 & (x04 | ~x05 | x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x36 & (~x79 | (x77 & x78))) | (~x78 & ~x79));
  ...
  assign z36 = ~x01 & ~x04 & x36 & new_n200_ & x54;
  assign z37 = ~x01 & ~x04 & x36 & new_n200_ & x55;
  assign z38 = ~x01 & ~x04 & x36 & new_n200_ & x56;
  assign z39 = ~x01 & ~x04 & x36 & new_n200_ & x57;
  assign z40 = ~x01 & ~x04 & x36 & new_n200_ & x58;
  assign z41 = ~x01 & ~x04 & x36 & new_n200_ & x59;
  assign z42 = ~x01 & ~x04 & x36 & new_n200_ & x60;
  assign z43 = ~x01 & ~x04 & x36 & new_n200_ & x61;
  assign z44 = ~x01 & ~x04 & x36 & new_n200_ & x62;
  assign z45 = ~x01 & ~x04 & x36 & new_n200_ & x63;
  assign z46 = ~x01 & ~x04 & x36 & new_n200_ & x64;
  assign z47 = ~x01 & ((x04 & x36 & new_n215_ & ~x77) | (new_n216_ & x77));
  assign new_n215_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = ~x78 & x79 & (x81 ^ ~x84) & (x67 | x75);
  assign z48 = ~x01 & ((x04 & new_n218_ & x36) | (new_n219_ & x68));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n219_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((x04 & new_n221_ & x36) | (new_n219_ & x69));
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n223_ & x36) | (new_n219_ & x70));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n225_ & x36) | (new_n219_ & x71));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n227_ & x36) | (new_n219_ & x72));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n229_ & x36) | (new_n219_ & x73));
  ...
  assign new_n233_ = x79 & x78 & x77 & x36 & ~x01 & ~x04;
  assign z56 = (~new_n235_ & (x36 | ~x78)) | (~x77 & ~x78) | (x79 & ~new_n236_ & (~x78 | (x36 & ~x77)));
  assign new_n235_ = x00 & ~x01;
  assign new_n236_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = x00 & ~x01 & ~x02 & x03 & (x36 | ~x78);
  assign z58 = ~x01 & (new_n243_ | (x36 & (x77 ? ~new_n239_ : new_n242_)));
  ...
  assign z59 = ~x01 & (new_n246_ | (x04 & x36 & new_n245_ & x77));
  assign new_n245_ = x78 & (x40 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n246_ = ~x79 & ((~x04 & (~x78 | (x36 & x78))) | (x77 & (x78 ? x36 : x40)));
  assign z60 = ~x01 & (new_n249_ | new_n250_ | (x04 & new_n248_ & x36));
  assign new_n248_ = ~x42 & x77 & x78 & (~new_n180_ | ~new_n181_);
  assign new_n249_ = (x81 ^ x84) & ((x36 & ~x77 & x78) | (x77 & ~x78 & x79));
  assign new_n250_ = ~x79 & (x78 ? x36 : ~x04);
  assign z61 = ~x01 & x79 & ~new_n252_ & x80;
  assign new_n252_ = ((~x81 ^ ~x84) | ((~x77 | x78) & (~x36 | x77 | ~x78))) & (~x77 | ~x78 | x04 | ~x36);
  assign z62 = ~x01 & ((x04 & new_n179_ & x36) | (new_n254_ & x79));
  assign new_n254_ = x81 & ((x36 & x78 & (x77 ? ~x04 : x84)) | (x77 & ~x78 & x84));
  assign z63 = ~x01 & x79 & ~new_n252_ & x82;
  assign z64 = ~x01 & (new_n257_ | (x79 & ~new_n252_ & x83));
  assign new_n257_ = x04 & x36 & new_n242_ & ~x77;
  assign z65 = ~x01 & new_n259_ & x79;
  assign new_n259_ = x84 & ((x36 & x78 & (x77 ? ~x04 : x81)) | (x77 & ~x78 & x81));
endmodule
