...
module FAU ( 
  ...
  assign new_n154_ = ~x78 & x81;
  assign new_n155_ = x78 ? (x77 & ~x79) : x81;
  assign z01 = ~x01 & ((x78 & (x77 | ~x79)) | (~x81 & (~x79 | (~x77 & ~x78))));
  assign z02 = new_n158_ & ~x01;
  assign new_n158_ = x79 & ((x75 & ~x77 & x78) | (~x78 & ~x81 & x66 & x77));
  ...
  assign z22 = ~x01 & (new_n182_ | (x78 & (new_n179_ | new_n184_)));
  assign new_n179_ = x04 & (~x79 | (~x42 & x77 & (~new_n180_ | ~new_n181_)));
  assign new_n180_ = x43 & ~x74 & x80;
  assign new_n181_ = ~x83 & x84 & x81 & x82;
  assign new_n182_ = new_n183_ & ~x41 & x66 & x77;
  assign new_n183_ = ~x78 & x79 & ~x81 & ~x84;
  assign new_n184_ = ~x41 & x75 & ~x77 & x79 & (~x81 ^ x84);
  assign z23 = ~new_n154_ & (~x00 | x01 | (~x04 & x05 & ~x79));
  assign z24 = ~x01 & new_n187_ & ~x04;
  assign new_n187_ = x05 & ~x43 & ((~x79 & ~x81) | (x78 & (x77 | ~x79)));
  ...
  assign new_n199_ = (x42 | ~x51 | ~x81) & (~x05 | ~x42 | (x81 ^ ~x83));
  ...
  assign z48 = ~x01 & ((new_n220_ & x04) | (new_n222_ & new_n221_ & x68));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n221_ = x77 & ~x78;
  assign new_n222_ = x79 & ~x81 & ~x84;
  assign z49 = ~x01 & ((new_n224_ & x04) | (new_n222_ & new_n221_ & x69));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n226_ & x04) | (new_n222_ & new_n221_ & x70));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n228_ & x04) | (new_n222_ & new_n221_ & x71));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n230_ & x04) | (new_n222_ & new_n221_ & x72));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n232_ & x04) | (new_n222_ & new_n221_ & x73));
  ...
  assign z56 = ~new_n239_ | (~new_n154_ & ~new_n238_);
  assign new_n238_ = x00 & ~x01 & (~x76 | x77 | ~x79);
  assign new_n239_ = (~x79 | ((x77 | ((x81 | ~x84) & (~x78 | ~x81 | x84))) & (x78 | x81 | (~x76 & ~x84)))) & (x77 | x78 | x81);
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = ~x01 & ((~new_n242_ & x78) | (new_n245_ & ~x79));
  assign new_n242_ = (~x04 | ~x77 | ~x79 | (~new_n243_ & (~new_n181_ | ~new_n244_))) & (x79 | (x04 & x77));
  assign new_n243_ = ~x40 & x42;
  assign new_n244_ = ~x42 & x43 & ~x74 & x80;
  assign new_n245_ = ~x81 & (~x04 | (new_n221_ & x40 & ~x42));
  assign z59 = ~x01 & (new_n248_ | (x04 & x77 & ~new_n247_ & x78));
  assign new_n247_ = ~x40 & (x42 | (new_n180_ & new_n181_));
  assign new_n248_ = ~x79 & ((~x04 & (x78 | ~x81)) | (x77 & (x78 | (x40 & ~x81))));
  assign z60 = ~x01 & (new_n252_ | (x78 & (new_n253_ | new_n250_ | ~x79)));
  assign new_n250_ = x04 & ~x42 & ((x81 & ~x84) | (~new_n251_ & x77));
  assign new_n251_ = x43 & ~x74 & x80 & x81 & x82 & ~x83;
  assign new_n252_ = ~x81 & ((~x04 & ~x79) | (new_n221_ & x79 & x84));
  assign new_n253_ = ~x77 & (~x81 ^ ~x84);
  assign z61 = ~x01 & x79 & ~new_n255_ & x80;
  assign new_n255_ = x77 ? (x78 ? x04 : (x81 | x84)) : (~x78 | (x81 ^ x84));
  assign z62 = ~x01 & x78 & (new_n179_ | new_n257_);
  assign new_n257_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign z63 = ~x01 & x79 & ~new_n255_ & x82;
  assign z64 = ~x01 & ((x79 & ~new_n255_ & x83) | (new_n260_ & x78 & ~x79));
  assign new_n260_ = x04 & ~x77;
  assign z65 = new_n262_ & ~x01;
  assign new_n262_ = x78 & x79 & x84 & (x77 ? ~x04 : x81);
endmodule
