...
module FAU ( 
  ...
  wire new_n154_, new_n157_, new_n178_, new_n179_, new_n180_, new_n182_,
    ...
    new_n252_, new_n254_, new_n256_, new_n258_;
  assign z00 = new_n154_ | ((x78 | x82) & (x40 ? x52 : x06));
  assign new_n154_ = ~x01 & x40 & (x78 ? (~x77 | x79) : x82);
  assign z01 = ~x01 & ((x78 & (x77 | ~x79)) | (x82 & (~x79 | (~x77 & ~x78))));
  assign z02 = ~x01 & ~new_n157_ & x79;
  assign new_n157_ = (~x75 | x77 | ~x78) & (x78 | ~x82 | ~x66 | ~x77);
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (x78 ? (~x77 | x79) : x82);
  ...
  assign new_n184_ = x05 & ~x43 & ((x78 & (x77 | ~x79)) | (~x79 & x82));
  ...
  assign z56 = (~new_n234_ & (x78 | x82)) | (x79 & ~new_n235_ & (x78 ? ~x77 : x82)) | (~x77 & ~x78 & x82);
  assign new_n234_ = x00 & ~x01;
  assign new_n235_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = x00 & ~x01 & ~x02 & x03 & (x78 | x82);
  assign z58 = ~x01 & ((~new_n238_ & x78) | (new_n241_ & ~x79));
  ...
  assign new_n241_ = x82 & (~x04 | (x40 & ~x42 & x77 & ~x78));
  assign z59 = ~x01 & (new_n244_ | (x04 & x77 & ~new_n243_ & x78));
  assign new_n243_ = ~x40 & (x42 | (new_n180_ & x43 & ~x74 & x80));
  assign new_n244_ = ~x79 & ((~x04 & (x78 | x82)) | (x77 & (x78 | (x40 & x82))));
  assign z60 = ~x01 & (new_n247_ | new_n248_ | (x04 & new_n246_ & ~x42));
  assign new_n246_ = x77 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n247_ = (x81 ^ x84) & ((~x77 & x78) | (x77 & ~x78 & x79 & x82));
  assign new_n248_ = ~x79 & (x78 | (~x04 & x82));
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((x81 ^ x84) | (x77 ? (x78 | ~x82) : ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n252_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n252_ = x81 & (x77 ? (x78 ? ~x04 : (x82 & x84)) : (x78 & x84));
  assign z63 = ~x01 & new_n254_ & x79;
  assign new_n254_ = x82 & ((~x04 & x77 & x78) | ((~x81 ^ x84) & (~x77 ^ ~x78)));
  assign z64 = ~new_n256_ & ~x01;
  assign new_n256_ = (~x04 | x77 | ~x78 | x79) & (~x79 | new_n250_ | ~x83);
  assign z65 = ~x01 & new_n258_ & x79;
  assign new_n258_ = x84 & (x77 ? (x78 ? ~x04 : (x81 & x82)) : (x78 & x81));
endmodule
