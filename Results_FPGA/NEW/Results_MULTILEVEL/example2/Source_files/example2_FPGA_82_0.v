...
module FAU ( 
  ...
  assign new_n154_ = ~x01 & x40 & (x78 ? (~x77 | x79) : x83);
  assign z01 = ~x01 & ((x78 & (x77 | ~x79)) | (x83 & (~x79 | (~x77 & ~x78))));
  assign z02 = ~x01 & ~new_n157_ & x79;
  assign new_n157_ = (~x75 | x77 | ~x78) & (x78 | ~x83 | ~x66 | ~x77);
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (x78 ? (~x77 | x79) : x83);
  ...
  assign new_n184_ = x05 & ~x43 & ((x78 & (x77 | ~x79)) | (~x79 & x83));
  ...
  assign z56 = (~new_n234_ & (x78 | x83)) | (x79 & ~new_n235_ & (x78 ? ~x77 : x83)) | (~x77 & ~x78 & x83);
  ...
  assign new_n241_ = x83 & (~x04 | (x40 & ~x42 & x77 & ~x78));
  assign z59 = ~x01 & (new_n244_ | (x04 & x77 & ~new_n243_ & x78));
  assign new_n243_ = ~x40 & (x42 | (new_n180_ & x43 & ~x74 & x80));
  assign new_n244_ = ~x79 & ((~x04 & (x78 | x83)) | (x77 & (x78 | (x40 & x83))));
  assign z60 = ~x01 & (new_n247_ | new_n248_ | (x04 & new_n246_ & ~x42));
  assign new_n246_ = x77 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n247_ = (x81 ^ x84) & ((~x77 & x78) | (x77 & ~x78 & x79 & x83));
  assign new_n248_ = ~x79 & (x78 | (~x04 & x83));
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((x81 ^ x84) | (x77 ? (x78 | ~x83) : ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n254_ | (x77 & (new_n253_ | (new_n252_ & x04))));
  assign new_n252_ = ~x42 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n253_ = x79 & x81 & (x78 ? ~x04 : (x83 & x84));
  assign new_n254_ = x78 & ((x04 & ~x79) | (~x77 & x79 & x81 & x84));
  assign z63 = ~x01 & x79 & ~new_n250_ & x82;
  assign z64 = ~x01 & ((new_n257_ & x79) | (x78 & ~x79 & x04 & ~x77));
  assign new_n257_ = x83 & ((~x04 & x77 & x78) | ((~x81 ^ x84) & (~x77 ^ ~x78)));
  assign z65 = ~x01 & new_n259_ & x79;
  assign new_n259_ = x84 & (x77 ? (x78 ? ~x04 : (x81 & x83)) : (x78 & x81));
endmodule
