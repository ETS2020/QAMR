...
module FAU ( 
  ...
  assign new_n54_ = (~x02 | ~x03) & ((~new_n55_ & (x20 | x31)) | (~x15 & ~x20 & x31));
  ...
  assign new_n59_ = ~new_n60_ & ((~x15 & ~x20 & x31) | (~new_n55_ & (x20 | (x15 & x31))));
  assign new_n60_ = (~x29 | (x27 & x28)) & (~x27 | ~x28 | x29);
  assign z6 = x01 & x25 & ~x26 & new_n62_ & (~x02 | ~x03);
  assign new_n62_ = ~new_n63_ & ((~x15 & ~x20 & x31) | (~new_n55_ & (x20 | (x15 & x31))));
  ...
  assign new_n67_ = (x16 | x21) & (x20 | (x15 & x31));
  assign new_n68_ = (~x31 | (x29 & x30 & x27 & x28)) & (~x20 | ~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign z8 = x00 & ~x26 & ((x20 & ~x31 & x32) | (~new_n70_ & x31));
  ...
  assign new_n81_ = (new_n74_ | (~x20 & ~x31)) & (~x20 | x31 | (~x30 & (new_n79_ | ~x29))) & (~x31 | (~new_n79_ & x29 & x30));
  assign new_n82_ = (~x20 | x30 | x31 | (~new_n79_ & x29)) & (~x29 | ~x30 | new_n79_ | ~x31);
endmodule
