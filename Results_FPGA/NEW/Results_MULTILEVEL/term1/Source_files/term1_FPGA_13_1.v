...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (x25 | ~x31)) | (~x31 & (new_n65_ | ~x25)) | (x25 & ~new_n65_ & x31);
  assign new_n62_ = ~new_n63_ & x01 & ~x26 & (~x02 | ~x03);
  assign new_n63_ = (x19 | x24) & new_n64_ & (x18 | x23);
  assign new_n64_ = (x17 | x22) & (x16 | x21) & (x15 | x20);
  assign new_n65_ = x29 & x30 & x27 & x28;
  assign z8 = x00 & ~x26 & (new_n79_ | ((new_n67_ | ~new_n72_) & x25));
  ...
  assign new_n81_ = (new_n74_ | (~x25 & x31)) & (x31 | (~x30 & (new_n71_ | ~x29))) & (~x25 | ~x31 | (~new_n71_ & x29 & x30));
  assign new_n82_ = (~x25 | ~x29 | ~x30 | new_n71_ | ~x31) & (x30 | x31 | (~new_n71_ & x29));
endmodule
