...
module FAU ( 
  ...
  assign new_n50_ = ~x09 & ((~new_n51_ & (x04 ? x07 : (~x07 & ~x14))) | (~new_n52_ & (x04 ? ~x07 : (x07 & ~x14))));
  ...
  assign z8 = x00 & ~x26 & (~new_n79_ | ((new_n70_ | ~new_n75_) & ~new_n47_));
  ...
  assign z9 = x00 & ~x26 & (~new_n93_ | ((new_n87_ | ~new_n89_) & ~new_n47_));
