// Benchmark "FAU" written by ABC on Sat Aug  8 22:32:20 2020
...
module FAU ( 
  ...
  assign new_n59_ = ~new_n53_ & ~new_n60_ & (~x02 | ~x03);
  assign new_n60_ = x29 ? ((~x30 | (x27 & x28)) & (~x27 | ~x28 | x30)) : ~x30;
  assign z7 = (~new_n62_ & (x06 | x31)) | (x31 & (~new_n65_ | ~x29 | ~x30)) | (new_n65_ & x06 & x29 & x30 & ~x31);
  ...
  assign z8 = x00 & ~x26 & ((x06 & ~x31 & x32) | (~new_n67_ & x31));
  ...
  assign new_n78_ = (new_n71_ | (~x06 & ~x31)) & (~x06 | x31 | (~x30 & (new_n76_ | ~x29))) & (~x31 | (~new_n76_ & x29 & x30));
  assign new_n79_ = (~x06 | x30 | x31 | (~new_n76_ & x29)) & (~x29 | ~x30 | new_n76_ | ~x31);
endmodule
