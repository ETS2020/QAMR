// Benchmark "FAU" written by ABC on Sat Aug  8 22:32:40 2020
...
module FAU ( 
  ...
  assign new_n54_ = ((~x23 & x31) | (new_n55_ & new_n56_)) & (x18 | x23 | x31);
  ...
  assign z7 = (~new_n64_ & (x23 | ~x31)) | (x23 & (new_n63_ | (~new_n65_ & x31))) | (~x31 & (new_n65_ | (new_n63_ & x18)));
  assign new_n63_ = (x19 | x24) & new_n55_ & (x17 | x22);
  assign new_n64_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign new_n65_ = x29 & x30 & x27 & x28;
  assign z8 = x00 & ~x26 & (new_n79_ | ((new_n67_ | ~new_n72_) & x23));
