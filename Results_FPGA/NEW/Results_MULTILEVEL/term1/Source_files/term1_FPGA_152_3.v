...
module FAU ( 
  ...
  assign new_n54_ = (x15 | x20) & ((new_n55_ & new_n56_) | (x15 & x31));
  ...
  assign z7 = ((~x15 | ~x31) & (~new_n64_ | (new_n63_ & x20))) | (~x15 & ~new_n65_ & x31) | (~x31 & (new_n65_ | (new_n63_ & x15)));
  assign new_n63_ = (x19 | x24) & new_n55_ & (x18 | x23);
  assign new_n64_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign new_n65_ = x27 & x28 & x29 & x30;
  assign z8 = x00 & ~x26 & ((~new_n67_ & ~x15) | (~x31 & x32));
  ...
  assign new_n71_ = x32 & (~new_n72_ | ~x10 | ~x16);
  assign new_n72_ = x17 & x18 & x19;
  assign new_n73_ = ~x27 & ~x28;
  assign z9 = x00 & ~x26 & (new_n75_ | ~new_n79_);
  assign new_n75_ = (new_n73_ | ~x29) & (x15 ? (new_n77_ & ~x30) : ~new_n76_);
  assign new_n76_ = (~x31 | ~x33) & (~new_n69_ | ~x19 | x30 | x31 | x33);
  assign new_n77_ = ~x31 & ~x33 & ((~new_n78_ & x16) | (new_n72_ & x11 & ~x16));
  assign new_n78_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x18 | ~x19 | ~x12 | x17);
  assign new_n79_ = ~new_n80_ & (~x33 | (~new_n85_ & (x31 | (new_n83_ & ~new_n87_))));
  assign new_n80_ = x29 & ~new_n73_ & ((new_n81_ & new_n82_) | (~x31 & x33));
  assign new_n81_ = x16 & x17 & x10 & ~x15;
  assign new_n82_ = x18 & x19 & x30 & x31 & ~x33;
  assign new_n83_ = (x19 | (x16 & x17 & x18)) & new_n84_ & (x16 | (x11 & x17 & x18));
  assign new_n84_ = (x17 | (x12 & x18)) & ~x30 & (x13 | x18);
  assign new_n85_ = ~x15 & (~x10 | ~x16 | ~x17 | ~new_n86_ | ~x18);
  assign new_n86_ = x19 & (x30 | ~x31);
