...
module FAU ( 
  ...
  assign new_n54_ = (x15 | x20) & ((new_n55_ & new_n56_) | (x20 & x31));
  ...
  assign z7 = ((~x20 | ~x31) & (~new_n64_ | (new_n63_ & x15))) | (~x20 & ~new_n65_ & x31) | (~x31 & (new_n65_ | (new_n63_ & x20)));
  assign new_n63_ = (x19 | x24) & new_n55_ & (x18 | x23);
  assign new_n64_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign new_n65_ = x27 & x28 & x29 & x30;
  assign z8 = x00 & ~x26 & (new_n79_ | (~x20 & (new_n67_ | ~new_n72_)));
  ...
  assign new_n81_ = (new_n74_ | (x20 & x31)) & (x31 | (~x30 & (new_n71_ | ~x29))) & (x20 | ~x31 | (~new_n71_ & x29 & x30));
  assign new_n82_ = (x20 | ~x29 | ~x30 | new_n71_ | ~x31) & (x30 | x31 | (~new_n71_ & x29));
endmodule
