...
module FAU ( 
  ...
  assign z7 = (~new_n64_ & (x17 | ~x31)) | (x17 & (new_n63_ | (~new_n65_ & x31))) | (~x31 & (new_n65_ | (new_n63_ & x22)));
  assign new_n63_ = (x19 | x24) & new_n55_ & (x18 | x23);
  assign new_n64_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign new_n65_ = x29 & x30 & x27 & x28;
  assign z8 = x00 & ~x26 & ((~x31 & x32) | (~new_n67_ & x17));
  ...
  assign new_n69_ = (~x16 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x11 | x16 | ~x18 | ~x19);
  assign new_n70_ = x16 & x18 & x19;
  assign new_n71_ = (~x15 | ~x16 | ~x18 | (x14 & ~x19)) & new_n72_ & (x19 | (x15 & x16 & x18));
  assign new_n72_ = (x15 | (x10 & x16 & x18)) & (x16 | (x11 & x18)) & (x13 | x18);
  assign new_n73_ = ~x27 & ~x28;
  assign z9 = x00 & ~x26 & (x33 ? (new_n75_ | ~new_n77_) : ~new_n82_);
  assign new_n75_ = ~new_n76_ & (x17 | ~x31);
  assign new_n76_ = new_n72_ & (x19 | (x15 & x16 & x18));
  assign new_n77_ = ~new_n78_ & (x31 | (new_n80_ & ~new_n81_));
  assign new_n78_ = x17 & (new_n79_ | (x31 & (new_n73_ | ~x29 | ~x30)));
  assign new_n79_ = x15 & x16 & x18 & (~x14 | x19);
  assign new_n80_ = ~x30 & (x17 | (new_n70_ & x12 & x15));
  assign new_n81_ = x29 & (x27 | x28);
  assign new_n82_ = (x30 | ~new_n83_ | x31) & (~x17 | ~x29 | ~x30 | ~new_n87_ | ~x31);
  assign new_n83_ = ~new_n81_ & (new_n86_ | (x15 & (new_n85_ | (~new_n84_ & x16))));
  assign new_n84_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n85_ = x17 & x18 & x19 & x11 & ~x16;
  assign new_n86_ = x17 & x18 & x19 & x10 & ~x15 & x16;
  assign new_n87_ = ~new_n73_ & ((~new_n69_ & x15) | (new_n70_ & x10 & ~x15));
endmodule
