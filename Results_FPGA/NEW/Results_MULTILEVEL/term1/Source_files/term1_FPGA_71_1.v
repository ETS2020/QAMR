...
module FAU ( 
  ...
  assign new_n49_ = x01 ? ((~x05 & x31) | (~x02 ^ x03)) : (((x05 ? ~x03 : x31) | (~x02 & x06)) & (x02 | x03 | ~x05 | ~x06));
  assign new_n50_ = x01 ? ((~x05 & x31) | (~x02 ^ ~x03)) : ((x02 | ~x06 | (x05 ? ~x03 : x31)) & (x03 | ~x05 | (~x02 & x06)));
  ...
  assign z7 = (~new_n62_ & (x05 | ~x31)) | (x05 & x31 & (~new_n65_ | ~x29 | ~x30)) | (new_n65_ & x29 & x30 & ~x31);
  ...
  assign z8 = x00 & ~x26 & (new_n79_ | ((new_n67_ | ~new_n72_) & x05));
  ...
  assign new_n81_ = (new_n74_ | (~x05 & x31)) & (x31 | (~x30 & (new_n71_ | ~x29))) & (~x05 | ~x31 | (~new_n71_ & x29 & x30));
  assign new_n82_ = (~x05 | ~x29 | ~x30 | new_n71_ | ~x31) & (x30 | x31 | (~new_n71_ & x29));
endmodule
