...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (~x09 | ~x31)) | (~x09 & x31 & (~new_n65_ | ~x29 | ~x30)) | (new_n65_ & x29 & x30 & ~x31);
  ...
  assign z8 = x00 & ~x26 & (new_n79_ | (~x09 & (new_n67_ | ~new_n72_)));
  ...
  assign new_n81_ = (new_n74_ | (x09 & x31)) & (x31 | (~x30 & (new_n71_ | ~x29))) & (x09 | ~x31 | (~new_n71_ & x29 & x30));
  assign new_n82_ = (x09 | ~x29 | ~x30 | new_n71_ | ~x31) & (x30 | x31 | (~new_n71_ & x29));
endmodule
