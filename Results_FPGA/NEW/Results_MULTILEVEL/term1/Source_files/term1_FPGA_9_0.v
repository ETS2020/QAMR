// Benchmark "FAU" written by ABC on Sat Aug  8 22:31:30 2020
...
module FAU ( 
  ...
  assign new_n54_ = (~x02 | ~x03) & (new_n55_ | (~x16 & ~x21 & x31));
  assign new_n55_ = ~new_n47_ & (~new_n56_ | (~x15 & ~x20) | (~x17 & ~x22));
  assign new_n56_ = (x18 | x23) & (x19 | x24);
  assign z4 = x01 & x25 & ~x26 & new_n54_ & (x27 ^ x28);
  assign z5 = x01 & x25 & new_n59_ & ~x26;
  assign new_n59_ = (~x02 | ~x03) & ~new_n60_ & (((~x27 | ~x28) & x29) | (x27 & x28 & ~x29));
  assign new_n60_ = (x15 | ((x20 | (~x21 & ~x31)) & (new_n61_ | ~x31))) & (x16 | x21 | ~x31) & (new_n61_ | (~x21 & (~x16 | ~x31)));
  assign new_n61_ = (x17 | x22) & (x18 | x23) & (x19 | x24);
  assign z6 = x01 & x25 & ~x26 & new_n63_ & (~x02 | ~x03);
  assign new_n63_ = ~new_n60_ & (x29 ? ((x30 & (~x27 | ~x28)) | (x27 & x28 & ~x30)) : x30);
  ...
  assign new_n67_ = (x15 | x20) & (x21 | (x16 & x31));
  assign new_n68_ = (~x31 | (x29 & x30 & x27 & x28)) & (~x29 | ~x30 | x31 | ~x21 | ~x27 | ~x28);
  assign z8 = x00 & ~x26 & ((x21 & ~x31 & x32) | (~new_n70_ & x31));
  assign new_n70_ = (~x29 | new_n79_ | (x30 ? ~x32 : (new_n71_ | x32))) & ((~new_n79_ & x29) | (x30 ? (new_n71_ | x32) : ~x32)) & (new_n74_ | ~x32);
  ...
  assign new_n77_ = x17 & x18 & x10 & x16;
  assign new_n78_ = (x16 | (x11 & x17 & x18)) & (x13 | x18) & (x17 | (x12 & x18));
  assign new_n79_ = ~x27 & ~x28;
  assign z9 = x00 & ~x26 & (x33 ? ~new_n81_ : (~new_n71_ & ~new_n82_));
  assign new_n81_ = (new_n74_ | (~x21 & ~x31)) & (~x21 | x31 | (~x30 & (new_n79_ | ~x29))) & (~x31 | (~new_n79_ & x29 & x30));
  assign new_n82_ = (~x21 | x30 | x31 | (~new_n79_ & x29)) & (~x29 | ~x30 | new_n79_ | ~x31);
endmodule
