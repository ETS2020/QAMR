// Benchmark "FAU" written by ABC on Sat Aug  8 22:31:37 2020
...
module FAU ( 
  ...
  assign z0 = ~x32 & (x22 | x31);
  assign z1 = (x22 | x31) & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  assign z2 = x08 & new_n49_ & ~x09;
  assign new_n49_ = (x22 | x31) & ((~new_n50_ & (x04 ^ ~x07)) | (~new_n51_ & (x04 ^ x07)));
  ...
  assign new_n54_ = ((~x22 & ~x31) | (new_n55_ & new_n56_)) & (x17 | x22 | ~x31);
  ...
  assign z7 = ~new_n63_ | (~new_n66_ & (x22 | x31));
  assign new_n63_ = new_n65_ & (~new_n64_ | (~x19 & ~x24));
  assign new_n64_ = (x18 | x23) & new_n55_ & (x22 | (x17 & x31));
  assign new_n65_ = (~x31 | (x27 & x28 & x29 & x30)) & (~x29 | ~x30 | x31 | ~x22 | ~x27 | ~x28);
  assign new_n66_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign z8 = x00 & ~x26 & ((x22 & ~x31 & x32) | (~new_n68_ & x31));
  ...
  assign new_n79_ = (new_n72_ | (~x22 & ~x31)) & (~x22 | x31 | (~x30 & (new_n77_ | ~x29))) & (~x31 | (~new_n77_ & x29 & x30));
  assign new_n80_ = (~x22 | x30 | x31 | (~new_n77_ & x29)) & (~x29 | ~x30 | new_n77_ | ~x31);
endmodule
