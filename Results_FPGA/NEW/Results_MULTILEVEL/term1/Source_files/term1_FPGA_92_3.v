...
module FAU ( 
  ...
  assign new_n54_ = (x16 | x21) & ((new_n55_ & new_n56_) | (x16 & x31));
  ...
  assign new_n81_ = x11 & x15 & ~x16 & x17;
  ...
  assign new_n86_ = (x17 | (x12 & x18)) & ~x30 & (x13 | x18);
  assign new_n87_ = ~x16 & (~new_n88_ | ~x11 | ~x15 | ~x17);
