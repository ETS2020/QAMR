...
module FAU ( 
  ...
  assign z7 = (~x26 & (new_n66_ | ~new_n64_ | (new_n62_ & x21))) | (x16 & (new_n62_ | x26));
  assign new_n62_ = new_n63_ & (x19 | x24);
  assign new_n63_ = (x18 | x23) & (x17 | x22) & (x15 | x20);
  assign new_n64_ = new_n65_ & x01 & (~x02 | ~x03);
