...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n53_, new_n54_, new_n55_, new_n56_,
    ...
    new_n84_, new_n85_;
  assign z0 = x22 & ~x32;
  assign z1 = (x02 & (x03 ? (x32 & ~x33) : (x22 & ~x32))) | (~x02 & (x03 ? (x22 & ~x32) : (x32 & ~x33))) | (x22 & ~x32 & ~x33);
  assign z2 = x08 & new_n49_ & ~x09;
  assign new_n49_ = (x22 | x32) & ((~new_n50_ & (~x04 ^ x07)) | (~new_n51_ & (~x04 ^ ~x07)));
  ...
  assign new_n54_ = ((~x22 & ~x32) | (new_n55_ & new_n56_)) & (x17 | x22 | ~x32);
  ...
  assign z7 = (~new_n63_ & (x22 | x32)) | (new_n66_ & (x19 | x24));
  assign new_n63_ = ~new_n64_ & x01 & (~x02 | ~x03) & new_n65_ & x25;
  assign new_n64_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign new_n65_ = ~x26 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n66_ = (x18 | x23) & new_n55_ & (x22 | (x17 & x32));
  assign z8 = x00 & ~x26 & (new_n73_ | new_n75_ | (new_n68_ & x29));
  assign new_n68_ = ~new_n72_ & ((x22 & ~x30 & x31 & ~new_n69_ & ~x32) | (x30 & x32));
  ...
  assign new_n73_ = ~new_n74_ & ((x22 & x30 & x31 & ~new_n69_ & ~x32) | (~x30 & x32));
  assign new_n74_ = ~new_n72_ & x29;
  assign new_n75_ = x32 & (new_n78_ | new_n79_ | ~new_n76_ | new_n80_);
  assign new_n76_ = ~new_n77_ & (x17 | (x12 & x18)) & x31 & (x13 | x18);
  ...
  assign z9 = x00 & ~x26 & (x22 | x32) & (new_n82_ | ~new_n83_);
  assign new_n82_ = x29 & ~new_n72_ & (x30 ? (x31 & ~new_n69_ & ~x33) : x33);
  assign new_n83_ = (new_n74_ | (x30 ? ~x33 : (x31 | new_n69_ | x33))) & (new_n84_ | ~x33);
  assign new_n84_ = ~new_n78_ & ~new_n79_ & ~new_n80_ & ~new_n77_ & new_n85_;
