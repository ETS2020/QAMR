...
module FAU ( 
  ...
  assign new_n50_ = ~x09 & ((~new_n51_ & (x04 ? x07 : (~x07 & x28))) | (~new_n52_ & (x04 ? ~x07 : (x07 & x28))));
  ...
  assign new_n58_ = ~new_n55_ & (~x02 | ~x03) & ((~x27 & x28) | (x04 & x27 & ~x28));
  assign z5 = x01 & x25 & ~x26 & new_n60_ & (~x02 | ~x03);
  assign new_n60_ = ~new_n55_ & ((x28 & (~x27 ^ ~x29)) | (x04 & ~x28 & x29));
  assign z6 = x01 & x25 & ~x26 & new_n62_ & (~x02 | ~x03);
  assign new_n62_ = ~new_n55_ & ((x28 & (x27 ? (x29 ^ x30) : x30)) | (x04 & ~x28 & x30));
  assign z7 = (~new_n64_ & (x28 | (x04 & ~x31))) | (~new_n67_ & x28) | (x04 & ~x28 & x31);
  ...
  assign new_n67_ = (~x31 | (x27 & x29 & x30)) & (~x30 | x31 | ~x27 | ~x29);
  ...
  assign new_n89_ = (~x04 | (x27 ? (~x29 | x30) : (x28 | ~x30))) & (~x28 | ~x29 | x30);
  assign new_n90_ = (~x04 | (x27 ? (~x29 | ~x30) : (x28 | x30))) & (~x28 | ~x29 | ~x30);
  ...
  assign new_n98_ = (~x04 | ((~x30 | ~x31 | ~x27 | ~x29) & (x27 | x28 | x30 | x31))) & (~x28 | ~x29 | ~x30 | ~x31);
endmodule
