...
module FAU ( 
  ...
  assign new_n69_ = (new_n76_ | (x30 ? (~x31 | new_n66_ | x32) : ~x32)) & (new_n70_ | ~x32);
  assign new_n70_ = ~new_n71_ & ~new_n72_ & ~new_n73_ & ~new_n74_ & new_n75_;
  assign new_n71_ = x16 & x17 & x18 & x19 & (~x10 | x15);
  assign new_n72_ = ~x15 & (~x16 | ~x17 | ~x18 | ~x19);
  assign new_n73_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign new_n74_ = ~x17 & (~x12 | ~x18 | ~x19);
  assign new_n75_ = (x18 | (x13 & x19)) & (x14 | x19) & x31;
  assign new_n76_ = x29 & (x27 | x28);
  assign z9 = x00 & ~x26 & (~new_n79_ | (new_n78_ & x29));
  assign new_n78_ = (x27 | x28) & (x30 ? (x31 & ~new_n66_ & ~x33) : x33);
  assign new_n79_ = (new_n80_ | ~x33) & (new_n76_ | (x30 ? ~x33 : (x31 | new_n66_ | x33)));
  assign new_n80_ = ~new_n71_ & ~new_n72_ & ~new_n73_ & ~new_n74_ & new_n81_;
  assign new_n81_ = (x18 | (x13 & x19)) & (x14 | x19) & (x30 | ~x31) & (~x30 | x31);
  assign z0 = ~x32;
endmodule
