...
module FAU ( 
  ...
  assign z02 = new_n49_ | (x00 & ~new_n47_ & x19);
  assign new_n47_ = new_n48_ & ~x01 & ~x02 & ~x03;
  assign new_n48_ = ~x06 & ~x07 & ~x04 & ~x05;
  assign new_n49_ = new_n50_ & ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n50_ = ~x05 & ~x06 & ~x07 & x08 & ~x09;
  assign z04 = x20 | x21;
  assign z05 = x10 | (new_n53_ & ~x01 & ~x02 & ~x03 & ~x04);
  assign new_n53_ = ~x05 & ~x06 & ~x07 & ~x08 & x19;
  assign z06 = new_n55_ | (x19 & (~x00 | (~new_n47_ & x00)));
  assign new_n55_ = ~x01 & ~x02 & new_n56_ & ~x03;
  assign new_n56_ = ~x04 & ~x05 & ~x06 & ~x07 & (x08 | (~x08 & x19));
  assign z07 = x18 & x24;
  assign z09 = x11 & x24;
