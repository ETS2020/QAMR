// Benchmark "FAU" written by ABC on Wed Jul 29 03:32:22 2020
...
module FAU ( 
  ...
  assign new_n45_ = ~x05 & ~x06 & ~x07 & (x08 ? (x09 & x19) : ~x09);
  ...
  assign z04 = x20 | x21;
  assign z05 = new_n53_ | x10;
  assign new_n53_ = new_n50_ & ~x07 & ~x08 & ~x05 & ~x06;
  assign z06 = new_n53_ | (~new_n55_ & x19);
  assign new_n55_ = (x01 | x02 | ~new_n56_ | x03) & x00 & (~x00 | (new_n48_ & ~x01 & ~x02 & ~x03));
  assign new_n56_ = ~x04 & ~x05 & ~x06 & ~x07 & x08;
  assign z07 = x18 & x24;
  assign z09 = x11 & x24;
