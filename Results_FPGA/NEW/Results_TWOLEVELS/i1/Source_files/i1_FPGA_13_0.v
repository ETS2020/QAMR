// Benchmark "FAU" written by ABC on Wed Jul 29 03:32:12 2020
...
module FAU ( 
  ...
  assign z01 = (~x01 & ~x02 & new_n44_ & ~x03) | (~x00 & x19);
  assign new_n44_ = ~x04 & ~x05 & ~x06 & ~x07 & (~x08 ^ x09);
  assign z02 = (x00 & x19 & (~new_n46_ | ~new_n47_)) | (new_n48_ & new_n49_);
  ...
  assign z04 = x20 | x21;
  assign z05 = x10 | (new_n48_ & ~x05 & ~x06 & ~x07 & ~x08);
  assign z06 = (new_n53_ & ~x01) | (x19 & (~x00 | (x00 & (~new_n46_ | ~new_n47_))));
