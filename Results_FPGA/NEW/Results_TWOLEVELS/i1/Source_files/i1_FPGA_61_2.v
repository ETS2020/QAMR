// Benchmark "FAU" written by ABC on Wed Jul 29 03:32:28 2020
...
module FAU ( 
  ...
  assign z01 = x00 ? (~x01 & ~x02 & new_n44_ & ~x03) : x19;
  ...
  assign z04 = x20 | x21;
  assign z05 = x10 | (new_n52_ & ~x01 & ~x02 & ~x03 & ~x04);
  assign new_n52_ = ~x05 & ~x06 & ~x07 & ~x08 & x19;
  assign z06 = x00 | (~x00 & x19);
  assign z07 = x18 & x24;
  assign z09 = x11 & x24;
