...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n53_, new_n58_, new_n59_, new_n60_, new_n61_,
    new_n62_, new_n63_, new_n67_, new_n69_, new_n71_, new_n73_, new_n75_,
  ...
  assign z10 = ~x07 & ~x15 & ~x17 & (~x19 | (~new_n51_ & x19));
  assign z11 = new_n67_ & ~x07;
  assign new_n67_ = ~x15 & ((~x04 & (x17 ? (~x18 & x19) : x18)) | (~x05 & (x17 ^ x18)));
  assign z12 = new_n69_ & ~x07;
  assign new_n69_ = ~x15 & ((x19 & ((~x04 & (~x17 | (x17 & ~x18))) | (~x05 & (~x17 | ~x18)))) | (x17 & x18 & ~x19));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n71_ | (new_n51_ & new_n71_) | (x17 & x18 & x19 & ~x20);
  assign new_n71_ = ~x07 & ~x15;
  assign z14 = (~new_n62_ & x21) | ~new_n71_ | new_n73_ | (new_n51_ & new_n71_);
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n73_ & x22) | ~new_n71_ | new_n75_ | (new_n51_ & new_n71_);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n75_ & x23) | ~new_n71_ | new_n77_ | (new_n51_ & new_n71_);
  assign new_n77_ = new_n78_ & x17 & x18 & x19;
  assign new_n78_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (x17 & new_n81_ & x18) | ~new_n80_ | (~new_n77_ & x24);
  assign new_n80_ = ~x07 & ~x15 & (~new_n51_ | x07 | x15);
  assign new_n81_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n83_ | ~new_n71_ | new_n84_ | (new_n51_ & new_n71_);
  assign new_n83_ = x25 & (~new_n62_ | x21 | x22 | x23 | x24);
  assign new_n84_ = new_n62_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z02 = x16;
endmodule
