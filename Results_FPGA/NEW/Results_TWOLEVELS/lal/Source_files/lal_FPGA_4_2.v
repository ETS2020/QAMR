// Benchmark "FAU" written by ABC on Wed Jul 29 04:25:21 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n52_, new_n57_, new_n62_, new_n64_, new_n67_, new_n68_,
    new_n70_, new_n71_;
  assign z00 = x08 & ~x16;
  ...
  assign z13 = (x17 & x18 & x19 & ~x20) | ~new_n64_ | (x20 & (~x17 | ~x18 | ~x19));
  assign new_n64_ = ~x07 & ~x15 & (~x04 | ~x05 | x07 | x15);
  assign z14 = (x17 & x18 & x19 & ~x20 & ~x21) | ~new_n64_ | (x21 & (~x17 | ~x18 | ~x19 | x20));
  assign z15 = new_n67_ | x07 | x15 | new_n68_ | (x04 & x05 & ~x07 & ~x15);
  assign new_n67_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n68_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (x19 & (new_n70_ | new_n71_)) | ~new_n64_ | (x23 & (~x19 | x20));
  assign new_n70_ = ~x07 & ~x15 & (~x04 | ~x05) & (~x17 | ~x18);
  assign new_n71_ = x17 & x18 & ~x20 & (x21 | (~x21 & x22));
