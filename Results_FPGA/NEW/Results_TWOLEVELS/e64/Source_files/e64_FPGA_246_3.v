// Benchmark "FAU" written by ABC on Wed Jul 29 04:00:41 2020
...
module FAU ( 
  ...
  assign z02 = ~x63 & ~x62 & new_n151_ & ~x61 & ~x64;
  assign new_n151_ = ~x60 & ~x58 & ~x57 & new_n152_ & ~x56 & ~x59;
  assign new_n152_ = ~x55 & ~x53 & ~x52 & new_n153_ & ~x51 & ~x54;
  assign new_n153_ = ~x50 & ~x48 & ~x47 & new_n154_ & ~x46 & ~x49;
  assign new_n154_ = ~x45 & ~x43 & ~x42 & new_n155_ & ~x41 & ~x44;
  assign new_n155_ = ~x40 & ~x38 & ~x37 & new_n156_ & ~x36 & ~x39;
  assign new_n156_ = ~x35 & ~x33 & ~x32 & new_n157_ & ~x31 & ~x34;
  assign new_n157_ = ~x30 & x29 & ~x28 & x27 & new_n158_ & ~x26;
  assign new_n158_ = ~x25 & ~x23 & ~x22 & new_n159_ & ~x21 & ~x24;
  ...
  assign new_n179_ = ~x37 & ~x36 & new_n169_ & ~x35 & x38;
  assign z09 = ~x63 & ~x62 & new_n181_ & ~x61 & ~x64;
  ...
  assign new_n234_ = ~x26 & ~x24 & ~x22 & new_n235_ & ~x18 & ~x25;
  assign new_n235_ = ~x14 & ~x11 & new_n236_ & ~x10 & ~x15;
  assign new_n236_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  assign z21 = ~x62 & ~x60 & new_n238_ & ~x58;
  assign new_n238_ = ~x56 & ~x47 & ~x46 & new_n239_ & ~x43 & ~x50;
  assign new_n239_ = ~x41 & ~x39 & ~x37 & new_n240_ & ~x30 & ~x40;
  assign new_n240_ = x29 & ~x26 & ~x25 & new_n241_ & ~x24 & ~x28;
  assign new_n241_ = ~x22 & ~x15 & ~x14 & new_n242_ & ~x11 & ~x18;
  assign new_n242_ = ~x10 & ~x07 & ~x06 & x00 & ~x03 & ~x08;
  assign z22 = ~x64 & new_n244_ & ~x63;
  assign new_n244_ = ~x62 & ~x60 & ~x59 & new_n245_ & ~x58 & ~x61;
  assign new_n245_ = ~x57 & ~x55 & ~x54 & new_n246_ & ~x53 & ~x56;
  assign new_n246_ = ~x51 & ~x49 & ~x48 & new_n247_ & ~x47 & ~x50;
  assign new_n247_ = ~x46 & ~x43 & ~x42 & new_n248_ & ~x41 & ~x45;
  assign new_n248_ = ~x40 & ~x39 & ~x37 & x36 & new_n249_ & ~x35;
  assign new_n249_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n250_ & x29;
  assign new_n250_ = ~x28 & ~x25 & ~x24 & new_n251_ & ~x22 & ~x26;
  assign new_n251_ = ~x17 & ~x15 & new_n252_ & ~x14 & ~x18;
  assign new_n252_ = new_n229_ & ~x12;
  assign z23 = ~x63 & ~x62 & new_n254_ & ~x61 & ~x64;
  assign new_n254_ = ~x60 & ~x58 & ~x57 & new_n255_ & ~x56 & ~x59;
  assign new_n255_ = ~x55 & ~x53 & ~x52 & new_n256_ & ~x51 & ~x54;
  ...
  assign new_n260_ = ~x26 & ~x24 & ~x22 & new_n261_ & ~x21 & ~x25;
  assign new_n261_ = ~x18 & ~x17 & x16 & ~x15 & new_n252_ & ~x14;
  assign z24 = ~x60 & ~x50 & ~x46 & new_n263_ & ~x43 & ~x58;
  assign new_n263_ = ~x40 & ~x39 & ~x37 & x29 & new_n264_ & ~x28;
  assign new_n264_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x58 & ~x50 & new_n266_ & ~x46 & ~x60;
  assign new_n266_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n267_ & x29;
  assign new_n267_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z26 = new_n269_ & ~x64;
  assign new_n269_ = ~x63 & ~x61 & ~x60 & new_n270_ & ~x59 & ~x62;
  assign new_n270_ = ~x58 & ~x56 & ~x55 & new_n271_ & ~x54 & ~x57;
  assign new_n271_ = ~x53 & ~x51 & ~x50 & new_n272_ & ~x49 & ~x52;
  ...
  assign new_n276_ = ~x25 & ~x22 & ~x21 & new_n277_ & ~x20 & ~x24;
  assign new_n277_ = ~x18 & ~x17 & new_n160_ & ~x16;
  assign z27 = ~x64 & ~x63 & new_n279_ & ~x62;
  assign new_n279_ = ~x61 & ~x59 & ~x58 & new_n280_ & ~x57 & ~x60;
  assign new_n280_ = ~x56 & ~x54 & ~x53 & new_n281_ & ~x52 & ~x55;
  assign new_n281_ = ~x51 & ~x49 & ~x48 & new_n282_ & ~x47 & ~x50;
  assign new_n282_ = ~x46 & ~x43 & ~x42 & new_n283_ & ~x41 & ~x45;
  assign new_n283_ = ~x40 & ~x37 & ~x36 & new_n284_ & ~x35 & ~x39;
  assign new_n284_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n285_ & x29;
  assign new_n285_ = ~x28 & ~x25 & ~x24 & new_n286_ & ~x22 & ~x26;
  assign new_n286_ = ~x21 & ~x18 & ~x17 & new_n287_ & ~x16 & ~x20;
  assign new_n287_ = ~x15 & ~x14 & x13 & new_n229_ & ~x12;
  assign z28 = ~x60 & ~x58 & new_n289_ & ~x50;
  assign new_n289_ = ~x46 & ~x40 & ~x39 & new_n290_ & ~x37 & ~x43;
  assign new_n290_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = ~x58 & ~x50 & new_n292_ & ~x46 & x60;
  assign new_n292_ = ~x43 & ~x40 & new_n203_ & ~x39;
  assign z30 = ~x63 & ~x62 & new_n294_ & ~x61 & ~x64;
  assign new_n294_ = ~x60 & ~x58 & ~x57 & new_n295_ & ~x56 & ~x59;
  assign new_n295_ = ~x55 & ~x54 & ~x53 & x52 & new_n296_ & ~x51;
  assign new_n296_ = ~x50 & ~x48 & ~x47 & new_n297_ & ~x46 & ~x49;
  assign new_n297_ = ~x45 & ~x42 & ~x41 & new_n298_ & ~x40 & ~x43;
  assign new_n298_ = ~x39 & ~x36 & ~x35 & new_n299_ & ~x34 & ~x37;
  assign new_n299_ = ~x33 & ~x31 & ~x30 & x29 & new_n300_ & ~x28;
  assign new_n300_ = ~x26 & ~x24 & ~x22 & new_n251_ & ~x21 & ~x25;
  assign z31 = ~x64 & ~x63 & new_n302_ & ~x62;
  assign new_n302_ = ~x61 & ~x59 & ~x58 & new_n303_ & ~x57 & ~x60;
  assign new_n303_ = ~x56 & ~x54 & ~x53 & new_n304_ & ~x51 & ~x55;
  assign new_n304_ = ~x50 & ~x48 & ~x47 & new_n305_ & ~x46 & ~x49;
  assign new_n305_ = ~x45 & ~x42 & ~x41 & new_n306_ & ~x40 & ~x43;
  assign new_n306_ = ~x39 & ~x36 & ~x35 & new_n307_ & ~x34 & ~x37;
  ...
  assign new_n314_ = ~x58 & ~x55 & ~x51 & new_n315_ & ~x50 & ~x56;
  assign new_n315_ = ~x47 & ~x43 & ~x41 & new_n316_ & ~x40 & ~x46;
  assign new_n316_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n317_ & x29;
  assign new_n317_ = ~x28 & ~x25 & ~x24 & new_n318_ & ~x22 & ~x26;
  assign new_n318_ = ~x18 & ~x14 & ~x11 & new_n319_ & ~x10 & ~x15;
  assign new_n319_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n321_ & ~x62;
  assign new_n321_ = x61 & ~x58 & ~x56 & new_n322_ & ~x55 & ~x60;
  assign new_n322_ = ~x51 & ~x47 & ~x46 & new_n323_ & ~x43 & ~x50;
  assign new_n323_ = ~x41 & ~x39 & ~x37 & new_n233_ & ~x35 & ~x40;
  assign z37 = ~x64 & new_n325_ & ~x63;
  assign new_n325_ = ~x62 & ~x60 & ~x59 & new_n326_ & ~x58 & ~x61;
  assign new_n326_ = ~x57 & ~x55 & ~x54 & new_n327_ & ~x53 & ~x56;
  assign new_n327_ = ~x52 & ~x50 & ~x49 & new_n328_ & ~x48 & ~x51;
  assign new_n328_ = ~x47 & ~x45 & ~x43 & new_n329_ & ~x42 & ~x46;
  assign new_n329_ = ~x41 & ~x39 & ~x37 & new_n330_ & ~x36 & ~x40;
  assign new_n330_ = ~x35 & ~x33 & ~x32 & new_n331_ & ~x31 & ~x34;
  assign new_n331_ = ~x30 & ~x28 & ~x26 & new_n332_ & ~x25 & x29;
  assign new_n332_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n277_ & x19;
  assign z38 = ~x62 & ~x61 & new_n334_ & ~x60;
  assign new_n334_ = x59 & ~x56 & ~x55 & new_n335_ & ~x51 & ~x58;
  assign new_n335_ = ~x50 & ~x46 & ~x43 & new_n336_ & ~x42 & ~x47;
  assign new_n336_ = ~x41 & ~x40 & new_n337_ & ~x39;
  assign new_n337_ = ~x37 & ~x35 & ~x30 & x29 & new_n338_ & ~x28;
  assign new_n338_ = ~x26 & ~x24 & ~x22 & new_n339_ & ~x18 & ~x25;
  assign new_n339_ = ~x14 & ~x11 & new_n340_ & ~x10 & ~x15;
  assign new_n340_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n342_ & ~x61;
  assign new_n342_ = ~x60 & ~x56 & ~x55 & new_n343_ & ~x51 & ~x58;
  ...
  assign new_n348_ = ~x39 & ~x35 & ~x34 & new_n349_ & ~x33 & ~x37;
  assign new_n349_ = ~x30 & x29 & ~x28 & new_n350_ & ~x26;
  assign new_n350_ = ~x25 & ~x22 & ~x18 & new_n351_ & ~x17 & ~x24;
  assign new_n351_ = ~x15 & ~x11 & ~x10 & new_n340_ & ~x09 & ~x14;
  assign z41 = ~x62 & ~x60 & ~x59 & new_n353_ & ~x58 & ~x61;
  assign new_n353_ = ~x56 & ~x51 & ~x50 & new_n354_ & ~x47 & ~x55;
  assign new_n354_ = ~x46 & ~x42 & ~x41 & new_n355_ & ~x40 & ~x43;
  assign new_n355_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n349_ & x33;
  assign z42 = ~x62 & new_n357_ & ~x61;
  assign new_n357_ = ~x60 & ~x58 & ~x56 & new_n358_ & ~x55 & ~x59;
  assign new_n358_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n224_ & x49;
  assign z43 = new_n360_ & ~x62;
  assign new_n360_ = ~x61 & ~x59 & ~x58 & new_n361_ & ~x56 & ~x60;
  assign new_n361_ = ~x55 & ~x53 & ~x51 & new_n362_ & ~x50 & ~x54;
  assign new_n362_ = ~x47 & ~x45 & ~x43 & new_n363_ & ~x42 & ~x46;
  assign new_n363_ = ~x41 & ~x39 & ~x37 & new_n364_ & ~x35 & ~x40;
  assign new_n364_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n365_ & x29;
  assign new_n365_ = ~x28 & ~x25 & ~x24 & new_n366_ & ~x22 & ~x26;
  assign new_n366_ = ~x18 & ~x15 & ~x14 & new_n367_ & ~x11 & ~x17;
  assign new_n367_ = ~x10 & ~x08 & ~x07 & new_n368_ & ~x06 & ~x09;
  assign new_n368_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x62 & ~x60 & ~x59 & new_n370_ & ~x58 & ~x61;
  assign new_n370_ = ~x56 & ~x54 & ~x53 & new_n371_ & ~x51 & ~x55;
  assign new_n371_ = ~x50 & ~x46 & ~x45 & new_n372_ & ~x43 & ~x47;
  assign new_n372_ = ~x42 & ~x40 & ~x39 & new_n373_ & ~x37 & ~x41;
  assign new_n373_ = ~x35 & ~x33 & ~x31 & new_n374_ & ~x30 & ~x34;
  assign new_n374_ = x29 & ~x26 & ~x25 & new_n375_ & ~x24 & ~x28;
  assign new_n375_ = ~x22 & ~x17 & ~x15 & new_n376_ & ~x14 & ~x18;
  assign new_n376_ = ~x11 & ~x09 & ~x08 & new_n377_ & ~x07 & ~x10;
  assign new_n377_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x61 & ~x60 & new_n379_ & ~x59 & ~x62;
  assign new_n379_ = ~x58 & ~x55 & ~x51 & new_n380_ & ~x50 & ~x56;
  assign new_n380_ = ~x47 & ~x43 & ~x42 & new_n381_ & ~x41 & ~x46;
  assign new_n381_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n349_ & x34;
  assign z46 = ~x62 & new_n383_ & ~x61;
  assign new_n383_ = ~x60 & ~x58 & ~x56 & new_n384_ & ~x55 & ~x59;
  assign new_n384_ = ~x51 & ~x47 & ~x46 & new_n385_ & ~x43 & ~x50;
  assign new_n385_ = ~x42 & ~x40 & ~x39 & new_n386_ & ~x37 & ~x41;
  assign new_n386_ = ~x35 & ~x30 & x29 & ~x28 & new_n387_ & ~x26;
  assign new_n387_ = ~x25 & ~x22 & ~x18 & new_n388_ & ~x17 & ~x24;
  assign new_n388_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n340_ & x09;
  assign z47 = ~x62 & new_n390_ & ~x61;
  assign new_n390_ = ~x60 & ~x58 & ~x56 & new_n391_ & ~x55 & ~x59;
  assign new_n391_ = ~x51 & ~x47 & ~x46 & new_n392_ & ~x43 & ~x50;
  assign new_n392_ = ~x42 & ~x40 & ~x39 & new_n393_ & ~x37 & ~x41;
  ...
  assign new_n397_ = ~x53 & ~x50 & ~x47 & new_n398_ & ~x46 & ~x51;
  assign new_n398_ = ~x43 & ~x41 & ~x40 & new_n399_ & ~x39 & ~x42;
  assign new_n399_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n349_ & x31;
  assign z49 = ~x61 & ~x60 & new_n401_ & ~x59 & ~x62;
  ...
  assign new_n405_ = ~x59 & ~x56 & ~x55 & new_n406_ & ~x54 & ~x58;
  assign new_n406_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n224_ & x48;
  assign z52 = new_n408_ & ~x64;
  assign new_n408_ = ~x63 & ~x61 & ~x60 & new_n409_ & ~x59 & ~x62;
  assign new_n409_ = ~x58 & ~x56 & ~x55 & new_n410_ & ~x54 & ~x57;
  assign new_n410_ = ~x53 & ~x50 & ~x49 & new_n411_ & ~x48 & ~x51;
  assign new_n411_ = ~x47 & ~x45 & ~x43 & new_n412_ & ~x42 & ~x46;
  assign new_n412_ = ~x41 & ~x39 & ~x37 & new_n413_ & ~x35 & ~x40;
  assign new_n413_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n414_ & x29;
  assign new_n414_ = ~x28 & ~x25 & ~x24 & new_n415_ & ~x22 & ~x26;
  assign new_n415_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n229_ & x12;
  assign z53 = ~x64 & new_n220_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n322_ & x55;
  assign z55 = ~x60 & ~x58 & new_n419_ & ~x56 & ~x62;
  assign new_n419_ = ~x51 & ~x47 & ~x46 & new_n420_ & ~x43 & ~x50;
  assign new_n420_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n233_ & x35;
  assign z56 = ~x64 & ~x62 & ~x61 & new_n422_ & ~x60 & ~x63;
  assign new_n422_ = ~x59 & ~x57 & ~x56 & new_n423_ & ~x55 & ~x58;
  assign new_n423_ = ~x54 & ~x52 & ~x51 & new_n424_ & ~x50 & ~x53;
  assign new_n424_ = ~x49 & ~x47 & ~x46 & new_n425_ & ~x45 & ~x48;
  assign new_n425_ = ~x43 & ~x41 & ~x40 & new_n426_ & ~x39 & ~x42;
  assign new_n426_ = ~x37 & ~x35 & ~x34 & new_n427_ & ~x33 & ~x36;
  assign new_n427_ = ~x31 & ~x30 & x29 & ~x28 & new_n428_ & ~x26;
  assign new_n428_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n429_ & x20;
  assign new_n429_ = ~x18 & ~x16 & ~x15 & new_n252_ & ~x14 & ~x17;
  assign z57 = ~x62 & ~x58 & ~x56 & new_n431_ & ~x50 & ~x60;
  assign new_n431_ = ~x47 & ~x43 & ~x41 & new_n432_ & ~x40 & ~x46;
  ...
  assign z58 = ~x60 & ~x58 & new_n437_ & ~x56 & ~x62;
  assign new_n437_ = ~x50 & ~x46 & ~x43 & new_n438_ & ~x41 & ~x47;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n442_ & ~x47 & ~x58;
  assign new_n442_ = ~x46 & ~x40 & ~x39 & new_n443_ & ~x37 & ~x43;
  assign new_n443_ = ~x30 & ~x28 & ~x25 & new_n444_ & ~x24 & x29;
  assign new_n444_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x58 & ~x56 & new_n446_ & ~x50 & ~x60;
  assign new_n446_ = ~x47 & ~x43 & ~x40 & new_n447_ & ~x39 & ~x46;
  assign new_n447_ = ~x37 & ~x30 & x29 & ~x28 & new_n448_ & ~x25;
  assign new_n448_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n450_ & x47;
  assign new_n450_ = new_n451_ & ~x46;
  assign new_n451_ = ~x43 & ~x39 & ~x37 & new_n452_ & ~x30 & ~x40;
  assign new_n452_ = x29 & new_n453_ & ~x28;
  assign new_n453_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n450_ & ~x50;
  assign z64 = ~x58 & ~x50 & new_n456_ & ~x46 & ~x60;
