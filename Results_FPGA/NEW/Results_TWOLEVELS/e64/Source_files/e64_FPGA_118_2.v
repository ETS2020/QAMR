// Benchmark "FAU" written by ABC on Wed Jul 29 04:00:05 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n422_, new_n423_, new_n425_, new_n426_, new_n427_, new_n430_,
    new_n431_, new_n432_, new_n434_, new_n435_, new_n436_, new_n438_,
    new_n439_, new_n440_, new_n441_, new_n444_;
  ...
  assign new_n160_ = ~x15 & ~x14 & ~x12 & new_n161_ & ~x11 & ~x16;
  ...
  assign new_n250_ = ~x18 & new_n251_ & ~x17;
  assign new_n251_ = ~x15 & ~x14 & new_n228_ & ~x12;
  assign z23 = ~x64 & new_n253_ & ~x63;
  assign new_n253_ = ~x61 & ~x60 & ~x59 & new_n254_ & ~x58 & ~x62;
  assign new_n254_ = ~x56 & ~x55 & ~x54 & new_n255_ & ~x53 & ~x57;
  assign new_n255_ = ~x51 & ~x50 & ~x49 & new_n256_ & ~x48 & ~x52;
  assign new_n256_ = ~x46 & ~x45 & ~x43 & new_n257_ & ~x42 & ~x47;
  assign new_n257_ = ~x40 & ~x39 & ~x37 & new_n258_ & ~x36 & ~x41;
  assign new_n258_ = ~x34 & ~x33 & ~x31 & new_n259_ & ~x30 & ~x35;
  assign new_n259_ = ~x28 & ~x26 & ~x25 & new_n260_ & ~x24 & x29;
  assign new_n260_ = ~x22 & ~x21 & ~x18 & ~x17 & new_n251_ & x16;
  ...
  assign z26 = ~x64 & ~x63 & ~x62 & new_n268_ & ~x61;
  assign new_n268_ = ~x59 & ~x58 & ~x57 & new_n269_ & ~x56 & ~x60;
  assign new_n269_ = ~x54 & ~x53 & ~x52 & new_n270_ & ~x51 & ~x55;
  ...
  assign new_n273_ = ~x33 & x32 & ~x31 & ~x30 & new_n274_ & x29;
  assign new_n274_ = ~x26 & ~x25 & ~x24 & new_n275_ & ~x22 & ~x28;
  assign new_n275_ = ~x21 & new_n276_ & ~x20;
  assign new_n276_ = ~x18 & new_n160_ & ~x17;
  assign z28 = ~x60 & ~x58 & new_n278_ & ~x50;
  assign new_n278_ = ~x43 & ~x40 & ~x39 & new_n279_ & ~x37 & ~x46;
  assign new_n279_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n281_ & ~x46;
  assign new_n281_ = ~x43 & ~x40 & new_n202_ & ~x39;
  assign z30 = ~x64 & ~x63 & ~x62 & new_n283_ & ~x61;
  ...
  assign new_n289_ = ~x25 & ~x24 & ~x22 & new_n250_ & ~x21 & ~x26;
  ...
  assign new_n297_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n250_ & x21;
  ...
  assign new_n312_ = ~x40 & ~x39 & ~x37 & new_n232_ & ~x35 & ~x41;
  assign z37 = ~x63 & ~x62 & ~x61 & new_n314_ & ~x60 & ~x64;
  assign new_n314_ = ~x58 & ~x57 & ~x56 & new_n315_ & ~x55 & ~x59;
  assign new_n315_ = ~x53 & ~x52 & ~x51 & new_n316_ & ~x50 & ~x54;
  assign new_n316_ = ~x48 & ~x47 & ~x46 & new_n317_ & ~x45 & ~x49;
  assign new_n317_ = ~x42 & ~x41 & ~x40 & new_n318_ & ~x39 & ~x43;
  assign new_n318_ = ~x36 & ~x35 & ~x34 & new_n319_ & ~x33 & ~x37;
  assign new_n319_ = ~x32 & ~x31 & ~x30 & x29 & new_n320_ & ~x28;
  assign new_n320_ = ~x25 & ~x24 & ~x22 & new_n321_ & ~x21 & ~x26;
  assign new_n321_ = ~x20 & new_n276_ & x19;
  ...
  assign new_n347_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n223_ & x49;
  ...
  assign new_n392_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n221_ & x57;
  assign z51 = ~x62 & ~x61 & new_n394_ & ~x60;
  assign new_n394_ = ~x58 & ~x56 & ~x55 & new_n395_ & ~x54 & ~x59;
  assign new_n395_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n223_ & x48;
  ...
  assign new_n409_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n232_ & x35;
  assign z56 = ~x63 & ~x62 & ~x61 & new_n411_ & ~x60 & ~x64;
  assign new_n411_ = ~x58 & ~x57 & ~x56 & new_n412_ & ~x55 & ~x59;
  assign new_n412_ = ~x53 & ~x52 & ~x51 & new_n413_ & ~x50 & ~x54;
  ...
  assign new_n417_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n276_ & x20;
