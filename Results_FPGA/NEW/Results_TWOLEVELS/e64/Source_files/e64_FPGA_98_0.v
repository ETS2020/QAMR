// Benchmark "FAU" written by ABC on Wed Jul 29 03:59:59 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n378_, new_n379_, new_n383_, new_n384_, new_n386_, new_n387_,
    new_n388_, new_n389_, new_n390_, new_n391_, new_n392_, new_n393_,
    new_n395_, new_n396_, new_n397_, new_n398_, new_n399_, new_n401_,
    new_n402_, new_n403_, new_n406_, new_n407_, new_n408_, new_n410_,
  ...
  assign z26 = ~x64 & ~x63 & ~x62 & new_n233_ & ~x61;
  ...
  assign new_n238_ = ~x33 & x32 & ~x31 & ~x30 & new_n239_ & x29;
  ...
  assign z37 = ~x64 & ~x63 & ~x62 & new_n290_ & ~x61;
  ...
  assign new_n295_ = ~x33 & ~x32 & ~x31 & ~x30 & new_n239_ & x29;
  assign z38 = ~x62 & ~x61 & new_n297_ & ~x60;
  assign new_n297_ = ~x58 & ~x56 & ~x55 & new_n298_ & ~x51 & x59;
  assign new_n298_ = ~x47 & ~x46 & ~x43 & new_n299_ & ~x42 & ~x50;
  assign new_n299_ = ~x41 & ~x40 & new_n300_ & ~x39;
  assign new_n300_ = ~x37 & ~x35 & ~x30 & x29 & new_n301_ & ~x28;
  assign new_n301_ = ~x25 & ~x24 & ~x22 & new_n302_ & ~x18 & ~x26;
  assign new_n302_ = ~x15 & ~x14 & ~x11 & new_n303_ & ~x10;
  assign new_n303_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n305_ & ~x61;
  assign new_n305_ = ~x58 & ~x56 & ~x55 & new_n306_ & ~x51 & ~x60;
  assign new_n306_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n299_ & x42;
  assign z40 = ~x62 & ~x61 & new_n308_ & ~x60;
  assign new_n308_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n309_ & x54;
  assign new_n309_ = ~x51 & ~x50 & new_n310_ & ~x47;
  assign new_n310_ = ~x43 & ~x42 & ~x41 & new_n311_ & ~x40 & ~x46;
  assign new_n311_ = ~x37 & ~x35 & ~x34 & new_n312_ & ~x33 & ~x39;
  assign new_n312_ = ~x30 & x29 & ~x28 & new_n313_ & ~x26;
  assign new_n313_ = ~x24 & ~x22 & ~x18 & new_n314_ & ~x17 & ~x25;
  assign new_n314_ = ~x14 & ~x11 & ~x10 & new_n303_ & ~x09 & ~x15;
  assign z41 = ~x61 & ~x60 & ~x59 & new_n316_ & ~x58 & ~x62;
  assign new_n316_ = ~x55 & ~x51 & ~x50 & new_n317_ & ~x47 & ~x56;
  assign new_n317_ = ~x43 & ~x42 & ~x41 & new_n318_ & ~x40 & ~x46;
  assign new_n318_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n312_ & x33;
  assign z42 = ~x62 & new_n320_ & ~x61;
  assign new_n320_ = ~x59 & ~x58 & ~x56 & new_n321_ & ~x55 & ~x60;
  assign new_n321_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n187_ & x49;
  assign z43 = new_n323_ & ~x62;
  assign new_n323_ = ~x60 & ~x59 & ~x58 & new_n324_ & ~x56 & ~x61;
  assign new_n324_ = ~x54 & ~x53 & ~x51 & new_n325_ & ~x50 & ~x55;
  ...
  assign new_n329_ = ~x17 & ~x15 & ~x14 & new_n330_ & ~x11 & ~x18;
  assign new_n330_ = ~x09 & ~x08 & ~x07 & new_n331_ & ~x06 & ~x10;
  assign new_n331_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & ~x59 & new_n333_ & ~x58 & ~x62;
  assign new_n333_ = ~x55 & ~x54 & ~x53 & new_n334_ & ~x51 & ~x56;
  assign new_n334_ = ~x47 & ~x46 & ~x45 & new_n335_ & ~x43 & ~x50;
  assign new_n335_ = ~x41 & ~x40 & ~x39 & new_n336_ & ~x37 & ~x42;
  assign new_n336_ = ~x34 & ~x33 & ~x31 & new_n337_ & ~x30 & ~x35;
  assign new_n337_ = ~x28 & ~x26 & ~x25 & new_n338_ & ~x24 & x29;
  assign new_n338_ = ~x18 & ~x17 & ~x15 & new_n339_ & ~x14 & ~x22;
  assign new_n339_ = ~x10 & ~x09 & ~x08 & new_n340_ & ~x07 & ~x11;
  assign new_n340_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n342_ & ~x59;
  assign new_n342_ = ~x56 & ~x55 & ~x51 & new_n343_ & ~x50 & ~x58;
  assign new_n343_ = ~x46 & ~x43 & ~x42 & new_n344_ & ~x41 & ~x47;
  assign new_n344_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n312_ & x34;
  assign z46 = ~x62 & new_n346_ & ~x61;
  ...
  assign new_n351_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n303_ & x09;
  assign z47 = ~x62 & new_n353_ & ~x61;
  assign new_n353_ = ~x59 & ~x58 & ~x56 & new_n354_ & ~x55 & ~x60;
  assign new_n354_ = ~x50 & ~x47 & ~x46 & new_n355_ & ~x43 & ~x51;
  assign new_n355_ = ~x41 & ~x40 & ~x39 & new_n356_ & ~x37 & ~x42;
  assign new_n356_ = ~x35 & ~x30 & x29 & ~x28 & new_n357_ & ~x26;
  assign new_n357_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n302_ & x17;
  assign z48 = ~x62 & ~x61 & new_n359_ & ~x60;
  assign new_n359_ = ~x58 & ~x56 & ~x55 & new_n360_ & ~x54 & ~x59;
  assign new_n360_ = ~x51 & ~x50 & ~x47 & new_n361_ & ~x46 & ~x53;
  assign new_n361_ = ~x42 & ~x41 & ~x40 & new_n362_ & ~x39 & ~x43;
  assign new_n362_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n312_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n364_ & ~x59;
  assign new_n364_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n309_ & x53;
  assign z50 = new_n366_ & ~x62;
  assign new_n366_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n367_ & x57;
  assign new_n367_ = ~x56 & ~x55 & new_n186_ & ~x54;
  assign z51 = ~x62 & ~x61 & new_n369_ & ~x60;
  assign new_n369_ = ~x58 & ~x56 & ~x55 & new_n370_ & ~x54 & ~x59;
  assign new_n370_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n187_ & x48;
  ...
  assign new_n379_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n192_ & x12;
  ...
  assign new_n384_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n198_ & x35;
  assign z56 = ~x64 & ~x63 & new_n386_ & ~x62;
  assign new_n386_ = ~x60 & ~x59 & ~x58 & new_n387_ & ~x57 & ~x61;
  assign new_n387_ = ~x55 & ~x54 & ~x53 & new_n388_ & ~x52 & ~x56;
  assign new_n388_ = ~x50 & ~x49 & ~x48 & new_n389_ & ~x47 & ~x51;
  assign new_n389_ = ~x45 & ~x43 & ~x42 & new_n390_ & ~x41 & ~x46;
  assign new_n390_ = ~x39 & ~x37 & ~x36 & new_n391_ & ~x35 & ~x40;
  assign new_n391_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n392_ & x29;
  assign new_n392_ = ~x26 & ~x25 & ~x24 & new_n393_ & ~x22 & ~x28;
  assign new_n393_ = ~x21 & x20 & ~x18 & ~x17 & new_n216_ & ~x16;
  ...
  assign z60 = ~x58 & ~x56 & ~x50 & new_n406_ & ~x47 & ~x60;
  assign new_n406_ = ~x43 & ~x40 & ~x39 & new_n407_ & ~x37 & ~x46;
  assign new_n407_ = ~x30 & x29 & ~x28 & ~x25 & new_n408_ & ~x24;
  assign new_n408_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n410_ & ~x50;
  assign new_n410_ = ~x46 & ~x43 & ~x40 & new_n411_ & ~x39 & ~x47;
  assign new_n411_ = ~x37 & ~x30 & x29 & ~x28 & new_n412_ & ~x25;
  assign new_n412_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n414_ & x47;
  assign new_n414_ = new_n415_ & ~x46;
  assign new_n415_ = ~x40 & ~x39 & ~x37 & new_n416_ & ~x30 & ~x43;
  assign new_n416_ = x29 & new_n417_ & ~x28;
  assign new_n417_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n414_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n420_ & ~x46;
  assign new_n420_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n416_ & x30;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z08 = 1'b0;
  assign z09 = 1'b0;
