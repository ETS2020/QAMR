...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n397_, new_n400_, new_n401_, new_n403_, new_n404_, new_n405_,
  ...
  assign new_n220_ = ~x61 & ~x60 & ~x59 & new_n221_ & ~x57 & ~x62;
  ...
  assign new_n243_ = ~x62 & ~x61 & ~x60 & new_n244_ & ~x59 & ~x63;
  ...
  assign new_n253_ = ~x60 & ~x59 & ~x57 & new_n254_ & ~x56 & ~x61;
  ...
  assign z26 = ~x63 & ~x62 & ~x61 & new_n268_ & ~x60 & ~x64;
  assign new_n268_ = ~x57 & ~x56 & ~x55 & new_n269_ & ~x54 & ~x59;
  assign new_n269_ = ~x52 & ~x51 & ~x50 & new_n270_ & ~x49 & ~x53;
  assign new_n270_ = ~x47 & ~x46 & ~x45 & new_n271_ & ~x43 & ~x48;
  ...
  assign new_n274_ = ~x24 & ~x22 & ~x21 & new_n159_ & ~x20 & ~x25;
  assign z27 = ~x63 & ~x62 & ~x61 & new_n276_ & ~x60 & ~x64;
  assign new_n276_ = ~x57 & ~x56 & ~x55 & new_n277_ & ~x54 & ~x59;
  ...
  assign new_n280_ = ~x35 & ~x34 & ~x33 & new_n281_ & ~x31 & ~x36;
  assign new_n281_ = ~x30 & x29 & ~x28 & ~x26 & new_n282_ & ~x25;
  assign new_n282_ = ~x22 & ~x21 & ~x20 & new_n283_ & ~x18 & ~x24;
  assign new_n283_ = ~x17 & ~x16 & ~x15 & ~x14 & new_n251_ & x13;
  assign z28 = ~x60 & ~x58 & new_n285_ & ~x50;
  assign new_n285_ = ~x43 & ~x40 & ~x39 & new_n286_ & ~x37 & ~x46;
  ...
  assign new_n290_ = ~x60 & ~x59 & ~x57 & new_n291_ & ~x56 & ~x61;
  ...
  assign new_n296_ = ~x25 & ~x24 & ~x22 & new_n250_ & ~x21 & ~x26;
  assign z31 = ~x64 & new_n298_ & ~x63;
  assign new_n298_ = ~x61 & ~x60 & ~x59 & new_n299_ & ~x57 & ~x62;
  ...
  assign new_n319_ = ~x40 & ~x39 & ~x37 & new_n232_ & ~x35 & ~x41;
  ...
  assign z42 = new_n353_ & ~x62;
  assign new_n353_ = ~x60 & ~x59 & ~x56 & new_n354_ & ~x55 & ~x61;
  ...
  assign z50 = ~x62 & ~x61 & ~x60 & ~x59 & new_n221_ & x57;
  assign z51 = ~x62 & new_n400_ & ~x61;
  assign new_n400_ = ~x59 & ~x56 & ~x55 & new_n401_ & ~x54 & ~x60;
  assign new_n401_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n223_ & x48;
  assign z52 = ~x63 & ~x62 & ~x61 & new_n403_ & ~x60 & ~x64;
  assign new_n403_ = ~x57 & ~x56 & ~x55 & new_n404_ & ~x54 & ~x59;
  assign new_n404_ = ~x51 & ~x50 & ~x49 & new_n405_ & ~x48 & ~x53;
  ...
  assign new_n409_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n228_ & x12;
  assign z53 = ~x64 & new_n220_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n318_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n413_ & ~x56;
  assign new_n413_ = ~x50 & ~x47 & ~x46 & new_n414_ & ~x43 & ~x51;
  assign new_n414_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n232_ & x35;
  assign z56 = ~x64 & ~x63 & ~x62 & new_n416_ & ~x61;
  assign new_n416_ = ~x59 & ~x57 & ~x56 & new_n417_ & ~x55 & ~x60;
  assign new_n417_ = ~x53 & ~x52 & ~x51 & new_n418_ & ~x50 & ~x54;
  assign new_n418_ = ~x48 & ~x47 & ~x46 & new_n419_ & ~x45 & ~x49;
  assign new_n419_ = ~x42 & ~x41 & ~x40 & new_n420_ & ~x39 & ~x43;
  assign new_n420_ = ~x36 & ~x35 & ~x34 & new_n421_ & ~x33 & ~x37;
  assign new_n421_ = ~x31 & ~x30 & x29 & ~x28 & new_n422_ & ~x26;
  assign new_n422_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n423_ & x20;
  assign new_n423_ = ~x17 & ~x16 & ~x15 & new_n251_ & ~x14 & ~x18;
  assign z57 = ~x60 & ~x58 & ~x56 & new_n425_ & ~x50 & ~x62;
  assign new_n425_ = ~x46 & ~x43 & ~x41 & new_n426_ & ~x40 & ~x47;
  ...
  assign new_n431_ = ~x47 & ~x46 & ~x43 & new_n432_ & ~x41 & ~x50;
  ...
  assign z60 = ~x58 & ~x56 & ~x50 & new_n436_ & ~x47 & ~x60;
  assign new_n436_ = ~x43 & ~x40 & ~x39 & new_n437_ & ~x37 & ~x46;
  assign new_n437_ = ~x30 & x29 & ~x28 & ~x25 & new_n438_ & ~x24;
  assign new_n438_ = ~x14 & ~x11 & ~x10 & x07 & ~x08 & ~x15;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n440_ & ~x50;
  assign new_n440_ = ~x46 & ~x43 & ~x40 & new_n441_ & ~x39 & ~x47;
  assign new_n441_ = ~x37 & ~x30 & x29 & ~x28 & new_n442_ & ~x25;
  assign new_n442_ = ~x15 & ~x14 & ~x11 & x08 & ~x10 & ~x24;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n444_ & x47;
  assign new_n444_ = new_n445_ & ~x46;
  assign new_n445_ = ~x40 & ~x39 & ~x37 & new_n446_ & ~x30 & ~x43;
  assign new_n446_ = x29 & new_n447_ & ~x28;
  assign new_n447_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n444_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n450_ & ~x46;
