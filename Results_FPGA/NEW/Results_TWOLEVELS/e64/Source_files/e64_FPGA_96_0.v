...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n144_,
    ...
    new_n178_, new_n179_, new_n181_, new_n185_, new_n187_, new_n188_,
    new_n189_, new_n191_, new_n192_, new_n193_, new_n196_, new_n197_,
    new_n198_, new_n200_, new_n201_, new_n202_, new_n204_, new_n205_,
    new_n206_, new_n207_, new_n210_;
  assign z04 = x15 & x29;
  ...
  assign z21 = ~x62 & ~x60 & ~x58 & ~x56 & new_n166_ & ~x50;
  assign new_n166_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n167_ & ~x40;
  assign new_n167_ = ~x39 & ~x37 & ~x30 & x29 & new_n168_ & ~x28;
  assign new_n168_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n169_ & ~x18;
  assign new_n169_ = ~x15 & new_n170_ & ~x14;
  ...
  assign z25 = ~x60 & ~x58 & ~x50 & new_n175_ & ~x46;
  assign new_n175_ = ~x43 & ~x40 & ~x39 & new_n176_ & x29 & ~x37;
  assign new_n176_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z28 = ~x60 & ~x58 & new_n178_ & ~x50;
  assign new_n178_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n179_ & ~x37;
  assign new_n179_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & new_n181_ & ~x46;
  assign new_n181_ = ~x43 & ~x40 & new_n149_ & ~x39;
  assign z32 = ~x58 & new_n181_ & x46 & ~x50;
  assign z33 = ~x58 & ~x50 & ~x43 & new_n149_ & x39 & ~x40;
  assign z34 = new_n185_ & x58;
  assign new_n185_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n187_ & ~x50;
  assign new_n187_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n188_ & ~x40;
  assign new_n188_ = ~x39 & ~x37 & ~x30 & x29 & new_n189_ & ~x28;
  assign new_n189_ = ~x26 & ~x25 & ~x24 & new_n169_ & x18 & ~x22;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n191_ & ~x56;
  assign new_n191_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n192_ & ~x41;
  assign new_n192_ = ~x40 & ~x39 & ~x37 & new_n193_ & x29 & ~x30;
  assign new_n193_ = ~x28 & ~x26 & ~x25 & new_n169_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n149_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n196_ & ~x47;
  ...
  assign z61 = ~x60 & ~x58 & ~x56 & new_n200_ & ~x50;
  assign new_n200_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n201_ & ~x39;
  assign new_n201_ = ~x37 & ~x30 & x29 & ~x28 & new_n202_ & ~x25;
  assign new_n202_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n204_ & x47 & ~x50;
  assign new_n204_ = new_n205_ & ~x46;
  assign new_n205_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n206_ & ~x30;
  assign new_n206_ = x29 & new_n207_ & ~x28;
  assign new_n207_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n204_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n210_ & ~x46;
  assign new_n210_ = ~x43 & ~x40 & ~x39 & new_n206_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
