...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n144_,
    ...
    new_n196_, new_n197_, new_n199_, new_n200_, new_n201_, new_n204_,
    new_n205_, new_n206_, new_n208_, new_n209_, new_n210_, new_n212_,
    new_n213_, new_n214_, new_n215_, new_n218_;
  assign z04 = x15 & x29;
  ...
  assign new_n166_ = ~x56 & ~x50 & ~x47 & ~x46 & new_n167_ & ~x43;
  ...
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n193_ & ~x50;
  assign new_n193_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n194_ & ~x40;
  assign new_n194_ = ~x39 & ~x37 & ~x30 & x29 & new_n195_ & ~x28;
  assign new_n195_ = ~x26 & ~x25 & ~x24 & new_n196_ & x18 & ~x22;
  assign new_n196_ = ~x15 & new_n197_ & ~x14;
  assign new_n197_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n199_ & ~x56;
  assign new_n199_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n200_ & ~x41;
  assign new_n200_ = ~x40 & ~x39 & ~x37 & new_n201_ & x29 & ~x30;
  assign new_n201_ = ~x28 & ~x26 & ~x25 & new_n196_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n149_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n204_ & ~x47;
  ...
  assign z61 = ~x60 & ~x58 & ~x56 & new_n208_ & ~x50;
  assign new_n208_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n209_ & ~x39;
  assign new_n209_ = ~x37 & ~x30 & x29 & ~x28 & new_n210_ & ~x25;
  assign new_n210_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n212_ & x47 & ~x50;
  assign new_n212_ = new_n213_ & ~x46;
  assign new_n213_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n214_ & ~x30;
  assign new_n214_ = x29 & new_n215_ & ~x28;
  assign new_n215_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n212_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n218_ & ~x46;
  assign new_n218_ = ~x43 & ~x40 & ~x39 & new_n214_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
