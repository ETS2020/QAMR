// Benchmark "FAU" written by ABC on Wed Jul 29 04:00:30 2020
...
module FAU ( 
  ...
  assign z47 = ~x61 & ~x60 & ~x59 & new_n390_ & ~x56 & ~x62;
  assign new_n390_ = ~x51 & ~x50 & ~x47 & new_n391_ & ~x46 & ~x55;
  assign new_n391_ = ~x42 & ~x41 & ~x40 & new_n392_ & ~x39 & ~x43;
  assign new_n392_ = ~x37 & ~x35 & ~x30 & x29 & new_n393_ & ~x28;
  assign new_n393_ = ~x25 & ~x24 & ~x22 & new_n394_ & ~x18 & ~x26;
  assign new_n394_ = new_n339_ & x17;
