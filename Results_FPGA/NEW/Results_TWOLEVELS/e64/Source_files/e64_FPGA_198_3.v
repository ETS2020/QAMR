...
module FAU ( 
  ...
  assign z01 = ~x61 & ~x60 & ~x59 & new_n142_ & ~x56 & ~x62;
  assign new_n142_ = ~x54 & ~x53 & ~x51 & new_n143_ & ~x50 & ~x55;
  assign new_n143_ = ~x46 & ~x43 & ~x42 & new_n144_ & ~x41 & ~x47;
  assign new_n144_ = ~x39 & ~x37 & ~x35 & new_n145_ & ~x34 & ~x40;
  assign new_n145_ = ~x33 & ~x31 & ~x30 & x29 & new_n146_ & ~x28;
  assign new_n146_ = ~x26 & ~x25 & ~x24 & new_n147_ & ~x22;
  assign new_n147_ = ~x17 & ~x15 & ~x14 & new_n148_ & ~x11 & ~x18;
  assign new_n148_ = ~x10 & ~x09 & ~x08 & new_n149_ & ~x07;
