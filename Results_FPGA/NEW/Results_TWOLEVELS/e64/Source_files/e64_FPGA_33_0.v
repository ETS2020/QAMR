...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n144_,
    ...
    new_n185_, new_n187_, new_n191_, new_n193_, new_n194_, new_n196_,
  ...
  assign z20 = ~x62 & ~x60 & ~x58 & new_n166_ & ~x56;
  assign new_n166_ = x51 & ~x50 & ~x47 & ~x46 & new_n167_ & ~x43;
  ...
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n193_ & ~x51;
  assign new_n193_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n194_ & ~x41;
  assign new_n194_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n168_ & ~x30;
  assign z55 = ~x62 & ~x60 & ~x58 & ~x56 & new_n196_ & ~x51;
  assign new_n196_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n197_ & ~x41;
  assign new_n197_ = ~x40 & ~x39 & ~x37 & x35 & new_n168_ & ~x30;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n199_ & ~x50;
  assign new_n199_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n200_ & ~x40;
  assign new_n200_ = ~x39 & ~x37 & ~x30 & x29 & new_n201_ & ~x28;
  assign new_n201_ = ~x26 & ~x25 & ~x24 & new_n202_ & x18 & ~x22;
  assign new_n202_ = ~x15 & new_n203_ & ~x14;
  assign new_n203_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n205_ & ~x56;
  assign new_n205_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n206_ & ~x41;
  assign new_n206_ = ~x40 & ~x39 & ~x37 & new_n207_ & x29 & ~x30;
  assign new_n207_ = ~x28 & ~x26 & ~x25 & new_n202_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n149_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n210_ & ~x47;
  assign new_n210_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n211_ & ~x37;
  assign new_n211_ = ~x30 & x29 & ~x28 & ~x25 & new_n212_ & ~x24;
  assign new_n212_ = ~x15 & ~x14 & ~x11 & ~x10 & x07 & ~x08;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n214_ & ~x50;
  assign new_n214_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n215_ & ~x39;
  assign new_n215_ = ~x37 & ~x30 & x29 & ~x28 & new_n216_ & ~x25;
  assign new_n216_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n218_ & x47 & ~x50;
  assign new_n218_ = new_n219_ & ~x46;
  assign new_n219_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n220_ & ~x30;
  assign new_n220_ = x29 & new_n221_ & ~x28;
  assign new_n221_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n218_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n224_ & ~x46;
  assign new_n224_ = ~x43 & ~x40 & ~x39 & new_n220_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
