...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n144_,
    ...
    new_n232_, new_n233_, new_n234_, new_n237_, new_n238_, new_n240_,
    new_n241_, new_n242_, new_n243_, new_n244_, new_n246_, new_n247_,
    new_n248_, new_n251_, new_n252_, new_n253_, new_n255_, new_n256_,
    new_n257_, new_n259_, new_n260_, new_n261_, new_n262_, new_n265_;
  assign z04 = x15 & x29;
  ...
  assign z45 = ~x62 & new_n216_ & ~x61;
  assign new_n216_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n217_ & ~x55;
  assign new_n217_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n218_ & ~x43;
  assign new_n218_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n219_ & ~x37;
  assign new_n219_ = ~x35 & ~x30 & x29 & ~x28 & new_n220_ & ~x26;
  assign new_n220_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n221_ & ~x17;
  assign new_n221_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n211_ & ~x09;
  assign z46 = ~x62 & new_n223_ & ~x61;
  assign new_n223_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n224_ & ~x55;
  assign new_n224_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n225_ & ~x43;
  assign new_n225_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n226_ & ~x37;
  assign new_n226_ = ~x35 & ~x30 & x29 & ~x28 & new_n227_ & ~x26;
  assign new_n227_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n228_ & ~x17;
  assign new_n228_ = ~x15 & ~x14 & ~x11 & new_n211_ & x09 & ~x10;
  assign z47 = ~x62 & new_n230_ & ~x61;
  ...
  assign new_n234_ = ~x25 & ~x24 & ~x22 & new_n210_ & x17 & ~x18;
  assign z54 = ~x62 & ~x60 & ~x58 & new_n202_ & x55 & ~x56;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n237_ & ~x56;
  assign new_n237_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n238_ & ~x43;
  assign new_n238_ = ~x41 & ~x40 & ~x39 & new_n168_ & x35 & ~x37;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n240_ & ~x50;
  assign new_n240_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n241_ & ~x40;
  assign new_n241_ = ~x39 & ~x37 & ~x30 & x29 & new_n242_ & ~x28;
  assign new_n242_ = ~x26 & ~x25 & ~x24 & new_n243_ & x18 & ~x22;
  assign new_n243_ = ~x15 & new_n244_ & ~x14;
  assign new_n244_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n246_ & ~x56;
  assign new_n246_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n247_ & ~x41;
  assign new_n247_ = ~x40 & ~x39 & ~x37 & new_n248_ & x29 & ~x30;
  assign new_n248_ = ~x28 & ~x26 & ~x25 & new_n243_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n149_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n251_ & ~x47;
  assign new_n251_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n252_ & ~x37;
  assign new_n252_ = ~x30 & x29 & ~x28 & ~x25 & new_n253_ & ~x24;
  assign new_n253_ = ~x15 & ~x14 & ~x11 & ~x10 & x07 & ~x08;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n255_ & ~x50;
  assign new_n255_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n256_ & ~x39;
  assign new_n256_ = ~x37 & ~x30 & x29 & ~x28 & new_n257_ & ~x25;
  assign new_n257_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n259_ & x47 & ~x50;
  assign new_n259_ = new_n260_ & ~x46;
  assign new_n260_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n261_ & ~x30;
  assign new_n261_ = x29 & new_n262_ & ~x28;
  assign new_n262_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n259_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n265_ & ~x46;
  assign new_n265_ = ~x43 & ~x40 & ~x39 & new_n261_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
