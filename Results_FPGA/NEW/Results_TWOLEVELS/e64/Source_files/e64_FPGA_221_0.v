...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n144_,
    ...
    new_n236_, new_n237_, new_n238_, new_n239_, new_n242_;
  assign z04 = x15 & x29;
  ...
  assign z39 = ~x62 & ~x61 & new_n205_ & ~x60;
  ...
  assign z54 = ~x62 & ~x60 & ~x58 & new_n212_ & x55 & ~x56;
  assign new_n212_ = new_n202_ & ~x51;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n214_ & ~x56;
  assign new_n214_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n215_ & ~x43;
  assign new_n215_ = ~x41 & ~x40 & ~x39 & new_n168_ & x35 & ~x37;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n217_ & ~x50;
  assign new_n217_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n218_ & ~x40;
  assign new_n218_ = ~x39 & ~x37 & ~x30 & x29 & new_n219_ & ~x28;
  assign new_n219_ = ~x26 & ~x25 & ~x24 & new_n220_ & x18 & ~x22;
  assign new_n220_ = ~x15 & new_n221_ & ~x14;
  assign new_n221_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n223_ & ~x56;
  assign new_n223_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n224_ & ~x41;
  assign new_n224_ = ~x40 & ~x39 & ~x37 & new_n225_ & x29 & ~x30;
  assign new_n225_ = ~x28 & ~x26 & ~x25 & new_n220_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n149_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n228_ & ~x47;
  ...
  assign z61 = ~x60 & ~x58 & ~x56 & new_n232_ & ~x50;
  ...
  assign z62 = ~x60 & ~x58 & ~x56 & new_n236_ & x47 & ~x50;
  assign new_n236_ = new_n237_ & ~x46;
  assign new_n237_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n238_ & ~x30;
  assign new_n238_ = x29 & new_n239_ & ~x28;
  assign new_n239_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n236_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n242_ & ~x46;
  assign new_n242_ = ~x43 & ~x40 & ~x39 & new_n238_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
