// Benchmark "FAU" written by ABC on Wed Jul 29 03:35:07 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n51_, new_n57_, new_n60_, new_n61_, new_n62_,
  ...
  assign z03 = new_n51_ | (new_n49_ & ~x00 & ~x17 & x18 & ~x19);
  assign new_n51_ = x00 & x01 & x02 & ~x09 & x11 & x12;
  assign z04 = ~x12 & ~x11 & ~x09 & x02 & x00 & x01;
  assign z05 = x09 & x02 & x00 & x01;
  assign z06 = x00 & x01 & x02 & ~x09 & x11;
  assign z07 = x00 & x02 & (~x01 | (x11 & ~x12 & x01 & ~x09));
  ...
  assign new_n68_ = new_n65_ & ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n71_ & ~x24;
  assign new_n71_ = (x02 | ((~x00 | ~x01) & (x00 | x01 | ~x17 | x19))) & (x00 | x01 | ~x23 | (~x02 & ~x19));
