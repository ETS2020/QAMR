// Benchmark "FAU" written by ABC on Wed Jul 29 03:34:53 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n51_, new_n53_, new_n55_, new_n56_, new_n57_, new_n59_,
    new_n60_, new_n61_, new_n63_, new_n64_, new_n66_;
  ...
  assign z08 = x19 & ~x18 & ~x08 & ~x07 & new_n53_ & ~x06;
  assign new_n53_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  ...
  assign z11 = ~x00 & ~x22 & (new_n63_ | (new_n60_ & new_n64_));
  assign new_n63_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n64_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~new_n66_ & ~x24;
  assign new_n66_ = x00 ? (~x01 | (x02 & x10)) : (x01 | (~x23 & (x02 | x19)));
  assign z13 = ~x19 & ~x02 & ~x00 & ~x01;
