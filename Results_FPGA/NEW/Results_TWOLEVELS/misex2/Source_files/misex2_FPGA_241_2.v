...
module FAU ( 
  ...
  assign z09 = ~x21 & ~x22 & (new_n62_ | new_n64_);
  assign new_n62_ = new_n63_ & ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n63_ = ~x00 & ~x01 & x02 & ~x11 & x12;
  assign new_n64_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (new_n66_ & ~x20 & x21 & x22) | (new_n67_ & new_n68_ & x20 & ~x21 & ~x22);
  assign new_n66_ = x01 & x18 & ~x19;
  assign new_n67_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x14 & x15 & x16;
  assign z11 = ~x22 & (new_n70_ | (new_n63_ & new_n71_));
