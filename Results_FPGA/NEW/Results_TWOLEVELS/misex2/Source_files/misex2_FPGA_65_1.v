// Benchmark "FAU" written by ABC on Wed Jul 29 03:35:06 2020
...
module FAU ( 
  ...
  assign z08 = x19 & ~x18 & x17 & ~x08 & new_n59_ & ~x07;
  assign new_n59_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n63_ | (new_n61_ & new_n62_));
  assign new_n61_ = ~x01 & x02 & ~x11 & x12;
  ...
  assign z11 = ~x00 & ~x22 & (new_n69_ | (new_n66_ & new_n70_));
