// Benchmark "FAU" written by ABC on Wed Jul 29 03:35:27 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n55_, new_n57_, new_n60_, new_n61_, new_n62_,
    new_n64_, new_n65_, new_n66_, new_n68_, new_n69_, new_n71_;
  ...
  assign new_n50_ = x00 & x01 & ~x09 & x10 & x11 & x12;
  assign z04 = ~x12 & ~x11 & x10 & ~x09 & x00 & x01;
  assign z05 = x10 & x09 & x00 & x01;
  assign z06 = x00 & x01 & ~x09 & x10 & x11;
  assign z07 = ~new_n55_ & x00;
  assign new_n55_ = (x01 | ~x02) & (~x01 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n65_ = ~x11 & x12 & ~x13 & ~x01 & x02;
  ...
  assign z12 = x09 & ~x24 & (x00 ? (x01 & ~x10) : ~new_n71_);
  assign new_n71_ = (x02 | (x19 ? ~x23 : ~x17)) & (x01 | ~x02 | ~x23);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x02 & x19);
  assign z16 = ~x00 & x01;
endmodule
