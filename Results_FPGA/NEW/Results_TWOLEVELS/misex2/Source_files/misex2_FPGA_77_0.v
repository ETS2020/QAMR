// Benchmark "FAU" written by ABC on Wed Jul 29 03:35:08 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n57_, new_n59_, new_n64_,
  ...
  assign z16 = ~x00 & x01;
  assign z10 = ~x00 & (new_n64_ | new_n66_);
  assign new_n64_ = new_n65_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = ~x14 & x16 & x20 & ~x21 & ~x22;
  assign new_n66_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign z11 = ~x00 & ~new_n68_ & ~x22;
  assign new_n68_ = ~new_n69_ & (~new_n70_ | x01 | ~x02 | x11 | ~x12);
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n70_ = ~x13 & ~x14 & ~x16 & x20 & ~x21;
