...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n49_, new_n54_, new_n56_, new_n59_, new_n60_,
    new_n61_, new_n63_, new_n64_, new_n65_, new_n67_, new_n68_, new_n70_,
    new_n71_;
  assign z02 = ~x19 & ~x18 & ~x17 & new_n46_ & x09;
  assign new_n46_ = ~x02 & ~x00 & ~x01;
  assign z03 = (new_n48_ & ~x00 & ~x01 & ~x02) | (new_n49_ & x01 & x02 & ~x09);
  ...
  assign new_n54_ = (~x00 | x01) & (~x10 | ~x11 | x12 | ~x01 | x09);
  ...
  assign new_n70_ = ~x24 & ((x01 & (x10 ? ~x02 : x00)) | (~x00 & ~new_n71_ & ~x01));
  assign new_n71_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x09;
