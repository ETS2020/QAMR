// Benchmark "FAU" written by ABC on Wed Jul 29 03:35:05 2020
...
module FAU ( 
  ...
  assign z08 = x19 & ~x18 & x17 & ~x08 & new_n60_ & ~x07;
  assign new_n60_ = ~x06 & ~x05 & x04 & ~x03 & ~x00 & x02;
  ...
  assign new_n74_ = (x01 | ~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = ~x19 & x17 & ~x00 & ~x02;
