...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (new_n69_ | (x19 & new_n65_ & x31));
  ...
  assign new_n70_ = ~new_n71_ & new_n72_ & x19 & (x12 | x17);
  ...
  assign new_n78_ = ~new_n68_ & ((~x31 & x33) | (x19 & x30 & x31 & ~new_n66_ & ~x33));
  assign new_n79_ = ~new_n80_ & ((x31 & x33) | (x19 & ~x30 & ~x31 & ~new_n66_ & ~x33));
  assign new_n80_ = ~new_n68_ & x29;
  assign new_n81_ = x33 & (new_n73_ | new_n75_ | ~new_n82_ | new_n76_);
  assign new_n82_ = ~new_n71_ & (x30 | ~x31) & (~x30 | x31) & x19 & (x12 | x17);
  assign z0 = ~x32;
endmodule
