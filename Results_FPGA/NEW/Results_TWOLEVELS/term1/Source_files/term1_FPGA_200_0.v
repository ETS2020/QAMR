...
module FAU ( 
  ...
  assign new_n66_ = (~x15 | ((new_n67_ | ~x16) & (~new_n68_ | ~x11 | x16))) & (~new_n68_ | x15 | ~x16);
  assign new_n67_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = ~new_n74_ & ~new_n75_ & new_n70_ & ~new_n76_;
  ...
  assign new_n75_ = ~x15 & (~x16 | ~x17 | ~x18 | ~x19);
  ...
  assign new_n81_ = x33 & (new_n84_ | ~new_n82_ | new_n75_);
  assign new_n82_ = (x19 | (x16 & x17 & x18)) & new_n83_ & (x16 | (x11 & x17 & x18));
