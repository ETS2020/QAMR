...
module FAU ( 
  ...
  assign new_n54_ = (x17 | x22) & (x18 | x23) & x24;
  ...
  assign new_n61_ = x24 & (x18 | x23) & new_n53_ & (x17 | x22);
  ...
  assign new_n65_ = ~new_n67_ & (~x14 | ~x15 | ~x16 | ~new_n66_ | ~x17);
  assign new_n66_ = x18 & ~x30 & x31 & (x27 | x28) & ~x32;
  assign new_n67_ = x30 & x32 & (x28 | (x27 & ~x28));
  assign new_n68_ = ~new_n69_ & ((~x30 & x32) | (new_n70_ & x18 & x30 & x31 & ~x32));
  assign new_n69_ = x29 & (x27 | x28);
  assign new_n70_ = x16 & x17 & x14 & x15;
  assign new_n71_ = x32 & (~new_n72_ | ~x17 | ~x18 | ~x31);
  assign new_n72_ = x14 & x15 & x16;
  assign z9 = x00 & ~x26 & (new_n76_ | new_n77_ | (new_n74_ & x29));
  assign new_n74_ = ~new_n75_ & ((~x31 & x33) | (new_n70_ & x18 & x30 & x31 & ~x33));
  assign new_n75_ = ~x27 & ~x28;
  assign new_n76_ = ~new_n69_ & ((x31 & x33) | (new_n70_ & x18 & ~x30 & ~x31 & ~x33));
  assign new_n77_ = x33 & (~new_n72_ | ~x17 | ~x18 | (x30 & ~x31) | (~x30 & x31));
  assign z0 = ~x32;
endmodule
