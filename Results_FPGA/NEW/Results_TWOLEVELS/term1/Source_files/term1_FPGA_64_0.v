...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & ((x31 & new_n65_ & ~x32) | (~new_n71_ & x32));
  assign new_n65_ = ((x29 & ~new_n69_ & ~x30) | (x30 & (new_n69_ | ~x29))) & (new_n66_ | new_n70_);
  assign new_n66_ = x15 & (new_n67_ | new_n68_);
  assign new_n67_ = x16 & (x17 ? ((x13 & ~x18 & x19) | (x14 & x18 & ~x19)) : (x18 & x19));
  assign new_n68_ = x11 & ~x16 & x17 & x18 & x19;
  assign new_n69_ = ~x27 & ~x28;
  assign new_n70_ = x17 & x18 & x19 & x10 & ~x15 & x16;
  assign new_n71_ = ~new_n79_ & ~new_n72_ & ~new_n74_ & new_n75_;
  assign new_n72_ = ~x17 & (~new_n73_ | ~x15 | ~x16);
  assign new_n73_ = x18 & x19;
  assign new_n74_ = ~x15 & (~new_n73_ | ~x10 | ~x16);
  assign new_n75_ = ~new_n76_ & new_n77_ & new_n78_ & (x18 | (x13 & x19));
  assign new_n76_ = ~x16 & (~x11 | ~x18 | ~x19);
  assign new_n77_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n78_ = (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n79_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign z9 = x00 & ~x26 & (new_n81_ | new_n83_ | (~new_n85_ & x33));
  assign new_n81_ = x29 & ~new_n69_ & ((~x31 & x33) | (new_n82_ & x30));
  assign new_n82_ = x31 & ~x33 & (new_n70_ | (x15 & (new_n67_ | new_n68_)));
  assign new_n83_ = ~new_n84_ & ((x31 & x33) | (~x30 & ~x31 & (new_n66_ | new_n70_) & ~x33));
  assign new_n84_ = ~new_n69_ & x29;
  assign new_n85_ = (~x15 | ~x16 | ~new_n88_ | ~x17) & new_n86_ & (x17 | (new_n73_ & x15 & x16));
  assign new_n86_ = (x19 | (x15 & x16 & x18)) & new_n87_ & (x15 | (x10 & x16 & x18));
  assign new_n87_ = (x16 | (x11 & x18)) & (x13 | x18) & (x30 | ~x31) & (~x30 | x31);
  assign new_n88_ = x18 & (~x14 | x19);
  assign z0 = ~x32;
endmodule
