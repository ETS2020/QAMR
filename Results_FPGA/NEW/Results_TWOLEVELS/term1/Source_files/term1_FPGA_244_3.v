...
module FAU ( 
  ...
  assign new_n65_ = ~new_n66_ & (new_n70_ | (x15 & (new_n72_ | (~new_n68_ & x16))));
  assign new_n66_ = (~x29 | new_n67_ | x30) & (~x30 | (~new_n67_ & x29));
  assign new_n67_ = ~x27 & ~x28;
  assign new_n68_ = (~new_n69_ | ~x17) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n69_ = ~x26 & ((x13 & ~x18 & x19) | (x14 & x18 & ~x19));
  ...
  assign z9 = x00 & (new_n88_ | new_n93_ | (new_n81_ & x29));
  assign new_n81_ = ~new_n67_ & (new_n85_ | (~x26 & (new_n87_ | (new_n82_ & x17))));
  assign new_n82_ = x30 & x31 & ~x33 & (new_n84_ | (~new_n83_ & x15));
  assign new_n83_ = (~x16 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x11 | x16 | ~x18 | ~x19);
  assign new_n84_ = x16 & x18 & x19 & x10 & ~x15;
  assign new_n85_ = new_n86_ & x18 & x19 & x30 & x31 & ~x33;
  assign new_n86_ = x16 & ~x17 & x12 & x15;
  assign new_n87_ = ~x31 & x33;
  assign new_n88_ = ~new_n89_ & (new_n91_ | (~x26 & (new_n92_ | (new_n90_ & x17))));
  assign new_n89_ = ~new_n67_ & x29;
  assign new_n90_ = ~x30 & ~x31 & ~x33 & (new_n84_ | (~new_n83_ & x15));
  assign new_n91_ = new_n86_ & x18 & x19 & ~x30 & ~x31 & ~x33;
  assign new_n92_ = x31 & x33;
  assign new_n93_ = ~x26 & x33 & (new_n78_ | new_n74_ | ~new_n94_);
  assign new_n94_ = (x15 | (new_n71_ & x10 & x16)) & new_n95_ & (x16 | (new_n71_ & x11));
