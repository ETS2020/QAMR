// Benchmark "FAU" written by ABC on Wed Jul 29 06:23:56 2020
...
module FAU ( 
  ...
  assign new_n67_ = (~x17 | ((x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x18 | ~x19 | ~x12 | x17);
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = ~x27 & ~x28;
  assign new_n70_ = ~new_n75_ & ~new_n76_ & new_n71_ & ~new_n77_;
  assign new_n71_ = ~new_n72_ & new_n73_ & new_n74_ & (x17 | (x12 & x19));
  assign new_n72_ = ~x16 & (~x11 | ~x17 | ~x19);
  assign new_n73_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n74_ = (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n75_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign new_n76_ = ~x18 & (~x15 | ~x16 | ~x17 | ~x19);
  assign new_n77_ = ~x15 & (~x17 | ~x19 | ~x10 | ~x16);
  assign z9 = x00 & ~x26 & (new_n79_ | new_n80_ | new_n81_);
  assign new_n79_ = x29 & ~new_n69_ & ((~x31 & x33) | (x30 & x31 & ~new_n66_ & ~x33));
  assign new_n80_ = (new_n69_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n66_ & ~x33));
  assign new_n81_ = x33 & ((new_n84_ & x15) | ~new_n82_ | new_n76_);
  assign new_n82_ = (x19 | (x15 & x16 & x17)) & new_n83_ & (x15 | (x10 & x16 & x17));
  assign new_n83_ = (x16 | (x11 & x17)) & (x12 | x17) & (x30 | ~x31) & (~x30 | x31);
