...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n51_, new_n52_, new_n53_, new_n56_, new_n58_,
    ...
    new_n75_, new_n76_, new_n77_, new_n79_;
  ...
  assign new_n60_ = (~new_n61_ | (~x19 & ~x24)) & new_n63_ & x01 & x25;
  assign new_n61_ = new_n62_ & (x18 | x23);
  assign new_n62_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n63_ = ~x26 & ~new_n64_ & (~x02 | ~x03 | x33);
  ...
  assign new_n70_ = ~new_n76_ & ~new_n71_ & new_n72_ & ~new_n77_;
  assign new_n71_ = ~x15 & (~new_n69_ | ~x10 | ~x16);
  ...
  assign z9 = x00 & new_n79_ & ~x26;
  assign new_n79_ = ~new_n67_ & ((x29 & x30 & (x27 | x28) & x31) | (~x30 & ~x31 & (~x29 | (~x27 & ~x28))));
  assign z0 = ~x32;
endmodule
