// Benchmark "FAU" written by ABC on Wed Jul 29 06:24:09 2020
...
module FAU ( 
  ...
  assign z8 = x00 & ((~new_n65_ & ~x26) | (~x12 & ~x17 & x32));
  assign new_n65_ = (~x31 | x32 | new_n66_ | new_n68_) & (~x32 | (new_n71_ & ~new_n78_));
  ...
  assign new_n73_ = ~x15 & (~x18 | ~x19 | ~x10 | ~x16);
  assign new_n74_ = ~x16 & (~x11 | ~x18 | ~x19);
  ...
  assign z9 = x00 & (new_n86_ | (~x26 & (new_n80_ | new_n81_ | new_n82_)));
  assign new_n80_ = x29 & ~new_n67_ & ((~x31 & x33) | (x30 & x31 & ~new_n68_ & ~x33));
  assign new_n81_ = (new_n67_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n68_ & ~x33));
  assign new_n82_ = x33 & (new_n85_ | ~new_n83_ | new_n72_);
  assign new_n83_ = (x19 | (x15 & x16 & x18)) & new_n84_ & (x15 | (x10 & x16 & x18));
  assign new_n84_ = (x16 | (x11 & x18)) & (x13 | x18) & (x30 | ~x31) & (~x30 | x31);
  assign new_n85_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n86_ = ~x12 & ~x17 & x33;
  assign z0 = ~x32;
endmodule
