...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n51_, new_n52_, new_n53_, new_n54_, new_n56_,
    new_n58_, new_n60_, new_n62_, new_n63_, new_n66_, new_n67_, new_n68_,
  ...
  assign z7 = (new_n62_ & (x19 | x24)) | ~new_n63_ | new_n54_ | ~x01;
  assign new_n62_ = (x18 | x23) & new_n52_ & (x17 | x22);
  assign new_n63_ = x25 & ~x26 & (~x27 | ~x28 | ~x29 | ~x30);
  assign z8 = x32 & x00 & ~x26;
  assign z9 = x00 & ~x26 & ((~new_n71_ & x33) | (~x30 & new_n66_ & ~x33));
  assign new_n66_ = ~new_n67_ & (new_n70_ | (x15 & (new_n69_ | (~new_n68_ & x16))));
  assign new_n67_ = x29 & (x27 | x28);
  assign new_n68_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n69_ = x11 & ~x16 & x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & x10 & ~x15 & x16;
  assign new_n71_ = ~new_n72_ & ~new_n67_ & ~new_n73_ & ~new_n74_ & ~new_n75_ & new_n76_;
  ...
  assign new_n76_ = (x17 | (x12 & x18)) & (x13 | x18) & ~x30;
  assign z0 = ~x32;
endmodule
