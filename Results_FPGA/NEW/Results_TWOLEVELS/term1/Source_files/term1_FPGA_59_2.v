...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & ((new_n65_ & x18) | (~new_n69_ & x32));
  ...
  assign new_n70_ = new_n71_ & new_n72_ & (x17 | (x12 & x19));
  assign new_n71_ = (x14 | x19) & x18 & (~x15 | ~x16 | ~x17 | ~x19);
  ...
  assign new_n77_ = ~new_n68_ & ((~x31 & x33) | (x18 & x30 & x31 & ~new_n66_ & ~x33));
  assign new_n78_ = ~new_n79_ & ((x31 & x33) | (x18 & ~x30 & ~x31 & ~new_n66_ & ~x33));
  assign new_n79_ = ~new_n68_ & x29;
  assign new_n80_ = x33 & (new_n74_ | ~new_n81_ | new_n75_);
  assign new_n81_ = (x17 | (x12 & x19)) & new_n82_ & x18 & (x14 | x19);
  assign new_n82_ = (x30 | ~x31) & (~x30 | x31) & (~x17 | ~x19 | ~x15 | ~x16);
  assign z0 = ~x32;
endmodule
