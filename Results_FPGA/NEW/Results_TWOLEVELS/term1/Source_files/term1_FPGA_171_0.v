...
module FAU ( 
  ...
  assign z4 = x01 & x25 & ~x26 & ~new_n56_ & ~new_n51_ & ~new_n54_;
  ...
  assign z7 = new_n62_ | new_n63_ | new_n54_ | ~x01 | ~new_n65_ | ~x25;
  assign new_n62_ = x31 & (~new_n56_ | ~x29 | ~x30);
  assign new_n63_ = ~new_n64_ & (x18 | x23) & new_n52_ & (x17 | x22);
  assign new_n64_ = ~x19 & ~x24;
  assign new_n65_ = ~x26 & (~new_n56_ | ~x29 | ~x30 | x31);
  assign z8 = x00 & ~x26 & ((~new_n72_ & x32) | (x31 & new_n67_ & ~x32));
  assign new_n67_ = ~new_n68_ & (new_n71_ | (x15 & (new_n70_ | (~new_n69_ & x16))));
  ...
  assign z9 = x00 & ~x26 & (x33 ? ~new_n81_ : (~new_n80_ & ~new_n88_));
  assign new_n80_ = ~new_n71_ & (~x15 | (~new_n70_ & (new_n69_ | ~x16)));
  ...
  assign new_n87_ = (~x29 | x30) & (x13 | x18) & (~x30 | x31) & (x29 | ~x31);
  assign new_n88_ = x29 ? (~x30 | ~x31) : (x30 | x31);
  assign z0 = ~x32;
endmodule
