...
module FAU ( 
  ...
  assign new_n71_ = ~new_n74_ & (x26 | (~new_n75_ & ~new_n76_ & new_n72_ & ~new_n77_));
  assign new_n72_ = (x16 | (x11 & x17 & x19)) & new_n73_ & (x17 | (x12 & x19));
  assign new_n73_ = (x14 | x19) & (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n74_ = x19 & ((x15 & x16 & x17 & x18) | (~x13 & ~x18));
  ...
  assign new_n79_ = (new_n80_ | x26) & (~x19 | ~x30 | ~new_n82_ | ~x31);
  assign new_n80_ = (x31 | ~x33) & (~new_n81_ | ~x18 | x19 | ~x30 | ~x31 | x33);
  assign new_n81_ = x16 & x17 & x14 & x15;
  assign new_n82_ = ~x33 & ((~new_n83_ & x15) | (new_n84_ & x10 & ~x15));
  assign new_n83_ = (~x16 | ((~x12 | x17 | ~x18) & (~x13 | ~x17 | x18))) & (~x11 | x16 | ~x17 | ~x18);
  assign new_n84_ = x16 & x17 & x18;
  assign new_n85_ = (new_n86_ | x26) & (~x19 | x30 | ~new_n82_ | x31);
  assign new_n86_ = (~x31 | ~x33) & (~new_n81_ | ~x18 | x19 | x30 | x31 | x33);
  assign new_n87_ = x33 & (new_n90_ | (~x26 & (~new_n88_ | new_n76_)));
  assign new_n88_ = ~new_n77_ & new_n89_ & (x16 | (x11 & x17 & x19));
  assign new_n89_ = (x17 | (x12 & x19)) & (x14 | x19) & (x30 | ~x31) & (~x30 | x31);
  assign new_n90_ = x15 & x16 & x17 & x19 & (~x13 | x18);
  assign z0 = ~x32;
endmodule
