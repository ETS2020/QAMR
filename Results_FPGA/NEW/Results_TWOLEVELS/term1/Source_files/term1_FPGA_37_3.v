...
module FAU ( 
  ...
  assign z8 = x00 & ((~new_n65_ & x31) | (~x26 & ~x31 & x32));
  assign new_n65_ = (~x29 | new_n74_ | (x30 ? ~x32 : (new_n66_ | x32))) & ((~new_n74_ & x29) | (x30 ? (new_n66_ | x32) : ~x32)) & (new_n69_ | ~x32);
  ...
  assign z9 = x00 & (new_n76_ | (new_n78_ & x29) | (~new_n79_ & x33));
  assign new_n76_ = ~new_n77_ & ((x31 & x33) | (~x26 & ~x30 & ~x31 & ~new_n66_ & ~x33));
  assign new_n77_ = ~new_n74_ & x29;
  assign new_n78_ = ~new_n74_ & ((x30 & x31 & ~new_n66_ & ~x33) | (~x26 & ~x31 & x33));
  assign new_n79_ = (x30 | ~x31) & (x26 | (~new_n70_ & new_n80_ & ~new_n71_));
  assign new_n80_ = ~new_n72_ & new_n81_ & (x16 | (x11 & x17 & x18));
