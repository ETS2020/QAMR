...
module FAU ( 
  ...
  assign new_n65_ = x31 & ~new_n66_ & ((x29 & (x27 | x28) & ~x30) | (x30 & (~x29 | (~x27 & ~x28))));
  ...
  assign z9 = x00 & ~x26 & (new_n71_ | new_n73_ | (new_n70_ & x29));
  assign new_n70_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n66_ & ~x33));
  assign new_n71_ = ~new_n72_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n66_ & ~x33));
  assign new_n72_ = x29 & (x27 | x28);
  assign new_n73_ = x33 & (~new_n74_ | (~x15 & (~new_n68_ | ~x10 | ~x16)));
  assign new_n74_ = ~new_n75_ & ~new_n76_ & ~new_n77_ & new_n78_ & (x30 | ~x31) & (~x30 | x31);
  assign new_n75_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign new_n76_ = ~x17 & (~x12 | ~x18 | ~x19);
  assign new_n77_ = ~x18 & (~x13 | ~x19);
