...
module FAU ( 
  ...
  assign z9 = x00 & ((x29 & ~new_n79_ & ~new_n69_) | new_n81_ | (~new_n80_ & (new_n69_ | ~x29)));
  assign new_n79_ = (x26 | ~x30 | ~x31 | new_n66_ | x33) & (x31 | ~x33);
  assign new_n80_ = (~x31 | ~x33) & (x26 | x30 | x31 | new_n66_ | x33);
