...
module FAU ( 
  ...
  assign z7 = new_n60_ | ~new_n62_ | ~x01 | ~x25 | (x02 & x03);
  assign new_n60_ = (x19 | x24) & new_n61_ & (x18 | x23);
  assign new_n61_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n62_ = ~x26 & ~x31 & (~x27 | ~x28 | ~x29 | ~x30);
  assign z8 = x00 & ~x26 & (new_n64_ | new_n68_);
  assign new_n64_ = x29 & x31 & ~x32 & ~new_n65_ & (x27 | x28);
  ...
  assign new_n68_ = x32 & (~new_n69_ | new_n74_ | (~x15 & (~new_n67_ | ~new_n73_)));
  ...
  assign new_n72_ = x29 & x31 & (x27 | x28);
  assign new_n73_ = x10 & x16;
  assign new_n74_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign z9 = x00 & ~x26 & (new_n76_ | ((~new_n78_ | new_n82_) & x33));
  assign new_n76_ = ~x30 & ~x31 & ~x33 & ~new_n65_ & ~new_n77_;
  assign new_n77_ = x29 & (x27 | x28);
  assign new_n78_ = ~new_n77_ & new_n79_ & (x19 | (new_n80_ & x15 & x16));
