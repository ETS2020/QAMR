...
module FAU ( 
  ...
  assign z9 = x00 & ~x26 & (~new_n78_ | new_n82_);
  assign new_n78_ = (x31 | (~x30 & (~x29 | (~x27 & ~x28)))) & new_n79_ & (~x31 | ((x27 | x28) & x29 & x30));
  assign new_n79_ = (x19 | (new_n80_ & x15 & x16)) & new_n81_ & (x15 | (new_n80_ & x10 & x16));
