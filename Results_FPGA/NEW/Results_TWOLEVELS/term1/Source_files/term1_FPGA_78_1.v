...
module FAU ( 
  ...
  assign new_n68_ = (~x14 | ~x18 | x19) & (~x19 | x26 | ~x13 | x18);
  ...
  assign new_n75_ = ~new_n76_ & new_n77_ & new_n78_ & (x17 | (x12 & x18));
  ...
  assign new_n81_ = ~x19 & (~x14 | ~x15 | ~x16 | ~x17 | ~x18);
  ...
  assign new_n86_ = (x18 | (x15 & x16 & x17)) & new_n87_ & (x15 | (x10 & x16 & x17));
