...
module FAU ( 
  ...
  assign z6 = x01 & x25 & ~x26 & new_n58_ & x27;
  assign new_n58_ = x28 & x29 & ~new_n52_ & (~x02 | ~x03);
  assign z7 = ~new_n61_ | ((x19 | x24) & new_n60_ & (x18 | x23));
  assign new_n60_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n61_ = x01 & (~x02 | ~x03) & x25 & ~x26 & ~x31;
  assign z8 = x00 & ~x26 & (new_n63_ | new_n67_);
  assign new_n63_ = x29 & x31 & ~x32 & ~new_n64_ & (x27 | x28);
  ...
  assign new_n67_ = x32 & (~new_n68_ | new_n73_ | (~x15 & (~new_n66_ | ~new_n72_)));
  ...
  assign new_n71_ = x29 & x31 & (x27 | x28);
  assign new_n72_ = x10 & x16;
  assign new_n73_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign z9 = x00 & ~x26 & (new_n75_ | ((~new_n76_ | new_n81_) & x33));
  assign new_n75_ = ~x31 & ~x33 & ~new_n64_ & (~x29 | (~x27 & ~x28));
  assign new_n76_ = (~x29 | (~x27 & ~x28)) & ~new_n77_ & new_n79_;
  ...
  assign new_n80_ = (x17 | (x12 & x18)) & (x13 | x18) & ~x31;
