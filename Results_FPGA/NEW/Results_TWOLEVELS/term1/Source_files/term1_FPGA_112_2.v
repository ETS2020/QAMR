...
module FAU ( 
  ...
  assign new_n54_ = x22 & (x18 | x23) & (x19 | x24);
  ...
  assign new_n61_ = x22 & (x19 | x24) & new_n53_ & (x18 | x23);
  ...
  assign new_n65_ = ~new_n67_ & (~x12 | ~x15 | ~x16 | ~new_n66_ | ~x18);
  ...
  assign new_n71_ = x32 & (~new_n72_ | ~x18 | ~x19 | ~x31);
  assign new_n72_ = x12 & x15 & x16;
  ...
  assign new_n77_ = x33 & (~new_n72_ | ~x18 | ~x19 | (x30 & ~x31) | (~x30 & x31));
  assign z0 = ~x32;
endmodule
