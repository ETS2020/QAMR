...
module FAU ( 
  ...
  assign z6 = x01 & x25 & new_n56_ & ~x26;
  assign new_n56_ = (~x02 | ~x03) & ~new_n52_ & ((x30 & (~x27 | ~x29)) | (x27 & x29 & ~x30));
  assign z7 = ~new_n58_ | (x31 & (~x27 | ~x29 | ~x30));
  assign new_n58_ = ~new_n59_ & new_n61_ & x01 & (~x02 | ~x03);
  assign new_n59_ = (x19 | x24) & new_n60_ & (x18 | x23);
  assign new_n60_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n61_ = x25 & ~x26 & (~x27 | ~x29 | ~x30 | x31);
  assign z8 = x00 & ~x26 & (new_n68_ | new_n69_ | (new_n63_ & x29));
  assign new_n63_ = ~new_n67_ & (x30 ? x32 : (x31 & ~new_n64_ & ~x32));
  ...
  assign new_n68_ = (new_n67_ | ~x29) & (x30 ? (x31 & ~new_n64_ & ~x32) : x32);
  assign new_n69_ = x32 & (~new_n70_ | (~x15 & (~new_n66_ | ~x10 | ~x16)));
  assign new_n70_ = ~new_n71_ & ~new_n72_ & ~new_n73_ & new_n74_ & (x14 | x19);
  ...
  assign z9 = x00 & ~x26 & (new_n77_ | new_n78_ | (new_n76_ & x29));
  assign new_n76_ = ~new_n67_ & ((x30 & x31 & ~new_n64_ & ~x33) | (~x31 & x33));
  assign new_n77_ = (new_n67_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n64_ & ~x33));
