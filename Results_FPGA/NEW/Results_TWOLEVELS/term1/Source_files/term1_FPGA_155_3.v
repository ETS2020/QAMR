// Benchmark "FAU" written by ABC on Wed Jul 29 06:24:10 2020
...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & ((x31 & new_n65_ & ~x32) | (~new_n70_ & x32));
  assign new_n65_ = ~new_n66_ & ((x29 & ~new_n69_ & ~x30) | (x30 & (new_n69_ | ~x29)));
  ...
  assign new_n70_ = ~new_n75_ & new_n71_ & ~new_n77_ & (x15 | (new_n68_ & new_n76_));
  ...
  assign z9 = x00 & ~x26 & (new_n86_ | new_n88_ | (new_n79_ & x29));
  assign new_n79_ = ~new_n69_ & ((~x31 & x33) | (x30 & x31 & (new_n80_ | new_n84_)));
  assign new_n80_ = x15 & (new_n83_ | (x16 & (new_n81_ | new_n82_)));
  assign new_n81_ = x17 & ((x14 & x18 & ~x19) | (x19 & ~x33 & x13 & ~x18));
  assign new_n82_ = x18 & x19 & ~x33 & x12 & ~x17;
  assign new_n83_ = x18 & x19 & ~x33 & x11 & ~x16 & x17;
  assign new_n84_ = x10 & ~x15 & x16 & new_n85_ & x19 & ~x33;
  assign new_n85_ = x17 & x18;
  assign new_n86_ = ~new_n87_ & ((x31 & x33) | (~x30 & (new_n80_ | new_n84_) & ~x31));
  assign new_n87_ = ~new_n69_ & x29;
  assign new_n88_ = x33 & (new_n89_ | ~new_n90_ | (~x16 & (~new_n85_ | ~x11)));
  assign new_n89_ = ~x15 & (~new_n76_ | ~new_n85_);
  assign new_n90_ = (x17 | (x12 & x18)) & new_n92_ & (x13 | x18) & (~new_n91_ | ~x17 | ~x18);
  assign new_n91_ = x15 & x16;
  assign new_n92_ = x19 & (~x30 | x31) & (x30 | ~x31);
  assign z0 = ~x32;
endmodule
