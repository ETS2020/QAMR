...
module FAU ( 
  ...
  assign new_n56_ = (~x02 | ~x03) & ~new_n57_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign new_n57_ = new_n52_ & new_n53_;
  assign z6 = x01 & x25 & ~x26 & new_n59_ & (~x02 | ~x03);
  assign new_n59_ = ~new_n57_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = (x27 & x28 & x29 & (new_n61_ | ~x31)) | ~new_n62_ | (x31 & (~x27 | ~x28 | ~x29));
  assign new_n61_ = x01 & x25 & ~x26 & new_n51_ & ~x30;
  assign new_n62_ = new_n64_ & ((~x19 & ~x24) | ~new_n63_ | (~x18 & ~x23));
  assign new_n63_ = new_n52_ & (x17 | x22);
  assign new_n64_ = x25 & ~x26 & x01 & (~x02 | ~x03);
  assign z8 = x00 & ~x26 & (x32 ? ~new_n71_ : new_n66_);
  assign new_n66_ = ~new_n67_ & ((x29 & ~new_n70_ & ~x30) | (x30 & x31 & (new_n70_ | ~x29)));
  ...
  assign new_n71_ = ~new_n76_ & new_n72_ & ~new_n78_ & (x15 | (new_n69_ & new_n77_));
  ...
  assign z9 = x00 & ~x26 & (new_n80_ | ((~new_n81_ | new_n88_) & x33));
  assign new_n80_ = x29 & x30 & x31 & ~x33 & ~new_n67_ & ~new_n70_;
  assign new_n81_ = ~new_n84_ & ~new_n82_ & ~new_n85_ & ~new_n86_ & new_n83_ & new_n87_;
  assign new_n82_ = ~x15 & (~new_n77_ | ~x17 | ~x18);
  assign new_n83_ = ~new_n70_ & (x13 | x18);
