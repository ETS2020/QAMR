// Benchmark "FAU" written by ABC on Wed Jul 29 06:23:25 2020
...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (new_n70_ | new_n71_ | ~new_n65_ | new_n72_);
  assign new_n65_ = ~new_n68_ & new_n66_ & ~new_n69_;
  assign new_n66_ = new_n67_ & (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  ...
  assign z9 = x00 & ~x26 & (~new_n79_ | (new_n74_ & x29));
  assign new_n74_ = (x27 | x28) & ((~x31 & x33) | (x30 & new_n75_ & x31));
  assign new_n75_ = ~x33 & (new_n78_ | (x15 & (new_n77_ | (~new_n76_ & x16))));
  assign new_n76_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n77_ = x17 & x18 & x19 & x11 & ~x16;
  assign new_n78_ = x17 & x18 & x19 & x10 & ~x15 & x16;
  assign new_n79_ = (new_n82_ | ((x30 | ~new_n75_ | x31) & (~x31 | ~x33))) & (new_n80_ | ~x33);
  assign new_n80_ = ~new_n71_ & ~new_n72_ & ~new_n68_ & ~new_n69_ & new_n67_ & new_n81_;
