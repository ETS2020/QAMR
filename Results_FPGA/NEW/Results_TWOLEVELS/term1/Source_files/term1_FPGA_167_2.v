...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (new_n65_ | ((~new_n70_ | new_n76_) & x32));
  assign new_n65_ = x31 & ~x32 & ~new_n66_ & ((x29 & ~new_n69_ & ~x30) | (x30 & (new_n69_ | ~x29)));
  ...
  assign new_n70_ = (x28 | (x27 ? (~x29 | ~x30) : x30)) & new_n71_ & ~new_n75_;
  ...
  assign z9 = x00 & ((new_n78_ & x29) | new_n79_ | (new_n81_ & ~x26));
  assign new_n78_ = ~new_n69_ & ((x30 & x31 & ~new_n66_ & ~x33) | (~x26 & ~x31 & x33));
  assign new_n79_ = ~new_n80_ & ((~x30 & ~x31 & ~new_n66_ & ~x33) | (~x26 & x31 & x33));
  assign new_n80_ = ~new_n69_ & x29;
  assign new_n81_ = x33 & (new_n76_ | new_n75_ | new_n72_ | new_n73_ | ~new_n82_);
