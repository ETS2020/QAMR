...
module FAU ( 
  ...
  assign new_n65_ = ~new_n66_ & ((x29 & ~new_n70_ & ~x30) | (x30 & (new_n70_ | ~x29)));
  assign new_n66_ = (~x15 | (~new_n68_ & (new_n67_ | ~x16))) & (~new_n69_ | ~x10 | x15 | ~x16);
  assign new_n67_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n68_ = x18 & x19 & ~x26 & x11 & ~x16 & x17;
  ...
  assign new_n73_ = (x13 | x18) & (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n74_ = x16 & ((~x14 & ~x19) | (x18 & x19 & x15 & x17));
  assign new_n75_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign new_n76_ = ~x19 & (~x17 | ~x18 | ~x15 | ~x16);
  assign new_n77_ = ~x15 & (~x17 | ~x18 | ~x10 | ~x16);
  assign z9 = x00 & ((new_n79_ & x29) | new_n84_ | (~new_n87_ & x33));
  assign new_n79_ = ~new_n70_ & (new_n80_ | (x16 & x30 & new_n83_ & x31));
  assign new_n80_ = ~x26 & ((~x31 & x33) | (new_n82_ & new_n81_ & x30 & x31 & ~x33));
  assign new_n81_ = x18 & x19;
  assign new_n82_ = ~x16 & x17 & x11 & x15;
  assign new_n83_ = ~x33 & ((~new_n67_ & x15) | (new_n69_ & x10 & ~x15));
  assign new_n84_ = ~new_n85_ & (new_n86_ | (x16 & ~x30 & new_n83_ & ~x31));
  assign new_n85_ = ~new_n70_ & x29;
  assign new_n86_ = ~x26 & ((x31 & x33) | (new_n82_ & new_n81_ & ~x30 & ~x31 & ~x33));
  assign new_n87_ = ~new_n90_ & (x26 | (~new_n76_ & new_n88_ & ~new_n77_));
  assign new_n88_ = (x16 | (x11 & x17 & x18)) & new_n89_ & (x17 | (x12 & x18));
  assign new_n89_ = (x30 | ~x31) & (~x30 | x31) & (x13 | x18);
