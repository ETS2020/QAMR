// Benchmark "FAU" written by ABC on Wed Jul 29 03:05:28 2020
...
module FAU ( 
  ...
  assign new_n38_ = x02 ? (x05 | x13) : (~x05 | x12 | ~x13 | (~new_n39_ & ~new_n40_));
  assign new_n39_ = x00 & (x01 ? ~x11 : (~x07 & ~x09));
  assign new_n40_ = ~x00 & ~x07 & (x01 ? ~x10 : ~x08);
