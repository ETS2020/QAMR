// Benchmark "FAU" written by ABC on Wed Jul 29 03:05:07 2020
...
module FAU ( 
  ...
  assign z01 = x02 ? (x04 & ~x05 & (x13 | (~x03 & ~x13))) : (~x04 & x05 & (x13 | (~x03 & ~x13)));
