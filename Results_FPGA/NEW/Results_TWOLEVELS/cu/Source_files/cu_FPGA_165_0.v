// Benchmark "FAU" written by ABC on Wed Jul 29 03:05:26 2020
...
module FAU ( 
  ...
  assign z06 = ~x03 & x04 & (x02 ? new_n40_ : (new_n38_ & ~x07));
  assign new_n38_ = ~x12 & x13 & (new_n39_ | (~x00 & x01 & ~x10));
  assign new_n39_ = x05 & (x00 ? (x01 ? ~x11 : ~x09) : (~x01 & ~x08));
