...
module FAU ( 
  ...
  wire new_n154_, new_n176_, new_n177_, new_n178_, new_n179_, new_n180_,
    new_n183_, new_n185_, new_n194_, new_n195_, new_n196_, new_n198_,
    new_n199_, new_n212_, new_n213_, new_n215_, new_n223_, new_n225_,
  ...
  assign z47 = ~x01 & ((new_n212_ & x77) | (new_n213_ & x04 & x07));
  assign new_n212_ = ~x78 & x79 & (~x81 ^ x84) & (x67 | x75);
  assign new_n213_ = ~x77 & x78 & ~x79;
  assign z48 = ~x01 & ((new_n215_ & x68) | (new_n213_ & x04 & x08));
  assign new_n215_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z49 = ~x01 & ((new_n215_ & x69) | (new_n213_ & x04 & x09));
  assign z50 = ~x01 & ((new_n215_ & x70) | (new_n213_ & x04 & x10));
  assign z51 = ~x01 & ((new_n215_ & x71) | (new_n213_ & x04 & x11));
  assign z52 = ~x01 & ((new_n215_ & x72) | (new_n213_ & x04 & x12));
  assign z53 = ~x01 & ((new_n215_ & x73) | (new_n213_ & x04 & x13));
  assign z54 = ~x79 & x78 & ~x77 & x14 & ~x01 & x04;
  ...
  assign z60 = ~x01 & ((new_n226_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n178_ | ~x79)));
  ...
  assign z64 = ~x01 & ((new_n246_ & x78 & ~x79) | (x79 & ~new_n239_ & x83));
