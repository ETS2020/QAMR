...
module FAU ( 
  ...
  assign z22 = ~x01 & ((~new_n177_ & ~x77) | (x04 & x77 & ~new_n179_ & x78));
  assign new_n177_ = (x41 | ~x75 | new_n178_ | ~x79) & (~x04 | ~x78 | x79);
  assign new_n178_ = x81 ^ x84;
  assign new_n179_ = x79 & (x42 | (new_n180_ & new_n181_));
  ...
  assign z47 = ~x01 & ((x04 & ~x77 & new_n215_ & x78) | (x77 & new_n214_ & ~x78));
  assign new_n214_ = x79 & ~new_n178_ & (x67 | x75);
  assign new_n215_ = ~x79 & (x52 ? x15 : x07);
  assign z48 = ~x01 & ((new_n217_ & x68) | (new_n218_ & x04));
  assign new_n217_ = x77 & ~x78 & ~new_n178_ & x79;
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((new_n217_ & x69) | (new_n220_ & x04));
  ...
  assign z51 = ~x01 & ((new_n217_ & x71) | (new_n224_ & x04));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n217_ & x72) | (new_n226_ & x04));
  ...
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n244_ | new_n245_)));
  assign new_n244_ = x04 & x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n245_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n235_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n247_ | ~x79)));
  assign new_n247_ = ~x42 & x77 & (~new_n180_ | ~new_n181_);
  assign z61 = ~x01 & x79 & ~new_n249_ & x80;
  assign new_n249_ = (x04 | ~x77 | ~x78) & (new_n178_ | (~x77 ^ x78));
