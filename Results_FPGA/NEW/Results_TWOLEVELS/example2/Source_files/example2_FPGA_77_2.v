...
module FAU ( 
  ...
  wire new_n154_, new_n156_, new_n157_, new_n158_, new_n159_, new_n181_,
    ...
    new_n242_, new_n245_, new_n247_, new_n248_, new_n249_, new_n251_,
    new_n253_, new_n255_;
  ...
  assign new_n158_ = x81 & x82 & ~x83 & x84;
  assign new_n159_ = x43 & ~x74 & x81 & x82 & ~x83 & x84;
  ...
  assign z22 = ~x01 & (new_n181_ | (~x41 & new_n182_ & x79));
  assign new_n181_ = x04 & x78 & (~x79 | (~x42 & ~new_n159_ & x77));
  ...
  assign z58 = ~x01 & (new_n240_ | (x77 & (new_n237_ | new_n239_)));
  assign new_n237_ = x04 & x78 & x79 & (new_n238_ | (new_n157_ & new_n158_));
  ...
  assign new_n242_ = (~x40 | (x78 ? ~x04 : x79)) & (~x04 | ~x78 | (x79 & (new_n159_ | x42)));
  assign z60 = ~x01 & ((new_n234_ & x79) | new_n181_ | (~x04 & ~x79));
  assign z61 = ~x01 & ~new_n245_ & x79;
  assign new_n245_ = ((x81 ^ x84) | (x77 ? (x78 | ~x80) : ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n249_ & x77) | (x78 & (x77 ? ~new_n247_ : ~new_n248_)));
  assign new_n247_ = x04 ? (x79 & (new_n159_ | x42)) : (~x79 | ~x81);
  assign new_n248_ = x79 ? (~x81 | ~x84) : ~x04;
  assign new_n249_ = x79 & x81 & x84 & (~x80 | (~x78 & x80));
  assign z63 = ~x01 & new_n251_ & x79;
  assign new_n251_ = x82 & ((~x04 & x77 & x78) | ((~x81 ^ x84) & (~x77 ^ ~x78)));
  assign z64 = ~x01 & ((new_n253_ & x79) | (x78 & ~x79 & x04 & ~x77));
  assign new_n253_ = x83 & ((~x04 & x77 & x78) | ((~x81 ^ x84) & (~x77 ^ ~x78)));
  assign z65 = ~x01 & new_n255_ & x79;
  assign new_n255_ = x84 & ((x78 & (x77 ? ~x04 : x81)) | (x77 & x81 & (~x80 | (~x78 & x80))));
  assign z55 = 1'b0;
endmodule
