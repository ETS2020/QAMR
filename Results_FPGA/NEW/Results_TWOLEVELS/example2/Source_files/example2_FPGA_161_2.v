...
module FAU ( 
  ...
  assign new_n196_ = (~x05 | ~x42 | (~x81 ^ x83)) & (x42 | ~x51 | ~x78 | ~x81);
  assign new_n197_ = (~x05 | ~x42 | (x81 ^ x83)) & (~x78 | x81 | x42 | ~x51);
  assign z34 = ~x01 & ~x04 & new_n199_ & x52;
  assign new_n199_ = x77 & ~new_n200_ & x79;
  assign new_n200_ = ((~x82 ^ x84) | ((~x78 | x81 | (x42 & x83)) & (~x42 | ~x81 | ~x83))) & ((x82 ^ x84) | ((~x78 | ~x81 | (x42 & x83)) & (~x42 | x81 | ~x83)));
  ...
  assign z58 = ~x01 & ((~new_n238_ & x04) | (~x79 & (new_n242_ | ~x04)));
  assign new_n238_ = x77 ? (~x79 | (~new_n239_ & (~new_n240_ | ~new_n241_))) : (~x78 | x79);
  assign new_n239_ = ~x40 & x42;
  assign new_n240_ = ~x42 & x43 & ~x74 & x78;
  assign new_n241_ = x82 & ~x83 & x84 & x80 & x81;
  assign new_n242_ = x40 & x77 & ~x78;
