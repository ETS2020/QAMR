// Benchmark "FAU" written by ABC on Wed Jul 29 06:48:40 2020
...
module FAU ( 
  ...
  assign z47 = ~x01 & (new_n215_ | (new_n214_ & x04));
  assign new_n214_ = ~x77 & x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n215_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z48 = ~x01 & ((new_n217_ & x04) | (new_n215_ & x68));
  assign new_n217_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((new_n219_ & x04) | (new_n215_ & x69));
  assign new_n219_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n221_ & x04) | (new_n215_ & x70));
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n223_ & x04) | (new_n215_ & x71));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n225_ & x04) | (new_n215_ & x72));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n227_ & x04) | (new_n215_ & x73));
