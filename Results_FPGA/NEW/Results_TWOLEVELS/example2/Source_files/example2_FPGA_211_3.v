...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n242_, new_n244_, new_n246_, new_n248_, new_n250_, new_n251_,
    new_n252_, new_n256_;
  ...
  assign z22 = ~x01 & (new_n181_ | (x77 & (new_n177_ | new_n180_)));
  assign new_n177_ = x04 & x78 & (~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n178_ = x43 & ~x74 & x80;
  assign new_n179_ = x81 & x82 & ~x83 & x84;
  assign new_n180_ = ~x41 & x66 & ~x78 & x79 & (~x81 ^ x84);
  assign new_n181_ = x04 & ~x77 & x78 & ~x79;
  ...
  assign new_n215_ = x79 & (~x81 ^ x84) & (x75 | (x67 & ~x78));
  ...
  assign new_n238_ = x04 & x78 & x79 & (new_n239_ | (new_n179_ & new_n240_));
  ...
  assign z59 = ~x01 & ((x77 & (new_n177_ | new_n244_)) | (~x04 & ~x79));
  assign new_n244_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n235_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n246_ | ~x79)));
  ...
  assign z64 = ~x01 & (new_n181_ | (x79 & ~new_n248_ & x83));
