...
module FAU ( 
  ...
  assign new_n177_ = x04 & (new_n178_ | (~x42 & x77 & ~new_n179_ & x80));
  assign new_n178_ = x78 & (x77 ? (~x79 | (~x42 & ~x80)) : ~x79);
  ...
  assign new_n243_ = (~x78 | (x79 & (x42 | x80))) & (x42 | new_n179_ | ~x80);
  assign new_n244_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n234_ & x79) | new_n177_ | (~x04 & ~x79));
  assign z61 = new_n247_ & ~x01;
  assign new_n247_ = x79 & x80 & (x77 ? ~x04 : (~x81 ^ x84));
  assign z62 = ~x01 & (new_n251_ | (~new_n249_ & x78));
  assign new_n249_ = x77 ? (x04 ? (~new_n250_ & x79) : (~x79 | ~x81)) : (x79 ? (~x81 | ~x84) : ~x04);
  assign new_n250_ = ~x42 & ~x80;
  assign new_n251_ = x77 & (new_n252_ | (x04 & ~x42 & ~new_n179_ & x80));
  assign new_n252_ = x81 & x84 & ~x78 & x79;
