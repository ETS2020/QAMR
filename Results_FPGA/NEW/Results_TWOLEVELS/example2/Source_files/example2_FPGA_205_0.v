...
module FAU ( 
  ...
  assign new_n243_ = x78 & (~x79 | (~x42 & (~new_n179_ | ~new_n180_)));
  ...
  assign new_n249_ = x04 ? (x79 & (x42 | (new_n179_ & new_n180_))) : (~x79 | ~x81);
