// Benchmark "FAU" written by ABC on Wed Jul 29 06:48:37 2020
...
module FAU ( 
  ...
  assign z48 = ~x01 & ((new_n217_ & x68) | (new_n219_ & x04));
  assign new_n217_ = x77 & new_n218_ & ~x78;
  assign new_n218_ = x79 & (x81 ^ ~x84);
  assign new_n219_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((x04 & new_n221_ & ~x77) | (x69 & new_n218_ & x77));
  assign new_n221_ = x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n217_ & x70) | (new_n223_ & x04));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n217_ & x71) | (new_n225_ & x04));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n217_ & x72) | (new_n227_ & x04));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n217_ & x73) | (new_n229_ & x04));
