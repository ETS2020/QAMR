...
module FAU ( 
  ...
  assign z49 = ~x01 & ((new_n219_ & x04) | (new_n220_ & x69));
  assign new_n219_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign new_n220_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z50 = ~x01 & ((new_n220_ & x70) | (new_n222_ & x04));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n220_ & x71) | (new_n224_ & x04));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n220_ & x72) | (new_n226_ & x04));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n220_ & x73) | (new_n228_ & x04));
