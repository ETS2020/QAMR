// Benchmark "FAU" written by ABC on Wed Jul 29 06:50:00 2020
...
module FAU ( 
  ...
  assign z51 = ~x01 & (new_n224_ | (new_n218_ & x71));
  assign new_n224_ = x04 & ~x77 & x78 & ~x79 & (x19 | ~x52);
  ...
  assign new_n234_ = (~x76 | (x77 & x78)) & (x01 | (~x81 ^ x84) | (~x77 ^ x78));
  ...
  assign z60 = ~x01 & (new_n249_ | new_n248_ | (x78 & (new_n246_ | new_n250_)));
  assign new_n246_ = x04 & (new_n247_ | (~x42 & x77 & (~new_n180_ | ~new_n181_)));
  assign new_n247_ = ~x79 & (x77 | (~x52 & ~x77));
  assign new_n248_ = ~x04 & ~x79;
  assign new_n249_ = x79 & (x81 ^ x84) & (x77 ^ x78);
  assign new_n250_ = x52 & ~x79;
