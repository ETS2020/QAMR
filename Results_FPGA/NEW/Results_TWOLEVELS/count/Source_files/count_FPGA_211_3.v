...
module FAU ( 
  ...
  assign new_n63_ = (x17 | ~new_n64_ | x19) & (new_n61_ | ~x24);
  assign new_n64_ = ~x21 & ~x22 & ~x23 & ~x24 & (x25 | (~x20 & ~x25));
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n66_ | (~new_n67_ & x25)));
  ...
  assign new_n82_ = new_n56_ & new_n83_ & new_n84_ & ~x25 & ~x26 & ~x27;
  assign new_n83_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n84_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n86_ | (~new_n82_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n86_ = new_n56_ & new_n83_ & new_n87_ & new_n88_;
