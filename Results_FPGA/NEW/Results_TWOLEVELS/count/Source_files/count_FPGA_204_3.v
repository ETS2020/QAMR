...
module FAU ( 
  ...
  assign new_n66_ = new_n57_ & new_n67_ & ~x24 & ~x25;
  assign new_n67_ = ~x22 & ~x23;
  assign z07 = (x16 & (new_n69_ | (~new_n66_ & x26))) | x18 | (~x08 & ~x16);
  assign new_n69_ = new_n57_ & new_n67_ & new_n70_;
  ...
  assign z14 = ~new_n91_ | (x16 & ((~new_n85_ & x33) | (new_n66_ & new_n89_)));
  assign new_n89_ = new_n90_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n96_ | (x16 & (new_n94_ | (x34 & (~new_n89_ | ~new_n93_))));
  assign new_n93_ = new_n67_ & ~x24 & ~x25 & ~x17 & ~x19 & ~x21;
  assign new_n94_ = new_n90_ & new_n95_ & new_n57_ & new_n67_ & ~x24 & ~x25;
  assign new_n95_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n96_ = (x00 | x16) & ~x18 & (~x20 | ~x34);
endmodule
