...
module FAU ( 
  ...
  assign z08 = ~new_n78_ | (x16 & (new_n77_ | ((new_n73_ | new_n75_) & ~x19)));
  assign new_n73_ = ~x17 & ~x20 & ~x21 & new_n74_ & ~x22;
  assign new_n74_ = ~x24 & ~x25 & ~x26 & ~x27 & (x28 | (~x23 & ~x28));
  assign new_n75_ = ~new_n76_ & x27;
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~new_n56_ & x27;
  assign new_n78_ = ~x18 & (x07 | x16);
  assign z09 = (x16 & (new_n82_ | (~new_n80_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n80_ = new_n56_ & (x19 | (new_n81_ & ~x21 & ~x22 & ~x24));
  assign new_n81_ = ~x25 & ~x26 & ~x27;
  assign new_n82_ = new_n83_ & ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n85_ | (new_n87_ & new_n90_))) | x18 | (~x05 & ~x16);
  ...
  assign new_n92_ = new_n56_ & (x19 | (new_n66_ & new_n89_ & ~x25 & ~x26));
  assign new_n93_ = new_n90_ & new_n88_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign new_n97_ = new_n56_ & new_n66_ & new_n81_ & new_n98_;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n100_ | new_n102_));
  assign new_n100_ = x32 & (~new_n56_ | (~x19 & (~new_n70_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n56_ & new_n66_ & new_n86_ & new_n103_;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n105_ | (new_n67_ & new_n107_)));
  assign new_n105_ = x33 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n106_)));
  assign new_n106_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = new_n108_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n110_ | (new_n67_ & new_n111_)));
  assign new_n110_ = x34 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n89_ | ~new_n108_)));
