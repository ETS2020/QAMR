...
module FAU ( 
  ...
  assign new_n90_ = new_n56_ & new_n64_ & new_n72_ & new_n83_ & new_n91_;
  assign new_n91_ = ~x29 & ~x30;
  assign z12 = (~new_n93_ & x16) | x18 | (~x03 & ~x16);
  assign new_n93_ = (~x31 | (new_n56_ & (new_n94_ | x19))) & (~new_n95_ | ~new_n56_ | ~new_n65_);
  assign new_n94_ = new_n73_ & new_n79_ & new_n91_ & ~x28;
  assign new_n95_ = new_n79_ & ~x25 & ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = (~new_n97_ & x16) | x18 | (~x02 & ~x16);
  assign new_n97_ = (new_n100_ | ~x32) & (~new_n98_ | ~new_n99_ | ~new_n91_ | x31 | x32);
  assign new_n98_ = new_n56_ & new_n65_;
  assign new_n99_ = new_n83_ & ~x25 & ~x26;
  ...
  assign new_n103_ = ~x17 & ~x20 & ~x22 & ~x23 & new_n104_ & ~x24;
  assign new_n104_ = ~x25 & ~x26 & ~x27 & ~x28 & new_n105_ & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33 & (x34 | (~x21 & ~x34));
  assign new_n106_ = x33 & (~new_n76_ | ~new_n87_ | x30 | x31 | x32);
  assign new_n107_ = ~new_n56_ & x33;
  assign new_n108_ = ~x18 & (x01 | x16);
  assign z15 = (x16 & (new_n110_ | (new_n68_ & new_n113_))) | x18 | (~x00 & ~x16);
  assign new_n110_ = x34 & (~new_n56_ | (~x19 & (~new_n111_ | ~new_n112_)));
  assign new_n111_ = new_n79_ & ~x25 & ~x22 & ~x23 & ~x24;
  assign new_n112_ = ~x31 & ~x32 & ~x33 & new_n91_ & ~x28;
  assign new_n113_ = new_n114_ & new_n79_ & ~x28 & ~x29;
