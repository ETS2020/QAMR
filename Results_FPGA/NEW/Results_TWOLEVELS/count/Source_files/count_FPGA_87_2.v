...
module FAU ( 
  ...
  assign z04 = (~new_n61_ & ~x20) | (~x11 & ~x16) | x18 | (x16 & x20 & x23);
  assign new_n61_ = (x17 | x19 | x21 | x22 | x23) & (~x23 | (~x17 & ~x19 & ~x21 & ~x22));
  ...
  assign new_n77_ = new_n65_ & new_n70_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n79_ & x16) | x18 | (~x04 & ~x16);
  assign new_n79_ = (~x30 | (new_n65_ & new_n70_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n70_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n82_ | (~new_n81_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n81_ = new_n65_ & new_n70_ & ~x29 & ~x30 & ~x27 & ~x28;
