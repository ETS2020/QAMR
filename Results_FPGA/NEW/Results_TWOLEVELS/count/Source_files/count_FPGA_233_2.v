...
module FAU ( 
  ...
  assign new_n67_ = (~x25 | (new_n56_ & (new_n65_ | x19))) & (~new_n57_ | ~new_n68_);
  ...
  assign new_n74_ = new_n56_ & (x19 | (new_n64_ & new_n75_));
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign new_n76_ = new_n77_ & ~x23 & ~x24 & new_n78_ & ~x25;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n78_ = ~x26 & ~x27;
  assign z09 = (x16 & (new_n81_ | (~new_n80_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n80_ = new_n56_ & (x19 | (new_n64_ & new_n78_ & ~x24 & ~x25));
  assign new_n81_ = new_n77_ & ~x23 & ~x24 & ~x25 & new_n82_ & ~x26;
  assign new_n82_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n86_ | (~new_n84_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n84_ = new_n56_ & (x19 | (new_n65_ & new_n85_ & new_n82_));
  assign new_n85_ = ~x25 & ~x26;
  assign new_n86_ = new_n87_ & new_n75_ & new_n88_ & ~x27;
  assign new_n87_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = ~x28 & ~x29;
  assign z11 = ~new_n93_ | (x16 & (new_n91_ | (x30 & (new_n90_ | ~new_n56_))));
  assign new_n90_ = ~x19 & (~new_n65_ | ~new_n85_ | ~new_n88_ | x27);
  assign new_n91_ = new_n87_ & new_n75_ & new_n82_ & new_n92_;
  assign new_n92_ = ~x29 & ~x30;
  assign new_n93_ = ~x18 & (x04 | x16);
  assign z12 = ~new_n99_ | (x16 & (new_n97_ | (x31 & (new_n95_ | ~new_n56_))));
  assign new_n95_ = ~x19 & (~new_n71_ | ~new_n96_);
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n56_ & new_n65_ & new_n98_ & new_n78_ & ~x25;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n99_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n104_ | (x16 & (new_n101_ | x17 | (new_n102_ & new_n103_)));
  assign new_n101_ = x32 & (x19 | x20 | x31 | (~x19 & (~new_n71_ | ~new_n96_)));
  assign new_n102_ = new_n68_ & ~x19 & ~x20 & ~x21;
  assign new_n103_ = new_n82_ & ~x26 & new_n92_ & ~x31 & ~x32;
  assign new_n104_ = ~x18 & (x02 | x16);
  assign z14 = ~new_n109_ | (x16 & (new_n106_ | (x33 & (~new_n102_ | ~new_n103_))));
  assign new_n106_ = new_n107_ & new_n108_ & new_n68_ & ~x19 & ~x20 & ~x21;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n114_ | (x16 & ((~new_n106_ & x34) | (new_n111_ & new_n113_)));
  assign new_n111_ = new_n112_ & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n112_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n113_ = new_n82_ & new_n92_ & ~x33 & ~x34 & ~x31 & ~x32;
