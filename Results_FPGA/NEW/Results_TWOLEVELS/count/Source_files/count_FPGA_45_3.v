...
module FAU ( 
  ...
  assign z08 = ~new_n79_ | (x16 & (new_n78_ | ((new_n74_ | new_n76_) & ~x19)));
  assign new_n74_ = ~x17 & ~x20 & ~x21 & new_n75_ & ~x22;
  assign new_n75_ = ~x23 & ~x24 & ~x26 & ~x27 & (x28 | (~x25 & ~x28));
  assign new_n76_ = x27 & (~new_n64_ | ~new_n77_);
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign new_n78_ = ~new_n56_ & x27;
  assign new_n79_ = ~x18 & (x07 | x16);
  assign z09 = (~new_n81_ & x16) | x18 | (~x06 & ~x16);
  assign new_n81_ = (~x28 | (new_n56_ & (new_n82_ | x19))) & (~new_n83_ | ~new_n84_);
  ...
  assign new_n86_ = new_n88_ & (x19 | (new_n64_ & new_n87_));
  assign new_n87_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n88_ = ~x17 & ~x19 & ~x20 & ~x28;
  assign new_n89_ = new_n90_ & new_n77_ & ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z11 = (x16 & (new_n92_ | (~new_n86_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n92_ = ~x25 & ((x29 & x30) | (new_n90_ & new_n93_ & ~x28 & ~x29 & ~x30));
  assign new_n93_ = ~x24 & ~x26 & ~x27;
  assign z12 = ~new_n98_ | (x16 & (new_n95_ | (x31 & (~new_n86_ | new_n97_))));
  assign new_n95_ = new_n56_ & new_n65_ & new_n96_ & ~x25 & ~x26 & ~x27;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = ~x25 & (x29 | x30);
  assign new_n98_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n104_ | (x16 & (new_n100_ | (x32 & (~new_n86_ | new_n103_))));
  assign new_n100_ = new_n56_ & new_n65_ & new_n101_ & new_n102_;
  assign new_n101_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n103_ = ~x25 & (x29 | x30 | x31);
  assign new_n104_ = ~x18 & (x02 | x16);
  assign z14 = (x16 & (new_n106_ | (new_n68_ & new_n108_))) | x18 | (~x01 & ~x16);
  assign new_n106_ = x33 & (new_n107_ | ~new_n88_ | (~x19 & (~new_n64_ | ~new_n87_)));
  assign new_n107_ = ~x25 & (x29 | x30 | x31 | x32);
  assign new_n108_ = new_n109_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (x16 & (new_n111_ | (new_n68_ & new_n113_))) | x18 | (~x00 & ~x16);
  assign new_n111_ = x34 & (new_n112_ | ~new_n88_ | (~x19 & (~new_n64_ | ~new_n87_)));
  assign new_n112_ = ~x25 & (x29 | x30 | x31 | x32 | x33);
