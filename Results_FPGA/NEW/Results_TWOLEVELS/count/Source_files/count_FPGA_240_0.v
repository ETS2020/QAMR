...
module FAU ( 
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n71_ | new_n73_));
  assign new_n71_ = ~x17 & ~x19 & ~x20 & new_n72_ & ~x21;
  ...
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n78_ | (~new_n65_ & x28)));
  assign new_n78_ = ~x17 & ~x19 & ~x20 & new_n79_ & ~x21;
  assign new_n79_ = ~x22 & ~x23 & (x24 | (~x24 & (x25 | (~x25 & (x26 | (~x26 & x27))))));
