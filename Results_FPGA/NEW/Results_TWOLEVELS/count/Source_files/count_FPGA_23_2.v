...
module FAU ( 
  ...
  assign z07 = ~new_n72_ | (~x20 & (new_n69_ | new_n70_));
  assign new_n69_ = x26 & (~new_n67_ | x17 | x19 | x21);
  assign new_n70_ = new_n71_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n71_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n72_ = (x08 | x16) & ~x18 & (~x16 | ~x20 | ~x26);
  ...
  assign new_n78_ = new_n59_ & ~x23 & ~x24 & ~x25 & new_n79_ & ~x26;
  assign new_n79_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n81_ | (~new_n78_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n81_ = new_n61_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n61_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n75_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n61_ & new_n75_ & new_n79_ & ~x29 & ~x30;
  ...
  assign new_n89_ = new_n56_ & new_n64_ & new_n90_ & new_n79_ & ~x25 & ~x26;
  ...
  assign z15 = (~new_n96_ & x16) | x18 | (~x00 & ~x16);
  assign new_n96_ = (~x34 | (new_n57_ & new_n67_ & new_n93_ & new_n94_)) & (~new_n93_ | ~new_n97_ | ~new_n57_ | ~new_n67_);
