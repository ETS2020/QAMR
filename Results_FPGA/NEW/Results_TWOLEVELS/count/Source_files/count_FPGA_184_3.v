...
module FAU ( 
  ...
  assign z06 = (~new_n66_ & x16) | (~x09 & ~x16) | x18 | (x20 & x25);
  assign new_n66_ = (~x25 | (new_n67_ & ~x22 & ~x23 & ~x24)) & (~new_n57_ | x24 | x25 | x22 | x23);
  assign new_n67_ = ~x17 & ~x19 & ~x21;
  assign z07 = (x16 & (new_n70_ | (~new_n69_ & x26))) | x18 | (~x08 & ~x16);
  ...
  assign z14 = ~new_n92_ | (x16 & ((new_n69_ & new_n90_) | (~new_n86_ & x33)));
  assign new_n90_ = new_n91_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n91_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n92_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n95_ | (x16 & ((new_n69_ & new_n94_) | (x34 & (~new_n69_ | ~new_n90_))));
