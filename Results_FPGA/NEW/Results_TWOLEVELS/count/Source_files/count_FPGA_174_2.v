...
module FAU ( 
  ...
  assign new_n71_ = new_n59_ & new_n72_ & ~x23 & ~x24;
  assign new_n72_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n74_ | (~new_n71_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n74_ = new_n59_ & new_n75_ & new_n76_;
  ...
  assign new_n79_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = ~new_n85_ | (x16 & (new_n83_ | (~x17 & ~new_n81_ & ~x19)));
  assign new_n81_ = ~x20 & (~new_n82_ | ~new_n75_ | x21 | x22);
  assign new_n82_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n83_ = x30 & (~new_n79_ | ~new_n84_ | x17 | x19);
  assign new_n84_ = ~x21 & ~x22 & ~x23;
  assign new_n85_ = ~x18 & (x04 | x16);
  assign z12 = (~new_n87_ & x16) | x18 | (~x03 & ~x16);
  assign new_n87_ = (~x31 | (new_n88_ & new_n72_ & ~x28 & ~x29 & ~x30)) & (~new_n88_ | ~new_n72_ | x30 | x31 | x28 | x29);
  assign new_n88_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z13 = (x16 & (new_n92_ | (~new_n90_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n90_ = new_n88_ & new_n72_ & new_n91_ & ~x30 & ~x31;
  assign new_n91_ = ~x28 & ~x29;
  assign new_n92_ = new_n66_ & new_n94_ & new_n76_ & new_n93_ & ~x31 & ~x32;
  assign new_n93_ = ~x29 & ~x30;
  assign new_n94_ = ~x17 & ~x19 & ~x21;
  assign z14 = (x16 & (new_n96_ | (~new_n92_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n96_ = new_n66_ & new_n94_ & new_n97_ & new_n91_ & ~x26 & ~x27;
  ...
  assign new_n101_ = new_n102_ & new_n93_ & ~x27 & ~x28;
