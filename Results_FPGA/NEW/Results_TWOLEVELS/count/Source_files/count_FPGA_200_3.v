...
module FAU ( 
  ...
  assign new_n70_ = ~new_n71_ & (~x26 | (new_n56_ & (new_n72_ | x19)));
  assign new_n71_ = new_n57_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n72_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z08 = (~new_n74_ & x16) | x18 | (~x07 & ~x16);
  assign new_n74_ = ~new_n75_ & (~x27 | (new_n56_ & (new_n78_ | x19)));
  assign new_n75_ = new_n76_ & ~x23 & ~x24 & new_n77_ & ~x25;
  ...
  assign new_n80_ = new_n56_ & (x19 | (new_n64_ & new_n77_ & ~x24 & ~x25));
  assign new_n81_ = new_n76_ & new_n82_;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~new_n84_ & x16) | x18 | (~x05 & ~x16);
  assign new_n84_ = (x19 | ((x17 | ~new_n85_ | x20) & (new_n87_ | ~x29))) & (~x29 | (~x17 & ~x19 & ~x20));
  assign new_n85_ = ~x21 & ~x22 & ~x23 & new_n86_ & ~x24;
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28 & (x30 | (~x29 & ~x30));
  assign new_n87_ = new_n65_ & new_n88_;
  assign new_n88_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z11 = (~new_n90_ & x16) | x18 | (~x04 & ~x16);
  assign new_n90_ = ~new_n91_ & (~x30 | (new_n56_ & (new_n87_ | x19)));
  assign new_n91_ = new_n56_ & new_n64_ & new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n96_ | (~new_n94_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n94_ = new_n56_ & (new_n95_ | x19);
  assign new_n95_ = new_n72_ & new_n77_ & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n97_ & new_n56_ & new_n65_;
  assign new_n97_ = new_n77_ & ~x25 & new_n98_ & ~x28 & ~x29;
  ...
  assign new_n101_ = new_n72_ & ~x26 & ~x27 & ~x28 & new_n98_ & ~x29;
  assign new_n102_ = new_n88_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n104_ | new_n106_));
  assign new_n104_ = new_n68_ & new_n105_ & new_n77_ & ~x28 & ~x29;
  ...
  assign new_n109_ = (~new_n68_ | ~new_n111_) & (~x34 | (~new_n110_ & new_n56_));
  assign new_n110_ = ~x19 & (~new_n78_ | ~new_n105_ | x27 | x28 | x29);
  assign new_n111_ = new_n112_ & new_n77_ & ~x28 & ~x29;
