...
module FAU ( 
  ...
  assign z12 = ~new_n83_ | (x16 & ((~new_n81_ & x31) | (new_n63_ & new_n82_)));
  assign new_n81_ = new_n61_ & new_n69_ & new_n75_ & ~x29 & ~x30;
  assign new_n82_ = new_n72_ & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n83_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n87_ | (x16 & ((new_n63_ & new_n85_) | (x32 & (~new_n63_ | ~new_n82_))));
  assign new_n85_ = new_n86_ & new_n75_ & ~x25 & ~x26;
  assign new_n86_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n87_ = ~x18 & (x02 | x16);
  assign z14 = ~new_n93_ | (~x20 & ((new_n89_ & new_n91_) | (x33 & (~new_n89_ | ~new_n90_))));
  assign new_n89_ = new_n66_ & ~x17 & ~x19 & ~x21;
  assign new_n90_ = new_n86_ & new_n75_ & ~x26;
  assign new_n91_ = new_n92_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n92_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n93_ = (x01 | x16) & ~x18 & (~x16 | ~x20 | ~x33);
  assign z15 = ~new_n96_ | (x16 & ((new_n65_ & new_n95_) | (x34 & (~new_n65_ | ~new_n91_))));
