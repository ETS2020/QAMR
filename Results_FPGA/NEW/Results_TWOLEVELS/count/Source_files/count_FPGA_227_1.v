...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n57_, new_n60_, new_n62_, new_n64_, new_n65_, new_n67_,
  ...
  assign z04 = (x16 & (new_n60_ | (~new_n57_ & x23))) | x18 | (~x11 & ~x16);
  assign new_n60_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23;
  assign z05 = (x16 & (new_n62_ | (~new_n60_ & x24))) | x18 | (~x10 & ~x16);
  assign new_n62_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n64_ | (~new_n62_ & x25)));
  assign new_n64_ = new_n56_ & new_n65_;
  assign new_n65_ = ~x21 & ~x23 & ~x24 & ~x25;
  assign z07 = (x16 & (new_n67_ | (~new_n64_ & x26))) | x18 | (~x08 & ~x16);
  assign new_n67_ = new_n57_ & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n69_ | (~new_n67_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n69_ = new_n57_ & new_n70_ & ~x23 & ~x24;
