// Benchmark "FAU" written by ABC on Wed Jul 29 04:07:36 2020
...
module FAU ( 
  ...
  assign new_n59_ = (x17 | x19 | x21 | x22 | (~x23 & (x20 | x23))) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z04 = (~new_n61_ & x16) | x18 | (~x11 & ~x16);
  assign new_n61_ = (~x23 | (~x17 & ~x19 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  ...
  assign z06 = (x16 & (new_n67_ | (~new_n63_ & x25))) | x18 | (~x09 & ~x16);
  ...
  assign new_n72_ = new_n73_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n73_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = (x16 & (new_n75_ | (~new_n72_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n75_ = new_n73_ & new_n76_;
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n78_ | (~new_n75_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n78_ = new_n65_ & new_n70_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n80_ & x16) | x18 | (~x04 & ~x16);
  assign new_n80_ = (~x30 | (new_n65_ & new_n70_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n70_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n83_ | (~new_n82_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n82_ = new_n65_ & new_n70_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign new_n86_ = new_n56_ & new_n64_ & new_n87_ & new_n88_;
  assign new_n87_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n88_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n92_ | (x16 & ((~new_n86_ & x33) | (new_n67_ & new_n90_)));
  assign new_n90_ = new_n91_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n91_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n92_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n95_ | (x16 & ((new_n67_ & new_n94_) | (x34 & (~new_n67_ | ~new_n90_))));
  assign new_n94_ = new_n91_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
