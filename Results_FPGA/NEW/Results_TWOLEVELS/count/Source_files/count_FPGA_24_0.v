...
module FAU ( 
  ...
  assign new_n66_ = (~x25 | (new_n67_ & new_n69_)) & (~new_n68_ | ~new_n70_);
  ...
  assign new_n72_ = (x17 | x19 | new_n73_ | x20) & (~x26 | (~x17 & ~x19 & ~x20));
  assign new_n73_ = ~x21 & (x21 | (~x22 & (x22 | (~x23 & (x23 | (~x24 & (x24 | ~x25)))))));
