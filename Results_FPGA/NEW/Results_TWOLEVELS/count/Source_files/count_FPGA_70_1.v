...
module FAU ( 
  ...
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n72_ | x27));
  assign z09 = (~new_n76_ & x16) | x18 | (~x06 & ~x16);
  assign new_n76_ = (~x28 | (new_n56_ & (new_n77_ | x19))) & (~new_n78_ | ~new_n79_);
  ...
  assign new_n81_ = new_n56_ & (x19 | (new_n64_ & new_n82_ & ~x24 & ~x25));
  assign new_n82_ = ~x26 & ~x28;
  assign new_n83_ = new_n78_ & ~x23 & ~x24 & ~x25 & new_n84_ & ~x26;
  assign new_n84_ = ~x28 & ~x29;
  assign z11 = (x16 & (new_n88_ | (~new_n86_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n86_ = new_n56_ & (x19 | (new_n65_ & new_n87_));
  assign new_n87_ = ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n88_ = new_n89_ & new_n73_ & ~x28 & ~x29 & ~x30;
  ...
  assign new_n92_ = ~x25 & ~x26 & ~x28 & ~x29 & ~x30;
  assign new_n93_ = new_n89_ & new_n73_ & new_n84_ & new_n94_;
  assign new_n94_ = ~x30 & ~x31;
  assign z13 = (x16 & (new_n97_ | (~new_n96_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n96_ = new_n56_ & (x19 | (new_n71_ & new_n82_ & new_n94_ & ~x29));
  assign new_n97_ = new_n56_ & new_n65_ & new_n98_ & new_n82_ & ~x25;
  ...
  assign new_n101_ = ~x26 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = new_n56_ & new_n65_ & new_n87_ & new_n94_ & ~x32 & ~x33;
  assign z15 = (x16 & (new_n104_ | (new_n68_ & new_n106_))) | x18 | (~x00 & ~x16);
  assign new_n104_ = x34 & (~new_n56_ | (~x19 & (~new_n77_ | ~new_n105_)));
  assign new_n105_ = ~x28 & ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n106_ = new_n107_ & new_n82_ & ~x29 & ~x30;
