...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n66_,
    ...
    new_n89_, new_n90_, new_n91_, new_n92_, new_n94_;
  ...
  assign new_n73_ = new_n59_ & new_n74_ & ~x23 & ~x24 & ~x25;
  assign new_n74_ = ~x26 & ~x27 & ~x28;
  assign z10 = (~new_n76_ & x16) | x18 | (~x05 & ~x16);
  assign new_n76_ = (new_n73_ | ~x29) & (~new_n61_ | ~new_n69_ | x27 | x28 | x29);
  ...
  assign new_n81_ = new_n63_ & new_n82_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = new_n83_ & ~x28 & ~x29;
  assign new_n83_ = ~x30 & ~x31;
  assign z13 = (x16 & (new_n85_ | (~new_n81_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n85_ = ~x17 & ~x19 & ~x21 & ~x22 & new_n86_ & ~x23;
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & new_n87_ & ~x28;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32 & (x33 | (~x20 & ~x33));
  assign z14 = (x16 & (new_n91_ | (~new_n89_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n89_ = new_n90_ & new_n66_ & ~x17 & ~x19 & ~x21;
  assign new_n90_ = new_n74_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n91_ = new_n65_ & new_n92_ & new_n83_ & ~x32 & ~x33;
  assign new_n92_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (~new_n94_ & x16) | x18 | (~x00 & ~x16);
  assign new_n94_ = (~x34 | (new_n65_ & new_n92_ & new_n83_ & ~x32 & ~x33)) & (~new_n65_ | ~new_n92_ | ~new_n83_ | x32 | x33 | x34);
endmodule
