// Benchmark "FAU" written by ABC on Wed Jul 29 04:07:37 2020
...
module FAU ( 
  ...
  assign z07 = (x16 & (new_n70_ | (~new_n69_ & x26))) | ~new_n72_ | (~x08 & ~x16);
  assign new_n69_ = new_n67_ & ~x17 & ~x19 & ~x21;
  assign new_n70_ = new_n57_ & new_n71_ & ~x22 & ~x23;
  assign new_n71_ = ~x24 & ~x25 & ~x26;
  assign new_n72_ = ~x18 & (~x20 | ~x26);
  assign z08 = (x16 & (new_n74_ | (~new_n70_ & x27))) | x18 | (~x07 & ~x16);
  ...
  assign new_n79_ = new_n61_ & new_n71_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n81_ & x16) | x18 | (~x04 & ~x16);
  assign new_n81_ = (~x30 | (new_n61_ & new_n71_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n71_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n84_ | (~new_n83_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n83_ = new_n61_ & new_n71_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign new_n95_ = (~x34 | (new_n57_ & new_n67_ & new_n92_ & new_n93_)) & (~new_n92_ | ~new_n96_ | ~new_n57_ | ~new_n67_);
