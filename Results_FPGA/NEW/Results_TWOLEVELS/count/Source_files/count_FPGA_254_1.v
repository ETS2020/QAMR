// Benchmark "FAU" written by ABC on Wed Jul 29 04:08:24 2020
...
module FAU ( 
  ...
  assign new_n75_ = (~x27 | (new_n56_ & (new_n76_ | x19))) & (~new_n77_ | ~new_n78_);
  ...
  assign new_n80_ = new_n56_ & (x19 | (new_n64_ & new_n81_ & ~x24 & ~x25));
  ...
  assign new_n85_ = new_n56_ & (x19 | (new_n65_ & new_n86_));
  ...
  assign new_n92_ = new_n56_ & (x19 | (new_n65_ & new_n90_ & ~x25 & ~x26));
  assign new_n93_ = new_n88_ & new_n89_ & new_n83_ & new_n94_;
  assign new_n94_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n97_ | (~new_n96_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n96_ = new_n56_ & (x19 | (new_n72_ & new_n81_ & new_n94_ & ~x28));
  assign new_n97_ = new_n56_ & new_n65_ & new_n98_ & new_n81_ & ~x25;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n100_ | new_n102_));
  assign new_n100_ = x32 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n56_ & new_n65_ & new_n86_ & new_n94_ & ~x31 & ~x32;
  assign z14 = (x16 & (new_n106_ | (~new_n104_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n104_ = new_n56_ & (x19 | (new_n76_ & new_n105_));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = new_n57_ & new_n69_ & new_n107_ & new_n108_;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n106_ | x34));
endmodule
