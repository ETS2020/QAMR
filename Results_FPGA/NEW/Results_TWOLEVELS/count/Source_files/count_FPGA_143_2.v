...
module FAU ( 
  ...
  assign new_n72_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = ~new_n77_ | (~x20 & (new_n74_ | new_n75_));
  assign new_n74_ = x28 & (~new_n72_ | x17 | x19 | x21 | x22);
  assign new_n75_ = new_n76_ & ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign new_n76_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n77_ = (x06 | x16) & ~x18 & (~x16 | ~x20 | ~x28);
  assign z10 = (x16 & (new_n81_ | (~new_n79_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n79_ = new_n59_ & new_n80_;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n81_ = new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n69_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n61_ & new_n69_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = ~new_n95_ | (x16 & ((~new_n89_ & x33) | (new_n66_ & new_n93_)));
  assign new_n93_ = new_n94_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n98_ | (x16 & ((new_n66_ & new_n97_) | (x34 & (~new_n66_ | ~new_n93_))));
