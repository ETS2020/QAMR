...
module FAU ( 
  ...
  assign new_n70_ = (~x26 | (new_n71_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n71_ | x22 | x23 | x24 | x25 | x26);
  assign new_n71_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z08 = (~new_n73_ & x16) | x18 | (~x07 & ~x16);
  assign new_n73_ = (x17 | x19 | new_n74_ | x20) & (~x27 | (~x17 & ~x19 & ~x20));
  assign new_n74_ = ~x21 & (x21 | (~x22 & (x22 | (~x23 & (x23 | (~x24 & (x24 | (~x25 & (x25 | ~x26)))))))));
