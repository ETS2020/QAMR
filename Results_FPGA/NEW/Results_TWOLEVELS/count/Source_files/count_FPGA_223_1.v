...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n59_, new_n61_, new_n63_, new_n64_, new_n65_,
    ...
    new_n93_, new_n96_, new_n97_, new_n98_, new_n100_, new_n101_,
  ...
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n92_ | x31));
  assign z13 = (x16 & (new_n97_ | (~new_n96_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n96_ = new_n56_ & (x19 | (new_n71_ & new_n80_ & new_n93_ & ~x28));
  ...
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n102_ = new_n56_ & new_n65_ & new_n85_ & new_n93_ & ~x32 & ~x33;
  assign z15 = (x16 & (new_n104_ | (new_n68_ & new_n106_))) | x18 | (~x00 & ~x16);
  assign new_n104_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n105_)));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n106_ = new_n107_ & new_n80_ & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x32 & ~x33 & ~x34;
endmodule
