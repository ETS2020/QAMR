...
module FAU ( 
  ...
  assign new_n70_ = (~x26 | (~x17 & ~x19 & ~x20)) & (x19 | ((new_n68_ | ~x26) & (x17 | ~new_n71_ | x20)));
  assign new_n71_ = ~x21 & ~x22 & ~x23 & ~x24 & (x25 | ~x26);
  assign z08 = (~new_n73_ & x16) | x18 | (~x07 & ~x16);
  assign new_n73_ = (~x27 | (new_n56_ & (new_n74_ | x19))) & (~new_n57_ | ~new_n75_);
  assign new_n74_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x26;
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x26 & ~x27;
  assign z09 = (~new_n77_ & x16) | x18 | (~x06 & ~x16);
  assign new_n77_ = (~x28 | (new_n56_ & (new_n78_ | x19))) & (~new_n79_ | ~new_n80_);
  assign new_n78_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x26 & ~x27;
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n80_ = ~x23 & ~x24 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n85_ | (~new_n82_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n82_ = new_n56_ & (x19 | (new_n83_ & new_n84_ & ~x24 & ~x26));
  assign new_n83_ = ~x21 & ~x22 & ~x23;
  assign new_n84_ = ~x27 & ~x28;
  assign new_n85_ = new_n79_ & ~x23 & ~x24 & ~x26 & new_n86_ & ~x27;
  assign new_n86_ = ~x28 & ~x29;
  assign z11 = (x16 & (new_n90_ | (~new_n88_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n88_ = new_n56_ & (x19 | (new_n68_ & new_n89_));
  ...
  assign new_n94_ = new_n56_ & (x19 | (new_n68_ & new_n95_));
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n91_ & new_n92_ & new_n86_ & new_n97_;
  assign new_n97_ = ~x30 & ~x31;
  assign z13 = (x16 & (new_n100_ | (~new_n99_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n99_ = new_n56_ & (x19 | (new_n74_ & new_n84_ & new_n97_ & ~x29));
  assign new_n100_ = new_n56_ & new_n68_ & new_n101_ & new_n84_ & ~x26;
  ...
  assign new_n105_ = new_n56_ & new_n68_ & new_n89_ & new_n97_ & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n107_ | new_n109_));
  assign new_n107_ = x34 & (~new_n56_ | (~x19 & (~new_n78_ | ~new_n108_)));
  assign new_n108_ = ~x28 & ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = new_n111_ & new_n112_ & new_n57_ & new_n110_;
  assign new_n110_ = ~x22 & ~x23 & ~x24 & ~x26;
