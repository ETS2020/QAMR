...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n59_, new_n61_, new_n63_, new_n64_, new_n65_,
    ...
    new_n76_, new_n77_, new_n78_, new_n81_, new_n82_, new_n83_, new_n85_,
  ...
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n76_ | x28));
  assign z10 = (x16 & (new_n82_ | (~new_n81_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n81_ = new_n56_ & (x19 | (new_n64_ & new_n78_ & ~x24 & ~x25));
  assign new_n82_ = new_n77_ & ~x23 & ~x24 & ~x25 & new_n83_ & ~x26;
  assign new_n83_ = ~x27 & ~x29;
  ...
  assign new_n87_ = new_n88_ & new_n75_ & ~x27 & ~x29 & ~x30;
  assign new_n88_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z12 = (x16 & (new_n92_ | (~new_n90_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n90_ = new_n56_ & (x19 | (new_n65_ & new_n91_));
  assign new_n91_ = ~x25 & ~x26 & ~x27 & ~x29 & ~x30;
  assign new_n92_ = new_n88_ & new_n75_ & new_n83_ & new_n93_;
  assign new_n93_ = ~x30 & ~x31;
  assign z13 = (x16 & (new_n96_ | (~new_n95_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n95_ = new_n56_ & (x19 | (new_n71_ & new_n78_ & new_n93_ & ~x29));
  assign new_n96_ = new_n56_ & new_n65_ & new_n97_ & new_n78_ & ~x25;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n99_ | new_n101_));
  assign new_n99_ = x33 & (~new_n56_ | (~x19 & (~new_n71_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = new_n56_ & new_n65_ & new_n86_ & new_n93_ & ~x32 & ~x33;
  assign z15 = (x16 & (new_n103_ | (new_n68_ & new_n105_))) | x18 | (~x00 & ~x16);
  assign new_n103_ = x34 & (~new_n56_ | (~x19 & (~new_n104_ | ~new_n64_ | ~new_n75_)));
  assign new_n104_ = ~x27 & ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n105_ = new_n106_ & new_n78_ & ~x29 & ~x30;
