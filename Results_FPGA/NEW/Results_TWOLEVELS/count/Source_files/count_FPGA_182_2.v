// Benchmark "FAU" written by ABC on Wed Jul 29 04:08:10 2020
...
module FAU ( 
  ...
  assign z01 = x18 | (~x14 & ~x16) | (x16 & (x19 | (x17 & x20) | (~x17 & ~x20)));
  assign z02 = x18 | (~x13 & ~x16) | (x16 & (((x17 | x20) & x21) | (~x17 & ~x20 & ~x21)));
  assign z03 = (x16 & (new_n58_ | (~new_n57_ & x22))) | x18 | (~x12 & ~x16);
  assign new_n57_ = ~x17 & ~x20 & ~x21;
  assign new_n58_ = ~x17 & ~x20 & ~x21 & ~x22;
  assign z04 = (x16 & (new_n60_ | (~new_n58_ & x23))) | x18 | (~x11 & ~x16);
  assign new_n60_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = (x16 & (new_n62_ | (~new_n60_ & x24))) | x18 | (~x10 & ~x16);
  assign new_n62_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
