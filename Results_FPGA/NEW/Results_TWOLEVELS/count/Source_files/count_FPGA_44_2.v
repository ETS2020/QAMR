...
module FAU ( 
  ...
  assign z05 = (~new_n63_ & ~x20) | (~x10 & ~x16) | x18 | (x16 & x20 & x24);
  assign new_n63_ = (x17 | x19 | x21 | x22 | x23 | x24) & (~x24 | (~x17 & ~x19 & ~x21 & ~x22 & ~x23));
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n65_ | new_n67_));
  assign new_n65_ = x25 & (~new_n56_ | ~new_n66_);
  ...
  assign new_n82_ = new_n56_ & new_n66_ & new_n83_ & ~x25 & ~x26 & ~x27;
  assign new_n83_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n85_ | (~new_n82_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n85_ = new_n56_ & new_n66_ & new_n86_ & new_n87_;
