...
module FAU ( 
  ...
  assign new_n66_ = ~x17 & ~x19 & new_n67_ & ~x21;
  assign new_n67_ = ~x22 & ~x23 & ~x24 & ~x25 & (x26 | (~x20 & ~x26));
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n69_ | new_n71_));
  assign new_n69_ = x26 & (~new_n70_ | x17 | x19 | x21);
