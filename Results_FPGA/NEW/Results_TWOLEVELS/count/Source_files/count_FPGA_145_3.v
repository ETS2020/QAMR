...
module FAU ( 
  ...
  assign new_n67_ = new_n57_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n69_ | (~new_n67_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n69_ = ~x17 & ~x19 & ~x21 & ~x22 & new_n70_ & ~x23;
  assign new_n70_ = ~x24 & ~x25 & ~x26 & ~x27 & (x28 | (~x20 & ~x28));
  ...
  assign z11 = (x16 & (new_n80_ | (~new_n74_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n80_ = ~x20 & ((x29 & x30) | (new_n82_ & new_n81_ & ~x28 & ~x29 & ~x30));
  assign new_n81_ = ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z12 = (x16 & (new_n84_ | (new_n63_ & new_n85_))) | x18 | (~x03 & ~x16);
  assign new_n84_ = x31 & (~new_n59_ | ~new_n75_ | (~x20 & (x29 | x30)));
  assign new_n85_ = new_n81_ & new_n86_ & ~x28 & ~x29;
  assign new_n86_ = ~x30 & ~x31;
  assign z13 = (x16 & (new_n88_ | (new_n63_ & new_n89_))) | x18 | (~x02 & ~x16);
  assign new_n88_ = x32 & (~new_n59_ | ~new_n75_ | (~x20 & (~new_n86_ | x29)));
  assign new_n89_ = new_n90_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n90_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n92_ | (new_n65_ & new_n93_))) | x18 | (~x01 & ~x16);
  assign new_n92_ = x33 & ((~new_n90_ & ~x20) | ~new_n59_ | ~new_n75_);
  assign new_n93_ = new_n94_ & new_n86_ & ~x32 & ~x33;
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (x16 & (new_n96_ | (new_n65_ & new_n98_))) | x18 | (~x00 & ~x16);
  assign new_n96_ = x34 & (new_n97_ | ~new_n59_ | ~new_n75_);
  assign new_n97_ = ~x20 & (x29 | x30 | x31 | x32 | x33);
  assign new_n98_ = new_n94_ & new_n86_ & ~x32 & ~x33 & ~x34;
endmodule
