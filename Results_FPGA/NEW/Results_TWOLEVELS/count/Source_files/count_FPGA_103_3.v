// Benchmark "FAU" written by ABC on Wed Jul 29 04:07:54 2020
...
module FAU ( 
  ...
  assign z03 = (~new_n59_ & x16) | (~x12 & ~x16) | x18 | (x20 & x22);
  assign new_n59_ = (~x22 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  ...
  assign new_n77_ = new_n62_ & new_n70_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n79_ & x16) | x18 | (~x04 & ~x16);
  assign new_n79_ = (~x30 | (new_n62_ & new_n70_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n70_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n82_ | (~new_n81_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n81_ = new_n62_ & new_n70_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign new_n85_ = new_n56_ & new_n65_ & new_n86_ & new_n87_;
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n91_ | (x16 & ((~new_n85_ & x33) | (new_n67_ & new_n89_)));
  assign new_n89_ = new_n90_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n94_ | (x16 & ((new_n67_ & new_n93_) | (x34 & (~new_n67_ | ~new_n89_))));
