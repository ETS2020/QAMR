...
module FAU ( 
  ...
  assign new_n92_ = x30 & (~new_n64_ | ~new_n71_ | x27 | x28 | x29);
  ...
  assign new_n97_ = new_n64_ & new_n71_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z13 = (~new_n99_ & x16) | x18 | (~x02 & ~x16);
  assign new_n99_ = (x17 | x19 | (~x20 & (new_n100_ | x20))) & (~x32 | (~x17 & ~x19));
