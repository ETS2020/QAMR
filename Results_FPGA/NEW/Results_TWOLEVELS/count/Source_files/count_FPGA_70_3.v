...
module FAU ( 
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n70_ | (~new_n56_ & x26)));
  assign new_n70_ = ~x19 & (new_n72_ | (~x17 & ~x20 & new_n71_ & ~x21));
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x26 & (x27 | (~x25 & ~x27));
  assign new_n72_ = x26 & (x21 | x22 | x23 | x24 | x25);
  ...
  assign z10 = (x16 & (new_n84_ | (new_n86_ & new_n88_))) | x18 | (~x05 & ~x16);
  ...
  assign new_n90_ = new_n56_ & (x19 | (new_n65_ & new_n87_ & ~x25 & ~x26));
  assign new_n91_ = new_n88_ & new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n97_ | (~new_n94_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n94_ = new_n56_ & (x19 | (new_n95_ & new_n78_ & new_n96_ & ~x28));
  ...
  assign new_n102_ = new_n56_ & new_n65_ & new_n85_ & new_n96_ & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n104_ | (new_n68_ & new_n107_)));
  assign new_n104_ = x33 & (~new_n56_ | (~x19 & (~new_n105_ | ~new_n106_)));
  ...
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n110_ | (new_n68_ & new_n111_)));
  assign new_n110_ = x34 & (~new_n56_ | (~x19 & (~new_n105_ | ~new_n87_ | ~new_n108_)));
  assign new_n111_ = new_n112_ & new_n78_ & ~x28 & ~x29;
