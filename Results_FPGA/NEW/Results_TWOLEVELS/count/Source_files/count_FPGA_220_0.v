...
module FAU ( 
  ...
  assign z05 = ~new_n65_ | (x16 & ((x24 & (~new_n62_ | ~new_n63_)) | (new_n62_ & new_n64_)));
  assign new_n62_ = ~x17 & ~x19 & ~x20;
  assign new_n63_ = ~x21 & ~x22 & ~x23;
  assign new_n64_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n65_ = ~x18 & (x10 | x16);
  assign z06 = (x16 & (new_n68_ | (new_n67_ & ~x17))) | x18 | (~x09 & ~x16);
  assign new_n67_ = ~x19 & ~x20 & (x21 | (~x21 & (x22 | (~x22 & (x23 | (~x23 & x24))))));
  assign new_n68_ = x25 & (x17 | x19 | x20);
