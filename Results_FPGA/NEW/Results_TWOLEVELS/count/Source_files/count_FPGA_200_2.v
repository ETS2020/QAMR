...
module FAU ( 
  ...
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n86_ | new_n87_));
  assign new_n86_ = x29 & (~new_n78_ | ~new_n83_ | x23 | x24 | x25);
  assign new_n87_ = new_n56_ & new_n64_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n89_ & x16) | x18 | (~x04 & ~x16);
  assign new_n89_ = (x19 | ((x17 | ~new_n90_ | x20) & (new_n92_ | ~x30))) & (~x30 | (~x17 & ~x19 & ~x20));
  assign new_n90_ = ~x21 & ~x22 & ~x23 & new_n91_ & ~x24;
  ...
  assign new_n95_ = new_n56_ & (new_n96_ | x19);
  assign new_n96_ = new_n65_ & ~x25 & ~x26 & ~x27 & ~x28 & ~x30;
  assign new_n97_ = new_n56_ & new_n64_ & new_n72_ & new_n98_ & ~x27 & ~x28;
  assign new_n98_ = ~x30 & ~x31;
  assign z13 = (~new_n100_ & x16) | x18 | (~x02 & ~x16);
  assign new_n100_ = (~x32 | (new_n56_ & (new_n101_ | x19))) & (~new_n102_ | ~new_n56_ | ~new_n65_);
  assign new_n101_ = new_n73_ & new_n79_ & new_n98_ & ~x28;
  assign new_n102_ = new_n79_ & ~x25 & new_n103_ & ~x28 & ~x30;
  assign new_n103_ = ~x31 & ~x32;
  assign z14 = (~new_n105_ & x16) | x18 | (~x01 & ~x16);
  assign new_n105_ = (~new_n107_ | ~new_n56_ | ~new_n65_) & (~x33 | (~new_n106_ & new_n56_));
  assign new_n106_ = ~x19 & (~new_n73_ | ~new_n83_ | ~new_n103_ | x30);
  assign new_n107_ = new_n93_ & new_n98_ & ~x32 & ~x33;
  assign z15 = (x16 & (new_n109_ | (new_n68_ & new_n111_))) | x18 | (~x00 & ~x16);
  assign new_n109_ = x34 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n110_)));
  assign new_n110_ = ~x27 & ~x28 & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n111_ = new_n79_ & ~x28 & ~x30 & new_n103_ & ~x33 & ~x34;
endmodule
