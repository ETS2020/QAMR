// Benchmark "FAU" written by ABC on Wed Jul 29 04:07:39 2020
...
module FAU ( 
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n72_ | (new_n70_ & ~x17)));
  ...
  assign new_n75_ = ~new_n76_ & (x17 | x19 | x20 | ~new_n77_ | x21);
  assign new_n76_ = x27 & (~new_n73_ | ~new_n71_ | x22 | x23);
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n79_ | (~new_n81_ & x28))) | x18 | (~x06 & ~x16);
  ...
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n86_ | (new_n84_ & ~x17)));
  ...
  assign new_n89_ = ~new_n92_ & (x17 | x19 | x20 | ~new_n90_ | x21);
  assign new_n90_ = ~x22 & ~x23 & ~x24 & new_n91_ & ~x25;
  assign new_n91_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n92_ = x30 & (~new_n63_ | ~new_n71_ | x27 | x28 | x29);
  assign z12 = (x16 & (new_n94_ | (~new_n97_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n94_ = new_n95_ & new_n96_ & ~x25 & ~x26 & ~x27;
  assign new_n95_ = new_n68_ & ~x17 & ~x19 & ~x20;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = new_n63_ & new_n71_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z13 = (~new_n99_ & x16) | x18 | (~x02 & ~x16);
  assign new_n99_ = (x17 | x19 | new_n100_ | x20) & (~x32 | (~x17 & ~x19 & ~x20));
  assign new_n100_ = ~x21 & (x21 | (~x22 & (x22 | (~x23 & (x23 | (~x24 & (x24 | (~x25 & (new_n101_ | x25)))))))));
  assign new_n101_ = ~x26 & (x26 | (~x27 & (x27 | (~x28 & (x28 | (~x29 & (x29 | (~x30 & (x30 | ~x31)))))))));
