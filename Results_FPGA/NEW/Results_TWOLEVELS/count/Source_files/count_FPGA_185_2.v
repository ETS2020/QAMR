...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n65_ | (new_n57_ & new_n66_))) | x18 | (~x09 & ~x16);
  assign new_n65_ = x25 & (~new_n56_ | x21 | x22 | x23 | x24);
  assign new_n66_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n68_ | new_n70_));
  assign new_n68_ = ~x17 & ~x19 & (new_n69_ | x20);
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n70_ = x26 & (~new_n66_ | ~new_n71_);
  assign new_n71_ = ~x17 & ~x19 & ~x21;
  assign z08 = (~new_n73_ & x16) | x18 | (~x07 & ~x16);
  assign new_n73_ = (~x27 | (new_n74_ & ~x23 & ~x24 & ~x25 & ~x26)) & (~new_n74_ | x23 | x24 | x25 | x26 | x27);
  assign new_n74_ = ~x17 & ~x19 & ~x21 & ~x22;
  assign z09 = (x16 & (new_n78_ | (~new_n76_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n76_ = new_n74_ & new_n77_ & ~x23 & ~x24;
  ...
  assign new_n81_ = new_n79_ & ~x24 & ~x25 & ~x26 & new_n82_ & ~x27;
  assign new_n82_ = ~x28 & ~x29;
  assign z11 = (x16 & (new_n84_ | (~new_n81_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n84_ = new_n85_ & new_n77_ & ~x28 & ~x29 & ~x30;
  assign new_n85_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z12 = (~new_n87_ & x16) | x18 | (~x03 & ~x16);
  assign new_n87_ = (~x31 | (new_n85_ & new_n77_ & ~x28 & ~x29 & ~x30)) & (~new_n85_ | ~new_n77_ | x30 | x31 | x28 | x29);
  assign z13 = (x16 & (new_n90_ | (~new_n89_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n89_ = new_n85_ & new_n77_ & new_n82_ & ~x30 & ~x31;
  assign new_n90_ = new_n66_ & new_n71_ & new_n91_ & ~x26 & ~x27 & ~x28;
  assign new_n91_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n93_ | (~new_n90_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n93_ = new_n66_ & new_n71_ & new_n94_ & new_n82_ & ~x26 & ~x27;
  assign new_n94_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n99_ | (x16 & ((~new_n93_ & x34) | (new_n96_ & new_n97_)));
  assign new_n96_ = new_n74_ & ~x23 & ~x24 & ~x25 & ~x26;
