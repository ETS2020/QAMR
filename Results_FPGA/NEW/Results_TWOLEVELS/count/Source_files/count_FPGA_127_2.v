...
module FAU ( 
  ...
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n70_ | (~new_n73_ & x27)));
  assign new_n70_ = ~x17 & ~x19 & (x20 | (new_n71_ & new_n72_));
  assign new_n71_ = ~x21 & ~x22 & ~x23;
  assign new_n72_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n73_ = new_n74_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n74_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign z09 = (x16 & (new_n78_ | (~new_n76_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n76_ = new_n77_ & ~x17 & ~x19 & ~x21 & ~x22;
  ...
  assign new_n84_ = new_n86_ & new_n85_ & ~x28 & ~x29 & ~x30;
  assign new_n85_ = ~x25 & ~x26 & ~x27;
  assign new_n86_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z12 = (~new_n88_ & x16) | x18 | (~x03 & ~x16);
  assign new_n88_ = (~x31 | (new_n86_ & new_n85_ & ~x28 & ~x29 & ~x30)) & (~new_n86_ | ~new_n85_ | x30 | x31 | x28 | x29);
  assign z13 = (x16 & (new_n91_ | (~new_n90_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n90_ = new_n86_ & new_n85_ & new_n82_ & ~x30 & ~x31;
  assign new_n91_ = new_n66_ & new_n92_ & new_n93_ & ~x26 & ~x27 & ~x28;
  assign new_n92_ = ~x17 & ~x19 & ~x21;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n95_ | (~new_n91_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n95_ = new_n66_ & new_n92_ & new_n96_ & new_n82_ & ~x26 & ~x27;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n100_ | (x16 & ((~new_n95_ & x34) | (new_n73_ & new_n98_)));
