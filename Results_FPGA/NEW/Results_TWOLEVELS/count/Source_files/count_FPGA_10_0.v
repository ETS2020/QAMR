...
module FAU ( 
  ...
  assign z08 = (x16 & (new_n75_ | (~new_n77_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n75_ = ~x17 & ~x19 & ~x20 & new_n76_ & ~x21;
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n77_ = new_n73_ & new_n71_ & ~x22 & ~x23;
  ...
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n92_ | (new_n89_ & ~x17)));
  assign new_n89_ = ~x19 & ~x20 & ~x21 & ~x22 & new_n90_ & ~x23;
  assign new_n90_ = ~x24 & ~x25 & ~x26 & ~x27 & new_n91_ & ~x28;
  assign new_n91_ = ~x29 & ~x30;
  assign new_n92_ = x30 & (~new_n63_ | ~new_n71_ | x27 | x28 | x29);
  assign z12 = (~new_n94_ & x16) | x18 | (~x03 & ~x16);
  assign new_n94_ = (x17 | x19 | ~new_n95_ | x20) & (new_n97_ | ~x31);
  assign new_n95_ = ~x21 & ~x22 & ~x23 & ~x24 & new_n96_ & ~x25;
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = new_n63_ & new_n71_ & new_n91_ & ~x27 & ~x28;
  assign z13 = (~new_n99_ & x16) | x18 | (~x02 & ~x16);
  assign new_n99_ = (~x32 | (new_n100_ & new_n101_)) & (~new_n100_ | ~new_n103_ | ~new_n91_ | x31 | x32);
  assign new_n100_ = new_n68_ & ~x17 & ~x19 & ~x20;
  assign new_n101_ = new_n102_ & ~x25 & ~x26 & ~x27;
  assign new_n102_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n103_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z14 = (~new_n105_ & x16) | x18 | (~x01 & ~x16);
  assign new_n105_ = (x17 | x19 | x20 | (~x21 & (new_n106_ | x21))) & (~x33 | (~x17 & ~x19 & ~x20));
  assign new_n106_ = ~x22 & (x22 | (~x23 & (x23 | (~x24 & (x24 | (~x25 & (x25 | (~x26 & (new_n107_ | x26)))))))));
  assign new_n107_ = ~x27 & (x27 | (~x28 & (x28 | (~x29 & (x29 | (~x30 & (x30 | (~x31 & (x31 | ~x32)))))))));
