...
module FAU ( 
  ...
  assign z13 = (x16 & (new_n101_ | (~new_n99_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n99_ = new_n56_ & (x19 | (new_n71_ & new_n100_));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n56_ & new_n65_ & new_n85_ & new_n93_ & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n101_ | x33));
  ...
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x34;
endmodule
