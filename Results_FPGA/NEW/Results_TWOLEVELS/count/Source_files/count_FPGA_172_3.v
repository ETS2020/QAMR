...
module FAU ( 
  ...
  assign z10 = ~new_n79_ | (x16 & ((~new_n76_ & x29) | (new_n78_ & new_n61_)));
  assign new_n76_ = new_n77_ & ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign new_n77_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n78_ = new_n69_ & ~x27 & ~x28 & ~x29;
  assign new_n79_ = (x05 | x16) & ~x18 & (~x20 | ~x29);
