...
module FAU ( 
  ...
  assign z04 = (x16 & (new_n61_ | (new_n62_ & ~x17))) | x18 | (~x11 & ~x16);
  assign new_n61_ = ~new_n59_ & x23;
  assign new_n62_ = ~x19 & ~x21 & ~x22 & ~x23 & (x24 | (~x20 & ~x24));
  assign z05 = (x16 & (new_n64_ | (new_n56_ & new_n65_))) | x18 | (~x10 & ~x16);
  assign new_n64_ = x24 & (x17 | x19 | x21 | x22 | x23);
  ...
  assign new_n78_ = new_n79_ & new_n71_ & ~x27 & ~x28 & ~x29;
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z11 = (~new_n81_ & x16) | x18 | (~x04 & ~x16);
  assign new_n81_ = (~x30 | (new_n79_ & new_n71_ & ~x27 & ~x28 & ~x29)) & (~new_n79_ | ~new_n71_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n84_ | (~new_n83_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n83_ = new_n79_ & new_n71_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = ~new_n93_ | (x16 & ((new_n68_ & new_n91_) | (~new_n87_ & x33)));
