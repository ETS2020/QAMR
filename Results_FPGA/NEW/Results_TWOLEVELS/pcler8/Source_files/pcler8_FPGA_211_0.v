// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:56 2020
...
module FAU ( 
  ...
  assign z16 = z08 | (x09 & ~x10 & (new_n78_ | (~x20 & x26)));
  assign new_n78_ = ~x08 & ((new_n81_ & new_n82_) | (x26 & (~new_n79_ | ~new_n80_)));
