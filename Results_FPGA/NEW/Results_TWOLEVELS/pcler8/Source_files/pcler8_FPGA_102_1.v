...
module FAU ( 
  ...
  assign z14 = z06 | (x09 & ~x10 & (new_n72_ | new_n74_));
  assign new_n72_ = x24 & ((~x08 & (~x20 | ~x21 | ~x22)) | (~new_n73_ & x20));
  assign new_n73_ = x19 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n74_ = new_n75_ & x22 & x23 & ~x24;
  assign new_n75_ = x19 & x20 & x21;
  assign z15 = x08 ? x06 : (x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n75_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n63_ | ~x24 | x25);
