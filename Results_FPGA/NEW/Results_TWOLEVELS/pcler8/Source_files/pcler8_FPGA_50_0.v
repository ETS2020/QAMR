// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:09 2020
...
module FAU ( 
  ...
  assign new_n57_ = (x19 | (~x20 & ~x23)) & (~new_n59_ | ~new_n58_ | ~x11 | ~x20);
  ...
  assign new_n70_ = (~x19 | (x20 & (~x21 | ~x22 | x23))) & (~x23 | (x19 & x21 & ~new_n71_ & x22));
