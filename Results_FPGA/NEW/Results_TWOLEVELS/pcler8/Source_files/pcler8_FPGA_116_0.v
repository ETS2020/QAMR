...
module FAU ( 
  ...
  assign new_n66_ = (~x22 | (~new_n68_ & (new_n67_ | (x19 & x20 & x21)))) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n67_ = ~x23 & ~x26;
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = x08 ? x04 : (x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x23 | ((~x22 | (x19 & x20 & x21)) & ~new_n71_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  ...
  assign z16 = x08 ? x07 : (x09 & ~x10 & (new_n79_ | new_n80_));
  assign new_n79_ = x24 & (~x23 | (new_n74_ & x22 & x25 & ~x26));
  assign new_n80_ = x26 & ((~new_n74_ & x22) | ~x24 | ~x25 | x18 | ~x22);
endmodule
