...
module FAU ( 
  ...
  assign new_n72_ = (~x24 | (new_n74_ & x22 & x23 & (~new_n73_ | ~x16))) & (~new_n74_ | ~x22 | ~x23 | x24);
  assign new_n73_ = x25 & x26;
  assign new_n74_ = x19 & x20 & x21;
  assign z15 = x08 ? x06 : (x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x25 | (new_n74_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n63_ | ~x24 | x25);
  assign z16 = x08 ? x07 : (new_n78_ & x09);
  assign new_n78_ = ~x10 & ((new_n81_ & new_n82_) | ((~new_n79_ | ~new_n80_) & x26));
