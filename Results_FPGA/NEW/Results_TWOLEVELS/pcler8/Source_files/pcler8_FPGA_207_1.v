// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:54 2020
...
module FAU ( 
  ...
  assign new_n62_ = (~x19 | ~x20 | (x21 & (~new_n64_ | ~x21 | ~new_n63_ | ~x24))) & (~x21 | (x19 & x20));
  ...
  assign new_n72_ = (~x24 | (new_n73_ & x22 & x23 & (~new_n63_ | ~x16))) & (~new_n73_ | ~x22 | ~x23 | x24);
  assign new_n73_ = x19 & x20 & x21;
  assign z15 = x08 ? x06 : (x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x25 | (new_n73_ & new_n64_ & x24 & (~x17 | ~x26))) & (~new_n73_ | ~new_n64_ | ~x24 | x25);
