...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | new_n66_ | (x19 & x20 & x21 & ~x22));
  ...
  assign new_n74_ = (~x25 | (new_n72_ & x23 & ~new_n75_ & x24)) & (~new_n72_ | ~x22 | ~x23 | ~x24 | x25);
  assign new_n75_ = x17 & x26;
  assign z16 = x08 ? x07 : (x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~new_n72_ | ~new_n80_) & (~x26 | (new_n78_ & new_n79_));
