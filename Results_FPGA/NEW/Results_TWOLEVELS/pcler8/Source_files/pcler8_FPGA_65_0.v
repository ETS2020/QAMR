...
module FAU ( 
  ...
  assign new_n57_ = (x19 | (~x20 & ~x26)) & (~new_n59_ | ~new_n58_ | ~x11 | ~x20);
  ...
  assign z16 = x08 ? x07 : (x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x19 | (~new_n80_ & x20)) & (~x26 | (new_n81_ & new_n82_));
  assign new_n80_ = x24 & x25 & ~x26 & x21 & x22 & x23;
  assign new_n81_ = ~x18 & x19 & x21;
