// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:03 2020
...
module FAU ( 
  ...
  assign z15 = x08 ? x06 : (new_n75_ & x09);
  assign new_n75_ = ~x10 & ((x25 & (~new_n72_ | ~x22 | ~x23 | ~x24)) | (new_n72_ & x22 & x23 & x24 & ~x25));
