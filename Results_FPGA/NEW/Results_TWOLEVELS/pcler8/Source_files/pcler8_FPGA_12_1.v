...
module FAU ( 
  ...
  assign z07 = x06 & x08;
  assign z08 = x07 & x08;
  assign z09 = x08 ? x00 : (new_n57_ & x09);
  assign new_n57_ = ~x10 & (~x19 | (new_n58_ & x11 & x21 & x22));
  ...
  assign new_n71_ = (~x24 | (new_n72_ & x19 & x21)) & (~new_n73_ | ~x19 | ~x20 | ~x21);
  ...
  assign new_n78_ = (~new_n76_ | ~new_n81_) & (~x26 | (new_n79_ & new_n80_));
  assign new_n79_ = ~x18 & x19 & x21;
