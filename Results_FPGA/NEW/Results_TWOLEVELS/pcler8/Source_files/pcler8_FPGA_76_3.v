// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:14 2020
...
module FAU ( 
  ...
  assign new_n72_ = (~x24 | (x19 & x20 & x21 & x22 & x23)) & (~x22 | ~x23 | x24 | ~x19 | ~x20 | ~x21);
  assign z15 = x08 ? x06 : (x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x25 | (new_n75_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n63_ | ~x24 | x25);
