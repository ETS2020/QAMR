// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:41 2020
...
module FAU ( 
  ...
  assign z13 = (x04 & x08) | (x09 & ~x10 & (new_n71_ | (~new_n69_ & ~x08)));
  assign new_n69_ = (~x23 | (x19 & x21 & ~new_n70_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign new_n71_ = ~x20 & x23;
  ...
  assign new_n77_ = (~x25 | (new_n74_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n63_ | ~x24 | x25);
