// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:58 2020
...
module FAU ( 
  ...
  assign z07 = x06 & x08;
  assign z08 = x07 & x08;
  assign z09 = x08 ? x00 : (x09 & ~new_n57_ & ~x10);
  ...
  assign z11 = x08 ? x02 : new_n62_;
  assign new_n62_ = x09 & ~x10 & ((x21 & (~x19 | new_n63_ | ~x20)) | (x19 & x20 & ~x21));
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = x08 ? x03 : new_n65_;
  assign new_n65_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign z13 = x08 ? x04 : (x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x23 | (x19 & x20 & x21 & ~new_n68_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  ...
  assign new_n74_ = (~x25 | (new_n71_ & new_n75_ & x24 & (~x17 | ~x26))) & (~new_n71_ | ~new_n75_ | ~x24 | x25);
  assign new_n75_ = x22 & x23;
  assign z16 = x08 ? x07 : (new_n77_ & x09);
  assign new_n77_ = ~x10 & ((new_n80_ & new_n81_) | (x26 & (~new_n78_ | ~new_n79_)));
  assign new_n78_ = ~x18 & x19 & x20 & x21;
