// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:45 2020
...
module FAU ( 
  ...
  assign z16 = z08 | (x09 & ~x10 & (new_n78_ | new_n80_));
  assign new_n78_ = x26 & (new_n79_ | (x20 & (x18 | ~x19 | ~x25)));
  assign new_n79_ = ~x08 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
