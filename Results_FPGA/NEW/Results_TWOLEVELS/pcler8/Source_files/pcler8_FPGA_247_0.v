// Benchmark "FAU" written by ABC on Wed Jul 29 03:59:08 2020
...
module FAU ( 
  ...
  assign z14 = z06 | (x09 & ~x10 & (new_n72_ | (~x20 & x24)));
  assign new_n72_ = ~x08 & (new_n74_ | (x24 & (~new_n73_ | ~x19 | ~x21)));
  assign new_n73_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n74_ = x22 & x23 & ~x24 & x19 & x20 & x21;
  assign z15 = x08 ? x06 : (x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x25 | (new_n77_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n77_ | ~new_n63_ | ~x24 | x25);
