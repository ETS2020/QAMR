...
module FAU ( 
  ...
  assign new_n63_ = (~x24 | (x19 & x20 & x21 & x22 & x23)) & (~x22 | ~x23 | x24 | ~x19 | ~x20 | ~x21);
  assign z15 = x08 ? x06 : (new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x25 & (~new_n66_ | ~x22 | ~x23 | ~x24)) | (new_n66_ & x24 & ~x25 & x22 & x23));
  assign new_n66_ = x19 & x20 & x21;
  assign z16 = x08 ? x07 : (x09 & ~new_n68_ & ~x10);
  assign new_n68_ = ~x26 & (~new_n66_ | ~x22 | ~x23 | ~x24 | ~x25);
  assign z00 = 1'b0;
endmodule
