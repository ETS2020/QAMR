...
module FAU ( 
  ...
  assign z15 = z07 | (x09 & ~x10 & (new_n78_ | (~new_n76_ & x25)));
  assign new_n76_ = (new_n77_ | ~x20) & (x08 | (new_n63_ & x20 & x21));
  assign new_n77_ = x19 & x24 & (~x17 | ~x26);
  assign new_n78_ = new_n73_ & new_n63_ & x24 & ~x25;
