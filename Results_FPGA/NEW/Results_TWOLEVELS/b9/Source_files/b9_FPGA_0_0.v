// Benchmark "FAU" written by ABC on Wed Jul 29 04:53:02 2020
...
module FAU ( 
  ...
  assign z02 = (~new_n70_ & x40) | ~x39 | ~x40 | (x04 & ~x08 & ~x27);
  ...
  assign z10 = new_n82_ | (~x04 & (new_n81_ | (x27 & ~new_n68_ & ~new_n80_)));
  ...
  assign new_n86_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n89_ | ((x04 | ~x39) & (new_n88_ | ~x27)) | (~x27 & ~x40);
