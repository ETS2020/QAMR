...
module FAU ( 
  ...
  assign z14 = new_n92_ | ~new_n96_ | (~new_n94_ & (x18 | x19 | ~x20));
  assign new_n92_ = ~x37 & ((~new_n93_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n93_ = ~x04 & ~x13 & x39;
  assign new_n94_ = ~new_n95_ & x39 & (~x40 | (~x04 & ~x13));
  assign new_n95_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = x40 & (x27 | (new_n97_ & x39 & (~x04 | ~x40)));
  assign new_n97_ = (~x13 | ~x20) & (x30 | x32);
