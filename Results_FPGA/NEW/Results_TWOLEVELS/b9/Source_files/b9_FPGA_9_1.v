// Benchmark "FAU" written by ABC on Wed Jul 29 04:53:04 2020
...
module FAU ( 
  ...
  assign new_n81_ = x05 & ((~x28 & x35) | (x36 & x39 & x40));
  assign new_n82_ = (~x39 | ~x40) & ((~x28 & x35) | (x07 & x36));
  ...
  assign z18 = ~new_n103_ | (x08 & ((new_n69_ & ~x27) | (z08 & x29)));
