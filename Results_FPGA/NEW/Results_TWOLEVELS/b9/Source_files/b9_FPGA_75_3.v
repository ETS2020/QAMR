...
module FAU ( 
  ...
  assign new_n85_ = x35 ? (~x28 & (~x04 | ~x27)) : x09;
  assign new_n86_ = ~x08 & ((~x09 & (~x27 | ~x35)) | (x35 & (x04 | x28)));
  ...
  assign z20 = ~x30 & (new_n106_ | (~new_n105_ & ~x09));
  assign new_n105_ = (x08 | (x27 & x35)) & (x35 | (x29 & x39 & x40));
