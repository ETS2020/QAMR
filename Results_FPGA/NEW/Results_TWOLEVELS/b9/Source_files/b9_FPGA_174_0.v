...
module FAU ( 
  ...
  assign new_n66_ = ~x04 & x39 & (x36 ? x40 : x35);
  assign new_n67_ = ~x37 & (~x28 | ~x35);
  assign z08 = x39 & x40;
  assign z01 = ~x04 | (~x30 & ~x32 & (~x27 | (~new_n70_ & ~x36)));
  assign new_n70_ = ~x28 & x35;
  assign z02 = (~new_n72_ & x40) | ~x39 | ~x40 | (x04 & ~x08 & ~x27);
  ...
  assign new_n81_ = ((~new_n70_ & ~x36) | ((~x07 | x39) & (~x05 | ~x39 | ~x40))) & (~x07 | x40);
  assign new_n82_ = new_n83_ & x05;
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n85_ | new_n86_);
  assign new_n85_ = (~new_n70_ | (x04 & x27)) & (~z08 | ~x29);
  assign new_n86_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = new_n89_ | new_n88_ | (~x27 & (~x39 | ~x40 | (x04 & x40)));
  ...
  assign new_n94_ = ~new_n95_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n95_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = ((~x04 & ~x13) | (~new_n67_ & (x27 | ~x40))) & ((x39 & x40) | (~new_n67_ & x27));
  assign new_n97_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n102_ | (x08 & ((new_n70_ & ~x27) | (z08 & x29)));
  assign new_n102_ = ~x09 & ~x30 & (~new_n70_ | x04 | ~x27);
