// Benchmark "FAU" written by ABC on Wed Jul 29 04:53:53 2020
...
module FAU ( 
  ...
  assign z12 = new_n86_ | new_n87_ | (~x27 & (~z08 | x04));
  assign new_n86_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n87_ = (~x28 | ~x35) & (~x40 | (~x37 & (x04 | ~x39)));
  ...
  assign z14 = (~new_n92_ & (x18 | x19 | ~x20)) | ~new_n94_ | new_n97_;
  assign new_n92_ = ~new_n93_ & z08 & ~x04 & ~x13;
  assign new_n93_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n94_ = ~new_n96_ & (new_n95_ | (x28 & x35));
  assign new_n95_ = x40 & (x37 | (~x04 & ~x13 & x39));
