...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n77_, new_n78_,
    new_n81_, new_n82_, new_n85_, new_n87_, new_n93_;
  ...
  assign z10 = new_n82_ | (~x04 & ((new_n81_ & x07) | (z08 & x05)));
  assign new_n81_ = x27 & (~x39 | ~x40) & (x36 | (~x28 & x35));
  assign new_n82_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & (~new_n69_ | (~x08 & ~x27) | (x04 & x27));
  assign z12 = new_n85_ | ((new_n66_ | ~x27) & (~z08 | x04));
  assign new_n85_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n87_ | (~x18 & ~x19 & x20 & ~new_n66_ & x27);
  assign new_n87_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = ~new_n87_ & (new_n66_ | ~x20 | ~x27 | x18 | x19);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = new_n93_ | x09 | x30;
  assign new_n93_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = ~x09 & ~x30 & (~x35 | (~x27 & (~x08 | x28)));
  assign z05 = ~z06;
  assign z19 = ~x09 & ~x30 & (~new_n69_ | (~x08 & ~x27) | (x04 & x27));
endmodule
