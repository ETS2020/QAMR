...
module FAU ( 
  ...
  assign new_n69_ = ~x32 & ((~x30 & (~x27 | (~x35 & ~x36))) | (x28 & x35 & ~x36));
  ...
  assign z11 = ~x09 & (new_n87_ | (~new_n86_ & (~z08 | ~x29)));
  assign new_n86_ = x35 ? (~x28 & (~x04 | ~x27)) : x30;
  assign new_n87_ = ~x08 & ((~x30 & (~x27 | ~x35)) | (x35 & (x04 | x28)));
  ...
  assign z20 = ~x09 & (new_n107_ | (~new_n106_ & ~x30));
  assign new_n106_ = (x08 | (x27 & x35)) & (x35 | (x29 & x39 & x40));
  assign new_n107_ = ~x27 & x28 & x35 & (~x29 | ~x39 | ~x40);
  assign z05 = ~z06;
  assign z19 = ~x09 & (new_n87_ | (~new_n86_ & (~z08 | ~x29)));
endmodule
