// Benchmark "FAU" written by ABC on Wed Jul 29 04:53:45 2020
...
module FAU ( 
  ...
  assign new_n71_ = x39 & ((~x02 & (~x08 | ~x29)) | (x04 & x28));
  ...
  assign new_n80_ = (new_n81_ | (~x36 & (x28 | ~x35))) & (~x07 | x39 | (x28 & ~x36));
  ...
  assign new_n85_ = (new_n86_ | (~x28 & (~x04 | ~x27))) & ~new_n87_ & (x08 | (~x04 & x27 & ~x28));
  assign new_n86_ = x29 & x39 & x40;
  assign new_n87_ = ~x35 & (~x08 | ~x29 | ~x40);
  assign z12 = new_n89_ | new_n90_ | (~x39 & (~x27 | (~x28 & ~x37)));
  assign new_n89_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
  assign new_n90_ = (x04 | ~x40) & (~x27 | (~x37 & (~x28 | ~x35)));
  ...
  assign new_n97_ = ~new_n98_ & ~new_n99_ & ~new_n100_ & (~x13 | x27 | ~x39);
  assign new_n98_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n99_ = (~x27 | (~x28 & ~x37)) & (x04 | ~x39 | ~x40);
  assign new_n100_ = ~x37 & ((x13 & (~x28 | ~x35)) | (~x35 & (x04 | ~x40)));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n105_ | (x08 & (new_n86_ | (new_n69_ & ~x27)));
  assign new_n105_ = ~x09 & ~x30 & (~new_n69_ | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (~new_n107_ | (~x08 & (~x27 | ~x35)));
  assign new_n107_ = ((x29 & x40) | (x35 & (x27 | ~x28))) & (x27 | ~x28 | x39);
  assign z05 = ~z06;
