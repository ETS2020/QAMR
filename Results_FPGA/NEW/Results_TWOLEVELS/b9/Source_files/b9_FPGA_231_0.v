...
module FAU ( 
  ...
  assign z12 = new_n88_ | new_n87_ | (~x27 & (~x39 | ~x40 | (x04 & x39)));
  ...
  assign new_n94_ = ~x04 & ~x13 & x40;
  assign new_n95_ = ~new_n96_ & x40 & (~x39 | (~x04 & ~x13));
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = x39 & (x27 | (new_n98_ & x40 & (~x04 | ~x39)));
  assign new_n98_ = (x30 | x32) & (~x13 | x19);
