...
module FAU ( 
  ...
  assign new_n65_ = ~x04 & x39 & x40 & (~x28 | x36);
  ...
  assign new_n70_ = x39 & x40 & (~x04 | (~x28 & (x08 | x27)));
  ...
  assign z10 = new_n82_ | (~x04 & ((new_n80_ & x27) | (new_n81_ & x05)));
  assign new_n80_ = (~x28 | x36) & ((x39 & x40) ? x05 : x07);
  assign new_n81_ = x39 & x40 & (x30 | x32);
  assign new_n82_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & (new_n84_ | new_n85_);
  assign new_n84_ = (x28 | (x04 & x27)) & (~x29 | ~x39 | ~x40);
  assign new_n85_ = ~x08 & (x04 | ~x27 | x28);
  ...
  assign z14 = (~new_n92_ & (new_n93_ | ~new_n94_)) | new_n97_ | (~new_n95_ & ~new_n96_);
  assign new_n92_ = ~x18 & ~x19 & x20;
  assign new_n93_ = ~x30 & ~x32 & (~x35 | (x28 & ~x36));
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = x27 & (x35 | x37);
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign new_n97_ = ~x28 & ~x37 & (~x39 | ~x40 | x04 | x13);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = new_n102_ | x09 | x30 | (~x04 & x27 & ~x28);
  assign new_n102_ = x08 & ((~x27 & ~x28) | (x29 & x39 & x40));
