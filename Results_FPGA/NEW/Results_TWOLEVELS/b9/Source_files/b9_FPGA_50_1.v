...
module FAU ( 
  ...
  assign z13 = (x27 & (new_n89_ | (new_n88_ & ~x04 & ~x13))) | (~x04 & new_n82_ & ~x13);
  assign new_n88_ = z08 & ~x28;
  assign new_n89_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n91_ | (~x30 & ~x32 & (new_n94_ | ~x27));
  assign new_n91_ = (new_n92_ | new_n93_) & (x28 | ~x35 | x37);
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = ~x18 & ~x19 & x20 & x27 & (x35 | x37);
  assign new_n94_ = x28 & (x18 | x19 | ~x20 | (~x13 & ~x37));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n99_ | (x08 & ((z08 & x29) | (new_n72_ & ~x27)));
  assign new_n99_ = ~x09 & ~x30 & (~new_n72_ | x04 | ~x27);
