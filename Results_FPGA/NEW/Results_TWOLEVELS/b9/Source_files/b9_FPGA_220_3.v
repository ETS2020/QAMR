...
module FAU ( 
  ...
  assign z11 = ~x30 & (new_n84_ | (~new_n86_ & (~new_n85_ | (x04 & x27))));
  assign new_n84_ = ~x08 & ((~x09 & (~new_n85_ | ~x27)) | (x04 & x40));
  assign new_n85_ = ~x28 & x35;
  assign new_n86_ = (x39 | ~x40) & (x09 | (x29 & x40));
  ...
  assign z18 = ~new_n102_ | (x08 & ((z08 & x29) | (new_n85_ & ~x27)));
  assign new_n102_ = ~x09 & ~x30 & (~new_n85_ | x04 | ~x27);
  ...
  assign z05 = ~z06;
  assign z19 = ~x30 & (new_n84_ | (~new_n86_ & (~new_n85_ | (x04 & x27))));
endmodule
