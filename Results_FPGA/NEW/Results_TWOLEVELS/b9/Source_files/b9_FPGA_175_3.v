...
module FAU ( 
  ...
  assign new_n85_ = (x39 | ~x40) & (x09 | (x29 & x40));
  ...
  assign z20 = ~x30 & (new_n105_ | (~new_n104_ & ~x09));
  assign new_n104_ = (x08 | (x27 & x35)) & ((x29 & x40) | (x35 & (x27 | ~x28)));
  assign new_n105_ = ~x39 & x40 & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
