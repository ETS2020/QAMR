...
module FAU ( 
  ...
  assign z14 = (~new_n94_ & (new_n95_ | ~new_n96_)) | new_n97_ | new_n93_ | (~new_n96_ & ~x27);
  assign new_n93_ = ~x37 & (~x28 | ~x35) & (~z08 | x04 | x13);
  assign new_n94_ = ~x18 & ~x19 & x20;
  assign new_n95_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = ~x13 & x39 & x40 & (~x04 | ~x40);
  assign new_n97_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n102_ | (x08 & ((z08 & x29) | (new_n72_ & ~x27)));
