...
module FAU ( 
  ...
  assign new_n80_ = (x36 | (~x28 & x35)) & (z08 ? x05 : x07);
  ...
  assign z12 = new_n87_ | new_n86_ | (~x27 & (~x39 | ~x40 | (x04 & x40)));
  assign new_n86_ = ~x37 & (~x28 | ~x35) & (~z08 | x04);
  assign new_n87_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (x27 & (new_n90_ | (~x04 & new_n89_ & ~x13))) | (~x04 & new_n91_ & ~x13);
  assign new_n89_ = x39 & (~x28 | (x35 & x36));
  assign new_n90_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n91_ = x39 & (x30 | x32);
  assign z14 = new_n93_ | new_n95_ | (~new_n98_ & ~x27);
  assign new_n93_ = ~x37 & ((~new_n94_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n94_ = ~x04 & ~x13 & x39;
  assign new_n95_ = (x18 | x19 | ~x20) & (new_n96_ | ~new_n97_ | x13);
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = x39 & (~x04 | ~x40);
  assign new_n98_ = new_n97_ & ~x13 & (x30 | x32);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n104_ | (~new_n103_ & x08);
  assign new_n103_ = (~z08 | ~x29) & (x27 | x28 | ~x35);
  assign new_n104_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (new_n106_ | (~x08 & (~x27 | ~x35)));
  assign new_n106_ = (~z08 | ~x29) & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
