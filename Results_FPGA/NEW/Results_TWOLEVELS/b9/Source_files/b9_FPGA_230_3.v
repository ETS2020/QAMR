...
module FAU ( 
  ...
  assign new_n89_ = ~x19 & x20 & ((x28 & x35) | (~x18 & x37));
  assign z14 = new_n91_ | ~new_n95_ | (~new_n94_ & (x18 | (~x35 & ~x37)));
  assign new_n91_ = (x19 | ~x20) & (new_n92_ | ~new_n93_);
  assign new_n92_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n93_ = x39 & x40 & ~x04 & ~x13;
  assign new_n94_ = ~x04 & ~x13 & z08 & (~x28 | x30 | x32);
  assign new_n95_ = (new_n93_ | (x27 & (x28 | x37))) & (x27 | x30 | x32);
