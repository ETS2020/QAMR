...
module FAU ( 
  ...
  assign z14 = new_n91_ | new_n93_ | (~x30 & ~new_n95_ & ~x32);
  assign new_n91_ = (x18 | x19 | ~x20) & (~new_n92_ | x04 | x13);
  assign new_n92_ = x39 & x40 & (x32 | x36 | ~x28 | x30);
  assign new_n93_ = ~new_n94_ & (~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = x27 & (~x28 | x35 | (~x18 & x20 & x37));
