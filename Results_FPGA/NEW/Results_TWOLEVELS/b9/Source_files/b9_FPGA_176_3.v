// Benchmark "FAU" written by ABC on Wed Jul 29 04:53:44 2020
...
module FAU ( 
  ...
  assign z10 = new_n83_ | (~x04 & (new_n82_ | (x27 & ~new_n69_ & ~new_n81_)));
  ...
  assign z12 = new_n88_ | ((new_n66_ | ~x27) & (~z08 | x04));
  ...
  assign z14 = (~new_n94_ & (new_n95_ | ~new_n96_)) | new_n97_ | (~new_n96_ & (new_n66_ | ~x27));
  assign new_n94_ = ~x18 & ~x19 & x20;
  assign new_n95_ = x28 & ~x30 & (x35 ? ~x36 : ~x32);
  ...
  assign z18 = ~new_n103_ | (x08 & ((new_n102_ & ~x27) | (z08 & x29)));
