...
module FAU ( 
  ...
  assign new_n66_ = ~x04 & x39 & (x35 | (x36 & x40));
  assign z08 = x39 & x40;
  assign z01 = ~x04 | (~x30 & ~x32 & (~x27 | (~new_n69_ & ~x36)));
  assign new_n69_ = ~x28 & x35;
  assign z02 = new_n71_ | ~z08 | (x04 & (x28 | (~x08 & ~x27)));
  assign new_n71_ = x40 & ((~x02 & (~x08 | ~x29)) | (x04 & ~x35));
  ...
  assign new_n80_ = ~x04 & ((new_n83_ & x05) | (x27 & (new_n82_ | (new_n81_ & x05))));
  assign new_n81_ = x39 & ((x36 & x40) | (~x28 & x35));
  assign new_n82_ = x07 & ((x36 & (~x39 | ~x40)) | (~x28 & x35 & ~x39));
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n85_ & ~x30;
  assign new_n85_ = (new_n86_ | (new_n69_ & (~x04 | ~x27))) & x40 & (x08 | (new_n69_ & ~x04 & x27));
  assign new_n86_ = x29 & x39;
  assign z12 = new_n88_ | new_n89_ | (~x40 & (~x27 | (~x35 & ~x37)));
  assign new_n88_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n89_ = (x04 | ~x39) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign z13 = (x27 & (new_n92_ | (~x04 & new_n91_ & ~x13))) | (~x04 & new_n83_ & ~x13);
  assign new_n91_ = x39 & (~x28 | (x35 & x36 & x40));
  ...
  assign new_n96_ = (x37 | (x40 & (~x28 | x30 | x32))) & (~x28 | x30 | new_n97_ | x32);
  assign new_n97_ = ~x18 & ~x19 & x20;
  assign new_n98_ = ~new_n97_ & (~x40 | (~x32 & ~x36 & x28 & ~x30));
  assign new_n99_ = ~x04 & (x30 | x32) & x39 & x40 & (~x13 | ~x40);
  ...
  assign new_n106_ = ((x27 & x35) | (x08 & x40)) & (new_n86_ | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
