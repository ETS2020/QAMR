...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n69_, new_n71_, new_n76_, new_n77_, new_n80_,
    ...
    new_n91_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n102_,
    new_n104_;
  ...
  assign z10 = (~new_n80_ & x27) | (~x04 & new_n82_ & x05);
  assign new_n80_ = (new_n81_ | (~new_n69_ & ~x36)) & (~x06 | ~x37);
  assign new_n81_ = (x04 | ((~x05 | ~x39 | ~x40) & (~x07 | x40))) & (~x07 | x39);
  assign new_n82_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n84_ | ~new_n85_);
  assign new_n84_ = (~x29 | ~x40) & (~new_n69_ | (x04 & x27));
  assign new_n85_ = (new_n69_ | (x08 & x39)) & (x08 | (~x04 & x27));
  assign z12 = new_n87_ | (~new_n88_ & (~z08 | x04));
  assign new_n87_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
  assign new_n88_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n91_ | (~x04 & new_n90_ & ~x13))) | (~x04 & new_n82_ & ~x13);
  ...
  assign new_n95_ = ~new_n96_ & ~new_n97_ & (x37 | new_n94_ | (x28 & x35));
  assign new_n96_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n97_ = ~x27 & (~x39 | ~x40 | x04 | (x13 & x39));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n102_ | (x08 & ((new_n69_ & ~x27) | (z08 & x29)));
  assign new_n102_ = ~x09 & ~x30 & (~new_n69_ | x04 | ~x27);
