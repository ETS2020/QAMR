...
module FAU ( 
  ...
  assign z02 = new_n72_ | ~z08 | (x04 & (~x35 | (~x08 & ~x27)));
  assign new_n72_ = x40 & ((~x02 & (~x08 | ~x29)) | (x04 & x28));
  ...
  assign new_n84_ = (~z08 | ~x29) & (x28 | ~x35 | (x04 & x27));
  ...
  assign new_n88_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  ...
  assign new_n101_ = (~z08 | ~x29) & (x27 | x28 | ~x35);
