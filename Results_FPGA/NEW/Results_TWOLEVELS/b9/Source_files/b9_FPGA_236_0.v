...
module FAU ( 
  ...
  assign z03 = ~x21 | ~x35 | (~x27 & ~x37) | (x27 & ~x28);
  assign z04 = (~x27 & ~x37) | (x27 & ~x28) | x21 | ~x35;
  ...
  assign z14 = (~new_n95_ & (new_n96_ | ~new_n97_)) | new_n98_ | (~new_n89_ & ~new_n99_);
  assign new_n95_ = ~x18 & ~x19 & x20;
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = x39 & x40 & ~x13 & (~x04 | ~x27);
  ...
  assign z18 = ~new_n104_ | (x08 & ((~x27 & ~x28) | (z08 & x29)));
