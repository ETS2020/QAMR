...
module FAU ( 
  ...
  assign new_n84_ = (~new_n72_ | (x04 & x27)) & (~z08 | ~x29);
  ...
  assign z14 = new_n93_ | ~new_n95_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n93_ = (x04 | x13) & (~new_n94_ | (~x37 & (~x28 | ~x35)));
  assign new_n94_ = ~x18 & (~x40 | (~x19 & x20 & x27));
  assign new_n95_ = (new_n96_ | (x39 & x40)) & ~new_n97_ & (x40 | (~x19 & x20));
  assign new_n96_ = x27 & (x37 | (x28 & x35));
  assign new_n97_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n98_ = x39 & (~x28 | x30 | x32 | (x35 & x36));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n103_ | (x08 & ((z08 & x29) | (new_n72_ & ~x27)));
  assign new_n103_ = ~x09 & ~x30 & (~new_n72_ | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (new_n105_ | (~x08 & (~x27 | ~x35)));
  assign new_n105_ = (~z08 | ~x29) & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
