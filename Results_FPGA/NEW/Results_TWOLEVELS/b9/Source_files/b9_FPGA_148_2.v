...
module FAU ( 
  ...
  assign new_n69_ = ~x32 & ((~x35 & ~x36) | (~x30 & (~x27 | (x28 & ~x36))));
  ...
  assign new_n86_ = x35 & (x30 | (~x28 & (~x04 | ~x27)));
  assign new_n87_ = ~x08 & (~x35 | (~x30 & (x04 | ~x27 | x28)));
  ...
  assign new_n96_ = x28 & ~x32 & (~x35 | (~x30 & ~x36));
  assign new_n97_ = x39 & x40 & ~x04 & ~x13;
  assign new_n98_ = ~x32 & ((~x27 & ~x30) | (x28 & ~x35 & ~x37));
  ...
  assign z20 = ~x09 & (new_n106_ | (~new_n107_ & (~z08 | ~x29)));
  assign new_n106_ = ~x08 & (~x35 | (~x27 & ~x30));
  assign new_n107_ = x35 & (x27 | ~x28 | x30);
  assign z05 = ~z06;
