...
module FAU ( 
  ...
  assign z12 = (~x10 & (new_n87_ | ~x27)) | ((new_n67_ | ~x27) & (~z08 | x04));
  assign new_n87_ = ~x35 & ~x36 & ~x37;
  assign z13 = new_n89_ | (~x04 & ~x13 & x39 & (x30 | x32));
  assign new_n89_ = x27 & (new_n90_ | (~x18 & ~x19 & ~new_n67_ & x20));
  assign new_n90_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign z14 = new_n93_ | (~new_n92_ & (x04 | x13 | ~x39));
  assign new_n92_ = ~new_n67_ & ~x18 & ~x19 & x20 & x27;
  assign new_n93_ = ~x30 & ~x32 & (~x27 | (~new_n94_ & x28));
  assign new_n94_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n99_ | (x08 & (new_n85_ | (~x27 & ~x28 & x35)));
  assign new_n99_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (new_n101_ | (~x08 & (~x27 | ~x35)));
  assign new_n101_ = ~new_n85_ & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
