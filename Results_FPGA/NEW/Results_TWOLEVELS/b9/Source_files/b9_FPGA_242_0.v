...
module FAU ( 
  ...
  assign z02 = ~new_n70_ | (~x02 & x39 & (~x08 | ~x29));
  ...
  assign new_n80_ = (new_n68_ | x36) & (x40 ? x05 : x07);
  assign new_n81_ = x05 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n83_ & ~x30;
  assign new_n83_ = (new_n84_ | x27) & ~new_n85_ & ~new_n86_ & (x39 | (~x27 & x35));
  assign new_n84_ = x08 & (~x28 | x39);
  assign new_n85_ = (~x29 | ~x40) & ((x04 & x27) | x28 | ~x35);
  assign new_n86_ = ~x08 & (x04 | x28 | ~x35);
  assign z12 = (~x10 & (new_n88_ | ~x27)) | ((x04 | ~x40) & (new_n66_ | ~x27));
  assign new_n88_ = ~x35 & ~x36 & ~x37;
  assign z13 = new_n90_ | (~x04 & ~x13 & x40 & (x30 | x32));
  assign new_n90_ = x27 & (new_n91_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n91_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n94_ | (~new_n93_ & (x04 | x13 | ~x40));
