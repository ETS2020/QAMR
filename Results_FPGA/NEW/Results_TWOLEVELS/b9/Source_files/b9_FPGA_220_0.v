...
module FAU ( 
  ...
  assign new_n84_ = ((x29 & x39) | (new_n72_ & (~x04 | ~x27))) & (x08 | (new_n72_ & ~x04 & x27));
  ...
  assign z18 = ~new_n101_ | (x08 & ((x29 & x39) | (new_n72_ & ~x27)));
  assign new_n101_ = ~x09 & ~x30 & (~new_n72_ | x04 | ~x27);
  assign z20 = ~x09 & ~new_n103_ & ~x30;
  assign new_n103_ = (x08 | (x27 & x35)) & ((x29 & x39) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
