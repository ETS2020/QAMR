...
module FAU ( 
  ...
  assign new_n85_ = ~new_n86_ & (new_n87_ | x08) & (x35 | (x08 & x29 & x40));
  assign new_n86_ = (x28 | (x04 & x27)) & (~x29 | ~x39 | ~x40);
  assign new_n87_ = x27 & ~x28 & (~x04 | ~x39);
  assign z12 = new_n89_ | new_n90_ | (~x27 & ((x04 & x39) | ~x39 | ~x40));
  assign new_n89_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
  assign new_n90_ = ~x37 & ((~x28 & ~x39) | ((~x28 | ~x35) & (x04 | ~x40)));
  ...
  assign z14 = (~new_n95_ & (x18 | x19 | ~x20)) | ~new_n97_ | new_n100_;
  assign new_n95_ = ~new_n96_ & x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = new_n99_ & (new_n98_ | (~x04 & ~x13));
  assign new_n98_ = (x27 | ~x39) & (x37 | (x28 & x35));
  assign new_n99_ = ((x39 & x40) | (x27 & (x28 | x37))) & (x35 | x37 | x40);
