...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | ~new_n70_ | ~x40;
  assign new_n70_ = x39 & (~x04 | (~x28 & x35 & (x08 | x27)));
  assign z03 = (~x21 & (x37 | ~x40)) | (x27 & (~x28 | ~x35)) | (~x27 & ~x37);
  assign z04 = (x27 & (~x28 | ~x35)) | (~x27 & ~x37) | (x21 & (x37 | ~x40));
  ...
  assign z14 = new_n65_ | (~new_n93_ & (new_n94_ | ~new_n95_)) | (~new_n96_ & ~x27);
