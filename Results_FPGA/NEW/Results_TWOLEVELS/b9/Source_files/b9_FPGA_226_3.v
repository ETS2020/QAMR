...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n76_, new_n77_, new_n81_,
    ...
    new_n105_;
  assign z00 = ~x16 | (~x15 & x27 & (new_n65_ | ~new_n66_));
  ...
  assign new_n70_ = (x02 | (x08 & x29)) & (~x04 | (~x28 & x35));
  assign z03 = (x27 & (~x35 | (~x28 & x37))) | ~x21 | (~x37 & (~x27 | ~x28));
  assign z04 = (x27 & (~x35 | (~x28 & x37))) | x21 | (~x37 & (~x27 | ~x28));
  ...
  assign z10 = new_n83_ | (~x04 & (new_n82_ | (x27 & ~new_n68_ & ~new_n81_)));
  assign new_n81_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n82_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n83_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n85_ & ~new_n86_));
  assign new_n85_ = x29 & x39 & x40;
  assign new_n86_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n87_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = x37 ? ~x27 : ((~new_n89_ & (~x28 | ~x35)) | ~x27 | (~x35 & ~x36));
  assign new_n89_ = ~x04 & x39 & x40;
  assign z13 = (x27 & (new_n93_ | (~x04 & new_n92_ & ~x13))) | (~x04 & new_n91_ & ~x13);
  assign new_n91_ = x39 & x40 & (x30 | x32);
  assign new_n92_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = (~new_n95_ & (new_n96_ | ~new_n97_)) | new_n98_ | (~new_n97_ & (new_n66_ | ~x27));
  ...
  assign new_n103_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & (new_n105_ | (~x08 & (~x27 | ~x35)));
  assign new_n105_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
