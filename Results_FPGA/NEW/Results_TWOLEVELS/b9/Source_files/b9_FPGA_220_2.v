...
module FAU ( 
  ...
  assign z11 = ~new_n84_ & ~x30;
  assign new_n84_ = (new_n85_ | (new_n72_ & (~x04 | ~x27))) & (x08 | x09 | (new_n72_ & ~x04 & x27));
  assign new_n85_ = x40 & (x09 | (x29 & x39));
  ...
  assign new_n97_ = ~x27 & (x04 | ~x39 | ~x40 | (x13 & x40));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n102_ | (x08 & ((new_n72_ & ~x27) | (z08 & x29)));
  assign new_n102_ = ~x09 & ~x30 & (~new_n72_ | x04 | ~x27);
  assign z20 = ~new_n104_ & ~x30;
  assign new_n104_ = (new_n105_ | x09) & (x40 | (x35 & (x27 | ~x28)));
  assign new_n105_ = (x08 | (x27 & x35)) & ((x29 & x39) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
  assign z19 = ~new_n84_ & ~x30;
endmodule
