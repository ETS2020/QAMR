...
module FAU ( 
  ...
  assign z11 = ~x30 & (new_n87_ | (~new_n85_ & ~new_n86_));
  assign new_n85_ = x29 & x39 & x40;
  assign new_n86_ = x35 ? (~x28 & (~x04 | ~x27)) : x09;
  assign new_n87_ = ~x08 & (x35 ? (x04 | ~x27 | x28) : ~x09);
  ...
  assign z20 = ~x30 & (new_n105_ | (~new_n85_ & ~new_n106_));
  assign new_n105_ = ~x08 & (x35 ? ~x27 : ~x09);
  assign new_n106_ = (x09 | x35) & (x27 | ~x28 | ~x35);
  assign z05 = ~z06;
  assign z19 = ~x30 & (new_n87_ | (~new_n85_ & ~new_n86_));
endmodule
