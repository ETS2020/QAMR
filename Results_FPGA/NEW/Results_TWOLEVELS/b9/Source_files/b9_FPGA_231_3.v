// Benchmark "FAU" written by ABC on Wed Jul 29 04:53:57 2020
...
module FAU ( 
  ...
  assign new_n65_ = x27 & (new_n66_ | new_n67_ | x37);
  ...
  assign new_n82_ = (~x27 | new_n70_ | (z08 ? ~x05 : ~x07)) & (~new_n83_ | ~x05);
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n85_ & ~x30;
  assign new_n85_ = ((z08 & x29) | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
  assign z12 = new_n87_ | ((~x27 | (~new_n67_ & ~x37)) & (~z08 | x04));
  assign new_n87_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
  assign z13 = (x27 & (new_n89_ | (~x04 & new_n90_ & ~x13))) | (~x04 & new_n83_ & ~x13);
  assign new_n89_ = ~x18 & ~x19 & x20 & (new_n67_ | x37);
  assign new_n90_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n92_ | new_n95_ | ~new_n96_ | (new_n94_ & ~x37);
  assign new_n92_ = (x18 | ~x20) & (new_n93_ | ~z08 | x04 | x13);
  assign new_n93_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n94_ = ~new_n67_ & (~z08 | x04 | x13);
  assign new_n95_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n96_ = ~x19 & (x27 | (x39 & x40 & ~x04 & (~x13 | ~x39)));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n101_ | (x08 & ((new_n73_ & ~x27) | (z08 & x29)));
  assign new_n101_ = ~x09 & ~x30 & (~new_n73_ | x04 | ~x27);
