...
module FAU ( 
  ...
  wire new_n65_, new_n68_, new_n70_, new_n71_, new_n72_, new_n73_, new_n75_,
    new_n78_, new_n79_, new_n83_, new_n84_, new_n86_, new_n89_, new_n90_,
  ...
  assign new_n68_ = x39 & x40 & (~x04 | (x08 & ~x28 & x35));
  ...
  assign new_n83_ = x36 & ((x39 & x40) ? x05 : x07);
  ...
  assign z13 = new_n90_ | (x27 & (new_n71_ | new_n89_));
  assign new_n89_ = ~x04 & ~x13 & ~x28 & x39 & x40;
  assign new_n90_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n71_ & ~new_n92_) | new_n94_ | (~new_n93_ & (x04 | x13));
  assign new_n92_ = x39 & x40 & (~x28 | x30 | x32);
  assign new_n93_ = x27 & x37 & (~x27 | (~x18 & ~x19 & x20));
