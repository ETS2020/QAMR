...
module FAU ( 
  ...
  assign z02 = new_n72_ | ~z08 | (x04 & (x28 | ~x35));
  assign z08 = x39 & x40;
  ...
  assign z11 = ~x09 & ~x30 & (~x08 | (~new_n85_ & (~z08 | ~x29)));
  ...
  assign z18 = ~new_n101_ | (~x28 & x35 & (~x04 | ~x27));
  assign new_n101_ = ~x09 & ~x30 & (~x39 | ~x40 | ~x08 | ~x29);
  assign z20 = ~x09 & ~x30 & (new_n103_ | ~x08);
  assign new_n103_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
  assign z19 = ~x09 & ~x30 & (~x08 | (~new_n85_ & (~z08 | ~x29)));
endmodule
