// Benchmark "FAU" written by ABC on Wed Jul 29 03:46:51 2020
...
module FAU ( 
  ...
  wire new_n52_;
  assign z00 = x11 & x20;
  assign z01 = x15 & x10 & ~x14;
  assign z02 = ~x11 & x12 & (x14 | (x08 & x10 & ~x15));
  assign z03 = x15 & x10 & x12 & ~x14;
  assign z09 = x08 & x09;
  assign z12 = x12 & ((x13 & (~x08 | ~x10 | x15)) | (x00 & x08 & x10 & ~x15));
  assign z13 = x12 & ((x15 & (x14 | (x10 & ~x14))) | (x14 & (~x01 | ~x08 | ~x10)));
