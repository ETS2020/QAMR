// Benchmark "FAU" written by ABC on Wed Jul 29 15:31:57 2020
...
module FAU ( 
  ...
  assign new_n212_ = ~x064 & (x104 | x112 | (~x056 & (x096 | x120)));
  assign new_n213_ = x112 & (~x032 | (~x104 & x120));
  assign new_n214_ = ~x032 & (x104 | (~x088 & x096));
  assign new_n215_ = ~x080 & (x016 | x112 | ~x120);
  assign new_n216_ = ~x088 & x120;
