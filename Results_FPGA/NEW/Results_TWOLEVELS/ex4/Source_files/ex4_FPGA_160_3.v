// Benchmark "FAU" written by ABC on Wed Jul 29 15:33:40 2020
...
module FAU ( 
  ...
  assign new_n195_ = x070 & (~x110 | ~x118 | (x062 & (~x102 | ~x126)));
  assign new_n196_ = ~x118 & (x038 | (x110 & ~x126));
  assign new_n197_ = x038 & (~x110 | (x094 & ~x102));
  assign new_n198_ = x086 & (~x022 | ~x118 | x126);
  assign new_n199_ = x094 & ~x126;
