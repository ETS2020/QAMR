// Benchmark "FAU" written by ABC on Wed Jul 29 15:33:24 2020
...
module FAU ( 
  ...
  assign new_n236_ = (x013 | x037 | ~x085) & (x077 | (~new_n237_ & (~new_n243_ | x013 | ~x037)));
  assign new_n237_ = ~x053 & (new_n238_ | new_n239_ | new_n240_ | new_n241_ | ~new_n242_);
  assign new_n238_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n239_ = ~x061 & ((~x069 & x101) | (x093 & x125));
  assign new_n240_ = ~x093 & ((~x037 & x101) | (~x069 & x125));
  assign new_n241_ = (x109 | x117) & (~x037 | ~x069);
  assign new_n242_ = ~x085 & (x021 | x117 | ~x125);
  assign new_n243_ = ~x109 & x125;
  ...
  assign z14 = ~x046 & ((~new_n252_ & x006) | ~new_n265_ | (~new_n260_ & ~x078));
  ...
  assign new_n260_ = (new_n261_ | ~x070) & (x086 | (~new_n264_ & (new_n262_ | x054)));
  assign new_n261_ = (x038 | (~x022 & (~x030 | x054 | x086))) & (x054 | new_n201_ | x086);
  assign new_n262_ = (~new_n263_ | ~x030) & ((~x110 & ~x118) | (~x022 & (new_n203_ | ~x030)));
  assign new_n263_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n264_ = x038 & (~new_n201_ | (x030 & (~x014 | ~x022)));
  assign new_n265_ = (new_n266_ | ~x014) & (~x038 | ~x054) & (x014 | ~x022 | x054 | ~x070);
  assign new_n266_ = ~x078 & (x054 | x086 | (~x110 & ~x118));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
