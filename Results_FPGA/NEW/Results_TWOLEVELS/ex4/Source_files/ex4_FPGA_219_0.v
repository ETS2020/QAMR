// Benchmark "FAU" written by ABC on Wed Jul 29 15:34:29 2020
...
module FAU ( 
  ...
  assign new_n191_ = (~x014 | ~x038 | x086) & (~x078 | (~new_n192_ & (~new_n198_ | ~x014 | x038)));
  assign new_n192_ = x054 & (new_n193_ | new_n194_ | new_n195_ | new_n196_ | ~new_n197_);
  assign new_n193_ = (x014 | x022) & (~x030 | ~x062 | ~x094);
  assign new_n194_ = x062 & ((x038 & ~x102) | (~x094 & ~x126));
  assign new_n195_ = (x038 | x070) & (~x110 | ~x118);
  assign new_n196_ = x070 & x094 & (~x102 | ~x126);
  assign new_n197_ = x086 & (~x022 | ~x118 | x126);
  assign new_n198_ = x110 & ~x126;
  ...
  assign new_n260_ = (x038 | (~x022 & (~x030 | x054 | x086))) & (x054 | new_n201_ | x086);
  assign new_n261_ = (~new_n262_ | ~x030) & ((~x110 & ~x118) | (~x022 & (new_n203_ | ~x030)));
  assign new_n262_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n263_ = x038 & (~new_n201_ | (x030 & (~x014 | ~x022)));
  assign new_n264_ = (new_n265_ | ~x014) & (~x038 | ~x054) & (x014 | ~x022 | x054 | ~x070);
  assign new_n265_ = ~x078 & (x054 | x086 | (~x110 & ~x118));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
