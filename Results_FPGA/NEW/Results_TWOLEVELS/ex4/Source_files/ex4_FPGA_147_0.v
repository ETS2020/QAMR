...
module FAU ( 
  ...
  assign z06 = x046 & (~new_n197_ | (~x006 & (new_n206_ | (~new_n191_ & x054))));
  assign new_n191_ = (new_n192_ | ~x078) & ~new_n196_ & (~x070 | ~x094 | x102);
  assign new_n192_ = ~new_n193_ & (new_n194_ | (~x038 & ~x070)) & ~new_n195_ & x086;
  assign new_n193_ = (x014 | x022) & (~x030 | ~x062 | ~x094);
  assign new_n194_ = x110 & x118;
  assign new_n195_ = ~x126 & ((x070 & x094) | (x022 & x118) | (x110 & ~x118));
  assign new_n196_ = x038 & x062 & (~x102 | (~x014 & ~x126));
  assign new_n197_ = new_n205_ & (~x086 | (~new_n204_ & ((~new_n198_ & new_n200_) | ~x054)));
  assign new_n198_ = ~new_n194_ & (~x014 | (x078 & (~x022 | (~new_n199_ & ~x030))));
  assign new_n199_ = ~x062 & ~x094;
  assign new_n200_ = (~new_n203_ | x030) & (~x078 | ((new_n201_ | x070) & (new_n202_ | x030)));
  assign new_n201_ = x062 & x094;
  assign new_n202_ = (~x022 | x070) & (x126 | (~x014 & ~x022) | (~x062 & ~x094));
  assign new_n203_ = ~x102 & (x062 | x094) & (x014 | x022);
  assign new_n204_ = ~x038 & x078 & (~new_n201_ | (~x030 & (x014 | x022)));
  ...
  assign z14 = ~x046 & (~new_n260_ | (~new_n253_ & ~x078));
  assign new_n253_ = (new_n259_ | x038) & (x054 | (~new_n254_ & ~new_n256_)) & (new_n258_ | ~x038);
  assign new_n254_ = ~x086 & (~new_n255_ | (x030 & ~new_n201_ & (~x014 | ~x022)));
  assign new_n255_ = (~x022 | (~x110 & ~x118)) & (~x070 | (~x062 & ~x094));
  assign new_n256_ = x006 & (~new_n257_ | (~x022 & (x094 | (~x118 & x126))));
  assign new_n257_ = (x014 | ~x094) & ~x086 & (x070 | x094);
  assign new_n258_ = (new_n199_ | x086) & (~x006 | x014 | x110 | ~x126);
  assign new_n259_ = (~x006 | x054 | x062) & (~x022 | ~x070);
  assign new_n260_ = (new_n261_ | x014) & (~x038 | ~x054) & (~x014 | (~x078 & (~new_n262_ | x054)));
  assign new_n261_ = (~x022 | x054 | ~x070) & (~x006 | x038 | ~x086);
  assign new_n262_ = ~x086 & (x110 | x118);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
