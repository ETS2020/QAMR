...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n191_ & ~x006) | ~new_n207_ | (~new_n199_ & x078));
  ...
  assign new_n199_ = new_n204_ & (~x086 | (~new_n200_ & ~new_n206_ & (new_n202_ | x030)));
  assign new_n200_ = ~new_n201_ & (~x038 | (x054 & ~x070));
  assign new_n201_ = (~x022 | x030) & x062 & x094;
  assign new_n202_ = (~x014 | x038) & (~x054 | new_n203_ | (~x062 & ~x094));
  assign new_n203_ = x118 & ((~x014 & ~x022) | (x102 & x126));
  assign new_n204_ = ~new_n205_ & (x022 | ((~x054 | x110) & (~x038 | x070)));
  assign new_n205_ = ~x030 & x054 & ~x110 & (x062 | x094);
  assign new_n206_ = ~x022 & x054 & ~x118;
  assign new_n207_ = (new_n208_ | x014) & (x038 | x054) & (~x014 | x022 | ~x054 | x070);
  assign new_n208_ = x078 & (~x054 | (x110 & (~x086 | x118)));
  ...
  assign z14 = ~x046 & ((~new_n258_ & x014) | new_n253_ | new_n260_ | (~new_n259_ & ~x014));
  assign new_n253_ = ~x078 & (new_n256_ | new_n257_ | (~new_n254_ & ~x054));
  assign new_n254_ = ~new_n255_ & (x086 | ((~x030 | (x062 & x094)) & (~x070 | (~x062 & ~x094))));
  assign new_n255_ = x006 & (~x038 | ~x070 | x086 | (~x118 & x126));
  assign new_n256_ = x022 & ((~x038 & x070) | (~x054 & ~x086));
  assign new_n257_ = x038 & ~x086 & (x062 | x094);
  assign new_n258_ = ~x078 & (x054 | x086);
  assign new_n259_ = (~x022 | x054 | ~x070) & (~x006 | x038 | ~x086);
  assign new_n260_ = x038 & x054;
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
