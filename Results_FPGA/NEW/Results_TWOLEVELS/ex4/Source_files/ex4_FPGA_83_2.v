...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n192_ & ~x006) | ~new_n207_ | (~new_n200_ & x078));
  ...
  assign new_n200_ = (new_n201_ | x070) & (~x086 | (~new_n206_ & (new_n203_ | ~x054)));
  assign new_n201_ = (~x038 | (x022 & (x030 | ~x054 | ~x086))) & (~x054 | new_n202_ | ~x086);
  assign new_n202_ = x062 & x094;
  assign new_n203_ = (~new_n205_ | x030) & ((x110 & x118) | (x022 & (new_n204_ | x030)));
  assign new_n204_ = ~x062 & ~x094;
  assign new_n205_ = (~x102 | ~x126) & (x062 | x094) & (x014 | x022);
  assign new_n206_ = ~x038 & (~new_n202_ | (~x030 & (x014 | x022)));
  assign new_n207_ = (new_n208_ | x014) & (x038 | x054) & (~x014 | x022 | ~x054 | x070);
  assign new_n208_ = x078 & (~x054 | ~x086 | (x110 & x118));
  ...
  assign new_n248_ = ~x077 & ((x069 & (~new_n186_ | (~x021 & x029))) | (new_n249_ & x029));
