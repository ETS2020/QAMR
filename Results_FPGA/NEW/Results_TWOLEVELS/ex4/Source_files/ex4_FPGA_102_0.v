// Benchmark "FAU" written by ABC on Wed Jul 29 15:32:51 2020
...
module FAU ( 
  ...
  assign new_n174_ = (~x077 | (~new_n175_ & (~new_n181_ | ~x013 | x037))) & (~x013 | ~x037 | x085);
  assign new_n175_ = x053 & (new_n176_ | new_n177_ | new_n178_ | new_n179_ | ~new_n180_);
  assign new_n176_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n177_ = x061 & ((x037 & ~x101) | (~x093 & ~x125));
  assign new_n178_ = (x037 | x069) & (~x109 | ~x117);
  assign new_n179_ = x069 & x093 & (~x101 | ~x125);
  assign new_n180_ = x085 & (~x021 | ~x117 | x125);
  assign new_n181_ = x109 & ~x125;
  ...
  assign new_n185_ = x077 & ((~x069 & (~new_n186_ | (x021 & ~x029))) | (new_n187_ & ~x029));
  ...
  assign new_n191_ = (~x014 | ~x038 | x086) & (~x054 | (~new_n192_ & (~new_n198_ | x014 | ~x038)));
  ...
  assign new_n202_ = x078 & ((~x070 & (~new_n203_ | (x022 & ~x030))) | (new_n204_ & ~x030));
  ...
  assign z13 = ~x045 & ((~new_n236_ & x005) | ~new_n249_ | (~new_n244_ & ~x077));
  ...
  assign new_n244_ = (new_n245_ | ~x069) & (x085 | (~new_n248_ & (new_n246_ | x053)));
  assign new_n245_ = (x037 | (~x021 & (~x029 | x053 | x085))) & (x053 | new_n184_ | x085);
  assign new_n246_ = (~new_n247_ | ~x029) & ((~x109 & ~x117) | (~x021 & (new_n186_ | ~x029)));
  assign new_n247_ = (x101 | x125) & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n248_ = x037 & (~new_n184_ | (x029 & (~x013 | ~x021)));
  assign new_n249_ = (new_n250_ | ~x013) & (~x037 | ~x053) & (x013 | ~x021 | x053 | ~x069);
  assign new_n250_ = ~x077 & (x053 | x085 | (~x109 & ~x117));
  assign z14 = ~x046 & ((~new_n252_ & x006) | ~new_n265_ | (~new_n260_ & ~x086));
  assign new_n252_ = (x054 | (~new_n253_ & (~new_n259_ | ~x014 | x038))) & (x014 | x038 | ~x086);
  ...
  assign new_n259_ = ~x062 & x126;
  assign new_n260_ = ~new_n264_ & (x054 | (~new_n262_ & (new_n261_ | (~x110 & ~x118))));
  assign new_n261_ = ~x014 & (x078 | (~x022 & (new_n203_ | ~x030)));
  assign new_n262_ = ~x078 & ((x070 & (~new_n201_ | (~x022 & x030))) | (new_n263_ & x030));
  assign new_n263_ = (x102 | x126) & (~x062 | ~x094) & (~x014 | ~x022);
  assign new_n264_ = x038 & ~x078 & (~new_n201_ | (x030 & (~x014 | ~x022)));
