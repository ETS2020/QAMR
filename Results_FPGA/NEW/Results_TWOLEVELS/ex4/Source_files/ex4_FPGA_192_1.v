...
module FAU ( 
  ...
  assign z06 = x046 & (new_n191_ | ~new_n205_ | (~new_n198_ & x086));
  assign new_n191_ = ~x006 & (new_n197_ | (x054 & (new_n196_ | new_n192_ | ~new_n194_)));
  assign new_n192_ = x070 & (new_n193_ | (x062 & x078 & (~x102 | ~x126)));
  assign new_n193_ = x094 & (~x110 | ~x118 | ~x126);
  assign new_n194_ = (~x078 | x086) & (new_n195_ | ~x094);
  assign new_n195_ = (x118 | (~x038 & (~x110 | x126))) & (~x038 | (x102 & x110)) & (~x022 | ~x118 | x126);
  assign new_n196_ = (x014 | x022) & (x094 ? (~x030 | ~x062) : x078);
  assign new_n197_ = x014 & x038 & ~x086;
  assign new_n198_ = (new_n204_ | x038) & ((~new_n199_ & new_n201_) | ~x054);
  assign new_n199_ = ~new_n200_ & (~x110 | ~x118);
  assign new_n200_ = (x030 | (~x094 & (~x062 | ~x078))) & x014 & (x022 | ~x078);
  assign new_n201_ = (~x094 | (~new_n202_ & (x062 | x070))) & (~x078 | (~new_n203_ & (x070 | x094)));
  assign new_n202_ = ~x030 & ((x022 & ~x070) | ((x014 | x022) & (~x102 | ~x126)));
  assign new_n203_ = ~x030 & x062 & (x014 | x022) & (~x102 | ~x126);
  assign new_n204_ = x094 ? (x062 & (x030 | (~x014 & ~x022))) : ~x078;
  ...
  assign z14 = ~x046 & ((~new_n250_ & x006) | ~new_n260_ | (~new_n255_ & ~x078));
  assign new_n250_ = (x054 | new_n251_ | x078) & (x014 | x038 | ~x086);
  assign new_n251_ = ~new_n252_ & ~new_n253_ & ~new_n254_ & ~x086;
  assign new_n252_ = (x030 | x062) & (~x014 | ~x022);
  assign new_n253_ = (~x038 | ~x070) & (x102 | x110 | x118);
  assign new_n254_ = x126 & (~x070 | (~x014 & ~x110) | (~x022 & ~x118));
  assign new_n255_ = (new_n258_ | ~x070) & (x086 | (~new_n259_ & (new_n256_ | x054)));
  assign new_n256_ = (~x030 | (new_n257_ & ((x014 & x022) | (~x102 & ~x126)))) & (new_n257_ | ~x022);
  assign new_n257_ = ~x110 & ~x118;
  assign new_n258_ = (x038 | (~x022 & (~x030 | x054 | x086))) & (x054 | ~x062 | x086);
  assign new_n259_ = x038 & (x062 | (x030 & (~x014 | ~x022)));
  assign new_n260_ = (new_n261_ | ~x014) & (~x038 | ~x054) & (x014 | ~x022 | x054 | ~x070);
  assign new_n261_ = ~x078 & (x054 | new_n257_ | x086);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
