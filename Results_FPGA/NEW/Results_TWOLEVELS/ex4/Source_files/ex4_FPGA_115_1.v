...
module FAU ( 
  ...
  assign new_n208_ = (x072 | (~new_n209_ & (~new_n215_ | x008 | ~x032))) & (x008 | x032 | ~x080);
  assign new_n209_ = ~x048 & (new_n210_ | new_n211_ | new_n212_ | new_n213_ | ~new_n214_);
  assign new_n210_ = (~x008 | ~x016) & (x024 | x056 | x088);
  assign new_n211_ = ~x056 & ((~x064 & x096) | (x088 & x120));
  assign new_n212_ = ~x088 & ((~x032 & x096) | (~x064 & x120));
  assign new_n213_ = (x104 | x112) & (~x032 | ~x064);
  assign new_n214_ = ~x080 & (x016 | x112 | ~x120);
  assign new_n215_ = ~x104 & x120;
  ...
  assign new_n238_ = (x013 | x037 | ~x085) & (x053 | (~new_n239_ & (~new_n245_ | ~x013 | x037)));
  ...
  assign new_n253_ = (x014 | x038 | ~x086) & (x054 | (~new_n254_ & (~new_n260_ | ~x014 | x038)));
