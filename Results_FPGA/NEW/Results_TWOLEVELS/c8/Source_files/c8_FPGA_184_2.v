...
module FAU ( 
  ...
  wire new_n58_, new_n60_, new_n62_, new_n64_, new_n66_, new_n67_, new_n68_,
    new_n69_, new_n71_, new_n73_, new_n74_, new_n75_, new_n76_;
  ...
  assign z14 = x16 ? (new_n69_ | new_n66_ | x19) : ~new_n68_;
  assign new_n66_ = new_n67_ & ~x22 & ~x23 & ~x24;
  assign new_n67_ = ~x17 & ~x20 & ~x21;
  assign new_n68_ = x18 ? ~x05 : ~x13;
  assign new_n69_ = x24 & (x17 | x20 | x21 | x22 | x23);
  assign z15 = x16 ? ~new_n71_ : (x18 ? x06 : x14);
  assign new_n71_ = (~x25 | (new_n67_ & ~x22 & ~x23 & ~x24)) & (~new_n67_ | x22 | x23 | x24 | x25);
  assign z16 = x16 ? (new_n74_ | (~new_n73_ & x26)) : ~new_n76_;
  assign new_n73_ = new_n67_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n74_ = new_n75_ & ~x17 & ~x20 & ~x21 & ~x22;
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n76_ = x18 ? ~x07 : ~x15;
