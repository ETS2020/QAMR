...
module FAU ( 
  ...
  assign new_n68_ = (new_n70_ | x23) & (~x24 | (new_n69_ & ~x21 & ~x22 & ~x23));
  assign new_n69_ = ~x19 & ~x20;
  assign new_n70_ = x17 ? ~x24 : (x19 | x20 | x21 | x22 | x24);
  assign z15 = x16 ? ~new_n72_ : (x18 ? x06 : x14);
  assign new_n72_ = (~x25 | (new_n60_ & new_n73_)) & (~new_n62_ | ~new_n74_);
  assign new_n73_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ~new_n76_ : (x18 ? x07 : x15);
  assign new_n76_ = (x24 | (~x17 & (~new_n77_ | ~new_n69_ | x17))) & (new_n78_ | ~x26);
