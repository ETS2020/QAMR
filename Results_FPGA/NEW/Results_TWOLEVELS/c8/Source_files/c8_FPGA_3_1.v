// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:16 2020
...
module FAU ( 
  ...
  assign z10 = x16 ? (x20 | (~x17 & ~x19)) : ~new_n58_;
  assign new_n58_ = x18 ? ~x01 : ~x09;
  assign z11 = x16 ? ~new_n60_ : (x18 ? x02 : x10);
  assign new_n60_ = (~x21 | (~x17 & ~x19)) & (x17 | x19 | x21);
  assign z12 = x16 ? (new_n64_ | (~new_n62_ & x22)) : ~new_n63_;
  assign new_n62_ = ~x17 & ~x19 & ~x21;
  assign new_n63_ = x18 ? ~x03 : ~x11;
  assign new_n64_ = ~x21 & ~x22 & ~x17 & ~x19;
  assign z13 = x16 ? ~new_n66_ : (x18 ? x04 : x12);
  assign new_n66_ = (~x23 | (~x21 & ~x22 & ~x17 & ~x19)) & (x17 | x19 | x21 | x22 | x23);
  ...
  assign new_n70_ = (~x25 | (new_n62_ & ~x22 & ~x23 & ~x24)) & (~new_n62_ | x22 | x23 | x24 | x25);
  assign z16 = x16 ? (new_n73_ | (~new_n72_ & x26)) : ~new_n74_;
  assign new_n72_ = new_n62_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n73_ = new_n64_ & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n74_ = x18 ? ~x07 : ~x15;
