...
module FAU ( 
  ...
  assign new_n72_ = ~x21 & ~x22 & ~x24;
  assign z16 = x16 ? ~new_n74_ : (x18 ? x07 : x15);
  assign new_n74_ = (~x26 | (new_n60_ & new_n75_)) & (~new_n62_ | ~new_n76_);
  assign new_n75_ = ~x21 & ~x22 & ~x24 & ~x25;
  assign new_n76_ = ~x22 & ~x24 & ~x25 & ~x26;
  assign z17 = ~new_n78_ & x16;
  assign new_n78_ = (~new_n76_ | x20 | x21 | x17 | ~x19) & (~x17 | ~x27);
  assign z08 = x27;
endmodule
