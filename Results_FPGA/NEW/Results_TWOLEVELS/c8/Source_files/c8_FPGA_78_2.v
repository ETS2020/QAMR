// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:30 2020
...
module FAU ( 
  ...
  assign new_n58_ = ~x19 & (~x17 | ~x20) & (x17 | x20);
  assign z11 = x16 ? ~new_n60_ : (x18 ? x02 : x10);
  assign new_n60_ = (~x21 | (~x17 & ~x20)) & (x17 | x20 | x21);
  ...
  assign new_n66_ = (~x23 | (~x17 & ~x20 & ~x21 & ~x22)) & (x17 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? ~new_n68_ : (x18 ? x05 : x13);
  assign new_n68_ = (~x24 | (~x17 & ~x20 & ~x21 & ~x22 & ~x23)) & (x17 | x20 | x21 | x22 | x23 | x24);
