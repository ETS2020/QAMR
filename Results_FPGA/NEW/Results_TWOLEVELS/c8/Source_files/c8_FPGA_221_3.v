// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:57 2020
...
module FAU ( 
  ...
  assign new_n64_ = (x17 | x20 | x21 | x22 | (~x23 & (x19 | x23))) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z13 = x16 ? ~new_n66_ : (x18 ? x04 : x12);
  assign new_n66_ = (~x23 | (~x17 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
