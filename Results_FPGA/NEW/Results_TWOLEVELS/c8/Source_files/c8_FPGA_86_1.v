...
module FAU ( 
  ...
  assign z11 = x16 ? (new_n60_ | x21) : (x18 ? x02 : x10);
  assign new_n60_ = ~x17 & ~x19 & ~x20;
  assign z12 = x16 ? (new_n63_ | (~new_n60_ & x22)) : ~new_n62_;
  ...
  assign new_n67_ = (~x24 | (~x17 & ~x19 & ~x20 & ~x22 & ~x23)) & (x17 | x19 | x20 | x22 | x23 | x24);
  assign z15 = x16 ? ~new_n69_ : (x18 ? x06 : x14);
  assign new_n69_ = (~x25 | (new_n60_ & ~x22 & ~x23 & ~x24)) & (~new_n60_ | x22 | x23 | x24 | x25);
