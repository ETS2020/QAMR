...
module FAU ( 
  ...
  assign new_n70_ = (x17 | x19 | ~new_n72_ | x20) & (~x25 | (new_n71_ & ~x17 & ~x19 & ~x20));
  assign new_n71_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n72_ = ~x21 & ~x22 & ~x23 & ~x24 & (x26 | (~x25 & ~x26));
  assign z16 = x16 ? (new_n74_ | (new_n62_ & new_n76_)) : ~new_n75_;
  assign new_n74_ = x26 & (~new_n60_ | ~new_n71_);
