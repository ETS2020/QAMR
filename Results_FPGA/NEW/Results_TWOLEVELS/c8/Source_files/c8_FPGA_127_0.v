...
module FAU ( 
  ...
  assign z14 = x16 ? (new_n68_ | (~new_n67_ & ~x23)) : ~new_n66_;
  assign new_n66_ = x18 ? ~x05 : ~x13;
  assign new_n67_ = (x17 | x19 | x20 | x21 | x22 | x24) & (~x17 | ~x24);
  assign new_n68_ = x24 & (x19 | x20 | x21 | x22 | x23);
  assign z15 = x16 ? ((~new_n71_ & x25) | (x17 & ~x24)) : ~new_n70_;
  assign new_n70_ = x18 ? ~x06 : ~x14;
