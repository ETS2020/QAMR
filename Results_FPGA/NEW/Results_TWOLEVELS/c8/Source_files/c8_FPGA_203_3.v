// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:54 2020
...
module FAU ( 
  ...
  assign new_n58_ = (x17 | x20 | (~x21 & (x19 | x21))) & (~x20 | (~x17 & ~x19));
  assign z11 = x16 ? ~new_n60_ : (x18 ? x02 : x10);
  assign new_n60_ = (~x21 | (~x17 & ~x20)) & (x17 | x19 | x20 | x21);
  ...
  assign new_n66_ = (~x24 | (new_n67_ & ~x21 & ~x22 & ~x23)) & (~new_n67_ | x21 | x22 | x23 | x24);
  assign new_n67_ = ~x17 & ~x19 & ~x20;
  assign z15 = x16 ? (new_n69_ | new_n70_) : (x18 ? x06 : x14);
  assign new_n69_ = x25 & (~new_n67_ | x21 | x22 | x23 | x24);
  ...
  assign new_n75_ = (~new_n76_ | x20 | x22 | x17 | ~x19) & (~x17 | ~x27);
