...
module FAU ( 
  ...
  assign new_n68_ = ~x24 & (~new_n60_ | ~new_n69_ | x21);
  assign new_n69_ = ~x22 & ~x23;
  assign z15 = x16 ? ~new_n71_ : (x18 ? x06 : x14);
  assign new_n71_ = (~x25 | (new_n60_ & ~x21 & ~x22 & ~x23)) & (~new_n60_ | x21 | x22 | x23 | x25);
  assign z16 = x16 ? ~new_n73_ : (x18 ? x07 : x15);
  assign new_n73_ = (~x26 | (new_n60_ & new_n74_)) & (~new_n62_ | ~new_n69_ | x25 | x26);
  assign new_n74_ = ~x21 & ~x22 & ~x23 & ~x25;
