...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n58_, new_n60_, new_n62_, new_n64_, new_n69_, new_n70_;
  ...
  assign new_n64_ = (x17 | x19 | (~x20 & (x20 | (~x21 & (x21 | ~x22))))) & (~x23 | (~x17 & ~x19));
  assign z14 = x16 ? x24 : (x18 ? x05 : x13);
  assign z15 = x16 ? x25 : (x18 ? x06 : x14);
  assign z16 = x16 ? x26 : (x18 ? x07 : x15);
  assign z17 = x16 & ((x17 & x27) | (new_n70_ & new_n69_ & ~x17 & ~x20));
