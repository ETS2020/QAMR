...
module FAU ( 
  ...
  assign new_n66_ = (x17 | x19 | new_n68_ | x20) & (~x24 | (~x17 & ~x19 & new_n67_ & ~x20));
  assign new_n67_ = ~x22 & ~x23;
  assign new_n68_ = ~x21 & (x22 | x23 | x24);
  assign z15 = x16 ? ~new_n70_ : (x18 ? x06 : x14);
  assign new_n70_ = (~x25 | (new_n71_ & ~x22 & ~x23 & ~x24)) & (~new_n71_ | x22 | x23 | x24 | x25);
  assign new_n71_ = ~x17 & ~x19 & ~x20;
  assign z16 = x16 ? ~new_n73_ : (x18 ? x07 : x15);
  assign new_n73_ = (~x26 | (new_n71_ & new_n74_)) & (~new_n75_ | ~new_n76_);
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n75_ = ~x17 & ~x19 & ~x20 & ~x22;
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign z17 = ~new_n78_ & x16;
  assign new_n78_ = (~new_n76_ | x20 | x22 | x17 | ~x19) & (~x17 | ~x27);
  assign z08 = x27;
endmodule
