...
module FAU ( 
  ...
  assign new_n64_ = (x17 | x19 | x20 | x21 | (~x22 & x23)) & (~x23 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z14 = x16 ? ~new_n66_ : (x18 ? x05 : x13);
  assign new_n66_ = (~x24 | (~x17 & ~x19 & ~x20 & ~x21 & ~x23)) & (x17 | x19 | x20 | x21 | x23 | x24);
  assign z15 = x16 ? ~new_n68_ : (x18 ? x06 : x14);
  assign new_n68_ = (~x25 | (new_n69_ & ~x21 & ~x23 & ~x24)) & (~new_n69_ | x21 | x23 | x24 | x25);
  assign new_n69_ = ~x17 & ~x19 & ~x20;
  assign z16 = x16 ? (new_n72_ | (~new_n71_ & x26)) : ~new_n74_;
  assign new_n71_ = new_n69_ & ~x21 & ~x23 & ~x24 & ~x25;
  ...
  assign new_n76_ = (~new_n73_ | x20 | x21 | x17 | ~x19) & (~x17 | ~x27);
  assign z08 = x27;
endmodule
