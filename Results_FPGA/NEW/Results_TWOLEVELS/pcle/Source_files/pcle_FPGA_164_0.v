// Benchmark "FAU" written by ABC on Wed Jul 29 03:53:09 2020
...
module FAU ( 
  ...
  assign new_n33_ = x09 & ~x10 & ~x11 & (x12 | x17);
  ...
  assign new_n44_ = (new_n45_ | ~x11) & (~x17 | (x11 & x13 & new_n46_ & x14));
  assign new_n45_ = x12 & (~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign new_n46_ = x15 & x16;
  assign z8 = x08 ? x07 : (x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~x18 | (new_n49_ & new_n51_)) & (~new_n50_ | ~new_n46_ | ~x17 | x18);
