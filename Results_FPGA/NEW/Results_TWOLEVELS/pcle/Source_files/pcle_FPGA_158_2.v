...
module FAU ( 
  ...
  wire new_n31_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
    new_n46_;
  assign z0 = x18 & x17 & x16 & new_n31_ & x14;
  ...
  assign new_n39_ = ~x10 & (x12 ? (~x11 | (x11 & (~x13 | (x13 & ~x14)))) : x15);
  assign z6 = x08 ? x05 : (new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x16 & (~x11 | ~x12 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x16));
  assign z7 = x08 ? x06 : (x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x17 | (x11 & x12 & x13 & x14 & x16)) & (~x14 | ~x16 | x17 | ~x11 | ~x12 | ~x13);
  assign z8 = x08 ? x07 : (new_n45_ & x09);
  assign new_n45_ = ~x10 & ((x18 & (~new_n46_ | ~x14 | ~x16 | ~x17)) | (new_n46_ & x17 & ~x18 & x14 & x16));
