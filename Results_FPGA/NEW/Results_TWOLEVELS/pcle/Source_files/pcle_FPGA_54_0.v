...
module FAU ( 
  ...
  assign new_n33_ = x09 & ~x10 & ~x11 & (x14 | x16);
  assign z2 = x08 ? x01 : new_n35_;
  assign new_n35_ = x09 & ~x10 & (x11 ? (~x12 & (x14 | x16)) : x12);
  assign z3 = x08 ? x02 : new_n37_;
  assign new_n37_ = x09 & ~x10 & ((x13 & (~x11 | ~x12)) | (x11 & x12 & ~x13));
  assign z4 = x08 ? x03 : new_n39_;
  assign new_n39_ = x09 & ~x10 & ((x11 & (x12 ? (x13 & ~x14) : x14)) | (x14 & (~x11 | ~x13)));
  assign z5 = x08 ? x04 : (new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x15 & (~x11 | ~x12 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = x08 ? x05 : (x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x11 | (x12 ? (~x13 | (x14 & (~x15 | x16))) : ~x16)) & (~x16 | (x11 & x13 & x15));
