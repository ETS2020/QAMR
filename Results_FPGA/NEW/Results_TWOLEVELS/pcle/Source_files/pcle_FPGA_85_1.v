// Benchmark "FAU" written by ABC on Wed Jul 29 03:52:55 2020
...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x13 & ~x14 & x11 & x12));
  assign z5 = x08 ? x04 : new_n39_;
  assign new_n39_ = x09 & ~x10 & ((x14 & ~x15 & x11 & x13) | (x15 & (~x11 | ~x13 | ~x14)));
