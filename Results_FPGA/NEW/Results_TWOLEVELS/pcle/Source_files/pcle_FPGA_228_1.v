...
module FAU ( 
  ...
  assign z6 = (x05 & x08) | (new_n41_ & x09);
  assign new_n41_ = ~x10 & ((~new_n43_ & x16) | (new_n42_ & x14 & x15 & ~x16));
  assign new_n42_ = x11 & x12 & x13;
  assign new_n43_ = (x08 | (x11 & x12)) & (~x12 | (x13 & x14 & x15));
  assign z7 = x08 ? x06 : (new_n45_ & x09);
  assign new_n45_ = ~x10 & ((x17 & (~new_n42_ | ~x14 | ~x15 | ~x16)) | (new_n42_ & x16 & ~x17 & x14 & x15));
  assign z8 = x08 ? x07 : (x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~x18 | (new_n42_ & new_n50_)) & (~new_n48_ | ~new_n49_ | ~x17 | x18);
