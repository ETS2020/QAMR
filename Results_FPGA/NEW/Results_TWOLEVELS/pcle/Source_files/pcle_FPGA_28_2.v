// Benchmark "FAU" written by ABC on Wed Jul 29 03:52:45 2020
...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & (x12 ? (~x11 | (x11 & ~x13)) : x14);
  assign z5 = x08 ? x04 : new_n39_;
  assign new_n39_ = x09 & ~x10 & ((x15 & (~x11 | ~x12 | ~x13)) | (x13 & ~x15 & x11 & x12));
  assign z6 = x08 ? x05 : (new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x16 & (~x11 | ~x12 | ~x13 | ~x15)) | (x11 & x12 & x13 & x15 & ~x16));
  assign z7 = x08 ? x06 : (x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x17 | (x11 & x12 & x13 & x15 & x16)) & (~x15 | ~x16 | x17 | ~x11 | ~x12 | ~x13);
