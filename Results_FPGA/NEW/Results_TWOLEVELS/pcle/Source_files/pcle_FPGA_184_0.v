...
module FAU ( 
  ...
  assign z1 = x08 ? x00 : (x09 & ~x10 & ~new_n33_ & ~x11);
  ...
  assign new_n40_ = (~x15 | (x11 & (new_n33_ | (x12 & x13 & x14)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15);
  assign z6 = x08 ? x05 : (x09 & ~new_n42_ & ~x10);
  assign new_n42_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = x08 ? x06 : (x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (new_n46_ | ~x17) & (~new_n45_ | ~x16 | x17 | ~x14 | ~x15);
  assign new_n45_ = x11 & x12 & x13;
  assign new_n46_ = (~x15 | (x12 & x13 & x14)) & x11 & x15 & x16;
  assign z8 = x08 ? x07 : (x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~x18 | (x11 & x15 & x16)) & (~x15 | ((~new_n50_ | ~x11) & (new_n49_ | ~x18)));
