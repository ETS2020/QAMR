// Benchmark "FAU" written by ABC on Wed Jul 29 03:53:21 2020
...
module FAU ( 
  ...
  assign z2 = x08 ? x01 : new_n34_;
  assign new_n34_ = x09 & ~x10 & (x12 ? ~x11 : (~x13 | (x11 & x13)));
  assign z3 = x08 ? x02 : new_n36_;
  assign new_n36_ = x09 & ~x10 & (~x11 | (x11 & ~x12 & x13) | (x12 & ~x13));
  assign z4 = x08 ? x03 : new_n38_;
  assign new_n38_ = x09 & ~x10 & ((x14 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x14));
  ...
  assign z8 = x08 ? x07 : (x09 & ~new_n47_ & ~x10);
