...
module FAU ( 
  ...
  assign z6 = (x05 & x08) | (x09 & ~new_n41_ & ~x10);
  assign new_n41_ = (~x16 | ((~x12 | (x14 & x15)) & (new_n42_ | x08))) & (~new_n42_ | ~x14 | ~x15 | x16);
  assign new_n42_ = x11 & x12 & x13;
  assign z7 = x08 ? x06 : (new_n44_ & x09);
  assign new_n44_ = ~x10 & ((x17 & (~new_n42_ | ~x14 | ~x15 | ~x16)) | (new_n42_ & x16 & ~x17 & x14 & x15));
  assign z8 = x08 ? x07 : (x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x18 | (new_n42_ & new_n49_)) & (~new_n47_ | ~new_n48_ | ~x17 | x18);
