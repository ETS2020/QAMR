...
module FAU ( 
  ...
  assign z8 = new_n50_ | (x09 & ~x10 & (new_n48_ | (~new_n46_ & x18)));
  assign new_n46_ = (new_n47_ | ~x12) & (x08 | (x11 & x12 & x13 & x15));
  assign new_n47_ = x14 & x16 & x17;
  assign new_n48_ = new_n49_ & x15 & x16 & x17 & ~x18;
