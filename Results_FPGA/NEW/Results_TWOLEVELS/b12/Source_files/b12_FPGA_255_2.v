// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:58 2020
...
module FAU ( 
  ...
  assign z4 = (~x00 & (~x12 | (~x07 & x12))) | (~x07 & (~x08 | ~x09)) | (x07 & ~x11);
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | x07 | x10 | ~x13;
  assign z6 = ~x07 & ~x10 & (new_n37_ | new_n38_);
  assign new_n37_ = (~x00 | ~x08) & ((~x01 & (x02 | (~x03 & x09))) | (~x02 & x03 & ~x09));
