// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:31 2020
...
module FAU ( 
  ...
  assign z2 = (~x00 & (new_n31_ | (~new_n30_ & x02))) | (~x08 & (new_n32_ | x02));
  assign new_n30_ = (~x01 | (x04 & ~x05)) & (~x04 | (x01 & x05)) & (x01 | (x10 & (~x03 | x04)));
  assign new_n31_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign new_n32_ = ~x01 & ~x07 & (x10 ? ~x03 : x09);
  assign z3 = (x00 & (~x07 | ~x11)) | (~x12 & (~x11 | (~x00 & ~x07)));
  assign z4 = x07 ? ~x11 : (~x00 | ~x08 | ~x09);
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | x07 | x10 | ~x13;
  assign z6 = ~x10 & ((~new_n37_ & ~x08) | (~new_n38_ & ~x00));
  assign new_n37_ = (~x00 | (~x02 & (~x03 | x07 | x09))) & (x07 | (x01 ? x02 : (x03 | ~x09)));
  assign new_n38_ = (x01 | (~x02 & (x03 | x07 | ~x09))) & (x02 | x07 | (~x01 & (~x03 | x09))) & (~x02 | x14);
  assign z7 = (~new_n40_ & ~x02) | x07 | x10 | (~x08 & (x02 | ~x03));
