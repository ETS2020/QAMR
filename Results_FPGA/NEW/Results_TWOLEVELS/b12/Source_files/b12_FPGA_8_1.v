...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n33_, new_n38_, new_n39_,
    new_n41_, new_n43_;
  assign z0 = ~x00 & ((x02 & ~x04 & (x01 | (~x01 & x03))) | (x01 & (x05 | (~x02 & x03))));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (x01 | ((~x02 | ~x03 | x04) & (~x04 | ~x05))) & (~x03 | ((~x01 | x05) & (~x02 | x06))) & (~x02 | ~x04 | (x05 & x06));
  assign z2 = (~new_n30_ & ~x00) | (new_n33_ & ~x07);
  assign new_n30_ = (~x01 | (~x05 & (~x02 | x04))) & (x01 | (new_n32_ & (new_n31_ | ~x02))) & (~x02 | ~x04 | x05);
  assign new_n31_ = (~x03 | x04) & (x07 | x10);
  assign new_n32_ = (x03 | (~x07 & ~x10)) & (~x04 | ~x05) & (x07 | ~x09 | x10);
