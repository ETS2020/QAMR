...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n37_, new_n38_;
  ...
  assign z4 = x07 ? ~x11 : (~x00 | (~x03 & ~x08) | (x00 & ~x09));
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | x07 | x10 | ~x13;
  assign z6 = ~x07 & ~x10 & (new_n37_ | new_n38_);
  assign new_n37_ = ~x08 & ((x00 & (x01 | x03)) | (~x01 & (x02 | x09)));
  assign new_n38_ = ~x00 & (x01 ? (~x02 | ~x14) : (x02 | x03 | x09));
  assign z7 = x07 | x10 | (~x08 & (x01 | (~x07 & (~x03 | (~x01 & x02 & ~x10)))));
