...
module FAU ( 
  ...
  assign z6 = ~x07 & ((~new_n37_ & ~x08) | (~new_n38_ & ~x00));
  assign new_n37_ = (~x00 | (~x02 & (~x03 | x09 | x10))) & (x10 | (x01 ? x02 : (x03 | ~x09)));
  assign new_n38_ = (x01 | (~x02 & (x03 | ~x09 | x10))) & (x02 | x10 | (~x01 & (~x03 | x09))) & (~x02 | x14);
