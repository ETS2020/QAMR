// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:44 2020
...
module FAU ( 
  ...
  assign new_n28_ = (x01 | ((~x02 | ~x03 | x04) & (~x04 | ~x06))) & (~x03 | (x06 ? x05 : ~x01)) & (~x04 | (x06 ? x05 : ~x02));
  assign z2 = (~x00 & (~new_n32_ | (~new_n30_ & x02))) | (new_n34_ & ~x07);
  assign new_n30_ = (~x01 | (x04 & ~x05)) & (x01 | (~new_n31_ & (~x03 | x04))) & (~x04 | x06);
  assign new_n31_ = ~x07 & ~x10;
  assign new_n32_ = (new_n33_ | x01) & (~x04 | x05 | ~x06);
  assign new_n33_ = (x03 | (~x07 & ~x10)) & (~x04 | ~x06) & (x07 | ~x09 | x10);
  ...
  assign new_n39_ = ~x08 & ((x00 & (x02 | (x03 & ~x09))) | (x01 & ~x02) | (~x01 & ~x03 & x09));
  assign new_n40_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14) | (~x02 & (x01 | (x03 & ~x09))));
  assign z7 = (~new_n42_ & ~x02) | x07 | x10 | (~x08 & (~x03 | (x02 & ~x07)));
