...
module FAU ( 
  ...
  assign z2 = (~x07 & ~x08) | (~x00 & (new_n31_ | (~new_n30_ & x02)));
  ...
  assign z6 = ~x07 & ~x10 & (x00 ? ~x08 : ~new_n36_);
  assign new_n36_ = (x01 | (~x02 & (x03 | ~x09))) & (~x02 | x14) & (x02 | (~x01 & (~x03 | x09)));
  assign z7 = x07 | x10 | new_n38_ | (~x07 & ~x08);
