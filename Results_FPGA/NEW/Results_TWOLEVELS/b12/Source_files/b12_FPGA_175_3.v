...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n37_, new_n38_, new_n40_,
    new_n42_;
  assign z0 = ~x00 & x01 & (x03 | (x02 & (~x04 | x05)));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (~x02 | ~x04 | (x01 & x05 & x06)) & (~x01 | ~x03);
  ...
  assign new_n37_ = (~x00 | ~x08) & ((x01 & ~x02) | (~x01 & ~x03 & x09) | (x03 & ~x09));
  assign new_n38_ = x02 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = new_n40_ | x07 | x10 | (~x01 & x03 & x09);
  assign new_n40_ = ~x08 & (~x03 | (~x07 & ~x10 & x01 & ~x02));
