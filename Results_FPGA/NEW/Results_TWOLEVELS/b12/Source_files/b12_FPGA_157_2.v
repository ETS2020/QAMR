...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n37_, new_n40_;
  ...
  assign new_n32_ = ~x01 & ~x07 & ~x08 & (x10 ? ~x03 : x09);
  ...
  assign new_n37_ = ~x10 & (~x00 | ~x08) & (x01 | (x03 & ~x09) | (~x03 & x09));
  assign z7 = (~x08 & (~x03 | (x01 & ~x07 & ~x10))) | x07 | x10 | (~x01 & x03 & x09);
