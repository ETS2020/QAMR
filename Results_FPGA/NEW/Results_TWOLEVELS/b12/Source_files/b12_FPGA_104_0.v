// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:29 2020
...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n37_, new_n38_, new_n40_,
    new_n42_;
  assign z0 = ~x00 & ((x03 & (x01 ? ~x02 : ~x04)) | (x01 & (~x04 | (x02 & x05))));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = ((x04 ? ~x02 : ~x03) | (x01 & x05 & x06)) & (~x01 | x02 | ~x03);
  assign z2 = new_n30_ | (new_n32_ & ~x07);
  ...
  assign new_n38_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (~x02 & (x01 | (x03 & ~x09))) | (x02 & ~x14));
