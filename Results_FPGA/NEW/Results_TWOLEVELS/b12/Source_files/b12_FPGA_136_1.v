...
module FAU ( 
  ...
  assign z3 = ~x11 & (x00 | (~x00 & ~x12));
  assign z4 = ~x11 & (~x00 | x07 | ~x08 | ~x09);
  assign z5 = (~x11 & (x00 | x07 | (~x00 & x12))) | x10 | x11 | ~x13;
  ...
  assign z7 = (~new_n41_ & ~x01) | ~new_n42_ | (~x08 & (x01 | ~x03));
  assign new_n41_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign new_n42_ = ~x10 & ~x11 & (~x07 | x11);
  assign z8 = (~new_n44_ & x09) | x11 | (x07 & ~x11) | x10 | (~x00 & ~x09);
