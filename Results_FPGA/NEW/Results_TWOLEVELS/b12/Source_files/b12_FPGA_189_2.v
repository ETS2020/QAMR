...
module FAU ( 
  ...
  assign z2 = (new_n32_ & ~x01) | (~x00 & ((~new_n30_ & x02) | (~new_n31_ & ~x01)));
  ...
  assign new_n37_ = (~x08 | (~x00 & ~x02)) & (x01 | (x03 & ~x09));
  assign new_n38_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14));
  assign new_n39_ = ~x03 & ~x08 & x09;
  assign z7 = (~x08 & (~x03 | (x01 & ~x07 & ~x10))) | x07 | new_n41_ | x10;
