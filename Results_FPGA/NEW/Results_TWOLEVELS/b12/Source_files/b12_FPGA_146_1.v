...
module FAU ( 
  ...
  assign z3 = (~x11 & (x00 | ~x12)) | (~x07 & (x00 ? (~x09 | (x02 & x09)) : ~x12));
  assign z4 = (~x07 & (~x00 | (x02 & ~x08) | (x00 & ~x09))) | (~x11 & (x07 | ~x08));
  assign z5 = (~new_n36_ & x00) | x07 | x10 | ~x13 | (~x00 & ~x07 & x12);
  assign new_n36_ = x11 & (x07 | (x09 & (~x02 | ~x09)));
  ...
  assign z8 = (~x00 & (~x09 | (new_n43_ & ~x01 & x02))) | ~new_n43_ | (~new_n44_ & x09);
  assign new_n43_ = ~x07 & ~x10;
  assign new_n44_ = ~x01 & x03 & ~x12 & (~x00 | ~x02 | x07);
endmodule
