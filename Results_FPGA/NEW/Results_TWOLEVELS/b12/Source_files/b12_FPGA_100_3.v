...
module FAU ( 
  ...
  assign z6 = ~x07 & ~x10 & (~new_n39_ | (~new_n37_ & ~new_n38_));
  assign new_n37_ = (x02 | x08) & (x00 | x14);
  assign new_n38_ = ~x01 & (~x03 | x09);
  assign new_n39_ = (x01 | ((x00 | (~x02 & (x03 | ~x09))) & (x03 | x08 | ~x09))) & (~x00 | ~x02 | x08);
  ...
  assign new_n43_ = ~x01 & ~x02 & ~x12 & (x03 | x07);
endmodule
