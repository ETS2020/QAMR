...
module FAU ( 
  ...
  assign new_n32_ = (x01 | ((~x09 | x10) & (x03 | x08 | ~x10))) & (~x02 | x08);
  ...
  assign new_n38_ = (x00 | ((x01 | (~x02 & (~x03 | x09))) & (~x01 | x02) & (~x02 | x14))) & (x01 | x03 | ~x09);
  assign z7 = (~x01 & ~x07 & ~new_n40_ & ~x10) | x07 | x10 | (~x08 & (x01 | ~x03));
  assign new_n40_ = ~x09 & (~x02 | x08);
  assign z8 = (~new_n42_ & x09) | x07 | x10 | (~x00 & ~x09);
  assign new_n42_ = ~x01 & ~x02 & ~x12 & (x07 | x10 | x01 | x03);
endmodule
