...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n36_, new_n37_, new_n38_, new_n40_,
    new_n42_;
  assign z0 = (x03 & ((~x00 & x01 & ~x02) | (~x01 & x02 & ~x04))) | (x01 & x02 & (~x04 | x05));
  assign z1 = (x02 & ((~x01 & (x04 | (x03 & ~x04))) | (~new_n28_ & (x03 | x04)))) | (~x00 & x01 & ~x02 & x03);
  assign new_n28_ = x05 & x06;
  assign z2 = (~new_n30_ & x02) | (~new_n31_ & ~x01);
  ...
  assign new_n36_ = (~x00 | ~x08) & (x01 ? ~x02 : (~x03 & x09));
  assign new_n37_ = x02 & (~x01 | ~x14);
  assign new_n38_ = x03 & ~x09 & (x00 ? ~x08 : ~x02);
  assign z7 = (~new_n40_ & ~x02) | x07 | x10 | (~x08 & (x02 | ~x03));
  assign new_n40_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign z8 = ~new_n42_ | (x09 & (x01 | ~x03 | x12));
  assign new_n42_ = ~x07 & (x00 | x09) & ~x10 & (x01 | ~x02 | x07 | x10);
endmodule
