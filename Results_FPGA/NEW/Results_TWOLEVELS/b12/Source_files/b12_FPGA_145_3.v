...
module FAU ( 
  ...
  assign new_n38_ = ~x01 & (x02 | (~x03 & x09)) & (~x00 | ~x08);
  assign new_n39_ = ~x00 & x01 & ~x14;
  assign z7 = (~new_n41_ & ~x01) | x07 | x10 | (~x08 & (x01 | ~x03));
  assign new_n41_ = (x02 | ~x03 | ~x09) & (x08 | x10 | ~x02 | x07);
