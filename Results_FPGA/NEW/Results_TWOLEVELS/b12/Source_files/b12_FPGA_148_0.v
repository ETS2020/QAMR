...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n37_, new_n38_, new_n40_,
    new_n42_;
  assign z0 = ~x00 & ((x02 & (x01 ? x05 : (x03 & ~x04))) | (x01 & ((~x02 & x03) | (~x04 & ~x05))));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (~x02 | ((x01 | (~x04 & (~x03 | x04))) & (x06 | (~x03 & ~x04)))) & (~x04 | x05) & (~x03 | (x05 & (~x01 | x02)));
  assign z2 = new_n30_ | (new_n32_ & ~x07);
  assign new_n30_ = ~x00 & ((x01 & (x05 ? x02 : ~x04)) | (x04 & ~x05) | (~new_n31_ & ~x01));
