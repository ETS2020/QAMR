...
module FAU ( 
  ...
  assign z03 = x04 & ((~x03 & ((~x06 & x07) | (x02 & x06 & ~x07))) | (~x16 & (x06 ^ x07)));
  assign z04 = ~new_n41_ & x04;
  assign new_n41_ = (~x07 | ((x03 | (~x06 ^ x08)) & (~x06 | x08 | x16))) & (~x08 | ((x07 | ((~x02 | x03) & x16)) & (x06 | x16)));
  ...
  assign new_n54_ = ~x10 & ~x11 & ~x12 & ~x13 & (~x03 | ~x16);
  assign new_n55_ = ~x02 & x16;
  assign new_n56_ = x13 & (~new_n48_ | x11 | x12 | x09 | x10);
  assign z10 = x04 & (new_n60_ | (new_n58_ & x06));
  assign new_n58_ = x07 & x08 & ~x09 & ~new_n59_ & (~x03 | ~x16);
  assign new_n59_ = ~x00 & (x12 | x13 | x10 | x11);
  assign new_n60_ = x14 & (~x02 | x03) & x16;
