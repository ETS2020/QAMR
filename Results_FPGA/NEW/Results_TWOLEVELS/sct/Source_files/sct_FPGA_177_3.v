...
module FAU ( 
  ...
  assign z08 = (x04 & (new_n50_ | new_n54_)) | (~new_n48_ & x12) | ~new_n52_ | ~x04;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & new_n51_ & ~x10;
  assign new_n51_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n52_ = (~new_n53_ | ~x06 | ~x07 | ~x08) & (~x03 | ~x16);
  assign new_n53_ = ~x12 & x13 & ~x09 & ~x11;
  assign new_n54_ = ~x02 & x16;
  assign z09 = (x04 & (new_n50_ | (~x02 & x16))) | new_n56_ | ~x04 | (x03 & x16);
  assign new_n56_ = ~new_n57_ & x13;
  assign new_n57_ = x06 & x07 & x08 & ~x09 & ~x11 & ~x12;
