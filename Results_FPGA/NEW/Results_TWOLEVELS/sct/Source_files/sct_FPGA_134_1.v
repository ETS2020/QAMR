// Benchmark "FAU" written by ABC on Wed Jul 29 03:50:27 2020
...
module FAU ( 
  ...
  assign z07 = (new_n47_ & x06) | new_n43_ | new_n48_ | ~x04;
  assign new_n47_ = x08 & ~x09 & ~x10 & ~x11 & (x12 | (x07 & ~x12));
  assign new_n48_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n43_ | new_n52_ | new_n50_ | ~x04;
  ...
  assign new_n56_ = x13 & (~new_n51_ | x11 | x12 | x09 | x10);
  assign z10 = x04 & ((x06 & new_n58_ & x07) | (new_n39_ & x14));
