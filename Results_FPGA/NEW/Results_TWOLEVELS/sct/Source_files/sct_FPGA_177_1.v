...
module FAU ( 
  ...
  assign z07 = (x16 & (x03 | (~x02 & x04))) | new_n47_ | new_n48_ | ~x04;
  assign new_n47_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~new_n50_ & x04) | (~new_n48_ & x12) | ~x04 | (x03 & x16);
  assign new_n50_ = ~new_n52_ & (~x06 | ~x07 | ~x08 | ~new_n51_ | x09);
  assign new_n51_ = ~x10 & ~x11 & ~x12 & ((x02 & ~x03) | ~x16);
  assign new_n52_ = ~x02 & x16;
  assign z09 = (~new_n50_ & x04) | ~x04 | x13 | (x03 & x16);
  assign z10 = x04 & (new_n56_ | (x06 & x07 & new_n55_ & x08));
  assign new_n55_ = ~x09 & ~new_n39_ & (x00 | (~x10 & ~x11 & ~x12));
