// Benchmark "FAU" written by ABC on Wed Jul 29 03:50:06 2020
...
module FAU ( 
  ...
  assign z03 = x04 & (x06 ? ~x07 : ((x02 & ~x03 & x16) | (x07 & ~x16)));
  assign z04 = ~new_n41_ & x04;
  assign new_n41_ = (~x02 | x03 | (x06 ? (x08 | ~x16) : ~x08)) & (~x08 | (x07 & (x06 | x16))) & (~x06 | ~x07 | x08 | x16);
  ...
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & new_n54_ & ~x11;
  assign new_n54_ = ~x12 & ~x13 & ((x02 & ~x03 & x16) | (x07 & ~x16));
  assign new_n55_ = x13 & (~new_n48_ | x11 | x12 | x09 | x10);
  assign z10 = x04 & (new_n59_ | (x06 & x08 & new_n57_ & ~x09));
  assign new_n57_ = ~new_n58_ & ((x07 & ~x16) | (x02 & ~x03 & x16));
