// Benchmark "FAU" written by ABC on Wed Jul 29 03:50:15 2020
...
module FAU ( 
  ...
  wire new_n39_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n51_,
    new_n53_, new_n54_, new_n55_, new_n57_, new_n58_, new_n61_;
  ...
  assign z10 = x04 & ((x06 & new_n57_ & x07) | (new_n39_ & x14));
  ...
  assign new_n61_ = (((~x02 | x03) & x16) | (x06 & (~x06 | x07))) & ~x03 & ~x17 & (x02 | ~x16);
  assign z14 = x04 & x17;
  assign z11 = x02;
endmodule
