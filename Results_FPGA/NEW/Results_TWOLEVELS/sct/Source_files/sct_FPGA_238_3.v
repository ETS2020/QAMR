...
module FAU ( 
  ...
  assign z05 = new_n43_ | new_n44_ | ~x04 | (~new_n45_ & x09);
  assign new_n43_ = x06 & x07 & x08 & (x10 | (~x09 & ~x10));
  assign new_n44_ = x16 & (x03 | (~x02 & x04));
  assign new_n45_ = x06 & x07 & x08;
  assign z06 = new_n44_ | new_n47_ | ~x04 | (~new_n45_ & x10);
  assign new_n47_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = ~new_n49_ | new_n44_;
  assign new_n49_ = (new_n47_ | ~x11) & x04 & (~new_n45_ | x09 | x10 | x11);
  assign z08 = ~new_n51_ | new_n44_;
  assign new_n51_ = (~x12 | (new_n45_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n45_ | x11 | x12 | x09 | x10);
