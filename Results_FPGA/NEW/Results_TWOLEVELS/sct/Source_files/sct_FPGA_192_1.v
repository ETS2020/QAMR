...
module FAU ( 
  ...
  assign z06 = (x16 & (x03 | (~x02 & x04))) | new_n45_ | new_n46_ | ~x04;
  assign new_n45_ = x10 & (~x06 | ~x08 | x09);
  assign new_n46_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = ~new_n48_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n48_ = (new_n46_ | ~x11) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x07 & x08;
  assign z08 = ~new_n51_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n51_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n49_ | x11 | x12 | x09 | x10);
  ...
  assign new_n55_ = x13 & (~new_n49_ | x11 | x12 | x09 | x10);
