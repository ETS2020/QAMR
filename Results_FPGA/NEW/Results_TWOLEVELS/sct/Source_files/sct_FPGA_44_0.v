...
module FAU ( 
  ...
  assign z05 = (~new_n43_ & x04) | ~x04 | (~x08 & x09) | new_n45_ | (x06 & x08 & ~x09);
  assign new_n43_ = ~new_n44_ & (new_n39_ | (x06 ? x07 : ~x09));
  assign new_n44_ = ~x02 & x16;
  assign new_n45_ = x03 & x16;
  assign z06 = ~new_n47_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & x04 & (x09 | x10 | ~x06 | ~x08);
  assign z07 = ~new_n49_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n49_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & x04 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (x16 & (x03 | (~x02 & x04))) | new_n51_ | new_n52_ | ~x04;
  assign new_n51_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n52_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = (~new_n54_ & x04) | (~new_n52_ & x13) | new_n45_ | ~x04;
  assign new_n54_ = ~new_n44_ & (~x06 | ~x08 | x09 | ~new_n55_ | x10);
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign z10 = x04 & ((x06 & new_n57_ & x08) | (new_n39_ & x14));
