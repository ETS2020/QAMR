// Benchmark "FAU" written by ABC on Wed Jul 29 03:50:11 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n41_, new_n42_, new_n44_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n52_, new_n54_, new_n55_, new_n56_, new_n58_, new_n59_;
  assign z00 = x01 ? ~x02 : ~x14;
  assign z01 = x05 ? ~x04 : (x15 | ~x18);
  assign z02 = x04 & ~x06 & (~x16 | (~x03 & (~x07 | (x02 & x07))));
  assign z03 = x04 & ((~x03 & ((x02 & ~x06 & x07) | (x06 & ~x07))) | (~x16 & (x06 ^ x07)));
  assign z04 = x04 & ((~new_n41_ & (x06 ? (x07 & ~x08) : x08)) | (~x07 & ~new_n42_ & x08));
  ...
  assign z10 = x04 & ((x06 & new_n58_ & x07) | (new_n41_ & x14));
  assign new_n58_ = x08 & ~x09 & ~new_n41_ & ~new_n59_;
