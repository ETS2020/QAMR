...
module FAU ( 
  ...
  assign new_n41_ = (~x02 | x03 | ((~x08 | (x06 & x07)) & (~x06 | ~x07 | x08))) & (~x08 | x16);
  ...
  assign new_n53_ = (~new_n54_ | ~new_n48_ | ~x02 | x03) & (x02 | ~x16);
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ~x09 & ~x10;
  assign new_n55_ = x13 & (~new_n48_ | x11 | x12 | x09 | x10);
  assign z10 = x04 & ((x02 & new_n57_ & ~x03) | (x14 & x16 & (~x02 | x03)));
