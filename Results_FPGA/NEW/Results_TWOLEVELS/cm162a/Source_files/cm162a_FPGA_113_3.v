...
module FAU ( 
  ...
  assign z3 = (~new_n29_ & x04) | new_n31_ | ~x05 | (x03 & ~x04 & x12);
  assign new_n29_ = (~x02 | (~new_n30_ & (x11 | x12 | x08 | x10))) & ((~x10 & ~x11) | ~x12);
  assign new_n30_ = x03 & x09 & x13;
  assign new_n31_ = ~x07 & (~x03 | (x12 & (~x02 | x08)));
