...
module FAU ( 
  ...
  assign z3 = ~new_n30_ | (x02 & ~new_n29_ & x04);
  assign new_n29_ = (~new_n23_ | ~x03) & (x11 | x12 | x08 | x10);
  assign new_n30_ = (x07 | (x03 & (new_n31_ | ~x12))) & x05 & (~x03 | x04 | ~x12);
  assign new_n31_ = ~x10 & ~x11 & x02 & ~x08;
