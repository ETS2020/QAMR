// Benchmark "FAU" written by ABC on Wed Jul 29 03:08:07 2020
...
module FAU ( 
  ...
  assign new_n27_ = (~x02 | ((~x04 | (~new_n23_ & (~new_n28_ | x11 | x12))) & (~new_n28_ | x11 | ~x12))) & (~x11 | (new_n28_ & x02 & x04));
  assign new_n28_ = ~x08 & ~x10;
  assign z3 = (x03 & (new_n31_ | (new_n30_ & x02))) | ~x05 | (~x03 & ~x07);
  assign new_n30_ = x04 & (new_n23_ | (new_n28_ & ~x11 & ~x12));
  assign new_n31_ = x12 & (~x02 | x08 | x10 | x11);
