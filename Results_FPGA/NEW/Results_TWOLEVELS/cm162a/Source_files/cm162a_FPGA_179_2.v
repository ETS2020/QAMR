// Benchmark "FAU" written by ABC on Wed Jul 29 03:08:24 2020
...
module FAU ( 
  ...
  assign new_n22_ = (~x02 | ~x04 | (x08 & ~x13)) & (~x08 | (x02 & x04));
  assign z1 = (~new_n24_ & x03) | ~x05 | (~x01 & ~x03);
  assign new_n24_ = (~x02 | ~x04 | (~x13 & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = (~new_n26_ & x03) | ~x05 | (~x03 & ~x06);
  assign new_n26_ = (~x02 | ~x04 | (~x13 & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~x10));
  assign z3 = (x03 & (new_n29_ | (new_n28_ & x02))) | ~x05 | (~x03 & ~x07);
  assign new_n28_ = x04 & (x13 | (~x08 & ~x10 & ~x11 & ~x12));
