// Benchmark "FAU" written by ABC on Wed Jul 29 13:08:42 2020
...
module FAU ( 
  ...
  assign new_n341_ = ~new_n346_ & (x05 | ~x15 | ~x21 | ~new_n342_ | ~x22);
  assign new_n342_ = ~new_n92_ & (new_n343_ | new_n345_);
  assign new_n343_ = x24 & ~x34 & x35 & ~new_n344_ & (x20 | x25);
  assign new_n344_ = (~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? (~x39 | (~x23 & ~x40)) : (x39 | x40)));
  assign new_n345_ = x34 & ~x35 & x37 & new_n87_ & ~x38;
  ...
  assign new_n353_ = new_n339_ & new_n127_ & ~x35 & x38;
  ...
  assign new_n365_ = (new_n366_ | x35) & (~new_n370_ | ~new_n297_ | ~x35 | ~x37);
  ...
  assign z20 = ~x07 & ~x32 & x33 & (new_n455_ | (~new_n438_ & ~x36));
  assign new_n438_ = (x35 | (~new_n439_ & (new_n445_ | x34))) & (x34 | (~new_n454_ & (new_n451_ | ~x35)));
  assign new_n439_ = ~x38 & ((~new_n440_ & ~x37) | new_n444_ | (new_n442_ & ~x05));
  assign new_n440_ = (~new_n441_ | x05) & (x00 | new_n87_ | ~x05);
  assign new_n441_ = ~x34 & (x31 | (~x31 & ~new_n86_ & x39));
  assign new_n442_ = ~x31 & ~x34 & (new_n158_ | (new_n443_ & x37));
  assign new_n443_ = ~x39 & ((x15 & ~new_n145_ & ~new_n154_) | new_n92_ | ~x15);
  assign new_n444_ = x39 & (x05 ? (~x34 | (x37 & x40)) : (x34 & x37 & ~new_n86_ & x40));
  assign new_n445_ = (new_n450_ | ~x37) & (new_n448_ | ~x05) & (x05 | (x31 ? new_n448_ : (new_n446_ | x37)));
  assign new_n446_ = (~x39 | (~new_n305_ & (~x40 | (~new_n447_ & new_n86_)))) & (~x38 | x39 | new_n86_ | x40);
  assign new_n447_ = x15 & x38 & ~new_n145_ & ~new_n154_;
  assign new_n448_ = ~new_n149_ & new_n449_ & ~new_n205_ & new_n102_;
  assign new_n449_ = x14 & x15 & (~x39 | x40) & (~x38 | x39);
  assign new_n450_ = x05 ? ~x38 : (~x31 | ~x39);
  assign new_n451_ = (new_n452_ | (~x05 & (x05 | new_n86_ | ~x13))) & (x05 | new_n86_ | new_n453_);
  assign new_n452_ = ~new_n121_ & (~new_n127_ | x38);
  ...
  assign new_n456_ = new_n457_ & x35 & x37 & x38;
  assign new_n457_ = ~x00 & x05;
  assign new_n458_ = ~x00 & x05 & x38 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n459_ = ~x37 & ~x38 & x39 & x11 & ~x35;
  ...
  assign new_n466_ = new_n125_ & x38 & ~x00 & ~x05 & x37;
  assign new_n467_ = (~x34 | new_n468_ | x36) & (~new_n297_ | ~x32 | ~x36 | x37);
  assign new_n468_ = new_n469_ & (x00 | x05 | x37 | new_n87_ | x38);
  assign new_n469_ = ~x32 & (~new_n87_ | ~x38 | x06 | ~x37);
  assign z22 = ~x07 & x33 & (new_n477_ | (~new_n471_ & ~x34));
  assign new_n471_ = (new_n472_ | x36) & (x00 | ~x05 | x32 | ~new_n476_ | ~x36);
  assign new_n472_ = (~x05 | new_n475_ | x32) & (x35 | (new_n425_ & (~x05 | new_n473_ | x32)));
  assign new_n473_ = ~new_n149_ & (~x38 | (~x37 & x39)) & new_n474_ & (~x39 | (x38 & x40));
  assign new_n474_ = new_n102_ & x14 & ~new_n205_ & x15;
  ...
  assign z23 = x33 & (x07 | (~x07 & ~x32 & (new_n526_ | (~new_n480_ & ~x34))));
  assign new_n480_ = (new_n481_ | x38) & (new_n501_ | ~x38) & (x35 | new_n521_ | x36);
  ...
  assign new_n484_ = ~new_n92_ & (new_n485_ | (x35 & ~new_n486_ & x40));
  ...
  assign new_n491_ = ~new_n86_ & ((x37 & (x13 ? (~x31 & ~x35) : (x35 ? x40 : ~x31))) | (x35 & (x13 ? (~x37 | x40) : ~x37)));
  ...
  assign new_n496_ = (~x40 | (~new_n497_ & new_n86_)) & (~x39 | (x37 ? (new_n498_ | x40) : new_n86_));
  assign new_n497_ = ~x09 & x15 & ~new_n92_ & ~x16;
  ...
  assign new_n502_ = (~x05 | (~x37 & x39)) & ~new_n509_ & (x05 | (x31 ? x39 : new_n503_));
  assign new_n503_ = new_n507_ & (x37 | (~new_n506_ & (~x15 | (~new_n504_ & ~new_n505_))));
  assign new_n504_ = ~new_n203_ & x39;
  assign new_n505_ = ~x16 & ~new_n92_ & ((~x17 & x39 & x40) | (~x09 & ~x40));
  assign new_n506_ = ~x40 & ((~x39 & (new_n92_ | ~x15)) | (x09 & ~x13 & ~x15 & x39));
  assign new_n507_ = (x39 | new_n498_ | ~x40) & (x09 | ~x39 | (~new_n508_ & ~x37 & x40));
  ...
  assign new_n517_ = ((~new_n518_ & x40) | (x37 ^ ~x39)) & (~x39 | (~x37 & (~new_n457_ | x37 | ~x40))) & (x37 | x39 | (~x40 & (new_n519_ | x40)));
  ...
  assign new_n521_ = x05 ? (new_n525_ & ~new_n149_) : (~new_n522_ & (~x31 | (new_n524_ & ~new_n149_)));
  assign new_n522_ = x39 & (x31 ? (x37 | ~x40) : (~new_n523_ & ~x37));
  assign new_n523_ = ~new_n497_ & ~new_n158_ & (~x09 | ~x13 | x15);
  assign new_n524_ = ~new_n205_ & x11 & x12 & x14 & x15;
  assign new_n525_ = x14 & ~new_n125_ & x15 & ~new_n205_ & new_n102_;
  ...
  assign new_n529_ = x34 & (x37 ? (~x39 | (x39 & ~x40)) : (new_n189_ | ~x39 | (~new_n123_ & x39)));
  assign new_n530_ = x15 & ~x31 & new_n87_ & ~x37;
  assign new_n531_ = ~new_n87_ & (new_n457_ | (new_n532_ & new_n533_));
  ...
  assign z24 = ~x07 & ~x32 & x33 & (x36 ? ~new_n547_ : ~new_n537_);
  assign new_n537_ = new_n538_ & (x38 | (~new_n544_ & (x35 | (~new_n375_ & ~new_n376_))));
  assign new_n538_ = ~new_n393_ & (x34 | (~new_n543_ & (new_n539_ | x05)));
  assign new_n539_ = (x31 | ~new_n114_ | x35) & (~x15 | new_n540_ | new_n92_);
  assign new_n540_ = ~new_n388_ & (~x38 | (~new_n387_ & (x37 | (~new_n384_ & ~new_n541_))));
  assign new_n541_ = x39 & (new_n106_ | new_n542_);
  assign new_n542_ = x35 & (~x24 | (x24 & (~x22 | (x22 & ~x40 & (~x21 | (x21 & ~x23))))));
  assign new_n543_ = new_n111_ & x35 & x37;
  ...
  assign new_n547_ = (new_n389_ | x34) & (~new_n297_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n552_ : ~new_n549_);
  assign new_n549_ = (x05 | new_n539_ | x34) & (x38 | (~new_n550_ & ~new_n544_));
  assign new_n550_ = ~x35 & (new_n375_ | (x34 & (new_n218_ | (new_n551_ & x00))));
  assign new_n551_ = ~x01 & x02 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n552_ = (~new_n297_ | ~x34 | x35 | x37) & (x34 | (~new_n554_ & (~x35 | new_n553_ | ~x37)));
  assign new_n553_ = (~new_n125_ | x38) & (~new_n532_ | x03 | ~x04 | ~x38);
  assign new_n554_ = new_n112_ & new_n153_ & x10 & x27 & ~x35;
  assign z26 = ~x07 & ~x32 & x33 & (new_n559_ | (~new_n556_ & ~x35));
  assign new_n556_ = (new_n557_ | new_n123_) & (~new_n297_ | ~x34 | ~x36 | x37);
  ...
  assign new_n564_ = (x38 | new_n546_ | x39) & (x37 | ~x38 | new_n214_ | ~x39);
  assign new_n565_ = ~x09 & ~x17 & (new_n298_ | new_n122_);
  ...
  assign new_n573_ = (x34 | ~x35 | ~x36 | ~x37 | ~x38) & (~x34 | x35 | x36 | x37 | new_n87_ | x38);
  assign new_n574_ = new_n138_ & ~x34 & ~x35 & new_n111_ & x36 & ~x37;
  assign z29 = ~x07 & ~x32 & x33 & (new_n570_ | (new_n576_ & ~x05));
  assign new_n576_ = ~x36 & ((~new_n577_ & ~x34) | (x15 & new_n324_ & ~x21));
  ...
  assign new_n587_ = (x37 | ~x38 | ~x39 | x40) & (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n174_ | ~x40)));
  assign z31 = ~x07 & ~x32 & x33 & (new_n597_ | (~new_n589_ & ~x34));
  assign new_n589_ = (new_n590_ | ~x35) & (~new_n112_ | ~new_n153_ | ~new_n138_ | x35 | ~x36);
  ...
  assign new_n593_ = ~x21 & x22 & ~x23 & x24 & ~new_n174_ & x37;
  assign new_n594_ = x39 & (~x24 | (x21 & x22 & ~x23 & x24 & ~x40));
  assign new_n595_ = new_n596_ & x00 & ~x01 & x02 & ~x03;
  ...
  assign z33 = x33 ? (x07 | (~x07 & ~new_n602_ & ~x32)) : x32;
  assign new_n602_ = x34 ? (x35 | new_n623_ | x36) : (x35 ? new_n603_ : new_n613_);
  assign new_n603_ = x37 ? ((new_n611_ | ~x36) & (x05 | ~new_n604_ | x36)) : new_n607_;
  assign new_n604_ = ~x38 & ~x39 & ~new_n605_ & x40;
  assign new_n605_ = (~x15 | ~x22 | ~x24 | new_n606_ | new_n92_) & (x13 | (~new_n92_ & x15));
  assign new_n606_ = ~x21 & (x21 | new_n174_ | ~x23);
  ...
  assign new_n613_ = (new_n622_ | ~x36) & (x05 | x31 | new_n614_ | x36);
  assign new_n614_ = ~new_n320_ & ~new_n615_ & new_n621_ & (x37 | (~new_n618_ & ~new_n619_));
  assign new_n615_ = x15 & ((~new_n616_ & x09) | (x16 & new_n152_ & x17));
  assign new_n616_ = x37 ? (x38 | x39 | new_n205_ | new_n154_) : (~x38 | new_n617_ | ~x39);
  assign new_n617_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n618_ = x38 & ~x39 & ~new_n86_ & ~x40;
  assign new_n619_ = x39 & (new_n620_ | (~x11 & ~x12 & (~x38 | x40)));
  assign new_n620_ = ~x15 & (~x38 | x40 | (x09 & (x13 | (~x13 & x38 & ~x40))));
  assign new_n621_ = (x38 | new_n86_ | (~x40 & (~x37 | x39))) & (~x38 | ~x39 | ~x09 | ~x37);
  assign new_n622_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n138_ | x40))) & (~x39 | (x38 ? x40 : (new_n288_ | ~x40)))));
  assign new_n623_ = x38 ? ((~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39)) & (x37 | x39 | x40)) : new_n624_;
  assign new_n624_ = ~new_n625_ & (x01 | x02 | new_n432_ | x03);
  assign new_n625_ = x39 & x40 & (~x37 | (~x05 & ~new_n312_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~x32 & (new_n649_ | (~new_n627_ & ~x34))));
  assign new_n627_ = ~new_n639_ & ~new_n628_ & (x36 | (~new_n648_ & (new_n645_ | x35)));
  assign new_n628_ = x39 & (~new_n634_ | (x38 & (new_n638_ | (~new_n629_ & ~x37))));
  assign new_n629_ = (x35 | (x36 ? new_n406_ : new_n630_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n630_ = ~new_n633_ & (~x15 | (~new_n632_ & (x05 | new_n631_ | x31)));
  assign new_n631_ = (~x16 | ~x17 | new_n154_ | ~x40) & (~x09 | (x40 ? (new_n154_ | (~x16 & ~x17)) : new_n102_));
  assign new_n632_ = x11 & x12 & x14 & ~new_n145_ & x40;
  ...
  assign new_n636_ = (~x09 | ~x13 | x15) & ((x38 & ~x40) | (~new_n92_ & x15));
  ...
  assign new_n642_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n443_ & ~x38));
  assign new_n643_ = ~x39 & (x35 ? (new_n644_ | (x06 & x40)) : ~x40);
  assign new_n644_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n645_ = x05 ? (new_n646_ & ~new_n149_) : ~new_n647_;
  assign new_n646_ = ~new_n205_ & new_n102_ & x14 & x15 & (~x38 | x39);
  assign new_n647_ = ~x31 & ~new_n86_ & ((~x38 & x40) | (~x37 & x38 & ~x39 & ~x40));
  assign new_n648_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x35 & ~x37 & x38 & ~x40));
  assign new_n649_ = ~x35 & ~x36 & (new_n651_ | (~new_n650_ & ~x38));
  assign new_n650_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n407_ | ~new_n533_) & (x00 | ~x05)));
