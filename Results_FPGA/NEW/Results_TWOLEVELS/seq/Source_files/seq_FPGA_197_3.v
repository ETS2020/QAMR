...
module FAU ( 
  ...
  assign z12 = ~x40 & ~x38 & ~x37 & ~x35 & new_n354_ & x34;
  assign new_n354_ = x33 & ~x32 & x08 & new_n355_ & ~x07;
  ...
  assign new_n454_ = ~x34 & x36 & (new_n455_ | (x40 & (new_n456_ | new_n457_)));
  assign new_n455_ = new_n355_ & x35 & x37 & x38;
  ...
  assign new_n515_ = ((~new_n516_ & x40) | (x37 ^ ~x39)) & (~x39 | (~x37 & (~new_n355_ | x37 | ~x40))) & (x37 | x39 | (~x40 & (new_n517_ | x40)));
  ...
  assign new_n529_ = ~new_n87_ & (new_n355_ | (new_n530_ & new_n531_));
  ...
  assign new_n535_ = new_n536_ & (x38 | (~new_n542_ & (x35 | (~new_n374_ & ~new_n375_))));
  ...
  assign new_n545_ = (new_n388_ | x34) & (~new_n297_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n550_ : ~new_n547_);
  assign new_n547_ = (x05 | new_n537_ | x34) & (x38 | (~new_n548_ & ~new_n542_));
  assign new_n548_ = ~x35 & (new_n374_ | (x34 & (new_n218_ | (new_n549_ & x00))));
  ...
  assign new_n571_ = (~x34 | x35 | x36 | x37 | new_n87_ | x38) & (x34 | ~x35 | ~x36 | ~x37 | ~x38);
  ...
  assign new_n627_ = (x35 | (x36 ? new_n405_ : new_n628_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n640_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n442_ & ~x38));
  ...
  assign new_n648_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((~new_n406_ | ~new_n531_) & (x00 | ~x05)));
