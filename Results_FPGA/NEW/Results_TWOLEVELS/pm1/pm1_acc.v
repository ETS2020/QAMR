// Benchmark "FAU" written by ABC on Tue Jul 28 13:40:15 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n38_, new_n41_, new_n43_;
  ...
  assign z08 = ~new_n38_ | x10 | ~x11;
  assign new_n38_ = x00 & (~x02 | ~x03 | ~x04 | ~x09 | ~x12);
