...
module FAU ( 
  ...
  assign z08 = (~x10 & ((new_n39_ & x09 & x11 & x12) | (x00 & ~x11 & ~x12))) | (~x11 & x12) | ~x00 | x10;
  assign new_n39_ = x02 & x03 & x04;
  assign z09 = ~x10 & ((x00 & ~x11 & ~x12) | (x11 & ~new_n41_ & x12));
  assign new_n41_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x09 & ~x10 & x11 & ~new_n39_ & x12;
  assign z11 = ~x10 & x11 & ((new_n44_ & x01) | (x00 & ~x01 & ~x12));
  assign new_n44_ = x09 & x12 & (~x02 | ~x03 | ~x04);
  assign z12 = x12 & x11 & ~x09 & ~x10;
  assign z04 = ~x14;
  assign z05 = ~x13;
  assign z07 = ~x15;
endmodule
