...
module FAU ( 
  ...
  wire new_n32_, new_n37_, new_n39_, new_n41_, new_n42_, new_n44_, new_n46_;
  ...
  assign z09 = x00 & (new_n42_ | (~new_n41_ & ~x10));
  assign new_n41_ = x11 ? (~x12 | (x09 & (~x09 | (x02 & x04 & (~x02 | ~x03 | ~x04))))) : x12;
  assign new_n42_ = x11 & x12 & ~x03 & x09;
  assign z10 = x00 & new_n44_ & x09;
  assign new_n44_ = x11 & x12 & (~x03 | (~x10 & (~x02 | ~x04)));
  assign z11 = x00 & x11 & (x01 ? new_n46_ : (~x10 & ~x12));
  assign new_n46_ = x09 & x12 & (~x03 | (~x10 & (~x02 | ~x04)));
