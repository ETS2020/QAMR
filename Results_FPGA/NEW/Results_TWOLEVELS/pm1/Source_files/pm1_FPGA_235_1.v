...
module FAU ( 
  ...
  wire new_n32_, new_n37_, new_n40_, new_n43_;
  ...
  assign z09 = new_n40_ & x00;
  assign new_n40_ = ~x10 & (x11 ? (x12 & (~x09 | (x09 & (~x02 | ~x03 | (x02 & x03))))) : ~x12);
  assign z10 = x00 & x09 & ~x10 & x11 & ~new_n37_ & x12;
  assign z11 = x00 & new_n43_ & ~x10;
  assign new_n43_ = x11 & (x01 ? (x09 & x12 & (~x02 | ~x03)) : ~x12);
