...
module FAU ( 
  ...
  assign z00 = (x11 & (~x05 | ~x06 | ~x07 | (x05 & x06 & x07))) | x01 | (~x11 & x12);
  assign z01 = ~x12 | (x11 & (~x05 | ~x06 | ~x07 | (x05 & x06 & x07)));
  assign z02 = (x11 & (~x05 | ~x06 | ~x07)) | ~x09 | ~x12 | (~x11 & x12);
  assign z03 = ~x09 | ~x12 | (~x11 & x12) | (x05 & x06 & x07 & x11);
