...
module FAU ( 
  ...
  assign z01 = x46 ? new_n161_ : ((~new_n142_ & x53) | new_n166_ | (~new_n153_ & ~x53));
  ...
  assign new_n166_ = x47 & (new_n167_ | (~new_n168_ & x51));
  assign new_n167_ = x38 & ~x48 & x49 & new_n160_ & ~x50;
  ...
  assign new_n368_ = (~new_n164_ | x50) & (~x53 | (~x48 & (x48 | (x50 & (~new_n118_ | x28 | ~x50)))));
  ...
  assign z07 = (~new_n378_ & ~x46) | (~x47 & (~new_n423_ | (~new_n415_ & x46)));
  assign new_n378_ = (x53 | (new_n389_ & (new_n379_ | ~x47))) & (new_n411_ | ~x47) & (new_n399_ | ~x53);
  ...
  assign new_n389_ = ~new_n397_ & (new_n394_ | x50) & (~x50 | (new_n390_ & ~new_n398_));
  assign new_n390_ = new_n393_ & (x47 | (~new_n392_ & (~x51 | (~new_n250_ & ~new_n391_))));
  assign new_n391_ = ~x48 & ~x49 & (x52 | (~x25 & ~x52));
  assign new_n392_ = x49 & x52 & x29 & x48;
  assign new_n393_ = (~x18 | ~x49 | x52) & (~x51 | ~x52 | ~x03 | x49);
  assign new_n394_ = (x47 | (x49 ? new_n395_ : new_n396_)) & (~new_n160_ | ~x48 | x49);
  ...
  assign new_n397_ = ~x14 & ~x48 & new_n160_ & x49;
  assign new_n398_ = ~x51 & ((x08 & ((x48 & ~x52) | (~x47 & ~x48 & x49 & x52))) | (x49 & ((~x08 & ~x48 & x52) | (~x47 & x48 & ~x52))));
  ...
  assign new_n402_ = ~new_n404_ & (~x51 | ((new_n403_ | x50) & (~x49 | new_n257_ | ~x50)));
  ...
  assign new_n411_ = ~new_n167_ & (new_n412_ | ~x50);
  ...
  assign new_n418_ = (~x52 | (~x27 & (~x21 | ~x51 | x53))) & (x21 | x53) & (~x51 | new_n302_ | x52);
  ...
  assign new_n446_ = new_n280_ & x51 & ~x46 & x48 & ~x49;
  ...
  assign new_n455_ = new_n280_ & x50 & ~x51;
  ...
  assign new_n463_ = x50 ? (x51 | new_n267_ | ~x52) : (~x51 | x52);
  assign new_n464_ = new_n173_ & ~x50 & ~x51 & ~x47 & ~x48 & x49;
  ...
  assign new_n470_ = new_n280_ & x49 & x50;
  ...
  assign new_n488_ = new_n280_ & new_n139_ & x46 & x48 & ~x49;
  ...
  assign new_n499_ = (~new_n500_ | x46) & (~new_n280_ | ~new_n139_ | ~x46 | x47 | x48);
  ...
  assign z49 = (~x48 & (new_n523_ | (new_n330_ & ~x46 & x47 & ~x49))) | (new_n330_ & x46 & ~x47 & x48 & ~x49);
