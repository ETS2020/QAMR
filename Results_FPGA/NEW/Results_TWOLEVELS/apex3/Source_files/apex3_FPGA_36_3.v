...
module FAU ( 
  ...
  assign new_n136_ = x51 & ((~x52 & x53 & x41 & x50) | (~x34 & ~x50 & x52 & ~x53));
  assign new_n137_ = new_n138_ & new_n120_ & ~x50 & x51;
  ...
  assign new_n178_ = (x51 | (~new_n179_ & new_n180_)) & (~x49 | new_n181_ | ~x51);
  assign new_n179_ = ~x47 & ((~x49 & ~x50 & x53) | (~x53 & (x49 | (x37 & ~x49 & ~x50))));
  assign new_n180_ = (~x53 | ((~x29 | x49 | ~x50) & (~x49 | (x29 & x50)))) & (~x08 | ~x50 | x53);
  assign new_n181_ = (~x50 | (x53 ? x41 : x47)) & (x47 | x50 | (x53 & (~x19 | ~x53)));
  ...
  assign new_n195_ = new_n161_ & x03 & new_n120_ & x50 & x51;
  ...
  assign new_n199_ = x50 ? (x47 ? new_n202_ : new_n204_) : (x47 ? new_n203_ : new_n200_);
  assign new_n200_ = x51 ? (x49 ? (x52 & (x34 | ~x52)) : (~x52 & (x40 | x52))) : new_n201_;
  assign new_n201_ = (~x49 | (x52 & (~x20 | ~x52))) & (x37 | x49 | x52);
  assign new_n202_ = (~x52 | (~x49 & (x49 | x51))) & (~x51 | x52 | (~x49 & (new_n155_ | x49)));
  assign new_n203_ = (~x01 | (x49 ? ~x51 : (x51 | x52))) & (~x49 | (x51 ? (x43 & ~x52) : x52));
  assign new_n204_ = (x52 | (x08 & (~x49 | ~x51))) & (~x49 | ~x52 | (~x29 & ~x51));
  ...
  assign new_n240_ = (new_n241_ | ~x47) & ~new_n247_ & (new_n257_ | x52) & (new_n252_ | x47);
  ...
  assign new_n247_ = ~x53 & (new_n250_ | (~new_n248_ & x52) | (~new_n251_ & ~x52));
  assign new_n248_ = (new_n249_ | x47) & (~x51 | (x49 ? x30 : ~x48));
  assign new_n249_ = x48 ? (~x49 | (~x29 & ~x51)) : ((x49 | (x51 & (~x16 | ~x51))) & (~x30 | ~x49 | ~x51));
  assign new_n250_ = ~x08 & ((~x51 & x52 & ~x48 & x49) | (~x47 & x48 & ~x52));
  assign new_n251_ = (~x48 | ((~x08 | x51) & (x47 | ~x49 | ~x51))) & (~x49 | (x51 & (~x35 | x47 | x48 | ~x51))) & (x47 | x48 | x49 | ~x51);
  ...
  assign new_n263_ = new_n161_ & ~x35 & new_n126_ & x51;
  ...
  assign new_n282_ = x51 & ((~new_n283_ & ~x49) | (new_n172_ & x48 & x49));
  ...
  assign new_n310_ = new_n159_ & ~x49 & new_n114_ & ~x36;
  ...
  assign new_n323_ = (~x50 | ((~x51 | x53) & (~x29 | x51 | ~x53))) & (~x51 | ~x53 | ~x19 | x50);
  ...
  assign new_n330_ = x04 & x46 & x48 & new_n148_ & ~x49 & x50;
  ...
  assign z06 = (~new_n334_ & ~x46) | (~x47 & ((~new_n364_ & x51) | (~new_n369_ & x46)));
  assign new_n334_ = (x52 | (~new_n335_ & new_n343_)) & ~new_n349_ & ~new_n362_ & (new_n355_ | ~x52);
  ...
  assign new_n366_ = (~new_n166_ | x50) & (~x53 | (~x48 & (x48 | (x50 & (~new_n118_ | x28 | ~x50)))));
  ...
  assign new_n376_ = ~new_n409_ & (new_n397_ | ~x53) & (x53 | (~new_n377_ & ~new_n387_ & new_n393_));
  ...
  assign new_n389_ = (~x49 | (~x48 & (x48 | (x52 ? ~x30 : ~x35)))) & (x48 | x49 | (~x52 & (x25 | x52)));
  ...
  assign new_n415_ = ~x51 & (x49 ? ~new_n374_ : (x53 & (x52 | (x41 & ~x52))));
  assign new_n416_ = (~x52 | (~x27 & (~x21 | ~x51 | x53))) & (x21 | x53) & (~x51 | new_n300_ | x52);
  ...
  assign new_n421_ = ~new_n237_ & (x49 | (x48 ? ~new_n422_ : ~new_n423_));
  ...
  assign new_n444_ = new_n278_ & x51 & ~x46 & x48 & ~x49;
  ...
  assign new_n453_ = new_n278_ & x50 & ~x51;
  ...
  assign new_n468_ = new_n278_ & x49 & x50;
  ...
  assign new_n486_ = x46 & x48 & ~x49 & new_n278_ & ~x50 & x51;
  ...
  assign z35 = (x49 & (new_n497_ | (new_n498_ & ~x46))) | (~x46 & new_n499_ & ~x47);
  assign new_n497_ = x46 & ~x47 & ~x48 & new_n278_ & ~x50 & x51;
  ...
  assign z49 = (~x48 & (new_n521_ | (new_n328_ & ~x46 & x47 & ~x49))) | (new_n328_ & x46 & ~x47 & x48 & ~x49);
