// Benchmark "FAU" written by ABC on Wed Jul 29 11:21:42 2020
...
module FAU ( 
  ...
  assign z01 = x46 ? new_n162_ : ((~new_n143_ & x53) | new_n167_ | (~new_n154_ & ~x53));
  ...
  assign new_n147_ = (~x50 | ~x52 | x48 | ~x49) & (~x48 | x49 | x50 | x52);
  ...
  assign new_n152_ = (x52 | ((~x50 | (~x48 & (x48 | ~x49))) & (~x48 | ~x49) & (x48 | (x29 ? x49 : x50)))) & (x48 | ~x49 | x50) & (x49 | ~x52 | (x48 & (~x48 | (x50 & (~x45 | ~x50)))));
  assign new_n153_ = (x48 | x52 | (x50 ? x49 : x39)) & (x50 | ~x52 | x13 | x49);
  assign new_n154_ = (new_n155_ | ~x48) & (~x47 | (~new_n160_ & (new_n158_ | x48)));
  ...
  assign new_n160_ = new_n161_ & ~x31 & ~x49;
  assign new_n161_ = ~x51 & x52;
  assign new_n162_ = ~x47 & ~x49 & ((~new_n163_ & ~x50) | (x48 & ~new_n166_ & x50));
  assign new_n163_ = (new_n164_ | ~x51) & (~x48 | x51 | (x52 ? (~x53 & (~x16 | x53)) : ~x53));
  assign new_n164_ = (~x53 | ((~x39 | x48 | ~x52) & (~x48 | (x52 & (~x04 | ~x52))))) & (~new_n165_ | x52);
  assign new_n165_ = ~x53 & (x37 | ~x48 | (~x38 & ~x43));
  assign new_n166_ = (x53 | (x51 ? (x52 & (~x03 | ~x52)) : ~x04)) & (x52 | ~x53 | (~x51 & (~x04 | x51)));
  assign new_n167_ = x47 & (new_n168_ | (~new_n169_ & x51));
  assign new_n168_ = new_n161_ & ~x50 & x38 & ~x48 & x49;
  ...
  assign new_n178_ = x53 ? ((~x49 | ((~x50 | x51 | ~x52) & x52 & (x50 | ~x52))) & (~x50 | ~x51 | x52)) : (x50 & (~x50 | x52 | (x51 & (~x49 | ~x51))));
  assign new_n179_ = x52 ? new_n180_ : (new_n184_ & ~new_n186_);
  ...
  assign new_n186_ = ~x47 & ((~x50 & (x51 ? x49 : (x49 ? ~x53 : (x53 | (x37 & ~x53))))) | (x49 & x50 & ~x53));
  ...
  assign new_n204_ = x51 & (x47 ? (x49 | (~x49 & ~new_n157_ & ~x52)) : (x49 & (x52 | (~x07 & ~x52))));
  ...
  assign new_n213_ = (~x53 | ((~x51 | x52) & (~x49 | ~x52 | (x17 & x51)))) & (x51 | ~x52 | x20 | ~x49);
  ...
  assign z04 = ~new_n269_ | (x50 & ((~new_n261_ & ~x47) | (~new_n242_ & ~x46)));
  assign new_n242_ = (new_n243_ | ~x47) & ~new_n249_ & (new_n259_ | x52) & (new_n255_ | x47);
  ...
  assign new_n249_ = ~x53 & ((~new_n252_ & ~x51) | new_n254_ | (x51 & (new_n250_ | new_n253_)));
  ...
  assign new_n255_ = ~new_n256_ & (new_n258_ | ~x51) & (new_n257_ | x51);
  ...
  assign new_n259_ = (~new_n260_ | ~x48) & (~x14 | x48 | x49 | ~x51);
  ...
  assign new_n269_ = (x50 | ((new_n278_ | x46) & (new_n270_ | x47))) & (x46 | ~new_n283_ | ~x47);
  ...
  assign new_n274_ = ~new_n277_ & (~x51 | (~new_n276_ & (new_n275_ | ~x49)));
  assign new_n275_ = x46 ? (x48 | (x52 ? ~x53 : (~x24 & x53))) : ((x48 | x52 | ~x53) & (~x52 | x53 | x34 | ~x48));
  assign new_n276_ = ~x39 & x46 & ~x48 & x52 & x53;
  assign new_n277_ = ~x46 & ~x48 & ~x51 & x52 & x53;
  assign new_n278_ = ~new_n282_ & (~x47 | ((new_n280_ | ~x51) & (~new_n281_ | ~new_n279_ | x51)));
  assign new_n279_ = x52 & ~x53;
  assign new_n280_ = (~x53 | (x48 ? (x21 & (x49 | ~x52)) : (x49 | ~x52))) & (x48 | ~x49 | x53 | (~x52 & (x20 | x52)));
  assign new_n281_ = x31 & ~x48 & ~x49;
  assign new_n282_ = x52 & x53 & ((x49 & x51) | (x13 & ~x48 & ~x49 & ~x51));
  assign new_n283_ = x51 & ((~new_n284_ & ~x49) | (new_n174_ & x48 & x49));
  assign new_n284_ = (x48 | x52 | (x53 ? ~x29 : x31)) & (x27 | ~x52 | x53);
  assign z05 = ~new_n330_ | (~new_n286_ & ~x48) | (~new_n312_ & x48) | (~new_n326_ & ~x46);
  assign new_n286_ = (~x50 | (~new_n287_ & new_n294_)) & ~new_n311_ & (new_n303_ | x50);
  assign new_n287_ = ~x53 & (~new_n291_ | (x49 & (~new_n288_ | new_n293_)));
  ...
  assign new_n298_ = (x46 | x51 | (x49 & (~x20 | ~x49))) & (x03 | ~x49 | ~x51);
  ...
  assign new_n303_ = ~new_n308_ & (x46 | (x53 ? (new_n304_ & ~new_n310_) : new_n306_));
  assign new_n304_ = x51 ? new_n305_ : ((x47 | (~x52 & (x49 | x52))) & (~x13 | x49 | ~x52));
  assign new_n305_ = (x29 | ~x47 | x52) & (x49 | ~x52 | x16 | x47);
  assign new_n306_ = (new_n307_ | x51) & (x47 | ~x51 | ((x49 | ~x52) & (~x41 | ~x49 | x52)));
  assign new_n307_ = x47 ? ((~x49 | x52) & (~x31 | x49 | ~x52)) : (~x52 | (~x49 & (~x32 | x49)));
  assign new_n308_ = ~x47 & (new_n309_ | (~x41 & x49 & new_n126_ & x51));
  ...
  assign new_n311_ = new_n161_ & ~x49 & new_n114_ & ~x36;
  ...
  assign new_n324_ = (~x50 | ~x51 | x53) & (~x53 | ((x50 | ~x51) & (~x29 | ~x50 | x51)));
  assign new_n325_ = x50 & x51 & ((~x52 & x53 & ~x41 & x49) | (~x49 & x52 & ~x53));
  assign new_n326_ = (new_n327_ | x50) & (~new_n329_ | x20 | x47 | ~x49);
  assign new_n327_ = (~new_n328_ | ~x49) & (~x47 | (~new_n136_ & (~new_n120_ | x13 | x49)));
  assign new_n328_ = x51 & ((x52 & x53 & x17 & ~x47) | (x12 & ~x52 & ~x53));
  assign new_n329_ = new_n120_ & x50 & ~x51;
  assign new_n330_ = (x46 | new_n333_ | ~x47) & (x47 | (~new_n331_ & ~new_n332_));
  assign new_n331_ = x04 & x46 & x48 & new_n150_ & ~x49 & x50;
  assign new_n332_ = ~x48 & ((~x49 & ((x46 & (x50 ? (~x51 & x52) : (x51 & ~x52))) | (x51 & ~x52 & ~x46 & ~x50))) | (~x46 & x49 & ~x50 & x51 & x52));
  assign new_n333_ = (x48 | x49 | x50 | ~x51 | ~x52) & (~x48 | ~x49 | ~x50 | (~x51 & (x51 | ~x52)));
  ...
  assign new_n336_ = x53 & ((~new_n337_ & x48) | (new_n127_ & new_n343_) | (~new_n341_ & ~x48));
  assign new_n337_ = new_n340_ & (~x47 | (~new_n338_ & new_n339_));
  assign new_n338_ = x01 & (x49 | (~x38 & x43 & ~x51));
  assign new_n339_ = (x49 | ((~x50 | x51) & (~x21 | x50 | ~x51))) & (~x49 | x51) & (x43 | ~x50 | ~x51);
  assign new_n340_ = (~x50 | ((x41 | ~x49 | ~x51) & (~x29 | x49 | x51))) & (x50 | (x49 ? (x51 & (x47 | ~x51)) : x47)) & (x29 | ~x49 | x51);
  assign new_n341_ = (x49 | ((~x47 | ~x50) & x51 & (x47 | x50 | ~x51))) & (new_n342_ | ~x49) & (x50 | ~x51 | x29 | ~x47);
  assign new_n342_ = x50 ? (x47 ? (x51 & (~x43 | ~x51)) : (x51 & (x44 | ~x51))) : ((~x47 | ~x51) & (x14 | x47 | x51));
  assign new_n343_ = x47 & x49;
  ...
  assign new_n352_ = (x49 | x50 | x32 | x47) & (~x50 | (~x47 & ~x25 & (~x49 | (x08 & (~x08 | x47)))));
  assign new_n353_ = x49 & ((x38 & x47 & ~x50) | (x50 & x53 & x20 & ~x47));
  assign new_n354_ = x47 ^ x49;
  assign new_n355_ = (~x49 | x51 | ~x52 | x53) & (x47 | x49 | ~x50 | ~x51 | ~x53);
  ...
  assign new_n359_ = ~x49 & x50 & ~x45 & x47;
  ...
  assign new_n365_ = (~x52 | (x50 ? new_n268_ : new_n368_)) & (~x46 | new_n366_ | x52);
  assign new_n366_ = (new_n367_ | x49) & (x48 | ~x49 | new_n112_ | ~x53);
  assign new_n367_ = (~new_n165_ | x50) & (~x53 | (~x48 & (x48 | (x50 & (~new_n118_ | x28 | ~x50)))));
  assign new_n368_ = (~x46 | ((new_n369_ | x49) & (x48 | ~x49 | x53))) & (x49 | x53 | ~x25 | x48);
  assign new_n369_ = x48 ? (x53 & (x04 | ~x53)) : (x53 & (~x39 | ~x53));
  assign new_n370_ = ~new_n371_ & (~x36 | x48 | ~new_n279_ | x50);
  ...
  assign z07 = (~x46 & (new_n377_ | ~new_n397_)) | (~x47 & (~new_n421_ | (~new_n413_ & x46)));
  assign new_n377_ = ~x53 & ((~new_n378_ & x47) | ~new_n393_ | (~new_n388_ & x50));
  assign new_n378_ = new_n381_ & (~x51 | ((new_n379_ | ~x48) & ~new_n387_ & (new_n386_ | x48)));
  assign new_n379_ = (~x01 | ((~x49 | x50) & (~x26 | x49 | ~x50))) & (new_n380_ | x50) & (~x50 | (~x52 & (x49 | x52 | (x01 & x26))));
  assign new_n380_ = (~x27 | ~x52) & (~x49 | (x43 & ~x52));
  assign new_n381_ = (~new_n385_ | x48) & (x51 | ((new_n382_ | x48) & ~new_n383_ & new_n384_));
  assign new_n382_ = x50 ? (~x49 & (x49 | (~x52 & (~x28 | x52)))) : (~x49 & (x09 | x49 | x52));
  assign new_n383_ = x52 & ((x48 & x50) | (~x31 & ~x49));
  assign new_n384_ = (~x49 | (~x05 & (~x48 | x50 | x52))) & (~x48 | x52 | (x01 & ~x50));
  assign new_n385_ = x50 & ~x52 & (x49 ? x11 : ~x28);
  assign new_n386_ = x50 ? (x49 & (~x49 | (~x52 & (x11 | x52)))) : (x49 & (x20 | ~x49 | x52));
  assign new_n387_ = x05 & ~x49 & ~x52;
  assign new_n388_ = (new_n390_ | x51) & ~new_n392_ & (x47 | (~new_n391_ & (new_n389_ | ~x51)));
  assign new_n389_ = ~new_n251_ & (x48 | x49 | (~x52 & (x25 | x52)));
  assign new_n390_ = (~x08 | ((~x48 | x52) & (~x49 | ~x52 | x47 | x48))) & (~x49 | ((x52 | (~x18 & (x47 | ~x48))) & (x08 | x48 | ~x52)));
  assign new_n391_ = x49 & x52 & x29 & x48;
  ...
  assign new_n397_ = (new_n409_ | ~x47) & (~x53 | (new_n404_ & (new_n398_ | x47)));
  assign new_n398_ = (new_n399_ | x48) & ~new_n403_ & (new_n401_ | ~x48);
  assign new_n399_ = new_n400_ & (x14 | ((x49 | ~x50 | ~x51) & (~x49 | x50 | x51 | x52)));
  assign new_n400_ = (x51 | ((x50 | ~x52) & (~x50 | x52 | ~x37 | ~x49))) & (x50 | ~x51 | (~x49 & (x16 | x49 | ~x52)));
  assign new_n401_ = (new_n402_ | ~x51) & (~x29 | ~x49 | ~x50 | x51 | x52);
  assign new_n402_ = (x50 | (x49 ? x52 : (x52 & (x03 | ~x52)))) & (~x49 | ~x50 | (x52 ? ~x42 : ~x41));
  assign new_n403_ = x17 & x49 & ~x50 & x51 & x52;
  assign new_n404_ = ~new_n407_ & (~x47 | (~new_n408_ & (new_n405_ | x52)));
  assign new_n405_ = (x43 | ((~x48 | x49 | x50 | x51) & (x48 | ~x49 | ~x50 | ~x51))) & (~x48 | x49 | x50 | new_n406_ | x51);
  assign new_n406_ = x01 & ~x38;
  assign new_n407_ = x13 & ~x48 & ~x49 & new_n161_ & ~x50;
  assign new_n408_ = x50 & x51 & x52 & (x48 ? (x49 | (x45 & ~x49)) : x49);
  assign new_n409_ = ~new_n168_ & (new_n410_ | ~x50);
  ...
  assign new_n414_ = new_n417_ & (~x50 | (~new_n415_ & ~new_n136_ & (new_n416_ | x49)));
  assign new_n415_ = ~x51 & (x49 ? ~new_n375_ : (x53 & (x52 | (x41 & ~x52))));
  assign new_n416_ = (~x52 | (~x27 & (~x21 | ~x51 | x53))) & (x21 | x53) & (~x51 | new_n301_ | x52);
  assign new_n417_ = (new_n418_ | x50) & (x53 | ((x49 | x51) & (x20 | ~x49 | ~x51)));
  ...
  assign new_n422_ = ~x50 & ((new_n161_ & x26) | (new_n174_ & ~x29));
  ...
  assign new_n444_ = new_n279_ & x51 & ~x46 & x48 & ~x49;
  assign new_n445_ = (~x51 | ((x48 | ~x49 | ~x53) & (x49 | x53 | ~x46 | ~x48))) & (~x46 | x49 | x51 | x53 | (x48 & (~x04 | ~x48)));
  ...
  assign new_n453_ = new_n279_ & x50 & ~x51;
  ...
  assign new_n462_ = x49 & ~x53 & (x50 ? (~x51 & ~new_n267_ & x52) : (x51 & ~x52));
  ...
  assign new_n467_ = new_n279_ & x49 & x50;
  assign z22 = new_n469_ | (~x46 & (x48 ? new_n471_ : ~new_n470_));
  assign new_n469_ = new_n114_ & ~x48 & x49 & new_n126_ & x50 & ~x51;
  assign new_n470_ = x47 ? (~x49 | ~x50 | x51 | ~x52 | ~x53) : (x52 | x53 | (x49 ? (x50 | x51) : (~x50 | ~x51)));
  assign new_n471_ = x49 & ~x50 & x53 & (x47 ? (~x51 & x52) : (x51 & ~x52));
  ...
  assign new_n485_ = new_n279_ & new_n140_ & x46 & x48 & ~x49;
  ...
  assign new_n496_ = (~new_n497_ | x46) & (~new_n279_ | ~new_n140_ | ~x46 | x47 | x48);
  ...
  assign z49 = (~x48 & (new_n520_ | (new_n329_ & ~x46 & x47 & ~x49))) | (new_n329_ & x46 & ~x47 & x48 & ~x49);
