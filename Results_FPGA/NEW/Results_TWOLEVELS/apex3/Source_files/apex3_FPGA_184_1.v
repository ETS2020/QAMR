// Benchmark "FAU" written by ABC on Wed Jul 29 11:22:42 2020
...
module FAU ( 
  ...
  assign z01 = x46 ? (~x47 & ~new_n164_ & ~x49) : ~new_n142_;
  assign new_n142_ = (~x53 | (x47 ? new_n143_ : new_n161_)) & (new_n150_ | x53) & (new_n157_ | ~x47);
  ...
  assign new_n158_ = x38 & ~x48 & x49 & new_n159_ & ~x50;
  ...
  assign new_n163_ = (~x49 | ~x50 | ((~x51 | ~x52) & (~x29 | x51 | x52))) & (~x51 | x52 | x49 | x50);
  ...
  assign new_n203_ = x51 & (x47 ? (x49 | (~x49 & ~new_n152_ & ~x52)) : (x49 & (x52 | (~x07 & ~x52))));
  ...
  assign z04 = ~new_n269_ | (x50 & ((~new_n261_ & ~x47) | (~new_n241_ & ~x46)));
  assign new_n241_ = (new_n242_ | ~x47) & ~new_n248_ & (new_n259_ | x52) & (new_n254_ | x47);
  ...
  assign new_n279_ = x47 & ((~new_n281_ & x51) | (new_n282_ & new_n280_ & ~x51));
  ...
  assign new_n284_ = (x52 | ~x53 | ~x48 | ~x49) & (x49 | ((x52 | ~x53 | ~x29 | x48) & (x27 | ~x52 | x53)));
  ...
  assign new_n312_ = new_n159_ & ~x49 & new_n114_ & ~x36;
  ...
  assign new_n332_ = x04 & x46 & x48 & new_n162_ & ~x49 & x50;
  ...
  assign new_n357_ = (~x48 | new_n362_ | ~x51) & (x53 | (~new_n358_ & (new_n360_ | ~x48)));
  assign new_n358_ = ~new_n359_ & x47;
  assign new_n359_ = (x50 | ((~x49 | x51) & (~x48 | ~x51 | (~x27 & ~x49)))) & (x49 | (x31 & (~x48 | ~x50 | x51)));
  assign new_n360_ = (x49 | (x50 ^ x51)) & (x47 | ~x49 | (x50 ? (~x29 & ~x51) : new_n361_));
  assign new_n361_ = x51 ? ~x34 : ~x20;
  assign new_n362_ = (~x53 | (x47 ? ((~x49 | x50) & (~x45 | x49 | ~x50)) : new_n363_)) & (x49 | ~x50 | x45 | ~x47);
  assign new_n363_ = (~x42 | ~x49 | ~x50) & (x03 | x49 | x50);
  ...
  assign new_n368_ = (~new_n166_ | x50) & (~x53 | (~x48 & (x48 | (x50 & (~new_n118_ | x28 | ~x50)))));
  ...
  assign new_n378_ = (x53 | (new_n388_ & (new_n379_ | ~x47))) & (new_n410_ | ~x47) & (new_n398_ | ~x53);
  assign new_n379_ = (~x51 | (new_n382_ & (new_n380_ | ~x48))) & new_n386_ & (new_n384_ | x51);
  ...
  assign new_n384_ = (x49 | ~x50 | ~x52) & (~x49 | (x50 ^ x52)) & (new_n385_ | x52) & (~x49 | (~x05 & (x48 | x50 | ~x52)));
  assign new_n385_ = x48 ? (x01 & ~x50) : (x49 ? ~x50 : (x50 ? ~x28 : x09));
  assign new_n386_ = (x31 | x49 | ~x52) & (x48 | ~x50 | new_n387_ | x52);
  assign new_n387_ = x49 ? ~x11 : x28;
  assign new_n388_ = ~new_n396_ & (new_n393_ | x50) & (~x50 | (new_n389_ & (new_n397_ | x51)));
  assign new_n389_ = ~new_n392_ & (x47 | (~new_n391_ & (~x51 | (~new_n250_ & ~new_n390_))));
  assign new_n390_ = ~x48 & ~x49 & (x52 | (~x25 & ~x52));
  assign new_n391_ = x49 & x52 & x29 & x48;
  assign new_n392_ = x51 & x52 & x03 & ~x49;
  assign new_n393_ = (x47 | (x49 ? new_n394_ : new_n395_)) & (~new_n159_ | ~x48 | x49);
  ...
  assign new_n396_ = ~x14 & ~x48 & new_n159_ & x49;
  ...
  assign new_n410_ = ~new_n158_ & (new_n411_ | ~x50);
  ...
  assign new_n422_ = ~new_n238_ & (x49 | (x48 ? ~new_n423_ : ~new_n424_));
  assign new_n423_ = ~x50 & ((new_n159_ & x26) | (new_n173_ & ~x29));
  ...
  assign new_n462_ = x50 ? (x51 | new_n267_ | ~x52) : (~x51 | x52);
  assign new_n463_ = new_n173_ & ~x50 & ~x51 & ~x47 & ~x48 & x49;
  ...
  assign new_n469_ = new_n280_ & x49 & x50;
  ...
  assign new_n487_ = new_n280_ & new_n139_ & x46 & x48 & ~x49;
  ...
  assign new_n498_ = (~new_n499_ | x46) & (~new_n280_ | ~new_n139_ | ~x46 | x47 | x48);
