...
module FAU ( 
  ...
  assign new_n313_ = ~x36 & x46 & ~x47 & ~x49 & x52;
  ...
  assign z06 = (~new_n337_ & ~x46) | (~x47 & ((~new_n367_ & x46) | (~new_n373_ & x51)));
  ...
  assign new_n367_ = ~new_n368_ & (~x36 | x48 | ~new_n281_ | x50);
  ...
  assign new_n373_ = (new_n374_ | ~x52) & (~x46 | x52 | (~new_n377_ & (new_n376_ | x49)));
  assign new_n374_ = (new_n269_ | ~x50) & (x49 | new_n375_ | x50);
  assign new_n375_ = (~x25 | x48 | x53) & (~x46 | ((~x39 | x48 | ~x53) & (~x48 | (x53 & (x04 | ~x53)))));
  assign new_n376_ = (~new_n167_ | x50) & (~x53 | (~x48 & (x48 | (x50 & (~new_n118_ | x28 | ~x50)))));
  assign new_n377_ = ~x48 & x49 & ~new_n112_ & x53;
  ...
  assign new_n417_ = ~x51 & (x49 ? ~new_n372_ : (x53 & (x52 | (x41 & ~x52))));
