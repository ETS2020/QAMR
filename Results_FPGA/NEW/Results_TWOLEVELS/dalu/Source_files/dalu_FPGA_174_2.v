// Benchmark "FAU" written by ABC on Sat Aug  1 07:41:48 2020
...
module FAU ( 
  ...
  assign new_n116_ = x70 ? (new_n121_ | x71) : ((~x01 | (~new_n117_ & x00)) & (~x00 | x01 | new_n117_ | ~x71));
  ...
  assign new_n133_ = (new_n110_ | new_n128_) & (new_n134_ | new_n127_);
  assign new_n134_ = (x68 | new_n130_ | ~x69) & (~x49 | ~x68 | ~new_n104_ | x69);
  assign new_n135_ = (new_n136_ | x68) & (~x33 | ((x68 | ~x70 | ~x71) & (x70 | x71 | ~x68 | x69)));
  assign new_n136_ = (x70 | (~x01 & (~x49 | ~x69 | x71))) & (~x70 | x71 | ~x17 | x69);
  ...
  assign new_n150_ = (~x02 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n151_ | ~x70) & (x70 | x71 | ~x50 | ~x69);
  ...
  assign new_n172_ = (~x03 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n173_ | ~x70) & (x70 | x71 | ~x51 | ~x69);
  assign new_n173_ = (~x35 | ~x71) & (~x19 | x69 | x71);
  assign new_n174_ = x66 & ~x67 & ((~new_n172_ & ~x68) | (new_n109_ & x35 & x68));
  ...
  assign new_n188_ = (~x04 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n189_ | ~x70) & (x70 | x71 | ~x52 | ~x69);
  assign new_n189_ = (~x36 | ~x71) & (~x20 | x69 | x71);
  assign new_n190_ = ~x67 & ((~new_n188_ & ~x68) | (new_n109_ & x36 & x68));
  ...
  assign new_n201_ = x00 ? (x05 | (~x06 & ~x07 & (x06 | x07 | (~x04 & (new_n120_ | x04))))) : ~x05;
  assign new_n202_ = x32 ? (x37 | (~x38 & ~x39 & (x38 | x39 | (~x36 & (new_n125_ | x36))))) : ~x37;
  ...
  assign new_n206_ = (~x05 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n207_ | ~x70) & (x70 | x71 | ~x53 | ~x69);
  assign new_n207_ = (~x37 | ~x71) & (~x21 | x69 | x71);
  assign new_n208_ = ~x67 & ((~new_n206_ & ~x68) | (new_n109_ & x37 & x68));
  ...
  assign new_n212_ = (new_n127_ | ~x22) & (new_n213_ | ~x72) & (new_n214_ | x72);
  assign new_n213_ = (x73 | (x74 ? ~x17 : ~x18)) & (~x16 | ~x73 | x74);
  assign new_n214_ = (~x73 | (x74 ? ~x19 : ~x20)) & (~x21 | x73 | ~x74);
  assign new_n215_ = ~new_n216_ & ~new_n217_ & (new_n127_ | ~x54);
  ...
  assign new_n225_ = (~x06 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n226_ | ~x70) & (x70 | x71 | ~x54 | ~x69);
  assign new_n226_ = (~x38 | ~x71) & (~x22 | x69 | x71);
  assign new_n227_ = x66 & ~x67 & ((~new_n225_ & ~x68) | (new_n109_ & x38 & x68));
  ...
  assign new_n231_ = (new_n127_ | ~x23) & (new_n232_ | ~x72) & (new_n233_ | x72);
  assign new_n232_ = (x73 | (x74 ? ~x18 : ~x19)) & (~x16 | ~x73 | x74);
  assign new_n233_ = (~x73 | (x74 ? ~x20 : ~x21)) & (~x22 | x73 | ~x74);
  assign new_n234_ = ~new_n235_ & ~new_n236_ & (new_n127_ | ~x55);
  ...
  assign new_n244_ = (~x07 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n245_ | ~x70) & (x70 | x71 | ~x55 | ~x69);
  assign new_n245_ = (~x39 | ~x71) & (~x23 | x69 | x71);
  assign new_n246_ = x66 & ~x67 & ((~new_n244_ & ~x68) | (new_n109_ & x39 & x68));
  ...
  assign new_n250_ = (~x08 | (x00 & (~new_n119_ | ~new_n120_))) & (~x00 | x08 | (new_n119_ & new_n120_));
  assign new_n251_ = (~x40 | (x32 & (~new_n124_ | ~new_n125_))) & (~x32 | x40 | (new_n124_ & new_n125_));
  assign new_n252_ = (new_n127_ | ~x56) & (new_n253_ | ~x72) & (new_n254_ | x72);
  ...
  assign new_n256_ = (new_n127_ | ~x24) & (new_n257_ | ~x72) & (new_n258_ | x72);
  ...
  assign new_n263_ = (~x08 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n264_ | ~x70) & (x70 | x71 | ~x56 | ~x69);
  assign new_n264_ = (~x40 | ~x71) & (~x24 | x69 | x71);
  assign new_n265_ = x66 & ~x67 & ((~new_n263_ & ~x68) | (new_n109_ & x40 & x68));
  ...
  assign new_n269_ = (~x09 | (~new_n159_ & x00)) & (~x00 | new_n159_ | x09);
  assign new_n270_ = (~x41 | (~new_n162_ & x32)) & (~x32 | new_n162_ | x41);
  assign new_n271_ = ~new_n272_ & ~new_n273_ & (new_n127_ | ~x57);
  ...
  assign new_n275_ = (new_n127_ | ~x25) & (new_n276_ | ~x72) & (new_n277_ | x72);
  ...
  assign new_n282_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n283_ | ~x70) & (x70 | x71 | ~x57 | ~x69);
  assign new_n283_ = (~x41 | ~x71) & (~x25 | x69 | x71);
  assign new_n284_ = x66 & ~x67 & ((~new_n282_ & ~x68) | (new_n109_ & x41 & x68));
  assign z10 = x64 ? (~x65 & (x66 ? new_n313_ : ~new_n306_)) : ~new_n286_;
  assign new_n286_ = (~new_n303_ | ~x65) & (new_n113_ | (x70 ? new_n298_ : new_n287_));
  ...
  assign new_n293_ = ~x72 & ((x73 & (x74 ? x55 : x56)) | (x57 & ~x73 & x74));
  assign new_n294_ = x71 & (new_n295_ | new_n296_ | new_n297_);
  ...
  assign new_n298_ = x65 ? (x68 | new_n299_ | ~x69) : (~x68 | ~new_n301_ | x69);
  assign new_n299_ = ~new_n300_ & (x71 | (~new_n296_ & ~new_n297_)) & (~x71 | (~new_n292_ & ~new_n293_));
  assign new_n300_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x58 : x26);
  assign new_n301_ = ~x71 & ((x42 & (new_n302_ | ~x32)) | (x32 & ~new_n302_ & ~x42));
  assign new_n302_ = ~x43 & ~x44 & ~x45 & ~x46 & ~x47;
  assign new_n303_ = ~x66 & ~x67 & x68 & ~x69 & (new_n304_ | new_n305_);
  assign new_n304_ = ~x70 & x71 & ((x10 & (new_n289_ | ~x00)) | (x00 & ~new_n289_ & ~x10));
  assign new_n305_ = x70 & ~x71 & ((x42 & (new_n302_ | ~x32)) | (x32 & ~new_n302_ & ~x42));
  assign new_n306_ = x68 ? (~new_n310_ | x69) : (x67 ? new_n311_ : (new_n307_ | ~x69));
  assign new_n307_ = ((new_n309_ & ~new_n295_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n308_ & ~new_n291_));
  assign new_n308_ = ~new_n292_ & ~new_n293_;
  assign new_n309_ = ~new_n296_ & ~new_n297_;
  assign new_n310_ = ~x70 & ~x71 & (x67 ? x42 : (~new_n308_ | new_n291_));
  assign new_n311_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n312_ | ~x70) & (x70 | x71 | ~x58 | ~x69);
  assign new_n312_ = (~x42 | ~x71) & (~x26 | x69 | x71);
  assign new_n313_ = ~x67 & ((~new_n311_ & ~x68) | (new_n109_ & x42 & x68));
  assign z11 = x64 ? (~x65 & (x66 ? new_n338_ : ~new_n331_)) : ~new_n315_;
  assign new_n315_ = ((~x66 & ~x67) | (~new_n316_ & ~new_n326_)) & (~x65 | x66 | ~new_n330_ | x67);
  assign new_n316_ = ~x70 & ((x68 & ~new_n317_ & ~x69) | (x65 & ~x68 & new_n322_ & x69));
  assign new_n317_ = x65 ? (x71 | (~new_n319_ & ~new_n320_ & ~new_n321_)) : (new_n318_ | ~x71);
  assign new_n318_ = (~x11 | (x00 & (x14 | x15 | x12 | x13))) & (~x00 | x11 | (~x14 & ~x15 & ~x12 & ~x13));
  assign new_n319_ = x59 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n320_ = x72 & ((~x73 & (x74 ? x54 : x55)) | (x51 & x73 & ~x74));
  assign new_n321_ = ~x72 & ((x73 & (x74 ? x56 : x57)) | (x58 & ~x73 & x74));
  ...
  assign new_n326_ = x70 & (x65 ? (~x68 & ~new_n327_ & x69) : (x68 & new_n329_ & ~x69));
  assign new_n327_ = ~new_n328_ & (x71 | (~new_n324_ & ~new_n325_)) & (~x71 | (~new_n320_ & ~new_n321_));
  assign new_n328_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x59 : x27);
  assign new_n329_ = ~x71 & ((x43 & (new_n125_ | ~x32)) | (x32 & ~new_n125_ & ~x43));
  assign new_n330_ = x68 & ~x69 & (x70 ? new_n329_ : (~new_n318_ & x71));
  assign new_n331_ = x68 ? (~new_n335_ | x69) : (x67 ? new_n336_ : (new_n332_ | ~x69));
  assign new_n332_ = ((new_n334_ & ~new_n323_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n333_ & ~new_n319_));
  assign new_n333_ = ~new_n320_ & ~new_n321_;
  assign new_n334_ = ~new_n324_ & ~new_n325_;
  assign new_n335_ = ~x70 & ~x71 & (x67 ? x43 : (~new_n333_ | new_n319_));
  assign new_n336_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n337_ | ~x70) & (x70 | x71 | ~x59 | ~x69);
  assign new_n337_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n338_ = ~x67 & ((~new_n336_ & ~x68) | (new_n109_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n363_ : ~new_n356_)) : ~new_n340_;
  ...
  assign new_n342_ = x65 ? (x71 | (~new_n344_ & ~new_n345_ & ~new_n346_)) : ~new_n343_;
  ...
  assign new_n348_ = x28 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n349_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n350_ = ~x72 & ((x73 & (x74 ? x25 : x26)) | (x27 & ~x73 & x74));
  ...
  assign new_n353_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n354_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n355_ = x68 & ~x69 & (x70 ? new_n354_ : new_n343_);
  ...
  assign new_n360_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n358_ | new_n344_));
  assign new_n361_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n362_ | ~x70) & (x70 | x71 | ~x60 | ~x69);
  assign new_n362_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n363_ = ~x67 & ((~new_n361_ & ~x68) | (new_n109_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n388_ : ~new_n381_)) : ~new_n365_;
  ...
  assign new_n368_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  ...
  assign new_n373_ = x29 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n374_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  ...
  assign new_n378_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n379_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  ...
  assign new_n385_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n383_ | new_n369_));
  assign new_n386_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n387_ | ~x70) & (x70 | x71 | ~x61 | ~x69);
  assign new_n387_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n388_ = ~x67 & ((~new_n386_ & ~x68) | (new_n109_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n411_ : ~new_n406_)) : ~new_n390_;
  assign new_n390_ = ~new_n404_ & (new_n113_ | (x70 ? new_n400_ : (~new_n391_ & ~new_n396_)));
  assign new_n391_ = x68 & ~x69 & (x65 ? (~new_n392_ & ~x71) : (~new_n395_ & x71));
  assign new_n392_ = (new_n127_ | ~x62) & (new_n393_ | ~x72) & (new_n394_ | x72);
  assign new_n393_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n394_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n395_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n396_ = x65 & ~x68 & x69 & ~new_n397_ & x71;
  assign new_n397_ = (new_n127_ | ~x30) & (new_n398_ | ~x72) & (new_n399_ | x72);
  assign new_n398_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n399_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n400_ = x65 ? (x68 | ~x69 | (~new_n401_ & new_n402_)) : (~x68 | ~new_n403_ | x69);
  assign new_n401_ = ~new_n127_ & (x71 ? x62 : x30);
  assign new_n402_ = x71 ? (x72 ? new_n393_ : new_n394_) : (x72 ? new_n398_ : new_n399_);
  assign new_n403_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n404_ = x65 & ~x66 & ~x67 & x68 & ~new_n405_ & ~x69;
  assign new_n405_ = x70 ? ~new_n403_ : (new_n395_ | ~x71);
  assign new_n406_ = x68 ? (~new_n408_ | x69) : (x67 ? new_n409_ : (new_n407_ | ~x69));
  assign new_n407_ = (new_n397_ | (~x70 ^ x71)) & (~x70 | new_n392_ | ~x71);
  assign new_n408_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n392_);
  assign new_n409_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n410_ | ~x70) & (x70 | x71 | ~x62 | ~x69);
  assign new_n410_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n411_ = ~x67 & ((~new_n409_ & ~x68) | (new_n109_ & x46 & x68));
  assign z15 = x68 ? (~new_n424_ & ~x69) : (x64 ? new_n413_ : new_n423_);
  assign new_n413_ = ~x65 & (x66 ? (~new_n421_ & ~x67) : (x67 ? ~new_n421_ : (~new_n414_ & x69)));
  assign new_n414_ = (new_n415_ | (~x70 ^ x71)) & (~x70 | new_n418_ | ~x71);
  assign new_n415_ = (new_n127_ | ~x31) & (new_n416_ | ~x72) & (new_n417_ | x72);
  assign new_n416_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n417_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n418_ = (new_n127_ | ~x63) & (new_n419_ | ~x72) & (new_n420_ | x72);
  assign new_n419_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n420_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n421_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n422_ | ~x70) & (x70 | x71 | ~x63 | ~x69);
  assign new_n422_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n423_ = x65 & x69 & ~new_n414_ & ~new_n113_;
  assign new_n424_ = x64 ? (~new_n426_ | x65) : ((new_n425_ | new_n113_) & (~new_n427_ | ~x65));
  assign new_n425_ = (x70 | ((~x65 | new_n418_ | x71) & (~x15 | x65 | ~x71))) & (~x70 | x71 | ~x47 | x65);
  assign new_n426_ = ~x70 & ~x71 & ((~x66 & ~new_n418_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n427_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
endmodule
