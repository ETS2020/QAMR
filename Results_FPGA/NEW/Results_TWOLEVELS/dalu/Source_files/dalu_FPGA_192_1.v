// Benchmark "FAU" written by ABC on Sat Aug  1 07:42:26 2020
...
module FAU ( 
  ...
  assign new_n113_ = x66 ? (x67 | x71) : ~x67;
  assign new_n114_ = ~x67 & ((x70 & (new_n115_ | (x32 & x71))) | (x00 & ~x70 & x71));
  assign new_n115_ = x16 & ~x66 & x69;
  assign new_n116_ = ~x70 & ((~new_n113_ & x32) | (new_n109_ & x48));
  assign z01 = x64 ? (~x65 & (new_n134_ | (new_n140_ & ~x66))) : ~new_n118_;
  ...
  assign new_n134_ = ~x67 & (x68 ? new_n138_ : (~new_n135_ | (~new_n139_ & x01)));
  assign new_n135_ = (~x66 | new_n136_ | x71) & (~x70 | ((~x33 | ~x71) & (~new_n137_ | x66)));
  assign new_n136_ = (~x17 | x69 | ~x70) & (~x49 | ~x69 | x70);
  assign new_n137_ = x69 & ((x17 & (x72 ? (x73 & x74) : (~x73 & ~x74))) | (x16 & ((x73 & (~x74 | (~x72 & x74))) | (~x73 & x74) | (x72 & ~x74))));
  assign new_n138_ = ~x69 & ~x70 & ((~new_n130_ & ~x66) | (x33 & x66 & ~x71));
  assign new_n139_ = (x70 | ~x71) & (~x70 | x71 | ~x66 | ~x69);
  assign new_n140_ = x67 & ((~new_n142_ & ~x68) | (new_n141_ & x33 & x68));
  assign new_n141_ = ~x69 & ~x70;
  assign new_n142_ = (~x17 | x69 | ~x70) & (~x69 | (x70 ? ~x01 : ~x49));
  assign z02 = x64 ? (~x65 & (new_n163_ | (~new_n158_ & ~x67))) : ~new_n144_;
  assign new_n144_ = (~x68 | x69 | (x65 ? new_n150_ : new_n145_)) & (~x65 | x68 | new_n155_ | ~x69);
  assign new_n145_ = x70 ? (~new_n148_ | x71) : (~x71 | ((~x02 | (~new_n146_ & x00)) & (~x00 | new_n146_ | x02)));
  assign new_n146_ = new_n147_ & new_n123_ & new_n124_;
  assign new_n147_ = ~x06 & ~x07 & ~x08 & ~x03 & ~x04 & ~x05;
  assign new_n148_ = ~new_n109_ & ((x34 & (~x32 | (new_n149_ & new_n127_ & new_n128_))) | (x32 & ~x34 & (~new_n149_ | ~new_n127_ | ~new_n128_)));
  assign new_n149_ = ~x38 & ~x39 & ~x40 & ~x35 & ~x36 & ~x37;
  assign new_n150_ = (x66 | x67 | new_n151_ | ~x70) & (x70 | x71 | new_n152_ | (~x66 & ~x67));
  assign new_n151_ = (~x34 | (x32 & (~new_n149_ | ~new_n127_ | ~new_n128_))) & (~x32 | x34 | (new_n149_ & new_n127_ & new_n128_));
  assign new_n152_ = new_n154_ & (new_n153_ | ~x50);
  assign new_n153_ = x72 ? (~x73 | ~x74) : (x73 | x74);
  assign new_n154_ = (~x48 | ((~x73 | (x74 & (x72 | ~x74))) & (~x72 | (x74 & (x73 | ~x74))))) & (x73 | ~x74 | ~x49 | x72);
  assign new_n155_ = ~new_n156_ & (new_n157_ | (x70 ? (new_n109_ | x71) : ~x71)) & (~x70 | new_n154_ | ~x71);
  assign new_n156_ = ~new_n153_ & ((x71 & (x70 ? x50 : x18)) | (x18 & x70 & ~new_n109_ & ~x71));
  assign new_n157_ = (~x16 | ((~x73 | (x74 & (x72 | ~x74))) & (~x72 | (x74 & (x73 | ~x74))))) & (x73 | ~x74 | ~x17 | x72);
  assign new_n158_ = x68 ? ~new_n161_ : (~new_n159_ & ~new_n162_ & (new_n139_ | ~x02));
  assign new_n159_ = x70 & ((x34 & x71) | (~x66 & ~new_n160_ & x69));
  assign new_n160_ = new_n157_ & (new_n153_ | ~x18);
  assign new_n161_ = ~x69 & ~x70 & ((~new_n152_ & ~x66) | (x34 & x66 & ~x71));
  assign new_n162_ = x66 & ~x71 & ((x18 & ~x69 & x70) | (x50 & x69 & ~x70));
  assign new_n163_ = ~x66 & x67 & ((~new_n164_ & ~x68) | (new_n141_ & x34 & x68));
  assign new_n164_ = (~x18 | x69 | ~x70) & (~x69 | (x70 ? ~x02 : ~x50));
  assign z03 = x64 ? (~x65 & (new_n181_ | (new_n186_ & ~x66))) : ~new_n166_;
  assign new_n166_ = (~x68 | x69 | (x65 ? new_n174_ : new_n167_)) & (~x65 | x68 | new_n178_ | ~x69);
  ...
  assign new_n171_ = ~new_n109_ & ((x35 & (~x32 | (new_n172_ & new_n173_))) | (x32 & ~x35 & (~new_n172_ | ~new_n173_)));
  assign new_n172_ = ~x39 & ~x40 & ~x41 & ~x36 & ~x37 & ~x38;
  assign new_n173_ = ~x45 & ~x46 & ~x47 & ~x42 & ~x43 & ~x44;
  assign new_n174_ = (x66 | x67 | new_n175_ | ~x70) & (x70 | x71 | new_n176_ | (~x66 & ~x67));
  assign new_n175_ = (~x35 | (x32 & (~new_n172_ | ~new_n173_))) & (~x32 | x35 | (new_n172_ & new_n173_));
  assign new_n176_ = new_n177_ & (new_n153_ | ~x51);
  assign new_n177_ = (~x48 | (x72 ? (x74 & (x73 | ~x74)) : (~x73 | ~x74))) & (x72 | ((~x50 | x73 | ~x74) & (~x49 | ~x73 | x74)));
  assign new_n178_ = ~new_n179_ & (new_n180_ | (x70 ? (new_n109_ | x71) : ~x71)) & (~x70 | new_n177_ | ~x71);
  assign new_n179_ = ~new_n153_ & ((x71 & (x70 ? x51 : x19)) | (x19 & x70 & ~new_n109_ & ~x71));
  assign new_n180_ = (~x16 | (x72 ? (x74 & (x73 | ~x74)) : (~x73 | ~x74))) & (x72 | ((~x18 | x73 | ~x74) & (~x17 | ~x73 | x74)));
  assign new_n181_ = ~x67 & (x68 ? new_n185_ : (~new_n182_ | (~new_n139_ & x03)));
  assign new_n182_ = (~x66 | new_n184_ | x71) & (~x70 | ((~x35 | ~x71) & (~new_n183_ | x66)));
  assign new_n183_ = x69 & (~new_n180_ | (~new_n153_ & x19));
  assign new_n184_ = (~x19 | x69 | ~x70) & (~x51 | ~x69 | x70);
  assign new_n185_ = ~x69 & ~x70 & ((~new_n176_ & ~x66) | (x35 & x66 & ~x71));
  assign new_n186_ = x67 & ((~new_n187_ & ~x68) | (new_n141_ & x35 & x68));
  ...
  assign new_n200_ = ~new_n208_ & (x67 | (x68 ? ~new_n205_ : (new_n201_ & ~new_n207_)));
  assign new_n201_ = (new_n202_ | ~x70) & (~x52 | ~x66 | ~x69 | x70 | x71);
  assign new_n202_ = new_n204_ & (x66 | ~x69 | (x72 ? new_n203_ : new_n193_));
  assign new_n203_ = (~x16 | (x74 & (x73 | ~x74))) & (~x20 | ~x73 | ~x74);
  assign new_n204_ = (~x36 | ~x71) & (x69 | x71 | ~x20 | ~x66);
  assign new_n205_ = ~x69 & ~x70 & ((~new_n206_ & ~x66) | (x36 & x66 & ~x71));
  assign new_n206_ = x72 ? ((~x48 | (x74 & (x73 | ~x74))) & (~x52 | ~x73 | ~x74)) : new_n192_;
  assign new_n207_ = ~new_n139_ & x04;
  assign new_n208_ = ~x66 & x67 & ((~new_n209_ & ~x68) | (new_n141_ & x36 & x68));
  ...
  assign new_n226_ = ~new_n234_ & (x67 | (x68 ? ~new_n231_ : (new_n227_ & ~new_n233_)));
  assign new_n227_ = (new_n228_ | ~x70) & (~x53 | ~x66 | ~x69 | x70 | x71);
  assign new_n228_ = new_n230_ & (x66 | ~x69 | (x72 ? new_n229_ : new_n220_));
  assign new_n229_ = (~x21 | ~x73 | ~x74) & (~x17 | x73 | x74) & (~x16 | (~x73 ^ x74));
  assign new_n230_ = (~x37 | ~x71) & (x69 | x71 | ~x21 | ~x66);
  assign new_n231_ = ~x69 & ~x70 & ((~new_n232_ & ~x66) | (x37 & x66 & ~x71));
  assign new_n232_ = x72 ? (new_n216_ & (~x48 | (~x73 ^ x74))) : new_n219_;
  assign new_n233_ = ~new_n139_ & x05;
  assign new_n234_ = ~x66 & x67 & ((~new_n235_ & ~x68) | (new_n141_ & x37 & x68));
  ...
  assign new_n241_ = ~new_n153_ & ((x22 & ~x68 & x69 & x70) | (x54 & x68 & ~x69 & ~x70));
  ...
  assign new_n251_ = (new_n153_ | (x70 ? ~x54 : ~x22)) & (new_n245_ | x70) & (new_n242_ | ~x70);
  assign new_n252_ = ~x66 & ~x67 & x68 & ~x69 & ~new_n249_ & x70;
  assign new_n253_ = (x67 | (x68 ? ~new_n259_ : new_n254_)) & (x66 | new_n262_ | ~x67);
  assign new_n254_ = (new_n139_ | ~x06) & ~new_n258_ & (new_n255_ | ~x70);
  assign new_n255_ = ~new_n257_ & (x66 | ~x69 | (~new_n256_ & ~new_n246_ & ~new_n247_));
  assign new_n256_ = x22 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n257_ = x38 & x71;
  assign new_n258_ = x66 & ~x71 & ((x22 & ~x69 & x70) | (x54 & x69 & ~x70));
  assign new_n259_ = ~x69 & ~x70 & (new_n261_ | (~x66 & (~new_n242_ | new_n260_)));
  assign new_n260_ = ~new_n153_ & x54;
  assign new_n261_ = x38 & x66 & ~x71;
  ...
  assign new_n269_ = ~new_n153_ & ((x23 & ~x68 & x69 & x70) | (x55 & x68 & ~x69 & ~x70));
  ...
  assign new_n279_ = (new_n153_ | (x70 ? ~x55 : ~x23)) & (new_n273_ | x70) & (new_n270_ | ~x70);
  assign new_n280_ = ~x66 & ~x67 & x68 & ~x69 & ~new_n277_ & x70;
  assign new_n281_ = (x67 | (x68 ? ~new_n287_ : new_n282_)) & (x66 | new_n290_ | ~x67);
  assign new_n282_ = (new_n139_ | ~x07) & ~new_n286_ & (new_n283_ | ~x70);
  assign new_n283_ = ~new_n285_ & (x66 | ~x69 | (~new_n284_ & ~new_n274_ & ~new_n275_));
  assign new_n284_ = x23 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n285_ = x39 & x71;
  assign new_n286_ = x66 & ~x71 & ((x23 & ~x69 & x70) | (x55 & x69 & ~x70));
  assign new_n287_ = ~x69 & ~x70 & (new_n289_ | (~x66 & (~new_n270_ | new_n288_)));
  assign new_n288_ = ~new_n153_ & x55;
  assign new_n289_ = x39 & x66 & ~x71;
  ...
  assign new_n300_ = (new_n153_ | ~x56) & (new_n301_ | ~x72) & (new_n302_ | x72);
  ...
  assign new_n305_ = ~new_n153_ & ((x71 & (x70 ? x56 : x24)) | (x24 & x70 & ~new_n109_ & ~x71));
  ...
  assign new_n309_ = (x67 | (x68 ? ~new_n315_ : new_n310_)) & (x66 | new_n316_ | ~x67);
  assign new_n310_ = (new_n139_ | ~x08) & ~new_n314_ & (new_n311_ | ~x70);
  assign new_n311_ = ~new_n313_ & (x66 | ~x69 | (~new_n312_ & ~new_n307_ & ~new_n308_));
  assign new_n312_ = x24 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n313_ = x40 & x71;
  assign new_n314_ = x66 & ~x71 & ((x24 & ~x69 & x70) | (x56 & x69 & ~x70));
  assign new_n315_ = ~x69 & ~x70 & ((~new_n300_ & ~x66) | (x40 & x66 & ~x71));
  ...
  assign new_n320_ = x70 ? (~new_n321_ | x71) : (~x71 | ((~x00 | new_n170_ | x09) & (~x09 | (~new_n170_ & x00))));
  assign new_n321_ = ~new_n109_ & ((x32 & ~new_n173_ & ~x41) | (x41 & (new_n173_ | ~x32)));
  assign new_n322_ = ~new_n323_ & (x70 | x71 | new_n109_ | (~new_n324_ & new_n325_));
  assign new_n323_ = ~x66 & ~x67 & x70 & ((x41 & (new_n173_ | ~x32)) | (x32 & ~new_n173_ & ~x41));
  assign new_n324_ = ~new_n153_ & x57;
  ...
  assign new_n329_ = ~new_n153_ & ((x71 & (x70 ? x57 : x25)) | (x25 & x70 & ~new_n109_ & ~x71));
  ...
  assign new_n333_ = ~new_n340_ & (x67 | (x68 ? (~new_n339_ | x69) : new_n334_));
  assign new_n334_ = (new_n139_ | ~x09) & ~new_n338_ & (new_n335_ | ~x70);
  assign new_n335_ = ~new_n337_ & (x66 | ~x69 | (~new_n336_ & ~new_n331_ & ~new_n332_));
  assign new_n336_ = x25 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n337_ = x41 & x71;
  assign new_n338_ = x66 & ~x71 & ((x25 & ~x69 & x70) | (x57 & x69 & ~x70));
  assign new_n339_ = ~x70 & ((~x66 & (new_n324_ | ~new_n325_)) | (x41 & x66 & ~x71));
  assign new_n340_ = ~x66 & x67 & ((~new_n341_ & ~x68) | (new_n141_ & x41 & x68));
  ...
  assign new_n356_ = ~new_n153_ & ((x71 & (x70 ? x58 : x26)) | (x26 & x70 & ~new_n109_ & ~x71));
  ...
  assign new_n360_ = ~new_n367_ & (x67 | (x68 ? (~new_n366_ | x69) : new_n361_));
  assign new_n361_ = (new_n139_ | ~x10) & ~new_n365_ & (new_n362_ | ~x70);
  assign new_n362_ = ~new_n364_ & (x66 | ~x69 | (~new_n363_ & ~new_n358_ & ~new_n359_));
  assign new_n363_ = x26 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n364_ = x42 & x71;
  assign new_n365_ = x66 & ~x71 & ((x26 & ~x69 & x70) | (x58 & x69 & ~x70));
  assign new_n366_ = ~x70 & ((~x66 & (~new_n355_ | new_n348_)) | (x42 & x66 & ~x71));
  assign new_n367_ = ~x66 & x67 & ((~new_n368_ & ~x68) | (new_n141_ & x42 & x68));
  ...
  assign new_n380_ = ~new_n153_ & ((x71 & (x70 ? x59 : x27)) | (x27 & x70 & ~new_n109_ & ~x71));
  ...
  assign new_n384_ = ~new_n391_ & (x67 | (x68 ? (~new_n390_ | x69) : new_n385_));
  assign new_n385_ = (new_n139_ | ~x11) & ~new_n389_ & (new_n386_ | ~x70);
  assign new_n386_ = ~new_n388_ & (x66 | ~x69 | (~new_n387_ & ~new_n382_ & ~new_n383_));
  assign new_n387_ = x27 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n388_ = x43 & x71;
  assign new_n389_ = x66 & ~x71 & ((x27 & ~x69 & x70) | (x59 & x69 & ~x70));
  assign new_n390_ = ~x70 & ((~x66 & (~new_n379_ | new_n374_)) | (x43 & x66 & ~x71));
  assign new_n391_ = ~x66 & x67 & ((~new_n392_ & ~x68) | (new_n141_ & x43 & x68));
  ...
  assign new_n396_ = ~new_n153_ & x60;
  ...
  assign new_n402_ = x69 & (~new_n403_ | (~new_n406_ & ~new_n153_));
  ...
  assign new_n407_ = ~new_n414_ & (x67 | (x68 ? (~new_n413_ | x69) : new_n408_));
  assign new_n408_ = (new_n139_ | ~x12) & ~new_n412_ & (new_n409_ | ~x70);
  assign new_n409_ = ~new_n411_ & (x66 | ~x69 | (~new_n410_ & ~new_n404_ & ~new_n405_));
  assign new_n410_ = x28 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n411_ = x44 & x71;
  assign new_n412_ = x66 & ~x71 & ((x28 & ~x69 & x70) | (x60 & x69 & ~x70));
  assign new_n413_ = ~x70 & ((~x66 & (new_n396_ | ~new_n397_)) | (x44 & x66 & ~x71));
  assign new_n414_ = ~x66 & x67 & ((~new_n415_ & ~x68) | (new_n141_ & x44 & x68));
  ...
  assign new_n419_ = ~new_n153_ & x61;
  ...
  assign new_n425_ = x69 & (~new_n426_ | (~new_n429_ & ~new_n153_));
  ...
  assign new_n430_ = ~new_n437_ & (x67 | (x68 ? (~new_n436_ | x69) : new_n431_));
  assign new_n431_ = (new_n139_ | ~x13) & ~new_n435_ & (new_n432_ | ~x70);
  assign new_n432_ = ~new_n434_ & (x66 | ~x69 | (~new_n433_ & ~new_n427_ & ~new_n428_));
  assign new_n433_ = x29 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n434_ = x45 & x71;
  assign new_n435_ = x66 & ~x71 & ((x29 & ~x69 & x70) | (x61 & x69 & ~x70));
  assign new_n436_ = ~x70 & ((~x66 & (new_n419_ | ~new_n420_)) | (x45 & x66 & ~x71));
  assign new_n437_ = ~x66 & x67 & ((~new_n438_ & ~x68) | (new_n141_ & x45 & x68));
  ...
  assign new_n442_ = (new_n153_ | ~x62) & (new_n443_ | ~x72) & (new_n444_ | x72);
  ...
  assign new_n448_ = ~new_n153_ & ((x71 & (x70 ? x62 : x30)) | (x30 & x70 & ~new_n109_ & ~x71));
  ...
  assign new_n453_ = x65 ? (x66 | x67) : (x66 ? x71 : ~x67);
  assign new_n454_ = (x67 | (x68 ? ~new_n459_ : new_n455_)) & (x66 | new_n460_ | ~x67);
  assign new_n455_ = ~new_n456_ & ~new_n458_ & (~x70 | (~new_n457_ & (~x46 | ~x71)));
  assign new_n456_ = ~new_n139_ & x14;
  assign new_n457_ = ~x66 & x69 & (new_n450_ | new_n451_ | (~new_n153_ & x30));
  assign new_n458_ = x66 & ~x71 & ((x30 & ~x69 & x70) | (x62 & x69 & ~x70));
  assign new_n459_ = ~x69 & ~x70 & ((~new_n442_ & ~x66) | (x46 & x66 & ~x71));
  assign new_n460_ = (~x46 | ~x68 | x69 | x70) & (x68 | ((new_n461_ | ~x69) & (~x30 | x69 | ~x70)));
  assign new_n461_ = x70 ? ~x14 : ~x62;
  assign z15 = x68 ? (~new_n475_ & ~x69) : ~new_n463_;
  assign new_n463_ = x64 ? (x65 | (~new_n464_ & ~new_n474_)) : (~x65 | new_n468_ | ~x69);
  assign new_n464_ = ~x67 & ((x70 & (new_n465_ | (x47 & x71))) | (x15 & ~x70 & x71));
  assign new_n465_ = ~x66 & x69 & (new_n466_ | new_n467_ | (~new_n153_ & x31));
  ...
  assign new_n470_ = ~new_n153_ & ((x71 & (x70 ? x63 : x31)) | (x31 & x70 & ~new_n109_ & ~x71));
  ...
  assign new_n477_ = (new_n153_ | ~x63) & (new_n472_ | ~x72) & (new_n473_ | x72);
  assign new_n478_ = ~x70 & ((x47 & (x66 ? (~x67 & ~x71) : x67)) | (~x66 & ~new_n477_ & ~x67));
