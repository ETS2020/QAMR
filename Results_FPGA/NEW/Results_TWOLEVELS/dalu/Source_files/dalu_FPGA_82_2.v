// Benchmark "FAU" written by ABC on Sat Aug  1 07:38:12 2020
...
module FAU ( 
  ...
  assign z09 = x64 ? (~x65 & (x66 ? new_n286_ : ~new_n283_)) : ~new_n268_;
  assign new_n268_ = (~new_n282_ | ~x65) & (new_n112_ | ((~new_n269_ | ~x68) & (~x65 | ~new_n276_ | x68)));
  ...
  assign new_n276_ = x69 & ((~new_n278_ & (x70 ^ x71)) | new_n281_ | (x70 & ~new_n277_ & x71));
  assign new_n277_ = x72 ? new_n274_ : new_n275_;
  ...
  assign new_n281_ = ~new_n126_ & ((x25 & ~x70) | (x57 & x70 & x71));
  assign new_n282_ = ~x66 & ~x67 & x68 & ~x69 & (new_n270_ | new_n271_);
  assign new_n283_ = x68 ? (~new_n284_ | x69) : (x67 ? new_n285_ : ~new_n276_);
  assign new_n284_ = ~x70 & ~x71 & (x67 ? x41 : (~new_n277_ | new_n273_));
  assign new_n285_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x57 | ~x69) & (~x41 | ~x70 | ~x71);
  assign new_n286_ = ~x67 & ((~new_n285_ & ~x68) | (new_n108_ & x41 & x68));
  assign z10 = x64 ? new_n311_ : (new_n309_ | (~new_n112_ & (new_n288_ | new_n300_)));
  assign new_n288_ = ~x70 & ((x68 & ~new_n289_ & ~x69) | (x65 & ~x68 & ~new_n295_ & x69));
  assign new_n289_ = x65 ? (new_n290_ | x71) : (~x71 | ((~x00 | new_n294_ | x10) & (~x10 | (~new_n294_ & x00))));
  ...
  assign new_n295_ = (new_n296_ | ~x71) & (x73 | ~x74 | ~x25 | x72);
  assign new_n296_ = ~new_n298_ & (~x72 | new_n297_ | x73) & (new_n299_ | ~x73);
  assign new_n297_ = x74 ? ~x21 : ~x22;
  assign new_n298_ = x26 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n299_ = (x72 | (x74 ? ~x23 : ~x24)) & (~x18 | ~x72 | x74);
  assign new_n300_ = x70 & (x65 ? (~x68 & ~new_n301_ & x69) : (x68 & new_n307_ & ~x69));
  assign new_n301_ = (new_n126_ | new_n306_) & (new_n304_ | x73) & (new_n302_ | ~x73);
  assign new_n302_ = (new_n303_ | x74) & (x72 | ~x74 | (x71 ? ~x55 : ~x23));
  assign new_n303_ = x71 ? (x72 ? ~x50 : ~x56) : (x72 ? ~x18 : ~x24);
  assign new_n304_ = (new_n305_ | ~x72) & (x72 | ~x74 | ~x57 | ~x71);
  assign new_n305_ = x71 ? (x74 ? ~x53 : ~x54) : (x74 ? ~x21 : ~x22);
  assign new_n306_ = x71 ? ~x58 : ~x26;
  ...
  assign new_n310_ = x70 ? ~new_n307_ : (~x71 | ((~x00 | new_n294_ | x10) & (~x10 | (~new_n294_ & x00))));
  ...
  assign new_n315_ = ~new_n194_ & (new_n298_ | (x72 & ~new_n297_ & ~x73) | (~new_n299_ & x73));
  assign new_n316_ = ~new_n317_ & (~x70 | ~x71 | (~new_n291_ & ~new_n292_ & ~new_n293_));
  assign new_n317_ = ~x72 & ~x73 & x74 & x25 & ~x70;
  assign new_n318_ = x68 & ~x69 & new_n319_ & ~x70;
  assign new_n319_ = ~x71 & (x67 ? x42 : (new_n291_ | new_n292_ | new_n293_));
  assign new_n320_ = ~x67 & ((~new_n313_ & ~x68) | (new_n108_ & x42 & x68));
  assign z11 = x64 ? (~new_n343_ & ~x65) : ((new_n341_ & x65) | (~new_n322_ & ~new_n112_));
  assign new_n322_ = x70 ? (x65 ? (~new_n333_ | x68) : (~new_n339_ | ~x68)) : new_n323_;
  assign new_n323_ = (~x68 | new_n324_ | x69) & (~x65 | x68 | new_n329_ | ~x69);
  ...
  assign new_n330_ = x74 & ((~x72 & (x73 ? x24 : x26)) | (x22 & x72 & ~x73));
  assign new_n331_ = x72 & ~x74 & (x73 ? x19 : x23);
  assign new_n332_ = x73 & ~x74 & x25 & ~x72;
  assign new_n333_ = x69 & (new_n334_ | (~new_n335_ & x74) | (~new_n337_ & ~x74));
  assign new_n334_ = ~new_n126_ & (x71 ? x59 : x27);
  assign new_n335_ = (new_n336_ | x73) & (x72 | ~x73 | (x71 ? ~x56 : ~x24));
  assign new_n336_ = x71 ? (x72 ? ~x54 : ~x58) : (x72 ? ~x22 : ~x26);
  assign new_n337_ = (new_n338_ | ~x72) & (x72 | ~x73 | ~x57 | ~x71);
  assign new_n338_ = x71 ? (x73 ? ~x51 : ~x55) : (x73 ? ~x19 : ~x23);
  assign new_n339_ = ~x69 & ~new_n340_ & ~x71;
  assign new_n340_ = (~x43 | (~new_n124_ & x32)) & (~x32 | new_n124_ | x43);
  assign new_n341_ = ~x66 & ~x67 & x68 & ~new_n342_ & ~x69;
  assign new_n342_ = x70 ? (new_n340_ | x71) : (new_n325_ | ~x71);
  assign new_n343_ = x66 ? ~new_n352_ : (x68 ? ~new_n350_ : new_n344_);
  assign new_n344_ = x67 ? new_n346_ : (~x69 | (new_n348_ & (new_n345_ | new_n194_)));
  assign new_n345_ = (new_n126_ | ~x27) & ~new_n330_ & ~new_n331_;
  assign new_n346_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n347_ | ~x70);
  assign new_n347_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n348_ = ~new_n349_ & (~x70 | ~x71 | (~new_n326_ & ~new_n327_ & ~new_n328_));
  assign new_n349_ = ~x72 & x73 & ~x74 & x25 & ~x70;
  assign new_n350_ = ~x69 & ~x70 & ~x71 & (x67 ? x43 : ~new_n351_);
  assign new_n351_ = ~new_n326_ & ~new_n327_ & ~new_n328_;
  assign new_n352_ = ~x67 & ((~new_n346_ & ~x68) | (new_n108_ & x43 & x68));
  ...
  assign new_n361_ = ~new_n364_ & (~x71 | (~new_n362_ & ~new_n363_ & (new_n126_ | ~x28)));
  assign new_n362_ = ~x72 & ((x26 & x73 & ~x74) | (x27 & ~x73 & x74));
  assign new_n363_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n364_ = x73 & x74 & x25 & ~x72;
  assign new_n365_ = x70 & (x65 ? (~x68 & ~new_n366_ & x69) : (x68 & new_n368_ & ~x69));
  assign new_n366_ = ~new_n367_ & (x71 | (~new_n362_ & ~new_n363_)) & (~x71 | (~new_n359_ & ~new_n360_));
  assign new_n367_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n368_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n369_ = x68 & ~x69 & (x70 ? new_n368_ : (~new_n357_ & x71));
  assign new_n370_ = x68 ? (~new_n374_ | x69) : (x67 ? new_n376_ : (new_n371_ | ~x69));
  assign new_n371_ = new_n372_ & (new_n194_ | (~new_n362_ & ~new_n363_ & (new_n126_ | ~x28)));
  assign new_n372_ = ~new_n373_ & (~x70 | ~x71 | (~new_n358_ & ~new_n359_ & ~new_n360_));
  assign new_n373_ = x25 & ~x70 & ~x72 & x73 & x74;
  assign new_n374_ = ~x70 & ~x71 & (x67 ? x44 : ~new_n375_);
  assign new_n375_ = ~new_n358_ & ~new_n359_ & ~new_n360_;
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n404_ : ~new_n396_)) : ~new_n380_;
  ...
  assign new_n387_ = ~new_n390_ & (~x71 | (~new_n388_ & ~new_n389_ & (new_n126_ | ~x29)));
  assign new_n388_ = x72 & ((x21 & x73 & ~x74) | (x24 & ~x73 & x74));
  assign new_n389_ = ~x72 & ((x73 & (x74 ? x26 : x27)) | (x28 & ~x73 & x74));
  assign new_n390_ = ~x73 & ~x74 & x25 & x72;
  assign new_n391_ = x70 & (x65 ? (~x68 & ~new_n392_ & x69) : (x68 & new_n394_ & ~x69));
  assign new_n392_ = ~new_n393_ & (x71 | (~new_n388_ & ~new_n389_)) & (~x71 | (~new_n385_ & ~new_n386_));
  assign new_n393_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n394_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n395_ = x68 & ~x69 & (x70 ? new_n394_ : (~new_n383_ & x71));
  assign new_n396_ = x68 ? (~new_n400_ | x69) : (x67 ? new_n402_ : (new_n397_ | ~x69));
  assign new_n397_ = new_n398_ & (new_n194_ | (~new_n388_ & ~new_n389_ & (new_n126_ | ~x29)));
  assign new_n398_ = ~new_n399_ & (~x70 | ~x71 | (~new_n384_ & ~new_n385_ & ~new_n386_));
  assign new_n399_ = x25 & ~x70 & x72 & ~x73 & ~x74;
  assign new_n400_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n401_);
  assign new_n401_ = ~new_n384_ & ~new_n385_ & ~new_n386_;
  ...
  assign new_n406_ = ~new_n423_ & (new_n112_ | (x70 ? (~new_n417_ & ~new_n426_) : new_n407_));
  ...
  assign new_n414_ = ~x74 & ((x72 & (x73 ? x22 : x26)) | (x28 & ~x72 & x73));
  assign new_n415_ = ~x72 & x74 & (x73 ? x27 : x29);
  assign new_n416_ = x25 & x72 & ~x73 & x74;
  assign new_n417_ = x65 & ~x68 & x69 & (new_n418_ | new_n419_ | new_n421_);
  assign new_n418_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n419_ = ~x74 & ((x72 & ~new_n306_ & ~x73) | (~new_n420_ & x73));
  assign new_n420_ = x71 ? (x72 ? ~x54 : ~x60) : (x72 ? ~x22 : ~x28);
  assign new_n421_ = x74 & ((~new_n422_ & ~x72) | (x72 & ~x73 & x57 & x71));
  assign new_n422_ = x71 ? (x73 ? ~x59 : ~x61) : (x73 ? ~x27 : ~x29);
  assign new_n423_ = x65 & ~x66 & ~x67 & x68 & ~new_n424_ & ~x69;
  assign new_n424_ = x70 ? ~new_n425_ : (new_n409_ | ~x71);
  assign new_n425_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n426_ = ~x65 & x68 & new_n425_ & ~x69;
  assign new_n427_ = x68 ? ~new_n432_ : (x67 ? new_n433_ : ~new_n428_);
  assign new_n428_ = x69 & ((~new_n430_ & (x70 ^ x71)) | new_n431_ | (x70 & ~new_n429_ & x71));
  assign new_n429_ = ~new_n410_ & ~new_n411_ & ~new_n412_;
  assign new_n430_ = (new_n126_ | ~x30) & ~new_n414_ & ~new_n415_;
  assign new_n431_ = x25 & ~x70 & x72 & ~x73 & x74;
  assign new_n432_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n429_);
  ...
  assign new_n447_ = x65 & x69 & ~new_n438_ & ~new_n112_;
  assign new_n448_ = x64 ? (~new_n450_ | x65) : ((new_n449_ | new_n112_) & (~new_n451_ | ~x65));
