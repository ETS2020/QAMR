// Benchmark "FAU" written by ABC on Sat Aug  1 07:44:40 2020
...
module FAU ( 
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n335_ : ~new_n331_)) : ~new_n315_;
  assign new_n315_ = (~new_n329_ | ~x65) & (new_n112_ | ((~new_n316_ | ~x68) & (~x65 | ~new_n323_ | x68)));
  assign new_n316_ = ~x69 & ((~new_n317_ & ~x70) | (~x65 & x70 & ~new_n322_ & ~x71));
  ...
  assign new_n322_ = (~x43 | (~new_n124_ & x32)) & (~x32 | new_n124_ | x43);
  assign new_n323_ = x69 & (new_n325_ | (x70 & (new_n328_ | (~new_n324_ & x71))));
  assign new_n324_ = ~new_n320_ & ~new_n321_;
  assign new_n325_ = ~new_n194_ & (x72 ? ~new_n326_ : ~new_n327_);
  assign new_n326_ = (x73 | (x74 ? ~x22 : ~x23)) & (~x19 | ~x73 | x74);
  assign new_n327_ = (~x73 | (x74 ? ~x24 : ~x25)) & (~x26 | x73 | ~x74);
  assign new_n328_ = ~new_n126_ & (x27 | (x59 & x71));
  assign new_n329_ = ~x66 & ~x67 & x68 & ~new_n330_ & ~x69;
  assign new_n330_ = x70 ? (x71 | ((~x43 | (~new_n124_ & x32)) & (~x32 | new_n124_ | x43))) : (new_n318_ | ~x71);
  assign new_n331_ = x68 ? (~new_n332_ | x69) : (x67 ? new_n333_ : ~new_n323_);
  assign new_n332_ = ~x70 & ~x71 & (x67 ? x43 : (~new_n324_ | new_n319_));
  assign new_n333_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n334_ | ~x70);
  assign new_n334_ = (~x43 | ~x71) & (~x27 | x69);
  assign new_n335_ = ~x67 & ((~new_n333_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n366_ : ~new_n359_)) : ~new_n337_;
  assign new_n337_ = ~new_n355_ & (new_n112_ | (x70 ? (~new_n347_ & ~new_n358_) : new_n338_));
  assign new_n338_ = (~x68 | new_n339_ | x69) & (~x65 | x68 | ~x69 | new_n344_ | ~x71);
  assign new_n339_ = x65 ? (x71 | (~new_n341_ & ~new_n342_ & ~new_n343_)) : (new_n340_ | ~x71);
  assign new_n340_ = (~x12 | (x00 & (x13 | x14 | x15))) & (~x00 | x12 | (~x13 & ~x14 & ~x15));
  ...
  assign new_n344_ = (~x28 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n346_ | ~x73) & (~x72 | new_n345_ | x73);
  assign new_n345_ = x74 ? ~x23 : ~x24;
  assign new_n346_ = (x72 | (x74 ? ~x25 : ~x26)) & (~x20 | ~x72 | x74);
  assign new_n347_ = x65 & ~x68 & x69 & (new_n348_ | new_n349_ | new_n352_);
  assign new_n348_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n349_ = ~x72 & (x73 ? ~new_n350_ : new_n351_);
  assign new_n350_ = x71 ? (x74 ? ~x57 : ~x58) : (x74 ? ~x25 : ~x26);
  assign new_n351_ = x74 & (x27 | (x59 & x71));
  assign new_n352_ = x72 & ((~new_n353_ & ~x74) | (~x73 & ~new_n354_ & x74));
  assign new_n353_ = x71 ? (x73 ? ~x52 : ~x56) : (x73 ? ~x20 : ~x24);
  assign new_n354_ = x71 ? ~x55 : ~x23;
  assign new_n355_ = x65 & ~x66 & ~x67 & x68 & ~new_n356_ & ~x69;
  assign new_n356_ = x70 ? ~new_n357_ : (new_n340_ | ~x71);
  assign new_n357_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n358_ = ~x65 & x68 & new_n357_ & ~x69;
  assign new_n359_ = x68 ? (x69 | x70 | new_n365_ | x71) : new_n360_;
  assign new_n360_ = x67 ? new_n361_ : (~x69 | (~new_n363_ & (new_n344_ | new_n194_)));
  assign new_n361_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n362_ | ~x70);
  assign new_n362_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n363_ = x70 & (new_n364_ | (x71 & (new_n341_ | new_n342_ | new_n343_)));
  assign new_n364_ = ~x73 & x74 & x27 & ~x72;
  assign new_n365_ = x67 ? ~x44 : (~new_n341_ & ~new_n342_ & ~new_n343_);
  assign new_n366_ = ~x67 & ((~new_n361_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n396_ : ~new_n389_)) : ~new_n368_;
  assign new_n368_ = (~new_n386_ | ~x65) & (new_n112_ | (x70 ? new_n378_ : new_n369_));
  ...
  assign new_n375_ = (~x29 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n376_ | ~x74) & (~x72 | new_n377_ | x74);
  assign new_n376_ = (x72 | (x73 ? ~x26 : ~x28)) & (~x24 | ~x72 | x73);
  assign new_n377_ = x73 ? ~x21 : ~x25;
  assign new_n378_ = x65 ? (x68 | ~x69 | (~new_n379_ & new_n380_)) : (~x68 | ~new_n385_ | x69);
  assign new_n379_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n380_ = x72 ? (~new_n384_ & (new_n383_ | x74)) : (~new_n382_ & (new_n381_ | ~x74));
  assign new_n381_ = x71 ? (x73 ? ~x58 : ~x60) : (x73 ? ~x26 : ~x28);
  assign new_n382_ = x73 & ~x74 & (x27 | (x59 & x71));
  assign new_n383_ = x71 ? (x73 ? ~x53 : ~x57) : (x73 ? ~x21 : ~x25);
  assign new_n384_ = ~x73 & x74 & (x71 ? x56 : x24);
  assign new_n385_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n386_ = ~x66 & ~x67 & x68 & ~x69 & (new_n387_ | new_n388_);
  assign new_n387_ = ~x70 & ~new_n371_ & x71;
  assign new_n388_ = new_n385_ & x70;
  assign new_n389_ = x68 ? (x69 | x70 | new_n395_ | x71) : new_n390_;
  assign new_n390_ = x67 ? new_n391_ : (~x69 | (~new_n393_ & (new_n375_ | new_n194_)));
  assign new_n391_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n392_ | ~x70);
  assign new_n392_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n393_ = x70 & (new_n394_ | (x71 & (new_n372_ | new_n373_ | new_n374_)));
  assign new_n394_ = x73 & ~x74 & x27 & ~x72;
  assign new_n395_ = x67 ? ~x45 : (~new_n372_ & ~new_n373_ & ~new_n374_);
  assign new_n396_ = ~x67 & ((~new_n391_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n427_ : ~new_n420_)) : ~new_n398_;
  assign new_n398_ = ~new_n416_ & (new_n112_ | (x70 ? (~new_n408_ & ~new_n419_) : new_n399_));
  assign new_n399_ = (~x68 | new_n400_ | x69) & (~x65 | x68 | ~x69 | new_n405_ | ~x71);
  ...
  assign new_n405_ = (new_n126_ | ~x30) & (new_n406_ | x72) & (new_n407_ | ~x72);
  assign new_n406_ = (~x29 | x73 | ~x74) & (~x28 | ~x73 | x74);
  assign new_n407_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n408_ = x65 & ~x68 & x69 & (new_n409_ | new_n410_ | new_n413_);
  assign new_n409_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n410_ = ~x72 & ((~new_n406_ & ~x71) | new_n412_ | (~new_n411_ & x71));
  assign new_n411_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n412_ = x27 & x73 & x74;
  assign new_n413_ = x72 & ((~new_n414_ & ~x74) | (~x73 & ~new_n415_ & x74));
  assign new_n414_ = x71 ? (x73 ? ~x54 : ~x58) : (x73 ? ~x22 : ~x26);
  assign new_n415_ = x71 ? ~x57 : ~x25;
  assign new_n416_ = x65 & ~x66 & ~x67 & x68 & ~new_n417_ & ~x69;
  assign new_n417_ = x70 ? ~new_n418_ : (new_n401_ | ~x71);
  assign new_n418_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n419_ = ~x65 & x68 & new_n418_ & ~x69;
  assign new_n420_ = x68 ? (~new_n424_ | x69) : (x67 ? new_n425_ : (new_n421_ | ~x69));
  assign new_n421_ = (new_n405_ | (~x70 ^ x71)) & (~x70 | (~new_n423_ & (new_n422_ | ~x71)));
  assign new_n422_ = ~new_n402_ & ~new_n403_ & ~new_n404_;
  assign new_n423_ = x73 & x74 & x27 & ~x72;
  assign new_n424_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n422_);
  assign new_n425_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n426_ | ~x70);
  assign new_n426_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n427_ = ~x67 & ((~new_n425_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n440_ | new_n444_)) : (new_n429_ | (new_n445_ & x65));
  assign new_n429_ = ~new_n112_ & (x65 ? (x68 ? new_n438_ : new_n430_) : new_n439_);
  assign new_n430_ = x69 & (new_n431_ | (x70 & (new_n437_ | (~new_n434_ & x71))));
  assign new_n431_ = ~new_n194_ & (new_n432_ | new_n433_ | (~new_n126_ & x31));
  assign new_n432_ = x72 & ((x23 & x73 & ~x74) | (x26 & ~x73 & x74));
  assign new_n433_ = ~x72 & ((x73 & (x74 ? x28 : x29)) | (x30 & ~x73 & x74));
  assign new_n434_ = (new_n126_ | ~x63) & (new_n435_ | ~x72) & (new_n436_ | x72);
  assign new_n435_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n436_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n437_ = ~x73 & ~x74 & x27 & x72;
  assign new_n438_ = ~x69 & ~x70 & ~new_n434_ & ~x71;
  assign new_n439_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n440_ = ~x66 & (x68 ? new_n441_ : (x67 ? ~new_n442_ : new_n430_));
  assign new_n441_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n434_);
  assign new_n442_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n443_ | ~x70);
  assign new_n443_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n444_ = x66 & ~x67 & ((~new_n442_ & ~x68) | (new_n108_ & x47 & x68));
