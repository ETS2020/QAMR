// Benchmark "FAU" written by ABC on Sat Aug  1 07:35:26 2020
...
module FAU ( 
  ...
  assign z10 = x64 ? new_n307_ : (new_n305_ | (~new_n112_ & (new_n288_ | new_n300_)));
  assign new_n288_ = ~x70 & ((x68 & ~new_n289_ & ~x69) | (x65 & ~x68 & ~new_n296_ & x69));
  assign new_n289_ = x65 ? (x71 | (new_n292_ & ~new_n295_)) : (new_n290_ | ~x71);
  ...
  assign new_n296_ = (new_n297_ | ~x71) & (new_n126_ | ~x26);
  ...
  assign new_n300_ = x70 & (new_n301_ | (x65 & ~x68 & new_n304_ & x69));
  assign new_n301_ = ~x71 & (x65 ? (~x68 & ~new_n297_ & x69) : (x68 & ~new_n302_ & ~x69));
  assign new_n302_ = (~x42 | (x32 & (~new_n303_ | x43 | x44))) & (~x32 | x42 | (new_n303_ & ~x43 & ~x44));
  assign new_n303_ = ~x45 & ~x46 & ~x47;
  assign new_n304_ = x71 & (~new_n292_ | new_n295_);
  assign new_n305_ = x65 & ~x66 & ~x67 & x68 & ~new_n306_ & ~x69;
  assign new_n306_ = x70 ? (new_n302_ | x71) : (new_n290_ | ~x71);
  assign new_n307_ = ~x65 & (x66 ? new_n315_ : (new_n308_ | new_n313_));
  assign new_n308_ = ~x68 & (x67 ? ~new_n312_ : (x69 & (new_n309_ | ~new_n310_)));
  assign new_n309_ = ~new_n194_ & (x72 ? ~new_n298_ : ~new_n299_);
  assign new_n310_ = (new_n126_ | new_n311_) & (~x70 | ~x71 | (~new_n293_ & ~new_n294_));
  assign new_n311_ = (~x58 | ~x70 | ~x71) & (~x26 | x70);
  assign new_n312_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x58 | ~x69) & (~x42 | ~x70 | ~x71);
  assign new_n313_ = x68 & ~x69 & new_n314_ & ~x70;
  assign new_n314_ = ~x71 & (x67 ? x42 : (new_n295_ | new_n293_ | new_n294_));
  assign new_n315_ = ~x67 & ((~new_n312_ & ~x68) | (new_n108_ & x42 & x68));
  assign z11 = x64 ? (~new_n338_ & ~x65) : ((new_n336_ & x65) | (~new_n317_ & ~new_n112_));
  assign new_n317_ = x70 ? (x65 ? (~new_n328_ | x68) : (~new_n334_ | ~x68)) : new_n318_;
  assign new_n318_ = (~x68 | new_n319_ | x69) & (~x65 | x68 | new_n324_ | ~x69);
  ...
  assign new_n324_ = ~new_n327_ & (~x71 | (~new_n325_ & ~new_n326_ & (new_n126_ | ~x27)));
  assign new_n325_ = x73 & ((~x72 & (x74 ? x24 : x25)) | (x19 & x72 & ~x74));
  assign new_n326_ = x72 & ~x73 & (x74 ? x22 : x23);
  assign new_n327_ = ~x73 & x74 & x26 & ~x72;
  assign new_n328_ = x69 & (new_n329_ | (~new_n330_ & x73) | (~new_n332_ & ~x73));
  assign new_n329_ = ~new_n126_ & (x71 ? x59 : x27);
  assign new_n330_ = (new_n331_ | x74) & (x72 | ~x74 | (x71 ? ~x56 : ~x24));
  assign new_n331_ = x71 ? (x72 ? ~x51 : ~x57) : (x72 ? ~x19 : ~x25);
  assign new_n332_ = (~x72 | (x71 ? new_n333_ : new_n278_)) & (~x58 | ~x71 | x72 | ~x74);
  ...
  assign new_n337_ = x70 ? (new_n335_ | x71) : (new_n320_ | ~x71);
  assign new_n338_ = x66 ? ~new_n347_ : (x68 ? ~new_n345_ : new_n339_);
  assign new_n339_ = x67 ? new_n341_ : (~x69 | (new_n343_ & (new_n340_ | new_n194_)));
  assign new_n340_ = (new_n126_ | ~x27) & ~new_n325_ & ~new_n326_;
  assign new_n341_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n342_ | ~x70);
  assign new_n342_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n343_ = ~new_n344_ & (~x70 | ~x71 | (~new_n321_ & ~new_n322_ & ~new_n323_));
  assign new_n344_ = ~x72 & ~x73 & x74 & x26 & ~x70;
  assign new_n345_ = ~x69 & ~x70 & ~x71 & (x67 ? x43 : ~new_n346_);
  assign new_n346_ = ~new_n321_ & ~new_n322_ & ~new_n323_;
  assign new_n347_ = ~x67 & ((~new_n341_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~new_n370_ & ~x65) : ((new_n368_ & x65) | (~new_n349_ & ~new_n112_));
  assign new_n349_ = x70 ? (x65 ? (~new_n360_ | x68) : (~new_n366_ | ~x68)) : new_n350_;
  assign new_n350_ = (~x68 | new_n351_ | x69) & (~x65 | x68 | new_n356_ | ~x69);
  ...
  assign new_n356_ = ~new_n359_ & (~x71 | (~new_n357_ & ~new_n358_ & (new_n126_ | ~x28)));
  assign new_n357_ = x74 & ((~x72 & (x73 ? x25 : x27)) | (x23 & x72 & ~x73));
  assign new_n358_ = x72 & ~x74 & (x73 ? x20 : x24);
  assign new_n359_ = x73 & ~x74 & x26 & ~x72;
  assign new_n360_ = x69 & (new_n361_ | (~new_n362_ & x74) | (~new_n364_ & ~x74));
  assign new_n361_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n362_ = (new_n363_ | x73) & (x72 | ~x73 | (x71 ? ~x57 : ~x25));
  assign new_n363_ = x71 ? (x72 ? ~x55 : ~x59) : (x72 ? ~x23 : ~x27);
  assign new_n364_ = (new_n365_ | ~x72) & (x72 | ~x73 | ~x58 | ~x71);
  assign new_n365_ = x71 ? (x73 ? ~x52 : ~x56) : (x73 ? ~x20 : ~x24);
  assign new_n366_ = ~x69 & ~new_n367_ & ~x71;
  assign new_n367_ = (~x44 | (~new_n303_ & x32)) & (~x32 | new_n303_ | x44);
  assign new_n368_ = ~x66 & ~x67 & x68 & ~new_n369_ & ~x69;
  assign new_n369_ = x70 ? (new_n367_ | x71) : (new_n352_ | ~x71);
  assign new_n370_ = x66 ? ~new_n379_ : (x68 ? ~new_n377_ : new_n371_);
  assign new_n371_ = x67 ? new_n373_ : (~x69 | (new_n375_ & (new_n372_ | new_n194_)));
  assign new_n372_ = (new_n126_ | ~x28) & ~new_n357_ & ~new_n358_;
  assign new_n373_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n374_ | ~x70);
  assign new_n374_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n375_ = ~new_n376_ & (~x70 | ~x71 | (~new_n353_ & ~new_n354_ & ~new_n355_));
  assign new_n376_ = ~x72 & x73 & ~x74 & x26 & ~x70;
  assign new_n377_ = ~x69 & ~x70 & ~x71 & (x67 ? x44 : ~new_n378_);
  assign new_n378_ = ~new_n353_ & ~new_n354_ & ~new_n355_;
  assign new_n379_ = ~x67 & ((~new_n373_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n405_ : ~new_n397_)) : ~new_n381_;
  ...
  assign new_n388_ = ~new_n391_ & (~x71 | (~new_n389_ & ~new_n390_ & (new_n126_ | ~x29)));
  assign new_n389_ = ~x72 & ((x27 & x73 & ~x74) | (x28 & ~x73 & x74));
  assign new_n390_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n391_ = x73 & x74 & x26 & ~x72;
  assign new_n392_ = x70 & (x65 ? (~x68 & ~new_n393_ & x69) : (x68 & new_n395_ & ~x69));
  assign new_n393_ = ~new_n394_ & (x71 | (~new_n389_ & ~new_n390_)) & (~x71 | (~new_n386_ & ~new_n387_));
  assign new_n394_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n395_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n396_ = x68 & ~x69 & (x70 ? new_n395_ : (~new_n384_ & x71));
  assign new_n397_ = x68 ? (~new_n401_ | x69) : (x67 ? new_n403_ : (new_n398_ | ~x69));
  assign new_n398_ = new_n399_ & (new_n194_ | (~new_n389_ & ~new_n390_ & (new_n126_ | ~x29)));
  assign new_n399_ = ~new_n400_ & (~x70 | ~x71 | (~new_n385_ & ~new_n386_ & ~new_n387_));
  assign new_n400_ = x26 & ~x70 & ~x72 & x73 & x74;
  assign new_n401_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n402_);
  assign new_n402_ = ~new_n385_ & ~new_n386_ & ~new_n387_;
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n430_ : ~new_n424_)) : ~new_n407_;
  assign new_n407_ = ~new_n422_ & (new_n112_ | (x70 ? new_n418_ : (~new_n408_ & ~new_n413_)));
  assign new_n408_ = x68 & ~x69 & (x65 ? (~new_n409_ & ~x71) : (~new_n412_ & x71));
  assign new_n409_ = (new_n126_ | ~x62) & ~new_n410_ & ~new_n411_;
  assign new_n410_ = x72 & ((~x73 & (x74 ? x57 : x58)) | (x54 & x73 & ~x74));
  assign new_n411_ = ~x72 & ((x73 & (x74 ? x59 : x60)) | (x61 & ~x73 & x74));
  assign new_n412_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n413_ = x65 & ~x68 & x69 & (new_n417_ | (~new_n414_ & x71));
  assign new_n414_ = (new_n126_ | ~x30) & ~new_n415_ & ~new_n416_;
  assign new_n415_ = x72 & ((x22 & x73 & ~x74) | (x25 & ~x73 & x74));
  assign new_n416_ = ~x72 & ((x73 & (x74 ? x27 : x28)) | (x29 & ~x73 & x74));
  assign new_n417_ = ~x73 & ~x74 & x26 & x72;
  assign new_n418_ = x65 ? (x68 | new_n419_ | ~x69) : (~x68 | ~new_n421_ | x69);
  assign new_n419_ = ~new_n420_ & (x71 | (~new_n415_ & ~new_n416_)) & (~x71 | (~new_n410_ & ~new_n411_));
  ...
  assign new_n423_ = x70 ? ~new_n421_ : (new_n412_ | ~x71);
  assign new_n424_ = x68 ? (~new_n427_ | x69) : (x67 ? new_n428_ : (new_n425_ | ~x69));
  assign new_n425_ = (new_n414_ | (~x70 ^ x71)) & (~x70 | new_n409_ | ~x71) & (~new_n426_ | ~x26 | x70);
  assign new_n426_ = x72 & ~x73 & ~x74;
  assign new_n427_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n409_);
  ...
  assign new_n433_ = x69 & ((~new_n434_ & (x70 ^ x71)) | new_n440_ | (x70 & ~new_n437_ & x71));
  assign new_n434_ = (~x31 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n435_ | x74) & (x72 | new_n436_ | ~x74);
  assign new_n435_ = (~x72 | (x73 ? ~x23 : ~x27)) & (~x29 | x72 | ~x73);
  assign new_n436_ = x73 ? ~x28 : ~x30;
  ...
  assign new_n440_ = x26 & ~x70 & x72 & ~x73 & x74;
