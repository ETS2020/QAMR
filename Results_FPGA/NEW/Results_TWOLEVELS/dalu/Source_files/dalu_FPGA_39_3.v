// Benchmark "FAU" written by ABC on Sat Aug  1 07:36:29 2020
...
module FAU ( 
  ...
  assign z07 = x64 ? (~x65 & (new_n242_ | new_n247_)) : (new_n228_ | (new_n241_ & x65));
  assign new_n228_ = ~new_n112_ & (x65 ? (x68 ? new_n236_ : new_n229_) : new_n238_);
  ...
  assign new_n236_ = ~x69 & ~x70 & (new_n237_ | (~new_n233_ & ~x71));
  assign new_n237_ = x55 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n242_ = ~x66 & (x68 ? new_n243_ : (x67 ? ~new_n245_ : new_n229_));
  assign new_n243_ = ~x69 & ~new_n244_ & ~x70;
  assign new_n244_ = (~x39 | ~x67 | x71) & (x67 | (~new_n237_ & (x71 | (~new_n234_ & ~new_n235_))));
  assign new_n245_ = (~x07 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n246_ | ~x70) & (~x55 | ~x69 | x70);
  assign new_n246_ = (~x39 | ~x71) & (~x23 | x69 | x71);
  assign new_n247_ = x66 & ~x67 & ((~new_n245_ & ~x68) | (new_n108_ & x39 & x68));
  assign z08 = x64 ? (~x65 & (new_n265_ | new_n269_)) : (new_n249_ | (new_n263_ & x65));
  assign new_n249_ = ~new_n112_ & ((x68 & ~new_n250_ & ~x69) | (x65 & new_n258_ & ~x68));
  assign new_n250_ = x65 ? (new_n253_ | x70) : (x70 ? (new_n252_ | x71) : (new_n251_ | ~x71));
  ...
  assign new_n253_ = ~new_n257_ & (x71 | (~new_n255_ & ~new_n256_ & (~new_n254_ | ~x72)));
  assign new_n254_ = ~x73 & (x74 ? x51 : x52);
  assign new_n255_ = x56 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n256_ = x73 & ((~x72 & (x74 ? x53 : x54)) | (x48 & x72 & ~x74));
  assign new_n257_ = ~x73 & x74 & x55 & ~x72;
  assign new_n258_ = x69 & ((~new_n260_ & (x70 ^ x71)) | (x70 & ~new_n259_ & x71));
  assign new_n259_ = ~new_n255_ & ~new_n256_ & (~new_n254_ | ~x72);
  assign new_n260_ = (new_n126_ | ~x24) & (new_n261_ | ~x72) & (new_n262_ | x72);
  ...
  assign new_n264_ = x70 ? (new_n252_ | x71) : (new_n251_ | ~x71);
  assign new_n265_ = ~x66 & (x68 ? new_n266_ : (x67 ? ~new_n267_ : new_n258_));
  assign new_n266_ = ~x69 & ~x70 & ((~new_n253_ & ~x67) | (x40 & x67 & ~x71));
  assign new_n267_ = (~x08 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x56 | ~x69) & (new_n268_ | ~x70);
  assign new_n268_ = (~x40 | ~x71) & (~x24 | x69 | x71);
  assign new_n269_ = x66 & ~x67 & ((~new_n267_ & ~x68) | (new_n108_ & x40 & x68));
  assign z09 = x64 ? (~x65 & (x66 ? new_n290_ : ~new_n286_)) : ~new_n271_;
  assign new_n271_ = (~new_n285_ | ~x65) & (new_n112_ | ((~new_n272_ | ~x68) & (~x65 | ~new_n280_ | x68)));
  assign new_n272_ = ~x69 & (x65 ? (~new_n275_ & ~x70) : (new_n273_ | new_n274_));
  assign new_n273_ = ~x70 & x71 & ((x09 & (new_n158_ | ~x00)) | (x00 & ~new_n158_ & ~x09));
  assign new_n274_ = x70 & ~x71 & ((x41 & (new_n161_ | ~x32)) | (x32 & ~new_n161_ & ~x41));
  assign new_n275_ = ~new_n279_ & (x71 | (~new_n276_ & ~new_n277_ & ~new_n278_));
  assign new_n276_ = x57 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n277_ = x74 & ((~x72 & (x73 ? x54 : x56)) | (x52 & x72 & ~x73));
  assign new_n278_ = x72 & ~x74 & (x73 ? x49 : x53);
  assign new_n279_ = x73 & ~x74 & x55 & ~x72;
  assign new_n280_ = x69 & ((~new_n282_ & (x70 ^ x71)) | (x70 & ~new_n281_ & x71));
  assign new_n281_ = ~new_n276_ & ~new_n277_ & ~new_n278_;
  assign new_n282_ = (new_n126_ | ~x25) & (new_n283_ | ~x72) & (new_n284_ | x72);
  assign new_n283_ = (x73 | (x74 ? ~x20 : ~x21)) & (~x17 | ~x73 | x74);
  assign new_n284_ = (~x73 | (x74 ? ~x22 : ~x23)) & (~x24 | x73 | ~x74);
  assign new_n285_ = ~x66 & ~x67 & x68 & ~x69 & (new_n273_ | new_n274_);
  assign new_n286_ = x68 ? ~new_n287_ : (x67 ? new_n288_ : ~new_n280_);
  assign new_n287_ = ~x69 & ~x70 & ((~new_n275_ & ~x67) | (x41 & x67 & ~x71));
  assign new_n288_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x57 | ~x69) & (new_n289_ | ~x70);
  assign new_n289_ = (~x41 | ~x71) & (~x25 | x69 | x71);
  assign new_n290_ = ~x67 & ((~new_n288_ & ~x68) | (new_n108_ & x41 & x68));
  assign z10 = x64 ? (~x65 & (x66 ? new_n320_ : ~new_n313_)) : ~new_n292_;
  assign new_n292_ = (~new_n310_ | ~x65) & (new_n112_ | (x70 ? new_n305_ : new_n293_));
  assign new_n293_ = (~x68 | x69 | (x65 ? new_n296_ : ~new_n294_)) & (~x65 | x68 | ~new_n301_ | ~x69);
  assign new_n294_ = x71 & ((x10 & (new_n295_ | ~x00)) | (x00 & ~new_n295_ & ~x10));
  assign new_n295_ = ~x11 & ~x12 & ~x13 & ~x14 & ~x15;
  assign new_n296_ = ~new_n300_ & (x71 | (~new_n297_ & ~new_n298_ & ~new_n299_));
  assign new_n297_ = x58 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n298_ = ~x72 & ((x56 & x73 & ~x74) | (x57 & ~x73 & x74));
  assign new_n299_ = x72 & ((~x73 & (x74 ? x53 : x54)) | (x50 & x73 & ~x74));
  assign new_n300_ = x73 & x74 & x55 & ~x72;
  ...
  assign new_n306_ = ~new_n307_ & (x71 | (~new_n303_ & ~new_n304_)) & (~x71 | (~new_n298_ & ~new_n299_));
  ...
  assign new_n311_ = ~x70 & x71 & ((x10 & (new_n295_ | ~x00)) | (x00 & ~new_n295_ & ~x10));
  ...
  assign new_n314_ = ((new_n316_ & ~new_n302_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n315_ & ~new_n297_));
  assign new_n315_ = ~new_n298_ & ~new_n299_;
  assign new_n316_ = ~new_n303_ & ~new_n304_;
  assign new_n317_ = ~x70 & ((~new_n296_ & ~x67) | (x42 & x67 & ~x71));
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n347_ : ~new_n340_)) : ~new_n322_;
  assign new_n322_ = ~new_n338_ & (new_n112_ | (x70 ? new_n334_ : new_n323_));
  assign new_n323_ = (~x68 | x69 | (x65 ? new_n325_ : ~new_n324_)) & (~x65 | x68 | ~new_n330_ | ~x69);
  assign new_n324_ = x71 & ((x11 & (new_n119_ | ~x00)) | (x00 & ~new_n119_ & ~x11));
  assign new_n325_ = ~new_n329_ & (x71 | (~new_n326_ & ~new_n327_ & ~new_n328_));
  assign new_n326_ = x59 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n327_ = x72 & ((x51 & x73 & ~x74) | (x54 & ~x73 & x74));
  assign new_n328_ = ~x72 & ((x73 & (x74 ? x56 : x57)) | (x58 & ~x73 & x74));
  assign new_n329_ = ~x73 & ~x74 & x55 & x72;
  ...
  assign new_n334_ = x65 ? (x68 | new_n335_ | ~x69) : (~x68 | x69 | new_n337_ | x71);
  assign new_n335_ = ~new_n336_ & (x71 | (~new_n332_ & ~new_n333_)) & (~x71 | (~new_n327_ & ~new_n328_));
  assign new_n336_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x59 : x27);
  assign new_n337_ = (~x43 | (x32 & (x46 | x47 | x44 | x45))) & (~x32 | x43 | (~x46 & ~x47 & ~x44 & ~x45));
  assign new_n338_ = x65 & ~x66 & ~x67 & x68 & ~new_n339_ & ~x69;
  assign new_n339_ = x70 ? (new_n337_ | x71) : (~x71 | ((~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11)));
  assign new_n340_ = x68 ? (~new_n344_ | x69) : (x67 ? new_n345_ : (new_n341_ | ~x69));
  assign new_n341_ = ((new_n343_ & ~new_n331_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n342_ & ~new_n326_));
  assign new_n342_ = ~new_n327_ & ~new_n328_;
  assign new_n343_ = ~new_n332_ & ~new_n333_;
  assign new_n344_ = ~x70 & ((~new_n325_ & ~x67) | (x43 & x67 & ~x71));
  assign new_n345_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n346_ | ~x70);
  assign new_n346_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n347_ = ~x67 & ((~new_n345_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n378_ : ~new_n371_)) : ~new_n349_;
  assign new_n349_ = ~new_n367_ & (new_n112_ | (x70 ? (~new_n360_ & ~new_n370_) : new_n350_));
  assign new_n350_ = (~x68 | x69 | (x65 ? new_n353_ : ~new_n351_)) & (~x65 | x68 | ~new_n357_ | ~x69);
  assign new_n351_ = x71 & ((x12 & (new_n352_ | ~x00)) | (x00 & ~new_n352_ & ~x12));
  assign new_n352_ = ~x13 & ~x14 & ~x15;
  assign new_n353_ = ~new_n356_ & (x71 | (~new_n354_ & ~new_n355_ & (new_n126_ | ~x60)));
  assign new_n354_ = ~x74 & ((x72 & (x73 ? x52 : x56)) | (x58 & ~x72 & x73));
  assign new_n355_ = ~x72 & x74 & (x73 ? x57 : x59);
  assign new_n356_ = x55 & x72 & ~x73 & x74;
  assign new_n357_ = x71 & ((~new_n126_ & x28) | (~new_n359_ & ~x72) | (~new_n358_ & x72));
  assign new_n358_ = (x73 | (x74 ? ~x23 : ~x24)) & (~x20 | ~x73 | x74);
  assign new_n359_ = (~x73 | (x74 ? ~x25 : ~x26)) & (~x27 | x73 | ~x74);
  assign new_n360_ = x65 & ~x68 & x69 & (new_n361_ | new_n362_ | new_n365_);
  assign new_n361_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n362_ = ~x74 & ((~new_n363_ & x73) | (x72 & ~new_n364_ & ~x73));
  assign new_n363_ = x71 ? (x72 ? ~x52 : ~x58) : (x72 ? ~x20 : ~x26);
  assign new_n364_ = x71 ? ~x56 : ~x24;
  assign new_n365_ = x74 & ((~new_n366_ & ~x72) | (x23 & ~x71 & x72 & ~x73));
  assign new_n366_ = x71 ? (x73 ? ~x57 : ~x59) : (x73 ? ~x25 : ~x27);
  assign new_n367_ = x65 & ~x66 & ~x67 & x68 & ~new_n368_ & ~x69;
  assign new_n368_ = x70 ? ~new_n369_ : (~x71 | ((~x12 | (~new_n352_ & x00)) & (~x00 | new_n352_ | x12)));
  assign new_n369_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n370_ = ~x65 & x68 & new_n369_ & ~x69;
  assign new_n371_ = x68 ? ~new_n375_ : (x67 ? new_n376_ : ~new_n372_);
  assign new_n372_ = x69 & ((~new_n374_ & (x70 ^ x71)) | (x70 & ~new_n373_ & x71));
  assign new_n373_ = (new_n126_ | ~x60) & ~new_n354_ & ~new_n355_;
  assign new_n374_ = (new_n126_ | ~x28) & (new_n358_ | ~x72) & (new_n359_ | x72);
  assign new_n375_ = ~x69 & ~x70 & ((~new_n353_ & ~x67) | (x44 & x67 & ~x71));
  ...
  assign new_n403_ = ~x67 & ((~new_n401_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n426_ : ~new_n421_)) : ~new_n405_;
  assign new_n405_ = ~new_n419_ & (new_n112_ | (x70 ? new_n415_ : (~new_n406_ & ~new_n411_)));
  assign new_n406_ = x68 & ~x69 & (x65 ? (~new_n407_ & ~x71) : (~new_n410_ & x71));
  assign new_n407_ = (new_n126_ | ~x62) & (new_n408_ | ~x72) & (new_n409_ | x72);
  ...
  assign new_n412_ = (new_n126_ | ~x30) & (new_n413_ | ~x72) & (new_n414_ | x72);
  ...
  assign new_n416_ = ~new_n126_ & (x71 ? x62 : x30);
  ...
  assign new_n426_ = ~x67 & ((~new_n424_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n440_ | new_n445_)) : (new_n428_ | (new_n446_ & x65));
  assign new_n428_ = ~new_n112_ & (x65 ? (x68 ? new_n437_ : new_n429_) : new_n439_);
  assign new_n429_ = x69 & ((~new_n430_ & (x70 ^ x71)) | (x70 & ~new_n433_ & x71));
  assign new_n430_ = (new_n126_ | ~x31) & (new_n431_ | ~x72) & (new_n432_ | x72);
  ...
  assign new_n434_ = x63 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n435_ = ~x73 & ((x72 & (x74 ? x58 : x59)) | (x62 & ~x72 & x74));
  assign new_n436_ = ~x72 & x73 & (x74 ? x60 : x61);
  assign new_n437_ = ~x69 & ~x70 & (new_n438_ | (~new_n433_ & ~x71));
  assign new_n438_ = x55 & x72 & x73 & ~x74;
  assign new_n439_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n440_ = ~x66 & (x68 ? new_n441_ : (x67 ? ~new_n443_ : new_n429_));
  assign new_n441_ = ~x69 & ~x70 & (new_n442_ | (x47 & x67 & ~x71));
  assign new_n442_ = ~x67 & (new_n438_ | (~x71 & (new_n434_ | new_n435_ | new_n436_)));
  assign new_n443_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n444_ | ~x70);
  assign new_n444_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n445_ = x66 & ~x67 & ((~new_n443_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n446_ = ~x66 & new_n439_ & ~x67;
endmodule
