...
module FAU ( 
  ...
  assign z12 = (~x65 & (new_n359_ | (new_n368_ & x64))) | (~x64 & ~new_n375_ & x65);
  assign new_n359_ = ~x69 & ((~new_n360_ & x68) | (x28 & x64 & new_n367_ & ~x68));
  assign new_n360_ = x64 ? (x70 | new_n364_ | x71) : ~new_n361_;
  assign new_n361_ = ~new_n99_ & (x70 ? new_n363_ : new_n362_);
  assign new_n362_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  assign new_n363_ = ~x71 & (~x32 | (~x45 & ~x46 & ~x47));
  assign new_n364_ = x67 ? x66 : ((new_n161_ | ~x60) & ~new_n365_ & ~new_n366_ & ~x66);
  assign new_n365_ = x72 & ((~x73 & (x74 ? x55 : x56)) | (x52 & x73 & ~x74));
  assign new_n366_ = ~x72 & ((x59 & ~x73 & x74) | (x73 & (x74 ? x57 : x58)));
  assign new_n367_ = x70 & ~x71 & (x66 ^ x67);
  assign new_n368_ = ~x68 & (x66 ? (~new_n374_ & ~x67) : (x67 ? ~new_n374_ : (~new_n369_ & x69)));
  assign new_n369_ = (~x70 | new_n373_ | ~x71) & ((~x70 ^ x71) | (new_n370_ & (new_n161_ | ~x28)));
  ...
  assign new_n373_ = ~new_n365_ & ~new_n366_ & (new_n161_ | ~x60);
  assign new_n374_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x44 | ~x70 | ~x71) & (x70 | x71 | ~x60 | ~x69);
  assign new_n375_ = x70 ? new_n378_ : (x68 ? (new_n376_ | x69) : (~new_n377_ | ~x69));
  assign new_n376_ = (x66 | ~new_n362_ | x67) & (x71 | new_n373_ | (~x66 & ~x67));
  assign new_n377_ = x71 & ~new_n99_ & (~new_n370_ | (~new_n161_ & x28));
  assign new_n378_ = (x68 | ~x69 | new_n379_ | (~x66 & ~x67)) & (x66 | x67 | ~x68 | ~new_n363_ | x69);
  assign new_n379_ = ~new_n380_ & (x71 | (~new_n371_ & ~new_n372_)) & (~x71 | (~new_n365_ & ~new_n366_));
  assign new_n380_ = (x71 ? x60 : x28) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n405_ = ~x67 & ((~new_n403_ & ~x68) | (new_n106_ & x45 & x68));
