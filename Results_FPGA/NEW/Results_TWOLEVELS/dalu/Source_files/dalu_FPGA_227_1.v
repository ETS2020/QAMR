// Benchmark "FAU" written by ABC on Sat Aug  1 07:43:43 2020
...
module FAU ( 
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n428_ : ~new_n409_)) : ~new_n391_;
  assign new_n391_ = ~new_n407_ & (new_n112_ | (new_n401_ & (new_n392_ | x70)));
  assign new_n392_ = (~x68 | new_n393_ | x69) & (~x65 | x68 | ~x69 | new_n398_ | ~x71);
  assign new_n393_ = x65 ? (x71 | (~new_n395_ & ~new_n396_ & ~new_n397_)) : ~new_n394_;
  assign new_n394_ = x71 & ((x14 & (~x00 | ~x15)) | (x00 & ~x14 & x15));
  assign new_n395_ = x62 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n396_ = x72 & ((~x73 & (x74 ? x57 : x58)) | (x54 & x73 & ~x74));
  assign new_n397_ = ~x72 & ((x73 & (x74 ? x59 : x60)) | (x61 & ~x73 & x74));
  assign new_n398_ = ~new_n399_ & ~new_n400_ & (~x27 | ~x73 | ~x74) & (~x26 | x73 | x74);
  assign new_n399_ = x72 & ((x25 & x74) | (x73 & (x22 | x74)));
  assign new_n400_ = ~x72 & ((x28 & ~x74) | (~x73 & (x29 | ~x74)));
  assign new_n401_ = x65 ? (x68 | ~x69 | (~new_n402_ & ~new_n403_)) : (~x68 | ~new_n406_ | x69);
  assign new_n402_ = ~new_n126_ & ((x62 & x71) | (x30 & x70 & ~x71));
  assign new_n403_ = x70 & (x71 ? (new_n396_ | new_n397_) : (new_n404_ | new_n405_));
  assign new_n404_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n405_ = ~x72 & ((x73 & (x74 ? x27 : x28)) | (x29 & ~x73 & x74));
  assign new_n406_ = x70 & ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n407_ = x65 & ~x66 & ~x67 & x68 & ~new_n408_ & ~x69;
  assign new_n408_ = ~new_n406_ & (~new_n394_ | x70);
  assign new_n409_ = x68 ? (~new_n424_ | x69) : (x67 ? new_n426_ : (new_n410_ | ~x69));
  assign new_n410_ = (new_n411_ | ~x72) & ~new_n416_ & ~new_n423_ & (new_n419_ | x72);
  assign new_n411_ = ~new_n414_ & ~new_n415_ & (~x73 | (~new_n412_ & new_n413_));
  assign new_n412_ = x22 & (x70 ? (~x71 & ~x74) : x71);
  assign new_n413_ = (~x70 | ((~x30 | x71 | ~x74) & (~x54 | ~x71 | x74))) & (~x71 | ~x74 | (~x62 & x70));
  assign new_n414_ = x74 & ((x25 & (x70 ? (~x71 & ~x73) : x71)) | (x71 & ~x73 & x57 & x70));
  assign new_n415_ = x70 & ~x73 & ~x74 & (x71 ? x58 : x26);
  assign new_n416_ = x73 & ((~new_n418_ & x74) | (x70 & ~x72 & ~new_n417_ & ~x74));
  assign new_n417_ = x71 ? ~x60 : ~x28;
  assign new_n418_ = (~x27 | (x70 ? (x71 | x72) : ~x71)) & (~x71 | x72 | ~x59 | ~x70);
  assign new_n419_ = ~new_n422_ & (x73 | (~new_n420_ & new_n421_));
  assign new_n420_ = x29 & (x70 ? (~x71 & x74) : x71);
  assign new_n421_ = (~x70 | ((~x61 | ~x71 | ~x74) & (~x30 | x71 | x74))) & (~x71 | x74 | (~x62 & x70));
  assign new_n422_ = x71 & ~x74 & x28 & ~x70;
  assign new_n423_ = x26 & ~x70 & x71 & ~x73 & ~x74;
  assign new_n424_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n425_);
  assign new_n425_ = ~new_n395_ & ~new_n396_ & ~new_n397_;
  assign new_n426_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n427_ | ~x70);
  assign new_n427_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n428_ = ~x67 & ((~new_n426_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n447_ | new_n451_)) : (new_n430_ | (new_n452_ & x65));
  assign new_n430_ = ~new_n112_ & (x65 ? (x68 ? new_n442_ : new_n431_) : new_n446_);
  assign new_n431_ = x69 & (new_n432_ | ~new_n438_ | (~x73 & (new_n434_ | ~new_n436_)));
  assign new_n432_ = ~new_n194_ & ((~new_n433_ & x72) | (x29 & ~x72 & x73 & ~x74));
  assign new_n433_ = (~x27 | x73 | x74) & (~x73 | (x74 ? ~x31 : ~x23));
  assign new_n434_ = x74 & (~new_n435_ | (x26 & (x70 ? (~x71 & x72) : x71)));
  assign new_n435_ = (~x70 | ((~x58 | ~x71 | ~x72) & (~x30 | x71 | x72))) & (~x71 | x72 | (~x62 & x70));
  assign new_n436_ = (new_n437_ | x72) & (~x59 | ~x70 | ~x71 | ~x72 | x74);
  assign new_n437_ = (~x31 | (x70 ? (x71 | x74) : ~x71)) & (~x71 | x74 | ~x63 | ~x70);
  assign new_n438_ = (x72 | (~new_n439_ & ~new_n440_)) & (~x70 | ~x71 | ~new_n441_ | ~x72);
  assign new_n439_ = x74 & ((x28 & (x70 ? (~x71 & x73) : x71)) | (x60 & x70 & x71 & x73));
  assign new_n440_ = x61 & x70 & x71 & x73 & ~x74;
  assign new_n441_ = x73 & (x74 ? x63 : x55);
  assign new_n442_ = ~x69 & ~x70 & ~new_n443_ & ~x71;
  ...
  assign new_n446_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n447_ = ~x66 & (x68 ? new_n448_ : (x67 ? ~new_n449_ : new_n431_));
  assign new_n448_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n443_);
  assign new_n449_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n450_ | ~x70);
  assign new_n450_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n451_ = x66 & ~x67 & ((~new_n449_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n452_ = ~x66 & new_n446_ & ~x67;
endmodule
