// Benchmark "FAU" written by ABC on Sat Aug  1 07:41:33 2020
...
module FAU ( 
  ...
  assign z10 = x64 ? (~x65 & (x66 ? new_n315_ : ~new_n307_)) : ~new_n288_;
  assign new_n288_ = (~new_n304_ | ~x65) & (new_n112_ | (x70 ? new_n299_ : new_n289_));
  assign new_n289_ = (~x68 | x69 | (x65 ? new_n292_ : ~new_n290_)) & (~x65 | x68 | ~new_n295_ | ~x69);
  assign new_n290_ = x71 & ((x10 & (new_n291_ | ~x00)) | (x00 & ~new_n291_ & ~x10));
  assign new_n291_ = ~x11 & ~x12 & ~x13 & ~x14 & ~x15;
  assign new_n292_ = (new_n126_ | ~x58) & (x71 | (x72 ? new_n293_ : new_n294_));
  ...
  assign new_n299_ = (x71 | (x65 ? (~new_n300_ | x68) : (~new_n301_ | ~x68))) & (~x65 | ~new_n303_ | x68);
  assign new_n300_ = x69 & (new_n296_ | new_n297_ | new_n298_);
  assign new_n301_ = ~x69 & ((x42 & (new_n302_ | ~x32)) | (x32 & ~new_n302_ & ~x42));
  assign new_n302_ = ~x43 & ~x44 & ~x45 & ~x46 & ~x47;
  assign new_n303_ = x69 & x71 & (x72 ? ~new_n293_ : ~new_n294_);
  assign new_n304_ = ~x66 & ~x67 & x68 & ~x69 & (new_n305_ | new_n306_);
  assign new_n305_ = ~x70 & x71 & ((x10 & (new_n291_ | ~x00)) | (x00 & ~new_n291_ & ~x10));
  assign new_n306_ = x70 & ~x71 & ((x42 & (new_n302_ | ~x32)) | (x32 & ~new_n302_ & ~x42));
  assign new_n307_ = x68 ? ~new_n312_ : (x67 ? new_n313_ : ~new_n308_);
  assign new_n308_ = x69 & ((~new_n311_ & (x70 ^ x71)) | (x70 & x71 & (new_n309_ | new_n310_)));
  assign new_n309_ = ~new_n293_ & x72;
  assign new_n310_ = ~new_n294_ & ~x72;
  assign new_n311_ = ~new_n296_ & ~new_n297_ & ~new_n298_;
  assign new_n312_ = ~x69 & ~x70 & ((~new_n292_ & ~x67) | (x42 & x67 & ~x71));
  assign new_n313_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n314_ | ~x70) & (~x58 | ~x69 | x70);
  assign new_n314_ = (~x42 | ~x71) & (~x26 | x69 | x71);
  assign new_n315_ = ~x67 & ((~new_n313_ & ~x68) | (new_n108_ & x42 & x68));
  assign z11 = x64 ? (~x65 & (x66 ? new_n345_ : ~new_n338_)) : ~new_n317_;
  assign new_n317_ = ~new_n334_ & (new_n112_ | (x70 ? (~new_n327_ & ~new_n337_) : new_n318_));
  assign new_n318_ = (~x68 | x69 | (x65 ? new_n320_ : ~new_n319_)) & (~x65 | x68 | ~new_n324_ | ~x69);
  assign new_n319_ = x71 & ((x11 & (new_n119_ | ~x00)) | (x00 & ~new_n119_ & ~x11));
  assign new_n320_ = ~new_n323_ & (x71 | (~new_n321_ & ~new_n322_ & (new_n126_ | ~x59)));
  assign new_n321_ = x73 & ((~x72 & (x74 ? x56 : x57)) | (x51 & x72 & ~x74));
  assign new_n322_ = x72 & ~x73 & (x74 ? x54 : x55);
  assign new_n323_ = ~x73 & x74 & x58 & ~x72;
  assign new_n324_ = x71 & ((~new_n126_ & x27) | (~new_n326_ & ~x72) | (~new_n325_ & x72));
  ...
  assign new_n328_ = ~new_n126_ & (x71 ? x59 : x27);
  assign new_n329_ = x73 & ((~new_n330_ & ~x74) | (~x72 & ~new_n331_ & x74));
  assign new_n330_ = x71 ? (x72 ? ~x51 : ~x57) : (x72 ? ~x19 : ~x25);
  assign new_n331_ = x71 ? ~x56 : ~x24;
  assign new_n332_ = ~x73 & ((~new_n333_ & x72) | (x26 & ~x71 & ~x72 & x74));
  assign new_n333_ = x71 ? (x74 ? ~x54 : ~x55) : (x74 ? ~x22 : ~x23);
  assign new_n334_ = x65 & ~x66 & ~x67 & x68 & ~new_n335_ & ~x69;
  assign new_n335_ = x70 ? (new_n336_ | x71) : (~x71 | ((~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11)));
  assign new_n336_ = (~x43 | (x32 & (x46 | x47 | x44 | x45))) & (~x32 | x43 | (~x46 & ~x47 & ~x44 & ~x45));
  assign new_n337_ = ~x65 & x68 & ~x69 & ~new_n336_ & ~x71;
  assign new_n338_ = x68 ? (~new_n342_ | x69) : (x67 ? new_n343_ : (new_n339_ | ~x69));
  assign new_n339_ = ((~x70 ^ x71) | (new_n341_ & (new_n126_ | ~x27))) & (~x70 | new_n340_ | ~x71);
  assign new_n340_ = (new_n126_ | ~x59) & ~new_n321_ & ~new_n322_;
  assign new_n341_ = x72 ? new_n325_ : new_n326_;
  assign new_n342_ = ~x70 & ((~new_n320_ & ~x67) | (x43 & x67 & ~x71));
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n376_ : ~new_n369_)) : ~new_n347_;
  assign new_n347_ = ~new_n365_ & (new_n112_ | (x70 ? (~new_n358_ & ~new_n368_) : new_n348_));
  assign new_n348_ = (~x68 | x69 | (x65 ? new_n351_ : ~new_n349_)) & (~x65 | x68 | ~new_n355_ | ~x69);
  assign new_n349_ = x71 & ((x12 & (new_n350_ | ~x00)) | (x00 & ~new_n350_ & ~x12));
  assign new_n350_ = ~x13 & ~x14 & ~x15;
  assign new_n351_ = ~new_n354_ & (x71 | (~new_n352_ & ~new_n353_ & (new_n126_ | ~x60)));
  assign new_n352_ = x74 & ((~x72 & (x73 ? x57 : x59)) | (x55 & x72 & ~x73));
  assign new_n353_ = x72 & ~x74 & (x73 ? x52 : x56);
  assign new_n354_ = x73 & ~x74 & x58 & ~x72;
  assign new_n355_ = x71 & ((~new_n126_ & x28) | (~new_n357_ & ~x72) | (~new_n356_ & x72));
  assign new_n356_ = (x73 | (x74 ? ~x23 : ~x24)) & (~x20 | ~x73 | x74);
  assign new_n357_ = (~x73 | (x74 ? ~x25 : ~x26)) & (~x27 | x73 | ~x74);
  assign new_n358_ = x65 & ~x68 & x69 & (new_n359_ | new_n360_ | new_n363_);
  assign new_n359_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n360_ = x74 & ((~new_n361_ & ~x73) | (~x72 & ~new_n362_ & x73));
  assign new_n361_ = x71 ? (x72 ? ~x55 : ~x59) : (x72 ? ~x23 : ~x27);
  assign new_n362_ = x71 ? ~x57 : ~x25;
  assign new_n363_ = ~x74 & ((~new_n364_ & x72) | (x26 & ~x71 & ~x72 & x73));
  assign new_n364_ = x71 ? (x73 ? ~x52 : ~x56) : (x73 ? ~x20 : ~x24);
  assign new_n365_ = x65 & ~x66 & ~x67 & x68 & ~new_n366_ & ~x69;
  assign new_n366_ = x70 ? ~new_n367_ : (~x71 | ((~x12 | (~new_n350_ & x00)) & (~x00 | new_n350_ | x12)));
  assign new_n367_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n368_ = ~x65 & x68 & new_n367_ & ~x69;
  assign new_n369_ = x68 ? ~new_n373_ : (x67 ? new_n374_ : ~new_n370_);
  assign new_n370_ = x69 & ((~new_n372_ & (x70 ^ x71)) | (x70 & ~new_n371_ & x71));
  assign new_n371_ = (new_n126_ | ~x60) & ~new_n352_ & ~new_n353_;
  assign new_n372_ = (new_n126_ | ~x28) & (new_n356_ | ~x72) & (new_n357_ | x72);
  assign new_n373_ = ~x69 & ~x70 & ((~new_n351_ & ~x67) | (x44 & x67 & ~x71));
  assign new_n374_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n375_ | ~x70);
  assign new_n375_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n376_ = ~x67 & ((~new_n374_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n404_ : ~new_n397_)) : ~new_n378_;
  assign new_n378_ = (~new_n394_ | ~x65) & (new_n112_ | (x70 ? new_n390_ : new_n379_));
  assign new_n379_ = (~x68 | x69 | (x65 ? new_n380_ : ~new_n389_)) & (~x65 | x68 | ~new_n385_ | ~x69);
  assign new_n380_ = ~new_n384_ & (x71 | (~new_n381_ & ~new_n382_ & ~new_n383_));
  ...
  assign new_n384_ = x73 & x74 & x58 & ~x72;
  ...
  assign new_n391_ = ~new_n392_ & (x71 | (~new_n387_ & ~new_n388_)) & (~x71 | (~new_n382_ & ~new_n383_));
  assign new_n392_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n393_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n394_ = ~x66 & ~x67 & x68 & ~x69 & (new_n395_ | new_n396_);
  assign new_n395_ = new_n389_ & ~x70;
  assign new_n396_ = new_n393_ & x70;
  assign new_n397_ = x68 ? (~new_n401_ | x69) : (x67 ? new_n402_ : (new_n398_ | ~x69));
  assign new_n398_ = ((new_n400_ & ~new_n386_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n399_ & ~new_n381_));
  assign new_n399_ = ~new_n382_ & ~new_n383_;
  assign new_n400_ = ~new_n387_ & ~new_n388_;
  assign new_n401_ = ~x70 & ((~new_n380_ & ~x67) | (x45 & x67 & ~x71));
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n429_ : ~new_n422_)) : ~new_n406_;
  assign new_n406_ = ~new_n420_ & (new_n112_ | (x70 ? new_n416_ : new_n407_));
  assign new_n407_ = (~x68 | x69 | (x65 ? new_n408_ : ~new_n415_)) & (~x65 | x68 | ~new_n412_ | ~x69);
  assign new_n408_ = ~new_n411_ & (x71 | (~new_n409_ & ~new_n410_ & (new_n126_ | ~x62)));
  assign new_n409_ = x72 & ((x54 & x73 & ~x74) | (x57 & ~x73 & x74));
  assign new_n410_ = ~x72 & ((x73 & (x74 ? x59 : x60)) | (x61 & ~x73 & x74));
  assign new_n411_ = ~x73 & ~x74 & x58 & x72;
  assign new_n412_ = x71 & ((~new_n126_ & x30) | new_n413_ | new_n414_);
  ...
  assign new_n421_ = x70 ? ~new_n419_ : ~new_n415_;
  assign new_n422_ = x68 ? (~new_n426_ | x69) : (x67 ? new_n427_ : (new_n423_ | ~x69));
  assign new_n423_ = (new_n425_ | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n424_ & (new_n126_ | ~x62)));
  assign new_n424_ = ~new_n409_ & ~new_n410_;
  assign new_n425_ = (new_n126_ | ~x30) & ~new_n413_ & ~new_n414_;
  assign new_n426_ = ~x70 & ((~new_n408_ & ~x67) | (x46 & x67 & ~x71));
  ...
  assign z15 = x64 ? (~new_n443_ & ~x65) : (new_n431_ | (new_n449_ & x65));
  assign new_n431_ = ~new_n112_ & (x65 ? (x68 ? new_n439_ : new_n432_) : new_n442_);
  assign new_n432_ = x69 & (new_n436_ | (~new_n433_ & ~new_n194_));
  ...
  assign new_n436_ = x70 & x71 & ((~new_n126_ & x63) | new_n437_ | new_n438_);
  assign new_n437_ = ~x74 & ((x72 & (x73 ? x55 : x59)) | (x61 & ~x72 & x73));
  assign new_n438_ = ~x72 & x74 & (x73 ? x60 : x62);
  assign new_n439_ = ~x69 & ~new_n440_ & ~x70;
  assign new_n440_ = ~new_n441_ & (x71 | (~new_n437_ & ~new_n438_ & (new_n126_ | ~x63)));
  assign new_n441_ = x58 & x72 & ~x73 & x74;
  assign new_n442_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n443_ = x66 ? (new_n448_ | x67) : (x68 ? ~new_n447_ : new_n444_);
  assign new_n444_ = x67 ? new_n445_ : (~x69 | (~new_n436_ & (new_n433_ | new_n194_)));
  assign new_n445_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n446_ | ~x70);
  assign new_n446_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n447_ = ~x69 & ~x70 & ((~new_n440_ & ~x67) | (x47 & x67 & ~x71));
  assign new_n448_ = (~new_n108_ | ~x47 | ~x68) & (new_n445_ | x68);
  assign new_n449_ = ~x66 & new_n442_ & ~x67;
endmodule
