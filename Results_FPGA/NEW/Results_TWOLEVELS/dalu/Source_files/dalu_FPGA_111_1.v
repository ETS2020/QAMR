// Benchmark "FAU" written by ABC on Sat Aug  1 07:39:18 2020
...
module FAU ( 
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n369_ : ~new_n362_)) : ~new_n340_;
  assign new_n340_ = ~new_n360_ & (new_n112_ | (new_n351_ & (~x71 | (~new_n341_ & ~new_n346_))));
  assign new_n341_ = ~x70 & (x65 ? (~x68 & ~new_n342_ & x69) : (x68 & ~new_n345_ & ~x69));
  ...
  assign new_n345_ = (~x12 | (x00 & (x13 | x14 | x15))) & (~x00 | x12 | (~x13 & ~x14 & ~x15));
  assign new_n346_ = x65 & ~x68 & x69 & (new_n347_ | (~new_n348_ & x70));
  assign new_n347_ = ~new_n126_ & (x28 | x70);
  assign new_n348_ = ~new_n349_ & ~new_n350_ & (~x57 | ~x73 | ~x74) & (~x56 | x73 | x74);
  assign new_n349_ = x72 & ((x55 & x74) | (x52 & x73));
  assign new_n350_ = ~x72 & ((x59 & ~x73) | (x58 & ~x74));
  assign new_n351_ = x65 ? (~new_n352_ & (x71 | (~new_n354_ & ~new_n357_))) : ~new_n358_;
  assign new_n352_ = ~new_n126_ & ~new_n353_;
  assign new_n353_ = (~x28 | x68 | ~x69 | ~x70) & (x69 | x70 | x71 | ~x60 | ~x68);
  assign new_n354_ = x68 & ~x69 & ~x70 & (x72 ? ~new_n355_ : ~new_n356_);
  assign new_n355_ = (x73 | (x74 ? ~x55 : ~x56)) & (~x52 | ~x73 | x74);
  assign new_n356_ = (~x73 | (x74 ? ~x57 : ~x58)) & (~x59 | x73 | ~x74);
  assign new_n357_ = ~x68 & x69 & x70 & (x72 ? ~new_n343_ : ~new_n344_);
  ...
  assign new_n361_ = x70 ? ~new_n359_ : (new_n345_ | ~x71);
  assign new_n362_ = x68 ? (~new_n364_ | x69) : (x67 ? new_n367_ : (new_n363_ | ~x69));
  assign new_n363_ = (new_n342_ | (~x70 ^ x71)) & (~x70 | new_n348_ | ~x71) & (new_n126_ | ((~x70 | ~x71) & (~x28 | (~x70 & ~x71))));
  assign new_n364_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n365_ | new_n366_));
  assign new_n365_ = x72 ? new_n355_ : new_n356_;
  assign new_n366_ = ~new_n126_ & x60;
  assign new_n367_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n368_ | ~x70);
  assign new_n368_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n369_ = ~x67 & ((~new_n367_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n413_ : ~new_n400_)) : ~new_n371_;
  assign new_n371_ = ~new_n396_ & (new_n112_ | ((new_n372_ | ~x71) & ~new_n398_ & (new_n384_ | x71)));
  assign new_n372_ = (x70 | (x65 ? (~new_n375_ | x68) : (~new_n373_ | ~x68))) & (~x65 | ~new_n379_ | x68);
  assign new_n373_ = ~new_n374_ & ~x69;
  assign new_n374_ = (~x00 | x13 | (~x14 & ~x15)) & (~x13 | (x00 & (x14 | x15)));
  assign new_n375_ = x69 & (new_n377_ | (x72 & ~new_n376_ & ~x73) | (~new_n378_ & x73));
  assign new_n376_ = x74 ? ~x24 : ~x25;
  assign new_n377_ = x29 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n378_ = (x72 | (x74 ? ~x26 : ~x27)) & (~x21 | ~x72 | x74);
  assign new_n379_ = x69 & (new_n383_ | (x70 & (new_n380_ | new_n381_ | new_n382_)));
  assign new_n380_ = x61 & (x72 ? (x73 & x74) : ~x73);
  assign new_n381_ = ~x74 & ((x72 & (x73 ? x53 : x57)) | (x59 & ~x72 & x73));
  assign new_n382_ = x74 & ((x56 & ~x73) | (~x72 & (x58 | ~x73)));
  assign new_n383_ = ~x73 & x74 & x28 & ~x72;
  assign new_n384_ = x65 ? (~new_n385_ & (new_n390_ | x73) & (new_n386_ | ~x73)) : ~new_n394_;
  assign new_n385_ = ~new_n126_ & ((~x69 & ~x70 & x61 & x68) | (x69 & x70 & x29 & ~x68));
  assign new_n386_ = (x72 | new_n389_ | ~x74) & (x74 | (x68 ? ~new_n387_ : ~new_n388_));
  assign new_n387_ = ~x69 & ~x70 & (x72 ? x53 : x59);
  assign new_n388_ = x69 & x70 & (x72 ? x21 : x27);
  assign new_n389_ = (~x26 | x68 | ~x69 | ~x70) & (x69 | x70 | ~x58 | ~x68);
  assign new_n390_ = ~new_n393_ & (~x72 | (x68 ? (~new_n391_ | x69) : (~new_n392_ | ~x69)));
  assign new_n391_ = ~x70 & (x74 ? x56 : x57);
  assign new_n392_ = x70 & (x74 ? x24 : x25);
  assign new_n393_ = x60 & x68 & ~x69 & ~x70 & ~x72 & x74;
  assign new_n394_ = x68 & ~x69 & ~new_n395_ & x70;
  assign new_n395_ = (~x32 | x45 | (~x46 & ~x47)) & (~x45 | (x32 & (x46 | x47)));
  assign new_n396_ = x65 & ~x66 & new_n397_ & ~x67;
  assign new_n397_ = x68 & ~x69 & (x70 ? (~new_n395_ & ~x71) : (~new_n374_ & x71));
  assign new_n398_ = new_n399_ & x70 & ~x72 & ~x73 & x74;
  assign new_n399_ = x28 & x65 & ~x68 & x69;
  assign new_n400_ = x68 ? (~new_n407_ | x69) : (x67 ? new_n411_ : (new_n401_ | ~x69));
  assign new_n401_ = (new_n402_ | new_n194_) & ~new_n403_ & (x72 | (~new_n405_ & ~new_n406_));
  assign new_n402_ = ~new_n377_ & (~x72 | new_n376_ | x73) & (new_n378_ | ~x73);
  assign new_n403_ = x70 & x71 & (new_n404_ | (x56 & ~x73 & x74));
  assign new_n404_ = x72 & ((x73 & (x74 ? x61 : x53)) | (x57 & ~x73 & ~x74));
  assign new_n405_ = ~x73 & ((x61 & x70 & x71) | (x74 & ((x70 & x71) | (x28 & (x70 | x71)))));
  assign new_n406_ = x70 & x71 & ((x58 & x74) | (x59 & x73 & ~x74));
  assign new_n407_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n408_);
  assign new_n408_ = (new_n126_ | ~x61) & (new_n409_ | ~x72) & (new_n410_ | x72);
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n455_ : ~new_n441_)) : ~new_n415_;
  assign new_n415_ = ~new_n438_ & (new_n112_ | ((new_n416_ | ~x71) & ~new_n440_ & (new_n426_ | x71)));
  assign new_n416_ = (~x65 | ~new_n420_ | x68) & (x70 | (x65 ? (~new_n417_ | x68) : (~new_n425_ | ~x68)));
  assign new_n417_ = x69 & ((~new_n126_ & x30) | new_n419_ | (~new_n418_ & x74));
  assign new_n418_ = (x72 | (x73 ? ~x27 : ~x29)) & (~x25 | ~x72 | x73);
  assign new_n419_ = x72 & ~x74 & (x73 ? x22 : x26);
  assign new_n420_ = x69 & (new_n424_ | (x70 & (new_n421_ | new_n422_ | new_n423_)));
  assign new_n421_ = x62 & (x72 ? (x73 & x74) : ~x74);
  assign new_n422_ = ~x73 & ((x72 & (x74 ? x57 : x58)) | (x61 & ~x72 & x74));
  assign new_n423_ = x73 & ((x54 & ~x74) | (~x72 & (x59 | ~x74)));
  assign new_n424_ = x73 & ~x74 & x28 & ~x72;
  assign new_n425_ = ~x69 & ((x14 & (~x00 | ~x15)) | (x00 & ~x14 & x15));
  assign new_n426_ = x65 ? (~new_n427_ & (new_n432_ | x74) & (new_n428_ | ~x74)) : ~new_n436_;
  assign new_n427_ = ~new_n126_ & ((~x69 & ~x70 & x62 & x68) | (x69 & x70 & x30 & ~x68));
  assign new_n428_ = (x72 | new_n431_ | ~x73) & (x73 | (x68 ? ~new_n429_ : ~new_n430_));
  assign new_n429_ = ~x69 & ~x70 & (x72 ? x57 : x61);
  assign new_n430_ = x69 & x70 & (x72 ? x25 : x29);
  assign new_n431_ = (~x27 | x68 | ~x69 | ~x70) & (x69 | x70 | ~x59 | ~x68);
  assign new_n432_ = ~new_n435_ & (~x72 | (x68 ? (~new_n433_ | x69) : (~new_n434_ | ~x69)));
  assign new_n433_ = ~x70 & (x73 ? x54 : x58);
  assign new_n434_ = x70 & (x73 ? x22 : x26);
  assign new_n435_ = x60 & x68 & ~x69 & ~x70 & ~x72 & x73;
  ...
  assign new_n439_ = x70 ? (new_n437_ | x71) : (~x71 | ((~x00 | x14 | ~x15) & (~x14 | (x00 & x15))));
  assign new_n440_ = new_n399_ & x70 & ~x72 & x73 & ~x74;
  assign new_n441_ = x68 ? (~new_n449_ | x69) : (x67 ? new_n453_ : (new_n442_ | ~x69));
  assign new_n442_ = (new_n443_ | (~x70 ^ x71)) & ~new_n444_ & (~x70 | new_n447_ | ~x71);
  assign new_n443_ = (new_n126_ | ~x30) & ~new_n419_ & (new_n418_ | ~x74);
  assign new_n444_ = ~x72 & (new_n445_ | (new_n446_ & x70));
  assign new_n445_ = x73 & ((x59 & x70 & x71) | (~x74 & ((x70 & x71) | (x28 & (x70 | x71)))));
  assign new_n446_ = x71 & ((x62 & ~x74) | (x61 & ~x73 & x74));
  assign new_n447_ = (~x72 | new_n448_ | x73) & (~x73 | ((~x54 | x74) & (~x62 | ~x72 | ~x74)));
  assign new_n448_ = x74 ? ~x57 : ~x58;
  assign new_n449_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n450_);
  assign new_n450_ = (new_n126_ | ~x62) & (new_n451_ | ~x72) & (new_n452_ | x72);
  ...
  assign new_n455_ = ~x67 & ((~new_n453_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n472_ | new_n476_)) : (new_n457_ | (new_n477_ & x65));
  assign new_n457_ = ~new_n112_ & (x65 ? (x68 ? new_n467_ : new_n458_) : new_n471_);
  assign new_n458_ = x69 & (new_n459_ | new_n462_ | (x70 & ~new_n465_ & x71));
  assign new_n459_ = ~new_n194_ & (new_n460_ | new_n461_ | (~new_n126_ & x31));
  assign new_n460_ = ~x72 & ((x29 & x73 & ~x74) | (x30 & ~x73 & x74));
  assign new_n461_ = x72 & ((~x73 & (x74 ? x26 : x27)) | (x23 & x73 & ~x74));
  assign new_n462_ = ~x72 & (new_n463_ | new_n464_);
  assign new_n463_ = x73 & ((x61 & x70 & x71) | (x74 & ((x70 & x71) | (x28 & (x70 | x71)))));
  assign new_n464_ = x70 & x71 & ((x62 & x74) | (x63 & ~x73 & ~x74));
  assign new_n465_ = (~x72 | new_n466_ | x73) & (~x73 | ((~x63 | ~x74) & (~x55 | ~x72 | x74)));
  assign new_n466_ = x74 ? ~x58 : ~x59;
  assign new_n467_ = ~x69 & ~x70 & ~new_n468_ & ~x71;
  assign new_n468_ = (new_n126_ | ~x63) & (new_n469_ | ~x72) & (new_n470_ | x72);
  assign new_n469_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n470_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n471_ = x68 & ~x69 & ((x47 & x70 & ~x71) | (x15 & ~x70 & x71));
  assign new_n472_ = ~x66 & (x68 ? new_n473_ : (x67 ? ~new_n474_ : new_n458_));
  assign new_n473_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n468_);
  assign new_n474_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n475_ | ~x70);
  assign new_n475_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n476_ = x66 & ~x67 & ((~new_n474_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n477_ = ~x66 & new_n471_ & ~x67;
endmodule
