// Benchmark "FAU" written by ABC on Sat Aug  1 07:36:51 2020
...
module FAU ( 
  ...
  assign z08 = x64 ? (~x65 & (new_n263_ | new_n266_)) : (new_n248_ | (new_n261_ & x65));
  ...
  assign new_n255_ = x69 & ((~new_n257_ & (x70 ^ x71)) | new_n260_ | (x70 & ~new_n256_ & x71));
  assign new_n256_ = x72 ? new_n253_ : new_n254_;
  ...
  assign new_n260_ = ~new_n126_ & ((x24 & ~x70) | (x56 & x70 & x71));
  assign new_n261_ = ~x66 & ~x67 & x68 & ~new_n262_ & ~x69;
  assign new_n262_ = x70 ? (new_n251_ | x71) : (new_n250_ | ~x71);
  assign new_n263_ = ~x66 & (x68 ? new_n264_ : (x67 ? ~new_n265_ : new_n255_));
  assign new_n264_ = ~x69 & ~x70 & ~x71 & (x67 ? x40 : ~new_n252_);
  assign new_n265_ = (~x08 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x56 | ~x69) & (~x40 | ~x70 | ~x71);
  assign new_n266_ = x66 & ~x67 & ((~new_n265_ & ~x68) | (new_n108_ & x40 & x68));
  assign z09 = x64 ? (~x65 & (new_n284_ | new_n288_)) : (new_n268_ | (new_n282_ & x65));
  assign new_n268_ = ~new_n112_ & ((x68 & ~new_n269_ & ~x69) | (x65 & new_n276_ & ~x68));
  ...
  assign new_n276_ = x69 & (~new_n280_ | (~new_n277_ & ~new_n194_));
  assign new_n277_ = (~x25 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n279_ | ~x73) & (~x72 | new_n278_ | x73);
  assign new_n278_ = x74 ? ~x20 : ~x21;
  assign new_n279_ = (x72 | (x74 ? ~x22 : ~x23)) & (~x17 | ~x72 | x74);
  assign new_n280_ = ~new_n281_ & (~x70 | ~x71 | (~new_n273_ & ~new_n274_ & ~new_n275_));
  assign new_n281_ = ~x72 & ~x73 & x74 & x24 & ~x70;
  ...
  assign z10 = x64 ? new_n314_ : (new_n312_ | (~new_n112_ & (new_n290_ | new_n303_)));
  assign new_n290_ = ~x70 & ((new_n291_ & x68) | (x65 & new_n298_ & ~x68));
  assign new_n291_ = ~x69 & (x65 ? (~new_n294_ & ~x71) : (~new_n292_ & x71));
  ...
  assign new_n298_ = x69 & (new_n302_ | (~new_n299_ & x71));
  assign new_n299_ = (new_n126_ | ~x26) & ~new_n300_ & ~new_n301_;
  assign new_n300_ = x74 & ((~x72 & (x73 ? x23 : x25)) | (x21 & x72 & ~x73));
  assign new_n301_ = x72 & ~x74 & (x73 ? x18 : x22);
  assign new_n302_ = x73 & ~x74 & x24 & ~x72;
  assign new_n303_ = x70 & (x65 ? (~x68 & ~new_n304_ & x69) : (x68 & new_n310_ & ~x69));
  assign new_n304_ = (new_n126_ | new_n309_) & (new_n307_ | x74) & (new_n305_ | ~x74);
  assign new_n305_ = (new_n306_ | x73) & (x72 | ~x73 | (x71 ? ~x55 : ~x23));
  assign new_n306_ = x71 ? (x72 ? ~x53 : ~x57) : (x72 ? ~x21 : ~x25);
  assign new_n307_ = (new_n308_ | ~x72) & (x72 | ~x73 | ~x56 | ~x71);
  assign new_n308_ = x71 ? (x73 ? ~x50 : ~x54) : (x73 ? ~x18 : ~x22);
  ...
  assign new_n313_ = x70 ? ~new_n310_ : (new_n292_ | ~x71);
  assign new_n314_ = ~x65 & (x66 ? new_n323_ : (new_n315_ | new_n321_));
  ...
  assign new_n318_ = ~new_n194_ & (new_n300_ | new_n301_ | (~new_n126_ & x26));
  assign new_n319_ = ~new_n320_ & (~x70 | ~x71 | (~new_n295_ & ~new_n296_ & ~new_n297_));
  assign new_n320_ = ~x72 & x73 & ~x74 & x24 & ~x70;
  assign new_n321_ = x68 & ~x69 & new_n322_ & ~x70;
  assign new_n322_ = ~x71 & (x67 ? x42 : (new_n295_ | new_n296_ | new_n297_));
  assign new_n323_ = ~x67 & ((~new_n316_ & ~x68) | (new_n108_ & x42 & x68));
  assign z11 = x64 ? (~x65 & (x66 ? new_n351_ : ~new_n343_)) : ~new_n325_;
  assign new_n325_ = ~new_n341_ & (new_n112_ | (~new_n326_ & ~new_n336_));
  ...
  assign new_n332_ = ~new_n335_ & (~x71 | (~new_n333_ & ~new_n334_ & (new_n126_ | ~x27)));
  assign new_n333_ = ~x72 & ((x25 & x73 & ~x74) | (x26 & ~x73 & x74));
  assign new_n334_ = x72 & ((~x73 & (x74 ? x22 : x23)) | (x19 & x73 & ~x74));
  assign new_n335_ = x73 & x74 & x24 & ~x72;
  assign new_n336_ = x70 & (x65 ? (~x68 & ~new_n337_ & x69) : (x68 & new_n339_ & ~x69));
  assign new_n337_ = ~new_n338_ & (x71 | (~new_n333_ & ~new_n334_)) & (~x71 | (~new_n330_ & ~new_n331_));
  ...
  assign new_n342_ = x70 ? (new_n340_ | x71) : (new_n328_ | ~x71);
  assign new_n343_ = x68 ? (~new_n347_ | x69) : (x67 ? new_n349_ : (new_n344_ | ~x69));
  assign new_n344_ = new_n345_ & (new_n194_ | (~new_n333_ & ~new_n334_ & (new_n126_ | ~x27)));
  assign new_n345_ = ~new_n346_ & (~x70 | ~x71 | (~new_n329_ & ~new_n330_ & ~new_n331_));
  assign new_n346_ = x24 & ~x70 & ~x72 & x73 & x74;
  assign new_n347_ = ~x70 & ~x71 & (x67 ? x43 : ~new_n348_);
  assign new_n348_ = ~new_n329_ & ~new_n330_ & ~new_n331_;
  ...
  assign new_n361_ = x72 & ((x20 & x73 & ~x74) | (x23 & ~x73 & x74));
  ...
  assign new_n365_ = ~new_n366_ & (x71 | (~new_n361_ & ~new_n362_)) & (~x71 | (~new_n358_ & ~new_n359_));
  assign new_n366_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n367_ = ~x71 & ((x44 & (new_n311_ | ~x32)) | (x32 & ~new_n311_ & ~x44));
  assign new_n368_ = x68 & ~x69 & (x70 ? new_n367_ : (~new_n356_ & x71));
  assign new_n369_ = x68 ? (~new_n373_ | x69) : (x67 ? new_n375_ : (new_n370_ | ~x69));
  assign new_n370_ = new_n371_ & (new_n194_ | (~new_n361_ & ~new_n362_ & (new_n126_ | ~x28)));
  assign new_n371_ = ~new_n372_ & (~x70 | ~x71 | (~new_n357_ & ~new_n358_ & ~new_n359_));
  assign new_n372_ = x24 & ~x70 & x72 & ~x73 & ~x74;
  assign new_n373_ = ~x70 & ~x71 & (x67 ? x44 : ~new_n374_);
  assign new_n374_ = ~new_n357_ & ~new_n358_ & ~new_n359_;
  ...
  assign z13 = x64 ? (~new_n397_ & ~x65) : ((~new_n379_ & ~new_n112_) | (new_n407_ & x65));
  assign new_n379_ = x70 ? (x65 ? (~new_n390_ | x68) : (~new_n396_ | ~x68)) : new_n380_;
  assign new_n380_ = (~x68 | new_n381_ | x69) & (~x65 | x68 | new_n386_ | ~x69);
  ...
  assign new_n386_ = ~new_n389_ & (~x71 | (~new_n387_ & ~new_n388_ & (new_n126_ | ~x29)));
  assign new_n387_ = ~x74 & ((x72 & (x73 ? x21 : x25)) | (x27 & ~x72 & x73));
  assign new_n388_ = ~x72 & x74 & (x73 ? x26 : x28);
  assign new_n389_ = x24 & x72 & ~x73 & x74;
  assign new_n390_ = x69 & (new_n391_ | (~new_n392_ & ~x74) | (~new_n394_ & x74));
  assign new_n391_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n392_ = (new_n393_ | ~x73) & (~x72 | x73 | (x71 ? ~x57 : ~x25));
  assign new_n393_ = x71 ? (x72 ? ~x53 : ~x59) : (x72 ? ~x21 : ~x27);
  assign new_n394_ = (new_n395_ | x72) & (~x72 | x73 | ~x56 | ~x71);
  assign new_n395_ = x71 ? (x73 ? ~x58 : ~x60) : (x73 ? ~x26 : ~x28);
  assign new_n396_ = ~x69 & ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n397_ = x66 ? ~new_n406_ : (x68 ? ~new_n404_ : new_n398_);
  assign new_n398_ = x67 ? new_n400_ : (~x69 | (new_n402_ & (new_n399_ | new_n194_)));
  assign new_n399_ = (new_n126_ | ~x29) & ~new_n387_ & ~new_n388_;
  assign new_n400_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n401_ | ~x70);
  assign new_n401_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n402_ = ~new_n403_ & (~x70 | ~x71 | (~new_n383_ & ~new_n384_ & ~new_n385_));
  assign new_n403_ = x24 & ~x70 & x72 & ~x73 & x74;
  assign new_n404_ = ~x69 & ~x70 & ~x71 & (x67 ? x45 : ~new_n405_);
  assign new_n405_ = ~new_n383_ & ~new_n384_ & ~new_n385_;
  assign new_n406_ = ~x67 & ((~new_n400_ & ~x68) | (new_n108_ & x45 & x68));
  assign new_n407_ = ~x66 & ~x67 & x68 & ~x69 & (new_n408_ | new_n409_);
  assign new_n408_ = ~x70 & ~new_n382_ & x71;
  assign new_n409_ = x70 & ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
