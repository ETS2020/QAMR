// Benchmark "FAU" written by ABC on Sat Aug  1 07:41:32 2020
...
module FAU ( 
  ...
  assign z10 = x64 ? (~new_n305_ & ~x65) : (new_n286_ | (x65 & new_n313_ & ~x66));
  assign new_n286_ = ~new_n112_ & (x70 ? ~new_n298_ : (new_n287_ | (new_n294_ & x65)));
  assign new_n287_ = x68 & ~x69 & (x65 ? (~new_n290_ & ~x71) : new_n288_);
  ...
  assign new_n291_ = x72 & ((x53 & x74) | (x73 & (x50 | x74)));
  assign new_n292_ = ~x72 & ((x56 & ~x74) | (~x73 & (x57 | ~x74)));
  assign new_n293_ = (~x55 | ~x73 | ~x74) & (~x54 | x73 | x74);
  ...
  assign new_n305_ = x66 ? ~new_n312_ : (~new_n306_ & ~new_n310_);
  assign new_n306_ = ~x68 & (x67 ? ~new_n309_ : (x69 & (new_n307_ | new_n308_)));
  assign new_n307_ = ~new_n194_ & (new_n296_ | new_n297_ | (~new_n126_ & x26));
  assign new_n308_ = x70 & x71 & ((~new_n126_ & x58) | new_n301_ | new_n302_);
  assign new_n309_ = (~x10 | (x71 ? x70 : ~x69)) & (~x70 | ((~x42 | ~x71) & (~x26 | x69 | x71))) & (~x69 | x70 | x71);
  assign new_n310_ = x68 & ~x69 & new_n311_ & ~x70;
  assign new_n311_ = ~x71 & (x67 ? x42 : (new_n291_ | new_n292_ | ~new_n293_));
  assign new_n312_ = ~x67 & ((~new_n309_ & ~x68) | (new_n108_ & x42 & x68));
  assign new_n313_ = ~x67 & x68 & ~x69 & (x70 ? new_n303_ : new_n288_);
  assign z11 = x64 ? (~new_n332_ & ~x65) : ((new_n330_ & x65) | (~new_n315_ & ~new_n112_));
  assign new_n315_ = x70 ? new_n321_ : ((~new_n316_ | ~x68) & (~x65 | ~new_n329_ | x68));
  assign new_n316_ = ~x69 & (x65 ? (~new_n318_ & ~x71) : (~new_n317_ & x71));
  assign new_n317_ = (~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11);
  assign new_n318_ = (~x59 | (x72 ? (~x73 | ~x74) : x73)) & (new_n319_ | x74) & (new_n320_ | ~x74);
  assign new_n319_ = (~x72 | (x73 ? ~x51 : ~x55)) & (~x57 | x72 | ~x73);
  assign new_n320_ = (~x54 | x73) & (x72 | (~x56 & x73));
  assign new_n321_ = x65 ? (x68 | new_n322_ | ~x69) : (~x68 | ~new_n328_ | x69);
  assign new_n322_ = ~new_n325_ & (x71 | (~new_n323_ & ~new_n324_)) & (~x71 | (~new_n326_ & ~new_n327_));
  ...
  assign new_n329_ = x69 & x71 & ((~new_n126_ & x27) | new_n323_ | new_n324_);
  assign new_n330_ = ~x66 & ~x67 & x68 & ~new_n331_ & ~x69;
  assign new_n331_ = x70 ? ~new_n328_ : (new_n317_ | ~x71);
  assign new_n332_ = x66 ? (new_n339_ | x67) : (x68 ? ~new_n338_ : new_n333_);
  assign new_n333_ = x67 ? new_n334_ : (~x69 | (~new_n336_ & ~new_n337_));
  assign new_n334_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n335_ | ~x70);
  assign new_n335_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n336_ = ~new_n194_ & (new_n323_ | new_n324_ | (~new_n126_ & x27));
  assign new_n337_ = x70 & x71 & ((~new_n126_ & x59) | new_n326_ | new_n327_);
  assign new_n338_ = ~x69 & ~x70 & ~x71 & (x67 ? x43 : ~new_n318_);
  assign new_n339_ = (~new_n108_ | ~x43 | ~x68) & (new_n334_ | x68);
  assign z12 = x64 ? (~x65 & (x66 ? new_n367_ : ~new_n359_)) : ~new_n341_;
  assign new_n341_ = ((~x66 & ~x67) | (~new_n342_ & ~new_n352_)) & (~x65 | x66 | ~new_n358_ | x67);
  ...
  assign new_n345_ = x60 & (x72 ? (x73 & x74) : ~x74);
  assign new_n346_ = ~x73 & ((x72 & (x74 ? x55 : x56)) | (x59 & ~x72 & x74));
  assign new_n347_ = x73 & ((x52 & ~x74) | (~x72 & (x57 | ~x74)));
  ...
  assign new_n351_ = ~x72 & ((x27 & ~x73 & x74) | (x73 & (x74 ? x25 : x26)));
  assign new_n352_ = x70 & (x65 ? (~x68 & ~new_n353_ & x69) : (x68 & new_n357_ & ~x69));
  assign new_n353_ = ~new_n354_ & (x71 | (~new_n350_ & ~new_n351_)) & (~x71 | (~new_n355_ & ~new_n356_));
  ...
  assign new_n358_ = x68 & ~x69 & (x70 ? new_n357_ : new_n344_);
  assign new_n359_ = x68 ? (~new_n363_ | x69) : (x67 ? new_n365_ : (new_n360_ | ~x69));
  assign new_n360_ = ~new_n361_ & (~x70 | ~x71 | (~new_n362_ & ~new_n355_ & ~new_n356_));
  assign new_n361_ = ~new_n194_ & (new_n349_ | new_n350_ | new_n351_);
  assign new_n362_ = ~new_n126_ & x60;
  assign new_n363_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n364_ | new_n345_));
  assign new_n364_ = ~new_n346_ & ~new_n347_;
  ...
  assign z13 = x64 ? (~new_n384_ & ~x65) : (new_n369_ | (x65 & new_n392_ & ~x66));
  assign new_n369_ = ~new_n112_ & (x70 ? ~new_n379_ : (new_n370_ | (new_n375_ & x65)));
  assign new_n370_ = x68 & ~x69 & (x65 ? (~new_n371_ & ~x71) : new_n374_);
  assign new_n371_ = (~x61 | ((~x73 | ~x74) & (x72 | x73 | x74))) & ~new_n372_ & (new_n373_ | x72);
  assign new_n372_ = x72 & ((~x73 & (x74 ? x56 : x57)) | (x53 & x73 & ~x74));
  assign new_n373_ = (~x60 | ~x74) & (~x73 | (~x59 & ~x74));
  assign new_n374_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n375_ = ~x68 & x69 & x71 & (new_n376_ | new_n377_ | new_n378_);
  assign new_n376_ = ~new_n126_ & x29;
  assign new_n377_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n378_ = ~x72 & ((x28 & ~x73 & x74) | (x73 & (x74 ? x26 : x27)));
  assign new_n379_ = x65 ? (x68 | new_n380_ | ~x69) : (~x68 | ~new_n383_ | x69);
  assign new_n380_ = ~new_n381_ & (~x71 | (~new_n372_ & ~new_n382_)) & (x71 | (~new_n377_ & ~new_n378_));
  ...
  assign new_n384_ = x66 ? (new_n391_ | x67) : (x68 ? ~new_n390_ : new_n385_);
  assign new_n385_ = x67 ? new_n386_ : (~x69 | (~new_n388_ & ~new_n389_));
  assign new_n386_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n387_ | ~x70);
  assign new_n387_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n388_ = ~new_n194_ & (new_n377_ | new_n378_ | (~new_n126_ & x29));
  assign new_n389_ = x70 & x71 & ((~new_n126_ & x61) | new_n372_ | new_n382_);
  assign new_n390_ = ~x69 & ~x70 & ~x71 & (x67 ? x45 : ~new_n371_);
  assign new_n391_ = (~new_n108_ | ~x45 | ~x68) & (new_n386_ | x68);
  assign new_n392_ = ~x67 & x68 & ~x69 & (x70 ? new_n383_ : new_n374_);
  assign z14 = x64 ? (~new_n409_ & ~x65) : (new_n394_ | (x65 & new_n416_ & ~x66));
  assign new_n394_ = ~new_n112_ & (x70 ? ~new_n404_ : (new_n395_ | new_n400_));
  assign new_n395_ = x68 & ~x69 & (x65 ? (~new_n396_ & ~x71) : new_n399_);
  assign new_n396_ = (~x62 | ((x73 | x74) & (~x72 | ~x73 | ~x74))) & ~new_n397_ & (new_n398_ | ~x72);
  assign new_n397_ = ~x72 & ((x61 & ~x73 & x74) | (x73 & (x74 ? x59 : x60)));
  assign new_n398_ = (~x54 | x74) & (x73 | (~x57 & x74));
  assign new_n399_ = x71 & ((x14 & (~x00 | ~x15)) | (x00 & ~x14 & x15));
  assign new_n400_ = x65 & ~x68 & x69 & ~new_n401_ & x71;
  assign new_n401_ = (new_n126_ | ~x30) & (new_n402_ | ~x72) & (new_n403_ | x72);
  assign new_n402_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n403_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n404_ = x65 ? (x68 | ~x69 | (~new_n405_ & new_n406_)) : (~x68 | ~new_n408_ | x69);
  assign new_n405_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n406_ = x71 ? (~new_n397_ & ~new_n407_) : (x72 ? new_n402_ : new_n403_);
  ...
  assign new_n410_ = x67 ? new_n411_ : (~x69 | (~new_n413_ & (new_n401_ | new_n194_)));
  assign new_n411_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n412_ | ~x70);
  assign new_n412_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n413_ = x70 & x71 & ((~new_n126_ & x62) | new_n397_ | new_n407_);
  assign new_n414_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n396_);
  assign new_n415_ = (~new_n108_ | ~x46 | ~x68) & (new_n411_ | x68);
  assign new_n416_ = ~x67 & x68 & ~x69 & (x70 ? new_n408_ : new_n399_);
  assign z15 = x64 ? (~new_n432_ & ~x65) : (new_n418_ | (new_n438_ & x65));
  assign new_n418_ = ~new_n112_ & (x65 ? (x68 ? new_n427_ : new_n419_) : new_n431_);
  assign new_n419_ = x69 & (new_n423_ | (~new_n420_ & ~new_n194_));
  ...
  assign new_n423_ = x70 & x71 & (new_n424_ | (~new_n426_ & ~x72) | (~new_n425_ & x72));
  assign new_n424_ = x63 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n428_ = (~x63 | (x72 ? ~x74 : (x73 | x74))) & (new_n430_ | x73) & (new_n429_ | ~x73);
  assign new_n429_ = (x72 | (x74 ? ~x60 : ~x61)) & (~x55 | ~x72 | x74);
  assign new_n430_ = (~x62 | ~x74) & (~x72 | (~x59 & ~x74));
  assign new_n431_ = x68 & ~x69 & ((x47 & x70 & ~x71) | (x15 & ~x70 & x71));
  assign new_n432_ = x66 ? (new_n437_ | x67) : (x68 ? ~new_n436_ : new_n433_);
  assign new_n433_ = x67 ? new_n434_ : (~x69 | (~new_n423_ & (new_n420_ | new_n194_)));
  assign new_n434_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n435_ | ~x70);
  assign new_n435_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n436_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n428_);
  assign new_n437_ = (~new_n108_ | ~x47 | ~x68) & (new_n434_ | x68);
  assign new_n438_ = ~x66 & new_n431_ & ~x67;
endmodule
