// Benchmark "FAU" written by ABC on Sat Aug  1 07:39:48 2020
...
module FAU ( 
  ...
  assign new_n329_ = ~x71 & ((x43 & (new_n124_ | ~x32)) | (x32 & ~new_n124_ & ~x43));
  ...
  assign new_n336_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n337_ | ~x70);
  assign new_n337_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n338_ = ~x67 & ((~new_n336_ & ~x68) | (new_n108_ & x43 & x68));
  ...
  assign new_n363_ = ~x67 & ((~new_n361_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~new_n380_ & ~x65) : ((~new_n365_ & ~new_n112_) | (new_n387_ & x65));
  assign new_n365_ = x70 ? (x65 ? (~new_n375_ | x68) : (~new_n379_ | ~x68)) : new_n366_;
  assign new_n366_ = (~x68 | new_n367_ | x69) & (~x65 | x68 | ~x69 | new_n372_ | ~x71);
  assign new_n367_ = x65 ? (x71 | (~new_n369_ & ~new_n370_ & ~new_n371_)) : (new_n368_ | ~x71);
  assign new_n368_ = (~x00 | x13 | (~x14 & ~x15)) & (~x13 | (x00 & (x14 | x15)));
  ...
  assign new_n372_ = (new_n126_ | ~x29) & (new_n373_ | ~x72) & (new_n374_ | x72);
  assign new_n373_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n374_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n375_ = x69 & (new_n378_ | (~new_n377_ & ~x71) | (~new_n376_ & x71));
  assign new_n376_ = ~new_n370_ & ~new_n371_;
  assign new_n377_ = x72 ? new_n373_ : new_n374_;
  assign new_n378_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n379_ = ~x69 & ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n380_ = x66 ? ~new_n386_ : (x68 ? (~new_n385_ | x69) : new_n381_);
  assign new_n381_ = x67 ? new_n382_ : (~x69 | (~new_n384_ & (new_n372_ | new_n194_)));
  ...
  assign new_n385_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n376_ | new_n369_));
  assign new_n386_ = ~x67 & ((~new_n382_ & ~x68) | (new_n108_ & x45 & x68));
  assign new_n387_ = ~x66 & ~x67 & x68 & ~x69 & (new_n388_ | new_n389_);
  assign new_n388_ = ~x70 & ~new_n368_ & x71;
  assign new_n389_ = x70 & ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign z14 = x64 ? new_n408_ : (new_n426_ | (~new_n391_ & ~new_n112_));
  assign new_n391_ = x70 ? new_n397_ : ((~new_n392_ | ~x68) & (~x65 | ~new_n405_ | x68));
  assign new_n392_ = ~x69 & (x65 ? (~new_n393_ & ~x71) : (~new_n396_ & x71));
  assign new_n393_ = (new_n126_ | ~x62) & ~new_n394_ & ~new_n395_;
  assign new_n394_ = x72 & ((~x73 & (x74 ? x57 : x58)) | (x54 & x73 & ~x74));
  assign new_n395_ = ~x72 & ((x73 & (x74 ? x59 : x60)) | (x61 & ~x73 & x74));
  assign new_n396_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n397_ = (~x65 | ~new_n404_ | x68) & (x71 | (x65 ? (~new_n400_ | x68) : (~new_n398_ | ~x68)));
  assign new_n398_ = ~new_n399_ & ~x69;
  assign new_n399_ = (~x46 | (x32 & x47)) & (~x32 | x46 | ~x47);
  assign new_n400_ = x69 & ((~new_n401_ & x72) | ~new_n403_ | (~new_n402_ & ~x72));
  assign new_n401_ = (~x25 | ~x74) & (~x73 | (~x22 & ~x74));
  assign new_n402_ = (~x28 | x74) & (x73 | (~x29 & x74));
  assign new_n403_ = (~x27 | ~x73 | ~x74) & (~x26 | x73 | x74);
  assign new_n404_ = x69 & ((~new_n126_ & x62) | (x71 & (new_n394_ | new_n395_)));
  assign new_n405_ = x69 & x71 & ((~new_n126_ & x30) | new_n406_ | new_n407_);
  assign new_n406_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n407_ = ~x72 & ((x73 & (x74 ? x27 : x28)) | (x29 & ~x73 & x74));
  assign new_n408_ = ~x65 & (x66 ? new_n425_ : (x68 ? new_n424_ : ~new_n409_));
  assign new_n409_ = x67 ? new_n423_ : (~x69 | (~new_n410_ & ~new_n415_ & new_n418_));
  assign new_n410_ = x72 & (new_n413_ | new_n414_ | (x73 & (new_n411_ | ~new_n412_)));
  assign new_n411_ = x22 & (x70 ? ~x71 : (x71 & ~x74));
  assign new_n412_ = (~x71 | ((~x30 | x70 | ~x74) & (~x54 | ~x70 | x74))) & (~x70 | ~x74 | (~x62 & x71));
  assign new_n413_ = x74 & ((x25 & (x70 ? ~x71 : (x71 & ~x73))) | (x71 & ~x73 & x57 & x70));
  assign new_n414_ = x71 & ~x73 & ~x74 & (x70 ? x58 : x26);
  assign new_n415_ = x73 & ((~new_n416_ & x74) | (x71 & ~x72 & ~new_n417_ & ~x74));
  assign new_n416_ = (~x27 | (x70 ? x71 : (~x71 | x72))) & (~x71 | x72 | ~x59 | ~x70);
  assign new_n417_ = x70 ? ~x60 : ~x28;
  assign new_n418_ = ~new_n422_ & (x72 | (~new_n421_ & (x73 | (~new_n419_ & new_n420_))));
  assign new_n419_ = x29 & (x70 ? ~x71 : (x71 & x74));
  assign new_n420_ = (~x71 | ((~x30 | x70 | x74) & (~x61 | ~x70 | ~x74))) & (~x70 | x74 | (~x62 & x71));
  assign new_n421_ = ~x71 & ~x74 & x28 & x70;
  assign new_n422_ = ~x71 & ~x73 & ~x74 & x26 & x70;
  assign new_n423_ = (~x14 | (~x70 ^ x71)) & (x70 | x71 | ~x62 | ~x69) & (~x70 | (x71 ? ~x46 : x69));
  assign new_n424_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n393_);
  assign new_n425_ = ~x67 & ((~new_n423_ & ~x68) | (new_n108_ & x46 & x68));
  assign new_n426_ = x65 & ~x66 & ~x67 & x68 & ~new_n427_ & ~x69;
  assign new_n427_ = x70 ? (new_n399_ | x71) : (new_n396_ | ~x71);
  assign z15 = x64 ? (~x65 & (new_n446_ | new_n450_)) : (new_n429_ | (new_n451_ & x65));
  assign new_n429_ = ~new_n112_ & (x65 ? (x68 ? new_n441_ : new_n430_) : new_n445_);
  assign new_n430_ = x69 & (new_n431_ | ~new_n437_ | (~x73 & (new_n433_ | ~new_n435_)));
  assign new_n431_ = ~new_n194_ & ((~new_n432_ & x72) | (x29 & ~x72 & x73 & ~x74));
  assign new_n432_ = (~x27 | x73 | x74) & (~x73 | (x74 ? ~x31 : ~x23));
  assign new_n433_ = x74 & (~new_n434_ | (x26 & (x70 ? ~x71 : (x71 & x72))));
  assign new_n434_ = (~x71 | ((~x30 | x70 | x72) & (~x58 | ~x70 | ~x72))) & (~x70 | x72 | (~x62 & x71));
  assign new_n435_ = (new_n436_ | x72) & (~x59 | ~x70 | ~x71 | ~x72 | x74);
  assign new_n436_ = (~x31 | (x70 ? x71 : (~x71 | x74))) & (~x71 | x74 | ~x63 | ~x70);
  assign new_n437_ = (x72 | (~new_n438_ & ~new_n439_)) & (~x70 | ~x71 | ~new_n440_ | ~x72);
  assign new_n438_ = x74 & ((x28 & (x70 ? ~x71 : (x71 & x73))) | (x60 & x70 & x71 & x73));
  assign new_n439_ = x61 & x70 & x71 & x73 & ~x74;
  assign new_n440_ = x73 & (x74 ? x63 : x55);
  assign new_n441_ = ~x69 & ~x70 & ~new_n442_ & ~x71;
  assign new_n442_ = (new_n126_ | ~x63) & (new_n443_ | ~x72) & (new_n444_ | x72);
  assign new_n443_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n444_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n445_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n446_ = ~x66 & (x68 ? new_n447_ : (x67 ? ~new_n448_ : new_n430_));
  assign new_n447_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n442_);
  assign new_n448_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n449_ | ~x70);
  assign new_n449_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n450_ = x66 & ~x67 & ((~new_n448_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n451_ = ~x66 & new_n445_ & ~x67;
endmodule
