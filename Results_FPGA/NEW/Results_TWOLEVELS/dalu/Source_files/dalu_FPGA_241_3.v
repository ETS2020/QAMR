// Benchmark "FAU" written by ABC on Sat Aug  1 07:44:19 2020
...
module FAU ( 
  ...
  assign new_n115_ = x70 ? ((~x33 | (~new_n121_ & x32)) & (~x32 | x33 | new_n121_ | x71)) : (new_n116_ | ~x71);
  ...
  assign new_n132_ = (new_n109_ | new_n127_) & (new_n133_ | new_n126_);
  assign new_n133_ = (x68 | new_n129_ | ~x69) & (~new_n108_ | ~x49 | ~x68);
  assign new_n134_ = (new_n135_ | x68) & (x69 | x70 | ~x33 | ~x68);
  assign new_n135_ = (~x01 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x71 | ((~x17 | x69 | ~x70) & (~x49 | ~x69 | x70)));
  ...
  assign new_n187_ = (~x04 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n188_ | ~x70) & (x70 | x71 | ~x52 | ~x69);
  ...
  assign new_n205_ = (~x05 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n206_ | ~x70) & (x70 | x71 | ~x53 | ~x69);
  ...
  assign new_n214_ = ~new_n215_ & ~new_n216_ & (new_n126_ | ~x54);
  ...
  assign new_n219_ = x00 ? (x06 | (~x07 & (x07 | (~x05 & (x05 | (~x04 & (new_n120_ | x04))))))) : ~x06;
  ...
  assign new_n224_ = (~x06 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n225_ | ~x70) & (x70 | x71 | ~x54 | ~x69);
  ...
  assign new_n233_ = ~new_n234_ & ~new_n235_ & (new_n126_ | ~x55);
  ...
  assign new_n238_ = x00 ? (x07 | (~x06 & (x06 | (~x05 & (x05 | (~x04 & (new_n120_ | x04))))))) : ~x07;
  ...
  assign new_n243_ = (~x07 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n244_ | ~x70) & (x70 | x71 | ~x55 | ~x69);
  ...
  assign new_n249_ = (~x08 | (x00 & (~new_n119_ | ~new_n120_))) & (~x00 | x08 | (new_n119_ & new_n120_));
  ...
  assign new_n262_ = (~x08 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n263_ | ~x70) & (x70 | x71 | ~x56 | ~x69);
  ...
  assign new_n270_ = ~new_n271_ & ~new_n272_ & (new_n126_ | ~x57);
  ...
  assign new_n281_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n282_ | ~x70) & (x70 | x71 | ~x57 | ~x69);
  ...
  assign new_n310_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n311_ | ~x70) & (x70 | x71 | ~x58 | ~x69);
  ...
  assign new_n335_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n336_ | ~x70) & (x70 | x71 | ~x59 | ~x69);
  ...
  assign new_n360_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n361_ | ~x70) & (x70 | x71 | ~x60 | ~x69);
  assign new_n361_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n362_ = ~x67 & ((~new_n360_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n387_ : ~new_n380_)) : ~new_n364_;
  assign new_n364_ = ((~x66 & ~x67) | (~new_n365_ & ~new_n375_)) & (~x65 | x66 | ~new_n379_ | x67);
  ...
  assign new_n367_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n368_ = x61 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n369_ = x72 & ((~x73 & (x74 ? x56 : x57)) | (x53 & x73 & ~x74));
  assign new_n370_ = ~x72 & ((x73 & (x74 ? x58 : x59)) | (x60 & ~x73 & x74));
  assign new_n371_ = x71 & (new_n372_ | new_n373_ | new_n374_);
  assign new_n372_ = x29 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n376_ = ~new_n377_ & (x71 | (~new_n373_ & ~new_n374_)) & (~x71 | (~new_n369_ & ~new_n370_));
  assign new_n377_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x61 : x29);
  assign new_n378_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n379_ = x68 & ~x69 & (x70 ? new_n378_ : new_n367_);
  assign new_n380_ = x68 ? (~new_n384_ | x69) : (x67 ? new_n385_ : (new_n381_ | ~x69));
  assign new_n381_ = ((new_n383_ & ~new_n372_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n382_ & ~new_n368_));
  assign new_n382_ = ~new_n369_ & ~new_n370_;
  assign new_n383_ = ~new_n373_ & ~new_n374_;
  assign new_n384_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n382_ | new_n368_));
  assign new_n385_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n386_ | ~x70) & (x70 | x71 | ~x61 | ~x69);
  assign new_n386_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n387_ = ~x67 & ((~new_n385_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n410_ : ~new_n405_)) : ~new_n389_;
  assign new_n389_ = ~new_n403_ & (new_n112_ | (x70 ? new_n399_ : (~new_n390_ & ~new_n395_)));
  assign new_n390_ = x68 & ~x69 & (x65 ? (~new_n391_ & ~x71) : (~new_n394_ & x71));
  assign new_n391_ = (new_n126_ | ~x62) & (new_n392_ | ~x72) & (new_n393_ | x72);
  assign new_n392_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n393_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n394_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n395_ = x65 & ~x68 & x69 & ~new_n396_ & x71;
  assign new_n396_ = (new_n126_ | ~x30) & (new_n397_ | ~x72) & (new_n398_ | x72);
  assign new_n397_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n398_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n399_ = x65 ? (x68 | ~x69 | (~new_n400_ & new_n401_)) : (~x68 | ~new_n402_ | x69);
  assign new_n400_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n401_ = x71 ? (x72 ? new_n392_ : new_n393_) : (x72 ? new_n397_ : new_n398_);
  assign new_n402_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n403_ = x65 & ~x66 & ~x67 & x68 & ~new_n404_ & ~x69;
  assign new_n404_ = x70 ? ~new_n402_ : (new_n394_ | ~x71);
  assign new_n405_ = x68 ? (~new_n407_ | x69) : (x67 ? new_n408_ : (new_n406_ | ~x69));
  assign new_n406_ = (new_n396_ | (~x70 ^ x71)) & (~x70 | new_n391_ | ~x71);
  assign new_n407_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n391_);
  assign new_n408_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n409_ | ~x70) & (x70 | x71 | ~x62 | ~x69);
  assign new_n409_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n410_ = ~x67 & ((~new_n408_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x68 ? (~new_n423_ & ~x69) : (x64 ? new_n412_ : new_n422_);
  assign new_n412_ = ~x65 & (x66 ? (~new_n420_ & ~x67) : (x67 ? ~new_n420_ : (~new_n413_ & x69)));
  assign new_n413_ = (new_n414_ | (~x70 ^ x71)) & (~x70 | new_n417_ | ~x71);
  assign new_n414_ = (new_n126_ | ~x31) & (new_n415_ | ~x72) & (new_n416_ | x72);
  assign new_n415_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n416_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n417_ = (new_n126_ | ~x63) & (new_n418_ | ~x72) & (new_n419_ | x72);
  assign new_n418_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n419_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n420_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n421_ | ~x70) & (x70 | x71 | ~x63 | ~x69);
  assign new_n421_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n422_ = x65 & x69 & ~new_n413_ & ~new_n112_;
  assign new_n423_ = x64 ? (~new_n425_ | x65) : ((new_n424_ | new_n112_) & (~new_n426_ | ~x65));
  assign new_n424_ = (x70 | ((~x65 | new_n417_ | x71) & (~x15 | x65 | ~x71))) & (~x70 | x71 | ~x47 | x65);
  assign new_n425_ = ~x70 & ~x71 & ((~x66 & ~new_n417_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n426_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
endmodule
