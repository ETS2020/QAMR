// Benchmark "FAU" written by ABC on Sat Aug  1 07:38:04 2020
...
module FAU ( 
  ...
  assign z01 = x64 ? new_n133_ : (new_n132_ | (~new_n115_ & ~new_n113_));
  ...
  assign new_n126_ = (~x70 | (~new_n127_ & (new_n130_ | (x71 ? ~x48 : ~x16)))) & (~x16 | x70 | new_n130_ | ~x71);
  assign new_n127_ = ~new_n128_ & ~new_n129_;
  assign new_n128_ = x72 ? (~x73 | ~x74) : (x73 | x74);
  assign new_n129_ = ~x17 & (~x49 | ~x71);
  assign new_n130_ = (~x73 | (x74 & (x72 | ~x74))) & (x73 | ~x74) & (~x72 | x74);
  assign new_n131_ = ~x70 & ~x71 & ((~new_n130_ & x48) | (~new_n128_ & x49));
  assign new_n132_ = x65 & ~x66 & ~x67 & x68 & ~new_n116_ & ~x69;
  assign new_n133_ = ~x65 & ((~new_n134_ & (x66 ^ x67)) | (~x66 & ~new_n136_ & ~x67));
  assign new_n134_ = (x68 | (new_n135_ & (new_n108_ | ~x01))) & (~new_n107_ | ~x33 | ~x68);
  assign new_n135_ = (x70 | x71 | ~x49 | ~x69) & (~x70 | ((~x33 | ~x71) & (~x17 | x69)));
  assign new_n136_ = (new_n128_ | new_n137_) & (new_n110_ | new_n130_);
  assign new_n137_ = (~x49 | ((~x70 | ~x71 | x68 | ~x69) & (x70 | x71 | ~x68 | x69))) & (~x17 | x68 | ~x69 | ~x70);
  assign z02 = x64 ? (~new_n151_ & ~x65) : (new_n139_ | (new_n149_ & x65));
  assign new_n139_ = ~new_n113_ & ((x68 & ~new_n140_ & ~x69) | (x65 & ~x68 & ~new_n146_ & x69));
  assign new_n140_ = x65 ? (x70 | new_n145_ | x71) : (x70 ? (new_n143_ | x71) : (new_n141_ | ~x71));
  assign new_n141_ = (~x02 | (x00 & (~new_n142_ | ~new_n119_ | ~new_n120_))) & (~x00 | x02 | (new_n142_ & new_n119_ & new_n120_));
  ...
  assign new_n147_ = ~new_n128_ & ((x18 & (x70 ^ x71)) | (x50 & x70 & x71));
  assign new_n148_ = (new_n111_ | ((~x73 | (x74 & (x72 | ~x74))) & (~x72 | (x74 & (x73 | ~x74))))) & (~x70 | x72 | x73 | new_n129_ | ~x74);
  assign new_n149_ = ~x66 & ~x67 & x68 & ~new_n150_ & ~x69;
  assign new_n150_ = x70 ? (new_n143_ | x71) : (new_n141_ | ~x71);
  assign new_n151_ = x66 ? (new_n155_ | x67) : (x68 ? ~new_n156_ : new_n152_);
  assign new_n152_ = x67 ? new_n153_ : (~x69 | (~new_n147_ & new_n148_));
  assign new_n153_ = (~x02 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x50 | ~x69) & (new_n154_ | ~x70);
  assign new_n154_ = (~x34 | ~x71) & (~x18 | x69 | x71);
  assign new_n155_ = (new_n153_ | x68) & (~new_n107_ | ~x34 | ~x68);
  assign new_n156_ = ~x69 & ~x70 & ~x71 & (x67 ? x34 : ~new_n145_);
  assign z03 = x64 ? (~x65 & (new_n173_ | new_n177_)) : (new_n158_ | (new_n171_ & x65));
  assign new_n158_ = ~new_n113_ & ((x68 & ~new_n159_ & ~x69) | (x65 & new_n168_ & ~x68));
  ...
  assign new_n161_ = ~x07 & ~x08 & ~x09 & ~x04 & ~x05 & ~x06;
  ...
  assign new_n168_ = x69 & ((~new_n169_ & (x70 ^ x71)) | (x70 & (new_n170_ | (~new_n166_ & x71))));
  assign new_n169_ = (~x19 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (x73 | ~x74 | ~x18 | x72) & (~x16 | (x72 ? (x74 & (x73 | ~x74)) : (~x73 | ~x74)));
  assign new_n170_ = x17 & ~x72 & x73 & ~x74;
  assign new_n171_ = ~x66 & ~x67 & x68 & ~new_n172_ & ~x69;
  assign new_n172_ = x70 ? (new_n163_ | x71) : (new_n160_ | ~x71);
  assign new_n173_ = ~x66 & (x68 ? new_n174_ : (x67 ? ~new_n175_ : new_n168_));
  assign new_n174_ = ~x69 & ~x70 & ~x71 & (x67 ? x35 : ~new_n166_);
  assign new_n175_ = (~x03 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x51 | ~x69) & (new_n176_ | ~x70);
  assign new_n176_ = (~x35 | ~x71) & (~x19 | x69 | x71);
  assign new_n177_ = x66 & ~x67 & ((~new_n175_ & ~x68) | (new_n107_ & x35 & x68));
  assign z04 = x64 ? (~new_n193_ & ~x65) : ~new_n179_;
  assign new_n179_ = ((~x66 & ~x67) | (x65 ? new_n180_ : ~new_n190_)) & (~x65 | x66 | ~new_n190_ | x67);
  assign new_n180_ = x68 ? (x69 | ~new_n189_ | x70) : (~x69 | (~new_n181_ & (new_n185_ | ~x70)));
  assign new_n181_ = ~new_n182_ & (x72 ? ~new_n183_ : ~new_n184_);
  assign new_n182_ = x70 ^ ~x71;
  assign new_n183_ = (~x20 | ~x73 | ~x74) & (~x16 | (x74 & (x73 | ~x74)));
  assign new_n184_ = (x73 | (x74 ? ~x19 : ~x20)) & (~x18 | ~x73 | x74);
  assign new_n185_ = (~x71 | (x72 ? new_n187_ : new_n188_)) & (~new_n186_ | ~x17 | x72);
  assign new_n186_ = x73 & x74;
  assign new_n187_ = (~x52 | ~x73 | ~x74) & (~x48 | (x74 & (x73 | ~x74)));
  assign new_n188_ = x73 ? (x74 ? ~x49 : ~x50) : (x74 ? ~x51 : ~x52);
  assign new_n189_ = ~x71 & (x72 ? ~new_n187_ : ~new_n188_);
  ...
  assign new_n193_ = x66 ? (new_n199_ | x67) : (x68 ? ~new_n197_ : new_n194_);
  assign new_n194_ = x67 ? new_n195_ : (~x69 | (~new_n181_ & (new_n185_ | ~x70)));
  ...
  assign new_n199_ = (new_n195_ | x68) & (~new_n107_ | ~x36 | ~x68);
  assign z05 = x64 ? (~x65 & (new_n214_ | new_n218_)) : (new_n201_ | (new_n213_ & x65));
  assign new_n201_ = ~new_n113_ & (x65 ? (x68 ? new_n209_ : new_n202_) : new_n210_);
  assign new_n202_ = x69 & ((~new_n203_ & (x70 ^ x71)) | (x70 & (new_n208_ | (~new_n205_ & x71))));
  assign new_n203_ = x72 ? ((~x16 | (~x73 ^ x74)) & (~x21 | ~x73 | ~x74)) : new_n204_;
  ...
  assign new_n208_ = ~x73 & ~x74 & x17 & x72;
  assign new_n209_ = ~x69 & ~x70 & ~new_n205_ & ~x71;
  ...
  assign new_n213_ = ~x66 & new_n210_ & ~x67;
  assign new_n214_ = ~x66 & (x68 ? new_n215_ : (x67 ? ~new_n216_ : new_n202_));
  assign new_n215_ = ~x69 & ~x70 & ~x71 & (x67 ? x37 : ~new_n205_);
  assign new_n216_ = (~x05 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x53 | ~x69) & (new_n217_ | ~x70);
  assign new_n217_ = (~x37 | ~x71) & (~x21 | x69 | x71);
  assign new_n218_ = x66 & ~x67 & ((~new_n216_ & ~x68) | (new_n107_ & x37 & x68));
  assign z06 = x64 ? (~x65 & (new_n236_ | new_n240_)) : (new_n220_ | (new_n235_ & x65));
  assign new_n220_ = ~new_n113_ & (x65 ? (x68 ? new_n230_ : new_n221_) : new_n232_);
  assign new_n221_ = x69 & (new_n225_ | (~new_n222_ & ~new_n182_));
  assign new_n222_ = (~x22 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n223_ | x74) & (x72 | new_n224_ | ~x74);
  assign new_n223_ = (~x72 | (x73 ? ~x16 : ~x18)) & (~x20 | x72 | ~x73);
  assign new_n224_ = x73 ? ~x19 : ~x21;
  assign new_n225_ = x70 & (new_n229_ | (x71 & (new_n226_ | new_n227_ | new_n228_)));
  ...
  assign new_n229_ = ~x73 & x74 & x17 & x72;
  assign new_n230_ = ~x69 & ~x70 & ~new_n231_ & ~x71;
  assign new_n231_ = ~new_n226_ & ~new_n227_ & ~new_n228_;
  ...
  assign new_n236_ = ~x66 & (x68 ? new_n237_ : (x67 ? ~new_n238_ : new_n221_));
  assign new_n237_ = ~x69 & ~x70 & ~x71 & (x67 ? x38 : ~new_n231_);
  assign new_n238_ = (~x06 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x54 | ~x69) & (new_n239_ | ~x70);
  assign new_n239_ = (~x38 | ~x71) & (~x22 | x69 | x71);
  assign new_n240_ = x66 & ~x67 & ((~new_n238_ & ~x68) | (new_n107_ & x38 & x68));
  assign z07 = x64 ? (~x65 & (new_n254_ | new_n260_)) : (new_n242_ | (new_n253_ & x65));
  assign new_n242_ = ~new_n113_ & (x65 ? ~new_n243_ : new_n250_);
  ...
  assign new_n247_ = ~new_n248_ & ~new_n249_ & (new_n128_ | ~x55);
  ...
  assign new_n253_ = ~x66 & new_n250_ & ~x67;
  assign new_n254_ = ~x66 & (x68 ? new_n257_ : (x67 ? ~new_n258_ : new_n255_));
  assign new_n255_ = x69 & (new_n256_ | (~new_n244_ & ~new_n182_));
  assign new_n256_ = x70 & x71 & (new_n248_ | new_n249_ | (~new_n128_ & x55));
  assign new_n257_ = ~x69 & ~x70 & ~x71 & (x67 ? x39 : ~new_n247_);
  ...
  assign z09 = x64 ? (~x65 & (new_n297_ | new_n301_)) : (new_n281_ | (new_n295_ & x65));
  assign new_n281_ = ~new_n113_ & ((x68 & ~new_n282_ & ~x69) | (x65 & new_n289_ & ~x68));
  ...
  assign new_n288_ = ~x72 & ((x73 & (x74 ? x54 : x55)) | (x56 & ~x73 & x74));
  assign new_n289_ = x69 & (new_n293_ | (~new_n182_ & (~new_n290_ | (~new_n128_ & x25))));
  assign new_n290_ = (x72 | new_n292_ | ~x73) & (x73 | ((new_n291_ | ~x72) & (~x24 | x72 | ~x74)));
  assign new_n291_ = x74 ? ~x20 : ~x21;
  assign new_n292_ = x74 ? ~x22 : ~x23;
  assign new_n293_ = x70 & (new_n294_ | (x71 & (new_n286_ | new_n287_ | new_n288_)));
  assign new_n294_ = x73 & ~x74 & x17 & x72;
  assign new_n295_ = ~x66 & ~x67 & x68 & ~new_n296_ & ~x69;
  assign new_n296_ = x70 ? (new_n284_ | x71) : (new_n283_ | ~x71);
  assign new_n297_ = ~x66 & (x68 ? new_n298_ : (x67 ? ~new_n299_ : new_n289_));
  assign new_n298_ = ~x69 & ~x70 & ~x71 & (x67 ? x41 : ~new_n285_);
  assign new_n299_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x57 | ~x69) & (new_n300_ | ~x70);
  assign new_n300_ = (~x41 | ~x71) & (~x25 | x69 | x71);
  assign new_n301_ = x66 & ~x67 & ((~new_n299_ & ~x68) | (new_n107_ & x41 & x68));
  assign z10 = x64 ? (~x65 & (x66 ? new_n330_ : ~new_n323_)) : ~new_n303_;
  assign new_n303_ = (~new_n320_ | ~x65) & (new_n113_ | (x70 ? new_n315_ : new_n304_));
  ...
  assign new_n324_ = ((new_n326_ & ~new_n312_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n325_ & ~new_n308_));
  ...
  assign new_n330_ = ~x67 & ((~new_n328_ & ~x68) | (new_n107_ & x42 & x68));
  assign z11 = x64 ? (~x65 & (x66 ? new_n355_ : ~new_n348_)) : ~new_n332_;
  assign new_n332_ = (~x65 | x66 | ~new_n347_ | x67) & ((~x66 & ~x67) | (~new_n333_ & ~new_n343_));
  ...
  assign new_n335_ = (~x11 | (x00 & (x14 | x15 | x12 | x13))) & (~x00 | x11 | (~x14 & ~x15 & ~x12 & ~x13));
  assign new_n336_ = x59 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n337_ = x72 & ((~x73 & (x74 ? x54 : x55)) | (x51 & x73 & ~x74));
  assign new_n338_ = ~x72 & ((x73 & (x74 ? x56 : x57)) | (x58 & ~x73 & x74));
  ...
  assign new_n345_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x59 : x27);
  assign new_n346_ = ~x71 & ((x43 & (new_n125_ | ~x32)) | (x32 & ~new_n125_ & ~x43));
  assign new_n347_ = x68 & ~x69 & (x70 ? new_n346_ : (~new_n335_ & x71));
  assign new_n348_ = x68 ? (~new_n352_ | x69) : (x67 ? new_n353_ : (new_n349_ | ~x69));
  assign new_n349_ = ((new_n351_ & ~new_n340_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n350_ & ~new_n336_));
  ...
  assign new_n355_ = ~x67 & ((~new_n353_ & ~x68) | (new_n107_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n380_ : ~new_n373_)) : ~new_n357_;
  assign new_n357_ = (~x65 | x66 | ~new_n372_ | x67) & ((~x66 & ~x67) | (~new_n358_ & ~new_n368_));
  ...
  assign new_n363_ = ~x72 & ((x73 & (x74 ? x57 : x58)) | (x59 & ~x73 & x74));
  ...
  assign new_n374_ = ((new_n376_ & ~new_n365_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n375_ & ~new_n361_));
  ...
  assign new_n380_ = ~x67 & ((~new_n378_ & ~x68) | (new_n107_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n405_ : ~new_n398_)) : ~new_n382_;
  assign new_n382_ = (~x65 | x66 | ~new_n397_ | x67) & ((~x66 & ~x67) | (~new_n383_ & ~new_n393_));
  ...
  assign new_n399_ = ((new_n401_ & ~new_n390_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n400_ & ~new_n386_));
  ...
  assign new_n405_ = ~x67 & ((~new_n403_ & ~x68) | (new_n107_ & x45 & x68));
  ...
  assign new_n409_ = (new_n128_ | ~x62) & (new_n410_ | ~x72) & (new_n411_ | x72);
  ...
  assign new_n414_ = (new_n128_ | ~x30) & (new_n415_ | ~x72) & (new_n416_ | x72);
  ...
  assign new_n418_ = ~new_n128_ & (x71 ? x62 : x30);
  ...
  assign new_n428_ = ~x67 & ((~new_n426_ & ~x68) | (new_n107_ & x46 & x68));
  ...
  assign new_n432_ = (new_n128_ | ~x31) & (new_n433_ | ~x72) & (new_n434_ | x72);
  ...
  assign new_n440_ = x65 & x69 & ~new_n431_ & ~new_n113_;
  assign new_n441_ = x64 ? (~new_n443_ | x65) : ((~new_n444_ | ~x65) & (new_n442_ | new_n113_));
