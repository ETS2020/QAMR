// Benchmark "FAU" written by ABC on Sat Aug  1 07:42:02 2020
...
module FAU ( 
  ...
  assign new_n275_ = ~new_n194_ & (new_n276_ | new_n277_ | (~new_n126_ & x25));
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n341_ : ~new_n334_)) : ~new_n314_;
  assign new_n314_ = ~new_n332_ & (new_n112_ | (~new_n315_ & ~new_n325_));
  ...
  assign new_n320_ = (~x56 | ~x73 | ~x74) & (~x55 | x73 | x74);
  ...
  assign new_n325_ = x70 & (x65 ? (~x68 & ~new_n326_ & x69) : (x68 & new_n330_ & ~x69));
  assign new_n326_ = ~new_n327_ & (x71 | (~new_n323_ & ~new_n324_)) & (~x71 | (~new_n328_ & ~new_n329_));
  ...
  assign new_n333_ = x70 ? (new_n331_ | x71) : (new_n317_ | ~x71);
  assign new_n334_ = x68 ? (~new_n338_ | x69) : (x67 ? new_n340_ : (new_n335_ | ~x69));
  assign new_n335_ = ~new_n337_ & (~x70 | ~x71 | (new_n336_ & (new_n126_ | ~x59)));
  assign new_n336_ = ~new_n328_ & ~new_n329_;
  assign new_n337_ = ~new_n194_ & (new_n322_ | new_n323_ | new_n324_);
  assign new_n338_ = ~x70 & ~x71 & (x67 ? x43 : ~new_n339_);
  assign new_n339_ = ~new_n318_ & ~new_n319_ & new_n320_;
  assign new_n340_ = (~x11 | (x71 ? x70 : ~x69)) & (~x70 | ((~x43 | ~x71) & (~x27 | x69 | x71))) & (~x69 | x70 | x71);
  assign new_n341_ = ~x67 & ((~new_n340_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~new_n359_ & ~x65) : (new_n343_ | (x65 & new_n367_ & ~x66));
  assign new_n343_ = ~new_n112_ & (x70 ? ~new_n353_ : (new_n344_ | (new_n349_ & x65)));
  assign new_n344_ = x68 & ~x69 & (x65 ? (~new_n345_ & ~x71) : new_n348_);
  assign new_n345_ = (new_n346_ | x74) & (new_n347_ | ~x74) & (~x60 | (x72 ? (~x73 | ~x74) : x73));
  assign new_n346_ = (~x72 | (x73 ? ~x52 : ~x56)) & (~x58 | x72 | ~x73);
  assign new_n347_ = (~x55 | x73) & (x72 | (~x57 & x73));
  assign new_n348_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  assign new_n349_ = ~x68 & x69 & x71 & (new_n350_ | new_n351_ | new_n352_);
  assign new_n350_ = ~new_n126_ & x28;
  ...
  assign new_n354_ = ~new_n355_ & (x71 | (~new_n351_ & ~new_n352_)) & (~x71 | (~new_n356_ & ~new_n357_));
  ...
  assign new_n359_ = x66 ? (new_n366_ | x67) : (x68 ? ~new_n365_ : new_n360_);
  assign new_n360_ = x67 ? new_n361_ : (~x69 | (~new_n363_ & ~new_n364_));
  assign new_n361_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n362_ | ~x70);
  assign new_n362_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n363_ = ~new_n194_ & (new_n351_ | new_n352_ | (~new_n126_ & x28));
  assign new_n364_ = x70 & x71 & ((~new_n126_ & x60) | new_n356_ | new_n357_);
  assign new_n365_ = ~x69 & ~x70 & ~x71 & (x67 ? x44 : ~new_n345_);
  assign new_n366_ = (~new_n108_ | ~x44 | ~x68) & (new_n361_ | x68);
  assign new_n367_ = ~x67 & x68 & ~x69 & (x70 ? new_n358_ : new_n348_);
  assign z13 = x64 ? (~x65 & (x66 ? new_n395_ : ~new_n387_)) : ~new_n369_;
  assign new_n369_ = ((~x66 & ~x67) | (~new_n370_ & ~new_n380_)) & (~x65 | x66 | ~new_n386_ | x67);
  ...
  assign new_n373_ = x61 & (x72 ? (x73 & x74) : ~x74);
  assign new_n374_ = ~x73 & ((x72 & (x74 ? x56 : x57)) | (x60 & ~x72 & x74));
  assign new_n375_ = x73 & ((x53 & ~x74) | (~x72 & (x58 | ~x74)));
  ...
  assign new_n380_ = x70 & (x65 ? (~x68 & ~new_n381_ & x69) : (x68 & new_n385_ & ~x69));
  assign new_n381_ = ~new_n382_ & (x71 | (~new_n378_ & ~new_n379_)) & (~x71 | (~new_n383_ & ~new_n384_));
  ...
  assign new_n386_ = x68 & ~x69 & (x70 ? new_n385_ : new_n372_);
  assign new_n387_ = x68 ? (~new_n391_ | x69) : (x67 ? new_n393_ : (new_n388_ | ~x69));
  assign new_n388_ = ~new_n390_ & (~x70 | ~x71 | (new_n389_ & (new_n126_ | ~x61)));
  assign new_n389_ = ~new_n383_ & ~new_n384_;
  assign new_n390_ = ~new_n194_ & (new_n377_ | new_n378_ | new_n379_);
  assign new_n391_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n392_ | new_n373_));
  assign new_n392_ = ~new_n374_ & ~new_n375_;
  ...
  assign new_n407_ = x65 ? (x68 | ~x69 | (~new_n408_ & new_n409_)) : (~x68 | ~new_n411_ | x69);
  assign new_n408_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n409_ = x71 ? (~new_n400_ & ~new_n410_) : (x72 ? new_n405_ : new_n406_);
  assign new_n410_ = ~x72 & ((x61 & ~x73 & x74) | (x73 & (x74 ? x59 : x60)));
  assign new_n411_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n412_ = x66 ? (new_n418_ | x67) : (x68 ? ~new_n417_ : new_n413_);
  assign new_n413_ = x67 ? new_n414_ : (~x69 | (~new_n416_ & (new_n404_ | new_n194_)));
  assign new_n414_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n415_ | ~x70);
  assign new_n415_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n416_ = x70 & x71 & ((~new_n126_ & x62) | new_n400_ | new_n410_);
  assign new_n417_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n399_);
  assign new_n418_ = (~new_n108_ | ~x46 | ~x68) & (new_n414_ | x68);
  assign new_n419_ = ~x67 & x68 & ~x69 & (x70 ? new_n411_ : new_n402_);
  assign z15 = x64 ? (~new_n433_ & ~x65) : (new_n421_ | (new_n439_ & x65));
  assign new_n421_ = ~new_n112_ & (x65 ? (x68 ? new_n429_ : new_n422_) : new_n432_);
  assign new_n422_ = x69 & (new_n426_ | (~new_n423_ & ~new_n194_));
  ...
  assign new_n426_ = x70 & x71 & ((~new_n126_ & x63) | new_n427_ | new_n428_);
  ...
  assign new_n430_ = (~x63 | ((x73 | x74) & (~x72 | ~x73 | ~x74))) & ~new_n428_ & (new_n431_ | ~x72);
  assign new_n431_ = (~x55 | x74) & (x73 | (~x58 & x74));
  assign new_n432_ = x68 & ~x69 & ((x47 & x70 & ~x71) | (x15 & ~x70 & x71));
  assign new_n433_ = x66 ? (new_n438_ | x67) : (x68 ? ~new_n437_ : new_n434_);
  assign new_n434_ = x67 ? new_n435_ : (~x69 | (~new_n426_ & (new_n423_ | new_n194_)));
  assign new_n435_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n436_ | ~x70);
  assign new_n436_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n437_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n430_);
  assign new_n438_ = (~new_n108_ | ~x47 | ~x68) & (new_n435_ | x68);
  assign new_n439_ = ~x66 & new_n432_ & ~x67;
endmodule
