// Benchmark "FAU" written by ABC on Sat Aug  1 07:38:47 2020
...
module FAU ( 
  ...
  assign new_n102_ = new_n95_ & new_n103_ & ~x05 & ~x08 & ~x09 & ~x10;
  ...
  assign new_n114_ = (~x01 | (x00 & (~new_n116_ | ~new_n117_ | ~new_n96_ | ~new_n115_))) & (~x00 | x01 | (new_n116_ & new_n117_ & new_n96_ & new_n115_));
  ...
  assign new_n190_ = x00 ? (x04 | (~x06 & ~x07 & (x06 | x07 | (~x05 & (new_n117_ | x05))))) : ~x04;
  ...
  assign z05 = (~x65 & ((new_n209_ & x64) | (~new_n199_ & ~x69))) | (~x64 & ~new_n216_ & x65);
  assign new_n199_ = (~x68 | (x64 ? ~new_n203_ : ~new_n200_)) & (~x21 | ~x64 | ~new_n208_ | x68);
  assign new_n200_ = ~new_n99_ & ((new_n201_ & ~x70) | (~x32 & x70 & ~x71));
  assign new_n201_ = x71 & (x00 ? (~x05 & (~new_n103_ | x04 | (new_n202_ & ~x04))) : x05);
  assign new_n202_ = ~x06 & ~x07 & (x14 | x15 | x12 | x13);
  assign new_n203_ = ~x70 & ~x71 & (x67 ? ~x66 : ~new_n204_);
  assign new_n204_ = (~x72 | (new_n206_ & (~x48 | new_n205_ | x66))) & ~x66 & (new_n207_ | x72);
  assign new_n205_ = ~x73 ^ x74;
  assign new_n206_ = (~x49 | x73 | x74) & (~x53 | ~x73 | ~x74);
  assign new_n207_ = x73 ? (x74 ? ~x50 : ~x51) : (x74 ? ~x52 : ~x53);
  assign new_n208_ = x70 & ~x71 & (x66 ^ x67);
  assign new_n209_ = ~x68 & (x66 ? (~new_n215_ & ~x67) : (x67 ? ~new_n215_ : (~new_n210_ & x69)));
  assign new_n210_ = (~x70 | new_n213_ | ~x71) & ((~x70 ^ x71) | (x72 ? new_n211_ : new_n214_));
  assign new_n211_ = new_n212_ & (new_n205_ | ~x16);
  assign new_n212_ = (~x17 | x73 | x74) & (~x21 | ~x73 | ~x74);
  assign new_n213_ = x72 ? (new_n206_ & (new_n205_ | ~x48)) : new_n207_;
  assign new_n214_ = x73 ? (x74 ? ~x18 : ~x19) : (x74 ? ~x20 : ~x21);
  assign new_n215_ = (~x05 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x37 | ~x70 | ~x71) & (x70 | x71 | ~x53 | ~x69);
  assign new_n216_ = x70 ? new_n222_ : (~new_n217_ & ~new_n221_);
  assign new_n217_ = ~new_n99_ & (x72 ? (new_n218_ | ~new_n219_) : ~new_n220_);
  assign new_n218_ = ~new_n205_ & ((~x69 & ~x71 & x48 & x68) | (x69 & x71 & x16 & ~x68));
  assign new_n219_ = x68 ? (x69 | new_n206_ | x71) : (~x69 | new_n212_ | ~x71);
  assign new_n220_ = x68 ? (x69 | new_n207_ | x71) : (~x69 | new_n214_ | ~x71);
  assign new_n221_ = ~x66 & ~x67 & x68 & new_n201_ & ~x69;
  assign new_n222_ = ~new_n225_ & (x68 | ~x69 | new_n99_ | (~new_n223_ & ~new_n224_));
  assign new_n223_ = x72 & ((~new_n122_ & ~new_n205_) | (~new_n212_ & ~x71) | (~new_n206_ & x71));
  assign new_n224_ = ~x72 & (x71 ? ~new_n207_ : ~new_n214_);
  assign new_n225_ = new_n99_ & ~x32 & x68 & ~x69 & ~x71;
  assign z06 = x64 ? (~x65 & (new_n240_ | new_n244_)) : (new_n227_ | (new_n239_ & x65));
  assign new_n227_ = ~new_n99_ & (x65 ? (x68 ? new_n235_ : new_n228_) : new_n236_);
  assign new_n228_ = x69 & ((~new_n229_ & (x70 ^ x71)) | (x70 & ~new_n232_ & x71));
  assign new_n229_ = (new_n161_ | ~x22) & (new_n231_ | x72) & (new_n230_ | ~x72);
  assign new_n230_ = (x73 | (x74 ? ~x17 : ~x18)) & (~x16 | ~x73 | x74);
  assign new_n231_ = (~x73 | (x74 ? ~x19 : ~x20)) & (~x21 | x73 | ~x74);
  assign new_n232_ = ~new_n233_ & ~new_n234_ & (new_n161_ | ~x54);
  assign new_n233_ = x72 & ((~x73 & (x74 ? x49 : x50)) | (x48 & x73 & ~x74));
  assign new_n234_ = ~x72 & ((x53 & ~x73 & x74) | (x73 & (x74 ? x51 : x52)));
  assign new_n235_ = ~x69 & ~x70 & ~new_n232_ & ~x71;
  assign new_n236_ = x68 & ~x69 & (x70 ? (~new_n238_ & ~x71) : (~new_n237_ & x71));
  assign new_n237_ = x00 ? (x06 | (~x07 & (x07 | (~x04 & (x04 | (~x05 & (new_n117_ | x05))))))) : ~x06;
  assign new_n238_ = ~x32 ^ x38;
  assign new_n239_ = ~x66 & new_n236_ & ~x67;
  assign new_n240_ = ~x66 & (x68 ? new_n241_ : (x67 ? ~new_n242_ : new_n228_));
  assign new_n241_ = ~x69 & ~x70 & ~x71 & (x67 ? x38 : ~new_n232_);
  assign new_n242_ = (~x06 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x54 | ~x69) & (new_n243_ | ~x70);
  assign new_n243_ = (~x38 | ~x71) & (~x22 | x69 | x71);
  assign new_n244_ = x66 & ~x67 & ((~new_n242_ & ~x68) | (new_n106_ & x38 & x68));
  assign z07 = x64 ? (~x65 & (new_n259_ | new_n263_)) : (new_n246_ | (new_n258_ & x65));
  assign new_n246_ = ~new_n99_ & (x65 ? (x68 ? new_n254_ : new_n247_) : new_n255_);
  assign new_n247_ = x69 & ((~new_n248_ & (x70 ^ x71)) | (x70 & ~new_n251_ & x71));
  assign new_n248_ = (new_n161_ | ~x23) & (new_n250_ | x72) & (new_n249_ | ~x72);
  assign new_n249_ = (x73 | (x74 ? ~x18 : ~x19)) & (~x16 | ~x73 | x74);
  assign new_n250_ = (~x73 | (x74 ? ~x20 : ~x21)) & (~x22 | x73 | ~x74);
  assign new_n251_ = ~new_n252_ & ~new_n253_ & (new_n161_ | ~x55);
  ...
  assign new_n256_ = x00 ? (x07 | (~x06 & (x06 | (~x04 & (x04 | (~x05 & (new_n117_ | x05))))))) : ~x07;
  assign new_n257_ = ~x32 ^ x39;
  ...
  assign new_n261_ = (~x07 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x55 | ~x69) & (new_n262_ | ~x70);
  assign new_n262_ = (~x39 | ~x71) & (~x23 | x69 | x71);
  assign new_n263_ = x66 & ~x67 & ((~new_n261_ & ~x68) | (new_n106_ & x39 & x68));
  assign z08 = x64 ? (~x65 & (new_n279_ | new_n283_)) : (new_n265_ | (new_n277_ & x65));
  assign new_n265_ = ~new_n99_ & ((x65 & new_n273_ & ~x68) | (x68 & ~new_n266_ & ~x69));
  assign new_n266_ = x65 ? (x70 | new_n270_ | x71) : (x70 ? (new_n268_ | x71) : (new_n267_ | ~x71));
  assign new_n267_ = (~x08 | (x00 & (~new_n116_ | ~new_n117_))) & (~x00 | x08 | (new_n116_ & new_n117_));
  assign new_n268_ = (~x40 | (x32 & (~new_n269_ | x41 | x42 | x43))) & (~x32 | x40 | (new_n269_ & ~x41 & ~x42 & ~x43));
  assign new_n269_ = ~x44 & ~x45 & ~x46 & ~x47;
  assign new_n270_ = (new_n161_ | ~x56) & (new_n272_ | x72) & (new_n271_ | ~x72);
  ...
  assign new_n274_ = (new_n161_ | ~x24) & (new_n276_ | x72) & (new_n275_ | ~x72);
  ...
  assign new_n280_ = ~x69 & ~x70 & ~x71 & (x67 ? x40 : ~new_n270_);
  assign new_n281_ = (~x08 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x56 | ~x69) & (new_n282_ | ~x70);
  assign new_n282_ = (~x40 | ~x71) & (~x24 | x69 | x71);
  assign new_n283_ = x66 & ~x67 & ((~new_n281_ & ~x68) | (new_n106_ & x40 & x68));
  assign z09 = x64 ? (~x65 & (new_n299_ | new_n303_)) : (new_n285_ | (new_n297_ & x65));
  assign new_n285_ = ~new_n99_ & ((x65 & new_n293_ & ~x68) | (x68 & ~new_n286_ & ~x69));
  assign new_n286_ = x65 ? (x70 | new_n290_ | x71) : (x70 ? (new_n288_ | x71) : (new_n287_ | ~x71));
  assign new_n287_ = (~x09 | (~new_n159_ & x00)) & (~x00 | new_n159_ | x09);
  assign new_n288_ = (~x41 | (x32 & (~new_n289_ | x42 | x43 | x44))) & (~x32 | x41 | (new_n289_ & ~x42 & ~x43 & ~x44));
  assign new_n289_ = ~x45 & ~x46 & ~x47;
  assign new_n290_ = ~new_n291_ & ~new_n292_ & (new_n161_ | ~x57);
  ...
  assign new_n294_ = (new_n161_ | ~x25) & (new_n296_ | x72) & (new_n295_ | ~x72);
  ...
  assign new_n300_ = ~x69 & ~x70 & ~x71 & (x67 ? x41 : ~new_n290_);
  assign new_n301_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x57 | ~x69) & (new_n302_ | ~x70);
  assign new_n302_ = (~x41 | ~x71) & (~x25 | x69 | x71);
  assign new_n303_ = x66 & ~x67 & ((~new_n301_ & ~x68) | (new_n106_ & x41 & x68));
  assign z10 = x64 ? (~x65 & (x66 ? new_n332_ : ~new_n325_)) : ~new_n305_;
  assign new_n305_ = (new_n99_ | (x70 ? new_n317_ : new_n306_)) & (~new_n322_ | ~x65);
  assign new_n306_ = (~x68 | x69 | (x65 ? ~new_n309_ : ~new_n307_)) & (~x65 | x68 | ~new_n313_ | ~x69);
  assign new_n307_ = x71 & ((x10 & (new_n308_ | ~x00)) | (x00 & ~new_n308_ & ~x10));
  ...
  assign new_n317_ = x65 ? (x68 | new_n318_ | ~x69) : (~x68 | ~new_n320_ | x69);
  assign new_n318_ = ~new_n319_ & (x71 | (~new_n315_ & ~new_n316_)) & (~x71 | (~new_n311_ & ~new_n312_));
  assign new_n319_ = (x71 ? x58 : x26) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n320_ = ~x71 & ((x42 & (new_n321_ | ~x32)) | (x32 & ~new_n321_ & ~x42));
  assign new_n321_ = ~x43 & ~x44 & ~x45 & ~x46 & ~x47;
  assign new_n322_ = ~x66 & ~x67 & x68 & ~x69 & (new_n323_ | new_n324_);
  assign new_n323_ = ~x70 & x71 & ((x10 & (new_n308_ | ~x00)) | (x00 & ~new_n308_ & ~x10));
  assign new_n324_ = x70 & ~x71 & ((x42 & (new_n321_ | ~x32)) | (x32 & ~new_n321_ & ~x42));
  assign new_n325_ = x68 ? (~new_n329_ | x69) : (x67 ? new_n330_ : (new_n326_ | ~x69));
  assign new_n326_ = ((~x70 ^ x71) | (new_n328_ & ~new_n314_)) & (~x70 | ~x71 | (new_n327_ & ~new_n310_));
  assign new_n327_ = ~new_n311_ & ~new_n312_;
  assign new_n328_ = ~new_n315_ & ~new_n316_;
  assign new_n329_ = ~x70 & ~x71 & (x67 ? x42 : (~new_n327_ | new_n310_));
  ...
  assign new_n348_ = ~x71 & ((x43 & (new_n269_ | ~x32)) | (x32 & ~new_n269_ & ~x43));
  ...
  assign new_n373_ = ~x71 & ((x44 & (new_n289_ | ~x32)) | (x32 & ~new_n289_ & ~x44));
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n407_ : ~new_n400_)) : ~new_n384_;
  assign new_n384_ = ((~x66 & ~x67) | (~new_n385_ & ~new_n395_)) & (~x65 | x66 | ~new_n399_ | x67);
  ...
  assign new_n392_ = x29 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n393_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n394_ = ~x72 & ((x28 & ~x73 & x74) | (x73 & (x74 ? x26 : x27)));
  assign new_n395_ = x70 & (x65 ? (~x68 & ~new_n396_ & x69) : (x68 & new_n398_ & ~x69));
  assign new_n396_ = ~new_n397_ & (x71 | (~new_n393_ & ~new_n394_)) & (~x71 | (~new_n389_ & ~new_n390_));
  assign new_n397_ = (x71 ? x61 : x29) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n398_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n399_ = x68 & ~x69 & (x70 ? new_n398_ : new_n387_);
  assign new_n400_ = x68 ? (~new_n404_ | x69) : (x67 ? new_n405_ : (new_n401_ | ~x69));
  assign new_n401_ = ((~x70 ^ x71) | (new_n403_ & ~new_n392_)) & (~x70 | ~x71 | (new_n402_ & ~new_n388_));
  assign new_n402_ = ~new_n389_ & ~new_n390_;
  assign new_n403_ = ~new_n393_ & ~new_n394_;
  assign new_n404_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n402_ | new_n388_));
  assign new_n405_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n406_ | ~x70);
  assign new_n406_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n407_ = ~x67 & ((~new_n405_ & ~x68) | (new_n106_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n430_ : ~new_n425_)) : ~new_n409_;
  assign new_n409_ = ~new_n423_ & (new_n99_ | (x70 ? new_n419_ : (~new_n410_ & ~new_n415_)));
  assign new_n410_ = x68 & ~x69 & (x65 ? (~new_n411_ & ~x71) : (~new_n414_ & x71));
  assign new_n411_ = (new_n161_ | ~x62) & (new_n413_ | x72) & (new_n412_ | ~x72);
  assign new_n412_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n413_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n414_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n415_ = x65 & ~x68 & x69 & ~new_n416_ & x71;
  assign new_n416_ = (new_n161_ | ~x30) & (new_n418_ | x72) & (new_n417_ | ~x72);
  assign new_n417_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n418_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n419_ = x65 ? (x68 | ~x69 | (~new_n420_ & new_n421_)) : (~x68 | ~new_n422_ | x69);
  assign new_n420_ = ~new_n161_ & (x71 ? x62 : x30);
  assign new_n421_ = x71 ? (x72 ? new_n412_ : new_n413_) : (x72 ? new_n417_ : new_n418_);
  assign new_n422_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n423_ = x65 & ~x66 & ~x67 & x68 & ~new_n424_ & ~x69;
  assign new_n424_ = x70 ? ~new_n422_ : (new_n414_ | ~x71);
  assign new_n425_ = x68 ? (~new_n427_ | x69) : (x67 ? new_n428_ : (new_n426_ | ~x69));
  assign new_n426_ = (new_n416_ | (~x70 ^ x71)) & (~x70 | new_n411_ | ~x71);
  assign new_n427_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n411_);
  assign new_n428_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n429_ | ~x70);
  assign new_n429_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n430_ = ~x67 & ((~new_n428_ & ~x68) | (new_n106_ & x46 & x68));
  assign z15 = x68 ? (~new_n443_ & ~x69) : (x64 ? new_n432_ : new_n442_);
  assign new_n432_ = ~x65 & (x66 ? (~new_n440_ & ~x67) : (x67 ? ~new_n440_ : (~new_n433_ & x69)));
  assign new_n433_ = (new_n434_ | (~x70 ^ x71)) & (~x70 | new_n437_ | ~x71);
  assign new_n434_ = (new_n161_ | ~x31) & (new_n436_ | x72) & (new_n435_ | ~x72);
  assign new_n435_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n436_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n437_ = (new_n161_ | ~x63) & (new_n439_ | x72) & (new_n438_ | ~x72);
  assign new_n438_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n439_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n440_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n441_ | ~x70);
  assign new_n441_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n442_ = x65 & x69 & ~new_n433_ & ~new_n99_;
  assign new_n443_ = x64 ? (~new_n445_ | x65) : ((new_n444_ | new_n99_) & (~new_n446_ | ~x65));
  assign new_n444_ = (x70 | ((~x65 | new_n437_ | x71) & (~x15 | x65 | ~x71))) & (~x70 | x71 | ~x47 | x65);
  assign new_n445_ = ~x70 & ~x71 & ((~x66 & ~new_n437_ & ~x67) | (x47 & (x66 ^ x67)));
