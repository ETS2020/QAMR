// Benchmark "FAU" written by ABC on Sat Aug  1 07:40:50 2020
...
module FAU ( 
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n336_ : ~new_n329_)) : ~new_n314_;
  assign new_n314_ = ((~x66 & ~x67) | (~new_n315_ & ~new_n324_)) & (~x65 | x66 | ~new_n328_ | x67);
  ...
  assign new_n321_ = x71 & ((~new_n126_ & x27) | new_n322_ | new_n323_);
  assign new_n322_ = x72 & ((~x73 & (x74 ? x22 : x23)) | (x19 & x73 & ~x74));
  assign new_n323_ = ~x72 & ((x26 & ~x73 & x74) | (x73 & (x74 ? x24 : x25)));
  assign new_n324_ = x70 & (x65 ? (~x68 & ~new_n325_ & x69) : (x68 & new_n327_ & ~x69));
  assign new_n325_ = ~new_n326_ & (x71 | (~new_n322_ & ~new_n323_)) & (~x71 | (~new_n319_ & ~new_n320_));
  assign new_n326_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x59 : x27);
  assign new_n327_ = ~x71 & ((x43 & (new_n124_ | ~x32)) | (x32 & ~new_n124_ & ~x43));
  assign new_n328_ = x68 & ~x69 & (x70 ? new_n327_ : (~new_n317_ & x71));
  assign new_n329_ = x68 ? (~new_n333_ | x69) : (x67 ? new_n334_ : (new_n330_ | ~x69));
  assign new_n330_ = (new_n332_ | (~x70 ^ x71)) & (~x70 | new_n331_ | ~x71);
  assign new_n331_ = ~new_n318_ & ~new_n319_ & ~new_n320_;
  assign new_n332_ = (new_n126_ | ~x27) & ~new_n322_ & ~new_n323_;
  assign new_n333_ = ~x70 & ~x71 & (x67 ? x43 : ~new_n331_);
  assign new_n334_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n335_ | ~x70);
  assign new_n335_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n336_ = ~x67 & ((~new_n334_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n364_ : ~new_n357_)) : ~new_n338_;
  assign new_n338_ = ~new_n355_ & (new_n112_ | (~new_n339_ & ~new_n349_));
  ...
  assign new_n341_ = (~x12 | (x00 & (x13 | x14 | x15))) & (~x00 | x12 | (~x13 & ~x14 & ~x15));
  assign new_n342_ = x72 & ((x55 & x74) | (x73 & (x52 | x74)));
  assign new_n343_ = ~x72 & ((x58 & ~x74) | (~x73 & (x59 | ~x74)));
  assign new_n344_ = (~x57 | ~x73 | ~x74) & (~x56 | x73 | x74);
  assign new_n345_ = x71 & (new_n346_ | new_n347_ | new_n348_);
  assign new_n346_ = x28 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n347_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n348_ = ~x72 & ((x27 & ~x73 & x74) | (x73 & (x74 ? x25 : x26)));
  assign new_n349_ = x70 & (x65 ? (~x68 & ~new_n350_ & x69) : (x68 & new_n354_ & ~x69));
  assign new_n350_ = ~new_n351_ & (x71 | (~new_n347_ & ~new_n348_)) & (~x71 | (~new_n352_ & ~new_n353_));
  assign new_n351_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  ...
  assign new_n356_ = x70 ? ~new_n354_ : (new_n341_ | ~x71);
  assign new_n357_ = x68 ? (~new_n361_ | x69) : (x67 ? new_n363_ : (new_n358_ | ~x69));
  assign new_n358_ = ~new_n360_ & (~x70 | ~x71 | (new_n359_ & (new_n126_ | ~x60)));
  assign new_n359_ = ~new_n352_ & ~new_n353_;
  assign new_n360_ = ~new_n194_ & (new_n346_ | new_n347_ | new_n348_);
  assign new_n361_ = ~x70 & ~x71 & (x67 ? x44 : ~new_n362_);
  assign new_n362_ = ~new_n342_ & ~new_n343_ & new_n344_;
  assign new_n363_ = (~x12 | (x71 ? x70 : ~x69)) & (~x70 | ((~x44 | ~x71) & (~x28 | x69 | x71))) & (~x69 | x70 | x71);
  assign new_n364_ = ~x67 & ((~new_n363_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~new_n382_ & ~x65) : (new_n366_ | (x65 & new_n390_ & ~x66));
  assign new_n366_ = ~new_n112_ & (x70 ? ~new_n376_ : (new_n367_ | (new_n372_ & x65)));
  assign new_n367_ = x68 & ~x69 & (x65 ? (~new_n368_ & ~x71) : new_n371_);
  assign new_n368_ = (new_n369_ | x74) & (new_n370_ | ~x74) & (~x61 | (x72 ? (~x73 | ~x74) : x73));
  assign new_n369_ = (~x72 | (x73 ? ~x53 : ~x57)) & (~x59 | x72 | ~x73);
  assign new_n370_ = (~x56 | x73) & (x72 | (~x58 & x73));
  assign new_n371_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n372_ = ~x68 & x69 & x71 & (new_n373_ | new_n374_ | new_n375_);
  assign new_n373_ = ~new_n126_ & x29;
  assign new_n374_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n375_ = ~x72 & ((x28 & ~x73 & x74) | (x73 & (x74 ? x26 : x27)));
  assign new_n376_ = x65 ? (x68 | new_n377_ | ~x69) : (~x68 | ~new_n381_ | x69);
  assign new_n377_ = ~new_n378_ & (x71 | (~new_n374_ & ~new_n375_)) & (~x71 | (~new_n379_ & ~new_n380_));
  ...
  assign new_n382_ = x66 ? (new_n389_ | x67) : (x68 ? ~new_n388_ : new_n383_);
  assign new_n383_ = x67 ? new_n384_ : (~x69 | (~new_n386_ & ~new_n387_));
  assign new_n384_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n385_ | ~x70);
  assign new_n385_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n386_ = ~new_n194_ & (new_n374_ | new_n375_ | (~new_n126_ & x29));
  assign new_n387_ = x70 & x71 & ((~new_n126_ & x61) | new_n379_ | new_n380_);
  assign new_n388_ = ~x69 & ~x70 & ~x71 & (x67 ? x45 : ~new_n368_);
  assign new_n389_ = (~new_n108_ | ~x45 | ~x68) & (new_n384_ | x68);
  assign new_n390_ = ~x67 & x68 & ~x69 & (x70 ? new_n381_ : new_n371_);
  assign z14 = x64 ? (~x65 & (x66 ? new_n417_ : ~new_n410_)) : ~new_n392_;
  assign new_n392_ = ~new_n408_ & (new_n112_ | (x70 ? new_n402_ : new_n393_));
  ...
  assign new_n396_ = x62 & (x72 ? (x73 & x74) : ~x74);
  assign new_n397_ = ~x73 & ((x72 & (x74 ? x57 : x58)) | (x61 & ~x72 & x74));
  assign new_n398_ = x73 & ((x54 & ~x74) | (~x72 & (x59 | ~x74)));
  assign new_n399_ = (new_n126_ | ~x30) & (new_n400_ | ~x72) & (new_n401_ | x72);
  assign new_n400_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n401_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n402_ = x65 ? (x68 | ~x69 | (~new_n403_ & new_n404_)) : (~x68 | ~new_n407_ | x69);
  assign new_n403_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n404_ = x71 ? (x72 ? new_n405_ : new_n406_) : (x72 ? new_n400_ : new_n401_);
  ...
  assign new_n409_ = x70 ? ~new_n407_ : (new_n395_ | ~x71);
  assign new_n410_ = x68 ? (~new_n413_ | x69) : (x67 ? new_n415_ : (new_n411_ | ~x69));
  assign new_n411_ = (new_n399_ | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n412_ & (new_n126_ | ~x62)));
  assign new_n412_ = x72 ? new_n405_ : new_n406_;
  assign new_n413_ = ~x70 & ~x71 & (x67 ? x46 : (~new_n414_ | new_n396_));
  assign new_n414_ = ~new_n397_ & ~new_n398_;
  assign new_n415_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n416_ | ~x70);
  assign new_n416_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n417_ = ~x67 & ((~new_n415_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~new_n431_ & ~x65) : ~new_n419_;
  assign new_n419_ = ((~x66 & ~x67) | (x65 ? new_n420_ : ~new_n430_)) & (~x65 | x66 | ~new_n430_ | x67);
  assign new_n420_ = x68 ? (x69 | ~new_n427_ | x70) : (~x69 | (~new_n421_ & (~new_n424_ | ~x70)));
  assign new_n421_ = ~new_n194_ & (new_n422_ | new_n423_ | (~new_n126_ & x31));
  assign new_n422_ = x72 & ((~x73 & (x74 ? x26 : x27)) | (x23 & x73 & ~x74));
  assign new_n423_ = ~x72 & ((x30 & ~x73 & x74) | (x73 & (x74 ? x28 : x29)));
  assign new_n424_ = x71 & ((~new_n126_ & x63) | new_n425_ | new_n426_);
  assign new_n425_ = x72 & ((~x73 & (x74 ? x58 : x59)) | (x55 & x73 & ~x74));
  assign new_n426_ = ~x72 & ((x62 & ~x73 & x74) | (x73 & (x74 ? x60 : x61)));
  assign new_n427_ = ~x71 & (new_n428_ | new_n425_ | (~new_n429_ & ~x72));
  assign new_n428_ = x63 & ((x73 & x74) | (~x72 & ~x73 & ~x74));
  assign new_n429_ = (~x62 | ~x74) & (~x73 | (~x61 & ~x74));
  assign new_n430_ = x68 & ~x69 & ((x47 & x70 & ~x71) | (x15 & ~x70 & x71));
  assign new_n431_ = x66 ? (new_n437_ | x67) : (x68 ? ~new_n435_ : new_n432_);
  assign new_n432_ = x67 ? new_n433_ : (~x69 | (~new_n421_ & (~new_n424_ | ~x70)));
  assign new_n433_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n434_ | ~x70);
  assign new_n434_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n435_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n436_);
  assign new_n436_ = ~new_n428_ & ~new_n425_ & (new_n429_ | x72);
  assign new_n437_ = (~new_n108_ | ~x47 | ~x68) & (new_n433_ | x68);
endmodule
