// Benchmark "FAU" written by ABC on Sat Aug  1 07:37:41 2020
...
module FAU ( 
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n361_ : ~new_n355_)) : ~new_n339_;
  assign new_n339_ = ~new_n353_ & (new_n112_ | (x70 ? new_n350_ : new_n340_));
  assign new_n340_ = (~x65 | x68 | ~new_n346_ | ~x69) & (~x68 | x69 | (x65 ? new_n343_ : ~new_n341_));
  assign new_n341_ = x71 & ((x12 & (new_n342_ | ~x00)) | (x00 & ~new_n342_ & ~x12));
  assign new_n342_ = ~x13 & ~x14 & ~x15;
  assign new_n343_ = (new_n126_ | ~x60) & (x71 | (~new_n344_ & ~new_n345_));
  ...
  assign new_n350_ = x65 ? (x68 | new_n351_ | ~x69) : (~x68 | ~new_n352_ | x69);
  assign new_n351_ = x71 ? (~new_n344_ & ~new_n345_) : (~new_n347_ & ~new_n348_ & ~new_n349_);
  assign new_n352_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n353_ = x65 & ~x66 & ~x67 & x68 & ~new_n354_ & ~x69;
  assign new_n354_ = x70 ? ~new_n352_ : (~x71 | ((~x12 | (~new_n342_ & x00)) & (~x00 | new_n342_ | x12)));
  assign new_n355_ = x68 ? ~new_n358_ : (x67 ? new_n359_ : ~new_n356_);
  assign new_n356_ = x69 & ((~new_n357_ & (x70 ^ x71)) | (x70 & x71 & (new_n344_ | new_n345_)));
  assign new_n357_ = ~new_n347_ & ~new_n348_ & ~new_n349_;
  assign new_n358_ = ~x69 & ~x70 & ((~new_n343_ & ~x67) | (x44 & x67 & ~x71));
  assign new_n359_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n360_ | ~x70) & (~x60 | ~x69 | x70);
  assign new_n360_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n361_ = ~x67 & ((~new_n359_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n391_ : ~new_n384_)) : ~new_n363_;
  assign new_n363_ = ~new_n380_ & (new_n112_ | (x70 ? (~new_n373_ & ~new_n383_) : new_n364_));
  assign new_n364_ = (~x68 | x69 | (x65 ? new_n365_ : ~new_n372_)) & (~x65 | x68 | ~new_n369_ | ~x69);
  assign new_n365_ = ~new_n368_ & (x71 | (~new_n366_ & ~new_n367_ & (new_n126_ | ~x61)));
  assign new_n366_ = x73 & ((~x72 & (x74 ? x58 : x59)) | (x53 & x72 & ~x74));
  assign new_n367_ = x72 & ~x73 & (x74 ? x56 : x57);
  assign new_n368_ = ~x73 & x74 & x60 & ~x72;
  assign new_n369_ = x71 & ((~new_n126_ & x29) | (~new_n371_ & ~x72) | (~new_n370_ & x72));
  assign new_n370_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n371_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n372_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n373_ = x65 & ~x68 & x69 & (new_n374_ | new_n375_ | new_n378_);
  assign new_n374_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n375_ = x73 & ((~new_n377_ & ~x74) | (~x72 & ~new_n376_ & x74));
  assign new_n376_ = x71 ? ~x58 : ~x26;
  assign new_n377_ = x71 ? (x72 ? ~x53 : ~x59) : (x72 ? ~x21 : ~x27);
  assign new_n378_ = ~x73 & ((~new_n379_ & x72) | (x28 & ~x71 & ~x72 & x74));
  assign new_n379_ = x71 ? (x74 ? ~x56 : ~x57) : (x74 ? ~x24 : ~x25);
  assign new_n380_ = x65 & new_n381_ & ~x66;
  assign new_n381_ = ~x67 & x68 & ~x69 & (x70 ? new_n382_ : new_n372_);
  assign new_n382_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n383_ = ~x65 & x68 & new_n382_ & ~x69;
  assign new_n384_ = x68 ? (~new_n388_ | x69) : (x67 ? new_n389_ : (new_n385_ | ~x69));
  assign new_n385_ = ((~x70 ^ x71) | (new_n387_ & (new_n126_ | ~x29))) & (~x70 | new_n386_ | ~x71);
  assign new_n386_ = (new_n126_ | ~x61) & ~new_n366_ & ~new_n367_;
  assign new_n387_ = x72 ? new_n370_ : new_n371_;
  assign new_n388_ = ~x70 & ((~new_n365_ & ~x67) | (x45 & x67 & ~x71));
  assign new_n389_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n390_ | ~x70);
  assign new_n390_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n391_ = ~x67 & ((~new_n389_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n421_ : ~new_n414_)) : ~new_n393_;
  assign new_n393_ = ~new_n410_ & (new_n112_ | (x70 ? (~new_n403_ & ~new_n413_) : new_n394_));
  assign new_n394_ = (~x68 | x69 | (x65 ? new_n395_ : ~new_n402_)) & (~x65 | x68 | ~new_n399_ | ~x69);
  assign new_n395_ = ~new_n398_ & (x71 | (~new_n396_ & ~new_n397_ & (new_n126_ | ~x62)));
  assign new_n396_ = x74 & ((~x72 & (x73 ? x59 : x61)) | (x57 & x72 & ~x73));
  assign new_n397_ = x72 & ~x74 & (x73 ? x54 : x58);
  assign new_n398_ = x73 & ~x74 & x60 & ~x72;
  assign new_n399_ = x71 & ((~new_n126_ & x30) | (~new_n401_ & ~x72) | (~new_n400_ & x72));
  assign new_n400_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n401_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n402_ = x71 & ((x14 & (~x00 | ~x15)) | (x00 & ~x14 & x15));
  assign new_n403_ = x65 & ~x68 & x69 & (new_n404_ | new_n405_ | new_n408_);
  assign new_n404_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n405_ = x74 & ((~new_n407_ & ~x73) | (~x72 & ~new_n406_ & x73));
  assign new_n406_ = x71 ? ~x59 : ~x27;
  assign new_n407_ = x71 ? (x72 ? ~x57 : ~x61) : (x72 ? ~x25 : ~x29);
  assign new_n408_ = ~x74 & ((~new_n409_ & x72) | (x28 & ~x71 & ~x72 & x73));
  assign new_n409_ = x71 ? (x73 ? ~x54 : ~x58) : (x73 ? ~x22 : ~x26);
  assign new_n410_ = x65 & ~x66 & ~x67 & x68 & ~new_n411_ & ~x69;
  assign new_n411_ = x70 ? ~new_n412_ : ~new_n402_;
  assign new_n412_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n413_ = ~x65 & x68 & new_n412_ & ~x69;
  assign new_n414_ = x68 ? ~new_n418_ : (x67 ? new_n419_ : ~new_n415_);
  assign new_n415_ = x69 & ((~new_n417_ & (x70 ^ x71)) | (x70 & ~new_n416_ & x71));
  assign new_n416_ = (new_n126_ | ~x62) & ~new_n396_ & ~new_n397_;
  assign new_n417_ = (new_n126_ | ~x30) & (new_n400_ | ~x72) & (new_n401_ | x72);
  assign new_n418_ = ~x69 & ~x70 & ((~new_n395_ & ~x67) | (x46 & x67 & ~x71));
  ...
  assign new_n424_ = x69 & ((~new_n425_ & (x70 ^ x71)) | (x70 & x71 & (~new_n428_ | new_n431_)));
  ...
  assign new_n429_ = ~x72 & ((x61 & x73 & ~x74) | (x62 & ~x73 & x74));
  assign new_n430_ = x72 & ((~x73 & (x74 ? x58 : x59)) | (x55 & x73 & ~x74));
  assign new_n431_ = x63 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n432_ = ~x69 & ~x70 & (new_n433_ | (~x71 & (~new_n428_ | new_n431_)));
  assign new_n433_ = x73 & x74 & x60 & ~x72;
  ...
  assign new_n437_ = ~x67 & (new_n433_ | (~x71 & (new_n431_ | new_n429_ | new_n430_)));
