...
module FAU ( 
  ...
  assign new_n414_ = (new_n415_ | (~x70 ^ x71)) & (~x70 | new_n418_ | ~x71) & (new_n127_ | ((~x70 | ~x71) & (~x31 | (~x70 & ~x71))));
  assign new_n415_ = ~new_n416_ & ~new_n417_;
  assign new_n416_ = x72 & ((~x73 & (x74 ? x26 : x27)) | (x23 & x73 & ~x74));
  assign new_n417_ = ~x72 & ((x73 & (x74 ? x28 : x29)) | (x30 & ~x73 & x74));
  assign new_n418_ = ~new_n419_ & ~new_n420_ & (~x60 | ~x73 | ~x74) & (~x59 | x73 | x74);
  assign new_n419_ = x72 & ((x58 & x74) | (x55 & x73));
  assign new_n420_ = ~x72 & ((x61 & ~x74) | (x62 & ~x73));
  ...
  assign new_n424_ = x64 ? (~new_n429_ | x65) : ((new_n425_ | new_n113_) & (~new_n430_ | ~x65));
  assign new_n425_ = (x70 | ((~x65 | new_n426_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n426_ = (new_n127_ | ~x63) & (new_n427_ | ~x72) & (new_n428_ | x72);
  assign new_n427_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n428_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n429_ = ~x70 & ~x71 & ((~x66 & ~new_n426_ & ~x67) | (x47 & (x66 ^ x67)));
