// Benchmark "FAU" written by ABC on Sat Aug  1 07:38:42 2020
...
module FAU ( 
  ...
  assign z09 = x64 ? (~x65 & (new_n280_ | new_n283_)) : (new_n267_ | (new_n278_ & x65));
  ...
  assign new_n271_ = x72 ? ((new_n199_ | x73) & (~x49 | ~x73 | x74)) : new_n272_;
  ...
  assign new_n277_ = ~new_n126_ & x57;
  ...
  assign new_n282_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x70 | ((~x41 | ~x71) & (~x25 | x69 | x71)));
  assign new_n283_ = x66 & ~x67 & ((~new_n282_ & ~x68) | (new_n108_ & x41 & x68));
  assign z10 = x64 ? (~new_n310_ & ~x65) : (new_n285_ | (x65 & new_n308_ & ~x66));
  assign new_n285_ = ~new_n112_ & (x70 ? (new_n297_ | new_n305_) : (new_n286_ | new_n292_));
  assign new_n286_ = x71 & (x65 ? (~x68 & ~new_n289_ & x69) : (x68 & ~new_n287_ & ~x69));
  assign new_n287_ = (~x10 | (x00 & (~new_n288_ | x11 | x12))) & (~x00 | x10 | (new_n288_ & ~x11 & ~x12));
  assign new_n288_ = ~x13 & ~x14 & ~x15;
  assign new_n289_ = (new_n126_ | ~x26) & ~new_n290_ & ~new_n291_;
  ...
  assign new_n295_ = x73 & ((~x72 & (x74 ? x55 : x56)) | (x50 & x72 & ~x74));
  assign new_n296_ = x72 & ~x73 & (x74 ? x53 : x54);
  assign new_n297_ = x65 & ~x68 & x69 & (new_n298_ | new_n299_ | new_n302_);
  assign new_n298_ = ~new_n126_ & (x71 ? x58 : x26);
  assign new_n299_ = ~x72 & (new_n301_ | (~new_n300_ & x73));
  assign new_n300_ = x71 ? (x74 ? ~x55 : ~x56) : (x74 ? ~x23 : ~x24);
  assign new_n301_ = ~x73 & x74 & (x57 | (x25 & ~x71));
  assign new_n302_ = x72 & ((~new_n303_ & ~x74) | (~x73 & ~new_n304_ & x74));
  assign new_n303_ = x71 ? (x73 ? ~x50 : ~x54) : (x73 ? ~x18 : ~x22);
  assign new_n304_ = x71 ? ~x53 : ~x21;
  ...
  assign new_n308_ = ~x67 & x68 & ~x69 & (x70 ? new_n306_ : new_n309_);
  assign new_n309_ = ~new_n287_ & x71;
  assign new_n310_ = x66 ? ~new_n319_ : (~new_n311_ & ~new_n317_);
  ...
  assign new_n314_ = (x70 ^ x71) & ((~new_n126_ & x26) | new_n290_ | new_n291_);
  assign new_n315_ = x70 & (new_n316_ | (x71 & (new_n294_ | new_n295_ | new_n296_)));
  assign new_n316_ = ~x73 & x74 & x57 & ~x72;
  assign new_n317_ = x68 & ~x69 & new_n318_ & ~x70;
  assign new_n318_ = ~x71 & (x67 ? x42 : (new_n294_ | new_n295_ | new_n296_));
  assign new_n319_ = ~x67 & ((~new_n312_ & ~x68) | (new_n108_ & x42 & x68));
  assign z11 = x64 ? (~x65 & (x66 ? new_n349_ : ~new_n343_)) : ~new_n321_;
  assign new_n321_ = ~new_n341_ & (new_n112_ | (x70 ? new_n331_ : (~new_n322_ & ~new_n327_)));
  assign new_n322_ = x71 & (x65 ? (~x68 & ~new_n324_ & x69) : (x68 & ~new_n323_ & ~x69));
  assign new_n323_ = (~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11);
  assign new_n324_ = (new_n126_ | ~x27) & (new_n325_ | ~x72) & (new_n326_ | x72);
  ...
  assign new_n328_ = (~x59 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n329_ | ~x74) & (~x72 | new_n330_ | x74);
  assign new_n329_ = (x72 | (x73 ? ~x56 : ~x58)) & (~x54 | ~x72 | x73);
  assign new_n330_ = x73 ? ~x51 : ~x55;
  assign new_n331_ = x65 ? (x68 | ~x69 | (~new_n332_ & new_n334_)) : (~x68 | ~new_n339_ | x69);
  assign new_n332_ = ~new_n126_ & ~new_n333_;
  assign new_n333_ = x71 ? ~x59 : ~x27;
  assign new_n334_ = x72 ? (~new_n338_ & (new_n337_ | x74)) : (~new_n336_ & (new_n335_ | ~x74));
  assign new_n335_ = x71 ? (x73 ? ~x56 : ~x58) : (x73 ? ~x24 : ~x26);
  assign new_n336_ = x73 & ~x74 & (x57 | (x25 & ~x71));
  assign new_n337_ = x71 ? (x73 ? ~x51 : ~x55) : (x73 ? ~x19 : ~x23);
  assign new_n338_ = ~x73 & x74 & (x71 ? x54 : x22);
  assign new_n339_ = ~new_n340_ & ~x71;
  assign new_n340_ = (~x43 | (x32 & (x46 | x47 | x44 | x45))) & (~x32 | x43 | (~x46 & ~x47 & ~x44 & ~x45));
  assign new_n341_ = x65 & ~x66 & ~x67 & x68 & ~new_n342_ & ~x69;
  assign new_n342_ = x70 ? (new_n340_ | x71) : (~x71 | ((~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11)));
  assign new_n343_ = x68 ? ~new_n346_ : (x67 ? new_n347_ : ~new_n344_);
  assign new_n344_ = x69 & ((~new_n324_ & (x70 ^ x71)) | (x70 & (new_n345_ | (~new_n328_ & x71))));
  assign new_n345_ = x73 & ~x74 & x57 & ~x72;
  assign new_n346_ = ~x69 & ~x70 & ~x71 & (x67 ? x43 : ~new_n328_);
  ...
  assign z12 = x64 ? new_n372_ : (new_n370_ | (~new_n112_ & (new_n351_ | new_n361_)));
  assign new_n351_ = ~x70 & (new_n352_ | (x65 & x68 & new_n357_ & ~x69));
  assign new_n352_ = x71 & (x65 ? (~x68 & ~new_n354_ & x69) : (x68 & ~new_n353_ & ~x69));
  assign new_n353_ = (~x12 | (~new_n288_ & x00)) & (~x00 | new_n288_ | x12);
  assign new_n354_ = (new_n126_ | ~x28) & ~new_n355_ & ~new_n356_;
  ...
  assign new_n359_ = ~x72 & ((x58 & x73 & ~x74) | (x59 & ~x73 & x74));
  assign new_n360_ = x72 & ((~x73 & (x74 ? x55 : x56)) | (x52 & x73 & ~x74));
  assign new_n361_ = x70 & (x65 ? (~x68 & ~new_n362_ & x69) : (x68 & new_n369_ & ~x69));
  assign new_n362_ = (new_n126_ | new_n368_) & (new_n363_ | x72) & (new_n366_ | ~x72);
  assign new_n363_ = (new_n365_ | ~x71) & (~x57 | ~x73 | ~x74) & (new_n364_ | x71);
  assign new_n364_ = (~x73 | (x74 ? ~x25 : ~x26)) & (~x27 | x73 | ~x74);
  assign new_n365_ = (~x59 | x73 | ~x74) & (~x58 | ~x73 | x74);
  assign new_n366_ = (new_n367_ | x74) & (x73 | ~x74 | (x71 ? ~x55 : ~x23));
  assign new_n367_ = x71 ? (x73 ? ~x52 : ~x56) : (x73 ? ~x20 : ~x24);
  assign new_n368_ = x71 ? ~x60 : ~x28;
  assign new_n369_ = ~x71 & ((x44 & (new_n307_ | ~x32)) | (x32 & ~new_n307_ & ~x44));
  assign new_n370_ = x65 & ~x66 & ~x67 & x68 & ~new_n371_ & ~x69;
  assign new_n371_ = x70 ? ~new_n369_ : (new_n353_ | ~x71);
  assign new_n372_ = ~x65 & (x66 ? new_n381_ : (new_n373_ | new_n379_));
  assign new_n373_ = ~x68 & (x67 ? ~new_n374_ : (x69 & (new_n376_ | new_n377_)));
  assign new_n374_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n375_ | ~x70);
  assign new_n375_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n376_ = (x70 ^ x71) & ((~new_n126_ & x28) | new_n355_ | new_n356_);
  assign new_n377_ = x70 & (new_n378_ | (x71 & (new_n358_ | new_n359_ | new_n360_)));
  assign new_n378_ = x73 & x74 & x57 & ~x72;
  assign new_n379_ = x68 & ~x69 & new_n380_ & ~x70;
  assign new_n380_ = ~x71 & (x67 ? x44 : (new_n358_ | new_n359_ | new_n360_));
  assign new_n381_ = ~x67 & ((~new_n374_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n412_ : ~new_n404_)) : ~new_n383_;
  assign new_n383_ = ~new_n400_ & (new_n112_ | (x70 ? (~new_n394_ & ~new_n403_) : new_n384_));
  assign new_n384_ = (~x71 | (x65 ? (~new_n387_ | x68) : (~new_n385_ | ~x68))) & (~x65 | ~new_n390_ | ~x68);
  assign new_n385_ = ~new_n386_ & ~x69;
  assign new_n386_ = (~x00 | x13 | (~x14 & ~x15)) & (~x13 | (x00 & (x14 | x15)));
  assign new_n387_ = x69 & ((~new_n126_ & x29) | (~new_n389_ & ~x72) | (~new_n388_ & x72));
  assign new_n388_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n389_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n390_ = ~x69 & ~x71 & (new_n391_ | (~new_n393_ & ~x72) | (~new_n392_ & x72));
  assign new_n391_ = x61 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n392_ = (~x56 | x73 | ~x74) & (~x53 | ~x73 | x74);
  assign new_n393_ = (~x73 | (x74 ? ~x58 : ~x59)) & (~x60 | x73 | ~x74);
  assign new_n394_ = x65 & ~x68 & x69 & (new_n395_ | new_n396_ | new_n398_);
  assign new_n395_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n396_ = x72 & ((~new_n392_ & x71) | (~new_n388_ & ~x71) | (new_n397_ & x57));
  assign new_n397_ = ~x73 & ~x74;
  assign new_n398_ = ~x72 & ((~new_n399_ & x74) | (x73 & ~new_n333_ & ~x74));
  assign new_n399_ = x71 ? (x73 ? ~x58 : ~x60) : (x73 ? ~x26 : ~x28);
  assign new_n400_ = x65 & ~x66 & new_n401_ & ~x67;
  assign new_n401_ = x68 & ~x69 & (x70 ? new_n402_ : (~new_n386_ & x71));
  assign new_n402_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n403_ = ~x65 & x68 & new_n402_ & ~x69;
  assign new_n404_ = x68 ? ~new_n409_ : (x67 ? new_n410_ : ~new_n405_);
  assign new_n405_ = x69 & ((~new_n406_ & (x70 ^ x71)) | (x70 & (new_n408_ | (~new_n407_ & x71))));
  assign new_n406_ = (new_n126_ | ~x29) & (new_n388_ | ~x72) & (new_n389_ | x72);
  assign new_n407_ = ~new_n391_ & (new_n393_ | x72) & (new_n392_ | ~x72);
  assign new_n408_ = new_n397_ & x57 & x72;
  assign new_n409_ = ~x69 & ~x70 & ~x71 & (x67 ? x45 : ~new_n407_);
  assign new_n410_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n411_ | ~x70);
  assign new_n411_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n412_ = ~x67 & ((~new_n410_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n439_ : ~new_n433_)) : ~new_n414_;
  assign new_n414_ = ~new_n431_ & (new_n112_ | (x70 ? new_n424_ : (~new_n415_ & ~new_n420_)));
  assign new_n415_ = x71 & (x65 ? (~x68 & ~new_n416_ & x69) : (x68 & ~new_n419_ & ~x69));
  assign new_n416_ = (new_n126_ | ~x30) & (new_n417_ | ~x72) & (new_n418_ | x72);
  ...
  assign new_n421_ = (~x62 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n422_ | x74) & (x72 | new_n423_ | ~x74);
  assign new_n422_ = (~x72 | (x73 ? ~x54 : ~x58)) & (~x60 | x72 | ~x73);
  assign new_n423_ = x73 ? ~x59 : ~x61;
  assign new_n424_ = x65 ? (x68 | ~x69 | (~new_n425_ & new_n426_)) : (~x68 | ~new_n430_ | x69);
  assign new_n425_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n426_ = x72 ? (~new_n301_ & (new_n427_ | x74)) : (~new_n429_ & (new_n428_ | ~x74));
  assign new_n427_ = x71 ? (x73 ? ~x54 : ~x58) : (x73 ? ~x22 : ~x26);
  assign new_n428_ = x71 ? (x73 ? ~x59 : ~x61) : (x73 ? ~x27 : ~x29);
  assign new_n429_ = x73 & ~x74 & (x71 ? x60 : x28);
  assign new_n430_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n431_ = x65 & ~x66 & ~x67 & x68 & ~new_n432_ & ~x69;
  assign new_n432_ = x70 ? ~new_n430_ : (new_n419_ | ~x71);
  assign new_n433_ = x68 ? (~new_n436_ | x69) : (x67 ? new_n437_ : (new_n434_ | ~x69));
  assign new_n434_ = (new_n416_ | (~x70 ^ x71)) & (~x70 | (~new_n435_ & (new_n421_ | ~x71)));
  assign new_n435_ = x57 & x72 & ~x73 & x74;
  assign new_n436_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n421_);
  assign new_n437_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n438_ | ~x70);
  assign new_n438_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n439_ = ~x67 & ((~new_n437_ & ~x68) | (new_n108_ & x46 & x68));
  ...
  assign new_n443_ = (new_n126_ | ~x31) & (new_n444_ | ~x72) & (new_n445_ | x72);
  assign new_n444_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n445_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n446_ = (new_n126_ | ~x63) & (new_n447_ | ~x72) & (new_n448_ | x72);
  ...
  assign new_n451_ = x65 & x69 & ~new_n442_ & ~new_n112_;
  assign new_n452_ = x64 ? (~new_n454_ | x65) : ((new_n453_ | new_n112_) & (~new_n455_ | ~x65));
