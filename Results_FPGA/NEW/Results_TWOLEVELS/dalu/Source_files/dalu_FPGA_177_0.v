...
module FAU ( 
  ...
  assign z09 = (~x65 & (new_n281_ | (new_n291_ & x64))) | (~x64 & ~new_n298_ & x65);
  assign new_n281_ = ~x69 & ((~new_n282_ & x68) | (x25 & x64 & new_n290_ & ~x68));
  assign new_n282_ = x64 ? (~new_n286_ | x70) : (new_n99_ | (x70 ? ~new_n284_ : ~new_n283_));
  assign new_n283_ = x71 & ((x09 & (new_n159_ | ~x00)) | (x00 & ~new_n159_ & ~x09));
  assign new_n284_ = ~x71 & (~x32 | (new_n285_ & ~x42 & ~x43 & ~x44));
  assign new_n285_ = ~x45 & ~x46 & ~x47;
  assign new_n286_ = ~x71 & (x67 ? ~x66 : (new_n287_ | new_n288_ | new_n289_ | x66));
  ...
  assign new_n290_ = x70 & ~x71 & (x66 ^ x67);
  assign new_n291_ = ~x68 & (x66 ? (~new_n297_ & ~x67) : (x67 ? ~new_n297_ : (~new_n292_ & x69)));
  assign new_n292_ = (~x70 | new_n296_ | ~x71) & ((~x70 ^ x71) | (new_n293_ & (new_n161_ | ~x25)));
  ...
  assign new_n296_ = ~new_n287_ & ~new_n288_ & ~new_n289_;
  assign new_n297_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x41 | ~x70 | ~x71) & (x70 | x71 | ~x57 | ~x69);
  assign new_n298_ = x70 ? new_n301_ : (x68 ? (new_n299_ | x69) : (~new_n300_ | ~x69));
  assign new_n299_ = (x66 | ~new_n283_ | x67) & (x71 | new_n296_ | (~x66 & ~x67));
  assign new_n300_ = x71 & ~new_n99_ & (~new_n293_ | (~new_n161_ & x25));
  assign new_n301_ = (x68 | ~x69 | new_n302_ | (~x66 & ~x67)) & (x66 | x67 | ~x68 | ~new_n284_ | x69);
  assign new_n302_ = ~new_n303_ & (x71 | (~new_n294_ & ~new_n295_)) & (~x71 | (~new_n288_ & ~new_n289_));
  assign new_n303_ = (x71 ? x57 : x25) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n348_ = ~x71 & ((x43 & (new_n192_ | ~x32)) | (x32 & ~new_n192_ & ~x43));
  ...
  assign new_n373_ = ~x71 & ((x44 & (new_n285_ | ~x32)) | (x32 & ~new_n285_ & ~x44));
