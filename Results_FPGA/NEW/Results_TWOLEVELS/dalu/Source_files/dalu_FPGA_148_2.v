// Benchmark "FAU" written by ABC on Sat Aug  1 07:40:45 2020
...
module FAU ( 
  ...
  assign new_n286_ = (~new_n303_ | ~x65) & (new_n112_ | (x70 ? new_n298_ : new_n287_));
  ...
  assign new_n311_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x58 | ~x69) & (new_n312_ | ~x70);
  assign new_n312_ = (~x42 | ~x71) & (~x26 | x69 | x71);
  assign new_n313_ = ~x67 & ((~new_n311_ & ~x68) | (new_n108_ & x42 & x68));
  assign z11 = x64 ? (~x65 & (x66 ? new_n337_ : ~new_n332_)) : ~new_n315_;
  assign new_n315_ = ~new_n330_ & (new_n112_ | (x70 ? (~new_n325_ & ~new_n328_) : new_n316_));
  assign new_n316_ = (~x68 | new_n317_ | x69) & (~x65 | x68 | new_n322_ | ~x69);
  ...
  assign new_n322_ = (new_n126_ | ~x27) & (~x71 | (x72 ? new_n323_ : new_n324_));
  assign new_n323_ = (x73 | (x74 ? ~x22 : ~x23)) & (~x19 | ~x73 | x74);
  assign new_n324_ = (~x73 | (x74 ? ~x24 : ~x25)) & (~x26 | x73 | ~x74);
  assign new_n325_ = ~x71 & (x65 ? (~x68 & ~new_n326_ & x69) : (x68 & ~new_n327_ & ~x69));
  assign new_n326_ = x72 ? new_n323_ : new_n324_;
  assign new_n327_ = (~x43 | (x32 & (x46 | x47 | x44 | x45))) & (~x32 | x43 | (~x46 & ~x47 & ~x44 & ~x45));
  assign new_n328_ = x65 & ~x68 & x69 & x71 & (~new_n329_ | new_n319_);
  assign new_n329_ = ~new_n320_ & ~new_n321_;
  assign new_n330_ = x65 & ~x66 & ~x67 & x68 & ~new_n331_ & ~x69;
  assign new_n331_ = x70 ? (new_n327_ | x71) : (new_n318_ | ~x71);
  assign new_n332_ = x68 ? (~new_n335_ | x69) : (x67 ? new_n336_ : (new_n333_ | ~x69));
  assign new_n333_ = (new_n326_ | (~x70 ^ x71)) & ~new_n334_ & (~x70 | new_n329_ | ~x71);
  assign new_n334_ = ~new_n126_ & ((x27 & ~x70) | (x59 & x70 & x71));
  assign new_n335_ = ~x70 & ~x71 & (x67 ? x43 : (~new_n329_ | new_n319_));
  assign new_n336_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (~x43 | ~x70 | ~x71);
  assign new_n337_ = ~x67 & ((~new_n336_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~new_n359_ & ~x65) : ((~new_n339_ & ~new_n112_) | (new_n369_ & x65));
  assign new_n339_ = x70 ? (x65 ? (~new_n350_ | x68) : (~new_n357_ | ~x68)) : new_n340_;
  assign new_n340_ = (~x68 | new_n341_ | x69) & (~x65 | x68 | new_n346_ | ~x69);
  assign new_n341_ = x65 ? (x71 | (~new_n343_ & ~new_n344_ & ~new_n345_)) : (new_n342_ | ~x71);
  assign new_n342_ = (~x12 | (x00 & (x13 | x14 | x15))) & (~x00 | x12 | (~x13 & ~x14 & ~x15));
  ...
  assign new_n346_ = ~new_n349_ & (~x71 | (~new_n347_ & ~new_n348_ & (new_n126_ | ~x28)));
  assign new_n347_ = x73 & ((~x72 & (x74 ? x25 : x26)) | (x20 & x72 & ~x74));
  assign new_n348_ = x72 & ~x73 & (x74 ? x23 : x24);
  assign new_n349_ = ~x73 & x74 & x27 & ~x72;
  assign new_n350_ = x69 & (new_n351_ | (~new_n352_ & x73) | (~new_n354_ & ~x73));
  assign new_n351_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n352_ = (new_n353_ | x74) & (x72 | ~x74 | (x71 ? ~x57 : ~x25));
  assign new_n353_ = x71 ? (x72 ? ~x52 : ~x58) : (x72 ? ~x20 : ~x26);
  assign new_n354_ = (~x72 | (x71 ? new_n355_ : new_n356_)) & (~x59 | ~x71 | x72 | ~x74);
  assign new_n355_ = x74 ? ~x55 : ~x56;
  assign new_n356_ = x74 ? ~x23 : ~x24;
  assign new_n357_ = ~x69 & ~new_n358_ & ~x71;
  assign new_n358_ = (~x44 | (x32 & (x45 | x46 | x47))) & (~x32 | x44 | (~x45 & ~x46 & ~x47));
  assign new_n359_ = x66 ? ~new_n368_ : (x68 ? ~new_n366_ : new_n360_);
  assign new_n360_ = x67 ? new_n362_ : (~x69 | (new_n364_ & (new_n361_ | new_n194_)));
  assign new_n361_ = (new_n126_ | ~x28) & ~new_n347_ & ~new_n348_;
  assign new_n362_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n363_ | ~x70);
  assign new_n363_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n364_ = ~new_n365_ & (~x70 | ~x71 | (~new_n343_ & ~new_n344_ & ~new_n345_));
  assign new_n365_ = ~x72 & ~x73 & x74 & x27 & ~x70;
  assign new_n366_ = ~x69 & ~x70 & ~x71 & (x67 ? x44 : ~new_n367_);
  assign new_n367_ = ~new_n343_ & ~new_n344_ & ~new_n345_;
  assign new_n368_ = ~x67 & ((~new_n362_ & ~x68) | (new_n108_ & x44 & x68));
  assign new_n369_ = ~x66 & ~x67 & x68 & ~new_n370_ & ~x69;
  assign new_n370_ = x70 ? (new_n358_ | x71) : (new_n342_ | ~x71);
  assign z13 = x64 ? (~new_n390_ & ~x65) : ((~new_n372_ & ~new_n112_) | (new_n400_ & x65));
  assign new_n372_ = x70 ? (x65 ? (~new_n383_ | x68) : (~new_n389_ | ~x68)) : new_n373_;
  assign new_n373_ = (~x68 | new_n374_ | x69) & (~x65 | x68 | new_n379_ | ~x69);
  assign new_n374_ = x65 ? (x71 | (~new_n376_ & ~new_n377_ & ~new_n378_)) : (new_n375_ | ~x71);
  assign new_n375_ = (~x00 | x13 | (~x14 & ~x15)) & (~x13 | (x00 & (x14 | x15)));
  ...
  assign new_n379_ = ~new_n382_ & (~x71 | (~new_n380_ & ~new_n381_ & (new_n126_ | ~x29)));
  assign new_n380_ = x74 & ((~x72 & (x73 ? x26 : x28)) | (x24 & x72 & ~x73));
  assign new_n381_ = x72 & ~x74 & (x73 ? x21 : x25);
  assign new_n382_ = x73 & ~x74 & x27 & ~x72;
  assign new_n383_ = x69 & (new_n384_ | (~new_n385_ & x74) | (~new_n387_ & ~x74));
  assign new_n384_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n385_ = (new_n386_ | x73) & (x72 | ~x73 | (x71 ? ~x58 : ~x26));
  assign new_n386_ = x71 ? (x72 ? ~x56 : ~x60) : (x72 ? ~x24 : ~x28);
  assign new_n387_ = (new_n388_ | ~x72) & (x72 | ~x73 | ~x59 | ~x71);
  assign new_n388_ = x71 ? (x73 ? ~x53 : ~x57) : (x73 ? ~x21 : ~x25);
  assign new_n389_ = ~x69 & ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n390_ = x66 ? ~new_n399_ : (x68 ? ~new_n397_ : new_n391_);
  assign new_n391_ = x67 ? new_n393_ : (~x69 | (new_n395_ & (new_n392_ | new_n194_)));
  assign new_n392_ = (new_n126_ | ~x29) & ~new_n380_ & ~new_n381_;
  assign new_n393_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n394_ | ~x70);
  assign new_n394_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n395_ = ~new_n396_ & (~x70 | ~x71 | (~new_n376_ & ~new_n377_ & ~new_n378_));
  assign new_n396_ = ~x72 & x73 & ~x74 & x27 & ~x70;
  assign new_n397_ = ~x69 & ~x70 & ~x71 & (x67 ? x45 : ~new_n398_);
  assign new_n398_ = ~new_n376_ & ~new_n377_ & ~new_n378_;
  assign new_n399_ = ~x67 & ((~new_n393_ & ~x68) | (new_n108_ & x45 & x68));
  assign new_n400_ = ~x66 & ~x67 & x68 & ~x69 & (new_n401_ | new_n402_);
  assign new_n401_ = ~x70 & ~new_n375_ & x71;
  assign new_n402_ = x70 & ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign z14 = x64 ? (~x65 & (x66 ? new_n430_ : ~new_n422_)) : ~new_n404_;
  assign new_n404_ = ~new_n420_ & (new_n112_ | (~new_n405_ & ~new_n416_));
  ...
  assign new_n408_ = x62 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n409_ = x72 & ((~x73 & (x74 ? x57 : x58)) | (x54 & x73 & ~x74));
  assign new_n410_ = ~x72 & ((x73 & (x74 ? x59 : x60)) | (x61 & ~x73 & x74));
  assign new_n411_ = ~new_n415_ & (~x71 | (~new_n412_ & ~new_n413_ & ~new_n414_));
  assign new_n412_ = x30 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n413_ = ~x72 & ((x28 & x73 & ~x74) | (x29 & ~x73 & x74));
  assign new_n414_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n415_ = x73 & x74 & x27 & ~x72;
  assign new_n416_ = x70 & (x65 ? (~x68 & ~new_n417_ & x69) : (x68 & new_n419_ & ~x69));
  assign new_n417_ = ~new_n418_ & (x71 | (~new_n413_ & ~new_n414_)) & (~x71 | (~new_n409_ & ~new_n410_));
  ...
  assign new_n421_ = x70 ? ~new_n419_ : (new_n407_ | ~x71);
  assign new_n422_ = x68 ? (~new_n427_ | x69) : (x67 ? new_n428_ : (new_n423_ | ~x69));
  assign new_n423_ = ((new_n425_ & ~new_n412_) | (~x70 ^ x71)) & ~new_n426_ & (~x70 | new_n424_ | ~x71);
  assign new_n424_ = ~new_n408_ & ~new_n409_ & ~new_n410_;
  assign new_n425_ = ~new_n413_ & ~new_n414_;
  assign new_n426_ = x27 & ~x70 & ~x72 & x73 & x74;
  assign new_n427_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n424_);
  assign new_n428_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n429_ | ~x70);
  assign new_n429_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n430_ = ~x67 & ((~new_n428_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n443_ | new_n447_)) : (new_n432_ | (new_n448_ & x65));
  assign new_n432_ = ~new_n112_ & (x65 ? (x68 ? new_n441_ : new_n433_) : new_n442_);
  assign new_n433_ = x69 & (new_n434_ | new_n440_ | (x70 & ~new_n437_ & x71));
  assign new_n434_ = ~new_n194_ & (new_n435_ | new_n436_ | (~new_n126_ & x31));
  assign new_n435_ = x72 & ((x23 & x73 & ~x74) | (x26 & ~x73 & x74));
  assign new_n436_ = ~x72 & ((x73 & (x74 ? x28 : x29)) | (x30 & ~x73 & x74));
  assign new_n437_ = (new_n126_ | ~x63) & (new_n438_ | ~x72) & (new_n439_ | x72);
  assign new_n438_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n439_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n440_ = x27 & ~x70 & x72 & ~x73 & ~x74;
  assign new_n441_ = ~x69 & ~x70 & ~new_n437_ & ~x71;
  assign new_n442_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n443_ = ~x66 & (x68 ? new_n444_ : (x67 ? ~new_n445_ : new_n433_));
  assign new_n444_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n437_);
  assign new_n445_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n446_ | ~x70);
  assign new_n446_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n447_ = x66 & ~x67 & ((~new_n445_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n448_ = ~x66 & new_n442_ & ~x67;
endmodule
