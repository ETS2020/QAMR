// Benchmark "FAU" written by ABC on Sat Aug  1 07:35:18 2020
...
module FAU ( 
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n386_ : ~new_n381_)) : ~new_n364_;
  assign new_n364_ = ~new_n379_ & (new_n112_ | (x70 ? (~new_n374_ & ~new_n377_) : new_n365_));
  assign new_n365_ = (~x68 | new_n366_ | x69) & (~x65 | x68 | new_n371_ | ~x69);
  ...
  assign new_n371_ = (new_n126_ | ~x29) & (~x71 | (x72 ? new_n372_ : new_n373_));
  assign new_n372_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n373_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n374_ = ~x71 & (x65 ? (~x68 & ~new_n375_ & x69) : (x68 & ~new_n376_ & ~x69));
  assign new_n375_ = x72 ? new_n372_ : new_n373_;
  assign new_n376_ = (~x32 | x45 | (~x46 & ~x47)) & (~x45 | (x32 & (x46 | x47)));
  assign new_n377_ = x65 & ~x68 & x69 & x71 & (~new_n378_ | new_n368_);
  assign new_n378_ = ~new_n369_ & ~new_n370_;
  assign new_n379_ = x65 & ~x66 & new_n380_ & ~x67;
  assign new_n380_ = x68 & ~x69 & (x70 ? (~new_n376_ & ~x71) : (~new_n367_ & x71));
  assign new_n381_ = x68 ? (~new_n384_ | x69) : (x67 ? new_n385_ : (new_n382_ | ~x69));
  assign new_n382_ = (new_n375_ | (~x70 ^ x71)) & ~new_n383_ & (~x70 | new_n378_ | ~x71);
  assign new_n383_ = ~new_n126_ & ((x29 & ~x70) | (x61 & x70 & x71));
  assign new_n384_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n378_ | new_n368_));
  assign new_n385_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (~x45 | ~x70 | ~x71);
  assign new_n386_ = ~x67 & ((~new_n385_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n418_ : ~new_n410_)) : ~new_n388_;
  assign new_n388_ = ~new_n406_ & (new_n112_ | (x70 ? (~new_n399_ & ~new_n409_) : new_n389_));
  assign new_n389_ = (~x68 | new_n390_ | x69) & (~x65 | x68 | new_n395_ | ~x69);
  assign new_n390_ = x65 ? (x71 | (~new_n392_ & ~new_n393_ & ~new_n394_)) : (new_n391_ | ~x71);
  assign new_n391_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n392_ = x62 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n393_ = x72 & ((~x73 & (x74 ? x57 : x58)) | (x54 & x73 & ~x74));
  assign new_n394_ = ~x72 & ((x73 & (x74 ? x59 : x60)) | (x61 & ~x73 & x74));
  assign new_n395_ = ~new_n398_ & (~x71 | (~new_n396_ & ~new_n397_ & (new_n126_ | ~x30)));
  assign new_n396_ = x73 & ((~x72 & (x74 ? x27 : x28)) | (x22 & x72 & ~x74));
  assign new_n397_ = x72 & ~x73 & (x74 ? x25 : x26);
  assign new_n398_ = ~x73 & x74 & x29 & ~x72;
  assign new_n399_ = x65 & ~x68 & x69 & (new_n400_ | new_n401_ | new_n404_);
  assign new_n400_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n401_ = x73 & ((~new_n403_ & ~x74) | (~x72 & ~new_n402_ & x74));
  assign new_n402_ = x71 ? ~x59 : ~x27;
  assign new_n403_ = x71 ? (x72 ? ~x54 : ~x60) : (x72 ? ~x22 : ~x28);
  assign new_n404_ = ~x73 & ((~new_n405_ & x72) | (x61 & x71 & ~x72 & x74));
  assign new_n405_ = x71 ? (x74 ? ~x57 : ~x58) : (x74 ? ~x25 : ~x26);
  assign new_n406_ = x65 & ~x66 & ~x67 & x68 & ~new_n407_ & ~x69;
  assign new_n407_ = x70 ? ~new_n408_ : (new_n391_ | ~x71);
  assign new_n408_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n409_ = ~x65 & x68 & new_n408_ & ~x69;
  assign new_n410_ = x68 ? ~new_n415_ : (x67 ? new_n416_ : ~new_n411_);
  assign new_n411_ = x69 & ((~new_n413_ & (x70 ^ x71)) | new_n414_ | (x70 & ~new_n412_ & x71));
  assign new_n412_ = ~new_n392_ & ~new_n393_ & ~new_n394_;
  assign new_n413_ = (new_n126_ | ~x30) & ~new_n396_ & ~new_n397_;
  assign new_n414_ = ~x72 & ~x73 & x74 & x29 & ~x70;
  assign new_n415_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n412_);
  ...
  assign z15 = x64 ? (~x65 & (new_n431_ | new_n435_)) : (new_n420_ | (new_n436_ & x65));
  assign new_n420_ = ~new_n112_ & (x65 ? (x68 ? new_n429_ : new_n421_) : new_n430_);
  assign new_n421_ = x69 & ((~new_n422_ & (x70 ^ x71)) | new_n428_ | (x70 & ~new_n425_ & x71));
  assign new_n422_ = (~x31 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n423_ | ~x74) & (~x72 | new_n424_ | x74);
  assign new_n423_ = (x72 | (x73 ? ~x28 : ~x30)) & (~x26 | ~x72 | x73);
  assign new_n424_ = x73 ? ~x23 : ~x27;
  ...
  assign new_n428_ = ~x72 & x73 & ~x74 & x29 & ~x70;
  assign new_n429_ = ~x69 & ~x70 & ~new_n425_ & ~x71;
  assign new_n430_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n431_ = ~x66 & (x68 ? new_n432_ : (x67 ? ~new_n433_ : new_n421_));
  assign new_n432_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n425_);
