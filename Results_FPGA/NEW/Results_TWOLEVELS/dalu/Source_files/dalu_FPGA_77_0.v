// Benchmark "FAU" written by ABC on Sat Aug  1 07:37:59 2020
...
module FAU ( 
  ...
  assign new_n116_ = (~x68 | x69 | (x65 ? ~new_n133_ : new_n117_)) & (~x65 | x68 | new_n135_ | ~x69);
  ...
  assign new_n124_ = x00 & ~x01 & (new_n125_ | (~x08 & (~new_n126_ | ~new_n127_)));
  assign new_n125_ = x71 & (x02 | x03 | x08);
  assign new_n126_ = ~x04 & ~x05 & ~x06 & ~x07 & ~x09;
  ...
  assign new_n133_ = new_n134_ & ~x70;
  assign new_n134_ = ~x71 & ((x49 & (x72 ? (x73 & x74) : (~x73 & ~x74))) | (x48 & ((x73 & (~x74 | (~x72 & x74))) | (x72 & ~x74) | (~x73 & x74))));
  assign new_n135_ = (new_n136_ | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n112_ | ((~x73 | (x74 & (x72 | ~x74))) & (~x72 | x74) & (x73 | ~x74)));
  ...
  assign new_n141_ = (new_n142_ | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n111_ | ((~x73 | (x74 & (x72 | ~x74))) & (~x72 | x74) & (x73 | ~x74)));
  assign new_n142_ = (x68 | new_n136_ | ~x69) & (~x49 | ~x68 | ~new_n105_ | x69);
  assign z02 = x64 ? new_n156_ : (new_n155_ | (~new_n144_ & ~new_n114_));
  assign new_n144_ = (~x68 | x69 | (x65 ? ~new_n151_ : new_n145_)) & (~x65 | ~new_n153_ | x68);
  assign new_n145_ = x70 ? ~new_n149_ : ((~x00 | new_n148_ | x02) & (new_n146_ | ~x02));
  assign new_n146_ = ~new_n123_ & (~new_n147_ | ~new_n121_ | ~new_n122_);
  assign new_n147_ = ~x03 & ~x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n148_ = (x08 | (new_n126_ & new_n127_)) & (~x71 | (~x03 & ~x08));
  assign new_n149_ = ~x71 & ((x34 & (~x32 | (new_n150_ & new_n131_ & new_n132_))) | (x32 & ~x34 & (~new_n150_ | ~new_n131_ | ~new_n132_)));
  ...
  assign new_n155_ = x65 & ~x66 & ~x67 & x68 & ~new_n145_ & ~x69;
  ...
  assign z03 = x64 ? new_n179_ : (new_n178_ | (~new_n163_ & ~new_n114_));
  assign new_n163_ = (~x68 | x69 | (x65 ? ~new_n172_ : new_n164_)) & (~x65 | x68 | new_n175_ | ~x69);
  assign new_n164_ = x70 ? ~new_n169_ : ((~x00 | new_n167_ | x03) & (new_n165_ | ~x03));
  assign new_n165_ = ~new_n123_ & (~new_n127_ | ~new_n166_);
  assign new_n166_ = ~x04 & ~x05 & ~x06 & ~x07 & ~x08 & ~x09;
  assign new_n167_ = ~new_n168_ & (x08 | (new_n121_ & new_n122_));
  assign new_n168_ = x71 & (x04 | x05 | x06 | x07 | x08);
  ...
  assign new_n181_ = (~x03 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x51 | ~x69 | x70 | x71) & (new_n182_ | ~x70);
  assign new_n182_ = (~x35 | ~x71) & (~x19 | x69 | x71);
  assign new_n183_ = ~x70 & ~x71 & (x67 ? x35 : (new_n173_ | ~new_n174_));
  assign new_n184_ = (new_n181_ | x68) & (~new_n108_ | ~x35 | ~x68);
  ...
  assign new_n194_ = x32 ? (x36 | (~x37 & ~x38 & ~x39 & (x37 | x38 | new_n132_ | x39))) : ~x36;
  ...
  assign z05 = x64 ? (~x65 & (x66 ? new_n220_ : ~new_n215_)) : ~new_n202_;
  ...
  assign new_n208_ = x72 ? new_n209_ : (x73 ? new_n210_ : new_n211_);
  ...
  assign new_n213_ = x00 ? (x05 | (~x06 & ~x07 & (x06 | x07 | (~x04 & (new_n122_ | x04))))) : ~x05;
  assign new_n214_ = x32 ? (x37 | (~x38 & ~x39 & (x38 | x39 | (~x36 & (new_n132_ | x36))))) : ~x37;
  assign new_n215_ = x68 ? ~new_n217_ : (x67 ? new_n218_ : ~new_n216_);
  assign new_n216_ = x69 & (new_n204_ | (x70 & ~new_n208_ & x71));
  assign new_n217_ = ~x69 & ~x70 & ~x71 & (x67 ? x37 : ~new_n208_);
  assign new_n218_ = (~x05 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x53 | ~x69 | x70 | x71) & (new_n219_ | ~x70);
  assign new_n219_ = (~x37 | ~x71) & (~x21 | x69 | x71);
  assign new_n220_ = ~x67 & ((~new_n218_ & ~x68) | (new_n108_ & x37 & x68));
  assign z06 = x64 ? (~x65 & (new_n235_ | new_n241_)) : (new_n222_ | (new_n234_ & x65));
  assign new_n222_ = ~new_n114_ & (x65 ? ~new_n223_ : new_n231_);
  assign new_n223_ = x68 ? (x69 | x70 | new_n228_ | x71) : (~x69 | ((new_n224_ | (~x70 ^ x71)) & (~x70 | new_n228_ | ~x71)));
  assign new_n224_ = (new_n225_ | ~x22) & (new_n226_ | ~x72) & (new_n227_ | x72);
  ...
  assign new_n228_ = ~new_n229_ & ~new_n230_ & (new_n225_ | ~x54);
  ...
  assign new_n232_ = x00 ? (x06 | (~x07 & (x07 | (~x05 & (x05 | (~x04 & (new_n122_ | x04))))))) : ~x06;
  assign new_n233_ = x32 ? (x38 | (~x39 & (x39 | (~x37 & (x37 | (~x36 & (new_n132_ | x36))))))) : ~x38;
  assign new_n234_ = ~x66 & new_n231_ & ~x67;
  assign new_n235_ = ~x66 & (x68 ? new_n238_ : (x67 ? ~new_n239_ : new_n236_));
  assign new_n236_ = x69 & (new_n237_ | (~new_n224_ & ~new_n205_));
  assign new_n237_ = x70 & x71 & (new_n229_ | new_n230_ | (~new_n225_ & x54));
  assign new_n238_ = ~x69 & ~x70 & ~x71 & (x67 ? x38 : ~new_n228_);
  assign new_n239_ = (~x06 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x54 | ~x69 | x70 | x71) & (new_n240_ | ~x70);
  ...
  assign new_n243_ = ~new_n114_ & (x65 ? (x68 ? new_n251_ : new_n244_) : new_n252_);
  assign new_n244_ = x69 & ((~new_n245_ & (~x70 ^ ~x71)) | (x70 & ~new_n248_ & x71));
  assign new_n245_ = (new_n225_ | ~x23) & (new_n246_ | ~x72) & (new_n247_ | x72);
  assign new_n246_ = (x73 | (x74 ? ~x18 : ~x19)) & (~x16 | ~x73 | x74);
  assign new_n247_ = (~x73 | (x74 ? ~x20 : ~x21)) & (~x22 | x73 | ~x74);
  assign new_n248_ = ~new_n249_ & ~new_n250_ & (new_n225_ | ~x55);
  ...
  assign new_n253_ = x00 ? (x07 | (~x06 & (x06 | (~x05 & (x05 | (~x04 & (new_n122_ | x04))))))) : ~x07;
  assign new_n254_ = x32 ? (x39 | (~x38 & (x38 | (~x37 & (x37 | (~x36 & (new_n132_ | x36))))))) : ~x39;
  ...
  assign new_n258_ = (~x07 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x55 | ~x69 | x70 | x71) & (new_n259_ | ~x70);
  assign new_n259_ = (~x39 | ~x71) & (~x23 | x69 | x71);
  assign new_n260_ = x66 & ~x67 & ((~new_n258_ & ~x68) | (new_n108_ & x39 & x68));
  assign z08 = x64 ? new_n276_ : (new_n275_ | (~new_n262_ & ~new_n114_));
  assign new_n262_ = (~x68 | x69 | (x65 ? ~new_n274_ : new_n263_)) & (~x65 | x68 | new_n266_ | ~x69);
  assign new_n263_ = x70 ? (new_n265_ | x71) : ((~x08 | ~x71 | (~new_n264_ & x00)) & (~x00 | new_n264_ | x08));
  assign new_n264_ = new_n121_ & new_n122_;
  assign new_n265_ = (~x40 | (x32 & (~new_n131_ | ~new_n132_))) & (~x32 | x40 | (new_n131_ & new_n132_));
  assign new_n266_ = (~x70 | new_n267_ | ~x71) & ((~new_n270_ & new_n271_) | (x70 ^ ~x71));
  assign new_n267_ = ~new_n268_ & ~new_n269_ & (new_n225_ | ~x56);
  assign new_n268_ = x72 & ((~x73 & (x74 ? x51 : x52)) | (x48 & x73 & ~x74));
  assign new_n269_ = ~x72 & ((x55 & ~x73 & x74) | (x73 & (x74 ? x53 : x54)));
  assign new_n270_ = ~new_n225_ & x24;
  assign new_n271_ = x72 ? new_n272_ : (~new_n273_ & (~x23 | x73 | ~x74));
  assign new_n272_ = (x73 | (x74 ? ~x19 : ~x20)) & (~x16 | ~x73 | x74);
  assign new_n273_ = x73 & (x74 ? x21 : x22);
  assign new_n274_ = ~x70 & ~x71 & (new_n268_ | new_n269_ | (~new_n225_ & x56));
  assign new_n275_ = x65 & ~x66 & ~x67 & x68 & ~new_n263_ & ~x69;
  assign new_n276_ = ~x65 & ((~new_n288_ & (x66 ^ x67)) | (~x67 & (new_n285_ | (~new_n277_ & ~x66))));
  assign new_n277_ = x68 ? (~new_n274_ | x69) : (~x69 | (~new_n278_ & ~new_n282_));
  assign new_n278_ = x72 & ((x73 & (new_n279_ | (new_n280_ & x71))) | (x71 & ~new_n281_ & ~x73));
  assign new_n279_ = ~x74 & ((x16 & (~x70 ^ ~x71)) | (x48 & x70 & x71));
  assign new_n280_ = x74 & (x70 ? x56 : x24);
  assign new_n281_ = x70 ? (x74 ? ~x51 : ~x52) : (x74 ? ~x19 : ~x20);
  assign new_n282_ = x71 & ~x72 & (x70 ? ~new_n283_ : (new_n273_ | new_n284_));
  assign new_n283_ = x73 ? (x74 ? ~x53 : ~x54) : (x74 ? ~x55 : ~x56);
  assign new_n284_ = ~x73 & (x74 ? x23 : x24);
  assign new_n285_ = ~x68 & x69 & x70 & ~x71 & (new_n270_ | ~new_n286_);
  assign new_n286_ = (~new_n273_ | x72) & (x73 | ((new_n287_ | ~x72) & (~x23 | x72 | ~x74)));
  assign new_n287_ = x74 ? ~x19 : ~x20;
  assign new_n288_ = (new_n289_ | x68) & (~x40 | ((x68 | ~x70 | ~x71) & (~x68 | x69 | x70 | x71)));
  assign new_n289_ = (x71 | ((~x24 | ~x70) & (~x69 | (~x56 & ~x70)))) & (~x08 | x70 | ~x71);
  ...
  assign new_n293_ = ~x70 & x71 & ((x09 & (new_n127_ | ~x00)) | (x00 & ~new_n127_ & ~x09));
  assign new_n294_ = x70 & ~x71 & ((x41 & (new_n171_ | ~x32)) | (x32 & ~new_n171_ & ~x41));
  ...
  assign new_n301_ = (new_n225_ | ~x25) & (new_n302_ | ~x72) & (new_n303_ | x72);
  ...
  assign new_n307_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x57 | ~x69 | x70 | x71) & (new_n308_ | ~x70);
  assign new_n308_ = (~x41 | ~x71) & (~x25 | x69 | x71);
  assign new_n309_ = ~x67 & ((~new_n307_ & ~x68) | (new_n108_ & x41 & x68));
  assign z10 = x64 ? (~x65 & (x66 ? new_n338_ : ~new_n331_)) : ~new_n311_;
  assign new_n311_ = (~new_n328_ | ~x65) & (new_n114_ | (x70 ? new_n323_ : new_n312_));
  ...
  assign new_n336_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x58 | ~x69 | x70 | x71) & (new_n337_ | ~x70);
  ...
  assign new_n340_ = ((~new_n341_ & ~new_n351_) | (~x66 & ~x67)) & (~x65 | x66 | ~new_n355_ | x67);
  ...
  assign new_n354_ = ~x71 & ((x43 & (new_n132_ | ~x32)) | (x32 & ~new_n132_ & ~x43));
  ...
  assign new_n361_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x59 | ~x69 | x70 | x71) & (new_n362_ | ~x70);
  assign new_n362_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n363_ = ~x67 & ((~new_n361_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n388_ : ~new_n381_)) : ~new_n365_;
  assign new_n365_ = ((~new_n366_ & ~new_n376_) | (~x66 & ~x67)) & (~x65 | x66 | ~new_n380_ | x67);
  ...
  assign new_n377_ = ~new_n378_ & (x71 | (~new_n374_ & ~new_n375_)) & (~x71 | (~new_n370_ & ~new_n371_));
  ...
  assign new_n386_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x60 | ~x69 | x70 | x71) & (new_n387_ | ~x70);
  ...
  assign new_n411_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x61 | ~x69 | x70 | x71) & (new_n412_ | ~x70);
  ...
  assign new_n415_ = ~new_n429_ & (new_n114_ | (x70 ? new_n425_ : (~new_n416_ & ~new_n421_)));
  assign new_n416_ = x68 & ~x69 & (x65 ? (~new_n417_ & ~x71) : (~new_n420_ & x71));
  assign new_n417_ = (new_n225_ | ~x62) & (new_n418_ | ~x72) & (new_n419_ | x72);
  ...
  assign new_n422_ = (new_n225_ | ~x30) & (new_n423_ | ~x72) & (new_n424_ | x72);
  ...
  assign new_n426_ = ~new_n225_ & (x71 ? x62 : x30);
  ...
  assign new_n434_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x62 | ~x69 | x70 | x71) & (new_n435_ | ~x70);
  ...
  assign new_n440_ = (new_n225_ | ~x31) & (new_n441_ | ~x72) & (new_n442_ | x72);
  assign new_n441_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n442_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n443_ = (new_n225_ | ~x63) & (new_n444_ | ~x72) & (new_n445_ | x72);
  assign new_n444_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n445_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n446_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x63 | ~x69 | x70 | x71) & (new_n447_ | ~x70);
  assign new_n447_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n448_ = x65 & x69 & ~new_n439_ & ~new_n114_;
  assign new_n449_ = x64 ? (~new_n451_ | x65) : ((new_n450_ | new_n114_) & (~new_n452_ | ~x65));
