...
module FAU ( 
  ...
  assign z3 = ~new_n29_ | (x13 & (new_n31_ | (x04 & (x11 | x12))));
  assign new_n29_ = x05 & (x04 | x07) & (~new_n30_ | ~x02 | ~x03 | ~x04);
  assign new_n30_ = ~x12 & ~x13 & ~x09 & ~x11;
  assign new_n31_ = ~x07 & (~x02 | ~x03 | x09);
