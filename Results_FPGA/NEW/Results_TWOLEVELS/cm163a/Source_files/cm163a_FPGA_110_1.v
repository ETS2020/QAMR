// Benchmark "FAU" written by ABC on Wed Jul 29 03:28:04 2020
...
module FAU ( 
  ...
  assign new_n25_ = x02 & x03 & ~x09;
  assign z2 = (~new_n27_ & x04) | ~x05 | (~x04 & ~x06);
  assign new_n27_ = (~x12 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x12);
  assign z3 = (~new_n29_ & x04) | ~x05 | (~x04 & ~x07);
  assign new_n29_ = (~x13 | (x02 & x03 & ~x09 & ~x12)) & (~x02 | ~x03 | x09 | x12 | x13);
