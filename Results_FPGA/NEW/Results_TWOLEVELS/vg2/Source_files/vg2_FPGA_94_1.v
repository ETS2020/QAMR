...
module FAU ( 
  ...
  assign new_n42_ = x14 & x16 & x17 & x20 & ~new_n43_ & x23;
  ...
  assign new_n58_ = x20 & x23 & x16 & x17;
  ...
  assign new_n76_ = x09 & (x17 | ~x22) & (x04 | ~x23);
