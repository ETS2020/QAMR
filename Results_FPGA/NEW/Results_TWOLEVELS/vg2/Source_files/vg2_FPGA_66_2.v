...
module FAU ( 
  ...
  assign z4 = (z5 & (x08 | (~new_n80_ & ~x16))) | (new_n77_ & x16) | (z7 & ~x08);
  assign new_n77_ = ~new_n78_ & (new_n79_ | new_n64_ | (x08 & x18 & x24));
  assign new_n78_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n79_ = x15 & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n80_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z6 = (z5 & (x03 | (~new_n84_ & ~x11))) | (new_n82_ & x11) | (z7 & ~x03);
  assign new_n82_ = (~new_n83_ | new_n79_) & (~x06 | (x14 & ~x20));
  assign new_n83_ = ~new_n64_ & (~x03 | ~x18 | ~x24);
