...
module FAU ( 
  ...
  assign z0 = ~x01 & ~x03 & ~x06 & new_n36_ & ~x14;
  assign new_n36_ = ~x20 & (new_n37_ | new_n38_);
  assign new_n37_ = ~x11 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  ...
  assign new_n56_ = new_n57_ & new_n59_ & ~x10 & ~x12 & ~x14 & ~x16;
  ...
  assign new_n71_ = ~x08 & ~x10 & ~x14 & ~x20 & ~x24;
  ...
  assign z6 = (~new_n79_ & ~x24) | (x24 & ~new_n86_ & (x05 | x13)) | (~x05 & ~new_n89_ & ~x13);
  assign new_n79_ = (new_n80_ | ~x03) & ~new_n82_ & (~new_n85_ | ~x05) & (new_n84_ | x03);
  assign new_n80_ = ~new_n81_ & (~x05 | ~x13 | ~x19);
  assign new_n81_ = x00 & ~x02 & ~x10;
  assign new_n82_ = (new_n81_ | new_n83_) & (x06 | (~x14 & x20));
  assign new_n83_ = x05 & ~x11 & x13 & x19;
  assign new_n84_ = (~x05 | ~x13 | ~x15) & (x02 | x10 | ~x21);
  assign new_n85_ = x11 & x13 & x15 & (~x06 | (x14 & ~x20));
  assign new_n86_ = (new_n88_ | ~x07) & (new_n87_ | ~x18);
  assign new_n87_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n88_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n89_ = (new_n87_ | ~x15) & (new_n88_ | ~x19);
endmodule
