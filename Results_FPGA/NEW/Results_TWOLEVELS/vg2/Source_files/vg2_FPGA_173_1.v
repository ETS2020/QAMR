...
module FAU ( 
  ...
  assign new_n57_ = ~x08 & ~x09 & ~x04 & ~x06;
  assign new_n58_ = ~x12 & ~x14 & ~x10 & ~x11;
  assign new_n59_ = ~x16 & ~x17 & ~x20 & ~x22 & ~x24;
  ...
  assign z4 = new_n79_ | new_n80_ | new_n84_ | new_n86_;
  assign new_n79_ = z7 & (~x08 | (x16 & (~x09 | (~x17 & x22))));
  assign new_n80_ = (x05 ? (x13 & ~x24) : ~x13) & (new_n83_ | (~new_n81_ & x19));
  assign new_n81_ = ~new_n82_ & ~x08;
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n83_ = ~x04 & x15 & x16 & x22 & x23;
  assign new_n84_ = x24 & ~new_n60_ & (new_n85_ | (~new_n81_ & x07));
  assign new_n85_ = ~x04 & x16 & x18 & x22 & x23;
  assign new_n86_ = x00 & ~x02 & ~x10 & ~new_n87_ & ~x24;
  assign new_n87_ = ~x08 & (x16 | (~x09 & (x22 | (~x04 & ~x17))));
