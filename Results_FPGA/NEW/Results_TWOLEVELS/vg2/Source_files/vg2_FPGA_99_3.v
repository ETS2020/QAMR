...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | new_n55_ | (~x05 & ~new_n47_ & ~x13);
  ...
  assign new_n49_ = new_n50_ & ~x16 & ~x17 & ~x12 & ~x14;
  ...
  assign new_n55_ = ~x01 & ~x03 & ~x04 & new_n56_ & ~x06;
  assign new_n56_ = x07 & ~x08 & ~x09 & ~x11 & new_n57_ & ~x12;
  assign new_n57_ = ~x14 & ~x16 & ~x17 & new_n58_ & ~x20;
  assign new_n58_ = ~x22 & ~x23 & x24 & (x05 | x13);
  assign z2 = x01 & x03 & x06 & x11 & new_n60_ & x14;
  assign new_n60_ = x20 & (new_n61_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
  ...
  assign new_n64_ = x11 & x14 & ~new_n43_ & x20;
  assign new_n65_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
  ...
  assign new_n69_ = ~x01 & ~x03 & ~x06 & x07 & new_n70_ & ~x08;
  assign new_n70_ = ~x11 & ~x14 & ~x20 & x24 & (x05 | x13);
  ...
  assign z6 = new_n76_ | new_n77_ | (x18 & new_n79_ & x24);
  assign new_n76_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n77_ = ~new_n78_ & (new_n61_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n78_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n79_ = (x05 | x13) & (~x03 | (x11 & (~x06 | x14)));
endmodule
