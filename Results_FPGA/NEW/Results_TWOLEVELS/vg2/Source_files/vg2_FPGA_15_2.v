...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n56_ | (x24 & ~new_n49_ & (x05 | x13));
  ...
  assign new_n57_ = new_n51_ & x22 & x23 & ~x24 & x20 & x21;
  ...
  assign z3 = (~new_n64_ & ~x24) | (x24 & ~new_n69_ & (x05 | x13)) | (~x05 & ~new_n73_ & ~x13);
  ...
  assign new_n68_ = (~x05 | ~x13 | ~x19) & (~x00 | x02 | x10);
  ...
  assign z4 = (~new_n77_ & (new_n78_ | x08)) | new_n80_ | (z7 & (new_n79_ | ~x08));
  assign new_n77_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n80_ = x00 & ~x02 & x08 & ~x10 & ~x24;
