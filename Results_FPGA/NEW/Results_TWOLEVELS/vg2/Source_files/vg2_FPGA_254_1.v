...
module FAU ( 
  ...
  assign z2 = x01 & x03 & x06 & new_n63_ & x14;
  assign new_n63_ = x20 & (new_n64_ | new_n65_);
  assign new_n64_ = x11 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  ...
  assign new_n68_ = x14 & x20 & (new_n43_ | new_n44_);
  ...
  assign z6 = new_n82_ | new_n85_ | (~x24 & (new_n84_ | (~new_n83_ & ~x03)));
  assign new_n82_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n83_ = ~new_n44_ & (~x05 | ~x13 | ~x15);
  assign new_n84_ = (new_n43_ | new_n44_) & (~x06 | (x14 & ~x20));
  assign new_n85_ = ~new_n86_ & ((~x05 & ~x13 & x15) | (x18 & x24 & (x05 | x13)));
