...
module FAU ( 
  ...
  assign new_n49_ = new_n50_ & new_n52_ & ~x11 & ~x12 & ~x14;
  assign new_n50_ = new_n51_ & ~x08 & ~x09 & ~x06 & x07;
  assign new_n51_ = ~x01 & ~x03 & ~x04;
  assign new_n52_ = ~x22 & ~x23 & ~x16 & ~x17;
  ...
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n65_ | (~x05 & ~x13 & x15) | (x13 & x18 & x24);
  ...
  assign new_n70_ = (~new_n71_ | x01 | x03 | x06) & (~new_n72_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n71_ = x07 & ~x08 & ~x11 & ~x14;
  ...
  assign z6 = new_n81_ | new_n85_ | (x24 & ~new_n83_ & (x05 | x13));
  assign new_n81_ = ~new_n82_ & (new_n38_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n82_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n83_ = (new_n84_ | ~x18) & (~x07 | (~x03 & (~x06 | x11)));
  assign new_n84_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n85_ = ~new_n84_ & (new_n65_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
endmodule
