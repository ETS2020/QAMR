...
module FAU ( 
  ...
  assign new_n41_ = x09 & x11 & x12 & new_n42_ & x14;
  ...
  assign new_n53_ = x11 & x12 & x06 & x09;
  assign new_n54_ = x22 & x23 & x18 & x20;
  assign new_n55_ = ~new_n56_ & (~new_n52_ | ~new_n58_ | ~x14 | ~x15 | ~x16);
  ...
  assign z3 = (~new_n64_ & ~x24) | (x24 & ~new_n67_ & (x05 | x13)) | (~x05 & ~new_n70_ & ~x13);
  assign new_n64_ = x01 ? (~x03 | ~new_n65_ | ~x06) : (x03 | ~new_n66_ | x06);
  assign new_n65_ = x11 & x14 & ~new_n43_ & x20;
  assign new_n66_ = ~x08 & ~x11 & ~new_n46_ & ~x14;
  assign new_n67_ = (~new_n68_ | x01 | x03 | x06) & (~new_n69_ | ~x01 | ~x03 | ~x06);
  assign new_n68_ = x07 & ~x08 & ~x11 & ~x14;
  assign new_n69_ = x18 & x20 & x11 & x14;
  assign new_n70_ = (~new_n71_ | x01 | x03 | x06) & (~new_n72_ | ~x01 | ~x03 | ~x06);
  assign new_n71_ = ~x14 & x19 & ~x08 & ~x11;
