...
module FAU ( 
  ...
  assign new_n36_ = ~x11 & ~x14 & ~x20 & (~new_n37_ | (~x05 & x19));
  assign new_n37_ = ~new_n38_ & (~x05 | ~x07 | ~x24);
  ...
  assign new_n50_ = (~x18 | ~x24 | (~x13 & (~x05 | ~x20))) & (x05 | x13 | ~x15 | ~x20);
  ...
  assign new_n56_ = ~new_n57_ & ~new_n60_ & (~x20 | (~new_n58_ & ~new_n59_));
  assign new_n57_ = x05 & ((x18 & x20 & x24) | (x13 & x15 & ~x24));
  assign new_n58_ = ~x05 & ~x13 & x15;
  assign new_n59_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n60_ = x13 & x18 & x24;
  ...
  assign new_n66_ = ~x14 & ~x20 & (x05 ? (x07 & x24) : x19);
  ...
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n59_ | (~x05 & ~x13 & x15) | (x13 & x18 & x24);
  assign new_n73_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n74_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n76_ | new_n78_ | new_n80_ | (~new_n81_ & x13);
  assign new_n76_ = ~new_n77_ & (~new_n37_ | (~x05 & ~x13 & x19));
  assign new_n77_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n78_ = (~new_n79_ | new_n58_) & (~x03 | (~x06 & x11));
  assign new_n79_ = ~new_n59_ & (~x05 | ~x18 | ~x24);
  assign new_n80_ = x11 & x14 & ~x20 & (~new_n79_ | (~x05 & x15));
  assign new_n81_ = (new_n82_ | (~x03 & (x11 | (~x06 & x14)))) & (new_n83_ | (x03 & (x06 | ~x11)));
  assign new_n82_ = (~x07 | ~x24) & (~x05 | ~x19 | x24);
  assign new_n83_ = (~x18 | ~x24) & (~x05 | ~x15 | x24);
endmodule
