...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n56_ | (x24 & ~new_n50_ & (x05 | x13));
  assign new_n40_ = ~new_n43_ & (~new_n41_ | ~new_n48_ | ~new_n49_ | ~x17 | ~x20);
  assign new_n41_ = new_n42_ & x01 & x03 & x04;
  assign new_n42_ = x09 & x11 & x06 & x08;
  assign new_n43_ = new_n44_ & new_n45_ & new_n46_ & new_n47_ & x19 & ~x20;
  ...
  assign new_n50_ = ~new_n51_ & (~new_n41_ | ~new_n55_ | ~new_n49_ | ~x18 | ~x20);
  assign new_n51_ = new_n53_ & new_n54_ & new_n44_ & new_n52_;
  ...
  assign new_n56_ = ~x10 & ~x24 & (new_n58_ | (new_n41_ & new_n57_));
  assign new_n57_ = new_n55_ & new_n49_ & x20 & x21;
  assign new_n58_ = new_n59_ & new_n60_ & new_n53_ & new_n54_;
  ...
  assign z3 = (~new_n66_ & ~x24) | (x24 & ~new_n71_ & (x05 | x13)) | (~x05 & ~new_n75_ & ~x13);
  ...
  assign z4 = (z5 & (new_n82_ | x08)) | new_n79_ | (z7 & (new_n83_ | ~x08));
  assign new_n79_ = x16 & x22 & ~new_n80_ & (~x17 | (~x04 & x23));
  assign new_n80_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n81_ & (x05 | x13 | ~x15);
  assign new_n81_ = ~x10 & x21 & ~x24;
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n83_ = ~x09 & x16;
  assign z6 = (z5 & (x03 | (~new_n85_ & ~x11))) | (z7 & (~x03 | (~new_n86_ & x11)));
