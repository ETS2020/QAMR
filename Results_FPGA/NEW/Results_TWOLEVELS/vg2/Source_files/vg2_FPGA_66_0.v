...
module FAU ( 
  ...
  assign z4 = (~new_n77_ & x24) | new_n83_ | (~x02 & ~x10 & ~new_n85_ & ~x24);
  assign new_n77_ = (new_n82_ | ((~x07 | x19) & (new_n78_ | ~x18))) & (~x07 | new_n80_ | ~x19);
  ...
  assign new_n83_ = ~new_n84_ & ((~new_n78_ & x15) | (~new_n80_ & x19));
  assign new_n84_ = x05 ? (~x13 | x24) : x13;
  assign new_n85_ = (new_n78_ | ~x21) & (new_n80_ | ~x00);
  assign z5 = (x05 & ((x13 & x19 & ~x24) | (x07 & ~x19 & x24))) | new_n38_ | (~x05 & ~x13 & x19) | (x07 & x24 & (x19 | (x13 & ~x19)));
  assign z6 = ~new_n88_ | (~new_n92_ & x24);
  assign new_n88_ = ~new_n89_ & (new_n91_ | (~new_n64_ & (new_n84_ | ~x15)));
  assign new_n89_ = ~new_n90_ & (new_n38_ | (~new_n84_ & x19));
  assign new_n90_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n91_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n92_ = (new_n82_ | ((~x07 | x19) & (new_n91_ | ~x18))) & (~x07 | new_n90_ | ~x19);
endmodule
