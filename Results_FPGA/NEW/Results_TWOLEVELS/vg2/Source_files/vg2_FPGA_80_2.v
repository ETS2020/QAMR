...
module FAU ( 
  ...
  assign z4 = (z5 & (new_n76_ | new_n75_ | x08)) | (z7 & (new_n77_ | ~x08));
  assign new_n75_ = new_n50_ & x04;
  assign new_n76_ = ~x16 & (x09 | (x17 & ~x22));
