...
module FAU ( 
  ...
  assign new_n51_ = new_n47_ & new_n53_ & new_n54_ & new_n52_ & ~x17 & ~x20;
  ...
  assign new_n58_ = x17 & x20 & x21 & x22 & ~x24;
  ...
  assign z4 = new_n78_ | new_n79_ | new_n84_ | (~new_n83_ & ~new_n59_);
  assign new_n78_ = z5 & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  assign new_n79_ = x24 & (x05 | x13) & (new_n82_ | (~new_n80_ & x18));
  assign new_n80_ = ~new_n81_ & x08;
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n82_ = x04 & x07 & new_n52_ & ~x16;
  assign new_n83_ = (new_n80_ | ~x15) & (~x04 | x16 | ~new_n52_ | ~x19);
  assign new_n84_ = ~x02 & ~x10 & x21 & ~new_n85_ & ~x24;
  assign new_n85_ = x08 & (~x16 | (x09 & (~x22 | (x04 & x17))));
