...
module FAU ( 
  ...
  assign new_n40_ = x01 ? (~x03 | ~x04 | ~new_n41_ | ~x06) : (x04 | ~new_n44_ | x06);
  ...
  assign new_n49_ = new_n50_ & ~x09 & ~x11 & x07 & ~x08;
  assign new_n50_ = ~x01 & ~x04 & ~x06;
  ...
  assign new_n57_ = new_n50_ & ~x11 & ~x12 & ~x08 & ~x09;
  ...
  assign new_n65_ = x01 ? (~x03 | ~new_n66_ | ~x06) : (~new_n67_ | x06);
  assign new_n66_ = x11 & x14 & ~new_n43_ & x20;
  assign new_n67_ = ~x08 & ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign new_n68_ = (~new_n69_ | ~x01 | ~x03 | ~x06) & (~new_n70_ | x01 | x06 | ~x07);
  assign new_n69_ = x18 & x20 & x11 & x14;
  assign new_n70_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n71_ = (~new_n72_ | ~x01 | ~x03 | ~x06) & (~new_n73_ | x01 | x06 | x08);
