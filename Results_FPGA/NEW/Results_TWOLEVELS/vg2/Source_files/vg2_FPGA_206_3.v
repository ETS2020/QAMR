...
module FAU ( 
  ...
  assign new_n45_ = ~x16 & ~x17 & ~x22 & (new_n46_ | new_n47_) & ~x23;
  assign new_n46_ = x00 & ~x02 & ~x10;
  assign new_n47_ = x05 & x13 & x19 & ~x20;
  ...
  assign z7 = (x05 & ((x13 & x15 & ~x24) | (x18 & x24))) | (x13 & x18 & x24) | new_n65_ | (~x05 & ~x13 & x15);
  ...
  assign new_n69_ = ~x11 & ~x14 & (new_n46_ | new_n47_);
  ...
  assign new_n83_ = (new_n84_ | ~x18) & (x14 | ~x20 | ~x07 | x11);
  assign new_n84_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n85_ = (new_n84_ | ~x15) & (x11 | x14 | ~x19 | ~x20);
  assign new_n86_ = ~x02 & ~x10 & x21 & ~new_n84_ & ~x24;
endmodule
