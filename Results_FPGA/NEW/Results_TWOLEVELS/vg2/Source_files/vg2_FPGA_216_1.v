...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n60_, new_n61_, new_n62_, new_n66_, new_n67_, new_n68_, new_n70_,
    new_n71_, new_n72_, new_n73_, new_n74_, new_n75_, new_n76_, new_n77_,
    new_n78_, new_n79_;
  assign z0 = ~x01 & ~x03 & ~x06 & new_n36_ & ~x11;
  assign new_n36_ = ~x14 & ((~new_n37_ & ~x20) | (~x05 & ~x13 & x19));
  ...
  assign new_n43_ = (~x05 | ~x15) & (x02 | x10 | ~x21);
  ...
  assign new_n47_ = ~new_n51_ & (x01 | x03 | ~new_n48_ | x04);
  assign new_n48_ = ~x06 & ~x08 & ~x09 & ~x11 & new_n49_ & ~x12;
  assign new_n49_ = ~x14 & ~x16 & ~x17 & ~x22 & ~new_n50_ & ~x23;
  assign new_n50_ = (x05 | x13 | ~x19) & (~x07 | x20 | ~x24 | (~x05 & ~x13));
  assign new_n51_ = new_n52_ & new_n54_ & x04 & x06 & x01 & x03;
  assign new_n52_ = new_n53_ & x14 & x16 & x17 & x18;
  assign new_n53_ = x23 & x24 & x20 & x22;
  assign new_n54_ = x11 & x12 & x08 & x09;
  assign z2 = x01 & x03 & new_n56_ & x06;
  assign new_n56_ = x11 & x14 & x20 & (x24 ? x18 : ~new_n43_);
  assign z3 = ~new_n58_ | (~x24 & (x01 ? (new_n61_ & x03) : (new_n62_ & ~x03)));
  assign new_n58_ = (x01 | x03 | x06 | ~new_n59_ | x08) & (~new_n60_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n59_ = ~x11 & ~new_n50_ & ~x14;
  assign new_n60_ = x11 & x14 & x18 & x20 & x24;
  ...
  assign z6 = (~new_n70_ & ~x24) | new_n75_ | (~new_n77_ & x24) | (new_n79_ & ~x05);
  assign new_n70_ = new_n71_ & (new_n46_ | (~x03 & (~x06 | x11)));
  assign new_n71_ = (new_n72_ | new_n73_) & (x11 | x14 | new_n74_ | ~x20);
  assign new_n72_ = (x02 | x10 | ~x21) & (~x05 | ~x13 | ~x15);
  assign new_n73_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n74_ = (~x00 | x02 | x10) & (~x05 | ~x19);
  assign new_n75_ = ~new_n76_ & (x03 | (x06 & ~x11));
  assign new_n76_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign new_n77_ = ~new_n78_ & (~x18 | new_n73_ | (~x05 & ~x13));
  assign new_n78_ = x07 & ~x11 & ~x14 & x20;
  assign new_n79_ = ~x13 & x15 & (~x03 | (x11 & (~x06 | x14)));
endmodule
