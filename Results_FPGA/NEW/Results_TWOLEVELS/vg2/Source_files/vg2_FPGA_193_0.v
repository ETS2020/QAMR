...
module FAU ( 
  ...
  assign new_n54_ = (new_n57_ | ~x05) & (new_n55_ | ~x20) & (x05 | x13 | ~x15);
  assign new_n55_ = ~new_n56_ & (~x13 | ~x18 | ~x24);
  assign new_n56_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n57_ = (x13 | ~x18 | ~x24) & (~x13 | ~x15 | ~x20 | x24);
  ...
  assign z6 = new_n71_ | new_n73_ | new_n75_ | (~x05 & ~new_n79_ & ~x13);
  assign new_n71_ = ~new_n72_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n72_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & ~new_n66_ & (~x07 | ~x13 | ~x24);
  assign new_n73_ = ~x03 & (~new_n55_ | new_n74_);
  assign new_n74_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n75_ = x11 & ((~x24 & (new_n76_ | new_n77_)) | (x18 & ~new_n78_ & x24));
  assign new_n76_ = ~x02 & ~x10 & x21 & (~x06 | (x14 & ~x20));
  assign new_n77_ = x05 & x15 & ((~x06 & x13) | (x14 & ~x20));
  assign new_n78_ = (~x14 | x20) & (x06 | (~x05 & ~x13));
  assign new_n79_ = (~x19 | (~x03 & (x11 | (~x06 & x14)))) & (~x15 | (x03 & (x06 | ~x11)));
endmodule
