// Benchmark "FAU" written by ABC on Wed Jul 29 04:19:11 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n58_, new_n60_, new_n62_, new_n63_, new_n64_, new_n65_, new_n66_,
    new_n67_, new_n68_, new_n69_, new_n70_, new_n74_, new_n75_, new_n76_,
    new_n78_, new_n79_;
  assign z0 = ~x03 & ~x06 & ~x11 & new_n36_ & ~x14;
  assign new_n36_ = ~x20 & (new_n37_ | new_n38_);
  assign new_n37_ = ~x01 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  ...
  assign new_n56_ = new_n57_ & new_n58_ & ~x06 & ~x08 & ~x09 & ~x10;
  assign new_n57_ = new_n52_ & ~x22 & ~x23 & ~x24 & ~x17 & ~x20;
  assign new_n58_ = x00 & ~x02 & ~x03 & ~x04;
  assign z2 = x01 & x03 & x06 & x11 & new_n60_ & x14;
  assign new_n60_ = x20 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  assign z3 = (~new_n66_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n69_ | (x24 & ~new_n62_ & (x05 | x13));
  ...
  assign new_n66_ = (~new_n68_ | x01 | x03 | x06 | x08) & (~new_n67_ | ~x01 | ~x03 | ~x06 | ~x08);
  assign new_n67_ = x11 & x14 & x15 & x20;
  assign new_n68_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n69_ = new_n70_ & ~x03 & ~x06 & ~x08 & x00 & ~x02;
  ...
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | new_n74_ | (~x05 & ~x13 & x15);
