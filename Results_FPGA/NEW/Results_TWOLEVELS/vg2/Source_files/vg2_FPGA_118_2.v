...
module FAU ( 
  ...
  assign new_n44_ = ~x09 & ~x11 & ~x12 & new_n45_ & ~x14;
  ...
  assign new_n48_ = new_n49_ & new_n51_ & ~x12 & ~x14 & ~x16;
  assign new_n49_ = new_n50_ & ~x09 & ~x11 & ~x06 & x07;
  ...
  assign new_n55_ = ~new_n56_ & (~new_n52_ | ~new_n59_ | ~x12 | ~x14 | ~x15);
  assign new_n56_ = new_n57_ & new_n58_ & ~x14 & ~x16 & ~x17;
  assign new_n57_ = new_n50_ & ~x11 & ~x12 & ~x06 & ~x09;
  assign new_n58_ = x19 & ~x20 & ~x22 & ~x23;
  assign new_n59_ = x22 & x23 & x16 & x17;
  ...
  assign z3 = (~new_n65_ & ~x24) | (x24 & ~new_n68_ & (x05 | x13)) | (~x05 & ~new_n71_ & ~x13);
  assign new_n65_ = x01 ? (~x03 | ~new_n66_ | ~x06) : (x03 | ~new_n67_ | x06);
  assign new_n66_ = x08 & x11 & ~new_n43_ & x14;
  assign new_n67_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign new_n68_ = (~new_n70_ | x01 | x03 | x06) & (~new_n69_ | ~x01 | ~x03 | ~x06);
  assign new_n69_ = x14 & x18 & x08 & x11;
  assign new_n70_ = x07 & ~x11 & ~x14 & ~x20;
  assign new_n71_ = (~new_n73_ | x01 | x03 | x06) & (~new_n72_ | ~x01 | ~x03 | ~x06);
  assign new_n72_ = x14 & x15 & x08 & x11;
