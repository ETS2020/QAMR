...
module FAU ( 
  ...
  assign z6 = ~new_n84_ | (~x11 & ~new_n37_ & (x06 | (~x14 & x20)));
  assign new_n84_ = (~new_n85_ | ~x24) & ~new_n87_ & (x02 | x10 | new_n88_ | x24);
  assign new_n85_ = ~new_n62_ & ((x03 & x07) | (~new_n86_ & x18));
  assign new_n86_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n87_ = ~new_n49_ & ((~new_n86_ & x15) | (x03 & x19));
  assign new_n88_ = (~x00 | ~x03) & (new_n86_ | ~x21);
endmodule
