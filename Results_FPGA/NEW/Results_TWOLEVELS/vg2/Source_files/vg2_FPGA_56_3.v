// Benchmark "FAU" written by ABC on Wed Jul 29 04:18:43 2020
...
module FAU ( 
  ...
  assign new_n73_ = (~new_n75_ | x01 | x03 | x06 | x08) & (~new_n74_ | ~x01 | ~x03 | ~x06 | ~x08);
  assign new_n74_ = x15 & x20 & x11 & x14;
  assign new_n75_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (z5 & (x08 | (~new_n79_ & ~x16))) | (z7 & (~x08 | (~new_n80_ & x16)));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | new_n78_ | (~x05 & ~x13 & x15);
  assign new_n78_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n79_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n80_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = ~new_n82_ | (z5 & (x03 | (x06 & ~x11)));
  assign new_n82_ = (~x24 | new_n83_ | (~x05 & ~x13)) & ~new_n86_ & (new_n85_ | (x05 ? (~x13 | x24) : x13));
  assign new_n83_ = (new_n84_ | ~x18) & (~x07 | x11 | x14 | ~x20);
  assign new_n84_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n85_ = (new_n84_ | ~x15) & (~x19 | ~x20 | x11 | x14);
  assign new_n86_ = ~x02 & ~x24 & (new_n87_ | (~x10 & ~new_n84_ & x21));
  assign new_n87_ = x00 & ~x11 & ~x14 & x20;
endmodule
