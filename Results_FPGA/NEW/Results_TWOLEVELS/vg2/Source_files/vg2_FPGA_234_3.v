...
module FAU ( 
  ...
  assign z1 = new_n40_ | (x24 & ~new_n50_ & ~new_n61_) | (~x10 & ~new_n57_ & ~x24);
  assign new_n40_ = ~new_n49_ & ((new_n41_ & new_n43_) | (new_n45_ & new_n47_));
  ...
  assign new_n50_ = ~new_n51_ & (~new_n41_ | ~new_n56_ | ~new_n55_ | ~x18 | ~x20);
  ...
  assign new_n57_ = (~new_n41_ | ~new_n58_) & (~new_n53_ | ~new_n54_ | ~new_n59_ | ~new_n60_);
  assign new_n58_ = new_n56_ & new_n55_ & x20 & x21;
  ...
  assign z3 = (~new_n74_ & ~new_n49_) | (new_n67_ & x24) | (~x10 & ~new_n72_ & ~x24);
  assign new_n67_ = ~new_n61_ & (new_n68_ | new_n70_);
  ...
  assign new_n72_ = ~new_n73_ & (~new_n69_ | ~x11 | ~x14 | ~x20 | ~x21);
  assign new_n73_ = new_n59_ & ~x06 & ~x08 & ~x11 & ~x14 & ~x20;
  ...
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | new_n79_ | (~x05 & ~x13 & x15);
