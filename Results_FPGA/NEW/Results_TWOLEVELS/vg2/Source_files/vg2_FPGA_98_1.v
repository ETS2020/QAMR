...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n58_, new_n59_, new_n61_, new_n63_, new_n64_, new_n65_, new_n66_,
  ...
  assign new_n37_ = ~x14 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  ...
  assign new_n52_ = new_n54_ & new_n55_ & new_n45_ & new_n53_ & ~x06 & x07;
  assign new_n53_ = ~x08 & ~x09;
  assign new_n54_ = ~x11 & ~x12 & ~x14 & ~x16;
  assign new_n55_ = ~x17 & ~x20 & ~x22 & ~x23;
  assign new_n56_ = new_n57_ & new_n59_ & ~x10 & ~x11 & ~x12 & ~x16;
  assign new_n57_ = new_n58_ & ~x02 & ~x03 & x00 & ~x01;
  assign new_n58_ = ~x04 & ~x06 & ~x08 & ~x09;
  assign new_n59_ = ~x17 & ~x20 & ~x22 & ~x23 & ~x24;
  assign z2 = x01 & x03 & x06 & x11 & new_n61_ & x14;
  assign new_n61_ = x20 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  ...
  assign new_n79_ = (new_n80_ | (x05 ? (~x13 | x24) : x13)) & ~new_n83_ & (~x24 | new_n82_ | (~x05 & ~x13));
  assign new_n80_ = (new_n81_ | ~x19) & (~x11 | ~x14 | ~x15 | x20);
  assign new_n81_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n82_ = (new_n81_ | ~x07) & (~x18 | x20 | ~x11 | ~x14);
  assign new_n83_ = x00 & new_n84_ & ~x02;
  assign new_n84_ = ~x10 & ~x24 & (x03 | (~x11 & (x06 | x20)));
endmodule
