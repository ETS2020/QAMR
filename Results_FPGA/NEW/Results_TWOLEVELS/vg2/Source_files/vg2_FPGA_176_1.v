...
module FAU ( 
  ...
  assign z1 = new_n40_ | (x24 & ~new_n49_ & ~new_n61_) | (~x10 & ~new_n56_ & ~x24);
  ...
  assign new_n49_ = ~new_n50_ & (~new_n53_ | ~new_n55_ | x01 | x03 | x04);
  assign new_n50_ = new_n51_ & new_n52_ & new_n42_ & x01 & x03 & x04;
  ...
  assign new_n56_ = ~new_n57_ & (~new_n53_ | ~new_n60_ | ~x00 | x01 | x03);
  assign new_n57_ = new_n42_ & new_n58_ & new_n51_ & new_n59_;
  assign new_n58_ = x03 & x04 & x01 & ~x02;
  assign new_n59_ = x20 & x21 & x22 & x23;
  ...
  assign new_n71_ = ~x10 & ~x24 & (new_n72_ | new_n73_);
  assign new_n72_ = new_n70_ & ~x03 & ~x06 & x00 & ~x01;
  ...
  assign z6 = (z5 & (x03 | (~new_n84_ & ~x11))) | (z7 & (~x03 | (~new_n85_ & x11)));
