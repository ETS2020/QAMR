...
module FAU ( 
  ...
  assign z4 = (~new_n78_ & (~x08 | (~new_n81_ & x16))) | (z5 & (x08 | (~new_n80_ & ~x16)));
  ...
  assign z6 = ~new_n83_ | (~x11 & z5 & (x06 | (~x14 & x20)));
  assign new_n83_ = ~new_n84_ & ~new_n87_ & (new_n49_ | (~new_n86_ & (~x03 | ~x19)));
  assign new_n84_ = x24 & ~new_n61_ & ((x03 & x07) | (x18 & (new_n85_ | ~x03)));
  assign new_n85_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n86_ = x15 & (new_n85_ | ~x03);
  assign new_n87_ = ~x10 & ~x24 & ((~new_n88_ & x03) | (~x02 & ~x03 & x21));
  assign new_n88_ = ~x00 & (~x11 | ~x21 | (x06 & (~x14 | x20)));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n90_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n90_ = ~x10 & x21 & ~x24 & (x03 | (~x02 & ~x03));
endmodule
