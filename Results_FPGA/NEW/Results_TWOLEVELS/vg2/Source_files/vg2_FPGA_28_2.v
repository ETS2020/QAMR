...
module FAU ( 
  ...
  assign new_n36_ = ~x20 & (new_n37_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n37_ = x00 & ~x02 & ~x10 & ~x24;
  assign z1 = (~new_n39_ & ~x24) | new_n54_ | (~x05 & ~new_n46_ & ~x13);
  ...
  assign new_n46_ = ~new_n47_ & (~new_n51_ | ~new_n53_ | ~x01 | ~x03 | ~x04);
  assign new_n47_ = new_n48_ & new_n50_ & ~x01 & ~x03 & ~x04;
  assign new_n48_ = new_n49_ & ~x12 & ~x14 & ~x16 & ~x17;
  ...
  assign new_n54_ = x01 & x03 & x04 & new_n55_ & x06;
  assign new_n55_ = x08 & x09 & x11 & x12 & new_n56_ & x14;
  assign new_n56_ = x16 & x17 & x18 & new_n57_ & x20;
  assign new_n57_ = x22 & x23 & x24 & (x05 | x13);
  ...
  assign z3 = (~new_n63_ & ~x24) | new_n69_ | (~x05 & ~new_n66_ & ~x13);
  assign new_n63_ = x01 ? (~x03 | ~x06 | ~new_n64_ | ~x08) : (x03 | x06 | ~new_n65_ | x08);
  assign new_n64_ = x11 & x14 & ~new_n42_ & x20;
  ...
  assign new_n70_ = x14 & x18 & x20 & x24 & (x05 | x13);
  ...
  assign z6 = new_n76_ | new_n81_ | (x24 & ~new_n78_ & (x05 | x13));
  assign new_n76_ = ~new_n77_ & (new_n37_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n77_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n78_ = ~new_n80_ & (new_n79_ | ~x18);
  assign new_n79_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n80_ = x07 & (x03 | (~x11 & (x06 | ~x14)));
  assign new_n81_ = ~new_n79_ & (new_n61_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
endmodule
