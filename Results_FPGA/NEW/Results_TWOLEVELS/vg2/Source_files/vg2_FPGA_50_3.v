...
module FAU ( 
  ...
  assign new_n42_ = ~x22 & (new_n43_ | (x05 & x13 & x19));
  assign new_n43_ = x00 & ~x02 & ~x10 & ~x23;
  ...
  assign new_n47_ = x22 & x23 & (x05 ? (x18 & x24) : x15);
  assign new_n48_ = ~x08 & ~x09 & ~x11 & new_n49_ & ~x12;
  assign new_n49_ = ~x14 & ~x16 & ~x17 & ~x20 & ~new_n50_ & ~x22;
  assign new_n50_ = (~x07 | ~x24 | (~x13 & (~x05 | x23))) & (x05 | x13 | ~x19 | x23);
  assign new_n51_ = new_n52_ & new_n54_ & x01 & ~x02 & x03 & x04;
  assign new_n52_ = new_n53_ & x14 & x16 & x11 & x12;
  assign new_n53_ = x17 & x20 & x21 & x22 & x23;
  ...
  assign z4 = (~new_n78_ & x16) | new_n84_ | new_n80_ | new_n86_ | (~new_n73_ & ~x16);
  assign new_n73_ = ~new_n77_ & (new_n74_ | x22);
  assign new_n74_ = ~new_n75_ & (~x04 | x05 | x13 | ~x19 | x23);
  assign new_n75_ = ~x24 & (new_n76_ | (x13 & x19 & x04 & x05));
  assign new_n76_ = x00 & ~x02 & ~x10 & (x17 | (x04 & ~x23));
  assign new_n77_ = x00 & ~x02 & x09 & ~x10 & ~x24;
  assign new_n78_ = (x04 | ~new_n79_ | ~x22) & (~z7 | (x09 & (x17 | ~x22)));
  assign new_n79_ = x23 & ((~x05 & x15) | new_n58_ | (x05 & x18 & x24));
  assign new_n80_ = x24 & ((x07 & (new_n81_ | (~new_n82_ & x08))) | (~x08 & ~new_n82_ & x18));
  assign new_n81_ = ~x16 & (new_n83_ | (~new_n82_ & x09));
  assign new_n82_ = ~x05 & ~x13;
  assign new_n83_ = ~x22 & ((x04 & (x13 | (x05 & ~x23))) | (x17 & (x05 | x13)));
  assign new_n84_ = (x05 ? (x13 & ~x24) : ~x13) & (new_n85_ | (~x08 & x15));
  assign new_n85_ = x19 & (x08 | (~x16 & (x09 | (x17 & ~x22))));
