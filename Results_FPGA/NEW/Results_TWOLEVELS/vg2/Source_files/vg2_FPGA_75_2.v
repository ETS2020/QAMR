...
module FAU ( 
  ...
  wire new_n37_, new_n39_, new_n40_, new_n41_, new_n42_, new_n43_, new_n44_,
    ...
    new_n78_;
  assign z0 = ~x03 & ~x06 & ~x11 & ~x14 & z5 & ~x20;
  ...
  assign new_n54_ = ~new_n55_ & (~new_n51_ | ~new_n58_ | ~x14 | ~x15 | ~x16);
  ...
  assign z3 = (~new_n63_ & ~x24) | (x24 & ~new_n66_ & (x05 | x13)) | (~x05 & ~new_n70_ & ~x13);
  assign new_n63_ = (~x01 | ~x06 | ~new_n64_ | ~x08) & (x03 | x06 | ~new_n65_ | x08);
  assign new_n64_ = x11 & x14 & ~new_n42_ & x20;
  assign new_n65_ = ~x11 & ~x14 & ~new_n45_ & ~x20;
  assign new_n66_ = ~new_n67_ & (~new_n69_ | x03 | x06 | ~x07);
  assign new_n67_ = new_n68_ & x01 & x06 & x08;
  assign new_n68_ = x18 & x20 & x11 & x14;
  assign new_n69_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n70_ = (~new_n71_ | ~x01 | ~x06 | ~x08) & (~new_n72_ | x03 | x06 | x08);
