...
module FAU ( 
  ...
  assign new_n37_ = ~new_n38_ & (~x07 | ~x24 | (~x05 & ~x13));
  ...
  assign new_n44_ = new_n45_ & new_n47_ & ~x10 & ~x11 & ~x12 & ~x14;
  assign new_n45_ = new_n46_ & ~x02 & ~x03 & x00 & ~x01;
  assign new_n46_ = ~x04 & ~x06 & ~x08 & ~x09;
  ...
  assign new_n57_ = new_n58_ & new_n60_ & new_n51_ & x09 & x11;
  assign new_n58_ = new_n59_ & x14 & x15 & x12 & ~x13;
  assign new_n59_ = x16 & x17 & x20 & x22 & x23;
  assign new_n60_ = x01 & x03 & x04 & ~x05;
  ...
  assign z3 = (~new_n66_ & ~x24) | new_n73_ | (x24 & ~new_n70_ & (x05 | x13));
  assign new_n66_ = (~x01 | ~new_n67_ | ~x03) & (~new_n69_ | ~new_n68_ | ~x00 | x01);
  assign new_n67_ = x06 & x08 & x11 & x14 & ~new_n43_ & x20;
  assign new_n68_ = ~x02 & ~x03 & ~x06;
  assign new_n69_ = ~x08 & ~x10 & ~x11 & ~x14 & ~x20;
  assign new_n70_ = (~new_n71_ | ~new_n51_ | ~x01 | ~x03) & (~new_n72_ | ~new_n54_ | x01 | x03);
  assign new_n71_ = x18 & x20 & x11 & x14;
  assign new_n72_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n73_ = new_n74_ & x01 & x03 & new_n51_ & ~x05;
  assign new_n74_ = x11 & ~x13 & x14 & x15 & x20;
  ...
  assign z6 = new_n80_ | new_n84_ | (~new_n81_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n80_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n81_ = ~new_n83_ & (new_n82_ | ~x15);
  assign new_n82_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n83_ = x19 & (x03 | (~x11 & (x06 | ~x14)));
  assign new_n84_ = ~new_n82_ & (new_n64_ | (x18 & x24 & (x05 | x13)));
endmodule
