// Benchmark "FAU" written by ABC on Wed Jul 29 09:19:50 2020
...
module FAU ( 
  ...
  assign z10 = (x29 & (new_n150_ | ~new_n167_)) | new_n177_ | (~x29 & (new_n163_ | new_n174_));
  ...
  assign new_n174_ = new_n142_ & new_n176_ & new_n175_ & ~x09 & ~x18;
  ...
  assign new_n182_ = ~new_n154_ & ((x29 & ~x30) | (x01 & ~x29 & x30));
  ...
  assign new_n186_ = (~x18 | new_n159_ | x30) & (~x22 | ~x30 | x18 | ~x19);
  ...
  assign z12 = ~new_n207_ | (x29 & (x30 ? ~new_n197_ : (~new_n155_ | new_n215_)));
  assign new_n197_ = new_n201_ & (~x20 | (x21 ? new_n205_ : new_n198_));
  assign new_n198_ = x18 ? new_n199_ : (~x22 | (x28 & (~x19 | ~x28)));
  assign new_n199_ = (~new_n200_ | ~x19) & (~new_n161_ | x17 | x19);
  ...
  assign new_n207_ = (x29 | ((new_n208_ | x19) & (~x18 | ~new_n212_ | ~x19))) & (~x18 | ~new_n214_ | ~x19);
  assign new_n208_ = ~new_n209_ & (~new_n142_ | ~new_n176_ | x09 | x18 | x20);
  assign new_n209_ = x17 & x18 & x20 & new_n210_ & new_n211_;
  assign new_n210_ = x28 & ~x30;
  assign new_n211_ = ~x21 & x26;
  assign new_n212_ = ~x21 & ((new_n210_ & ~x20 & x26) | (x20 & (new_n213_ | (new_n210_ & ~x27))));
  assign new_n213_ = x27 & (x30 | (~x03 & ~x30));
  assign new_n214_ = ~x20 & x21 & ~new_n100_ & x30;
  assign new_n215_ = ~x18 & (~new_n162_ | (~x20 & (new_n216_ | (new_n217_ & ~x09))));
  assign new_n216_ = x19 & ~new_n154_ & (x21 ? ~x28 : x01);
  assign new_n217_ = x21 & x22 & ~x28 & ~x38 & new_n218_ & ~x39;
  assign new_n218_ = ~x40 & ~x41 & ~x42 & ~x43 & (~x44 | (~x19 & x44));
  assign z13 = (~new_n220_ & x30) | new_n244_ | (~x30 & (new_n238_ | (~new_n234_ & ~x28)));
  assign new_n220_ = ~new_n227_ & (new_n221_ | ~x19) & (~new_n231_ | x19);
  ...
  assign new_n227_ = ~new_n154_ & (new_n229_ | (new_n230_ & new_n228_ & x01));
  ...
  assign new_n236_ = ~x09 & ~x18 & ~x20 & x22 & new_n153_ & ~x38;
  ...
  assign new_n248_ = ~x18 & ((~new_n249_ & x21) | (x19 & x20 & new_n225_ & ~x21));
  ...
  assign new_n256_ = (~x19 | x20 | new_n203_ | x21) & (~x20 | ((~new_n257_ | x19) & (~new_n200_ | ~x19 | x21)));
  ...
  assign new_n268_ = ~new_n269_ & ~new_n274_ & (x18 | ~x20 | ~new_n176_ | ~x22);
  ...
  assign new_n287_ = (x27 | x28 | ~x13 | x14) & (~new_n188_ | x20 | ~x28);
  assign new_n288_ = new_n188_ & x00 & new_n116_ & ~x20 & ~x28;
  ...
  assign new_n295_ = (~x19 | (x20 ? ~x27 : ~new_n161_)) & (~new_n161_ | ~x20 | ~x17 | x19);
  ...
  assign new_n309_ = x18 & ~x20 & ((~new_n123_ & x30) | (x26 & (x28 ^ x30)));
  ...
  assign new_n313_ = ~x29 & (x18 ? (new_n161_ & x20) : (new_n293_ | (x20 & x22)));
  ...
  assign new_n320_ = ~x20 & x22 & ~x28 & (x30 | (~new_n173_ & ~x09));
  ...
  assign new_n342_ = x11 & x20 & ~x28 & ~new_n206_ & x30;
  ...
  assign new_n351_ = (~new_n225_ | ~x19) & (x28 | ((~x19 | ~x23 | x29) & (~x22 | ~x29)));
  ...
  assign new_n358_ = (new_n359_ | ~x19) & (new_n363_ | x19) & (~new_n334_ | ~new_n194_ | x18);
  ...
  assign new_n361_ = ~new_n362_ & (x29 | (x20 ? ~new_n213_ : (new_n123_ | ~x30)));
  ...
  assign new_n371_ = x19 & ~x28 & ~x29 & ~new_n154_ & x30;
  ...
  assign new_n376_ = (x20 | x28 | ~x18 | x19) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n159_ | x28)));
  ...
  assign new_n385_ = x20 & ((new_n213_ & x19) | (~x17 & ~x19 & new_n176_ & x26));
  ...
  assign new_n394_ = new_n176_ & ~x21;
  ...
  assign new_n399_ = (new_n154_ | (x20 ? (x21 | x28) : (x21 & (~x01 | ~x21 | x28)))) & (~x20 | ~new_n400_ | x21);
  ...
  assign new_n409_ = x28 & x26 & ~x21 & new_n188_ & x20;
  assign z22 = (x30 & (~new_n411_ | new_n227_)) | new_n449_ | (~x30 & (new_n431_ | new_n446_));
  ...
  assign new_n441_ = ~new_n160_ & (~x18 | (x20 ? (~new_n442_ & new_n444_) : new_n445_));
  assign new_n442_ = ~x28 & (x21 ? ~new_n443_ : (x19 | (x17 & ~x19 & x26)));
  assign new_n443_ = ~x22 & (~x25 | (x11 & (~x11 | x19)));
  assign new_n444_ = (~new_n135_ | x19 | x21) & (~x19 | (~x21 & (~new_n200_ | ~x04 | x21)));
  ...
  assign new_n450_ = ~x20 & x22 & ~x28 & ~new_n173_ & x29;
  assign new_n451_ = new_n237_ & ~x10;
  ...
  assign new_n462_ = x30 & (x20 ? ~new_n154_ : ~new_n203_);
  assign new_n463_ = ~x10 & x25 & ((~x18 & ~x19 & x20) | (x18 & x19 & ~x20 & x30));
  assign new_n464_ = x20 & x22 & x30;
  assign new_n465_ = (x21 | (~new_n467_ & (new_n466_ | x20))) & (~new_n354_ | x20 | ~x21 | ~x23);
  ...
  assign new_n495_ = (~new_n148_ | x21 | ~x27 | x30) & (~x30 | (~new_n497_ & (new_n496_ | ~x21)));
  assign new_n496_ = x19 ? (~x18 & (~new_n114_ | ~new_n115_ | x18)) : (~new_n108_ & (x18 | ~x24));
  assign new_n497_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n498_ = (new_n499_ | x20) & (~new_n145_ | x18 | ~x19 | ~x21);
  assign new_n499_ = (new_n500_ | x19) & (~new_n119_ | ~new_n161_ | ~x18 | ~x19 | x21);
  assign new_n500_ = (x03 | x18 | new_n124_ | x21) & (~x18 | ~x21 | ~new_n116_ | x28);
  ...
  assign new_n505_ = ~new_n507_ & (~x00 | (~new_n506_ & (new_n508_ | ~x20)));
  assign new_n506_ = x18 & x19 & ~new_n123_ & ~x20;
  assign new_n507_ = ~x00 & ~x04 & x18 & new_n200_ & x19 & x20;
  ...
  assign z34 = x18 ? ~new_n519_ : (new_n528_ | new_n536_ | (~new_n532_ & x29));
  assign new_n519_ = (new_n520_ | ~x20) & (new_n526_ | x20) & (~new_n334_ | ~new_n142_ | x19);
  assign new_n520_ = ~new_n523_ & (x21 | (x30 ? new_n521_ : (~new_n192_ & ~new_n525_)));
  assign new_n521_ = (new_n522_ | ~x00) & (~x19 | x27 | ~x28 | x29);
  assign new_n522_ = (x19 | ~x26 | ~x28 | x29) & (x05 | ~x19 | x27 | x28 | ~x29);
  assign new_n523_ = ~x11 & new_n524_ & ~x19;
  assign new_n524_ = x21 & ~x28 & x29 & x30 & (x25 | x26);
  assign new_n525_ = x19 & ~x27 & x28 & (~x29 | (~x00 & ~x04 & x29));
  assign new_n526_ = ~new_n527_ & (~new_n116_ | ~new_n135_ | ~x00 | ~x19 | x21);
  assign new_n527_ = (x28 ? (~x29 & ~x30) : (x29 & x30)) & (x19 ? (~x21 & x26) : x21);
  assign new_n528_ = x30 & ((~new_n531_ & ~x28) | (~new_n529_ & ~x29));
  assign new_n529_ = (~x19 | ~x21 | new_n94_ | x28) & (~x28 | ((~x00 | ~x19 | ~x21) & (new_n530_ | x21)));
  ...
  assign new_n536_ = ~x21 & x28 & ~x29 & ~x30 & (new_n194_ | ~x19);
  assign z35 = x30 ? (new_n565_ | (~x29 & (new_n538_ | ~new_n547_))) : ~new_n553_;
  assign new_n538_ = ~x18 & (x19 ? ~new_n539_ : (~new_n544_ | (~new_n542_ & x20)));
  assign new_n539_ = x21 ? (~new_n540_ & (~x01 | ~new_n165_ | x20)) : new_n541_;
  assign new_n540_ = x00 & (x28 | (~x05 & ~x15 & x20 & x22 & ~x28));
  assign new_n541_ = x20 ? (~x22 | (x28 & (~x28 | (x02 & ~x03)))) : (~x22 & ~x23);
  assign new_n542_ = (x21 | (~new_n543_ & ~x24)) & (~x00 | ~x21 | (new_n100_ & ~x22 & ~x24));
  assign new_n543_ = x28 & ((x03 & ~x06) | (~x02 & (~x06 | (x00 & ~x03))));
  assign new_n544_ = (x21 | ~x23 | x28) & (x20 | (x21 ? new_n546_ : (~new_n545_ & x28)));
  ...
  assign new_n550_ = new_n383_ & new_n161_ & x00 & ~x05 & ~x15 & ~x19;
  ...
  assign new_n553_ = x21 ? (~x29 | (~new_n561_ & new_n564_)) : (~new_n554_ & (new_n556_ | ~x29));
  assign new_n554_ = ~x03 & (new_n555_ | (new_n120_ & x20 & x27 & ~x29));
  assign new_n555_ = new_n175_ & new_n260_ & x00 & ~x05 & ~x18;
  ...
  assign new_n561_ = ~x19 & ((~x18 & x20) | (~x28 & (~new_n563_ | (x18 & (new_n562_ | ~x20)))));
  assign new_n562_ = new_n237_ & x11;
  assign new_n563_ = ~new_n253_ & (~new_n264_ | x41 | ~x42 | x38 | ~x39);
  assign new_n564_ = (x18 | ~x19 | ~x28) & (~x20 | ((~x19 | (~x18 & ~x22)) & (~x18 | new_n159_ | x28)));
  assign new_n565_ = x19 & x20 & ~x21 & ~new_n566_ & x29;
  assign new_n566_ = (x18 | ~x22 | ~x28) & (~x05 | ~x18 | x27 | x28);
  assign z36 = ~new_n578_ | (~x30 & ((~new_n568_ & ~x21) | new_n591_ | (~new_n586_ & x21)));
  assign new_n568_ = ~new_n554_ & new_n572_ & (~x18 | (new_n569_ & (new_n577_ | ~x26)));
  assign new_n569_ = ~new_n571_ & (~x19 | ((new_n570_ | ~x29) & (~x20 | new_n297_ | x29)));
  assign new_n570_ = (~x00 | new_n123_ | x20) & (~x20 | x27 | (x28 & (x00 | x04 | ~x28)));
  assign new_n571_ = new_n175_ & ~x14 & ~x27 & ~x28 & ~x29;
  ...
  assign new_n578_ = ~new_n583_ & (~x21 | ((~new_n585_ | ~x18) & (~new_n579_ | x28)));
  assign new_n579_ = x30 & (new_n581_ | (~x29 & (new_n582_ | (~new_n580_ & ~x18))));
  assign new_n580_ = (new_n94_ | ~x19) & (~x09 | x19 | x20 | ~x22 | ~x33);
  assign new_n581_ = x20 & x25 & x29 & new_n188_ & ~x11;
  assign new_n582_ = ~x05 & x15 & x20 & (x18 ? ~x19 : (x19 & x22));
  assign new_n583_ = new_n584_ & new_n228_ & ~x07 & ~x16;
  assign new_n584_ = new_n194_ & x28 & ~x29;
  assign new_n585_ = ~x19 & x20 & x28 & (x16 ? ~x08 : ~x07);
  assign new_n586_ = x29 ? (new_n564_ & (new_n587_ | x19)) : new_n589_;
  assign new_n587_ = (x18 | ~x20) & (x28 | (x20 ? new_n319_ : (~x18 & (x09 | ~new_n588_ | x18))));
  assign new_n588_ = x22 & ~x38 & ~x41 & (x39 ? x42 : (x40 & ~x42));
  assign new_n589_ = ~new_n590_ & (~new_n188_ | x20 | ~x28);
  assign new_n590_ = ~x12 & ~x13 & ~x14 & ~x27 & ~x28;
  assign new_n591_ = new_n584_ & new_n228_ & ~x08 & x16;
  assign z37 = (x30 & (~new_n593_ | new_n227_)) | new_n583_ | new_n648_ | (~new_n624_ & ~x30);
  ...
  assign new_n600_ = ~new_n540_ & (x28 | (~new_n601_ & ~x25 & ~x24 & ~x26));
  assign new_n601_ = x20 & x22 & (x05 | (~x05 & x15));
  assign new_n602_ = (new_n546_ | x20) & (~x00 | ~x20 | (new_n100_ & ~x22 & ~x24));
  ...
  assign new_n609_ = new_n211_ & x18;
  assign new_n610_ = new_n135_ & ~x21 & x00 & x18;
  assign new_n611_ = x18 & x19 & (~x21 | (x00 & x21));
  assign new_n612_ = x18 & ~new_n613_ & ~x20;
  assign new_n613_ = (~x00 | ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28))) & (new_n417_ | x21) & (x19 | ~x21 | ~x28);
  assign new_n614_ = new_n620_ & (~x29 | (new_n618_ & (x28 | (~new_n615_ & new_n616_))));
  assign new_n615_ = ~x19 & (x21 ? ~new_n427_ : (~x18 | (new_n253_ & ~x17 & x18)));
  assign new_n616_ = (~x18 | ~x19 | ~new_n211_ | x20) & (~x20 | ((~new_n402_ | x18) & (new_n617_ | ~x19)));
  assign new_n617_ = x18 ? (x21 | x27 | (~x05 & (~x00 | x05))) : (~x21 | ~x22);
  assign new_n618_ = (x18 | x19 | ~x20 | ~x21) & (~x19 | (~new_n619_ & (~x18 | (x20 ? ~x21 : (new_n203_ | x21)))));
  assign new_n619_ = x28 & ((~x18 & (x21 | (x20 & ~x21 & x22))) | (x18 & x20 & ~x21 & ~x27));
  ...
  assign new_n624_ = x29 ? (new_n630_ & (x18 | (~new_n625_ & new_n645_))) : new_n637_;
  assign new_n625_ = ~x20 & (new_n216_ | new_n629_ | (~x28 & (new_n626_ | new_n628_)));
  assign new_n626_ = ~x09 & x21 & x22 & ~x38 & ~new_n627_ & ~x41;
  assign new_n627_ = (x39 | x42 | (x40 ? x19 : ((x43 | x44) & (x19 | (~x43 ^ x44))))) & (x19 | ~x39 | ~x42);
  assign new_n628_ = ~x19 & ~x21 & (x03 | x05 | (x00 & ~x03 & ~x05));
  assign new_n629_ = ~x19 & x21 & x23;
  assign new_n630_ = ~new_n160_ & (~x18 | (new_n631_ & ~new_n636_));
  assign new_n631_ = x21 ? new_n635_ : (x19 ? (~new_n632_ & ~new_n633_) : ~new_n634_);
  assign new_n632_ = ~x20 & ((x26 & x28) | (x00 & ((x26 & ~x28) | (x10 & x25))));
  assign new_n633_ = x20 & (x27 ? ~x28 : (~x28 | (x28 & (x04 | (~x00 & ~x04)))));
  assign new_n634_ = x20 & x26 & (x28 | (~x28 & (x17 | (x00 & ~x17))));
  assign new_n635_ = (~x19 | ~x20) & (x28 | ((x19 | (x20 & (~x11 | ~x20 | ~x25))) & (x11 | ~x20 | ~x25)));
  assign new_n636_ = x22 & ((x20 & x21 & ~x28) | (x00 & x19 & ~x20 & ~x21));
  assign new_n637_ = (~x20 | (~new_n638_ & (new_n640_ | x21))) & new_n642_ & (new_n589_ | ~x21);
  assign new_n638_ = x19 & ((new_n448_ & x18) | (~new_n639_ & x28));
  assign new_n639_ = (~x16 | x18 | ~x22 | (x08 & (~x08 | ~x21))) & (~x18 | x21 | x27);
  assign new_n640_ = (new_n641_ | x18) & (~x17 | ~x18 | ~new_n135_ | x19);
  ...
  assign new_n648_ = x21 & (new_n649_ | (~x09 & ~x18 & new_n450_ & ~x19));
  assign new_n649_ = x20 & (new_n485_ | (~new_n650_ & x28));
  assign new_n650_ = x16 ? (~x18 | x19) : (x07 ? ((~x18 | x19) & (~x22 | x29 | x18 | ~x19)) : (~x18 | x19));
  ...
  assign new_n659_ = new_n148_ & x20 & ~x21 & x27;
  ...
  assign new_n663_ = (~x19 | new_n271_ | x20) & (~x20 | ((~new_n161_ | x19) & (~new_n200_ | x04 | ~x19)));
  assign new_n664_ = new_n120_ & ~x05 & new_n176_ & x20 & ~x27;
  assign new_n665_ = ~x20 & ~new_n154_ & ((~x21 & x29 & ~x30) | (x21 & ~x28 & ~x29 & x30));
  assign z39 = (~new_n671_ & x29) | (x19 & (~new_n667_ | (~new_n676_ & ~x18)));
  assign new_n667_ = (~x29 | (~new_n670_ & (new_n668_ | x30))) & (~new_n166_ | ~x27 | x29 | ~x30);
  assign new_n668_ = (new_n669_ | ~x20) & (~x18 | x20 | ~new_n135_ | x21);
  assign new_n669_ = (~x21 | ~x22) & (~x18 | (~x21 & (~new_n200_ | ~x04 | x21)));
  assign new_n670_ = x18 & ~x20 & ~x21 & ~new_n203_ & x30;
  assign new_n671_ = (~x20 | ((~new_n674_ | x19) & (new_n672_ | x30))) & (x19 | new_n675_ | x30);
  assign new_n672_ = (new_n673_ | ~x21) & (~new_n188_ | ~new_n135_ | x21);
  assign new_n673_ = (~x18 | new_n159_ | x28) & (x19 | (x18 & (new_n319_ | x28)));
  assign new_n674_ = ~x21 & ~x28 & x30 & (~x18 | (~x17 & x18 & x26));
  assign new_n675_ = (x18 | x21 | ~x28) & (~x21 | x28 | ~x18 | x20);
  assign new_n676_ = x21 ? new_n678_ : (~new_n677_ & (~x29 | new_n302_ | x30));
  assign new_n677_ = x02 & ~x03 & x20 & new_n116_ & x22 & x28;
  assign new_n678_ = (~x28 | ~x29 | x30) & (~x01 | x20 | x28 | x29 | new_n154_ | ~x30);
  assign z40 = ~x28 & ((~new_n680_ & ~x18) | (x05 & x18 & new_n682_ & x20));
  assign new_n680_ = (new_n681_ | ~x05) & (~new_n119_ | x21 | ~new_n175_ | ~x03);
