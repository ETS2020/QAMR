// Benchmark "FAU" written by ABC on Wed Jul 29 09:19:19 2020
...
module FAU ( 
  ...
  assign new_n478_ = ~new_n479_ & ~new_n485_ & (~x28 | (~new_n484_ & (~new_n483_ | ~x07)));
  ...
  assign new_n483_ = ~x16 & ((x18 & ~x19) | (x22 & ~x29 & ~x30 & ~x18 & x19));
  assign new_n484_ = x08 & x16 & ((x18 & ~x19) | (x22 & ~x29 & ~x18 & x19));
  ...
  assign new_n583_ = new_n584_ & new_n228_ & ~x08 & x16;
  ...
  assign new_n591_ = new_n584_ & new_n228_ & ~x07 & ~x16;
  ...
  assign new_n639_ = (x16 | x18 | ~x22 | (x07 & (~x07 | ~x21))) & (~x18 | x21 | x27);
  ...
  assign new_n650_ = x16 ? (x08 ? ((~x18 | x19) & (~x22 | x29 | x18 | ~x19)) : (~x18 | x19)) : (~x18 | x19);
