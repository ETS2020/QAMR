...
module FAU ( 
  ...
  assign new_n575_ = ~new_n576_ & (~new_n581_ | x18 | ~x19 | x08 | ~x16);
  ...
  assign new_n588_ = new_n581_ & ~x07 & ~x16 & ~x18 & x19;
  ...
  assign new_n636_ = x22 & ((x07 & ~x16 & x21) | (x16 & (~x08 | (x08 & x21))));
  ...
  assign new_n647_ = x28 & (x16 ? (x18 & ~x19 & x21) : ~new_n648_);
  assign new_n648_ = (~x07 | ~x18 | x19 | ~x21) & (x07 | ((x18 | ~x19 | ~x22 | x29) & (~x18 | x19 | ~x21)));
