...
module FAU ( 
  ...
  assign new_n478_ = new_n479_ & (~x28 | (~new_n484_ & (~new_n485_ | ~x08)));
  ...
  assign new_n484_ = x07 & ~x16 & ((x18 & ~x19) | (x22 & ~x29 & ~x18 & x19));
  assign new_n485_ = x16 & ((x18 & ~x19) | (x22 & ~x29 & ~x30 & ~x18 & x19));
  ...
  assign new_n638_ = x22 & (x16 ? (~x08 | (x08 & x21)) : ~x07);
  ...
  assign new_n649_ = x16 ? (~x18 | x19) : (x07 ? ((~x18 | x19) & (~x22 | x29 | x18 | ~x19)) : (~x18 | x19));
