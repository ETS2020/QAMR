...
module FAU ( 
  ...
  assign new_n80_ = x07 ? ((~x08 | x17 | ~x18 | (x05 ^ ~x15)) & (x05 | ~x17 | x18)) : ((~x17 | x18) & (~x05 | x08 | x15 | x17 | ~x18));
  assign z04 = ~x14 & ~x20;
  ...
  assign z06 = ~x09 & ((~new_n91_ & ~x05) | (new_n98_ & new_n66_ & x04 & x05));
  assign new_n91_ = (x07 | ((x17 | ~x18 | (~new_n63_ & (new_n92_ | x15))) & (~x15 | ~x17 | x18))) & (~x17 | x18 | ~x07 | x15);
  ...
  assign new_n103_ = ~new_n114_ & (x07 | (~new_n111_ & ((~new_n104_ & ~new_n113_) | x15)));
  assign new_n104_ = ~x09 & (new_n110_ | (~x21 & (new_n107_ | (new_n105_ & x04))));
  assign new_n105_ = ~new_n106_ & ~x12;
  assign new_n106_ = (x05 | x06 | x08) & (~x02 | ~x08 | ~x13 | x14);
  ...
  assign new_n125_ = (x07 | ((x17 | ~new_n126_ | ~x18) & (~x17 | x18 | x05 | ~x15))) & (x15 | ~x17 | x18 | x05 | ~x07);
  assign new_n126_ = ~x21 & ((~new_n130_ & ~x04) | (~new_n127_ & ~x05) | (new_n131_ & x04 & x05));
  assign new_n127_ = ~new_n129_ & (x15 | (x08 ? (~new_n94_ | x14) : new_n128_));
  ...
  assign z17 = ~x09 & ((~new_n150_ & ~x05) | (new_n152_ & new_n66_ & ~x04 & x05));
  assign new_n150_ = (~x17 | x18 | ~x07 | x15) & (x07 | ((~x15 | ~x17 | x18) & (x08 | x15 | x17 | ~new_n151_ | ~x18)));
  assign new_n151_ = ~new_n61_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  ...
  assign z27 = (~new_n186_ & ~x09) | (new_n190_ & new_n66_ & x03 & ~x05);
  assign new_n186_ = (x17 | new_n187_ | ~x18) & (x05 | ~x17 | x18 | (~x07 ^ x15));
  assign new_n187_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n188_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n188_ = ~x21 & (new_n189_ | (~new_n130_ & ~x04));
  ...
  assign new_n193_ = (new_n197_ | x07) & (x05 | ((new_n196_ | ~x15) & (~new_n194_ | x07)));
