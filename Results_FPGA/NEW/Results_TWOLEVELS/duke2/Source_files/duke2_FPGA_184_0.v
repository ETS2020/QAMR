...
module FAU ( 
  ...
  assign new_n67_ = x15 & ~x21 & ~x09 & ~x11;
  assign z02 = ~x17 & ((~new_n77_ & x08) | (~new_n69_ & ~x09));
  assign new_n69_ = new_n70_ & (x05 | (x07 ? new_n75_ : (new_n76_ | ~x18)));
  assign new_n70_ = ~new_n74_ & (x07 | ((new_n73_ | x04) & (new_n71_ | ~x18)));
  ...
  assign new_n74_ = x05 & x07 & x08 & ~x15 & x18 & x19;
  assign new_n75_ = (~x01 | x15 | x18 | (~x08 & ~x16)) & (~x18 | ~x19 | ~x08 | ~x15);
  assign new_n76_ = (x02 | (~x06 & (~x08 | ~x11 | ~x15 | x21))) & (x08 | ~x15) & (~x06 | x11);
  assign new_n77_ = (~x18 | ((new_n78_ | x15) & (x05 | new_n79_ | ~x15))) & (x04 | ~x05 | x15);
  assign new_n78_ = x05 ? ((~x07 | (~x09 & x19)) & (~x09 | x12 | ~x04 | x07)) : x07;
  ...
  assign new_n85_ = ~x17 & (new_n92_ | (x18 & (new_n86_ | new_n88_ | new_n90_)));
  ...
  assign new_n90_ = ~x06 & (new_n91_ | (x04 & ~x08 & ~x12 & x21));
  ...
  assign new_n100_ = ~x08 & ~x21 & (new_n101_ | (~x02 & x06 & x11));
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n121_ | (~x17 & (new_n118_ | (x18 & (new_n107_ | new_n123_))));
  assign new_n107_ = ~x07 & (new_n114_ | (~x09 & (new_n117_ | (~new_n108_ & ~x15))));
  assign new_n108_ = ~new_n112_ & (x21 | (~new_n109_ & (~x04 | new_n113_ | x12)));
  ...
  assign new_n112_ = x05 & ((~x08 & ~x19) | (x04 & x08 & ~x12 & ~x21));
  assign new_n113_ = (x05 | x06 | x08) & (~x13 | x14 | ~x02 | ~x08);
  assign new_n114_ = x08 & ((new_n116_ & x04 & x05) | (x02 & new_n115_ & ~x05));
  assign new_n115_ = ~x11 & x15 & (x09 | ~x21);
  assign new_n116_ = x09 & ~x12 & ~x15;
  assign new_n117_ = x05 & x08 & x21;
  assign new_n118_ = ~x15 & ((~x04 & x05 & x08) | (new_n120_ & new_n119_ & ~x05));
  assign new_n119_ = ~x07 & ~x09;
  assign new_n120_ = ~x18 & ~x21 & x12 & ~x14;
  assign new_n121_ = ~x07 & ~x09 & new_n122_ & ~x15;
  assign new_n122_ = x17 & ~x18;
  assign new_n123_ = x05 & x07 & x08 & ~x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign z12 = ~x09 & ((~new_n132_ & ~x07) | (new_n122_ & ~x15 & ~x05 & x07));
  assign new_n132_ = ~new_n139_ & (x17 | x21 | (~new_n137_ & (new_n133_ | ~x18)));
  ...
  assign new_n139_ = x00 & ~x05 & new_n122_ & x15;
  ...
  assign new_n146_ = (~x07 | new_n147_ | ~x15) & (x07 | ~x12 | x14 | x15 | x21);
  ...
  assign new_n152_ = ~x14 & ~x21 & ((~new_n153_ & x06) | new_n97_ | (new_n155_ & ~x06));
  ...
  assign z17 = ~x09 & ((~new_n158_ & ~x05) | (new_n161_ & new_n66_ & ~x04 & x05));
  assign new_n158_ = (~new_n122_ | ~x07 | x15) & (x07 | ((x08 | ~new_n159_ | x15) & (~new_n122_ | ~x00 | ~x15)));
  assign new_n159_ = ~x17 & ~new_n61_ & ~new_n160_;
  assign new_n160_ = (~x02 | ~x06 | x11 | ~x18) & (x04 | x06 | ~x12);
  assign new_n161_ = ~x17 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~new_n163_ & ~x17;
  assign new_n163_ = (x14 | new_n164_ | x15) & (~x18 | ~x19 | x08 | ~x15);
  assign new_n164_ = ~new_n92_ & (~x18 | (~new_n86_ & (~new_n165_ | ~x08)));
  assign new_n165_ = x10 & x12 & ~x13 & ~x21 & (x06 ^ ~x16);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~new_n168_ & ~x17;
  assign new_n168_ = ~new_n175_ & (x09 | (~new_n173_ & (x21 | (~new_n169_ & ~new_n137_))));
  assign new_n169_ = ~x15 & ((new_n172_ & ~x05 & x12) | (x04 & new_n170_ & ~x12));
  assign new_n170_ = x18 & (x05 ? x08 : (x08 ? (new_n171_ & x10) : ~x06));
  assign new_n171_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n172_ = ~x14 & ~x18;
  assign new_n173_ = ~x05 & ~x06 & new_n174_ & ~x08;
  assign new_n174_ = ~x14 & ~x15 & x21 & (x04 ? (~x12 & x18) : x12);
  assign new_n175_ = x04 & x05 & x08 & new_n176_ & x09 & ~x12;
  assign new_n176_ = ~x15 & x18;
  assign z21 = ~x17 & ~new_n178_ & x18;
  assign new_n178_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n185_ = (x21 | (~new_n188_ & (new_n186_ | ~x08))) & (~new_n176_ | x05 | x08);
  assign new_n186_ = (new_n187_ | ~x05) & (x02 | x05 | ~x11 | ~x15 | ~x18);
  assign new_n187_ = (x04 | x11 | ~x15) & (x15 | ~x18 | ~x04 | x12);
  assign new_n188_ = ~x05 & x12 & ~x14 & ~x15 & ~x18;
  assign new_n189_ = x08 & ~x15 & ~x18 & x01 & ~x05 & x07;
  assign z25 = new_n191_ & ~x05;
  assign new_n191_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n194_ | (new_n200_ & new_n66_ & x03 & ~x05);
  assign new_n194_ = ~x09 & ((~new_n195_ & ~x17) | (~x05 & new_n199_ & x17));
  assign new_n195_ = x07 ? ~new_n198_ : (~new_n197_ & (x21 | (~new_n137_ & ~new_n196_)));
  assign new_n196_ = x02 & ~x05 & x06 & new_n176_ & ~x08 & ~x11;
  assign new_n197_ = x05 & ~x08 & ~x15 & x18 & x19;
  assign new_n198_ = x08 & x18 & x19 & (~x05 ^ ~x15);
  assign new_n199_ = ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n200_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n202_ | (~x05 & ~new_n208_ & ~x09))) | (~x09 & new_n213_ & x17);
  assign new_n202_ = x08 & ((~new_n203_ & x18) | (new_n207_ & ~x04));
  assign new_n203_ = (x05 | (~new_n204_ & (new_n206_ | ~x15))) & (~new_n119_ | ~x15 | ~x21);
  ...
  assign new_n207_ = x05 & ~x07 & x12 & ~x15 & (x09 | ~x21);
  assign new_n208_ = new_n209_ & (new_n211_ | x02);
  assign new_n209_ = (x07 | x08 | new_n210_ | ~x18) & (~x15 | x18 | ~x07 | x11);
  assign new_n210_ = (~x15 | x19) & (~new_n101_ | x14 | x15 | ~x21);
  assign new_n211_ = (~x07 | ~x15 | x18) & (~new_n212_ | x14 | x15 | ~x18 | ~x21);
  assign new_n212_ = x06 & ~x07 & ~x08 & x11;
