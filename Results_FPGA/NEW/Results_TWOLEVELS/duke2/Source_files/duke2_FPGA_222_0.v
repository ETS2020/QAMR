...
module FAU ( 
  ...
  assign new_n82_ = ~x14 & ~x15 & ~x17 & x18 & (~new_n83_ | new_n86_);
  assign new_n83_ = x06 ? new_n84_ : (x08 | ~x21 | (x04 ^ ~x12));
  assign new_n84_ = (~x11 | ~x21 | x02 | x08) & (~new_n85_ | ~x08 | ~x10);
  assign new_n85_ = x12 & ~x13 & ~x21;
  assign new_n86_ = ~new_n87_ & x02;
  assign new_n87_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign z06 = ~x09 & ((~new_n89_ & ~x05) | (new_n96_ & new_n65_ & x04 & x05));
  assign new_n89_ = (x07 | (x15 ? new_n94_ : (x17 | new_n90_ | ~x18))) & (~x17 | x18 | ~x07 | x15);
  assign new_n90_ = x08 ? (x14 | new_n91_ | x21) : (new_n93_ | (x21 & (x14 | ~x21)));
  assign new_n91_ = ~new_n92_ & (~x06 | ~x10 | ~x12 | x13) & (~x02 | x06 | x10 | ~x13);
  assign new_n92_ = (~x10 | (x04 & x10 & ~x12)) & (~x13 | (~x02 & x11 & x13));
  assign new_n93_ = (x02 | ~x06 | ~x11) & (~x04 | x06 | x12);
  assign new_n94_ = (~x00 | ~x17 | x18) & (~new_n95_ | x17 | ~x18 | x21);
  assign new_n95_ = ~x02 & x08 & x11;
  assign new_n96_ = ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign z07 = new_n98_ & ~x17;
  assign new_n98_ = x18 & ((x08 & x09 & ~x15 & ~x05 & ~x07) | (~x09 & (x05 ^ x15) & (x07 ^ ~x08)));
  assign z08 = x14 & ~x20;
  ...
  assign new_n115_ = ~x07 & ~x09 & new_n116_ & ~x15;
  ...
  assign z12 = ~x09 & ((~new_n125_ & ~x07) | (~x05 & x07 & new_n116_ & ~x15));
  ...
  assign new_n145_ = ~x14 & (new_n146_ | new_n92_ | new_n147_) & ~x21;
  assign new_n146_ = x02 & x06 & ((x04 & ~x12) | (~x10 & x13));
  assign new_n147_ = ~x06 & x12 & ((~x02 & x11) | (x10 & ~x13));
  assign z17 = ~x09 & ((~new_n149_ & ~x05) | (new_n152_ & new_n65_ & ~x04 & x05));
  assign new_n149_ = (~new_n116_ | ~x07 | x15) & (x07 | ((x08 | ~new_n150_ | x15) & (~new_n116_ | ~x00 | ~x15)));
  assign new_n150_ = ~x17 & x18 & ~new_n61_ & ~new_n151_;
  ...
  assign new_n155_ = ~new_n86_ & (new_n156_ | ~x12);
  assign new_n156_ = (x08 | ~x21 | x04 | x06) & (~x06 | ~x08 | ~x10 | x13 | x21);
  ...
  assign new_n178_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n179_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n180_ = new_n76_ & x08 & ~x15 & ~x18;
  assign z25 = new_n182_ & ~x05;
  assign new_n182_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n185_ | (new_n190_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n187_ = ~x21 & (new_n188_ | (~new_n130_ & ~x04));
