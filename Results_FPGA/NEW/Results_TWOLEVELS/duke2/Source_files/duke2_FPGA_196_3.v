...
module FAU ( 
  ...
  assign new_n82_ = x05 ? ((~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (~x17 | (x15 ? (~x00 & (x00 | x18)) : x18));
  assign z04 = ~x14 & ~x20;
  ...
  assign new_n93_ = (x07 | ((~x00 | ~x15 | ~x17) & (x17 | new_n94_ | ~x18))) & (~x17 | x18 | ~x07 | x15);
  ...
  assign new_n124_ = x05 ? ((~x17 | x18) & (~new_n125_ | x15 | x17 | ~x18)) : ((~x17 | (x15 ? (~x00 & (x00 | x18)) : x18)) & (~new_n125_ | ~x15 | x17 | ~x18));
  ...
  assign new_n131_ = (x17 | ~new_n132_ | ~x18) & (~x00 | x05 | ~x15 | ~x17);
  ...
  assign new_n139_ = x17 & (x05 ? (~x07 & ~x18) : ((~x18 & (x07 | (~x07 & (~x15 | (~x00 & x15))))) | (x00 & ~x07 & x15)));
  ...
  assign new_n147_ = (~x17 | ((~x00 | x07 | ~x15) & (x18 | (~x07 & (x00 | x07 | ~x15))))) & (x01 | ~x07 | x18);
  ...
  assign new_n158_ = (~x00 | ~x15 | ~x17) & (x08 | x15 | x17 | ~new_n159_ | ~x18);
  ...
  assign new_n194_ = ~x09 & ((~x05 & ~new_n198_ & x17) | (~x17 & ~new_n195_ & x18));
  ...
  assign new_n198_ = (~x00 | x07 | ~x15) & (~x07 | x15 | x18);
  assign new_n199_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x09 & ~new_n209_ & x17) | (~x17 & (new_n201_ | (new_n208_ & ~x05)));
  ...
  assign new_n209_ = x05 ? (x07 | x18) : (~x15 | ((x18 | x19) & (x07 | (~x00 & (x00 | x18)))));
endmodule
