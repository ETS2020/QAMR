// Benchmark "FAU" written by ABC on Wed Jul 29 04:22:15 2020
...
module FAU ( 
  ...
  assign new_n72_ = (x15 | ((~x05 | x08) & (x06 | x12))) & (~x08 | ~x21 | (~x05 & ~x15));
  ...
  assign new_n84_ = ~x15 & ~x17 & (new_n85_ | (x18 & (new_n88_ | new_n91_)));
  assign new_n85_ = ~new_n86_ & x02;
  assign new_n86_ = (~new_n87_ | x06 | ~x08) & (~x06 | x08 | x11 | ~x18 | ~x21);
  assign new_n87_ = ~x10 & x13 & ~x21;
  assign new_n88_ = x06 & (new_n89_ | new_n90_);
  ...
  assign z06 = ~x09 & (new_n105_ | ((new_n94_ | new_n107_) & ~x05));
  assign new_n94_ = ~x07 & (new_n104_ | (~x17 & (new_n63_ | (~new_n95_ & ~x15))));
  assign new_n95_ = ~new_n102_ & (x14 | (~new_n100_ & (~x18 | (~new_n96_ & new_n98_))));
  assign new_n96_ = new_n97_ & x04;
  assign new_n97_ = ~x12 & ((~x06 & ~x08 & x21) | (~x13 & ~x21 & x08 & x10));
  assign new_n98_ = (~x06 | (~new_n89_ & ~new_n90_)) & (~new_n99_ | ~x08);
  assign new_n99_ = ~x13 & ~x21 & (~x10 | (~x06 & x10 & x12 & ~x16));
  assign new_n100_ = x08 & x13 & ~new_n101_ & ~x21;
  assign new_n101_ = x02 ? (x06 | x10) : (~x11 | (x10 & (~x04 | ~x10 | x12)));
  assign new_n102_ = ~x08 & x18 & ~new_n103_ & ~x21;
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n121_ | (~x17 & (new_n112_ | (x05 & new_n120_ & x08)));
  assign new_n112_ = ~x07 & ((~new_n113_ & x08) | (~x09 & ~new_n117_ & ~x15));
  assign new_n113_ = ~new_n114_ & (~x18 | ((~x09 & x21) ? ~x05 : new_n116_));
  assign new_n114_ = x02 & ~x09 & x13 & new_n115_ & ~x14;
  ...
  assign new_n119_ = x04 & ((~x06 & ~x08 & ~x12 & x18) | (x12 & ~x14 & ~x18));
  assign new_n120_ = ~x15 & x18 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  assign new_n121_ = ~x07 & ~x09 & ~x15 & x17 & ~x18;
  ...
  assign z12 = ~x09 & (new_n140_ | (~x07 & (new_n139_ | (new_n130_ & ~x17))));
  assign new_n130_ = ~x21 & (new_n136_ | (x18 & (x05 ? new_n138_ : ~new_n131_)));
  assign new_n131_ = ~new_n134_ & (x15 | (new_n132_ & (~x04 | new_n135_ | x12)));
  assign new_n132_ = (new_n133_ | x08) & (~x08 | x10 | x13 | x14);
  assign new_n133_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n134_ = ~x02 & x11 & ((x08 & x15) | (x06 & ~x08 & ~x15));
  assign new_n135_ = (x06 | x08) & (~x08 | ~x10 | x13 | x14);
  assign new_n136_ = ~x02 & ~x05 & x08 & new_n137_ & x11;
  assign new_n137_ = x13 & ~x14 & ~new_n61_ & ~x15;
  assign new_n138_ = x08 & (x04 ? (~x12 & ~x15) : (~x11 & x15));
  assign new_n139_ = x00 & ~x05 & x15 & x17 & ~x18;
  assign new_n140_ = ~x05 & x07 & ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~x17 & (new_n143_ | (~x05 & new_n147_ & ~x09))) | (~x05 & new_n149_ & ~x09);
  assign new_n143_ = new_n144_ & x08;
  assign new_n144_ = x18 & (x07 ? new_n146_ : (~new_n145_ & (x09 | (~x09 & ~x21))));
  assign new_n145_ = (x12 | x15 | ~x04 | ~x05) & (x02 | x05 | ~x11 | ~x15);
  ...
  assign z16 = x08 & ~x17 & (x05 ? new_n159_ : ~new_n152_);
  assign new_n152_ = (x07 | new_n153_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n153_ = x09 ? (~x18 | x19) : (x14 | new_n154_ | x21);
  assign new_n154_ = (~x06 | (~new_n155_ & ~new_n156_)) & (new_n61_ | new_n157_) & (~new_n158_ | x06);
  assign new_n155_ = x02 & x13 & (~x10 | (x04 & ~x12));
  assign new_n156_ = x12 & ~x16 & x18 & (~x13 | (~x02 & x11));
  assign new_n157_ = (x13 | ~x18) & (x02 | ~x11 | ~x13);
  assign new_n158_ = x12 & x16 & x18 & (~x13 | (~x02 & x11));
  assign new_n159_ = x09 & ~x15 & x18 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n163_ | (~x05 & (new_n107_ | (~new_n161_ & ~x07))));
  assign new_n161_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n162_ | ~x18);
  assign new_n162_ = ~new_n133_ & (~x21 | (~x14 & x21));
  assign new_n163_ = new_n66_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~new_n165_ & ~x17;
  assign new_n165_ = ~new_n170_ & (x14 | x15 | (~new_n85_ & (~new_n166_ | ~x12)));
  assign new_n166_ = x18 & ((~new_n169_ & ~x06) | (new_n167_ & new_n168_ & x06));
  assign new_n167_ = ~x13 & x16 & ~x21;
  assign new_n168_ = x08 & x10;
  assign new_n169_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n170_ = x18 & x19 & ~x08 & x15;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n180_ | (~new_n173_ & ~x09));
  assign new_n173_ = ~new_n177_ & (~x18 | (~new_n174_ & (x05 | ~new_n179_ | x06)));
  assign new_n174_ = ~x21 & (x04 ? (~x12 & ~new_n175_ & ~x15) : ~new_n176_);
  assign new_n175_ = x05 ? ~x08 : new_n135_;
  assign new_n176_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n177_ = x04 & ~x05 & ~x14 & ~x15 & ~new_n178_ & ~x21;
  assign new_n178_ = (~x12 | x18) & (~new_n168_ | x02 | ~x11 | x12 | ~x13);
  ...
  assign new_n183_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n185_ & ~x07) | (~x05 & new_n186_ & x07));
  assign new_n185_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign new_n200_ = ~x21 & (new_n201_ | (~new_n176_ & ~x04));
  ...
  assign z28 = (~x17 & (new_n212_ | (~new_n206_ & x18))) | (~x09 & x17 & ~new_n216_ & ~x18);
  assign new_n206_ = (~x08 | ((new_n207_ | x05) & (new_n211_ | x07))) & (x05 | x07 | ~new_n210_ | x08);
  assign new_n207_ = (new_n208_ | ~x15) & (x07 | x09 | ~new_n209_ | ~x10);
  assign new_n208_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n209_ = x12 & ~x14 & ~x15 & ~x21 & (x11 | ~x13);
  assign new_n210_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n103_ & x21));
  assign new_n211_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n212_ = ~x05 & ~new_n213_ & ~x09;
  assign new_n213_ = (~new_n214_ | ~x07) & (~new_n215_ | ~new_n168_ | ~x02 | x07);
  assign new_n214_ = x15 & ~x18 & (~x02 | ~x11);
  assign new_n215_ = x12 & x13 & ~x14 & ~x15 & ~x21;
