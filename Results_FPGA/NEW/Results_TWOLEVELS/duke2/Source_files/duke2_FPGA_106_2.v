...
module FAU ( 
  ...
  assign new_n55_ = new_n56_ & x04 & x12 & ~x15 & ~x17 & ~x21;
  ...
  assign new_n91_ = (~x17 | x18 | ~x00 | ~x15) & (x17 | ~x18 | (~new_n62_ & (new_n92_ | x15)));
  ...
  assign new_n118_ = ~x18 & ~x21 & x12 & ~x15;
  assign new_n119_ = ~x07 & new_n120_ & ~x09;
  assign new_n120_ = ~x15 & x17 & ~x18;
  assign z10 = new_n122_ | (x08 & new_n125_ & ~x15);
  assign new_n122_ = ~x09 & (x07 ? ~new_n124_ : ~new_n123_);
  ...
  assign z14 = (new_n144_ & ~x05) | (~new_n138_ & ~x17);
  assign new_n138_ = (~x08 | new_n139_ | ~x18) & (x05 | x09 | new_n142_ | x18);
  assign new_n139_ = x07 ? ~new_n141_ : (new_n140_ | (~x09 & (x09 | x21)));
  assign new_n140_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n141_ = ~x19 & (x05 ^ x15);
  assign new_n142_ = (~x07 | new_n143_ | ~x15) & (~x04 | x07 | ~x12 | x15 | x21);
  assign new_n143_ = x02 & x11 & (~x02 | ~x11);
  ...
  assign new_n149_ = (~x06 | (~new_n150_ & (~x12 | new_n151_ | x16))) & ~new_n94_ & (x06 | ~x12 | new_n151_ | ~x16);
  ...
  assign new_n156_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n160_ = (x04 | x08 | ~x21) & (~new_n89_ | ~x08 | ~x10);
  assign new_n161_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & new_n56_ & ~x09;
  assign z20 = ~x07 & ~x17 & (new_n170_ | (~new_n164_ & ~x09));
  assign new_n164_ = ~new_n169_ & (~x18 | (~new_n165_ & (x05 | ~new_n168_ | x06)));
  assign new_n165_ = ~x21 & (x04 ? (new_n166_ & ~x12) : ~new_n134_);
  ...
  assign new_n169_ = x04 & ~x05 & x12 & ~x15 & ~x18 & ~x21;
  assign new_n170_ = x04 & x05 & x08 & new_n171_ & x09 & ~x12;
  ...
  assign new_n175_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n176_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n56_ & x08;
  assign z24 = ~x09 & ~x17 & (new_n182_ | (~new_n179_ & ~x07));
  assign new_n179_ = (x21 | (~new_n180_ & (~new_n181_ | ~x08))) & (~new_n171_ | x05 | x08);
  assign new_n180_ = x04 & ~x15 & ((x05 & x08 & ~x12 & x18) | (~x05 & x12 & ~x18));
  assign new_n181_ = x15 & x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  ...
  assign new_n188_ = ~x21 & (new_n189_ | (~new_n134_ & ~x04));
  ...
  assign z28 = (~x17 & (new_n194_ | (new_n201_ & ~x05))) | (~x09 & new_n202_ & x17);
  assign new_n194_ = x18 & ((~new_n195_ & x08) | (~x05 & ~x07 & new_n200_ & ~x08));
  assign new_n195_ = (new_n199_ | x07) & (x05 | ((~new_n196_ | x07) & (new_n198_ | ~x15)));
  assign new_n196_ = ~x09 & x10 & new_n197_ & x12;
