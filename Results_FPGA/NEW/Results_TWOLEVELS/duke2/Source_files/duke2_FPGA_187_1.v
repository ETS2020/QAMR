...
module FAU ( 
  ...
  assign z03 = x07 ? new_n80_ : ~new_n79_;
  assign new_n79_ = (x15 | ((x17 | ~x18 | (x05 ? (x08 | x09) : (~x08 | ~x09))) & (x05 | x09 | ~x17 | x18))) & (x09 | ~x17 | x18 | (~x05 & (x05 | ~x15)));
  assign new_n80_ = ~x09 & ((x08 & ~x17 & x18 & (x05 ^ x15)) | (~x05 & x17 & ~x18));
  assign z04 = ~x14 & ~x20;
  ...
  assign z20 = ~x07 & ~x17 & (new_n171_ | (~new_n164_ & ~x09));
  ...
  assign new_n176_ = (~x06 | x08 | x09 | (~x05 ^ x15)) & (x05 | ~x08 | ~x09 | x15);
  assign new_n177_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n179_ & ~x05;
  assign new_n179_ = ~x07 & x08 & x09 & ~x15 & ~x17 & x18;
  ...
  assign z27 = (~new_n190_ & ~x09) | (new_n195_ & ~x05 & ~x07 & x08 & x09);
  assign new_n190_ = (x17 | new_n191_ | ~x18) & (x05 | ~x17 | new_n194_ | x18);
  assign new_n191_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n192_ & (~x05 | x08 | x15 | ~x19));
  assign new_n192_ = ~x21 & (new_n193_ | (~new_n134_ & ~x04));
  assign new_n193_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n194_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n195_ = x18 & x19 & ~x15 & ~x17;
  assign z28 = (~x17 & (new_n197_ | (new_n204_ & ~x05))) | (~x09 & new_n205_ & x17);
  assign new_n197_ = x18 & ((~new_n198_ & x08) | (~x05 & ~x07 & new_n203_ & ~x08));
  assign new_n198_ = (new_n202_ | x07) & (x05 | ((~new_n199_ | x07) & (new_n201_ | ~x15)));
