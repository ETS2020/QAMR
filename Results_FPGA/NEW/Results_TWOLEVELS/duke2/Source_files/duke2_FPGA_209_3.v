...
module FAU ( 
  ...
  assign z02 = ~x17 & (new_n68_ | (new_n76_ & x01 & ~x05 & x07));
  assign new_n68_ = x18 & ((~new_n73_ & x08) | (~x07 & (new_n69_ | (new_n75_ & x08))));
  ...
  assign new_n76_ = ~x15 & ~x18 & x08 & ~x09;
  ...
  assign z04 = ~x14 & ~x20;
  assign z05 = ~x05 & ~x09 & ~x14 & new_n82_ & ~x15;
  assign new_n82_ = ~x17 & x18 & (new_n88_ | (~x07 & (~new_n83_ | new_n86_)));
  assign new_n83_ = (new_n84_ | x06) & (x02 | ~x06 | x08 | ~x11 | ~x21);
  ...
  assign new_n89_ = x12 & ~x13 & x16 & ~x21;
  assign z06 = ~x09 & ((~new_n91_ & ~x05) | (new_n103_ & new_n65_ & x04 & x05));
  assign new_n91_ = (x15 | ((x17 | new_n92_ | ~x18) & (~x07 | ~x17 | x18))) & (x07 | new_n101_ | ~x15);
  assign new_n92_ = (~new_n99_ | x07) & (x14 | ((new_n93_ | ~x06) & (new_n95_ | x07)));
  assign new_n93_ = ~new_n94_ & (x08 | ~x11 | ~x21 | x02 | x07);
  ...
  assign new_n101_ = (~x00 | ~x17 | x18) & (~new_n102_ | x17 | ~x18 | x21);
  assign new_n102_ = ~x02 & x08 & x11;
  assign new_n103_ = ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign z07 = ~x17 & ~new_n105_ & x18;
  assign new_n105_ = (x09 | (~x05 ^ x15) | (~x07 ^ ~x08)) & (x05 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20;
  ...
  assign new_n122_ = ~x07 & ~x09 & new_n123_ & ~x15;
  ...
  assign z12 = ~x09 & ((~new_n132_ & ~x07) | (~x05 & x07 & new_n123_ & ~x15));
  ...
  assign new_n150_ = (x15 | ((~new_n151_ | x09) & (x07 | ~x09 | x19))) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n151_ = ~x14 & ~x21 & (new_n155_ | (~x07 & (new_n152_ | new_n96_)));
  assign new_n152_ = x06 & ((new_n154_ & x12) | (x02 & (new_n153_ | (x04 & ~x12))));
  ...
  assign new_n158_ = (x07 | ((x08 | ~new_n159_ | x15) & (~new_n123_ | ~x00 | ~x15))) & (~new_n123_ | ~x07 | x15);
  assign new_n159_ = ~x17 & x18 & ~new_n61_ & ~new_n160_;
  assign new_n160_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n161_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x09 & new_n163_ & ~x17;
  assign new_n163_ = x18 & (new_n166_ | (~x07 & (new_n168_ | (new_n164_ & ~x14))));
  assign new_n164_ = ~x15 & (new_n86_ | (~x06 & ~new_n165_ & x12));
  assign new_n165_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  assign new_n166_ = new_n167_ & x10 & x12 & x06 & x08;
  assign new_n167_ = ~x13 & ~x14 & ~x15 & x16 & ~x21;
  assign new_n168_ = ~x08 & x15 & x19;
  ...
  assign new_n181_ = (x05 | ~x07 | ~x08 | x09 | ~x15) & (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  ...
  assign z27 = new_n197_ | (new_n202_ & new_n65_ & x03 & ~x05);
