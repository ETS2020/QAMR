...
module FAU ( 
  ...
  assign z02 = ~x17 & (new_n68_ | (new_n77_ & x01 & ~x05 & x07));
  assign new_n68_ = x18 & ((~x07 & (new_n69_ | (new_n76_ & x08))) | (~new_n73_ & x08));
  ...
  assign new_n73_ = new_n75_ & (~x07 | new_n74_ | (~x09 & x19 & (x09 | ~x19)));
  ...
  assign new_n94_ = new_n95_ & ~x07 & x08 & x04 & x05;
  assign new_n95_ = ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign new_n96_ = x07 & ~x15 & x17 & ~x18;
  assign z07 = ~x09 & ~x17 & x18 & ~new_n74_ & (x07 ^ ~x08);
  assign z08 = x14 & ~x20;
  ...
  assign z14 = (~x17 & (new_n133_ | (~x05 & new_n136_ & ~x09))) | (~x05 & new_n138_ & ~x09);
  assign new_n133_ = x08 & ~new_n134_ & x18;
  assign new_n134_ = x07 ? (new_n74_ | x19) : (new_n135_ | (~x09 & (x09 | x21)));
  ...
  assign z16 = x08 & ~x17 & ~new_n141_ & x18;
  assign new_n141_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n142_;
  assign new_n142_ = (x07 | x15 | (x09 ? x19 : ~new_n143_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n143_ = ~x14 & ~x21 & (new_n92_ | (~new_n144_ & x06));
  assign new_n144_ = (~x02 | ((x10 | ~x13) & (~x04 | x12))) & (~x12 | ((x02 | ~x11) & (~x10 | x13)));
  ...
  assign new_n151_ = ~new_n84_ & (~new_n152_ | x06);
  assign new_n152_ = x12 & ((~x13 & ~x21 & x08 & x10) | (~x04 & ~x08 & x21));
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n162_ | (~new_n155_ & ~x09));
  assign new_n155_ = ~new_n159_ & (~x18 | (~new_n156_ & (x05 | ~new_n161_ | x06)));
  assign new_n156_ = ~x21 & (x04 ? (new_n157_ & ~x12) : ~new_n129_);
  ...
  assign new_n183_ = ~x21 & (new_n184_ | (~new_n129_ & ~x04));
