...
module FAU ( 
  ...
  assign new_n70_ = (new_n72_ | ~x08) & (~x05 | x08 | new_n71_ | x15);
  assign new_n71_ = x06 & x19 & (~x06 | ~x19);
  ...
  assign new_n75_ = (~x08 | ((~x07 | ~x19) & (~new_n76_ | x02 | x07))) & (x07 | x08 | (x06 & x19 & (~x06 | ~x19)));
  ...
  assign z03 = x05 ? (~new_n81_ & ~x09) : ~new_n82_;
  assign new_n81_ = (x07 | ((~x17 | x18) & (x08 | x15 | x17 | new_n71_ | ~x18))) & (~x07 | ~x08 | x15 | x17 | ~x18);
  assign new_n82_ = (~x08 | x17 | ~x18 | (x07 ? (x09 | ~x15) : (~x09 | x15))) & (x09 | ~x17 | x18);
  assign z04 = ~x14 & ~x20;
  ...
  assign z07 = ~x17 & x18 & (new_n105_ | (new_n104_ & ~x09));
  assign new_n104_ = (x05 ^ x15) & (x07 ? x08 : (~new_n71_ & ~x08));
  assign new_n105_ = x09 & ~x15 & x16 & ~x05 & ~x07 & x08;
  assign z08 = x14 & ~x20;
  ...
  assign new_n137_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  ...
  assign z17 = ~x09 & (new_n159_ | (~x05 & (new_n102_ | (~new_n157_ & ~x07))));
  assign new_n157_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n158_ | ~x18);
  assign new_n158_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n159_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n161_ & x18;
  assign new_n161_ = (x14 | new_n162_ | x15) & (x08 | ~x15 | (x06 & (~x06 | ~x19)));
  ...
  assign new_n177_ = (new_n178_ | x07) & (~x08 | x09 | ~x15 | x05 | ~x07);
  assign new_n178_ = (x05 | ~x06 | ~x08 | ~x09 | x15) & (x08 | x09 | (x05 ? (x15 | (x19 & (~x06 | ~x19))) : (x06 | ~x15)));
  assign z22 = ~x17 & x18 & ((~new_n180_ & ~x07) | (~x05 & new_n181_ & x07));
  assign new_n180_ = (x08 | x09 | (x19 & (~x06 | ~x19)) | (~x05 ^ x15)) & (~x09 | x15 | x05 | ~x08);
  ...
  assign new_n191_ = x18 & (x08 ? (x09 & ~x15) : (~x09 & ~new_n71_ & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n194_ | (new_n200_ & ~x07 & x08 & x03 & ~x05);
  assign new_n194_ = ~x09 & ((~x17 & ~new_n195_ & x18) | (~x05 & x17 & ~new_n199_ & ~x18));
  assign new_n195_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : new_n196_;
  assign new_n196_ = ~new_n198_ & (x21 | (~new_n197_ & (new_n137_ | x04)));
  assign new_n197_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n198_ = x05 & ~x08 & ~x15 & (~x06 | (x06 & x19));
