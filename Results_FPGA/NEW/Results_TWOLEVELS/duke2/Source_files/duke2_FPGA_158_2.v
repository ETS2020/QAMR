...
module FAU ( 
  ...
  assign new_n68_ = (new_n69_ | x07) & (~x08 | (new_n75_ & (~x07 | (~x05 ^ x15))));
  ...
  assign new_n74_ = (~x05 | (x08 ? (~x21 & (~x15 | x21 | x04 | x11)) : x15)) & (~x08 | ~x15 | ~x21);
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n116_ | (~x17 & (new_n114_ | (~new_n103_ & x18)));
  assign new_n103_ = ~new_n113_ & (x07 | (~new_n112_ & (x15 | (~new_n104_ & ~new_n111_))));
  ...
  assign new_n111_ = ~x04 & x05 & x08 & ~new_n71_ & x12;
  assign new_n112_ = x08 & ((x02 & ~x05 & ~x11 & ~new_n71_ & x15) | (new_n71_ & x05));
  ...
  assign z14 = x07 ? ~new_n136_ : (new_n138_ | (~x17 & (new_n132_ | new_n134_)));
  assign new_n132_ = x08 & x18 & ~new_n133_ & (x09 | (~x09 & ~x21));
  assign new_n133_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n134_ = new_n135_ & x04 & ~x05 & ~x09 & x12;
  assign new_n135_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n136_ = (x05 | ((x09 | x18) & (~new_n137_ | ~x08 | ~x15))) & (~new_n137_ | ~x05 | ~x08 | x15);
  assign new_n137_ = ~x17 & x18 & ~x19;
  assign new_n138_ = ~x05 & ~x09 & x15 & x17 & ~x18;
  ...
  assign z17 = ~x09 & (new_n150_ | (~x05 & (new_n98_ | (~new_n148_ & ~x07))));
  ...
  assign new_n152_ = (x14 | x15 | (~new_n153_ & ~new_n82_)) & (x08 | ~x15 | ~x19);
  ...
  assign z20 = ~x07 & ~x17 & (new_n158_ | new_n164_);
  assign new_n158_ = ~x09 & (new_n159_ | (new_n135_ & x04 & ~x05 & x12));
  assign new_n159_ = x18 & (new_n162_ | (~x21 & (x04 ? new_n160_ : ~new_n128_)));
  assign new_n160_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n161_ : ~x06));
  assign new_n161_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n162_ = ~x05 & new_n163_ & ~x06;
  ...
  assign new_n169_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign z28 = (~x17 & (new_n194_ | (~new_n188_ & x18))) | (~x09 & x17 & ~new_n196_ & ~x18);
  ...
  assign new_n192_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n95_ & x21));
