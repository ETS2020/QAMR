...
module FAU ( 
  ...
  assign new_n69_ = (~x01 | x18 | (~x16 & (~x08 | x15))) & (~x08 | ~x15 | ~x18 | ~x19);
  ...
  assign new_n82_ = ~x17 & x18 & (new_n88_ | (~x15 & (~new_n83_ | new_n86_)));
  ...
  assign z06 = ~x09 & ((~new_n91_ & ~x05) | (new_n101_ & new_n65_ & x04 & x05));
  assign new_n91_ = (x07 | ((x17 | new_n92_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n92_ = (~new_n98_ | x08) & (x21 | (~new_n93_ & ~new_n100_ & (new_n95_ | ~x08)));
  assign new_n93_ = x06 & (new_n94_ | (x11 & ~x15 & ~x02 & ~x08));
  assign new_n94_ = ~x13 & ~x14 & x16 & x08 & x10 & x12;
  assign new_n95_ = (x14 | x15 | (~new_n96_ & ~new_n97_)) & (x02 | ~x11 | ~x15);
  assign new_n96_ = (~x10 | (x04 & x10 & ~x12)) & (~x13 | (~x02 & x11 & x13));
  assign new_n97_ = ~x06 & ((x02 & ~x10 & x13) | (~x13 & ~x16 & x10 & x12));
  assign new_n98_ = ~x14 & new_n99_ & ~x15;
  assign new_n99_ = x21 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  assign new_n100_ = x04 & ~x06 & ~x08 & ~x12 & ~x15;
  assign new_n101_ = ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign z07 = ~x17 & ~new_n103_ & x18;
  assign new_n103_ = (x09 | (~x05 ^ x15) | (x07 ^ x08)) & (x05 | x07 | ~x08 | ~x09 | ~x16);
  assign z08 = x14 & ~x20;
  ...
  assign new_n147_ = (x07 | (x09 ? (x15 | x19) : ~new_n148_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n148_ = ~x14 & ~x21 & (new_n152_ | (~x15 & (new_n149_ | new_n96_)));
  assign new_n149_ = x06 & ((new_n151_ & x12) | (x02 & (new_n150_ | (x04 & ~x12))));
  ...
  assign new_n155_ = (new_n156_ | x07) & (~x17 | x18 | ~x07 | x15);
  ...
  assign new_n160_ = (x14 | (~new_n88_ & (new_n161_ | x15))) & (x08 | ~x15 | ~x19);
  assign new_n161_ = ~new_n86_ & (x06 | new_n162_ | ~x12);
  assign new_n162_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  ...
  assign new_n177_ = (x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)));
  ...
  assign z27 = new_n191_ | (new_n196_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n198_ = (~new_n205_ | x05) & (~x18 | ((new_n199_ | ~x08) & (~new_n204_ | x05)));
  ...
  assign new_n204_ = ~x07 & ~x08 & ~x09 & (new_n98_ | (x15 & ~x19));
