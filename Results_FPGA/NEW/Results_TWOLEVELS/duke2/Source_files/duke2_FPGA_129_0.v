...
module FAU ( 
  ...
  assign new_n129_ = ~new_n131_ & (x15 | (x08 ? (~new_n93_ | x14) : new_n130_));
  ...
  assign z14 = (~x17 & (new_n136_ | (~x05 & new_n140_ & ~x09))) | (~x05 & ~x09 & new_n142_ & x17);
  ...
  assign new_n142_ = ~x18 & (x07 | (~x07 & x15));
  ...
  assign z17 = ~x09 & (new_n154_ | (~x05 & (new_n99_ | (~new_n152_ & ~x07))));
  assign new_n152_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n153_ | ~x18);
  assign new_n153_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n154_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n179_ = (x07 | (~new_n180_ & (x05 | x08 | x15 | ~x18))) & (x05 | ~x07 | ~x08 | x15 | x18);
  ...
  assign new_n200_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n96_ & x21));
