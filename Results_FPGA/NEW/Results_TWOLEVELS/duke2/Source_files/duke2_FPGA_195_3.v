...
module FAU ( 
  ...
  assign z27 = ~x09 & ((~x17 & ~new_n190_ & x18) | (~x05 & x17 & ~new_n193_ & ~x18));
  assign new_n190_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n191_ & (~x05 | x08 | x15 | ~x19));
  assign new_n191_ = ~x21 & (new_n192_ | (~new_n134_ & ~x04));
  assign new_n192_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n193_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  ...
  assign new_n198_ = ~x14 & ~x15 & ~x21 & (~x13 | x11 | (x02 & x13));
