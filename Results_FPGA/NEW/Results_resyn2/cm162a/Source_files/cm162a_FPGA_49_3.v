// Benchmark "FAU" written by ABC on Wed Jul 29 23:08:38 2020
...
module FAU ( 
  ...
  assign z2 = (x04 & (new_n27_ | (~new_n26_ & x02))) | new_n28_ | ~new_n29_;
  assign new_n26_ = (x11 | x08 | x10) & (~x03 | ~x09 | ~x13);
  assign new_n27_ = x10 & x11;
  assign new_n28_ = x11 & ((x03 & ~x04) | (~x06 & (~x02 | x08)));
  assign new_n29_ = x05 & (x03 | x06);
  assign z3 = (x03 & (new_n32_ | (new_n31_ & ~new_n33_))) | ~x05 | (~x03 & ~x07);
  assign new_n31_ = x02 & x04 & ((x09 & x13) | (~x08 & ~x10));
  assign new_n32_ = x12 & (~x02 | ~x04 | x11 | x08 | x10);
  assign new_n33_ = (x11 | x12) & (~x09 | ~x13);
