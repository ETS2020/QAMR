// Benchmark "FAU" written by ABC on Wed Jul 29 23:09:55 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n34_;
  ...
  assign z3 = ~new_n34_ | (x03 & (~new_n33_ | (x02 & (z4 | new_n32_))));
  assign z4 = x13 & x04 & x09;
  assign new_n32_ = ~x12 & ~x11 & ~x08 & ~x10;
  assign new_n33_ = x04 & (~x12 | (x02 & ~x11 & ~x08 & ~x10));
