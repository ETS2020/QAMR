// Benchmark "FAU" written by ABC on Wed Jul 29 23:08:35 2020
...
module FAU ( 
  ...
  assign z3 = ~new_n33_ | (x03 & (new_n32_ | (new_n28_ & ~new_n31_)));
  assign new_n31_ = (x11 | x12) & (~x09 | ~x13);
  assign new_n32_ = x12 & (x08 | x10 | ~x04 | x11);
  assign new_n33_ = (x02 | ~x12) & x05 & (x03 | x07);
