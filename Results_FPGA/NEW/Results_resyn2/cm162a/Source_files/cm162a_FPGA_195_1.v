// Benchmark "FAU" written by ABC on Wed Jul 29 23:09:45 2020
...
module FAU ( 
  ...
  assign new_n26_ = (~x04 | ((~x09 | ~x13) & (x11 | x08 | x10))) & (~x11 | (~x10 & x04 & ~x08));
  assign z3 = (x03 & (new_n29_ | (~new_n28_ & x04))) | ~x05 | (~x03 & ~x07);
  assign new_n28_ = (~x09 | ~x13) & (x08 | x10 | x11 | x12);
  assign new_n29_ = x12 & (x11 | x10 | ~x04 | x08);
