...
module FAU ( 
  ...
  assign z2 = ~new_n29_ | (x03 & ((~new_n28_ & x11) | (new_n27_ & (new_n26_ | ~x11))));
  assign new_n26_ = x09 & x13;
  assign new_n27_ = x02 & x04 & ((x09 & x13) | (~x08 & ~x10));
  assign new_n28_ = x02 & x04 & ~x08 & ~x10;
  assign new_n29_ = x05 & (x03 | x06);
  assign z3 = (x03 & (new_n31_ | (new_n27_ & ~new_n32_))) | ~x05 | (~x03 & ~x07);
  assign new_n31_ = x12 & (~x02 | ~x04 | x08 | x10);
  assign new_n32_ = (~x09 | ~x13) & ~x11 & x12;
