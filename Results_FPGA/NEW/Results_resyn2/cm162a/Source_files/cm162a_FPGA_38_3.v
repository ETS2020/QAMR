// Benchmark "FAU" written by ABC on Wed Jul 29 23:08:32 2020
...
module FAU ( 
  ...
  assign z2 = (~new_n26_ & x02 & x04) | ~new_n28_ | (~new_n27_ & x11);
  assign new_n26_ = (x11 | x08 | x10) & (~x03 | ~x09 | ~x13);
  assign new_n27_ = (~x03 | (x02 & ~x10)) & (x06 | (x04 & ~x08));
  assign new_n28_ = x05 & (x03 | x06);
  assign z3 = (x03 & (new_n31_ | (new_n30_ & ~new_n32_))) | ~x05 | (~x03 & ~x07);
  assign new_n30_ = x02 & x04 & ((x09 & x13) | (~x08 & ~x10));
  assign new_n31_ = x12 & (~x02 | ~x04 | x11 | x08 | x10);
