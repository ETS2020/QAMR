...
module FAU ( 
  ...
  assign new_n71_ = (~new_n47_ | ~new_n72_ | ~x25 | (x17 & x26)) & new_n48_ & (x25 | (new_n47_ & new_n72_));
  assign new_n72_ = x23 & x24;
  assign z16 = z08 | ((new_n74_ | (~x19 & x26)) & x09 & ~x10);
  assign new_n74_ = (x26 | (new_n47_ & new_n72_ & x25)) & ~x08 & (~new_n75_ | ~new_n72_ | ~x25 | ~x26);
  assign new_n75_ = x21 & x22 & ~x18 & x20;
endmodule
