...
module FAU ( 
  ...
  assign z12 = z04 | (new_n48_ & ((x22 & (new_n64_ | ~new_n66_)) | (new_n66_ & x09 & ~x22)));
  assign new_n64_ = x14 & new_n65_ & x25 & x26;
  assign new_n65_ = x23 & x24;
  assign new_n66_ = x21 & x19 & x20;
  assign z13 = z05 | (~new_n68_ & new_n48_);
  assign new_n68_ = (~x23 | ~x09 | x22) & ((~new_n69_ & new_n66_ & x23) | ~x22 | (~new_n66_ & ~x23));
  assign new_n69_ = x24 & x25 & x15 & x26;
  assign z14 = z06 | (~new_n71_ & new_n48_);
  assign new_n71_ = (~x24 | ((new_n72_ | ~x22) & (~x09 | (x22 & x23)))) & (~new_n73_ | ~x23 | x24);
