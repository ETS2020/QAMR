...
module FAU ( 
  ...
  assign z13 = z05 | ((new_n66_ | ~x23 | ~new_n48_ | ~x22) & new_n47_ & (x23 | (new_n48_ & x22)));
  assign new_n66_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~new_n68_ & new_n47_);
  assign new_n68_ = ~new_n69_ & (~x16 | ~x24 | ~x25 | ~x26);
  assign new_n69_ = (x24 | (x19 & x20 & x21 & x22 & x23)) & (~x22 | ~x19 | ~x20 | ~x21 | ~x23 | ~x24);
  assign z15 = new_n71_ | z07;
  assign new_n71_ = ((x17 & x26) | ~x25 | ~new_n72_ | ~x22) & new_n47_ & (x25 | (new_n72_ & x22));
  assign new_n72_ = x19 & x20 & x21 & x23 & x24;
  assign z16 = new_n74_ | z08;
  assign new_n74_ = (x26 | (x25 & new_n72_ & x22)) & new_n47_ & (~new_n72_ | x18 | ~x25 | ~x26);
endmodule
