...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n58_, new_n59_, new_n61_, new_n63_, new_n65_,
    new_n67_, new_n69_, new_n71_, new_n73_;
  ...
  assign new_n65_ = (~x21 | ~x19 | ~x20 | new_n59_ | ~x22) & new_n48_ & (x22 | (x21 & x19 & x20));
  ...
  assign z15 = z07 | (new_n48_ & (new_n71_ | x25) & (~new_n71_ | ~x25 | (x17 & x26)));
  assign new_n71_ = new_n47_ & x23 & x24;
  assign z16 = z08 | (~new_n73_ & new_n48_ & (x26 | (new_n71_ & x25)));
  assign new_n73_ = new_n59_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
