...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n157_, new_n177_, new_n178_, new_n179_, new_n183_, new_n184_,
    new_n193_, new_n194_, new_n196_, new_n210_, new_n220_, new_n223_,
    new_n224_, new_n227_, new_n229_, new_n231_, new_n232_, new_n236_;
  assign z00 = (x06 | x40) & (z04 | ~x40 | x52);
  assign z04 = ~x01 & (~x77 | x79);
  assign z01 = ~x01 & (~x78 | x77 | ~x79);
  assign z02 = ~x01 & x79 & new_n157_ & x75;
  ...
  assign z22 = ~x01 & ((~new_n179_ & ~x77 & x78) | (~new_n177_ & x04 & x77));
  assign new_n177_ = x79 & (x42 | (new_n178_ & x84 & x80 & x82));
  assign new_n178_ = x81 & ~x83 & x43 & ~x74;
  assign new_n179_ = (~x04 | x79) & (~x79 | (x81 ^ x84) | x41 | ~x75);
  ...
  assign z26 = new_n184_ & (new_n183_ ^ ~x81) & ~x42 & x44;
  assign z27 = new_n184_ & (new_n183_ ^ ~x81) & ~x42 & x45;
  assign z28 = new_n184_ & (new_n183_ ^ ~x81) & ~x42 & x46;
  assign z29 = new_n184_ & (new_n183_ ^ ~x81) & ~x42 & x47;
  assign z30 = new_n184_ & (new_n183_ ^ ~x81) & ~x42 & x48;
  assign z31 = new_n184_ & (new_n183_ ^ ~x81) & ~x42 & x49;
  assign z32 = new_n184_ & (new_n183_ ^ ~x81) & ~x42 & x50;
  ...
  assign new_n210_ = ~x01 & new_n157_ & x04 & ~x79;
  ...
  assign z56 = new_n220_ | ~x00 | x01 | ~x78;
  assign new_n220_ = ~x77 & x79 & (x76 | (x81 ^ x84));
  assign z57 = x00 & ~x01 & ~x02 & x03;
  assign z58 = ~x01 & ((~new_n223_ & new_n224_) | (~x04 & ~x79) | (new_n157_ & x04 & ~x79));
  assign new_n223_ = ~x42 & (~new_n178_ | ~x84 | ~x80 | ~x82);
  assign new_n224_ = (~x40 | ~x42) & x04 & x77 & x79;
  assign z59 = (x40 | new_n223_ | ~x79) & ~x01 & (x04 ? x77 : ~x79);
  assign z60 = ~x01 & (~new_n227_ | (~new_n177_ & x04 & x77));
  assign new_n227_ = (x04 | x79) & (~new_n157_ | (x79 & (~x81 ^ x84)));
  assign z61 = ~new_n229_ & x80 & ~x01 & x79;
  assign new_n229_ = (x04 | ~x77) & (x77 | ~x78 | (x81 ^ x84));
  assign z62 = ~x01 & (new_n231_ | (x77 & (new_n232_ | (~new_n177_ & x04))));
  assign new_n231_ = (~x79 | (x81 & x84)) & new_n157_ & (x04 | x79);
  assign new_n232_ = x81 & ~x04 & x79;
  assign z63 = ~new_n229_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & ((new_n157_ & x04 & ~x79) | (~new_n229_ & x79 & x83));
  assign z65 = ~new_n236_ & x84 & ~x01 & x79;
  assign new_n236_ = (x04 | ~x77) & (~x81 | x77 | ~x78);
endmodule
