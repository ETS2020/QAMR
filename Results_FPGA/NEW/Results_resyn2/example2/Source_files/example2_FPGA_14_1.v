...
module FAU ( 
  ...
  assign z22 = ~x01 & (new_n181_ | (~new_n176_ & x77));
  assign new_n176_ = ~new_n180_ & (~new_n179_ | (x79 & (x42 | (new_n177_ & new_n178_))));
  assign new_n177_ = x84 & x80 & x82;
  assign new_n178_ = x81 & ~x83 & x43 & ~x74;
  assign new_n179_ = x04 & x78;
  assign new_n180_ = ~x41 & x66 & x79 & (~x81 ^ x84);
  assign new_n181_ = ~x77 & x78 & x04 & ~x79;
  ...
  assign z47 = ~x01 & (new_n213_ | (new_n214_ & (x67 | x75)));
  assign new_n213_ = new_n181_ & (x15 | ~x52) & (x07 | x52);
  assign new_n214_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z48 = ~x01 & (new_n216_ | (new_n214_ & x68));
  assign new_n216_ = new_n181_ & (x16 | ~x52) & (x08 | x52);
  assign z49 = ~x01 & (new_n218_ | (new_n214_ & x69));
  assign new_n218_ = new_n181_ & (x17 | ~x52) & (x09 | x52);
  assign z50 = ~x01 & (new_n220_ | (new_n214_ & x70));
  assign new_n220_ = new_n181_ & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (new_n222_ | (new_n214_ & x71));
  assign new_n222_ = new_n181_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (new_n224_ | (new_n214_ & x72));
  assign new_n224_ = new_n181_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n226_ | (new_n214_ & x73));
  assign new_n226_ = new_n181_ & (x21 | ~x52) & (x13 | x52);
  assign z54 = new_n181_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  ...
  assign z60 = ~x01 & (~new_n240_ | (new_n179_ & (~x79 | (new_n239_ & x77))));
  ...
  assign z64 = ~x01 & (new_n181_ | (~new_n242_ & x79 & x83));
