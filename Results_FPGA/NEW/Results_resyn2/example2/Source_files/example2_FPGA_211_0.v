...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n246_, new_n250_;
  assign z00 = (~x01 & (~x78 | (~new_n154_ & x40))) | (x06 & ~x40) | (x40 & x52);
  ...
  assign new_n234_ = ~new_n235_ & (~new_n236_ | ~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n235_ = ~x42 & ~x78 & x40 & ~x79;
  assign new_n236_ = (~x40 | ~x42) & x04 & x78;
  assign z59 = ~x01 & ((~new_n238_ & x77) | (~x04 & ~x79));
  assign new_n238_ = (~x40 | x79) & (~new_n180_ | (~x40 & x79 & (x42 | (new_n178_ & new_n179_))));
