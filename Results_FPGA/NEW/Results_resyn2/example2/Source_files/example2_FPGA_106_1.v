// Benchmark "FAU" written by ABC on Thu Jul 30 01:41:24 2020
...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n183_, new_n184_,
    new_n193_, new_n194_, new_n196_, new_n210_, new_n219_, new_n222_,
    new_n223_, new_n225_, new_n226_, new_n228_, new_n230_, new_n232_,
    new_n236_;
  assign z00 = (x06 | x40) & (z04 | ~x40 | x52);
  assign z04 = ~x01 & (~x78 | x79);
  assign z01 = ~x01 & (~x79 | ~x77 | x78);
  assign z02 = ~x01 & x79 & x66 & x77 & ~x78;
  ...
  assign z22 = ~x01 & (new_n178_ | (~new_n176_ & x04 & x78));
  assign new_n176_ = x79 & (x42 | (new_n177_ & x80 & x82 & x84));
  assign new_n177_ = x81 & ~x83 & x43 & ~x74;
  assign new_n178_ = new_n179_ & (x81 ^ ~x84);
  assign new_n179_ = ~x41 & x66 & x77 & ~x78 & x79;
  ...
  assign new_n184_ = ~x01 & ~x04 & x78 & x79;
  ...
  assign z47 = new_n210_ & (x67 | x75);
  assign new_n210_ = ~x01 & x79 & x77 & ~x78 & (x81 ^ ~x84);
  assign z48 = new_n210_ & x68;
  assign z49 = new_n210_ & x69;
  assign z50 = new_n210_ & x70;
  assign z51 = new_n210_ & x71;
  assign z52 = new_n210_ & x72;
  assign z53 = new_n210_ & x73;
  assign z55 = new_n184_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = new_n219_ | ~x77 | ~x00 | x01;
  assign new_n219_ = ~x78 & x79 & (x76 | (x81 ^ x84));
  assign z57 = x00 & ~x01 & ~x02 & x03;
  assign z58 = ~x01 & (new_n222_ | (new_n176_ & new_n223_));
  assign new_n222_ = ~x79 & (~x04 | (x40 & ~x42 & x77 & ~x78));
  assign new_n223_ = (~x40 | ~x42) & x04 & x78;
  assign z59 = ~x01 & (new_n226_ | (new_n225_ & x04 & x78) | (~x79 & (~x04 | x78)));
  assign new_n225_ = ~x42 & (~new_n177_ | ~x84 | ~x80 | ~x82);
  assign new_n226_ = x40 & ((x04 & x78) | (x77 & ~x79));
  assign z60 = ~x01 & (new_n228_ | (new_n225_ & x04 & x78) | (~x79 & (~x04 | x78)));
  assign new_n228_ = (~x81 | ~x84) & (x81 | x84) & x79 & x77 & ~x78;
  assign z61 = ~new_n230_ & x80 & ~x01 & x79;
  assign new_n230_ = (~x77 | x78 | (x81 ^ x84)) & (x04 | ~x78);
  assign z62 = ~x01 & (new_n232_ | (~new_n176_ & x04 & x78));
  assign new_n232_ = x79 & x81 & ((~x04 & x78) | (x77 & ~x78 & x84));
  assign z63 = ~new_n230_ & x82 & ~x01 & x79;
  assign z64 = ~new_n230_ & x83 & ~x01 & x79;
  assign z65 = ~new_n236_ & x84 & ~x01 & x79;
  assign new_n236_ = (~x81 | ~x77 | x78) & (x04 | ~x78);
  assign z54 = 1'b0;
endmodule
