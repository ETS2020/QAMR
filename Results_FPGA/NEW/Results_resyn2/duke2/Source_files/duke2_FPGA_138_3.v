// Benchmark "FAU" written by ABC on Wed Jul 29 21:58:55 2020
...
module FAU ( 
  ...
  assign new_n69_ = x18 & ((~new_n70_ & ~x07) | (new_n75_ & x05 & x07 & x08));
  ...
  assign new_n82_ = ((~x08 & ~x16) | x18 | ~x01 | x15) & (~x08 | ~x15 | ~x18 | ~x19);
  ...
  assign new_n88_ = ~x07 & (~x17 | x18) & (x17 | ~x18 | x15 | ~x05 | x08);
  ...
  assign z06 = ~x09 & (new_n109_ | (~new_n101_ & ~x05));
  ...
  assign new_n107_ = ~new_n108_ & ~x08 & ~x21;
  assign new_n108_ = (~x04 | x06 | x12) & (~x06 | x02 | ~x11);
  assign new_n109_ = new_n110_ & new_n111_ & ~x07 & x08;
  assign new_n110_ = ~x17 & x18 & ~x21;
  assign new_n111_ = x04 & ~x15 & x05 & ~x12;
  assign z07 = new_n86_ & ~new_n113_;
  assign new_n113_ = (x05 | x07 | ~x08 | ~x16 | ~x09 | x15) & ((x07 ^ x08) | x09 | (~x05 ^ x15));
  assign z08 = x14 & ~x20;
  assign z09 = (~x17 & (new_n125_ | (~new_n116_ & x18))) | (new_n127_ & ~x09 & x17 & ~x18);
  assign new_n116_ = ~new_n123_ & (x15 | ((new_n117_ | x07) & (~new_n72_ | (~x07 & x12))));
  assign new_n117_ = ~new_n122_ & (x09 | (~new_n118_ & (x19 | ~x05 | x08)));
  assign new_n118_ = ~x21 & ((new_n63_ & ~new_n119_) | (~x05 & (new_n120_ | new_n121_)));
  assign new_n119_ = (x05 | x06 | x08) & (~x02 | ~x13 | ~x08 | x14);
  assign new_n120_ = (~x10 | x12) & x08 & ~x14 & x02 & x13;
  assign new_n121_ = ~x02 & x11 & x06 & ~x08;
  assign new_n122_ = x08 & x12 & ~x04 & x05 & (x09 | ~x21);
  assign new_n123_ = ~new_n124_ & ~x07 & x08;
  assign new_n124_ = (~x09 & x21) ? ~x05 : (~x02 | x11 | x05 | ~x15);
  assign new_n125_ = new_n126_ & ~x14 & x04 & ~x05;
  assign new_n126_ = ~x18 & ~x21 & x12 & ~x15 & ~x07 & ~x09;
  assign new_n127_ = ~x07 & ~x15;
  assign z10 = new_n129_ | (~new_n132_ & new_n79_ & ~x15 & ~x17);
  assign new_n129_ = ~new_n130_ & ~x09 & (new_n131_ | x07 | (x17 & ~x18));
  assign new_n130_ = ~new_n85_ & x07 & (~new_n86_ | ~new_n72_ | ~new_n75_);
  assign new_n131_ = ~new_n87_ & new_n86_ & ~x06 & ~x08;
  assign new_n132_ = (~x09 | x05 | x07) & (~x05 | ~x07 | (~x09 & x19));
  assign z11 = ~x09 & ~x17 & x01 & ~x15 & new_n81_ & ~x18;
  assign z12 = ~x09 & ((~x07 & (new_n135_ | (new_n85_ & x00 & x15))) | (new_n85_ & x07 & ~x15));
  assign new_n135_ = new_n110_ & ((~new_n136_ & ~x05) | new_n138_ | (new_n111_ & x08));
  assign new_n136_ = (~new_n61_ | ~x08 | ~x15) & (x15 | ((new_n137_ | x08) & (~new_n104_ | ~x08 | x14)));
  assign new_n137_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n138_ = ~x04 & ((new_n139_ & x12 & ~x15) | (new_n72_ & ~x11 & x15));
  assign new_n139_ = ~x05 & ~x06 & ~x08;
  assign z13 = (~x05 | ~x07) & x17 & ~x09 & ~x18;
  assign z14 = (new_n144_ & ~new_n146_) | (~x17 & ((new_n144_ & ~new_n145_) | (~new_n142_ & new_n79_)));
  assign new_n142_ = (new_n143_ | x07 | (~x09 & x21)) & (new_n87_ | ~x07 | x19);
  assign new_n143_ = ~new_n111_ & (~new_n61_ | x05 | ~x15);
  ...
  assign z16 = new_n79_ & ~x17 & (new_n149_ | new_n153_);
  assign new_n149_ = ~x05 & ((~new_n150_ & ~x07 & ~x15) | (x09 & x15 & (~x02 | x07)));
  assign new_n150_ = (~x09 | x19) & ((~new_n151_ & new_n152_) | x09 | x14 | x21);
  assign new_n151_ = x12 & (new_n61_ | ~x13) & (new_n61_ | x10) & (~x06 ^ ~x16);
  assign new_n152_ = ((~new_n63_ & x10) | (x13 & (x02 | ~x11))) & (~x02 | ~x06 | (~new_n63_ & (x10 | ~x13)));
  assign new_n153_ = x05 & ~x15 & x09 & (x07 | ~x12);
  assign z17 = ~x09 & ((new_n67_ & new_n110_) | (~new_n155_ & ~x05));
  assign new_n155_ = (~x07 | x15 | ~x17 | x18) & (x07 | (~new_n156_ & (~x17 | x18 | ~x00 | ~x15)));
  assign new_n156_ = new_n157_ & (~x06 | (x02 & ~x11)) & (x06 | (~x04 & x12));
  assign new_n157_ = ~x08 & x18 & ~x15 & ~x17 & (~x14 | ~x21);
  assign z18 = new_n99_ & ((x19 & ~x08 & x15) | (~new_n159_ & ~x14 & ~x15));
  assign new_n159_ = ~new_n95_ & (~x12 | (~new_n161_ & (new_n160_ | x06)));
  ...
  assign z20 = ~x07 & ~x17 & ((~new_n164_ & ~x09) | (new_n169_ & new_n63_ & x09));
  assign new_n164_ = ~new_n168_ & (~x18 | (~new_n167_ & (x21 | (~new_n165_ & ~new_n138_))));
  assign new_n165_ = new_n63_ & ~x15 & ((~x05 & ~x06 & ~x08) | (x08 & (new_n166_ | x05)));
  assign new_n166_ = x10 & ~x14 & (new_n61_ | ~x13);
  assign new_n167_ = new_n139_ & new_n55_ & x21 & (~x04 ^ ~x12);
  assign new_n168_ = new_n55_ & x04 & ~x05 & x12 & ~x18 & ~x21;
  assign new_n169_ = new_n79_ & x05 & ~x15;
  ...
  assign new_n176_ = (new_n177_ | x21) & (x05 | x15 | x08 | ~x18);
  ...
  assign new_n180_ = x08 & x01 & ~x15 & new_n81_ & ~x18;
  assign z25 = new_n86_ & ~x05 & ~x07 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = ~x09 & ((~new_n184_ & new_n86_) | (~new_n187_ & new_n85_));
  assign new_n184_ = (x07 | (~new_n185_ & (x15 | ~x19 | ~x05 | x08))) & (~x07 | ~x19 | ~x08 | (x05 ^ ~x15));
  assign new_n185_ = ~x21 & (new_n138_ | new_n186_);
  assign new_n186_ = x06 & ~x08 & x02 & ~x11 & ~x05 & ~x15;
  assign new_n187_ = x15 ? (~x00 | x07) : ~x07;
  assign z28 = new_n198_ | (~new_n189_ & ~x17);
  assign new_n189_ = ~new_n197_ & (~x18 | (~new_n193_ & (~x08 | (~new_n190_ & ~new_n195_))));
  assign new_n190_ = ~x05 & (new_n192_ | (new_n191_ & (~x13 | x02 | x11)));
  assign new_n191_ = new_n55_ & ~x21 & x10 & x12 & ~x07 & ~x09;
  assign new_n192_ = x15 & (x07 | ~x11 | (~x02 & (x09 | ~x21)));
  assign new_n193_ = ~new_n194_ & ~x05 & ~x09 & ~x07 & ~x08;
  assign new_n194_ = (~x15 | x19) & (new_n108_ | ~x21 | x14 | x15);
  assign new_n195_ = ~new_n196_ & ~x07;
  assign new_n196_ = (~x21 | x09 | ~x15) & (~x12 | x15 | x04 | ~x05 | (~x09 & x21));
  assign new_n197_ = new_n81_ & ~x18 & ~x09 & x15 & (~x02 | ~x11);
