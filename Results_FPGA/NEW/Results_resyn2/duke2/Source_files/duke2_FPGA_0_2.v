// Benchmark "FAU" written by ABC on Wed Jul 29 21:58:08 2020
...
module FAU ( 
  ...
  assign new_n118_ = ~x02 & x11 & x06 & ~x08;
  ...
  assign new_n148_ = (x07 | x15 | (~new_n149_ & (~x09 | x19))) & (~x09 | ~x15 | (x02 & ~x07));
  ...
  assign new_n156_ = ~new_n157_ & new_n86_ & ~x15 & ~x08 & (~x14 | ~x21);
  assign new_n157_ = (x04 | x06 | ~x12) & (~x06 | ~x02 | x11);
  ...
  assign z28 = new_n197_ | (~x17 & ((~new_n190_ & x18) | (new_n198_ & new_n130_ & ~x18)));
  ...
  assign new_n197_ = z13 & (~x07 | ~x19) & (x05 | x15);
  assign new_n198_ = (~x02 | ~x11) & ~x09 & x15;
endmodule
