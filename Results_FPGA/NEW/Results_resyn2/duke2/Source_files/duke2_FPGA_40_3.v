...
module FAU ( 
  ...
  assign z03 = new_n80_ | (~new_n82_ & ~new_n85_ & ~x09);
  assign new_n80_ = new_n66_ & ~x05 & new_n81_ & x09 & ~x15;
  assign new_n81_ = ~x17 & x18;
  assign new_n82_ = ~new_n83_ & x07 & (~new_n81_ | new_n84_ | ~x08);
  assign new_n83_ = ~x05 & x17 & ~x18;
  assign new_n84_ = x05 ^ ~x15;
  assign new_n85_ = ~x07 & (~x17 | x18) & (~x05 | x08 | x15 | x17 | ~x18);
  assign z04 = ~x14 & ~x20;
  assign z05 = ~new_n88_ & new_n96_ & ~x09 & new_n81_ & ~x05 & ~x07;
  ...
  assign new_n125_ = ~new_n83_ & x07 & (~new_n126_ | x17);
  assign new_n126_ = x05 & ~x15 & x08 & x18;
  assign new_n127_ = ~x07 & (~x17 | x18) & (new_n84_ | x06 | x08 | x17 | ~x18);
  assign new_n128_ = (~x05 | x07) & new_n81_ & (x05 | ~x07);
  assign z11 = new_n130_ & ~x18 & x01 & x07;
  assign new_n130_ = ~x05 & ~x15 & ~x09 & ~x17;
  assign z12 = ~x09 & ((~x07 & (new_n132_ | (new_n83_ & x00 & x15))) | (new_n83_ & x07 & ~x15));
  ...
  assign new_n142_ = (new_n84_ | ~x07 | x19) & (new_n143_ | x07 | (~x09 & x21));
  ...
  assign new_n158_ = new_n81_ & ~x15 & ~x08 & (~x14 | ~x21);
  ...
  assign z23 = x08 & x09 & ~x15 & new_n81_ & ~x05 & ~x07;
  ...
  assign z27 = new_n187_ | (~x09 & (new_n188_ | (~new_n185_ & new_n81_)));
  assign new_n185_ = (x07 | (~new_n186_ & (x08 | ~x19 | ~x05 | x15))) & (~x07 | ~x19 | ~x08 | (x05 ^ ~x15));
  assign new_n186_ = ~x21 & (new_n136_ | (new_n135_ & ~x08 & ~x05 & ~x15));
  assign new_n187_ = new_n80_ & x03 & x19;
  assign new_n188_ = new_n83_ & (x15 ? (x00 & ~x07) : x07);
