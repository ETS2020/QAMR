...
module FAU ( 
  ...
  assign z09 = ~new_n52_ | (x04 & ((new_n50_ & new_n45_) | (~x02 & x16)));
  assign new_n50_ = (~x16 | (~x10 & x02 & ~x03)) & new_n51_ & ~x13;
  assign new_n51_ = ~x11 & ~x12;
  assign new_n52_ = ((new_n47_ & new_n51_) | ~x13) & x04 & (~x03 | ~x16);
  assign z10 = x04 & ((new_n45_ & (new_n50_ | (~new_n40_ & x00))) | (new_n40_ & x14));
