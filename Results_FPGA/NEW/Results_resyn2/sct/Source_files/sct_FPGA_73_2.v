...
module FAU ( 
  ...
  assign z09 = ~new_n53_ | (x04 & ((new_n51_ & new_n45_) | (~x02 & x16)));
  assign new_n51_ = ~new_n52_ & ~x13 & ~x10 & ~x12;
  assign new_n52_ = x16 & (x11 | ~x02 | x03);
  assign new_n53_ = (~x13 | (new_n49_ & ~x12)) & x04 & (~x03 | ~x16);
  assign z10 = x04 & ((new_n40_ & x14) | (new_n45_ & (new_n51_ | (~new_n40_ & x00))));
