// Benchmark "FAU" written by ABC on Wed Jul 29 20:20:29 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n42_, new_n46_, new_n49_, new_n50_, new_n51_, new_n53_;
  ...
  assign z04 = (x08 | (new_n42_ & (x02 | ~x16))) & (~new_n42_ | ~x08) & x04 & (~x03 | ~x16);
  assign new_n42_ = x06 & x07;
  assign z05 = (x09 & (~new_n42_ | ~x08)) | ~new_n39_ | (new_n42_ & x08 & ~x09);
  assign z06 = (x10 & (~x06 | ~x07 | ~x08 | x09)) | ~new_n39_ | (~x10 & x06 & x07 & x08 & ~x09);
  ...
  assign z09 = ((~new_n46_ | ~new_n49_) & x13) | ~new_n39_ | (new_n50_ & new_n51_);
  assign new_n49_ = ~x11 & ~x12;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & (~x03 | ~x16);
  assign new_n51_ = ~x11 & ~x12 & ~x10 & ~x13;
  assign z10 = x04 & (new_n53_ | (new_n50_ & (new_n51_ | x00)));
