...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n42_, new_n45_, new_n50_, new_n51_, new_n52_;
  ...
  assign z04 = new_n42_ & (~x16 | (x02 & (~x03 | x07)));
  assign new_n42_ = (x08 | (x06 & x07)) & x04 & (~x08 | ~x06 | ~x07);
  ...
  assign z10 = x04 & (new_n51_ | (new_n52_ & (new_n50_ | x00)));
  assign new_n50_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n51_ = x14 & x16 & (~x02 | x03);
  assign new_n52_ = x06 & x07 & x08 & ~x09 & (x02 | ~x16);
