...
module FAU ( 
  ...
  assign z06 = x01 & x09 & (~x02 | ~x04 | ~z01 | ~x03);
  assign z08 = ~new_n38_ | (new_n34_ & x02 & x04);
  assign new_n38_ = x11 & x00 & ~x10;
  assign z09 = x00 & ~x10 & (~x11 ^ x12);
  assign z10 = new_n38_ & x09 & x12 & (~x02 | ~x04);
  assign z11 = (~x01 | (x12 & (~x02 | ~x04))) & new_n38_ & (~x12 | (x01 & x09));
