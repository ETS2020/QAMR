...
module FAU ( 
  ...
  assign z08 = (new_n34_ & new_n37_) | ~new_n39_ | x10;
  assign new_n39_ = x00 & x11;
  assign z09 = (x12 | (~x10 & ~x11)) & x00 & (x11 | ~x12);
  assign z10 = ~new_n37_ & x12 & x00 & x09 & x11;
  assign z11 = new_n39_ & ((x01 & x09 & ~new_n37_ & x12) | (~x12 & ~x01 & ~x10));
