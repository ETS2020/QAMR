...
module FAU ( 
  ...
  assign z0 = ((~x04 & (x01 | x03)) | ~x02 | (x01 & x05)) & ~x00 & (x02 | (x01 & x03));
  assign z1 = ~x00 & (x02 | (x01 & x03)) & ~new_n28_ & (x03 | x04);
  assign new_n28_ = x02 & x06 & x01 & x05;
  ...
  assign z6 = (new_n35_ | x01 | x02) & new_n36_ & (x00 | ~x01 | ~x02 | ~x14);
