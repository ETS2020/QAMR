...
module FAU ( 
  ...
  assign z0 = (x02 ? (~x04 | x05) : x03) & ~x00 & x01;
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (~x01 | x02 | ~x03) & ((x06 & x01 & x05) | ~x02 | ~x04);
  assign z2 = (~new_n30_ & ~new_n31_ & ~x00) | (~new_n32_ & ~x07 & ~x08);
  assign new_n30_ = ~x02 & (x01 | (~x09 & ~x07 & ~x10));
  assign new_n31_ = (~x02 | (~x01 & ~x04)) & x03 & (x07 | x10);
