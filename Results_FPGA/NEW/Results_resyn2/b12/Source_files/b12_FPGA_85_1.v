...
module FAU ( 
  ...
  assign new_n30_ = (~x09 | x07 | (x08 & (x00 | x10))) & ((~x07 & ~x10) | x00 | x03);
  assign z3 = (~x07 | ~x11) & (x00 | ~x12);
  assign z4 = (~x07 | ~x11) & (~x08 | ~x09 | ~x00 | x07);
  assign z5 = (~x00 & x12) | x07 | x10 | x00 | ~x13;
  assign z6 = ~new_n36_ & new_n35_ & ((~x03 & x09) | (x03 & ~x09) | x01 | x02);
  assign new_n35_ = ~x07 & (~x08 | (~x00 & ~x10));
  assign new_n36_ = ~x00 & ((x10 & (x01 | (~x02 & x03))) | (x14 & x01 & x02));
