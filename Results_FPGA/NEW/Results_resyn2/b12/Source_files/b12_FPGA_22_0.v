// Benchmark "FAU" written by ABC on Wed Jul 29 23:48:33 2020
...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n34_, new_n35_, new_n37_;
  ...
  assign z3 = (~x07 | ~x11) & (x00 | (~x11 & ~x12));
  assign z4 = (~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  assign z6 = ((x03 & ~x09) | x01 | x02 | (~x03 & x09)) & new_n35_ & (~new_n34_ | ~x01 | ~x02);
