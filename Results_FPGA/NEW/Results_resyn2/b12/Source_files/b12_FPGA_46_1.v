...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n33_, new_n37_, new_n39_,
    new_n40_, new_n43_;
  assign z0 = ~x00 & ((x02 & x01 & (~x04 | x05)) | ((~x02 | ~x04) & x03 & (x01 | x02)));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = ((~x04 & (~x02 | ~x03)) | (x06 & x01 & x05)) & (~x03 | ~x01 | x02);
  assign z2 = (~x00 & (x02 | (~new_n30_ & ~new_n31_))) | (new_n33_ & (new_n32_ | x02));
  assign new_n30_ = x01 & (~x04 | x05);
  assign new_n31_ = (~x09 | x07 | x10) & ~x04 & (x03 | (~x07 & ~x10));
  ...
  assign z6 = ~new_n39_ & new_n40_ & (x00 | ~x01 | ~x02 | ~x14);
