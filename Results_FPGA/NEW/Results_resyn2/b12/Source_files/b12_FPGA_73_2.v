// Benchmark "FAU" written by ABC on Wed Jul 29 23:48:51 2020
...
module FAU ( 
  ...
  assign z3 = x00 ? (~x07 | ~x11) : ~x12;
  assign z4 = (~x00 & (~x07 | ~x12)) | ((~x07 | ~x11) & (~x09 | x07 | ~x08));
  ...
  assign new_n40_ = (~x00 | x09) & (~x09 | x12 | ~x03 | x01 | x02);
endmodule
