...
module FAU ( 
  ...
  assign new_n30_ = ~x02 & ((x03 & x10) | x01 | (~x09 & ~x10));
  assign z3 = (~x00 & ~x12) | (x00 & ~x07) | (x07 & ~x11);
  assign z4 = (~x07 & (~x08 | ~x09)) | ~x00 | (x07 & ~x11);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = (x01 | x02 | (~x03 ^ ~x09)) & new_n36_ & (~new_n35_ | ~x01 | ~x02);
  assign new_n35_ = ~x00 & x14;
  assign new_n36_ = ~x10 & (~x00 | (~x07 & ~x08));
  assign z7 = (new_n38_ & x09) | x07 | x10 | (~new_n38_ & ~x08);
  assign new_n38_ = x03 & ~x01 & ~x02;
  assign z8 = (x09 & (~new_n38_ | x12)) | x07 | x10 | (~x00 & ~x09);
endmodule
