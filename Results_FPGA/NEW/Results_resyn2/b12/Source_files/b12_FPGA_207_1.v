// Benchmark "FAU" written by ABC on Wed Jul 29 23:49:58 2020
...
module FAU ( 
  ...
  assign z4 = (~x07 & (~x09 | ~x00 | ~x08)) | (~x11 & (x07 | x12));
  assign z5 = ~new_n34_ | x00 | ~x13;
  ...
  assign z8 = ~new_n34_ | (x09 ? (~x03 | x01 | x02) : ~x00);
endmodule
