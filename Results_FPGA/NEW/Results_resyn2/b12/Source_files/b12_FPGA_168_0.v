// Benchmark "FAU" written by ABC on Wed Jul 29 23:49:39 2020
...
module FAU ( 
  ...
  assign z0 = ~x00 & ((x01 & (x02 ? x05 : x03)) | (~x04 & x02 & x03));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (~x02 | (x05 & ((~x03 & ~x04) | (x01 & x06)))) & (~x01 | x02 | ~x03);
  ...
  assign z6 = ~new_n35_ & new_n36_ & (x00 | ~x01 | ~x02 | ~x14);
  assign new_n35_ = (~x03 | x09) & (x03 | ~x09) & ~x01 & ~x02;
