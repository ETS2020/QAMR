...
module FAU ( 
  ...
  assign z4 = ~x09 | (x07 ? ~x11 : (~x00 | ~x08));
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = ~new_n35_ & new_n36_ & ((x03 & ~x09) | x01 | x02 | (~x03 & x09));
  assign new_n35_ = (x07 | (x01 & x14)) & ~x00 & x02;
  assign new_n36_ = (~x07 | (x03 & ~x09)) & ~x10 & (~x00 | ~x08);
