// Benchmark "FAU" written by ABC on Wed Jul 29 23:49:15 2020
...
module FAU ( 
  ...
  wire new_n29_, new_n34_, new_n35_, new_n37_, new_n39_;
  ...
  assign z6 = (x01 | x02 | (~x03 & x09) | (x03 & ~x09)) & new_n35_ & (~new_n34_ | (~x03 & x09));
  assign new_n34_ = ~x00 & x01 & x02 & x14;
  assign new_n35_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = new_n37_ | x07 | x10;
  assign new_n37_ = (~x08 | (x03 & ~x01 & ~x02)) & (~x03 | x09 | x01 | x02);
  assign z8 = new_n39_ | x07 | x10;
  assign new_n39_ = (~x00 | x09) & (~x09 | x12 | ~x03 | x01 | x02);
endmodule
