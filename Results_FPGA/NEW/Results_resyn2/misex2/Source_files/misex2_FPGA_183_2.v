...
module FAU ( 
  ...
  assign z09 = ~x21 & ~x22 & (new_n62_ | (new_n60_ & new_n61_ & ~x15));
  assign new_n60_ = ~x11 & x12 & x02 & ~x00 & ~x01;
  assign new_n61_ = ~x13 & ~x14 & ~x16 & x20;
  assign new_n62_ = x18 & ~x19 & x01 & ~x20;
  assign z10 = new_n64_ | (new_n60_ & new_n65_ & x20 & x15 & x16);
  assign new_n64_ = x22 & x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x13 & ~x14 & ~x21 & ~x22;
  assign z11 = ~x22 & ((new_n62_ & x21) | (new_n60_ & new_n61_ & x15 & ~x21));
