...
module FAU ( 
  ...
  assign z09 = ~x00 & ~x22 & (new_n62_ | (new_n60_ & new_n61_ & ~x15));
  assign new_n60_ = ~x13 & ~x14 & ~x11 & x12 & ~x01 & x02;
  assign new_n61_ = ~x16 & x20;
  assign new_n62_ = ~x20 & x18 & ~x19 & x01 & ~x21;
  assign z10 = ~x00 & ((new_n64_ & x22) | (new_n60_ & new_n65_ & x20 & ~x22));
  assign new_n64_ = x21 & ~x20 & x18 & ~x19;
  assign new_n65_ = x15 & x16;
  assign z11 = ~x00 & ~x22 & (new_n64_ | (new_n60_ & new_n61_ & x15));
