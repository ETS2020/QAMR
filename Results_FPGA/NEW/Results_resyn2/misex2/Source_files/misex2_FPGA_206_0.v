// Benchmark "FAU" written by ABC on Wed Jul 29 21:22:16 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n54_, new_n56_, new_n58_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n66_, new_n67_;
  assign z01 = new_n46_ & ~x18 & ~x02 & ~x19 & x10 & ~x17;
  assign new_n46_ = ~x00 & ~x01;
  assign z02 = new_n46_ & ~x18 & ~x02 & ~x19 & ~x10 & ~x17;
  assign z03 = new_n49_ | (x18 & ~x19 & new_n46_ & ~x02 & ~x17);
  assign new_n49_ = x12 & ~x09 & x10 & x11 & x01 & x02;
  assign z04 = ~x12 & ~x09 & x10 & ~x11 & x01 & x02;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z06 = ~x09 & x10 & x11 & x01 & x02;
  assign z07 = (new_n54_ | ~x01) & x02 & (x00 | x01);
  assign new_n54_ = x11 & ~x12 & ~x09 & x10;
  assign z08 = new_n56_ & new_n46_ & x02 & x19 & x17 & ~x18;
  ...
  assign new_n62_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n63_ = x20 & ~x21 & ~x14 & x15;
  assign z11 = ~x00 & ~x22 & (new_n62_ | (new_n59_ & new_n63_ & ~x16));
  assign z12 = ~x24 & (new_n66_ | new_n67_);
  assign new_n66_ = (~x02 | ~x10) & x09 & x00 & x01;
