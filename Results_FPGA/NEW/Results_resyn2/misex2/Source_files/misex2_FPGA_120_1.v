...
module FAU ( 
  ...
  assign new_n60_ = ~x16 & x20 & ~x13 & ~x14;
  assign new_n61_ = ~x11 & x12 & ~x01 & x02;
  assign new_n62_ = ~x19 & ~x20 & ~x21 & x01 & x18;
  assign z10 = ~x00 & ((new_n64_ & new_n61_ & new_n65_) | (new_n66_ & x22));
  assign new_n64_ = x20 & ~x13 & ~x14;
  assign new_n65_ = x15 & x16 & ~x21 & ~x22;
  assign new_n66_ = ~x19 & ~x20 & x21 & x01 & x18;
  assign z11 = ~x00 & ~x22 & (new_n66_ | (new_n60_ & new_n61_ & x15));
