// Benchmark "FAU" written by ABC on Wed Jul 29 21:22:10 2020
...
module FAU ( 
  ...
  assign z08 = new_n58_ & new_n57_ & x02 & x19 & x17 & ~x18;
  assign new_n57_ = ~x00 & ~x01;
  assign new_n58_ = ~x07 & ~x08 & ~x05 & ~x06 & ~x03 & x04;
  ...
  assign new_n65_ = x20 & ~x21 & ~x14 & x15;
  assign z11 = ~x00 & ~x22 & (new_n64_ | (new_n61_ & new_n65_ & ~x16));
  assign z12 = ~x24 & (new_n69_ | (~new_n68_ & x09));
  assign new_n68_ = (~x00 | ~x01 | (x02 & x10)) & (x02 | x19 | ~x17 | x00 | x01);
  assign new_n69_ = (x02 | x19) & x23 & ~x00 & ~x01;
  assign z13 = new_n57_ & x17 & ~x02 & ~x19;
  assign z14 = new_n46_ & ~x09 & ~x18 & ~x19 & ~x10 & ~x17;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x19 & ~x01 & ~x02);
  assign z16 = ~x00 & x01;
  assign z17 = new_n57_ & x02;
endmodule
