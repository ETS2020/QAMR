...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n50_, new_n55_, new_n57_, new_n59_, new_n60_,
    new_n61_, new_n63_, new_n64_, new_n67_, new_n68_;
  assign z00 = new_n46_ & ~x02 & ~x17 & ~x09 & ~x18 & ~x19;
  assign new_n46_ = ~x00 & ~x01;
  assign z01 = new_n46_ & ~x02 & ~x17 & x09 & ~x18 & ~x19;
  assign z03 = new_n50_ | (x12 & new_n49_ & x11 & ~x09 & x10);
  assign new_n49_ = x02 & x00 & x01;
  assign new_n50_ = ~x00 & ~x01 & ~x02 & ~x17 & x18 & ~x19;
  assign z04 = new_n49_ & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = new_n49_ & x09 & x10;
  assign z06 = new_n49_ & x11 & ~x09 & x10;
  assign z07 = ~new_n55_ & x00 & x02;
  assign new_n55_ = x01 & (x12 | ~x11 | x09 | ~x10);
  assign z08 = new_n57_ & new_n46_ & x02 & x19 & x17 & ~x18;
  assign new_n57_ = ~x03 & x04 & ~x07 & ~x08 & ~x05 & ~x06;
  ...
  assign z12 = new_n68_ & ((x01 & (~x10 | (x00 & ~x02))) | (~new_n67_ & ~x00 & ~x01));
  assign new_n67_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n68_ = x09 & ~x24;
  assign z13 = new_n46_ & x17 & ~x02 & ~x19;
  assign z15 = (~x02 & (x00 | (~x01 & x19))) | (x01 & ~x10);
  assign z16 = ~x00 & x01;
