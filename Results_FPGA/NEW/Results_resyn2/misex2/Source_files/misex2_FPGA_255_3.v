// Benchmark "FAU" written by ABC on Wed Jul 29 21:22:27 2020
...
module FAU ( 
  ...
  assign z09 = (new_n62_ | (new_n60_ & new_n61_)) & ~x00 & ~x22;
  assign new_n60_ = ~x13 & ~x14 & ~x11 & x12;
  assign new_n61_ = ~x15 & ~x16 & ~x01 & x02 & x20 & ~x21;
  assign new_n62_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = new_n60_ & z17 & x15 & new_n64_ & x16;
  assign new_n64_ = ~x22 & x20 & ~x21;
  assign z11 = new_n60_ & z17 & x15 & new_n64_ & ~x16;
