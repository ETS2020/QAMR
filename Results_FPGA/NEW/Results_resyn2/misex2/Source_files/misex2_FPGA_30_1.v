...
module FAU ( 
  ...
  assign z09 = (new_n60_ | (new_n61_ & new_n62_ & ~x15)) & new_n63_ & ~x21;
  assign new_n60_ = x18 & ~x19 & x01 & ~x20;
  assign new_n61_ = ~x11 & x12 & ~x01 & x02;
  assign new_n62_ = x20 & ~x13 & ~x14;
  assign new_n63_ = ~x00 & ~x22;
  assign z10 = new_n60_ & x21 & ~x00 & x22;
  assign z11 = new_n63_ & ((new_n60_ & x21) | (new_n61_ & new_n62_ & x15 & ~x21));
  assign z12 = x09 & ~x24 & (new_n67_ | (new_n52_ & (~x02 | ~x10)));
