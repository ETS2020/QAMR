...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x09;
  assign new_n46_ = ~x01 & ~x02 & ~x00 & ~x17 & ~x18 & ~x19;
  assign z01 = new_n46_ & x09 & x10;
  assign z02 = new_n46_ & ~x10;
  assign z03 = new_n51_ | (z06 & x12);
  assign z06 = x02 & x00 & x01 & ~x09 & x11;
  assign new_n51_ = ~x01 & ~x02 & ~x00 & ~x17 & x18 & ~x19;
  assign z04 = x02 & x00 & x01 & ~x12 & ~x09 & ~x11;
  assign z05 = x02 & x00 & x01 & x09 & x10;
  assign z07 = x00 & x02 & (~x01 | (~x12 & ~x09 & x11));
  ...
  assign z12 = ~x24 & ((~new_n67_ & x00 & x01) | (~new_n68_ & x09 & ~x00 & ~x01));
  assign new_n67_ = x10 & (x02 | ~x09);
