// Benchmark "FAU" written by ABC on Wed Jul 29 21:22:11 2020
...
module FAU ( 
  ...
  assign new_n61_ = ~x11 & x12 & ~x01 & x02;
  assign new_n62_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n64_ & new_n65_) | (x22 & new_n60_ & x21));
  assign new_n64_ = ~x11 & x12 & ~x01 & x02 & ~x14 & x15;
  assign new_n65_ = ~x13 & x16 & ~x22 & x20 & ~x21;
  assign z11 = ~x00 & ~x22 & ((new_n60_ & x21) | (new_n64_ & new_n67_ & ~x21));
