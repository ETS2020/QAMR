...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n52_, new_n56_, new_n59_, new_n60_, new_n61_, new_n63_,
  ...
  assign z04 = new_n52_ & x01 & ~x11 & ~x12 & ~x09 & x10;
  assign new_n52_ = x00 & x02;
  assign z05 = new_n52_ & x01 & x09 & x10;
  assign z07 = new_n52_ & (~x01 | (~x12 & x11 & ~x09 & x10));
  ...
  assign new_n60_ = x12 & ~x13 & ~x01 & x02;
  assign new_n61_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((x22 & new_n59_ & x21) | (new_n63_ & new_n64_ & ~x21 & ~x22));
  assign new_n63_ = x12 & ~x13 & ~x01 & x02 & ~x14 & x15;
  assign new_n64_ = x16 & x20;
  assign z11 = ((new_n59_ & x21) | (new_n63_ & new_n66_ & ~x21)) & ~x00 & ~x22;
  assign new_n66_ = ~x16 & x20;
  assign z12 = new_n69_ & ((~new_n68_ & ~x00 & ~x01) | (x00 & x01 & (~x02 | ~x10)));
