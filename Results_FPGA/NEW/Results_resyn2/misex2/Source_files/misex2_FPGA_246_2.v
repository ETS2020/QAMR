// Benchmark "FAU" written by ABC on Wed Jul 29 21:22:25 2020
...
module FAU ( 
  ...
  assign z03 = (z06 & x12) | (new_n46_ & new_n51_ & ~x17);
  ...
  assign z09 = (new_n63_ | (new_n61_ & new_n62_)) & ~x22 & ~x00 & ~x21;
  assign new_n61_ = ~x13 & ~x14 & ~x16 & x20;
  assign new_n62_ = ~x11 & x12 & ~x01 & x02;
  assign new_n63_ = x18 & ~x19 & x01 & ~x20;
  assign z10 = x22 & z16 & new_n51_ & ~x20 & x21;
  assign z16 = ~x00 & x01;
  assign z11 = ~x22 & z16 & new_n51_ & ~x20 & x21;
  assign z12 = (new_n68_ | (new_n53_ & (~x02 | ~x10))) & x09 & ~x24;
