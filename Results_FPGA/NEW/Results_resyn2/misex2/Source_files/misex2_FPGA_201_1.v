...
module FAU ( 
  ...
  assign new_n61_ = x20 & ~x14 & ~x16;
  assign new_n62_ = ~x19 & ~x20 & ~x21 & x01 & x18;
  assign z10 = ~x00 & (new_n65_ | (new_n60_ & new_n64_));
  assign new_n64_ = x15 & ~x21 & ~x14 & x16 & x20 & ~x22;
  assign new_n65_ = x18 & ~x19 & x01 & ~x20 & x21 & x22;
  assign z11 = (new_n68_ | (new_n60_ & new_n67_)) & ~x00 & ~x22;
  assign new_n67_ = x15 & ~x21 & x20 & ~x14 & ~x16;
