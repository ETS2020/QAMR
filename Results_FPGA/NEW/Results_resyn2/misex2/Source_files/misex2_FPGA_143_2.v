...
module FAU ( 
  ...
  assign z03 = new_n51_ | (new_n50_ & ~x09 & x12);
  assign new_n50_ = x00 & x01 & x11 & x02 & x10;
  assign new_n51_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = x10 & ~x12 & new_n53_ & x02 & ~x11;
  assign new_n53_ = x00 & x01;
  assign z05 = new_n53_ & x09 & x02 & x10;
  assign z06 = new_n50_ & (~x09 | ~x12);
  ...
  assign z12 = x09 & ~x24 & (new_n69_ | (new_n53_ & (~x02 | ~x10)));
