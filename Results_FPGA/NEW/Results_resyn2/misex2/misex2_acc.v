...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n52_, new_n58_, new_n61_, new_n62_,
  ...
  assign z03 = new_n50_ | (x12 & x02 & x11 & new_n51_ & new_n52_);
  assign new_n50_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign new_n51_ = x00 & x01;
  assign new_n52_ = ~x09 & x10;
  assign z04 = ~x11 & ~x12 & x02 & x10 & new_n51_ & ~x09;
  assign z05 = x02 & x10 & new_n51_ & x09;
  assign z06 = x11 & x02 & x10 & new_n51_ & ~x09;
  assign z07 = x00 & x02 & (~x01 | (new_n52_ & x11 & ~x12));
  ...
  assign z12 = (new_n69_ | (new_n51_ & (~x02 | ~x10))) & x09 & ~x24;
