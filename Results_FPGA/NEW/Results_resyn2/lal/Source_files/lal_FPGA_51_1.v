...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n51_, new_n57_, new_n63_, new_n66_, new_n67_, new_n68_;
  assign z00 = x08 & ~x16;
  ...
  assign z13 = (x17 & x19 & ~x20 & (x18 | x21)) | ~new_n57_ | (x20 & (~x19 | ~x17 | ~x18));
  assign z14 = (x21 & (~x17 | ~x19 | x20)) | ~new_n57_ | (x19 & ~x20 & x17 & x18 & ~x21);
  assign z15 = (new_n63_ & ~x22) | ~new_n57_ | (~new_n63_ & x22);
  assign new_n63_ = x19 & ~x20 & ~x21 & x17 & x18;
  assign z16 = (x23 & (~new_n63_ | x22)) | ~new_n57_ | (new_n63_ & ~x22 & ~x23);
  assign z17 = ((~new_n63_ | ~new_n66_) & x24) | ~new_n57_ | (new_n67_ & new_n68_);
  assign new_n66_ = ~x22 & ~x23;
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z18 = (~x25 & new_n67_ & new_n68_) | ~new_n57_ | (x25 & (~new_n67_ | ~new_n68_));
  assign z08 = ~z03;
  assign z02 = x16;
endmodule
