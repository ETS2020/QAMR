...
module FAU ( 
  ...
  assign z11 = (x17 | x18) & new_n58_ & (~x17 | ~x18);
  assign z12 = (x18 | x19) & new_n58_ & (~x17 | ~x18);
  assign z13 = (x20 & (~x17 | ~x18)) | ~new_n58_ | (~x20 & x17 & x18);
  assign z14 = (x21 & (x20 | ~x17 | ~x18)) | ~new_n58_ | (~x21 & ~x20 & x17 & x18);
  assign z15 = (~new_n64_ & x22) | ~new_n58_ | (new_n64_ & ~x22);
  assign new_n64_ = ~x21 & ~x20 & x17 & x18;
