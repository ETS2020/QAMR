...
module FAU ( 
  ...
  assign z10 = new_n58_ & (~x17 | ~x18);
  assign new_n58_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign z11 = new_n58_ & ~x17 & x18;
  assign z12 = new_n58_ & (~x17 | ~x19) & (x17 | x19);
  assign z13 = (x20 & (~x17 | ~x19)) | ~new_n58_ | (~x20 & x17 & x19);
  assign z14 = (x21 & (x20 | ~x17 | ~x19)) | ~new_n58_ | (~x21 & ~x20 & x17 & x19);
