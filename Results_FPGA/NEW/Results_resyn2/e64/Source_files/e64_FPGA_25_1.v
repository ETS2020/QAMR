// Benchmark "FAU" written by ABC on Thu Jul 30 00:04:56 2020
...
module FAU ( 
  ...
  assign new_n202_ = new_n196_ & new_n197_ & ~x62;
  assign new_n203_ = new_n204_ & ~x25 & ~x03 & ~x07;
  assign new_n204_ = ~x15 & ~x24 & ~x10 & ~x11 & ~x08 & ~x14;
  assign z14 = new_n206_ & ~x58 & ~x43 & x50;
  assign new_n206_ = ~x15 & ~x10 & ~x14 & ~x28 & x29;
  assign z15 = new_n177_ & ~x43 & new_n208_ & x10 & ~x58;
  assign new_n208_ = ~x14 & ~x15;
  assign z16 = new_n210_ & new_n203_ & new_n149_ & x26 & ~x28;
  assign new_n210_ = new_n211_ & new_n212_ & ~x62;
  assign new_n211_ = ~x43 & ~x46 & ~x47 & ~x50;
  assign new_n212_ = ~x60 & ~x56 & ~x58;
  assign z17 = new_n210_ & new_n214_ & new_n149_ & new_n215_ & ~x15 & ~x28;
  assign new_n214_ = x03 & ~x07 & new_n199_ & ~x08 & ~x14;
  assign new_n215_ = ~x24 & ~x25;
  assign z18 = new_n217_ & new_n196_ & x62 & ~x07 & ~x08;
  assign new_n217_ = new_n219_ & new_n218_ & new_n215_ & new_n177_;
  assign new_n218_ = ~x10 & ~x11 & ~x14 & ~x15;
  assign new_n219_ = ~x30 & ~x39 & ~x40 & ~x43;
  assign z19 = x64 & new_n230_ & new_n228_ & new_n221_ & new_n223_;
  assign new_n221_ = new_n222_ & new_n159_ & new_n157_ & new_n158_;
  assign new_n222_ = ~x14 & ~x18 & ~x15 & ~x17;
  assign new_n223_ = new_n224_ & new_n226_ & new_n227_ & new_n187_ & new_n225_ & ~x47;
  assign new_n224_ = ~x30 & ~x31;
  assign new_n225_ = ~x45 & ~x46;
  assign new_n226_ = ~x22 & ~x24 & ~x25 & ~x26 & ~x28 & x29;
  assign new_n227_ = ~x34 & ~x39 & ~x33 & ~x35;
  assign new_n228_ = new_n163_ & ~x54 & new_n229_ & ~x48 & ~x49;
  assign new_n229_ = ~x53 & ~x50 & ~x51;
  assign new_n230_ = new_n231_ & ~x57 & ~x59;
  assign new_n231_ = ~x61 & ~x62 & ~x58 & ~x60;
  assign z20 = new_n233_ & new_n235_ & x51 & new_n202_ & ~x41;
  assign new_n233_ = new_n204_ & new_n234_;
  assign new_n234_ = ~x18 & ~x22 & ~x25 & ~x26 & ~x28 & x29;
  ...
  assign z22 = new_n241_ & new_n243_ & new_n240_ & new_n221_ & ~x12;
  assign new_n240_ = new_n165_ & new_n166_;
  assign new_n241_ = new_n242_ & new_n163_ & ~x54 & new_n229_ & ~x48 & ~x49;
  assign new_n242_ = ~x45 & ~x47 & ~x43 & ~x46;
  assign new_n243_ = new_n224_ & new_n226_ & new_n227_ & new_n238_ & x36 & ~x42;
  assign z23 = new_n245_ & new_n208_ & new_n246_ & new_n247_ & new_n184_ & new_n249_;
  assign new_n245_ = ~x12 & new_n159_ & new_n157_ & new_n158_;
  assign new_n246_ = new_n153_ & ~x34 & ~x39 & ~x36 & ~x40;
  assign new_n247_ = new_n248_ & new_n191_ & new_n224_ & ~x33 & ~x35;
  assign new_n248_ = ~x18 & ~x22 & ~x21 & ~x24 & x16 & ~x17;
  assign new_n249_ = new_n164_ & ~x48 & ~x49 & ~x45 & ~x47;
  assign z24 = new_n251_ & new_n215_ & x11;
  assign new_n251_ = new_n206_ & new_n197_ & new_n252_;
  assign new_n252_ = ~x50 & ~x58 & ~x46 & ~x60;
  assign z25 = new_n251_ & x24 & ~x25;
  assign z26 = new_n255_ & new_n256_ & new_n258_ & new_n162_ & ~x47;
  assign new_n255_ = new_n160_ & ~x12 & new_n159_ & new_n157_ & new_n158_;
  assign new_n256_ = new_n257_ & new_n186_ & new_n187_;
  assign new_n257_ = ~x34 & ~x39 & ~x35 & ~x36 & ~x31 & ~x33;
  assign new_n258_ = ~x30 & x32 & new_n226_ & ~x20 & ~x21;
  assign z27 = new_n245_ & new_n162_ & new_n260_ & new_n261_ & new_n246_ & new_n262_;
  assign new_n260_ = new_n222_ & ~x16;
  assign new_n261_ = new_n226_ & ~x20 & ~x21;
  assign new_n262_ = new_n263_ & new_n224_ & ~x33 & ~x35;
  assign new_n263_ = x13 & ~x48 & ~x49 & ~x45 & ~x47;
  assign z28 = new_n252_ & x25 & new_n197_ & new_n206_;
  assign z29 = new_n197_ & new_n206_ & ~x50 & ~x58 & ~x46 & x60;
  assign z30 = new_n267_ & new_n269_ & new_n240_ & new_n221_ & ~x12;
  assign new_n267_ = new_n268_ & new_n257_ & new_n186_ & new_n187_;
  assign new_n268_ = x29 & ~x30;
  assign new_n269_ = new_n270_ & new_n154_ & x52 & new_n163_ & ~x54;
  assign new_n270_ = ~x21 & ~x24 & ~x25 & ~x22 & ~x26 & ~x28;
  assign z31 = new_n221_ & ~x12 & new_n267_ & new_n184_ & new_n272_;
  assign new_n272_ = new_n151_ & new_n154_ & x21;
  assign z32 = new_n206_ & ~x50 & ~x58 & new_n197_ & x46;
  assign z33 = x39 & ~x40 & ~x43 & new_n206_ & ~x50 & ~x58;
  assign z34 = new_n208_ & x58 & new_n177_ & ~x43;
  ...
  assign new_n279_ = new_n218_ & ~x08 & ~x06 & ~x07;
  ...
  assign new_n283_ = new_n238_ & new_n281_ & new_n235_ & new_n204_ & new_n234_;
  assign new_n284_ = ~x62 & ~x58 & ~x60;
  assign z37 = new_n255_ & new_n184_ & new_n286_ & new_n249_ & new_n270_;
  ...
  assign new_n289_ = new_n152_ & new_n218_ & new_n231_ & new_n143_ & new_n142_ & new_n278_;
  assign z39 = new_n289_ & new_n281_ & new_n163_ & x42;
  assign z40 = new_n293_ & x54 & new_n292_ & new_n227_;
  ...
  assign z42 = new_n296_ & new_n221_ & new_n223_;
  assign new_n296_ = new_n229_ & x49 & ~x54 & new_n134_ & new_n135_;
  assign z43 = new_n146_ & new_n299_ & new_n300_ & new_n298_ & new_n157_ & new_n158_;
  assign new_n298_ = new_n191_ & new_n224_ & ~x33 & ~x35;
  assign new_n299_ = new_n218_ & new_n187_ & x01 & ~x04 & ~x05;
  ...
  assign z47 = new_n306_ & new_n311_ & new_n152_ & new_n218_;
  assign new_n311_ = new_n226_ & new_n312_ & ~x41 & ~x42 & ~x30 & ~x39;
  assign new_n312_ = ~x35 & ~x40 & x17 & ~x18;
  assign z48 = new_n292_ & ~x34 & ~x35 & new_n146_ & new_n314_;
  assign new_n314_ = new_n153_ & new_n154_ & ~x39 & ~x40 & x31 & ~x33;
  assign z49 = new_n292_ & new_n227_ & new_n146_ & x53 & new_n316_ & ~x42;
  assign new_n316_ = new_n238_ & new_n281_;
  assign z50 = new_n228_ & new_n221_ & new_n223_ & new_n231_ & x57 & ~x59;
  assign z51 = new_n319_ & new_n221_ & new_n223_;
  ...
  assign new_n322_ = new_n200_ & new_n139_ & ~x18 & ~x22 & x12 & ~x17;
  assign z53 = x63 & ~x64 & new_n230_ & new_n228_ & new_n221_ & new_n223_;
  assign z54 = new_n283_ & ~x35 & ~x39 & new_n284_ & x55 & ~x56;
  assign z55 = new_n283_ & x35 & ~x39 & new_n212_ & ~x62;
  assign z56 = new_n245_ & new_n208_ & new_n327_ & new_n184_ & ~x52;
  assign new_n327_ = new_n270_ & new_n154_ & new_n186_ & new_n187_ & new_n257_ & new_n328_;
  assign new_n328_ = ~x17 & ~x18 & x29 & ~x30 & ~x16 & x20;
  assign z57 = new_n195_ & new_n330_ & new_n215_ & x18 & ~x22;
  assign new_n330_ = ~x03 & new_n218_ & ~x08 & ~x06 & ~x07;
  assign z58 = new_n237_ & new_n330_ & new_n191_ & x22 & ~x24;
  assign z59 = x40 & ~x43 & new_n206_ & ~x50 & ~x58;
  assign z60 = new_n334_ & new_n335_ & new_n219_;
  assign new_n334_ = new_n199_ & x07 & ~x08 & new_n177_ & ~x58 & ~x60;
  assign new_n335_ = new_n200_ & ~x47 & ~x50 & ~x46 & ~x56;
  assign z61 = new_n337_ & new_n149_ & new_n215_ & ~x15 & ~x28;
  assign new_n337_ = new_n212_ & new_n211_ & new_n199_ & x08 & ~x14;
  assign z62 = new_n217_ & new_n212_ & ~x50 & ~x46 & x47;
  assign z63 = new_n217_ & new_n252_ & x56;
  assign z64 = new_n197_ & new_n252_ & x30 & new_n218_ & new_n215_ & new_n177_;
  assign z05 = x29;
endmodule
