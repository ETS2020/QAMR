// Benchmark "FAU" written by ABC on Thu Jul 30 00:05:09 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n266_, new_n268_, new_n269_, new_n271_, new_n274_, new_n275_,
  ...
  assign new_n212_ = ~x37 & ~x28 & x29 & ~x15 & ~x10 & ~x14;
  ...
  assign z24 = new_n258_ & x11 & new_n260_ & new_n185_ & ~x24 & ~x25;
  assign new_n258_ = new_n217_ & new_n259_;
  assign new_n259_ = ~x46 & ~x60 & ~x50 & ~x58;
  assign new_n260_ = ~x15 & ~x10 & ~x14;
  assign z25 = new_n258_ & new_n260_ & ~x25 & ~x28 & x24 & x29;
  assign z26 = new_n176_ & new_n263_ & new_n192_ & new_n265_ & new_n264_ & new_n266_;
  assign new_n263_ = new_n157_ & ~x12 & new_n156_ & new_n154_ & new_n155_;
  assign new_n264_ = new_n194_ & new_n230_;
  assign new_n265_ = new_n254_ & new_n229_;
  assign new_n266_ = ~x20 & ~x21 & new_n174_ & x32 & ~x34;
  assign z27 = new_n161_ & new_n248_ & new_n251_ & new_n253_ & new_n268_;
  assign new_n268_ = new_n269_ & x13 & ~x20 & ~x21;
  assign new_n269_ = ~x15 & ~x17 & ~x18 & ~x14 & ~x16;
  assign z28 = new_n271_ & new_n259_ & x25;
  assign new_n271_ = new_n212_ & new_n210_ & ~x43;
  assign z29 = new_n271_ & ~x50 & ~x58 & ~x46 & x60;
  assign z30 = new_n274_ & ~x54 & new_n247_ & new_n275_ & new_n265_ & new_n276_;
  assign new_n274_ = new_n150_ & ~x58 & new_n162_ & new_n164_;
  assign new_n275_ = new_n137_ & ~x21 & ~x22;
  assign new_n276_ = new_n134_ & new_n178_ & ~x48 & ~x49 & x52 & ~x53;
  assign z31 = new_n247_ & new_n279_ & new_n233_ & new_n278_ & new_n280_ & new_n282_;
  assign new_n278_ = ~x58 & new_n162_ & new_n164_;
  assign new_n279_ = new_n228_ & new_n229_;
  assign new_n280_ = new_n281_ & new_n166_ & new_n170_;
  assign new_n281_ = ~x25 & ~x28 & ~x24 & ~x26;
  assign new_n282_ = new_n254_ & x21 & ~x22 & ~x34 & ~x35;
  assign z32 = new_n271_ & x46 & ~x50 & ~x58;
  assign z33 = x39 & ~x40 & new_n212_ & ~x50 & ~x43 & ~x58;
  assign z34 = new_n184_ & ~x43 & new_n135_ & x58;
  assign z35 = new_n136_ & new_n137_ & new_n287_ & new_n288_ & new_n289_;
  assign new_n287_ = new_n205_ & ~x03 & ~x08 & ~x06 & ~x07;
  assign new_n288_ = new_n234_ & ~x61 & ~x62 & ~x58 & ~x60;
  assign new_n289_ = new_n290_ & new_n228_ & ~x00 & x04;
  assign new_n290_ = ~x35 & ~x37 & ~x39 & ~x41 & ~x40 & ~x43;
  assign z36 = new_n238_ & new_n178_ & new_n290_ & new_n203_ & ~x55 & x61;
  assign z37 = new_n188_ & new_n263_ & new_n275_ & new_n252_ & new_n293_;
  assign new_n293_ = new_n167_ & new_n294_ & new_n166_ & x19 & ~x20;
  assign new_n294_ = ~x32 & ~x34 & ~x40 & ~x43;
  assign z38 = new_n296_ & new_n300_ & new_n178_ & new_n150_ & ~x62;
  assign new_n296_ = new_n205_ & new_n298_ & new_n299_ & new_n281_ & new_n170_ & new_n297_;
  assign new_n297_ = ~x35 & ~x37;
  assign new_n298_ = ~x04 & ~x00 & ~x03 & ~x08 & ~x06 & ~x07;
  assign new_n299_ = ~x18 & ~x22 & ~x41 & ~x39 & ~x40;
  assign new_n300_ = ~x58 & ~x60 & ~x42 & ~x43 & x59 & ~x61;
  assign z39 = new_n296_ & new_n288_ & new_n228_ & x42 & ~x43;
  assign z40 = new_n303_ & new_n305_ & new_n236_ & new_n150_ & x54;
  assign new_n303_ = new_n298_ & new_n304_ & new_n136_ & new_n137_;
  assign new_n304_ = ~x09 & ~x10 & ~x14 & ~x15 & ~x11 & ~x17;
  assign new_n305_ = new_n306_ & new_n231_ & new_n210_ & ~x43 & ~x46;
  assign new_n306_ = ~x41 & ~x42 & ~x51 & ~x47 & ~x50;
  assign z41 = new_n303_ & new_n308_ & ~x34 & ~x35 & x33 & ~x37;
  assign new_n308_ = new_n236_ & new_n197_ & new_n202_ & new_n150_ & ~x51;
  assign z42 = new_n310_ & new_n226_ & new_n227_;
  assign new_n310_ = new_n143_ & new_n146_ & ~x50 & ~x51 & x49 & ~x53;
  assign z43 = new_n227_ & new_n312_ & new_n149_ & new_n154_ & new_n155_;
  ...
  assign z45 = new_n303_ & new_n320_ & new_n190_ & new_n297_ & x34 & ~x39;
  assign new_n320_ = new_n178_ & new_n151_ & new_n150_ & ~x62;
  assign z46 = new_n308_ & new_n298_ & new_n322_ & new_n281_ & new_n170_ & new_n297_;
  assign new_n322_ = new_n323_ & ~x10 & ~x14 & x09 & ~x11;
  assign new_n323_ = ~x15 & ~x17 & ~x18 & ~x22;
  assign z47 = new_n325_ & new_n190_ & new_n230_ & new_n320_ & new_n205_ & new_n298_;
  ...
  assign z51 = new_n226_ & new_n227_ & new_n149_ & new_n313_ & x48 & ~x49;
  assign z52 = new_n274_ & ~x54 & new_n280_ & new_n332_ & new_n226_ & new_n252_;
  assign new_n332_ = new_n333_ & new_n190_ & new_n323_;
  assign new_n333_ = ~x34 & ~x37 & x12 & ~x14 & ~x35 & ~x39;
  assign z53 = x63 & ~x64 & new_n235_ & new_n233_ & new_n226_ & new_n227_;
  assign z54 = new_n203_ & x55 & new_n238_ & new_n178_ & new_n290_;
  assign z55 = new_n238_ & new_n203_ & new_n217_ & new_n178_ & x35 & ~x41;
  assign z56 = new_n275_ & new_n338_ & new_n176_ & new_n251_ & new_n135_;
  assign new_n338_ = new_n134_ & new_n339_ & new_n178_ & new_n179_ & new_n254_ & new_n229_;
  assign new_n339_ = ~x17 & ~x18 & ~x16 & x20;
  assign z57 = new_n201_ & new_n287_ & new_n137_ & x18 & ~x22;
  assign z58 = new_n242_ & new_n287_ & ~x24 & ~x26 & x22 & ~x25;
  assign z59 = x40 & new_n212_ & ~x50 & ~x43 & ~x58;
  assign z60 = new_n222_ & new_n260_ & x07 & ~x08 & ~x11;
  assign z61 = new_n219_ & new_n216_ & new_n345_ & new_n170_ & x08 & ~x10;
  assign new_n345_ = ~x25 & ~x28 & ~x58 & ~x60;
  assign z62 = new_n347_ & x47 & ~x50 & ~x60 & ~x56 & ~x58;
  assign new_n347_ = new_n223_ & ~x11 & new_n260_ & new_n185_ & ~x24 & ~x25;
  assign z63 = new_n347_ & x56 & ~x60 & ~x50 & ~x58;
  assign z64 = new_n350_ & new_n259_ & x30 & new_n210_ & ~x43;
  assign new_n350_ = ~x11 & new_n260_ & new_n185_ & ~x24 & ~x25;
  assign z05 = x29;
endmodule
