...
module FAU ( 
  ...
  assign z03 = z07 & x00;
  assign z06 = (new_n32_ | (new_n35_ & (new_n33_ | new_n34_))) & ~x03 & x04;
  assign new_n32_ = ~x13 & x02 & ~x05;
  assign new_n33_ = x00 & ((x01 & ~x11) | (~x09 & ~x01 & x13));
  assign new_n34_ = ~x00 & ((x01 & ~x10) | (~x08 & ~x01 & x13));
  assign new_n35_ = ~x07 & ~x12 & ~x02 & x05;
  assign z08 = ~x03 & x04 & (x13 ? (~x12 & ~x02 & x05) : (x02 & ~x05));
  assign z09 = x06 & x13;
