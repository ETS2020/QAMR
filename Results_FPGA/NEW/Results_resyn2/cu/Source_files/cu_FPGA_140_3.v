// Benchmark "FAU" written by ABC on Wed Jul 29 19:15:14 2020
...
module FAU ( 
  ...
  assign z06 = ~x03 & x04 & (new_n34_ | (~new_n35_ & new_n36_ & ~new_n37_));
  assign new_n34_ = ~x13 & x02 & ~x05;
  assign new_n35_ = (x09 | x01 | x07) & x00 & (~x01 | x11);
  assign new_n36_ = ~x02 & x05 & ~x12 & x13;
  assign new_n37_ = (x08 | x01 | x07) & ~x00 & (~x01 | x10);
  assign z08 = ~x03 & x04 & (new_n34_ | new_n36_);
  assign z09 = x06 & x13;
