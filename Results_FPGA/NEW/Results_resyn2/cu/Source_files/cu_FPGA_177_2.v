...
module FAU ( 
  ...
  assign z02 = new_n29_ & ~x01 & ~x00 & x05;
  assign new_n29_ = ~x02 & ~x04 & ~x03 & ~x13;
  assign z03 = ~x01 & new_n29_ & x00;
  assign z04 = new_n29_ & x01 & ~x00 & x05;
  assign z05 = x01 & new_n29_ & x00;
  assign z06 = (new_n34_ | (new_n37_ & (new_n35_ | new_n36_))) & ~x03 & x04;
  assign new_n34_ = ~x13 & x02 & ~x05;
  assign new_n35_ = (x01 | ~x08) & ~x00 & x05 & (~x01 | ~x10);
  assign new_n36_ = (~x01 | ~x11) & x00 & (x01 | ~x09);
  assign new_n37_ = ~x12 & x13 & ~x02 & ~x07;
  assign z07 = new_n29_ & (x00 | x05);
