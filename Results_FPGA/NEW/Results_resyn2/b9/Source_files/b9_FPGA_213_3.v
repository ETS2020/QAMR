...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & ~new_n69_ & ~x30);
  ...
  assign z10 = new_n82_ | (~x04 & ((new_n80_ & (new_n69_ | x30)) | (new_n69_ & new_n81_)));
  ...
  assign z13 = (x27 & ((~new_n89_ & new_n90_) | (~new_n65_ & new_n91_))) | (new_n90_ & x30);
  assign new_n89_ = x28 & (~x35 | ~x36);
  assign new_n90_ = ~x13 & ~x04 & x39 & x40;
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n91_ & (~new_n90_ | new_n93_)) | new_n94_ | (~new_n90_ & (new_n65_ | ~x27));
  assign new_n93_ = ~x30 & x28 & (~x35 | ~x36);
  assign new_n94_ = ~x30 & ((~x27 & ~x32) | (~x37 & x28 & ~x35));
