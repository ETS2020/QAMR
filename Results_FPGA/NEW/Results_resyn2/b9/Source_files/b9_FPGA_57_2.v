...
module FAU ( 
  ...
  assign new_n65_ = (x35 | x36) & ~x04 & x39;
  assign new_n66_ = ~x37 & (~x28 | ~x35);
  assign new_n67_ = x10 & ~x04 & x39;
  ...
  assign new_n81_ = x05 & (x30 | x32) & x39 & x40;
  ...
  assign z12 = (~x27 | (new_n66_ & (~new_n65_ | ~x40))) & (~new_n67_ | ~x40);
  ...
  assign z14 = (~new_n91_ & (~new_n90_ | (new_n70_ & new_n89_))) | (~new_n94_ & (~new_n90_ | (new_n70_ & ~new_n95_)));
