...
module FAU ( 
  ...
  wire new_n65_, new_n68_, new_n70_, new_n76_, new_n79_, new_n80_, new_n82_,
    new_n83_, new_n85_, new_n87_, new_n88_, new_n90_, new_n95_;
  ...
  assign z11 = new_n83_ & ((x27 & (x04 | x28)) | new_n82_ | (~x08 & ~x27));
  assign new_n82_ = (~x35 | (~x27 & x28)) & (~x29 | ~x39 | ~x40);
  assign new_n83_ = ~x09 & ~x30;
  assign z12 = new_n85_ | (~x27 & (~x39 | ~x40)) | (x40 & (x04 | ~x10));
  assign new_n85_ = ~x37 & ((~x28 & ~x40) | (x27 & ~x35));
  assign z13 = (new_n87_ & ~x04 & ~x13) | (new_n65_ & new_n88_);
  assign new_n87_ = x39 & x40 & (x30 | x32);
  assign new_n88_ = x20 & ~x18 & ~x19;
  assign z14 = new_n85_ | (x40 & (x04 | x13)) | new_n90_ | (~new_n88_ & ~x40);
  assign new_n90_ = ~x27 & (~x39 | ~x40 | (~x30 & ~x32));
  assign z15 = x12 & x26 & x27 & x34;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z18 = (x08 & (new_n95_ | (new_n68_ & ~x27))) | ~new_n83_ | (new_n68_ & ~x04 & x27);
  assign new_n95_ = x29 & x39 & x40;
  assign z20 = new_n83_ & (new_n82_ | (~x08 & ~x27));
  assign z19 = new_n83_ & ((x27 & (x04 | x28)) | new_n82_ | (~x08 & ~x27));
endmodule
