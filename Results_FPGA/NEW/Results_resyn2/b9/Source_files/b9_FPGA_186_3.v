// Benchmark "FAU" written by ABC on Thu Jul 30 01:05:14 2020
...
module FAU ( 
  ...
  assign z06 = (~x27 | ~x28) & (~x37 | ((~new_n77_ | x27 | ~x39) & ~x28 & x40));
  ...
  assign z10 = new_n84_ | (new_n83_ & ((~new_n70_ & z08) | (new_n69_ & (z08 | x07))));
  ...
  assign z12 = (~x10 | ~x40 | x04 | ~x39) & (~new_n90_ | (~new_n89_ & (~x40 | x04 | ~x39)));
  assign new_n89_ = (x37 | (x28 & x35)) & (~x40 | (x28 & x35));
  assign new_n90_ = x27 & (x35 | x36 | x10 | ~x40);
  ...
  assign z14 = ((~new_n93_ | new_n97_) & (~new_n89_ | ~x27)) | (~new_n94_ & (~new_n93_ | new_n98_));
  assign new_n97_ = (~x27 | x28) & ~x30 & ~x32;
  assign new_n98_ = ~x30 & ~x32 & x28 & ~x36;
