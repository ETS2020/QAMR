...
module FAU ( 
  ...
  assign z11 = (new_n79_ | ~x08) & new_n80_ & ~new_n81_;
  assign new_n79_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n80_ = ~x09 & ~x30;
  assign new_n81_ = ~x40 & ~x04 & x27 & ~x28 & x35;
  assign z13 = ~z12 & x20 & ~x18 & ~x19;
  assign z15 = x12 & x26 & x27 & x34;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z18 = (x08 & (new_n87_ | (new_n67_ & ~x27))) | ~new_n80_ | (new_n67_ & ~x04 & x27);
  assign new_n87_ = x29 & x39 & x40;
  assign z20 = (~x08 | (~new_n87_ & (x28 | ~x35))) & new_n80_ & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z14 = z12 | ~x20 | x18 | x19;
  assign z19 = (new_n79_ | ~x08) & new_n80_ & ~new_n81_;
endmodule
