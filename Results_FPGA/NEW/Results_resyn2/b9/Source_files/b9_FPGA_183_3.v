...
module FAU ( 
  ...
  assign new_n83_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  ...
  assign z14 = (~new_n94_ & (~new_n91_ | new_n95_)) | ((~new_n91_ | new_n96_) & (new_n65_ | ~x27));
  ...
  assign z18 = ~new_n83_ | x30 | (new_n101_ & (new_n85_ | ~x27));
  assign new_n101_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign z20 = ~new_n101_ & new_n103_ & (~x35 | (~x27 & (~x09 | x28)));
  assign new_n103_ = ~x30 & (~x09 | (~x39 & x40));
  assign z05 = ~z06;
