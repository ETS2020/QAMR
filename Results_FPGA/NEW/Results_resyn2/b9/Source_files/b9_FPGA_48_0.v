...
module FAU ( 
  ...
  assign z12 = new_n88_ | (~new_n87_ & (new_n65_ | ~x27));
  assign new_n87_ = ~x04 & x39 & x40;
  assign new_n88_ = ~x10 & ((~x37 & ~x35 & ~x36) | (~x27 & x40));
  assign z13 = (new_n92_ & x27) | (new_n91_ & ((~new_n90_ & x27) | (~new_n70_ & x40)));
  assign new_n90_ = (x32 | ~x35 | ~x36) & (x28 | ~x40);
  assign new_n91_ = x39 & ~x04 & ~x13;
  assign new_n92_ = x20 & ~x18 & ~x19 & (x37 | (x28 & x35));
  assign z14 = (~x27 | (~new_n92_ & (new_n94_ | ~new_n87_ | x13))) & (~new_n87_ | new_n70_ | x13);
