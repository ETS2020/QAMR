...
module FAU ( 
  ...
  assign z12 = new_n87_ | (~new_n86_ & (new_n65_ | ~x27));
  assign new_n86_ = ~x04 & x39 & x40;
  assign new_n87_ = ~x10 & ((~x37 & ~x35 & ~x36) | (~x27 & x40));
  assign z14 = (~x27 | (~new_n90_ & (~new_n86_ | new_n89_))) & (~new_n86_ | (~x30 & ~x32));
  ...
  assign z05 = ~z06;
  assign z13 = (x27 & (new_n90_ | (new_n86_ & ~new_n89_))) | (new_n86_ & (x30 | x32));
