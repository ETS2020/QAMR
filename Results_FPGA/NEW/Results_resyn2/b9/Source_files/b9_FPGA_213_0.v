...
module FAU ( 
  ...
  assign z10 = new_n82_ | (new_n81_ & ((z08 & (new_n69_ | ~new_n70_)) | (new_n69_ & x07)));
  ...
  assign z12 = new_n87_ | (~new_n88_ & (~z08 | x04));
  assign new_n87_ = ~x10 & ((~x37 & ~x35 & ~x36) | (~x27 & x40));
  assign new_n88_ = x27 & (x37 | (x28 & x35));
  assign z13 = (new_n88_ & new_n90_) | (new_n92_ & (new_n91_ | (~new_n70_ & x40)));
  assign new_n90_ = x20 & ~x18 & ~x19;
  assign new_n91_ = x27 & ((~x28 & x40) | (~x32 & x35 & x36));
  assign new_n92_ = x39 & ~x04 & ~x13;
  assign z14 = (~new_n90_ & (~new_n94_ | new_n95_)) | (~new_n88_ & (~new_n94_ | new_n96_));
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = (~x35 | ~x36) & x28 & ~x30 & ~x32;
  assign new_n96_ = (~x27 | x28) & ~x30 & ~x32;
