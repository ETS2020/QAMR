...
module FAU ( 
  ...
  assign z14 = (new_n70_ | ~new_n90_) & (~x27 | (~new_n91_ & (new_n89_ | ~new_n90_)));
  assign new_n89_ = x28 & (~x35 | ~x36);
  assign new_n90_ = x39 & ~x04 & ~x13;
  assign new_n91_ = x20 & ~x18 & ~x19 & (x37 | (x28 & x35));
  assign z15 = x12 & x26 & x27 & x34;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z20 = ~new_n85_ & ~x09 & ~x30 & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z13 = (~new_n70_ & new_n90_) | (x27 & (new_n91_ | (~new_n89_ & new_n90_)));
