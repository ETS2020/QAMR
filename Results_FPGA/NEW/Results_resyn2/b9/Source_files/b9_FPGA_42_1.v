// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:18 2020
...
module FAU ( 
  ...
  assign z13 = (x27 & (new_n91_ | (~new_n89_ & new_n90_))) | (new_n90_ & (x30 | x32));
  assign new_n89_ = x28 & (~x35 | ~x36);
  assign new_n90_ = ~x13 & ~x04 & x39 & x40;
  assign new_n91_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n93_ & (~new_n90_ | new_n94_)) | ~x20 | (~new_n87_ & (~new_n90_ | new_n95_));
