// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:39 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n77_, new_n80_,
    new_n81_, new_n82_, new_n86_, new_n87_, new_n88_;
  ...
  assign z14 = (~x27 | (~new_n88_ & (new_n86_ | ~new_n87_))) & (~new_n87_ | (~x30 & ~x32));
  ...
  assign z05 = ~z06;
  assign z13 = (x27 & (new_n88_ | (~new_n86_ & new_n87_))) | (new_n87_ & (x30 | x32));
