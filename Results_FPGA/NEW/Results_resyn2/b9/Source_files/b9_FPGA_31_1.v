// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:13 2020
...
module FAU ( 
  ...
  assign new_n65_ = ((~x35 & ~x36) | x04 | ~x40) & ~x37 & (~x28 | ~x35);
  assign new_n66_ = x10 & ~x04 & x40;
  assign z01 = ~x04 | ((new_n68_ | ~x27) & ~x30 & ~x32);
  assign new_n68_ = ~x36 & (x28 | ~x35);
  assign z02 = new_n70_ | ~x40 | (~x02 & (~x08 | ~x29));
