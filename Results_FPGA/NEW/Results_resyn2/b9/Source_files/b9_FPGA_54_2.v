// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:22 2020
...
module FAU ( 
  ...
  assign z10 = new_n82_ | (~x04 & (new_n80_ | (new_n69_ & new_n81_)));
  assign new_n80_ = x05 & x39 & (x32 | (x30 & x40));
  ...
  assign new_n85_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n87_ | ((~z08 | x04) & (new_n65_ | ~x27));
  assign new_n87_ = ~x10 & ((~x37 & ~x35 & ~x36) | (~x27 & x40));
  assign z13 = new_n92_ | (x27 & ((~new_n89_ & new_n90_) | (~new_n65_ & new_n91_)));
  assign new_n89_ = x28 & (~x35 | ~x36);
  assign new_n90_ = x39 & x40 & ~x04 & ~x13;
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = ~x04 & ~x13 & x39 & (x32 | (x30 & x40));
  assign z14 = (~new_n91_ & (~new_n90_ | new_n94_)) | ((~new_n90_ | new_n95_) & (new_n65_ | ~x27));
  assign new_n94_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n95_ = (~x27 | x28) & ~x30 & ~x32;
