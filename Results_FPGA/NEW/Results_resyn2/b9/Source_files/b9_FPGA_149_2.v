// Benchmark "FAU" written by ABC on Thu Jul 30 01:05:00 2020
...
module FAU ( 
  ...
  assign z10 = new_n83_ | (~x04 & ((new_n81_ & (new_n69_ | ~new_n70_)) | (new_n69_ & new_n82_)));
  assign new_n81_ = x05 & x39;
  assign new_n82_ = x07 & (~x39 | ~x40);
  assign new_n83_ = x37 & x06 & x27;
  assign z11 = new_n86_ & (~new_n85_ | (x27 & (~z08 | ~x29)));
  assign new_n85_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n86_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n88_ | ((~z08 | x04) & (new_n65_ | ~x27));
  assign new_n88_ = ~x10 & ((~x37 & ~x35 & ~x36) | (~x27 & x40));
  assign z13 = (~new_n70_ & new_n91_) | (x27 & ((~new_n65_ & new_n92_) | (~new_n90_ & new_n91_)));
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign new_n91_ = ~x13 & ~x04 & x39 & x40;
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n92_ & (~new_n91_ | new_n94_)) | ((~new_n91_ | new_n95_) & (new_n65_ | ~x27));
