...
module FAU ( 
  ...
  assign z10 = new_n82_ | (x27 & ((~new_n80_ & new_n81_) | (x06 & x37)));
  assign new_n80_ = x40 & (x04 | (~x05 & x39));
  assign new_n81_ = (x36 | (~x28 & x35)) & (x07 | (x39 & x40));
  assign new_n82_ = x05 & (x30 | x32) & ~x04 & x39 & x40;
  assign z11 = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39)));
  ...
  assign z13 = new_n92_ | (x27 & ((~new_n65_ & new_n91_) | (~new_n89_ & new_n90_)));
  assign new_n89_ = x28 & (~x35 | ~x36);
  assign new_n90_ = ~x13 & ~x04 & x39 & x40;
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = ~x13 & (x30 | x32) & ~x04 & x39 & x40;
  ...
  assign z05 = ~z06;
  assign z19 = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39)));
endmodule
