...
module FAU ( 
  ...
  assign new_n65_ = (new_n66_ | ~x27) & (~x10 | ~x40 | x04 | ~x39);
  ...
  assign new_n80_ = ~x04 & ((x05 & ~new_n69_ & z08) | (new_n68_ & (~z08 | x05) & (z08 | x07)));
  assign z11 = new_n83_ & (~new_n82_ | (x27 & (~z08 | ~x29)));
  assign new_n82_ = x08 & ((~x28 & x35) | (z08 & x29));
  assign new_n83_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n86_ | ((~x40 | x04 | ~x39) & (~x27 | (new_n85_ & (x04 | ~x39))));
  assign new_n85_ = ~x37 & (~x28 | ~x35);
  assign new_n86_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = new_n88_ | (~new_n69_ & z08 & ~x04 & ~x13);
  assign new_n88_ = x27 & (new_n90_ | (new_n89_ & (~x28 | (x35 & x36))));
  assign new_n89_ = ~x04 & ~x13 & x39 & x40;
  assign new_n90_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n92_ | ~new_n94_ | (~x27 & (new_n69_ | ~new_n89_));
  assign new_n92_ = ~new_n93_ & (~x20 | x18 | x19);
  assign new_n93_ = x40 & (x30 | x32 | ~x28 | (x35 & x36));
  assign new_n94_ = ~new_n95_ & (new_n90_ | (x39 & ~x04 & ~x13));
  assign new_n95_ = ~x30 & ~x32 & ~x37 & x28 & ~x35;
  assign z15 = x12 & x26 & x27 & x34;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z20 = ~new_n82_ & ~x09 & ~x30 & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z18 = ~new_n83_ | (new_n82_ & (~x27 | (z08 & x29)));
  assign z19 = new_n83_ & (~new_n82_ | (x27 & (~z08 | ~x29)));
endmodule
