// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:50 2020
...
module FAU ( 
  ...
  assign z10 = new_n83_ | (~x04 & (new_n82_ | (~new_n80_ & new_n81_)));
  assign new_n80_ = ~x36 & (x28 | (~x35 & x40));
  assign new_n81_ = x27 & ((x39 & x40) ? x05 : x07);
  assign new_n82_ = x05 & (x30 | x32) & x39 & x40;
  assign new_n83_ = x37 & x06 & x27;
  assign z11 = (new_n85_ | (~new_n86_ & ~new_n87_)) & ~x09 & ~x30;
  assign new_n85_ = ~x35 & (~x08 | ~x29 | ~x39);
  assign new_n86_ = x08 & ((~x27 & ~x28) | (x29 & x39 & x40));
  assign new_n87_ = ~x04 & x27 & ~x28;
  assign z12 = ~new_n89_ & (new_n90_ | x04 | ~x39);
  assign new_n89_ = x27 & (x37 | (x28 & x35));
  assign new_n90_ = (~x10 | (~x40 & (~x27 | ~x28))) & (~x27 | ((~x40 | (~x35 & ~x36)) & (~x28 | ~x36)));
  assign z13 = new_n95_ | (x27 & ((~new_n65_ & new_n94_) | (~new_n92_ & new_n93_)));
  ...
  assign z14 = (~new_n94_ & (~new_n93_ | new_n97_)) | (~new_n89_ & (new_n98_ | ~new_n99_));
  assign new_n97_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n98_ = (~x27 | x28) & ~x30 & ~x32;
  assign new_n99_ = (x40 | (x27 & x28)) & x39 & ~x04 & ~x13;
  ...
  assign new_n105_ = ~x09 & ~x30 & (~x35 | x04 | ~x27 | x28);
  assign z20 = (new_n107_ | ~new_n108_) & ~x09 & ~x30;
  assign new_n107_ = (~x29 | ~x39) & (~x35 | (~x27 & x28));
  assign new_n108_ = (x40 | x27 | ~x28) & (x08 | (x27 & x35));
  assign z05 = ~z06;
  assign z19 = (new_n85_ | (~new_n86_ & ~new_n87_)) & ~x09 & ~x30;
endmodule
