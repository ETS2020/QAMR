// Benchmark "FAU" written by ABC on Thu Jul 30 01:05:21 2020
...
module FAU ( 
  ...
  assign z00 = ~x16 | (~x15 & (new_n65_ | (new_n67_ & x10)));
  ...
  assign z07 = ((x00 & ~x25) | (~x14 & x25) | ~x38) & x03 & (new_n78_ | ~x14);
  assign new_n78_ = (x15 | ~x17) & ~x31 & ~x33;
  assign z09 = x11 & x26 & x27 & x34;
  assign z10 = new_n81_ | (x37 & x06 & x27);
  assign new_n81_ = (z08 | (new_n69_ & x07)) & (new_n69_ | ~new_n70_) & ~x04 & (~z08 | x05);
  assign z11 = new_n84_ & (~new_n83_ | (x27 & (~z08 | ~x29)));
  assign new_n83_ = x08 & ((~x28 & x35) | (z08 & x29));
  assign new_n84_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = (~x10 & (new_n86_ | (~x27 & x40))) | (~new_n67_ & (new_n66_ | ~x27));
  assign new_n86_ = ~x37 & ~x35 & ~x36;
  assign z13 = (x27 & (new_n88_ | (~new_n89_ & new_n90_))) | (~new_n70_ & new_n90_);
  assign new_n88_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n89_ = x28 & (~x35 | ~x36);
  assign new_n90_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = new_n93_ | new_n94_ | (~new_n92_ & (x18 | x19 | ~x20));
  assign new_n92_ = (~new_n70_ | ~new_n89_) & x39 & ~x04 & ~x13;
  assign new_n93_ = ~new_n90_ & (new_n66_ | ~x27 | (~x40 & (x18 | ~x20)));
  assign new_n94_ = new_n70_ & (~x27 | (~x37 & x28 & ~x35));
