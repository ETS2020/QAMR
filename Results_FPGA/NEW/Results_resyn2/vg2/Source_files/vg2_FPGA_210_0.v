...
module FAU ( 
  ...
  assign z4 = ~new_n65_ | (~new_n70_ & x24 & (x05 | x13));
  assign new_n65_ = (new_n66_ | (~new_n68_ & x08)) & (new_n67_ | (~new_n69_ & ~x08));
  assign new_n66_ = (~new_n56_ | x24) & (~x15 | ((x05 | x13) & (x24 | ~x05 | ~x13)));
  assign new_n67_ = (~new_n37_ | x24) & (~x19 | ((x05 | x13) & (x24 | ~x05 | ~x13)));
  assign new_n68_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n70_ = (~x18 | (~new_n68_ & x08)) & (~x07 | ~x08) & (~new_n69_ | x18);
  assign z6 = ~new_n72_ | (~new_n75_ & x24 & (x05 | x13));
  assign new_n72_ = (new_n66_ | new_n73_) & (new_n67_ | (~new_n74_ & ~x03));
  assign new_n73_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n74_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n75_ = (~x03 | ~x07) & (~new_n74_ | x18) & (new_n73_ | ~x18);
endmodule
