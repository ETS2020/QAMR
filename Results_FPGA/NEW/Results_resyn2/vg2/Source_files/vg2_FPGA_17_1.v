// Benchmark "FAU" written by ABC on Wed Jul 29 20:31:58 2020
...
module FAU ( 
  ...
  assign new_n59_ = new_n60_ & x01 & x03 & x06 & x20;
  assign new_n60_ = x11 & x14;
  assign z3 = (~new_n62_ & ~x24) | (~new_n64_ & x24 & (x05 | x13)) | (~new_n66_ & ~x05 & ~x13);
  assign new_n62_ = (new_n45_ | ~new_n63_) & (~new_n59_ | new_n43_ | ~x08);
  assign new_n63_ = new_n48_ & ~x20 & ~x11 & ~x14;
  assign new_n64_ = (~new_n63_ | ~x07) & (~new_n65_ | ~new_n60_ | ~x18 | ~x20);
  assign new_n65_ = x01 & x03 & x06 & x08;
  assign new_n66_ = (~new_n63_ | ~x19) & (~new_n65_ | ~new_n60_ | ~x15 | ~x20);
