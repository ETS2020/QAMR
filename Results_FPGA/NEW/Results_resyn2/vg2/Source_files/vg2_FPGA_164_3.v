// Benchmark "FAU" written by ABC on Wed Jul 29 20:32:32 2020
...
module FAU ( 
  ...
  wire new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n45_, new_n46_,
    ...
    new_n55_, new_n57_, new_n58_, new_n60_, new_n61_;
  ...
  assign new_n46_ = x01 & x03 & x06 & x20 & x11 & x14;
  assign z3 = (~new_n48_ & ~x24) | (~new_n51_ & x24 & (x05 | x13)) | (~new_n54_ & ~x05 & ~x13);
  assign new_n48_ = (new_n49_ | ~new_n46_ | ~x08) & (new_n50_ | ~new_n38_ | x08);
  assign new_n49_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n50_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n51_ = (~new_n38_ | ~x07 | x08) & (~new_n52_ | ~new_n53_);
  assign new_n52_ = x01 & x03 & x06 & x08;
  assign new_n53_ = x11 & x14 & x18 & x20;
  assign new_n54_ = (~new_n52_ | ~new_n55_) & (~new_n38_ | x08 | ~x19);
