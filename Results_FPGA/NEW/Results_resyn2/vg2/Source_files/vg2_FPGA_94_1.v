...
module FAU ( 
  ...
  assign new_n43_ = new_n44_ & x14 & x16 & x22 & x23;
  assign new_n44_ = x01 & x04 & x06 & x08;
  ...
  assign new_n49_ = new_n43_ & new_n48_ & x18 & x17 & x20;
  ...
  assign new_n54_ = (~new_n43_ | ~new_n55_) & (~new_n56_ | ~new_n47_ | ~new_n53_ | x04);
  ...
  assign new_n60_ = x11 & x14 & x20;
  assign z3 = new_n62_ | new_n65_ | new_n66_;
  assign new_n62_ = ~x24 & ((~new_n41_ & new_n63_) | (new_n64_ & ~new_n46_));
  assign new_n63_ = new_n60_ & x01 & x03 & x06 & x08;
  assign new_n64_ = new_n53_ & ~x08 & new_n52_ & ~x11 & ~x14;
  assign new_n65_ = ~new_n57_ & x24 & ((new_n63_ & x18) | (new_n64_ & x07));
  assign new_n66_ = new_n57_ & ((new_n63_ & x15) | (new_n38_ & ~x08 & x19));
