...
module FAU ( 
  ...
  assign z4 = new_n65_ | (~new_n67_ & (new_n69_ | ~x08)) | (~new_n68_ & (new_n66_ | x08));
  assign new_n65_ = new_n53_ & (x18 | (x07 & (new_n66_ | x08)));
  ...
  assign z6 = (new_n53_ & (x18 | (~new_n72_ & x07))) | new_n71_ | (~new_n68_ & ~new_n72_);
  assign new_n71_ = ~new_n67_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
