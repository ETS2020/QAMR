...
module FAU ( 
  ...
  assign new_n42_ = ~new_n46_ & (~new_n43_ | new_n51_ | x09 | x06 | x08);
  ...
  assign new_n53_ = new_n48_ & x11 & new_n54_ & x18 & x14 & x16;
  ...
  assign new_n57_ = new_n48_ & x11 & new_n54_ & x15 & x14 & x16;
  ...
  assign z3 = (~new_n64_ & x24 & (x05 | x13)) | (~new_n66_ & ~x05 & ~x13) | (~new_n67_ & ~x24);
  assign new_n64_ = (~new_n65_ | ~x18) & (~new_n38_ | ~x07 | ~new_n40_ | x08);
  assign new_n65_ = new_n62_ & x06 & x08;
  assign new_n66_ = (~new_n65_ | ~x15) & (~new_n40_ | ~new_n39_ | ~new_n58_);
  assign new_n67_ = (~new_n65_ | new_n47_) & (new_n51_ | ~new_n38_ | ~new_n40_ | x08);
  assign z4 = (z5 & (x08 | (~new_n69_ & ~x16))) | (z7 & (~x08 | (~new_n70_ & x16)));
  assign new_n69_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n70_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n75_ & x24 & (x05 | x13)) | ~new_n72_ | (~new_n77_ & ((~x05 & ~x13) | (~x24 & x05 & x13)));
  assign new_n72_ = ~new_n73_ & (~z5 | (~x03 & (~new_n39_ | ~x20)));
  assign new_n73_ = ~new_n74_ & ~x24 & ~x02 & ~x10;
  assign new_n74_ = (~x06 | x11) & (~x21 | (x03 & ~x11));
  assign new_n75_ = (new_n76_ | ~x18) & (~x07 | ~x06 | x11);
  assign new_n76_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n77_ = (new_n76_ | ~x15) & (~x19 | ~x06 | x11);
endmodule
