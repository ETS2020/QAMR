...
module FAU ( 
  ...
  assign new_n61_ = (~x15 | ~x17 | ~x18 | ~x14 | x19) & ((~x15 & (~x10 | ~x17 | ~x18)) | ~x19 | (x15 & x17 & x18));
  assign new_n62_ = (x17 | (x12 & x18)) & x16 & (x13 | x18);
  assign new_n63_ = x16 & (new_n65_ | (~new_n64_ & x15));
  assign new_n64_ = (~x17 | ((~x18 | ~x14 | x19) & (~x19 | ~x13 | x18))) & (~x12 | ~x18 | x17 | ~x19);
  assign new_n65_ = ~x15 & x19 & x10 & x17 & x18;
  assign z9 = x00 & ~x26 & ((~new_n67_ & new_n69_) | new_n71_ | new_n73_);
  assign new_n67_ = ~x33 & (~new_n68_ | ~x16 | (~new_n65_ & (new_n64_ | ~x15)));
  ...
  assign new_n72_ = x16 & x30 & x31 & ~x33;
