...
module FAU ( 
  ...
  assign new_n48_ = ~new_n49_ & (new_n51_ | x05) & (new_n52_ | x06);
  assign new_n49_ = (x01 | ((x02 | x03) & ((~x02 & x06) | (~x03 & x05)))) & new_n50_ & ((~x02 & ~x03) | ~x01 | (x02 & x03));
  assign new_n50_ = x04 ^ ~x07;
  assign new_n51_ = ((x07 & (x02 | ~x06)) | (~x02 & ~x07) | x01 | ~x04) & ((~x07 & (x02 | ~x06)) | x03 | x04 | (~x02 & x07));
  assign new_n52_ = ((x07 & (x03 | ~x05)) | x01 | ~x04 | (~x03 & ~x07)) & ((~x07 & (x03 | ~x05)) | x02 | x04 | (~x03 & x07));
  assign new_n53_ = ((~x02 & ~x03) | ~x01 | (x02 & x03)) & (x01 | ((x02 | ~x06 | x03 | ~x05) & (~x02 | ~x03) & (x05 | x06)));
  assign z3 = new_n55_ & ~x27;
  assign new_n55_ = new_n57_ & (~new_n56_ | (~x16 & ~x21) | (~x19 & ~x24));
  assign new_n56_ = (x17 | x22) & (x18 | x23) & (x15 | x20);
  assign new_n57_ = x25 & ~x26 & x01 & (~x02 | ~x03);
  ...
  assign new_n74_ = ((~x33 & (~new_n69_ | ~x30 | ~x31)) | ~new_n72_ | (x31 & x33)) & (new_n75_ | ~x33) & (new_n72_ | ((~x31 | ~x33) & (~new_n69_ | x33 | x30 | x31)));
  assign new_n75_ = ~new_n76_ & new_n77_ & (~new_n65_ | (x14 & ~x19)) & (new_n65_ | x19);
  assign new_n76_ = (~x17 | ~x18 | ~x10 | ~x16) & (~x15 | (~x16 & (~x11 | ~x17 | ~x18)));
