// Benchmark "FAU" written by ABC on Wed Jul 29 23:27:08 2020
...
module FAU ( 
  ...
  assign z8 = new_n58_ & (x32 | (new_n59_ & new_n66_));
  assign new_n58_ = (~new_n59_ | ~new_n61_ | new_n64_ | new_n65_) & x00 & ~x26;
  assign new_n59_ = x31 & (new_n60_ | x30) & (~new_n60_ | ~x30);
  ...
  assign z9 = x00 & (new_n69_ | new_n70_ | (x33 & (~new_n71_ | new_n73_)));
  assign new_n69_ = (x33 | (new_n66_ & ~x26 & ~x30 & ~x31)) & ~new_n60_ & (x31 | ~x33);
  assign new_n70_ = new_n60_ & ((~x31 & x33) | (new_n66_ & ~x26 & ~x33 & x30 & x31));
  assign new_n71_ = new_n72_ & (x17 | (x12 & x18)) & (~new_n62_ | ~x19) & (new_n62_ | x19);
  assign new_n72_ = (~x30 ^ x31) & (x14 | x19) & (x13 | x18);
