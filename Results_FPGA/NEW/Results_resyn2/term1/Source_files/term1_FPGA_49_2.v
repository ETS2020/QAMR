...
module FAU ( 
  ...
  assign new_n61_ = (~x15 | ~x16 | ~x17 | ~x14 | x19) & ((~x15 & (~x10 | ~x16 | ~x17)) | ~x19 | (x15 & x16 & x17));
  assign new_n62_ = (x16 | (x11 & x17)) & x18 & (x12 | x17);
  assign new_n63_ = x18 & (new_n65_ | (~new_n64_ & x15));
  assign new_n64_ = (~x16 | ((~x17 | ~x14 | x19) & (~x19 | ~x12 | x17))) & (~x11 | ~x17 | x16 | ~x19);
  assign new_n65_ = ~x15 & x19 & x10 & x16 & x17;
  assign z9 = x00 & ~x26 & ((~new_n67_ & new_n69_) | new_n71_ | new_n73_);
  assign new_n67_ = ~x33 & (~new_n68_ | ~x18 | (~new_n65_ & (new_n64_ | ~x15)));
  ...
  assign new_n72_ = x18 & x30 & x31 & ~x33;
