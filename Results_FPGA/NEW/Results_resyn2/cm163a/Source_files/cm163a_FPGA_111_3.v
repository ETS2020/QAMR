// Benchmark "FAU" written by ABC on Wed Jul 29 23:01:41 2020
...
module FAU ( 
  ...
  assign new_n27_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x11 | x12 | (x09 & ~x13));
  assign z3 = ~x05 | (~x04 & ~x07) | ((~new_n29_ | (~x09 & ~x13)) & x04 & (new_n29_ | x13));
