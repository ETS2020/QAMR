// Benchmark "FAU" written by ABC on Wed Jul 29 23:00:49 2020
...
module FAU ( 
  ...
  assign new_n27_ = (~x12 | (~x11 & ~x09 & x02 & x03)) & (x09 | ~x02 | ~x03 | x11 | x12);
  assign z3 = (~new_n29_ & x04) | ~x05 | (~x04 & ~x07);
  assign new_n29_ = (x13 | ~x02 | ~x03 | x11 | x12) & ~x09 & (~x13 | (x02 & x03 & ~x11 & ~x12));
