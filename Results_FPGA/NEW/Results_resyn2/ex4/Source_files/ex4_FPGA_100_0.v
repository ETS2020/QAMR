// Benchmark "FAU" written by ABC on Thu Jul 30 10:35:00 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (~new_n180_ | (~x005 & (new_n188_ | (~new_n174_ & x053))));
  assign new_n174_ = (~x077 | (new_n175_ & ~new_n177_)) & (new_n178_ | (x029 & (new_n179_ | ~x077)));
  assign new_n175_ = new_n176_ & x085 & ((x109 & x117) | (~x037 & ~x069));
  assign new_n176_ = (~x069 | ~x093 | (x101 & x125)) & (x125 | ~x021 | ~x117);
  assign new_n177_ = x061 & ((x037 & ~x101) | (~x093 & ~x125));
  assign new_n178_ = ~x013 & ~x021;
  assign new_n179_ = x061 & x093;
  assign new_n180_ = (~x085 | (~new_n181_ & ~new_n184_)) & ~new_n185_ & new_n187_;
  assign new_n181_ = x053 & (new_n182_ | (~new_n183_ & ~x029 & (x061 | x093)));
  assign new_n182_ = (~x109 | ~x117) & (~x013 | (~x021 & x077));
  assign new_n183_ = x109 & x117 & ((x101 & x125) | (~x013 & ~x021));
  assign new_n184_ = (~new_n178_ | (~new_n179_ & x077)) & ~x037 & (~x029 | (~new_n179_ & x077));
  assign new_n185_ = (new_n186_ | (~x021 & (x013 | x037))) & x053 & ~x069;
  assign new_n186_ = (x037 | (x077 & (~x061 | ~x093))) & x085 & (~x029 | (x077 & (~x061 | ~x093)));
  assign new_n187_ = (x013 | x077) & (x053 | (x037 & (x069 | x021 | ~x077)));
  assign new_n188_ = x013 & ((x037 & ~x085) | (~x037 & x077 & x109 & ~x125));
  ...
  assign z13 = ~x045 & (~new_n239_ | (~x077 & (~new_n237_ | (~new_n233_ & ~x053))));
  assign new_n233_ = (new_n234_ | x085) & (~x005 | (~new_n236_ & ~x085 & x013 & x021));
  assign new_n234_ = ~new_n235_ & ((new_n179_ & ~x021) | (~x109 & ~x117));
  assign new_n235_ = (x101 | x125) & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n236_ = (x101 | x125) & ((~x069 & ~x093) | (~x037 & ~x061));
  assign new_n237_ = (new_n238_ | ~x037 | x085) & ((~x021 & (x053 | x085)) | ~x069 | (x021 & x037));
  assign new_n238_ = ~x061 & ~x093 & x013 & x021;
  assign new_n239_ = (new_n240_ | x013) & (~x037 | ~x053) & (new_n241_ | ~x013);
  assign new_n240_ = (~x069 | ~x021 | x053) & (~x085 | ~x005 | x037);
  assign new_n241_ = ~x077 & (x053 | x085 | (~x109 & ~x117));
