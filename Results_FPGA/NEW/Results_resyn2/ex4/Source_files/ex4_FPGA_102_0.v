...
module FAU ( 
  ...
  assign z05 = x045 & (new_n174_ | ~new_n188_ | (~new_n181_ & x085));
  ...
  assign new_n181_ = ~new_n185_ & (~x053 | ((new_n186_ | new_n187_) & (new_n182_ | ~x077)));
  assign new_n182_ = ~new_n184_ & (~new_n183_ | (~x061 & ~x093) | (x101 & x125));
  assign new_n183_ = ~x029 & (x013 | x021);
  assign new_n184_ = ~x069 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n185_ = (new_n183_ | ~x061 | ~x093) & ~x037 & x077;
  assign new_n186_ = x109 & x117;
  assign new_n187_ = x013 & (~x077 | (x021 & (x029 | (~x061 & ~x093))));
  assign new_n188_ = (x021 | x069 | (~x013 & ~x037)) & (x013 | x077) & (x037 | x053);
  ...
  assign z13 = ~x045 & (~new_n233_ | ((~x053 | ~x077) & x021 & x069));
  assign new_n233_ = (~x037 | ~x053) & (~x013 | ~x077) & (x013 | x037 | ~x005 | ~x085);
  ...
  assign new_n239_ = (~x030 | (x014 & x022)) & ((x014 & x022) | (~x062 & ~x094));
