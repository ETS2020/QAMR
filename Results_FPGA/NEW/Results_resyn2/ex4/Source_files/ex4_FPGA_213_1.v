// Benchmark "FAU" written by ABC on Thu Jul 30 10:36:47 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n174_ | new_n181_ | ~new_n187_);
  assign new_n174_ = x077 & ((~new_n180_ & ~x069) | ((new_n175_ | ~new_n178_) & x085));
  assign new_n175_ = (~x037 | (~new_n176_ & (~x101 | ~x125))) & ~new_n177_ & ~x029;
  assign new_n176_ = ~x061 & ~x093;
  assign new_n177_ = ~x013 & ~x021;
  assign new_n178_ = (new_n179_ | (x021 & (x029 | (~x061 & ~x093)))) & (x037 | (x061 & x093));
  assign new_n179_ = x109 & x117;
  assign new_n180_ = (~x037 | (x021 & (x029 | ~x085))) & (~x085 | (x061 & x093));
  assign new_n181_ = ~x005 & (new_n184_ | (x077 & (new_n182_ | new_n183_ | ~new_n186_)));
  assign new_n182_ = x069 & (~new_n179_ | (x093 & (~x101 | ~x125)));
  assign new_n183_ = ~new_n177_ & (~x029 | ~x061 | ~x093);
  assign new_n184_ = x037 & (~new_n185_ | (x077 & (~x109 | (x061 & ~x101))));
  assign new_n185_ = x085 & (x013 | ~x061 | x125);
  assign new_n186_ = (x117 | (~x037 & (~x109 | x125))) & x085 & (x125 | ~x021 | ~x117);
  assign new_n187_ = (new_n188_ | x013) & (x037 | x053) & (~x013 | x021 | ~x053 | x069);
  assign new_n188_ = x077 & (new_n179_ | ~x085);
  ...
  assign z13 = ~x045 & (~new_n238_ | (~x053 & (new_n233_ | new_n236_ | new_n243_)));
  assign new_n233_ = x005 & (~new_n234_ | ((~x021 | x117) & x125 & (~x109 | ~x117)));
  assign new_n234_ = new_n235_ & (x061 | ((x037 | ~x101) & (~x093 | ~x125)));
  assign new_n235_ = ~x085 & (x069 | x093 | (~x101 & ~x125));
  assign new_n236_ = (x109 | x117) & (new_n237_ | (x005 & (~x037 | ~x069)));
  assign new_n237_ = ~x085 & (~new_n177_ | (x029 & (~x061 | ~x093)));
  assign new_n238_ = ~new_n240_ & new_n242_ & (new_n239_ | ~x037);
  assign new_n239_ = ~x053 & (x085 | (new_n176_ & (x021 | ~x029)));
  assign new_n240_ = x069 & (new_n241_ | ((~x013 | ~x037) & x021 & ~x077));
  assign new_n241_ = ~x053 & ~x085 & (x061 | x093 | (x029 & ~x037));
  assign new_n242_ = x013 ? ~x077 : (x085 ? ~x005 : (~x029 | ~x037));
  assign new_n243_ = (~x013 | ~x021) & (new_n244_ | (x005 & (~new_n176_ | x029)));
  assign new_n244_ = ~x085 & (x101 | x125) & x029 & (~x061 | ~x093);
  assign z14 = ~x046 & (new_n246_ | ~new_n259_ | (~new_n253_ & ~x086));
  assign new_n246_ = x006 & ((~new_n247_ & ~x054) | (x086 & ~x014 & ~x038));
  ...
  assign new_n250_ = (~x030 | (x014 & x022)) & ((x014 & x022) | (~x062 & ~x094));
  ...
  assign new_n259_ = (((x038 | x078) & (x014 | x054)) | ~x022 | ~x070) & (~x038 | ~x054) & (~x014 | ~x078);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
