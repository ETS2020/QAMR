// Benchmark "FAU" written by ABC on Thu Jul 30 10:37:06 2020
...
module FAU ( 
  ...
  assign new_n174_ = ~x005 & ((x013 & x037 & ~x085) | (~new_n175_ & x053));
  ...
  assign new_n180_ = ~x021 & x037 & x061 & ~x125;
  assign new_n181_ = ~new_n186_ & (~x077 | (~new_n187_ & ((~new_n182_ & new_n184_) | ~x053)));
  assign new_n182_ = new_n183_ & ~x029 & (x013 | x021);
  assign new_n183_ = (~x101 | ~x125) & (x061 | x093);
  assign new_n184_ = (x069 | ((~x021 | x029) & x061 & x093)) & ((~x061 & ~x093) | new_n185_ | x029);
  assign new_n185_ = x109 & x117;
  assign new_n186_ = (~x013 | ~x021) & ~new_n185_ & x053;
  assign new_n187_ = ~x037 & ((~x029 & (x013 | x021)) | ~x061 | ~x093);
  ...
  assign z13 = ~x045 & (~new_n240_ | (~x077 & (~new_n237_ | (~new_n233_ & ~x053))));
  assign new_n233_ = new_n236_ & ((~new_n234_ & ~new_n235_) | (~x101 & ~x125));
  assign new_n234_ = x005 & ((~x037 & ~x061) | (~x069 & ~x093));
  assign new_n235_ = ~x013 & x029 & ~x085 & (~x061 | ~x093);
  assign new_n236_ = (~x005 | (~x085 & (x013 | ~x029))) & (x085 | (~x109 & ~x117));
  assign new_n237_ = new_n239_ & (new_n238_ | (~x061 & ~x093));
  assign new_n238_ = (~x037 | x085) & (x053 | ~x005 | x013);
  assign new_n239_ = (x037 | ~x069) & (x013 | ~x029 | ~x037 | x085);
  assign new_n240_ = (new_n241_ | x013) & (~x037 | ~x053) & (~x013 | ~x077);
  assign new_n241_ = (~x069 | ~x021 | x053) & (~x085 | ~x005 | x037);
