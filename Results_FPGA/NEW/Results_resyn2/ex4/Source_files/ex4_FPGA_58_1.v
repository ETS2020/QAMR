...
module FAU ( 
  ...
  assign z13 = ~x045 & (~new_n246_ | (~new_n233_ & ~x077));
  assign new_n233_ = (new_n234_ | ~x005) & (new_n240_ | ~x069) & (new_n242_ | x085);
  assign new_n234_ = ~new_n239_ & (x053 | (~new_n235_ & new_n236_ & ~new_n237_ & new_n238_));
  assign new_n235_ = (x109 | x117) & (~x037 | ~x069);
  assign new_n236_ = ~x085 & (~x125 | x021 | x117);
  assign new_n237_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n238_ = (x061 | ((~x093 | ~x125) & (x069 | ~x101))) & (x093 | ((x037 | ~x101) & (x069 | ~x125)));
  assign new_n239_ = ~x013 & x037 & ~x109 & x125;
  assign new_n240_ = (x037 | (~x021 & (~x029 | x053 | x085))) & (new_n241_ | x053 | x085);
  assign new_n241_ = ~x061 & ~x093;
  assign new_n242_ = ~new_n245_ & (x053 | (~new_n243_ & (new_n244_ | new_n187_ | ~x029)));
  assign new_n243_ = x021 & (x109 | x117);
  assign new_n244_ = ~x109 & ~x117 & ((x013 & x021) | (~x101 & ~x125));
  assign new_n245_ = x037 & ((x029 & (~x013 | ~x021)) | x061 | x093);
  assign new_n246_ = (new_n247_ | ~x013) & new_n248_ & (~x005 | x013 | x037 | ~x085);
  assign new_n247_ = ~x077 & (x053 | x085 | (~x109 & ~x117));
  assign new_n248_ = (~x037 | ~x053) & (x013 | ~x021 | x053 | ~x069);
