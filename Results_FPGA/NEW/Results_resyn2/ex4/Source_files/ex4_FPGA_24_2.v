...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n174_ & x077) | new_n180_ | ~new_n185_);
  assign new_n174_ = (new_n175_ | x069) & (~x085 | (~new_n179_ & (new_n177_ | ~x053)));
  assign new_n175_ = (~x037 | (x021 & (x029 | ~x053 | ~x085))) & (new_n176_ | ~x053 | ~x085);
  assign new_n176_ = x061 & x093;
  assign new_n177_ = (x021 | (x109 & x117)) & (~new_n178_ | (x109 & x117 & (x101 | (~x013 & ~x021))));
  assign new_n178_ = ~x029 & (x061 | x093);
  assign new_n179_ = ~x037 & (~new_n176_ | (~x029 & (x013 | x021)));
  assign new_n180_ = new_n184_ & (~x085 | (x053 & x077 & (~new_n181_ | new_n183_)));
  assign new_n181_ = (new_n176_ | (~x013 & ~x021)) & ~new_n182_ & (x029 | (~x013 & ~x021));
  assign new_n182_ = (~x109 | ~x117) & (x037 | x069);
  assign new_n183_ = ~x101 & ((x069 & x093) | (x037 & x061));
  assign new_n184_ = ~x005 & ((x013 & x037) | (x053 & x077));
  ...
  assign z13 = ~x045 & ((~new_n232_ & x005) | ~new_n248_ | (~new_n241_ & ~x085));
  assign new_n232_ = ~new_n240_ & (x053 | (~new_n233_ & ~new_n235_ & (new_n237_ | x125)));
  assign new_n233_ = ~x077 & (new_n234_ | x085 | (~x013 & x093));
  assign new_n234_ = x125 & ((~x069 & ~x093) | (x117 ? ~x109 : ~x021));
  assign new_n235_ = ~x037 & (~new_n236_ | (~x125 & (x109 | (~x061 & x101))));
  assign new_n236_ = (x077 | ~x117) & (~x125 | ~x013 | x061);
  assign new_n237_ = ~new_n239_ & (x069 | (new_n238_ & (x093 | ~x101)));
  assign new_n238_ = ~x109 & ~x117;
  assign new_n239_ = (~x013 | ~x021) & (x029 | x061 | (~x021 & x093));
  assign new_n240_ = x085 & ~x013 & ~x037;
  assign new_n241_ = (new_n242_ | ~x037) & (x053 | (new_n245_ & (new_n244_ | x077)));
  assign new_n242_ = (new_n243_ | ~x029 | x125) & (x077 | (~x061 & ~x093));
  assign new_n243_ = x013 & x021;
  assign new_n244_ = (~x069 | (~x061 & ~x093)) & (new_n243_ | (x061 & x093) | ~x029 | ~x125);
  assign new_n245_ = (new_n246_ | ~x029 | x125) & (new_n238_ | (new_n247_ & (new_n176_ | ~x029 | x125)));
  assign new_n246_ = (x021 | ~x069) & (~x101 | (x013 & x021) | (x061 & x093));
  assign new_n247_ = ~x013 & (~x021 | x077);
