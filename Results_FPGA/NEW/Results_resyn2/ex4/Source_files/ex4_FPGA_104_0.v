...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n174_ & x085) | ~new_n188_ | (~new_n181_ & ~x005));
  assign new_n174_ = (~x053 | (new_n177_ & (new_n175_ | ~x077))) & (new_n180_ | x037 | ~x077);
  assign new_n175_ = (new_n176_ | x029) & (x069 | (x061 & x093));
  assign new_n176_ = (~x021 | x069) & ((~x013 & ~x021) | x125 | (~x061 & ~x093));
  assign new_n177_ = (new_n178_ | (x013 & (~x077 | (~new_n179_ & x021)))) & (~new_n179_ | x101 | (~x013 & ~x021));
  assign new_n178_ = x109 & x117;
  assign new_n179_ = ~x029 & (x061 | x093);
  assign new_n180_ = x061 & x093 & (x029 | (~x013 & ~x021));
  assign new_n181_ = ((~new_n182_ & new_n186_) | ~x053) & (x085 | ~x013 | ~x037);
  assign new_n182_ = x077 & (new_n183_ | new_n184_ | ~new_n185_);
  assign new_n183_ = ~x125 & ((x069 & x093) | (x117 ? x021 : x109));
  assign new_n184_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n185_ = x085 & ((x109 & x117) | (~x037 & ~x069));
  assign new_n186_ = (~new_n187_ | x101) & (~x037 | ~x061 | (x101 & (x013 | x125)));
  assign new_n187_ = x069 & x093;
  ...
  assign z13 = ~x045 & (~new_n241_ | (~x077 & (~new_n238_ | (~new_n233_ & ~x053))));
  assign new_n233_ = ~new_n234_ & (x085 | (~new_n236_ & new_n237_));
  assign new_n234_ = x005 & (~new_n235_ | (x125 & ~x021 & ~x117));
  assign new_n235_ = (~x093 | (x013 & x061)) & ~x085 & (x069 | x093);
  assign new_n236_ = (~x013 | ~x021) & x029 & (~x061 | ~x093);
  assign new_n237_ = (~x069 | (~x061 & ~x093)) & (~x021 | (~x109 & ~x117));
  assign new_n238_ = x037 ? (~new_n240_ & (x085 | (~x061 & ~x093))) : new_n239_;
  assign new_n239_ = (~x021 | ~x069) & (x053 | ~x005 | x021);
  assign new_n240_ = x005 & ~x013 & ~x109 & x125;
  assign new_n241_ = (new_n242_ | x013) & (~x037 | ~x053) & (new_n243_ | ~x013);
  assign new_n242_ = (x053 | ~x021 | ~x069) & (~x085 | ~x005 | x037);
  assign new_n243_ = ~x077 & (x053 | x085 | (~x109 & ~x117));
