// Benchmark "FAU" written by ABC on Thu Jul 30 10:37:13 2020
...
module FAU ( 
  ...
  assign new_n196_ = (x030 | (~x014 & ~x022)) & (x126 | ~x022 | ~x110);
  ...
  assign z13 = ~x045 & (new_n234_ | new_n241_ | ~new_n247_);
  ...
  assign new_n241_ = ~x085 & (new_n246_ | (~x053 & (new_n242_ | (~new_n244_ & ~x077))));
  ...
  assign new_n246_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n251_ = ~x070 & (x110 | x118 | (~x062 & (x102 | x126)));
  assign new_n252_ = ~x086 & (~x126 | x022 | x118);
  assign new_n253_ = (~x030 | (x014 & x022)) & ((x014 & x022) | (~x062 & ~x094));
  assign new_n254_ = (~x118 | (x038 & (x110 | ~x126))) & (x038 | (~x110 & (x094 | ~x102)));
  assign new_n255_ = x014 & ~x038 & ~x094 & x126;
