...
module FAU ( 
  ...
  assign new_n32_ = x14 & x11 & x12 & x17 & x15 & x16;
  ...
  assign z4 = (x03 & x08) | ((~x13 | ~new_n36_ | ~x14) & new_n31_ & (x14 | (new_n36_ & x13)));
  assign z5 = (x04 & x08) | ((x15 | (new_n39_ & x13)) & new_n31_ & (~new_n39_ | ~x15));
  assign new_n39_ = x14 & x11 & x12;
  assign z6 = (x05 & x08) | (new_n31_ & (x16 | (new_n39_ & x15)) & (~x16 | ~new_n39_ | ~x15));
