...
module FAU ( 
  ...
  assign z2 = (x01 & x08) | ((x12 | (~x08 & x11)) & (~x11 | ~x12) & x09 & ~x10);
  assign z3 = (x02 & x08) | (((x11 & x12) | x13) & new_n33_ & (~x11 | ~x12 | ~x13));
  assign z4 = (x03 & x08) | ((~new_n32_ | ~x14) & new_n33_ & (new_n32_ | x14));
  assign z5 = (x04 & x08) | ((~x15 | ~new_n32_ | ~x14) & new_n33_ & (x15 | (new_n32_ & x14)));
  ...
  assign z8 = new_n44_ | (new_n33_ & ((~new_n31_ & x18) | (new_n42_ & x17 & ~x18)));
