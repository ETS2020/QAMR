...
module FAU ( 
  ...
  assign new_n35_ = ~x08 & x09 & (~x10 | ~x16);
  ...
  assign new_n43_ = (x17 | (x16 & new_n32_ & x14 & x15)) & new_n35_ & (~x16 | ~new_n32_ | ~x14 | ~x15 | ~x17);
  assign z8 = (x07 & x08) | (~x08 & x09 & (new_n46_ | (~new_n45_ & ~x10)));
