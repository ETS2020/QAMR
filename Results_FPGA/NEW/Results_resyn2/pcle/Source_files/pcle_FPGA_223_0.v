...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n40_, new_n41_, new_n43_, new_n45_,
    new_n46_;
  assign z0 = new_n31_ & x16 & new_n33_ & x18;
  assign new_n31_ = new_n32_ & x17 & x14 & x15;
  ...
  assign z6 = (x05 & x08) | ((~new_n40_ | ~x16) & new_n41_ & (new_n40_ | x16));
  assign new_n40_ = new_n32_ & x14 & x15;
  assign new_n41_ = ~x08 & ~x10 & (x09 | ~x16);
  assign z7 = new_n43_ | (x06 & x08);
  assign new_n43_ = (x17 | (x16 & new_n32_ & x14 & x15)) & new_n41_ & (~x16 | ~new_n32_ | ~x17 | ~x14 | ~x15);
  assign z8 = (x07 & x08) | (~x08 & ~x10 & (new_n46_ | (~new_n45_ & x09)));
  assign new_n45_ = (~x18 | (new_n32_ & x14 & x15 & x17)) & (~new_n32_ | ~x14 | ~x15 | ~x16 | ~x17 | x18);
