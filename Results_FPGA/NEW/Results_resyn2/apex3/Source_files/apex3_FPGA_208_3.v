// Benchmark "FAU" written by ABC on Thu Jul 30 22:28:18 2020
...
module FAU ( 
  ...
  assign new_n402_ = (new_n403_ | x51) & (x49 | ~x03 | ~x51 | ~x52) & (~x18 | ~x49 | x52);
  assign new_n403_ = (~x08 | ~x48 | x52) & ((x47 & (x08 | x48 | ~x52)) | ~x49 | (x48 ^ ~x52));
  ...
  assign z08 = (~new_n436_ & ~x46) | (new_n439_ & (x51 ? ~x53 : (~x49 & x53)));
  assign new_n436_ = (new_n438_ | x48) & (~new_n437_ | ((x50 | ~x53) & (~x50 | x53) & (~new_n164_ | ~x53)));
  assign new_n437_ = new_n371_ & ~x49 & (new_n110_ | (~x50 ^ x53));
  assign new_n438_ = (~x52 | x53 | ((~x47 | (x49 ? (~x50 | x51) : (x50 | ~x51))) & (x50 | x51 | x47 | x49))) & (x47 | ~x49 | ~x50 | x51 | x52 | ~x53);
  ...
  assign new_n513_ = (~new_n138_ | x49 | ~x51 | ~x52 | ~x53) & (~new_n475_ | x51 | x53 | ~x49 | x52);
