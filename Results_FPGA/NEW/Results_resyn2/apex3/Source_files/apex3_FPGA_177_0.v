// Benchmark "FAU" written by ABC on Thu Jul 30 22:27:23 2020
...
module FAU ( 
  ...
  assign new_n320_ = (new_n321_ | x50) & (~new_n324_ | x20 | x47 | ~x49);
  ...
  assign new_n324_ = new_n195_ & x50 & ~x51;
  ...
  assign z07 = new_n407_ | (~new_n370_ & ~x46);
  ...
  assign new_n407_ = ~x47 & (~new_n416_ | (x46 & (new_n410_ | (~new_n408_ & ~x48))));
  ...
  assign new_n411_ = (new_n412_ | x48) & (~x48 | x50) & (~new_n126_ | ~x48);
  assign new_n412_ = (x50 | ~x51 | (~x39 & x52)) & (x51 | ((x50 | x52) & (~x50 | ~x52) & (~x41 | x52) & (~x14 | ~x52)));
  ...
  assign new_n416_ = (new_n417_ | x49) & (new_n419_ | ~x51 | x48 | ~x49);
  assign new_n417_ = (new_n418_ | ~x48 | x50) & (~x50 | x51 | x48 | x53);
  ...
  assign z16 = new_n449_ | (~x48 & (new_n448_ | (new_n147_ & ~new_n450_)));
  assign new_n448_ = new_n229_ & x49 & (x51 | ~x53);
  assign new_n449_ = new_n276_ & x48 & x49 & new_n133_ & x50 & ~x51;
  ...
  assign z22 = new_n467_ | (new_n438_ & new_n122_ & new_n194_);
  ...
  assign z49 = (~x48 & (new_n509_ | (new_n324_ & ~x49 & ~x46 & x47))) | (new_n324_ & x46 & ~x47 & x48 & ~x49);
