// Benchmark "FAU" written by ABC on Thu Jul 30 22:29:01 2020
...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n521_, new_n522_;
  assign z00 = new_n142_ | (~new_n127_ & (new_n107_ | new_n140_ | new_n141_ | x48));
  ...
  assign new_n127_ = (x47 | (~new_n136_ & (new_n128_ | x49))) & ~new_n138_ & x48;
  assign new_n128_ = (~new_n135_ | (~new_n129_ & new_n134_)) & (~new_n131_ | ~new_n133_ | ~x40);
  ...
  assign new_n138_ = new_n139_ & x52 & ((x49 & ~x50 & x51 & x53) | ((~x53 | ~x49 | x51) & x50 & (x49 | (~x51 & x53))));
  assign new_n139_ = ~x46 & x47;
  assign new_n140_ = new_n113_ & ((x50 & ~x52 & x51 & ~x53) | ((~x39 | ~x51) & x53 & ~x50 & x52));
  assign new_n141_ = x09 & ~x53 & new_n133_ & x47 & ~x52;
  ...
  assign new_n148_ = (~x53 | ((~x39 | x48 | ~x52) & (~x48 | (~x04 & x52)))) & (x52 | x53 | (new_n130_ & x48));
  assign new_n149_ = x52 & (x53 | (~x03 & x51));
  assign new_n150_ = (new_n151_ | x53) & ~new_n163_ & (new_n156_ | ~x53);
  assign new_n151_ = (new_n155_ | ~x48) & (~x47 | (~new_n154_ & (new_n152_ | x48)));
  assign new_n152_ = (new_n153_ | ~x50) & (x51 | ((~x52 | (~x49 & ~x50)) & (x09 | x50 | x49 | x52)));
  assign new_n153_ = (x28 | x49 | x52) & (~x51 | (~x49 & x52) | (x11 & x49 & ~x52));
  assign new_n154_ = ~x51 & x52 & ~x31 & ~x49;
  ...
  assign new_n161_ = (x52 | ~x49 | ~x50) & (x50 | ((~x39 | x49 | x52) & ((~x38 & x49) | ~x52 | (~x13 & ~x49))));
  assign new_n162_ = x47 & ~x51 & (x49 | ~x52 | ~x48 | ~x50);
  assign new_n163_ = x47 & (new_n164_ | (x51 & (new_n167_ | ~new_n168_)));
  assign new_n164_ = new_n166_ & x38 & new_n165_ & ~x50;
  assign new_n165_ = ~x51 & x52;
  assign new_n166_ = ~x48 & x49;
  assign new_n167_ = (~x52 | ((~x49 | (~x48 & ~x50)) & (x45 | ~x48 | ~x50))) & x53 & (x50 | ~x48 | x49 | x52);
  assign new_n168_ = (~x20 | x52 | ~x49 | x50) & ((~x50 & x52) | (x50 & ~x52) | ~x48 | x49 | (x45 & x52));
  assign z02 = new_n170_ | (~x46 & ((~new_n178_ & x48) | (~new_n200_ & ~new_n196_ & ~x48)));
  assign new_n170_ = ~x47 & (new_n171_ | (new_n177_ & new_n119_ & x03));
  assign new_n171_ = x46 & (new_n175_ | (~new_n172_ & ~x49 & ~new_n173_ & ~new_n176_));
  assign new_n172_ = ~x48 & (~new_n143_ | ((x52 | x53) & (~x39 | ~x52 | ~x53)));
  assign new_n173_ = ~new_n174_ & x48 & ~x50 & (x04 | ~new_n119_ | ~x51);
  assign new_n174_ = (x52 | (~x37 & (x38 | x43))) & ~x53 & (x51 ^ x52);
  assign new_n175_ = (~x50 | x53) & (x50 | ~x53) & (~x50 ^ ~x52) & new_n166_ & ~x51;
  assign new_n176_ = (x51 | ((x52 | ~x53) & (~x52 | x53) & (x04 | x53))) & x50 & ((x03 & x52 & ~x53) | ~x51 | (~x52 & x53));
  assign new_n177_ = new_n166_ & x50 & x51;
  assign new_n178_ = (~x52 | (~new_n179_ & ~new_n195_)) & (new_n182_ | ~x47) & (new_n190_ | x52);
  assign new_n179_ = (new_n181_ | x50 | (~x51 & ~x49 & ~x53)) & (new_n180_ | ~x50 | (~x49 & x51 & ~x53));
  assign new_n180_ = new_n144_ & (~x51 | x42 | ~x53);
  ...
  assign new_n190_ = (new_n191_ | x51) & (new_n192_ | x47) & (~new_n193_ | ~new_n194_ | ~x51);
  assign new_n191_ = (~x50 | ~x08 | x53) & ((~x49 & (~x29 | ~x50)) | ~x53 | (x49 & x29 & x50));
  assign new_n192_ = (~x49 | x53) & (x50 | ((x49 | x51 | (~x37 & ~x53)) & (~x19 | ~x49 | ~x51)));
  assign new_n193_ = x50 & x53;
  assign new_n194_ = ~x41 & x49;
  assign new_n195_ = x20 & ((~x50 & ~x53 & ~x47 & x49 & ~x51) | (x51 & ~x49 & x53));
  assign new_n196_ = (new_n197_ | ~x49 | ~x50) & ~x47 & (x51 | ~new_n199_ | x49 | x50);
  assign new_n197_ = ~new_n198_ & ((~x44 & x53) | ~new_n110_ | (~x35 & ~x53));
  ...
  assign new_n201_ = (~x49 | x50 | ((x20 | x52) & (x51 | x52) & (~x51 | ~x52))) & (x49 | (~x28 & x50) | (x50 & (x51 | x52)) | (~x50 & (~x51 | ~x52)));
  assign new_n202_ = (x51 | x52) & ((x43 & ~x52) | (x01 & ~x51));
  assign z03 = new_n204_ | (~x46 & ((~new_n218_ & ~x48) | ~new_n244_ | (~new_n228_ & x48)));
  assign new_n204_ = ~x47 & (new_n216_ | (x46 & (new_n209_ | (~new_n205_ & ~x49))));
  assign new_n205_ = (~x48 | (~new_n207_ & ~new_n208_)) & (~new_n206_ | x50 | x53);
  assign new_n206_ = x51 & ~new_n130_ & ~x52;
  assign new_n207_ = ~x51 & ((x52 & x53) | ((x50 | x16 | ~x52) & ~x53 & (x04 | ~x50)));
  assign new_n208_ = (~x53 | (x04 & ~x50)) & x51 & x52 & (x03 | ~x50);
  assign new_n209_ = ~new_n215_ & ~x48 & (new_n210_ | new_n212_ | ~new_n214_);
  assign new_n210_ = (~new_n211_ | ~x49 | x51 | ~x25 | x53) & x52 & (~x51 | (x49 & ~x53) | (~x49 & x53));
  ...
  assign new_n216_ = ~new_n217_ & new_n166_ & x51;
  ...
  assign new_n234_ = ~new_n235_ & x50 & ((x08 & ~x47) | x51 | (x47 & ~x52));
  ...
  assign new_n238_ = (~new_n193_ | (x52 ? ~x45 : ~x43)) & (x01 | ~x43 | ~x49 | x52);
  ...
  assign new_n243_ = new_n199_ & x49 & ((~x50 & ~x51) | (~x41 & x50 & x51));
  ...
  assign new_n260_ = new_n166_ & ~x35 & new_n132_ & x51;
  ...
  assign new_n264_ = (x47 | (~new_n265_ & (~new_n159_ | (~x16 & x52)))) & (new_n266_ | new_n159_ | ~x52);
  ...
  assign new_n285_ = (~x16 | (x51 & ~x53) | (~x46 & ~x51) | (x46 & ~x48) | (x48 & x53)) & x52 & (~x46 | x51 | ~x48 | ~x53);
  assign new_n286_ = ~new_n287_ & ((~x51 & (~x13 | x48 | x49)) | ~new_n119_ | (~x49 & x51));
  assign new_n287_ = x47 & ((~new_n288_ & x51) | (new_n123_ & ~x51 & new_n159_ & x31));
  assign new_n288_ = (~x53 | ((x49 | ~x52) & (x21 | ~x48))) & ((x20 & ~x52) | x53 | x48 | ~x49);
  assign new_n289_ = ~new_n290_ & new_n139_ & x51;
  ...
  assign new_n316_ = ~new_n317_ & ((x37 & ~x46 & x49) | ~new_n158_ | (~x49 & ~x41 & x46));
  ...
  assign new_n320_ = (x01 | ~x49 | x51) & new_n139_ & (x51 ^ x52);
  ...
  assign new_n328_ = new_n165_ & ~x36 & new_n113_ & ~x49;
  ...
  assign new_n358_ = new_n166_ & ~x53 & (x25 | x47) & ~x50 & ~x51;
  ...
  assign new_n365_ = (x51 | (~new_n367_ & (new_n366_ | ~x49))) & (~new_n187_ | (x47 ^ x49));
  ...
  assign new_n376_ = ~new_n377_ & (~new_n166_ | ~x53 | (x24 & ~x50) | (~x06 & x50));
  assign new_n377_ = ~x49 & ((~x50 & (~new_n130_ | ~x48)) | (x53 & (new_n331_ | x48)));
  assign new_n378_ = ~new_n379_ & ~x50 & (~new_n159_ | ~x25 | x53);
  ...
  assign new_n396_ = x51 & (new_n265_ | (new_n159_ & (~x25 | x52)));
  assign new_n397_ = (x50 | (~new_n398_ & (~new_n165_ | ~x48 | x49))) & (~new_n165_ | x14 | x48 | ~x49);
  ...
  assign new_n408_ = x48 & (~new_n158_ | ~x49 | ~x29 | ~x50);
  ...
  assign new_n413_ = ~new_n164_ & (~x50 | (~new_n417_ & (~new_n416_ | (~new_n414_ & new_n415_))));
  ...
  assign new_n422_ = new_n159_ & x13 & new_n165_ & ~x50;
  ...
  assign new_n446_ = (x49 ? (x50 & ~x51) : (~x50 & x51)) & new_n355_ & new_n139_ & x52;
  ...
  assign z13 = new_n451_ & ~x48 & ~x49 & x53 & new_n165_ & ~x50;
  assign new_n451_ = ~x46 & ~x47;
  assign z14 = new_n126_ & x50 & ~x52 & new_n144_ & ~x46 & x48;
  ...
  assign new_n460_ = (new_n461_ | x49 | ~x52) & (~new_n139_ | new_n370_ | x52 | ~x49 | ~x50);
  ...
  assign z18 = (new_n113_ & ~new_n467_) | (new_n466_ & (~x48 | (new_n158_ & x23)));
  assign new_n466_ = (x48 | (~x51 & x52) | (x51 & ~x52)) & new_n353_ & new_n139_ & ~x49;
  ...
  assign new_n469_ = new_n199_ & ~x48 & ~x50 & ~x47 & x49 & ~x51;
  assign new_n470_ = new_n113_ & (x51 ^ x52) & new_n166_ & ~x53 & (~x50 | x52) & (x50 | ~x52);
  ...
  assign z21 = x51 & (new_n462_ | (new_n474_ & new_n199_ & ~x49 & ~x50));
  assign new_n474_ = x46 & ~x47 & ~x48;
  assign z22 = new_n477_ | (~x46 & (new_n476_ | (~new_n478_ & ~x47 & ~x52)));
  assign new_n476_ = (~x48 ^ ~x50) & x47 & x49 & new_n165_ & x53;
  assign new_n477_ = new_n126_ & x50 & ~x52 & new_n113_ & new_n166_;
  assign new_n478_ = (x48 | x53 | (x49 ? (x50 | x51) : (~x50 | ~x51))) & (~x48 | ~x53 | ~x51 | ~x49 | x50);
  assign z23 = ~x49 & x50 & new_n123_ & new_n139_ & x51;
  ...
  assign new_n483_ = new_n144_ & ~x50 & ~x46 & x48;
  assign z26 = new_n165_ & ~new_n485_;
  assign new_n485_ = (~x50 | ~x53 | x49 | x46 | ~x47) & (~x46 | ~x49 | x48 | x50 | x47 | x53);
  assign z27 = new_n199_ & ~x49 & ~x50 & new_n451_ & x48 & ~x51;
  ...
  assign z29 = new_n199_ & new_n334_ & x48 & ~x46 & x47 & x50;
  assign z30 = ~x47 & ((~new_n492_ & ~x48) | (new_n491_ & x46 & x48 & ~x49));
  assign new_n491_ = new_n143_ & new_n123_;
  ...
  assign z34 = (new_n355_ | ~x52) & (~new_n355_ | x52) & new_n139_ & x49 & ~x50 & ~x51;
  assign z35 = (~new_n499_ & x49) | (new_n501_ & ~x46 & ~x49 & ~x53);
  assign new_n499_ = (~new_n491_ | ~x46 | x47 | x48) & (~new_n500_ | (~x47 & ~x52) | (x48 ? x47 : x52));
  assign new_n500_ = new_n193_ & ~x46 & ~x51;
  assign new_n501_ = (~x51 | ~x52) & (x51 | x52) & new_n371_ & (x50 | x52);
  assign z36 = new_n370_ & ~x50 & x52 & new_n144_ & ~x46 & x48;
  assign z37 = new_n144_ & new_n132_ & ~x51 & ~x50 & ~x46 & x48;
  assign z38 = new_n131_ & new_n483_;
  assign z39 = new_n199_ & new_n339_ & new_n451_ & ((~x50 & x51) | (~x24 & x50 & ~x51));
  ...
  assign z41 = ~x50 & (new_n511_ | (new_n139_ & ~x49 & new_n119_ & x51));
  assign new_n511_ = new_n474_ & new_n126_ & new_n300_;
  assign z42 = new_n119_ & new_n451_ & ~x48 & new_n369_ & x51;
  assign z43 = new_n199_ & new_n451_ & ~x48 & new_n369_ & x51;
  assign z44 = new_n339_ & new_n451_ & ((~x51 & x52 & x53) | (x50 & (x51 ^ x52)));
  assign z46 = new_n119_ & new_n334_ & x48 & ~x46 & x47 & x50;
  assign z47 = new_n339_ & ~x50 & new_n131_ & new_n451_;
  assign z48 = new_n518_ & new_n133_ & x47 & ~x52;
  assign new_n518_ = new_n159_ & x27 & ~x43 & x51 & ~x53;
  assign z49 = new_n521_ | (~x48 & (new_n520_ | (~new_n522_ & ~x50)));
  assign new_n520_ = new_n139_ & ~x49 & new_n119_ & x50 & ~x51;
  assign new_n521_ = new_n119_ & x50 & ~x51 & new_n113_ & new_n339_;
