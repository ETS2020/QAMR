...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n58_, new_n60_, new_n63_, new_n64_, new_n66_, new_n68_,
    new_n69_;
  ...
  assign z04 = x18 | (~x11 & ~x16) | (x16 & (new_n60_ ^ x23));
  assign new_n60_ = ~x22 & ~x17 & ~x19 & ~x20 & ~x21;
  assign z05 = x18 | (~x10 & ~x16) | (x16 & ((x24 & (~new_n60_ | x23)) | (new_n60_ & ~x23 & ~x24)));
  assign z06 = ~new_n64_ | (x16 & ((x25 & (~new_n63_ | ~new_n58_ | x22)) | (new_n58_ & new_n63_ & ~x22 & ~x25)));
  assign new_n63_ = ~x23 & ~x24;
  assign new_n64_ = ~x18 & (x09 | x16);
  assign z07 = (x16 & (~x26 ^ (~new_n58_ | ~new_n66_))) | x18 | (~x08 & ~x16);
  assign new_n66_ = ~x23 & ~x24 & ~x22 & ~x25;
  assign z08 = ~new_n69_ | (new_n68_ & (x26 | ~new_n58_ | ~new_n66_));
  assign new_n68_ = x16 & (x27 | (~x17 & ~x19));
