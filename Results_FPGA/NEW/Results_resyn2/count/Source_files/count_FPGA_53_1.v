...
module FAU ( 
  ...
  wire new_n56_, new_n59_, new_n62_, new_n64_, new_n65_, new_n66_, new_n68_,
    new_n69_, new_n71_, new_n72_, new_n75_, new_n78_, new_n79_, new_n80_,
  ...
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (~x31 ^ (~new_n68_ | ~new_n75_)));
  assign z13 = (x16 & (new_n79_ | (~new_n78_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n78_ = ~x29 & ~x31 & new_n59_ & new_n65_ & new_n72_ & ~x26;
  assign new_n79_ = ~x26 & ~x27 & new_n59_ & new_n65_ & new_n80_ & ~x28;
  assign new_n80_ = ~x29 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n83_ | (~new_n82_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n82_ = new_n80_ & new_n59_ & new_n65_ & new_n72_ & ~x26;
  assign new_n83_ = new_n75_ & new_n59_ & new_n66_ & ~x33 & ~x31 & ~x32;
  assign z15 = ~new_n85_ | (x16 & ((new_n79_ & ~x33 & ~x34) | (~new_n83_ & x34)));
