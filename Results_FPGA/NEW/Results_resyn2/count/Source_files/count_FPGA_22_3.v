...
module FAU ( 
  ...
  wire new_n56_, new_n58_, new_n60_, new_n61_, new_n65_, new_n66_, new_n67_,
    new_n68_, new_n71_, new_n72_, new_n73_, new_n75_, new_n78_, new_n79_,
  ...
  assign z09 = ~new_n73_ | (x16 & (new_n71_ | (x28 & (~new_n67_ | x27))));
  assign new_n71_ = new_n72_ & new_n61_ & new_n66_;
  assign new_n72_ = ~x28 & ~x26 & ~x27;
  assign new_n73_ = ~x18 & (x06 | x16);
  assign z10 = (x16 & (new_n75_ | (~new_n71_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n75_ = new_n56_ & new_n68_ & ~x29 & ~x27 & ~x28;
  assign z11 = x18 | (~x04 & ~x16) | ((~new_n75_ | ~x30) & x16 & (new_n75_ | x30));
  assign z12 = ~new_n83_ | (x16 & (new_n78_ | (~x19 & (new_n79_ | new_n81_))));
  assign new_n78_ = ~new_n56_ & x31;
  assign new_n79_ = new_n68_ & new_n80_ & ~x17 & ~x20 & (~x27 | x32);
  assign new_n80_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign new_n81_ = x31 & (~new_n72_ | ~new_n82_ | x23 | x21 | x22);
  assign new_n82_ = ~x24 & ~x25 & ~x29 & ~x30;
  assign new_n83_ = ~x18 & (x03 | x16);
  assign z13 = x18 | (~x02 & ~x16) | (~new_n85_ & x16);
  assign new_n85_ = (~x32 | (new_n86_ & new_n61_ & new_n66_)) & (~new_n87_ | ~new_n72_ | ~new_n61_ | ~new_n66_);
  assign new_n86_ = ~x26 & ~x29 & ~x30 & ~x28 & ~x31;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & ((x33 & (~new_n67_ | ~new_n89_)) | (new_n67_ & new_n89_ & ~x33)));
  assign new_n89_ = ~x29 & ~x27 & ~x28 & ~x30 & ~x31 & ~x32;
  assign z15 = x18 | (~x00 & ~x16) | ((~new_n91_ | ~x34) & x16 & (new_n91_ | x34));
  assign new_n91_ = new_n56_ & new_n68_ & new_n89_ & ~x33;
endmodule
