...
module FAU ( 
  ...
  wire new_n56_, new_n59_, new_n62_, new_n64_, new_n65_, new_n66_, new_n68_,
    ...
    new_n81_, new_n83_, new_n85_, new_n86_, new_n87_;
  ...
  assign new_n75_ = new_n59_ & new_n66_ & new_n73_ & ~x29;
  assign z12 = x18 | ((~x03 | x16) & (x31 | new_n77_ | ~x16));
  assign new_n77_ = ~x30 & new_n59_ & new_n66_ & new_n73_ & ~x29;
  assign z13 = (x16 & (new_n80_ | (~new_n79_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n79_ = ~x29 & ~x30 & new_n59_ & new_n65_ & new_n73_ & ~x26;
  assign new_n80_ = new_n81_ & ~x26 & ~x27 & new_n59_ & new_n65_;
  assign new_n81_ = ~x29 & ~x30 & ~x28 & ~x32;
  assign z14 = ~new_n83_ | ((x33 | (new_n77_ & ~x32)) & x16 & (~new_n79_ | x32 | ~x33));
  assign new_n83_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n87_ | (x16 & ((new_n80_ & ~x33 & ~x34) | (~new_n85_ & x34)));
  assign new_n85_ = new_n86_ & new_n59_ & new_n66_ & new_n73_ & ~x29;
  assign new_n86_ = ~x33 & ~x30 & ~x32;
