...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n57_, new_n61_, new_n62_, new_n63_, new_n65_, new_n67_,
  ...
  assign new_n65_ = new_n63_ & ~x24 & ~x25;
  assign z07 = x18 | (~x08 & ~x16) | (~new_n67_ & x16);
  assign new_n67_ = (~x26 | (new_n63_ & ~x24 & ~x25)) & (~new_n63_ | x26 | x24 | x25);
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n69_ | new_n70_));
  assign new_n69_ = x27 & (~new_n63_ | x26 | x24 | x25);
  assign new_n70_ = new_n56_ & new_n62_ & new_n71_ & ~x27;
  assign new_n71_ = ~x25 & ~x26;
  assign z09 = (x16 & (new_n73_ | (~new_n70_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n73_ = new_n57_ & ~x22 & new_n74_ & ~x23 & ~x27 & ~x28;
  assign new_n74_ = ~x24 & ~x25 & ~x26;
  assign z10 = (x16 & (new_n76_ | (~new_n73_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n76_ = new_n63_ & new_n74_ & ~x29 & ~x27 & ~x28;
  assign z11 = x18 | (~x04 & ~x16) | (~new_n78_ & x16);
  assign new_n78_ = (~x30 | (new_n63_ & new_n74_ & ~x29 & ~x27 & ~x28)) & (~new_n63_ | ~new_n74_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n82_ | (~new_n80_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n80_ = new_n63_ & new_n74_ & new_n81_;
  assign new_n81_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n82_ = new_n56_ & new_n62_ & new_n83_ & new_n71_ & ~x27;
  assign new_n83_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = ~new_n86_ | (x16 & ((~new_n82_ & x32) | (new_n61_ & new_n85_)));
  assign new_n85_ = new_n81_ & new_n71_ & ~x31 & ~x32;
  assign new_n86_ = ~x18 & (x02 | x16);
  assign z14 = x18 | (~x01 & ~x16) | ((~new_n61_ | ~new_n85_) & x16 & x33);
