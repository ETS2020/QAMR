// Benchmark "FAU" written by ABC on Thu Jul 30 00:57:05 2020
...
module FAU ( 
  ...
  assign z04 = (~new_n59_ & x16) | x18 | (~x11 & ~x16) | (x19 & x23);
  assign new_n59_ = (x20 | x17 | x19 | x23 | x21 | x22) & (~x23 | (~x21 & ~x22 & ~x17 & ~x20));
  ...
  assign new_n81_ = new_n82_ & new_n61_ & new_n64_ & ~x26 & new_n71_ & ~x29;
  assign new_n82_ = ~x30 & ~x31 & ~x32;
  assign new_n83_ = new_n84_ & new_n71_ & new_n61_ & new_n64_ & ~x26;
