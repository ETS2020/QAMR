...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n59_, new_n61_, new_n62_;
  ...
  assign z04 = ~new_n59_ | (x16 & (~x23 ^ (~new_n56_ | x21 | x22)));
  assign new_n59_ = ~x18 & (x11 | x16);
  assign z05 = (~new_n61_ & ~new_n62_ & x16) | x18 | (~x10 & ~x16);
  assign new_n61_ = ~x23 & ~x20 & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n62_ = ~x24 & (x17 | x19);
