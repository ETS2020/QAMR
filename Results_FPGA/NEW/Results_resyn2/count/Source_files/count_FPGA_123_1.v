...
module FAU ( 
  ...
  assign z09 = (x16 & (new_n67_ ^ x28)) | x18 | (~x06 & ~x16);
  assign z10 = ~new_n73_ | (x16 & (new_n71_ | (x29 & (~new_n67_ | x28))));
  assign new_n71_ = new_n72_ & new_n60_ & ~x23 & ~x24 & ~x25;
  assign new_n72_ = ~x29 & ~x26 & ~x28;
  assign new_n73_ = ~x18 & (x05 | x16);
  assign z11 = x18 | (~x04 & ~x16) | (x16 & ((x30 & (~new_n67_ | ~new_n75_)) | (new_n67_ & new_n75_ & ~x30)));
  assign new_n75_ = ~x28 & ~x29;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n77_ | x31) & (~new_n77_ | ~x31));
