...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n58_, new_n60_, new_n61_, new_n63_, new_n65_, new_n68_,
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n65_ | x26));
  assign z08 = (x16 & (new_n68_ | (~new_n65_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n68_ = new_n61_ & ~x27 & ~x24 & ~x25;
  assign z09 = (x16 & (new_n68_ ^ x28)) | x18 | (~x06 & ~x16);
  assign z10 = ~new_n73_ | (x16 & (new_n71_ | (x29 & (~new_n68_ | x28))));
