...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n60_, new_n63_, new_n65_, new_n66_, new_n67_, new_n69_,
  ...
  assign z04 = x18 | (~x11 & ~x16) | (x16 & ((x23 & (~new_n56_ | x21)) | (new_n56_ & ~x21 & ~x23)));
  assign z05 = x18 | ((~x10 | x16) & ((new_n60_ & ~x24) | ~x16 | (~new_n60_ & x24)));
  assign new_n60_ = ~x20 & ~x17 & ~x19 & ~x21 & ~x23;
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (~x25 ^ (~new_n60_ | x24)));
  assign z07 = x18 | (~x08 & ~x16) | (~new_n63_ & x16);
  assign new_n63_ = (~x26 | (~x25 & new_n60_ & ~x24)) & (~new_n60_ | x26 | x24 | x25);
  assign z08 = x18 | (~x07 & ~x16) | (~new_n65_ & x16);
  assign new_n65_ = (~x27 | (new_n60_ & new_n66_)) & (~new_n60_ | ~new_n67_);
  ...
  assign new_n70_ = new_n60_ & new_n66_ & ~x27 & ~x28;
  assign z10 = (x16 & (new_n72_ | (~new_n70_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n72_ = new_n60_ & new_n66_ & new_n73_ & ~x27;
  ...
  assign new_n78_ = ~x30 & ~x31 & new_n60_ & new_n66_ & new_n73_ & ~x27;
  assign new_n79_ = ~x27 & ~x28 & new_n60_ & new_n66_ & new_n80_ & ~x29;
  assign new_n80_ = ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n83_ | (~new_n82_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n82_ = new_n80_ & new_n60_ & new_n66_ & new_n73_ & ~x27;
  assign new_n83_ = new_n84_ & new_n60_ & new_n67_ & new_n73_ & ~x30;
