...
module FAU ( 
  ...
  wire new_n56_, new_n59_, new_n62_, new_n64_, new_n65_, new_n66_, new_n68_,
    new_n69_, new_n71_, new_n72_, new_n75_, new_n77_, new_n78_, new_n79_,
  ...
  assign new_n71_ = new_n59_ & new_n65_ & new_n72_ & ~x26;
  assign new_n72_ = ~x27 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & ((x29 & (~new_n68_ | ~new_n72_)) | (new_n68_ & new_n72_ & ~x29)));
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (~x30 ^ (~new_n68_ | ~new_n75_)));
  assign new_n75_ = new_n72_ & ~x29;
  assign z12 = (x16 & (new_n78_ | (~new_n77_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n77_ = ~x29 & ~x30 & new_n59_ & new_n65_ & new_n72_ & ~x26;
  assign new_n78_ = ~x26 & ~x27 & new_n59_ & new_n65_ & new_n79_ & ~x28;
  assign new_n79_ = ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n78_ | x32));
  assign z14 = (x16 & (new_n83_ | (~new_n82_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n82_ = new_n79_ & new_n59_ & new_n65_ & new_n72_ & ~x26;
  assign new_n83_ = new_n84_ & new_n59_ & new_n66_ & new_n72_ & ~x29;
  assign new_n84_ = ~x33 & ~x30 & ~x31;
  assign z15 = ~new_n86_ | (x16 & ((new_n78_ & ~x33 & ~x34) | (~new_n83_ & x34)));
