// Benchmark "FAU" written by ABC on Thu Jul 30 00:57:36 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n58_, new_n61_, new_n62_, new_n63_, new_n64_, new_n66_,
    ...
    new_n89_, new_n90_;
  assign z00 = (new_n54_ & x16) | x18 | (~x15 & ~x16);
  assign new_n54_ = ~x17 & ~x19;
  assign z01 = (x16 & (~x20 ^ (x17 | x19))) | x18 | (~x14 & ~x16);
  assign z02 = x18 | (~x13 & ~x16) | (x16 & ((x21 & (~new_n54_ | x20)) | (new_n54_ & ~x20 & ~x21)));
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n69_ | (~new_n66_ & x26)));
  assign new_n69_ = new_n64_ & new_n70_;
  assign new_n70_ = ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n72_ | (~new_n69_ & x27)));
  assign new_n72_ = new_n62_ & new_n63_ & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n74_ | (~new_n72_ & x28)));
  assign new_n74_ = new_n75_ & new_n58_ & ~x22;
  assign new_n75_ = ~x27 & ~x28 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n77_ | (~new_n74_ & x29)));
  assign new_n77_ = new_n64_ & new_n70_ & ~x29 & ~x27 & ~x28;
  assign z11 = x18 | (~x04 & ~x16) | (~new_n79_ & x16);
  assign new_n79_ = (~x30 | (new_n64_ & new_n70_ & ~x29 & ~x27 & ~x28)) & (~new_n64_ | ~new_n70_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n83_ | (~new_n81_ & x31)));
  assign new_n81_ = new_n64_ & new_n70_ & new_n82_;
  assign new_n82_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n83_ = new_n62_ & new_n63_ & new_n84_ & ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n86_ | (~new_n83_ & x32)));
  assign new_n86_ = new_n62_ & new_n63_ & new_n82_ & new_n87_;
  assign new_n87_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n89_ | (~new_n86_ & x33)));
  assign new_n89_ = new_n58_ & new_n67_ & new_n84_ & new_n90_;
