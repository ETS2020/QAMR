...
module FAU ( 
  ...
  assign new_n60_ = (~x21 | (~x20 & ~x17 & ~x19)) & (x19 | x21 | x17 | x20);
  assign z12 = (~new_n62_ & x16) | ((x03 | ~x18) & ~x16 & (x11 | x18));
  assign new_n62_ = (~x22 | (~x19 & ~x21 & ~x17 & ~x20)) & (x20 | x17 | x19 | x21 | x22);
  assign z13 = ((x04 | ~x18) & ~x16 & (x12 | x18)) | ((~new_n64_ | ~x23) & x16 & (new_n64_ | x23));
  assign new_n64_ = ~x20 & ~x17 & ~x19 & ~x21 & ~x22;
  assign z14 = new_n68_ | (x16 & ((x24 & (~new_n66_ | ~new_n67_)) | x19 | (new_n66_ & new_n67_ & ~x24)));
  assign new_n66_ = ~x21 & ~x17 & ~x20;
  assign new_n67_ = ~x22 & ~x23;
  assign new_n68_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = new_n70_ | (x16 & ((x25 & (~new_n66_ | ~new_n67_ | x24)) | (new_n66_ & new_n67_ & ~x24 & ~x25)));
  assign new_n70_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = new_n73_ | ((~x26 | ~new_n66_ | ~new_n72_) & x16 & (x26 | (new_n66_ & new_n72_)));
