// Benchmark "FAU" written by ABC on Wed Jul 29 23:43:02 2020
...
module FAU ( 
  ...
  assign z14 = new_n66_ | ((~x24 | ~new_n62_ | x22 | x23) & x16 & (x24 | (new_n62_ & ~x22 & ~x23)));
  assign new_n66_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = new_n70_ | (x16 & ((new_n62_ & new_n68_) | (~new_n69_ & x25)));
  assign new_n68_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n69_ = ~x23 & ~x24 & ~x20 & ~x21 & ~x17 & ~x22;
  assign new_n70_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = ~new_n72_ & ((~x26 & new_n62_ & new_n68_) | ~x16 | (x26 & (~new_n62_ | ~new_n68_)));
  assign new_n72_ = (~x07 | ~x18) & ~x16 & (~x15 | x18);
  assign z17 = x16 & ((new_n74_ & new_n75_) | (x17 & x27));
  assign new_n74_ = x19 & ~x26 & ~x17 & ~x22;
