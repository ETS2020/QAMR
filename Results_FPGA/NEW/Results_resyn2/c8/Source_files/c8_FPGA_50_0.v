...
module FAU ( 
  ...
  assign z13 = (x16 & (new_n64_ ^ x23)) | ((x04 | ~x18) & ~x16 & (x12 | x18));
  assign new_n64_ = ~x20 & ~x17 & ~x19 & ~x21 & ~x22;
  assign z14 = new_n66_ | (x16 & ((x24 & (~new_n64_ | x23)) | (new_n64_ & ~x23 & ~x24)));
  assign new_n66_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = ~new_n69_ & (~x16 | ((~new_n64_ | ~new_n68_) & (new_n58_ | x25)));
  assign new_n68_ = ~x23 & ~x24;
  assign new_n69_ = (~x06 | ~x18) & ~x16 & (~x14 | x18);
  assign z16 = x16 ? x26 : (x18 ? x07 : x15);
  assign z17 = x16 & ((x17 & x27) | (new_n72_ & new_n73_));
  assign new_n72_ = ~x17 & ~x20 & ~x25 & ~x26;
