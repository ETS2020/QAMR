...
module FAU ( 
  ...
  assign z14 = new_n67_ | (x16 & ((x24 & (x23 | ~new_n60_ | ~new_n64_)) | (new_n60_ & new_n64_ & ~x23 & ~x24)));
  assign new_n67_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = new_n70_ | (x16 & (~x25 ^ (~new_n60_ | ~new_n69_)));
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n70_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = new_n72_ | (new_n73_ & (x25 | ~new_n60_ | ~new_n69_));
  assign new_n72_ = (x07 | ~x18) & ~x16 & (x15 | x18);
  assign new_n73_ = x16 & (x26 | (~x17 & ~x19));
  assign z17 = x16 & ((x17 & x27) | (new_n69_ & new_n75_ & ~x17 & ~x20));
