...
module FAU ( 
  ...
  assign new_n62_ = (~x22 | (~x21 & ~x20 & ~x17 & ~x19)) & (x17 | x19 | x22 | x20 | x21);
  ...
  assign z15 = ~new_n69_ & ((~x25 & new_n64_ & new_n68_) | ~x16 | (x25 & (~new_n64_ | ~new_n68_)));
  assign new_n68_ = ~x23 & ~x24;
  assign new_n69_ = (~x06 | ~x18) & ~x16 & (~x14 | x18);
  assign z16 = ~new_n72_ & (~x16 | (~new_n71_ & (x25 | ~new_n64_ | ~new_n68_)));
  assign new_n71_ = ~x26 & (x17 | x19);
