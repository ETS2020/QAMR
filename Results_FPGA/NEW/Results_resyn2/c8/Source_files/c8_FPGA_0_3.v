...
module FAU ( 
  ...
  assign z15 = new_n70_ | (x16 & ((new_n62_ & new_n69_) | (x25 & (~new_n62_ | ~new_n68_))));
  assign new_n68_ = ~x23 & ~x24;
  assign new_n69_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n70_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = ~new_n72_ & ((~x26 & new_n62_ & new_n69_) | ~x16 | (x26 & (~new_n62_ | ~new_n69_)));
  assign new_n72_ = (~x07 | ~x18) & ~x16 & (~x15 | x18);
  assign z17 = x16 & ((new_n69_ & new_n74_) | (x17 & x27));
