...
module FAU ( 
  ...
  assign new_n120_ = ~x66 & ((new_n121_ & x00 & x70) | ((new_n121_ | new_n122_) & x48 & ~x70));
  assign new_n121_ = ~x68 & x69;
  assign new_n122_ = ~x67 & x68;
  ...
  assign new_n135_ = ~x71 & ((~new_n123_ & ~new_n137_) | (~new_n136_ & ~x66));
  ...
  assign new_n154_ = ~x66 & (new_n155_ | (~new_n149_ & new_n122_ & ~x70));
  ...
  assign new_n171_ = ~x71 & (new_n173_ | (~x66 & (new_n174_ | (new_n172_ & ~new_n165_))));
  ...
  assign new_n190_ = ~x66 & (~x70 | (new_n121_ & x04));
  ...
  assign new_n207_ = ~x66 & (~x70 | (new_n121_ & x05));
  ...
  assign new_n222_ = ~x71 & ((~new_n123_ & ~new_n224_) | (~new_n223_ & ~x66));
  ...
  assign new_n238_ = ~x71 & ((~new_n123_ & ~new_n240_) | (~new_n239_ & ~x66));
  ...
  assign new_n254_ = ~new_n257_ & (x71 | (~new_n256_ & (new_n255_ | x66)));
  ...
  assign new_n270_ = ~x71 & ((~new_n123_ & ~new_n272_) | (~new_n271_ & ~x66));
  ...
  assign new_n287_ = ~new_n290_ & (x71 | (~new_n289_ & (new_n288_ | x66)));
  ...
  assign new_n294_ = ~x71 & ((~new_n123_ & ~new_n299_) | (~new_n295_ & ~x66));
  ...
  assign new_n324_ = ~x71 & ((~new_n123_ & ~new_n326_) | (~new_n325_ & ~x66));
  ...
  assign new_n342_ = ~new_n345_ & (x71 | (~new_n344_ & (new_n343_ | x66)));
  ...
  assign new_n348_ = new_n209_ & (new_n354_ | (~x71 & (new_n353_ | (~new_n349_ & ~x66))));
  ...
  assign new_n374_ = ~x71 & ((~new_n123_ & ~new_n376_) | (~new_n375_ & ~x66));
