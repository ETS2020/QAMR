// Benchmark "FAU" written by ABC on Sat Aug  1 16:20:18 2020
...
module FAU ( 
  ...
  assign z10 = (~x64 & (new_n236_ | (~new_n238_ & ~new_n110_ & x65))) | (x64 & ~x65 & (new_n245_ | (~new_n238_ & new_n110_)));
  assign new_n236_ = new_n123_ & (new_n237_ | ((~x00 | ~x10) & (x00 | x10) & ~x70 & x71));
  assign new_n237_ = (~x42 | ~x32 | (new_n104_ & ~x43)) & new_n96_ & (x42 | (x32 & (~new_n104_ | x43)));
  assign new_n238_ = (x68 | ~x69 | ((new_n239_ | (x70 ^ ~x71)) & (new_n242_ | ~x70 | ~x71))) & (new_n242_ | ~x68 | x69 | x70 | x71);
  assign new_n239_ = (new_n240_ | x72) & ~new_n241_ & (~new_n116_ | ~x26);
  assign new_n240_ = (~x73 | (x74 ? ~x23 : ~x24)) & (~x25 | x73 | ~x74);
  assign new_n241_ = (x73 | (x21 & x74) | (x22 & ~x74)) & x72 & (~x73 | (x18 & ~x74));
  assign new_n242_ = (new_n243_ | x72) & ~new_n244_ & (~new_n116_ | ~x58);
  assign new_n243_ = (~x73 | (x74 ? ~x55 : ~x56)) & (~x57 | x73 | ~x74);
  assign new_n244_ = (x73 | (x53 & x74) | (x54 & ~x74)) & x72 & (~x73 | (x50 & ~x74));
  assign new_n245_ = (~x66 | ~x67) & (x66 | x67) & ((~new_n108_ & x42) | (~new_n246_ & ~x68));
  assign new_n246_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x58 | ~x69) & (~x26 | x69 | ~x70 | x71);
  assign z11 = (~new_n248_ & ~x64) | (~new_n258_ & x64 & ~x65);
  assign new_n248_ = (new_n110_ | ((new_n249_ | ~x65) & (new_n256_ | ~new_n98_))) & (new_n256_ | ~new_n105_);
  assign new_n249_ = (x68 | ~x69 | ((new_n250_ | (x70 ^ ~x71)) & (new_n253_ | ~x70 | ~x71))) & (new_n253_ | ~x68 | x69 | x70 | x71);
  assign new_n250_ = (new_n251_ | x72) & ~new_n252_ & (~new_n116_ | ~x27);
  assign new_n251_ = (~x73 | (x74 ? ~x24 : ~x25)) & (~x26 | x73 | ~x74);
  assign new_n252_ = (x73 | (x22 & x74) | (x23 & ~x74)) & x72 & (~x73 | (x19 & ~x74));
  assign new_n253_ = (new_n254_ | x72) & ~new_n255_ & (~new_n116_ | ~x59);
  assign new_n254_ = (~x73 | (x74 ? ~x56 : ~x57)) & (~x58 | x73 | ~x74);
  assign new_n255_ = (x73 | (x54 & x74) | (x55 & ~x74)) & x72 & (~x73 | (x51 & ~x74));
  assign new_n256_ = (new_n257_ | x70 | ~x71) & ((~x43 & (new_n104_ | ~x32)) | ~x70 | x71 | (x43 & ~new_n104_ & x32));
  assign new_n257_ = ~new_n162_ & x00;
  assign new_n258_ = (new_n249_ | x66 | x67) & (new_n259_ | (~x66 & ~x67) | (x66 & x67));
  assign new_n259_ = (new_n108_ | ~x43) & (new_n260_ | x68);
  assign new_n260_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (~x27 | x69 | ~x70 | x71);
  assign z12 = ~new_n262_ & (~new_n279_ | (~new_n273_ & ~new_n110_ & (new_n276_ | ~new_n278_)));
  assign new_n262_ = x64 & (x65 | ((new_n263_ | x66 | x67) & (new_n270_ | (x66 & x67) | (~x66 & ~x67))));
  assign new_n263_ = (x68 | ~x69 | ((new_n264_ | (x70 ^ ~x71)) & (new_n267_ | ~x70 | ~x71))) & (new_n267_ | ~x68 | x69 | x70 | x71);
  assign new_n264_ = (new_n265_ | ~x72) & ~new_n266_ & (~new_n116_ | ~x28);
  assign new_n265_ = (x73 | (x74 ? ~x23 : ~x24)) & (~x20 | ~x73 | x74);
  assign new_n266_ = (~x73 | (x26 & ~x74) | (x25 & x74)) & ~x72 & (x73 | (x27 & x74));
  assign new_n267_ = (new_n268_ | ~x72) & ~new_n269_ & (~new_n116_ | ~x60);
  assign new_n268_ = (x73 | (x74 ? ~x55 : ~x56)) & (~x52 | ~x73 | x74);
  assign new_n269_ = (~x73 | (x58 & ~x74) | (x57 & x74)) & ~x72 & (x73 | (x59 & x74));
  assign new_n270_ = (~x44 | ~x68 | x69 | x70 | x71) & (new_n271_ | x68);
  assign new_n271_ = (new_n272_ | ~x70) & (x70 | x71 | ~x60 | ~x69) & (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71)));
  assign new_n272_ = (~x28 | x69 | x71) & (~x44 | ~x71);
  assign new_n273_ = ~new_n274_ & x70 & (~new_n98_ | ~new_n275_);
  assign new_n274_ = (~new_n267_ | ~x71) & new_n120_ & (~new_n264_ | x71);
  assign new_n275_ = (~x44 | ~x32 | (~x45 & ~x46 & ~x47)) & ~x71 & (x44 | (x32 & (x45 | x46 | x47)));
  assign new_n276_ = x68 & ~x69 & ((new_n277_ & ~x65 & x71) | (~new_n267_ & x65 & ~x71));
  assign new_n277_ = x12 ^ (x00 & (x13 | x14 | x15));
  assign new_n278_ = ~x70 & (new_n264_ | ~new_n120_ | ~x71);
  assign new_n279_ = ~x64 & (~new_n105_ | ((~new_n275_ | ~x70) & (~new_n277_ | x70 | ~x71)));
  assign z13 = ~new_n281_ & (~new_n298_ | (~new_n292_ & ~new_n110_ & (new_n295_ | ~new_n297_)));
  assign new_n281_ = x64 & (x65 | ((new_n282_ | x66 | x67) & (new_n289_ | (x66 & x67) | (~x66 & ~x67))));
  assign new_n282_ = (x68 | ~x69 | ((new_n283_ | (x70 ^ ~x71)) & (new_n286_ | ~x70 | ~x71))) & (new_n286_ | ~x68 | x69 | x70 | x71);
  assign new_n283_ = (new_n284_ | ~x72) & ~new_n285_ & (~new_n116_ | ~x29);
  assign new_n284_ = (x73 | (x74 ? ~x24 : ~x25)) & (~x21 | ~x73 | x74);
  assign new_n285_ = (~x73 | (x27 & ~x74) | (x26 & x74)) & ~x72 & (x73 | (x28 & x74));
  assign new_n286_ = (new_n287_ | ~x72) & ~new_n288_ & (~new_n116_ | ~x61);
  assign new_n287_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n288_ = (~x73 | (x59 & ~x74) | (x58 & x74)) & ~x72 & (x73 | (x60 & x74));
  assign new_n289_ = (~x45 | ~x68 | x69 | x70 | x71) & (new_n290_ | x68);
  assign new_n290_ = (new_n291_ | ~x70) & (x70 | x71 | ~x61 | ~x69) & (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71)));
  assign new_n291_ = (~x29 | x69 | x71) & (~x45 | ~x71);
  assign new_n292_ = ~new_n293_ & x70 & (~new_n98_ | ~new_n294_);
  assign new_n293_ = (~new_n286_ | ~x71) & new_n120_ & (~new_n283_ | x71);
  assign new_n294_ = (x45 | (x32 & (x46 | x47))) & ~x71 & (~x45 | ~x32 | (~x46 & ~x47));
  assign new_n295_ = x68 & ~x69 & ((new_n296_ & ~x65 & x71) | (~new_n286_ & x65 & ~x71));
  assign new_n296_ = ~x13 ^ (~x00 | (~x14 & ~x15));
  assign new_n297_ = ~x70 & (new_n283_ | ~new_n120_ | ~x71);
  assign new_n298_ = ~x64 & (~new_n105_ | ((~new_n294_ | ~x70) & (~new_n296_ | x70 | ~x71)));
  assign z14 = (new_n300_ | ~x64) & (new_n311_ | x64 | (~new_n317_ & new_n105_));
  assign new_n300_ = ~x65 & ((~new_n301_ & ~x66 & ~x67) | (~new_n308_ & (~x66 | ~x67) & (x66 | x67)));
  assign new_n301_ = (x68 | ~x69 | ((new_n302_ | (x70 ^ ~x71)) & (new_n305_ | ~x70 | ~x71))) & (new_n305_ | ~x68 | x69 | x70 | x71);
  assign new_n302_ = (new_n303_ | x72) & ~new_n304_ & (~new_n116_ | ~x30);
  assign new_n303_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n304_ = (x73 | (x25 & x74) | (x26 & ~x74)) & x72 & (~x73 | (x22 & ~x74));
  assign new_n305_ = (new_n306_ | x72) & ~new_n307_ & (~new_n116_ | ~x62);
  assign new_n306_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n307_ = (x73 | (x57 & x74) | (x58 & ~x74)) & x72 & (~x73 | (x54 & ~x74));
  assign new_n308_ = (~x46 | ~x68 | x69 | x70 | x71) & (new_n309_ | x68);
  assign new_n309_ = (new_n310_ | ~x70) & (x70 | x71 | ~x62 | ~x69) & (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71)));
  assign new_n310_ = (~x30 | x69 | x71) & (~x46 | ~x71);
  assign new_n311_ = ~new_n312_ & ~new_n110_ & (new_n314_ | ~new_n316_);
  assign new_n312_ = new_n313_ & ((new_n305_ & x71) | ~new_n120_ | (new_n302_ & ~x71));
  assign new_n313_ = x70 & (~new_n98_ | (~x46 & (~x32 | ~x47)) | x71 | (x46 & x32 & x47));
  assign new_n314_ = x68 & ~x69 & ((new_n315_ & ~x65 & x71) | (~new_n305_ & x65 & ~x71));
  assign new_n315_ = ~x14 ^ (~x00 | ~x15);
  assign new_n316_ = ~x70 & (new_n302_ | ~new_n120_ | ~x71);
  assign new_n317_ = (~new_n315_ | x70 | ~x71) & (~x70 | (~x46 & (~x32 | ~x47)) | x71 | (x46 & x32 & x47));
  assign z15 = (~new_n326_ & ~x68) | (~new_n319_ & x68 & ~x69);
  assign new_n319_ = (new_n320_ | x64) & (new_n325_ | ~x64 | x65 | x70 | x71);
  assign new_n320_ = ~new_n321_ & (new_n322_ | new_n110_ | x70 | ~x65 | x71);
  assign new_n321_ = ~new_n124_ & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n322_ = (new_n323_ | ~x72) & (new_n324_ | x72) & (~new_n116_ | ~x63);
  assign new_n323_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n324_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n325_ = (new_n322_ | x66 | x67) & (~x47 | (~x66 & ~x67) | (x66 & x67));
  assign new_n326_ = ~new_n327_ & (~new_n333_ | ((new_n322_ | ~x70 | ~x71) & (new_n330_ | (x70 ^ ~x71))));
  assign new_n327_ = ~new_n328_ & x64 & ~x65 & (~x66 | ~x67) & (x66 | x67);
  assign new_n328_ = (new_n329_ | ~x70) & (x70 | x71 | ~x63 | ~x69) & (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71)));
  assign new_n329_ = (~x31 | x69 | x71) & (~x47 | ~x71);
  assign new_n330_ = (new_n331_ | x72) & (~new_n116_ | ~x31) & (new_n332_ | ~x72);
  assign new_n331_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n332_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n333_ = (x64 ? ~x65 : ~new_n110_) & x69 & (new_n110_ | x65);
endmodule
