...
module FAU ( 
  ...
  assign z25 = (~x37 & ~x39) | (~x10 & (x09 ? x37 : x36));
  assign z26 = (~x10 & (x09 ? x38 : x37)) | (~x37 & ~x39);
  assign z27 = ~new_n114_ & ~x10;
  assign new_n114_ = x09 ? ((~x00 | (~x39 & (~x14 | ~x37))) & (x14 | ~x39)) : (~x38 | (~x37 & ~x39));
  assign z28 = (~x37 & ~x39) | (~x10 & ((x40 & (x39 | (x09 & ~x14))) | (x39 & (~x09 | x14))));
