...
module FAU ( 
  ...
  assign z15 = ~x10 & ((x26 & (x27 ? ~x38 : ~x08)) | (x08 & x27 & ~x38));
  assign z16 = (x27 & x38) | (~x10 & (x08 ? x28 : x27));
  ...
  assign z25 = ~x10 & (x09 ? (x37 & (~x38 | (~x27 & x38))) : (x36 & (~x27 | ~x38)));
  assign z26 = ~x10 & (x09 ? (~x27 & x38) : (x37 & (~x27 | ~x38)));
  assign z27 = (x27 & x38) | (~x10 & (x09 ? ~new_n114_ : x38));
