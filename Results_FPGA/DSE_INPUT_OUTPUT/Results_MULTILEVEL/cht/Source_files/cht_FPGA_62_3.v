...
module FAU ( 
  ...
  assign new_n114_ = x09 ? ((~x00 | (x39 ? x46 : ~x14)) & (x14 | ~x39 | x46)) : (~x38 | (x39 & x46));
  assign z28 = ~x10 & ((x40 & ((x39 & ~x46) | (x09 & ~x14 & ~x39))) | (x39 & ~x46 & (~x09 | x14)));
  ...
  assign z34 = ~x10 & ((~x39 & x46 & (x45 | (x09 & ~x14))) | (x45 & ~x46 & (~x09 | x14)));
