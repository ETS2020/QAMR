...
module FAU ( 
  ...
  assign z01 = x10 ? x03 : (x07 ? x05 : x12);
  assign z02 = x10 ? x03 : (x07 ? x06 : x13);
  assign z03 = x10 ? x03 : (x07 ? x01 : x14);
  assign z04 = ~x10 & (x07 ? x02 : x15);
  assign z05 = ~x10 & (x07 ? x03 : x16);
  assign z06 = x10 ? x03 : (x08 ? x18 : x17);
  assign z07 = x10 ? x03 : (x08 ? x19 : x18);
  assign z08 = x10 ? x03 : (x08 ? x20 : x19);
  assign z09 = ~x10 & (x08 ? x21 : x20);
  assign z10 = ~x10 & (x08 ? x22 : x21);
  assign z11 = x10 ? x03 : (x08 ? x23 : x22);
  assign z12 = ~x10 & (x08 ? x24 : x23);
  assign z13 = x10 ? x03 : (x08 ? x25 : x24);
  assign z14 = ~x10 & (x08 ? x26 : x25);
  assign z15 = x10 ? x03 : (x08 ? x27 : x26);
  assign z16 = ~x10 & (x08 ? x28 : x27);
  assign z17 = x10 ? x03 : (x08 ? x29 : x28);
  assign z18 = ~x10 & (x08 ? x30 : x29);
  assign z19 = ~x10 & (x08 ? x00 : x30);
  assign z20 = ~x10 & (x09 ? x32 : x31);
  assign z21 = ~x10 & (x09 ? x33 : x32);
  assign z22 = x10 ? x03 : (x09 ? x34 : x33);
  assign z23 = x10 ? x03 : (x09 ? x35 : x34);
  assign z24 = ~x10 & (x09 ? x36 : x35);
  assign z25 = ~x10 & (x09 ? x37 : x36);
  assign z26 = ~x10 & (x09 ? x38 : x37);
  assign z27 = ~x10 & (x09 ? (x14 ? x00 : x39) : x38);
  assign z28 = x10 ? x03 : ((x39 & (~x09 | x14)) | (x09 & ~x14 & x40));
  assign z29 = x10 ? x03 : ((x40 & (~x09 | x14)) | (x09 & ~x14 & x41));
  assign z30 = ~x10 & ((x41 & (~x09 | x14)) | (x09 & ~x14 & x42));
  assign z31 = ~x10 & ((x42 & (~x09 | x14)) | (x09 & ~x14 & x43));
  assign z32 = x10 ? x03 : ((x43 & (~x09 | x14)) | (x09 & ~x14 & x44));
