// Benchmark "FAU" written by ABC on Tue Aug 18 16:41:51 2020
...
module FAU ( 
  ...
  assign z12 = ~x09 & x12;
  assign z05 = z12 | ~x13;
  assign z06 = (x12 & (~x09 | (x01 & ~x11))) | (x01 & ~new_n40_ & x09);
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~z12 & ~x15;
  assign z08 = ((new_n40_ | ~x09) & x12) | ~x00 | x10 | ~x11;
  assign z09 = (~x09 & x12) | (x00 & ~x10 & (~x11 ^ x12));
  assign z10 = x12 & (~x09 | (x00 & ~x10 & ~new_n40_ & x11));
