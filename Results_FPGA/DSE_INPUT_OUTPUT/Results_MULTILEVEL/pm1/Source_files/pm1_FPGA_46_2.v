// Benchmark "FAU" written by ABC on Tue Aug 18 16:41:19 2020
...
module FAU ( 
  ...
  assign z06 = x09 & (~x12 | (x01 & (~new_n40_ | ~x04 | ~x11)));
  assign new_n40_ = x02 & x03;
  assign z07 = ~x15 & (~x09 | x12);
  assign z08 = ((~new_n43_ | ~x00) & (~x09 | x12)) | (new_n40_ & x04 & x09 & x12);
  ...
  assign z11 = (~x12 & (x09 | (new_n43_ & x00 & ~x01))) | (x00 & x01 & new_n48_ & x09);
  assign new_n48_ = ~x10 & x11 & (~x02 | ~x03 | ~x04);
