// Benchmark "FAU" written by ABC on Tue Aug 18 16:41:40 2020
...
module FAU ( 
  ...
  assign z06 = (~x02 & (x12 | (x01 & x09))) | (x01 & ~new_n40_ & x09);
  assign new_n40_ = x03 & x04 & (x11 | ~x12);
  assign z07 = ~x15 | (~x02 & x12);
  assign z08 = new_n43_ | ~x00 | x10 | ~x11;
  assign new_n43_ = x12 & (~x02 | (x03 & x04 & x09));
  assign z09 = x00 & ~x10 & ((x02 & x11 & x12) | (~x11 & ~x12));
  assign z10 = x00 & new_n46_ & x02;
  assign new_n46_ = x09 & ~x10 & x11 & x12 & (~x03 | ~x04);
  assign z11 = (~x02 & x12) | (x00 & new_n48_ & ~x10);
  assign new_n48_ = x11 & (x01 ? (x09 & x12 & (~x03 | ~x04)) : ~x12);
