// Benchmark "FAU" written by ABC on Tue Aug 18 16:41:42 2020
...
module FAU ( 
  ...
  assign new_n42_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x12) & (x12 | x15);
  assign z09 = x00 & ~x10 & (x11 ? x12 : (~x12 & x15));
  assign z10 = (~x12 & ~x15) | (x00 & new_n45_ & x09);
  assign new_n45_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = new_n47_ | (x00 & x01 & new_n45_ & x09);
  assign new_n47_ = ~x12 & (~x15 | (~x10 & x11 & x00 & ~x01));
