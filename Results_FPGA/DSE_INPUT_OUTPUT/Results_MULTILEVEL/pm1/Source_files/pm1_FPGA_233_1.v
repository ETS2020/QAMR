// Benchmark "FAU" written by ABC on Tue Aug 18 16:42:34 2020
...
module FAU ( 
  ...
  assign new_n34_ = x04 & x05 & x06 & x07;
  assign z03 = ~new_n36_ | ~x11 | ~x12;
  assign new_n36_ = x09 & x04 & (~x07 | ~x08 | ~x05 | ~x06);
  ...
  assign z10 = x12 & (new_n46_ | ~x04);
  assign new_n46_ = x00 & x09 & ~x10 & (~x02 | ~x03) & x11;
  assign z11 = x00 & ~x10 & ~new_n48_ & x11;
  assign new_n48_ = x01 ? (~x04 | ~x09 | (x02 & x03) | ~x12) : x12;
  assign z12 = x12 & (~x04 | (~x10 & x11 & x00 & ~x09));
endmodule
