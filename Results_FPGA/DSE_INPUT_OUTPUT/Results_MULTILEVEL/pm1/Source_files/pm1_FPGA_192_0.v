...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n40_, new_n43_, new_n46_, new_n47_, new_n49_,
    new_n50_;
  assign z00 = x12 | (x04 & (x01 | x11));
  assign z01 = x12 ? x11 : x04;
  ...
  assign z08 = (~new_n43_ & (x04 | x12)) | (x02 & x03 & x04 & x09 & x12);
  assign new_n43_ = x00 & ~x10 & x11;
  assign z09 = x00 & ~x10 & ((x11 & x12) | (x04 & ~x11 & ~x12));
  assign z10 = (~x04 & (~x12 | (new_n46_ & x00 & x09))) | (x00 & new_n47_ & x09);
  assign new_n46_ = ~x10 & x11;
  assign new_n47_ = ~x10 & x11 & x12 & (~x02 | ~x03);
  assign z11 = (~new_n49_ & ~x04) | (x00 & new_n50_ & ~x10);
  assign new_n49_ = x12 & (~x00 | ~x01 | ~x09 | x10 | ~x11);
  assign new_n50_ = x11 & (x01 ? (x09 & (~x02 | ~x03) & x12) : ~x12);
