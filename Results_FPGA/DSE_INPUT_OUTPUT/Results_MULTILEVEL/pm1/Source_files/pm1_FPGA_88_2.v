// Benchmark "FAU" written by ABC on Tue Aug 18 16:41:36 2020
...
module FAU ( 
  ...
  assign z06 = x01 & x09 & ((~new_n40_ & (~x11 | x12)) | (~x11 & x12));
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~x15 | (x11 & ~x12);
  assign z08 = ~new_n43_ | ~x11 | ~x12;
  assign new_n43_ = ~x10 & x00 & (~x02 | ~x03 | ~x04 | ~x09);
  assign z09 = x00 & z01 & ~x10;
