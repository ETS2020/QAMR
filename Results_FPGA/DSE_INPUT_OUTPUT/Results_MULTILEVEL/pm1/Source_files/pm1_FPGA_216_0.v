// Benchmark "FAU" written by ABC on Tue Aug 18 16:42:27 2020
...
module FAU ( 
  ...
  assign z02 = (~x12 & (x08 | x11)) | ~x11 | (x11 & (~new_n34_ | ~x07 | ~x08 | ~x09));
  assign new_n34_ = x05 & x06;
  assign z03 = ~x11 | ~x12 | ~x09 | (new_n34_ & x07 & x08);
  assign z04 = ~x14 & (x08 | x11);
  assign z05 = ~x13 & (x08 | x11);
  assign z06 = (~x11 & (~x08 | (x01 & x09 & x12))) | (x01 & ~new_n39_ & x09);
  assign new_n39_ = x02 & x03 & x04;
  assign z07 = ~x15 | (~x08 & ~x11);
  assign z08 = x11 ? (~new_n42_ | ~x00) : x08;
  assign new_n42_ = ~x10 & (~x02 | ~x03 | ~x04 | ~x09 | ~x12);
  assign z09 = x00 & ~x10 & ((x11 & x12) | (x08 & ~x11 & ~x12));
  assign z10 = (~x08 & ~x11) | (x00 & x09 & ~x10 & new_n45_ & x11);
  assign new_n45_ = x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (~x08 & ~x11) | (x00 & ~x10 & ~new_n47_ & x11);
