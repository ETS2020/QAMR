...
module FAU ( 
  ...
  assign new_n36_ = x09 & x04 & (~x05 | ~x06 | ~x07 | ~x08);
  ...
  assign new_n43_ = x12 & (~x04 | (x02 & x03 & x09));
  assign z09 = (~x04 & x12) | (x00 & ~x10 & (~x11 ^ x12));
  assign z10 = x00 & new_n46_ & x04;
  assign new_n46_ = x09 & ~x10 & x11 & x12 & (~x02 | ~x03);
  assign z11 = (~x04 & x12) | (x00 & new_n48_ & ~x10);
  assign new_n48_ = x11 & (x01 ? (x09 & x12 & (~x02 | ~x03)) : ~x12);
