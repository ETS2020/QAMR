// Benchmark "FAU" written by ABC on Tue Aug 18 16:41:28 2020
...
module FAU ( 
  ...
  assign z06 = x01 & x09 & ((~x11 & x12) | (~new_n40_ & (~x10 | x12)));
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~x15 | (x10 & ~x12);
  assign z08 = (~x10 & (~x00 | ~x11)) | (x12 & (new_n43_ | x10));
