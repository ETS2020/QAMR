...
module FAU ( 
  ...
  assign z06 = (new_n40_ & x01) | (~x10 & ~x12);
  assign new_n40_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = ~x15 | (~x10 & ~x12);
  assign z08 = x10 | (~new_n43_ & x12);
  assign new_n43_ = x00 & x11 & (~x02 | ~x03 | ~x04 | ~x09);
  assign z09 = ~x10 & (~x12 | (x00 & x11));
  assign z10 = ~x10 & (~x12 | (new_n46_ & x00));
  assign new_n46_ = x09 & x11 & (~x02 | ~x03 | ~x04);
  assign z11 = ~x10 & (~x12 | (x00 & new_n46_ & x01));
