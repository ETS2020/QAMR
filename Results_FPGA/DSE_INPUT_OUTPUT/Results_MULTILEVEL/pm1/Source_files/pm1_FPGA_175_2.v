...
module FAU ( 
  ...
  assign z03 = ~new_n36_ | ~x12 | ~x13;
  assign new_n36_ = x11 & x09 & (~x07 | ~x08 | ~x05 | ~x06);
  assign z04 = x13 ? ~x14 : (x12 | (~x12 & ~x14));
  assign z05 = ~x12 & ~x13;
  assign z06 = (x12 & (~x13 | (x01 & x09 & ~x11))) | (x01 & ~new_n40_ & x09);
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~x15 & (~x12 | x13);
  assign z08 = new_n43_ | ((~x12 | x13) & (~x00 | x10 | ~x11));
  assign new_n43_ = x02 & x03 & x04 & x09 & x12 & x13;
  assign z09 = (x12 & ~x13) | (x00 & ~x10 & (~x11 ^ x12));
  assign z10 = x00 & x09 & new_n46_ & ~x10;
  assign new_n46_ = x11 & x12 & x13 & (~x02 | ~x03 | ~x04);
  assign z11 = (x12 & ~x13) | (x00 & ~x10 & ~new_n48_ & x11);
