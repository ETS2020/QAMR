...
module FAU ( 
  ...
  assign z00 = x11 | x12 | x01 | ~x07;
  assign z01 = x11 | ~x12;
  assign z02 = x12 ? (~x11 | (x11 & (~new_n34_ | ~x07 | ~x08 | ~x09))) : x07;
  ...
  assign new_n39_ = (x11 | ~x12) & ((x02 & x03 & x04) | (~x07 & ~x12));
  assign z07 = ~x15 | (~x07 & ~x12);
  assign z08 = ~new_n42_ | ~x00 | x10 | ~x11;
  assign new_n42_ = (x07 | x12) & (~x02 | ~x03 | ~x04 | ~x09 | ~x12);
  assign z09 = (~x07 & ~x12) | (x00 & ~x10 & (x11 ^ ~x12));
  assign z10 = (~x07 & ~x12) | (x00 & new_n45_ & x09);
