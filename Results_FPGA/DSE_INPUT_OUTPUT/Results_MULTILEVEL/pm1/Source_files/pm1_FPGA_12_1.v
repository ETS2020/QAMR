...
module FAU ( 
  ...
  assign z02 = (~new_n34_ & x11) | ~x03 | ~x11 | ~x12;
  assign new_n34_ = x05 & x06 & x07 & x08 & x09;
  assign z03 = ~new_n36_ | ~x11 | ~x12;
  assign new_n36_ = x09 & x03 & (~x07 | ~x08 | ~x05 | ~x06);
  assign z04 = ~x14 | (~x03 & x12);
  assign z05 = ~x13 | (~x03 & x12);
  assign z06 = (~x03 & ((x01 & x09) | x12)) | (x01 & ~new_n40_ & x09);
  ...
  assign z10 = x12 & (new_n46_ | ~x03);
  assign new_n46_ = x00 & x09 & ~x10 & (~x02 | ~x04) & x11;
  assign z11 = (~x03 & x12) | (x00 & new_n48_ & ~x10);
  assign new_n48_ = x11 & (x01 ? (x09 & (~x02 | ~x04) & x12) : ~x12);
