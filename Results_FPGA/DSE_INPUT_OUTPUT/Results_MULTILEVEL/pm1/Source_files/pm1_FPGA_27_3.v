...
module FAU ( 
  ...
  assign z06 = (x03 & x08) | (x01 & x09 & (~new_n40_ | ~x02 | ~x03));
  ...
  assign new_n46_ = x11 & x12 & (~x03 | (~x08 & (~x02 | ~x04)));
  assign z11 = (x03 & x08) | (x00 & ~x10 & ~new_n48_ & x11);
  assign new_n48_ = x01 ? (~x09 | ~x12 | (x02 & x03 & x04)) : x12;
  assign z12 = (x03 & x08) | (x00 & ~x09 & new_n34_ & ~x10);
endmodule
