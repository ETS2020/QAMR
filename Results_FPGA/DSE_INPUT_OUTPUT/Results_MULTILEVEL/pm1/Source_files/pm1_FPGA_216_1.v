...
module FAU ( 
  ...
  assign z02 = (x08 & (~x12 | (~new_n34_ & x11))) | ~x08 | ~x11;
  ...
  assign z06 = (new_n40_ & x01) | (~x08 & x11);
  assign new_n40_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = ~x15 | (~x08 & x11);
  assign z08 = ~x11 | (x08 & (~new_n43_ | ~x00));
  assign new_n43_ = ~x10 & (~x02 | ~x03 | ~x04 | ~x09 | ~x12);
  assign z09 = x00 & ~x10 & ((~x11 & ~x12) | (x08 & x11 & x12));
  assign z10 = x11 & (~x08 | (new_n46_ & x00));
  assign new_n46_ = x09 & ~x10 & (~x02 | ~x03 | ~x04) & x12;
  assign z11 = x11 & (~x08 | (x00 & ~new_n48_ & ~x10));
