...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n44_, new_n47_, new_n49_;
  ...
  assign z08 = ~new_n44_ | ~x00 | x10 | ~x11;
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x12) & (x12 | ~x13);
  assign z09 = (~x12 & x13) | (x00 & ~x10 & (~x11 ^ x12));
  assign z10 = (~x12 & x13) | (x00 & new_n47_ & x09);
  assign new_n47_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = x00 & ~x10 & x11 & (x01 ? new_n49_ : new_n32_);
