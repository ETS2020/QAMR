...
module FAU ( 
  ...
  assign z06 = x01 & x09 & ((~new_n39_ & (~x10 | ~x12)) | (~x10 & ~x11 & x12));
  assign new_n39_ = x02 & x03 & x04;
  assign z07 = ~x15 & (~x10 | ~x12);
  assign z08 = ~new_n42_ | x10 | ~x11;
  assign new_n42_ = x00 & (~x02 | ~x03 | ~x04 | ~x09 | ~x12);
  assign z09 = x00 & ~x10 & (~x11 ^ x12);
  assign z10 = x12 & (x10 | (x00 & x09 & ~x10 & ~new_n39_ & x11));
  assign z11 = (x10 & x12) | (x00 & x11 & (x01 ? new_n46_ : (~x10 & ~x12)));
