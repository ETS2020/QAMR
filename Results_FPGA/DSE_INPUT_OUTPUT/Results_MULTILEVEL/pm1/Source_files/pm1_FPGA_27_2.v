...
module FAU ( 
  ...
  wire new_n34_, new_n39_, new_n42_, new_n45_, new_n47_, new_n49_;
  ...
  assign z06 = (x03 & ~x08) | (x01 & x09 & (~new_n39_ | ~x02 | ~x03));
  ...
  assign new_n45_ = x11 & x12 & (~x03 | (x08 & (~x02 | ~x04)));
  assign z11 = (x03 & ~x08) | (x00 & ~x10 & ~new_n47_ & x11);
  assign new_n47_ = x01 ? (~x09 | ~x12 | (x02 & x03 & x04)) : x12;
  assign z12 = new_n49_ | (x03 & ~x08);
