...
module FAU ( 
  ...
  wire new_n32_, new_n37_, new_n40_, new_n44_;
  ...
  assign z06 = (~x11 & ((x01 & x09) | ~x12)) | (x01 & ~new_n37_ & x09);
  assign new_n37_ = x02 & x03 & x04;
  assign z07 = ~x15 | (~x11 & ~x12);
  assign z08 = (x11 & (~x00 | x10)) | (x12 & (new_n40_ | ~x11));
  assign new_n40_ = x04 & x09 & x02 & x03;
  assign z09 = x12 & x11 & x00 & ~x10;
  assign z10 = (~x11 & ~x12) | (x00 & x09 & ~x10 & x11 & ~new_n37_ & x12);
