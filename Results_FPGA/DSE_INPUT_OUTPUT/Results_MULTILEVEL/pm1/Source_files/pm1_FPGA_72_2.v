...
module FAU ( 
  ...
  assign z06 = x01 & x09 & x12 & (~new_n40_ | ~x04 | ~x11);
  assign new_n40_ = x02 & x03;
  assign z07 = ~x15 & (~x01 | x12);
  assign z08 = new_n43_ | ((~x01 | x12) & (~x00 | x10 | ~x11));
  assign new_n43_ = x02 & x03 & x04 & x09 & x12;
  assign z09 = x00 & ~x10 & ((x11 & x12) | (~x01 & ~x11 & ~x12));
  assign z10 = (x01 & ~x12) | (x00 & new_n46_ & x09);
  assign new_n46_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (~x12 & (x01 | (x00 & ~x10 & x11))) | (x00 & new_n48_ & x01);
  assign new_n48_ = x09 & ~x10 & x11 & (~x02 | ~x03 | ~x04);
  assign z12 = (x01 & ~x12) | (x00 & ~x09 & ~x10 & x11 & x12);
endmodule
