...
module FAU ( 
  ...
  assign z06 = (~x03 & (x01 | ~x09)) | (x01 & ~new_n40_ & x09);
  assign new_n40_ = x02 & x04 & (x11 | ~x12);
  assign z07 = ~x15 | (~x03 & ~x09);
  assign z08 = ~new_n43_ | x10 | ~x11;
  assign new_n43_ = x00 & (x03 | x09) & (~x02 | ~x03 | ~x04 | ~x09 | ~x12);
  assign z09 = (~x03 & ~x09) | (x00 & ~x10 & (~x11 ^ x12));
  assign z10 = (~x03 & (~x09 | (new_n36_ & x00 & ~x10))) | (x00 & x09 & new_n46_ & ~x10);
  assign new_n46_ = x11 & x12 & (~x02 | ~x04);
  assign z11 = x00 & ~x10 & ~new_n48_ & x11;
  assign new_n48_ = x01 ? (~x09 | ~x12 | (x02 & x03 & x04)) : (x12 | (~x03 & ~x09));
