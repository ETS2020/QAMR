// Benchmark "FAU" written by ABC on Tue Aug 18 16:41:24 2020
...
module FAU ( 
  ...
  assign z02 = x12 ? (~x11 | (x11 & (~x05 | ~x06 | ~new_n34_ | ~x07))) : x07;
  assign new_n34_ = x08 & x09;
  assign z03 = (x07 & (new_n36_ | ~x12)) | (x12 & (~x09 | ~x11));
  assign new_n36_ = x05 & x06 & x08;
  assign z04 = ~x14 | (~x07 & ~x12);
  assign z05 = ~x13 | (~x07 & ~x12);
  assign z06 = (new_n40_ & x01) | (~x07 & ~x12);
