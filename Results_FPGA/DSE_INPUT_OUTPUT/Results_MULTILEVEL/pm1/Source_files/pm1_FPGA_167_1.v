...
module FAU ( 
  ...
  assign z02 = (~new_n34_ & x11) | ~x08 | ~x11 | ~x12;
  assign new_n34_ = x07 & x09 & x05 & x06;
  assign z03 = new_n36_ | ~x12;
  assign new_n36_ = x08 & ((x05 & x06 & x07) | ~x09 | ~x11);
  ...
  assign new_n43_ = x12 & (~x08 | (x02 & x03 & x04 & x09));
  assign z09 = (~x08 & x12) | (x00 & ~x10 & (~x11 ^ x12));
  assign z10 = x00 & x08 & new_n46_ & x09;
