...
module FAU ( 
  ...
  assign z3 = new_n49_ | (~x7 & (~new_n47_ | (~new_n44_ & ~x6)));
  assign new_n44_ = x0 ? new_n46_ : new_n45_;
  assign new_n45_ = (~x3 | ~x8) & (~x1 | ~x2 | ~x4 | (~x3 & ~x8));
  assign new_n46_ = x5 & ((x3 & x8) | (x1 & x2 & x4));
  assign new_n47_ = (~x6 | (x0 ? (~x8 | (~new_n48_ & x3)) : (x5 | ((~x3 | x8) & (new_n48_ | (~x3 & x8)))))) & (~x0 | ~new_n48_ | x3);
  assign new_n48_ = ~x4 & (~x1 | x2);
  assign new_n49_ = x5 & ((~x6 & (x0 ? ~new_n51_ : ~new_n50_)) | (x0 & ~new_n52_ & x6));
  assign new_n50_ = (~x3 | ~x8) & (~x7 | (~x3 & ~x8) | (~x4 & (~x1 | ~x2)));
  assign new_n51_ = (x3 | x8) & (x4 | (x3 & x8) | (x1 & x2));
  assign new_n52_ = (x3 | ~x8) & (~x7 | (x3 & ~x8) | (x1 & ~x2 & x4));
  assign z4 = (~x0 & (new_n54_ | x5)) | (~new_n55_ & x5) | (~x5 & x7);
  assign new_n54_ = x6 & ((x3 & ~x8) | (~new_n48_ & (x3 | ~x8)));
