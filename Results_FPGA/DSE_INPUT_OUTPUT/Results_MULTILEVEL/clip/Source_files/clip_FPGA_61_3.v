...
module FAU ( 
  ...
  assign z2 = new_n31_ | new_n35_ | (~new_n34_ & ~x1);
  ...
  assign new_n35_ = ~x5 & (x6 ? (~new_n37_ & (~x3 ^ ~x8)) : ~new_n36_);
  assign new_n36_ = (~x0 | (~x3 & ~x8)) & ((x3 ^ ~x8) | ((x4 | x7) & (x2 | (x4 & x7))));
  assign new_n37_ = (x4 | ~x7) & (~x2 | (x4 & ~x7));
  assign z3 = (x0 & (~new_n39_ | (~new_n45_ & ~x6))) | ~new_n43_ | (~new_n41_ & ~x6);
  assign new_n39_ = (new_n40_ | ((x3 | (x4 & (~x6 | ~x7))) & (~x6 | ~x8 | (x4 & ~x7)))) & (x3 | ((x4 | ~x7) & (~x6 | ~x8))) & (~x7 | ~x8 | x4 | ~x6);
  assign new_n40_ = x1 & ~x2;
  assign new_n41_ = (~x3 | (~new_n42_ & (x0 | (~x8 & (~x4 | ~x7))))) & (~x8 | (~new_n42_ & (x0 | ~x4 | ~x7)));
  assign new_n42_ = x1 & x2 & (x4 | x7);
  assign new_n43_ = (~x1 | ~x5) & (x0 | x5 | new_n44_ | ~x6);
  assign new_n44_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign new_n45_ = ((x4 & x7) | (x3 & x8)) & ~x1 & x5 & (x3 | x8);
  assign z4 = (~x0 & ~x5 & ~new_n44_ & x6) | (~x1 & ~new_n47_ & x5);
  assign new_n47_ = (x4 | (x8 & (~x0 | x3))) & (x3 | (x7 & x8)) & (x7 | x8) & x0 & ~x6;
endmodule
