...
module FAU ( 
  ...
  assign z1 = new_n24_ | ~new_n27_ | (x1 & ~new_n30_ & (~x4 ^ x7));
  assign new_n24_ = ~x5 & (~new_n26_ | (x0 & x3 & ~new_n25_ & ~x6));
  assign new_n25_ = ~x4 & ~x7;
  assign new_n26_ = (~x6 | ((~x1 | x2 | (~x4 ^ ~x7)) & (~x2 | (x4 ^ ~x7)))) & ~x8 & (x1 | (x4 ^ ~x7));
  assign new_n27_ = (new_n28_ | ((~x0 | (x1 & (~x2 | ~x6))) & (x6 | (x1 & x2)))) & (new_n29_ | (x1 & (~x2 | ~x6)));
  ...
  assign new_n36_ = ~new_n37_ & (new_n38_ | (x3 ? (~x5 | ~x8) : x8)) & (x5 | x8 | ~x0 | ~x3);
  ...
  assign z3 = (~x6 & (x0 ? ~new_n42_ : ~new_n44_)) | ~new_n48_ | (~new_n45_ & x6);
  assign new_n42_ = (new_n43_ | (x3 & x8)) & x5 & (x8 | (x3 & (x1 | x4)));
  ...
  assign new_n48_ = (~x0 | ((x1 | x3 | x4) & (x5 | ~x8))) & (x3 | x5 | ~x8);
  assign z4 = new_n50_ | (x5 & (new_n52_ | ~x0 | x6));
  assign new_n50_ = ~x8 & (new_n51_ | (~x0 & ~new_n46_ & x6));
  assign new_n51_ = x5 & (((~x4 | ~x7) & (~x1 | ~x2)) | ~x3 | (~x4 & ~x7));
  assign new_n52_ = ~x3 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
endmodule
