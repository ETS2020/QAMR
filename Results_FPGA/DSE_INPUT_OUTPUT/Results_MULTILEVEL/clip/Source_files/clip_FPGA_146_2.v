...
module FAU ( 
  ...
  assign z3 = x0 ? (~new_n31_ & x5) : ((~new_n36_ & ~x6) | (new_n35_ & ~x5));
  assign new_n31_ = (new_n32_ | ~x6) & (~new_n34_ | x6) & (new_n33_ | x3);
  assign new_n32_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign new_n33_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n34_ = ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign new_n35_ = x6 & ((x3 & ~x8) | (~new_n26_ & (x3 | ~x8)));
  assign new_n36_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign z4 = (~new_n38_ & x5) | (~x0 & (new_n35_ | x5));
  assign new_n38_ = ((x4 & x7) | new_n39_ | (x3 & x8)) & (x3 | (x8 & (x4 | x7))) & ~x6 & (x4 | x7 | x8);
