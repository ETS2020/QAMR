...
module FAU ( 
  ...
  assign z4 = (~new_n46_ & ~x3) | (x5 & (new_n51_ | ~x0 | x6));
  assign new_n46_ = (x2 | (~new_n48_ & (new_n47_ | ~x5))) & ~new_n50_ & (new_n49_ | ~x5);
  assign new_n47_ = x4 & x7;
  assign new_n48_ = ~x0 & x1 & x6 & ~x8 & (x4 | ~x7);
  assign new_n49_ = x8 & (x4 | x7) & (x1 | (x4 & x7));
  assign new_n50_ = ~x0 & x4 & x6 & ~x7 & ~x8;
