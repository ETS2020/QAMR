...
module FAU ( 
  ...
  assign z1 = (~new_n23_ & x2) | (x7 & (new_n33_ | new_n29_ | ~new_n31_));
  ...
  assign new_n27_ = ((~x4 ^ x7) | (~x0 & x5)) & (x3 | (x4 ? (x7 | ~x8) : ~x7)) & (x4 | ~x7 | ~x8);
  assign new_n28_ = x0 & x4 & ~x5 & ~x7 & (x3 | x8);
  assign new_n29_ = ~new_n30_ & ((~x1 & ~x4) | (x1 & ~x2 & x4 & x6));
  assign new_n30_ = ~x0 & x5;
  assign new_n31_ = (x6 | (~new_n32_ & (x4 | (x1 & x2)))) & (x1 | x4 | ~x8);
  assign new_n32_ = x0 & ~x5 & (x3 | x8);
  assign new_n33_ = ~x3 & ((~x1 & ~x4) | (x1 & ~x2 & x4 & x6 & x8));
  assign z2 = (~new_n35_ & (~x3 ^ x8)) | new_n36_ | new_n38_ | ~new_n40_;
  assign new_n35_ = (~x4 | ((x6 | (~x1 & ~x7)) & (new_n30_ | ((~x1 | x2) & (~x6 | x7))))) & (x6 | ~x7 | ~x1 | ~x2);
  assign new_n36_ = x6 & ~new_n37_ & (x3 ? (~new_n30_ & ~x8) : x8);
  assign new_n37_ = (x1 | x2) & x4 & (~x2 | ~x7);
  assign new_n38_ = ~x6 & (new_n32_ | ~new_n39_);
  assign new_n39_ = (x7 | ~x8 | x1 | x3) & (~x3 | ((x8 | ((x1 | (x4 & x7)) & (x4 | (x2 & x7)))) & (x2 | ~x4 | ~x8)));
  assign new_n40_ = (x2 | (x7 & (x3 | x4 | ~x8))) & (x3 | x4 | ~x8 | (x1 & x7));
  assign z3 = (~new_n42_ & x0) | new_n49_ | (~x0 & (new_n46_ | (~new_n48_ & ~x6)));
  ...
  assign new_n48_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x1 | (~x4 & (~x2 | ~x7))) & (~x4 | (x2 & ~x7))));
  assign new_n49_ = ~x2 & ~x7;
  assign z4 = ~new_n51_ | (~x0 & (x5 | (~new_n53_ & x6)));
  assign new_n51_ = ~new_n49_ & (~x5 | ((new_n52_ | (x3 & x8)) & ~x6 & (x3 | x8)));
  assign new_n52_ = (x1 | (x4 & x7)) & (x4 | (x2 & x7));
  assign new_n53_ = (~x3 | x8) & (~x4 | (~x3 & x8) | (x7 & (~x1 | x2)));
endmodule
