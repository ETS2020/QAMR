...
module FAU ( 
  ...
  assign z3 = x0 ? (x5 & (~new_n31_ | (~new_n36_ & x6))) : ~new_n34_;
  assign new_n31_ = ~new_n33_ & (new_n32_ | x3);
  assign new_n32_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n33_ = ~x6 & ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign new_n34_ = (x6 | ((~x3 | ~x8) & (new_n35_ | (~x3 & ~x8)))) & (x5 | ~x6 | ((~x3 | x8) & (new_n28_ | (~x3 & x8))));
  assign new_n35_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n36_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign z4 = new_n38_ | (~x0 & x5) | (x0 & (~x5 | (~new_n31_ & x5)));
  assign new_n38_ = x6 & ((~new_n28_ & (x3 | ~x8)) | x0 | (x3 & ~x8));
endmodule
