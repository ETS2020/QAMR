...
module FAU ( 
  ...
  assign z2 = (~new_n29_ & (x3 ^ ~x8)) | ~new_n32_ | new_n35_ | (~new_n34_ & (x3 ^ x8));
  ...
  assign z3 = (~x6 & (x0 ? ~new_n39_ : ~new_n37_)) | new_n43_ | (~new_n41_ & x6);
  assign new_n37_ = (~x2 | new_n38_ | (~x3 & ~x8) | (~x4 & ~x7)) & (~x3 | (~x8 & (~x4 | ~x7))) & (~x4 | ~x7 | ~x8);
  assign new_n38_ = ~x1 & ~x5;
  assign new_n39_ = ~new_n40_ & (x3 | x8) & x1 & x5;
  assign new_n40_ = (~x3 | ~x8) & ((~x4 & ~x7) | (~x2 & (~x4 | ~x7)));
  assign new_n41_ = x0 ? ((x3 | ~x8) & (new_n33_ | (x3 & ~x8))) : (new_n42_ | x5);
  assign new_n42_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign new_n43_ = ~new_n44_ & ~x1;
  assign new_n44_ = ~x5 & (~x0 | (x4 & ~x7) | (x3 & ~x8));
  assign z4 = (~new_n46_ & x5) | (~x0 & (x5 | (~x5 & ~new_n42_ & x6)));
  assign new_n46_ = ~new_n40_ & x1 & ~x6 & (x3 | x8);
endmodule
