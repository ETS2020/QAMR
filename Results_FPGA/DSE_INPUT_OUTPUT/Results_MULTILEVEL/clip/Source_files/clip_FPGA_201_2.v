...
module FAU ( 
  ...
  assign z2 = new_n29_ | (~new_n31_ & ~x6) | (~new_n33_ & x6) | (x1 & ~x5);
  ...
  assign z3 = ~new_n40_ | (~x6 & (x0 ? ~new_n38_ : ~new_n36_));
  assign new_n36_ = (new_n18_ | (x1 & ~x5)) & (~x1 | ~x2 | ~new_n37_ | ~x5);
  assign new_n37_ = (x3 | x8) & (x4 | x7);
  assign new_n38_ = (new_n39_ | (x3 & x8)) & (x1 | (x5 & (x4 | x8))) & (x3 | ~x5 | x8);
  assign new_n39_ = (~x5 | ((x4 | x7) & (x2 | (x4 & x7)))) & (x1 | x7);
  assign new_n40_ = (~x6 | ((~new_n42_ | ~x0) & (new_n41_ | x1))) & (~new_n43_ | ~x0 | x1);
  assign new_n41_ = x0 ? ((~x8 | (x4 & ~x7)) & (x3 | (~x7 & ~x8))) : (x5 | ((~x3 | (x8 & (~x4 | x7))) & (~x4 | x7 | x8)));
  assign new_n42_ = x5 & ((~x3 & x8) | ((~x3 | x8) & ((~x4 & x7) | (x2 & (~x4 | x7)))));
  assign new_n43_ = ~x3 & ~x4;
  assign z4 = (~x0 & (new_n47_ | x5)) | (x1 & ~x5) | (~new_n45_ & x5);
  assign new_n45_ = ((x4 & x7) | new_n46_ | (x3 & x8)) & (x3 | (x8 & (x4 | x7))) & ~x6 & (x4 | x7 | x8);
  assign new_n46_ = x1 & x2;
  assign new_n47_ = x6 & ((x3 & (~x8 | (x4 & ~x7))) | (x4 & ~x7 & ~x8));
endmodule
