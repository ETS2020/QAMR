...
module FAU ( 
  ...
  assign z2 = (~new_n34_ & x8) | new_n38_ | (~new_n41_ & ~x6) | (~x7 & ~x8);
  assign new_n34_ = (new_n35_ | ~x0) & (new_n37_ | ~x3) & (new_n36_ | x3);
  assign new_n35_ = (x5 | x6) & (~x1 | x2 | ~x3 | ~x4 | ~x6);
  assign new_n36_ = (x1 | (x4 & (~x6 | ~x7))) & (~x6 | ((x4 | ~x7) & (~x2 | (x4 & ~x7)))) & (x2 | x4 | x6);
  assign new_n37_ = (~x4 | x6 | ~x7) & (~x1 | ((~x2 | x6 | (~x4 & ~x7)) & (x5 | ~x6 | x2 | ~x4)));
  assign new_n38_ = (x0 | ~x5) & ((new_n40_ & x3) | (new_n39_ & x1));
  assign new_n39_ = ~x2 & (x3 ? (x6 & ~x7) : (x4 & ~x8));
  assign new_n40_ = x6 & ((x4 & ~x7) | (~x8 & (~x1 | x2 | ~x4)));
  assign new_n41_ = (new_n42_ | (x3 ? (x4 | x8) : x7)) & ~new_n43_ & (x3 | ((x4 | x7) & (x8 | (~new_n42_ & ~x4))));
  assign new_n42_ = x1 & x2;
  assign new_n43_ = x0 & x3 & ~x5;
  ...
  assign z4 = (~x0 & ((~new_n58_ & x6) | (~new_n57_ & x5))) | (x5 & (~new_n56_ | (~new_n57_ & x6)));
  assign new_n56_ = (new_n42_ | ((x4 | ~x7 | x8) & (x3 | (x7 ? x4 : ~x8)))) & (x3 | ((~x7 | x8) & (x4 | x7 | ~x8)));
  assign new_n57_ = ~x7 & ~x8;
  assign new_n58_ = (~x3 | ((~x1 | x2 | (x7 ? ~x4 : ~x8)) & (~x4 | x7 | ~x8) & (~x7 | x8))) & (~x1 | x2 | ~x4 | ~x7 | x8);
endmodule
