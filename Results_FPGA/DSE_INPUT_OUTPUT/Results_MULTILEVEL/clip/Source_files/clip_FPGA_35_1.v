...
module FAU ( 
  ...
  assign new_n39_ = x6 ? ((x3 | ~x8) & (~x7 | (x1 & ~x2) | (x3 & ~x8))) : ((x3 | x8) & (x7 | (x1 & x2) | (x3 & x8)));
  assign new_n40_ = (~x3 | x8) & (~x1 | x2 | x7);
  assign new_n41_ = (new_n42_ | (~x3 & ~x8)) & (~x3 | ~x8 | (x5 & (x0 | ~x4)));
  assign new_n42_ = (x0 | ~x4 | (~x7 & (~x1 | ~x2))) & (~x1 | ~x2 | x5 | ~x7);
  assign new_n43_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign z4 = (x4 & ((~x0 & (new_n45_ | x5)) | (~new_n46_ & x5))) | (~x0 & new_n47_ & ~x5);
  assign new_n45_ = x6 & ~new_n27_ & (new_n30_ | ~x7);
  assign new_n46_ = (x7 | (x1 & x2) | (x3 & x8)) & ~x6 & (x3 | x8);
