...
module FAU ( 
  ...
  assign new_n31_ = (new_n32_ | (x3 ? (x5 | x8) : ~x8)) & (new_n33_ | (x3 ? (~x8 | (~x0 & x5)) : (x5 | x8)));
  ...
  assign new_n39_ = x6 ? ((new_n33_ | (x8 & (~x3 | x5))) & (~x3 | x8)) : ((new_n35_ | (~x3 & ~x8)) & (~x3 | ~x8));
  assign new_n40_ = ~x3 & (new_n41_ | ~new_n42_);
  assign new_n41_ = ~x5 & ((x2 & (~x4 | x7)) | x8 | (x7 & (~x1 | ~x4)));
