...
module FAU ( 
  ...
  assign new_n38_ = x6 ? (x0 ? ~new_n41_ : ~new_n42_) : (x0 ? new_n40_ : new_n39_);
  assign new_n39_ = ~x8 & (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n40_ = x5 & (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign new_n41_ = ~x4 & x8 & (~x1 | x2);
  assign new_n42_ = ~x5 & ((x1 & ~x2 & (x4 | ~x7)) | ~x8 | (x4 & ~x7));
  assign new_n43_ = (~x6 | ((new_n45_ | (x3 & ~x8)) & (x3 | ~x8))) & (x5 | x6) & (x3 | (~new_n44_ & (x6 | x8)));
  assign new_n44_ = ~x4 & (~x1 | ~x2);
  assign new_n45_ = x1 & ~x2 & x4;
  assign new_n46_ = (~x1 | ((~x2 | x6 | ~x8) & (x2 | ~x4 | x5 | ~x6 | x8))) & (~x4 | x6 | ~x8);
  assign z4 = new_n48_ | (x7 & ((~new_n51_ & x5) | (~x0 & (new_n52_ | x5))));
  assign new_n48_ = x3 & ((~x0 & (x5 | (~new_n50_ & x6))) | (x5 & (new_n49_ | x6)));
  assign new_n49_ = ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign new_n50_ = x8 & (~x4 | x7) & (~x1 | x2 | (~x4 & x7));
  assign new_n51_ = ~x6 & (x3 | (~new_n44_ & x8));
