...
module FAU ( 
  ...
  assign new_n35_ = (x8 | (new_n34_ & (~new_n33_ | ~x6))) & (x4 | new_n36_ | ~x8);
  ...
  assign z4 = (x5 & (new_n49_ | ~new_n50_ | ~x0 | x6)) | (~x0 & ~x5 & ~new_n51_ & x6);
  assign new_n49_ = (~x3 | ~x8) & (~x1 | ~x2 | ~x4);
  assign new_n50_ = ~x7 & (x3 | x8);
