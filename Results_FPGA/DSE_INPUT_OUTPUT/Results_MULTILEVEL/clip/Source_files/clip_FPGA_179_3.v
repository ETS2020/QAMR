...
module FAU ( 
  ...
  assign new_n39_ = (new_n40_ | x7) & (x5 | (~new_n19_ & x6 & (~new_n41_ | ~x7)));
  assign new_n40_ = (x4 | (((x1 & ~x2) | (x3 & (~x6 | ~x8))) & (x6 | (x3 & x8)))) & (x6 | ((x3 | x8) & ((x1 & x2) | (x3 & x8)))) & (x3 | ~x6 | ~x8);
  ...
  assign z4 = (~x7 & ((~x0 & (new_n46_ | x5)) | (~new_n47_ & x5))) | (~x0 & new_n48_ & ~x5);
  assign new_n46_ = x6 & ~new_n19_ & (x4 | (x1 & ~x2));
  assign new_n47_ = ((x3 & x8) | (x1 & x2 & x4)) & ~x6 & (x3 | x8);
  assign new_n48_ = x6 & ((x3 & ~x8) | (x1 & ~x2 & x4 & (x3 | ~x8)));
endmodule
