...
module FAU ( 
  ...
  assign new_n24_ = (new_n25_ | (x1 & (~x2 | ~x6))) & (new_n26_ | x6) & (new_n27_ | ~x6);
  assign new_n25_ = x4 ? (x5 | x7) : (~x7 | (x5 & ~x8));
  assign new_n26_ = (~x1 | ~x2 | (~x4 ^ ~x7)) & ((~x4 ^ x7) | (x1 & x2));
  assign new_n27_ = x3 & (~x1 | x2 | x5 | (~x4 ^ ~x7));
  ...
  assign z4 = (~new_n43_ & ~x2) | (~new_n46_ & x5) | (~new_n45_ & x6);
  assign new_n43_ = ~new_n44_ & (x0 | ~x1 | ~x6 | (~x4 & x7));
  assign new_n44_ = x5 & (~x4 | ~x7) & (~x3 | ~x8);
  assign new_n45_ = x3 & ~x5 & (x0 | (x8 & (~x4 | x7)));
  assign new_n46_ = ((x3 & x8) | ((x4 | x7) & (x1 | (x4 & x7)))) & x0 & (x3 | x8);
endmodule
