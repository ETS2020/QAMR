...
module FAU ( 
  ...
  assign new_n26_ = (new_n27_ | ((x1 | x7) & (~x6 | ((~x1 | x2 | ~x7) & (~x2 | x7))))) & (x6 | ((x7 | (x1 & x2)) & (~x1 | ~x2 | ~x7)));
  ...
  assign z3 = (~new_n38_ & ~x0) | (~x4 & x5) | (x0 & (new_n41_ | ~new_n43_));
  assign new_n38_ = (x5 | ~x6 | ((~x3 | x8) & (new_n39_ | (~x3 & x8)))) & (x6 | ((~x3 | ~x8) & (new_n40_ | (~x3 & ~x8))));
  assign new_n39_ = (~x4 | x7) & (~x1 | x2 | (~x4 & x7));
  assign new_n40_ = (~x1 | ~x2 | ~x7) & ((~x4 & ~x5) | (~x7 & (~x1 | ~x2)));
  assign new_n41_ = ~x6 & (new_n42_ | ~x4 | ~x5 | (~x3 & ~x8));
  assign new_n42_ = ~x7 & (~x3 | ~x8) & (~x1 | ~x2);
  assign new_n43_ = ((x4 & (~x6 | ~x7)) | new_n32_ | (x3 & ~x8)) & (x3 | ((x4 | ~x7) & (~x6 | ~x8))) & (x4 | ~x7 | ~x8);
  assign z4 = (x4 & ((~x0 & (x5 | (new_n45_ & ~x5))) | (~new_n46_ & x5))) | (~x0 & new_n47_ & ~x5);
  assign new_n45_ = x6 & (new_n32_ | ~x7) & (x3 | ~x8);
  assign new_n46_ = ~new_n42_ & ~x6 & (x3 | x8);
