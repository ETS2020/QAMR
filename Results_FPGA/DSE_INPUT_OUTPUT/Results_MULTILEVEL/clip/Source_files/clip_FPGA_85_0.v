...
module FAU ( 
  ...
  assign z3 = new_n47_ | (x7 & (new_n44_ | (new_n28_ & x0) | (~new_n45_ & ~x0)));
  assign new_n44_ = x6 & (x0 ? ((~x3 & x8) | (~new_n42_ & (~x3 | x8))) : (~x5 & ~x8 & (new_n42_ | x3)));
  assign new_n45_ = ~new_n46_ & (~x1 | x2 | ~x3 | ~x4 | x5);
  assign new_n46_ = ~x6 & ((x3 & x8) | ((x3 | x8) & (x4 | (x1 & x2))));
  assign new_n47_ = x5 & ((~new_n50_ & x0) | (~x6 & (x0 ? ~new_n49_ : ~new_n48_)));
  assign new_n48_ = (~x3 | ~x8) & (~x1 | ~x2 | ~x4 | (~x3 & ~x8));
  assign new_n49_ = ((x3 & x8) | ((x2 | (x4 & x7)) & (x7 | (x1 & x4)))) & (x8 | (x3 & (x1 | x4)));
  assign new_n50_ = (x4 | ((x1 | (x3 & (~x6 | ~x8))) & (~x2 | ~x6 | (x3 & ~x8)))) & (x3 | ~x6 | ~x8);
  assign z4 = ~new_n54_ | new_n56_ | (~new_n52_ & ~x2);
  assign new_n52_ = ~new_n53_ & ((x3 & x8) | (x7 & (x4 | ~x5)));
  assign new_n53_ = ~x0 & x1 & x4 & x6 & (x3 | ~x8);
  assign new_n54_ = (new_n55_ | (x3 & x8)) & (x5 | x7) & (~x5 | (~x6 & (x3 | x8)));
  assign new_n55_ = (x4 | x7) & (x1 | (x7 & (x4 | ~x5)));
  assign new_n56_ = ~x0 & (x5 | (x3 & x6 & ~x8));
endmodule
