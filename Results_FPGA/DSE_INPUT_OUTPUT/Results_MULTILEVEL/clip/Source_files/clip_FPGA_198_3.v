...
module FAU ( 
  ...
  assign new_n29_ = x2 ? (x5 | x6 | (~x4 & ~x7)) : (~x6 | (~x0 & x5) | (~x4 & x7));
  ...
  assign new_n40_ = (x1 | (x4 & (~x6 | ~x7))) & (~x2 | (x4 & ~x7)) & (~x6 | ~x8) & (x4 | ~x7);
  ...
  assign z4 = new_n49_ | (new_n52_ & ~x0);
  assign new_n49_ = ~x2 & ((~new_n51_ & x5) | (~x0 & (x5 | (x1 & new_n50_ & ~x5))));
  assign new_n50_ = x6 & (x4 | ~x7) & (x3 | ~x8);
  assign new_n51_ = ((x4 & x7) | (x3 & x8)) & ~x6 & (x3 | x8);
  assign new_n52_ = ~x5 & x6 & ((x3 & (~x8 | (x4 & ~x7))) | (x4 & ~x7 & ~x8));
endmodule
