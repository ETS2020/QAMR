...
module FAU ( 
  ...
  assign new_n34_ = (new_n35_ | ~x2) & (~new_n36_ | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign new_n35_ = (~x4 | x7 | (x3 ^ x8)) & ((x4 & ~x7) | (~x3 ^ x8));
  ...
  assign new_n39_ = x1 & ~x5 & (x3 | ~x8) & (x4 | ~x7);
  ...
  assign new_n43_ = ~new_n44_ & (~x0 | (x4 & ~x7) | (x3 & ~x8));
  ...
  assign new_n47_ = x1 & x6 & (x3 | ~x8) & (x4 | ~x7);
  assign new_n48_ = ~x6 & (x3 | x8) & ((x4 & x7) | (x3 & x8));
