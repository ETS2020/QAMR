...
module FAU ( 
  ...
  assign new_n36_ = (new_n37_ | ~x3) & (x5 | (x6 & (new_n38_ | x3)));
  assign new_n37_ = x6 ? (~x8 | ((x4 | ~x7) & ((x4 & ~x7) | (x1 & ~x2)))) : (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign new_n38_ = ((x4 & ~x7) | (x1 & ~x2)) & ~x8 & (x4 | ~x7);
  assign new_n39_ = (new_n40_ | ((x5 | ~x8) & (x0 | ~x3))) & (x0 | ~x3 | ~x8);
  assign new_n40_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n41_ = (~x3 | x8) & (new_n34_ | (~x3 & x8));
  assign z4 = (x3 & ((~new_n45_ & x5) | (~x0 & (new_n44_ | x5)))) | (~x0 & new_n43_ & ~x5);
  assign new_n43_ = x6 & ~new_n34_ & ~x8;
  assign new_n44_ = x6 & (~x8 | (x4 & ~x7) | (x1 & ~x2 & (x4 | ~x7)));
  assign new_n45_ = ~x6 & (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
endmodule
