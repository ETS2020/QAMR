...
module FAU ( 
  ...
  assign z2 = new_n28_ | (x5 & (new_n30_ | new_n33_));
  assign new_n28_ = ~x6 & (~new_n29_ | (x0 & ~x5 & (x3 | x8)));
  assign new_n29_ = (((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))) | (~x3 ^ ~x8)) & ((x4 & x7) | (x1 & x2) | (x3 ^ ~x8)) & (x4 | x7 | (x3 ^ ~x8));
  assign new_n30_ = x6 & ((~new_n31_ & ((~x3 & x8) | (x0 & x3 & ~x8))) | (x0 & ~new_n32_ & (x3 ^ ~x8)));
  assign new_n31_ = (~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4));
  assign new_n32_ = (~x4 | x7) & (~x1 | x2 | (~x4 & x7));
  assign new_n33_ = ~x1 & ~x4 & ((~x3 & x8) | (x0 & x3 & ~x8));
  assign z3 = (~x5 & (x0 | x6)) | (~new_n35_ & x0) | (~x6 & (x0 ? (~new_n37_ & x5) : ~new_n38_));
  assign new_n35_ = (new_n36_ | ~x6) & (x4 | ~x5 | x1 | x3);
  ...
  assign z4 = x6 | (x5 & (~x0 | (x0 & ((~new_n40_ & ~x3) | (new_n41_ & ~x6)))));
  assign new_n40_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & (x4 | x7) & x8));
