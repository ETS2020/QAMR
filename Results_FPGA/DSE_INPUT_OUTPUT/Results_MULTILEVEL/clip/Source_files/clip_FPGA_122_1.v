...
module FAU ( 
  ...
  assign z3 = x0 ? ~new_n28_ : ((~new_n32_ & ~x6) | x5 | (~x5 & ~new_n33_ & x6));
  assign new_n28_ = (new_n29_ | ~x6) & (new_n31_ | x6) & (new_n30_ | x3);
  assign new_n29_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign new_n30_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n31_ = x5 & (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign new_n32_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign new_n33_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign z4 = (x6 & (x0 ? x5 : (~new_n33_ & ~x5))) | (x0 & ~new_n35_ & x5);
