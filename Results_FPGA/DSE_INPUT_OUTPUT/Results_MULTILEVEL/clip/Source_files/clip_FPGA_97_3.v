...
module FAU ( 
  ...
  assign z2 = new_n30_ | new_n33_ | new_n35_ | (x2 & (new_n37_ | x0));
  assign new_n30_ = (x3 ^ ~x8) & (new_n32_ | (~new_n31_ & x1));
  assign new_n31_ = (~x6 | (~x4 & x7) | (~x0 & (x2 | x5))) & (~x2 | x6 | (~x4 & ~x7));
  assign new_n32_ = x4 & (x6 ? (~x7 & (x0 | ~x5)) : x7);
  assign new_n33_ = ~x6 & (~new_n34_ | (x0 & ~x5 & (x3 | x8)));
  assign new_n34_ = ((x4 & x7) | ((x2 | (~x3 ^ x8)) & (x1 | ~x3 | x8))) & (x7 | (x3 ? (x4 | x8) : (~x8 | (x1 & x4))));
  assign new_n35_ = ~new_n36_ & ((~x1 & (~x4 | (x6 & x7))) | (~x4 & x6 & x7));
  assign new_n36_ = x3 ? (x8 | (~x0 & x5)) : ~x8;
  assign new_n37_ = x6 & (~x4 | x7) & (x3 ? (~x5 & ~x8) : x8);
  assign z3 = (~new_n39_ & x0) | (~x0 & ~x5 & ~new_n44_ & x6) | (~new_n42_ & ~x6);
  assign new_n39_ = (x6 | (x5 & (new_n40_ | ~x5))) & ~x2 & (new_n41_ | ~x6);
  assign new_n40_ = (x3 | x8) & ((x3 & x8) | (x4 & x7));
  assign new_n41_ = (x3 | ~x8) & ((x3 & ~x8) | ((x4 | ~x7) & (x1 | (x4 & ~x7))));
  assign new_n42_ = (~x3 | (~new_n43_ & (x0 | (~x8 & (~x4 | ~x7))))) & (~x8 | (~new_n43_ & (x0 | ~x4 | ~x7)));
  assign new_n43_ = x1 & x2 & (x4 | x7);
  assign new_n44_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign z4 = (x5 & (~x0 | x6 | (x0 & ~new_n40_ & ~x6))) | (x0 & x2) | (~x0 & ~new_n44_ & x6);
endmodule
