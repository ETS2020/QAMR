...
module FAU ( 
  ...
  assign new_n38_ = (new_n39_ | x7) & (x5 | (~new_n25_ & x6 & (~new_n40_ | ~x7)));
  assign new_n39_ = (x4 | (((x1 & ~x2) | (x3 & (~x6 | ~x8))) & (x6 | (x3 & x8)))) & (x6 | ((x3 | x8) & ((x1 & x2) | (x3 & x8)))) & (x3 | ~x6 | ~x8);
  ...
  assign new_n45_ = x6 & ~new_n25_ & (x4 | (x1 & ~x2));
  assign new_n46_ = ((x3 & x8) | (x1 & x2 & x4)) & ~x6 & (x3 | x8);
