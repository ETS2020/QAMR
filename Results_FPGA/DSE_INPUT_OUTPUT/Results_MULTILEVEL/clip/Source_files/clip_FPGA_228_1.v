...
module FAU ( 
  ...
  assign z3 = (~x6 & (x0 ? ~new_n36_ : ~new_n41_)) | (new_n38_ & x0);
  assign new_n36_ = ((x4 & x7) | new_n37_ | (x3 & x8)) & (x3 | ((x4 | x7) & x8)) & x5 & (x4 | x7 | x8);
  assign new_n37_ = x1 & x2;
  assign new_n38_ = x5 & (new_n40_ | (~new_n39_ & ~x3));
  ...
  assign z4 = ~new_n43_ & x5;
  assign new_n43_ = new_n44_ & ((x4 & x7) | new_n37_ | (x3 & x8));
  assign new_n44_ = (x3 | ((x4 | x7) & x8)) & x0 & ~x6 & (x4 | x7 | x8);
endmodule
