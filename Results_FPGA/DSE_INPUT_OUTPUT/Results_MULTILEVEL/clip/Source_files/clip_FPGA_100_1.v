...
module FAU ( 
  ...
  assign z2 = (~new_n35_ & (x3 ^ x8)) | (~new_n28_ & x6) | (~new_n32_ & ~x6);
  assign new_n28_ = (~x7 | new_n29_ | new_n30_) & (new_n31_ | (x3 ^ x8));
  assign new_n29_ = x1 & ~x2;
  assign new_n30_ = x3 ? (x8 | (x5 & (~x0 | ~x4))) : (~x4 | ~x8);
  assign new_n31_ = (~x4 | (~x0 & x5) | (x7 & (~x1 | x2))) & (~x1 | x2 | x5 | x7);
  assign new_n32_ = ~new_n34_ & (new_n33_ | x5);
  assign new_n33_ = (~x0 | (~x3 & ~x8)) & (~x1 | ~x2 | ~x7 | (x3 ^ x8));
  assign new_n34_ = x4 & (x7 | (x1 & x2)) & (x3 ^ ~x8);
  assign new_n35_ = (x1 | (x4 ? (x6 | x7) : x5)) & (x6 | ((x2 | (x4 ? x7 : x5)) & (x4 | x5 | x7))) & (x4 | x5 | ~x6 | (~x2 & ~x7));
  assign z3 = (~new_n37_ & x0) | (~new_n41_ & ~x6) | (~x0 & ~x5 & ~new_n43_ & x6);
  assign new_n37_ = (new_n39_ | ~x4) & (x5 | (new_n38_ & (~new_n40_ | x4)));
  ...
  assign new_n45_ = x6 & (new_n29_ | ~x7) & (x3 | ~x8);
