...
module FAU ( 
  ...
  assign z1 = new_n21_ | ~new_n23_ | (~new_n25_ & (x0 | (~x3 & x8)));
  assign new_n21_ = ~x6 & ((x1 & x2 & (x4 ^ ~x7)) | new_n22_ | ((x4 ^ x7) & (~x1 | ~x2)));
  assign new_n22_ = ~x5 & ((x3 & x8) | ((x4 | x7) & (x3 | x8)));
  assign new_n23_ = (x0 | x5) & (x4 | ~new_n24_ | ~x7);
  assign new_n24_ = (~x1 | (x2 & x6)) & (x0 | ~x3 | x8);
  assign new_n25_ = (~x6 | ((~x1 | x2 | (~x4 ^ ~x7)) & (~x2 | ~x4 | x7))) & (x1 | ~x4 | x7);
  assign z2 = new_n27_ | (x5 & ((~new_n31_ & ~x6) | (new_n32_ & ~x3)));
  assign new_n27_ = x0 & (x6 ? ~new_n30_ : (new_n28_ | new_n29_));
  assign new_n28_ = ~x3 & ~x8 & ((x4 & x7) | (x1 & x2 & (x4 | x7)));
  ...
  assign z3 = (~x5 & (~x0 | ~x6)) | (~x6 & (x0 ? ~new_n37_ : ~new_n38_)) | (~new_n34_ & x0);
  assign new_n34_ = ~new_n36_ & (new_n35_ | x3);
  assign new_n35_ = (x1 | (x4 & (~x6 | ~x7))) & (~x6 | ((~x2 | (x4 & ~x7)) & ~x8 & (x4 | ~x7)));
  assign new_n36_ = x6 & x8 & ((~x4 & x7) | ((~x1 | x2) & (~x4 | x7)));
  assign new_n37_ = ((x3 & x8) | ((x2 | (x4 & x7)) & (x7 | (x1 & x4)))) & (x8 | (x3 & (x1 | x4)));
  assign new_n38_ = (~x3 | ~x8) & (((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))) | (~x3 & ~x8));
  assign z4 = x5 & (new_n40_ | ~new_n41_);
  assign new_n40_ = (~x4 | ~x7) & (~x3 | ~x8) & (~x1 | ~x2);
  assign new_n41_ = (x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8) & x0 & ~x6;
endmodule
