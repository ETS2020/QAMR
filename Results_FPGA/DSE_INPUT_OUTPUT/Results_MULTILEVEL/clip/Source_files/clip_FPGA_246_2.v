...
module FAU ( 
  ...
  assign new_n35_ = (x6 | ((~x3 | ~x8) & (new_n36_ | (~x3 & ~x8)))) & (x5 | ~x6 | ((~x3 | x8) & (new_n29_ | (~x3 & x8))));
  assign new_n36_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n37_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign z4 = (x6 & (new_n39_ | new_n18_ | x0)) | (~x0 & x5) | (x0 & (~x5 | (~new_n32_ & x5)));
  assign new_n39_ = ~new_n29_ & (x3 | ~x8);
endmodule
