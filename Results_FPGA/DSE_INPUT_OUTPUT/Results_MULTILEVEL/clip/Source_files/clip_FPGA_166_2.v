...
module FAU ( 
  ...
  assign z2 = (~new_n29_ & x6) | (~x5 & (new_n36_ | (~new_n34_ & ~x6)));
  assign new_n29_ = (new_n30_ | new_n31_) & ~new_n33_ & (new_n32_ | (~x0 & x5));
  assign new_n30_ = x4 & ~x7;
  assign new_n31_ = ((x1 & ~x2) | ((x3 | ~x8) & (~x0 | ~x3 | x8))) & (~x2 | ~x3 | x5 | x8);
  assign new_n32_ = (((~x4 | x7) & (~x1 | x2 | (~x4 & x7))) | (~x3 ^ ~x8)) & (~x3 | x4 | ~x7 | x8);
  assign new_n33_ = x7 & ((~x3 & ~x4 & x8) | (~x1 & x3 & ~x5 & ~x8));
  assign new_n34_ = new_n35_ & (~x0 | (~x3 & ~x8));
  assign new_n35_ = ((x3 ^ ~x8) | ((x2 | (x4 & x7)) & (x7 | (x1 & x4)))) & ((~x3 ^ ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign new_n36_ = ~x1 & ~x4 & (~x3 ^ ~x8);
  assign z3 = (~new_n38_ & x0) | (~new_n40_ & ~x6) | (~x0 & ~x5 & ~new_n42_ & x6);
  assign new_n38_ = ((x4 & ~x7) | new_n39_ | (x3 & ~x8)) & x6 & (x4 | ~x7 | ~x8) & (x3 | (~x8 & (x4 | ~x7)));
  assign new_n39_ = x1 & ~x2;
  assign new_n40_ = (new_n41_ | (~x3 & ~x8)) & ~x5 & (~x3 | ~x8);
