...
module FAU ( 
  ...
  assign z3 = (~x6 & (x0 ? ~new_n42_ : ~new_n47_)) | new_n48_ | (~new_n44_ & x6);
  assign new_n42_ = ~new_n43_ & x5 & (x8 | (x3 & (x1 | x4)));
  assign new_n43_ = (~x3 | ~x8) & ((~x2 & (~x4 | ~x7)) | (~x7 & (~x1 | ~x4)));
  ...
  assign new_n48_ = ~x1 & (~x5 | (x0 & ~x3 & ~x4));
  assign z4 = ~new_n50_ | (~x0 & (x5 | (~new_n46_ & x6)));
  assign new_n50_ = (~new_n51_ | (x4 & x7)) & (new_n52_ | ~x5) & (x1 | x5);
  assign new_n51_ = (~x3 | ~x8) & (~x1 | (~x2 & x5));
  assign new_n52_ = (x3 | (x8 & (x4 | x7))) & ~x6 & (x4 | x7 | x8);
endmodule
