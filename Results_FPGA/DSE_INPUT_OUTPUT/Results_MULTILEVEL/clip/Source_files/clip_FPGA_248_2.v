...
module FAU ( 
  ...
  assign z2 = new_n32_ | new_n35_ | new_n37_ | (x2 & (new_n39_ | ~x5));
  assign new_n32_ = (~x3 ^ x8) & (new_n34_ | (~new_n33_ & x1));
  assign new_n33_ = (~x6 | (~x4 & x7) | (x5 & (~x0 | x2))) & (~x2 | x6 | (~x4 & ~x7));
  assign new_n34_ = x4 & (x6 ? (~x7 & (x0 | ~x5)) : x7);
  assign new_n35_ = ~x6 & (~new_n36_ | (x0 & ~x5 & (x3 | x8)));
  assign new_n36_ = ((x4 & x7) | ((x2 | (~x3 ^ x8)) & (x1 | ~x3 | x8))) & (x7 | (x3 ? (x4 | x8) : (~x8 | (x1 & x4))));
  assign new_n37_ = ~new_n38_ & ((~x4 & x6 & x7) | (~x1 & (~x4 | (x6 & x7))));
  assign new_n38_ = x3 ? (x8 | (~x0 & x5)) : ~x8;
  assign new_n39_ = x6 & (~x4 | x7) & ((~x3 & x8) | (x0 & x3 & ~x8));
  ...
  assign z4 = (~x0 & (x5 | (~new_n50_ & x6))) | (x2 & ~x5) | (~new_n53_ & x5);
