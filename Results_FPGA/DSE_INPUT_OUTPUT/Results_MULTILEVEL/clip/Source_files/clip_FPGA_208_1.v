...
module FAU ( 
  ...
  assign z3 = x0 ? ~new_n27_ : ((~new_n31_ & ~x6) | x5 | (~x5 & ~new_n32_ & x6));
  ...
  assign z4 = (x6 & (x0 ? x5 : (~new_n32_ & ~x5))) | (x0 & ~new_n34_ & x5);
  assign new_n34_ = ((x4 & x7) | (x3 & x8) | (x1 & x2)) & (x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8);
endmodule
