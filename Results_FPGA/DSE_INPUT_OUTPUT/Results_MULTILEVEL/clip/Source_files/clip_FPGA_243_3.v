...
module FAU ( 
  ...
  assign new_n19_ = (~x7 | (~x5 & (~x1 | x2))) & (~x1 | x2 | (new_n20_ & x5));
  ...
  assign new_n26_ = ~new_n27_ & ((x4 & ~x6 & (~x5 | x7)) | (x2 & ~x4 & x7));
  ...
  assign z3 = (~new_n45_ & ~x0) | (~new_n49_ & ~x6) | new_n53_ | (~new_n52_ & x0);
  ...
  assign new_n49_ = (~x7 | (~x0 & (new_n27_ | new_n50_))) & (~x0 | (~new_n51_ & ~new_n27_ & x5));
  ...
  assign z4 = (x5 & (new_n51_ | ~new_n55_ | ~x0 | x6)) | (~x0 & ~x5 & ~new_n56_ & x6);
  assign new_n55_ = ~new_n27_ & ~x7;
