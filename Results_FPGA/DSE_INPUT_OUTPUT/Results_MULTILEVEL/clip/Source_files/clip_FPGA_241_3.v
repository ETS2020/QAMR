...
module FAU ( 
  ...
  assign z3 = new_n32_ | (~x5 & (x0 ? ~new_n30_ : new_n29_));
  assign new_n29_ = x6 & ((x3 & ~x8) | (~new_n27_ & (x3 | ~x8)));
  assign new_n30_ = ((x4 & ~x7) | new_n31_ | (x3 & ~x8)) & (x3 | (~x8 & (x4 | ~x7))) & x6 & (x4 | ~x7 | ~x8);
  assign new_n31_ = x1 & ~x2;
  assign new_n32_ = ~x6 & (x0 ? ~new_n34_ : ~new_n33_);
  assign new_n33_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign new_n34_ = ((x4 & x7) | (x1 & x2) | (x3 & x8)) & (x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8);
  assign z4 = (~new_n36_ & x5) | (~x0 & (new_n29_ | x5));
