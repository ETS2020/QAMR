...
module FAU ( 
  ...
  assign z3 = new_n28_ | new_n31_ | (x0 & ~x1 & ~x3 & ~x4);
  assign new_n28_ = x6 & (x0 ? ~new_n29_ : (~new_n30_ & ~x5));
  assign new_n29_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign new_n30_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign new_n31_ = ~x6 & ((~new_n34_ & ~x5) | (x0 & (new_n32_ | new_n33_ | ~x5)));
  assign new_n32_ = (~x3 | ~x8) & ((~x2 & (~x4 | ~x7)) | (~x7 & (~x1 | ~x4)));
  assign new_n33_ = ~x8 & (~x3 | (~x1 & ~x4));
  assign new_n34_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign z4 = (~x0 & (x5 | (~new_n30_ & x6))) | (~new_n36_ & x5);
