...
module FAU ( 
  ...
  assign z3 = (x0 & (~new_n30_ | (~new_n29_ & ~x5))) | (x5 & x6) | (~new_n33_ & ~x0);
  assign new_n29_ = (new_n26_ | (x3 & ~x8)) & x6 & (~x8 | (x3 & (x1 | x4)));
  assign new_n30_ = ~new_n32_ & (new_n31_ | x3);
  assign new_n31_ = (x1 | (x4 & (~x5 | x7))) & (~x5 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n32_ = x5 & ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign new_n33_ = x6 ? ((~x3 | x8) & (new_n27_ | (~x3 & x8))) : ((~x3 | ~x8) & (new_n34_ | (~x3 & ~x8)));
  assign new_n34_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign z4 = (~x0 & (x5 | (~new_n36_ & x6))) | (x5 & (x6 | (~new_n37_ & x0)));
  assign new_n36_ = (~x3 | x8) & (new_n27_ | (~x3 & x8));
  assign new_n37_ = ((x4 & x7) | (x1 & x2) | (x3 & x8)) & (x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8);
endmodule
