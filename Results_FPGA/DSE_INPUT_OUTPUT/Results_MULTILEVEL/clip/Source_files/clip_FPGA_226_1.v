...
module FAU ( 
  ...
  assign z3 = (~x0 & (new_n38_ | (~new_n36_ & ~x5))) | (~new_n40_ & x0) | (~x3 & x5);
  assign new_n36_ = (new_n37_ | ~x3) & (~x6 | new_n34_ | x8);
  assign new_n37_ = (~x1 | (x2 ? (x8 | (~x4 & ~x7)) : (~x6 | (~x4 & x7)))) & (~x6 | x8) & (~x4 | (x7 ? x8 : ~x6));
  assign new_n38_ = ~x6 & ((~new_n39_ & (x5 | x8)) | (x8 & (x3 | x5)));
  assign new_n39_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n40_ = (x6 | (~new_n42_ & new_n43_)) & new_n45_ & (new_n41_ | ~new_n44_);
  assign new_n41_ = x4 & ~x7;
  assign new_n42_ = ~x8 & ((~x4 & ~x7) | ((~x1 | ~x2) & (~x4 | ~x7)));
  assign new_n43_ = x3 & x5;
  assign new_n44_ = (~x3 | (x6 & x8)) & (~x1 | x2);
  assign new_n45_ = (x3 | (~x8 & (x4 | ~x7))) & (x4 | ~x6 | ~x7 | ~x8);
  assign z4 = new_n47_ | (~x0 & (x5 | (x3 & ~x5 & ~new_n34_ & x6))) | (x5 & (~x3 | x6));
  assign new_n47_ = ~x8 & ((~new_n48_ & x5) | (~x0 & new_n49_ & ~x5));
  assign new_n48_ = (x4 | x7) & ((x1 & x2) | (x4 & x7));
  assign new_n49_ = x6 & ((x1 & ~x2 & (x4 | ~x7)) | x3 | (x4 & ~x7));
endmodule
