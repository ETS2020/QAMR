...
module FAU ( 
  ...
  assign z0 = (~new_n19_ & (~x1 ^ ~x2)) | new_n17_ | (x1 & ~x2 & x5 & ~x6);
  assign new_n17_ = ~x0 & ~new_n18_ & ((~x1 & x2 & (~x4 | x7)) | (x1 & ~x2 & ~x4 & x7));
  assign new_n18_ = x3 & ~x8;
  assign new_n19_ = x0 ? ~x5 : (x5 & x6 & (x3 | ~x8));
  ...
  assign z3 = x0 ? (x5 & (~new_n32_ | (~new_n37_ & x6))) : ~new_n35_;
  assign new_n32_ = ~new_n34_ & (new_n33_ | x3);
  assign new_n33_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n34_ = ~x6 & ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign new_n35_ = (x6 | ((~x3 | ~x8) & (new_n36_ | (~x3 & ~x8)))) & (x5 | ~x6 | ((~x3 | x8) & (new_n27_ | (~x3 & x8))));
  assign new_n36_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n37_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign z4 = (x6 & (new_n39_ | new_n18_ | x0)) | (x0 & (~x5 | (~new_n32_ & x5))) | (~x0 & x5);
  assign new_n39_ = ~new_n27_ & (x3 | ~x8);
endmodule
