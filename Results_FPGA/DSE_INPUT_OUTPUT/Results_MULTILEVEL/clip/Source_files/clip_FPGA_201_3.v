...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ~x6) | (new_n33_ & ~x1) | (~new_n35_ & x6) | (x1 & x5);
  assign new_n31_ = new_n32_ & (~x0 | ((~x1 | (x3 ^ ~x8)) & (x5 | (~x3 & ~x8))));
  assign new_n32_ = ((x4 & x7) | ((x2 | (x3 ^ ~x8)) & (x1 | ~x3 | x8))) & (x7 | (x3 ? (x4 | x8) : (~x8 | (x1 & x4)))) & ((~x3 ^ ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign new_n33_ = ~new_n34_ & (~x4 | (x6 & x7));
  assign new_n34_ = x3 ? (x8 | (~x0 & x5)) : ~x8;
  assign new_n35_ = (new_n36_ | (x3 ^ x8)) & (new_n37_ | ((x3 | ~x8) & (~x1 | ~x3 | x8)));
  assign new_n36_ = (~x1 | x2 | (~x4 & x7)) & (~x4 | x7 | (~x0 & x5));
  assign new_n37_ = (x4 | ~x7) & (~x2 | (x4 & ~x7));
  assign z3 = (~new_n43_ & ~x1) | (~x5 & (new_n39_ | ~new_n41_));
  assign new_n39_ = ~x0 & ~new_n40_ & x6;
  ...
  assign z4 = new_n39_ | (~new_n45_ & x5);
  assign new_n45_ = (new_n46_ | (x3 & x8)) & x0 & ~x1 & ~x6 & (x3 | x8);
