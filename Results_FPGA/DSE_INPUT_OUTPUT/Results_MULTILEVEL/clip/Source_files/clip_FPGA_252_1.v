...
module FAU ( 
  ...
  assign z1 = new_n24_ | ~new_n26_ | (~x5 & (new_n29_ | ~new_n30_));
  assign new_n24_ = x1 & ~new_n25_ & (x4 ^ ~x7);
  assign new_n25_ = x2 ? x6 : (~x6 | (~x0 & (x3 | ~x8)));
  assign new_n26_ = (new_n27_ | ((~x0 | (x1 & (~x2 | ~x6))) & (x6 | (x1 & x2)))) & (new_n28_ | (x1 & (~x2 | ~x6)));
  assign new_n27_ = x4 ^ ~x7;
  assign new_n28_ = (x3 | (x4 ? (x7 | ~x8) : ~x7)) & (x4 | ~x7 | ~x8);
  assign new_n29_ = x0 & x3 & ~x6 & (x4 | x7);
  assign new_n30_ = (~x6 | ((~x1 | x2 | (~x4 ^ ~x7)) & (~x2 | (~x4 ^ x7)))) & ~x8 & (x1 | (~x4 ^ x7));
