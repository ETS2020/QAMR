...
module FAU ( 
  ...
  assign z3 = new_n31_ | (~new_n27_ & x0) | (~x0 & (x6 ? ~new_n33_ : ~new_n32_));
  assign new_n27_ = (new_n28_ | ~x6) & (new_n30_ | x6) & (new_n29_ | x3);
  assign new_n28_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign new_n29_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n30_ = x5 & (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign new_n31_ = x5 & (~x0 | (~x1 & ~x3 & ~x4));
  assign new_n32_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign new_n33_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign z4 = (~x0 & (x5 | (~new_n33_ & x6))) | (~new_n35_ & x5);
