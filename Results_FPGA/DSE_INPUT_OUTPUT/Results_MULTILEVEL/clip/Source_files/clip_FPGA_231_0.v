...
module FAU ( 
  ...
  assign new_n40_ = x8 & ((~x6 & (x0 ? ~x5 : ~new_n41_)) | (new_n42_ & x0));
  assign new_n41_ = ~x3 & (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n42_ = ~x3 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign new_n43_ = ((x4 & ~x7) | (x1 & ~x2) | (x3 & ~x8)) & (x3 | (~x8 & (x4 | ~x7))) & (x4 | ~x7 | ~x8);
  assign z4 = (x5 & (new_n42_ | ~x0 | x6 | ~x8)) | (~x6 & ~x8) | (~new_n45_ & ~x0);
  assign new_n45_ = (~x3 | x8) & (new_n39_ | (x8 & (~x3 | ~x6)));
endmodule
