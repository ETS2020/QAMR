...
module FAU ( 
  ...
  assign new_n44_ = ((x1 & x2 & x4) | (x3 & x8)) & x5 & (x3 | x8);
  assign new_n45_ = (new_n28_ | ((x3 | (x4 & ~x7)) & (~x8 | (~x7 & (x4 | ~x6))))) & (x4 | ~x7 | ~x8) & (x3 | ((~x6 | ~x8) & (x4 | ~x7)));
  assign z4 = (~x7 & ((~x0 & (x5 | (new_n47_ & ~x5))) | (~new_n48_ & x5))) | (~x0 & new_n49_ & ~x5);
  assign new_n47_ = ~new_n25_ & (new_n28_ | x4) & x6;
  assign new_n48_ = ((x1 & x2 & x4) | (x3 & x8)) & ~x6 & (x3 | x8);
  assign new_n49_ = x6 & ((x3 & ~x8) | (x1 & ~x2 & x4 & (x3 | ~x8)));
endmodule
