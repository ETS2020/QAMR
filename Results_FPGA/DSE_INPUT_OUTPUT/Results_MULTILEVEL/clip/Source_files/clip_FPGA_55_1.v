...
module FAU ( 
  ...
  assign z2 = (~new_n30_ & (~x3 ^ x8)) | (~new_n35_ & (x3 ^ x8)) | ~new_n33_ | new_n36_;
  assign new_n30_ = ~new_n32_ & (new_n31_ | ~x1);
  assign new_n31_ = x2 ? (x6 | (~x4 & ~x7)) : (~x6 | (~x0 & x5) | (~x4 & x7));
  assign new_n32_ = x4 & (x6 ? (~x7 & (x0 | ~x1 | ~x5)) : x7);
  assign new_n33_ = (~x0 | ((~x3 | (x6 ? (new_n34_ | x8) : x5)) & (x5 | x6 | ~x8))) & (~x6 | new_n34_ | (x3 ? (x5 | x8) : ~x8));
  assign new_n34_ = (x4 | ~x7) & (~x2 | (x4 & ~x7));
  assign new_n35_ = (x6 | ((x2 | (x4 & x7)) & (x7 | (x1 & x4)))) & (x1 | (x4 & (~x6 | ~x7)));
  assign new_n36_ = ~x1 & (x5 | (~x6 & x8 & x0 & x3));
  assign z3 = (~new_n38_ & x0) | (~new_n42_ & ~x6) | (~x0 & ~x5 & ~new_n43_ & x6);
  assign new_n38_ = ~new_n40_ & (new_n41_ | ~x1) & (~new_n39_ | (x4 & ~x7));
  assign new_n39_ = (~x3 | x8) & (x1 ? (x2 & x6) : ~x5);
  assign new_n40_ = ~x5 & (~x6 | (~x3 & x8));
  assign new_n41_ = (x4 | (x6 ? (~x7 | (x3 & ~x8)) : ((x3 & x8) | (x2 & x7)))) & (x6 | ((x3 | x8) & (x2 | x7 | (x3 & x8)))) & (x3 | ~x6 | ~x8);
  assign new_n42_ = (new_n21_ | ((x0 | ~x1) & x5)) & (x0 | ~x1 | ~new_n18_ | ~x2);
  assign new_n43_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign z4 = (~new_n45_ & x5) | (~x0 & (x5 | (~new_n43_ & x6)));
  assign new_n45_ = (new_n46_ | (x3 & x8)) & (x3 | x8) & x1 & ~x6;
