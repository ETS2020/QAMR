...
module FAU ( 
  ...
  assign z3 = (~x6 & (x0 ? ~new_n34_ : ~new_n35_)) | (~new_n36_ & x0) | (~new_n32_ & x6);
  assign new_n32_ = (new_n33_ | ~x0) & (x5 | ((~x3 | x8) & (new_n27_ | (~x3 & x8))));
  ...
  assign new_n36_ = x5 & (x1 | x3 | x4);
  assign z4 = ~new_n38_ | (x6 & ((~new_n27_ & (x3 | ~x8)) | x0 | (x3 & ~x8)));
  assign new_n38_ = x0 ? (~new_n40_ & x5 & (new_n39_ | x3)) : ~x5;
  assign new_n39_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n40_ = ~x6 & ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
endmodule
