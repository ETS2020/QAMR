...
module FAU ( 
  ...
  assign z3 = (~new_n42_ & x0) | (~new_n44_ & ~x6) | (~x0 & ~x5 & ~new_n46_ & x6);
  assign new_n42_ = ((x4 & ~x7) | new_n43_ | (x3 & ~x8)) & x6 & (x4 | ~x7 | ~x8) & (x3 | (~x8 & (x4 | ~x7)));
  assign new_n43_ = x1 & ~x2;
  assign new_n44_ = (new_n45_ | (~x3 & ~x8)) & ~x5 & (~x3 | ~x8);
  assign new_n45_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n46_ = (~x3 | x8) & (new_n40_ | (~x3 & x8));
  assign z4 = x5 | (~x0 & ~new_n46_ & x6);
endmodule
