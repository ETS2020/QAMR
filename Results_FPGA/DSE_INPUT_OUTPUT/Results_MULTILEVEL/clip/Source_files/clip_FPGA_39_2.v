...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n19_, new_n20_, new_n22_, new_n23_, new_n24_,
    ...
    new_n49_, new_n50_;
  assign z0 = (x0 & ((new_n17_ & ~x5) | (~x1 & x2) | (x1 & ~x2))) | ~new_n19_ | (~x5 & (x1 | x2));
  assign new_n17_ = ~new_n18_ & ~x6;
  assign new_n18_ = (~x3 | (~x8 & (~x4 | ~x7))) & (~x4 | ~x7 | ~x8);
  assign new_n19_ = ((~x1 ^ x2) | (x6 & (x3 | ~x8))) & (new_n20_ | (x3 & ~x8));
  assign new_n20_ = (x1 | ~x2 | (x4 & ~x7)) & (~x1 | x2 | x4 | ~x7);
  ...
  assign new_n26_ = (~x4 ^ x7) & ((x2 & ~x6) | (~x2 & ~x3 & x6 & x8));
  ...
  assign new_n44_ = x5 & ((~x3 & x8) | ((~x3 | x8) & ((x2 & (~x4 | x7)) | (~x4 & x7))));
  ...
  assign new_n49_ = x5 & ((~new_n50_ & (~x3 | ~x8)) | (~x3 & ~x8) | ~x0 | x6);
