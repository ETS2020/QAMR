...
module FAU ( 
  ...
  assign new_n17_ = (~x0 | (~new_n18_ & x2)) & (x2 | (new_n19_ & x5));
  assign new_n18_ = ~x6 & (x7 | (x4 & ~x5)) & (x3 | x8);
  ...
  assign new_n37_ = ((~x0 & x5) | (x1 & (~x2 | x7))) & (x1 | ~x7) & (x6 | x7);
  assign new_n38_ = (~x8 | (new_n40_ & (~new_n39_ | ~x6))) & (~x0 | x5 | x6);
  assign new_n39_ = ~x7 & (x0 | ~x5) & (x4 | (x1 & ~x2));
  assign new_n40_ = (~x1 | (x2 ? (x6 | (~x4 & ~x7)) : (~x4 | ~x7))) & (~x4 | x6 | ~x7);
  assign new_n41_ = (x8 | (new_n40_ & (~new_n39_ | ~x6))) & (x4 | new_n42_ | ~x8);
  assign new_n42_ = x1 & (~x2 | x7);
  assign new_n43_ = (~x5 | ~x7) & (x6 | ~x8 | ~x0 | x5);
  assign z3 = (~new_n45_ & x0) | (~new_n48_ & ~x6) | (~x0 & ~x5 & ~new_n50_ & x6);
  assign new_n45_ = (new_n46_ | x7) & (x5 | (new_n19_ & (~new_n47_ | ~x7)));
  assign new_n46_ = (x4 | (((x1 & ~x2) | (x3 & (~x6 | ~x8))) & (x6 | (x3 & x8)))) & (x6 | ((x3 | x8) & ((x1 & x2) | (x3 & x8)))) & (x3 | ~x6 | ~x8);
  assign new_n47_ = (~x3 | x8) & (~x1 | x2 | ~x4);
  assign new_n48_ = (new_n49_ | (~x3 & ~x8)) & (~x3 | ~x8 | (x5 & (x0 | x7)));
  assign new_n49_ = (~x1 | ~x2 | ((x5 | ~x7) & (x0 | ~x4 | x7))) & (~x4 | x5 | ~x7);
  assign new_n50_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign z4 = (~new_n52_ & x5) | (~x0 & ~new_n50_ & x6);
