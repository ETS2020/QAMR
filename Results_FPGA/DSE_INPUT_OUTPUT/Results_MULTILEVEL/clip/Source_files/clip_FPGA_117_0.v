...
module FAU ( 
  ...
  assign new_n44_ = new_n47_ & (~x1 | (~new_n46_ & (new_n45_ | ~x4)));
  assign new_n45_ = x2 ? (x6 | x7 | (~x3 & ~x8)) : (x5 | (~x3 & (~x6 | x8)));
  assign new_n46_ = x2 & ~x6 & x7 & (x3 | x8);
  assign new_n47_ = (x6 | ((~x3 | (~x8 & (~x4 | ~x7))) & (~x4 | ~x7 | ~x8))) & (~x3 | x5 | ~x6 | x8);
  assign new_n48_ = new_n50_ & (new_n49_ | x3);
  assign new_n49_ = (~x2 | (x7 ? ~x6 : x4)) & (x2 | (x7 ? x4 : x6)) & ((x1 & x4) | (x6 ^ x7)) & (x1 | x4) & (x6 | x8) & (~x6 | ~x8);
  assign new_n50_ = x6 ? (~x8 | ((x4 | ~x7) & ((x1 & ~x2) | (~x7 & (x4 | x7))))) : (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign z4 = new_n52_ | new_n58_ | new_n59_ | ~new_n56_ | (~new_n53_ & ~new_n60_);
  assign new_n52_ = ~x2 & (new_n55_ | (~new_n53_ & ~new_n54_));
  assign new_n53_ = x3 & x8;
  assign new_n54_ = (x4 | ~x5 | ~x7) & (~x0 | x6 | x7);
  assign new_n55_ = ~x0 & x1 & x4 & x6 & (x3 | ~x8);
  assign new_n56_ = (x5 | x7) & (x3 | ((~x0 | new_n57_ | x7) & (~x5 | ~x7 | x8)));
  assign new_n57_ = (x6 | x8) & (x4 | (x1 & ~x2));
  assign new_n58_ = ~x0 & (x5 | ~x7 | (x3 & x6 & ~x8));
  assign new_n59_ = x6 & (x5 | ~x7);
  assign new_n60_ = (~x0 | x6 | x7 | (x1 & x4)) & (~x5 | ~x7 | x1 | x4);
endmodule
