...
module FAU ( 
  ...
  assign z2 = (~new_n23_ & ~x6) | ~new_n26_ | (~new_n25_ & x6);
  assign new_n23_ = new_n24_ & (~x0 | x5 | (~x3 & ~x8));
  ...
  assign z3 = x6 ? (x0 ? ~new_n32_ : (~new_n31_ & ~x5)) : ~new_n28_;
  assign new_n28_ = (x5 | ((new_n29_ | (~x3 & ~x8)) & ~x0 & (~x3 | ~x8))) & (~x0 | new_n30_ | ~x5);
  ...
  assign z4 = (~x0 & (x5 | (~new_n31_ & x6))) | (x5 & (x6 | (x0 & ~new_n30_ & ~x6)));
endmodule
