...
module FAU ( 
  ...
  assign new_n32_ = (new_n33_ | x6) & (~new_n34_ | x3) & (x5 | ~x6);
  assign new_n33_ = ((x4 & x7) | ((x2 | (x3 ^ ~x8)) & (x1 | ~x3 | x8))) & (x7 | (x3 ? (x4 | x8) : (~x8 | (x1 & x4)))) & (((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))) | (~x3 ^ ~x8));
  assign new_n34_ = x8 & ((~x1 & (~x4 | (x6 & x7))) | (x6 & ((~x4 & x7) | (x2 & (~x4 | x7)))));
  ...
  assign z4 = x6 | (x5 & (~x0 | (x0 & ((~new_n41_ & ~x3) | (new_n42_ & ~x6)))));
  assign new_n41_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & (x4 | x7) & x8));
