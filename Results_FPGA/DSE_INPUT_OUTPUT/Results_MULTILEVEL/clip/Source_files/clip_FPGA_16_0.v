...
module FAU ( 
  ...
  assign new_n20_ = (~x1 | x2 | x3 | ~x8) & (x0 | x7);
  ...
  assign new_n35_ = ((x1 & ~x2) | (x3 ? (x8 | (x4 & ~x7)) : (x4 | ~x8))) & ((~x3 ^ ~x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7)))) & (~x3 | x4 | ~x7 | x8);
  assign z3 = ~new_n39_ | (~x6 & (x0 ? ~new_n37_ : new_n43_));
  assign new_n37_ = (new_n38_ | (x3 & x8)) & x5 & (x8 | (x3 & (x1 | x4)));
  assign new_n38_ = (x2 | (x4 & x7)) & (x7 | (x1 & x4));
  assign new_n39_ = (~x7 | (x0 ? ~new_n41_ : (new_n40_ | x5))) & (new_n42_ | ~x0);
