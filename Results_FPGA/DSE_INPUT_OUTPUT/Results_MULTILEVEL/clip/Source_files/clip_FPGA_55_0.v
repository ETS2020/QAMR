...
module FAU ( 
  ...
  assign z2 = new_n32_ | (~new_n35_ & ~x6) | new_n40_ | (~new_n37_ & x6);
  assign new_n32_ = (new_n33_ | ~new_n34_) & (x3 ^ ~x8);
  assign new_n33_ = x1 & ((x0 & ~x2 & x6 & (x4 | ~x7)) | (x2 & ~x6 & (x4 | x7)));
  assign new_n34_ = (~x6 | ((x5 | ((~x4 | x7) & (x2 | (~x4 & x7)))) & (~x0 | ~x4 | x7))) & (~x4 | x6 | ~x7);
  assign new_n35_ = new_n36_ & (~x0 | x5 | (~x3 & ~x8));
  assign new_n36_ = ((x4 & x7) | ((x2 | (x3 ^ ~x8)) & (x1 | ~x3 | x8))) & (x7 | (x3 ? (x4 | x8) : (~x8 | (x1 & x4))));
  assign new_n37_ = (new_n38_ | ((x3 | ~x8) & (~x0 | ~x3 | x8))) & (~x3 | x5 | new_n39_ | x8);
  assign new_n38_ = (~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4));
  assign new_n39_ = (x4 | ~x7) & (~x2 | (x4 & ~x7));
  assign new_n40_ = ~x1 & (~x5 | (~x4 & ((~x3 & x8) | (x0 & x3 & ~x8))));
  ...
  assign new_n48_ = (~x3 | (~x8 & (~x4 | ~x7))) & (~x4 | ~x7 | ~x8);
  assign new_n49_ = x2 & (x3 | x8) & (x4 | x7);
  assign new_n50_ = x6 & ((x3 & ~x8) | ((x3 | ~x8) & ((x4 & ~x7) | (~x2 & (x4 | ~x7)))));
  assign z4 = (~x0 & (new_n50_ | x5)) | new_n52_ | (~new_n54_ & x5) | (~x1 & ~x5);
  assign new_n52_ = new_n53_ & (~x4 | ~x7);
  assign new_n53_ = (~x3 | ~x8) & (~x1 | (~x2 & x5));
  assign new_n54_ = (x3 | (x8 & (x4 | x7))) & ~x6 & (x4 | x7 | x8);
endmodule
