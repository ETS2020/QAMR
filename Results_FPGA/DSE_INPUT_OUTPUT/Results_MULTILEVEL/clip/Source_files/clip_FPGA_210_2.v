...
module FAU ( 
  ...
  assign z3 = (~x6 & (new_n43_ | new_n46_)) | new_n51_ | (~new_n47_ & x6);
  ...
  assign new_n46_ = ~x0 & ((x3 & x5 & x8) | (~new_n39_ & (x3 ? x5 : x8)));
  ...
  assign z4 = ~new_n55_ | (~x8 & (~new_n53_ | (~new_n57_ & ~x2)));
  assign new_n53_ = ~new_n54_ & (x0 | ~x4 | ~x6 | x7);
  assign new_n54_ = x5 & (~x3 | (~x4 & ~x7) | (~x1 & (~x4 | ~x7)));
  assign new_n55_ = x5 ? (x0 & ~x6 & (new_n56_ | x3)) : ~x3;
  assign new_n56_ = (x4 | x7) & ((x4 & x7) | (x1 & x2));
  assign new_n57_ = (x0 | ~x1 | ~x6 | (~x4 & x7)) & (~x5 | (x4 & x7));
endmodule
