...
module FAU ( 
  ...
  assign z3 = (~new_n30_ & ~x6) | (x6 & (x5 | (~new_n33_ & ~x0))) | (x0 & ~new_n34_ & ~x5);
  assign new_n30_ = x0 ? (x5 & (new_n32_ | ~x5)) : new_n31_;
  assign new_n31_ = (~x3 | ~x8) & (((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))) | (~x3 & ~x8));
  assign new_n32_ = ((x4 & x7) | (x3 & x8) | (x1 & x2)) & (x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8);
  assign new_n33_ = (~x3 | x8) & (new_n28_ | (~x3 & x8));
  assign new_n34_ = ((x4 & ~x7) | (x3 & ~x8) | (x1 & ~x2)) & (x3 | (~x8 & (x4 | ~x7))) & (x4 | ~x7 | ~x8);
  assign z4 = x0 ? (x5 & ~new_n32_ & ~x6) : (x5 ? ~x6 : (~new_n33_ & x6));
endmodule
