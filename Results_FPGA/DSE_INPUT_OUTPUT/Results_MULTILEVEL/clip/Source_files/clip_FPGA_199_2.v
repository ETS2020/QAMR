...
module FAU ( 
  ...
  assign z2 = new_n29_ | (~new_n31_ & ~x6) | new_n35_ | (~new_n33_ & x6);
  ...
  assign new_n33_ = ((~x3 ^ ~x8) | (~new_n34_ & (~x4 | x5 | x7))) & (~x3 | x5 | x8 | (x4 & ~x7));
  assign new_n34_ = x0 & ((x4 & ~x7) | (x1 & ~x2 & (x4 | ~x7)));
  assign new_n35_ = x1 & ~x5;
  assign z3 = (~new_n37_ & x0) | new_n35_ | (~x0 & (~new_n43_ | (~new_n41_ & x4)));
  assign new_n37_ = (new_n38_ | ~x6) & (new_n40_ | x6) & (new_n39_ | x3);
  assign new_n38_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign new_n39_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n40_ = x5 & (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign new_n41_ = (x6 | (~x3 & ~x8) | (~new_n42_ & ~x7)) & (x5 | ~x6 | x7 | (~x3 & x8));
  assign new_n42_ = x1 & x2;
  assign new_n43_ = (new_n44_ | x6) & (~x6 | x8 | ~x3 | x5);
  assign new_n44_ = (~x3 | ~x8) & (~x1 | ~x2 | ~x7 | (~x3 & ~x8));
  assign z4 = (~new_n46_ & x5) | (~x1 & (new_n48_ | (new_n49_ & x5)));
  assign new_n46_ = (new_n47_ | (x3 & x8)) & x0 & ~x6 & (x3 | x8);
  assign new_n47_ = (x4 | x7) & (x2 | (x4 & x7));
