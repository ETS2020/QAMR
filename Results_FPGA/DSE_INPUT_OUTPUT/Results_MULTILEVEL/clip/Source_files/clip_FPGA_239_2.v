...
module FAU ( 
  ...
  assign new_n18_ = ((x3 & ~x8) | (x4 & ~x7)) & ~x0 & x6 & (x3 | ~x8);
  ...
  assign new_n41_ = x0 & ((~new_n42_ & x6) | (~new_n43_ & ~x3) | (~new_n44_ & ~x6));
  assign new_n42_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign new_n43_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
  assign new_n44_ = x5 & (x8 | ((x4 | x7) & ((x1 & x2) | (x4 & x7))));
  assign new_n45_ = (~x2 | x5) & (x0 | ((new_n46_ | x6) & (~new_n47_ | x5)));
  assign new_n46_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign new_n47_ = x6 & ((x3 & ~x8) | ((x3 | ~x8) & ((x4 & ~x7) | (x1 & (x4 | ~x7)))));
  assign z4 = new_n49_ | (~x2 & (new_n51_ | (new_n47_ & ~x0)));
  assign new_n49_ = x5 & ((~new_n50_ & (~x3 | ~x8)) | (~x3 & ~x8) | ~x0 | x6);
  assign new_n50_ = (x4 | x7) & (x1 | (x4 & x7));
