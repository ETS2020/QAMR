...
module FAU ( 
  ...
  assign z2 = (~new_n27_ & ~x6) | ~new_n32_ | (~new_n29_ & x6);
  assign new_n27_ = new_n28_ & (x5 | (~x3 & ~x8));
  assign new_n28_ = ((x4 & x7) | ((x2 | (x3 ^ ~x8)) & (x1 | ~x3 | x8))) & (x7 | (x3 ? (x4 | x8) : (~x8 | (x1 & x4)))) & (((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))) | (~x3 ^ ~x8));
  assign new_n29_ = (new_n30_ | ((x3 | ~x8) & (~x0 | ~x3 | x8))) & (~x0 | new_n31_ | (x3 ^ x8));
  assign new_n30_ = (~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4));
  assign new_n31_ = (~x4 | x7) & (~x1 | x2 | (~x4 & x7));
  assign new_n32_ = (x0 | x5) & (x1 | x4 | ((x3 | ~x8) & (~x0 | ~x3 | x8)));
  assign z3 = (~new_n36_ & x0) | (~x6 & (x0 ? ~new_n34_ : (~new_n39_ & x5)));
  assign new_n34_ = (new_n35_ | (x3 & x8)) & x5 & (x8 | (x3 & (x1 | x4)));
  ...
  assign z4 = x5 & (new_n41_ | ~new_n42_);
  assign new_n41_ = (~x4 | ~x7) & (~x3 | ~x8) & (~x1 | ~x2);
  assign new_n42_ = (x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8) & x0 & ~x6;
endmodule
