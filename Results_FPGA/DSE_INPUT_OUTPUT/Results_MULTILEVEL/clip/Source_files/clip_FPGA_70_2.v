...
module FAU ( 
  ...
  assign z3 = (~x6 & (new_n39_ | new_n42_)) | new_n48_ | (~new_n44_ & x6);
  assign new_n39_ = x0 & (~new_n41_ | (~new_n40_ & (~x4 | ~x7)));
  assign new_n40_ = (x2 | (x3 & (~x5 | x8))) & (x1 | ~x5 | x8);
  assign new_n41_ = (x7 | ((x4 | ~x5 | x8) & (x3 | (x1 & x4)))) & (x3 | (x5 & x8));
  ...
  assign new_n48_ = x0 & ~x1 & ~x3 & ~x4;
  assign z4 = ~new_n52_ | (~x8 & (~new_n50_ | (~new_n54_ & ~x2)));
  assign new_n50_ = ~new_n51_ & (x0 | ~x4 | ~x6 | x7);
  assign new_n51_ = x5 & (~x3 | (~x4 & ~x7) | (~x1 & (~x4 | ~x7)));
  assign new_n52_ = x5 ? (x0 & ~x6 & (new_n53_ | x3)) : ~x3;
  assign new_n53_ = (x4 | x7) & ((x4 & x7) | (x1 & x2));
  assign new_n54_ = (x0 | ~x1 | ~x6 | (~x4 & x7)) & (~x5 | (x4 & x7));
endmodule
