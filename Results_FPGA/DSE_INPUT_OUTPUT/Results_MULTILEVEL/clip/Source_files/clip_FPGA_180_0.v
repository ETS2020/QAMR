...
module FAU ( 
  ...
  assign z3 = (~new_n50_ & ~x0) | (~new_n54_ & x0) | (~x5 & (~x7 | (x0 & ~x6)));
  assign new_n50_ = new_n53_ & (~x1 | (~new_n51_ & ~new_n52_));
  assign new_n51_ = x4 & (x2 ? (~x6 & (x3 | x8)) : (~x5 & (x3 | (x6 & ~x8))));
  assign new_n52_ = x2 & ~x6 & x7 & (x3 | x8);
  assign new_n53_ = (x6 | ((~x3 | (~x8 & (~x4 | ~x7))) & (~x4 | ~x7 | ~x8))) & (~x3 | x5 | ~x6 | x8);
  assign new_n54_ = (new_n55_ | ~x6) & (new_n56_ | x3) & (~new_n57_ | x6);
  assign new_n55_ = ((x3 & ~x8) | ((~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4)))) & (~x8 | (x3 & (x1 | x4)));
  assign new_n56_ = (x1 | (x4 & (x6 | x7))) & (x6 | ((x2 | (x4 & x7)) & x8 & (x4 | x7)));
