...
module FAU ( 
  ...
  assign new_n18_ = (~x1 | ~x4 | (~x3 & ~x8)) & (~x3 | ~x8);
  assign new_n19_ = (x1 ^ x2) & (x0 | ~x6 | (~x3 & x8));
  assign new_n20_ = (~x3 | x8) & ((~x1 & x2 & (~x4 | x7)) | (x1 & ~x2 & ~x4 & x7));
  assign z1 = (~x7 & (~new_n24_ | (~new_n22_ & x0))) | (x5 & ~new_n26_ & x7);
  assign new_n22_ = (x5 | new_n23_ | x6) & (~x4 | (x1 & (~x2 | ~x6))) & (~x1 | x2 | x4 | ~x6);
  assign new_n23_ = (~x3 | (~x4 & ~x8)) & (~x4 | ~x8);
  assign new_n24_ = (new_n25_ | ((~x4 | (x1 & (~x2 | ~x6))) & (~x1 | x2 | x4 | ~x6))) & (x6 | ((~x4 | (x1 & x2)) & (~x1 | ~x2 | x4)));
  assign new_n25_ = x5 & (x3 | ~x8);
  assign new_n26_ = (x4 | ((new_n27_ | (x1 & (~x2 | ~x6))) & (x6 | (x1 & x2)))) & (~x1 | ~x4 | (x2 ? x6 : (new_n28_ | ~x6)));
  ...
  assign z4 = (~x0 & (x5 | (~new_n45_ & x6))) | (~x5 & x7) | (~new_n52_ & x5);
