...
module FAU ( 
  ...
  wire new_n17_, new_n19_, new_n20_, new_n21_, new_n22_, new_n24_, new_n25_,
    new_n26_, new_n28_, new_n29_, new_n30_, new_n31_;
  ...
  assign new_n19_ = (~x2 | (~x6 & (~x0 | new_n20_ | x5))) & x1 & (x2 | (x0 & x6));
  assign new_n20_ = ~x3 & ~x8;
  assign new_n21_ = (x0 | ~x6) & (~x1 | (~x2 ^ x6));
  assign new_n22_ = ~x5 & ~x6 & ((x3 & (x4 ? x7 : (~x7 & x8))) | (x4 & x7 & x8));
  assign z2 = (~new_n26_ & ~x6) | (x0 & (~new_n24_ | (~x5 & ~new_n20_ & ~x6)));
  ...
  assign z3 = (~new_n28_ & ~x0) | (~new_n30_ & x6) | (x0 & ~x6 & (~x5 | (~new_n31_ & x5)));
  ...
  assign new_n31_ = ((x4 & x7) | (x3 & x8) | (x1 & x2)) & (x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8);
  assign z4 = (~x0 & (x5 | x6)) | (x5 & (x6 | (x0 & ~new_n31_ & ~x6)));
endmodule
