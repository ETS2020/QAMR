// Benchmark "FAU" written by ABC on Mon Aug 17 19:20:01 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n314_, new_n315_, new_n316_, new_n319_, new_n321_, new_n323_,
    ...
    new_n483_, new_n484_, new_n485_, new_n487_, new_n489_;
  assign z00 = ~x43 & (x15 | (new_n133_ & new_n142_ & new_n138_ & new_n144_));
  ...
  assign new_n144_ = new_n146_ & new_n145_ & ~x53 & ~x54 & ~x55;
  assign new_n145_ = ~x50 & ~x51;
  assign new_n146_ = ~x60 & ~x61 & ~x62 & ~x56 & ~x58 & ~x59;
  assign z01 = ~x43 & (x15 | (new_n148_ & new_n151_ & new_n142_));
  assign new_n148_ = new_n149_ & new_n144_;
  assign new_n149_ = new_n139_ & new_n150_ & new_n141_ & ~x42;
  assign new_n150_ = ~x40 & ~x41;
  assign new_n151_ = new_n134_ & new_n137_ & ~x04 & x05 & ~x06;
  assign z02 = ~x43 & (x15 | (new_n153_ & new_n157_ & new_n163_ & new_n167_));
  assign new_n153_ = new_n154_ & new_n156_ & ~x00 & ~x01 & ~x02;
  assign new_n154_ = new_n155_ & new_n135_ & ~x09 & ~x10;
  ...
  assign new_n163_ = new_n164_ & new_n166_ & new_n150_ & ~x42 & ~x44;
  assign new_n164_ = new_n165_ & ~x34 & ~x35 & ~x32 & ~x33;
  assign new_n165_ = ~x36 & ~x37 & ~x38 & ~x39;
  assign new_n166_ = ~x45 & ~x46 & ~x47 & ~x48;
  assign new_n167_ = new_n168_ & new_n170_ & ~x51 & ~x52 & ~x49 & ~x50;
  assign new_n168_ = new_n169_ & ~x59 & ~x60 & ~x57 & ~x58;
  assign new_n169_ = ~x61 & ~x62 & ~x63 & ~x64;
  assign new_n170_ = ~x53 & ~x54 & ~x55 & ~x56;
  assign z03 = ~x43 & (x15 | (new_n172_ & new_n153_ & new_n158_ & new_n174_));
  assign new_n172_ = new_n167_ & new_n173_ & new_n166_ & new_n150_ & ~x42 & x44;
  assign new_n173_ = new_n165_ & ~x33 & ~x34 & ~x35;
  assign new_n174_ = new_n175_ & new_n162_ & ~x26 & ~x28;
  assign new_n175_ = ~x31 & ~x32 & x29 & ~x30;
  assign z04 = x43 & x15 & x29;
  assign z05 = x15 ? (~x43 | (x29 & x43)) : x29;
  assign z06 = ~x43 & (x15 | (x29 & ~x37 & x14 & ~x28));
  assign z07 = (x15 & ~x43) | (~x15 & ~x28 & x29 & ~x37 & x43);
  assign z08 = ~x43 & (x15 | (new_n153_ & new_n181_ & new_n167_ & new_n185_));
  assign new_n181_ = new_n182_ & new_n160_ & new_n184_ & ~x23 & ~x24;
  assign new_n182_ = new_n183_ & ~x16 & ~x17 & ~x18;
  assign new_n183_ = ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n184_ = ~x25 & ~x26;
  assign new_n185_ = new_n186_ & new_n188_ & ~x32 & ~x33 & ~x34;
  assign new_n186_ = new_n166_ & new_n187_ & ~x41 & ~x42;
  assign new_n187_ = ~x39 & ~x40;
  assign new_n188_ = ~x35 & ~x36 & ~x37 & x38;
  assign z09 = ~x43 & (x15 | (new_n190_ & new_n191_ & new_n192_ & new_n193_));
  assign new_n190_ = new_n153_ & new_n182_ & new_n160_ & new_n184_ & x23 & ~x24;
  assign new_n191_ = new_n168_ & new_n170_ & ~x50 & ~x51 & ~x52;
  assign new_n192_ = ~x32 & ~x33 & ~x34 & new_n140_ & ~x35 & ~x36;
  assign new_n193_ = new_n150_ & ~x42 & ~x45 & new_n141_ & ~x48 & ~x49;
  ...
  assign z14 = ~x43 & (x15 | (new_n207_ & ~x10 & ~x14 & ~x28));
  assign new_n207_ = x29 & ~x37 & x50 & ~x58;
  assign z15 = ~x58 & new_n209_ & ~x43;
  assign new_n209_ = ~x37 & x29 & ~x28 & ~x15 & x10 & ~x14;
  assign z16 = ~x43 & (x15 | (new_n211_ & new_n213_));
  assign new_n211_ = new_n212_ & ~x03 & ~x07 & new_n136_ & ~x08;
  assign new_n212_ = new_n161_ & x26 & new_n162_ & ~x14;
  assign new_n213_ = new_n214_ & ~x30 & ~x37 & ~x39 & ~x40 & ~x46;
  assign new_n214_ = ~x58 & ~x60 & ~x62 & ~x47 & ~x50 & ~x56;
  assign z17 = ~x43 & (x15 | (new_n216_ & new_n213_));
  assign new_n216_ = new_n217_ & x03 & ~x07 & new_n136_ & ~x08;
  assign new_n217_ = ~x14 & ~x24 & new_n161_ & ~x25;
  assign z18 = ~x43 & (x15 | (new_n219_ & new_n221_));
  assign new_n219_ = new_n135_ & new_n220_ & new_n162_ & ~x28 & x29 & ~x30;
  assign new_n220_ = ~x10 & ~x11 & ~x14;
  assign new_n221_ = new_n222_ & new_n140_ & new_n141_ & ~x40;
  assign new_n222_ = ~x50 & ~x56 & ~x58 & ~x60 & x62;
  assign z19 = ~x43 & (x15 | (new_n224_ & new_n228_ & new_n231_));
  assign new_n224_ = new_n225_ & new_n227_ & new_n135_ & ~x06 & new_n136_ & ~x09;
  assign new_n225_ = new_n226_ & new_n161_ & ~x26 & ~x30 & ~x31 & ~x33;
  assign new_n226_ = ~x14 & ~x17 & ~x18 & new_n162_ & ~x22;
  assign new_n227_ = ~x03 & ~x04 & ~x05 & ~x00 & ~x01 & ~x02;
  assign new_n228_ = new_n229_ & new_n230_ & ~x47 & ~x48 & ~x49;
  assign new_n229_ = ~x34 & ~x35 & ~x37 & new_n150_ & ~x39;
  ...
  assign new_n245_ = ~x10 & ~x08 & ~x07 & ~x06 & x00 & ~x03;
  assign z22 = ~x43 & (x15 | (new_n247_ & new_n251_ & new_n253_ & new_n227_));
  assign new_n247_ = new_n248_ & new_n250_ & new_n169_ & ~x58 & ~x59 & ~x60;
  assign new_n248_ = new_n249_ & new_n230_ & ~x49 & ~x50 & ~x47 & ~x48;
  assign new_n249_ = new_n150_ & ~x39 & ~x35 & x36 & ~x37;
  assign new_n250_ = ~x55 & ~x56 & ~x57 & ~x51 & ~x53 & ~x54;
  assign new_n251_ = new_n226_ & new_n252_;
  assign new_n252_ = ~x33 & ~x34 & ~x30 & ~x31 & new_n161_ & ~x26;
  assign new_n253_ = ~x11 & ~x12 & ~x09 & ~x10 & new_n135_ & ~x06;
  assign z23 = ~x64 & ~x63 & ~x62 & ~x61 & new_n255_ & ~x60;
  assign new_n255_ = ~x59 & ~x58 & ~x57 & ~x56 & new_n256_ & ~x55;
  assign new_n256_ = ~x54 & ~x53 & ~x52 & ~x51 & new_n257_ & ~x50;
  ...
  assign new_n261_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n262_ & ~x18;
  assign new_n262_ = ~x17 & new_n263_ & x16;
  assign new_n263_ = ~x15 & ~x14 & ~x12 & new_n264_ & ~x11;
  assign new_n264_ = ~x10 & ~x09 & ~x08 & ~x07 & new_n265_ & ~x06;
  assign new_n265_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z24 = ~x43 & (x15 | (new_n267_ & new_n268_ & new_n269_));
  assign new_n267_ = new_n162_ & new_n161_ & ~x10 & x11 & ~x14;
  assign new_n268_ = new_n187_ & ~x37;
  assign new_n269_ = new_n270_ & ~x46 & ~x50;
  assign new_n270_ = ~x58 & ~x60;
  ...
  assign new_n283_ = ~x15 & ~x14 & ~x13 & ~x12 & new_n264_ & ~x11;
  ...
  assign new_n293_ = ~x15 & ~x14 & x13 & ~x12 & new_n264_ & ~x11;
  assign z28 = ~x43 & (x15 | (new_n295_ & new_n296_));
  assign new_n295_ = ~x39 & ~x40 & ~x46 & new_n270_ & ~x50;
  assign new_n296_ = ~x28 & x29 & ~x37 & ~x10 & ~x14 & x25;
  ...
  assign new_n308_ = ~x22 & ~x21 & ~x18 & new_n263_ & ~x17;
  ...
  assign new_n316_ = ~x24 & ~x22 & x21 & ~x18 & new_n263_ & ~x17;
  assign z32 = ~x58 & ~x50 & new_n298_ & x46;
  assign z33 = ~x43 & (x15 | (new_n319_ & new_n161_ & ~x10 & ~x14));
  assign new_n319_ = ~x40 & ~x50 & ~x58 & ~x37 & x39;
  assign z34 = ~new_n321_ & ~x43;
  assign new_n321_ = ~x15 & (x14 | x28 | ~x29 | x37 | ~x58);
  assign z35 = ~x62 & ~x61 & new_n323_ & ~x60;
  assign new_n323_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n324_ & ~x50;
  ...
  assign new_n328_ = ~x08 & ~x07 & ~x06 & new_n137_ & x04;
  assign z36 = ~x43 & (x15 | (new_n330_ & new_n332_ & new_n333_));
  assign new_n330_ = new_n331_ & new_n141_ & new_n150_ & new_n140_ & ~x30 & ~x35;
  assign new_n331_ = new_n145_ & ~x55 & ~x56 & new_n270_ & x61 & ~x62;
  assign new_n332_ = ~x00 & ~x03 & ~x06 & new_n135_ & new_n136_;
  assign new_n333_ = new_n161_ & new_n184_ & ~x22 & ~x24 & ~x14 & ~x18;
  ...
  assign new_n342_ = ~x20 & x19 & ~x18 & ~x17 & new_n283_ & ~x16;
  assign z38 = ~x43 & (x15 | (new_n344_ & new_n347_ & new_n348_));
  assign new_n344_ = new_n345_ & new_n346_ & ~x22 & ~x24 & ~x14 & ~x18;
  assign new_n345_ = new_n135_ & new_n136_ & new_n137_ & ~x04 & ~x06;
  assign new_n346_ = new_n184_ & ~x28 & x29 & ~x30;
  assign new_n347_ = new_n187_ & ~x35 & ~x37 & new_n141_ & ~x41 & ~x42;
  assign new_n348_ = new_n349_ & new_n145_ & ~x55 & ~x56;
  assign new_n349_ = ~x60 & ~x61 & ~x62 & ~x58 & x59;
  ...
  assign new_n356_ = ~x08 & ~x07 & ~x06 & new_n137_ & ~x04;
  assign z40 = ~x43 & (x15 | (new_n358_ & new_n149_ & new_n360_));
  assign new_n358_ = new_n359_ & new_n134_ & new_n137_ & ~x04 & ~x06;
  assign new_n359_ = new_n346_ & ~x14 & ~x17 & ~x18 & ~x22 & ~x24;
  assign new_n360_ = new_n361_ & new_n145_ & x54 & ~x55 & ~x56;
  assign new_n361_ = ~x60 & ~x61 & ~x62 & ~x58 & ~x59;
  assign z41 = ~x43 & (x15 | (new_n358_ & new_n363_));
  assign new_n363_ = new_n365_ & new_n364_ & ~x35 & ~x37 & x33 & ~x34;
  assign new_n364_ = new_n187_ & ~x41 & ~x42 & ~x46;
  ...
  assign new_n374_ = new_n264_ & ~x11;
  assign z43 = ~x43 & (x15 | (new_n376_ & new_n378_ & new_n380_ & new_n382_));
  assign new_n376_ = new_n377_ & ~x02 & ~x03 & ~x04 & ~x00 & x01;
  assign new_n377_ = ~x08 & ~x09 & ~x10 & ~x05 & ~x06 & ~x07;
  assign new_n378_ = new_n379_ & new_n184_ & ~x24 & ~x28 & x29 & ~x30;
  assign new_n379_ = ~x17 & ~x18 & ~x22 & ~x11 & ~x14;
  assign new_n380_ = new_n381_ & new_n230_ & new_n150_ & ~x39;
  assign new_n381_ = ~x34 & ~x35 & ~x37 & ~x31 & ~x33;
  assign new_n382_ = new_n146_ & ~x53 & ~x54 & ~x55 & new_n145_ & ~x47;
  ...
  assign z45 = ~x62 & ~x61 & new_n393_ & ~x60;
  ...
  assign new_n396_ = x34 & ~x30 & x29 & ~x28 & new_n397_ & ~x26;
  ...
  assign z48 = ~x43 & (x15 | (new_n148_ & new_n413_ & new_n415_));
  assign new_n413_ = new_n414_ & new_n220_ & ~x08 & ~x09;
  assign new_n414_ = new_n137_ & ~x04 & ~x06 & ~x07;
  assign new_n415_ = new_n416_ & ~x26 & ~x28 & x29 & ~x30 & x31;
  assign new_n416_ = ~x17 & ~x18 & new_n162_ & ~x22;
  assign z49 = ~x43 & (x15 | (new_n413_ & new_n418_ & new_n419_ & new_n421_));
  assign new_n418_ = new_n416_ & ~x26 & ~x28 & x29 & ~x30 & ~x33;
  assign new_n419_ = new_n268_ & ~x34 & ~x35 & new_n420_ & ~x41 & ~x42;
  assign new_n420_ = ~x46 & ~x47 & ~x50;
  assign new_n421_ = new_n361_ & ~x54 & ~x55 & ~x56 & ~x51 & x53;
  assign z50 = ~x43 & (x15 | (new_n224_ & new_n228_ & new_n232_ & new_n423_));
  assign new_n423_ = ~x60 & ~x61 & ~x62 & x57 & ~x58 & ~x59;
  assign z51 = ~x43 & (x15 | (new_n425_ & new_n428_ & new_n143_ & new_n429_));
  assign new_n425_ = new_n426_ & new_n427_ & new_n268_ & ~x33 & ~x34 & ~x35;
  assign new_n426_ = new_n146_ & ~x53 & ~x54 & ~x55 & new_n145_ & ~x49;
  assign new_n427_ = ~x41 & ~x42 & ~x45 & ~x46 & ~x47 & x48;
  assign new_n428_ = new_n377_ & ~x00 & ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n429_ = ~x18 & ~x22 & ~x24 & ~x11 & ~x14 & ~x17;
  ...
  assign new_n438_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n374_ & x12;
  assign z53 = new_n440_ & ~x64;
  assign new_n440_ = x63 & ~x62 & ~x61 & ~x60 & new_n441_ & ~x59;
  assign new_n441_ = ~x58 & ~x57 & ~x56 & ~x55 & new_n442_ & ~x54;
  assign new_n442_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n369_ & ~x48;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n444_ & x55;
  assign new_n444_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n445_ & ~x43;
  assign new_n445_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n237_ & ~x35;
  assign z55 = ~x43 & (x15 | (new_n447_ & new_n332_ & new_n450_));
  assign new_n447_ = new_n448_ & new_n449_ & new_n141_ & new_n145_;
  assign new_n448_ = new_n140_ & new_n150_ & x29 & ~x30 & x35;
  assign new_n449_ = ~x56 & ~x58 & ~x60 & ~x62;
  assign new_n450_ = ~x14 & ~x18 & ~x22 & new_n162_ & ~x26 & ~x28;
  assign z56 = ~x64 & ~x63 & new_n452_ & ~x62;
  assign new_n452_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n453_ & ~x57;
  assign new_n453_ = ~x56 & ~x55 & ~x54 & ~x53 & new_n454_ & ~x52;
  assign new_n454_ = ~x51 & ~x50 & ~x49 & ~x48 & new_n455_ & ~x47;
  assign new_n455_ = ~x46 & ~x45 & ~x43 & ~x42 & new_n456_ & ~x41;
  assign new_n456_ = ~x40 & ~x39 & ~x37 & ~x36 & new_n457_ & ~x35;
  assign new_n457_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n458_ & x29;
  assign new_n458_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n459_ & ~x22;
  assign new_n459_ = ~x21 & x20 & ~x18 & ~x17 & new_n263_ & ~x16;
  ...
  assign z58 = ~x43 & (x15 | (new_n467_ & new_n469_ & new_n470_));
  assign new_n467_ = new_n468_ & new_n420_ & new_n449_;
  assign new_n468_ = new_n150_ & ~x39 & x29 & ~x30 & ~x37;
  assign new_n469_ = ~x03 & ~x06 & ~x07 & new_n136_ & ~x08;
  assign new_n470_ = ~x25 & ~x26 & ~x28 & ~x14 & x22 & ~x24;
  assign z59 = ~x43 & (x15 | (new_n472_ & new_n161_ & ~x10 & ~x14));
  assign new_n472_ = ~x50 & ~x58 & ~x37 & x40;
  ...
  assign z62 = ~x43 & (x15 | (new_n482_ & new_n484_));
  assign new_n482_ = new_n483_ & new_n140_ & ~x40 & ~x46;
  assign new_n483_ = x47 & ~x50 & new_n270_ & ~x56;
  assign new_n484_ = new_n485_ & new_n136_ & ~x14 & ~x24;
  assign new_n485_ = ~x25 & ~x28 & x29 & ~x30;
  assign z63 = ~x43 & (x15 | (new_n484_ & new_n487_));
  assign new_n487_ = new_n140_ & ~x40 & ~x46 & new_n270_ & ~x50 & x56;
  assign z64 = ~x43 & (x15 | (new_n489_ & new_n220_ & new_n162_ & new_n161_));
  assign new_n489_ = new_n269_ & new_n187_ & x30 & ~x37;
endmodule
