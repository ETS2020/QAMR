...
module FAU ( 
  ...
  assign new_n136_ = ~x28 & x29 & ~x37 & ~x43 & (x10 | x50);
  ...
  assign z15 = (~x10 & ~x50) | (new_n141_ & ~x15 & ~x28 & x10 & ~x14);
  assign z34 = ~x14 & ~x15 & new_n144_ & ~x28;
  assign new_n144_ = x29 & ~x37 & ~x43 & x58 & (x10 | x50);
  assign z01 = 1'b0;
  assign z03 = 1'b0;
  assign z09 = 1'b0;
  assign z12 = 1'b0;
