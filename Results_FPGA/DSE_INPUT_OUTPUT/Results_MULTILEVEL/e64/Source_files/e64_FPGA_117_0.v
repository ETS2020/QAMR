...
module FAU ( 
  ...
  assign z05 = z00 | x29;
  assign z06 = (~x14 & ~x50) | (new_n136_ & x14 & ~x15 & ~x28);
  ...
  assign z15 = ~x14 & (~x50 | (new_n143_ & x10 & ~x15 & ~x28));
  assign new_n143_ = ~x43 & ~x58 & x29 & ~x37;
  assign z34 = ~x14 & (new_n145_ | ~x50);
  assign new_n145_ = ~x15 & ~x28 & x29 & ~x37 & ~x43 & x58;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z08 = 1'b0;
  assign z17 = 1'b0;
