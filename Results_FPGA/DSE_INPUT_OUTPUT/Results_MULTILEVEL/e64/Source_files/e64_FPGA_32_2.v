// Benchmark "FAU" written by ABC on Mon Aug 17 19:18:57 2020
...
module FAU ( 
  ...
  assign z00 = ~x43 & (x15 | (new_n133_ & new_n138_ & new_n142_ & new_n145_));
  ...
  assign new_n138_ = new_n141_ & new_n139_ & ~x14 & ~x17;
  ...
  assign z01 = ~x43 & (x15 | (new_n149_ & new_n138_ & new_n148_));
  assign new_n148_ = new_n134_ & new_n137_ & ~x04 & x05 & ~x06;
  assign new_n149_ = new_n145_ & new_n150_ & new_n143_;
  ...
  assign z13 = ~x62 & ~x60 & ~x58 & new_n200_ & ~x56;
  assign new_n200_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n201_ & x41;
  assign new_n201_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n202_ & x29;
  assign new_n202_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n203_ & ~x15;
  assign new_n203_ = ~x14 & ~x11 & ~x10 & ~x08 & ~x03 & ~x07;
  assign z14 = ~x58 & x50 & new_n205_ & ~x43;
  assign new_n205_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z15 = ~x43 & (new_n207_ | x15);
  assign new_n207_ = x29 & ~x37 & ~x58 & x10 & ~x14 & ~x28;
  assign z16 = ~x43 & (x15 | (new_n209_ & new_n213_));
  assign new_n209_ = new_n210_ & ~x03 & ~x07 & new_n136_ & ~x08;
  assign new_n210_ = new_n211_ & ~x14 & new_n212_ & x26;
  assign new_n211_ = ~x24 & ~x25;
  assign new_n212_ = ~x28 & x29;
  assign new_n213_ = new_n214_ & new_n215_;
  assign new_n214_ = ~x39 & ~x40 & ~x46 & ~x30 & ~x37;
  assign new_n215_ = ~x47 & ~x50 & ~x56 & ~x58 & ~x60 & ~x62;
  assign z17 = ~x43 & (x15 | (new_n217_ & new_n213_));
  assign new_n217_ = new_n218_ & new_n136_ & ~x08 & x03 & ~x07;
  assign new_n218_ = ~x14 & ~x24 & new_n212_ & ~x25;
  ...
  assign new_n225_ = ~x56 & new_n226_ & ~x55;
  ...
  assign new_n232_ = new_n163_ & ~x11;
  assign z20 = ~x43 & (x15 | (new_n234_ & new_n238_ & new_n239_));
  assign new_n234_ = new_n235_ & new_n237_ & ~x47 & ~x50 & x51;
  assign new_n235_ = x29 & ~x30 & ~x37 & new_n236_ & ~x41 & ~x46;
  assign new_n236_ = ~x39 & ~x40;
  assign new_n237_ = ~x56 & ~x58 & ~x60 & ~x62;
  assign new_n238_ = new_n135_ & new_n136_ & ~x00 & ~x03 & ~x06;
  assign new_n239_ = new_n211_ & ~x26 & ~x28 & ~x14 & ~x18 & ~x22;
  assign z21 = ~x43 & (x15 | (new_n241_ & new_n245_ & new_n246_));
  assign new_n241_ = new_n237_ & new_n244_ & new_n242_ & new_n243_ & ~x28;
  assign new_n242_ = new_n151_ & ~x37 & ~x39;
  assign new_n243_ = x29 & ~x30;
  assign new_n244_ = ~x46 & ~x47 & ~x50;
  assign new_n245_ = new_n140_ & ~x25 & ~x26 & ~x11 & ~x14 & ~x18;
  assign new_n246_ = ~x07 & ~x08 & ~x10 & x00 & ~x03 & ~x06;
  assign z22 = ~x43 & (x15 | (new_n250_ & new_n253_ & new_n248_ & new_n257_));
  assign new_n248_ = new_n249_ & ~x14 & ~x17 & ~x18 & new_n211_ & ~x22;
  assign new_n249_ = new_n212_ & ~x26 & ~x30 & ~x31 & ~x33 & ~x34;
  assign new_n250_ = new_n251_ & ~x35 & x36 & ~x37 & new_n151_ & ~x39;
  assign new_n251_ = new_n252_ & ~x42 & ~x45 & ~x46;
  assign new_n252_ = ~x47 & ~x48 & ~x49 & ~x50;
  assign new_n253_ = new_n254_ & new_n256_;
  assign new_n254_ = new_n255_ & ~x63 & ~x64 & ~x61 & ~x62;
  assign new_n255_ = ~x58 & ~x59 & ~x60;
  assign new_n256_ = ~x51 & ~x53 & ~x54 & ~x55 & ~x56 & ~x57;
  assign new_n257_ = new_n258_ & new_n259_ & new_n135_ & ~x06;
  assign new_n258_ = ~x00 & ~x01 & ~x02 & ~x03 & ~x04 & ~x05;
  assign new_n259_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z23 = ~x43 & (x15 | (new_n261_ & new_n257_ & new_n264_ & new_n265_));
  assign new_n261_ = new_n262_ & new_n251_ & new_n242_ & ~x34 & ~x35 & ~x36;
  assign new_n262_ = new_n254_ & new_n263_ & ~x51 & ~x52 & ~x53;
  assign new_n263_ = ~x54 & ~x55 & ~x56 & ~x57;
  assign new_n264_ = new_n140_ & ~x18 & ~x21 & ~x14 & x16 & ~x17;
  assign new_n265_ = new_n243_ & ~x31 & ~x33 & ~x25 & ~x26 & ~x28;
  assign z24 = ~x43 & (x15 | (new_n267_ & new_n268_ & new_n236_ & ~x37));
  assign new_n267_ = new_n211_ & new_n212_ & ~x10 & x11 & ~x14;
  assign new_n268_ = ~x46 & ~x50 & ~x58 & ~x60;
  assign z25 = ~x60 & ~x58 & ~x50 & new_n270_ & ~x46;
  ...
  assign new_n281_ = ~x18 & ~x17 & new_n162_ & ~x16;
  ...
  assign z30 = ~x43 & (x15 | (new_n298_ & new_n257_ & new_n249_ & new_n300_));
  assign new_n298_ = new_n299_ & new_n254_ & new_n263_ & ~x51 & x52 & ~x53;
  assign new_n299_ = new_n251_ & ~x35 & ~x36 & ~x37 & new_n151_ & ~x39;
  assign new_n300_ = new_n211_ & ~x21 & ~x22 & ~x14 & ~x17 & ~x18;
  ...
  assign new_n309_ = x21 & ~x18 & ~x17 & ~x15 & new_n310_ & ~x14;
  assign new_n310_ = new_n232_ & ~x12;
  assign z32 = ~x58 & ~x50 & new_n296_ & x46;
  assign z33 = ~x43 & (x15 | (new_n313_ & new_n212_ & ~x10 & ~x14));
  assign new_n313_ = ~x40 & ~x50 & ~x58 & ~x37 & x39;
  assign z34 = ~new_n315_ & ~x43;
  assign new_n315_ = ~x15 & (x14 | x28 | ~x29 | x37 | ~x58);
  ...
  assign z36 = ~x43 & (x15 | (new_n324_ & new_n326_));
  assign new_n324_ = new_n238_ & new_n325_ & new_n212_ & ~x25 & ~x26;
  assign new_n325_ = new_n140_ & ~x14 & ~x18;
  assign new_n326_ = new_n327_ & new_n328_ & ~x58 & ~x60 & x61 & ~x62;
  assign new_n327_ = new_n144_ & new_n151_ & ~x30 & ~x35 & ~x37 & ~x39;
  ...
  assign z38 = ~x43 & (x15 | (new_n339_ & new_n341_ & new_n342_));
  assign new_n339_ = new_n340_ & new_n325_ & ~x25 & ~x26 & new_n243_ & ~x28;
  assign new_n340_ = new_n135_ & new_n136_ & new_n137_ & ~x04 & ~x06;
  assign new_n341_ = new_n236_ & ~x35 & ~x37 & new_n144_ & ~x41 & ~x42;
  assign new_n342_ = new_n328_ & ~x60 & ~x61 & ~x62 & ~x58 & x59;
  ...
  assign z42 = ~x43 & (x15 | (new_n363_ & new_n366_ & new_n146_ & new_n367_));
  assign new_n363_ = new_n364_ & new_n141_ & new_n139_ & ~x11 & ~x14 & ~x17;
  assign new_n364_ = new_n365_ & ~x00 & ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n365_ = ~x05 & ~x06 & ~x07 & ~x08 & ~x09 & ~x10;
  assign new_n366_ = new_n143_ & ~x40 & ~x41 & ~x42 & new_n144_ & ~x45;
  ...
  assign new_n390_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n355_ & x34;
  assign z46 = ~x43 & (x15 | (new_n392_ & new_n395_ & new_n328_ & new_n396_));
  assign new_n392_ = new_n393_ & new_n394_ & new_n211_ & new_n212_ & ~x26;
  assign new_n393_ = new_n137_ & ~x04 & ~x06 & new_n135_ & new_n136_ & x09;
  assign new_n394_ = ~x14 & ~x17 & ~x18 & ~x22;
  assign new_n395_ = new_n150_ & ~x37 & ~x39 & ~x30 & ~x35;
  assign new_n396_ = ~x60 & ~x61 & ~x62 & ~x58 & ~x59;
  ...
  assign new_n402_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n348_ & x17;
  assign z48 = ~x43 & (x15 | (new_n149_ & new_n404_ & new_n406_));
  assign new_n404_ = new_n405_ & ~x26 & ~x28 & x29 & ~x30 & x31;
  assign new_n405_ = ~x17 & ~x18 & new_n211_ & ~x22;
  assign new_n406_ = new_n407_ & new_n137_ & ~x04 & ~x06 & ~x07;
  ...
  assign new_n410_ = new_n411_ & new_n244_ & ~x41 & ~x42;
  assign new_n411_ = ~x34 & ~x35 & new_n236_ & ~x37;
  assign new_n412_ = new_n396_ & ~x54 & ~x55 & ~x56 & ~x51 & x53;
  assign z50 = new_n414_ & ~x62;
  assign new_n414_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n225_ & x57;
  assign z51 = ~x43 & (x15 | (new_n363_ & new_n416_ & new_n146_ & new_n418_));
  assign new_n416_ = new_n417_ & ~x33 & ~x34 & ~x35 & new_n236_ & ~x37;
  assign new_n417_ = ~x41 & ~x42 & ~x45 & ~x46 & ~x47 & x48;
  assign new_n418_ = ~x49 & ~x50 & ~x51 & ~x53 & ~x54 & ~x55;
  assign z52 = ~x43 & (x15 | (new_n420_ & new_n253_ & new_n251_ & new_n422_));
  assign new_n420_ = new_n421_ & new_n265_ & new_n139_ & x12 & ~x14 & ~x17;
  assign new_n421_ = new_n258_ & new_n135_ & ~x06 & new_n136_ & ~x09;
  assign new_n422_ = new_n151_ & ~x39 & ~x34 & ~x35 & ~x37;
  assign z53 = ~x43 & (x15 | (new_n248_ & new_n421_ & new_n424_ & new_n426_));
  assign new_n424_ = new_n425_ & ~x48 & ~x49 & ~x50 & new_n144_ & ~x45;
  assign new_n425_ = ~x35 & ~x37 & ~x39 & ~x40 & ~x41 & ~x42;
  assign new_n426_ = new_n256_ & new_n255_ & ~x61 & ~x62 & x63 & ~x64;
  assign z54 = ~x43 & (x15 | (new_n324_ & new_n428_));
  assign new_n428_ = new_n429_ & new_n237_ & ~x47 & ~x50 & ~x51 & x55;
  assign new_n429_ = new_n236_ & ~x41 & ~x46 & ~x30 & ~x35 & ~x37;
  ...
  assign new_n435_ = ~x10 & ~x08 & ~x07 & new_n137_ & ~x06;
  assign z56 = ~x43 & (x15 | (new_n261_ & new_n437_ & new_n265_ & new_n440_));
  assign new_n437_ = new_n438_ & new_n439_ & ~x00 & ~x01 & ~x02;
  assign new_n438_ = new_n136_ & ~x12 & ~x14 & ~x07 & ~x08 & ~x09;
  assign new_n439_ = ~x03 & ~x04 & ~x05 & ~x06;
  assign new_n440_ = ~x16 & ~x17 & ~x18 & new_n140_ & x20 & ~x21;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n442_ & ~x50;
  ...
  assign new_n448_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n449_ & ~x41;
  ...
  assign z60 = ~x43 & (new_n453_ | x15);
  assign new_n453_ = new_n454_ & new_n218_ & new_n136_ & x07 & ~x08;
  assign new_n454_ = new_n214_ & ~x47 & ~x50 & ~x56 & ~x58 & ~x60;
  ...
  assign new_n462_ = ~x25 & ~x24 & ~x15 & new_n136_ & ~x14;
  assign z63 = ~x43 & (new_n464_ | x15);
  assign new_n464_ = new_n465_ & new_n466_ & ~x37 & ~x39 & ~x40 & ~x46;
  assign new_n465_ = new_n136_ & ~x14 & ~x24 & new_n243_ & ~x25 & ~x28;
  assign new_n466_ = ~x58 & ~x60 & ~x50 & x56;
  assign z64 = ~x43 & (new_n468_ | x15);
  assign new_n468_ = new_n469_ & new_n268_ & new_n236_ & x30 & ~x37;
  assign new_n469_ = new_n211_ & new_n212_ & ~x10 & ~x11 & ~x14;
endmodule
