...
module FAU ( 
  ...
  assign z05 = z01 | x29;
  assign z06 = ~x43 & (~x25 | (new_n136_ & x14 & ~x15));
  ...
  assign new_n146_ = new_n136_ & ~x10 & ~x14 & ~x15;
  assign new_n147_ = ~x39 & ~x40 & ~x46 & ~x50 & ~x58 & ~x60;
  assign z29 = x60 & ~x58 & ~x50 & new_n149_ & ~x46;
  assign new_n149_ = ~x43 & ~x40 & ~x39 & new_n142_ & ~x37;
  assign z32 = ~x58 & ~x50 & new_n149_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n141_ & x39;
  assign z34 = ~x43 & (new_n153_ | ~x25);
  assign new_n153_ = ~x14 & ~x15 & ~x28 & x29 & ~x37 & x58;
