...
module FAU ( 
  ...
  wire new_n136_, new_n141_, new_n142_, new_n144_, new_n146_, new_n147_,
    new_n149_, new_n153_, new_n155_, new_n156_;
  assign z00 = ~x25 & ~x43;
  assign z04 = z05 & x15;
  assign z05 = ~z00 & x29;
  assign z06 = new_n136_ & ~x43;
  assign new_n136_ = ~x37 & x29 & ~x28 & x14 & ~x15 & x25;
  ...
  assign new_n144_ = x29 & ~x28 & x25 & x10 & ~x14 & ~x15;
  assign z28 = ~x43 & ((new_n146_ & new_n147_) | ~x25);
  assign new_n146_ = ~x10 & ~x14 & ~x15 & ~x28 & x29 & ~x37;
  assign new_n147_ = ~x39 & ~x40 & ~x46 & ~x50 & ~x58 & ~x60;
  assign z29 = x60 & ~x58 & new_n149_ & ~x46 & ~x50;
  assign new_n149_ = ~x43 & ~x40 & new_n142_ & ~x37 & ~x39;
  assign z32 = ~x58 & new_n149_ & x46 & ~x50;
  assign z33 = ~x58 & ~x50 & ~x43 & new_n141_ & x39 & ~x40;
  assign z34 = new_n153_ & ~x43 & x58;
  assign new_n153_ = ~x37 & x29 & ~x28 & ~x14 & ~x15 & x25;
  assign z59 = ~x43 & (~x25 | (new_n156_ & new_n155_ & ~x15 & ~x28));
  assign new_n155_ = ~x10 & ~x14;
  assign new_n156_ = x29 & ~x37 & x40 & ~x50 & ~x58;
  assign z08 = 1'b0;
  assign z13 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
