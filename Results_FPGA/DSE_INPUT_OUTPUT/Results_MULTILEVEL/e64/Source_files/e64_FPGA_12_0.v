...
module FAU ( 
  ...
  wire new_n136_, new_n141_, new_n142_, new_n144_, new_n146_, new_n147_,
    new_n149_, new_n150_, new_n153_, new_n155_;
  assign z01 = ~x25 & ~x43;
  ...
  assign z14 = ~x43 & (~x25 | (new_n142_ & new_n141_ & ~x15 & ~x28));
  ...
  assign new_n149_ = ~x43 & ~x40 & ~x39 & new_n150_ & ~x37;
  assign new_n150_ = x29 & ~x28 & x25 & ~x10 & ~x14 & ~x15;
  assign z32 = ~x58 & ~x50 & new_n149_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n153_ & x39;
  assign new_n153_ = new_n150_ & ~x37;
  assign z34 = x58 & new_n155_ & ~x43;
  assign new_n155_ = ~x37 & x29 & ~x28 & ~x14 & ~x15 & x25;
