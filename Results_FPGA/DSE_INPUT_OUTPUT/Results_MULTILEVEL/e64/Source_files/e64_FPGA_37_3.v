// Benchmark "FAU" written by ABC on Mon Aug 17 19:19:00 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n479_;
  assign z00 = x29 & (x43 | (new_n133_ & new_n145_ & new_n141_ & new_n143_));
  assign new_n133_ = new_n134_ & new_n138_ & new_n140_ & ~x04 & ~x05 & ~x06;
  assign new_n134_ = new_n135_ & ~x28 & ~x30 & ~x31 & new_n137_ & ~x24;
  ...
  assign z01 = x29 & (x43 | (new_n149_ & new_n134_ & new_n148_));
  assign new_n148_ = new_n138_ & new_n140_ & ~x04 & x05 & ~x06;
  assign new_n149_ = new_n145_ & new_n141_ & new_n150_;
  assign new_n150_ = new_n151_ & new_n144_ & ~x42;
  ...
  assign z03 = x29 & (x43 | (new_n166_ & new_n174_ & new_n178_));
  assign new_n166_ = new_n167_ & new_n171_ & new_n173_ & new_n151_ & ~x42 & x44;
  assign new_n167_ = new_n168_ & new_n170_ & ~x51 & ~x52 & ~x49 & ~x50;
  assign new_n168_ = new_n169_ & ~x57 & ~x58 & ~x59 & ~x60;
  ...
  assign new_n174_ = new_n175_ & new_n177_ & ~x13 & ~x14 & ~x11 & ~x12;
  assign new_n175_ = new_n176_ & ~x00 & ~x01 & ~x02;
  assign new_n176_ = ~x05 & ~x06 & ~x03 & ~x04;
  assign new_n177_ = ~x09 & ~x10 & ~x07 & ~x08;
  assign new_n178_ = new_n179_ & new_n181_ & ~x17 & ~x18 & ~x15 & ~x16;
  assign new_n179_ = new_n137_ & ~x23 & ~x24 & new_n180_ & ~x31 & ~x32;
  assign new_n180_ = ~x28 & ~x30;
  assign new_n181_ = ~x21 & ~x22 & ~x19 & ~x20;
  ...
  assign new_n193_ = ~x28 & new_n160_ & ~x26;
  ...
  assign new_n202_ = ~x22 & new_n161_ & ~x21;
  ...
  assign new_n219_ = new_n136_ & x10 & ~x28 & ~x37 & ~x58;
  assign z16 = x29 & (x43 | (new_n211_ & new_n221_ & new_n215_ & new_n222_));
  ...
  assign z18 = x29 & (x43 | (new_n229_ & new_n231_));
  assign new_n229_ = new_n230_ & ~x15 & ~x24 & new_n180_ & ~x25;
  assign new_n230_ = ~x07 & ~x08 & ~x10 & ~x11 & ~x14;
  assign new_n231_ = new_n232_ & new_n142_ & new_n144_ & ~x40;
  ...
  assign new_n247_ = ~x11 & ~x10 & ~x08 & ~x07 & new_n140_ & ~x06;
  ...
  assign z22 = x29 & (new_n255_ | x43);
  assign new_n255_ = new_n256_ & new_n259_ & new_n261_ & new_n262_ & new_n264_ & new_n265_;
  assign new_n256_ = new_n257_ & new_n258_ & ~x06 & ~x07 & ~x08;
  assign new_n257_ = ~x03 & ~x04 & ~x05 & ~x00 & ~x01 & ~x02;
  assign new_n258_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign new_n259_ = new_n260_ & new_n213_ & ~x33 & ~x34 & ~x30 & ~x31;
  assign new_n260_ = ~x18 & ~x22 & ~x24 & ~x14 & ~x15 & ~x17;
  assign new_n261_ = new_n151_ & ~x39 & ~x35 & x36 & ~x37;
  assign new_n262_ = new_n263_ & ~x42 & ~x45 & ~x46;
  assign new_n263_ = ~x49 & ~x50 & ~x47 & ~x48;
  assign new_n264_ = new_n169_ & ~x58 & ~x59 & ~x60;
  ...
  assign new_n274_ = ~x17 & x16 & ~x15 & ~x14 & new_n241_ & ~x12;
  ...
  assign z27 = x29 & (x43 | (new_n292_ & new_n296_ & new_n175_ & new_n300_));
  assign new_n292_ = new_n293_ & new_n168_ & new_n170_ & ~x50 & ~x51 & ~x52;
  assign new_n293_ = new_n294_ & new_n172_ & new_n295_ & ~x36 & ~x37;
  assign new_n294_ = ~x41 & ~x42 & ~x45 & new_n144_ & ~x48 & ~x49;
  assign new_n295_ = ~x39 & ~x40;
  assign new_n296_ = new_n297_ & new_n299_ & ~x14 & ~x15 & ~x16;
  assign new_n297_ = new_n298_ & ~x22 & ~x30 & ~x31 & ~x26 & ~x28;
  assign new_n298_ = ~x24 & ~x25;
  assign new_n299_ = ~x20 & ~x21 & ~x17 & ~x18;
  assign new_n300_ = ~x07 & ~x08 & ~x09 & new_n139_ & ~x12 & x13;
  assign z28 = ~x60 & ~x58 & new_n302_ & ~x50;
  assign new_n302_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n303_ & ~x37;
  assign new_n303_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x29 & (x43 | (new_n305_ & new_n306_));
  assign new_n305_ = ~x10 & ~x14 & ~x15 & ~x28 & ~x37;
  assign new_n306_ = ~x39 & ~x40 & ~x46 & ~x50 & ~x58 & x60;
  assign z30 = ~x64 & ~x63 & ~x62 & ~x61 & new_n308_ & ~x60;
  assign new_n308_ = ~x59 & ~x58 & ~x57 & ~x56 & new_n309_ & ~x55;
  assign new_n309_ = ~x54 & ~x53 & x52 & ~x51 & new_n310_ & ~x50;
  assign new_n310_ = ~x49 & ~x48 & ~x47 & ~x46 & new_n311_ & ~x45;
  assign new_n311_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n312_ & ~x39;
  ...
  assign new_n315_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n241_ & ~x12;
  assign z31 = x29 & (x43 | (new_n317_ & new_n256_ & new_n320_ & new_n321_));
  assign new_n317_ = new_n318_ & new_n264_ & new_n319_ & ~x50 & ~x51 & ~x53;
  assign new_n318_ = new_n294_ & ~x34 & ~x35 & ~x36 & new_n295_ & ~x37;
  assign new_n319_ = ~x56 & ~x57 & ~x54 & ~x55;
  assign new_n320_ = new_n137_ & ~x24 & new_n180_ & ~x31 & ~x33;
  assign new_n321_ = ~x14 & ~x15 & ~x17 & ~x18 & x21 & ~x22;
  assign z32 = x29 & (new_n323_ | x43);
  assign new_n323_ = new_n305_ & new_n295_ & x46 & ~x50 & ~x58;
  ...
  assign new_n336_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n245_ & ~x35;
  ...
  assign new_n345_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n290_ & x19;
  ...
  assign new_n353_ = ~x08 & ~x07 & ~x06 & new_n140_ & ~x04;
  assign z39 = ~x62 & new_n355_ & ~x61;
  assign new_n355_ = ~x60 & ~x58 & ~x56 & ~x55 & new_n356_ & ~x51;
  assign new_n356_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n349_ & x42;
  assign z40 = x29 & (x43 | (new_n358_ & new_n361_ & new_n141_ & new_n150_));
  assign new_n358_ = new_n359_ & new_n135_ & new_n298_ & new_n180_ & ~x26;
  assign new_n359_ = new_n138_ & new_n360_;
  assign new_n360_ = new_n140_ & ~x04 & ~x06;
  assign new_n361_ = new_n362_ & ~x50 & ~x51 & x54 & ~x55 & ~x56;
  ...
  assign new_n372_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n236_ & x49;
  ...
  assign z44 = x29 & (x43 | (new_n384_ & new_n145_ & new_n134_ & new_n385_));
  assign new_n384_ = new_n141_ & ~x40 & ~x41 & ~x42 & new_n144_ & ~x45;
  assign new_n385_ = new_n386_ & ~x06 & ~x07 & ~x08 & new_n139_ & ~x09;
  assign new_n386_ = ~x00 & x02 & ~x03 & ~x04 & ~x05;
  assign z45 = x29 & (x43 | (new_n388_ & new_n359_ & new_n392_));
  assign new_n388_ = new_n390_ & new_n389_ & ~x35 & ~x37 & ~x30 & x34;
  assign new_n389_ = new_n295_ & ~x41 & ~x42 & ~x46;
  assign new_n390_ = new_n362_ & new_n391_ & ~x51 & ~x55 & ~x56;
  assign new_n391_ = ~x47 & ~x50;
  assign new_n392_ = new_n136_ & ~x17 & ~x18 & new_n213_ & ~x22 & ~x24;
  assign z46 = x29 & (x43 | (new_n395_ & new_n394_ & new_n392_));
  assign new_n394_ = new_n360_ & ~x07 & ~x08 & new_n139_ & x09;
  assign new_n395_ = new_n396_ & new_n150_ & new_n142_ & ~x30 & ~x35;
  assign new_n396_ = new_n362_ & ~x50 & ~x51 & ~x55 & ~x56;
  assign z47 = x29 & (x43 | (new_n395_ & new_n398_ & new_n399_));
  assign new_n398_ = new_n360_ & new_n139_ & ~x07 & ~x08;
  assign new_n399_ = new_n213_ & ~x22 & ~x24 & new_n136_ & x17 & ~x18;
  assign z48 = x29 & (x43 | (new_n149_ & new_n401_ & new_n403_));
  assign new_n401_ = new_n402_ & new_n140_ & ~x04 & ~x06 & ~x07;
  assign new_n402_ = ~x08 & ~x09 & ~x10 & ~x11 & ~x14;
  assign new_n403_ = new_n404_ & new_n137_ & ~x28 & ~x30 & x31;
  assign new_n404_ = ~x15 & ~x17 & ~x18 & ~x22 & ~x24;
  assign z49 = ~x62 & new_n406_ & ~x61;
  assign new_n406_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n407_ & ~x55;
  assign new_n407_ = ~x54 & x53 & ~x51 & ~x50 & new_n408_ & ~x47;
  assign new_n408_ = ~x46 & ~x43 & ~x42 & ~x41 & new_n409_ & ~x40;
  assign new_n409_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n367_ & ~x33;
  assign z50 = x29 & (x43 | (new_n411_ & new_n413_ & new_n415_ & new_n416_));
  assign new_n411_ = new_n412_ & new_n260_ & new_n213_ & ~x30 & ~x31 & ~x33;
  assign new_n412_ = new_n257_ & ~x06 & ~x07 & ~x08 & new_n139_ & ~x09;
  assign new_n413_ = new_n414_ & ~x34 & ~x35 & ~x37 & new_n151_ & ~x39;
  assign new_n414_ = ~x47 & ~x48 & ~x49 & ~x42 & ~x45 & ~x46;
  assign new_n415_ = ~x54 & ~x55 & ~x56 & ~x50 & ~x51 & ~x53;
  assign new_n416_ = ~x60 & ~x61 & ~x62 & x57 & ~x58 & ~x59;
  assign z51 = ~x62 & ~x61 & new_n418_ & ~x60;
  assign new_n418_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n419_ & ~x54;
  assign new_n419_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n236_ & x48;
  ...
  assign new_n428_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n241_ & x12;
  assign z53 = x29 & (x43 | (new_n259_ & new_n412_ & new_n430_ & new_n432_));
  assign new_n430_ = new_n431_ & ~x40 & ~x41 & ~x42 & new_n142_ & ~x35;
  assign new_n431_ = new_n144_ & ~x45 & ~x48 & ~x49 & ~x50;
  assign new_n432_ = new_n265_ & new_n433_ & ~x58 & ~x59 & ~x60;
  assign new_n433_ = ~x61 & ~x62 & x63 & ~x64;
  assign z54 = x29 & (x43 | (new_n435_ & new_n438_ & new_n439_));
  assign new_n435_ = new_n436_ & new_n437_ & new_n391_ & ~x51 & x55;
  assign new_n436_ = ~x30 & ~x35 & ~x37 & new_n295_ & ~x41 & ~x46;
  assign new_n437_ = ~x60 & ~x62 & ~x56 & ~x58;
  assign new_n438_ = ~x00 & ~x03 & ~x06 & new_n139_ & ~x07 & ~x08;
  assign new_n439_ = new_n136_ & ~x18 & ~x22 & new_n298_ & ~x26 & ~x28;
  ...
  assign z56 = x29 & (x43 | (new_n444_ & new_n446_ & new_n175_ & new_n448_));
  assign new_n444_ = new_n445_ & new_n264_ & new_n319_ & ~x51 & ~x52 & ~x53;
  assign new_n445_ = new_n262_ & new_n142_ & new_n151_ & ~x34 & ~x35 & ~x36;
  assign new_n446_ = new_n320_ & new_n447_ & ~x15 & ~x16 & ~x17;
  assign new_n447_ = ~x21 & ~x22 & ~x18 & x20;
  assign new_n448_ = ~x07 & ~x08 & ~x09 & new_n139_ & ~x12 & ~x14;
  assign z57 = x29 & (x43 | (new_n450_ & new_n451_ & new_n452_ & new_n453_));
  assign new_n450_ = ~x03 & ~x06 & ~x07 & new_n139_ & ~x08;
  assign new_n451_ = new_n137_ & ~x22 & ~x24 & ~x14 & ~x15 & x18;
  assign new_n452_ = ~x28 & ~x30 & ~x37 & new_n151_ & ~x39;
  assign new_n453_ = new_n437_ & new_n391_ & ~x46;
  ...
  assign z59 = ~new_n461_ & x29;
  assign new_n461_ = ~x43 & (~new_n462_ | x10 | x14 | x15 | x28);
  assign new_n462_ = ~x50 & ~x58 & ~x37 & x40;
  assign z60 = x29 & (new_n464_ | x43);
  assign new_n464_ = new_n466_ & new_n465_ & new_n139_ & x07 & ~x08;
  assign new_n465_ = new_n136_ & ~x24 & ~x25 & ~x28;
  assign new_n466_ = new_n222_ & new_n391_ & ~x56 & ~x58 & ~x60;
  ...
  assign z62 = x29 & (x43 | (new_n472_ & new_n474_));
  assign new_n472_ = new_n473_ & ~x56 & ~x58 & ~x60 & x47 & ~x50;
  assign new_n473_ = new_n142_ & ~x40 & ~x46;
  assign new_n474_ = new_n139_ & new_n136_ & new_n180_ & new_n298_;
  assign z63 = x29 & (new_n476_ | x43);
  assign new_n476_ = new_n474_ & new_n473_ & ~x58 & ~x60 & ~x50 & x56;
  assign z64 = ~x60 & ~x58 & ~x50 & ~x46 & new_n478_ & ~x43;
  assign new_n478_ = ~x40 & ~x39 & ~x37 & x30 & new_n479_ & x29;
  assign new_n479_ = ~x28 & ~x25 & ~x24 & ~x15 & new_n139_ & ~x14;
endmodule
