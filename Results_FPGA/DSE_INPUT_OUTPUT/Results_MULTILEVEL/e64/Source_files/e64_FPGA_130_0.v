...
module FAU ( 
  ...
  assign z14 = ~x43 & (~x25 | (new_n141_ & new_n142_));
  ...
  assign z29 = ~x43 & (~x25 | (new_n146_ & new_n149_));
  assign new_n149_ = ~x39 & ~x40 & ~x46 & ~x50 & ~x58 & x60;
  assign z32 = ~x43 & (~x25 | (new_n151_ & new_n152_));
  assign new_n151_ = ~x10 & ~x14 & ~x15 & ~x28 & x29;
  assign new_n152_ = ~x37 & ~x39 & ~x40 & x46 & ~x50 & ~x58;
  assign z33 = ~x43 & (~x25 | (new_n151_ & new_n154_));
  assign new_n154_ = ~x37 & x39 & ~x40 & ~x50 & ~x58;
  assign z34 = x58 & new_n156_ & ~x43;
  assign new_n156_ = ~x37 & x29 & ~x28 & ~x14 & ~x15 & x25;
  assign z59 = ~x58 & ~x50 & ~x43 & x40 & new_n158_ & ~x37;
  assign new_n158_ = x29 & ~x28 & x25 & ~x10 & ~x14 & ~x15;
  assign z00 = 1'b0;
  assign z02 = 1'b0;
  assign z09 = 1'b0;
  assign z12 = 1'b0;
