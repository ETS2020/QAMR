...
module FAU ( 
  ...
  assign new_n27_ = (~x01 | ((~x03 | (x02 & (x04 | x06))) & (~x02 | (x04 & (~x05 | (~x06 & (~x04 | x06))))))) & (x04 | x06 | ~x02 | ~x03);
  assign z1 = ~new_n29_ & ~x00;
  assign new_n29_ = (~x02 | ((x06 | (~x04 & (~x03 | (x01 & x04)))) & (~x01 | ~x04 | x05))) & (~x01 | ~x03 | (x02 & (x04 | x06) & (x05 | ~x06)));
  ...
  assign new_n34_ = ~x06 & (~x09 | x10 | x07 | x08);
