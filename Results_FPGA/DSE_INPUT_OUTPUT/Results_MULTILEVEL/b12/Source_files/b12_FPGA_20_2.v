...
module FAU ( 
  ...
  assign z2 = (x02 & (~x00 | (~x07 & ~x08))) | ~new_n33_ | (~new_n32_ & ~x07);
  assign new_n32_ = (x08 | (x10 ? x03 : ~x09)) & (x00 | x01 | ~x09 | x10);
  assign new_n33_ = (x00 | x01 | x03 | (~x07 & ~x10)) & (~x01 | x08);
  assign z3 = (~x07 | ~x11) & (~x01 | x08) & (x00 | ~x12);
  assign z4 = x07 ? (~x11 & (~x01 | x08)) : (x00 ? (x08 ? ~x09 : ~x01) : (~x01 | x08));
  assign z5 = (x00 & (x08 | (~x01 & ~x07 & ~x08))) | ((~x01 | x08) & (x07 | (~x00 & ~new_n37_ & ~x07)));
  assign new_n37_ = ~x10 & ~x12 & x13;
  assign z6 = (x01 & ~x08) | (~x07 & ~x10 & (new_n40_ | (~new_n39_ & ~x08)));
  assign new_n39_ = ~x02 & (x03 | ~x09) & (~x03 | x09);
  assign new_n40_ = ~x00 & (x01 ? (~x02 | ~x14) : (x02 | (x03 & ~x09) | (~x03 & x09)));
  assign z7 = ((~x01 | x08) & (x07 | x10)) | (~x01 & ((~new_n42_ & ~x08) | (x09 & (new_n42_ | ~x08))));
  assign new_n42_ = ~x02 & x03;
  assign z8 = (x01 & (~x08 | x09)) | ~new_n45_ | (~new_n44_ & x09);
