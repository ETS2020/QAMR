...
module FAU ( 
  ...
  assign z1 = (~new_n29_ & ~x00) | (~x01 & ~x12);
  assign new_n29_ = (~x02 | (~x03 & ~x04) | (x01 & x05 & x06)) & (~x01 | x02 | ~x03);
  assign z2 = (~new_n31_ & ~new_n32_) | (~x01 & ~new_n33_ & x12);
  assign new_n31_ = x00 & (x07 | x08);
  assign new_n32_ = (~x02 | (~x01 & ~x12)) & (x01 | x03 | ~x10 | ~x12);
  assign new_n33_ = (x00 | (x07 ? x03 : (~x09 | x10))) & (x07 | x08 | ~x09 | x10);
  assign z3 = (~x01 & ~x12) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~new_n36_ & ~x07) | (~x01 & ~x12) | (x07 & ~x11);
  assign new_n36_ = x00 & x08 & x09;
  assign z5 = ~x13 | x10 | x12 | x07 | x00 | ~x01;
  assign z6 = ~x07 & ~x10 & (x01 ? ~new_n40_ : new_n39_);
  assign new_n39_ = x12 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n42_ | ((x07 | x10) & (x01 | x12));
  assign new_n42_ = (x08 | (~x01 & (~x12 | (~x02 & x03)))) & (x01 | x02 | ~x03 | ~x09 | ~x12);
  assign z8 = (x01 | x12) & (x09 | x10 | ~x00 | x07);
endmodule
