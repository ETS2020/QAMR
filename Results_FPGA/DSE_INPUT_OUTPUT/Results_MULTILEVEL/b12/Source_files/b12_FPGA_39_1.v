...
module FAU ( 
  ...
  assign z0 = (~x01 & (x04 | (~x00 & x02 & x03))) | (~new_n27_ & ~x00);
  assign new_n27_ = (~x02 | ((~x01 | (x04 & ~x05)) & (~x04 | ~x05 | x06))) & (~x01 | ~x03 | (x02 & (x04 | (x05 & x06))));
  assign z1 = (~x01 & (x04 | (~x00 & x02 & x03))) | (~new_n29_ & ~x00);
  assign new_n29_ = (~x01 | ~x03 | (x02 & (x04 | (x05 & x06)))) & (~x02 | ~x04 | (x05 & (~x05 | x06)));
  ...
  assign new_n40_ = ~x04 & (~x00 | ~x08) & (x02 | (x03 & ~x09) | (~x03 & x09));
