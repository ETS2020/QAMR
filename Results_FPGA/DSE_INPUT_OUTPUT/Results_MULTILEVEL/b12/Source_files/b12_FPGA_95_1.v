...
module FAU ( 
  ...
  assign z0 = ~x00 & ((x02 & ~x04 & (x03 | (x01 & ~x05))) | (x01 & x03 & (~x02 | x05)));
  assign z1 = (~x03 & (x05 | (~x00 & x02 & x04))) | (~x00 & ~new_n28_ & x03);
  assign new_n28_ = x02 ? (x01 & x05 & x06) : ~x01;
  ...
  assign z7 = (~x03 & (x05 | ~x08)) | ~new_n41_ | (~x08 & (x01 | x02));
  assign new_n41_ = ~x07 & ~x10 & (~x03 | ~x09 | x01 | x02);
  assign z8 = (~x03 & (x05 | x09)) | ~new_n44_ | (~new_n43_ & x09);
