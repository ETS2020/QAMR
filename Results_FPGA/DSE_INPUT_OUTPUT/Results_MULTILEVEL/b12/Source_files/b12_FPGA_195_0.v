...
module FAU ( 
  ...
  assign z0 = (~x02 & (~x05 | (~x00 & x01 & x03))) | (~x00 & x02 & ((x01 & (~x04 | x05)) | (x03 & ~x04)));
  assign z1 = new_n29_ | (~new_n28_ & ~x00);
  assign new_n28_ = ((~x03 & ~x04) | (x05 & (~x02 | (x01 & x06)))) & (~x01 | x02 | ~x03);
  assign new_n29_ = ~x02 & ~x05;
  assign z2 = (~new_n31_ & ~new_n32_) | (~x01 & ~new_n33_ & x05);
  assign new_n31_ = x00 & (x07 | x08);
  assign new_n32_ = ~x02 & (x01 | x03 | ~x05 | ~x10);
  ...
  assign z6 = (~x02 & ~x05) | (~x07 & ~x10 & (x02 ? ~new_n39_ : new_n38_));
  ...
  assign new_n42_ = (~x05 | ((x08 | (~x01 & x03)) & (x01 | x02 | ~x03 | ~x09))) & (~x02 | x08);
  assign z8 = (~x00 & (x02 | (x05 & ~x09))) | new_n41_ | (x09 & (x02 | (~new_n44_ & x05)));
