// Benchmark "FAU" written by ABC on Mon Aug 17 19:55:50 2020
...
module FAU ( 
  ...
  assign z2 = (~new_n30_ & ((x01 & x02) | (~x01 & ~x02 & ~x03 & x10))) | (~x01 & ~new_n31_ & ~x02);
  ...
  assign z6 = (~x01 & x02) | (~x07 & ~x10 & (new_n37_ | (~new_n38_ & x01)));
  assign new_n37_ = (~x00 | ~x08) & (x01 ? ~x02 : (x03 ^ x09));
  assign new_n38_ = x00 ? x08 : x14;
  assign z7 = (~x01 & (x02 | (x03 & x09))) | ~new_n40_ | (~x08 & (x01 | ~x03));
  assign new_n40_ = ~x07 & ~x10;
  assign z8 = (x02 & (~x01 | x09)) | ~new_n42_ | (x09 & (x01 | ~x03 | x12));
