...
module FAU ( 
  ...
  assign z3 = (x01 & ~x10) | ((x00 | ~x12) & (~x07 | ~x11));
  assign z4 = (~new_n36_ & ~x07) | (x01 & ~x10) | (x07 & ~x11);
  assign new_n36_ = x00 & x08 & x09;
  assign z5 = x10 | (~x01 & (x12 | ~x13 | x00 | x07));
  assign z6 = ~x01 & new_n39_ & ~x07;
  assign new_n39_ = ~x10 & (~x00 | ~x08) & (x02 | (x03 & ~x09) | (~x03 & x09));
  assign z7 = (~x08 & (x02 | ~x03)) | ~new_n41_ | x10 | (~x02 & x03 & x09);
