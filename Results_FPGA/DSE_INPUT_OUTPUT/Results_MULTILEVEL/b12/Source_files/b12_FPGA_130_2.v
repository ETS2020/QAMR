// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:00 2020
...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (~x01 | x10)) : ((~new_n36_ & ((x00 & ~x01) | x10)) | (~x00 & (~x01 | x10)));
  assign new_n36_ = x08 & x09;
  assign z5 = x10 | (~x01 & ((~x00 & ~x07 & (x12 | ~x13)) | x00 | x07));
  assign z6 = ~x10 & (new_n39_ | x01);
  assign new_n39_ = ~x07 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign z7 = (~x08 & (x02 | ~x03)) | ~new_n41_ | x10 | (~x02 & x03 & x09);
  assign new_n41_ = ~x01 & ~x07;
  assign z8 = (~new_n43_ & x09) | ~new_n41_ | x10 | (~x00 & ~x09);
