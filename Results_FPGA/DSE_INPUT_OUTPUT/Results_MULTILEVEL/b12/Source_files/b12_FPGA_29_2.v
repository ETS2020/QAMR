...
module FAU ( 
  ...
  assign z5 = ~new_n36_ & (~x01 | x08);
  assign new_n36_ = ~x00 & ~x07 & ~x10 & ~x12 & x13;
  ...
  assign z7 = ~new_n41_ | (~x08 & (x01 | x02 | ~x03));
  assign new_n41_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? x08 : ~x09)) | (~new_n43_ & (~x01 | x08)) | (x09 & (x01 ? x08 : ~new_n44_));
