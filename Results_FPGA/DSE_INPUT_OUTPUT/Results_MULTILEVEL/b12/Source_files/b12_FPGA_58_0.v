...
module FAU ( 
  ...
  assign z2 = (x02 & (~x00 | (~x07 & ~x08))) | (~x01 & ((~new_n31_ & ~x00) | ~x08));
  ...
  assign new_n35_ = ~x07 & ~x00 & (x01 | x08);
  assign z6 = (~x01 & ~x08) | (~x07 & ~x10 & (x00 ? ~x08 : ~new_n37_));
  assign new_n37_ = x01 ? (x02 & x14) : (~x02 & (~x03 | x09) & (x03 | ~x09));
  assign z7 = ~new_n39_ | ~x08 | x10;
  assign new_n39_ = ~x07 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 | (x08 & ~x09))) | (~new_n41_ & (x01 | x08)) | (x09 & (x01 | (~new_n42_ & x08)));
