...
module FAU ( 
  ...
  assign z5 = (x00 & (x01 | (~x07 & ~x08))) | (x07 & (x01 | ~x08)) | (~x07 & ~new_n37_ & ((~x00 & x01) | ~x08));
  assign new_n37_ = ~x10 & ~x12 & x13;
  assign z6 = (~x01 & x08) | (~x07 & ~x10 & (x01 ? ~new_n39_ : ~new_n40_));
  assign new_n39_ = ((x02 & x14) | (x00 & x08)) & (~x00 | x08);
  assign new_n40_ = ~x02 & (x03 | ~x09) & (~x03 | x09);
  assign z7 = (~x01 & (~new_n42_ | x08 | x09)) | x07 | x10 | (x01 & ~x08);
  assign new_n42_ = ~x02 & x03;
  assign z8 = (x08 & (~x01 | x09)) | ~new_n45_ | (~new_n44_ & x09);
