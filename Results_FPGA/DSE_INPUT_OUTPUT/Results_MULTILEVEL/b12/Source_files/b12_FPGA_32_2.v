...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (~x01 | x12)) : ((~new_n37_ & ((x00 & ~x01) | x12)) | (~x00 & (~x01 | x12)));
  assign new_n37_ = x08 & x09;
  assign z5 = x12 | (~x01 & ((~x00 & ~x07 & (x10 | ~x13)) | x00 | x07));
  assign z6 = (x01 & ~x12) | (~x07 & ~x10 & (x01 ? ~new_n41_ : new_n40_));
  assign new_n40_ = (~x00 | ~x08) & (x02 | (x03 & ~x09) | (~x03 & x09));
  assign new_n41_ = x00 ? x08 : (x02 & x14);
  assign z7 = (x01 & (~x08 | ~x12)) | ~new_n43_ | (~x08 & (x02 | ~x03));
  assign new_n43_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (x01 & (x09 | ~x12)) | ~new_n45_ | (x09 & (x02 | ~x03 | x12));
