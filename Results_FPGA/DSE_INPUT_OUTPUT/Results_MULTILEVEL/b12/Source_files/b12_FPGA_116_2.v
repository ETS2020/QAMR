...
module FAU ( 
  ...
  assign z7 = (~new_n43_ & ((~x08 & (~x09 | x14)) | (~new_n42_ & x14))) | new_n44_ | (~new_n42_ & ~x09);
  assign new_n42_ = ~x07 & ~x10;
  assign new_n43_ = ~x01 & ~x02 & x03;
  assign new_n44_ = ~x01 & ~x02 & x03 & x09 & x14;
  assign z8 = (~new_n42_ & (~x09 | x14)) | (~x00 & ~x09) | (x09 & ~new_n46_ & x14);
