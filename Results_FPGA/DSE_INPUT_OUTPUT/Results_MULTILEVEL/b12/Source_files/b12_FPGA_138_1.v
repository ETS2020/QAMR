...
module FAU ( 
  ...
  assign z1 = ~x00 & (new_n29_ | new_n30_);
  assign new_n29_ = x03 & ((x01 & ~x02 & (x06 | ~x09)) | (x02 & (x06 ? (~x01 | ~x05) : ~x09)));
  assign new_n30_ = x02 & x04 & (x06 ? (~x01 | ~x05) : ~x09);
  assign z2 = (~new_n32_ & ~new_n33_) | (~x06 & x09) | (~new_n34_ & ~x01);
