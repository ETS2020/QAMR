...
module FAU ( 
  ...
  assign z0 = ~x00 & ~new_n27_ & (x07 | x11);
  ...
  assign z2 = (~x00 & (new_n31_ | new_n32_)) | (~x07 & new_n33_ & ~x08);
  assign new_n31_ = x02 & (x07 | x11);
  assign new_n32_ = ~x01 & ((~x03 & (x07 | (x10 & x11))) | (~x07 & x09 & ~x10 & x11));
  assign new_n33_ = x11 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = (~x07 & ~x11) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = ~x11 | (~x07 & (~x00 | ~x08 | ~x09));
  assign z5 = x07 | (x11 & (x12 | ~x13 | x00 | x10));
  assign z6 = ~x07 & (~x11 | (~x10 & (new_n38_ | new_n39_)));
  assign new_n38_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n39_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = new_n41_ | ~new_n42_ | x10 | ~x11;
  assign new_n41_ = ~x08 & (x01 | x02 | ~x03);
  assign new_n42_ = ~x07 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n44_ & x09) | x10 | ~x11 | x07 | (~x00 & ~x09);
