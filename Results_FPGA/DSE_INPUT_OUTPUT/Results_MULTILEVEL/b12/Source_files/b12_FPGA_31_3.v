...
module FAU ( 
  ...
  assign new_n32_ = ~x10 & (x02 | (~x01 & ~x03 & x07));
  assign z3 = (~x07 | (~x10 & ~x11)) & (x00 | ~x12);
  assign z4 = x07 ? (x10 | (~x10 & ~x11)) : (~x00 | (x00 & (~x08 | ~x09)));
  assign z5 = x07 ? ~x10 : (x00 | (~x00 & (x10 | x12 | ~x13)));
  ...
  assign z8 = x07 ? ~x10 : ((~new_n42_ & x09) | x10 | (~x00 & ~x09));
