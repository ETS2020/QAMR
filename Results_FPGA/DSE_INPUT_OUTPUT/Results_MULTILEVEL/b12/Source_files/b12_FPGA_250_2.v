// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:50 2020
...
module FAU ( 
  ...
  assign z2 = (~x11 | x13) & ((~new_n31_ & ~new_n32_) | (~new_n33_ & ~x01));
  ...
  assign z4 = ((~x11 | (~x07 & x13)) & (~x00 | ~x08 | ~x09)) | (x07 & ~x11);
  assign z5 = x12 | ~x13 | x10 | x00 | x07;
  assign z6 = ~x07 & ~x10 & (~x11 | x13) & (new_n38_ | new_n39_);
