// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:24 2020
...
module FAU ( 
  ...
  assign z1 = ~x00 & (x01 | (x02 & (x04 | (~x01 & x03 & ~x04))));
  ...
  assign z8 = (~new_n39_ & (x00 ? x09 : ~x01)) | ((x07 | x10) & (x00 | ~x01)) | (x00 & x01 & x09) | (~x00 & ~x01 & ~x09);
