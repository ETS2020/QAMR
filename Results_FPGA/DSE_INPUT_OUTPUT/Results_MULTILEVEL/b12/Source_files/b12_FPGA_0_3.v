...
module FAU ( 
  ...
  assign new_n27_ = (~x01 | ((~x02 | (x05 ? x11 : x04)) & (~x03 | (x05 ? x11 : x02)))) & (~x02 | ~x03 | x04 | (x05 & x11));
  assign z1 = ~x00 & ((x03 & (new_n29_ | (~new_n30_ & x02))) | (x02 & ~new_n30_ & x04));
  assign new_n29_ = x01 & (~x05 | (~x02 & ~x11));
  assign new_n30_ = x05 & (x11 | (x01 & x06));
  ...
  assign z4 = ((~x11 | (~x05 & ~x07)) & (~x00 | ~x08 | ~x09)) | (x07 & ~x11);
