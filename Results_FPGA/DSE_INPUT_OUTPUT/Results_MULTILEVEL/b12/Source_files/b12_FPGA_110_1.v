...
module FAU ( 
  ...
  assign new_n27_ = (~x02 | ((~x01 | (~x05 & (x04 | x14))) & (~x03 | x04 | (~x05 & x14)))) & (~x01 | ~x03 | (~x05 & (x02 | x14)));
  assign z1 = (new_n29_ | new_n30_) & ~x00;
  assign new_n29_ = x03 & ((x01 & ~x02 & (x05 | ~x14)) | (x02 & (x05 ? (~x01 | ~x06) : ~x14)));
  assign new_n30_ = x02 & x04 & (x05 ? (~x01 | ~x06) : ~x14);
