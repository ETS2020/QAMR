...
module FAU ( 
  ...
  assign z2 = (x02 & (~x00 | (~x07 & ~x08))) | new_n31_ | (~x07 & x10);
  assign new_n31_ = ~x01 & ((~x00 & (x07 ? ~x03 : x09)) | (~x07 & ~x08 & x09));
  assign z3 = (~x07 & x10) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = x07 ? ~x11 : (~x09 | x10 | ~x00 | ~x08);
  assign z5 = x07 | (~x10 & (x00 | x12 | ~x13));
  ...
  assign new_n39_ = ~x10 & ((~x08 & (x01 | x02 | ~x03)) | (~x01 & ~x02 & x03 & x09));
