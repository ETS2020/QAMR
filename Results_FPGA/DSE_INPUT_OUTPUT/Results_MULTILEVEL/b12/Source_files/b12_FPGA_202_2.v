...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n34_, new_n38_, new_n39_,
    new_n41_, new_n43_;
  assign z0 = ~x00 & x03 & ((~x04 & (x01 ? ~x05 : x02)) | (x01 & (~x02 | x05)));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = x01 ? (~x03 | (x02 & x05 & (~x05 | x06))) : (~x02 | (~x03 & ~x04));
  assign z2 = ~new_n32_ | (~x07 & (new_n30_ | new_n31_));
  assign new_n30_ = ~x01 & x09 & ~x10 & (~x00 | ~x08);
  assign new_n31_ = ~x08 & (x02 | (~x03 & x10));
  assign new_n32_ = (x00 | (~x02 & (x03 | (~x07 & ~x10)))) & (~x01 | x03);
  ...
  assign z7 = (~new_n41_ & (~x01 | x03)) | (x03 & (x01 ? ~x08 : (~x02 & x09))) | (~x01 & ~x08 & (x02 | ~x03));
