...
module FAU ( 
  ...
  assign z0 = (x04 & (x06 | (new_n27_ & ~x00 & x01))) | (~new_n28_ & ~x00);
  assign new_n27_ = x02 & x05;
  assign new_n28_ = (~x01 | (x02 ? x04 : ~x03)) & (~x02 | ~x03 | x04 | (x01 & x05 & x06));
  assign z1 = (new_n30_ & ~x00) | (x04 & (x06 | (~x00 & x02)));
  assign new_n30_ = x03 & (x02 ? (~x04 & (~x01 | ~x05 | ~x06)) : x01);
  ...
  assign z7 = new_n43_ | ~new_n44_ | new_n32_ | x07;
