...
module FAU ( 
  ...
  assign new_n30_ = (x01 | (~x03 & ~x04)) & (~x04 | x13 | (x05 & x06));
  assign new_n31_ = x01 & x03 & ~x13 & (~x02 | ~x05 | ~x06);
  assign z2 = (~x01 & (~new_n35_ | (~new_n33_ & (new_n34_ | x02)))) | (x02 & ~new_n33_ & ~x13);
  ...
  assign z5 = ~x13 | (~x01 & (x00 | x07 | x10 | x12));
  ...
  assign z7 = (x01 & (~x08 | x13)) | ~new_n43_ | (~x08 & (x02 | ~x03));
  assign new_n43_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (x01 & (x09 | x13)) | ~new_n46_ | (~new_n45_ & x09);
