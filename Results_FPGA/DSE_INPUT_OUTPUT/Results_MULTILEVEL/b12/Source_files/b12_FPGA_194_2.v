...
module FAU ( 
  ...
  assign z7 = new_n42_ | (~new_n43_ & ~x02) | (x02 & ~x08 & x11);
  assign new_n42_ = (x07 | x10) & (~x02 | x11);
  assign new_n43_ = (x08 | (~x01 & x03)) & (x01 | ~x03 | ~x09);
  assign z8 = (~x00 & (x02 ? x11 : ~x09)) | new_n42_ | (x09 & (x02 ? x11 : ~new_n45_));
