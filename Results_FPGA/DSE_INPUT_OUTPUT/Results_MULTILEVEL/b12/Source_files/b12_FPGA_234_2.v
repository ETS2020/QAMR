...
module FAU ( 
  ...
  assign z3 = (x01 & ~x08) | ((~x07 | ~x11) & (x00 | ~x12));
  ...
  assign z6 = (x01 & ~x08) | (~x07 & ~x10 & (new_n39_ | (~new_n38_ & ~x08)));
  assign new_n38_ = ~x02 & (~x03 | x09) & (x03 | ~x09);
  assign new_n39_ = ~x00 & (x01 ? (~x02 | ~x14) : (x02 | (x03 & ~x09) | (~x03 & x09)));
  assign z7 = ~new_n41_ | (~x08 & (x01 | x02 | ~x03));
  assign new_n41_ = ~x07 & ~x10 & (~x03 | ~x09 | x01 | x02);
  assign z8 = (x01 & (~x08 | x09)) | ~new_n44_ | (~new_n43_ & x09);
