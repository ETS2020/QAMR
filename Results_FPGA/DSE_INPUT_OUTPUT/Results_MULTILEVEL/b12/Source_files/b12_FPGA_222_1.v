...
module FAU ( 
  ...
  assign z2 = (new_n33_ & ~x07) | (~x00 & (new_n32_ | (~new_n28_ & x02)));
  assign new_n32_ = ~x01 & ((~x03 & x07 & ~x08) | (x09 & ~x10 & x03 & ~x07));
  assign new_n33_ = ~x08 & (x02 | (~x01 & ((x09 & ~x10) | (~x03 & (x09 | x10)))));
  assign z3 = new_n28_ | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x03 & (~x07 | x08)) | (x07 & ~x11) | (~x07 & (~x00 | ~x08 | ~x09));
  ...
  assign z7 = (~x08 & (x01 | x02)) | ~new_n42_ | x10 | (~x01 & ~x02 & x09);
