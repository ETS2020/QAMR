...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | (x02 ? x04 : ~x01)) & ~x11 & (~x01 | ~x02 | (x04 & ~x05));
  ...
  assign z4 = (x00 & ~x07 & (~x08 | ~x09)) | (~x11 & (~x00 | x07));
  assign z5 = ~x13 | x11 | x12 | x00 | x07 | x10;
  ...
  assign z8 = (~new_n44_ & (x00 ? x09 : ~x11)) | ((x07 | x10) & (x00 | ~x11)) | (~x00 & ~x09 & ~x11);
