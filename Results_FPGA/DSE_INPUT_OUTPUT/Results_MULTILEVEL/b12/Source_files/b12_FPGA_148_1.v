...
module FAU ( 
  ...
  assign z7 = ((x00 | ~x01) & (x07 | x10)) | (~new_n37_ & ~x01) | (x00 & x01 & ~x08);
  assign new_n37_ = (x08 | (~x02 & x03)) & (x02 | ~x03 | ~x09);
  assign z8 = (~new_n39_ & (x00 ? x09 : ~x01)) | ((x00 | ~x01) & (x07 | x10)) | (x00 & x01 & x09) | (~x00 & ~x01 & ~x09);
  assign new_n39_ = ~x02 & x03 & ~x12;
endmodule
