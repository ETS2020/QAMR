// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:46 2020
...
module FAU ( 
  ...
  assign z2 = new_n32_ | new_n27_ | (~new_n34_ & ~x01);
  ...
  assign z4 = ~new_n27_ & (x07 ? ~x11 : (~x00 | ~x08 | ~x09));
  assign z5 = x10 | x00 | x07 | x12 | ~x13;
  assign z6 = ~x07 & ~x10 & (new_n41_ | (~new_n39_ & ~x00));
  assign new_n39_ = ~new_n40_ & (~x01 | (x14 & (x02 | ~x13)));
  assign new_n40_ = (~x14 | (~x01 & x13)) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n41_ = ~x08 & (new_n40_ | (x01 & (~x14 | (x00 & x13))));
  assign z7 = ~new_n27_ & (~new_n43_ | (~x08 & (x01 | x02 | ~x03)));
  assign new_n43_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n45_ & x09) | x07 | (~x00 & ~x09) | new_n27_ | x10;
