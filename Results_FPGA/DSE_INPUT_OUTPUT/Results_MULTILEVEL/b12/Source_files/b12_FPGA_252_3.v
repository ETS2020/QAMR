// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:51 2020
...
module FAU ( 
  ...
  assign z2 = (~new_n30_ & ~new_n31_) | (~new_n32_ & ~x01) | (x01 & x03);
  ...
  assign new_n39_ = ~x03 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = (~new_n41_ & (~x01 | ~x03)) | (~x03 & ~x08) | (~x01 & (x02 ? ~x08 : (x03 & x09)));
