...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n37_, new_n38_, new_n40_,
    new_n42_;
  assign z0 = (x03 & ((x01 & ~x02) | (~x00 & ~x01 & x02 & ~x04))) | (x01 & (x00 | (x02 & (~x04 | x05))));
  ...
  assign z4 = (x00 & (x01 | (~x07 & (~x08 | ~x09)))) | (~x00 & ~x07) | (x07 & ~x11);
  assign z5 = x00 | x07 | (~x00 & ~x07 & (x10 | x12 | ~x13));
  assign z6 = (x00 & x01) | (~x07 & ~x10 & (x01 ? ~new_n37_ : new_n38_));
  assign new_n37_ = x02 & x14;
  assign new_n38_ = (~x00 | ~x08) & (x02 | (x03 & ~x09) | (~x03 & x09));
  assign z7 = (x01 & (x00 | ~x08)) | ~new_n40_ | (~x08 & (x02 | ~x03));
  assign new_n40_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n42_ & x09) | x01 | x07 | x10 | (~x00 & ~x09);
