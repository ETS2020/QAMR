...
module FAU ( 
  ...
  assign z1 = (~x00 & ((~new_n28_ & ((x01 & x03) | (x02 & x04))) | (x01 & ~x02 & x03))) | (~x01 & (x00 | (x02 & (x03 | x04))));
  ...
  assign z7 = ~new_n37_ | (~x01 & (x00 | (~x02 & x03 & x09)));
  assign new_n37_ = ~x07 & ~x10 & (x08 | (~x01 & ~x02 & x03));
  assign z8 = (x00 & (~x01 | x09)) | x07 | x10 | (~new_n39_ & ~x00);
