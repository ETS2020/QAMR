...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ~new_n32_) | (~new_n33_ & ~x01) | (~x11 & ~x12);
  ...
  assign z4 = x07 ? (~x11 & x12) : (((~x08 | ~x09) & (x12 | (x00 & x11))) | (~x00 & (x11 | x12)));
  assign z5 = (x11 & (x00 | x07 | (~x00 & ~x07 & (x10 | ~x13)))) | (x12 & (~x07 | (x07 & ~x11)));
  assign z6 = (~x11 & ~x12) | (~x07 & ~x10 & (new_n38_ | new_n39_));
  assign new_n38_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n39_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = new_n41_ | ~new_n42_ | x10 | (~x11 & ~x12);
  assign new_n41_ = ~x08 & (x01 | x02 | ~x03);
  assign new_n42_ = ~x07 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x11 & (x09 | ~x12)) | ~new_n45_ | (x09 & (~new_n44_ | ~x03 | x12));
