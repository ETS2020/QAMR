...
module FAU ( 
  ...
  assign z2 = (~x01 & (new_n31_ | (~x00 & (new_n32_ | x02)))) | (new_n33_ & x02);
  assign new_n31_ = ~x07 & ((~x08 & (x10 ? ~x03 : x09)) | (~x00 & x09 & ~x10));
  assign new_n32_ = ~x03 & (x07 | x10);
  assign new_n33_ = ~x08 & (~x00 | ~x07);
  ...
  assign new_n40_ = x01 & ~x08 & (x00 | ~x02 | ~x14);
