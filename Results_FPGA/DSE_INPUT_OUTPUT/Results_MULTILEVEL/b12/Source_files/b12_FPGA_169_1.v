...
module FAU ( 
  ...
  assign new_n30_ = (~x02 | ((~x04 | (x06 & (~x01 | x05))) & (~x03 | x06))) & (~x01 | ~x03 | (x02 & x05 & x06));
  ...
  assign new_n35_ = ~x06 & (x07 | x08 | ~x09 | x10);
  ...
  assign new_n43_ = (x01 | ~x06) & (x07 | x10);
  assign new_n44_ = (~x01 | x08) & (x06 | ((x08 | (~x02 & x03)) & (x01 | x02 | ~x03 | ~x09)));
  assign z8 = (~x00 & (x01 | (~x06 & ~x09))) | new_n43_ | (x09 & (x01 | (~new_n46_ & ~x06)));
