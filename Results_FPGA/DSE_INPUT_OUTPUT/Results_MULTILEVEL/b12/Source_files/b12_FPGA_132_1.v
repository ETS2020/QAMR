...
module FAU ( 
  ...
  assign z1 = (~x03 & (x06 | (~x00 & x02 & x04))) | (~x00 & ~new_n29_ & x03);
  assign new_n29_ = x02 ? (x01 & x05 & x06) : ~x01;
  assign z2 = (~new_n31_ & ~new_n32_) | new_n34_ | (~new_n33_ & ~x01);
  ...
  assign z7 = (~x03 & (x06 | ~x08)) | ~new_n42_ | (~x08 & (x01 | x02));
  assign new_n42_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x03 ? ~x09 : ~x06)) | (~new_n44_ & (x03 | ~x06)) | (x09 & (x03 ? ~new_n45_ : ~x06));
