...
module FAU ( 
  ...
  assign z0 = (~x01 & (x04 | (~x00 & x02 & x03 & ~x04))) | (~x00 & x01 & ((x02 & (~x04 | x05)) | (x03 & (~x02 | ~x04))));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (~x01 | (((x05 & x06) | (~x03 & (~x02 | ~x04))) & (x02 | ~x03))) & (~x03 | x04 | x01 | ~x02);
