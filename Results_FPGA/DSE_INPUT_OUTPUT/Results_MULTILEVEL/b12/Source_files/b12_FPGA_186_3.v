...
module FAU ( 
  ...
  assign z1 = (x10 & x12) | (~new_n29_ & ~x00);
  assign new_n29_ = (~x02 | (~x03 & ~x04) | (x01 & x05 & x06)) & (~x01 | x02 | ~x03);
  assign z2 = (~new_n31_ & (~x10 | ~x12)) | (~x01 & (new_n32_ | new_n33_));
  assign new_n31_ = (x00 | (~x02 & (x01 | x03 | ~x07))) & (~x02 | x07 | x08);
  assign new_n32_ = ~x00 & ((~x07 & x09 & ~x10) | (~x03 & x10 & ~x12));
  assign new_n33_ = ~x07 & ~x08 & ((x09 & ~x10) | (~x03 & x10 & ~x12));
  assign z3 = (~x07 | ~x11) & (~x12 | (x00 & ~x10));
  assign z4 = x07 ? (~x11 & (~x10 | ~x12)) : (x00 ? (~new_n36_ & (~x10 | ~x12)) : (~x10 | (x10 & ~x12)));
  assign new_n36_ = x08 & x09;
  assign z5 = ((~x10 | ~x12) & (x00 | x07)) | (~x00 & ~x07 & (x10 ? ~x12 : (x12 | ~x13)));
  ...
  assign z8 = x10 ? ~x12 : ((~new_n44_ & x09) | x07 | (~x00 & ~x09));
