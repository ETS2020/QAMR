...
module FAU ( 
  ...
  assign z1 = (~x00 & ((x02 & (x04 | (~x01 & x03))) | (x01 & x03 & (~new_n28_ | ~x02)))) | (x01 & x04);
  ...
  assign z7 = (x01 & (x04 | ~x08)) | ~new_n40_ | (~x08 & (x02 | ~x03));
  assign new_n40_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? ~x04 : ~x09)) | (~new_n42_ & (~x01 | ~x04)) | (x09 & (x01 ? ~x04 : ~new_n43_));
