...
module FAU ( 
  ...
  assign new_n33_ = (x01 | x02 | x03 | ~x10) & (~x02 | ~x14);
  assign new_n34_ = (x00 | (x07 ? x03 : (~x09 | x10))) & (~x09 | x10 | x07 | x08);
  assign z3 = (~x07 | ~x11) & ~new_n28_ & (x00 | ~x12);
  assign z4 = ~new_n28_ & (x07 ? ~x11 : (~x00 | (x00 & (~x08 | ~x09))));
  assign z5 = ~new_n28_ & (x00 | x07 | (~x00 & ~x07 & (x10 | x12 | ~x13)));
  assign z6 = ~x07 & ~x10 & (x02 ? new_n40_ : new_n39_);
  assign new_n39_ = (~x00 | ~x08) & (x01 | (x03 & ~x09) | (~x03 & x09));
  assign new_n40_ = x14 & (x00 ? ~x08 : ~x01);
  assign z7 = (x02 & (~x08 | ~x14)) | ~new_n42_ | (~x08 & (x01 | ~x03));
  assign new_n42_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x02 ? x14 : ~x09)) | (~new_n44_ & (~x02 | x14)) | (x09 & (x02 ? x14 : ~new_n45_));
