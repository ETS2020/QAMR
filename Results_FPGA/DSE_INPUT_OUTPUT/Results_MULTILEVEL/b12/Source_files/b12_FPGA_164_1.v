...
module FAU ( 
  ...
  assign new_n27_ = (~x01 | ((~x02 | (x04 & ~x05)) & (~x03 | (x02 & (x04 | x05) & (~x05 | x06))))) & (x04 | x05 | ~x02 | ~x03);
  assign z1 = ~new_n29_ & ~x00;
  assign new_n29_ = (~x02 | ((x05 | (~x04 & (~x03 | (x01 & x04)))) & (~x05 | x06 | ~x01 | ~x04))) & (~x01 | ~x03 | (x02 & (x04 | x05) & (~x05 | x06)));
