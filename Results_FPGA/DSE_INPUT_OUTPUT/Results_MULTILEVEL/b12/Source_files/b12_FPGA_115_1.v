...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & (x04 | ~x10)) | (~x01 & (new_n32_ | new_n33_));
  assign new_n31_ = (x00 | (~x02 & (x01 | x03 | ~x07))) & (~x02 | x07 | x08);
  assign new_n32_ = ~x00 & ((~x03 & x04 & x10) | (~x07 & x09 & ~x10));
  assign new_n33_ = ~x07 & ~x08 & ((x09 & ~x10) | (~x03 & x04 & x10));
