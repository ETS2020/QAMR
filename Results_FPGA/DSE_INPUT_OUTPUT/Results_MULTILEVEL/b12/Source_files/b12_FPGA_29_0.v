...
module FAU ( 
  ...
  assign z6 = ~x07 & ~x10 & (x00 ? (x01 & ~x08) : ~new_n38_);
  assign new_n38_ = x01 ? (x02 & x14) : (~x08 | (~x02 & (~x03 | x09) & (x03 | ~x09)));
  assign z7 = ~new_n40_ | ~x08 | x10;
  assign new_n40_ = ~x07 & (x01 | x02 | ~x03 | ~x09);
