...
module FAU ( 
  ...
  assign z2 = (~x01 & (new_n32_ | (~x00 & (new_n33_ | x02)))) | (new_n34_ & x02);
  assign new_n32_ = ~x07 & ((~x08 & (x10 ? ~x03 : x09)) | (~x00 & x09 & ~x10));
  assign new_n33_ = ~x03 & (x07 | x10);
  assign new_n34_ = ~x08 & (~x00 | ~x07);
  ...
  assign z6 = (x01 & x08) | (~x07 & ~x10 & (x01 ? ~new_n41_ : new_n40_));
  ...
  assign z8 = (x01 & (x08 | x09)) | ~new_n46_ | (~new_n45_ & x09);
