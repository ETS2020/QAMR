// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:02 2020
...
module FAU ( 
  ...
  assign new_n30_ = (~x02 | ((x01 | (~x04 & (~x03 | x04))) & (~x04 | (x05 & x06)))) & (~x01 | ~x03 | (x02 & x05 & x06));
  ...
  assign z6 = new_n28_ | (~x07 & ~new_n39_ & ~x10);
  assign new_n39_ = x01 ? (x00 ? x08 : x02) : ((x00 & x08) | (~x02 & (x03 | ~x09) & (~x03 | x09)));
  assign z7 = ((~x01 | x14) & (x07 | x10)) | (~new_n41_ & ~x01) | (x01 & ~x08 & x14);
  assign new_n41_ = (x08 | (~x02 & x03)) & (x02 | ~x03 | ~x09);
  assign z8 = (x01 & (x09 | ~x14)) | ~new_n44_ | (~new_n43_ & x09);
