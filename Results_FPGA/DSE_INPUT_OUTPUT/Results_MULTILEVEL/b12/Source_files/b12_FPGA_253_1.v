...
module FAU ( 
  ...
  assign new_n30_ = x03 & ((x01 & ~x02 & (x05 | ~x13)) | (x02 & (x05 ? (~x01 | ~x06) : ~x13)));
  assign new_n31_ = x02 & x04 & (x05 ? (~x01 | ~x06) : ~x13);
  ...
  assign z5 = ~x13 | (x05 & (x10 | x12 | x00 | x07));
  ...
  assign new_n46_ = ~x10 & (x05 | ~x13) & ~x07 & (x00 | x09);
endmodule
