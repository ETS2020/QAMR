...
module FAU ( 
  ...
  assign new_n33_ = (~x02 | (~x01 & ~x14)) & (x01 | x03 | ~x10 | ~x14);
  ...
  assign z5 = ~new_n30_ & (x00 | x07 | x10 | x12 | ~x13);
  assign z6 = new_n30_ | (~x07 & ~x10 & (new_n39_ | new_n40_ | new_n41_));
  assign new_n39_ = x01 & (x00 ? ~x08 : ~x02);
  assign new_n40_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n41_ = ~x00 & ~x14;
  assign z7 = ~new_n43_ | (~x01 & (~x14 | (~x02 & x03 & x09)));
  assign new_n43_ = (x08 | (~x01 & ~x02 & x03)) & ~x07 & ~x10;
  assign z8 = (~x14 & (~x01 | x09)) | ~new_n46_ | (~new_n45_ & x09);
