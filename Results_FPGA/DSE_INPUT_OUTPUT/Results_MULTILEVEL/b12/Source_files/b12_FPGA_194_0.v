// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:26 2020
...
module FAU ( 
  ...
  assign z0 = (~x02 & (~x11 | (~x00 & x01 & x03))) | (~x00 & ~new_n27_ & x02);
  assign new_n27_ = (~x01 | (x04 & ~x05)) & (~x03 | x04);
  assign z1 = (~x02 & ~x11) | (~new_n29_ & ~x00);
  assign new_n29_ = (~x02 | (~x03 & ~x04) | (x01 & x05 & x06)) & (~x01 | x02 | ~x03);
  assign z2 = (~new_n31_ & ~new_n32_) | (~x01 & ~new_n33_ & x11);
  assign new_n31_ = x00 & (x07 | x08);
  assign new_n32_ = ~x02 & (x01 | x03 | ~x10 | ~x11);
  assign new_n33_ = (x00 | (x07 ? x03 : (~x09 | x10))) & (x07 | x08 | ~x09 | x10);
  assign z3 = (~x02 & ~x11) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x07 & (x02 | x11) & (~x00 | ~x08 | ~x09)) | (x02 & x07 & ~x11);
  assign z5 = ~new_n37_ | ~x13 | x10 | x12;
  assign new_n37_ = ~x07 & ~x00 & (x02 | x11);
  assign z6 = ~x07 & ~x10 & (x02 ? ~new_n40_ : new_n39_);
  assign new_n39_ = x11 & (~x00 | ~x08) & (x01 | (~x03 & x09) | (x03 & ~x09));
