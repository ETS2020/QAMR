...
module FAU ( 
  ...
  assign new_n27_ = (~x02 | (x01 ? ~x05 : (~x03 | x04))) & (~x01 | ~x03 | ~x05 | (x02 & x06));
  assign z1 = ~new_n29_ & ~x00;
  assign new_n29_ = (~x01 | ~x03 | ~x05 | (x02 & x06)) & (~x02 | ((x01 | (~x03 & ~x04)) & (~x01 | ~x04 | ~x05 | x06)));
  assign z2 = (~new_n31_ & ~new_n32_) | (~new_n33_ & ~x01) | (x01 & ~x05);
  ...
  assign z7 = ((~x01 | x05) & (x07 | x10)) | (~new_n42_ & ~x01) | (x01 & x05 & ~x08);
  assign new_n42_ = (x08 | (~x02 & x03)) & (x02 | ~x03 | ~x09);
  assign z8 = (x01 & (~x05 | x09)) | ~new_n45_ | (~new_n44_ & x09);
