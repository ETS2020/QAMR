...
module FAU ( 
  ...
  assign z1 = (~new_n29_ & ~x00) | (~x01 & x10);
  assign new_n29_ = (~x02 | ((x01 | (~x03 & ~x04)) & (~x04 | (x05 & x06)))) & (~x01 | ~x03 | (x02 & x05 & x06));
  assign z2 = (x02 & (~x00 | (~x07 & ~x08))) | (~new_n31_ & ~x01);
  assign new_n31_ = (x00 | (x07 ? x03 : ~x09)) & ~x10 & (x07 | x08 | ~x09);
  assign z3 = (~x07 | ~x11) & (x01 | ~x10) & (x00 | ~x12);
  assign z4 = x07 ? (~x11 & (x01 | ~x10)) : (x00 ? (~new_n34_ & (x01 | ~x10)) : (~x10 | (x01 & x10)));
  assign new_n34_ = x08 & x09;
  assign z5 = ((x00 | x07) & (x01 | ~x10)) | (~x00 & ~x07 & (x10 ? x01 : (x12 | ~x13)));
  assign z6 = (~x01 & x10) | (~x07 & (x01 ? (~new_n38_ & ~x10) : new_n37_));
