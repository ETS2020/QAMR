...
module FAU ( 
  ...
  assign z1 = (x01 & x13) | (~new_n29_ & ~x00);
  assign new_n29_ = (~x02 | ((x01 | (~x04 & (~x03 | x04))) & (~x04 | (x05 & x06)))) & (~x01 | ~x03 | (x02 & x05 & x06));
  assign z2 = (~x01 & (~new_n33_ | (~new_n31_ & (new_n32_ | x02)))) | (x02 & ~new_n31_ & ~x13);
  ...
  assign new_n40_ = ~x13 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = (x01 & (~x08 | x13)) | ~new_n42_ | (~x08 & (x02 | ~x03));
  assign new_n42_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? ~x13 : ~x09)) | (~new_n44_ & (~x01 | ~x13)) | (x09 & (x01 ? ~x13 : ~new_n45_));
