...
module FAU ( 
  ...
  assign new_n33_ = (x09 ? ~x11 : x10) & (~x00 | (~x07 & ~x08));
  assign new_n34_ = ~x07 & x09 & ~x10 & ~x11 & (~x00 | ~x08);
  assign z3 = (~x11 | (~x07 & ~x09)) & (x00 | ~x12);
  assign z4 = x07 ? (x09 | ~x11) : (~x09 | x11 | ~x00 | ~x08);
  ...
  assign new_n40_ = ~x01 & (~x00 | ~x08) & (x03 ? ~x09 : (x09 & ~x11));
  assign z7 = new_n43_ | new_n44_ | (~new_n42_ & (x01 | x02 | ~x03));
  assign new_n42_ = (x08 | (x09 & x11)) & (x11 | (~x07 & ~x10));
  assign new_n43_ = ~x09 & (x07 | x10);
  assign new_n44_ = ~x01 & ~x02 & x03 & x09 & ~x11;
  assign z8 = (~new_n46_ & x09) | x07 | x10 | (~x00 & ~x09);
  assign new_n46_ = ~x01 & ~x02 & x03 & ~x11 & ~x12;
endmodule
