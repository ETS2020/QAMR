...
module FAU ( 
  ...
  assign new_n30_ = (~x02 | (x06 & ((~x03 & ~x04) | (x01 & x05)))) & (~x01 | x02 | ~x03);
  assign z2 = new_n32_ | new_n28_ | (~new_n34_ & ~x01);
  assign new_n32_ = ~new_n33_ & (~x00 | (~x07 & ~x08));
  ...
  assign new_n39_ = ~new_n28_ & (x00 ? (x01 & ~x08) : (x01 ? (~x02 | ~x14) : x02));
  assign new_n40_ = (~x00 | x03 | ~x06 | (~x02 & ~x09)) & (x01 | ~x03 | (~x02 & x09));
  assign new_n41_ = ~x00 & ~x01 & (x03 ? ~x09 : (x06 & x09));
  assign z7 = (~x03 & (~x06 | ~x08)) | ~new_n43_ | (~x08 & (x01 | x02));
  assign new_n43_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n45_ | (~x03 & (~x06 | x09));
  assign new_n45_ = (new_n46_ | ~x09) & ~x07 & ~x10 & (x00 | x09);
