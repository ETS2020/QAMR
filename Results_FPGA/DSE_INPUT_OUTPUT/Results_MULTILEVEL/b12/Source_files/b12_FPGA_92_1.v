...
module FAU ( 
  ...
  assign z6 = (~x01 & x05) | (~x07 & ~x10 & (x01 ? ~new_n39_ : new_n38_));
  assign new_n38_ = (~x00 | ~x08) & (x02 | (x03 & ~x09) | (~x03 & x09));
  assign new_n39_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n41_ | (~new_n34_ & (x07 | x10));
  assign new_n41_ = (x05 | ((x08 | (~x02 & x03)) & (x01 | x02 | ~x03 | ~x09))) & (~x01 | x08);
  assign z8 = (x05 & (~x01 | x09)) | ~new_n44_ | (~new_n43_ & x09);
