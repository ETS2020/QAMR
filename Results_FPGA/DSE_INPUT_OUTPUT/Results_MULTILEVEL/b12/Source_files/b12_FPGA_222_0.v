...
module FAU ( 
  ...
  assign z2 = (x03 & (new_n32_ | (~new_n31_ & ~x00))) | (~x00 & ~new_n33_ & x08);
  assign new_n31_ = ~x02 & (~x09 | x10 | x01 | x07);
  assign new_n32_ = ~x07 & ~x08 & (x02 | (~x01 & x09 & ~x10));
  assign new_n33_ = ~x02 & (x01 | x03 | (~x07 & ~x09 & ~x10));
  assign z3 = (~x03 & ~x08) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x08 & (~x03 | ~x07)) | (x07 & ~x11) | (~x07 & (~x00 | ~x09));
  assign z5 = ~new_n37_ | x10 | x12 | ~x13;
  assign new_n37_ = ~x07 & ~x00 & (x03 | x08);
  assign z6 = (~x03 & ~x08) | (~x07 & ~x10 & (new_n39_ | new_n40_));
  assign new_n39_ = ~x01 & ((x02 & (~x00 | ~x08)) | (~x08 & ~x09) | (~x00 & (x03 ^ x09)));
  assign new_n40_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = ~new_n42_ | (~x08 & (x01 | x02 | ~x03));
  assign new_n42_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x03 ? ~x09 : x08)) | (~new_n44_ & (x03 | x08)) | (x09 & (x03 ? ~new_n45_ : x08));
