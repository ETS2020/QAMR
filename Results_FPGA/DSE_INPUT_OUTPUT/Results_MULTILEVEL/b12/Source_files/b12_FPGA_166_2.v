...
module FAU ( 
  ...
  assign new_n27_ = ~x00 & ((x02 & (x01 | (~x01 & x03 & ~x04))) | (x01 & x03 & (~x02 | ~x06)));
  assign new_n28_ = x01 & ~x05;
  assign z1 = new_n28_ | new_n30_;
  assign new_n30_ = ~x00 & ((x01 & x03 & (~x02 | ~x06)) | (x02 & (x01 ? (x04 & ~x06) : (x03 | x04))));
  assign z2 = (~new_n32_ & ~new_n33_) | (x01 & ~x05) | (~new_n34_ & ~x01);
  ...
  assign z7 = (x01 & (~x05 | ~x08)) | ~new_n42_ | (~x08 & (x02 | ~x03));
  assign new_n42_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? x05 : ~x09)) | (~new_n44_ & (~x01 | x05)) | (x09 & (x01 ? x05 : ~new_n45_));
