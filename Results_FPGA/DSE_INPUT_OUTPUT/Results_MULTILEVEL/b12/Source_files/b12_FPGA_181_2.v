...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | (x05 & ~x12) | (x02 ? x04 : ~x01)) & (~x01 | ~x02 | (x05 ? ~x12 : x04));
  assign z1 = ~x00 & ((x03 & (new_n29_ | (~new_n30_ & x02))) | (x02 & ~new_n30_ & x04));
  assign new_n29_ = x01 & (~x05 | (~x02 & x12));
  assign new_n30_ = x05 & (~x12 | (x01 & x06));
  assign z2 = ~new_n32_ & ((~new_n35_ & ~x01) | (~new_n33_ & ~new_n34_));
  ...
  assign z5 = x12 | (~x05 & (x00 | x07 | x10 | ~x13));
  ...
  assign z7 = ~new_n32_ & (~new_n43_ | (~x08 & (x01 | x02 | ~x03)));
