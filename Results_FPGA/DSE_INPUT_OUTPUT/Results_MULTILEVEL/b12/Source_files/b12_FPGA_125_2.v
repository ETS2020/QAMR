...
module FAU ( 
  ...
  assign new_n27_ = (~x02 | (~x01 & (x01 | ~x03 | x04))) & (~x01 | ~x03 | ~x05 | (x02 & x06));
  assign new_n28_ = x01 & ~x05;
  assign z1 = ~new_n30_ & ~x00;
  assign new_n30_ = (~x01 | ~x03 | ~x05 | (x02 & x06)) & (~x02 | ((x01 | (~x03 & ~x04)) & (~x01 | ~x04 | ~x05 | x06)));
  assign z2 = (~new_n32_ & ~new_n33_) | (~new_n34_ & ~x01) | (x01 & ~x05);
  ...
  assign new_n40_ = x05 & (x00 ? ~x08 : (~x02 | ~x14));
