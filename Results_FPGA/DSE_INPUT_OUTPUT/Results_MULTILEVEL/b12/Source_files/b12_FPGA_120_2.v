// Benchmark "FAU" written by ABC on Mon Aug 17 19:55:56 2020
...
module FAU ( 
  ...
  assign z4 = (~x00 & (x13 ? ~x07 : ~x11)) | (x00 & (~x11 | (~x07 & x13)) & (~x08 | ~x09)) | (x07 & ~x11);
  assign z5 = ((x00 | x07) & (~x11 | x13)) | (~x00 & ((~x11 & ~x13) | (~x07 & x13 & (x10 | x12))));
  ...
  assign z7 = new_n42_ | ~new_n43_ | new_n28_ | x10;
  assign new_n42_ = ~x08 & (x01 | x02 | ~x03);
  assign new_n43_ = ~x07 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n28_ & ((~new_n45_ & x09) | x07 | x10 | (~x00 & ~x09));
