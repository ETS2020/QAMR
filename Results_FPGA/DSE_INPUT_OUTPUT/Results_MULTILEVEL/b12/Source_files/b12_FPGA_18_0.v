...
module FAU ( 
  ...
  assign new_n28_ = (((~x01 | ~x03) & (~x02 | ~x04)) | (x05 & x06)) & (~x01 | x02 | ~x03) & (x01 | ~x02 | ~x04);
  ...
  assign z4 = ~new_n35_ & (x07 ? ~x11 : (~x00 | ~x08 | ~x09));
  assign z5 = ~x13 | x10 | x12 | x07 | new_n35_ | x00;
  assign z6 = (~x01 & ~x04) | (~x07 & ~x10 & (x01 ? ~new_n40_ : new_n39_));
  assign new_n39_ = (~x00 | ~x08) & (x02 | (x03 & ~x09) | (~x03 & x09));
  assign new_n40_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n42_ | (~x01 & (~x04 | (~x02 & x03 & x09)));
  assign new_n42_ = (x08 | (~x01 & ~x02 & x03)) & ~x07 & ~x10;
  assign z8 = (~x00 & (x01 | (x04 & ~x09))) | (~new_n44_ & (x01 | x04)) | (x09 & (x01 | (~new_n45_ & x04)));
