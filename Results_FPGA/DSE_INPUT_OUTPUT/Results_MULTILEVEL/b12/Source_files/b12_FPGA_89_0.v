...
module FAU ( 
  ...
  assign z3 = (~x07 | ~x11) & (x00 | ~x12) & (x01 | x09);
  ...
  assign new_n39_ = x01 ? (x00 ? x08 : (x02 & x14)) : ((x00 & x08) | (~x02 & x03));
  assign z7 = new_n41_ | x07 | ~x08 | x10;
  assign new_n41_ = ~x01 & (~x09 | (~x02 & x03));
  assign z8 = (x01 & (~x00 | x09)) | (~new_n43_ & ~x01) | x07 | x10;
  assign new_n43_ = x09 & ~x12 & ~x02 & x03;
endmodule
