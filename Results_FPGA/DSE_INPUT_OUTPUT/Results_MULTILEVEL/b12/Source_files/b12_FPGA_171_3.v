...
module FAU ( 
  ...
  assign z2 = (~x01 & (~new_n33_ | (~new_n31_ & (new_n32_ | x02)))) | (x02 & ~new_n31_ & ~x12);
  ...
  assign z7 = (~new_n42_ & (~x01 | ~x12)) | (~new_n43_ & ~x01) | (x01 & ~x08 & ~x12);
  assign new_n42_ = ~x07 & ~x10;
  assign new_n43_ = (x08 | (~x02 & x03)) & (x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? ~x12 : ~x09)) | (~new_n42_ & (~x01 | ~x12)) | (x09 & (x01 ? ~x12 : ~new_n45_));
