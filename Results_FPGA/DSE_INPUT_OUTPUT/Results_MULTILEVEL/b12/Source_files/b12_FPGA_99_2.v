...
module FAU ( 
  ...
  assign z6 = (x00 & (~x01 | (~x07 & ~x08 & ~x10))) | (~x07 & ~new_n36_ & ~x10);
  assign new_n36_ = (x00 | ~x01 | (x02 & x14)) & (x01 | (~x02 & (~x03 | x09) & (x03 | ~x09)));
  assign z7 = ~new_n38_ | ((~x00 | x01) & (x07 | x10));
  assign new_n38_ = (x00 | ((x08 | (~x02 & x03)) & (x01 | x02 | ~x03 | ~x09))) & (~x01 | x08);
  assign z8 = (x00 & (~x01 | x09)) | (~new_n40_ & ~x00) | x07 | x10;
  assign new_n40_ = ~x01 & ~x02 & x03 & x09 & ~x12;
endmodule
