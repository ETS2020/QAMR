...
module FAU ( 
  ...
  assign z0 = (~x01 & (x08 | (new_n27_ & ~x00 & x02))) | (~x00 & ~new_n28_ & x01);
  assign new_n27_ = x03 & ~x04;
  assign new_n28_ = x02 ? (x04 & ~x05) : ~x03;
  assign z1 = (~new_n30_ & ~x00) | (~x01 & x08);
  assign new_n30_ = (~x02 | ((x01 | (~x03 & ~x04)) & (~x04 | (x05 & x06)))) & (~x01 | ~x03 | (x02 & x05 & x06));
  assign z2 = new_n32_ | (~x01 & (x08 | (~new_n33_ & ~x07))) | (x02 & ~x07 & ~x08);
  assign new_n32_ = ~x00 & (x02 | (~x01 & ~x03 & x07));
  assign new_n33_ = x10 ? x03 : ~x09;
