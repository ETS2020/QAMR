...
module FAU ( 
  ...
  assign new_n30_ = (~x03 | ((~x01 | (x02 & x06)) & (~x02 | (x01 & x05 & x06)))) & (~x02 | ~x04 | (x01 & x05 & x06));
  ...
  assign z3 = (x06 & x12) | ((~x07 | ~x11) & (x00 | ~x12));
  ...
  assign z7 = (~new_n42_ & ~x08) | ~new_n43_ | new_n28_ | x10;
  assign new_n42_ = ~x01 & ~x02 & x03;
  assign new_n43_ = ~x07 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x09 & ((~new_n45_ & ~x06) | (~x00 & (~x06 | ~x12)))) | (~x12 & (~new_n45_ | (~new_n42_ & x09))) | (~x06 & x09 & x12);
