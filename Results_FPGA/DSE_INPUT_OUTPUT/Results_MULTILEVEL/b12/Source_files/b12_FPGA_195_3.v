...
module FAU ( 
  ...
  assign z1 = (x02 & x05) | (~x00 & ((x02 & (x03 | x04)) | (x01 & ~x02 & x03)));
  ...
  assign z7 = new_n40_ | (~new_n41_ & ~x02) | (x02 & ~x05 & ~x08);
  assign new_n40_ = (x07 | x10) & (~x02 | ~x05);
  assign new_n41_ = (x08 | (~x01 & x03)) & (x01 | ~x03 | ~x09);
  assign z8 = (~x00 & (x02 ? ~x05 : ~x09)) | new_n40_ | (x09 & (x02 ? ~x05 : ~new_n43_));
