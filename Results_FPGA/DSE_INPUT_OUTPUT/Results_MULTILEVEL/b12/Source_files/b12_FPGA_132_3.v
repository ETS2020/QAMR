...
module FAU ( 
  ...
  assign new_n27_ = (~x01 | ((~x02 | x03 | (x04 & ~x05)) & (~x03 | x06 | (x02 & ~x05)))) & (~x02 | ~x03 | x04 | x06);
  assign z1 = new_n30_ | (~new_n29_ & ~x00);
  assign new_n29_ = (~x03 | (~x02 & (~x01 | x06 | (x02 & ~x05)))) & (~x02 | ~x04 | (x01 & x05 & x06));
  assign new_n30_ = x03 & x06;
  assign z2 = (~new_n32_ & ~new_n33_) | new_n30_ | (~new_n34_ & ~x01);
  ...
  assign z6 = new_n30_ | (~x07 & ~x10 & (new_n39_ | new_n40_));
  ...
  assign z8 = (~x00 & (~x03 | (~x06 & ~x09))) | (~new_n44_ & (~x03 | ~x06)) | (x09 & (~x03 | (~new_n45_ & ~x06)));
