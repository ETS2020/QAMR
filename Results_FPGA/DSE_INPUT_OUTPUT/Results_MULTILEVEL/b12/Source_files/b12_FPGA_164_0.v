...
module FAU ( 
  ...
  assign new_n27_ = (~x01 | ((~x02 | (x04 & ~x05)) & (~x03 | (x02 & (x04 | x05) & (~x05 | x06))))) & (x01 | ~x02 | ~x03 | x04 | ~x05);
  assign z1 = ~new_n29_ & ~x00;
  assign new_n29_ = (~x02 | ((~x04 | (x01 ? (x05 & (~x05 | x06)) : ~x05)) & (x01 | ~x03 | ~x05))) & (~x01 | ~x03 | (x02 & (x04 | x05) & (~x05 | x06)));
  ...
  assign z6 = (~x01 & ~x05) | (~x07 & ~x10 & (x01 ? ~new_n41_ : new_n40_));
  assign new_n40_ = (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n41_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n43_ | (~new_n36_ & (x07 | x10));
  assign new_n43_ = (~x05 | ((x08 | (~x02 & x03)) & (x01 | x02 | ~x03 | ~x09))) & (~x01 | x08);
  assign z8 = (~x05 & (~x01 | x09)) | ~new_n46_ | (~new_n45_ & x09);
