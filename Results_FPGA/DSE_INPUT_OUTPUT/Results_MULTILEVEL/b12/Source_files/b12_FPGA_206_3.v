...
module FAU ( 
  ...
  assign z2 = ~new_n34_ | (~new_n33_ & (~x00 | (~x07 & ~x08)));
  assign new_n33_ = ~x02 & (x01 | (~x09 & (x03 | ~x10)));
  assign new_n34_ = (~x03 | ~x09) & (x00 | x01 | x03 | ~x07);
  assign z3 = (~x07 | ~x11) & ~new_n28_ & (x00 | ~x12);
  assign z4 = (x03 & (~x07 | x09)) | (~x07 & (~x00 | ~x08 | ~x09)) | (x07 & ~x11);
  assign z5 = ~x13 | x10 | x12 | new_n28_ | x00 | x07;
  assign z6 = new_n28_ | (~x07 & ~x10 & (new_n39_ | new_n40_));
  assign new_n39_ = (x00 ? ~x08 : ~x01) & (x02 | x03 | x09);
  assign new_n40_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = ((~x03 | ~x09) & (x07 | x10)) | (~x08 & (~x03 | (~new_n42_ & ~x09)));
  assign new_n42_ = ~x01 & ~x02;
  assign z8 = x09 | x10 | ~x00 | x07;
endmodule
