...
module FAU ( 
  ...
  assign new_n36_ = ~x07 & ~x00 & (x02 | x09);
  assign z6 = (~x02 & ~x09) | (~x07 & ~new_n38_ & ~x10);
  assign new_n38_ = x02 ? (x00 ? x08 : (x01 & x14)) : ((x00 & x08) | (~x01 & x03));
  assign z7 = new_n40_ | x07 | ~x08 | x10;
  assign new_n40_ = ~x02 & (~x09 | (~x01 & x03));
  assign z8 = (x02 & (~x00 | x09)) | (~new_n42_ & ~x02) | x07 | x10;
  assign new_n42_ = x09 & ~x12 & ~x01 & x03;
endmodule
