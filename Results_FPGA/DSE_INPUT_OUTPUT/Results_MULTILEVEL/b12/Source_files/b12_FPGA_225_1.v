...
module FAU ( 
  ...
  assign z0 = ~x00 & ((x01 & ((x02 & (~x04 ^ x05)) | (x03 & (x04 ? ~x02 : ~x05)))) | (~x04 & ~x05 & x02 & x03));
  assign z1 = new_n29_ | (~new_n28_ & ~x00);
  assign new_n28_ = (~x03 | ((~x01 | (x04 ? x02 : x05)) & (~x02 | x04 | x05))) & (~x02 | ~x04 | (x01 & x05 & x06));
  ...
  assign z6 = new_n29_ | (~x07 & ~x10 & (new_n38_ | new_n39_));
  assign new_n38_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n39_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = new_n41_ | ~new_n42_ | new_n29_ | x07;
