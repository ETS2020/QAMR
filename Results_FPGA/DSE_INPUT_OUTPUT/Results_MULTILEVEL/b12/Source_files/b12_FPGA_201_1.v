...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | ((~x01 | x02) & (x01 | ~x02 | x04 | x10))) & (~x01 | ~x02 | (x04 & ~x05));
  assign z1 = ~x00 & ((~new_n30_ & x02) | (x01 & x03 & (~new_n29_ | ~x02)));
  assign new_n29_ = x05 & x06;
  assign new_n30_ = (~x04 | (x01 ? (x05 & x06) : x10)) & (x01 | ~x03 | x10);
  assign z2 = (x02 & (~x00 | (~x07 & ~x08))) | (~new_n32_ & ~x01);
  assign new_n32_ = (x00 | (x07 ? x03 : ~x09)) & ~x10 & (x07 | x08 | ~x09);
  assign z3 = (~x07 | ~x11) & (x01 | ~x10) & (x00 | ~x12);
  assign z4 = ~new_n35_ & (x01 | ~x10);
  assign new_n35_ = x07 ? x11 : (x00 & x08 & x09);
