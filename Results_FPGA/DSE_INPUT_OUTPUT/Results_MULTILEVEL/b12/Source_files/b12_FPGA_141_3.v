...
module FAU ( 
  ...
  assign z1 = (x01 & x09) | (~new_n29_ & ~x00);
  ...
  assign new_n32_ = (x01 | x03 | ~x07) & (x07 | ~x09 | x10);
  assign new_n33_ = x09 & (x01 | (~x07 & ~x08 & ~x10));
  ...
  assign z8 = (~new_n42_ & (~x01 | ~x09)) | (~x00 & ~x09) | (~x01 & ~new_n44_ & x09);
