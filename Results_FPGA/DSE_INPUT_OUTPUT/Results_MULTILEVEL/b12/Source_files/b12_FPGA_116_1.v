...
module FAU ( 
  ...
  assign z4 = (~x09 & (~x07 | x14)) | (~new_n37_ & ~x07) | (x07 & ~x11);
  assign new_n37_ = x00 & x08;
  assign z5 = ~new_n27_ & (x00 | x07 | x10 | x12 | ~x13);
  assign z6 = new_n27_ | (~x07 & ~x10 & (new_n41_ | (~new_n37_ & ~new_n40_)));
  assign new_n40_ = ((~x01 & ~x02) | (x09 & x14)) & (x01 | (~x02 & (x03 | ~x09))) & (~x03 | x09) & (x03 | ~x09 | x14);
  assign new_n41_ = x01 & (x00 ? ~x08 : ~x02);
  assign z7 = ((x09 | ~x14) & (x07 | x10)) | (x09 & (new_n43_ | ~x08)) | (~x08 & ~new_n43_ & ~x14);
