...
module FAU ( 
  ...
  assign z5 = (x00 & (x03 | (~x07 & ~x09))) | (x07 & (x03 | ~x09)) | (~x07 & ~new_n38_ & (~x09 | (~x00 & x03)));
  ...
  assign new_n42_ = (x01 | ((x00 | (~x02 & (~x03 | x09))) & (~x02 | x08 | ~x09))) & (~x00 | ~x02 | x08 | x09);
  assign z7 = ~new_n44_ | (~x03 & (~x08 | x09));
  assign new_n44_ = ((~x01 & ~x02) | x08) & ~x07 & ~x10 & (x01 | x02 | ~x09);
  assign z8 = ((x03 | ~x09) & (x07 | x10)) | (x03 & ~new_n46_ & x09) | (~x00 & ~x09);
