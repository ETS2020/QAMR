...
module FAU ( 
  ...
  assign new_n29_ = (~x03 | (x01 ? (x05 & (x02 | ~x06)) : ~x02)) & (~x02 | ~x04 | (x01 & x05));
  ...
  assign z7 = (x01 & (~x06 | ~x08)) | ~new_n42_ | (~x08 & (x02 | ~x03));
  assign new_n42_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? x06 : ~x09)) | (~new_n44_ & (~x01 | x06)) | (x09 & (x01 ? x06 : ~new_n45_));
