...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ~x00) | (~new_n32_ & ~x07);
  assign new_n31_ = (x01 | x03 | (~x07 & ~x10)) & ~x02 & (x07 | ~x09 | x10);
  assign new_n32_ = ~x01 & (x08 | (~x02 & (~x09 | x10) & (x03 | ~x10)));
  ...
  assign z8 = (~new_n41_ & x09) | ~new_n39_ | x10 | (~x00 & ~x09);
