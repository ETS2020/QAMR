...
module FAU ( 
  ...
  assign new_n28_ = (~x03 | ((~x01 | x02 | (x04 & ~x06)) & (~x02 | x04 | (x01 & x05 & x06)))) & (~x01 | ~x02 | (x04 & ~x05));
  assign z1 = ~new_n30_ & ~x00;
  assign new_n30_ = (~x03 | ((~x01 | x02 | (x04 & ~x06)) & (~x02 | x04 | (x01 & x05 & x06)))) & (~x02 | ~x04 | ~x06 | (x01 & x05));
  ...
  assign z6 = ~x07 & ~new_n27_ & (new_n39_ | new_n40_) & ~x10;
  ...
  assign new_n44_ = ~x07 & (~x04 | x06) & ~x10 & (x00 | x09);
endmodule
