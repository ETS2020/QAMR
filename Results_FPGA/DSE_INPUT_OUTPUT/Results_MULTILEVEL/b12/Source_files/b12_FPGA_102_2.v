...
module FAU ( 
  ...
  assign z2 = (~new_n32_ & ~new_n33_) | (~new_n34_ & ~x01) | (x01 & ~x12);
  ...
  assign z7 = (x01 & (~x08 | ~x12)) | ~new_n44_ | (~new_n43_ & ~x08);
  assign new_n43_ = ~x02 & x03;
  assign new_n44_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? x12 : ~x09)) | (~new_n46_ & (~x01 | x12)) | (x09 & (x12 | (~new_n43_ & ~x01)));
