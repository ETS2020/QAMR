// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:37 2020
...
module FAU ( 
  ...
  assign new_n40_ = x12 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = (x01 & (~x08 | ~x12)) | ~new_n43_ | (~new_n42_ & ~x08);
  assign new_n42_ = ~x02 & x03;
  assign new_n43_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? x12 : ~x09)) | (~new_n45_ & (~x01 | x12)) | (x09 & (x12 | (~new_n42_ & ~x01)));
