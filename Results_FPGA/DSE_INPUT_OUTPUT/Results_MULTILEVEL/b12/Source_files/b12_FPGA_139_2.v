...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ~new_n32_) | (x01 & ~x06) | (~new_n33_ & ~x01);
  ...
  assign z5 = ~x13 | x10 | x12 | new_n35_ | x00 | x07;
  assign z6 = ~x07 & ~x10 & (x01 ? new_n40_ : new_n39_);
  assign new_n39_ = (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = x06 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = ((~x01 | x06) & (x07 | x10)) | (~new_n42_ & ~x01) | (x01 & x06 & ~x08);
  assign new_n42_ = (x08 | (~x02 & x03)) & (x02 | ~x03 | ~x09);
  assign z8 = (x01 & (~x06 | x09)) | ~new_n45_ | (~new_n44_ & x09);
