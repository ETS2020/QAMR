...
module FAU ( 
  ...
  assign new_n30_ = (x03 | (x04 & ~x09)) & (~x01 | ~x05 | ~x06);
  ...
  assign z4 = (~x03 & (~x07 | x09)) | (x07 & ~x11) | (~x07 & (~x00 | ~x08 | ~x09));
  ...
  assign new_n41_ = (x01 | ((x00 | (~x02 & (~x03 | x09))) & (~x02 | x08 | ~x09))) & (~x00 | ~x02 | x08 | x09);
  assign z7 = (~new_n43_ & (x03 | ~x09)) | (x03 & ((~x08 & (x01 | x02)) | (~x01 & ~x02 & x09))) | (~x03 & ~x08 & ~x09);
