...
module FAU ( 
  ...
  assign z3 = ((~x07 | ~x11) & (x00 | ~x12)) | (x02 & x09);
  assign z4 = (~x09 & (~x07 | ~x11)) | (~x02 & (x07 ? ~x11 : (~x00 | ~x08)));
  assign z5 = ~new_n37_ | ~x13 | x10 | x12;
  assign new_n37_ = ~x07 & ~x00 & (~x02 | ~x09);
  assign z6 = (x02 & x09) | (~x07 & ~x10 & (new_n39_ | (~new_n40_ & x02)));
  assign new_n39_ = (~x00 | ~x08) & ((x01 & (~x02 | x09)) | (~x03 & x09) | (~x02 & x03 & ~x09));
  assign new_n40_ = x00 ? x08 : (x01 & x14);
  assign z7 = ~new_n42_ | (x02 & (~x08 | x09));
  assign new_n42_ = (x08 | (~x01 & x03)) & ~x07 & ~x10 & (x01 | ~x03 | ~x09);
