...
module FAU ( 
  ...
  assign z0 = (~x00 & ((x01 & (x02 | x03)) | (x02 & x03 & ~x04))) | (x02 & ~x05);
  assign z1 = new_n28_ | new_n29_;
  assign new_n28_ = x02 & ~x05;
  assign new_n29_ = ~x00 & ((x02 & (x03 | x04) & (~x01 | ~x06)) | (x01 & ~x02 & x03));
  assign z2 = (~new_n31_ & ~new_n32_) | (~x01 & ~new_n33_ & ~x02);
  assign new_n31_ = x00 & (x07 | x08);
  assign new_n32_ = (~x02 | ~x05) & (x01 | x02 | x03 | ~x10);
  ...
  assign z7 = new_n41_ | (x02 & x05 & ~x08) | (~new_n42_ & ~x02);
  assign new_n41_ = (x07 | x10) & (~x02 | x05);
  assign new_n42_ = (x08 | (~x01 & x03)) & (x01 | ~x03 | ~x09);
  assign z8 = (~x00 & (x02 ? x05 : ~x09)) | new_n41_ | (x09 & (x02 ? x05 : ~new_n44_));
