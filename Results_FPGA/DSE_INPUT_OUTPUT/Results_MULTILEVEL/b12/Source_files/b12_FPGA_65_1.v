...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | ((~x02 | x04) & (~x01 | x02 | x11))) & (~x01 | ~x02 | (x04 & ~x05));
  ...
  assign new_n33_ = ~x02 & (~x10 | x11 | x01 | x03);
  assign new_n34_ = (x00 | (x07 ? x03 : (~x09 | x10))) & (x07 | x08 | ~x09 | x10);
  assign z3 = (~x02 & x11) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x02 & (x07 | x11)) | (~x07 & (~x00 | ~x08 | ~x09)) | (x07 & ~x11);
  assign z5 = ~new_n30_ & (x00 | x07 | x10 | x12 | ~x13);
  assign z6 = (~x02 & x11) | (~x07 & ~x10 & (x02 ? ~new_n40_ : new_n39_));
  ...
  assign new_n43_ = (x08 | (~x02 & (x11 | (~x01 & x03)))) & (x01 | x02 | ~x03 | ~x09 | x11);
  assign z8 = (~x00 & (x02 | (~x09 & ~x11))) | new_n42_ | (x09 & (x02 | (~new_n45_ & ~x11)));
