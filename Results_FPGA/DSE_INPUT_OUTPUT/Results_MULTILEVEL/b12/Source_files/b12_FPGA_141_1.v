...
module FAU ( 
  ...
  assign z1 = (~new_n30_ & ~x00) | (~x01 & x09);
  assign new_n30_ = (~x02 | ((x01 | (~x03 & ~x04)) & (~x04 | (x05 & x06)))) & (~x01 | ~x03 | (x02 & x05 & x06));
  assign z2 = (~new_n33_ & ~x01) | (~new_n32_ & (x02 | (~x01 & ~x03 & x10)));
  assign new_n32_ = x00 & (x07 | x08);
  assign new_n33_ = ~x09 & (x00 | x03 | ~x07);
  assign z3 = (~x07 | ~x11) & (x01 | ~x09) & (x00 | ~x12);
  assign z4 = (~x01 & (~x07 | x09)) | (~x07 & (~x00 | ~x08 | ~x09)) | (x07 & ~x11);
  ...
  assign z7 = ((x01 | ~x09) & (x07 | x10)) | (~x08 & (x01 | (~new_n41_ & ~x09)));
