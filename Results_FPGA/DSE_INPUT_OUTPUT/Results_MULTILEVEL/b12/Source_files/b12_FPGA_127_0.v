// Benchmark "FAU" written by ABC on Mon Aug 17 19:55:58 2020
...
module FAU ( 
  ...
  assign new_n28_ = ~x04 & ~x14;
  assign z1 = ~x00 & (new_n31_ | (~new_n30_ & x03));
  assign new_n30_ = (~x01 | x02 | (~x04 & ~x14)) & (~x02 | ~x14 | (x01 & x05 & x06));
  assign new_n31_ = x02 & x04 & (~x01 | ~x05 | ~x06);
  assign z2 = (~new_n33_ & ~new_n34_) | new_n28_ | (~new_n35_ & ~x01);
