...
module FAU ( 
  ...
  assign new_n27_ = x01 & ((x02 & (~x04 | x05)) | (x03 & (~x02 | (~x04 & (~x05 | ~x06)))));
  assign z1 = ~new_n29_ & ~x00;
  assign new_n29_ = (~x01 | ((~x03 | (x02 & (x04 | (x05 & x06)))) & (~x02 | ~x04 | ~x05 | x06))) & (~x02 | ~x04 | (x01 & x05));
  ...
  assign z4 = ~new_n36_ & (x07 ? ~x11 : (~x00 | ~x08 | ~x09));
  assign z5 = ~x13 | x10 | x12 | x07 | new_n36_ | x00;
  ...
  assign z7 = ~new_n43_ | (~x01 & (~x04 | (~x02 & x03 & x09)));
  assign new_n43_ = (x08 | (~x01 & ~x02 & x03)) & ~x07 & ~x10;
  assign z8 = (~x00 & (x01 | (x04 & ~x09))) | (~new_n45_ & (x01 | x04)) | (x09 & (x01 | (~new_n46_ & x04)));
