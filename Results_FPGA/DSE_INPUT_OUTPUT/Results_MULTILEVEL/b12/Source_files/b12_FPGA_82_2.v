...
module FAU ( 
  ...
  assign z0 = (~x06 & (x04 | (~x00 & x02 & x03))) | (~new_n27_ & ~x00);
  assign new_n27_ = (~x02 | ((~x01 | (x04 & ~x05)) & (~x03 | x04 | (x01 & x05)))) & (~x01 | x02 | ~x03);
  assign z1 = new_n30_ | (~new_n29_ & ~x00);
  assign new_n29_ = (~x01 | x02 | ~x03) & (~x02 | (((x01 & x05) | (~x04 & (~x03 | x04))) & (~x03 | x06)));
  assign new_n30_ = x04 & ~x06;
  assign z2 = ~new_n30_ & ((~new_n32_ & ~new_n33_) | (~new_n34_ & ~x01));
