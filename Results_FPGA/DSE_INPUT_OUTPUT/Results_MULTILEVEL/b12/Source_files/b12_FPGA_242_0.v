...
module FAU ( 
  ...
  assign z2 = (~new_n32_ & ~new_n33_) | new_n27_ | (~new_n34_ & ~x01);
  ...
  assign new_n39_ = (x01 | (x00 & x08) | (~x02 & (x03 | ~x09) & (~x03 | x09))) & (~x00 | ~x01 | x08);
  assign new_n40_ = ~x00 & x01 & (x14 ? ~x02 : x13);
  assign z7 = ~new_n27_ & (~new_n42_ | (~x08 & (x01 | x02 | ~x03)));
  assign new_n42_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n44_ | (x09 & (x01 | x02 | ~x03 | x12));
  assign new_n44_ = ~x07 & (x00 | x09) & ~x10 & (x13 | x14);
endmodule
