...
module FAU ( 
  ...
  assign z1 = (~x01 & (x04 | (~x00 & x02 & x03))) | (~x00 & ((x02 & ~new_n28_ & (x03 | x04)) | (x01 & ~x02 & x03)));
  assign new_n28_ = x05 & x06;
  assign z2 = (~new_n30_ & ~new_n31_) | (~x01 & ~new_n32_ & ~x04);
  assign new_n30_ = x00 & (x07 | x08);
  assign new_n31_ = (~x02 | (~x01 & x04)) & (x04 | ~x10 | x01 | x03);
  ...
  assign new_n38_ = ~x04 & (~x00 | ~x08) & (x02 | (x03 & ~x09) | (~x03 & x09));
  assign new_n39_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n41_ | (~x01 & (x04 | (~x02 & x03 & x09)));
  assign new_n41_ = (x08 | (~x01 & ~x02 & x03)) & ~x07 & ~x10;
  assign z8 = (~x00 & (x01 | (~x04 & ~x09))) | (~new_n43_ & (x01 | ~x04)) | (x09 & (x01 | (~new_n44_ & ~x04)));
