...
module FAU ( 
  ...
  assign z0 = new_n27_ | (~x04 & x12);
  assign new_n27_ = ~x00 & ((x03 & (x02 ? ~x04 : x01)) | (x01 & x02 & (~x04 | x05)));
  assign z1 = ~x00 & (new_n30_ | (~new_n29_ & x03));
  assign new_n29_ = (~x01 | x02 | (~x04 & x12)) & (~x02 | x12 | (x01 & x05 & x06));
  assign new_n30_ = x02 & x04 & (~x01 | ~x05 | ~x06);
  assign z2 = (~new_n32_ & ~new_n33_) | (~new_n34_ & ~x01) | (~x04 & x12);
  ...
  assign z4 = x07 ? (~x11 & (x04 | ~x12)) : (x00 ? (~new_n37_ & (x04 | ~x12)) : (~x12 | (x04 & x12)));
  assign new_n37_ = x08 & x09;
  assign z5 = ((x04 | ~x12) & (x00 | x07)) | (~x00 & ~x07 & (x12 ? x04 : (x10 | ~x13)));
  ...
  assign z7 = (~new_n43_ & ~x08) | ~new_n44_ | x10 | (~x04 & x12);
  assign new_n43_ = ~x01 & ~x02 & x03;
  assign new_n44_ = ~x07 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (x12 & (~x04 | x09)) | ~new_n46_ | (~new_n43_ & x09);
