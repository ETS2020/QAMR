...
module FAU ( 
  ...
  assign z0 = (~x00 & ((x02 & ((x01 & (~x04 | x05)) | (x03 & ~x04))) | (x01 & x03 & (~x02 | x05)))) | (~x01 & ~x05);
  ...
  assign new_n33_ = x05 & (~x09 | x10 | x07 | x08);
  ...
  assign new_n39_ = x05 & (~x00 | ~x08) & (x02 | (x03 & ~x09) | (~x03 & x09));
  ...
  assign z8 = (~x05 & (~x01 | x09)) | ~new_n45_ | (~new_n44_ & x09);
