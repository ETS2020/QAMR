...
module FAU ( 
  ...
  assign z0 = (~x00 & ((x01 & x02 & (~x04 | x05)) | (x03 & (~x02 | ~x04)))) | (~x01 & ~x02);
  assign z1 = (~x01 & ~x02) | (~x00 & ((~x01 & (x03 | x04)) | (~new_n28_ & (x03 | (x02 & x04))) | (~x02 & x03)));
