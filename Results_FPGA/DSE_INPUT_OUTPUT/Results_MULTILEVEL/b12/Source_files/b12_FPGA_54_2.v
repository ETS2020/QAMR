...
module FAU ( 
  ...
  assign z3 = (x00 & ~x12) | ((x00 | ~x12) & (~x07 | ~x11));
  assign z4 = (~x12 & (x00 | ~x07)) | (~x07 & (~x00 | ~x08 | ~x09)) | (x07 & ~x11);
  assign z5 = x12 | (~x00 & (x07 | x10 | ~x13));
  assign z6 = ~x07 & ~x10 & (new_n41_ | (~new_n39_ & ~new_n40_));
  assign new_n39_ = x00 ? (x08 | ~x12) : x01;
  assign new_n40_ = ~x02 & (~x03 | x09) & (x03 | ~x09);
  assign new_n41_ = x01 & (x00 ? (~x08 & x12) : (~x02 | ~x14));
  assign z7 = (new_n43_ | ~new_n44_) & (~x00 | x12);
  assign new_n43_ = ~x08 & (x01 | x02 | ~x03);
  assign new_n44_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (x00 & (x09 | ~x12)) | (~new_n46_ & ~x00) | x07 | x10;
  assign new_n46_ = ~x01 & ~x02 & x03 & x09 & ~x12;
endmodule
