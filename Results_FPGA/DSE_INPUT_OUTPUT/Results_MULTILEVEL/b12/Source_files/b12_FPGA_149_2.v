...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | (x05 & ~x06) | (x02 ? x04 : ~x01)) & (~x01 | ~x02 | (x05 ? ~x06 : x04));
  assign z1 = new_n29_ | new_n30_;
  assign new_n29_ = x05 & ~x06;
  assign new_n30_ = ~x00 & ((x02 & (x03 | x04) & (~x01 | ~x05)) | (x01 & ~x02 & x03));
  assign z2 = ~new_n29_ & ((~new_n34_ & ~x01) | (~new_n32_ & ~new_n33_));
  ...
  assign z4 = ~new_n29_ & (x07 ? ~x11 : (~x00 | (x00 & (~x08 | ~x09))));
  assign z5 = ~new_n29_ & (x00 | x07 | (~x00 & ~x07 & (x10 | x12 | ~x13)));
  assign z6 = new_n29_ | (~x07 & ~x10 & (new_n39_ | new_n40_));
  assign new_n39_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = new_n42_ | ~new_n43_ | new_n29_ | x07;
  assign new_n42_ = ~x08 & (x01 | x02 | ~x03);
  assign new_n43_ = ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n29_ & ((~new_n45_ & x09) | x07 | x10 | (~x00 & ~x09));
