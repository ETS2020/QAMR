...
module FAU ( 
  ...
  assign z0 = (x04 & x10) | (~x00 & (new_n28_ | (~new_n27_ & x03)));
  assign new_n27_ = (~x01 | x02 | (x04 & x10)) & (~x02 | x04 | (x01 & x05 & x06));
  assign new_n28_ = x01 & x02 & (~x04 | x05);
  assign z1 = ~x00 & (new_n30_ | (~new_n27_ & x03));
  assign new_n30_ = x02 & x04 & ~x10 & (~x01 | ~x05 | ~x06);
  assign z2 = (~new_n32_ & ~new_n33_) | (x04 & x10) | (~new_n34_ & ~x01);
  ...
  assign z4 = (~new_n37_ & ~x07) | (x04 & x10) | (x07 & ~x11);
  ...
  assign z7 = ~new_n43_ | (~x08 & (x01 | x02 | ~x03));
