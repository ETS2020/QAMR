...
module FAU ( 
  ...
  assign new_n30_ = (~x03 | (x01 ? (~x06 | (x02 & x05)) : ~x02)) & (~x02 | ~x04 | (x01 & (x05 | ~x06)));
  assign z2 = (~new_n32_ & ~new_n33_) | (x01 & ~x06) | (~new_n34_ & ~x01);
  ...
  assign z6 = (x01 & ~x06) | (~x07 & ~x10 & (x01 ? ~new_n40_ : new_n39_));
  assign new_n39_ = (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = x00 ? x08 : (x02 & x14);
  assign z7 = new_n42_ | (~new_n43_ & ~x01) | (x01 & x06 & ~x08);
  assign new_n42_ = (~x01 | x06) & (x07 | x10);
  assign new_n43_ = (x08 | (~x02 & x03)) & (x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 ? x06 : ~x09)) | new_n42_ | (x09 & (x01 ? x06 : ~new_n45_));
