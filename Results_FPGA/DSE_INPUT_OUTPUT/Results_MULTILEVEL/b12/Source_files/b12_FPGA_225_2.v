...
module FAU ( 
  ...
  assign z0 = ~x00 & ((x01 & (~x04 | x05) & (x02 | x03)) | (x02 & x03 & ~x04));
  assign z1 = new_n28_ | (~new_n29_ & ~x00);
  assign new_n28_ = x04 & ~x05;
  assign new_n29_ = (~x02 | (((~x03 & ~x04) | (x01 & x06)) & (~x03 | x05))) & (~x01 | x02 | ~x03);
  assign z2 = (~new_n31_ & ~new_n32_) | new_n28_ | (~new_n33_ & ~x01);
  ...
  assign z7 = new_n41_ | ~new_n42_ | new_n28_ | x07;
