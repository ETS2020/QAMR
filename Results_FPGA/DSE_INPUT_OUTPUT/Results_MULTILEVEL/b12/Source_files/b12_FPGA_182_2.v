...
module FAU ( 
  ...
  assign new_n38_ = ~x07 & ~x00 & (~x02 | x09);
  assign z6 = (x02 & ~x09) | (~x07 & ~x10 & (new_n40_ | (~new_n41_ & x02)));
  assign new_n40_ = (~x00 | ~x08) & ((~x02 & (x01 | (~x03 & x09))) | (x03 & ~x09));
  assign new_n41_ = x00 ? x08 : (x01 & x14);
  assign z7 = (x02 & (~x08 | ~x09)) | ~new_n43_ | (~x08 & (x01 | ~x03));
  assign new_n43_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n45_ & x09) | x02 | x07 | x10 | (~x00 & ~x09);
