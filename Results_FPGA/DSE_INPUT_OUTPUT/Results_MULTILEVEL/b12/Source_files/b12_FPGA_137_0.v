...
module FAU ( 
  ...
  assign new_n30_ = x03 & ((x01 & ~x02 & (x06 | x13)) | (x02 & (x06 ? (~x01 | ~x05) : x13)));
  assign new_n31_ = x02 & x04 & (x06 ? (~x01 | ~x05) : x13);
  assign z2 = ~new_n28_ & ((~new_n33_ & ~new_n34_) | (~new_n35_ & ~x01));
  ...
  assign z7 = ~new_n28_ & (~new_n43_ | (~x08 & (x01 | x02 | ~x03)));
  assign new_n43_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n45_ | (x09 & (x01 | x02 | ~x03 | x12));
  assign new_n45_ = ~x07 & (x00 | x09) & ~x10 & (x06 | x13);
endmodule
