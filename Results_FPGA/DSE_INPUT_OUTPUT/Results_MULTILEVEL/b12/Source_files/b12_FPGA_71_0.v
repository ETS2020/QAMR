...
module FAU ( 
  ...
  assign z0 = (~x01 & (~x13 | (new_n27_ & ~x00 & x02))) | (~x00 & ~new_n28_ & x01);
  ...
  assign new_n31_ = ~x01 & ~x13;
  assign z2 = (~new_n33_ & ~new_n34_) | (~x01 & ~new_n35_ & x13);
  assign new_n33_ = x00 & (x07 | x08);
  assign new_n34_ = (~x02 | (~x01 & ~x13)) & (x01 | x03 | ~x10 | ~x13);
  assign new_n35_ = (x00 | (x07 ? x03 : (~x09 | x10))) & (x07 | x08 | ~x09 | x10);
  assign z3 = new_n31_ | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n31_ | (x07 & ~x11);
  assign z5 = x12 | ~x13 | x10 | x00 | x07;
  assign z6 = (~x01 & ~x13) | (~x07 & ~x10 & (x01 ? ~new_n41_ : new_n40_));
  assign new_n40_ = (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n41_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n43_ | (~x01 & (~x13 | (~x02 & x03 & x09)));
  assign new_n43_ = (x08 | (~x01 & ~x02 & x03)) & ~x07 & ~x10;
  assign z8 = (~x00 & (x01 | (~x09 & x13))) | (~new_n45_ & (x01 | x13)) | (x09 & (x01 | (~new_n46_ & x13)));
