...
module FAU ( 
  ...
  assign z5 = x07 | new_n27_ | x00 | ~x13 | x10 | x12;
  assign z6 = new_n27_ | (~x07 & ~x10 & (new_n39_ | new_n40_ | new_n41_));
  assign new_n39_ = ~x09 & (x00 ? (~x08 & (x02 | x03)) : (~x01 & x03));
  assign new_n40_ = ~x01 & ((~x00 & (x02 | (~x03 & x09))) | (~x08 & x09 & (x02 | ~x03)));
  assign new_n41_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = new_n44_ | new_n45_ | (~new_n43_ & (x01 | x02 | ~x03));
  assign new_n43_ = (x08 | (x09 & ~x11)) & (~x11 | (~x07 & ~x10));
  assign new_n44_ = ~x09 & (x07 | x10);
  assign new_n45_ = ~x01 & ~x02 & x03 & x09 & x11;
  assign z8 = (~new_n47_ & x09) | x07 | x10 | (~x00 & ~x09);
  assign new_n47_ = ~x01 & ~x02 & x03 & x11 & ~x12;
endmodule
