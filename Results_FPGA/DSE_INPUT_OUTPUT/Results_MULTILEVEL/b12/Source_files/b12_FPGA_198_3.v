// Benchmark "FAU" written by ABC on Mon Aug 17 19:56:28 2020
...
module FAU ( 
  ...
  assign new_n37_ = ~x00 & (x01 ? (~x02 | ~x14) : (x02 | (~x03 & x09) | (x03 & ~x09)));
  assign new_n38_ = ~x01 & ~x08 & (x02 | (x03 & ~x09) | (~x03 & x09));
  assign z7 = (x01 & (x00 | ~x08)) | ~new_n40_ | (~x08 & (x02 | ~x03));
  assign new_n40_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~x00 & (x01 | ~x09)) | (~x01 & (x07 | x10 | (~new_n42_ & x09)));
