...
module FAU ( 
  ...
  assign new_n28_ = (~x03 | ((~x01 | x02 | (x04 & x06)) & (~x02 | x04 | (x01 & x05 & x06)))) & (~x01 | ~x02 | (x04 & (~x04 | ~x05 | x06)));
  assign z1 = ~new_n30_ & ~x00;
  assign new_n30_ = (~x03 | ((~x02 | x04 | (x01 & x05 & x06)) & (~x01 | ((x02 | (x04 & x06)) & (~x04 | x06))))) & (~x02 | ~x04 | x06);
