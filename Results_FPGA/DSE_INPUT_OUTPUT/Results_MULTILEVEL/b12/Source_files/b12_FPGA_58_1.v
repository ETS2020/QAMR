...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | ((~x01 | x02) & (x01 | ~x02 | x04 | x08))) & (~x01 | ~x02 | (x04 & ~x05));
  assign z1 = (~new_n29_ & ~x00) | (~x01 & x08);
  assign new_n29_ = (~x02 | ((x01 | (~x03 & ~x04)) & (~x04 | (x05 & x06)))) & (~x01 | ~x03 | (x02 & x05 & x06));
  assign z2 = new_n31_ | (~x01 & (x08 | (~new_n32_ & ~x07))) | (x02 & ~x07 & ~x08);
  assign new_n31_ = ~x00 & (x02 | (~x01 & ~x03 & x07));
  ...
  assign z6 = (~x01 & x08) | (~x07 & ~x10 & (x01 ? ~new_n38_ : ~new_n39_));
  assign new_n38_ = ((x02 & x14) | (x00 & x08)) & (~x00 | x08);
  assign new_n39_ = ~x02 & (~x03 | x09) & (x03 | ~x09);
  assign z7 = (~x01 & (~new_n41_ | x08 | x09)) | x07 | x10 | (x01 & ~x08);
  assign new_n41_ = ~x02 & x03;
  assign z8 = (~x00 & (x01 | (~x08 & ~x09))) | (~new_n43_ & (x01 | ~x08)) | (x09 & (x01 | (~new_n44_ & ~x08)));
