...
module FAU ( 
  ...
  assign new_n79_ = x12 & (x17 | (x18 ? x33 : ~x15));
  assign z13 = x19 ? ~new_n81_ : ~x33;
  assign new_n81_ = x12 & (x17 | (x18 ? x34 : ~x14));
  assign z14 = (x12 & ~x17 & ~new_n83_ & x19) | (~x19 & ~x34);
  assign new_n83_ = x18 ? x35 : ~x13;
  assign z15 = x19 ? (~x12 | (~x17 & (~x18 | ~x28))) : ~x35;
endmodule
