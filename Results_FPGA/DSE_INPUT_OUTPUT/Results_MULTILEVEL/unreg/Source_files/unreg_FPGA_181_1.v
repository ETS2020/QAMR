...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n60_, new_n62_, new_n64_, new_n66_, new_n68_,
    ...
    new_n84_;
  assign z00 = (x01 & ~x17 & ~new_n55_ & x19) | (~x19 & ~x20);
  assign new_n55_ = x18 ? x21 : ~x03;
  assign z01 = x19 ? ~new_n57_ : ~x21;
  assign new_n57_ = x01 & (x17 | (x18 ? x22 : ~x02));
  ...
  assign z14 = (x01 & ~x17 & ~new_n82_ & x19) | (~x19 & ~x34);
  assign new_n82_ = x18 ? x35 : ~x13;
  assign z15 = (x01 & ~x17 & ~new_n84_ & x19) | (~x19 & ~x35);
