...
module FAU ( 
  ...
  assign z04 = (~x17 & ~new_n63_ & x19) | (~x19 & (x05 | ~x24));
  assign new_n63_ = x18 ? x25 : ~x07;
  assign z05 = (~x17 & ~new_n65_ & x19) | (~x19 & (x05 | ~x25));
  ...
  assign z08 = (~x17 & ~new_n70_ & x19) | (~x19 & (x05 | ~x28));
  ...
  assign z13 = (~x17 & ~new_n80_ & x19) | (~x19 & (x05 | ~x33));
