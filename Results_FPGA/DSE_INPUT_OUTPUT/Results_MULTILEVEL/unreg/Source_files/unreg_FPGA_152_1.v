...
module FAU ( 
  ...
  wire new_n56_, new_n58_, new_n60_, new_n62_, new_n64_, new_n66_, new_n68_,
    ...
    new_n84_;
  assign z00 = (x03 & ~x17 & x19 & (~x18 | ~x21)) | (~x19 & ~x20);
  assign z01 = x19 ? ~new_n56_ : ~x21;
  assign new_n56_ = x03 & (x17 | (x18 ? x22 : ~x02));
  assign z02 = x19 ? ~new_n58_ : ~x22;
  assign new_n58_ = x03 & (x17 | (x18 ? x23 : ~x01));
  ...
  assign new_n64_ = x03 & (x17 | (x18 ? x26 : ~x06));
  ...
  assign new_n78_ = x03 & (x17 | (x18 ? x33 : ~x15));
  assign z13 = x19 ? ~new_n80_ : ~x33;
  assign new_n80_ = x03 & (x17 | (x18 ? x34 : ~x14));
