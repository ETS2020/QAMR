...
module FAU ( 
  ...
  assign new_n65_ = (~x06 | (x26 & (x18 | x29))) & (~x18 | x26);
  assign z06 = (~x19 & ~x26) | (~x17 & ~new_n67_ & (~x26 | (x19 & ~x29)));
  assign new_n67_ = x18 ? x27 : ~x05;
  assign z07 = (~x17 & ~new_n69_ & x19) | (x26 & x29) | (~x19 & ~x27);
  assign new_n69_ = x18 ? x20 : ~x04;
  assign z08 = (~x17 & ~new_n71_ & x19) | (~x19 & ~x28 & (~x26 | ~x29));
  assign new_n71_ = (~x11 | (x29 & (x18 | x26))) & (~x18 | x29);
  assign z09 = (~x17 & ~new_n73_ & x19) | (x26 & x29) | (~x19 & (x26 | ~x29));
  assign new_n73_ = x18 ? x30 : ~x10;
  assign z10 = (~x17 & ~new_n75_ & x19) | (x26 & x29) | (~x19 & ~x30);
  assign new_n75_ = x18 ? x31 : ~x09;
  assign z11 = (~x17 & ~new_n77_ & x19) | (x26 & x29) | (~x19 & ~x31);
  assign new_n77_ = x18 ? x24 : ~x08;
  assign z12 = (~x17 & ~new_n79_ & x19) | (x26 & x29) | (~x19 & ~x32);
  assign new_n79_ = x18 ? x33 : ~x15;
  assign z13 = ~new_n81_ & (~x26 | ~x29);
  assign new_n81_ = (x17 | ~x19 | (x18 ? x34 : ~x14)) & (x19 | x33);
  assign z14 = (~x17 & ~new_n83_ & x19) | (x26 & x29) | (~x19 & ~x34);
