...
module FAU ( 
  ...
  assign z03 = (~x01 & ~x17 & ~new_n60_ & x19) | (~x19 & ~x23);
  assign new_n60_ = x18 ? ~x16 : ~x00;
  assign z04 = x19 ? ~new_n62_ : ~x24;
  assign new_n62_ = ~x01 & (x17 | (x18 ? x25 : ~x07));
  assign z05 = x19 ? ~new_n64_ : ~x25;
  assign new_n64_ = ~x01 & (x17 | (x18 ? x26 : ~x06));
  assign z06 = (~x01 & ~x17 & ~new_n66_ & x19) | (~x19 & ~x26);
  ...
  assign new_n76_ = ~x01 & (x17 | (x18 ? x24 : ~x08));
  assign z12 = (~x01 & ~x17 & ~new_n78_ & x19) | (~x19 & ~x32);
