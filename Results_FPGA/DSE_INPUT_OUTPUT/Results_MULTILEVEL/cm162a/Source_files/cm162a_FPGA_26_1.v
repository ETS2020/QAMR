...
module FAU ( 
  ...
  assign z3 = new_n31_ | (~x07 & (~x03 | x09)) | ~x05 | (new_n34_ & x03);
  assign new_n31_ = x02 & x04 & ~x12 & (new_n33_ | (~new_n32_ & x03));
  assign new_n32_ = (x08 | x10 | x11) & (~x07 | ~x09 | ~x13);
  assign new_n33_ = ~x10 & ~x11 & ~x07 & ~x08;
  assign new_n34_ = x12 & (~new_n35_ | ~x02 | ~x04 | x08);
  assign new_n35_ = ~x10 & ~x11 & (~x09 | ~x13);
