...
module FAU ( 
  ...
  assign z1 = (~new_n24_ & x03) | (~x01 & ~x03) | ~x05 | (~x04 & x09);
  assign new_n24_ = (~x02 | (~new_n25_ & (~x04 | x08 | x10))) & (~x10 | (x02 & x04 & ~new_n25_ & ~x08));
  assign new_n25_ = x09 & x13;
  assign z2 = (~new_n27_ & x03) | (~x04 & x09) | ~x05 | (~x03 & ~x06);
  assign new_n27_ = (~x02 | (~new_n25_ & (~x04 | x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~new_n25_ & ~x10));
  assign z3 = (x03 & (new_n31_ | (~new_n29_ & x04))) | ~new_n32_ | (~x04 & x09);
