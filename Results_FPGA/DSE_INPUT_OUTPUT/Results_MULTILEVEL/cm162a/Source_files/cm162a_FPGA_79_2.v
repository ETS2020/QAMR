// Benchmark "FAU" written by ABC on Mon Aug 17 19:49:48 2020
...
module FAU ( 
  ...
  assign z1 = (~new_n24_ & x03) | (~x01 & ~x03) | ~x05 | (x10 & ~x13);
  ...
  assign z3 = (~new_n30_ & x03) | ~x05 | (x10 & ~x13) | (~x03 & ~x07);
  assign new_n30_ = ~new_n31_ & (~x02 | new_n32_ | ~x04) & (~x12 | (new_n33_ & x02 & x04));
  assign new_n31_ = x10 & (x12 | (x02 & x04 & x09));
  assign new_n32_ = (~x09 | ~x13) & (x08 | x10 | x11 | x12);
  assign new_n33_ = ~x08 & ~x11 & (~x09 | ~x13);
