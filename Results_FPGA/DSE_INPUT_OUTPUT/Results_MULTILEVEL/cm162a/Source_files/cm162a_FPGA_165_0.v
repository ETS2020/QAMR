...
module FAU ( 
  ...
  assign z3 = ~new_n32_ | (x03 & (~new_n30_ | (x02 & ~new_n29_ & x04)));
  assign new_n29_ = ~new_n25_ & (x11 | x12 | x08 | x10);
  assign new_n30_ = (new_n31_ | (x09 & ~x12)) & (~x09 | ~x12 | ~x13);
  assign new_n31_ = x02 & x04 & ~x08 & ~x10 & ~x11;
  assign new_n32_ = x05 & (x09 | x12) & (x03 | x07);
