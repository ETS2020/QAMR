// Benchmark "FAU" written by ABC on Mon Aug 17 19:49:19 2020
...
module FAU ( 
  ...
  assign z0 = ~new_n22_ | (x09 & (~x12 | (x03 & x08 & x13)));
  ...
  assign new_n30_ = x05 & (x03 | x06) & (~x09 | x12);
  assign z3 = new_n33_ | (x03 & ((new_n32_ & new_n35_) | (x12 & (~new_n32_ | ~new_n34_))));
  assign new_n32_ = x02 & x04 & ~x08;
  assign new_n33_ = (~x09 | x12) & (~x05 | (~x03 & ~x07));
  assign new_n34_ = ~x10 & ~x11 & (~x09 | ~x13);
  assign new_n35_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z4 = x09 & (~x12 | (x04 & x13));
endmodule
