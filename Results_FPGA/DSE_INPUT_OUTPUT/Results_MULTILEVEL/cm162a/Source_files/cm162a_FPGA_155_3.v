...
module FAU ( 
  ...
  assign z3 = new_n31_ | (~x10 & ((~new_n29_ & x03) | ~x05 | (~x03 & ~x07)));
  assign new_n29_ = (new_n30_ | ~x04) & (~x12 | (x02 & x04 & ~x08 & ~x11));
  assign new_n30_ = (~x02 | ((~x09 | ~x13) & (x08 | x11 | x12))) & (~x09 | ~x12 | ~x13);
  assign new_n31_ = ~x09 & ((~x03 & (~x05 | ~x07)) | (x03 & x10 & x12) | (~x05 & ~x12));
  assign z4 = ~new_n33_ & x09;
  assign new_n33_ = ~x10 & (~x04 | ~x13 | ((~x03 | x10 | (~x02 & ~x12)) & x03 & x12));
endmodule
