...
module FAU ( 
  ...
  assign z2 = (~new_n26_ & (~x09 | ~x12)) | (x03 & x09 & new_n28_ & ~x12);
  ...
  assign z3 = (~new_n30_ & x03) | ((~x09 | ~x12) & (~x05 | (~x03 & ~x07)));
  assign new_n30_ = (~x02 | ~x04 | x12 | (~new_n31_ & (~x09 | ~x13))) & (x09 | ~x12 | (new_n31_ & x02 & x04));
