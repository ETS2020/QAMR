...
module FAU ( 
  ...
  assign z3 = ~new_n33_ | (x03 & (new_n31_ | (x02 & new_n30_ & x04)));
  assign new_n30_ = ~x12 & ((x09 & x13) | (new_n27_ & ~x11 & ~x13));
  assign new_n31_ = x12 & (x13 ? x09 : (~new_n32_ | ~x02 | ~x04));
  assign new_n32_ = ~x08 & ~x10 & ~x11;
  assign new_n33_ = (x03 | ((x07 | (~x09 & x13)) & (x05 | ~x09))) & (x05 | (x13 & (~x09 | x12)));
