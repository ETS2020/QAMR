...
module FAU ( 
  ...
  assign z2 = (x03 & ((~new_n27_ & (x06 | x13)) | ((new_n28_ | ~x05) & x13))) | (~x05 & x06) | (~x03 & ~x06 & x13);
  assign new_n27_ = (~x11 | (~x08 & ~x10 & x02 & x04)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n28_ = x09 & (x11 | (x02 & x04));
  assign z3 = (~new_n23_ & ((~new_n30_ & x03) | ~x05 | (~x03 & ~x07))) | (new_n31_ & x03);
