...
module FAU ( 
  ...
  assign z3 = (x03 & (~new_n32_ | new_n36_)) | ~x05 | new_n24_ | (~x03 & ~x07);
  assign new_n32_ = ~new_n35_ & (~x04 | (~new_n34_ & (~new_n33_ | ~x02)));
  assign new_n33_ = ~x11 & ((x09 & x13) | (~x08 & ~x10 & ~x12));
  assign new_n34_ = x09 & x12 & x13;
  assign new_n35_ = x12 & (~x02 | ~x04 | x08 | x10);
  assign new_n36_ = x11 & (x12 | (x02 & x04 & x09));
