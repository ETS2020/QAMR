...
module FAU ( 
  ...
  assign z2 = new_n26_ | (~new_n28_ & x09);
  assign new_n26_ = x02 & ((~new_n27_ & x03) | ~x05 | (~x03 & ~x06));
  assign new_n27_ = (~x04 | ((~x09 | ~x13) & (x08 | x10 | x11))) & (~x11 | (x04 & ~x08 & ~x10));
  assign new_n28_ = (~x03 | ~x11 | (x02 & ~x13)) & (x05 | x11) & (x03 | (x05 & x06));
  assign z3 = (~new_n30_ & x03) | ~x05 | (~x03 & ~x07) | (~x02 & ~x09);
