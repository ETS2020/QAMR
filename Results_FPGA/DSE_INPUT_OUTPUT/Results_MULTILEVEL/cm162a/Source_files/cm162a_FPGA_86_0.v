...
module FAU ( 
  ...
  assign new_n25_ = (~x02 | ~x04 | (~new_n26_ & (x08 | x10))) & (~x10 | (x02 & x04 & ~new_n26_ & ~x08));
  assign new_n26_ = x09 & x13;
  assign z2 = (~new_n28_ & x03) | ~x05 | (~x03 & (~x06 | ~x09));
  assign new_n28_ = (~x02 | ~x04 | (~new_n26_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~new_n26_ & ~x10));
  assign z3 = (x03 & (new_n30_ | new_n32_ | ~x05)) | (x09 & (~x05 | (~x03 & ~x07)));
