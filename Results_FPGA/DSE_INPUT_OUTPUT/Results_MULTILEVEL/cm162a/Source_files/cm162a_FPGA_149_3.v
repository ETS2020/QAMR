...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & x03) | x01 | ~x05 | (~x00 & ~x03);
  assign new_n22_ = (~x08 | (x02 & x04 & (~x09 | ~x13))) & (~x02 | ~x04 | x08);
  assign z1 = (x02 & x04 & (new_n24_ | (~x08 & ~x10))) | ~new_n25_ | (x10 & (~x02 | ~x04 | new_n24_ | x08));
  assign new_n24_ = x09 & x13;
  assign new_n25_ = ~x01 & x03 & x05;
  ...
  assign new_n34_ = ~x01 & x05 & (x03 | x07);
  assign z4 = x04 & x09 & x13 & (~x01 | (x01 & ~x05));
endmodule
