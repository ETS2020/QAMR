...
module FAU ( 
  ...
  assign z2 = (~new_n27_ & x03) | ~x05 | (x08 & x09) | (~x03 & ~x06);
  assign new_n27_ = (~x02 | ~x04 | (~new_n25_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~new_n25_ & ~x10));
  assign z3 = new_n31_ | (~x08 & ((~new_n29_ & x03) | ~x05 | (~x03 & ~x07)));
  assign new_n29_ = (new_n30_ | ~x04) & (~x12 | (x02 & x04 & ~x10 & ~x11));
  assign new_n30_ = (~x02 | ((~x09 | ~x13) & (x10 | x11 | x12))) & (~x09 | ~x12 | ~x13);
  assign new_n31_ = ~x09 & ((~x03 & (~x05 | ~x07)) | (x03 & x08 & x12) | (~x05 & ~x12));
  assign z4 = ~new_n33_ & x09;
  assign new_n33_ = ~x08 & (~x04 | ~x13 | ((~x03 | x08 | (~x02 & ~x12)) & x03 & x12));
endmodule
