...
module FAU ( 
  ...
  assign z0 = (~x03 & (~x00 | ~x05)) | (~x08 & (~x05 | (x02 & x03 & x04)));
  assign z1 = (~x03 & (~x01 | ~x05)) | (~x08 & (~x05 | (~new_n23_ & x03)));
  assign new_n23_ = (~x10 | (x02 & x04 & (~x09 | ~x13))) & (~x02 | ~x04 | x10);
  assign z2 = (~x08 & (~x05 | (~new_n25_ & x03))) | (~x03 & (~x05 | ~x06));
  assign new_n25_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x10 | x11))) & (~x11 | (x02 & x04 & ~x10 & (~x09 | ~x13)));
  assign z3 = (~x08 & (~x05 | (~new_n27_ & x03))) | (~x03 & (~x05 | ~x07));
