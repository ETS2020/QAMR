// Benchmark "FAU" written by ABC on Mon Aug 17 19:49:33 2020
...
module FAU ( 
  ...
  assign z0 = ~new_n22_ | (x09 & (x06 | (x03 & x08 & x13)));
  ...
  assign new_n28_ = (x03 | (x06 & ~x09)) & (~x09 | (~new_n29_ & ~x06)) & x05 & (~new_n30_ | ~x03);
  assign new_n29_ = x11 & x13;
  assign new_n30_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign new_n31_ = (x10 | x11 | ~x03 | x08) & (~x09 | ~x13);
  assign z3 = (~new_n24_ & ((~new_n33_ & x03) | ~x05 | (~x03 & ~x07))) | (new_n34_ & x03);
  assign new_n33_ = (~x12 | (x02 & x04 & ~x08 & ~x10 & ~x11)) & (~x02 | ~x04 | x08 | x10 | x11 | x12);
  assign new_n34_ = ~x06 & x09 & x13 & (x12 | (x02 & x04));
