...
module FAU ( 
  ...
  assign new_n31_ = (~x02 | (~new_n32_ & (~x06 | ~x09 | ~x13))) & (~x12 | ~x13 | ~x06 | ~x09);
  assign new_n32_ = ~x11 & ~x12 & ~x08 & ~x10;
  assign new_n33_ = x12 & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n34_ = x05 & (x06 | ~x09) & (x03 | x07);
