...
module FAU ( 
  ...
  assign z2 = (~new_n28_ & x03) | (~x04 & x13) | ~x05 | (~x03 & ~x06);
  assign new_n28_ = (~x02 | (~new_n23_ & (~x04 | x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~new_n23_ & ~x10));
  assign z3 = new_n31_ | (x04 & ((~new_n30_ & x03) | ~x05 | (~x03 & ~x07)));
  assign new_n30_ = (~x02 | (~new_n23_ & (x08 | x10 | x11 | x12))) & (~x12 | (~x10 & ~new_n23_ & ~x11 & x02 & ~x08));
  assign new_n31_ = ~x13 & ((~x03 & (~x05 | ~x07)) | (x03 & ~x04 & x12) | (~x05 & ~x12));
