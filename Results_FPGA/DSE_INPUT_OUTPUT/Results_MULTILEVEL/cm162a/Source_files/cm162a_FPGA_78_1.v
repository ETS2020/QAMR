...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_;
  assign z0 = ~new_n22_ | (x13 & (~x11 | (x03 & x08 & x09)));
  ...
  assign z2 = ((x11 | ~x13) & (~x05 | (~x03 & ~x06))) | (~new_n26_ & x03);
  assign new_n26_ = (new_n28_ | ~x11) & (~new_n27_ | x10 | x11 | x13);
  assign new_n27_ = x02 & x04 & ~x08;
  assign new_n28_ = x02 & x04 & ~x08 & ~x10 & (~x09 | ~x13);
  assign z3 = ((x11 | ~x13) & (~x05 | (~x03 & ~x07))) | (~new_n30_ & x03);
  assign new_n30_ = (~x02 | new_n31_ | ~x04) & (new_n32_ | ~x12);
  assign new_n31_ = (~x09 | ~x11 | ~x13) & (x08 | x10 | x11 | x12 | x13);
  assign new_n32_ = ~x11 & (x13 | (x02 & x04 & ~x08 & ~x10));
  assign z4 = x11 & x13 & x04 & x09;
endmodule
