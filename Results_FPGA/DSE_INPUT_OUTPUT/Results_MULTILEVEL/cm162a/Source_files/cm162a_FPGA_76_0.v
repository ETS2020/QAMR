// Benchmark "FAU" written by ABC on Mon Aug 17 19:49:46 2020
...
module FAU ( 
  ...
  assign z3 = (x03 & ((~new_n32_ & (x07 | x13)) | (x13 & (new_n33_ | ~x05)))) | (~x05 & x07) | (~x03 & ~x07 & x13);
  assign new_n32_ = (~x12 | (x02 & x04 & ~x08 & ~x10 & ~x11)) & (~x02 | ~x04 | x08 | x10 | x11 | x12);
  assign new_n33_ = x09 & (x12 | (x02 & x04));
