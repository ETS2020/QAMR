...
module FAU ( 
  ...
  assign new_n28_ = x05 & (~x09 | ~x11) & (x03 | x06);
  assign z3 = ~new_n32_ | (x03 & (new_n31_ | (x04 & ~new_n30_ & ~x11)));
  assign new_n30_ = (~x02 | ((~x09 | ~x13) & (x08 | x10 | x12))) & (~x09 | ~x12 | ~x13);
  assign new_n31_ = x12 & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n32_ = x05 & (~x09 | ~x11) & (x03 | x07);
