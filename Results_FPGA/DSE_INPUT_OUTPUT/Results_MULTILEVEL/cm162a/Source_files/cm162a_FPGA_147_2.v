...
module FAU ( 
  ...
  assign z2 = (~new_n26_ & x03) | ~x05 | (~x03 & ~x06) | (x02 & ~x09);
  assign new_n26_ = ~new_n27_ & (new_n28_ | ~x11);
  assign new_n27_ = x02 & x04 & (x13 | (~x08 & ~x10 & ~x11));
  assign new_n28_ = x02 & x04 & ~x08 & x09 & ~x10 & ~x13;
  assign z3 = new_n33_ | (~new_n30_ & x03) | ~x05 | (~x03 & ~x07);
  assign new_n30_ = (~x04 | (~new_n31_ & (~x09 | ~x12 | ~x13))) & (new_n32_ | ~x12);
  assign new_n31_ = x02 & (x13 | (~x11 & ~x12 & ~x08 & ~x10));
  assign new_n32_ = x02 & x04 & ~x08 & ~x10 & ~x11;
  assign new_n33_ = ~x09 & (x02 | (x03 & x12));
