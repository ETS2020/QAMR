...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_;
  assign z0 = (~x03 & (~x00 | ~x06)) | ~x05 | (~new_n22_ & x03);
  assign new_n22_ = (~x08 | (x02 & ~new_n23_ & x04)) & (~x02 | ~x04 | x08);
  assign new_n23_ = x09 & x13;
  assign z1 = (~new_n25_ & x03) | ~x05 | (~x03 & (~x01 | ~x06));
  assign new_n25_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10))) & (~x10 | (x02 & x04 & ~new_n23_ & ~x08));
  assign z2 = (x03 & (new_n27_ | ~x05 | (~new_n28_ & x11))) | (~x05 & x06);
  assign new_n27_ = x02 & x04 & (new_n23_ | (~x08 & ~x10 & ~x11));
  assign new_n28_ = x02 & x04 & ~x08 & ~new_n23_ & ~x10;
  assign z3 = (x03 & (new_n30_ | new_n32_ | ~x05)) | (x06 & (~x05 | (~x03 & ~x07)));
