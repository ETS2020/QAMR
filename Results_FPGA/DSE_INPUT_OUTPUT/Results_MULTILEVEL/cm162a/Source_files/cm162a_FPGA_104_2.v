...
module FAU ( 
  ...
  assign new_n22_ = (~x08 | (x02 & x04 & ~x13)) & x09 & (~x02 | ~x04 | x08);
  assign z1 = (x09 & (~x05 | (~new_n24_ & x03))) | (~x03 & (~x01 | ~x05));
  ...
  assign z3 = (x03 & (new_n28_ | new_n30_ | ~x09)) | ~x05 | (~x07 & (~x03 | ~x09));
  assign new_n28_ = x04 & ((x02 & (new_n29_ | (x09 & x13))) | (x09 & x12 & x13));
