...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n30_;
  ...
  assign z3 = (x04 & (~x05 | (~new_n30_ & x03))) | (~x07 & (~x03 | (~x04 & x12) | (~x05 & ~x12)));
  assign new_n30_ = (~x02 | (~new_n23_ & (x11 | x12 | x08 | x10))) & (~x12 | (~x10 & ~new_n23_ & ~x11 & x02 & ~x08));
