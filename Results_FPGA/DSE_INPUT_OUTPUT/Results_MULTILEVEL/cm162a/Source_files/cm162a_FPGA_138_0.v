...
module FAU ( 
  ...
  assign z2 = (~new_n27_ & x03) | ~x05 | (~x02 & ~x13) | (~x03 & ~x06);
  assign new_n27_ = (~x02 | ~x04 | (~new_n25_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~new_n25_ & ~x10));
  assign z3 = (~new_n31_ & ~x03) | new_n32_ | (x03 & (new_n29_ | (~new_n33_ & x12)));
  assign new_n29_ = x04 & ((x02 & (new_n30_ | (x09 & x13))) | (x09 & x12 & x13));
  assign new_n30_ = ~x08 & ~x10 & ~x11 & ~x12;
  assign new_n31_ = (x07 | (~x02 & ~x13)) & (x05 | ~x13);
  assign new_n32_ = ~x05 & (x02 | (~x12 & x13));
  assign new_n33_ = x02 ? (~x10 & ~x11 & x04 & ~x08) : ~x13;
