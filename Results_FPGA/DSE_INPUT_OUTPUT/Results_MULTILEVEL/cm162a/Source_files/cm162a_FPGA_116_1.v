// Benchmark "FAU" written by ABC on Mon Aug 17 19:50:03 2020
...
module FAU ( 
  ...
  assign z3 = (x03 & ((~new_n31_ & (x07 | ~x09)) | (~x05 & ~x09) | (x07 & new_n32_ & x09))) | (~x05 & x07) | (~x03 & ~x07 & ~x09);
  assign new_n31_ = (~x12 | (x02 & x04 & ~x08 & ~x10 & ~x11)) & (~x02 | ~x04 | x08 | x10 | x11 | x12);
  assign new_n32_ = x13 & (x12 | (x02 & x04));
