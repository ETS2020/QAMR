...
module FAU ( 
  ...
  assign z2 = ~new_n26_ | (x02 & ~new_n29_ & x04);
  assign new_n26_ = (x03 | (x06 & ~x09)) & (~x09 | (~new_n27_ & ~x06)) & x05 & (~new_n28_ | ~x03);
  assign new_n27_ = x11 & x13;
  assign new_n28_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign new_n29_ = (~x09 | ~x13) & (~x03 | x08 | x10 | x11);
  assign z3 = (~new_n31_ & (~x06 | ~x09)) | (x03 & ~x06 & new_n33_ & x09);
  assign new_n31_ = (new_n32_ | ~x03) & x05 & (x03 | x07);
