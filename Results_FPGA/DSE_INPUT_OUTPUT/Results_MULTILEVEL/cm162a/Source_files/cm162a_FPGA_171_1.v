...
module FAU ( 
  ...
  assign new_n25_ = ~x07 & x13;
  assign z2 = (~new_n25_ & ((~new_n27_ & x03) | ~x05 | (~x03 & ~x06))) | (new_n28_ & x03);
  assign new_n27_ = (~x11 | (~x08 & ~x10 & x02 & x04)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n28_ = x07 & x09 & x13 & (x11 | (x02 & x04));
  assign z3 = (x03 & ((~new_n30_ & (x07 | ~x13)) | new_n31_ | (~x05 & ~x13))) | (~x05 & x07) | (~x03 & ~x07 & ~x13);
  assign new_n30_ = (~x12 | (x02 & x04 & ~x08 & ~x10 & ~x11)) & (~x02 | ~x04 | x08 | x10 | x11 | x12);
  assign new_n31_ = x04 & x07 & x09 & x13 & (x02 | x12);
