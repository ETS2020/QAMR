...
module FAU ( 
  ...
  assign z2 = (x03 & (new_n26_ | (~new_n28_ & x11))) | (~x05 & x06) | (~x03 & ~x06 & x11);
  assign new_n26_ = x02 & x04 & x06 & (new_n27_ | (x09 & x13));
  assign new_n27_ = ~x08 & ~x10 & ~x11;
  assign new_n28_ = new_n29_ & x02 & x04 & x05;
  assign new_n29_ = ~x08 & ~x10 & (~x09 | ~x13);
  assign z3 = (~new_n31_ & x03) | ~x05 | (~x06 & ~x11) | (~x03 & ~x07);
  assign new_n31_ = (~x04 | (~new_n33_ & (new_n32_ | ~x02))) & (~x12 | (new_n27_ & x02 & x04));
