...
module FAU ( 
  ...
  assign z2 = (~new_n27_ & x03) | (~new_n23_ & (~x05 | (~x03 & ~x06)));
  assign new_n27_ = (~x02 | new_n28_ | ~x04) & (~x11 | ~x13 | (new_n29_ & x02 & x04));
  assign new_n28_ = (~x09 | ~x13) & (x08 | x10 | x11);
  assign new_n29_ = ~x08 & ~x09 & ~x10;
  assign z3 = (x03 & (~new_n31_ | new_n35_)) | ~x05 | new_n23_ | (~x03 & ~x07);
  ...
  assign new_n35_ = x11 & (x12 | (x02 & x04 & x09));
