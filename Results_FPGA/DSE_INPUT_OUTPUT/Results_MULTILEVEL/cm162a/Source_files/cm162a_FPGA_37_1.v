...
module FAU ( 
  ...
  assign z2 = (~new_n28_ & (x11 | ~x13)) | (x03 & (new_n30_ | (~new_n29_ & x11)));
  assign new_n28_ = x05 & (x03 | x06);
  assign new_n29_ = x02 & x04 & ~x08 & ~x10 & (~x09 | ~x13);
  assign new_n30_ = x02 & x04 & ~x08 & ~x10 & ~x11 & ~x13;
  assign z3 = (~new_n32_ & x03) | (~x11 & x13) | ~x05 | (~x03 & ~x07);
  assign new_n32_ = (~x02 | new_n33_ | ~x04) & (new_n30_ | ~x12);
