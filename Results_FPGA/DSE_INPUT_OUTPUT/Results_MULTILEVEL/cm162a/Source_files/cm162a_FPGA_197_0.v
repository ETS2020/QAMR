...
module FAU ( 
  ...
  assign z2 = (~new_n26_ & (x09 | x12)) | (x03 & new_n28_ & x09);
  ...
  assign new_n30_ = (~x09 | ((~new_n32_ | ~x02) & (~x12 | ~x13))) & (new_n31_ | ~x12);
  assign new_n31_ = x02 & x04 & ~x08 & ~x10 & ~x11;
  assign new_n32_ = x04 & (x13 | (~x08 & ~x10 & ~x11 & ~x12));
  assign z4 = (~x09 & ~x12) | (x04 & x09 & x13);
endmodule
