...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = (~new_n22_ & (~x00 | (x03 & x09))) | (~x00 & (~x03 | ~x05)) | (x09 & (~x05 | (new_n23_ & x03)));
  ...
  assign new_n26_ = x00 & ~x09;
  assign z2 = (~new_n26_ & ((~new_n28_ & x03) | ~x05 | (~x03 & ~x06))) | (new_n29_ & x03);
  assign new_n28_ = (~x11 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n29_ = x09 & x13 & (x11 | (x02 & x04));
  assign z3 = (x03 & (new_n31_ | new_n33_)) | ~x05 | new_n26_ | (~x03 & ~x07);
