// Benchmark "FAU" written by ABC on Mon Aug 17 19:49:54 2020
...
module FAU ( 
  ...
  assign new_n24_ = (~x02 | ~x04 | x10 | (x08 & ~x13)) & (~x10 | (x02 & x04 & ~x08 & (~x09 | ~x13)));
  assign z2 = new_n27_ | (x09 & ((~new_n26_ & x03) | ~x05 | (~x03 & ~x06)));
  assign new_n26_ = (~x02 | ~x04 | (~x13 & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~x13));
