...
module FAU ( 
  ...
  assign z1 = (~new_n24_ & x03) | (~x01 & ~x03) | ~x05 | (~x10 & ~x11);
  assign new_n24_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08 & (~x09 | ~x13)));
  assign z2 = new_n26_ | (x03 & (new_n27_ | new_n28_));
  assign new_n26_ = (x10 | x11) & (~x05 | (~x03 & ~x06));
  assign new_n27_ = x09 & x13 & (x11 | (x02 & x04 & x10));
  assign new_n28_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign z3 = (x10 | x11) & ((~new_n30_ & x03) | ~x05 | (~x03 & ~x07));
  assign new_n30_ = ~x12 & (~x02 | ~x04 | ~x09 | ~x13);
