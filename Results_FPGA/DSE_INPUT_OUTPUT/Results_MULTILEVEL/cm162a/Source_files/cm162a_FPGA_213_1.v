...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = (~x00 & (~x03 | x09)) | ~x05 | (~new_n22_ & x03);
  assign new_n22_ = (~x08 | (x02 & x04 & (~x09 | ~x13))) & (~x02 | ~x04 | x08);
  assign z1 = (~new_n24_ & x03) | (~x00 & x09) | ~x05 | (~x01 & ~x03);
  assign new_n24_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08 & (~x09 | ~x13)));
  assign z2 = (~new_n26_ & (x00 | ~x09)) | (x00 & x03 & new_n28_ & x09);
  ...
  assign new_n33_ = x05 & (x03 | x07) & (x00 | ~x09);
  assign z4 = x09 & (~x00 | (x04 & x13));
endmodule
