// Benchmark "FAU" written by ABC on Mon Aug 17 19:49:24 2020
...
module FAU ( 
  ...
  assign z2 = (x03 & ((~new_n26_ & (x06 | x13)) | (x13 & (new_n27_ | ~x05)))) | (~x05 & x06) | (~x03 & ~x06 & x13);
  assign new_n26_ = (~x11 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n27_ = x09 & (x11 | (x02 & x04));
