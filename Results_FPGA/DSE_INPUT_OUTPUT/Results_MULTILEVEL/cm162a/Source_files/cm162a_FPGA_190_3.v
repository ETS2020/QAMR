...
module FAU ( 
  ...
  assign new_n29_ = ~x07 & x09 & x13 & (x11 | (x02 & x04));
  assign z3 = ~new_n33_ | (~new_n31_ & x04);
  assign new_n31_ = (~x02 | (~new_n32_ & (x07 | ~x09 | ~x13))) & (x07 | ~x09 | ~x12 | ~x13);
  assign new_n32_ = ~x10 & ~x11 & ~x12 & x03 & ~x08;
  assign new_n33_ = (x03 | (x07 & ~x09)) & (~new_n34_ | ~x03) & x05 & (~x07 | ~x09);
  assign new_n34_ = x12 & (~x02 | ~x04 | x08 | x10 | x11);
  assign z4 = x09 & x13 & x04 & ~x07;
endmodule
