...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = (x03 & ((~new_n22_ & (x00 | x09)) | (x09 & (new_n23_ | ~x05)))) | (x00 & ~x05) | (~x00 & ~x03 & x09);
  assign new_n22_ = (~x08 | (x02 & x04)) & (~x02 | ~x04 | x08);
  assign new_n23_ = x08 & x13;
  assign z1 = (~new_n26_ & x03) | (~x01 & ~x03) | new_n25_ | ~x05;
  assign new_n25_ = ~x00 & ~x09;
  assign new_n26_ = (~x02 | ~x04 | ((x08 | x10) & (~x09 | ~x13))) & (~x10 | (x02 & x04 & ~x08 & (~x09 | ~x13)));
  assign z2 = (~new_n25_ & ((~new_n28_ & x03) | ~x05 | (~x03 & ~x06))) | (new_n29_ & x03);
  assign new_n28_ = (~x11 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n29_ = x09 & x13 & (x11 | (x02 & x04));
  assign z3 = (x03 & (new_n31_ | new_n33_)) | ~x05 | new_n25_ | (~x03 & ~x07);
