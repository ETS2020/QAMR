...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = ~new_n22_ | (~x05 & (x03 | ~x08));
  assign new_n22_ = (x08 | ((x00 | x03) & (~x02 | ~x03 | ~x04))) & (~x03 | ~x08 | (x02 & ~new_n23_ & x04));
  assign new_n23_ = x09 & x13;
  assign z1 = (~new_n25_ & x03) | (~x08 & (~x05 | (~x01 & ~x03)));
  assign new_n25_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10))) & x05 & (~x10 | (x02 & x04 & ~new_n23_ & ~x08));
  assign z2 = (~new_n27_ & x03) | (~x08 & (~x05 | (~x03 & ~x06)));
  ...
  assign z3 = (x03 & (new_n31_ | new_n33_ | ~x05)) | (~x08 & (~x05 | (~x03 & ~x07)));
