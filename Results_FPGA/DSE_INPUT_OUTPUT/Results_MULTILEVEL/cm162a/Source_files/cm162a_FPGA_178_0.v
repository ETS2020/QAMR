...
module FAU ( 
  ...
  assign z1 = (x03 & ((~new_n24_ & (x01 | x09)) | (x09 & (new_n25_ | ~x05)))) | (x01 & ~x05) | (~x01 & ~x03 & x09);
  ...
  assign new_n29_ = x05 & (x01 | x09) & (x03 | x06);
  assign z3 = (new_n33_ & x03) | (~new_n31_ & ((~new_n32_ & x03) | ~x05 | (~x03 & ~x07)));
