...
module FAU ( 
  ...
  assign new_n22_ = ~x04 & (x07 | (x03 & x08));
  assign new_n23_ = (~x08 | (x02 & (~x09 | ~x13))) & (~x02 | ~x04 | x08);
  assign z1 = ~new_n25_ | (~x03 & ((~x05 & ~x07) | (~x01 & (x04 | ~x07))));
  ...
  assign new_n28_ = (~x02 | ((~x09 | ~x13) & (x08 | x10 | x11))) & (~x11 | (x02 & ~x08 & ~x10 & (~x09 | ~x13)));
  assign new_n29_ = ~x07 & ((~x03 & (~x05 | ~x06)) | (~x05 & ~x11) | (x03 & ~x04 & x11));
  ...
  assign new_n34_ = (x03 | (x04 & x07)) & x05 & (x04 | (~x07 & ~x12));
