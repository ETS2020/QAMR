...
module FAU ( 
  ...
  assign new_n27_ = (~x02 | ~x04 | x10 | (~new_n23_ & (x08 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~new_n23_ & ~x10));
  assign z3 = (~new_n29_ & (~x10 | x11)) | (x03 & ((~new_n30_ & ~x10) | (x11 & x12)));
  assign new_n29_ = x05 & (x03 | x07) & (~x02 | ~x03 | ~new_n23_ | ~x04);
  assign new_n30_ = (~x04 | (~new_n31_ & (~x02 | x08 | x11 | x12))) & (~x12 | (x02 & x04 & ~x08));
