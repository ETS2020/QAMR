...
module FAU ( 
  ...
  assign new_n28_ = (new_n30_ | ~x11) & (~new_n29_ | x09 | x10 | x11);
  assign new_n29_ = x02 & x04 & ~x08;
  assign new_n30_ = x02 & x04 & ~x08 & ~x10 & (~x09 | ~x13);
  assign z3 = (~new_n32_ & x03) | (x09 & ~x11) | ~x05 | (~x03 & ~x07);
  assign new_n32_ = (~x04 | (~new_n34_ & (new_n33_ | ~x02))) & (~x12 | (new_n35_ & x02 & x04));
