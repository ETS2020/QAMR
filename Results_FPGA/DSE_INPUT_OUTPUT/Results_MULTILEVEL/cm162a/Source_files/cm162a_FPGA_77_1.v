...
module FAU ( 
  ...
  assign z1 = (x03 & ((~new_n24_ & (x01 | ~x09)) | (x01 & new_n25_ & x09) | (~x05 & ~x09))) | (x01 & ~x05) | (~x01 & ~x03 & ~x09);
  assign new_n24_ = (~x10 | (x02 & x04 & ~x08)) & (~x02 | ~x04 | x08 | x10);
  assign new_n25_ = x13 & (x10 | (x02 & x04));
  assign z2 = ~new_n29_ | (x03 & ((new_n27_ & x02) | (~new_n28_ & x11)));
  assign new_n27_ = x04 & ((~x08 & ~x10 & ~x11) | (x09 & x13));
  assign new_n28_ = x02 & x04 & ~x08 & ~x10 & (~x09 | ~x13);
  assign new_n29_ = (x01 | ~x09) & x05 & (x03 | x06);
  assign z3 = ~new_n34_ | (x03 & (new_n33_ | (x04 & (new_n31_ | new_n32_))));
  assign new_n31_ = x01 & x09 & x13 & (x02 | x12);
  assign new_n32_ = x02 & ~x08 & ~x10 & ~x11 & ~x12;
  assign new_n33_ = x12 & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n34_ = x05 & (x01 | ~x09) & (x03 | x07);
