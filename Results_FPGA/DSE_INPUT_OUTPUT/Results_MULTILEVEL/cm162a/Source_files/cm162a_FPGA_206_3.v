...
module FAU ( 
  ...
  assign new_n26_ = (~x02 | ~x04 | new_n27_ | x11) & (x07 | ~x11 | (new_n28_ & x02 & x04));
  assign new_n27_ = (~x09 | ~x13) & (x08 | x10);
  assign new_n28_ = ~x08 & ~x10 & (~x09 | ~x13);
  assign z3 = (~x03 & (~x07 | x11)) | (x11 & (x07 | x12)) | ~x05 | (~new_n30_ & x03);
  assign new_n30_ = (~x04 | (~new_n32_ & ~new_n33_)) & (~x12 | (new_n31_ & x02 & x04));
  assign new_n31_ = ~x08 & ~x10;
  assign new_n32_ = x09 & x13 & ((x02 & (~x11 | ~x12)) | (x12 & (~x07 | ~x11)));
