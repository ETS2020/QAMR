// Benchmark "FAU" written by ABC on Mon Aug 17 19:49:37 2020
...
module FAU ( 
  ...
  assign z0 = ~x05 | (~new_n22_ & x09);
  assign new_n22_ = x03 ? ((~x08 | (x02 & x04 & ~x13)) & (~x02 | ~x04 | x08)) : x00;
  assign z1 = ~x05 | (x09 & (x03 ? ~new_n24_ : ~x01));
  ...
  assign new_n28_ = (~x04 | ((~x02 | (~new_n30_ & ~x13)) & (~x12 | ~x13))) & (~x12 | (new_n29_ & x02 & x04));
  assign new_n29_ = ~x08 & ~x10 & ~x11;
