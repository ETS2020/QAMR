// Benchmark "FAU" written by ABC on Mon Aug 17 19:50:05 2020
...
module FAU ( 
  ...
  assign new_n31_ = (~x02 | (~new_n32_ & (~x09 | ~x13))) & (~x09 | ~x13 | (x03 & ~x12));
  assign new_n32_ = x03 & ~x08 & ~x10 & ~x11 & ~x12;
  assign new_n33_ = (~new_n34_ | ~x03) & x05 & (~x07 | ~x09) & (x03 | x07);
