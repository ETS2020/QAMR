...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & (~x07 | x13)) | (x03 & x08 & x09 & x13);
  ...
  assign new_n28_ = x05 & (x03 | x06) & (~x07 | x13);
  assign z3 = (~new_n30_ & (~x07 | (x03 & x13))) | (x13 & (~x05 | (new_n31_ & x03))) | (~x07 & (~x03 | ~x05));
  assign new_n30_ = (~x12 | (x02 & x04 & ~x08 & ~x10 & ~x11)) & (~x02 | ~x04 | x08 | x10 | x11 | x12);
  assign new_n31_ = x09 & (x12 | (x02 & x04));
