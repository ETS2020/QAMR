...
module FAU ( 
  ...
  assign z2 = (~x11 & (new_n26_ | ~x05)) | (~x06 & ((~new_n28_ & x11) | ~x03 | ~x05));
  assign new_n26_ = x02 & x03 & x04 & (new_n27_ | (x09 & x13));
  assign new_n27_ = ~x08 & ~x10;
  assign new_n28_ = x02 & x04 & ~x08 & ~x10 & (~x09 | ~x13);
  assign z3 = ~new_n32_ | (x03 & (new_n31_ | (~new_n30_ & x04)));
  assign new_n30_ = (~x02 | ((~x09 | ~x13) & (~new_n27_ | x11 | x12))) & (~x12 | ~x13 | ~x09 | x11);
