...
module FAU ( 
  ...
  assign new_n28_ = ~new_n30_ & (~new_n29_ | ~x02);
  assign new_n29_ = x04 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
  assign new_n30_ = x11 & (~x02 | ~x04 | x08 | x10 | x13);
  assign z3 = (x03 & (new_n32_ | new_n34_)) | ~x05 | new_n23_ | (~x03 & ~x07);
  assign new_n32_ = x04 & ((x02 & (new_n33_ | (x09 & x13))) | (x09 & x12 & x13));
  assign new_n33_ = ~x08 & ~x10 & ~x12 & (~x09 | ~x11);
