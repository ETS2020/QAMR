...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = (~new_n22_ & ~x08) | (x03 & ~new_n23_ & x08) | ~x05 | (~x00 & ~x03);
  assign new_n22_ = x13 & (~x02 | ~x03 | ~x04);
  ...
  assign new_n27_ = (~x02 | ~x04 | (~x09 & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x09 & ~x10));
  assign new_n28_ = x08 & (~x05 | (~x03 & ~x06) | (x03 & x11));
  ...
  assign new_n33_ = x05 & (x08 | x13) & (x03 | x07);
