...
module FAU ( 
  ...
  assign new_n24_ = (x01 | (x08 & x13)) & (x05 | x13);
  assign new_n25_ = ~x05 & (~x08 | (~x10 & ~x13));
  assign new_n26_ = x08 ? (~x10 | x13) : ((~x10 | (x02 & x04 & (~x09 | ~x13))) & (~x02 | ~x04 | x10));
  ...
  assign new_n30_ = x05 & (~x08 | ~x13) & (x03 | x06);
  ...
  assign new_n34_ = x05 & (~x08 | ~x13) & (x03 | x07);
