...
module FAU ( 
  ...
  assign z3 = (~x03 & (~x07 | ~x11)) | ~new_n30_ | (x07 & (~x11 | (x03 & x12)));
  assign new_n30_ = (~x04 | (~new_n31_ & ~new_n32_)) & x05 & (~new_n33_ | ~x03);
  assign new_n31_ = x09 & x13 & ((x02 & (~x07 | (x03 & ~x12))) | (x03 & ~x07 & x12));
