...
module FAU ( 
  ...
  assign z1 = (~x10 & (new_n24_ | ~x03)) | (x03 & ~new_n25_ & x10) | ~x05 | (~x01 & ~x03);
  assign new_n24_ = x02 & x04 & (~x08 | (x09 & x13));
  assign new_n25_ = x02 & x04 & ~x08 & (~x09 | ~x13);
  assign z2 = (~new_n27_ & x03) | (x10 & (~x05 | (~x03 & ~x06)));
  ...
  assign z3 = (x03 & (new_n31_ | new_n33_ | ~x05)) | (x10 & (~x05 | (~x03 & ~x07)));
