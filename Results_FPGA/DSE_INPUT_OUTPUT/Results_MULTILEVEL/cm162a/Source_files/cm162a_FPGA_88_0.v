// Benchmark "FAU" written by ABC on Mon Aug 17 19:49:51 2020
...
module FAU ( 
  ...
  assign z2 = (~new_n27_ & x03) | ~x05 | (~x02 & ~x09) | (~x03 & ~x06);
  assign new_n27_ = (~x02 | ~x04 | (~new_n25_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~new_n25_ & ~x10));
  assign z3 = (~new_n29_ & x03) | ~x05 | (~x02 & ~x09) | (~x03 & ~x07);
  assign new_n29_ = (~x02 | new_n30_ | ~x04) & (~x12 | (new_n31_ & x02 & x04 & ~x08));
  assign new_n30_ = (~x09 | ~x13) & (x11 | x12 | x08 | x10);
  assign new_n31_ = ~x10 & ~x11 & (~x09 | ~x13);
  assign z4 = (~x02 & (~x09 | (x03 & x04 & x13))) | (x04 & x09 & x13 & (~x03 | (x02 & x03)));
endmodule
