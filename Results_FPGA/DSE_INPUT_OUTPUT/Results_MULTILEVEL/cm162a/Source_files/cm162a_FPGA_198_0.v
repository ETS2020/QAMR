...
module FAU ( 
  ...
  assign new_n24_ = (x00 | x13) & ((~new_n25_ & x03) | ~x05 | (~x01 & ~x03));
  assign new_n25_ = (~x10 | (x02 & x04 & ~x08)) & (x08 | x10 | ~x02 | ~x04);
  assign new_n26_ = x02 & x04;
  assign z2 = new_n28_ | (x03 & x09 & x13 & (new_n26_ | x11));
  assign new_n28_ = (x00 | x13) & ((~new_n29_ & x03) | ~x05 | (~x03 & ~x06));
  assign new_n29_ = (~x11 | (~x08 & ~x10 & x02 & x04)) & (~x02 | ~x04 | x08 | x10 | x11);
  ...
  assign new_n34_ = x05 & (x00 | x13) & (x03 | x07);
