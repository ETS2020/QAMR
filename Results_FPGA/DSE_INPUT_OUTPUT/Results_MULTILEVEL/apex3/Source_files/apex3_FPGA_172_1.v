...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n335_, new_n339_, new_n340_, new_n343_, new_n345_, new_n346_,
    new_n347_, new_n349_, new_n353_, new_n359_, new_n361_, new_n363_;
  ...
  assign z09 = ~x46 & (x47 | (new_n303_ & new_n304_));
  assign new_n303_ = new_n125_ & ~x51;
  ...
  assign z11 = ~x47 & ((~new_n308_ & x51) | (new_n309_ & new_n156_ & x50 & ~x51));
  ...
  assign z12 = ~x46 & x47;
  assign z13 = ~x46 & (x47 | (new_n304_ & new_n156_ & ~x51));
  assign z14 = ~x53 & new_n313_ & ~x52;
  assign new_n313_ = ~x51 & x50 & x49 & x48 & ~x46 & ~x47;
  assign z15 = ~x47 & ((~new_n316_ & ~x49) | (new_n315_ & ~x48 & x49 & x50));
  assign new_n315_ = new_n156_ & x51;
  assign new_n316_ = (~x48 | (x51 ? (~x52 | (~x50 ^ x53)) : (x52 | (x46 ^ (x50 | x53))))) & (~x46 | ~x50 | x51 | ~x52 | x53);
  assign z16 = z12 | (~x48 & new_n318_ & ~x49);
  assign new_n318_ = x52 & ((x46 & ~x47 & (x50 ? (~x51 & x53) : (x51 & ~x53))) | (~x46 & ~x50 & ~x51 & x53));
  assign z17 = (~x46 & (x47 | (~x48 & new_n321_ & ~x49))) | (new_n320_ & x46 & ~x47 & x48 & ~x49);
  assign new_n320_ = new_n164_ & new_n129_;
  assign new_n321_ = x51 & x52 & (~x50 ^ ~x53);
  assign z18 = x46 ? (~new_n323_ & ~x47) : x47;
  assign new_n323_ = (x49 | ~x51 | ((~x48 | x53 | (~x50 ^ x52)) & (x48 | ~x50 | ~x52 | ~x53))) & (x51 | x52 | ~x53 | x48 | ~x49 | x50);
  assign z19 = ~x47 & ~new_n325_ & ~x48;
  assign new_n325_ = (x53 | (x46 ? (~x49 | (x50 ? (x51 | ~x52) : (~x51 | x52))) : (x49 | ~x52 | (x50 ^ ~x51)))) & (x46 | x52 | ~x53 | (x49 ? (x50 | x51) : (~x50 | ~x51)));
  assign z20 = ~x46 & (new_n327_ | x47);
  assign new_n327_ = x48 & x49 & ~x50 & x51 & (x52 ^ x53);
  assign z21 = (~x46 & x47) | (new_n329_ & ~x48 & ~x49 & x46 & ~x47);
  assign new_n329_ = new_n125_ & ~x50 & x51;
  assign z22 = ~x47 & ~new_n331_ & ~x52;
  assign new_n331_ = (x48 | x53 | ((x46 | (x49 ? (x50 | x51) : (~x50 | ~x51))) & (~x46 | ~x49 | ~x50 | x51))) & (x46 | ~x48 | ~x49 | x50 | ~x51 | ~x53);
  ...
  assign z26 = (~x46 & x47) | (new_n320_ & x46 & ~x47 & ~x48 & x49);
  assign z27 = ~x46 & (x47 | (new_n303_ & x48 & ~x49 & ~x50));
  ...
  assign z35 = ~x47 & (new_n345_ | (~new_n347_ & x52));
  assign new_n345_ = ~x46 & x48 & ~x49 & new_n346_ & x50 & x51;
  assign new_n346_ = ~x52 & ~x53;
  assign new_n347_ = (x46 | ~x48 | x51 | (x49 ? (~x50 | ~x53) : x53)) & (x50 | ~x51 | x53 | ~x46 | x48 | ~x49);
  assign z36 = x53 & x52 & new_n349_ & ~x51;
  assign new_n349_ = ~x50 & x49 & x48 & ~x46 & ~x47;
  assign z37 = ~x46 & (x47 | (new_n172_ & x48 & new_n346_ & ~x51));
  ...
  assign z42 = ~x46 & (x47 | (new_n315_ & new_n172_ & ~x48));
  assign z43 = ~x46 & (x47 | (new_n172_ & ~x48 & new_n125_ & x51));
  assign z44 = ~x46 & (new_n359_ | x47);
  assign new_n359_ = x48 & ~x49 & ((~x51 & x52 & x53) | (x50 & (~x51 ^ ~x52)));
  assign z47 = ~x46 & (new_n361_ | x47);
  assign new_n361_ = new_n346_ & x51 & x48 & ~x49 & ~x50;
  assign z49 = x46 ? (new_n363_ & ~x47) : (x47 | (new_n304_ & new_n125_ & x51));
  assign new_n363_ = x52 & ((~x48 & x49 & ~x50 & (~x51 ^ ~x53)) | (x48 & ~x49 & x50 & ~x51 & x53));
  assign z23 = 1'b0;
  assign z33 = 1'b0;
  assign z34 = 1'b0;
  assign z46 = 1'b0;
