...
module FAU ( 
  ...
  assign z11 = ~x09 & (new_n87_ | ~x27);
  assign new_n87_ = ~x30 & (~new_n73_ | x04) & (~new_n68_ | ~x08 | ~x29);
  assign z12 = new_n89_ | ((x27 ? new_n66_ : x09) & (~new_n68_ | x04));
  assign new_n89_ = ~x10 & ((x09 & ~x27) | (x27 & ~x35 & ~x36 & ~x37));
  assign z13 = (~x04 & ~x13 & new_n91_ & x39) | (new_n93_ & ~x18);
  assign new_n91_ = x40 & ((~new_n92_ & x27) | ((x09 | x27) & (x30 | x32)));
  ...
  assign z19 = ~x09 & new_n87_ & x27;
  assign z20 = ~x09 & (~x27 | (new_n105_ & x27));
  assign new_n105_ = ~x30 & ~x35 & (~new_n68_ | ~x08 | ~x29);
  assign z18 = x09 | (~new_n87_ & x27);
endmodule
