...
module FAU ( 
  ...
  assign z13 = (x27 & (new_n94_ | (~x04 & new_n95_ & ~x13))) | (~new_n96_ & ~x13);
  assign new_n94_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n95_ = x39 & (~x28 | (x35 & x36));
  assign new_n96_ = x40 & (x04 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n99_ | (~new_n98_ & (x13 | (~new_n92_ & x40)));
  assign new_n98_ = ~new_n66_ & x20 & x27 & ~x18 & ~x19;
