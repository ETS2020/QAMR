...
module FAU ( 
  ...
  assign new_n86_ = (x27 | (x33 & x40)) & (x33 | (~x04 & ~x28 & x35));
  assign new_n87_ = x40 & (x33 | (x29 & x39));
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n91_ | (x33 & x40) | (~new_n90_ & (x04 | ~x39 | ~x40));
  ...
  assign new_n95_ = ~x33 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n106_ = x08 & x29 & ~x33 & x39 & x40;
  assign z19 = new_n68_ | (~x09 & ~x30 & (new_n109_ | (~new_n88_ & ~new_n108_)));
