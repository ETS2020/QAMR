...
module FAU ( 
  ...
  assign new_n86_ = (~new_n69_ | x04) & (~new_n72_ | ~x08 | ~x29);
  ...
  assign new_n106_ = (~x27 | (new_n69_ & ~x04) | (new_n72_ & x08 & x29)) & (x04 | ((x08 | x27) & (new_n69_ | (new_n72_ & x29))));
  assign z20 = (x04 & ~x27) | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & ((new_n72_ & x29) | (x35 & (x27 | ~x28)));
endmodule
