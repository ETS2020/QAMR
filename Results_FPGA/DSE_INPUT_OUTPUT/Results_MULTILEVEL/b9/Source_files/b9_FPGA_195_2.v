...
module FAU ( 
  ...
  assign new_n87_ = (~x27 | (new_n73_ & ~x04) | (new_n68_ & x08 & x29)) & (x04 | ((new_n73_ | (new_n68_ & x29)) & (x08 | x27)));
  assign z12 = new_n89_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n89_ = (~new_n68_ | x04) & (~x27 | (~x37 & (~x28 | ~x35)));
  ...
  assign new_n94_ = x04 ? ~x27 : (~new_n95_ & new_n68_ & ~x13);
  ...
  assign new_n99_ = ~x04 & ~x27 & (~new_n68_ | x13 | (~x30 & ~x32));
