...
module FAU ( 
  ...
  assign z14 = x27 ? (new_n99_ | (~new_n97_ & ~new_n101_)) : (~new_n100_ & ~x31);
  ...
  assign z15 = (~x27 & x31) | (x12 & x26 & x27 & x34);
  assign z16 = (~x27 & x31) | (x01 & x22 & ~x23);
  assign z17 = (~x27 & x31) | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n106_ | (x08 & (new_n89_ | (new_n73_ & ~x27)));
  assign new_n106_ = ~x09 & (~new_n73_ | x04 | ~x27) & ~x30 & (x27 | ~x31);
  assign z19 = ~x09 & ~x30 & (new_n87_ | (~new_n108_ & ~x31));
  assign new_n108_ = (x08 | x27) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : x31)) & (new_n89_ | ((~x27 | x35) & (x31 | (x35 & (x27 | ~x28)))));
endmodule
