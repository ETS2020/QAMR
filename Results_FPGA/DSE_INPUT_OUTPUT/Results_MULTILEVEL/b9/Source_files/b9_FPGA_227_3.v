...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n100_, new_n101_, new_n102_, new_n107_, new_n108_, new_n109_,
    new_n111_, new_n113_;
  assign z00 = (~new_n67_ & (~x16 | (new_n68_ & ~x15))) | (~x04 & new_n65_ & ~x15);
  assign new_n65_ = new_n66_ & ~x19;
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n72_ | ~new_n73_ | x19;
  ...
  assign new_n87_ = ~new_n88_ & (~x40 | (~x19 & (~x29 | ~x39)));
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n89_ = (x27 | (x19 & x40)) & (x19 | (~x04 & ~x28 & x35));
  assign z12 = new_n91_ | new_n67_ | (~new_n68_ & (~new_n73_ | x04));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n93_ | (new_n95_ & ~x04))) | (~new_n96_ & x40);
  assign new_n93_ = ~x18 & ~x19 & ~new_n94_ & x20;
  assign new_n94_ = ~x37 & (~x28 | ~x35);
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x19 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n98_ | (~new_n101_ & ~x19) | (~x40 & (new_n94_ | x19 | ~x27));
  assign new_n98_ = (x18 | ~x20) & (~x40 | (~x19 & (new_n99_ | ~new_n100_)));
  ...
  assign z18 = (~new_n107_ & (~x19 | ~x40)) | (new_n109_ & x08 & ~x19);
  assign new_n107_ = ~new_n108_ & ~x09 & ~x30;
  assign new_n108_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n109_ = x29 & x39 & x40;
  assign z19 = new_n67_ | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = (new_n109_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign z20 = new_n67_ | (~x09 & ~new_n113_ & ~x30);
  assign new_n113_ = (x08 | (x27 & x35)) & (new_n109_ | (x35 & (x27 | ~x28)));
endmodule
