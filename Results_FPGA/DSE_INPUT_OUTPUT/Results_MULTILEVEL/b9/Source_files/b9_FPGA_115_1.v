...
module FAU ( 
  ...
  assign new_n95_ = x37 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n97_ & (new_n98_ | ~new_n99_)) | new_n91_ | (~new_n100_ & ~x27);
  assign new_n97_ = ~x18 & ~x19 & x20;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39 & x40;
  assign new_n100_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  ...
  assign new_n105_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n106_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = new_n67_ | (~x09 & ~x30 & (new_n108_ | (~new_n87_ & ~new_n88_)));
  assign new_n108_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
