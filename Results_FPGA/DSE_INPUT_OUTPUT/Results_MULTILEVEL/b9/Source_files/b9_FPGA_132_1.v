...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n75_, new_n76_, new_n80_,
    new_n82_, new_n85_, new_n87_, new_n88_, new_n94_, new_n95_, new_n97_,
    new_n98_, new_n99_;
  ...
  assign z13 = x04 ? (~x18 & ~x19 & new_n65_ & x20) : new_n85_;
  assign new_n85_ = ~x13 & ~x27 & x39 & x40 & (x30 | x32);
  assign z14 = x04 ? (~new_n87_ | (~x37 & (~x28 | ~x35))) : ~new_n88_;
  assign new_n87_ = x20 & x27 & ~x18 & ~x19;
  assign new_n88_ = ~x13 & ~x27 & (x30 | x32) & x39 & x40;
  ...
  assign z19 = ~x09 & ~x30 & (new_n95_ | (~new_n94_ & (x04 | ~x27)));
  assign new_n94_ = x08 & (x35 | (x29 & x39 & x40));
  assign new_n95_ = (~x29 | ~x39 | ~x40) & (x27 ? x04 : x28);
  assign z20 = ~x09 & ~x30 & (new_n98_ | (~new_n97_ & ~new_n99_));
