// Benchmark "FAU" written by ABC on Mon Aug 17 20:13:51 2020
...
module FAU ( 
  ...
  assign z18 = (~new_n103_ & x08) | ~new_n104_ | x09 | (~x27 & x40);
  assign new_n103_ = (~new_n70_ | x27) & (~x29 | ~x39 | ~x40);
  assign new_n104_ = ~x30 & (~new_n70_ | x04 | ~x27);
