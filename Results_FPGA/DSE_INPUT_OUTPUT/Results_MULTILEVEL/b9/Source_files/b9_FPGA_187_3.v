...
module FAU ( 
  ...
  assign new_n86_ = (x28 | ~x35) & (~new_n66_ | ~x08 | ~x29);
  assign z12 = (~x10 & (new_n88_ | ~x27)) | x04 | (~new_n66_ & (new_n89_ | ~x27));
  assign new_n88_ = ~x35 & ~x36 & ~x37;
  assign new_n89_ = ~x37 & (~x28 | ~x35);
  assign z13 = ~x04 & (new_n91_ | (~x13 & x39 & ~new_n69_ & x40));
  assign new_n91_ = x27 & (new_n92_ | (~x18 & ~x19 & ~new_n89_ & x20));
  ...
  assign z18 = ~new_n102_ | (x08 & (new_n101_ | (~x28 & x35)));
