...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n76_, new_n77_, new_n81_,
    new_n83_, new_n86_, new_n88_, new_n89_, new_n94_, new_n96_, new_n97_,
  ...
  assign z13 = (~new_n86_ & ~x04) | (~x18 & ~x19 & new_n65_ & x20);
  ...
  assign z20 = ~x09 & ~x30 & (new_n100_ | (~new_n99_ & ~new_n101_));
