...
module FAU ( 
  ...
  assign new_n87_ = (~x27 | (new_n72_ & ~x04) | (new_n68_ & x08 & x29)) & (x04 | ((new_n72_ | (new_n68_ & x29)) & (x08 | x27)));
  ...
  assign z19 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n104_ & ~x30);
  assign new_n104_ = (~new_n72_ | x04) & (~new_n68_ | ~x08 | ~x29);
