...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n77_,
    ...
    new_n99_, new_n104_, new_n106_, new_n107_, new_n109_, new_n110_;
  ...
  assign z02 = (~new_n71_ & ~x02) | new_n72_ | ~x39 | ~x40;
  ...
  assign z07 = new_n65_ | (x03 & (new_n78_ | (new_n77_ & ~x31)));
  assign new_n77_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign new_n78_ = ~x14 & (x00 | x25 | ~x38);
  assign z08 = x39 ^ ~x40;
  assign z09 = new_n65_ | (x11 & x26 & x27 & x34);
  assign z10 = (x27 & (new_n83_ | (~x04 & ~new_n69_ & ~new_n82_))) | (new_n84_ & ~x04);
  assign new_n82_ = (~x07 | (~x39 ^ x40)) & (~x05 | ~x39 | ~x40);
  assign new_n83_ = x06 & x37 & (x39 | x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n65_ | (~x09 & ~x30 & (new_n88_ | (~new_n86_ & ~new_n87_)));
  ...
  assign z18 = ((x39 | x40) & (new_n104_ | x09 | x30)) | (new_n71_ & x39 & x40);
  assign new_n104_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = ~x09 & ~x30 & ((~new_n87_ & ~new_n107_) | (~new_n106_ & ~x08));
  assign new_n106_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign new_n107_ = x39 ? (x29 & x40) : ~x40;
  assign z20 = ~x09 & ~x30 & (new_n109_ | new_n110_);
  assign new_n109_ = (x39 ? (~x29 | ~x40) : x40) & (~x35 | (~x27 & x28));
  assign new_n110_ = ~x08 & ((~x35 & x39) | (~x27 & (x39 | x40)));
