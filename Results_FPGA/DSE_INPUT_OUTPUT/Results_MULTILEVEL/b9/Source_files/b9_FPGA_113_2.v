...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & (~x11 | x27)) | (~x11 & ~x27 & x04 & ~x08);
  ...
  assign z19 = (x11 & ~x27) | (~x09 & ~x30 & (new_n87_ | (~new_n108_ & ~x11)));
  assign new_n108_ = (x08 | x27) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : x11)) & (new_n89_ | ((~x27 | x35) & (x11 | (x35 & (x27 | ~x28)))));
endmodule
