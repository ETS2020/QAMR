...
module FAU ( 
  ...
  assign z12 = x39 ? (new_n89_ | (~new_n90_ & (x04 | ~x40))) : (~new_n90_ & x40);
  ...
  assign new_n99_ = x39 ? (~new_n100_ & (new_n90_ | (~x04 & ~x13 & x40))) : (new_n90_ | ~x40);
  ...
  assign new_n108_ = (x27 | (~x39 & ~x40)) & (~x39 | (new_n74_ & ~x04));
  assign new_n109_ = (~new_n74_ | (x04 & x27)) & (x39 ? (~x29 | ~x40) : x40);
