...
module FAU ( 
  ...
  assign new_n91_ = x20 & (x18 | new_n68_ | x19);
  assign new_n92_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n97_ | (x20 & (new_n96_ | (~new_n94_ & (x18 | x19))));
  ...
  assign new_n97_ = ~x27 & (x04 | x13 | ~new_n66_ | (~x30 & ~x32));
  assign z15 = x34 & x27 & x26 & x12 & x20;
  assign z16 = x01 & x22 & ~x23 & (x20 | ~x27);
  assign z17 = (~x20 & x27) | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n102_ | (x08 & ((new_n73_ & ~x27) | (new_n66_ & x29)));
  assign new_n102_ = ~x09 & ~x30 & (~x27 | (x20 & (~new_n73_ | x04)));
