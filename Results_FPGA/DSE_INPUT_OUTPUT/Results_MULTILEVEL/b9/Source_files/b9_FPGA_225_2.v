...
module FAU ( 
  ...
  assign new_n71_ = (x27 | (~x10 & (~x04 | x08))) & new_n66_ & (new_n72_ | ~x04);
  ...
  assign z07 = (~new_n78_ & x03) | (x10 & ~x27);
  ...
  assign new_n83_ = x40 & (((~x10 | x27) & (x30 | x32)) | (~new_n69_ & x27));
  assign new_n84_ = x07 & x27 & ~new_n66_ & ~new_n69_;
  assign new_n85_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n88_ & ~x10));
  assign new_n87_ = x27 & (~new_n72_ | x04) & (~new_n66_ | ~x08 | ~x29);
  assign new_n88_ = (new_n72_ | new_n89_) & (x08 | x27);
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = (~x10 & ~x27) | (~x37 & ((new_n91_ & x27) | (~x10 & ~x35 & ~x36)));
  assign new_n91_ = (~x28 | ~x35) & (~new_n66_ | x04);
  assign z13 = (x27 & (new_n94_ | (new_n93_ & ~x04))) | (new_n95_ & ~x04) | (x10 & ~x27);
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n95_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (x27 & (new_n99_ | (~new_n97_ & ~new_n101_))) | (~x10 & ~new_n100_ & ~x27);
  ...
  assign z18 = new_n107_ | (~new_n106_ & (~x10 | x27));
  assign new_n106_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign new_n107_ = ~x28 & x35 & ((~x04 & x27) | (x08 & ~x10 & ~x27));
  assign z19 = ~x09 & ~x30 & (new_n87_ | (~new_n109_ & ~x10));
  assign new_n109_ = (x08 | x27) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 ? x35 : x10)) & (new_n89_ | ((~x27 | x35) & (x10 | (x35 & (x27 | ~x28)))));
endmodule
