...
module FAU ( 
  ...
  assign z10 = (~x04 & (new_n84_ | (~new_n83_ & ~x32))) | (new_n85_ & ~x32 & x37);
  assign new_n83_ = (~x27 | new_n70_ | (new_n68_ ? ~x05 : ~x07)) & (~new_n68_ | ~x05 | ~x30);
  assign new_n84_ = x05 & ~x27 & new_n68_ & x32;
  assign new_n85_ = x06 & x27;
  assign z11 = (x27 & x32) | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (new_n88_ | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | ((~x27 | (new_n66_ & ~x32)) & (~new_n68_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x32 & ~x35 & ~x36 & ~x37));
  assign z13 = (x27 & ((new_n93_ & ~x04) | new_n92_ | x32)) | (new_n94_ & ~x04);
  ...
  assign new_n96_ = new_n97_ & (~x27 | ~x28 | x30 | (x35 & x36));
  assign new_n97_ = x39 & x40 & ~x04 & ~x13;
  assign new_n98_ = (~x27 | (~new_n99_ & ~x32)) & (x27 | x30 | x32) & (new_n97_ | (~new_n66_ & x27));
  assign new_n99_ = ~x35 & ~x37 & x28 & ~x30;
  ...
  assign new_n104_ = (~x27 | (~x32 & (~new_n73_ | x04))) & ~x09 & ~x30;
  assign z19 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (new_n88_ | ((new_n73_ | (x27 & x32)) & (~x04 | ~x27 | x32))) & (x08 | (x27 & (x32 | (new_n73_ & ~x04))));
  assign z20 = ~x09 & ~new_n108_ & ~x30;
  assign new_n108_ = (x08 | (x27 & (x32 | x35))) & (new_n88_ | ((x32 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
endmodule
