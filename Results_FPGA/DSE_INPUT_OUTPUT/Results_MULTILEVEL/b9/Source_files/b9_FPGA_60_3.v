...
module FAU ( 
  ...
  assign z07 = (x04 & x27) | (~new_n74_ & x03);
  ...
  assign z10 = new_n79_ | (x27 & (new_n82_ | x04 | (x06 & x37)));
  assign new_n79_ = x05 & x39 & x40 & (new_n80_ | (~new_n81_ & x27));
  assign new_n80_ = ~x04 & (x30 | x32);
  assign new_n81_ = ~x36 & (x28 | ~x35);
  assign new_n82_ = x07 & ~new_n81_ & (~x39 | ~x40);
  assign z11 = ~x09 & ~new_n84_ & ~x30;
  assign new_n84_ = (x08 | x27) & ((~x28 & x35) | ((x04 | x08) & (new_n85_ | (x04 & x27))));
  assign new_n85_ = x29 & x39 & x40;
  assign z12 = new_n87_ | x04 | ((~x39 | ~x40) & (new_n88_ | ~x27));
  assign new_n87_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign z13 = (~x13 & new_n90_ & x39) | (x27 & (new_n91_ | x04));
  assign new_n90_ = x40 & (new_n80_ | (x27 & (~x28 | (x35 & x36))));
  assign new_n91_ = ~x18 & ~x19 & ~new_n88_ & x20;
  assign z14 = ~new_n94_ | (~new_n93_ & (x13 | ~x39 | ~x40));
  assign new_n93_ = ~new_n88_ & x20 & x27 & ~x18 & ~x19;
  assign new_n94_ = ~x04 & (x30 | x32 | (x27 & (new_n95_ | ~x28)));
  ...
  assign new_n100_ = ~x09 & ~x30 & (~x39 | ~x40 | ~x08 | ~x29);
  assign z19 = (x04 & x27) | (~x09 & ~new_n102_ & ~x30);
  assign new_n102_ = (x08 | (x27 & ~x28 & (x04 | x35))) & (new_n85_ | (~x28 & (x35 | (x04 & x27))));
  assign z20 = ~x09 & ~new_n104_ & ~x30;
  assign new_n104_ = (x08 | (x27 & (x04 | x35))) & (new_n85_ | ((x04 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
endmodule
