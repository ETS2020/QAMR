...
module FAU ( 
  ...
  assign z18 = (~new_n97_ & (x04 | ~x27)) | (new_n68_ & x08 & ~x27);
  assign new_n97_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39 | ~x40);
  assign z20 = new_n77_ | (~x09 & ~x30 & (new_n99_ | new_n100_));
  assign new_n99_ = ~x08 & (~x27 | ~x35);
  assign new_n100_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
  assign z19 = ~x09 & ~x30 & ((~new_n77_ & ~x08) | (~new_n85_ & ~new_n86_));
endmodule
