...
module FAU ( 
  ...
  assign z12 = (~x21 & (new_n92_ | (~new_n93_ & (new_n66_ | ~x27)))) | (~x40 & (new_n66_ | ~x27));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = ~x04 & x39;
  assign z13 = new_n98_ | (x27 & ((~new_n95_ & ~x21) | (new_n97_ & ~x18)));
  ...
  assign new_n100_ = ~x21 & (new_n101_ | ~new_n102_);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13 & x39;
  assign new_n103_ = (x40 | (~new_n66_ & x27)) & (x21 | (~new_n104_ & (new_n102_ | (~new_n66_ & x27))));
