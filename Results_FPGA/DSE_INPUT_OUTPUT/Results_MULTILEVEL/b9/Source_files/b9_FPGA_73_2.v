...
module FAU ( 
  ...
  assign z19 = ~x09 & ~x30 & (new_n104_ | (~new_n105_ & ~x04));
  assign new_n104_ = x27 & (~new_n73_ | x04) & (~new_n68_ | ~x08 | ~x29);
  assign new_n105_ = (x08 | x27) & (new_n106_ | (x35 & (x27 | ~x28)));
  assign new_n106_ = x29 & x39 & x40;
  assign z20 = ~x09 & ~new_n108_ & ~x30;
  assign new_n108_ = (x08 | (x27 ? x35 : x04)) & (new_n106_ | ((~x27 | x35) & (x04 | (x35 & (x27 | ~x28)))));
endmodule
