...
module FAU ( 
  ...
  assign new_n85_ = (~x06 | ~x27 | ~x37) & (x19 | ~x40);
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~new_n89_) | (~new_n87_ & ~x08));
  assign new_n87_ = (x27 | (~x19 & x40)) & (~x19 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 & (~x19 | (x29 & x39));
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n92_ | (~x19 & x40) | (~new_n91_ & (x04 | ~x39 | ~x40));
  ...
  assign z14 = new_n98_ | new_n101_ | (x19 & (new_n99_ | ~new_n100_));
  assign new_n98_ = ~x27 & (~x40 | (x19 & ~x30 & ~x32));
  ...
  assign new_n107_ = x08 & x19 & x29 & x39 & x40;
