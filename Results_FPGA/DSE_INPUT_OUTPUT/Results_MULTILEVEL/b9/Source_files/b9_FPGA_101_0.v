...
module FAU ( 
  ...
  assign z09 = (~x09 & ~x27) | (x27 & x34 & x11 & x26);
  assign z10 = new_n86_ | (~x04 & (new_n85_ | (x05 & new_n84_ & x39)));
  assign new_n84_ = x40 & (((x09 | x27) & (x30 | x32)) | (~new_n70_ & x27));
  assign new_n85_ = x07 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n86_ = x06 & x27 & x37;
  assign z11 = ~x09 & (~x27 | (~x30 & ~new_n88_ & (~new_n73_ | x04)));
  assign new_n88_ = new_n66_ & x08 & x29;
  assign z12 = new_n90_ | ((~new_n66_ | x04) & (x27 ? new_n68_ : x09));
  assign new_n90_ = ~x10 & ((x09 & ~x27) | (~x36 & ~x37 & x27 & ~x35));
  assign z13 = (x27 & (new_n92_ | (new_n93_ & ~x04))) | (~x09 & ~x27) | (new_n94_ & ~x04);
  ...
  assign z16 = (~x09 & ~x27) | (x01 & x22 & ~x23);
