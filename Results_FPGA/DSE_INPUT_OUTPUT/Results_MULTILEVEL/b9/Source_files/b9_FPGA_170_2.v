...
module FAU ( 
  ...
  assign z18 = ~new_n101_ | (x08 & ((new_n70_ & ~x27) | (new_n72_ & x29)));
  assign new_n101_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n70_ | x04 | ~x27);
  assign z19 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n103_ & ~x30);
  assign new_n103_ = (~new_n72_ | ~x08 | ~x29) & (~new_n70_ | x04);
  assign z20 = (x04 & ~x27) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (x27 & x35)) & ((new_n72_ & x29) | (x35 & (x27 | ~x28)));
endmodule
