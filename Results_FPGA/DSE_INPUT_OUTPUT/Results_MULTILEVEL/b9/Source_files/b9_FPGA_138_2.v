...
module FAU ( 
  ...
  assign new_n72_ = ~x27 & (x09 | (x04 & ~x08));
  ...
  assign z18 = ~new_n109_ | (x08 & (new_n91_ | (~x27 & ~x28 & x35)));
  assign new_n109_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = new_n79_ | (~x30 & (new_n112_ | (~new_n91_ & ~new_n111_)));
  assign new_n111_ = (~x28 | (x09 & x27)) & (x09 | (x35 & (~x04 | ~x27)));
  assign new_n112_ = ~x08 & (~x27 | (~x09 & (x04 | x28 | ~x35)));
  assign z20 = new_n79_ | (~x30 & (new_n114_ | (~new_n91_ & ~new_n115_)));
  assign new_n114_ = ~x08 & (~x27 | (~x09 & ~x35));
  assign new_n115_ = (x27 | ~x28) & (x09 | x35);
endmodule
