...
module FAU ( 
  ...
  assign z02 = new_n70_ | ~new_n66_ | (~x02 & (~x08 | ~x29));
  assign new_n70_ = x04 & (~new_n71_ | ~x08 | x27);
  ...
  assign new_n104_ = (x04 | x08) & (new_n105_ | (x04 & x27));
  assign new_n105_ = x29 & x39 & x40;
  assign z20 = (x04 & x27) | (~x09 & ~new_n107_ & ~x30);
  assign new_n107_ = (x08 | (x27 & (x04 | x35))) & (new_n105_ | ((x04 | x35) & (x27 | (~x28 & x35))));
endmodule
