...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n110_, new_n112_, new_n113_, new_n115_, new_n116_;
  ...
  assign new_n83_ = x27 & x33;
  assign z09 = x34 & ~x33 & x27 & x11 & x26;
  assign z10 = (~x04 & (new_n87_ | (x27 & ~new_n70_ & ~new_n86_))) | (~new_n88_ & x27);
  assign new_n86_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n87_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n88_ = ~x33 & (~x06 | ~x37);
  assign z11 = ~x09 & ~x30 & (new_n92_ | (~new_n90_ & ~new_n91_));
  assign new_n90_ = x29 & x39 & x40;
  assign new_n91_ = ((x27 & x33) | (~x28 & x35)) & (~x04 | ~x27 | x33);
  assign new_n92_ = ~x08 & (~x27 | (~x33 & (x04 | x28 | ~x35)));
  assign z12 = new_n94_ | ((~new_n82_ | x04) & (~x27 | (new_n66_ & ~x33)));
  assign new_n94_ = ~x10 & (~x27 | (~x33 & ~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n97_ | x33 | (new_n96_ & ~x04))) | (new_n98_ & ~x04);
  assign new_n96_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n98_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n100_ & (new_n101_ | ~new_n102_)) | new_n103_ | new_n83_ | (~new_n102_ & ~new_n104_);
  ...
  assign z16 = new_n83_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n83_ & ~x24;
  assign z18 = new_n110_ | (~new_n83_ & ~new_n109_);
  assign new_n109_ = ~x09 & ~x30 & (~x39 | ~x40 | ~x08 | ~x29);
  assign new_n110_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & x27 & ~x33));
  assign z19 = new_n83_ | (~x09 & ~x30 & (new_n113_ | (~new_n90_ & ~new_n112_)));
  assign new_n112_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n113_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n83_ | (~x09 & ~x30 & (new_n115_ | new_n116_));
  assign new_n115_ = ~x08 & (~x27 | ~x35);
  assign new_n116_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
endmodule
