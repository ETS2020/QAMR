...
module FAU ( 
  ...
  assign new_n72_ = (~x04 | (new_n73_ & (x08 | x27))) & new_n68_ & (x16 | ~x27);
  ...
  assign z13 = (x16 & ((new_n94_ & ~x04) | (~new_n92_ & x27))) | (new_n95_ & ~x04);
  ...
  assign new_n99_ = (x16 | ~x27) & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z19 = (~x16 & x27) | (~x09 & ~x30 & (new_n108_ | new_n109_));
  assign new_n108_ = ~new_n88_ & ((~x35 & (x16 | ~x27)) | x28 | (x04 & x27));
  assign new_n109_ = ~x08 & (x04 | ~x27 | x28 | (x16 & ~x35));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 & (~x16 | x35))) & (new_n88_ | ((~x16 | x35) & (x27 | (~x28 & x35))));
endmodule
