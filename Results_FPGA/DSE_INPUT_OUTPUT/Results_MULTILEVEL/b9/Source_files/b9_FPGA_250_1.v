...
module FAU ( 
  ...
  assign z07 = new_n67_ | (x03 & (new_n77_ | (new_n76_ & ~x31)));
  ...
  assign z10 = ~new_n83_ | (~x04 & (new_n82_ | (~new_n69_ & ~new_n81_ & x27)));
  assign new_n81_ = (~x07 | (x37 & x39 & x40)) & (~x05 | ~x39 | ~x40);
  assign new_n82_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n83_ = (x37 | ~x40) & (~x06 | ~x27 | ~x37);
  assign z11 = ~x09 & ~x30 & ((~new_n86_ & ~new_n87_) | (~new_n85_ & ~x08));
  assign new_n85_ = (x27 | (~x37 & x40)) & (~x37 | (~x04 & ~x28 & x35));
  assign new_n86_ = x40 & (~x37 | (x29 & x39));
  assign new_n87_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = (~new_n65_ & ~x40) | (~x27 & ~new_n89_ & x37);
  assign new_n89_ = ~x04 & x10 & x39;
  ...
  assign new_n93_ = x37 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n95_ & (new_n96_ | ~new_n97_)) | new_n98_ | (~new_n99_ & ~x27);
  assign new_n95_ = ~x18 & ~x19 & x20;
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = ~x04 & ~x13 & x39 & x40;
  assign new_n98_ = ~x37 & (~x28 | ~x35 | x40);
  ...
  assign z18 = (~new_n104_ & x08) | ~new_n105_ | new_n67_ | x30;
  assign new_n104_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n105_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = new_n67_ | (~x09 & ~x30 & (new_n108_ | (~new_n87_ & ~new_n107_)));
