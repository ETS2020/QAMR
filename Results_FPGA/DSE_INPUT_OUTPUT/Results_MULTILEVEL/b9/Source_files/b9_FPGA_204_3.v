...
module FAU ( 
  ...
  assign new_n72_ = (~x04 | (new_n73_ & x08)) & new_n68_ & (~x02 | ~x27);
  ...
  assign z06 = (x02 & x27) | (~x37 & (~x27 | ~x28));
  ...
  assign z12 = new_n90_ | ((~x27 | (new_n66_ & ~x02)) & (~new_n68_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x02 & ~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & ~x02) | (~x04 & ~x13 & new_n85_ & ~x27);
  ...
  assign z14 = (~new_n100_ & ~x27) | (~x02 & (new_n99_ | (~new_n97_ & ~new_n101_)));
  ...
  assign z18 = new_n107_ | (~new_n106_ & (~x02 | ~x27));
  assign new_n106_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n107_ = ~x28 & x35 & ((~x02 & ~x04 & x27) | (x08 & ~x27));
  assign z19 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (new_n88_ | ((new_n73_ | (x02 & x27)) & (x02 | ~x04 | ~x27))) & (x08 | (x27 & (x02 | (new_n73_ & ~x04))));
