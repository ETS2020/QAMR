...
module FAU ( 
  ...
  assign new_n72_ = (x27 | (~x05 & (~x04 | x08))) & new_n73_ & (new_n74_ | ~x04);
  ...
  assign z10 = x27 & ((~new_n85_ & ~x04) | (x06 & x37));
  assign new_n85_ = (new_n70_ | ((x39 & x40) ? ~x05 : ~x07)) & (~x05 | ~x39 | new_n86_ | ~x40);
  ...
  assign new_n91_ = (~x05 | x27) & ((new_n73_ & ~x04) | (x27 & (new_n67_ | x37)));
  assign z13 = new_n94_ | (~x04 & ~x13 & x39 & ~new_n93_ & x40);
  assign new_n93_ = (new_n86_ | (x05 & ~x27)) & (~x27 | (x28 & (~x35 | ~x36)));
  assign new_n94_ = ~x18 & ~x19 & x20 & x27 & (new_n67_ | x37);
  assign z14 = (x27 & (new_n98_ | (~new_n96_ & ~new_n100_))) | (~x05 & ~new_n99_ & ~x27);
