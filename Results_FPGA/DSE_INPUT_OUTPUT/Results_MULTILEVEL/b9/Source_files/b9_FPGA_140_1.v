...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n104_, new_n106_;
  assign z00 = (~x15 & x16 & (new_n67_ | (~new_n65_ & x27))) | (~x16 & ~x27);
  ...
  assign z10 = (~new_n84_ & ~x04) | (x27 & (~x16 | (x06 & x37)));
  assign new_n84_ = (~x27 | new_n70_ | (new_n68_ ? ~x05 : ~x07)) & (~new_n85_ | ~x05);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | ((new_n73_ | (~x16 & x27)) & (~x04 | ~x16 | ~x27))) & (x08 | (x27 & (~x16 | (new_n73_ & ~x04))));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | ((~new_n68_ | x04) & (~x27 | (new_n66_ & x16)));
  assign new_n90_ = ~x10 & (~x27 | (x16 & ~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (~new_n92_ | (~x04 & new_n93_ & ~x13))) | (~x04 & new_n85_ & ~x13);
  assign new_n92_ = x16 & (x18 | x19 | new_n66_ | ~x20);
  assign new_n93_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (~new_n98_ & ~x27) | (x16 & (new_n97_ | (~new_n95_ & ~new_n99_)));
