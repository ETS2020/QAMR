...
module FAU ( 
  ...
  assign z01 = (~x30 & ~x32 & ~new_n70_ & ~x36) | ~x04 | ~x27;
  assign new_n70_ = ~x28 & x35;
  assign z02 = (x27 & (new_n72_ | ~new_n68_ | (~new_n70_ & x04))) | (~x04 & (~new_n68_ | new_n72_));
  ...
  assign z11 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n86_ & ~x30);
  assign new_n86_ = (~new_n70_ | x04) & (~new_n68_ | ~x08 | ~x29);
  assign z12 = (x27 & ~new_n88_ & ~x37) | (~x04 & ~x27 & (~new_n68_ | ~x10));
  assign new_n88_ = ((x28 & x35) | (new_n68_ & ~x04)) & (x10 | x35 | x36);
  assign z13 = ~new_n91_ | (~x18 & new_n90_ & ~x19);
  assign new_n90_ = x20 & ~new_n66_ & (x04 | x27);
  assign new_n91_ = x04 ? x27 : (x13 | ~x39 | new_n92_ | ~x40);
  assign new_n92_ = ~x30 & ~x32 & (~x27 | (x28 & (~x35 | ~x36)));
  ...
  assign z18 = ~new_n102_ | (x08 & (new_n103_ | (new_n70_ & ~x27)));
  assign new_n102_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n70_ | x04 | ~x27);
  assign new_n103_ = x29 & x39 & x40;
  assign z19 = ~x09 & ~x30 & ((new_n86_ & x27) | (~new_n105_ & ~x04));
  assign new_n105_ = (x08 | x27) & (new_n103_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (x08 | (x27 ? x35 : x04)) & (new_n103_ | ((~x27 | x35) & (x04 | (x35 & (x27 | ~x28)))));
endmodule
