...
module FAU ( 
  ...
  assign new_n91_ = x40 & (((~x09 | x27) & (x30 | x32)) | (~new_n92_ & x27));
  ...
  assign z18 = (~x09 & (new_n104_ | x30)) | (x27 & (x09 | (new_n73_ & ~x04)));
  assign new_n104_ = x08 & ((new_n73_ & ~x27) | (new_n68_ & x29));
  assign z19 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = ((new_n68_ & x29) | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
  assign z20 = x09 ? ~x27 : (~x30 & (new_n108_ | (~x08 & (~x27 | ~x35))));
  assign new_n108_ = (~new_n68_ | ~x29) & (~x35 | (~x27 & x28));
endmodule
