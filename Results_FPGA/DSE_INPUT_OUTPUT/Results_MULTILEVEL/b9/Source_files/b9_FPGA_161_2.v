...
module FAU ( 
  ...
  assign new_n70_ = new_n72_ & (~x04 | (new_n71_ & x27));
  ...
  assign new_n86_ = (~x27 | (new_n71_ & ~x04) | (new_n72_ & x08 & x29)) & (x04 | ((x08 | x27) & (new_n71_ | (new_n72_ & x29))));
  ...
  assign new_n101_ = ~x09 & ~new_n102_ & ~x30;
  assign new_n102_ = x39 & x40 & x08 & x29;
  assign z19 = (~x27 & (x04 | (~x04 & ~x08 & ~x09 & ~x30))) | (~x09 & new_n104_ & ~x30);
  assign new_n104_ = ~new_n102_ & ((~x35 & (~x04 | x27)) | x04 | x28);
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (~x27 | new_n102_ | x35) & (x04 | (~new_n107_ & (x08 | (x27 & x35))));
