...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n77_, new_n78_,
    new_n79_, new_n83_, new_n85_, new_n88_, new_n90_, new_n91_, new_n96_,
  ...
  assign z10 = (~x04 & (new_n83_ | x27)) | (x06 & x27 & x37);
  assign new_n83_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n77_ | (~x09 & ~x30 & (new_n85_ | ~x08));
  ...
  assign z18 = (~new_n96_ & (x04 | ~x27)) | (new_n68_ & x08 & ~x27);
  assign new_n96_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39 | ~x40);
  assign z19 = new_n77_ | (~x09 & ~x30 & (~x08 | (~new_n98_ & ~new_n99_)));
