...
module FAU ( 
  ...
  assign new_n91_ = ~new_n65_ & (x04 | ~new_n84_ | x13);
  ...
  assign z18 = ~new_n103_ | (x08 & ((new_n72_ & ~x27) | (z08 & x29)));
  assign new_n103_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n65_ & ~x30;
  assign z20 = ~x09 & ~new_n105_ & ~x30;
  assign new_n105_ = ~new_n106_ & (x08 | ((x35 | ~x39) & (x27 | (~x39 & ~x40))));
  assign new_n106_ = (x39 ? (~x29 | ~x40) : x40) & (~x35 | (~x27 & x28));
