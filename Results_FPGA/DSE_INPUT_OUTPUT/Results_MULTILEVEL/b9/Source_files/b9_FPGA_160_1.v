...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n76_, new_n77_,
    new_n81_, new_n83_, new_n86_, new_n88_, new_n89_, new_n94_, new_n96_,
  ...
  assign z02 = new_n71_ | (x04 & (~new_n68_ | (~x08 & ~x27))) | ~new_n70_ | (~x04 & x27);
  ...
  assign z18 = (~new_n94_ & (x04 | ~x27)) | (new_n68_ & x08 & ~x27);
  assign new_n94_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39 | ~x40);
  assign z19 = ~x09 & ~x30 & (new_n96_ | (~new_n97_ & (~new_n70_ | ~x29)));
  ...
  assign new_n100_ = (~x35 | (~x27 & x28)) & (~x29 | ~x39 | ~x40);
  assign z05 = ~z06;
endmodule
