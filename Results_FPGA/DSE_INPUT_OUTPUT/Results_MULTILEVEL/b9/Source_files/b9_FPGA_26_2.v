...
module FAU ( 
  ...
  assign z01 = ~x04 | ~x27 | (~x30 & new_n69_ & ~x32);
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = (x27 & (new_n72_ | ~new_n73_ | (~new_n71_ & x04))) | (~x04 & (new_n72_ | ~new_n73_));
  ...
  assign new_n84_ = (~x27 | new_n69_ | (new_n73_ ? ~x05 : ~x07)) & (~new_n85_ | ~x05);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (~x27 | (new_n71_ & ~x04) | (new_n73_ & x08 & x29)) & (x04 | ((x08 | x27) & (new_n71_ | (new_n73_ & x29))));
  assign z12 = new_n89_ | (~new_n67_ & (~new_n73_ | x04));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~x04 & new_n85_ & ~x13) | (x27 & (new_n92_ | (~x04 & new_n91_ & ~x13)));
  ...
  assign new_n94_ = new_n73_ & ~x04 & ~x13;
  ...
  assign z18 = ~new_n102_ | (x08 & ((new_n71_ & ~x27) | (new_n73_ & x29)));
  assign new_n102_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n71_ | x04 | ~x27);
  assign z20 = (x04 & ~x27) | (~x09 & ~new_n104_ & ~x30);
  assign new_n104_ = (x08 | (x27 & x35)) & ((new_n73_ & x29) | (x35 & (x27 | ~x28)));
