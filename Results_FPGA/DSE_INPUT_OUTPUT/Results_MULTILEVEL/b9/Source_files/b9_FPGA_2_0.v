...
module FAU ( 
  ...
  assign new_n83_ = (~x06 | ~x27 | ~x37) & (x22 | x40);
  assign z11 = new_n65_ | (~x09 & ~x30 & (new_n87_ | (~new_n85_ & ~new_n86_)));
  ...
  assign new_n106_ = ~x08 & (~x27 | ~x35);
  assign new_n107_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
  assign z05 = x37 | new_n65_ | (x27 & x28);
  assign z19 = new_n65_ | (~x09 & ~x30 & (new_n87_ | (~new_n85_ & ~new_n86_)));
endmodule
