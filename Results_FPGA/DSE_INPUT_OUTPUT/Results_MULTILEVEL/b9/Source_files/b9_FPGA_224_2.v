...
module FAU ( 
  ...
  assign new_n88_ = (~x27 | (~x37 & (~x28 | ~x35))) & (~new_n68_ | x04);
  assign z13 = (~x18 & new_n92_ & ~x19) | (x04 & ~x27) | (new_n90_ & ~x04);
  assign new_n90_ = ~x13 & x39 & x40 & (new_n91_ | x30 | x32);
  assign new_n91_ = x27 & (~x28 | (x35 & x36));
  assign new_n92_ = x20 & (x37 | (x28 & x35)) & (x04 | x27);
  ...
  assign z19 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n86_ & ~x30);
endmodule
