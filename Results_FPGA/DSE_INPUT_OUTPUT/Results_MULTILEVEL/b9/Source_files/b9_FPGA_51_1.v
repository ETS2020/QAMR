...
module FAU ( 
  ...
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | ~x04 | (~x02 & x27);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = (~x08 & (~x02 | (x04 & ~x27))) | ~new_n72_ | (~x02 & (x27 | ~x29));
  assign new_n72_ = new_n66_ & (new_n73_ | ~x04);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (~x21 & (x02 | ~x27)) | (x02 & x27 & (~x28 | ~x35)) | (~x27 & ~x37);
  assign z04 = (x02 & x27 & (~x28 | ~x35)) | (~x27 & ~x37) | (x21 & (x02 | ~x27));
  assign z06 = ~x37 & (~x27 | (x02 & ~x28));
  assign z07 = (~x02 & x27) | (~new_n78_ & x03);
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & ((x00 & ~x25) | ~x38);
  assign z08 = x39 & x40 & (x02 | ~x27);
  assign z09 = x34 & x27 & x26 & x02 & x11;
  assign z10 = new_n85_ | (~x04 & (new_n84_ | (x05 & new_n83_ & x39)));
  assign new_n83_ = x40 & ((x02 & ((~new_n70_ & x27) | x30 | x32)) | (~x27 & (x30 | x32)));
  assign new_n84_ = x02 & x07 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n85_ = x02 & x06 & x27 & x37;
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | ((new_n73_ | (~x02 & x27)) & (~x02 | ~x04 | ~x27))) & (x08 | (x27 & (~x02 | (new_n73_ & ~x04))));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | ((~new_n66_ | x04) & (~x27 | (new_n68_ & x02)));
  assign new_n90_ = ~x10 & (~x27 | (x02 & ~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & x02) | (new_n96_ & ~x04);
  ...
  assign z14 = (~new_n101_ & ~x27) | (x02 & (new_n100_ | (~new_n98_ & ~new_n102_)));
  ...
  assign z18 = ~new_n107_ | (x08 & (new_n88_ | (new_n73_ & ~x27)));
  assign new_n107_ = (~x27 | (x02 & (~new_n73_ | x04))) & ~x09 & ~x30;
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (x08 | (x27 & (~x02 | x35))) & (new_n88_ | ((~x02 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
