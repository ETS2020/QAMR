...
module FAU ( 
  ...
  assign z00 = new_n65_ | ~x16 | (~x15 & x27 & (new_n66_ | ~new_n67_));
  assign new_n65_ = x10 & (~x40 | (~x04 & ~x15 & x39));
  assign new_n66_ = ~x04 & x39 & x40 & (x35 | x36);
  assign new_n67_ = ~x37 & (~x28 | ~x35);
  assign z01 = new_n70_ | ~x04 | (~x30 & ~x32 & (new_n69_ | ~x27));
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign new_n70_ = x10 & ~x40;
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : ~x10;
  ...
  assign z07 = new_n70_ | (x03 & (new_n78_ | (new_n77_ & ~x31)));
  ...
  assign new_n84_ = (~x10 | x40) & (~x06 | ~x27 | ~x37);
  assign z11 = new_n70_ | (~x09 & ~x30 & (new_n88_ | (~new_n86_ & ~new_n87_)));
  assign new_n86_ = x29 & x39 & x40;
  assign new_n87_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n88_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = (~x10 & (new_n90_ | ~x27)) | (~new_n91_ & (new_n67_ | ~x27)) | (~x40 & (new_n67_ | x10));
  assign new_n90_ = ~x35 & ~x36 & ~x37;
  assign new_n91_ = ~x04 & x39;
  assign z13 = new_n95_ | (x27 & ((x40 & (new_n93_ | new_n94_)) | (new_n94_ & ~x10)));
  assign new_n93_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n95_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n98_ & (new_n99_ | ~new_n100_)) | new_n101_ | new_n70_ | (~new_n97_ & ~new_n100_);
  ...
  assign z18 = new_n107_ | (~new_n70_ & (new_n106_ | x09 | x30));
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n107_ = x08 & x29 & x39 & x40;
  assign z19 = ~x09 & ~x30 & ((~new_n109_ & ~x08) | (~new_n87_ & ~new_n110_));
  assign new_n109_ = (x27 | (x10 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n110_ = x40 ? (x29 & x39) : x10;
  assign z20 = new_n70_ | (~x09 & ~x30 & (new_n112_ | new_n113_));
