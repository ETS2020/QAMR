...
module FAU ( 
  ...
  assign new_n82_ = (x36 | (~x28 & x35)) & (new_n66_ ? x05 : x07);
  ...
  assign new_n102_ = ((~x28 & x35) | ((new_n86_ | (~x04 & ~x27)) & (x08 | ~x27))) & (~x04 | (x08 & (new_n86_ | ~x27)));
  assign z20 = (~x04 & ~x27) | (~x09 & ~new_n104_ & ~x30);
  assign new_n104_ = (x08 | (x27 & x35)) & (new_n86_ | (x35 & (x27 | ~x28)));
endmodule
