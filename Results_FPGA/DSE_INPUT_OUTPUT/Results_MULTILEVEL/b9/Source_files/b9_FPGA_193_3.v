...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n73_ | ~new_n68_ | x13;
  ...
  assign new_n89_ = (x27 | (x13 & x40)) & (x13 | (~x04 & ~x28 & x35));
  assign z12 = (~x13 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x40 & (new_n66_ | ~x27));
  ...
  assign new_n96_ = x40 & (x13 | (~x04 & x39 & (x30 | x32)));
  assign z14 = (~new_n98_ & (~x40 | (~new_n92_ & ~x13))) | (new_n99_ & ~x13);
  assign new_n98_ = ~new_n66_ & ~x18 & ~x19 & x20 & x27;
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (~new_n100_ & x28));
  ...
  assign z18 = (~new_n105_ & x08) | ~new_n106_ | new_n69_ | x09;
  assign new_n105_ = (~new_n68_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n106_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n108_ & ~x09;
  assign new_n108_ = ~x30 & (new_n109_ | (~new_n88_ & (~x35 | (~x27 & x28))));
  assign new_n109_ = ~x08 & ((~x13 & (~x27 | ~x35)) | (~x27 & ~x40));
