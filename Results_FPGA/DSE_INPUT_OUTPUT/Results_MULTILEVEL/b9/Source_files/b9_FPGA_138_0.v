...
module FAU ( 
  ...
  assign new_n87_ = (x09 | x27) & (~x06 | ~x27 | ~x37);
  assign z11 = ~x09 & (~x27 | (~x30 & ~new_n90_ & (~new_n89_ | x04)));
  assign new_n89_ = ~x28 & x35;
  assign new_n90_ = x08 & x29 & x39 & x40;
  assign z12 = new_n92_ | new_n79_ | (~new_n93_ & (x04 | ~x39 | ~x40));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n96_ | (new_n95_ & ~x04))) | (new_n97_ & ~x04) | (~x09 & ~x27);
  ...
  assign z18 = ~x27 | x30 | x09 | new_n90_ | (new_n89_ & ~x04);
  assign z20 = ~x09 & (~x27 | (~x30 & ~new_n90_ & ~x35));
  assign z19 = ~x09 & (~x27 | (~x30 & ~new_n90_ & (~new_n89_ | x04)));
endmodule
