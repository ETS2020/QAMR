...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n76_, new_n77_,
    ...
    new_n102_, new_n103_, new_n105_, new_n106_, new_n108_;
  ...
  assign z10 = new_n81_ | (x27 & (new_n80_ | (x06 & ~new_n67_ & x37)));
  assign new_n80_ = ~x04 & ~new_n69_ & ((x05 & x39 & x40) | (x07 & ~x40));
  assign new_n81_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n67_ | (~x09 & ~x30 & (new_n83_ | new_n85_));
  assign new_n83_ = ~new_n84_ & (~x29 | ~x40);
  ...
  assign z13 = new_n93_ | (x27 & (new_n90_ | (new_n92_ & ~x18)));
  assign new_n90_ = x39 & (new_n91_ | (~x18 & ~x19 & ~new_n87_ & x20));
  assign new_n91_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n92_ = ~x19 & x20 & ~new_n87_ & ~x40;
  assign new_n93_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n96_ | (~new_n95_ & (~x40 | (x39 & (x04 | x13))));
  assign new_n95_ = ~new_n87_ & ~x18 & ~x19 & x20 & x27;
  assign new_n96_ = ~x30 & ~x32 & x39 & (~x27 | (~new_n97_ & x28));
  ...
  assign new_n105_ = (new_n106_ | x08) & (new_n84_ | (x40 & (x29 | ~x39)));
  assign new_n106_ = (x27 | (~x39 & x40)) & (~x39 | (~x28 & x35 & (~x04 | ~x40)));
  assign z20 = new_n67_ | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & ((x29 & x40) | ((x27 | ~x28) & x35));
  assign z06 = ~z05;
  assign z08 = x40;
endmodule
