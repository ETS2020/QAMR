...
module FAU ( 
  ...
  assign new_n82_ = ~new_n70_ & ((x07 & (x40 ? ~x39 : ~x01)) | (x05 & x39 & x40));
  ...
  assign z12 = new_n90_ | (x01 & ~x40) | (~new_n91_ & (x04 | ~x39 | ~x40));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n93_ & x27) | new_n68_ | (~x04 & new_n84_ & ~x13);
  ...
  assign new_n99_ = (~x40 | (~new_n100_ & (new_n91_ | new_n98_))) & (x01 | new_n91_ | x40);
  ...
  assign z18 = new_n106_ | (~new_n68_ & (new_n105_ | x09 | x30));
  assign new_n105_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n106_ = x08 & x29 & x39 & x40;
  assign z19 = (x01 & ~x40) | (~x09 & ~x30 & (~new_n108_ | (~new_n111_ & ~x01)));
  assign new_n108_ = ~new_n109_ & (new_n110_ | ~x40) & (x08 | ~x28);
  assign new_n109_ = (x28 | (x04 & x27)) & (~x29 | ~x39 | ~x40);
  assign new_n110_ = (x08 | (~x04 & x27 & x35)) & (x35 | (x29 & x39));
  assign new_n111_ = (x35 | x40) & (x08 | x27);
  assign z20 = new_n113_ & ~x09;
  assign new_n113_ = ~x30 & (new_n114_ | (~new_n87_ & (~x35 | (~x27 & x28))));
  assign new_n114_ = ~x08 & ((~x35 & x40) | (~x27 & (~x01 | x40)));
  assign z06 = ~z05;
endmodule
