...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n99_, new_n100_, new_n105_, new_n107_, new_n109_;
  ...
  assign z11 = (~x16 & x27) | (~x09 & ~new_n87_ & ~x30);
  ...
  assign new_n105_ = ~x09 & ~x30 & (~x27 | (x16 & (~new_n73_ | x04)));
  assign z19 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (new_n88_ | ((new_n73_ | (~x16 & x27)) & (~x04 | ~x16 | ~x27))) & (x08 | (x27 & (~x16 | (new_n73_ & ~x04))));
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (x08 | (x27 & (~x16 | x35))) & (new_n88_ | ((~x16 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
endmodule
