...
module FAU ( 
  ...
  assign z12 = new_n92_ | ((~new_n66_ | x04) & (x27 ? new_n68_ : ~x19));
  ...
  assign new_n99_ = ~new_n100_ & new_n66_ & ~x04 & ~x13;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = (~x19 | x27) & ((new_n66_ & ~x04 & ~x13) | (~new_n68_ & x27));
  ...
  assign z19 = (x19 & ~x27) | (~x09 & ~x30 & (new_n88_ | (~new_n110_ & ~x19)));
  assign new_n110_ = (x08 | x27) & (new_n90_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n112_ & ~x30;
  assign new_n112_ = (x08 | (x27 ? x35 : x19)) & (new_n90_ | ((~x27 | x35) & (x19 | (x35 & (x27 | ~x28)))));
endmodule
