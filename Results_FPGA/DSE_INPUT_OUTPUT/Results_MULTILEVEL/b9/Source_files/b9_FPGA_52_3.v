...
module FAU ( 
  ...
  assign z06 = (x18 & x27) | (~x37 & (~x27 | ~x28));
  ...
  assign z10 = (~new_n84_ & ~x04) | (x27 & (x18 | (x06 & x37)));
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n70_ | (new_n66_ ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | ((new_n73_ | (x18 & x27)) & (~x04 | x18 | ~x27))) & (x08 | (x27 & (x18 | (new_n73_ & ~x04))));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | (x18 & x27) | ((~new_n66_ | x04) & (new_n68_ | ~x27));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & ~x18) | (~x04 & ~x13 & new_n85_ & ~x27);
  ...
  assign z14 = (~new_n97_ & (x19 | ~x20)) | ~new_n99_ | new_n100_;
  ...
  assign new_n106_ = ~x28 & x35 & ((~x04 & ~x18 & x27) | (x08 & ~x27));
  assign z19 = (x18 & x27) | (~x09 & ~x30 & (new_n108_ | new_n109_));
  assign new_n108_ = ~new_n88_ & ((~x35 & (~x18 | ~x27)) | x28 | (x04 & x27));
  assign new_n109_ = ~x08 & (x04 | ~x27 | x28 | (~x18 & ~x35));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 & (x18 | x35))) & (new_n88_ | ((x18 | x35) & (x27 | (~x28 & x35))));
endmodule
