...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n73_, new_n79_,
    ...
    new_n100_, new_n101_, new_n106_, new_n108_, new_n110_, new_n111_;
  ...
  assign z18 = (~new_n106_ & x08) | (~x09 & (new_n88_ | x30)) | (x09 & x40);
  assign new_n106_ = (~z08 | ~x29) & (x09 | x27 | x28 | ~x35);
  assign z19 = (x09 & ~x40) | (~x30 & (new_n108_ | (~x08 & ~new_n88_ & ~x09)));
  assign new_n108_ = ~new_n87_ & (~x40 | (~x09 & (~x29 | ~x39)));
  assign z20 = (x09 & ~x40) | (~x30 & ((~new_n111_ & ~x09) | (~new_n110_ & ~x40)));
  assign new_n110_ = x35 & (x27 | ~x28);
  assign new_n111_ = (x08 | (x27 & x35)) & ((x29 & x39) | (x35 & (x27 | ~x28)));
endmodule
