...
module FAU ( 
  ...
  assign z12 = new_n89_ | (x19 & x27) | ((~new_n66_ | x04) & (new_n68_ | ~x27));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n91_ & ~x19) | (~x04 & ~x13 & new_n85_ & ~x27);
  ...
  assign z14 = (~new_n96_ & (x18 | ~x20)) | ~new_n98_ | new_n99_;
  ...
  assign new_n105_ = ~x28 & x35 & ((~x04 & ~x19 & x27) | (x08 & ~x27));
  assign z20 = (x19 & x27) | (~x09 & ~new_n107_ & ~x30);
  assign new_n107_ = (x08 | (x27 & x35)) & ((new_n66_ & x29) | (x35 & (x27 | ~x28)));
  assign z19 = (x19 & x27) | (~x09 & ~new_n87_ & ~x30);
endmodule
