...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n76_, new_n77_, new_n78_,
    new_n82_, new_n84_, new_n86_, new_n88_, new_n90_, new_n91_, new_n96_,
  ...
  assign z19 = new_n76_ | (~x09 & ~x30 & (~x08 | (~new_n98_ & ~new_n99_)));
  assign new_n98_ = x29 & x39 & x40;
  assign new_n99_ = (x27 | (~x28 & x35)) & ~x27 & (~x04 | x35);
  assign z20 = ~x09 & ~x30 & (new_n101_ | (~new_n98_ & ~new_n102_));
