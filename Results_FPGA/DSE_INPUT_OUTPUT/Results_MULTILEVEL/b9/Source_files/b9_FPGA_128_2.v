...
module FAU ( 
  ...
  assign new_n72_ = (x27 | (~x13 & (~x04 | x08))) & new_n66_ & (new_n73_ | ~x04);
  ...
  assign z10 = (~new_n84_ & ~x04) | (x13 & ~x27) | (x06 & x27 & x37);
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n70_ | (new_n66_ ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = (~x27 & (x13 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n87_ & ~x30);
  ...
  assign z13 = (x27 & (new_n94_ | (~x04 & new_n93_ & ~x13))) | (~x04 & new_n85_ & ~x13);
  assign new_n93_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n98_ | new_n101_ | (~new_n96_ & (x18 | x19 | ~x20));
  assign new_n96_ = x13 ? ~x27 : (new_n91_ & ~new_n97_);
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x37 & (new_n100_ | (~new_n99_ & (~x28 | ~x35)));
  assign new_n99_ = x13 ? ~x27 : (~x04 & x39 & x40);
  assign new_n100_ = ~x13 & x28 & ~x30 & ~x32 & ~x35;
  assign new_n101_ = ~x13 & ~x27 & (~new_n66_ | x04 | (~x30 & ~x32));
  ...
  assign new_n106_ = ~x09 & (~x13 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = (x13 & ~x27) | (~x09 & ~x30 & ((new_n108_ & x27) | (~new_n109_ & ~x13)));
  assign new_n108_ = (~new_n73_ | x04) & (~new_n66_ | ~x08 | ~x29);
  assign new_n109_ = (x08 | x27) & (new_n88_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 ? x35 : x13)) & (new_n88_ | ((~x27 | x35) & (x13 | (x35 & (x27 | ~x28)))));
endmodule
