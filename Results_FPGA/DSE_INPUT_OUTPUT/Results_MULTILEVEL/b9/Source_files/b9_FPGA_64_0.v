...
module FAU ( 
  ...
  assign z11 = (~x27 & (~x22 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (x08 | (new_n73_ & ~x04)) & ((new_n68_ & x29) | (new_n73_ & (~x04 | ~x27)));
  assign z12 = new_n89_ | ((x27 ? new_n66_ : x22) & (~new_n68_ | x04));
  assign new_n89_ = ~x10 & ((x22 & ~x27) | (~x36 & ~x37 & x27 & ~x35));
  assign z13 = (~new_n91_ & x27) | (~x22 & ~x27) | (~x04 & new_n85_ & ~x13);
  ...
  assign new_n96_ = (x22 | x27) & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = new_n103_ | (~new_n102_ & (x22 | x27));
  assign new_n102_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n103_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x22 & ~x27));
  assign z19 = ~x09 & ~x30 & ((~new_n106_ & x22) | (new_n105_ & x27));
  assign new_n105_ = (~new_n73_ | x04) & (~new_n68_ | ~x08 | ~x29);
  assign new_n106_ = (x08 | x27) & (new_n73_ | (new_n68_ & x29));
