...
module FAU ( 
  ...
  assign new_n82_ = ((~new_n69_ & ~x36) | (new_n66_ ? ~x05 : ~x07)) & (~new_n83_ | ~x05);
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = (~x04 & ~x27) | (~x09 & ~new_n85_ & ~x30);
  assign new_n85_ = (x08 | (new_n69_ & ~x04)) & (new_n86_ | (new_n69_ & (~x04 | ~x27)));
  ...
  assign z19 = ~x09 & ~x30 & ((~new_n103_ & x27) | (~new_n104_ & x04));
  assign new_n103_ = ((~x28 & x35) | (new_n66_ & x08 & x29)) & (~x04 | (new_n66_ & x29));
  assign new_n104_ = x08 & (new_n86_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (x08 | (x27 ? x35 : ~x04)) & (new_n86_ | ((~x27 | x35) & (~x04 | (x35 & (x27 | ~x28)))));
endmodule
