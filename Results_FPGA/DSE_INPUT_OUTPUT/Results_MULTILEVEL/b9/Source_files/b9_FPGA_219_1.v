...
module FAU ( 
  ...
  assign z19 = ~x09 & ~x30 & (new_n97_ | (~new_n96_ & (x04 | ~x27)));
  assign new_n96_ = x08 & (x35 | (x29 & x39 & x40));
  assign new_n97_ = (~x29 | ~x39 | ~x40) & (x27 ? x04 : x28);
  assign z20 = ~x09 & ~x30 & (new_n99_ | (~new_n100_ & (~new_n65_ | ~x29)));
