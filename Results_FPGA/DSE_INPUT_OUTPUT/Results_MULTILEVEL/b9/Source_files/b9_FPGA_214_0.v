...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & (x21 | x27)) | (x21 & ~x27 & x04 & ~x08);
  ...
  assign z05 = x37 | (~x21 & ~x27) | (x27 & x28);
  assign z06 = ~x37 & (x27 ? ~x28 : x21);
  assign z07 = (~x21 & ~x27) | (~new_n79_ & x03);
  ...
  assign z15 = (~x21 & ~x27) | (x12 & x26 & x27 & x34);
  assign z16 = (~x21 & ~x27) | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~x24 & (x21 | x27);
  assign z18 = new_n106_ | (~new_n105_ & (x21 | x27));
  assign new_n105_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n106_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x21 & ~x27));
  assign z19 = (~x21 & ~x27) | (~x09 & ~x30 & (new_n87_ | (~new_n108_ & x21)));
  assign new_n108_ = (x08 | x27) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : ~x21)) & (new_n89_ | ((~x27 | x35) & (~x21 | (x35 & (x27 | ~x28)))));
endmodule
