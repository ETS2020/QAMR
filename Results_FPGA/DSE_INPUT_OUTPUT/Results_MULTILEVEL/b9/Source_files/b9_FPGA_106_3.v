...
module FAU ( 
  ...
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | ~x04 | (x27 & x33);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = (~x04 | (new_n73_ & (x08 | x27))) & new_n68_ & (~x27 | ~x33);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (x27 & (~x28 | x33 | ~x35)) | ~x21 | (~x27 & ~x37);
  assign z04 = (x21 & (~x27 | ~x33)) | (~x27 & ~x37) | (x27 & ~x33 & (~x28 | ~x35));
  assign z05 = x37 | (x27 & (x28 | x33));
  assign z06 = (x27 & x33) | (~x37 & (~x27 | ~x28));
  ...
  assign z13 = (~new_n92_ & ~x33) | (~x04 & ~x13 & new_n85_ & ~x27);
  ...
  assign z14 = (~x33 & (new_n99_ | (~new_n97_ & ~new_n101_))) | (~new_n100_ & ~x27);
  ...
  assign z18 = new_n107_ | (~new_n106_ & (~x27 | ~x33));
  assign new_n106_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n107_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & x27 & ~x33));
  assign z19 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (new_n88_ | ((new_n73_ | (x27 & x33)) & (~x04 | ~x27 | x33))) & (x08 | (x27 & (x33 | (new_n73_ & ~x04))));
