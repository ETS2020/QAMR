...
module FAU ( 
  ...
  assign z07 = (x04 & x27) | (~new_n75_ & x03);
  ...
  assign z10 = ~x04 & (new_n81_ | (x27 & (new_n80_ | (x06 & x37))));
  assign new_n80_ = (x36 | (~x28 & x35)) & (new_n66_ ? x05 : x07);
  assign new_n81_ = new_n82_ & x05;
  assign new_n82_ = x39 & x40 & (x30 | x32);
  assign z11 = (x04 & x27) | (~x09 & ~x30 & (new_n84_ | (~x08 & ~x27)));
  assign new_n84_ = (x28 | ~x35) & (~new_n66_ | ~x08 | ~x29);
  assign z12 = (~x10 & (new_n86_ | ~x27)) | (~new_n66_ & (~x27 | (new_n87_ & ~x04))) | (x04 & ~x27);
  assign new_n86_ = ~x04 & ~x35 & ~x36 & ~x37;
  assign new_n87_ = ~x37 & (~x28 | ~x35);
  assign z13 = ~x04 & ((x27 & (new_n89_ | (new_n90_ & ~x13))) | (new_n82_ & ~x13));
  assign new_n89_ = ~x18 & ~x19 & ~new_n87_ & x20;
  assign new_n90_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ((~new_n66_ | x13) & (~x27 | (~new_n92_ & ~x04))) | new_n93_ | (x04 & ~x27);
  assign new_n92_ = ~new_n87_ & ~x18 & ~x19 & x20;
  ...
  assign z18 = ~new_n100_ | (x08 & (new_n99_ | (~x28 & x35)));
  assign new_n99_ = x29 & x39 & x40;
  assign new_n100_ = (~x27 | (~x04 & (x28 | ~x35))) & ~x09 & ~x30;
  assign z19 = ~x09 & ~new_n102_ & ~x30;
  assign new_n102_ = (x08 | x27) & ((~x28 & x35) | ((new_n99_ | (x04 & x27)) & (x04 | x08)));
  assign z20 = (x04 & x27) | (~x09 & ~new_n104_ & ~x30);
  assign new_n104_ = (x08 | (x27 & (x04 | x35))) & (new_n99_ | ((x04 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
endmodule
