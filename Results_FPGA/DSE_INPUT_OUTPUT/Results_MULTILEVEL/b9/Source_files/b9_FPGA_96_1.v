...
module FAU ( 
  ...
  assign new_n87_ = ((new_n68_ & x29) | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
  assign z12 = new_n89_ | ((~new_n68_ | x04) & (~x27 | (new_n66_ & x20)));
  assign new_n89_ = ~x10 & (~x27 | (x20 & ~x35 & ~x36 & ~x37));
  assign z13 = (x20 & (new_n91_ | (~x04 & new_n93_ & ~x13))) | (~x04 & new_n94_ & ~x13);
  assign new_n91_ = x27 & ((new_n92_ & ~x04) | (~x18 & ~new_n66_ & ~x19));
  assign new_n92_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = new_n85_ & x28;
  assign new_n94_ = new_n85_ & ~x27;
  assign z14 = new_n99_ | (x20 & (new_n98_ | (~new_n96_ & (x18 | x19))));
  ...
  assign new_n99_ = ~x27 & (x04 | x13 | ~new_n68_ | (~x30 & ~x32));
  assign z15 = x27 & (~x20 | (x12 & x26 & x34));
  assign z16 = (~x20 & x27) | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~x24 & (x20 | ~x27);
  assign z18 = ~new_n104_ | (x08 & ((new_n73_ & ~x27) | (new_n68_ & x29)));
