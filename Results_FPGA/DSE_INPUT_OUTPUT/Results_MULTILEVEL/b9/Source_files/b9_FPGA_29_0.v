...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n90_ | (~new_n91_ & (new_n66_ | ~x27)))) | (x36 & ~x40 & (new_n66_ | ~x27));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n91_ = ~x04 & x39;
  assign z13 = (x27 & (new_n93_ | (new_n94_ & ~x04))) | new_n68_ | (new_n95_ & ~x04);
  assign new_n93_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n98_ | (~new_n97_ & (x04 | x13 | ~x39 | ~x40));
  ...
  assign z18 = new_n105_ | (~new_n68_ & (new_n104_ | x09 | x30));
  assign new_n104_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n105_ = x08 & x29 & x39 & x40;
  assign z19 = new_n68_ | (~x09 & ~new_n107_ & ~x30);
  assign new_n107_ = (new_n108_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n108_ = x29 & x39 & x40;
  assign z20 = new_n68_ | (new_n110_ & ~x09);
  assign new_n110_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n108_ & (~x35 | (~x27 & x28))));
  assign z06 = ~z05;
endmodule
