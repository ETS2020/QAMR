...
module FAU ( 
  ...
  assign z03 = (~x21 & (~x23 | x27)) | (x27 & (~x28 | ~x35)) | (~x23 & ~x27 & ~x37);
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | (~x27 & (x23 | ~x37));
  ...
  assign new_n100_ = (~x23 | x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign z19 = (x23 & ~x27) | (~x09 & ~x30 & (new_n88_ | (~new_n109_ & ~x23)));
  assign new_n109_ = (x08 | x27) & (new_n90_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 ? x35 : x23)) & (new_n90_ | ((~x27 | x35) & (x23 | (x35 & (x27 | ~x28)))));
endmodule
