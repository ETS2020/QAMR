...
module FAU ( 
  ...
  assign z02 = (~new_n73_ & (~x06 | ~x27)) | (x04 & ~x08 & ~x27);
  ...
  assign z10 = (x06 & x27) | (~x04 & ((new_n83_ & x27) | (new_n84_ & x05)));
  assign new_n83_ = (new_n71_ | x36) & (new_n66_ ? x05 : x07);
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = (new_n87_ | ((new_n71_ | (x06 & x27)) & (~x04 | x06 | ~x27))) & (x08 | (x27 & (x06 | (new_n71_ & ~x04))));
