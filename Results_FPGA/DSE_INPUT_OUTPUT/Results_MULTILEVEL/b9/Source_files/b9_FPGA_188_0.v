...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x03;
  ...
  assign new_n86_ = x40 ? (x29 & x39) : ~x03;
  assign new_n87_ = (x27 | (~x03 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (x03 & ~new_n66_ & ~x40);
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n91_ | (~x04 & new_n93_ & ~x13))) | (~x04 & new_n83_ & ~x13);
  assign new_n91_ = ~x18 & new_n92_ & ~x19;
  assign new_n92_ = x20 & (x03 | x40) & (x37 | (x28 & x35));
  ...
  assign new_n97_ = ~new_n65_ & (new_n66_ | (z08 & ~x04 & ~x13));
