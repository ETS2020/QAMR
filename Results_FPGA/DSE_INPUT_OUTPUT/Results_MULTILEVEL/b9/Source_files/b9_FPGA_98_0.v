...
module FAU ( 
  ...
  assign new_n82_ = (~x07 | (x40 ? x39 : ~x38)) & (~x05 | ~x39 | ~x40);
  ...
  assign z12 = new_n88_ | (~x38 & ~x40) | (~new_n66_ & (x04 | ~x39 | ~x40));
  assign new_n88_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (~new_n90_ & x27);
  assign new_n90_ = (x18 | ~new_n93_ | x19) & (~x40 | (~new_n91_ & (x18 | ~new_n92_ | x19)));
  assign new_n91_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n92_ = x20 & (x37 | (x28 & x35));
  assign new_n93_ = x20 & x38 & (x37 | (x28 & x35));
  ...
  assign new_n105_ = ~new_n86_ & (x27 | x28 | ~x35);
  assign new_n106_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = ~x09 & ~x30 & (new_n108_ | (~new_n110_ & ~x08));
  assign new_n108_ = ~new_n109_ & (x40 ? (~x29 | ~x39) : x38);
  assign new_n109_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n110_ = (x27 | (~x38 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z20 = new_n65_ | (new_n112_ & ~x09);
  assign new_n112_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n86_ & (~x35 | (~x27 & x28))));
  assign z05 = ~z06;
endmodule
