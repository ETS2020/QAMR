...
module FAU ( 
  ...
  assign new_n86_ = ((z08 & x29) | (new_n74_ & (~x04 | ~x27))) & (x08 | (new_n74_ & ~x04 & x27));
  assign z12 = new_n88_ | (~x39 & ~x40) | ((new_n66_ | ~x27) & (x04 | ~x39 | ~x40));
  assign new_n88_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n93_ | (x27 & (new_n90_ | (new_n92_ & ~x18)));
  assign new_n90_ = x39 & (new_n91_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n91_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n92_ = ~x19 & x20 & ~new_n66_ & x40;
  assign new_n93_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n95_ & (x18 | x19 | ~x20)) | ~new_n97_ | new_n98_;
  assign new_n95_ = ~new_n96_ & z08 & ~x04 & ~x13;
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = (x39 | x40) & ((~new_n66_ & x27) | (x39 & x40 & ~x04 & ~x13));
  ...
  assign z19 = ~x09 & ~x30 & (new_n107_ | (~new_n106_ & ~x08));
  assign new_n106_ = (x27 | (~x39 & ~x40)) & (~x39 | (new_n74_ & ~x04));
  assign new_n107_ = (~new_n74_ | (x04 & x27)) & (x39 ? (~x29 | ~x40) : x40);
  assign z20 = new_n69_ | (~x09 & ~new_n109_ & ~x30);
  assign new_n109_ = (x08 | (x27 & x35)) & ((z08 & x29) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
endmodule
