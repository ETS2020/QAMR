...
module FAU ( 
  ...
  assign new_n88_ = (x08 | (~x04 & ~x28 & x35)) & (new_n89_ | (~x28 & x35 & (~x04 | ~x27)));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | ((~new_n66_ | x04) & (x27 ? new_n68_ : x13));
  assign new_n91_ = ~x10 & ((x13 & ~x27) | (x27 & ~x35 & ~x36 & ~x37));
  assign z13 = x27 & (new_n93_ | (~x04 & ~x13 & new_n94_ & x39));
  assign new_n93_ = ~x18 & ~x19 & ~new_n68_ & x20;
  assign new_n94_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign z14 = (~new_n96_ & (x18 | x19 | ~x20)) | new_n98_ | ~x27;
  ...
  assign new_n104_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x13 & ~x27));
  assign z19 = (~x13 & ~x27) | (~x09 & ~x30 & ((new_n106_ & x27) | (~new_n107_ & x13)));
  assign new_n106_ = (x04 | x28 | ~x35) & (~new_n66_ | ~x08 | ~x29);
  assign new_n107_ = (x08 | x27) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (x08 | (x27 ? x35 : ~x13)) & (new_n89_ | ((~x27 | x35) & (~x13 | (x35 & (x27 | ~x28)))));
endmodule
