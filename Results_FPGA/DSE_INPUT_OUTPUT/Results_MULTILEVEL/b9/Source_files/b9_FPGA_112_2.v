...
module FAU ( 
  ...
  assign z05 = (x27 & (x28 | x37)) | (~x13 & x37);
  ...
  assign new_n98_ = ~new_n99_ & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign new_n104_ = ~x09 & (~x13 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = (~x27 & (x13 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n106_ & ~x30);
