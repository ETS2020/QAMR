...
module FAU ( 
  ...
  assign new_n91_ = ~x10 & ((x20 & ~x27) | (~x36 & ~x37 & x27 & ~x35));
  assign z13 = (x27 & (new_n93_ | (new_n94_ & ~x04))) | (~x20 & ~x27) | (new_n95_ & ~x04);
  ...
  assign new_n106_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x20 & ~x27));
  assign z19 = (~x20 & ~x27) | (~x09 & ~x30 & ((new_n108_ & x27) | (~new_n109_ & x20)));
  assign new_n108_ = (x04 | x28 | ~x35) & (~new_n66_ | ~x08 | ~x29);
  assign new_n109_ = (x08 | x27) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 ? x35 : ~x20)) & (new_n89_ | ((~x27 | x35) & (~x20 | (x35 & (x27 | ~x28)))));
endmodule
