...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n76_, new_n77_, new_n78_,
    new_n82_, new_n84_, new_n86_, new_n88_, new_n90_, new_n91_, new_n97_,
  ...
  assign z17 = new_n76_ | (x23 & ~x24 & x01 & x22);
  assign z18 = (~new_n84_ & x08) | x09 | new_n76_ | x30;
  assign z19 = new_n76_ | (~x09 & ~x30 & (~x08 | (~new_n97_ & ~new_n98_)));
