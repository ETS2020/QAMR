...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n79_, new_n80_, new_n84_, new_n86_, new_n87_, new_n89_, new_n91_,
  ...
  assign new_n84_ = (~x27 | new_n70_ | (new_n73_ ? ~x05 : ~x07)) & (~new_n73_ | ~x05 | ~x32);
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = (new_n87_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = (~x30 & (new_n89_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n95_ | (~new_n91_ & x27);
  assign new_n91_ = (~new_n94_ | x18) & (x30 | ((~new_n92_ | x04) & (~new_n93_ | x18)));
  assign new_n92_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n94_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign new_n95_ = ~x04 & ~x13 & ~x30 & new_n73_ & x32;
  assign z14 = (~new_n98_ & (~new_n97_ | new_n99_)) | new_n100_ | new_n67_ | (~new_n97_ & ~new_n68_);
  assign new_n97_ = new_n73_ & ~x04 & ~x13;
