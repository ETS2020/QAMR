...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x30 & (x13 | (~x32 & (new_n71_ | ~x27))));
  ...
  assign z10 = (new_n86_ & ~x04) | (x27 & (new_n85_ | (~x04 & ~new_n84_ & ~new_n71_)));
  assign new_n84_ = (~x07 | new_n68_ | (x13 & ~x30)) & (~new_n68_ | ~x05 | x13);
  assign new_n85_ = x06 & ~new_n69_ & x37;
  assign new_n86_ = x05 & x39 & x40 & (x30 | (~x13 & x32));
  assign z11 = ~x30 & (x13 | (~new_n88_ & ~x09));
  assign new_n88_ = (new_n89_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | new_n69_ | (~new_n92_ & (~new_n68_ | x04));
  ...
  assign new_n101_ = (x30 | (~new_n102_ & ~x13)) & (new_n92_ | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = (~new_n107_ & x08) | ~new_n108_ | x09 | x13;
  assign new_n107_ = ~new_n89_ & (x27 | x28 | ~x35);
  assign new_n108_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = ~x09 & ~x13 & ~new_n88_ & ~x30;
  assign z20 = ~x30 & (x13 | (~new_n111_ & ~x09));
