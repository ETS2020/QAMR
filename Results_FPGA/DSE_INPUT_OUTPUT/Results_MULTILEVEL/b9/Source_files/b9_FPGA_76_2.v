...
module FAU ( 
  ...
  assign z00 = new_n65_ | (~x15 & x27 & (new_n68_ | new_n69_ | x37));
  assign new_n65_ = ~new_n67_ & (~x16 | (~x04 & x10 & new_n66_ & ~x15));
  ...
  assign new_n73_ = (new_n74_ | ~x04) & new_n66_ & ~new_n67_;
  ...
  assign z13 = (new_n94_ & ~x18) | (~x04 & ~x13 & new_n92_ & x39);
  assign new_n92_ = x40 & (((x30 | x32) & (~x02 | x27)) | (~new_n93_ & x27));
