...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x29 | (~x08 & x40))) | (~new_n72_ & x40) | (~x29 & ~x40);
  ...
  assign z08 = x40 ? x39 : x29;
  assign z09 = x11 & x26 & x27 & ~new_n68_ & x34;
  assign z10 = (x27 & (new_n82_ | (~x04 & ~new_n70_ & ~new_n83_))) | (new_n84_ & ~x04);
  ...
  assign z12 = (x40 & (new_n91_ | (~new_n90_ & (x04 | ~x39)))) | (~x29 & ~new_n90_ & ~x40);
  ...
  assign new_n95_ = ~x19 & x20 & ~new_n66_ & ~x29;
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n98_ & (new_n99_ | ~new_n100_)) | new_n101_ | new_n68_ | (~new_n90_ & ~new_n100_);
