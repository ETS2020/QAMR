...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (~x14 | x27)) | (~x15 & ~new_n67_ & x27);
  ...
  assign z02 = (~new_n72_ & (~x14 | x27)) | (~x14 & ~x27 & x04 & ~x08);
  assign new_n72_ = (x02 | (x08 & x29)) & new_n66_ & (new_n73_ | ~x04);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (x27 & (~x28 | ~x35)) | ~x21 | (~x27 & (x14 | ~x37));
  assign z04 = (~x14 & (x21 | (~x27 & ~x37))) | (x27 & (x21 | ~x28 | ~x35));
  assign z05 = x37 | (x14 & ~x27) | (x27 & x28);
  assign z06 = ~x37 & (x27 ? ~x28 : ~x14);
  ...
  assign z09 = (x14 & ~x27) | (x27 & x34 & x11 & x26);
  assign z10 = (~new_n84_ & ~x04) | (x14 & ~x27) | (x06 & x27 & x37);
  assign new_n84_ = (~x27 | new_n70_ | (new_n66_ ? ~x05 : ~x07)) & (~new_n85_ | ~x05);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((new_n87_ & x27) | (~new_n88_ & ~x14));
  assign new_n87_ = (~new_n73_ | x04) & (~new_n66_ | ~x08 | ~x29);
  assign new_n88_ = (x08 | x27) & (new_n73_ | (new_n66_ & x29));
  assign z12 = new_n90_ | ((~new_n66_ | x04) & (x27 ? new_n68_ : ~x14));
  assign new_n90_ = ~x10 & ((~x14 & ~x27) | (x27 & ~x35 & ~x36 & ~x37));
  assign z13 = (~x04 & ~x13 & new_n92_ & x39) | (new_n94_ & ~x18);
  assign new_n92_ = x40 & (((x30 | x32) & (~x14 | x27)) | (~new_n93_ & x27));
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x19 & x20 & ~new_n68_ & x27;
  assign z14 = (x27 & (new_n98_ | (~new_n96_ & ~new_n100_))) | (~x14 & ~new_n99_ & ~x27);
  ...
  assign new_n105_ = ~x09 & (~x14 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z20 = (x14 & ~x27) | (~x09 & ~new_n107_ & ~x30);
  assign new_n107_ = (x08 | (x27 & x35)) & ((new_n66_ & x29) | (x35 & (x27 | ~x28)));
  assign z19 = ~x09 & ~x30 & ((new_n87_ & x27) | (~new_n88_ & ~x14));
endmodule
