...
module FAU ( 
  ...
  assign new_n85_ = (x04 | x08) & (new_n86_ | (x04 & x27));
  ...
  assign z14 = ~new_n96_ | (~new_n94_ & (~new_n66_ | x13));
  assign new_n94_ = new_n95_ & (x37 | (x28 & x35));
  ...
  assign new_n104_ = (x08 | (x27 & (x04 | x35))) & (new_n86_ | ((x04 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
  assign z19 = ~x09 & ~x30 & ((~new_n85_ & ~new_n71_) | (~x08 & ~x27));
endmodule
