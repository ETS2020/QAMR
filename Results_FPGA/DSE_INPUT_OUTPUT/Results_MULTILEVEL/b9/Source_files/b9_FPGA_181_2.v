...
module FAU ( 
  ...
  assign new_n86_ = (~new_n72_ | ~x08 | ~x29) & (~new_n70_ | x04);
  assign z12 = new_n88_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n88_ = (~x27 | (~x37 & (~x28 | ~x35))) & (~new_n72_ | x04);
  ...
  assign new_n105_ = (~x27 | (new_n70_ & ~x04) | (new_n72_ & x08 & x29)) & (x04 | ((x08 | x27) & (new_n70_ | (new_n72_ & x29))));
