...
module FAU ( 
  ...
  assign z10 = (~new_n84_ & ~x04) | (x27 & (x14 | (x06 & x37)));
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n70_ | (new_n68_ ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | ((new_n73_ | (x14 & x27)) & (~x04 | x14 | ~x27))) & (x08 | (x27 & (x14 | (new_n73_ & ~x04))));
  ...
  assign new_n92_ = ~x14 & (x18 | x19 | new_n66_ | ~x20);
  assign new_n93_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (~new_n98_ & ~x27) | (~x14 & (new_n97_ | (~new_n95_ & ~new_n99_)));
  ...
  assign z20 = (x14 & x27) | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = (x08 | (x27 & x35)) & (new_n88_ | (x35 & (x27 | ~x28)));
