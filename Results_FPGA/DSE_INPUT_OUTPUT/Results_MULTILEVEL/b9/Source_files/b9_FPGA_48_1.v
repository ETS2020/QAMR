...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n76_, new_n77_, new_n78_,
    ...
    new_n97_, new_n99_, new_n100_, new_n102_, new_n103_;
  ...
  assign z19 = ~x09 & ~x30 & (new_n100_ | (~new_n76_ & ~new_n99_));
  assign new_n99_ = x08 & (x35 | (x29 & x39 & x40));
  assign new_n100_ = (~x29 | ~x39 | ~x40) & (x27 ? x04 : x28);
  assign z20 = ~x09 & ~x30 & (new_n102_ | (~new_n84_ & ~new_n103_));
  assign new_n102_ = ~x08 & (~x27 | (x04 & ~x35));
  assign new_n103_ = (~x04 | x35) & (x27 | (~x28 & x35));
endmodule
