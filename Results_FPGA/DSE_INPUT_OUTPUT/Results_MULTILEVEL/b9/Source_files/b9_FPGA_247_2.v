...
module FAU ( 
  ...
  assign z00 = (~x16 & (~x04 | x27)) | (~new_n65_ & ~x15);
  ...
  assign z02 = (x27 & (new_n72_ | ~new_n71_ | (~new_n69_ & x04))) | (~x04 & (~new_n71_ | new_n72_));
  ...
  assign new_n83_ = (new_n69_ | x36) & (new_n71_ ? x05 : x07);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = (~x27 | (new_n69_ & ~x04) | (new_n71_ & x08 & x29)) & (x04 | ((new_n69_ | (new_n71_ & x29)) & (x08 | x27)));
  assign z12 = (x27 & ~new_n88_ & ~x37) | (~x04 & ~x27 & (~new_n71_ | ~x10));
  assign new_n88_ = ((x28 & x35) | (new_n71_ & ~x04)) & (x10 | x35 | x36);
  assign z13 = (~x18 & new_n92_ & ~x19) | (new_n90_ & ~x04) | (x04 & ~x27);
  assign new_n90_ = ~x13 & x39 & x40 & (new_n91_ | x30 | x32);
  assign new_n91_ = x27 & (~x28 | (x35 & x36));
  assign new_n92_ = x20 & (x04 | x27) & (x37 | (x28 & x35));
  assign z14 = new_n96_ | new_n99_ | (~new_n94_ & (x18 | x19 | ~x20));
  assign new_n94_ = x04 ? ~x27 : (~new_n95_ & new_n71_ & ~x13);
  assign new_n95_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = ~x37 & (new_n98_ | (~new_n97_ & (~x28 | ~x35)));
  assign new_n97_ = x04 ? ~x27 : (~x13 & x39 & x40);
  assign new_n98_ = ~x04 & x28 & ~x30 & ~x32 & ~x35;
  assign new_n99_ = ~x04 & ~x27 & (~new_n71_ | x13 | (~x30 & ~x32));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = (x04 & ~x27) | (x01 & x22 & ~x23);
  assign z17 = (x04 & ~x27) | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n104_ & (~x04 | x27)) | (~x04 & ~x28 & x35 & (x08 | x27));
  assign new_n104_ = ~x09 & ~x30 & (~new_n71_ | ~x08 | ~x29);
  assign z19 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n106_ & ~x30);
  assign new_n106_ = (~new_n69_ | x04) & (~new_n71_ | ~x08 | ~x29);
  assign z20 = (x04 & ~x27) | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & ((new_n71_ & x29) | (x35 & (x27 | ~x28)));
endmodule
