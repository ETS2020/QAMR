...
module FAU ( 
  ...
  assign z02 = ~new_n68_ | new_n73_ | (~x02 & (~x08 | ~x29));
  ...
  assign new_n89_ = (x27 | (x13 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~x13 & ~new_n92_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n94_ & x27) | (x13 & ~x40) | (~x04 & new_n85_ & ~x13);
  ...
  assign new_n97_ = x13 ? ~x40 : (~new_n98_ & ~x04 & x39 & x40);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = x13 ? (new_n92_ | ~x40) : (~new_n100_ & (new_n92_ | (~x04 & x39 & x40)));
  ...
  assign z18 = (~new_n105_ & x08) | ~new_n106_ | new_n69_ | x30;
  ...
  assign new_n109_ = ~x08 & ((~x35 & x40) | (~x27 & (~x13 | x40)));
