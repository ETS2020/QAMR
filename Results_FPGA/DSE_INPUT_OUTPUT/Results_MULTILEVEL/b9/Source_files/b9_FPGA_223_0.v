...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n93_, new_n94_, new_n95_, new_n100_, new_n102_, new_n103_,
    new_n105_;
  ...
  assign new_n82_ = (~new_n83_ | ~x05) & ((~new_n69_ & ~x36) | (new_n66_ ? ~x05 : ~x07));
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n85_ & ~x30;
  assign new_n85_ = (new_n69_ | ((new_n86_ | (~x04 & ~x27)) & (x08 | ~x27))) & (~x04 | (x08 & (new_n86_ | ~x27)));
  assign new_n86_ = x29 & x39 & x40;
  assign z12 = ~x27 | (~x37 & (new_n88_ | (~x10 & ~x35 & ~x36)));
  assign new_n88_ = (~x28 | ~x35) & (~new_n66_ | x04);
  assign z13 = x27 & (new_n90_ | (~x04 & ~x13 & new_n91_ & x39));
  assign new_n90_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n91_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign z14 = (~new_n93_ & (x18 | x19 | ~x20)) | new_n95_ | ~x27;
  assign new_n93_ = new_n94_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = ~x37 & ((~new_n94_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = (~x04 & ~x27) | (x01 & x22 & ~x23);
  assign z17 = (~x04 & ~x27) | (x01 & x22 & x23 & ~x24);
  assign z18 = (~x04 & (new_n69_ | ~x27)) | ~new_n100_ | (x08 & (new_n86_ | (new_n69_ & ~x27)));
  assign new_n100_ = ~x09 & ~x30;
  assign z19 = (~x04 & ~x27) | (~x09 & ~x30 & ((~new_n102_ & x27) | (~new_n103_ & x04)));
  assign new_n102_ = ((~x28 & x35) | (new_n66_ & x08 & x29)) & (~x04 | (new_n66_ & x29));
  assign new_n103_ = x08 & (new_n86_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n105_ & ~x30;
  assign new_n105_ = (x08 | (x27 ? x35 : ~x04)) & (new_n86_ | ((~x27 | x35) & (~x04 | (x35 & (x27 | ~x28)))));
endmodule
