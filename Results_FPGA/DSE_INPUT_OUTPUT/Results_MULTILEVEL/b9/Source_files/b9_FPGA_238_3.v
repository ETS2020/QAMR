...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (~x31 | ~x39)) | (~x04 & ~x15 & ~x31 & new_n67_ & x39);
  ...
  assign new_n69_ = x31 & x39;
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~x39 | (~x31 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  assign new_n72_ = x40 & (~x04 | (~x28 & x35 & (x08 | x27)));
  ...
  assign z07 = (x31 & x39) | (x03 & (new_n79_ | (new_n78_ & ~x31)));
  ...
  assign new_n88_ = x39 & (x31 | (x29 & x40));
  assign new_n89_ = (x27 | (x31 & x39)) & (x31 | (~x04 & ~x28 & x35));
  assign z12 = new_n91_ | (x31 & x39) | (~new_n66_ & (x04 | ~x39 | ~x40));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x27) | (~x04 & ~x13 & new_n85_ & ~x31);
  assign new_n93_ = (x31 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x19 & x20 & ~x39 & (x37 | (x28 & x35));
  assign z14 = (~new_n98_ & (new_n99_ | ~new_n100_)) | new_n101_ | new_n69_ | (~new_n66_ & ~new_n100_);
  ...
  assign z18 = (~new_n106_ & (~x31 | ~x39)) | (x08 & x29 & ~x31 & x39 & x40);
  ...
  assign new_n110_ = ~x08 & ((~x31 & ~x35) | (~x27 & (~x31 | ~x39)));
