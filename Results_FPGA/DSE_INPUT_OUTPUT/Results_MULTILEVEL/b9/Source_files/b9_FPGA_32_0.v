...
module FAU ( 
  ...
  assign z09 = (~x20 & ~x27) | (x27 & x34 & x11 & x26);
  assign z10 = new_n86_ | (~x04 & (new_n85_ | (x05 & new_n84_ & x39)));
  assign new_n84_ = x40 & (((x30 | x32) & (x20 | x27)) | (~new_n70_ & x27));
  assign new_n85_ = x07 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n86_ = x06 & x27 & x37;
  assign z11 = (~x27 & (~x20 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
  ...
  assign z13 = (x27 & (new_n93_ | (new_n94_ & ~x04))) | (new_n95_ & ~x04) | (~x20 & ~x27);
  assign new_n93_ = ~x18 & ~x19 & ~new_n68_ & x20;
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (x27 & (new_n99_ | (~new_n97_ & ~new_n101_))) | (x20 & ~new_n100_ & ~x27);
  ...
  assign new_n106_ = ~x09 & (x20 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = ~x09 & ~x30 & ((~new_n109_ & x20) | (new_n108_ & x27));
  assign new_n108_ = (~new_n73_ | x04) & (~new_n66_ | ~x08 | ~x29);
  assign new_n109_ = (x08 | x27) & (new_n73_ | new_n89_);
  assign z20 = (~x20 & ~x27) | (~x09 & ~new_n111_ & ~x30);
