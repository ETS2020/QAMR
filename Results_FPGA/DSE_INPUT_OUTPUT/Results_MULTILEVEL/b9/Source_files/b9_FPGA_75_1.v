...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (x00 | ~x27)) | (x00 & ~x15 & ~new_n67_ & x27);
  ...
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | ~x04 | (~x00 & x27);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = (~new_n72_ & (x00 | ~x27)) | (x04 & ~x08 & ~x27);
  assign new_n72_ = (x02 | (x08 & x29)) & new_n66_ & (new_n73_ | ~x04);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (~x21 & (x00 | ~x27)) | (x00 & x27 & (~x28 | ~x35)) | (~x27 & ~x37);
  assign z04 = (x00 & x27 & (~x28 | ~x35)) | (~x27 & ~x37) | (x21 & (x00 | ~x27));
  assign z06 = ~x37 & (~x27 | (x00 & ~x28));
  assign z07 = (~x00 & x27) | (~new_n78_ & x03);
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & ((x00 & ~x25) | ~x38);
  assign z08 = x39 & x40 & (x00 | ~x27);
  assign z09 = x34 & x27 & x26 & x00 & x11;
  assign z10 = new_n85_ | (~x04 & (new_n84_ | (x05 & new_n83_ & x39)));
  assign new_n83_ = x40 & ((x00 & (x30 | x32 | (~new_n70_ & x27))) | (~x27 & (x30 | x32)));
  assign new_n84_ = x00 & x07 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n85_ = x00 & x06 & x27 & x37;
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | ((new_n73_ | (~x00 & x27)) & (~x00 | ~x04 | ~x27))) & (x08 | (x27 & (~x00 | (new_n73_ & ~x04))));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | ((~new_n66_ | x04) & (~x27 | (new_n68_ & x00)));
  assign new_n90_ = ~x10 & (~x27 | (x00 & ~x35 & ~x36 & ~x37));
  assign z13 = (x00 & ((~new_n92_ & x27) | (new_n94_ & ~x04))) | (new_n95_ & ~x04);
  ...
  assign new_n99_ = (x00 | ~x27) & ((new_n66_ & ~x04 & ~x13) | (~new_n68_ & x27));
  assign new_n100_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x34 & x27 & x26 & x00 & x12;
  assign z16 = x01 & x22 & ~x23 & (x00 | ~x27);
  assign z17 = x01 & x22 & x23 & ~x24 & (x00 | ~x27);
  assign z18 = new_n106_ | (~new_n105_ & (x00 | ~x27));
  assign new_n105_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign new_n106_ = ~x28 & x35 & ((x00 & ~x04 & x27) | (x08 & ~x27));
  assign z20 = (~x00 & x27) | (~x09 & ~new_n108_ & ~x30);
