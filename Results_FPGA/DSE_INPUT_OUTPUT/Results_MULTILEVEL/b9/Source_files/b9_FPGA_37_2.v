...
module FAU ( 
  ...
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | (~x27 & (x25 | ~x37));
  assign z05 = (~x25 & x37) | (x27 & (x28 | x37));
  assign z06 = ~x37 & (x27 ? ~x28 : ~x25);
  assign z07 = (~new_n79_ & x03) | (x25 & ~x27);
  ...
  assign z12 = new_n92_ | (x25 & ~x27) | ((~new_n66_ | x04) & (new_n68_ | ~x27));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n94_ | (new_n95_ & ~x04))) | (new_n96_ & ~x04) | (x25 & ~x27);
  ...
  assign new_n100_ = (~x25 | x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign new_n106_ = ~x09 & (~x25 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = (x25 & ~x27) | (~x09 & ~x30 & (new_n88_ | (~new_n108_ & ~x25)));
  assign new_n108_ = (x08 | x27) & (new_n90_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : x25)) & (new_n90_ | ((~x27 | x35) & (x25 | (x35 & (x27 | ~x28)))));
endmodule
