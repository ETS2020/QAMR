...
module FAU ( 
  ...
  assign z08 = x39 & x40 & (~x09 | x27);
  assign z09 = x34 & x27 & x11 & x26;
  assign z10 = (~new_n84_ & ~x04) | (x09 & ~x27) | (x06 & x27 & x37);
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n70_ | (new_n68_ ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = (~x27 & (x09 | (~x08 & ~x30))) | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (x08 | (~x04 & ~x28 & x35)) & (new_n88_ | (~x28 & x35 & (~x04 | ~x27)));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | (x09 & ~x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & x27) | (x09 & ~x27) | (~x04 & new_n85_ & ~x13);
  assign new_n92_ = (~new_n93_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x27 & (new_n97_ | (~new_n95_ & ~new_n99_))) | (~x09 & ~new_n98_ & ~x27);
  ...
  assign z15 = (x09 & ~x27) | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~x23 & (~x09 | x27);
  assign z17 = (x09 & ~x27) | (x23 & ~x24 & x01 & x22);
  assign z18 = ~new_n104_ | (x08 & (new_n88_ | (~x27 & ~x28 & x35)));
  assign new_n104_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = (x09 & ~x27) | (~x30 & (new_n106_ | (~x08 & (~x27 | (~new_n107_ & ~x09)))));
  assign new_n106_ = ~new_n88_ & ((x28 & (~x09 | ~x27)) | (~x09 & (~x35 | (x04 & x27))));
  assign new_n107_ = ~x04 & ~x28 & x35;
  assign z20 = (x09 & ~x27) | (~x30 & (new_n109_ | (~x08 & (~x27 | (~x09 & ~x35)))));
  assign new_n109_ = ~new_n88_ & ((~x09 & ~x35) | (~x27 & x28));
endmodule
