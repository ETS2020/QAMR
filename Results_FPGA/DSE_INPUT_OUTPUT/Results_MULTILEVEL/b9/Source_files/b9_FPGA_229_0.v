...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (x24 & ~new_n66_ & ~x40);
  ...
  assign new_n94_ = x20 & x24 & (x37 | (x28 & x35));
  ...
  assign new_n100_ = (~x24 | new_n66_ | x40) & (~x40 | (~new_n101_ & (new_n66_ | new_n99_)));
  ...
  assign z18 = new_n106_ | new_n107_ | x09 | new_n65_ | x30;
  assign new_n106_ = x08 & (new_n87_ | (~x27 & ~x28 & x35));
  assign new_n107_ = ~x04 & x27 & ~x28 & x35;
