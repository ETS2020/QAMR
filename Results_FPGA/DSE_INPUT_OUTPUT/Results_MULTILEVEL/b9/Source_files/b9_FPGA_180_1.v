...
module FAU ( 
  ...
  assign z06 = ~x28 & ~x37;
  assign z07 = (~new_n77_ & x03) | (~x27 & x28);
  ...
  assign z11 = (~x27 & (x28 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = (x08 | (~x04 & ~x28 & x35)) & (new_n87_ | (~x28 & x35 & (~x04 | ~x27)));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = new_n89_ | (~new_n90_ & (~new_n66_ | x04));
  assign new_n89_ = ~x10 & ((~x27 & ~x28) | (~x36 & ~x37 & x27 & ~x35));
  assign new_n90_ = (x28 | (x27 & x37)) & (~x27 | x35 | x37);
  assign z13 = new_n92_ | (~x27 & x28) | (new_n94_ & ~x18);
  assign new_n92_ = ~x04 & ~x13 & x39 & ~new_n93_ & x40;
  assign new_n93_ = ~x30 & ~x32 & (~x27 | (x28 & (~x35 | ~x36)));
  assign new_n94_ = ~x19 & x20 & ((x28 & x35) | (x27 & x37));
  assign z14 = new_n100_ | (x27 & ((~new_n96_ & ~new_n101_) | (new_n98_ & ~x35)));
  assign new_n96_ = new_n97_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n97_ = x39 & x40 & ~x04 & ~x13;
  assign new_n98_ = ~x37 & (~new_n99_ | x04 | x13);
  assign new_n99_ = x39 & x40 & (~x28 | x30 | x32);
  assign new_n100_ = ~x28 & ((~new_n97_ & (~x27 | ~x37)) | (~x27 & ~x30 & ~x32));
  assign new_n101_ = ~x18 & ~x19 & x20;
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = x01 & x22 & ~x23 & (x27 | ~x28);
  assign z17 = x01 & x22 & x23 & ~x24 & (x27 | ~x28);
  assign z18 = ~new_n106_ | (x08 & (new_n87_ | (~x27 & x35)));
  assign new_n106_ = ~x09 & (x27 | ~x28) & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = (~x09 & ~new_n108_ & ~x30) | (~x27 & (x28 | (~x08 & ~x09 & ~x28 & ~x30)));
  assign new_n108_ = ((~new_n109_ & ~x28) | (new_n66_ & x08 & x29)) & (x28 | x35 | (new_n66_ & x29));
  assign new_n109_ = x27 & (x04 | ~x35);
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 ? x35 : x28)) & (x35 | new_n87_ | (~x27 & x28));
  assign z05 = ~z06;
endmodule
