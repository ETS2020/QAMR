...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : ~x26;
  ...
  assign z14 = ~new_n98_ | (~new_n95_ & (x18 | x19 | ~x20));
  assign new_n95_ = x40 ? (~new_n96_ & new_n97_) : x26;
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = ~x04 & ~x13 & x39;
  assign new_n98_ = (x26 | new_n66_ | x40) & (~x40 | (~new_n99_ & (new_n66_ | new_n97_)));
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x26 & (~x40 | (x12 & x27 & x34));
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = new_n105_ | (~new_n65_ & (new_n104_ | x09 | x30));
  assign new_n104_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n105_ = x08 & x29 & x39 & x40;
  assign z19 = ~x09 & ~x30 & (new_n107_ | (~new_n109_ & ~x08));
  assign new_n107_ = ~new_n108_ & (x40 ? (~x29 | ~x39) : ~x26);
  assign new_n108_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n109_ = (x27 | (x26 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z20 = new_n65_ | (new_n111_ & ~x09);
  assign new_n111_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n87_ & (~x35 | (~x27 & x28))));
endmodule
