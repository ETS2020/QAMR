...
module FAU ( 
  ...
  assign z01 = ~x04 | (x27 & ~x30 & new_n70_ & ~x32);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = (x27 & (new_n73_ | ~new_n68_ | (~new_n72_ & x04))) | (~x04 & (~new_n68_ | new_n73_));
  ...
  assign new_n87_ = (~new_n72_ | x04) & (~new_n68_ | ~x08 | ~x29);
  assign z12 = (x27 & ~new_n89_ & ~x37) | (~x04 & ~x27 & (~new_n68_ | ~x10));
  assign new_n89_ = ((x28 & x35) | (new_n68_ & ~x04)) & (x10 | x35 | x36);
  ...
  assign z18 = ~new_n102_ | (x08 & (new_n103_ | (new_n72_ & ~x27)));
  assign new_n102_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n72_ | x04 | ~x27);
  assign new_n103_ = x29 & x39 & x40;
  assign z19 = ~x09 & ~x30 & ((~new_n105_ & ~x04) | (new_n87_ & x27));
