...
module FAU ( 
  ...
  assign new_n87_ = (x04 | x08) & ((x04 & x27) | (new_n66_ & x29));
  assign z12 = ~new_n89_ | (~x10 & (~x27 | (new_n90_ & ~x36 & ~x37)));
  assign new_n89_ = (~x04 | x27) & (new_n66_ | (x27 & (x04 | x37 | (x28 & x35))));
  assign new_n90_ = ~x04 & ~x35;
  ...
  assign z20 = ~x09 & ~x30 & (new_n104_ | (~x08 & (new_n90_ | ~x27)));
  assign new_n104_ = (~new_n66_ | ~x29) & (new_n90_ | (~new_n71_ & ~x27));
  assign z19 = ~x09 & ~x30 & ((~new_n87_ & ~new_n71_) | (~x08 & ~x27));
endmodule
