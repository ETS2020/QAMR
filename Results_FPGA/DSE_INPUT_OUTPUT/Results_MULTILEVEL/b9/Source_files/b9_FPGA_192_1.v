// Benchmark "FAU" written by ABC on Mon Aug 17 20:14:33 2020
...
module FAU ( 
  ...
  assign z00 = (~x15 & (new_n67_ | (~new_n65_ & x27))) | ~x16 | (~x14 & x27);
  ...
  assign z04 = (x27 & (~x14 | ~x28 | ~x35)) | x21 | (~x27 & ~x37);
  assign z05 = (~x27 & x37) | (x14 & (x37 | (x27 & x28)));
  assign z06 = ~x37 & (~x27 | (x14 & ~x28));
  assign z07 = x03 & (x14 ? (new_n79_ & ~x31) : new_n80_);
  assign new_n79_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign new_n80_ = ~x27 & (x00 | x25 | ~x38);
  assign z08 = new_n68_ | (~x14 & x27);
  assign z09 = x34 & x27 & x26 & x11 & x14;
  assign z10 = new_n86_ | (~x04 & (new_n85_ | (x05 & new_n84_ & x39)));
  assign new_n84_ = x40 & ((x14 & ((~new_n70_ & x27) | x30 | x32)) | (~x27 & (x30 | x32)));
  assign new_n85_ = x07 & x14 & x27 & ~new_n68_ & ~new_n70_;
  assign new_n86_ = x06 & x14 & x27 & x37;
  assign z11 = ~x09 & ~new_n88_ & ~x30;
  assign new_n88_ = (new_n89_ | ((new_n73_ | (~x14 & x27)) & (~x04 | ~x14 | ~x27))) & (x08 | (x27 & (~x14 | (new_n73_ & ~x04))));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | (~x14 & x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x14) | (new_n97_ & ~x04);
  assign new_n93_ = (~x27 | (~new_n95_ & (x04 | ~new_n94_ | x13))) & (x04 | ~new_n96_ | x13);
  assign new_n94_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = x28 & x39 & x40 & (x30 | x32);
  assign new_n97_ = ~x13 & ~x27 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n102_ & ~x27) | (x14 & (new_n101_ | (~new_n99_ & ~new_n103_)));
  ...
  assign new_n102_ = ~x04 & ~x13 & new_n68_ & (x30 | x32);
  assign new_n103_ = ~x18 & ~x19 & x20;
  assign z15 = x27 & (~x14 | (x12 & x26 & x34));
  assign z16 = x01 & x22 & ~x23 & (x14 | ~x27);
  assign z17 = x01 & x22 & x23 & ~x24 & (x14 | ~x27);
  assign z18 = ~new_n108_ | (x08 & (new_n89_ | (new_n73_ & ~x27)));
  assign new_n108_ = ~x09 & ~x30 & (~x27 | (x14 & (~new_n73_ | x04)));
  assign z20 = (~x14 & x27) | (~x09 & ~new_n110_ & ~x30);
  assign new_n110_ = (x08 | (x27 & x35)) & (new_n89_ | (x35 & (x27 | ~x28)));
