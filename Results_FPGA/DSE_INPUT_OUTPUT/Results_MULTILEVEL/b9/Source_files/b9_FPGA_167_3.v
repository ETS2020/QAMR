...
module FAU ( 
  ...
  assign z12 = ~new_n88_ | (~x10 & (~x27 | (new_n89_ & ~x36 & ~x37)));
  assign new_n88_ = (~x04 | x27) & (new_n66_ | (x27 & (x04 | x37 | (x28 & x35))));
  assign new_n89_ = ~x04 & ~x35;
  assign z13 = (~x13 & new_n91_ & x39) | (x27 & (new_n92_ | x04));
  assign new_n91_ = x40 & (new_n82_ | (x27 & (~x28 | (x35 & x36))));
  ...
  assign z18 = (~new_n101_ & (~x04 | ~x27)) | (~x28 & x35 & (x27 ? ~x04 : x08));
  assign new_n101_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign z19 = (x04 & x27) | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (x08 | (x27 & ~x28 & (x04 | x35))) & (new_n104_ | (~x28 & (x35 | (x04 & x27))));
  assign new_n104_ = x29 & x39 & x40;
  assign z20 = ~x09 & ~x30 & (new_n106_ | (~x08 & (new_n89_ | ~x27)));
  assign new_n106_ = ~new_n104_ & (new_n89_ | (~new_n71_ & ~x27));
  assign z05 = ~z06;
endmodule
