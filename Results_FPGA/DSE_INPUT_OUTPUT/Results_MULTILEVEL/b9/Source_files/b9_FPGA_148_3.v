...
module FAU ( 
  ...
  assign z10 = ~x04 & (new_n82_ | (x27 & (new_n81_ | (x06 & x37))));
  assign new_n81_ = (new_n71_ | x36) & (new_n66_ ? x05 : x07);
  assign new_n82_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n84_ & ~new_n71_) | (~x08 & ~x27));
  assign new_n84_ = (x04 | x08) & (new_n85_ | (x04 & x27));
  assign new_n85_ = x29 & x39 & x40;
  assign z12 = ~new_n87_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n87_ = ~x04 & (new_n66_ | (x27 & (x37 | (x28 & x35))));
  assign z13 = (x27 & (new_n91_ | x04)) | (~x13 & new_n89_ & x39);
  assign new_n89_ = x40 & ((~x04 & (x30 | x32)) | (~new_n90_ & x27));
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign new_n91_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n95_ | (~new_n93_ & (~new_n66_ | x13));
  assign new_n93_ = new_n94_ & (x37 | (x28 & x35));
  assign new_n94_ = ~x18 & ~x19 & x20 & x27;
  assign new_n95_ = ~x04 & (x30 | x32 | (x27 & (new_n96_ | ~x28)));
  ...
  assign z18 = (x08 & (new_n71_ | new_n85_)) | ~new_n101_ | (x27 & (new_n71_ | x04));
  assign new_n101_ = ~x09 & ~x30;
  assign z20 = (x04 & x27) | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (x08 | (x27 & (x04 | x35))) & (new_n85_ | ((x04 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
  assign z19 = ~x09 & ~x30 & ((~new_n84_ & ~new_n71_) | (~x08 & ~x27));
endmodule
