...
module FAU ( 
  ...
  assign z02 = ~x40 | (~x24 & (~new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n85_ = (~x07 | (x40 & (x24 | x39))) & (~x39 | ~x40 | ~x05 | x24);
  assign new_n86_ = x05 & ~x24 & x39 & x40 & (x30 | x32);
  assign z11 = (x40 & (x24 | (new_n90_ & ~x09 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
  assign new_n88_ = (new_n89_ | (new_n71_ & (~x04 | ~x27))) & (x08 | (new_n71_ & x27));
  ...
  assign new_n94_ = (~new_n97_ | x18) & (x24 | ((~new_n95_ | x04) & (~new_n96_ | x18)));
  ...
  assign new_n103_ = (new_n68_ | x40) & (x24 | (~new_n104_ & (new_n68_ | new_n102_)));
  ...
  assign new_n109_ = ~new_n67_ & ~x09 & ~x30 & (~new_n71_ | x04 | ~x27);
  assign z19 = new_n67_ | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = (new_n89_ | (new_n71_ & (~x04 | ~x27))) & (x08 | (new_n71_ & ~x04 & x27));
  assign z20 = new_n67_ | (new_n113_ & ~x09);
  assign new_n113_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n89_ & (~x35 | (~x27 & x28))));
endmodule
