...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n78_,
    new_n79_, new_n82_, new_n83_, new_n85_, new_n87_, new_n89_, new_n90_,
  ...
  assign new_n85_ = ((z08 & x29) | (new_n72_ & (~x04 | ~x27))) & (x08 | (new_n72_ & ~x04 & x27));
  assign z12 = x39 ? (new_n87_ | (~new_n66_ & (x04 | ~x40))) : (~new_n66_ & x40);
  assign new_n87_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = ~new_n91_ | (x27 & (new_n90_ | (new_n89_ & ~x04)));
  assign new_n89_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n90_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n91_ = (x39 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  assign z14 = ~new_n95_ | (~new_n93_ & (x18 | x19 | ~x20));
  assign new_n93_ = ~new_n94_ & z08 & ~x04 & ~x13;
  assign new_n94_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n95_ = ~new_n96_ & (x39 | x40) & (new_n66_ | (~x04 & ~x13 & x39 & x40));
  ...
  assign z18 = ~new_n101_ | (x08 & ((new_n72_ & ~x27) | (z08 & x29)));
  assign new_n101_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n65_ & ~x30;
  assign z19 = new_n65_ | (~x09 & ~x30 & (~new_n103_ | (~new_n105_ & ~x08)));
  assign new_n103_ = ((x29 & x40) | (~new_n104_ & ~x28 & (x35 | ~x39))) & (x39 | (~new_n104_ & ~x28 & (x35 | ~x40)));
  assign new_n104_ = x04 & x27;
  assign new_n105_ = (x27 | (~x39 & ~x40)) & ~x28 & (~x39 | (~x04 & x35));
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = ~new_n108_ & (x08 | ((x35 | ~x39) & (x27 | (~x39 & ~x40))));
  assign new_n108_ = (~x35 | (~x27 & x28)) & (x39 ? (~x29 | ~x40) : x40);
  assign z05 = ~z06;
endmodule
