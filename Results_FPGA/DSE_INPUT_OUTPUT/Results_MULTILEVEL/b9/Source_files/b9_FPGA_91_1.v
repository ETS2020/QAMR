...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x03 | ~x40);
  assign z01 = new_n70_ | ~x04 | (~x30 & ~x32 & (new_n71_ | ~x27));
  assign new_n70_ = ~x03 & x40;
  assign new_n71_ = ~x36 & (x28 | ~x35);
  assign z02 = ~x40 | (x03 & (~new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z07 = x03 ? (new_n80_ | (new_n79_ & ~x31)) : x40;
  ...
  assign z10 = ~new_n86_ | (~x04 & (new_n85_ | (x27 & ~new_n71_ & ~new_n84_)));
  assign new_n84_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n86_ = (x03 | ~x40) & (~x06 | ~x27 | ~x37);
  assign z11 = ~x09 & ~x30 & ((~new_n89_ & ~new_n90_) | (~new_n88_ & ~x08));
  assign new_n88_ = (x27 | (~x03 & x40)) & (~x03 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (~x03 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x03 & (new_n92_ | (~new_n93_ & (x04 | ~x39)))) | (~new_n93_ & ~x40);
  ...
  assign new_n97_ = x03 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n108_ = x03 & x08 & x29 & x39 & x40;
  assign z20 = ~x09 & ~x30 & (new_n111_ | (~new_n89_ & ~new_n110_));
  assign new_n110_ = x35 & (x27 | ~x28);
  assign new_n111_ = ~x08 & ((x03 & (~x27 | ~x35)) | (~x27 & ~x40));
