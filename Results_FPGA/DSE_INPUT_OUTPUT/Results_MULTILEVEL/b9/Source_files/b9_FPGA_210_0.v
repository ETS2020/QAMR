...
module FAU ( 
  ...
  assign z01 = (~x27 & (~x20 | (~x30 & ~x32))) | ~x04 | (~x30 & new_n70_ & ~x32);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = (~new_n72_ & (x20 | x27)) | (x04 & ~x08 & x20 & ~x27);
  ...
  assign z13 = (~new_n92_ & x27) | (~x04 & ~x13 & new_n85_ & x20);
  ...
  assign z19 = (~x20 & ~x27) | (~x09 & ~x30 & ((~new_n107_ & x20) | (new_n106_ & x27)));
  assign new_n106_ = (~new_n73_ | x04) & (~new_n66_ | ~x08 | ~x29);
  assign new_n107_ = (new_n88_ | (x35 & (x27 | ~x28))) & (x08 | x27);
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (x08 | (x27 ? x35 : ~x20)) & (new_n88_ | ((~x27 | x35) & (~x20 | (x35 & (x27 | ~x28)))));
endmodule
