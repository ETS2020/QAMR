...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n77_, new_n78_,
    ...
    new_n93_, new_n94_, new_n95_, new_n100_, new_n103_;
  ...
  assign z05 = (x27 & (x28 | x37)) | (x04 & x37);
  ...
  assign z10 = (~x04 & (new_n82_ | new_n83_ | ~x27)) | (x06 & x27 & x37);
  assign new_n82_ = (new_n68_ | x36) & (new_n71_ ? x05 : x07);
  assign new_n83_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = (~x04 & ~x27) | (~x09 & ~new_n85_ & ~x30);
  assign new_n85_ = (x08 | (new_n68_ & ~x04)) & ((new_n71_ & x29) | (new_n68_ & (~x04 | ~x27)));
  assign z12 = (x04 & ~x27) | (~new_n87_ & ~x37);
  assign new_n87_ = (new_n88_ | (x28 & x35)) & (x10 | ~x27 | x35 | x36);
  assign new_n88_ = ~x04 & (~x27 | (x39 & x40));
  assign z13 = x27 & (new_n90_ | (~x04 & ~x13 & new_n91_ & x39));
  assign new_n90_ = ~x18 & ~x19 & ~new_n65_ & x20;
  ...
  assign new_n95_ = ~x37 & ((~new_n94_ & (~x28 | ~x35)) | (x28 & ~x30 & ~x32 & ~x35));
  assign z15 = (~x04 & ~x27) | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~x23 & (x04 | x27);
  assign z17 = x01 & x22 & x23 & ~x24 & (x04 | x27);
  assign z18 = (~x04 & (new_n68_ | ~x27)) | new_n100_ | x09 | x30;
  assign new_n100_ = x08 & ((new_n68_ & ~x27) | (new_n71_ & x29));
  assign z19 = (~x09 & ~new_n85_ & ~x30) | (~x27 & (~x04 | (~x08 & ~x09 & ~x30)));
  assign z20 = (~x04 & ~x27) | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (x08 | (x27 & x35)) & ((new_n71_ & x29) | (x35 & (x27 | ~x28)));
endmodule
