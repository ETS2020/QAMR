...
module FAU ( 
  ...
  assign new_n104_ = (x08 | (x27 & ~x28 & (x04 | x35))) & (new_n105_ | (~x28 & (x35 | (x04 & x27))));
  assign new_n105_ = x29 & x39 & x40;
  assign z20 = ~x09 & ~x30 & (new_n107_ | (~x08 & (new_n90_ | ~x27)));
  assign new_n107_ = ~new_n105_ & (new_n90_ | (~new_n71_ & ~x27));
endmodule
