...
module FAU ( 
  ...
  assign new_n86_ = (~x07 | (x40 & (~x29 | x39))) & (~x39 | ~x40 | ~x05 | ~x29);
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n89_ & ~x08));
  assign new_n88_ = ~z08 & (~new_n71_ | (x04 & x27));
  assign new_n89_ = (x27 | (~x29 & x40)) & (~x29 | (new_n71_ & ~x04));
  assign z12 = (x29 & (new_n92_ | (~new_n91_ & (x04 | ~x39)))) | (~new_n91_ & ~x40);
  assign new_n91_ = ~new_n66_ & x27;
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n97_ | (x27 & ((~new_n94_ & x29) | (new_n96_ & ~x18)));
  ...
  assign new_n97_ = ~x04 & new_n85_ & ~x13;
  assign z14 = (~new_n99_ & (new_n100_ | ~new_n101_)) | new_n102_ | new_n68_ | (~new_n91_ & ~new_n101_);
  ...
  assign z18 = (~new_n107_ & (x29 | ~x40)) | (x39 & x40 & x08 & x29);
