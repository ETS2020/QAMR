...
module FAU ( 
  ...
  assign z12 = new_n93_ | (~new_n92_ & (x40 ? (x04 | ~x39) : ~x36));
  ...
  assign new_n98_ = ~x04 & new_n86_ & ~x13;
  ...
  assign z19 = new_n68_ | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = (new_n112_ | x08) & ~new_n114_ & (new_n113_ | (x29 & x39));
  assign new_n112_ = (x27 | (x36 & ~x40)) & ~x28 & (~x40 | (~x04 & x35));
  assign new_n113_ = (~x04 | ~x27) & ~x28 & (x35 | ~x40);
  assign new_n114_ = ~x40 & ((x04 & x27) | x28 | (~x35 & ~x36));
  assign z20 = new_n116_ & ~x09;
  assign new_n116_ = ~x30 & (new_n117_ | (~new_n89_ & (~x35 | (~x27 & x28))));
  assign new_n117_ = ~x08 & ((~x35 & x40) | (~x27 & (~x36 | x40)));
endmodule
