...
module FAU ( 
  ...
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | ~x04 | (~x09 & x27);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = ~new_n73_ & new_n66_ & (x09 | ~x27);
  ...
  assign z10 = new_n87_ | (~x04 & ((new_n84_ & x05) | (new_n86_ & x07)));
  assign new_n84_ = x39 & x40 & ((x09 & (~new_n85_ | (~new_n70_ & x27))) | (~new_n85_ & ~x27));
  assign new_n85_ = ~x30 & ~x32;
  assign new_n86_ = x09 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n87_ = x06 & x09 & x27 & x37;
  assign z11 = ~x09 & (x27 | (~new_n89_ & ~x30));
  assign new_n89_ = x08 & ((~x28 & x35) | (new_n66_ & x29));
  assign z12 = new_n91_ | ((~new_n66_ | x04) & (~x27 | (new_n68_ & x09)));
  assign new_n91_ = ~x10 & (~x27 | (x09 & ~x35 & ~x36 & ~x37));
  assign z13 = (x27 & ((new_n95_ & ~x04) | new_n93_ | ~x09)) | (new_n94_ & ~x04);
  assign new_n93_ = ~x18 & ~x19 & ~new_n68_ & x20;
  assign new_n94_ = ~x13 & x39 & ~new_n85_ & x40;
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (~new_n100_ & ~x27) | (x09 & (new_n99_ | (~new_n97_ & ~new_n101_)));
  ...
  assign new_n100_ = ~x04 & ~x13 & new_n66_ & ~new_n85_;
  ...
  assign z18 = x09 | (~x27 & (new_n89_ | x30));
