...
module FAU ( 
  ...
  assign new_n72_ = (x27 | (~x18 & (~x04 | x08))) & new_n66_ & (new_n73_ | ~x04);
  ...
  assign z06 = ~x37 & (x27 ? ~x28 : ~x18);
  assign z07 = x03 & ~new_n79_ & (~x18 | x27);
  ...
  assign new_n84_ = x40 & (((~x18 | x27) & (x30 | x32)) | (~new_n70_ & x27));
  ...
  assign z12 = new_n92_ | ((~new_n66_ | x04) & (x27 ? new_n68_ : ~x18));
  assign new_n92_ = ~x10 & ((~x18 & ~x27) | (x27 & ~x35 & ~x36 & ~x37));
  ...
  assign new_n97_ = ~x13 & ~x18 & x39 & x40 & (x30 | x32);
  assign z14 = (x27 & (new_n101_ | (~new_n99_ & (~new_n103_ | x18)))) | (~x18 & ~new_n102_ & ~x27);
  assign new_n99_ = new_n100_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n100_ = x39 & x40 & ~x04 & ~x13;
  assign new_n101_ = ~x37 & ((~new_n100_ & (~x28 | ~x35)) | (x28 & ~x30 & ~x32 & ~x35));
  assign new_n102_ = ~x04 & ~x13 & new_n66_ & (x30 | x32);
  assign new_n103_ = ~x19 & x20;
  assign z15 = (x18 & ~x27) | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~x23 & (~x18 | x27);
  assign z17 = (x18 & ~x27) | (x23 & ~x24 & x01 & x22);
  assign z18 = new_n109_ | (~new_n108_ & (~x18 | x27));
  assign new_n108_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign new_n109_ = ~x28 & x35 & ((~x04 & x27) | (x08 & ~x18 & ~x27));
  assign z19 = (x18 & ~x27) | (~x09 & ~x30 & (new_n88_ | (~new_n111_ & ~x18)));
  assign new_n111_ = (x08 | x27) & (new_n90_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n113_ & ~x30;
  assign new_n113_ = (x08 | (x27 ? x35 : x18)) & (new_n90_ | ((~x27 | x35) & (x18 | (x35 & (x27 | ~x28)))));
endmodule
