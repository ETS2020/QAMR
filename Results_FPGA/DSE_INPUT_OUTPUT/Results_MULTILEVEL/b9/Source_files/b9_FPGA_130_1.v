...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n89_, new_n91_, new_n92_, new_n99_, new_n100_, new_n102_,
    new_n103_;
  ...
  assign z02 = ~x40 | (x13 & (~new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z07 = x03 & ~new_n70_ & (new_n79_ | (new_n78_ & ~x31));
  ...
  assign z10 = ~new_n85_ | (~x04 & (new_n84_ | (x27 & ~new_n71_ & ~new_n83_)));
  assign new_n83_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n85_ = (~x06 | ~x27 | ~x37) & (x13 | ~x40);
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~new_n89_) | (~new_n87_ & ~x08));
  assign new_n87_ = (x27 | (~x13 & x40)) & (~x13 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 & (~x13 | (x29 & x39));
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n91_ | (~x13 & x40) | (~new_n92_ & (x04 | ~x39 | ~x40));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n70_ | (~x18 & ~x19 & new_n92_ & x20);
  assign z14 = ~new_n70_ & (new_n66_ | ~x20 | ~x27 | x18 | x19);
  assign z15 = new_n70_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n70_ | (x01 & x22 & ~x23);
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n100_ | (~new_n70_ & (new_n99_ | x09 | x30));
  assign new_n99_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n100_ = x08 & x13 & x29 & x39 & x40;
  assign z20 = ~x09 & ~x30 & (new_n103_ | (~new_n88_ & ~new_n102_));
  assign new_n102_ = x35 & (x27 | ~x28);
  assign new_n103_ = ~x08 & ((x13 & (~x27 | ~x35)) | (~x27 & ~x40));
