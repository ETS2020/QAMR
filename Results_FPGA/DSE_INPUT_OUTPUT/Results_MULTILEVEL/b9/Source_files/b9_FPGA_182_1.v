...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n76_, new_n77_,
    new_n78_, new_n82_, new_n84_, new_n85_, new_n88_, new_n90_, new_n91_,
    new_n96_, new_n98_, new_n99_, new_n101_, new_n102_;
  ...
  assign z19 = ~x09 & ~x30 & (new_n99_ | (~new_n76_ & ~new_n98_));
  assign new_n98_ = x08 & (x35 | (x29 & x39 & x40));
  assign new_n99_ = (~x29 | ~x39 | ~x40) & (x27 ? x04 : x28);
