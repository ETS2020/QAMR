...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n73_, new_n74_,
    new_n80_, new_n81_, new_n84_, new_n85_, new_n87_, new_n89_, new_n90_,
  ...
  assign new_n87_ = ((x29 & x39) | (new_n74_ & (~x04 | ~x27))) & (x08 | (new_n74_ & ~x04 & x27));
  assign z12 = new_n89_ | new_n69_ | (~new_n90_ & (~z08 | x04));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n90_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n92_ | (~x04 & new_n85_ & ~x13);
  assign new_n92_ = x27 & ((new_n94_ & x09) | (x40 & (new_n93_ | new_n94_)));
  ...
  assign new_n99_ = (~x40 | (~new_n100_ & (new_n90_ | new_n98_))) & (~x09 | new_n90_ | x40);
  ...
  assign new_n105_ = ~new_n106_ & ~x30 & (~new_n74_ | x04 | ~x27);
