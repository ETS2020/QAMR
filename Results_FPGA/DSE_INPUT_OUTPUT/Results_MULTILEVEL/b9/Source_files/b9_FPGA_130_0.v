...
module FAU ( 
  ...
  assign z12 = new_n89_ | new_n69_ | ((new_n66_ | ~x27) & (~z08 | x04));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n91_ | (~x04 & new_n92_ & ~x13))) | (~new_n93_ & ~x13);
  assign new_n91_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n92_ = x39 & (~x28 | (x35 & x36));
  assign new_n93_ = x40 & (x04 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n96_ | (~new_n95_ & (x13 | (x40 & (x04 | ~x39))));
  ...
  assign z18 = (~new_n102_ & ~new_n69_) | (z08 & x08 & x29);
  assign new_n102_ = ~new_n103_ & ~x09 & ~x30;
  assign new_n103_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n105_ & ~x09;
  assign new_n105_ = ~x30 & (new_n106_ | (~new_n86_ & (~x35 | (~x27 & x28))));
  assign new_n106_ = ~x08 & ((~x35 & x40) | (~x27 & (x13 | x40)));
  assign z05 = ~z06;
