...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
    ...
    new_n99_, new_n104_, new_n105_, new_n107_, new_n109_;
  ...
  assign z01 = ~x04 | (x21 & ~x30 & ~x32 & (new_n71_ | ~x27));
  assign new_n71_ = ~x36 & (x28 | ~x35);
  assign z02 = (~new_n73_ & (~x04 | x21)) | (x04 & x21 & (~new_n74_ | (~x08 & ~x27)));
  assign new_n73_ = new_n68_ & (x02 | (x08 & x29));
  ...
  assign new_n84_ = (new_n71_ | (new_n68_ ? ~x05 : ~x07)) & (~x06 | ~x37);
  assign new_n85_ = x06 & x21 & x37;
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n88_ & ~x30;
  assign new_n88_ = (new_n89_ | ((new_n74_ | (x04 & ~x21)) & (~x04 | ~x21 | ~x27))) & (x08 | (x04 ? ~x21 : (new_n74_ & x27)));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | (x04 & ~x21) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x27) | (x04 & ~x21) | (~x04 & new_n86_ & ~x13);
  ...
  assign new_n98_ = (~x04 | x21) & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = new_n105_ | (~new_n104_ & ~new_n69_);
  assign new_n104_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n105_ = ~x28 & x35 & ((x08 & x21 & ~x27) | (~x04 & (x08 | x27)));
  assign z19 = new_n69_ | (~x09 & ~new_n107_ & ~x30);
  assign new_n107_ = (new_n89_ | (new_n74_ & (~x04 | ~x27))) & (x08 | (new_n74_ & ~x04 & x27));
  assign z20 = new_n69_ | (~x09 & ~new_n109_ & ~x30);
