...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & (x19 | x27)) | (x19 & ~x27 & x04 & ~x08);
  ...
  assign z14 = new_n95_ | new_n98_ | (~x27 & (~x19 | (~x30 & ~x32)));
  ...
  assign z20 = (~x19 & ~x27) | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = (x08 | (x27 & x35)) & ((new_n66_ & x29) | (x35 & (x27 | ~x28)));
  assign z19 = (~x27 & (~x19 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n87_ & ~x30);
endmodule
