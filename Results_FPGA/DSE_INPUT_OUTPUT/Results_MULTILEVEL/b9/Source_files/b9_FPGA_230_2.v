// Benchmark "FAU" written by ABC on Mon Aug 17 20:14:42 2020
...
module FAU ( 
  ...
  assign z12 = (~x10 & (new_n89_ | ~x27)) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n89_ = ~x35 & ~x36 & ~x37;
  assign z13 = (x27 & (new_n91_ | (~x04 & new_n92_ & ~x13))) | (~x04 & new_n85_ & ~x13);
  ...
  assign new_n102_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign z19 = ~x09 & ~new_n104_ & ~x30;
  assign new_n104_ = (~x27 | (new_n73_ & ~x04) | (new_n68_ & x08 & x29)) & (x04 | ((x08 | x27) & (new_n73_ | (new_n68_ & x29))));
  assign z20 = (x04 & ~x27) | (~x09 & ~new_n106_ & ~x30);
