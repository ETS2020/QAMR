...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n70_, new_n71_, new_n76_, new_n77_,
    ...
    new_n92_, new_n93_, new_n94_, new_n99_, new_n101_, new_n102_,
    new_n104_;
  ...
  assign z11 = (x04 & x27) | (~x09 & ~x30 & (new_n84_ | (~x08 & ~x27)));
  assign new_n84_ = ~new_n71_ & (~new_n66_ | ~x08 | ~x29);
  assign z12 = ~new_n86_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n86_ = ~x04 & (new_n66_ | (x27 & (x37 | (x28 & x35))));
  assign z13 = (x27 & (new_n90_ | x04)) | (~x13 & new_n88_ & x39);
  assign new_n88_ = x40 & ((~x04 & (x30 | x32)) | (~new_n89_ & x27));
  assign new_n89_ = x28 & (~x35 | ~x36);
  assign new_n90_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ((~new_n66_ | x13) & (~x27 | (~new_n94_ & ~x04))) | new_n92_ | (x04 & ~x27);
  assign new_n92_ = ~x30 & ~x32 & (~x27 | (~x04 & ~new_n93_ & x28));
  assign new_n93_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign new_n94_ = (x37 | (x28 & x35)) & ~x18 & ~x19 & x20;
  assign z15 = x34 & x27 & x26 & ~x04 & x12;
  assign z16 = (x04 & x27) | (x01 & x22 & ~x23);
  assign z17 = (x04 & x27) | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n99_ & (~x04 | ~x27)) | (~x28 & x35 & (x27 ? ~x04 : x08));
  assign new_n99_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign z19 = ~x09 & ~x30 & ((~new_n101_ & ~new_n71_) | (~x08 & ~x27));
  assign new_n101_ = (x04 | x08) & (new_n102_ | (x04 & x27));
  assign new_n102_ = x29 & x39 & x40;
  assign z20 = ~x09 & ~new_n104_ & ~x30;
  assign new_n104_ = (x08 | (x27 & (x04 | x35))) & (new_n102_ | ((x04 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
endmodule
