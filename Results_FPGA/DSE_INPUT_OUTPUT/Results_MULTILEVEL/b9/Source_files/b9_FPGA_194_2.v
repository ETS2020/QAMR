...
module FAU ( 
  ...
  assign z19 = (~x27 & (x04 | (~x04 & ~x08 & ~x09 & ~x30))) | (~x09 & new_n104_ & ~x30);
  assign new_n104_ = ~new_n105_ & (x04 | x28 | (~x35 & (~x04 | x27)));
  assign new_n105_ = x08 & x29 & x39 & x40;
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (x04 | (~new_n108_ & (x08 | (x27 & x35)))) & (~x27 | new_n105_ | x35);
