...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n72_ | ~new_n73_ | ~x38;
  ...
  assign new_n103_ = (~x38 | (~new_n104_ & (new_n68_ | new_n102_))) & (new_n68_ | x40);
  ...
  assign new_n109_ = (~new_n73_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n110_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = ~x09 & ~x30 & (new_n112_ | (~new_n113_ & ~x08));
  assign new_n112_ = ~new_n88_ & (~x40 | (x38 & (~x29 | ~x39)));
  assign new_n113_ = (x27 | (~x38 & x40)) & (~x38 | (~x28 & x35 & (~x04 | ~x40)));
  assign z20 = new_n67_ | (~x09 & ~new_n115_ & ~x30);
  assign new_n115_ = (x08 | (x27 & x35)) & ((new_n73_ & x29) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
endmodule
