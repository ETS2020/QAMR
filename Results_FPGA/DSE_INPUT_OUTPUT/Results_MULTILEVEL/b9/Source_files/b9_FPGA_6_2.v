...
module FAU ( 
  ...
  assign z10 = new_n81_ | new_n65_ | (x06 & x27 & x37);
  assign new_n81_ = ~x04 & ((x27 & (new_n83_ | (new_n82_ & x05))) | (new_n84_ & x05));
  assign new_n82_ = x39 & (x36 | (~x28 & x35 & x40));
  assign new_n83_ = x07 & ((~x28 & x35 & (~x39 | ~x40)) | (x36 & ~x39));
  ...
  assign z12 = new_n90_ | (~new_n66_ & (x40 ? (x04 | ~x39) : ~x36));
  ...
  assign new_n99_ = ~new_n65_ & (new_n66_ | (z08 & ~x04 & ~x13));
  ...
  assign z18 = (z08 & x08 & x29) | (~new_n105_ & ~new_n65_);
  assign new_n105_ = ~new_n106_ & ~x09 & ~x30;
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = new_n65_ | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (new_n109_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (~x28 & x35 & ~x04 & x27));
