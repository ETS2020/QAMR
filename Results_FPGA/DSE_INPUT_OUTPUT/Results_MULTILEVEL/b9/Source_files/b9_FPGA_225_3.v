...
module FAU ( 
  ...
  assign z07 = (~new_n79_ & x03) | (x10 & x27);
  assign new_n79_ = (~new_n80_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n80_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = new_n73_ | (x10 & x27);
  assign z09 = x34 & x27 & x26 & ~x10 & x11;
  assign z10 = new_n86_ | (~x04 & (new_n85_ | (x05 & new_n84_ & x39)));
  assign new_n84_ = x40 & ((~x10 & ((~new_n70_ & x27) | x30 | x32)) | (~x27 & (x30 | x32)));
  assign new_n85_ = x07 & ~x10 & x27 & ~new_n73_ & ~new_n70_;
  assign new_n86_ = x27 & x37 & x06 & ~x10;
  assign z11 = ~x09 & ~new_n88_ & ~x30;
  assign new_n88_ = (new_n89_ | ((new_n74_ | (x10 & x27)) & (~x04 | x10 | ~x27))) & (x08 | (x27 & (x10 | (new_n74_ & ~x04))));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = ((~x27 | (new_n67_ & ~x10)) & (~new_n73_ | x04)) | (~x10 & (new_n91_ | ~x27));
  assign new_n91_ = ~x35 & ~x36 & ~x37;
  assign z13 = (x27 & ((new_n94_ & ~x04) | new_n93_ | x10)) | (new_n95_ & ~x04);
  assign new_n93_ = ~x18 & ~x19 & ~new_n67_ & x20;
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n100_ & ~x27) | (~x10 & (new_n99_ | (~new_n97_ & ~new_n101_)));
  ...
  assign new_n100_ = ~x04 & ~x13 & new_n73_ & (x30 | x32);
  ...
  assign new_n107_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & ~x10 & x27));
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (x08 | (x27 & (x10 | x35))) & (new_n89_ | ((x10 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
