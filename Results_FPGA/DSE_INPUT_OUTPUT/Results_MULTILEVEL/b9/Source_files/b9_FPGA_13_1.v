...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (x29 | ~x39)) | (~x04 & ~x15 & x29 & new_n67_ & x39);
  assign new_n65_ = x16 & (~new_n66_ | x15);
  assign new_n66_ = x27 & (x37 | (x28 & x35));
  assign new_n67_ = x40 & (x10 | (x27 & (x35 | x36)));
  assign z01 = ~new_n69_ & (~x04 | (~x30 & ~x32 & (new_n70_ | ~x27)));
  assign new_n69_ = ~x29 & x39;
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (~x08 & (~x02 | (x04 & ~x27)));
  assign new_n72_ = (~x04 | (~x28 & x35)) & new_n73_ & x29;
  ...
  assign new_n84_ = (~x27 | new_n70_ | (new_n73_ ? ~x05 : ~x07)) & (~new_n85_ | ~x05);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = new_n69_ | (~x09 & ~x30 & (new_n87_ | new_n88_));
  assign new_n87_ = ~new_n73_ & ((x04 & x27) | x28 | ~x35);
  assign new_n88_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x39));
  assign z12 = new_n90_ | new_n69_ | (~new_n66_ & (~new_n73_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n93_ | (new_n92_ & ~x04))) | (~new_n94_ & x39);
  assign new_n92_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n94_ = x29 & (x04 | x13 | ~x40 | (~x30 & ~x32));
  assign z14 = ~new_n99_ | ((x18 | x19 | ~x20) & (new_n96_ | ~x39));
  assign new_n96_ = x29 & (new_n97_ | ~new_n98_);
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x40;
  assign new_n99_ = (~x29 | (~new_n100_ & (new_n66_ | new_n98_))) & (new_n66_ | x39);
  ...
  assign z18 = (x08 & x29 & x39 & x40) | (~new_n105_ & (x29 | ~x39));
  assign new_n105_ = ~new_n106_ & ~x09 & ~x30;
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = new_n69_ | (new_n108_ & ~x09);
  assign new_n108_ = ~x30 & (new_n109_ | new_n111_ | (~new_n110_ & ~x08));
  assign new_n109_ = (~x39 | ~x40) & (x28 | (x04 & x27));
  assign new_n110_ = (x27 | (~x29 & x39)) & ~x28 & (~x04 | ~x39) & (~x29 | x35);
  assign new_n111_ = ~x35 & (~x39 | (x29 & ~x40));
  assign z20 = ~x09 & ~new_n113_ & ~x30;
  assign new_n113_ = ~new_n114_ & (x08 | ((~x29 | x35) & (x27 | (~x29 & x39))));
