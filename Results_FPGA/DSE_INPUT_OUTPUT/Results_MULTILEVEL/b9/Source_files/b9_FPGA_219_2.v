...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n72_, new_n78_,
    ...
    new_n93_, new_n94_, new_n95_, new_n96_, new_n101_, new_n102_,
    new_n104_, new_n106_;
  ...
  assign new_n86_ = (~new_n70_ | x04) & (~new_n72_ | ~x08 | ~x29);
  assign z12 = (x27 & ~new_n88_ & ~x37) | (~x04 & ~x27 & (~new_n72_ | ~x10));
  assign new_n88_ = ((x28 & x35) | (new_n72_ & ~x04)) & (x10 | x35 | x36);
  ...
  assign z18 = ~new_n101_ | (x08 & (new_n102_ | (new_n70_ & ~x27)));
  assign new_n101_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n70_ | x04 | ~x27);
  assign new_n102_ = x29 & x39 & x40;
  assign z19 = ~x09 & ~x30 & ((~new_n104_ & ~x04) | (new_n86_ & x27));
  assign new_n104_ = (x08 | x27) & (new_n102_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (x08 | (x27 ? x35 : x04)) & (new_n102_ | ((~x27 | x35) & (x04 | (x35 & (x27 | ~x28)))));
endmodule
