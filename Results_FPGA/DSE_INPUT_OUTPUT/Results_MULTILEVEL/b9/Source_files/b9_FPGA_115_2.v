...
module FAU ( 
  ...
  assign z03 = (~x21 & (~x37 | x40)) | (~new_n67_ & (~x37 | (x27 & x40))) | (~x27 & ~x37);
  assign z04 = (~new_n67_ & x27) | x21 | (x37 & ~x40) | (~x27 & (~x37 | ~x40));
  ...
  assign new_n84_ = ~new_n86_ & (~x27 | new_n85_ | (~x36 & (x28 | ~x35)));
  assign new_n85_ = (~x07 | ((x39 | ~x40) & (x37 | (x39 & x40)))) & (~x05 | ~x39 | ~x40);
  ...
  assign new_n91_ = (new_n67_ | (x40 & (x37 | (~x04 & x39)))) & (x40 | (x27 & ~x37)) & (x27 | (~x04 & x39));
  assign z13 = new_n69_ | (new_n95_ & ~x04) | (x27 & (new_n93_ | (new_n94_ & ~x04)));
  ...
  assign new_n99_ = ~new_n100_ & (new_n67_ | (x40 & (new_n101_ | x37))) & (new_n101_ | x27) & (x40 | (x27 & ~x37));
