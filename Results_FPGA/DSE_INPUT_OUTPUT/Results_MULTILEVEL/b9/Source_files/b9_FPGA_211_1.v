...
module FAU ( 
  ...
  assign new_n83_ = ((~new_n70_ & ~x36) | (new_n68_ ? ~x05 : ~x07)) & (~new_n68_ | ~x05 | ~x32);
  assign new_n84_ = new_n68_ & ~x32 & x05 & x30;
  ...
  assign new_n89_ = ~x10 & ((~x27 & ~x32) | (x27 & ~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n91_ | (new_n92_ & ~x04))) | (~x27 & x32) | (new_n93_ & ~x04);
  ...
  assign new_n97_ = (x30 | (~new_n98_ & x27)) & (x27 | ~x32) & (new_n96_ | (~new_n66_ & x27));
  assign new_n98_ = ~x35 & ~x37 & x28 & ~x32;
