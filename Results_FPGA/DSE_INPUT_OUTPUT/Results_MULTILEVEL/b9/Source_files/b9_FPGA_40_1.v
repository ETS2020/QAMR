...
module FAU ( 
  ...
  assign new_n90_ = ~x10 & (~x27 | (x26 & ~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & x26) | (~x04 & ~x13 & new_n85_ & ~x27);
  ...
  assign z14 = (~new_n100_ & ~x27) | (x26 & (new_n99_ | (~new_n97_ & ~new_n101_)));
  ...
  assign new_n106_ = ~x09 & ~x30 & (~x27 | (x26 & (~new_n73_ | x04)));
  assign z19 = ~x09 & ~new_n108_ & ~x30;
  assign new_n108_ = (new_n88_ | ((new_n73_ | (~x26 & x27)) & (~x04 | ~x26 | ~x27))) & (x08 | (x27 & (~x26 | (new_n73_ & ~x04))));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 & (~x26 | x35))) & (new_n88_ | ((x27 | (~x28 & x35)) & (~x26 | x35)));
endmodule
