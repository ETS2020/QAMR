...
module FAU ( 
  ...
  assign new_n85_ = ~new_n86_ & (~new_n68_ | x04);
  assign new_n86_ = x39 & x40 & x08 & x29;
  ...
  assign new_n96_ = ~new_n97_ & (new_n95_ | (x27 & (x37 | (x28 & x35))));
  ...
  assign z18 = ~new_n102_ | (x08 & ((new_n68_ & ~x27) | (new_n71_ & x29)));
  assign new_n102_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n68_ | x04 | ~x27);
  assign z19 = (~x09 & new_n104_ & ~x30) | (~x27 & (x04 | (~x04 & ~x08 & ~x09 & ~x30)));
  assign new_n104_ = ~new_n86_ & ((~x35 & (~x04 | x27)) | x04 | x28);
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (~x27 | new_n86_ | x35) & (x04 | (~new_n107_ & (x08 | (x27 & x35))));
