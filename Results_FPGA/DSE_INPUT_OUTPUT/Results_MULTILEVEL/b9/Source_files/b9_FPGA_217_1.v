...
module FAU ( 
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x09 | ~x39 | ~x40)) | (x05 & x39 & x40));
  assign new_n84_ = ~new_n68_ & (~x06 | ~x27 | ~x37);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ~new_n87_ & ~x40;
  assign new_n87_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z12 = ~new_n89_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n89_ = (x09 | ~x40) & ((~new_n66_ & x27) | (~x04 & x39 & x40));
  assign z13 = (~new_n91_ & x27) | (~x04 & x09 & new_n85_ & ~x13);
  ...
  assign new_n96_ = x09 & (new_n97_ | ~new_n98_);
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (~x09 | (~new_n100_ & (new_n98_ | (~new_n66_ & x27)))) & (x40 | (~new_n66_ & x27));
  ...
  assign z18 = x09 | (~new_n105_ & ~x40);
  assign new_n105_ = ~x30 & (x28 | ~x35 | (x27 ? x04 : ~x08));
  assign z19 = ~x09 & (x40 | (~new_n87_ & ~x30));
  assign z20 = ~new_n108_ & ~x09;
  assign new_n108_ = ~x40 & (x30 | (x35 & (x27 | (x08 & ~x28))));
endmodule
