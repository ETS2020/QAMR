...
module FAU ( 
  ...
  assign z07 = x03 & ~new_n78_ & (~x18 | ~x27);
  ...
  assign new_n83_ = x40 & ((~x18 & ((~new_n70_ & x27) | x30 | x32)) | (~x27 & (x30 | x32)));
  assign new_n84_ = x07 & ~x18 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n85_ = x27 & x37 & x06 & ~x18;
  ...
  assign z12 = new_n90_ | ((~new_n66_ | x04) & (~x27 | (new_n68_ & ~x18)));
  assign new_n90_ = ~x10 & (~x27 | (~x18 & ~x35 & ~x36 & ~x37));
  assign z13 = (~x18 & (new_n92_ | (~x04 & new_n94_ & ~x13))) | (~x04 & new_n95_ & ~x13);
  assign new_n92_ = x27 & ((new_n93_ & ~x04) | (~x19 & ~new_n68_ & x20));
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = x28 & x39 & x40 & (x30 | x32);
  assign new_n95_ = ~x27 & x39 & x40 & (x30 | x32);
  assign z14 = new_n100_ | (~x18 & (new_n99_ | (~new_n97_ & (x19 | ~x20))));
