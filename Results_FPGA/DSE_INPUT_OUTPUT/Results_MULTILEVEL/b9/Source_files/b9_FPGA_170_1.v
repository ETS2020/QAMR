...
module FAU ( 
  ...
  assign z12 = (~new_n87_ & x04) | (~x27 & (~x10 | ~x39 | ~x40));
  ...
  assign z19 = new_n76_ | (~x09 & ~x30 & (new_n99_ | ~x08));
  assign new_n99_ = (~x29 | ~x39 | ~x40) & (x27 | (~x27 & x28) | ~x35);
  assign z20 = new_n76_ | (~x09 & ~x30 & (new_n101_ | new_n102_));
