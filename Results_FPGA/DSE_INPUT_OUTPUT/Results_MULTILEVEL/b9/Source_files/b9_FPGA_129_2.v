...
module FAU ( 
  ...
  assign new_n84_ = (~x29 | ~x39) & ((x04 & x27) | x28 | ~x35);
  assign new_n85_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x39));
  assign z12 = (x40 & (new_n87_ | (~new_n66_ & x04))) | (~new_n66_ & ~x39);
  assign new_n87_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n91_ | (x27 & (new_n89_ | new_n90_));
  assign new_n89_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n90_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n91_ = x39 & (~x40 | (~x04 & ~x13 & (x30 | x32)));
  assign z14 = (~new_n93_ & (x04 | x13 | ~x39)) | new_n95_ | (x39 & ~x40);
  ...
  assign new_n101_ = x08 & ((x29 & x39) | (~x27 & ~x28 & x35));
  ...
  assign new_n105_ = (~x29 | ~x39) & (x28 | (x04 & x27));
  assign new_n106_ = (x27 | (x39 & ~x40)) & ~x28 & (x35 | ~x40) & (~x04 | ~x39);
  assign new_n107_ = ~x35 & (~x39 | (~x29 & x40));
