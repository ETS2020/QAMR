...
module FAU ( 
  ...
  assign new_n71_ = (x27 | (~x16 & (~x04 | x08))) & new_n66_ & (new_n72_ | ~x04);
  assign new_n72_ = ~x28 & x35;
  assign z03 = (~x16 & (~x21 | (~x27 & ~x37))) | (x27 & (~x21 | ~x28 | ~x35));
  assign z04 = (~x16 & (x21 | (~x27 & ~x37))) | (x27 & (x21 | ~x28 | ~x35));
  assign z05 = (~x16 & x37) | (x27 & (x28 | x37));
  assign z06 = (~x28 & ~x37) | (~x27 & (x16 | ~x37));
  assign z07 = (x16 & ~x27) | (~new_n78_ & x03);
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = new_n66_ | (x16 & ~x27);
  assign z09 = x34 & x27 & x11 & x26;
  assign z10 = (~new_n83_ & ~x04) | (x16 & ~x27) | (x06 & x27 & x37);
  assign new_n83_ = (~new_n84_ | ~x05) & (~x27 | new_n69_ | (new_n66_ ? ~x05 : ~x07));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n87_ & ~x16));
  assign new_n86_ = x27 & (~new_n72_ | x04) & (~new_n66_ | ~x08 | ~x29);
  assign new_n87_ = (x08 | x27) & (new_n72_ | new_n88_);
  ...
  assign new_n99_ = (~x16 | x27) & (new_n98_ | (x27 & (x37 | (x28 & x35))));
  ...
  assign new_n106_ = ~x28 & x35 & ((~x04 & x27) | (x08 & ~x16 & ~x27));
  assign z19 = (x16 & ~x27) | (~x09 & ~x30 & (new_n86_ | (~new_n108_ & ~x16)));
  assign new_n108_ = (x08 | x27) & (new_n88_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : x16)) & (new_n88_ | ((~x27 | x35) & (x16 | (x35 & (x27 | ~x28)))));
endmodule
