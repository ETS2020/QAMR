...
module FAU ( 
  ...
  assign z13 = ~x04 & ((x27 & (new_n91_ | (new_n92_ & ~x13))) | (new_n84_ & ~x13));
  assign new_n91_ = ~x18 & ~x19 & ~new_n89_ & x20;
  assign new_n92_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ~new_n95_ | (~new_n94_ & (~new_n66_ | x13));
  assign new_n94_ = ~new_n89_ & ~x18 & ~x19 & x20 & x27;
  ...
  assign z19 = ~x09 & ~x30 & ((~new_n104_ & ~new_n71_) | (~x08 & ~x27));
  assign new_n104_ = (x04 | x08) & (new_n101_ | (x04 & x27));
