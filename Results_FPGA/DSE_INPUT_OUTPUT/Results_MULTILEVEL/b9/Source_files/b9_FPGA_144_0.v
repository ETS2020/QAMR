...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x30 & (~x40 | (~x32 & (new_n69_ | ~x27))));
  ...
  assign z10 = (x27 & (new_n81_ | (~x04 & ~new_n69_ & ~new_n82_))) | (new_n83_ & ~x04);
  assign new_n81_ = x06 & ~new_n65_ & x37;
  assign new_n82_ = (~x07 | (x40 ? x39 : ~x30)) & (~x05 | ~x39 | ~x40);
  assign new_n83_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x30 & (~x40 | (~x09 & (new_n85_ | (~new_n86_ & ~x08))));
  assign new_n85_ = (~x29 | ~x39) & (x28 | ~x35 | (x04 & x27));
  assign new_n86_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = new_n88_ | (~x30 & ~x40) | (~new_n66_ & (x04 | ~x39 | ~x40));
  assign new_n88_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = ~new_n92_ | (x27 & (new_n91_ | (new_n90_ & ~x04)));
  assign new_n90_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n91_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n92_ = (x30 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  assign z14 = ~new_n97_ | (~new_n94_ & (x18 | x19 | ~x20));
  assign new_n94_ = x40 ? (~new_n95_ & new_n96_) : ~x30;
  assign new_n95_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = ~x04 & ~x13 & x39;
  assign new_n97_ = (~x40 | ((new_n66_ | new_n96_) & (~new_n98_ | x30))) & (~x30 | new_n66_ | x40);
  ...
  assign z18 = x30 | (x40 & (new_n103_ | new_n86_ | x09));
  assign new_n103_ = x08 & ((x29 & x39) | (~x27 & ~x28 & x35));
  assign z20 = ~x30 & (~x40 | (~new_n105_ & ~x09));
