...
module FAU ( 
  ...
  assign new_n87_ = (~x39 | (~x29 & x40)) & (~new_n73_ | (x04 & x27));
  assign new_n88_ = (x27 | (x39 & ~x40)) & (~x40 | (new_n73_ & ~x04));
  assign z12 = new_n90_ | (x39 & ~x40) | ((new_n66_ | ~x27) & (x04 | ~x39));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n92_ | (x39 & (~x40 | (~x04 & ~new_n85_ & ~x13)));
  ...
  assign new_n95_ = ~new_n66_ & x20 & x27 & ~x18 & ~x19;
  ...
  assign z18 = ~new_n102_ | (x08 & ((x29 & x39) | (new_n73_ & ~x27)));
  assign new_n102_ = ~x09 & (~new_n73_ | x04 | ~x27) & ~new_n69_ & ~x30;
