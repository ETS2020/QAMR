...
module FAU ( 
  ...
  assign z13 = ~x04 & ((x27 & (new_n90_ | (new_n91_ & ~x13))) | (new_n82_ & ~x13));
  assign new_n90_ = ~x18 & ~x19 & ~new_n88_ & x20;
  assign new_n91_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ((~new_n66_ | x13) & (~x27 | (~new_n93_ & ~x04))) | new_n94_ | (x04 & ~x27);
  assign new_n93_ = ~new_n88_ & ~x18 & ~x19 & x20;
  ...
  assign new_n102_ = (x08 | (x27 & (x04 | x35))) & (new_n85_ | ((x04 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
