...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n77_, new_n78_,
    new_n79_, new_n83_, new_n85_, new_n88_, new_n90_, new_n91_, new_n97_,
  ...
  assign z18 = (~new_n85_ & x08) | x09 | new_n77_ | x30;
  assign z19 = new_n77_ | (~x09 & ~x30 & (~x08 | (~new_n97_ & ~new_n98_)));
