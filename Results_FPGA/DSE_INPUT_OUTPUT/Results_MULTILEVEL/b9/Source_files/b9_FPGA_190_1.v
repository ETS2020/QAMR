...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n75_, new_n76_, new_n80_,
    new_n82_, new_n84_, new_n86_, new_n88_, new_n89_, new_n94_, new_n96_,
  ...
  assign z12 = x04 ? ~new_n84_ : (~new_n65_ | ~x10 | x27);
  assign new_n84_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n86_ & ~x04) | (~x18 & ~x19 & new_n84_ & x20);
  assign new_n86_ = ~x27 & (x13 | ~x39 | ~x40 | (~x30 & ~x32));
  ...
  assign z18 = (~new_n94_ & (x04 | ~x27)) | (~x28 & x35 & x08 & ~x27);
  assign new_n94_ = ~x09 & ~x30 & (~x39 | ~x40 | ~x08 | ~x29);
  assign z19 = ~x09 & ~x30 & (new_n96_ | (~new_n97_ & (~new_n65_ | ~x29)));
  assign new_n96_ = ~x08 & (x04 | ~x27);
  assign new_n97_ = x27 ? ~x04 : (~x28 & x35);
  assign z20 = (~x04 & x27) | (~x09 & ~x30 & (new_n99_ | new_n100_));
  assign new_n99_ = ~x08 & (~x27 | ~x35);
