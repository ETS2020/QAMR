...
module FAU ( 
  ...
  assign new_n71_ = (new_n69_ | ~x04) & new_n72_ & x27;
  assign new_n72_ = x39 & x40;
  assign z03 = (x27 & (~x28 | ~x35)) | ~x21 | (~x27 & (~x37 | x40));
  ...
  assign new_n83_ = (~new_n84_ | ~x05) & ((~new_n69_ & ~x36) | (new_n72_ ? ~x05 : ~x07));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = (~x27 | (((new_n87_ & x08) | (new_n69_ & ~x04)) & (~x04 | x40))) & (x40 | (new_n69_ & (x08 | x27)));
  assign new_n87_ = x29 & x39;
  assign z12 = (~new_n89_ & ~x37) | (~x27 & ~x40);
  assign new_n89_ = (new_n90_ | (x28 & x35)) & (x10 | ~x27 | x35 | x36);
  ...
  assign z18 = ~new_n104_ | (x08 & ((new_n72_ & x29) | (new_n69_ & ~x27)));
  assign new_n104_ = ~x09 & (x27 | ~x40) & ~x30 & (~new_n69_ | x04 | ~x27);
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (x08 | (x27 ? x35 : x40)) & (x35 | (x40 & (new_n87_ | ~x27))) & (x27 | ~x28 | x40);
