...
module FAU ( 
  ...
  assign z18 = ~new_n104_ | (x08 & ((new_n70_ & ~x27) | (new_n68_ & x29)));
  assign new_n104_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n70_ | x04 | ~x27);
  assign z19 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (~x27 | (new_n70_ & ~x04) | (new_n68_ & x08 & x29)) & (x04 | ((x08 | x27) & (new_n70_ | (new_n68_ & x29))));
