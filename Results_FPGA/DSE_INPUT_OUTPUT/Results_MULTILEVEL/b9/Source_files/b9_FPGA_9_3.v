...
module FAU ( 
  ...
  assign z07 = (~new_n79_ & x03) | (x20 & x27);
  ...
  assign new_n92_ = (new_n93_ | x27) & (x20 | ((~x27 | (x28 & (~x35 | ~x36))) & (new_n93_ | ~x28)));
  assign new_n93_ = ~x30 & ~x32;
  assign z14 = new_n95_ | x04 | x13 | ~new_n72_ | (x20 & x27);
