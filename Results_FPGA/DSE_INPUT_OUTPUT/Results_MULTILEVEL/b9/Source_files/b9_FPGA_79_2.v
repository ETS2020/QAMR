...
module FAU ( 
  ...
  assign z01 = new_n70_ | ~x04 | ~x27;
  assign new_n70_ = ~x30 & ~x32 & ~x36 & (x28 | ~x35);
  ...
  assign new_n83_ = (x36 | (~x28 & x35)) & (new_n68_ ? x05 : x07);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n86_ & ~x30);
  assign new_n86_ = (x04 | x28 | ~x35) & (~new_n68_ | ~x08 | ~x29);
  assign z12 = new_n88_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n88_ = (~new_n68_ | x04) & (~x27 | (~x37 & (~x28 | ~x35)));
