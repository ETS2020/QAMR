...
module FAU ( 
  ...
  assign z08 = new_n81_ | (x09 & ~x27);
  assign new_n81_ = x39 & x40;
  assign z09 = x34 & x27 & x11 & x26;
  assign z10 = new_n86_ | (~x04 & (new_n85_ | (x05 & new_n84_ & x39)));
  assign new_n84_ = x40 & (((x30 | x32) & (~x09 | x27)) | (~new_n69_ & x27));
  assign new_n85_ = x07 & x27 & ~new_n81_ & ~new_n69_;
  assign new_n86_ = x06 & x27 & x37;
  assign z11 = (~x27 & (x09 | (~x08 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
  ...
  assign new_n91_ = (~x09 | x27) & (new_n92_ | (x27 & (x37 | (x28 & x35))));
  assign new_n92_ = ~x04 & x39 & x40;
  assign z13 = (new_n96_ & ~x18) | (~x04 & ~x13 & new_n94_ & x39);
  assign new_n94_ = x40 & (((x30 | x32) & (~x09 | x27)) | (~new_n95_ & x27));
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x19 & x20 & x27 & (x37 | (x28 & x35));
  assign z14 = (x27 & (new_n100_ | (~new_n98_ & ~new_n102_))) | (~x09 & ~new_n101_ & ~x27);
  assign new_n98_ = new_n99_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n99_ = x39 & x40 & ~x04 & ~x13;
  assign new_n100_ = ~x37 & ((~x32 & ~x35 & x28 & ~x30) | (~new_n99_ & (~x28 | ~x35)));
  assign new_n101_ = ~x04 & ~x13 & new_n81_ & (x30 | x32);
  assign new_n102_ = ~x18 & ~x19 & x20;
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = x01 & x22 & ~x23 & (~x09 | x27);
  assign z17 = x01 & x22 & x23 & ~x24 & (~x09 | x27);
  assign z18 = (~new_n107_ & ~x09) | (x27 & (new_n108_ | x09));
  assign new_n107_ = ~x30 & (~x08 | (~new_n89_ & (x27 | x28 | ~x35)));
  assign new_n108_ = ~x04 & ~x28 & x35;
  assign z19 = (x09 & ~x27) | (~x30 & (new_n110_ | (~x08 & (~x27 | (~new_n108_ & ~x09)))));
  assign new_n110_ = ~new_n89_ & ((x28 & (~x09 | ~x27)) | (~x09 & (~x35 | (x04 & x27))));
  assign z20 = (x09 & ~x27) | (~x30 & (new_n112_ | (~x08 & (~x27 | (~x09 & ~x35)))));
  assign new_n112_ = ~new_n89_ & ((~x09 & ~x35) | (~x27 & x28));
endmodule
