...
module FAU ( 
  ...
  assign z01 = x04 ? (~x30 & ~x32 & (new_n68_ | ~x27)) : x27;
  assign new_n68_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n70_ | (~x02 & (~x08 | ~x29));
  assign new_n70_ = (~x04 | (~x28 & x35)) & new_n71_ & (x27 | (x04 & x08));
  ...
  assign new_n82_ = ~new_n68_ & (new_n71_ ? x05 : x07);
  assign new_n83_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n85_ & ~x30;
  assign new_n85_ = ((~x28 & x35) | ((new_n86_ | (~x04 & ~x27)) & (x08 | ~x27))) & (~x04 | (x08 & (new_n86_ | ~x27)));
