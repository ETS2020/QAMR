...
module FAU ( 
  ...
  assign z18 = ~new_n102_ | (x08 & ((new_n69_ & ~x27) | (new_n72_ & x29)));
  assign new_n102_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n69_ | x04 | ~x27);
  assign z20 = (x04 & ~x27) | (~x09 & ~new_n104_ & ~x30);
  assign new_n104_ = (x08 | (x27 & x35)) & ((new_n72_ & x29) | (x35 & (x27 | ~x28)));
