...
module FAU ( 
  ...
  assign z13 = ~new_n89_ | (~x18 & new_n91_ & ~x19);
  assign new_n89_ = x04 ? x27 : (x13 | ~x39 | new_n90_ | ~x40);
  ...
  assign z18 = ~new_n101_ | (x08 & (new_n102_ | (new_n68_ & ~x27)));
  assign new_n101_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n68_ | x04 | ~x27);
  assign new_n102_ = x29 & x39 & x40;
  assign z19 = ~x09 & ~x30 & ((new_n85_ & x27) | (~new_n104_ & ~x04));
