...
module FAU ( 
  ...
  assign z05 = x37 | (x27 & x28) | (~x03 & ~x27);
  ...
  assign new_n84_ = x40 & (((x30 | x32) & (x03 | x27)) | (~new_n70_ & x27));
  assign new_n85_ = x07 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n86_ = x06 & x27 & x37;
  assign z11 = (~x27 & (~x03 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
  assign new_n88_ = (x08 | (new_n73_ & ~x04)) & ((new_n66_ & x29) | (new_n73_ & (~x04 | ~x27)));
  assign z12 = new_n90_ | (~x03 & ~x27) | ((~new_n66_ | x04) & (new_n68_ | ~x27));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n92_ | (new_n93_ & ~x04))) | (~x03 & ~x27) | (new_n94_ & ~x04);
  ...
  assign new_n98_ = (x03 | x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = (~x03 & ~x27) | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~x24 & (x03 | x27);
  assign z18 = ~new_n104_ | (x08 & ((new_n73_ & ~x27) | (new_n66_ & x29)));
  assign new_n104_ = ~x09 & (x03 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z20 = (~x03 & ~x27) | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = (x08 | (x27 & x35)) & ((new_n66_ & x29) | (x35 & (x27 | ~x28)));
  assign z19 = (~x27 & (~x03 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
endmodule
