...
module FAU ( 
  ...
  assign new_n73_ = (~x04 | (new_n71_ & (x08 | x27))) & new_n68_ & (~x06 | ~x27);
  ...
  assign z10 = ~x04 & (new_n85_ | (x05 & x39 & ~new_n84_ & x40));
  assign new_n84_ = (x06 | ((~x27 | (~new_n71_ & ~x36)) & ~x30 & ~x32)) & (x27 | (~x30 & ~x32));
  assign new_n85_ = ~x06 & x07 & x27 & ~new_n68_ & (new_n71_ | x36);
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | ((new_n71_ | (x06 & x27)) & (~x04 | x06 | ~x27))) & (x08 | (x27 & (x06 | (new_n71_ & ~x04))));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | (x06 & x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & ~x06) | (new_n96_ & ~x04);
  ...
  assign z14 = (~new_n101_ & ~x27) | (~x06 & (new_n100_ | (~new_n98_ & ~new_n102_)));
  ...
  assign new_n108_ = ~x28 & x35 & ((~x04 & ~x06 & x27) | (x08 & ~x27));
  assign z19 = (x06 & x27) | (~x09 & ~new_n110_ & ~x30);
  assign new_n110_ = (new_n88_ | (new_n71_ & (~x04 | ~x27))) & (x08 | (new_n71_ & ~x04 & x27));
