...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n76_, new_n77_, new_n81_,
    new_n83_, new_n86_, new_n88_, new_n89_, new_n94_, new_n96_, new_n98_,
    new_n99_;
  ...
  assign new_n88_ = x20 & x27 & ~x18 & ~x19;
  ...
  assign z19 = (~x04 & x27) | (~x09 & ~x30 & (new_n96_ | ~x08));
  assign new_n96_ = (~x29 | ~x39 | ~x40) & (x27 | ~x35 | (~x27 & x28));
