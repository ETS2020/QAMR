...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n112_;
  assign z00 = (x10 & (new_n65_ | ~x16)) | (x27 & (~x16 | (~new_n67_ & ~x15)));
  ...
  assign z01 = (~x27 & (~x10 | (~x30 & ~x32))) | ~x04 | (~x30 & new_n70_ & ~x32);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = (x27 | (x10 & (~x04 | x08))) & new_n66_ & (new_n73_ | ~x04);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (x10 & (~x21 | (~x27 & ~x37))) | (x27 & (~x21 | ~x28 | ~x35));
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | (~x27 & (~x10 | ~x37));
  assign z05 = x37 | (x27 & x28) | (~x10 & ~x27);
  assign z06 = ~x37 & (x27 ? ~x28 : x10);
  assign z07 = (~x10 & ~x27) | (~new_n79_ & x03);
  ...
  assign new_n108_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x10 & ~x27));
  assign z19 = ~x09 & ~x30 & (new_n88_ | (~new_n110_ & x10));
  assign new_n110_ = (x08 | x27) & (new_n90_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n112_ & ~x30;
  assign new_n112_ = (x08 | (x27 ? x35 : ~x10)) & (new_n90_ | ((~x27 | x35) & (~x10 | (x35 & (x27 | ~x28)))));
endmodule
