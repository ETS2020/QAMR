...
module FAU ( 
  ...
  assign z10 = (x04 & (~x27 | (x06 & x37))) | (~x04 & (new_n83_ | (new_n82_ & x27))) | (x06 & x27 & x37);
  ...
  assign new_n85_ = (~new_n68_ | x04) & (~new_n71_ | ~x08 | ~x29);
  ...
  assign z19 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n85_ & ~x30);
endmodule
