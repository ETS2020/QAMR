...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n99_, new_n104_, new_n106_, new_n108_;
  ...
  assign z07 = (~x14 & x27) | (x03 & ((new_n78_ & ~x31) | (~new_n79_ & ~x14)));
  ...
  assign new_n83_ = x40 & ((x14 & ((~new_n70_ & x27) | x30 | x32)) | (~x27 & (x30 | x32)));
  assign new_n84_ = x07 & x14 & x27 & ~new_n68_ & ~new_n70_;
  assign new_n85_ = x06 & x14 & x27 & x37;
  assign z11 = (~x14 & x27) | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (new_n88_ | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | (~x14 & x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & ((new_n93_ & ~x04) | new_n92_ | ~x14)) | (new_n94_ & ~x04);
  ...
  assign new_n98_ = (x14 | ~x27) & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x27 & (~x14 | (x12 & x26 & x34));
  assign z16 = (~x14 & x27) | (x01 & x22 & ~x23);
  assign z17 = (~x14 & x27) | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n104_ | (x08 & (new_n88_ | (new_n73_ & ~x27)));
  assign new_n104_ = ~x09 & ~x30 & (~x27 | (x14 & (~new_n73_ | x04)));
  assign z19 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (new_n88_ | ((new_n73_ | (~x14 & x27)) & (~x04 | ~x14 | ~x27))) & (x08 | (x27 & (~x14 | (new_n73_ & ~x04))));
  assign z20 = (~x14 & x27) | (~x09 & ~new_n108_ & ~x30);
