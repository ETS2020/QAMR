...
module FAU ( 
  ...
  assign new_n97_ = ~x13 & x19 & x39 & x40 & (x30 | x32);
  assign z14 = new_n99_ | new_n102_ | (~x27 & (~x19 | (~x30 & ~x32)));
  ...
  assign z18 = ~new_n107_ | (x08 & (new_n90_ | (new_n73_ & ~x27)));
  assign new_n107_ = ~x09 & (x19 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = (~x19 & ~x27) | (~x09 & ~x30 & (new_n88_ | (~new_n109_ & x19)));
  assign new_n109_ = (x08 | x27) & (new_n90_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 ? x35 : ~x19)) & (new_n90_ | ((~x27 | x35) & (~x19 | (x35 & (x27 | ~x28)))));
endmodule
