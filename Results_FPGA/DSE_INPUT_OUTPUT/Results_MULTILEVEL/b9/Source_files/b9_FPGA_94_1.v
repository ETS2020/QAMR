...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (x22 | ~x27)) | (~x15 & x22 & ~new_n67_ & x27);
  ...
  assign z07 = x03 & ~new_n78_ & (x22 | ~x27);
  ...
  assign new_n84_ = x07 & x22 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n85_ = x06 & x22 & x27 & x37;
  ...
  assign z12 = new_n90_ | (~x22 & x27) | ((~new_n66_ | x04) & (new_n68_ | ~x27));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & ((new_n93_ & ~x04) | new_n92_ | ~x22)) | (new_n94_ & ~x04);
  ...
  assign new_n98_ = (x22 | ~x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign new_n104_ = ~x09 & ~x30 & (~x27 | (x22 & (~new_n73_ | x04)));
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (x08 | (x27 & (~x22 | x35))) & (new_n88_ | ((~x22 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
