...
module FAU ( 
  ...
  assign new_n95_ = ~x19 & x20 & ~new_n66_ & x36;
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n99_ | (~new_n98_ & (~z08 | x04 | x13));
  assign new_n98_ = ~new_n66_ & x20 & x27 & ~x18 & ~x19;
  assign new_n99_ = ~new_n67_ & (x30 | x32 | (x27 & (new_n100_ | ~x28)));
  ...
  assign new_n108_ = ((new_n71_ & (~x04 | ~x27)) | (z08 & x29)) & (x08 | (new_n71_ & ~x04 & x27));
  assign z20 = new_n67_ | (~x09 & ~new_n110_ & ~x30);
  assign new_n110_ = (x08 | (x27 & x35)) & ((z08 & x29) | (x35 & (x27 | ~x28)));
  assign z06 = ~z05;
endmodule
