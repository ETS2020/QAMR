...
module FAU ( 
  ...
  assign z00 = ~new_n69_ & (~x16 | (~x15 & (new_n67_ | (~new_n65_ & x27))));
  ...
  assign z09 = (~x20 & ~x34) | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n69_ & ((~new_n85_ & ~x04) | (x06 & x27 & x37));
  ...
  assign new_n88_ = ((new_n68_ & x29) | (new_n74_ & (~x04 | ~x27))) & (x08 | (new_n74_ & ~x04 & x27));
  assign z12 = new_n90_ | new_n69_ | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x20 & (new_n92_ | (~x04 & new_n86_ & ~x13))) | (~x04 & new_n94_ & ~x13);
  assign new_n92_ = x27 & ((new_n93_ & ~x04) | (~x18 & ~new_n66_ & ~x19));
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = x34 & x39 & ~new_n95_ & x40;
  ...
  assign new_n99_ = ~new_n69_ & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = ~new_n105_ | (x08 & ((new_n74_ & ~x27) | (new_n68_ & x29)));
  assign new_n105_ = ~x09 & (~new_n74_ | x04 | ~x27) & ~new_n69_ & ~x30;
  assign z19 = ~x09 & ~x30 & ~new_n88_ & ~new_n69_;
  assign z20 = ~x09 & ~x30 & ~new_n108_ & ~new_n69_;
