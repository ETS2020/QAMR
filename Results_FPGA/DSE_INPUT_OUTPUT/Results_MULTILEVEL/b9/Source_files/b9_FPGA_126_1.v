...
module FAU ( 
  ...
  assign z07 = x03 & ~new_n76_ & ~new_n67_;
  ...
  assign z12 = new_n89_ | (~x39 & x40) | ((x04 | ~x40) & (new_n88_ | ~x27));
  ...
  assign z14 = (~new_n96_ & (x04 | x13 | ~x40)) | new_n97_ | (~x39 & x40);
  assign new_n96_ = ~new_n88_ & ~x18 & ~x19 & x20 & x27;
  ...
  assign new_n106_ = (new_n107_ | x08) & (new_n85_ | (x40 & (x29 | ~x39)));
  assign new_n107_ = (x27 | (~x39 & x40)) & (~x39 | (~x28 & x35 & (~x04 | ~x40)));
  assign z20 = new_n67_ | (~x09 & ~new_n109_ & ~x30);
  assign new_n109_ = (x08 | (x27 & x35)) & ((x29 & x40) | ((x27 | ~x28) & x35));
  assign z05 = ~z06;
endmodule
