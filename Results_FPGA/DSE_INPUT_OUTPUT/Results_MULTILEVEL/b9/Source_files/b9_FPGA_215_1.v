...
module FAU ( 
  ...
  assign new_n78_ = ~x14 & ~new_n68_ & (x00 | x25 | ~x38);
  assign new_n79_ = (x17 ? x15 : ~x40) & (~x38 | (x00 & ~x25));
  assign z08 = x40 & x17 & x39;
  assign z09 = x11 & x26 & x27 & ~new_n68_ & x34;
  assign z10 = (new_n84_ & ~x04) | (x27 & (new_n83_ | (~x04 & ~new_n70_ & ~new_n86_)));
  assign new_n83_ = x06 & ~new_n68_ & x37;
  assign new_n84_ = new_n85_ & x05;
  assign new_n85_ = x17 & x39 & x40 & (x30 | x32);
  assign new_n86_ = (~x07 | (x40 & (~x17 | x39))) & (~x39 | ~x40 | ~x05 | ~x17);
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n90_ & ~x08));
  assign new_n88_ = ~new_n89_ & (~x40 | (x17 & (~x29 | ~x39)));
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n90_ = (x27 | (~x17 & x40)) & (~x17 | (~x04 & ~x28 & x35));
  assign z12 = (x17 & (new_n93_ | (~new_n92_ & (x04 | ~x39)))) | (~new_n92_ & ~x40);
  assign new_n92_ = ~new_n66_ & x27;
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n98_ | (x27 & ((new_n97_ & ~x18) | (~new_n95_ & x17)));
  ...
  assign z14 = (~new_n100_ & (new_n101_ | ~new_n102_)) | new_n103_ | new_n68_ | (~new_n92_ & ~new_n102_);
  ...
  assign z18 = (~new_n108_ & x08) | ~new_n110_ | new_n68_ | x09;
  assign new_n108_ = ~new_n109_ & (x27 | x28 | ~x35);
  assign new_n109_ = x29 & x39 & x40;
  assign new_n110_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = new_n68_ | (~x09 & ~new_n112_ & ~x30);
  assign new_n112_ = (new_n109_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign z20 = new_n68_ | (new_n114_ & ~x09);
  assign new_n114_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n109_ & (~x35 | (~x27 & x28))));
endmodule
