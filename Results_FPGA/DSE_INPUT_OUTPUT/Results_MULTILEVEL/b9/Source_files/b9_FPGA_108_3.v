...
module FAU ( 
  ...
  assign z09 = x34 & x27 & x26 & x11 & ~x19;
  ...
  assign new_n100_ = ~x27 & (x04 | x13 | ~new_n68_ | (~x30 & ~x32));
  ...
  assign new_n105_ = ~x09 & ~x30 & (~x27 | (~x19 & (~new_n73_ | x04)));
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (x08 | (x27 & (x19 | x35))) & (new_n88_ | ((x19 | x35) & (x27 | (~x28 & x35))));
