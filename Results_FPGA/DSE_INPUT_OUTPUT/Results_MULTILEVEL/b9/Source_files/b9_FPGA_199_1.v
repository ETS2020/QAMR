...
module FAU ( 
  ...
  assign z07 = (~x25 & x27) | (~new_n79_ & x03);
  ...
  assign new_n88_ = (new_n89_ | ((new_n73_ | (~x25 & x27)) & (~x04 | ~x25 | ~x27))) & (x08 | (x27 & (~x25 | (new_n73_ & ~x04))));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | ((~new_n68_ | x04) & (~x27 | (new_n66_ & x25)));
  assign new_n91_ = ~x10 & (~x27 | (x25 & ~x35 & ~x36 & ~x37));
  assign z13 = (x25 & ((~new_n93_ & x27) | (new_n95_ & ~x04))) | (new_n96_ & ~x04);
  assign new_n93_ = (~new_n94_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x13 & x28 & x39 & x40 & (x30 | x32);
  ...
  assign new_n100_ = (x25 | ~x27) & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = new_n107_ | (~new_n106_ & (x25 | ~x27));
  assign new_n106_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n107_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & x25 & x27));
  assign z19 = (~x25 & x27) | (~x09 & ~x30 & (new_n109_ | new_n110_));
  assign new_n109_ = ~new_n89_ & ((~x35 & (x25 | ~x27)) | x28 | (x04 & x27));
  assign new_n110_ = ~x08 & (x04 | ~x27 | x28 | (x25 & ~x35));
