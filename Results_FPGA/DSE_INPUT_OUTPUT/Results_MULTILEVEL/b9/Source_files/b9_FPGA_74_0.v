...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n93_, new_n94_, new_n95_, new_n100_, new_n102_;
  ...
  assign new_n85_ = ~x30 & ((~new_n69_ & ((~new_n86_ & (x04 | x27)) | (~x08 & x27))) | (x04 & (~x08 | (~new_n86_ & x27))));
  ...
  assign new_n102_ = (x08 | (x27 & x35)) & (new_n86_ | (x35 & (x27 | ~x28)));
