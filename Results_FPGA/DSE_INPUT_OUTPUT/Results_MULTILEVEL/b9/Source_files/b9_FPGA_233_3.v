...
module FAU ( 
  ...
  assign z11 = ~x09 & ~x30 & ((~new_n85_ & ~new_n71_) | (~x08 & ~x27));
  assign new_n85_ = (x04 | x08) & ((x04 & x27) | (new_n66_ & x29));
  assign z12 = (~x10 & (new_n87_ | ~x27)) | (x04 & ~x27) | (~new_n66_ & (~x27 | (new_n88_ & ~x04)));
  assign new_n87_ = ~x04 & ~x35 & ~x36 & ~x37;
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign z13 = ~x04 & ((x27 & (new_n90_ | (new_n91_ & ~x13))) | (new_n83_ & ~x13));
  assign new_n90_ = ~x18 & ~x19 & ~new_n88_ & x20;
  assign new_n91_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ~new_n94_ | (~new_n93_ & (~new_n66_ | x13));
  assign new_n93_ = ~new_n88_ & ~x18 & ~x19 & x20 & x27;
  ...
  assign z18 = ~new_n100_ | (x08 & (new_n71_ | (new_n66_ & x29)));
  assign new_n100_ = (~x27 | (~new_n71_ & ~x04)) & ~x09 & ~x30;
  assign z19 = (x04 & x27) | (~x09 & ~x30 & (new_n102_ | (~x08 & ~x27)));
  assign new_n102_ = ~new_n71_ & (~new_n66_ | ~x08 | ~x29);
