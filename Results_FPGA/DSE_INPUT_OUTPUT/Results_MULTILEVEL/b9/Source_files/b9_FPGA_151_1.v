...
module FAU ( 
  ...
  assign new_n85_ = x05 & x26 & x39 & x40 & (x30 | x32);
  assign z11 = (x40 & (~x26 | (new_n89_ & ~x09 & ~x30))) | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (new_n88_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (x27 & ~x28 & x35));
  ...
  assign new_n95_ = x26 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n100_ | ((x18 | x19 | ~x20) & (new_n97_ | ~x40));
  assign new_n97_ = x26 & (new_n98_ | ~new_n99_);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (new_n68_ | x40) & (~x26 | (~new_n101_ & (new_n68_ | new_n99_)));
  ...
  assign z18 = (~new_n106_ & (x26 | ~x40)) | (new_n88_ & x08 & x26);
  assign new_n106_ = ~new_n107_ & ~x09 & ~x30;
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = ~x09 & ~x30 & (new_n109_ | (~new_n111_ & ~x08));
  assign new_n109_ = ~new_n110_ & (~x40 | (x26 & (~x29 | ~x39)));
  assign new_n110_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n111_ = (x27 | (~x26 & x40)) & (~x26 | (~x28 & x35 & (~x04 | ~x40)));
  assign z20 = new_n67_ | (new_n113_ & ~x09);
  assign new_n113_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n88_ & (~x35 | (~x27 & x28))));
endmodule
