...
module FAU ( 
  ...
  assign z10 = (~new_n84_ & ~x04) | (x27 & (x10 | (x06 & x37)));
  ...
  assign z12 = ((~new_n66_ | x04) & (~x27 | (new_n68_ & ~x10))) | (~x10 & (new_n90_ | ~x27));
  assign new_n90_ = ~x35 & ~x36 & ~x37;
  assign z13 = (~x10 & ((~new_n92_ & x27) | (new_n94_ & ~x04))) | (new_n95_ & ~x04);
  ...
  assign new_n99_ = (~x10 | ~x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign new_n106_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & ~x10 & x27));
