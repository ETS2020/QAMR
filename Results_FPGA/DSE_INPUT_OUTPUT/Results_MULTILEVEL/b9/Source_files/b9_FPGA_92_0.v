// Benchmark "FAU" written by ABC on Mon Aug 17 20:14:08 2020
...
module FAU ( 
  ...
  assign new_n84_ = x40 & (((x22 | x27) & (x30 | x32)) | (~new_n70_ & x27));
  assign new_n85_ = x07 & x27 & ~new_n68_ & ~new_n70_;
  assign new_n86_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & ((new_n88_ & x27) | (~new_n89_ & x22));
  assign new_n88_ = (x04 | x28 | ~x35) & (~new_n68_ | ~x08 | ~x29);
  assign new_n89_ = (x08 | x27) & (new_n90_ | (~x28 & x35));
  assign new_n90_ = x29 & x39 & x40;
  assign z12 = new_n92_ | ((x27 ? new_n66_ : x22) & (~new_n68_ | x04));
  assign new_n92_ = ~x10 & ((x22 & ~x27) | (~x36 & ~x37 & x27 & ~x35));
  assign z13 = (x27 & (new_n94_ | (~x04 & new_n95_ & ~x13))) | (~x04 & new_n97_ & ~x13);
  assign new_n94_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n95_ = new_n96_ & x39;
  assign new_n96_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n97_ = x22 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | new_n102_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = ~new_n100_ & new_n68_ & ~x04 & ~x13;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = (x22 | x27) & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  assign new_n102_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = (~x22 & ~x27) | (x01 & x22 & ~x23);
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = new_n108_ | (~new_n107_ & (x22 | x27));
  assign new_n107_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n108_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x22 & ~x27));
  assign z19 = (~x27 & (~x22 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n110_ & ~x30);
  assign new_n110_ = (x08 | (~x04 & ~x28 & x35)) & (new_n90_ | (~x28 & x35 & (~x04 | ~x27)));
  assign z20 = (~x22 & ~x27) | (~x09 & ~new_n112_ & ~x30);
  assign new_n112_ = (x08 | (x27 & x35)) & (new_n90_ | (x35 & (x27 | ~x28)));
endmodule
