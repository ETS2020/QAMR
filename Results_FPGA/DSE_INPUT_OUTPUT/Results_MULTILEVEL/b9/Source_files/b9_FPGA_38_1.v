...
module FAU ( 
  ...
  assign z10 = (~x04 & x05 & new_n82_ & ~x27) | (x27 & x37 & x04 & x06);
  ...
  assign z13 = x04 ? (~x18 & ~x19 & new_n87_ & x20) : new_n89_;
  assign new_n89_ = ~x13 & ~x27 & x39 & x40 & (x30 | x32);
  assign z14 = new_n92_ | (x04 & (~new_n91_ | (~x37 & (~x28 | ~x35))));
  assign new_n91_ = ~x18 & ~x19 & x20 & x27;
  assign new_n92_ = ~x27 & (~x39 | ~x40 | x13 | (~x30 & ~x32));
