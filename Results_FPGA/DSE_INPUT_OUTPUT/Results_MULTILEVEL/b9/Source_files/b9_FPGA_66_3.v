...
module FAU ( 
  ...
  assign new_n69_ = x13 & x30;
  assign z01 = (~x30 & ~x32 & (new_n71_ | ~x27)) | ~x04 | (x13 & x30);
  assign new_n71_ = ~x36 & (x28 | ~x35);
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n73_ | ~new_n68_ | new_n69_;
  ...
  assign z10 = (x27 & (new_n85_ | (~x04 & ~new_n84_ & ~new_n71_))) | (new_n86_ & ~x04);
  assign new_n84_ = (~x07 | new_n68_ | (x13 & x30)) & (~new_n68_ | ~x05 | x30);
  assign new_n85_ = x06 & ~new_n69_ & x37;
  assign new_n86_ = x05 & x39 & x40 & (x30 ? ~x13 : x32);
  assign z11 = (x13 & x30) | (~x09 & ~new_n88_ & ~x30);
  ...
  assign new_n93_ = ~x13 & (new_n94_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n94_ = ~x04 & x39 & x40 & (~x28 | (x35 & x36));
  ...
  assign new_n100_ = (~x13 | ~x30) & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign new_n106_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = ~x09 & ~new_n88_ & ~x30;
  assign z20 = (x13 & x30) | (~x09 & ~new_n109_ & ~x30);
