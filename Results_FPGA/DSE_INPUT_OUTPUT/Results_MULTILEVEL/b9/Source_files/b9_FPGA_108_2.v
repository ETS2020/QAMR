...
module FAU ( 
  ...
  assign z14 = (x27 & (new_n99_ | (~new_n97_ & ~new_n101_))) | (~x19 & ~new_n100_ & ~x27);
  ...
  assign new_n106_ = ~x09 & (~x19 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = ~x09 & ~x30 & (new_n87_ | (~new_n108_ & ~x19));
  assign new_n108_ = (x08 | x27) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : x19)) & (new_n89_ | ((~x27 | x35) & (x19 | (x35 & (x27 | ~x28)))));
endmodule
