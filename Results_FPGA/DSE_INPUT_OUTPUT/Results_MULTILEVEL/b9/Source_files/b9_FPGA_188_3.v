...
module FAU ( 
  ...
  assign new_n87_ = ~new_n88_ & (~x40 | (~x03 & (~x29 | ~x39)));
  ...
  assign z13 = (~new_n93_ & x27) | (~x03 & ~x04 & new_n85_ & ~x13);
  ...
  assign new_n100_ = ~new_n67_ & (new_n68_ | (new_n84_ & ~x04 & ~x13));
  ...
  assign new_n106_ = ~x03 & x08 & new_n84_ & x29;
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = ~x09 & ~x30 & (new_n87_ | (~new_n109_ & ~x08));
  assign new_n109_ = (x27 | (x03 & x40)) & (x03 | (~x28 & x35 & (~x04 | ~x40)));
  assign z20 = new_n67_ | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = (x08 | (x27 & x35)) & ((new_n84_ & x29) | (x35 & (x27 | ~x28)));
endmodule
