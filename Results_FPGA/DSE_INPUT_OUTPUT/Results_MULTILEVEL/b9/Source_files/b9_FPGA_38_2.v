...
module FAU ( 
  ...
  assign z14 = new_n93_ | (new_n98_ & ~x04) | (~new_n96_ & ~x37);
  assign new_n93_ = ~new_n94_ & (x04 ? x27 : (new_n95_ | ~new_n72_ | x13));
  assign new_n94_ = ~x18 & ~x19 & x20;
  assign new_n95_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = (new_n97_ | (x28 & x35)) & (x04 | ~x28 | x30 | x32 | x35);
  assign new_n97_ = x04 ? ~x27 : (~x13 & x39 & x40);
  assign new_n98_ = ~x27 & (~new_n72_ | x13 | (~x30 & ~x32));
  ...
  assign new_n105_ = ~new_n106_ & ((~x35 & (~x04 | x27)) | x04 | x28);
  assign new_n106_ = x39 & x40 & x08 & x29;
  assign z20 = ~x09 & ~new_n108_ & ~x30;
  assign new_n108_ = (x04 | (~new_n109_ & (x08 | (x27 & x35)))) & (~x27 | new_n106_ | x35);
  assign new_n109_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
endmodule
