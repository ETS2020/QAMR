...
module FAU ( 
  ...
  assign z01 = (~x27 & (x18 | (~x30 & ~x32))) | ~x04 | (~x30 & new_n70_ & ~x32);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = new_n73_ & (x27 | (~x18 & (~x04 | x08)));
  assign new_n73_ = x39 & x40 & (~x04 | (~x28 & x35));
  assign z03 = (~x18 & (~x21 | (~x27 & ~x37))) | (x27 & (~x21 | ~x28 | ~x35));
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | (~x27 & (x18 | ~x37));
  assign z05 = x37 | (x18 & ~x27) | (x27 & x28);
  assign z06 = ~x37 & (x27 ? ~x28 : ~x18);
  assign z07 = (~new_n79_ & x03) | (x18 & ~x27);
  ...
  assign z11 = (~x27 & (x18 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n87_ & ~x30);
  ...
  assign z13 = (~new_n92_ & x27) | (~x04 & ~x13 & new_n85_ & ~x18);
  ...
  assign new_n105_ = ~x28 & x35 & ((~x04 & x27) | (x08 & ~x18 & ~x27));
  assign z19 = (x18 & ~x27) | (~x09 & ~x30 & ((new_n107_ & x27) | (~new_n108_ & ~x18)));
  assign new_n107_ = (x04 | x28 | ~x35) & (~new_n66_ | ~x08 | ~x29);
  assign new_n108_ = (new_n88_ | (x35 & (x27 | ~x28))) & (x08 | x27);
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : x18)) & (new_n88_ | ((~x27 | x35) & (x18 | (x35 & (x27 | ~x28)))));
endmodule
