...
module FAU ( 
  ...
  assign new_n68_ = x27 & ~x30 & ~x32 & ~x36 & (x28 | ~x35);
  assign z02 = (x27 & (new_n70_ | ~new_n71_ | (x04 & (x28 | ~x35)))) | (~x04 & (new_n70_ | ~new_n71_));
  ...
  assign new_n82_ = (x36 | (~x28 & x35)) & (new_n71_ ? x05 : x07);
  assign new_n83_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n85_ & ~x30);
  assign new_n85_ = (x04 | x28 | ~x35) & (~new_n71_ | ~x08 | ~x29);
  ...
  assign z19 = ~x09 & ~x30 & ((new_n85_ & x27) | (~new_n105_ & ~x04));
