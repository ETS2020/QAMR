...
module FAU ( 
  ...
  assign new_n81_ = ~x04 & ~new_n69_ & ((x05 & x39 & x40) | (x07 & ~x40));
  assign new_n82_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n65_ | (~x09 & ~x30 & (new_n84_ | new_n85_));
  assign new_n84_ = (~x29 | ~x40) & ((x04 & x27) | x28 | ~x35);
  assign new_n85_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = (x39 & (new_n87_ | (~new_n66_ & x04))) | (~new_n66_ & ~x40);
  assign new_n87_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n91_ | (x27 & (new_n89_ | new_n90_));
  assign new_n89_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n90_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n91_ = x40 & (~x39 | (~x04 & ~x13 & (x30 | x32)));
  assign z14 = (~new_n93_ & (x04 | x13 | ~x40)) | new_n95_ | (~x39 & x40);
  assign new_n93_ = new_n94_ & (x37 | (x28 & x35));
  assign new_n94_ = ~x18 & ~x19 & x20 & x27;
  assign new_n95_ = ~x30 & ~x32 & (~x27 | (~new_n96_ & x28));
  ...
  assign z18 = new_n101_ | ~new_n102_ | new_n65_ | x30;
  assign new_n101_ = x08 & ((x29 & x40) | (~x27 & ~x28 & x35));
  assign new_n102_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = new_n65_ | (new_n104_ & ~x09);
  assign new_n104_ = ~x30 & (new_n105_ | new_n107_ | (~new_n106_ & ~x08));
  assign new_n105_ = (~x29 | ~x40) & (x28 | (x04 & x27));
  assign new_n106_ = (x27 | (~x39 & x40)) & ~x28 & (x35 | ~x39) & (~x04 | ~x40);
  assign new_n107_ = ~x35 & (~x40 | (~x29 & x39));
