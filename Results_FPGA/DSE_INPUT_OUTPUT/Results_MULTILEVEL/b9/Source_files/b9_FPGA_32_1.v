...
module FAU ( 
  ...
  assign z14 = new_n100_ | (x20 & (new_n99_ | (~new_n97_ & (x18 | x19))));
  ...
  assign new_n100_ = ~x27 & (x04 | x13 | ~new_n66_ | (~x30 & ~x32));
  ...
  assign new_n105_ = ~x09 & ~x30 & (~x27 | (x20 & (~new_n73_ | x04)));
  assign z19 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (new_n89_ | ((new_n73_ | (~x20 & x27)) & (~x04 | ~x20 | ~x27))) & (x08 | (x27 & (~x20 | (new_n73_ & ~x04))));
  assign z20 = (~x20 & x27) | (~x09 & ~new_n109_ & ~x30);
