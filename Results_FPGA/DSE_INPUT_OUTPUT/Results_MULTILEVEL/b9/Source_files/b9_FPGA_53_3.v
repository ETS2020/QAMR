...
module FAU ( 
  ...
  assign z03 = (x27 & (x25 | ~x28 | ~x35)) | ~x21 | (~x27 & ~x37);
  assign z04 = (x21 & (~x25 | ~x27)) | (~x27 & ~x37) | (~x25 & x27 & (~x28 | ~x35));
  assign z05 = (~x25 & (x37 | (x27 & x28))) | (~x27 & x37);
  ...
  assign z12 = new_n91_ | (x25 & x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & ~x25) | (new_n97_ & ~x04);
  ...
  assign z14 = (~new_n102_ & ~x27) | (~x25 & (new_n101_ | (~new_n99_ & ~new_n103_)));
  ...
  assign z19 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (new_n89_ | ((new_n73_ | (x25 & x27)) & (~x04 | x25 | ~x27))) & (x08 | (x27 & (x25 | (new_n73_ & ~x04))));
