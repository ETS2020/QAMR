...
module FAU ( 
  ...
  assign new_n66_ = ~x04 & x39 & (x36 | (x35 & x40));
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n72_ | ~x39 | ~x40;
  ...
  assign z07 = x03 & ~new_n77_ & ~new_n68_;
  assign new_n77_ = (~new_n78_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n78_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = x40 ? x39 : x36;
  assign z09 = new_n68_ | (x11 & x26 & x27 & x34);
  assign z10 = new_n85_ | (x27 & (new_n82_ | (x06 & ~new_n68_ & x37)));
  assign new_n82_ = ~x04 & (new_n84_ | (~new_n83_ & x40));
  assign new_n83_ = (~x05 | ~x39 | (~x36 & (x28 | ~x35))) & (~x07 | ~x36 | x39);
  assign new_n84_ = x07 & ~x28 & x35 & ~x36 & (~x39 | ~x40);
  assign new_n85_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & (x40 ? (~x29 | ~x39) : ~x36);
  assign new_n88_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n89_ = (x27 | (x36 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n91_ | (~new_n92_ & (x40 ? (x04 | ~x39) : ~x36));
  assign new_n91_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n95_ | (new_n94_ & ~x04))) | new_n68_ | (new_n96_ & ~x04);
  assign new_n94_ = ~x13 & x39 & ((x35 & x36) | (~x28 & x40));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n98_ & (new_n99_ | ~new_n100_)) | new_n101_ | new_n68_ | (~new_n92_ & ~new_n100_);
  ...
  assign z18 = new_n107_ | (~new_n68_ & (new_n106_ | x09 | x30));
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n107_ = x39 & x40 & x08 & x29;
  assign z19 = new_n68_ | (~x09 & ~new_n109_ & ~x30);
  assign new_n109_ = (new_n110_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (~x28 & x35 & ~x04 & x27));
  assign new_n110_ = x29 & x39 & x40;
  assign z20 = new_n68_ | (new_n112_ & ~x09);
  assign new_n112_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n110_ & (~x35 | (~x27 & x28))));
  assign z06 = ~z05;
endmodule
