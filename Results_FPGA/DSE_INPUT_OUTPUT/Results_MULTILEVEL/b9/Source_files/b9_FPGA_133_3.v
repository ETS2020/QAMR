...
module FAU ( 
  ...
  assign new_n85_ = (x28 | ~x35) & (~new_n66_ | ~x08 | ~x29);
  assign z12 = ~new_n87_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n87_ = ~x04 & (new_n66_ | (x27 & (x37 | (x28 & x35))));
  assign z13 = ~x04 & ((new_n83_ & ~x13) | (x27 & (new_n90_ | (new_n89_ & ~x13))));
  assign new_n89_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n90_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n94_ | (~new_n92_ & (~new_n66_ | x13));
  assign new_n92_ = new_n93_ & (x37 | (x28 & x35));
  ...
  assign z18 = ~new_n101_ | (x08 & (new_n100_ | (~x28 & x35)));
  assign new_n100_ = x29 & x39 & x40;
  assign new_n101_ = (~x27 | (~x04 & (x28 | ~x35))) & ~x09 & ~x30;
  assign z19 = (x04 & x27) | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (x08 | (x27 & ~x28 & (x04 | x35))) & (new_n100_ | (~x28 & (x35 | (x04 & x27))));
