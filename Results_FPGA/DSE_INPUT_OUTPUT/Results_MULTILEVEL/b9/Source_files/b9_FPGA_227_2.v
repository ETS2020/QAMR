...
module FAU ( 
  ...
  assign new_n86_ = ~new_n87_ & (x40 ? (~x29 | ~x39) : ~x19);
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (x19 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n90_ | new_n67_ | ((~z08 | x04) & (new_n66_ | ~x27));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n92_ | (new_n94_ & ~x04))) | new_n67_ | (new_n93_ & ~x04);
  assign new_n92_ = ~x18 & x20 & ~new_n66_ & (~x19 | ~x40);
  assign new_n93_ = new_n84_ & ~x13;
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x40 & (new_n96_ | new_n98_)) | (~x19 & ~new_n100_ & ~x40);
  assign new_n96_ = (new_n66_ | ~new_n97_) & (x04 | x13 | ~x39);
  assign new_n97_ = ~x18 & ~x19 & x20 & x27;
  assign new_n98_ = ~x30 & ~x32 & (~x27 | (~new_n99_ & x28));
  assign new_n99_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign new_n100_ = ~new_n66_ & ~x18 & x20 & x27;
  ...
  assign new_n108_ = (new_n109_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n109_ = x29 & x39 & x40;
  assign z20 = new_n67_ | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = (x08 | (x27 & x35)) & (new_n109_ | (x35 & (x27 | ~x28)));
endmodule
