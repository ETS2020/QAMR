...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n77_, new_n78_,
    new_n82_, new_n84_, new_n87_, new_n89_, new_n90_, new_n95_, new_n97_,
  ...
  assign z07 = (~x04 & x27) | (x03 & (new_n78_ | (new_n77_ & ~x31)));
  ...
  assign z11 = (~x04 & x27) | (~x09 & ~x30 & (new_n84_ | ~x08));
  assign new_n84_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign z12 = (~new_n65_ & x04) | (~x27 & (~new_n70_ | ~x10));
  assign z13 = (~new_n87_ & ~x04) | (~x18 & ~x19 & new_n65_ & x20);
  ...
  assign z18 = (~new_n95_ & (x04 | ~x27)) | (new_n68_ & x08 & ~x27);
  assign new_n95_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39 | ~x40);
  assign z19 = ~x09 & ~x30 & (new_n98_ | (~new_n97_ & (x04 | ~x27)));
  assign new_n97_ = x08 & (x35 | (x29 & x39 & x40));
  assign new_n98_ = (~x29 | ~x39 | ~x40) & (x27 ? x04 : x28);
  assign z20 = ~x09 & ~x30 & (new_n100_ | (~new_n101_ & (~new_n70_ | ~x29)));
