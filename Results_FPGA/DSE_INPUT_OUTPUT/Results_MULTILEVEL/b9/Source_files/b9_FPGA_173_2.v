...
module FAU ( 
  ...
  assign z19 = ~x09 & ~x30 & ((new_n86_ & x27) | (~new_n104_ & ~x04));
  assign new_n104_ = (x08 | x27) & (new_n105_ | (x35 & (x27 | ~x28)));
  assign new_n105_ = x29 & x39 & x40;
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (x08 | (x27 ? x35 : x04)) & (new_n105_ | ((~x27 | x35) & (x04 | (x35 & (x27 | ~x28)))));
endmodule
