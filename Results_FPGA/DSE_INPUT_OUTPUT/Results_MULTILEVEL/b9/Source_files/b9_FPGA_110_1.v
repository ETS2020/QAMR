...
module FAU ( 
  ...
  assign z02 = ~x40 | (x11 & (~new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z11 = (x40 & (~x11 | (new_n88_ & ~x09 & ~x30))) | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = (new_n87_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (x27 & ~x28 & x35));
  assign new_n87_ = x29 & x39 & x40;
  assign new_n88_ = x04 & ~x08;
  assign z12 = (x11 & (new_n90_ | (~new_n91_ & (x04 | ~x39)))) | (~new_n91_ & ~x40);
  ...
  assign new_n95_ = x11 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n100_ | ((new_n97_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n97_ = x11 & (new_n98_ | ~new_n99_);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (new_n91_ | x40) & (~x11 | (~new_n101_ & (new_n91_ | new_n99_)));
  ...
  assign z18 = (~new_n106_ & (x11 | ~x40)) | (new_n87_ & x08 & x11);
  assign new_n106_ = ~new_n107_ & ~x09 & ~x30;
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = ~x09 & ~x30 & (new_n109_ | (~new_n111_ & ~x08));
  assign new_n109_ = ~new_n110_ & ((x04 & x27) | x28 | ~x35);
  assign new_n110_ = x40 & (~x11 | (x29 & x39));
  assign new_n111_ = (x27 | (~x11 & x40)) & (~x11 | (~x04 & ~x28 & x35));
  assign z20 = new_n113_ & ~x09;
  assign new_n113_ = ~x30 & (new_n114_ | (~new_n110_ & (~x35 | (~x27 & x28))));
  assign new_n114_ = ~x08 & ((~x27 & ~x40) | (x11 & (~x27 | ~x35)));
  assign z06 = ~z05;
endmodule
