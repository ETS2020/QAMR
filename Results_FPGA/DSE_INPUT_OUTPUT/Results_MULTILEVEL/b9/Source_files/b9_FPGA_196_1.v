...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n76_, new_n77_, new_n81_,
    new_n83_, new_n86_, new_n88_, new_n89_, new_n95_, new_n96_, new_n98_,
    new_n99_, new_n100_;
  ...
  assign z07 = x03 & (x04 | ~x27) & (new_n77_ | (new_n76_ & ~x31));
  ...
  assign z14 = x04 ? (~new_n88_ | (~x37 & (~x28 | ~x35))) : ~new_n89_;
  assign new_n88_ = ~x18 & ~x19 & x20 & x27;
  assign new_n89_ = ~x13 & ~x27 & (x30 | x32) & x39 & x40;
  assign z15 = x34 & x27 & x26 & x04 & x12;
  assign z16 = x01 & x22 & ~x23 & (x04 | ~x27);
  assign z17 = x01 & x22 & x23 & ~x24 & (x04 | ~x27);
  assign z18 = (~new_n83_ & x08) | x09 | x30 | (~x04 & x27);
  assign z19 = ~x09 & ~x30 & (new_n96_ | (~new_n95_ & (x04 | ~x27)));
  assign new_n95_ = x08 & (x35 | (x29 & x39 & x40));
  assign new_n96_ = (~x29 | ~x39 | ~x40) & (x27 ? x04 : x28);
  assign z20 = ~x09 & ~x30 & (new_n99_ | (~new_n98_ & ~new_n100_));
  assign new_n98_ = x29 & x39 & x40;
  assign new_n99_ = ~x08 & (~x27 | (x04 & ~x35));
  assign new_n100_ = (~x04 | x35) & (x27 | (~x28 & x35));
endmodule
