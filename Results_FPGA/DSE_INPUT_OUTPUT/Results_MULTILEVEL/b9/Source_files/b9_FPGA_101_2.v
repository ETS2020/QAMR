...
module FAU ( 
  ...
  assign new_n91_ = ~x10 & ((~x09 & ~x27) | (~x36 & ~x37 & x27 & ~x35));
  assign z13 = (x27 & (new_n93_ | (new_n94_ & ~x04))) | (new_n95_ & ~x04) | (x09 & ~x27);
  ...
  assign z18 = (~new_n106_ & ~x09) | (x27 & (new_n107_ | x09));
  assign new_n106_ = ~x30 & (~x08 | (~new_n89_ & (x27 | x28 | ~x35)));
  assign new_n107_ = ~x04 & ~x28 & x35;
  assign z19 = (x09 & ~x27) | (~x30 & (new_n109_ | (~x08 & (~x27 | (~new_n107_ & ~x09)))));
  assign new_n109_ = ~new_n89_ & ((x28 & (~x09 | ~x27)) | (~x09 & (~x35 | (x04 & x27))));
  assign z20 = (x09 & ~x27) | (~x30 & (new_n111_ | (~x08 & (~x27 | (~x09 & ~x35)))));
  assign new_n111_ = ~new_n89_ & ((~x09 & ~x35) | (~x27 & x28));
endmodule
