...
module FAU ( 
  ...
  assign z07 = x03 & ~new_n76_ & (new_n78_ | (new_n77_ & ~x31));
  ...
  assign z13 = (~new_n88_ & ~x04) | (~x18 & ~x19 & new_n65_ & x20);
  ...
  assign z18 = (~new_n96_ & x08) | x09 | new_n76_ | x30;
  assign new_n96_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign z19 = new_n76_ | (~x09 & ~x30 & (~x08 | (~new_n84_ & ~new_n98_)));
  assign new_n98_ = (x27 | (~x28 & x35)) & ~x27 & (~x04 | x35);
  assign z20 = ~x09 & ~x30 & (new_n100_ | (~new_n84_ & ~new_n101_));
