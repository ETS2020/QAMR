...
module FAU ( 
  ...
  assign z05 = (x13 & x37) | (x27 & (x28 | x37));
  ...
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & x13) | (new_n87_ & x27));
  ...
  assign z14 = new_n98_ | ~x27 | (~new_n96_ & (x18 | x19 | ~x20));
  ...
  assign z18 = ~new_n103_ | (x08 & (new_n89_ | (new_n73_ & ~x27)));
  assign new_n103_ = ~x09 & (x13 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = (~x27 & (~x13 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (new_n73_ & ~x04)) & (new_n89_ | (new_n73_ & (~x04 | ~x27)));
  assign z20 = (~x13 & ~x27) | (~x09 & ~new_n107_ & ~x30);
