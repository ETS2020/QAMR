...
module FAU ( 
  ...
  assign z04 = (~x13 & (x21 | (~x27 & ~x37))) | (x27 & (x21 | ~x28 | ~x35));
  assign z05 = x37 | (x27 & x28) | (x13 & ~x27);
  assign z06 = (~x27 & (x13 | ~x37)) | (~x28 & ~x37);
  ...
  assign new_n90_ = (~x13 | x27) & (new_n91_ | (x27 & (x37 | (x28 & x35))));
  assign new_n91_ = ~x04 & x39 & x40;
  assign z13 = (x27 & (new_n94_ | (~x04 & new_n93_ & ~x13))) | (~x04 & new_n95_ & ~x13);
  ...
  assign new_n97_ = x13 ? ~x27 : (new_n91_ & ~new_n98_);
  ...
  assign new_n102_ = ~x13 & ~x27 & (~new_n66_ | x04 | (~x30 & ~x32));
  ...
  assign new_n110_ = (x08 | (x27 & x35)) & ((new_n66_ & x29) | (x35 & (x27 | ~x28)));
  assign z19 = (~x27 & (x13 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
endmodule
