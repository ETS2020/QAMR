...
module FAU ( 
  ...
  assign z12 = (~x10 & (new_n88_ | ~x27)) | (~new_n66_ & (~x27 | (new_n89_ & ~x04))) | (x04 & ~x27);
  ...
  assign z18 = ~new_n101_ | (x08 & (new_n86_ | (~x28 & x35)));
  assign new_n101_ = (~x27 | (~x04 & (x28 | ~x35))) & ~x09 & ~x30;
  assign z20 = (x04 & x27) | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (x08 | (x27 & (x04 | x35))) & (new_n86_ | ((x04 | x35) & (x27 | (~x28 & x35))));
