...
module FAU ( 
  ...
  assign new_n82_ = ((~new_n68_ & ~x36) | (new_n71_ ? ~x05 : ~x07)) & (~new_n83_ | ~x05);
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n85_ & ~x30;
  assign new_n85_ = (new_n68_ | ((new_n86_ | (~x04 & ~x27)) & (x08 | ~x27))) & (~x04 | (x08 & (new_n86_ | ~x27)));
  ...
  assign new_n103_ = (x08 | (new_n68_ & ~x04)) & (new_n86_ | (new_n68_ & (~x04 | ~x27)));
  assign z20 = (~x04 & ~x27) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (x27 & x35)) & (new_n86_ | (x35 & (x27 | ~x28)));
endmodule
