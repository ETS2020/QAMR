...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n75_, new_n76_, new_n77_,
    new_n81_, new_n83_, new_n84_, new_n87_, new_n89_, new_n90_, new_n95_,
  ...
  assign z07 = x03 & ~new_n75_ & (new_n77_ | (new_n76_ & ~x31));
  ...
  assign z13 = x04 ? (~x18 & ~x19 & new_n65_ & x20) : new_n87_;
  assign new_n87_ = ~x13 & ~x27 & x39 & x40 & (x30 | x32);
  assign z14 = x04 ? (~new_n89_ | (~x37 & (~x28 | ~x35))) : ~new_n90_;
  assign new_n89_ = ~x18 & ~x19 & x20 & x27;
  assign new_n90_ = ~x13 & ~x27 & (x30 | x32) & x39 & x40;
  ...
  assign z19 = ~x09 & ~x30 & (new_n98_ | (~new_n75_ & ~new_n97_));
