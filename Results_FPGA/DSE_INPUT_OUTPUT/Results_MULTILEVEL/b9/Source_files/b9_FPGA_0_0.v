...
module FAU ( 
  ...
  assign new_n71_ = (~x04 | (~x28 & x35)) & new_n66_ & (x27 | (x04 & x08));
  assign z03 = (~new_n73_ & x27) | ~x21 | (~x27 & (~x04 | ~x37));
  assign new_n73_ = x28 & x35;
  assign z04 = (x04 & (x21 | (~x27 & ~x37))) | (x27 & (~new_n73_ | x21));
  ...
  assign new_n83_ = (x36 | (~x28 & x35)) & (new_n66_ ? x05 : x07);
  ...
  assign z12 = (~x37 & (new_n89_ | (~new_n73_ & (x04 | (~new_n66_ & x27))))) | (x04 & ~x27);
  assign new_n89_ = ~x10 & x27 & ~x35 & ~x36;
  assign z13 = new_n91_ | (~x04 & (~x27 | (~x13 & new_n92_ & x39)));
  assign new_n91_ = ~x18 & ~x19 & x20 & x27 & (new_n73_ | x37);
  ...
  assign z18 = (~new_n101_ & (x04 | x27)) | (~x28 & x35 & (x04 ? (x08 & ~x27) : x27));
  assign new_n101_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign z19 = (~x04 & ~x27) | (~x09 & ~x30 & ((~new_n103_ & x27) | (~new_n104_ & x04)));
