...
module FAU ( 
  ...
  assign z05 = (~x27 & x37) | (~x09 & (x37 | (x27 & x28)));
  ...
  assign new_n84_ = x40 & ((~x09 & ((~new_n70_ & x27) | x30 | x32)) | (~x27 & (x30 | x32)));
  assign new_n85_ = x07 & ~x09 & x27 & ~new_n68_ & ~new_n70_;
  assign new_n86_ = x27 & x37 & x06 & ~x09;
  assign z11 = (x09 & x27) | (~new_n88_ & ~x30);
  assign new_n88_ = (new_n89_ | ((~x04 | ~x27) & (new_n73_ | x09))) & (x08 | x09 | (new_n73_ & ~x04 & x27));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | (x09 & x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & ~x09) | (new_n97_ & ~x04);
  ...
  assign z14 = (~new_n102_ & ~x27) | (~x09 & (new_n101_ | (~new_n99_ & ~new_n103_)));
  ...
  assign z18 = new_n108_ | (~x09 & (x30 | (new_n73_ & ~x04 & x27))) | (x09 & ~x27);
  assign new_n108_ = x08 & ((new_n73_ & ~x27) | (new_n68_ & ~x09 & x29));
  assign z20 = x09 ? x27 : (~x30 & (new_n110_ | (~x08 & (~x27 | ~x35))));
  assign new_n110_ = ~new_n89_ & (~x35 | (~x27 & x28));
  assign z19 = (x09 & x27) | (~new_n88_ & ~x30);
endmodule
