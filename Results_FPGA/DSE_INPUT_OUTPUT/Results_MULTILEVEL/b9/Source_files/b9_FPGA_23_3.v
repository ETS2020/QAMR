...
module FAU ( 
  ...
  assign new_n85_ = (new_n71_ | ((x04 | x08) & (new_n86_ | (x04 & x27)))) & (x08 | x27);
  assign new_n86_ = x29 & x39 & x40;
  assign z12 = (~x10 & (new_n88_ | ~x27)) | (x04 & ~x27) | (~new_n66_ & (~x27 | (new_n89_ & ~x04)));
  assign new_n88_ = ~x04 & ~x35 & ~x36 & ~x37;
  assign new_n89_ = ~x37 & (~x28 | ~x35);
  assign z13 = (x27 & (new_n93_ | x04)) | (~x13 & new_n91_ & x39);
  assign new_n91_ = x40 & ((~x04 & (x30 | x32)) | (~new_n92_ & x27));
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x18 & ~x19 & ~new_n89_ & x20;
  assign z14 = ((~new_n66_ | x13) & (~x27 | (~new_n95_ & ~x04))) | new_n96_ | (x04 & ~x27);
  assign new_n95_ = ~new_n89_ & ~x18 & ~x19 & x20;
  assign new_n96_ = ~x30 & ~x32 & (~x27 | (~x04 & ~new_n97_ & x28));
  ...
  assign z18 = (x08 & (new_n71_ | new_n86_)) | ~new_n102_ | (x27 & (new_n71_ | x04));
  assign new_n102_ = ~x09 & ~x30;
  assign z19 = (x04 & x27) | (~x09 & ~new_n104_ & ~x30);
  assign new_n104_ = (x08 | (x27 & ~x28 & (x04 | x35))) & (new_n86_ | (~x28 & (x35 | (x04 & x27))));
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (x08 | (x27 & (x04 | x35))) & (new_n86_ | ((x04 | x35) & (x27 | (~x28 & x35))));
endmodule
