...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n75_, new_n76_, new_n80_,
    new_n82_, new_n85_, new_n87_, new_n88_, new_n93_, new_n95_, new_n97_,
    new_n98_;
  ...
  assign z07 = x03 & (x04 | ~x27) & (new_n76_ | (new_n75_ & ~x31));
  ...
  assign z13 = (~new_n85_ & ~x04) | (~x18 & ~x19 & new_n65_ & x20);
  assign new_n85_ = ~x27 & (x13 | ~x39 | ~x40 | (~x30 & ~x32));
  assign z14 = new_n88_ | (x04 & (~new_n87_ | (~x37 & (~x28 | ~x35))));
  assign new_n87_ = ~x18 & ~x19 & x20 & x27;
  assign new_n88_ = ~x27 & (~x39 | ~x40 | x13 | (~x30 & ~x32));
  assign z15 = x34 & x27 & x26 & x04 & x12;
  assign z16 = (~x04 & x27) | (x01 & x22 & ~x23);
  assign z17 = (~x04 & x27) | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n93_ & (x04 | ~x27)) | (~x28 & x35 & x08 & ~x27);
  assign new_n93_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39 | ~x40);
  assign z19 = (~x04 & x27) | (~x09 & ~x30 & (new_n95_ | ~x08));
  assign new_n95_ = (~x29 | ~x39 | ~x40) & (x27 | ~x35 | (~x27 & x28));
  assign z20 = (~x04 & x27) | (~x09 & ~x30 & (new_n97_ | new_n98_));
  assign new_n97_ = ~x08 & (~x27 | ~x35);
