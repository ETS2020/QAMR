...
module FAU ( 
  ...
  assign new_n68_ = ~x30 & ~x40;
  assign z01 = ~x04 | (~x30 & (~x40 | (~x32 & (new_n70_ | ~x27))));
  ...
  assign z11 = ~x09 & ~x30 & ~new_n88_ & x40;
  assign new_n88_ = ((x29 & x39) | (new_n71_ & (~x04 | ~x27))) & (x08 | (new_n71_ & ~x04 & x27));
  assign z12 = ~new_n90_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n90_ = (x30 | x40) & ((~new_n66_ & x27) | (~x04 & x39 & x40));
  ...
  assign new_n94_ = ~x19 & x20 & ~new_n66_ & x30;
  ...
  assign new_n99_ = (new_n100_ | x30) & (new_n98_ | (~new_n66_ & x27));
  assign new_n100_ = x40 & (x32 | (x27 & (~x28 | x35 | x37)));
  assign z15 = new_n68_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n68_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n68_ & ~x24;
  assign z18 = ~new_n105_ | (x08 & ((x29 & x39) | (new_n71_ & ~x27)));
  assign new_n105_ = ~x09 & (~new_n71_ | x04 | ~x27) & ~x30 & x40;
  assign z20 = ~x30 & (~x40 | (~new_n107_ & ~x09));
  assign new_n107_ = (x08 | (x27 & x35)) & ((x29 & x39) | (x35 & (x27 | ~x28)));
  assign z19 = ~x09 & ~x30 & ~new_n88_ & x40;
endmodule
