...
module FAU ( 
  ...
  assign z05 = (x22 & x37) | (x27 & (x28 | x37));
  ...
  assign new_n84_ = x40 & (((x30 | x32) & (x22 | x27)) | (~new_n70_ & x27));
  ...
  assign z13 = (x27 & (new_n94_ | (new_n95_ & ~x04))) | (~x22 & ~x27) | (new_n96_ & ~x04);
  ...
  assign z18 = new_n107_ | (~new_n106_ & (x22 | x27));
  assign new_n106_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign new_n107_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x22 & ~x27));
  assign z19 = (~x27 & (~x22 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n109_ & ~x30);
  assign new_n109_ = (x08 | (~x04 & ~x28 & x35)) & (new_n90_ | (~x28 & x35 & (~x04 | ~x27)));
  assign z20 = (~x22 & ~x27) | (~x09 & ~new_n111_ & ~x30);
