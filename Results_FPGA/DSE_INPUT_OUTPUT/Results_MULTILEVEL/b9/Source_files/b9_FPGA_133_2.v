...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n112_;
  assign z00 = ~new_n67_ | (~x15 & (new_n66_ | (new_n65_ & x39)));
  assign new_n65_ = x40 & ((x10 & (~x04 | ~x27)) | (~x04 & x27 & (x35 | x36)));
  assign new_n66_ = x27 & (x37 | (x28 & x35));
  assign new_n67_ = x16 & (~x04 | x27);
  assign z01 = ~x04 | (x27 & ~x30 & new_n69_ & ~x32);
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n71_ | (~x02 & (~x08 | ~x29));
  assign new_n71_ = (~x04 | (x27 & ~x28 & x35)) & x39 & x40;
  ...
  assign z07 = x03 & (~x04 | x27) & (new_n78_ | (new_n77_ & ~x31));
  ...
  assign z11 = new_n87_ | (~x09 & ~x30 & ~new_n88_ & (~new_n86_ | x04));
  assign new_n86_ = ~x28 & x35;
  assign new_n87_ = ~x27 & (x04 | (~x08 & ~x09 & ~x30));
  assign new_n88_ = x39 & x40 & x08 & x29;
  assign z12 = new_n90_ | (~new_n66_ & (x04 | ~x39 | ~x40));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~x04 & new_n92_ & ~x13) | (x27 & (new_n94_ | (~x04 & new_n93_ & ~x13)));
  assign new_n92_ = x39 & x40 & (x30 | x32);
  assign new_n93_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = (~new_n96_ & (new_n97_ | ~new_n98_)) | new_n99_ | (~new_n66_ & ~new_n98_);
  ...
  assign new_n105_ = ~x09 & (~x04 | x27) & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = new_n107_ | (~x09 & ~x30 & ~new_n88_ & ~new_n108_);
  assign new_n107_ = ~x27 & (x04 | (~x04 & ~x08 & ~x09 & ~x30));
  assign new_n108_ = ~x04 & ~x28 & (x35 | (x04 & ~x27));
  assign z20 = ~x09 & ~x30 & (new_n112_ | (~x04 & (new_n110_ | new_n111_)));
  assign new_n110_ = ~x08 & (~x27 | ~x35);
  assign new_n111_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
  assign new_n112_ = x27 & ~x35 & (~x08 | ~x29 | ~x39 | ~x40);
endmodule
