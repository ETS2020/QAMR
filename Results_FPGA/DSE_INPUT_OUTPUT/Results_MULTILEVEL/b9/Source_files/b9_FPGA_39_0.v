...
module FAU ( 
  ...
  assign new_n84_ = x40 & (((x30 | x32) & (x18 | x27)) | (~new_n70_ & x27));
  ...
  assign new_n96_ = ~x19 & x20 & ~new_n68_ & x27;
  assign z14 = new_n98_ | (x18 & ~x27 & ~x30 & ~x32) | (new_n101_ & x27);
  assign new_n98_ = (new_n99_ | ~new_n100_) & (x18 | (x27 & (x19 | ~x20)));
