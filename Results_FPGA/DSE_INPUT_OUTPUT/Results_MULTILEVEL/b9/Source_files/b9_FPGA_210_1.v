...
module FAU ( 
  ...
  assign z13 = (~new_n91_ & x20) | (~x04 & ~x13 & new_n84_ & ~x27);
  ...
  assign z19 = (~x20 & x27) | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = ~new_n108_ & (new_n87_ | new_n107_);
  assign new_n107_ = (x35 | (~x20 & x27)) & ~x28 & (~x04 | ~x27);
  assign new_n108_ = ~x08 & (x04 | ~x27 | x28 | (x20 & ~x35));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 & (~x20 | x35))) & (new_n87_ | ((~x20 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
endmodule
