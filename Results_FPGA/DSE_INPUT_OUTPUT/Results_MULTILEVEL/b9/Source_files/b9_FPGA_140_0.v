...
module FAU ( 
  ...
  assign z03 = (x16 & (~x21 | (~x27 & ~x37))) | (x27 & (~x21 | ~x28 | ~x35));
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | (~x27 & (~x16 | ~x37));
  assign z05 = (x16 & x37) | (x27 & (x28 | x37));
  assign z06 = ~x37 & (x27 ? ~x28 : x16);
  assign z07 = x03 & ~new_n79_ & (x16 | x27);
  ...
  assign z13 = (~new_n93_ & x27) | (~x16 & ~x27) | (~x04 & new_n85_ & ~x13);
  assign new_n93_ = (~new_n94_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x27 & (new_n98_ | (~new_n96_ & ~new_n100_))) | (x16 & ~new_n99_ & ~x27);
  ...
  assign z17 = x01 & x22 & x23 & ~x24 & (x16 | x27);
  assign z18 = ~new_n105_ | (x08 & (new_n89_ | (new_n73_ & ~x27)));
  assign new_n105_ = ~x09 & (x16 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = ~x09 & ~x30 & (new_n87_ | (~new_n107_ & x16));
