...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & (x06 | ~x27)) | (x04 & ~x08 & ~x27);
  assign new_n72_ = (x02 | (x08 & x29)) & new_n66_ & (new_n73_ | ~x04);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (~x21 & (x06 | ~x27)) | (x06 & x27 & (~x28 | ~x35)) | (~x27 & ~x37);
  assign z04 = (x27 & (~x06 | ~x28 | ~x35)) | x21 | (~x27 & ~x37);
  assign z06 = ~x37 & (~x27 | (x06 & ~x28));
  assign z07 = x03 & ~new_n78_ & (x06 | ~x27);
  ...
  assign z10 = (~new_n83_ & ~x04) | (x27 & (~x06 | x37));
  assign new_n83_ = (~x27 | new_n70_ | (new_n66_ ? ~x05 : ~x07)) & (~new_n84_ | ~x05);
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = (new_n87_ | ((new_n73_ | (~x06 & x27)) & (~x04 | ~x06 | ~x27))) & (x08 | (x27 & (~x06 | (new_n73_ & ~x04))));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = new_n89_ | (~x06 & x27) | ((~new_n66_ | x04) & (new_n68_ | ~x27));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n91_ & x06) | (~x04 & ~x13 & new_n84_ & ~x27);
  ...
  assign new_n98_ = (x06 | ~x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign z18 = new_n105_ | (~new_n104_ & (x06 | ~x27));
  assign new_n104_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign new_n105_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & x06 & x27));
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (x08 | (x27 & (~x06 | x35))) & (new_n87_ | ((~x06 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
