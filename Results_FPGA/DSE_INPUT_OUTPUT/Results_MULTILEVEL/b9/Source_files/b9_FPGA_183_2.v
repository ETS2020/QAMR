...
module FAU ( 
  ...
  assign z18 = ~new_n103_ | (x08 & ((new_n68_ & ~x27) | (new_n71_ & x29)));
  assign new_n103_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n68_ | x04 | ~x27);
  assign z20 = (x04 & ~x27) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (x27 & x35)) & ((new_n71_ & x29) | (x35 & (x27 | ~x28)));
