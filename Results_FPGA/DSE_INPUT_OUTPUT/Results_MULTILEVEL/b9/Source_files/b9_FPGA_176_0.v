...
module FAU ( 
  ...
  assign new_n67_ = x39 & x40 & (x10 | x35 | x36);
  assign z01 = x04 ? (~x30 & ~x32 & (~x27 | (~new_n69_ & ~x36))) : x27;
  assign new_n69_ = ~x28 & x35;
  assign z02 = (~x08 & (x27 ? ~x02 : x04)) | (~new_n71_ & (x04 | x27)) | (~new_n69_ & x04);
  assign new_n71_ = new_n72_ & (x02 | x29);
  assign new_n72_ = x39 & x40;
  assign z03 = (~new_n66_ & x27) | ~x21 | (~x27 & (~x04 | ~x37));
  assign z04 = (x04 & (x21 | (~x27 & ~x37))) | (x27 & (~new_n66_ | x21));
  ...
  assign z10 = (~x04 & (new_n83_ | new_n84_ | ~x27)) | (x06 & x27 & x37);
  assign new_n83_ = (new_n69_ | x36) & (new_n72_ ? x05 : x07);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = (~x04 & ~x27) | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = (x08 | (new_n69_ & ~x04)) & (new_n87_ | (new_n69_ & (~x04 | ~x27)));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = (x04 & ~x27) | (~x37 & (new_n89_ | (~new_n66_ & (x04 | (~new_n72_ & x27)))));
  assign new_n89_ = ~x10 & x27 & ~x35 & ~x36;
  assign z13 = new_n91_ | (~x04 & (~x27 | (~x13 & new_n92_ & x39)));
  assign new_n91_ = ~x18 & ~x19 & x20 & x27 & (new_n66_ | x37);
  ...
  assign z18 = (~x04 & (new_n69_ | ~x27)) | ~new_n101_ | (x08 & (new_n87_ | (new_n69_ & ~x27)));
  assign new_n101_ = ~x09 & ~x30;
  assign z19 = ~x09 & ~x30 & ((~new_n104_ & x04) | (~new_n103_ & x27));
  assign new_n103_ = ((~x28 & x35) | (new_n72_ & x08 & x29)) & (~x04 | (new_n72_ & x29));
  assign new_n104_ = x08 & (new_n87_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (x08 | (x27 ? x35 : ~x04)) & (new_n87_ | ((~x27 | x35) & (~x04 | (x35 & (x27 | ~x28)))));
endmodule
