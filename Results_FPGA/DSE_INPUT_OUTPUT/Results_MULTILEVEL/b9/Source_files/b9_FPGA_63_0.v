...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n92_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_, new_n104_;
  ...
  assign z12 = new_n89_ | (~x09 & ~x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n91_ & x27) | (~x09 & ~x27) | (~x04 & new_n85_ & ~x13);
  assign new_n91_ = (~new_n92_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n92_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x27 & (new_n96_ | (~new_n94_ & ~new_n98_))) | (x09 & ~new_n97_ & ~x27);
  ...
  assign z18 = ~new_n87_ | x09 | ~x27 | x30;
  assign z20 = ~x09 & (new_n104_ | ~x27);
  assign new_n104_ = ~x30 & ~x35 & (~new_n68_ | ~x08 | ~x29);
  assign z19 = ~x09 & (~x27 | (new_n87_ & ~x30));
endmodule
