...
module FAU ( 
  ...
  assign z02 = new_n72_ | ~x02 | x29 | ~x39 | ~x40;
  ...
  assign z11 = new_n69_ | (new_n87_ & ~x09);
  assign new_n87_ = ~x30 & (x28 | ~x35 | (~x08 & ~x27) | (x04 & x27));
  assign z12 = new_n89_ | (x29 & x39) | (~new_n66_ & (x04 | ~x39 | ~x40));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n92_ | (new_n91_ & ~x04))) | (~new_n93_ & x39);
  assign new_n91_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n92_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n93_ = ~x29 & (x04 | x13 | ~x40 | (~x30 & ~x32));
  assign z14 = ~new_n98_ | ((x18 | x19 | ~x20) & (new_n95_ | ~x39));
  assign new_n95_ = ~x29 & (new_n96_ | ~new_n97_);
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = ~x04 & ~x13 & x40;
  assign new_n98_ = (x29 | (~new_n99_ & (new_n66_ | new_n97_))) & (new_n66_ | x39);
  ...
  assign z18 = ~new_n69_ & (new_n104_ | x09 | x30);
  assign new_n104_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = new_n69_ | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = (new_n69_ | (x35 & (x08 | x27))) & ~x28 & (~x04 | ~x27);
  assign z20 = ~x09 & new_n108_ & ~x30;
  assign new_n108_ = ~new_n69_ & (~x35 | (~x27 & (~x08 | x28)));
endmodule
