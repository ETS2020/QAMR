...
module FAU ( 
  ...
  assign z02 = x39 ? ((~x02 & (~x08 | ~x29)) | new_n73_ | ~x40) : x40;
  ...
  assign z07 = x03 & ~new_n70_ & (new_n80_ | (new_n79_ & ~x31));
  ...
  assign new_n86_ = (x39 | x40) & (~x06 | ~x27 | ~x37);
  assign z11 = new_n70_ | (~x09 & ~x30 & (new_n90_ | (~new_n88_ & ~new_n89_)));
  ...
  assign z19 = ~x09 & ~x30 & ((~new_n110_ & ~x08) | (~new_n89_ & ~new_n111_));
  assign new_n110_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign new_n111_ = x39 ? (x29 & x40) : ~x40;
