...
module FAU ( 
  ...
  assign z00 = (~x15 & (new_n65_ | (~new_n67_ & x27))) | ~x16 | (x04 & ~x27);
  ...
  assign new_n90_ = x20 & ~new_n67_ & (x04 | x27);
  ...
  assign new_n94_ = x04 ? ~x27 : (~new_n95_ & new_n72_ & ~x13);
  ...
  assign new_n99_ = ~x04 & ~x27 & (~new_n72_ | x13 | (~x30 & ~x32));
  ...
  assign new_n104_ = ~x09 & ~x30 & (~new_n72_ | ~x08 | ~x29);
  assign z19 = ~x09 & ~x30 & (new_n106_ | (~new_n107_ & ~x04));
  assign new_n106_ = x27 & (~new_n69_ | x04) & (~new_n72_ | ~x08 | ~x29);
  assign new_n107_ = (x08 | x27) & (new_n108_ | (x35 & (x27 | ~x28)));
  assign new_n108_ = x29 & x39 & x40;
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : x04)) & (new_n108_ | ((~x27 | x35) & (x04 | (x35 & (x27 | ~x28)))));
endmodule
