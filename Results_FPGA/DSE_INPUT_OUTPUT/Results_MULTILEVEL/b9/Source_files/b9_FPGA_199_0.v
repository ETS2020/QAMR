...
module FAU ( 
  ...
  assign z06 = (~x28 & ~x37) | (~x27 & (~x25 | ~x37));
  ...
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n89_ & x25));
  ...
  assign new_n97_ = x25 & x39 & x40 & (x30 | x32);
  ...
  assign new_n101_ = (x25 | x27) & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = new_n108_ | (~new_n107_ & (x25 | x27));
  assign new_n107_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n108_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x25 & ~x27));
  assign z19 = (~x25 & ~x27) | (~x09 & ~x30 & (new_n88_ | (~new_n110_ & x25)));
  assign new_n110_ = (x08 | x27) & (new_n90_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n112_ & ~x30;
  assign new_n112_ = (x08 | (x27 ? x35 : ~x25)) & (new_n90_ | ((~x27 | x35) & (~x25 | (x35 & (x27 | ~x28)))));
endmodule
