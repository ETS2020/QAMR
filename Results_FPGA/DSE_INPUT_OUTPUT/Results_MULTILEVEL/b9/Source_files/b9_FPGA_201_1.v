...
module FAU ( 
  ...
  assign new_n84_ = ~new_n85_ & (~x27 | (~new_n71_ & ~x36) | (~new_n68_ & ~x07));
  ...
  assign z14 = (~new_n100_ & ~x27) | (x05 & (new_n99_ | (~new_n97_ & ~new_n101_)));
  ...
  assign z18 = ~new_n106_ | (x08 & (new_n88_ | (new_n71_ & ~x27)));
  assign new_n106_ = (~x27 | (x05 & (~new_n71_ | x04))) & ~x09 & ~x30;
  assign z19 = ~x09 & ~new_n108_ & ~x30;
  assign new_n108_ = (new_n88_ | ((new_n71_ | (~x05 & x27)) & (~x04 | ~x05 | ~x27))) & (x08 | (x27 & (~x05 | (new_n71_ & ~x04))));
