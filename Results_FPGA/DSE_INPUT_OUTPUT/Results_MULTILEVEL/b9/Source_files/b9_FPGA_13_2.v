...
module FAU ( 
  ...
  assign z11 = new_n65_ | (~x09 & ~x30 & (new_n85_ | new_n86_));
  assign new_n85_ = (~x29 | ~x40) & ((x04 & x27) | x28 | ~x35);
  assign new_n86_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x29));
  ...
  assign z19 = new_n65_ | (new_n106_ & ~x09);
  assign new_n106_ = ~x30 & (new_n107_ | new_n109_ | (~new_n108_ & ~x08));
  assign new_n107_ = (~x29 | ~x40) & (x28 | (x04 & x27));
  assign new_n108_ = (x27 | (x29 & ~x39)) & ~x28 & (~x04 | ~x29) & (x35 | ~x39);
  assign new_n109_ = ~x35 & (~x29 | (x39 & ~x40));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = ~new_n112_ & (x08 | ((x35 | ~x39) & (x27 | (x29 & ~x39))));
