...
module FAU ( 
  ...
  assign z11 = (~x27 & (~x22 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
  ...
  assign new_n91_ = ~x10 & ((x22 & ~x27) | (~x36 & ~x37 & x27 & ~x35));
  ...
  assign new_n96_ = ~x13 & x22 & x39 & x40 & (x30 | x32);
  assign z14 = (x27 & (new_n100_ | (~new_n98_ & ~new_n102_))) | (x22 & ~new_n101_ & ~x27);
  ...
  assign new_n107_ = ~x09 & (x22 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = (~x22 & ~x27) | (~x09 & ~x30 & ((~new_n110_ & x22) | (new_n109_ & x27)));
  assign new_n109_ = (~new_n73_ | x04) & (~new_n68_ | ~x08 | ~x29);
  assign new_n110_ = (x08 | x27) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n112_ & ~x30;
  assign new_n112_ = (x08 | (x27 ? x35 : ~x22)) & (new_n89_ | ((~x27 | x35) & (~x22 | (x35 & (x27 | ~x28)))));
endmodule
