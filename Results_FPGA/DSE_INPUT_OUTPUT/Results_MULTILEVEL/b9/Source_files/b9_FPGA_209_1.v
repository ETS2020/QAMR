...
module FAU ( 
  ...
  assign new_n72_ = ~new_n73_ & x01 & x39 & x40;
  ...
  assign z12 = new_n91_ | (~x01 & x40) | (~new_n92_ & (x04 | ~x39 | ~x40));
  ...
  assign new_n96_ = x01 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n101_ | ((new_n98_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n98_ = x01 & (new_n99_ | ~new_n100_);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x01 | (~new_n102_ & (new_n92_ | new_n100_))) & (new_n92_ | x40);
  ...
  assign z18 = (~new_n107_ & (x01 | ~x40)) | (x01 & x08 & x29 & x39 & x40);
  assign new_n107_ = ~new_n108_ & ~x09 & ~x30;
  assign new_n108_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = new_n68_ | (~x09 & ~new_n110_ & ~x30);
  assign new_n110_ = (new_n111_ | x08) & ~new_n113_ & (new_n112_ | (x29 & x39));
  assign new_n111_ = (~x01 | (x27 & x35)) & ~x28 & (x27 | x40) & (~x04 | ~x40);
  assign new_n112_ = (~x04 | ~x27) & ~x28 & (~x01 | x35);
  assign new_n113_ = ~x40 & ((x04 & x27) | x28 | ~x35);
  assign z20 = new_n115_ & ~x09;
  assign new_n115_ = ~x30 & (new_n116_ | (~new_n88_ & (~x35 | (~x27 & x28))));
