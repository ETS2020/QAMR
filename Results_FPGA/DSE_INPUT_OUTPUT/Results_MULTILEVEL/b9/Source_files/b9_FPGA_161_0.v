...
module FAU ( 
  ...
  assign new_n101_ = ~x09 & ~x30 & (~new_n71_ | ~x08 | ~x29);
  assign z19 = (~x04 & ~x27) | (~x09 & ~x30 & ((~new_n104_ & x04) | (~new_n103_ & x27)));
  assign new_n103_ = ((~x28 & x35) | (new_n71_ & x08 & x29)) & (~x04 | (new_n71_ & x29));
