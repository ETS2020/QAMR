...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (x11 | ~x27)) | (x11 & ~x15 & ~new_n67_ & x27);
  ...
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | ~x04 | (~x11 & x27);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = (~x04 | (new_n73_ & (x08 | x27))) & new_n66_ & (x11 | ~x27);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (~x21 & (x11 | ~x27)) | (x11 & x27 & (~x28 | ~x35)) | (~x27 & ~x37);
  assign z04 = (x11 & x27 & (~x28 | ~x35)) | (~x27 & ~x37) | (x21 & (x11 | ~x27));
  assign z06 = ~x37 & (~x27 | (x11 & ~x28));
  assign z07 = x03 & ~new_n78_ & (x11 | ~x27);
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & ((x00 & ~x25) | ~x38);
  assign z08 = new_n66_ | (~x11 & x27);
  assign z09 = x34 & x27 & x11 & x26;
  assign z10 = (~new_n83_ & ~x04) | (x27 & (~x11 | (x06 & x37)));
  assign new_n83_ = (~new_n84_ | ~x05) & (~x27 | new_n70_ | (new_n66_ ? ~x05 : ~x07));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = (new_n87_ | ((new_n73_ | (~x11 & x27)) & (~x04 | ~x11 | ~x27))) & (x08 | (x27 & (~x11 | (new_n73_ & ~x04))));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = new_n89_ | (~x11 & x27) | ((~new_n66_ | x04) & (new_n68_ | ~x27));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n91_ & x11) | (~x04 & ~x13 & new_n84_ & ~x27);
  ...
  assign z14 = (~new_n99_ & ~x27) | (x11 & (new_n98_ | (~new_n96_ & ~new_n100_)));
  ...
  assign z15 = x27 & (~x11 | (x12 & x26 & x34));
  assign z16 = x01 & x22 & ~x23 & (x11 | ~x27);
  assign z17 = (~x11 & x27) | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n105_ | (x08 & (new_n87_ | (new_n73_ & ~x27)));
  assign new_n105_ = ~x09 & ~x30 & (~x27 | (x11 & (~new_n73_ | x04)));
  assign z20 = (~x11 & x27) | (~x09 & ~new_n107_ & ~x30);
