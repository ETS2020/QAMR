...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n90_, new_n91_, new_n93_, new_n94_, new_n101_, new_n102_,
    new_n104_, new_n105_;
  ...
  assign new_n87_ = (~x06 | ~x27 | ~x37) & (x13 | ~x40);
  assign z11 = ~x09 & ~x30 & ((~new_n90_ & ~new_n91_) | (~new_n89_ & ~x08));
  assign new_n89_ = (x27 | (~x13 & x40)) & (~x13 | (~x04 & ~x28 & x35));
  assign new_n90_ = x40 & (~x13 | (x29 & x39));
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x13 & (new_n93_ | (~new_n94_ & (x04 | ~x39)))) | (~new_n94_ & ~x40);
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n94_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n70_ | (~x18 & ~x19 & new_n94_ & x20);
  assign z14 = ~new_n70_ & (new_n66_ | x18 | x19 | ~x20 | ~x27);
  assign z15 = new_n70_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n70_ | (x01 & x22 & ~x23);
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n101_ & x08) | ~new_n102_ | new_n70_ | x09;
  assign new_n101_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n102_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & (new_n105_ | (~new_n90_ & ~new_n104_));
  assign new_n104_ = x35 & (x27 | ~x28);
  assign new_n105_ = ~x08 & ((x13 & (~x27 | ~x35)) | (~x27 & ~x40));
