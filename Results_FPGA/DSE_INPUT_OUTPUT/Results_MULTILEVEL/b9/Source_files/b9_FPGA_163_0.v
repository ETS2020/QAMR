...
module FAU ( 
  ...
  assign z01 = new_n71_ | ~x04 | (~x30 & new_n72_ & ~x32);
  assign new_n71_ = ~x27 & (~x18 | (~x30 & ~x32));
  assign new_n72_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n74_ | (~x02 & (~x08 | ~x29));
  assign new_n74_ = new_n75_ & (x27 | (x18 & (~x04 | x08)));
  assign new_n75_ = x39 & x40 & (~x04 | (~x28 & x35));
  assign z03 = (x18 & (~x21 | (~x27 & ~x37))) | (x27 & (~new_n69_ | ~x21));
  assign z04 = (~new_n69_ & x27) | x21 | (~x27 & (~x18 | ~x37));
  assign z05 = x37 | (~x18 & ~x27) | (x27 & x28);
  assign z06 = ~x37 & (x27 ? ~x28 : x18);
  assign z07 = (~x18 & ~x27) | (~new_n81_ & x03);
  assign new_n81_ = (~new_n82_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n82_ = ~x33 & (x15 | ~x17) & ((x00 & ~x25) | ~x38);
  assign z08 = new_n66_ | (~x18 & ~x27);
  assign z09 = (~x18 & ~x27) | (x27 & x34 & x11 & x26);
  assign z10 = (~new_n86_ & ~x04) | (~x18 & ~x27) | (x06 & x27 & x37);
  assign new_n86_ = (~new_n87_ | ~x05) & (~x27 | new_n72_ | (new_n66_ ? ~x05 : ~x07));
  assign new_n87_ = x39 & x40 & (x30 | x32);
  assign z11 = (~x27 & (~x18 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n89_ & ~x30);
  ...
  assign new_n92_ = (x18 | x27) & ((x27 & (new_n69_ | x37)) | (new_n66_ & ~x04));
  ...
  assign z14 = new_n71_ | new_n100_ | (~new_n98_ & (x18 | x19 | ~x20));
  ...
  assign z17 = (~x18 & ~x27) | (x01 & x22 & x23 & ~x24);
  ...
  assign z19 = (~x18 & ~x27) | (~x09 & ~x30 & ((new_n108_ & x27) | (~new_n109_ & x18)));
