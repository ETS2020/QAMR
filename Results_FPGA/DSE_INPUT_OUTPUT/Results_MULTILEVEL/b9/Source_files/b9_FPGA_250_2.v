...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
    new_n74_, new_n76_, new_n81_, new_n82_, new_n86_, new_n87_, new_n89_,
  ...
  assign z03 = (~new_n76_ & x27) | (~x27 & (~x37 | ~x40)) | ~x21 | (x37 & ~x40);
  assign new_n76_ = x28 & x35;
  assign z04 = (~new_n76_ & x27) | (~x27 & (~x37 | ~x40)) | x21 | (x37 & ~x40);
  ...
  assign new_n86_ = (~new_n87_ | ~x05) & (~x27 | new_n71_ | (new_n68_ ? ~x05 : ~x07));
  assign new_n87_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n90_ | (~new_n89_ & ~x08));
  assign new_n89_ = (x27 | (x37 & ~x40)) & (~x40 | (new_n74_ & ~x04));
  assign new_n90_ = ~new_n91_ & (x40 ? (~x29 | ~x39) : ~x37);
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n93_ | new_n94_;
  assign new_n93_ = ((~x04 & x39) | ((new_n76_ | x37) & (x27 | ~x40))) & (x37 | x40 | (new_n76_ & x27));
  assign new_n94_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (~new_n96_ & x27) | new_n69_ | (~x04 & new_n87_ & ~x13);
  ...
  assign new_n101_ = ~new_n102_ & (new_n76_ | (x40 & (new_n103_ | x37))) & (new_n103_ | x27) & (x40 | (x27 & ~x37));
  ...
  assign z19 = new_n69_ | (~x09 & ~new_n110_ & ~x30);
  assign new_n110_ = (x08 | (new_n74_ & ~x04 & x27)) & ((new_n74_ & (~x04 | ~x27)) | (new_n68_ & x29));
