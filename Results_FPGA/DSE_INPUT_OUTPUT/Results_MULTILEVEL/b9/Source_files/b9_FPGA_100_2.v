...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : ~x21;
  assign new_n72_ = x39 & (~x04 | (~x28 & x35 & (x08 | x27)));
  assign z03 = (x27 & (~x28 | ~x35)) | ~x21 | (x21 & ~x40) | (~x27 & ~x37);
  ...
  assign new_n89_ = (x27 | (x21 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x21 & ~x40 & (new_n66_ | ~x27));
  ...
  assign new_n96_ = ~x19 & x20 & ~new_n66_ & ~x21;
  assign new_n97_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n102_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = x40 ? (~new_n100_ & new_n101_) : x21;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (x21 | x40 | (~new_n66_ & x27)) & (~x40 | (~new_n103_ & (new_n101_ | (~new_n66_ & x27))));
  ...
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x21 | x40)));
