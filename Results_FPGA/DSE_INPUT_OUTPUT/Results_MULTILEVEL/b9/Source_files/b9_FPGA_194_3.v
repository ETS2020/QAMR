...
module FAU ( 
  ...
  assign z11 = ~x09 & ~x30 & ((~new_n87_ & ~new_n71_) | (~x08 & ~x27));
  assign new_n87_ = (x04 | x08) & (new_n88_ | (x04 & x27));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = ~new_n90_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n90_ = ~x04 & (new_n66_ | (x27 & (x37 | (x28 & x35))));
  ...
  assign z14 = ~new_n97_ | (~new_n95_ & (~new_n66_ | x13));
  assign new_n95_ = new_n96_ & (x37 | (x28 & x35));
  assign new_n96_ = ~x18 & ~x19 & x20 & x27;
  assign new_n97_ = ~x04 & (x30 | x32 | (x27 & (new_n98_ | ~x28)));
  ...
  assign z18 = (x08 & (new_n71_ | new_n88_)) | ~new_n103_ | (x27 & (new_n71_ | x04));
  assign new_n103_ = ~x09 & ~x30;
  assign z19 = (x04 & x27) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (x27 & ~x28 & (x04 | x35))) & (new_n88_ | (~x28 & (x35 | (x04 & x27))));
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (x08 | (x27 & (x04 | x35))) & (new_n88_ | ((x04 | x35) & (x27 | (~x28 & x35))));
endmodule
