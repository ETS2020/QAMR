...
module FAU ( 
  ...
  assign z04 = (x27 & (~x28 | ~x35)) | (x22 & ~x27 & ~x37) | (x21 & (x22 | x27));
  assign z05 = x37 | (~x22 & ~x27) | (x27 & x28);
  assign z06 = (~x28 & ~x37) | (~x27 & (~x22 | ~x37));
  ...
  assign z13 = (~new_n92_ & x27) | (~x22 & ~x27) | (~x04 & new_n85_ & ~x13);
  ...
  assign new_n97_ = (x22 | x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign new_n103_ = ~x09 & (x22 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
