...
module FAU ( 
  ...
  assign z18 = ~new_n102_ | (x08 & ((x29 & x40) | (new_n72_ & ~x27)));
  assign new_n102_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n67_ & ~x30;
  assign z19 = ~x09 & ~x30 & (new_n104_ | (~new_n105_ & ~x08));
  assign new_n104_ = (~new_n72_ | (x04 & x27)) & (~x40 | (~x29 & x39));
  assign new_n105_ = (x27 | (~x39 & x40)) & (~x39 | (~x28 & x35 & (~x04 | ~x40)));
