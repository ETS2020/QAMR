...
module FAU ( 
  ...
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | ~x04 | (x30 & x40);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n72_ | ~new_n73_ | x30;
  ...
  assign new_n83_ = ~x04 & ~new_n70_ & ~new_n84_;
  assign new_n84_ = (~x07 | (x40 & (x30 | x39))) & (~x39 | ~x40 | ~x05 | x30);
  assign new_n85_ = ~x04 & x05 & ~x30 & new_n73_ & x32;
  assign z11 = (x30 & x40) | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (new_n88_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x28 & x35 & ~x04 & x27));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | new_n67_ | (~new_n68_ & (~new_n73_ | x04));
  ...
  assign z20 = (x30 & x40) | (~x09 & ~new_n107_ & ~x30);
