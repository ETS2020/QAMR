...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & (x25 | x27)) | (x25 & ~x27 & x04 & ~x08);
  ...
  assign new_n90_ = ~x10 & ((x25 & ~x27) | (x27 & ~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & x27) | (~x25 & ~x27) | (~x04 & new_n85_ & ~x13);
  assign new_n92_ = (~new_n93_ | x04) & (x18 | x19 | new_n68_ | ~x20);
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x27 & (new_n97_ | (~new_n95_ & ~new_n99_))) | (x25 & ~new_n98_ & ~x27);
  ...
  assign z18 = ~new_n104_ | (x08 & ((new_n66_ & x29) | (new_n73_ & ~x27)));
  assign new_n104_ = ~x09 & (x25 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = (~x27 & (~x25 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = (x08 | (new_n73_ & ~x04)) & ((new_n66_ & x29) | (new_n73_ & (~x04 | ~x27)));
