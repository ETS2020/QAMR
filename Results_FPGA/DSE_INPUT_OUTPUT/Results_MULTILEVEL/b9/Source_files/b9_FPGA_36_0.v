...
module FAU ( 
  ...
  assign z07 = (~new_n80_ & x03) | (~x13 & ~x27);
  ...
  assign new_n89_ = (x08 | (new_n74_ & ~x04)) & ((new_n66_ & x29) | (new_n74_ & (~x04 | ~x27)));
  ...
  assign z18 = new_n106_ | (~new_n105_ & (x13 | x27));
  assign new_n105_ = ~x09 & ~x30 & (~new_n66_ | ~x08 | ~x29);
  assign new_n106_ = ~x28 & x35 & ((~x04 & x27) | (x08 & x13 & ~x27));
  assign z20 = (~x13 & ~x27) | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & ((new_n66_ & x29) | (x35 & (x27 | ~x28)));
  assign z19 = (~x27 & (~x13 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n89_ & ~x30);
endmodule
