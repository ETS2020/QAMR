...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n111_, new_n113_;
  assign z00 = (~x15 & (new_n67_ | (~new_n65_ & x27))) | ~x16 | (~x06 & x27);
  ...
  assign new_n72_ = (~x04 | (new_n73_ & (x08 | x27))) & new_n68_ & (x06 | ~x27);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (~x21 & (x06 | ~x27)) | (x06 & x27 & (~x28 | ~x35)) | (~x27 & ~x37);
  assign z04 = (x06 & x27 & (~x28 | ~x35)) | (~x27 & ~x37) | (x21 & (x06 | ~x27));
  assign z05 = (x06 & (x37 | (x27 & x28))) | (~x27 & x37);
  ...
  assign new_n85_ = x06 & x07 & x27 & ~new_n68_ & ~new_n70_;
  ...
  assign z12 = new_n91_ | (~x06 & x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x06) | (new_n97_ & ~x04);
  ...
  assign z14 = (~new_n102_ & ~x27) | (x06 & (new_n101_ | (~new_n99_ & ~new_n103_)));
  ...
  assign z18 = new_n109_ | (~new_n108_ & (x06 | ~x27));
  assign new_n108_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n109_ = ~x28 & x35 & ((~x04 & x06 & x27) | (x08 & ~x27));
  assign z19 = (~x06 & x27) | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = (new_n89_ | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
  assign z20 = (~x06 & x27) | (~x09 & ~new_n113_ & ~x30);
