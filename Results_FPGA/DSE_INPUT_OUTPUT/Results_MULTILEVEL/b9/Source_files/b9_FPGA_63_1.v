...
module FAU ( 
  ...
  assign new_n72_ = ~new_n73_ & new_n68_ & (x09 | ~x27);
  ...
  assign z10 = (~new_n86_ & x27) | (~x04 & ((new_n84_ & x27) | (new_n85_ & x05)));
  assign new_n84_ = ~new_n70_ & (new_n68_ ? x05 : x07);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign new_n86_ = x09 & (~x06 | ~x37);
  assign z11 = ~x09 & (x27 | (~new_n88_ & ~x30));
  assign new_n88_ = x08 & ((~x28 & x35) | (new_n68_ & x29));
  ...
  assign new_n92_ = x09 & (x18 | x19 | new_n66_ | ~x20);
  ...
  assign z18 = new_n88_ | x09 | x27 | x30;
  assign z19 = ~x09 & (x27 | (~new_n88_ & ~x30));
  assign z20 = ~x09 & (x27 | (~new_n88_ & ~x30));
endmodule
