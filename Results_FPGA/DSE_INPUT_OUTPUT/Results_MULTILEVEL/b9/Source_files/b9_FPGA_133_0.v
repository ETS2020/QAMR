...
module FAU ( 
  ...
  assign new_n85_ = (x08 | (new_n68_ & ~x04)) & (new_n86_ | (new_n68_ & (~x04 | ~x27)));
  assign new_n86_ = x29 & x39 & x40;
  assign z12 = ~x27 | (~x37 & (new_n88_ | (~x10 & ~x35 & ~x36)));
  assign new_n88_ = (~x28 | ~x35) & (~new_n71_ | x04);
  ...
  assign z18 = (~x04 & (new_n68_ | ~x27)) | ~new_n100_ | (x08 & (new_n86_ | (new_n68_ & ~x27)));
  assign new_n100_ = ~x09 & ~x30;
  assign z19 = (~x04 & ~x27) | (~x09 & ~x30 & ((~new_n103_ & x04) | (~new_n102_ & x27)));
  assign new_n102_ = ((~x28 & x35) | (new_n71_ & x08 & x29)) & (~x04 | (new_n71_ & x29));
