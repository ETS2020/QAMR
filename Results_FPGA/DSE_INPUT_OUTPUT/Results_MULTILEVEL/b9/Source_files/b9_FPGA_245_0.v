...
module FAU ( 
  ...
  assign new_n96_ = ~new_n97_ & new_n73_ & ~x04 & ~x13;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = (new_n99_ | x30) & (new_n66_ | (new_n73_ & ~x04 & ~x13));
  assign new_n99_ = x40 & (x32 | (x27 & (~x28 | x35 | x37)));
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = new_n65_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n104_ | (x08 & ((x29 & x39) | (new_n72_ & ~x27)));
  assign new_n104_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~x30 & x40;
  assign z20 = ~x30 & (~x40 | (~new_n106_ & ~x09));
  assign new_n106_ = (x08 | (x27 & x35)) & ((x29 & x39) | (x35 & (x27 | ~x28)));
  assign z19 = ~x09 & ~x30 & ~new_n87_ & x40;
endmodule
