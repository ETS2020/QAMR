...
module FAU ( 
  ...
  assign z07 = x03 & (new_n79_ | (x40 & (new_n78_ | (new_n77_ & ~x31))));
  assign new_n77_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign new_n78_ = ~x14 & (x00 | x25 | ~x38);
  assign new_n79_ = ~x14 & x33 & (x00 | x25 | ~x38);
  ...
  assign new_n84_ = (x33 | x40) & (~x06 | ~x27 | ~x37);
  assign z11 = ~x09 & ~x30 & ((~new_n87_ & ~new_n88_) | (~new_n86_ & ~x08));
  assign new_n86_ = (x27 | (~x33 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n87_ = x40 ? (x29 & x39) : ~x33;
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n90_ | new_n65_ | (~new_n66_ & (~z08 | x04));
  ...
  assign z19 = new_n65_ | (~x09 & ~x30 & (new_n108_ | (~new_n88_ & ~new_n107_)));
  assign new_n107_ = x29 & x39 & x40;
  assign new_n108_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
