...
module FAU ( 
  ...
  assign z11 = new_n67_ | (~x09 & ~x30 & (new_n84_ | new_n86_));
  assign new_n84_ = ~new_n85_ & (~x29 | ~x40);
  assign new_n85_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n86_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = (x39 & (new_n89_ | (x04 & (new_n88_ | ~x27)))) | (~x40 & (new_n88_ | ~x27));
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n91_ | (x40 & (~x39 | (~x04 & ~new_n82_ & ~x13)));
  assign new_n91_ = x27 & (new_n92_ | (~x18 & ~x19 & ~new_n88_ & x20));
  assign new_n92_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n95_ | (~new_n94_ & (~x40 | (x39 & (x04 | x13))));
  assign new_n94_ = ~new_n88_ & ~x18 & ~x19 & x20 & x27;
  assign new_n95_ = ~x30 & ~x32 & x39 & (~x27 | (~new_n96_ & x28));
  assign new_n96_ = ((~x18 & ~x19 & x20) | (x35 & x36)) & (x35 | x37);
  assign z15 = x12 & x26 & x27 & ~new_n67_ & x34;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n101_ & (x39 | ~x40)) | (x08 & x29 & x39 & x40);
  assign new_n101_ = ~new_n102_ & ~x09 & ~x30;
  assign new_n102_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = ~x09 & ~new_n104_ & ~x30;
  assign new_n104_ = (new_n105_ | x08) & (new_n85_ | (x40 & (x29 | ~x39)));
  assign new_n105_ = (x27 | (~x39 & x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = ~new_n108_ & (x08 | ((x35 | ~x39) & (x27 | (~x39 & x40))));
  assign new_n108_ = (~x40 | (~x29 & x39)) & (~x35 | (~x27 & x28));
  assign z08 = x40;
endmodule
