...
module FAU ( 
  ...
  assign new_n84_ = ~new_n85_ & (~x29 | ~x39);
  ...
  assign z13 = new_n91_ | (x39 & (~x40 | (~x04 & ~new_n82_ & ~x13)));
  assign new_n91_ = x27 & (new_n92_ | (~x18 & ~x19 & ~new_n88_ & x20));
  assign new_n92_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign z14 = new_n95_ | (~new_n94_ & (~x39 | (x40 & (x04 | x13))));
  assign new_n94_ = ~new_n88_ & ~x18 & ~x19 & x20 & x27;
  assign new_n95_ = ~x30 & ~x32 & x40 & (~x27 | (~new_n96_ & x28));
  ...
  assign new_n104_ = (new_n105_ | x08) & (new_n85_ | (x39 & (x29 | ~x40)));
  assign new_n105_ = (x27 | (x39 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
