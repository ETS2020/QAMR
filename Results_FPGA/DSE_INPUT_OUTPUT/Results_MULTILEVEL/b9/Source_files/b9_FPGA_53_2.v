...
module FAU ( 
  ...
  assign new_n72_ = (x27 | (~x25 & (~x04 | x08))) & new_n68_ & (new_n73_ | ~x04);
  assign new_n73_ = ~x28 & x35;
  assign z03 = (x27 & (~x28 | ~x35)) | ~x21 | (~x27 & (x25 | ~x37));
  assign z04 = (x21 & (~x25 | x27)) | (x27 & (~x28 | ~x35)) | (~x25 & ~x27 & ~x37);
  assign z05 = (~x25 & x37) | (x27 & (x28 | x37));
  assign z06 = ~x37 & (x27 ? ~x28 : ~x25);
  assign z07 = x03 & (new_n80_ | (~x31 & new_n79_ & ~x33));
  assign new_n79_ = (x15 | ~x17) & ((x27 & ~x38) | (~x25 & (x00 | ~x38)));
  assign new_n80_ = ~x14 & (x25 ? x27 : (x00 | ~x38));
  assign z08 = new_n68_ | (x25 & ~x27);
  assign z09 = (x25 & ~x27) | (x27 & x34 & x11 & x26);
  ...
  assign new_n88_ = (x08 | (new_n73_ & ~x04)) & ((new_n68_ & x29) | (new_n73_ & (~x04 | ~x27)));
  assign z12 = new_n90_ | (x25 & ~x27) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (new_n95_ & ~x04) | (x27 & (new_n92_ | (new_n93_ & ~x04)));
  assign new_n92_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n93_ = ~x13 & new_n94_ & x39;
  assign new_n94_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n95_ = ~x13 & ~x25 & x39 & x40 & (x30 | x32);
  assign z14 = (x27 & (new_n99_ | (~new_n97_ & ~new_n101_))) | (~x25 & ~new_n100_ & ~x27);
  ...
  assign new_n107_ = ~x28 & x35 & ((~x04 & x27) | (x08 & ~x25 & ~x27));
  assign z19 = ~x09 & ~x30 & ((new_n109_ & x27) | (~new_n110_ & ~x25));
  assign new_n109_ = (~new_n73_ | x04) & (~new_n68_ | ~x08 | ~x29);
  assign new_n110_ = (x08 | x27) & (new_n73_ | (new_n68_ & x29));
  assign z20 = (x25 & ~x27) | (~x09 & ~new_n112_ & ~x30);
  assign new_n112_ = (x08 | (x27 & x35)) & ((new_n68_ & x29) | (x35 & (x27 | ~x28)));
endmodule
