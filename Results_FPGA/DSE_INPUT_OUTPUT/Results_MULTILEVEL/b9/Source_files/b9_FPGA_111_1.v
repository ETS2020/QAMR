...
module FAU ( 
  ...
  assign new_n85_ = x06 & x07 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n86_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~new_n88_ & ~x30;
  assign new_n88_ = (new_n89_ | ((new_n73_ | (~x06 & x27)) & (~x04 | ~x06 | ~x27))) & (x08 | (x27 & (~x06 | (new_n73_ & ~x04))));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | ((~new_n66_ | x04) & (~x27 | (new_n68_ & x06)));
  assign new_n91_ = ~x10 & (~x27 | (x06 & ~x35 & ~x36 & ~x37));
  assign z13 = (x06 & ((~new_n93_ & x27) | (new_n95_ & ~x04))) | (new_n96_ & ~x04);
  assign new_n93_ = (~new_n94_ | x04) & (x18 | x19 | new_n68_ | ~x20);
  ...
  assign new_n100_ = (x06 | ~x27) & ((new_n66_ & ~x04 & ~x13) | (~new_n68_ & x27));
  ...
  assign z18 = ~new_n106_ | (x08 & (new_n89_ | (new_n73_ & ~x27)));
  assign new_n106_ = (~x27 | (x06 & (~new_n73_ | x04))) & ~x09 & ~x30;
  assign z20 = (~x06 & x27) | (~x09 & ~new_n108_ & ~x30);
