...
module FAU ( 
  ...
  assign z10 = new_n83_ | (x05 & x39 & ~new_n82_ & x40);
  assign new_n82_ = (x04 | (~x30 & ~x32)) & (~x27 | (~new_n71_ & ~x36));
  assign new_n83_ = x27 & ((new_n84_ & x07) | x04 | (x06 & x37));
  assign new_n84_ = (~x39 | ~x40) & (x36 | (~x28 & x35));
  assign z11 = ~x09 & ~x30 & ((~new_n86_ & ~new_n71_) | (~x08 & ~x27));
  assign new_n86_ = (x04 | x08) & ((x04 & x27) | (new_n66_ & x29));
  ...
  assign new_n90_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n91_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n92_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ((~new_n66_ | x13) & (~x27 | (~new_n96_ & ~x04))) | new_n94_ | (x04 & ~x27);
  assign new_n94_ = ~x30 & ~x32 & (~x27 | (~x04 & ~new_n95_ & x28));
  ...
  assign z18 = ~new_n101_ | (x08 & (new_n71_ | (new_n66_ & x29)));
  assign new_n101_ = ~x09 & ~x30 & (~x27 | (~new_n71_ & ~x04));
  assign z19 = (x04 & x27) | (~x09 & ~x30 & (new_n103_ | (~x08 & ~x27)));
  assign new_n103_ = ~new_n71_ & (~new_n66_ | ~x08 | ~x29);
  assign z20 = (x04 & x27) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (x27 & x35)) & ((new_n66_ & x29) | (x35 & (x27 | ~x28)));
endmodule
