...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & ~x02) | ~new_n68_ | (x04 & (~new_n70_ | ~x27));
  ...
  assign new_n86_ = (~new_n68_ | ~new_n72_) & (~new_n70_ | x04);
  ...
  assign new_n102_ = ~x09 & ~x30 & (~new_n68_ | ~new_n72_);
  assign z19 = (~x09 & new_n104_ & ~x30) | (~x27 & (x04 | (~x04 & ~x08 & ~x09 & ~x30)));
  assign new_n104_ = (~new_n68_ | ~new_n72_) & ((~x35 & (~x04 | x27)) | x04 | x28);
  assign z20 = ~x09 & ~x30 & (new_n107_ | (~new_n106_ & ~x04));
  assign new_n106_ = (x08 | (x27 & x35)) & ((new_n68_ & x29) | (x35 & (x27 | ~x28)));
  assign new_n107_ = x27 & ~x35 & (~new_n68_ | ~new_n72_);
endmodule
