...
module FAU ( 
  ...
  assign new_n71_ = (~x04 | (~x28 & x35)) & new_n72_ & (x27 | (x04 & x08));
  ...
  assign new_n83_ = (x36 | (~x28 & x35)) & (new_n72_ ? x05 : x07);
  ...
  assign z12 = (~x37 & (new_n89_ | (~new_n66_ & (x04 | (~new_n72_ & x27))))) | (x04 & ~x27);
  ...
  assign new_n103_ = ((~x28 & x35) | ((new_n87_ | (~x04 & ~x27)) & (x08 | ~x27))) & (~x04 | (x08 & (new_n87_ | ~x27)));
  assign z20 = (~x04 & ~x27) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (x27 & x35)) & (new_n87_ | (x35 & (x27 | ~x28)));
endmodule
