...
module FAU ( 
  ...
  assign z12 = new_n90_ | (~x39 & ~x40) | (~new_n91_ & (x04 | ~x39 | ~x40));
  ...
  assign new_n98_ = x39 ? (~new_n99_ & ~x04 & ~x13 & x40) : ~x40;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = x39 ? (~new_n101_ & (new_n91_ | (~x04 & ~x13 & x40))) : (new_n91_ | ~x40);
  ...
  assign new_n109_ = (x08 | (x27 & x35)) & ((x35 & (x27 | ~x28)) | (z08 & x29));
