...
module FAU ( 
  ...
  assign z00 = new_n65_ | ~x16 | (~x15 & x27 & (new_n67_ | ~new_n68_));
  assign new_n65_ = x10 & (~x27 | (new_n66_ & ~x04 & ~x15));
  ...
  assign z11 = ~x09 & ~x30 & ((~new_n89_ & ~x10) | (new_n88_ & x27));
  assign new_n88_ = (~new_n73_ | x04) & (~new_n66_ | ~x08 | ~x29);
  assign new_n89_ = (new_n73_ | (new_n66_ & x29)) & (x08 | x27);
  assign z12 = ~x27 | (~x37 & (new_n91_ | (~x10 & ~x35 & ~x36)));
  assign new_n91_ = (~x28 | ~x35) & (~new_n66_ | x04);
  assign z13 = (~x04 & ~x13 & new_n93_ & x39) | (new_n95_ & ~x18);
  assign new_n93_ = x40 & (((~x10 | x27) & (x30 | x32)) | (~new_n94_ & x27));
  ...
  assign z19 = (~x27 & (x10 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n109_ & ~x30);
  assign new_n109_ = (x08 | (new_n73_ & ~x04)) & ((new_n66_ & x29) | (new_n73_ & (~x04 | ~x27)));
  assign z20 = (x10 & ~x27) | (~x09 & ~new_n111_ & ~x30);
