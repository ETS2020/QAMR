...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n74_,
    new_n75_, new_n80_, new_n81_, new_n84_, new_n85_, new_n86_, new_n88_,
  ...
  assign new_n84_ = (~x07 | (~x39 ^ x40)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x06 & x37 & (x39 | x40);
  assign new_n86_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n89_ & ~new_n90_) | (~new_n88_ & ~x08));
  assign new_n88_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign new_n89_ = x39 ? (x29 & x40) : ~x40;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = x39 ? (new_n92_ | (~new_n93_ & (x04 | ~x40))) : (~new_n93_ & x40);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign z13 = ~new_n97_ | (x27 & (new_n96_ | (new_n95_ & ~x04)));
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n97_ = (x39 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  ...
  assign z18 = ((x39 | x40) & (new_n107_ | x09 | x30)) | (new_n74_ & x39 & x40);
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n70_ | (~x09 & ~x30 & (new_n109_ | new_n110_));
  assign new_n109_ = ~x08 & (~x27 | ~x35);
  assign new_n110_ = (~x35 | (~x27 & x28)) & (~x29 | ~x39 | ~x40);
