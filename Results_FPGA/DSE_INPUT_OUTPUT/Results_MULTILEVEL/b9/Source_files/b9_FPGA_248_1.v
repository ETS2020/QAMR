...
module FAU ( 
  ...
  assign z02 = ~x40 | (x27 & (new_n71_ | ~x39 | (~new_n69_ & x04)));
  ...
  assign z06 = (~x27 & (~x37 | x40)) | (~x28 & ~x37);
  ...
  assign new_n82_ = (~new_n84_ | ~x05) & ((~new_n69_ & ~x36) | (new_n83_ ? ~x05 : ~x07));
  assign new_n83_ = x39 & x40;
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = (~x27 & x40) | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = ((new_n83_ & x29) | (new_n69_ & (~x04 | ~x27))) & (new_n69_ | (x08 & x27)) & (x08 | (~x04 & x27));
  assign z12 = (~x27 & ~x40) | (~new_n88_ & ~x37);
  ...
  assign z14 = new_n96_ | ~x27 | (~new_n94_ & (x18 | x19 | ~x20));
  ...
  assign z18 = ~new_n101_ | (x08 & ((new_n83_ & x29) | (new_n69_ & ~x27)));
  assign new_n101_ = ~x09 & (x27 | ~x40) & ~x30 & (~new_n69_ | x04 | ~x27);
  assign z19 = (~x27 & (x40 | (~x30 & ~x40 & ~x08 & ~x09))) | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (new_n69_ | x40) & (~x27 | (((new_n104_ & x08) | (new_n69_ & ~x04)) & (~x04 | x40)));
  assign new_n104_ = x29 & x39;
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = (x08 | (x27 ? x35 : x40)) & (x35 | (x40 & (new_n104_ | ~x27))) & (x27 | ~x28 | x40);
endmodule
