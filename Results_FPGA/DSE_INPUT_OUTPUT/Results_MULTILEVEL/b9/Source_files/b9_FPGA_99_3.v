...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | ~new_n66_ | new_n70_;
  ...
  assign new_n81_ = (x36 | (~x28 & x35)) & (new_n66_ ? x05 : x07);
  ...
  assign z12 = (~x10 & (new_n87_ | ~x27)) | (~new_n66_ & (~x27 | (new_n88_ & ~x04))) | (x04 & ~x27);
  assign new_n87_ = ~x04 & ~x35 & ~x36 & ~x37;
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign z13 = (x27 & (new_n92_ | x04)) | (~x13 & new_n90_ & x39);
  assign new_n90_ = x40 & ((~new_n91_ & x27) | (~x04 & (x30 | x32)));
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = ~x18 & ~x19 & ~new_n88_ & x20;
  assign z14 = ~new_n95_ | (~new_n94_ & (~new_n66_ | x13));
  assign new_n94_ = ~new_n88_ & x20 & x27 & ~x18 & ~x19;
  ...
  assign z18 = ~new_n101_ | (x08 & (new_n85_ | (~x28 & x35)));
  assign new_n101_ = (~x27 | (~x04 & (x28 | ~x35))) & ~x09 & ~x30;
  assign z19 = (x04 & x27) | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (x08 | (x27 & ~x28 & (x04 | x35))) & (new_n85_ | (~x28 & (x35 | (x04 & x27))));
  assign z20 = ~x09 & ~new_n105_ & ~x30;
  assign new_n105_ = (x08 | (x27 & (x04 | x35))) & (new_n85_ | ((x04 | x35) & (x27 | (~x28 & x35))));
endmodule
