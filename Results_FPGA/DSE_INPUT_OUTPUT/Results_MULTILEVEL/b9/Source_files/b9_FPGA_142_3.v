...
module FAU ( 
  ...
  assign new_n72_ = (~x04 | (new_n73_ & (x08 | x27))) & new_n68_ & (~x09 | ~x27);
  ...
  assign z10 = (~new_n84_ & ~x04) | (x27 & (x09 | (x06 & x37)));
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n70_ | (new_n68_ ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = (x09 & x27) | (~new_n87_ & ~x30);
  assign new_n87_ = (new_n88_ | ((~x04 | ~x27) & (new_n73_ | x09))) & (x08 | x09 | (new_n73_ & ~x04 & x27));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n90_ | ((~x27 | (new_n66_ & ~x09)) & (~new_n68_ | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x09 & ~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & ~x09) | (~x04 & ~x13 & new_n85_ & ~x27);
  ...
  assign z18 = new_n106_ | (~x09 & (x30 | (new_n73_ & ~x04 & x27))) | (x09 & ~x27);
  assign new_n106_ = x08 & ((new_n73_ & ~x27) | (new_n68_ & ~x09 & x29));
