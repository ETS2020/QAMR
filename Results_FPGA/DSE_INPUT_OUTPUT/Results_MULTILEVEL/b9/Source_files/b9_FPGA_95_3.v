...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
    ...
    new_n100_, new_n101_, new_n106_, new_n108_;
  ...
  assign new_n69_ = x30 & x40;
  assign z01 = (~x30 & ~x32 & (new_n71_ | ~x27)) | ~x04 | (x30 & x40);
  assign new_n71_ = ~x36 & (x28 | ~x35);
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n73_ | ~new_n68_ | x30;
  ...
  assign z10 = new_n86_ | (x27 & (new_n84_ | (x06 & ~new_n69_ & x37)));
  assign new_n84_ = ~x04 & ~new_n71_ & ~new_n85_;
  assign new_n85_ = (~x07 | (x40 & (x30 | x39))) & (~x39 | ~x40 | ~x05 | x30);
  assign new_n86_ = ~x04 & x05 & ~x30 & new_n68_ & x32;
  assign z11 = ~x09 & ~new_n88_ & ~x30;
  assign new_n88_ = (new_n89_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x28 & x35 & ~x04 & x27));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | new_n69_ | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n96_ | (x27 & ((~new_n93_ & ~x30) | (new_n95_ & ~x18)));
  assign new_n93_ = (~new_n94_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x19 & x20 & ~new_n66_ & ~x40;
  assign new_n96_ = new_n68_ & x32 & ~x04 & ~x13 & ~x30;
  assign z14 = ~new_n100_ | new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = new_n99_ & (~x28 | x32 | (x35 & x36));
  assign new_n99_ = ~x04 & ~x13 & x39 & x40;
  assign new_n100_ = ~new_n69_ & (new_n99_ | (~new_n66_ & x27));
  ...
  assign z18 = ~new_n106_ | (x08 & (new_n89_ | (~x27 & ~x28 & x35)));
  assign new_n106_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = (~x09 & ~new_n108_ & ~x30) | (x30 & x40);
