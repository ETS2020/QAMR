...
module FAU ( 
  ...
  assign z11 = ~x09 & new_n88_ & x27;
  assign new_n88_ = ~x30 & (~new_n74_ | x04) & (~new_n66_ | ~x08 | ~x29);
  ...
  assign new_n92_ = x40 & (((x09 | x27) & (x30 | x32)) | (~new_n93_ & x27));
  ...
  assign z18 = x09 | (~new_n88_ & x27);
  assign z20 = ~x09 & (~x27 | (new_n106_ & x27));
  assign new_n106_ = ~x30 & ~x35 & (~new_n66_ | ~x08 | ~x29);
  assign z19 = ~x09 & new_n88_ & x27;
endmodule
