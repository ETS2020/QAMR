...
module FAU ( 
  ...
  assign new_n97_ = x27 & (x04 | x13 | ~x39 | ~x40);
  assign new_n98_ = (~x28 | (~new_n100_ & (new_n99_ | x27))) & (~x27 | x37 | new_n99_ | (x28 & x35));
  ...
  assign z18 = new_n105_ | ((x27 | x28) & (x09 | new_n87_ | x30));
  assign new_n105_ = ~x04 & x27 & ~x28 & x35;
  assign z19 = (~x27 & ~x28) | (~x09 & ~x30 & ~new_n87_ & ~new_n105_);
  assign z20 = (~x27 & ~x28) | (~x09 & ~x30 & ~new_n87_ & (~x27 | ~x35));
endmodule
