...
module FAU ( 
  ...
  assign new_n88_ = (x27 | (~x36 & ~x40)) & (~x40 | (new_n71_ & ~x04));
  assign new_n89_ = new_n71_ & (~x04 | ~x27);
  assign new_n90_ = x40 ? (x29 & x39) : ~x36;
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & (new_n66_ | ~x27)))) | (x36 & ~x40 & (new_n66_ | ~x27));
  ...
  assign new_n97_ = ~x19 & x20 & ~new_n66_ & x36;
  assign new_n98_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | (~new_n100_ & (x04 | x13 | ~x39 | ~x40));
  assign new_n100_ = ~new_n66_ & x20 & x27 & ~x18 & ~x19;
  assign new_n101_ = ~new_n68_ & (x30 | x32 | (x27 & (new_n102_ | ~x28)));
  ...
  assign new_n111_ = (x27 | (~x36 & ~x40)) & ~x28 & (~x40 | (~x04 & x35));
  assign new_n112_ = (~x04 | ~x27) & ~x28 & (x35 | ~x40);
  assign new_n113_ = ~x40 & ((x04 & x27) | x28 | (~x35 & x36));
  assign z20 = new_n115_ & ~x09;
  assign new_n115_ = ~x30 & (new_n116_ | (~new_n90_ & (~x35 | (~x27 & x28))));
  assign new_n116_ = ~x08 & ((~x35 & x40) | (~x27 & (x36 | x40)));
endmodule
