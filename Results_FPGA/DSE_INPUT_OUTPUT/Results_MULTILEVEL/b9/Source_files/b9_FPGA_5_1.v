...
module FAU ( 
  ...
  assign new_n83_ = ~new_n85_ & (~x27 | new_n84_ | (~new_n71_ & ~x36));
  assign new_n84_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n87_ & ~z08) | (~new_n88_ & ~x08));
  assign new_n87_ = new_n71_ & (~x04 | ~x27);
  assign new_n88_ = (x27 | (~x29 & x40)) & (~x29 | (new_n71_ & ~x04));
  assign z12 = new_n91_ | (~x29 & x40) | (~new_n90_ & (x04 | ~x39 | ~x40));
  assign new_n90_ = ~new_n66_ & x27;
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n93_ | (new_n94_ & ~x04))) | (~new_n95_ & x40);
  assign new_n93_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = x29 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign z18 = (x39 & x40 & x08 & x29) | (~new_n105_ & (x29 | ~x40));
  assign new_n105_ = ~new_n106_ & ~x09 & ~x30;
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = new_n68_ | (new_n108_ & ~x09);
  assign new_n108_ = ~x30 & (new_n109_ | (~new_n110_ & ~x08) | (~z08 & ~x35));
  assign new_n109_ = (x28 | (x04 & x27)) & (~x39 | ~x40);
  assign new_n110_ = (x27 | (~x29 & x40)) & ~x28 & (~x29 | x35) & (~x04 | ~x40);
