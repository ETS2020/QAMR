...
module FAU ( 
  ...
  assign new_n101_ = ~x04 & ~x13 & new_n72_ & (x30 | x32);
  assign new_n102_ = ~x18 & ~x19 & x20;
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = x01 & x22 & ~x23 & (x06 | x27);
  assign z17 = (~x06 & ~x27) | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n108_ | (~new_n107_ & (x06 | x27));
  assign new_n107_ = ~x09 & ~x30 & (~new_n72_ | ~x08 | ~x29);
  assign new_n108_ = ~x28 & x35 & ((~x04 & x27) | (x06 & x08 & ~x27));
  assign z19 = (~x27 & (~x06 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n110_ & ~x30);
  assign new_n110_ = (x08 | (new_n73_ & ~x04)) & ((new_n72_ & x29) | (new_n73_ & (~x04 | ~x27)));
  assign z20 = (~x06 & ~x27) | (~x09 & ~new_n112_ & ~x30);
