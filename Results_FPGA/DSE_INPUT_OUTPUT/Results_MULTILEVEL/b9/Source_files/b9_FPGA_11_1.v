...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (x33 | ~x40)) | (~x04 & ~x15 & new_n66_ & x33);
  ...
  assign new_n85_ = (x33 | ~x40) & (~x06 | ~x27 | ~x37);
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~new_n89_) | (~new_n87_ & ~x08));
  assign new_n87_ = (~x33 | (~x04 & ~x28 & x35)) & (x27 | (~x33 & x40));
  assign new_n88_ = x40 & (~x33 | (x29 & x39));
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n92_ | (~x33 & x40) | (~new_n91_ & (x04 | ~x39 | ~x40));
  ...
  assign new_n96_ = x33 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n107_ = x08 & x29 & x33 & x39 & x40;
  assign z19 = new_n68_ | (~x09 & ~x30 & (new_n110_ | (~new_n89_ & ~new_n109_)));
  assign new_n109_ = x29 & x39 & x40;
  assign new_n110_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
