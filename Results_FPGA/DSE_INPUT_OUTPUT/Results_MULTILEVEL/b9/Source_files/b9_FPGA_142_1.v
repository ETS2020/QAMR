...
module FAU ( 
  ...
  assign new_n87_ = ~x30 & (~x08 | ((x28 | ~x35) & (~new_n68_ | ~x29)));
  assign z12 = new_n89_ | ((~x27 | (new_n66_ & x09)) & (~new_n68_ | x04));
  assign new_n89_ = ~x10 & (~x27 | (x09 & ~x35 & ~x36 & ~x37));
  assign z13 = (~new_n91_ & x09) | (~x04 & ~x13 & new_n85_ & ~x27);
  ...
  assign z14 = (~new_n99_ & ~x27) | (x09 & (new_n98_ | (~new_n96_ & ~new_n100_)));
  ...
  assign z20 = ~x09 & (x27 | (new_n87_ & ~x27));
