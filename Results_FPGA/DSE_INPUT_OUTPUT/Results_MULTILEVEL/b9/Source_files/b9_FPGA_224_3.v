...
module FAU ( 
  ...
  assign new_n88_ = x40 & ((~new_n89_ & x27) | (~x04 & (x30 | x32)));
  ...
  assign z20 = (x04 & x27) | (~x09 & ~new_n101_ & ~x30);
  assign new_n101_ = (x08 | (x27 & x35)) & ((x35 & (x27 | ~x28)) | (new_n66_ & x29));
  assign z19 = (x04 & x27) | (~x09 & ~x30 & (new_n84_ | (~x08 & ~x27)));
endmodule
