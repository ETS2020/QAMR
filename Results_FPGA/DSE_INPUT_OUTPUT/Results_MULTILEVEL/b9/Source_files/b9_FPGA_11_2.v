...
module FAU ( 
  ...
  assign new_n83_ = (~x33 | x40) & (~x06 | ~x27 | ~x37);
  assign z11 = ~x09 & ~x30 & ((~new_n86_ & ~new_n87_) | (~new_n85_ & ~x08));
  assign new_n85_ = (x27 | (x33 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n86_ = x40 ? (x29 & x39) : x33;
  ...
  assign z19 = new_n65_ | (~x09 & ~x30 & (new_n107_ | (~new_n87_ & ~new_n106_)));
  assign new_n106_ = x29 & x39 & x40;
  assign new_n107_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
