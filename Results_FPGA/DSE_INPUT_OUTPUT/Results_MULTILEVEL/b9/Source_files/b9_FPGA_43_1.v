...
module FAU ( 
  ...
  assign z18 = (~new_n97_ & x08) | x09 | new_n76_ | x30;
  assign new_n97_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign z20 = new_n76_ | (~x09 & ~x30 & (new_n99_ | new_n100_));
  assign new_n99_ = ~x08 & (~x27 | ~x35);
  assign new_n100_ = (~x29 | ~x39 | ~x40) & ((~x27 & x28) | ~x35);
  assign z19 = ~x09 & ~x30 & ((~new_n84_ & ~new_n85_) | (~new_n76_ & ~x08));
endmodule
