...
module FAU ( 
  ...
  assign new_n105_ = (new_n106_ | x08) & (new_n84_ | (x39 & (x29 | ~x40)));
  assign new_n106_ = (x27 | (x39 & ~x40)) & (~x40 | (~x28 & x35 & (~x04 | ~x39)));
  assign z20 = new_n67_ | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & ((x29 & x39) | ((x27 | ~x28) & x35));
  assign z06 = ~z05;
  assign z08 = x39;
endmodule
