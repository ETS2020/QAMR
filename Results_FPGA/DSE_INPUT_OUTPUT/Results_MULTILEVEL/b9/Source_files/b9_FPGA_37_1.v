...
module FAU ( 
  ...
  assign z04 = (x27 & (~x25 | ~x28 | ~x35)) | x21 | (~x27 & ~x37);
  ...
  assign new_n85_ = x07 & x25 & x27 & ~new_n66_ & ~new_n70_;
  ...
  assign z12 = new_n91_ | (~x25 & x27) | ((~new_n66_ | x04) & (new_n68_ | ~x27));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & ((new_n94_ & ~x04) | new_n93_ | ~x25)) | (new_n95_ & ~x04);
  ...
  assign new_n99_ = (x25 | ~x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign new_n105_ = ~x09 & ~x30 & (~x27 | (x25 & (~new_n73_ | x04)));
  assign z19 = (~x25 & x27) | (~x09 & ~x30 & (new_n107_ | new_n108_));
  assign new_n107_ = ~new_n89_ & ((~x35 & (x25 | ~x27)) | x28 | (x04 & x27));
  assign new_n108_ = ~x08 & (x04 | ~x27 | x28 | (x25 & ~x35));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 & (~x25 | x35))) & (new_n89_ | ((x27 | (~x28 & x35)) & (~x25 | x35)));
endmodule
