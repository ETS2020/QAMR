...
module FAU ( 
  ...
  assign new_n86_ = (new_n71_ | ((x04 | x08) & (new_n87_ | (x04 & x27)))) & (x08 | x27);
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = ~new_n89_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n89_ = ~x04 & (new_n66_ | (x27 & (x37 | (x28 & x35))));
  assign z13 = ~x04 & ((new_n84_ & ~x13) | (x27 & (new_n92_ | (new_n91_ & ~x13))));
  ...
  assign z18 = (x08 & (new_n71_ | new_n87_)) | ~new_n101_ | (x27 & (new_n71_ | x04));
  assign new_n101_ = ~x09 & ~x30;
  assign z19 = (x04 & x27) | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (x08 | (x27 & ~x28 & (x04 | x35))) & (new_n87_ | (~x28 & (x35 | (x04 & x27))));
