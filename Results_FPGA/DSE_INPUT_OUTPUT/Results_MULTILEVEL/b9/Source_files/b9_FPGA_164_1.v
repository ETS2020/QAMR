...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n72_, new_n77_,
    ...
    new_n111_, new_n112_;
  assign z00 = (~new_n65_ & (x17 | ~x40)) | (~x04 & ~x15 & new_n66_ & x17);
  ...
  assign new_n77_ = (x17 ? x15 : ~x40) & (~x38 | (x00 & ~x25));
  assign new_n78_ = ~x14 & (x17 | ~x40) & (x00 | x25 | ~x38);
  ...
  assign new_n84_ = (~x06 | ~x27 | ~x37) & (x17 | ~x40);
  assign z11 = new_n86_ | (~x09 & ~x30 & (new_n89_ | (~new_n87_ & ~new_n88_)));
  assign new_n86_ = x40 & (~x17 | (x04 & ~x08 & ~x09 & ~x30));
  assign new_n87_ = x29 & x39 & x40;
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n89_ = ~x08 & (~x27 | x28 | ~x35);
  assign z12 = new_n92_ | (~x17 & x40) | (~new_n91_ & (x04 | ~x39 | ~x40));
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n96_ & x40) | (x27 & (new_n95_ | (new_n94_ & ~x04)));
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = x17 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n98_ & (new_n99_ | ~new_n100_)) | new_n101_ | new_n68_ | (~new_n91_ & ~new_n100_);
  ...
  assign z18 = (~new_n106_ & x08) | ~new_n107_ | new_n68_ | x09;
  assign new_n106_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n107_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = new_n68_ | (~x09 & ~x30 & (new_n109_ | (~new_n87_ & ~new_n88_)));
  assign new_n109_ = ~x08 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n111_ | new_n112_));
