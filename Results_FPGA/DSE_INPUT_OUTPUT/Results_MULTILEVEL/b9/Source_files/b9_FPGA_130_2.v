...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x13;
  ...
  assign new_n85_ = ~new_n86_ & (x28 | ~x35 | (x04 & x27));
  assign new_n86_ = x40 ? (x29 & x39) : x13;
  assign new_n87_ = (x27 | (x13 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n89_ | new_n69_ | (~new_n90_ & (~z08 | x04));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n90_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n92_ & x27) | (x13 & ~x40) | (~x04 & new_n83_ & ~x13);
  ...
  assign new_n95_ = x13 ? ~x40 : (~new_n96_ & ~x04 & x39 & x40);
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = x13 ? (new_n90_ | ~x40) : (~new_n98_ & (new_n90_ | (~x04 & x39 & x40)));
  ...
  assign z20 = new_n106_ & ~x09;
  assign new_n106_ = ~x30 & (new_n107_ | (~new_n86_ & (~x35 | (~x27 & x28))));
  assign new_n107_ = ~x08 & ((~x35 & x40) | (~x27 & (~x13 | x40)));
  assign z05 = ~z06;
