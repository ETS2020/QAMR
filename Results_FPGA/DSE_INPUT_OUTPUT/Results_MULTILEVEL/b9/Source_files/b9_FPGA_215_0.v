...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x17 | x40);
  assign z01 = (~x30 & ~x32 & (new_n71_ | ~x27)) | new_n70_ | ~x04;
  assign new_n70_ = ~x17 & ~x40;
  assign new_n71_ = ~x36 & (x28 | ~x35);
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : x17;
  ...
  assign new_n80_ = ~x14 & (x17 | x40) & (x00 | x25 | ~x38);
  assign z08 = x39 & x40;
  assign z09 = x11 & x26 & x27 & ~new_n70_ & x34;
  assign z10 = (x27 & (new_n85_ | (~x04 & ~new_n71_ & ~new_n84_))) | (new_n86_ & ~x04);
  assign new_n84_ = (~x07 | (x40 ? x39 : ~x17)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x06 & x37 & (x17 | x40);
  assign new_n86_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n89_ & ~new_n90_) | (~new_n88_ & ~x08));
  assign new_n88_ = (x27 | (~x17 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 ? (x29 & x39) : ~x17;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & (x04 | ~x39)))) | (x17 & ~new_n93_ & ~x40);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n97_ | (x27 & ((x40 & (new_n95_ | new_n96_)) | (new_n96_ & x17)));
  assign new_n95_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n97_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n99_ & (new_n100_ | ~new_n101_)) | new_n102_ | new_n70_ | (~new_n93_ & ~new_n101_);
  ...
  assign z15 = new_n70_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n107_ & x08) | ~new_n108_ | new_n70_ | x30;
  assign new_n107_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n108_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = new_n70_ | (~x09 & ~x30 & (new_n111_ | (~new_n90_ & ~new_n110_)));
  assign new_n110_ = x29 & x39 & x40;
  assign new_n111_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n70_ | (~x09 & ~x30 & (new_n113_ | new_n114_));
  assign new_n113_ = ~x08 & (~x27 | ~x35);
  assign new_n114_ = (~x29 | ~x39 | ~x40) & (~x35 | (~x27 & x28));
endmodule
