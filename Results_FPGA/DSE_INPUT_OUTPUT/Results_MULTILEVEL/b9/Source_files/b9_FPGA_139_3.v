...
module FAU ( 
  ...
  assign new_n86_ = x27 & x37 & x06 & ~x25;
  assign z11 = (x25 & x27) | (~x09 & ~new_n88_ & ~x30);
  assign new_n88_ = (new_n89_ | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | ((~new_n66_ | x04) & (~x27 | (new_n68_ & ~x25)));
  assign new_n91_ = ~x10 & (~x27 | (~x36 & ~x37 & ~x25 & ~x35));
  assign z13 = (new_n96_ & ~x04) | (~x25 & ((~new_n93_ & x27) | (new_n95_ & ~x04)));
  ...
  assign new_n100_ = (~x25 | ~x27) & ((new_n66_ & ~x04 & ~x13) | (~new_n68_ & x27));
  ...
  assign z19 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (new_n89_ | ((new_n73_ | (x25 & x27)) & (~x04 | x25 | ~x27))) & (x08 | (x27 & (x25 | (new_n73_ & ~x04))));
