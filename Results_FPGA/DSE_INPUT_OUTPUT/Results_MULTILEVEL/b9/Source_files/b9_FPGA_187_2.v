...
module FAU ( 
  ...
  assign z01 = (~x30 & new_n70_ & ~x32) | ~x04 | ~x27;
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = new_n68_ & (~x04 | (new_n73_ & x27));
  ...
  assign z07 = x03 & ~new_n79_ & (~x04 | x27);
  ...
  assign z10 = (x04 & (~x27 | (x06 & x37))) | (~new_n84_ & ~x04) | (x06 & x27 & x37);
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n70_ | (new_n68_ ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = (~x27 & (x04 | (~x08 & ~x09 & ~x30))) | (~x09 & new_n87_ & ~x30);
  assign new_n87_ = ~new_n88_ & (~new_n73_ | x04);
  assign new_n88_ = x08 & x29 & x39 & x40;
  assign z12 = (~x10 & (new_n90_ | ~x27)) | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  ...
  assign new_n97_ = ~new_n98_ & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = ~new_n103_ | (x08 & ((new_n73_ & ~x27) | (new_n68_ & x29)));
  assign new_n103_ = ~x09 & (~x04 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = (~x09 & new_n105_ & ~x30) | (~x27 & (x04 | (~x09 & ~x30 & ~x04 & ~x08)));
  assign new_n105_ = ~new_n88_ & ((~x35 & (~x04 | x27)) | x04 | x28);
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (x04 | (~new_n108_ & (x08 | (x27 & x35)))) & (~x27 | new_n88_ | x35);
