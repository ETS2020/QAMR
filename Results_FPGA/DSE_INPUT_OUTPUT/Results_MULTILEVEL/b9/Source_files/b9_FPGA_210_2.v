...
module FAU ( 
  ...
  assign z07 = x03 & ~new_n80_ & (~x20 | x27);
  ...
  assign z10 = (~new_n85_ & ~x04) | (x20 & ~x27) | (x06 & x27 & x37);
  ...
  assign z13 = (~new_n93_ & x27) | (~x04 & ~x13 & new_n86_ & ~x20);
  ...
  assign z18 = ~new_n104_ | (x08 & (new_n89_ | (new_n74_ & ~x27)));
  assign new_n104_ = ~x09 & (~x20 | x27) & ~x30 & (~new_n74_ | x04 | ~x27);
  assign z19 = (x20 & ~x27) | (~x09 & ~x30 & ((new_n106_ & x27) | (~new_n107_ & ~x20)));
  assign new_n106_ = (~new_n74_ | x04) & (~new_n66_ | ~x08 | ~x29);
  assign new_n107_ = (new_n89_ | (x35 & (x27 | ~x28))) & (x08 | x27);
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (x08 | (x27 ? x35 : x20)) & (new_n89_ | ((~x27 | x35) & (x20 | (x35 & (x27 | ~x28)))));
endmodule
