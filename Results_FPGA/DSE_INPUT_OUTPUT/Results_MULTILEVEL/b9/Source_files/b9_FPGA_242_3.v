...
module FAU ( 
  ...
  assign z01 = ~x04 | (new_n69_ & ~x27);
  assign new_n69_ = ~x30 & ~x32;
  assign z02 = (~x02 & (~x08 | ~x29)) | ~new_n66_ | new_n71_;
  ...
  assign z07 = (x04 & x27) | (~new_n77_ & x03);
  ...
  assign new_n82_ = (new_n69_ | x04) & (~x27 | (~x36 & (x28 | ~x35)));
  assign new_n83_ = x27 & ((new_n84_ & x07) | x04 | (x06 & x37));
  assign new_n84_ = (~x39 | ~x40) & (x36 | (~x28 & x35));
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = ((~x28 & x35) | ((new_n87_ | (x04 & x27)) & (x04 | x08))) & (x08 | x27);
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = ~new_n89_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n89_ = ~x04 & (new_n66_ | (x27 & (x37 | (x28 & x35))));
  assign z13 = ~x04 & (new_n91_ | (x27 & (new_n92_ | new_n93_)));
  assign new_n91_ = ~x13 & x39 & ~new_n69_ & x40;
  assign new_n92_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ((~new_n66_ | x13) & (~x27 | (~new_n97_ & ~x04))) | new_n95_ | (x04 & ~x27);
  ...
  assign z18 = ~new_n102_ | (x08 & (new_n87_ | (~x28 & x35)));
  assign new_n102_ = (~x27 | (~x04 & (x28 | ~x35))) & ~x09 & ~x30;
