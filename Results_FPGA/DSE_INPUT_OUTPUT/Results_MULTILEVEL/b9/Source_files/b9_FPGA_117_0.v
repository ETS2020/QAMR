...
module FAU ( 
  ...
  assign new_n85_ = (~x06 | ~x27 | ~x37) & (x10 | x40);
  assign z11 = new_n70_ | (~x09 & ~x30 & (new_n89_ | (~new_n87_ & ~new_n88_)));
  assign new_n87_ = x29 & x39 & x40;
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n89_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n92_ | (~new_n91_ & (~z08 | x04));
  ...
  assign z14 = (~new_n98_ & (new_n99_ | ~new_n100_)) | new_n101_ | new_n70_ | (~new_n91_ & ~new_n100_);
  ...
  assign z19 = ~x09 & ~x30 & ((~new_n88_ & ~new_n110_) | (~new_n109_ & ~x08));
