...
module FAU ( 
  ...
  assign new_n82_ = ~new_n84_ & (~x27 | new_n70_ | new_n83_);
  ...
  assign new_n90_ = (~x13 | ~x40) & ((~new_n66_ & x27) | (~x04 & x39 & x40));
  assign z13 = new_n94_ | (x27 & (new_n92_ | new_n93_));
  assign new_n92_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n93_ = ~x04 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = x40 & (x13 | (~x04 & x39 & (x30 | x32)));
  assign z14 = (~new_n96_ & (~x40 | (~x13 & (x04 | ~x39)))) | (new_n97_ & ~x13);
  ...
  assign z18 = (~new_n103_ & (~x13 | ~x40)) | (x29 & x39 & x40 & x08 & ~x13);
  assign new_n103_ = ~new_n104_ & ~x09 & ~x30;
  assign new_n104_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n106_ & ~x09;
  assign new_n106_ = ~x30 & (new_n107_ | (~new_n87_ & (~x35 | (~x27 & x28))));
  assign new_n107_ = ~x08 & ((~x13 & (~x27 | ~x35)) | (~x27 & ~x40));
  assign z05 = ~z06;
