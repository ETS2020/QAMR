...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (~x22 | x27)) | (~x15 & ~new_n67_ & x27);
  ...
  assign z03 = (~x21 & (~x22 | x27)) | (x27 & (~x28 | ~x35)) | (~x22 & ~x27 & ~x37);
  ...
  assign new_n100_ = (~x22 | x27) & ((~new_n68_ & x27) | (new_n66_ & ~x04 & ~x13));
  ...
  assign z18 = ~new_n106_ | (x08 & (new_n90_ | (new_n73_ & ~x27)));
  assign new_n106_ = ~x09 & (~x22 | x27) & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z19 = ~x09 & ~x30 & (new_n88_ | (~new_n108_ & ~x22));
  assign new_n108_ = (x08 | x27) & (new_n90_ | (x35 & (x27 | ~x28)));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 ? x35 : x22)) & (new_n90_ | ((~x27 | x35) & (x22 | (x35 & (x27 | ~x28)))));
endmodule
