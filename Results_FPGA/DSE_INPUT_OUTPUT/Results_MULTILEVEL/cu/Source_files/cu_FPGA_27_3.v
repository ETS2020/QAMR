...
module FAU ( 
  ...
  assign z00 = (x02 & (~x04 | x05)) | (~x02 & (x04 | ~x05)) | z09 | x03;
  assign z09 = x06 & x13;
  assign z01 = ~x03 & ~z09 & (x02 ? (x04 & ~x05) : (~x04 & x05));
  assign z02 = new_n31_ & ~x13;
  assign new_n31_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z03 = z09 | (new_n33_ & x00 & ~x01 & ~x02);
  ...
  assign new_n43_ = x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x06 & ~x12 & x13));
