...
module FAU ( 
  ...
  assign z00 = ~z05 & ((x02 & (~x04 | x05)) | x03 | (~x02 & (x04 | ~x05)));
  assign z05 = x00 & ~x13;
  assign z01 = z05 | (~x03 & (x02 ? (x04 & ~x05) : (~x04 & x05)));
  assign z02 = new_n31_ & ~x13;
  assign new_n31_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z04 = ~new_n33_ & ~x13;
  assign new_n33_ = ~x00 & (~x01 | x02 | x03 | x04 | ~x05);
  assign z06 = ~x03 & x04 & ((new_n35_ & ~x02) | (new_n37_ & ~x00 & x02));
  assign new_n35_ = x05 & ~x07 & ~x12 & ~new_n36_ & x13;
  assign new_n36_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign new_n37_ = ~x05 & ~x13;
  assign z07 = ~x13 & x05 & ~x04 & ~x03 & ~x00 & ~x02;
  assign z08 = z05 | new_n40_;
  assign new_n40_ = ~x03 & x04 & ((~x12 & x13 & ~x02 & x05) | (x02 & ~x05 & ~x13));
  assign z09 = x06 & x13;
