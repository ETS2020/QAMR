...
module FAU ( 
  ...
  assign z06 = (~x05 & ~x10) | (~x03 & x04 & (new_n37_ | new_n40_));
  assign new_n37_ = ~x02 & ~x07 & ~x12 & x13 & (new_n38_ | new_n39_);
  assign new_n38_ = x05 & (x00 ? (x01 ? ~x11 : ~x09) : (~x01 & ~x08));
  assign new_n39_ = ~x00 & x01 & ~x10;
  assign new_n40_ = x02 & ~x05 & ~x13;
  assign z07 = ~x13 & x05 & ~x04 & ~x02 & ~x03;
  assign z08 = new_n43_ | (~x05 & ~x10);
