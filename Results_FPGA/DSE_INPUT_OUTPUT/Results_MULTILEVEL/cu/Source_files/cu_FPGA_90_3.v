...
module FAU ( 
  ...
  assign new_n34_ = ~x02 & (x00 | x03 | x04 | ~x05 | x13);
  assign z05 = new_n36_ & ~x13;
  assign new_n36_ = x05 & ~x04 & ~x03 & ~x02 & x00 & x01;
  assign z06 = (~x03 & x04 & (new_n38_ | (new_n41_ & x02))) | (x01 & x02);
  assign new_n38_ = x05 & ~x07 & ~x12 & x13 & (new_n39_ | new_n40_);
  assign new_n39_ = x00 & (x01 ? ~x11 : (~x02 & ~x09));
  assign new_n40_ = ~x00 & (x01 ? ~x10 : (~x02 & ~x08));
  assign new_n41_ = ~x05 & ~x13;
  assign z07 = (x01 & x02) | (~x04 & x05 & ~x13 & ~x02 & ~x03);
