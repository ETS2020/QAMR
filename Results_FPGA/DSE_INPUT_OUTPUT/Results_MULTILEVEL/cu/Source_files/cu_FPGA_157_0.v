...
module FAU ( 
  ...
  wire new_n30_, new_n35_, new_n36_, new_n38_, new_n40_;
  assign z00 = (x02 & (~x04 | x05)) | (~x02 & (x04 | ~x05)) | x03 | (~x06 & ~x07);
  ...
  assign z06 = (~x06 & ~x07) | (~x03 & ~new_n35_ & x04);
  assign new_n35_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n36_ | ~x13);
  assign new_n36_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign z07 = new_n38_ & ~x02;
  assign new_n38_ = ~x03 & ~x04 & x05 & ~x13 & (x06 | x07);
