...
module FAU ( 
  ...
  assign z04 = x05 & (new_n34_ | x06);
  assign new_n34_ = ~x00 & x01 & ~x02 & ~x03 & ~x04 & ~x13;
  assign z05 = ~x13 & new_n36_ & ~x06;
  assign new_n36_ = x05 & ~x04 & ~x03 & ~x02 & x00 & x01;
  assign z06 = ~x03 & x04 & (x02 ? (~x05 & ~x13) : (new_n38_ & x05));
  assign new_n38_ = ~x06 & ~x07 & ~x12 & ~new_n39_ & x13;
  assign new_n39_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign z07 = ~x13 & ~x06 & x05 & ~x04 & ~x02 & ~x03;
  assign z08 = new_n42_ | (x05 & x06);
