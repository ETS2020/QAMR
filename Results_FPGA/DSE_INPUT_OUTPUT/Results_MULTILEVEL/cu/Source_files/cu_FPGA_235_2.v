...
module FAU ( 
  ...
  assign z02 = ~x13 & (x01 | (~x00 & ~x02 & new_n31_ & ~x03));
  assign new_n31_ = ~x04 & x05;
  assign z03 = ~x13 & (x01 | (new_n31_ & ~x03 & x00 & ~x02));
  assign z06 = z04 | (~x03 & x04 & (x02 ? new_n37_ : new_n34_));
  ...
  assign new_n40_ = x04 & ((~x02 & x05 & ~x12 & x13) | (~x01 & x02 & ~x05 & ~x13));
  assign z09 = x06 & x13;
