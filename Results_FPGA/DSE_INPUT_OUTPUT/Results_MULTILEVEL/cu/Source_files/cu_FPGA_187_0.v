...
module FAU ( 
  ...
  wire new_n30_, new_n34_, new_n36_, new_n37_, new_n38_, new_n39_, new_n42_;
  ...
  assign z05 = ~x13 & new_n34_ & x10;
  assign new_n34_ = x05 & ~x04 & ~x03 & ~x02 & x00 & x01;
  assign z06 = (~x10 & ~x13) | (~x03 & x04 & (new_n36_ | new_n39_));
  assign new_n36_ = ~x02 & x05 & ~x07 & ~x12 & (new_n37_ | new_n38_);
  assign new_n37_ = x13 & (x00 ? (x01 ? ~x11 : ~x09) : (~x01 & ~x08));
  assign new_n38_ = ~x00 & x01 & ~x10;
  assign new_n39_ = x02 & ~x05 & ~x13;
