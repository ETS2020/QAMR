...
module FAU ( 
  ...
  assign z00 = (x03 & (~x02 | x04)) | (~x02 & (x04 | ~x05)) | (x04 & x05);
  ...
  assign z04 = ~new_n34_ & ~x04;
  assign new_n34_ = ~x02 & (x00 | ~x01 | x03 | ~x05 | x13);
  ...
  assign z08 = (x02 & (~x04 | (~x03 & ~x05 & ~x13))) | (~x02 & ~x03 & x04 & x05 & ~x12 & x13);
