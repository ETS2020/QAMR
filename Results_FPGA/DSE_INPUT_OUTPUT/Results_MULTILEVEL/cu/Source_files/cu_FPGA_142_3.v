...
module FAU ( 
  ...
  assign z05 = (x11 & x13) | (new_n30_ & x00 & x01 & ~x02);
  assign z06 = ~x03 & x04 & (x02 ? (~x05 & ~x13) : (new_n37_ & x05));
  assign new_n37_ = ~x07 & ~x11 & new_n38_ & ~x12;
  assign new_n38_ = x13 & ((x00 & (x01 | ~x09)) | (~x00 & ~x01 & ~x08) | (x01 & ~x10));
  assign z07 = ~x13 & x05 & ~x04 & ~x02 & ~x03;
  assign z08 = new_n41_ & ~x03;
  assign new_n41_ = x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x11 & ~x12 & x13));
