...
module FAU ( 
  ...
  wire new_n29_, new_n31_, new_n34_, new_n36_, new_n37_;
  assign z01 = ~x03 & (~x05 | (~x02 & ~x04));
  assign z02 = new_n29_ & ~x13;
  assign new_n29_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z03 = ~x03 & (~x05 | (new_n31_ & x00 & ~x01));
  assign new_n31_ = ~x02 & ~x04 & ~x13;
  assign z04 = ~x03 & (~x05 | (new_n31_ & ~x00 & x01));
