...
module FAU ( 
  ...
  assign z00 = (x03 & (x01 | x05)) | (x01 & ~x05 & (~x02 | ~x04)) | (x05 & (x02 | x04));
  assign z01 = (~x01 & ~x05) | (~x03 & (x02 ? (x04 & ~x05) : (~x04 & x05)));
  ...
  assign z05 = (~x01 & ~x05) | (x00 & x01 & ~x02 & new_n36_ & x05 & ~x13);
  ...
  assign new_n45_ = x04 & ((~x02 & x05 & ~x12 & x13) | (~x05 & ~x13 & x01 & x02));
