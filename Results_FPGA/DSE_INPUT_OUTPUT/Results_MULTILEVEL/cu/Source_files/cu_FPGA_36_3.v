// Benchmark "FAU" written by ABC on Mon Aug 17 19:54:58 2020
...
module FAU ( 
  ...
  assign z04 = (x03 & x13) | (new_n34_ & ~x00 & ~x03 & ~x04 & x05 & ~x13);
  assign new_n34_ = x01 & ~x02;
  assign z05 = (x03 & x13) | (~x03 & ~x04 & x05 & ~x13 & new_n34_ & x00);
