...
module FAU ( 
  ...
  wire new_n30_, new_n33_, new_n35_, new_n39_;
  assign z00 = (x03 & (~x05 | x07)) | (x05 & x07 & (x02 | x04)) | (~x05 & (~x02 | ~x04));
  assign z01 = (x05 & ~x07) | (~x03 & (x02 ? (x04 & ~x05) : (~x04 & x05)));
  assign z02 = x05 & (~x07 | (new_n30_ & ~x00 & ~x01 & ~x02));
  assign new_n30_ = ~x03 & ~x04 & ~x13;
  assign z03 = x05 & (~x07 | (new_n30_ & x00 & ~x01 & ~x02));
