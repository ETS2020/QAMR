...
module FAU ( 
  ...
  assign z00 = (~x09 | ~x13) & ((x02 & (~x04 | x05)) | x03 | (~x02 & (x04 | ~x05)));
  assign z01 = ~x03 & (~x09 | ~x13) & (x02 ? (x04 & ~x05) : (~x04 & x05));
  ...
  assign z06 = (x09 & x13) | (~x03 & ~new_n37_ & x04);
  assign new_n37_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n38_ | ~x13);
  assign new_n38_ = (~x00 | (x01 & x11)) & (x01 | x08) & (x00 | ~x01 | x10);
