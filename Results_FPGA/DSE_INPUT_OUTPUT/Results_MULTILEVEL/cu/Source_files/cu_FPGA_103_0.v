...
module FAU ( 
  ...
  assign z02 = ~new_n30_ & ~x02;
  assign new_n30_ = x05 & (x00 | x01 | x03 | x04 | x13);
  ...
  assign z06 = (~x02 & (~x05 | (~x03 & new_n38_ & x04))) | (~x03 & x04 & ~x05 & ~x13);
  assign new_n38_ = ~x07 & ~x12 & ~new_n39_ & x13;
  assign new_n39_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign z07 = ~x02 & (~x05 | (~x03 & ~x04 & ~x13));
  assign z08 = ~x03 & x04 & ((~x02 & x05 & ~x12 & x13) | (x02 & ~x05 & ~x13));
  assign z09 = x06 & x13 & (x02 | x05);
  assign z10 = (~x02 & (~x05 | (~x03 & x06))) | (~x03 & ~x05 & x06);
endmodule
