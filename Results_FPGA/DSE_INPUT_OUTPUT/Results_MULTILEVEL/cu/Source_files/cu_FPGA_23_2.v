...
module FAU ( 
  ...
  assign z02 = ~x04 & (x03 | (new_n30_ & ~x00 & ~x01));
  assign new_n30_ = ~x02 & x05 & ~x13;
  assign z03 = ~x04 & (x03 | (new_n30_ & x00 & ~x01));
  ...
  assign z06 = x03 ? ~x04 : (~new_n37_ & x04);
  assign new_n37_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n38_ | ~x13);
  assign new_n38_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign z07 = ~x04 & (new_n30_ | x03);
  assign z08 = x03 ? ~x04 : (x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13)));
