...
module FAU ( 
  ...
  assign z06 = (~x05 & ~x08) | (~x03 & x04 & (new_n38_ | new_n41_));
  assign new_n38_ = ~x02 & ~x07 & ~x12 & x13 & (new_n39_ | new_n40_);
  assign new_n39_ = x05 & (x00 ? (x01 ? ~x11 : ~x09) : (x01 & ~x10));
  assign new_n40_ = ~x00 & ~x01 & ~x08;
  assign new_n41_ = x02 & ~x05 & ~x13;
  assign z07 = (~x05 & ~x08) | (~x02 & ~x03 & ~x04 & x05 & ~x13);
  assign z08 = new_n44_ & ~x03;
  assign new_n44_ = x04 & ((~x02 & x05 & ~x12 & x13) | (x08 & ~x13 & x02 & ~x05));
