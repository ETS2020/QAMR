...
module FAU ( 
  ...
  wire new_n30_, new_n33_, new_n36_, new_n37_, new_n38_, new_n41_;
  ...
  assign new_n37_ = x00 ? (x01 ? x11 : x09) : ((x08 | (x01 & x10)) & (~x01 | x10));
  assign new_n38_ = ~x08 & ~x13;
  assign z07 = ~x13 & (x08 | (~x04 & x05 & ~x02 & ~x03));
  assign z08 = new_n41_ | (x08 & ~x13);
