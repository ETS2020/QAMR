...
module FAU ( 
  ...
  assign z03 = (x08 & x13) | (new_n30_ & x00 & ~x01 & ~x02);
  assign z04 = new_n33_ & ~x13;
  assign new_n33_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z05 = (x08 & x13) | (new_n30_ & x00 & x01 & ~x02);
  assign z06 = ~x03 & x04 & (x02 ? (~x05 & ~x13) : (new_n36_ & x05));
  assign new_n36_ = ~x07 & ~x08 & new_n37_ & ~x12;
  assign new_n37_ = x13 & ((~x00 & (~x01 | ~x10)) | (~x01 & ~x09) | (x00 & x01 & ~x11));
  assign z07 = (x08 & x13) | (~x02 & ~x03 & ~x04 & x05 & ~x13);
  assign z08 = new_n40_ | (x08 & x13);
