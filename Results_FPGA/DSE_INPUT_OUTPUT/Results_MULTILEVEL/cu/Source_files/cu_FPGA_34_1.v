...
module FAU ( 
  ...
  assign z00 = (x03 & (x04 | ~x13)) | (x04 & (~x02 | x05)) | (~x04 & ~x13 & (x02 | ~x05));
  ...
  assign z05 = ~new_n36_ & ~x04;
  assign new_n36_ = ~x13 & (~x00 | ~x01 | x02 | x03 | ~x05);
  ...
  assign z08 = (~x04 & x13) | (~x03 & ((~x02 & x05 & ~x12 & x13) | (~x05 & ~x13 & x02 & x04)));
