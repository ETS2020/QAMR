...
module FAU ( 
  ...
  assign z04 = x01 & (x13 | (~x00 & ~x02 & new_n33_ & ~x03));
  assign new_n33_ = ~x04 & x05;
  assign z05 = x01 & (x13 | (new_n33_ & ~x03 & x00 & ~x02));
  assign z06 = (x01 & x13) | (~x03 & ~new_n36_ & x04);
  assign new_n36_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n37_ | ~x13);
  assign new_n37_ = x00 ? x09 : x08;
  assign z07 = ~x13 & x05 & ~x04 & ~x02 & ~x03;
  assign z08 = new_n40_ & ~x03;
  assign new_n40_ = x04 & ((x02 & ~x05 & ~x13) | (~x01 & ~x02 & x05 & ~x12 & x13));
