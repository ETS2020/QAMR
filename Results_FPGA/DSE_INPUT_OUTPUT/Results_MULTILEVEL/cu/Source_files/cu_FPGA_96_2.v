...
module FAU ( 
  ...
  assign z00 = (x02 & (~x04 | x05)) | x03 | (~x02 & (x04 | ~x05 | ~x08));
  assign z01 = (~x03 & (x02 ? (x04 & ~x05) : (~x04 & x05))) | (x05 & ~x08);
