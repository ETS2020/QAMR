...
module FAU ( 
  ...
  assign z12 = (~new_n67_ & x19) | (x03 & x08) | (new_n65_ & ~x08);
  assign new_n65_ = x09 & ~x10 & x22 & (~new_n66_ | ~x19 | ~x20);
  assign new_n66_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n67_ = ~x10 & (x08 | ~x09 | ~x20 | ~x21 | x22);
  assign z13 = (~x08 & x09 & ~new_n69_ & ~x10) | (x04 & x08 & (~x10 | ~x19));
  assign new_n69_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (~new_n72_ & x19) | (x05 & x08) | (new_n74_ & ~x08);
  assign new_n72_ = ~x10 & (~new_n73_ | x08 | ~x09 | ~x20);
