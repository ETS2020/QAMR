...
module FAU ( 
  ...
  assign z10 = (x01 & ~new_n50_ & x08) | (~x08 & new_n60_ & x09);
  assign new_n60_ = ~x10 & ((~x11 & x20 & ((new_n61_ & new_n62_) | ~x19)) | (x19 & ~x20));
  ...
  assign z12 = (x20 & (new_n69_ | x11)) | (x03 & x08) | (new_n67_ & ~x08);
  ...
  assign new_n74_ = (x20 | ~x24) & (x11 | (~new_n77_ & ((new_n75_ & new_n76_) | ~x24)));
  ...
  assign new_n79_ = ~x11 & ((new_n80_ & new_n83_) | (x25 & (~new_n81_ | ~new_n82_)));
  ...
  assign new_n86_ = ~x11 & (~new_n88_ | ~new_n87_ | ~x24 | ~x25 | x26);
