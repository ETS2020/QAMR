...
module FAU ( 
  ...
  assign z11 = x08 ? x02 : (~x19 | (x09 & ~new_n63_ & ~x10));
  ...
  assign new_n69_ = x19 & (x22 ? ((x20 & x21 & (new_n70_ | ~x23)) | (x23 & (~x20 | ~x21))) : x23);
