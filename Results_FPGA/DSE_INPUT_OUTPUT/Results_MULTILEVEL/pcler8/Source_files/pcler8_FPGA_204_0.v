...
module FAU ( 
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (~x19 | x20 | ~x23);
  ...
  assign z12 = (~new_n47_ & (x08 ? x03 : (new_n68_ & x09))) | (~x08 & new_n70_ & x09);
  assign new_n68_ = ~x10 & ~new_n69_ & x22;
  assign new_n69_ = x19 & x21;
  assign new_n70_ = ~x10 & ((new_n71_ & x22) | (x19 & x20 & x21 & ~x22));
  assign new_n71_ = x23 & (~x20 | (x25 & x26 & x14 & x24));
  assign z13 = (~x08 & x09 & ~new_n73_ & ~x10) | (x04 & ~new_n47_ & x08);
  assign new_n73_ = (~x23 | (~new_n74_ & x22 & (~x22 | (x19 & x20 & x21)))) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n74_ = x25 & x26 & x15 & x24;
  assign z14 = new_n79_ | (~x08 & x09 & ~new_n76_ & ~x10) | (x05 & x08);
  assign new_n76_ = (~x24 | (new_n69_ & x22 & ~new_n78_ & x23)) & (~new_n77_ | ~x22 | ~x23 | x24);
  assign new_n77_ = x19 & x20 & x21;
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n85_ | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((new_n77_ & new_n84_) | ((~new_n82_ | ~new_n83_) & x25));
  assign new_n82_ = x19 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign new_n85_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n92_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x26));
endmodule
