...
module FAU ( 
  ...
  assign new_n63_ = x09 & ~x10 & ((x19 & (new_n64_ | (x20 & ~x21))) | (x21 & (~x20 | (~x19 & x20))));
  ...
  assign new_n69_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x19 & x21)))) & (x22 | ~x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x22 & (new_n72_ | ~x20)) | (x05 & x08) | (new_n74_ & ~x08);
  assign new_n72_ = ~x08 & x09 & ~x10 & new_n73_ & x23 & ~x24;
  assign new_n73_ = x19 & x21;
  assign new_n74_ = x09 & ~x10 & x24 & (~new_n73_ | ~new_n75_);
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~new_n77_ & x22) | (x06 & x08) | (~x08 & new_n79_ & x09);
  assign new_n77_ = x20 & (~new_n78_ | ~x21 | ~x23 | ~x24 | x25);
  assign new_n78_ = ~x08 & x09 & ~x10 & x19;
  assign new_n79_ = ~x10 & x25 & (~new_n80_ | ~x19 | ~x21 | ~x22);
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x22 & (new_n82_ | ~x20)) | (x07 & x08) | (new_n83_ & ~x08);
  assign new_n82_ = new_n78_ & x21 & x23 & x24 & x25 & ~x26;
  assign new_n83_ = x09 & ~x10 & x26 & (~new_n84_ | ~new_n73_ | x18);
