...
module FAU ( 
  ...
  assign z10 = (x01 & (x08 | (x09 & new_n63_ & ~x10))) | (~x08 & x09 & new_n64_ & ~x10);
  ...
  assign new_n68_ = (~x01 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x20 | ~x22);
  assign new_n69_ = new_n49_ & x14 & x23;
  assign z13 = (x04 & ~new_n51_ & x08) | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((~x20 & x23) | (x01 & ((x20 & ~new_n72_ & x22) | (~x22 & x23))));
  ...
  assign new_n76_ = x01 & (new_n78_ | (x24 & (~new_n77_ | ~x19 | ~x21)));
  ...
  assign new_n85_ = x01 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
