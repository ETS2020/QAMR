...
module FAU ( 
  ...
  assign z11 = (~new_n49_ & ((x02 & x08) | (new_n65_ & ~x08 & x09))) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & x19 & (x20 ? (new_n64_ | ~x21) : (x21 & x24));
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = ~x10 & ~x19 & x21;
  ...
  assign new_n69_ = ~x20 & (~x24 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n73_ = ~x20 & x23 & x24;
  assign z14 = (~x08 & new_n75_ & x09) | (x05 & ~new_n49_ & x08);
  ...
  assign z15 = new_n83_ | (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & x08);
  assign new_n79_ = (~new_n76_ | ~new_n82_) & (~x25 | (new_n80_ & new_n81_));
  ...
  assign new_n90_ = ~x20 & (~x24 | (~x08 & x09 & ~x10 & x26));
endmodule
