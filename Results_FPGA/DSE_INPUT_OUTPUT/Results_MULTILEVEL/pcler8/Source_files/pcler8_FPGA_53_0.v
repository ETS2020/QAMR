...
module FAU ( 
  ...
  assign new_n61_ = (~x09 | ~x20 | (x19 & (~new_n59_ | ~new_n58_ | ~x12))) & (~x19 | x20);
  ...
  assign z15 = new_n80_ | (x06 & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n78_ & new_n58_ & x19)) & (~new_n74_ | ~new_n79_);
  assign new_n78_ = x23 & x24 & (~x17 | ~x26);
  assign new_n79_ = x22 & x23 & x24 & ~x25;
  assign new_n80_ = ~x20 & (~x09 | (~x08 & ~x10 & x25));
  assign z16 = (~x20 & (~x09 | (new_n87_ & ~x08))) | (x07 & x08) | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((new_n85_ & new_n86_) | (x26 & (~new_n83_ | ~new_n84_)));
  assign new_n83_ = ~x18 & x19 & x21;
