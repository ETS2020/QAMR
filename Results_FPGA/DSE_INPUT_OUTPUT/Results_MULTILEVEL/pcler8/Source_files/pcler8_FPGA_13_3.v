...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n57_, new_n59_, new_n60_, new_n62_, new_n64_, new_n65_,
    new_n66_, new_n68_;
  ...
  assign z11 = (~new_n59_ & x20) | (x02 & x08) | (new_n60_ & ~x08);
  assign new_n59_ = ~x24 & (x10 | ~x19 | x21 | x08 | ~x09);
  assign new_n60_ = x09 & ~x10 & x21 & (~x19 | ~x20);
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x22 & (~x20 | (~x24 & (~x19 | ~x21)))) | (x19 & x20 & x21 & ~x22 & ~x24));
