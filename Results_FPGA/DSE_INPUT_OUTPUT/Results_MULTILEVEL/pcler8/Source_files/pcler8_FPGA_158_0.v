...
module FAU ( 
  ...
  assign new_n57_ = new_n58_ & ~x08 & x09 & x11 & x20 & x21;
  ...
  assign new_n68_ = x22 ? ((~x20 | ~x21 | (~new_n69_ & x23)) & (~x23 | (x20 & x21))) : ~x23;
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~x10 & (~x19 | (~x08 & ~new_n71_ & x09)));
  assign new_n71_ = (~x24 | (x20 & x21 & x22 & ~new_n72_ & x23)) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
