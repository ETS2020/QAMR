...
module FAU ( 
  ...
  assign new_n71_ = ~x10 & ((x26 & ((x20 & ~new_n72_ & x22) | (~x22 & x23))) | (~x20 & x23));
  assign new_n72_ = (~x19 | ~x21 | (x23 & (~x15 | ~x24 | ~x25))) & (~x23 | (x19 & x21));
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x24 | (x20 & (new_n76_ | ~x26))) & (~new_n77_ | ~new_n75_ | x24 | ~x26);
  assign new_n75_ = x22 & x23;
  assign new_n76_ = x19 & x21 & x22 & x23 & (~x16 | ~x25);
  assign new_n77_ = x19 & x20 & x21;
  assign z15 = (~new_n79_ & x20) | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n79_ = x26 & (~new_n47_ | ~new_n48_ | ~x23 | ~x24 | x25);
  assign new_n80_ = ~x10 & x25 & (~new_n81_ | x17 | ~x19 | ~x20);
  assign new_n81_ = x21 & x22 & x23 & x24;
  assign z16 = (x07 & ~new_n51_ & x08) | (~x08 & x09 & new_n83_ & ~x10);
  assign new_n83_ = x26 & (~new_n84_ | x18 | ~x19 | ~x20 | ~x21);
