...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n61_, new_n62_, new_n64_,
    ...
    new_n91_, new_n92_;
  assign z00 = (x15 & ~x20) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign new_n67_ = ~x20 & (x15 | (new_n47_ & ~x10 & x22));
  assign new_n68_ = ~x10 & ((x22 & (~x19 | new_n69_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (~x08 & new_n73_ & x09) | (~new_n71_ & x15);
  assign new_n71_ = x20 & (~new_n72_ | ~new_n47_ | x10 | ~x19);
  assign new_n72_ = x21 & x22 & x24 & x25 & x26;
  assign new_n73_ = ~x10 & ((x23 & ((x20 & x22 & (~x19 | ~x21)) | ~x20 | ~x22)) | (x19 & x20 & x21 & x22 & ~x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x20 | ((~x24 | (new_n76_ & new_n77_)) & (~new_n76_ | ~new_n78_))) & (x15 | x20 | ~x24);
  assign new_n76_ = x19 & x21;
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = new_n80_ | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n80_ = ~x20 & (x15 | (new_n47_ & ~x10 & x25));
