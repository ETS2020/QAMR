...
module FAU ( 
  ...
  assign z00 = (~x20 & ~x24) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (x19 & ~x20 & x24));
  ...
  assign new_n68_ = ~x20 & (~x24 | (new_n47_ & ~x10 & x22));
  ...
  assign z15 = new_n79_ | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n79_ = ~x20 & (~x24 | (new_n47_ & ~x10 & x25));
  assign new_n80_ = ~x10 & ((new_n76_ & new_n83_) | (x25 & (~new_n81_ | ~new_n82_)));
  ...
  assign new_n85_ = ~x20 & (~x24 | (new_n47_ & ~x10 & x26));
