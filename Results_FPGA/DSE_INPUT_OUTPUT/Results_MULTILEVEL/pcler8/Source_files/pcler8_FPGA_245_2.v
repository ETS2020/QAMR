...
module FAU ( 
  ...
  assign z12 = (~x08 & x09 & ~new_n66_ & ~x10) | (x03 & x08 & x20);
  assign new_n66_ = (~x20 | ((~x22 | (x19 & ~new_n67_ & x21)) & (~x19 | ~x21 | x22))) & (x03 | x20 | ~x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n71_ | new_n72_ | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign new_n71_ = x03 & (~x20 | (x04 & x08 & x20));
  assign new_n72_ = ~x03 & x04 & x08;
  assign z14 = new_n74_ | (x20 & (x08 ? x05 : (new_n76_ & x09)));
  assign new_n74_ = ~new_n75_ & ~x03;
  assign new_n75_ = (~x05 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x24);
  assign new_n76_ = ~x10 & ((x24 & (~new_n77_ | ~x22 | new_n78_ | ~x23)) | (new_n77_ & x22 & x23 & ~x24));
  assign new_n77_ = x19 & x21;
  assign new_n78_ = x16 & x25 & x26;
  assign z15 = (~new_n49_ & (x08 ? x06 : (new_n80_ & x09))) | (~x08 & new_n82_ & x09);
  assign new_n80_ = ~x10 & x25 & (~new_n81_ | ~x19 | ~x21 | ~x22);
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = ~x10 & (new_n83_ | (new_n84_ & x19 & x20 & x21));
  assign new_n83_ = ~x03 & ~x20 & x25;
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign z16 = (~new_n49_ & (x08 ? x07 : (new_n86_ & x09))) | (~x08 & new_n88_ & x09);
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | ~new_n77_ | x18);
  assign new_n87_ = x22 & x23 & x24 & x25;
  assign new_n88_ = ~x10 & ((new_n89_ & new_n90_) | (~x03 & ~x20 & x26));
