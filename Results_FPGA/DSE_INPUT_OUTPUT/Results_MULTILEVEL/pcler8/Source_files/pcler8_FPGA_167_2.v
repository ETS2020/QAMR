...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x02 | (x02 & x13))) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ~new_n49_ & (x19 ? (~x20 | (new_n61_ & new_n64_)) : x20);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = (~x08 & x09 & ~new_n66_ & ~x10) | (x02 & x08 & x13);
  assign new_n66_ = ~new_n67_ & (~x13 | ~x19 | ~x22 | ~new_n68_ | ~x23);
  assign new_n67_ = (~x02 | x13) & (x19 ? (x20 ^ x21) : x21);
  assign new_n68_ = x24 & x25 & x26 & (x20 | (x12 & x21));
  ...
  assign z16 = ~new_n49_ & (x08 ? x07 : (new_n82_ & x09));
