...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((~x18 & x20 & (~x19 | (new_n64_ & new_n65_))) | (x19 & ~x20));
  ...
  assign z12 = (x20 & (new_n71_ | x18)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign new_n76_ = (x20 | ~x24) & (x18 | (~new_n79_ & ((new_n77_ & new_n78_) | ~x24)));
  ...
  assign new_n89_ = ~x18 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
  assign new_n90_ = ~x10 & x26 & (~new_n83_ | ~new_n48_ | ~x24 | ~x25);
endmodule
