...
module FAU ( 
  ...
  assign z10 = (new_n57_ & ~x08) | z00 | (x01 & x08);
  assign new_n57_ = x09 & ~x10 & (x19 ^ x20);
  assign z11 = (new_n59_ & ~x08) | z00 | (x02 & x08);
  assign new_n59_ = x09 & ~x10 & (x20 ? (x19 ^ x21) : x21);
  ...
  assign new_n63_ = (~x23 | (x20 & (x24 | (x22 & (~x20 | ~x22 | (x19 & x21)))))) & (~x22 | x23 | x24 | ~x19 | ~x20 | ~x21);
  assign z14 = (x05 & ~z00 & x08) | (~x08 & x09 & ~new_n65_ & ~x10);
