...
module FAU ( 
  ...
  assign new_n62_ = x09 & ~x10 & (x20 ? (x24 & (new_n63_ | ~x19)) : x19);
  ...
  assign z12 = (x20 & (new_n70_ | ~x24)) | (new_n68_ & ~x08) | (x03 & x08);
  ...
  assign new_n76_ = x24 & (~new_n74_ | ~new_n77_);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = new_n79_ | (x06 & x08) | (~x08 & x09 & new_n81_ & ~x10);
  assign new_n79_ = x20 & (~x24 | (new_n80_ & new_n48_ & ~x10 & x19));
  assign new_n80_ = x21 & x22 & x23 & ~x25;
  assign new_n81_ = x25 & (~new_n74_ | ~x22 | ~x23 | (x17 & x26));
  assign z16 = (x07 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x24 | ((new_n84_ | ~x26) & (~new_n74_ | ~new_n85_))) & (x20 | ~x26);
  assign new_n84_ = x22 & x23 & x25 & ~x18 & x19 & x21;
