...
module FAU ( 
  ...
  assign z10 = (~x08 & ~new_n60_ & x09) | (x10 & ~x19) | (x01 & x08);
  assign new_n60_ = (x10 | ~x19 | (x20 & (~new_n58_ | ~new_n61_))) & (x19 | ~x20);
  assign new_n61_ = x12 & x21 & x22;
  assign z11 = new_n66_ | (x02 & x08) | (~x08 & x09 & new_n63_ & ~x10);
  assign new_n63_ = x19 & (x20 ? (~x21 | (new_n65_ & new_n64_ & x13)) : x21);
  assign new_n64_ = x22 & x23;
  assign new_n65_ = x24 & x25 & x26;
  assign new_n66_ = ~x19 & (x10 | (~x08 & x09 & x21));
  assign z12 = (x03 & x08 & (~x10 | x19)) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x22 | (new_n69_ & x21 & (~new_n65_ | ~x14 | ~x23))) & (~new_n69_ | ~x21 | x22);
  ...
  assign new_n78_ = (~x25 | (new_n75_ & new_n64_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n64_ | ~x24 | x25);
