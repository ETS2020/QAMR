...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n74_ & ~x10) | (x04 & ~new_n50_ & x08);
  assign new_n74_ = (~x18 | (~new_n77_ & (~x23 | (new_n75_ & new_n76_)))) & (x20 | ~x23);
  assign new_n75_ = x19 & x21;
  assign new_n76_ = x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x18 | (~new_n81_ & (~x24 | (new_n75_ & new_n80_)))) & (x20 | ~x24);
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n81_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (~new_n83_ & x20) | (x06 & x08) | (~x08 & new_n85_ & x09);
  assign new_n83_ = x18 & (~new_n84_ | ~new_n48_ | x10 | ~x19);
  assign new_n84_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n85_ = ~x10 & x25 & (~new_n86_ | ~x19 | ~x20 | ~x21);
  assign new_n86_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n88_ | (new_n89_ & new_n48_ & ~x10 & x18 & x19);
  assign new_n88_ = ~new_n50_ & ((x07 & x08) | (~x08 & x09 & ~x10 & x26));
  assign new_n89_ = x23 & x24 & x25 & x20 & x21 & x22;
endmodule
