...
module FAU ( 
  ...
  assign z00 = x20 & (~x24 | (new_n47_ & new_n48_ & x21 & x22));
  ...
  assign new_n66_ = (x20 | ~x22) & (~x24 | ((~x19 | ~x20 | ~x21 | (~new_n67_ & x22)) & (~x22 | (x19 & x21))));
  assign new_n67_ = x25 & x26 & x14 & x23;
  assign z13 = (~x08 & x09 & ~new_n69_ & ~x10) | (x04 & ~new_n50_ & x08);
  assign new_n69_ = (x20 | ~x23) & (~x24 | ((~x23 | (x19 & x21)) & (~x19 | ~x20 | new_n70_ | ~x21)));
  assign new_n70_ = x22 ? (x23 & (~x15 | ~x25 | ~x26)) : ~x23;
  assign z14 = z06 | (~x08 & x09 & new_n72_ & ~x10);
  assign new_n72_ = x24 & (~new_n73_ | ~x22 | ~x23 | (new_n60_ & x16));
  assign new_n73_ = x19 & x20 & x21;
  assign z15 = new_n75_ | (x06 & x08) | (~x08 & x09 & new_n77_ & ~x10);
  assign new_n75_ = x20 & (~x24 | (new_n47_ & new_n76_));
  assign new_n76_ = x21 & x22 & x23 & ~x25;
  assign new_n77_ = x25 & (~new_n73_ | ~x22 | ~x23 | (x17 & x26));
  assign z16 = (~x08 & x09 & ~new_n79_ & ~x10) | (x07 & ~new_n50_ & x08);
  assign new_n79_ = (~x24 | ((new_n80_ | ~x26) & (~new_n73_ | ~new_n81_))) & (x20 | ~x26);
  assign new_n80_ = ~x18 & x19 & x21 & x22 & x23 & x25;
