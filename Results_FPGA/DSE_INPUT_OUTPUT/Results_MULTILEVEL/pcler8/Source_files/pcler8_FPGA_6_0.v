...
module FAU ( 
  ...
  assign z00 = (~x20 & ~x23) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign new_n67_ = ~x20 & (~x23 | (new_n47_ & ~x10 & x22));
  assign new_n68_ = ~x10 & ((x22 & (~x19 | new_n69_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n74_ | (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & x08);
  assign new_n71_ = (~x23 | ((new_n72_ | ~x22) & ~new_n73_ & x22)) & (~new_n72_ | ~x22 | x23);
  assign new_n72_ = x19 & x21;
  assign new_n73_ = x25 & x26 & x15 & x24;
  assign new_n74_ = ~x20 & (~x23 | (~x08 & x09 & ~x10));
  assign z14 = new_n76_ | (x05 & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n76_ = ~x20 & (~x23 | (new_n47_ & ~x10 & x24));
  assign new_n77_ = (~x24 | (new_n72_ & x22 & ~new_n78_ & x23)) & (~new_n79_ | ~x22 | ~x23 | x24);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = x19 & x20 & x21;
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & new_n82_ & x09);
  assign new_n81_ = ~x20 & (~x23 | (new_n47_ & ~x10 & x25));
  ...
  assign new_n87_ = x23 & ((new_n79_ & new_n88_) | (~x20 & x26));
  assign new_n88_ = x25 & ~x26 & x22 & x24;
  assign new_n89_ = x20 & x26 & (~new_n90_ | ~new_n72_ | x18);
