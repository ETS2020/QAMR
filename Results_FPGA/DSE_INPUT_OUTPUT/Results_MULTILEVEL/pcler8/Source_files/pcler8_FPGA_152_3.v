...
module FAU ( 
  ...
  assign new_n47_ = x21 & x20 & x19 & ~x14 & new_n48_ & ~x10;
  ...
  assign z12 = (x20 & (new_n67_ | x14)) | (x03 & x08) | (new_n68_ & ~x08);
  assign new_n67_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign new_n68_ = x09 & ~x10 & x22 & (~x19 | ~x20 | ~x21);
  assign z13 = (~x08 & x09 & ~new_n70_ & ~x10) | (x04 & ~new_n50_ & x08);
  assign new_n70_ = (x20 | ~x23) & (x14 | (~new_n73_ & (~x23 | (new_n71_ & new_n72_))));
  ...
  assign new_n75_ = (x20 | ~x24) & (x14 | (~new_n77_ & (~x24 | (new_n71_ & new_n76_))));
  ...
  assign new_n79_ = x20 & (x14 | (new_n80_ & new_n48_ & ~x10 & x19));
  assign new_n80_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x25 & (~new_n82_ | ~x19 | ~x20 | ~x21);
  assign new_n82_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n84_ & x20) | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n84_ = ~x14 & (~new_n86_ | ~new_n85_ | ~x24 | ~x25 | x26);
  assign new_n85_ = x22 & x23;
  assign new_n86_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | ~new_n85_ | ~x24 | ~x25);
