...
module FAU ( 
  ...
  assign z00 = x20 & (x17 | (new_n47_ & new_n49_ & new_n50_));
  ...
  assign z12 = (x20 & (new_n70_ | x17)) | (new_n68_ & ~x08) | (x03 & x08);
  ...
  assign new_n75_ = (x20 | ~x24) & (x17 | (~new_n77_ & ((new_n48_ & new_n76_) | ~x24)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n79_ | new_n82_));
  assign new_n79_ = ~x17 & (new_n80_ | (new_n81_ & x19 & x20 & x21));
  assign new_n80_ = x25 & (~x19 | ~x21 | ~x22 | ~x23 | ~x24);
