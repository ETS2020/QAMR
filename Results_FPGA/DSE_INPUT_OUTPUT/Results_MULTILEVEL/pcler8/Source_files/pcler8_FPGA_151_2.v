...
module FAU ( 
  ...
  assign z00 = x20 & (~x23 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign z09 = new_n60_ | (new_n61_ & new_n49_ & x21 & x22 & x23);
  assign new_n60_ = ~new_n51_ & ((x00 & x08) | (~x08 & x09 & ~x10 & ~x19));
  assign new_n61_ = ~x08 & x09 & ~x10 & x11 & x20;
  assign z10 = z02 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = x20 ? (~x23 | (x19 & (~new_n49_ | ~new_n48_ | ~x12))) : ~x19;
  assign z11 = (x02 & ~new_n51_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (x23 & (x19 ? (new_n66_ | ~x21) : x21)) : x21);
  assign new_n66_ = x13 & x22 & x24 & x25 & x26;
  assign z12 = new_n68_ | (x03 & x08) | (~x08 & x09 & new_n70_ & ~x10);
  assign new_n68_ = x20 & (~x23 | (new_n69_ & x19 & x21 & ~x22));
  assign new_n69_ = ~x08 & x09 & ~x10;
  assign new_n70_ = x22 & ((~new_n72_ & x23) | ~x23 | (new_n71_ & x14 & x24));
  assign new_n71_ = x25 & x26;
  assign new_n72_ = x19 & x20 & x21;
  assign z13 = new_n68_ | (x04 & x08) | (~x08 & x09 & new_n74_ & ~x10);
  assign new_n74_ = x23 & ((~new_n72_ & x22) | ~x22 | (new_n71_ & x15 & x24));
  assign z14 = (~new_n76_ & x20) | (x05 & x08) | (new_n77_ & ~x08);
  assign new_n76_ = x23 & (~new_n69_ | ~x19 | ~x21 | ~x22 | x24);
  assign new_n77_ = x09 & ~x10 & x24 & (~new_n78_ | ~x19 | ~x20);
  assign new_n78_ = x21 & x22 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((x23 & (new_n82_ | (~new_n81_ & x25))) | (~x20 & x25));
  assign new_n81_ = x19 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n82_ = x19 & x20 & x21 & x22 & x24 & ~x25;
  assign z16 = (~new_n84_ & x20) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n84_ = x23 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
