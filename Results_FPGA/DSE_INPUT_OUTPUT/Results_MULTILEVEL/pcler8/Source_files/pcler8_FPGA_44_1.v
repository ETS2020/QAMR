...
module FAU ( 
  ...
  assign z14 = (x20 & (new_n73_ | ~x09)) | (x05 & x08) | (~x08 & new_n74_ & x09);
  assign new_n73_ = ~x08 & ~x10 & x19 & new_n58_ & x23 & ~x24;
  assign new_n74_ = ~x10 & x24 & (~new_n75_ | ~new_n76_);
  assign new_n75_ = x19 & x20 & x21;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((x25 & (~new_n75_ | ~new_n79_ | new_n80_ | ~x24)) | (new_n75_ & new_n79_ & x24 & ~x25));
