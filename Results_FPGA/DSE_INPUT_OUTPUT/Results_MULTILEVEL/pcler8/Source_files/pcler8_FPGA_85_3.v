...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n61_, new_n63_,
    ...
    new_n84_;
  assign z00 = x19 & (x16 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign new_n65_ = x19 ? (x20 ? (x21 & (~new_n49_ | ~new_n48_ | ~x13)) : ~x21) : ~x21;
  assign z12 = new_n51_ | (x03 & x08) | (~x08 & new_n67_ & x09);
  ...
  assign z14 = (~new_n73_ & x19) | (x05 & x08) | (~x08 & new_n75_ & x09);
  assign new_n73_ = ~x16 & (~new_n74_ | ~x21 | ~x22 | ~x23 | x24);
  assign new_n74_ = ~x08 & x09 & ~x10 & x20;
  assign new_n75_ = ~x10 & x24 & (~x19 | ~x20 | ~new_n48_ | ~x21);
  assign z15 = (~new_n77_ & x19) | (x06 & x08) | (~x08 & new_n79_ & x09);
  assign new_n77_ = ~x16 & (~new_n74_ | ~new_n78_);
  ...
  assign new_n82_ = ~x16 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
