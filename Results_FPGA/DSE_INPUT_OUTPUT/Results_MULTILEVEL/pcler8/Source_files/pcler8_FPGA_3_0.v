...
module FAU ( 
  ...
  assign z14 = new_n80_ | (~x08 & x09 & ~new_n76_ & ~x10) | (x05 & x08);
  ...
  assign new_n80_ = ~x20 & (~x16 | (~x08 & x09 & ~x10 & x24));
  ...
  assign new_n86_ = ~x20 & (~x16 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n93_ = ~x20 & (~x16 | (~x08 & x09 & ~x10 & x26));
endmodule
