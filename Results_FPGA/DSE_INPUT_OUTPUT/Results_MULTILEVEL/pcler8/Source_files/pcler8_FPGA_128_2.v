...
module FAU ( 
  ...
  assign z00 = x09 & (~x20 | (new_n48_ & new_n47_ & ~x08 & ~x10));
  ...
  assign z09 = (x00 & x08) | (x09 & (~x20 | (new_n58_ & ~x08)));
  assign new_n58_ = ~x10 & (~x19 | (new_n59_ & x11 & x21 & x22));
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08 & (~x09 | x20)) | (~x08 & x09 & ~x10 & ~new_n61_ & x20);
  assign new_n61_ = x19 & (~new_n59_ | ~x12 | ~x21 | ~x22);
  assign z11 = (x02 & x08) | (x09 & (~x20 | (~x08 & ~new_n63_ & ~x10)));
  ...
  assign z13 = (x04 & x08) | (x09 & (~x20 | (new_n69_ & ~x08)));
  assign new_n69_ = ~x10 & (x22 ? ((x19 & x21 & (new_n70_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (~x09 | x20)) | (~x08 & x09 & ~x10 & ~new_n72_ & x20);
  assign new_n72_ = (~x24 | (new_n47_ & x22 & ~new_n73_ & x23)) & (~new_n47_ | ~x22 | ~x23 | x24);
  assign new_n73_ = x16 & x25 & x26;
  assign z15 = (x06 & x08 & (~x09 | x20)) | (~x08 & x09 & ~x10 & ~new_n75_ & x20);
  assign new_n75_ = (~new_n76_ | ~x23 | ~x24 | x25) & (~x25 | (new_n76_ & x23 & x24 & (~x17 | ~x26)));
  assign new_n76_ = x19 & x21 & x22;
  assign z16 = (x07 & x08) | (x09 & (~x20 | (~x08 & ~new_n78_ & ~x10)));
