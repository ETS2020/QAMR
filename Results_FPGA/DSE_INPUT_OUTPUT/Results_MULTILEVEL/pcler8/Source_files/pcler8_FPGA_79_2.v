...
module FAU ( 
  ...
  assign z10 = (x01 & ~new_n50_ & x08) | (new_n62_ & ~x08);
  ...
  assign z12 = (x20 & (new_n70_ | ~x25)) | (new_n68_ & ~x08) | (x03 & x08);
  assign new_n68_ = x09 & ~x10 & x22 & (~new_n69_ | ~x19 | ~x20);
  assign new_n69_ = x21 & (~x24 | ~x26 | ~x14 | ~x23);
  assign new_n70_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x23 | (x20 & (new_n73_ | ~x25))) & (~new_n74_ | ~x22 | x23 | ~x25);
  assign new_n73_ = x19 & x21 & x22 & (~x15 | ~x24 | ~x26);
  assign new_n74_ = x19 & x20 & x21;
  assign z14 = new_n76_ | (x05 & x08) | (~x08 & x09 & new_n78_ & ~x10);
  assign new_n76_ = x20 & (~x25 | (new_n77_ & new_n48_ & ~x10 & x19));
  assign new_n77_ = x21 & x22 & x23 & ~x24;
  assign new_n78_ = x24 & (~new_n74_ | ~x22 | ~x23 | (x16 & x26));
  assign z15 = (~x08 & x09 & new_n80_ & ~x10) | new_n50_ | (x06 & x08);
  assign new_n80_ = x25 & (~new_n74_ | ~new_n81_);
  assign new_n81_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (x07 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x25 | ((new_n84_ | ~x26) & (~new_n74_ | ~new_n85_))) & (x20 | ~x26);
  assign new_n84_ = x22 & x23 & x24 & ~x18 & x19 & x21;
