...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x24 & (x19 ? (x20 & (new_n66_ | ~x21)) : x21)) | (~x20 & x21));
  ...
  assign z13 = (~new_n71_ & x20) | (x04 & x08) | (new_n73_ & ~x08);
  assign new_n71_ = x24 & (~new_n72_ | x08 | ~x09 | x10);
  ...
  assign new_n79_ = ~x10 & ((x24 & (new_n81_ | (~new_n80_ & x25))) | (~x20 & x25));
  ...
  assign new_n83_ = x20 & (~x24 | (new_n84_ & new_n48_ & ~x10 & x19));
  assign new_n84_ = x21 & x22 & x23 & x25 & ~x26;
  assign new_n85_ = x26 & (~new_n86_ | x18 | ~x19 | ~x20);
  assign new_n86_ = x21 & x22 & x23 & x25;
endmodule
