...
module FAU ( 
  ...
  assign z11 = new_n65_ | (~new_n50_ & (x08 ? x02 : new_n67_));
  ...
  assign z12 = z04 | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & ((x22 & (~x19 | ~x20 | new_n70_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n72_ | (new_n63_ & new_n48_ & ~x10 & x15);
  assign new_n72_ = ~new_n50_ & (x08 ? x04 : (new_n73_ & x09));
  assign new_n73_ = ~x10 & ((x23 & (~x19 | ~x20 | ~x21 | ~x22)) | (x19 & x20 & x21 & x22 & ~x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~new_n78_ | ~new_n79_) & (~x24 | (new_n76_ & new_n77_));
  assign new_n76_ = x19 & x20 & x21;
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = ~x16 & x19 & x20;
  assign new_n79_ = x21 & x22 & x23 & ~x24;
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n81_ = ~x24 & (x16 | (new_n48_ & ~x10 & x25));
  assign new_n82_ = (~x25 | (new_n76_ & x22 & ~new_n83_ & x23)) & (~new_n76_ | ~x22 | ~x23 | ~x24 | x25);
  assign new_n83_ = x17 & x26;
  assign z16 = new_n85_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n90_));
  assign new_n85_ = x07 & ~new_n50_ & x08;
  assign new_n86_ = x24 & ((x26 & (~new_n87_ | ~new_n88_)) | (new_n76_ & new_n89_));
  assign new_n87_ = ~x18 & x19 & x20;
  assign new_n88_ = x21 & x22 & x23 & x25;
  assign new_n89_ = x22 & x23 & x25 & ~x26;
  assign new_n90_ = ~x16 & ~x24 & x26;
endmodule
