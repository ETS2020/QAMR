...
module FAU ( 
  ...
  assign z12 = (x20 & (new_n64_ | x26)) | (x03 & x08) | (new_n62_ & ~x08);
  assign new_n62_ = x09 & ~x10 & ~new_n63_ & x22;
  assign new_n63_ = x19 & x20 & x21;
  assign new_n64_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign z13 = z05 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x23 & ((x20 & x22 & (~x19 | ~x21)) | ~x20 | ~x22)) | (x19 & x20 & x21 & x22 & ~x23));
  assign z14 = (x05 & ~z00 & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  ...
  assign new_n73_ = ~x10 & x25 & (~new_n63_ | ~x22 | ~x23 | ~x24);
  assign z16 = (~x08 & x09 & ~new_n75_ & ~x10) | z00 | (x07 & x08);
  assign new_n75_ = ~x26 & (~new_n63_ | ~new_n69_ | ~x24 | ~x25);
endmodule
