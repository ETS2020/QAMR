...
module FAU ( 
  ...
  assign z00 = ~x10 & (~x13 | (new_n47_ & new_n49_ & new_n50_));
  ...
  assign z09 = (x00 & x08 & (x10 | x13)) | (~x08 & x09 & ~x10 & ~new_n60_ & x13);
  assign new_n60_ = x19 & (~new_n61_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08 & (x10 | x13)) | (~x08 & x09 & ~x10 & ~new_n63_ & x13);
  assign new_n63_ = x19 ? (x20 & (~new_n61_ | ~x12 | ~x21 | ~x22)) : ~x20;
  assign z11 = (x02 & x08 & (x10 | x13)) | (~x08 & x09 & ~x10 & ~new_n65_ & x13);
  assign new_n65_ = x19 ? ((~x20 | ((~new_n49_ | ~new_n50_) & x21)) & (~x21 | (x20 & (~new_n50_ | ~new_n49_ | ~x12)))) : ~x21;
  assign z12 = (x03 & x08) | (~x10 & (~x13 | (~x08 & ~new_n67_ & x09)));
  assign new_n67_ = (~x22 | (new_n68_ & x21 & (~new_n50_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  assign new_n68_ = x19 & x20;
  assign z13 = (x04 & x08 & (x10 | x13)) | (~x08 & x09 & ~x10 & ~new_n70_ & x13);
  assign new_n70_ = (~x23 | (new_n68_ & x21 & ~new_n71_ & x22)) & (~new_n68_ | ~x21 | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~x10 & (~x13 | (~x08 & ~new_n73_ & x09)));
  assign new_n73_ = (~x24 | (new_n48_ & x22 & ~new_n74_ & x23)) & (~new_n48_ | ~x22 | ~x23 | x24);
  assign new_n74_ = x16 & x25 & x26;
  assign z15 = (x06 & x08) | (~x10 & (~x13 | (~x08 & ~new_n76_ & x09)));
  assign new_n76_ = (~x25 | (new_n48_ & new_n49_ & x24 & (~x17 | ~x26))) & (~new_n48_ | ~new_n49_ | ~x24 | x25);
  assign z16 = (x07 & x08) | (~x10 & (~x13 | (new_n78_ & ~x08)));
  assign new_n78_ = x09 & ((new_n81_ & new_n82_) | ((~new_n79_ | ~new_n80_) & x26));
