...
module FAU ( 
  ...
  assign z11 = new_n47_ | (x02 & x08) | (new_n64_ & ~x08);
  ...
  assign new_n77_ = ~x20 & (~x25 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n81_ | (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & x08);
  assign new_n79_ = (~x25 | (new_n80_ & x23 & x24 & (~x17 | ~x26))) & (~new_n80_ | ~x23 | ~x24 | x25);
  assign new_n80_ = x19 & x21 & x22;
  assign new_n81_ = ~x20 & (~x25 | (~x08 & x09 & ~x10));
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n83_ | new_n84_));
  assign new_n83_ = x20 & ((~x25 & x26) | (new_n80_ & x23 & x24 & x25 & ~x26));
  assign new_n84_ = x25 & x26 & (~new_n85_ | ~new_n48_ | x18);
