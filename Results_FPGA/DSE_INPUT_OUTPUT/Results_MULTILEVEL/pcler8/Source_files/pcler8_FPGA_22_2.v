...
module FAU ( 
  ...
  assign new_n58_ = ~x10 & (~x19 | (new_n60_ & new_n59_ & x11));
  ...
  assign z12 = new_n49_ | (x03 & x08) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x19 | ~x21 | (x22 & (~new_n65_ | ~x14 | ~x23))) & (~x22 | (x19 & x21));
  assign z13 = (~x08 & new_n69_ & x09) | (x04 & ~new_n49_ & x08);
  assign new_n69_ = ~x10 & ((x20 & ((x19 & ~new_n70_ & x21) | (~x21 & x23))) | (~x19 & x23));
  assign new_n70_ = x22 ? (x23 & (~x15 | ~x24 | ~x25 | ~x26)) : ~x23;
  assign z14 = (x19 & (new_n72_ | ~x20)) | (x05 & x08) | (new_n73_ & ~x08);
  assign new_n72_ = ~x08 & x09 & ~x10 & new_n59_ & x23 & ~x24;
  assign new_n73_ = x09 & ~x10 & x24 & (~new_n74_ | ~x19 | ~x21);
  assign new_n74_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & ((x20 & (new_n78_ | (~new_n77_ & x25))) | (~x19 & x25));
  ...
  assign new_n80_ = (x19 | ~x26) & (~x20 | ((new_n81_ | ~x26) & (~new_n82_ | ~new_n59_ | ~x19)));
