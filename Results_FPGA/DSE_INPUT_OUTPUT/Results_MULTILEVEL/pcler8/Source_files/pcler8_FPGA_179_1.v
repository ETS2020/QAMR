...
module FAU ( 
  ...
  assign new_n59_ = ~x10 & (~x19 | (new_n60_ & x20 & x21 & x22));
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (~x11 | ~x20 | ((~new_n60_ | ~new_n63_) & x19)) & (~x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & ~new_n50_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x11 & x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x20 & (new_n70_ | ~x11)) | (x03 & x08) | (new_n68_ & ~x08);
  ...
  assign new_n80_ = x11 & ((new_n81_ & new_n84_) | (x25 & (~new_n82_ | ~new_n83_)));
  ...
  assign z16 = (~new_n87_ & x20) | (x07 & x08) | (~x08 & new_n90_ & x09);
  assign new_n87_ = x11 & (~new_n89_ | ~new_n88_ | ~x24 | ~x25 | x26);
  assign new_n88_ = x22 & x23;
  assign new_n89_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n90_ = ~x10 & x26 & (~new_n91_ | ~new_n88_ | ~x24 | ~x25);
