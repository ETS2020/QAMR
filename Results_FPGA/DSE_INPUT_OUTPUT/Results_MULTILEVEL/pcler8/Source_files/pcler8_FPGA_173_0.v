...
module FAU ( 
  ...
  assign z01 = (~x09 & ~x20) | (x00 & x08);
  assign z02 = (~x09 & ~x20) | (x01 & x08);
  ...
  assign z09 = (x00 & x08 & (x09 | x20)) | (~x08 & x09 & ~new_n57_ & ~x10);
  assign new_n57_ = x19 & (~new_n58_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08 & (x09 | x20)) | (~x08 & x09 & ~new_n60_ & ~x10);
  assign new_n60_ = x20 ? (x19 & (~new_n58_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = (new_n62_ & ~x08) | (x02 & x08) | (~x09 & ~x20);
  assign new_n62_ = ~x10 & ((x09 & x20 & (x19 ? (new_n63_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x20 & (~x09 | (new_n67_ & ~x08))) | (x03 & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x22 & (~x19 | new_n66_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  ...
  assign z14 = new_n76_ | (x05 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x24 | (new_n74_ & x22 & ~new_n75_ & x23)) & (~new_n73_ | ~x22 | ~x23 | x24);
  assign new_n73_ = x19 & x20 & x21;
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign new_n76_ = ~x20 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (~x20 & (~x09 | (new_n82_ & ~x08))) | (x06 & x08) | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((new_n73_ & new_n81_) | (x25 & (~new_n79_ | ~new_n80_)));
  assign new_n79_ = x19 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x10 & x25;
  assign z16 = (~x20 & (~x09 | (new_n89_ & ~x08))) | (x07 & x08) | (~x08 & new_n84_ & x09);
