...
module FAU ( 
  ...
  assign z12 = (~new_n66_ & x14) | (x03 & x08) | (new_n67_ & ~x08);
  assign new_n66_ = x20 & (~new_n59_ | x10 | ~x22 | x08 | ~x09);
  assign new_n67_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign z13 = new_n69_ | (~x08 & x09 & ~x10 & (new_n70_ | new_n72_));
  assign new_n69_ = x04 & ~new_n49_ & x08;
  assign new_n70_ = x20 & (x22 ? ((x19 & x21 & (new_n71_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x14 & ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x20 | ((~x24 | (new_n75_ & new_n76_)) & (~new_n75_ | ~new_n77_))) & (x14 | x20 | ~x24);
  ...
  assign new_n91_ = ~x20 & (x14 | (~x08 & x09 & ~x10 & x26));
endmodule
