...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x06 & ~x20 & x21));
  ...
  assign new_n70_ = ~x20 & (x06 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n75_ = ~x06 & ~x20 & x23;
  assign z14 = new_n81_ | (x05 & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  ...
  assign new_n81_ = ~x20 & (x06 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & new_n83_ & x09);
  assign new_n83_ = ~x10 & ((x25 & (~new_n80_ | ~new_n48_ | new_n84_ | ~x24)) | (new_n80_ & new_n48_ & x24 & ~x25));
  ...
  assign new_n91_ = ~x20 & (x06 | (~x08 & x09 & ~x10 & x26));
endmodule
