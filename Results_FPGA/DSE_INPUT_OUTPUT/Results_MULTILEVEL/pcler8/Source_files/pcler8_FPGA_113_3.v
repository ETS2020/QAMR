...
module FAU ( 
  ...
  assign z11 = (new_n66_ & ~x08) | (x02 & x08) | (x03 & x19);
  assign new_n66_ = x09 & ~x10 & ((x19 & x20 & (new_n67_ | ~x21)) | (x21 & (~x19 | ~x20)));
  assign new_n67_ = new_n60_ & x24 & new_n68_ & x13;
  assign new_n68_ = x22 & x23;
  assign z12 = (~x19 & ((x03 & x08) | (new_n72_ & ~x08 & x09))) | (~x03 & ~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x22 & (~x20 | new_n71_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n71_ = new_n60_ & x24 & x14 & x23;
  assign new_n72_ = ~x10 & x22;
  assign z13 = (~x08 & new_n74_ & x09) | (x04 & x08 & (~x03 | (x03 & ~x19)));
  ...
  assign z16 = (~x08 & new_n86_ & x09) | (x07 & x08 & (~x03 | ~x19));
