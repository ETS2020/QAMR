...
module FAU ( 
  ...
  assign z00 = x20 & (~x13 | (new_n47_ & new_n49_));
  ...
  assign new_n65_ = ~x10 & ((x13 & (x19 ? (x20 & (new_n47_ | ~x21)) : x21)) | (~x20 & x21));
  ...
  assign new_n71_ = (~x19 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x21));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (new_n74_ & ~x08);
  assign new_n74_ = x09 & ~x10 & (new_n75_ | (~x20 & x24));
  assign new_n75_ = x13 & (new_n77_ | (x24 & (~new_n76_ | ~x19 | ~x21)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((~x20 & x25) | (x13 & (new_n82_ | (~new_n80_ & x25))));
  assign new_n80_ = new_n81_ & x19 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x19 & x20 & x21 & new_n48_ & x24 & ~x25;
  assign z16 = (~new_n84_ & x20) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n84_ = x13 & (~new_n49_ | ~new_n48_ | ~x24 | ~x25 | x26);
