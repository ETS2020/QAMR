...
module FAU ( 
  ...
  assign new_n61_ = (~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (~x19 | x20 | ~x26);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (new_n64_ & ~x08) | new_n49_ | (x02 & x08);
  ...
  assign new_n67_ = ~x10 & ((x22 & (new_n68_ | (x20 & (~x19 | ~x21)))) | (x19 & x20 & x21 & ~x22));
  assign new_n68_ = x26 & (~x20 | (x14 & x23 & x24 & x25));
  ...
  assign new_n73_ = ~x20 & x23 & x26;
  assign z14 = (new_n75_ & ~x08) | (x05 & ~new_n49_ & x08);
  assign new_n75_ = x09 & ~x10 & (new_n78_ | (x24 & (new_n76_ | new_n77_)));
  assign new_n76_ = x26 & (~x20 | (x16 & x25));
  assign new_n77_ = x20 & (~x19 | ~x21 | ~x22 | ~x23);
  assign new_n78_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n49_ & x08) | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((x25 & (new_n82_ | new_n83_)) | (new_n81_ & new_n84_));
  assign new_n81_ = x19 & x20 & x21;
  assign new_n82_ = x26 & (x17 | ~x20);
  assign new_n83_ = x20 & (~x22 | ~x23 | ~x24 | ~x19 | ~x21);
