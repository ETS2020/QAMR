...
module FAU ( 
  ...
  assign z09 = (~x08 & ~new_n57_ & ~x10) | (~x09 & x20) | (x00 & x08);
  assign new_n57_ = (~x09 | x19) & (~new_n59_ | ~new_n58_ | ~x11 | ~x20);
  assign new_n58_ = x21 & x22;
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = (~x08 & ~new_n61_ & ~x10) | (~x09 & x20) | (x01 & x08);
  assign new_n61_ = (~x20 | (x19 & (~new_n59_ | ~new_n58_ | ~x12))) & (~x09 | ~x19 | x20);
  assign z11 = (x02 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x19 | ~x20 | (x21 & (~new_n65_ | ~new_n64_ | ~x13))) & (~x21 | (x19 & x20));
  ...
  assign new_n68_ = x21 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n69_ = ~x08 & ~x10 & x19 & x21 & ~x22;
  assign z13 = z05 | (~x08 & ~x10 & (new_n73_ | (~new_n71_ & x22)));
  assign new_n71_ = (~x19 | ~x20 | ~x21 | (~new_n72_ & x23)) & (~x09 | ~x23 | (x19 & x20 & x21));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = x09 & ~x22 & x23;
  assign z14 = (x20 & (new_n75_ | ~x09)) | (x05 & x08) | (~x08 & new_n76_ & x09);
  assign new_n75_ = ~x08 & ~x10 & x19 & new_n58_ & x23 & ~x24;
  assign new_n76_ = ~x10 & x24 & (~new_n77_ | ~x19 | ~x20 | ~x21);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = new_n79_ | (x06 & x08) | (~x08 & x09 & new_n81_ & ~x10);
  assign new_n79_ = x20 & (~x09 | (new_n80_ & new_n64_ & x24 & ~x25));
  assign new_n80_ = x19 & x21 & ~x08 & ~x10;
  assign new_n81_ = x25 & (~new_n82_ | ~x19 | ~x20 | ~x21);
  assign new_n82_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (x20 & (new_n84_ | ~x09)) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n84_ = new_n80_ & new_n64_ & x24 & x25 & ~x26;
  assign new_n85_ = ~x10 & x26 & (~new_n86_ | ~new_n64_ | ~x24 | ~x25);
