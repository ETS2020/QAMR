...
module FAU ( 
  ...
  assign z11 = (~x08 & x09 & ~new_n64_ & ~x10) | new_n49_ | (x02 & x08);
  ...
  assign new_n74_ = ~x15 & ~x20 & x23;
  assign z14 = (~x08 & x09 & ~new_n76_ & ~x10) | (x05 & ~new_n49_ & x08);
  assign new_n76_ = (~x20 | ((~x24 | (new_n77_ & new_n78_)) & (~new_n77_ | ~new_n79_))) & (x15 | x20 | ~x24);
  ...
  assign new_n86_ = ~x20 & (x15 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n93_ = ~x20 & (x15 | (~x08 & x09 & ~x10 & x26));
endmodule
