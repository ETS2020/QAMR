...
module FAU ( 
  ...
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (x19 & ~x20 & x23));
  ...
  assign new_n68_ = ~x20 & (~x23 | (new_n47_ & ~x10 & x22));
  ...
  assign new_n72_ = (~x23 | ((~x22 | (x19 & x21)) & ~new_n73_ & x22)) & (~x19 | ~x21 | ~x22 | x23);
  ...
  assign new_n86_ = ~x20 & (~x23 | (new_n47_ & ~x10 & x26));
