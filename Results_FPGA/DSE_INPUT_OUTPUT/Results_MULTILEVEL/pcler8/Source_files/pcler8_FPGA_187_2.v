...
module FAU ( 
  ...
  assign new_n68_ = (~x20 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x21 | x22))) & (x18 | x20 | ~x22);
  ...
  assign new_n78_ = ~x20 & (x18 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x20 | ((~new_n81_ | ~new_n83_) & (~x25 | (new_n81_ & new_n82_)))) & (x18 | x20 | ~x25);
  ...
  assign new_n86_ = x20 & ((x18 & x26) | (new_n81_ & new_n87_ & x25 & ~x26));
  assign new_n87_ = x23 & x24;
  assign new_n88_ = ~x18 & x26 & (~new_n89_ | ~x19 | ~x20 | ~x21);
