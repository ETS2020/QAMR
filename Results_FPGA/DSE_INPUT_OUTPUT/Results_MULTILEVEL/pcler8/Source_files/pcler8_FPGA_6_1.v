...
module FAU ( 
  ...
  assign z00 = x23 & (~x20 | (new_n47_ & new_n48_ & x21 & x22));
  ...
  assign new_n63_ = ~x20 & (new_n47_ | x23);
  ...
  assign new_n81_ = x23 & (~x20 | (new_n47_ & new_n82_));
  assign new_n82_ = x21 & x22 & x24 & ~x25;
  assign new_n83_ = x25 & (~new_n84_ | ~x23 | ~x24 | (x17 & x26));
  assign new_n84_ = x19 & x21 & x22;
  assign z16 = z08 | (~x08 & x09 & ~new_n86_ & ~x10);
  assign new_n86_ = (x23 | ~x26) & (~x20 | ((new_n87_ | ~x26) & (~new_n84_ | ~new_n88_)));
  assign new_n87_ = ~x18 & x19 & x21 & x22 & x24 & x25;
