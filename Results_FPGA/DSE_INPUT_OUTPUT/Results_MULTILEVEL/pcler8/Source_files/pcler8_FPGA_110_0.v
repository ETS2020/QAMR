...
module FAU ( 
  ...
  assign new_n70_ = ~x20 & (~x17 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z14 = new_n79_ | (~x08 & x09 & ~new_n75_ & ~x10) | (x05 & x08);
  ...
  assign new_n79_ = ~x20 & (~x17 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~x08 & new_n81_ & x09) | (x06 & ~new_n49_ & x08);
  assign new_n81_ = ~x10 & ((x25 & (new_n82_ | new_n83_)) | (new_n78_ & new_n84_));
  assign new_n82_ = x17 & (~x20 | x26);
  assign new_n83_ = x20 & (~x19 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n91_));
  assign new_n86_ = x20 & ((new_n89_ & new_n90_) | (x26 & (~new_n87_ | ~new_n88_)));
