...
module FAU ( 
  ...
  assign new_n59_ = new_n60_ & ~x03 & x11 & new_n61_ & x22 & x23;
  ...
  assign new_n66_ = ~x10 & ((~x03 & ((x19 & x20 & (new_n67_ | ~x21)) | (~x20 & x21))) | (~x19 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & (x08 | x19)) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (new_n70_ & x21 & (~new_n61_ | ~x14 | ~x23))) & (~new_n70_ | ~x21 | x22);
  ...
  assign new_n75_ = (x19 | ~x24) & (x03 | (((new_n60_ & new_n76_) | ~x24) & (~new_n77_ | ~new_n60_ | ~x19)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = (~new_n79_ & x19) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n79_ = ~x03 & (~new_n80_ | x08 | ~x09 | x10 | ~x20);
  ...
  assign new_n84_ = ~x03 & (~new_n85_ | x08 | ~x09 | ~new_n60_ | x10);
