...
module FAU ( 
  ...
  assign z11 = (~x08 & x09 & ~new_n63_ & ~x10) | new_n49_ | (x02 & x08);
  ...
  assign new_n68_ = ~x20 & (~x14 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n73_ = x14 & ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x20 | ((~x24 | (new_n76_ & new_n77_)) & (~new_n76_ | ~new_n78_))) & (~x14 | x20 | ~x24);
  ...
  assign new_n85_ = ~x20 & (~x14 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n92_ = ~x20 & (~x14 | (~x08 & x09 & ~x10 & x26));
endmodule
