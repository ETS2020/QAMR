...
module FAU ( 
  ...
  assign z10 = ~new_n64_ | (x12 & (new_n62_ | ~x20));
  ...
  assign new_n80_ = ~x20 & (x12 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~x08 & x09 & ~new_n82_ & ~x10) | (x06 & ~new_n47_ & x08);
  assign new_n82_ = (~x20 | ((~x25 | (new_n83_ & new_n84_)) & (~new_n83_ | ~new_n85_))) & (x12 | x20 | ~x25);
