...
module FAU ( 
  ...
  assign new_n64_ = (~x19 | ~x20 | (~new_n65_ & x21)) & (~x21 | (x19 & x20));
  ...
  assign new_n74_ = x20 & (x11 | (new_n75_ & new_n76_));
  ...
  assign new_n82_ = ~x11 & ((new_n78_ & new_n85_) | (x25 & (~new_n83_ | ~new_n84_)));
  ...
  assign new_n88_ = ~x11 & ((new_n91_ & new_n92_) | ((~new_n89_ | ~new_n90_) & x26));
