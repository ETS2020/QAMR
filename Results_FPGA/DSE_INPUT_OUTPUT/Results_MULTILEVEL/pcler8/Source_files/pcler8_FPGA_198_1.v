...
module FAU ( 
  ...
  assign new_n64_ = (~x13 | ~x20 | (x19 & (~new_n66_ | ~new_n65_ | ~x12 | ~x19))) & (~x19 | x20);
  assign new_n65_ = x21 & x22;
  assign new_n66_ = x23 & x24 & x25 & x26;
  assign z11 = (~x08 & x09 & ~new_n68_ & ~x10) | new_n50_ | (x02 & x08);
  assign new_n68_ = (~x19 | ~x20 | ((~new_n61_ | ~new_n62_) & x21)) & (~x21 | (x19 & x20));
  ...
  assign z13 = (x20 & (new_n73_ | ~x13)) | (x04 & x08) | (new_n75_ & ~x08);
  ...
  assign new_n78_ = (~x13 | (~new_n80_ & ((new_n74_ & new_n79_) | ~x24))) & (x20 | ~x24);
  ...
  assign new_n89_ = x13 & (~new_n90_ | ~new_n61_ | ~x24 | ~x25 | x26);
