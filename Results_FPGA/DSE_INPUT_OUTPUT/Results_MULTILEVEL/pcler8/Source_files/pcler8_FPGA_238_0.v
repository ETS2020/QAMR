...
module FAU ( 
  ...
  assign z14 = new_n83_ | (x05 & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  ...
  assign new_n83_ = ~x20 & (~x15 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n89_ | (x06 & x08) | (~x08 & new_n85_ & x09);
  ...
  assign new_n89_ = ~x20 & (~x15 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n96_ | (x07 & x08) | (~x08 & new_n91_ & x09);
  ...
  assign new_n96_ = ~x20 & (~x15 | (~x08 & x09 & ~x10 & x26));
endmodule
