...
module FAU ( 
  ...
  assign z04 = (~x03 & ~x19) | (x08 & (x03 | ~x19));
  assign z05 = new_n50_ | (x04 & x08);
  assign z06 = x05 & ~new_n50_ & x08;
  assign z07 = new_n50_ | (x06 & x08);
  assign z08 = new_n50_ | (x07 & x08);
  assign z09 = (x00 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x03 | x19) & (~new_n48_ | ~new_n49_ | ~new_n62_ | ~x11 | ~x19);
  assign new_n62_ = x20 & x21;
  assign z10 = (~x08 & x09 & ~new_n64_ & ~x10) | new_n50_ | (x01 & x08);
  ...
  assign new_n67_ = x19 & (x20 ? ((new_n49_ & new_n48_ & x13) | ~x21) : x21);
  assign new_n68_ = ~x19 & (~x03 | (~x08 & x09 & ~x10 & x21));
  assign z12 = (x08 & (x03 | ~x19)) | (~x19 & (~x03 | (new_n72_ & x09))) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x22 & (~x20 | new_n71_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign new_n72_ = ~x10 & x22;
  assign z13 = new_n74_ | (x19 & (x08 ? x04 : (new_n76_ & x09)));
  assign new_n74_ = ~new_n75_ & x03;
  assign new_n75_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x19 | ~x23);
  assign new_n76_ = ~x10 & (x22 ? ((x20 & x21 & (new_n77_ | ~x23)) | (x23 & (~x20 | ~x21))) : x23);
  assign new_n77_ = x15 & x24 & x25 & x26;
  assign z14 = new_n81_ | (~x08 & x09 & ~new_n79_ & ~x10) | (x05 & x08);
  assign new_n79_ = (~x24 | (new_n62_ & x22 & ~new_n80_ & x23)) & (~new_n62_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n80_ = x16 & x25 & x26;
  assign new_n81_ = ~x19 & (~x03 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x03 & (new_n87_ | (x06 & x08))) | (x19 & (x08 ? x06 : new_n83_));
  assign new_n83_ = x09 & ~x10 & ((new_n84_ & new_n86_) | ((~new_n84_ | ~new_n85_) & x25));
  assign new_n84_ = x20 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x23 & x24 & ~x25;
  assign new_n87_ = ~x08 & x09 & ~x10 & ~x19 & x25;
  assign z16 = new_n94_ | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n89_ = ~x10 & ((new_n92_ & new_n93_) | ((~new_n90_ | ~new_n91_) & x26));
  assign new_n90_ = ~x18 & x20 & x21;
  assign new_n91_ = x22 & x23 & x24 & x25;
  assign new_n92_ = x19 & x20 & x21 & x22;
  assign new_n93_ = x23 & x24 & x25 & ~x26;
  assign new_n94_ = ~x19 & (~x03 | (~x08 & x09 & ~x10 & x26));
endmodule
