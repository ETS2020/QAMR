...
module FAU ( 
  ...
  assign z15 = (x06 & x08 & (x09 | x20)) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x25 | (new_n73_ & new_n77_ & x24 & (~x17 | ~x26))) & (~new_n73_ | ~new_n77_ | ~x24 | x25);
  assign new_n77_ = x22 & x23;
  assign z16 = z08 | (~x08 & new_n79_ & x09);
