...
module FAU ( 
  ...
  assign z13 = new_n71_ | (~x08 & x09 & ~x10 & (new_n72_ | new_n75_));
  assign new_n71_ = x04 & ~new_n49_ & x08;
  assign new_n72_ = x15 & ((new_n73_ & new_n74_) | (~x20 & x23));
  assign new_n73_ = x19 & x20 & x21;
  assign new_n74_ = x22 & x24 & x25 & x26;
  assign new_n75_ = x20 & (x22 ? ((x23 & (~x19 | ~x21)) | (x19 & x21 & ~x23)) : x23);
  ...
  assign new_n82_ = ~x10 & ((new_n73_ & new_n85_) | (x25 & (~new_n83_ | ~new_n84_)));
