...
module FAU ( 
  ...
  assign new_n81_ = x20 & ((new_n82_ & new_n83_) | x05);
  assign new_n82_ = ~x10 & x19 & ~x08 & x09;
  assign new_n83_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n84_ = x25 & (~new_n78_ | ~new_n61_ | ~x24 | (x17 & x26));
  assign z16 = new_n86_ | (~x08 & x09 & ~x10 & (new_n87_ | new_n92_));
  assign new_n86_ = x07 & ~new_n50_ & x08;
  assign new_n87_ = ~x05 & ((new_n90_ & new_n91_) | ((~new_n88_ | ~new_n89_) & x26));
