...
module FAU ( 
  ...
  assign z12 = (x03 & (x08 | (new_n68_ & x09 & ~x10))) | (~x08 & x09 & new_n66_ & ~x10);
  assign new_n66_ = x20 & ((x22 & (~x19 | new_n67_ | ~x21)) | (x19 & x21 & ~x22));
  ...
  assign z15 = (~new_n49_ & (x08 ? x06 : (new_n79_ & x09))) | (~x08 & new_n81_ & x09);
  assign new_n79_ = ~x10 & x25 & (~new_n80_ | ~x19 | ~x21 | ~x22);
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = ~x10 & (new_n82_ | (new_n83_ & x19 & x20 & x21));
  assign new_n82_ = x03 & ~x20 & x25;
  ...
  assign new_n87_ = ~x10 & ((new_n88_ & new_n89_) | (x03 & ~x20 & x26));
