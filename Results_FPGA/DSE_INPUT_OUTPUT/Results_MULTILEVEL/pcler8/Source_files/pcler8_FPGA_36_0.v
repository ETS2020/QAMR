...
module FAU ( 
  ...
  assign z00 = (~x19 & ~x21) | (new_n47_ & new_n48_ & x21 & x22 & x23);
  ...
  assign new_n64_ = (~x19 | (~x20 ^ x21)) & (~x21 | (~new_n65_ & x19));
  ...
  assign new_n69_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & ~new_n50_ & x08);
  assign new_n71_ = x19 ? (x22 ? ((~x20 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x20 & x21))) : ~x23) : (~x21 | ~x23);
  assign new_n72_ = x25 & x26 & x15 & x24;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x21 | ((x19 | ~x24) & (~new_n75_ | ~x19 | ~x20))) & (~x19 | ~x24 | (new_n76_ & x20 & x21));
  ...
  assign new_n83_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n85_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n88_));
  assign new_n85_ = x07 & ~new_n50_ & x08;
  assign new_n86_ = x21 & ((~x19 & x26) | (new_n87_ & x19 & x20 & x22));
  assign new_n87_ = x23 & x24 & x25 & ~x26;
  assign new_n88_ = x19 & x26 & (~new_n89_ | x18 | ~x20 | ~x21);
