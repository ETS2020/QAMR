...
module FAU ( 
  ...
  assign new_n62_ = x20 ? (x19 & (~new_n60_ | ~new_n59_ | ~x12)) : ~x19;
  ...
  assign new_n69_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & ~new_n49_ & x08);
  assign new_n71_ = x19 ? (x22 ? ((~x20 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x20 & x21))) : ~x23) : (~x20 | ~x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = new_n77_ | (~x08 & x09 & ~new_n74_ & ~x10) | (x05 & x08);
  assign new_n74_ = (~x24 | (new_n75_ & x22 & ~new_n76_ & x23)) & (~new_n75_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n75_ = x20 & x21;
  assign new_n76_ = x16 & x25 & x26;
  assign new_n77_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x20 | ((x19 | ~x25) & (~new_n80_ | ~new_n59_ | ~x19))) & (~x19 | ~x25 | (new_n81_ & new_n59_ & x20));
  assign new_n80_ = x23 & x24 & ~x25;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n83_ | (~x08 & x09 & ~x10 & (new_n84_ | new_n86_));
  assign new_n83_ = x07 & ~new_n49_ & x08;
  assign new_n84_ = x20 & ((new_n85_ & new_n59_ & x19) | (~x19 & x26));
  assign new_n85_ = x23 & x24 & x25 & ~x26;
  assign new_n86_ = x19 & x26 & (~new_n87_ | ~new_n75_ | x18);
