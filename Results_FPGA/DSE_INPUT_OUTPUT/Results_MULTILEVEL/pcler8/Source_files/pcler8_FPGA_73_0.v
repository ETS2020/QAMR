...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n61_, new_n62_, new_n63_,
    ...
    new_n91_;
  assign z00 = (~x05 & ~x20) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign z10 = (x01 & ~new_n50_ & x08) | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (x05 & x19 & ~x20));
  assign new_n62_ = x12 & x21 & x22;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = x20 ? (x19 ? (~new_n66_ & x21) : ~x21) : ~x21;
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = new_n68_ | (x03 & x08) | (~x08 & new_n69_ & x09);
  assign new_n68_ = ~x20 & (~x05 | (new_n47_ & ~x10 & x22));
  ...
  assign z14 = (x08 & (x05 | ~x20)) | (~x08 & new_n75_ & x09) | (~x20 & (~x05 | (new_n78_ & x09)));
  assign new_n75_ = ~x10 & (new_n77_ | (x24 & (~new_n76_ | ~x19 | ~x21)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign new_n78_ = ~x10 & x24;
  assign z15 = (x05 & (new_n80_ | (x06 & x08))) | (x20 & (x08 ? x06 : new_n81_));
  assign new_n80_ = new_n47_ & ~x10 & ~x20 & x25;
  assign new_n81_ = x09 & ~x10 & ((x25 & (~new_n82_ | ~new_n83_)) | (new_n82_ & new_n84_));
  assign new_n82_ = x19 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x23 & x24 & ~x25;
  assign z16 = new_n86_ | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n86_ = ~x20 & (~x05 | (new_n47_ & ~x10 & x26));
