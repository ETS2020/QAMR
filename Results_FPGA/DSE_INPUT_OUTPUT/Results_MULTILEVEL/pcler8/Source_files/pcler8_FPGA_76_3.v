...
module FAU ( 
  ...
  assign z12 = (x20 & (new_n71_ | x18)) | (new_n69_ & ~x08) | (x03 & x08);
  ...
  assign new_n81_ = ~x18 & (~new_n82_ | x08 | ~x09 | x10 | ~x19);
  assign new_n82_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n83_ = ~x10 & x25 & (~new_n84_ | ~x19 | ~x20 | ~x21);
  assign new_n84_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (x07 & ~new_n52_ & x08) | (~x08 & x09 & ~new_n86_ & ~x10);
  assign new_n86_ = (x20 | ~x26) & (x18 | ((~new_n88_ | ~new_n89_) & (new_n87_ | ~x26)));
  assign new_n87_ = x19 & x21 & x22 & x23 & x24 & x25;
