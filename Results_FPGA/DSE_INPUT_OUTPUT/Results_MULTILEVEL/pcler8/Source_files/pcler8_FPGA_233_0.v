...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x10 & (~x20 | (new_n57_ & ~x08)));
  ...
  assign new_n62_ = x19 ? (~new_n63_ & x21) : (~x20 | ~x21);
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08) | (~x10 & (~x20 | (~x08 & ~new_n65_ & x09)));
  assign new_n65_ = (~x22 | (x19 & ~new_n66_ & x21)) & (~x19 | ~x21 | x22);
  ...
  assign new_n71_ = (~x24 | (x19 & x21 & x22 & ~new_n72_ & x23)) & (~x19 | ~x21 | ~x22 | ~x23 | x24);
