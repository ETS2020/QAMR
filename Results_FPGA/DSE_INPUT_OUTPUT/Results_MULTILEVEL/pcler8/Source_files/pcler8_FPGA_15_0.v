...
module FAU ( 
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (~x19 | x20 | ~x24);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (x19 ? (new_n66_ | ~x21) : x21) : (x21 & x24));
  ...
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & new_n76_ & x09);
  ...
  assign new_n80_ = (new_n81_ | ~x24) & (~x20 | (new_n82_ & new_n83_) | ~x25);
