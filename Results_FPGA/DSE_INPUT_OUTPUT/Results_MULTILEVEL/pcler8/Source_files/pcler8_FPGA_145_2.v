...
module FAU ( 
  ...
  assign new_n57_ = new_n59_ & new_n60_ & ~x08 & ~x10 & new_n58_ & x11;
  assign new_n58_ = x20 & x21;
  assign new_n59_ = x22 & x23;
  assign new_n60_ = x24 & x25 & x26;
  assign z10 = (x01 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n62_ & x19);
  assign new_n62_ = x20 & (~new_n63_ | ~x12 | ~x21 | ~x22);
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08) | (x09 & (~x19 | (~x08 & ~new_n65_ & ~x10)));
  assign new_n65_ = (~x20 | (x21 & (~new_n60_ | ~new_n59_ | ~x13))) & (~x19 | x20 | ~x21);
  assign z12 = (x03 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n67_ & x19);
  assign new_n67_ = (~x22 | (x20 & x21 & (~new_n60_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n69_ & x19);
  assign new_n69_ = x22 ? ((~x20 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x20 & x21))) : ~x23;
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (x09 & (~x19 | (~x08 & ~new_n72_ & ~x10)));
  assign new_n72_ = (~x24 | (new_n58_ & x22 & ~new_n73_ & x23)) & (~new_n58_ | ~x22 | ~x23 | x24);
  ...
  assign new_n78_ = (~x26 | (new_n79_ & new_n58_ & ~x18)) & (~new_n76_ | ~new_n80_);
