...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x02 | (x02 & x20))) | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n60_ & new_n63_))) | (~x02 & x19 & ~x20));
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (~x08 & new_n65_ & x09) | (x02 & x08 & x20);
  assign new_n65_ = ~x10 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x02 & ~x20 & x21));
  ...
  assign new_n70_ = ~x20 & (x02 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n75_ = x25 & x26 & x15 & x24;
  ...
  assign new_n91_ = ~x10 & ((new_n86_ & new_n94_) | ((~new_n92_ | ~new_n93_) & x26));
  assign new_n92_ = ~x18 & x19 & x21;
  assign new_n93_ = x24 & x25 & x22 & x23;
