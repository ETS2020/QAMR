...
module FAU ( 
  ...
  assign z12 = new_n68_ | (~x08 & x09 & ~new_n66_ & ~x10) | (x03 & x08);
  ...
  assign new_n90_ = ~x20 & (~x22 | (~x08 & x09 & ~x10 & x26));
endmodule
