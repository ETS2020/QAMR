// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:43 2020
...
module FAU ( 
  ...
  assign z11 = z03 | (~x08 & x09 & ~x10 & (new_n64_ | new_n66_));
  assign new_n64_ = x21 & ((x12 & (~x19 | (new_n60_ & new_n65_))) | (x19 & ~x20));
  assign new_n65_ = x13 & x19 & x22;
  assign new_n66_ = x19 & x20 & (new_n67_ | ~x21);
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (~x08 & x09 & ~new_n69_ & ~x10) | (x03 & ~new_n47_ & x08);
