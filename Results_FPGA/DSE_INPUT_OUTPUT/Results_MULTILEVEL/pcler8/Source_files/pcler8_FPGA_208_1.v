...
module FAU ( 
  ...
  assign z10 = new_n61_ | (x01 & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n61_ = ~x20 & (new_n62_ | x23);
  assign new_n62_ = ~x08 & x09 & ~x10 & x19;
  assign new_n63_ = (x19 | ~x20) & (~new_n59_ | ~x12 | ~x21 | ~x22);
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (x19 ? (new_n66_ | ~x21) : x21) : (x21 & ~x23));
  ...
  assign new_n70_ = ~x20 & (x23 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & x09 & new_n72_ & ~x10);
  ...
  assign z15 = (~new_n80_ & x23) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n80_ = x20 & (~new_n62_ | ~x21 | ~x22 | ~x24 | x25);
  assign new_n81_ = ~x10 & x25 & (~new_n82_ | ~x19 | ~x21 | ~x22);
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n84_ & x23) | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n84_ = x20 & (~new_n62_ | ~new_n85_);
  assign new_n85_ = x21 & x22 & x24 & x25 & ~x26;
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | x18 | ~x19 | ~x21);
