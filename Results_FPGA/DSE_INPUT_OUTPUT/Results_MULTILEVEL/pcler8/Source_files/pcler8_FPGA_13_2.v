...
module FAU ( 
  ...
  assign new_n61_ = x20 ? (~x24 | (~new_n62_ & x19)) : ~x19;
  ...
  assign new_n67_ = (~x22 | (x20 & (~x24 | (x19 & ~new_n68_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x24);
  assign new_n68_ = x14 & x23 & x25 & x26;
  assign z13 = new_n70_ | (x04 & x08) | (~x08 & new_n72_ & x09);
  assign new_n70_ = x20 & (~x24 | (new_n71_ & ~x08 & x09 & ~x10));
  assign new_n71_ = x19 & x21 & x22 & ~x23;
  assign new_n72_ = ~x10 & x23 & (~x19 | ~x20 | ~new_n73_ | ~x21);
  assign new_n73_ = x22 & (~x15 | ~x25 | ~x26);
