...
module FAU ( 
  ...
  assign z00 = (x17 & ~x20) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign z12 = new_n67_ | (x03 & x08) | (~x08 & new_n68_ & x09);
  assign new_n67_ = ~x20 & (x17 | (new_n47_ & ~x10 & x22));
  ...
  assign new_n73_ = ~x17 & ~x20 & x23;
  assign z14 = new_n75_ | (x05 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n75_ = ~x20 & (x17 | (new_n47_ & ~x10 & x24));
  assign new_n76_ = (~x24 | (new_n77_ & x22 & ~new_n78_ & x23)) & (~new_n79_ | ~x22 | ~x23 | x24);
  assign new_n77_ = x19 & x21;
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = x19 & x20 & x21;
  assign z15 = (x06 & x08) | (~x08 & new_n82_ & x09) | (~new_n81_ & x17);
  assign new_n81_ = x20 & (~new_n47_ | x10 | ~x25 | ~x26);
  assign new_n82_ = ~x10 & ((x25 & (~new_n79_ | ~x22 | ~x23 | ~x24)) | (new_n79_ & x22 & x23 & x24 & ~x25));
  assign z16 = new_n84_ | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n84_ = ~x20 & (x17 | (new_n47_ & ~x10 & x26));
