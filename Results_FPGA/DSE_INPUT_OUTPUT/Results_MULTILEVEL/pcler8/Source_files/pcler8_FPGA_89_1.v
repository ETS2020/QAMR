...
module FAU ( 
  ...
  assign new_n47_ = x19 & (~new_n48_ | x08 | ~x09 | x10 | ~x20);
  assign new_n48_ = x21 & x22 & x23 & x24 & x25;
  ...
  assign new_n78_ = ~x19 & (x26 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~new_n50_ & (x08 ? x06 : (new_n80_ & x09))) | (~x08 & new_n81_ & x09);
  assign new_n80_ = ~x10 & x25 & (~new_n60_ | ~x22 | ~x23 | ~x24);
  assign new_n81_ = ~x10 & (x19 ? (new_n82_ | (x17 & x25 & x26)) : (x25 & ~x26));
