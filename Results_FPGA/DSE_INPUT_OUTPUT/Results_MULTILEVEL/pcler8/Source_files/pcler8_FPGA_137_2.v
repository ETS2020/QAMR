...
module FAU ( 
  ...
  assign z10 = z02 | (~x08 & x09 & ~new_n60_ & ~x10);
  assign new_n60_ = x20 ? (x19 & (~new_n58_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = (~x08 & x09 & ~new_n62_ & ~x10) | (x02 & x08 & (~x10 | x20));
  assign new_n62_ = x20 ? (x19 ? (~new_n63_ & x21) : ~x21) : ~x21;
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = new_n67_ | (x03 & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x22 & (~x19 | new_n66_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n66_ = x14 & x23 & x24 & x25 & x26;
  assign new_n67_ = ~x20 & (x10 | (~x08 & x09 & x22));
  assign z13 = z05 | (~x08 & x09 & (new_n71_ | (~new_n69_ & ~x10)));
  assign new_n69_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x19 & x21))) : ~x23;
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign new_n71_ = ~x20 & x22 & x23;
  assign z14 = new_n77_ | (x05 & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (new_n74_ & x22 & ~new_n75_ & x23)) & (~new_n76_ | ~x22 | ~x23 | x24);
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign new_n76_ = x19 & x20 & x21;
  assign new_n77_ = ~x20 & (x10 | (~x08 & x09 & x24));
  assign z15 = new_n83_ | (x06 & x08) | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((new_n76_ & new_n82_) | (x25 & (~new_n80_ | ~new_n81_)));
  assign new_n80_ = x19 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x24 & ~x25 & x22 & x23;
  assign new_n83_ = ~x20 & (x10 | (~x08 & x09 & x25));
  assign z16 = z08 | (~x08 & new_n85_ & x09);
  assign new_n85_ = ~x10 & ((new_n88_ & new_n89_) | (x26 & (~new_n86_ | ~new_n87_)));
  assign new_n86_ = x20 & x21 & ~x18 & x19;
  assign new_n87_ = x22 & x23 & x24 & x25;
  assign new_n88_ = x19 & x20 & x21 & x22;
  assign new_n89_ = x25 & ~x26 & x23 & x24;
endmodule
