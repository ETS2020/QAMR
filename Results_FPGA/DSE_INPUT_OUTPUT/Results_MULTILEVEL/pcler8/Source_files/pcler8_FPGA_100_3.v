...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (~x07 | (x07 & ~x20))) | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & ((~x07 & ((new_n60_ & new_n61_) | ~x19)) | (~x19 & ~x20));
  assign new_n60_ = x11 & x20 & x21 & x22;
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (x07 | ~x20 | ((~new_n61_ | ~new_n64_) & x19)) & (~x19 | x20);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = (new_n66_ & ~x08) | new_n50_ | (x02 & x08);
  assign new_n66_ = x09 & ~x10 & ((x19 & x20 & (new_n67_ | ~x21)) | (x21 & (~x19 | ~x20)));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n71_ | x07)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign z13 = new_n50_ | (x04 & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  ...
  assign new_n76_ = (x07 | (~new_n79_ & ((new_n77_ & new_n78_) | ~x24))) & (x20 | ~x24);
  ...
  assign new_n81_ = ~x07 & ((new_n82_ & new_n85_) | (x25 & (~new_n83_ | ~new_n84_)));
  ...
  assign z16 = (x07 & (x08 | x20)) | (~x08 & new_n88_ & x09);
  assign new_n88_ = ~x10 & ((new_n91_ & new_n92_) | ((~new_n89_ | ~new_n90_) & x26));
  assign new_n89_ = x20 & x21 & ~x18 & x19;
