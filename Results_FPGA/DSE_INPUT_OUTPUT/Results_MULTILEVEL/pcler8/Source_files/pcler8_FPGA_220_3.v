...
module FAU ( 
  ...
  assign new_n76_ = x19 & (x16 | (new_n77_ & new_n60_ & x23 & ~x24));
  assign new_n77_ = ~x08 & x09 & ~x10 & x20;
  assign new_n78_ = x24 & (~x19 | ~x20 | ~new_n66_ | ~x21);
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n80_ | new_n85_));
  assign new_n80_ = ~x16 & ((new_n83_ & new_n84_) | (x25 & (~new_n81_ | ~new_n82_)));
  ...
  assign new_n87_ = ~x16 & (~new_n88_ | ~new_n66_ | ~x24 | ~x25 | x26);
