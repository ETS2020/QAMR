...
module FAU ( 
  ...
  assign z15 = (x03 & (new_n82_ | (x06 & x08))) | (x20 & (x08 ? x06 : new_n83_));
  assign new_n82_ = new_n48_ & ~x10 & ~x20 & x25;
  assign new_n83_ = x09 & ~x10 & ((x25 & (~new_n84_ | ~new_n85_)) | (new_n84_ & new_n86_));
  ...
  assign new_n88_ = ~x20 & (~x03 | (new_n48_ & ~x10 & x26));
