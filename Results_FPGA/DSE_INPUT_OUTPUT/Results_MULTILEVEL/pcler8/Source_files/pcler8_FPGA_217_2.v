...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (x19 ? (new_n64_ | ~x21) : x21)) | (~x04 & ~x20 & x21));
  ...
  assign new_n68_ = ~x20 & (x04 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z14 = new_n76_ | (~x08 & x09 & ~new_n73_ & ~x10) | (x05 & x08);
  assign new_n73_ = (~x24 | (new_n74_ & x19 & x21)) & (~new_n75_ | ~x19 | ~x20 | ~x21);
  assign new_n74_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x22 & x23 & ~x24;
  assign new_n76_ = ~x20 & (x04 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n78_ | (x20 & (x08 ? x06 : (new_n80_ & x09)));
  assign new_n78_ = ~new_n79_ & ~x04;
  assign new_n79_ = (~x06 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x25);
  assign new_n80_ = ~x10 & ((x25 & (~new_n81_ | ~x23 | new_n82_ | ~x24)) | (new_n81_ & x23 & x24 & ~x25));
  ...
  assign new_n86_ = ~x10 & ((x26 & (~new_n87_ | ~new_n88_)) | (new_n81_ & new_n89_));
