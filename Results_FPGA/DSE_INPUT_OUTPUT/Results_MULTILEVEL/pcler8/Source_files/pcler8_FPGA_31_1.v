...
module FAU ( 
  ...
  assign new_n64_ = (~x13 | ~x20 | (x19 & (~new_n62_ | ~new_n61_ | ~x12 | ~x19))) & (~x19 | x20);
  assign z11 = z03 | (new_n66_ & ~x08);
  assign new_n66_ = x09 & ~x10 & ((x19 & x20 & (new_n49_ | ~x21)) | ((~x19 | ~x20) & x21));
  ...
  assign z13 = (x20 & (new_n71_ | ~x13)) | (x04 & x08) | (new_n72_ & ~x08);
  ...
  assign z14 = (~x08 & x09 & ~new_n75_ & ~x10) | (x05 & ~new_n51_ & x08);
  assign new_n75_ = (~x13 | (~new_n77_ & ((new_n48_ & new_n76_) | ~x24))) & (x20 | ~x24);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n79_ | new_n84_));
  assign new_n79_ = x13 & ((new_n80_ & new_n83_) | ((~new_n81_ | ~new_n82_) & x25));
  ...
  assign new_n87_ = x13 & ((new_n90_ & new_n91_) | ((~new_n88_ | ~new_n89_) & x26));
