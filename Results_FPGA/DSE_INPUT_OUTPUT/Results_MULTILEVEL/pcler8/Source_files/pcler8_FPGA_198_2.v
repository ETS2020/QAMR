...
module FAU ( 
  ...
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (~x13 & x19 & ~x20));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = (x13 & (new_n66_ | ~x20)) | (x02 & x08) | (new_n68_ & ~x08);
  assign new_n66_ = new_n67_ & new_n48_ & ~x10 & x19;
  assign new_n67_ = x22 & x23 & x24 & x25 & x26;
  assign new_n68_ = x09 & ~x10 & (x20 ? (x19 ^ x21) : x21);
  ...
  assign new_n86_ = ~x20 & (x13 | (new_n48_ & ~x10 & x26));
