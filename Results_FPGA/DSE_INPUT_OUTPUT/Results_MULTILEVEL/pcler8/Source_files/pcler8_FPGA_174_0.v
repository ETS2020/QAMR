...
module FAU ( 
  ...
  assign new_n60_ = x24 & (~x19 | (new_n48_ & new_n49_ & new_n61_ & x11));
  assign new_n61_ = x20 & x21;
  assign z10 = (x01 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = x19 ? (x20 & (~new_n64_ | ~new_n49_ | ~x23 | ~x24)) : (~x20 | ~x24);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & (x19 ? (x20 ? (new_n67_ | ~x21) : x21) : (x21 & x24));
  ...
  assign new_n74_ = ~x19 & (~x24 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n83_ = ~x19 & (~x24 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n85_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n87_));
  assign new_n85_ = x07 & ~new_n51_ & x08;
  assign new_n86_ = x24 & ((~x19 & x26) | (new_n61_ & x19 & new_n48_ & x25 & ~x26));
  assign new_n87_ = x19 & x26 & (~new_n88_ | ~new_n61_ | x18);
