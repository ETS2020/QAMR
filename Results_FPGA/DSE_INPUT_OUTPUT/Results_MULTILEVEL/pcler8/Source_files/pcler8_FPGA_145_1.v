...
module FAU ( 
  ...
  assign new_n62_ = ~x10 & ((x09 & x21 & (~x19 | (x19 & ~x20))) | (x19 & x20 & (new_n63_ | ~x21)));
  ...
  assign z14 = (x19 & (new_n71_ | ~x09)) | (x05 & x08) | (~x08 & new_n73_ & x09);
  assign new_n71_ = new_n72_ & ~x08 & ~x10 & x20;
  assign new_n72_ = x21 & x22 & x23 & ~x24;
  assign new_n73_ = ~x10 & x24 & (~new_n74_ | ~x19 | ~x20 | ~x21);
  assign new_n74_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x19 & (new_n76_ | ~x09)) | (x06 & x08) | (~x08 & new_n78_ & x09);
  assign new_n76_ = new_n77_ & x20 & x21 & ~x08 & ~x10;
  assign new_n77_ = x22 & x23 & x24 & ~x25;
  assign new_n78_ = ~x10 & x25 & (~new_n79_ | ~x19 | ~x20 | ~x21);
