...
module FAU ( 
  ...
  assign z12 = (~x19 & (~x03 | (new_n70_ & ~x08 & x09))) | (x03 & x08) | (~x08 & new_n68_ & x09);
  ...
  assign new_n74_ = ~x19 & (~x03 | (~x10 & x23 & ~x08 & x09));
  ...
  assign new_n86_ = ~x19 & (~x03 | (~x10 & x25 & ~x08 & x09));
  ...
  assign new_n93_ = ~x19 & (~x03 | (~x10 & x26 & ~x08 & x09));
endmodule
