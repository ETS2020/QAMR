...
module FAU ( 
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (x13 | ~x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x13 & (new_n65_ | ~x20)) | (x02 & x08) | (new_n67_ & ~x08);
  assign new_n65_ = new_n66_ & ~x08 & x09 & ~x10 & x19;
  assign new_n66_ = x22 & x23 & x24 & x25 & x26;
  assign new_n67_ = x09 & ~x10 & (x20 ? (x19 ^ x21) : x21);
  ...
  assign z13 = (~x08 & x09 & ~new_n72_ & ~x10) | new_n47_ | (x04 & x08);
  assign new_n72_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n73_ = x25 & x26 & x15 & x24;
  assign z14 = (~x08 & x09 & ~new_n75_ & ~x10) | (x05 & ~new_n47_ & x08);
  assign new_n75_ = (~x20 | ((~x24 | (new_n76_ & new_n77_)) & (~new_n76_ | ~new_n78_))) & (x13 | x20 | ~x24);
  assign new_n76_ = x19 & x21;
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x20 | ((~x25 | (new_n81_ & new_n82_)) & (~new_n81_ | ~new_n83_))) & (x13 | x20 | ~x25);
