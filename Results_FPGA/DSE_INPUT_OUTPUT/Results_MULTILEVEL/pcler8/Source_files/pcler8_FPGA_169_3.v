...
module FAU ( 
  ...
  assign new_n66_ = ~x10 & x23 & (~new_n67_ | ~x19 | ~x20);
  assign new_n67_ = x21 & x22;
  assign z14 = new_n69_ | (x05 & x08) | (~x08 & x09 & new_n71_ & ~x10);
  assign new_n69_ = x20 & (x26 | (new_n70_ & new_n67_ & x23 & ~x24));
  assign new_n70_ = ~x10 & x19 & ~x08 & x09;
  assign new_n71_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = (~new_n73_ & x20) | (x06 & x08) | (~x08 & new_n74_ & x09);
  assign new_n73_ = ~x26 & (~new_n70_ | ~new_n67_ | ~x23 | ~x24 | x25);
  assign new_n74_ = ~x10 & x25 & (~new_n75_ | ~x22 | ~x23 | ~x24);
  assign new_n75_ = x19 & x20 & x21;
  assign z16 = z08 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = ~x26 & (~new_n75_ | ~x22 | ~x23 | ~x24 | ~x25);
endmodule
