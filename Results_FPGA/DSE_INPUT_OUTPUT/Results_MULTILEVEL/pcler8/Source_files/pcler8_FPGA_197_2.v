...
module FAU ( 
  ...
  assign new_n61_ = (x10 | ~x19 | (x20 & (~new_n59_ | ~new_n58_ | ~x12))) & (x19 | ~x20);
  ...
  assign z14 = new_n75_ | (x05 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x24 | (new_n73_ & x22 & ~new_n74_ & x23)) & (~new_n73_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x16 & x25 & x26;
  assign new_n75_ = ~x19 & (x10 | (~x08 & x09 & x24));
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n79_ & new_n58_ & x20)) & (~new_n78_ | ~new_n80_);
  assign new_n78_ = x19 & x20 & x21;
  assign new_n79_ = x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x22 & x23 & x24 & ~x25;
  assign new_n81_ = ~x19 & (x10 | (~x08 & x09 & x25));
  ...
  assign new_n88_ = ~x19 & (x10 | (~x08 & x09 & x26));
endmodule
