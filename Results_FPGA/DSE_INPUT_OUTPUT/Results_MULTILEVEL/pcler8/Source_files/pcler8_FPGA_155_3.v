...
module FAU ( 
  ...
  assign z00 = x20 & (x04 | (new_n47_ & new_n48_ & new_n49_ & x24));
  ...
  assign new_n60_ = x19 & (~new_n61_ | ~new_n49_ | ~x23 | ~x24);
  assign new_n61_ = x11 & x20 & x21 & x22;
  assign z10 = z02 | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & ((~x04 & x20 & (new_n64_ | ~x19)) | (x19 & ~x20));
  assign new_n64_ = new_n49_ & x23 & x24 & x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((~x04 & x20 & (x19 ? (new_n67_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n67_ = new_n49_ & x24 & new_n48_ & x13;
  assign z12 = (x03 & x08 & (~x04 | (x04 & ~x20))) | (new_n69_ & ~x08);
  assign new_n69_ = x09 & ~new_n70_ & ~x10;
  assign new_n70_ = (x20 | ~x22) & (x04 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & new_n73_ & x09) | (x04 & x08 & ~x20);
  assign new_n73_ = ~x10 & ((~x20 & x23) | (~x04 & ((~x22 & x23) | (x20 & ~new_n74_ & x22))));
  assign new_n74_ = (~x19 | ~x21 | (x23 & (~new_n49_ | ~x15 | ~x24))) & (~x23 | (x19 & x21));
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (x04 | (~new_n78_ & (new_n77_ | ~x24))) & (x20 | ~x24);
  assign new_n77_ = x19 & x21 & x22 & x23 & (~new_n49_ | ~x16);
  ...
  assign new_n81_ = new_n48_ & x24 & (~x17 | ~x26);
  assign new_n82_ = ~x04 & (~new_n83_ | x10 | ~x19 | x08 | ~x09);
  assign new_n83_ = x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (~new_n85_ & x20) | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n85_ = ~x04 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
