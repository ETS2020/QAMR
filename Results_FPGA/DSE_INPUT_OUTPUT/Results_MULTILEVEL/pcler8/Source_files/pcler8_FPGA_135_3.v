...
module FAU ( 
  ...
  assign z11 = (new_n64_ & ~x08) | new_n50_ | (x02 & x08);
  ...
  assign z13 = (x20 & (new_n69_ | x13)) | (x04 & x08) | (new_n71_ & ~x08);
  assign new_n69_ = ~x08 & x09 & ~x10 & new_n70_ & x22 & ~x23;
  ...
  assign new_n74_ = (x13 | (~new_n76_ & ((new_n70_ & new_n75_) | ~x24))) & (x20 | ~x24);
  ...
  assign new_n78_ = ~x13 & (~new_n79_ | x10 | ~x19 | x08 | ~x09);
  ...
  assign new_n83_ = ~x13 & (~new_n84_ | x08 | ~x09 | ~new_n70_ | x10);
  assign new_n84_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n85_ = ~x10 & (~new_n86_ | ~new_n87_) & x26;
