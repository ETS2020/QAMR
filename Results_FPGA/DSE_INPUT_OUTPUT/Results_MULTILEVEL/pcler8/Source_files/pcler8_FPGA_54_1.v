...
module FAU ( 
  ...
  assign new_n62_ = x03 & ~x08 & x09 & ~x10 & x11 & x20;
  ...
  assign z12 = (x20 & (new_n73_ | ~x03)) | (x03 & x08) | (new_n71_ & ~x08);
  assign new_n71_ = x09 & ~x10 & x22 & (~new_n72_ | ~x19 | ~x20);
  assign new_n72_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n73_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  ...
  assign new_n83_ = x03 & ((new_n84_ & new_n87_) | (x25 & (~new_n85_ | ~new_n86_)));
  ...
  assign new_n90_ = x03 & (~new_n91_ | ~new_n60_ | ~x24 | ~x25 | x26);
