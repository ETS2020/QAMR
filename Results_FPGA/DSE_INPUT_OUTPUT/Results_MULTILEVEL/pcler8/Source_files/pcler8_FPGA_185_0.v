...
module FAU ( 
  ...
  assign z00 = (~x20 & ~x22) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign new_n59_ = ~new_n50_ & ((x00 & x08) | (~x10 & ~x19 & ~x08 & x09));
  ...
  assign z12 = new_n69_ | (~x08 & x09 & ~new_n67_ & ~x10) | (x03 & x08);
  assign new_n67_ = (~x22 | (x19 & ~new_n68_ & x21)) & (~x19 | ~x21 | x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x20 & (~x22 | (~x08 & x09 & ~x10));
