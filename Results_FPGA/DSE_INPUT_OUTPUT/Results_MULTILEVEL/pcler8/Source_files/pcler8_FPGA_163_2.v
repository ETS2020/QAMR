...
module FAU ( 
  ...
  assign z11 = new_n65_ | (x02 & x08) | (~x08 & x09 & new_n62_ & ~x10);
  assign new_n62_ = x19 & (x20 ? (~x21 | (new_n64_ & new_n63_ & x13)) : x21);
  assign new_n63_ = x22 & x23;
  assign new_n64_ = x24 & x25 & x26;
  assign new_n65_ = ~x19 & (x10 | (~x08 & x09 & x21));
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (new_n68_ & x21 & (~new_n64_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  assign new_n68_ = x19 & x20;
  assign z13 = (~x08 & x09 & ~new_n70_ & ~x10) | (x10 & ~x19) | (x04 & x08);
  ...
  assign new_n78_ = (~x25 | (new_n79_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n79_ | ~new_n63_ | ~x24 | x25);
