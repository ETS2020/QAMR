...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n58_ & ~x10) | (~x09 & ~x20) | (x00 & x08);
  assign new_n58_ = x19 & (~new_n59_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = (~x08 & x09 & ~new_n61_ & ~x10) | (x01 & x08 & (x09 | x20));
  assign new_n61_ = x20 ? (x19 & (~new_n59_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = (new_n63_ & ~x08) | (x02 & x08) | (~x09 & ~x20);
  ...
  assign z13 = (~x08 & x09 & ~new_n69_ & ~x10) | (~x09 & ~x20) | (x04 & x08);
  ...
  assign new_n78_ = ~x10 & ((x25 & (~new_n73_ | ~new_n48_ | new_n79_ | ~x24)) | (new_n73_ & new_n48_ & x24 & ~x25));
