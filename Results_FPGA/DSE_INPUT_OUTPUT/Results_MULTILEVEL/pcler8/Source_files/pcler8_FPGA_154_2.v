...
module FAU ( 
  ...
  assign new_n73_ = ~x10 & x23 & (~new_n74_ | ~x21 | ~x19 | ~x20);
  assign new_n74_ = x22 & (~x15 | ~x24 | ~x25);
  assign z14 = (x05 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (x20 & (new_n78_ | ~x26))) & (~new_n79_ | ~new_n77_ | x24 | ~x26);
  assign new_n77_ = x22 & x23;
  assign new_n78_ = x19 & x21 & x22 & x23 & (~x16 | ~x25);
  assign new_n79_ = x19 & x20 & x21;
  assign z15 = (x20 & (new_n81_ | ~x26)) | (x06 & x08) | (new_n82_ & ~x08);
  assign new_n81_ = new_n47_ & new_n48_ & x23 & x24 & ~x25;
  assign new_n82_ = x09 & ~x10 & x25 & (~new_n83_ | ~new_n84_);
  assign new_n83_ = ~x17 & x19 & x20;
  assign new_n84_ = x21 & x22 & x23 & x24;
  assign z16 = new_n51_ | (x07 & x08) | (~x08 & x09 & new_n86_ & ~x10);
  assign new_n86_ = x26 & (~new_n61_ | ~x20 | ~x21 | x18 | ~x19);
endmodule
