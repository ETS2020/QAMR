...
module FAU ( 
  ...
  assign new_n63_ = (x13 | ~x20 | (x19 & (~new_n61_ | ~new_n64_))) & (~x19 | x20);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = (~new_n66_ & x20) | (x02 & x08) | (new_n67_ & ~x08);
  assign new_n66_ = ~x13 & (x08 | ~x09 | x10 | ~x19 | x21);
  assign new_n67_ = x09 & ~x10 & x21 & (~x19 | ~x20);
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x13 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x20 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (new_n73_ & ~x08) | (x20 & (new_n72_ | x13));
  ...
  assign new_n87_ = x07 & ~new_n51_ & x08;
  assign new_n88_ = ~x13 & ((new_n91_ & new_n92_) | ((~new_n89_ | ~new_n90_) & x26));
