...
module FAU ( 
  ...
  assign new_n82_ = ~x20 & (x25 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~x08 & x09 & ~new_n84_ & ~x10) | new_n49_ | (x06 & x08);
  assign new_n84_ = (~x25 | (new_n86_ & new_n87_)) & (~new_n81_ | ~new_n85_ | ~x24 | x25);
  assign new_n85_ = x22 & x23;
  assign new_n86_ = x19 & x21 & x22;
  assign new_n87_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x07 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n89_ & ~x10);
  assign new_n89_ = (x25 | ~x26) & (~x20 | ((~new_n86_ | ~new_n90_ | ~x25 | x26) & (new_n91_ | ~x26)));
  assign new_n90_ = x23 & x24;
  assign new_n91_ = x22 & x23 & x24 & ~x18 & x19 & x21;
endmodule
