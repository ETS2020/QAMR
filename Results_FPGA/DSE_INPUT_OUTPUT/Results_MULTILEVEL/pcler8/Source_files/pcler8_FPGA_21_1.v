...
module FAU ( 
  ...
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((x15 & (new_n75_ | (~new_n74_ & x23))) | (~x20 & x23));
  assign new_n74_ = x19 & x21 & x22 & (~x24 | ~x25 | ~x26);
  assign new_n75_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (~x08 & x09 & ~new_n77_ & ~x10) | (x05 & ~new_n50_ & x08);
  assign new_n77_ = (x20 | ~x24) & (~x15 | (~new_n80_ & ((new_n78_ & new_n79_) | ~x24)));
  ...
  assign z16 = (~new_n87_ & x20) | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n87_ = x15 & (~new_n88_ | ~new_n66_ | ~x24 | ~x25 | x26);
  assign new_n88_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n66_ | ~x24 | ~x25);
