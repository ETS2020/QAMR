...
module FAU ( 
  ...
  assign z11 = x08 ? (x02 | ~x20) : (x09 & ~new_n62_ & ~x10);
  ...
  assign z15 = z07 | (x09 & ~x10 & (new_n76_ | (~x20 & x25)));
  assign new_n76_ = ~x08 & ((new_n77_ & new_n80_) | (x25 & (~new_n78_ | ~new_n79_)));
  assign new_n77_ = x19 & x20 & x21;
  assign new_n78_ = x19 & x21 & x22;
  assign new_n79_ = x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (x09 & ~x10 & (new_n82_ | (~x20 & x26)));
  assign new_n82_ = ~x08 & ((new_n85_ & new_n86_) | (x26 & (~new_n83_ | ~new_n84_)));
