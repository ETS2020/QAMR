...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x15 & x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n70_ | ~x15)) | (x03 & x08) | (new_n68_ & ~x08);
  ...
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & new_n72_ & x09);
  assign new_n72_ = ~x10 & ((~x20 & x23) | (x15 & (new_n74_ | (~new_n73_ & x23))));
  assign new_n73_ = x19 & x21 & x22 & (~x24 | ~x25 | ~x26);
  assign new_n74_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (~new_n76_ & x20) | (x05 & x08) | (~x08 & new_n78_ & x09);
  assign new_n76_ = x15 & (~new_n77_ | x10 | ~x19 | x08 | ~x09);
  assign new_n77_ = x21 & x22 & x23 & ~x24;
  assign new_n78_ = ~x10 & (~new_n79_ | ~new_n80_) & x24;
  ...
  assign new_n83_ = x15 & ((new_n79_ & new_n86_) | (x25 & (~new_n84_ | ~new_n85_)));
  assign new_n84_ = x19 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x22 & x23 & x24 & ~x25;
  assign new_n87_ = ~x20 & x25;
  assign z16 = (~new_n89_ & x20) | (x07 & x08) | (~x08 & new_n92_ & x09);
  assign new_n89_ = x15 & (~new_n91_ | ~new_n90_ | ~x24 | ~x25 | x26);
  assign new_n90_ = x22 & x23;
  assign new_n91_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n92_ = ~x10 & x26 & (~new_n93_ | ~new_n90_ | ~x24 | ~x25);
