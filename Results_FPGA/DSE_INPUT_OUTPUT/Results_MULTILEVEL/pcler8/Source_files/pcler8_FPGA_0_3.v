...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n61_, new_n64_,
  ...
  assign new_n64_ = ~x10 & ((~x20 & x21) | (~x12 & x20 & (x19 ? (new_n65_ | ~x21) : x21)));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n69_ | x12)) | (x03 & x08) | (new_n67_ & ~x08);
  ...
  assign new_n71_ = (x20 | ~x23) & (x12 | (~new_n74_ & ((new_n72_ & new_n73_) | ~x23)));
  ...
  assign new_n76_ = ~x12 & (~new_n77_ | ~x23 | x24 | ~x21 | ~x22);
  ...
  assign z15 = (x20 & (new_n82_ | x12)) | (x06 & x08) | (new_n83_ & ~x08);
  assign new_n82_ = new_n77_ & x21 & x22 & x23 & x24 & ~x25;
  assign new_n83_ = x09 & ~x10 & x25 & (~new_n79_ | ~new_n84_);
  assign new_n84_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n86_ & x20) | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n86_ = ~x12 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | ~new_n48_ | ~x24 | ~x25);
