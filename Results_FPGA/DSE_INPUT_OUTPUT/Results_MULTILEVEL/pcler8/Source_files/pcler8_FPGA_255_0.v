...
module FAU ( 
  ...
  assign z10 = new_n61_ | (~new_n49_ & ~new_n63_);
  assign new_n61_ = new_n62_ & ~x08 & x09 & ~x10 & x12 & x19;
  ...
  assign new_n65_ = ~x10 & (x19 ? (x20 ? (x25 & (new_n66_ | ~x21)) : x21) : x21);
  assign new_n66_ = x13 & x22 & x23 & x24 & x26;
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x22 & (new_n69_ | (x21 & (~x19 | ~x20)))) | (x19 & x20 & x21 & ~x22));
  assign new_n69_ = x25 & (~x21 | (x24 & x26 & x14 & x23));
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x21 | ~x22 | ((~x19 | ~x20 | (~new_n72_ & x23)) & (~x23 | (x19 & x20)))) & (~x23 | (x21 & x22));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~x10 & (new_n74_ | new_n76_));
  assign new_n74_ = x24 & ((~new_n75_ & x21) | (x25 & (~x21 | (x16 & x26))));
  assign new_n75_ = x19 & x20 & x22 & x23;
  assign new_n76_ = new_n77_ & x22 & x23 & ~x24;
  assign new_n77_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((x25 & (~new_n77_ | ~new_n80_ | new_n81_ | ~x24)) | (new_n77_ & new_n80_ & x24 & ~x25));
  ...
  assign new_n88_ = ~x21 & (~x25 | (~x08 & x09 & ~x10 & x26));
endmodule
