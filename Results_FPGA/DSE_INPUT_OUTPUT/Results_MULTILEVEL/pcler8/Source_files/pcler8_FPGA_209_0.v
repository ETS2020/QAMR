...
module FAU ( 
  ...
  assign new_n68_ = x20 & ((x22 & (~x19 | new_n69_ | ~x21)) | (x19 & x21 & ~x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign new_n70_ = ~x20 & x22;
  ...
  assign z15 = (x03 & (new_n81_ | (x06 & x08))) | (x20 & (x08 ? x06 : new_n82_));
  assign new_n81_ = new_n47_ & ~x10 & ~x20 & x25;
  ...
  assign new_n87_ = ~x20 & (~x03 | (new_n47_ & ~x10 & x26));
