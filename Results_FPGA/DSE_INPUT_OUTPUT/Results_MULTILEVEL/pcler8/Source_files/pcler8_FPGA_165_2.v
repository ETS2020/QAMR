...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (~x10 | x20)) | (~x08 & x09 & ~new_n66_ & ~x10);
  ...
  assign z14 = (x05 & x08 & (~x10 | x20)) | (~x08 & x09 & ~new_n72_ & ~x10);
  ...
  assign z16 = new_n83_ | (x07 & x08) | (~x08 & new_n78_ & x09);
  ...
  assign new_n83_ = ~x20 & (x10 | (~x08 & x09 & x26));
endmodule
