...
module FAU ( 
  ...
  assign z10 = (~new_n49_ & ~new_n61_) | (new_n62_ & new_n64_ & new_n63_ & x21);
  ...
  assign new_n66_ = (~x19 | ~x20 | (x21 & (~new_n64_ | ~new_n63_ | ~x13))) & (~x21 | (x19 & x20));
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | new_n49_ | (x03 & x08);
  assign new_n68_ = (~x22 | (new_n69_ & x21 & (~new_n64_ | ~x14 | ~x23))) & (~new_n69_ | ~x21 | x22);
  assign new_n69_ = x19 & x20;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x25 | (~new_n72_ & ~new_n73_)) & (~x23 | (x22 & (new_n74_ | ~x22)));
  assign new_n72_ = x19 & x20 & x21 & x22 & ~x23;
  assign new_n73_ = x15 & x23 & x24 & x26;
  assign new_n74_ = x19 & x20 & x21;
  assign z14 = new_n78_ | (x05 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (new_n69_ & new_n77_)) & (~new_n74_ | ~x22 | ~x23 | x24);
  assign new_n77_ = x21 & x22 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = ~x23 & (~x25 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x25 | (new_n74_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n63_ | ~x24 | x25);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n82_ | new_n83_));
  assign new_n82_ = x25 & ((~x23 & x26) | (new_n74_ & x22 & x23 & x24 & ~x26));
  assign new_n83_ = x23 & x26 & (~new_n84_ | ~new_n69_ | x18);
