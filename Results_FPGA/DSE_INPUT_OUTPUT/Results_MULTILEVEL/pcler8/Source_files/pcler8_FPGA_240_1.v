...
module FAU ( 
  ...
  assign new_n67_ = ~x10 & ((x16 & x20 & (x19 ? (new_n68_ | ~x21) : x21)) | (~x20 & x21));
  ...
  assign new_n77_ = (new_n78_ | ~x24) & (~new_n79_ | ~x22 | ~x23 | x24);
  assign new_n78_ = x19 & x21 & x22 & x23 & (~x25 | ~x26);
  assign new_n79_ = x19 & x20 & x21;
  assign z15 = (~new_n83_ & x20) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & x25 & (~new_n82_ | ~new_n79_);
  assign new_n82_ = new_n50_ & x24 & (~x17 | ~x26);
  assign new_n83_ = x16 & (~new_n84_ | x10 | ~x19 | x08 | ~x09);
  assign new_n84_ = x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (~new_n86_ & x20) | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n86_ = x16 & (~new_n49_ | ~new_n50_ | ~x24 | ~x25 | x26);
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | ~new_n50_ | ~x24 | ~x25);
