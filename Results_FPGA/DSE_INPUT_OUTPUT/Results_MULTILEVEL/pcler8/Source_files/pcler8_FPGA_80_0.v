...
module FAU ( 
  ...
  assign new_n71_ = ~x20 & (~x15 | (~x08 & x09 & ~x10 & x22));
  assign z13 = ~new_n76_ | (~x08 & x09 & ~x10 & (new_n73_ | new_n77_));
  ...
  assign new_n76_ = ~new_n49_ & (~x04 | ~x08);
  assign new_n77_ = x23 & (~x20 | ~x22);
  assign z14 = z06 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x20 | ((~x24 | (new_n80_ & new_n81_)) & (~new_n80_ | ~new_n82_))) & (~x15 | x20 | ~x24);
  assign new_n80_ = x19 & x21;
  assign new_n81_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n82_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (~x20 | ((~x25 | (new_n85_ & new_n86_)) & (~new_n85_ | ~new_n87_))) & (~x15 | x20 | ~x25);
  assign new_n85_ = x19 & x21 & x22;
  assign new_n86_ = x23 & x24 & (~x17 | ~x26);
  assign new_n87_ = x23 & x24 & ~x25;
  assign z16 = new_n94_ | (~x08 & new_n89_ & x09) | (x07 & x08);
  ...
  assign new_n94_ = ~x20 & (~x15 | (~x08 & x09 & ~x10 & x26));
endmodule
