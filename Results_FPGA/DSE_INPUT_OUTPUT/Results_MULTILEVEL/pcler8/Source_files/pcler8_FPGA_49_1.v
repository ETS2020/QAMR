...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n49_, new_n58_, new_n59_, new_n61_, new_n63_, new_n65_,
  ...
  assign new_n63_ = (~x19 | (~x20 ^ x21)) & (x19 | ~x21) & (~new_n59_ | ~x13 | ~x20 | ~x22);
  assign z12 = z04 | (~x08 & new_n65_ & x09);
  ...
  assign new_n68_ = (~x19 | ~x22 | ((~x20 | ~x21 | (~new_n69_ & x23)) & (~x23 | (x20 & x21)))) & (x22 | ~x23);
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = (x22 & (new_n71_ | ~x19)) | (x05 & x08) | (new_n73_ & ~x08);
  assign new_n71_ = ~x08 & x09 & ~x10 & new_n72_ & x23 & ~x24;
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x09 & ~x10 & x24 & (~new_n72_ | ~new_n74_);
  assign new_n74_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~new_n76_ & x22) | (x06 & x08) | (~x08 & new_n78_ & x09);
  assign new_n76_ = x19 & (~new_n77_ | ~x21 | ~x23 | ~x24 | x25);
  assign new_n77_ = ~x08 & x09 & ~x10 & x20;
  assign new_n78_ = ~x10 & x25 & (~new_n79_ | ~x20 | ~x21 | ~x22);
  assign new_n79_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x22 & (new_n81_ | ~x19)) | (x07 & x08) | (new_n82_ & ~x08);
  assign new_n81_ = new_n77_ & x21 & x23 & x24 & x25 & ~x26;
  assign new_n82_ = x09 & ~x10 & x26 & (~new_n83_ | ~new_n72_ | x18);
