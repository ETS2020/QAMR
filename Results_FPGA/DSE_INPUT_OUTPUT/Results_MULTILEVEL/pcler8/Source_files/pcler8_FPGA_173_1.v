...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n62_, new_n64_,
    ...
    new_n84_, new_n85_;
  assign z00 = x20 & (new_n47_ | ~x09);
  assign new_n47_ = new_n48_ & new_n49_ & x24 & x25 & x26;
  assign new_n48_ = ~x08 & ~x10 & x19 & x21;
  ...
  assign new_n71_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n72_ = x25 & x26 & x15 & x24;
  assign z14 = (x20 & (new_n74_ | ~x09)) | (x05 & x08) | (~x08 & new_n76_ & x09);
  assign new_n74_ = new_n75_ & ~x08 & ~x10 & x19;
  ...
  assign new_n79_ = x20 & (~x09 | (new_n48_ & new_n49_ & x24 & ~x25));
  assign new_n80_ = x25 & (~new_n81_ | ~x19 | ~x20 | ~x21);
  assign new_n81_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (x20 & (new_n83_ | ~x09)) | (x07 & x08) | (~x08 & new_n84_ & x09);
  assign new_n83_ = new_n48_ & new_n49_ & x24 & x25 & ~x26;
  assign new_n84_ = ~x10 & x26 & (~new_n85_ | ~new_n49_ | ~x24 | ~x25);
