...
module FAU ( 
  ...
  assign new_n61_ = (x19 | (~x20 & ~x21)) & (~x19 | x20) & (~new_n59_ | ~x12 | ~x21 | ~x22);
  assign z11 = new_n49_ | (x02 & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  ...
  assign new_n66_ = x09 & ~x10 & x22 & (~x19 | new_n67_ | ~x21);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign new_n68_ = x20 & (x08 | ~x09 | x10 | ~x19 | x22);
  assign z13 = z05 | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x22 & (x19 ? (x21 & (new_n71_ | ~x23)) : x23)) | (x23 & (~x21 | ~x22)));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((x20 & (new_n75_ | (~new_n74_ & x24))) | (~x21 & x24));
  assign new_n74_ = x19 & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x19 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n77_ & x09);
  assign new_n77_ = ~x10 & ((x20 & (new_n79_ | (~new_n78_ & x25))) | (~x21 & x25));
  assign new_n78_ = x19 & x22 & x23 & x24 & (~x17 | ~x26);
  assign new_n79_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (~new_n81_ & x21) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n81_ = x20 & (~new_n82_ | x08 | ~x09 | x10 | ~x19);
  assign new_n82_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | x18 | ~x19 | ~x21);
