...
module FAU ( 
  ...
  assign z15 = new_n79_ | (x06 & x08) | (~x08 & x09 & new_n82_ & ~x10);
  assign new_n79_ = x20 & (x10 | (new_n81_ & new_n80_ & x24 & ~x25));
  ...
  assign new_n85_ = ~x10 & (~new_n81_ | ~new_n80_ | ~x24 | ~x25 | x26);
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | ~new_n80_ | ~x24 | ~x25);
