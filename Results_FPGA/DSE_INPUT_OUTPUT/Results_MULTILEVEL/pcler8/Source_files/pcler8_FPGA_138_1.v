...
module FAU ( 
  ...
  assign z09 = z01 | (~x08 & ~new_n59_ & ~x10);
  assign new_n59_ = (~x09 | x19) & (~new_n61_ | ~new_n60_ | ~x11 | ~x20);
  ...
  assign new_n71_ = ~x10 & x23 & (~new_n69_ | ~new_n72_);
  assign new_n72_ = x21 & x22 & (~x15 | ~x24 | ~x25 | ~x26);
  ...
  assign new_n80_ = x25 & (~new_n76_ | ~new_n48_ | ~x24 | (x17 & x26));
