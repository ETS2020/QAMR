...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((~x03 & (x19 ? (x20 & (new_n65_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x20 & ((x03 & x08) | (new_n69_ & ~x08 & x09))) | (~x03 & ~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x22 & (~x19 | new_n68_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x10 & x22;
  assign z13 = (x03 & (x20 | (x04 & x08 & ~x20))) | (~x08 & new_n71_ & x09) | (~x03 & x04 & x08);
  assign new_n71_ = ~x10 & ((x23 & (~new_n72_ | ~x21 | new_n73_ | ~x22)) | (new_n72_ & x21 & x22 & ~x23));
  assign new_n72_ = x19 & x20;
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (~x08 & x09 & ~new_n75_ & ~x10) | (x05 & ~new_n50_ & x08);
  assign new_n75_ = (x20 | ~x24) & (x03 | (~new_n78_ & ((new_n76_ & new_n77_) | ~x24)));
  ...
  assign new_n80_ = ~x03 & ((new_n81_ & new_n84_) | (x25 & (~new_n82_ | ~new_n83_)));
  ...
  assign new_n87_ = ~x03 & ((new_n90_ & new_n91_) | ((~new_n88_ | ~new_n89_) & x26));
