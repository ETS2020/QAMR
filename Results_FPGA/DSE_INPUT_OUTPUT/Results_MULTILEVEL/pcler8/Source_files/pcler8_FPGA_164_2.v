...
module FAU ( 
  ...
  assign new_n61_ = x20 ? (~x22 | (x19 & (~new_n63_ | ~new_n62_ | ~x12))) : ~x19;
  ...
  assign new_n73_ = x20 & (~x22 | (new_n74_ & ~x08 & x09 & ~x10));
  assign new_n74_ = x19 & x21 & x23 & ~x24;
  assign new_n75_ = ~x10 & x24 & (~new_n68_ | ~new_n76_ | ~x21);
  assign new_n76_ = x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~new_n78_ & x20) | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n78_ = x22 & (~new_n79_ | ~new_n62_ | ~x24 | x25);
  assign new_n79_ = ~x08 & x09 & ~x10 & x19;
  assign new_n80_ = ~x10 & x25 & (~new_n81_ | ~x19 | ~x20 | ~x21);
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x20 & (new_n83_ | ~x22)) | (x07 & x08) | (new_n84_ & ~x08);
  assign new_n83_ = new_n79_ & new_n62_ & x24 & x25 & ~x26;
