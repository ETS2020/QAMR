...
module FAU ( 
  ...
  assign z10 = (new_n62_ & ~x08) | new_n50_ | (x01 & x08);
  assign new_n62_ = x09 & ~x10 & (x19 ^ x20);
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((~x12 & ((x19 & x20 & (new_n65_ | ~x21)) | (~x20 & x21))) | (~x19 & x21));
  ...
  assign z13 = (x19 & (new_n70_ | x12)) | (x04 & x08) | (new_n72_ & ~x08);
  ...
  assign new_n75_ = (x19 | ~x24) & (x12 | ((~x24 | (new_n71_ & new_n76_)) & (~new_n77_ | ~new_n71_ | ~x19)));
  ...
  assign new_n84_ = ~x12 & (~new_n48_ | ~new_n85_);
