...
module FAU ( 
  ...
  assign new_n65_ = ~x20 & (x26 | (~x08 & x09 & ~x10 & x19));
  assign z11 = z03 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x19 | ((~x20 | x21) & (~new_n61_ | ~new_n60_ | ~x13))) & (~x21 | (x20 & (x19 | ~x20)));
  ...
  assign new_n73_ = (~x22 | ((~x19 | ~x21 | (~new_n74_ & (~x20 | x23))) & (~x20 | ~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  ...
  assign new_n80_ = ~x20 & (x26 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n85_ | (x06 & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x25 | (new_n83_ & new_n84_)) & (~new_n79_ | ~new_n60_ | ~x24 | x25);
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = x23 & x24 & (~x17 | ~x26);
  assign new_n85_ = ~x20 & (x26 | (~x08 & x09 & ~x10 & x25));
  assign z16 = (x07 & ~new_n49_ & x08) | (~x08 & x09 & new_n87_ & ~x10);
