...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n61_, new_n63_,
    ...
    new_n84_;
  assign z00 = x20 & (~x21 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign z09 = (~new_n60_ & (~x20 | x21)) | (new_n61_ & new_n49_ & new_n48_ & x21);
  assign new_n60_ = (~x00 | ~x08) & (x08 | ~x09 | x10 | x19);
  assign new_n61_ = ~x08 & x09 & ~x10 & x11 & x20;
  assign z10 = z02 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = x20 ? (~x21 | (x19 & (~new_n49_ | ~new_n48_ | ~x12))) : ~x19;
  assign z11 = z03 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = x20 ? ((~new_n49_ | ~new_n48_ | ~x13) & (x19 | ~x21)) : ~x21;
  assign z12 = (x03 & ~new_n51_ & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((~x20 & x22) | (x21 & (x19 ? (x20 & (new_n68_ | ~x22)) : x22)));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n51_ & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((~x20 & x23) | (x21 & (x19 ? (~new_n71_ & x20) : x23)));
  assign new_n71_ = x22 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = new_n73_ | (x05 & x08) | (~x08 & new_n75_ & x09);
  assign new_n73_ = x20 & (~x21 | (new_n74_ & ~x08 & x09 & ~x10));
  assign new_n74_ = x19 & x22 & x23 & ~x24;
  assign new_n75_ = ~x10 & x24 & (~new_n76_ | ~x22 | ~x19 | ~x20);
  assign new_n76_ = x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~new_n78_ & x20) | (x06 & x08) | (~x08 & new_n79_ & x09);
  assign new_n78_ = x21 & (~new_n47_ | ~new_n48_ | ~x24 | x25);
  assign new_n79_ = ~x10 & x25 & (~new_n80_ | ~x19 | ~x20 | ~x22);
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n82_ & x20) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n82_ = x21 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
