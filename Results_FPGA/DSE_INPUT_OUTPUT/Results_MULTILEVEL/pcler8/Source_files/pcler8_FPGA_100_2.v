...
module FAU ( 
  ...
  assign z11 = (new_n65_ & ~x08) | new_n49_ | (x02 & x08);
  ...
  assign new_n70_ = ~x20 & (x07 | (~x10 & x22 & ~x08 & x09));
  ...
  assign new_n80_ = (~x20 | ((~x25 | (new_n81_ & new_n82_)) & (~new_n81_ | ~new_n83_))) & (x07 | x20 | ~x25);
  assign new_n81_ = x19 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x23 & x24 & ~x25;
  assign z16 = (x07 & (x08 | ~x20)) | (~x08 & new_n85_ & x09);
