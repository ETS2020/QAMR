...
module FAU ( 
  ...
  assign z00 = x20 & (~x18 | (new_n47_ & new_n49_ & new_n50_));
  ...
  assign new_n64_ = ~x10 & ((x18 & x20 & (~x19 | (new_n65_ & new_n66_))) | (x19 & ~x20));
  assign new_n65_ = x12 & x21 & x22;
  assign new_n66_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x19 | ~x20 | (x21 & (~new_n50_ | ~new_n49_ | ~x13))) & (~x21 | (x19 & x20));
  assign z12 = (x20 & (new_n72_ | ~x18)) | (new_n70_ & ~x08) | (x03 & x08);
  ...
  assign new_n74_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n52_ & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x18 | (~new_n79_ & ((new_n48_ & new_n78_) | ~x24))) & (x20 | ~x24);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = new_n81_ | (~x08 & x09 & ~x10 & (new_n82_ | new_n87_));
  assign new_n81_ = x06 & ~new_n52_ & x08;
  assign new_n82_ = x18 & ((new_n83_ & new_n86_) | ((~new_n84_ | ~new_n85_) & x25));
  ...
  assign new_n89_ = ~x26 & (~new_n83_ | ~new_n49_ | ~x24 | ~x25);
endmodule
