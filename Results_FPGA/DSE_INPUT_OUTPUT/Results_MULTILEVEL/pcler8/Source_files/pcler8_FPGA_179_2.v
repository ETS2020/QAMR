...
module FAU ( 
  ...
  assign new_n61_ = (~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (x11 | ~x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (~x11 & ~x20 & x21));
  ...
  assign new_n69_ = ~x20 & (x11 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | new_n49_ | (x04 & x08);
  ...
  assign new_n74_ = (~x20 | ((~x24 | (new_n75_ & new_n76_)) & (~new_n75_ | ~new_n77_))) & (x11 | x20 | ~x24);
  assign new_n75_ = x19 & x21;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x20 | ((~x25 | (new_n80_ & new_n81_)) & (~new_n80_ | ~new_n82_))) & (x11 | x20 | ~x25);
  ...
  assign new_n89_ = ~x20 & (x11 | (~x08 & x09 & ~x10 & x26));
endmodule
