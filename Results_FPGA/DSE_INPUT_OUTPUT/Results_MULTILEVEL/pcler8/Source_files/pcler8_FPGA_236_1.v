...
module FAU ( 
  ...
  assign new_n60_ = x02 & ~x08 & x09 & ~x10 & x11 & x20;
  ...
  assign new_n67_ = x20 ? (x19 ? (x21 & (~new_n62_ | ~new_n61_ | ~x13)) : ~x21) : ~x21;
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x20 | ~x22) & (~x02 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n70_ = new_n62_ & x14 & x23;
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & new_n72_ & x09);
  assign new_n72_ = ~x10 & ((~x20 & x23) | (x02 & ((~x22 & x23) | (x20 & ~new_n73_ & x22))));
  ...
  assign new_n76_ = (x20 | ~x24) & (~x02 | (~new_n79_ & ((new_n77_ & new_n78_) | ~x24)));
  assign new_n77_ = x19 & x21;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (~new_n83_ & x20) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & x25 & (~new_n82_ | ~x19 | ~x20 | ~x21);
  assign new_n82_ = new_n61_ & x24 & (~x17 | ~x26);
  assign new_n83_ = x02 & (~new_n84_ | x08 | ~x09 | x10 | ~x19);
  assign new_n84_ = x21 & x22 & x23 & x24 & ~x25;
  assign z16 = new_n90_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n91_));
  assign new_n86_ = x02 & (new_n87_ | new_n88_);
  assign new_n87_ = x26 & (~new_n61_ | ~x24 | ~x25 | ~new_n77_ | x18);
  assign new_n88_ = new_n89_ & x19 & x20 & x21 & x22;
  assign new_n89_ = x23 & x24 & x25 & ~x26;
  assign new_n90_ = x07 & ~new_n50_ & x08;
