...
module FAU ( 
  ...
  assign new_n62_ = ~x20 & (x23 | (~x08 & x09 & ~x10 & x19));
  assign z11 = z03 | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & ((x19 & (new_n65_ | (x20 & ~x21))) | (x21 & (~x20 | (~x19 & x20))));
  ...
  assign new_n69_ = ~x20 & (x23 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z14 = (~x08 & x09 & ~new_n74_ & ~x10) | (x05 & ~new_n49_ & x08);
  assign new_n74_ = (x23 | ~x24) & (~x20 | ((~x24 | (new_n75_ & ~new_n76_ & x22)) & (~new_n75_ | ~x22 | ~x23 | x24)));
  assign new_n75_ = x19 & x21;
  assign new_n76_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((~x23 & x25) | (x20 & (new_n80_ | (~new_n79_ & x25))));
  assign new_n79_ = x19 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n80_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (x23 & (new_n82_ | ~x20)) | (x07 & x08) | (new_n84_ & ~x08);
  assign new_n82_ = new_n83_ & ~x10 & x19 & ~x08 & x09;
  assign new_n83_ = x21 & x22 & x24 & x25 & ~x26;
  assign new_n84_ = x09 & ~x10 & x26 & (~new_n85_ | ~new_n75_ | x18);
