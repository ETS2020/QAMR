...
module FAU ( 
  ...
  assign new_n64_ = x20 ? ((~x19 | ((~new_n65_ | ~new_n66_) & x21)) & (~x21 | (x19 & (~new_n66_ | ~new_n65_ | ~x12)))) : ~x21;
  ...
  assign z13 = (x20 & (new_n71_ | ~x13)) | (x04 & x08) | (new_n73_ & ~x08);
  ...
  assign z14 = (~x08 & x09 & ~new_n76_ & ~x10) | (x05 & ~new_n50_ & x08);
  assign new_n76_ = (x20 | ~x24) & (~x13 | (~new_n78_ & ((new_n72_ & new_n77_) | ~x24)));
  ...
  assign new_n80_ = x13 & (~new_n81_ | x10 | ~x19 | x08 | ~x09);
  ...
  assign new_n85_ = x13 & (~new_n86_ | ~new_n65_ | ~x24 | ~x25 | x26);
  assign new_n86_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | ~new_n65_ | ~x24 | ~x25);
