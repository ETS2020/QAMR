...
module FAU ( 
  ...
  assign z10 = x08 ? x01 : (~x20 | (new_n60_ & x09));
  ...
  assign z12 = x08 ? x03 : (~x20 | (x09 & ~new_n65_ & ~x10));
  assign new_n65_ = (~x22 | (x19 & x21 & (~new_n63_ | ~x14 | ~x23))) & (~x19 | ~x21 | x22);
  assign z13 = x08 ? x04 : (~x20 | (new_n67_ & x09));
  assign new_n67_ = ~x10 & (x22 ? ((x19 & x21 & (new_n68_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n68_ = x15 & x24 & x25 & x26;
  assign z14 = x08 ? x05 : (~x20 | (x09 & ~new_n70_ & ~x10));
