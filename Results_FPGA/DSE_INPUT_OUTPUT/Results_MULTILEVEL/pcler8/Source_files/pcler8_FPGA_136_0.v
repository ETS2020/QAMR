...
module FAU ( 
  ...
  assign z12 = (~new_n49_ & (x08 ? x03 : (new_n69_ & x09))) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((new_n68_ & x22) | (x19 & x20 & x21 & ~x22));
  assign new_n68_ = x23 & (~x20 | (x25 & x26 & x14 & x24));
  assign new_n69_ = ~x10 & x22 & (~x19 | ~x21);
  assign z13 = new_n73_ | (x04 & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x23 | ((~x22 | (x19 & x21)) & ~new_n72_ & x22)) & (~x19 | ~x21 | ~x22 | x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = ~x20 & (~x23 | (~x08 & x09 & ~x10));
  ...
  assign new_n78_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (new_n81_ | ~x23) & (~x20 | ~x25 | (new_n82_ & new_n83_ & x23));
  assign new_n81_ = (x20 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x24 | x25);
  assign new_n82_ = x19 & x21 & x22;
  assign new_n83_ = x24 & (~x17 | ~x26);
  assign z16 = new_n85_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n88_));
  assign new_n85_ = x07 & ~new_n49_ & x08;
  assign new_n86_ = x23 & ((~x20 & x26) | (new_n87_ & x19 & x20 & x21));
  assign new_n87_ = x22 & x24 & x25 & ~x26;
  assign new_n88_ = x20 & x26 & (~new_n89_ | x18 | ~x19 | ~x21);
