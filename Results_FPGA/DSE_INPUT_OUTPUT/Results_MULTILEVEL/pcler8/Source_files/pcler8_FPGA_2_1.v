...
module FAU ( 
  ...
  assign z00 = x20 & (~x09 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign z10 = (~x08 & ~new_n63_ & ~x10) | (x01 & x08) | (~x09 & x20);
  assign new_n63_ = (~x20 | (x19 & (~new_n61_ | ~new_n60_ | ~x12))) & (~x09 | ~x19 | x20);
  assign z11 = z03 | (new_n65_ & ~x08);
  assign new_n65_ = ~x10 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (x09 & ~x20 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & x08 & (x09 | ~x20));
  assign new_n68_ = (~x22 | (new_n69_ & x21 & (~new_n49_ | ~x14 | ~x23))) & (~new_n69_ | ~x21 | x22);
  ...
  assign new_n75_ = ~x08 & ~x10 & x19 & new_n60_ & x23 & ~x24;
  assign new_n76_ = ~x10 & x24 & (~new_n77_ | ~x19 | ~x20 | ~x21);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = new_n79_ | (x06 & x08) | (~x08 & x09 & new_n80_ & ~x10);
  assign new_n79_ = x20 & (~x09 | (new_n47_ & new_n48_ & x24 & ~x25));
  assign new_n80_ = x25 & (~new_n81_ | ~x19 | ~x20 | ~x21);
  assign new_n81_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (x07 & x08 & (x09 | ~x20)) | (~x08 & new_n83_ & x09);
  assign new_n83_ = ~x10 & ((new_n86_ & new_n87_) | ((~new_n84_ | ~new_n85_) & x26));
  assign new_n84_ = x20 & x21 & ~x18 & x19;
  assign new_n85_ = x24 & x25 & x22 & x23;
  assign new_n86_ = x21 & x22 & x19 & x20;
