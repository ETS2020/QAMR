...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n60_ & ~x10) | new_n47_ | (x00 & x08);
  assign new_n60_ = x19 & (~new_n61_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = (~x08 & x09 & ~new_n63_ & ~x10) | (x01 & ~new_n47_ & x08);
  assign new_n63_ = (~x20 | (x19 & (~new_n61_ | ~new_n64_))) & (~x19 | x20 | ~x26);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = x20 ? (x19 ? (x21 & (~new_n50_ | ~new_n49_ | ~x13)) : ~x21) : ~x21;
  assign z12 = new_n70_ | (x03 & x08) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x22 & (~x19 | new_n69_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign new_n70_ = ~x20 & (~x26 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x19 & x21)))) & ((x20 & x22) | ~x23);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n47_ & x08) | (new_n75_ & ~x08);
  assign new_n75_ = x09 & ~x10 & (new_n78_ | ((new_n76_ | new_n77_) & x24));
  assign new_n76_ = x26 & (~x20 | (x16 & x25));
  assign new_n77_ = x20 & (~x22 | ~x23 | ~x19 | ~x21);
  assign new_n78_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = new_n85_ | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((new_n81_ & new_n84_) | ((~new_n82_ | ~new_n83_) & x25));
  assign new_n81_ = x19 & x20 & x21;
  assign new_n82_ = x19 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign new_n85_ = ~x20 & (~x26 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n91_ | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n87_ = ~x10 & ((new_n82_ & new_n90_) | ((~new_n88_ | ~new_n89_) & x26));
  assign new_n88_ = ~x18 & x19 & x21;
  assign new_n89_ = x22 & x23 & x24 & x25;
  assign new_n90_ = x23 & x24 & x25 & ~x26;
  assign new_n91_ = ~x20 & (~x26 | (~x08 & x09 & ~x10));
endmodule
