...
module FAU ( 
  ...
  assign new_n80_ = ~x18 & (new_n81_ | (new_n83_ & x19 & x20 & x21));
  assign new_n81_ = x25 & (~new_n82_ | ~x23 | ~x24 | (x17 & x26));
  assign new_n82_ = x19 & x21 & x22;
  assign new_n83_ = new_n48_ & x24 & ~x25;
  assign new_n84_ = ~x20 & x25;
  assign z16 = z08 | (new_n86_ & ~x08);
  assign new_n86_ = x09 & ~x10 & ((~x20 & x26) | (~new_n87_ & ~x18));
  assign new_n87_ = (~x26 | (new_n82_ & x23 & x24 & x25)) & (~new_n88_ | ~x23 | ~x24 | ~x25 | x26);
