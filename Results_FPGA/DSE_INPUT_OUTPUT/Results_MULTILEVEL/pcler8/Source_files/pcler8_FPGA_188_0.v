...
module FAU ( 
  ...
  assign z00 = (~x20 & ~x21) | (new_n47_ & new_n49_ & new_n48_ & x21);
  ...
  assign z11 = new_n66_ | (~x08 & x09 & ~new_n65_ & ~x10) | (x02 & x08);
  assign new_n65_ = x21 ? ((x19 | ~x20) & (~new_n49_ | ~new_n48_ | ~x13)) : ~x19;
  assign new_n66_ = ~x20 & (~x21 | (~x08 & x09 & ~x10));
  assign z12 = z04 | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x20 & ((~x21 & x22) | (x19 & x21 & ~x22))) | (x21 & x22 & (~x19 | new_n69_ | ~x20)));
  ...
  assign new_n78_ = ~x20 & (~x21 | (~x08 & x09 & ~x10 & x24));
  ...
  assign new_n84_ = ~x20 & (~x21 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n86_ | (~x08 & x09 & ~x10 & (new_n87_ | new_n89_));
  assign new_n86_ = x07 & ~new_n51_ & x08;
  assign new_n87_ = x21 & ((~x20 & x26) | (new_n88_ & x19 & x20 & x22));
  assign new_n88_ = x23 & x24 & x25 & ~x26;
  assign new_n89_ = x20 & x26 & (~new_n90_ | ~new_n75_ | x18);
