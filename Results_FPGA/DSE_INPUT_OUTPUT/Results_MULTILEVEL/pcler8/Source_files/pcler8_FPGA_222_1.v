...
module FAU ( 
  ...
  assign z09 = z01 | (~x08 & ~new_n57_ & ~x10);
  ...
  assign z13 = (x20 & (new_n72_ | ~x09)) | (x04 & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & x23 & (~new_n68_ | ~new_n71_);
  assign new_n71_ = x21 & x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n72_ = ~x08 & ~x10 & x19 & x21 & x22 & ~x23;
  assign z14 = (x05 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n74_ & ~x10);
  ...
  assign new_n78_ = x20 & (~x09 | (new_n79_ & new_n64_ & x24 & ~x25));
  assign new_n79_ = x19 & x21 & ~x08 & ~x10;
  assign new_n80_ = x25 & (~new_n75_ | ~new_n64_ | ~x24 | (x17 & x26));
  assign z16 = (x07 & x08 & (x09 | ~x20)) | (~x08 & new_n82_ & x09);
