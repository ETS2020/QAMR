...
module FAU ( 
  ...
  assign new_n68_ = (~x22 | ((~x14 | (~new_n60_ & x20)) & (~x20 | (x19 & x21)))) & (~x19 | ~x20 | ~x21 | x22);
  ...
  assign z14 = new_n77_ | (~x08 & x09 & ~new_n73_ & ~x10) | (x05 & x08);
  ...
  assign new_n77_ = ~x20 & (~x14 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n83_ | (x06 & x08) | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((new_n76_ & new_n82_) | ((~new_n80_ | ~new_n81_) & x25));
  assign new_n80_ = x19 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x22 & x23 & x24 & ~x25;
  assign new_n83_ = ~x20 & (~x14 | (~x08 & x09 & ~x10 & x25));
