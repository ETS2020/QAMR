...
module FAU ( 
  ...
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (~x18 & x19 & ~x20));
  ...
  assign new_n68_ = ~x20 & (x18 | (new_n47_ & ~x10 & x22));
  ...
  assign new_n75_ = (~x20 | ((~x24 | (new_n76_ & new_n77_)) & (~new_n76_ | ~new_n78_))) & (x18 | x20 | ~x24);
  ...
  assign new_n80_ = (~x20 | ((~x25 | (new_n81_ & new_n82_)) & (~new_n81_ | ~new_n83_))) & (x18 | x20 | ~x25);
  assign new_n81_ = x19 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x23 & x24 & ~x25;
  assign z16 = new_n85_ | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n85_ = x18 & (~x20 | (new_n47_ & ~x10 & x26));
