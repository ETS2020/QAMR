...
module FAU ( 
  ...
  assign new_n78_ = ~x10 & ((~x19 & x25) | (x21 & (new_n80_ | (~new_n79_ & x25))));
  assign new_n79_ = x20 & x22 & x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x19 & x20 & x22 & x23 & x24 & ~x25;
  assign z16 = (~new_n82_ & x19) | (x07 & x08) | (~x08 & new_n84_ & x09);
  assign new_n82_ = x21 & (~new_n83_ | x08 | ~x09 | x10 | ~x20);
