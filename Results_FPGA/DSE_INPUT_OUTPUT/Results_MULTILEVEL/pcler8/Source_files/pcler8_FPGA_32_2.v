...
module FAU ( 
  ...
  assign new_n62_ = (x10 | ~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (~x19 | x20);
  ...
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & x08 & (~x10 | x20));
  ...
  assign new_n74_ = (~x24 | (new_n76_ & x22 & ~new_n77_ & x23)) & (~new_n75_ | ~x22 | ~x23 | x24);
  assign new_n75_ = x19 & x20 & x21;
  assign new_n76_ = x19 & x21;
  assign new_n77_ = x16 & x25 & x26;
  assign new_n78_ = ~x20 & (x10 | (~x08 & x09 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x25 | (new_n75_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n48_ | ~x24 | x25);
