...
module FAU ( 
  ...
  assign z09 = (~x08 & new_n59_ & x09) | new_n50_ | (x00 & x08);
  ...
  assign z11 = new_n50_ | (x02 & x08) | (new_n65_ & ~x08);
  assign new_n65_ = x09 & ~x10 & ((x19 & (new_n66_ | (x20 & ~x21))) | (x21 & (~x20 | (~x19 & x20))));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = x20 ? ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x21 | x22)) : (~x22 | x25);
  ...
  assign new_n79_ = ~x20 & (x25 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n50_ | (x06 & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~new_n78_ | ~new_n84_) & (~x25 | (new_n82_ & new_n83_));
  ...
  assign new_n86_ = (x25 | ~x26) & (~x20 | ((new_n88_ | ~x26) & (~new_n82_ | ~new_n87_ | ~x25 | x26)));
  assign new_n87_ = x23 & x24;
  assign new_n88_ = x22 & x23 & x24 & ~x18 & x19 & x21;
endmodule
