...
module FAU ( 
  ...
  assign z13 = (x20 & (new_n73_ | x10)) | (x04 & x08) | (new_n71_ & ~x08);
  assign new_n71_ = x09 & ~x10 & x23 & (~new_n69_ | ~new_n72_);
  assign new_n72_ = x21 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n73_ = ~x08 & x09 & x19 & x21 & x22 & ~x23;
  ...
  assign new_n81_ = ~x10 & ((new_n84_ & new_n85_) | ((~new_n82_ | ~new_n83_) & x26));
