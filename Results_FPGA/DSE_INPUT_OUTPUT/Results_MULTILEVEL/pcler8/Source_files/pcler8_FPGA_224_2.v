...
module FAU ( 
  ...
  assign z09 = (new_n57_ & new_n58_) | (x00 & x08 & (~x09 | x19));
  assign new_n57_ = ~x08 & x09 & ~x10 & x11 & x19 & x20;
  assign new_n58_ = x24 & x25 & x26 & x21 & x22 & x23;
  ...
  assign new_n66_ = (~x22 | (x20 & ~new_n67_ & x21)) & (~x20 | ~x21 | x22);
  ...
  assign new_n72_ = (~x24 | (x20 & x21 & x22 & ~new_n73_ & x23)) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
