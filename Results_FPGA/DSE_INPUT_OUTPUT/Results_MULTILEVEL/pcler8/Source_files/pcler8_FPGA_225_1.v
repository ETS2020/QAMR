...
module FAU ( 
  ...
  assign new_n62_ = (~x14 | ~x19 | ((~new_n60_ | ~new_n63_) & x20)) & (x19 | ~x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x14 & x19 & (x20 ? (new_n66_ | ~x21) : x21)) | (~x19 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x19 & (new_n70_ | ~x14)) | (x03 & x08) | (new_n68_ & ~x08);
  assign new_n68_ = x09 & ~x10 & x22 & (~new_n69_ | ~x19 | ~x20);
  assign new_n69_ = x21 & (~x23 | ~x24 | ~x25 | ~x26);
  ...
  assign new_n77_ = (x19 | ~x24) & (~x14 | (((new_n73_ & new_n78_) | ~x24) & (~new_n79_ | ~new_n73_ | ~x19)));
  ...
  assign new_n88_ = x14 & (~new_n89_ | x08 | ~x09 | ~new_n73_ | x10);
  assign new_n89_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n90_ = ~x10 & x26 & (~new_n91_ | ~new_n73_ | x18 | ~x19);
