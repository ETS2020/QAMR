...
module FAU ( 
  ...
  assign new_n69_ = ~x20 & (x05 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z15 = (~x05 & (new_n82_ | (x06 & x08))) | (x20 & (x08 ? x06 : new_n78_));
  assign new_n78_ = x09 & ~x10 & ((x25 & (~new_n79_ | ~new_n80_)) | (new_n79_ & new_n81_));
  assign new_n79_ = x19 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x23 & x24 & ~x25;
  assign new_n82_ = ~x08 & x09 & ~x10 & ~x20 & x25;
  ...
  assign new_n89_ = ~x20 & (x05 | (~x08 & x09 & ~x10 & x26));
endmodule
