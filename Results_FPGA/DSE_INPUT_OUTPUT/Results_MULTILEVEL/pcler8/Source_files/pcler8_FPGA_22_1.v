...
module FAU ( 
  ...
  assign new_n62_ = x19 & (~x20 | (new_n60_ & new_n59_ & x12));
  assign z11 = z03 | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = x20 ? (x21 & (~new_n65_ | ~x13 | ~x22 | ~x23)) : ~x21;
  assign new_n65_ = x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n67_ & ~x10) | new_n49_ | (x03 & x08);
  assign new_n67_ = (~x20 | ~x21 | (x22 & (~new_n65_ | ~x14 | ~x23))) & (~x22 | (x20 & x21));
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & ((x19 & ((x20 & ~new_n70_ & x21) | (~x21 & x23))) | (~x20 & x23));
  assign new_n70_ = x22 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = (x20 & (new_n72_ | ~x19)) | (x05 & x08) | (new_n73_ & ~x08);
  assign new_n72_ = ~x08 & x09 & ~x10 & new_n59_ & x23 & ~x24;
  assign new_n73_ = x09 & ~x10 & x24 & (~new_n74_ | ~x20 | ~x21);
  assign new_n74_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & ((~x20 & x25) | (x19 & (new_n78_ | (~new_n77_ & x25))));
  assign new_n77_ = x21 & x22 & x23 & x24 & (~x17 | ~x26);
  assign new_n78_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (~x08 & x09 & ~new_n80_ & ~x10) | (x07 & ~new_n49_ & x08);
  assign new_n80_ = (x20 | ~x26) & (~x19 | ((new_n81_ | ~x26) & (~new_n82_ | ~new_n59_ | ~x20)));
  assign new_n81_ = ~x18 & x21 & x22 & x23 & x24 & x25;
