...
module FAU ( 
  ...
  assign z10 = (~x08 & ~new_n62_ & x09) | (x10 & x20) | (x01 & x08);
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n59_ | ~x12))) & (x10 | ~x19 | x20);
  assign z11 = (new_n64_ & ~x08) | (x10 & x20) | (x02 & x08);
  assign new_n64_ = x09 & ((x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (~x10 & ~x20 & x21));
  ...
  assign z14 = ((new_n75_ | x10) & x20) | (x05 & x08) | (new_n76_ & ~x08);
  assign new_n75_ = ~x08 & x09 & x19 & new_n59_ & x23 & ~x24;
  assign new_n76_ = x09 & ~x10 & x24 & (~new_n77_ | ~new_n78_);
