...
module FAU ( 
  ...
  assign z00 = x20 & (~x18 | (new_n47_ & new_n50_ & new_n51_));
  ...
  assign z01 = x00 & ~new_n53_ & x08;
  assign new_n53_ = ~x18 & x20;
  assign z02 = new_n53_ | (x01 & x08);
  assign z03 = new_n53_ | (x02 & x08);
  assign z04 = x03 & ~new_n53_ & x08;
  assign z05 = x04 & ~new_n53_ & x08;
  assign z06 = new_n53_ | (x05 & x08);
  assign z07 = x06 & ~new_n53_ & x08;
  ...
  assign new_n63_ = ~x08 & x09 & ~x10 & x11 & x18 & x20;
  ...
  assign new_n68_ = x20 ? (x19 ? (x21 & (~new_n51_ | ~new_n50_ | ~x13)) : ~x21) : ~x21;
  assign z12 = (x20 & (new_n72_ | ~x18)) | (x03 & x08) | (new_n70_ & ~x08);
  ...
  assign new_n74_ = (x20 | ~x23) & (~x18 | (~new_n76_ & ((new_n49_ & new_n75_) | ~x23)));
  assign new_n75_ = x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (x05 & ~new_n53_ & x08) | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (x20 | ~x24) & (~x18 | (~new_n80_ & ((new_n49_ & new_n79_) | ~x24)));
  ...
  assign new_n82_ = x20 & (~x18 | (new_n83_ & new_n48_ & ~x10 & x19));
  ...
  assign new_n87_ = ~new_n53_ & ((x07 & x08) | (~x08 & x09 & ~x10 & x26));
