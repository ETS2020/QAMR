...
module FAU ( 
  ...
  assign new_n63_ = (~x16 | ~x19 | (x20 & (~new_n61_ | ~new_n60_ | ~x12))) & (x19 | ~x20);
  ...
  assign z12 = (x19 & (new_n70_ | ~x16)) | (x03 & x08) | (new_n68_ & ~x08);
  ...
  assign new_n72_ = (~x19 | ~x22 | ((~x20 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x20 & x21)))) & (~x23 | (x19 & x22));
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = new_n75_ | (x05 & x08) | (~x08 & x09 & new_n77_ & ~x10);
  assign new_n75_ = x19 & (~x16 | (new_n76_ & new_n60_ & x23 & ~x24));
  assign new_n76_ = ~x08 & x09 & ~x10 & x20;
  assign new_n77_ = x24 & (~new_n78_ | ~x22 | ~x23 | (x25 & x26));
  assign new_n78_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n80_ | new_n84_));
  assign new_n80_ = x16 & ((new_n78_ & new_n83_) | (x25 & (~new_n81_ | ~new_n82_)));
  assign new_n81_ = x20 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign new_n84_ = ~x19 & x25;
  assign z16 = (~new_n86_ & x19) | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n86_ = x16 & (~new_n88_ | x08 | ~x09 | ~new_n87_ | x10);
  assign new_n87_ = x20 & x21;
  assign new_n88_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n87_ | x18 | ~x19);
