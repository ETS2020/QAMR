...
module FAU ( 
  ...
  assign new_n60_ = ~x08 & x09 & ~x10 & x11 & x18 & x20;
  ...
  assign z12 = (~x08 & x09 & ~new_n69_ & ~x10) | (x03 & ~new_n50_ & x08);
  assign new_n69_ = (x20 | ~x22) & (~x18 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  ...
  assign new_n76_ = x20 & (~x18 | (new_n77_ & new_n48_ & ~x10 & x19));
  assign new_n77_ = x21 & x22 & x23 & ~x24;
  assign new_n78_ = x24 & (~x19 | ~x20 | ~x21 | ~new_n79_ | ~x22);
  assign new_n79_ = x23 & (~x16 | ~x25 | ~x26);
  ...
  assign z16 = new_n86_ | (new_n87_ & new_n48_ & ~x10 & x18 & x19);
  assign new_n86_ = ~new_n50_ & ((x07 & x08) | (~x08 & x09 & ~x10 & x26));
  assign new_n87_ = x23 & x24 & x25 & x20 & x21 & x22;
endmodule
