...
module FAU ( 
  ...
  assign z00 = (~x09 & x18) | (new_n47_ & ~x08 & x09 & new_n50_ & ~x10);
  ...
  assign z02 = (~x09 & x18) | (x01 & x08);
  assign z03 = (~x09 & x18) | (x02 & x08);
  assign z04 = x03 & x08 & (x09 | ~x18);
  assign z05 = (~x09 & x18) | (x04 & x08);
  assign z06 = x05 & x08 & (x09 | ~x18);
  assign z07 = (~x09 & x18) | (x06 & x08);
  assign z08 = (~x09 & x18) | (x07 & x08);
  assign z09 = (~x08 & x09 & ~new_n60_ & ~x10) | (~x09 & x18) | (x00 & x08);
