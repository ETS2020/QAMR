...
module FAU ( 
  ...
  assign z00 = (~x19 & ~x20) | (new_n47_ & ~x08 & x09 & ~x10 & x19 & x20);
  ...
  assign new_n58_ = x20 & (~x19 | (new_n59_ & x11 & x21 & x22));
  ...
  assign new_n63_ = (~x21 | (~x19 ^ x20)) & (~x19 | ~x20 | (~new_n64_ & x21));
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (x20 ? (x21 & ~x22) : x22)) | (x20 & x22 & (~x19 | new_n67_ | ~x21)));
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n71_ | (x04 & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x19 | ~x20 | ~x22 | (x21 ? (~new_n70_ & x23) : ~x23)) & (~x23 | (x20 & x22));
  assign new_n70_ = x25 & x26 & x15 & x24;
  assign new_n71_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n76_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x24));
  ...
  assign new_n83_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n85_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n88_));
  assign new_n85_ = x07 & ~new_n49_ & x08;
  assign new_n86_ = x20 & ((~x19 & x26) | (new_n87_ & x19 & x21 & x22));
  assign new_n87_ = x23 & x24 & x25 & ~x26;
  assign new_n88_ = x19 & x26 & (~new_n89_ | ~new_n74_ | x18);
