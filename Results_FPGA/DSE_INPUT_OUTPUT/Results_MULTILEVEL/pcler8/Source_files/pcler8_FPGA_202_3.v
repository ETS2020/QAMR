...
module FAU ( 
  ...
  assign z00 = x20 & (x06 | (new_n47_ & new_n48_ & new_n49_ & x24));
  ...
  assign new_n72_ = (x20 | ~x23) & (x06 | (~new_n75_ & (~x23 | (new_n73_ & new_n74_))));
  ...
  assign new_n77_ = x20 & (x06 | (new_n78_ & new_n79_));
  assign new_n78_ = ~x08 & x09 & ~x10 & x19;
  assign new_n79_ = x21 & x22 & x23 & ~x24;
  assign new_n80_ = x24 & (~new_n81_ | ~x22 | ~x23 | (new_n49_ & x16));
  assign new_n81_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x25 | (new_n81_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n81_ | ~new_n48_ | ~x24 | x25);
  assign z16 = (~new_n85_ & x20) | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n85_ = ~x06 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
