...
module FAU ( 
  ...
  assign new_n62_ = ~x08 & x09 & ~x10 & x11 & ~x16 & x20;
  assign z10 = z02 | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & ((~x16 & x20 & (new_n65_ | ~x19)) | (x19 & ~x20));
  assign new_n65_ = x12 & x21 & x22 & new_n48_ & x23 & x24;
  assign z11 = (x02 & ~new_n52_ & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((~x20 & x21) | (~x16 & x20 & (x19 ? (new_n68_ | ~x21) : x21)));
  assign new_n68_ = new_n50_ & x13 & new_n48_ & x24;
  assign z12 = (x03 & ~new_n52_ & x08) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x20 | ~x22) & (x16 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x21 | x22 | ~x19 | ~x20)));
  assign new_n71_ = x14 & x23 & new_n48_ & x24;
  assign z13 = (x04 & ~new_n52_ & x08) | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((~x20 & x23) | (~x16 & ((~x22 & x23) | (x20 & ~new_n74_ & x22))));
  assign new_n74_ = (~x19 | ~x21 | (x23 & (~new_n48_ | ~x15 | ~x24))) & (~x23 | (x19 & x21));
  assign z14 = z06 | (new_n76_ & ~x08);
  assign new_n76_ = x09 & ~x10 & ((~x20 & x24) | (~new_n77_ & ~x16));
  assign new_n77_ = (~x24 | (x19 & x21 & x22 & x23)) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign z15 = (~new_n81_ & x20) | (x06 & x08) | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & x25 & (~new_n80_ | ~x19 | ~x20 | ~x21);
  assign new_n80_ = new_n50_ & x24 & (~x17 | ~x26);
  assign new_n81_ = ~x16 & (~new_n82_ | x10 | ~x19 | x08 | ~x09);
