...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x10 | x19)) | (~x08 & x09 & ~new_n62_ & ~x10);
  ...
  assign new_n65_ = (~x22 | (x19 & x20 & ~new_n66_ & x21)) & (~x21 | x22 | ~x19 | ~x20);
  ...
  assign new_n71_ = (~x24 | (new_n72_ & x22 & ~new_n73_ & x23)) & (~new_n72_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x16 & x25 & x26;
  assign new_n74_ = ~x19 & (x10 | (~x08 & x09 & x24));
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & new_n76_ & x09);
