// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:42 2020
...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (x19 ? (new_n64_ | ~x21) : x21)) | (x03 & ~x20 & x21));
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x20 & (~x03 | (new_n68_ & ~x08 & x09))) | (x03 & x08) | (~x08 & new_n66_ & x09);
  ...
  assign new_n70_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = new_n73_ | (x20 & (x08 ? x05 : (new_n75_ & x09)));
  assign new_n73_ = ~new_n74_ & x03;
  assign new_n74_ = (~x05 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x24);
