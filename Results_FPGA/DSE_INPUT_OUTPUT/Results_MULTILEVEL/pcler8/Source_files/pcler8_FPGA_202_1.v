...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x06 & x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x20 & (new_n70_ | ~x06)) | (new_n68_ & ~x08) | (x03 & x08);
  ...
  assign new_n72_ = (x20 | ~x23) & (~x06 | (~new_n75_ & ((new_n73_ & new_n74_) | ~x23)));
  ...
  assign new_n77_ = x06 & (~new_n78_ | x10 | ~x19 | x08 | ~x09);
  assign new_n78_ = x21 & x22 & x23 & ~x24;
  assign new_n79_ = ~x10 & x24 & (~new_n80_ | ~x19 | ~x20 | ~x21);
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x08 & (x06 | x20)) | (~x08 & new_n83_ & x09) | ((new_n82_ | ~x06) & x20);
  assign new_n82_ = new_n73_ & x09 & ~x10 & new_n49_ & x24 & ~x25;
  assign new_n83_ = ~x10 & x25 & (~new_n84_ | ~x19 | ~x20 | ~x21);
  assign new_n84_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n86_ & x20) | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n86_ = x06 & (~new_n48_ | ~new_n49_ | ~x24 | ~x25 | x26);
