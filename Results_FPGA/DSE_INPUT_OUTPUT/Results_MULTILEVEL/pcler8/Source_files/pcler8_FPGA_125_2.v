...
module FAU ( 
  ...
  assign z09 = (x09 & (~x20 | (new_n57_ & ~x08))) | (x00 & x08);
  assign new_n57_ = ~x10 & (~x19 | (new_n58_ & x11 & x21 & x22));
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign z10 = (x09 & (~x20 | (new_n60_ & ~x08))) | (x01 & x08);
  assign new_n60_ = ~x10 & (~x19 | (new_n58_ & x12 & x21 & x22));
  ...
  assign z13 = (x04 & x08) | (x09 & (~x20 | (~x08 & ~new_n67_ & ~x10)));
  assign new_n67_ = x22 ? ((~x19 | ~x21 | (~new_n68_ & x23)) & (~x20 | ~x23 | (x19 & x21))) : ~x23;
