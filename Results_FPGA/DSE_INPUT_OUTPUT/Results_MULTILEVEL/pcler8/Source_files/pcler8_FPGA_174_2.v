...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n61_, new_n63_,
    ...
    new_n84_;
  assign z00 = x19 & (~x24 | (new_n47_ & new_n48_ & new_n49_));
  assign new_n47_ = ~x08 & x09 & ~x10 & x20;
  assign new_n48_ = x21 & x22;
  assign new_n49_ = x23 & x25 & x26;
  ...
  assign new_n60_ = new_n48_ & x11 & x20 & new_n61_ & x23 & x24;
  assign new_n61_ = x25 & x26;
  assign z10 = (x01 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = x19 ? (~x24 | (x20 & (~new_n49_ | ~new_n48_ | ~x12))) : ~x20;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x19 ? (x24 & (x20 ? (new_n66_ | ~x21) : x21)) : x21);
  ...
  assign z13 = (x19 & (new_n71_ | ~x24)) | (x04 & x08) | (new_n73_ & ~x08);
  assign new_n71_ = ~x08 & x09 & ~x10 & new_n72_ & x22 & ~x23;
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x09 & ~x10 & x23 & (~new_n74_ | ~x19 | ~x20);
  assign new_n74_ = x21 & x22 & (~x15 | ~x25 | ~x26);
  assign z14 = (x05 & ~new_n51_ & x08) | (~x08 & x09 & new_n76_ & ~x10);
  assign new_n76_ = x24 & (~new_n77_ | ~x22 | ~x23 | (new_n61_ & x16));
  assign new_n77_ = x19 & x20 & x21;
  assign z15 = new_n79_ | (x06 & x08) | (~x08 & x09 & new_n80_ & ~x10);
  assign new_n79_ = x19 & (~x24 | (new_n47_ & new_n48_ & x23 & ~x25));
  assign new_n80_ = x25 & (~new_n77_ | ~x22 | ~x23 | (x17 & x26));
  assign z16 = (x07 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x24 | ((new_n83_ | ~x26) & (~new_n84_ | ~new_n72_ | ~x19))) & (x19 | ~x26);
