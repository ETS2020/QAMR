...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n59_ & ~x10) | (x00 & x08) | (x10 & ~x20);
  ...
  assign new_n85_ = ~x20 & (x10 | (~x08 & x09 & x26));
endmodule
