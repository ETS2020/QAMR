...
module FAU ( 
  ...
  assign new_n64_ = x19 ? (x20 ? (x21 & (~new_n49_ | ~new_n48_ | ~x13)) : ~x21) : ~x21;
  ...
  assign z13 = z05 | (~x08 & x09 & (new_n71_ | (~new_n69_ & x22)));
  assign new_n69_ = (~x19 | ~x20 | ~x21 | (~new_n70_ & x23)) & (x10 | ~x23 | (x19 & x20 & x21));
  assign new_n70_ = x25 & x26 & x15 & x24;
  assign new_n71_ = ~x10 & ~x22 & x23;
  assign z14 = new_n73_ | (x05 & x08) | (~x08 & x09 & new_n75_ & ~x10);
  assign new_n73_ = x19 & (x10 | (new_n74_ & ~x08 & x09 & x20));
  ...
  assign new_n78_ = x19 & (x10 | (new_n47_ & new_n48_ & x24 & ~x25));
  ...
  assign new_n82_ = ~x10 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
