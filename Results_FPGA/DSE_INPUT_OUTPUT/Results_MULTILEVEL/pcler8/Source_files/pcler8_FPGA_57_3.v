...
module FAU ( 
  ...
  assign z15 = new_n75_ | (x06 & x08) | (~x08 & x09 & new_n78_ & ~x10);
  assign new_n75_ = x19 & (x10 | (new_n77_ & new_n76_ & x24 & ~x25));
  assign new_n76_ = x22 & x23;
  assign new_n77_ = ~x08 & x09 & x20 & x21;
  assign new_n78_ = x25 & (~new_n72_ | ~new_n76_ | ~x24 | (x17 & x26));
