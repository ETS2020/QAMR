...
module FAU ( 
  ...
  assign new_n67_ = x20 ? ((~x22 | (x19 & ~new_n68_ & x21)) & (~x19 | ~x21 | x22)) : (~x22 | x24);
  ...
  assign new_n77_ = ~x10 & ((x20 & (new_n79_ | (~new_n78_ & x25))) | (~x24 & x25));
  assign new_n78_ = x19 & x21 & x22 & x23 & (~x17 | ~x26);
  assign new_n79_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (~new_n81_ & x24) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n81_ = x20 & (~new_n82_ | x10 | ~x19 | x08 | ~x09);
