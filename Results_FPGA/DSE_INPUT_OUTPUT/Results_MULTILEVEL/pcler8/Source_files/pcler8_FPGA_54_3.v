...
module FAU ( 
  ...
  assign new_n60_ = ~x03 & ~x08 & x09 & ~x10 & x11 & x20;
  assign new_n61_ = x22 & x23;
  assign new_n62_ = x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((~x03 & x20 & ((new_n65_ & new_n66_) | ~x19)) | (x19 & ~x20));
  assign new_n65_ = x12 & x21 & x22;
  assign new_n66_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n50_ & x08) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((~x03 & x20 & (x19 ? (new_n69_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n69_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & (x08 | x20)) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x22 | (new_n72_ & x21 & (~new_n62_ | ~x14 | ~x23))) & (~new_n72_ | ~x21 | x22);
  ...
  assign new_n77_ = (x20 | ~x24) & (x03 | (~new_n80_ & ((new_n78_ & new_n79_) | ~x24)));
  ...
  assign new_n82_ = ~x03 & ((new_n83_ & new_n86_) | (x25 & (~new_n84_ | ~new_n85_)));
  ...
  assign new_n89_ = ~x03 & (~new_n90_ | ~new_n61_ | ~x24 | ~x25 | x26);
  assign new_n90_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n91_ = ~x10 & x26 & (~new_n92_ | ~new_n61_ | ~x24 | ~x25);
  assign new_n92_ = x20 & x21 & ~x18 & x19;
endmodule
