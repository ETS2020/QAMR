...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n61_, new_n62_, new_n63_,
    new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n72_, new_n73_,
    new_n74_, new_n76_, new_n77_, new_n78_, new_n79_, new_n81_, new_n82_,
    new_n83_, new_n84_, new_n85_, new_n87_, new_n88_, new_n89_, new_n90_,
    new_n91_, new_n92_;
  assign z00 = (~x16 & ~x20) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (x16 & x19 & ~x20));
  assign new_n62_ = x12 & x21 & x22;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n50_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (x16 & ~x20 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x20 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x21 | x22))) & (~x16 | x20 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n71_ | (~x08 & x09 & ~x10 & (new_n72_ | new_n74_));
  assign new_n71_ = x04 & ~new_n50_ & x08;
  assign new_n72_ = x20 & (x22 ? ((x19 & x21 & (new_n73_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign new_n74_ = x16 & ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~x10 & (new_n76_ | new_n78_));
  assign new_n76_ = x24 & ((~new_n77_ & x20) | (x16 & (~x20 | (x25 & x26))));
  assign new_n77_ = x19 & x21 & x22 & x23;
  assign new_n78_ = new_n79_ & x22 & x23 & ~x24;
  assign new_n79_ = x19 & x20 & x21;
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & new_n82_ & x09);
  assign new_n81_ = ~x20 & (~x16 | (new_n47_ & ~x10 & x25));
  assign new_n82_ = ~x10 & ((new_n79_ & new_n85_) | (x25 & (~new_n83_ | ~new_n84_)));
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = x23 & x24 & (~x17 | ~x26);
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign z16 = new_n87_ | (x07 & x08) | (~x08 & new_n88_ & x09);
  assign new_n87_ = ~x20 & (~x16 | (new_n47_ & ~x10 & x26));
