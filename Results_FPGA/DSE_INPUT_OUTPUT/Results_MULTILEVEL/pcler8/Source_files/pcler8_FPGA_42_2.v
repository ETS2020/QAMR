...
module FAU ( 
  ...
  assign z09 = new_n60_ | (new_n47_ & new_n49_ & ~x10 & x11 & x20);
  assign new_n60_ = ~new_n51_ & ((x00 & x08) | (~x08 & x09 & ~x10 & ~x19));
  assign z10 = (~x08 & x09 & ~new_n62_ & ~x10) | new_n51_ | (x01 & x08);
  assign new_n62_ = x20 ? (x19 & (~new_n63_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x05 & ~x20 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & ~new_n51_ & x08);
  assign new_n68_ = (~x20 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x21 | x22))) & (x05 | x20 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | new_n51_ | (x04 & x08);
  assign new_n71_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (~x08 & x09 & ~new_n74_ & ~x10) | (x05 & x08 & x20);
  assign new_n74_ = (~x20 | ((~x24 | (new_n75_ & new_n76_)) & (~new_n75_ | ~new_n77_))) & (x05 | x20 | ~x24);
  ...
  assign new_n79_ = ~x20 & (x05 | (new_n49_ & ~x10 & x25));
  assign new_n80_ = (~x25 | (new_n81_ & new_n82_)) & (~new_n83_ | ~new_n48_ | ~x24 | x25);
  assign new_n81_ = x19 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x19 & x20 & x21;
  assign z16 = new_n85_ | (x20 & (x08 ? x07 : (new_n87_ & x09)));
  assign new_n85_ = ~new_n86_ & ~x05;
  assign new_n86_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x26);
  assign new_n87_ = ~x10 & ((x26 & (~new_n88_ | ~new_n89_)) | (new_n81_ & new_n90_));
