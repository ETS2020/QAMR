...
module FAU ( 
  ...
  assign z11 = (~x08 & x09 & ~new_n64_ & ~x10) | (x02 & ~new_n47_ & x08);
  assign new_n64_ = (~x13 | ((x20 | ~x21) & (~new_n60_ | ~x19 | ~x20 | ~x22))) & (~x20 | (~x19 ^ x21));
  assign z12 = z04 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x20 | ((~x22 | (x19 & ~new_n67_ & x21)) & (~x19 | ~x21 | x22))) & (~x13 | x20 | ~x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~x10 & (new_n69_ | new_n71_));
  assign new_n69_ = x20 & (x22 ? ((x19 & x21 & (new_n70_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n70_ = x25 & x26 & x15 & x24;
  assign new_n71_ = x13 & ~x20 & x23;
  ...
  assign new_n78_ = (~x20 | ((~x25 | (new_n79_ & new_n80_)) & (~new_n79_ | ~new_n81_))) & (~x13 | x20 | ~x25);
  ...
  assign new_n88_ = ~x20 & (~x13 | (~x08 & x09 & ~x10 & x26));
endmodule
