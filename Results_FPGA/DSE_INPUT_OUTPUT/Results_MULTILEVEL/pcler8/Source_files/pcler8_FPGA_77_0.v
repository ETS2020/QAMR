...
module FAU ( 
  ...
  assign z00 = (~x13 & ~x20) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign z11 = ~new_n67_ | (~x08 & x09 & ~x10 & (new_n64_ | new_n68_));
  assign new_n64_ = x20 & (~new_n66_ | (x13 & x22 & new_n65_ & x23));
  assign new_n65_ = x24 & x25 & x26 & (x19 | (x12 & x21));
  assign new_n66_ = ~x19 ^ x21;
  assign new_n67_ = ~new_n50_ & (~x02 | ~x08);
  assign new_n68_ = ~x20 & x21;
  assign z12 = (x03 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x20 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x19 | ~x21 | x22))) & (~x13 | x20 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n73_ | (~x08 & x09 & ~x10 & (new_n74_ | new_n76_));
  assign new_n73_ = x04 & ~new_n50_ & x08;
  assign new_n74_ = x20 & (x22 ? ((x19 & x21 & (new_n75_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n75_ = x25 & x26 & x15 & x24;
  assign new_n76_ = x13 & ~x20 & x23;
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x20 | ((~new_n79_ | ~new_n81_) & (~x24 | (new_n79_ & new_n80_)))) & (~x13 | x20 | ~x24);
  assign new_n79_ = x19 & x21;
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n81_ = x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x20 | ((~new_n84_ | ~new_n86_) & (~x25 | (new_n84_ & new_n85_)))) & (~x13 | x20 | ~x25);
  assign new_n84_ = x19 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x23 & x24 & ~x25;
  assign z16 = new_n88_ | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n88_ = ~x20 & (~x13 | (new_n47_ & ~x10 & x26));
  ...
  assign new_n93_ = x25 & ~x26 & x23 & x24;
endmodule
