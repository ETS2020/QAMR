...
module FAU ( 
  ...
  assign z12 = (~new_n67_ & x14) | (x03 & x08) | (new_n68_ & ~x08);
  assign new_n67_ = x19 & (~new_n60_ | x10 | ~x22 | x08 | ~x09);
  assign new_n68_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x21 & ~x22 & x19 & x20));
  ...
  assign new_n72_ = ~x14 & ~x19 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (x14 | x19 | ~x24) & (~x19 | ((~new_n75_ | ~new_n77_) & (~x24 | (new_n75_ & new_n76_))));
  assign new_n75_ = x20 & x21;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x14 | x19 | ~x25) & (~x19 | ((~new_n80_ | ~new_n82_) & (~x25 | (new_n80_ & new_n81_))));
