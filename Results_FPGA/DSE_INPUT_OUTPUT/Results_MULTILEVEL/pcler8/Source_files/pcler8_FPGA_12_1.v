...
module FAU ( 
  ...
  assign z09 = new_n59_ | (new_n60_ & new_n61_ & x21 & new_n62_ & x24);
  ...
  assign z11 = (x08 & (x02 | x20)) | (~x02 & x20) | (new_n68_ & x09);
  assign new_n68_ = ~x10 & ((~x08 & x21 & (~x19 | ~x20)) | (x19 & x20 & (new_n69_ | ~x21)));
  ...
  assign new_n75_ = (~x19 | ~x21 | (x23 & (~new_n62_ | ~x15 | ~x24))) & (~x23 | (x19 & x21));
  assign z14 = new_n79_ | (x05 & x08) | (~x08 & x09 & new_n77_ & ~x10);
  assign new_n77_ = x24 & (~new_n78_ | ~x19 | ~x20 | ~x21);
  assign new_n78_ = x22 & (~new_n62_ | ~x16) & x23;
  assign new_n79_ = x20 & (~x02 | (new_n80_ & new_n66_ & x23 & ~x24));
  ...
  assign new_n84_ = x19 & x20 & x21 & new_n61_ & x24 & ~x25;
  assign z16 = (x07 & ~new_n50_ & x08) | (~x08 & new_n86_ & x09);
  assign new_n86_ = ~x10 & ((~x20 & x26) | (x02 & (new_n88_ | (~new_n87_ & x26))));
  assign new_n87_ = ~x18 & x19 & x21 & new_n61_ & x24 & x25;
  assign new_n88_ = new_n89_ & new_n66_ & x19 & x20;
