...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n70_ & ~x10) | (x04 & x08 & (x09 | x20));
  assign new_n70_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = (~x20 & (~x09 | (new_n76_ & ~x08))) | (x05 & x08) | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & (new_n75_ | (x24 & (~new_n74_ | ~x19 | ~x21)));
  assign new_n74_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign new_n76_ = ~x10 & x24;
  assign z15 = z07 | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((x25 & (~new_n80_ | ~new_n79_ | new_n81_ | ~x24)) | (new_n80_ & new_n79_ & x24 & ~x25));
  assign new_n79_ = x22 & x23;
  assign new_n80_ = x19 & x20 & x21;
  assign new_n81_ = x17 & x26;
