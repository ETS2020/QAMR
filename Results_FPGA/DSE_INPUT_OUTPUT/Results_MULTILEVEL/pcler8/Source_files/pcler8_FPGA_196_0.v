...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n59_ & ~x10) | new_n49_ | (x00 & x08);
  ...
  assign z11 = (~new_n49_ & ((x02 & x08) | (new_n66_ & ~x08 & x09))) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & x19 & (x20 ? (new_n65_ | ~x21) : (x21 & x25));
  ...
  assign new_n75_ = x22 & x23 & x19 & x21;
  assign new_n76_ = new_n77_ & x22 & x23 & ~x24;
  assign new_n77_ = x19 & x20 & x21;
  assign z15 = (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n79_ = (~x25 | (new_n77_ & new_n80_ & x24 & (~x17 | ~x26))) & (~new_n77_ | ~new_n80_ | ~x24 | x25);
  assign new_n80_ = x22 & x23;
  assign z16 = new_n82_ | (~x08 & x09 & ~x10 & (new_n83_ | new_n84_));
  assign new_n82_ = x07 & ~new_n49_ & x08;
  assign new_n83_ = x25 & ((~x20 & x26) | (new_n77_ & new_n80_ & x24 & ~x26));
