...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((x04 & (x19 ? (x20 & (new_n65_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n69_ | ~x04)) | (x03 & x08) | (new_n67_ & ~x08);
  ...
  assign new_n74_ = x20 & ((new_n75_ & new_n76_) | ~x04);
  assign new_n75_ = ~x08 & x09 & ~x10 & x19;
  assign new_n76_ = x21 & x22 & x23 & ~x24;
  assign new_n77_ = (~new_n78_ | ~new_n79_) & x24;
  ...
  assign new_n82_ = x04 & ((new_n78_ & new_n85_) | (x25 & (~new_n83_ | ~new_n84_)));
