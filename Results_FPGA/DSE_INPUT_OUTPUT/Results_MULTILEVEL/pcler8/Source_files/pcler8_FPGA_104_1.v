...
module FAU ( 
  ...
  assign z09 = (~x08 & ~new_n59_ & ~x10) | (x00 & x08) | (~x09 & x20);
  assign new_n59_ = (~new_n60_ | ~new_n61_) & (~x09 | x19);
  assign new_n60_ = x21 & x22 & x11 & x20;
  assign new_n61_ = x25 & x26 & x23 & x24;
  assign z10 = (x01 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = x20 ? (x19 & (~new_n61_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = (x02 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = x20 ? (x19 ? (x21 & (~new_n49_ | ~new_n48_ | ~x13)) : ~x21) : ~x21;
  ...
  assign z16 = (x20 & (new_n81_ | ~x09)) | (x07 & x08) | (~x08 & new_n82_ & x09);
  assign new_n81_ = new_n47_ & new_n48_ & x24 & x25 & ~x26;
  assign new_n82_ = ~x10 & x26 & (~new_n83_ | ~new_n48_ | ~x24 | ~x25);
