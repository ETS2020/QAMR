...
module FAU ( 
  ...
  assign z09 = new_n60_ | (new_n61_ & new_n62_ & new_n49_ & x24);
  ...
  assign new_n64_ = (~x20 | (x19 & (~new_n65_ | ~new_n49_ | ~x23 | ~x24))) & (~x19 | x20 | x24);
  assign new_n65_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x19 | (~new_n68_ & (~x20 | x21))) & (~x21 | (x20 & (x19 | ~x20)));
  ...
  assign new_n72_ = ~x20 & (x24 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (~x08 & x09 & ~new_n74_ & ~x10) | new_n51_ | (x04 & x08);
  assign new_n74_ = (~x22 | ((~x19 | ~x21 | (~new_n75_ & (~x20 | x23))) & (~x20 | ~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  ...
  assign z15 = (~new_n80_ & x24) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n80_ = x20 & (~new_n47_ | ~new_n48_ | ~x23 | x25);
  assign new_n81_ = ~x10 & x25 & (~new_n82_ | ~new_n48_ | ~x19);
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n84_ & x24) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n84_ = x20 & (~new_n47_ | ~new_n48_ | ~x23 | ~x25 | x26);
  assign new_n85_ = ~x10 & x26 & (~new_n86_ | ~new_n78_ | x18);
