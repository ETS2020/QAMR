...
module FAU ( 
  ...
  assign z11 = new_n65_ | (~x08 & x09 & ~new_n63_ & ~x10) | (x02 & x08);
  assign new_n63_ = x21 ? (~new_n64_ & (x19 | ~x20)) : ~x19;
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = ~x20 & (~x21 | (~x08 & x09 & ~x10));
  ...
  assign new_n69_ = ~x20 & (~x21 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((x20 & x21 & ~new_n72_ & x22) | (x23 & (~x20 | ~x21 | ~x22)));
  assign new_n72_ = x19 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x21 | ((x20 | ~x24) & (~new_n75_ | ~x19 | ~x20))) & (~x20 | ~x24 | (new_n76_ & x19 & x21));
  assign new_n75_ = x22 & x23 & ~x24;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (new_n79_ | ~x21) & (~x20 | ~x25 | (new_n80_ & new_n81_));
  assign new_n79_ = (x20 | ~x25) & (~x19 | ~x20 | ~x22 | ~x23 | ~x24 | x25);
  ...
  assign new_n88_ = ~x20 & (~x21 | (~x08 & x09 & ~x10 & x26));
endmodule
