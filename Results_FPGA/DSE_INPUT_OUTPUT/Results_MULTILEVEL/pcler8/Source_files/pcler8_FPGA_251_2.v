...
module FAU ( 
  ...
  assign z05 = x04 & x08 & (~x03 | (x03 & x19));
  ...
  assign z12 = (x03 & (x08 | ~x19)) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x22 | (x19 & x20 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n73_ | (x04 & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x22 | ~x23) & (~x19 | ~x22 | ((~x20 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x20 & x21))));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = ~x19 & (x03 | (~x10 & x23 & ~x08 & x09));
  ...
  assign new_n85_ = ~x19 & (x03 | (~x10 & x25 & ~x08 & x09));
  ...
  assign new_n92_ = ~x19 & (x03 | (~x10 & x26 & ~x08 & x09));
endmodule
