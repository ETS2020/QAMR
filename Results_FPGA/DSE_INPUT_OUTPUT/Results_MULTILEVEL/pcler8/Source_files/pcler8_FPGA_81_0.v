...
module FAU ( 
  ...
  assign z09 = x08 ? x00 : (~x20 | (new_n57_ & x09));
  ...
  assign z13 = x08 ? x04 : (~x20 | (x09 & ~new_n67_ & ~x10));
  ...
  assign z15 = x08 ? x06 : (~x20 | (x09 & ~new_n73_ & ~x10));
  assign new_n73_ = (~x25 | (new_n74_ & x23 & x24 & (~x17 | ~x26))) & (~new_n74_ | ~x23 | ~x24 | x25);
  assign new_n74_ = x19 & x21 & x22;
  assign z16 = x08 ? x07 : (~x20 | (x09 & ~new_n76_ & ~x10));
  assign new_n76_ = (~new_n74_ | ~new_n79_) & (~x26 | (new_n77_ & new_n78_));
