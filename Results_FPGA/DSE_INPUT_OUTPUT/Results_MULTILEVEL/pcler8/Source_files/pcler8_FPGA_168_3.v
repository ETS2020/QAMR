...
module FAU ( 
  ...
  assign z10 = (~x08 & ~new_n63_ & x09) | (x01 & x08) | (x10 & x20);
  assign new_n63_ = (~x20 | (x19 & (~new_n61_ | ~new_n60_ | ~x12))) & (x10 | ~x19 | x20);
  assign z11 = (x02 & x08 & (~x10 | ~x20)) | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x19 | ~x20 | (x21 & (~new_n49_ | ~new_n48_ | ~x13))) & (~x21 | (x19 & x20));
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (new_n68_ & x21 & (~new_n49_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  ...
  assign z14 = (x20 & (new_n73_ | x10)) | (x05 & x08) | (new_n74_ & ~x08);
  assign new_n73_ = ~x08 & x09 & x19 & new_n60_ & x23 & ~x24;
  assign new_n74_ = x09 & ~x10 & x24 & (~new_n75_ | ~new_n76_);
  assign new_n75_ = x19 & x20 & x21;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = new_n78_ | (x06 & x08) | (~x08 & x09 & new_n79_ & ~x10);
  assign new_n78_ = x20 & (x10 | (new_n47_ & new_n48_ & x24 & ~x25));
  assign new_n79_ = x25 & (~new_n75_ | ~new_n48_ | ~x24 | (x17 & x26));
  assign z16 = (x07 & x08 & (~x10 | ~x20)) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = ((new_n82_ & new_n83_) | ~x26) & (~new_n84_ | ~new_n60_ | ~new_n68_);
  assign new_n82_ = ~x18 & x19 & x20 & x21;
