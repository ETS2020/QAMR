...
module FAU ( 
  ...
  assign z10 = (~x08 & ~new_n60_ & x09) | (x01 & x08) | (x10 & ~x20);
  ...
  assign new_n73_ = (~x24 | (new_n75_ & x22 & ~new_n76_ & x23)) & (~new_n74_ | ~x22 | ~x23 | x24);
  ...
  assign new_n79_ = ~x10 & ((new_n74_ & new_n82_) | (x25 & (~new_n80_ | ~new_n81_)));
  ...
  assign new_n90_ = ~x20 & (x10 | (~x08 & x09 & x26));
endmodule
