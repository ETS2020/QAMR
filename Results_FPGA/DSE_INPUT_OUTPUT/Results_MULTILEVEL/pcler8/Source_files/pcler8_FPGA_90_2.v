...
module FAU ( 
  ...
  assign new_n64_ = x12 & x21 & x22 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & (x20 ? (x23 & (x19 ? (new_n67_ | ~x21) : x21)) : x21);
  assign new_n67_ = x13 & x22 & x24 & x25 & x26;
  assign z12 = new_n69_ | (~x08 & x09 & new_n71_ & ~x10) | (x03 & x08);
  assign new_n69_ = x20 & (new_n70_ | ~x23);
  assign new_n70_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign new_n71_ = x22 & ((~new_n72_ & x23) | ~x23 | (new_n61_ & x14 & x24));
  assign new_n72_ = x19 & x20 & x21;
  assign z13 = new_n69_ | (~x08 & x09 & new_n74_ & ~x10) | (x04 & x08);
  assign new_n74_ = x23 & ((~new_n72_ & x22) | ~x22 | (new_n61_ & x15 & x24));
  assign z14 = z06 | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & ((x23 & (new_n78_ | (~new_n77_ & x24))) | (~x20 & x24));
  assign new_n77_ = x19 & x21 & x22 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x19 & x20 & x21 & x22 & ~x24;
  ...
  assign z16 = (~new_n84_ & x20) | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n84_ = x23 & (~new_n85_ | x10 | ~x19 | x08 | ~x09);
