...
module FAU ( 
  ...
  assign new_n68_ = x20 & (x22 ? ((x19 & x21 & (new_n69_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = x08 ? x05 : (~x20 | (x09 & ~new_n71_ & ~x10));
  assign new_n71_ = (~x24 | (x19 & x21 & x22 & ~new_n72_ & x23)) & (~x19 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n72_ = x16 & x25 & x26;
  assign z15 = x08 ? x06 : (~x20 | (x09 & ~new_n74_ & ~x10));
  assign new_n74_ = (~x25 | (new_n75_ & x23 & x24 & (~x17 | ~x26))) & (~new_n75_ | ~x23 | ~x24 | x25);
  assign new_n75_ = x19 & x21 & x22;
  assign z16 = x08 ? x07 : (~x20 | (x09 & ~new_n77_ & ~x10));
  assign new_n77_ = (~new_n75_ | ~new_n80_) & (~x26 | (new_n78_ & new_n79_));
