...
module FAU ( 
  ...
  assign z09 = (~new_n59_ & (~x13 | ~x20)) | (new_n61_ & new_n60_ & x11 & ~x13 & x20);
  ...
  assign new_n63_ = ~x10 & ((~x13 & x20 & (~x19 | (new_n64_ & new_n65_))) | (x19 & ~x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (~new_n67_ & x20) | (x02 & x08) | (new_n68_ & ~x08);
  assign new_n67_ = ~x13 & (~new_n48_ | x10 | ~x19 | x21);
  assign new_n68_ = x09 & ~x10 & x21 & (~x19 | ~x20);
  assign z12 = z04 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x13 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x21 | x22 | ~x19 | ~x20))) & (x20 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (new_n75_ & ~x08) | (x20 & (new_n73_ | x13));
  assign new_n73_ = new_n60_ & new_n74_ & x22 & ~x23;
  ...
  assign z16 = (~new_n89_ & x20) | (x07 & x08) | (~x08 & new_n91_ & x09);
  assign new_n89_ = ~x13 & (~new_n90_ | ~new_n48_ | ~new_n74_ | x10);
  assign new_n90_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n91_ = ~x10 & x26 & (~new_n92_ | ~new_n93_);
