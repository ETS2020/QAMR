...
module FAU ( 
  ...
  assign new_n64_ = ~x20 & (x23 | (~x08 & x09 & ~x10 & x19));
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & (x20 ? (x19 ? (new_n67_ | ~x21) : x21) : (x21 & ~x23));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n69_ & ~x10) | (x03 & ~new_n49_ & x08);
  assign new_n69_ = x20 ? ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x21 | x22)) : (~x22 | x23);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x19 & x21)))) & (x22 | ~x23);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (~new_n75_ & x23) | (x05 & x08) | (new_n77_ & ~x08);
  assign new_n75_ = x20 & (~new_n76_ | x08 | ~x09 | x10);
  assign new_n76_ = x19 & x21 & x22 & ~x24;
  assign new_n77_ = x09 & ~x10 & x24 & (~new_n78_ | ~x19 | ~x21);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~x08 & x09 & ~new_n80_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n80_ = (~x20 | ((new_n81_ | ~x25) & (~new_n82_ | ~x23 | ~x24 | x25))) & (x23 | ~x25);
  assign new_n81_ = x19 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n82_ = x19 & x21 & x22;
  assign z16 = (~x08 & x09 & ~new_n84_ & ~x10) | (x07 & ~new_n49_ & x08);
  assign new_n84_ = (x23 | ~x26) & (~x20 | ((new_n85_ | ~x26) & (~new_n82_ | ~new_n86_)));
  assign new_n85_ = x22 & x24 & x25 & ~x18 & x19 & x21;
