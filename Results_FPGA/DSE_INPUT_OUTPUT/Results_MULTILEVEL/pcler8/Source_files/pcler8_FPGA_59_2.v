...
module FAU ( 
  ...
  assign new_n62_ = x20 ? (x19 & (~new_n60_ | ~x12 | ~x21 | ~x23)) : ~x19;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x22 & (x19 ? (x20 & (new_n65_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n65_ = x13 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~x10 & ~new_n67_ & x22);
  assign new_n67_ = x19 & x20 & x21 & (~new_n60_ | ~x14 | ~x23);
  assign z13 = z05 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x19 | ~x20 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x22 & (~x22 | (x19 & x20 & x21))));
  ...
  assign new_n82_ = x23 & x24 & x25 & ~x18 & x19 & x21;
