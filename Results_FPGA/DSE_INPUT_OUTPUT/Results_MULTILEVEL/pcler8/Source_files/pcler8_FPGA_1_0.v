...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (x18 & ~x20 & x21));
  ...
  assign new_n76_ = ~x20 & (~x18 | (new_n47_ & ~x10 & x24));
  ...
  assign new_n81_ = (~x20 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_))) & (~x18 | x20 | ~x25);
  assign new_n82_ = x19 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x23 & x24 & ~x25;
  assign z16 = (~x08 & new_n86_ & x09) | new_n50_ | (x07 & x08);
