...
module FAU ( 
  ...
  assign new_n70_ = ~x20 & (~x16 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n76_ = ~new_n79_ & (~x24 | ((~x16 | (~new_n77_ & x20)) & (new_n78_ | ~x20)));
  assign new_n77_ = x25 & x26;
  assign new_n78_ = x19 & x21 & x22 & x23;
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x20 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_))) & (~x16 | x20 | ~x25);
  ...
  assign new_n91_ = ~x20 & (~x16 | (~x08 & x09 & ~x10 & x26));
endmodule
