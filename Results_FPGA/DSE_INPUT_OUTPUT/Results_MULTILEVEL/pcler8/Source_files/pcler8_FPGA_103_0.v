...
module FAU ( 
  ...
  assign z11 = new_n49_ | (x02 & x08) | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & (x19 ? (x20 ? (new_n64_ | ~x21) : x21) : x21);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = new_n66_ | (x03 & x08) | (~x08 & new_n68_ & x09);
  assign new_n66_ = ~x22 & (~x06 | (new_n67_ & ~x08 & x09 & ~x10));
  assign new_n67_ = x19 & x20 & x21;
  assign new_n68_ = ~x10 & x22 & (~x19 | ~x20 | new_n69_ | ~x21);
  ...
  assign new_n74_ = (~x24 | (x19 & x20 & new_n75_ & x21)) & (~new_n76_ | ~x19 | ~x20 | ~x21);
  assign new_n75_ = x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x22 & x23 & ~x24;
  assign new_n77_ = ~x22 & (~x06 | (~x10 & x24 & ~x08 & x09));
  assign z15 = (x08 & (x06 | ~x22)) | (~x22 & (~x06 | (new_n82_ & x09))) | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((x25 & (~new_n67_ | ~new_n81_)) | (new_n67_ & new_n80_ & x24 & ~x25));
  assign new_n80_ = x22 & x23;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = ~x10 & x25;
  assign z16 = new_n84_ | (x22 & (x08 ? x07 : (new_n86_ & x09)));
  assign new_n84_ = ~new_n85_ & x06;
  assign new_n85_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x26);
  assign new_n86_ = ~x10 & ((x26 & (~new_n87_ | ~new_n88_)) | (new_n67_ & new_n89_));
