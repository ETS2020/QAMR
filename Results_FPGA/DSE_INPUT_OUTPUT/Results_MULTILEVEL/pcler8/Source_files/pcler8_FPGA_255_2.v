// Benchmark "FAU" written by ABC on Tue Aug 18 17:08:40 2020
...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n61_ & ~x10) | (x01 & ~new_n49_ & x08);
  assign new_n61_ = ~new_n62_ & (~new_n63_ | ~x12 | ~x19 | ~x21 | ~x22);
  assign new_n62_ = (~x21 | (x21 & x25)) & (x19 ^ x20);
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x19 ? (x20 ? (new_n66_ | ~x21) : (x21 & x25)) : (x21 & x25));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & ~new_n49_ & x08);
  assign new_n68_ = (~x22 | (x21 & (~x25 | (x19 & ~new_n69_ & x20)))) & (~x19 | ~x20 | ~x21 | x22 | ~x25);
  assign new_n69_ = x14 & x23 & x24 & x26;
  assign z13 = (~new_n71_ & x21) | (x04 & x08) | (new_n73_ & ~x08);
  assign new_n71_ = x25 & (~new_n72_ | x08 | ~x09 | x10);
  assign new_n72_ = x19 & x20 & x22 & ~x23;
  assign new_n73_ = x09 & ~x10 & x23 & (~new_n74_ | ~x19 | ~x20);
  assign new_n74_ = x21 & x22 & (~x15 | ~x24 | ~x26);
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (x21 & (new_n78_ | ~x25))) & (~new_n79_ | ~new_n77_ | x24 | ~x25);
  assign new_n77_ = x22 & x23;
  assign new_n78_ = x19 & x20 & x22 & x23 & (~x16 | ~x26);
  assign new_n79_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & x09 & new_n81_ & ~x10);
  assign new_n81_ = x25 & (~new_n79_ | ~new_n77_ | ~x24 | (x17 & x26));
  assign z16 = (~new_n83_ & x21) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n83_ = x25 & (~new_n84_ | x08 | ~x09 | x10 | ~x19);
  assign new_n84_ = x20 & x22 & x23 & x24 & ~x26;
