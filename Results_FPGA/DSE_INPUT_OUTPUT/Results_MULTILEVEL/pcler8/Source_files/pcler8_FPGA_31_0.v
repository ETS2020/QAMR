// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:22 2020
...
module FAU ( 
  ...
  assign new_n63_ = (~x20 | (x19 & (~new_n61_ | ~new_n64_))) & (~x13 | ~x19 | x20);
  ...
  assign z14 = (~x08 & x09 & ~new_n74_ & ~x10) | (x05 & ~new_n47_ & x08);
  assign new_n74_ = (~x20 | ((~new_n75_ | ~new_n77_) & ((new_n75_ & new_n76_) | ~x24))) & (~x13 | x20 | ~x24);
  assign new_n75_ = x19 & x21;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x20 | ((~new_n80_ | ~new_n82_) & ((new_n80_ & new_n81_) | ~x25))) & (~x13 | x20 | ~x25);
  assign new_n80_ = x19 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x23 & x24 & ~x25;
  assign z16 = new_n84_ | (~x08 & x09 & ~x10 & (new_n85_ | new_n89_));
  assign new_n84_ = x07 & ~new_n47_ & x08;
  assign new_n85_ = x20 & ((new_n80_ & new_n88_) | ((~new_n86_ | ~new_n87_) & x26));
  assign new_n86_ = ~x18 & x19 & x21;
  assign new_n87_ = x22 & x23 & x24 & x25;
  assign new_n88_ = x23 & x24 & x25 & ~x26;
  assign new_n89_ = x13 & ~x20 & x26;
endmodule
