...
module FAU ( 
  ...
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (~x17 & x19 & ~x20));
  ...
  assign new_n68_ = ~x20 & (x17 | (new_n47_ & ~x10 & x22));
  ...
  assign new_n74_ = ~x17 & ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x20 | ((~x24 | (new_n77_ & new_n78_)) & (~new_n77_ | ~new_n79_))) & (x17 | x20 | ~x24);
  assign new_n77_ = x19 & x21;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x20 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_))) & (x17 | x20 | ~x25);
  ...
  assign new_n86_ = ~x20 & (x17 | (new_n47_ & ~x10 & x26));
