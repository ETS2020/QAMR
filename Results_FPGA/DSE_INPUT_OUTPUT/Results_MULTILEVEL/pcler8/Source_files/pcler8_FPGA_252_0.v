...
module FAU ( 
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (~x02 | ~x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = new_n67_ | (~x08 & x09 & ~x10 & ~new_n65_ & x20);
  assign new_n65_ = x19 ? (~new_n66_ & x21) : ~x21;
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n67_ = x02 & (x08 | (x09 & ~x10 & ~x20 & x21));
  ...
  assign new_n71_ = ~x20 & (~x02 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n73_ | (x20 & (x08 ? x04 : (new_n75_ & x09)));
  assign new_n73_ = ~new_n74_ & x02;
  assign new_n74_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x23);
  assign new_n75_ = ~x10 & (x22 ? ((x19 & x21 & (new_n76_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  ...
  assign new_n92_ = ~x10 & (((~new_n93_ | ~new_n94_) & x26) | (new_n87_ & new_n95_));
