...
module FAU ( 
  ...
  assign z14 = (x05 & ~new_n50_ & x08) | (new_n79_ & ~x08);
  assign new_n79_ = x09 & ~x10 & ((~x20 & x24) | (~new_n80_ & ~x16));
  assign new_n80_ = (~x24 | (x22 & x23 & x19 & x21)) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n82_ | new_n87_));
  assign new_n82_ = ~x16 & ((new_n83_ & new_n86_) | (x25 & (~new_n84_ | ~new_n85_)));
  ...
  assign new_n89_ = ~x16 & (~new_n90_ | ~new_n60_ | ~x24 | ~x25 | x26);
  assign new_n90_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n91_ = ~x10 & x26 & (~new_n92_ | ~new_n60_ | ~x24 | ~x25);
