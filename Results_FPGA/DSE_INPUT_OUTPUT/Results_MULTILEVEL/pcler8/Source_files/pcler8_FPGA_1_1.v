...
module FAU ( 
  ...
  assign z00 = x20 & (~x18 | (new_n49_ & new_n47_ & x22 & x23));
  ...
  assign new_n61_ = x11 & x18 & x20 & ~x08 & x09 & ~x10;
  assign z10 = (x01 & ~new_n51_ & x08) | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & ((x18 & x20 & (new_n64_ | ~x19)) | (x19 & ~x20));
  assign new_n64_ = new_n48_ & x23 & x24 & x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x18 & x20 & (x19 ? (new_n67_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n67_ = x13 & x22 & x23 & new_n48_ & x24;
  assign z12 = (x03 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x20 | ~x22) & (~x18 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x21 | x22 | ~x19 | ~x20)));
  assign new_n70_ = x14 & x23 & new_n48_ & x24;
  assign z13 = (x04 & ~new_n51_ & x08) | (~x08 & new_n72_ & x09);
  assign new_n72_ = ~x10 & ((~x20 & x23) | (x18 & ((~x22 & x23) | (x20 & ~new_n73_ & x22))));
  assign new_n73_ = (~x19 | ~x21 | (x23 & (~new_n48_ | ~x15 | ~x24))) & (~x23 | (x19 & x21));
  assign z14 = (~new_n78_ & x20) | (x05 & x08) | (~x08 & new_n75_ & x09);
  assign new_n75_ = ~x10 & x24 & (~new_n76_ | ~new_n77_);
  ...
  assign new_n84_ = new_n77_ & x22 & x23 & x24 & ~x25;
  assign z16 = (~x08 & x09 & ~new_n86_ & ~x10) | new_n51_ | (x07 & x08);
  assign new_n86_ = ~x26 & (~new_n77_ | ~x24 | ~x25 | ~x22 | ~x23);
endmodule
