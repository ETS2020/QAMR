...
module FAU ( 
  ...
  assign z00 = ~new_n47_ & x23;
  assign new_n47_ = x19 & (~new_n48_ | x08 | ~x09 | x10 | ~x20);
  assign new_n48_ = x21 & x22 & x24 & x25 & x26;
  ...
  assign new_n62_ = x19 ? (x20 & (~new_n60_ | ~new_n63_)) : (~x20 | x23);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (~x08 & x09 & ~new_n65_ & ~x10) | new_n50_ | (x02 & x08);
  assign new_n65_ = (~x19 | (x20 ^ ~x21)) & (x19 | ~x21) & (~new_n60_ | ~x13 | ~x20 | ~x22);
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = x19 ? ((~x22 | (x20 & ~new_n68_ & x21)) & (~x20 | ~x21 | x22)) : (~x22 | x23);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & x09 & new_n70_ & ~x10);
  ...
  assign new_n73_ = (x23 | ~x24) & (~x19 | ((~x24 | (new_n74_ & ~new_n75_ & x22)) & (~new_n74_ | ~x22 | ~x23 | x24)));
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign z15 = (~x08 & x09 & ~new_n77_ & ~x10) | (x06 & ~new_n50_ & x08);
  assign new_n77_ = (x23 | ~x25) & (~x19 | ((new_n78_ | ~x25) & (~new_n79_ | ~x23 | ~x24 | x25)));
  assign new_n78_ = x20 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n79_ = x20 & x21 & x22;
  assign z16 = (~x08 & x09 & ~new_n81_ & ~x10) | (x07 & ~new_n50_ & x08);
  assign new_n81_ = (x23 | ~x26) & (~x19 | ((new_n82_ | ~x26) & (~new_n79_ | ~new_n83_)));
  assign new_n82_ = ~x18 & x20 & x21 & x22 & x24 & x25;
