...
module FAU ( 
  ...
  assign z12 = (x21 & (new_n61_ | x23)) | (new_n62_ & ~x08) | (x03 & x08);
  assign new_n61_ = ~x08 & x09 & ~x10 & x19 & x20 & ~x22;
  assign new_n62_ = x09 & ~x10 & x22 & (~x19 | ~x20 | ~x21);
  assign z13 = new_n47_ | (x04 & x08) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & (x23 | (x19 & x20 & x21 & x22));
