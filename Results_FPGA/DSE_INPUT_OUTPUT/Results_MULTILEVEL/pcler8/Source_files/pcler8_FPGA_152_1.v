...
module FAU ( 
  ...
  assign z12 = (x20 & (new_n69_ | ~x14)) | (x03 & x08) | (new_n67_ & ~x08);
  assign new_n67_ = x09 & ~x10 & x22 & (~new_n68_ | ~x19 | ~x20);
  assign new_n68_ = x21 & (~x23 | ~x24 | ~x25 | ~x26);
  assign new_n69_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & ~new_n50_ & x08);
  assign new_n71_ = (x20 | ~x23) & (~x14 | (~new_n74_ & ((new_n72_ & new_n73_) | ~x23)));
  ...
  assign new_n76_ = (x20 | ~x24) & (~x14 | (~new_n78_ & ((new_n72_ & new_n77_) | ~x24)));
  ...
  assign new_n80_ = x14 & (~new_n81_ | x10 | ~x19 | x08 | ~x09);
  assign new_n81_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x10 & x25 & (~new_n83_ | ~x19 | ~x20 | ~x21);
  assign new_n83_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n85_ & x20) | (x07 & x08) | (~x08 & new_n88_ & x09);
  assign new_n85_ = x14 & (~new_n87_ | ~new_n86_ | ~x24 | ~x25 | x26);
  assign new_n86_ = x22 & x23;
  assign new_n87_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n88_ = ~x10 & x26 & (~new_n89_ | ~new_n86_ | ~x24 | ~x25);
