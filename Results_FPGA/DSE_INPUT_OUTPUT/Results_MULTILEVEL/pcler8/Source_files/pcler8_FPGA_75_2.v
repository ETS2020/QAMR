...
module FAU ( 
  ...
  assign z14 = (x09 & ~new_n74_ & ~x10) | (x08 & (x05 | ~x20));
  assign new_n74_ = (x20 | ~x24) & (x08 | (~new_n77_ & (~x24 | (new_n75_ & new_n76_))));
  assign new_n75_ = x19 & x21;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (~new_n79_ & x20) | (~x08 & x09 & new_n81_ & ~x10);
  assign new_n79_ = (~x06 | ~x08) & (~new_n80_ | x10 | ~x19 | x08 | ~x09);
