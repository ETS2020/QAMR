...
module FAU ( 
  ...
  assign z00 = x19 & (new_n47_ | ~x09);
  assign new_n47_ = new_n48_ & x20 & x21 & ~x08 & ~x10;
  ...
  assign new_n58_ = new_n60_ & new_n59_ & x11 & x20;
  assign new_n59_ = x21 & x22;
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = (~x08 & ~new_n62_ & ~x10) | (~x09 & x19) | (x01 & x08);
  assign new_n62_ = (~x19 | (x20 & (~new_n60_ | ~new_n59_ | ~x12))) & (~x09 | x19 | ~x20);
  assign z11 = (new_n64_ & ~x08) | (x02 & x08) | (~x09 & x19);
  assign new_n64_ = ~x10 & ((x19 & (x20 ? (new_n65_ | ~x21) : x21)) | (x09 & ~x19 & x21));
  assign new_n65_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x19 & (new_n69_ | ~x09)) | (x03 & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & x22 & (~new_n68_ | ~x19 | ~x20);
  assign new_n68_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n69_ = ~x08 & ~x10 & x20 & x21 & ~x22;
  ...
  assign z14 = (x19 & (new_n74_ | ~x09)) | (x05 & x08) | (~x08 & new_n75_ & x09);
  assign new_n74_ = ~x08 & ~x10 & x20 & new_n59_ & x23 & ~x24;
  ...
  assign new_n79_ = ~x10 & ((x25 & (~new_n76_ | ~new_n80_ | new_n81_ | ~x24)) | (new_n76_ & new_n80_ & x24 & ~x25));
  assign new_n80_ = x22 & x23;
  assign new_n81_ = x17 & x26;
  assign z16 = (~x08 & new_n83_ & x09) | (x07 & x08 & (x09 | ~x19));
