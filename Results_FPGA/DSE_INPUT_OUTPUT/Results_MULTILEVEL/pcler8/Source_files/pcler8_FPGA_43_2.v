...
module FAU ( 
  ...
  assign new_n64_ = x20 & (~x19 | (new_n62_ & new_n61_ & x12));
  assign z11 = (x02 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = x19 ? (~x20 | (x21 & (~new_n49_ | ~new_n48_ | ~x13))) : ~x21;
  assign z12 = z04 | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x20 & ((x19 & x21 & (new_n69_ | ~x22)) | (~x21 & x22))) | (~x19 & x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | new_n51_ | (x04 & x08);
  assign new_n71_ = (~x19 | ~x21 | ((~x22 | (~new_n72_ & x23)) & (~x20 | x22 | ~x23))) & (~x23 | (x19 & x21));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x19 & (new_n74_ | ~x20)) | (x05 & x08) | (new_n75_ & ~x08);
  assign new_n74_ = ~x08 & x09 & ~x10 & new_n61_ & x23 & ~x24;
  ...
  assign new_n78_ = x19 & (~x20 | (new_n47_ & new_n48_ & x24 & ~x25));
  assign new_n79_ = x25 & (~new_n80_ | ~new_n61_ | ~x19);
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x07 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x19 | ~x26) & (~x20 | ((new_n83_ | ~x26) & (~new_n84_ | ~new_n61_ | ~x19)));
  assign new_n83_ = ~x18 & x21 & x22 & x23 & x24 & x25;
