...
module FAU ( 
  ...
  assign z09 = z01 | (~x08 & x09 & (new_n57_ | (~x10 & ~x19)));
  ...
  assign new_n73_ = x20 & (x10 | (new_n74_ & ~x08 & x09 & x19));
  assign new_n74_ = x21 & x22 & x23 & ~x24;
  assign new_n75_ = x24 & (~new_n76_ | ~new_n77_);
  assign new_n76_ = x19 & x20 & x21;
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & x08 & (~x10 | ~x20));
  assign new_n79_ = (~x25 | (new_n76_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n76_ | ~new_n63_ | ~x24 | x25);
  assign z16 = (~new_n81_ & x20) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n81_ = ~x10 & (~new_n82_ | ~x19 | ~x21 | x08 | ~x09);
  assign new_n82_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | ~new_n63_ | ~x24 | ~x25);
