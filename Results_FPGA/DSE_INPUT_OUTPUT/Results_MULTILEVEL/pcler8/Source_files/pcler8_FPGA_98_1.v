...
module FAU ( 
  ...
  assign new_n64_ = ~x20 & (x24 | (~x08 & x09 & ~x10 & x19));
  ...
  assign new_n72_ = (~x22 | ((~x19 | ~x21 | (~new_n73_ & (~x20 | x23))) & (~x20 | ~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & new_n75_ & ~x10);
  assign new_n75_ = x20 & ((x24 & (~new_n76_ | ~x22 | new_n77_ | ~x23)) | (new_n76_ & x22 & x23 & ~x24));
  assign new_n76_ = x19 & x21;
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((x20 & (new_n81_ | (~new_n80_ & x25))) | (~x24 & x25));
  assign new_n80_ = x19 & x21 & x22 & x23 & (~x17 | ~x26);
  assign new_n81_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (x24 & (new_n83_ | ~x20)) | (x07 & x08) | (new_n85_ & ~x08);
  assign new_n83_ = new_n84_ & ~x08 & x09 & ~x10 & x19;
  assign new_n84_ = x21 & x22 & x23 & x25 & ~x26;
  assign new_n85_ = x09 & ~x10 & x26 & (~new_n86_ | ~new_n76_ | x18);
