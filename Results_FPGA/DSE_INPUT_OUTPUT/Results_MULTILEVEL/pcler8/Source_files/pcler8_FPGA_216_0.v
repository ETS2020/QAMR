...
module FAU ( 
  ...
  assign z10 = (x01 & (x08 | (new_n63_ & x09 & ~x10))) | (~x08 & x09 & new_n62_ & ~x10);
  ...
  assign z12 = (x01 & (new_n70_ | (x03 & x08))) | (x20 & (x08 ? x03 : new_n68_));
  ...
  assign new_n88_ = ~x20 & (~x01 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n95_ = ~x20 & (~x01 | (~x08 & x09 & ~x10 & x26));
endmodule
