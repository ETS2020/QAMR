...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n60_, new_n63_, new_n64_,
  ...
  assign new_n66_ = (x12 | ((~x19 | ~x20 | ~x21 | (~new_n67_ & x22)) & (~x22 | (x20 & x21)))) & (x19 | ~x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x19 | ~x23) & (x12 | ((~x23 | (x20 & x21)) & (~x19 | ~x20 | new_n70_ | ~x21)));
  assign new_n70_ = x22 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (x19 | ~x24) & (x12 | (((new_n73_ & new_n74_) | ~x24) & (~new_n75_ | ~new_n73_ | ~x19)));
  ...
  assign new_n77_ = ~x12 & (~new_n78_ | x08 | ~x09 | x10 | ~x20);
  assign new_n78_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n79_ = ~x10 & x25 & (~new_n80_ | ~new_n73_ | ~x19);
  assign new_n80_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n82_ | (~x08 & x09 & ~x10 & (new_n83_ | new_n88_));
  assign new_n82_ = x07 & ~new_n50_ & x08;
  assign new_n83_ = ~x12 & ((new_n86_ & new_n87_) | ((~new_n84_ | ~new_n85_) & x26));
