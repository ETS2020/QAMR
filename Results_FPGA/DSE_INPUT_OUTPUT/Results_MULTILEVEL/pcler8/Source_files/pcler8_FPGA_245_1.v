...
module FAU ( 
  ...
  assign z12 = (x03 & (x08 | (x09 & ~new_n67_ & ~x10))) | (~x08 & x09 & new_n69_ & ~x10);
  assign new_n67_ = (~x22 | (x19 & ~new_n68_ & x21)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x20 & x22;
  assign z13 = (x20 & (new_n71_ | ~x03)) | (x04 & x08) | (new_n73_ & ~x08);
  ...
  assign new_n76_ = (x20 | ~x24) & (~x03 | (~new_n78_ & ((new_n72_ & new_n77_) | ~x24)));
