...
module FAU ( 
  ...
  assign new_n64_ = (~x23 | (x20 & (x24 | (x19 & x21 & x22)))) & (~x19 | ~x20 | ~x21 | ~x22 | x23 | x24);
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (x20 | ~x24) & (~x22 | ~x23 | x24 | ~x19 | ~x20 | ~x21);
