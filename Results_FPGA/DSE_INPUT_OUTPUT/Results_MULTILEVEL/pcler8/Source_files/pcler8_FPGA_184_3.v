...
module FAU ( 
  ...
  assign new_n63_ = x09 & ~x10 & ((~x12 & ~x19 & x20) | (x19 & ~x20));
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((~x20 & x21) | (~x12 & x20 & (x19 ? (new_n66_ | ~x21) : x21)));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n68_ | x12)) | (new_n69_ & ~x08) | (x03 & x08);
  assign new_n68_ = new_n60_ & x19 & x21 & ~x22;
  assign new_n69_ = x09 & ~x10 & x22 & (~new_n70_ | ~x19 | ~x20);
  assign new_n70_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign z13 = (~x08 & x09 & ~new_n72_ & ~x10) | new_n50_ | (x04 & x08);
  ...
  assign new_n75_ = ~x12 & (~new_n76_ | x08 | ~x09 | x10 | ~x19);
  assign new_n76_ = x21 & x22 & x23 & ~x24;
  assign new_n77_ = ~x10 & (~new_n78_ | ~new_n79_) & x24;
  assign new_n78_ = x19 & x20 & x21;
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n81_ | new_n85_));
  assign new_n81_ = ~x12 & ((new_n78_ & new_n84_) | (x25 & (~new_n82_ | ~new_n83_)));
  assign new_n82_ = x19 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign new_n85_ = ~x20 & x25;
  assign z16 = new_n87_ | (~x08 & x09 & ~x10 & (new_n88_ | new_n93_));
  assign new_n87_ = x07 & ~new_n50_ & x08;
  assign new_n88_ = ~x12 & ((new_n91_ & new_n92_) | ((~new_n89_ | ~new_n90_) & x26));
