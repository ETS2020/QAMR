...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n61_, new_n63_,
    new_n64_, new_n66_, new_n68_, new_n69_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n75_, new_n77_, new_n78_, new_n79_, new_n80_, new_n82_,
    new_n83_, new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n90_,
    new_n91_, new_n92_, new_n93_;
  assign z00 = (~x15 & ~x20) | (new_n47_ & new_n50_ & ~x10 & x19 & x20);
  ...
  assign z09 = new_n61_ | (new_n47_ & new_n50_ & ~x10 & x11 & x20);
  assign new_n61_ = ~new_n52_ & ((x00 & x08) | (~x08 & x09 & ~x10 & ~x19));
  assign z10 = z02 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = x20 ? (x19 & (~new_n64_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = x20 ? (x19 ? (x21 & (~new_n49_ | ~new_n48_ | ~x13)) : ~x21) : ~x21;
  assign z12 = new_n68_ | (x03 & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n68_ = ~x20 & (~x15 | (new_n50_ & ~x10 & x22));
  assign new_n69_ = (~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~x10 & (new_n72_ | new_n75_));
  assign new_n72_ = x20 & x22 & (~new_n74_ | (x15 & new_n73_ & x24));
  assign new_n73_ = x25 & x26 & ((x19 & x21) | (x14 & x23));
  assign new_n74_ = (~x23 | (x19 & x21)) & (~x19 | ~x21 | x23);
  assign new_n75_ = x23 & (~x20 | ~x22);
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x20 | ((~new_n78_ | ~new_n80_) & (~x24 | (new_n78_ & new_n79_)))) & (~x15 | x20 | ~x24);
  ...
  assign new_n82_ = ~x20 & (~x15 | (new_n50_ & ~x10 & x25));
  assign new_n83_ = (~x25 | (new_n84_ & new_n85_)) & (~new_n86_ | ~new_n48_ | ~x24 | x25);
  assign new_n84_ = x19 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x19 & x20 & x21;
  assign z16 = new_n88_ | (~x08 & x09 & ~x10 & (new_n89_ | new_n93_));
  assign new_n88_ = x07 & ~new_n52_ & x08;
  assign new_n89_ = x20 & ((new_n84_ & new_n92_) | (x26 & (~new_n90_ | ~new_n91_)));
  assign new_n90_ = ~x18 & x19 & x21;
  assign new_n91_ = x22 & x23 & x24 & x25;
  assign new_n92_ = x23 & x24 & x25 & ~x26;
  assign new_n93_ = x15 & ~x20 & x26;
endmodule
