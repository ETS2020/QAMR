...
module FAU ( 
  ...
  assign z10 = ~new_n63_ | (x12 & (new_n61_ | ~x19));
  assign new_n61_ = new_n62_ & x22 & x23 & x24 & x25 & x26;
  assign new_n62_ = ~x08 & x09 & ~x10 & x21;
  assign new_n63_ = x08 ? ~x01 : (~x09 | x10 | (~x19 ^ x20));
  assign z11 = (~x19 & (new_n62_ | x12)) | (x02 & x08) | (new_n65_ & ~x08);
  assign new_n65_ = x09 & ~x10 & x19 & (x20 ? (new_n66_ | ~x21) : x21);
  ...
  assign new_n73_ = ~x12 & ~x19 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | ((~x24 | (new_n76_ & new_n77_)) & (~new_n76_ | ~new_n78_))) & (x12 | x19 | ~x24);
  ...
  assign new_n80_ = (~x25 | (new_n81_ & new_n82_)) & (~new_n83_ | ~new_n76_ | ~x19);
  ...
  assign z16 = new_n86_ | (~x08 & x09 & ~x10 & (new_n87_ | new_n91_));
  assign new_n86_ = x07 & ~new_n49_ & x08;
  assign new_n87_ = x19 & ((x26 & (~new_n88_ | ~new_n89_)) | (new_n81_ & new_n90_));
