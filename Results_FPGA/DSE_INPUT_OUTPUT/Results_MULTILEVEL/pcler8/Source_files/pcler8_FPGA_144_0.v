...
module FAU ( 
  ...
  assign z10 = new_n62_ | (x01 & x08) | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & (~x20 | (new_n59_ & x12 & x21 & x22));
  assign new_n62_ = ~x19 & (~x20 | (~x08 & x09 & ~x10));
  ...
  assign z12 = (~x08 & new_n67_ & x09) | (x03 & ~new_n49_ & x08);
  ...
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n85_ | new_n87_));
  assign new_n85_ = x20 & ((~x19 & x26) | (new_n86_ & x19 & x21 & x22));
