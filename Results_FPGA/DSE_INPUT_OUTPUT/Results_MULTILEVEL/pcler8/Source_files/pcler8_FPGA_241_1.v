...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n63_ & ~x10) | (x01 & ~new_n50_ & x08);
  assign new_n63_ = (~x14 | ~x20 | (x19 & (~new_n61_ | ~new_n60_ | ~x12))) & (~x19 | x20);
  assign z11 = (x02 & ~new_n50_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x14 & x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & ~new_n50_ & x08);
  assign new_n68_ = (x20 | ~x22) & (~x14 | ((~x22 | (x19 & ~new_n61_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = ~new_n72_ & (~x23 | (x20 & x22 & (~x14 | ~x20 | new_n71_ | ~x22)));
  assign new_n71_ = x19 & x21 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n72_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = new_n74_ | (x05 & x08) | (~x08 & x09 & new_n76_ & ~x10);
  assign new_n74_ = x20 & (~x14 | (new_n75_ & new_n60_ & x23 & ~x24));
  ...
  assign new_n79_ = x14 & (~new_n75_ | ~new_n60_ | ~x23 | ~x24 | x25);
  assign new_n80_ = ~x10 & x25 & (~new_n81_ | ~x19 | ~x20 | ~x21);
  assign new_n81_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n83_ | new_n88_));
  assign new_n83_ = x14 & ((new_n86_ & new_n87_) | (x26 & (~new_n84_ | ~new_n85_)));
