...
module FAU ( 
  ...
  assign z11 = (x13 & (new_n63_ | ~x20)) | (x02 & x08) | (new_n65_ & ~x08);
  assign new_n63_ = new_n64_ & ~x08 & x09 & ~x10 & x19;
  assign new_n64_ = x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = x09 & ~x10 & (x20 ? (x19 ^ x21) : x21);
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x20 | ((~x22 | (x19 & ~new_n68_ & x21)) & (~x19 | ~x21 | x22))) & (x13 | x20 | ~x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & x09 & ~new_n70_ & ~x10) | new_n49_ | (x04 & x08);
  assign new_n70_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = (~x08 & x09 & ~new_n73_ & ~x10) | (x05 & ~new_n49_ & x08);
  assign new_n73_ = (~x20 | ((~x24 | (new_n74_ & new_n75_)) & (~new_n74_ | ~new_n76_))) & (x13 | x20 | ~x24);
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x22 & x23 & ~x24;
  assign z15 = new_n83_ | (x06 & x08) | (~x08 & new_n78_ & x09);
  ...
  assign new_n83_ = ~x20 & (x13 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n90_ = ~x20 & (x13 | (~x08 & x09 & ~x10 & x26));
endmodule
