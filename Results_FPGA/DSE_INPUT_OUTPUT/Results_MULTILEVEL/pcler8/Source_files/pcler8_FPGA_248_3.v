...
module FAU ( 
  ...
  assign new_n80_ = x20 & (x10 | (new_n81_ & new_n64_ & x24 & ~x25));
  assign new_n81_ = ~x08 & x09 & x19 & x21;
  assign new_n82_ = x25 & (~new_n83_ | ~x19 | ~x20 | ~x21);
  assign new_n83_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n85_ & x20) | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n85_ = ~x10 & (~new_n81_ | ~new_n64_ | ~x24 | ~x25 | x26);
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | ~new_n64_ | ~x24 | ~x25);
