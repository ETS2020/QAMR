...
module FAU ( 
  ...
  assign new_n63_ = x20 ? (x19 ? (~new_n64_ & x21) : ~x21) : ~x21;
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x22 | (~new_n67_ & x21 & x19 & x20)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (~x10 | x20)) | (~x08 & x09 & ~new_n69_ & ~x10);
  ...
  assign z15 = new_n79_ | (x06 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x25 | (new_n77_ & new_n58_ & x19)) & (~new_n73_ | ~new_n78_);
  assign new_n77_ = x23 & x24 & (~x17 | ~x26);
  assign new_n78_ = x22 & x23 & x24 & ~x25;
  assign new_n79_ = ~x20 & (x10 | (~x08 & x09 & x25));
  assign z16 = new_n86_ | (x07 & x08) | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((new_n84_ & new_n85_) | (x26 & (~new_n82_ | ~new_n83_)));
  assign new_n82_ = ~x18 & x19 & x21;
  assign new_n83_ = x22 & x23 & x24 & x25;
  assign new_n84_ = x19 & x20 & x21 & x22;
  assign new_n85_ = x23 & x24 & x25 & ~x26;
  assign new_n86_ = ~x20 & (x10 | (~x08 & x09 & x26));
endmodule
