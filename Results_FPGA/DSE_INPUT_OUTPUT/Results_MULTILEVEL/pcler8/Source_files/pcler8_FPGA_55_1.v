...
module FAU ( 
  ...
  assign z10 = z02 | (~x08 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x20 | (x19 & (~new_n61_ | ~new_n60_ | ~x12))) & (~x09 | ~x19 | x20);
  assign z11 = (~x08 & x09 & ~new_n65_ & ~x10) | (x02 & x08 & (x09 | ~x20));
  ...
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & x08 & (x09 | ~x20));
  assign new_n71_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n72_ = x25 & x26 & x15 & x24;
  assign z14 = (x20 & (new_n74_ | ~x09)) | (x05 & x08) | (~x08 & new_n75_ & x09);
  assign new_n74_ = ~x08 & ~x10 & x19 & new_n60_ & x23 & ~x24;
  assign new_n75_ = ~x10 & x24 & (~new_n76_ | ~x19 | ~x20 | ~x21);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = new_n78_ | (x06 & x08) | (~x08 & x09 & new_n79_ & ~x10);
  assign new_n78_ = x20 & (~x09 | (new_n47_ & new_n48_ & x24 & ~x25));
  assign new_n79_ = x25 & (~new_n80_ | ~x19 | ~x20 | ~x21);
  assign new_n80_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (x20 & (new_n82_ | ~x09)) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n82_ = new_n47_ & new_n48_ & x24 & x25 & ~x26;
