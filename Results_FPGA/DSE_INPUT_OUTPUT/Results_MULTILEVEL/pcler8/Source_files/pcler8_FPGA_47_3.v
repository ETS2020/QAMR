...
module FAU ( 
  ...
  assign new_n57_ = (x08 | x19) & (~new_n59_ | ~new_n58_ | ~x11 | ~x20);
  assign new_n58_ = x21 & x22;
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (x08 | ~x19 | (x20 & (~new_n59_ | ~new_n58_ | ~x12))) & (x19 | ~x20);
  assign z11 = (new_n63_ & x09) | (x08 & (x02 | x20));
  assign new_n63_ = ~x10 & ((~x08 & x21 & (~x19 | (x19 & ~x20))) | (x19 & x20 & (new_n64_ | ~x21)));
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x20 & ((x03 & x08) | (new_n68_ & ~x08 & x09))) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x22 & (~x19 | new_n67_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign new_n68_ = ~x10 & x22;
  assign z13 = (~x08 & x09 & ~new_n70_ & ~x10) | (x04 & x08 & ~x20);
  assign new_n70_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = new_n77_ | (~x08 & x09 & ~new_n73_ & ~x10);
  ...
  assign new_n77_ = ~x20 & ((x05 & x08) | (~x08 & x09 & ~x10 & x24));
  assign z15 = (new_n79_ & x09) | (x08 & (x06 | x20));
  assign new_n79_ = ~x10 & ((~x08 & x25 & (~new_n74_ | ~new_n80_)) | (new_n74_ & new_n81_));
  assign new_n80_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (x09 & ~x10 & (new_n85_ | (new_n83_ & ~x08)));
  assign new_n83_ = x26 & (~new_n84_ | ~x20 | ~x21 | x18 | ~x19);
  assign new_n84_ = x22 & x23 & x24 & x25;
  assign new_n85_ = new_n86_ & new_n58_ & x19 & x20;
