...
module FAU ( 
  ...
  assign z12 = new_n67_ | (x03 & x08) | (~x08 & x09 & new_n69_ & ~x10);
  assign new_n67_ = x20 & (~x23 | (new_n68_ & x19 & x21 & ~x22));
  assign new_n68_ = ~x08 & x09 & ~x10;
  assign new_n69_ = x22 & ((~new_n71_ & x23) | ~x23 | (new_n70_ & x14 & x24));
  assign new_n70_ = x25 & x26;
  assign new_n71_ = x19 & x20 & x21;
  assign z13 = new_n67_ | (x04 & x08) | (~x08 & x09 & new_n73_ & ~x10);
  assign new_n73_ = x23 & ((~new_n71_ & x22) | ~x22 | (new_n70_ & x15 & x24));
  assign z14 = (~new_n75_ & x20) | (x05 & x08) | (new_n76_ & ~x08);
  assign new_n75_ = x23 & (~new_n68_ | ~x19 | ~x21 | ~x22 | x24);
  ...
  assign z16 = (x07 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x20 | ~x26) & (~x23 | ((new_n84_ | ~x26) & (~new_n71_ | ~new_n85_)));
