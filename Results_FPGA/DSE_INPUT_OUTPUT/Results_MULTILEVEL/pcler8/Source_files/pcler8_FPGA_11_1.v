...
module FAU ( 
  ...
  assign z00 = x20 & (new_n47_ | ~x07);
  assign new_n47_ = new_n49_ & new_n50_ & ~x08 & x09 & new_n48_ & ~x10;
  ...
  assign z10 = (~x08 & x09 & ~new_n64_ & ~x10) | new_n52_ | (x01 & x08);
  ...
  assign new_n67_ = ~x10 & ((x07 & (x19 ? (x20 & (new_n68_ | ~x21)) : x21)) | (~x20 & x21));
  ...
  assign z13 = (x20 & (new_n73_ | ~x07)) | (new_n74_ & ~x08) | (x04 & x08);
  ...
  assign z14 = (~x08 & x09 & ~new_n77_ & ~x10) | (x05 & ~new_n52_ & x08);
  assign new_n77_ = (x20 | ~x24) & (~x07 | (~new_n79_ & (~x24 | (new_n48_ & new_n78_))));
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & x09 & new_n84_ & ~x10);
  assign new_n81_ = x20 & (~x07 | (new_n82_ & new_n83_));
  assign new_n82_ = ~x08 & x09 & ~x10 & x19;
  assign new_n83_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n84_ = x25 & (~new_n85_ | ~x19 | ~x20 | ~x21);
  assign new_n85_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (x08 & (x07 | x20)) | (x20 & (new_n87_ | ~x07)) | (~x08 & new_n89_ & x09);
  assign new_n87_ = new_n88_ & new_n48_ & x09 & ~x10;
  assign new_n88_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n49_ | ~x24 | ~x25);
