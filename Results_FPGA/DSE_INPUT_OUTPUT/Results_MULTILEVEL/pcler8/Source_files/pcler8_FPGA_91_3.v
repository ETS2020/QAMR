...
module FAU ( 
  ...
  assign new_n57_ = x09 & ~x10 & (x19 ? ~x20 : (x20 & ~x23));
  assign z11 = (x02 & ~new_n47_ & x08) | (new_n59_ & ~x08);
  assign new_n59_ = x09 & ~x10 & (x20 ? (~x23 & (x19 ^ x21)) : x21);
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & ((x22 & (~x20 | (~x23 & (~x19 | ~x21)))) | (x19 & x20 & x21 & ~x22 & ~x23));
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((~x20 & x23) | (x19 & x20 & x21 & x22 & ~x23));
