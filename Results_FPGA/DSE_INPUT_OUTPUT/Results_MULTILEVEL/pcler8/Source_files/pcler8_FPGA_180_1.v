...
module FAU ( 
  ...
  assign z06 = x05 & x08;
  assign z07 = (~x05 & x20) | (x06 & x08 & (~x20 | (x05 & x20)));
  ...
  assign new_n60_ = x05 & ~x08 & x09 & ~x10 & x11 & x20;
  assign new_n61_ = x22 & x23;
  assign new_n62_ = x24 & x25 & x26;
  assign z10 = (x01 & ~new_n50_ & x08) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x05 & x20 & ((new_n65_ & new_n66_) | ~x19)) | (x19 & ~x20));
  ...
  assign z14 = (x08 & (x05 | x20)) | (x20 & (new_n77_ | ~x05)) | (~x08 & new_n79_ & x09);
  assign new_n77_ = new_n78_ & x09 & ~x10 & x19;
  ...
  assign new_n82_ = x05 & (~new_n83_ | x08 | ~x09 | x10 | ~x19);
