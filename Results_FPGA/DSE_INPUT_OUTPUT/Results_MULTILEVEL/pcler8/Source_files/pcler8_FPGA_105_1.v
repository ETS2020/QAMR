...
module FAU ( 
  ...
  wire new_n47_, new_n57_, new_n58_, new_n59_, new_n61_, new_n63_, new_n64_,
    ...
    new_n75_, new_n77_, new_n79_, new_n80_, new_n81_, new_n82_;
  ...
  assign z14 = (~x08 & x09 & ~new_n73_ & ~x10) | (x05 & x08 & (x09 | ~x20));
  ...
  assign z16 = (x20 & (new_n79_ | ~x09)) | (x07 & x08) | (~x08 & new_n81_ & x09);
  assign new_n79_ = new_n80_ & x19 & x21 & ~x08 & ~x10;
  assign new_n80_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n81_ = ~x10 & x26 & (~new_n82_ | ~new_n64_ | ~x24 | ~x25);
