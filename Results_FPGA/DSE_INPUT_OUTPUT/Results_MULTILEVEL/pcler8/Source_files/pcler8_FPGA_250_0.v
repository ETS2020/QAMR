...
module FAU ( 
  ...
  assign z11 = (~x08 & x09 & ~new_n65_ & ~x10) | new_n49_ | (x02 & x08);
  assign new_n65_ = (~x19 | (~x20 ^ x21)) & (~x21 | (x19 & (~new_n60_ | ~new_n66_ | ~x13)));
  ...
  assign z13 = (~x08 & x09 & ~new_n72_ & ~x10) | (x04 & ~new_n49_ & x08);
  assign new_n72_ = (~x21 | ~x22 | ((~x19 | ~x20 | (~new_n73_ & x23)) & (~x23 | (x19 & x20)))) & (~x23 | (x21 & x22));
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (~x08 & x09 & ~new_n75_ & ~x10) | (x05 & ~new_n49_ & x08);
  assign new_n75_ = (~x21 | ((x23 | ~x24) & (~new_n76_ | ~x22 | ~x23 | x24))) & (~x23 | ~x24 | (new_n76_ & x21 & ~new_n77_ & x22));
  assign new_n76_ = x19 & x20;
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = new_n83_ | (x06 & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | (new_n80_ & new_n81_)) & (~new_n82_ | ~new_n66_ | ~x24 | x25);
  assign new_n80_ = x19 & x20 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x19 & x20 & x21;
  assign new_n83_ = ~x21 & (~x23 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n90_ = ~x21 & (~x23 | (~x08 & x09 & ~x10 & x26));
endmodule
