...
module FAU ( 
  ...
  assign z13 = (x04 & x08 & (x10 | x20)) | (~x08 & x09 & ~x10 & ~new_n69_ & x20);
  assign new_n69_ = x22 ? ((~x19 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x19 & x21))) : ~x23;
  ...
  assign z15 = (x06 & x08) | (~x10 & (~x20 | (~x08 & ~new_n75_ & x09)));
