...
module FAU ( 
  ...
  assign new_n61_ = (x08 | ((x19 | ~x20) & (~new_n59_ | ~new_n58_ | ~x12 | ~x19))) & (~x19 | x20);
  assign z11 = (~x08 & x09 & ~new_n63_ & ~x10) | (x02 & x08 & x20);
  assign new_n63_ = x19 ? (x20 ? (~new_n64_ & x21) : ~x21) : ~x21;
  ...
  assign z15 = z07 | (x09 & ~x10 & (new_n80_ | (~x20 & x25)));
  ...
  assign z16 = z08 | (x09 & ~x10 & (new_n85_ | (~x20 & x26)));
  assign new_n85_ = ~x08 & ((new_n88_ & new_n89_) | (x26 & (~new_n86_ | ~new_n87_)));
