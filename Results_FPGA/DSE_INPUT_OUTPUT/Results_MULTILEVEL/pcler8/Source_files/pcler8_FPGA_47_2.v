...
module FAU ( 
  ...
  assign z11 = (x08 & (x02 | ~x20)) | (new_n63_ & x09);
  assign new_n63_ = ~x10 & ((~x08 & (x19 ? (x20 & (new_n64_ | ~x21)) : x21)) | (x19 & ~x20 & x21));
  ...
  assign z14 = (~new_n73_ & x20) | (~x08 & x09 & new_n75_ & ~x10);
  assign new_n73_ = (~x05 | ~x08) & (~new_n74_ | x10 | ~x19 | x08 | ~x09);
  ...
  assign z15 = new_n83_ | (x09 & ~x10 & (new_n79_ | (~x20 & x25)));
  assign new_n79_ = ~x08 & ((new_n76_ & new_n82_) | (x25 & (~new_n80_ | ~new_n81_)));
  assign new_n80_ = x19 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x22 & x23 & x24 & ~x25;
  assign new_n83_ = x08 & (x06 | ~x20);
