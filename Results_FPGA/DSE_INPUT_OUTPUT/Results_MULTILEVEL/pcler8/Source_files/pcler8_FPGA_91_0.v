...
module FAU ( 
  ...
  assign z10 = (x01 & ~new_n49_ & x08) | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (x19 & ~x20 & x23));
  ...
  assign z12 = (~new_n49_ & (x08 ? x03 : (new_n71_ & x09))) | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & ((new_n70_ & x22) | (x19 & x20 & x21 & ~x22));
  assign new_n70_ = x23 & (~x20 | (x25 & x26 & x14 & x24));
  assign new_n71_ = ~x10 & x22 & (~x19 | ~x21);
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x23 | (~new_n74_ & x22 & (~x22 | (x19 & x20 & x21)))) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = new_n79_ | (x05 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (new_n77_ & x19 & x21)) & (~new_n78_ | ~x19 | ~x20 | ~x21);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign new_n79_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (new_n82_ | ~x23) & (~x20 | ~x25 | (new_n83_ & new_n84_ & x23));
  assign new_n82_ = (x20 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x24 | x25);
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = x24 & (~x17 | ~x26);
  assign z16 = new_n91_ | (~x08 & new_n86_ & x09) | (x07 & x08);
  ...
  assign new_n91_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x26));
endmodule
