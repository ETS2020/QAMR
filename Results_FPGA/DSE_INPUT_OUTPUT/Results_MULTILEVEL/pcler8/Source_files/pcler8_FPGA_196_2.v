...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((x25 & (x19 ? (x20 & (new_n65_ | ~x21)) : x21)) | (~x20 & x21));
  ...
  assign new_n68_ = x24 & x26 & x14 & x23;
  ...
  assign new_n73_ = (~x24 | (x20 & (new_n75_ | ~x25))) & (~new_n76_ | ~new_n74_ | x24 | ~x25);
  ...
  assign new_n78_ = x25 & (~new_n76_ | ~new_n74_ | ~x24 | (x17 & x26));
  assign z16 = (~x08 & x09 & ~new_n80_ & ~x10) | (x07 & ~new_n50_ & x08);
  assign new_n80_ = (~x25 | ((new_n81_ | ~x26) & (~new_n76_ | ~new_n82_))) & (x20 | ~x26);
