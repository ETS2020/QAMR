...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n59_ & ~x10);
  assign new_n59_ = x19 & (~new_n60_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n60_ = x25 & x26 & x23 & x24;
  assign z10 = (x01 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = x20 ? (x19 & (~new_n60_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = (x02 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = x20 ? (x19 ? (x21 & (~new_n49_ | ~new_n48_ | ~x13)) : ~x21) : ~x21;
  assign z12 = (x20 & (new_n68_ | ~x09)) | (x03 & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & x22 & (~new_n67_ | ~x19 | ~x20);
  assign new_n67_ = x21 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n68_ = ~x08 & ~x10 & x19 & x21 & ~x22;
  assign z13 = (x20 & (new_n72_ | ~x09)) | (x04 & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & x23 & (~new_n71_ | ~x19 | ~x20);
  assign new_n71_ = x21 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  ...
  assign z15 = (x06 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n78_ & ~x10);
