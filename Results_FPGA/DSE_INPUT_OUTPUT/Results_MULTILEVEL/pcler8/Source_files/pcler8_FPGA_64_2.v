...
module FAU ( 
  ...
  assign z00 = (x10 & ~x13) | (new_n47_ & ~x08 & x09 & new_n50_ & ~x10);
  ...
  assign z11 = (~x08 & x09 & ~new_n65_ & ~x10) | (x02 & x08 & (~x10 | x13));
  assign new_n65_ = x19 ? (x20 ? (x21 & (~new_n49_ | ~new_n48_ | ~x13)) : ~x21) : ~x21;
  assign z12 = (~x08 & x09 & ~new_n67_ & ~x10) | (x10 & ~x13) | (x03 & x08);
  assign new_n67_ = (~x22 | (new_n50_ & x21 & (~new_n49_ | ~x14 | ~x23))) & (~new_n50_ | ~x21 | x22);
  assign z13 = (~x08 & x09 & ~new_n69_ & ~x10) | (x04 & x08 & (~x10 | x13));
