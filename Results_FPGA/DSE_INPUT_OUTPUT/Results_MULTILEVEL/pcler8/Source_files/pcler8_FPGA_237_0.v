...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n63_ & ~x10) | new_n47_ | (x01 & x08);
  ...
  assign new_n69_ = ~x20 & (~x04 | (~x10 & x22 & ~x08 & x09));
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & x08) | (~x04 & ~x20);
  assign new_n71_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x21)))) & ((x20 & x22) | ~x23);
  ...
  assign new_n78_ = ~x20 & (~x04 | (~x10 & x24 & ~x08 & x09));
