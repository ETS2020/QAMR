...
module FAU ( 
  ...
  assign z14 = (x05 & (x08 | ~x20)) | (~x08 & new_n75_ & x09);
  ...
  assign z15 = (~x05 & (new_n79_ | (x06 & x08))) | (x20 & (x08 ? x06 : new_n80_));
  assign new_n79_ = new_n47_ & ~x10 & ~x20 & x25;
  assign new_n80_ = x09 & ~x10 & ((x25 & (~new_n81_ | ~new_n82_)) | (new_n81_ & new_n83_));
  ...
  assign new_n85_ = ~x20 & (x05 | (new_n47_ & ~x10 & x26));
