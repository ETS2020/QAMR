...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x10 | ~x20)) | (~x08 & x09 & ~new_n61_ & ~x10);
  ...
  assign z13 = (x04 & x08 & (~x10 | ~x20)) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x20 & (new_n74_ | x10)) | (x05 & x08) | (new_n75_ & ~x08);
  assign new_n74_ = ~x08 & x09 & x19 & new_n58_ & x23 & ~x24;
  assign new_n75_ = x09 & ~x10 & x24 & (~new_n76_ | ~new_n77_);
  assign new_n76_ = x19 & x20 & x21;
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = new_n79_ | (x06 & x08) | (~x08 & x09 & new_n81_ & ~x10);
  assign new_n79_ = x20 & (x10 | (new_n80_ & new_n64_ & x24 & ~x25));
  assign new_n80_ = ~x08 & x09 & x19 & x21;
  assign new_n81_ = x25 & (~new_n76_ | ~new_n64_ | ~x24 | (x17 & x26));
