...
module FAU ( 
  ...
  assign new_n60_ = new_n61_ & x21 & x24 & x25 & x26;
  ...
  assign new_n66_ = ~x10 & ((x20 & (x19 ? (new_n67_ | ~x21) : x21)) | (~x04 & ~x20 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = new_n69_ | (x03 & x08) | (~x08 & new_n70_ & x09);
  assign new_n69_ = ~x20 & (x04 | (new_n48_ & ~x10 & x22));
  assign new_n70_ = ~x10 & ((x22 & (~x19 | new_n71_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & (x08 | ~x20)) | (~x08 & x09 & ~new_n73_ & ~x10);
  ...
  assign new_n76_ = ~x20 & (x04 | (new_n48_ & ~x10 & x24));
  assign new_n77_ = (~x24 | (new_n78_ & x22 & ~new_n79_ & x23)) & (~new_n80_ | ~x22 | ~x23 | x24);
  ...
  assign new_n82_ = ~x20 & (x04 | (new_n48_ & ~x10 & x25));
  assign new_n83_ = (~x25 | (new_n84_ & new_n85_)) & (~new_n80_ | ~new_n61_ | ~x24 | x25);
  assign new_n84_ = x19 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n87_ | (x20 & (x08 ? x07 : (new_n89_ & x09)));
  assign new_n87_ = ~new_n88_ & ~x04;
  assign new_n88_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x26);
