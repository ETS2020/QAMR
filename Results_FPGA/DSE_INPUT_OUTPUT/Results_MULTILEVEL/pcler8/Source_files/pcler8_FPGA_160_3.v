...
module FAU ( 
  ...
  assign new_n72_ = (x15 | ((~x23 | (x19 & x21 & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23))) & (x20 | ~x23);
  assign z14 = (~new_n74_ & x20) | (x05 & x08) | (~x08 & new_n76_ & x09);
  assign new_n74_ = ~x15 & (~new_n75_ | x10 | ~x19 | x08 | ~x09);
  ...
  assign new_n80_ = x06 & ~new_n50_ & x08;
  assign new_n81_ = ~x15 & ((new_n77_ & new_n84_) | (x25 & (~new_n82_ | ~new_n83_)));
  ...
  assign new_n87_ = ~x15 & (~new_n89_ | ~new_n88_ | ~x24 | ~x25 | x26);
