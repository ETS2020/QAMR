...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & (x20 ? (x19 ? (new_n65_ | ~x21) : x21) : (x21 & ~x23));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n67_ & ~x10) | (x03 & ~new_n49_ & x08);
  assign new_n67_ = x20 ? ((~x22 | (x19 & ~new_n68_ & x21)) & (~x19 | ~x21 | x22)) : (~x22 | x23);
  ...
  assign z14 = (~new_n73_ & x23) | (x05 & x08) | (new_n75_ & ~x08);
  assign new_n73_ = x20 & (~new_n74_ | x08 | ~x09 | x10);
  assign new_n74_ = x19 & x21 & x22 & ~x24;
  assign new_n75_ = x09 & ~x10 & x24 & (~new_n76_ | ~x19 | ~x21);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x20 | ((new_n79_ | ~x25) & (~new_n80_ | ~x23 | ~x24 | x25))) & (x23 | ~x25);
  assign new_n79_ = x19 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n80_ = x19 & x21 & x22;
  assign z16 = (~x08 & x09 & ~new_n82_ & ~x10) | (x07 & ~new_n49_ & x08);
  assign new_n82_ = (x23 | ~x26) & (~x20 | ((new_n83_ | ~x26) & (~new_n80_ | ~new_n84_)));
