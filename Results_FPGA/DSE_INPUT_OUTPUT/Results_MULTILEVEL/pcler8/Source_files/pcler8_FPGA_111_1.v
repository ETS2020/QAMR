...
module FAU ( 
  ...
  assign new_n65_ = (~x19 | ~x20 | (x21 & (~new_n66_ | ~x13 | ~x22))) & (~x21 | (x19 & x20));
  assign new_n66_ = x24 & x25 & x26;
  assign z12 = new_n68_ | (~new_n50_ & (x08 ? x03 : new_n69_));
  assign new_n68_ = new_n48_ & ~x10 & x14 & new_n66_ & x22 & x23;
  assign new_n69_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x21 & ~x22 & x19 & x20));
  assign z13 = z05 | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((x23 & ((~new_n72_ & x22) | new_n73_ | ~x22)) | (new_n72_ & x22 & ~x23 & ~x26));
  assign new_n72_ = x19 & x20 & x21;
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = new_n75_ | (x05 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n75_ = ~x23 & (x26 | (new_n48_ & ~x10 & x24));
  assign new_n76_ = (~x24 | (x19 & x20 & new_n77_ & x21)) & (~new_n78_ | ~x19 | ~x20 | ~x21);
  assign new_n77_ = x22 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = new_n80_ | (x06 & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n80_ = ~x23 & (x26 | (new_n48_ & ~x10 & x25));
  assign new_n81_ = (~x25 | (new_n72_ & x22 & ~new_n82_ & x24)) & (~new_n72_ | ~x24 | x25 | ~x22 | ~x23);
