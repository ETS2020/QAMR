...
module FAU ( 
  ...
  assign z11 = (x02 & ~new_n47_ & x08) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (x06 & ~x20 & x21));
  ...
  assign new_n69_ = ~x20 & (~x06 | (~x10 & x22 & ~x08 & x09));
  ...
  assign new_n74_ = x06 & ~x20 & x23;
  assign z14 = new_n80_ | (x05 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  ...
  assign new_n80_ = ~x20 & (~x06 | (~x10 & x24 & ~x08 & x09));
  assign z15 = (x08 & (x06 | ~x20)) | (~x08 & new_n82_ & x09) | (~x20 & (~x06 | (new_n86_ & x09)));
  assign new_n82_ = ~x10 & ((new_n79_ & new_n85_) | ((~new_n83_ | ~new_n84_) & x25));
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = x23 & x24 & (~x17 | ~x26);
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign new_n86_ = ~x10 & x25;
  ...
  assign new_n93_ = ~x20 & (~x06 | (~x10 & x26 & ~x08 & x09));
endmodule
