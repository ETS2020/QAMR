...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((~x16 & (x19 ? (x20 & (new_n65_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n69_ | x16)) | (x03 & x08) | (new_n67_ & ~x08);
  ...
  assign z14 = ~new_n74_ | (x20 & (x16 | (new_n76_ & new_n77_)));
  assign new_n74_ = x08 ? ~x05 : (~x09 | ~new_n75_ | x10);
  assign new_n75_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign new_n76_ = ~x08 & x09 & ~x10 & x19;
  assign new_n77_ = x21 & x22 & x23 & ~x24;
  assign z15 = new_n79_ | (~x08 & x09 & ~x10 & (new_n80_ | new_n85_));
  assign new_n79_ = x06 & ~new_n50_ & x08;
  assign new_n80_ = ~x16 & ((new_n83_ & new_n84_) | ((~new_n81_ | ~new_n82_) & x25));
  ...
  assign new_n87_ = ~x16 & ((new_n90_ & new_n91_) | ((~new_n88_ | ~new_n89_) & x26));
