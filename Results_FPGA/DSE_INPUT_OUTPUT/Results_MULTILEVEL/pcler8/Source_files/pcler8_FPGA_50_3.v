...
module FAU ( 
  ...
  assign new_n73_ = (x08 | ~x24 | (new_n74_ & x22 & ~new_n75_ & x23)) & (~new_n74_ | ~x22 | ~x23 | x24);
  assign new_n74_ = x19 & x20 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign z15 = z07 | (x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x08 | ~x25 | (new_n74_ & new_n78_ & ~new_n79_ & x24)) & (~new_n74_ | ~new_n78_ | ~x24 | x25);
  assign new_n78_ = x22 & x23;
  assign new_n79_ = x17 & x26;
  assign z16 = z08 | (x09 & ~x10 & (new_n83_ | (new_n81_ & ~x08)));
  assign new_n81_ = x26 & (~new_n82_ | ~x20 | ~x21 | x18 | ~x19);
  assign new_n82_ = x22 & x23 & x24 & x25;
  assign new_n83_ = new_n84_ & new_n58_ & x19 & x20;
