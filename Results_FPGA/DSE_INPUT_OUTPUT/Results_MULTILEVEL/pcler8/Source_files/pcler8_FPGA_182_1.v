...
module FAU ( 
  ...
  assign z10 = (x01 & (x08 | (x09 & new_n63_ & ~x10))) | (~x08 & x09 & new_n65_ & ~x10);
  ...
  assign z15 = new_n82_ | (x06 & x08) | (~x08 & x09 & new_n85_ & ~x10);
  assign new_n82_ = x20 & ((new_n83_ & new_n84_) | ~x01);
  assign new_n83_ = ~x08 & x09 & ~x10 & x19;
  ...
  assign new_n88_ = x01 & ((new_n91_ & new_n92_) | ((~new_n89_ | ~new_n90_) & x26));
