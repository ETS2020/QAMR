...
module FAU ( 
  ...
  assign z13 = new_n74_ | (~x08 & x09 & ~x10 & (new_n75_ | new_n77_));
  assign new_n74_ = x04 & ~new_n49_ & x08;
  assign new_n75_ = x20 & (x22 ? ((x19 & x21 & (new_n76_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n76_ = x15 & x24 & x25 & x26;
  assign new_n77_ = ~x20 & x23 & x24;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x24 | (new_n80_ & x22 & x23 & (~new_n61_ | ~x16))) & (~new_n80_ | ~x22 | ~x23 | x24);
  assign new_n80_ = x19 & x20 & x21;
  assign z15 = new_n86_ | (x06 & x08) | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((new_n80_ & new_n85_) | (x25 & (~new_n83_ | ~new_n84_)));
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = x23 & x24 & (~x17 | ~x26);
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign new_n86_ = ~x20 & (~x24 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n88_ | (~x08 & x09 & ~x10 & (new_n89_ | new_n90_));
  assign new_n88_ = x07 & ~new_n49_ & x08;
  assign new_n89_ = x24 & ((~x20 & x26) | (new_n80_ & new_n60_ & x25 & ~x26));
