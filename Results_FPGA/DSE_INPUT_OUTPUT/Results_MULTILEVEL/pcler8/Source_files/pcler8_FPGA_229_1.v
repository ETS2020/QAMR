...
module FAU ( 
  ...
  assign z00 = x24 & (new_n47_ | ~x19);
  assign new_n47_ = new_n48_ & x21 & x22 & x23 & x25 & x26;
  ...
  assign new_n62_ = ~x19 & (new_n48_ | x24);
  assign new_n63_ = (~x19 | x20) & (~new_n60_ | ~x12 | ~x21 | ~x22);
  ...
  assign new_n71_ = x22 ? ((~x20 | ~x21 | (~new_n72_ & (~x19 | x23))) & (~x19 | ~x23 | (x20 & x21))) : ~x23;
  assign new_n72_ = x25 & x26 & x15 & x24;
  assign new_n73_ = ~x19 & (x24 | (~x08 & x09 & ~x10 & x23));
  assign z14 = new_n50_ | (x05 & x08) | (~x08 & new_n75_ & x09);
  ...
  assign new_n79_ = x24 & (~x19 | (new_n48_ & new_n80_));
  assign new_n80_ = x21 & x22 & x23 & ~x25;
  assign new_n81_ = x25 & (~new_n82_ | ~x23 | ~x24 | (x17 & x26));
  assign new_n82_ = x20 & x21 & x22;
  assign z16 = (~x08 & x09 & ~new_n84_ & ~x10) | (x07 & ~new_n50_ & x08);
  assign new_n84_ = (x24 | ~x26) & (~x19 | ((new_n85_ | ~x26) & (~new_n82_ | ~new_n86_)));
  assign new_n85_ = x22 & x23 & x25 & ~x18 & x20 & x21;
