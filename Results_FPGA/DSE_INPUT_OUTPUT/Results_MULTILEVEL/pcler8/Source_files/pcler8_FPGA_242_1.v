...
module FAU ( 
  ...
  assign new_n75_ = (x23 | ~x24) & (~x20 | ((~x24 | (new_n76_ & ~new_n77_ & x22)) & (~new_n76_ | ~x22 | ~x23 | x24)));
  assign new_n76_ = x19 & x21;
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = (~new_n79_ & x23) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n79_ = x20 & (~new_n80_ | ~x24 | x25 | ~x21 | ~x22);
  assign new_n80_ = ~x08 & x09 & ~x10 & x19;
  assign new_n81_ = ~x10 & x25 & (~new_n82_ | ~x19 | ~x21 | ~x22);
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x23 & (new_n84_ | ~x20)) | (x07 & x08) | (new_n85_ & ~x08);
  assign new_n84_ = new_n80_ & x21 & x22 & x24 & x25 & ~x26;
