...
module FAU ( 
  ...
  assign new_n61_ = ~x07 & ~x08 & x09 & ~x10 & x11 & x20;
  ...
  assign new_n66_ = ~x10 & ((~x07 & (x19 ? (x20 & (new_n67_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x20 | ~x22) & (x07 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x20 & (new_n72_ | x07)) | (new_n73_ & ~x08) | (x04 & x08);
  ...
  assign z14 = (~x08 & x09 & ~new_n76_ & ~x10) | (x05 & ~new_n51_ & x08);
  assign new_n76_ = (x20 | ~x24) & (x07 | (~new_n78_ & (~x24 | (new_n48_ & new_n77_))));
  ...
  assign new_n80_ = x20 & (x07 | (new_n81_ & new_n82_));
  assign new_n81_ = ~x10 & x19 & ~x08 & x09;
