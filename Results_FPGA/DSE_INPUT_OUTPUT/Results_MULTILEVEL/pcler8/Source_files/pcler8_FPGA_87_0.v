...
module FAU ( 
  ...
  assign z10 = (~x08 & ~new_n61_ & ~x10) | (x01 & x08) | (~x09 & ~x20);
  assign new_n61_ = (~x09 | ~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (~x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = z03 | (new_n64_ & ~x08);
  assign new_n64_ = ~x10 & ((x09 & x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n67_ & ~x10) | (x03 & x08 & (x09 | x20));
  ...
  assign z15 = (~x08 & x09 & ~new_n77_ & ~x10) | (x06 & x08 & (x09 | x20));
