...
module FAU ( 
  ...
  assign new_n60_ = ~x10 & (~x19 | (new_n49_ & new_n48_ & ~x02 & x11));
  ...
  assign new_n65_ = x19 ? (x20 ? (~new_n66_ & x21) : ~x21) : ~x21;
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (x02 | ((~x19 | ~x20 | ~x21 | (~new_n69_ & x22)) & ((x20 & x21) | ~x22))) & (x19 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x19 & (new_n71_ | x02)) | (x04 & x08) | (new_n72_ & ~x08);
  assign new_n71_ = ~x08 & x09 & ~x10 & new_n48_ & x22 & ~x23;
  ...
  assign new_n75_ = (x02 | (((new_n48_ & new_n76_) | ~x24) & (~new_n77_ | ~new_n48_ | ~x19))) & (x19 | ~x24);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = (~new_n79_ & x19) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n79_ = ~x02 & (~new_n80_ | x08 | ~x09 | x10 | ~x20);
  assign new_n80_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = ~x10 & x25 & (~new_n82_ | ~new_n48_ | ~x19);
  assign new_n82_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n84_ | (~x08 & x09 & (new_n85_ | new_n90_) & ~x10);
  assign new_n84_ = x07 & ~new_n51_ & x08;
  assign new_n85_ = ~x02 & ((new_n88_ & new_n89_) | ((~new_n86_ | ~new_n87_) & x26));
