...
module FAU ( 
  ...
  assign z09 = new_n59_ | (new_n60_ & new_n62_ & new_n61_ & x21);
  assign new_n59_ = ~new_n50_ & ((x00 & x08) | (~x08 & x09 & ~x10 & ~x19));
  assign new_n60_ = ~x08 & x09 & ~x10 & x11 & x15 & x20;
  assign new_n61_ = x22 & x23;
  assign new_n62_ = x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x15 & x20 & (~x19 | (new_n65_ & new_n66_))) | (x19 & ~x20));
  assign new_n65_ = x12 & x21 & x22;
  assign new_n66_ = x23 & x24 & x25 & x26;
  assign z11 = (~x08 & x09 & ~new_n68_ & ~x10) | new_n50_ | (x02 & x08);
  assign new_n68_ = (~x19 | ~x20 | (x21 & (~new_n62_ | ~new_n61_ | ~x13))) & (~x21 | (x19 & x20));
  assign z12 = new_n50_ | (x03 & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x20 & (new_n71_ | (x19 & x21 & ~x22))) | (x22 & (~x19 | ~x20 | ~x21)));
  assign new_n71_ = x24 & x25 & x26 & x14 & x22 & x23;
  assign z13 = new_n50_ | (x04 & x08) | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((x23 & (~x20 | ~x22)) | (x20 & x22 & (new_n74_ | (~new_n75_ & x23))));
  assign new_n74_ = x19 & x21 & (~x23 | (x24 & x25 & x26));
  assign new_n75_ = x19 & x21 & (~x25 | ~x26 | ~x14 | ~x24);
  assign z14 = new_n77_ | (x05 & x08) | (~x08 & x09 & new_n80_ & ~x10);
  assign new_n77_ = x20 & (~x15 | (new_n78_ & new_n79_));
  ...
  assign new_n83_ = x20 & (~x15 | (new_n78_ & new_n84_));
  ...
  assign new_n88_ = x15 & (~new_n89_ | ~new_n61_ | ~x24 | ~x25 | x26);
  assign new_n89_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n90_ = ~x10 & x26 & (~new_n91_ | ~new_n61_ | ~x24 | ~x25);
