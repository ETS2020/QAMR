...
module FAU ( 
  ...
  assign z10 = (~x08 & ~new_n62_ & x09) | (x01 & x08) | (x10 & x20);
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (x10 | ~x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (new_n65_ & ~x08) | (x02 & x08) | (x10 & x20);
  assign new_n65_ = x09 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x10 & ~x20 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08 & (~x10 | ~x20)) | (~x08 & x09 & ~new_n68_ & ~x10);
  ...
  assign z16 = (~new_n80_ & x20) | (x07 & x08) | (~x08 & new_n81_ & x09);
  assign new_n80_ = ~x10 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
