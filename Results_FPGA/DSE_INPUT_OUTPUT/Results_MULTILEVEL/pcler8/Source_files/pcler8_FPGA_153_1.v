...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n60_ | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n60_ = x11 & x20 & x21 & x22;
  assign z10 = z02 | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = x19 ? (x20 & (~new_n64_ | ~new_n63_ | ~x21)) : ~x20;
  assign new_n63_ = x22 & x23;
  assign new_n64_ = x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = x19 ? (x21 ? (x20 & (~new_n64_ | ~new_n63_ | ~x13)) : ~x20) : ~x21;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x12 | ((~x19 | ~x20 | ~x21 | (~new_n69_ & x22)) & (~x22 | (x20 & x21)))) & (x19 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x19 | ~x23) & (~x12 | ((~x23 | (x20 & x21)) & (~x19 | ~x20 | new_n72_ | ~x21)));
  assign new_n72_ = x22 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x12 | (((new_n75_ & new_n76_) | ~x24) & (~new_n77_ | ~new_n75_ | ~x19))) & (x19 | ~x24);
