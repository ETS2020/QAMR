...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n58_, new_n60_, new_n62_, new_n63_, new_n64_, new_n66_;
  ...
  assign new_n58_ = x09 & ~x10 & (x20 ? (~x24 & (x19 ^ x21)) : x21);
  assign z12 = z04 | (~x08 & new_n60_ & x09);
  assign new_n60_ = ~x10 & ((x22 & (~x20 | (~x24 & (~x19 | ~x21)))) | (x19 & x20 & x21 & ~x22 & ~x24));
  assign z13 = (~new_n62_ & x20) | (~x08 & new_n64_ & x09) | (x04 & x08);
  assign new_n62_ = ~x24 & (~new_n63_ | x08 | ~x09 | x10);
  assign new_n63_ = x19 & x21 & x22 & ~x23;
  assign new_n64_ = ~x10 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (x20 | ~x24) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x24);
