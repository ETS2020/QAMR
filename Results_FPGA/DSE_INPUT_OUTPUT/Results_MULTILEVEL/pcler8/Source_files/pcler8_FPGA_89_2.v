...
module FAU ( 
  ...
  assign new_n65_ = (~x19 | ~x20 | (x21 & (~new_n49_ | ~x13 | ~x22))) & (~x21 | (x19 & x20));
  assign z12 = (x03 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (x19 & (~x26 | (x20 & ~new_n68_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x26);
  assign new_n68_ = x14 & x23 & x24 & x25;
  assign z13 = (x19 & (new_n70_ | ~x26)) | (x04 & x08) | (new_n72_ & ~x08);
  assign new_n70_ = new_n71_ & ~x08 & x09 & ~x10;
  assign new_n71_ = x20 & x21 & x22 & ~x23;
  assign new_n72_ = x09 & ~x10 & x23 & (~new_n73_ | ~x19 | ~x20);
  assign new_n73_ = x21 & x22 & (~x15 | ~x24 | ~x25);
  assign z14 = (~new_n75_ & x19) | (x05 & x08) | (~x08 & new_n76_ & x09);
  assign new_n75_ = x26 & (~new_n47_ | ~new_n48_ | ~x23 | x24);
  assign new_n76_ = ~x10 & x24 & (~new_n77_ | ~x19 | ~x20 | ~x21);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25);
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | (x19 & (new_n81_ | ~x26))) & (~new_n82_ | ~new_n80_ | x25 | ~x26);
  assign new_n80_ = x23 & x24;
  assign new_n81_ = ~x17 & x20 & x21 & x22 & x23 & x24;
  assign new_n82_ = x19 & x20 & x21 & x22;
  assign z16 = z08 | (~x08 & x09 & new_n84_ & ~x10);
  assign new_n84_ = x26 & (~new_n85_ | ~x22 | ~x23 | ~x24 | ~x25);
