// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:33 2020
...
module FAU ( 
  ...
  assign z00 = ~x10 & (~x19 | (new_n48_ & new_n47_ & ~x08 & x09));
  ...
  assign z09 = (~x10 & (new_n58_ | ~x19)) | (x00 & x08);
  assign new_n58_ = new_n48_ & ~x08 & x09 & new_n47_ & x11;
  assign z10 = (x01 & x08) | (~x10 & (~x19 | (~x08 & ~new_n60_ & x09)));
  assign new_n60_ = x20 & (~new_n61_ | ~x12 | ~x21 | ~x22);
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08) | (~x10 & (~x19 | (~x08 & ~new_n63_ & x09)));
  assign new_n63_ = x20 ? (x21 & (~new_n64_ | ~x13 | ~x22 | ~x23)) : ~x21;
  assign new_n64_ = x24 & x25 & x26;
  assign z12 = (x03 & x08) | (~x10 & (~x19 | (~x08 & ~new_n66_ & x09)));
  assign new_n66_ = (~x22 | (x20 & x21 & (~new_n64_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08) | (~x10 & (~x19 | (new_n68_ & ~x08)));
  assign new_n68_ = x09 & (x22 ? ((x20 & x21 & (new_n69_ | ~x23)) | (x23 & (~x20 | ~x21))) : x23);
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n71_ & x19);
  assign new_n71_ = (~x24 | (new_n47_ & x22 & ~new_n72_ & x23)) & (~new_n47_ | ~x22 | ~x23 | x24);
  assign new_n72_ = x16 & x25 & x26;
  assign z15 = (x06 & x08) | (~x10 & (~x19 | (~x08 & ~new_n74_ & x09)));
  assign new_n74_ = (~new_n75_ | ~x23 | ~x24 | x25) & (~x25 | (new_n75_ & x23 & x24 & (~x17 | ~x26)));
  assign new_n75_ = x20 & x21 & x22;
  assign z16 = (x07 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n77_ & x19);
  assign new_n77_ = (~x26 | (new_n78_ & new_n47_ & ~x18)) & (~new_n75_ | ~new_n79_);
