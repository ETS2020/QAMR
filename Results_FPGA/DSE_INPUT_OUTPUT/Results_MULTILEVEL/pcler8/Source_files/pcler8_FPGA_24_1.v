...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (x09 & ~x10 & ((~new_n60_ & x00) | (new_n63_ & ~x08)));
  ...
  assign new_n65_ = (~x00 | ~x20 | (x19 & (~new_n62_ | ~new_n61_ | ~x12))) & (~x19 | x20);
  assign z11 = (x02 & ~new_n52_ & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x00 & x20 & (x19 ? (new_n68_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n68_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x20 & (new_n72_ | ~x00)) | (x03 & x08) | (new_n70_ & ~x08);
  ...
  assign new_n77_ = x20 & (~x00 | (new_n78_ & new_n61_ & x23 & ~x24));
  assign new_n78_ = ~x08 & x09 & ~x10 & x19;
  assign new_n79_ = x24 & (~new_n80_ | ~x19 | ~x20 | ~x21);
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~new_n82_ & x20) | (x06 & x08) | (~x08 & new_n83_ & x09);
  assign new_n82_ = x00 & (~new_n78_ | ~new_n61_ | ~x23 | ~x24 | x25);
  ...
  assign new_n86_ = x00 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
