...
module FAU ( 
  ...
  assign z12 = ~new_n61_ | (x20 & (new_n63_ | x23));
  assign new_n61_ = x08 ? ~x03 : (~x09 | ~new_n62_ | x10);
  assign new_n62_ = x22 & (~x19 | ~x20 | ~x21 | x23);
  assign new_n63_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((~x20 & x23) | (x19 & x20 & x21 & x22 & ~x23));
