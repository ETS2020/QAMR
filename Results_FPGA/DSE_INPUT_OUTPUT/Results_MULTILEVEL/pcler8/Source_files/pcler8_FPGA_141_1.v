...
module FAU ( 
  ...
  assign z11 = (x02 & x08) | (~x10 & (x19 | (~x08 & x09 & x21)));
  assign z12 = (x03 & x08 & (x10 | ~x19)) | (~x08 & x09 & ~x10 & ~x19 & x22);
  assign z13 = (x04 & x08) | (~x10 & (x19 | (~x08 & x09 & x23)));
  assign z14 = (x05 & x08 & (x10 | ~x19)) | (~x08 & x09 & ~x10 & ~x19 & x24);
  assign z15 = (x06 & x08 & (x10 | ~x19)) | (~x08 & x09 & ~x10 & ~x19 & x25);
  assign z16 = (x07 & x08 & (x10 | ~x19)) | (~x08 & x09 & ~x10 & ~x19 & x26);
  assign z00 = 1'b0;
endmodule
