...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (~x19 | (new_n64_ & new_n65_))) | (x07 & x19 & ~x20));
  ...
  assign new_n71_ = ~x20 & (~x07 | (~x10 & x22 & ~x08 & x09));
