...
module FAU ( 
  ...
  assign z01 = x00 ? x08 : x20;
  assign z02 = x01 & ~new_n51_ & x08;
  assign new_n51_ = ~x00 & x20;
  ...
  assign z09 = (x00 & x08) | (x09 & ~x10 & ((~new_n59_ & x00) | (new_n62_ & ~x08)));
  ...
  assign new_n64_ = x20 ? (x19 & (~new_n61_ | ~new_n60_ | ~x12)) : ~x19;
  assign z11 = (x02 & ~new_n51_ & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x00 & (x19 ? (x20 & (new_n67_ | ~x21)) : x21)) | (~x20 & x21));
  ...
  assign new_n76_ = x20 & (~x00 | (new_n77_ & new_n60_ & x23 & ~x24));
  ...
  assign new_n81_ = x00 & (~new_n77_ | ~new_n60_ | ~x23 | ~x24 | x25);
  ...
  assign new_n85_ = x00 & ((new_n88_ & new_n89_) | ((~new_n86_ | ~new_n87_) & x26));
