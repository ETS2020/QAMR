...
module FAU ( 
  ...
  assign new_n62_ = ~x10 & ((x09 & x21 & (~x20 | (~x19 & x20))) | (x19 & x20 & (new_n63_ | ~x21)));
  ...
  assign z13 = (x20 & (new_n70_ | ~x09)) | (x04 & x08) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & x23 & (~new_n69_ | ~x19 | ~x20);
  assign new_n69_ = x21 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n70_ = ~x08 & ~x10 & x19 & x21 & x22 & ~x23;
  ...
  assign new_n81_ = ~x10 & x26 & (~new_n82_ | ~new_n77_ | ~x24 | ~x25);
