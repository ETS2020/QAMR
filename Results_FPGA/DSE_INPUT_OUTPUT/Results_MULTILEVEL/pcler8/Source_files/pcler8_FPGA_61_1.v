...
module FAU ( 
  ...
  assign z14 = z06 | (~x08 & x09 & ~x10 & ~new_n76_ & x20);
  assign new_n76_ = (~x24 | (new_n77_ & x22 & x23 & (~new_n61_ | ~x16))) & (~new_n77_ | ~x22 | ~x23 | x24);
  assign new_n77_ = x19 & x21;
  assign z15 = (~new_n79_ & x24) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n79_ = x20 & (~new_n80_ | ~x21 | ~x22 | ~x23 | x25);
  assign new_n80_ = ~x08 & x09 & ~x10 & x19;
  assign new_n81_ = ~x10 & x25 & (~new_n82_ | ~x19 | ~x21 | ~x22);
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x24 & (new_n84_ | ~x20)) | (x07 & x08) | (new_n85_ & ~x08);
  assign new_n84_ = new_n80_ & x21 & x22 & x23 & x25 & ~x26;
  assign new_n85_ = x09 & ~x10 & x26 & (~new_n86_ | ~new_n77_ | x18);
