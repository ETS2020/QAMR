...
module FAU ( 
  ...
  assign z09 = (x00 & ~new_n61_ & x08) | (~x08 & x09 & ~new_n58_ & ~x10);
  assign new_n58_ = (x19 | (x07 & ~x20)) & (~new_n60_ | ~new_n59_ | ~x11 | ~x20);
  assign new_n59_ = x21 & x22;
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign new_n61_ = x07 & (~x07 | ~x20);
  assign z10 = z02 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x20 | (x19 & (~new_n60_ | ~new_n59_ | ~x12))) & (x07 | ~x19 | x20);
  assign z11 = z03 | (new_n65_ & ~x08);
  assign new_n65_ = x09 & ~x10 & (x20 ? (x19 ? (new_n66_ | ~x21) : x21) : x21);
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x20 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x21 | x22))) & (x07 | x20 | ~x22);
  ...
  assign new_n73_ = ~x07 & ~x20 & x23;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x20 | ((~x24 | (new_n76_ & new_n77_)) & (~new_n76_ | ~new_n78_))) & (x07 | x20 | ~x24);
  ...
  assign new_n85_ = ~x20 & (x07 | (~x10 & x25 & ~x08 & x09));
  assign z16 = (x07 & (x08 | ~x20)) | (~x08 & new_n87_ & x09);
