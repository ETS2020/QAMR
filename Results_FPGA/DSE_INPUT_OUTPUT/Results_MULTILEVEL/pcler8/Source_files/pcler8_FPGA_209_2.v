...
module FAU ( 
  ...
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & x08 & x20);
  assign new_n68_ = (~x20 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x21 | x22))) & (x03 | x20 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n73_ | new_n74_ | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = x03 & (~x20 | (x04 & x08 & x20));
  ...
  assign new_n82_ = new_n47_ & ~x10 & ~x20 & x25;
  ...
  assign new_n88_ = ~x20 & (x03 | (new_n47_ & ~x10 & x26));
