...
module FAU ( 
  ...
  assign new_n77_ = ~x19 & (x13 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n79_ = (~x19 | ((~new_n80_ | ~new_n82_) & (~x25 | (new_n80_ & new_n81_)))) & (x13 | x19 | ~x25);
