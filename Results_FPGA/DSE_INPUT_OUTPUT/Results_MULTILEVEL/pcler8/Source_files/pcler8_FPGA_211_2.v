...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (~x19 | (new_n64_ & new_n65_))) | (~x18 & x19 & ~x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (~x08 & x09 & ~new_n67_ & ~x10) | new_n49_ | (x02 & x08);
  assign new_n67_ = x20 ? (x19 ? (x21 & (~new_n61_ | ~new_n60_ | ~x13)) : ~x21) : ~x21;
  ...
  assign new_n71_ = ~x20 & (x18 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n73_ | (~x08 & x09 & ~x10 & (new_n74_ | new_n76_));
  assign new_n73_ = x04 & ~new_n49_ & x08;
  assign new_n74_ = x20 & (x22 ? ((x19 & x21 & (new_n75_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign new_n76_ = ~x18 & ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x20 | ((~new_n79_ | ~new_n81_) & (~x24 | (new_n79_ & new_n80_)))) & (x18 | x20 | ~x24);
  assign new_n79_ = x19 & x21;
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n81_ = x22 & x23 & ~x24;
  assign z15 = new_n87_ | (x06 & x08) | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x25 | (new_n84_ & new_n85_)) & (~new_n86_ | ~new_n60_ | ~x24 | x25);
  assign new_n84_ = x19 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x19 & x20 & x21;
  assign new_n87_ = ~x20 & (x18 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n89_ | new_n91_));
  assign new_n89_ = x20 & ((x18 & x26) | (new_n84_ & new_n90_ & x25 & ~x26));
  assign new_n90_ = x23 & x24;
  assign new_n91_ = ~x18 & x26 & (~new_n86_ | ~new_n60_ | ~x24 | ~x25);
endmodule
