...
module FAU ( 
  ...
  assign z11 = (~x08 & x09 & ~new_n65_ & ~x10) | new_n51_ | (x02 & x08);
  ...
  assign new_n83_ = ~x20 & (~x24 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n85_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n87_));
  assign new_n85_ = x07 & ~new_n51_ & x08;
  assign new_n86_ = x24 & ((~x20 & x26) | (new_n77_ & new_n48_ & x25 & ~x26));
