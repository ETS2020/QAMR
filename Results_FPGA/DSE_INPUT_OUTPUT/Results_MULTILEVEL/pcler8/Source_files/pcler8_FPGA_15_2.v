...
module FAU ( 
  ...
  assign z00 = x20 & (~x24 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign new_n61_ = x22 & x23 & x25 & x26;
  assign z10 = (~x08 & x09 & ~new_n63_ & ~x10) | (x01 & ~new_n51_ & x08);
  assign new_n63_ = x20 ? (~x24 | (x19 & (~new_n49_ | ~new_n48_ | ~x12))) : ~x19;
  ...
  assign new_n71_ = ~x10 & ((~x20 & x23) | (x24 & ((~x22 & x23) | (x20 & ~new_n72_ & x22))));
  assign new_n72_ = (~x19 | ~x21 | (x23 & (~x15 | ~x25 | ~x26))) & (~x23 | (x19 & x21));
  assign z14 = (x05 & ~new_n51_ & x08) | (~x08 & x09 & new_n74_ & ~x10);
  assign new_n74_ = x24 & (~new_n75_ | ~x19 | ~x20 | ~x21);
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n77_ & x09);
  assign new_n77_ = ~x10 & ((x24 & (new_n79_ | (~new_n78_ & x25))) | (~x20 & x25));
  assign new_n78_ = x19 & x21 & x22 & x23 & (~x17 | ~x26);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x25;
  assign z16 = (~new_n81_ & x20) | (x07 & x08) | (~x08 & new_n82_ & x09);
  assign new_n81_ = x24 & (~new_n47_ | ~new_n48_ | ~x23 | ~x25 | x26);
