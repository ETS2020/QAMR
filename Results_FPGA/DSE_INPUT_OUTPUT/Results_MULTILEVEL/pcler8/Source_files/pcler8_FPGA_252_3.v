...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x02 | (x02 & ~x20))) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((~x02 & x20 & (~x19 | (new_n61_ & new_n64_))) | (x19 & ~x20));
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = (~x08 & new_n66_ & x09) | (x02 & x08 & ~x20);
  assign new_n66_ = ~x10 & ((~x02 & x20 & (x19 ? (new_n67_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = ((new_n71_ | x02) & x20) | (new_n69_ & ~x08) | (x03 & x08);
  ...
  assign z16 = z08 | (~x08 & x09 & (new_n89_ | new_n94_) & ~x10);
