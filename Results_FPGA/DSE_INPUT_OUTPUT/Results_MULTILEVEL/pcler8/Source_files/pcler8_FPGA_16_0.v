...
module FAU ( 
  ...
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (x14 & x19 & ~x20));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x20 & (x19 ? (new_n67_ | ~x21) : x21)) | (x14 & ~x20 & x21));
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = new_n71_ | (x03 & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign new_n71_ = ~x20 & (~x14 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~x10 & (new_n73_ | new_n76_));
  assign new_n73_ = x20 & x22 & (~new_n75_ | (x15 & new_n74_ & x24));
  assign new_n74_ = x25 & x26 & ((x19 & x21) | (x14 & x23));
  assign new_n75_ = (~x23 | (x19 & x21)) & (~x19 | ~x21 | x23);
  assign new_n76_ = x23 & (~x20 | ~x22);
  ...
  assign new_n81_ = ~x20 & (~x14 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x20 | ((~x25 | (new_n84_ & new_n85_)) & (~new_n84_ | ~new_n86_))) & (~x14 | x20 | ~x25);
  ...
  assign new_n88_ = x07 & ~new_n49_ & x08;
