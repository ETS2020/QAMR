...
module FAU ( 
  ...
  assign new_n57_ = x09 & ~x10 & (~x21 | (x21 & ~x25)) & (x19 ^ x20);
  assign z11 = (x02 & ~new_n47_ & x08) | (new_n59_ & ~x08);
  assign new_n59_ = x09 & ~x10 & (x19 ? (x20 ? ~x21 : (x21 & ~x25)) : (x21 & ~x25));
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & ((x22 & (~x21 | (~new_n62_ & ~x25))) | (new_n62_ & x21 & ~x22 & ~x25));
  assign new_n62_ = x19 & x20;
  assign z13 = (x21 & (new_n64_ | x25)) | (new_n65_ & ~x08) | (x04 & x08);
  assign new_n64_ = ~x08 & x09 & ~x10 & new_n62_ & x22 & ~x23;
  assign new_n65_ = x09 & ~x10 & x23 & (~new_n62_ | ~x21 | ~x22);
  assign z14 = z06 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x24 | (x21 & (x25 | (new_n68_ & x19 & x20)))) & (~x19 | ~x20 | ~x21 | ~new_n68_ | x24 | x25);
  assign new_n68_ = x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x21 | ~x25) & (~new_n68_ | ~x24 | x25 | ~x19 | ~x20 | ~x21);
