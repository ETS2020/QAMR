...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (~x19 | (new_n64_ & new_n65_))) | (~x15 & x19 & ~x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (~x08 & new_n67_ & x09) | new_n50_ | (x02 & x08);
  assign new_n67_ = ~x10 & (x20 ? (x19 ? (~x21 | (new_n61_ & new_n68_)) : x21) : x21);
  assign new_n68_ = x13 & x22 & x23;
  assign z12 = new_n70_ | (x03 & x08) | (~x08 & new_n71_ & x09);
  assign new_n70_ = ~x20 & (x15 | (new_n48_ & ~x10 & x22));
  assign new_n71_ = ~x10 & ((x22 & (~x19 | new_n72_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n72_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (~x08 & new_n76_ & x09) | (~new_n74_ & x15);
  assign new_n74_ = x20 & (~new_n75_ | ~new_n48_ | x10 | ~x19);
  assign new_n75_ = x21 & x22 & x24 & x25 & x26;
  assign new_n76_ = ~x10 & ((x23 & ((x20 & x22 & (~x19 | ~x21)) | ~x20 | ~x22)) | (x19 & x20 & x21 & x22 & ~x23));
  assign z14 = new_n78_ | (x05 & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n78_ = ~x20 & (x15 | (new_n48_ & ~x10 & x24));
  assign new_n79_ = (~x24 | (new_n80_ & x22 & ~new_n81_ & x23)) & (~new_n82_ | ~x22 | ~x23 | x24);
  assign new_n80_ = x19 & x21;
  assign new_n81_ = x16 & x25 & x26;
  assign new_n82_ = x19 & x20 & x21;
  assign z15 = new_n84_ | (x06 & x08) | (~x08 & new_n85_ & x09);
  assign new_n84_ = ~x20 & (x15 | (new_n48_ & ~x10 & x25));
  assign new_n85_ = ~x10 & ((new_n82_ & new_n88_) | (x25 & (~new_n86_ | ~new_n87_)));
  assign new_n86_ = x19 & x21 & x22;
  assign new_n87_ = x23 & x24 & (~x17 | ~x26);
  assign new_n88_ = x22 & x23 & x24 & ~x25;
  assign z16 = new_n90_ | (x07 & x08) | (~x08 & new_n91_ & x09);
  assign new_n90_ = ~x20 & (x15 | (new_n48_ & ~x10 & x26));
