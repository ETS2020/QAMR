...
module FAU ( 
  ...
  assign new_n62_ = x20 ? (x19 ? (x21 & (~new_n64_ | ~new_n63_ | ~x13)) : ~x21) : ~x21;
  ...
  assign z15 = (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & x08 & (~x10 | x20));
  assign new_n79_ = (~x25 | (new_n74_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n63_ | ~x24 | x25);
