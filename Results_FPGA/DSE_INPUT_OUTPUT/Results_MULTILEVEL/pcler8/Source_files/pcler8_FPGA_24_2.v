...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n58_ & ~x10) | (x00 & x08 & x20);
  assign new_n58_ = (x19 | (x00 & ~x20)) & (~new_n60_ | ~new_n59_ | ~x11 | ~x20);
  assign new_n59_ = x21 & x22;
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = (~x00 & (new_n62_ | (x01 & x08))) | (x20 & (x08 ? x01 : new_n63_));
  assign new_n62_ = new_n47_ & ~x10 & x19 & ~x20;
  assign new_n63_ = x09 & ~x10 & (~x19 | (new_n60_ & new_n59_ & x12));
