// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:40 2020
...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n62_ & ~x10) | new_n47_ | (x01 & x08);
  assign new_n62_ = x19 ? (x20 & (~new_n60_ | ~x12 | ~x21 | ~x22)) : ~x20;
  assign z11 = new_n66_ | (x02 & x08) | (~x08 & x09 & new_n64_ & ~x10);
  assign new_n64_ = x19 & (x20 ? (new_n65_ | ~x21) : x21);
  assign new_n65_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n66_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x21));
  ...
  assign new_n70_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n74_ | (x04 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x19 | ~x22 | ((~x20 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x20 & x21)))) & (x22 | ~x23);
  assign new_n73_ = x25 & x26 & x15 & x24;
  assign new_n74_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x23));
  assign z14 = new_n76_ | (x05 & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n76_ = x16 & (~x19 | (new_n49_ & ~x08 & x09 & ~x10));
