...
module FAU ( 
  ...
  assign new_n61_ = x19 ? (x20 & (~new_n62_ | ~x12 | ~x21 | ~x22)) : ~x20;
  assign new_n62_ = x25 & x26 & x23 & x24;
  assign z11 = (~new_n50_ & ((new_n66_ & ~x08 & x09) | (x02 & x08))) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & x19 & ((x12 & ~x20 & x21) | (x20 & (new_n65_ | ~x21)));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n66_ = ~x10 & ~x19 & x21;
  ...
  assign new_n72_ = x04 & ~new_n50_ & x08;
  assign new_n73_ = x20 & (x22 ? ((x19 & x21 & (new_n74_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n74_ = x25 & x26 & x15 & x24;
  ...
  assign new_n93_ = x21 & x22 & x19 & x20;
