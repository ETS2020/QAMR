...
module FAU ( 
  ...
  assign new_n76_ = ~x17 & (~new_n77_ | x10 | ~x19 | x08 | ~x09);
  ...
  assign z15 = (x06 & ~new_n50_ & x08) | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & (new_n85_ | (~x17 & (new_n83_ | (new_n79_ & new_n84_))));
  assign new_n83_ = x25 & (~x19 | ~x21 | ~x22 | ~x23 | ~x24);
