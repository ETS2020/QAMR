...
module FAU ( 
  ...
  assign z13 = (x04 & x08) | (~x10 & (~x20 | (~x08 & ~new_n68_ & x09)));
  assign new_n68_ = x22 ? ((~x19 | ~x21 | (~new_n69_ & x23)) & (~x20 | ~x23 | (x19 & x21))) : ~x23;
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~x10 & (~x20 | (~x08 & ~new_n71_ & x09)));
  assign new_n71_ = (~x24 | (new_n49_ & x22 & ~new_n72_ & x23)) & (~new_n49_ | ~x22 | ~x23 | x24);
  assign new_n72_ = x16 & x25 & x26;
  assign z15 = (x06 & x08 & (x10 | x20)) | (~x08 & x09 & ~x10 & ~new_n74_ & x20);
  assign new_n74_ = (~new_n75_ | ~x23 | ~x24 | x25) & (~x25 | (new_n75_ & x23 & x24 & (~x17 | ~x26)));
  assign new_n75_ = x19 & x21 & x22;
  assign z16 = (x07 & x08) | (~x10 & (~x20 | (~x08 & ~new_n77_ & x09)));
  assign new_n77_ = (~new_n75_ | ~new_n79_) & (~x26 | (new_n78_ & new_n49_ & ~x18));
