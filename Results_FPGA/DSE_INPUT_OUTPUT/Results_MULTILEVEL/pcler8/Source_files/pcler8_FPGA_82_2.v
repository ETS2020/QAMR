...
module FAU ( 
  ...
  assign new_n70_ = x25 & (~new_n71_ | x08 | ~x09 | x10);
  assign new_n71_ = x19 & x21 & x22 & ~x23;
  assign new_n72_ = x09 & ~x10 & x23 & (~new_n73_ | ~x19 | ~x20);
  assign new_n73_ = x21 & x22 & (~x15 | ~x24 | ~x26);
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x24 | (x20 & (new_n76_ | ~x25))) & (~new_n77_ | ~new_n59_ | x24 | ~x25);
  assign new_n76_ = x19 & x21 & x22 & x23 & (~x16 | ~x26);
  assign new_n77_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & x25 & (~new_n77_ | ~new_n80_);
  assign new_n80_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n82_ & x20) | (x07 & x08) | (~x08 & new_n84_ & x09);
  assign new_n82_ = x25 & (~new_n83_ | x10 | ~x19 | x08 | ~x09);
  assign new_n83_ = x21 & x22 & x23 & x24 & ~x26;
