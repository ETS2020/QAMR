...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n62_ & ~x10) | (x01 & ~new_n49_ & x08);
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n59_ | ~x12))) & (~x19 | x20 | ~x24);
  ...
  assign new_n68_ = x24 & (~x20 | (x14 & x23 & x25 & x26));
  ...
  assign z15 = new_n80_ | (~x08 & x09 & ~new_n77_ & ~x10) | (x06 & x08);
  assign new_n77_ = (~new_n74_ | ~new_n79_) & (~x25 | (new_n78_ & new_n59_ & x19));
  assign new_n78_ = x23 & x24 & (~x17 | ~x26);
  assign new_n79_ = x22 & x23 & x24 & ~x25;
  assign new_n80_ = ~x20 & (~x24 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n82_ | new_n84_));
  assign new_n82_ = x24 & ((new_n74_ & new_n83_) | (~x20 & x26));
