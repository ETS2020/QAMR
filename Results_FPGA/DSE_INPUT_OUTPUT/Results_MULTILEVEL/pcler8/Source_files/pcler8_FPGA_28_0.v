...
module FAU ( 
  ...
  assign new_n63_ = x21 ? (~new_n64_ & (~x19 | x20)) : ~x20;
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = ~x19 & (~x21 | (~x08 & x09 & ~x10));
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x21 & ((x19 & x20 & (new_n68_ | ~x22)) | (x22 & (~x19 | ~x20)))) | (x19 & ~x21 & x22));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x19 & ~x21 & x23) | (x21 & ((x23 & (~x19 | ~x20)) | (x19 & ~new_n71_ & x20))));
  ...
  assign new_n76_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (new_n79_ | ~x21) & (~x19 | ~x25 | (new_n80_ & new_n81_));
  assign new_n79_ = (x19 | ~x25) & (~x19 | ~x20 | ~x22 | ~x23 | ~x24 | x25);
  ...
  assign new_n88_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x26));
endmodule
