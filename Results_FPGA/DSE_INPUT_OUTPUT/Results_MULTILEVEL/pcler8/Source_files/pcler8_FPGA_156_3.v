...
module FAU ( 
  ...
  assign z10 = (~x08 & ~new_n63_ & x09) | (x01 & x08) | (x10 & x19);
  assign new_n63_ = (~x19 | (x20 & (~new_n61_ | ~new_n60_ | ~x12))) & (x10 | x19 | ~x20);
  ...
  assign z14 = (x19 & (new_n74_ | x10)) | (x05 & x08) | (new_n75_ & ~x08);
  assign new_n74_ = ~x08 & x09 & x20 & new_n60_ & x23 & ~x24;
  ...
  assign new_n81_ = ((new_n82_ & new_n83_) | ~x26) & (~new_n84_ | ~new_n60_ | ~new_n69_);
