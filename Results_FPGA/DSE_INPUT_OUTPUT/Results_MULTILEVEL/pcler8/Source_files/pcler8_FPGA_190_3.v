...
module FAU ( 
  ...
  assign z10 = (~x08 & new_n63_ & x09) | new_n51_ | (x01 & x08);
  assign new_n63_ = ~x10 & (x20 ? (~x19 | (new_n61_ & new_n60_ & x12)) : x19);
  assign z11 = (~x08 & new_n65_ & x09) | (x02 & ~new_n51_ & x08);
  assign new_n65_ = ~x10 & ((~x00 & (x19 ? (x20 & (new_n66_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n70_ | x00)) | (x03 & x08) | (new_n68_ & ~x08);
  ...
  assign z13 = new_n51_ | (x04 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  ...
  assign new_n75_ = x20 & (x00 | (new_n76_ & new_n60_ & x23 & ~x24));
  ...
  assign new_n80_ = ~x00 & (~new_n76_ | ~new_n60_ | ~x23 | ~x24 | x25);
