...
module FAU ( 
  ...
  assign z11 = (x23 & (new_n65_ | ~x26)) | (x02 & x08) | (new_n67_ & ~x08);
  assign new_n65_ = new_n48_ & ~x10 & x13 & new_n66_ & x21 & x22;
  assign new_n66_ = x24 & x25;
  assign new_n67_ = x09 & ~x10 & ((x21 & (~x19 | ~x20)) | (x19 & x20 & ~x21));
  assign z12 = new_n69_ | (~x08 & x09 & ~x10 & ~new_n71_ & x22);
  assign new_n69_ = ~new_n50_ & ((x03 & x08) | (new_n70_ & ~x08 & x09 & ~x10));
  assign new_n70_ = x19 & x20 & x21 & ~x22;
  assign new_n71_ = (new_n72_ | (x23 & (~x23 | ~x26))) & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n72_ = x19 & x20 & x21;
  assign z13 = z05 | (~x08 & new_n74_ & x09);
  assign new_n74_ = ~x10 & (new_n77_ | (x23 & x26 & (new_n75_ | ~new_n76_)));
  assign new_n75_ = x22 & (~x19 | ~x20 | ~x21);
  assign new_n76_ = x22 & (~x15 | ~x24 | ~x25);
  assign new_n77_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = new_n79_ | (x05 & x08) | (~x08 & x09 & new_n82_ & ~x10);
  assign new_n79_ = x23 & (~x26 | (new_n81_ & new_n80_ & x22 & ~x24));
  assign new_n80_ = x20 & x21;
  assign new_n81_ = ~x08 & x09 & ~x10 & x19;
  assign new_n82_ = x24 & (~new_n72_ | ~x22 | ~x23 | (x16 & x25));
  assign z15 = (x23 & (new_n84_ | ~x26)) | (x06 & x08) | (new_n85_ & ~x08);
  assign new_n84_ = new_n81_ & new_n80_ & x22 & x24 & ~x25;
  assign new_n85_ = x09 & ~x10 & x25 & (~new_n86_ | ~new_n87_);
  assign new_n86_ = ~x17 & x19 & x20;
  assign new_n87_ = x21 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~x10 & ~new_n89_ & x26);
  assign new_n89_ = new_n80_ & ~x18 & x19 & new_n66_ & x22 & x23;
endmodule
