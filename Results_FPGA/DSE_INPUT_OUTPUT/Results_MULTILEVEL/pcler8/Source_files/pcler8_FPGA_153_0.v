...
module FAU ( 
  ...
  assign z11 = z03 | (~x08 & x09 & ~x10 & (new_n63_ | new_n66_));
  assign new_n63_ = x19 & (~new_n65_ | (x13 & x22 & new_n64_ & x23));
  assign new_n64_ = x24 & x25 & x26 & (x20 | (x12 & x21));
  ...
  assign new_n75_ = (~x19 | ((~new_n76_ | ~new_n78_) & (~x24 | (new_n76_ & new_n77_)))) & (~x12 | x19 | ~x24);
  ...
  assign new_n88_ = x19 & ((new_n81_ & new_n91_) | (x26 & (~new_n89_ | ~new_n90_)));
