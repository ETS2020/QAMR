...
module FAU ( 
  ...
  assign new_n62_ = x20 ? (~x24 | (x19 & (~new_n64_ | ~new_n63_ | ~x12))) : ~x19;
  assign new_n63_ = x21 & x22;
  assign new_n64_ = x23 & x25 & x26;
  assign z11 = (~x08 & x09 & ~new_n66_ & ~x10) | new_n49_ | (x02 & x08);
  assign new_n66_ = (~x19 | ~x20 | (x21 & (~new_n64_ | ~x13 | ~x22))) & (~x21 | (x19 & x20));
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x22 | (x20 & (~x24 | (x19 & ~new_n69_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x24);
  assign new_n69_ = x14 & x23 & x25 & x26;
  assign z13 = z05 | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((x24 & ((x20 & ~new_n72_ & x22) | (~x22 & x23))) | (~x20 & x23));
  assign new_n72_ = (~x19 | ~x21 | (x23 & (~x15 | ~x25 | ~x26))) & (~x23 | (x19 & x21));
  assign z14 = z06 | (~x08 & x09 & ~x10 & ~new_n74_ & x24);
  assign new_n74_ = new_n75_ & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x19 & x20 & x21;
  assign z15 = new_n77_ | (x06 & x08) | (~x08 & x09 & new_n79_ & ~x10);
  assign new_n77_ = x20 & (~x24 | (new_n78_ & new_n63_ & x23 & ~x25));
  assign new_n78_ = ~x08 & x09 & ~x10 & x19;
  assign new_n79_ = x25 & (~new_n75_ | ~x22 | ~x23 | (x17 & x26));
  assign z16 = (~new_n81_ & x20) | (x07 & x08) | (~x08 & new_n82_ & x09);
  assign new_n81_ = x24 & (~new_n78_ | ~new_n63_ | ~x23 | ~x25 | x26);
  assign new_n82_ = ~x10 & x26 & (~new_n83_ | x18 | ~x19 | ~x20);
