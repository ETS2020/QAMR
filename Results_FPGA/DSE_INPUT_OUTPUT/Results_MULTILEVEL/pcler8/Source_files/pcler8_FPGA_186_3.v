...
module FAU ( 
  ...
  assign new_n47_ = new_n48_ & x19 & x21 & ~x08 & x09;
  ...
  assign z09 = (x00 & x08 & (~x10 | ~x20)) | (~x08 & x09 & ~new_n58_ & ~x10);
  ...
  assign z11 = (new_n63_ & ~x08) | (x10 & x20) | (x02 & x08);
  assign new_n63_ = x09 & ((~x10 & x21 & (~x20 | (~x19 & x20))) | (x19 & x20 & (new_n64_ | ~x21)));
  ...
  assign new_n77_ = (~x25 | (new_n74_ & new_n78_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n78_ | ~x24 | x25);
  assign new_n78_ = x22 & x23;
  assign z16 = (x07 & x08 & (~x10 | ~x20)) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~new_n83_ | ~new_n84_) & (~x26 | (new_n81_ & new_n82_));
