...
module FAU ( 
  ...
  assign new_n47_ = x20 & (~new_n48_ | x08 | ~x09 | x10 | ~x19);
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (~x19 | x20 | x26);
  ...
  assign new_n75_ = x20 ? ((~x24 | (new_n76_ & new_n77_)) & (~new_n76_ | ~new_n78_)) : (~x24 | x26);
  ...
  assign z16 = (~x08 & new_n87_ & x09) | new_n50_ | (x07 & x08);
