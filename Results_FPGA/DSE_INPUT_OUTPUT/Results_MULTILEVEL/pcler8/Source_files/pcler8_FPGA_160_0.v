...
module FAU ( 
  ...
  assign new_n61_ = (~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (~x15 | ~x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (x15 & ~x20 & x21));
  ...
  assign new_n69_ = ~x20 & (~x15 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n71_ | (~x08 & x09 & ~x10 & (new_n72_ | new_n74_));
  assign new_n71_ = x04 & ~new_n49_ & x08;
  assign new_n72_ = x15 & ((~x20 & x23) | (new_n73_ & x19 & x20 & x21));
  assign new_n73_ = x22 & x24 & x25 & x26;
  assign new_n74_ = x20 & (x22 ? ((x23 & (~x19 | ~x21)) | (x19 & x21 & ~x23)) : x23);
  ...
  assign new_n79_ = ~x20 & (~x15 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x20 | ((~new_n82_ | ~new_n84_) & (~x25 | (new_n82_ & new_n83_)))) & (~x15 | x20 | ~x25);
  ...
  assign new_n91_ = ~x20 & (~x15 | (~x08 & x09 & ~x10 & x26));
endmodule
