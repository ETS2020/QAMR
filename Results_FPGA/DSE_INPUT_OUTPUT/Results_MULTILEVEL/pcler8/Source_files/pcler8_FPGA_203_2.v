...
module FAU ( 
  ...
  assign z13 = z05 | (new_n71_ & ~x08);
  assign new_n71_ = x09 & ~x10 & ((x20 & ~new_n72_ & x22) | (x23 & (~x20 | ~x22)));
  assign new_n72_ = (~x19 | ~x21 | (x23 & (~x15 | ~x24 | ~x26))) & (~x23 | (x19 & x21));
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x24 | (x20 & (new_n75_ | ~x25))) & (~new_n76_ | ~new_n59_ | x24 | ~x25);
  assign new_n75_ = x19 & x21 & x22 & x23 & (~x16 | ~x26);
  assign new_n76_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & x25 & (~new_n76_ | ~new_n79_);
  assign new_n79_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n81_ & x20) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n81_ = x25 & (~new_n82_ | x10 | ~x19 | x08 | ~x09);
