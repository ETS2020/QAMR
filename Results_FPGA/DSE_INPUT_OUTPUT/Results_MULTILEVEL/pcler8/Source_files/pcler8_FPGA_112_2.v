...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n60_ & ~x10) | (x01 & x08 & (~x10 | x20));
  assign new_n60_ = x20 ? (x19 & (~new_n58_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = z03 | (new_n62_ & ~x08);
  assign new_n62_ = x09 & ((~x10 & x20 & (x19 ? (new_n63_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = new_n67_ | (x03 & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x22 & (~x19 | new_n66_ | ~x21)) | (x21 & ~x22 & x19 & x20));
  ...
  assign new_n78_ = (~x25 | (new_n73_ & new_n79_ & x24 & (~x17 | ~x26))) & (~new_n73_ | ~new_n79_ | ~x24 | x25);
