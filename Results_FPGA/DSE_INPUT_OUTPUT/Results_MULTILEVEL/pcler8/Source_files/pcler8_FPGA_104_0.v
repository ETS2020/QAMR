...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n59_ & ~x10) | (x00 & x08) | (~x09 & ~x20);
  assign new_n59_ = x19 & (~new_n60_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = (~x08 & x09 & ~new_n62_ & ~x10) | (x01 & x08 & (x09 | x20));
  assign new_n62_ = x20 ? (x19 & (~new_n60_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = (~x08 & x09 & ~new_n64_ & ~x10) | (x02 & x08 & (x09 | x20));
  ...
  assign z16 = (~x20 & (~x09 | (new_n85_ & ~x08))) | (x07 & x08) | (~x08 & new_n80_ & x09);
