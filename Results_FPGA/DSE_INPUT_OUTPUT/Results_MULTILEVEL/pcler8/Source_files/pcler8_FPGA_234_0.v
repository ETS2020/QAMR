...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n57_ & ~x10) | (~x09 & ~x20) | (x00 & x08);
  ...
  assign z11 = (~x08 & x09 & ~new_n63_ & ~x10) | (x02 & x08 & (x09 | x20));
  ...
  assign z13 = z05 | (~x08 & ~x10 & (new_n72_ | (~new_n70_ & x09)));
  assign new_n70_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x21))) : ~x23;
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x20 & x22 & x23;
  assign z14 = new_n78_ | (x05 & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  ...
  assign new_n78_ = ~x20 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (~x20 & (~x09 | (new_n84_ & ~x08))) | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((new_n77_ & new_n83_) | (x25 & (~new_n81_ | ~new_n82_)));
  assign new_n81_ = x19 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign new_n84_ = ~x10 & x25;
  assign z16 = (~x20 & (~x09 | (new_n91_ & ~x08))) | (x07 & x08) | (~x08 & new_n86_ & x09);
