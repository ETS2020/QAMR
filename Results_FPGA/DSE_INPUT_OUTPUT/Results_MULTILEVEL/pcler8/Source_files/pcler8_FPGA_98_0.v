...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & x19 & (x20 ? (new_n66_ | ~x21) : (x21 & x24));
  ...
  assign new_n70_ = x24 & (~x20 | (x25 & x26 & x14 & x23));
  assign z13 = new_n74_ | (x04 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x19 | ~x20 | ~x22 | (x21 ? (~new_n73_ & x23) : ~x23)) & (~x23 | (x19 & x22));
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign new_n74_ = ~x20 & (~x24 | (~x08 & x09 & ~x10 & x23));
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & new_n76_ & x09);
  ...
  assign new_n80_ = (new_n81_ | ~x24) & (~x20 | ~x25 | (new_n82_ & new_n83_));
  assign new_n81_ = (x20 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x25);
