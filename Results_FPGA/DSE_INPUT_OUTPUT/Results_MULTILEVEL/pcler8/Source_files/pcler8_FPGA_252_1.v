...
module FAU ( 
  ...
  assign new_n63_ = (~x02 | ~x20 | (x19 & (~new_n61_ | ~new_n64_))) & (~x19 | x20);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = (x02 & x08) | (x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (x08 | ~x21 | (x20 & (~x02 | x19 | ~x20))) & (~x02 | ~x19 | ~x20 | (~new_n67_ & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n71_ | ~x02)) | (new_n69_ & ~x08) | (x03 & x08);
  ...
  assign z13 = (~x08 & x09 & ~new_n73_ & ~x10) | (x04 & ~new_n51_ & x08);
  assign new_n73_ = (~x02 | (~new_n75_ & ((new_n48_ & new_n74_) | ~x23))) & (x20 | ~x23);
  assign new_n74_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n75_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x02 | (~new_n79_ & ((new_n48_ & new_n78_) | ~x24))) & (x20 | ~x24);
  ...
  assign new_n81_ = x06 & ~new_n51_ & x08;
  assign new_n82_ = x02 & ((new_n83_ & new_n86_) | ((~new_n84_ | ~new_n85_) & x25));
  ...
  assign new_n89_ = x02 & ((new_n92_ & new_n93_) | ((~new_n90_ | ~new_n91_) & x26));
