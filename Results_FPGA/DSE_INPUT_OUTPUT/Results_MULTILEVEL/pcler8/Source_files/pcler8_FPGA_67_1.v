...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((x14 & (x19 ? (x20 & (new_n65_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n67_ & ~x10) | (x03 & ~new_n50_ & x08);
  assign new_n67_ = (x20 | ~x22) & (~x14 | ((~x22 | (x19 & ~new_n60_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign z13 = z05 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x20 | ~x23) & (~x14 | ((x22 | ~x23) & (~x20 | ~x22 | (~new_n71_ & (new_n70_ | ~x23)))));
  assign new_n70_ = x19 & x21 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n71_ = x19 & x21 & ~x23;
  assign z14 = (~x08 & x09 & ~new_n73_ & ~x10) | (x05 & ~new_n50_ & x08);
  assign new_n73_ = (x20 | ~x24) & (~x14 | (~new_n76_ & ((new_n74_ & new_n75_) | ~x24)));
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n78_ | new_n83_));
  assign new_n78_ = x14 & ((new_n79_ & new_n82_) | (x25 & (~new_n80_ | ~new_n81_)));
  ...
  assign new_n86_ = x14 & ((new_n89_ & new_n90_) | ((~new_n87_ | ~new_n88_) & x26));
