...
module FAU ( 
  ...
  assign z12 = (x19 & (new_n68_ | ~x09)) | (x03 & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & x22 & (~new_n67_ | ~x19 | ~x20);
  assign new_n67_ = x21 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n68_ = ~x08 & ~x10 & x20 & x21 & ~x22;
  assign z13 = ~new_n73_ | (~x08 & ~x10 & (new_n72_ | (~new_n70_ & x22)));
  assign new_n70_ = (~x19 | ~x20 | ~x21 | (~new_n71_ & x23)) & (~x09 | ~x23 | (x19 & x20 & x21));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = x09 & ~x22 & x23;
  assign new_n73_ = (~x04 | ~x08) & (x09 | ~x19);
  ...
  assign new_n79_ = x19 & (~x09 | (new_n80_ & new_n63_ & x24 & ~x25));
  assign new_n80_ = x20 & x21 & ~x08 & ~x10;
  assign new_n81_ = x25 & (~new_n76_ | ~new_n63_ | ~x24 | (x17 & x26));
  assign z16 = (x19 & (new_n83_ | ~x09)) | (x07 & x08) | (~x08 & new_n84_ & x09);
  assign new_n83_ = new_n80_ & new_n63_ & x24 & x25 & ~x26;
