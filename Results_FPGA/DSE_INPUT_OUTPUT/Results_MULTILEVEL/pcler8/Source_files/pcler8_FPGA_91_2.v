...
module FAU ( 
  ...
  assign new_n68_ = (~x22 | (x20 & (~x23 | (~new_n69_ & (~x20 | (x19 & x21)))))) & (~x19 | ~x20 | ~x21 | x22 | ~x23);
  assign new_n69_ = x14 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & x09 & new_n71_ & ~x10);
  assign new_n71_ = x23 & ((x20 & x22 & (~x19 | ~x21)) | ~x20 | new_n72_ | ~x22);
  ...
  assign new_n83_ = x20 & (~x23 | (new_n84_ & new_n48_ & ~x10 & x19));
  assign new_n84_ = x21 & x22 & x24 & x25 & ~x26;
