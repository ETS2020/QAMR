...
module FAU ( 
  ...
  assign z11 = (x13 & (new_n64_ | ~x20)) | (x02 & x08) | (new_n66_ & ~x08);
  assign new_n64_ = new_n65_ & ~x08 & x09 & ~x10 & x19;
  assign new_n65_ = x22 & x23 & x24 & x25 & x26;
  assign new_n66_ = x09 & ~x10 & (x20 ? (x19 ^ x21) : x21);
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & ~new_n47_ & x08);
  assign new_n68_ = (~x20 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x21 | x22))) & (x13 | x20 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | new_n47_ | (x04 & x08);
  ...
  assign new_n74_ = (~x24 | (new_n75_ & x19 & x21)) & (~new_n76_ | ~x19 | ~x20 | ~x21);
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x22 & x23 & ~x24;
  assign new_n77_ = ~x20 & (x13 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & ~new_n47_ & x08);
  assign new_n79_ = (~x20 | ((~x25 | (new_n80_ & new_n81_)) & (~new_n80_ | ~new_n82_))) & (x13 | x20 | ~x25);
