...
module FAU ( 
  ...
  assign new_n64_ = x19 ? ((~new_n49_ | ~new_n48_ | ~x12) & (x20 | ~x21)) : ~x20;
  ...
  assign new_n68_ = (~x19 | ~x20 | (x22 & (~new_n49_ | ~x14 | ~x23))) & (~x22 | (x19 & x20));
  assign z13 = (x04 & ~new_n51_ & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x21 & ((x19 & ~new_n71_ & x20) | (~x20 & x23))) | (~x19 & x23));
  assign new_n71_ = x22 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = z06 | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((~x19 & x24) | (x21 & (new_n75_ | (~new_n74_ & x24))));
  ...
  assign new_n77_ = x19 & (~x21 | (new_n47_ & new_n48_ & x24 & ~x25));
  assign new_n78_ = x25 & (~new_n79_ | ~new_n61_ | ~x19);
  assign new_n79_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (~x08 & x09 & ~new_n81_ & ~x10) | (x07 & ~new_n51_ & x08);
  assign new_n81_ = (x19 | ~x26) & (~x21 | ((new_n82_ | ~x26) & (~new_n83_ | ~new_n61_ | ~x19)));
