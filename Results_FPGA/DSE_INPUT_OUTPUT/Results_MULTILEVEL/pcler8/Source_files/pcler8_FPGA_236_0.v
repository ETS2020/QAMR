...
module FAU ( 
  ...
  assign z12 = (x02 & (new_n69_ | (x03 & x08))) | (x20 & (x08 ? x03 : new_n70_));
  assign new_n69_ = new_n48_ & ~x10 & ~x20 & x22;
  assign new_n70_ = x09 & ~x10 & ((x22 & (~x19 | new_n71_ | ~x21)) | (x19 & x21 & ~x22));
  ...
  assign new_n84_ = ~x20 & (~x02 | (new_n48_ & ~x10 & x25));
