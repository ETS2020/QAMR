...
module FAU ( 
  ...
  assign new_n66_ = x20 & (x19 ? (~x21 | (new_n49_ & new_n48_ & x13)) : x21);
  assign z12 = (x03 & ~new_n51_ & x08) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x20 & (x19 ? (x21 & (new_n69_ | ~x22)) : x22)) | (~x21 & x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n51_ & x08) | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((~x21 & x23) | (x20 & (x19 ? (~new_n72_ & x21) : x23)));
  assign new_n72_ = x22 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = new_n74_ | (x05 & x08) | (~x08 & new_n76_ & x09);
  assign new_n74_ = x21 & (~x20 | (new_n75_ & ~x08 & x09 & ~x10));
  assign new_n75_ = x19 & x22 & x23 & ~x24;
  assign new_n76_ = ~x10 & x24 & (~x19 | ~x21 | ~new_n77_ | ~x22);
  assign new_n77_ = x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~new_n79_ & x21) | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n79_ = x20 & (~new_n47_ | ~new_n48_ | ~x24 | x25);
  ...
  assign new_n83_ = x20 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
