...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n69_ & ~x10) | (x04 & x08 & (~x10 | ~x20));
  assign new_n69_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n70_ = x25 & x26 & x15 & x24;
  assign z14 = (~x08 & x09 & ~new_n72_ & ~x10) | (x05 & x08 & (~x10 | ~x20));
  assign new_n72_ = (~x24 | (new_n73_ & x22 & ~new_n74_ & x23)) & (~new_n73_ | ~x22 | ~x23 | x24);
  assign new_n73_ = x19 & x20 & x21;
  assign new_n74_ = x16 & x25 & x26;
  assign z15 = new_n76_ | (x06 & x08) | (~x08 & x09 & new_n77_ & ~x10);
  assign new_n76_ = x20 & (x10 | (new_n47_ & new_n48_ & x24 & ~x25));
  assign new_n77_ = x25 & (~new_n73_ | ~new_n48_ | ~x24 | (x17 & x26));
  assign z16 = (~new_n79_ & x20) | (x07 & x08) | (~x08 & new_n80_ & x09);
  assign new_n79_ = ~x10 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
  assign new_n80_ = ~x10 & x26 & (~new_n81_ | ~new_n48_ | ~x24 | ~x25);
