...
module FAU ( 
  ...
  assign z14 = (x05 & (x08 | ~x20)) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x24 | (new_n78_ & x22 & ~new_n79_ & x23)) & (~new_n78_ | ~x22 | ~x23 | x24);
  assign new_n78_ = x19 & x20 & x21;
  assign new_n79_ = x16 & x25 & x26;
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n81_ = ~x20 & (x05 | (new_n48_ & ~x10 & x25));
  assign new_n82_ = (~x25 | (new_n83_ & new_n84_)) & (~new_n78_ | ~new_n61_ | ~x24 | x25);
