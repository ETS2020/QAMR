...
module FAU ( 
  ...
  assign new_n72_ = (x19 | ~x23) & (x03 | (~new_n74_ & ((new_n60_ & new_n73_) | ~x23)));
  assign new_n73_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n74_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (~new_n76_ & x19) | (x05 & x08) | (~x08 & new_n78_ & x09);
  assign new_n76_ = ~x03 & (~new_n77_ | x08 | ~x09 | x10 | ~x20);
  ...
  assign z15 = new_n82_ | (~x08 & x09 & (new_n83_ | new_n87_) & ~x10);
  assign new_n82_ = x06 & ~new_n50_ & x08;
  assign new_n83_ = ~x03 & ((new_n79_ & new_n86_) | ((~new_n84_ | ~new_n85_) & x25));
  assign new_n84_ = x20 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x22 & x23 & x24 & ~x25;
  assign new_n87_ = ~x19 & x25;
  assign z16 = (~new_n89_ & x19) | (x07 & x08) | (~x08 & new_n90_ & x09);
  assign new_n89_ = ~x03 & (~new_n47_ | ~new_n66_ | ~x24 | ~x25 | x26);
