...
module FAU ( 
  ...
  assign new_n74_ = ~x20 & (x04 | (new_n48_ & ~x10 & x24));
  assign new_n75_ = (~x24 | (new_n76_ & x19 & x21)) & (~new_n77_ | ~x19 | ~x20 | ~x21);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = new_n79_ | (x20 & (x08 ? x06 : (new_n81_ & x09)));
  assign new_n79_ = ~new_n80_ & ~x04;
  assign new_n80_ = (~x06 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x25);
  assign new_n81_ = ~x10 & ((x25 & (~new_n82_ | ~x23 | new_n83_ | ~x24)) | (new_n82_ & x23 & x24 & ~x25));
