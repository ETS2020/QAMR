...
module FAU ( 
  ...
  assign z09 = (~new_n62_ & (~x15 | ~x20)) | (new_n59_ & new_n63_ & x11 & ~x15 & x20);
  ...
  assign new_n65_ = (x15 | ~x20 | (x19 & (~new_n67_ | ~new_n66_ | ~x12))) & (~x19 | x20);
  assign new_n66_ = x21 & x22;
  assign new_n67_ = x23 & x24 & x25 & x26;
  assign z11 = (~x08 & x09 & ~new_n69_ & ~x10) | new_n50_ | (x02 & x08);
  assign new_n69_ = (~x19 | ~x20 | (x21 & (~new_n61_ | ~new_n60_ | ~x13))) & (~x21 | (x19 & x20));
  assign z12 = new_n71_ | (x03 & x08) | (~x08 & new_n72_ & x09);
  assign new_n71_ = x20 & (x15 | (new_n63_ & x19 & x21 & ~x22));
  assign new_n72_ = ~x10 & x22 & (~x19 | ~x20 | new_n73_ | ~x21);
  assign new_n73_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (~x08 & new_n76_ & x09) | (~new_n75_ & x20);
  assign new_n75_ = ~x15 & (~new_n63_ | ~x22 | x23 | ~x19 | ~x21);
  assign new_n76_ = ~x10 & x23 & (~new_n66_ | ~x19 | ~x20);
  assign z14 = (x05 & x08) | (~x08 & new_n80_ & x09) | (~new_n78_ & x20);
  assign new_n78_ = ~x15 & (~new_n79_ | ~new_n66_ | ~x23 | x24);
  assign new_n79_ = ~x08 & x09 & ~x10 & x19;
  assign new_n80_ = ~x10 & x24 & (~new_n81_ | ~x19 | ~x20 | ~x21);
  assign new_n81_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x06 & x08) | (~x08 & new_n84_ & x09) | (~new_n83_ & x20);
  assign new_n83_ = ~x15 & (~new_n79_ | ~new_n66_ | ~x23 | ~x24 | x25);
  assign new_n84_ = ~x10 & x25 & (~new_n85_ | ~x19 | ~x20 | ~x21);
  assign new_n85_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (x07 & x08) | (~x08 & new_n89_ & x09) | (~new_n87_ & x20);
  assign new_n87_ = ~x15 & (~new_n88_ | ~new_n60_ | ~x24 | ~x25 | x26);
  assign new_n88_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n60_ | ~x24 | ~x25);
  assign new_n90_ = ~x18 & x19 & x20 & x21;
endmodule
