...
module FAU ( 
  ...
  assign z00 = x20 & (x05 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign new_n61_ = ~x05 & ~x08 & x09 & ~x10 & x11 & x20;
  assign z10 = (x01 & ~new_n51_ & x08) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((~x05 & x20 & (~x19 | (new_n64_ & new_n65_))) | (x19 & ~x20));
  ...
  assign z12 = (x20 & (new_n71_ | x05)) | (new_n69_ & ~x08) | (x03 & x08);
  ...
  assign z14 = (x05 & (x08 | x20)) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (new_n77_ & x22 & ~new_n78_ & x23)) & (~new_n77_ | ~x22 | ~x23 | x24);
  assign new_n77_ = x19 & x20 & x21;
  assign new_n78_ = x16 & x25 & x26;
  assign z15 = new_n80_ | (~x08 & x09 & ~x10 & (new_n81_ | new_n85_));
  assign new_n80_ = x06 & ~new_n51_ & x08;
  assign new_n81_ = ~x05 & ((new_n77_ & new_n84_) | ((~new_n82_ | ~new_n83_) & x25));
  ...
  assign new_n87_ = ~x05 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
