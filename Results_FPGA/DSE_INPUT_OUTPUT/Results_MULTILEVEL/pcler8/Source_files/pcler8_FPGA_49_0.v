...
module FAU ( 
  ...
  assign new_n63_ = x19 & (x20 ? (new_n64_ | ~x21) : x21);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x21));
  assign z12 = new_n69_ | (x03 & x08) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (x20 & ~new_n68_ & x21)) & (~x20 | ~x21 | x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x19 & (~x22 | (~x08 & x09 & ~x10));
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x22 | ((~x19 | ~x20 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x20 & x21)))) & (~x19 | x22 | ~x23);
  ...
  assign new_n79_ = (~x25 | (new_n80_ & new_n81_)) & (~new_n82_ | ~new_n75_ | ~x19);
  assign new_n80_ = x20 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x22 & x23 & x24 & ~x25;
  assign new_n83_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n90_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x26));
endmodule
