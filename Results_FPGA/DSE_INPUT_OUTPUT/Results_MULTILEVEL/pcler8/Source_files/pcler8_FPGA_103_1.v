...
module FAU ( 
  ...
  assign z14 = (~new_n73_ & x22) | (x05 & x08) | (~x08 & new_n75_ & x09);
  assign new_n73_ = x06 & (~new_n74_ | x10 | ~x19 | x08 | ~x09);
  assign new_n74_ = x20 & x21 & x23 & ~x24;
  assign new_n75_ = ~x10 & x24 & (~new_n76_ | ~x19 | ~x20 | ~x21);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x08 & (x06 | x22)) | (~x08 & new_n80_ & x09) | (x22 & (new_n78_ | ~x06));
  assign new_n78_ = new_n79_ & x19 & x20 & x09 & ~x10;
  ...
  assign new_n83_ = x07 & ~new_n50_ & x08;
  assign new_n84_ = x06 & ((new_n87_ & new_n88_) | ((~new_n85_ | ~new_n86_) & x26));
