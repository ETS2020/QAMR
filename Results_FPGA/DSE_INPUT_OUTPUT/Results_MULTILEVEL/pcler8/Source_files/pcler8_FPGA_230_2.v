...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n72_ & ~x10) | (x04 & x08 & (~x10 | x19));
  ...
  assign z15 = (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & x08 & (~x10 | x19));
  assign new_n79_ = (~x25 | (new_n80_ & new_n59_ & x24 & (~x17 | ~x26))) & (~new_n80_ | ~new_n59_ | ~x24 | x25);
  assign new_n80_ = x19 & x20 & x21;
  assign z16 = (~x08 & x09 & ~new_n82_ & ~x10) | (x07 & x08 & (~x10 | x19));
