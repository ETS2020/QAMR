...
module FAU ( 
  ...
  assign new_n77_ = ~x22 & (x06 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | (new_n67_ & new_n80_ & x24 & (~x17 | ~x26))) & (~new_n67_ | ~new_n80_ | ~x24 | x25);
  assign new_n80_ = x22 & x23;
  assign z16 = new_n82_ | (x22 & (x08 ? x07 : (new_n84_ & x09)));
  assign new_n82_ = ~new_n83_ & ~x06;
  assign new_n83_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x26);
  assign new_n84_ = ~x10 & ((x26 & (~new_n85_ | ~new_n86_)) | (new_n67_ & new_n87_));
