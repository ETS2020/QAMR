...
module FAU ( 
  ...
  assign z04 = x03 & x08;
  assign z05 = (~x03 & x20) | (x04 & x08 & (~x20 | (x03 & x20)));
  ...
  assign z13 = (x20 & (new_n74_ | ~x03)) | (x04 & x08) | (new_n76_ & ~x08);
  assign new_n74_ = ~x08 & x09 & ~x10 & new_n75_ & x22 & ~x23;
  ...
  assign new_n79_ = (x20 | ~x24) & (~x03 | (~new_n81_ & ((new_n75_ & new_n80_) | ~x24)));
  ...
  assign new_n88_ = x03 & (~new_n89_ | ~new_n60_ | ~new_n75_ | x10);
