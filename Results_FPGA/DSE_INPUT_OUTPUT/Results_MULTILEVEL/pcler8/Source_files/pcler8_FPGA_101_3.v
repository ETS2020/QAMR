...
module FAU ( 
  ...
  assign z12 = (x20 & (new_n60_ | x25)) | (x03 & x08) | (new_n61_ & ~x08);
  ...
  assign z14 = ~new_n65_ | (x20 & ((new_n67_ & new_n68_) | x25));
  assign new_n65_ = x08 ? ~x05 : (~x09 | ~new_n66_ | x10);
  assign new_n66_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign new_n67_ = ~x10 & x19 & ~x08 & x09;
  assign new_n68_ = x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & ~z00 & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((~x20 & x25) | (new_n71_ & x19 & x20 & x21));
