...
module FAU ( 
  ...
  assign z00 = (~x19 & ~x23) | (new_n47_ & new_n48_ & x21 & x22 & x23);
  ...
  assign new_n65_ = x19 & (x20 ? (new_n66_ | ~x21) : x21);
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n67_ = ~x19 & (~x23 | (~x08 & x09 & ~x10 & x21));
  ...
  assign new_n75_ = ~new_n76_ & (~x19 | ~x24 | (new_n77_ & x20 & x21));
  assign new_n76_ = x23 & ((~x19 & x24) | (x19 & x20 & x21 & x22 & ~x24));
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~x08 & x09 & ~new_n79_ & ~x10) | (x06 & ~new_n50_ & x08);
  ...
  assign new_n85_ = x23 & ((~x19 & x26) | (new_n86_ & x19 & x20 & x21));
