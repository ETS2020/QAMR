...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((~x18 & x20 & ((new_n65_ & new_n66_) | ~x19)) | (x19 & ~x20));
  ...
  assign new_n74_ = (x20 | ~x23) & (x18 | (~new_n77_ & ((new_n75_ & new_n76_) | ~x23)));
  ...
  assign new_n79_ = (x20 | ~x24) & (x18 | (~new_n81_ & ((new_n75_ & new_n80_) | ~x24)));
  ...
  assign new_n83_ = ~x18 & (~new_n84_ | x08 | ~x09 | x10 | ~x19);
  ...
  assign new_n88_ = (x20 | ~x26) & (x18 | ((~new_n90_ | ~new_n91_) & (new_n89_ | ~x26)));
  assign new_n89_ = x19 & x21 & x22 & x23 & x24 & x25;
