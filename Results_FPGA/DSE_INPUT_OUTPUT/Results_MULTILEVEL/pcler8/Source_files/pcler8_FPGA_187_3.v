...
module FAU ( 
  ...
  assign new_n65_ = x20 ? (x19 & (~new_n66_ | ~new_n61_ | ~x23 | ~x24)) : ~x19;
  assign new_n66_ = x12 & x21 & x22;
  assign z11 = (~x08 & x09 & ~new_n68_ & ~x10) | new_n50_ | (x02 & x08);
  assign new_n68_ = x20 ? (x19 ? (x21 & (~new_n60_ | ~new_n63_ | ~x13)) : ~x21) : ~x21;
  assign z12 = (~x08 & x09 & ~new_n70_ & ~x10) | (x03 & ~new_n50_ & x08);
  assign new_n70_ = (x20 | ~x22) & (x18 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  ...
  assign new_n81_ = ~x18 & (new_n82_ | (new_n84_ & x19 & x20 & x21));
  assign new_n82_ = x25 & (~new_n83_ | ~x23 | ~x24 | (x17 & x26));
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = new_n63_ & x24 & ~x25;
  assign new_n85_ = ~x20 & x25;
  assign z16 = (x07 & ~new_n50_ & x08) | (new_n87_ & ~x08);
  assign new_n87_ = x09 & ~x10 & ((~x20 & x26) | (~new_n88_ & ~x18));
  assign new_n88_ = (~x26 | (new_n83_ & x23 & x24 & x25)) & (~new_n89_ | ~x23 | ~x24 | ~x25 | x26);
