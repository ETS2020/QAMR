...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n69_ & ~x10) | (x10 & ~x20) | (x04 & x08);
  ...
  assign new_n72_ = (~x24 | (new_n73_ & x19 & x21)) & (~new_n74_ | ~x19 | ~x20 | ~x21);
  assign new_n73_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n74_ = x22 & x23 & ~x24;
  assign new_n75_ = ~x20 & (x10 | (~x08 & x09 & x24));
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n79_ & new_n58_ & x19)) & (~new_n80_ | ~new_n78_ | ~x19);
