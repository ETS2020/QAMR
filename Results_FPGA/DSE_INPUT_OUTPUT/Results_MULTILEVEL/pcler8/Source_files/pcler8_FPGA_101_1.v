...
module FAU ( 
  ...
  assign z00 = x25 & (~x20 | (new_n48_ & new_n47_ & ~x10 & x19));
  ...
  assign new_n62_ = ~x20 & (x25 | (new_n47_ & ~x10 & x19));
  ...
  assign new_n77_ = ~x20 & (x25 | (new_n47_ & ~x10 & x24));
  ...
  assign new_n82_ = x20 & ((x25 & (~new_n83_ | ~x23 | new_n84_ | ~x24)) | (new_n83_ & x23 & x24 & ~x25));
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = x17 & x26;
  assign z16 = (x07 & x08) | (~x08 & new_n88_ & x09) | (~new_n86_ & x25);
  assign new_n86_ = x20 & (~new_n87_ | ~new_n47_ | x10 | ~x19);
  assign new_n87_ = x21 & x22 & x23 & x24 & ~x26;
  assign new_n88_ = ~x10 & x26 & (~new_n89_ | x18 | ~x19 | ~x21);
