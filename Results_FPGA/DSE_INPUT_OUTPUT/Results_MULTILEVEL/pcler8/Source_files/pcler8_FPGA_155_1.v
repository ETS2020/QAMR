...
module FAU ( 
  ...
  assign new_n63_ = (~x04 | ~x20 | (x19 & (~new_n61_ | ~new_n64_))) & (~x19 | x20);
  ...
  assign z12 = (~x08 & x09 & ~new_n69_ & ~x10) | (x03 & ~new_n51_ & x08);
  assign new_n69_ = (x20 | ~x22) & (~x04 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n70_ = x24 & x25 & x26 & x14 & x23;
  assign z13 = (x04 & (x08 | (x09 & ~new_n72_ & ~x10))) | (~x08 & x09 & new_n75_ & ~x10);
  assign new_n72_ = (x22 | ~x23) & (~x20 | ~x22 | (~new_n73_ & (~new_n74_ | ~x19)));
  assign new_n73_ = ~x08 & x23 & (~x19 | ~x21);
  assign new_n74_ = x21 & (~x23 | (x25 & x26 & x15 & x24));
  assign new_n75_ = ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x20 | ~x24) & (~x04 | (~new_n80_ & ((new_n78_ & new_n79_) | ~x24)));
  ...
  assign new_n87_ = x04 & (~new_n48_ | ~new_n49_ | ~x24 | ~x25 | x26);
  assign new_n88_ = ~x10 & x26 & (~new_n89_ | ~new_n49_ | ~x24 | ~x25);
