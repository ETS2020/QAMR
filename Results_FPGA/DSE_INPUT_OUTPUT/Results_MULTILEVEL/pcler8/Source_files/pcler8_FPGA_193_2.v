...
module FAU ( 
  ...
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x20 & (x19 ? (new_n64_ | ~x21) : x21)) | (~x11 & ~x20 & x21));
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n66_ & ~x10) | (x03 & ~new_n49_ & x08);
  assign new_n66_ = (~x20 | ((~x22 | (x19 & ~new_n67_ & x21)) & (~x19 | ~x21 | x22))) & (x11 | x20 | ~x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = new_n76_ | (x05 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x24 | (new_n73_ & x22 & ~new_n74_ & x23)) & (~new_n75_ | ~x22 | ~x23 | x24);
  assign new_n73_ = x19 & x21;
  assign new_n74_ = x16 & x25 & x26;
  assign new_n75_ = x19 & x20 & x21;
  assign new_n76_ = ~x20 & (x11 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n82_ | (x06 & x08) | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((new_n75_ & new_n81_) | (x25 & (~new_n79_ | ~new_n80_)));
  assign new_n79_ = x19 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x20 & (x11 | (~x08 & x09 & ~x10 & x25));
