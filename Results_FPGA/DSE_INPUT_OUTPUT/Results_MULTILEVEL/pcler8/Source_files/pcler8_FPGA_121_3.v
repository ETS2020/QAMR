...
module FAU ( 
  ...
  assign new_n66_ = (~x22 | (~new_n67_ & x21 & x19 & x20)) & (~x21 | x22 | ~x19 | ~x20);
  ...
  assign new_n73_ = ~x08 & x09 & x19 & new_n58_ & x23 & ~x24;
  ...
  assign new_n78_ = x20 & (x10 | (new_n80_ & new_n79_ & x24 & ~x25));
  assign new_n79_ = x22 & x23;
  assign new_n80_ = ~x08 & x09 & x19 & x21;
  assign new_n81_ = x25 & (~new_n75_ | ~new_n79_ | ~x24 | (x17 & x26));
  assign z16 = (~x08 & x09 & ~new_n83_ & ~x10) | (x07 & x08 & (~x10 | ~x20));
