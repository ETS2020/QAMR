...
module FAU ( 
  ...
  assign z13 = (x04 & x08) | (~x10 & (~x19 | (~x08 & ~new_n67_ & x09)));
  assign new_n67_ = x22 ? ((~x19 | ~x23 | (x20 & x21)) & (~x20 | ~x21 | (~new_n68_ & x23))) : ~x23;
  assign new_n68_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~x10 & (~x19 | (~x08 & ~new_n70_ & x09)));
  assign new_n70_ = (~x24 | (x20 & x21 & x22 & ~new_n71_ & x23)) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n71_ = x16 & x25 & x26;
  assign z15 = (x06 & x08) | (~x10 & (~x19 | (~x08 & ~new_n73_ & x09)));
  assign new_n73_ = (~x25 | (new_n74_ & x23 & x24 & (~x17 | ~x26))) & (~new_n74_ | ~x23 | ~x24 | x25);
  assign new_n74_ = x20 & x21 & x22;
  assign z16 = (x07 & x08) | (~x10 & (~x19 | (~x08 & ~new_n76_ & x09)));
