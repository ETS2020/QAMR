...
module FAU ( 
  ...
  assign new_n63_ = x20 ? (~new_n64_ & x19) : ~x19;
  assign new_n64_ = x12 & x21 & x22 & x23 & x24 & x25;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x26 & (x19 ? (x20 & (new_n67_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25;
  assign z12 = (x20 & (new_n71_ | ~x26)) | (x03 & x08) | (new_n69_ & ~x08);
  assign new_n69_ = x09 & ~x10 & x22 & (~new_n70_ | ~x19 | ~x20);
  assign new_n70_ = x21 & (~x24 | ~x25 | ~x14 | ~x23);
  assign new_n71_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign z13 = (~new_n73_ & x20) | (x04 & x08) | (new_n75_ & ~x08);
  assign new_n73_ = x26 & (~new_n74_ | x08 | ~x09 | x10);
  assign new_n74_ = x19 & x21 & x22 & ~x23;
  assign new_n75_ = x09 & ~x10 & x23 & (~new_n76_ | ~x19 | ~x20);
  assign new_n76_ = x21 & x22 & (~x15 | ~x24 | ~x25);
  assign z14 = (~x08 & x09 & ~new_n78_ & ~x10) | (x05 & ~new_n50_ & x08);
  assign new_n78_ = (~x24 | (x20 & (new_n79_ | ~x26))) & (~new_n80_ | ~new_n61_ | x24 | ~x26);
  assign new_n79_ = x19 & x21 & x22 & x23 & (~x16 | ~x25);
  assign new_n80_ = x19 & x20 & x21;
  assign z15 = new_n82_ | (x06 & x08) | (~x08 & x09 & new_n84_ & ~x10);
  assign new_n82_ = x20 & (~x26 | (new_n83_ & new_n48_ & ~x10 & x19));
  assign new_n83_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n84_ = x25 & (~new_n85_ | x17 | ~x19 | ~x20);
  assign new_n85_ = x21 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & new_n87_ & ~x10);
  assign new_n87_ = x26 & (~new_n88_ | ~new_n61_ | ~x24 | ~x25);
