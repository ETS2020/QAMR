// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:41 2020
...
module FAU ( 
  ...
  assign new_n60_ = x21 & x22 & x23 & new_n61_ & x24;
  assign new_n61_ = x25 & x26;
  assign z10 = z02 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x20 | (x19 & (~new_n64_ | ~new_n61_ | ~x23 | ~x24))) & (~x19 | x20 | x23);
  ...
  assign new_n69_ = ~x20 & (x23 | (new_n48_ & ~x10 & x22));
  ...
  assign new_n73_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x19 & x21))) : ~x23;
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (x23 | ~x24) & (~x20 | ((~x24 | (new_n77_ & ~new_n78_ & x22)) & (~new_n77_ | ~x22 | ~x23 | x24)));
  assign new_n77_ = x19 & x21;
  assign new_n78_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((~x23 & x25) | (x20 & (new_n82_ | (~new_n81_ & x25))));
  assign new_n81_ = x19 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n82_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = new_n84_ | (x07 & x08) | (~x08 & x09 & new_n86_ & ~x10);
  assign new_n84_ = x23 & (~x20 | (new_n85_ & new_n48_ & ~x10 & x19));
  assign new_n85_ = x21 & x22 & x24 & x25 & ~x26;
  assign new_n86_ = x26 & (~new_n87_ | ~new_n77_ | x18);
