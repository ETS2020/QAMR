...
module FAU ( 
  ...
  assign z14 = new_n72_ | (x20 & (x08 ? x05 : (new_n74_ & x09)));
  assign new_n72_ = ~new_n73_ & ~x03;
  assign new_n73_ = (~x05 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x24);
