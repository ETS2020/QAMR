...
module FAU ( 
  ...
  assign z11 = (~new_n47_ & ((new_n66_ & ~x08 & x09) | (x02 & x08))) | (~x08 & new_n64_ & x09);
  ...
  assign new_n68_ = (~x20 | ((~x19 | ~x21 | (~new_n69_ & x22)) & (~x22 | (x19 & x21)))) & (~x12 | x20 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x12 | x20 | ~x23) & (~x20 | ((~x23 | (x19 & x21)) & (~x19 | new_n72_ | ~x21)));
  ...
  assign new_n77_ = ~x20 & (~x12 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x20 | ((~x25 | (new_n80_ & new_n81_)) & (~new_n80_ | ~new_n82_))) & (~x12 | x20 | ~x25);
