...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n62_ & ~x10) | (x01 & ~new_n47_ & x08);
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (x14 | ~x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & ~new_n47_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x14 & ~x20 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & ~new_n47_ & x08);
  assign new_n68_ = (~x20 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x21 | x22))) & (x14 | x20 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n72_ = x25 & x26 & x15 & x24;
  assign z14 = new_n78_ | (~x08 & x09 & ~new_n74_ & ~x10) | (x05 & x08);
  assign new_n74_ = (~x24 | (new_n75_ & x22 & ~new_n76_ & x23)) & (~new_n77_ | ~x22 | ~x23 | x24);
  assign new_n75_ = x19 & x21;
  assign new_n76_ = x16 & x25 & x26;
  assign new_n77_ = x19 & x20 & x21;
  assign new_n78_ = ~x20 & (x14 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n84_ | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((new_n77_ & new_n83_) | ((~new_n81_ | ~new_n82_) & x25));
  assign new_n81_ = x19 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign new_n84_ = ~x20 & (x14 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n90_));
  assign new_n86_ = x20 & ((new_n81_ & new_n89_) | ((~new_n87_ | ~new_n88_) & x26));
  assign new_n87_ = ~x18 & x19 & x21;
  assign new_n88_ = x24 & x25 & x22 & x23;
  assign new_n89_ = x23 & x24 & x25 & ~x26;
  assign new_n90_ = ~x14 & ~x20 & x26;
endmodule
