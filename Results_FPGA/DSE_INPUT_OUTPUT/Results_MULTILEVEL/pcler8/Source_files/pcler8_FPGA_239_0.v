...
module FAU ( 
  ...
  assign new_n67_ = (~x22 | ((~x14 | (~new_n60_ & x19)) & (~x19 | (x20 & x21)))) & (~x19 | ~x20 | ~x21 | x22);
  assign z13 = new_n69_ | (~x08 & x09 & ~x10 & (new_n70_ | new_n73_));
  assign new_n69_ = x04 & ~new_n47_ & x08;
  assign new_n70_ = x23 & ((x14 & (new_n72_ | ~x19)) | (x19 & (~x22 | (~new_n71_ & x22))));
  assign new_n71_ = x20 & x21;
  assign new_n72_ = x15 & x19 & x22 & x24 & x25 & x26;
  assign new_n73_ = x19 & x20 & new_n74_ & x21;
  assign new_n74_ = x22 & (~x23 | (x25 & x26 & x15 & x24));
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | ((~x24 | (new_n71_ & new_n77_)) & (~new_n71_ | ~new_n78_))) & (~x14 | x19 | ~x24);
