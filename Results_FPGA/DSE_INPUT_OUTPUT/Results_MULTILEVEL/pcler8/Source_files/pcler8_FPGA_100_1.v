...
module FAU ( 
  ...
  assign new_n60_ = x07 & ~x08 & x09 & ~x10 & x11 & x20;
  assign new_n61_ = x22 & x23;
  assign new_n62_ = x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x07 & x20 & ((new_n65_ & new_n66_) | ~x19)) | (x19 & ~x20));
  ...
  assign z12 = (x20 & (new_n72_ | ~x07)) | (x03 & x08) | (new_n70_ & ~x08);
  ...
  assign new_n77_ = (~x07 | (~new_n80_ & ((new_n78_ & new_n79_) | ~x24))) & (x20 | ~x24);
  ...
  assign new_n82_ = x07 & ((new_n83_ & new_n86_) | (x25 & (~new_n84_ | ~new_n85_)));
  ...
  assign z16 = (x08 & (x07 | x20)) | (x20 & (new_n89_ | ~x07)) | (~x08 & new_n91_ & x09);
  assign new_n89_ = new_n90_ & new_n78_ & x09 & ~x10;
  assign new_n90_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n91_ = ~x10 & x26 & (~new_n92_ | ~new_n61_ | ~x24 | ~x25);
