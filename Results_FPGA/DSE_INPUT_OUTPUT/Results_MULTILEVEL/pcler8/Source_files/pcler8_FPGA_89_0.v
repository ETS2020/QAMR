...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & (x19 ? (~x20 | (new_n65_ & new_n66_)) : (x20 & x26));
  assign new_n65_ = x12 & x21 & x22;
  assign new_n66_ = x23 & x24 & x25 & x26;
  assign z11 = new_n69_ | (~x08 & x09 & new_n68_ & ~x10) | (x02 & x08);
  assign new_n68_ = x19 & (x20 ? (~x21 | (new_n50_ & new_n49_ & x13)) : x21);
  assign new_n69_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x21));
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((x22 & (new_n72_ | (x19 & (~x20 | ~x21)))) | (x19 & x20 & x21 & ~x22));
  assign new_n72_ = x26 & (~x19 | (x24 & x25 & x14 & x23));
  ...
  assign new_n76_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n80_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~new_n47_ & (x08 ? x06 : (new_n82_ & x09))) | (~x08 & new_n83_ & x09);
  assign new_n82_ = ~x10 & x25 & (~new_n61_ | ~x22 | ~x23 | ~x24);
  assign new_n83_ = ~x10 & (new_n84_ | (new_n85_ & new_n61_ & x19));
  assign new_n84_ = x25 & x26 & (x17 | ~x19);
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign z16 = new_n91_ | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n87_ = ~x10 & ((new_n89_ & new_n90_) | ((~new_n62_ | ~new_n88_) & x26));
