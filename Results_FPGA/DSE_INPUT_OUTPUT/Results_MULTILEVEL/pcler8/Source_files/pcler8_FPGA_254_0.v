...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n61_, new_n62_, new_n64_,
    ...
    new_n91_;
  assign z00 = (~x20 & ~x21) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign new_n61_ = (~x20 | (x19 & (~new_n62_ | ~x12 | ~x21 | ~x22))) & (~x19 | x20 | ~x21);
  assign new_n62_ = x25 & x26 & x23 & x24;
  assign z11 = new_n66_ | (x02 & x08) | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = x21 ? (~new_n65_ & (x19 | ~x20)) : ~x19;
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n66_ = ~x20 & (~x21 | (~x08 & x09 & ~x10));
  assign z12 = (x03 & ~new_n50_ & x08) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x21 & ((x19 & x20 & (new_n69_ | ~x22)) | (x22 & (~x19 | ~x20)))) | (x20 & ~x21 & x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((x20 & ~x21 & x23) | (x21 & ((x23 & (~x19 | ~x20)) | (x19 & ~new_n72_ & x20))));
  assign new_n72_ = x22 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = new_n74_ | (x05 & x08) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n74_ = ~x20 & (~x21 | (new_n47_ & ~x10 & x24));
  ...
  assign new_n80_ = ~x20 & (~x21 | (new_n47_ & ~x10 & x25));
  ...
  assign new_n86_ = ~x20 & (~x21 | (new_n47_ & ~x10 & x26));
