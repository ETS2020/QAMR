...
module FAU ( 
  ...
  assign z10 = (~x08 & ~new_n61_ & ~x10) | (~x09 & ~x19) | (x01 & x08);
  assign new_n61_ = (~x09 | ~x19 | (x20 & (~new_n59_ | ~new_n62_))) & (x19 | ~x20);
  ...
  assign z12 = (~x19 & (~x09 | (new_n70_ & ~x08))) | (x03 & x08) | (~x08 & new_n68_ & x09);
  ...
  assign new_n75_ = (~x24 | (new_n76_ & x22 & ~new_n77_ & x23)) & (~new_n76_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n76_ = x20 & x21;
  assign new_n77_ = x16 & x25 & x26;
  assign new_n78_ = ~x19 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = z07 | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((x25 & (~new_n81_ | ~new_n48_ | new_n82_ | ~x24)) | (new_n81_ & new_n48_ & x24 & ~x25));
  assign new_n81_ = x19 & x20 & x21;
  assign new_n82_ = x17 & x26;
  assign z16 = (~x08 & new_n84_ & x09) | (x07 & x08 & (x09 | x19));
