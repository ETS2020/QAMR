...
module FAU ( 
  ...
  assign z09 = (x09 & (~x20 | (new_n58_ & ~x08))) | (x00 & x08);
  ...
  assign z13 = (x04 & x08) | (x09 & (~x20 | (~x08 & ~new_n69_ & ~x10)));
  assign new_n69_ = x22 ? ((~x19 | ~x21 | (~new_n70_ & x23)) & (~x20 | ~x23 | (x19 & x21))) : ~x23;
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (x09 & (~x20 | (~x08 & ~new_n72_ & ~x10)));
  ...
  assign new_n78_ = (~new_n76_ | ~new_n80_) & (~x26 | (new_n79_ & new_n47_ & ~x18));
