...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (~x19 | (new_n64_ & new_n65_))) | (~x01 & x19 & ~x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (~x01 & (new_n67_ | (x02 & x08))) | (x20 & ((x01 & x02 & x08) | (new_n68_ & ~x08)));
  assign new_n67_ = new_n48_ & ~x10 & ~x20 & x21;
  assign new_n68_ = x09 & ~x10 & (x19 ? (new_n69_ | ~x21) : x21);
  assign new_n69_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x01 & (new_n71_ | (x03 & x08))) | (x20 & (x08 ? x03 : new_n72_));
  assign new_n71_ = new_n48_ & ~x10 & ~x20 & x22;
  assign new_n72_ = x09 & ~x10 & ((x22 & (~x19 | new_n73_ | ~x21)) | (x19 & x21 & ~x22));
  assign new_n73_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & x09 & ~new_n75_ & ~x10) | new_n50_ | (x04 & x08);
  assign new_n75_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n76_ & x23)) & (~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  ...
  assign z15 = new_n84_ | (x06 & x08) | (~x08 & x09 & ~new_n85_ & ~x10);
  assign new_n84_ = ~x20 & (x01 | (new_n48_ & ~x10 & x25));
  assign new_n85_ = (~x25 | (new_n86_ & new_n87_)) & (~new_n88_ | ~new_n61_ | ~x24 | x25);
  ...
  assign new_n92_ = ~x10 & ((new_n86_ & new_n95_) | (x26 & (~new_n93_ | ~new_n94_)));
