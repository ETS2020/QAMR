...
module FAU ( 
  ...
  assign new_n63_ = (~x05 | ~x20 | (x19 & (~new_n61_ | ~new_n60_ | ~x12))) & (~x19 | x20);
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x05 & x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n70_ | ~x05)) | (x03 & x08) | (new_n68_ & ~x08);
  ...
  assign z14 = (x08 & (x05 | x20)) | (x20 & (new_n75_ | ~x05)) | (~x08 & new_n76_ & x09);
  assign new_n75_ = x09 & ~x10 & x19 & new_n60_ & x23 & ~x24;
  assign new_n76_ = ~x10 & (~new_n77_ | ~new_n78_) & x24;
  assign new_n77_ = x19 & x20 & x21;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n80_ | new_n84_));
  assign new_n80_ = x05 & ((new_n77_ & new_n83_) | (x25 & (~new_n81_ | ~new_n82_)));
  assign new_n81_ = x19 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign new_n84_ = ~x20 & x25;
  assign z16 = (~new_n86_ & x20) | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n86_ = x05 & (~new_n88_ | ~new_n87_ | ~x24 | ~x25 | x26);
  assign new_n87_ = x22 & x23;
  assign new_n88_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n87_ | ~x24 | ~x25);
