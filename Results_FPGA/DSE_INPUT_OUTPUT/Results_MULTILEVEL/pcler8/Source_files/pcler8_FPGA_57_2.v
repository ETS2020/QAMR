...
module FAU ( 
  ...
  assign z11 = new_n64_ | (x02 & x08) | (~x08 & x09 & new_n62_ & ~x10);
  assign new_n62_ = x19 & (x20 ? (new_n63_ | ~x21) : x21);
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n64_ = ~x19 & (x10 | (~x08 & x09 & x21));
  ...
  assign z15 = new_n80_ | (x06 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~new_n73_ | ~new_n79_) & (~x25 | (new_n77_ & new_n78_));
  assign new_n77_ = x20 & x21 & x22;
  assign new_n78_ = x23 & x24 & (~x17 | ~x26);
  assign new_n79_ = x22 & x23 & x24 & ~x25;
  assign new_n80_ = ~x19 & (x10 | (~x08 & x09 & x25));
  assign z16 = (x07 & x08 & (~x10 | x19)) | (~x08 & x09 & ~new_n82_ & ~x10);
