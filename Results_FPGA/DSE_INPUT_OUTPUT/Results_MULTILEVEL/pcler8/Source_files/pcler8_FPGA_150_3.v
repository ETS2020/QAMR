...
module FAU ( 
  ...
  assign z12 = (x20 & (new_n70_ | x05)) | (new_n68_ & ~x08) | (x03 & x08);
  ...
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n79_ | new_n83_));
  assign new_n79_ = ~x05 & ((new_n76_ & new_n82_) | (x25 & (~new_n80_ | ~new_n81_)));
  ...
  assign new_n85_ = ~x05 & (~new_n87_ | ~new_n86_ | ~x24 | ~x25 | x26);
