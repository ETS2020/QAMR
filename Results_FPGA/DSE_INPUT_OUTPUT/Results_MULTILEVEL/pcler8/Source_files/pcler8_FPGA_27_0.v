...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (x19 ? (new_n64_ | ~x21) : x21)) | (x16 & ~x20 & x21));
  ...
  assign new_n68_ = ~x20 & (~x16 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n76_ = ~x20 & (~x16 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~x08 & x09 & ~new_n78_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n78_ = (~x20 | ((~x25 | (new_n79_ & new_n80_)) & (~new_n79_ | ~new_n81_))) & (~x16 | x20 | ~x25);
