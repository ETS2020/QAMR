...
module FAU ( 
  ...
  assign new_n62_ = new_n49_ & ~x08 & x09 & ~x10 & x12 & x19;
  ...
  assign z12 = new_n68_ | (x03 & x08) | (~x08 & new_n70_ & x09);
  assign new_n68_ = ~x22 & (~x25 | (new_n69_ & ~x08 & x09 & ~x10));
  assign new_n69_ = x19 & x20 & x21;
  assign new_n70_ = ~x10 & x22 & (~new_n48_ | new_n71_ | ~x21);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & x09 & ~new_n73_ & ~x10) | new_n47_ | (x04 & x08);
  assign new_n73_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n47_ & x08) | (new_n76_ & ~x08);
  assign new_n76_ = x09 & ~x10 & (new_n79_ | (x24 & (new_n77_ | new_n78_)));
  assign new_n77_ = x25 & (~x22 | (x16 & x26));
  assign new_n78_ = x22 & (~x19 | ~x20 | ~x21 | ~x23);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = new_n82_ | (~x08 & x09 & ~new_n81_ & ~x10) | (x06 & x08);
  assign new_n81_ = (~x25 | (new_n69_ & x23 & x24 & (~x17 | ~x26))) & (~new_n69_ | ~x23 | ~x24 | x25);
  assign new_n82_ = ~x22 & (~x25 | (~x08 & x09 & ~x10));
  assign z16 = new_n84_ | (~x08 & x09 & ~x10 & (new_n85_ | new_n86_));
  assign new_n84_ = x07 & ~new_n47_ & x08;
  assign new_n85_ = x25 & ((~x22 & x26) | (new_n69_ & x22 & x23 & x24 & ~x26));
  assign new_n86_ = x22 & x26 & (~new_n87_ | ~new_n48_ | x18);
