...
module FAU ( 
  ...
  assign z00 = x22 & (~x20 | (new_n47_ & new_n48_ & x21 & x23));
  ...
  assign z09 = new_n59_ | (new_n60_ & new_n48_ & new_n61_ & x21);
  ...
  assign new_n63_ = ~x20 & (new_n47_ | x22);
  assign new_n64_ = (x19 | ~x20) & (~new_n65_ | ~x12 | ~x21 | ~x22);
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (~x08 & x09 & ~new_n67_ & ~x10) | new_n50_ | (x02 & x08);
  assign new_n67_ = (~x19 | ((~new_n48_ | ~new_n61_ | ~x13) & (~x20 | x21))) & (~x21 | (x20 & (x19 | ~x20)));
  assign z12 = new_n50_ | (x03 & x08) | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & ((x22 & (~x19 | new_n70_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & x09 & ~new_n72_ & ~x10) | (x04 & ~new_n50_ & x08);
  ...
  assign new_n75_ = (~x20 | ((~x24 | (new_n76_ & ~new_n77_ & x23)) & (~new_n76_ | ~x22 | ~x23 | x24))) & (x22 | ~x24);
  assign new_n76_ = x19 & x21;
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((~x22 & x25) | (x20 & (new_n81_ | (~new_n80_ & x25))));
  assign new_n80_ = x19 & x21 & x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x22 | ~x26) & (~x20 | ((new_n85_ | ~x26) & (~new_n84_ | ~new_n86_)));
  assign new_n84_ = x19 & x21 & x22;
  assign new_n85_ = ~x18 & x19 & x21 & x23 & x24 & x25;
