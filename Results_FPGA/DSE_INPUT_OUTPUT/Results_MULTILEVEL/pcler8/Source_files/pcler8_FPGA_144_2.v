...
module FAU ( 
  ...
  assign new_n62_ = (x19 | ~x20) & (~new_n60_ | ~new_n59_ | ~x12 | ~x19);
  ...
  assign new_n77_ = x19 & (~x20 | (new_n78_ & new_n79_));
  assign new_n78_ = ~x08 & x09 & ~x10 & x21;
  assign new_n79_ = x22 & x23 & x24 & ~x25;
  assign new_n80_ = x25 & (~new_n81_ | ~new_n59_ | ~x19);
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x19 | ~x26) & (~x20 | ((new_n84_ | ~x26) & (~new_n85_ | ~new_n59_ | ~x19)));
