...
module FAU ( 
  ...
  assign new_n73_ = (x20 | ~x23) & (x17 | (~new_n76_ & ((new_n74_ & new_n75_) | ~x23)));
  ...
  assign new_n78_ = (x20 | ~x24) & (x17 | (~new_n80_ & ((new_n74_ & new_n79_) | ~x24)));
  ...
  assign new_n84_ = x25 & (~x19 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign new_n86_ = ~x20 & x25;
  assign z16 = (~new_n88_ & x20) | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n88_ = ~x17 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
