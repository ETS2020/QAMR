...
module FAU ( 
  ...
  assign new_n77_ = x20 & (x10 | (new_n78_ & new_n64_ & x24 & ~x25));
  assign new_n78_ = ~x08 & x09 & x19 & x21;
  assign new_n79_ = x25 & (~new_n74_ | ~new_n64_ | ~x24 | (x17 & x26));
  assign z16 = (~new_n81_ & x20) | (x07 & x08) | (~x08 & new_n82_ & x09);
  assign new_n81_ = ~x10 & (~new_n78_ | ~new_n64_ | ~x24 | ~x25 | x26);
  assign new_n82_ = ~x10 & x26 & (~new_n83_ | ~new_n64_ | ~x24 | ~x25);
