...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n61_, new_n62_,
    ...
    new_n91_, new_n92_;
  assign z00 = x20 & (x01 | (new_n47_ & new_n49_ & new_n50_));
  ...
  assign z12 = (~x08 & x09 & ~new_n69_ & ~x10) | (x03 & ~new_n52_ & x08);
  assign new_n69_ = (x20 | ~x22) & (x01 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x20 & (new_n72_ | x01)) | (x04 & x08) | (new_n73_ & ~x08);
  ...
  assign z14 = (~x08 & x09 & ~new_n76_ & ~x10) | (x05 & ~new_n52_ & x08);
  assign new_n76_ = (x20 | ~x24) & (x01 | (~new_n78_ & ((new_n48_ & new_n77_) | ~x24)));
  ...
  assign new_n80_ = x20 & (x01 | (new_n81_ & new_n82_));
  ...
  assign z16 = new_n86_ | (~x08 & x09 & (new_n87_ | new_n92_) & ~x10);
