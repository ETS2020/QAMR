...
module FAU ( 
  ...
  assign z12 = (x19 & (new_n71_ | ~x03)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign new_n73_ = (~x19 | ~x22 | ((~x20 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x20 & x21)))) & (~x23 | (x19 & x22));
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (x19 | ~x24) & (~x03 | (((new_n60_ & new_n77_) | ~x24) & (~new_n78_ | ~new_n60_ | ~x19)));
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = (~new_n80_ & x19) | (x06 & x08) | (~x08 & new_n82_ & x09);
  assign new_n80_ = x03 & (~new_n81_ | x08 | ~x09 | x10 | ~x20);
  ...
  assign new_n85_ = x03 & (~new_n86_ | x08 | ~x09 | ~new_n60_ | x10);
