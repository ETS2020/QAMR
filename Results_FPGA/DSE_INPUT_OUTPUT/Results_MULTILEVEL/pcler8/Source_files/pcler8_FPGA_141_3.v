...
module FAU ( 
  ...
  assign new_n63_ = x09 & ((x19 & (x20 ? (new_n64_ | ~x21) : x21)) | (~x10 & ~x19 & x21));
  ...
  assign z13 = (x19 & (new_n71_ | x10)) | (x04 & x08) | (new_n69_ & ~x08);
  assign new_n69_ = x09 & ~x10 & x23 & (~new_n70_ | ~x19 | ~x20);
  assign new_n70_ = x21 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n71_ = ~x08 & x09 & x20 & x21 & x22 & ~x23;
