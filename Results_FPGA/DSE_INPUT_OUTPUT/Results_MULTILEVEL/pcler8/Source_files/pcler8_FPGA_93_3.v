...
module FAU ( 
  ...
  assign new_n73_ = (x20 | ~x24) & (x03 | (~new_n76_ & ((new_n74_ & new_n75_) | ~x24)));
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (~new_n78_ & x20) | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n78_ = ~x03 & (~new_n79_ | x10 | ~x19 | x08 | ~x09);
  ...
  assign new_n83_ = ~x03 & ((new_n86_ & new_n87_) | ((~new_n84_ | ~new_n85_) & x26));
