// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:48 2020
...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((~x17 & ((~x20 & x21) | (x19 & x20 & (new_n66_ | ~x21)))) | (~x19 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (x17 | ((~x22 | (x20 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x08 & new_n71_ & x09) | (x04 & x08 & (~x17 | ~x19));
  assign new_n71_ = ~x10 & ((~x19 & x23) | (~x17 & ((~x22 & x23) | (x19 & ~new_n72_ & x22))));
  assign new_n72_ = (~x20 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x20 & x21));
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (~new_n75_ & x19) | (x05 & x08) | (~x08 & new_n77_ & x09);
  assign new_n75_ = ~x17 & (~new_n76_ | ~new_n60_ | ~x23 | x24);
  assign new_n76_ = ~x10 & x20 & ~x08 & x09;
  assign new_n77_ = ~x10 & x24 & (~new_n78_ | ~new_n48_ | ~x19);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (new_n80_ & ~x08);
  assign new_n80_ = x09 & ~x10 & ((~x19 & x25) | (~new_n81_ & ~x17));
  assign new_n81_ = (~x25 | (new_n48_ & x22 & x23 & x24)) & (~new_n48_ | ~x19 | ~x22 | ~x23 | ~x24 | x25);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n83_ | new_n87_));
  assign new_n83_ = ~x17 & (new_n84_ | (x26 & (~new_n86_ | ~new_n48_ | x18)));
  assign new_n84_ = new_n85_ & new_n60_ & x19 & x20;
  assign new_n85_ = x23 & x24 & x25 & ~x26;
  assign new_n86_ = x22 & x23 & x24 & x25;
  assign new_n87_ = ~x19 & x26;
endmodule
