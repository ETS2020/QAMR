...
module FAU ( 
  ...
  assign z12 = (x20 & (new_n69_ | ~x03)) | (x03 & x08) | (new_n67_ & ~x08);
  ...
  assign new_n74_ = (x20 | ~x24) & (~x03 | (~new_n77_ & ((new_n75_ & new_n76_) | ~x24)));
  assign new_n75_ = x19 & x21;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (~new_n79_ & x20) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n79_ = x03 & (~new_n80_ | x10 | ~x19 | x08 | ~x09);
  ...
  assign new_n84_ = x03 & ((new_n87_ & new_n88_) | ((~new_n85_ | ~new_n86_) & x26));
