...
module FAU ( 
  ...
  assign new_n60_ = ~x08 & x09 & ~x10 & x11 & x17 & x20;
  ...
  assign z11 = (~x08 & x09 & ~new_n67_ & ~x10) | new_n50_ | (x02 & x08);
  ...
  assign new_n76_ = x20 & (~x17 | (new_n77_ & new_n78_));
  ...
  assign z15 = (~x08 & x09 & ~new_n83_ & ~x10) | (x06 & ~new_n50_ & x08);
  assign new_n83_ = (x20 | ~x25) & (~x17 | ((~new_n80_ | ~new_n85_) & (new_n84_ | ~x25)));
  assign new_n84_ = x19 & x21 & x22 & x23 & x24 & ~x26;
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n87_ | new_n92_));
  assign new_n87_ = x17 & ((new_n90_ & new_n91_) | ((~new_n88_ | ~new_n89_) & x26));
