...
module FAU ( 
  ...
  assign z00 = x19 & (~x12 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign new_n63_ = x19 ? (x20 & (~new_n49_ | ~new_n48_ | ~x21)) : ~x20;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x12 & ((x19 & x20 & (new_n66_ | ~x21)) | (~x20 & x21))) | (~x19 & x21));
  ...
  assign z13 = (x19 & (new_n71_ | ~x12)) | (x04 & x08) | (new_n73_ & ~x08);
  ...
  assign new_n76_ = (x19 | ~x24) & (~x12 | (((new_n72_ & new_n77_) | ~x24) & (~new_n78_ | ~new_n72_ | ~x19)));
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = (~new_n80_ & x19) | (x06 & x08) | (~x08 & new_n82_ & x09);
  assign new_n80_ = x12 & (~new_n81_ | x10 | ~x20 | x08 | ~x09);
  assign new_n81_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x10 & x25 & (~new_n83_ | ~new_n72_ | ~x19);
  assign new_n83_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n85_ & x19) | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n85_ = x12 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
