...
module FAU ( 
  ...
  assign z05 = x04 & x08 & (~x03 | (x03 & x20));
  ...
  assign z12 = (x03 & (x08 | ~x20)) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (x19 & x20 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22);
  ...
  assign new_n81_ = new_n48_ & ~x10 & ~x20 & x25;
  ...
  assign new_n87_ = ~x20 & (x03 | (new_n48_ & ~x10 & x26));
