...
module FAU ( 
  ...
  assign new_n61_ = x20 ? (x19 & (~new_n63_ | ~x12 | ~new_n62_ | ~x24)) : ~x19;
  ...
  assign new_n68_ = x20 & (~x23 | (new_n69_ & x19 & x21 & ~x22 & x23));
  assign new_n69_ = ~x08 & x09 & ~x10;
  assign new_n70_ = x22 & ((~new_n71_ & x23) | ~x23 | (new_n62_ & x14 & x24));
  assign new_n71_ = x19 & x20 & x21;
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & x09 & new_n73_ & ~x10);
  assign new_n73_ = x23 & ((~new_n71_ & x22) | ~x22 | (new_n62_ & x15 & x24));
  assign z14 = (~new_n75_ & x20) | (x05 & x08) | (new_n76_ & ~x08);
  assign new_n75_ = x23 & (~new_n69_ | ~x19 | ~x21 | ~x22 | x24);
  ...
  assign new_n79_ = x20 & (~x23 | (new_n80_ & new_n63_ & x24 & ~x25));
  assign new_n80_ = ~x08 & x09 & ~x10 & x19;
  assign new_n81_ = x25 & (~new_n71_ | ~x22 | ~x24 | (x17 & x26));
  assign z16 = (~new_n83_ & x20) | (x07 & x08) | (~x08 & new_n84_ & x09);
  assign new_n83_ = x23 & (~new_n80_ | ~new_n63_ | ~x24 | ~x25 | x26);
