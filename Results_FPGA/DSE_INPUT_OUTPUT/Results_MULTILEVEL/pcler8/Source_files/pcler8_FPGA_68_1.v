...
module FAU ( 
  ...
  assign new_n61_ = ~x08 & x09 & ~x10 & x11 & x17 & x20;
  assign z10 = z02 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x17 & x20 & (~x19 | (new_n64_ & new_n65_))) | (x19 & ~x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x19 | ~x20 | (x21 & (~new_n49_ | ~new_n48_ | ~x13))) & ((x19 & x20) | ~x21);
  assign z12 = (x20 & (new_n71_ | ~x17)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign new_n73_ = (~x17 | (~new_n76_ & ((new_n74_ & new_n75_) | ~x23))) & (x20 | ~x23);
  ...
  assign new_n78_ = (~x17 | (~new_n80_ & ((new_n74_ & new_n79_) | ~x24))) & (x20 | ~x24);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x20 | ~x25) & (~x17 | ((~new_n83_ | ~new_n85_) & (new_n84_ | ~x25)));
  assign new_n83_ = x19 & x20 & x21;
  assign new_n84_ = x19 & x21 & x22 & x23 & x24 & ~x26;
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign z16 = (~new_n87_ & x20) | (x07 & x08) | (~x08 & new_n88_ & x09);
  assign new_n87_ = x17 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
