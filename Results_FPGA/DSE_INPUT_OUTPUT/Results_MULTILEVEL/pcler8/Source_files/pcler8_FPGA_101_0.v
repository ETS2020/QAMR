...
module FAU ( 
  ...
  assign z00 = (~x20 & ~x25) | (new_n47_ & new_n50_ & ~x10 & x19 & x20);
  ...
  assign new_n68_ = ~x20 & (~x25 | (new_n50_ & ~x10 & x22));
  ...
  assign new_n76_ = ~x20 & (~x25 | (new_n50_ & ~x10 & x24));
  ...
  assign z15 = (x06 & ~new_n52_ & x08) | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((x25 & (~new_n80_ | ~new_n48_ | new_n83_ | ~x24)) | (new_n80_ & new_n48_ & x24 & ~x25));
  assign new_n83_ = x17 & x26;
  assign z16 = new_n85_ | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n85_ = ~x20 & (~x25 | (new_n50_ & ~x10 & x26));
