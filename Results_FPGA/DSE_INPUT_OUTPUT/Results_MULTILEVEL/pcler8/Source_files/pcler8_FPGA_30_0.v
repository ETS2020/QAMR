...
module FAU ( 
  ...
  assign z09 = new_n59_ | (x00 & x08 & (x10 | x19));
  assign new_n59_ = new_n60_ & new_n48_ & x21 & x22 & x23;
  assign new_n60_ = ~x08 & x09 & ~x10 & x11 & x19 & x20;
  assign z10 = (x01 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n62_ & x19);
  ...
  assign new_n65_ = x20 ? (x21 & (~new_n48_ | ~x13 | ~x22 | ~x23)) : ~x21;
  assign z12 = (x03 & x08) | (~x10 & (~x19 | (~x08 & ~new_n67_ & x09)));
  assign new_n67_ = (~x22 | (x20 & x21 & (~new_n48_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08) | (~x10 & (~x19 | (new_n69_ & ~x08)));
  assign new_n69_ = x09 & (x22 ? ((x20 & x21 & (new_n70_ | ~x23)) | (x23 & (~x20 | ~x21))) : x23);
