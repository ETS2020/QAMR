...
module FAU ( 
  ...
  assign new_n64_ = x20 ? (~x24 | (x19 & (~new_n49_ | ~new_n48_ | ~x12))) : ~x19;
  ...
  assign new_n69_ = x21 & (~x14 | ~x23 | ~x25 | ~x26);
  assign new_n70_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign z13 = (new_n72_ & ~x08) | new_n51_ | (x04 & x08);
  assign new_n72_ = x09 & ~x10 & ((x20 & ~new_n73_ & x22) | (x23 & (~x20 | ~x22)));
  assign new_n73_ = (~x19 | ~x21 | (x23 & (~x15 | ~x25 | ~x26))) & (~x23 | (x19 & x21));
  ...
  assign new_n78_ = x20 & (~x24 | (new_n47_ & new_n48_ & x23 & ~x25));
  assign new_n79_ = x25 & (~new_n76_ | ~x22 | ~x23 | (x17 & x26));
