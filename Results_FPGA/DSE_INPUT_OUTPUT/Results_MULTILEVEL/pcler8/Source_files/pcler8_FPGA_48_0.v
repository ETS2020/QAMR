...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & x19 & (x20 ? (new_n66_ | ~x21) : (x21 & x26));
  ...
  assign new_n71_ = ~x20 & (~x26 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z14 = (x05 & ~new_n49_ & x08) | (new_n76_ & ~x08);
  assign new_n76_ = x09 & ~x10 & (new_n79_ | (x24 & (new_n77_ | new_n78_)));
  assign new_n77_ = x26 & (~x20 | (x16 & x25));
  assign new_n78_ = x20 & (~x22 | ~x23 | ~x19 | ~x21);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = new_n86_ | (~x08 & x09 & ~new_n81_ & ~x10) | (x06 & x08);
  assign new_n81_ = (~x25 | (new_n84_ & new_n85_)) & (~new_n83_ | ~new_n82_ | ~x24 | x25);
  assign new_n82_ = x22 & x23;
  assign new_n83_ = x19 & x20 & x21;
  assign new_n84_ = x19 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = ~x20 & (~x26 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n92_ | (x07 & x08) | (~x08 & new_n88_ & x09);
  assign new_n88_ = ~x10 & ((new_n84_ & new_n91_) | (x26 & (~new_n89_ | ~new_n90_)));
  assign new_n89_ = ~x18 & x19 & x21;
  assign new_n90_ = x22 & x23 & x24 & x25;
  assign new_n91_ = x23 & x24 & x25 & ~x26;
  assign new_n92_ = ~x20 & (~x26 | (~x08 & x09 & ~x10));
endmodule
