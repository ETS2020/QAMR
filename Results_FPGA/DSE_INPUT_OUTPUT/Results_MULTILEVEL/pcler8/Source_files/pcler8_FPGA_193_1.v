...
module FAU ( 
  ...
  assign new_n59_ = ~x10 & (~x19 | (new_n61_ & new_n60_ & x20));
  ...
  assign new_n65_ = ~x10 & ((x11 & (x19 ? (x20 & (new_n66_ | ~x21)) : x21)) | (~x20 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & ~new_n50_ & x08);
  assign new_n68_ = (x20 | ~x22) & (~x11 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x19 | ~x20 | ~x21 | ~x22 | (~new_n72_ & x23)) & (~x23 | (x19 & x20 & x21 & x22));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = new_n74_ | (x05 & x08) | (~x08 & x09 & new_n76_ & ~x10);
  assign new_n74_ = x20 & (~x11 | (new_n75_ & new_n60_ & x23 & ~x24));
  assign new_n75_ = ~x08 & x09 & ~x10 & x19;
  assign new_n76_ = x24 & (~new_n77_ | ~x19 | ~x20 | ~x21);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~new_n79_ & x20) | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n79_ = x11 & (~new_n75_ | ~new_n60_ | ~x23 | ~x24 | x25);
  assign new_n80_ = ~x10 & x25 & (~new_n81_ | ~x19 | ~x20 | ~x21);
  assign new_n81_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n83_ & x20) | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n83_ = x11 & (~new_n85_ | ~new_n84_ | ~x24 | ~x25 | x26);
  assign new_n84_ = x22 & x23;
  assign new_n85_ = ~x08 & x09 & ~x10 & x19 & x21;
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | ~new_n84_ | ~x24 | ~x25);
