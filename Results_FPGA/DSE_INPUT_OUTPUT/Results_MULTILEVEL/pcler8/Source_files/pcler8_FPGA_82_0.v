...
module FAU ( 
  ...
  assign z14 = (x05 & ~new_n49_ & x08) | (new_n73_ & ~x08);
  assign new_n73_ = x09 & ~x10 & (new_n76_ | (x24 & (new_n74_ | new_n75_)));
  assign new_n74_ = x25 & (~x20 | (x16 & x26));
  assign new_n75_ = x20 & (~x19 | ~x21 | ~x22 | ~x23);
  ...
  assign new_n88_ = ~x20 & (~x25 | (~x08 & x09 & ~x10 & x26));
endmodule
