...
module FAU ( 
  ...
  assign z12 = new_n68_ | (~x08 & x09 & ~new_n67_ & ~x10) | (x03 & x08);
  assign new_n67_ = (~x22 | (x19 & x21 & (~new_n50_ | ~x14 | ~x23))) & (~x19 | ~x21 | x22);
  assign new_n68_ = ~x20 & (~x22 | (~x08 & x09 & ~x10));
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x22 | ((~x19 | ~x20 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x20 & x21)))) & (~x20 | x22 | ~x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = ~new_n74_ & (~x20 | ~x24 | (new_n75_ & x19 & x21));
  assign new_n74_ = x22 & ((~x20 & x24) | (x19 & x20 & x21 & x23 & ~x24));
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~x08 & x09 & ~new_n77_ & ~x10) | (x06 & ~new_n47_ & x08);
  assign new_n77_ = (new_n78_ | ~x22) & (~x20 | (new_n79_ & new_n80_) | ~x25);
  assign new_n78_ = (x20 | ~x25) & (~x19 | ~x20 | ~x21 | ~x23 | ~x24 | x25);
  assign new_n79_ = x19 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n82_ | (~x08 & x09 & ~x10 & (new_n83_ | new_n85_));
  assign new_n82_ = x07 & ~new_n47_ & x08;
