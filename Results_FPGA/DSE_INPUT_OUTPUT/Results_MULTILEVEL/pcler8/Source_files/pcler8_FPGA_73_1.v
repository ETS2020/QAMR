...
module FAU ( 
  ...
  assign z14 = (x08 & (x05 | x20)) | ((new_n76_ | ~x05) & x20) | (~x08 & new_n78_ & x09);
  assign new_n76_ = new_n77_ & x09 & ~x10 & x19;
  ...
  assign new_n82_ = x06 & ~new_n51_ & x08;
  assign new_n83_ = x05 & ((new_n79_ & new_n86_) | ((~new_n84_ | ~new_n85_) & x25));
  ...
  assign new_n89_ = x05 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
