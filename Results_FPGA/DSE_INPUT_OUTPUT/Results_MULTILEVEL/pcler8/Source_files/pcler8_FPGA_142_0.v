...
module FAU ( 
  ...
  assign z10 = (~new_n61_ & (x21 | x23)) | (new_n62_ & new_n63_ & x21 & x22 & x23);
  assign new_n61_ = x08 ? ~x01 : (~x09 | x10 | (~x19 ^ x20));
  assign new_n62_ = ~x08 & x09 & ~x10 & x12 & x19;
  assign new_n63_ = x24 & x25 & x26;
  assign z11 = (~x08 & new_n65_ & x09) | new_n49_ | (x02 & x08);
  assign new_n65_ = ~x10 & (x19 ? (x20 ? (new_n66_ | ~x21) : x21) : (x21 | ~x23));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = new_n70_ | (x03 & x08) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x22 & (~x19 | new_n69_ | ~x20)) | (x19 & x20 & x21 & ~x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign new_n70_ = ~x21 & (~x23 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n74_ | (x04 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x23 | (~new_n73_ & x22 & (~x22 | (x19 & x20)))) & (~x19 | ~x20 | ~x22 | x23);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign new_n74_ = ~x21 & (~x23 | (~x08 & x09 & ~x10));
  assign z14 = new_n79_ | (x05 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (new_n77_ & x19 & x20)) & (~new_n78_ | ~x19 | ~x20 | ~x21);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign new_n79_ = ~x21 & (~x23 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~x08 & x09 & ~new_n81_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n81_ = (new_n82_ | ~x23) & (~x21 | ~x25 | (new_n83_ & new_n84_ & x23));
  assign new_n82_ = (x21 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x24 | x25);
  assign new_n83_ = x19 & x20 & x22;
  ...
  assign new_n91_ = ~x21 & (~x23 | (~x08 & x09 & ~x10 & x26));
endmodule
