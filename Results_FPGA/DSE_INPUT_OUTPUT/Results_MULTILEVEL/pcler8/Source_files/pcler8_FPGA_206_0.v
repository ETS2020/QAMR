...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (x10 | x20)) | (~x08 & x09 & ~x10 & ~new_n62_ & x20);
  ...
  assign z13 = (x04 & x08) | (~x10 & (~x20 | (new_n68_ & ~x08)));
  assign new_n68_ = x09 & (x22 ? ((x19 & x21 & (new_n69_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
