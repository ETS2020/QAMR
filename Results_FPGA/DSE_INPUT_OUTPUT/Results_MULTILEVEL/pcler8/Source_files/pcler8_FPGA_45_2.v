...
module FAU ( 
  ...
  assign new_n63_ = (~x20 | (x19 & (~new_n64_ | ~x12 | ~x21 | ~x22))) & (x12 | ~x19 | x20);
  ...
  assign new_n70_ = ~x20 & (x12 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n72_ | (~x08 & x09 & ~x10 & (new_n73_ | new_n75_));
  assign new_n72_ = x04 & ~new_n49_ & x08;
