...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (~x10 | ~x19)) | (~x08 & x09 & ~x10 & (new_n57_ | ~x19));
  ...
  assign z11 = (new_n62_ & ~x08) | (x02 & x08) | (x10 & x19);
  assign new_n62_ = x09 & ((~x10 & x21 & (~x19 | (x19 & ~x20))) | (x19 & x20 & (new_n63_ | ~x21)));
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x22 | (x19 & x20 & ~new_n66_ & x21)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n66_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x19 & (new_n70_ | x10)) | (x04 & x08) | (new_n68_ & ~x08);
  assign new_n68_ = x09 & ~x10 & x23 & (~new_n69_ | ~x19 | ~x20);
  assign new_n69_ = x21 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n70_ = ~x08 & x09 & x20 & x21 & x22 & ~x23;
  assign z14 = new_n72_ | (x05 & x08) | (~x08 & x09 & new_n74_ & ~x10);
  assign new_n72_ = x19 & (x10 | (new_n73_ & ~x08 & x09 & x20));
  ...
  assign new_n78_ = (~x25 | (new_n75_ & new_n79_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n79_ | ~x24 | x25);
  assign new_n79_ = x22 & x23;
  assign z16 = (x07 & x08 & (~x10 | ~x19)) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~new_n84_ | ~new_n85_) & (~x26 | (new_n82_ & new_n83_));
