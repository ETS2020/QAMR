...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n68_ & ~x10) | (x10 & ~x20) | (x04 & x08);
  assign new_n68_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n69_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = new_n75_ | (x05 & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x24 | (new_n73_ & x22 & ~new_n74_ & x23)) & (~new_n72_ | ~x22 | ~x23 | x24);
  ...
  assign new_n77_ = (~new_n72_ | ~new_n80_) & (~x25 | (new_n78_ & new_n79_));
