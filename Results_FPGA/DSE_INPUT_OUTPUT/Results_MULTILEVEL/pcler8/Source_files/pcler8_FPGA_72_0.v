...
module FAU ( 
  ...
  assign new_n58_ = x20 & (~x19 | (new_n60_ & new_n59_ & x11));
  ...
  assign z11 = (new_n49_ & x02) | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = (~x21 | (~x19 ^ x20)) & (~x19 | ~x20 | (~new_n65_ & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (new_n49_ & x03) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x19 & (x20 ? (x21 & ~x22) : x22)) | (x20 & x22 & (~x19 | new_n68_ | ~x21)));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n72_ | (x04 & x08) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x19 | ~x20 | ~x22 | (x21 ? (~new_n71_ & x23) : ~x23)) & (~x23 | (x20 & x22));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x23));
  assign z14 = (new_n49_ & x05) | (~x08 & x09 & ~new_n74_ & ~x10);
  ...
  assign new_n78_ = (~x20 | ((x19 | ~x25) & (~new_n79_ | ~new_n59_ | ~x19))) & (~x19 | ~x25 | (new_n80_ & new_n59_ & x20));
  ...
  assign new_n87_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x26));
endmodule
