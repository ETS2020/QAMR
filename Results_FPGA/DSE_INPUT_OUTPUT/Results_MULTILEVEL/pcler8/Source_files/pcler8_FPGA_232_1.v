...
module FAU ( 
  ...
  assign z00 = x20 & (~x18 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign new_n61_ = ~x08 & x09 & ~x10 & x11 & x18 & x20;
  ...
  assign new_n68_ = (x20 | ~x22) & (~x18 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n69_ = new_n49_ & x14 & x23;
  assign z13 = z05 | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((~x20 & x23) | (x18 & ((~x22 & x23) | (x20 & ~new_n72_ & x22))));
  assign new_n72_ = (~x19 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x19 & x21));
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n51_ & x08) | (new_n75_ & ~x08);
  assign new_n75_ = x09 & ~x10 & (new_n76_ | (~x20 & x24));
  assign new_n76_ = x18 & (new_n78_ | (x24 & (~new_n77_ | ~x19 | ~x21)));
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((~x20 & x25) | (x18 & (new_n83_ | (~new_n81_ & x25))));
  assign new_n81_ = new_n82_ & x19 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x19 & x20 & x21 & new_n48_ & x24 & ~x25;
  assign z16 = new_n85_ | (~new_n51_ & ~new_n87_);
  assign new_n85_ = new_n86_ & ~x08 & x09 & ~x10 & x18 & x19;
  assign new_n86_ = x20 & x21 & x22 & x23 & x24 & x25;
  assign new_n87_ = (~x07 | ~x08) & (x10 | ~x26 | x08 | ~x09);
endmodule
