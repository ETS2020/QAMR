...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n58_ & ~x10) | (x10 & ~x20) | (x00 & x08);
  assign new_n58_ = x19 & (~new_n59_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & ~new_n61_ & x09);
  assign new_n61_ = (x10 | ~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (~x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (new_n64_ & ~x08) | (x02 & x08) | (x10 & ~x20);
  assign new_n64_ = x09 & ((~x10 & x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (~x20 & x21));
  ...
  assign z13 = (~x08 & x09 & ~new_n70_ & ~x10) | (x10 & ~x20) | (x04 & x08);
