...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n61_, new_n63_,
    ...
    new_n91_;
  assign z00 = x20 & (~x03 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign z14 = (~x08 & x09 & ~new_n78_ & ~x10) | (x05 & ~new_n51_ & x08);
  assign new_n78_ = (~x03 | (~new_n80_ & ((new_n74_ & new_n79_) | ~x24))) & (x20 | ~x24);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n82_ | new_n87_));
  assign new_n82_ = x03 & ((new_n83_ & new_n86_) | ((~new_n84_ | ~new_n85_) & x25));
  ...
  assign z16 = (~new_n89_ & x20) | (x07 & x08) | (~x08 & new_n90_ & x09);
  assign new_n89_ = x03 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
  assign new_n90_ = ~x10 & x26 & (~new_n91_ | ~new_n48_ | ~x24 | ~x25);
