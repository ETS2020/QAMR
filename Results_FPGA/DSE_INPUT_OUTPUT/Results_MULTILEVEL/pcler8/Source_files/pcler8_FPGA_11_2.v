...
module FAU ( 
  ...
  assign z00 = (x07 & ~x20) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign z10 = (~x08 & x09 & ~new_n61_ & ~x10) | new_n50_ | (x01 & x08);
  ...
  assign new_n64_ = ~x10 & ((x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (~x07 & ~x20 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x20 | ((~x22 | (x19 & ~new_n68_ & x21)) & (~x19 | ~x21 | x22))) & (x07 | x20 | ~x22);
  ...
  assign z14 = (~x08 & x09 & ~new_n73_ & ~x10) | (x05 & ~new_n50_ & x08);
  assign new_n73_ = (~x20 | ((~x24 | (new_n74_ & new_n75_)) & (~new_n74_ | ~new_n76_))) & (x07 | x20 | ~x24);
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x22 & x23 & ~x24;
  assign z15 = new_n78_ | (x06 & x08) | (~x08 & new_n79_ & x09);
  assign new_n78_ = ~x20 & (x07 | (new_n47_ & ~x10 & x25));
