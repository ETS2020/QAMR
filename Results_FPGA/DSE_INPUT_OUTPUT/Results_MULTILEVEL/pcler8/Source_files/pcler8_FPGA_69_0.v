...
module FAU ( 
  ...
  assign z11 = z03 | (~x08 & x09 & ~x10 & (new_n64_ | new_n67_));
  ...
  assign new_n74_ = x13 & ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x20 | ((~new_n77_ | ~new_n79_) & (~x24 | (new_n77_ & new_n78_)))) & (~x13 | x20 | ~x24);
  assign new_n77_ = x19 & x21;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x20 | ((~new_n82_ | ~new_n84_) & (~x25 | (new_n82_ & new_n83_)))) & (~x13 | x20 | ~x25);
  ...
  assign new_n86_ = ~x20 & (~x13 | (new_n47_ & ~x10 & x26));
  ...
  assign new_n91_ = x25 & ~x26 & x23 & x24;
endmodule
