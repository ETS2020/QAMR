...
module FAU ( 
  ...
  assign new_n69_ = ~x20 & (x17 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n74_ = (~x20 | ((~new_n75_ | ~new_n77_) & ((new_n75_ & new_n76_) | ~x24))) & (x17 | x20 | ~x24);
  assign new_n75_ = x19 & x21;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x20 | ((~new_n80_ | ~new_n82_) & ((new_n80_ & new_n81_) | ~x25))) & (x17 | x20 | ~x25);
