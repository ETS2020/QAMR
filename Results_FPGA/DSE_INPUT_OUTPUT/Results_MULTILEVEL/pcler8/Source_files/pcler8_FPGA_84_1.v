...
module FAU ( 
  ...
  assign z11 = (~x08 & x09 & ~new_n62_ & ~x10) | (x02 & x08 & (x09 | ~x20));
  assign new_n62_ = x20 ? (x19 ? (~new_n63_ & x21) : ~x21) : ~x21;
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x20 & (new_n67_ | ~x09)) | (x03 & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & x22 & (~new_n66_ | ~x19 | ~x20);
  assign new_n66_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n67_ = ~x08 & ~x10 & x19 & x21 & ~x22;
  assign z13 = (~x08 & x09 & ~new_n69_ & ~x10) | (x04 & x08 & (x09 | ~x20));
  ...
  assign z15 = (x20 & (new_n76_ | ~x09)) | (x06 & x08) | (~x08 & new_n78_ & x09);
  assign new_n76_ = new_n77_ & ~x08 & ~x10 & x19 & x21;
  assign new_n77_ = x22 & x23 & x24 & ~x25;
  assign new_n78_ = ~x10 & x25 & (~new_n73_ | ~new_n79_);
  assign new_n79_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~x08 & new_n81_ & x09) | (x07 & x08 & (x09 | ~x20));
