...
module FAU ( 
  ...
  assign z14 = ~new_n73_ | (x16 & (new_n75_ | ~x20));
  assign new_n73_ = x08 ? ~x05 : (~x09 | new_n74_ | x10);
  assign new_n74_ = (~x24 | (x19 & x20 & x21 & x22 & x23)) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n75_ = x24 & x25 & x26 & ~x08 & x09 & ~x10;
  assign z15 = (~x08 & x09 & ~new_n77_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n77_ = (~x20 | ((~x25 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_))) & (x16 | x20 | ~x25);
  assign new_n78_ = x19 & x21 & x22;
  assign new_n79_ = x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n82_ | new_n86_));
  assign new_n82_ = x20 & ((new_n78_ & new_n85_) | (x26 & (~new_n83_ | ~new_n84_)));
  assign new_n83_ = ~x18 & x19 & x21;
  assign new_n84_ = x22 & x23 & x24 & x25;
  assign new_n85_ = x23 & x24 & x25 & ~x26;
  assign new_n86_ = ~x16 & ~x20 & x26;
endmodule
