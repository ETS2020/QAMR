...
module FAU ( 
  ...
  assign z00 = x20 & (x10 | (new_n47_ & new_n48_ & new_n49_ & x24));
  ...
  assign z09 = (~x08 & ~new_n59_ & x09) | (x10 & x20) | (x00 & x08);
  assign new_n59_ = (~new_n60_ | ~new_n61_) & (x10 | x19);
  ...
  assign new_n65_ = x09 & ((~x10 & x21 & (~x20 | (~x19 & x20))) | (x19 & x20 & (new_n66_ | ~x21)));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (~new_n70_ & x20) | (x03 & x08) | (new_n68_ & ~x08);
  assign new_n68_ = x09 & ~x10 & x22 & (~new_n69_ | ~x19 | ~x20);
  assign new_n69_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n70_ = ~x10 & (x08 | ~x09 | ~x19 | ~x21 | x22);
  assign z13 = z05 | (~x08 & x09 & (new_n74_ | (~new_n72_ & x22)));
  ...
  assign new_n76_ = x20 & (x10 | (new_n77_ & ~x08 & x09 & x19));
  assign new_n77_ = x21 & x22 & x23 & ~x24;
  assign new_n78_ = x24 & (~new_n79_ | ~x22 | ~x23 | (new_n49_ & x16));
  assign new_n79_ = x19 & x20 & x21;
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & x09 & new_n82_ & ~x10);
  assign new_n81_ = x20 & (x10 | (new_n47_ & new_n48_ & x24 & ~x25));
  assign new_n82_ = x25 & (~new_n79_ | ~new_n48_ | ~x24 | (x17 & x26));
