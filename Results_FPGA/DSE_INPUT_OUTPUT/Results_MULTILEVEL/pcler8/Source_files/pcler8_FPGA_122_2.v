...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x02 | (x02 & x25))) | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & (new_n63_ | (new_n65_ & new_n64_ & x12 & x19));
  assign new_n63_ = (~x02 | x25) & (x19 ^ x20);
  assign new_n64_ = x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (~x08 & x09 & ~new_n67_ & ~x10) | (x02 & x08 & x25);
  assign new_n67_ = ~new_n68_ & (~new_n65_ | ~x20 | ~x22 | ~x13 | ~x19);
  assign new_n68_ = (~x02 | x25) & (x19 ? (x20 ^ x21) : x21);
  ...
  assign new_n80_ = new_n81_ & ~x08 & x09 & new_n71_ & ~x10;
  ...
  assign new_n85_ = ~x10 & x26 & (~new_n86_ | ~new_n71_ | x18);
