...
module FAU ( 
  ...
  assign new_n57_ = new_n59_ & new_n60_ & ~x08 & x09 & new_n58_ & x11;
  ...
  assign z11 = (x02 & x08) | (~x10 & (~x19 | (~x08 & ~new_n65_ & x09)));
  ...
  assign z13 = (x04 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n69_ & x19);
  assign new_n69_ = x22 ? ((~x20 | ~x21 | (~new_n70_ & x23)) & (~x23 | (x20 & x21))) : ~x23;
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~x10 & (~x19 | (~x08 & ~new_n72_ & x09)));
