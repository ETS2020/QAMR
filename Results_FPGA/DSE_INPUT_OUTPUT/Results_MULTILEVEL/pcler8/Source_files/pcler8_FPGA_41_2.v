// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:25 2020
...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~new_n57_ & ~x10) | (x10 & ~x20) | (x00 & x08);
  assign new_n57_ = x19 & (~new_n58_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & ~new_n60_ & x09);
  assign new_n60_ = (x10 | ~x20 | (x19 & (~new_n58_ | ~new_n61_))) & (~x19 | x20);
  assign new_n61_ = x12 & x21 & x22;
  assign z11 = (~x08 & x09 & ~new_n63_ & ~x10) | (x02 & x08 & (~x10 | x20));
  assign new_n63_ = x20 ? (x19 ? (x21 & (~new_n65_ | ~new_n64_ | ~x13)) : ~x21) : ~x21;
  assign new_n64_ = x22 & x23;
  assign new_n65_ = x24 & x25 & x26;
  assign z12 = new_n69_ | (x03 & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x22 & (~x19 | new_n68_ | ~x21)) | (x21 & ~x22 & x19 & x20));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x20 & (x10 | (~x08 & x09 & x22));
  assign z13 = ~new_n74_ | (~x08 & x09 & (new_n73_ | (~new_n71_ & ~x10)));
  assign new_n71_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n72_ & x23)) & (~x23 | (x19 & x21))) : ~x23;
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = new_n64_ & ~x20;
  assign new_n74_ = (~x04 | ~x08) & (~x10 | x20);
  ...
  assign z15 = (~x08 & x09 & ~new_n80_ & ~x10) | (x06 & x08 & (~x10 | x20));
  assign new_n80_ = (~x25 | (new_n77_ & new_n64_ & x24 & (~x17 | ~x26))) & (~new_n77_ | ~new_n64_ | ~x24 | x25);
  assign z16 = z08 | (~x08 & new_n82_ & x09);
