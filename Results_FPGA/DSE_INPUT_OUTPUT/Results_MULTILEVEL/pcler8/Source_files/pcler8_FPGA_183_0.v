...
module FAU ( 
  ...
  assign new_n68_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n72_ | (x04 & x08) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x23 | ((~x22 | (x19 & x21)) & ~new_n71_ & x22)) & (~x19 | ~x21 | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x20 & (~x23 | (~x08 & x09 & ~x10));
  assign z14 = (~x08 & x09 & ~new_n74_ & ~x10) | (x05 & ~new_n49_ & x08);
  assign new_n74_ = ~new_n75_ & (~x20 | ~x24 | (new_n76_ & x19 & x21));
  assign new_n75_ = x23 & ((~x20 & x24) | (x19 & x20 & x21 & x22 & ~x24));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (new_n79_ | ~x23) & (~x20 | ~x25 | (new_n80_ & new_n81_ & x23));
  assign new_n79_ = (x20 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x24 | x25);
  assign new_n80_ = x19 & x21 & x22;
  assign new_n81_ = x24 & (~x17 | ~x26);
  ...
  assign new_n88_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x26));
endmodule
