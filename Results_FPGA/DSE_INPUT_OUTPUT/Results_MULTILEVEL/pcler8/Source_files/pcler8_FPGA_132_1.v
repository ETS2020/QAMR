...
module FAU ( 
  ...
  assign z14 = (~new_n76_ & x23) | (x05 & x08) | (new_n78_ & ~x08);
  assign new_n76_ = x20 & (~new_n77_ | x08 | ~x09 | x10);
  assign new_n77_ = x19 & x21 & x22 & ~x24;
  assign new_n78_ = x09 & ~x10 & x24 & (~new_n79_ | ~x19 | ~x21);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~x08 & x09 & ~new_n81_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n81_ = (~x20 | ((new_n82_ | ~x25) & (~new_n83_ | ~x23 | ~x24 | x25))) & (x23 | ~x25);
  assign new_n82_ = x19 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n83_ = x19 & x21 & x22;
  assign z16 = (~x08 & x09 & ~new_n85_ & ~x10) | (x07 & ~new_n49_ & x08);
  assign new_n85_ = (x23 | ~x26) & (~x20 | ((new_n86_ | ~x26) & (~new_n83_ | ~new_n87_)));
