...
module FAU ( 
  ...
  assign new_n69_ = ~x20 & (x24 | (new_n48_ & ~x10 & x22));
  ...
  assign new_n76_ = ~x20 & x23 & ~x24;
  assign z14 = new_n78_ | (~x08 & x09 & ~x10 & ~new_n79_ & x20);
  assign new_n78_ = x05 & ~new_n50_ & x08;
  assign new_n79_ = (~x24 | (x19 & x21 & x22 & ~new_n80_ & x23)) & (~x19 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n80_ = x16 & x25 & x26;
  assign z15 = new_n82_ | (x06 & x08) | (~x08 & x09 & new_n84_ & ~x10);
  assign new_n82_ = x24 & (~x20 | (new_n83_ & new_n48_ & ~x10 & x19));
  assign new_n83_ = x21 & x22 & x23 & ~x25;
  assign new_n84_ = x25 & (~new_n85_ | ~x23 | ~x24 | (x17 & x26));
  assign new_n85_ = x19 & x21 & x22;
  assign z16 = (x07 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n87_ & ~x10);
  assign new_n87_ = (x24 | ~x26) & (~x20 | ((new_n88_ | ~x26) & (~new_n85_ | ~new_n89_)));
  assign new_n88_ = x22 & x23 & x25 & ~x18 & x19 & x21;
