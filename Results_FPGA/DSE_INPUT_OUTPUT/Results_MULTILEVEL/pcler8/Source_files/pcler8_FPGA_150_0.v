...
module FAU ( 
  ...
  assign new_n61_ = (~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (~x05 | ~x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (x05 & ~x20 & x21));
  ...
  assign new_n69_ = ~x20 & (~x05 | (~x10 & x22 & ~x08 & x09));
  ...
  assign z14 = (x08 & (x05 | ~x20)) | (~x08 & new_n74_ & x09) | (~x20 & (~x05 | (new_n77_ & x09)));
  ...
  assign z15 = (x05 & (new_n83_ | (x06 & x08))) | (x20 & (x08 ? x06 : new_n79_));
  assign new_n79_ = x09 & ~x10 & ((x25 & (~new_n80_ | ~new_n81_)) | (new_n80_ & new_n82_));
  assign new_n80_ = x19 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x23 & x24 & ~x25;
  assign new_n83_ = ~x08 & x09 & ~x10 & ~x20 & x25;
  ...
  assign new_n90_ = ~x20 & (~x05 | (~x10 & x26 & ~x08 & x09));
endmodule
