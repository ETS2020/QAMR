...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & x19 & (x20 ? (new_n66_ | ~x21) : (x21 & x23));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n67_ = ~x10 & ~x19 & x21;
  assign z12 = (~x08 & new_n69_ & x09) | (~new_n49_ & (x08 ? x03 : (new_n71_ & x09)));
  ...
  assign new_n73_ = (~x23 | ((~x22 | (x19 & x21)) & ~new_n74_ & x22)) & (~x19 | ~x21 | ~x22 | x23);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign new_n75_ = ~x20 & (~x23 | (~x08 & x09 & ~x10));
  ...
  assign new_n80_ = ~x20 & (~x23 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (~x08 & x09 & ~new_n82_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n82_ = (new_n83_ | ~x23) & (~x20 | ~x25 | (new_n84_ & new_n85_ & x23));
  assign new_n83_ = (x20 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x24 | x25);
  assign new_n84_ = x19 & x21 & x22;
  assign new_n85_ = x24 & (~x17 | ~x26);
  assign z16 = new_n87_ | (~x08 & x09 & ~x10 & (new_n88_ | new_n90_));
  assign new_n87_ = x07 & ~new_n49_ & x08;
  assign new_n88_ = x23 & ((~x20 & x26) | (new_n89_ & x19 & x20 & x21));
  assign new_n89_ = x22 & x24 & x25 & ~x26;
  assign new_n90_ = x20 & x26 & (~new_n91_ | x18 | ~x19 | ~x21);
