...
module FAU ( 
  ...
  assign new_n60_ = new_n61_ & x11 & x20 & x21 & x22;
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((~x07 & x20 & ((new_n61_ & new_n64_) | ~x19)) | (x19 & ~x20));
  ...
  assign new_n69_ = (x07 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x20 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & new_n72_ & x09);
  assign new_n72_ = ~x10 & ((~x20 & x23) | (~x07 & ((x20 & ~new_n73_ & x22) | (~x22 & x23))));
  assign new_n73_ = (~x19 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x19 & x21));
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = (new_n76_ & ~x08) | (x05 & ~new_n50_ & x08);
  assign new_n76_ = x09 & ~x10 & (new_n77_ | (~x20 & x24));
  assign new_n77_ = ~x07 & (new_n79_ | (x24 & (~new_n78_ | ~x19 | ~x21)));
