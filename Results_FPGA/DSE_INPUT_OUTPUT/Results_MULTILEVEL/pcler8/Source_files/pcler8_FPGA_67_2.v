...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x20 & (x19 ? (new_n64_ | ~x21) : x21)) | (~x14 & ~x20 & x21));
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n66_ & ~x10) | (x03 & ~new_n49_ & x08);
  assign new_n66_ = (~x20 | ((~x19 | ~x21 | (~new_n67_ & x22)) & (~x22 | (x19 & x21)))) & (x14 | x20 | ~x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x14 | x20 | ~x23) & (~x20 | ((~x23 | (x19 & x21)) & (~x19 | new_n70_ | ~x21)));
  assign new_n70_ = x22 ? (x23 & (~x25 | ~x26 | ~x15 | ~x24)) : ~x23;
  assign z14 = (~x08 & x09 & ~new_n72_ & ~x10) | (x05 & ~new_n49_ & x08);
  assign new_n72_ = (~x20 | ((~x24 | (new_n73_ & new_n74_)) & (~new_n73_ | ~new_n75_))) & (x14 | x20 | ~x24);
  assign new_n73_ = x19 & x21;
  assign new_n74_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x22 & x23 & ~x24;
  assign z15 = (~new_n49_ & (x08 ? x06 : (new_n77_ & x09))) | (~x08 & new_n79_ & x09);
  assign new_n77_ = ~x10 & x25 & (~new_n78_ | ~x19 | ~x21 | ~x22);
  assign new_n78_ = x23 & x24 & (~x17 | ~x26);
  assign new_n79_ = ~x10 & (new_n80_ | (new_n81_ & x19 & x20 & x21));
  assign new_n80_ = ~x14 & ~x20 & x25;
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign z16 = (~new_n49_ & (x08 ? x07 : (new_n83_ & x09))) | (~x08 & new_n85_ & x09);
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | ~new_n73_ | x18);
  assign new_n84_ = x22 & x23 & x24 & x25;
  assign new_n85_ = ~x10 & ((new_n86_ & new_n87_) | (~x14 & ~x20 & x26));
