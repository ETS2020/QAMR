// Benchmark "FAU" written by ABC on Tue Aug 18 17:07:15 2020
...
module FAU ( 
  ...
  assign z11 = z03 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x19 | ~x20 | (x21 & (~new_n65_ | ~new_n64_ | ~x13))) & (~x21 | (x19 & x20));
  assign new_n64_ = x22 & x23;
  assign new_n65_ = x24 & x25 & x26;
  assign z12 = (~new_n69_ & x20) | (x03 & x08) | (new_n67_ & ~x08);
  assign new_n67_ = x09 & ~x10 & x22 & (~new_n68_ | ~x19 | ~x20);
  assign new_n68_ = x21 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n69_ = ~x10 & (x08 | ~x09 | ~x19 | ~x21 | x22);
  assign z13 = z05 | (~x08 & x09 & (new_n73_ | (~new_n71_ & x22)));
  assign new_n71_ = (~x19 | ~x20 | ~x21 | (~new_n72_ & x23)) & (x10 | ~x23 | (x19 & x20 & x21));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = ~x10 & ~x22 & x23;
  assign z14 = new_n75_ | (x05 & x08) | (~x08 & x09 & new_n77_ & ~x10);
  assign new_n75_ = x20 & (x10 | (new_n76_ & ~x08 & x09 & x19));
  ...
  assign z15 = (~x08 & x09 & ~new_n81_ & ~x10) | (x06 & x08 & (~x10 | ~x20));
  assign new_n81_ = (~x25 | (new_n78_ & new_n64_ & x24 & (~x17 | ~x26))) & (~new_n78_ | ~new_n64_ | ~x24 | x25);
