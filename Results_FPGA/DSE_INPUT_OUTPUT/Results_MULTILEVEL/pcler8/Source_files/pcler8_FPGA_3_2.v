...
module FAU ( 
  ...
  assign new_n63_ = (~x20 | (x19 & (~new_n61_ | ~new_n64_))) & (x16 | ~x19 | x20);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = (~x08 & x09 & ~new_n66_ & ~x10) | new_n47_ | (x02 & x08);
