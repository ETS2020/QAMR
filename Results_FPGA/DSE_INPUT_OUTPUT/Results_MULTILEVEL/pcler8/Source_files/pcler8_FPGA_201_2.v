...
module FAU ( 
  ...
  assign z10 = (x01 & ~new_n49_ & x08) | (new_n61_ & ~x08);
  assign new_n61_ = x09 & ~x10 & (x20 ? (x24 & (new_n62_ | ~x19)) : x19);
  ...
  assign new_n70_ = x24 & (~new_n71_ | x08 | ~x09 | x10);
  ...
  assign new_n78_ = x20 & (~x24 | (new_n79_ & new_n80_));
  assign new_n79_ = ~x08 & x09 & ~x10 & x19;
  assign new_n80_ = x21 & x22 & x23 & ~x25;
  assign new_n81_ = x25 & (~new_n76_ | ~x22 | ~x23 | (x17 & x26));
  assign z16 = z08 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x24 | ((new_n84_ | ~x26) & (~new_n76_ | ~new_n85_))) & (x20 | ~x26);
