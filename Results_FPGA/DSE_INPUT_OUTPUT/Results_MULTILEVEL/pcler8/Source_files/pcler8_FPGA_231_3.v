...
module FAU ( 
  ...
  assign z13 = (x04 & x08) | (new_n71_ & ~x08) | (x20 & (new_n73_ | x10));
  assign new_n71_ = x09 & ~x10 & x23 & (~new_n72_ | ~x19 | ~x20);
  assign new_n72_ = x21 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n73_ = x21 & x22 & ~x23 & ~x08 & x09 & x19;
  assign z14 = (~x08 & x09 & ~new_n75_ & ~x10) | (x05 & x08 & (~x10 | ~x20));
  ...
  assign new_n79_ = (~x25 | (new_n76_ & new_n64_ & x24 & (~x17 | ~x26))) & (~new_n76_ | ~new_n64_ | ~x24 | x25);
  ...
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | ~new_n64_ | ~x24 | ~x25);
