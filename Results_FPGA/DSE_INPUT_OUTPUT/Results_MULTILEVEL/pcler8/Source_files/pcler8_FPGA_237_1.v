...
module FAU ( 
  ...
  assign z00 = x20 & (~x04 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign z10 = (~x08 & x09 & ~new_n64_ & ~x10) | new_n51_ | (x01 & x08);
  assign new_n64_ = x20 ? (x19 & (~new_n62_ | ~new_n61_ | ~x12)) : ~x19;
  assign z11 = z03 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = x20 ? (x19 ? (x21 & (~new_n49_ | ~new_n48_ | ~x13)) : ~x21) : ~x21;
  assign z12 = (x20 & (new_n70_ | ~x04)) | (x03 & x08) | (new_n68_ & ~x08);
  ...
  assign z13 = (~x08 & x09 & ~new_n72_ & ~x10) | (x04 & x08) | (~x04 & x20);
  ...
  assign new_n75_ = x20 & (~x04 | (new_n76_ & new_n61_ & x23 & ~x24));
  assign new_n76_ = ~x08 & x09 & ~x10 & x19;
  assign new_n77_ = x24 & (~new_n78_ | ~x19 | ~x20 | ~x21);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~new_n80_ & x20) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n80_ = x04 & (~new_n76_ | ~new_n61_ | ~x23 | ~x24 | x25);
  ...
  assign new_n84_ = x04 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
