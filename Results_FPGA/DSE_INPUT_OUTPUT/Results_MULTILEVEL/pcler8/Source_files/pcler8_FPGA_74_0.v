...
module FAU ( 
  ...
  assign new_n80_ = ~x10 & ((x25 & (~new_n77_ | ~new_n63_ | new_n81_ | ~x24)) | (new_n77_ & new_n63_ & x24 & ~x25));
  assign new_n81_ = x17 & x26;
  assign z16 = (~x20 & (~x09 | (new_n88_ & ~x08))) | (x07 & x08) | (~x08 & new_n83_ & x09);
