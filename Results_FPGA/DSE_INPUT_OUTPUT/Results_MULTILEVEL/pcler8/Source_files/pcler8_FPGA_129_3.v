...
module FAU ( 
  ...
  assign z09 = (~new_n62_ & (~x15 | ~x20)) | (new_n61_ & new_n63_ & x11 & ~x15 & x20);
  assign new_n61_ = new_n50_ & new_n49_ & x21;
  ...
  assign new_n68_ = x20 ? (x19 ? (x21 & (~new_n50_ | ~new_n49_ | ~x13)) : ~x21) : ~x21;
  assign z12 = (x20 & (new_n70_ | x15)) | (x03 & x08) | (new_n71_ & ~x08);
  assign new_n70_ = new_n63_ & x19 & x21 & ~x22;
  assign new_n71_ = x09 & ~x10 & x22 & (~new_n72_ | ~x19 | ~x20);
  assign new_n72_ = x21 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign z13 = (~new_n74_ & x20) | (x04 & x08) | (~x08 & new_n75_ & x09);
  assign new_n74_ = ~x15 & (~new_n63_ | ~new_n48_ | ~x22 | x23);
  assign new_n75_ = ~x10 & ~new_n76_ & x23;
  assign new_n76_ = x19 & x20 & x21 & x22;
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (x20 | ~x24) & (x15 | (~new_n80_ & ((new_n48_ & new_n79_) | ~x24)));
  ...
  assign new_n82_ = ~x15 & (~new_n83_ | x08 | ~x09 | x10 | ~x19);
  assign new_n83_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n84_ = ~x10 & x25 & (~new_n85_ | ~x19 | ~x20 | ~x21);
  assign new_n85_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n87_ | (~x08 & x09 & ~x10 & (new_n88_ | new_n92_));
  assign new_n87_ = x07 & ~new_n52_ & x08;
  assign new_n88_ = ~x15 & (((~new_n89_ | ~new_n90_) & x26) | (new_n76_ & new_n91_));
