...
module FAU ( 
  ...
  assign z11 = (new_n67_ & ~x08) | new_n49_ | (x02 & x08);
  assign new_n67_ = x09 & ~x10 & (x20 ? (x19 ? (new_n68_ | ~x21) : x21) : x21);
  ...
  assign new_n72_ = ~x20 & (~x18 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n77_ = x18 & ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x20 | ((~x24 | (new_n80_ & new_n81_)) & (~new_n80_ | ~new_n82_))) & (~x18 | x20 | ~x24);
  assign new_n80_ = x19 & x21;
  assign new_n81_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n82_ = x22 & x23 & ~x24;
  assign z15 = new_n88_ | (x06 & x08) | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (~x25 | (new_n85_ & new_n86_)) & (~new_n87_ | ~new_n60_ | ~x24 | x25);
  assign new_n85_ = x19 & x21 & x22;
  assign new_n86_ = x23 & x24 & (~x17 | ~x26);
  assign new_n87_ = x19 & x20 & x21;
  assign new_n88_ = ~x20 & (~x18 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n90_ | new_n91_));
  assign new_n90_ = x20 & ((x26 & (~new_n85_ | ~x23 | ~x24 | ~x25)) | (new_n85_ & x25 & ~x26 & x23 & x24));
