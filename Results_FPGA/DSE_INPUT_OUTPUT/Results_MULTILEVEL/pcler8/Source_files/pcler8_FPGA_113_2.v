...
module FAU ( 
  ...
  assign new_n61_ = (~x19 | (x20 & (~new_n59_ | ~new_n62_))) & (x03 | x19 | ~x20);
  ...
  assign new_n66_ = ~x19 & (x03 | (~x08 & x09 & ~x10 & x21));
  ...
  assign z13 = new_n71_ | (x19 & (new_n75_ | (~x08 & new_n73_ & x09)));
  assign new_n71_ = ~new_n72_ & ~x03;
  assign new_n72_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x19 | ~x23);
  assign new_n73_ = ~x10 & (x22 ? ((x20 & x21 & (new_n74_ | ~x23)) | (x23 & (~x20 | ~x21))) : x23);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign new_n75_ = x03 & x04 & x08;
  assign z14 = new_n80_ | (x05 & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x24 | (new_n78_ & x22 & ~new_n79_ & x23)) & (~x22 | ~x23 | x24 | ~new_n78_ | ~x19);
  assign new_n78_ = x20 & x21;
  assign new_n79_ = x16 & x25 & x26;
  assign new_n80_ = ~x19 & (x03 | (~x08 & x09 & ~x10 & x24));
