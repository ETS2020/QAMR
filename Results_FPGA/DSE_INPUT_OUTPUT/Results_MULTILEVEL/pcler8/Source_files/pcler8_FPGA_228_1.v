...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n73_ & ~x10) | (x04 & x08) | (~x04 & x20);
  ...
  assign new_n76_ = x20 & (~x04 | (new_n77_ & new_n63_ & x23 & ~x24));
  ...
  assign new_n81_ = x04 & (~new_n77_ | ~new_n63_ | ~x23 | ~x24 | x25);
  ...
  assign new_n85_ = x04 & ((new_n88_ & new_n89_) | ((~new_n86_ | ~new_n87_) & x26));
