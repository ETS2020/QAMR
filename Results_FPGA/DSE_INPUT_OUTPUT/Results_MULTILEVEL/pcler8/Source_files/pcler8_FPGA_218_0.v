...
module FAU ( 
  ...
  assign z09 = (~x10 & (~x20 | (new_n57_ & ~x08))) | (x00 & x08);
  assign new_n57_ = x09 & (~x19 | (new_n58_ & x11 & x21 & x22));
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign z10 = (~x10 & (~x20 | (new_n60_ & ~x08))) | (x01 & x08);
  assign new_n60_ = x09 & (~x19 | (new_n58_ & x12 & x21 & x22));
  assign z11 = (x02 & x08) | (~x10 & (~x20 | (~x08 & ~new_n62_ & x09)));
  assign new_n62_ = x19 ? (x21 & (~new_n63_ | ~x13 | ~x22 | ~x23)) : ~x21;
  assign new_n63_ = x24 & x25 & x26;
  assign z12 = (x03 & x08) | (~x10 & (~x20 | (~x08 & ~new_n65_ & x09)));
  assign new_n65_ = (~x22 | (x19 & x21 & (~new_n63_ | ~x14 | ~x23))) & (~x19 | ~x21 | x22);
  assign z13 = (~x10 & (~x20 | (new_n67_ & ~x08))) | (x04 & x08);
  assign new_n67_ = x09 & (x22 ? ((x19 & x21 & (new_n68_ | ~x23)) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n68_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~x10 & (~x20 | (~x08 & ~new_n70_ & x09)));
