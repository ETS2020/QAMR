...
module FAU ( 
  ...
  assign new_n61_ = (~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (~x19 | x20 | ~x24);
  ...
  assign new_n68_ = x24 & (~x20 | (x25 & x26 & x14 & x23));
  ...
  assign z14 = new_n75_ | (~x08 & x09 & ~new_n73_ & ~x10) | (x05 & x08);
  assign new_n73_ = (~x24 | (x19 & x21 & x22 & ~new_n74_ & x23)) & (~x19 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n74_ = x16 & x25 & x26;
  assign new_n75_ = ~x20 & (~x24 | (~x08 & x09 & ~x10));
  assign z15 = z07 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (new_n78_ | ~x24) & (~x20 | ~x25 | (new_n79_ & new_n80_));
  assign new_n78_ = (x20 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x25);
  assign new_n79_ = x19 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n87_ | (x07 & x08) | (~x08 & new_n82_ & x09);
  ...
  assign new_n87_ = ~x20 & (~x24 | (~x08 & x09 & ~x10 & x26));
endmodule
