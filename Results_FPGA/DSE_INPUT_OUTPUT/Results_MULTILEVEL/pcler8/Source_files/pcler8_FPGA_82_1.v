...
module FAU ( 
  ...
  assign new_n70_ = (~x22 | ((~x19 | ~x21 | (~new_n71_ & (~x20 | x23))) & (~x20 | ~x23 | (x19 & x21)))) & (~x23 | (x20 & x22));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = x20 ? ((~x24 | (new_n74_ & new_n75_)) & (~new_n74_ | ~new_n76_)) : (~x24 | x25);
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & ~new_n78_ & x20);
  assign new_n78_ = (~x25 | (new_n79_ & x23 & x24 & (~x17 | ~x26))) & (~new_n79_ | ~x23 | ~x24 | x25);
  assign new_n79_ = x19 & x21 & x22;
  assign z16 = (~new_n81_ & x25) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n81_ = x20 & (~new_n82_ | x08 | ~x09 | x10 | ~x19);
  assign new_n82_ = x21 & x22 & x23 & x24 & ~x26;
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | ~new_n74_ | x18);
