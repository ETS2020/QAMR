...
module FAU ( 
  ...
  assign z5 = (~x08 & new_n43_ & x09) | new_n34_ | (x04 & x08);
  assign new_n43_ = ~x10 & ((x15 & (~x11 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (x05 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (~x12 | ((~x16 | (x11 & x13 & x14)) & (~x14 | ~x15 | x16 | ~x11 | ~x13))) & (x15 | ~x16);
  ...
  assign z8 = (~new_n50_ & x15) | (x07 & x08) | (~x08 & new_n52_ & x09);
  assign new_n50_ = (~new_n51_ | x08 | ~x09 | x10 | ~x11) & x12;
