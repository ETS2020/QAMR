...
module FAU ( 
  ...
  assign z2 = (~x00 & (new_n35_ | (x01 & x08))) | (~x12 & (new_n36_ | (x01 & x08)));
  assign new_n35_ = ~x08 & x09 & ~x10 & ~x11 & x12;
  assign new_n36_ = ~x08 & x09 & ~x10 & x11;
  assign z3 = (~new_n38_ & x12) | (x02 & x08) | (new_n39_ & ~x08);
  assign new_n38_ = ~x00 & (x08 | ~x09 | x10 | ~x11 | x13);
  ...
  assign new_n44_ = ~x00 & (~new_n45_ | x08 | ~x09 | x10);
  assign new_n45_ = x11 & x13 & x14 & ~x15;
  assign new_n46_ = ~x10 & ~new_n47_ & x15;
  assign new_n47_ = x11 & x12 & x13 & x14;
  assign z6 = (x05 & ~new_n41_ & x08) | (new_n49_ & ~x08);
  assign new_n49_ = x09 & ~x10 & ((~new_n50_ & ~x00) | (~x12 & x16));
  assign new_n50_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~new_n52_ & x12) | (x06 & x08) | (~x08 & new_n54_ & x09);
  assign new_n52_ = (~new_n36_ | ~new_n53_) & ~x00;
  ...
  assign new_n57_ = (x12 | ~x18) & (x00 | ((~new_n47_ | ~new_n59_) & (new_n58_ | ~x18)));
