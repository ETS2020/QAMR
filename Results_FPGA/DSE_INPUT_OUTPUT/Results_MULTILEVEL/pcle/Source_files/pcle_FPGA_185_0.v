...
module FAU ( 
  ...
  assign z0 = (~x12 & ~x13) | (new_n32_ & new_n31_ & ~x10 & x11 & x12);
  ...
  assign z3 = (~x12 & (~x13 | (new_n38_ & ~x08))) | (new_n39_ & ~x08) | (x02 & x08);
  assign new_n38_ = x09 & ~x10;
  assign new_n39_ = x09 & ~x10 & (x11 ? ~x13 : (x12 & x13));
  assign z4 = new_n41_ | (new_n42_ & ~x08) | (x03 & x08);
  assign new_n41_ = ~x12 & (~x13 | (new_n31_ & ~x10 & x14));
  assign new_n42_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & x08 & (x12 | x13)) | (~x08 & new_n44_ & x09);
  assign new_n44_ = ~x10 & ((x13 & ((~x12 & x15) | (x11 & x12 & x14 & ~x15))) | (x12 & x15 & (~x14 | (x14 & (~x11 | ~x13)))));
  assign z6 = new_n46_ | (x05 & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n46_ = ~x12 & (~x13 | (new_n31_ & ~x10 & x16));
  assign new_n47_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (new_n49_ & ~x08) | (x06 & x08 & (x12 | x13));
  assign new_n49_ = x09 & ~x10 & ((~new_n50_ & x13) | (new_n51_ & x12));
  assign new_n50_ = (~x11 | ~x12 | ~x14 | ~x15 | ~x16 | x17) & (x12 | ~x17);
  assign new_n51_ = x17 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign z8 = new_n53_ | (x07 & x08) | (~x08 & x09 & ~new_n54_ & ~x10);
  assign new_n53_ = ~x12 & (~x13 | (new_n31_ & ~x10 & x18));
