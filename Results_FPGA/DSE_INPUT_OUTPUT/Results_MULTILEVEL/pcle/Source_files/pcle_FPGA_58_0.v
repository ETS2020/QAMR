...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & ((x11 & ~x13 & (x12 | ~x17)) | (x13 & (~x12 | (~x11 & (x17 | (x12 & ~x17))))));
  ...
  assign new_n41_ = ~x12 & (~x17 | (~x08 & x09 & ~x10 & x15));
  assign new_n42_ = ~x10 & ((x12 & x14 & ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15))) | (~x14 & x15));
  assign z6 = (~new_n33_ & (x08 ? x05 : (new_n46_ & x09))) | (~x08 & new_n44_ & x09);
  assign new_n44_ = ~x10 & (new_n45_ | (~x12 & x16 & x17));
  assign new_n45_ = x11 & x12 & x13 & x14 & x15 & ~x16;
  assign new_n46_ = ~x10 & x16 & (~x11 | ~x13 | ~x14 | ~x15);
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & new_n48_ & x09);
  assign new_n48_ = ~x10 & ((x17 & (~new_n49_ | ~x14 | ~x15 | ~x16)) | (new_n49_ & x14 & x15 & x16 & ~x17));
  assign new_n49_ = x11 & x12 & x13;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x12 | ((x17 | ~x18) & (~new_n54_ | ~new_n52_ | ~x17 | x18))) & (~x17 | new_n53_ | ~x18);
