...
module FAU ( 
  ...
  assign z3 = (x02 & ~new_n36_ & x08) | (new_n37_ & ~x08);
  assign new_n36_ = x11 & ~x12;
  assign new_n37_ = x09 & ~x10 & (x11 ? (x12 & ~x13) : x13);
  assign z4 = (~new_n39_ & x11) | (new_n40_ & ~x08) | (x03 & x08);
  assign new_n39_ = x12 & (x08 | ~x09 | x10 | ~x13 | x14);
  assign new_n40_ = x09 & ~x10 & (~x11 | ~x12 | ~x13) & x14;
  assign z5 = new_n42_ | (new_n43_ & ~x08) | (x04 & x08);
  assign new_n42_ = ~x12 & (x11 | (~x08 & x09 & ~x10 & x15));
  assign new_n43_ = x09 & ~x10 & ((x11 & x13 & (~x14 ^ ~x15)) | (x15 & (~x11 | ~x13)));
  assign z6 = (x05 & ~new_n36_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (~x12 | (((x13 & x14 & x15) | ~x16) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (x11 | ~x16);
  assign z7 = (x06 & ~new_n36_ & x08) | (new_n47_ & ~x08);
