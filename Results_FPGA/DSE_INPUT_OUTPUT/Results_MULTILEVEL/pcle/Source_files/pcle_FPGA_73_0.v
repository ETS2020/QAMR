...
module FAU ( 
  ...
  assign z7 = (~x08 & x09 & ~new_n45_ & ~x10) | new_n33_ | (x06 & x08);
  assign new_n45_ = (new_n47_ | (x18 & (~x17 | ~x18))) & (~new_n46_ | ~x15 | ~x16 | x17 | ~x18);
  assign new_n46_ = x11 & x12 & x13 & x14;
  assign new_n47_ = x11 & x12 & x13 & x14 & x15 & x16;
  assign z8 = (~x08 & x09 & ~new_n49_ & ~x10) | (x07 & ~new_n33_ & x08);
  assign new_n49_ = x17 ? ((~x18 | (new_n50_ & x14 & x15 & x16)) & (~new_n50_ | ~x14 | ~x15 | ~x16 | x18)) : ~x18;
