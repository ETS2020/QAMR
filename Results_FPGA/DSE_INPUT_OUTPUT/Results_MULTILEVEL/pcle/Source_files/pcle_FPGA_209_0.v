...
module FAU ( 
  ...
  assign z3 = ~new_n31_ & (x08 ? x02 : new_n38_);
  assign new_n38_ = x09 & ~x10 & ((x13 & (~x11 | ~x12)) | (x11 & x12 & ~x13));
  assign z4 = ~new_n31_ & (x08 ? x03 : new_n40_);
  ...
  assign new_n44_ = x15 ? ((~x16 | (new_n32_ & x13 & x14)) & (~new_n32_ | ~x13 | ~x14 | x16)) : (~x16 | ~x18);
  assign z7 = (x06 & ~new_n31_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & (x15 ? ~new_n47_ : (x17 & x18));
  assign new_n47_ = (~x17 | (x11 & x12 & x13 & x14 & x16)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x16 | x17);
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & new_n49_ & x09);
