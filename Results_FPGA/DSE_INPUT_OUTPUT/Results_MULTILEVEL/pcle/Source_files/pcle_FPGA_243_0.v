...
module FAU ( 
  ...
  assign new_n39_ = ~x12 & (~x05 | (~x10 & x14 & ~x08 & x09));
  assign new_n40_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n42_ & ~x10);
  assign new_n42_ = (~x12 | (x14 ? ((~x15 | (x11 & x13)) & (~x11 | ~x13 | x15)) : ~x15)) & (~x05 | x12 | ~x15);
  assign z6 = (x08 & (x05 | ~x12)) | (~x12 & (~x05 | (new_n46_ & x09))) | (~x08 & new_n44_ & x09);
  assign new_n44_ = ~new_n45_ & ~x10;
  assign new_n45_ = (~x16 | (x11 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign new_n46_ = ~x10 & x16;
  assign z7 = (x05 & (new_n50_ | (x06 & x08))) | (x12 & (x08 ? x06 : new_n48_));
  assign new_n48_ = x09 & ~new_n49_ & ~x10;
  assign new_n49_ = (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17) & (~x17 | (x11 & x13 & x14 & x15 & x16));
