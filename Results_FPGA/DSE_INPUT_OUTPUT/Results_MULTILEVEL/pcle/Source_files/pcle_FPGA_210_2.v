...
module FAU ( 
  ...
  assign new_n43_ = (~x16 | (new_n44_ & x13 & x14 & x15)) & (~new_n44_ | x06 | ~x13 | ~x14 | ~x15 | x16);
  assign new_n44_ = x11 & x12;
  assign z7 = (new_n46_ & ~x08) | (x06 & x08 & x16);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x16) | (~x06 & ~x16 & x17));
  assign new_n47_ = (~x17 | (x11 & x12 & x13 & x14 & x15)) & (~x14 | ~x15 | x17 | ~x11 | ~x12 | ~x13);
  assign z8 = (x06 & (~x16 | (x07 & x08 & x16))) | (~x08 & new_n49_ & x09) | (~x06 & x07 & x08);
  assign new_n49_ = ~x10 & ((x18 & (~new_n50_ | ~new_n52_)) | (new_n51_ & new_n53_));
