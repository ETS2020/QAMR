...
module FAU ( 
  ...
  assign z4 = (x00 & (new_n40_ | (x03 & x08))) | (x12 & (x08 ? x03 : new_n41_));
  assign new_n40_ = new_n31_ & ~x10 & ~x12 & x14;
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14));
  assign z5 = (x00 & (new_n43_ | (x04 & x08))) | (x12 & (x08 ? x04 : new_n44_));
  assign new_n43_ = new_n31_ & ~x10 & ~x12 & x15;
  assign new_n44_ = x09 & ~x10 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15)) : x15);
  ...
  assign new_n50_ = ~x12 & (~x00 | (new_n31_ & ~x10 & x17));
