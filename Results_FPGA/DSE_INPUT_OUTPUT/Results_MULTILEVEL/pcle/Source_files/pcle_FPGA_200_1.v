...
module FAU ( 
  ...
  assign z7 = new_n46_ | (x06 & x08) | (~x08 & x09 & new_n49_ & ~x10);
  assign new_n46_ = x15 & (~x12 | (new_n48_ & new_n47_ & x16 & ~x17));
  assign new_n47_ = x13 & x14;
  assign new_n48_ = ~x08 & x09 & ~x10 & x11;
  assign new_n49_ = x17 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign z8 = (~new_n51_ & x15) | (x07 & x08) | (~x08 & new_n52_ & x09);
  assign new_n51_ = x12 & (~new_n48_ | ~new_n47_ | ~x16 | ~x17 | x18);
