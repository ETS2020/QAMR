...
module FAU ( 
  ...
  assign z5 = (~x02 & (new_n43_ | (x04 & x08))) | (x12 & (x08 ? x04 : new_n44_));
  assign new_n43_ = new_n31_ & ~x10 & ~x12 & x15;
  assign new_n44_ = x09 & ~x10 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15)) : x15);
  assign z6 = (~x02 & (new_n46_ | (x05 & x08))) | (x12 & (x08 ? x05 : new_n47_));
  ...
  assign new_n50_ = ~x12 & (x02 | (new_n31_ & ~x10 & x17));
  ...
  assign new_n55_ = (~x18 | (new_n56_ & x15 & x16 & x17)) & (~new_n57_ | ~x15 | ~x16 | ~x17 | x18);
