...
module FAU ( 
  ...
  assign z5 = (x12 & (new_n43_ | ~x14)) | (x04 & x08) | (new_n42_ & ~x08);
  assign new_n42_ = x09 & ~x10 & x15 & (~x14 | (~new_n40_ & x14));
  assign new_n43_ = ~x08 & x09 & ~x10 & x11 & x13 & ~x15;
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (x12 | ~x16) & (~x14 | ((~x16 | (x11 & x13 & x15)) & (~x11 | ~x12 | ~x13 | ~x15 | x16)));
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & ((~new_n48_ & x14) | (~x12 & x17));
  assign new_n48_ = (~x17 | (x11 & x13 & x15 & x16)) & (~x11 | ~x12 | ~x13 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & new_n50_ & x09);
  assign new_n50_ = ~x10 & (new_n53_ | (x14 & (new_n51_ | (new_n40_ & new_n52_))));
