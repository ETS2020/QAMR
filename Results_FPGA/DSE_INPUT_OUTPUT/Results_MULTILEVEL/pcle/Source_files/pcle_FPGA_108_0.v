...
module FAU ( 
  ...
  assign new_n39_ = x09 & ~x10 & ((x12 & ((~x13 & x14) | (x11 & x13 & ~x14))) | (x13 & x14 & (~x11 | ~x12)));
  assign z5 = (~new_n41_ & ~x12) | (x04 & x08) | (~x08 & new_n42_ & x09);
  assign new_n41_ = x13 & (x08 | ~x09 | x10 | ~x13 | ~x14 | ~x15);
  assign new_n42_ = ~x10 & ((x13 & x14 & (x11 ? (x12 & ~x15) : x15)) | (x15 & (~x13 | ~x14)));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x13 | ((x12 | ~x16) & (~x11 | ~x12 | ~x14 | ~x15 | x16))) & (~x12 | ~x16 | (x14 & x15 & x11 & x13));
  ...
  assign new_n49_ = ~x12 & (~x13 | (~x08 & x09 & ~x10 & x17));
  assign z8 = (~x08 & x09 & ~new_n51_ & ~x10) | (x07 & ~new_n33_ & x08);
  assign new_n51_ = (~x13 | ((~new_n52_ | ~new_n53_) & (x12 | ~x18))) & (~x12 | new_n54_ | ~x18);
