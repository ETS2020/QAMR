...
module FAU ( 
  ...
  assign z4 = (new_n39_ & ~x08) | new_n34_ | (x03 & x08);
  ...
  assign new_n43_ = (~x14 | ((~x16 | (x12 & x13 & x15)) & (~x11 | ~x12 | ~x13 | ~x15 | x16))) & (x11 | ~x16);
  assign z7 = (x06 & ~new_n34_ & x08) | (new_n45_ & ~x08);
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x14) | (~x11 & x17));
  assign new_n46_ = (~x17 | (x15 & x16 & x12 & x13)) & (~x11 | ~x12 | ~x13 | ~x15 | ~x16 | x17);
  assign z8 = (~new_n48_ & x11) | (x07 & x08) | (~x08 & new_n50_ & x09);
  assign new_n48_ = x14 & (~new_n49_ | x08 | ~x09 | x10 | ~x12);
  assign new_n49_ = x13 & x15 & x16 & x17 & ~x18;
  assign new_n50_ = ~x10 & ~new_n51_ & x18;
  assign new_n51_ = x11 & x12 & x13 & x15 & x16 & x17;
endmodule
