...
module FAU ( 
  ...
  assign z6 = new_n43_ | (x05 & x08) | (~x08 & new_n44_ & x09);
  assign new_n43_ = ~x12 & (~x16 | (~x08 & x09 & ~x10));
  assign new_n44_ = ~x10 & ((x16 & (~x11 | ~x13 | ~x14 | ~x15)) | (x11 & x13 & x14 & x15 & ~x16));
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((new_n48_ & x12) | (~new_n47_ & x16));
  assign new_n47_ = (x12 | ~x17) & (~x14 | ~x15 | x17 | ~x11 | ~x12 | ~x13);
