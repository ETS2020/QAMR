...
module FAU ( 
  ...
  assign z0 = x14 & (new_n31_ | ~x04);
  assign new_n31_ = new_n32_ & x13 & x15 & x16 & x17 & x18;
  assign new_n32_ = ~x08 & x09 & ~x10 & x11 & x12;
  assign z1 = ~new_n34_ & (x04 | ~x14);
  assign new_n34_ = (~x00 | ~x08) & (x08 | ~x09 | x10 | x11);
  assign z2 = ~new_n36_ & (x04 | ~x14);
  assign new_n36_ = x08 ? ~x01 : (~x09 | x10 | (~x11 ^ x12));
  assign z3 = (x04 | ~x14) & (x08 ? x02 : new_n38_);
  assign new_n38_ = x09 & ~x10 & (x11 ? (x12 ^ x13) : x13);
  assign z4 = (x03 & x08 & (x04 | ~x14)) | (~x08 & new_n40_ & x09);
  assign new_n40_ = ~x10 & ((x04 & x14 & (~x11 | ~x12 | ~x13)) | (x13 & ~x14 & x11 & x12));
  assign z5 = (x08 & (x04 | x14)) | (x14 & (new_n42_ | ~x04)) | (~x08 & new_n43_ & x09);
  assign new_n42_ = x09 & ~x10 & x11 & x12 & x13 & ~x15;
  assign new_n43_ = ~x10 & x15 & (~x11 | ~x12 | ~x13 | ~x14);
  assign z6 = (new_n45_ & ~x08) | (x05 & x08 & (x04 | ~x14));
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x04) | (~x14 & x16));
  assign new_n46_ = (~x16 | (x11 & x12 & x13 & x15)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = (~x08 & new_n48_ & x09) | (x06 & x08 & (x04 | ~x14));
  ...
  assign z8 = (~new_n54_ & x14) | (x07 & x08) | (~x08 & new_n56_ & x09);
  assign new_n54_ = x04 & (~new_n32_ | ~new_n55_);
  assign new_n55_ = x13 & x15 & x16 & x17 & ~x18;
  assign new_n56_ = ~x10 & x18 & (~new_n49_ | ~new_n57_);
