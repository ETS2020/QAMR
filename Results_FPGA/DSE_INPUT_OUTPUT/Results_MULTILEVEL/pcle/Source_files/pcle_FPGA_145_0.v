...
module FAU ( 
  ...
  assign new_n39_ = ~x10 & ((x14 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x14 & x16));
  assign z5 = new_n41_ | (x04 & x08) | (~x08 & new_n42_ & x09);
  assign new_n41_ = ~x14 & (~x16 | (~x08 & x09 & ~x10 & x15));
  assign new_n42_ = ~x10 & x14 & (x11 ? ((x15 & (~x12 | ~x13)) | (x12 & x13 & ~x15)) : x15);
  ...
  assign new_n46_ = (~x16 | ((x14 | ~x17) & (~new_n47_ | ~x14 | ~x15 | x17))) & (~x14 | new_n48_ | ~x17);
  assign new_n47_ = x11 & x12 & x13;
  assign new_n48_ = x11 & x12 & x13 & x15 & x16;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n50_ & ~x10);
  assign new_n50_ = (~x16 | ((x14 | ~x18) & (~new_n47_ | ~x14 | ~x15 | ~x17 | x18))) & (~x14 | ~x18 | (new_n47_ & x15 & x16 & x17));
endmodule
