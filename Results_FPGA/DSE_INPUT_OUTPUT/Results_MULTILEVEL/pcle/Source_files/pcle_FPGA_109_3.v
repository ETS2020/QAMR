...
module FAU ( 
  ...
  assign z4 = (x12 & (new_n42_ | x06)) | (new_n40_ & ~x08) | (x03 & x08);
  ...
  assign new_n46_ = ~x06 & (~new_n47_ | ~x13 | ~x14 | ~x15 | x16);
  ...
  assign new_n51_ = ~x10 & ((new_n41_ & x14 & x15 & x16 & ~x17) | (x17 & (~new_n41_ | ~x14 | ~x15 | ~x16)));
  assign z8 = (x07 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n53_ & ~x10);
  assign new_n53_ = (x06 | ((~new_n55_ | ~new_n56_) & (new_n54_ | ~x18))) & (x12 | ~x18);
