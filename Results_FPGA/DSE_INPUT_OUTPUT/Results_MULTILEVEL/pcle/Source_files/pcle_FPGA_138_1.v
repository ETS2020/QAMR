...
module FAU ( 
  ...
  assign new_n46_ = ~x10 & ((x17 & (~new_n38_ | ~x14 | ~x15 | ~x16)) | (new_n38_ & x16 & ~x17 & x14 & x15));
  assign z8 = (x11 & (new_n48_ | ~x09)) | (x07 & x08) | (~x08 & new_n50_ & x09);
  assign new_n48_ = new_n49_ & x12 & x13 & ~x08 & ~x10;
  assign new_n49_ = x14 & x15 & x16 & x17 & ~x18;
  assign new_n50_ = ~x10 & x18 & (~new_n38_ | ~new_n51_);
