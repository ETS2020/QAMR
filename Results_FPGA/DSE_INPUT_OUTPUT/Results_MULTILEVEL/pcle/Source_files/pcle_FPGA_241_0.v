...
module FAU ( 
  ...
  assign z3 = (~x12 & (~x13 | (new_n37_ & ~x08))) | (new_n38_ & ~x08) | (x02 & x08);
  assign new_n37_ = x09 & ~x10;
  assign new_n38_ = x09 & ~x10 & (x11 ? ~x13 : (x12 & x13));
  ...
  assign new_n57_ = ~x12 & (~x13 | (~x08 & x09 & ~x10 & x18));
endmodule
