...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n35_, new_n37_;
  assign z1 = ~new_n31_ & ((x00 & x08) | (~x08 & x09 & ~x10 & ~x11));
  assign new_n31_ = x13 & x14;
  assign z2 = (x01 & ~new_n31_ & x08) | (new_n33_ & ~x08);
  assign new_n33_ = x09 & ~x10 & (~x13 | (x13 & ~x14)) & (x11 ^ x12);
  assign z3 = (x02 & ~new_n31_ & x08) | (new_n35_ & ~x08);
  assign new_n35_ = x09 & ~x10 & (x11 ? (x12 ? ~x13 : (x13 & ~x14)) : (x13 & ~x14));
  assign z4 = (x03 & ~new_n31_ & x08) | (new_n37_ & ~x08);
  assign new_n37_ = x09 & ~x10 & ((~x13 & x14) | (x13 & ~x14 & x11 & x12));
