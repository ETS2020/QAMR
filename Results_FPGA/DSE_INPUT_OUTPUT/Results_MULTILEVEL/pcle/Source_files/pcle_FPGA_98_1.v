...
module FAU ( 
  ...
  assign z3 = (new_n36_ & ~x08) | (~x11 & x14) | (x02 & x08);
  assign new_n36_ = x09 & ~x10 & (x11 ? (x12 ^ x13) : x13);
  assign z4 = (new_n38_ & ~x08) | (~x11 & x14) | (x03 & x08);
  ...
  assign z6 = (new_n42_ & ~x08) | (x05 & x08 & (x11 | ~x14));
  assign new_n42_ = x09 & ~new_n43_ & ~x10;
  assign new_n43_ = (~x11 | ((~x16 | (x12 & x13 & x15)) & (~x12 | ~x13 | ~x14 | ~x15 | x16))) & (x14 | ~x16);
  assign z7 = (new_n45_ & ~x08) | (x06 & x08 & (x11 | ~x14));
  assign new_n45_ = x09 & ~x10 & ((~x14 & x17) | (~new_n46_ & x11));
  assign new_n46_ = (~x17 | (x12 & x13 & x15 & x16)) & (~x15 | ~x16 | x17 | ~x12 | ~x13 | ~x14);
  assign z8 = (~new_n48_ & x14) | (x07 & x08) | (~x08 & new_n50_ & x09);
  assign new_n48_ = x11 & (~new_n49_ | x08 | ~x09 | x10 | ~x12);
  assign new_n49_ = x13 & x15 & x16 & x17 & ~x18;
