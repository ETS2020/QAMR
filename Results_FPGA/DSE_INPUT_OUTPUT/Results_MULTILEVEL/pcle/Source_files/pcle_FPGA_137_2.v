...
module FAU ( 
  ...
  assign z4 = (x12 & (new_n42_ | ~x17)) | (x03 & x08) | (new_n40_ & ~x08);
  ...
  assign z7 = (~x08 & new_n51_ & x09) | new_n34_ | (x06 & x08);
  assign new_n51_ = ~x10 & x17 & (~new_n41_ | ~x14 | ~x15 | ~x16);
  assign z8 = (x07 & ~new_n34_ & x08) | (~x08 & new_n53_ & x09);
  assign new_n53_ = ~x10 & (new_n56_ | (x17 & (new_n54_ | (new_n41_ & new_n55_))));
  assign new_n54_ = x18 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign new_n55_ = x14 & x15 & x16 & ~x18;
