...
module FAU ( 
  ...
  assign z2 = (x01 & x08 & (~x02 | (x02 & x12))) | (new_n35_ & ~x08);
  assign new_n35_ = x09 & ~x10 & ((~x11 & x12) | (~x02 & x11 & ~x12));
  assign z3 = (new_n37_ & ~x08) | (x02 & x08 & x12);
  assign new_n37_ = x09 & ~x10 & ((x12 & (x11 ^ x13)) | (~x02 & ~x12 & x13));
  assign z4 = new_n39_ | (x03 & x08) | (new_n40_ & ~x08);
  assign new_n39_ = ~x12 & (x02 | (~x08 & x09 & ~x10 & x14));
  assign new_n40_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = new_n42_ | (x04 & x08) | (~x08 & new_n43_ & x09);
  assign new_n42_ = ~x12 & (x02 | (~x08 & x09 & ~x10 & x15));
  ...
  assign new_n49_ = (~x17 | (new_n46_ & x14 & x15 & x16)) & (~new_n50_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n50_ = x11 & x12 & x13;
  assign new_n51_ = ~x12 & (x02 | (~x08 & x09 & ~x10 & x17));
