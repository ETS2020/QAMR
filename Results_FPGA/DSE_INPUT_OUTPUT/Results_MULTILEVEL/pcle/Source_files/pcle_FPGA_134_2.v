...
module FAU ( 
  ...
  assign new_n38_ = ~x12 & (x07 | (~x08 & x09 & ~x10 & x13));
  assign new_n39_ = x09 & ~x10 & (x11 ? (x12 & ~x13) : x13);
  assign z4 = new_n41_ | (new_n42_ & ~x08) | (x03 & x08);
  assign new_n41_ = ~x12 & (x07 | (~x08 & x09 & ~x10 & x14));
  assign new_n42_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x12 | (x14 ? ((~x15 | (x11 & x13)) & (~x11 | ~x13 | x15)) : ~x15)) & (x07 | x12 | ~x15);
  assign z6 = new_n46_ | (x05 & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n46_ = ~x12 & (x07 | (~x08 & x09 & ~x10 & x16));
  assign new_n47_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & x08 & (~x07 | (x07 & x12))) | (new_n49_ & ~x08);
  assign new_n49_ = x09 & ~x10 & ((~new_n50_ & x12) | (~x07 & ~x12 & x17));
  assign new_n50_ = (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17) & (~x17 | (x11 & x13 & x14 & x15 & x16));
  assign z8 = new_n55_ | (~x08 & x09 & ~x10 & (new_n52_ | new_n54_));
  assign new_n52_ = x12 & ((x18 & (~new_n53_ | ~x15 | ~x16 | ~x17)) | (new_n53_ & x15 & x16 & x17 & ~x18));
  assign new_n53_ = x11 & x13 & x14;
  assign new_n54_ = ~x07 & ~x12 & x18;
