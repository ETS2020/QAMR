...
module FAU ( 
  ...
  assign z4 = (~x12 & (~x14 | (new_n40_ & ~x08))) | (x03 & x08) | (new_n41_ & ~x08);
  assign new_n40_ = x09 & ~x10;
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14));
  assign z5 = (x04 & x08 & (x12 | x14)) | (~x08 & new_n43_ & x09);
  assign new_n43_ = ~x10 & ((x12 & ((~x14 & x15) | (x11 & x13 & x14 & ~x15))) | (x14 & x15 & (~x11 | ~x12 | ~x13)));
  ...
  assign new_n51_ = (~x17 | (new_n47_ & x14 & x15 & x16)) & (~new_n48_ | ~x14 | ~x15 | ~x16 | x17);
