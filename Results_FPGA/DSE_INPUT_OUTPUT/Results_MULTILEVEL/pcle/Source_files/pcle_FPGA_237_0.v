...
module FAU ( 
  ...
  assign z8 = new_n52_ | (x07 & x08) | (~x08 & x09 & ~new_n50_ & ~x10);
  assign new_n50_ = (~x18 | (new_n47_ & x15 & x16 & x17)) & (~new_n51_ | ~x15 | ~x16 | ~x17 | x18);
  assign new_n51_ = x11 & x12 & x13 & x14;
  assign new_n52_ = ~x14 & (~x16 | (~x08 & x09 & ~x10 & x18));
endmodule
