...
module FAU ( 
  ...
  assign new_n41_ = (~x15 | (x12 & (~x16 | (x14 & (~x12 | ~x14 | (x11 & x13)))))) & (~x14 | x15 | ~x16 | ~x11 | ~x12 | ~x13);
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & new_n43_ & ~x10);
  assign new_n43_ = x16 & (~x11 | ~x12 | ~x13 | ~x14 | ~x15);
  assign z7 = ~new_n45_ | (x12 & (~x16 | (new_n47_ & new_n48_)));
  assign new_n45_ = x08 ? ~x06 : (~x09 | ~new_n46_ | x10);
  assign new_n46_ = x17 & (~x11 | ~x12 | ~x13 | ~x14 | ~x15);
  assign new_n47_ = ~x08 & x09 & ~x10 & x11;
  assign new_n48_ = x13 & x14 & x15 & ~x17;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & new_n50_ & x09);
  assign new_n50_ = ~x10 & (new_n54_ | (x16 & (new_n52_ | (new_n51_ & new_n53_))));
  assign new_n51_ = x11 & x12 & x13;
  assign new_n52_ = x18 & (~x11 | ~x13 | ~x14 | ~x15 | ~x17);
  assign new_n53_ = x14 & x15 & x17 & ~x18;
