...
module FAU ( 
  ...
  assign new_n37_ = ~x12 & (x15 | (~x08 & x09 & ~x10 & x13));
  assign new_n38_ = x09 & ~x10 & (x11 ? (x12 & ~x13) : x13);
  assign z4 = (x03 & ~new_n33_ & x08) | (~x08 & new_n40_ & x09);
  assign new_n40_ = ~x10 & ((x14 & ((~x12 & ~x15) | ((~x15 | (x12 & x15)) & (~x11 | ~x13)))) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & new_n42_ & x09);
  assign new_n42_ = ~x10 & x12 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15)) : x15);
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (x15 | ~x16) & (~x12 | ((~x16 | (x11 & x13 & x14)) & (~x11 | ~x13 | ~x14 | ~x15 | x16)));
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x12) | (~x15 & x17));
  assign new_n47_ = (~x17 | (x11 & x13 & x14 & x16)) & (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14);
  assign z8 = (~new_n49_ & x15) | (x07 & x08) | (~x08 & new_n51_ & x09);
  assign new_n49_ = x12 & (~new_n50_ | x08 | ~x09 | x10 | ~x11);
  assign new_n50_ = x13 & x14 & x16 & x17 & ~x18;
