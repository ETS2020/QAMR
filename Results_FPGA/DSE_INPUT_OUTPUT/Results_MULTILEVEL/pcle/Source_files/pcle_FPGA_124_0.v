...
module FAU ( 
  ...
  assign z4 = (~x12 & (~x14 | (new_n40_ & ~x08))) | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n40_ = x09 & ~x10;
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14));
  assign z5 = new_n43_ | (x04 & x08) | (~x08 & new_n44_ & x09);
  assign new_n43_ = ~x12 & (~x14 | (~x08 & x09 & ~x10 & x15));
  assign new_n44_ = ~x10 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x15)) : x15);
  assign z6 = (x05 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x14 | ((x12 | ~x16) & (~x11 | ~x12 | ~x13 | ~x15 | x16))) & (~x12 | ~x16 | (x14 & x15 & x11 & x13));
  assign z7 = (x06 & ~new_n31_ & x08) | (~x08 & new_n48_ & x09);
  assign new_n48_ = ~x10 & ((~new_n49_ & x14) | (x12 & ~new_n50_ & x17));
  assign new_n49_ = (x12 | ~x17) & (~x11 | ~x12 | ~x13 | ~x15 | ~x16 | x17);
  assign new_n50_ = x11 & x13 & x14 & x15 & x16;
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n52_ & ~x10);
  assign new_n52_ = (~x14 | ((~new_n53_ | ~new_n54_) & (x12 | ~x18))) & (~x12 | new_n55_ | ~x18);
