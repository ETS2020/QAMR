...
module FAU ( 
  ...
  assign new_n42_ = ~x10 & ((x11 & x12 & ((x13 & ~x14 & x15) | (x14 & ~x15))) | (x15 & (~x11 | ~x12)));
  assign z6 = (x05 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x13 | ((~x16 | (x11 & x14 & x15)) & (~x11 | ~x12 | ~x14 | ~x15 | x16))) & (x12 | ~x16);
  assign z7 = (x06 & ~new_n34_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~x12 & x17) | (~new_n47_ & x13));
  assign new_n47_ = (~x17 | (x15 & x16 & x11 & x14)) & (~x15 | ~x16 | x17 | ~x11 | ~x12 | ~x14);
