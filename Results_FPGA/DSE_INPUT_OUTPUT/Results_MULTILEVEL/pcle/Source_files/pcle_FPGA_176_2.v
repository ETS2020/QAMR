...
module FAU ( 
  ...
  assign z1 = (~x08 & x09 & ~x10 & ~x11 & (~x00 | x12)) | (x00 & x08 & x12);
  assign z2 = (~x00 & (new_n35_ | (new_n31_ & ~x10 & x11 & ~x12))) | (x12 & (new_n35_ | (new_n31_ & ~x10 & ~x11)));
  assign new_n35_ = x01 & x08;
  assign z3 = new_n37_ | (new_n38_ & ~x08) | (x02 & x08);
  assign new_n37_ = ~x12 & (x00 | (new_n31_ & ~x10 & x13));
  ...
  assign new_n52_ = (~x17 | (new_n48_ & x14 & x15 & x16)) & (~new_n49_ | ~x16 | x17 | ~x14 | ~x15);
