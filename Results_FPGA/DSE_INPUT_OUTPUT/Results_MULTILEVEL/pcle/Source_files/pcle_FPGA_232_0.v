...
module FAU ( 
  ...
  assign new_n40_ = ~x12 & (~x04 | (new_n31_ & ~x10 & x14));
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & (x08 | (new_n43_ & x09 & ~x10))) | (~x08 & x09 & new_n44_ & ~x10);
  assign new_n43_ = ~x12 & x15;
  assign new_n44_ = x12 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15)) : x15);
  assign z6 = (x04 & (new_n46_ | (x05 & x08))) | (x12 & (x08 ? x05 : new_n47_));
  assign new_n46_ = new_n31_ & ~x10 & ~x12 & x16;
  assign new_n47_ = new_n48_ & x09;
  assign new_n48_ = ~x10 & ((x16 & (~x11 | ~x13 | ~x14 | ~x15)) | (x11 & x13 & x14 & x15 & ~x16));
  assign z7 = (x04 & (new_n50_ | (x06 & x08))) | (x12 & (x08 ? x06 : new_n51_));
  assign new_n50_ = new_n31_ & ~x10 & ~x12 & x17;
  assign new_n51_ = x09 & ~new_n52_ & ~x10;
  assign new_n52_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
