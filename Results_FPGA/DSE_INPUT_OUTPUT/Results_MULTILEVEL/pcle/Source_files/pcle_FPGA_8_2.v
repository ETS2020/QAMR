...
module FAU ( 
  ...
  assign new_n42_ = ~x10 & ((~x12 & x15) | (x13 & (x11 ? (x12 & (x14 ^ x15)) : x15)));
  assign z6 = (x05 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (x12 | ~x16) & (~x13 | ((~x16 | (x11 & x14 & x15)) & (~x11 | ~x12 | ~x14 | ~x15 | x16)));
  assign z7 = ~new_n46_ | (x12 & (~x13 | (new_n32_ & new_n48_)));
  assign new_n46_ = x08 ? ~x06 : (~x09 | ~new_n47_ | x10);
  assign new_n47_ = x17 & (~x11 | ~x12 | ~x14 | ~x15 | ~x16);
