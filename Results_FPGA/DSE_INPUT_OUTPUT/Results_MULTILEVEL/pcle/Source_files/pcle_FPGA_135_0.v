...
module FAU ( 
  ...
  assign new_n43_ = ~x10 & ((x13 & ((~x12 & x15) | (x11 & x12 & x14 & ~x15))) | (x12 & x15 & (~x14 | (x14 & (~x11 | ~x13)))));
  assign z6 = (x05 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (~x13 | ((x12 | ~x16) & (~x11 | ~x12 | ~x14 | ~x15 | x16))) & (~x12 | ~x16 | (x14 & x15 & x11 & x13));
  assign z7 = (x06 & ~new_n31_ & x08) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & ((new_n49_ & x12) | (~new_n48_ & x13));
  assign new_n48_ = (x12 | ~x17) & (~x11 | ~x12 | ~x14 | ~x15 | ~x16 | x17);
