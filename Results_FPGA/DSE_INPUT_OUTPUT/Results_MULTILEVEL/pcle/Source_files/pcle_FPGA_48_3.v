...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n35_, new_n37_, new_n39_, new_n41_, new_n42_,
  ...
  assign new_n39_ = (~x15 | (x11 & (x18 | (x14 & (~x11 | ~x14 | (x12 & x13)))))) & (~x14 | x15 | x18 | ~x11 | ~x12 | ~x13);
  assign z6 = (x05 & ~new_n32_ & x08) | (~x08 & x09 & ~new_n41_ & ~x10);
  assign new_n41_ = (~x16 | (x11 & (x18 | (new_n42_ & x14 & x15)))) & (~new_n42_ | ~x11 | ~x14 | ~x15 | x16 | x18);
  ...
  assign z8 = (~x08 & x09 & ~new_n49_ & ~x10) | new_n32_ | (x07 & x08);
  assign new_n49_ = ~x18 & (~new_n47_ | ~x14 | ~x15 | ~x16 | ~x17);
  assign z0 = 1'b0;
endmodule
