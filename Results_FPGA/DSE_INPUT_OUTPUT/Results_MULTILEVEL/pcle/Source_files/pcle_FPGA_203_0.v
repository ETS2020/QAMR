...
module FAU ( 
  ...
  assign z5 = (x08 & (x04 | ~x14)) | (~x08 & new_n43_ & x09) | (~x14 & (~x04 | (new_n42_ & x09)));
  assign new_n42_ = ~x10 & x15;
  assign new_n43_ = ~x10 & x14 & ((x15 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x15));
  assign z6 = (x04 & (new_n46_ | (x05 & x08))) | (x14 & (x08 ? x05 : new_n45_));
  assign new_n45_ = x09 & ~x10 & ((x16 & (~new_n32_ | ~x13 | ~x15)) | (new_n32_ & x13 & x15 & ~x16));
  assign new_n46_ = ~x08 & x09 & ~x10 & ~x14 & x16;
  assign z7 = (x04 & (new_n50_ | (x06 & x08))) | (x14 & (x08 ? x06 : new_n48_));
  assign new_n48_ = x09 & ~new_n49_ & ~x10;
  assign new_n49_ = (~x17 | (x11 & x12 & x13 & x15 & x16)) & (~x11 | ~x12 | ~x13 | ~x15 | ~x16 | x17);
  ...
  assign new_n55_ = ~x14 & (~x04 | (~x08 & x09 & ~x10 & x18));
endmodule
