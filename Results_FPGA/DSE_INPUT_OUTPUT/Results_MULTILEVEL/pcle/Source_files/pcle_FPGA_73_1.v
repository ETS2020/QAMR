...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n46_, new_n47_, new_n48_, new_n50_;
  ...
  assign z7 = (x06 & x08) | (~x08 & new_n47_ & x09) | (~new_n45_ & ~x17);
  assign new_n45_ = ~x18 & (~new_n46_ | x10 | ~x11 | x08 | ~x09);
  ...
  assign new_n50_ = x17 & ((x18 & (~new_n48_ | ~x14 | ~x15 | ~x16)) | (new_n48_ & x14 & x15 & x16 & ~x18));
endmodule
