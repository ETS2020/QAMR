...
module FAU ( 
  ...
  assign new_n44_ = (~x16 | (x14 & (new_n46_ | ~x17))) & (~new_n45_ | x16 | ~x17 | ~x14 | ~x15);
  assign new_n45_ = x11 & x12 & x13;
  assign new_n46_ = x11 & x12 & x13 & x15;
  ...
  assign new_n50_ = ~x10 & (new_n53_ | (x17 & (new_n51_ | (new_n45_ & new_n52_))));
  assign new_n51_ = x18 & (~x11 | ~x12 | ~x13 | ~x15 | ~x16);
  assign new_n52_ = x14 & x15 & x16 & ~x18;
