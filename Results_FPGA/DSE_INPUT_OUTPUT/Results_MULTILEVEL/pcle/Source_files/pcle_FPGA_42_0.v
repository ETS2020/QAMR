...
module FAU ( 
  ...
  wire new_n31_, new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_,
  ...
  assign z3 = (~x11 & (~x13 | (new_n37_ & ~x08))) | (new_n38_ & ~x08) | (x02 & x08);
  assign new_n37_ = x09 & ~x10;
  assign new_n38_ = x09 & ~x10 & ((x11 & ~x12 & x13) | (x12 & ~x13));
  assign z4 = (new_n34_ & x03) | (new_n40_ & ~x08);
  assign new_n40_ = x09 & ~x10 & ((x13 & (x11 ? (x12 & ~x14) : x14)) | (x11 & x14 & (~x12 | ~x13)));
  assign z5 = (new_n34_ & x04) | (~x08 & new_n42_ & x09);
  assign new_n42_ = ~x10 & (x11 ? ((x12 & x13 & (x14 ^ x15)) | (x15 & (~x12 | ~x13))) : (x13 & x15));
  assign z6 = (new_n34_ & x05) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x13 | ((x11 | ~x16) & (~x11 | ~x12 | ~x14 | ~x15 | x16))) & (~x11 | ~x16 | (x14 & x15 & x12 & x13));
  assign z7 = (new_n46_ & ~x08) | (new_n34_ & x06);
  assign new_n46_ = x09 & ~x10 & ((new_n48_ & x11) | (~new_n47_ & x13));
