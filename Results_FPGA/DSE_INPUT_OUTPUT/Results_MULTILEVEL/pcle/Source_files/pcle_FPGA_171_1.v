...
module FAU ( 
  ...
  assign new_n48_ = (new_n50_ | ~x17) & (~new_n49_ | ~x16 | x17 | ~x14 | ~x15);
  assign new_n49_ = x11 & x12 & x13;
  assign new_n50_ = x11 & x13 & x14 & x15 & x16;
  assign z8 = (~x08 & x09 & ~new_n52_ & ~x10) | (x07 & ~new_n33_ & x08);
  assign new_n52_ = (x17 | ~x18) & (~x12 | ((new_n50_ | ~x18) & (~new_n54_ | ~new_n53_ | ~x17 | x18)));
