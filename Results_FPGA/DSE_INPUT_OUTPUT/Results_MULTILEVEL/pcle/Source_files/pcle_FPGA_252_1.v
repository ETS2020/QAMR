...
module FAU ( 
  ...
  assign z6 = (x05 & x08 & (x09 | ~x11)) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x11 & (new_n45_ | ~x09)) | (x06 & x08) | (~x08 & new_n47_ & x09);
  assign new_n45_ = new_n46_ & x12 & x13 & ~x08 & ~x10;
  assign new_n46_ = x14 & x15 & x16 & ~x17;
  assign new_n47_ = ~x10 & x17 & (~new_n38_ | ~new_n48_ | ~x14);
  assign new_n48_ = x15 & x16;
  assign z8 = (x07 & x08 & (x09 | ~x11)) | (~x08 & x09 & ~new_n50_ & ~x10);
  assign new_n50_ = (~x18 | (new_n38_ & new_n52_)) & (~new_n51_ | ~new_n48_ | ~x17 | x18);
