...
module FAU ( 
  ...
  assign new_n36_ = x09 & ~x10 & (x11 ? (~x12 & x13) : (~x13 | (x12 & x13)));
  assign z3 = (new_n38_ & ~x08) | (x02 & ~new_n31_ & x08);
  assign new_n38_ = x09 & ~x10 & (x12 ? (x11 ^ x13) : x13);
  assign z4 = (new_n40_ & ~x08) | (x03 & ~new_n31_ & x08);
  assign new_n40_ = x09 & ~x10 & ((x12 & ((~x13 & x14) | (x11 & x13 & ~x14))) | (x13 & x14 & (~x11 | ~x12)));
  assign z5 = (~new_n42_ & ~x12) | (x04 & x08) | (~x08 & new_n43_ & x09);
  assign new_n42_ = x13 & (~x13 | ~x14 | ~x15 | x08 | ~x09 | x10);
  assign new_n43_ = ~x10 & ((x13 & x14 & (x11 ? (x12 & ~x15) : x15)) | (x15 & (~x13 | ~x14)));
  assign z6 = (x05 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (~x12 | ((x13 | ~x16) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (~x13 | ~x16 | (x14 & x15 & x11 & x12));
  ...
  assign new_n50_ = ~x12 & (~x13 | (~x10 & x17 & ~x08 & x09));
  ...
  assign new_n54_ = x13 & x14 & x11 & x12;
  assign new_n55_ = ~x12 & (~x13 | (~x10 & x18 & ~x08 & x09));
endmodule
