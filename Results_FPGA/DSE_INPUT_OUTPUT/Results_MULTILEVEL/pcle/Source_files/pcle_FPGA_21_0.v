...
module FAU ( 
  ...
  assign new_n47_ = x09 & ~x10 & ((~new_n48_ & x12) | (new_n49_ & x13));
  assign new_n48_ = (x13 | ~x17) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign new_n49_ = x17 & (~x11 | ~x12 | ~x14 | ~x15 | ~x16);
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x12 | ((x13 | ~x18) & (~new_n52_ | ~new_n53_))) & (~x13 | new_n54_ | ~x18);
