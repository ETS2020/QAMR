...
module FAU ( 
  ...
  assign z6 = (new_n48_ & ~x08) | (x05 & x08 & (x02 | ~x12));
  assign new_n48_ = x09 & ~x10 & ((~x12 & x16) | (~new_n49_ & x02));
  assign new_n49_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~new_n51_ & x12) | (~x08 & new_n53_ & x09) | (x06 & x08);
  assign new_n51_ = x02 & (~new_n52_ | x10 | ~x11 | x08 | ~x09);
  ...
  assign new_n55_ = x12 & (~x02 | (new_n57_ & new_n56_ & ~x08 & x09));
