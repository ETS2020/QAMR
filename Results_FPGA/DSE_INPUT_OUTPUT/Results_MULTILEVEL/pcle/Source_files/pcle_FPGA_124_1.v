...
module FAU ( 
  ...
  assign z4 = (new_n40_ & ~x08) | new_n34_ | (x03 & x08);
  assign new_n40_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x13 & ~x14 & x11 & x12));
  assign z5 = (new_n42_ & ~x08) | new_n34_ | (x04 & x08);
  assign new_n42_ = x09 & ~x10 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15)) : x15);
  assign z6 = (x05 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x12 | ((~x16 | (x11 & x13 & x15)) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (x14 | ~x16);
  assign z7 = (x06 & ~new_n34_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x12) | (~x14 & x17));
  assign new_n47_ = (~x17 | (x11 & x13 & x15 & x16)) & (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14);
  assign z8 = (x07 & ~new_n34_ & x08) | (~x08 & new_n49_ & x09);
  assign new_n49_ = ~x10 & (new_n53_ | (x12 & (new_n51_ | (new_n50_ & new_n52_))));
  assign new_n50_ = x11 & x13 & x14;
  assign new_n51_ = x18 & (~x11 | ~x13 | ~x15 | ~x16 | ~x17);
  assign new_n52_ = x15 & x16 & x17 & ~x18;
  assign new_n53_ = ~x14 & x18;
endmodule
