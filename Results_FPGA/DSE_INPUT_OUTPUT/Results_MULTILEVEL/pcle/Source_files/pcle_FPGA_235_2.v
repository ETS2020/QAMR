...
module FAU ( 
  ...
  assign z4 = new_n33_ | (x03 & x08) | (~x08 & x09 & new_n39_ & ~x10);
  assign new_n39_ = (~x15 | (x15 & x18)) & ((x14 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n41_ & ~x10);
  assign new_n41_ = (~x15 | ~x18 | (x11 & x12 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x15);
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x16 | (x15 & (new_n45_ | ~x18))) & (~new_n44_ | ~x14 | ~x15 | x16 | ~x18);
  assign new_n44_ = x11 & x12 & x13;
  assign new_n45_ = x11 & x12 & x13 & x14;
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~new_n45_ | ~x15 | ~x16 | x17 | ~x18) & (~x17 | (x15 & (new_n48_ | ~x18)));
  assign new_n48_ = x11 & x12 & x13 & x14 & x16;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & new_n50_ & ~x10);
  assign new_n50_ = x18 & (~new_n44_ | ~x14 | ~x15 | ~x16 | ~x17);
endmodule
