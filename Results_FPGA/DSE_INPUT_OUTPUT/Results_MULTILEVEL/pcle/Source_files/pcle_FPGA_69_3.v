...
module FAU ( 
  ...
  assign z4 = (~new_n39_ & x12) | (x03 & x08) | (new_n37_ & ~x08);
  assign new_n37_ = x09 & ~x10 & ~new_n38_ & x14;
  assign new_n38_ = x11 & x12 & x13;
  assign new_n39_ = ~x10 & (x08 | ~x09 | ~x11 | ~x13 | x14);
  assign z5 = new_n41_ | (x04 & x08) | (~x08 & new_n43_ & x09);
  assign new_n41_ = x12 & (x10 | (new_n42_ & x13 & x14 & ~x15));
  assign new_n42_ = ~x08 & x09 & x11;
  assign new_n43_ = ~x10 & x15 & (~x13 | ~x14 | ~x11 | ~x12);
  assign z6 = (x05 & x08) | (~x08 & new_n46_ & x09) | (~new_n45_ & x12);
  assign new_n45_ = ~x10 & (~new_n42_ | ~x15 | x16 | ~x13 | ~x14);
  assign new_n46_ = ~x10 & x16 & (~x11 | ~x12 | ~new_n47_ | ~x13);
  assign new_n47_ = x14 & x15;
  assign z7 = (x06 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (~x17 | (new_n38_ & x14 & x15 & x16)) & (~new_n38_ | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & x08) | (~x08 & new_n53_ & x09) | (~new_n51_ & x12);
  assign new_n51_ = ~x10 & (~new_n52_ | x08 | ~x09 | ~x11 | ~x13);
