...
module FAU ( 
  ...
  assign z5 = ~new_n43_ | (x12 & (new_n45_ | x10));
  assign new_n43_ = x08 ? ~x04 : (~x09 | ~new_n44_ | x10);
  assign new_n44_ = x15 & (~x13 | ~x14 | ~x11 | ~x12);
  assign new_n45_ = x13 & x14 & ~x15 & ~x08 & x09 & x11;
  assign z6 = (x05 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~x16 | (x13 & x14 & x15 & x11 & x12)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
