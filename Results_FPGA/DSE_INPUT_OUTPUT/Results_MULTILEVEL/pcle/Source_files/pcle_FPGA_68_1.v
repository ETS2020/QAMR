...
module FAU ( 
  ...
  assign new_n42_ = (x14 | ~x15) & (~x12 | ~x14 | ((x08 | ~x15 | (x11 & x13)) & (~x11 | ~x13 | x15)));
  assign new_n43_ = ~x12 & x15;
  assign z6 = ~new_n47_ | (~new_n45_ & x12);
  assign new_n45_ = x04 & (~new_n46_ | x08 | ~x09 | x10 | ~x11);
  ...
  assign new_n50_ = ~x10 & (new_n54_ | (x04 & (new_n51_ | (new_n52_ & new_n53_))));
  ...
  assign new_n56_ = (x12 | ~x18) & (~x04 | ((~new_n58_ | ~new_n59_) & (new_n57_ | ~x18)));
