...
module FAU ( 
  ...
  assign new_n40_ = ~x13 & (x08 | ~x09 | x10 | ~x14 | ~x15);
  assign new_n41_ = x09 & ~x10 & ((x11 & x13 & ~x14) | (x14 & (~x11 | ~x13)));
  assign z5 = new_n34_ | (x04 & x08) | (~x08 & new_n43_ & x09);
  assign new_n43_ = ~x10 & ((x11 & x13 & (x14 ^ x15)) | (x15 & (~x11 | ~x13 | (~x12 & x14))));
  ...
  assign new_n47_ = x09 & ~x10 & ((~x13 & x17) | (~new_n48_ & x12));
  assign new_n48_ = (~x17 | (x15 & x16 & x11 & x14)) & (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14);
