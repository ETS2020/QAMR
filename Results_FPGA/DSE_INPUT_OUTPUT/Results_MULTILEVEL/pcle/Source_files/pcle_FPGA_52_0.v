...
module FAU ( 
  ...
  assign new_n41_ = ~x12 & (~x13 | (~x08 & x09 & ~x10 & x14));
  assign new_n42_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = new_n44_ | (x04 & x08) | (~x08 & new_n45_ & x09);
  assign new_n44_ = ~x12 & (~x13 | (~x08 & x09 & ~x10 & x15));
  assign new_n45_ = ~x10 & ((x13 & x14 & (x11 ? (x12 & ~x15) : x15)) | (x15 & (~x13 | ~x14)));
  assign z6 = (x05 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~x13 | ((x12 | ~x16) & (~x11 | ~x12 | ~x14 | ~x15 | x16))) & (~x12 | ~x16 | (x14 & x15 & x11 & x13));
  assign z7 = (new_n49_ & ~x08) | (x06 & ~new_n31_ & x08);
  assign new_n49_ = x09 & ~x10 & ((new_n51_ & x12) | (~new_n50_ & x13));
  assign new_n50_ = (x12 | ~x17) & (~x11 | ~x12 | ~x14 | ~x15 | ~x16 | x17);
  ...
  assign new_n56_ = ~x12 & (~x13 | (~x08 & x09 & ~x10 & x18));
endmodule
