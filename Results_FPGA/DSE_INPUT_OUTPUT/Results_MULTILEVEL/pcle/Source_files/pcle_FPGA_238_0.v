...
module FAU ( 
  ...
  assign new_n43_ = ~x12 & (~x14 | (~x08 & x09 & ~x10 & x14 & x15));
  assign new_n44_ = ~x10 & ((x12 & x14 & ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15))) | (~x14 & x15));
  assign z6 = new_n49_ | (x05 & x08) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x16 | (new_n48_ & x14 & x15)) & (~new_n47_ | ~x14 | ~x15 | x16);
  assign new_n47_ = x11 & x12 & x13;
  assign new_n48_ = x11 & x13;
  assign new_n49_ = ~x12 & (~x14 | (~x08 & x09 & ~x10 & x16));
  assign z7 = new_n52_ | (x06 & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x17 | (new_n48_ & x14 & x15 & x16)) & (~new_n47_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n52_ = ~x12 & (~x14 | (~x08 & x09 & ~x10 & x17));
  assign z8 = (~x08 & x09 & ~new_n54_ & ~x10) | (x07 & ~new_n31_ & x08);
  assign new_n54_ = (~x14 | ((~new_n47_ | ~new_n55_) & (x12 | ~x18))) & (~x12 | new_n56_ | ~x18);
