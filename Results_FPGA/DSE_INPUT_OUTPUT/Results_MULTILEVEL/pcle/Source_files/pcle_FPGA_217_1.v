...
module FAU ( 
  ...
  assign z4 = (x12 & (new_n42_ | ~x01)) | (x03 & x08) | (new_n40_ & ~x08);
  assign new_n40_ = x09 & ~x10 & ~new_n41_ & x14;
  assign new_n41_ = x11 & x12 & x13;
  assign new_n42_ = ~x08 & x09 & ~x10 & x11 & x13 & ~x14;
  assign z5 = (x04 & ~new_n35_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x01 | ((~x15 | (x11 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x15))) & (x12 | ~x15);
  assign z6 = (~new_n46_ & x12) | (x05 & x08) | (~x08 & new_n48_ & x09);
  assign new_n46_ = x01 & (~new_n47_ | ~x15 | x16 | ~x13 | ~x14);
  ...
  assign new_n50_ = x01 & (~new_n47_ | ~new_n51_);
  ...
  assign new_n55_ = ~x10 & x18 & (~new_n41_ | ~new_n33_ | ~x16 | ~x17);
endmodule
