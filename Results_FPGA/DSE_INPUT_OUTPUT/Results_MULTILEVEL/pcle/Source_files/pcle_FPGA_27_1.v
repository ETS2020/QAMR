...
module FAU ( 
  ...
  assign z4 = (new_n42_ & ~x08) | (x03 & x08) | (x12 & (new_n41_ | ~x03));
  ...
  assign new_n44_ = x03 & (~new_n45_ | x08 | ~x09 | x10);
  assign new_n45_ = x11 & x13 & x14 & ~x15;
  assign new_n46_ = ~x10 & x15 & (~x14 | (x14 & (~x11 | ~x12 | ~x13)));
  ...
  assign new_n56_ = (x12 | ~x18) & (~x03 | ((~new_n58_ | ~new_n59_) & (new_n57_ | ~x18)));
