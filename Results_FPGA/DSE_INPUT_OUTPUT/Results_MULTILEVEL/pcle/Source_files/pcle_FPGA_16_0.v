...
module FAU ( 
  ...
  assign new_n42_ = x12 ? (x14 ? ((~x15 | (x11 & x13)) & (~x11 | ~x13 | x15)) : ~x15) : (~x15 | ~x18);
  ...
  assign z8 = new_n52_ | (x07 & x08) | (~x08 & new_n50_ & x09);
  assign new_n50_ = ~x10 & ((x18 & (~new_n51_ | ~x15 | ~x16 | ~x17)) | (new_n51_ & x15 & x16 & x17 & ~x18));
  assign new_n51_ = x11 & x13 & x14;
  assign new_n52_ = ~x12 & (~x18 | (~x08 & x09 & ~x10));
endmodule
