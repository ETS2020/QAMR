...
module FAU ( 
  ...
  assign new_n43_ = ~x12 & (x17 | (~x08 & x09 & ~x10 & x15));
  assign new_n44_ = ~x10 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x15)) : x15);
  assign z6 = (~new_n34_ & (x08 ? x05 : (new_n48_ & x09))) | (~x08 & new_n46_ & x09);
  assign new_n46_ = ~x10 & (new_n47_ | (~x12 & x16 & ~x17));
  ...
  assign new_n50_ = (new_n52_ | ~x17) & (~new_n51_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n51_ = x11 & x12 & x13;
  assign new_n52_ = x11 & x13 & x14 & x15 & x16;
  assign z8 = (~x08 & x09 & ~new_n54_ & ~x10) | (x07 & ~new_n34_ & x08);
  assign new_n54_ = (x17 | ~x18) & (~x12 | ((new_n52_ | ~x18) & (~new_n56_ | ~new_n55_ | ~x17 | x18)));
