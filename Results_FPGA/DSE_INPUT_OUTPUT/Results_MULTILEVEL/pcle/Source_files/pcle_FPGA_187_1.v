...
module FAU ( 
  ...
  wire new_n31_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n44_,
    new_n45_, new_n46_, new_n47_, new_n49_, new_n50_, new_n51_;
  ...
  assign z7 = (x12 & (new_n43_ | ~x09)) | (x06 & x08) | (~x08 & new_n45_ & x09);
  assign new_n43_ = new_n44_ & x11 & x13 & ~x08 & ~x10;
  assign new_n44_ = x14 & x15 & x16 & ~x17;
  assign new_n45_ = ~x10 & x17 & (~new_n46_ | ~new_n47_ | ~x14);
  assign new_n46_ = x11 & x12 & x13;
  assign new_n47_ = x15 & x16;
  assign z8 = (x07 & x08 & (x09 | ~x12)) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (~x18 | (new_n46_ & new_n50_)) & (~new_n51_ | ~new_n47_ | ~x17 | x18);
