...
module FAU ( 
  ...
  assign z5 = (x00 & (new_n43_ | (x04 & x08))) | (x11 & (x08 ? x04 : new_n44_));
  assign new_n43_ = new_n32_ & ~x10 & ~x11 & x15;
  assign new_n44_ = x09 & ~x10 & (x14 ? ((x15 & (~x12 | ~x13)) | (x12 & x13 & ~x15)) : x15);
  assign z6 = (x00 & (new_n46_ | (x05 & x08))) | (x11 & (x08 ? x05 : new_n47_));
  assign new_n46_ = new_n32_ & ~x10 & ~x11 & x16;
  assign new_n47_ = new_n48_ & x09;
  assign new_n48_ = ~x10 & ((x16 & (~x14 | ~x15 | ~x12 | ~x13)) | (x12 & x13 & x14 & x15 & ~x16));
  assign z7 = (x00 & (new_n50_ | (x06 & x08))) | (x11 & (x08 ? x06 : new_n51_));
  assign new_n50_ = new_n32_ & ~x10 & ~x11 & x17;
  assign new_n51_ = x09 & ~new_n52_ & ~x10;
  assign new_n52_ = (~x17 | (x12 & x13 & x14 & x15 & x16)) & (~x15 | ~x16 | x17 | ~x12 | ~x13 | ~x14);
  assign z8 = new_n54_ | (x07 & x08) | (~x08 & x09 & ~new_n55_ & ~x10);
  assign new_n54_ = ~x11 & (~x00 | (new_n32_ & ~x10 & x18));
