...
module FAU ( 
  ...
  assign z7 = (x11 & (new_n43_ | ~x09)) | (x06 & x08) | (~x08 & new_n45_ & x09);
  assign new_n43_ = new_n44_ & x14 & x15 & x16 & ~x17;
  assign new_n44_ = x12 & x13 & ~x08 & ~x10;
  assign new_n45_ = ~x10 & x17 & (~new_n46_ | ~x14 | ~x15 | ~x16);
  assign new_n46_ = x11 & x12 & x13;
  assign z8 = (x11 & (new_n48_ | ~x09)) | (x07 & x08) | (~x08 & new_n49_ & x09);
  assign new_n48_ = new_n44_ & x14 & x15 & x16 & x17 & ~x18;
  assign new_n49_ = ~x10 & x18 & (~new_n46_ | ~new_n50_);
