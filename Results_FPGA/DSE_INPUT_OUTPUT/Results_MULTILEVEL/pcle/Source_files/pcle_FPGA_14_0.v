...
module FAU ( 
  ...
  assign z6 = (x02 & (new_n48_ | (x05 & x08))) | (x12 & (x08 ? x05 : new_n46_));
  ...
  assign new_n51_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14);
  assign new_n52_ = ~x08 & x09 & ~x10 & ~x12 & x17;
  assign z8 = (~new_n33_ & (x08 ? x07 : (new_n54_ & x09))) | (~x08 & new_n56_ & x09);
  assign new_n54_ = ~x10 & ~new_n55_ & x18;
  assign new_n55_ = x11 & x13 & x14 & x15 & x16 & x17;
  assign new_n56_ = ~x10 & ((new_n57_ & new_n58_) | (x02 & ~x12 & x18));
