...
module FAU ( 
  ...
  assign new_n41_ = ~x13 & (~x14 | (~x08 & x09 & ~x10 & x14 & x15));
  assign new_n42_ = ~x10 & ((~x14 & x15) | (x13 & x14 & ((x15 & (~x11 | ~x12)) | (x11 & x12 & ~x15))));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & new_n44_ & x09);
  assign new_n44_ = ~x10 & ((x14 & ((~x13 & x16) | (new_n45_ & x13 & x15 & ~x16))) | (x13 & x16 & (~new_n45_ | ~x14 | ~x15)));
  assign new_n45_ = x11 & x12;
  assign z7 = new_n49_ | (x06 & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~x17 | (new_n45_ & x14 & x15 & x16)) & (~new_n48_ | ~x16 | x17 | ~x14 | ~x15);
  assign new_n48_ = x11 & x12 & x13;
  assign new_n49_ = ~x13 & (~x14 | (~x08 & x09 & ~x10 & x17));
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x14 | ((~new_n48_ | ~new_n52_) & (x13 | ~x18))) & (~x13 | new_n53_ | ~x18);
