...
module FAU ( 
  ...
  assign new_n38_ = x09 & ~x10 & ((x03 & x12 & (x11 ^ x13)) | (~x12 & x13));
  ...
  assign new_n43_ = (~x03 | ((x14 | ~x15) & (~x12 | ~x14 | ((~x15 | (x11 & x13)) & (~x11 | ~x13 | x15))))) & (x12 | ~x15);
  assign z6 = (x05 & ~new_n34_ & x08) | (new_n45_ & ~x08);
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x03) | (~x12 & x16));
  assign new_n46_ = (~x16 | (x11 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & ~new_n34_ & x08) | (~x08 & new_n48_ & x09);
  ...
  assign new_n54_ = (x12 | ~x18) & (~x03 | ((~new_n56_ | ~new_n57_) & (new_n55_ | ~x18)));
