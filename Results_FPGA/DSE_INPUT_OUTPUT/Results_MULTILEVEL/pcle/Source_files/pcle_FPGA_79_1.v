...
module FAU ( 
  ...
  assign z5 = (x11 & (new_n39_ | ~x09)) | (x04 & x08) | (~x08 & new_n40_ & x09);
  assign new_n39_ = ~x08 & ~x10 & x12 & x13 & x14 & ~x15;
  ...
  assign z8 = (x11 & (new_n47_ | ~x09)) | (x07 & x08) | (~x08 & new_n49_ & x09);
  assign new_n47_ = new_n48_ & x12 & x13 & ~x08 & ~x10;
  assign new_n48_ = x14 & x15 & x16 & x17 & ~x18;
  assign new_n49_ = ~x10 & x18 & (~new_n45_ | ~new_n50_);
