...
module FAU ( 
  ...
  assign z6 = (x05 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~x17 | (new_n39_ & x14 & x15 & x16)) & (~new_n39_ | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n50_ & ~x10);
  assign new_n50_ = (~x18 | (new_n39_ & new_n52_)) & (~new_n43_ | ~new_n51_ | ~x17 | x18);
