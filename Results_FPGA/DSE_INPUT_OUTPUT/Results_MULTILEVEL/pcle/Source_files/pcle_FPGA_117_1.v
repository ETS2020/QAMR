...
module FAU ( 
  ...
  assign new_n50_ = ~x10 & x17 & (~new_n51_ | ~new_n52_ | ~x14);
  assign new_n51_ = x11 & x12 & x13;
  assign new_n52_ = x15 & x16;
  assign z8 = (x07 & x08 & (x09 | ~x11)) | (~x08 & x09 & ~new_n54_ & ~x10);
  assign new_n54_ = (~x18 | (new_n51_ & new_n55_)) & (~new_n40_ | ~new_n52_ | ~x17 | x18);
