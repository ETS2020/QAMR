...
module FAU ( 
  ...
  assign new_n39_ = ~x10 & ((x14 & x16 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = new_n33_ | (x04 & x08) | (~x08 & x09 & ~new_n41_ & ~x10);
  assign new_n41_ = x14 ? ((~x15 | ~x16 | (x11 & x12 & x13)) & (~x11 | ~x12 | ~x13 | x15)) : ~x15;
  ...
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x16) | (~x14 & x17));
  assign new_n46_ = (~x17 | (x11 & x12 & x13 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x17);
  ...
  assign new_n50_ = x18 & (~x11 | ~x12 | ~x13 | ~x15 | ~x17);
