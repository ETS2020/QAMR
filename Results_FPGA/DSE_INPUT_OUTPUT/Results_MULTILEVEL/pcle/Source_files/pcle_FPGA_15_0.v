...
module FAU ( 
  ...
  assign new_n38_ = x09 & ~x10 & (x12 ? (x11 ^ x13) : (x13 & x16));
  ...
  assign new_n42_ = x12 ? (x14 ? ((~x15 | (x11 & x13)) & (~x11 | ~x13 | x15)) : ~x15) : (~x15 | ~x16);
  assign z6 = new_n44_ | (x05 & x08) | (~x08 & new_n45_ & x09);
  assign new_n44_ = ~x12 & (~x16 | (~x08 & x09 & ~x10));
  assign new_n45_ = ~x10 & ((x16 & (~x11 | ~x13 | ~x14 | ~x15)) | (x11 & x13 & x14 & x15 & ~x16));
  assign z7 = (x06 & ~new_n31_ & x08) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & ((new_n49_ & x12) | (~new_n48_ & x16));
  assign new_n48_ = (x12 | ~x17) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x17);
  assign new_n49_ = x17 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x16 | ((~new_n52_ | ~new_n53_) & (x12 | ~x18))) & (~x12 | new_n54_ | ~x18);
  assign new_n52_ = x11 & x12 & x13;
  assign new_n53_ = x17 & ~x18 & x14 & x15;
