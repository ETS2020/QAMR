...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & ((x11 & ~x13 & (x12 | ~x16)) | (x13 & (~x12 | (~x11 & (x16 | (x12 & ~x16))))));
  ...
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x16) | (new_n48_ & x12));
  assign new_n47_ = (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x17) & (x12 | ~x17);
  ...
  assign new_n53_ = ~x12 & (~x16 | (~x08 & x09 & ~x10 & x18));
endmodule
