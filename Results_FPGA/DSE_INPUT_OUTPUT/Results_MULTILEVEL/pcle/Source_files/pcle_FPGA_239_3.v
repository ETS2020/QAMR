...
module FAU ( 
  ...
  assign new_n35_ = x09 & ~x10 & (x12 ? (x11 ? ~x13 : (x13 & ~x18)) : x13);
  ...
  assign z7 = (~new_n44_ & x12) | (x06 & x08) | (~x08 & new_n46_ & x09);
  assign new_n44_ = ~x18 & (~new_n45_ | x10 | ~x11 | x08 | ~x09);
  assign new_n45_ = x13 & x14 & x15 & x16 & ~x17;
  assign new_n46_ = ~x10 & x17 & (~new_n47_ | ~x11 | ~x12 | ~x13);
  assign new_n47_ = x14 & x15 & x16 & ~x18;
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (x12 | ~x18) & (~new_n50_ | ~x11 | ~x12 | ~x13 | ~x14);
