...
module FAU ( 
  ...
  assign z7 = (~x02 & (new_n49_ | (x06 & x08))) | (x12 & (x08 ? x06 : new_n50_));
  ...
  assign z8 = new_n53_ | (x07 & x08) | (~x08 & x09 & ~new_n54_ & ~x10);
  assign new_n53_ = ~x12 & (x02 | (new_n31_ & ~x10 & x18));
