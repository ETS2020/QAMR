...
module FAU ( 
  ...
  assign z4 = (x12 & (new_n40_ | ~x06)) | (new_n41_ & ~x08) | (x03 & x08);
  ...
  assign new_n43_ = (~x06 | ((~x15 | (x11 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x15))) & (x12 | ~x15);
  assign z6 = ~new_n47_ | (~new_n45_ & x12);
  assign new_n45_ = x06 & (~new_n46_ | ~x13 | ~x14 | ~x15 | x16);
  assign new_n46_ = ~x08 & x09 & ~x10 & x11;
  assign new_n47_ = x08 ? ~x05 : (~x09 | x10 | new_n48_ | ~x16);
  assign new_n48_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = (x08 & (x06 | x12)) | (x12 & (new_n50_ | ~x06)) | (~x08 & new_n52_ & x09);
  assign new_n50_ = new_n51_ & x11 & x13 & x09 & ~x10;
  ...
  assign new_n55_ = (~x06 | ((~new_n57_ | ~new_n58_) & (new_n56_ | ~x18))) & (x12 | ~x18);
