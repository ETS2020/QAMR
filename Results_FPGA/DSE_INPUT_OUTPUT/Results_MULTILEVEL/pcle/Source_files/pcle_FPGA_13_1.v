...
module FAU ( 
  ...
  assign new_n38_ = x05 & (x08 | ~x09 | x10 | ~x11 | x13);
  assign new_n39_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (x03 & ~new_n34_ & x08) | (~x08 & new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x05 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14))) | (~x12 & x14));
