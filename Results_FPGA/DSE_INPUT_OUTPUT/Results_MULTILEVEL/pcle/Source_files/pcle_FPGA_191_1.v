...
module FAU ( 
  ...
  assign z4 = (x12 & (new_n42_ | ~x05)) | (new_n40_ & ~x08) | (x03 & x08);
  ...
  assign z6 = (x08 & (x05 | x12)) | (~x08 & new_n50_ & x09) | (x12 & (new_n48_ | ~x05));
  ...
  assign new_n53_ = x05 & (~new_n54_ | x10 | ~x11 | x08 | ~x09);
  ...
  assign new_n57_ = x12 & (~x05 | (new_n59_ & new_n58_ & ~x08 & x09));
