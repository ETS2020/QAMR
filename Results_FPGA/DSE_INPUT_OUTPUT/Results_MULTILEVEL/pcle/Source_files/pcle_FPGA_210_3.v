...
module FAU ( 
  ...
  assign new_n44_ = (x06 | new_n46_ | ~x16) & (~new_n45_ | ~x14 | ~x15 | x16);
  assign new_n45_ = x11 & x12 & x13;
  assign new_n46_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = new_n49_ | (~x06 & ~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (new_n46_ | ~x17) & (~new_n45_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n49_ = ~x16 & ((x06 & x08) | (~x08 & x09 & ~x10 & x17));
  assign z8 = (x06 & (x16 | (x07 & x08 & ~x16))) | (~x08 & new_n51_ & x09) | (~x06 & x07 & x08);
  assign new_n51_ = ~x10 & ((x18 & (~new_n45_ | ~new_n53_)) | (new_n52_ & new_n54_));
