...
module FAU ( 
  ...
  assign z0 = (x03 & ~x12) | (new_n32_ & new_n31_ & ~x10 & x11 & x12);
  ...
  assign new_n50_ = ~x12 & (x03 | (new_n31_ & ~x10 & x17));
  assign new_n51_ = (~x17 | (new_n48_ & x14 & x15 & x16)) & (~new_n52_ | ~x14 | ~x15 | ~x16 | x17);
  ...
  assign new_n56_ = ~x10 & ((new_n57_ & x15 & x16 & x17 & ~x18) | (x18 & (~new_n57_ | ~x15 | ~x16 | ~x17)));
