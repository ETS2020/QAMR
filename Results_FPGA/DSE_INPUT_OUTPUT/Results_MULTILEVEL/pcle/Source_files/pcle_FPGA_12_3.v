...
module FAU ( 
  ...
  wire new_n33_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n43_,
  ...
  assign z4 = (x12 & (new_n37_ | x17)) | (new_n38_ & ~x08) | (x03 & x08);
  assign new_n37_ = ~x08 & x09 & ~x10 & x11 & x13 & ~x14;
  assign new_n38_ = x09 & ~x10 & x14 & (~x11 | ~x12 | ~x13);
  assign z5 = (x04 & ~z0 & x08) | (~x08 & x09 & ~new_n40_ & ~x10);
  assign new_n40_ = (~x15 | (x12 & (x17 | (x11 & x13 & x14)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15 | x17);
  assign z6 = ~new_n42_ | (x12 & (x17 | (new_n44_ & new_n45_)));
  ...
  assign z7 = (~x08 & new_n47_ & x09) | z0 | (x06 & x08);
  assign new_n47_ = ~x10 & (new_n48_ | x17);
