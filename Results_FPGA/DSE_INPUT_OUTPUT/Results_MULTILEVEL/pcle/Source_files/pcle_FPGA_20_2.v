...
module FAU ( 
  ...
  assign new_n44_ = ~x10 & x15 & (~x14 | (x14 & (~x11 | ~x12 | ~x13)));
  assign z6 = ~new_n48_ | (x12 & (~x18 | (new_n46_ & new_n50_)));
  assign new_n46_ = new_n47_ & x15 & ~x16;
  ...
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n52_ & ~x10);
  assign new_n52_ = (~x17 | (~new_n53_ & x12)) & (~new_n54_ | ~new_n47_ | ~x11 | ~x12);
  assign new_n53_ = x18 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign new_n54_ = x15 & x16 & ~x17 & x18;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & new_n56_ & ~x10);
  assign new_n56_ = x18 & (~new_n57_ | ~x11 | ~x12 | ~x13);
