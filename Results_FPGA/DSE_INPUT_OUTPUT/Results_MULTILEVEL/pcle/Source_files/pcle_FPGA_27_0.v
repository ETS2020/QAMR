...
module FAU ( 
  ...
  assign z4 = (~x12 & (~x03 | (new_n41_ & ~x08 & x09))) | (x03 & x08) | (~x08 & new_n42_ & x09);
  assign new_n41_ = ~x10 & x14;
  assign new_n42_ = ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = new_n44_ | (x04 & x08) | (~x08 & new_n45_ & x09);
  assign new_n44_ = ~x12 & (~x03 | (new_n31_ & ~x10 & x15));
  assign new_n45_ = ~x10 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x15)) : x15);
  assign z6 = (x03 & (new_n47_ | (x05 & x08))) | (x12 & (x08 ? x05 : new_n48_));
  ...
  assign new_n51_ = ~x12 & (~x03 | (new_n31_ & ~x10 & x17));
  assign new_n52_ = (~x17 | (new_n49_ & x14 & x15 & x16)) & (~new_n53_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n53_ = x11 & x12 & x13;
  assign z8 = new_n55_ | (x12 & (x08 ? x07 : (new_n57_ & x09)));
  assign new_n55_ = ~new_n56_ & x03;
  assign new_n56_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x12 | ~x18);
  assign new_n57_ = ~x10 & ((x18 & (~new_n58_ | ~x15 | ~x16 | ~x17)) | (new_n58_ & x15 & x16 & x17 & ~x18));
  assign new_n58_ = x11 & x13 & x14;
endmodule
