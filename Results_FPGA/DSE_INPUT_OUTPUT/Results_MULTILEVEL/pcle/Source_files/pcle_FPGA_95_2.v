...
module FAU ( 
  ...
  assign z2 = (new_n34_ & ~x08) | (x11 & ~x15) | (x01 & x08);
  assign new_n34_ = x09 & ~x10 & (x11 ^ x12);
  assign z3 = (new_n36_ & ~x08) | (x11 & ~x15) | (x02 & x08);
  assign new_n36_ = x09 & ~x10 & (x11 ? (~x12 ^ ~x13) : x13);
  assign z4 = (~new_n38_ & x11) | (x03 & x08) | (~x08 & new_n40_ & x09);
  assign new_n38_ = x15 & (~new_n39_ | ~x12 | ~x13 | x14 | ~x15);
  assign new_n39_ = ~x08 & x09 & ~x10;
  assign new_n40_ = ~x10 & x14 & (~x15 | (x15 & (~x11 | ~x12 | ~x13)));
  assign z5 = (x04 & x08 & (~x11 | x15)) | (~x08 & new_n42_ & x09);
  assign new_n42_ = ~x10 & x15 & (~x14 | (x14 & (~x11 | ~x12 | ~x13)));
  assign z6 = (~new_n44_ & x11) | (x05 & x08) | (~x08 & new_n45_ & x09);
  assign new_n44_ = x15 & (~new_n39_ | ~x12 | ~x13 | ~x14 | x16);
  assign new_n45_ = ~x10 & x16 & (~x11 | ~x12 | ~x13 | ~x14);
  assign z7 = (new_n47_ & ~x08) | (x06 & x08 & (~x11 | x15));
  assign new_n47_ = x09 & ~x10 & ((~new_n48_ & x15) | (~x11 & x17));
  assign new_n48_ = (~x17 | (x12 & x13 & x14 & x16)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x16 | x17);
  assign z8 = (~new_n50_ & x11) | (x07 & x08) | (~x08 & new_n52_ & x09);
  assign new_n50_ = x15 & (~new_n51_ | x08 | ~x09 | x10 | ~x12);
