...
module FAU ( 
  ...
  assign z2 = (x01 & x08 & (~x02 | (x02 & ~x12))) | (new_n36_ & ~x08);
  assign new_n36_ = x09 & ~x10 & ((~x02 & ~x11 & x12) | (x11 & ~x12));
  assign z3 = (new_n38_ & ~x08) | (x02 & x08 & ~x12);
  assign new_n38_ = x09 & ~x10 & ((~x02 & x12 & (x11 ^ x13)) | (~x12 & x13));
  ...
  assign new_n48_ = ~x02 & (~new_n49_ | x10 | ~x11 | x08 | ~x09);
  ...
  assign new_n53_ = ~x10 & (new_n56_ | (~x02 & (new_n54_ | (new_n41_ & new_n55_))));
  assign new_n54_ = x17 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign new_n55_ = x14 & x15 & x16 & ~x17;
  assign new_n56_ = ~x12 & x17;
  assign z8 = (~new_n58_ & x12) | (~x08 & new_n60_ & x09) | (x07 & x08);
  assign new_n58_ = ~x02 & (~new_n59_ | ~new_n51_ | ~x16 | ~x17 | x18);
  assign new_n59_ = ~x08 & x09 & ~x10 & x11 & x13;
  assign new_n60_ = ~x10 & x18 & (~new_n41_ | ~new_n51_ | ~x16 | ~x17);
endmodule
