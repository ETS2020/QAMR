...
module FAU ( 
  ...
  assign z5 = (~new_n41_ & x12) | (~x08 & new_n43_ & x09) | (x04 & x08);
  ...
  assign new_n45_ = ~new_n46_ & x16;
  assign new_n46_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = ~new_n50_ | (~new_n48_ & x12);
  assign new_n48_ = x16 & (~new_n49_ | ~x13 | ~x14 | ~x15 | x17);
  assign new_n49_ = ~x08 & x09 & ~x10 & x11;
  assign new_n50_ = x08 ? ~x06 : (~x09 | x10 | new_n46_ | ~x17);
  assign z8 = ~new_n53_ | (x12 & (new_n52_ | ~x16));
  assign new_n52_ = new_n49_ & x13 & x14 & x15 & x17 & ~x18;
