...
module FAU ( 
  ...
  assign new_n42_ = ~x12 & (~x14 | (~x08 & x09 & ~x10 & x14 & x15));
  ...
  assign new_n47_ = ~x10 & ((~new_n48_ & x14) | (x12 & ~new_n49_ & x17));
  assign new_n48_ = (x12 | ~x17) & (~x11 | ~x12 | ~x13 | ~x15 | ~x16 | x17);
  assign new_n49_ = x14 & x15 & x16 & x11 & x13;
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x14 | ((~new_n52_ | ~new_n53_) & (x12 | ~x18))) & (~x12 | new_n54_ | ~x18);
