...
module FAU ( 
  ...
  assign new_n35_ = x09 & ~x10 & (x12 ? (x11 ? ~x13 : (x13 & ~x16)) : x13);
  assign z4 = (x12 & (new_n37_ | x16)) | (new_n38_ & ~x08) | (x03 & x08);
  ...
  assign new_n40_ = (~x15 | (x12 & (x16 | (x11 & x13 & x14)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15 | x16);
  assign z6 = (x05 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n42_ & ~x10);
  assign new_n42_ = (x12 | ~x16) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
