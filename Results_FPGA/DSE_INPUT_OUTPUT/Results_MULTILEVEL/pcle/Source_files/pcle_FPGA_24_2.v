...
module FAU ( 
  ...
  assign z7 = (x06 & x08 & (~x07 | (x07 & x12))) | (~x12 & (new_n53_ | x07)) | (new_n49_ & ~x08);
  assign new_n49_ = x09 & ~x10 & (new_n51_ | (new_n50_ & new_n52_));
  assign new_n50_ = x11 & x12 & x13;
  assign new_n51_ = x17 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign new_n52_ = x14 & x15 & x16 & ~x17;
  assign new_n53_ = ~x08 & x09 & ~x10 & x17;
  assign z8 = new_n58_ | (~x08 & x09 & ~x10 & (new_n55_ | new_n57_));
  assign new_n55_ = x12 & ((x18 & (~new_n56_ | ~x15 | ~x16 | ~x17)) | (new_n56_ & x17 & ~x18 & x15 & x16));
