...
module FAU ( 
  ...
  assign z8 = (x11 & (new_n47_ | ~x09)) | (x07 & x08) | (~x08 & new_n48_ & x09);
  assign new_n47_ = new_n32_ & x14 & x15 & x16 & x17 & ~x18;
  assign new_n48_ = ~x10 & x18 & (~new_n45_ | ~new_n49_);
  assign new_n49_ = x16 & x17 & x14 & x15;
endmodule
