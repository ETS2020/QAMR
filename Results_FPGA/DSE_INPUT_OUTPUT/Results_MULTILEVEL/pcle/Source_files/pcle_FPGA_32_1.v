...
module FAU ( 
  ...
  assign new_n42_ = (x11 | ~x15) & (~x02 | ((x14 | ~x15) & (~x11 | ~x14 | ((~x15 | (x12 & x13)) & (~x12 | ~x13 | x15)))));
  assign z6 = ~new_n46_ | (~new_n44_ & x11);
  assign new_n44_ = x02 & (~new_n45_ | ~x15 | x16 | ~x13 | ~x14);
  assign new_n45_ = ~x08 & x09 & ~x10 & x12;
  assign new_n46_ = x08 ? ~x05 : (~x09 | x10 | new_n47_ | ~x16);
  assign new_n47_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = (new_n35_ & x06) | (~x08 & new_n49_ & x09);
  ...
  assign z8 = (new_n35_ & x07) | (~x08 & x09 & ~new_n55_ & ~x10);
  assign new_n55_ = (x11 | ~x18) & (~x02 | ((~new_n57_ | ~new_n58_) & (new_n56_ | ~x18)));
