...
module FAU ( 
  ...
  assign new_n40_ = (~x15 | (x12 & (x18 | (x11 & x13 & x14)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15 | x18);
  assign z6 = ~new_n42_ | (x12 & (x18 | (new_n44_ & new_n45_)));
  assign new_n42_ = x08 ? ~x05 : (~x09 | ~new_n43_ | x10);
  ...
  assign new_n47_ = (~x17 | (x12 & (new_n49_ | x18))) & (~new_n50_ | ~new_n48_ | x17 | x18);
  ...
  assign new_n52_ = (x12 | ~x18) & (~new_n50_ | ~new_n48_ | ~x17 | x18);
  assign z0 = 1'b0;
endmodule
