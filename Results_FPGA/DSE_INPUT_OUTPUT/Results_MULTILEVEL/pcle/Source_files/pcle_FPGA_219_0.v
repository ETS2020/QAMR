...
module FAU ( 
  ...
  assign new_n41_ = ~x10 & (x12 ? ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14)) : (x14 & x16));
  assign z5 = new_n43_ | (x04 & x08) | (~x08 & new_n44_ & x09);
  assign new_n43_ = ~x12 & (~x16 | (~x08 & x09 & ~x10 & x15));
  assign new_n44_ = ~x10 & ((x12 & x14 & ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15))) | (~x14 & x15));
  assign z6 = new_n46_ | (x05 & x08) | (~x08 & new_n47_ & x09);
  ...
  assign new_n49_ = (~x12 | ((x16 | ~x17) & (~new_n50_ | ~x15 | ~x16 | x17))) & (~x16 | new_n51_ | ~x17);
  assign new_n50_ = x11 & x13 & x14;
  assign new_n51_ = x11 & x12 & x13 & x14 & x15;
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n53_ & ~x10);
  assign new_n53_ = (~x12 | ((x16 | ~x18) & (~new_n50_ | ~new_n54_))) & (~x16 | new_n55_ | ~x18);
  assign new_n54_ = x15 & x16 & x17 & ~x18;
  assign new_n55_ = x11 & x12 & x13 & x14 & x15 & x17;
endmodule
