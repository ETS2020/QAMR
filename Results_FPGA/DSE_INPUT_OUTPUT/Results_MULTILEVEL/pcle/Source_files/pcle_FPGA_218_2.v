...
module FAU ( 
  ...
  assign new_n38_ = x09 & ~x10 & ((x12 & (x11 ^ x13)) | (~x06 & ~x12 & x13));
  assign z4 = new_n40_ | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n40_ = ~x12 & (x06 | (~x10 & x14 & ~x08 & x09));
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = new_n43_ | (x04 & x08) | (~x08 & new_n44_ & x09);
  assign new_n43_ = ~x12 & (x06 | (~x10 & x15 & ~x08 & x09));
  assign new_n44_ = ~x10 & (x14 ? ((x15 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x15)) : x15);
  assign z6 = (x05 & ~new_n31_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x12) | (~x06 & ~x12 & x16));
  assign new_n47_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x11 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & (x08 | ~x12)) | (~x08 & new_n49_ & x09);
  assign new_n49_ = ~x10 & ((x17 & (~new_n50_ | ~x14 | ~x15 | ~x16)) | (new_n50_ & x14 & x15 & x16 & ~x17));
  ...
  assign new_n55_ = ~x12 & (x06 | (~x10 & x18 & ~x08 & x09));
endmodule
