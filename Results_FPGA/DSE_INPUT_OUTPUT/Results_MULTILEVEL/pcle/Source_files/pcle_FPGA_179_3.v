...
module FAU ( 
  ...
  assign z5 = (x12 & (new_n41_ | x10)) | (new_n39_ & ~x08) | (x04 & x08);
  assign new_n39_ = x09 & ~x10 & x15 & (~x14 | (~new_n40_ & x14));
  assign new_n40_ = x11 & x12 & x13;
  assign new_n41_ = ~x08 & x09 & x11 & x13 & x14 & ~x15;
  assign z6 = (~new_n43_ & x12) | (x05 & x08) | (~x08 & new_n45_ & x09);
  assign new_n43_ = ~x10 & (~new_n44_ | x08 | ~x09 | ~x11);
  assign new_n44_ = x13 & x14 & x15 & ~x16;
  assign new_n45_ = ~x10 & x16 & (~x11 | ~x12 | ~new_n46_ | ~x13);
  assign new_n46_ = x14 & x15;
  assign z7 = (~new_n48_ & x12) | (x06 & x08) | (~x08 & new_n50_ & x09);
  assign new_n48_ = ~x10 & (~new_n49_ | ~new_n46_ | ~x16 | x17);
  assign new_n49_ = ~x08 & x09 & x11 & x13;
  assign new_n50_ = ~x10 & x17 & (~new_n40_ | ~x14 | ~x15 | ~x16);
  assign z8 = (~new_n52_ & x12) | (x07 & x08) | (~x08 & new_n53_ & x09);
  assign new_n52_ = ~x10 & (~new_n49_ | ~new_n46_ | ~x16 | ~x17 | x18);
