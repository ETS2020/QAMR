...
module FAU ( 
  ...
  assign z3 = (x02 & x08) | (new_n38_ & x09);
  ...
  assign new_n48_ = x09 & ~x10 & ((~new_n49_ & x02) | (~x12 & x16));
  assign new_n49_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & ~new_n34_ & x08) | (~x08 & new_n51_ & x09);
  assign new_n51_ = ~x10 & (new_n54_ | (x02 & (new_n52_ | (new_n41_ & new_n53_))));
  ...
  assign new_n56_ = (x12 | ~x18) & (~x02 | ((~new_n58_ | ~new_n59_) & (new_n57_ | ~x18)));
