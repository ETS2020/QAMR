...
module FAU ( 
  ...
  assign new_n38_ = x18 & (x08 | ~x09 | x10 | ~x11 | x13);
  assign new_n39_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (new_n42_ & ~x08) | (x03 & x08) | (x12 & (new_n41_ | ~x18));
  ...
  assign new_n44_ = (~x15 | (x12 & (~x18 | (x11 & x13 & x14)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15 | ~x18);
  ...
  assign z7 = (x06 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (~x17 | (~new_n51_ & x12)) & (~new_n52_ | ~new_n50_ | ~x11 | ~x12);
