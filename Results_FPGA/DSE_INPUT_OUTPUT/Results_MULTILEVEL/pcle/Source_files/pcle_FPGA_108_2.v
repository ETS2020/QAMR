...
module FAU ( 
  ...
  assign new_n41_ = ~x10 & ((x11 & x12 & ((x13 & ~x14 & x15) | (x14 & ~x15))) | (x15 & (~x11 | ~x12)));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x13 | ((~x16 | (x11 & x14 & x15)) & (~x11 | ~x12 | ~x14 | ~x15 | x16))) & (x12 | ~x16);
  assign z7 = ~new_n47_ | (~new_n45_ & x12);
  assign new_n45_ = x13 & (~new_n46_ | x08 | ~x09 | x10 | ~x11);
