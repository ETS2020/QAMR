...
module FAU ( 
  ...
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x12) | (~x16 & x17));
  assign new_n46_ = (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17) & (~x17 | (x11 & x13 & x14 & x15));
  assign z8 = (~new_n48_ & x16) | (x07 & x08) | (~x08 & new_n50_ & x09);
  assign new_n48_ = x12 & (~new_n49_ | x10 | ~x11 | x08 | ~x09);
