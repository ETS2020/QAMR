...
module FAU ( 
  ...
  assign z7 = (x06 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~x17 | (new_n49_ & x14 & x15 & x16)) & (~new_n49_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n49_ = x11 & x12 & x13;
  assign z8 = (x07 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x18 | (new_n49_ & new_n53_)) & (~new_n41_ | ~new_n52_ | ~x17 | x18);
