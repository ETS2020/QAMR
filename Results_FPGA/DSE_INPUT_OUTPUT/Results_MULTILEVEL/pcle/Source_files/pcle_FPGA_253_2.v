...
module FAU ( 
  ...
  assign new_n38_ = x15 & (x08 | ~x09 | x10 | ~x11 | x13);
  assign new_n39_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (x03 & ~new_n34_ & x08) | (~x08 & new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x14 & (~x12 | (x15 & (~x11 | ~x13)))) | (x11 & x12 & x13 & ~x14 & x15));
  assign z5 = (~x08 & new_n43_ & x09) | new_n34_ | (x04 & x08);
  assign new_n43_ = ~x10 & x15 & (~x14 | (x14 & (~x11 | ~x12 | ~x13)));
  assign z6 = (x05 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (~x15 | ((~x16 | (x11 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x16))) & (x12 | ~x16);
  assign z7 = (x06 & ~new_n34_ & x08) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & ((~new_n48_ & x15) | (~x12 & x17));
  assign new_n48_ = (~x17 | (x14 & x16 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x16 | x17);
  assign z8 = (~new_n50_ & x12) | (x07 & x08) | (~x08 & new_n52_ & x09);
  assign new_n50_ = (~new_n51_ | x08 | ~x09 | x10 | ~x11) & x15;
  assign new_n51_ = x13 & x14 & x16 & x17 & ~x18;
  assign new_n52_ = ~x10 & ~new_n53_ & x18;
  assign new_n53_ = x11 & x12 & x13 & x14 & x16 & x17;
endmodule
