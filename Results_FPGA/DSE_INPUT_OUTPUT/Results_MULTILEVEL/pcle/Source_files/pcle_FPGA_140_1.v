...
module FAU ( 
  ...
  assign z5 = (x08 & (x04 | x11)) | (x11 & (new_n45_ | ~x04)) | (~x08 & new_n43_ & x09);
  assign new_n43_ = ~x10 & ~new_n44_ & x15;
  assign new_n44_ = x11 & x12 & x13 & x14;
  assign new_n45_ = x09 & ~x10 & x12 & x13 & x14 & ~x15;
  assign z6 = ~new_n49_ | (~new_n47_ & x11);
  assign new_n47_ = x04 & (~new_n48_ | ~x13 | ~x14 | ~x15 | x16);
  assign new_n48_ = ~x10 & x12 & ~x08 & x09;
  assign new_n49_ = x08 ? ~x05 : (~x09 | x10 | new_n50_ | ~x16);
  assign new_n50_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = ~new_n53_ | (x11 & (new_n52_ | ~x04));
  assign new_n52_ = new_n48_ & x15 & x16 & ~x17 & x13 & x14;
  assign new_n53_ = x08 ? ~x06 : (~x09 | x10 | new_n54_ | ~x17);
  assign new_n54_ = x11 & x12 & x13 & x14 & x15 & x16;
  assign z8 = (x07 & ~new_n35_ & x08) | (~x08 & x09 & ~new_n56_ & ~x10);
  assign new_n56_ = (~x04 | ((new_n57_ | ~x18) & (~new_n44_ | ~new_n58_))) & (x11 | ~x18);
