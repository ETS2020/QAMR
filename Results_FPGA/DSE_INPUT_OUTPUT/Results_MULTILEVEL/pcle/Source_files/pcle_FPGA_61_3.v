...
module FAU ( 
  ...
  assign z5 = ~z0 & (x08 ? x04 : (new_n39_ & x09));
  ...
  assign z7 = (x06 & x08) | (~x08 & new_n45_ & x09) | (~new_n43_ & x16);
  assign new_n43_ = ~x18 & (~new_n44_ | x08 | ~x09 | x10 | ~x11);
  assign new_n44_ = x12 & x13 & x14 & x15 & ~x17;
  assign new_n45_ = ~x10 & x17 & (~new_n46_ | ~x11 | ~x12 | ~x13);
  assign new_n46_ = x14 & x15 & x16 & ~x18;
  assign z8 = (x07 & ~z0 & x08) | (~x08 & new_n48_ & x09);
  assign new_n48_ = ~x10 & ((~x16 & x18) | (new_n49_ & x15 & x16 & x17 & ~x18));
