// Benchmark "FAU" written by ABC on Tue Aug 18 17:00:58 2020
...
module FAU ( 
  ...
  assign new_n36_ = x09 & ~x10 & (x11 ? (~x12 & x18) : x12);
  assign z3 = new_n38_ | (new_n39_ & ~x08) | (x02 & x08);
  assign new_n38_ = ~x12 & (~x18 | (~x08 & x09 & ~x10 & x13));
  assign new_n39_ = x09 & ~x10 & (x11 ? (x12 & ~x13) : x13);
  assign z4 = new_n41_ | (new_n42_ & ~x08) | (x03 & x08);
  assign new_n41_ = ~x12 & (~x18 | (~x08 & x09 & ~x10 & x14));
  assign new_n42_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = x12 ? (x14 ? ((~x15 | (x11 & x13)) & (~x11 | ~x13 | x15)) : ~x15) : (~x15 | ~x18);
  assign z6 = (x05 & ~new_n31_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & (x12 ? ~new_n47_ : (x16 & x18));
  assign new_n47_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x14 | ~x15 | x16 | ~x11 | ~x13);
  assign z7 = (x06 & ~new_n31_ & x08) | (new_n49_ & ~x08);
  assign new_n49_ = x09 & ~x10 & (x12 ? ~new_n50_ : (x17 & x18));
  assign new_n50_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & new_n52_ & x09);
