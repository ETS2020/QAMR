...
module FAU ( 
  ...
  assign z3 = (~new_n37_ & ~x05) | (new_n38_ & ~x08) | (x02 & x08);
  assign new_n37_ = x12 & (x08 | ~x09 | x10 | ~x11 | x13);
  ...
  assign new_n43_ = ~x12 & (~x05 | (~x08 & x09 & ~x10 & x15));
  assign new_n44_ = ~x10 & (x14 ? ((x15 & (~x11 | ~x13)) | (x13 & ~x15 & x11 & x12)) : x15);
  assign z6 = (x08 & (x05 | ~x12)) | (~x12 & (~x05 | (new_n49_ & x09))) | (~x08 & new_n46_ & x09);
  assign new_n46_ = ~x10 & ((x16 & (~new_n47_ | ~x14 | ~x15)) | (new_n48_ & x14 & x15 & ~x16));
  ...
  assign new_n52_ = ~x12 & (~x05 | (~x08 & x09 & ~x10 & x17));
  ...
  assign new_n57_ = ~x12 & (~x05 | (~x08 & x09 & ~x10 & x18));
endmodule
