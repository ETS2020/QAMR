...
module FAU ( 
  ...
  assign z1 = ~new_n33_ | (~x12 & ~x16);
  assign new_n33_ = (~x00 | ~x08) & (x08 | ~x09 | x10 | x11);
  assign z2 = (x01 & x08 & (x12 | x16)) | (new_n35_ & ~x08);
  assign new_n35_ = x09 & ~x10 & (x11 ? (~x12 & x16) : x12);
  assign z3 = (x02 & x08 & (x12 | x16)) | (new_n37_ & ~x08);
  assign new_n37_ = x09 & ~x10 & (x12 ? (x11 ^ x13) : (x13 & x16));
  assign z4 = (x03 & x08 & (x12 | x16)) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & (x12 ? ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14)) : (x14 & x16));
  assign z5 = new_n41_ | (~x08 & new_n42_ & x09) | (x04 & x08);
  assign new_n41_ = ~x12 & (~x16 | (~x08 & x09 & ~x10 & x15));
  assign new_n42_ = ~x10 & ((x12 & x14 & ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15))) | (~x14 & x15));
  assign z6 = new_n46_ | (x05 & x08) | (~x08 & new_n44_ & x09);
  assign new_n44_ = ~x10 & ((x16 & (~new_n45_ | ~x14 | ~x15)) | (new_n45_ & x14 & x15 & ~x16));
  assign new_n45_ = x11 & x13;
  assign new_n46_ = ~x12 & (~x16 | (~x08 & x09 & ~x10));
  ...
  assign new_n55_ = ~x12 & (~x16 | (~x08 & x09 & ~x10 & x18));
endmodule
