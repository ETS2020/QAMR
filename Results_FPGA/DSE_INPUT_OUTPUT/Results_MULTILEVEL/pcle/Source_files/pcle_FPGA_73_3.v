...
module FAU ( 
  ...
  assign z5 = ~new_n31_ & (x08 ? x04 : (new_n39_ & x09));
  ...
  assign z7 = (~x08 & new_n43_ & x09) | new_n31_ | (x06 & x08);
  assign new_n43_ = ~x10 & ((x17 & (~new_n44_ | ~x14 | ~x15 | ~x16)) | (new_n44_ & x14 & x15 & x16 & ~x17));
  assign new_n44_ = x11 & x12 & x13;
  assign z8 = (~x08 & new_n46_ & x09) | (x07 & ~new_n31_ & x08);
  assign new_n46_ = ~x10 & ((new_n47_ & x15 & x16 & x17 & ~x18) | (~x17 & x18));
