...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & (x11 ? (x12 ? (~x13 & ~x16) : x13) : x13);
  assign z4 = (x03 & ~new_n33_ & x08) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & (x13 ? ((x14 & (~x11 | ~x12)) | (x11 & x12 & ~x14)) : (x14 & ~x16));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n41_ & ~x10);
  assign new_n41_ = x13 ? (x14 ? ((~x15 | (x11 & x12)) & (~x11 | ~x12 | x15)) : ~x15) : (~x15 | x16);
  assign z6 = (~x08 & x09 & ~new_n43_ & ~x10) | new_n33_ | (x05 & x08);
  assign new_n43_ = (~x16 | (x11 & x12 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n45_ & ~x08);
  assign new_n45_ = x09 & ~x10 & ((~x16 & x17) | (~new_n46_ & x13));
  assign new_n46_ = (~x11 | ~x12 | ~x14 | ~x15 | ~x16 | x17) & (~x17 | (x11 & x12 & x14 & x15));
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (x16 | ~x18) & (~x13 | ((new_n50_ | ~x18) & (~new_n49_ | ~new_n51_)));
  assign new_n49_ = x11 & x12 & x14;
  assign new_n50_ = x11 & x12 & x14 & x15 & x17;
