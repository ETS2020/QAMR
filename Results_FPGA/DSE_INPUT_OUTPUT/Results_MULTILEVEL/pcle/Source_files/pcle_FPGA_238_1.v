...
module FAU ( 
  ...
  assign z4 = (x03 & x08 & (x12 | ~x14)) | (new_n41_ & ~x08);
  assign new_n41_ = x09 & ~x10 & x12 & ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14));
  assign z5 = (~x08 & new_n43_ & x09) | (x04 & x08) | (~x12 & x14);
  assign new_n43_ = ~x10 & (x14 ? ((x12 & x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15)) : x15);
  assign z6 = (new_n47_ & ~x08) | (x05 & x08) | (x14 & (new_n45_ | ~x12));
  ...
  assign new_n49_ = x12 & (~new_n32_ | ~x13 | ~x15 | ~x16 | x17);
  assign new_n50_ = ~x10 & x17 & (~new_n46_ | ~x14 | ~x15 | ~x16);
  assign z8 = (~x08 & new_n52_ & x09) | (x07 & x08 & (x12 | ~x14));
