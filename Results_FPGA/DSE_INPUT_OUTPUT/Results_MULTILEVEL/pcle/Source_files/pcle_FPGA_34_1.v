...
module FAU ( 
  ...
  assign z4 = (x11 & (new_n41_ | ~x07)) | (new_n39_ & ~x08) | (x03 & x08);
  ...
  assign new_n44_ = (x11 | ~x15) & (~x07 | ((~x15 | (x12 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x15)));
  assign z6 = (~new_n46_ & x11) | (x05 & x08) | (~x08 & new_n48_ & x09);
  assign new_n46_ = x07 & (~new_n47_ | ~x15 | x16 | ~x13 | ~x14);
  ...
  assign new_n51_ = x07 & (~new_n47_ | ~new_n52_);
  assign new_n52_ = x13 & x14 & x15 & x16 & ~x17;
  assign new_n53_ = ~x10 & x17 & (~new_n40_ | ~x14 | ~x15 | ~x16);
  assign z8 = (x08 & (x07 | x11)) | (~x08 & new_n57_ & x09) | (x11 & (new_n55_ | ~x07));
  assign new_n55_ = new_n56_ & x12 & x13 & x09 & ~x10;
  assign new_n56_ = x14 & x15 & x16 & x17 & ~x18;
  assign new_n57_ = ~x10 & x18 & (~new_n40_ | ~new_n49_ | ~x16 | ~x17);
endmodule
