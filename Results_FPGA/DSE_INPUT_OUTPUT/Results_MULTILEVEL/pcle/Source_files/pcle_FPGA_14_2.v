...
module FAU ( 
  ...
  assign z2 = (x01 & x08 & (~x02 | (x02 & x12))) | (x02 & ~x12) | (new_n35_ & ~x08);
  ...
  assign z8 = (~new_n33_ & (x08 ? x07 : (new_n53_ & x09))) | (~x08 & new_n55_ & x09);
  assign new_n53_ = ~x10 & ~new_n54_ & x18;
  assign new_n54_ = x11 & x13 & x14 & x15 & x16 & x17;
  assign new_n55_ = ~x10 & ((new_n56_ & new_n57_) | (~x02 & ~x12 & x18));
