...
module FAU ( 
  ...
  assign new_n35_ = x09 & ~x10 & (~x13 | (x13 & x14)) & (x11 ^ x12);
  assign z3 = (x02 & ~new_n33_ & x08) | (new_n37_ & ~x08);
  assign new_n37_ = x09 & ~x10 & (x11 ? (x12 ? ~x13 : (x13 & x14)) : (x13 & x14));
  assign z4 = (x03 & ~new_n33_ & x08) | (new_n39_ & ~x08);
  assign new_n39_ = x09 & ~x10 & ~new_n40_ & x14;
  assign new_n40_ = x11 & x12 & x13;
  assign z5 = new_n42_ | (~x08 & new_n43_ & x09) | (x04 & x08);
  assign new_n42_ = ~x14 & (x13 | (~x08 & x09 & ~x10 & x15));
  assign new_n43_ = ~x10 & (x13 ? ((x14 & x15 & (~x11 | ~x12)) | (x11 & x12 & ~x15)) : (x14 & x15));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (x13 | ~x16) & (~x14 | ((~x16 | (x11 & x12 & x15)) & (~x11 | ~x12 | ~x13 | ~x15 | x16)));
  assign z7 = ~new_n49_ | (~new_n47_ & x13);
  assign new_n47_ = x14 & (~new_n48_ | x08 | ~x09 | x10 | ~x11);
  assign new_n48_ = x12 & x15 & x16 & ~x17;
  assign new_n49_ = x08 ? ~x06 : (~x09 | x10 | new_n50_ | ~x17);
  assign new_n50_ = x11 & x12 & x13 & x15 & x16;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & new_n52_ & x09);
  assign new_n52_ = ~x10 & (new_n55_ | (x14 & (new_n53_ | (new_n40_ & new_n54_))));
  assign new_n53_ = x18 & (~x11 | ~x12 | ~x15 | ~x16 | ~x17);
