...
module FAU ( 
  ...
  assign new_n43_ = (x03 | ((~x15 | (x11 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x15))) & (x12 | ~x15);
  assign z6 = new_n45_ | (x05 & x08) | (~x08 & x09 & new_n48_ & ~x10);
  assign new_n45_ = x12 & (x03 | (new_n47_ & new_n46_ & x15 & ~x16));
