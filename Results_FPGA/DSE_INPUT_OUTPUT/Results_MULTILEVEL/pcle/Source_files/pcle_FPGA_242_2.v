...
module FAU ( 
  ...
  assign z6 = (~new_n43_ & x14) | (x05 & x08) | (~x08 & new_n45_ & x09);
  assign new_n43_ = x18 & (~new_n44_ | x10 | ~x11 | x08 | ~x09);
  assign new_n44_ = x12 & x13 & x15 & ~x16;
  assign new_n45_ = ~x10 & x16 & (~new_n46_ | ~x13 | ~x14 | ~x15);
  assign new_n46_ = x11 & x12;
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~x17 | (x14 & (~x18 | (new_n46_ & new_n49_ & x13)))) & (~new_n46_ | ~x13 | ~x14 | ~new_n49_ | x17 | ~x18);
  assign new_n49_ = x15 & x16;
  assign z8 = (~x08 & x09 & new_n51_ & ~x10) | new_n33_ | (x07 & x08);
