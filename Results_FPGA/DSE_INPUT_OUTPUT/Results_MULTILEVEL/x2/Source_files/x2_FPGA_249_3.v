...
module FAU ( 
  ...
  assign z0 = x9 | ~x7 | ~x8;
  assign z1 = (x9 & (x0 | ~x7)) | x8 | (x7 & ~x9);
  assign z2 = (x0 & x9) | (~x7 & ~x8 & ~x9);
  assign z3 = (x7 & (~x0 | ~x9)) | (~x0 & ((x9 & (~x7 | x8)) | (~x7 & (x1 | x2 | ~x8)))) | (x0 & ~x7 & ~x9);
  assign z4 = (~x6 & x7 & (~x0 | ~x9)) | (x0 & ~x7 & ~x9) | (~x0 & (~x7 | (x8 & x9)));
  assign z5 = (~x0 & (new_n25_ | new_n26_ | ~x6)) | (~x9 & (~new_n27_ | ~x6));
