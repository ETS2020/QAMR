...
module FAU ( 
  ...
  assign z4 = (x9 & (x0 | x8)) | ~x7 | (~x6 & x7);
  assign z5 = new_n25_ | new_n26_ | ~new_n27_ | (~x6 & (x7 | ~x9));
  assign new_n25_ = ~x0 & (~x6 | (x5 & ~x7 & x8 & x9));
  assign new_n26_ = ~x1 & x2 & (x7 ? (x8 & x9) : ~x8);
  assign new_n27_ = x9 ? ~x0 : (x8 & (~x3 | x4 | ~x7));
  assign z6 = new_n29_ | (~new_n30_ & ~x7) | (x7 & (new_n31_ | new_n32_));
  assign new_n29_ = ~x6 & (~x0 | ~x9);
  assign new_n30_ = (x8 | x9) & (~x8 | ~x9 | x0 | ~x5);
