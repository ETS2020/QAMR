...
module FAU ( 
  ...
  assign z0 = ~x8 | x9 | ~x6 | ~x7;
  assign z1 = x8 ? x6 : (x7 ^ x9);
  assign z2 = (~x6 & x8) | (~x7 & ~x8 & ~x9);
  assign z3 = (~x8 & (~x6 | ~x7)) | (x6 & (((~x7 | x8) & x9) | x7 | (~new_n23_ & ~x7)));
  ...
  assign z6 = (~new_n29_ & ~x7) | ~x6 | (x7 & (new_n30_ | new_n31_));
  assign new_n29_ = (x8 | x9) & (~x5 | ~x6 | ~x8 | ~x9);
