...
module FAU ( 
  ...
  assign new_n232_ = x70 & ~x71 & ((x41 & (new_n152_ | ~x32)) | (x32 & ~new_n152_ & ~x41));
  ...
  assign z10 = ~new_n248_ | (~x65 & ((new_n238_ & x68) | (x64 & new_n251_ & ~x68)));
  assign new_n238_ = ~x69 & (x64 ? (~x70 & ~new_n244_ & ~x71) : new_n239_);
  ...
  assign new_n244_ = (~x42 | (~x66 ^ x67)) & (x66 | x67 | (~new_n245_ & ~new_n246_ & ~new_n247_));
  assign new_n245_ = x58 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n246_ = x72 & ((x50 & x73 & ~x74) | (~x73 & (x74 ? x53 : x54)));
  assign new_n247_ = ~x72 & ((x73 & (x74 ? x55 : x56)) | (x57 & ~x73 & x74));
  assign new_n248_ = (x68 | ~x69) & (x64 | ~x65 | ~x68 | new_n249_ | x69);
  assign new_n249_ = (x66 | ~new_n242_ | x67) & (x70 | (~new_n250_ & (x66 | ~new_n240_ | x67)));
  assign new_n250_ = ~x71 & ~new_n104_ & (new_n245_ | new_n246_ | new_n247_);
