// Benchmark "FAU" written by ABC on Tue Aug 18 06:22:16 2020
...
module FAU ( 
  ...
  assign new_n169_ = ~new_n170_ & (x66 | ~new_n163_ | x67);
  ...
  assign new_n213_ = x71 & ((x00 & ~x08 & (~new_n123_ | ~new_n124_)) | (x08 & (~x00 | (new_n123_ & new_n124_))));
  assign new_n214_ = x70 & ~x71 & ((x32 & ~x40 & (~new_n127_ | ~new_n128_)) | (x40 & (~x32 | (new_n127_ & new_n128_))));
  ...
  assign new_n225_ = x71 & ((x09 & (new_n149_ | ~x00)) | (x00 & ~new_n149_ & ~x09));
  ...
  assign new_n231_ = x70 & ~x71 & ((x41 & (new_n152_ | ~x32)) | (x32 & ~new_n152_ & ~x41));
  ...
  assign z10 = ~new_n247_ | (~x65 & ((new_n237_ & x68) | (x64 & new_n250_ & ~x68)));
  assign new_n237_ = ~x69 & (x64 ? (~x70 & ~new_n243_ & ~x71) : new_n238_);
  assign new_n238_ = ~new_n104_ & (new_n241_ | (new_n239_ & ~x70));
  assign new_n239_ = x71 & ((x10 & (new_n240_ | ~x00)) | (x00 & ~new_n240_ & ~x10));
  assign new_n240_ = ~x11 & ~x12 & ~x13 & ~x14 & ~x15;
  assign new_n241_ = x70 & ~x71 & ((x42 & (new_n242_ | ~x32)) | (x32 & ~new_n242_ & ~x42));
  assign new_n242_ = ~x43 & ~x44 & ~x45 & ~x46 & ~x47;
  assign new_n243_ = (~x42 | (~x66 ^ x67)) & (x66 | x67 | (~new_n244_ & ~new_n245_ & ~new_n246_));
  assign new_n244_ = x58 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n245_ = x72 & ((x50 & x73 & ~x74) | (~x73 & (x74 ? x53 : x54)));
  assign new_n246_ = ~x72 & ((x73 & (x74 ? x55 : x56)) | (x57 & ~x73 & x74));
  assign new_n247_ = (x68 | ~x69) & (x64 | ~x65 | ~x68 | new_n248_ | x69);
  assign new_n248_ = (x66 | ~new_n241_ | x67) & (x70 | (~new_n249_ & (x66 | ~new_n239_ | x67)));
  assign new_n249_ = ~x71 & ~new_n104_ & (new_n244_ | new_n245_ | new_n246_);
  ...
  assign new_n254_ = x71 & ((x11 & (new_n124_ | ~x00)) | (x00 & ~new_n124_ & ~x11));
  assign new_n255_ = x70 & ~x71 & ((x43 & (new_n128_ | ~x32)) | (x32 & ~new_n128_ & ~x43));
  ...
  assign z12 = (~new_n264_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n274_ & ~x69);
  assign new_n264_ = (~new_n265_ | ~x68) & (~x64 | x68 | new_n106_ | new_n273_);
  assign new_n265_ = ~x69 & (x64 ? (~x70 & ~new_n269_ & ~x71) : new_n266_);
  assign new_n266_ = ~new_n104_ & (x70 ? new_n268_ : new_n267_);
  assign new_n267_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  assign new_n268_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n269_ = (~x44 | (~x66 ^ x67)) & (x66 | x67 | (~new_n270_ & ~new_n271_ & ~new_n272_));
  assign new_n270_ = x60 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n271_ = x72 & ((x52 & x73 & ~x74) | (~x73 & (x74 ? x55 : x56)));
  assign new_n272_ = ~x72 & ((x73 & (x74 ? x57 : x58)) | (x59 & ~x73 & x74));
  assign new_n273_ = (~x70 | (x71 ? ~x44 : ~x28)) & (~x12 | x70 | ~x71);
  assign new_n274_ = (x70 | (~new_n275_ & (x66 | ~new_n267_ | x67))) & (x66 | x67 | ~new_n268_ | ~x70);
  assign new_n275_ = ~x71 & ~new_n104_ & (new_n270_ | new_n271_ | new_n272_);
  ...
  assign new_n286_ = x68 & ((~x66 & new_n284_ & ~x67) | (~new_n287_ & ~x70));
