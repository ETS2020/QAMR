// Benchmark "FAU" written by ABC on Tue Aug 18 06:24:06 2020
...
module FAU ( 
  ...
  assign new_n199_ = ~x65 & (x68 ? (new_n203_ & ~x69) : (x69 & (new_n200_ | ~new_n201_)));
  assign new_n200_ = ~new_n106_ & ((x05 & (x66 ^ x67)) | (~x66 & ~new_n190_ & ~x67));
  ...
  assign z06 = (~new_n205_ & ~x64) | new_n186_ | (new_n219_ & x64);
  ...
  assign z08 = (~x64 & (new_n243_ | (new_n256_ & x65))) | new_n186_ | (x64 & ~new_n257_ & ~x65);
  ...
  assign z09 = (~new_n264_ & ~x64) | new_n186_ | (x64 & ~new_n278_ & ~x65);
  ...
  assign z12 = x64 ? (~new_n351_ & ~x65) : ~new_n335_;
  assign new_n335_ = (~x65 | x66 | ~new_n350_ | x67) & ((~x66 & ~x67) | (~new_n336_ & ~new_n346_));
  assign new_n336_ = ~x70 & ((x68 & ~new_n337_ & ~x69) | (x65 & ~x68 & new_n342_ & x69));
  assign new_n337_ = x65 ? (x71 | (~new_n339_ & ~new_n340_ & ~new_n341_)) : ~new_n338_;
  assign new_n338_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  ...
  assign new_n343_ = x28 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n347_ = ~new_n348_ & (~x71 | (~new_n340_ & ~new_n341_)) & (x71 | (~new_n344_ & ~new_n345_));
  assign new_n348_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n349_ = ~x71 & ((x44 & (new_n300_ | ~x32)) | (x32 & ~new_n300_ & ~x44));
  assign new_n350_ = x68 & ~x69 & (x70 ? new_n349_ : new_n338_);
  assign new_n351_ = x68 ? (~new_n358_ | x69) : (~x69 | (~new_n352_ & new_n354_));
  assign new_n352_ = ~new_n106_ & ((x12 & (x66 ^ x67)) | (~x66 & ~x67 & (~new_n353_ | new_n343_)));
  assign new_n353_ = ~new_n344_ & ~new_n345_;
  assign new_n354_ = ~new_n356_ & (x66 | (~new_n355_ & (~new_n357_ | ~x12 | ~x60)));
  assign new_n355_ = ~x67 & x70 & x71 & (new_n339_ | new_n340_ | new_n341_);
  assign new_n356_ = (x66 ^ x67) & ((x44 & x70 & x71) | (x60 & ~x70 & ~x71));
  assign new_n357_ = x67 & ~x70;
  assign new_n358_ = ~x70 & ~x71 & ((~x66 & ~new_n359_ & ~x67) | (x44 & (x66 ^ x67)));
  assign new_n359_ = ~new_n339_ & ~new_n340_ & ~new_n341_;
  assign z13 = x64 ? (~new_n377_ & ~x65) : ~new_n361_;
  assign new_n361_ = (~x65 | x66 | ~new_n376_ | x67) & ((~x66 & ~x67) | (~new_n362_ & ~new_n372_));
  ...
  assign new_n364_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  ...
  assign new_n377_ = x68 ? (~new_n383_ | x69) : (~x69 | (~new_n378_ & new_n380_));
  assign new_n378_ = ~new_n106_ & ((x13 & (x66 ^ x67)) | (~x66 & ~x67 & (~new_n379_ | new_n369_)));
  assign new_n379_ = ~new_n370_ & ~new_n371_;
  assign new_n380_ = ~new_n382_ & (x66 | (~new_n381_ & (~new_n357_ | ~x13 | ~x61)));
  assign new_n381_ = ~x67 & x70 & x71 & (new_n365_ | new_n366_ | new_n367_);
  assign new_n382_ = (x66 ^ x67) & ((x45 & x70 & x71) | (x61 & ~x70 & ~x71));
  assign new_n383_ = ~x70 & ~x71 & ((~x66 & ~new_n384_ & ~x67) | (x45 & (x66 ^ x67)));
  assign new_n384_ = ~new_n365_ & ~new_n366_ & ~new_n367_;
  assign z14 = (~new_n386_ & ~x64) | new_n186_ | (new_n400_ & x64);
  assign new_n386_ = (~new_n399_ | ~x65) & (new_n110_ | (x70 ? new_n395_ : new_n387_));
  assign new_n387_ = (~new_n391_ | ~x65) & (x69 | (x65 ? (new_n388_ | x71) : ~new_n394_));
  assign new_n388_ = (new_n208_ | ~x62) & (new_n389_ | ~x72) & (new_n390_ | x72);
  assign new_n389_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n390_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n391_ = ~x68 & x71 & (new_n392_ | new_n393_ | (~new_n208_ & x30));
  assign new_n392_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n393_ = ~x72 & ((x73 & (x74 ? x27 : x28)) | (x29 & ~x73 & x74));
  assign new_n394_ = x71 & ((x14 & (~x00 | ~x15)) | (x00 & ~x14 & x15));
  assign new_n395_ = x65 ? (x68 | (~new_n396_ & new_n397_)) : (~new_n398_ | x69);
  assign new_n396_ = ~new_n208_ & (x71 ? x62 : x30);
  assign new_n397_ = x71 ? (x72 ? new_n389_ : new_n390_) : (~new_n392_ & ~new_n393_);
  assign new_n398_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n399_ = ~x66 & ~x67 & ~x69 & (x70 ? new_n398_ : new_n394_);
  assign new_n400_ = ~x65 & ((new_n405_ & ~x69) | (~x68 & (new_n401_ | ~new_n403_)));
  assign new_n401_ = ~new_n106_ & ((x14 & (x66 ^ x67)) | (~x66 & ~new_n402_ & ~x67));
  assign new_n402_ = ~new_n392_ & ~new_n393_ & (new_n208_ | ~x30);
  assign new_n403_ = (new_n404_ | (~x66 ^ x67)) & (x66 | x67 | ~x70 | new_n388_ | ~x71);
  assign new_n404_ = (~x62 | x70 | x71) & (~x46 | ~x70 | ~x71);
  assign new_n405_ = ~x70 & ~x71 & ((~x66 & ~new_n388_ & ~x67) | (x46 & (x66 ^ x67)));
  assign z15 = x68 ? (~new_n418_ & ~x69) : (x69 & (x64 ? new_n407_ : new_n417_));
  assign new_n407_ = ~x65 & (new_n408_ | (~x66 & new_n412_ & ~x67) | (~new_n416_ & (x66 ^ x67)));
  assign new_n408_ = ~new_n106_ & ((x15 & (x66 ^ x67)) | (~x66 & ~new_n409_ & ~x67));
  assign new_n409_ = (new_n208_ | ~x31) & (new_n410_ | ~x72) & (new_n411_ | x72);
  ...
  assign new_n413_ = (new_n208_ | ~x63) & (new_n414_ | ~x72) & (new_n415_ | x72);
  assign new_n414_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n415_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n416_ = (~x63 | x70 | x71) & (~x47 | ~x70 | ~x71);
  assign new_n417_ = x65 & ~new_n110_ & (new_n412_ | (~new_n409_ & ~new_n106_));
  assign new_n418_ = x64 ? (~new_n420_ | x65) : ((new_n419_ | new_n110_) & (~new_n421_ | ~x65));
  assign new_n419_ = (x70 | ((~x65 | new_n413_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n420_ = ~x70 & ~x71 & ((~x66 & ~new_n413_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n421_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
endmodule
