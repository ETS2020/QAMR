// Benchmark "FAU" written by ABC on Tue Aug 18 06:23:07 2020
...
module FAU ( 
  ...
  assign z00 = x64 ? new_n106_ : (new_n113_ | (~x61 & new_n94_ & x68));
  ...
  assign new_n107_ = (x61 | ((new_n108_ | ~x32) & (new_n109_ | x68))) & (~new_n110_ | x68);
  ...
  assign new_n111_ = (x68 | new_n112_ | ~x69) & (~x48 | x61 | ~x68 | ~new_n105_ | x69);
  assign new_n112_ = (~x16 | (~x70 ^ x71)) & (~x48 | ~x70 | ~x71);
  assign new_n113_ = x65 & ~x68 & x69 & ~new_n114_ & ~new_n112_;
  assign new_n114_ = ~x66 & ~x67;
  assign z01 = x64 ? new_n133_ : ((~new_n116_ & ~new_n114_) | (new_n131_ & ~x61));
  assign new_n116_ = (x61 | ~x68 | new_n117_ | x69) & (~x65 | x68 | new_n129_ | ~x69);
  ...
  assign new_n135_ = (x68 | new_n130_ | ~x69) & (~x49 | x61 | ~x68 | ~new_n105_ | x69);
  assign new_n136_ = (x61 | ((new_n108_ | ~x33) & (new_n137_ | x68))) & (~new_n138_ | x68);
  assign new_n137_ = (~x01 | x70 | ~x71) & (~x17 | x69 | ~x70 | x71);
  assign new_n138_ = x69 & ((x01 & (x70 ^ x71)) | (x33 & x70 & x71) | (x49 & ~x70 & ~x71));
  assign z02 = x64 ? new_n151_ : ((~new_n140_ & ~new_n114_) | (new_n149_ & ~x61));
  assign new_n140_ = (x61 | ~x68 | new_n141_ | x69) & (~x65 | x68 | new_n147_ | ~x69);
  ...
  assign new_n151_ = ~x65 & ((~new_n152_ & ~x68) | (~x61 & x68 & new_n159_ & ~x69));
  assign new_n152_ = (~x69 | (~new_n153_ & new_n155_)) & (x61 | new_n157_ | new_n158_);
  ...
  assign z03 = x64 ? new_n177_ : ((~new_n161_ & ~new_n114_) | (new_n175_ & ~x61));
  assign new_n161_ = (x61 | ~x68 | new_n162_ | x69) & (~x65 | x68 | new_n172_ | ~x69);
  ...
  assign new_n177_ = ~x65 & ((~new_n178_ & ~x68) | (~x61 & x68 & new_n184_ & ~x69));
  assign new_n178_ = ~new_n182_ & (~x69 | (~new_n179_ & ~new_n180_ & (~new_n181_ | x66)));
  assign new_n179_ = ~new_n154_ & ((x03 & (x66 ^ x67)) | (~x66 & ~x67 & (new_n173_ | ~new_n174_)));
  assign new_n180_ = ~new_n157_ & ((x35 & x70 & x71) | (x51 & ~x70 & ~x71));
  assign new_n181_ = ~x67 & x70 & x71 & (~new_n171_ | (~new_n170_ & x51));
  assign new_n182_ = ~x61 & ~new_n157_ & ~new_n183_;
  assign new_n183_ = (~x70 | ((~x35 | ~x71) & (~x19 | x69 | x71))) & (~x03 | x70 | ~x71);
  assign new_n184_ = ~x70 & ~x71 & ((x35 & (x66 ^ x67)) | (~x66 & ~new_n169_ & ~x67));
  assign z04 = (~new_n186_ & ~x64) | new_n202_ | (x64 & ~x65 & (new_n195_ | new_n200_));
  ...
  assign new_n193_ = x00 ? (x04 | (new_n122_ & ~x05 & ~x06 & ~x07)) : ~x04;
  assign new_n194_ = x32 ? (x36 | (new_n127_ & ~x37 & ~x38 & ~x39)) : ~x36;
  ...
  assign new_n213_ = x00 ? (x05 | (new_n122_ & ~x04 & ~x06 & ~x07)) : ~x05;
  assign new_n214_ = x32 ? (x37 | (new_n127_ & ~x36 & ~x38 & ~x39)) : ~x37;
  ...
  assign new_n222_ = ((~x66 & ~x67) | ((new_n223_ | ~x65) & (x61 | ~new_n233_ | x65))) & (x61 | ~x65 | x66 | ~new_n233_ | x67);
  assign new_n223_ = (x68 | ~x69 | (~new_n224_ & ~new_n228_)) & (x61 | ~x68 | ~new_n232_ | x69);
  ...
  assign new_n234_ = x00 ? (x06 | (new_n122_ & ~x04 & ~x05 & ~x07)) : ~x06;
  assign new_n235_ = x32 ? (x38 | (new_n127_ & ~x36 & ~x37 & ~x39)) : ~x38;
  assign new_n236_ = (x68 | ((~new_n242_ | x61) & (new_n237_ | ~x69))) & (x61 | ~x68 | ~new_n240_ | x69);
  ...
  assign new_n245_ = ((~x66 & ~x67) | ((new_n246_ | ~x65) & (x61 | ~new_n256_ | x65))) & (x61 | ~x65 | x66 | ~new_n256_ | x67);
  assign new_n246_ = (x68 | ~x69 | (~new_n247_ & ~new_n251_)) & (x61 | ~x68 | ~new_n255_ | x69);
  ...
  assign new_n259_ = (x68 | ((~new_n265_ | x61) & (new_n260_ | ~x69))) & (x61 | ~x68 | ~new_n263_ | x69);
  ...
  assign z08 = (~new_n268_ & ~x64) | new_n202_ | (x64 & ~x65 & (new_n282_ | new_n286_));
  ...
  assign new_n271_ = x70 & ~x71 & ((x40 & (~x32 | (new_n126_ & new_n127_))) | (x32 & ~x40 & (~new_n126_ | ~new_n127_)));
  ...
  assign new_n280_ = (~x23 | x73 | ~x74) & (~x73 | (x74 ? ~x21 : ~x22));
  ...
  assign new_n286_ = x66 & ~x67 & ((~new_n284_ & ~x68) | (new_n201_ & x40 & x68));
  assign z09 = x64 ? new_n303_ : ((~new_n288_ & ~new_n114_) | (new_n301_ & ~x61));
  assign new_n288_ = (x61 | ~x68 | new_n289_ | x69) & (~x65 | x68 | new_n296_ | ~x69);
  assign new_n289_ = x65 ? (x70 | new_n292_ | x71) : (x70 ? (new_n291_ | x71) : (new_n290_ | ~x71));
  assign new_n290_ = (~x09 | (~new_n165_ & x00)) & (~x00 | new_n165_ | x09);
  assign new_n291_ = (~x41 | (~new_n168_ & x32)) & (~x32 | new_n168_ | x41);
  assign new_n292_ = ~new_n293_ & ~new_n294_ & ~new_n295_;
  assign new_n293_ = x57 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n294_ = x72 & ((~x73 & (x74 ? x52 : x53)) | (x49 & x73 & ~x74));
  assign new_n295_ = ~x72 & ((x56 & ~x73 & x74) | (x73 & (x74 ? x54 : x55)));
  assign new_n296_ = ~new_n297_ & (new_n154_ | (~new_n298_ & ~new_n299_ & ~new_n300_));
  assign new_n297_ = x70 & x71 & (new_n293_ | new_n294_ | new_n295_);
  ...
  assign new_n302_ = x70 ? (new_n291_ | x71) : (new_n290_ | ~x71);
  assign new_n303_ = ~x65 & (new_n307_ | (~x68 & (new_n309_ | (~new_n304_ & x69))));
  assign new_n304_ = (new_n305_ | new_n154_) & (new_n306_ | (~x66 ^ x67)) & (x66 | ~new_n297_ | x67);
  assign new_n305_ = (~x09 | (~x66 ^ x67)) & (x66 | x67 | (~new_n298_ & ~new_n299_ & ~new_n300_));
  assign new_n306_ = (~x41 | ~x70 | ~x71) & (~x57 | x70 | x71);
  assign new_n307_ = ~x61 & x68 & ~x69 & ~x70 & ~new_n308_ & ~x71;
  assign new_n308_ = (~x41 | (~x66 ^ x67)) & (x66 | x67 | (~new_n293_ & ~new_n294_ & ~new_n295_));
  assign new_n309_ = ~x61 & ~new_n157_ & ~new_n310_;
  assign new_n310_ = (~x70 | ((~x41 | ~x71) & (~x25 | x69 | x71))) & (~x09 | x70 | ~x71);
  assign z10 = (~x64 & (new_n328_ | (~new_n312_ & ~new_n114_))) | new_n202_ | (new_n330_ & x64);
  ...
  assign new_n327_ = x69 & x71 & (new_n322_ | new_n323_ | (~new_n170_ & x26));
  ...
  assign new_n334_ = ~new_n154_ & (new_n322_ | new_n323_ | (~new_n170_ & x26));
  ...
  assign new_n338_ = ~x67 & ((~new_n332_ & ~x68) | (new_n201_ & x42 & x68));
  assign z11 = x64 ? (~new_n358_ & ~x65) : ~new_n340_;
  assign new_n340_ = (~new_n356_ | x61) & (new_n114_ | (x70 ? new_n351_ : new_n341_));
  assign new_n341_ = (x61 | ~x68 | new_n342_ | x69) & (~x65 | x68 | ~new_n347_ | ~x69);
  assign new_n342_ = x65 ? (x71 | (~new_n344_ & ~new_n345_ & ~new_n346_)) : (new_n343_ | ~x71);
  assign new_n343_ = (~x11 | (x00 & (x12 | x13 | x14 | x15))) & (~x00 | x11 | (~x12 & ~x13 & ~x14 & ~x15));
  ...
  assign new_n351_ = (~x65 | x68 | new_n352_ | ~x69) & (x61 | x65 | ~x68 | ~new_n354_ | x69);
  ...
  assign new_n354_ = ~new_n355_ & ~x71;
  assign new_n355_ = (~x43 | (x32 & (x44 | x45 | x46 | x47))) & (~x32 | x43 | (~x44 & ~x45 & ~x46 & ~x47));
  assign new_n356_ = x65 & ~x66 & ~x67 & x68 & ~new_n357_ & ~x69;
  assign new_n357_ = x70 ? (new_n355_ | x71) : (new_n343_ | ~x71);
  assign new_n358_ = (x61 | ~new_n363_ | ~x68) & (x68 | (~new_n359_ & (x61 | new_n157_ | new_n365_)));
  assign new_n359_ = x69 & ((~new_n360_ & ~new_n154_) | new_n361_ | (new_n362_ & ~x66));
  assign new_n360_ = (~x11 | (~x66 ^ x67)) & (x66 | x67 | (~new_n348_ & ~new_n349_ & ~new_n350_));
  assign new_n361_ = ~new_n157_ & ((x43 & x70 & x71) | (x59 & ~x70 & ~x71));
  assign new_n362_ = ~x67 & x70 & x71 & (new_n344_ | new_n345_ | new_n346_);
  assign new_n363_ = ~x69 & ~x70 & ~new_n364_ & ~x71;
  assign new_n364_ = (~x43 | (~x66 ^ x67)) & (x66 | x67 | (~new_n344_ & ~new_n345_ & ~new_n346_));
  assign new_n365_ = (~x70 | ((~x43 | ~x71) & (~x27 | x69 | x71))) & (~x11 | x70 | ~x71);
  assign z12 = (~new_n367_ & ~x64) | new_n202_ | (x64 & ~x65 & (new_n382_ | new_n390_));
  assign new_n367_ = ((~new_n368_ & ~new_n377_) | (~x66 & ~x67)) & (~x65 | x66 | ~new_n381_ | x67);
  ...
  assign new_n374_ = x71 & (new_n375_ | new_n376_ | (~new_n170_ & x28));
  ...
  assign new_n383_ = x69 & (new_n385_ | (~new_n154_ & (~new_n384_ | (~new_n170_ & x28))));
  ...
  assign new_n388_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n389_ | ~x70) & (~x60 | ~x69 | x70 | x71);
  assign new_n389_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n390_ = x66 & ~x67 & ((~new_n388_ & ~x68) | (new_n201_ & x44 & x68));
  assign z13 = (~new_n392_ & ~x64) | new_n202_ | (x64 & ~new_n410_ & ~x65);
  assign new_n392_ = ~new_n408_ & (new_n114_ | (x71 ? new_n393_ : new_n403_));
  assign new_n393_ = (x70 | (x65 ? (~new_n396_ | x68) : (~new_n394_ | ~x68))) & (~x65 | x68 | new_n400_ | ~x70);
  assign new_n394_ = ~new_n395_ & ~x69;
  assign new_n395_ = (~x00 | x13 | (~x14 & ~x15)) & (~x13 | (x00 & (x14 | x15)));
  assign new_n396_ = x69 & (new_n397_ | new_n398_ | new_n399_);
  assign new_n397_ = x29 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n398_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n399_ = ~x72 & ((x28 & ~x73 & x74) | (x73 & (x74 ? x26 : x27)));
  assign new_n400_ = (new_n170_ | ~x61) & (~x69 | (x72 ? new_n401_ : new_n402_));
  assign new_n401_ = (x73 | (x74 ? ~x56 : ~x57)) & (~x53 | ~x73 | x74);
  assign new_n402_ = (~x60 | x73 | ~x74) & (~x73 | (x74 ? ~x58 : ~x59));
  assign new_n403_ = x65 ? (x68 ? ~new_n405_ : ~new_n404_) : (~new_n406_ | ~x68);
  assign new_n404_ = x69 & x70 & (new_n397_ | new_n398_ | new_n399_);
  assign new_n405_ = ~x69 & ~x70 & (x72 ? ~new_n401_ : ~new_n402_);
  assign new_n406_ = ~x69 & ~new_n407_ & x70;
  assign new_n407_ = (~x32 | x45 | (~x46 & ~x47)) & (~x45 | (x32 & (x46 | x47)));
  assign new_n408_ = x65 & ~x66 & new_n409_ & ~x67;
  assign new_n409_ = x68 & ~x69 & (x70 ? (~new_n407_ & ~x71) : (~new_n395_ & x71));
  assign new_n410_ = x66 ? ~new_n420_ : (x68 ? (~new_n417_ | x69) : new_n411_);
  assign new_n411_ = x67 ? new_n412_ : (~new_n416_ & (~x69 | (~new_n414_ & ~new_n415_)));
  assign new_n412_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x61 | x70 | x71) & (new_n413_ | ~x70);
  assign new_n413_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n414_ = ~new_n154_ & (new_n397_ | new_n398_ | new_n399_);
  assign new_n415_ = x70 & x71 & (x72 ? ~new_n401_ : ~new_n402_);
  assign new_n416_ = x61 & x70 & ~new_n170_ & x71;
  assign new_n417_ = ~x70 & ~x71 & (x67 ? x45 : (new_n418_ | new_n419_));
  assign new_n418_ = ~new_n401_ & x72;
  assign new_n419_ = ~new_n402_ & ~x72;
  assign new_n420_ = ~x67 & ((~new_n412_ & ~x68) | (new_n201_ & x45 & x68));
  assign z14 = (~new_n422_ & ~x64) | new_n202_ | (x64 & ~x65 & (new_n446_ | new_n452_));
  assign new_n422_ = ~new_n444_ & (new_n114_ | (x71 ? (~new_n423_ & ~new_n428_) : new_n433_));
  assign new_n423_ = ~x70 & (x65 ? (~x68 & ~new_n424_ & x69) : (x68 & ~new_n427_ & ~x69));
  assign new_n424_ = (new_n170_ | ~x30) & (new_n425_ | ~x72) & (new_n426_ | x72);
  ...
  assign new_n428_ = x65 & ~x68 & x70 & (new_n432_ | (~new_n429_ & x69));
  assign new_n429_ = (~x62 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n431_ | ~x73) & (~x72 | new_n430_ | x73);
  assign new_n430_ = x74 ? ~x57 : ~x58;
  assign new_n431_ = (x72 | (x74 ? ~x59 : ~x60)) & (~x54 | ~x72 | x74);
  assign new_n432_ = x61 & ~x72 & ~x73 & x74;
  assign new_n433_ = x65 ? (~new_n434_ & ~new_n435_ & ~new_n439_) : ~new_n443_;
  assign new_n434_ = ~new_n170_ & ((x62 & x68 & ~x69 & ~x70) | (x69 & x70 & x30 & ~x68));
  assign new_n435_ = x73 & ((~x74 & (new_n436_ | new_n437_)) | (~x72 & ~new_n438_ & x74));
  assign new_n436_ = x68 & ~x69 & ~x70 & (x72 ? x54 : x60);
  assign new_n437_ = ~x68 & x69 & x70 & (x72 ? x22 : x28);
  assign new_n438_ = (~x69 | ~x70 | ~x27 | x68) & (x69 | x70 | ~x59 | ~x68);
  assign new_n439_ = ~x73 & (new_n442_ | (x72 & (new_n440_ | new_n441_)));
  assign new_n440_ = x68 & ~x69 & ~x70 & (x74 ? x57 : x58);
  assign new_n441_ = ~x68 & x69 & x70 & (x74 ? x25 : x26);
  assign new_n442_ = x29 & ~x68 & x69 & x70 & ~x72 & x74;
  assign new_n443_ = x68 & ~x69 & x70 & ((x32 & ~x46 & x47) | (x46 & (~x47 | (~x32 & x47))));
  assign new_n444_ = x65 & ~x66 & ~x67 & x68 & ~new_n445_ & ~x69;
  assign new_n445_ = x70 ? (x71 | ((~x32 | x46 | ~x47) & (~x46 | (x32 & x47)))) : (new_n427_ | ~x71);
  assign new_n446_ = ~x66 & (x68 ? new_n449_ : (x67 ? ~new_n450_ : ~new_n447_));
  assign new_n447_ = ~new_n448_ & (~x69 | ((new_n424_ | (~x70 ^ x71)) & (~x70 | new_n429_ | ~x71)));
  assign new_n448_ = x61 & x70 & x71 & ~x72 & ~x73 & x74;
  assign new_n449_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n429_);
  assign new_n450_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n451_ | ~x70) & (~x62 | ~x69 | x70 | x71);
  assign new_n451_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n452_ = x66 & ~x67 & ((~new_n450_ & ~x68) | (new_n201_ & x46 & x68));
  assign z15 = (~x64 & (new_n454_ | new_n472_)) | new_n202_ | (new_n466_ & x64);
  assign new_n454_ = ~new_n114_ & (x65 ? (x68 ? new_n463_ : ~new_n455_) : new_n465_);
  assign new_n455_ = ~new_n462_ & (~x69 | (~new_n456_ & ~new_n459_));
  assign new_n456_ = ~new_n154_ & (new_n457_ | new_n458_ | (~new_n170_ & x31));
  assign new_n457_ = x72 & ((~x73 & (x74 ? x26 : x27)) | (x23 & x73 & ~x74));
  assign new_n458_ = ~x72 & ((x30 & ~x73 & x74) | (x73 & (x74 ? x28 : x29)));
  assign new_n459_ = x70 & x71 & (new_n460_ | new_n461_ | (~new_n170_ & x63));
  assign new_n460_ = x74 & ((~x72 & (x73 ? x60 : x62)) | (x58 & x72 & ~x73));
  assign new_n461_ = x72 & ~x74 & (x73 ? x55 : x59);
  assign new_n462_ = x61 & x70 & x71 & ~x72 & x73 & ~x74;
  assign new_n463_ = ~x69 & ~x70 & ~new_n464_ & ~x71;
  assign new_n464_ = ~new_n460_ & ~new_n461_ & (new_n170_ | ~x63);
  assign new_n465_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n466_ = ~x65 & (x66 ? new_n471_ : (x68 ? new_n470_ : ~new_n467_));
  assign new_n467_ = x67 ? new_n468_ : (~new_n462_ & (~x69 | (~new_n456_ & ~new_n459_)));
  assign new_n468_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (new_n469_ | ~x70) & (~x63 | ~x69 | x70 | x71);
  assign new_n469_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n470_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n464_);
  assign new_n471_ = ~x67 & ((~new_n468_ & ~x68) | (new_n201_ & x47 & x68));
  assign new_n472_ = x65 & ~x66 & new_n465_ & ~x67;
endmodule
