...
module FAU ( 
  ...
  assign new_n169_ = x68 & ((~new_n170_ & ~x70) | (~x66 & new_n163_ & ~x67));
  assign new_n170_ = (x71 | new_n171_ | (~x66 & ~x67)) & (x66 | ~new_n161_ | x67);
  assign new_n171_ = x72 ? ((~x52 | ~x73 | ~x74) & (~x48 | (x74 & (x73 | ~x74)))) : new_n167_;
  assign z05 = ~x69 & ((~new_n173_ & ~x65) | (~x64 & new_n183_ & x65));
  assign new_n173_ = (~x68 | (x64 ? ~new_n178_ : ~new_n174_)) & (~x64 | ~new_n182_ | x68);
  ...
  assign new_n186_ = (~x68 | (x64 ? ~new_n192_ : ~new_n187_)) & (~x64 | ~new_n196_ | x68);
  ...
  assign new_n200_ = (~x64 | ~new_n209_ | x68) & (~x68 | x69 | (x64 ? ~new_n205_ : ~new_n201_));
  ...
  assign new_n215_ = x71 & ((x08 & (~x00 | (new_n121_ & new_n122_))) | (x00 & ~x08 & (~new_n121_ | ~new_n122_)));
  assign new_n216_ = x70 & ~x71 & ((x40 & (~x32 | (new_n125_ & new_n126_))) | (x32 & ~x40 & (~new_n125_ | ~new_n126_)));
  ...
  assign new_n227_ = x71 & ((x09 & (new_n149_ | ~x00)) | (x00 & ~new_n149_ & ~x09));
  ...
  assign new_n233_ = x70 & ~x71 & ((x41 & (new_n152_ | ~x32)) | (x32 & ~new_n152_ & ~x41));
  ...
  assign new_n255_ = (~x11 | (~new_n122_ & x00)) & (~x00 | new_n122_ | x11);
  assign new_n256_ = x70 & ~x71 & ((x43 & (new_n126_ | ~x32)) | (x32 & ~new_n126_ & ~x43));
