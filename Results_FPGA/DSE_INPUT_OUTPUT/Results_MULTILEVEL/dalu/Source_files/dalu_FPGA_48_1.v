...
module FAU ( 
  ...
  assign z07 = ~x69 & ((~new_n199_ & ~x65) | (~x64 & new_n209_ & x65));
  assign new_n199_ = (~x68 | (x64 ? ~new_n204_ : ~new_n200_)) & (~x64 | ~new_n208_ | x68);
  ...
  assign new_n209_ = x68 & ((~x66 & new_n202_ & ~x67) | (~new_n210_ & ~x70));
  assign new_n210_ = (x66 | ~new_n201_ | x67) & (x71 | new_n205_ | (~x66 & ~x67));
  ...
  assign z10 = ~new_n249_ | (~x65 & ((new_n239_ & x68) | (x64 & new_n252_ & ~x68)));
  assign new_n239_ = ~x69 & (x64 ? (~x70 & ~new_n245_ & ~x71) : new_n240_);
  ...
  assign new_n245_ = (~x42 | (~x66 ^ x67)) & (x66 | x67 | (~new_n246_ & ~new_n247_ & ~new_n248_));
  assign new_n246_ = x58 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n247_ = x72 & ((x50 & x73 & ~x74) | (~x73 & (x74 ? x53 : x54)));
  assign new_n248_ = ~x72 & ((x73 & (x74 ? x55 : x56)) | (x57 & ~x73 & x74));
  assign new_n249_ = (x68 | ~x69) & (x64 | ~x65 | ~x68 | new_n250_ | x69);
  assign new_n250_ = (x66 | ~new_n243_ | x67) & (x70 | (~new_n251_ & (x66 | ~new_n241_ | x67)));
  assign new_n251_ = ~x71 & ~new_n104_ & (new_n246_ | new_n247_ | new_n248_);
  assign new_n252_ = ~new_n106_ & ((x70 & (x71 ? x42 : x26)) | (x10 & ~x70 & x71));
  assign z11 = (~new_n254_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n263_ & ~x69);
  assign new_n254_ = (~x64 | ~new_n262_ | x68) & (~x68 | x69 | (x64 ? ~new_n258_ : ~new_n255_));
  assign new_n255_ = ~new_n104_ & (new_n257_ | (new_n256_ & ~x70));
  assign new_n256_ = x71 & ((x11 & (new_n122_ | ~x00)) | (x00 & ~new_n122_ & ~x11));
