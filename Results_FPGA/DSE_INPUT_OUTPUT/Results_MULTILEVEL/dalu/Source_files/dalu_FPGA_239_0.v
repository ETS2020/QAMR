...
module FAU ( 
  ...
  assign z05 = (~new_n188_ & ~x64) | new_n186_ | (new_n199_ & x64);
  assign new_n188_ = ((~x66 & ~x67) | (x65 ? new_n189_ : ~new_n196_)) & (~x65 | x66 | ~new_n196_ | x67);
  assign new_n189_ = (x68 | ((new_n190_ | (~x70 ^ x71)) & (~x70 | new_n193_ | ~x71))) & (x69 | x70 | new_n193_ | x71);
  ...
  assign new_n355_ = (new_n357_ | (~x66 ^ x67)) & (x66 | (~new_n356_ & (~new_n358_ | ~x67 | x70)));
  ...
  assign new_n375_ = ~new_n208_ & (x71 ? x61 : x29);
  ...
  assign new_n380_ = (x66 | x67 | (~new_n373_ & ~new_n371_ & ~new_n372_)) & (~x13 | (~x66 ^ x67));
  ...
  assign new_n384_ = (x66 | x67 | (~new_n368_ & ~new_n365_ & ~new_n366_)) & (~x45 | (~x66 ^ x67));
  assign new_n385_ = ~x66 & ~x67 & ~x69 & (x70 ? new_n377_ : new_n367_);
  assign z14 = (~new_n387_ & ~x64) | new_n186_ | (new_n401_ & x64);
  ...
  assign new_n392_ = ~x68 & x71 & (new_n393_ | new_n394_ | (~new_n208_ & x30));
  ...
  assign new_n397_ = ~new_n208_ & (x71 ? x62 : x30);
  ...
  assign new_n403_ = ~new_n393_ & ~new_n394_ & (new_n208_ | ~x30);
