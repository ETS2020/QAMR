...
module FAU ( 
  ...
  assign z09 = (x16 & ((~new_n72_ & x28) | new_n74_ | x18)) | (~x06 & ~x16 & ~x18);
  ...
  assign new_n88_ = new_n57_ & new_n67_ & new_n89_ & new_n90_;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & ((~new_n88_ & x34) | new_n92_ | x18)) | (~x00 & ~x16 & ~x18);
  assign new_n92_ = new_n57_ & new_n67_ & new_n89_ & new_n93_;
  assign new_n93_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
