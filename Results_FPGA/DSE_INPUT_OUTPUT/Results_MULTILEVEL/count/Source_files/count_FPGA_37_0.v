...
module FAU ( 
  ...
  assign new_n93_ = x01 & ~x18 & (x03 | x16);
  ...
  assign new_n98_ = x01 & ~x18 & (x02 | x16);
  assign z14 = x18 | (x01 & x16 & (new_n100_ | (~new_n95_ & x33)));
  ...
  assign new_n105_ = x01 & ~x18 & (x00 | x16);
endmodule
