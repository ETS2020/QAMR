...
module FAU ( 
  ...
  assign z06 = x18 ? x33 : (x16 ? (new_n68_ | new_n69_) : ~x09);
  ...
  assign new_n80_ = new_n63_ & new_n81_ & ~x27 & ~x28 & ~x29;
  assign new_n81_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n63_ & new_n81_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n81_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n63_ & new_n81_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z14 = ~new_n95_ | (x16 & ((new_n69_ & new_n93_) | (~new_n89_ & x33)));
  assign new_n93_ = new_n94_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n98_ | (x16 & ((new_n69_ & new_n97_) | (x34 & (~new_n69_ | ~new_n93_))));
