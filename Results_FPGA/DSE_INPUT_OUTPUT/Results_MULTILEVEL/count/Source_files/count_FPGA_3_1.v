...
module FAU ( 
  ...
  assign new_n71_ = (~x26 | (new_n59_ & new_n67_)) & (~new_n60_ | ~new_n72_ | x24 | x26);
  assign new_n72_ = ~x22 & ~x23;
  assign z08 = (~new_n74_ & x16) | ~new_n54_ | (~x07 & ~x16);
  assign new_n74_ = (~x27 | (new_n60_ & new_n72_ & new_n75_)) & (~new_n60_ | ~new_n72_ | ~new_n76_);
  assign new_n75_ = ~x24 & ~x26;
  assign new_n76_ = ~x24 & ~x26 & ~x27;
  assign z09 = x18 | (~x25 & (x16 ? ~new_n78_ : ~x06));
  assign new_n78_ = (~x28 | (new_n60_ & new_n72_ & new_n76_)) & (~new_n62_ | ~new_n79_);
  assign new_n79_ = ~x23 & ~x24 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n82_ | (~new_n81_ & x29))) | ~new_n54_ | (~x05 & ~x16);
  assign new_n81_ = new_n62_ & new_n79_;
  assign new_n82_ = new_n62_ & new_n75_ & ~x23 & new_n83_ & ~x27;
  assign new_n83_ = ~x28 & ~x29;
  assign z11 = x18 | (~x25 & (x16 ? (new_n85_ | new_n86_) : ~x04));
  assign new_n85_ = x30 & (~new_n62_ | ~new_n75_ | x23 | ~new_n83_ | x27);
  assign new_n86_ = new_n64_ & new_n76_ & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x25 & (x16 ? ~new_n88_ : ~x03));
  assign new_n88_ = (~x31 | (new_n64_ & new_n76_ & ~x28 & ~x29 & ~x30)) & (~new_n64_ | ~new_n76_ | x28 | x29 | x30 | x31);
  assign z13 = (x16 & (new_n91_ | (~new_n90_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n90_ = new_n64_ & new_n76_ & new_n83_ & ~x30 & ~x31;
  ...
  assign new_n95_ = x33 & (~new_n92_ | ~new_n93_ | ~new_n59_ | ~new_n67_);
  assign new_n96_ = new_n97_ & new_n98_ & new_n59_ & new_n67_;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x25 & (x16 ? (new_n100_ | new_n101_) : ~x00));
  assign new_n100_ = x34 & (~new_n97_ | ~new_n98_ | ~new_n59_ | ~new_n67_);
  assign new_n101_ = new_n102_ & new_n103_ & new_n60_ & new_n72_ & new_n75_;
