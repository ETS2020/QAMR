...
module FAU ( 
  ...
  assign z03 = x18 ? x10 : (x16 ? ~new_n60_ : ~x12);
  ...
  assign z06 = x18 ? x10 : (new_n68_ | (~x09 & ~x16));
  ...
  assign z08 = x18 ? x10 : (x16 ? ~new_n75_ : ~x07);
  assign new_n75_ = (~new_n61_ | ~new_n76_) & (~x27 | (new_n58_ & new_n73_));
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~new_n78_ & x16) | x18 | (~x06 & ~x16);
  assign new_n78_ = (~new_n61_ | ~new_n79_) & (~x28 | (new_n61_ & new_n76_));
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x10 : (x16 ? (new_n81_ | new_n82_) : ~x05);
  ...
  assign z12 = x18 ? x10 : (x16 ? (new_n87_ | new_n89_) : ~x03);
  assign new_n87_ = x31 & (~new_n63_ | ~new_n83_ | ~new_n88_ | x29 | x30);
  ...
  assign z13 = x18 ? x10 : (x16 ? (new_n93_ | new_n94_) : ~x02);
  assign new_n93_ = x32 & (~new_n57_ | ~new_n66_ | ~new_n90_ | ~new_n91_);
  ...
  assign new_n98_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n95_ | ~new_n96_);
  assign new_n99_ = new_n58_ & new_n69_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n104_ | (x16 & ((new_n71_ & new_n103_) | (~new_n99_ & x34)));
  assign new_n103_ = new_n100_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
