...
module FAU ( 
  ...
  assign z05 = (~new_n67_ & x16) | x08 | x18 | (~x10 & ~x16);
  ...
  assign z07 = x18 | (~x08 & (~new_n73_ | (x26 & (~new_n59_ | ~new_n71_))));
  assign new_n73_ = x16 & (~new_n74_ | x19 | x20 | x21 | ~x16 | x17);
  ...
  assign z13 = ~new_n97_ | (x16 & ((new_n93_ & new_n94_) | (~new_n90_ & x32)));
  assign new_n93_ = new_n58_ & new_n68_;
