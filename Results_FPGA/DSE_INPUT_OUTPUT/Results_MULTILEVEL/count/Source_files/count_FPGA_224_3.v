...
module FAU ( 
  ...
  assign new_n72_ = (~x26 | (new_n58_ & new_n73_ & ~x24 & ~x25)) & (~new_n74_ | ~new_n73_ | x24 | x25 | x26);
  assign new_n73_ = ~x22 & ~x23;
  assign new_n74_ = ~x17 & ~x18 & ~x19 & ~x20 & ~x21;
  assign z08 = x18 ? ~x32 : (x16 ? (new_n76_ | new_n78_) : ~x07);
  assign new_n76_ = x27 & (~new_n58_ | ~new_n73_ | ~new_n77_);
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign new_n78_ = new_n61_ & new_n79_;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? ~x32 : (x16 ? (new_n81_ | new_n82_) : ~x06);
  assign new_n81_ = x28 & (~new_n61_ | ~new_n79_);
  ...
  assign z13 = (~x32 & (new_n93_ | x18)) | (~x18 & (x16 ? (~new_n90_ & x32) : ~x02));
  assign new_n93_ = new_n91_ & new_n95_ & new_n94_ & x16 & ~x17 & ~x19;
  assign new_n94_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n95_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n100_ | (~new_n97_ & x33)));
  assign new_n97_ = new_n57_ & new_n67_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n100_ = new_n58_ & new_n70_ & new_n101_ & new_n102_;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n104_ | (~x18 & (x16 ? (~new_n100_ & x34) : ~x00));
  assign new_n104_ = ~x32 & (x18 | (new_n67_ & new_n105_ & new_n98_ & new_n106_));
  assign new_n105_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x33 & ~x34;
endmodule
