...
module FAU ( 
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n73_ | (~new_n72_ & x26)));
  assign new_n72_ = new_n58_ & new_n70_ & ~x24 & ~x25;
  assign new_n73_ = new_n74_ & ~x17 & ~x18 & ~x19 & ~x20 & ~x21;
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n77_ | (~new_n76_ & x27)));
  ...
  assign z14 = ~new_n98_ | (x16 & ((~new_n92_ & x33) | (new_n72_ & new_n96_)));
  assign new_n96_ = new_n97_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = ~x18 & (x01 | x16);
  assign z15 = new_n104_ | (~x18 & (x16 ? (new_n100_ | new_n102_) : ~x00));
  assign new_n100_ = x34 & (~new_n57_ | ~new_n67_ | ~new_n93_ | ~new_n101_);
  assign new_n101_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n102_ = new_n97_ & new_n103_ & new_n58_ & new_n70_ & ~x24 & ~x25;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n104_ = x31 & (x18 | (x16 & x34));
endmodule
