...
module FAU ( 
  ...
  assign new_n71_ = (~x26 | (new_n58_ & new_n69_ & ~x24 & ~x25)) & (~new_n58_ | ~new_n69_ | x24 | x25 | x26);
  assign z08 = x18 | (~x33 & (x16 ? ~new_n73_ : ~x07));
  assign new_n73_ = (~x27 | (new_n58_ & new_n69_ & new_n74_)) & (~new_n61_ | ~new_n75_);
  assign new_n74_ = ~x24 & ~x25 & ~x26;
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x33 & (x16 ? ~new_n77_ : ~x06));
  assign new_n77_ = (~new_n61_ | ~new_n78_) & (~x28 | (new_n61_ & new_n75_));
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x33 & (x16 ? (new_n80_ | new_n81_) : ~x05));
  assign new_n80_ = x29 & (~new_n61_ | ~new_n78_);
  assign new_n81_ = new_n63_ & new_n74_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x33 & (x16 ? ~new_n83_ : ~x04));
  assign new_n83_ = (~x30 | (new_n63_ & new_n74_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n74_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (~x33 & (x16 ? (new_n85_ | new_n87_) : ~x03));
  assign new_n85_ = x31 & (~new_n63_ | ~new_n74_ | ~new_n86_ | x29 | x30);
  assign new_n86_ = ~x27 & ~x28;
  assign new_n87_ = new_n88_ & new_n89_ & new_n57_ & new_n66_;
  assign new_n88_ = ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x33 & (x16 ? (new_n91_ | new_n92_) : ~x02));
  assign new_n91_ = x32 & (~new_n88_ | ~new_n89_ | ~new_n57_ | ~new_n66_);
  assign new_n92_ = new_n57_ & new_n66_ & new_n93_ & new_n86_ & ~x25 & ~x26;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x33 & ((~x01 & ~x16) | (new_n95_ & new_n96_)));
  assign new_n95_ = new_n93_ & new_n86_ & ~x25 & ~x26;
  assign new_n96_ = new_n66_ & ~x19 & ~x20 & x16 & ~x17;
  assign z15 = ~new_n101_ | (x16 & ((~new_n92_ & x34) | (new_n98_ & new_n99_)));
  assign new_n98_ = new_n58_ & new_n69_ & ~x24 & ~x25;
  assign new_n99_ = new_n100_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
