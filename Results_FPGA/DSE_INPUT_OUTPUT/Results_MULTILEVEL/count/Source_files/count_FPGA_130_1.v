...
module FAU ( 
  ...
  assign z03 = x18 ? x11 : (x16 ? ~new_n60_ : ~x12);
  assign new_n60_ = ~new_n61_ & (new_n58_ | ~x22);
  assign new_n61_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z04 = x18 ? x11 : (x16 ? (new_n63_ | (~new_n61_ & x23)) : ~x11);
  assign new_n63_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = x18 ? x11 : (x16 ? ~new_n65_ : ~x10);
  ...
  assign z08 = x18 ? x11 : (x16 ? ~new_n74_ : ~x07);
  assign new_n74_ = (~x27 | (new_n58_ & new_n72_)) & (~new_n61_ | ~new_n75_);
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? x11 : (x16 ? ~new_n77_ : ~x06);
  assign new_n77_ = (~new_n61_ | ~new_n78_) & (~x28 | (new_n61_ & new_n75_));
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x11 : (x16 ? (new_n80_ | new_n81_) : ~x05);
  assign new_n80_ = x29 & (~new_n61_ | ~new_n78_);
  assign new_n81_ = new_n63_ & new_n82_ & ~x27 & ~x28 & ~x29;
  assign new_n82_ = ~x24 & ~x25 & ~x26;
  assign z11 = x18 ? x11 : (x16 ? ~new_n84_ : ~x04);
  assign new_n84_ = (~x30 | (new_n63_ & new_n82_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n82_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n87_ | (~new_n86_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n86_ = new_n63_ & new_n82_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n87_ = new_n57_ & new_n66_ & new_n88_ & new_n89_;
  assign new_n88_ = ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? x11 : (x16 ? (new_n91_ | new_n92_) : ~x02);
  assign new_n91_ = x32 & (~new_n57_ | ~new_n66_ | ~new_n88_ | ~new_n89_);
  assign new_n92_ = new_n57_ & new_n66_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? x11 : (x16 ? (new_n96_ | new_n97_) : ~x01);
  assign new_n96_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n93_ | ~new_n94_);
  assign new_n97_ = new_n58_ & new_n69_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? x11 : (x16 ? ~new_n101_ : ~x00);
  assign new_n101_ = (~x34 | (new_n58_ & new_n69_ & new_n98_ & new_n99_)) & (~new_n98_ | ~new_n102_ | ~new_n58_ | ~new_n69_);
