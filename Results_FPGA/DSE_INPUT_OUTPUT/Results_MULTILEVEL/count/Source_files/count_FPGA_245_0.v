...
module FAU ( 
  ...
  assign z04 = (x16 & (new_n64_ | (~new_n62_ & x23))) | ~x11 | x18;
  ...
  assign z06 = x18 | (x11 & (new_n69_ | (~x09 & ~x16)));
  ...
  assign new_n89_ = new_n58_ & new_n67_ & new_n90_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = ~new_n95_ | (x16 & (new_n92_ | (~new_n89_ & x32)));
  assign new_n92_ = new_n58_ & new_n67_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n94_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n95_ = x11 & ~x18 & (x02 | x16);
  assign z14 = ~new_n101_ | (x16 & ((new_n97_ & new_n98_) | (~new_n92_ & x33)));
  ...
  assign new_n103_ = (~x34 | (new_n59_ & new_n70_ & new_n99_ & new_n100_)) & (~new_n59_ | ~new_n70_ | ~new_n99_ | ~new_n104_);
