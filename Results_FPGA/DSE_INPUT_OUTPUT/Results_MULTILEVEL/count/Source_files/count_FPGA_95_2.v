...
module FAU ( 
  ...
  assign z06 = (x20 & (x18 | (x16 & x25))) | (~x18 & (x16 ? ~new_n66_ : ~x09));
  assign new_n66_ = (new_n68_ | ~x25) & (~new_n57_ | ~new_n67_ | x24 | x25);
  assign new_n67_ = ~x22 & ~x23;
  assign new_n68_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = (x20 & (x18 | (x16 & x26))) | (~x18 & (x16 ? ~new_n70_ : ~x08));
  assign new_n70_ = (~x26 | (new_n71_ & new_n67_ & ~x24 & ~x25)) & (~new_n57_ | ~new_n67_ | x24 | x25 | x26);
  assign new_n71_ = ~x17 & ~x19 & ~x21;
  assign z08 = (x16 & (new_n75_ | (~new_n73_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n73_ = new_n57_ & new_n67_ & new_n74_;
  ...
  assign new_n78_ = new_n59_ & ~x26 & ~x27 & ~x28 & new_n79_ & ~x23;
  assign new_n79_ = ~x24 & ~x25;
  assign z10 = (x20 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n81_ : ~x05));
  assign new_n81_ = (~x29 | (new_n82_ & new_n83_)) & (~new_n61_ | ~new_n84_);
  assign new_n82_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x20 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n86_ : ~x04));
  assign new_n86_ = (~x30 | (new_n82_ & new_n84_)) & (~new_n61_ | ~new_n74_ | ~new_n87_);
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n92_ | (~x18 & (x16 ? (new_n89_ | new_n90_) : ~x03));
  assign new_n89_ = x31 & (~new_n68_ | ~new_n76_ | x28 | x29 | x30);
  assign new_n90_ = new_n76_ & new_n91_ & new_n56_ & new_n64_;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = x20 & (x18 | (x16 & x31));
  assign z13 = new_n98_ | (~x18 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n68_ | ~new_n76_ | ~new_n91_);
  assign new_n95_ = new_n96_ & new_n97_ & new_n56_ & new_n64_;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n98_ = x20 & (x18 | (x16 & x32));
  assign z14 = ~new_n104_ | (x16 & ((new_n100_ & new_n101_) | (~new_n95_ & x33)));
  assign new_n100_ = new_n57_ & new_n67_ & new_n79_;
  ...
  assign new_n106_ = x34 & (~new_n71_ | ~new_n67_ | ~new_n79_ | ~new_n102_ | ~new_n103_);
  assign new_n107_ = new_n57_ & new_n67_ & new_n79_ & new_n102_ & new_n108_;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n109_ = x20 & (x18 | (x16 & x34));
endmodule
