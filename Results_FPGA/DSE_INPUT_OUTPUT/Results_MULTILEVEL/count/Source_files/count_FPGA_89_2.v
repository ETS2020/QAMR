...
module FAU ( 
  ...
  assign z06 = x18 ? x30 : (new_n67_ | (~x09 & ~x16));
  ...
  assign new_n78_ = new_n60_ & ~x23 & ~x24 & ~x25 & new_n79_ & ~x26;
  ...
  assign z11 = new_n88_ | (~x18 & ((~x04 & ~x16) | (new_n84_ & new_n86_)));
  assign new_n84_ = new_n85_ & x16 & ~x17 & ~x19;
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n86_ = new_n87_ & new_n79_ & ~x29 & ~x30;
  assign new_n87_ = ~x24 & ~x25 & ~x26;
  assign new_n88_ = x30 & (x18 | (x16 & (~new_n62_ | ~new_n82_)));
  assign z12 = (x16 & (new_n90_ | (new_n64_ & new_n91_))) | x18 | (~x03 & ~x16);
  assign new_n90_ = x31 & (~new_n62_ | ~new_n87_ | ~new_n79_ | x29 | x30);
  assign new_n91_ = new_n76_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = new_n97_ | (~x18 & (x16 ? (new_n93_ | new_n94_) : ~x02));
  assign new_n93_ = x32 & (~new_n62_ | ~new_n87_ | ~new_n79_ | x29 | x31);
  assign new_n94_ = new_n57_ & new_n65_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n97_ = x30 & (x18 | (x16 & x32));
  assign z14 = new_n104_ | (~x18 & (x16 ? (new_n99_ | new_n101_) : ~x01));
  assign new_n99_ = x33 & (~new_n57_ | ~new_n65_ | ~new_n76_ | ~new_n100_);
  ...
  assign new_n104_ = x30 & (x18 | (x16 & x33));
  assign z15 = ~new_n107_ | (x16 & ((~new_n101_ & x34) | (new_n70_ & new_n106_)));
