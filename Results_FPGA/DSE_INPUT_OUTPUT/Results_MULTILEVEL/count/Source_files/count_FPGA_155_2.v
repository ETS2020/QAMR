...
module FAU ( 
  ...
  assign new_n86_ = x31 & (~new_n62_ | ~new_n82_ | ~new_n87_ | x27 | x28);
  ...
  assign new_n93_ = new_n57_ & new_n65_ & new_n94_ & new_n87_ & ~x31 & ~x32;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z14 = (~x18 & (new_n96_ | (~x01 & ~x16))) | (x33 & (x18 | (~new_n93_ & x16)));
  assign new_n96_ = new_n65_ & new_n97_ & new_n94_ & new_n98_;
  assign new_n97_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n98_ = ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n103_ | (x16 & ((new_n70_ & new_n102_) | (x34 & (~new_n70_ | ~new_n100_))));
  assign new_n100_ = new_n101_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = new_n101_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
