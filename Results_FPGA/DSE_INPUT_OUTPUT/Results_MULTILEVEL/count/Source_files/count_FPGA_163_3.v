...
module FAU ( 
  ...
  assign z08 = x16 ? (~x18 & (new_n75_ | (~new_n74_ & x27))) : (~x07 | x18);
  ...
  assign z12 = x16 ? (~x18 & (new_n86_ | (~new_n85_ & x31))) : (~x03 | x18);
  ...
  assign z13 = x16 ? (~x18 & (new_n89_ | (~new_n86_ & x32))) : (~x02 | x18);
  ...
  assign new_n96_ = (~x34 | (new_n57_ & new_n69_ & new_n93_ & new_n94_)) & (~new_n93_ | ~new_n97_ | ~new_n57_ | ~new_n69_);
