...
module FAU ( 
  ...
  assign z05 = x18 ? x03 : (x16 ? ~new_n63_ : ~x10);
  assign new_n63_ = (new_n61_ | ~x24) & (~new_n56_ | ~new_n64_);
  assign new_n64_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = x18 ? x03 : (x16 ? ~new_n66_ : ~x09);
  assign new_n66_ = (~x25 | (new_n56_ & new_n64_)) & (~new_n57_ | ~new_n67_);
  assign new_n67_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 ? x03 : (x16 ? ~new_n69_ : ~x08);
  assign new_n69_ = (~x26 | (new_n57_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n57_ | x22 | x23 | x24 | x25 | x26);
  ...
  assign z10 = x18 ? x03 : (x16 ? (new_n79_ | new_n80_) : ~x05);
  assign new_n79_ = x29 & (~new_n59_ | ~new_n77_);
  assign new_n80_ = new_n61_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n82_ & x16) | x18 | (~x04 & ~x16);
  assign new_n82_ = (~x30 | (new_n61_ & new_n72_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n72_ | x29 | x30 | x27 | x28);
  assign z12 = x18 ? x03 : (x16 ? (new_n85_ | (~new_n84_ & x31)) : ~x03);
  assign new_n84_ = new_n61_ & new_n72_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n85_ = new_n56_ & new_n64_ & new_n74_ & new_n86_;
  assign new_n86_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? x03 : (x16 ? (new_n88_ | new_n89_) : ~x02);
  assign new_n88_ = x32 & (~new_n56_ | ~new_n64_ | ~new_n74_ | ~new_n86_);
  ...
  assign z15 = x18 ? x03 : (x16 ? ~new_n97_ : ~x00);
  assign new_n97_ = (~x34 | (new_n57_ & new_n67_ & new_n94_ & new_n95_)) & (~new_n94_ | ~new_n98_ | ~new_n57_ | ~new_n67_);
