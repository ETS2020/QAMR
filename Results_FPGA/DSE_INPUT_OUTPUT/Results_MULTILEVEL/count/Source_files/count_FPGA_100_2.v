...
module FAU ( 
  ...
  assign z07 = x18 | (~x05 & (x16 ? ~new_n75_ : ~x08));
  ...
  assign z10 = (x29 & (~new_n62_ | ~new_n83_)) | ~new_n86_ | x05 | ~x16;
  assign new_n86_ = ~x18 & (~new_n65_ | ~new_n78_ | x27 | x28 | x29);
  assign z11 = x18 | (~x05 & (x16 ? ~new_n88_ : ~x04));
  ...
  assign new_n106_ = ~x05 & ~x18 & (x00 | x16);
endmodule
