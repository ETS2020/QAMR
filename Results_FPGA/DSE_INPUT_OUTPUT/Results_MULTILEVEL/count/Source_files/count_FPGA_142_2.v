...
module FAU ( 
  ...
  assign new_n70_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x24;
  ...
  assign new_n77_ = (~x27 | (new_n59_ & new_n75_)) & (~new_n63_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x23 & (x18 | (x16 & x28))) | (~x18 & (x16 ? ~new_n80_ : ~x06));
  assign new_n80_ = (~x28 | (new_n59_ & new_n81_)) & (~new_n63_ | ~new_n82_);
  assign new_n81_ = ~x22 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n85_ | (~new_n84_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n84_ = new_n63_ & new_n82_;
  assign new_n85_ = new_n64_ & new_n86_ & new_n87_;
  assign new_n86_ = ~x24 & ~x25 & ~x26;
  assign new_n87_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x23 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n89_ : ~x04));
  assign new_n89_ = (~x30 | (new_n63_ & new_n86_ & new_n87_)) & (~new_n64_ | ~new_n86_ | ~new_n90_);
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n96_ | (~x18 & (x16 ? (new_n92_ | new_n94_) : ~x03));
  assign new_n92_ = x31 & (~new_n70_ | ~new_n93_ | x28 | x29 | x30);
  assign new_n93_ = ~x25 & ~x26 & ~x27;
  assign new_n94_ = new_n58_ & new_n67_ & new_n93_ & new_n95_;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = x23 & (x18 | (x16 & x31));
  assign z13 = (x16 & (new_n98_ | (~new_n94_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n98_ = new_n58_ & new_n67_ & new_n99_ & new_n100_;
  assign new_n99_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n105_ | (x16 & ((new_n73_ & new_n102_) | (~new_n98_ & x33)));
  ...
  assign new_n107_ = x34 & (~new_n103_ | ~new_n104_ | ~new_n58_ | ~new_n108_);
  assign new_n108_ = ~x21 & ~x22 & ~x24 & ~x25;
  assign new_n109_ = new_n59_ & new_n71_ & new_n103_ & new_n110_;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n111_ = x23 & (x18 | (x16 & x34));
endmodule
