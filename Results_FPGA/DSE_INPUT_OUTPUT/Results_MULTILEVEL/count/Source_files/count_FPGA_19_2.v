...
module FAU ( 
  ...
  assign new_n77_ = new_n64_ & new_n78_ & ~x23 & ~x24;
  assign new_n78_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n80_ | (~new_n77_ & x28)));
  assign new_n80_ = new_n64_ & new_n81_;
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x34 : (x16 ? (new_n83_ | new_n84_) : ~x05);
  assign new_n83_ = x29 & (~new_n64_ | ~new_n81_);
  ...
  assign z12 = x18 ? x34 : (x16 ? (new_n88_ | new_n90_) : ~x03);
  assign new_n88_ = x31 & (~new_n65_ | ~new_n76_ | ~new_n89_ | x29 | x30);
  ...
  assign z14 = ~new_n100_ | (x16 & ((new_n71_ & new_n98_) | (~new_n94_ & x33)));
  assign new_n98_ = new_n99_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n100_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n103_ | (x16 & ((new_n71_ & new_n102_) | (x34 & (~new_n71_ | ~new_n98_))));
