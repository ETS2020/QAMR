...
module FAU ( 
  ...
  assign new_n72_ = x12 & ~x18 & (x09 | x16);
  assign z07 = x18 | (x12 & (x16 ? ~new_n74_ : ~x08));
  assign new_n74_ = (~x26 | (new_n59_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n59_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = ~new_n79_ | (x16 & ((~new_n76_ & x27) | (new_n61_ & new_n78_)));
  assign new_n76_ = new_n59_ & new_n77_ & ~x22 & ~x23;
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n79_ = x12 & ~x18 & (x07 | x16);
  assign z09 = (~new_n81_ & x16) | ~x12 | x18 | (~x06 & ~x16);
  assign new_n81_ = (~new_n61_ | ~new_n82_) & (~x28 | (new_n61_ & new_n78_));
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n84_ | new_n85_)) | ~x12 | x18 | (~x05 & ~x16);
  assign new_n84_ = x29 & (~new_n61_ | ~new_n82_);
  assign new_n85_ = new_n64_ & new_n77_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & x16) | ~x12 | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n64_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n77_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n92_ | (x16 & ((new_n69_ & new_n90_) | (~new_n89_ & x31)));
  assign new_n89_ = new_n64_ & new_n77_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n90_ = new_n91_ & ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n92_ = x12 & ~x18 & (x03 | x16);
  assign z13 = ~new_n97_ | (x16 & ((new_n69_ & new_n94_) | (x32 & (~new_n69_ | ~new_n90_))));
  assign new_n94_ = new_n95_ & new_n96_;
  assign new_n95_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n96_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n97_ = x12 & ~x18 & (x02 | x16);
  assign z14 = x18 | (x12 & (x16 ? (new_n99_ | new_n100_) : ~x01));
  assign new_n99_ = x33 & (~new_n58_ | ~new_n67_ | ~new_n95_ | ~new_n96_);
