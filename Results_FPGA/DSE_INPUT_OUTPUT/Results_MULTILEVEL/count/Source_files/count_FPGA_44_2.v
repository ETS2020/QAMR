...
module FAU ( 
  ...
  assign z07 = (x20 & (x18 | (x16 & x26))) | (~x18 & (x16 ? ~new_n73_ : ~x08));
  assign new_n73_ = (~x26 | (new_n59_ & new_n74_ & ~x24 & ~x25)) & (~new_n69_ | ~new_n74_ | x24 | x25 | x26);
  assign new_n74_ = ~x22 & ~x23;
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n78_ | (~new_n76_ & x27)));
  assign new_n76_ = new_n69_ & new_n74_ & new_n77_;
  ...
  assign z10 = new_n86_ | (~x18 & (x16 ? (new_n83_ | new_n85_) : ~x05));
  assign new_n83_ = x29 & (~new_n84_ | ~new_n56_ | ~new_n74_ | x21);
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n85_ = new_n63_ & new_n77_ & ~x27 & ~x28 & ~x29;
  assign new_n86_ = x20 & (x18 | (x16 & x29));
  assign z11 = (~new_n88_ & x16) | x18 | (~x04 & ~x16);
  assign new_n88_ = (~x30 | (new_n63_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n77_ | x29 | x30 | x27 | x28);
  assign z12 = ~new_n94_ | (x16 & ((~new_n90_ & x31) | (new_n91_ & new_n92_)));
  assign new_n90_ = new_n63_ & new_n77_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n91_ = new_n66_ & ~x17 & ~x19 & ~x20;
  assign new_n92_ = new_n93_ & ~x25 & ~x26 & ~x27;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = ~x18 & (x03 | x16);
  assign z13 = new_n100_ | (~x18 & (x16 ? (new_n96_ | new_n97_) : ~x02));
  assign new_n96_ = x32 & (~new_n70_ | ~new_n93_ | x25 | x26 | x27);
  assign new_n97_ = new_n98_ & new_n99_ & new_n66_ & ~x17 & ~x19 & ~x20;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n100_ = x20 & (x18 | (x16 & x32));
  assign z14 = new_n106_ | (~x18 & (x16 ? (new_n102_ | new_n103_) : ~x01));
  assign new_n102_ = x33 & (~new_n59_ | ~new_n71_ | ~new_n81_ | ~new_n99_);
  assign new_n103_ = new_n69_ & new_n71_ & new_n104_ & new_n105_;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n106_ = x20 & (x18 | (x16 & x33));
  assign z15 = (~new_n108_ & x16) | x18 | (~x00 & ~x16);
  assign new_n108_ = (~x34 | (new_n69_ & new_n71_ & new_n104_ & new_n105_)) & (~new_n104_ | ~new_n109_ | ~new_n69_ | ~new_n71_);
