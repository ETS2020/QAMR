...
module FAU ( 
  ...
  assign new_n75_ = x27 & (~new_n76_ | x20 | x22 | x17 | x19);
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = new_n60_ & new_n78_ & ~x23 & ~x24;
  assign new_n78_ = ~x25 & ~x26 & ~x27;
  assign new_n79_ = x21 & (x18 | (x16 & x27));
  assign z09 = (x16 & (new_n81_ | (~new_n77_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n81_ = new_n60_ & ~x23 & ~x24 & ~x25 & new_n82_ & ~x26;
  assign new_n82_ = ~x27 & ~x28;
  assign z10 = (x21 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n84_ : ~x05));
  assign new_n84_ = (~new_n62_ | ~new_n87_) & (~x29 | (new_n85_ & new_n86_));
  assign new_n85_ = ~x17 & ~x19 & ~x20 & ~x22 & ~x23;
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x21 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n89_ : ~x04));
  assign new_n89_ = (~x30 | (new_n85_ & new_n87_)) & (~new_n62_ | ~new_n90_ | ~new_n91_);
  assign new_n90_ = ~x24 & ~x25 & ~x26;
  assign new_n91_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n96_ | (~x18 & (x16 ? (new_n93_ | new_n94_) : ~x03));
  assign new_n93_ = x31 & (~new_n68_ | ~new_n78_ | x28 | x29 | x30);
  assign new_n94_ = new_n57_ & new_n65_ & new_n78_ & new_n95_;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = x21 & (x18 | (x16 & x31));
  assign z13 = new_n101_ | (~x18 & (x16 ? (new_n98_ | new_n99_) : ~x02));
  assign new_n98_ = x32 & (~new_n68_ | ~new_n78_ | ~new_n95_);
  assign new_n99_ = new_n57_ & new_n65_ & new_n100_ & new_n82_ & ~x25 & ~x26;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = x21 & (x18 | (x16 & x32));
  assign z14 = (x16 & (new_n103_ | (~new_n99_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n103_ = new_n58_ & new_n69_ & new_n104_ & new_n105_;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n108_ | (x16 & ((new_n71_ & new_n107_) | (~new_n103_ & x34)));
  assign new_n107_ = new_n104_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
