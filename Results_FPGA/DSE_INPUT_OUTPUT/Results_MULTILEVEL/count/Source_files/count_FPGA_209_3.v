...
module FAU ( 
  ...
  assign z08 = x18 ? ~x29 : (x16 ? ~new_n75_ : ~x07);
  ...
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n83_ | (~new_n82_ & x29)));
  ...
  assign z14 = ~new_n98_ | (x16 & ((new_n71_ & new_n96_) | (~new_n92_ & x33)));
  assign new_n96_ = new_n97_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n101_ | (x16 & ((new_n71_ & new_n100_) | (x34 & (~new_n71_ | ~new_n96_))));
