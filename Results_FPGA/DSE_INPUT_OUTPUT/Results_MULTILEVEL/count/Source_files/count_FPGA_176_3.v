...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n67_ | (new_n57_ & new_n68_))) | x18 | (~x09 & ~x16);
  ...
  assign new_n72_ = x27 & (~new_n57_ | ~new_n73_ | x22 | x23);
  ...
  assign z10 = (~x29 & (new_n79_ | x18)) | (~x18 & (x16 ? (~new_n76_ & x29) : ~x05));
  assign new_n79_ = new_n77_ & new_n80_;
  assign new_n80_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  ...
  assign new_n84_ = new_n62_ & new_n73_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z14 = new_n92_ | (~x18 & (x16 ? (~new_n88_ & x33) : ~x01));
  assign new_n92_ = ~x29 & (x18 | (new_n65_ & new_n93_ & new_n89_ & new_n94_));
  assign new_n93_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n94_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x18 & (new_n98_ | new_n100_)) | (~x29 & (x18 | (new_n96_ & new_n97_)));
  assign new_n96_ = new_n65_ & new_n93_;
  assign new_n97_ = new_n89_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n98_ = x16 & x34 & (~new_n57_ | ~new_n68_ | ~new_n94_ | ~new_n99_);
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n100_ = ~x00 & ~x16;
endmodule
