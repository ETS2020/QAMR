...
module FAU ( 
  ...
  assign z06 = (x25 & (~new_n56_ | ~new_n64_)) | ~x16 | new_n66_ | x18;
  ...
  assign new_n78_ = new_n61_ & new_n69_ & new_n74_ & ~x29 & ~x30;
  assign z12 = (~new_n78_ & x31) | ~x16 | new_n80_ | x18;
  assign new_n80_ = new_n56_ & new_n64_ & new_n81_ & ~x25 & ~x26 & ~x27;
  assign new_n81_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n83_ | (~new_n80_ & x32)));
  assign new_n83_ = new_n56_ & new_n64_ & new_n84_ & new_n74_ & ~x25 & ~x26;
  assign new_n84_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~new_n83_ & x33) | ~x16 | x18 | (new_n66_ & new_n86_);
  assign new_n86_ = new_n87_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n87_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = x18 | (x16 & ((new_n66_ & new_n89_) | (x34 & (~new_n66_ | ~new_n86_))));
  assign new_n89_ = new_n87_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
