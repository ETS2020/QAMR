...
module FAU ( 
  ...
  assign new_n73_ = (~x26 | (new_n58_ & new_n71_)) & (~new_n58_ | ~new_n74_);
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? ~x06 : (x16 ? ~new_n76_ : ~x07);
  assign new_n76_ = (~x27 | (new_n58_ & new_n74_)) & (~new_n61_ | ~new_n77_);
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n80_ | (~new_n79_ & x28)));
  assign new_n79_ = new_n61_ & new_n77_;
  assign new_n80_ = new_n61_ & ~x23 & ~x24 & ~x25 & new_n81_ & ~x26;
  assign new_n81_ = ~x27 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n83_ | (~new_n80_ & x29)));
  ...
  assign new_n88_ = new_n64_ & new_n84_ & new_n81_ & ~x29 & ~x30;
  assign new_n89_ = new_n57_ & new_n67_ & new_n90_ & new_n91_;
  assign new_n90_ = ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x06 : (x16 ? (new_n93_ | new_n94_) : ~x02);
  assign new_n93_ = x32 & (~new_n57_ | ~new_n67_ | ~new_n90_ | ~new_n91_);
  assign new_n94_ = new_n57_ & new_n67_ & new_n95_ & new_n81_ & ~x25 & ~x26;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n100_ | (x16 & ((~new_n94_ & x33) | (new_n70_ & new_n97_)));
  ...
  assign z15 = x18 ? ~x06 : (x16 ? ~new_n102_ : ~x00);
  assign new_n102_ = (~x34 | (new_n58_ & new_n71_ & new_n98_ & new_n99_)) & (~new_n98_ | ~new_n103_ | ~new_n58_ | ~new_n71_);
