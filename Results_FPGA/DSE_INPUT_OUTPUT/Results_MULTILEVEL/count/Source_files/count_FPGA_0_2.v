// Benchmark "FAU" written by ABC on Mon Aug 17 20:10:36 2020
...
module FAU ( 
  ...
  assign z06 = x18 ? x28 : (new_n69_ | (~x09 & ~x16));
  ...
  assign z08 = x18 ? x28 : (x16 ? (new_n76_ | new_n77_) : ~x07);
  assign new_n76_ = x27 & (~new_n59_ | ~new_n73_ | ~new_n74_);
  assign new_n77_ = new_n63_ & new_n78_;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~new_n80_ & ~x18) | (x28 & (x18 | (~new_n77_ & x16)));
  assign new_n80_ = (x06 | x16) & (~new_n82_ | ~new_n81_ | ~x16 | x17 | x19);
  assign new_n81_ = ~x20 & ~x21 & ~x22;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~x18 & (new_n84_ | (~x05 & ~x16))) | (x28 & (x18 | (x16 & x29)));
  assign new_n84_ = x16 & ((x29 & (~new_n63_ | ~new_n78_)) | (new_n64_ & new_n85_));
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = new_n90_ | (~x18 & (x16 ? (new_n87_ | new_n89_) : ~x04));
  assign new_n87_ = x30 & (~new_n63_ | ~new_n88_);
  assign new_n88_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n89_ = new_n64_ & new_n74_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n90_ = x28 & (x18 | (x16 & x30));
  assign z12 = ~new_n96_ | (x16 & ((new_n92_ & new_n93_) | (~new_n89_ & x31)));
  assign new_n92_ = new_n58_ & new_n67_;
  assign new_n93_ = new_n94_ & new_n95_ & ~x28 & ~x29;
  ...
  assign new_n98_ = x32 & (~new_n64_ | ~new_n74_ | ~new_n95_ | x27 | x29);
  assign new_n99_ = new_n58_ & new_n67_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = x28 & (x18 | (x16 & x32));
  assign z14 = new_n108_ | (~x18 & (x16 ? (new_n104_ | new_n105_) : ~x01));
  assign new_n104_ = x33 & (~new_n58_ | ~new_n67_ | ~new_n94_ | ~new_n101_);
  assign new_n105_ = new_n59_ & new_n70_ & new_n106_ & new_n107_;
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n108_ = x28 & (x18 | (x16 & x33));
  assign z15 = new_n114_ | (~x18 & (x16 ? (new_n110_ | new_n112_) : ~x00));
  assign new_n110_ = x34 & (~new_n58_ | ~new_n67_ | ~new_n107_ | ~new_n111_);
  assign new_n111_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n112_ = new_n59_ & new_n70_ & new_n106_ & new_n113_;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n114_ = x28 & (x18 | (x16 & x34));
endmodule
