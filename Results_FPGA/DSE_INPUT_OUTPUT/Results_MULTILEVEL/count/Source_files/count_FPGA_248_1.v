...
module FAU ( 
  ...
  assign new_n86_ = new_n87_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n92_ | (x16 & (new_n89_ | (x33 & (~new_n63_ | ~new_n86_))));
  ...
  assign z15 = (x16 & ((~new_n89_ & x34) | new_n94_ | x18)) | (~x00 & ~x16 & ~x18);
  assign new_n94_ = new_n57_ & new_n67_ & new_n90_ & new_n95_;
