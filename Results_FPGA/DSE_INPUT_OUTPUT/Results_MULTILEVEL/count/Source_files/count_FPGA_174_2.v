...
module FAU ( 
  ...
  assign z05 = x18 ? x31 : (x16 ? ~new_n65_ : ~x10);
  ...
  assign z07 = x18 ? x31 : (x16 ? ~new_n72_ : ~x08);
  assign new_n72_ = (~x26 | (new_n57_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n57_ | x22 | x23 | x24 | x25 | x26);
  ...
  assign z09 = x18 ? x31 : (x16 ? ~new_n79_ : ~x06);
  assign new_n79_ = (~new_n60_ | ~new_n80_) & (~x28 | (new_n60_ & new_n77_));
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n83_ | (~new_n82_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n82_ = new_n60_ & new_n80_;
  assign new_n83_ = new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 ? x31 : (x16 ? ~new_n85_ : ~x04);
  assign new_n85_ = (~x30 | (new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n75_ | x27 | x28 | x29 | x30);
  assign z12 = new_n91_ | (~x18 & ((~x03 & ~x16) | (new_n87_ & new_n89_)));
  assign new_n87_ = new_n88_ & x16 & ~x17 & ~x19;
  assign new_n88_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n89_ = new_n90_ & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n91_ = x31 & (x18 | (x16 & (~new_n63_ | ~new_n75_ | ~new_n92_)));
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = new_n98_ | (~x18 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n63_ | ~new_n75_ | ~new_n92_);
  assign new_n95_ = new_n56_ & new_n66_ & new_n96_ & new_n97_;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n98_ = x31 & (x18 | (x16 & x32));
  assign z14 = ~new_n102_ | (x16 & ((new_n69_ & new_n100_) | (~new_n95_ & x33)));
  ...
  assign new_n104_ = x34 & (~new_n56_ | ~new_n66_ | ~new_n96_ | ~new_n105_);
  assign new_n105_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n106_ = new_n57_ & new_n70_ & new_n101_ & new_n107_;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n108_ = x31 & (x18 | (x16 & x34));
endmodule
