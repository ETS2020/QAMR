...
module FAU ( 
  ...
  assign new_n72_ = new_n59_ & new_n73_ & ~x22 & ~x23;
  ...
  assign new_n78_ = new_n62_ & ~x23 & ~x24 & ~x25 & new_n79_ & ~x26;
  assign new_n79_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n81_ | (~new_n78_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n81_ = new_n64_ & new_n73_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n64_ & new_n73_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n73_ | x27 | x28 | x29 | x30);
  assign z12 = x18 ? ~x09 : (x16 ? (new_n85_ | new_n86_) : ~x03);
  assign new_n85_ = x31 & (~new_n64_ | ~new_n73_ | ~new_n79_ | x29 | x30);
  assign new_n86_ = new_n58_ & new_n67_ & new_n76_ & new_n87_;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x09 : (x16 ? (new_n89_ | new_n90_) : ~x02);
  assign new_n89_ = x32 & (~new_n58_ | ~new_n67_ | ~new_n76_ | ~new_n87_);
  assign new_n90_ = new_n58_ & new_n67_ & new_n91_ & new_n92_;
  assign new_n91_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n92_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n97_ | (x16 & ((~new_n90_ & x33) | (new_n69_ & new_n94_)));
  ...
  assign z15 = x18 ? ~x09 : (x16 ? ~new_n99_ : ~x00);
  assign new_n99_ = (~x34 | (new_n59_ & new_n70_ & new_n95_ & new_n96_)) & (~new_n95_ | ~new_n100_ | ~new_n59_ | ~new_n70_);
