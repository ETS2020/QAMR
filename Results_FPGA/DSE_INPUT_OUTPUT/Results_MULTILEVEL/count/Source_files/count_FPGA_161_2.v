...
module FAU ( 
  ...
  assign new_n71_ = new_n58_ & new_n72_ & ~x24 & ~x25;
  assign new_n72_ = ~x22 & ~x23;
  assign z07 = x18 ? x30 : (x16 ? ~new_n74_ : ~x08);
  assign new_n74_ = (~x26 | (new_n58_ & new_n72_ & ~x24 & ~x25)) & (~new_n58_ | ~new_n72_ | x24 | x25 | x26);
  assign z08 = (x16 & (new_n78_ | (~new_n76_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n76_ = new_n58_ & new_n72_ & new_n77_;
  ...
  assign new_n83_ = x29 & (~new_n63_ | ~new_n81_);
  assign new_n84_ = new_n64_ & new_n85_;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = new_n89_ | (~x18 & ((~x04 & ~x16) | (new_n87_ & new_n88_)));
  assign new_n87_ = x16 & ~x17 & ~x19 & new_n72_ & ~x20 & ~x21;
  assign new_n88_ = new_n77_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n89_ = x30 & (x18 | (x16 & (~new_n64_ | ~new_n85_)));
  assign z12 = ~new_n93_ | (x16 & (new_n91_ | (x31 & (~new_n88_ | ~new_n64_))));
  ...
  assign new_n95_ = new_n57_ & new_n68_ & new_n96_ & new_n97_;
  ...
  assign new_n103_ = x34 & (~new_n57_ | ~new_n68_ | ~new_n96_ | ~new_n104_);
  assign new_n104_ = ~x29 & ~x31 & ~x32 & ~x33;
  assign new_n105_ = new_n100_ & new_n106_ & new_n58_ & new_n72_ & ~x24 & ~x25;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n107_ = x30 & (x18 | (x16 & x34));
endmodule
