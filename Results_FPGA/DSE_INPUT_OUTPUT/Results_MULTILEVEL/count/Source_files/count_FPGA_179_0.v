...
module FAU ( 
  ...
  assign new_n71_ = new_n60_ & ~x24 & ~x25 & ~x22 & ~x23;
  ...
  assign new_n83_ = new_n66_ & new_n76_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (x33 & (x16 ? ~new_n85_ : ~x04));
  assign new_n85_ = (~x30 | (new_n66_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n66_ | ~new_n76_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n88_ | (~new_n87_ & x31))) | ~new_n54_ | (~x03 & ~x16);
  assign new_n87_ = new_n66_ & new_n76_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n88_ = new_n59_ & new_n69_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n91_ | (~new_n88_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n91_ = new_n59_ & new_n69_ & new_n92_ & new_n93_;
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x33 & (x16 ? ~new_n91_ : ~x01));
