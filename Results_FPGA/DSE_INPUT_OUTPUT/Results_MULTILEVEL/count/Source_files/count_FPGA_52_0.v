...
module FAU ( 
  ...
  assign z03 = (~new_n61_ & x16) | ~x00 | x18 | (~x12 & ~x16);
  assign new_n61_ = ~new_n62_ & (new_n59_ | ~x22);
  assign new_n62_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z04 = (~new_n64_ & x16) | ~x00 | x18 | (~x11 & ~x16);
  ...
  assign new_n73_ = x00 & ~x18 & (x09 | x16);
  ...
  assign new_n93_ = x00 & ~x18 & (x03 | x16);
  ...
  assign new_n98_ = x00 & ~x18 & (x02 | x16);
  ...
  assign new_n103_ = x00 & ~x18 & (x01 | x16);
  assign z15 = x18 | (x00 & ~new_n105_ & x16);
