...
module FAU ( 
  ...
  assign z07 = (x16 & (new_n71_ | (new_n59_ & new_n72_))) | ~new_n54_ | (~x08 & ~x16);
  assign new_n71_ = x26 & (~new_n58_ | ~new_n67_);
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x26;
  assign z08 = x18 | (~x25 & (x16 ? ~new_n74_ : ~x07));
  assign new_n74_ = (~new_n59_ | ~new_n75_) & (~x27 | (new_n59_ & new_n72_));
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x26 & ~x27;
  assign z09 = x18 | (~x25 & (x16 ? ~new_n77_ : ~x06));
  assign new_n77_ = (~x28 | (new_n59_ & new_n75_)) & (~new_n61_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x25 & (x16 ? ~new_n80_ : ~x05));
  assign new_n80_ = (~new_n61_ | ~new_n81_) & (~x29 | (new_n61_ & new_n78_));
  assign new_n81_ = ~x23 & ~x24 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n84_ | (~new_n83_ & x30))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n83_ = new_n61_ & new_n81_;
  assign new_n84_ = new_n64_ & new_n85_ & ~x28 & ~x29 & ~x30;
  assign new_n85_ = ~x24 & ~x26 & ~x27;
  assign z12 = x18 | (~x25 & (x16 ? ~new_n87_ : ~x03));
  assign new_n87_ = (~x31 | (new_n64_ & new_n85_ & ~x28 & ~x29 & ~x30)) & (~new_n64_ | ~new_n85_ | x28 | x29 | x30 | x31);
  assign z13 = (x16 & (new_n90_ | (~new_n89_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n89_ = new_n64_ & new_n85_ & ~x28 & ~x29 & ~x30 & ~x31;
  ...
  assign new_n94_ = x33 & (~new_n58_ | ~new_n67_ | ~new_n91_ | ~new_n92_);
  ...
  assign new_n99_ = x34 & (~new_n58_ | ~new_n67_ | ~new_n96_ | ~new_n97_);
