...
module FAU ( 
  ...
  assign z07 = x18 | (x02 & (x16 ? ~new_n74_ : ~x08));
  ...
  assign z12 = x18 | (x02 & (x16 ? (new_n89_ | new_n91_) : ~x03));
  assign new_n89_ = x31 & (~new_n65_ | ~new_n85_ | ~new_n90_);
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n58_ & new_n68_ & new_n92_ & ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n94_ | (~new_n91_ & x32))) | ~x02 | x18;
  ...
  assign z15 = x18 | (x02 & (x16 ? ~new_n103_ : ~x00));
  assign new_n103_ = (~x34 | (new_n59_ & new_n72_ & new_n100_ & new_n101_)) & (~new_n59_ | ~new_n72_ | ~new_n100_ | ~new_n104_);
