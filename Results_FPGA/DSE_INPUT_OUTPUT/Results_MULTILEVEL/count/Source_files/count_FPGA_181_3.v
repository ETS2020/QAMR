...
module FAU ( 
  ...
  assign z08 = x16 ? (~x18 & (new_n73_ | (~new_n72_ & x27))) : (~x07 | x18);
  ...
  assign new_n81_ = (~x30 | (new_n62_ & new_n79_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n79_ | x27 | x28 | x29 | x30);
  assign z12 = x16 ? (~x18 & (new_n84_ | (~new_n83_ & x31))) : (~x03 | x18);
  assign new_n83_ = new_n62_ & new_n79_ & ~x27 & ~x28 & ~x29 & ~x30;
