...
module FAU ( 
  ...
  assign z09 = x18 | (x15 & (x16 ? ~new_n81_ : ~x06));
  assign new_n81_ = (~new_n62_ | ~new_n82_) & (~x28 | (new_n62_ & new_n79_ & ~x23 & ~x24));
  assign new_n82_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = (x16 & (new_n84_ | new_n85_)) | ~x15 | (~x05 & ~x16) | x18;
  assign new_n84_ = x29 & (~new_n62_ | ~new_n82_);
  assign new_n85_ = new_n65_ & new_n77_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & x16) | ~x15 | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n65_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n77_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (x15 & (x16 ? (new_n89_ | new_n91_) : ~x03));
  assign new_n89_ = x31 & (~new_n65_ | ~new_n77_ | ~new_n90_);
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n58_ & new_n68_ & new_n79_ & new_n92_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x15 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n79_ | ~new_n92_);
  ...
  assign new_n104_ = (~x34 | (new_n59_ & new_n72_ & new_n101_ & new_n102_)) & (~new_n101_ | ~new_n105_ | ~new_n59_ | ~new_n72_);
