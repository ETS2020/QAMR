...
module FAU ( 
  ...
  assign new_n70_ = new_n57_ & new_n71_ & new_n72_;
  ...
  assign z09 = (x21 & (x18 | (x16 & x28))) | (~x18 & (x16 ? ~new_n77_ : ~x06));
  assign new_n77_ = (~x28 | (new_n75_ & new_n78_)) & (~new_n60_ | ~new_n79_);
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x22;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = new_n84_ | (~x18 & (x16 ? (new_n81_ | new_n83_) : ~x05));
  assign new_n81_ = x29 & (~new_n82_ | x17 | x19 | ~new_n71_ | x20);
  assign new_n82_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n83_ = new_n62_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign new_n84_ = x21 & (x18 | (x16 & x29));
  assign z11 = (~new_n86_ & x16) | x18 | (~x04 & ~x16);
  assign new_n86_ = (~x30 | (new_n62_ & new_n72_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n72_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n89_ | (~new_n88_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n88_ = new_n62_ & new_n72_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n89_ = new_n56_ & new_n65_ & new_n90_ & ~x25 & ~x26 & ~x27;
  ...
  assign z14 = ~new_n99_ | (x16 & ((~new_n92_ & x33) | (new_n67_ & new_n96_)));
  ...
  assign new_n101_ = x34 & (~new_n56_ | ~new_n68_ | ~new_n97_ | ~new_n98_);
  assign new_n102_ = new_n57_ & new_n68_ & new_n97_ & new_n103_;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n104_ = x21 & (x18 | (x16 & x34));
endmodule
