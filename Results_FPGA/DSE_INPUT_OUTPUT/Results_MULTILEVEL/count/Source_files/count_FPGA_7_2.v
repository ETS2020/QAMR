...
module FAU ( 
  ...
  assign new_n72_ = (~x26 | (new_n59_ & new_n70_ & ~x24 & ~x25)) & (~new_n59_ | ~new_n70_ | x24 | x25 | x26);
  assign z08 = x18 ? x28 : (x16 ? (new_n74_ | new_n76_) : ~x07);
  assign new_n74_ = x27 & (~new_n59_ | ~new_n70_ | ~new_n75_);
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign new_n76_ = new_n63_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~new_n78_ & ~x18) | (x28 & (x18 | (~new_n76_ & x16)));
  assign new_n78_ = (x06 | x16) & (~new_n80_ | ~new_n79_ | ~x16 | x17 | x19);
  ...
  assign new_n87_ = x31 & (~new_n64_ | ~new_n75_ | x27 | x29 | x30);
  assign new_n88_ = new_n58_ & new_n67_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n90_ = x28 & (x18 | (x16 & x31));
  assign z13 = new_n97_ | (~x18 & (x16 ? (new_n92_ | new_n94_) : ~x02));
  assign new_n92_ = x32 & (~new_n64_ | ~new_n75_ | ~new_n93_);
  assign new_n93_ = ~x27 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = new_n58_ & new_n67_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n97_ = x28 & (x18 | (x16 & x32));
  assign z14 = (x16 & (new_n99_ | (~new_n94_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n99_ = new_n100_ & new_n101_ & new_n59_ & new_n70_ & ~x24 & ~x25;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n107_ | (~x18 & (x16 ? (new_n103_ | new_n105_) : ~x00));
  assign new_n103_ = x34 & (~new_n58_ | ~new_n67_ | ~new_n101_ | ~new_n104_);
  assign new_n104_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n105_ = new_n100_ & new_n106_ & new_n59_ & new_n70_ & ~x24 & ~x25;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n107_ = x28 & (x18 | (x16 & x34));
endmodule
