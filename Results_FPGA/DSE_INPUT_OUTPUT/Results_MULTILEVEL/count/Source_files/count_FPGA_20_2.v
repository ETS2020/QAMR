...
module FAU ( 
  ...
  assign z03 = (x20 & (x18 | (x16 & x22))) | (~x18 & (x16 ? ~new_n59_ : ~x12));
  assign new_n59_ = ~new_n61_ & (new_n60_ | ~x22);
  assign new_n60_ = ~x17 & ~x19 & ~x21;
  assign new_n61_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z04 = (x20 & (x18 | (x16 & x23))) | (~x18 & (x16 ? ~new_n63_ : ~x11));
  assign new_n63_ = (~x23 | (~x17 & ~x19 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  ...
  assign new_n83_ = new_n67_ & new_n84_;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = new_n88_ | (~x18 & (x16 ? (new_n86_ | new_n87_) : ~x04));
  assign new_n86_ = x30 & (~new_n84_ | x17 | x19 | ~new_n74_ | x21);
  assign new_n87_ = new_n67_ & new_n77_ & new_n81_ & ~x29 & ~x30;
  assign new_n88_ = x20 & (x18 | (x16 & x30));
  assign z12 = ~new_n93_ | (x16 & ((~new_n87_ & x31) | (new_n90_ & new_n91_)));
  assign new_n90_ = new_n56_ & new_n66_;
  ...
  assign new_n95_ = x32 & (~new_n70_ | ~new_n92_ | x25 | x26 | x27);
  assign new_n96_ = new_n56_ & new_n66_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n98_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n99_ = x20 & (x18 | (x16 & x32));
  assign z14 = new_n105_ | (~x18 & (x16 ? (new_n101_ | new_n102_) : ~x01));
  assign new_n101_ = x33 & (~new_n60_ | ~new_n71_ | ~new_n98_ | ~new_n81_ | x26);
  assign new_n102_ = new_n57_ & new_n71_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n105_ = x20 & (x18 | (x16 & x33));
  assign z15 = new_n110_ | (~x18 & (x16 ? (new_n107_ | new_n108_) : ~x00));
  assign new_n107_ = x34 & (~new_n60_ | ~new_n71_ | ~new_n103_ | ~new_n104_);
  assign new_n108_ = new_n57_ & new_n71_ & new_n103_ & new_n109_;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n110_ = x20 & (x18 | (x16 & x34));
endmodule
