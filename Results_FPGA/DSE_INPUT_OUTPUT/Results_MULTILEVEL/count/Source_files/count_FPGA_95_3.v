...
module FAU ( 
  ...
  assign new_n82_ = ~x20 & (x18 | (new_n83_ & new_n84_));
  assign new_n83_ = ~x21 & ~x22 & ~x23 & x16 & ~x17 & ~x19;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n86_ & ~x18) | (~x20 & (x18 | (new_n83_ & new_n72_ & new_n87_)));
  assign new_n86_ = x16 ? (~x30 | (new_n61_ & new_n84_)) : x04;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~x20 & (x18 | (new_n89_ & new_n77_ & new_n91_))) | (~new_n90_ & ~x18);
  assign new_n89_ = new_n64_ & x16 & ~x17 & ~x19;
  assign new_n90_ = x16 ? (~x31 | (new_n61_ & new_n72_ & new_n87_)) : x03;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x18 & (new_n95_ | new_n96_)) | (~x20 & (x18 | (new_n89_ & new_n93_)));
  assign new_n93_ = new_n94_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n95_ = x16 & x32 & (~new_n56_ | ~new_n64_ | ~new_n77_ | ~new_n91_);
  assign new_n96_ = ~x02 & ~x16;
  assign z14 = ~new_n101_ | (x16 & (new_n98_ | (x33 & (~new_n63_ | ~new_n93_))));
  ...
  assign z15 = new_n103_ | (~x18 & (x16 ? (~new_n98_ & x34) : ~x00));
  assign new_n103_ = ~x20 & (x18 | (new_n67_ & new_n68_ & new_n99_ & new_n104_));
