...
module FAU ( 
  ...
  assign new_n65_ = new_n66_ & ~x19 & ~x20 & ~x17 & ~x18;
  ...
  assign new_n75_ = (~x27 | (new_n58_ & new_n73_)) & (~new_n60_ | ~new_n76_);
  ...
  assign z12 = x18 ? ~x12 : (x16 ? (new_n87_ | new_n88_) : ~x03);
  assign new_n87_ = x31 & (~new_n63_ | ~new_n83_ | ~new_n80_ | x29 | x30);
  assign new_n88_ = new_n57_ & new_n66_ & new_n89_ & new_n90_;
  assign new_n89_ = ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x12 : (x16 ? (new_n92_ | new_n93_) : ~x02);
  assign new_n92_ = x32 & (~new_n57_ | ~new_n66_ | ~new_n89_ | ~new_n90_);
  assign new_n93_ = new_n57_ & new_n66_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? ~x12 : (x16 ? (new_n97_ | new_n98_) : ~x01);
  assign new_n97_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n94_ | ~new_n95_);
