...
module FAU ( 
  ...
  assign z05 = (~x22 & (new_n65_ | x18)) | (~x18 & (x16 ? new_n67_ : ~x10));
  assign new_n65_ = x16 & ~x17 & ~x19 & new_n66_ & ~x20 & ~x21;
  ...
  assign new_n78_ = new_n60_ & new_n66_ & new_n79_;
  assign new_n79_ = ~x25 & ~x26 & ~x27;
  assign z09 = (~x22 & (new_n81_ | x18)) | (~x18 & (x16 ? new_n83_ : ~x06));
  assign new_n81_ = new_n82_ & x16 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n83_ = x28 & (~new_n60_ | ~new_n66_ | ~new_n79_);
  assign z10 = (~x22 & (x18 | (new_n85_ & new_n63_))) | (~new_n86_ & ~x18);
  assign new_n85_ = new_n76_ & ~x27 & ~x28 & ~x29;
  assign new_n86_ = x16 ? (~x29 | (new_n60_ & new_n82_)) : x05;
  assign z11 = (~new_n88_ & x16) | x18 | (~x04 & ~x16);
  assign new_n88_ = (~x30 | (new_n68_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n68_ | ~new_n76_ | x27 | x28 | x29 | x30);
  assign z12 = (~new_n90_ & ~x18) | (~x22 & (x18 | (new_n65_ & new_n79_ & new_n92_)));
  assign new_n90_ = x16 ? (~x31 | (new_n68_ & new_n76_ & new_n91_)) : x03;
  ...
  assign new_n96_ = x16 & x32 & (~new_n57_ | ~new_n71_ | ~new_n79_ | ~new_n92_);
  assign new_n97_ = ~x02 & ~x16;
  assign z14 = ~new_n102_ | (x16 & (new_n99_ | (x33 & (~new_n70_ | ~new_n94_))));
  ...
  assign z15 = ~new_n105_ | (x16 & ((new_n72_ & new_n104_) | (~new_n99_ & x34)));
