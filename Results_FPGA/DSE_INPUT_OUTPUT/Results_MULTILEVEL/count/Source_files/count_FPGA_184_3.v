...
module FAU ( 
  ...
  assign z05 = (x16 & (new_n68_ | (~new_n70_ & x24))) | x18 | (~x10 & ~x16);
  assign new_n68_ = new_n57_ & new_n69_;
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n70_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n72_ | (~new_n68_ & x25)));
  assign new_n72_ = new_n61_ & new_n73_;
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n75_ | (~new_n72_ & x26)));
  assign new_n75_ = new_n61_ & new_n76_ & ~x22 & ~x23;
  assign new_n76_ = ~x24 & ~x25 & ~x26;
  assign z08 = new_n78_ | (~x18 & (x16 ? (~new_n75_ & x27) : ~x07));
  assign new_n78_ = ~x21 & (x18 | (new_n62_ & new_n79_));
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n82_ | (~new_n81_ & x28)));
  assign new_n81_ = new_n65_ & new_n79_;
  assign new_n82_ = new_n65_ & new_n83_ & ~x26 & ~x27 & ~x28;
  assign new_n83_ = ~x23 & ~x24 & ~x25;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n85_ | (~new_n82_ & x29)));
  assign new_n85_ = new_n70_ & new_n76_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & x16) | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n70_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n70_ | ~new_n76_ | x27 | x28 | x29 | x30);
  assign z12 = (~new_n91_ & ~x18) | (~x21 & (x18 | (new_n89_ & new_n93_ & new_n94_)));
  assign new_n89_ = new_n90_ & x16 & ~x17 & ~x19;
  assign new_n90_ = ~x20 & ~x22 & ~x23 & ~x24;
  assign new_n91_ = x16 ? (~x31 | (new_n70_ & new_n76_ & new_n92_)) : x03;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n93_ = ~x25 & ~x26 & ~x27;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x18 & (new_n99_ | new_n100_)) | (~x21 & (x18 | (new_n89_ & new_n96_)));
  assign new_n96_ = new_n97_ & new_n98_;
  assign new_n97_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n98_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n99_ = x16 & x32 & (~new_n57_ | ~new_n69_ | ~new_n93_ | ~new_n94_);
  assign new_n100_ = ~x02 & ~x16;
  assign z14 = (~x18 & (new_n106_ | new_n107_)) | (~x21 & (x18 | (new_n102_ & new_n103_)));
  assign new_n102_ = new_n58_ & new_n73_;
  assign new_n103_ = new_n104_ & new_n105_;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n106_ = x16 & x33 & (~new_n57_ | ~new_n69_ | ~new_n97_ | ~new_n98_);
  assign new_n107_ = ~x01 & ~x16;
  assign z15 = new_n109_ | (~x18 & (x16 ? (~new_n111_ & x34) : ~x00));
  assign new_n109_ = ~x21 & (x18 | (new_n58_ & new_n73_ & new_n104_ & new_n110_));
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n111_ = new_n61_ & new_n73_ & new_n104_ & new_n105_;
endmodule
