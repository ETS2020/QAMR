...
module FAU ( 
  ...
  assign new_n69_ = new_n60_ & ~x24 & ~x25 & ~x22 & ~x23;
  ...
  assign new_n74_ = new_n62_ & new_n75_ & ~x23 & ~x24;
  assign new_n75_ = ~x25 & ~x26 & ~x27;
  assign z09 = new_n77_ | (~x18 & (x16 ? (~new_n74_ & x28) : ~x06));
  assign new_n77_ = ~x22 & (x18 | (new_n59_ & new_n78_));
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n81_ | (~new_n80_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n80_ = new_n62_ & new_n78_;
  assign new_n81_ = new_n63_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n63_ & new_n72_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n72_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n63_ & new_n72_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n86_ = new_n66_ & new_n67_ & new_n75_ & new_n87_;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x18 & (new_n94_ | new_n95_)) | (~x22 & (x18 | (new_n89_ & new_n91_)));
  assign new_n89_ = new_n90_ & x16 & ~x17 & ~x19;
  assign new_n90_ = ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n91_ = new_n92_ & new_n93_;
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n94_ = x16 & x32 & (~new_n66_ | ~new_n67_ | ~new_n75_ | ~new_n87_);
  assign new_n95_ = ~x02 & ~x16;
  assign z14 = (~x18 & (new_n101_ | new_n102_)) | (~x22 & (x18 | (new_n97_ & new_n99_)));
  assign new_n97_ = new_n98_ & x16 & ~x17 & ~x19 & ~x20;
  assign new_n98_ = ~x21 & ~x23 & ~x24 & ~x25;
  assign new_n99_ = new_n100_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = x16 & x33 & (~new_n66_ | ~new_n67_ | ~new_n92_ | ~new_n93_);
  assign new_n102_ = ~x01 & ~x16;
  assign z15 = ~new_n105_ | (x16 & ((x34 & (~new_n69_ | ~new_n99_)) | (new_n69_ & new_n104_)));
