...
module FAU ( 
  ...
  assign z07 = x18 ? x33 : (x16 ? ~new_n69_ : ~x08);
  ...
  assign z09 = x18 ? x33 : (x16 ? ~new_n76_ : ~x06);
  assign new_n76_ = (~new_n59_ | ~new_n77_) & (~x28 | (new_n59_ & new_n74_ & ~x23 & ~x24));
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x33 : (x16 ? (new_n79_ | new_n80_) : ~x05);
  assign new_n79_ = x29 & (~new_n59_ | ~new_n77_);
  assign new_n80_ = new_n61_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 ? x33 : (x16 ? ~new_n82_ : ~x04);
  ...
  assign new_n88_ = new_n56_ & new_n64_ & new_n89_ & new_n90_;
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n90_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n94_ | (x16 & ((new_n67_ & new_n92_) | (~new_n88_ & x33)));
  assign new_n92_ = new_n93_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n93_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n94_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n97_ | (x16 & ((new_n67_ & new_n96_) | (x34 & (~new_n67_ | ~new_n92_))));
