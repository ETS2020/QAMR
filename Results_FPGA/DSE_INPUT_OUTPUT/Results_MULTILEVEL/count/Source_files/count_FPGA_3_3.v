...
module FAU ( 
  ...
  assign z06 = (~x25 & (new_n70_ | x18)) | (~x18 & (x16 ? (~new_n69_ & x25) : ~x09));
  assign new_n69_ = new_n58_ & new_n67_;
  assign new_n70_ = new_n67_ & new_n71_;
  assign new_n71_ = ~x19 & ~x20 & x16 & ~x17;
  assign z07 = new_n73_ | (~x18 & (x16 ? new_n75_ : ~x08));
  assign new_n73_ = ~x25 & (x18 | (new_n71_ & new_n74_ & ~x21 & ~x22));
  assign new_n74_ = ~x23 & ~x24 & ~x26;
  assign new_n75_ = x26 & (~new_n59_ | ~new_n76_);
  ...
  assign z09 = new_n82_ | (~x18 & (x16 ? (~new_n80_ & x28) : ~x06));
  assign new_n82_ = ~x25 & (x18 | (new_n83_ & new_n84_));
  assign new_n83_ = ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n84_ = ~x22 & ~x23 & ~x24 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n88_ | (~new_n86_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n86_ = new_n63_ & ~x23 & ~x24 & ~x25 & new_n87_ & ~x26;
  assign new_n87_ = ~x27 & ~x28;
  assign new_n88_ = new_n64_ & new_n79_ & ~x27 & ~x28 & ~x29;
  assign z11 = new_n90_ | (~x18 & (x16 ? (~new_n88_ & x30) : ~x04));
  assign new_n90_ = ~x25 & (x18 | (new_n91_ & new_n74_ & new_n87_ & new_n92_));
  assign new_n91_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n92_ = ~x29 & ~x30;
  assign z12 = new_n94_ | (~x18 & (x16 ? (~new_n99_ & x31) : ~x03));
  assign new_n94_ = ~x25 & (x18 | (new_n95_ & new_n96_ & new_n97_ & new_n98_));
  assign new_n95_ = x16 & ~x17 & ~x19;
  assign new_n96_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n97_ = ~x24 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n99_ = new_n64_ & new_n79_ & new_n87_ & new_n92_;
  assign z13 = ~new_n105_ | (x16 & (new_n102_ | (x32 & (~new_n69_ | ~new_n101_))));
  assign new_n101_ = new_n98_ & ~x25 & ~x26 & ~x27;
  ...
  assign z14 = new_n107_ | (~x18 & (x16 ? (~new_n102_ & x33) : ~x01));
  assign new_n107_ = ~x25 & (x18 | (new_n67_ & new_n71_ & new_n108_ & new_n109_));
  assign new_n108_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x18 & (new_n112_ | new_n113_)) | (~x25 & (x18 | (new_n70_ & new_n111_)));
  assign new_n111_ = new_n108_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n112_ = x16 & x34 & (~new_n59_ | ~new_n76_ | ~new_n108_ | ~new_n109_);
  assign new_n113_ = ~x00 & ~x16;
endmodule
