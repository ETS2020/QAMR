...
module FAU ( 
  ...
  assign new_n81_ = new_n62_ & new_n73_ & new_n82_ & ~x27;
  assign new_n82_ = ~x28 & ~x29;
  assign z11 = x18 | (~x33 & (x16 ? ~new_n84_ : ~x04));
  assign new_n84_ = (~x30 | (new_n62_ & new_n73_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n73_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n87_ | (~new_n86_ & x31))) | ~new_n54_ | (~x03 & ~x16);
  assign new_n86_ = new_n62_ & new_n73_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n87_ = new_n57_ & new_n65_ & new_n75_ & new_n82_ & ~x30 & ~x31;
  ...
  assign z14 = ~new_n54_ | (~x01 & ~x16) | (new_n93_ & new_n90_ & new_n91_);
  assign new_n93_ = new_n65_ & ~x19 & ~x20 & x16 & ~x17;
  assign z15 = ~new_n97_ | (x16 & ((~new_n89_ & x34) | (new_n68_ & new_n95_)));
  assign new_n95_ = new_n96_ & new_n82_ & ~x26 & ~x27;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x34;
