...
module FAU ( 
  ...
  assign z05 = ~new_n58_ | (~x10 & ~x16) | (x16 & (new_n66_ | (~new_n64_ & x24)));
  ...
  assign z09 = (x16 & (new_n79_ | (~new_n77_ & x28))) | ~new_n58_ | (~x06 & ~x16);
  assign new_n79_ = new_n62_ & new_n80_;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n54_ & (~new_n83_ | (x16 & (new_n82_ | (~new_n79_ & x29))));
  assign new_n82_ = new_n64_ & new_n76_ & ~x27 & ~x28 & ~x29;
  assign new_n83_ = ~x18 & (x05 | x16);
  assign z11 = (~new_n85_ & x16) | ~new_n58_ | (~x04 & ~x16);
  assign new_n85_ = (~x30 | (new_n64_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n76_ | x29 | x30 | x27 | x28);
  assign z12 = ~new_n54_ & (~new_n90_ | (x16 & (new_n88_ | (~new_n87_ & x31))));
  assign new_n87_ = new_n64_ & new_n76_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n88_ = new_n59_ & new_n67_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n90_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n94_ | (x16 & ((~new_n88_ & x32) | (new_n66_ & new_n92_)));
  assign new_n92_ = new_n93_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n94_ = (x02 | x16) & ~new_n54_ & ~x18;
  assign z14 = new_n99_ | ~new_n100_ | (x16 & (new_n96_ | (~new_n88_ & x33)));
  assign new_n96_ = new_n60_ & new_n71_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n99_ = x32 & (x34 | (x16 & x33));
  assign new_n100_ = ~x18 & (x01 | x16);
  assign z15 = (x16 & (new_n102_ | (new_n70_ & new_n104_))) | ~new_n58_ | (~x00 & ~x16);
  assign new_n102_ = x34 & (~new_n59_ | ~new_n67_ | ~new_n93_ | ~new_n103_);
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x33;
  assign new_n104_ = new_n97_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
