// Benchmark "FAU" written by ABC on Mon Aug 17 20:11:10 2020
...
module FAU ( 
  ...
  assign new_n78_ = new_n61_ & new_n79_ & ~x27 & ~x28 & ~x29;
  assign new_n79_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n81_ & x16) | x18 | (~x04 & ~x16);
  assign new_n81_ = (~x30 | (new_n61_ & new_n79_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n79_ | x29 | x30 | x27 | x28);
  assign z12 = x16 ? (~x18 & (new_n84_ | (~new_n83_ & x31))) : (~x03 | x18);
  assign new_n83_ = new_n61_ & new_n79_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = ~new_n94_ | (x16 & ((~new_n87_ & x33) | (new_n66_ & new_n91_)));
  ...
  assign new_n96_ = (~x34 | (new_n57_ & new_n67_ & new_n92_ & new_n93_)) & (~new_n92_ | ~new_n97_ | ~new_n57_ | ~new_n67_);
