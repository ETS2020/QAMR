...
module FAU ( 
  ...
  assign z03 = x18 ? ~x29 : (x16 ? ~new_n60_ : ~x12);
  ...
  assign z06 = x18 ? ~x29 : (x16 ? ~new_n69_ : ~x09);
  ...
  assign new_n83_ = (~x30 | (new_n64_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n75_ | x29 | x30 | x27 | x28);
  assign z12 = new_n86_ | (~x18 & (x16 ? (~new_n85_ & x31) : ~x03));
  assign new_n85_ = new_n64_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n86_ = ~x29 & (x18 | (new_n87_ & new_n88_ & new_n75_ & new_n89_));
  assign new_n87_ = x16 & ~x17 & ~x19;
  assign new_n88_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n89_ = ~x27 & ~x28 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n93_ | (~new_n91_ & x32))) | x18 | (~x02 & ~x16);
  ...
  assign new_n97_ = ~x29 & (x18 | (new_n67_ & new_n98_ & new_n94_ & new_n99_));
  assign new_n98_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x29 & (new_n101_ | x18)) | (~x18 & (x16 ? new_n103_ : ~x00));
  assign new_n101_ = new_n67_ & new_n98_ & new_n94_ & new_n102_;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n103_ = x34 & (~new_n58_ | ~new_n70_ | ~new_n99_ | ~new_n104_);
