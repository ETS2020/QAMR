...
module FAU ( 
  ...
  assign z13 = (~new_n91_ & ~x32) | x18 | (~x02 & ~x16) | (x16 & ~new_n87_ & x32);
  assign new_n91_ = ~x34 & (~new_n92_ | ~new_n93_ | ~new_n88_ | ~new_n94_);
  assign new_n92_ = x16 & ~x17 & ~x19;
  assign new_n93_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n94_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign z14 = new_n96_ | ~new_n102_ | (x16 & x33 & (~new_n70_ | ~new_n100_));
  assign new_n96_ = ~x32 & (x34 | (new_n67_ & new_n97_ & new_n98_ & new_n99_));
  assign new_n97_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x33;
  assign new_n100_ = new_n101_ & ~x30 & ~x31 & ~x32 & ~x34;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x18 & (x01 | x16);
  assign z15 = (x16 & (x34 | (new_n70_ & new_n104_))) | ~new_n105_ | (~x32 & x34);
  assign new_n104_ = new_n101_ & ~x30 & ~x31 & ~x32 & ~x33;
