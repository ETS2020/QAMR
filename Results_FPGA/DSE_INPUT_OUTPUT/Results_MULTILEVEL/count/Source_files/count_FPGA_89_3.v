...
module FAU ( 
  ...
  assign z08 = x18 ? ~x30 : (x16 ? (new_n74_ | new_n75_) : ~x07);
  assign new_n74_ = x27 & (~new_n58_ | ~new_n72_);
  ...
  assign z11 = (~x30 & (new_n83_ | x18)) | (~x18 & (x16 ? (~new_n80_ & x30) : ~x04));
  ...
  assign new_n87_ = new_n62_ & new_n81_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n88_ = new_n57_ & new_n65_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n91_ | (~x18 & (x16 ? (~new_n88_ & x32) : ~x02));
  assign new_n91_ = ~x30 & (x18 | (new_n92_ & new_n93_ & new_n94_ & new_n95_));
  assign new_n92_ = x16 & ~x17 & ~x19;
  assign new_n93_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n94_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n95_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign z14 = (~x30 & (new_n97_ | x18)) | (~x18 & (x16 ? new_n101_ : ~x01));
  assign new_n97_ = new_n65_ & new_n98_ & new_n99_ & new_n100_;
  assign new_n98_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n99_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n100_ = ~x29 & ~x31 & ~x32 & ~x33;
  assign new_n101_ = x33 & (~new_n57_ | ~new_n65_ | ~new_n99_ | ~new_n102_);
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z15 = ~new_n106_ | (x16 & ((new_n70_ & new_n105_) | (x34 & (~new_n70_ | ~new_n104_))));
  assign new_n104_ = new_n85_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n105_ = new_n85_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
