...
module FAU ( 
  ...
  assign z07 = x18 ? x05 : (x16 ? ~new_n74_ : ~x08);
  ...
  assign new_n78_ = new_n64_ & new_n79_ & ~x23 & ~x24;
  ...
  assign new_n86_ = (~x30 | (new_n65_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n77_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n89_ | (~new_n88_ & x31)));
  assign new_n88_ = new_n65_ & new_n77_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n89_ = new_n58_ & new_n68_ & new_n79_ & new_n90_;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? x05 : (x16 ? (new_n92_ | new_n93_) : ~x02);
  assign new_n92_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n79_ | ~new_n90_);
  assign new_n93_ = new_n58_ & new_n68_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? x05 : (x16 ? (new_n97_ | new_n98_) : ~x01);
  assign new_n97_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n94_ | ~new_n95_);
  assign new_n98_ = new_n59_ & new_n72_ & new_n99_ & new_n100_;
