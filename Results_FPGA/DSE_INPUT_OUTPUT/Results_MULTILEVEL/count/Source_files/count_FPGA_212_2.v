...
module FAU ( 
  ...
  assign z06 = ~new_n72_ | (x16 & ((~new_n70_ & x25) | (new_n59_ & new_n71_)));
  assign new_n70_ = new_n58_ & new_n68_;
  assign new_n71_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n72_ = ~x04 & ~x18 & (x09 | x16);
  assign z07 = (~new_n74_ & x16) | x04 | x18 | (~x08 & ~x16);
  assign new_n74_ = (~new_n59_ | ~new_n75_) & (~x26 | (new_n59_ & new_n71_));
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x04 & (x16 ? ~new_n77_ : ~x07));
  assign new_n77_ = (~x27 | (new_n59_ & new_n75_)) & (~new_n62_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~new_n80_ & x16) | x04 | x18 | (~x06 & ~x16);
  assign new_n80_ = (~new_n62_ | ~new_n81_) & (~x28 | (new_n62_ & new_n78_));
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x04 & (x16 ? (new_n83_ | new_n84_) : ~x05));
  assign new_n83_ = x29 & (~new_n62_ | ~new_n81_);
  assign new_n84_ = new_n65_ & new_n85_ & ~x27 & ~x28 & ~x29;
  assign new_n85_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n84_ & x30) | x04 | ~x16 | new_n87_ | x18;
  assign new_n87_ = new_n65_ & new_n85_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = ~new_n92_ | (x16 & ((new_n70_ & new_n89_) | (~new_n87_ & x31)));
  assign new_n89_ = new_n90_ & new_n91_;
  assign new_n90_ = ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n92_ = ~x04 & ~x18 & (x03 | x16);
  assign z13 = x18 | (~x04 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n90_ | ~new_n91_);
