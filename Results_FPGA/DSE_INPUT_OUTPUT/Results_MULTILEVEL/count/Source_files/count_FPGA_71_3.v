...
module FAU ( 
  ...
  assign z06 = new_n67_ | (~x18 & (x16 ? (~new_n64_ & x25) : ~x09));
  assign new_n67_ = ~x21 & (x18 | (new_n68_ & new_n69_));
  ...
  assign z08 = (~x21 & (new_n73_ | x18)) | (~x18 & (x16 ? new_n75_ : ~x07));
  assign new_n73_ = new_n74_ & x16 & ~x17 & ~x19 & ~x20 & ~x22;
  assign new_n74_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n75_ = x27 & (~new_n58_ | ~new_n76_ | x22 | x23);
  assign new_n76_ = ~x24 & ~x25 & ~x26;
  assign z09 = (x16 & (new_n79_ | (~new_n78_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n78_ = new_n60_ & new_n74_;
  assign new_n79_ = new_n60_ & new_n80_ & ~x26 & ~x27 & ~x28;
  assign new_n80_ = ~x23 & ~x24 & ~x25;
  assign z10 = new_n82_ | (~x18 & (x16 ? (~new_n79_ & x29) : ~x05));
  assign new_n82_ = ~x21 & (x18 | (new_n83_ & new_n84_));
  assign new_n83_ = ~x20 & ~x22 & ~x23 & x16 & ~x17 & ~x19;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n86_ & ~x18) | (~x21 & (x18 | (new_n83_ & new_n76_ & new_n87_)));
  assign new_n86_ = x16 ? (~x30 | (new_n62_ & new_n84_)) : x04;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~x21 & (x18 | (new_n89_ & new_n92_ & new_n93_))) | (~new_n91_ & ~x18);
  assign new_n89_ = new_n90_ & x16 & ~x17 & ~x19;
  assign new_n90_ = ~x20 & ~x22 & ~x23 & ~x24;
  assign new_n91_ = x16 ? (~x31 | (new_n62_ & new_n76_ & new_n87_)) : x03;
  assign new_n92_ = ~x25 & ~x26 & ~x27;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x18 & (new_n97_ | new_n98_)) | (~x21 & (x18 | (new_n89_ & new_n95_)));
  assign new_n95_ = new_n96_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n97_ = x16 & x32 & (~new_n57_ | ~new_n65_ | ~new_n92_ | ~new_n93_);
  assign new_n98_ = ~x02 & ~x16;
  assign z14 = ~new_n103_ | (x16 & (new_n100_ | (x33 & (~new_n64_ | ~new_n95_))));
  assign new_n100_ = new_n58_ & new_n69_ & new_n101_ & new_n102_;
  ...
  assign new_n105_ = (~x34 | (new_n58_ & new_n69_ & new_n101_ & new_n102_)) & (~new_n101_ | ~new_n106_ | ~new_n58_ | ~new_n69_);
