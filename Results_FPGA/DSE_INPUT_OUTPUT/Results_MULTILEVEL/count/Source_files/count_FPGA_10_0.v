...
module FAU ( 
  ...
  assign new_n89_ = x31 & (~new_n65_ | ~new_n76_ | ~new_n90_);
  ...
  assign z14 = ~new_n101_ | (x16 & ((new_n71_ & new_n99_) | (~new_n95_ & x33)));
  assign new_n99_ = new_n100_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = x15 & ~x18 & (x01 | x16);
  assign z15 = ~new_n104_ | (x16 & ((new_n71_ & new_n103_) | (x34 & (~new_n71_ | ~new_n99_))));
  assign new_n103_ = new_n100_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n104_ = x15 & ~x18 & (x00 | x16);
endmodule
