...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n68_ | (new_n58_ & new_n69_))) | (~x09 & ~x16) | x18;
  assign new_n68_ = x25 & (~new_n57_ | ~new_n66_);
  assign new_n69_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 ? ~x28 : (x16 ? ~new_n71_ : ~x08);
  assign new_n71_ = (~x26 | (new_n58_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n58_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = x18 ? ~x28 : (x16 ? (new_n73_ | new_n75_) : ~x07);
  assign new_n73_ = x27 & (~new_n58_ | ~new_n74_ | x22 | x23);
  assign new_n74_ = ~x24 & ~x25 & ~x26;
  assign new_n75_ = new_n61_ & new_n76_ & ~x23 & ~x24;
  assign new_n76_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n78_ | (~new_n75_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n78_ = new_n61_ & new_n79_ & ~x26 & ~x27 & ~x28;
  assign new_n79_ = ~x23 & ~x24 & ~x25;
  assign z10 = new_n81_ | (~x18 & (x16 ? (~new_n78_ & x29) : ~x05));
  assign new_n81_ = ~x28 & (x18 | (new_n82_ & new_n83_));
  assign new_n82_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign z11 = (~x28 & (new_n85_ | x18)) | (~x18 & (x16 ? new_n86_ : ~x04));
  assign new_n85_ = new_n82_ & new_n79_ & ~x26 & ~x27 & ~x29 & ~x30;
  assign new_n86_ = x30 & (~new_n63_ | ~new_n74_ | x27 | x28 | x29);
  assign z12 = (~new_n91_ & ~x18) | (~x28 & (x18 | (new_n88_ & new_n90_)));
  assign new_n88_ = new_n89_ & x16 & ~x17 & ~x19;
  assign new_n89_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n90_ = new_n74_ & ~x30 & ~x31 & ~x27 & ~x29;
  assign new_n91_ = x16 ? (~x31 | (new_n63_ & new_n74_ & new_n92_)) : x03;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = (~x18 & (new_n96_ | new_n98_)) | (~x28 & (x18 | (new_n88_ & new_n94_)));
  assign new_n94_ = new_n95_ & ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n96_ = x16 & x32 & (~new_n57_ | ~new_n66_ | ~new_n76_ | ~new_n97_);
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n98_ = ~x02 & ~x16;
  assign z14 = (x16 & (new_n102_ | (~new_n100_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n100_ = new_n57_ & new_n66_ & new_n95_ & new_n101_;
  assign new_n101_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n102_ = new_n58_ & new_n69_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n106_ | (~x18 & (x16 ? (~new_n102_ & x34) : ~x00));
  assign new_n106_ = ~x28 & (x18 | (new_n66_ & new_n107_ & new_n108_ & new_n109_));
  assign new_n107_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n108_ = ~x25 & ~x26 & ~x27 & ~x29;
