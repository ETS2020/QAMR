...
module FAU ( 
  ...
  assign z11 = (~new_n87_ & x16) | ~x04 | x18;
  assign new_n87_ = (~x30 | (new_n65_ & new_n85_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n85_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n93_ | (x16 & ((new_n70_ & new_n90_) | (~new_n89_ & x31)));
  ...
  assign z13 = x18 | (x04 & (x16 ? (new_n95_ | new_n96_) : ~x02));
  ...
  assign z14 = x18 | (x04 & (x16 ? (new_n100_ | new_n101_) : ~x01));
