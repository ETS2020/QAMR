...
module FAU ( 
  ...
  assign z08 = (x16 & (new_n77_ | (~new_n75_ & x27))) | ~new_n78_ | (~x07 & ~x16);
  assign new_n75_ = new_n59_ & new_n76_ & ~x22 & ~x23;
  assign new_n76_ = ~x24 & ~x25 & ~x26;
  assign new_n77_ = new_n62_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n78_ = ~x18 & x32;
  assign z09 = (x16 & (new_n80_ | (~new_n77_ & x28))) | ~new_n78_ | (~x06 & ~x16);
  ...
  assign z11 = (~new_n86_ & x16) | ~new_n78_ | (~x04 & ~x16);
  assign new_n86_ = (~x30 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n76_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n89_ | (~new_n88_ & x31))) | ~new_n78_ | (~x03 & ~x16);
  ...
  assign z15 = ~new_n78_ | (~x00 & ~x16) | (x16 & x34);
endmodule
