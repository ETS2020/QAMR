...
module FAU ( 
  ...
  assign z02 = (x21 & (x17 | x19 | x20)) | ~x16 | x18 | (~x17 & ~x19 & ~x20 & ~x21);
  assign z03 = x18 | (x16 & (new_n58_ | (~new_n57_ & x22)));
  assign new_n57_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n58_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z04 = (~new_n58_ & x23) | ~x16 | new_n60_ | x18;
  assign new_n60_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = (~new_n60_ & x24) | ~x16 | new_n62_ | x18;
  assign new_n62_ = new_n63_ & ~x17 & ~x19 & ~x20;
  assign new_n63_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (~new_n62_ & x25) | ~x16 | new_n65_ | x18;
  ...
  assign z10 = (~new_n73_ & x29) | ~x16 | x18 | (new_n76_ & new_n60_);
  assign new_n76_ = new_n69_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~new_n78_ & x16);
  assign new_n78_ = (~x30 | (new_n60_ & new_n69_ & ~x27 & ~x28 & ~x29)) & (~new_n60_ | ~new_n69_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (x16 & ((~new_n80_ & x31) | (new_n62_ & new_n81_)));
  assign new_n80_ = new_n60_ & new_n69_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = x18 | (x16 & (new_n87_ | (x33 & (~new_n62_ | ~new_n84_))));
  assign new_n87_ = new_n57_ & new_n66_ & new_n88_ & new_n89_;
  assign new_n88_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n89_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n87_ & x34) | ~x16 | x18 | (new_n65_ & new_n91_);
