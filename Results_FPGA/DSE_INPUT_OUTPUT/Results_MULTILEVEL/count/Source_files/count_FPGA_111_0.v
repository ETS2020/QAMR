// Benchmark "FAU" written by ABC on Mon Aug 17 20:11:03 2020
...
module FAU ( 
  ...
  assign z09 = x18 | (x07 & (x16 ? ~new_n80_ : ~x06));
  assign new_n80_ = (~new_n62_ | ~new_n81_) & (~x28 | (new_n62_ & new_n78_ & ~x23 & ~x24));
  assign new_n81_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = x18 | (x07 & (x16 ? (new_n83_ | new_n84_) : ~x05));
  assign new_n83_ = x29 & (~new_n62_ | ~new_n81_);
  assign new_n84_ = new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n86_ & x16) | ~x07 | x18 | (~x04 & ~x16);
  assign new_n86_ = (~x30 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n76_ | x29 | x30 | x27 | x28);
  assign z12 = ~new_n92_ | (x16 & ((new_n88_ & new_n90_) | (~new_n89_ & x31)));
  assign new_n88_ = new_n58_ & new_n68_;
  assign new_n89_ = new_n65_ & new_n76_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n90_ = new_n78_ & new_n91_;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = x07 & ~x18 & (x03 | x16);
  assign z13 = x18 | (x07 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n78_ | ~new_n91_);
  assign new_n95_ = new_n58_ & new_n68_ & new_n96_ & new_n97_;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n102_ | (x16 & ((new_n99_ & new_n100_) | (~new_n95_ & x33)));
  assign new_n99_ = new_n59_ & new_n71_;
  assign new_n100_ = new_n101_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = x07 & ~x18 & (x01 | x16);
  assign z15 = ~new_n105_ | (x16 & ((new_n99_ & new_n104_) | (x34 & (~new_n99_ | ~new_n100_))));
