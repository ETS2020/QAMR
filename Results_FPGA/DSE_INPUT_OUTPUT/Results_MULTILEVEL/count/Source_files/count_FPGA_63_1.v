...
module FAU ( 
  ...
  assign z04 = x18 ? x02 : (x16 ? ~new_n62_ : ~x11);
  ...
  assign new_n72_ = (~x26 | (new_n57_ & new_n70_)) & (~new_n57_ | ~new_n73_);
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? x02 : (x16 ? ~new_n75_ : ~x07);
  ...
  assign new_n79_ = new_n60_ & ~x23 & ~x24 & ~x25 & new_n80_ & ~x26;
  ...
  assign new_n85_ = (~x30 | (new_n63_ & new_n83_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n83_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n88_ | (~new_n87_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n87_ = new_n63_ & new_n83_ & new_n80_ & ~x29 & ~x30;
  ...
  assign z14 = x18 ? x02 : (x16 ? (new_n95_ | new_n96_) : ~x01);
  assign new_n95_ = x33 & (~new_n56_ | ~new_n66_ | ~new_n92_ | ~new_n93_);
  assign new_n96_ = new_n57_ & new_n70_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n101_ | (x16 & ((~new_n96_ & x34) | (new_n69_ & new_n100_)));
