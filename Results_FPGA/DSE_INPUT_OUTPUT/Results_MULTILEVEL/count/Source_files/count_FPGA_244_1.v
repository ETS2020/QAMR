...
module FAU ( 
  ...
  assign z14 = (~x01 & ~x16 & ~x18) | (x16 & (~new_n89_ | (~new_n85_ & x33)));
  assign new_n89_ = ~x18 & (~new_n57_ | ~new_n67_ | ~new_n90_ | ~new_n91_);
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n95_ | (x16 & ((x34 & (~new_n66_ | ~new_n93_)) | (new_n66_ & new_n94_)));
  assign new_n93_ = new_n90_ & new_n91_;
  assign new_n94_ = new_n90_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
