...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n59_, new_n61_, new_n63_, new_n64_, new_n66_,
    ...
    new_n89_, new_n90_, new_n92_, new_n93_, new_n94_;
  ...
  assign new_n79_ = new_n61_ & new_n70_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = (~x01 & ~x16 & ~x18) | (x16 & (~new_n88_ | (~new_n84_ & x33)));
  assign new_n88_ = ~x18 & (~new_n57_ | ~new_n67_ | ~new_n89_ | ~new_n90_);
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n94_ | (x16 & ((x34 & (~new_n66_ | ~new_n92_)) | (new_n66_ & new_n93_)));
  assign new_n92_ = new_n89_ & new_n90_;
  assign new_n93_ = new_n89_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
