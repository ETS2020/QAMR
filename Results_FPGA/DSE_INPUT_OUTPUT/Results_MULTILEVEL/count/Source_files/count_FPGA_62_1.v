...
module FAU ( 
  ...
  assign z07 = (x16 & (new_n71_ | (~new_n69_ & x26))) | ~new_n54_ | (~x08 & ~x16);
  ...
  assign new_n80_ = new_n64_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n82_ & x16) | ~new_n54_ | (~x04 & ~x16);
  assign new_n82_ = (~x30 | (new_n64_ & new_n72_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n72_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (~x31 & ((~x03 & ~x16) | (new_n84_ & new_n85_)));
  assign new_n84_ = new_n72_ & new_n78_ & ~x29 & ~x30;
  assign new_n85_ = new_n86_ & x16 & ~x17 & ~x19;
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z13 = x18 | (~x31 & (x16 ? (new_n88_ | new_n89_) : ~x02));
  assign new_n88_ = x32 & (~new_n64_ | ~new_n72_ | ~new_n78_ | x29 | x30);
  assign new_n89_ = new_n58_ & new_n67_ & new_n75_ & new_n90_;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign z14 = x18 | (~x31 & (x16 ? (new_n92_ | new_n93_) : ~x01));
  assign new_n92_ = x33 & (~new_n58_ | ~new_n67_ | ~new_n75_ | ~new_n90_);
  assign new_n93_ = new_n58_ & new_n67_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign z15 = ~new_n99_ | (x16 & ((~new_n93_ & x34) | (new_n69_ & new_n97_)));
  assign new_n97_ = new_n98_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n98_ = ~x30 & ~x32 & ~x33 & ~x34;
