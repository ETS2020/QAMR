...
module FAU ( 
  ...
  assign z07 = new_n70_ | (~x18 & (x16 ? (~new_n67_ & x26) : ~x08));
  assign new_n70_ = ~x24 & (x18 | (new_n71_ & new_n72_ & ~x21 & ~x22));
  ...
  assign new_n78_ = ~x24 & (x18 | (new_n79_ & new_n80_));
  assign new_n79_ = ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n80_ = ~x22 & ~x23 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = new_n82_ | (~x18 & (x16 ? (~new_n85_ & x29) : ~x05));
  assign new_n82_ = ~x24 & (x18 | (new_n83_ & new_n72_ & new_n84_));
  assign new_n83_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n84_ = ~x27 & ~x28 & ~x29;
  assign new_n85_ = new_n60_ & ~x23 & ~x24 & ~x25 & new_n86_ & ~x26;
  assign new_n86_ = ~x27 & ~x28;
  assign z11 = (~x24 & (new_n88_ | x18)) | (~x18 & (x16 ? new_n90_ : ~x04));
  assign new_n88_ = new_n83_ & new_n72_ & new_n89_;
  assign new_n89_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n90_ = x30 & (~new_n62_ | ~new_n75_ | ~new_n84_);
  assign z12 = (~new_n96_ & ~x18) | (~x24 & (x18 | (new_n92_ & new_n94_)));
  ...
  assign new_n96_ = x16 ? (~x31 | (new_n62_ & new_n75_ & new_n89_)) : x03;
  assign z13 = ~new_n100_ | (x16 & (new_n98_ | (x32 & (~new_n64_ | ~new_n94_))));
  assign new_n98_ = new_n57_ & new_n65_ & new_n99_ & new_n86_ & ~x25 & ~x26;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n100_ = ~x18 & (x02 | x16);
  assign z14 = new_n102_ | (~x18 & (x16 ? (~new_n98_ & x33) : ~x01));
  assign new_n102_ = ~x24 & (x18 | (new_n71_ & new_n103_ & new_n104_ & new_n105_));
  assign new_n103_ = ~x21 & ~x22 & ~x23 & ~x25;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x18 & (new_n109_ | new_n110_)) | (~x24 & (x18 | (new_n107_ & new_n108_)));
  assign new_n107_ = new_n71_ & new_n103_;
  assign new_n108_ = new_n104_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n109_ = x16 & x34 & (~new_n58_ | ~new_n68_ | ~new_n104_ | ~new_n105_);
