...
module FAU ( 
  ...
  assign new_n70_ = (~x25 | (new_n57_ & ~x22 & ~x23 & ~x24)) & (~new_n58_ | x22 | x23 | x24 | x25);
  ...
  assign z10 = (x21 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n84_ : ~x05));
  assign new_n84_ = (~x29 | (new_n67_ & new_n85_)) & (~new_n64_ | ~new_n86_);
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = new_n91_ | (~x18 & (x16 ? (new_n88_ | new_n89_) : ~x04));
  assign new_n88_ = x30 & (~new_n67_ | ~new_n86_);
  assign new_n89_ = new_n64_ & new_n90_ & ~x24 & ~x25 & ~x26;
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = x21 & (x18 | (x16 & x30));
  assign z12 = (x16 & (new_n93_ | (~new_n89_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n93_ = new_n57_ & new_n68_ & new_n81_ & new_n94_;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n96_ | (~new_n93_ & x32))) | x18 | (~x02 & ~x16);
  ...
  assign new_n100_ = new_n58_ & new_n73_ & new_n101_ & new_n102_;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n105_ | (x16 & ((new_n72_ & new_n104_) | (~new_n100_ & x34)));
