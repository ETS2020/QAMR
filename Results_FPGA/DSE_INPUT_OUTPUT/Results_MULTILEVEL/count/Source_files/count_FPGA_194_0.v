...
module FAU ( 
  ...
  assign z07 = x18 | (x06 & (x16 ? ~new_n73_ : ~x08));
  ...
  assign z09 = x18 | (x06 & x16 & (new_n80_ | (~new_n79_ & x28)));
  assign new_n79_ = new_n62_ & new_n77_;
  assign new_n80_ = new_n62_ & ~x23 & ~x24 & ~x25 & new_n81_ & ~x26;
  assign new_n81_ = ~x27 & ~x28;
  assign z10 = ~new_n85_ | (x16 & ((~new_n80_ & x29) | (new_n83_ & new_n65_)));
  assign new_n83_ = new_n84_ & ~x27 & ~x28 & ~x29;
  assign new_n84_ = ~x24 & ~x25 & ~x26;
  assign new_n85_ = x06 & ~x18 & (x05 | x16);
  assign z11 = (~new_n87_ & x16) | ~x06 | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n65_ & new_n84_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n84_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (x06 & (x16 ? (new_n89_ | new_n90_) : ~x03));
  assign new_n89_ = x31 & (~new_n65_ | ~new_n84_ | ~new_n81_ | x29 | x30);
  assign new_n90_ = new_n58_ & new_n68_ & new_n91_ & new_n92_;
  assign new_n91_ = ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x06 & (x16 ? (new_n94_ | new_n95_) : ~x02));
