...
module FAU ( 
  ...
  assign new_n65_ = ~x18 & ~x25;
  assign z05 = (~new_n67_ & x16) | ~new_n65_ | (~x10 & ~x16);
  assign new_n67_ = (new_n64_ | ~x24) & (~new_n58_ | ~new_n68_);
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = ~new_n70_ | ~new_n65_;
  ...
  assign z09 = (x16 & (new_n80_ | (~new_n79_ & x28))) | ~new_n65_ | (~x06 & ~x16);
  assign new_n79_ = new_n59_ & new_n73_ & new_n77_;
  assign new_n80_ = new_n62_ & new_n81_ & ~x23 & ~x24;
  assign new_n81_ = ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x25 & (x16 ? ~new_n83_ : ~x05));
  assign new_n83_ = (~new_n62_ | ~new_n84_) & (~x29 | (new_n62_ & new_n81_ & ~x23 & ~x24));
  assign new_n84_ = ~x23 & ~x24 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x25 & (x16 ? (new_n86_ | new_n87_) : ~x04));
  assign new_n86_ = x30 & (~new_n62_ | ~new_n84_);
  assign new_n87_ = new_n64_ & new_n77_ & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n89_ & x16) | ~new_n65_ | (~x03 & ~x16);
  assign new_n89_ = (~x31 | (new_n64_ & new_n77_ & ~x28 & ~x29 & ~x30)) & (~new_n64_ | ~new_n77_ | x28 | x29 | x30 | x31);
  assign z13 = x18 | (~x25 & (x16 ? (new_n91_ | new_n93_) : ~x02));
  assign new_n91_ = x32 & (~new_n64_ | ~new_n77_ | ~new_n92_ | x30 | x31);
  assign new_n92_ = ~x28 & ~x29;
  assign new_n93_ = new_n58_ & new_n68_ & new_n81_ & new_n94_;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n96_ | (~new_n93_ & x33))) | ~new_n65_ | (~x01 & ~x16);
  assign new_n96_ = new_n58_ & new_n68_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x25 & (x16 ? (new_n100_ | new_n101_) : ~x00));
  assign new_n100_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n97_ | ~new_n98_);
  assign new_n101_ = new_n59_ & new_n73_ & new_n76_ & new_n102_ & new_n103_;
