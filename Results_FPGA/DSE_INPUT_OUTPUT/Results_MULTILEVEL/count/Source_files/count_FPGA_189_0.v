...
module FAU ( 
  ...
  assign z04 = (~new_n64_ & x16) | ~new_n65_ | (~x11 & ~x16);
  assign new_n64_ = (new_n62_ | ~x23) & (~new_n58_ | x21 | x22 | x23);
  assign new_n65_ = ~x18 & x29;
  assign z05 = (~new_n67_ & x16) | ~new_n65_ | (~x10 & ~x16);
  assign new_n67_ = (~x24 | (new_n58_ & ~x21 & ~x22 & ~x23)) & (~new_n58_ | x23 | x24 | x21 | x22);
  assign z06 = (x16 & (new_n70_ | (~new_n69_ & x25))) | ~new_n65_ | (~x09 & ~x16);
  assign new_n69_ = new_n58_ & ~x23 & ~x24 & ~x21 & ~x22;
  ...
  assign z15 = ~new_n65_ | (~x00 & ~x16) | (x16 & x34);
endmodule
