...
module FAU ( 
  ...
  assign z03 = (x16 & (new_n61_ | (~new_n60_ & x22))) | x18 | (~x12 & ~x16);
  ...
  assign z06 = (~x20 & (new_n68_ | x18)) | (~x18 & (x16 ? new_n70_ : ~x09));
  assign new_n68_ = new_n58_ & new_n69_;
  assign new_n69_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n70_ = x25 & (~new_n57_ | ~new_n66_);
  ...
  assign new_n79_ = x16 & ~x17 & ~x19 & ~x21 & ~x22;
  ...
  assign z11 = x18 | (~x04 & ~x16) | (~new_n85_ & x16);
  assign new_n85_ = (~x30 | (new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n75_ | x29 | x30 | x27 | x28);
  assign z12 = (~new_n90_ & ~x18) | (~x20 & (x18 | (new_n87_ & new_n88_)));
  assign new_n87_ = new_n66_ & x16 & ~x17 & ~x19;
  assign new_n88_ = ~x25 & ~x26 & ~x27 & new_n89_ & ~x28 & ~x29;
  assign new_n89_ = ~x30 & ~x31;
  assign new_n90_ = x16 ? (~x31 | (new_n63_ & new_n75_ & new_n91_)) : x03;
  assign new_n91_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = ~new_n96_ | (x16 & (new_n93_ | (x32 & (~new_n65_ | ~new_n88_))));
  assign new_n93_ = new_n57_ & new_n66_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n96_ = ~x18 & (x02 | x16);
  assign z14 = (x16 & (new_n98_ | (~new_n93_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n98_ = new_n60_ & new_n69_ & new_n99_ & new_n89_ & ~x32 & ~x33;
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = new_n101_ | (~x18 & (x16 ? (~new_n98_ & x34) : ~x00));
  assign new_n101_ = ~x20 & (x18 | (new_n58_ & new_n69_ & new_n99_ & new_n102_));
