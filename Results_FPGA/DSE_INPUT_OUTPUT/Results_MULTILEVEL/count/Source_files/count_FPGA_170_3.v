...
module FAU ( 
  ...
  assign new_n66_ = ~x19 & (x18 | (new_n67_ & new_n68_));
  assign new_n67_ = ~x20 & ~x21 & x16 & ~x17;
  assign new_n68_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = new_n70_ | (~x18 & (x16 ? new_n73_ : ~x08));
  assign new_n70_ = ~x19 & (x18 | (new_n67_ & new_n71_ & new_n72_));
  assign new_n71_ = ~x22 & ~x23;
  assign new_n72_ = ~x24 & ~x25 & ~x26;
  assign new_n73_ = x26 & (~new_n57_ | ~new_n68_);
  assign z08 = (~x19 & (x18 | (new_n76_ & new_n77_))) | (~new_n75_ & ~x18);
  assign new_n75_ = x16 ? (~x27 | (new_n57_ & new_n71_ & new_n72_)) : x07;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & x16 & ~x17;
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~x19 & (x18 | (new_n76_ & new_n80_))) | (~new_n79_ & ~x18);
  assign new_n79_ = x16 ? (~x28 | (new_n59_ & new_n77_)) : x06;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~new_n83_ & ~x18) | (~x19 & (x18 | (new_n82_ & new_n84_)));
  assign new_n82_ = new_n71_ & ~x21 & x16 & ~x17 & ~x20;
  assign new_n83_ = x16 ? (~x29 | (new_n59_ & new_n80_)) : x05;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x19 & (x18 | (new_n82_ & new_n72_ & new_n87_))) | (~new_n86_ & ~x18);
  assign new_n86_ = x16 ? (~x30 | (new_n61_ & new_n84_)) : x04;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n92_ & ~x18) | (~x19 & (x18 | (new_n89_ & new_n90_)));
  assign new_n89_ = new_n64_ & x16 & ~x17 & ~x20;
  assign new_n90_ = new_n91_ & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n91_ = ~x25 & ~x26 & ~x27;
  assign new_n92_ = x16 ? (~x31 | (new_n61_ & new_n72_ & new_n87_)) : x03;
  assign z13 = ~new_n97_ | (x16 & (new_n94_ | (x32 & (~new_n63_ | ~new_n90_))));
  ...
  assign new_n99_ = new_n57_ & new_n68_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n103_ & x16) | x18 | (~x00 & ~x16);
  assign new_n103_ = (~x34 | (new_n57_ & new_n68_ & new_n100_ & new_n101_)) & (~new_n57_ | ~new_n68_ | ~new_n100_ | ~new_n104_);
