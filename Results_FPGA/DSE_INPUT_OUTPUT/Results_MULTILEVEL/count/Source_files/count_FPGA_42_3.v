...
module FAU ( 
  ...
  assign z03 = (~x17 & (x18 | (new_n60_ & x16 & ~x19))) | (~new_n59_ & ~x18);
  assign new_n59_ = x16 ? (new_n57_ | ~x22) : x12;
  ...
  assign z07 = new_n71_ | (~x18 & (x16 ? (~new_n68_ & x26) : ~x08));
  assign new_n71_ = ~x17 & (x18 | (new_n72_ & new_n73_ & ~x22 & ~x23));
  assign new_n72_ = ~x20 & ~x21 & x16 & ~x19;
  assign new_n73_ = ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n76_ | (~new_n75_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n75_ = new_n57_ & new_n73_ & ~x22 & ~x23;
  ...
  assign new_n81_ = ~x17 & (x18 | (new_n82_ & new_n83_));
  assign new_n82_ = ~x21 & ~x22 & ~x23 & x16 & ~x19 & ~x20;
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n85_ & x16) | x18 | (~x04 & ~x16);
  assign new_n85_ = (~x30 | (new_n63_ & new_n73_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n73_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n88_ | (~new_n87_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n87_ = new_n63_ & new_n73_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign new_n91_ = ~x17 & (x18 | (new_n92_ & new_n66_ & new_n93_ & new_n94_));
  assign new_n92_ = x16 & ~x19 & ~x20;
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~x17 & (x18 | (new_n96_ & new_n97_))) | (~x18 & (new_n100_ | new_n101_));
  assign new_n96_ = new_n69_ & new_n72_;
  assign new_n97_ = new_n98_ & new_n99_;
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n100_ = x16 & x33 & (~new_n56_ | ~new_n66_ | ~new_n93_ | ~new_n94_);
  assign new_n101_ = ~x01 & ~x16;
  assign z15 = new_n103_ | (~x18 & (x16 ? (~new_n105_ & x34) : ~x00));
  assign new_n103_ = ~x17 & (x18 | (new_n69_ & new_n72_ & new_n98_ & new_n104_));
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n105_ = new_n57_ & new_n69_ & new_n98_ & new_n99_;
endmodule
