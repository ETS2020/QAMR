...
module FAU ( 
  ...
  assign z09 = x18 ? x31 : (x16 ? ~new_n78_ : ~x06);
  assign new_n78_ = (~new_n60_ | ~new_n79_) & (~x28 | (new_n60_ & new_n76_));
  ...
  assign z11 = (x16 & (new_n84_ | (~new_n82_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n84_ = new_n63_ & new_n74_ & new_n85_ & ~x29 & ~x30;
  assign new_n85_ = ~x27 & ~x28;
  assign z12 = ~new_n89_ | (x16 & ((new_n68_ & new_n87_) | (~new_n84_ & x31)));
  assign new_n87_ = new_n88_ & ~x25 & ~x26 & ~x27;
  assign new_n88_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n89_ = ~x18 & (x03 | x16);
  assign z13 = new_n95_ | (~x18 & (x16 ? (new_n91_ | new_n92_) : ~x02));
  assign new_n91_ = x32 & (~new_n63_ | ~new_n74_ | ~new_n85_ | x29 | x30);
  assign new_n92_ = new_n56_ & new_n66_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n95_ = x31 & (x18 | (x16 & x32));
  assign z14 = ~new_n99_ | (x16 & ((new_n69_ & new_n97_) | (~new_n92_ & x33)));
  assign new_n97_ = new_n98_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n99_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n102_ | (x16 & ((new_n69_ & new_n101_) | (x34 & (~new_n69_ | ~new_n97_))));
