...
module FAU ( 
  ...
  assign z11 = (~new_n86_ & ~x18) | (x30 & (x18 | (~new_n84_ & x16)));
  assign new_n86_ = (x04 | x16) & (~new_n88_ | ~new_n87_ | ~x16 | ~new_n76_ | ~new_n89_);
  ...
  assign new_n91_ = x31 & (~new_n64_ | ~new_n76_ | x27 | x28 | x29);
  assign new_n92_ = new_n57_ & new_n67_ & new_n78_ & new_n93_;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = x30 & (x18 | (x16 & x31));
  assign z13 = new_n101_ | (~x18 & (x16 ? (new_n96_ | new_n98_) : ~x02));
  assign new_n96_ = x32 & (~new_n64_ | ~new_n76_ | ~new_n97_ | x29 | x31);
  ...
  assign new_n101_ = x30 & (x18 | (x16 & x32));
  assign z14 = new_n108_ | (~x18 & (x16 ? (new_n103_ | new_n105_) : ~x01));
  assign new_n103_ = x33 & (~new_n57_ | ~new_n67_ | ~new_n78_ | ~new_n104_);
  assign new_n104_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign new_n105_ = new_n58_ & new_n71_ & new_n106_ & new_n107_;
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n108_ = x30 & (x18 | (x16 & x33));
  assign z15 = ~new_n111_ | (x16 & ((new_n70_ & new_n110_) | (~new_n105_ & x34)));
