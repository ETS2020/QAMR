...
module FAU ( 
  ...
  assign z07 = (~x25 & (new_n73_ | x18)) | (~x18 & (x16 ? new_n74_ : ~x08));
  assign new_n73_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x26;
  assign new_n74_ = x26 & (~new_n58_ | ~new_n75_);
  ...
  assign z09 = (x16 & (new_n82_ | (~new_n79_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n82_ = new_n61_ & new_n83_;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n85_ | (~new_n82_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n85_ = new_n64_ & new_n78_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & x16) | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n64_ & new_n78_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n78_ | x27 | x28 | x29 | x30);
  assign z12 = (~new_n93_ & ~x18) | (~x25 & (x18 | (new_n89_ & new_n91_)));
  assign new_n89_ = new_n90_ & x16 & ~x17 & ~x19;
  assign new_n90_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n91_ = new_n92_ & ~x24 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x16 ? (~x31 | (new_n64_ & new_n78_ & new_n94_)) : x03;
  assign new_n94_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = (~x18 & (new_n98_ | new_n99_)) | (~x25 & (x18 | (new_n89_ & new_n96_)));
  assign new_n96_ = new_n97_ & ~x27 & ~x28 & ~x24 & ~x26;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n98_ = x16 & x32 & (~new_n57_ | ~new_n67_ | ~new_n80_ | ~new_n92_);
  assign new_n99_ = ~x02 & ~x16;
  assign z14 = (~x18 & (new_n104_ | new_n106_)) | (~x25 & (x18 | (new_n70_ & new_n101_)));
  assign new_n101_ = new_n102_ & new_n103_;
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n104_ = x16 & x33 & (~new_n57_ | ~new_n67_ | ~new_n97_ | ~new_n105_);
  assign new_n105_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n106_ = ~x01 & ~x16;
  assign z15 = (~x18 & (new_n109_ | new_n110_)) | (~x25 & (x18 | (new_n70_ & new_n108_)));
  assign new_n108_ = new_n102_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n109_ = x16 & x34 & (~new_n58_ | ~new_n75_ | ~new_n102_ | ~new_n103_);
