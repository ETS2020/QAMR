...
module FAU ( 
  ...
  assign z09 = x16 ? (~x18 & (new_n73_ | (~new_n71_ & x28))) : (~x06 | x18);
  assign new_n73_ = new_n59_ & new_n74_;
  assign new_n74_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n76_ | (~new_n73_ & x29))) : (~x05 | x18);
  assign new_n76_ = new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29;
  assign z11 = x16 ? (~new_n78_ & ~x18) : (~x04 | x18);
  ...
  assign z13 = x16 ? (~x18 & (new_n84_ | (~new_n81_ & x32))) : (~x02 | x18);
