...
module FAU ( 
  ...
  assign new_n73_ = x27 & (~new_n58_ | ~new_n69_ | ~new_n74_);
  ...
  assign z12 = new_n89_ | (~x18 & (x16 ? (new_n86_ | new_n87_) : ~x03));
  assign new_n86_ = x31 & (~new_n63_ | ~new_n74_ | x27 | x28 | x30);
  assign new_n87_ = new_n57_ & new_n66_ & new_n76_ & new_n88_;
  assign new_n88_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n89_ = x29 & (x18 | (x16 & x31));
  assign z13 = new_n96_ | (~x18 & (x16 ? (new_n91_ | new_n93_) : ~x02));
  assign new_n91_ = x32 & (~new_n63_ | ~new_n74_ | ~new_n92_);
  ...
  assign new_n96_ = x29 & (x18 | (x16 & x32));
  assign z14 = new_n103_ | (~x18 & (x16 ? (new_n98_ | new_n100_) : ~x01));
  assign new_n98_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n76_ | ~new_n99_);
  assign new_n99_ = ~x28 & ~x30 & ~x31 & ~x32;
  assign new_n100_ = new_n101_ & new_n102_ & new_n58_ & new_n69_ & ~x24 & ~x25;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n103_ = x29 & (x18 | (x16 & x33));
  assign z15 = new_n108_ | (~x18 & (x16 ? (new_n105_ | new_n106_) : ~x00));
  assign new_n105_ = x34 & (~new_n57_ | ~new_n66_ | ~new_n94_ | ~new_n102_);
  assign new_n106_ = new_n101_ & new_n107_ & new_n58_ & new_n69_ & ~x24 & ~x25;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n108_ = x29 & (x18 | (x16 & x34));
endmodule
