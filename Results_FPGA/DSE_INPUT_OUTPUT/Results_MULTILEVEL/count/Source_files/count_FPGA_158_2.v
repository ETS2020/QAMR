...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n58_, new_n59_, new_n61_, new_n62_, new_n64_, new_n65_,
  ...
  assign z02 = (x16 & ((x21 & (x19 | x20)) | (~x19 & ~x20 & ~x21))) | ~new_n54_ | (~x13 & ~x16);
  ...
  assign new_n64_ = (~x24 | (new_n65_ & ~x21 & ~x22 & ~x23)) & (~new_n65_ | x17 | x23 | x24 | x21 | x22);
  assign new_n65_ = ~x19 & ~x20;
  assign z06 = (x16 & (new_n67_ | (~new_n69_ & x25))) | ~new_n54_ | (~x09 & ~x16);
  assign new_n67_ = new_n58_ & new_n68_;
  assign new_n68_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n69_ = ~x22 & ~x23 & ~x24 & ~x19 & ~x20 & ~x21;
  assign z07 = (x16 & (new_n71_ | (~new_n67_ & x26))) | ~new_n54_ | (~x08 & ~x16);
  ...
  assign z10 = x18 | (~x17 & (x16 ? (new_n80_ | new_n81_) : ~x05));
  assign new_n80_ = x29 & (~new_n62_ | ~new_n78_ | x24 | x25);
  assign new_n81_ = new_n62_ & new_n82_;
  assign new_n82_ = ~x27 & ~x28 & ~x29 & ~x24 & ~x25 & ~x26;
  assign z11 = x18 | (~x17 & (x16 ? (new_n84_ | new_n85_) : ~x04));
  assign new_n84_ = x30 & (~new_n62_ | ~new_n82_);
  assign new_n85_ = new_n69_ & new_n75_ & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x17 & (x16 ? ~new_n87_ : ~x03));
  assign new_n87_ = (~x31 | (new_n69_ & new_n75_ & ~x28 & ~x29 & ~x30)) & (~new_n69_ | ~new_n75_ | x30 | x31 | x28 | x29);
  assign z13 = (x16 & (new_n90_ | (~new_n89_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n89_ = new_n69_ & new_n75_ & ~x30 & ~x31 & ~x28 & ~x29;
  ...
  assign z15 = x18 | (~x17 & (x16 ? (new_n98_ | new_n99_) : ~x00));
