...
module FAU ( 
  ...
  assign z03 = x18 ? ~x03 : (x16 ? ~new_n59_ : ~x12);
  ...
  assign z06 = x18 ? ~x03 : (new_n67_ | (~x09 & ~x16));
  ...
  assign z09 = x18 ? ~x03 : (x16 ? ~new_n78_ : ~x06);
  assign new_n78_ = (~new_n60_ | ~new_n79_) & (~x28 | (new_n60_ & new_n76_ & ~x23 & ~x24));
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x03 : (x16 ? (new_n81_ | new_n82_) : ~x05);
  assign new_n81_ = x29 & (~new_n60_ | ~new_n79_);
  assign new_n82_ = new_n62_ & new_n83_ & ~x27 & ~x28 & ~x29;
  assign new_n83_ = ~x24 & ~x25 & ~x26;
  assign z11 = x18 ? ~x03 : (x16 ? ~new_n85_ : ~x04);
  assign new_n85_ = (~x30 | (new_n62_ & new_n83_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n83_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n88_ | (~new_n87_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n87_ = new_n62_ & new_n83_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n88_ = new_n56_ & new_n65_ & new_n76_ & new_n89_;
