...
module FAU ( 
  ...
  assign z12 = x18 | (x03 & x16 & (new_n90_ | (~new_n89_ & x31)));
  assign new_n89_ = new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z14 = ~new_n102_ | (x16 & ((new_n98_ & new_n99_) | (~new_n94_ & x33)));
  assign new_n98_ = new_n59_ & new_n71_;
  assign new_n99_ = new_n100_ & new_n101_;
  assign new_n100_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n101_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n102_ = x03 & ~x18 & (x01 | x16);
  assign z15 = x18 | (x03 & (x16 ? ~new_n104_ : ~x00));
  assign new_n104_ = (~x34 | (new_n59_ & new_n71_ & new_n100_ & new_n101_)) & (~new_n59_ | ~new_n71_ | ~new_n100_ | ~new_n105_);
