...
module FAU ( 
  ...
  assign new_n62_ = ~x18 & ~x34;
  assign z04 = x18 | (~x34 & (x16 ? ~new_n64_ : ~x11));
  assign new_n64_ = ~new_n65_ & (new_n61_ | ~x23);
  ...
  assign z06 = (x16 & (new_n71_ | (~new_n70_ & x25))) | ~new_n62_ | (~x09 & ~x16);
  ...
  assign z08 = (x16 & (new_n77_ | (~new_n75_ & x27))) | ~new_n62_ | (~x07 & ~x16);
  ...
  assign z09 = (x16 & (new_n80_ | (~new_n77_ & x28))) | ~new_n62_ | (~x06 & ~x16);
  assign new_n80_ = new_n61_ & new_n81_;
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x34 & (x16 ? (new_n83_ | new_n84_) : ~x05));
  ...
  assign z12 = x18 | (~x34 & (x16 ? (new_n89_ | new_n91_) : ~x03));
  assign new_n89_ = x31 & (~new_n65_ | ~new_n76_ | ~new_n90_ | x27 | x28);
  assign new_n90_ = ~x29 & ~x30;
  assign new_n91_ = new_n58_ & new_n68_ & new_n78_ & new_n92_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x34 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n78_ | ~new_n92_);
  assign new_n95_ = new_n58_ & new_n68_ & new_n96_ & new_n90_ & ~x31 & ~x32;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z14 = ~new_n100_ | (x16 & ((new_n71_ & new_n98_) | (~new_n95_ & x33)));
  assign new_n98_ = new_n85_ & ~x26 & ~x27 & new_n99_ & ~x30 & ~x31;
  assign new_n99_ = ~x32 & ~x33;
  assign new_n100_ = new_n62_ & (x01 | x16);
  assign z15 = ~new_n62_ | new_n102_ | (~x00 & ~x16);
  assign new_n102_ = new_n68_ & new_n103_ & new_n96_ & new_n90_ & new_n99_ & ~x31;
