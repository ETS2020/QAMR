...
module FAU ( 
  ...
  assign new_n64_ = new_n65_ & ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (x17 & (x18 | (x16 & x25))) | (~x18 & (x16 ? ~new_n67_ : ~x09));
  assign new_n67_ = (new_n70_ | ~x25) & (~new_n68_ | ~new_n69_ | x24 | x25);
  assign new_n68_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n69_ = ~x22 & ~x23;
  assign new_n70_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = (x17 & (x18 | (x16 & x26))) | (~x18 & (x16 ? ~new_n72_ : ~x08));
  assign new_n72_ = (~x26 | (new_n59_ & new_n69_ & ~x24 & ~x25)) & (~new_n68_ | ~new_n69_ | x24 | x25 | x26);
  assign z08 = (x16 & (new_n76_ | (~new_n74_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n74_ = new_n68_ & new_n69_ & new_n75_;
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign new_n76_ = new_n60_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n78_ | (~new_n76_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n78_ = new_n60_ & ~x26 & ~x27 & ~x28 & new_n79_ & ~x23;
  assign new_n79_ = ~x24 & ~x25;
  assign z10 = (x17 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n81_ : ~x05));
  assign new_n81_ = (~x29 | (new_n82_ & new_n83_)) & (~new_n62_ | ~new_n84_);
  assign new_n82_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n86_ & x16) | x18 | (~x04 & ~x16);
  assign new_n86_ = (~x30 | (new_n62_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n75_ | x29 | x30 | x27 | x28);
  assign z12 = ~new_n91_ | (x16 & ((~new_n88_ & x31) | (new_n64_ & new_n89_)));
  assign new_n88_ = new_n62_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n89_ = new_n90_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n91_ = ~x18 & (x03 | x16);
  assign z13 = new_n97_ | (~x18 & (x16 ? (new_n93_ | new_n94_) : ~x02));
  assign new_n93_ = x32 & (~new_n70_ | ~new_n90_ | x25 | x26 | x27);
  assign new_n94_ = new_n95_ & new_n96_ & new_n65_ & ~x17 & ~x19 & ~x20;
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n97_ = x17 & (x18 | (x16 & x32));
  assign z14 = ~new_n103_ | (x16 & ((~new_n94_ & x33) | (new_n99_ & new_n100_)));
  assign new_n99_ = new_n68_ & new_n69_ & new_n79_;
  ...
  assign new_n105_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n79_ | ~new_n101_ | ~new_n102_);
  assign new_n106_ = new_n68_ & new_n69_ & new_n79_ & new_n101_ & new_n107_;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n108_ = x17 & (x18 | (x16 & x34));
endmodule
