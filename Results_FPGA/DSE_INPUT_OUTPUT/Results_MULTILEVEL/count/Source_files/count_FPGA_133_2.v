...
module FAU ( 
  ...
  assign z06 = x18 | (~x04 & (new_n70_ | (~x09 & ~x16)));
  ...
  assign new_n79_ = ~x04 & ~x18 & (x07 | x16);
  assign z09 = ~new_n82_ | (x16 & ((new_n62_ & new_n81_) | (x28 & (~new_n77_ | ~new_n62_))));
  assign new_n81_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign new_n82_ = ~x04 & ~x18 & (x06 | x16);
  assign z10 = (x16 & (new_n84_ | new_n85_)) | x04 | x18 | (~x05 & ~x16);
  assign new_n84_ = x29 & (~new_n62_ | ~new_n81_);
  assign new_n85_ = new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x04 & (new_n87_ | ~x16 | (~new_n85_ & x30)));
  assign new_n87_ = new_n65_ & new_n76_ & new_n88_;
  assign new_n88_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x04 & (x16 ? (new_n90_ | new_n91_) : ~x03));
  assign new_n90_ = x31 & (~new_n65_ | ~new_n76_ | ~new_n88_);
  assign new_n91_ = new_n58_ & new_n68_ & new_n78_ & new_n92_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x04 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n78_ | ~new_n92_);
  ...
  assign new_n105_ = (~x34 | (new_n59_ & new_n71_ & new_n101_ & new_n102_)) & (~new_n59_ | ~new_n71_ | ~new_n101_ | ~new_n106_);
