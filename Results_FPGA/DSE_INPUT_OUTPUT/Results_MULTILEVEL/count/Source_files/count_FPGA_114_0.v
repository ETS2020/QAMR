...
module FAU ( 
  ...
  assign new_n79_ = new_n62_ & new_n70_ & new_n75_ & ~x29 & ~x30;
  assign z12 = (~new_n79_ & x31) | ~x16 | new_n81_ | x18;
  assign new_n81_ = new_n56_ & new_n65_ & new_n82_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~new_n81_ & x32) | ~x16 | new_n84_ | x18;
  assign new_n84_ = new_n56_ & new_n65_ & new_n85_ & new_n75_ & ~x25 & ~x26;
  assign new_n85_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((~new_n84_ & x33) | (new_n67_ & new_n87_)));
  assign new_n87_ = new_n88_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n88_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = x18 | (x16 & ((new_n67_ & new_n90_) | (x34 & (~new_n67_ | ~new_n87_))));
