...
module FAU ( 
  ...
  assign z10 = ~new_n54_ | (~x05 & ~x16) | (new_n81_ & new_n83_);
  assign new_n83_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign z11 = (x16 & (new_n85_ | (~new_n80_ & x30))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n85_ = new_n65_ & new_n76_ & ~x27 & ~x28 & ~x30;
  assign z12 = x18 | (~x29 & (x16 ? ~new_n87_ : ~x03));
  assign new_n87_ = (~x31 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x30)) & (~new_n65_ | ~new_n76_ | x30 | x31 | x27 | x28);
  assign z13 = (x16 & (new_n90_ | (~new_n89_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n89_ = new_n65_ & new_n76_ & ~x30 & ~x31 & ~x27 & ~x28;
  assign new_n90_ = new_n58_ & new_n68_ & new_n78_ & new_n91_;
  assign new_n91_ = ~x28 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x29 & (x16 ? (new_n93_ | new_n94_) : ~x01));
