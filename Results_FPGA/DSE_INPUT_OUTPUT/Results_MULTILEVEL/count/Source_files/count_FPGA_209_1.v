...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n70_ | new_n71_)) | ~new_n72_ | (~x09 & ~x16);
  assign new_n70_ = x25 & (~new_n58_ | ~new_n68_);
  assign new_n71_ = new_n59_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n72_ = ~x18 & ~x29;
  assign z07 = (~new_n74_ & x16) | ~new_n72_ | (~x08 & ~x16);
  assign new_n74_ = (~x26 | (new_n59_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n59_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = x18 | (~x29 & (x16 ? (new_n76_ | new_n78_) : ~x07));
  assign new_n76_ = x27 & (~new_n59_ | ~new_n77_ | x22 | x23);
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign new_n78_ = new_n62_ & new_n79_ & ~x23 & ~x24;
  assign new_n79_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x29 & (x16 ? ~new_n81_ : ~x06));
  assign new_n81_ = (~new_n62_ | ~new_n82_) & (~x28 | (new_n62_ & new_n79_ & ~x23 & ~x24));
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n72_ | (~x05 & ~x16) | (new_n82_ & new_n84_);
  assign new_n84_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign z11 = ~new_n72_ | (~x04 & ~x16) | (x16 & (new_n87_ | (~new_n86_ & x30)));
  assign new_n86_ = new_n62_ & new_n82_;
  assign new_n87_ = new_n65_ & new_n77_ & new_n88_ & ~x27;
  assign new_n88_ = ~x28 & ~x30;
  assign z12 = (~new_n90_ & x16) | ~new_n72_ | (~x03 & ~x16);
  assign new_n90_ = (~x31 | (new_n65_ & new_n77_ & ~x27 & ~x28 & ~x30)) & (~new_n65_ | ~new_n77_ | x27 | x28 | x30 | x31);
  assign z13 = ~new_n72_ | (~x02 & ~x16) | (x16 & (new_n93_ | (~new_n92_ & x32)));
  assign new_n92_ = new_n65_ & new_n77_ & ~x27 & ~x28 & ~x30 & ~x31;
  assign new_n93_ = new_n58_ & new_n68_ & new_n79_ & new_n88_ & ~x31 & ~x32;
  assign z14 = ~new_n72_ | (~x01 & ~x16) | (x16 & (new_n95_ | (~new_n93_ & x33)));
  assign new_n95_ = new_n58_ & new_n68_ & new_n96_ & new_n97_;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n97_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n101_ | (x16 & ((new_n71_ & new_n99_) | (~new_n95_ & x34)));
  assign new_n99_ = new_n100_ & new_n88_ & ~x26 & ~x27;
  assign new_n100_ = ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n101_ = new_n72_ & (x00 | x16);
endmodule
