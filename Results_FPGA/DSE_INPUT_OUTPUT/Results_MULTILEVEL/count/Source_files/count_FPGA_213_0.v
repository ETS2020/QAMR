...
module FAU ( 
  ...
  assign z00 = (x16 & (~x17 ^ x19)) | (~x15 & ~x16) | x18 | ~x21;
  assign z01 = (~new_n55_ & x16) | (~x14 & ~x16) | x18 | ~x21;
  assign new_n55_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z02 = new_n57_ | x18;
  assign new_n57_ = x21 & (x16 ? (x17 | x19 | x20) : ~x13);
  assign z03 = x18 | ~x21 | (~x12 & ~x16) | (x16 & x22);
  assign z04 = x18 | ~x21 | (~x11 & ~x16) | (x16 & x23);
  ...
  assign z09 = x18 | (x21 & (x16 ? x28 : ~x06));
  assign z10 = x18 | (x21 & (x16 ? x29 : ~x05));
  assign z11 = x18 | ~x21 | (~x04 & ~x16) | (x16 & x30);
  assign z12 = x18 | ~x21 | (~x03 & ~x16) | (x16 & x31);
  assign z13 = x18 | (x21 & (x16 ? x32 : ~x02));
  assign z14 = x18 | ~x21 | (~x01 & ~x16) | (x16 & x33);
