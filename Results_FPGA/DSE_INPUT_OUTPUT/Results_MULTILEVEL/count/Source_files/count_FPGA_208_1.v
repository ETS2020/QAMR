...
module FAU ( 
  ...
  assign new_n72_ = (~x26 | (new_n58_ & new_n68_)) & (~new_n59_ | ~new_n73_);
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x26;
  assign z08 = (~new_n75_ & x16) | ~new_n54_ | (~x07 & ~x16);
  assign new_n75_ = (~x27 | (new_n59_ & ~x24 & ~x26 & ~x22 & ~x23)) & (~new_n59_ | x22 | x23 | x24 | x26 | x27);
  ...
  assign new_n85_ = new_n65_ & new_n78_ & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x25 & (x16 ? ~new_n87_ : ~x03));
  assign new_n87_ = (~x31 | (new_n65_ & new_n78_ & ~x28 & ~x29 & ~x30)) & (~new_n65_ | ~new_n78_ | x28 | x29 | x30 | x31);
  assign z13 = x18 | (~x25 & (x16 ? (new_n89_ | new_n90_) : ~x02));
  assign new_n89_ = x32 & (~new_n65_ | ~new_n78_ | ~new_n83_ | x30 | x31);
  assign new_n90_ = new_n58_ & new_n68_ & new_n80_ & new_n91_;
  assign new_n91_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x25 & (x16 ? (new_n93_ | new_n94_) : ~x01));
  assign new_n93_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n80_ | ~new_n91_);
  assign new_n94_ = new_n58_ & new_n68_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x25 & (x16 ? (new_n98_ | new_n99_) : ~x00));
  assign new_n98_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n95_ | ~new_n96_);
  assign new_n99_ = new_n59_ & new_n73_ & new_n100_ & new_n101_;
