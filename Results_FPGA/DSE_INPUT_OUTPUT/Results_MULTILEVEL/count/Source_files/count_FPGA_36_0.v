...
module FAU ( 
  ...
  assign new_n76_ = new_n60_ & new_n69_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n76_ & x30) | ~x16 | new_n78_ | x18;
  assign new_n78_ = new_n60_ & new_n69_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | (x16 & ((~new_n78_ & x31) | (new_n62_ & new_n80_)));
  assign new_n80_ = new_n81_ & ~x25 & ~x26 & ~x27;
  assign new_n81_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x32 & (~new_n62_ | ~new_n80_)) | ~x16 | x18 | (new_n62_ & new_n83_);
  assign new_n83_ = new_n84_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n84_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & (new_n86_ | (x33 & (~new_n62_ | ~new_n83_))));
  assign new_n86_ = new_n57_ & new_n66_ & new_n87_ & new_n88_;
  assign new_n87_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n88_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n86_ & x34) | ~x16 | x18 | (new_n65_ & new_n90_);
