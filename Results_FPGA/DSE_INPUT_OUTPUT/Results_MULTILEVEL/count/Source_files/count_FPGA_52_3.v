...
module FAU ( 
  ...
  assign new_n81_ = new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n75_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z14 = ~new_n96_ | (x16 & ((new_n69_ & new_n93_) | (~new_n89_ & x33)));
  ...
  assign z15 = (~x00 & (~x16 | x18)) | (x16 & ~new_n98_ & ~x18);
  assign new_n98_ = (~x34 | (new_n58_ & new_n70_ & new_n94_ & new_n95_)) & (~new_n58_ | ~new_n70_ | ~new_n94_ | ~new_n99_);
