...
module FAU ( 
  ...
  assign new_n94_ = new_n95_ & new_n96_ & new_n62_ & new_n70_;
  assign new_n95_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n96_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n54_ & (~new_n101_ | (x16 & (new_n98_ | (~new_n94_ & x33))));
  assign new_n98_ = new_n99_ & new_n100_ & new_n63_ & new_n73_;
  assign new_n99_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n100_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n101_ = ~x18 & (x01 | x16);
  assign z15 = (x16 & (new_n103_ | (~new_n98_ & x34))) | (~new_n107_ & (~x14 | x34));
  assign new_n103_ = new_n104_ & new_n105_ & new_n99_ & new_n106_;
  assign new_n104_ = ~x19 & ~x20 & ~x14 & ~x17;
