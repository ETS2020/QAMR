...
module FAU ( 
  ...
  assign z03 = (~new_n61_ & x16) | ~x10 | x18 | (~x12 & ~x16);
  ...
  assign z11 = (~new_n86_ & x16) | ~x10 | x18 | (~x04 & ~x16);
  assign new_n86_ = (~x30 | (new_n65_ & new_n84_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n84_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n92_ | (x16 & ((~new_n88_ & x31) | (new_n67_ & new_n89_)));
  ...
  assign new_n92_ = x10 & ~x18 & (x03 | x16);
