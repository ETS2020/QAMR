...
module FAU ( 
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n73_ | new_n74_));
  assign new_n73_ = x26 & (~new_n59_ | ~new_n71_);
  assign new_n74_ = new_n75_ & ~x17 & ~x18 & ~x19 & ~x20 & ~x21;
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (~x27 & (x18 | (new_n75_ & new_n78_))) | (~new_n77_ & ~x18);
  assign new_n77_ = x16 ? (~x27 | (new_n59_ & new_n75_)) : x07;
  ...
  assign z10 = new_n84_ | (~x18 & (x16 ? (~new_n87_ & x29) : ~x05));
  assign new_n84_ = ~x27 & (x18 | (new_n85_ & new_n86_));
  assign new_n85_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n87_ = new_n62_ & ~x23 & ~x24 & ~x25 & new_n88_ & ~x26;
  assign new_n88_ = ~x27 & ~x28;
  assign z11 = (~new_n90_ & x16) | x18 | (~x04 & ~x16);
  assign new_n90_ = (~x30 | (new_n65_ & new_n91_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n91_ | x27 | x28 | x29 | x30);
  assign new_n91_ = ~x24 & ~x25 & ~x26;
  assign z12 = new_n94_ | (~x18 & (x16 ? (~new_n93_ & x31) : ~x03));
  assign new_n93_ = new_n65_ & new_n91_ & new_n88_ & ~x29 & ~x30;
  assign new_n94_ = ~x27 & (x18 | (new_n95_ & new_n96_ & new_n91_ & new_n97_));
  assign new_n95_ = x16 & ~x17 & ~x19;
  assign new_n96_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n100_ | (~new_n99_ & x32)));
  assign new_n99_ = new_n58_ & new_n68_ & new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n100_ = new_n58_ & new_n68_ & new_n101_ & new_n88_ & ~x25 & ~x26;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = new_n103_ | (~x18 & (x16 ? (~new_n100_ & x33) : ~x01));
  ...
  assign new_n108_ = (~x34 | (new_n59_ & new_n71_ & new_n106_ & new_n109_)) & (~new_n59_ | ~new_n71_ | ~new_n109_ | ~new_n110_);
