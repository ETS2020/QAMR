...
module FAU ( 
  ...
  assign new_n76_ = new_n58_ & new_n73_ & new_n74_;
  ...
  assign new_n85_ = (~x30 | (new_n64_ & new_n74_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n74_ | x29 | x30 | x27 | x28);
  assign z12 = new_n90_ | (~x18 & (x16 ? (new_n87_ | new_n88_) : ~x03));
  assign new_n87_ = x31 & (~new_n64_ | ~new_n74_ | x27 | x28 | x30);
  assign new_n88_ = new_n57_ & new_n67_ & new_n78_ & new_n89_;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n90_ = x29 & (x18 | (x16 & x31));
  assign z13 = ~new_n95_ | (x16 & ((new_n92_ & new_n93_) | (~new_n88_ & x32)));
  assign new_n92_ = new_n57_ & new_n67_;
  assign new_n93_ = new_n94_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x18 & (x02 | x16);
  assign z14 = new_n102_ | (~x18 & (x16 ? (new_n97_ | new_n99_) : ~x01));
  assign new_n97_ = x33 & (~new_n57_ | ~new_n67_ | ~new_n78_ | ~new_n98_);
  assign new_n98_ = ~x28 & ~x30 & ~x31 & ~x32;
  assign new_n99_ = new_n58_ & new_n70_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n102_ = x29 & (x18 | (x16 & x33));
  assign z15 = new_n107_ | (~x18 & (x16 ? (new_n104_ | new_n105_) : ~x00));
  assign new_n104_ = x34 & (~new_n57_ | ~new_n67_ | ~new_n94_ | ~new_n101_);
  assign new_n105_ = new_n58_ & new_n70_ & new_n100_ & new_n106_;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n107_ = x29 & (x18 | (x16 & x34));
endmodule
