...
module FAU ( 
  ...
  assign z03 = x18 ? x12 : (x16 ? (new_n59_ | (~new_n57_ & x22)) : ~x12);
  assign new_n59_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z04 = x18 ? x12 : (x16 ? ~new_n61_ : ~x11);
  ...
  assign z07 = x18 ? x12 : (x16 ? ~new_n71_ : ~x08);
  ...
  assign new_n80_ = new_n62_ & new_n74_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n82_ & x16) | x18 | (~x04 & ~x16);
  assign new_n82_ = (~x30 | (new_n62_ & new_n74_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n74_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n85_ | (~new_n84_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n84_ = new_n62_ & new_n74_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = x18 ? x12 : (x16 ? (new_n92_ | new_n93_) : ~x01);
  assign new_n92_ = x33 & (~new_n56_ | ~new_n65_ | ~new_n89_ | ~new_n90_);
  assign new_n93_ = new_n57_ & new_n69_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n98_ | (x16 & ((new_n68_ & new_n97_) | (~new_n93_ & x34)));
