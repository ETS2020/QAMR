...
module FAU ( 
  ...
  assign z07 = (~x08 & (~x16 | x18)) | (x16 & ~new_n72_ & ~x18);
  ...
  assign new_n76_ = (~x27 | (new_n57_ & new_n73_ & new_n74_)) & (~new_n60_ | ~new_n77_);
  ...
  assign new_n100_ = (~x34 | (new_n97_ & new_n98_ & new_n57_ & new_n70_)) & (~new_n57_ | ~new_n70_ | ~new_n97_ | ~new_n101_);
