...
module FAU ( 
  ...
  assign z06 = x18 ? x08 : (x16 ? ~new_n69_ : ~x09);
  assign new_n69_ = (~x25 | (new_n56_ & new_n67_)) & (~new_n57_ | ~new_n70_);
  assign new_n70_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = x18 ? x08 : (x16 ? ~new_n72_ : ~x08);
  assign new_n72_ = (~x26 | (new_n57_ & new_n70_)) & (~new_n57_ | ~new_n73_ | ~new_n74_);
  assign new_n73_ = ~x22 & ~x23;
  assign new_n74_ = ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? x08 : (x16 ? ~new_n76_ : ~x07);
  assign new_n76_ = (~new_n60_ | ~new_n77_) & (~x27 | (new_n57_ & new_n73_ & new_n74_));
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n80_ | (~new_n79_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n79_ = new_n60_ & new_n77_;
  assign new_n80_ = new_n60_ & ~x23 & ~x24 & ~x25 & new_n81_ & ~x26;
  ...
  assign z12 = x18 ? x08 : (x16 ? (new_n87_ | new_n88_) : ~x03);
  assign new_n87_ = x31 & (~new_n63_ | ~new_n74_ | ~new_n81_ | x29 | x30);
  ...
  assign new_n91_ = new_n92_ & new_n93_ & new_n56_ & new_n67_;
  assign new_n92_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n93_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 ? x08 : (x16 ? (new_n95_ | new_n96_) : ~x01);
  assign new_n95_ = x33 & (~new_n92_ | ~new_n93_ | ~new_n56_ | ~new_n67_);
  assign new_n96_ = new_n97_ & new_n98_ & new_n57_ & new_n70_;
  assign new_n97_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n98_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x18 ? x08 : (x16 ? ~new_n100_ : ~x00);
  assign new_n100_ = (~x34 | (new_n97_ & new_n98_ & new_n57_ & new_n70_)) & (~new_n97_ | ~new_n101_ | ~new_n57_ | ~new_n70_);
