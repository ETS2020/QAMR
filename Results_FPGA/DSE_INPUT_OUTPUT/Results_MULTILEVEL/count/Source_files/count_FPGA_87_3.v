...
module FAU ( 
  ...
  assign z04 = (~x11 & (~x16 | x18)) | (x16 & ~x18 & (new_n61_ | (~new_n59_ & x23)));
  assign new_n61_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = x18 ? ~x11 : (x16 ? ~new_n63_ : ~x10);
  ...
  assign z11 = x18 ? ~x11 : (x16 ? ~new_n83_ : ~x04);
  ...
  assign new_n85_ = new_n61_ & new_n81_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z14 = ~new_n96_ | (x16 & ((new_n67_ & new_n93_) | (~new_n89_ & x33)));
  ...
  assign z15 = x18 ? ~x11 : (x16 ? ~new_n98_ : ~x00);
  assign new_n98_ = (~x34 | (new_n57_ & new_n68_ & new_n94_ & new_n95_)) & (~new_n57_ | ~new_n68_ | ~new_n94_ | ~new_n99_);
