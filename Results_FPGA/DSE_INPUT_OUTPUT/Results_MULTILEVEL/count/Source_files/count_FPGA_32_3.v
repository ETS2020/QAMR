...
module FAU ( 
  ...
  assign new_n77_ = new_n61_ & new_n78_ & ~x23 & ~x24;
  assign new_n78_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? ~x14 : (x16 ? ~new_n80_ : ~x06);
  assign new_n80_ = (~new_n61_ | ~new_n81_) & (~x28 | (new_n61_ & new_n78_ & ~x23 & ~x24));
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x14 : (x16 ? (new_n83_ | new_n84_) : ~x05);
  assign new_n83_ = x29 & (~new_n61_ | ~new_n81_);
  ...
  assign z12 = x18 ? ~x14 : (x16 ? (new_n88_ | new_n90_) : ~x03);
  assign new_n88_ = x31 & (~new_n64_ | ~new_n75_ | ~new_n89_ | x29 | x30);
  ...
  assign new_n93_ = x32 & (~new_n57_ | ~new_n68_ | ~new_n78_ | ~new_n91_);
  assign new_n94_ = new_n57_ & new_n68_ & new_n95_ & new_n89_ & ~x25 & ~x26;
  assign new_n95_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n100_ | (x16 & ((new_n71_ & new_n97_) | (~new_n94_ & x33)));
  ...
  assign z15 = x18 ? ~x14 : (x16 ? ~new_n102_ : ~x00);
  assign new_n102_ = (~x34 | (new_n58_ & new_n72_ & new_n98_ & new_n99_)) & (~new_n58_ | ~new_n72_ | ~new_n98_ | ~new_n103_);
