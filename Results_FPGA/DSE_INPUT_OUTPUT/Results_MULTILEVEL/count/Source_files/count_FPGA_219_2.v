...
module FAU ( 
  ...
  assign z08 = (~x18 & (x16 ? ~new_n74_ : ~x07)) | (x25 & (x18 | (x16 & x27)));
  assign new_n74_ = (~x27 | (new_n58_ & new_n76_)) & (~new_n60_ | ~new_n75_ | ~new_n77_);
  assign new_n75_ = ~x23 & ~x24;
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x26;
  assign new_n77_ = ~x25 & ~x26 & ~x27;
  assign z09 = (~x18 & (x16 ? ~new_n79_ : ~x06)) | (x25 & (x18 | (x16 & x28)));
  assign new_n79_ = (~x28 | (new_n58_ & new_n80_)) & (~new_n60_ | ~new_n81_);
  assign new_n80_ = ~x22 & ~x23 & ~x24 & ~x26 & ~x27;
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~x18 & (x16 ? ~new_n83_ : ~x05)) | (x25 & (x18 | (x16 & x29)));
  assign new_n83_ = (~x29 | (new_n60_ & new_n75_ & new_n84_)) & (~new_n63_ | ~new_n85_);
  assign new_n84_ = ~x26 & ~x27 & ~x28;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & x16) | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n63_ & new_n88_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n88_ | x27 | x28 | x29 | x30);
  assign new_n88_ = ~x24 & ~x25 & ~x26;
  assign z12 = new_n94_ | (~x18 & (x16 ? (new_n90_ | new_n92_) : ~x03));
  assign new_n90_ = x31 & (~new_n63_ | ~new_n91_);
  assign new_n91_ = ~x24 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n92_ = new_n57_ & new_n66_ & new_n77_ & new_n93_;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = x25 & (x18 | (x16 & x31));
  assign z13 = ~new_n98_ | (x16 & ((new_n68_ & new_n96_) | (~new_n92_ & x32)));
  assign new_n96_ = new_n97_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n98_ = ~x18 & (x02 | x16);
  assign z14 = new_n104_ | (~x18 & (x16 ? (new_n100_ | new_n101_) : ~x01));
  assign new_n100_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n84_ | ~new_n97_);
  assign new_n101_ = new_n58_ & new_n70_ & new_n102_ & new_n103_;
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n104_ = x25 & (x18 | (x16 & x33));
  assign z15 = new_n109_ | (~x18 & (x16 ? (new_n106_ | new_n107_) : ~x00));
  assign new_n106_ = x34 & (~new_n57_ | ~new_n66_ | ~new_n102_ | ~new_n103_);
  assign new_n107_ = new_n58_ & new_n70_ & new_n102_ & new_n108_;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n109_ = x25 & (x18 | (x16 & x34));
endmodule
