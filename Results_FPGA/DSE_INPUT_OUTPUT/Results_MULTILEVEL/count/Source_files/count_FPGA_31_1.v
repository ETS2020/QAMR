...
module FAU ( 
  ...
  assign new_n74_ = new_n59_ & ~x23 & ~x24 & ~x25 & new_n75_ & ~x26;
  assign new_n75_ = ~x27 & ~x28;
  assign z10 = (~x05 & ~x16 & ~x18) | (x16 & ((~new_n74_ & x29) | new_n77_ | x18));
  assign new_n77_ = new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~x04 & ~x16 & ~x18) | (x16 & ((~new_n77_ & x30) | new_n79_ | x18));
  assign new_n79_ = new_n61_ & new_n69_ & new_n75_ & ~x29 & ~x30;
  assign z12 = (~x03 & ~x16 & ~x18) | (x16 & (new_n81_ | x18 | (new_n63_ & new_n82_)));
  assign new_n81_ = x31 & (~new_n61_ | ~new_n69_ | ~new_n75_ | x29 | x30);
  assign new_n82_ = new_n72_ & new_n83_;
  assign new_n83_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x02 & ~x16 & ~x18) | (x16 & (new_n85_ | x18 | (new_n63_ & new_n86_)));
  assign new_n85_ = x32 & (~new_n56_ | ~new_n64_ | ~new_n72_ | ~new_n83_);
  ...
  assign z15 = ~new_n95_ | (x16 & ((new_n66_ & new_n94_) | (x34 & (~new_n66_ | ~new_n91_))));
  assign new_n94_ = new_n92_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
