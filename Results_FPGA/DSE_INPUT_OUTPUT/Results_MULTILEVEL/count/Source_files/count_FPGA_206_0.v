...
module FAU ( 
  ...
  assign z14 = ~new_n86_ | (x33 & (~new_n62_ | ~new_n83_));
  assign new_n86_ = x16 & ~x18 & (~new_n57_ | ~new_n66_ | ~new_n87_ | ~new_n88_);
  assign new_n87_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n88_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x34 & (~new_n65_ | ~new_n90_)) | ~x16 | x18 | (new_n65_ & new_n91_);
  assign new_n90_ = new_n87_ & new_n88_;
  assign new_n91_ = new_n87_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
