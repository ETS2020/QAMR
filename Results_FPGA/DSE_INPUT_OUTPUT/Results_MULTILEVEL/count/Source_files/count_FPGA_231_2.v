...
module FAU ( 
  ...
  assign new_n74_ = new_n58_ & new_n70_ & new_n75_;
  ...
  assign new_n81_ = (~x29 | (new_n61_ & new_n82_)) & (~new_n63_ | ~new_n83_);
  ...
  assign z12 = ~new_n90_ | (x16 & ((new_n68_ & new_n88_) | (~new_n87_ & x31)));
  assign new_n87_ = new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n88_ = ~x25 & ~x26 & ~x27 & new_n89_ & ~x30 & ~x31;
  assign new_n89_ = ~x28 & ~x29;
  assign new_n90_ = ~x18 & (x03 | x16);
  assign z13 = new_n96_ | (~x18 & (x16 ? (new_n92_ | new_n93_) : ~x02));
  assign new_n92_ = x32 & (~new_n63_ | ~new_n75_ | ~new_n89_ | x30 | x31);
  ...
  assign new_n98_ = new_n99_ & new_n100_ & new_n58_ & new_n70_ & ~x24 & ~x25;
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n106_ | (~x18 & (x16 ? (new_n102_ | new_n104_) : ~x00));
  assign new_n102_ = x34 & (~new_n57_ | ~new_n66_ | ~new_n100_ | ~new_n103_);
  assign new_n103_ = ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n104_ = new_n99_ & new_n105_ & new_n58_ & new_n70_ & ~x24 & ~x25;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n106_ = x27 & (x18 | (x16 & x34));
endmodule
