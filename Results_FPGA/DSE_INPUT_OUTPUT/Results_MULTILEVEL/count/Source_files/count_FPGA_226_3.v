...
module FAU ( 
  ...
  assign z03 = x18 ? ~x09 : (x16 ? ~new_n59_ : ~x12);
  ...
  assign z06 = (~x09 & (~x16 | x18)) | (x16 & ~x18 & (new_n67_ | (~new_n64_ & x25)));
  assign new_n67_ = new_n57_ & new_n68_;
  assign new_n68_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 ? ~x09 : (x16 ? ~new_n70_ : ~x08);
  ...
  assign new_n72_ = new_n57_ & new_n73_ & ~x22 & ~x23;
  assign new_n73_ = ~x24 & ~x25 & ~x26;
  assign new_n74_ = new_n60_ & new_n75_ & ~x23 & ~x24;
  assign new_n75_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? ~x09 : (x16 ? ~new_n77_ : ~x06);
  assign new_n77_ = (~x28 | (new_n60_ & new_n75_ & ~x23 & ~x24)) & (~new_n60_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x09 : (x16 ? (new_n80_ | new_n81_) : ~x05);
  assign new_n80_ = x29 & (~new_n60_ | ~new_n78_);
  assign new_n81_ = new_n62_ & new_n73_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n62_ & new_n73_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n73_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n62_ & new_n73_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n86_ = new_n56_ & new_n65_ & new_n75_ & new_n87_;
  ...
  assign z14 = ~new_n96_ | (x16 & ((~new_n89_ & x33) | (new_n67_ & new_n93_)));
  ...
  assign z15 = x18 ? ~x09 : (x16 ? ~new_n98_ : ~x00);
  assign new_n98_ = (~x34 | (new_n57_ & new_n68_ & new_n94_ & new_n95_)) & (~new_n94_ | ~new_n99_ | ~new_n57_ | ~new_n68_);
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
