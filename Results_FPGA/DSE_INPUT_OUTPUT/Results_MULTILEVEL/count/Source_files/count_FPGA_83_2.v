...
module FAU ( 
  ...
  assign new_n73_ = (~x26 | (new_n57_ & new_n74_)) & (~new_n58_ | ~new_n75_);
  assign new_n74_ = ~x21 & ~x22 & ~x23 & ~x25;
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = new_n80_ | (~x18 & (x16 ? (new_n77_ | new_n78_) : ~x07));
  assign new_n77_ = x27 & (~new_n58_ | x25 | x26 | x22 | x23);
  assign new_n78_ = new_n61_ & new_n79_ & ~x23 & ~x24;
  assign new_n79_ = ~x25 & ~x26 & ~x27;
  assign new_n80_ = x24 & (x18 | (x16 & x27));
  assign z09 = (x16 & (new_n82_ | (~new_n78_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n82_ = new_n61_ & ~x23 & ~x24 & ~x25 & new_n83_ & ~x26;
  assign new_n83_ = ~x27 & ~x28;
  assign z10 = (~x18 & (x16 ? ~new_n85_ : ~x05)) | (x24 & (x18 | (x16 & x29)));
  assign new_n85_ = (~x29 | (new_n61_ & new_n86_)) & (~new_n64_ | ~new_n87_);
  assign new_n86_ = ~x23 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n89_ & x16) | x18 | (~x04 & ~x16);
  assign new_n89_ = (~x30 | (new_n64_ & new_n90_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n90_ | x27 | x28 | x29 | x30);
  assign new_n90_ = ~x24 & ~x25 & ~x26;
  assign z12 = new_n95_ | (~x18 & (x16 ? (new_n92_ | new_n93_) : ~x03));
  assign new_n92_ = x31 & (~new_n64_ | ~new_n79_ | x28 | x29 | x30);
  assign new_n93_ = new_n57_ & new_n67_ & new_n79_ & new_n94_ & ~x28 & ~x29;
  assign new_n94_ = ~x30 & ~x31;
  assign new_n95_ = x24 & (x18 | (x16 & x31));
  assign z13 = new_n100_ | (~x18 & (x16 ? (new_n97_ | new_n98_) : ~x02));
  assign new_n97_ = x32 & (~new_n64_ | ~new_n79_ | ~new_n94_ | x28 | x29);
  assign new_n98_ = new_n57_ & new_n67_ & new_n99_ & new_n83_ & ~x25 & ~x26;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n100_ = x24 & (x18 | (x16 & x32));
  assign z14 = ~new_n105_ | (x16 & ((~new_n98_ & x33) | (new_n70_ & new_n102_)));
  ...
  assign new_n107_ = x34 & (~new_n57_ | ~new_n74_ | ~new_n103_ | ~new_n104_);
  assign new_n108_ = new_n58_ & new_n71_ & new_n103_ & new_n109_;
