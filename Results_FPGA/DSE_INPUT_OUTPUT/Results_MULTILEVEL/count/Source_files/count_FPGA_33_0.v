...
module FAU ( 
  ...
  assign z12 = x18 | (x16 & ((~new_n79_ & x31) | (new_n64_ & new_n81_)));
  ...
  assign z14 = (~new_n84_ & x33) | ~x16 | x18 | (new_n67_ & new_n88_);
  assign new_n88_ = new_n89_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (x34 & (~new_n67_ | ~new_n88_)) | ~x16 | x18 | (new_n67_ & new_n91_);
