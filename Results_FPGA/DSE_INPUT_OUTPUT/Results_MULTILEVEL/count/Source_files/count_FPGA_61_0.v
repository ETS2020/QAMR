...
module FAU ( 
  ...
  assign z04 = (~new_n64_ & x16) | ~x04 | x18 | (~x11 & ~x16);
  assign new_n64_ = ~new_n65_ & (new_n62_ | ~x23);
  assign new_n65_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = (~new_n67_ & x16) | ~x04 | x18 | (~x10 & ~x16);
  ...
  assign new_n89_ = new_n65_ & new_n84_ & ~x27 & ~x28 & ~x29 & ~x30;
