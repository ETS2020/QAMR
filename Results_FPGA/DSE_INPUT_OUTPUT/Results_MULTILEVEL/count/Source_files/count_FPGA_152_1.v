...
module FAU ( 
  ...
  assign z06 = (~x09 & ~x16 & ~x18) | (x16 & ((~new_n63_ & x25) | new_n66_ | x18));
  ...
  assign z09 = (~x06 & ~x16 & ~x18) | (x16 & ((~new_n72_ & x28) | new_n74_ | x18));
  ...
  assign new_n81_ = x31 & (~new_n61_ | ~new_n70_ | ~new_n75_ | x29 | x30);
  assign new_n82_ = new_n83_ & ~x25 & ~x26 & ~x27;
  assign new_n83_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n88_ | (x16 & (new_n85_ | (x32 & (~new_n63_ | ~new_n82_))));
  ...
  assign z14 = (~x01 & ~x16 & ~x18) | (x16 & (~new_n90_ | (~new_n85_ & x33)));
  assign new_n90_ = ~x18 & (~new_n57_ | ~new_n67_ | ~new_n91_ | ~new_n92_);
  assign new_n91_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n92_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x00 & ~x16 & ~x18) | (x16 & (new_n94_ | x18 | (new_n66_ & new_n95_)));
  assign new_n94_ = x34 & (~new_n57_ | ~new_n67_ | ~new_n91_ | ~new_n92_);
  assign new_n95_ = new_n91_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
