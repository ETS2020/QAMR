...
module FAU ( 
  ...
  assign z01 = (x16 & (((x17 | x19) & x20) | (~x17 & ~x18 & ~x19 & ~x20))) | x18 | (~x14 & ~x16);
  ...
  assign z10 = x16 ? (~x18 & (new_n79_ | (~new_n76_ & x29))) : (~x05 | x18);
  assign new_n79_ = new_n61_ & new_n80_ & ~x27 & ~x28 & ~x29;
  assign new_n80_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n82_ & x16) | x18 | (~x04 & ~x16);
  assign new_n82_ = (~x30 | (new_n61_ & new_n80_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n80_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n85_ | (~new_n84_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n84_ = new_n61_ & new_n80_ & new_n77_ & ~x29 & ~x30;
  assign new_n85_ = new_n56_ & new_n65_ & new_n86_ & ~x25 & ~x26 & ~x27;
  assign new_n86_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = (x16 & (new_n88_ | (~new_n85_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n88_ = new_n56_ & new_n65_ & new_n89_ & new_n77_ & ~x25 & ~x26;
  assign new_n89_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n93_ | (x16 & ((new_n68_ & new_n91_) | (~new_n88_ & x33)));
  assign new_n91_ = new_n92_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n92_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n93_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n96_ | (x16 & ((new_n68_ & new_n95_) | (x34 & (~new_n68_ | ~new_n91_))));
