...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n69_ | new_n70_)) | x18 | (~x09 & ~x16);
  assign new_n69_ = x25 & (~new_n57_ | ~new_n67_);
  assign new_n70_ = new_n58_ & new_n71_;
  assign new_n71_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = x18 ? ~x12 : (x16 ? ~new_n73_ : ~x08);
  assign new_n73_ = (~x26 | (new_n58_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n58_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n77_ | (~new_n75_ & x27)));
  assign new_n75_ = new_n58_ & new_n76_ & ~x22 & ~x23;
  assign new_n76_ = ~x24 & ~x25 & ~x26;
  assign new_n77_ = new_n63_ & new_n78_ & ~x23 & ~x24;
  assign new_n78_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? ~x12 : (x16 ? (new_n80_ | new_n81_) : ~x06);
  assign new_n80_ = x28 & (~new_n63_ | ~new_n78_ | x23 | x24);
  assign new_n81_ = new_n63_ & new_n82_;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x12 : (x16 ? (new_n84_ | new_n85_) : ~x05);
  assign new_n84_ = x29 & (~new_n63_ | ~new_n82_);
  assign new_n85_ = new_n64_ & new_n76_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & x16) | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n64_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n76_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n90_ | (~new_n89_ & x31)));
  assign new_n89_ = new_n64_ & new_n76_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n90_ = new_n57_ & new_n67_ & new_n78_ & new_n91_;
  ...
  assign z14 = ~new_n100_ | (x16 & ((new_n70_ & new_n97_) | (~new_n93_ & x33)));
  ...
  assign z15 = x18 ? ~x12 : (x16 ? ~new_n102_ : ~x00);
  assign new_n102_ = (~x34 | (new_n58_ & new_n71_ & new_n98_ & new_n99_)) & (~new_n58_ | ~new_n71_ | ~new_n98_ | ~new_n103_);
