...
module FAU ( 
  ...
  assign z13 = (~x32 & (new_n91_ | x18)) | (~x18 & (x16 ? (~new_n88_ & x32) : ~x02));
  assign new_n91_ = new_n89_ & new_n93_ & new_n92_ & x16 & ~x17 & ~x19;
  assign new_n92_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n93_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign z14 = (~x32 & (new_n95_ | x18)) | (~x18 & (x16 ? new_n99_ : ~x01));
  assign new_n95_ = new_n68_ & new_n96_ & new_n97_ & new_n98_;
  assign new_n96_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n97_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n98_ = ~x29 & ~x30 & ~x31 & ~x33;
  assign new_n99_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n97_ | ~new_n100_);
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z15 = ~new_n106_ | (x16 & ((new_n102_ & new_n105_) | (x34 & (~new_n102_ | ~new_n103_))));
  assign new_n102_ = new_n59_ & new_n71_ & ~x24 & ~x25;
  assign new_n103_ = new_n104_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = new_n104_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
