// Benchmark "FAU" written by ABC on Mon Aug 17 20:10:52 2020
...
module FAU ( 
  ...
  assign z00 = (x16 & (~x17 ^ x19)) | x02 | x18 | (~x15 & ~x16);
  ...
  assign z05 = (~new_n67_ & x16) | x02 | x18 | (~x10 & ~x16);
  ...
  assign new_n73_ = ~x02 & ~x18 & (x09 | x16);
  assign z07 = (~new_n75_ & x16) | x02 | x18 | (~x08 & ~x16);
  assign new_n75_ = (~new_n59_ | ~new_n76_) & (~x26 | (new_n59_ & new_n72_));
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x02 & (x16 ? ~new_n78_ : ~x07));
  assign new_n78_ = (~x27 | (new_n59_ & new_n76_)) & (~new_n62_ | ~new_n79_);
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~new_n81_ & x16) | x02 | x18 | (~x06 & ~x16);
  assign new_n81_ = (~new_n62_ | ~new_n82_) & (~x28 | (new_n62_ & new_n79_));
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n84_ | new_n85_)) | x02 | x18 | (~x05 & ~x16);
  assign new_n84_ = x29 & (~new_n62_ | ~new_n82_);
  assign new_n85_ = new_n65_ & new_n86_ & ~x27 & ~x28 & ~x29;
  assign new_n86_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n88_ & x16) | x02 | x18 | (~x04 & ~x16);
  assign new_n88_ = (~x30 | (new_n65_ & new_n86_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n86_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n93_ | (x16 & ((new_n70_ & new_n91_) | (~new_n90_ & x31)));
  assign new_n90_ = new_n65_ & new_n86_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n92_ & ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n93_ = ~x02 & ~x18 & (x03 | x16);
  assign z13 = (x32 & (~new_n70_ | ~new_n91_)) | ~new_n98_ | x18 | (new_n70_ & new_n95_);
  ...
  assign new_n100_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n96_ | ~new_n97_);
  assign new_n101_ = new_n59_ & new_n72_ & new_n102_ & new_n103_;
  assign new_n102_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n103_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = ~new_n106_ | (x16 & ((new_n71_ & new_n105_) | (~new_n101_ & x34)));
  assign new_n105_ = new_n102_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n106_ = ~x02 & ~x18 & (x00 | x16);
endmodule
