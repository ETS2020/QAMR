...
module FAU ( 
  ...
  assign new_n79_ = new_n61_ & new_n70_ & new_n75_ & ~x29 & ~x30;
  ...
  assign z14 = (x16 & (new_n90_ | (~new_n85_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n90_ = new_n57_ & new_n67_ & new_n91_ & new_n92_;
  assign new_n91_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n92_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & ((~new_n90_ & x34) | new_n94_ | x18)) | (~x00 & ~x16 & ~x18);
  assign new_n94_ = new_n57_ & new_n67_ & new_n91_ & new_n95_;
  assign new_n95_ = ~x32 & ~x33 & ~x34 & ~x30 & ~x31;
endmodule
