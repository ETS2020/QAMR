...
module FAU ( 
  ...
  assign new_n78_ = (~x28 | (new_n61_ & new_n76_ & ~x23 & ~x24)) & (~new_n61_ | ~new_n79_);
  assign new_n79_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = ~new_n54_ | (~x05 & ~x16) | (new_n79_ & new_n81_);
  assign new_n81_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign z11 = (x16 & (new_n84_ | (~new_n83_ & x30))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n83_ = new_n61_ & new_n79_;
  assign new_n84_ = new_n63_ & new_n74_ & ~x27 & ~x28 & ~x30;
  assign z12 = x18 | (~x29 & (x16 ? ~new_n86_ : ~x03));
  assign new_n86_ = (~x31 | (new_n63_ & new_n74_ & ~x27 & ~x28 & ~x30)) & (~new_n63_ | ~new_n74_ | x30 | x31 | x27 | x28);
  assign z13 = x18 | (~x29 & (x16 ? (new_n88_ | new_n90_) : ~x02));
  assign new_n88_ = x32 & (~new_n63_ | ~new_n74_ | ~new_n89_);
  assign new_n89_ = ~x27 & ~x28 & ~x30 & ~x31;
  assign new_n90_ = new_n58_ & new_n66_ & new_n76_ & new_n91_;
  assign new_n91_ = ~x28 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x29 & (x16 ? (new_n93_ | new_n94_) : ~x01));
  assign new_n93_ = x33 & (~new_n58_ | ~new_n66_ | ~new_n76_ | ~new_n91_);
  assign new_n94_ = new_n58_ & new_n66_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x29 & (x16 ? (new_n98_ | new_n99_) : ~x00));
  assign new_n98_ = x34 & (~new_n58_ | ~new_n66_ | ~new_n95_ | ~new_n96_);
  assign new_n99_ = new_n59_ & new_n69_ & new_n100_ & new_n101_;
