...
module FAU ( 
  ...
  assign z14 = (x16 & (new_n89_ | (~new_n85_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n89_ = new_n57_ & new_n67_ & new_n90_ & new_n91_;
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & ((~new_n89_ & x34) | new_n93_ | x18)) | (~x00 & ~x16 & ~x18);
  assign new_n93_ = new_n57_ & new_n67_ & new_n90_ & new_n94_;
