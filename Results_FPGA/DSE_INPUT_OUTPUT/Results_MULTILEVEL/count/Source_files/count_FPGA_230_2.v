...
module FAU ( 
  ...
  assign z08 = x18 ? x28 : (x16 ? ~new_n74_ : ~x07);
  ...
  assign z10 = (~x18 & (x16 ? ~new_n81_ : ~x05)) | (x28 & (x18 | (x16 & x29)));
  assign new_n81_ = (~x29 | (new_n61_ & new_n76_)) & (~new_n63_ | ~new_n82_);
  assign new_n82_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x18 & (x16 ? ~new_n84_ : ~x04)) | (x28 & (x18 | (x16 & x30)));
  assign new_n84_ = (~x30 | (new_n61_ & new_n85_)) & (~new_n63_ | ~new_n75_ | ~new_n86_);
  assign new_n85_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n86_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n91_ | (~x18 & (x16 ? (new_n88_ | new_n89_) : ~x03));
  assign new_n88_ = x31 & (~new_n63_ | ~new_n75_ | x27 | x29 | x30);
  assign new_n89_ = new_n57_ & new_n66_ & new_n90_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n91_ = x28 & (x18 | (x16 & x31));
  assign z13 = new_n98_ | (~x18 & (x16 ? (new_n93_ | new_n95_) : ~x02));
  assign new_n93_ = x32 & (~new_n63_ | ~new_n75_ | ~new_n94_);
  ...
  assign new_n98_ = x28 & (x18 | (x16 & x32));
  assign z14 = (x16 & (new_n100_ | (~new_n95_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n100_ = new_n101_ & new_n102_ & new_n58_ & new_n70_ & ~x24 & ~x25;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n108_ | (~x18 & (x16 ? (new_n104_ | new_n106_) : ~x00));
  assign new_n104_ = x34 & (~new_n57_ | ~new_n66_ | ~new_n102_ | ~new_n105_);
  assign new_n105_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n106_ = new_n101_ & new_n107_ & new_n58_ & new_n70_ & ~x24 & ~x25;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n108_ = x28 & (x18 | (x16 & x34));
endmodule
