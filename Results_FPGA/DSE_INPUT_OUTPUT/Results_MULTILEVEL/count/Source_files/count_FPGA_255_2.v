...
module FAU ( 
  ...
  assign new_n64_ = (new_n65_ | ~x24) & (~new_n56_ | x23 | x24 | x21 | x22);
  ...
  assign z07 = (x16 & (new_n72_ | (~new_n68_ & x26))) | x18 | (~x08 & ~x16);
  ...
  assign z09 = new_n81_ | (~x18 & (x16 ? (new_n78_ | new_n79_) : ~x06));
  assign new_n78_ = x28 & (~new_n76_ | x17 | x19 | x20 | x22);
  assign new_n79_ = new_n60_ & ~x23 & ~x24 & ~x25 & new_n80_ & ~x26;
  assign new_n80_ = ~x27 & ~x28;
  assign new_n81_ = x21 & (x18 | (x16 & x28));
  assign z10 = (x16 & (new_n83_ | (~new_n79_ & x29))) | x18 | (~x05 & ~x16);
  ...
  assign new_n86_ = x30 & (~new_n65_ | ~new_n84_);
  assign new_n87_ = new_n62_ & new_n73_ & new_n80_ & ~x29 & ~x30;
  assign new_n88_ = x21 & (x18 | (x16 & x30));
  assign z12 = ~new_n92_ | (x16 & ((~new_n87_ & x31) | (new_n67_ & new_n90_)));
  assign new_n90_ = new_n91_ & ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n96_ | (x16 & ((new_n67_ & new_n94_) | (x32 & (~new_n67_ | ~new_n90_))));
  assign new_n94_ = new_n95_ & new_n80_ & ~x25 & ~x26;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n96_ = ~x18 & (x02 | x16);
  assign z14 = new_n102_ | (~x18 & (x16 ? (new_n98_ | new_n99_) : ~x01));
  assign new_n98_ = x33 & (~new_n56_ | ~new_n70_ | ~new_n95_ | ~new_n80_ | x26);
  assign new_n99_ = new_n69_ & new_n70_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n102_ = x21 & (x18 | (x16 & x33));
  assign z15 = ~new_n105_ | (x16 & ((~new_n99_ & x34) | (new_n68_ & new_n104_)));
