...
module FAU ( 
  ...
  assign z07 = (~new_n73_ & x16) | x06 | x18 | (~x08 & ~x16);
  ...
  assign z09 = x18 | (~x06 & (new_n80_ | ~x16 | (~new_n79_ & x28)));
  ...
  assign new_n97_ = ~x06 & ~x18 & (x02 | x16);
  assign z14 = x18 | (~x06 & (x16 ? (new_n99_ | new_n100_) : ~x01));
  ...
  assign z15 = ~new_n106_ | (x16 & ((new_n104_ & new_n105_) | (~new_n100_ & x34)));
  assign new_n104_ = new_n59_ & new_n71_;
  assign new_n105_ = new_n101_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n106_ = ~x06 & ~x18 & (x00 | x16);
endmodule
