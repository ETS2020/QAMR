...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n57_, new_n58_, new_n59_, new_n61_, new_n63_, new_n64_,
  ...
  assign z09 = ~new_n54_ | (~x06 & ~x16) | (new_n78_ & new_n80_ & x16 & ~x17);
  assign new_n78_ = new_n79_ & ~x22 & ~x23 & ~x24;
  assign new_n79_ = ~x25 & ~x26 & ~x27;
  assign new_n80_ = ~x19 & ~x20 & ~x21;
  assign z10 = (~new_n82_ & x16) | ~new_n54_ | (~x05 & ~x16);
  assign new_n82_ = (~new_n61_ | ~new_n83_) & (~x29 | (new_n61_ & new_n76_));
  assign new_n83_ = ~x26 & ~x27 & ~x29 & ~x23 & ~x24 & ~x25;
  assign z11 = x18 | (~x28 & (x16 ? (new_n85_ | new_n86_) : ~x04));
  assign new_n85_ = x30 & (~new_n61_ | ~new_n83_);
  assign new_n86_ = new_n64_ & new_n87_ & ~x27 & ~x29 & ~x30;
  assign new_n87_ = ~x24 & ~x25 & ~x26;
  assign z12 = x18 | (~x28 & (x16 ? ~new_n89_ : ~x03));
  assign new_n89_ = (~x31 | (new_n64_ & new_n87_ & ~x27 & ~x29 & ~x30)) & (~new_n64_ | ~new_n87_ | x30 | x31 | x27 | x29);
  assign z13 = x18 | (~x28 & (x16 ? (new_n91_ | new_n93_) : ~x02));
  assign new_n91_ = x32 & (~new_n64_ | ~new_n87_ | ~new_n92_ | x30 | x31);
  assign new_n92_ = ~x27 & ~x29;
  assign new_n93_ = new_n58_ & new_n67_ & new_n79_ & new_n94_;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x28 & (x16 ? (new_n96_ | new_n97_) : ~x01));
  assign new_n96_ = x33 & (~new_n58_ | ~new_n67_ | ~new_n79_ | ~new_n94_);
  assign new_n97_ = new_n58_ & new_n67_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x28 & (x16 ? (new_n101_ | new_n102_) : ~x00));
  assign new_n101_ = x34 & (~new_n58_ | ~new_n67_ | ~new_n98_ | ~new_n99_);
  assign new_n102_ = new_n59_ & new_n70_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x26 & ~x27 & ~x29 & ~x30;
