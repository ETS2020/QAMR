...
module FAU ( 
  ...
  assign new_n81_ = new_n62_ & new_n82_ & ~x26 & ~x27 & ~x28;
  assign new_n82_ = ~x23 & ~x24 & ~x25;
  assign z10 = x18 | (~x30 & (x16 ? (new_n84_ | new_n85_) : ~x05));
  assign new_n84_ = x29 & (~new_n62_ | ~new_n82_ | x26 | x27 | x28);
  assign new_n85_ = new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x30 & (new_n87_ | (~x04 & ~x16)));
  assign new_n87_ = new_n88_ & new_n82_ & new_n89_;
  assign new_n88_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z12 = x18 | (~x30 & (x16 ? ~new_n91_ : ~x03));
  assign new_n91_ = (~x31 | (new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n75_ | x29 | x31 | x27 | x28);
  assign z13 = (x16 & (new_n94_ | (~new_n93_ & x32))) | ~new_n55_ | (~x02 & ~x16);
  assign new_n93_ = new_n65_ & new_n75_ & ~x29 & ~x31 & ~x27 & ~x28;
  assign new_n94_ = new_n58_ & new_n68_ & new_n78_ & new_n95_;
  assign new_n95_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign z14 = x18 | (~x30 & (x16 ? (new_n97_ | new_n98_) : ~x01));
  assign new_n97_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n78_ | ~new_n95_);
  assign new_n98_ = new_n58_ & new_n68_ & new_n99_ & new_n100_;
  assign new_n99_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n100_ = ~x29 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n103_ | (x16 & ((new_n73_ & new_n102_) | (~new_n98_ & x34)));
  assign new_n102_ = new_n89_ & ~x33 & ~x34 & ~x31 & ~x32;
