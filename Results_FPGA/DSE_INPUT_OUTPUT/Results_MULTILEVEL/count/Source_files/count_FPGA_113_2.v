...
module FAU ( 
  ...
  assign new_n79_ = new_n61_ & new_n73_ & ~x23 & new_n80_ & ~x26;
  assign new_n80_ = ~x27 & ~x28;
  assign z10 = x18 ? x32 : (x16 ? (new_n82_ | new_n83_) : ~x05);
  assign new_n82_ = x29 & (~new_n61_ | ~new_n73_ | x23 | ~new_n80_ | x26);
  ...
  assign new_n87_ = new_n64_ & new_n74_ & new_n80_ & ~x29 & ~x30;
  assign new_n88_ = new_n57_ & new_n67_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x18 & (new_n91_ | (~x02 & ~x16))) | (x32 & (x18 | (~new_n88_ & x16)));
  assign new_n91_ = new_n67_ & new_n92_ & new_n93_ & new_n80_ & ~x25 & ~x26;
  assign new_n92_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n100_ | (x16 & (new_n97_ | (x33 & (~new_n95_ | ~new_n96_))));
  assign new_n95_ = new_n57_ & new_n67_;
  assign new_n96_ = new_n93_ & new_n80_ & ~x25 & ~x26;
  assign new_n97_ = new_n98_ & new_n99_ & new_n58_ & new_n70_ & new_n73_;
  ...
  assign new_n102_ = new_n58_ & new_n70_ & new_n73_;
