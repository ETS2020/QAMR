...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n69_ | (new_n58_ & new_n70_))) | ~new_n55_ | (~x09 & ~x16);
  assign new_n69_ = x25 & (~new_n57_ | ~new_n67_);
  assign new_n70_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 | (~x31 & (x16 ? ~new_n72_ : ~x08));
  assign new_n72_ = (~x26 | (new_n58_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n58_ | x24 | x25 | x26 | x22 | x23);
  ...
  assign z10 = (x16 & (new_n83_ | (~new_n80_ & x29))) | ~new_n55_ | (~x05 & ~x16);
  ...
  assign z12 = x18 | (~x31 & ((~x03 & ~x16) | (new_n87_ & new_n88_)));
  assign new_n87_ = new_n75_ & new_n81_ & ~x29 & ~x30;
  assign new_n88_ = new_n89_ & x16 & ~x17 & ~x19;
  assign new_n89_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z13 = x18 | (~x31 & (x16 ? (new_n91_ | new_n92_) : ~x02));
  assign new_n91_ = x32 & (~new_n64_ | ~new_n75_ | ~new_n81_ | x29 | x30);
  assign new_n92_ = new_n77_ & new_n93_ & new_n57_ & new_n67_;
  ...
  assign new_n100_ = new_n101_ & new_n102_ & new_n58_ & new_n70_;
