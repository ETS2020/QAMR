...
module FAU ( 
  ...
  assign new_n87_ = new_n64_ & new_n75_ & new_n79_ & ~x29 & ~x30;
  ...
  assign z14 = (~new_n97_ & ~x33) | x18 | (~x01 & ~x16) | (x16 & ~new_n92_ & x33);
  assign new_n97_ = x34 & (~new_n93_ | ~new_n94_ | ~new_n67_ | ~new_n98_);
  assign new_n98_ = ~x19 & ~x20 & x16 & ~x17;
  assign z15 = (~new_n102_ & (x33 | x34)) | (x16 & x34 & (~new_n70_ | ~new_n100_));
