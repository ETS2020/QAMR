...
module FAU ( 
  ...
  assign z04 = (~x11 & (~x16 | x18)) | (x16 & ~x18 & (new_n63_ | (~new_n61_ & x23)));
  ...
  assign new_n84_ = (~x30 | (new_n63_ & new_n82_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n82_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n88_ | (~new_n86_ & x31)));
  assign new_n86_ = new_n63_ & new_n82_ & new_n87_ & ~x29 & ~x30;
  ...
  assign z13 = x18 ? ~x11 : (x16 ? (new_n92_ | new_n93_) : ~x02);
  assign new_n92_ = x32 & (~new_n57_ | ~new_n66_ | ~new_n89_ | ~new_n90_);
  assign new_n93_ = new_n57_ & new_n66_ & new_n94_ & new_n87_ & ~x25 & ~x26;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n98_ | (x16 & ((~new_n93_ & x33) | (new_n69_ & new_n96_)));
