...
module FAU ( 
  ...
  assign z07 = x18 ? x09 : (x16 ? ~new_n71_ : ~x08);
  assign new_n71_ = (~new_n57_ | ~new_n72_) & (~x26 | (new_n57_ & new_n69_));
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? x09 : (x16 ? ~new_n74_ : ~x07);
  assign new_n74_ = (~x27 | (new_n57_ & new_n72_)) & (~new_n60_ | ~new_n75_);
  ...
  assign z12 = x18 ? x09 : (x16 ? (new_n86_ | new_n88_) : ~x03);
  assign new_n86_ = x31 & (~new_n62_ | ~new_n82_ | ~new_n87_);
  ...
  assign new_n91_ = new_n56_ & new_n65_ & new_n92_ & new_n93_;
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n98_ | (x16 & ((new_n68_ & new_n95_) | (~new_n91_ & x33)));
  ...
  assign z15 = x18 ? x09 : (x16 ? ~new_n100_ : ~x00);
  assign new_n100_ = (~x34 | (new_n57_ & new_n69_ & new_n96_ & new_n97_)) & (~new_n96_ | ~new_n101_ | ~new_n57_ | ~new_n69_);
