...
module FAU ( 
  ...
  assign new_n69_ = (~x26 | (new_n58_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n58_ | x22 | x23 | x24 | x25 | x26);
  ...
  assign new_n76_ = (~x28 | (new_n60_ & new_n74_ & ~x23 & ~x24)) & (~new_n60_ | ~new_n77_);
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x33 : (x16 ? (new_n79_ | new_n80_) : ~x05);
  assign new_n79_ = x29 & (~new_n60_ | ~new_n77_);
  assign new_n80_ = new_n62_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 ? ~x33 : (x16 ? ~new_n82_ : ~x04);
  assign new_n82_ = (~x30 | (new_n62_ & new_n72_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n72_ | x27 | x28 | x29 | x30);
  assign z12 = x18 ? ~x33 : (x16 ? (new_n84_ | new_n86_) : ~x03);
  assign new_n84_ = x31 & (~new_n62_ | ~new_n72_ | ~new_n85_);
  assign new_n85_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n86_ = new_n57_ & new_n65_ & new_n74_ & new_n87_;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x33 : (x16 ? (new_n89_ | new_n90_) : ~x02);
  assign new_n89_ = x32 & (~new_n57_ | ~new_n65_ | ~new_n74_ | ~new_n87_);
  ...
  assign z15 = ~new_n99_ | (x16 & ((new_n67_ & new_n98_) | (x34 & (~new_n67_ | ~new_n94_))));
