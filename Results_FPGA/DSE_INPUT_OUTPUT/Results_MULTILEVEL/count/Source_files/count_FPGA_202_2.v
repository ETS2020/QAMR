...
module FAU ( 
  ...
  assign new_n75_ = new_n59_ & new_n71_ & new_n76_;
  ...
  assign new_n81_ = new_n64_ & ~x23 & ~x24 & ~x25 & new_n82_ & ~x26;
  ...
  assign z12 = x18 ? x33 : (x16 ? (new_n88_ | new_n89_) : ~x03);
  assign new_n88_ = x31 & (~new_n65_ | ~new_n76_ | ~new_n82_ | x29 | x30);
  ...
  assign new_n92_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n78_ | ~new_n90_);
  assign new_n93_ = new_n58_ & new_n68_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n100_ | (x16 & ((~new_n93_ & x33) | (new_n97_ & new_n98_)));
  assign new_n97_ = new_n59_ & new_n71_ & ~x24 & ~x25;
  assign new_n98_ = new_n99_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n100_ = ~x18 & (x01 | x16);
  assign z15 = new_n105_ | (~x18 & (x16 ? (new_n102_ | new_n103_) : ~x00));
  assign new_n102_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n94_ | ~new_n95_);
  assign new_n103_ = new_n99_ & new_n104_ & new_n59_ & new_n71_ & ~x24 & ~x25;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n105_ = x33 & (x18 | (x16 & x34));
endmodule
