// Benchmark "FAU" written by ABC on Mon Aug 17 20:11:07 2020
...
module FAU ( 
  ...
  assign z04 = (~new_n64_ & x16) | x10 | x18 | (~x10 & ~x11 & ~x16);
  ...
  assign new_n77_ = (~x27 | (new_n59_ & new_n74_ & new_n75_)) & (~new_n62_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~new_n80_ & x16) | x10 | x18 | (~x06 & ~x16);
  assign new_n80_ = (~new_n62_ | ~new_n81_) & (~x28 | (new_n62_ & new_n78_));
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n83_ | new_n84_)) | x10 | x18 | (~x05 & ~x16);
  assign new_n83_ = x29 & (~new_n62_ | ~new_n81_);
  assign new_n84_ = new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x10 & (x16 ? ~new_n86_ : ~x04));
  assign new_n86_ = (~x30 | (new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n75_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n91_ | (x16 & (new_n89_ | (~new_n88_ & x31)));
  assign new_n88_ = new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n89_ = new_n58_ & new_n68_ & new_n90_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n91_ = ~x10 & ~x18 & (x03 | x16);
  assign z13 = ~new_n96_ | (x16 & (new_n93_ | (~new_n89_ & x32)));
  assign new_n93_ = new_n94_ & new_n95_ & new_n58_ & new_n68_;
  assign new_n94_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n95_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n96_ = ~x10 & ~x18 & (x02 | x16);
  assign z14 = x18 | (~x10 & (x16 ? (new_n98_ | new_n99_) : ~x01));
  assign new_n98_ = x33 & (~new_n94_ | ~new_n95_ | ~new_n58_ | ~new_n68_);
  assign new_n99_ = new_n100_ & new_n101_ & new_n59_ & new_n71_;
  assign new_n100_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n101_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x18 | (~x10 & (x16 ? ~new_n103_ : ~x00));
  assign new_n103_ = (~x34 | (new_n100_ & new_n101_ & new_n59_ & new_n71_)) & (~new_n59_ | ~new_n71_ | ~new_n100_ | ~new_n104_);
