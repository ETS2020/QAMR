// Benchmark "FAU" written by ABC on Mon Aug 17 20:11:01 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n57_, new_n58_, new_n60_, new_n61_, new_n63_, new_n64_,
  ...
  assign new_n66_ = (~x24 | (new_n57_ & ~x21 & ~x22 & ~x23)) & (~new_n57_ | x23 | x24 | x21 | x22);
  assign z06 = (x16 & (new_n68_ | new_n69_)) | ~new_n54_ | (~x09 & ~x16);
  assign new_n68_ = x25 & (~new_n57_ | x23 | x24 | x21 | x22);
  assign new_n69_ = new_n58_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = x18 | (x31 & (x16 ? ~new_n71_ : ~x08));
  assign new_n71_ = (~x26 | (new_n58_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n58_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = ~new_n54_ | (~x07 & ~x16) | (x16 & (new_n75_ | (~new_n73_ & x27)));
  ...
  assign z09 = x18 | (~new_n78_ & x31);
  assign new_n78_ = x16 ? ((~x28 | (new_n61_ & new_n76_)) & (~new_n61_ | ~new_n79_)) : x06;
  assign new_n79_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = ~new_n54_ | (~x05 & ~x16) | (x16 & (new_n82_ | (~new_n81_ & x29)));
  assign new_n81_ = new_n61_ & new_n79_;
  assign new_n82_ = new_n64_ & new_n74_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n84_ & x16) | ~new_n54_ | (~x04 & ~x16);
  assign new_n84_ = (~x30 | (new_n64_ & new_n74_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n74_ | x29 | x30 | x27 | x28);
  assign z12 = (~new_n86_ & x16) | ~new_n54_ | (~x03 & ~x16);
  assign new_n86_ = new_n64_ & new_n74_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z13 = x18 | (x31 & (x16 ? x32 : ~x02));
