...
module FAU ( 
  ...
  assign new_n73_ = x06 & ~x18 & (x09 | x16);
  assign z07 = x18 | (x06 & (x16 ? ~new_n75_ : ~x08));
  assign new_n75_ = (~new_n59_ | ~new_n76_) & (~x26 | (new_n59_ & new_n72_));
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (x06 & (x16 ? ~new_n78_ : ~x07));
  assign new_n78_ = (~x27 | (new_n59_ & new_n76_)) & (~new_n62_ | ~new_n79_);
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = new_n81_ | ~x06 | x18;
  assign new_n81_ = x16 & ((new_n62_ & new_n82_) | (x28 & (~new_n62_ | ~new_n79_)));
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n87_ | (x16 & ((~new_n84_ & x29) | (new_n85_ & new_n65_)));
  assign new_n84_ = new_n62_ & new_n82_;
  assign new_n85_ = new_n86_ & ~x27 & ~x28 & ~x29;
  assign new_n86_ = ~x24 & ~x25 & ~x26;
  assign new_n87_ = x06 & ~x18 & (x05 | x16);
  assign z11 = (~new_n89_ & x16) | ~x06 | x18 | (~x04 & ~x16);
  assign new_n89_ = (~x30 | (new_n65_ & new_n86_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n86_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n95_ | (x16 & ((new_n70_ & new_n92_) | (~new_n91_ & x31)));
  assign new_n91_ = new_n65_ & new_n86_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n92_ = new_n93_ & new_n94_;
  assign new_n93_ = ~x25 & ~x26 & ~x27;
  assign new_n94_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n95_ = x06 & ~x18 & (x03 | x16);
  assign z13 = x18 | (x06 & (x16 ? (new_n97_ | new_n98_) : ~x02));
  assign new_n97_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n93_ | ~new_n94_);
  assign new_n98_ = new_n58_ & new_n68_ & new_n99_ & new_n100_;
  assign new_n99_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n100_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n105_ | (x16 & ((new_n71_ & new_n102_) | (~new_n98_ & x33)));
  assign new_n102_ = new_n103_ & new_n104_;
  assign new_n103_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n104_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n105_ = x06 & ~x18 & (x01 | x16);
  assign z15 = x18 | (x06 & (x16 ? ~new_n107_ : ~x00));
