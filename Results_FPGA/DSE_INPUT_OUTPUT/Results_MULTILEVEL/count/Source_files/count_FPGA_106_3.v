...
module FAU ( 
  ...
  assign z08 = new_n77_ | (~x18 & (x16 ? (~new_n74_ & x27) : ~x07));
  assign new_n77_ = ~x26 & (x18 | (new_n78_ & new_n79_ & ~x22 & ~x23));
  assign new_n78_ = ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n79_ = ~x24 & ~x25 & ~x27;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n82_ | (~new_n81_ & x28)));
  assign new_n81_ = new_n62_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n82_ = new_n62_ & new_n83_ & new_n84_ & ~x26;
  assign new_n83_ = ~x23 & ~x24 & ~x25;
  assign new_n84_ = ~x27 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n86_ | (~new_n82_ & x29)));
  assign new_n86_ = new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = new_n88_ | (~x18 & (x16 ? (~new_n86_ & x30) : ~x04));
  assign new_n88_ = ~x26 & (x18 | (new_n89_ & new_n83_ & new_n90_));
  assign new_n89_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n92_ | (~x18 & (x16 ? (~new_n96_ & x31) : ~x03));
  assign new_n92_ = ~x26 & (x18 | (new_n93_ & new_n94_ & new_n79_ & new_n95_));
  assign new_n93_ = x16 & ~x17 & ~x19;
  assign new_n94_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = new_n65_ & new_n75_ & new_n90_;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n99_ | (~new_n98_ & x32)));
  assign new_n98_ = new_n58_ & new_n68_ & new_n95_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = new_n58_ & new_n68_ & new_n100_ & new_n84_ & ~x25 & ~x26;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = new_n102_ | (~x18 & (x16 ? (~new_n99_ & x33) : ~x01));
  assign new_n102_ = ~x26 & (x18 | (new_n68_ & new_n103_ & new_n104_ & new_n105_));
  assign new_n103_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n104_ = ~x25 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x18 & (new_n109_ | new_n111_)) | (~x26 & (x18 | (new_n107_ & new_n108_)));
  assign new_n107_ = new_n68_ & new_n103_;
  assign new_n108_ = new_n104_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n109_ = x16 & x34 & (~new_n59_ | ~new_n72_ | ~new_n105_ | ~new_n110_);
