...
module FAU ( 
  ...
  assign z05 = (x23 & (x18 | (x16 & x24))) | (~x18 & (x16 ? ~new_n63_ : ~x10));
  assign new_n63_ = (new_n59_ | ~x24) & (~new_n56_ | ~new_n64_);
  assign new_n64_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (x23 & (x18 | (x16 & x25))) | (~x18 & (x16 ? ~new_n66_ : ~x09));
  assign new_n66_ = (new_n67_ | ~x25) & (~new_n57_ | x22 | x23 | x24 | x25);
  ...
  assign new_n78_ = new_n59_ & ~x26 & ~x27 & ~x28 & new_n70_ & ~x23;
  assign z10 = (x23 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n80_ : ~x05));
  assign new_n80_ = (~x29 | (new_n59_ & new_n81_)) & (~new_n61_ | ~new_n82_);
  assign new_n81_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n82_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n84_ & x16) | x18 | (~x04 & ~x16);
  assign new_n84_ = (~x30 | (new_n61_ & new_n85_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n85_ | x27 | x28 | x29 | x30);
  assign new_n85_ = ~x24 & ~x25 & ~x26;
  assign z12 = new_n90_ | (~x18 & (x16 ? (new_n87_ | new_n88_) : ~x03));
  assign new_n87_ = x31 & (~new_n67_ | ~new_n76_ | x28 | x29 | x30);
  assign new_n88_ = new_n56_ & new_n64_ & new_n76_ & new_n89_;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n90_ = x23 & (x18 | (x16 & x31));
  assign z13 = (x16 & (new_n92_ | (~new_n88_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n92_ = new_n56_ & new_n64_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n99_ | (x16 & ((new_n69_ & new_n96_) | (~new_n92_ & x33)));
  ...
  assign z15 = new_n105_ | (~x18 & (x16 ? (new_n101_ | new_n103_) : ~x00));
  assign new_n101_ = x34 & (~new_n97_ | ~new_n98_ | ~new_n56_ | ~new_n102_ | ~new_n70_);
  assign new_n102_ = ~x21 & ~x22;
  assign new_n103_ = new_n97_ & new_n104_ & new_n57_ & new_n70_ & ~x22 & ~x23;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n105_ = x23 & (x18 | (x16 & x34));
endmodule
