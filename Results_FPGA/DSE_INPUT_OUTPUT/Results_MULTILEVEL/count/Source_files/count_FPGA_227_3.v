...
module FAU ( 
  ...
  assign new_n57_ = ~x17 & (x18 | (~x20 & ~x21 & x16 & ~x19));
  assign z03 = (~x17 & (new_n61_ | x18)) | (~x18 & (x16 ? new_n59_ : ~x12));
  assign new_n59_ = ~new_n60_ & x22;
  assign new_n60_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n61_ = x16 & ~x19 & ~x20 & ~x21 & ~x22;
  ...
  assign new_n71_ = new_n60_ & new_n72_ & ~x22 & ~x23;
  assign new_n72_ = ~x24 & ~x25 & ~x26;
  assign z08 = new_n74_ | (~x18 & (x16 ? (~new_n71_ & x27) : ~x07));
  assign new_n74_ = ~x17 & (x18 | (new_n61_ & new_n75_));
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~x17 & (x18 | (new_n61_ & new_n78_))) | (~new_n77_ & ~x18);
  assign new_n77_ = x16 ? (~x28 | (new_n63_ & new_n75_)) : x06;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n81_ | (~new_n80_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n80_ = new_n63_ & new_n78_;
  assign new_n81_ = new_n64_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~x17 & (new_n83_ | x18)) | (~x18 & (x16 ? new_n85_ : ~x04));
  assign new_n83_ = new_n84_ & new_n72_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n84_ = ~x21 & ~x22 & ~x23 & x16 & ~x19 & ~x20;
  assign new_n85_ = x30 & (~new_n64_ | ~new_n72_ | x27 | x28 | x29);
  assign z12 = (x16 & (new_n88_ | (~new_n87_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n87_ = new_n64_ & new_n72_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n88_ = new_n56_ & new_n67_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n91_ | (~new_n88_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n91_ = new_n56_ & new_n67_ & new_n92_ & new_n93_;
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n97_ | (x16 & ((~new_n91_ & x33) | (new_n69_ & new_n95_)));
  assign new_n95_ = new_n96_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n97_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n100_ | (x16 & ((new_n69_ & new_n99_) | (x34 & (~new_n69_ | ~new_n95_))));
