...
module FAU ( 
  ...
  assign z06 = x18 ? x26 : (x16 ? (new_n69_ | new_n70_) : ~x09);
  ...
  assign z11 = (~x18 & (x16 ? ~new_n85_ : ~x04)) | (x26 & (x18 | (x16 & x30)));
  assign new_n85_ = (~x30 | (new_n61_ & new_n86_)) & (~new_n64_ | ~new_n83_ | ~new_n87_);
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x27 & ~x28 & ~x29;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n93_ | (~x18 & (x16 ? (new_n89_ | new_n91_) : ~x03));
  assign new_n89_ = x31 & (~new_n64_ | ~new_n90_);
  assign new_n90_ = ~x24 & ~x25 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n57_ & new_n67_ & new_n92_ & ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x26 & (x18 | (x16 & x31));
  assign z13 = new_n99_ | (~x18 & (x16 ? (new_n95_ | new_n96_) : ~x02));
  assign new_n95_ = x32 & (~new_n64_ | ~new_n92_ | x24 | x25 | x27);
  assign new_n96_ = new_n57_ & new_n67_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n98_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n99_ = x26 & (x18 | (x16 & x32));
  assign z14 = (x16 & (new_n101_ | (~new_n96_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n101_ = new_n58_ & new_n71_ & new_n102_ & new_n103_;
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n106_ | (x16 & ((new_n70_ & new_n105_) | (~new_n101_ & x34)));
