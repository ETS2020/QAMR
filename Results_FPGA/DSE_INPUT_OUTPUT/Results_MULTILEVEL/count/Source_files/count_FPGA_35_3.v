...
module FAU ( 
  ...
  assign new_n63_ = new_n56_ & new_n64_ & ~x23 & ~x24;
  assign new_n64_ = ~x21 & ~x22;
  assign z06 = new_n66_ | (~x18 & (x16 ? (~new_n63_ & x25) : ~x09));
  assign new_n66_ = ~x23 & (x18 | (new_n67_ & new_n64_ & ~x24 & ~x25));
  assign new_n67_ = ~x19 & ~x20 & x16 & ~x17;
  assign z07 = new_n69_ | (~x18 & (x16 ? (~new_n71_ & x26) : ~x08));
  assign new_n69_ = ~x23 & (x18 | (new_n67_ & new_n64_ & new_n70_));
  assign new_n70_ = ~x24 & ~x25 & ~x26;
  assign new_n71_ = new_n57_ & new_n72_;
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z08 = (~x23 & (new_n74_ | x18)) | (~x18 & (x16 ? new_n76_ : ~x07));
  assign new_n74_ = new_n75_ & ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n75_ = ~x22 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n76_ = x27 & (~new_n57_ | ~new_n70_ | x22 | x23);
  assign z09 = (x16 & (new_n79_ | (~new_n78_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n78_ = new_n59_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n79_ = new_n59_ & new_n80_ & ~x26 & ~x27 & ~x28;
  assign new_n80_ = ~x23 & ~x24 & ~x25;
  assign z10 = (x16 & (new_n82_ | (~new_n79_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n82_ = new_n61_ & new_n70_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n84_ & x16) | x18 | (~x04 & ~x16);
  assign new_n84_ = (~x30 | (new_n61_ & new_n70_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n70_ | x27 | x28 | x29 | x30);
  assign z12 = (~new_n90_ & ~x18) | (~x23 & (x18 | (new_n86_ & new_n88_)));
  ...
  assign new_n90_ = x16 ? (~x31 | (new_n61_ & new_n70_ & new_n91_)) : x03;
  assign new_n91_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = ~new_n95_ | (x16 & ((new_n63_ & new_n93_) | (x32 & (~new_n63_ | ~new_n88_))));
  assign new_n93_ = new_n94_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n95_ = ~x18 & (x02 | x16);
  assign z14 = ~new_n100_ | (x16 & (new_n97_ | (x33 & (~new_n63_ | ~new_n93_))));
  assign new_n97_ = new_n57_ & new_n72_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n100_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n103_ | (x16 & ((~new_n97_ & x34) | (new_n71_ & new_n102_)));
