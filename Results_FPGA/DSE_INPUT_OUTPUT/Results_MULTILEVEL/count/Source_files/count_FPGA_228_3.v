...
module FAU ( 
  ...
  assign z03 = (~x21 & (new_n60_ | x18)) | (~x18 & (x16 ? new_n59_ : ~x12));
  assign new_n59_ = ~new_n57_ & x22;
  assign new_n60_ = x16 & ~x17 & ~x19 & ~x20 & ~x22;
  ...
  assign new_n74_ = new_n62_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = new_n76_ | (~x18 & (x16 ? (~new_n74_ & x28) : ~x06));
  assign new_n76_ = ~x21 & (x18 | (new_n60_ & new_n77_));
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~x21 & (x18 | (new_n79_ & new_n81_))) | (~new_n80_ & ~x18);
  assign new_n79_ = new_n72_ & ~x27 & ~x28 & ~x29;
  assign new_n80_ = x16 ? (~x29 | (new_n62_ & new_n77_)) : x05;
  assign new_n81_ = ~x20 & ~x22 & ~x23 & x16 & ~x17 & ~x19;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n63_ & new_n72_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n72_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n63_ & new_n72_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign new_n89_ = new_n56_ & new_n66_ & new_n90_ & new_n91_;
  ...
  assign z15 = new_n97_ | (~x18 & (x16 ? (~new_n93_ & x34) : ~x00));
  assign new_n97_ = ~x21 & (x18 | (new_n69_ & new_n98_ & new_n94_ & new_n99_));
