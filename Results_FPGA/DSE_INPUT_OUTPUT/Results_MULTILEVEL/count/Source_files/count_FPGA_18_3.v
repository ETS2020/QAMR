// Benchmark "FAU" written by ABC on Mon Aug 17 20:10:41 2020
...
module FAU ( 
  ...
  assign new_n79_ = (~x30 | (new_n61_ & new_n70_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n70_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n82_ | (~new_n81_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n81_ = new_n61_ & new_n70_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n82_ = new_n56_ & new_n64_ & new_n83_ & ~x25 & ~x26 & ~x27;
  assign new_n83_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x16 ? (~x18 & (new_n85_ | (~new_n82_ & x32))) : (~x02 | x18);
  assign new_n85_ = new_n56_ & new_n64_ & new_n86_ & new_n87_;
  assign new_n86_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n87_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n92_ | (x16 & ((~new_n85_ & x33) | (new_n66_ & new_n89_)));
  assign new_n89_ = new_n90_ & new_n91_;
  assign new_n90_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n91_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n92_ = ~x18 & (x01 | x16);
  assign z15 = x16 ? (~new_n94_ & ~x18) : (~x00 | x18);
  assign new_n94_ = (~x34 | (new_n57_ & new_n67_ & new_n90_ & new_n91_)) & (~new_n90_ | ~new_n95_ | ~new_n57_ | ~new_n67_);
