...
module FAU ( 
  ...
  assign new_n61_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & x16 & (~x16 | x17 | x19 | x20 | x21 | x22);
  ...
  assign new_n98_ = ~x12 & ~x18 & (x02 | x16);
  assign z14 = x18 | (~x12 & (x16 ? (new_n100_ | new_n101_) : ~x01));
