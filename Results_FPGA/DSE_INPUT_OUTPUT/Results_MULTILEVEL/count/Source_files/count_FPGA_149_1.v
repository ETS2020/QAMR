...
module FAU ( 
  ...
  assign z03 = (x16 & (new_n60_ | (~new_n58_ & x22))) | ~new_n54_ | (~x12 & ~x16);
  ...
  assign z06 = (x16 & (new_n68_ | (~new_n67_ & x25))) | ~new_n54_ | (~x09 & ~x16);
  assign new_n67_ = new_n57_ & new_n65_;
  assign new_n68_ = new_n58_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  ...
  assign new_n73_ = (~new_n58_ | x22 | x23 | x24 | x25 | x27) & (~x27 | (new_n58_ & ~x24 & ~x25 & ~x22 & ~x23));
  ...
  assign z10 = (x16 & (new_n80_ | (~new_n77_ & x29))) | ~new_n54_ | (~x05 & ~x16);
  ...
  assign z12 = x18 | (~x26 & (x16 ? ~new_n86_ : ~x03));
  assign new_n86_ = (~x31 | (new_n62_ & new_n76_ & ~x28 & ~x29 & ~x30)) & (~new_n62_ | ~new_n76_ | x30 | x31 | x28 | x29);
  assign z13 = x18 | (~x26 & (x16 ? (new_n88_ | new_n90_) : ~x02));
  assign new_n88_ = x32 & (~new_n62_ | ~new_n76_ | ~new_n89_ | x30 | x31);
  assign new_n89_ = ~x28 & ~x29;
  assign new_n90_ = new_n57_ & new_n65_ & new_n78_ & new_n91_;
  assign new_n91_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x26 & (x16 ? (new_n93_ | new_n94_) : ~x01));
  assign new_n93_ = x33 & (~new_n57_ | ~new_n65_ | ~new_n78_ | ~new_n91_);
  assign new_n94_ = new_n57_ & new_n65_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x25 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n101_ | (x16 & ((~new_n94_ & x34) | (new_n98_ & new_n99_)));
  assign new_n98_ = new_n58_ & ~x24 & ~x25 & ~x22 & ~x23;
