...
module FAU ( 
  ...
  assign new_n83_ = (~new_n64_ | ~new_n84_) & (~x29 | (new_n61_ & new_n81_));
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x18 & (x16 ? ~new_n86_ : ~x04)) | (x28 & (x18 | (x16 & x30)));
  assign new_n86_ = (~x30 | (new_n61_ & new_n87_)) & (~new_n64_ | ~new_n75_ | ~new_n88_);
  assign new_n87_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n88_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n93_ | (~x18 & (x16 ? (new_n90_ | new_n91_) : ~x03));
  assign new_n90_ = x31 & (~new_n64_ | ~new_n75_ | x27 | x29 | x30);
  assign new_n91_ = new_n57_ & new_n67_ & new_n77_ & new_n92_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x28 & (x18 | (x16 & x31));
  ...
  assign new_n100_ = x28 & (x18 | (x16 & x32));
  assign z14 = new_n106_ | (~x18 & (x16 ? (new_n102_ | new_n103_) : ~x01));
  assign new_n102_ = x33 & (~new_n57_ | ~new_n67_ | ~new_n77_ | ~new_n99_);
  assign new_n103_ = new_n58_ & new_n70_ & new_n104_ & new_n105_;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n106_ = x28 & (x18 | (x16 & x33));
  assign z15 = ~new_n110_ | (x16 & ((new_n108_ & new_n109_) | (~new_n103_ & x34)));
