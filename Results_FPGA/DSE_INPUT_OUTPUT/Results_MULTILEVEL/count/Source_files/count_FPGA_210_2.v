...
module FAU ( 
  ...
  assign z07 = (~new_n71_ & x26) | ~x16 | new_n75_ | x18;
  assign new_n75_ = new_n76_ & ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (~x08 & (x18 | (~x07 & ~x16))) | (x16 & (new_n78_ | new_n79_ | x18));
  assign new_n78_ = x27 & (~new_n59_ | ~new_n76_);
  ...
  assign z10 = (~new_n88_ & ~x16) | x18 | (x16 & (new_n86_ | (~new_n82_ & x29)));
  assign new_n86_ = new_n65_ & new_n87_ & ~x27 & ~x28 & ~x29;
  assign new_n87_ = ~x24 & ~x25 & ~x26;
  assign new_n88_ = x05 & ~x08;
  assign z11 = new_n91_ | (x16 & ((~new_n86_ & x30) | new_n90_ | x18));
  assign new_n90_ = new_n65_ & new_n87_ & new_n83_ & ~x29 & ~x30;
  assign new_n91_ = ~x08 & (x18 | (~x04 & ~x16));
  assign z12 = new_n96_ | (x16 & (new_n93_ | x18 | (new_n67_ & new_n94_)));
  assign new_n93_ = x31 & (~new_n65_ | ~new_n87_ | ~new_n83_ | x29 | x30);
  assign new_n94_ = new_n80_ & new_n95_;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = ~x08 & (x18 | (~x03 & ~x16));
  assign z13 = new_n101_ | (x16 & (new_n98_ | x18 | (new_n67_ & new_n99_)));
  assign new_n98_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n80_ | ~new_n95_);
  assign new_n99_ = new_n100_ & new_n83_ & ~x25 & ~x26;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = ~x08 & (x18 | (~x02 & ~x16));
  assign z14 = new_n106_ | (x16 & (~new_n103_ | (x33 & (~new_n67_ | ~new_n99_))));
  assign new_n103_ = ~x18 & (~new_n59_ | ~new_n72_ | ~new_n104_ | ~new_n105_);
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n106_ = ~x08 & (x18 | (~x01 & ~x16));
  assign z15 = x18 | (~new_n108_ & x16) | (~x16 & (~x00 | x08));
  assign new_n108_ = (~x34 | (new_n59_ & new_n72_ & new_n104_ & new_n105_)) & (~new_n59_ | ~new_n72_ | ~new_n104_ | ~new_n109_);
