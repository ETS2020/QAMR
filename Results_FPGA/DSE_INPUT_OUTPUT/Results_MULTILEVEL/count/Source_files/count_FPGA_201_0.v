...
module FAU ( 
  ...
  assign z02 = (~new_n57_ & x16) | (~x13 & ~x16) | x18 | ~x25;
  ...
  assign z04 = (~new_n61_ & x16) | (~x11 & ~x16) | x18 | ~x25;
  ...
  assign z10 = (~x05 & ~x16) | (x16 & x29) | x18 | ~x25;
  assign z11 = (~x04 & ~x16) | (x16 & x30) | x18 | ~x25;
  assign z12 = x18 | (x25 & (x16 ? x31 : ~x03));
  assign z13 = (~x02 & ~x16) | (x16 & x32) | x18 | ~x25;
