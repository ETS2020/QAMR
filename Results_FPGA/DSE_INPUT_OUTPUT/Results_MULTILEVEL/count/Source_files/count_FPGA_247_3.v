...
module FAU ( 
  ...
  assign new_n75_ = new_n59_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x16 ? (~x18 & (new_n77_ | (~new_n75_ & x28))) : (~x06 | x18);
  assign new_n77_ = new_n59_ & ~x23 & ~x24 & ~x25 & new_n78_ & ~x26;
  assign new_n78_ = ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n80_ | (~new_n77_ & x29))) : (~x05 | x18);
  assign new_n80_ = new_n61_ & new_n81_ & ~x27 & ~x28 & ~x29;
  assign new_n81_ = ~x24 & ~x25 & ~x26;
  assign z11 = x16 ? (~new_n83_ & ~x18) : (~x04 | x18);
  assign new_n83_ = (~x30 | (new_n61_ & new_n81_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n81_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n61_ & new_n81_ & new_n78_ & ~x29 & ~x30;
  ...
  assign new_n89_ = new_n56_ & new_n65_ & new_n90_ & new_n78_ & ~x25 & ~x26;
  assign new_n90_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x16 ? (~x18 & (new_n92_ | (~new_n89_ & x33))) : (~x01 | x18);
  assign new_n92_ = new_n57_ & new_n69_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n94_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = ~new_n97_ | (x16 & ((new_n68_ & new_n96_) | (~new_n92_ & x34)));
  assign new_n96_ = new_n93_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
