...
module FAU ( 
  ...
  assign new_n67_ = new_n68_ & ~x17 & ~x18 & ~x19 & ~x20;
  ...
  assign new_n73_ = new_n59_ & new_n71_ & new_n74_;
  assign new_n74_ = ~x24 & ~x25;
  assign new_n75_ = new_n76_ & ~x17 & ~x18 & ~x19 & ~x20 & ~x21;
  assign new_n76_ = ~x24 & ~x25 & ~x26 & ~x22 & ~x23;
  assign z08 = x18 ? x07 : (x16 ? (new_n79_ | (~new_n78_ & x27)) : ~x07);
  assign new_n78_ = new_n59_ & new_n76_;
  assign new_n79_ = new_n64_ & new_n80_ & ~x23 & ~x24;
  assign new_n80_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? x07 : (x16 ? (new_n82_ | new_n83_) : ~x06);
  assign new_n82_ = x28 & (~new_n64_ | ~new_n80_ | x23 | x24);
  assign new_n83_ = new_n64_ & new_n74_ & ~x23 & new_n84_ & ~x26;
  assign new_n84_ = ~x27 & ~x28;
  assign z10 = x18 ? x07 : (x16 ? (new_n86_ | new_n87_) : ~x05);
  assign new_n86_ = x29 & (~new_n64_ | ~new_n74_ | x23 | ~new_n84_ | x26);
  assign new_n87_ = new_n65_ & new_n88_ & ~x27 & ~x28 & ~x29;
  assign new_n88_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n90_ & x16) | x18 | (~x04 & ~x16);
  assign new_n90_ = (~x30 | (new_n65_ & new_n88_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n88_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n93_ | (~new_n92_ & x31)));
  assign new_n92_ = new_n65_ & new_n88_ & new_n84_ & ~x29 & ~x30;
  assign new_n93_ = new_n58_ & new_n68_ & new_n80_ & new_n94_;
  assign new_n94_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 ? x07 : (x16 ? (new_n96_ | new_n97_) : ~x02);
  assign new_n96_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n80_ | ~new_n94_);
  assign new_n97_ = new_n58_ & new_n68_ & new_n98_ & new_n84_ & ~x25 & ~x26;
  assign new_n98_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n102_ | (x16 & ((~new_n97_ & x33) | (new_n73_ & new_n100_)));
  assign new_n100_ = new_n101_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n101_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n102_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n105_ | (x16 & ((new_n73_ & new_n104_) | (x34 & (~new_n73_ | ~new_n100_))));
