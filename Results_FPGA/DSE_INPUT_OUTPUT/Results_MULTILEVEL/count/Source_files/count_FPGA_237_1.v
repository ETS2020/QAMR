...
module FAU ( 
  ...
  assign new_n78_ = new_n63_ & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  ...
  assign new_n84_ = new_n66_ & new_n77_ & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x19 & (x16 ? ~new_n86_ : ~x03));
  assign new_n86_ = (~x31 | (new_n66_ & new_n77_ & ~x28 & ~x29 & ~x30)) & (~new_n66_ | ~new_n77_ | x30 | x31 | x28 | x29);
  assign z13 = (x16 & (new_n89_ | (~new_n88_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n88_ = new_n66_ & new_n77_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n89_ = new_n59_ & new_n69_ & new_n90_ & ~x26 & ~x27 & ~x28;
  assign new_n90_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n92_ | (~new_n89_ & x33))) | ~new_n54_ | (~x01 & ~x16);
  assign new_n92_ = new_n59_ & new_n69_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n94_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x19 & (x16 ? (new_n96_ | new_n97_) : ~x00));
  assign new_n96_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n93_ | ~new_n94_);
  assign new_n97_ = new_n60_ & new_n72_ & new_n98_ & new_n99_;
