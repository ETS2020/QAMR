...
module FAU ( 
  ...
  assign z09 = (x22 & (x18 | (x16 & x28))) | (~x18 & (x16 ? ~new_n79_ : ~x06));
  assign new_n79_ = (~x28 | (new_n58_ & new_n77_)) & (~new_n60_ | ~new_n80_);
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = new_n85_ | (~x18 & (x16 ? (new_n82_ | new_n84_) : ~x05));
  assign new_n82_ = x29 & (~new_n66_ | ~new_n83_);
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n84_ = new_n63_ & new_n74_ & ~x27 & ~x28 & ~x29;
  assign new_n85_ = x22 & (x18 | (x16 & x29));
  assign z11 = (~new_n87_ & x16) | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n63_ & new_n74_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n74_ | x27 | x28 | x29 | x30);
  assign z12 = new_n94_ | (~x18 & (x16 ? (new_n89_ | new_n92_) : ~x03));
  assign new_n89_ = x31 & (~new_n91_ | ~new_n90_ | x28 | x29 | x30);
  assign new_n90_ = ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n92_ = new_n57_ & new_n67_ & new_n90_ & new_n93_;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = x22 & (x18 | (x16 & x31));
  assign z13 = new_n100_ | (~x18 & (x16 ? (new_n96_ | new_n97_) : ~x02));
  assign new_n96_ = x32 & (~new_n91_ | ~new_n90_ | ~new_n93_);
  assign new_n97_ = new_n57_ & new_n67_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n100_ = x22 & (x18 | (x16 & x32));
  assign z14 = (x16 & (new_n102_ | (~new_n97_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n102_ = new_n58_ & new_n71_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n107_ | (x16 & ((new_n70_ & new_n106_) | (~new_n102_ & x34)));
