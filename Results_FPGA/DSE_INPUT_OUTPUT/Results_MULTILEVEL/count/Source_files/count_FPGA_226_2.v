...
module FAU ( 
  ...
  assign z06 = x18 | (~x09 & (new_n71_ | ~x16 | (~new_n70_ & x25)));
  ...
  assign z08 = (x16 & (new_n76_ | new_n78_)) | x09 | x18 | (~x07 & ~x16);
  ...
  assign new_n92_ = ~x09 & ~x18 & (x03 | x16);
