...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n55_, new_n58_, new_n59_, new_n61_, new_n63_, new_n65_,
  ...
  assign z05 = ~new_n54_ | (~x10 & ~x16) | (x16 & (new_n65_ | (~new_n63_ & x24)));
  ...
  assign z07 = (x16 & (new_n71_ | (~new_n68_ & x26))) | ~new_n54_ | (~x08 & ~x16);
  ...
  assign new_n74_ = new_n61_ & ~x23 & ~x24 & new_n75_ & ~x25;
  assign new_n75_ = ~x26 & ~x27;
  assign z09 = ~new_n55_ & (~new_n80_ | (x16 & (new_n77_ | (~new_n74_ & x28))));
  assign new_n77_ = new_n61_ & new_n78_ & new_n79_ & ~x26;
  assign new_n78_ = ~x23 & ~x24 & ~x25;
  assign new_n79_ = ~x27 & ~x28;
  assign new_n80_ = ~x18 & (x06 | x16);
  assign z10 = (~new_n83_ & (x29 | x34)) | (x16 & (new_n82_ | (~new_n77_ & x29)));
  assign new_n82_ = new_n63_ & new_n72_ & new_n79_ & ~x29 & x34;
  assign new_n83_ = ~x18 & (x05 | x16);
  assign z11 = new_n85_ | (x16 & ~new_n82_ & x30) | x18 | (~x04 & ~x16);
  assign new_n85_ = ~x29 & (~x34 | (new_n86_ & new_n78_ & new_n87_));
  assign new_n86_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n87_ = ~x26 & ~x27 & ~x28 & ~x30;
  assign z12 = new_n89_ | ~new_n94_ | (x16 & x31 & (~new_n65_ | ~new_n93_));
  assign new_n89_ = ~x29 & (~x34 | (new_n90_ & new_n91_ & new_n72_ & new_n92_));
  assign new_n90_ = x16 & ~x17 & ~x19;
  assign new_n91_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n92_ = ~x27 & ~x28 & ~x30 & ~x31;
  assign new_n93_ = new_n75_ & ~x25 & ~x28 & ~x29 & ~x30 & x34;
  assign new_n94_ = ~x18 & (x03 | x16);
  assign z13 = new_n96_ | (x16 & (new_n98_ | (x32 & (new_n97_ | x29))));
  assign new_n96_ = ~new_n55_ & (x18 | (~x02 & ~x16));
  assign new_n97_ = x34 & (~new_n63_ | ~new_n72_ | ~new_n92_);
  assign new_n98_ = new_n59_ & new_n69_ & new_n99_ & new_n75_ & ~x28 & ~x29;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & x34;
  assign z14 = new_n101_ | (x16 & ~new_n98_ & x33) | x18 | (~x01 & ~x16);
  assign new_n101_ = ~x29 & (~x34 | (new_n66_ & new_n102_ & new_n103_ & new_n104_));
  assign new_n102_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n103_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n107_ | (x16 & (x29 ? x34 : (~new_n65_ | ~new_n106_)));
  assign new_n106_ = new_n103_ & new_n104_;
  assign new_n107_ = (x00 | x16) & ~new_n55_ & ~x18;
endmodule
