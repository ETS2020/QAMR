...
module FAU ( 
  ...
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n88_ | (~new_n87_ & x31)));
  assign new_n87_ = new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z14 = (~x18 & (new_n95_ | (~x01 & ~x16))) | (x33 & (x18 | (~new_n91_ & x16)));
  assign new_n95_ = new_n68_ & new_n96_ & new_n92_ & new_n97_;
  assign new_n96_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n103_ | (~x18 & (x16 ? (new_n99_ | new_n100_) : ~x00));
  assign new_n99_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n92_ | ~new_n93_);
  ...
  assign new_n103_ = x33 & (x18 | (x16 & x34));
endmodule
