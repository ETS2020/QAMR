// Benchmark "FAU" written by ABC on Mon Aug 17 20:11:22 2020
...
module FAU ( 
  ...
  assign z06 = x18 | (x08 & (new_n70_ | (~x09 & ~x16)));
  assign new_n70_ = x16 & ((x25 & (~new_n58_ | ~new_n68_)) | (new_n59_ & new_n71_));
  assign new_n71_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = (x16 & (new_n74_ | (~new_n73_ & x26))) | ~x08 | x18;
  assign new_n73_ = new_n59_ & new_n71_;
  assign new_n74_ = new_n59_ & new_n75_ & ~x22 & ~x23;
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign z08 = ~new_n78_ | (x16 & ((~new_n74_ & x27) | (new_n62_ & new_n77_)));
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n78_ = x08 & ~x18 & (x07 | x16);
  assign z09 = (~new_n80_ & x16) | ~x08 | x18 | (~x06 & ~x16);
  assign new_n80_ = (~new_n62_ | ~new_n81_) & (~x28 | (new_n62_ & new_n77_));
  ...
  assign new_n89_ = new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n90_ = new_n91_ & ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n92_ = x08 & ~x18 & (x03 | x16);
  assign z13 = ~new_n97_ | (x16 & ((new_n88_ & new_n94_) | (x32 & (~new_n88_ | ~new_n90_))));
  assign new_n94_ = new_n95_ & new_n96_;
  assign new_n95_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n96_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n97_ = x08 & ~x18 & (x02 | x16);
