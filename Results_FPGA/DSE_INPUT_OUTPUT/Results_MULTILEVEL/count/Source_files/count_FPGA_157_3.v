...
module FAU ( 
  ...
  assign new_n72_ = ~x25 & (x18 | (new_n73_ & new_n74_ & ~x21 & ~x22));
  assign new_n73_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n74_ = ~x23 & ~x24 & ~x26;
  assign z08 = (~x25 & (new_n76_ | x18)) | (~x18 & (x16 ? new_n78_ : ~x07));
  assign new_n76_ = new_n77_ & x16 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x26 & ~x27;
  ...
  assign new_n85_ = ~x25 & (x18 | (new_n86_ & new_n87_));
  assign new_n86_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n87_ = ~x23 & ~x24 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x25 & (new_n89_ | x18)) | (~x18 & (x16 ? new_n90_ : ~x04));
  assign new_n89_ = new_n86_ & new_n74_ & new_n83_ & ~x29 & ~x30;
  assign new_n90_ = x30 & (~new_n64_ | ~new_n79_ | x27 | x28 | x29);
  assign z12 = (x16 & (new_n93_ | (~new_n92_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n92_ = new_n64_ & new_n79_ & new_n83_ & ~x29 & ~x30;
  assign new_n93_ = new_n58_ & new_n67_ & new_n94_ & ~x25 & ~x26 & ~x27;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n96_ | (~x18 & (x16 ? (~new_n93_ & x32) : ~x02));
  assign new_n96_ = ~x25 & (x18 | (new_n97_ & new_n98_ & new_n99_ & new_n100_));
  assign new_n97_ = x16 & ~x17 & ~x19;
  assign new_n98_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n99_ = ~x24 & ~x26 & ~x27 & ~x28;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n103_ | (~new_n102_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n102_ = new_n58_ & new_n67_ & new_n100_ & new_n83_ & ~x25 & ~x26;
  ...
  assign new_n107_ = ~x25 & (x18 | (new_n67_ & new_n73_ & new_n104_ & new_n108_));
