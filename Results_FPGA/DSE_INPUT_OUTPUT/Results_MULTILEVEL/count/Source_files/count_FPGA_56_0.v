...
module FAU ( 
  ...
  assign z03 = (x16 & (new_n61_ | (~new_n59_ & x22))) | ~x12 | x18;
  ...
  assign z08 = (x16 & (new_n76_ | new_n78_)) | ~x12 | x18 | (~x07 & ~x16);
  ...
  assign z09 = x18 | (x12 & (x16 ? ~new_n81_ : ~x06));
  assign new_n81_ = (~new_n61_ | ~new_n82_) & (~x28 | (new_n61_ & new_n79_));
  ...
  assign new_n102_ = x12 & ~x18 & (x01 | x16);
  assign z15 = x18 | (x12 & (x16 ? ~new_n104_ : ~x00));
