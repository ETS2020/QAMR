...
module FAU ( 
  ...
  assign new_n73_ = x15 & ~x18 & (x09 | x16);
  assign z07 = x18 | (x15 & (x16 ? ~new_n75_ : ~x08));
  assign new_n75_ = (~x26 | (new_n59_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n59_ | x24 | x25 | x26 | x22 | x23);
  assign z08 = ~new_n80_ | (x16 & ((~new_n77_ & x27) | (new_n62_ & new_n79_)));
  ...
  assign z09 = (~new_n82_ & x16) | ~x15 | x18 | (~x06 & ~x16);
  assign new_n82_ = (~new_n62_ | ~new_n83_) & (~x28 | (new_n62_ & new_n79_));
  ...
  assign new_n105_ = new_n102_ & ~x32 & ~x33 & ~x34 & ~x30 & ~x31;
  assign new_n106_ = x15 & ~x18 & (x00 | x16);
endmodule
