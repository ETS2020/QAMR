...
module FAU ( 
  ...
  assign new_n81_ = new_n61_ & new_n70_ & new_n75_ & ~x29 & ~x30;
  ...
  assign new_n85_ = new_n56_ & new_n64_ & new_n86_ & new_n75_ & ~x25 & ~x26;
  assign new_n86_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n90_ | (x16 & ((~new_n85_ & x33) | (new_n67_ & new_n88_)));
  assign new_n88_ = new_n89_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n93_ | (x16 & ((new_n67_ & new_n92_) | (x34 & (~new_n67_ | ~new_n88_))));
