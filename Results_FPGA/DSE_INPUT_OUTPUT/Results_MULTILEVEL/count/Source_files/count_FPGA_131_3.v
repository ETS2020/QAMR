...
module FAU ( 
  ...
  assign z03 = (~x17 & (new_n60_ | x18)) | (~x18 & (x16 ? new_n59_ : ~x12));
  assign new_n59_ = ~new_n57_ & x22;
  assign new_n60_ = x16 & ~x19 & ~x20 & ~x21 & ~x22;
  ...
  assign z05 = new_n65_ | (~x18 & (x16 ? (~new_n63_ & x24) : ~x10));
  assign new_n65_ = ~x17 & (x18 | (new_n66_ & x16 & ~x19 & ~x20));
  ...
  assign new_n76_ = new_n57_ & new_n74_ & ~x22 & ~x23;
  assign new_n77_ = new_n62_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = new_n79_ | (~x18 & (x16 ? (~new_n77_ & x28) : ~x06));
  assign new_n79_ = ~x17 & (x18 | (new_n60_ & new_n80_));
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~x17 & (x18 | (new_n83_ & new_n84_))) | (~new_n82_ & ~x18);
  assign new_n82_ = x16 ? (~x29 | (new_n62_ & new_n80_)) : x05;
  assign new_n83_ = ~x21 & ~x22 & ~x23 & x16 & ~x19 & ~x20;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x17 & (x18 | (new_n83_ & new_n74_ & new_n87_))) | (~new_n86_ & ~x18);
  assign new_n86_ = x16 ? (~x30 | (new_n63_ & new_n84_)) : x04;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n92_ & ~x18) | (~x17 & (x18 | (new_n89_ & new_n90_)));
  assign new_n89_ = new_n66_ & x16 & ~x19 & ~x20;
  assign new_n90_ = new_n91_ & ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = x16 ? (~x31 | (new_n63_ & new_n74_ & new_n87_)) : x03;
  assign z13 = ~new_n97_ | (x16 & (new_n94_ | (x32 & (~new_n68_ | ~new_n90_))));
  assign new_n94_ = new_n56_ & new_n66_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n97_ = ~x18 & (x02 | x16);
  assign z14 = new_n99_ | (~x18 & (x16 ? (~new_n94_ & x33) : ~x01));
  assign new_n99_ = ~x17 & (x18 | (new_n70_ & new_n73_ & new_n100_ & new_n101_));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n103_ & x16) | x18 | (~x00 & ~x16);
  assign new_n103_ = (~x34 | (new_n57_ & new_n70_ & new_n100_ & new_n101_)) & (~new_n57_ | ~new_n70_ | ~new_n100_ | ~new_n104_);
