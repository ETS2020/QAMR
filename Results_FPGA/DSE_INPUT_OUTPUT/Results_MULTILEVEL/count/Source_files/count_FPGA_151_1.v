...
module FAU ( 
  ...
  assign z07 = (~x08 & ~x16 & ~x18) | (x16 & ((~new_n66_ & x26) | new_n68_ | x18));
  ...
  assign z12 = (x16 & (new_n80_ | (~new_n78_ & x31))) | x18 | (~x03 & ~x16);
  ...
  assign z14 = ~new_n89_ | (x16 & ((~new_n83_ & x33) | (new_n66_ & new_n87_)));
  assign new_n87_ = new_n88_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n88_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n89_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n92_ | (x16 & ((new_n66_ & new_n91_) | (x34 & (~new_n66_ | ~new_n87_))));
