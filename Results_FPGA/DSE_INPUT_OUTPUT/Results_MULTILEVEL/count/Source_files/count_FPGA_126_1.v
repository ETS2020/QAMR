...
module FAU ( 
  ...
  assign z05 = x18 ? x10 : (x16 ? ~new_n65_ : ~x10);
  assign new_n65_ = (new_n63_ | ~x24) & (~new_n57_ | ~new_n66_);
  assign new_n66_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z06 = x18 ? x10 : (x16 ? (new_n68_ | new_n69_) : ~x09);
  ...
  assign new_n88_ = new_n57_ & new_n66_ & new_n89_ & ~x25 & ~x26 & ~x27;
  ...
  assign z14 = x18 ? x10 : (x16 ? (new_n95_ | new_n96_) : ~x01);
  assign new_n95_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n92_ | ~new_n93_);
  assign new_n96_ = new_n58_ & new_n70_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n98_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x18 ? x10 : (x16 ? ~new_n100_ : ~x00);
  assign new_n100_ = (~x34 | (new_n58_ & new_n70_ & new_n97_ & new_n98_)) & (~new_n58_ | ~new_n70_ | ~new_n97_ | ~new_n101_);
