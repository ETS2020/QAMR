...
module FAU ( 
  ...
  assign z08 = (x19 & (x18 | (x16 & x27))) | (~x18 & (x16 ? ~new_n71_ : ~x07));
  assign new_n71_ = (~x27 | (new_n73_ & new_n72_ & ~x25 & ~x26)) & (~new_n59_ | ~new_n72_ | x25 | x26 | x27);
  assign new_n72_ = ~x23 & ~x24;
  assign new_n73_ = ~x17 & ~x20 & ~x21 & ~x22;
  assign z09 = (~new_n75_ & x16) | x18 | (~x06 & ~x16);
  assign new_n75_ = (~x28 | (new_n59_ & new_n72_ & new_n76_)) & (~new_n59_ | ~new_n77_);
  assign new_n76_ = ~x25 & ~x26 & ~x27;
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = new_n84_ | (~x18 & (x16 ? (new_n79_ | new_n82_) : ~x05));
  assign new_n79_ = x29 & (~new_n80_ | ~new_n81_);
  assign new_n80_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n81_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n82_ = new_n61_ & new_n83_ & ~x27 & ~x28 & ~x29;
  assign new_n83_ = ~x24 & ~x25 & ~x26;
  assign new_n84_ = x19 & (x18 | (x16 & x29));
  assign z11 = (~new_n86_ & x16) | x18 | (~x04 & ~x16);
  assign new_n86_ = (~x30 | (new_n61_ & new_n83_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n83_ | x29 | x30 | x27 | x28);
  assign z12 = new_n92_ | (~x18 & (x16 ? (new_n88_ | new_n90_) : ~x03));
  assign new_n88_ = x31 & (~new_n89_ | ~new_n76_ | x28 | x29 | x30);
  assign new_n89_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n90_ = new_n56_ & new_n64_ & new_n76_ & new_n91_;
  ...
  assign z15 = ~new_n103_ | (x16 & ((~new_n98_ & x34) | (new_n66_ & new_n102_)));
