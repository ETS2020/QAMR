...
module FAU ( 
  ...
  assign new_n63_ = new_n64_ & ~x17 & ~x18 & ~x19 & ~x20;
  ...
  assign z07 = x16 ? (~x18 & (new_n70_ | (~new_n67_ & x26))) : (~x08 | x18);
  assign new_n70_ = new_n57_ & new_n71_ & ~x22 & ~x23;
  assign new_n71_ = ~x24 & ~x25 & ~x26;
  assign z08 = x16 ? (~x18 & (new_n73_ | (~new_n70_ & x27))) : (~x07 | x18);
  assign new_n73_ = new_n59_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x16 ? (~x18 & (new_n75_ | (~new_n73_ & x28))) : (~x06 | x18);
  assign new_n75_ = new_n59_ & ~x23 & ~x24 & ~x25 & new_n76_ & ~x26;
  assign new_n76_ = ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n78_ | (~new_n75_ & x29))) : (~x05 | x18);
  assign new_n78_ = new_n61_ & new_n71_ & ~x27 & ~x28 & ~x29;
  assign z11 = x16 ? (~new_n80_ & ~x18) : (~x04 | x18);
  assign new_n80_ = (~x30 | (new_n61_ & new_n71_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n71_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n83_ | (~new_n82_ & x31)));
  assign new_n82_ = new_n61_ & new_n71_ & new_n76_ & ~x29 & ~x30;
  assign new_n83_ = new_n56_ & new_n64_ & new_n84_ & ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n86_ | (~new_n83_ & x32)));
  assign new_n86_ = new_n56_ & new_n64_ & new_n87_ & new_n76_ & ~x25 & ~x26;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n89_ | (~new_n86_ & x33))) : (~x01 | x18);
  assign new_n89_ = new_n57_ & new_n68_ & new_n90_ & new_n91_;
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n94_ | (x16 & ((~new_n89_ & x34) | (new_n67_ & new_n93_)));
  assign new_n93_ = new_n90_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
