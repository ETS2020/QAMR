...
module FAU ( 
  ...
  assign z10 = x18 | (x16 & ((new_n76_ & new_n61_) | (~new_n73_ & x29)));
  ...
  assign new_n81_ = new_n61_ & new_n77_ & new_n74_ & ~x29 & ~x30;
  ...
  assign new_n85_ = new_n56_ & new_n64_ & new_n86_ & new_n74_ & ~x25 & ~x26;
  assign new_n86_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((~new_n85_ & x33) | (new_n66_ & new_n88_)));
  assign new_n88_ = new_n89_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (x34 & (~new_n66_ | ~new_n88_)) | ~x16 | x18 | (new_n66_ & new_n91_);
