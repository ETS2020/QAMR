...
module FAU ( 
  ...
  assign z12 = (~x31 & (x18 | (new_n84_ & new_n72_ & new_n87_))) | (~new_n86_ & ~x18);
  assign new_n84_ = new_n85_ & x16 & ~x17 & ~x19;
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n86_ = x16 ? (~x31 | (new_n63_ & new_n72_ & new_n87_)) : x03;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = (~x18 & (new_n91_ | new_n93_)) | (~x31 & (x18 | (new_n84_ & new_n89_)));
  assign new_n89_ = new_n90_ & ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n91_ = x16 & x32 & (~new_n57_ | ~new_n66_ | ~new_n75_ | ~new_n92_);
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = ~x02 & ~x16;
  assign z14 = (~x31 & (new_n95_ | x18)) | (~x18 & (x16 ? new_n99_ : ~x01));
  assign new_n95_ = new_n66_ & new_n96_ & new_n97_ & new_n98_;
  assign new_n96_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n97_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n98_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n99_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n97_ | ~new_n100_);
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z15 = ~new_n105_ | (x16 & ((x34 & (~new_n69_ | ~new_n102_)) | (new_n69_ & new_n104_)));
  assign new_n102_ = new_n103_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = new_n103_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
