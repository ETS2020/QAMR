...
module FAU ( 
  ...
  assign z06 = (~x18 & (new_n69_ | (~x09 & ~x16))) | (x25 & (x18 | (~new_n68_ & x16)));
  ...
  assign new_n72_ = x16 & ((x26 & (~new_n57_ | ~new_n66_)) | (new_n58_ & new_n73_));
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (~x18 & (x16 ? ~new_n75_ : ~x07)) | (x25 & (x18 | (x16 & x27)));
  assign new_n75_ = (~new_n61_ | ~new_n77_) & (~x27 | (new_n58_ & new_n76_));
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x26;
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = new_n83_ | (~x18 & (x16 ? (new_n79_ | new_n81_) : ~x06));
  assign new_n79_ = x28 & (~new_n58_ | ~new_n80_ | x22 | x23);
  assign new_n80_ = ~x24 & ~x26 & ~x27;
  assign new_n81_ = new_n61_ & ~x23 & ~x24 & ~x25 & new_n82_ & ~x26;
  assign new_n82_ = ~x27 & ~x28;
  assign new_n83_ = x25 & (x18 | (x16 & x28));
  assign z10 = (x16 & (new_n85_ | (~new_n81_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n85_ = new_n63_ & new_n86_ & ~x27 & ~x28 & ~x29;
  assign new_n86_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n88_ & x16) | x18 | (~x04 & ~x16);
  assign new_n88_ = (~x30 | (new_n63_ & new_n86_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n86_ | x27 | x28 | x29 | x30);
  assign z12 = new_n93_ | (~x18 & (x16 ? (new_n90_ | new_n91_) : ~x03));
  assign new_n90_ = x31 & (~new_n63_ | ~new_n80_ | x28 | x29 | x30);
  assign new_n91_ = new_n57_ & new_n66_ & new_n92_ & ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x25 & (x18 | (x16 & x31));
  assign z13 = ~new_n97_ | (x16 & ((new_n68_ & new_n95_) | (~new_n91_ & x32)));
  assign new_n95_ = new_n96_ & new_n82_ & ~x25 & ~x26;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n97_ = ~x18 & (x02 | x16);
  assign z14 = new_n104_ | (~x18 & (x16 ? (new_n99_ | new_n100_) : ~x01));
  assign new_n99_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n96_ | ~new_n82_ | x26);
  assign new_n100_ = new_n58_ & new_n101_ & new_n102_ & new_n103_;
  assign new_n101_ = ~x22 & ~x23 & ~x24 & ~x25;
  ...
  assign new_n107_ = new_n58_ & new_n101_ & new_n102_ & new_n108_;
