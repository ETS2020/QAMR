...
module FAU ( 
  ...
  assign z05 = (~new_n61_ & x24) | ~x16 | new_n63_ | x18;
  ...
  assign new_n76_ = new_n77_ & ~x27 & ~x28 & ~x29;
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign z11 = x18 | (~new_n79_ & x16);
  assign new_n79_ = (~x30 | (new_n61_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n77_ | x27 | x28 | x29 | x30);
  assign z12 = (~new_n81_ & x31) | ~x16 | x18 | (new_n63_ & new_n82_);
  assign new_n81_ = new_n61_ & new_n77_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n82_ = new_n83_ & ~x25 & ~x26 & ~x27;
  assign new_n83_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n85_ | (x32 & (~new_n63_ | ~new_n82_))));
  assign new_n85_ = new_n56_ & new_n64_ & new_n86_ & new_n87_;
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~new_n85_ & x33) | ~x16 | x18 | (new_n66_ & new_n89_);
  assign new_n89_ = new_n90_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = ~x16 | x18 | (new_n66_ & new_n92_) | (x34 & (~new_n66_ | ~new_n89_));
  assign new_n92_ = new_n90_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
