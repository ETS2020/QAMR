...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n58_, new_n59_, new_n60_, new_n62_, new_n63_,
    ...
    new_n94_, new_n96_, new_n97_, new_n98_;
  ...
  assign z08 = (x16 & (new_n80_ | (~new_n78_ & x27))) | ~new_n66_ | (~x07 & ~x16);
  assign new_n78_ = new_n60_ & new_n79_ & ~x22 & ~x23;
  assign new_n79_ = ~x24 & ~x25 & ~x26;
  assign new_n80_ = new_n67_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n82_ | (~new_n80_ & x28))) | ~new_n66_ | (~x06 & ~x16);
  assign new_n82_ = new_n67_ & new_n83_;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n54_ & (~new_n86_ | (x16 & (new_n85_ | (~new_n82_ & x29))));
  assign new_n85_ = new_n68_ & new_n79_ & ~x27 & ~x28 & ~x29;
  assign new_n86_ = ~x18 & (x05 | x16);
  assign z11 = new_n88_ | (x16 & (new_n89_ | (~new_n85_ & x30)));
  assign new_n88_ = ~new_n54_ & (x18 | (~x04 & ~x16));
  assign new_n89_ = new_n59_ & new_n71_ & new_n90_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & x32;
  assign z12 = new_n92_ | x18 | (~x03 & ~x16) | (x16 & ~new_n89_ & x31);
  assign new_n92_ = ~x30 & (~x32 | (new_n63_ & new_n93_ & new_n79_ & new_n94_));
  assign new_n93_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n94_ = ~x27 & ~x28 & ~x29 & ~x31;
  assign z13 = (~new_n98_ & (x30 | x32)) | (x16 & x32 & (~new_n70_ | ~new_n96_));
