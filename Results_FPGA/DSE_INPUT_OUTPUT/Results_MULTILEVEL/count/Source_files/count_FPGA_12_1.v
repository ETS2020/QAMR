...
module FAU ( 
  ...
  assign z04 = x18 ? x14 : (x16 ? ~new_n61_ : ~x11);
  ...
  assign z06 = x18 ? x14 : (x16 ? ~new_n67_ : ~x09);
  ...
  assign z08 = x18 ? x14 : (x16 ? ~new_n74_ : ~x07);
  ...
  assign z10 = x18 ? x14 : (x16 ? (new_n80_ | new_n81_) : ~x05);
  ...
  assign z12 = x18 ? x14 : (x16 ? (new_n86_ | new_n88_) : ~x03);
  ...
  assign z14 = x18 ? x14 : (x16 ? (new_n95_ | new_n96_) : ~x01);
  ...
  assign z15 = x18 ? x14 : (x16 ? ~new_n100_ : ~x00);
  assign new_n100_ = (~x34 | (new_n57_ & new_n68_ & new_n97_ & new_n98_)) & (~new_n97_ | ~new_n101_ | ~new_n57_ | ~new_n68_);
