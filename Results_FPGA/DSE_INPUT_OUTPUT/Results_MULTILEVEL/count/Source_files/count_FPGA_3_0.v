...
module FAU ( 
  ...
  assign z00 = (x16 & (~x17 ^ x19)) | (~x15 & ~x16) | x18 | ~x25;
  ...
  assign z03 = (~new_n59_ & x16) | x18 | ~x25 | (~x12 & ~x16);
  assign new_n59_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z04 = (~new_n61_ & x16) | x18 | ~x25 | (~x11 & ~x16);
  ...
  assign z08 = (~x07 & ~x16) | (x16 & x27) | x18 | ~x25;
