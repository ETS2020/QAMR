...
module FAU ( 
  ...
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n75_ | (~new_n72_ & x28)));
  assign new_n75_ = new_n59_ & new_n76_ & ~x26 & ~x27 & ~x28;
  assign new_n76_ = ~x23 & ~x24 & ~x25;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n78_ | (~new_n75_ & x29)));
  ...
  assign new_n82_ = new_n61_ & new_n70_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n83_ = new_n56_ & new_n64_ & new_n73_ & new_n84_;
  ...
  assign new_n87_ = new_n88_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n88_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n93_ | (x16 & (new_n90_ | (x33 & (~new_n63_ | ~new_n87_))));
  ...
  assign z15 = (x16 & ((~new_n90_ & x34) | new_n95_ | x18)) | (~x00 & ~x16 & ~x18);
  assign new_n95_ = new_n57_ & new_n67_ & new_n91_ & new_n96_;
