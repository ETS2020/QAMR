...
module FAU ( 
  ...
  assign z01 = (~new_n55_ & x16) | x11 | x18 | (~x14 & ~x16);
  assign new_n55_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z02 = x18 | (~new_n57_ & ~x11);
  ...
  assign z14 = ~new_n101_ | (x16 & ((new_n70_ & new_n99_) | (~new_n95_ & x33)));
  assign new_n99_ = new_n100_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n100_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n101_ = ~x11 & ~x18 & (x01 | x16);
  assign z15 = ~new_n104_ | (x16 & ((new_n70_ & new_n103_) | (x34 & (~new_n70_ | ~new_n99_))));
  assign new_n103_ = new_n100_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n104_ = ~x11 & ~x18 & (x00 | x16);
endmodule
