...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n58_, new_n60_, new_n61_, new_n62_, new_n64_,
    ...
    new_n85_, new_n86_, new_n88_, new_n90_, new_n91_, new_n92_, new_n94_,
  ...
  assign z03 = (~x17 & (x18 | (new_n62_ & x16 & ~x19))) | (~new_n60_ & ~x18);
  assign new_n60_ = x16 ? (new_n61_ | ~x22) : x12;
  ...
  assign z05 = x18 | (~x10 & ~x16) | (x16 & (new_n67_ | (~new_n65_ & x24)));
  assign new_n67_ = new_n57_ & new_n68_;
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = new_n70_ | (~x18 & (x16 ? (~new_n67_ & x25) : ~x09));
  assign new_n70_ = ~x17 & (x18 | (new_n58_ & new_n71_));
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = new_n73_ | (~x18 & (x16 ? new_n76_ : ~x08));
  assign new_n73_ = ~x17 & (x18 | (new_n58_ & new_n74_ & new_n75_));
  assign new_n74_ = ~x22 & ~x23;
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign new_n76_ = x26 & (~new_n61_ | ~new_n71_);
  assign z08 = (x16 & (new_n79_ | (~new_n78_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n78_ = new_n61_ & new_n74_ & new_n75_;
  assign new_n79_ = new_n64_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n81_ | (~new_n79_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n81_ = new_n64_ & new_n82_ & ~x26 & ~x27 & ~x28;
  assign new_n82_ = ~x23 & ~x24 & ~x25;
  assign z10 = new_n84_ | (~x18 & (x16 ? (~new_n81_ & x29) : ~x05));
  assign new_n84_ = ~x17 & (x18 | (new_n86_ & new_n85_ & new_n74_ & ~x21));
  assign new_n85_ = x16 & ~x19 & ~x20;
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n88_ & x16) | x18 | (~x04 & ~x16);
  assign new_n88_ = (~x30 | (new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n75_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n91_ | (~new_n90_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n90_ = new_n65_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n91_ = new_n57_ & new_n68_ & new_n92_ & ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n94_ | (~x18 & (x16 ? (~new_n91_ & x32) : ~x02));
  assign new_n94_ = ~x17 & (x18 | (new_n85_ & new_n68_ & new_n95_ & new_n96_));
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n102_ | (x16 & (new_n99_ | (x33 & (~new_n67_ | ~new_n98_))));
  assign new_n98_ = new_n95_ & new_n96_;
  assign new_n99_ = new_n61_ & new_n71_ & new_n100_ & new_n101_;
  ...
  assign new_n104_ = ~x17 & (x18 | (new_n58_ & new_n71_ & new_n100_ & new_n105_));
