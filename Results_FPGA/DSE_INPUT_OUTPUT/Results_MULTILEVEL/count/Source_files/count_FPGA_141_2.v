...
module FAU ( 
  ...
  assign z14 = ~new_n96_ | (x16 & ((new_n69_ & new_n94_) | (~new_n90_ & x33)));
  assign new_n94_ = new_n95_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x18 & (x01 | x16);
  assign z15 = new_n101_ | (~x18 & (x16 ? (new_n98_ | new_n99_) : ~x00));
  assign new_n98_ = x34 & (~new_n57_ | ~new_n66_ | ~new_n91_ | ~new_n92_);
  assign new_n99_ = new_n95_ & new_n100_ & new_n58_ & new_n70_ & ~x24 & ~x25;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n101_ = x33 & (x18 | (x16 & x34));
endmodule
