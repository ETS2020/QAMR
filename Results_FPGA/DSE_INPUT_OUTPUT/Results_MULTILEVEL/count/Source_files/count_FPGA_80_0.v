...
module FAU ( 
  ...
  assign new_n67_ = new_n58_ & ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n68_ = new_n59_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = x18 | (x29 & (x16 ? ~new_n70_ : ~x08));
  assign new_n70_ = (~x26 | (new_n59_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n59_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = x18 | (x29 & (x16 ? (new_n72_ | new_n74_) : ~x07));
  assign new_n72_ = x27 & (~new_n59_ | ~new_n73_);
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n74_ = new_n61_ & new_n75_;
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~new_n77_ & x29);
  assign new_n77_ = x16 ? ((~x28 | (new_n61_ & new_n75_)) & (~new_n61_ | ~new_n78_)) : x06;
  assign new_n78_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = ~new_n54_ | (~x05 & ~x16) | (x16 & (~new_n61_ | ~new_n78_));
  assign z11 = ~new_n54_ | (~x04 & ~x16) | (x16 & x30);
  assign z12 = x18 | (x29 & (x16 ? x31 : ~x03));
  assign z13 = x18 | (x29 & (x16 ? x32 : ~x02));
