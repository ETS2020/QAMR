...
module FAU ( 
  ...
  assign z12 = x18 ? x06 : (x16 ? (new_n86_ | new_n87_) : ~x03);
  assign new_n86_ = x31 & (~new_n64_ | ~new_n75_ | ~new_n80_ | x29 | x30);
  assign new_n87_ = new_n88_ & new_n89_ & new_n57_ & new_n67_;
  assign new_n88_ = ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 ? x06 : (x16 ? (new_n91_ | new_n92_) : ~x02);
  assign new_n91_ = x32 & (~new_n88_ | ~new_n89_ | ~new_n57_ | ~new_n67_);
  assign new_n92_ = new_n57_ & new_n67_ & new_n93_ & new_n80_ & ~x25 & ~x26;
  assign new_n93_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n98_ | (x16 & ((~new_n92_ & x33) | (new_n95_ & new_n96_)));
  assign new_n95_ = new_n58_ & new_n70_ & ~x24 & ~x25;
