...
module FAU ( 
  ...
  assign z08 = (x16 & (new_n77_ | (~new_n75_ & x27))) | ~new_n59_ | (~x07 & ~x16);
  ...
  assign z09 = (x16 & (new_n80_ | (~new_n77_ & x28))) | ~new_n59_ | (~x06 & ~x16);
  ...
  assign new_n94_ = new_n57_ & new_n68_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n59_ | (~x01 & ~x16) | (new_n98_ & new_n95_ & new_n96_);
  assign new_n98_ = new_n68_ & ~x19 & ~x20 & x16 & ~x17;
  assign z15 = x18 | (~x33 & (x16 ? (new_n100_ | new_n101_) : ~x00));
  assign new_n100_ = x34 & (~new_n57_ | ~new_n68_ | ~new_n95_ | ~new_n96_);
