...
module FAU ( 
  ...
  assign z04 = (x17 & (x18 | (x16 & x23))) | (~x18 & (x16 ? ~new_n61_ : ~x11));
  assign new_n61_ = (~x23 | (~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  ...
  assign new_n67_ = new_n56_ & new_n64_;
  ...
  assign new_n74_ = new_n59_ & new_n75_ & ~x23 & ~x24;
  assign new_n75_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n77_ | (~new_n74_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n77_ = new_n59_ & new_n78_ & ~x23 & ~x24 & ~x25;
  assign new_n78_ = ~x26 & ~x27 & ~x28;
  assign z10 = (x17 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n80_ : ~x05));
  assign new_n80_ = (~x29 | (new_n81_ & new_n82_)) & (~new_n65_ | ~new_n83_);
  assign new_n81_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n82_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x17 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n85_ : ~x04));
  assign new_n85_ = (~x30 | (new_n81_ & new_n83_)) & (~new_n65_ | ~new_n72_ | ~new_n86_);
  assign new_n86_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n92_ | (~x18 & (x16 ? (new_n88_ | new_n90_) : ~x03));
  assign new_n88_ = x31 & (~new_n89_ | ~new_n75_ | x28 | x29 | x30);
  assign new_n89_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n90_ = new_n56_ & new_n64_ & new_n75_ & new_n91_;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = x17 & (x18 | (x16 & x31));
  assign z13 = ~new_n96_ | (x16 & ((~new_n90_ & x32) | (new_n67_ & new_n94_)));
  ...
  assign new_n98_ = x33 & (~new_n69_ | ~new_n99_ | ~new_n78_ | ~new_n95_);
  assign new_n99_ = ~x19 & ~x20 & ~x21;
  assign new_n100_ = new_n57_ & new_n69_ & new_n101_ & new_n102_;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n103_ = x17 & (x18 | (x16 & x33));
  assign z15 = new_n108_ | (~x18 & (x16 ? (new_n105_ | new_n106_) : ~x00));
  assign new_n105_ = x34 & (~new_n69_ | ~new_n99_ | ~new_n101_ | ~new_n102_);
  assign new_n106_ = new_n57_ & new_n69_ & new_n101_ & new_n107_;
