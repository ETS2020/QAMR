...
module FAU ( 
  ...
  assign new_n81_ = ~x01 & ~x18 & (x07 | x16);
  ...
  assign z10 = x18 | (~x01 & (x16 ? (new_n86_ | new_n87_) : ~x05));
  assign new_n86_ = x29 & (~new_n62_ | ~new_n83_);
  assign new_n87_ = new_n65_ & new_n78_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n89_ & x16) | x01 | x18 | (~x04 & ~x16);
  assign new_n89_ = (~x30 | (new_n65_ & new_n78_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n78_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x01 & (x16 ? (new_n91_ | new_n93_) : ~x03));
  assign new_n91_ = x31 & (~new_n65_ | ~new_n78_ | ~new_n92_ | x29 | x30);
  assign new_n92_ = ~x27 & ~x28;
  assign new_n93_ = new_n58_ & new_n68_ & new_n80_ & new_n94_;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n98_ | (x16 & ((new_n70_ & new_n96_) | (~new_n93_ & x32)));
  assign new_n96_ = new_n97_ & new_n92_ & ~x25 & ~x26;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n98_ = ~x01 & ~x18 & (x02 | x16);
  assign z14 = x18 | (~x01 & (~new_n100_ | (x33 & (~new_n70_ | ~new_n96_))));
  assign new_n100_ = x16 & (~new_n59_ | ~new_n72_ | ~new_n101_ | ~new_n102_);
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n106_ | (x16 & ((new_n71_ & new_n105_) | (x34 & (~new_n71_ | ~new_n104_))));
  assign new_n104_ = new_n101_ & new_n102_;
  assign new_n105_ = new_n101_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n106_ = ~x01 & ~x18 & (x00 | x16);
endmodule
