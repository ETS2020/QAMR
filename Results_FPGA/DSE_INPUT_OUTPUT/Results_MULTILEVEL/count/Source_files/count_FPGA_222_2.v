...
module FAU ( 
  ...
  assign z06 = x18 ? x26 : (new_n68_ | (~x09 & ~x16));
  ...
  assign new_n79_ = new_n61_ & ~x23 & ~x24 & ~x25 & new_n80_ & ~x26;
  assign new_n80_ = ~x27 & ~x28;
  assign z10 = (~x18 & (x16 ? ~new_n82_ : ~x05)) | (x26 & (x18 | (x16 & x29)));
  assign new_n82_ = (~new_n63_ | ~new_n84_) & (~x29 | (new_n61_ & new_n83_));
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x27 & ~x28;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x18 & (x16 ? ~new_n86_ : ~x04)) | (x26 & (x18 | (x16 & x30)));
  assign new_n86_ = (~x30 | (new_n61_ & new_n88_)) & (~new_n63_ | ~new_n87_ | ~new_n89_);
  ...
  assign new_n91_ = x31 & (~new_n63_ | ~new_n92_);
  assign new_n92_ = ~x24 & ~x25 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n93_ = new_n57_ & new_n66_ & new_n77_ & new_n94_;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n95_ = x26 & (x18 | (x16 & x31));
  assign z13 = ~new_n99_ | (x16 & ((~new_n93_ & x32) | (new_n65_ & new_n97_)));
  assign new_n97_ = new_n98_ & new_n80_ & ~x25 & ~x26;
  assign new_n98_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n99_ = ~x18 & (x02 | x16);
  assign z14 = new_n105_ | (~x18 & (x16 ? (new_n101_ | new_n102_) : ~x01));
  assign new_n101_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n98_ | ~new_n80_ | x25);
  ...
  assign z15 = ~new_n108_ | (x16 & ((~new_n102_ & x34) | (new_n71_ & new_n107_)));
