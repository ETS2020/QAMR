...
module FAU ( 
  ...
  assign z07 = (x16 & ((~new_n66_ & x26) | new_n68_ | x18)) | (~x08 & ~x16 & ~x18);
  ...
  assign z09 = (x16 & ((~new_n71_ & x28) | new_n74_ | x18)) | (~x06 & ~x16 & ~x18);
  assign new_n74_ = new_n59_ & new_n75_ & ~x26 & ~x27 & ~x28;
  assign new_n75_ = ~x23 & ~x24 & ~x25;
  assign z10 = (x16 & ((~new_n74_ & x29) | new_n77_ | x18)) | (~x05 & ~x16 & ~x18);
  assign new_n77_ = new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & ((~new_n77_ & x30) | new_n79_ | x18)) | (~x04 & ~x16 & ~x18);
  assign new_n79_ = new_n61_ & new_n69_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n81_ | (~new_n79_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n81_ = new_n56_ & new_n64_ & new_n72_ & new_n82_;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x02 & ~x16 & ~x18) | (x16 & (new_n84_ | x18 | (new_n63_ & new_n85_)));
  assign new_n84_ = x32 & (~new_n56_ | ~new_n64_ | ~new_n72_ | ~new_n82_);
  assign new_n85_ = new_n86_ & new_n87_;
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~x01 & ~x16 & ~x18) | (x16 & (new_n89_ | x18 | (new_n66_ & new_n90_)));
  assign new_n89_ = x33 & (~new_n56_ | ~new_n64_ | ~new_n86_ | ~new_n87_);
  assign new_n90_ = new_n91_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n91_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = ~new_n94_ | (x16 & ((new_n66_ & new_n93_) | (x34 & (~new_n66_ | ~new_n90_))));
