...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n70_ | (~new_n69_ & x25))) | ~new_n58_ | (~x09 & ~x16);
  assign new_n69_ = new_n59_ & new_n67_;
  assign new_n70_ = new_n60_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = ~new_n54_ & ((~new_n72_ & x16) | x18 | (~x08 & ~x16));
  assign new_n72_ = (~x26 | (new_n60_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n60_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = ~new_n54_ & ((x16 & (new_n74_ | new_n76_)) | x18 | (~x07 & ~x16));
  assign new_n74_ = x27 & (~new_n60_ | ~new_n75_ | x22 | x23);
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign new_n76_ = new_n62_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = ~new_n54_ & (~new_n80_ | (x16 & (new_n78_ | (~new_n76_ & x28))));
  assign new_n78_ = new_n62_ & new_n79_;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n80_ = ~x18 & (x06 | x16);
  assign z10 = ~new_n54_ & (~new_n83_ | (x16 & (new_n82_ | (~new_n78_ & x29))));
  assign new_n82_ = new_n64_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign new_n83_ = ~x18 & (x05 | x16);
  assign z11 = (~new_n85_ & x16) | ~new_n58_ | (~x04 & ~x16);
  assign new_n85_ = (~x30 | (new_n64_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n75_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n54_ & (~new_n90_ | (x16 & (new_n88_ | (~new_n87_ & x31))));
  assign new_n87_ = new_n64_ & new_n75_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n88_ = new_n59_ & new_n67_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n90_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n54_ & (~new_n95_ | (x16 & (new_n92_ | (~new_n88_ & x32))));
  assign new_n92_ = new_n59_ & new_n67_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n95_ = ~x18 & (x02 | x16);
  assign z14 = (~new_n101_ & ~x16) | new_n97_ | (~new_n98_ & ~x33) | (x16 & ~new_n92_ & x33);
  assign new_n97_ = ~new_n54_ & x18;
  assign new_n98_ = ~x34 & (~new_n67_ | ~new_n99_ | ~new_n93_ | ~new_n100_);
  assign new_n99_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32 & ~x34;
  assign new_n101_ = x01 & ~x18;
  assign z15 = (~new_n105_ & (x33 | ~x34)) | (x16 & ((x33 & x34) | (new_n70_ & new_n103_)));
