...
module FAU ( 
  ...
  assign z11 = x18 | (~x04 & (new_n88_ | ~x16 | (~new_n86_ & x30)));
  assign new_n88_ = new_n65_ & new_n78_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = ~new_n92_ | (x16 & ((new_n70_ & new_n90_) | (~new_n88_ & x31)));
  assign new_n90_ = new_n91_ & ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n92_ = ~x04 & ~x18 & (x03 | x16);
  assign z13 = ~new_n97_ | (x16 & (new_n94_ | (x32 & (~new_n70_ | ~new_n90_))));
  assign new_n94_ = new_n58_ & new_n68_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n96_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n97_ = ~x04 & ~x18 & (x02 | x16);
  assign z14 = ~new_n102_ | (x16 & ((new_n71_ & new_n99_) | (~new_n94_ & x33)));
  assign new_n99_ = new_n100_ & new_n101_;
  assign new_n100_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n101_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n102_ = ~x04 & ~x18 & (x01 | x16);
