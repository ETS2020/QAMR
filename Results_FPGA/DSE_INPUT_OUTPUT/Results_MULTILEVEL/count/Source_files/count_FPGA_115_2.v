...
module FAU ( 
  ...
  assign z14 = ~new_n99_ | (x16 & ((~new_n92_ & x33) | (new_n70_ & new_n97_)));
  assign new_n97_ = new_n98_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n99_ = (x01 | x16) & ~new_n54_ & ~x18;
  assign z15 = new_n101_ | (x16 & ((x34 & (~new_n70_ | ~new_n97_)) | (new_n70_ & new_n102_)));
