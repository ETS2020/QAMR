...
module FAU ( 
  ...
  assign new_n82_ = ~x30 & (~new_n83_ | ~new_n80_ | x22 | x23 | x24);
  assign new_n83_ = ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign z10 = (~new_n85_ & ~x28) | x18 | (~x05 & ~x16) | (new_n88_ & x16);
  assign new_n85_ = ~x30 & (~new_n86_ | ~new_n87_ | x26 | x27 | x29);
  assign new_n86_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n87_ = ~x23 & ~x24 & ~x25;
  assign new_n88_ = x29 & (~new_n66_ | ~new_n78_ | x27 | x28 | x30);
  assign z11 = (x16 & (new_n90_ | x30)) | (~x28 & x30) | x18 | (~x04 & ~x16);
  assign new_n90_ = new_n66_ & new_n78_ & ~x27 & ~x28 & ~x29;
  assign z12 = (~new_n92_ & ~x28) | x18 | (~x03 & ~x16) | (new_n94_ & x16);
  assign new_n92_ = ~x30 & (~new_n86_ | ~new_n87_ | ~new_n93_);
  assign new_n93_ = ~x26 & ~x27 & ~x29 & ~x31;
  assign new_n94_ = x31 & (~new_n66_ | ~new_n78_ | ~new_n95_);
  assign new_n95_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = new_n97_ | (x16 & (new_n101_ | (~x30 & (new_n98_ | new_n99_))));
  assign new_n97_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n98_ = x32 & (~new_n66_ | ~new_n78_ | x27 | x29 | x31);
  assign new_n99_ = new_n59_ & new_n69_ & new_n80_ & new_n100_;
  assign new_n100_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign new_n101_ = x28 & x32;
  assign z14 = new_n103_ | (x16 & (new_n109_ | (~x30 & (new_n104_ | new_n106_))));
  ...
  assign new_n108_ = ~x29 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = x28 & x33;
  assign z15 = new_n111_ | (x16 & (new_n116_ | (~x30 & (new_n112_ | new_n113_))));
  assign new_n111_ = ~new_n54_ & (x18 | (~x00 & ~x16));
  assign new_n112_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n80_ | ~new_n108_);
  assign new_n113_ = new_n60_ & new_n73_ & new_n114_ & new_n115_;
