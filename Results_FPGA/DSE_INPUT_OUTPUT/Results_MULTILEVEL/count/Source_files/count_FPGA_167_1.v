...
module FAU ( 
  ...
  assign new_n65_ = (~x24 | (new_n66_ & ~x21 & ~x22 & ~x23)) & (~new_n66_ | x17 | x23 | x24 | x21 | x22);
  assign new_n66_ = ~x19 & ~x20;
  assign z06 = (x16 & (new_n70_ | (~new_n68_ & x25))) | x18 | (~x09 & ~x16);
  assign new_n68_ = new_n56_ & new_n69_ & ~x21 & ~x22;
  ...
  assign new_n73_ = (~x26 | (new_n71_ & new_n74_)) & (~new_n57_ | ~new_n75_);
  assign new_n74_ = ~x19 & ~x20 & ~x21;
  assign new_n75_ = ~x24 & ~x25 & ~x26 & ~x22 & ~x23;
  assign z08 = (x17 & (x18 | (x16 & x27))) | (~x18 & (x16 ? ~new_n77_ : ~x07));
  assign new_n77_ = (~x27 | (new_n62_ & new_n69_ & ~x25 & ~x26)) & (~new_n59_ | ~new_n69_ | x25 | x26 | x27);
  assign z09 = (x17 & (x18 | (x16 & x28))) | (~x18 & (x16 ? ~new_n79_ : ~x06));
  assign new_n79_ = (~x28 | (new_n62_ & new_n69_ & new_n80_)) & (~new_n59_ | ~new_n81_);
  ...
  assign z12 = ~new_n91_ | (x16 & ((~new_n89_ & x31) | (new_n68_ & new_n90_)));
  assign new_n89_ = new_n63_ & new_n85_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n90_ = new_n80_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n91_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n95_ | (x16 & ((new_n68_ & new_n93_) | (x32 & (~new_n68_ | ~new_n90_))));
  assign new_n93_ = new_n94_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n95_ = ~x18 & (x02 | x16);
  assign z14 = new_n102_ | (~x18 & (x16 ? (new_n97_ | new_n99_) : ~x01));
  assign new_n97_ = x33 & (~new_n98_ | ~new_n94_ | ~new_n71_ | ~new_n74_);
  assign new_n98_ = ~x26 & ~x27 & ~x28;
  assign new_n99_ = new_n100_ & new_n101_ & new_n57_ & new_n71_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n102_ = x17 & (x18 | (x16 & x33));
  assign z15 = (~new_n104_ & x16) | x18 | (~x00 & ~x16);
  assign new_n104_ = (~x34 | (new_n100_ & new_n101_ & new_n57_ & new_n71_)) & (~new_n100_ | ~new_n105_ | ~new_n57_ | ~new_n71_);
