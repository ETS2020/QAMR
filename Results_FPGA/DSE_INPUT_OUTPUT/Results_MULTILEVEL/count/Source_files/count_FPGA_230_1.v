...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n69_ | (new_n59_ & new_n70_))) | ~new_n54_ | (~x09 & ~x16);
  ...
  assign z09 = ~new_n54_ | (~x06 & ~x16) | (new_n79_ & new_n78_ & x16 & ~x17);
  assign new_n78_ = ~x19 & ~x20 & ~x21;
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = x18 | (~x28 & (x16 ? ~new_n81_ : ~x05));
  assign new_n81_ = (~new_n62_ | ~new_n82_) & (~x29 | (new_n62_ & new_n76_));
  ...
  assign z12 = x18 | (~x28 & (x16 ? ~new_n88_ : ~x03));
  ...
  assign z15 = x18 | (~x28 & (x16 ? (new_n99_ | new_n100_) : ~x00));
