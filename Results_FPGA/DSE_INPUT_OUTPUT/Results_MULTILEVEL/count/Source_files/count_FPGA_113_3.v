...
module FAU ( 
  ...
  assign z05 = x18 ? ~x32 : (x16 ? ~new_n66_ : ~x10);
  ...
  assign z10 = x18 ? ~x32 : (x16 ? (new_n81_ | new_n82_) : ~x05);
  assign new_n81_ = x29 & (~new_n61_ | ~new_n79_);
  assign new_n82_ = new_n64_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n84_ & x16) | x18 | (~x04 & ~x16);
  assign new_n84_ = (~x30 | (new_n64_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n75_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n87_ | (~new_n86_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n86_ = new_n64_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n87_ = new_n57_ & new_n67_ & new_n88_ & ~x25 & ~x26 & ~x27;
  assign new_n88_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x32 & (new_n90_ | x18)) | (~x18 & (x16 ? (~new_n87_ & x32) : ~x02));
  assign new_n90_ = new_n88_ & new_n92_ & new_n91_ & x16 & ~x17 & ~x19;
  assign new_n91_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n92_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign z14 = ~new_n100_ | (x16 & (new_n97_ | (x33 & (~new_n94_ | ~new_n95_))));
  assign new_n94_ = new_n57_ & new_n67_;
  ...
  assign z15 = ~new_n104_ | (x16 & ((new_n102_ & new_n103_) | (~new_n97_ & x34)));
