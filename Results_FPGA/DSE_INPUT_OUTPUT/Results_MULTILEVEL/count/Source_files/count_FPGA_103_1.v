...
module FAU ( 
  ...
  assign z09 = x18 | (~x31 & (x16 ? (new_n79_ | new_n80_) : ~x06));
  assign new_n79_ = x28 & (~new_n61_ | ~new_n77_ | x23 | x24);
  assign new_n80_ = new_n61_ & ~x23 & ~x24 & ~x25 & new_n81_ & ~x26;
  assign new_n81_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n83_ | (~new_n80_ & x29))) | ~new_n54_ | (~x05 & ~x16);
  assign new_n83_ = new_n64_ & new_n75_ & new_n84_ & ~x27;
  ...
  assign z12 = ~new_n54_ | (~x03 & ~x16) | (new_n88_ & new_n90_ & new_n89_ & x16);
  assign new_n88_ = new_n75_ & new_n81_ & ~x29 & ~x30;
  assign new_n89_ = ~x17 & ~x19;
  assign new_n90_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z13 = x18 | (~x31 & (x16 ? (new_n92_ | new_n93_) : ~x02));
  assign new_n92_ = x32 & (~new_n64_ | ~new_n75_ | ~new_n81_ | x29 | x30);
  assign new_n93_ = new_n57_ & new_n67_ & new_n77_ & new_n84_ & ~x30 & ~x32;
  ...
  assign new_n99_ = new_n100_ & new_n84_ & ~x26 & ~x27;
  assign new_n100_ = ~x30 & ~x32 & ~x33 & ~x34;
