...
module FAU ( 
  ...
  assign new_n76_ = new_n58_ & new_n70_ & new_n74_;
  ...
  assign new_n81_ = new_n63_ & new_n73_ & ~x23 & new_n82_ & ~x26;
  assign new_n82_ = ~x27 & ~x28;
  assign z10 = x18 ? x32 : (x16 ? (new_n84_ | new_n85_) : ~x05);
  assign new_n84_ = x29 & (~new_n63_ | ~new_n73_ | x23 | ~new_n82_ | x26);
  assign new_n85_ = new_n64_ & new_n74_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 ? x32 : (x16 ? ~new_n87_ : ~x04);
  assign new_n87_ = (~x30 | (new_n64_ & new_n74_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n74_ | x27 | x28 | x29 | x30);
  assign z12 = x18 ? x32 : (x16 ? (new_n89_ | new_n91_) : ~x03);
  assign new_n89_ = x31 & (~new_n64_ | ~new_n74_ | ~new_n82_ | ~new_n90_);
  assign new_n90_ = ~x29 & ~x30;
  assign new_n91_ = new_n78_ & new_n92_ & new_n57_ & new_n67_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x18 & (new_n94_ | (~x02 & ~x16))) | (x32 & (x18 | (~new_n91_ & x16)));
  assign new_n94_ = new_n67_ & new_n95_ & new_n96_ & new_n90_ & ~x31 & ~x32;
  assign new_n95_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z14 = new_n102_ | (~x18 & (x16 ? (new_n98_ | new_n99_) : ~x01));
  assign new_n98_ = x33 & (~new_n78_ | ~new_n92_ | ~new_n57_ | ~new_n67_);
  assign new_n99_ = new_n100_ & new_n101_ & new_n58_ & new_n70_ & new_n73_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n102_ = x32 & (x18 | (x16 & x33));
  assign z15 = new_n108_ | (~x18 & (x16 ? (new_n104_ | new_n106_) : ~x00));
  assign new_n104_ = x34 & (~new_n96_ | ~new_n105_ | ~new_n57_ | ~new_n67_);
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x33;
  assign new_n106_ = new_n100_ & new_n107_ & new_n58_ & new_n70_ & new_n73_;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n108_ = x32 & (x18 | (x16 & x34));
endmodule
