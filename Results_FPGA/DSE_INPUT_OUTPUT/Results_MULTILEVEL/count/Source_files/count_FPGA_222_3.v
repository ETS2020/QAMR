...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n68_ | (new_n70_ & ~x18))) | (~x09 & ~x16 & ~x18) | (x18 & ~x26);
  assign new_n68_ = ~x17 & ~x19 & ~x20 & new_n69_ & ~x21;
  assign new_n69_ = ~x22 & ~x23 & ~x24 & ~x25 & (~x18 | ~x26);
  assign new_n70_ = x25 & (~new_n57_ | ~new_n66_);
  assign z07 = (x16 & (new_n74_ | (~new_n72_ & x26))) | x18 | (~x08 & ~x16);
  ...
  assign new_n79_ = new_n61_ & new_n80_ & ~x26 & ~x27 & ~x28;
  assign new_n80_ = ~x23 & ~x24 & ~x25;
  assign z10 = new_n82_ | (~x18 & (x16 ? (~new_n79_ & x29) : ~x05));
  assign new_n82_ = ~x26 & (x18 | (new_n83_ & new_n80_ & new_n84_));
  assign new_n83_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n84_ = ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & ~x18) | (~x26 & (new_n86_ | x18));
  assign new_n86_ = new_n83_ & new_n80_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n87_ = x16 ? (~x30 | (new_n63_ & new_n75_ & new_n84_)) : x04;
  assign z12 = new_n89_ | (~x18 & (x16 ? (~new_n94_ & x31) : ~x03));
  assign new_n89_ = ~x26 & (x18 | (new_n90_ & new_n91_ & new_n92_ & new_n93_));
  assign new_n90_ = x16 & ~x17 & ~x19;
  assign new_n91_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n92_ = ~x24 & ~x25 & ~x27;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = (x16 & (new_n97_ | (~new_n96_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n96_ = new_n57_ & new_n66_ & new_n93_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = new_n57_ & new_n66_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = new_n101_ | (~x18 & (x16 ? (~new_n97_ & x33) : ~x01));
  assign new_n101_ = ~x26 & (x18 | (new_n66_ & new_n102_ & new_n103_ & new_n104_));
  assign new_n102_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n103_ = ~x25 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n106_ & x16) | x18 | (~x00 & ~x16);
  assign new_n106_ = (~x34 | (new_n58_ & new_n73_ & new_n104_ & new_n107_)) & (~new_n58_ | ~new_n73_ | ~new_n107_ | ~new_n108_);
