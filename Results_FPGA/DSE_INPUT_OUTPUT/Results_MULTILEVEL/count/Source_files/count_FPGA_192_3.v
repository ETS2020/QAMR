...
module FAU ( 
  ...
  assign new_n60_ = ~x19 & ~x20 & ~x21 & x16 & ~x17;
  ...
  assign z05 = (~new_n67_ & ~x18) | (~x22 & (new_n65_ | x18));
  assign new_n65_ = new_n66_ & x16 & ~x17 & ~x19;
  assign new_n66_ = ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n67_ = x16 ? (new_n63_ | ~x24) : x10;
  ...
  assign z09 = new_n80_ | (~x18 & (x16 ? (~new_n77_ & x28) : ~x06));
  assign new_n80_ = ~x22 & (x18 | (new_n60_ & new_n81_));
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~x22 & (x18 | (new_n84_ & new_n85_))) | (~new_n83_ & ~x18);
  assign new_n83_ = x16 ? (~x29 | (new_n62_ & new_n81_)) : x05;
  assign new_n84_ = ~x20 & ~x21 & ~x23 & x16 & ~x17 & ~x19;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n88_ & ~x18) | (~x22 & (new_n87_ | x18));
  assign new_n87_ = new_n84_ & new_n75_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n88_ = x16 ? (~x30 | (new_n63_ & new_n85_)) : x04;
  assign z12 = (x16 & (new_n91_ | (~new_n90_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n90_ = new_n63_ & new_n75_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n57_ & new_n70_ & new_n78_ & new_n92_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x18 & (new_n96_ | new_n97_)) | (~x22 & (x18 | (new_n65_ & new_n94_)));
  assign new_n94_ = new_n95_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n96_ = x16 & x32 & (~new_n57_ | ~new_n70_ | ~new_n78_ | ~new_n92_);
  assign new_n97_ = ~x02 & ~x16;
  assign z14 = ~new_n102_ | (x16 & (new_n99_ | (x33 & (~new_n69_ | ~new_n94_))));
  assign new_n99_ = new_n58_ & new_n72_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n102_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n105_ | (x16 & ((~new_n99_ & x34) | (new_n71_ & new_n104_)));
