...
module FAU ( 
  ...
  assign new_n80_ = (~x30 | (new_n62_ & new_n71_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n71_ | x27 | x28 | x29 | x30);
  assign z12 = x16 ? (~x18 & (new_n83_ | (~new_n82_ & x31))) : (~x03 | x18);
  assign new_n82_ = new_n62_ & new_n71_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z14 = x16 ? (~x18 & (new_n90_ | (~new_n86_ & x33))) : (~x01 | x18);
  assign new_n90_ = new_n57_ & new_n68_ & new_n91_ & new_n92_;
  assign new_n91_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n92_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x16 ? (~new_n94_ & ~x18) : (~x00 | x18);
  assign new_n94_ = (~x34 | (new_n57_ & new_n68_ & new_n91_ & new_n92_)) & (~new_n91_ | ~new_n95_ | ~new_n57_ | ~new_n68_);
