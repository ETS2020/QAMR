...
module FAU ( 
  ...
  assign z03 = x18 ? x15 : (x16 ? ~new_n60_ : ~x12);
  ...
  assign z05 = x18 ? x15 : (x16 ? ~new_n66_ : ~x10);
  ...
  assign new_n78_ = new_n61_ & new_n79_;
  ...
  assign new_n85_ = new_n64_ & new_n73_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n86_ = new_n57_ & new_n67_ & new_n76_ & new_n87_;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? x15 : (x16 ? (new_n89_ | new_n90_) : ~x02);
  assign new_n89_ = x32 & (~new_n57_ | ~new_n67_ | ~new_n76_ | ~new_n87_);
  assign new_n90_ = new_n57_ & new_n67_ & new_n91_ & new_n92_;
  assign new_n91_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n92_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n96_ | (x16 & ((new_n70_ & new_n94_) | (~new_n90_ & x33)));
  assign new_n94_ = new_n95_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n99_ | (x16 & ((new_n70_ & new_n98_) | (x34 & (~new_n70_ | ~new_n94_))));
  assign new_n98_ = new_n95_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
