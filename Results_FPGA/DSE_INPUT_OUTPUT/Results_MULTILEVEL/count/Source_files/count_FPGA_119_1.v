...
module FAU ( 
  ...
  assign z04 = x18 ? x10 : (x16 ? ~new_n63_ : ~x11);
  assign new_n63_ = ~new_n64_ & (new_n61_ | ~x23);
  assign new_n64_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = x18 ? x10 : (x16 ? (new_n66_ | (~new_n64_ & x24)) : ~x10);
  ...
  assign new_n72_ = (~x26 | (new_n58_ & new_n70_)) & (~new_n58_ | ~new_n73_);
  ...
  assign z09 = x18 ? x10 : (x16 ? ~new_n78_ : ~x06);
  ...
  assign z13 = x18 ? x10 : (x16 ? (new_n92_ | new_n93_) : ~x02);
  assign new_n92_ = x32 & (~new_n57_ | ~new_n67_ | ~new_n89_ | ~new_n90_);
  assign new_n93_ = new_n57_ & new_n67_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n95_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n100_ | (x16 & ((~new_n93_ & x33) | (new_n69_ & new_n97_)));
  ...
  assign z15 = x18 ? x10 : (x16 ? ~new_n102_ : ~x00);
  assign new_n102_ = (~x34 | (new_n58_ & new_n70_ & new_n98_ & new_n99_)) & (~new_n98_ | ~new_n103_ | ~new_n58_ | ~new_n70_);
