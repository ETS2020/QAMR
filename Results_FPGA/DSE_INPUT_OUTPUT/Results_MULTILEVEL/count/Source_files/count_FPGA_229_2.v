...
module FAU ( 
  ...
  assign new_n71_ = x25 & (~new_n57_ | ~new_n69_);
  assign new_n72_ = new_n58_ & new_n73_;
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~new_n75_ & x16) | x18 | (~x08 & ~x16);
  assign new_n75_ = (~x26 | (new_n58_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n58_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = (x21 & (x18 | (x16 & x27))) | (~x18 & (x16 ? ~new_n77_ : ~x07));
  assign new_n77_ = (~x27 | (new_n64_ & new_n78_ & ~x25 & ~x26)) & (~new_n61_ | ~new_n78_ | x25 | x26 | x27);
  assign new_n78_ = ~x23 & ~x24;
  assign z09 = (x21 & (x18 | (x16 & x28))) | (~x18 & (new_n80_ | (~x06 & ~x16)));
  assign new_n80_ = x16 & ((x28 & (~new_n64_ | ~new_n81_)) | (new_n61_ & new_n82_));
  ...
  assign z12 = new_n95_ | (~x18 & (x16 ? (new_n90_ | new_n93_) : ~x03));
  assign new_n90_ = x31 & (~new_n92_ | ~new_n91_ | x28 | x29 | x30);
  assign new_n91_ = ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x17 & ~x19 & ~x20 & ~x22 & ~x23 & ~x24;
  assign new_n93_ = new_n57_ & new_n69_ & new_n91_ & new_n94_;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n95_ = x21 & (x18 | (x16 & x31));
  assign z13 = new_n101_ | (~x18 & (x16 ? (new_n97_ | new_n98_) : ~x02));
  assign new_n97_ = x32 & (~new_n92_ | ~new_n91_ | ~new_n94_);
  ...
  assign z14 = ~new_n106_ | (x16 & ((new_n72_ & new_n103_) | (~new_n98_ & x33)));
  ...
  assign new_n108_ = x34 & (~new_n57_ | ~new_n73_ | ~new_n104_ | ~new_n105_);
  assign new_n109_ = new_n58_ & new_n73_ & new_n104_ & new_n110_;
