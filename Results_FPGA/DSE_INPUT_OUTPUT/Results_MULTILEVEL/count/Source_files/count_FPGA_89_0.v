...
module FAU ( 
  ...
  assign z06 = x18 | (x30 & (x16 ? ~new_n68_ : ~x09));
  ...
  assign z09 = (x16 & (new_n77_ | (~new_n75_ & x28))) | ~new_n59_ | (~x06 & ~x16);
  assign new_n77_ = new_n61_ & new_n78_;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n80_ | (~new_n77_ & x29))) | ~new_n59_ | (~x05 & ~x16);
  assign new_n80_ = new_n63_ & new_n74_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (x30 & (x16 ? ~new_n80_ : ~x04));
