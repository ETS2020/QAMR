...
module FAU ( 
  ...
  assign z03 = x18 ? x08 : (x16 ? ~new_n60_ : ~x12);
  ...
  assign new_n86_ = (~x30 | (new_n64_ & new_n84_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n84_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n89_ | (~new_n88_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n88_ = new_n64_ & new_n84_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z14 = x18 ? x08 : (x16 ? (new_n96_ | new_n97_) : ~x01);
  assign new_n96_ = x33 & (~new_n57_ | ~new_n67_ | ~new_n93_ | ~new_n94_);
  assign new_n97_ = new_n58_ & new_n71_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n99_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x18 ? x08 : (x16 ? ~new_n101_ : ~x00);
  assign new_n101_ = (~x34 | (new_n58_ & new_n71_ & new_n98_ & new_n99_)) & (~new_n58_ | ~new_n71_ | ~new_n98_ | ~new_n102_);
