...
module FAU ( 
  ...
  assign z07 = (x23 & (x18 | (x16 & x26))) | (~x18 & (x16 ? ~new_n70_ : ~x08));
  ...
  assign z08 = new_n77_ | (~x18 & (x16 ? (new_n74_ | new_n75_) : ~x07));
  assign new_n74_ = x27 & (~new_n57_ | x22 | x24 | x25 | x26);
  assign new_n75_ = new_n59_ & new_n76_ & ~x23 & ~x24;
  assign new_n76_ = ~x25 & ~x26 & ~x27;
  assign new_n77_ = x23 & (x18 | (x16 & x27));
  assign z09 = (x16 & (new_n79_ | (~new_n75_ & x28))) | x18 | (~x06 & ~x16);
  ...
  assign new_n85_ = (~x30 | (new_n61_ & new_n83_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n83_ | x27 | x28 | x29 | x30);
  ...
  assign new_n96_ = new_n57_ & new_n68_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n102_ | (x16 & ((new_n100_ & new_n101_) | (~new_n96_ & x34)));
  assign new_n100_ = new_n57_ & new_n68_;
  assign new_n101_ = new_n97_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
