...
module FAU ( 
  ...
  assign z08 = (~x27 & (x18 | (new_n72_ & new_n75_))) | (~new_n74_ & ~x18);
  assign new_n74_ = x16 ? (~x27 | (new_n57_ & new_n72_)) : x07;
  assign new_n75_ = ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign z09 = (~x27 & (new_n77_ | x18)) | (~x18 & (x16 ? new_n79_ : ~x06));
  assign new_n77_ = new_n75_ & ~x25 & ~x26 & ~x28 & new_n78_ & ~x22;
  assign new_n78_ = ~x23 & ~x24;
  assign new_n79_ = x28 & (~new_n59_ | ~new_n78_ | x25 | x26 | x27);
  assign z10 = (~x27 & (new_n81_ | x18)) | (~x18 & (x16 ? new_n84_ : ~x05));
  assign new_n81_ = new_n82_ & new_n83_ & ~x26 & ~x28 & ~x29;
  assign new_n82_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n83_ = ~x23 & ~x24 & ~x25;
  assign new_n84_ = x29 & (~new_n59_ | ~new_n83_ | x26 | x27 | x28);
  assign z11 = (~x27 & (new_n86_ | x18)) | (~x18 & (x16 ? new_n87_ : ~x04));
  assign new_n86_ = new_n82_ & new_n83_ & ~x26 & ~x28 & ~x29 & ~x30;
  assign new_n87_ = x30 & (~new_n62_ | ~new_n88_ | x27 | x28 | x29);
  assign new_n88_ = ~x24 & ~x25 & ~x26;
  assign z12 = new_n90_ | (~x18 & (x16 ? (~new_n94_ & x31) : ~x03));
  assign new_n90_ = ~x27 & (x18 | (new_n91_ & new_n92_ & new_n88_ & new_n93_));
  assign new_n91_ = x16 & ~x17 & ~x19;
  assign new_n92_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = new_n62_ & new_n88_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = (x16 & (new_n97_ | (~new_n96_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n96_ = new_n56_ & new_n65_ & new_n93_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = new_n56_ & new_n65_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = new_n101_ | (~x18 & (x16 ? (~new_n97_ & x33) : ~x01));
  assign new_n101_ = ~x27 & (x18 | (new_n65_ & new_n102_ & new_n103_ & new_n104_));
  assign new_n102_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n103_ = ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x18 & (new_n108_ | new_n110_)) | (~x27 & (x18 | (new_n106_ & new_n107_)));
  assign new_n106_ = new_n65_ & new_n102_;
  assign new_n107_ = new_n103_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n108_ = x16 & x34 & (~new_n57_ | ~new_n68_ | ~new_n104_ | ~new_n109_);
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x00 & ~x16;
endmodule
