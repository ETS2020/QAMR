...
module FAU ( 
  ...
  assign new_n76_ = new_n59_ & new_n77_ & ~x25 & ~x26 & ~x27;
  assign new_n77_ = ~x23 & ~x24;
  assign z09 = (~x26 & (new_n79_ | x18)) | (~x18 & (x16 ? new_n81_ : ~x06));
  assign new_n79_ = new_n80_ & ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n80_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x27 & ~x28;
  assign new_n81_ = x28 & (~new_n59_ | ~new_n77_ | x25 | x26 | x27);
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n83_ | new_n84_));
  assign new_n83_ = x29 & (~new_n59_ | ~new_n72_ | x26 | x27 | x28);
  assign new_n84_ = new_n61_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = new_n86_ | (~x18 & (x16 ? (~new_n84_ & x30) : ~x04));
  assign new_n86_ = ~x26 & (x18 | (new_n87_ & new_n72_ & new_n88_));
  assign new_n87_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n88_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n91_ | (~new_n90_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n90_ = new_n61_ & new_n75_ & new_n88_;
  assign new_n91_ = new_n56_ & new_n64_ & new_n92_ & ~x25 & ~x26 & ~x27;
  ...
  assign z14 = new_n98_ | (~x18 & (x16 ? (~new_n94_ & x33) : ~x01));
  assign new_n98_ = ~x26 & (x18 | (new_n64_ & new_n71_ & new_n99_ & new_n100_));
  assign new_n99_ = ~x25 & ~x27 & ~x28 & ~x29;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x26 & (new_n102_ | x18)) | (~x18 & (new_n104_ | (~x00 & ~x16)));
  assign new_n102_ = new_n64_ & new_n71_ & new_n99_ & new_n103_;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n104_ = x16 & x34 & (~new_n57_ | ~new_n68_ | ~new_n100_ | ~new_n105_);
