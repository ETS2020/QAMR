...
module FAU ( 
  ...
  assign z09 = (~x28 & (new_n78_ | x18)) | (~x18 & (x16 ? (~new_n76_ & x28) : ~x06));
  assign new_n78_ = new_n79_ & x16 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = new_n81_ | (~x18 & (x16 ? (~new_n84_ & x29) : ~x05));
  assign new_n81_ = ~x28 & (x18 | (new_n82_ & new_n83_));
  assign new_n82_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n84_ = new_n60_ & new_n85_ & ~x26 & ~x27 & ~x28;
  ...
  assign new_n90_ = new_n63_ & new_n88_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = ~x28 & (x18 | (new_n92_ & new_n93_ & new_n88_ & new_n94_));
  assign new_n92_ = x16 & ~x17 & ~x19;
  assign new_n93_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n94_ = ~x27 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n102_ | (x16 & (new_n99_ | (x32 & (~new_n96_ | ~new_n97_))));
  assign new_n96_ = new_n57_ & new_n66_;
  assign new_n97_ = new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n99_ = new_n57_ & new_n66_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = ~x18 & (x02 | x16);
  assign z14 = ~new_n106_ | (x16 & ((new_n71_ & new_n104_) | (~new_n99_ & x33)));
  assign new_n104_ = new_n105_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n106_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n109_ | (x16 & ((new_n71_ & new_n108_) | (x34 & (~new_n71_ | ~new_n104_))));
  assign new_n108_ = new_n105_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
