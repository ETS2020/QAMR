...
module FAU ( 
  ...
  assign z05 = ~new_n59_ | (~x10 & ~x16) | (x16 & (new_n65_ | (~new_n63_ & x24)));
  assign new_n65_ = new_n57_ & new_n66_;
  assign new_n66_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (x16 & (new_n68_ | (~new_n65_ & x25))) | ~new_n59_ | (~x09 & ~x16);
  assign new_n68_ = new_n58_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = x18 | (x33 & (x16 ? ~new_n70_ : ~x08));
  assign new_n70_ = (~x26 | (new_n58_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n58_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = (x16 & (new_n74_ | (~new_n72_ & x27))) | ~new_n59_ | (~x07 & ~x16);
  ...
  assign new_n77_ = (~x28 | (new_n61_ & new_n75_ & ~x23 & ~x24)) & (~new_n61_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (x33 & (x16 ? (new_n80_ | new_n81_) : ~x05));
  assign new_n80_ = x29 & (~new_n61_ | ~new_n78_);
  assign new_n81_ = new_n63_ & new_n73_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (x33 & (x16 ? ~new_n83_ : ~x04));
  assign new_n83_ = (~x30 | (new_n63_ & new_n73_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n73_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (x33 & (x16 ? (new_n85_ | new_n87_) : ~x03));
  assign new_n85_ = x31 & (~new_n63_ | ~new_n73_ | ~new_n86_);
  assign new_n86_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n87_ = new_n57_ & new_n66_ & new_n75_ & new_n88_;
  assign new_n88_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x33 & (x16 ? (new_n90_ | new_n91_) : ~x02));
  assign new_n90_ = x32 & (~new_n57_ | ~new_n66_ | ~new_n75_ | ~new_n88_);
