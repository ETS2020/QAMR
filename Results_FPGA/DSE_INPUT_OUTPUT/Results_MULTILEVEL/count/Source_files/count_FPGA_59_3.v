...
module FAU ( 
  ...
  assign z08 = new_n71_ | (~x18 & (x16 ? (~new_n68_ & x27) : ~x07));
  assign new_n71_ = ~x19 & (x18 | (new_n72_ & new_n73_));
  assign new_n72_ = ~x20 & ~x21 & ~x22 & x16 & ~x17;
  assign new_n73_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n76_ | (~new_n75_ & x28))) | x18 | (~x06 & ~x16);
  ...
  assign new_n79_ = ~x19 & (x18 | (new_n80_ & new_n81_));
  assign new_n80_ = ~x21 & ~x22 & ~x23 & x16 & ~x17 & ~x20;
  assign new_n81_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n61_ & new_n81_)) & (~new_n61_ | ~new_n69_ | ~new_n84_);
  assign new_n84_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n89_ & ~x18) | (~x19 & (x18 | (new_n86_ & new_n87_)));
  assign new_n86_ = new_n64_ & x16 & ~x17 & ~x20;
  assign new_n87_ = new_n88_ & ~x25 & ~x26 & ~x27;
  assign new_n88_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n89_ = x16 ? (~x31 | (new_n61_ & new_n69_ & new_n84_)) : x03;
  assign z13 = ~new_n93_ | (x16 & (new_n91_ | (x32 & (~new_n63_ | ~new_n87_))));
  assign new_n91_ = new_n56_ & new_n64_ & new_n92_ & new_n77_ & ~x25 & ~x26;
  assign new_n92_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n93_ = ~x18 & (x02 | x16);
  assign z14 = ~new_n97_ | (x16 & ((~new_n91_ & x33) | (new_n66_ & new_n95_)));
  assign new_n95_ = new_n96_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n97_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n100_ | (x16 & ((new_n66_ & new_n99_) | (x34 & (~new_n66_ | ~new_n95_))));
