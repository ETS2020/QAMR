...
module FAU ( 
  ...
  assign z12 = ~new_n93_ | (x16 & ((~new_n89_ & x31) | (new_n67_ & new_n90_)));
  ...
  assign new_n93_ = x10 & ~x18 & (x03 | x16);
  ...
  assign z14 = ~new_n103_ | (x16 & ((~new_n96_ & x33) | (new_n70_ & new_n100_)));
  assign new_n100_ = new_n101_ & new_n102_;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n103_ = x10 & ~x18 & (x01 | x16);
  assign z15 = x18 | (x10 & (x16 ? ~new_n105_ : ~x00));
