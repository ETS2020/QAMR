...
module FAU ( 
  ...
  assign z08 = new_n86_ | x18 | (~x07 & ~x16) | (~new_n84_ & x16);
  assign new_n84_ = (~x27 | (new_n66_ & new_n85_ & ~x25 & ~x26)) & (~new_n63_ | ~new_n85_ | x25 | x26 | x27);
  assign new_n85_ = ~x23 & ~x24;
  assign new_n86_ = x20 & (x29 | (x16 & x27));
  assign z09 = (~new_n91_ & ~x16) | new_n92_ | (x16 & (new_n88_ | new_n93_));
  assign new_n88_ = ~x20 & ((new_n67_ & new_n90_) | (x28 & (~new_n66_ | ~new_n89_)));
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x23 & ~x24;
  ...
  assign z10 = ~new_n98_ | (x16 & ((~new_n95_ & x29) | (new_n96_ & new_n97_)));
  assign new_n95_ = new_n67_ & new_n90_;
  assign new_n96_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n97_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = (x05 | x16) & ~x18 & (~x20 | ~x29);
  assign z11 = new_n103_ | x18 | (~x04 & ~x16) | (~new_n100_ & x16);
  assign new_n100_ = (~x30 | (new_n67_ & new_n97_)) & (~new_n96_ | ~new_n101_ | ~new_n102_);
  assign new_n101_ = ~x24 & ~x25 & ~x26;
  assign new_n102_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n103_ = x20 & (x29 | (x16 & x30));
  assign z12 = (~new_n109_ & ~x16) | new_n110_ | (x16 & (new_n105_ | new_n107_));
  assign new_n105_ = ~x29 & ((x20 & x31) | (new_n96_ & new_n101_ & new_n106_));
  assign new_n106_ = ~x30 & ~x31 & ~x27 & ~x28;
  assign new_n107_ = ~x20 & x31 & (~new_n71_ | ~new_n108_);
  assign new_n108_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n109_ = (~x18 | x29) & (x03 | (x20 & x29));
  assign new_n110_ = x18 & (~x20 | (~x29 & ~x31));
  assign z13 = new_n118_ | (x16 & (new_n112_ | new_n114_)) | x18 | (~x02 & ~x16);
  assign new_n112_ = x32 & (~new_n71_ | ~new_n113_ | x25 | x26 | x27);
  assign new_n113_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n114_ = new_n116_ & new_n117_ & new_n115_ & ~x17 & ~x19 & ~x20;
  assign new_n115_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n116_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n117_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n118_ = x20 & (x29 | (x16 & x32));
  assign z14 = new_n126_ | ~new_n127_ | (x16 & (new_n121_ | (new_n120_ & new_n123_)));
  assign new_n120_ = new_n76_ & new_n77_;
  assign new_n121_ = x33 & (~new_n62_ | ~new_n77_ | ~new_n117_ | ~new_n122_ | x26);
  assign new_n122_ = ~x27 & ~x28;
  assign new_n123_ = new_n124_ & new_n125_;
  assign new_n124_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n125_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n126_ = x20 & (x29 | (x16 & x33));
  assign new_n127_ = ~x18 & (x01 | x16);
  assign z15 = (~new_n134_ & ~x16) | new_n135_ | (x16 & (new_n129_ | new_n133_));
  assign new_n129_ = ~x29 & (new_n130_ | (new_n76_ & new_n77_ & new_n131_ & new_n132_));
  assign new_n130_ = x20 & x34;
  assign new_n131_ = ~x28 & ~x30 & ~x26 & ~x27;
  assign new_n132_ = ~x33 & ~x34 & ~x31 & ~x32;
  assign new_n133_ = ~x20 & x34 & (~new_n124_ | ~new_n125_ | ~new_n62_ | ~new_n77_);
  assign new_n134_ = (~x18 | x29) & (x00 | (x20 & x29));
  assign new_n135_ = x18 & (~x20 | (~x29 & ~x34));
endmodule
