...
module FAU ( 
  ...
  assign new_n76_ = ~x18 & x27 & (~new_n58_ | ~new_n77_ | x22 | x23);
  ...
  assign new_n102_ = new_n57_ & new_n67_ & new_n103_ & ~x25 & ~x26 & ~x27;
  assign new_n103_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z14 = new_n105_ | (~x18 & (x16 ? (~new_n109_ & x33) : ~x01));
  assign new_n105_ = ~x28 & (x18 | (new_n67_ & new_n106_ & new_n107_ & new_n108_));
  assign new_n106_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n107_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = new_n57_ & new_n67_ & new_n101_ & new_n85_ & ~x25 & ~x26;
  assign z15 = (~new_n111_ & x16) | x18 | (~x00 & ~x16);
  assign new_n111_ = (~x34 | (new_n58_ & new_n70_ & new_n108_ & new_n112_)) & (~new_n58_ | ~new_n70_ | ~new_n112_ | ~new_n113_);
