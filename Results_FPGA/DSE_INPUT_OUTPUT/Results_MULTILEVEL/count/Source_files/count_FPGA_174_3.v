...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n68_ | (new_n57_ & new_n69_))) | x18 | (~x09 & ~x16);
  ...
  assign z09 = x18 ? ~x31 : (x16 ? (new_n78_ | new_n79_) : ~x06);
  assign new_n78_ = x28 & (~new_n60_ | ~new_n76_ | x23 | x24);
  assign new_n79_ = new_n60_ & new_n80_;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n82_ | (~new_n79_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n82_ = new_n63_ & new_n74_ & new_n83_ & ~x27;
  ...
  assign z12 = (~x31 & (x18 | (new_n87_ & new_n74_ & new_n90_))) | (~new_n89_ & ~x18);
  ...
  assign z13 = (~x18 & (new_n94_ | new_n96_)) | (~x31 & (x18 | (new_n87_ & new_n92_)));
  assign new_n92_ = new_n93_ & ~x24 & ~x25 & new_n83_ & ~x30 & ~x32;
  assign new_n93_ = ~x26 & ~x27;
  assign new_n94_ = x16 & x32 & (~new_n56_ | ~new_n66_ | ~new_n76_ | ~new_n95_);
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = ~x02 & ~x16;
  assign z14 = (x16 & (new_n101_ | (~new_n98_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n98_ = new_n56_ & new_n66_ & new_n99_ & new_n100_;
  assign new_n99_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = new_n57_ & new_n69_ & new_n102_ & new_n93_ & new_n83_;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n104_ | (~x18 & (x16 ? (~new_n101_ & x34) : ~x00));
  assign new_n104_ = ~x31 & (x18 | (new_n66_ & new_n105_ & new_n99_ & new_n106_));
  assign new_n105_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n106_ = ~x29 & ~x30 & ~x32 & ~x33 & ~x34;
endmodule
