...
module FAU ( 
  ...
  assign z07 = x18 | (~x21 & (x16 ? ~new_n71_ : ~x08));
  assign new_n71_ = (~x26 | (new_n59_ & new_n69_)) & (~new_n60_ | ~new_n72_);
  assign new_n72_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x21 & (x16 ? ~new_n74_ : ~x07));
  assign new_n74_ = (~x27 | (new_n60_ & ~x25 & ~x26 & ~x23 & ~x24)) & (~new_n60_ | x23 | x24 | x25 | x26 | x27);
  assign z09 = (x16 & (new_n78_ | (~new_n76_ & x28))) | ~new_n54_ | (~x06 & ~x16);
  ...
  assign z11 = (x16 & (new_n85_ | (~new_n84_ & x30))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n84_ = new_n63_ & new_n82_;
  assign new_n85_ = new_n66_ & new_n77_ & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x21 & (x16 ? ~new_n87_ : ~x03));
  assign new_n87_ = (~x31 | (new_n66_ & new_n77_ & ~x28 & ~x29 & ~x30)) & (~new_n66_ | ~new_n77_ | x28 | x29 | x30 | x31);
  assign z13 = (x16 & (new_n90_ | (~new_n89_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n89_ = new_n66_ & new_n77_ & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n90_ = new_n59_ & new_n69_ & new_n79_ & new_n91_;
  assign new_n91_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x21 & (x16 ? (new_n93_ | new_n94_) : ~x01));
  assign new_n93_ = x33 & (~new_n59_ | ~new_n69_ | ~new_n79_ | ~new_n91_);
  assign new_n94_ = new_n59_ & new_n69_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x21 & (x16 ? (new_n98_ | new_n99_) : ~x00));
  assign new_n98_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n95_ | ~new_n96_);
  assign new_n99_ = new_n60_ & new_n72_ & new_n100_ & new_n101_;
