...
module FAU ( 
  ...
  assign z05 = (~new_n65_ & x16) | ~new_n55_ | (~x10 & ~x16);
  assign new_n65_ = (new_n63_ | ~x24) & (~new_n58_ | ~new_n66_);
  assign new_n66_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = x18 | (x33 & (x16 ? ~new_n68_ : ~x09));
  assign new_n68_ = (~x25 | (new_n58_ & new_n66_)) & (~new_n59_ | ~new_n69_);
  assign new_n69_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~new_n71_ & x16) | ~new_n55_ | (~x08 & ~x16);
  assign new_n71_ = (~x26 | (new_n59_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n59_ | x24 | x25 | x26 | x22 | x23);
  assign z08 = (x16 & (new_n75_ | (~new_n73_ & x27))) | ~new_n55_ | (~x07 & ~x16);
  assign new_n73_ = new_n59_ & new_n74_ & ~x22 & ~x23;
  assign new_n74_ = ~x24 & ~x25 & ~x26;
  assign new_n75_ = new_n61_ & ~x25 & ~x26 & ~x27 & ~x23 & ~x24;
  ...
  assign new_n82_ = (~x30 | (new_n63_ & new_n74_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n74_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n85_ | (~new_n84_ & x31))) | ~new_n55_ | (~x03 & ~x16);
  assign new_n84_ = new_n63_ & new_n74_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n85_ = new_n58_ & new_n66_ & new_n86_ & ~x25 & ~x26 & ~x27;
  assign new_n86_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n88_ | (~new_n85_ & x32))) | ~new_n55_ | (~x02 & ~x16);
  assign new_n88_ = new_n58_ & new_n66_ & new_n89_ & new_n90_;
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n90_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~new_n88_ & x16) | ~new_n55_ | (~x01 & ~x16);
