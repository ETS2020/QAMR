...
module FAU ( 
  ...
  assign z11 = x18 | (x05 & (x16 ? ~new_n89_ : ~x04));
  ...
  assign z14 = x18 | (x05 & (x16 ? (new_n101_ | new_n102_) : ~x01));
  assign new_n101_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n98_ | ~new_n99_);
  assign new_n102_ = new_n59_ & new_n72_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n107_ | (x16 & ((new_n71_ & new_n106_) | (~new_n102_ & x34)));
  assign new_n106_ = new_n103_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n107_ = x05 & ~x18 & (x00 | x16);
endmodule
