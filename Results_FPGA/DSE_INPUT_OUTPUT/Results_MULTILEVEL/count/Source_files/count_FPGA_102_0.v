...
module FAU ( 
  ...
  assign z06 = (~new_n63_ & x25) | ~x16 | new_n66_ | x18;
  ...
  assign z10 = (~new_n73_ & x29) | ~x16 | x18 | (new_n76_ & new_n61_);
  assign new_n76_ = new_n69_ & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~new_n78_ & x16);
  assign new_n78_ = (~x30 | (new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n69_ | x27 | x28 | x29 | x30);
  assign z12 = (~new_n80_ & x31) | ~x16 | x18 | (new_n63_ & new_n81_);
  assign new_n80_ = new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n81_ = new_n82_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n84_ | (x32 & (~new_n63_ | ~new_n81_))));
  assign new_n84_ = new_n56_ & new_n64_ & new_n85_ & new_n86_;
  assign new_n85_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((~new_n84_ & x33) | (new_n66_ & new_n88_)));
  assign new_n88_ = new_n89_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = ~x16 | x18 | (new_n66_ & new_n91_) | (x34 & (~new_n66_ | ~new_n88_));
