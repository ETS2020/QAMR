// Benchmark "FAU" written by ABC on Mon Aug 17 20:11:13 2020
...
module FAU ( 
  ...
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n66_ | new_n67_));
  assign new_n66_ = x25 & (~new_n56_ | ~new_n64_);
  assign new_n67_ = new_n57_ & new_n68_;
  assign new_n68_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~x26 & (new_n70_ | x18)) | (~x18 & (x16 ? (~new_n67_ & x26) : ~x08));
  assign new_n70_ = new_n71_ & new_n72_ & ~x21 & ~x22;
  ...
  assign new_n76_ = new_n59_ & new_n77_ & ~x23 & ~x24;
  assign new_n77_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n79_ | (~new_n76_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n79_ = new_n59_ & new_n72_ & new_n80_ & ~x26;
  assign new_n80_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n82_ | (~new_n79_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n82_ = new_n61_ & new_n75_ & new_n83_ & ~x27;
  assign new_n83_ = ~x28 & ~x29;
  assign z11 = new_n85_ | (~x18 & (x16 ? (~new_n82_ & x30) : ~x04));
  assign new_n85_ = ~x26 & (x18 | (new_n86_ & new_n72_ & new_n87_));
  assign new_n86_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n93_ & ~x18) | (~x26 & (x18 | (new_n89_ & new_n91_)));
  assign new_n89_ = new_n90_ & x16 & ~x17 & ~x19;
  assign new_n90_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n91_ = new_n92_ & ~x24 & ~x25 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x16 ? (~x31 | (new_n61_ & new_n75_ & new_n87_)) : x03;
  assign z13 = (~x18 & (new_n97_ | new_n98_)) | (~x26 & (x18 | (new_n89_ & new_n95_)));
  assign new_n95_ = new_n96_ & new_n80_ & ~x24 & ~x25;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n97_ = x16 & x32 & (~new_n56_ | ~new_n64_ | ~new_n77_ | ~new_n92_);
  assign new_n98_ = ~x02 & ~x16;
  assign z14 = (~x26 & (new_n100_ | x18)) | (~x18 & (x16 ? new_n102_ : ~x01));
  assign new_n100_ = new_n64_ & new_n71_ & new_n101_ & new_n83_ & ~x25 & ~x27;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n102_ = x33 & (~new_n56_ | ~new_n64_ | ~new_n96_ | ~new_n103_ | ~new_n80_);
  assign new_n103_ = ~x25 & ~x26;
  assign z15 = (~new_n105_ & x16) | x18 | (~x00 & ~x16);
  assign new_n105_ = (~x34 | (new_n57_ & new_n68_ & new_n101_ & new_n106_)) & (~new_n57_ | ~new_n68_ | ~new_n106_ | ~new_n107_);
