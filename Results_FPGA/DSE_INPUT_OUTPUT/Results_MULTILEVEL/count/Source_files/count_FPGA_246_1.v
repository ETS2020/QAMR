...
module FAU ( 
  ...
  assign z08 = x18 | (~x28 & (new_n75_ | (~x07 & ~x16)));
  assign new_n75_ = x16 & ((x27 & (~new_n59_ | ~new_n73_)) | (new_n62_ & new_n76_));
  ...
  assign new_n84_ = ~x27 & ~x29;
  assign z11 = (x16 & (new_n86_ | (~new_n83_ & x30))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n86_ = new_n64_ & new_n87_ & ~x27 & ~x29 & ~x30;
  assign new_n87_ = ~x24 & ~x25 & ~x26;
  assign z12 = x18 | (~x28 & (x16 ? ~new_n89_ : ~x03));
  assign new_n89_ = (~x31 | (new_n64_ & new_n87_ & ~x27 & ~x29 & ~x30)) & (~new_n64_ | ~new_n87_ | x27 | x29 | x30 | x31);
  assign z13 = x18 | (~x28 & (x16 ? (new_n91_ | new_n92_) : ~x02));
  assign new_n91_ = x32 & (~new_n64_ | ~new_n87_ | ~new_n84_ | x30 | x31);
  assign new_n92_ = new_n58_ & new_n67_ & new_n79_ & new_n93_;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x28 & (x16 ? (new_n95_ | new_n96_) : ~x01));
  assign new_n95_ = x33 & (~new_n58_ | ~new_n67_ | ~new_n79_ | ~new_n93_);
  assign new_n96_ = new_n58_ & new_n67_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n98_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n103_ | (x16 & ((~new_n96_ & x34) | (new_n100_ & new_n101_)));
  assign new_n100_ = new_n59_ & new_n70_;
  assign new_n101_ = new_n102_ & ~x29 & ~x30 & ~x26 & ~x27;
  assign new_n102_ = ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n103_ = new_n54_ & (x00 | x16);
endmodule
