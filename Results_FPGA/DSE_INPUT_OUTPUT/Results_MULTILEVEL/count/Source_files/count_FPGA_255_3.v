...
module FAU ( 
  ...
  assign z05 = new_n66_ | (~x18 & (x16 ? (~new_n64_ & x24) : ~x10));
  assign new_n66_ = ~x21 & (x18 | (new_n67_ & x16 & ~x17 & ~x19));
  assign new_n67_ = ~x20 & ~x22 & ~x23 & ~x24;
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n69_ | new_n71_));
  assign new_n69_ = x25 & (~new_n56_ | ~new_n70_);
  ...
  assign new_n79_ = ~x21 & (x18 | (new_n61_ & new_n80_));
  ...
  assign z11 = (~x21 & (new_n85_ | x18)) | (~x18 & (x16 ? new_n87_ : ~x04));
  assign new_n85_ = new_n86_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n86_ = ~x20 & ~x22 & ~x23 & x16 & ~x17 & ~x19;
  assign new_n87_ = x30 & (~new_n64_ | ~new_n75_ | x27 | x28 | x29);
  assign z12 = (x16 & (new_n90_ | (~new_n89_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n89_ = new_n64_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n90_ = new_n56_ & new_n70_ & new_n91_ & ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n93_ | (~new_n90_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n93_ = new_n56_ & new_n70_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = new_n97_ | (~x18 & (x16 ? (~new_n93_ & x33) : ~x01));
  assign new_n97_ = ~x21 & (x18 | (new_n57_ & new_n72_ & new_n98_ & new_n99_));
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n103_ | (x16 & ((x34 & (~new_n71_ | ~new_n101_)) | (new_n71_ & new_n102_)));
