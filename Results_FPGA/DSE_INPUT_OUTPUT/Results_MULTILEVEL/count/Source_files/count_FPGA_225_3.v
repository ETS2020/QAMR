...
module FAU ( 
  ...
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n75_ | (~new_n74_ & x27)));
  ...
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n80_ | (~new_n77_ & x29)));
  assign new_n80_ = new_n62_ & new_n81_ & ~x27 & ~x28 & ~x29;
  assign new_n81_ = ~x24 & ~x25 & ~x26;
  assign z11 = x16 ? (~new_n83_ & ~x18) : (~x04 | x18);
  assign new_n83_ = (~x30 | (new_n62_ & new_n81_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n81_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n86_ | (~new_n85_ & x31)));
  assign new_n85_ = new_n62_ & new_n81_ & new_n78_ & ~x29 & ~x30;
  ...
  assign z14 = ~new_n95_ | (x16 & ((~new_n89_ & x33) | (new_n68_ & new_n92_)));
  ...
  assign z15 = x16 ? (~new_n97_ & ~x18) : (~x00 | x18);
  assign new_n97_ = (~x34 | (new_n57_ & new_n69_ & new_n93_ & new_n94_)) & (~new_n93_ | ~new_n98_ | ~new_n57_ | ~new_n69_);
