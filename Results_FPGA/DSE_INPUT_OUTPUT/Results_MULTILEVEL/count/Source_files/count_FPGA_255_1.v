...
module FAU ( 
  ...
  assign new_n66_ = ~x22 & ~x23 & ~x24 & ~x17 & ~x19 & ~x20;
  ...
  assign new_n71_ = new_n61_ & ~x25 & ~x26 & ~x23 & ~x24;
  ...
  assign new_n75_ = (~x28 | (new_n61_ & new_n76_)) & (~new_n63_ | ~new_n77_);
  ...
  assign z11 = x18 | (~x21 & (x16 ? (new_n82_ | new_n83_) : ~x04));
  assign new_n82_ = x30 & (~new_n63_ | ~new_n80_);
  ...
  assign new_n89_ = new_n60_ & new_n69_ & new_n90_ & new_n91_;
  assign new_n90_ = ~x26 & ~x27 & ~x28;
  assign new_n91_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x21 & (x16 ? (new_n93_ | new_n94_) : ~x01));
  assign new_n93_ = x33 & (~new_n60_ | ~new_n69_ | ~new_n90_ | ~new_n91_);
  assign new_n94_ = new_n60_ & new_n69_ & new_n95_ & new_n96_;
