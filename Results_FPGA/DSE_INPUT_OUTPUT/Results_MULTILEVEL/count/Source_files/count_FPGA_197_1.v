...
module FAU ( 
  ...
  assign new_n81_ = new_n63_ & new_n73_ & new_n82_ & ~x27;
  ...
  assign new_n88_ = new_n57_ & new_n66_ & new_n75_ & new_n82_ & new_n89_;
  assign new_n89_ = ~x30 & ~x31;
  assign z13 = x18 | (~x33 & (x16 ? (new_n91_ | new_n92_) : ~x02));
  assign new_n91_ = x32 & (~new_n57_ | ~new_n66_ | ~new_n75_ | ~new_n82_ | ~new_n89_);
  assign new_n92_ = new_n57_ & new_n66_ & new_n93_ & new_n87_ & ~x25 & ~x26;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n59_ | (~x01 & ~x16) | (new_n95_ & new_n96_);
  assign new_n95_ = new_n93_ & new_n87_ & ~x25 & ~x26;
  assign new_n96_ = new_n66_ & ~x19 & ~x20 & x16 & ~x17;
  assign z15 = ~new_n99_ | (x16 & ((~new_n92_ & x34) | (new_n68_ & new_n98_)));
  assign new_n98_ = new_n82_ & ~x26 & ~x27 & new_n89_ & ~x32 & ~x34;
  assign new_n99_ = new_n59_ & (x00 | x16);
endmodule
