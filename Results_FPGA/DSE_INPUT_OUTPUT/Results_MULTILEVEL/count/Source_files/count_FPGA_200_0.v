...
module FAU ( 
  ...
  assign z12 = (~new_n80_ & x31) | ~x16 | x18 | (new_n64_ & new_n82_);
  ...
  assign z14 = x18 | (x16 & ((~new_n85_ & x33) | (new_n67_ & new_n89_)));
  assign new_n89_ = new_n90_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = x18 | (x16 & ((new_n67_ & new_n92_) | (x34 & (~new_n67_ | ~new_n89_))));
