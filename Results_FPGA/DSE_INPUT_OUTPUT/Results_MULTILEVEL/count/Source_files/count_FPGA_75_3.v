...
module FAU ( 
  ...
  assign new_n72_ = ~x17 & (x18 | (new_n58_ & new_n73_ & ~x22 & ~x23));
  assign new_n73_ = ~x24 & ~x25 & ~x26;
  assign z08 = (~x17 & (new_n75_ | x18)) | (~x18 & (x16 ? new_n77_ : ~x07));
  assign new_n75_ = new_n76_ & ~x20 & ~x21 & ~x22 & x16 & ~x19;
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n77_ = x27 & (~new_n60_ | ~new_n73_ | x22 | x23);
  assign z09 = (x16 & (new_n80_ | (~new_n79_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n79_ = new_n61_ & new_n76_;
  assign new_n80_ = new_n61_ & ~x23 & ~x24 & ~x25 & new_n81_ & ~x26;
  assign new_n81_ = ~x27 & ~x28;
  assign z10 = new_n83_ | (~x18 & (x16 ? (~new_n80_ & x29) : ~x05));
  assign new_n83_ = ~x17 & (x18 | (new_n84_ & new_n85_));
  assign new_n84_ = ~x21 & ~x22 & ~x23 & x16 & ~x19 & ~x20;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & x16) | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n63_ & new_n85_)) & (~new_n63_ | ~new_n73_ | ~new_n88_);
  assign new_n88_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n93_ & ~x18) | (~x17 & (x18 | (new_n90_ & new_n91_)));
  assign new_n90_ = new_n66_ & x16 & ~x19 & ~x20;
  assign new_n91_ = new_n92_ & ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x16 ? (~x31 | (new_n63_ & new_n73_ & new_n88_)) : x03;
  assign z13 = ~new_n97_ | (x16 & (new_n95_ | (x32 & (~new_n68_ | ~new_n91_))));
  assign new_n95_ = new_n57_ & new_n66_ & new_n96_ & new_n81_ & ~x25 & ~x26;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n97_ = ~x18 & (x02 | x16);
  assign z14 = new_n99_ | (~x18 & (x16 ? (~new_n95_ & x33) : ~x01));
  assign new_n99_ = ~x17 & (x18 | (new_n58_ & new_n70_ & new_n100_ & new_n101_));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n105_ | (x16 & ((new_n69_ & new_n104_) | (x34 & (~new_n69_ | ~new_n103_))));
