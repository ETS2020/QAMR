...
module FAU ( 
  ...
  assign z08 = x16 ? (~x18 & (new_n72_ | (~new_n71_ & x27))) : (~x07 | x18);
  ...
  assign new_n77_ = new_n61_ & new_n78_ & ~x27 & ~x28 & ~x29;
  assign new_n78_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n80_ & x16) | x18 | (~x04 & ~x16);
  assign new_n80_ = (~x30 | (new_n61_ & new_n78_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n78_ | x29 | x30 | x27 | x28);
  assign z12 = x16 ? (~x18 & (new_n83_ | (~new_n82_ & x31))) : (~x03 | x18);
  assign new_n82_ = new_n61_ & new_n78_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign new_n88_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n92_ | (x16 & ((~new_n86_ & x33) | (new_n66_ & new_n90_)));
  assign new_n90_ = new_n91_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n91_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n92_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n95_ | (x16 & ((new_n66_ & new_n94_) | (x34 & (~new_n66_ | ~new_n90_))));
