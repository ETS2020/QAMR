...
module FAU ( 
  ...
  assign z01 = (~new_n55_ & x16) | (~x14 & ~x16) | x18 | ~x27;
  ...
  assign z04 = (~new_n63_ & x16) | (~x11 & ~x16) | x18 | ~x27;
  ...
  assign z06 = (x16 & (new_n67_ | new_n68_)) | (~x09 & ~x16) | x18 | ~x27;
  assign new_n67_ = x25 & (~new_n58_ | x21 | x22 | x23 | x24);
  assign new_n68_ = new_n59_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 | (x27 & (x16 ? ~new_n70_ : ~x08));
  assign new_n70_ = (~x26 | (new_n59_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n59_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = (~new_n72_ & x16) | (~x07 & ~x16) | x18 | ~x27;
  assign new_n72_ = new_n59_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
