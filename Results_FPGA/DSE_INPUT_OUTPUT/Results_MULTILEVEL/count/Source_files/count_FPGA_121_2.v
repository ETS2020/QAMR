...
module FAU ( 
  ...
  assign new_n78_ = (~x28 | (new_n58_ & new_n79_ & new_n76_)) & (~new_n60_ | ~new_n80_);
  assign new_n79_ = ~x22 & ~x23;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x24 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n82_ : ~x05));
  assign new_n82_ = (~new_n62_ | ~new_n84_) & (~x29 | (new_n60_ & new_n83_));
  assign new_n83_ = ~x23 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x24 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n86_ : ~x04));
  assign new_n86_ = (~x30 | (new_n60_ & new_n88_)) & (~new_n62_ | ~new_n87_ | ~new_n89_);
  assign new_n87_ = ~x24 & ~x25 & ~x26;
  assign new_n88_ = ~x23 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n89_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n94_ | (~x18 & (x16 ? (new_n91_ | new_n92_) : ~x03));
  assign new_n91_ = x31 & (~new_n62_ | ~new_n76_ | x28 | x29 | x30);
  assign new_n92_ = new_n57_ & new_n65_ & new_n76_ & new_n93_;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = x24 & (x18 | (x16 & x31));
  assign z13 = ~new_n98_ | (x16 & ((~new_n92_ & x32) | (new_n64_ & new_n96_)));
  ...
  assign new_n100_ = x33 & (~new_n57_ | ~new_n71_ | ~new_n101_ | ~new_n97_);
  assign new_n101_ = ~x26 & ~x27 & ~x28;
  assign new_n102_ = new_n58_ & new_n68_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n105_ = x24 & (x18 | (x16 & x33));
  assign z15 = new_n110_ | (~x18 & (x16 ? (new_n107_ | new_n108_) : ~x00));
  assign new_n107_ = x34 & (~new_n57_ | ~new_n71_ | ~new_n103_ | ~new_n104_);
  assign new_n108_ = new_n58_ & new_n68_ & new_n103_ & new_n109_;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n110_ = x24 & (x18 | (x16 & x34));
endmodule
