...
module FAU ( 
  ...
  assign z08 = x18 | (x16 & (new_n72_ | (x27 & (~new_n57_ | ~new_n70_))));
  ...
  assign new_n77_ = new_n62_ & new_n78_ & ~x27 & ~x28 & ~x29;
  assign new_n78_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n77_ & x30) | ~x16 | new_n80_ | x18;
  assign new_n80_ = new_n62_ & new_n78_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & ((~new_n80_ & x31) | (new_n64_ & new_n82_)));
  assign new_n82_ = new_n83_ & ~x25 & ~x26 & ~x27;
  assign new_n83_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n85_ | (x32 & (~new_n64_ | ~new_n82_))));
  assign new_n85_ = new_n56_ & new_n65_ & new_n86_ & new_n87_;
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~new_n85_ & x33) | ~x16 | x18 | (new_n67_ & new_n89_);
  assign new_n89_ = new_n90_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (x34 & (~new_n67_ | ~new_n89_)) | ~x16 | x18 | (new_n67_ & new_n92_);
