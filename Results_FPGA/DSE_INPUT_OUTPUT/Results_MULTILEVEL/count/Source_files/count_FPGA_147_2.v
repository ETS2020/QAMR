...
module FAU ( 
  ...
  assign new_n79_ = new_n66_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n81_ | (~new_n79_ & x28))) | ~new_n65_ | (~x06 & ~x16);
  assign new_n81_ = new_n66_ & ~x23 & ~x24 & ~x25 & new_n82_ & ~x26;
  assign new_n82_ = ~x27 & ~x28;
  assign z10 = ~new_n54_ & (~new_n86_ | (x16 & (new_n84_ | (~new_n81_ & x29))));
  assign new_n84_ = new_n67_ & new_n78_ & new_n85_ & ~x27;
  assign new_n85_ = ~x28 & ~x29;
  assign new_n86_ = ~x18 & (x05 | x16);
  assign z11 = (~new_n89_ & (~x30 | x32)) | (x16 & (new_n88_ | (x30 & ~new_n84_ & x32)));
  assign new_n88_ = new_n67_ & new_n78_ & new_n82_ & ~x29 & ~x30;
  assign new_n89_ = ~x18 & (x04 | x16);
  assign z12 = new_n94_ | (x16 & (new_n91_ | new_n92_)) | x18 | (~x03 & ~x16);
  assign new_n91_ = x31 & (~new_n67_ | ~new_n78_ | ~new_n85_ | x27);
  assign new_n92_ = new_n59_ & new_n70_ & new_n93_ & ~x25 & ~x26 & ~x27;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = x30 & (~x32 | (x16 & x31));
  assign z13 = new_n96_ | (x16 & ((~new_n92_ & x32) | (new_n69_ & new_n97_)));
  assign new_n96_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n97_ = new_n98_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z14 = new_n100_ | (x16 & (new_n104_ | (~x30 & (new_n101_ | new_n102_))));
  assign new_n100_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n101_ = x33 & (~new_n67_ | ~new_n78_ | ~new_n82_ | x29 | x31);
  assign new_n102_ = new_n59_ & new_n70_ & new_n98_ & new_n103_;
  assign new_n103_ = ~x29 & ~x31 & ~x32 & ~x33;
  assign new_n104_ = x32 & x33;
  assign z15 = new_n109_ | ~new_n110_ | (x16 & (new_n106_ | (new_n72_ & new_n107_)));
  assign new_n106_ = x34 & (~new_n59_ | ~new_n70_ | ~new_n98_ | ~new_n103_);
  assign new_n107_ = new_n108_ & new_n85_ & ~x26 & ~x27;
  assign new_n108_ = ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n109_ = x30 & (~x32 | (x16 & x34));
