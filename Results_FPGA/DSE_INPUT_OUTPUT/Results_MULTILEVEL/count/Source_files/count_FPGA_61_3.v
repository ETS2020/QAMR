...
module FAU ( 
  ...
  assign z06 = x18 ? ~x04 : (x16 ? ~new_n66_ : ~x09);
  assign new_n66_ = (~x25 | (new_n56_ & new_n64_)) & (~new_n57_ | ~new_n67_);
  assign new_n67_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n69_ | new_n70_));
  assign new_n69_ = x26 & (~new_n57_ | ~new_n67_);
  assign new_n70_ = new_n71_ & ~x17 & ~x18 & ~x19 & ~x20 & ~x21;
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? ~x04 : (x16 ? ~new_n73_ : ~x07);
  assign new_n73_ = (~x27 | (new_n57_ & new_n71_)) & (~new_n59_ | ~new_n74_);
  ...
  assign z11 = (~x04 & (~x16 | x18)) | (x16 & ~new_n83_ & ~x18);
  assign new_n83_ = (~x30 | (new_n61_ & new_n81_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n81_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n86_ | (~new_n85_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n85_ = new_n61_ & new_n81_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = x18 ? ~x04 : (x16 ? (new_n93_ | new_n94_) : ~x01);
  assign new_n93_ = x33 & (~new_n56_ | ~new_n64_ | ~new_n90_ | ~new_n91_);
  assign new_n94_ = new_n57_ & new_n67_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? ~x04 : (x16 ? ~new_n98_ : ~x00);
  assign new_n98_ = (~x34 | (new_n57_ & new_n67_ & new_n95_ & new_n96_)) & (~new_n95_ | ~new_n99_ | ~new_n57_ | ~new_n67_);
