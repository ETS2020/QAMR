...
module FAU ( 
  ...
  assign z09 = (x16 & ((~new_n71_ & x28) | new_n73_ | x18)) | (~x06 & ~x16 & ~x18);
  ...
  assign z12 = (~x03 & ~x16 & ~x18) | (x16 & (new_n80_ | x18 | (new_n63_ & new_n81_)));
  assign new_n80_ = x31 & (~new_n61_ | ~new_n69_ | ~new_n74_ | x29 | x30);
  assign new_n81_ = new_n82_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n87_ | (x16 & (new_n84_ | (x32 & (~new_n63_ | ~new_n81_))));
  ...
  assign z14 = ~new_n91_ | (x16 & ((~new_n84_ & x33) | (new_n66_ & new_n89_)));
  assign new_n89_ = new_n90_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n94_ | (x16 & ((new_n66_ & new_n93_) | (x34 & (~new_n66_ | ~new_n89_))));
