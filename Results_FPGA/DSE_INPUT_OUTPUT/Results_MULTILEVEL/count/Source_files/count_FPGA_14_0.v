...
module FAU ( 
  ...
  assign z05 = (~new_n62_ & x24) | ~x16 | new_n64_ | x18;
  assign new_n64_ = new_n56_ & new_n65_;
  assign new_n65_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (~new_n64_ & x25) | ~x16 | new_n67_ | x18;
  ...
  assign new_n79_ = new_n62_ & new_n70_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n79_ & x31) | ~x16 | x18 | (new_n64_ & new_n81_);
  assign new_n81_ = new_n82_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n84_ | (x32 & (~new_n64_ | ~new_n81_))));
  assign new_n84_ = new_n56_ & new_n65_ & new_n85_ & new_n86_;
  assign new_n85_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((~new_n84_ & x33) | (new_n67_ & new_n88_)));
  assign new_n88_ = new_n89_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = ~x16 | x18 | (new_n67_ & new_n91_) | (x34 & (~new_n67_ | ~new_n88_));
