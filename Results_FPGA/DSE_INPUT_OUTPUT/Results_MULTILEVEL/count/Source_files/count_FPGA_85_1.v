...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n71_ | (~new_n70_ & x25))) | ~new_n59_ | (~x09 & ~x16);
  assign new_n70_ = new_n57_ & new_n68_;
  assign new_n71_ = new_n58_ & ~x24 & ~x25 & ~x22 & ~x23;
  ...
  assign z11 = x18 | (~x30 & (new_n86_ | (~x04 & ~x16)));
  assign new_n86_ = new_n87_ & new_n88_ & ~x23 & ~x24 & ~x25;
  assign new_n87_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n88_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z12 = x18 | (~x30 & (x16 ? ~new_n90_ : ~x03));
  assign new_n90_ = (~x31 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n76_ | x27 | x28 | x29 | x31);
  assign z13 = x18 | (~x30 & (x16 ? (new_n92_ | new_n94_) : ~x02));
  assign new_n92_ = x32 & (~new_n65_ | ~new_n76_ | ~new_n93_ | x29 | x31);
  assign new_n93_ = ~x27 & ~x28;
  assign new_n94_ = new_n57_ & new_n68_ & new_n78_ & new_n95_;
  assign new_n95_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign z14 = x18 | (~x30 & (x16 ? (new_n97_ | new_n98_) : ~x01));
  assign new_n97_ = x33 & (~new_n57_ | ~new_n68_ | ~new_n78_ | ~new_n95_);
  ...
  assign new_n102_ = new_n88_ & ~x33 & ~x34 & ~x31 & ~x32;
  assign new_n103_ = new_n59_ & (x00 | x16);
endmodule
