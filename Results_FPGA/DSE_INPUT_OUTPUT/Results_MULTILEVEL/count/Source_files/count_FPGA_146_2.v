...
module FAU ( 
  ...
  assign z06 = (x24 & (x18 | (x16 & x25))) | (~x18 & (x16 ? ~new_n67_ : ~x09));
  assign new_n67_ = (new_n62_ | ~x25) & (~new_n58_ | ~new_n68_ | x24 | x25);
  assign new_n68_ = ~x22 & ~x23;
  assign z07 = (x24 & (x18 | (x16 & x26))) | (~x18 & (new_n70_ | (~x08 & ~x16)));
  assign new_n70_ = x16 & ((x26 & (~new_n57_ | ~new_n71_)) | (new_n58_ & new_n72_));
  ...
  assign z09 = (x24 & (x18 | (x16 & x28))) | (~x18 & (x16 ? ~new_n78_ : ~x06));
  assign new_n78_ = (~x28 | (new_n58_ & new_n68_ & new_n76_)) & (~new_n60_ | ~new_n79_);
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x24 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n81_ : ~x05));
  assign new_n81_ = (~new_n62_ | ~new_n83_) & (~x29 | (new_n60_ & new_n82_));
  assign new_n82_ = ~x23 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x24 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n85_ : ~x04));
  assign new_n85_ = (~x30 | (new_n60_ & new_n87_)) & (~new_n62_ | ~new_n86_ | ~new_n88_);
  assign new_n86_ = ~x24 & ~x25 & ~x26;
  assign new_n87_ = ~x23 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n88_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n93_ | (~x18 & (x16 ? (new_n90_ | new_n91_) : ~x03));
  assign new_n90_ = x31 & (~new_n62_ | ~new_n76_ | x28 | x29 | x30);
  assign new_n91_ = new_n57_ & new_n65_ & new_n76_ & new_n92_;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x24 & (x18 | (x16 & x31));
  assign z13 = (x16 & (new_n95_ | (~new_n91_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n95_ = new_n57_ & new_n65_ & new_n96_ & new_n97_;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n103_ | (x16 & ((new_n99_ & new_n100_) | (~new_n95_ & x33)));
  assign new_n99_ = new_n58_ & new_n68_ & ~x24 & ~x25;
  assign new_n100_ = new_n101_ & new_n102_;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n103_ = ~x18 & (x01 | x16);
  assign z15 = new_n108_ | (~x18 & (x16 ? (new_n105_ | new_n106_) : ~x00));
  assign new_n105_ = x34 & (~new_n57_ | ~new_n71_ | ~new_n101_ | ~new_n102_);
  assign new_n106_ = new_n101_ & new_n107_ & new_n58_ & new_n68_ & ~x24 & ~x25;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n108_ = x24 & (x18 | (x16 & x34));
endmodule
