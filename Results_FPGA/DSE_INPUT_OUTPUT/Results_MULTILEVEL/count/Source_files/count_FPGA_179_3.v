...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n70_ | (new_n59_ & new_n71_))) | (~x09 & ~x16) | x18;
  ...
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n89_ | (~new_n87_ & x31)));
  assign new_n87_ = new_n65_ & new_n76_ & new_n88_ & ~x27 & ~x28;
  assign new_n88_ = ~x29 & ~x30;
  assign new_n89_ = new_n58_ & new_n68_ & new_n90_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n92_ | (~new_n89_ & x32)));
  assign new_n92_ = new_n58_ & new_n68_ & new_n93_ & new_n88_ & ~x31 & ~x32;
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z14 = (~x33 & (new_n95_ | x18)) | (~x18 & (x16 ? (~new_n92_ & x33) : ~x01));
  assign new_n95_ = new_n93_ & new_n88_ & ~x31 & ~x32 & new_n68_ & new_n96_;
  assign new_n96_ = ~x19 & ~x20 & x16 & ~x17;
  assign z15 = (~x33 & (new_n98_ | x18)) | (~x18 & (x16 ? new_n100_ : ~x00));
  assign new_n98_ = new_n93_ & new_n99_ & new_n68_ & new_n96_;
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32 & ~x34;
  assign new_n100_ = x34 & (~new_n59_ | ~new_n71_ | ~new_n101_ | ~new_n102_);
