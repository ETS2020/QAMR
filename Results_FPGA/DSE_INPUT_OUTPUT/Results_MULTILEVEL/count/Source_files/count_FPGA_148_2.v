...
module FAU ( 
  ...
  assign z11 = (~x18 & (x16 ? ~new_n85_ : ~x04)) | (x28 & (x18 | (x16 & x30)));
  assign new_n85_ = (~x30 | (new_n63_ & new_n86_)) & (~new_n64_ | ~new_n74_ | ~new_n87_);
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n92_ | (~x18 & (x16 ? (new_n89_ | new_n90_) : ~x03));
  assign new_n89_ = x31 & (~new_n64_ | ~new_n74_ | x27 | x29 | x30);
  assign new_n90_ = new_n57_ & new_n67_ & new_n78_ & new_n91_;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = x28 & (x18 | (x16 & x31));
  assign z13 = new_n99_ | (~x18 & (x16 ? (new_n94_ | new_n96_) : ~x02));
  assign new_n94_ = x32 & (~new_n64_ | ~new_n74_ | ~new_n95_);
  assign new_n95_ = ~x27 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = new_n57_ & new_n67_ & new_n97_ & new_n98_;
  assign new_n97_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n98_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n99_ = x28 & (x18 | (x16 & x32));
  assign z14 = new_n105_ | (~x18 & (x16 ? (new_n101_ | new_n102_) : ~x01));
  assign new_n101_ = x33 & (~new_n57_ | ~new_n67_ | ~new_n78_ | ~new_n98_);
  assign new_n102_ = new_n58_ & new_n70_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n105_ = x28 & (x18 | (x16 & x33));
  assign z15 = new_n111_ | (~x18 & (x16 ? (new_n107_ | new_n109_) : ~x00));
  assign new_n107_ = x34 & (~new_n57_ | ~new_n67_ | ~new_n104_ | ~new_n108_);
  assign new_n108_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n109_ = new_n58_ & new_n70_ & new_n103_ & new_n110_;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n111_ = x28 & (x18 | (x16 & x34));
endmodule
