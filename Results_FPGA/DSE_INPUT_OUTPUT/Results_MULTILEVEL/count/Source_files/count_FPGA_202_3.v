...
module FAU ( 
  ...
  assign z09 = x18 ? ~x33 : (x16 ? (new_n80_ | new_n81_) : ~x06);
  assign new_n80_ = x28 & (~new_n64_ | ~new_n78_ | x23 | x24);
  assign new_n81_ = new_n64_ & new_n82_;
  ...
  assign new_n88_ = x31 & (~new_n65_ | ~new_n76_ | ~new_n89_ | x27 | x28);
  ...
  assign new_n94_ = new_n58_ & new_n68_ & new_n95_ & new_n89_ & ~x31 & ~x32;
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n97_ | (~new_n94_ & x33)));
  ...
  assign new_n101_ = ~x33 & (x18 | (new_n68_ & new_n102_ & new_n95_ & new_n103_));
  assign new_n102_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32 & ~x34;
endmodule
