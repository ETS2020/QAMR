...
module FAU ( 
  ...
  assign z10 = x18 | (x16 & ((new_n76_ & new_n60_) | (~new_n73_ & x29)));
  assign new_n76_ = new_n77_ & ~x27 & ~x28 & ~x29;
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign z11 = x18 | (~new_n79_ & x16);
  assign new_n79_ = (~x30 | (new_n60_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n60_ | ~new_n77_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (x16 & ((~new_n81_ & x31) | (new_n62_ & new_n82_)));
  assign new_n81_ = new_n60_ & new_n77_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign new_n88_ = new_n57_ & new_n66_ & new_n89_ & new_n90_;
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & ((~new_n88_ & x34) | (new_n65_ & new_n92_)));
