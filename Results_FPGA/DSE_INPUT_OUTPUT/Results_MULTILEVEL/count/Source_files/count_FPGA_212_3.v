...
module FAU ( 
  ...
  assign z08 = x18 ? ~x04 : (x16 ? (new_n74_ | new_n76_) : ~x07);
  ...
  assign z13 = x18 ? ~x04 : (x16 ? (new_n91_ | new_n92_) : ~x02);
  ...
  assign z14 = x18 ? ~x04 : (x16 ? (new_n96_ | new_n97_) : ~x01);
  ...
  assign z15 = x18 ? ~x04 : (x16 ? ~new_n101_ : ~x00);
  assign new_n101_ = (~x34 | (new_n58_ & new_n70_ & new_n98_ & new_n99_)) & (~new_n58_ | ~new_n70_ | ~new_n98_ | ~new_n102_);
