...
module FAU ( 
  ...
  assign z04 = x18 ? x07 : (x16 ? ~new_n61_ : ~x11);
  ...
  assign z14 = x18 ? x07 : (x16 ? (new_n93_ | new_n94_) : ~x01);
  assign new_n93_ = x33 & (~new_n56_ | ~new_n66_ | ~new_n90_ | ~new_n91_);
  assign new_n94_ = new_n57_ & new_n70_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n96_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = ~new_n99_ | (x16 & ((new_n69_ & new_n98_) | (~new_n94_ & x34)));
