...
module FAU ( 
  ...
  assign new_n55_ = ~x32 & (x16 ? ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)) : ~x14);
  ...
  assign z08 = (x16 & (new_n77_ | (~new_n75_ & x27))) | ~new_n79_ | (~x07 & ~x16);
  ...
  assign z09 = (x16 & (new_n81_ | (~new_n77_ & x28))) | ~new_n79_ | (~x06 & ~x16);
  ...
  assign z11 = (~new_n87_ & x16) | ~new_n79_ | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n76_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n93_ | (x16 & ((new_n89_ & new_n91_) | (~new_n90_ & x31)));
  assign new_n89_ = new_n58_ & new_n68_;
  assign new_n90_ = new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n92_ & ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n93_ = new_n79_ & (x03 | x16);
  assign z13 = new_n95_ | x18;
  assign new_n95_ = ~x32 & (new_n96_ | (new_n97_ & new_n98_ & new_n99_ & new_n100_));
  assign new_n96_ = ~x02 & ~x16;
  assign new_n97_ = x16 & ~x17 & ~x19;
  assign new_n98_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n99_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z14 = x18 | (~x32 & (x16 ? (new_n102_ | new_n103_) : ~x01));
  assign new_n102_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n100_ | ~new_n78_ | x25);
  assign new_n103_ = new_n58_ & new_n68_ & new_n92_ & new_n104_;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x33;
  assign z15 = ~new_n109_ | (x16 & ((new_n106_ & new_n107_) | (~new_n103_ & x34)));
  assign new_n106_ = new_n59_ & new_n71_;
  assign new_n107_ = new_n108_ & new_n78_ & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x33 & ~x34;
  assign new_n109_ = new_n79_ & (x00 | x16);
endmodule
