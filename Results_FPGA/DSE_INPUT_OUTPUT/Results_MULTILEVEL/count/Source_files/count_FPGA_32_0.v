...
module FAU ( 
  ...
  assign z01 = (x16 & ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20))) | ~x14 | x18;
  ...
  assign z11 = (~new_n86_ & x16) | ~x14 | x18 | (~x04 & ~x16);
  assign new_n86_ = (~x30 | (new_n64_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n76_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (x14 & (x16 ? (new_n88_ | new_n90_) : ~x03));
  assign new_n88_ = x31 & (~new_n64_ | ~new_n76_ | ~new_n89_);
