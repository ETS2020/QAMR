...
module FAU ( 
  ...
  assign z09 = x18 ? ~x29 : (x16 ? (new_n78_ | new_n79_) : ~x06);
  assign new_n78_ = x28 & (~new_n62_ | ~new_n76_ | x23 | x24);
  assign new_n79_ = new_n62_ & new_n80_ & ~x23 & ~x26 & ~x27 & ~x28;
  ...
  assign z12 = (~new_n89_ & ~x18) | (~x29 & (x18 | (new_n86_ & new_n88_)));
  assign new_n86_ = new_n87_ & x16 & ~x17 & ~x19;
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = new_n74_ & ~x27 & ~x28 & ~x30 & ~x31;
  assign new_n89_ = x16 ? (~x31 | (new_n63_ & new_n74_ & new_n90_)) : x03;
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = (~x18 & (new_n94_ | new_n96_)) | (~x29 & (x18 | (new_n86_ & new_n92_)));
  assign new_n92_ = new_n93_ & new_n80_ & ~x26 & ~x27;
  assign new_n93_ = ~x28 & ~x30 & ~x31 & ~x32;
  assign new_n94_ = x16 & x32 & (~new_n57_ | ~new_n66_ | ~new_n76_ | ~new_n95_);
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = ~x02 & ~x16;
  assign z14 = (~x29 & (new_n98_ | x18)) | (~x18 & (new_n102_ | (~x01 & ~x16)));
  assign new_n98_ = new_n100_ & new_n101_ & new_n66_ & new_n99_ & x16 & ~x17;
  assign new_n99_ = ~x19 & ~x20;
  assign new_n100_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n102_ = x16 & x33 & (~new_n57_ | ~new_n66_ | ~new_n100_ | ~new_n103_);
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z15 = (~x29 & (new_n105_ | x18)) | (~x18 & (new_n107_ | (~x00 & ~x16)));
  assign new_n105_ = new_n100_ & new_n106_ & new_n66_ & new_n99_ & x16 & ~x17;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n107_ = x16 & x34 & (~new_n58_ | ~new_n69_ | ~new_n101_ | ~new_n108_);
