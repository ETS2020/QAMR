...
module FAU ( 
  ...
  assign new_n76_ = new_n60_ & ~x23 & ~x24 & new_n77_ & ~x25;
  assign new_n77_ = ~x26 & ~x27;
  assign z09 = x18 ? ~x31 : (x16 ? (new_n79_ | new_n80_) : ~x06);
  assign new_n79_ = x28 & (~new_n60_ | x23 | x24 | ~new_n77_ | x25);
  ...
  assign new_n87_ = new_n63_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n88_ = new_n56_ & new_n66_ & new_n89_ & new_n77_ & ~x25;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n91_ | (~x18 & (x16 ? (~new_n88_ & x32) : ~x02));
  assign new_n91_ = ~x31 & (x18 | (new_n92_ & new_n93_ & new_n94_ & new_n95_));
  assign new_n92_ = x16 & ~x17 & ~x19;
  assign new_n93_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n94_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign z14 = ~new_n102_ | (x16 & (new_n99_ | (x33 & (~new_n68_ | ~new_n97_))));
  assign new_n97_ = new_n98_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n98_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n99_ = new_n57_ & new_n70_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n102_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n105_ | (x16 & ((new_n69_ & new_n104_) | (~new_n99_ & x34)));
