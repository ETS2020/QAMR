...
module FAU ( 
  ...
  assign z05 = ~new_n66_ | (x16 & ((x24 & (~new_n63_ | ~new_n64_)) | (new_n63_ & new_n65_)));
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x21 & ~x22 & ~x23;
  assign new_n65_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n66_ = (x10 | x16) & ~x18 & x25;
  assign z06 = x18 | (x25 & (x16 ? (~new_n63_ | ~new_n65_) : ~x09));
  assign z07 = x18 | (x25 & (x16 ? x26 : ~x08));
  assign z08 = x18 | ~x25 | (~x07 & ~x16) | (x16 & x27);
  assign z09 = x18 | ~x25 | (~x06 & ~x16) | (x16 & x28);
  assign z10 = x18 | ~x25 | (~x05 & ~x16) | (x16 & x29);
  assign z11 = x18 | ~x25 | (~x04 & ~x16) | (x16 & x30);
  assign z12 = x18 | ~x25 | (~x03 & ~x16) | (x16 & x31);
  assign z13 = x18 | (x25 & (x16 ? x32 : ~x02));
  assign z14 = x18 | (x25 & (x16 ? x33 : ~x01));
  assign z15 = x18 | ~x25 | (~x00 & ~x16) | (x16 & x34);
endmodule
