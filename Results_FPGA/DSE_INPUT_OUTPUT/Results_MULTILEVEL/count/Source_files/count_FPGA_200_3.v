...
module FAU ( 
  ...
  assign new_n79_ = new_n62_ & new_n80_ & ~x27 & ~x28 & ~x29;
  assign new_n80_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n82_ & x16) | x18 | (~x04 & ~x16);
  assign new_n82_ = (~x30 | (new_n62_ & new_n80_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n80_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n85_ | (~new_n84_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n84_ = new_n62_ & new_n80_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n85_ = new_n56_ & new_n65_ & new_n86_ & ~x25 & ~x26 & ~x27;
  assign new_n86_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x16 ? (~x18 & (new_n88_ | (~new_n85_ & x32))) : (~x02 | x18);
  assign new_n88_ = new_n56_ & new_n65_ & new_n89_ & new_n90_;
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n90_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n92_ | (~new_n88_ & x33))) : (~x01 | x18);
  assign new_n92_ = new_n57_ & new_n68_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n94_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x16 ? (~new_n96_ & ~x18) : (~x00 | x18);
  assign new_n96_ = (~x34 | (new_n57_ & new_n68_ & new_n93_ & new_n94_)) & (~new_n93_ | ~new_n97_ | ~new_n57_ | ~new_n68_);
  assign new_n97_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
