...
module FAU ( 
  ...
  assign z06 = x18 ? x27 : (x16 ? (new_n67_ | new_n68_) : ~x09);
  ...
  assign z08 = (~x18 & (new_n74_ | (~x07 & ~x16))) | (x27 & (x18 | (~new_n76_ & x16)));
  assign new_n74_ = new_n75_ & ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n76_ = new_n57_ & new_n72_;
  assign z09 = (~x18 & (x16 ? ~new_n78_ : ~x06)) | (x27 & (x18 | (x16 & x28)));
  assign new_n78_ = (~x28 | (new_n57_ & new_n72_)) & (~new_n59_ | ~new_n79_);
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~x18 & (x16 ? ~new_n81_ : ~x05)) | (x27 & (x18 | (x16 & x29)));
  assign new_n81_ = (~x29 | (new_n59_ & new_n82_)) & (~new_n62_ | ~new_n83_);
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28;
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x18 & (x16 ? ~new_n85_ : ~x04)) | (x27 & (x18 | (x16 & x30)));
  assign new_n85_ = (~x30 | (new_n59_ & new_n87_)) & (~new_n62_ | ~new_n86_ | ~new_n88_);
  ...
  assign new_n90_ = x31 & (~new_n62_ | ~new_n86_ | x28 | x29 | x30);
  assign new_n91_ = new_n56_ & new_n65_ & new_n92_ & ~x25 & ~x26 & ~x27;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x27 & (x18 | (x16 & x31));
  assign z13 = ~new_n98_ | (x16 & ((new_n95_ & new_n96_) | (~new_n91_ & x32)));
  assign new_n95_ = new_n56_ & new_n65_;
  assign new_n96_ = new_n97_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n98_ = ~x18 & (x02 | x16);
  assign z14 = new_n105_ | (~x18 & (x16 ? (new_n100_ | new_n102_) : ~x01));
  assign new_n100_ = x33 & (~new_n56_ | ~new_n65_ | ~new_n101_ | ~new_n97_);
  assign new_n101_ = ~x25 & ~x26 & ~x28;
  assign new_n102_ = new_n103_ & new_n104_ & new_n57_ & new_n69_ & ~x24 & ~x25;
  ...
  assign new_n107_ = x34 & (~new_n56_ | ~new_n65_ | ~new_n104_ | ~new_n108_);
  assign new_n108_ = ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n109_ = new_n103_ & new_n110_ & new_n57_ & new_n69_ & ~x24 & ~x25;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n111_ = x27 & (x18 | (x16 & x34));
endmodule
