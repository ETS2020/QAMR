...
module FAU ( 
  ...
  assign z08 = (x16 & (new_n77_ | (~new_n75_ & x27))) | ~new_n54_ | (~x07 & ~x16);
  ...
  assign new_n85_ = (~x30 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n76_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n88_ | (~new_n87_ & x31))) | ~new_n54_ | (~x03 & ~x16);
  assign new_n87_ = new_n65_ & new_n76_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n88_ = new_n58_ & new_n68_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 | (x32 & (x16 ? ~new_n88_ : ~x02));
