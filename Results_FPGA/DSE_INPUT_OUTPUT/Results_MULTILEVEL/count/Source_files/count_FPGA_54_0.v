...
module FAU ( 
  ...
  assign z06 = ~new_n54_ & (~new_n70_ | (x16 & (new_n69_ | (~new_n66_ & x25))));
  ...
  assign z14 = new_n96_ | ~new_n102_ | (x16 & x33 & (~new_n69_ | ~new_n100_));
  ...
  assign new_n100_ = new_n101_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & x34;
  assign new_n102_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n105_ | (x16 & (x32 ? x34 : (~new_n66_ | ~new_n104_)));
  assign new_n104_ = new_n98_ & new_n99_;
  assign new_n105_ = (x00 | x16) & ~new_n54_ & ~x18;
endmodule
