...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n58_, new_n60_, new_n61_, new_n63_, new_n65_,
    ...
    new_n76_, new_n77_, new_n79_, new_n80_, new_n82_, new_n84_, new_n86_,
  ...
  assign new_n71_ = (~x26 | (new_n58_ & new_n69_)) & (~new_n58_ | ~new_n72_ | ~new_n73_);
  assign new_n72_ = ~x22 & ~x23;
  assign new_n73_ = ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? ~x28 : (x16 ? (new_n75_ | new_n76_) : ~x07);
  assign new_n75_ = x27 & (~new_n58_ | ~new_n72_ | ~new_n73_);
  ...
  assign z12 = (~new_n88_ & ~x18) | (~x28 & (x18 | (new_n86_ & new_n87_)));
  assign new_n86_ = x16 & ~x17 & ~x19 & new_n72_ & ~x20 & ~x21;
  assign new_n87_ = new_n73_ & ~x30 & ~x31 & ~x27 & ~x29;
  assign new_n88_ = x16 ? (~x31 | (new_n63_ & new_n73_ & new_n89_)) : x03;
  assign new_n89_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = (~x18 & (new_n93_ | new_n95_)) | (~x28 & (x18 | (new_n86_ & new_n91_)));
  assign new_n91_ = new_n92_ & ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n92_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n93_ = x16 & x32 & (~new_n57_ | ~new_n66_ | ~new_n77_ | ~new_n94_);
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n95_ = ~x02 & ~x16;
  assign z14 = (~x28 & (new_n97_ | x18)) | (~x18 & (x16 ? new_n101_ : ~x01));
  assign new_n97_ = new_n66_ & new_n99_ & new_n100_ & new_n98_ & ~x27 & ~x29;
  assign new_n98_ = ~x25 & ~x26;
  assign new_n99_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n101_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n92_ | ~new_n98_ | ~new_n80_);
  assign z15 = (~new_n103_ & x16) | x18 | (~x00 & ~x16);
  assign new_n103_ = (~x34 | (new_n58_ & new_n69_ & new_n100_ & new_n104_)) & (~new_n58_ | ~new_n69_ | ~new_n104_ | ~new_n105_);
