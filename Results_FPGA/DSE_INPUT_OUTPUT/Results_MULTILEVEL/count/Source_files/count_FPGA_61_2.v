...
module FAU ( 
  ...
  assign new_n86_ = new_n65_ & new_n84_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = ~new_n91_ | (x16 & ((new_n88_ & new_n89_) | (~new_n86_ & x31)));
  assign new_n88_ = new_n58_ & new_n68_;
  assign new_n89_ = new_n90_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n91_ = ~x04 & ~x18 & (x03 | x16);
  assign z13 = ~new_n96_ | (x16 & ((new_n88_ & new_n93_) | (x32 & (~new_n88_ | ~new_n89_))));
  assign new_n93_ = new_n94_ & new_n95_;
  assign new_n94_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n95_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n96_ = ~x04 & ~x18 & (x02 | x16);
  assign z14 = x18 | (~x04 & (x16 ? (new_n98_ | new_n99_) : ~x01));
