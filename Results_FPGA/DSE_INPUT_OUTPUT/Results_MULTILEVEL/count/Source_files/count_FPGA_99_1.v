...
module FAU ( 
  ...
  assign z06 = x18 ? x01 : (new_n67_ | (~x09 & ~x16));
  assign new_n67_ = x16 & ((x25 & (~new_n56_ | ~new_n65_)) | (new_n57_ & new_n68_));
  ...
  assign z12 = x18 ? x01 : (x16 ? (new_n86_ | new_n88_) : ~x03);
  ...
  assign z14 = ~new_n98_ | (x16 & ((new_n70_ & new_n95_) | (~new_n91_ & x33)));
  ...
  assign z15 = x18 ? x01 : (x16 ? ~new_n100_ : ~x00);
  assign new_n100_ = (~x34 | (new_n57_ & new_n68_ & new_n96_ & new_n97_)) & (~new_n96_ | ~new_n101_ | ~new_n57_ | ~new_n68_);
