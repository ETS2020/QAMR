...
module FAU ( 
  ...
  assign z12 = (~new_n82_ & x31) | ~x16 | new_n83_ | x18;
  assign new_n82_ = new_n62_ & new_n78_ & new_n75_ & ~x29 & ~x30;
  assign new_n83_ = new_n56_ & new_n65_ & new_n84_ & ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~new_n83_ & x32) | ~x16 | new_n86_ | x18;
  assign new_n86_ = new_n56_ & new_n65_ & new_n87_ & new_n75_ & ~x25 & ~x26;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~new_n86_ & x33) | ~x16 | x18 | (new_n67_ & new_n89_);
