...
module FAU ( 
  ...
  assign z03 = (~x22 & (new_n59_ | x18)) | (~x18 & (x16 ? (~new_n57_ & x22) : ~x12));
  assign new_n59_ = x16 & ~x17 & ~x19 & ~x20 & ~x21;
  ...
  assign z06 = (~x22 & (new_n67_ | x18)) | (~x18 & (x16 ? new_n69_ : ~x09));
  assign new_n67_ = new_n68_ & ~x19 & ~x20 & x16 & ~x17;
  assign new_n68_ = ~x21 & ~x23 & ~x24 & ~x25;
  assign new_n69_ = x25 & (~new_n56_ | ~new_n65_);
  ...
  assign new_n80_ = ~x22 & (x18 | (new_n81_ & new_n82_));
  assign new_n81_ = ~x20 & ~x21 & ~x23 & x16 & ~x17 & ~x19;
  assign new_n82_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n85_ & ~x18) | (~x22 & (new_n84_ | x18));
  assign new_n84_ = new_n81_ & new_n74_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n85_ = x16 ? (~x30 | (new_n62_ & new_n82_)) : x04;
  assign z12 = (x16 & (new_n88_ | (~new_n87_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n87_ = new_n62_ & new_n74_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n88_ = new_n56_ & new_n65_ & new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n91_ | (~x18 & (x16 ? (~new_n88_ & x32) : ~x02));
  assign new_n91_ = ~x22 & (x18 | (new_n92_ & new_n93_ & new_n94_ & new_n95_));
  assign new_n92_ = x16 & ~x17 & ~x19;
  assign new_n93_ = ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~x18 & (new_n100_ | new_n101_)) | (~x22 & (x18 | (new_n67_ & new_n97_)));
  assign new_n97_ = new_n98_ & new_n99_;
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n100_ = x16 & x33 & (~new_n56_ | ~new_n65_ | ~new_n94_ | ~new_n95_);
  assign new_n101_ = ~x01 & ~x16;
  assign z15 = (~x18 & (new_n104_ | new_n106_)) | (~x22 & (x18 | (new_n67_ & new_n103_)));
  assign new_n103_ = new_n98_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n104_ = x16 & x34 & (~new_n57_ | ~new_n105_ | ~new_n98_ | ~new_n99_);
  assign new_n105_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n106_ = ~x00 & ~x16;
endmodule
