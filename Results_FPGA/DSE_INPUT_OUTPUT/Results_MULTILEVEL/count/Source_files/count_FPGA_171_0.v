...
module FAU ( 
  ...
  assign z12 = x18 | (x16 & ((~new_n78_ & x31) | (new_n63_ & new_n80_)));
  ...
  assign z14 = x18 | (x16 & ((~new_n83_ & x33) | (new_n66_ & new_n87_)));
  assign new_n87_ = new_n88_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n88_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = x18 | (x16 & ((new_n66_ & new_n90_) | (x34 & (~new_n66_ | ~new_n87_))));
