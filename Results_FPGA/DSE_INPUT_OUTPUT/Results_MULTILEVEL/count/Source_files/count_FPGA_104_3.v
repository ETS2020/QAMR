...
module FAU ( 
  ...
  assign z06 = x18 ? ~x15 : (new_n68_ | (~x09 & ~x16));
  ...
  assign z09 = x18 ? ~x15 : (x16 ? (new_n79_ | new_n80_) : ~x06);
  assign new_n79_ = x28 & (~new_n62_ | ~new_n77_ | x23 | x24);
  assign new_n80_ = new_n62_ & new_n81_;
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x15 : (x16 ? (new_n83_ | new_n84_) : ~x05);
  assign new_n83_ = x29 & (~new_n62_ | ~new_n81_);
  assign new_n84_ = new_n63_ & new_n85_ & ~x27 & ~x28 & ~x29;
  assign new_n85_ = ~x24 & ~x25 & ~x26;
  assign z11 = (~new_n87_ & x16) | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n63_ & new_n85_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n85_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n90_ | (~new_n89_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n89_ = new_n63_ & new_n85_ & ~x29 & ~x30 & ~x27 & ~x28;
