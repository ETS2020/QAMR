...
module FAU ( 
  ...
  assign z06 = ~new_n54_ & (~new_n71_ | (x16 & (new_n70_ | (~new_n69_ & x25))));
  assign new_n69_ = new_n59_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n70_ = new_n60_ & ~x22 & ~x23 & ~x24 & ~x25;
  ...
  assign z09 = (~new_n79_ & ~x28) | x18 | (~x06 & ~x16) | (x16 & ~new_n77_ & x28);
  assign new_n79_ = x30 & (~new_n80_ | ~new_n81_);
  assign new_n80_ = ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n81_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = ~new_n83_ | (~x28 & (~x30 | (new_n85_ & new_n86_)));
  assign new_n83_ = ~x18 & (x05 | x16) & (~x16 | ~x29 | (new_n65_ & new_n84_));
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & x30;
  assign new_n85_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign z11 = (x16 & (x28 ? x30 : ~new_n88_)) | (~x04 & ~x16) | x18 | (~x28 & ~x30);
