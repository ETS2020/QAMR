...
module FAU ( 
  ...
  assign z12 = new_n88_ | (~x18 & (x16 ? (new_n85_ | new_n86_) : ~x03));
  assign new_n85_ = x31 & (~new_n63_ | ~new_n74_ | x27 | x29 | x30);
  assign new_n86_ = new_n57_ & new_n66_ & new_n76_ & new_n87_;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n88_ = x28 & (x18 | (x16 & x31));
  assign z13 = new_n95_ | (~x18 & (x16 ? (new_n90_ | new_n92_) : ~x02));
  assign new_n90_ = x32 & (~new_n63_ | ~new_n74_ | ~new_n91_);
  ...
  assign new_n95_ = x28 & (x18 | (x16 & x32));
  assign z14 = new_n101_ | (~x18 & (x16 ? (new_n97_ | new_n98_) : ~x01));
  assign new_n97_ = x33 & (~new_n57_ | ~new_n66_ | ~new_n76_ | ~new_n94_);
  ...
  assign new_n103_ = new_n58_ & new_n69_;
