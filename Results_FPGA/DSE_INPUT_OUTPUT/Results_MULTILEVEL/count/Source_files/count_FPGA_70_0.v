...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n58_, new_n59_, new_n61_, new_n63_, new_n65_,
    new_n67_, new_n68_, new_n69_, new_n71_, new_n73_;
  ...
  assign z04 = x18 | (x27 & (x16 ? ~new_n63_ : ~x11));
  assign new_n63_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z05 = (~new_n65_ & x16) | (~x10 & ~x16) | x18 | ~x27;
  assign new_n65_ = (~x24 | (new_n58_ & ~x21 & ~x22 & ~x23)) & (~new_n58_ | x23 | x24 | x21 | x22);
  assign z06 = x18 | (x27 & (x16 ? ~new_n67_ : ~x09));
  assign new_n67_ = (~x25 | (new_n58_ & new_n69_)) & (~new_n59_ | ~new_n68_ | x24 | x25);
  assign new_n68_ = ~x22 & ~x23;
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = (~new_n71_ & x16) | (~x08 & ~x16) | x18 | ~x27;
  assign new_n71_ = (~x26 | (new_n59_ & new_n68_ & ~x24 & ~x25)) & (~new_n59_ | ~new_n68_ | x24 | x25 | x26);
  assign z08 = x18 | (x27 & (x16 ? ~new_n73_ : ~x07));
  assign new_n73_ = new_n59_ & new_n68_ & ~x24 & ~x25 & ~x26;
  ...
  assign z13 = (~x02 & ~x16) | (x16 & x32) | x18 | ~x27;
  assign z14 = x18 | (x27 & (x16 ? x33 : ~x01));
  assign z15 = (~x00 & ~x16) | (x16 & x34) | x18 | ~x27;
endmodule
