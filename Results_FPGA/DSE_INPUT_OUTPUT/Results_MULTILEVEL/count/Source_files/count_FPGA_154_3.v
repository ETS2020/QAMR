...
module FAU ( 
  ...
  assign z07 = x16 ? (~x18 & (new_n71_ | (~new_n68_ & x26))) : (~x08 | x18);
  ...
  assign new_n81_ = (~x30 | (new_n61_ & new_n72_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n72_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n84_ | (~new_n83_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n83_ = new_n61_ & new_n72_ & new_n77_ & ~x29 & ~x30;
  ...
  assign z15 = ~new_n95_ | (x16 & ((new_n68_ & new_n94_) | (~new_n90_ & x34)));
