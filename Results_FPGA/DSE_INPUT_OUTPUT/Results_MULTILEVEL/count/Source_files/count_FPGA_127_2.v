...
module FAU ( 
  ...
  assign z09 = (x22 & (x18 | (x16 & x28))) | (~x18 & (new_n78_ | (~x06 & ~x16)));
  assign new_n78_ = x16 & ((x28 & (~new_n59_ | ~new_n76_)) | (new_n63_ & new_n79_));
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n82_ | (~new_n81_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n81_ = new_n63_ & new_n79_;
  assign new_n82_ = new_n64_ & new_n73_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n84_ & x16) | x18 | (~x04 & ~x16);
  assign new_n84_ = (~x30 | (new_n64_ & new_n73_ & ~x27 & ~x28 & ~x29)) & (~new_n64_ | ~new_n73_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n86_ | (new_n66_ & new_n88_))) | (~x03 & ~x16) | x18;
  assign new_n86_ = x31 & (~new_n64_ | ~new_n73_ | ~new_n87_ | x29 | x30);
  assign new_n87_ = ~x27 & ~x28;
  assign new_n88_ = new_n89_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n95_ | (~x18 & (x16 ? (new_n91_ | new_n93_) : ~x02));
  assign new_n91_ = x32 & (~new_n92_ | ~new_n89_ | x25 | x26 | x27);
  assign new_n92_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n93_ = new_n58_ & new_n67_ & new_n94_ & new_n87_ & ~x25 & ~x26;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n95_ = x22 & (x18 | (x16 & x32));
  assign z14 = new_n102_ | (~x18 & (x16 ? (new_n97_ | new_n99_) : ~x01));
  assign new_n97_ = x33 & (~new_n58_ | ~new_n98_ | ~new_n94_ | ~new_n87_ | x26);
  ...
  assign new_n102_ = x22 & (x18 | (x16 & x33));
  assign z15 = ~new_n105_ | (x16 & ((~new_n99_ & x34) | (new_n69_ & new_n104_)));
