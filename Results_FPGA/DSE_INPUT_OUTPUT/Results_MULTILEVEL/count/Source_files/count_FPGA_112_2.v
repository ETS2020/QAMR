...
module FAU ( 
  ...
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n70_ | (~new_n69_ & x25)));
  assign new_n69_ = new_n67_ & ~x17 & ~x19 & ~x20;
  ...
  assign new_n76_ = (~x27 | (new_n63_ & new_n77_ & ~x25 & ~x26)) & (~new_n60_ | ~new_n77_ | x25 | x26 | x27);
  assign new_n77_ = ~x23 & ~x24;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n81_ | (~new_n79_ & x28)));
  assign new_n79_ = new_n60_ & new_n77_ & new_n80_;
  ...
  assign new_n89_ = x31 & (~new_n90_ | ~new_n59_ | ~new_n77_ | x22);
  assign new_n90_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n91_ = new_n80_ & new_n92_ & new_n67_ & ~x17 & ~x19 & ~x20;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n93_ = x20 & (x18 | (x16 & x31));
  assign z13 = ~new_n97_ | (x16 & ((~new_n91_ & x32) | (new_n69_ & new_n95_)));
  ...
  assign new_n99_ = x33 & (~new_n59_ | ~new_n72_ | ~new_n96_ | ~new_n82_ | x26);
  assign new_n100_ = new_n71_ & new_n72_ & new_n101_ & new_n102_;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n103_ = x20 & (x18 | (x16 & x33));
  assign z15 = (~new_n105_ & x16) | x18 | (~x00 & ~x16);
  assign new_n105_ = (~x34 | (new_n71_ & new_n72_ & new_n101_ & new_n102_)) & (~new_n101_ | ~new_n106_ | ~new_n71_ | ~new_n72_);
