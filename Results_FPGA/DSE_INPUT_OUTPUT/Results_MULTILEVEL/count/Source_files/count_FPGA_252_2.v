...
module FAU ( 
  ...
  assign z08 = (x16 & (new_n78_ | (~new_n77_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n77_ = new_n59_ & new_n71_ & new_n75_;
  assign new_n78_ = new_n62_ & new_n79_ & ~x23 & ~x24;
  assign new_n79_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n81_ | (~new_n78_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n81_ = new_n62_ & new_n74_ & ~x23 & new_n82_ & ~x26;
  assign new_n82_ = ~x27 & ~x28;
  assign z10 = x18 ? x32 : (x16 ? (new_n84_ | new_n85_) : ~x05);
  assign new_n84_ = x29 & (~new_n62_ | ~new_n74_ | x23 | ~new_n82_ | x26);
  assign new_n85_ = new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & x16) | x18 | (~x04 & ~x16);
  assign new_n87_ = (~x30 | (new_n65_ & new_n75_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n75_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n90_ | (~new_n89_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n89_ = new_n65_ & new_n75_ & new_n82_ & ~x29 & ~x30;
  assign new_n90_ = new_n58_ & new_n68_ & new_n79_ & new_n91_;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x18 & (new_n93_ | (~x02 & ~x16))) | (x32 & (x18 | (~new_n90_ & x16)));
  assign new_n93_ = new_n68_ & new_n94_ & new_n95_ & new_n82_ & ~x25 & ~x26;
  assign new_n94_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n95_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = new_n101_ | (~x18 & (x16 ? (new_n97_ | new_n98_) : ~x01));
  assign new_n97_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n79_ | ~new_n91_);
  assign new_n98_ = new_n99_ & new_n100_ & new_n59_ & new_n71_ & new_n74_;
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n101_ = x32 & (x18 | (x16 & x33));
  assign z15 = ~new_n105_ | (x16 & ((new_n103_ & new_n104_) | (~new_n98_ & x34)));
  assign new_n103_ = new_n59_ & new_n71_ & new_n74_;
  assign new_n104_ = new_n99_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
