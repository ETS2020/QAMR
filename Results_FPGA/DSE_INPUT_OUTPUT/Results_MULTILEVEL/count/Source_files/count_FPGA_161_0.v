...
module FAU ( 
  ...
  assign new_n55_ = ~x18 & x30;
  assign z02 = x18 | (~new_n57_ & x30);
  assign new_n57_ = x16 ? ((~x21 | (~x17 & ~x19 & ~x20)) & (x20 | x21 | x17 | x19)) : x13;
  assign z03 = (x16 & (new_n60_ | (~new_n59_ & x22))) | ~new_n55_ | (~x12 & ~x16);
  assign new_n59_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n60_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z04 = x18 | (x30 & (x16 ? ~new_n62_ : ~x11));
  ...
  assign z07 = x18 | (x30 & (x16 ? ~new_n70_ : ~x08));
  assign new_n70_ = (~x26 | (new_n59_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n59_ | x24 | x25 | x26 | x22 | x23);
  assign z08 = (x16 & (new_n73_ | (~new_n72_ & x27))) | ~new_n55_ | (~x07 & ~x16);
  assign new_n72_ = new_n59_ & ~x24 & ~x25 & ~x26 & ~x22 & ~x23;
  ...
  assign z10 = x18 | (x30 & (x16 ? (new_n78_ | new_n79_) : ~x05));
  assign new_n78_ = x29 & (~new_n60_ | ~new_n76_);
  assign new_n79_ = new_n63_ & new_n80_;
  assign new_n80_ = ~x27 & ~x28 & ~x29 & ~x24 & ~x25 & ~x26;
  assign z11 = x18 | (x30 & (x16 ? ~new_n79_ : ~x04));
