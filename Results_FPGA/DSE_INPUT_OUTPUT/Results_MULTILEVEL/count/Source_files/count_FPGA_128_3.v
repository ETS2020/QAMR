...
module FAU ( 
  ...
  assign z04 = (~x11 & (~x16 | x18)) | (x16 & ~x18 & (new_n62_ | (~new_n60_ & x23)));
  ...
  assign new_n78_ = (~x28 | (new_n60_ & new_n76_ & ~x23 & ~x24)) & (~new_n60_ | ~new_n79_);
  ...
  assign new_n85_ = (~x30 | (new_n62_ & new_n83_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n83_ | x27 | x28 | x29 | x30);
  assign z12 = x18 ? ~x11 : (x16 ? (new_n87_ | new_n89_) : ~x03);
  assign new_n87_ = x31 & (~new_n62_ | ~new_n83_ | ~new_n88_ | x29 | x30);
  assign new_n88_ = ~x27 & ~x28;
  assign new_n89_ = new_n57_ & new_n65_ & new_n76_ & new_n90_;
  assign new_n90_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = (x16 & (new_n92_ | (~new_n89_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n92_ = new_n57_ & new_n65_ & new_n93_ & new_n88_ & ~x25 & ~x26;
  assign new_n93_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~new_n97_ | (x16 & ((~new_n92_ & x33) | (new_n70_ & new_n95_)));
  assign new_n95_ = new_n96_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n96_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n97_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n100_ | (x16 & ((new_n70_ & new_n99_) | (x34 & (~new_n70_ | ~new_n95_))));
