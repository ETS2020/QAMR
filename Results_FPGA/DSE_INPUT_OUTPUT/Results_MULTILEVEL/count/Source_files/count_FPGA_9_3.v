...
module FAU ( 
  ...
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n74_ | (~new_n73_ & x27)));
  ...
  assign z14 = x16 ? (~x18 & (new_n91_ | (~new_n88_ & x33))) : (~x01 | x18);
  assign new_n91_ = new_n57_ & new_n68_ & new_n92_ & new_n93_;
  assign new_n92_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n93_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n96_ | (x16 & ((~new_n91_ & x34) | (new_n67_ & new_n95_)));
