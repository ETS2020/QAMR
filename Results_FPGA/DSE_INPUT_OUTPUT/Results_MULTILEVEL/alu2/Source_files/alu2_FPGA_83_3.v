...
module FAU ( 
  ...
  assign z4 = ~x8 & x9 & (new_n38_ | ~new_n44_ | (~new_n42_ & x1));
  assign new_n38_ = x5 & ((~new_n39_ & ~x4) | (~new_n41_ & x4) | (~new_n40_ & ~x6));
  assign new_n39_ = (~x6 | (((x1 ^ x3) | (x0 ^ x2)) & (~x1 | x3 | ~x7))) & (~x1 | ((~x0 | ~x7) & (x2 | x6))) & (~x0 | x3 | (x6 & ~x7));
  assign new_n40_ = (x2 | (x3 & (x1 | ~x4))) & (~x4 | (x7 & (x0 | x3)));
  assign new_n41_ = (x0 | (x1 & (~x3 | x7))) & (x1 | ~x2 | x7);
  assign new_n42_ = (x6 | new_n43_ | (x4 & x5)) & (~x4 | x5 | (~x2 & ~x6));
  assign new_n43_ = ~x0 & (~x3 | ~x7);
  assign new_n44_ = ~new_n46_ & (new_n45_ | ~x3);
  assign new_n45_ = (x5 | ((~x2 | ~x4) & (~x0 | (~x4 & ~x6)))) & (~x2 | ~x4 | x7);
  assign new_n46_ = ~x5 & x6 & (~x7 | (x0 & ~x4));
