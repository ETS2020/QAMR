...
module FAU ( 
  ...
  assign z4 = x6 & ~new_n51_ & x9;
  assign new_n51_ = (new_n52_ | ~x5) & ~new_n57_ & (x5 | (new_n55_ & (new_n59_ | ~x4)));
  assign new_n52_ = new_n54_ & (new_n53_ | x2);
  assign new_n53_ = (x0 | x7 | (~x1 ^ ~x3)) & (x4 | ~x7 | ((x3 | (~x0 & x8)) & (~x1 | x8)));
  assign new_n54_ = (x7 | ((~x2 | ((~x0 | (~x1 ^ ~x3)) & (~x4 | (x1 & ~x3)))) & (x0 | ~x3 | ~x4))) & (x0 | x1 | ~x4) & (x4 | ~x7 | ~x1 | x3);
  assign new_n55_ = new_n56_ & (~x1 | (x7 ? ~x0 : x3));
  assign new_n56_ = (x7 | x8) & (~x0 | ((x2 | x7) & (x4 | x8)));
  assign new_n57_ = new_n58_ & x0;
  assign new_n58_ = ~x4 & x7 & ((x1 & (~x2 | ~x8)) | (~x3 & ~x8));
  assign new_n59_ = (~x2 | ((x0 | x7) & (~x3 | x8))) & (~x1 | ~x7) & (~x3 | (x7 ? ~x0 : x1));
