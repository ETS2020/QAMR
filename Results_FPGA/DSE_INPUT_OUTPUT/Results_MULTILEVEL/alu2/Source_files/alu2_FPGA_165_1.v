...
module FAU ( 
  ...
  assign z4 = x9 & ((~new_n39_ & x4) | ~new_n45_ | (~new_n41_ & x1));
  assign new_n39_ = new_n40_ & (x1 | ((x2 | ~x5 | x6) & (~x3 | x5 | ~x6)));
  assign new_n40_ = (~x3 | ((x5 | x8) & (~x2 | (~x5 ^ x7)))) & (~x5 | x6 | (x7 & (x2 | x3)));
  assign new_n41_ = (new_n42_ | ~x2) & new_n44_ & (new_n43_ | x2);
  assign new_n42_ = (x5 | ~x7) & (~x6 | x7 | ~x3 | ~x5);
  assign new_n43_ = (x5 | ~x6) & (~x3 | x4 | ~x7);
  assign new_n44_ = ((x8 & (x3 | ~x6)) | (x5 & (x4 | ~x7))) & (~x3 | ((x5 | ~x7) & (x6 | (x7 ? x4 : x8))));
  assign new_n45_ = (x3 | new_n46_ | ~x5) & x0 & (~new_n47_ | x5);
  assign new_n46_ = (~x2 | ((x4 | x6 | ~x7) & (x1 | ~x6 | x7))) & (x4 | ((x6 | x8) & (~x7 | (x8 & (x2 | ~x6)))));
  assign new_n47_ = x6 & ((~x7 & (~x2 | ~x8)) | (~x8 & (x3 | ~x4)));
  assign z5 = (~x0 & x9) | ((x1 ^ ~x3) & (x2 ? (new_n49_ | x0) : ~x0));
  assign new_n49_ = ~x7 & x9 & x5 & x6;
endmodule
