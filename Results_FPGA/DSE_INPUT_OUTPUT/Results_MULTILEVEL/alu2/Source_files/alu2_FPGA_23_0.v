...
module FAU ( 
  ...
  assign z4 = x9 & (~new_n71_ | (x5 & (~new_n65_ | (~new_n81_ & ~x7))));
  assign new_n65_ = (new_n70_ | x0) & (new_n66_ | x2) & (new_n68_ | x4);
  assign new_n66_ = (new_n67_ | x4) & (x6 | ((x1 | ~x4) & (x3 | (~x4 & x8))));
  assign new_n67_ = (~x1 | x8 | (x6 & ~x7)) & (~x6 | ~x7 | ~x0 | x3);
  assign new_n68_ = (new_n69_ | ~x7) & (x6 | x8 | ~x0 | x3);
  assign new_n69_ = (~x1 | ((x3 | ~x6) & (~x0 | x8))) & (~x0 | x3 | (x8 & (~x2 | x6)));
  assign new_n70_ = (x1 | (~x4 & (~x6 | x8 | x2 | x3))) & (x3 | ~x4 | x6);
  assign new_n71_ = (~x0 | (~new_n79_ & (new_n72_ | x5))) & ~new_n80_ & (new_n74_ | x5);
  assign new_n72_ = (new_n73_ | ((x6 | x8) & (~x7 | (~x2 & ~x6)))) & (~x6 | ((x4 | x8) & (x2 | x7)));
  assign new_n73_ = ~x1 & (~x3 | ~x4);
  assign new_n74_ = (new_n75_ | ~x1) & ~new_n78_ & (~x4 | (~new_n76_ & ~new_n77_));
  assign new_n75_ = (~x4 | ((~x6 | ~x7) & (~x2 | x6 | x8))) & (~x3 | x6 | ~x7) & (x3 | ~x6 | x7);
  assign new_n76_ = x2 & ((~x0 & x6 & ~x7) | (x3 & ~x8));
  assign new_n77_ = x6 & ~x7 & ~x1 & x3;
  assign new_n78_ = x6 & ~x7 & ~x8;
  assign new_n79_ = x1 & ~x4 & ((~x6 & ~x8) | (~x2 & x6 & x7));
  assign new_n80_ = x1 & x3 & ~x4 & ~x6 & x7;
  assign new_n81_ = (~x2 | ((~x0 | x4 | ~x6 | (~x1 ^ ~x3)) & (~x4 | (x1 & ~x3)))) & (~x4 | x6) & (x0 | ((~x3 | ~x4) & (x2 | ~x6 | (x1 ? (~x3 | x4) : x3))));
