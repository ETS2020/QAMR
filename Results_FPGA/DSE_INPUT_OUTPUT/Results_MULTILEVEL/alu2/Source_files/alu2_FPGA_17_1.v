...
module FAU ( 
  ...
  assign z4 = x4 & x9 & (x5 ? ~new_n55_ : ~new_n51_);
  assign new_n51_ = (new_n52_ | ~x6) & new_n54_ & (~new_n53_ | ~x0);
  assign new_n52_ = ((~x1 & x7) | ((x0 | ~x2) & x8 & (~x0 | x2))) & (~x1 | (x3 & ~x7)) & (x1 | ~x3 | (~x0 & x7));
  assign new_n53_ = (~x8 | (x2 & x7)) & (x1 | (x3 & ~x6));
  assign new_n54_ = (~x1 | ((~x3 | ~x7) & (~x2 | x8))) & (~x2 | ~x3 | x8);
