...
module FAU ( 
  ...
  assign z4 = x9 & ((~new_n47_ & x5) | ~new_n52_ | (~new_n54_ & x0));
  assign new_n47_ = new_n48_ & (x4 | new_n51_ | (~x0 ^ ~x2));
  assign new_n48_ = (new_n49_ | x3) & (~x1 | ~new_n50_ | x2);
  assign new_n49_ = (x2 | ((x6 | x8) & (~x0 | ~x6 | ~x7))) & (~x0 | x6 | (x8 & (~x2 | ~x7))) & (~x1 | ~x6 | ~x7);
  assign new_n50_ = ~x8 & (~x6 | x7);
  assign new_n51_ = (x1 | x3 | (x8 & (~x6 | x7))) & (~x6 | x7 | ~x1 | ~x3);
  assign new_n52_ = new_n53_ & (~x1 | ((~x3 | x6 | ~x7) & (x3 | x5 | ~x6 | x7)));
  assign new_n53_ = ~x4 & (x5 | ~x6 | x7 | x8);
  assign new_n54_ = (~x6 | ((~x1 | ~x7 | (x2 & x5)) & (x5 | (x8 & (x2 | x7))))) & (~x1 | ((x5 | (x8 & (~x2 | ~x7))) & (x8 | (x6 & ~x7))));
