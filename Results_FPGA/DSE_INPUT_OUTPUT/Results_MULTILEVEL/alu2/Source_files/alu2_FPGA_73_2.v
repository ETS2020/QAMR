...
module FAU ( 
  ...
  assign z4 = ~new_n64_ | (x6 & ((~new_n74_ & x0) | ~new_n80_ | (~new_n77_ & ~x0)));
  assign new_n64_ = x5 ? (~new_n65_ & ~new_n73_ & x9) : (~x9 | (~new_n69_ & new_n71_));
  assign new_n65_ = ~x6 & ((~new_n66_ & ~x4) | new_n67_ | (~new_n68_ & x4));
  assign new_n66_ = (~x0 | ((~x1 | x8) & (x3 | (x8 & (~x2 | ~x7))))) & (~x1 | ((x2 | x8) & (~x3 | ~x7)));
  assign new_n67_ = ~x2 & ((~x1 & x4) | (~x3 & (x4 | ~x8)));
  assign new_n68_ = x7 & (x0 | x3);
  assign new_n69_ = ~new_n70_ & x0;
  assign new_n70_ = ((x8 & (~x2 | ~x7)) | (~x1 & (~x3 | ~x4))) & (~x1 | ~x3 | ~x7);
  assign new_n71_ = (~x1 | ((~new_n72_ | ~x2) & (~x3 | x6 | ~x7))) & (~new_n72_ | ~x2 | ~x3);
  assign new_n72_ = x4 & ~x8;
  assign new_n73_ = x4 & ((~x0 & (~x1 | (x3 & ~x7))) | (x2 & ~x7 & (~x1 | x3)));
  assign new_n74_ = (x4 | (x5 ? new_n75_ : (x8 | ~x9))) & (x5 | new_n76_ | ~x9);
  assign new_n75_ = x2 ? ((x7 & x8) | (~x1 ^ ~x3)) : (~x7 | (~x1 & x3));
  assign new_n76_ = (~x1 | (x2 & x3)) & (x2 | x7) & (x1 | ~x3 | ~x4);
  assign new_n77_ = (x2 | ~new_n78_ | ~x5) & (~x4 | ~new_n79_ | x5);
  assign new_n78_ = (~x7 | ~x8) & (x1 ? (x3 & ~x4) : ~x3);
  assign new_n79_ = x9 & ((x2 & ~x7) | (x1 & (x2 | x7)));
  assign new_n80_ = (~new_n81_ | x5) & (x4 | ~x5 | ~x7 | ~x1 | x3);
  assign new_n81_ = x9 & ((x1 & ~x3 & (x4 | ~x7)) | (~x7 & (~x8 | (~x1 & x3 & x4))));
