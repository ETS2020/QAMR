...
module FAU ( 
  ...
  assign new_n51_ = (new_n52_ | ~x5) & new_n58_ & (x5 | (new_n55_ & (new_n57_ | ~x3)));
  assign new_n52_ = (new_n53_ | x3) & (x1 | ~x4) & (new_n54_ | ~x3);
  assign new_n53_ = (x2 | ((x6 | x8) & (x1 | (x8 & (~x6 | x7))))) & (~x4 | x6) & (~x6 | ~x7 | ~x1 | x4);
  assign new_n54_ = (~x4 | x7) & (~x1 | x2 | x4 | (x8 & (~x6 | x7)));
  assign new_n55_ = (new_n56_ | ~x6) & (~x1 | ~x2 | ~x4 | x8);
  assign new_n56_ = (~x4 | ((~x2 | (~x1 & x7)) & (~x1 | (x3 & ~x7)))) & (x7 | (x8 & (~x1 | x3)));
  assign new_n57_ = (~x1 | x6 | ~x7) & (~x2 | ~x4 | x8);
  assign new_n58_ = ~x0 & (~x3 | ((~x1 | x4 | x6 | ~x7) & (~x6 | x7 | x1 | ~x4)));
  assign z5 = ((~x1 ^ x3) & (~x0 ^ x2)) | (x9 & (x0 | (new_n60_ & ~x2)));
  assign new_n60_ = x5 & (new_n21_ | ~x8) & (x1 ? (x3 & ~x4) : ~x3);
endmodule
