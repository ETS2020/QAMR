...
module FAU ( 
  ...
  assign z4 = x4 & ~new_n51_ & x9;
  assign new_n51_ = x5 ? new_n54_ : ((new_n55_ | ~x0) & new_n52_ & ~new_n56_);
  assign new_n52_ = ~new_n53_ & (~x6 | x7 | (x8 & (x1 | ~x3)));
  assign new_n53_ = x2 & ((x3 & ~x8) | (~x0 & x6 & ~x7));
  assign new_n54_ = (x7 | ((~x2 | (x1 & ~x3)) & x6 & (x0 | ~x3))) & (x0 | (x1 & (x3 | x6))) & (x2 | x6 | (x1 & x3));
  assign new_n55_ = (((~x2 | ~x7) & (x6 | x8)) | (~x1 & ~x3)) & (~x6 | (x7 ? ~x3 : x2));
  assign new_n56_ = x1 & ((x6 & (~x3 | x7)) | (x3 & x7) | (x2 & ~x6 & ~x8));
