// Benchmark "FAU" written by ABC on Mon Aug 17 20:18:37 2020
...
module FAU ( 
  ...
  assign z4 = x9 & (~new_n52_ | new_n59_);
  assign new_n52_ = (new_n53_ | ~x1) & (new_n55_ | x1) & x6 & (new_n58_ | x7);
  assign new_n53_ = (new_n54_ | x0) & (x5 | ((~x4 | ~x7) & (x3 | (~x4 & x7)))) & (x3 | x4 | ~x5 | ~x7);
  assign new_n54_ = x2 ? (~x4 | x5) : (~x3 | ~x5 | (x7 & (x4 | x8)));
  assign new_n55_ = (new_n57_ | ~x4) & (x0 | x2 | x3 | ~new_n56_ | x4);
  assign new_n56_ = x5 & (~x7 | ~x8);
  assign new_n57_ = (~x2 | ((~x5 | x7) & (~x3 | x5 | x8))) & (x0 | ~x5) & (~x3 | x5 | x7);
  assign new_n58_ = (x5 | x8) & (x0 | ~x4 | (x5 ? ~x3 : ~x2));
  assign new_n59_ = x0 & (new_n60_ | new_n62_ | (~new_n61_ & ~x4));
  assign new_n60_ = x3 & ((~x1 & x4 & ~x5) | (x5 & ~x7 & x1 & x2));
  assign new_n61_ = (~x7 | ((~x1 | (x2 & x8)) & (x2 | x3 | ~x5))) & (x5 | x8) & (x1 | ~x2 | x3 | ~x5 | (x7 & x8));
  assign new_n62_ = ~x5 & ((~x2 & (x1 | ~x7)) | (x1 & (~x3 | x7 | ~x8)));
