...
module FAU ( 
  ...
  assign z4 = x9 & ((~new_n52_ & x5) | (~new_n55_ & ~x5) | new_n58_ | x4);
  assign new_n52_ = (new_n53_ | x3) & (~x1 | new_n54_ | ~x3);
  assign new_n53_ = x6 ? ((x1 | (x7 & x8) | (~x0 ^ ~x2)) & (~x7 | (~x1 & (~x0 | x2)))) : ((x2 | x8) & (~x0 | (x8 & (~x2 | ~x7))));
  assign new_n54_ = ((~x0 ^ ~x2) | (x8 & (~x6 | x7))) & (~x0 | x2 | ~x7);
  assign new_n55_ = ~new_n57_ & (new_n56_ | ~x0);
  assign new_n56_ = (~x6 | ((x2 | (~x1 & x7)) & x8 & (~x1 | (x3 & ~x7)))) & (~x1 | (x8 & (~x2 | ~x7)));
  assign new_n57_ = x6 & ~x7 & (~x8 | (x1 & ~x3));
  assign new_n58_ = x1 & ~x6 & ((x3 & x7) | (x0 & ~x8));
