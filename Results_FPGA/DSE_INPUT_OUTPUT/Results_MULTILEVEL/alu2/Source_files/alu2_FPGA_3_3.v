...
module FAU ( 
  ...
  assign z4 = x9 & ((~new_n47_ & x5) | new_n53_ | x4 | (~new_n50_ & ~x5));
  assign new_n47_ = (new_n48_ | x3) & (~x1 | new_n49_ | ~x3);
  assign new_n48_ = x6 ? ((x1 | (x7 & x8) | (~x0 ^ ~x2)) & (~x7 | (~x1 & (~x0 | x2)))) : ((x2 | x8) & (~x0 | (x8 & (~x2 | ~x7))));
  assign new_n49_ = ((~x0 ^ ~x2) | (x8 & (~x6 | x7))) & (~x0 | x2 | ~x7);
  assign new_n50_ = ~new_n52_ & (new_n51_ | ~x0);
  assign new_n51_ = (~x6 | ((x2 | (~x1 & x7)) & x8 & (~x1 | (x3 & ~x7)))) & (~x1 | (x8 & (~x2 | ~x7)));
  assign new_n52_ = x6 & ~x7 & (~x8 | (x1 & ~x3));
  assign new_n53_ = x1 & ~x6 & ((x3 & x7) | (x0 & ~x8));
