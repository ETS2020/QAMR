...
module FAU ( 
  ...
  assign z3 = x1 & x3;
  assign z4 = x9 & (new_n57_ | new_n53_ | ~x1 | (~new_n61_ & ~x4));
  assign new_n53_ = ~x5 & (~new_n54_ | (~new_n56_ & x6));
  assign new_n54_ = new_n55_ & (~x2 | ((~x4 | x8) & (~x0 | ~x7)));
  assign new_n55_ = (~x0 | (x8 & (~x3 | ~x7))) & (~x3 | x6 | ~x7);
  assign new_n56_ = (~x0 | (x2 & x3)) & (x0 | ~x4 | (~x2 & ~x7)) & (x7 | (x3 & x8));
  assign new_n57_ = x5 & ((~new_n58_ & x3) | (~new_n59_ & ~x4) | (new_n60_ & x4));
  assign new_n58_ = (~x2 | ((~x0 | ((~x6 | x7) & (x4 | x8))) & (~x4 | x7))) & (~x6 | x7 | x0 | x2);
  assign new_n59_ = (x2 | x8 | (x6 & ~x7)) & (x3 | ~x6 | ~x7);
  assign new_n60_ = ~x6 & (~x7 | (~x3 & (~x0 | ~x2)));
  assign new_n61_ = (~x3 | x6 | ~x7) & (~x0 | ((x6 | (x8 & (~x2 | ~x7))) & (x2 | ~x6 | ~x7)));
  assign z5 = (x9 & (new_n64_ | ~x1)) | (~new_n63_ & (x0 ^ ~x2));
  assign new_n63_ = x3 ? (~x1 & (x7 | ~x9 | ~x5 | ~x6)) : x1;
  assign new_n64_ = ~x4 & x5 & ~x8 & x0 & x2 & x3;
endmodule
