...
module FAU ( 
  ...
  assign z3 = ~x9 & x1 & x3;
  assign z4 = x9 & (new_n51_ | (~new_n53_ & x5) | x3 | (new_n57_ & ~x5));
  assign new_n51_ = x1 & ((~new_n52_ & ~x5) | (~x4 & x5 & x6 & x7));
  assign new_n52_ = (~x2 | ((~x4 | x8) & (~x0 | ~x7))) & (~x0 | (~x6 & x8)) & (~x6 | (~x4 & x7));
  assign new_n53_ = (new_n54_ | ~x0) & ~new_n56_ & (new_n55_ | x2);
  assign new_n54_ = (~x2 | ((x1 | ((~x6 | x7) & (x4 | x8))) & (x4 | x6 | ~x7))) & (x4 | ((x2 | ~x6 | ~x7) & (x6 | x8)));
  assign new_n55_ = (x0 | x1 | (x8 & (~x6 | x7))) & (x6 | (~x4 & x8));
  assign new_n56_ = x4 & ((~x0 & (~x1 | ~x6)) | (~x7 & (~x6 | (~x1 & x2))));
  assign new_n57_ = x6 & ((x0 & ((~x2 & ~x7) | (~x4 & ~x8))) | (~x7 & (~x8 | (~x0 & x2 & x4))));
  assign z5 = (~new_n59_ & (x0 ^ ~x2)) | (x9 & (new_n60_ | x3));
  assign new_n59_ = x1 ? ~x3 : (x3 & (~x5 | ~x6 | x7 | ~x9));
  assign new_n60_ = ~x1 & x5 & ~x8 & (x0 ? (x2 & ~x4) : ~x2);
endmodule
