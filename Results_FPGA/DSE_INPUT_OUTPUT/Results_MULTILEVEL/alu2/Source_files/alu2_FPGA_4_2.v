...
module FAU ( 
  ...
  assign z3 = x3 & (x1 | ~x9);
  assign z4 = new_n65_ | (x9 & (x5 ? ~new_n60_ : ~new_n70_));
  assign new_n60_ = new_n61_ & (x4 | ((new_n63_ | x3) & (~x1 | ~new_n64_ | ~x3)));
  assign new_n61_ = (new_n62_ | ~x4) & (x2 | x3 | x6 | x8);
  assign new_n62_ = (x0 | (x1 & (x3 | x6))) & (x1 | (x2 ? x7 : x6)) & (x6 | (x7 & (x2 | x3)));
  assign new_n63_ = (~x0 | ((~x2 | ((x6 | ~x7) & (x1 | ~x6 | (x7 & x8)))) & (x6 | x8) & (x2 | ~x6 | ~x7))) & (~x1 | ~x6 | ~x7) & (x2 | ((~x7 | x8) & (x0 | x1 | ~x6 | x7)));
  assign new_n64_ = (~x8 | (x6 & ~x7)) & (x0 ^ ~x2);
  assign new_n65_ = x3 & (new_n66_ | ~x9 | (x4 & (new_n68_ | new_n69_)));
  assign new_n66_ = x1 & ((~x4 & (new_n67_ | (~x6 & x7))) | (~x5 & ~x6 & x7));
  assign new_n67_ = x0 & x5 & ((~x6 & ~x8) | (~x2 & x7));
  assign new_n68_ = ~x7 & ((x5 & (~x0 | x2)) | (~x1 & ~x5 & x6));
  assign new_n69_ = ~x5 & ((x0 & (x6 ? x7 : ~x8)) | (x2 & (~x8 | (x0 & x7))));
  assign new_n70_ = ~new_n73_ & (~x1 | (new_n72_ & (new_n71_ | ~x2)));
  assign new_n71_ = (~x0 | ~x7) & (~x4 | x6 | x8);
  assign new_n72_ = (~x0 | (x6 ? ~x7 : x8)) & (~x6 | (x7 ? ~x4 : x3));
  assign new_n73_ = x6 & ((x0 & ((~x2 & ~x7) | (~x4 & ~x8))) | (~x7 & (~x8 | (~x0 & x2 & x4))));
