...
module FAU ( 
  ...
  assign z4 = x9 & (~new_n65_ | (x5 & (~new_n60_ | (~new_n75_ & ~x7))));
  assign new_n60_ = (new_n63_ | x0) & ~new_n61_ & (x4 | new_n64_ | ~x7);
  assign new_n61_ = ~x6 & (new_n62_ | (~x2 & (x1 ? (~x4 & ~x8) : x4)));
  assign new_n62_ = ~x3 & ((x0 & ~x4 & (~x8 | (x2 & x7))) | (~x2 & (x4 | ~x8)));
  assign new_n63_ = (x1 | (~x4 & (~x6 | x8 | x2 | x3))) & (x3 | ~x4 | x6) & (~x1 | x2 | ~x3 | x4 | ~x6 | x8);
  assign new_n64_ = (~x1 | ((x3 | ~x6) & (~x0 | x8))) & (~x0 | x3 | (x8 & (x2 | ~x6)));
  ...
  assign new_n74_ = ~x4 & ~x6 & x7 & x1 & x3;
  assign new_n75_ = (~x2 | ((~x0 | x4 | ~x6 | (x1 ^ x3)) & (~x4 | (x1 & ~x3)))) & (~x4 | x6) & (x0 | ((~x3 | ~x4) & (x2 | ~x6 | (x1 ? (~x3 | x4) : x3))));
