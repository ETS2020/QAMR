...
module FAU ( 
  ...
  assign new_n30_ = x7 ? ((~x0 | x6 | (~x2 & x8)) & (~x2 | ~x4 | x8)) : ((~x8 | ((x0 | (x2 & x4)) & (~x2 | (~x0 & x4)))) & (x0 | x6 | (x2 & x4)));
  ...
  assign new_n44_ = (x4 | ((~x2 | ((~x6 | ~x8) & (~x3 | x6 | ~x7))) & (~x6 | ~x7 | ~x8) & (~x3 | x6 | x8))) & (x3 | ~x6 | ((~x7 | (~x4 & ~x8)) & (~x2 | ~x8)));
  ...
  assign z4 = x9 & ((~new_n53_ & x6) | ~new_n56_ | (~new_n59_ & x0));
  assign new_n53_ = new_n54_ & ((~x0 & x7) | (x1 ? x3 : (~x3 | ~x4)));
  assign new_n54_ = new_n55_ & ((~x1 & x7) | (x0 ? x2 : (~x2 | ~x4)));
  assign new_n55_ = (x8 | (x7 & (~x0 | (~x3 & x4)))) & (~x1 | ~x4 | (x3 & (x0 | ~x7)));
  assign new_n56_ = (~x1 | ((~new_n57_ | ~x2) & (~new_n58_ | ~x3))) & ~x5 & (~new_n57_ | ~x2 | ~x3);
  assign new_n57_ = x4 & ~x8;
  assign new_n58_ = ~x6 & x7;
  assign new_n59_ = ((x8 & (~x2 | ~x7)) | (~x1 & (~x3 | ~x4))) & (~x1 | ~x3 | ~x7);
