...
module FAU ( 
  ...
  assign new_n52_ = x5 & ((~new_n53_ & x6) | new_n55_ | (~new_n54_ & ~x8));
  assign new_n53_ = (x7 | (~x1 ^ ~x3) | (~x0 ^ ~x2)) & (x3 | ((~x1 | ~x7) & (x2 | (x0 ? ~x7 : (x1 | x8)))));
  assign new_n54_ = ((x6 & ~x7) | ((~x1 | x2) & (~x0 | x3))) & (x2 | x3 | x6);
  assign new_n55_ = x0 & x2 & ~x3 & ~x6 & x7;
  assign new_n56_ = (~x6 | ((~x1 | ~x7 | (x2 & x5)) & (x5 | (x8 & (x2 | x7))))) & (~x1 | ((x5 | (x8 & (~x2 | ~x7))) & (x8 | (x6 & ~x7))));
  assign new_n57_ = (~x1 | ((~x3 | x6 | ~x7) & (x3 | x5 | ~x6 | x7))) & (x5 | ~x6 | x7 | x8);
