...
module FAU ( 
  ...
  assign z4 = ~x0 & x9 & ((~new_n45_ & x4) | ~new_n49_ | (~new_n47_ & ~x4));
  assign new_n45_ = (new_n46_ | x5) & (x1 | (~x5 & (~x3 | ~x6 | x7))) & (~x5 | ((~x3 | x7) & (x6 | (x3 & x7))));
  assign new_n46_ = (~x1 | ((~x6 | ~x7) & (~x2 | x6 | x8))) & (~x2 | ((~x6 | x7) & (~x3 | x8)));
  assign new_n47_ = (new_n48_ | ~x5) & (~x1 | ~x3 | x6 | ~x7);
  assign new_n48_ = (x2 | ((~x6 | (x7 & x8) | (x1 ^ x3)) & (~x1 | x6 | x8))) & (~x6 | ~x7 | ~x1 | x3);
  assign new_n49_ = (new_n50_ | x5) & (x2 | x3 | ~x5 | x6 | x8);
  assign new_n50_ = (~x6 | x7 | x8) & (~x1 | (x3 ? (x6 | ~x7) : (~x6 | x7)));
