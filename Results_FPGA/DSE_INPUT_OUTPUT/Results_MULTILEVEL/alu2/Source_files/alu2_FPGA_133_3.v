...
module FAU ( 
  ...
  assign z4 = x9 & ((~new_n38_ & x5) | ~new_n45_ | (~new_n43_ & x1));
  assign new_n38_ = (x4 | (~new_n39_ & new_n40_)) & (new_n41_ | x6) & (new_n42_ | ~x4);
  assign new_n39_ = ~x8 & (~x1 ^ x3) & (~x0 ^ x2);
  assign new_n40_ = (~x7 | ((~x1 | x3 | ~x6) & (~x0 | (~x1 & x3)))) & (~x0 | x3 | x6);
  assign new_n41_ = (x2 | (x3 & (x1 | ~x4))) & (~x4 | (x7 & (x0 | x3)));
  assign new_n42_ = (x0 | (x1 & (~x3 | x7))) & (x1 | ~x2 | x7);
  ...
  assign new_n47_ = ~x8 & (x5 | ~x6 | (x7 & (~x0 | x4)));
