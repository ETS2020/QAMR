...
module FAU ( 
  ...
  assign new_n33_ = (x6 | ((~x0 | (x8 & (~x2 | ~x7))) & (~x2 | ~x4 | x8))) & (~x2 | ~x4 | ~x7 | x8);
  ...
  assign new_n45_ = (~x7 | (x4 ? (~x0 & (~x5 | x8)) : (x5 | x8))) & (~x5 | ~x8 | ~x2 | x4);
  assign new_n46_ = x5 & ((x2 & ~x7 & x8) | (~x2 & ~x6 & x7 & ~x8));
  assign new_n47_ = (~x2 | ~x4 | ~x7 | x8) & (~x0 | ((x6 | ~x7 | x8) & (~x2 | (x7 ? x6 : ~x8))));
  ...
  assign new_n52_ = (~x0 | x4 | x6 | ~x7) & (~x4 | ~x8 | x0 | x1);
  ...
  assign z3 = x3 & (x1 | ~x9);
  assign z4 = x9 & (~new_n60_ | (x5 & (~new_n70_ | (~new_n75_ & ~x7))));
  assign new_n60_ = (~x0 | (~new_n68_ & (new_n61_ | x5))) & ~new_n69_ & (new_n63_ | x5);
  assign new_n61_ = (new_n62_ | ((x6 | x8) & ((~x2 & ~x6) | ~x7))) & (~x6 | ((x2 | x7) & (x4 | x8)));
  assign new_n62_ = ~x1 & (~x3 | ~x4);
  assign new_n63_ = (new_n64_ | ~x1) & ~new_n67_ & (~x4 | (~new_n65_ & ~new_n66_));
  assign new_n64_ = (~x4 | ((~x6 | ~x7) & (~x2 | x6 | x8))) & (~x3 | x6 | ~x7) & (x3 | ~x6 | x7);
  assign new_n65_ = x2 & ((x3 & ~x8) | (~x0 & x6 & ~x7));
  assign new_n66_ = x6 & ~x7 & ~x1 & x3;
  assign new_n67_ = x6 & ~x7 & ~x8;
  assign new_n68_ = x1 & ~x4 & ((~x6 & ~x8) | (~x2 & x6 & x7));
  assign new_n69_ = x1 & x3 & ~x4 & ~x6 & x7;
  assign new_n70_ = (new_n71_ | ~x4) & ~new_n74_ & (x4 | (~new_n73_ & (new_n72_ | ~x7)));
  assign new_n71_ = (x0 | (x1 & (x3 | x6))) & (x2 | x6 | (x1 & x3));
  assign new_n72_ = (x3 | ((x2 | (x8 & (~x0 | ~x6))) & (~x1 | ~x6) & (~x0 | (x8 & (~x2 | x6))))) & (~x1 | x8 | (~x0 & x2));
  assign new_n73_ = ~x6 & ~x8 & ((x1 & ~x2) | (x0 & ~x3));
  assign new_n74_ = ~x6 & ~x8 & ~x2 & ~x3;
  assign new_n75_ = (~x6 | (~x1 ^ ~x3) | (~x0 ^ ~x2)) & (~x4 | ((~x2 | (x1 & ~x3)) & x6 & (x0 | ~x3)));
