...
module FAU ( 
  ...
  assign z4 = x5 & x9 & ((~new_n41_ & ~x4) | new_n47_ | (~new_n46_ & x4));
  assign new_n41_ = new_n42_ & (new_n45_ | (~x0 ^ ~x2));
  assign new_n42_ = (new_n44_ | ~x1) & (new_n43_ | x3);
  assign new_n43_ = (~x0 | ((~x2 | ((x6 | ~x7) & (x1 | ~x6 | x8))) & (x6 | x8) & (x2 | ~x6 | ~x7))) & (~x7 | ((x2 | x8) & (~x1 | ~x6)));
  assign new_n44_ = (x2 | ((x6 | x8) & (~x0 | ~x3 | ~x7))) & (~x3 | x6 | ~x7);
  assign new_n45_ = (~x1 | ~x3 | (x8 & (~x6 | x7))) & (x1 | x3 | ~x6 | x7);
  assign new_n46_ = (x7 | ((~x2 | (x1 & ~x3)) & x6 & (x0 | ~x3))) & (x0 | (x1 & (x3 | x6))) & (x2 | x6 | (x1 & x3));
  assign new_n47_ = ~x6 & ~x8 & ~x2 & ~x3;
