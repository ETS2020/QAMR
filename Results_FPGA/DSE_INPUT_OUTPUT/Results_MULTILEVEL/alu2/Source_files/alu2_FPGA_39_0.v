...
module FAU ( 
  ...
  assign z2 = new_n60_ | (x1 & x3) | (~x1 & ~x3);
  assign new_n60_ = ~x2 & ~x9;
  assign z3 = x1 & ~new_n60_ & x3;
  assign z4 = (~new_n63_ & x5) | new_n79_ | new_n60_ | (~new_n74_ & x0);
  assign new_n63_ = (new_n64_ | x3) & (new_n69_ | ~x3) & ~new_n73_ & (new_n72_ | x6);
  assign new_n64_ = ~new_n68_ & (new_n67_ | x6) & (~x6 | (~new_n66_ & (~new_n65_ | x1)));
  assign new_n65_ = (~x7 | ~x8) & ((~x0 & ~x2) | (x0 & x2 & ~x4 & x9));
  assign new_n66_ = ~x4 & x7 & ((x0 & ~x2) | (x1 & x9));
  assign new_n67_ = (~x9 | (x0 ? (x4 | (x8 & (~x2 | ~x7))) : ~x4)) & (x2 | (~x4 & x8));
  assign new_n68_ = ~x2 & x4 & ~x0 & ~x1;
  assign new_n69_ = (~new_n71_ | ~x4) & (~x1 | ~new_n70_ | x4);
  assign new_n70_ = x6 & (~x7 | ~x8) & (x0 ? (x2 & x9) : ~x2);
  assign new_n71_ = ~x7 & x9 & (~x0 | x2);
  assign new_n72_ = (x2 | (x1 ? (x4 | x8) : ~x4)) & (~x4 | x7 | ~x9);
  assign new_n73_ = ~x1 & x4 & x9 & (~x0 | (x2 & ~x7));
  assign new_n74_ = (~new_n78_ | ~x1) & (x5 | (~new_n77_ & (new_n75_ | ~x9)));
  assign new_n75_ = (new_n76_ | ((x6 | x8) & (~x7 | (~x2 & ~x6)))) & (x4 | ~x6 | x8);
  assign new_n76_ = ~x1 & (~x3 | ~x4);
  assign new_n77_ = ~x2 & x6 & ~x7;
  assign new_n78_ = ~x4 & ((~x2 & x6 & x7) | (~x6 & ~x8 & x9));
  assign new_n79_ = x9 & ((~new_n80_ & ~x5) | (new_n86_ & new_n85_ & ~x4));
