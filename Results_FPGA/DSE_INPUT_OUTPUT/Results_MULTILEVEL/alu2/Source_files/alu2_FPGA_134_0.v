...
module FAU ( 
  ...
  assign new_n54_ = ~x2 & ~x6 & (x3 ? x4 : x5);
  ...
  assign z4 = (~new_n64_ & x5) | new_n80_ | new_n60_ | (~new_n75_ & x0);
  assign new_n64_ = (new_n65_ | x3) & (new_n70_ | ~x3) & ~new_n74_ & (new_n73_ | x6);
  assign new_n65_ = ~new_n69_ & (new_n68_ | x6) & (~x6 | (~new_n67_ & (~new_n66_ | x1)));
  assign new_n66_ = (~x7 | ~x8) & ((~x0 & ~x2) | (x0 & x2 & ~x4 & x9));
  assign new_n67_ = ~x4 & x7 & ((x0 & ~x2) | (x1 & x9));
  assign new_n68_ = (~x9 | (x0 ? (x4 | (x8 & (~x2 | ~x7))) : ~x4)) & (x2 | (~x4 & x8));
  assign new_n69_ = ~x2 & x4 & ~x0 & ~x1;
  assign new_n70_ = (~new_n72_ | ~x4) & (~x1 | ~new_n71_ | x4);
  assign new_n71_ = x6 & (~x7 | ~x8) & (x0 ? (x2 & x9) : ~x2);
  assign new_n72_ = ~x7 & x9 & (~x0 | x2);
  assign new_n73_ = (x2 | (x1 ? (x4 | x8) : ~x4)) & (~x4 | x7 | ~x9);
  assign new_n74_ = ~x1 & x4 & x9 & (~x0 | (x2 & ~x7));
  assign new_n75_ = (~new_n79_ | ~x1) & (x5 | (~new_n78_ & (new_n76_ | ~x9)));
  assign new_n76_ = (new_n77_ | ((x6 | x8) & (~x7 | (~x2 & ~x6)))) & (x4 | ~x6 | x8);
  assign new_n77_ = ~x1 & (~x3 | ~x4);
  assign new_n78_ = ~x2 & x6 & ~x7;
  assign new_n79_ = ~x4 & ((~x2 & x6 & x7) | (~x6 & ~x8 & x9));
  assign new_n80_ = x9 & ((~new_n81_ & ~x5) | (new_n62_ & new_n86_ & ~x4));
