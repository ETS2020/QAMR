...
module FAU ( 
  ...
  assign new_n52_ = (new_n53_ | ~x5) & ~new_n59_ & (x5 | (new_n56_ & (new_n58_ | ~x4)));
  assign new_n53_ = x4 ? new_n55_ : new_n54_;
  assign new_n54_ = (x3 | ((x1 | (x7 & x8) | (x0 ^ x2)) & (~x7 | (~x1 & (~x0 | x2))))) & (~x1 | ~x3 | (x0 ? (~x2 | x7) : (x2 | (x7 & x8))));
  assign new_n55_ = (x0 | (x1 & (~x3 | x7))) & (~x2 | x7 | (x1 & ~x3));
  assign new_n56_ = new_n57_ & (~x1 | (x7 ? ~x0 : x3));
  assign new_n57_ = (x7 | x8) & (~x0 | ((x2 | x7) & (x4 | x8)));
  assign new_n58_ = (~x2 | ((x0 | x7) & (~x3 | x8))) & (~x1 | ~x7) & (~x3 | (x7 ? ~x0 : x1));
  assign new_n59_ = x0 & x1 & ~x4 & x7 & (~x2 | ~x8);
