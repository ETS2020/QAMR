...
module FAU ( 
  ...
  assign z4 = ~x5 & x9 & ((~new_n53_ & x6) | new_n55_ | ~new_n57_);
  assign new_n53_ = new_n54_ & ((~x1 & x7) | (x0 ? x2 : (~x2 | ~x4)));
  assign new_n54_ = ((~x0 & x7) | (x1 ? x3 : (~x3 | ~x4))) & (~x0 | ((x4 | x8) & (~x1 | ~x7))) & (x7 | x8) & (~x1 | ~x4 | (x3 & ~x7));
  assign new_n55_ = x0 & ~new_n56_ & (~x8 | (x2 & x7));
  assign new_n56_ = ~x1 & (~x3 | ~x4 | x6);
  assign new_n57_ = (x6 | ((~x1 | ((~new_n58_ | ~x2) & (~x3 | ~x7))) & (~new_n58_ | ~x2 | ~x3))) & (~new_n58_ | ~x3 | x1 | ~x2);
