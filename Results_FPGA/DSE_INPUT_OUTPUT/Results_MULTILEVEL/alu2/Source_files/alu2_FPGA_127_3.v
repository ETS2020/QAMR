...
module FAU ( 
  ...
  assign z4 = ~x8 & x9 & (~new_n43_ | (~new_n38_ & x5));
  assign new_n38_ = (new_n39_ | x1) & (new_n40_ | x4) & ~new_n42_ & (new_n41_ | ~x4);
  assign new_n39_ = (x0 | (~x4 & (x2 | x3))) & (x2 | ~x4 | x6) & (~x2 | ((~x4 | x7) & (~x0 | x3 | x4)));
  assign new_n40_ = ((x6 & ~x7) | ((~x1 | x2) & (~x0 | x3))) & (~x1 | ((x0 | x2 | ~x3) & (x3 | ~x6 | ~x7))) & (x2 | x3 | ~x7);
  assign new_n41_ = (x0 | (x3 ? x7 : x6)) & (~x1 | x6 | x7);
  assign new_n42_ = ~x2 & ~x3 & ~x6;
  assign new_n43_ = ~new_n44_ & ~new_n47_ & (~x1 | (~new_n45_ & new_n46_));
  assign new_n44_ = ~x7 & ((~x5 & x6) | (x2 & x3 & x4));
  assign new_n45_ = x2 & ((x4 & ~x5) | (x0 & x3 & ~x4));
  assign new_n46_ = (x6 | ((~x3 | ~x7 | (x4 & x5)) & (~x0 | x4))) & (~x4 | x5 | ~x6) & (~x0 | (x5 & (x4 | ~x7)));
  assign new_n47_ = ~x5 & ((x3 & ((x2 & x4) | (x0 & (x4 | x6)))) | (x0 & ~x4 & x6));
