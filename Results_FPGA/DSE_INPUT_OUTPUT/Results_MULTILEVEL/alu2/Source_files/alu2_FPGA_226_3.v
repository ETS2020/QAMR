...
module FAU ( 
  ...
  assign new_n49_ = (new_n50_ | ~x5) & new_n56_ & (x5 | (new_n53_ & (new_n55_ | ~x3)));
  assign new_n50_ = (new_n51_ | x3) & (x1 | ~x4) & (new_n52_ | ~x3);
  assign new_n51_ = (x2 | ((x1 | (x8 & (~x6 | x7))) & (x6 | x8))) & (~x4 | x6) & (~x6 | ~x7 | ~x1 | x4);
  assign new_n52_ = (~x1 | x2 | x4 | (x8 & (~x6 | x7))) & (~x4 | x7);
  assign new_n53_ = (new_n54_ | ~x6) & (~x1 | ~x2 | ~x4 | x8);
  assign new_n54_ = (~x4 | ((~x2 | (~x1 & x7)) & (~x1 | (x3 & ~x7)))) & (x7 | (x8 & (~x1 | x3)));
  assign new_n55_ = (~x1 | x6 | ~x7) & (~x2 | ~x4 | x8);
  assign new_n56_ = ~x0 & (~x3 | ((~x1 | x4 | x6 | ~x7) & (~x6 | x7 | x1 | ~x4)));
  assign z5 = ((x1 ^ ~x3) & (~x0 ^ x2)) | (x9 & (x0 | (new_n58_ & ~x2)));
  assign new_n58_ = x5 & (new_n21_ | ~x8) & (x1 ? (x3 & ~x4) : ~x3);
endmodule
