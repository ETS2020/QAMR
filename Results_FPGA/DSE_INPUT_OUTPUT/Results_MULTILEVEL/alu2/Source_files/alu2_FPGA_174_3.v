...
module FAU ( 
  ...
  assign new_n51_ = (new_n52_ | ~x5) & ~x3 & (x5 | (~new_n57_ & (new_n56_ | ~x1)));
  assign new_n52_ = (new_n53_ | x1) & ~new_n55_ & (new_n54_ | x4);
  assign new_n53_ = (x0 | (~x4 & (x2 | x3 | ~x6 | x7))) & (~x2 | x7 | (~x4 & (~x0 | x3 | ~x6)));
  assign new_n54_ = (~x7 | ((x2 | (x8 & (~x0 | ~x6))) & (~x1 | ~x6) & (~x0 | (x8 & (~x2 | x6))))) & (~x0 | x6 | x8);
  assign new_n55_ = ~x6 & ((~x2 & (x4 | ~x8)) | (x4 & (~x0 | ~x7)));
  assign new_n56_ = (~x2 | ((~x4 | x8) & (~x0 | ~x7))) & (~x0 | (~x6 & x8)) & (~x6 | (~x4 & x7));
  assign new_n57_ = x6 & ((x0 & ((~x2 & ~x7) | (~x4 & ~x8))) | (~x7 & (~x8 | (~x0 & x2 & x4))));
