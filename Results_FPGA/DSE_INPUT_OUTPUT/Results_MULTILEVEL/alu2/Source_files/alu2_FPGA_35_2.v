...
module FAU ( 
  ...
  assign new_n29_ = x3 ? (~x7 | ((~x6 | x9) & (x4 | (x9 & (~x6 | x8))))) : ((~x7 | x9) & (~x6 | x7 | x8));
  ...
  assign new_n43_ = (x4 | ((x0 | (~x6 & x7)) & (~x2 | (x7 & (~x5 | ~x6))))) & (x7 | ((~x2 | (~x0 & ~x5)) & (x0 | ~x5)));
  ...
  assign new_n56_ = (~x8 | (x2 ? (x7 & (x4 | ~x6)) : x6)) & (x0 | (~x8 & (~x2 | x4)));
  assign z2 = (~x5 | x9) & (~x1 ^ x3);
  assign z3 = x1 & x3 & (~x5 | x9);
  assign z4 = new_n60_ | (~new_n69_ & x5) | (~x5 & (new_n74_ | ~new_n76_) & x9);
  assign new_n60_ = x6 & ((~new_n61_ & x0) | ~new_n67_ | (~new_n64_ & ~x0));
  assign new_n61_ = (x4 | (x5 ? new_n62_ : (x8 | ~x9))) & (x5 | new_n63_ | ~x9);
  assign new_n62_ = x2 ? ((x7 & x8) | (~x1 ^ ~x3)) : (~x7 | (~x1 & x3));
  assign new_n63_ = (~x1 | (x2 & x3)) & (x2 | x7) & (x1 | ~x3 | ~x4);
  assign new_n64_ = (x2 | ~new_n65_ | ~x5) & (~x4 | ~new_n66_ | x5);
  assign new_n65_ = (~x7 | ~x8) & (x1 ? (x3 & ~x4) : ~x3);
  assign new_n66_ = x9 & ((x2 & ~x7) | (x1 & (x2 | x7)));
  assign new_n67_ = (~new_n68_ | x5) & (~x1 | x3 | x4 | ~x5 | ~x7);
  assign new_n68_ = x9 & ((x1 & ~x3 & (x4 | ~x7)) | (~x7 & (~x8 | (~x1 & x3 & x4))));
  assign new_n69_ = (new_n73_ | ~x4) & x9 & (x6 | (new_n70_ & (new_n72_ | x4)));
  assign new_n70_ = (new_n71_ | ~x4) & (x2 | ((x1 | ~x4) & (x3 | (~x4 & x8))));
  assign new_n71_ = x7 & (x0 | x3);
  assign new_n72_ = (~x0 | ((x3 | (x8 & (~x2 | ~x7))) & (~x1 | x8))) & (~x1 | ((x2 | x8) & (~x3 | ~x7)));
  assign new_n73_ = (x0 | (x1 & (~x3 | x7))) & (~x2 | x7 | (x1 & ~x3));
  assign new_n74_ = ~new_n75_ & x0;
  assign new_n75_ = ((x8 & (~x2 | ~x7)) | (~x1 & (~x3 | ~x4))) & (~x1 | ~x3 | ~x7);
  assign new_n76_ = (~x1 | ((~new_n77_ | ~x2) & (~x3 | x6 | ~x7))) & (~new_n77_ | ~x2 | ~x3);
