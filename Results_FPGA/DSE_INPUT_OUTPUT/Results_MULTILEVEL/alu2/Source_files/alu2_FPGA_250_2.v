// Benchmark "FAU" written by ABC on Mon Aug 17 20:18:45 2020
...
module FAU ( 
  ...
  assign z4 = new_n64_ | (~new_n71_ & x9) | (x0 & (new_n77_ | new_n79_ | ~x9));
  assign new_n64_ = x6 & ((~new_n65_ & x0) | (x9 & (~new_n70_ | (~new_n68_ & ~x0))));
  assign new_n65_ = (new_n67_ | x5) & (new_n66_ | x4);
  assign new_n66_ = (~x5 | (x2 ? ((~x1 ^ ~x3) | (x7 & x8)) : (x3 | ~x7))) & (x5 | x8) & (~x1 | x2 | ~x7);
  assign new_n67_ = (~x1 | (x2 & x3)) & (x7 | (x2 & x8)) & (x1 | ~x3 | ~x4);
  assign new_n68_ = (x2 | ~new_n69_ | ~x5) & (~x4 | x5 | ((~x2 | x7) & (~x1 | (~x2 & ~x7))));
  assign new_n69_ = (~x7 | ~x8) & (x1 ? (x3 & ~x4) : ~x3);
  assign new_n70_ = (x5 | ((~x1 | x3 | (~x4 & x7)) & (x7 | (x8 & (x1 | ~x3 | ~x4))))) & (~x1 | x3 | x4 | ~x5 | ~x7);
  assign new_n71_ = (new_n74_ | ~x4) & (x6 | (~new_n72_ & (new_n76_ | ~x1)));
  assign new_n72_ = x5 & (new_n73_ | (x4 & (~x7 | (~x0 & ~x3))));
  assign new_n73_ = ~x2 & ((~x1 & x4) | (~x3 & (x4 | ~x8)));
  assign new_n74_ = (new_n75_ | ~x5) & (~x2 | x5 | x8 | (~x1 & ~x3));
  assign new_n75_ = (x0 | (x1 & (~x3 | x7))) & (~x2 | x7 | (x1 & ~x3));
  assign new_n76_ = (~x3 | ~x7 | (x4 & x5)) & (x2 | x4 | ~x5 | x8);
