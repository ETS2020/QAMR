...
module FAU ( 
  ...
  assign new_n47_ = (~x8 | ~x9 | x0 | ~x4) & (x5 | x6 | x9);
  ...
  assign new_n57_ = new_n58_ & (new_n60_ | ~x0);
  assign new_n58_ = ~new_n59_ & (~x4 | ~x5 | x6 | x7 | ~x9);
  assign new_n59_ = x3 & ((x4 & ~x6 & ~x7 & x8 & x9) | (~x4 & x7 & ~x9));
  assign new_n60_ = x9 & (~x2 | ~x3 | x4 | x6 | ~x7);
  assign z2 = (~x0 | x9) & (x1 ^ ~x3);
  assign z3 = (x0 & ~x9) | (x1 & x3);
  assign z4 = x9 & (~new_n64_ | (x5 & (~new_n74_ | (~new_n79_ & ~x7))));
  assign new_n64_ = ~new_n73_ & (new_n67_ | x5) & (~x0 | (~new_n72_ & (new_n65_ | x5)));
  ...
  assign new_n69_ = x2 & ((~x0 & x6 & ~x7) | (x3 & ~x8));
  ...
  assign new_n76_ = (x3 | ((x2 | (x8 & (~x0 | ~x6))) & (~x1 | ~x6) & (~x0 | (x8 & (~x2 | x6))))) & (~x1 | x8 | (~x0 & x2));
