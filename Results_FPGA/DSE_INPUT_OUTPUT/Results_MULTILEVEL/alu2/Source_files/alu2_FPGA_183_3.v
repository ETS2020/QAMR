...
module FAU ( 
  ...
  assign z4 = x9 & ((~new_n38_ & x5) | ~new_n42_ | (~x5 & (new_n44_ | ~new_n45_)));
  assign new_n38_ = (new_n39_ | ~x1) & new_n41_ & (new_n40_ | x1);
  assign new_n39_ = (x2 | ((x0 | ~x3 | x4) & (x3 | x6))) & (~x6 | ((x3 | x4 | ~x7) & (~x0 | ~x2 | ~x3 | x7)));
  assign new_n40_ = ((~x2 & x6) | ((~x4 | x7) & (~x0 | x3 | x4))) & (x2 | ~x4 | x6) & (x0 | (~x4 & (x2 | x3)));
  assign new_n41_ = (x0 | ~x4 | (x3 ? x7 : x6)) & (x4 | ~x7 | ~x0 | x3);
  assign new_n42_ = ~new_n43_ & ~x8;
  assign new_n43_ = x1 & ((x0 & (x7 ? ~x4 : ~x6)) | (x3 & ~x4 & ~x6 & x7));
  assign new_n44_ = x4 & ((x1 & (x2 | x6)) | (x3 & (x0 | x2)));
  assign new_n45_ = (~x1 | (~x0 & (~x3 | x6 | ~x7))) & (~x6 | (x7 & (~x0 | (~x3 & x4))));
