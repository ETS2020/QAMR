...
module FAU ( 
  ...
  assign new_n40_ = (~new_n41_ | ~x1) & (~x6 | ((new_n43_ | x5) & (new_n44_ | ~x1)));
  ...
  assign z4 = ~x0 & x9 & ((~new_n49_ & x4) | ~new_n53_ | (~new_n51_ & ~x4));
  assign new_n49_ = (new_n50_ | x5) & (x1 | (~x5 & (~x3 | ~x6 | x7))) & (~x5 | ((~x3 | x7) & (x6 | (x3 & x7))));
  assign new_n50_ = (~x1 | ((~x6 | ~x7) & (~x2 | x6 | x8))) & (~x2 | ((~x6 | x7) & (~x3 | x8)));
  assign new_n51_ = (new_n52_ | ~x5) & (~x1 | ~x3 | x6 | ~x7);
  assign new_n52_ = (x2 | ((~x6 | (x7 & x8) | (~x1 ^ ~x3)) & (~x1 | x6 | x8))) & (~x6 | ~x7 | ~x1 | x3);
  assign new_n53_ = (new_n54_ | x5) & (x2 | x3 | ~x5 | x6 | x8);
  assign new_n54_ = (~x6 | x7 | x8) & (~x1 | (x3 ? (x6 | ~x7) : (~x6 | x7)));
