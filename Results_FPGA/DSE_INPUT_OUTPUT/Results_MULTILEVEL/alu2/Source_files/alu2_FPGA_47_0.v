...
module FAU ( 
  ...
  assign z4 = (~x0 & (new_n74_ | ~x9)) | (x9 & (~new_n66_ | (~new_n60_ & x5)));
  assign new_n60_ = (x4 | (x6 ? new_n63_ : new_n64_)) & ~new_n61_ & (~new_n65_ | ~x4);
  assign new_n61_ = ~x2 & ((~new_n62_ & ~x3) | (~x1 & x4 & ~x6));
  assign new_n62_ = (x6 | (~x4 & x8)) & (x0 | x1 | ~x6 | (x7 & x8));
  assign new_n63_ = ((x7 & x8) | ((~x0 | ~x2 | (x1 ^ x3)) & (x2 | ~x3 | x0 | ~x1))) & (x3 | ~x7 | (~x1 & (~x0 | x2)));
  assign new_n64_ = (~x0 | x3 | (x8 & (~x2 | ~x7))) & (~x1 | x2 | x8);
  assign new_n65_ = ~x7 & (~x6 | (x2 & (~x1 | x3)));
  assign new_n66_ = new_n69_ & (~x0 | (~new_n73_ & (new_n67_ | x5)));
  assign new_n67_ = (new_n68_ | ((x6 | x8) & (~x7 | (~x2 & ~x6)))) & (~x6 | ((x2 | x7) & (x4 | x8)));
  assign new_n68_ = ~x1 & (~x3 | ~x4);
  assign new_n69_ = ~new_n72_ & (x5 | (new_n71_ & (new_n70_ | ~x4)));
  assign new_n70_ = (~x1 | ((~x6 | ~x7) & (~x2 | x6 | x8))) & (~x3 | ((~x2 | x8) & (x1 | ~x6 | x7)));
  assign new_n71_ = (~x6 | x7 | x8) & (~x1 | (x3 ? (x6 | ~x7) : (~x6 | x7)));
  assign new_n72_ = ~x4 & ~x6 & x7 & x1 & x3;
  assign new_n73_ = x1 & ~x4 & ((~x6 & ~x8) | (~x2 & x6 & x7));
  assign new_n74_ = ~new_n75_ & x4;
  assign new_n75_ = (x7 | ((~x3 | ~x5) & (~x2 | x5 | ~x6))) & (~x5 | (x1 & (x3 | x6)));
