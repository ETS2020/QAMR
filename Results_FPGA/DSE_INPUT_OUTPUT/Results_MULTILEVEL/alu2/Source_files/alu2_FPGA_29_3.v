...
module FAU ( 
  ...
  assign z4 = x9 & (~new_n48_ | (x5 & (~new_n45_ | (~new_n53_ & ~x3))));
  assign new_n45_ = (x1 | ~x4) & (~x3 | ((~x4 | x7) & (x0 | ~new_n46_ | ~x1)));
  assign new_n46_ = ~x2 & ~x4 & (new_n47_ | ~x8);
  assign new_n47_ = x6 & ~x7;
  assign new_n48_ = (new_n49_ | ~x1) & new_n52_ & (new_n51_ | ~x4);
  assign new_n49_ = (x5 | ((~x4 | (~new_n50_ & (~x6 | ~x7))) & (~x3 | x6 | ~x7) & (x3 | ~x6 | x7))) & (~x3 | x4 | x6 | ~x7);
  assign new_n50_ = x2 & (x6 | ~x8);
  assign new_n51_ = (~x2 | x5 | (~new_n47_ & (~x3 | x8))) & (~new_n47_ | x1 | ~x3);
  assign new_n52_ = ~x0 & (x5 | ~x6 | x7 | x8);
  assign new_n53_ = (new_n54_ | x2) & (~x4 | x6) & (~x6 | ~x7 | ~x1 | x4);
  assign new_n54_ = (x0 | x1 | x4 | (x8 & (~x6 | x7))) & (x6 | x8);
