...
module FAU ( 
  ...
  assign z06 = new_n68_ | (~x09 & ((~new_n93_ & ~x07) | (new_n107_ & ~x05 & x07)));
  ...
  assign new_n121_ = ~x19 & (x07 | x09 | x15 | (~new_n122_ & ~x17));
  ...
  assign z12 = ~x09 & ((~new_n129_ & ~x07) | (new_n137_ & ~x05 & x07 & ~x15));
  ...
  assign new_n146_ = ~x19 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign z18 = new_n68_ | (~x05 & ~x07 & new_n159_ & ~x09);
  ...
  assign z20 = new_n68_ | (~x07 & ~x17 & (new_n171_ | (~new_n165_ & ~x15)));
  ...
  assign z24 = new_n68_ | (~x09 & ~x17 & (new_n178_ | new_n182_));
  ...
  assign z25 = (~x18 & x19) | (~x05 & ~x07 & ~x17 & ~new_n184_ & x18);
  ...
  assign new_n191_ = x17 & ~x18 & ~x19 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n192_ = new_n193_ & x03 & ~x05 & ~x07 & x08;
  assign new_n193_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & ~new_n195_ & x18) | (~x09 & ~x18 & ~new_n206_ & ~x19);
  ...
  assign new_n206_ = (~x15 | ((x07 | ~x17) & (x05 | (~x17 & (~x07 | (x02 & x11)))))) & (~x05 | x07 | ~x17);
endmodule
