...
module FAU ( 
  ...
  assign new_n87_ = ~new_n96_ & (x15 | (~new_n94_ & (x21 | (~new_n88_ & new_n90_))));
  assign new_n88_ = ~x02 & ~new_n89_ & x11;
  assign new_n89_ = (x05 | ~x06 | x08) & (x12 | x14 | ~x04 | ~x08);
  assign new_n90_ = ~new_n93_ & (~x08 | (~new_n91_ & (x05 | new_n92_ | x14)));
  assign new_n91_ = x04 & ~x12 & (x05 | (~x13 & ~x14));
  ...
  assign z09 = ~x17 & (new_n110_ | (x18 & (new_n112_ | (~new_n102_ & ~x07))));
  assign new_n102_ = x05 ? ~new_n109_ : (~new_n108_ & (x21 | (~new_n103_ & ~new_n107_)));
  assign new_n103_ = ~x09 & ~x15 & (new_n105_ | new_n106_ | (~new_n104_ & x04));
  ...
  assign new_n143_ = ~x05 & ~x08 & ~x15 & ~new_n144_ & (~x14 | ~x21);
  ...
  assign z20 = ~x07 & ~x17 & (new_n152_ | new_n159_);
  assign new_n152_ = ~x15 & (new_n156_ | (x18 & (new_n158_ | (~new_n153_ & ~x09))));
  ...
  assign new_n156_ = new_n157_ & x04 & ~x05 & ~x09;
  assign new_n157_ = x12 & ~x14 & ~x18 & ~x21;
  ...
  assign z23 = (x17 & ~x18) | (new_n62_ & ~x05 & x09 & ~x15 & ~x17 & x18);
  assign z24 = z13 | (~x09 & (new_n171_ | (~new_n167_ & ~x07)));
  ...
  assign z28 = ~x17 & (new_n193_ | (x18 & (new_n182_ | new_n191_)));
  ...
  assign new_n193_ = ~x05 & x07 & ~x09 & x15 & ~new_n67_ & ~x18;
  assign z15 = z13;
  assign z19 = z13;
endmodule
