...
module FAU ( 
  ...
  assign new_n120_ = (x17 | ~x18 | new_n121_ | x21) & (~new_n102_ | ~x15 | ~x17 | x18);
  assign new_n121_ = ~new_n122_ & ~new_n126_ & (x05 | (~new_n90_ & ~new_n124_ & ~new_n98_));
  ...
  assign new_n142_ = (x07 | ((x08 | ~new_n143_ | x15) & (~new_n127_ | ~x00 | ~x15))) & (~new_n127_ | ~x07 | x15);
  ...
  assign new_n154_ = x08 & x10 & ~x12 & ~x14 & ~new_n138_ & ~x21;
  ...
  assign new_n159_ = (new_n160_ | x07) & x18 & (x05 | ~x07 | ~x08 | ~x15);
  assign new_n160_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  ...
  assign new_n171_ = new_n172_ & x03 & ~x05 & ~x07 & x08;
