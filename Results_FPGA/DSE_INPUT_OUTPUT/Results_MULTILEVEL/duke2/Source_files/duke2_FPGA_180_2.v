...
module FAU ( 
  ...
  assign z01 = (~x05 & (new_n56_ | new_n64_)) | new_n62_ | z13;
  ...
  assign new_n68_ = (x07 | new_n69_ | x08) & (~x05 | (x08 ? ~x21 : x07));
  ...
  assign new_n75_ = (~x07 | (~x05 ^ x15)) & (x15 | (x05 ? (x04 & x12) : x07)) & (x05 | new_n70_ | ~x15);
  ...
  assign z09 = ~x17 & (new_n106_ | new_n114_);
  ...
  assign z16 = (x17 & ~x18) | (x08 & ~x17 & x18 & (x05 ? new_n138_ : ~new_n134_));
  ...
  assign new_n176_ = x08 & x09 & ~x15 & x19;
  ...
  assign new_n187_ = x07 & ~x09 & ~new_n70_ & x15;
  assign z15 = z13;
  assign z19 = z13;
endmodule
