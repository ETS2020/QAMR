...
module FAU ( 
  ...
  assign new_n111_ = (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09);
  assign z11 = new_n113_ & ~x18;
  assign new_n113_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n62_ | (~x09 & (new_n92_ | (~x07 & (new_n115_ | new_n118_))));
  assign new_n115_ = ~x17 & x18 & ~x21 & (new_n86_ | (~new_n116_ & ~x05));
  assign new_n116_ = ~new_n83_ & (~x08 | x10 | x13 | x14) & (new_n117_ | x08);
  assign new_n117_ = (x06 | (x04 ^ ~x12)) & (~x02 | ~x06 | x11);
  assign new_n118_ = x00 & ~x05 & x15 & x17;
  assign z13 = new_n62_ | (new_n120_ & ~x09);
  assign new_n120_ = x17 & ((~x05 & (~x18 | (x00 & ~x07 & x15))) | (~x07 & ~x18));
  assign z14 = (~x15 & ~new_n122_ & ~x17) | (new_n126_ & ~x05);
  ...
  assign z16 = x18 & (x15 | (x08 & ~new_n129_ & ~x17));
  assign new_n129_ = x05 ? (~x09 | (~x07 & x12)) : (x07 | (x09 ? x19 : ~new_n130_));
  assign new_n130_ = ~x14 & ~x21 & ((~new_n131_ & ~new_n132_) | (~new_n133_ & x12));
  assign new_n131_ = x10 & (~x04 | x12);
  assign new_n132_ = (~x02 | ~x06) & x13 & (x02 | ~x11);
  assign new_n133_ = ((x13 & (x02 | ~x11)) | (~x06 ^ x16)) & (~x06 | x10 | ~x11);
  assign z17 = ~x05 & ~new_n135_ & ~x09;
  assign new_n135_ = (x07 | ((x08 | ~new_n136_ | x15) & (~new_n91_ | ~x00 | ~x15))) & (~new_n91_ | ~x07 | x15);
  assign new_n136_ = ~x17 & x18 & ~new_n137_ & (~x21 | (~x14 & x21));
  assign new_n137_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = ~x05 & ~x07 & new_n139_ & ~x09;
  assign new_n139_ = ~x14 & ~x15 & ~x17 & x18 & (new_n74_ | new_n140_);
  assign new_n140_ = x12 & ((~new_n142_ & ~x06) | (new_n141_ & x06 & x08 & x10));
  ...
  assign new_n146_ = ~x06 & ~x08 & ~new_n60_ & (~x04 ^ ~x12);
  assign new_n147_ = x08 & x10 & ~x12 & ~x14 & ~new_n87_ & ~x21;
  assign new_n148_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n149_ = new_n150_ & x04 & ~x05 & ~x09;
  assign new_n150_ = ~x18 & ~x21 & x12 & ~x14;
  assign z21 = x06 & new_n152_ & ~x07;
  assign new_n152_ = ~x15 & ~x17 & x18 & (x05 ? (~x08 & ~x09) : (x08 & x09));
  assign z22 = x18 & (x15 | (new_n154_ & ~x07));
  assign new_n154_ = ~x17 & ((~x05 & x08 & x09) | (x05 & x06 & ~x08 & ~x09 & ~x15));
  assign z23 = x18 & (x15 | (new_n56_ & x08 & x09 & ~x17));
  assign z24 = new_n62_ | (~x09 & ~x17 & (new_n159_ | (~new_n157_ & ~x07)));
  assign new_n157_ = (~x04 | new_n158_ | x21) & (x05 | x08 | ~x18);
  assign new_n158_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x15 | x18 | x05 | ~x12);
  assign new_n159_ = new_n93_ & x01 & x08 & ~x15 & ~x18;
  assign z26 = ~x20 & ~new_n62_ & (x14 | x21);
  assign z27 = (~new_n162_ & ~x09) | (new_n165_ & new_n166_ & x09 & ~x15);
  assign new_n162_ = (x15 | ((x17 | new_n163_ | ~x18) & (~new_n93_ | ~x17 | x18))) & (~new_n164_ | ~x15 | ~x17 | x18);
  assign new_n163_ = x05 ? (~x19 | (~x07 ^ ~x08)) : (x07 | x08 | new_n137_ | x21);
  assign new_n164_ = new_n56_ & x00;
  assign new_n165_ = x03 & ~x05 & ~x07 & x08;
  assign new_n166_ = ~x17 & x18 & x19;
  ...
  assign new_n170_ = x11 & ~x14 & x18 & x21;
