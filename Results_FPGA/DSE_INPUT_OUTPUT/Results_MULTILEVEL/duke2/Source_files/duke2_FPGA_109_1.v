...
module FAU ( 
  ...
  assign z09 = ~x07 & ((~x05 & (new_n78_ | new_n80_)) | (~new_n82_ & ~x09));
  assign new_n78_ = x02 & new_n79_ & x08;
  assign new_n79_ = ~x11 & x15 & ~x17 & x18 & (x09 | ~x21);
  assign new_n80_ = new_n81_ & x04 & ~x09 & x12;
  assign new_n81_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n82_ = (x15 | ~x17 | x18) & (~x05 | ~x08 | ~x15 | x17 | ~x18 | ~x21);
  ...
  assign z12 = (~x15 & x18) | (~x09 & (new_n88_ | (new_n92_ & ~x15 & x17)));
  assign new_n88_ = ~x07 & ((new_n90_ & new_n91_) | ((new_n73_ | new_n89_) & ~x05));
  ...
  assign new_n95_ = (x09 | x18 | (~x07 & ~x17)) & (~x08 | x17 | new_n96_ | ~x18);
  ...
  assign new_n103_ = new_n60_ & ~x11 & x15 & new_n61_ & ~x17;
  ...
  assign new_n109_ = new_n90_ & ~x11 & x15 & x18;
  assign new_n110_ = x04 & ~x05 & x12 & ~x14 & ~x15 & ~x18;
  assign z21 = ~x05 & new_n112_ & ~x09;
  assign new_n112_ = x15 & ~x17 & x18 & ((x07 & x08) | (~x06 & ~x07 & ~x08));
  assign z22 = x18 & (new_n114_ | ~x15);
  assign new_n114_ = ~x05 & ~x17 & ((x07 & x08) | (~x08 & ~x09 & x06 & ~x07));
  assign z24 = z23 | (~x09 & ~x17 & (new_n120_ | (~new_n116_ & ~x05)));
  ...
  assign z28 = (~new_n127_ & ~x05) | z23 | (~x07 & ~new_n131_ & ~x09);
  assign new_n127_ = ~new_n130_ & (x17 | (~new_n129_ & (new_n128_ | (x02 & x11))));
  assign new_n128_ = (~x08 | ~x18) & (~x15 | x18 | ~x07 | x09);
