...
module FAU ( 
  ...
  assign new_n120_ = ~new_n121_ & ~new_n125_ & (x05 | (~new_n97_ & ~new_n123_ & ~new_n99_));
  ...
  assign new_n125_ = x04 & x08 & ~x12 & ~new_n101_ & ~x15;
  ...
  assign z20 = z19 | (~x07 & (new_n154_ | (~new_n148_ & ~x15)));
  assign new_n148_ = ~new_n152_ & (x17 | ~x18 | (~new_n153_ & (new_n149_ | x09)));
  ...
  assign new_n152_ = x04 & ~x05 & ~x09 & new_n55_ & ~x18 & ~x21;
  ...
  assign z24 = z19 | (~x09 & (new_n167_ | (~new_n163_ & ~x07)));
  ...
  assign new_n173_ = ~x21 & (new_n121_ | new_n174_);
  ...
  assign new_n186_ = x07 & ~x09 & ~new_n68_ & x15;
  assign z13 = 1'b0;
  assign z15 = 1'b0;
endmodule
