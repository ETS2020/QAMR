...
module FAU ( 
  ...
  assign z03 = (~new_n78_ & ~x09) | (~x17 & (new_n79_ | x20));
  ...
  assign new_n82_ = ~x17 & x18 & ~x20 & (new_n88_ | new_n83_ | new_n86_);
  ...
  assign new_n87_ = new_n85_ & x08 & ~x13 & ~x16 & ~x21;
  assign new_n88_ = ~new_n89_ & x02;
  assign new_n89_ = (x11 | ~x21 | ~x06 | x08) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign z06 = new_n108_ | (~x09 & (new_n107_ | (~x07 & (new_n91_ | new_n105_))));
  assign new_n91_ = ~x17 & x18 & (new_n103_ | (~x05 & (new_n92_ | new_n100_)));
  assign new_n92_ = ~x21 & (new_n93_ | new_n99_ | (~x15 & (new_n95_ | new_n97_)));
  assign new_n93_ = x04 & ~new_n94_ & ~x12;
  assign new_n94_ = (~x11 | x14 | x02 | ~x08) & (x06 | x08 | x15);
  assign new_n95_ = x06 & ((~x02 & ~x08 & x11) | (new_n96_ & new_n85_ & x08));
  assign new_n96_ = ~x13 & ~x14 & x16 & ~x20;
  assign new_n97_ = x08 & ~x14 & ((new_n98_ & ~x06) | (~x10 & ~x13));
  assign new_n98_ = ~x20 & ((x02 & ~x10 & x13) | (~x13 & ~x16 & x10 & x12));
  assign new_n99_ = ~x02 & x08 & x11 & (x15 | (~x10 & ~x14));
  assign new_n100_ = ~x08 & new_n101_ & ~x14;
  assign new_n101_ = ~x15 & (new_n102_ | (~x02 & x06 & x11));
  ...
  assign z07 = ~x17 & (x20 | (~new_n110_ & x18));
  assign new_n110_ = (x05 | x07 | ~x08 | ~x09 | x15 | ~x16) & (x09 | (~x07 ^ ~x08) | (~x05 ^ x15));
  assign z08 = x14 & ~x20;
  assign z09 = new_n122_ | (~x17 & (x20 | (~new_n113_ & x18)));
  ...
  assign z10 = z13 | (~x17 & (x20 | (~new_n125_ & x18)));
  assign new_n125_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = ~x17 & (new_n128_ | x20);
  assign new_n128_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x18;
  assign z12 = ~x09 & (new_n107_ | (~new_n130_ & ~x07));
  assign new_n130_ = ~new_n105_ & (x17 | ~x18 | x20 | new_n131_ | x21);
  assign new_n131_ = ~new_n132_ & ~new_n136_ & (x05 | (~new_n93_ & ~new_n134_ & ~new_n99_));
  ...
  assign z15 = new_n108_ | (new_n106_ & ~x15 & x05 & ~x07 & ~x09);
  ...
  assign z20 = ~x07 & ~x17 & ~x20 & (new_n171_ | (~new_n165_ & ~x15));
  ...
  assign z24 = ~x09 & ~x17 & ~x20 & (new_n180_ | new_n184_);
  ...
  assign z26 = x20 ? ~x17 : (x14 | x21);
  assign z27 = new_n194_ | (~x09 & (new_n196_ | (~x17 & new_n189_ & x18)));
  assign new_n189_ = ~x20 & (x07 ? new_n193_ : ~new_n190_);
  assign new_n190_ = ~new_n192_ & (x21 | (~new_n132_ & ~new_n191_));
  ...
  assign new_n195_ = ~x15 & ~x17 & x18 & x19 & ~x20;
  assign new_n196_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n198_ | ~new_n208_)) | (~x09 & new_n210_ & x17);
  ...
  assign new_n208_ = ~x20 & (x05 | ~new_n209_ | ~x07);
