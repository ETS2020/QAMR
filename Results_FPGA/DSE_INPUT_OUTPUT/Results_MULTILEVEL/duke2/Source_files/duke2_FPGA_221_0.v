...
module FAU ( 
  ...
  assign z12 = ~x09 & (new_n104_ | (~x07 & (new_n102_ | (new_n124_ & ~x17))));
  ...
  assign new_n130_ = x07 ? (new_n108_ | x19) : (new_n61_ | new_n131_);
  ...
  assign z17 = ~x09 & ((~new_n141_ & ~x05) | (new_n144_ & new_n107_ & ~x04 & x05));
  ...
  assign new_n146_ = (x14 | x15 | (~new_n147_ & ~new_n150_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n151_ = (x04 | x08 | ~x18 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  ...
  assign z27 = new_n173_ | (new_n178_ & new_n107_ & x03 & ~x05);
