...
module FAU ( 
  ...
  assign z06 = z11 | (~x09 & (new_n106_ | (~new_n89_ & ~x07)));
  ...
  assign z12 = (~x17 & ~x18) | (~x09 & (new_n125_ | (new_n107_ & ~x15 & x17 & ~x18)));
  assign new_n125_ = ~x07 & (new_n131_ | (~x17 & (~new_n126_ | new_n129_) & ~x21));
  assign new_n126_ = ~new_n128_ & (x05 | (~new_n91_ & ~new_n98_ & (new_n127_ | x15)));
  assign new_n127_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n104_ | ~x08 | x10);
  assign new_n128_ = x04 & x08 & ~x12 & ~x15 & (new_n104_ | x05);
  ...
  assign new_n153_ = (new_n154_ | ~x12) & (~x02 | (~new_n82_ & ~new_n156_));
  assign new_n154_ = (x06 | (~new_n155_ & (~new_n87_ | ~x08 | ~x10))) & (~new_n85_ | ~x06 | ~x08 | ~x10);
  assign new_n155_ = x18 & x21 & ~x04 & ~x08;
  assign new_n156_ = x06 & ~x08 & ~x11 & x18 & x21;
  assign z19 = ~x18 & x17 & new_n75_ & ~x09 & ~x15;
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n62_ | (~new_n159_ & ~x15))));
  ...
  assign new_n187_ = (~x15 | x19) & (~new_n101_ | x14 | x15 | ~x21);
