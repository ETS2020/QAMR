...
module FAU ( 
  ...
  assign z15 = (x18 & ~x20) | (new_n105_ & new_n139_ & x05);
  ...
  assign new_n172_ = new_n173_ & new_n157_ & ~x11 & x15;
  assign new_n173_ = x08 & ~x09 & ~x04 & x05;
  assign z21 = x18 & (~x20 | (~new_n175_ & ~x17));
  assign new_n175_ = (new_n176_ | x07) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign new_n176_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x20);
  ...
  assign new_n192_ = ~x21 & (new_n129_ | new_n193_);
  ...
  assign z28 = (~new_n198_ & ~x17) | (x18 & ~x20) | (~x09 & x17 & ~new_n211_ & ~x18);
