...
module FAU ( 
  ...
  assign new_n92_ = ~x07 & (new_n105_ | (x18 & (new_n103_ | (~new_n93_ & ~x05))));
  ...
  assign new_n121_ = ~x18 & (x17 | (new_n122_ & x12 & x04 & ~x05));
  ...
  assign new_n128_ = ~x07 & (new_n135_ | (x18 & (~new_n129_ | new_n133_) & ~x21));
  ...
  assign z17 = ~x09 & (new_n151_ | (new_n156_ & new_n155_ & ~x07 & x08));
  ...
  assign new_n169_ = new_n170_ & new_n155_ & x08 & ~x09;
  ...
  assign new_n188_ = new_n79_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n189_ = ~x05 & x17 & ((x07 & ~x15) | (x00 & ~x07 & x15));
