...
module FAU ( 
  ...
  assign z06 = z11 | (~x09 & (new_n105_ | (~x07 & (new_n89_ | new_n104_))));
  assign new_n89_ = ~x17 & (new_n101_ | (~x05 & (new_n98_ | (~new_n90_ & ~x21))));
  assign new_n90_ = ~new_n91_ & ~new_n97_ & (x15 | (~new_n95_ & (new_n93_ | ~x06)));
  assign new_n91_ = x04 & ~new_n92_ & ~x12;
  assign new_n92_ = (x06 | x08 | x15) & (x02 | ~x08 | ~x11 | x14);
  assign new_n93_ = (~new_n94_ | ~new_n84_ | ~x08) & (x02 | x08 | ~x11);
  ...
  assign new_n105_ = ~x05 & x07 & ~x15 & ~x18;
  assign z07 = ~x17 & (~new_n107_ | (~x09 & ~new_n109_ & (~x07 ^ x08)));
  assign new_n107_ = x18 & (~new_n108_ | x05 | x07 | ~x08);
  assign new_n108_ = x09 & ~x15 & x16;
  ...
  assign z12 = z11 | (~x09 & (new_n126_ | new_n105_));
  assign new_n126_ = ~x07 & (new_n104_ | (~x17 & ~x21 & (~new_n127_ | new_n130_)));
  assign new_n127_ = ~new_n129_ & (x05 | (~new_n91_ & ~new_n97_ & (new_n128_ | x15)));
  assign new_n128_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n103_ | ~x08 | x10);
  assign new_n129_ = x04 & x08 & ~x12 & ~x15 & (new_n103_ | x05);
  ...
  assign new_n134_ = x07 ? (new_n109_ | x19) : (new_n61_ | new_n135_);
  ...
  assign z17 = z11 | (~x09 & (new_n148_ | (~new_n145_ & ~x05)));
  ...
  assign new_n148_ = new_n149_ & ~x07 & x08 & ~x04 & x05;
  assign new_n149_ = ~x11 & x15 & ~x17 & ~x21;
  ...
  assign new_n163_ = (new_n164_ | x07) & x18 & (x05 | ~x07 | ~x08 | ~x15);
  assign new_n164_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & (new_n76_ | new_n124_) & x18;
  ...
  assign z28 = (~x17 & ~new_n178_ & x18) | (~x09 & x17 & ~new_n188_ & ~x18);
  assign new_n178_ = ~new_n186_ & (x05 | (new_n179_ & (new_n184_ | x02)));
  assign new_n179_ = (~new_n183_ | ~x08) & (x07 | x09 | (x08 ? ~new_n181_ : new_n180_));
  assign new_n180_ = (~x15 | x19) & (~new_n100_ | x14 | x15 | ~x21);
