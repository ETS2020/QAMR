...
module FAU ( 
  ...
  assign z06 = z11 | (~x09 & (new_n104_ | (~x07 & (new_n88_ | new_n103_))));
  ...
  assign new_n104_ = ~x05 & x07 & ~x15 & ~x18;
  ...
  assign z12 = z11 | (~x09 & (new_n121_ | new_n104_));
  assign new_n121_ = ~x07 & (new_n103_ | (~x17 & ~x21 & (~new_n122_ | new_n125_)));
  ...
  assign new_n140_ = (new_n141_ | x05) & (~new_n145_ | x07 | ~x08 | x04 | ~x05);
  assign new_n141_ = (x07 | ((x08 | ~new_n142_ | x15) & (~new_n144_ | ~x00 | ~x15))) & (~new_n144_ | ~x07 | x15);
  ...
  assign new_n148_ = (new_n149_ | ~x12) & (~x02 | (~new_n81_ & ~new_n151_));
  assign new_n149_ = (x06 | (~new_n150_ & (~new_n86_ | ~x08 | ~x10))) & (~new_n84_ | ~x06 | ~x08 | ~x10);
  assign new_n150_ = ~x04 & ~x08 & x18 & x21;
  assign new_n151_ = x06 & ~x08 & ~x11 & x18 & x21;
  assign z19 = ~x18 & (~x17 | (new_n153_ & ~x09 & ~x15));
  ...
  assign new_n161_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | ~x18))) & (x09 | x15 | ~x18 | ~x05 | ~x06 | x08);
  assign new_n162_ = x18 & (x05 | ~x07 | ~x08 | x09 | ~x15 | ~x18);
  assign z22 = ~x17 & ~new_n164_ & x18;
  assign new_n164_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = ~x17 & (~x18 | (new_n153_ & x08 & x09 & ~x15));
  ...
  assign new_n174_ = (new_n125_ | new_n175_) & ~x21;
  ...
  assign new_n181_ = (~x15 | x19) & (~new_n99_ | x14 | x15 | ~x21);
