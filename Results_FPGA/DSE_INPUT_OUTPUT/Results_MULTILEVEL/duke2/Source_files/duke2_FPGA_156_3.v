...
module FAU ( 
  ...
  assign z03 = (~new_n77_ & ~x09) | (new_n78_ & ~x05 & new_n79_ & x09 & ~x15);
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n91_ | (new_n105_ & ~x15 & x17)));
  assign new_n91_ = ~x07 & (new_n104_ | (x18 & (new_n102_ | (~new_n92_ & ~x15))));
  assign new_n92_ = ~new_n99_ & (x21 | (~new_n93_ & ~new_n101_ & (new_n95_ | ~x08)));
  ...
  assign new_n99_ = ~x05 & ~x08 & ~x14 & new_n100_ & ~x17;
  ...
  assign new_n104_ = x15 & x17 & x00 & ~x05;
  ...
  assign new_n138_ = new_n139_ & x15 & x00 & ~x05;
  ...
  assign z17 = ~x09 & ((~new_n156_ & ~x05) | (new_n159_ & new_n78_ & ~x04 & x05));
  assign new_n156_ = (x07 | ((x08 | ~new_n157_ | x15) & (~new_n139_ | ~x00 | ~x15))) & (~new_n139_ | ~x07 | x15);
  ...
  assign new_n168_ = ~x06 & ~x08 & ~new_n89_ & (~x14 | ~x21);
  ...
  assign z22 = x18 & (new_n178_ | x17 | (new_n105_ & x08 & x15));
  ...
  assign new_n185_ = new_n105_ & x01 & x08 & ~x15 & ~x18;
  ...
  assign new_n193_ = new_n56_ & x03 & x08 & x09 & ~x15 & x19;
