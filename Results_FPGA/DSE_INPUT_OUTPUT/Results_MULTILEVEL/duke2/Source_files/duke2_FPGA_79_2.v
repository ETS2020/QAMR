...
module FAU ( 
  ...
  assign new_n80_ = x18 & x19 & ~x15 & ~x17;
  ...
  assign new_n112_ = (x07 | ((new_n113_ | x05) & (~new_n63_ | ~x05 | ~x08))) & (~x05 | ~new_n119_ | ~x08);
  ...
  assign z12 = (x18 & ~x19) | (~x09 & (new_n127_ | new_n107_));
  assign new_n127_ = ~x07 & (new_n105_ | (~x17 & x18 & ~new_n128_ & ~x21));
  assign new_n128_ = (new_n132_ | x04) & (~new_n133_ | ~x04) & (x05 | (~new_n94_ & new_n129_));
  assign new_n129_ = ~new_n102_ & (x15 | (~new_n130_ & ~new_n131_));
  ...
  assign z14 = (new_n140_ & ~x05) | (~x07 & ~new_n136_ & ~x17);
  assign new_n136_ = ~new_n137_ & (~new_n139_ | x09 | ~x12 | ~x04 | x05);
  assign new_n137_ = x08 & x18 & x19 & ~new_n63_ & ~new_n138_;
  ...
  assign new_n149_ = (x07 | ((x08 | ~new_n150_ | x15) & (~new_n106_ | ~x00 | ~x15))) & (~new_n106_ | ~x07 | x15);
  assign new_n150_ = ~x17 & x18 & x19 & ~new_n151_ & (~x21 | (~x14 & x21));
  ...
  assign new_n155_ = x19 & ((~x08 & x15) | (~x14 & ~x15 & (new_n84_ | new_n156_)));
  assign new_n156_ = x12 & ((~new_n157_ & ~x06) | (new_n88_ & x06 & x08 & x10));
  assign new_n157_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = (~x07 & ~new_n160_ & ~x17) | (x18 & ~x19);
  assign new_n160_ = ~new_n167_ & (x15 | ((new_n161_ | x09) & (~new_n166_ | ~x04)));
  ...
  assign new_n165_ = x12 & ~x14 & ~x21 & (~x18 | ~x19);
  assign new_n166_ = x05 & x08 & ~x12 & ~new_n63_ & x18;
  ...
  assign new_n186_ = ~x21 & ((~new_n187_ & ~x04) | (new_n188_ & x02 & x06));
  assign new_n187_ = (x11 | ~x15 | ~x05 | ~x08) & (~x12 | x15 | x06 | x08);
  assign new_n188_ = ~x08 & ~x11 & ~x15;
  assign new_n189_ = x19 & (~new_n190_ | ~x03 | x05 | x07);
  assign new_n190_ = ~x15 & ~x17 & x08 & x09;
  assign new_n191_ = ~x05 & x17 & ~x18 & ((x00 & ~x07 & x15) | (x07 & ~x15));
  assign z28 = new_n205_ | (~x17 & (new_n203_ | (x18 & ~new_n193_ & x19)));
  assign new_n193_ = ~new_n201_ & (x05 | (~new_n194_ & ~new_n199_ & (new_n197_ | x02)));
  assign new_n194_ = x08 & ((new_n195_ & ~x07) | (x15 & (x07 | ~x11)));
  ...
  assign new_n199_ = new_n200_ & ~x07 & ~x08 & x04 & ~x06;
  assign new_n200_ = ~x09 & ~x12 & ~x14 & ~x15 & x21;
