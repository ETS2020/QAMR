...
module FAU ( 
  ...
  assign z05 = ~x15 & x18;
  assign z01 = x15 & ~x17 & (new_n59_ | (~x05 & ~new_n62_ & x11));
  assign new_n59_ = new_n60_ & new_n61_ & ~x09 & ~x11;
  assign new_n60_ = ~x04 & x05 & ~x07 & x08;
  assign new_n61_ = x18 & ~x21;
  assign new_n62_ = (x02 | x07 | ~x08 | ~x18 | (~x09 & x21)) & (~x02 | ~x07 | x09 | x18);
  ...
  assign new_n67_ = ~x07 & x11 & (x02 | x07 | ~x11 | ~x15 | (~x09 & x21));
  ...
  assign new_n74_ = x07 ? (x15 | ~x17) : (~new_n75_ & (~x17 | x18 | ~x00 | ~x15));
  ...
  assign z12 = ~x09 & (new_n92_ | (~x07 & (new_n90_ | new_n91_) & x15));
  assign new_n90_ = ~x05 & (new_n75_ | (x00 & x17 & ~x18));
  assign new_n91_ = ~x04 & x05 & x08 & new_n61_ & ~x11 & ~x17;
  ...
  assign z16 = ~x05 & new_n102_ & x08;
  assign new_n102_ = x09 & x15 & ~x17 & x18 & (~x02 | x07);
  ...
  assign new_n121_ = ~x04 & x05 & ~x07 & new_n61_ & x08 & ~x11;
