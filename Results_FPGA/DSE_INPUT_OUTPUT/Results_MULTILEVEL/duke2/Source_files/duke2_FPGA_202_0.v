...
module FAU ( 
  ...
  assign z06 = new_n67_ | (~x09 & (new_n105_ | (~new_n93_ & ~x07)));
  ...
  assign new_n105_ = ~x05 & x07 & new_n106_ & ~x15;
  ...
  assign new_n120_ = x20 & (x07 | x09 | new_n121_ | x15);
  ...
  assign z11 = x20 & new_n126_ & ~x18;
  assign new_n126_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n67_ | (~x09 & (new_n105_ | (~new_n128_ & ~x07)));
  assign new_n128_ = (~x00 | x05 | ~x15 | ~x17 | x18) & (x17 | ~new_n129_ | ~x18);
  ...
  assign z17 = new_n67_ | (~x09 & (new_n159_ | (~new_n156_ & ~x05)));
  assign new_n156_ = (x07 | ((x08 | ~new_n157_ | x15) & (~new_n106_ | ~x00 | ~x15))) & (~new_n106_ | ~x07 | x15);
  ...
  assign z20 = new_n67_ | (~x07 & ~x17 & (new_n172_ | (~new_n166_ & ~x15)));
  ...
  assign z24 = new_n67_ | (~x09 & ~x17 & (new_n180_ | new_n184_));
  ...
  assign new_n190_ = ~x21 & (new_n130_ | new_n191_);
  ...
  assign new_n207_ = x07 & ~x09 & x15 & ~x18 & ~new_n72_ & x20;
