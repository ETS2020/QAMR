...
module FAU ( 
  ...
  assign new_n115_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  ...
  assign new_n164_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = (x17 & ~x18) | (new_n63_ & ~x05 & ~x17 & x18 & x09 & ~x15);
  assign z24 = z19 | (~x09 & (new_n171_ | (~new_n167_ & ~x07)));
  ...
  assign z28 = ~x17 & ((new_n192_ & ~x05) | (x18 & (new_n190_ | (~new_n182_ & ~x05))));
