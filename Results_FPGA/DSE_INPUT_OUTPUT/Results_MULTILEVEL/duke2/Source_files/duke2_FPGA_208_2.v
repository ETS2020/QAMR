...
module FAU ( 
  ...
  assign new_n54_ = ~x17 & (~new_n55_ | ~x04 | x05 | x07 | x09);
  assign new_n55_ = x12 & ~x14 & ~x15 & ~x21;
  assign z01 = ~new_n57_ & ~x17;
  assign new_n57_ = (new_n58_ | x05) & (~new_n64_ | x04 | ~x05 | x07 | ~x08);
  ...
  assign z09 = z00 | (new_n106_ & ~x17);
  assign new_n106_ = x18 & ((new_n113_ & x05) | (~x07 & (x05 ? new_n112_ : ~new_n107_)));
  assign new_n107_ = (x21 | ((x09 | new_n108_ | x15) & (~new_n111_ | x11 | ~x15))) & (~new_n111_ | ~x09 | x11 | ~x15);
  assign new_n108_ = (new_n109_ | ~x04) & (~new_n110_ | ~x02) & (~new_n92_ | x02 | ~x06);
  ...
  assign new_n124_ = x04 & x08 & ~x12 & ~new_n101_ & ~x15;
  ...
  assign z17 = (x17 & ~x18) | (~x07 & ~x09 & ~x17 & (new_n139_ | new_n141_) & x18);
  ...
  assign new_n158_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n160_ & x08;
  assign new_n160_ = ~x05 & ~x07;
  assign z24 = z13 | (~x09 & (new_n166_ | (~new_n162_ & ~x07)));
  assign new_n162_ = ~new_n163_ & (x05 | x08 | x15 | x17 | ~x18);
  assign new_n163_ = ~x21 & ((x04 & ~new_n164_ & ~x15) | (x08 & new_n165_ & x15));
  assign new_n164_ = (~x05 | ~x08 | x12 | x17 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n165_ = ~x17 & x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  ...
  assign new_n172_ = (new_n120_ | new_n173_) & ~x21;
  ...
  assign new_n178_ = (~new_n179_ | ~x06 | x07 | x08 | x09) & (~x08 | ~x15);
  assign new_n179_ = x11 & ~x14 & ~x15 & x21;
  assign new_n180_ = ~x09 & (x08 ? (x10 & new_n182_ & x12) : ~new_n181_);
  assign new_n181_ = (~x15 | x19) & (~new_n96_ | x14 | x15 | ~x21);
  ...
  assign new_n185_ = x07 & ~x09 & ~new_n68_ & x15;
  assign z15 = z13;
  assign z19 = z13;
endmodule
