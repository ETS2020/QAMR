...
module FAU ( 
  ...
  assign z03 = new_n79_ | new_n82_ | (~new_n81_ & ~x09);
  ...
  assign z04 = ~x14 & ~x20;
  assign z05 = new_n82_ | (~x05 & ~x07 & ~x09 & new_n85_ & ~x14);
  ...
  assign new_n133_ = x08 & ~x12 & ~x15 & (new_n105_ | x05);
  assign new_n134_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign z13 = ~x09 & x17 & ~x18 & ~new_n125_ & ~x20;
  ...
  assign z18 = new_n82_ | (~x05 & ~x07 & ~x09 & new_n157_ & ~x17);
  ...
  assign z20 = new_n82_ | (~x07 & ~x17 & (new_n170_ | (~new_n163_ & ~x15)));
  ...
  assign z22 = (~x18 & x20) | (~x17 & ~new_n175_ & x18);
  ...
  assign z24 = new_n82_ | (~x09 & ~x17 & (new_n178_ | new_n182_));
  ...
  assign new_n190_ = ~new_n82_ & (~new_n191_ | ~x03 | x05 | x07 | ~x08);
  assign new_n191_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n192_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n194_ | new_n205_)) | (~x09 & new_n207_ & x17);
  ...
  assign new_n205_ = ~x05 & x07 & new_n206_ & ~x09;
  assign new_n206_ = x15 & ~x18 & ~x20 & (~x02 | ~x11);
  assign new_n207_ = ~x18 & ~x20 & ((~x07 & (x05 | x15)) | (~x05 & x15 & ~x19));
endmodule
