...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n69_, new_n71_, new_n73_, new_n74_, new_n75_, new_n80_, new_n82_,
    new_n85_, new_n86_;
  ...
  assign z14 = ~x05 & ~x09 & ~new_n73_ & ~x18;
  assign new_n73_ = (~x15 | (~x07 & ~x17)) & (~new_n74_ | ~new_n75_) & (~x07 | (x01 & ~x17));
  ...
  assign new_n80_ = ~x18 & (~new_n55_ | ~x04 | x05 | x07 | x09);
