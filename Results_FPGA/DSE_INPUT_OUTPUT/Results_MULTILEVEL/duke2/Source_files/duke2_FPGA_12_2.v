...
module FAU ( 
  ...
  assign z01 = (~x05 & (new_n56_ | new_n63_)) | new_n61_ | z15;
  assign new_n56_ = ~x07 & ~x17 & x18 & (new_n60_ | (~new_n57_ & ~x09));
  ...
  assign z14 = ~x17 & ((new_n134_ & ~x05) | (new_n131_ & x08));
  assign new_n131_ = x18 & (x07 ? new_n133_ : (~new_n132_ & (x09 | ~x21)));
  assign new_n132_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n133_ = ~x19 & (~x05 ^ ~x15);
  assign new_n134_ = ~x09 & ~x18 & (new_n135_ | (x07 & (~x01 | x15)));
  ...
  assign z20 = z15 | (~x07 & (new_n160_ | (~new_n153_ & ~x15)));
  assign new_n153_ = ~new_n157_ & (x17 | ~x18 | (~new_n159_ & (new_n154_ | x09)));
  ...
  assign new_n160_ = new_n62_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign z22 = x17 ? ~x18 : (~new_n164_ & x18);
