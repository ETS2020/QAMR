...
module FAU ( 
  ...
  assign new_n86_ = (~new_n87_ | ~new_n88_) & (~x11 | ~x21 | x02 | x08);
  assign new_n87_ = x08 & x10 & x12;
  assign new_n88_ = ~x13 & x16 & ~x21;
  assign new_n89_ = (x08 | new_n90_ | ~x21) & (~new_n87_ | x13 | x16 | x21);
  assign new_n90_ = ~x04 ^ x12;
  assign z06 = new_n81_ | (~x09 & ((~new_n92_ & ~x07) | (new_n109_ & ~x05 & x07)));
  assign new_n92_ = ~new_n107_ & (~x18 | (~new_n105_ & (x05 | (~new_n93_ & ~new_n102_))));
  ...
  assign z09 = (new_n114_ & ~x17) | (~x07 & ~x09 & new_n122_ & ~x15);
  assign new_n114_ = x18 & ((new_n121_ & x05) | (~x07 & (x05 ? new_n120_ : ~new_n115_)));
  assign new_n115_ = (x21 | ((~new_n119_ | x11 | ~x15) & (x09 | new_n116_ | x15))) & (~new_n119_ | ~x09 | x11 | ~x15);
  ...
  assign new_n122_ = ~x18 & (x17 | (new_n123_ & x04 & ~x05));
  assign new_n123_ = x12 & ~x14 & ~x21;
  assign z10 = (~new_n125_ & x18) | (~x09 & x17 & (~x05 | ~x07));
  assign new_n125_ = ~new_n126_ & ~x17 & (~new_n127_ | x05 | x06 | x07);
  assign new_n126_ = ~x15 & ((x05 & ((x07 & x08) | (~x08 & ~x09 & ~x06 & ~x07))) | (~x05 & ~x07 & x08 & x09));
  assign new_n127_ = ~x08 & ~x09 & x15;
  assign z11 = new_n129_ & ~x18;
  assign new_n129_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n131_ & ~x07) | (new_n139_ & ~x05 & x07));
  assign new_n131_ = (x17 | ~x18 | new_n132_ | x21) & (~new_n108_ | ~x15 | ~x17 | x18);
  assign new_n132_ = ~new_n133_ & ~new_n137_ & (x05 | (~new_n94_ & ~new_n135_ & ~new_n101_));
  ...
  assign z17 = new_n81_ | (~new_n156_ & ~x09);
  ...
  assign new_n160_ = x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n177_ = (new_n178_ | x07) & ~x17 & (~x08 | ~x15 | x05 | ~x07);
  assign new_n178_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n79_ | new_n127_);
