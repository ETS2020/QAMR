...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n90_ | (~x07 & (new_n93_ | (new_n81_ & ~x15))));
  ...
  assign z10 = (x18 & (x15 | (~new_n109_ & ~x17))) | (~x09 & x17 & ~new_n108_ & ~x18);
  ...
  assign z12 = new_n71_ | (~x09 & (new_n90_ | (~new_n112_ & ~x07)));
  assign new_n112_ = ~new_n116_ & (x17 | ~x18 | x21 | (~new_n86_ & ~new_n113_));
  assign new_n113_ = ~x05 & (new_n83_ | (~new_n114_ & ~x08) | (new_n115_ & x08 & ~x10));
  assign new_n114_ = (x06 | (x04 ^ ~x12)) & (~x02 | ~x06 | x11);
  assign new_n115_ = ~x13 & ~x14;
  assign new_n116_ = x00 & ~x05 & x15 & x17;
  assign z13 = new_n71_ | (new_n118_ & ~x09);
  assign new_n118_ = x17 & ((~x05 & (~x18 | (x00 & ~x07 & x15))) | (~x07 & ~x18));
  assign z14 = (~new_n120_ & ~x17) | new_n71_ | (new_n124_ & ~x05);
  assign new_n120_ = (~new_n121_ | ~x04) & (~new_n108_ | ~x08 | ~x18 | x19);
  ...
  assign z15 = new_n71_ | (new_n92_ & x05 & ~x07 & ~x09);
  ...
  assign z17 = new_n71_ | (~x05 & ~new_n133_ & ~x09);
  assign new_n133_ = (x07 | (~new_n134_ & (~x00 | ~x15 | ~x17))) & (~x07 | x15 | ~x17 | x18);
  assign new_n134_ = ~x08 & ~x17 & x18 & ~new_n135_ & (~x21 | (~x14 & x21));
  assign new_n135_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = x18 & (x15 | (new_n137_ & ~x05));
  assign new_n137_ = ~x07 & ~x09 & ~x14 & ~x17 & (new_n74_ | new_n138_);
  assign new_n138_ = x12 & ((~new_n140_ & ~x06) | (new_n139_ & x06 & x08 & x10));
  assign new_n139_ = ~x13 & x16 & ~x21;
  assign new_n140_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = new_n71_ | (new_n92_ & ~x05 & ~x07 & ~x09);
  assign z20 = ~x07 & ~x15 & ~x17 & (new_n147_ | (~new_n143_ & x18));
  assign new_n143_ = (x09 | ((~new_n145_ | ~x04) & (~new_n144_ | x05))) & (~x04 | ~new_n146_ | ~x05);
  assign new_n144_ = ~x06 & ~x08 & ~new_n60_ & (~x04 ^ ~x12);
  assign new_n145_ = x08 & x10 & ~x12 & ~x14 & ~new_n87_ & ~x21;
  assign new_n146_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n147_ = new_n148_ & x04 & ~x05 & ~x09;
  assign new_n148_ = ~x18 & ~x21 & x12 & ~x14;
  assign z21 = x06 & new_n150_ & ~x07;
  assign new_n150_ = ~x15 & ~x17 & x18 & (x05 ? (~x08 & ~x09) : (x08 & x09));
  assign z22 = x18 & (x15 | (new_n152_ & ~x07));
  assign new_n152_ = ~x17 & ((~x05 & x08 & x09) | (x05 & x06 & ~x08 & ~x09 & ~x15));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n56_ & x08;
  assign z24 = ~x09 & ~x15 & ~new_n155_ & ~x17;
  assign new_n155_ = (x07 | (~new_n156_ & (x05 | x08 | ~x18))) & (~x07 | ~x08 | x18 | ~x01 | x05);
  assign new_n156_ = new_n157_ & x04;
  assign new_n157_ = ~x21 & ((x05 & x08 & ~x12 & x18) | (~x14 & ~x18 & ~x05 & x12));
  assign z26 = new_n71_ | (~x20 & (x14 | x21));
  assign z27 = (~new_n160_ & ~x09) | (new_n163_ & new_n164_ & x09 & ~x15);
  assign new_n160_ = (~new_n162_ | ~x15 | ~x17 | x18) & (x15 | ((x17 | new_n161_ | ~x18) & (~new_n91_ | ~x17 | x18)));
  assign new_n161_ = x05 ? (~x19 | (~x07 ^ ~x08)) : (x07 | x08 | new_n135_ | x21);
  ...
  assign new_n168_ = x11 & ~x14 & x18 & x21;
