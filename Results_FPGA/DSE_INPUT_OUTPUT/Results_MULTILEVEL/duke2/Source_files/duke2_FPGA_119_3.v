...
module FAU ( 
  ...
  assign new_n107_ = ~x17 & (~new_n79_ | ~x09 | x15 | ~x16);
  ...
  assign new_n123_ = (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07);
  ...
  assign z14 = (x18 & (new_n142_ | x17)) | (~x05 & ~new_n145_ & ~x09);
  assign new_n142_ = x08 & (x07 ? (~new_n108_ & ~x19) : new_n143_);
  assign new_n143_ = ~new_n144_ & (x09 | ~x21);
  assign new_n144_ = (~x11 | ~x15 | x02 | x05) & (x12 | x15 | ~x04 | ~x05);
  assign new_n145_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n146_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n146_ = new_n147_ & new_n56_ & ~x15 & ~x17;
  assign new_n147_ = x04 & ~x07 & x12 & ~x14;
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x18 & (x17 | (x08 & (x05 ? new_n154_ : ~new_n150_)));
  ...
  assign z20 = new_n82_ | (~new_n168_ & ~x07);
  ...
  assign z21 = x18 & (~new_n177_ | (~new_n176_ & ~x07));
  assign new_n176_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15 | x17))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign new_n177_ = ~x17 & (x05 | ~x07 | ~x08 | x09 | ~x15 | x17);
  assign z22 = ~x17 & ~new_n179_ & x18;
  assign new_n179_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x18 & (x17 | (new_n166_ & x08 & x09 & ~x15));
  assign z24 = new_n82_ | (~x09 & (new_n182_ | new_n186_));
  assign new_n182_ = ~x07 & (new_n183_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n183_ = ~x21 & ((x04 & ~new_n184_ & ~x15) | (x08 & new_n185_ & x15));
  assign new_n184_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x17 | x18 | x05 | ~x12);
  assign new_n185_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n186_ = new_n126_ & x01 & ~x17 & ~x18 & x08 & ~x15;
  ...
  assign new_n194_ = new_n166_ & x03 & x08 & x09 & ~x15 & x19;
