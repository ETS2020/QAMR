...
module FAU ( 
  ...
  assign new_n55_ = x04 & ~x05 & ~x07 & x12 & ~x15 & ~x21;
  ...
  assign z06 = new_n67_ | (~x09 & ((~new_n92_ & ~x07) | (new_n106_ & ~x05 & x07)));
  ...
  assign new_n101_ = ~x15 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  ...
  assign z09 = (~x17 & ~new_n111_ & x18) | (~x18 & (x14 | (new_n120_ & ~x07)));
  ...
  assign new_n120_ = ~x09 & ~x15 & (x17 | (new_n121_ & x12 & ~x21));
  assign new_n121_ = x04 & ~x05;
  assign z10 = (~x17 & ~new_n124_ & x18) | (~x18 & (x14 | (~x09 & ~new_n123_ & x17)));
  ...
  assign new_n126_ = ~x15 & ~x14 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n67_ | (~new_n128_ & ~x09);
  assign new_n128_ = ~new_n136_ & (x07 | (~new_n137_ & (x17 | ~new_n129_ | ~x18)));
  assign new_n129_ = ~x21 & (new_n130_ | new_n135_ | (~x05 & (new_n94_ | ~new_n132_)));
  assign new_n130_ = ~new_n131_ & ~x04;
  assign new_n131_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  assign new_n132_ = ~new_n102_ & (x15 | (~new_n133_ & ~new_n134_));
  assign new_n133_ = x06 & ~x08 & (x02 ^ x11);
  assign new_n134_ = x08 & ~x10 & ~x13 & ~x14;
  assign new_n135_ = x04 & x08 & ~x12 & ~new_n104_ & ~x15;
  assign new_n136_ = new_n106_ & ~x05 & x07 & ~x14;
  assign new_n137_ = x00 & ~x05 & ~x14 & x15 & x17 & ~x18;
  assign z13 = ~x09 & ~x14 & x17 & ~new_n123_ & ~x18;
  assign z14 = (~new_n140_ & ~x17) | (~x05 & new_n146_ & ~x09);
  assign new_n140_ = ~new_n144_ & (~x08 | new_n141_ | ~x18);
  assign new_n141_ = x07 ? ~new_n143_ : (new_n142_ | (~x09 & x21));
  assign new_n142_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n143_ = ~x19 & (x05 ^ x15);
  assign new_n144_ = new_n145_ & new_n121_ & ~x07 & ~x09;
  assign new_n145_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n146_ = ~x14 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n148_ & ~x18;
  assign new_n148_ = x17 & ~x15 & ~x14 & ~x09 & x05 & ~x07;
  assign z16 = (x14 & ~x18) | (x08 & ~x17 & ~new_n150_ & x18);
  assign new_n150_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n151_;
  assign new_n151_ = (x07 | x15 | (x09 ? x19 : ~new_n152_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n152_ = ~x14 & ~x21 & (new_n154_ | (~new_n60_ & ~new_n153_));
  assign new_n153_ = (~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11);
  assign new_n154_ = x12 & (~x13 | (~x02 & x11)) & (x06 ^ x16);
  assign z17 = ~x09 & (new_n156_ | (new_n65_ & new_n161_ & new_n66_ & ~x17));
  assign new_n156_ = ~x05 & ((~new_n157_ & ~x07) | (new_n106_ & x07 & ~x14));
  assign new_n157_ = ~new_n160_ & (~new_n158_ | x08);
  assign new_n158_ = ~x15 & ~x17 & x18 & ~new_n159_ & (~x21 | (~x14 & x21));
  assign new_n159_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n160_ = x00 & ~x14 & x15 & x17 & ~x18;
  assign new_n161_ = ~x11 & x15;
  assign z18 = new_n67_ | (~x05 & ~x07 & ~x09 & new_n163_ & ~x17);
  assign new_n163_ = x18 & ((~x14 & ~new_n164_ & ~x15) | (~x08 & x15 & x19));
  assign new_n164_ = ~new_n85_ & (~x12 | (~new_n166_ & (new_n165_ | x06)));
  assign new_n165_ = (x04 | x08 | ~x21) & (~new_n90_ | ~x08 | ~x10);
  assign new_n166_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = new_n168_ & ~x18;
  assign new_n168_ = x17 & ~x15 & ~x14 & ~x09 & ~x05 & ~x07;
  assign z20 = new_n67_ | (~x07 & ~x17 & (new_n170_ | new_n176_));
  ...
  assign new_n175_ = x04 & ~x05 & ~x09 & x12 & ~x18 & ~x21;
  assign new_n176_ = new_n66_ & new_n161_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n209_ = x07 & ~x09 & x15 & ~new_n72_ & ~x18;
  assign new_n210_ = ~new_n211_ & ~x14;
