...
module FAU ( 
  ...
  assign z01 = (~x05 & (new_n57_ | new_n64_)) | new_n62_ | z19;
  ...
  assign new_n67_ = ~x15 & (new_n68_ | new_n70_);
  ...
  assign new_n75_ = (~x07 | (~x05 ^ x15)) & (x15 | (x05 ? (x04 & x12) : x07)) & (x05 | new_n76_ | ~x15);
  ...
  assign new_n162_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign new_n178_ = new_n179_ & x03 & ~x05 & ~x07;
  assign new_n179_ = ~x15 & x19 & x08 & x09;
  assign z28 = (~x17 & x18 & (new_n181_ | new_n190_)) | (~x18 & (new_n192_ | x17));
  ...
  assign new_n192_ = ~x05 & x07 & ~x09 & ~new_n76_ & x15;
  assign z13 = 1'b0;
  assign z15 = 1'b0;
endmodule
