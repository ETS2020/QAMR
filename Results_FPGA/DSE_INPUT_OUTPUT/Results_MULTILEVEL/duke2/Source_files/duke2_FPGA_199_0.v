...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n110_ | (~x07 & (new_n108_ | (new_n95_ & ~x17))));
  ...
  assign new_n98_ = (x06 | x08 | x15) & (~x11 | x14 | x02 | ~x08);
  ...
  assign new_n108_ = x00 & ~x05 & x15 & new_n109_ & x16;
  assign new_n109_ = x17 & ~x18;
  assign new_n110_ = new_n109_ & x16 & ~x05 & x07 & ~x15;
  ...
  assign z10 = (~x17 & ~new_n128_ & x18) | (~x18 & (~x16 | (~x09 & ~new_n127_ & x17)));
  ...
  assign z12 = ~x09 & (new_n110_ | (~x07 & (new_n108_ | (new_n131_ & ~x17))));
  assign new_n131_ = x18 & ~x21 & ((~new_n135_ & ~x04) | new_n132_ | (new_n134_ & x04));
  assign new_n132_ = ~x05 & (new_n97_ | new_n105_ | (~new_n133_ & ~x15));
  assign new_n133_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n107_ | ~x08 | x10);
  assign new_n134_ = x08 & ~x12 & ~x15 & (new_n107_ | x05);
  assign new_n135_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign z13 = ~x09 & x16 & x17 & ~new_n127_ & ~x18;
  assign z14 = (~new_n142_ & ~x18) | (~x17 & (new_n140_ | (x08 & ~new_n138_ & x18)));
  assign new_n138_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n65_ | new_n139_);
  ...
  assign new_n142_ = ~new_n143_ & x16;
  assign new_n143_ = ~x05 & ~x09 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n145_ & ~x18;
  assign new_n145_ = x16 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = new_n83_ | (x08 & ~new_n147_ & ~x17);
  assign new_n147_ = x05 ? (~new_n154_ | ~x09) : ((~new_n148_ | x07) & (~new_n153_ | ~x09));
  assign new_n148_ = ~x15 & (x09 ? (x18 & ~x19) : (new_n149_ & ~x14));
  assign new_n149_ = ~x21 & (new_n152_ | (x18 & (new_n151_ | (~new_n63_ & ~new_n150_))));
  assign new_n150_ = (~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11);
  assign new_n151_ = ~x06 & x12 & x16 & (~x13 | (~x02 & x11));
  assign new_n152_ = x06 & x12 & ~x16 & (~x13 | (~x02 & x11));
  assign new_n153_ = x15 & x18 & (~x02 | x07);
  assign new_n154_ = ~x15 & x18 & (x07 | ~x12);
  ...
  assign new_n159_ = new_n68_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = new_n83_ | (~x05 & ~x07 & new_n161_ & ~x09);
  assign new_n161_ = ~x17 & (new_n162_ | (~x08 & x15 & x18 & x19));
  assign new_n162_ = ~x14 & ~x15 & (new_n165_ | (x18 & (new_n88_ | new_n163_)));
  assign new_n163_ = x12 & (new_n164_ | (~x04 & ~x06 & ~x08 & x21));
  assign new_n164_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign new_n165_ = new_n166_ & ~x06 & x08 & x10;
  assign new_n166_ = ~x16 & ~x21 & x12 & ~x13;
  assign z19 = ~x18 & (~x16 | (new_n56_ & ~x09 & ~x15 & x17));
  assign z20 = new_n83_ | (~x07 & ~x17 & (new_n176_ | (~new_n169_ & ~x15)));
  assign new_n169_ = (new_n170_ | ~x18) & (~new_n175_ | ~x12 | x14 | x18 | x21);
  assign new_n170_ = (x09 | ((~new_n171_ | ~x04) & (~new_n174_ | x05))) & (~x04 | ~new_n173_ | ~x05);
  ...
  assign z24 = new_n83_ | (~x09 & ~x17 & (new_n183_ | new_n187_));
  assign new_n183_ = ~x07 & (new_n184_ | (~x05 & ~x08 & ~x15 & x18));
