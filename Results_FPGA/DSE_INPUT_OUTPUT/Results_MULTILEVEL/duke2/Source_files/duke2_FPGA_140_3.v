...
module FAU ( 
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n94_ | (new_n108_ & ~x15 & x17)));
  assign new_n94_ = ~x07 & (new_n107_ | (x18 & (new_n105_ | (~new_n95_ & ~x15))));
  assign new_n95_ = ~new_n102_ & (x21 | (~new_n96_ & ~new_n104_ & (new_n98_ | ~x08)));
  assign new_n96_ = ~x02 & ~new_n97_ & x11;
  assign new_n97_ = (x05 | ~x06 | x08) & (~x04 | ~x08 | x12 | x14);
  assign new_n98_ = ~new_n99_ & (x05 | x14 | (~new_n101_ & (new_n100_ | x17)));
  ...
  assign new_n107_ = x00 & ~x05 & x15 & x17;
  ...
  assign new_n128_ = ~new_n138_ & (x17 | ~x18 | (new_n129_ & ~new_n136_) | x21);
  ...
  assign new_n138_ = x00 & ~x05 & new_n139_ & x15;
  ...
  assign new_n155_ = (x07 | ((x08 | ~new_n156_ | x15) & (~new_n139_ | ~x00 | ~x15))) & (~new_n139_ | ~x07 | x15);
  ...
  assign new_n165_ = (new_n166_ | x15) & (~new_n172_ | x11 | ~x15 | ~x18 | x21);
  ...
  assign new_n177_ = (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  ...
  assign new_n185_ = new_n108_ & x01 & x08 & ~x15 & ~x18;
