...
module FAU ( 
  ...
  assign z01 = (x18 & ~x20) | (~x17 & (new_n66_ | (~new_n58_ & ~x05)));
  ...
  assign new_n81_ = x18 & x20 & ~x15 & ~x17;
  assign z04 = ~x20 & ~x14 & ~x18;
  assign z05 = x18 & (~x20 | (~x05 & ~x07 & new_n84_ & ~x09));
  ...
  assign z06 = (x18 & ~x20) | (~x09 & (new_n107_ | (~new_n92_ & ~x07)));
  ...
  assign z09 = new_n121_ | (~x07 & (new_n119_ | (~new_n112_ & ~x09)));
  assign new_n112_ = (x17 | new_n113_ | ~x18) & (x15 | (x18 & x20) | (~new_n118_ & ~x17));
  ...
  assign new_n118_ = x12 & ~x14 & ~x21 & x04 & ~x05;
  assign new_n119_ = x02 & ~x05 & x08 & new_n120_ & ~x11;
  assign new_n120_ = x15 & ~x17 & ~new_n64_ & x18;
  assign new_n121_ = x18 & (~x20 | (new_n122_ & x05));
  assign new_n122_ = x08 & ~x15 & ~x17 & (~x04 | x07 | ~x12);
  ...
  assign z12 = (x18 & ~x20) | (~x09 & (new_n107_ | (~new_n128_ & ~x07)));
  ...
  assign z14 = ~new_n141_ | (~x17 & (new_n139_ | (x08 & ~new_n137_ & x18)));
  ...
  assign new_n141_ = (~x18 | x20) & (x05 | x09 | new_n142_ | x18);
  assign new_n142_ = (~x15 | (~x07 & ~x17)) & (~x07 | (x01 & ~x17));
  assign z15 = (x18 & ~x20) | (new_n144_ & ~x15 & x17 & ~x18);
  ...
  assign z17 = (x18 & ~x20) | (~x09 & (new_n155_ | (~new_n152_ & ~x05)));
  assign new_n152_ = (x07 | ((~new_n106_ | ~x00 | ~x15) & (x08 | ~new_n153_ | x15))) & (~new_n106_ | ~x07 | x15);
  ...
  assign new_n157_ = x20 & ((~x14 & ~new_n158_ & ~x15) | (~x08 & x15 & x19));
  ...
  assign z20 = (~x07 & ~new_n163_ & ~x17) | (x18 & ~x20);
  assign new_n163_ = ~new_n170_ & (x15 | ((new_n164_ | x09) & (~new_n169_ | ~x04)));
  assign new_n164_ = (~new_n165_ | ~x04) & (x05 | ((~new_n168_ | ~x04) & (~new_n167_ | x06)));
  assign new_n165_ = x08 & x10 & new_n166_ & ~x12;
  assign new_n166_ = ~x14 & x18 & ~x21 & (~x13 | (~x02 & x11));
  assign new_n167_ = ~x08 & x18 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n168_ = x12 & ~x14 & ~x21 & (~x18 | ~x20);
  assign new_n169_ = x05 & x08 & ~x12 & ~new_n64_ & x18;
  assign new_n170_ = new_n171_ & ~x04 & x05 & x08 & ~x09;
  assign new_n171_ = ~x11 & x15 & x18 & ~x21;
  assign z21 = x18 & (~x20 | (~x17 & (new_n174_ | (~new_n173_ & ~x07))));
  assign new_n173_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | ~x20))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x20);
  assign new_n174_ = ~x05 & x07 & x08 & ~x09 & x15 & x20;
  assign z22 = ~x17 & x18 & ~new_n176_ & x20;
  assign new_n176_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x18 & (new_n178_ | ~x20);
  assign new_n178_ = ~x05 & ~x07 & x08 & x09 & ~x15 & ~x17;
  assign z24 = (x18 & ~x20) | (~x09 & ~x17 & (new_n180_ | new_n184_));
  ...
  assign z25 = x18 & (new_n186_ | ~x20);
  assign new_n186_ = ~x05 & ~x07 & ~x17 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x18 | x21);
  assign z27 = (~new_n192_ & x18) | (~x09 & (new_n194_ | (~x17 & ~new_n189_ & x18)));
  assign new_n189_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n190_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n190_ = ~x21 & (new_n133_ | new_n191_);
  assign new_n191_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n192_ = x20 & (~new_n193_ | ~x03 | x05 | x07 | ~x08);
  assign new_n193_ = x09 & ~x15 & ~x17 & x19;
  assign new_n194_ = ~x05 & x17 & ~x18 & ((x00 & ~x07 & x15) | (x07 & ~x15));
  assign z28 = (~new_n196_ & ~x17) | (~x09 & new_n208_ & x17);
  assign new_n196_ = (~new_n207_ | x05) & (~x18 | ~x20 | (~new_n205_ & (new_n197_ | x05)));
  assign new_n197_ = (new_n198_ | x02) & ~new_n204_ & (x07 | new_n200_ | x09);
