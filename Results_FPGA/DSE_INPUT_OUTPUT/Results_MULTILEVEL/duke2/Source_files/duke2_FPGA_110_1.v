...
module FAU ( 
  ...
  assign z02 = new_n78_ | (~x17 & (~new_n74_ | (~new_n69_ & ~x05)));
  ...
  assign new_n74_ = (~x08 | (~new_n75_ & (~new_n62_ | x07))) & (~new_n77_ | ~x05 | x07 | x08);
  ...
  assign new_n87_ = ~x06 & x08 & ~x10 & new_n67_ & x13;
  assign new_n88_ = ~new_n89_ & (~x11 | ~x21 | x02 | x08);
  assign new_n89_ = x08 & x10 & x12 & new_n67_ & ~x13 & x16;
  assign new_n90_ = (x08 | ~x21 | (x04 ^ ~x12)) & (~new_n91_ | ~x08 | ~x10 | ~x12);
  assign new_n91_ = new_n67_ & ~x13 & ~x16;
  assign z06 = new_n78_ | (~x09 & (new_n109_ | (~new_n93_ & ~x07)));
  assign new_n93_ = ~new_n108_ & (x17 | (~new_n105_ & ((~new_n94_ & ~new_n102_) | x05)));
  assign new_n94_ = x18 & ~x21 & (new_n95_ | new_n101_ | (~new_n97_ & ~x15));
  ...
  assign new_n106_ = ~x15 & x18 & (new_n107_ | x05) & ~x21;
  ...
  assign z09 = (~x17 & (new_n125_ | (~new_n114_ & x18))) | (~new_n122_ & ~x18);
  assign new_n114_ = (x15 | (~new_n121_ & (~new_n115_ | x07))) & (~new_n120_ | ~x02);
  ...
  assign new_n123_ = ~x15 & (x17 | (new_n124_ & x04 & ~x05));
  assign new_n124_ = x12 & ~x14;
  assign new_n125_ = x05 & ~x07 & new_n62_ & x08;
  assign z10 = (~x17 & ~new_n128_ & x18) | (~x18 & (x21 | (~x09 & ~new_n127_ & x17)));
  assign new_n127_ = x05 & x07;
  assign new_n128_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign z11 = ~x21 & new_n130_ & ~x18;
  assign new_n130_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n109_ | (~x07 & (new_n132_ | new_n108_))) & ~x21;
  assign new_n132_ = ~x17 & x18 & ((~new_n136_ & ~x04) | new_n133_ | (new_n135_ & x04));
  assign new_n133_ = ~x05 & (new_n95_ | new_n101_ | (~new_n134_ & ~x15));
  ...
  assign z13 = ~x09 & x17 & ~x18 & ~new_n127_ & ~x21;
  assign z14 = (~new_n139_ & ~x17) | (~x18 & (new_n143_ | x21));
  assign new_n139_ = (~x08 | new_n140_ | ~x18) & (~new_n142_ | ~new_n124_ | x15 | x18);
  assign new_n140_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n62_ | new_n141_);
  ...
  assign new_n149_ = (new_n60_ | (new_n150_ & (~x02 | ~x06))) & (~x12 | new_n150_ | (~x06 ^ x16));
  ...
  assign new_n156_ = x17 & ~x18 & ~x21;
  assign new_n157_ = new_n66_ & ~x11 & x15 & new_n67_ & ~x17;
  assign z18 = ~x05 & ~x07 & ~x09 & new_n159_ & ~x17;
  assign new_n159_ = x18 & ((~x14 & ~new_n160_ & ~x15) | (~x08 & x15 & x19));
  assign new_n160_ = (new_n161_ | ~x02) & (~x12 | (~new_n163_ & (new_n162_ | x06)));
  ...
  assign new_n165_ = ~x21 & (x05 | x07 | x09 | x15 | ~x17);
  assign z20 = new_n78_ | (~x07 & ~new_n167_ & ~x17);
  assign new_n167_ = (new_n168_ | x15) & (~new_n174_ | ~new_n67_ | x11 | ~x15);
  ...
  assign new_n172_ = x04 & x05 & x08 & ~new_n62_ & ~x12;
  assign new_n173_ = x04 & ~x05 & ~x09 & x12 & ~x14 & ~x18;
  ...
  assign new_n180_ = ((~new_n181_ & ~new_n184_) | x07) & (~new_n185_ | ~x01 | x05 | ~x07);
  ...
  assign new_n185_ = ~x18 & ~x21 & x08 & ~x15;
  ...
  assign new_n207_ = x07 & ~x09 & x15 & ~x18 & ~new_n71_ & ~x21;
