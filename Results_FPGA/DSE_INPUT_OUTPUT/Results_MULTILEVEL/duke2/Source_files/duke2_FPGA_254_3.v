...
module FAU ( 
  ...
  assign z23 = x18 & (x17 | (new_n83_ & ~x05 & ~x07));
  assign new_n83_ = x08 & x09 & ~x15;
  assign new_n84_ = (~x18 | ((~x05 | x15 | (x07 ^ x08)) & (~x08 | ~x15 | x05 | ~x07))) & (~x17 | (x05 & x07));
  assign z04 = ~x14 & ~x20 & (~x17 | ~x18);
  assign z05 = x18 & (x17 | (~x05 & new_n87_ & ~x07));
  assign new_n87_ = ~x09 & ~x14 & ~x15 & (~new_n88_ | (~new_n94_ & x02));
  assign new_n88_ = (x17 | (x06 ? new_n89_ : new_n91_)) & (~new_n93_ | x04 | x06);
  assign new_n89_ = ~new_n90_ & (~x11 | ~x21 | x02 | x08);
  assign new_n90_ = x08 & x10 & x12 & ~x13 & x16 & ~x21;
  assign new_n91_ = (~x04 | x08 | x12 | ~x21) & (~new_n92_ | ~x08 | ~x10 | ~x12);
  assign new_n92_ = ~x13 & ~x16 & ~x21;
  assign new_n93_ = ~x08 & x12 & x21;
  assign new_n94_ = (~x06 | x08 | x11 | ~x21) & (~new_n95_ | x06 | ~x08 | x10);
  assign new_n95_ = x13 & ~x17 & ~x21;
  assign z06 = ~x09 & (new_n110_ | (~x07 & (new_n112_ | (new_n97_ & ~x17))));
  ...
  assign new_n110_ = new_n111_ & ~x15 & x17 & ~x18;
  ...
  assign z09 = (new_n117_ & ~x17) | (~x07 & ~x09 & new_n126_ & ~x15);
  assign new_n117_ = x18 & ((~x07 & (x05 ? new_n125_ : ~new_n118_)) | (new_n124_ & x05));
  assign new_n118_ = (x21 | ((x09 | new_n119_ | x15) & (~new_n123_ | x11 | ~x15))) & (~new_n123_ | ~x09 | x11 | ~x15);
  ...
  assign new_n124_ = x08 & ~new_n80_ & ~x15;
  assign new_n125_ = ~x09 & (x08 ? x21 : (~x15 & ~x19));
  assign new_n126_ = ~x18 & (x17 | (new_n55_ & x12 & ~x14 & ~x21));
  ...
  assign z12 = ~x09 & (new_n110_ | (~x07 & (new_n112_ | (new_n131_ & ~x17))));
  assign new_n131_ = x18 & ~x21 & ((~new_n135_ & ~x04) | new_n132_ | (new_n134_ & x04));
  assign new_n132_ = ~x05 & (new_n99_ | new_n107_ | (~new_n133_ & ~x15));
  assign new_n133_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n109_ | ~x08 | x10);
  assign new_n134_ = x08 & ~x12 & ~x15 & (new_n109_ | x05);
  ...
  assign z17 = ~x09 & (new_n152_ | (new_n67_ & new_n156_ & new_n68_ & ~x17));
  ...
  assign new_n158_ = (x14 | x15 | (~new_n159_ & ~new_n162_)) & (x08 | ~x15 | ~x19);
  assign new_n159_ = ~new_n160_ & x02;
  assign new_n160_ = (~new_n161_ | x06 | ~x08) & (~x06 | x08 | x11 | x17 | ~x21);
  assign new_n161_ = ~x10 & x13 & ~x21;
  assign new_n162_ = x12 & ((~new_n163_ & ~x06) | (new_n164_ & x06 & x08 & x10));
  assign new_n163_ = (x17 | ~x21 | x04 | x08) & (~new_n92_ | ~x08 | ~x10);
  ...
  assign new_n172_ = new_n55_ & ~x09 & x12;
  assign new_n173_ = new_n68_ & new_n156_ & ~x04 & x05 & x08 & ~x09;
