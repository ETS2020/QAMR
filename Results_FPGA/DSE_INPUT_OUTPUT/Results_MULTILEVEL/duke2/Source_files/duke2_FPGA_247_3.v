...
module FAU ( 
  ...
  assign z11 = (x17 & x18) | (new_n127_ & ~x17 & ~x18 & ~x09 & ~x15);
  assign new_n127_ = x01 & ~x05 & x07;
  assign z12 = new_n81_ | (~x09 & (new_n106_ | (~x07 & (new_n129_ | new_n104_))));
  ...
  assign new_n137_ = x04 & x08 & ~x12 & (new_n132_ | x05) & ~x15;
  ...
  assign new_n143_ = new_n144_ & x04 & ~x07 & x12 & ~x14;
  assign new_n144_ = ~x15 & ~x17 & ~x18 & ~x21;
  ...
  assign z17 = ~x09 & ((~new_n153_ & ~x05) | (new_n156_ & new_n65_ & ~x04 & x05));
