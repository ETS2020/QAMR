...
module FAU ( 
  ...
  assign z23 = x18 & (x17 | (new_n56_ & new_n80_));
  assign new_n80_ = x08 & x09 & ~x15;
  assign new_n81_ = (~x18 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (~x17 | (x05 & x07));
  ...
  assign new_n121_ = ~x18 & (x17 | (x04 & ~x05 & new_n122_ & x12));
  assign new_n122_ = ~x14 & ~x21;
  assign z10 = (~new_n124_ & x18) | (~x09 & x17 & (~x05 | ~x07));
  assign new_n124_ = ~new_n125_ & ~x17 & (~new_n126_ | x05 | x06 | x07);
  assign new_n125_ = ~x15 & ((x05 & ((x07 & x08) | (~x08 & ~x09 & ~x06 & ~x07))) | (~x05 & ~x07 & x08 & x09));
  assign new_n126_ = ~x08 & ~x09 & x15;
  assign z11 = (x17 & x18) | (new_n128_ & ~x17 & ~x18 & ~x09 & ~x15);
  assign new_n128_ = x01 & ~x05 & x07;
  assign z12 = (~x09 & (new_n106_ | (~new_n130_ & ~x07))) | (x17 & x18);
  assign new_n130_ = ~new_n105_ & (~x18 | x21 | (new_n131_ & (new_n135_ | x04)));
  assign new_n131_ = (~new_n134_ | ~x04) & (x05 | (~new_n95_ & ~new_n132_ & ~new_n103_));
  ...
  assign z17 = ~x09 & (new_n152_ | (new_n66_ & new_n156_ & new_n67_ & ~x17));
  assign new_n152_ = ~x05 & ((~new_n153_ & ~x07) | (x07 & ~x15 & x17 & ~x18));
  assign new_n153_ = (x08 | x15 | x17 | ~new_n154_ | ~x18) & (~x17 | x18 | ~x00 | ~x15);
  ...
  assign new_n169_ = new_n67_ & new_n156_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n179_ = new_n128_ & x08 & ~x15 & ~x18;
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n80_ | new_n126_);
  assign z26 = (~new_n122_ & ~x20) | (x17 & x18);
  assign z27 = (~x09 & (new_n187_ | (~new_n183_ & x18))) | (x18 & (new_n186_ | x17));
  assign new_n183_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n184_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n184_ = ~x21 & (new_n185_ | (~new_n135_ & ~x04));
  assign new_n185_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n186_ = new_n56_ & x03 & ~x15 & x19 & x08 & x09;
  assign new_n187_ = ~x05 & x17 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n189_ | (new_n200_ & ~x05))) | (~x09 & new_n201_ & x17);
