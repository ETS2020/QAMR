...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n159_, new_n162_, new_n163_, new_n165_, new_n168_, new_n169_,
    new_n170_, new_n171_, new_n172_, new_n173_, new_n175_, new_n176_,
    new_n177_, new_n178_, new_n179_, new_n180_, new_n181_, new_n182_,
    new_n183_, new_n184_, new_n185_, new_n186_;
  assign z00 = ~new_n54_ & ~x18;
  assign new_n54_ = x17 & (x09 | ((~x05 | (x07 & x15)) & (x07 | (x00 & x15)) & (x05 | ~x07 | ~x15)));
  ...
  assign z05 = ~x17 & (~x18 | (~x05 & ~x07 & new_n79_ & ~x09));
  assign new_n79_ = ~x14 & ~x15 & (~new_n80_ | (~new_n86_ & x02));
  assign new_n80_ = (~x18 | (x06 ? new_n81_ : new_n83_)) & (~new_n85_ | x04 | x06);
  ...
  assign new_n86_ = (x11 | ~x21 | ~x06 | x08) & (~new_n87_ | x06 | ~x08 | x10);
  assign new_n87_ = x13 & x18 & ~x21;
  ...
  assign z12 = ~x09 & (new_n103_ | (~x07 & (new_n102_ | (new_n121_ & ~x17))));
  assign new_n121_ = x18 & ~x21 & ((~new_n125_ & ~x04) | new_n122_ | (new_n124_ & x04));
  assign new_n122_ = ~x05 & (new_n91_ | new_n99_ | (~new_n123_ & ~x15));
  assign new_n123_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n101_ | ~x08 | x10);
  assign new_n124_ = x08 & ~x12 & (new_n101_ | x05) & ~x15;
  ...
  assign z17 = (~x17 & ~x18) | (~x09 & (new_n141_ | (~new_n138_ & ~x05)));
  assign new_n138_ = x07 ? (x15 | x18) : ((x08 | ~new_n139_ | x15) & (~x00 | ~x15 | x18));
  assign new_n139_ = ~x17 & ~new_n140_ & (~x21 | (~x14 & x21));
  assign new_n140_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n141_ = new_n142_ & ~x04 & x05 & ~x07 & x08;
  assign new_n142_ = ~x11 & x15 & ~x17 & ~x21;
  assign z18 = ~x17 & (~x18 | (~x05 & new_n144_ & ~x07));
  assign new_n144_ = ~x09 & ((~x14 & ~new_n145_ & ~x15) | (~x08 & x15 & x19));
  assign new_n145_ = (new_n147_ | ~x02) & (~x12 | (~new_n148_ & (new_n146_ | x06)));
  assign new_n146_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  assign new_n147_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n148_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  ...
  assign new_n158_ = (new_n159_ | x07) & x18 & (x05 | ~x07 | ~x08 | ~x15);
  assign new_n159_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n75_ & x08;
  assign z24 = ~x07 & ~x09 & new_n162_ & ~x17;
  assign new_n162_ = x18 & ((~x05 & ~x08 & ~x15) | (x08 & ~new_n163_ & ~x21));
  assign new_n163_ = (x02 | x05 | ~x11 | ~x15) & (~x05 | (x04 ? (x12 | x15) : (x11 | ~x15)));
  assign z25 = new_n165_ & ~x05;
  assign new_n165_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = (~x17 & ~x18) | (~x20 & (x14 | x21));
  assign z27 = new_n168_ | (new_n173_ & x03 & ~x05 & ~x07 & x08);
  ...
  assign new_n171_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n172_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n173_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & ~new_n175_ & x18) | (~x09 & x17 & ~new_n186_ & ~x18);
  assign new_n175_ = ~new_n184_ & (x05 | (new_n176_ & (new_n182_ | x02)));
  assign new_n176_ = (~new_n181_ | ~x08) & (x07 | x09 | (x08 ? ~new_n179_ : new_n177_));
  assign new_n177_ = (~x15 | x19) & (~new_n178_ | x14 | x15 | ~x21);
  assign new_n178_ = x04 & ~x06 & ~x12;
  assign new_n179_ = x10 & new_n180_ & x12;
  assign new_n180_ = ~x14 & ~x15 & ~x21 & (x02 | x11 | ~x13);
