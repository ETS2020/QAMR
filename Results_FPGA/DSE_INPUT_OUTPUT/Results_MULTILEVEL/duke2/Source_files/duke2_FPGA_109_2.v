...
module FAU ( 
  ...
  assign z01 = (~x07 & ~x17 & ~new_n57_ & x18) | (x15 & ~x18);
  assign new_n57_ = (new_n58_ | x05) & (~new_n63_ | x04 | ~x05 | ~x08);
  ...
  assign z03 = (~new_n76_ & ~x09) | (new_n77_ & ~x05 & new_n75_ & x09 & ~x15);
  assign new_n75_ = ~x17 & x18;
  assign new_n76_ = (x15 | ((~x05 | x17 | ~x18 | (~x07 ^ ~x08)) & (~x17 | x18 | (x05 & x07)))) & (x05 | ~x07 | ~x08 | ~x15 | x17 | ~x18);
  ...
  assign new_n92_ = (x06 | ((~x02 | x10 | ~x13) & (x13 | x16 | ~x10 | ~x12))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  ...
  assign z09 = new_n114_ | (~x17 & ~new_n105_ & x18);
  ...
  assign new_n114_ = ~x07 & ~x09 & ~x15 & ~new_n55_ & ~x18;
  assign z10 = (~new_n116_ & ~x15) | (new_n118_ & new_n75_ & ~x09 & x15);
  assign new_n116_ = (x17 | new_n117_ | ~x18) & (x09 | ~x17 | x18 | (x05 & x07));
  assign new_n117_ = (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09);
  assign new_n118_ = ~x05 & ~x06 & ~x07 & ~x08;
  assign z11 = new_n120_ & ~x18;
  assign new_n120_ = ~x17 & ~x15 & ~x09 & x01 & ~x05 & x07;
  assign z12 = (x15 & ~x18) | (~new_n122_ & ~x09);
  assign new_n122_ = ~new_n135_ & (x07 | x17 | (new_n123_ & ~new_n133_) | x21);
  assign new_n123_ = ~new_n132_ & (~x18 | (~new_n130_ & (x05 | (~new_n124_ & new_n126_))));
  ...
  assign new_n133_ = ~x04 & (new_n134_ | (~x11 & x15 & x05 & x08));
  assign new_n134_ = x12 & ~x15 & x18 & ~x05 & ~x06 & ~x08;
  assign new_n135_ = x17 & ~x18 & ~x05 & x07;
  ...
  assign new_n158_ = (x14 | x15 | (~new_n81_ & ~new_n159_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n165_ = ~x06 & ~x08 & ~new_n87_ & (~x14 | ~x21);
  ...
  assign new_n175_ = (x05 | ((x15 | ~x18 | ~x08 | ~x09) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign z23 = (x15 & ~x18) | (new_n77_ & ~x05 & x09 & ~x15 & ~x17 & x18);
  assign z24 = (x15 & ~x18) | (~x09 & ~new_n178_ & ~x17);
  assign new_n178_ = (new_n179_ | x07) & (~x01 | x05 | ~x07 | ~x08 | x18);
  assign new_n179_ = ~new_n182_ & (x21 | (~new_n181_ & (new_n180_ | ~x04)));
  assign new_n180_ = (~x05 | ~x08 | x12 | x15 | ~x18) & (x14 | x18 | x05 | ~x12);
  assign new_n181_ = x08 & x15 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n182_ = ~x05 & ~x08 & ~x15 & x18;
  assign z25 = (new_n184_ & ~x05) | (x15 & ~x18);
  assign new_n184_ = ~x07 & ~x17 & ((x08 & x09 & ~x15 & x18) | (~x08 & ~x09 & x15));
  assign z26 = ~x20 & (~x15 | x18) & (x14 | x21);
  assign z27 = new_n187_ | (new_n192_ & new_n77_ & x03 & ~x05);
  assign new_n187_ = ~x09 & (new_n100_ | (~x17 & ~new_n188_ & x18));
  ...
  assign z28 = new_n204_ | (~x17 & (new_n201_ | ((~new_n194_ | new_n198_) & ~x05)));
  assign new_n194_ = (x07 | new_n195_ | x09) & (~x08 | ~x15 | (~x07 & x11));
  assign new_n195_ = x08 ? (~x10 | ~x12 | ~new_n197_ | x14) : new_n196_;
  assign new_n196_ = (~x15 | x19) & (~new_n97_ | ~x18 | ~x21 | x14 | x15);
  assign new_n197_ = ~x15 & x18 & ~x21 & (x02 | x11 | ~x13);
  assign new_n198_ = ~new_n199_ & ~x02;
  assign new_n199_ = (~x08 | ~x15) & (~new_n200_ | x08 | x09 | ~x06 | x07);
  assign new_n200_ = x11 & ~x14 & ~x15 & x18 & x21;
  assign new_n201_ = ~x07 & ~new_n202_ & x08;
  assign new_n202_ = (x04 | ~new_n203_ | ~x05) & (x09 | ~x15 | ~x21);
  assign new_n203_ = x12 & ~x15 & x18 & (x09 | ~x21);
