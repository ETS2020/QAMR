...
module FAU ( 
  ...
  assign new_n92_ = (x06 | x08 | x15) & (~x11 | x14 | x02 | ~x08);
  ...
  assign z07 = ~x17 & (~new_n108_ | (~x09 & ~new_n110_ & (~x07 ^ x08)));
  assign new_n108_ = x18 & (~new_n109_ | x05 | ~x09 | x15 | ~x16);
  assign new_n109_ = ~x07 & x08;
  assign new_n110_ = ~x05 ^ x15;
  assign z08 = z11 | (x14 & ~x20);
  assign z09 = (~new_n113_ & ~x17) | (new_n106_ & ~x07 & ~x09);
  assign new_n113_ = (x07 | (x05 ? ~new_n119_ : new_n114_)) & x18 & (~new_n120_ | ~x05);
  assign new_n114_ = (x21 | ((x09 | new_n115_ | x15) & (~new_n118_ | x11 | ~x15))) & (~new_n118_ | ~x09 | x11 | ~x15);
  assign new_n115_ = (new_n116_ | ~x04) & (~new_n117_ | ~x02) & (~new_n94_ | x02 | ~x06);
  ...
  assign z12 = ~x09 & ((~new_n126_ & ~x07) | (~x05 & x07 & new_n134_ & ~x15));
  assign new_n126_ = (x17 | ~x18 | new_n127_ | x21) & (~new_n105_ | ~x15 | ~x17 | x18);
  assign new_n127_ = ~new_n128_ & ~new_n132_ & (x05 | (~new_n91_ & ~new_n130_ & ~new_n98_));
  ...
  assign new_n137_ = x07 ? (new_n110_ | x19) : (new_n61_ | new_n138_);
  assign new_n138_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n139_ = ~x05 & ~x09 & ~x18 & (x07 | x15);
  assign z15 = ~x18 & (~x17 | (x05 & ~x07 & ~x09 & ~x15));
  assign z16 = ~x17 & (~x18 | (x08 & (x05 ? new_n146_ : ~new_n142_)));
  assign new_n142_ = (x07 | x15 | (x09 ? x19 : ~new_n143_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n143_ = ~x14 & ~new_n144_ & ~x21;
  assign new_n144_ = ~new_n145_ & (new_n59_ | ((~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11)));
  assign new_n145_ = x12 & (~x13 | (~x02 & x11)) & (x06 ^ x16);
  assign new_n146_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & ((~new_n148_ & ~x05) | (new_n151_ & new_n109_ & ~x04 & x05));
  assign new_n148_ = (x07 | ((x08 | ~new_n149_ | x15) & (~new_n134_ | ~x00 | ~x15))) & (~new_n134_ | ~x07 | x15);
  ...
  assign z18 = ~x17 & (~x18 | (~x05 & ~x07 & ~new_n153_ & ~x09));
  assign new_n153_ = (x14 | new_n154_ | x15) & (x08 | ~x15 | ~x19);
  assign new_n154_ = (new_n155_ | ~x12) & (~x02 | (~new_n82_ & ~new_n157_));
  assign new_n155_ = (x06 | (~new_n156_ & (~new_n87_ | ~x08 | ~x10))) & (~new_n85_ | ~x06 | ~x08 | ~x10);
  assign new_n156_ = ~x04 & ~x08 & x18 & x21;
  assign new_n157_ = x06 & ~x08 & ~x11 & x18 & x21;
  assign z19 = ~x18 & (~x17 | (~x05 & ~x07 & ~x09 & ~x15));
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n62_ | (~new_n160_ & ~x15))));
  ...
  assign new_n169_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z24 = ~x17 & (~x18 | (new_n171_ & ~x07));
  assign new_n171_ = ~x09 & ((~x05 & ~x08 & ~x15) | (x08 & ~new_n172_ & ~x21));
  assign new_n172_ = (x02 | x05 | ~x11 | ~x15) & (~x05 | (x04 ? (x12 | x15) : (x11 | ~x15)));
  assign z25 = ~x05 & ~x07 & ~x17 & (new_n75_ | new_n124_) & x18;
  assign z26 = ~x20 & ~z11 & (x14 | x21);
  assign z27 = new_n179_ | (~x09 & (new_n181_ | (~x17 & ~new_n176_ & x18)));
  assign new_n176_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n177_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n177_ = (new_n128_ | new_n178_) & ~x21;
  assign new_n178_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n179_ = new_n180_ & new_n109_ & x03 & ~x05;
  assign new_n180_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n181_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & ~new_n183_ & x18) | (~x09 & x17 & ~new_n193_ & ~x18);
  assign new_n183_ = ~new_n191_ & (x05 | (new_n184_ & (new_n189_ | x02)));
  assign new_n184_ = (~new_n188_ | ~x08) & (x07 | x09 | (x08 ? ~new_n186_ : new_n185_));
  assign new_n185_ = (~x15 | x19) & (~new_n101_ | x14 | x15 | ~x21);
