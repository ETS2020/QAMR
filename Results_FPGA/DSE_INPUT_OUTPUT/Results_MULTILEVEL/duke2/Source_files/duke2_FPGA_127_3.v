...
module FAU ( 
  ...
  assign new_n80_ = ~x01 & ~x05 & ~x07 & x08;
  assign z04 = new_n82_ | (~x14 & ~x20);
  assign new_n82_ = x01 & x18;
  assign z05 = x18 & (x01 | (~x05 & ~x07 & new_n84_ & ~x09));
  ...
  assign z06 = new_n82_ | (~x09 & ((~new_n92_ & ~x07) | (new_n107_ & ~x05 & x07)));
  ...
  assign z09 = new_n121_ | ((new_n112_ | x01) & x18);
  assign new_n112_ = ~x17 & ((~x07 & (x05 ? new_n120_ : ~new_n113_)) | (new_n119_ & x05));
  ...
  assign z12 = new_n82_ | (~x09 & ((~new_n129_ & ~x07) | (new_n107_ & ~x05 & x07)));
  assign new_n129_ = ~new_n105_ & (x17 | ~x18 | x21 | (new_n130_ & ~new_n134_));
  assign new_n130_ = (x05 | (~new_n94_ & ~new_n131_ & ~new_n102_)) & (~new_n133_ | ~x04);
  ...
  assign z14 = (~new_n137_ & ~x01) | (~x05 & ~x09 & ~new_n141_ & ~x18);
  assign new_n137_ = (~x08 | x17 | new_n138_ | ~x18) & (~new_n66_ | x09 | x18);
  ...
  assign new_n141_ = (~x07 | (~x15 & ~x17)) & (~x15 | ~x17) & (~new_n72_ | x14 | x15 | x17 | x21);
  assign z15 = new_n82_ | (new_n107_ & x05 & ~x07 & ~x09);
  assign z16 = x18 & (x01 | (x08 & ~new_n144_ & ~x17));
  assign new_n144_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n145_;
  assign new_n145_ = (x07 | x15 | (x09 ? x19 : ~new_n146_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n146_ = ~x14 & ~x21 & ((~new_n147_ & ~new_n148_) | (~new_n149_ & x12));
  assign new_n147_ = x10 & (~x04 | x12);
  assign new_n148_ = (~x02 | ~x06) & x13 & (x02 | ~x11);
  assign new_n149_ = ((x13 & (x02 | ~x11)) | (~x06 ^ x16)) & (~x06 | x10 | ~x11);
  assign z17 = ~x09 & (new_n151_ | new_n155_);
  assign new_n151_ = ~x05 & ((~new_n152_ & ~x07) | (new_n106_ & x07 & ~x15));
  assign new_n152_ = (x01 | x08 | ~new_n153_ | x15) & (~new_n106_ | ~x00 | ~x15);
  ...
  assign z19 = new_n82_ | (new_n107_ & ~x05 & ~x07 & ~x09);
  assign z20 = new_n82_ | (~x07 & ~new_n164_ & ~x17);
  ...
  assign new_n176_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x18 & (new_n178_ | x01);
  assign new_n178_ = ~x05 & ~x07 & x08 & x09 & ~x15 & ~x17;
  assign z24 = (~x07 & new_n180_ & ~x09) | (x01 & (new_n184_ | x18));
  ...
  assign new_n184_ = ~x09 & ~x15 & ~x17 & ~x05 & x07 & x08;
  assign z25 = x18 & (new_n186_ | x01);
  ...
  assign new_n192_ = ~x01 & (~new_n193_ | ~x03 | x05 | x07 | ~x08);
  assign new_n193_ = x09 & ~x15 & ~x17 & x19;
  assign new_n194_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n206_ | (new_n196_ & ~x01))) | (~x09 & new_n208_ & x17);
