...
module FAU ( 
  ...
  assign new_n64_ = x01 & x07 & ~x15 & (x08 | x16);
  assign new_n65_ = x08 ? ~x21 : x07;
  assign new_n66_ = ~x07 & x11 & (x02 | x07 | ~x11 | ~x15 | (~x09 & x21));
  ...
  assign z18 = x18 & (new_n106_ | ~x15);
  assign new_n106_ = ~x05 & ~x07 & ~x08 & ~x09 & ~x17 & x19;
  ...
  assign z21 = ~x05 & new_n112_ & ~x09;
  assign new_n112_ = x15 & ~x17 & x18 & ((x07 & x08) | (~x06 & ~x07 & ~x08));
  ...
  assign z27 = ~x09 & (new_n103_ | (~new_n124_ & ~x05));
