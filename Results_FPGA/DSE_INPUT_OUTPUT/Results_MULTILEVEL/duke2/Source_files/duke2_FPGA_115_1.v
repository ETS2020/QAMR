...
module FAU ( 
  ...
  assign z06 = (~x09 & (new_n105_ | (~new_n93_ & ~x07))) | (~x18 & x20);
  ...
  assign z07 = (~x18 & x20) | (~x17 & ~new_n107_ & x18);
  assign new_n107_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20;
  assign z09 = (~x17 & ~new_n110_ & x18) | (~new_n119_ & ~x18);
  ...
  assign new_n119_ = ~x20 & (x07 | x09 | x15 | (~new_n120_ & ~x17));
  ...
  assign z11 = ~x18 & (new_n125_ | x20);
  assign new_n125_ = ~x09 & ~x15 & ~x17 & x01 & ~x05 & x07;
  assign z12 = (~x09 & (new_n105_ | (~new_n127_ & ~x07))) | (~x18 & x20);
  ...
  assign z16 = (~x18 & x20) | (x08 & ~x17 & (new_n148_ | new_n152_) & x18);
  ...
  assign new_n165_ = (new_n166_ | ~x18) & (~new_n170_ | x20 | x21 | x14 | x18);
  ...
  assign z21 = (~x18 & x20) | (~x17 & ~new_n174_ & x18);
  ...
  assign z24 = (~x18 & x20) | (~x09 & ~x17 & (new_n179_ | new_n183_));
  ...
  assign new_n192_ = x17 & ~x18 & ~x20 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n193_ = new_n194_ & x03 & ~x05 & ~x07 & x08;
  assign new_n194_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n196_ & ~x17) | (~x18 & (x20 | (~x09 & ~new_n209_ & x17)));
