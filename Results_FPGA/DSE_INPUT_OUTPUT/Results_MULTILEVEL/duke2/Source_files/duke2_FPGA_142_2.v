...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n99_, new_n102_, new_n105_, new_n106_, new_n107_, new_n108_,
  ...
  assign new_n65_ = new_n63_ & x11 & x15;
  assign z02 = (~x17 & (x15 ? (~new_n72_ & x18) : ~new_n67_)) | (x18 & ~x21);
  ...
  assign z06 = new_n77_ | (~x05 & ~x09 & (new_n85_ | (new_n82_ & ~x07)));
  assign new_n82_ = ~x08 & ~x14 & ~x15 & ~x17 & new_n83_ & x18;
  assign new_n83_ = ~new_n84_ & x21;
  assign new_n84_ = (x02 | ~x06 | ~x11) & (~x04 | x06 | x12);
  assign new_n85_ = x17 & ~new_n63_ & ~new_n86_;
  assign new_n86_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign z07 = x18 & (~x21 | (~new_n88_ & ~x17));
  assign new_n88_ = (x09 | (~x07 ^ ~x08) | (x05 ^ ~x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = new_n77_ | (x14 & ~x20);
  assign z09 = new_n91_ | (x18 & (~x21 | (new_n97_ & x05)));
  assign new_n91_ = ~x07 & (new_n94_ | (~x09 & (new_n96_ | (~new_n92_ & ~x15))));
  assign new_n92_ = ~new_n93_ & (~x04 | x05 | ~x12 | x14 | x21);
  assign new_n93_ = x17 & ~x18;
  assign new_n94_ = new_n95_ & x02 & ~x05 & x08 & x09;
  assign new_n95_ = ~x17 & x18 & ~x11 & x15;
  assign new_n96_ = x05 & ~x17 & x18 & (x08 | (~x15 & ~x19));
  assign new_n97_ = x08 & ~x15 & ~x17 & (~x04 | x07 | ~x12);
  assign z10 = z13 | (x18 & ((~new_n99_ & ~x17) | ~x21));
  ...
  assign new_n115_ = (x07 | (~new_n116_ & (~new_n93_ | ~x00 | ~x15))) & (~new_n93_ | ~x07 | x15);
  assign new_n116_ = ~x08 & ~x14 & ~x15 & ~x17 & new_n117_ & x18;
  assign new_n117_ = x21 & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign z18 = x18 & (~x21 | (~x05 & ~x07 & new_n119_ & ~x08));
  assign new_n119_ = ~x09 & ~x17 & ((x15 & x19) | (~x14 & new_n117_ & ~x15));
  assign z19 = new_n77_ | (~x05 & ~x07 & ~x09 & new_n93_ & ~x15);
  assign z20 = new_n77_ | (~x07 & new_n122_ & ~x15);
  assign new_n122_ = ~x17 & (new_n124_ | (~x05 & ~x09 & ~new_n123_ & ~x14));
  assign new_n123_ = (~x04 | ((x06 | x08 | x12 | ~x18) & (~x12 | x21))) & (x04 | x06 | x08 | ~x12 | ~x18);
  assign new_n124_ = x04 & x05 & x08 & x09 & ~x12 & x18;
  assign z21 = x18 & (~x21 | (~new_n126_ & ~x17));
  assign new_n126_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = x18 & (~x21 | (~new_n128_ & ~x17));
  ...
  assign new_n140_ = (~x00 | x07 | ~x17 | x18) & (~new_n141_ | ~x18 | ~x07 | ~x08 | x17);
