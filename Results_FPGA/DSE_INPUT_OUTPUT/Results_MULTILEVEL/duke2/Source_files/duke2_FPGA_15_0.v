...
module FAU ( 
  ...
  assign z06 = z11 | (~x09 & ((~new_n89_ & ~x07) | (new_n103_ & ~x05 & x07)));
  ...
  assign new_n146_ = new_n147_ & ~x07 & x08 & ~x04 & x05;
  assign new_n147_ = ~x17 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n149_ & x18;
  assign new_n149_ = (x14 | x15 | (~new_n81_ & ~new_n150_)) & (x08 | ~x15 | ~x19);
  assign new_n150_ = x12 & ((~new_n151_ & ~x06) | (new_n85_ & x06 & x08 & x10));
  ...
  assign new_n155_ = ~x06 & ~x08 & ~new_n87_ & (~x14 | ~x21);
  assign new_n156_ = x08 & x10 & ~x12 & ~x14 & ~new_n140_ & ~x21;
  assign new_n157_ = x08 & ~new_n61_ & ~x12;
  assign z21 = ~x17 & ((~new_n159_ & ~x07) | ~x18 | (new_n160_ & ~x05 & x07));
  assign new_n159_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n160_ = x08 & ~x09 & x15;
