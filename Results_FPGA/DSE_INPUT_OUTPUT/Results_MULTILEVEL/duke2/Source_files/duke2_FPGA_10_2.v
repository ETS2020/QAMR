...
module FAU ( 
  ...
  assign z06 = (x17 & ~x18) | (~x07 & ~x09 & ~x17 & x18 & (new_n90_ | new_n101_));
  ...
  assign z09 = ~x17 & (new_n116_ | (~new_n107_ & x18));
  assign new_n107_ = (~new_n115_ | ~x05) & (x07 | (x05 ? ~new_n114_ : new_n108_));
  assign new_n108_ = (x21 | ((~new_n113_ | x11 | ~x15) & (x09 | new_n109_ | x15))) & (~new_n113_ | ~x09 | x11 | ~x15);
  ...
  assign z16 = (x17 & ~x18) | (x08 & ~x17 & x18 & (x05 ? new_n139_ : ~new_n135_));
  ...
  assign new_n159_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = (x17 & ~x18) | (new_n161_ & x09 & ~x15 & ~x17 & x18);
  assign new_n161_ = ~x05 & ~x07 & x08;
  assign z24 = ~x09 & ~x17 & (new_n163_ | new_n167_);
  assign new_n163_ = ~x07 & (new_n164_ | (~x05 & ~x08 & ~x15 & x18));
  ...
  assign new_n183_ = (~x15 | x19) & (~new_n97_ | x14 | x15 | ~x21);
