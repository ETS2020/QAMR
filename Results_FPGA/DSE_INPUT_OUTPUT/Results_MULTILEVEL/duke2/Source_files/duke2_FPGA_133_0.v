...
module FAU ( 
  ...
  assign new_n149_ = (x14 | (~new_n150_ & ~new_n153_) | x15) & (x08 | ~x15 | ~x19);
  assign new_n150_ = ~new_n151_ & x02;
  assign new_n151_ = (~x06 | x08 | x11 | ~x18 | ~x21) & (~new_n152_ | x06 | ~x08);
  assign new_n152_ = ~x10 & x13 & ~x21;
  assign new_n153_ = x12 & ((~new_n154_ & ~x06) | (new_n155_ & x06 & x08 & x10));
  assign new_n154_ = (x04 | x08 | ~x18 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  assign new_n155_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & new_n75_ & ~x09;
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n62_ | (~new_n158_ & ~x15))));
  assign new_n158_ = ~new_n159_ & (~x04 | ~x05 | ~x08 | new_n61_ | x12);
  assign new_n159_ = ~x09 & ((new_n162_ & ~x05) | (x04 & new_n160_ & x08));
  assign new_n160_ = x10 & ~x12 & ~x14 & ~new_n161_ & ~x21;
  assign new_n161_ = x13 & (x02 | ~x11);
  assign new_n162_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign z21 = ~x17 & ((~new_n164_ & ~x07) | ~x18 | (new_n165_ & ~x05 & x07));
  assign new_n164_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n165_ = x08 & ~x09 & x15;
  assign z22 = ~new_n167_ & ~x17;
  assign new_n167_ = (new_n168_ | x07) & x18 & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign z25 = ~x17 & (~x18 | (~x05 & (new_n76_ | new_n123_) & ~x07));
