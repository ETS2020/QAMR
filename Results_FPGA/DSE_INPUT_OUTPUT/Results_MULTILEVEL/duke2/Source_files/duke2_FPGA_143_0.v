...
module FAU ( 
  ...
  assign z06 = new_n77_ | (~x09 & (new_n104_ | (~x07 & (new_n88_ | new_n103_))));
  assign new_n88_ = ~x17 & (new_n100_ | (~x05 & (new_n97_ | (~new_n89_ & ~x21))));
  ...
  assign new_n93_ = x16 & x18 & ~x13 & ~x14;
  assign new_n94_ = x08 & ~x14 & ((new_n95_ & ~x06) | (~x10 & ~x13));
  assign new_n95_ = x18 & ((x02 & ~x10 & x13) | (x10 & x12 & ~x13 & ~x16));
  ...
  assign z12 = new_n77_ | (~x09 & (new_n121_ | new_n104_));
  assign new_n121_ = ~x07 & (new_n103_ | (~x17 & (~new_n122_ | new_n125_) & ~x21));
  assign new_n122_ = ~new_n124_ & (x05 | (~new_n90_ & ~new_n96_ & (new_n123_ | x15)));
  assign new_n123_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n102_ | ~x08 | x10);
  assign new_n124_ = x04 & x08 & ~x12 & ~x15 & (new_n102_ | x05);
  assign new_n125_ = ~new_n126_ & ~x04;
  assign new_n126_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign z13 = ~x18 & (~x17 | (~x09 & (~x05 | ~x07)));
  assign z14 = new_n131_ | (x08 & ~x17 & ~new_n129_ & x18);
  assign new_n129_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n61_ | new_n130_);
  assign new_n130_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n131_ = ~x05 & ~x09 & x17 & ~x18 & (x07 | x15);
  ...
  assign z17 = new_n77_ | (~x09 & (new_n143_ | (~new_n140_ & ~x05)));
  ...
  assign new_n144_ = ~x17 & ~x21 & ~x11 & x15;
  ...
  assign new_n152_ = ~new_n153_ & (~x04 | ~x05 | ~x08 | new_n61_ | x12);
  assign new_n153_ = ~x09 & ((new_n154_ & ~x05) | (x04 & new_n155_ & x08));
  assign new_n154_ = ~x06 & ~x08 & ~new_n86_ & (~x14 | ~x21);
  assign new_n155_ = x10 & ~x12 & ~x14 & ~new_n156_ & ~x21;
  assign new_n156_ = x13 & (x02 | ~x11);
  assign z21 = ~x17 & (~new_n159_ | (~new_n158_ & ~x07));
  assign new_n158_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | ~x18))) & (x09 | x15 | ~x18 | ~x05 | ~x06 | x08);
  assign new_n159_ = x18 & (x05 | ~x07 | ~x08 | x09 | ~x15 | ~x18);
  assign z22 = ~x17 & ~new_n161_ & x18;
  assign new_n161_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = ~x17 & (~x18 | (new_n150_ & x08 & x09 & ~x15));
  ...
  assign z28 = (~x17 & ~new_n176_ & x18) | (~x09 & x17 & ~new_n186_ & ~x18);
  assign new_n176_ = ~new_n184_ & (x05 | (new_n177_ & (new_n182_ | x02)));
  assign new_n177_ = (~new_n181_ | ~x08) & (x07 | x09 | (x08 ? ~new_n179_ : new_n178_));
  assign new_n178_ = (~x15 | x19) & (~new_n99_ | x14 | x15 | ~x21);
