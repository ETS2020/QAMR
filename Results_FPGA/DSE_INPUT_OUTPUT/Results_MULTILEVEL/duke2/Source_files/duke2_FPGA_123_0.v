...
module FAU ( 
  ...
  assign z06 = new_n78_ | (~x09 & (new_n105_ | (~x07 & (new_n89_ | new_n104_))));
  ...
  assign new_n105_ = ~x15 & ~x18 & ~x05 & x07;
  ...
  assign z10 = (~x17 & (new_n121_ | new_n122_ | ~x18)) | (~x09 & ~new_n120_ & ~x18);
  ...
  assign z12 = new_n78_ | (~x09 & (new_n124_ | new_n105_));
  assign new_n124_ = ~x07 & (new_n104_ | (~x17 & (~new_n125_ | new_n128_) & ~x21));
  assign new_n125_ = ~new_n127_ & (x05 | (~new_n91_ & ~new_n97_ & (new_n126_ | x15)));
  ...
  assign z13 = ~x18 & (~x17 | (~new_n120_ & ~x09));
  ...
  assign new_n164_ = (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15))) & (x09 | x15 | ~x18 | ~x05 | ~x06 | x08);
  ...
  assign new_n174_ = ~x21 & (new_n128_ | new_n175_);
  assign new_n175_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n176_ = new_n154_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n177_ = ~x05 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = new_n188_ | (~x17 & (~new_n186_ | (~new_n179_ & ~x05)));
  ...
  assign new_n184_ = (~x15 | x19) & (~new_n100_ | x14 | x15 | ~x21);
