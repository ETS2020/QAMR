...
module FAU ( 
  ...
  assign new_n84_ = ~x14 & ~x15 & (new_n85_ | (~new_n90_ & ~x06) | (~new_n87_ & x06));
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n93_ | (new_n106_ & ~x15 & x17)));
  assign new_n93_ = ~x07 & (new_n105_ | (x18 & (new_n103_ | (~new_n94_ & ~x15))));
  ...
  assign new_n108_ = ~x17 & (~new_n65_ | x05 | ~x09 | x15 | ~x16);
  assign new_n109_ = x05 ^ ~x15;
  assign z08 = x14 & ~x20 & (~x17 | ~x18);
  assign z09 = (new_n112_ & ~x17) | (~x07 & ~x09 & new_n121_ & ~x15);
  assign new_n112_ = x18 & ((new_n119_ & x05) | (~x07 & (x05 ? new_n120_ : ~new_n113_)));
  ...
  assign new_n119_ = x08 & ~new_n78_ & ~x15;
  assign new_n120_ = ~x09 & (x08 ? x21 : (~x15 & ~x19));
  assign new_n121_ = ~x18 & (x17 | (new_n100_ & x12 & ~x14 & ~x21));
  ...
  assign z12 = (x17 & x18) | (~x09 & (new_n129_ | (new_n106_ & ~x15 & x17)));
  assign new_n129_ = ~x07 & (new_n105_ | (x18 & (~new_n130_ | new_n137_) & ~x21));
  assign new_n130_ = (~new_n136_ | ~x04) & (x05 | (new_n131_ & (~x04 | new_n135_ | x12)));
  ...
  assign new_n141_ = x18 & (x07 ? (~new_n109_ & ~x19) : new_n142_);
  ...
  assign z17 = (x17 & x18) | (~new_n155_ & ~x09);
  ...
  assign z20 = (x17 & x18) | (~new_n166_ & ~x07);
  assign new_n166_ = ~new_n167_ & (~new_n159_ | ~x08 | x09 | x04 | ~x05);
  assign new_n167_ = ~x15 & (new_n171_ | (x18 & (new_n173_ | (~new_n168_ & ~x09))));
  ...
  assign new_n171_ = new_n172_ & new_n100_ & ~x09 & x12;
  assign new_n172_ = ~x18 & ~x21 & ~x14 & ~x17;
  ...
  assign new_n177_ = (new_n178_ | x07) & ~x17 & (x05 | ~x07 | ~x08 | ~x15);
  assign new_n178_ = (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign z23 = x18 & (x17 | (new_n180_ & ~x05 & ~x07));
  ...
  assign new_n186_ = x08 & ~x15 & ~x18 & new_n106_ & x01;
