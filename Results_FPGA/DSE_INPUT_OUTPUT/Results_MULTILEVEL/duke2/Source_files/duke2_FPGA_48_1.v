...
module FAU ( 
  ...
  assign new_n86_ = (x07 | ~x17 | x18) & (x05 | ((~x17 | x18) & (x06 | x07 | x08 | x17 | ~x18)));
  assign z11 = new_n88_ & ~x18;
  assign new_n88_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (~x15 & x18) | (~x09 & (new_n90_ | (new_n93_ & ~x15 & x17 & ~x18)));
  assign new_n90_ = ~x07 & (((new_n74_ | new_n75_) & ~x05) | (new_n91_ & new_n92_));
  ...
  assign z17 = z05 | (~x09 & (new_n104_ | new_n105_));
  assign new_n104_ = new_n60_ & new_n92_;
  ...
  assign new_n120_ = new_n93_ & x01 & x08 & ~x15 & ~x18;
  assign z25 = x18 & ~x17 & x15 & ~x09 & new_n55_ & ~x08;
  assign z26 = ~x20 & ~z05 & (x14 | x21);
  assign z27 = z05 | (~x09 & (new_n104_ | (~new_n124_ & ~x05)));
  assign new_n124_ = (~x07 | (~new_n125_ & (x15 | ~x17))) & (~x00 | x07 | ~x15 | ~x17 | x18);
  assign new_n125_ = x08 & ~x17 & x18 & x19;
  assign z28 = (~new_n127_ & ~x05) | z05 | (~x07 & ~new_n131_ & ~x09);
