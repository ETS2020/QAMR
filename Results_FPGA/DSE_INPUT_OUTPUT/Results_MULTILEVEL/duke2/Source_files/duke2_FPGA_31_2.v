...
module FAU ( 
  ...
  assign new_n78_ = (x09 | ((~x05 | x15 | (~x07 ^ ~x08)) & (~x08 | ~x15 | x05 | ~x07))) & (x05 | x07 | ~x08 | ~x09 | x15);
  assign z04 = z13 | (~x14 & ~x20);
  assign z05 = z13 | (~x05 & ~x07 & ~x09 & new_n81_ & ~x14);
  assign new_n81_ = ~x15 & ~x17 & x18 & (new_n82_ | new_n84_ | new_n87_);
  ...
  assign new_n94_ = (x06 | ((~x02 | x10 | ~x13) & (~x10 | ~x12 | x13 | x16))) & (x10 | x13);
  ...
  assign z09 = ~x17 & (new_n107_ | new_n116_);
  ...
  assign new_n116_ = new_n54_ & new_n55_ & ~x15 & ~x18 & ~x21;
  assign z10 = x17 ? ~x18 : (~new_n118_ & x18);
  assign new_n118_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = ~new_n120_ & ~x18;
  assign new_n120_ = ~x17 & (~x01 | x05 | ~x07 | x09 | x15);
  assign z12 = ~x07 & ~x09 & ~x17 & x18 & ~new_n122_ & ~x21;
  assign new_n122_ = ~new_n123_ & ~new_n127_ & (x05 | (~new_n98_ & ~new_n125_ & ~new_n100_));
  ...
  assign new_n127_ = x04 & x08 & ~x12 & ~new_n102_ & ~x15;
  ...
  assign new_n145_ = (x14 | x15 | (~new_n82_ & ~new_n146_)) & (x08 | ~x15 | ~x19);
  assign new_n146_ = x12 & ((~new_n147_ & ~x06) | (new_n86_ & x06 & x08 & x10));
  assign new_n147_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z20 = z13 | (~x07 & (new_n155_ | (~new_n149_ & ~x15)));
  assign new_n149_ = ~new_n153_ & (x17 | ~x18 | (~new_n154_ & (new_n150_ | x09)));
  assign new_n150_ = (~new_n152_ | x05) & (~x04 | ~x08 | ~new_n151_ | ~x10);
  assign new_n151_ = ~x12 & ~x14 & ~new_n138_ & ~x21;
  assign new_n152_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n153_ = x04 & ~x05 & ~x09 & new_n55_ & ~x18 & ~x21;
  assign new_n154_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign new_n155_ = new_n64_ & ~x04 & x05 & x08 & ~x09;
  assign z21 = x17 ? ~x18 : (~new_n157_ & x18);
  assign new_n157_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n159_ & x18;
  assign new_n159_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n161_ & x08;
  assign new_n161_ = ~x05 & ~x07;
  assign z24 = z13 | (~x09 & (new_n167_ | (~new_n163_ & ~x07)));
  assign new_n163_ = ~new_n164_ & (x05 | x08 | x15 | x17 | ~x18);
  assign new_n164_ = ~x21 & ((x04 & ~new_n165_ & ~x15) | (x08 & new_n166_ & x15));
  assign new_n165_ = (~x05 | ~x08 | x12 | x17 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n166_ = ~x17 & x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n167_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = (x17 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n169_ & x18);
  assign new_n169_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  ...
  assign new_n173_ = ~x21 & (new_n123_ | new_n174_);
  assign new_n174_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n175_ = new_n161_ & x03 & ~x15 & x19 & x08 & x09;
  assign z28 = ~x17 & ((x18 & (new_n184_ | (~new_n177_ & ~x05))) | (new_n186_ & ~x05));
  ...
  assign new_n182_ = (~x15 | x19) & (~new_n97_ | x14 | x15 | ~x21);
  ...
  assign new_n186_ = x07 & ~x09 & x15 & ~new_n71_ & ~x18;
  assign z15 = 1'b0;
  assign z19 = 1'b0;
endmodule
