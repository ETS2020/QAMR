...
module FAU ( 
  ...
  assign z03 = (~new_n80_ & ~x09) | new_n78_ | (x14 & ~x18);
  ...
  assign z05 = (x14 & ~x18) | (~x05 & ~x07 & ~x09 & new_n83_ & ~x14);
  ...
  assign z06 = (x14 & ~x18) | (~x09 & (new_n107_ | (~new_n92_ & ~x07)));
  ...
  assign z12 = (x14 & ~x18) | (~x09 & (new_n107_ | (~new_n129_ & ~x07)));
  ...
  assign new_n141_ = ~x18 & ~x21 & x12 & ~x15;
  ...
  assign z16 = (x14 & ~x18) | (x08 & ~x17 & ~new_n147_ & x18);
  ...
  assign z17 = (x14 & ~x18) | (~x09 & (new_n156_ | (~new_n153_ & ~x05)));
  ...
  assign z19 = ~x18 & (x14 | (new_n56_ & ~x09 & ~x15 & x17));
  assign z20 = (x14 & ~x18) | (~x07 & ~new_n163_ & ~x17);
  ...
  assign new_n169_ = x12 & ~x18 & ~x21 & x04 & ~x05 & ~x09;
  ...
  assign new_n182_ = ~x15 & ~x18 & x08 & ~x14;
  assign z25 = (x14 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n184_ & x18);
  ...
  assign new_n190_ = (~x14 | x18) & (~new_n191_ | ~new_n79_ | x17 | ~x18 | ~x19);
  assign new_n191_ = x03 & ~x05 & ~x07 & x08;
  assign new_n192_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n194_ | new_n205_)) | (~x09 & ~x14 & new_n207_ & x17);
  ...
  assign new_n206_ = ~x09 & ~x14 & x15 & ~new_n71_ & ~x18;
