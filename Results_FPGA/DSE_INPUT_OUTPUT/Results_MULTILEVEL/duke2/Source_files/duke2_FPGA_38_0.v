...
module FAU ( 
  ...
  assign new_n105_ = new_n76_ & x09 & ~x15 & x16;
  ...
  assign z12 = ~x09 & ((~new_n121_ & ~x07) | (new_n129_ & ~x05 & x07));
  assign new_n121_ = (x17 | ~x18 | new_n122_ | x21) & (~new_n128_ | ~x15 | ~x17 | x18);
  assign new_n122_ = ~new_n123_ & ~new_n127_ & (x05 | (~new_n91_ & ~new_n125_ & ~new_n99_));
  ...
  assign new_n148_ = ~x11 & x15 & ~x17 & ~x21;
  ...
  assign new_n161_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15);
  ...
  assign new_n175_ = (new_n123_ | new_n176_) & ~x21;
