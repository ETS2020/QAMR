...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n164_, new_n166_, new_n167_, new_n169_, new_n170_, new_n174_,
  ...
  assign z23 = ~x17 & (~x18 | (new_n76_ & new_n77_));
  assign new_n76_ = ~x05 & ~x07;
  assign new_n77_ = x08 & x09 & ~x15;
  assign new_n78_ = (x17 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (x18 | (x05 & x07));
  assign z04 = (~x14 & ~x20) | (~x17 & ~x18);
  assign z05 = ~x17 & (~x18 | (~x05 & ~x07 & new_n81_ & ~x09));
  assign new_n81_ = ~x14 & ~x15 & (new_n82_ | (~new_n84_ & x06) | (~new_n87_ & ~x06));
  ...
  assign z06 = (~x17 & ~x18) | (~x09 & (new_n90_ | (new_n105_ & ~x15 & ~x18)));
  ...
  assign new_n121_ = ~x15 & ((x05 & ((x07 & x08) | (~x08 & ~x09 & ~x06 & ~x07))) | (~x05 & ~x07 & x08 & x09));
  assign new_n122_ = ~x08 & ~x09 & x15;
  assign z12 = ~x09 & ((~new_n124_ & ~x07) | (~x05 & x07 & new_n131_ & ~x15));
  assign new_n124_ = (x17 | ~x18 | new_n125_ | x21) & (~new_n104_ | ~x15 | ~x17 | x18);
  assign new_n125_ = ~new_n126_ & ~new_n130_ & (x05 | (~new_n92_ & ~new_n128_ & ~new_n100_));
  ...
  assign new_n141_ = (new_n142_ | (new_n143_ & (~x02 | ~x06))) & (~x12 | new_n143_ | (~x06 ^ x16));
  ...
  assign new_n147_ = (x07 | ((x08 | ~new_n148_ | x15) & (~new_n131_ | ~x00 | ~x15))) & (~new_n131_ | ~x07 | x15);
  ...
  assign new_n152_ = (x14 | new_n153_ | x15) & (x08 | ~x15 | ~x19);
  assign new_n153_ = (new_n154_ | ~x12) & (~x02 | (~new_n83_ & ~new_n156_));
  assign new_n154_ = (x06 | (~new_n155_ & (~new_n88_ | ~x08 | ~x10))) & (~new_n86_ | ~x06 | ~x08 | ~x10);
  assign new_n155_ = ~x04 & ~x08 & x18 & x21;
  assign new_n156_ = x06 & ~x08 & ~x11 & x18 & x21;
  assign z19 = ~x18 & x17 & ~x15 & new_n76_ & ~x09;
  assign z20 = ~x07 & ~x17 & x18 & (new_n62_ | (~new_n159_ & ~x15));
  assign new_n159_ = (x09 | ((~new_n160_ | ~x04) & (~new_n162_ | x05))) & (~x04 | ~new_n161_ | ~x05);
  assign new_n160_ = x08 & x10 & ~x12 & ~x14 & ~new_n143_ & ~x21;
  assign new_n161_ = x08 & ~new_n60_ & ~x12;
  assign new_n162_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign z21 = ~x17 & ~new_n164_ & x18;
  assign new_n164_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~new_n166_ & ~x17;
  assign new_n166_ = (new_n167_ | x07) & x18 & (~x08 | ~x15 | x05 | ~x07);
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & (new_n77_ | new_n122_) & x18;
  ...
  assign new_n175_ = (new_n126_ | new_n176_) & ~x21;
  assign new_n176_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n177_ = new_n76_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n178_ = ~x05 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
