...
module FAU ( 
  ...
  assign new_n80_ = ~new_n81_ & (x17 | new_n82_ | ~x18);
  assign new_n81_ = x00 & x17 & ~x18 & (~x05 | ~x07);
  ...
  assign new_n95_ = (x07 | ((x17 | new_n96_ | ~x18) & (~x17 | x18 | x05 | ~x15))) & (x05 | ~x07 | x15 | ~x17 | x18);
  ...
  assign z07 = (~x17 & ~new_n108_ & x18) | (~x00 & ~x18);
  ...
  assign z10 = (new_n124_ & x08) | (~x09 & (new_n81_ | (new_n123_ & ~x06)));
  ...
  assign z12 = new_n68_ | (~new_n128_ & ~x09);
  assign new_n128_ = (x05 | ~x07 | x15 | ~x17 | x18) & (x07 | ((~x17 | x18 | x05 | ~x15) & (x17 | ~new_n129_ | ~x18)));
  ...
  assign new_n166_ = x17 & ~x15 & ~x09 & ~x07 & x00 & ~x05;
  assign z20 = new_n68_ | (~x07 & ~x17 & (new_n174_ | (~new_n168_ & ~x15)));
  ...
  assign new_n174_ = new_n67_ & new_n160_ & x08 & ~x09 & ~x04 & x05;
  assign z21 = (~x17 & ~new_n176_ & x18) | (~x00 & ~x18);
  assign new_n176_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (~x08 | x09 | ~x15 | x05 | ~x07);
  assign z22 = ~x17 & ~new_n178_ & x18;
  assign new_n178_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = (~x00 & ~x18) | (new_n83_ & ~x17 & x18 & x09 & ~x15);
  assign z24 = new_n68_ | (~x09 & ~x17 & (new_n181_ | new_n185_));
  ...
  assign new_n190_ = ~x09 & (x05 ? (~x17 & ~new_n193_ & x18) : ~new_n191_);
  assign new_n191_ = ~new_n159_ & (x17 | new_n192_ | ~x18);
  assign new_n192_ = (x07 | x08 | x15 | new_n158_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n193_ = (x07 | ((~new_n194_ | x04 | ~x08) & (x08 | x15 | ~x19))) & (x15 | ~x19 | ~x07 | ~x08);
  assign new_n194_ = ~x11 & x15 & ~x21;
  assign new_n195_ = ~x17 & x18 & x19 & x09 & ~x15;
  assign z28 = (~x17 & (new_n208_ | (~new_n197_ & x18))) | (~x18 & (new_n210_ | ~x00));
  assign new_n197_ = (~new_n205_ | x07) & (x05 | (~new_n198_ & ~new_n207_ & (~new_n201_ | x07)));
  assign new_n198_ = ~new_n199_ & ~x02;
  assign new_n199_ = (~x08 | ~x15) & (~new_n200_ | x08 | x09 | ~x06 | x07);
  assign new_n200_ = x11 & ~x14 & ~x15 & x21;
  assign new_n201_ = ~x09 & (x08 ? (x10 & new_n204_ & x12) : ~new_n202_);
