...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n101_ | (~x07 & ~x17 & ~new_n90_ & x18));
  assign new_n90_ = (x15 | (~new_n91_ & (~new_n98_ | x05))) & (x02 | ~new_n100_ | x05);
  assign new_n91_ = ~x21 & (new_n92_ | new_n94_ | (new_n97_ & x04 & ~x05));
  assign new_n92_ = ~x02 & x11 & (new_n93_ | (~x05 & x06 & ~x08));
  assign new_n93_ = x04 & x08 & x10 & ~x12 & ~x14;
  assign new_n94_ = x08 & (new_n95_ | (~x05 & ~new_n96_ & ~x14));
  ...
  assign new_n98_ = ~x08 & ~x14 & (new_n99_ | (~x02 & x06 & x11));
  assign new_n99_ = x04 & ~x06 & ~x12;
  assign new_n100_ = x08 & x11 & ~x21 & (x15 | (~x10 & ~x14));
  assign new_n101_ = ~x05 & x07 & ~x15 & x17 & ~x18;
  assign z07 = new_n80_ | (~x17 & (new_n103_ | new_n104_));
  assign new_n103_ = new_n78_ & ~x05 & x09 & ~x15 & x16 & x18;
  assign new_n104_ = ~x09 & (x07 ^ ~x08) & (x05 ? (~x15 & x18) : x15);
  assign z08 = new_n80_ | (x14 & ~x20);
  assign z09 = (~x17 & ((~new_n107_ & x18) | (new_n114_ & x02))) | (~new_n115_ & ~x18);
  assign new_n107_ = ~new_n112_ & (x15 | (~new_n113_ & (x07 | new_n108_ | x09)));
  assign new_n108_ = x05 ? (x08 | x19) : (x21 | (~new_n109_ & new_n110_));
  assign new_n109_ = x04 & (new_n97_ | (x13 & ~x14 & x02 & x08));
  ...
  assign z10 = (~new_n117_ & ~x15) | (new_n119_ & new_n76_ & ~x09 & x15);
  ...
  assign z12 = new_n80_ | (~new_n123_ & ~x09);
  assign new_n123_ = ~new_n136_ & (x07 | x17 | (new_n124_ & ~new_n134_) | x21);
  assign new_n124_ = ~new_n133_ & (~x18 | (~new_n131_ & (x05 | (~new_n125_ & new_n127_))));
  assign new_n125_ = x04 & ~new_n126_ & ~x12;
  assign new_n126_ = (x02 | ~x08 | ~x11 | x14) & (x06 | x08 | x15);
  assign new_n127_ = (~new_n128_ | x02) & (x15 | (~new_n129_ & ~new_n130_));
  assign new_n128_ = x11 & ((x08 & ~x10 & ~x14) | (x06 & ~x08 & ~x15));
  assign new_n129_ = ~x08 & ~x11 & x02 & x06;
  assign new_n130_ = x08 & ~x10 & ~x13 & ~x14;
  assign new_n131_ = new_n132_ & x04;
  assign new_n132_ = x08 & ~x12 & ~x15 & (x05 | (~x13 & ~x14));
  assign new_n133_ = ~x02 & ~x05 & x08 & x11 & x15;
  assign new_n134_ = ~x04 & (new_n135_ | (x05 & x08 & ~x11 & x15));
  assign new_n135_ = x12 & ~x15 & x18 & ~x05 & ~x06 & ~x08;
  assign new_n136_ = ~x05 & x07 & x17 & ~x18;
  assign z13 = ~x18 & (x15 | (~x09 & x17 & (~x07 | (~x05 & x07))));
  assign z14 = (~new_n144_ & ~x18) | (~x17 & (new_n142_ | (~new_n139_ & x08)));
  assign new_n139_ = x07 ? (x19 | (x05 ? (x15 | ~x18) : ~x15)) : ~new_n140_;
  assign new_n140_ = ~new_n61_ & (new_n141_ | (x11 & x15 & ~x02 & ~x05));
  assign new_n141_ = x04 & x05 & ~x12 & ~x15 & x18;
  assign new_n142_ = new_n143_ & ~x07 & ~x09 & x04 & ~x05;
  assign new_n143_ = x12 & ~x14 & ~x18 & ~x21;
  assign new_n144_ = ~x15 & (x05 | ~x07 | x09 | (x01 & ~x17));
  ...
  assign new_n149_ = ~x14 & ~x21 & ((~new_n59_ & ~new_n150_) | (~new_n151_ & x12));
  assign new_n150_ = (~x02 | ~x06) & x13 & (x02 | ~x11);
  assign new_n151_ = ((x13 & (x02 | ~x11)) | (~x06 ^ x16)) & (~x06 | x10 | ~x11);
  assign z17 = ~x09 & ((new_n156_ & new_n78_ & ~x04 & x05) | (new_n153_ & ~x05));
  ...
  assign z18 = new_n80_ | (~x05 & ~x07 & new_n158_ & ~x09);
  assign new_n158_ = ~x17 & ((~x14 & new_n159_ & ~x15) | (~x08 & x15 & x19));
  assign new_n159_ = x18 & (new_n83_ | (x12 & (new_n161_ | (~new_n160_ & ~x06))));
  ...
  assign new_n164_ = (new_n165_ | ~x18) & (~new_n143_ | ~x04 | x05 | x09);
  ...
  assign z22 = new_n175_ | new_n80_;
  assign new_n175_ = ~x17 & ((~new_n176_ & ~x07) | (x08 & x15 & ~x05 & x07));
  assign new_n176_ = (x05 | ((~x08 | ~x09 | x15 | ~x18) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign z23 = (x15 & ~x18) | (new_n78_ & ~x05 & x09 & ~x15 & ~x17 & x18);
  ...
  assign z27 = new_n188_ | (new_n193_ & new_n78_ & x03 & ~x05);
  assign new_n188_ = ~x09 & (new_n101_ | (~x17 & ~new_n189_ & x18));
  ...
  assign z28 = new_n204_ | (~x17 & (new_n202_ | ((~new_n195_ | new_n199_) & ~x05)));
  assign new_n195_ = (x07 | new_n196_ | x09) & (~x08 | ~x15 | (~x07 & x11));
  assign new_n196_ = x08 ? (~x10 | ~x12 | ~new_n198_ | x14) : new_n197_;
  assign new_n197_ = (~x15 | x19) & (~new_n99_ | ~x18 | ~x21 | x14 | x15);
