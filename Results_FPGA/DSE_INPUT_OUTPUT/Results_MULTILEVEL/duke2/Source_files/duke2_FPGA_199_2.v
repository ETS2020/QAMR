...
module FAU ( 
  ...
  assign new_n76_ = ((~new_n65_ & ~x07) | (~x05 ^ x15)) & (~x05 | new_n77_ | x15) & (x05 | x11 | ~x15);
  ...
  assign new_n108_ = new_n109_ & ~x16 & x00 & ~x05 & x15;
  ...
  assign z11 = ~x18 & (new_n130_ | x16);
  assign new_n130_ = ~x09 & ~x15 & ~x17 & x01 & ~x05 & x07;
  assign z12 = ~x09 & (new_n110_ | (~x07 & (new_n108_ | (new_n132_ & ~x17))));
  ...
  assign new_n135_ = x08 & ~x12 & ~x15 & (new_n107_ | x05);
  ...
  assign new_n139_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n65_ | new_n140_);
  ...
  assign new_n143_ = ~new_n144_ & ~x16;
  assign new_n144_ = ~x05 & ~x09 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n146_ & ~x18;
  assign new_n146_ = ~x16 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = new_n83_ | (x08 & ~new_n148_ & ~x17);
  assign new_n148_ = x05 ? (~new_n155_ | ~x09) : ((~new_n149_ | x07) & (~new_n154_ | ~x09));
  assign new_n149_ = ~x15 & (x09 ? (x18 & ~x19) : (new_n150_ & ~x14));
  assign new_n150_ = ~x21 & (new_n153_ | (x18 & (new_n152_ | (~new_n63_ & ~new_n151_))));
  assign new_n151_ = (~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11);
  assign new_n152_ = x06 & x12 & ~x16 & (~x13 | (~x02 & x11));
  assign new_n153_ = ~x06 & x12 & x16 & (~x13 | (~x02 & x11));
  assign new_n154_ = x15 & x18 & (~x02 | x07);
  assign new_n155_ = ~x15 & x18 & (x07 | ~x12);
  assign z17 = new_n83_ | (~x09 & (new_n160_ | (~new_n157_ & ~x05)));
  assign new_n157_ = (x07 | ((x08 | ~new_n158_ | x15) & (~new_n109_ | ~x00 | ~x15))) & (~new_n109_ | ~x07 | x15);
  ...
  assign z18 = new_n83_ | (~x05 & ~x07 & ~x09 & ~new_n162_ & ~x17);
  assign new_n162_ = (x14 | new_n163_ | x15) & (x08 | ~x15 | ~x18 | ~x19);
  assign new_n163_ = ~new_n164_ & (~x18 | (~new_n88_ & (x06 | new_n166_ | ~x12)));
  ...
  assign new_n196_ = ~x16 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
