...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n104_ | (x00 & ~new_n93_ & ~x07));
  assign new_n93_ = (x17 | ~x18 | (~new_n102_ & (new_n94_ | x15))) & (x05 | ~x15 | ~x17 | x18);
  ...
  assign z07 = x00 & ~x17 & ~new_n106_ & x18;
  assign new_n106_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = (~x00 & x18) | (x14 & ~x20);
  assign z09 = new_n117_ | (x18 & (~x00 | (~new_n109_ & ~x17)));
  assign new_n109_ = (x07 | (x05 ? ~new_n116_ : new_n110_)) & (~x05 | ~new_n77_ | ~x08);
  ...
  assign z10 = (x18 & (~x00 | (~new_n120_ & ~x17))) | (~x09 & x17 & ~new_n81_ & ~x18);
  ...
  assign z12 = ~x09 & (new_n104_ | (x00 & ~new_n124_ & ~x07));
  ...
  assign new_n137_ = ~x17 & (new_n141_ | (x00 & new_n138_ & x08));
  ...
  assign z16 = x00 & x08 & ~x17 & x18 & (new_n146_ | new_n150_);
  ...
  assign z17 = ~x09 & (new_n104_ | (x00 & ~new_n152_ & ~x07));
  assign new_n152_ = (new_n153_ | x05) & (~new_n156_ | x04 | ~x05 | ~x08 | x11);
  assign new_n153_ = (~x15 | ~x17 | x18) & (x08 | x15 | x17 | ~new_n154_ | ~x18);
  assign new_n154_ = ~new_n155_ & (~x21 | (~x14 & x21));
  assign new_n155_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n156_ = x15 & ~x17 & x18 & ~x21;
  assign z18 = x00 & ~x05 & ~x07 & ~x09 & new_n158_ & ~x17;
  ...
  assign z20 = ~x07 & ~x17 & (new_n169_ | (new_n164_ & x00));
  assign new_n164_ = x18 & (new_n64_ | (~x15 & (new_n168_ | (~new_n165_ & ~x09))));
  ...
  assign z22 = x18 & (new_n174_ | ~x00);
  assign new_n174_ = ~x17 & ((~new_n175_ & ~x07) | (x08 & x15 & ~x05 & x07));
  assign new_n175_ = (~x00 | ~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  assign z23 = x18 & new_n177_ & ~x17;
  assign new_n177_ = ~x15 & x09 & x08 & ~x07 & x00 & ~x05;
  assign z24 = (~x00 & x18) | (~x09 & ~x17 & (new_n179_ | new_n183_));
  ...
  assign new_n196_ = ~x18 & (x05 | ~x07 | x09 | x15 | ~x17);
  assign z28 = (~new_n198_ & ~x17) | (~x00 & x18) | (~x09 & x17 & ~new_n206_ & (~x00 | ~x18));
  assign new_n198_ = (new_n199_ | x05) & (x07 | ~x08 | new_n205_ | ~x18);
  assign new_n199_ = (new_n200_ | ~x15) & (x07 | x09 | x14 | ~new_n203_ | x15);
  assign new_n200_ = ~new_n202_ & (new_n201_ | (x02 & x11));
  assign new_n201_ = (~x07 | x09 | (x00 & x18)) & (~x08 | ~x18);
  assign new_n202_ = x18 & ((x07 & x08) | (~x07 & ~x08 & ~x09 & ~x19));
  assign new_n203_ = x18 & (x08 ? new_n204_ : (~new_n100_ & x21));
