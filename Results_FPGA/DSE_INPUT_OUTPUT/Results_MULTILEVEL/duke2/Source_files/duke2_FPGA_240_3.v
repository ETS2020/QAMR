...
module FAU ( 
  ...
  assign new_n54_ = ~new_n55_ & (~new_n56_ | ~new_n57_ | x14 | x15);
  assign new_n55_ = x17 & ((x05 & (~x07 | ~x15)) | (~x05 & x15 & (~x00 | x07)) | (~x07 & ~x15));
  assign new_n56_ = x04 & ~x05 & ~x07 & x12;
  assign new_n57_ = ~x18 & ~x21;
  assign new_n58_ = x17 & x18;
  assign z01 = (x18 & (new_n60_ | x17)) | (new_n67_ & x11 & x15 & ~x17 & ~x18);
  assign new_n60_ = ~x07 & ((~new_n61_ & ~x05) | (new_n66_ & ~x04 & x05 & x08));
  assign new_n61_ = (x09 | ((~new_n64_ | ~x06) & (~new_n62_ | x02))) & (~new_n65_ | x02);
  assign new_n62_ = x08 & x11 & x13 & ~x14 & ~new_n63_ & ~x21;
  assign new_n63_ = x10 & (~x04 | x12);
  assign new_n64_ = ~x08 & ~x15 & (~x14 | ~x21) & (~x02 ^ ~x11);
  assign new_n65_ = x08 & x11 & x15 & (x09 | ~x21);
  assign new_n66_ = ~x09 & ~x11 & x15 & ~x21;
  assign new_n67_ = x02 & ~x05 & x07 & ~x09;
  assign z02 = (~new_n69_ & ~x09) | (x18 & (x17 | (~new_n76_ & x08)));
  assign new_n69_ = (x15 | ((~new_n75_ | ~x01) & (new_n73_ | ~x18))) & (new_n70_ | ~x18);
  ...
  assign new_n87_ = (~new_n88_ | ~new_n89_) & (x02 | x08 | ~x11 | ~x21);
  ...
  assign z06 = new_n58_ | (~x09 & ((~new_n93_ & ~x07) | (new_n110_ & ~x05 & x07)));
  ...
  assign new_n99_ = ~x13 & ~x14 & x16 & ~x17;
  ...
  assign new_n123_ = ~x18 & (x17 | (new_n124_ & x12 & x04 & ~x05));
  ...
  assign z12 = ~x09 & ((~new_n132_ & ~x07) | (new_n140_ & ~x05 & x07));
  ...
  assign new_n144_ = new_n145_ & new_n57_ & ~x15 & ~x17;
  ...
  assign new_n153_ = (new_n63_ | (new_n154_ & (~x02 | ~x06))) & (~x12 | new_n154_ | (~x06 ^ x16));
  assign new_n154_ = x13 & (x02 | ~x11);
  assign new_n155_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = new_n58_ | (~new_n157_ & ~x09);
  ...
  assign new_n173_ = x04 & ~x05 & ~x09 & new_n57_ & x12 & ~x14;
  ...
  assign new_n185_ = new_n130_ & x08 & ~x15 & ~x18;
  assign z25 = x18 & (x17 | (~x05 & ~x07 & (new_n81_ | new_n128_)));
  assign z26 = ~x20 & ~new_n58_ & ~new_n124_;
