...
module FAU ( 
  ...
  assign z12 = (~x17 & ~x18) | (~x09 & (new_n102_ | (~new_n120_ & ~x07)));
  ...
  assign z14 = (x08 & new_n127_ & ~x17) | (~x05 & ~x09 & new_n130_ & x17);
  ...
  assign new_n146_ = (x14 | (~new_n80_ & ~new_n147_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n61_ | (~new_n151_ & ~x15))));
  ...
  assign new_n174_ = (~x08 | ~x15) & (~new_n175_ | x08 | x09 | ~x06 | x07);
