...
module FAU ( 
  ...
  assign new_n92_ = ~new_n100_ & (x21 | (~new_n93_ & ~new_n99_ & (new_n95_ | ~x08)));
  ...
  assign new_n104_ = x00 & ~x05 & x15 & x17;
  ...
  assign z12 = ~x09 & ((~new_n127_ & ~x07) | (~x05 & x07 & new_n138_ & ~x15));
  assign new_n127_ = ~new_n137_ & (x17 | ~x18 | x21 | (new_n128_ & ~new_n135_));
  ...
  assign new_n137_ = x00 & ~x05 & new_n138_ & x15;
  assign new_n138_ = x17 & ~x18;
  assign z13 = x17 & (x18 | (~new_n121_ & ~x09));
  assign z14 = (new_n146_ & ~x05) | (~x17 & (new_n141_ | (new_n143_ & x08)));
  ...
  assign z16 = x18 & (x17 | (x08 & (x05 ? new_n154_ : ~new_n149_)));
  ...
  assign new_n162_ = (x14 | x15 | (~new_n83_ & ~new_n163_)) & (x08 | ~x15 | ~x19);
  assign new_n163_ = x12 & ((~new_n164_ & ~x06) | (new_n87_ & x06 & x08 & x10));
  assign new_n164_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~new_n167_ & ~x17;
  assign new_n167_ = ~new_n168_ & (~new_n160_ | x04 | ~x05 | ~x08 | x09);
  ...
  assign new_n186_ = new_n105_ & x01 & ~x17 & ~x18 & x08 & ~x15;
