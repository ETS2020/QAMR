...
module FAU ( 
  ...
  assign z12 = ~x09 & (new_n104_ | (~x07 & (new_n103_ | (new_n123_ & ~x17))));
  assign new_n123_ = x18 & ~x21 & ((~new_n127_ & ~x04) | new_n124_ | (new_n126_ & x04));
  assign new_n124_ = ~x05 & (new_n92_ | new_n100_ | (~new_n125_ & ~x15));
  assign new_n125_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n102_ | ~x08 | x10);
  assign new_n126_ = x08 & ~x12 & (new_n102_ | x05) & ~x15;
  ...
  assign z18 = ~x17 & (~x18 | (~x05 & new_n147_ & ~x07));
  assign new_n147_ = ~x09 & ((~x14 & ~new_n148_ & ~x15) | (~x08 & x15 & x19));
  ...
  assign new_n162_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  ...
  assign z25 = ~x17 & (~x18 | (~x05 & (new_n76_ | new_n121_) & ~x07));
  ...
  assign new_n173_ = new_n75_ & x03 & x08 & x09 & ~x15 & x19;
