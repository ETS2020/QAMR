...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n105_ | (~x07 & (new_n107_ | (new_n92_ & ~x17))));
  ...
  assign new_n109_ = ~x17 & (~new_n80_ | ~x09 | x15 | ~x16);
  ...
  assign z12 = ~x09 & (new_n105_ | (~x07 & (new_n107_ | (new_n131_ & ~x17))));
  ...
  assign new_n138_ = x18 & (x07 ? (~new_n110_ & ~x19) : new_n139_);
  ...
  assign new_n158_ = (x14 | x15 | (~new_n84_ & ~new_n159_)) & (x08 | ~x15 | ~x19);
  assign new_n159_ = x12 & ((~new_n160_ & ~x06) | (new_n88_ & x06 & x08 & x10));
  ...
  assign new_n164_ = (x09 | ((~new_n166_ | ~x04) & (~new_n165_ | x05))) & (~x04 | ~new_n167_ | ~x05);
  ...
  assign z21 = x18 & ((~new_n171_ & ~x07) | x17 | (new_n172_ & ~x05 & x07));
  assign new_n171_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n172_ = x08 & ~x09 & x15;
  assign z22 = x18 & (new_n174_ | x17 | (new_n106_ & x08 & x15));
  assign new_n174_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  assign z23 = x18 & (x17 | (new_n176_ & ~x05 & ~x07));
  ...
  assign new_n180_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x17 | x18 | x05 | ~x12);
  ...
  assign new_n205_ = x07 & ~x09 & x15 & (~x02 | ~x11) & ~x18;
