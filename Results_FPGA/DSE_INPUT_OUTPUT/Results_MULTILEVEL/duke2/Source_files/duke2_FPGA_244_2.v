...
module FAU ( 
  ...
  assign new_n77_ = new_n78_ & x07 & x08 & x01 & ~x05;
  assign new_n78_ = ~x09 & ~x15 & ~x16 & ~x18;
  assign z03 = (~new_n80_ & ~x09) | (new_n83_ & x09 & ~x15 & ~x17 & x18);
  assign new_n80_ = (x17 | new_n81_ | ~x18) & (x16 | ~x17 | new_n82_ | x18);
  ...
  assign new_n124_ = ~x07 & ~x09 & ~x15 & ~x16 & ~new_n125_ & ~x18;
  assign new_n125_ = ~x17 & (~x04 | x05 | ~x12 | x14 | x21);
  assign z10 = (~x17 & ~new_n127_ & x18) | (~x18 & (x16 | (~x09 & ~new_n82_ & x17)));
  ...
  assign z12 = new_n67_ | (~x09 & (new_n110_ | (~new_n131_ & ~x07)));
  assign new_n131_ = ~new_n108_ & (x17 | ~x18 | x21 | (new_n132_ & ~new_n135_));
  assign new_n132_ = ~new_n134_ & (x05 | (~new_n97_ & ~new_n105_ & (new_n133_ | x15)));
  ...
  assign z13 = ~x09 & ~x16 & x17 & ~new_n82_ & ~x18;
  assign z14 = new_n139_ | (~x05 & new_n145_ & ~x09);
  assign new_n139_ = ~x17 & (new_n143_ | (new_n140_ & x08));
  ...
  assign new_n144_ = ~x14 & ~x15 & ~x16 & ~x18 & ~x21;
  assign new_n145_ = ~x16 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n147_ & ~x18;
  assign new_n147_ = ~x16 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n153_ : ~new_n149_);
  ...
  assign new_n155_ = (x07 | ((x08 | ~new_n156_ | x15) & (~new_n109_ | ~x00 | ~x15))) & (~new_n109_ | ~x07 | x15);
  ...
  assign new_n160_ = (x14 | (~new_n87_ & ~new_n161_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n168_ = x08 & x10 & ~x12 & ~x14 & ~new_n152_ & ~x21;
  ...
  assign new_n192_ = ~new_n67_ & (~new_n193_ | ~x03 | x05 | x07 | ~x08);
  assign new_n193_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n194_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = ((new_n196_ | new_n207_) & ~x17) | (~x09 & ~x16 & new_n209_ & x17);
  ...
  assign new_n207_ = ~x05 & new_n208_ & x07;
  assign new_n208_ = ~x09 & x15 & ~x16 & ~x18 & (~x02 | ~x11);
