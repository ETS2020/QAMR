...
module FAU ( 
  ...
  assign new_n64_ = (new_n65_ | x15) & (~new_n56_ | x08 | ~x15 | ~x18);
  ...
  assign new_n69_ = (x07 | ((~x05 | x08 | x15 | x17 | ~x18) & (~x17 | x18))) & (x05 | ~x17 | x18);
  assign z04 = z23 | (~x14 & ~x20);
  assign z05 = x18 & (x08 | (~x05 & new_n72_ & ~x07));
  assign new_n72_ = ~x09 & ~x14 & ~x15 & ~x17 & ~new_n73_ & x21;
  assign new_n73_ = x06 ? (x02 ? x11 : (x08 | ~x11)) : (x04 ? (x08 | x12) : ~x12);
  assign z06 = ~x05 & ~x09 & ((~new_n75_ & ~x07) | (new_n77_ & x07 & ~x15));
  assign new_n75_ = (x08 | x15 | x17 | ~new_n76_ | ~x18) & (~x17 | x18 | ~x00 | ~x15);
  ...
  assign new_n84_ = x04 & ((x12 & ~x14 & ~x18) | (~x17 & x18 & ~x06 & ~x12));
  ...
  assign z12 = ~x05 & ~x09 & ((~new_n91_ & ~x07) | (new_n77_ & x07 & ~x15));
  ...
  assign z19 = z23 | (new_n77_ & ~x15 & ~x05 & ~x07 & ~x09);
  assign z20 = ~x05 & ~x07 & ~x09 & ~x15 & ~new_n107_ & ~x17;
  assign new_n107_ = (~new_n108_ | x06) & (~new_n109_ | ~x04 | ~x12);
  assign new_n108_ = ~x08 & x18 & ~new_n60_ & (~x04 ^ ~x12);
  assign new_n109_ = ~x14 & ~x18 & ~x21;
  assign z21 = ~x07 & new_n111_ & ~x08;
  assign new_n111_ = ~x09 & ~x17 & x18 & (x05 ? (x06 & ~x15) : (~x06 & x15));
  assign z22 = x18 & (x08 | (new_n113_ & x06));
  assign new_n113_ = ~x07 & ~x09 & ~x17 & (x05 ? (~x08 & ~x15) : x15);
  ...
  assign z27 = ~x09 & ((~new_n120_ & ~x05) | (new_n122_ & x05 & ~x07 & ~x08));
  assign new_n120_ = (~new_n77_ | ~x07 | x15) & (x07 | (~new_n121_ & (~new_n77_ | ~x00 | ~x15)));
  assign new_n121_ = ~x08 & ~x15 & ~x17 & x18 & ~new_n102_ & ~x21;
  assign new_n122_ = ~x15 & ~x17 & x18 & x19;
  assign z28 = ~x09 & (new_n130_ | (~x05 & (new_n129_ | (~new_n124_ & ~x17))));
  assign new_n124_ = (new_n125_ | x02) & (~new_n127_ | x07) & (~new_n61_ | ~x07 | x11);
