...
module FAU ( 
  ...
  assign z11 = ~x17 & ~x18;
  assign z05 = ~x17 & (~x18 | (~x05 & new_n80_ & ~x07));
  assign new_n80_ = ~x09 & ~x14 & ~x15 & (~new_n81_ | (~new_n87_ & x02));
  ...
  assign z06 = ~x09 & (new_n104_ | (~x07 & (new_n102_ | (new_n90_ & ~x17))));
  ...
  assign z12 = z11 | (~x09 & (new_n104_ | (~new_n122_ & ~x07)));
  assign new_n122_ = ~new_n102_ & (x17 | x21 | (new_n123_ & (new_n127_ | x04)));
  assign new_n123_ = (~new_n126_ | ~x04) & (x05 | (~new_n92_ & ~new_n124_ & ~new_n100_));
  ...
  assign new_n137_ = x12 & (~x13 | (~x02 & x11)) & (x06 ^ x16);
  assign new_n138_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~new_n140_ & ~x09;
  assign new_n140_ = (new_n141_ | x05) & (~new_n144_ | x07 | ~x08 | x04 | ~x05);
  assign new_n141_ = (x07 | ((x08 | ~new_n142_ | x15) & (~new_n103_ | ~x00 | ~x15))) & (~new_n103_ | ~x07 | x15);
  assign new_n142_ = ~x17 & x18 & ~new_n143_ & (~x21 | (~x14 & x21));
  assign new_n143_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n144_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x17 & (~x18 | (~x05 & ~x07 & ~new_n146_ & ~x09));
  assign new_n146_ = (x14 | (~new_n147_ & ~new_n150_) | x15) & (x08 | ~x15 | ~x19);
  assign new_n147_ = ~new_n148_ & x02;
  assign new_n148_ = (~x06 | x08 | x11 | ~x18 | ~x21) & (~new_n149_ | x06 | ~x08);
  assign new_n149_ = ~x10 & x13 & ~x21;
  assign new_n150_ = x12 & ((~new_n151_ & ~x06) | (new_n152_ & x06 & x08 & x10));
  assign new_n151_ = (x04 | x08 | ~x18 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  assign new_n152_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x05 & ~x07 & ~x09;
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n62_ | (~new_n155_ & ~x15))));
  assign new_n155_ = ~new_n156_ & (~x04 | ~x05 | ~x08 | new_n61_ | x12);
  assign new_n156_ = ~x09 & ((new_n159_ & ~x05) | (x04 & new_n157_ & x08));
  assign new_n157_ = x10 & ~x12 & ~x14 & ~new_n158_ & ~x21;
  assign new_n158_ = x13 & (x02 | ~x11);
  assign new_n159_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign z21 = ~x17 & ((~new_n161_ & ~x07) | ~x18 | (new_n162_ & ~x05 & x07));
  assign new_n161_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n162_ = x08 & ~x09 & x15;
  ...
  assign new_n170_ = x18 & (x05 | x07 | (x08 ? (~x09 | x15) : (x09 | ~x15)));
  assign z26 = z11 | (~x20 & (x14 | x21));
  assign z27 = new_n173_ | (new_n178_ & x03 & ~x05 & ~x07 & x08);
  ...
  assign new_n175_ = ~x21 & (new_n176_ | (~new_n127_ & ~x04));
  ...
  assign new_n187_ = (~x08 | ~x15) & (~new_n188_ | ~x06 | x07 | x08 | x09);
