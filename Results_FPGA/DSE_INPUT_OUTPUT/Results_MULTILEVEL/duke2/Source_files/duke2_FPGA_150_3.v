...
module FAU ( 
  ...
  assign new_n108_ = ~x17 & (~new_n80_ | ~x09 | x15 | ~x16);
  ...
  assign new_n124_ = (new_n125_ | x15) & ~x17 & (~new_n126_ | x08 | x09 | ~x15);
  ...
  assign z12 = (x17 & x18) | (~x09 & (new_n130_ | (new_n106_ & ~x15 & x17 & ~x18)));
  assign new_n130_ = ~x07 & (new_n140_ | (x18 & ~x21 & (~new_n131_ | new_n138_)));
  ...
  assign new_n143_ = x08 & (x07 ? (~new_n109_ & ~x19) : new_n144_);
  ...
  assign new_n147_ = new_n148_ & x04 & ~x07 & x12 & ~x14;
  ...
  assign z17 = ~x09 & (new_n157_ | (new_n66_ & new_n161_ & new_n67_ & ~x17));
  assign new_n157_ = ~x05 & ((~new_n158_ & ~x07) | (x07 & ~x15 & x17 & ~x18));
  assign new_n158_ = (x08 | x15 | x17 | ~new_n159_ | ~x18) & (~x17 | x18 | ~x00 | ~x15);
  ...
  assign new_n163_ = (x14 | new_n164_ | x15) & (x08 | ~x15 | ~x19);
  assign new_n164_ = (new_n165_ | ~x12) & (~x02 | (~new_n85_ & ~new_n167_));
  assign new_n165_ = (x06 | (~new_n166_ & (~new_n90_ | ~x08 | ~x10))) & (~new_n88_ | ~x06 | ~x08 | ~x10);
  assign new_n166_ = ~x04 & ~x08 & ~x17 & x21;
  assign new_n167_ = x06 & ~x08 & ~x11 & ~x17 & x21;
  ...
  assign new_n176_ = new_n67_ & new_n161_ & x08 & ~x09 & ~x04 & x05;
