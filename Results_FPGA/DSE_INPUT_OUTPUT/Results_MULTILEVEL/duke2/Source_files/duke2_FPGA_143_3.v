...
module FAU ( 
  ...
  assign new_n82_ = ~x17 & x18 & (new_n83_ | (~new_n85_ & x06) | (~new_n88_ & ~x06));
  ...
  assign z06 = new_n80_ | (~x09 & (new_n106_ | ((new_n91_ | new_n105_) & ~x07)));
  assign new_n91_ = x18 & (new_n103_ | (~x15 & (new_n100_ | (~new_n92_ & ~x21))));
  assign new_n92_ = ~new_n93_ & (new_n95_ | ~x08) & (~new_n99_ | x06 | x08 | x12);
  assign new_n93_ = ~x02 & ~new_n94_ & x11;
  assign new_n94_ = (x05 | ~x06 | x08) & (x12 | x14 | ~x04 | ~x08);
  assign new_n95_ = ~new_n96_ & (x05 | x14 | (~new_n98_ & (new_n97_ | x17)));
  assign new_n96_ = x04 & ~x12 & (x05 | (~x13 & ~x14));
  assign new_n97_ = (x06 | ((x13 | x16 | ~x10 | ~x12) & (~x02 | x10 | ~x13))) & (~x06 | ~x10 | ~x12 | x13 | ~x16);
  assign new_n98_ = ~x10 & ~x13;
  assign new_n99_ = x04 & ~x05;
  assign new_n100_ = ~x05 & ~x08 & ~x14 & new_n101_ & ~x17;
  ...
  assign new_n105_ = x15 & x17 & x00 & ~x05;
  ...
  assign new_n120_ = ~x18 & (x17 | (new_n99_ & x12 & ~x14 & ~x21));
  ...
  assign z12 = new_n80_ | ((new_n126_ | new_n106_) & ~x09);
  assign new_n126_ = ~x07 & (new_n105_ | (x18 & ~x21 & (~new_n127_ | new_n134_)));
  ...
  assign new_n141_ = new_n142_ & new_n99_ & ~x07 & ~x09;
  ...
  assign z17 = new_n80_ | (~new_n152_ & ~x09);
  ...
  assign z20 = new_n80_ | (~x07 & (new_n169_ | (~new_n163_ & ~x15)));
  assign new_n163_ = (new_n164_ | ~x18) & (~new_n168_ | x18 | x21 | x14 | x17);
  assign new_n164_ = (x09 | ((~new_n165_ | x05) & (~new_n166_ | ~x04))) & (~x04 | ~new_n167_ | ~x05);
  assign new_n165_ = ~x06 & ~x08 & ~new_n89_ & (~x14 | ~x21);
  assign new_n166_ = x08 & x10 & ~x12 & ~x14 & ~new_n149_ & ~x21;
  assign new_n167_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n168_ = new_n99_ & ~x09 & x12;
  assign new_n169_ = new_n156_ & ~x04 & x05 & x08 & ~x09;
  assign z21 = x18 & (~new_n172_ | (~new_n171_ & ~x07));
  assign new_n171_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15 | x17))) & (x09 | x15 | x17 | ~x05 | ~x06 | x08);
  assign new_n172_ = ~x17 & (x05 | ~x07 | ~x08 | x09 | ~x15 | x17);
  assign z22 = ~x17 & ~new_n174_ & x18;
  assign new_n174_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x18 & (x17 | (new_n56_ & x08 & x09 & ~x15));
  assign z24 = new_n80_ | (~new_n177_ & ~x09);
  assign new_n177_ = (x07 | (~new_n178_ & ~new_n181_)) & (~new_n182_ | ~x01 | x05 | ~x07);
  assign new_n178_ = ~x21 & ((x04 & ~new_n179_ & ~x15) | (x08 & new_n180_ & x15));
  assign new_n179_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x17 | x18);
  ...
  assign new_n188_ = ~x21 & (new_n134_ | new_n189_);
  assign new_n189_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n190_ = new_n56_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n191_ = ~x05 & x17 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n193_ | (new_n203_ & ~x05))) | (~x09 & new_n204_ & x17);
  assign new_n193_ = x18 & (new_n201_ | (~x05 & (~new_n194_ | (~new_n199_ & ~x02))));
  assign new_n194_ = (~new_n198_ | ~x08) & (x07 | x09 | (x08 ? ~new_n196_ : new_n195_));
  assign new_n195_ = (~x15 | x19) & (~new_n102_ | x14 | x15 | ~x21);
