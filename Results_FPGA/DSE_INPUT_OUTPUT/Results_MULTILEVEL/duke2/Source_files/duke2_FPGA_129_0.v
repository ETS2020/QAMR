...
module FAU ( 
  ...
  assign new_n78_ = x17 ? (x18 | new_n80_ | ~x19) : (new_n79_ | ~x18);
  ...
  assign new_n100_ = ~x06 & ~x08 & ~x12 & x04 & ~x05;
  ...
  assign z09 = (~new_n119_ & ~x18) | (~x17 & (new_n121_ | (~new_n111_ & x18)));
  assign new_n111_ = (x07 | ((new_n112_ | x05) & (~new_n63_ | ~x05 | ~x08))) & (~x05 | ~new_n118_ | ~x08);
  assign new_n112_ = (x21 | ((~new_n113_ | x09) & (~new_n117_ | ~x02 | ~x08))) & (~new_n117_ | ~x09 | ~x02 | ~x08);
  ...
  assign new_n118_ = ~x15 & (~x04 | x07 | ~x12);
  assign new_n119_ = x19 & (x07 | x09 | new_n120_ | x15);
  assign new_n120_ = ~x17 & (~x04 | x05 | ~x12 | x14 | x21);
  assign new_n121_ = ~x09 & ~x15 & ~x19 & x05 & ~x07 & ~x08;
  assign z10 = (~x17 & ~new_n123_ & x18) | (~x18 & ((~x09 & ~new_n80_ & x17) | ~x19));
  ...
  assign z13 = ~x09 & x17 & ~x18 & ~new_n80_ & x19;
  assign z14 = (~new_n138_ & ~x17) | (~x18 & (new_n143_ | ~x19));
  assign new_n138_ = ~new_n139_ & (~new_n142_ | ~x04 | x05 | x07 | x09);
  assign new_n139_ = x08 & (x07 ? new_n141_ : (x18 & ~new_n63_ & ~new_n140_));
  assign new_n140_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n141_ = ~x19 & (x05 ^ x15);
  assign new_n142_ = ~x15 & ~x18 & ~x21 & x12 & ~x14;
  assign new_n143_ = ~x05 & ~x09 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n145_ & ~x18;
  assign new_n145_ = x19 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign z17 = new_n83_ | (~x09 & (new_n157_ | (~new_n153_ & ~x05)));
  ...
  assign new_n157_ = new_n67_ & new_n117_ & ~x17 & x18 & ~x21;
  assign z18 = new_n83_ | (~x05 & ~x07 & ~x09 & new_n159_ & ~x17);
  ...
  assign new_n165_ = (new_n166_ | ~x18) & (~new_n170_ | ~x19 | x21 | x14 | x18);
  assign new_n166_ = (x09 | ((~new_n169_ | x05) & (~new_n167_ | ~x04))) & (~x04 | ~new_n168_ | ~x05);
  assign new_n167_ = x08 & x10 & ~x12 & ~x14 & ~new_n150_ & ~x21;
  assign new_n168_ = x08 & ~new_n63_ & ~x12;
  assign new_n169_ = ~x06 & ~x08 & (~x14 | ~x21) & (x04 ^ x12);
  assign new_n170_ = ~x09 & x12 & x04 & ~x05;
  assign new_n171_ = new_n172_ & new_n117_ & x18 & ~x21;
  ...
  assign z23 = (~x18 & ~x19) | (new_n81_ & x09 & ~x15 & ~x17 & x18);
  assign z24 = new_n83_ | (~x09 & ~x17 & (new_n179_ | new_n183_));
  ...
  assign z28 = (new_n206_ & ~x07) | (~x17 & (new_n195_ | (~x05 & new_n205_ & x07)));
  ...
  assign new_n205_ = ~x09 & x15 & ~x18 & ~new_n71_ & x19;
  assign new_n206_ = ~x09 & x17 & ~x18 & x19 & (x05 | x15);
endmodule
