...
module FAU ( 
  ...
  assign z03 = (~new_n78_ & ~x09) | (x18 & (x17 | (new_n79_ & new_n80_)));
  assign new_n78_ = (~x18 | ((~x05 | x15 | (x07 ^ x08)) & (~x08 | ~x15 | x05 | ~x07))) & (~x17 | (x05 & x07));
  ...
  assign new_n120_ = ~x17 & (~new_n56_ | x14 | ~x04 | x05 | ~x12);
  ...
  assign z12 = ~x09 & (new_n106_ | (~x07 & (new_n105_ | (new_n126_ & ~x17))));
  assign new_n126_ = x18 & ~x21 & ((~new_n130_ & ~x04) | new_n127_ | (new_n129_ & x04));
  assign new_n127_ = ~x05 & (new_n94_ | new_n102_ | (~new_n128_ & ~x15));
  assign new_n128_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n104_ | ~x08 | x10);
  assign new_n129_ = x08 & ~x12 & ~x15 & (new_n104_ | x05);
  assign new_n130_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign z13 = x17 & (x18 | (~x09 & (~x05 | ~x07)));
  assign z14 = (~x05 & ~new_n133_ & ~x09) | (x18 & (new_n136_ | x17));
  assign new_n133_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n134_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n134_ = new_n135_ & new_n56_ & ~x15 & ~x17;
  assign new_n135_ = x04 & ~x07 & x12 & ~x14;
  assign new_n136_ = x08 & (x07 ? new_n138_ : (~new_n137_ & (x09 | ~x21)));
  assign new_n137_ = (~x11 | ~x15 | x02 | x05) & (x12 | x15 | ~x04 | ~x05);
  ...
  assign new_n143_ = (new_n62_ | (new_n144_ & (~x02 | ~x06))) & (~x12 | new_n144_ | (~x06 ^ x16));
  ...
  assign new_n155_ = (new_n156_ | ~x12) & (~x02 | (~new_n85_ & ~new_n158_));
  assign new_n156_ = (x06 | (~new_n157_ & (~new_n90_ | ~x08 | ~x10))) & (~new_n88_ | ~x06 | ~x08 | ~x10);
  assign new_n157_ = ~x17 & x21 & ~x04 & ~x08;
  assign new_n158_ = x06 & ~x08 & ~x11 & ~x17 & x21;
  assign z19 = x17 & (x18 | (new_n79_ & ~x09 & ~x15));
  assign z20 = ~x07 & ~new_n161_ & ~x17;
  assign new_n161_ = (new_n162_ | x15) & (~new_n168_ | x11 | ~x15 | ~x18 | x21);
  assign new_n162_ = ~new_n166_ & (~x18 | (~new_n167_ & (new_n163_ | x09)));
  ...
  assign new_n166_ = x04 & ~x05 & ~x09 & new_n56_ & x12 & ~x14;
  assign new_n167_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign new_n168_ = new_n151_ & x08 & ~x09;
  ...
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n79_ & x08;
  ...
  assign new_n194_ = (x07 | x09 | (x08 ? ~new_n197_ : new_n195_)) & (~new_n199_ | ~x08);
