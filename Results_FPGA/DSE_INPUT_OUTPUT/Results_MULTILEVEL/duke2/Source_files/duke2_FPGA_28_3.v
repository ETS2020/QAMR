...
module FAU ( 
  ...
  assign new_n56_ = x17 & ((~x00 & ((~x05 & x15 & x20) | (~x07 & ~x20))) | (x05 & (~x07 | ~x15)) | (~x07 & ~x15) | (~x05 & x07 & x15));
  assign z01 = (~new_n58_ & ~x17) | (x18 & x20);
  ...
  assign z05 = x18 & (x20 | (~x05 & ~x07 & new_n83_ & ~x09));
  ...
  assign new_n97_ = (x06 | ((~x02 | x10) & (~x12 | x13 | x16))) & (x13 | (x10 & (~x06 | ~x12 | ~x16)));
  ...
  assign z10 = z13 | (~x17 & x18 & ~new_n121_ & ~x20);
  assign new_n121_ = (x15 | ((~x08 | ~x09 | x05 | x07) & (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = new_n124_ & ~x18;
  assign new_n124_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n126_ & ~x07) | (~x05 & x07 & new_n104_ & ~x15));
  assign new_n126_ = ~new_n103_ & (x17 | ~x18 | ~new_n127_ | x20);
  ...
  assign new_n141_ = new_n142_ & new_n55_ & ~x15 & ~x18 & ~x21;
  ...
  assign z16 = x18 & (x20 | (x08 & ~x17 & (new_n147_ | new_n152_)));
  ...
  assign z17 = ~x09 & (new_n154_ | (new_n158_ & new_n159_ & x15 & ~x17));
  assign new_n154_ = ~x05 & ((~x07 & (new_n155_ | (new_n104_ & x00 & x15))) | (new_n104_ & x07 & ~x15));
  assign new_n155_ = ~x08 & ~x15 & ~x17 & x18 & new_n156_ & ~x20;
  ...
  assign z18 = x18 & (x20 | (~x05 & ~x07 & new_n161_ & ~x09));
  assign new_n161_ = ~x17 & ((~x08 & x15 & x19) | (~x14 & ~new_n162_ & ~x15));
  assign new_n162_ = ~new_n84_ & (~x12 | (~new_n164_ & (new_n163_ | x06)));
  assign new_n163_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n164_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = (x18 & x20) | (new_n166_ & ~x15 & x17 & ~x18);
  assign new_n166_ = ~x05 & ~x07 & ~x09;
  assign z20 = ~x07 & ~x17 & (new_n174_ | (~new_n168_ & ~x15));
  assign new_n168_ = ~new_n173_ & (~x18 | x20 | (~new_n172_ & (new_n169_ | x09)));
  assign new_n169_ = (~new_n171_ | x05) & (~x04 | ~x08 | ~new_n170_ | ~x10);
  assign new_n170_ = ~x12 & ~x14 & ~new_n151_ & ~x21;
  assign new_n171_ = ~x06 & ~x08 & (~x14 | ~x21) & (x04 ^ x12);
  assign new_n172_ = x04 & x05 & x08 & ~new_n64_ & ~x12;
  assign new_n173_ = x04 & ~x05 & ~x09 & new_n55_ & ~x18 & ~x21;
  assign new_n174_ = new_n115_ & new_n159_ & ~x04 & x05 & x08 & ~x09;
  assign z21 = x18 & (x20 | (~new_n176_ & ~x17));
  assign new_n176_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = x18 & (x20 | (~new_n178_ & ~x17));
  assign new_n178_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = ~x20 & new_n180_ & x18;
  assign new_n180_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n186_ | (~new_n182_ & ~x07));
  assign new_n182_ = ~new_n183_ & (x05 | x08 | x15 | ~x18 | x20);
  assign new_n183_ = ~x21 & ((x04 & ~new_n184_ & ~x15) | (x08 & new_n185_ & x15));
  assign new_n184_ = (x14 | x18 | x05 | ~x12) & (x12 | ~x18 | x20 | ~x05 | ~x08);
  assign new_n185_ = x18 & ~x20 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n186_ = x08 & ~x15 & ~x18 & x01 & ~x05 & x07;
  assign z25 = ~x05 & new_n188_ & ~x07;
  assign new_n188_ = ~x17 & x18 & ~x20 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  ...
  assign new_n192_ = ~x21 & (new_n128_ | new_n193_);
  ...
  assign z28 = (~x17 & (new_n208_ | (new_n198_ & x18))) | (~x09 & x17 & ~new_n210_ & ~x18);
  assign new_n198_ = ~x20 & (new_n206_ | (~x05 & (~new_n199_ | (~new_n204_ & ~x02))));
  assign new_n199_ = (x07 | new_n200_ | x09) & (~x08 | ~x15 | (~x07 & x11));
