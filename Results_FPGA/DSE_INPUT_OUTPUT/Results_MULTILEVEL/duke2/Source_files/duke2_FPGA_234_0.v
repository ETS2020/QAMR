...
module FAU ( 
  ...
  assign z06 = z11 | (~x09 & (new_n104_ | (~x07 & (new_n89_ | new_n106_))));
  ...
  assign new_n106_ = x00 & ~x05 & x15 & ~x18;
  ...
  assign new_n113_ = (x07 | (x05 ? ~new_n120_ : new_n114_)) & x18 & (~new_n121_ | ~x05);
  ...
  assign z12 = z11 | ((new_n125_ | new_n104_) & ~x09);
  assign new_n125_ = ~x07 & (new_n106_ | (~x17 & ~x21 & (~new_n126_ | new_n129_)));
  assign new_n126_ = ~new_n128_ & (x05 | (~new_n91_ & ~new_n97_ & (new_n127_ | x15)));
  assign new_n127_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n103_ | ~x08 | x10);
  assign new_n128_ = x04 & x08 & ~x12 & ~x15 & (new_n103_ | x05);
  ...
  assign new_n133_ = x07 ? (new_n110_ | x19) : (new_n61_ | new_n134_);
  ...
  assign z17 = ~x09 & ((~new_n144_ & ~x05) | (new_n148_ & new_n109_ & ~x04 & x05));
  ...
  assign new_n151_ = (new_n152_ | ~x12) & (~x02 | (~new_n82_ & ~new_n154_));
  assign new_n152_ = (x06 | (~new_n153_ & (~new_n87_ | ~x08 | ~x10))) & (~new_n85_ | ~x06 | ~x08 | ~x10);
  ...
  assign z21 = ~x17 & ((~new_n163_ & ~x07) | ~x18 | (new_n164_ & ~x05 & x07));
  assign new_n163_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n164_ = x08 & ~x09 & x15;
  assign z22 = ~x17 & (new_n166_ | ~x18 | (new_n105_ & x08 & x15));
  assign new_n166_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  ...
  assign new_n175_ = (new_n129_ | new_n176_) & ~x21;
  assign new_n176_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n177_ = new_n178_ & new_n109_ & x03 & ~x05;
  ...
  assign new_n183_ = (~x15 | x19) & (~new_n100_ | x14 | x15 | ~x21);
