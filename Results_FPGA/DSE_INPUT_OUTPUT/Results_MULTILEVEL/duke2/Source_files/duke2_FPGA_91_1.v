...
module FAU ( 
  ...
  assign z05 = x18 & (~x16 | (~x05 & new_n85_ & ~x07));
  assign new_n85_ = ~x09 & ~x14 & ~x15 & ~x17 & (~new_n86_ | new_n89_);
  assign new_n86_ = x06 ? new_n87_ : (x08 | ~x21 | (x04 ^ ~x12));
  assign new_n87_ = (~x11 | ~x21 | x02 | x08) & (~new_n88_ | ~x08 | ~x10);
  assign new_n88_ = x12 & ~x13 & ~x21;
  assign new_n89_ = ~new_n90_ & x02;
  assign new_n90_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign z06 = new_n83_ | (~x09 & ((~new_n92_ & ~x07) | (new_n105_ & ~x05 & x07)));
  assign new_n92_ = ~new_n102_ & (x05 | ((x17 | new_n93_ | ~x18) & (~new_n104_ | ~x17 | x18)));
  assign new_n93_ = ~new_n99_ & (x21 | (~new_n94_ & ~new_n101_ & (new_n96_ | x15)));
  assign new_n94_ = x04 & ~new_n95_ & ~x12;
  assign new_n95_ = (~x11 | x14 | x02 | ~x08) & (x06 | x08 | x15);
  assign new_n96_ = (~new_n98_ | ~x08) & (~x06 | (~new_n97_ & (x02 | x08 | ~x11)));
  assign new_n97_ = x08 & x10 & x12 & ~x13 & ~x14;
  assign new_n98_ = ~x10 & ~x14 & (~x13 | (x02 & ~x06 & x13));
  ...
  assign new_n102_ = x04 & x08 & ~x12 & new_n103_ & ~x15;
  assign new_n103_ = ~x17 & x18 & ~x21 & (x05 | (~x13 & ~x14));
  assign new_n104_ = x00 & x15;
  assign new_n105_ = new_n106_ & ~x15;
  assign new_n106_ = x17 & ~x18;
  assign z07 = x16 & new_n108_ & ~x17;
  assign new_n108_ = x18 & ((~x09 & (~x07 ^ x08) & (~x05 ^ ~x15)) | (x08 & x09 & ~x15 & ~x05 & ~x07));
  assign z08 = x14 & ~new_n83_ & ~x20;
  assign z09 = new_n119_ | (x18 & (~x16 | (~new_n111_ & ~x17)));
  ...
  assign z10 = (x18 & (~x16 | (~new_n123_ & ~x17))) | (~x09 & x17 & ~new_n122_ & ~x18);
  assign new_n122_ = x05 & x07;
  assign new_n123_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = new_n83_ | (new_n125_ & x01 & ~x05 & x07);
  assign new_n125_ = ~x17 & ~x18 & ~x09 & ~x15;
  assign z12 = ~x09 & ((~new_n127_ & ~x07) | (new_n105_ & ~x05 & x07));
  assign new_n127_ = ~new_n135_ & (~x16 | x17 | ~x18 | new_n128_ | x21);
  assign new_n128_ = ~new_n129_ & ~new_n133_ & (x05 | (~new_n94_ & ~new_n131_ & ~new_n101_));
  ...
  assign new_n135_ = x00 & ~x05 & new_n106_ & x15;
  assign z13 = (~x16 & x18) | (~x09 & x17 & ~new_n122_ & ~x18);
  ...
  assign z15 = new_n83_ | (new_n105_ & new_n140_ & x05);
  assign z16 = x08 & x16 & ~x17 & ~new_n147_ & x18;
  ...
  assign new_n151_ = ~x02 & ((~x10 & ~x13) | (~x06 & x11 & x12));
  assign new_n152_ = ~x13 & (x12 ? ~x06 : (x04 | ~x10));
  assign z17 = ~x09 & ((~new_n154_ & ~x05) | (new_n158_ & new_n157_ & ~x04 & x05));
  assign new_n154_ = (x07 | ((~new_n106_ | ~x00 | ~x15) & (x08 | ~new_n155_ | x15))) & (~new_n106_ | ~x07 | x15);
  assign new_n155_ = x16 & ~x17 & x18 & ~new_n156_ & (~x21 | (~x14 & x21));
  assign new_n156_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n157_ = ~x07 & x08 & ~x11;
  assign new_n158_ = x15 & x16 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & x16 & new_n160_ & ~x17;
  assign new_n160_ = x18 & ((~x14 & ~new_n161_ & ~x15) | (~x08 & x15 & x19));
  assign new_n161_ = ~new_n89_ & (new_n162_ | ~x12);
  assign new_n162_ = (x04 | x06 | x08 | ~x21) & (~x06 | ~x08 | ~x10 | x13 | x21);
  assign z19 = new_n83_ | (new_n105_ & new_n140_ & ~x05);
  assign z20 = ~x07 & ~x17 & (new_n171_ | (~new_n165_ & ~x15));
  assign new_n165_ = ~new_n170_ & (~x16 | ~x18 | (~new_n169_ & (new_n166_ | x09)));
  ...
  assign new_n188_ = ~new_n190_ & (x21 | (~new_n129_ & ~new_n189_));
  ...
  assign z28 = (~new_n196_ & ~x17) | (~x16 & x18) | (~x09 & x17 & ~new_n209_ & ~x18);
