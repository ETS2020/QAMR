...
module FAU ( 
  ...
  assign z01 = new_n66_ | (~x07 & ~x17 & (new_n64_ | (~new_n58_ & ~x05)));
  ...
  assign z02 = new_n66_ | (~x17 & ((~new_n68_ & ~x09) | (~new_n79_ & x08)));
  assign new_n68_ = ~new_n69_ & ~new_n78_ & (new_n74_ | x07);
  assign new_n69_ = ~x15 & (new_n70_ | (~x05 & (new_n72_ | (new_n73_ & ~x02))));
  assign new_n70_ = x18 & ((x05 & (x08 ? x21 : ~x07)) | (~x07 & ~new_n71_ & ~x08));
  assign new_n71_ = x06 ? (x02 & x11) : (x04 & x12);
  assign new_n72_ = x01 & x07 & ~x18 & (x08 | x16);
  assign new_n73_ = x06 & ~x07 & ~x08 & x11 & (~x14 | ~x21);
  assign new_n74_ = (~x08 | ((new_n75_ | x21) & (~x15 | ~x18 | ~x21))) & (~x15 | ~x18 | x05 | x08);
  assign new_n75_ = (x02 | x05 | ~new_n76_ | ~x11) & (x04 | ~x05 | ~new_n77_ | x11);
  assign new_n76_ = x13 & ~x14 & (~x10 | (x04 & ~x12));
  assign new_n77_ = x15 & x18;
  assign new_n78_ = ~x05 & x08 & x15 & x18 & x21;
  assign new_n79_ = x05 ? (~new_n81_ | x15) : ((new_n80_ | ~x15) & (x07 | x15 | ~x18));
  assign new_n80_ = (x02 | x07 | new_n63_ | ~x11) & (~x18 | (~x07 & x11));
  assign new_n81_ = x18 & (~x04 | x07 | ~x12);
  assign z03 = (~new_n83_ & ~x09) | (new_n85_ & x09 & ~x15 & ~x17 & x18);
  assign new_n83_ = (x17 | new_n84_ | ~x18) & (x11 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n89_ = ~x17 & x18 & (new_n90_ | (~new_n92_ & x06) | (~new_n94_ & ~x06));
  ...
  assign new_n108_ = ~x12 & ~x15 & (new_n109_ | x05) & ~x21;
  assign new_n109_ = ~x13 & ~x14;
  assign new_n110_ = x00 & ~x05 & ~x11 & x15 & x17 & ~x18;
  assign new_n111_ = ~x15 & x17 & ~x18 & ~x05 & x07 & ~x11;
  assign z07 = (x11 & ~x18) | (~x17 & ~new_n113_ & x18);
  assign new_n113_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~new_n66_ & ~x20;
  assign z09 = (~x07 & (new_n116_ | (x02 & new_n124_ & ~x05))) | (new_n125_ & x05);
  assign new_n116_ = ~x09 & (new_n122_ | (~x17 & ~new_n117_ & x18));
  assign new_n117_ = (x15 | (x05 ? (x08 | x19) : (new_n118_ | x21))) & (~x05 | ~x08 | ~x21);
  ...
  assign new_n122_ = ~x11 & ~x15 & ~x18 & (new_n123_ | x17);
  assign new_n123_ = x04 & ~x05 & x12 & ~x14 & ~x21;
  assign new_n124_ = x08 & ~x11 & x15 & ~x17 & ~new_n63_ & x18;
  assign new_n125_ = x08 & ~x15 & new_n81_ & ~x17;
  ...
  assign new_n130_ = ~x15 & ~x11 & ~x09 & x07 & x01 & ~x05;
  ...
  assign new_n135_ = x08 & ~x12 & (new_n109_ | x05) & ~x15;
  ...
  assign z17 = ~x09 & ((~new_n153_ & ~x05) | (new_n158_ & new_n86_ & ~x04 & x05));
  assign new_n153_ = (new_n154_ | x07) & (x15 | ~x17 | x18 | ~x07 | x11);
  assign new_n154_ = (x08 | x15 | x17 | ~new_n155_ | ~x18) & (~new_n157_ | ~x15 | ~x17 | x18);
  assign new_n155_ = ~new_n156_ & (~x14 | ~x21);
  assign new_n156_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n157_ = x00 & ~x11;
  assign new_n158_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = new_n66_ | (~x05 & ~x07 & ~x09 & new_n160_ & ~x17);
  assign new_n160_ = x18 & ((~x14 & ~new_n161_ & ~x15) | (~x08 & x15 & x19));
  assign new_n161_ = ~new_n90_ & (~x12 | (~new_n163_ & (new_n162_ | x06)));
  assign new_n162_ = (x04 | x08 | ~x21) & (~new_n95_ | ~x08 | ~x10);
  assign new_n163_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x11 & new_n56_ & ~x09;
  assign z20 = ~x07 & ~x17 & (new_n64_ | (~new_n166_ & ~x15));
  ...
  assign new_n171_ = x04 & ~x05 & ~x09 & ~x11;
  ...
  assign z22 = (x11 & ~x18) | (~x17 & ~new_n175_ & x18);
  assign new_n175_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)))));
  ...
  assign new_n180_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | x11 | ~x12 | x14 | x18);
  assign new_n181_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n182_ = ~x05 & ~x08 & ~x15 & x18;
  assign new_n183_ = x08 & ~x11 & ~x15 & ~x18;
  ...
  assign new_n189_ = ~x21 & (new_n190_ | (~new_n136_ & ~x04));
  assign new_n190_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n191_ = ~new_n66_ & (~new_n192_ | ~new_n86_ | ~x03 | x05);
  assign new_n192_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n193_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = ((new_n195_ | new_n206_) & ~x17) | (~x09 & ~x11 & new_n207_ & x17);
  ...
  assign new_n206_ = ~x11 & x15 & ~x18 & ~x05 & x07 & ~x09;
