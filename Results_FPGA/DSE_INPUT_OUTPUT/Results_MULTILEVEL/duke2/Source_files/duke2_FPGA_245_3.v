...
module FAU ( 
  ...
  assign z03 = (~new_n78_ & ~x09) | (x18 & (x17 | (new_n56_ & new_n79_)));
  assign new_n78_ = (~x18 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (~x17 | (x05 & x07));
  ...
  assign z09 = (~new_n112_ & x18) | (~x07 & ~x09 & ~new_n121_ & ~x15);
  ...
  assign new_n121_ = ~x17 & (~new_n122_ | x14 | x18 | x21);
  assign new_n122_ = x04 & ~x05 & x12;
  ...
  assign new_n128_ = (x17 | ~x18 | new_n129_ | x21) & (~new_n105_ | ~x15 | ~x17 | x18);
  assign new_n129_ = ~new_n130_ & ~new_n134_ & (x05 | (~new_n93_ & ~new_n132_ & ~new_n101_));
  ...
  assign new_n134_ = x04 & x08 & ~x12 & ~new_n103_ & ~x15;
  assign new_n135_ = x17 & ~x18;
  assign z13 = x17 & (x18 | (~x09 & (~x05 | ~x07)));
  assign z14 = (~x05 & ~new_n138_ & ~x09) | (x18 & (new_n141_ | x17));
  assign new_n138_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n139_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n139_ = new_n140_ & x04 & ~x07 & x12 & ~x14;
  assign new_n140_ = ~x15 & ~x17 & ~x18 & ~x21;
  assign new_n141_ = x08 & (x07 ? new_n143_ : (~new_n142_ & (x09 | ~x21)));
  ...
  assign new_n152_ = (x07 | ((x08 | ~new_n153_ | x15) & (~new_n135_ | ~x00 | ~x15))) & (~new_n135_ | ~x07 | x15);
  ...
  assign new_n164_ = (new_n165_ | ~x18) & (~new_n169_ | x18 | x21 | x14 | x17);
