...
module FAU ( 
  ...
  assign new_n68_ = (new_n69_ | ~x18) & (x15 | ((new_n72_ | ~x18) & (~new_n74_ | ~x01)));
  ...
  assign new_n74_ = ~x05 & x07 & ~x18 & ~x19 & (x08 | x16);
  ...
  assign new_n120_ = ~x19 & (x07 | x09 | x15 | (~new_n121_ & ~x17));
  ...
  assign z12 = ~x09 & (new_n106_ | (~x07 & (new_n104_ | (new_n128_ & ~x17))));
  ...
  assign new_n134_ = ~x17 & (new_n138_ | (new_n135_ & x08));
  ...
  assign new_n138_ = new_n139_ & ~x07 & ~x09 & x12 & x04 & ~x05;
  assign new_n139_ = ~x14 & ~x15 & ~x18 & ~x19 & ~x21;
  assign new_n140_ = ~x18 & ~x19 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n142_ & ~x18;
  assign new_n142_ = ~x19 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = (~x18 & x19) | (x08 & ~x17 & ~new_n144_ & x18);
  assign new_n144_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n145_;
  assign new_n145_ = (x07 | x15 | (x09 ? x19 : ~new_n146_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n146_ = ~x14 & ~x21 & (new_n148_ | (~new_n61_ & ~new_n147_));
  assign new_n147_ = (~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11);
  assign new_n148_ = x12 & (x06 ^ x16) & (~x13 | (~x02 & x11));
  assign z17 = ~x09 & (new_n153_ | (~new_n150_ & ~x05));
  assign new_n150_ = (x07 | ((x08 | ~new_n151_ | x15) & (~new_n105_ | ~x00 | ~x15))) & (~new_n105_ | ~x07 | x15);
  ...
  assign new_n156_ = x18 & (new_n84_ | (x12 & (new_n158_ | (~new_n157_ & ~x06))));
  ...
  assign z20 = ~x07 & ~x17 & (new_n168_ | (~new_n161_ & ~x15));
  assign new_n161_ = (new_n162_ | ~x18) & (~new_n167_ | x19 | x21 | x14 | x18);
  assign new_n162_ = (x09 | ((~new_n163_ | ~x04) & (~new_n165_ | x05))) & (~x04 | ~new_n166_ | ~x05);
  ...
  assign new_n167_ = ~x09 & x12 & x04 & ~x05;
  ...
  assign z22 = (~x18 & x19) | (~x17 & ~new_n173_ & x18);
  assign new_n173_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)))));
  assign z23 = (~x18 & x19) | (new_n80_ & ~x17 & x18 & x09 & ~x15);
  assign z24 = (~x18 & x19) | (~x09 & ~x17 & (new_n176_ | new_n180_));
  ...
  assign z25 = (~x18 & x19) | (~x05 & ~x07 & ~x17 & ~new_n182_ & x18);
  assign new_n182_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = (~x18 & x19) | (~x20 & (x14 | x21));
  assign z27 = (~new_n188_ & x19) | (~x09 & (new_n190_ | (~new_n185_ & ~x17)));
  assign new_n185_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n186_ & (~x05 | x08 | x15 | ~x19));
  assign new_n186_ = x18 & ~x21 & (new_n187_ | (~new_n132_ & ~x04));
  assign new_n187_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n188_ = x18 & (~new_n189_ | ~new_n56_ | ~x03);
  assign new_n189_ = x08 & x09 & ~x15 & ~x17;
  assign new_n190_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n205_ | (~new_n192_ & x18))) | (~x18 & (new_n203_ | x19));
  ...
  assign new_n204_ = x05 ? (x07 | ~x17) : (~x15 | (~x17 & (~x07 | (x02 & x11))));
  assign new_n205_ = ~x05 & x07 & x08 & ~x09 & x15 & x19;
endmodule
