...
module FAU ( 
  ...
  assign new_n149_ = (x14 | x15 | (~new_n80_ & ~new_n150_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n155_ = ~x06 & ~x08 & ~new_n86_ & (~x14 | ~x21);
  assign new_n156_ = x08 & x10 & ~x12 & ~x14 & ~new_n140_ & ~x21;
  assign new_n157_ = x08 & ~new_n61_ & ~x12;
  assign z21 = ~x17 & (~new_n160_ | (~new_n159_ & ~x07));
  assign new_n159_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | ~x18))) & (x09 | x15 | ~x18 | ~x05 | ~x06 | x08);
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n120_ | new_n164_);
  ...
  assign new_n172_ = ~x21 & (new_n124_ | new_n173_);
