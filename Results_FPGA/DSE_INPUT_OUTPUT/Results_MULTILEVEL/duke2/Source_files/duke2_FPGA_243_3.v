...
module FAU ( 
  ...
  assign new_n63_ = x18 & ((~x07 & ~new_n64_ & ~x08) | (x05 & (x08 ? x21 : ~x07)));
  assign new_n64_ = x06 ? (x02 & x11) : (x04 & x12);
  assign new_n65_ = x01 & ~x05 & x07 & ~x18 & (x08 | x16);
  assign new_n66_ = x08 & x18 & (x05 ? (~x04 | x07 | ~x12) : ~x07);
  assign z03 = z23 | new_n69_;
  assign z23 = x18 & (x15 | (new_n56_ & x08 & x09 & ~x17));
  assign new_n69_ = ~x09 & ((x05 & ~x17 & x18 & (~x07 ^ x08)) | (x17 & ~x18 & (~x05 | ~x07)));
  assign z04 = ~x14 & ~x20 & (~x15 | ~x18);
  assign z05 = x18 & (x15 | (~x05 & new_n72_ & ~x07));
  assign new_n72_ = ~x09 & ~x14 & ~x17 & (new_n73_ | new_n75_ | new_n80_);
  assign new_n73_ = x02 & (new_n74_ | (x06 & ~x08 & ~x11 & x21));
  assign new_n74_ = ~x06 & x08 & ~x10 & x13 & ~x15 & ~x21;
  assign new_n75_ = ~x15 & (x06 ? (new_n76_ | new_n77_) : (new_n78_ | new_n79_));
  assign new_n76_ = ~x02 & ~x08 & x11 & x21;
  assign new_n77_ = x08 & x10 & x12 & ~x13 & x16 & ~x21;
  assign new_n78_ = x04 & ~x08 & ~x12 & x21;
  assign new_n79_ = x08 & x10 & x12 & ~x13 & ~x16 & ~x21;
  assign new_n80_ = ~x04 & ~x06 & ~x08 & x12 & x21;
  assign z06 = ~x09 & (new_n91_ | (~x07 & (new_n93_ | (new_n82_ & ~x15))));
  ...
  assign new_n85_ = (x06 | ((~x02 | x10) & (x13 | x16 | ~x10 | ~x12))) & (x13 | (x10 & (~x06 | ~x10 | ~x12 | ~x16)));
  ...
  assign new_n91_ = new_n92_ & ~x15 & x17 & ~x18;
  ...
  assign z11 = (x15 & x18) | (new_n92_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  assign z12 = ~x09 & (new_n91_ | (~x07 & (new_n93_ | (new_n112_ & ~x15))));
  assign new_n112_ = ~x17 & x18 & ~x21 & (new_n87_ | (~new_n113_ & ~x05));
  assign new_n113_ = ~new_n84_ & (~x08 | x10 | x13 | x14) & (new_n114_ | x08);
  assign new_n114_ = (x06 | (x04 ^ ~x12)) & (~x02 | ~x06 | x11);
  assign z13 = (x15 & x18) | (~x09 & x17 & ~new_n108_ & ~x18);
  assign z14 = (~new_n117_ & ~x17) | (x15 & x18) | (new_n121_ & ~x05);
  assign new_n117_ = (~new_n118_ | ~x04) & (~new_n108_ | ~x08 | ~x18 | x19);
  assign new_n118_ = ~x07 & ((new_n119_ & x05) | (new_n120_ & ~x05 & ~x09 & x12));
  assign new_n119_ = x08 & ~x12 & x18 & (x09 | ~x21);
  assign new_n120_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n121_ = ~x09 & ((x15 & (x07 | x17)) | (x07 & ~x18 & (~x01 | x17)));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x18 & (x15 | (x08 & ~new_n124_ & ~x17));
  assign new_n124_ = x05 ? (~x09 | (~x07 & x12)) : (x07 | (x09 ? x19 : ~new_n125_));
  assign new_n125_ = ~x14 & ~x21 & ((~new_n126_ & ~new_n127_) | (~new_n128_ & x12));
  assign new_n126_ = x10 & (~x04 | x12);
  assign new_n127_ = (~x02 | ~x06) & x13 & (x02 | ~x11);
  assign new_n128_ = ((x13 & (x02 | ~x11)) | (~x06 ^ x16)) & (~x06 | x10 | ~x11);
  assign z17 = (~x05 & ~new_n130_ & ~x09) | (x15 & x18);
  assign new_n130_ = (x07 | (~new_n131_ & (~x00 | ~x15 | ~x17))) & (~x07 | x15 | ~x17 | x18);
  assign new_n131_ = ~x08 & ~x17 & x18 & ~new_n132_ & ~new_n133_;
  assign new_n132_ = x21 & (x14 | x15 | ~x21);
  assign new_n133_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = ~x05 & ~x07 & ~x09 & new_n135_ & ~x14;
  assign new_n135_ = ~x15 & ~x17 & x18 & (new_n136_ | (~new_n139_ & x02));
  ...
  assign new_n139_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign z19 = (x15 & x18) | (~x05 & ~x07 & ~x09 & ~x15 & x17 & ~x18);
  assign z20 = ~x07 & ~x15 & ~x17 & (new_n146_ | (~new_n142_ & x18));
  ...
  assign new_n146_ = new_n147_ & x04 & ~x05 & ~x09;
  assign new_n147_ = ~x18 & ~x21 & x12 & ~x14;
  assign z21 = x06 & new_n149_ & ~x07;
  assign new_n149_ = ~x15 & ~x17 & x18 & (x05 ? (~x08 & ~x09) : (x08 & x09));
  assign z22 = x18 & (x15 | (new_n151_ & ~x07));
  assign new_n151_ = ~x17 & ((~x05 & x08 & x09) | (x05 & x06 & ~x08 & ~x09 & ~x15));
  assign z24 = (x15 & x18) | (new_n153_ & ~x09);
  assign new_n153_ = ~x17 & ((~new_n154_ & ~x07) | (new_n156_ & x01 & ~x05 & x07));
  assign new_n154_ = (~x04 | new_n155_ | x21) & (x05 | x08 | ~x18);
  assign new_n155_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x15 | x18 | x05 | ~x12);
  assign new_n156_ = x08 & ~x15 & ~x18;
  assign z25 = x18 & ~x17 & ~x15 & x09 & new_n56_ & x08;
  assign z26 = ~x20 & (~x15 | ~x18) & (x14 | x21);
  assign z27 = (~new_n160_ & ~x09) | (new_n163_ & new_n164_ & x09 & ~x15);
  assign new_n160_ = (~new_n162_ | ~x15 | ~x17 | x18) & (x15 | ((x17 | new_n161_ | ~x18) & (~new_n92_ | ~x17 | x18)));
  assign new_n161_ = x05 ? (~x19 | (~x07 ^ ~x08)) : (x07 | x08 | new_n133_ | x21);
  assign new_n162_ = new_n56_ & x00;
  assign new_n163_ = x03 & ~x05 & ~x07 & x08;
  assign new_n164_ = ~x17 & x18 & x19;
  assign z28 = new_n172_ | (~x09 & (new_n175_ | ((new_n166_ | new_n174_) & ~x05)));
