...
module FAU ( 
  ...
  assign z02 = z23 | (~x17 & (new_n66_ | (~new_n62_ & ~x05)));
  assign new_n62_ = (x09 | (~new_n63_ & (new_n64_ | ~x18))) & (~x08 | new_n65_ | ~x18);
  assign new_n63_ = x01 & x07 & ~x15 & (x08 | x16);
  assign new_n64_ = x08 ? ~x21 : x07;
  assign new_n65_ = ~x07 & x11 & (x02 | x07 | ~x11 | ~x15 | (~x09 & x21));
  assign new_n66_ = ~x07 & x08 & new_n67_ & ~x09;
  assign new_n67_ = x18 & (x21 | (~x04 & x05 & ~x11 & x15 & ~x21));
  assign z23 = ~x15 & x18;
  ...
  assign new_n73_ = (x07 | ~x15 | (~new_n75_ & (~new_n74_ | ~x00))) & (~new_n74_ | ~x07 | x15);
  ...
  assign z09 = z23 | (~x07 & (new_n80_ | (~new_n83_ & ~x09)));
  ...
  assign z10 = ~x09 & ((new_n74_ & ~x07) | (~x05 & (new_n74_ | new_n85_)));
  assign new_n85_ = ~x06 & ~x07 & ~x08 & x15 & ~x17 & x18;
  assign z11 = new_n87_ & ~x18;
  assign new_n87_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~x07 & ~new_n89_ & x15) | (~x05 & x07 & new_n74_ & ~x15));
  assign new_n89_ = (~new_n90_ | ~new_n91_) & (x05 | (~new_n75_ & (~new_n74_ | ~x00)));
  assign new_n90_ = ~x04 & x05 & x08;
  assign new_n91_ = ~x11 & ~x17 & x18 & ~x21;
  assign z13 = (~x15 & x18) | (~x09 & x17 & ~x18 & (~x05 | ~x07));
  assign z14 = z23 | (~x05 & (new_n96_ | (~new_n94_ & ~x17)));
  assign new_n94_ = (x07 | (~new_n82_ & ~new_n95_)) & (~x07 | ~x08 | ~x18 | x19);
  ...
  assign new_n101_ = new_n59_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign new_n102_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z18 = x19 & new_n104_ & x18;
  assign new_n104_ = ~x17 & x15 & ~x09 & new_n55_ & ~x08;
  assign z19 = ~x15 & (x18 | (new_n55_ & ~x09 & x17));
  assign z20 = ~x07 & ~x09 & ~x17 & (new_n107_ | new_n108_) & ~x21;
  assign new_n107_ = new_n90_ & ~x11 & x15 & x18;
  ...
  assign z24 = z23 | (~x09 & (new_n114_ | new_n118_) & ~x17);
  assign new_n114_ = ~x05 & (new_n117_ | (~x07 & (new_n115_ | new_n116_) & ~x21));
  assign new_n115_ = x04 & x12 & ~x14 & ~x15;
  assign new_n116_ = x11 & x18 & ~x02 & x08;
  assign new_n117_ = x01 & x07 & x08 & ~x15;
  assign new_n118_ = new_n119_ & ~x04 & x05 & ~x07;
  assign new_n119_ = x18 & ~x21 & x08 & ~x11;
  assign z25 = x18 & (~x15 | (new_n55_ & ~x08 & ~x09 & ~x17));
  assign z26 = ~x20 & ~z23 & (x14 | x21);
  assign z27 = ~x09 & (new_n101_ | (~new_n123_ & ~x05));
  assign new_n123_ = (new_n124_ | ~x07) & (~x00 | x07 | ~new_n74_ | ~x15);
  assign new_n124_ = (x15 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18 | ~x19);
  assign z28 = (~new_n126_ & ~x05) | z23 | (~x07 & ~new_n130_ & ~x09);
