...
module FAU ( 
  ...
  assign new_n76_ = (x05 | x07 | ~x08 | ~x09 | x15) & (x09 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15)));
  ...
  assign z09 = (~x17 & ~new_n106_ & x18) | (~x18 & (new_n115_ | x17));
  ...
  assign new_n116_ = x12 & ~x14 & ~x15 & ~x21;
  ...
  assign new_n155_ = new_n156_ & new_n63_ & x08 & ~x09;
  ...
  assign z23 = (x17 & ~x18) | (new_n162_ & ~x17 & x18 & x09 & ~x15);
