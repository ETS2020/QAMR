...
module FAU ( 
  ...
  assign new_n67_ = x05 ? (x07 | ~new_n70_ | x14) : (~new_n68_ & (x07 | ~new_n69_ | x14));
  ...
  assign z06 = (x14 & x18) | (~x09 & (new_n90_ | new_n102_));
  ...
  assign z09 = (x18 & (new_n107_ | x14)) | (~x07 & new_n115_ & ~x09);
  ...
  assign new_n115_ = ~x15 & ((x17 & (x14 | ~x18)) | (new_n116_ & ~x14 & ~x18 & ~x21));
  assign new_n116_ = x04 & ~x05 & x12;
  assign z10 = z13 | (x18 & (x14 | (~new_n118_ & ~x17)));
  ...
  assign z12 = (x14 & x18) | (~x09 & (new_n123_ | new_n102_));
  ...
  assign z14 = (new_n138_ & ~x05) | (~x14 & ~new_n132_ & ~x17);
  assign new_n132_ = (~x08 | new_n133_ | ~x18) & (~new_n137_ | ~new_n136_ | x18 | x21);
  ...
  assign z16 = x18 & (x14 | (x08 & ~new_n141_ & ~x17));
  ...
  assign z17 = ~x09 & (new_n102_ | (~new_n148_ & ~x07));
  assign new_n148_ = ~new_n101_ & (x14 | x17 | (~new_n149_ & ~new_n151_) | ~x18);
  assign new_n149_ = ~x04 & (new_n126_ | new_n150_);
  assign new_n150_ = x05 & x08 & ~x11 & x15 & ~x21;
  assign new_n151_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign z18 = x18 & (x14 | (~x05 & ~x07 & new_n153_ & ~x09));
  assign new_n153_ = ~x17 & ((~x15 & (new_n82_ | new_n154_)) | (~x08 & x15 & x19));
  assign new_n154_ = x12 & ((~new_n155_ & ~x06) | (new_n86_ & x06 & x08 & x10));
  assign new_n155_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = (x14 & x18) | (~x07 & ~new_n158_ & ~x17);
  assign new_n158_ = (new_n159_ | ~x18) & (~new_n163_ | x14 | x15 | x18 | x21);
  assign new_n159_ = (~new_n162_ | ~x04) & (x09 | (~new_n149_ & (~new_n160_ | ~x04)));
  assign new_n160_ = ~x12 & ~x15 & ((new_n161_ & x08) | (~x05 & ~x06 & ~x08));
  assign new_n161_ = x10 & ~x21 & (~x13 | (~x02 & x11));
  assign new_n162_ = x05 & x08 & ~x12 & ~x15 & (x09 | ~x21);
  assign new_n163_ = x04 & ~x05 & ~x09 & x12;
  assign z21 = ~x14 & ~x17 & ~new_n165_ & x18;
  assign new_n165_ = (x07 | ((x05 | ((~x06 | ~x08 | ~x09 | x15) & (x09 | ~x15 | x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = x18 & (new_n167_ | x14);
  assign new_n167_ = ~x17 & ((~new_n168_ & ~x07) | (~x05 & x07 & x08 & x15));
  assign new_n168_ = (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15))) & (x09 | x14 | x15 | ~x05 | ~x06 | x08);
  assign z24 = (x14 & x18) | (new_n170_ & ~x09);
  assign new_n170_ = ~x17 & (x05 ? (~x07 & new_n175_ & x08) : ~new_n171_);
  assign new_n171_ = (new_n172_ | x15) & (~new_n174_ | ~x11 | ~x15 | ~x18 | x21);
  ...
  assign new_n181_ = ~x21 & (new_n125_ | new_n151_);
  assign new_n182_ = ~x14 & (~new_n183_ | x07 | ~x08 | ~x03 | x05);
  assign new_n183_ = x09 & ~x15 & ~x17 & x19;
  assign new_n184_ = ~x05 & x17 & ~x18 & ((x00 & ~x07 & x15) | (x07 & ~x15));
