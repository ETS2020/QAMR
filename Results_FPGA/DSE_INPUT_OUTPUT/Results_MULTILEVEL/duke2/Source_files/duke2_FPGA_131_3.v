...
module FAU ( 
  ...
  assign new_n58_ = x18 & ~x20 & (new_n63_ | (~x09 & ~new_n59_ & ~x15));
  ...
  assign new_n66_ = x18 & ~x20 & ~x21 & ~x11 & x15;
  assign new_n67_ = x02 & x07 & ~x09 & x11 & x15 & ~x18;
  assign z02 = (~x17 & (x15 ? (~new_n74_ & x18) : ~new_n69_)) | (x18 & x20);
  ...
  assign new_n79_ = ~x20 & ((x05 & ~x15 & (x07 ^ ~x08)) | (x08 & x15 & ~x05 & x07));
  assign new_n80_ = x05 & x07;
  assign new_n81_ = ~x15 & ~x17 & x18 & ~x20;
  assign z04 = ~x14 & ~x20;
  assign z05 = ~x05 & ~x07 & ~x09 & ~x14 & new_n84_ & ~x15;
  assign new_n84_ = ~x17 & x18 & ~x20 & (new_n85_ | new_n87_ | new_n89_);
  ...
  assign new_n92_ = ~x17 & x18 & ~x20 & (new_n103_ | (~new_n93_ & ~x05));
  ...
  assign z10 = (x18 & (x20 | (~new_n124_ & ~x17))) | (~x09 & x17 & ~new_n80_ & ~x18);
  ...
  assign z12 = new_n135_ | (~x09 & (new_n107_ | (~new_n128_ & ~x07)));
  assign new_n128_ = ~new_n105_ & (x17 | ~x18 | (new_n129_ & ~new_n133_) | x21);
  assign new_n129_ = (x05 | (~new_n94_ & ~new_n130_ & ~new_n102_)) & (~new_n132_ | ~x04);
  assign new_n130_ = ~x15 & (new_n131_ | (x06 & ~x08 & (x02 ^ x11)));
  assign new_n131_ = ~x13 & ~x14 & x08 & ~x10;
  assign new_n132_ = x08 & ~x12 & ~new_n104_ & ~x15;
  assign new_n133_ = ~new_n134_ & ~x04;
  assign new_n134_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n135_ = x18 & x20;
  assign z13 = (x18 & x20) | (~x09 & x17 & ~new_n80_ & ~x18);
  ...
  assign new_n143_ = (~x18 | ~x20) & (x05 | x09 | new_n144_ | x18);
  assign new_n144_ = (~x15 | (~x07 & ~x17)) & (~x07 | (x01 & ~x17));
  assign z15 = new_n135_ | (new_n141_ & x05 & new_n106_ & ~x15);
  assign z16 = x18 & (x20 | (x08 & ~new_n147_ & ~x17));
  assign new_n147_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n148_;
  assign new_n148_ = (x07 | x15 | (x09 ? x19 : ~new_n149_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n149_ = ~x14 & ~x21 & ((~new_n151_ & x12) | (~new_n61_ & ~new_n150_));
  ...
  assign new_n154_ = ~x17 & x18 & ~x20 & ~new_n155_ & (~x21 | (~x14 & x21));
  assign new_n155_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n156_ = ~x07 & x08 & ~x11;
  assign new_n157_ = x18 & ~x20 & ~x21 & x15 & ~x17;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & new_n159_ & x18;
  assign new_n159_ = ~x20 & ((~x14 & ~new_n160_ & ~x15) | (~x08 & x15 & x19));
  ...
  assign z19 = new_n135_ | (new_n141_ & ~x05 & new_n106_ & ~x15);
  assign z20 = new_n135_ | (~x07 & ~x17 & (new_n172_ | (~new_n165_ & ~x15)));
  assign new_n165_ = (new_n166_ | ~x18) & (~new_n171_ | x18 | x21 | ~x12 | x14);
  ...
  assign z21 = ~x17 & x18 & ~new_n175_ & ~x20;
  assign new_n175_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = x18 & (new_n177_ | x20);
  assign new_n177_ = ~x17 & ((~new_n178_ & ~x07) | (~x05 & x07 & x08 & x15));
  assign new_n178_ = (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x20);
  assign z23 = x18 & (new_n180_ | x20);
  assign new_n180_ = ~x05 & ~x07 & x08 & x09 & ~x15 & ~x17;
  assign z24 = ~x09 & ~x17 & (new_n186_ | (~new_n182_ & ~x07));
  assign new_n182_ = ~new_n183_ & (x15 | ~x18 | x20 | x05 | x08);
  assign new_n183_ = ~x21 & ((x04 & ~new_n184_ & ~x15) | (x08 & new_n185_ & x15));
  assign new_n184_ = (x14 | x18 | x05 | ~x12) & (~x05 | ~x08 | x12 | ~x18 | x20);
  assign new_n185_ = x18 & ~x20 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n186_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = x18 & (new_n188_ | x20);
  ...
  assign new_n192_ = ~x21 & (new_n133_ | new_n193_);
  assign new_n193_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n194_ = ~x20 & (~new_n195_ | ~x03 | x05 | x07 | ~x08);
  assign new_n195_ = x09 & ~x15 & ~x17 & x19;
  assign new_n196_ = ~x05 & x17 & ~x18 & ((x00 & ~x07 & x15) | (x07 & ~x15));
  assign z28 = ~new_n209_ | (~x17 & ((~new_n198_ & x18) | (new_n211_ & ~x05)));
  assign new_n198_ = (~new_n206_ | x07) & (x05 | (~new_n199_ & ~new_n208_ & (~new_n202_ | x07)));
  assign new_n199_ = ~new_n200_ & ~x02;
  assign new_n200_ = (~x08 | ~x15) & (~new_n201_ | ~x11 | x14 | x15 | ~x21);
  assign new_n201_ = ~x08 & ~x09 & x06 & ~x07;
