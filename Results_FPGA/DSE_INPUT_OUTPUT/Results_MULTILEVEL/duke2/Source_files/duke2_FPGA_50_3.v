...
module FAU ( 
  ...
  assign new_n84_ = ~x15 & ~x17 & x18 & ~x20;
  ...
  assign z10 = (~x09 & x17 & ~new_n83_ & ~x18) | (x18 & (x20 | (~new_n123_ & ~x17)));
  ...
  assign z14 = ~new_n146_ | (~x17 & (new_n141_ | (x08 & ~new_n144_ & x18)));
  assign new_n141_ = new_n142_ & new_n143_ & x04 & ~x05;
  assign new_n142_ = new_n56_ & ~x15 & ~x18 & ~x21;
  ...
  assign z15 = (x18 & x20) | (new_n143_ & x05 & ~x15 & x17 & ~x18);
  ...
  assign z17 = (~x09 & (new_n159_ | (~new_n156_ & ~x05))) | (x18 & x20);
  ...
  assign z19 = (x18 & x20) | (new_n143_ & ~x05 & ~x15 & x17 & ~x18);
  ...
  assign new_n174_ = new_n66_ & ~x04 & x05 & x08 & ~x09;
  assign z21 = ~x17 & x18 & ~new_n176_ & ~x20;
  assign new_n176_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ~new_n178_ & ~x20;
  ...
  assign z24 = (x18 & x20) | (~x09 & ~x17 & (new_n182_ | new_n186_));
  ...
  assign new_n186_ = new_n125_ & x08 & ~x15 & ~x18;
  ...
  assign new_n192_ = ~new_n194_ & (x21 | (~new_n129_ & ~new_n193_));
  ...
  assign new_n200_ = ~x20 & (new_n208_ | (~x05 & (~new_n201_ | (~new_n206_ & ~x02))));
