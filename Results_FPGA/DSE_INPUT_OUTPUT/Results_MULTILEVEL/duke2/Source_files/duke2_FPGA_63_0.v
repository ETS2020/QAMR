...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n89_ & ~x07) | (new_n103_ & ~x05 & x07));
  assign new_n89_ = ~new_n102_ & (x17 | ~x18 | (~new_n100_ & (new_n90_ | x05)));
  ...
  assign new_n119_ = ~new_n120_ & x18 & (~new_n121_ | x05 | x06 | x07);
  assign new_n120_ = ~x15 & ((x05 & ((x07 & x08) | (~x08 & ~x09 & ~x06 & ~x07))) | (~x05 & ~x07 & x08 & x09));
  assign new_n121_ = ~x08 & ~x09 & x15;
  ...
  assign z20 = ~x07 & ~x17 & x18 & (new_n61_ | (~new_n160_ & ~x15));
  assign new_n160_ = (x09 | ((~new_n161_ | ~x04) & (~new_n162_ | x05))) & (~x04 | ~new_n163_ | ~x05);
  ...
  assign new_n165_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (x08 | x09 | x15 | ~x05 | ~x06);
  assign new_n166_ = x08 & ~x09 & x15;
  assign z22 = ~x17 & (new_n168_ | ~x18 | (new_n131_ & x08 & x15));
  assign new_n168_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n75_ & x08;
  assign z24 = ~x17 & (~x18 | (new_n171_ & ~x07));
  assign new_n171_ = ~x09 & ((x08 & ~new_n172_ & ~x21) | (~x05 & ~x08 & ~x15));
  assign new_n172_ = (x02 | x05 | ~x11 | ~x15) & (~x05 | (x04 ? (x12 | x15) : (x11 | ~x15)));
  assign z25 = ~x05 & ~x07 & ~x17 & (new_n76_ | new_n121_) & x18;
  ...
  assign new_n179_ = new_n75_ & x03 & x08 & x09 & ~x15 & x19;
