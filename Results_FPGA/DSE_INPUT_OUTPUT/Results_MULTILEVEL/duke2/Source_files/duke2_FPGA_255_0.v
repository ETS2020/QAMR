...
module FAU ( 
  ...
  assign new_n56_ = (x09 | ((~new_n59_ | ~x06) & (~new_n57_ | x02))) & (~new_n60_ | x02);
  assign new_n57_ = x08 & x11 & x13 & new_n58_ & ~x14;
  assign new_n58_ = ~x21 & (~x10 | (x04 & ~x12));
  assign new_n59_ = ~x08 & ~x15 & (~x14 | ~x21) & (~x02 ^ ~x11);
  assign new_n60_ = x08 & x11 & x15 & (x09 | ~x21);
  assign new_n61_ = new_n62_ & ~x04 & x05 & x08;
  assign new_n62_ = x15 & ~x21 & ~x09 & ~x11;
  assign z02 = ~x17 & ((~new_n64_ & ~x07) | ~x18 | (~new_n71_ & x08));
  assign new_n64_ = ((new_n65_ & ~new_n68_) | x09) & (x05 | new_n70_ | ~x08);
  assign new_n65_ = x08 ? ((~new_n66_ | x02) & (~x15 | ~x21)) : new_n67_;
  assign new_n66_ = ~x05 & x11 & x13 & ~x14 & new_n58_ & x18;
  assign new_n67_ = x15 ? x05 : ((~x06 | (x02 & x11)) & ~x05 & (x06 | x12));
  assign new_n68_ = ~x04 & (new_n69_ | (~x06 & ~x08 & ~x15));
  assign new_n69_ = x05 & x08 & ~x11 & x15 & x18 & ~x21;
  assign new_n70_ = x15 & (x02 | ~x11 | ~x15 | ~x18 | (~x09 & x21));
  assign new_n71_ = (new_n72_ | (~x05 ^ x15)) & (~x05 | x15 | (x04 & x12)) & (x05 | x11 | ~x15);
  assign new_n72_ = ~x07 & (x09 | ~x21);
  ...
  assign z11 = ~x17 & ~x18;
  assign z05 = ~x17 & (~x18 | (~x05 & new_n79_ & ~x07));
  assign new_n79_ = ~x09 & ~x14 & ~x15 & (~new_n80_ | (~new_n86_ & x02));
  ...
  assign new_n86_ = (~x06 | x08 | x11 | ~x21) & (~new_n87_ | x06 | ~x08 | x10);
  ...
  assign new_n102_ = new_n103_ & x15 & x00 & ~x05;
  assign new_n103_ = x17 & ~x18;
  assign new_n104_ = new_n103_ & ~x15 & ~x05 & x07;
  assign z07 = ~x17 & (new_n107_ | new_n106_ | ~x18);
  assign new_n106_ = new_n75_ & x09 & ~x15 & x16;
  assign new_n107_ = ~x09 & (~x07 ^ x08) & (~x05 ^ ~x15);
  ...
  assign z10 = (~x17 & ~new_n120_ & x18) | (~x09 & x17 & ~x18 & (~x05 | ~x07));
  assign new_n120_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z12 = ~x09 & (new_n104_ | (~x07 & (new_n102_ | (new_n122_ & ~x17))));
  assign new_n122_ = x18 & ~x21 & ((~new_n126_ & ~x04) | new_n123_ | (new_n125_ & x04));
  assign new_n123_ = ~x05 & (new_n91_ | new_n99_ | (~new_n124_ & ~x15));
  assign new_n124_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n101_ | ~x08 | x10);
  assign new_n125_ = x08 & ~x12 & ~x15 & (new_n101_ | x05);
  assign new_n126_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign z13 = ~x18 & (~x17 | (~x09 & (~x05 | ~x07)));
  assign z14 = (x08 & new_n129_ & ~x17) | (~x05 & ~x09 & new_n132_ & x17);
  ...
  assign new_n137_ = (new_n138_ | (new_n139_ & (~x02 | ~x06))) & (~x12 | new_n139_ | (~x06 ^ x16));
  assign new_n138_ = x10 & (~x04 | x12);
  assign new_n139_ = x13 & (x02 | ~x11);
  assign new_n140_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~new_n142_ & ~x09;
  assign new_n142_ = (new_n143_ | x05) & (~new_n146_ | x07 | ~x08 | x04 | ~x05);
  assign new_n143_ = (x07 | ((x08 | ~new_n144_ | x15) & (~new_n103_ | ~x00 | ~x15))) & (~new_n103_ | ~x07 | x15);
  ...
  assign z18 = ~x17 & (~x18 | (~x05 & ~x07 & ~new_n148_ & ~x09));
  assign new_n148_ = (x14 | x15 | (~new_n149_ & ~new_n152_)) & (x08 | ~x15 | ~x19);
  assign new_n149_ = ~new_n150_ & x02;
  assign new_n150_ = (~x06 | x08 | x11 | ~x18 | ~x21) & (~new_n151_ | x06 | ~x08);
  assign new_n151_ = ~x10 & x13 & ~x21;
  assign new_n152_ = x12 & ((~new_n153_ & ~x06) | (new_n154_ & x06 & x08 & x10));
  assign new_n153_ = (~x18 | ~x21 | x04 | x08) & (~new_n84_ | ~x08 | ~x10);
  assign new_n154_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & (~x17 | (~x09 & ~x15 & ~x05 & ~x07));
  assign z20 = ~x07 & ~x17 & x18 & (new_n61_ | (~new_n157_ & ~x15));
  assign new_n157_ = (x09 | ((~new_n158_ | ~x04) & (~new_n159_ | x05))) & (~x04 | ~new_n160_ | ~x05);
  assign new_n158_ = x08 & x10 & ~x12 & ~x14 & ~new_n139_ & ~x21;
  assign new_n159_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n160_ = x08 & ~x12 & (x09 | ~x21);
  ...
  assign new_n164_ = (new_n165_ | x07) & x18 & (x05 | ~x07 | ~x08 | ~x15);
  assign new_n165_ = (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign z23 = ~x17 & (~x18 | (new_n167_ & ~x05 & ~x07));
  assign new_n167_ = x08 & x09 & ~x15;
  assign z24 = ~x17 & ((new_n169_ & ~x07) | ~x18);
  assign new_n169_ = ~x09 & ((x08 & ~new_n170_ & ~x21) | (~x05 & ~x08 & ~x15));
  assign new_n170_ = (x02 | x05 | ~x11 | ~x15) & (~x05 | (x04 ? (x12 | x15) : (x11 | ~x15)));
  assign z25 = ~new_n172_ & ~x17;
  assign new_n172_ = x18 & (x05 | x07 | (x08 ? (~x09 | x15) : (x09 | ~x15)));
  assign z26 = z11 | (~x20 & (x14 | x21));
  assign z27 = new_n175_ | (new_n180_ & x03 & ~x05 & ~x07 & x08);
  ...
  assign new_n177_ = ~x21 & (new_n178_ | (~new_n126_ & ~x04));
  assign new_n178_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n179_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n180_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & ~new_n182_ & x18) | (~x09 & x17 & ~new_n193_ & ~x18);
  assign new_n182_ = ~new_n191_ & (x05 | (new_n183_ & (new_n189_ | x02)));
  assign new_n183_ = (~new_n188_ | ~x08) & (x07 | x09 | (x08 ? ~new_n186_ : new_n184_));
  assign new_n184_ = (~x15 | x19) & (~new_n185_ | x14 | x15 | ~x21);
  assign new_n185_ = x04 & ~x06 & ~x12;
  assign new_n186_ = x10 & new_n187_ & x12;
  assign new_n187_ = ~x14 & ~x15 & ~x21 & (x02 | x11 | ~x13);
  assign new_n188_ = x15 & (x07 | ~x11);
