...
module FAU ( 
  ...
  assign new_n124_ = ~new_n126_ & (x05 | (~new_n91_ & ~new_n98_ & (new_n125_ | x15)));
  assign new_n125_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n104_ | ~x08 | x10);
  assign new_n126_ = x04 & x08 & ~x12 & ~x15 & (new_n104_ | x05);
  ...
  assign z17 = new_n78_ | (~x09 & (new_n147_ | (~new_n144_ & ~x05)));
  ...
  assign new_n158_ = x08 & ~new_n60_ & ~x12;
  ...
  assign new_n166_ = ~x09 & ((x08 & ~new_n167_ & ~x21) | (~x05 & ~x08 & ~x15));
