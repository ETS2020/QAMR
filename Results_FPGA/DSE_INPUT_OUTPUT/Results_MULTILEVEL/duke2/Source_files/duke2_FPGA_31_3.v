...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n108_ | (~x07 & (new_n107_ | (new_n94_ & ~x17))));
  ...
  assign new_n125_ = ~x15 & ((x05 & ((x07 & x08) | (~x08 & ~x09 & ~x06 & ~x07))) | (x08 & x09 & ~x05 & ~x07));
  assign new_n126_ = ~x08 & ~x09 & x15;
  assign z11 = (x17 & x18) | (new_n128_ & ~x17 & ~x18 & ~x09 & ~x15);
  assign new_n128_ = x01 & ~x05 & x07;
  assign z12 = ~x09 & (new_n108_ | (~x07 & (new_n107_ | (new_n130_ & ~x17))));
  ...
  assign z14 = (~x05 & ~new_n137_ & ~x09) | (x18 & (new_n140_ | x17));
  ...
  assign new_n140_ = x08 & (x07 ? new_n142_ : (~new_n141_ & (x09 | ~x21)));
  ...
  assign new_n164_ = ~new_n165_ & (~new_n155_ | x04 | ~x05 | ~x08 | x09);
  ...
  assign z24 = (x17 & x18) | (~x09 & (new_n178_ | (new_n128_ & new_n182_ & ~x17 & ~x18)));
  assign new_n178_ = ~x07 & (new_n179_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n179_ = ~x21 & ((x04 & ~new_n180_ & ~x15) | (x08 & new_n181_ & x15));
  assign new_n180_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x17 | x18);
  assign new_n181_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n182_ = x08 & ~x15;
  assign z25 = x18 & (x17 | (~x05 & ~x07 & (new_n81_ | new_n126_)));
  assign z26 = ~x20 & (x14 | x21) & (~x17 | ~x18);
  assign z27 = (x18 & (new_n189_ | x17)) | (~x09 & (new_n190_ | (~new_n186_ & x18)));
  ...
  assign new_n189_ = new_n80_ & x03 & x08 & x09 & ~x15 & x19;
