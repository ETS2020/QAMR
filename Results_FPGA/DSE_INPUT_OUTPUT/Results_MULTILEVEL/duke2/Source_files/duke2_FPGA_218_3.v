...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n105_ | (~x07 & (new_n107_ | (new_n93_ & ~x17))));
  ...
  assign new_n128_ = ~new_n107_ & (~x18 | x21 | (new_n129_ & (new_n133_ | x04)));
  assign new_n129_ = (~new_n132_ | ~x04) & (x05 | (~new_n95_ & ~new_n130_ & ~new_n103_));
  ...
  assign z16 = x18 & (x17 | (x08 & (x05 ? new_n147_ : ~new_n143_)));
  ...
  assign z17 = ~x09 & (new_n149_ | (new_n66_ & new_n153_ & new_n67_ & ~x17));
  assign new_n149_ = ~x05 & ((~new_n150_ & ~x07) | (x07 & ~x15 & x17 & ~x18));
  ...
  assign new_n168_ = new_n67_ & new_n153_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign z22 = x18 & (new_n173_ | x17 | (new_n106_ & x08 & x15));
  assign new_n173_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  ...
  assign new_n177_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x17 | x18);
  assign new_n178_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n179_ = new_n106_ & x01 & x08 & ~x15 & ~x17 & ~x18;
