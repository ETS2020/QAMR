...
module FAU ( 
  ...
  assign new_n123_ = ~new_n124_ & ~x17 & (~new_n125_ | x05 | x06 | x07);
  assign new_n124_ = ~x15 & ((x05 & ((x07 & x08) | (~x08 & ~x09 & ~x06 & ~x07))) | (x08 & x09 & ~x05 & ~x07));
  assign new_n125_ = ~x08 & ~x09 & x15;
  ...
  assign z14 = (~x05 & ~new_n136_ & ~x09) | (x18 & (new_n139_ | x17));
  assign new_n136_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n137_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n137_ = new_n138_ & new_n56_ & ~x15 & ~x17;
  assign new_n138_ = x04 & ~x07 & x12 & ~x14;
  assign new_n139_ = x08 & (x07 ? new_n141_ : (~new_n140_ & (x09 | ~x21)));
  ...
  assign z20 = (~new_n161_ & ~x07) | (x17 & x18);
  assign new_n161_ = ~new_n162_ & (~new_n154_ | x04 | ~x05 | ~x08 | x09);
  assign new_n162_ = ~x15 & (new_n166_ | (x18 & (new_n167_ | (~new_n163_ & ~x09))));
  ...
  assign new_n166_ = new_n55_ & ~x09 & x12 & new_n56_ & ~x14 & ~x17;
  assign new_n167_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign z21 = x18 & (~new_n170_ | (~new_n169_ & ~x07));
  assign new_n169_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15 | x17))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign new_n170_ = ~x17 & (x05 | ~x07 | ~x08 | x09 | ~x15 | x17);
  assign z22 = ~x17 & ~new_n172_ & x18;
  assign new_n172_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n80_ & x08;
  assign z24 = (x17 & x18) | (~x09 & (new_n175_ | (new_n179_ & new_n180_ & ~x17 & ~x18)));
  ...
  assign new_n179_ = x01 & ~x05 & x07;
  assign new_n180_ = x08 & ~x15;
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n81_ | new_n125_);
