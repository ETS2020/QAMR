...
module FAU ( 
  ...
  assign new_n105_ = new_n106_ & x15 & x00 & ~x05 & ~x14;
  assign new_n106_ = x17 & ~x18;
  assign new_n107_ = ~x05 & x07 & ~x14 & new_n106_ & ~x15;
  assign z07 = ~x17 & ~new_n109_ & x18;
  assign new_n109_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = ~x20 & x14 & x18;
  assign z09 = (~x17 & ~new_n112_ & x18) | (~x18 & (x14 | (new_n121_ & ~x07)));
  ...
  assign z13 = ~x09 & ~x14 & x17 & ~new_n124_ & ~x18;
  ...
  assign new_n139_ = new_n140_ & new_n122_ & ~x07 & ~x09;
  assign new_n140_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n141_ = ~x14 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n143_ & ~x18;
  assign new_n143_ = ~x14 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = (x14 & ~x18) | (x08 & ~x17 & ~new_n145_ & x18);
  assign new_n145_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n146_;
  assign new_n146_ = (x07 | x15 | (x09 ? x19 : ~new_n147_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n147_ = ~x14 & ~x21 & (new_n149_ | (~new_n60_ & ~new_n148_));
  assign new_n148_ = (~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11);
  assign new_n149_ = x12 & (x06 ^ x16) & (~x13 | (~x02 & x11));
  assign z17 = new_n67_ | (~x09 & (new_n154_ | (~new_n151_ & ~x05)));
  assign new_n151_ = (x07 | ((x08 | ~new_n152_ | x15) & (~new_n106_ | ~x00 | ~x15))) & (~new_n106_ | ~x07 | x15);
  ...
  assign z18 = new_n67_ | (~x05 & ~x07 & ~x09 & new_n156_ & ~x17);
  ...
  assign new_n161_ = ~x14 & (x05 | x07 | x09 | x15 | ~x17);
  assign z20 = new_n67_ | (~x07 & ~new_n163_ & ~x17);
  ...
  assign new_n168_ = x04 & x05 & x08 & ~new_n63_ & ~x12;
  assign new_n169_ = x04 & ~x05 & ~x09 & x12 & ~x18 & ~x21;
  assign new_n170_ = ~x04 & x05 & x08 & ~x09;
  assign z21 = (x14 & ~x18) | (~x17 & ~new_n172_ & x18);
  ...
  assign new_n178_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x18);
  assign new_n179_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n180_ = x08 & ~x15 & ~x18 & x01 & ~x05 & x07;
  ...
  assign new_n186_ = ~x21 & (new_n187_ | (~new_n133_ & ~x04));
  assign new_n187_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n188_ = ~new_n67_ & (~new_n189_ | x07 | ~x08 | ~x03 | x05);
  assign new_n189_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n190_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n192_ | new_n203_)) | (~x09 & ~x14 & new_n205_ & x17);
  ...
  assign new_n203_ = ~x05 & new_n204_ & x07;
  assign new_n204_ = ~x09 & ~x14 & x15 & ~x18 & (~x02 | ~x11);
