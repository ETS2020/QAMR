...
module FAU ( 
  ...
  assign z06 = new_n67_ | (~x09 & (new_n106_ | (~new_n94_ & ~x07)));
  ...
  assign z17 = new_n67_ | (~x09 & (new_n163_ | (~new_n160_ & ~x05)));
  assign new_n160_ = (x07 | ((x08 | ~new_n161_ | x15) & (~new_n107_ | ~x00 | ~x15))) & (~new_n107_ | ~x07 | x15);
  ...
  assign z18 = new_n67_ | (~x05 & ~x07 & ~x09 & ~new_n165_ & ~x17);
  assign new_n165_ = (x14 | new_n166_ | x15) & (~x18 | ~x19 | x08 | ~x15);
  assign new_n166_ = ~new_n168_ & (~x18 | (~new_n87_ & (x06 | new_n167_ | ~x12)));
  ...
  assign z20 = new_n67_ | (~x07 & ~x17 & (new_n179_ | (~new_n172_ & ~x15)));
  assign new_n172_ = (new_n173_ | ~x18) & (~new_n178_ | ~x12 | x14 | x18 | x21);
  assign new_n173_ = (x09 | ((~new_n176_ | x05) & (~new_n174_ | ~x04))) & (~x04 | ~new_n177_ | ~x05);
  ...
  assign z24 = new_n67_ | (~x09 & ~x17 & (new_n187_ | new_n191_));
  ...
  assign z28 = (~x17 & (new_n204_ | new_n215_)) | (~x09 & ~x16 & new_n217_ & x17);
  assign new_n204_ = x18 & (new_n213_ | (~x05 & (~new_n205_ | (~new_n211_ & ~x02))));
  assign new_n205_ = (~new_n210_ | ~x08) & (x07 | x09 | (x08 ? ~new_n208_ : new_n206_));
