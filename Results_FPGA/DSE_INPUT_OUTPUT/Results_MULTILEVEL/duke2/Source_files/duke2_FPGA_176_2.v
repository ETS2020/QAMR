...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n90_ & ~x07) | (new_n102_ & ~x05 & x07 & ~x15));
  assign new_n90_ = ~new_n101_ & (x17 | ~x18 | (~new_n104_ & (new_n91_ | x05)));
  ...
  assign new_n101_ = new_n102_ & x00 & ~x05 & x15;
  assign new_n102_ = new_n103_ & ~x16;
  ...
  assign z09 = (~new_n119_ & ~x18) | (~x17 & ~new_n110_ & x18);
  ...
  assign new_n119_ = ~x16 & (x07 | x09 | x15 | (~new_n120_ & ~x17));
  ...
  assign z11 = ~x18 & (new_n125_ | x16);
  assign new_n125_ = ~x09 & ~x15 & ~x17 & x01 & ~x05 & x07;
  assign z12 = new_n78_ | (~new_n127_ & ~x09);
  assign new_n127_ = ~new_n136_ & (x07 | (~new_n135_ & (x17 | ~new_n128_ | ~x18)));
  assign new_n128_ = ~x21 & (new_n129_ | new_n134_ | (~x05 & (new_n92_ | ~new_n131_)));
  assign new_n129_ = ~new_n130_ & ~x04;
  assign new_n130_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n131_ = ~new_n100_ & (x15 | (~new_n132_ & ~new_n133_));
  assign new_n132_ = x06 & ~x08 & (~x02 ^ ~x11);
  assign new_n133_ = ~x13 & ~x14 & x08 & ~x10;
  assign new_n134_ = x04 & x08 & ~x12 & ~new_n105_ & ~x15;
  assign new_n135_ = x00 & ~x05 & new_n103_ & x15;
  assign new_n136_ = new_n103_ & ~x15 & ~x05 & x07;
  ...
  assign new_n142_ = new_n143_ & ~x07 & ~x09 & x12 & x04 & ~x05;
  assign new_n143_ = ~x14 & ~x15 & ~x16 & ~x18 & ~x21;
  assign new_n144_ = ~x16 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n146_ & ~x18;
  assign new_n146_ = x17 & ~x16 & ~x15 & ~x09 & x05 & ~x07;
  ...
  assign z17 = new_n78_ | (~x09 & (new_n157_ | (~new_n154_ & ~x05)));
  assign new_n154_ = (x07 | ((x08 | ~new_n155_ | x15) & (~new_n103_ | ~x00 | ~x15))) & (~new_n103_ | ~x07 | x15);
  ...
  assign z18 = new_n78_ | (~x05 & ~x07 & ~x09 & ~new_n159_ & ~x17);
  assign new_n159_ = (x14 | new_n160_ | x15) & (~x18 | ~x19 | x08 | ~x15);
  assign new_n160_ = ~new_n161_ & (~x18 | (~new_n83_ & (x06 | new_n163_ | ~x12)));
  assign new_n161_ = new_n162_ & x06 & x08 & x10;
  assign new_n162_ = x16 & ~x21 & x12 & ~x13;
  ...
  assign z22 = (x16 & ~x18) | (~x17 & ~new_n177_ & x18);
  ...
  assign new_n190_ = ~x21 & (new_n129_ | new_n191_);
  ...
  assign z28 = (~x17 & (new_n196_ | new_n207_)) | (~x09 & ~x16 & new_n209_ & x17);
