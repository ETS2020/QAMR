...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n91_ & ~x07) | (~x05 & x07 & new_n105_ & ~x15));
  ...
  assign new_n107_ = ~x17 & (~new_n65_ | x05 | ~x09 | x15 | ~x16);
  ...
  assign new_n120_ = ~x17 & (~new_n121_ | x14 | x18 | x21);
  assign new_n121_ = x04 & ~x05 & x12;
  assign z10 = (~x17 & ~new_n123_ & x18) | (~x09 & x17 & ~x18 & (~x05 | ~x07));
  assign new_n123_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign z11 = new_n125_ & ~x18;
  assign new_n125_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (x17 & x18) | (~x09 & (new_n127_ | (new_n135_ & ~x15 & x17)));
  assign new_n127_ = ~x07 & (new_n134_ | (x18 & ~x21 & (~new_n128_ | new_n132_)));
  assign new_n128_ = (~new_n131_ | ~x04) & (x05 | (~new_n93_ & ~new_n129_ & ~new_n101_));
  assign new_n129_ = ~x15 & (new_n130_ | (x06 & ~x08 & (~x02 ^ ~x11)));
  assign new_n130_ = x08 & ~x10 & ~x13 & ~x14;
  assign new_n131_ = x08 & ~x12 & ~new_n103_ & ~x15;
  assign new_n132_ = ~new_n133_ & ~x04;
  assign new_n133_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n134_ = x00 & ~x05 & x15 & x17;
  assign new_n135_ = ~x05 & x07;
  assign z13 = x17 & (x18 | (~x09 & (~x05 | ~x07)));
  assign z14 = (x18 & (new_n138_ | x17)) | (~x05 & ~new_n141_ & ~x09);
  assign new_n138_ = x08 & (x07 ? (~new_n108_ & ~x19) : new_n139_);
  assign new_n139_ = ~new_n140_ & (x09 | ~x21);
  assign new_n140_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n141_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n142_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n142_ = new_n143_ & x04 & ~x07 & x12 & ~x14;
  ...
  assign new_n152_ = (x07 | ((x08 | ~new_n153_ | x15) & (~new_n105_ | ~x00 | ~x15))) & (~new_n105_ | ~x07 | x15);
  ...
  assign new_n164_ = ~x06 & ~x08 & ~new_n89_ & (~x14 | ~x21);
  ...
  assign new_n181_ = new_n135_ & x01 & x08 & ~x15 & ~x18;
  ...
  assign new_n189_ = new_n190_ & new_n65_ & x03 & ~x05;
