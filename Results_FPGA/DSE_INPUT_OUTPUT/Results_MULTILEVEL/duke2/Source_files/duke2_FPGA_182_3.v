...
module FAU ( 
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n92_ | (new_n104_ & ~x15 & x17)));
  assign new_n92_ = ~x07 & (new_n103_ | (x18 & (new_n101_ | (~new_n93_ & ~x15))));
  ...
  assign new_n103_ = x15 & x17 & x00 & ~x05;
  ...
  assign z12 = (x17 & x18) | (~x09 & (new_n127_ | (new_n104_ & ~x15 & x17 & ~x18)));
  ...
  assign z20 = (x17 & x18) | (~x07 & (new_n174_ | (~new_n168_ & ~x15)));
  assign new_n168_ = (new_n169_ | ~x18) & (~new_n173_ | x14 | x17 | x18 | x21);
  ...
  assign new_n174_ = new_n67_ & new_n158_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n178_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign new_n185_ = new_n104_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  ...
  assign new_n193_ = new_n166_ & x03 & x08 & x09 & ~x15 & x19;
