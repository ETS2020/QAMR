...
module FAU ( 
  ...
  assign new_n101_ = ~x12 & ~x15 & (new_n102_ | x05) & ~x21;
  ...
  assign z12 = ~x09 & (new_n105_ | (~x07 & (new_n103_ | (new_n125_ & ~x17))));
  assign new_n125_ = x18 & ~x21 & ((~new_n129_ & ~x04) | new_n126_ | (new_n128_ & x04));
  assign new_n126_ = ~x05 & (new_n92_ | new_n100_ | (~new_n127_ & ~x15));
  assign new_n127_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n102_ | ~x08 | x10);
  assign new_n128_ = x08 & ~x12 & (new_n102_ | x05) & ~x15;
  assign new_n129_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign z14 = new_n133_ | (~x17 & (~x18 | (~new_n131_ & x08)));
  assign new_n131_ = x07 ? (new_n109_ | x19) : (new_n61_ | new_n132_);
  assign new_n132_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n133_ = ~x05 & ~x09 & ~x18 & (x07 | x15);
  ...
  assign new_n138_ = (new_n59_ | (new_n139_ & (~x02 | ~x06))) & (~x12 | new_n139_ | (~x06 ^ x16));
  assign new_n139_ = x13 & (x02 | ~x11);
  assign new_n140_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & ((~new_n142_ & ~x05) | (new_n145_ & new_n108_ & ~x04 & x05));
  assign new_n142_ = (x07 | ((x08 | ~new_n143_ | x15) & (~new_n104_ | ~x00 | ~x15))) & (~new_n104_ | ~x07 | x15);
  ...
  assign z18 = ~x17 & (~x18 | (~x05 & ~x07 & ~new_n147_ & ~x09));
  assign new_n147_ = (x14 | (~new_n148_ & ~new_n151_) | x15) & (x08 | ~x15 | ~x19);
  assign new_n148_ = ~new_n149_ & x02;
  assign new_n149_ = (~x06 | x08 | x11 | ~x18 | ~x21) & (~new_n150_ | x06 | ~x08);
  assign new_n150_ = ~x10 & x13 & ~x21;
  assign new_n151_ = x12 & ((~new_n152_ & ~x06) | (new_n153_ & x06 & x08 & x10));
  assign new_n152_ = (x04 | x08 | ~x18 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  assign new_n153_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & (~x17 | (~x05 & ~x07 & ~x09 & ~x15));
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n62_ | (~new_n156_ & ~x15))));
  assign new_n156_ = (x09 | ((~new_n157_ | ~x04) & (~new_n159_ | x05))) & (~x04 | ~new_n158_ | ~x05);
  assign new_n157_ = x08 & x10 & ~x12 & ~x14 & ~new_n139_ & ~x21;
  ...
  assign z27 = new_n171_ | (new_n176_ & new_n108_ & x03 & ~x05);
