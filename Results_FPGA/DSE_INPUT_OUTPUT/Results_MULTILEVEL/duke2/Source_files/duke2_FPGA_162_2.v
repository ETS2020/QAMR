...
module FAU ( 
  ...
  assign new_n76_ = ~x03 & ~x05 & x07 & ~x18 & (x08 | x16);
  assign new_n77_ = (~x07 | (x05 ^ ~x15)) & (x15 | (x05 ? (x04 & x12) : x07)) & (x05 | new_n72_ | ~x15);
  assign z03 = (~new_n81_ & ~x09) | new_n79_ | (x03 & ~x18);
  assign new_n79_ = new_n80_ & x09 & ~x15 & ~x17 & x18;
  ...
  assign z12 = ~x09 & ((new_n134_ & ~x07) | (~x05 & (new_n136_ | (new_n131_ & ~x07))));
  assign new_n131_ = ~x17 & x18 & ~x21 & (new_n95_ | new_n132_ | new_n103_);
  ...
  assign new_n135_ = (x04 | ~x05 | x11 | ~x15) & (~x04 | x12 | x15 | (~new_n106_ & ~x05));
  assign new_n136_ = ~x03 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  ...
  assign z17 = ~x09 & (new_n159_ | (~new_n154_ & ~x05));
  ...
  assign z27 = new_n190_ | (x03 & (~x18 | (new_n80_ & new_n196_)));
  ...
  assign z28 = (~x17 & (new_n198_ | new_n203_)) | (~x03 & ~x09 & new_n205_ & x17);
  assign new_n198_ = ~x05 & ((~new_n199_ & x15) | (~x07 & new_n201_ & ~x09));
  assign new_n199_ = ~new_n200_ & (~x18 | ((~x07 | ~x08) & (x07 | x08 | x09 | x19)));
  assign new_n200_ = ~new_n72_ & ((x08 & x18) | (~x09 & ~x18 & ~x03 & x07));
  assign new_n201_ = ~x14 & ~x15 & x18 & (x08 ? new_n202_ : new_n102_);
  assign new_n202_ = x10 & x12 & ~x21 & (x02 | x11 | ~x13);
  assign new_n203_ = ~x07 & x08 & ~new_n204_ & x18;
