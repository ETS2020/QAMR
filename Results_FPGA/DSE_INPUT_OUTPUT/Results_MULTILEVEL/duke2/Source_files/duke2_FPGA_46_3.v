...
module FAU ( 
  ...
  assign z02 = (~x17 & (x15 ? (~new_n74_ & x18) : ~new_n68_)) | (x01 & x18);
  assign new_n68_ = (~x08 | new_n71_ | ~x18) & (x09 | (~new_n73_ & (new_n69_ | ~x18)));
  ...
  assign z06 = new_n83_ | (~x09 & (new_n108_ | (~new_n93_ & ~x07)));
  ...
  assign new_n108_ = new_n66_ & new_n107_ & ~x15;
  assign z07 = ~x01 & ~x17 & ~new_n110_ & x18;
  assign new_n110_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~new_n83_ & ~x20;
  assign z09 = new_n122_ | ((new_n113_ | x01) & x18);
  assign new_n113_ = ~x17 & ((~x07 & (x05 ? new_n121_ : ~new_n114_)) | (new_n120_ & x05));
  ...
  assign z12 = ~x09 & (new_n108_ | (~new_n129_ & ~x07));
  assign new_n129_ = ~new_n106_ & (x01 | x17 | ~x18 | new_n130_ | x21);
  assign new_n130_ = ~new_n131_ & ~new_n135_ & (x05 | (~new_n95_ & ~new_n133_ & ~new_n103_));
  ...
  assign new_n135_ = x04 & x08 & ~x12 & ~new_n105_ & ~x15;
  assign z13 = (x01 & x18) | (~x09 & x17 & ~new_n80_ & ~x18);
  assign z14 = (~new_n138_ & ~x01) | (~x05 & ~x09 & ~new_n142_ & ~x18);
  assign new_n138_ = (~x08 | x17 | new_n139_ | ~x18) & (~new_n66_ | x09 | x18);
  ...
  assign new_n142_ = (~x07 | (~x15 & ~x17)) & (~x15 | ~x17) & (~new_n72_ | x14 | x15 | x17 | x21);
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x18 & (x01 | (x08 & ~x17 & (new_n145_ | new_n150_)));
  ...
  assign z17 = new_n83_ | (~new_n152_ & ~x09);
  ...
  assign z18 = x18 & (x01 | (~x05 & ~x07 & new_n158_ & ~x09));
  ...
  assign z19 = new_n83_ | (new_n107_ & ~x15 & ~x05 & ~x07 & ~x09);
  assign z20 = new_n83_ | (~x07 & ~x17 & (new_n170_ | (~new_n164_ & ~x15)));
  ...
  assign new_n166_ = ~x06 & ~x08 & ~new_n61_ & (~x04 ^ ~x12);
  ...
  assign z21 = x18 & (x01 | (~x17 & (new_n174_ | (~new_n173_ & ~x09))));
  assign new_n173_ = (x01 | ((~x05 | ~x06 | x07 | x08 | x15) & (~x08 | ~x15 | x05 | ~x07))) & (x05 | x06 | x07 | x08 | ~x15);
  assign new_n174_ = ~x05 & x06 & ~x07 & x08 & x09 & ~x15;
  assign z22 = ~x01 & ~x17 & ~new_n176_ & x18;
  assign new_n176_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x18 & (new_n178_ | x01);
  ...
  assign new_n181_ = (x01 | ~x08 | ~new_n183_ | ~x15) & (~x04 | new_n182_ | x15);
  ...
  assign new_n191_ = ~new_n193_ & (x21 | (~new_n131_ & ~new_n192_));
  ...
  assign new_n210_ = (~x01 | ~x18) & (x09 | ~x17 | new_n211_ | x18);
