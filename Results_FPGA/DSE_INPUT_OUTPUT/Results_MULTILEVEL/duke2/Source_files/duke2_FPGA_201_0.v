...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n101_ | (~x07 & (new_n100_ | (new_n88_ & ~x17))));
  ...
  assign z07 = ~x17 & (new_n104_ | new_n103_ | ~x18);
  assign new_n103_ = new_n75_ & x09 & ~x15 & x16;
  assign new_n104_ = ~x09 & (~x07 ^ x08) & (~x05 ^ ~x15);
  ...
  assign z12 = (~x09 & (new_n101_ | (~new_n120_ & ~x07))) | (~x17 & ~x18);
  assign new_n120_ = ~new_n100_ & (x17 | x21 | (new_n121_ & (new_n125_ | x04)));
  ...
  assign new_n135_ = x12 & (~x13 | (~x02 & x11)) & (x06 ^ x16);
  assign new_n136_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = (~x09 & (new_n141_ | (~new_n138_ & ~x05))) | (~x17 & ~x18);
  ...
  assign new_n142_ = ~x17 & ~x21 & ~x11 & x15;
  ...
  assign new_n146_ = (x04 | x08 | ~x21) & (~new_n83_ | ~x08 | ~x10);
  ...
  assign z23 = ~x17 & (~x18 | (new_n163_ & ~x05 & ~x07));
  assign new_n163_ = x08 & x09 & ~x15;
  assign z24 = ~x17 & ((new_n165_ & ~x07) | ~x18);
