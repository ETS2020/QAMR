...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n159_, new_n161_, new_n163_, new_n164_, new_n168_, new_n169_,
  ...
  assign z06 = ~x09 & (new_n102_ | (~x07 & (new_n100_ | (new_n88_ & ~x17))));
  ...
  assign new_n117_ = ~new_n118_ & x18 & (~new_n119_ | x05 | x06 | x07);
  assign new_n118_ = ~x15 & ((x05 & ((x07 & x08) | (~x06 & ~x07 & ~x08 & ~x09))) | (~x05 & ~x07 & x08 & x09));
  assign new_n119_ = ~x08 & ~x09 & x15;
  assign z12 = z11 | (~x09 & (new_n102_ | (~new_n121_ & ~x07)));
  assign new_n121_ = ~new_n100_ & (x17 | x21 | (new_n122_ & (new_n126_ | x04)));
  ...
  assign new_n125_ = x08 & ~x12 & ~x15 & (x05 | (~x13 & ~x14));
  ...
  assign new_n141_ = (x07 | ((x08 | ~new_n142_ | x15) & (~new_n101_ | ~x00 | ~x15))) & (~new_n101_ | ~x07 | x15);
  ...
  assign new_n153_ = x08 & x10 & ~x12 & ~x14 & ~new_n137_ & ~x21;
  assign new_n154_ = x08 & ~new_n61_ & ~x12;
  assign z21 = ~x17 & (~new_n157_ | (~new_n156_ & ~x07));
  assign new_n156_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | ~x18))) & (x09 | x15 | ~x18 | ~x05 | ~x06 | x08);
  assign new_n157_ = x18 & (x05 | ~x07 | ~x08 | x09 | ~x15 | ~x18);
  assign z22 = ~x17 & ~new_n159_ & x18;
  assign new_n159_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = ~x17 & (~x18 | (new_n161_ & ~x05 & ~x07));
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n119_ | new_n161_);
