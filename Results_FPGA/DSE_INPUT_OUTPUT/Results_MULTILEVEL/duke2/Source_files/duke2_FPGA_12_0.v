...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n103_ | (~x07 & (new_n101_ | (new_n89_ & ~x17))));
  ...
  assign new_n100_ = ~x12 & ~x15 & ~x21 & (x05 | (~x13 & ~x14));
  ...
  assign z12 = z11 | (~x09 & (new_n103_ | (~new_n123_ & ~x07)));
  assign new_n123_ = ~new_n101_ & (x17 | x21 | (new_n124_ & (new_n128_ | x04)));
  assign new_n124_ = (~new_n127_ | ~x04) & (x05 | (~new_n91_ & ~new_n125_ & ~new_n99_));
  ...
  assign z16 = ~x17 & (~x18 | (x08 & (x05 ? new_n141_ : ~new_n136_)));
  assign new_n136_ = (x07 | x15 | (x09 ? x19 : ~new_n137_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n137_ = ~x14 & ~x21 & (new_n138_ | (~new_n140_ & x12));
  assign new_n138_ = (~x10 | (x04 & ~x12)) & (~new_n139_ | (x02 & x06));
  assign new_n139_ = x13 & (x02 | ~x11);
  assign new_n140_ = (~x06 | x10 | ~x11) & (new_n139_ | (x06 ^ ~x16));
  assign new_n141_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~new_n143_ & ~x09;
  assign new_n143_ = (new_n144_ | x05) & (~new_n147_ | x07 | ~x08 | x04 | ~x05);
  assign new_n144_ = (x07 | ((x08 | ~new_n145_ | x15) & (~new_n102_ | ~x00 | ~x15))) & (~new_n102_ | ~x07 | x15);
  ...
  assign new_n150_ = (new_n152_ | ~x02) & (~x12 | (~new_n153_ & (new_n151_ | x06)));
  assign new_n151_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  assign new_n152_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  ...
  assign new_n165_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
