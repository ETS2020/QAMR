...
module FAU ( 
  ...
  assign z01 = (~x05 & (new_n56_ | new_n63_)) | new_n61_ | new_n64_;
  ...
  assign z02 = (~x09 & (new_n66_ | (~x17 & ~new_n70_ & x18))) | new_n73_ | (x17 & ~x18);
  assign new_n66_ = ~x15 & (new_n69_ | (new_n67_ & ~x17));
  ...
  assign new_n73_ = x08 & ~x17 & ~new_n74_ & x18;
  ...
  assign z05 = new_n64_ | (~x05 & ~x07 & ~x09 & new_n80_ & ~x14);
  ...
  assign z09 = (~x17 & x18 & (new_n113_ | (~new_n103_ & ~x07))) | (~x18 & (new_n111_ | x17));
  ...
  assign new_n112_ = x12 & ~x14 & ~x15 & ~x21;
  ...
  assign z20 = new_n64_ | (~x07 & (new_n160_ | (~new_n153_ & ~x15)));
  ...
  assign new_n162_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign z28 = (~x17 & x18 & (new_n191_ | (~new_n183_ & ~x05))) | (~x18 & (x17 | (new_n193_ & ~x05)));
  ...
  assign new_n193_ = x07 & ~x09 & x15 & (~x02 | ~x11);
  assign z13 = 1'b0;
  assign z15 = 1'b0;
  assign z19 = 1'b0;
endmodule
