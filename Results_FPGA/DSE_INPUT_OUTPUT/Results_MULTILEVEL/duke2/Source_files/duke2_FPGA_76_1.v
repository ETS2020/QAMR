...
module FAU ( 
  ...
  assign new_n77_ = ~x05 & x07 & ~x18 & ~x21 & (x08 | x16);
  ...
  assign z06 = ~x09 & ((~new_n92_ & ~x07) | (new_n106_ & ~x05 & x07 & ~x15));
  ...
  assign new_n120_ = ~x18 & ~x21 & (x17 | (new_n121_ & x12 & ~x14));
  assign new_n121_ = x04 & ~x05;
  assign z10 = z13 | (~x17 & ~new_n123_ & x18);
  assign new_n123_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x06 | x07 | x08 | x09))) & (~x08 | ~x09 | x05 | x07))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign z13 = ~x18 & (x21 | (~x09 & x17 & (~x05 | ~x07)));
  assign z11 = ~x21 & new_n126_ & ~x18;
  assign new_n126_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ~new_n128_ & ~x21;
  assign new_n128_ = ~new_n137_ & (x07 | (~new_n135_ & (x17 | new_n129_ | ~x18)));
  assign new_n129_ = ~new_n130_ & ~new_n134_ & (x05 | (~new_n94_ & ~new_n132_ & ~new_n102_));
  ...
  assign new_n134_ = x04 & x08 & ~x12 & ~new_n104_ & ~x15;
  assign new_n135_ = x00 & ~x05 & new_n136_ & x15;
  assign new_n136_ = x17 & ~x18;
  assign new_n137_ = ~x05 & x07 & new_n136_ & ~x15;
  assign z14 = (~new_n139_ & ~x17) | (~x05 & new_n145_ & ~x09);
  assign new_n139_ = ~new_n143_ & (~x08 | new_n140_ | ~x18);
  assign new_n140_ = x07 ? ~new_n142_ : (new_n141_ | (~x09 & x21));
  assign new_n141_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n142_ = ~x19 & (x05 ^ x15);
  assign new_n143_ = new_n144_ & new_n121_ & ~x07 & ~x09;
  assign new_n144_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n145_ = ~x18 & ~x21 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n147_ & ~x21;
  assign new_n147_ = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = (~x18 & x21) | (x08 & ~x17 & ~new_n149_ & x18);
  ...
  assign z17 = new_n68_ | (~x09 & (new_n158_ | (~new_n155_ & ~x05)));
  assign new_n155_ = (x07 | ((x08 | ~new_n156_ | x15) & (~new_n136_ | ~x00 | ~x15))) & (~new_n136_ | ~x07 | x15);
  assign new_n156_ = ~x17 & ~new_n157_ & (x21 ? ~x14 : x18);
  assign new_n157_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n158_ = new_n66_ & new_n67_ & ~x17 & ~x11 & x15;
  assign z18 = new_n68_ | (~x05 & ~x07 & ~x09 & ~new_n160_ & ~x17);
  assign new_n160_ = (x14 | new_n161_ | x15) & (~x18 | ~x19 | x08 | ~x15);
  assign new_n161_ = (new_n162_ | ~x02) & (~x12 | (~new_n166_ & (new_n164_ | x06)));
  assign new_n162_ = (~x06 | x08 | x11 | ~x21) & (~new_n163_ | x06 | ~x08 | x10);
  assign new_n163_ = x13 & x18 & ~x21;
  assign new_n164_ = (x04 | x08 | ~x21) & (x16 | ~x18 | x21 | ~new_n165_ | ~x08);
  assign new_n165_ = x10 & ~x13;
  assign new_n166_ = x06 & x08 & x10 & new_n67_ & ~x13 & x16;
  assign z19 = ~x18 & (x21 | (new_n56_ & ~x09 & ~x15 & x17));
  assign z20 = new_n68_ | (~x07 & ~new_n169_ & ~x17);
  assign new_n169_ = (new_n170_ | x15) & (~new_n176_ | ~new_n67_ | x11 | ~x15);
  assign new_n170_ = ~new_n175_ & (~x18 | (~new_n174_ & (new_n171_ | x09)));
  ...
  assign new_n175_ = x12 & ~x14 & ~x18 & x04 & ~x05 & ~x09;
  assign new_n176_ = ~x04 & x05 & x08 & ~x09;
  assign z21 = (~x18 & x21) | (~x17 & ~new_n178_ & x18);
  ...
  assign new_n180_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n56_ & x08;
  assign z24 = new_n68_ | (~x09 & ~x17 & (new_n187_ | (~new_n183_ & ~x07)));
  assign new_n183_ = (x15 | (~new_n184_ & (x05 | x08 | ~x18))) & (~x08 | ~x15 | ~new_n186_ | ~x18);
  assign new_n184_ = ~new_n185_ & x04;
  assign new_n185_ = (x05 | ~x12 | x14 | x18) & (~x05 | ~x08 | x12 | ~x18 | x21);
  assign new_n186_ = ~x21 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n187_ = x08 & ~x15 & ~x18 & x01 & ~x05 & x07;
  assign z25 = (~x18 & x21) | (~x05 & ~x07 & ~x17 & ~new_n189_ & x18);
  ...
  assign new_n193_ = ~x21 & (new_n130_ | new_n194_);
  ...
  assign z28 = (~new_n200_ & ~x17) | (~x18 & (x21 | (~x09 & ~new_n207_ & x17)));
  assign new_n200_ = (~new_n205_ | x05) & (x07 | (~new_n201_ & (~new_n206_ | x09)));
  assign new_n201_ = ~x15 & ((~x05 & new_n204_ & ~x08) | (x08 & new_n202_ & x12));
  assign new_n202_ = x18 & ((~x05 & new_n203_ & ~x09) | (~x04 & x05 & (x09 | ~x21)));
  assign new_n203_ = x10 & ~x14 & ~x21 & (x02 | x11 | ~x13);
  assign new_n204_ = ~x09 & new_n101_ & ~x14;
  assign new_n205_ = x15 & ((x07 & x08 & x18) | (~new_n73_ & ((x08 & x18) | (x07 & ~x09 & ~x18))));
  assign new_n206_ = x15 & ((x08 & x21) | (~x05 & ~x08 & x18 & ~x19));
