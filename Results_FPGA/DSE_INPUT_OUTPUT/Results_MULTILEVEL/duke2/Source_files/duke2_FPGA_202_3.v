...
module FAU ( 
  ...
  assign z06 = (~x09 & (new_n107_ | (~new_n92_ & ~x07))) | (x18 & x20);
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n121_ | (x18 & (new_n112_ | x20));
  assign new_n112_ = ~x17 & ((new_n120_ & x05) | (~x07 & (x05 ? new_n119_ : ~new_n113_)));
  ...
  assign z12 = (~x09 & (new_n107_ | (~new_n128_ & ~x07))) | (x18 & x20);
  ...
  assign z17 = (~x09 & (new_n155_ | (~new_n152_ & ~x05))) | (x18 & x20);
  ...
  assign z21 = x18 & (x20 | (~new_n173_ & ~x17));
  assign new_n173_ = (new_n174_ | x07) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign new_n174_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x20);
