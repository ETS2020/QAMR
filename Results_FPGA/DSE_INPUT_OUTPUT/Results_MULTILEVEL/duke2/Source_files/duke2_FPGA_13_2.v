...
module FAU ( 
  ...
  assign z03 = (~new_n79_ & ~x09) | (x18 & (new_n82_ | ~x20));
  assign new_n79_ = x17 ? (new_n81_ | (x18 & x20)) : (new_n80_ | ~x18);
  ...
  assign z06 = new_n67_ | (~x09 & ((~new_n93_ & ~x07) | (new_n108_ & ~x05 & x07)));
  ...
  assign z13 = (x18 & ~x20) | (~x09 & x17 & ~new_n81_ & ~x18);
  assign z14 = new_n138_ | (new_n145_ & ~x05);
  assign new_n138_ = ~x17 & (new_n142_ | (x08 & new_n139_ & x18));
  assign new_n139_ = x20 & (x07 ? new_n141_ : (~new_n140_ & (x09 | ~x21)));
  ...
  assign z15 = new_n67_ | (new_n108_ & new_n143_ & x05);
  ...
  assign new_n154_ = (x07 | ((~new_n107_ | ~x00 | ~x15) & (x08 | ~new_n155_ | x15))) & (~new_n107_ | ~x07 | x15);
  ...
  assign z19 = new_n67_ | (new_n108_ & new_n143_ & ~x05);
  ...
  assign z28 = (~x17 & (new_n207_ | (new_n197_ & x18))) | (~x09 & x17 & ~new_n209_ & ~x18);
  assign new_n197_ = x20 & (new_n205_ | (~x05 & (~new_n198_ | (~new_n203_ & ~x02))));
