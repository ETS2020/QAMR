...
module FAU ( 
  ...
  assign z06 = new_n80_ | (~x09 & ((~new_n91_ & ~x07) | (new_n105_ & ~x05 & x07)));
  assign new_n91_ = (~x18 | (~new_n102_ & (new_n92_ | x05))) & (~new_n104_ | ~x00 | x05);
  ...
  assign z07 = x18 & (new_n107_ | new_n108_ | x17);
  ...
  assign new_n128_ = (x17 | ~x18 | new_n129_ | x21) & (~new_n135_ | ~x15 | ~x17 | x18);
  ...
  assign z22 = x18 & (new_n174_ | x17 | (new_n126_ & x08 & x15));
  assign new_n174_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  assign z24 = new_n80_ | (~x09 & (new_n176_ | new_n180_));
  ...
  assign new_n180_ = new_n126_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  ...
  assign new_n186_ = ~x21 & (new_n130_ | new_n187_);
