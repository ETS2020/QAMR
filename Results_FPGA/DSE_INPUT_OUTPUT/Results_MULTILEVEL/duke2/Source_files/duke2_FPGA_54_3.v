...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n104_ | (~new_n92_ & ~x07));
  assign new_n92_ = ~new_n103_ & (x17 | ~x18 | (~new_n101_ & (new_n93_ | x15)));
  assign new_n93_ = ~new_n99_ & (x21 | (~new_n94_ & ~new_n98_ & (new_n96_ | ~x08)));
  ...
  assign new_n97_ = (x06 | ((x13 | x16 | ~x10 | ~x12) & (~x02 | x10 | ~x13))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  assign new_n98_ = new_n55_ & ~x06 & ~x08 & ~x12;
  ...
  assign new_n118_ = ~x17 & (~new_n56_ | x14 | ~x04 | x05 | ~x12);
  assign z10 = (x18 & (new_n121_ | new_n122_ | x17)) | (~x09 & ~new_n120_ & x17);
  assign new_n120_ = x05 & x07;
  assign new_n121_ = ~x15 & ((x05 & ((x07 & x08) | (~x06 & ~x07 & ~x08 & ~x09))) | (x08 & x09 & ~x05 & ~x07));
  assign new_n122_ = ~x05 & ~x06 & ~x07 & ~x08 & ~x09 & x15;
  ...
  assign z13 = x17 & (x18 | (~new_n120_ & ~x09));
  ...
  assign z18 = x18 & (x17 | (~x05 & new_n157_ & ~x07));
  assign new_n157_ = ~x09 & ((~x14 & ~new_n158_ & ~x15) | (~x08 & x15 & x19));
  assign new_n158_ = (new_n160_ | ~x02) & (~x12 | (~new_n161_ & (new_n159_ | x06)));
  assign new_n159_ = (x04 | x08 | ~x21) & (~new_n87_ | ~x08 | ~x10);
  assign new_n160_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n161_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & new_n163_ & ~x09;
  assign new_n163_ = ~x05 & ~x07;
  assign z20 = (~new_n165_ & ~x07) | (x17 & x18);
  assign new_n165_ = ~new_n166_ & (~new_n155_ | x04 | ~x05 | ~x08 | x09);
  ...
  assign new_n176_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
  ...
  assign new_n192_ = new_n163_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n193_ = ~x05 & x17 & ((x00 & ~x07 & x15) | (x07 & ~x15));
