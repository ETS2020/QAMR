...
module FAU ( 
  ...
  assign z09 = (~x17 & ~new_n105_ & x18) | (~x18 & (new_n114_ | x17));
  ...
  assign new_n161_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign new_n177_ = new_n163_ & x03 & ~x15 & x19 & x08 & x09;
