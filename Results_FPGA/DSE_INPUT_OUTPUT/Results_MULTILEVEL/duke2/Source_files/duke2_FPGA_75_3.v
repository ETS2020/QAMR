...
module FAU ( 
  ...
  assign new_n119_ = ~x17 & (~new_n120_ | x14 | x18 | x21);
  assign new_n120_ = x04 & ~x05 & x12;
  ...
  assign z11 = (x17 & x18) | (new_n105_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  ...
  assign new_n167_ = ~x06 & ~x08 & ~new_n89_ & (~x14 | ~x21);
  ...
  assign new_n183_ = new_n105_ & x01 & x08 & ~x15 & ~x18;
