...
module FAU ( 
  ...
  assign new_n79_ = ~x14 & ~x15 & (new_n80_ | (~new_n85_ & ~x06) | (~new_n82_ & x06));
  ...
  assign z06 = new_n77_ | (~x09 & ((~new_n88_ & ~x07) | (new_n102_ & ~x05 & x07)));
  assign new_n88_ = (x17 | (~new_n99_ & (new_n89_ | x05))) & (~new_n101_ | ~x00 | x05);
  ...
  assign z09 = (~new_n108_ & ~x17) | (new_n102_ & ~x07 & ~x09);
  ...
  assign new_n118_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x06 | x07 | x08 | x09))) & (x05 | x07 | ~x08 | ~x09))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z12 = ~x09 & ((~new_n121_ & ~x07) | (~x05 & x07 & new_n129_ & ~x15));
  assign new_n121_ = (x17 | ~x18 | new_n122_ | x21) & (~new_n128_ | ~x15 | ~x17 | x18);
  assign new_n122_ = ~new_n123_ & ~new_n127_ & (x05 | (~new_n90_ & ~new_n125_ & ~new_n98_));
  ...
  assign new_n127_ = x04 & x08 & ~x12 & ~new_n100_ & ~x15;
  assign new_n128_ = x00 & ~x05;
  assign new_n129_ = x17 & ~x18;
  assign z14 = new_n133_ | (x08 & ~x17 & ~new_n131_ & x18);
  assign new_n131_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n61_ | new_n132_);
  assign new_n132_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n133_ = ~x05 & ~x09 & x17 & ~x18 & (x07 | x15);
  assign z15 = ~x18 & (~x17 | (x05 & ~x07 & ~x09 & ~x15));
  assign z16 = ~x17 & (~x18 | (x08 & (x05 ? new_n140_ : ~new_n136_)));
  assign new_n136_ = (x07 | x15 | (x09 ? x19 : ~new_n137_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n137_ = ~x14 & ~new_n138_ & ~x21;
  assign new_n138_ = ~new_n139_ & (new_n59_ | ((~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11)));
  assign new_n139_ = x12 & (~x13 | (~x02 & x11)) & (x06 ^ x16);
  assign new_n140_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = new_n77_ | (~x09 & (new_n145_ | (~new_n142_ & ~x05)));
  assign new_n142_ = x07 ? (x15 | x18) : ((x08 | ~new_n143_ | x15) & (~x00 | ~x15 | x18));
  assign new_n143_ = ~x17 & ~new_n144_ & (~x21 | (~x14 & x21));
  assign new_n144_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n145_ = new_n146_ & ~x04 & x05 & ~x07 & x08;
  assign new_n146_ = ~x17 & ~x21 & ~x11 & x15;
  assign z18 = ~x17 & (~x18 | (~x05 & ~x07 & ~new_n148_ & ~x09));
  assign new_n148_ = (x14 | x15 | (~new_n80_ & ~new_n149_)) & (x08 | ~x15 | ~x19);
  assign new_n149_ = x12 & ((~new_n150_ & ~x06) | (new_n84_ & x06 & x08 & x10));
  assign new_n150_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & new_n152_ & ~x09 & ~x15;
  ...
  assign new_n160_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  ...
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n152_ & x08;
  assign z24 = ~x17 & ((new_n167_ & ~x07) | ~x18);
  assign new_n167_ = ~x09 & ((~x05 & ~x08 & ~x15) | (x08 & ~new_n168_ & ~x21));
  ...
  assign z27 = (~x09 & (new_n177_ | (~new_n173_ & ~x17))) | (~x17 & (new_n176_ | ~x18));
  ...
  assign new_n176_ = new_n152_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n177_ = ~x05 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
