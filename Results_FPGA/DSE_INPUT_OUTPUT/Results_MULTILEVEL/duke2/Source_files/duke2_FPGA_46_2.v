...
module FAU ( 
  ...
  assign new_n58_ = (x07 | new_n59_ | ~x18) & (~new_n66_ | x01 | ~x02 | ~x07);
  ...
  assign z02 = (x01 & ~x18) | (~x17 & x18 & (new_n70_ | (~new_n77_ & x08)));
  ...
  assign new_n75_ = (x06 | x08 | x15) & (~new_n76_ | ~x05 | ~x08);
  ...
  assign new_n80_ = (x17 | new_n81_ | ~x18) & (x01 | ~x17 | x18 | (x05 & x07));
  ...
  assign z12 = ~x09 & (new_n127_ | (~x07 & x08 & new_n134_ & ~x17));
  assign new_n127_ = ~x05 & (new_n133_ | (~x07 & ~x17 & new_n128_ & x18));
  assign new_n128_ = ~x21 & (new_n129_ | new_n132_ | (x04 & ~new_n131_ & ~x12));
  assign new_n129_ = ~x15 & ((~new_n130_ & ~x08) | (~x13 & ~x14 & x08 & ~x10));
  assign new_n130_ = (~x06 | (x02 ^ ~x11)) & (x04 | x06 | ~x12);
  assign new_n131_ = (x06 | x08 | x15) & (x02 | ~x08 | ~x11 | x14);
  assign new_n132_ = ~x02 & x08 & x11 & (x15 | (~x10 & ~x14));
  assign new_n133_ = ~x01 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n134_ = x18 & ~x21 & ((new_n136_ & x04) | (new_n135_ & ~x04 & x05));
  assign new_n135_ = ~x11 & x15;
  assign new_n136_ = ~x12 & ~x15 & (x05 | (~x13 & ~x14));
  assign z14 = (new_n143_ & ~x01) | (~x17 & (new_n141_ | (new_n138_ & x08)));
  assign new_n138_ = x18 & (x07 ? new_n140_ : (~new_n65_ & ~new_n139_));
  ...
  assign new_n142_ = ~x05 & ~x09 & ~x01 & x04;
  assign new_n143_ = ~x05 & ~x09 & ~x18 & (x07 | (x15 & x17));
  assign z15 = new_n145_ & ~x18;
  assign new_n145_ = x17 & ~x15 & ~x09 & ~x07 & ~x01 & x05;
  assign z16 = (x01 & ~x18) | (x08 & ~x17 & x18 & (new_n147_ | new_n151_));
  assign new_n147_ = ~x05 & ((~x07 & ~new_n148_ & ~x15) | (x09 & x15 & (~x02 | x07)));
  assign new_n148_ = x09 ? x19 : (x14 | new_n149_ | x21);
  assign new_n149_ = ~new_n150_ & (new_n63_ | ((~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11)));
  ...
  assign new_n156_ = new_n157_ & new_n67_ & ~x04 & x05;
  assign new_n157_ = new_n135_ & ~x17 & x18 & ~x21;
  assign z18 = new_n84_ | (~x05 & ~x07 & ~x09 & new_n159_ & ~x17);
  assign new_n159_ = x18 & ((~x14 & ~new_n160_ & ~x15) | (~x08 & x15 & x19));
  assign new_n160_ = ~new_n87_ & (~x12 | (~new_n162_ & (new_n161_ | x06)));
  assign new_n161_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n162_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~new_n164_ & ~x18;
  assign new_n164_ = ~x01 & (x05 | x07 | x09 | x15 | ~x17);
  assign z20 = new_n84_ | (~x07 & ~new_n166_ & ~x17);
  assign new_n166_ = (new_n167_ | x15) & (~new_n173_ | ~x18 | x21 | x11 | ~x15);
  assign new_n167_ = ~new_n172_ & (~x18 | (~new_n171_ & (new_n168_ | x09)));
  ...
  assign new_n171_ = x04 & x05 & x08 & ~new_n65_ & ~x12;
  ...
  assign z24 = ~x07 & new_n180_ & ~x09;
  assign new_n180_ = ~x17 & (new_n181_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n181_ = ~x21 & ((x04 & ~new_n182_ & ~x15) | (x08 & new_n183_ & x15));
  assign new_n182_ = (~x05 | ~x08 | x12 | ~x18) & (x01 | x05 | ~x12 | x14 | x18);
  assign new_n183_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign z25 = (x01 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n185_ & x18);
  assign new_n185_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = new_n84_ | (~x20 & (x14 | x21));
  assign z27 = (~new_n188_ & ~x09) | (new_n191_ & new_n67_ & x03 & ~x05);
  assign new_n188_ = x05 ? (x17 | new_n190_ | ~x18) : (~new_n133_ & (x17 | new_n189_ | ~x18));
  assign new_n189_ = (x07 | x08 | x15 | new_n155_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n190_ = (x07 | ((~new_n76_ | x04 | ~x08) & (x08 | x15 | ~x19))) & (x15 | ~x19 | ~x07 | ~x08);
  assign new_n191_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n204_ & ~x18) | (~x17 & ((~new_n193_ & x18) | (new_n206_ & ~x05)));
  assign new_n193_ = ~new_n202_ & (x05 | (new_n194_ & (new_n200_ | x02)));
