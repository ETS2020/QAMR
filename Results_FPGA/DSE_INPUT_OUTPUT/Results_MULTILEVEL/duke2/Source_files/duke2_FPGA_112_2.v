...
module FAU ( 
  ...
  assign z06 = new_n68_ | (~x09 & ((~new_n93_ & ~x07) | (new_n105_ & ~x05 & x07)));
  ...
  assign z07 = (x01 & ~x18) | (~x17 & ~new_n108_ & x18);
  ...
  assign new_n120_ = ~x01 & (x07 | x09 | x15 | (~new_n121_ & ~x17));
  ...
  assign z12 = ~x09 & (new_n126_ | (~x07 & x08 & new_n134_ & ~x17));
  assign new_n126_ = ~x05 & ((~x07 & new_n127_ & ~x17) | (~x01 & new_n133_ & x17));
  assign new_n127_ = x18 & ~x21 & (~new_n128_ | (x04 & ~new_n132_ & ~x12));
  assign new_n128_ = ~new_n131_ & (x15 | ((new_n130_ | x08) & (~new_n129_ | ~x08 | x10)));
  assign new_n129_ = ~x13 & ~x14;
  assign new_n130_ = (~x06 | (~x02 ^ x11)) & (x04 | x06 | ~x12);
  assign new_n131_ = ~x02 & x08 & x11 & (x15 | (~x10 & ~x14));
  assign new_n132_ = (x06 | x08 | x15) & (~x11 | x14 | x02 | ~x08);
  assign new_n133_ = ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n134_ = x18 & ~x21 & ((new_n135_ & x04) | (new_n136_ & ~x04 & x05));
  assign new_n135_ = ~x12 & ~x15 & (new_n129_ | x05);
  ...
  assign new_n142_ = ~x01 & (x05 | x09 | (~x07 & (~x15 | ~x17)));
  ...
  assign new_n155_ = new_n67_ & new_n136_ & ~x17 & x18 & ~x21;
  ...
  assign z20 = new_n68_ | (~x07 & ~x17 & (new_n168_ | (~new_n162_ & ~x15)));
  ...
  assign new_n168_ = new_n169_ & new_n136_ & x18 & ~x21;
  assign new_n169_ = x08 & ~x09 & ~x04 & x05;
  assign z21 = (x01 & ~x18) | (~x17 & ~new_n171_ & x18);
  ...
  assign z24 = new_n68_ | (~x07 & new_n176_ & ~x09);
  assign new_n176_ = ~x17 & (new_n177_ | (~x05 & ~x08 & ~x15 & x18));
  ...
  assign z27 = ~new_n189_ | (~x09 & ((new_n184_ & ~x17) | (~x05 & new_n133_ & x17)));
  ...
  assign new_n187_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n188_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n189_ = ~new_n68_ & (~new_n190_ | ~x03 | x05 | x07 | ~x08);
  assign new_n190_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n192_ & ~x17) | (~x01 & ~x09 & new_n200_ & x17);
  assign new_n192_ = (new_n193_ | x05) & (x07 | ~x08 | new_n199_ | ~x18);
  assign new_n193_ = (new_n194_ | ~x15) & (x07 | x09 | x14 | ~new_n197_ | x15);
  assign new_n194_ = ~new_n196_ & (new_n195_ | (x02 & x11));
  assign new_n195_ = (~x08 | ~x18) & (x09 | x18 | x01 | ~x07);
  assign new_n196_ = x18 & ((x07 & x08) | (~x07 & ~x08 & ~x09 & ~x19));
  assign new_n197_ = x18 & (x08 ? new_n198_ : new_n102_);
