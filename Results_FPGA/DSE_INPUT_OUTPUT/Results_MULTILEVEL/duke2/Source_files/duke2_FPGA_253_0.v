...
module FAU ( 
  ...
  assign new_n77_ = (x02 | x07 | new_n64_ | ~x11) & ~x07 & x11;
  ...
  assign z06 = (~x18 & ~x20) | (~x09 & (new_n106_ | (~new_n94_ & ~x07)));
  ...
  assign z10 = (~x17 & ~new_n123_ & x18) | (~x18 & ((~x09 & ~new_n81_ & x17) | ~x20));
  ...
  assign new_n127_ = (~new_n138_ | ~x17 | x18 | ~x20) & (x17 | ~new_n128_ | ~x18);
  ...
  assign new_n184_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | ~x20);
