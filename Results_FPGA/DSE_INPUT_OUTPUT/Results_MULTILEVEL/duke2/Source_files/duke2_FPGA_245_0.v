...
module FAU ( 
  ...
  assign z06 = (~x17 & ~x18) | (~x09 & (new_n88_ | (new_n103_ & ~x15 & ~x18)));
  assign new_n88_ = ~x07 & (new_n101_ | (~x17 & (new_n99_ | (~new_n89_ & ~x05))));
  ...
  assign new_n101_ = new_n102_ & x15 & ~x18;
  assign new_n102_ = x00 & ~x05;
  assign new_n103_ = ~x05 & x07;
  assign z07 = ~x17 & (~new_n105_ | (~x09 & ~new_n107_ & (~x07 ^ x08)));
  assign new_n105_ = x18 & (~new_n106_ | x05 | ~x09 | x15 | ~x16);
  assign new_n106_ = ~x07 & x08;
  assign new_n107_ = x05 ^ ~x15;
  assign z08 = (~x17 & ~x18) | (x14 & ~x20);
  assign z09 = (~new_n110_ & ~x17) | (~x07 & ~x09 & ~x15 & ~x18);
  ...
  assign new_n122_ = (x17 | ~x18 | new_n123_ | x21) & (~new_n102_ | ~x15 | ~x17 | x18);
  assign new_n123_ = ~new_n124_ & ~new_n128_ & (x05 | (~new_n90_ & ~new_n126_ & ~new_n98_));
  ...
  assign new_n139_ = (new_n59_ | (new_n140_ & (~x02 | ~x06))) & (~x12 | new_n140_ | (~x06 ^ x16));
  assign new_n140_ = x13 & (x02 | ~x11);
  assign new_n141_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & ((~new_n143_ & ~x05) | (new_n146_ & new_n106_ & ~x04 & x05));
  assign new_n143_ = (x07 | ((x08 | ~new_n144_ | x15) & (~new_n129_ | ~x00 | ~x15))) & (~new_n129_ | ~x07 | x15);
  ...
  assign new_n149_ = (new_n150_ | ~x12) & (~x02 | (~new_n81_ & ~new_n152_));
  assign new_n150_ = (x06 | (~new_n151_ & (~new_n86_ | ~x08 | ~x10))) & (~new_n84_ | ~x06 | ~x08 | ~x10);
  assign new_n151_ = x18 & x21 & ~x04 & ~x08;
  assign new_n152_ = x06 & ~x08 & ~x11 & x18 & x21;
  assign z19 = ~x18 & x17 & new_n75_ & ~x09 & ~x15;
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n62_ | (~new_n155_ & ~x15))));
  assign new_n155_ = (x09 | ((~new_n156_ | ~x04) & (~new_n158_ | x05))) & (~x04 | ~new_n157_ | ~x05);
  assign new_n156_ = x08 & x10 & ~x12 & ~x14 & ~new_n140_ & ~x21;
  assign new_n157_ = x08 & ~new_n61_ & ~x12;
  ...
  assign new_n162_ = (new_n163_ | x07) & x18 & (~x08 | ~x15 | x05 | ~x07);
  assign new_n163_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  ...
  assign new_n173_ = ~x21 & (new_n124_ | new_n174_);
