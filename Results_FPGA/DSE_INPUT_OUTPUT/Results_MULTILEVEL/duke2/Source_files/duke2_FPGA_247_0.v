...
module FAU ( 
  ...
  assign new_n106_ = x18 & (~new_n75_ | x05 | ~x09 | x15 | ~x16);
  ...
  assign z12 = z11 | (~x09 & (new_n104_ | (~new_n123_ & ~x07)));
  assign new_n123_ = ~new_n102_ & (x17 | x21 | (new_n124_ & (new_n128_ | x04)));
  ...
  assign new_n130_ = x07 ? (new_n107_ | x19) : (new_n61_ | new_n131_);
  ...
  assign z17 = ~x09 & ((~new_n141_ & ~x05) | (new_n144_ & new_n75_ & ~x04 & x05));
  ...
  assign new_n160_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)))));
  ...
  assign z27 = new_n170_ | (new_n175_ & new_n75_ & x03 & ~x05);
