...
module FAU ( 
  ...
  assign new_n122_ = ~new_n123_ & ~x17 & (~new_n124_ | x05 | x06 | x07);
  ...
  assign z12 = (x17 & x18) | (~x09 & (new_n105_ | (~new_n128_ & ~x07)));
  ...
  assign new_n150_ = (new_n151_ | x05) & (~new_n154_ | ~new_n65_ | x04 | ~x05);
  ...
  assign new_n167_ = new_n154_ & x08 & ~x09 & ~x04 & x05;
  assign z21 = x18 & ((~new_n169_ & ~x07) | x17 | (new_n170_ & ~x05 & x07));
  assign new_n169_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n170_ = x08 & ~x09 & x15;
  assign z22 = ~new_n172_ & x18;
  assign new_n172_ = (new_n173_ | x07) & ~x17 & (~x08 | ~x15 | x05 | ~x07);
  assign new_n173_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)));
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n79_ | new_n124_);
