...
module FAU ( 
  ...
  assign z01 = ~x17 & (new_n58_ | new_n66_);
  assign new_n58_ = ~x05 & ((new_n59_ & ~x07) | (new_n65_ & x02 & x07 & ~x09));
  ...
  assign new_n65_ = x10 & x11 & x15 & ~x18;
  assign new_n66_ = new_n67_ & ~x09 & ~x11 & x15 & x18 & ~x21;
  assign new_n67_ = ~x04 & x05 & ~x07 & x08;
  assign z02 = (~x17 & ((~new_n69_ & ~x05) | (~new_n74_ & x18))) | (~x10 & ~x18);
  ...
  assign new_n90_ = (x08 | new_n91_ | ~x21) & (x13 | x16 | x21 | ~new_n88_ | ~x08);
  assign new_n91_ = ~x04 ^ x12;
  assign z06 = new_n79_ | (~x09 & ((~new_n93_ & ~x07) | (new_n104_ & ~x05 & x07)));
  assign new_n93_ = (x17 | (~new_n101_ & (new_n94_ | x05))) & (~new_n103_ | ~x00 | x05);
  assign new_n94_ = (~new_n98_ | ~x08) & (~x18 | (~new_n95_ & (x02 | ~new_n100_ | ~x08)));
  assign new_n95_ = ~x15 & (x08 ? (~x14 & ~new_n97_ & ~x21) : (~new_n96_ & (~x21 | (~x14 & x21))));
  assign new_n96_ = (x02 | ~x06 | ~x11) & (~x04 | x06 | x12);
  assign new_n97_ = (x06 | ((~x02 | x10 | ~x13) & (x13 | x16 | ~x10 | ~x12))) & (~x06 | ~x10 | ~x12 | x13 | ~x16);
  assign new_n98_ = new_n99_ & ~x10;
  assign new_n99_ = ~x14 & ~x21 & ((~x02 & x11) | (~x13 & ~x15));
  assign new_n100_ = x11 & ~x21 & (x15 | (x04 & ~x12 & ~x14));
  assign new_n101_ = x04 & x08 & new_n102_ & ~x12;
  assign new_n102_ = ~x15 & x18 & ~x21 & (x05 | (~x13 & ~x14));
  assign new_n103_ = x15 & x17 & ~x18;
  assign new_n104_ = ~x15 & x17 & ~x18;
  assign z07 = (~x10 & ~x18) | (~x17 & ~new_n106_ & x18);
  assign new_n106_ = (x09 | (~x07 ^ ~x08) | (x05 ^ ~x15)) & (~x09 | x15 | ~x16 | x05 | x07 | ~x08);
  assign z08 = x14 & ~new_n79_ & ~x20;
  assign z09 = ((new_n109_ | new_n117_) & ~x07) | (x05 & new_n119_ & x08);
  assign new_n109_ = ~x09 & (new_n115_ | (~x17 & ~new_n110_ & x18));
  assign new_n110_ = (x15 | (x05 ? (x08 | x19) : (new_n111_ | x21))) & (~x05 | ~x08 | ~x21);
  ...
  assign new_n115_ = x10 & ~x15 & ~x18 & (new_n116_ | x17);
  assign new_n116_ = x04 & ~x05 & x12 & ~x14 & ~x21;
  assign new_n117_ = x02 & ~x05 & new_n118_ & x08;
  assign new_n118_ = ~x11 & x15 & ~x17 & ~new_n64_ & x18;
  assign new_n119_ = ~x15 & ~x17 & x18 & (~x04 | x07 | ~x12);
  assign z10 = (~x17 & ~new_n122_ & x18) | (~x18 & (~x10 | (~x09 & ~new_n121_ & x17)));
  assign new_n121_ = x05 & x07;
  assign new_n122_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = ~x18 & (~x10 | (new_n124_ & ~x09 & ~x15 & ~x17));
  assign new_n124_ = x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n126_ & ~x07) | (new_n104_ & ~x05 & x07 & x10));
  assign new_n126_ = ~new_n136_ & (x17 | ~x18 | x21 | (new_n127_ & ~new_n134_));
  assign new_n127_ = (~new_n133_ | ~x04) & (x05 | (~new_n130_ & ~new_n132_ & (~new_n128_ | ~x04)));
  assign new_n128_ = ~new_n129_ & ~x12;
  ...
  assign new_n136_ = new_n103_ & x00 & ~x05 & x10;
  assign z13 = ~x09 & x10 & x17 & ~new_n121_ & ~x18;
  assign z14 = new_n139_ | (~x05 & new_n144_ & ~x09);
  assign new_n139_ = ~x17 & (new_n142_ | (x08 & ~new_n140_ & x18));
  assign new_n140_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n64_ | new_n141_);
  assign new_n141_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n142_ = new_n143_ & x04 & ~x05 & ~x07 & ~x09 & x10;
  assign new_n143_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n144_ = x10 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n146_ & ~x18;
  assign new_n146_ = x10 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = new_n79_ | (x08 & ~x17 & (x05 ? new_n153_ : ~new_n148_));
  assign new_n148_ = (x07 | new_n149_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n149_ = x09 ? (~x18 | x19) : (x14 | new_n150_ | x21);
  assign new_n150_ = (~x12 | ~new_n152_ | ~x18) & (new_n151_ | (x10 & (~x04 | x12 | ~x18)));
  assign new_n151_ = (~x02 | ~x06) & x13 & (x02 | ~x11);
  assign new_n152_ = (x06 ^ x16) & (~x13 | (~x02 & x11));
  assign new_n153_ = x09 & ~x15 & x18 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n159_ | (~new_n155_ & ~x05));
  assign new_n155_ = (x07 | (~new_n156_ & (~new_n103_ | ~x00 | ~x10))) & (~new_n104_ | ~x07 | ~x10);
  assign new_n156_ = ~x08 & ~x15 & ~x17 & new_n157_ & x18;
  assign new_n157_ = ~new_n158_ & (~x21 | (~x14 & x21));
  ...
  assign new_n161_ = (x14 | (~new_n85_ & ~new_n162_) | x15) & (x08 | ~x15 | ~x19);
  assign new_n162_ = x12 & ((~new_n163_ & ~x06) | (new_n89_ & x06 & x08 & x10));
  assign new_n163_ = (x04 | x08 | ~x21) & (x13 | x16 | x21 | ~x08 | ~x10);
  assign z19 = ~x18 & x17 & ~x15 & x10 & new_n56_ & ~x09;
  ...
  assign new_n172_ = x04 & ~x05 & ~x09 & x10;
  assign new_n173_ = new_n174_ & x08 & ~x09 & ~x04 & x05;
  assign new_n174_ = x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n192_ = ~new_n79_ & (~new_n193_ | ~x03 | x05 | x07 | ~x08);
  assign new_n193_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n194_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n207_ | (~new_n196_ & x18))) | (~x18 & (new_n208_ | ~x10));
  assign new_n196_ = ~new_n205_ & (x05 | (new_n197_ & (new_n203_ | x02)));
  ...
  assign new_n207_ = ~x05 & x07 & ~x09 & x15 & ~new_n71_ & ~x18;
