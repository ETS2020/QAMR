...
module FAU ( 
  ...
  assign z05 = ~x15 & x18;
  assign z06 = z05 | (~x05 & ~new_n72_ & ~x09);
  assign new_n72_ = x07 ? (x15 | ~x17) : (~new_n73_ & ~new_n74_);
  assign new_n73_ = x00 & x15 & x17 & ~x18;
  ...
  assign new_n89_ = ~x07 & ((new_n90_ & new_n91_) | ((new_n73_ | new_n74_) & ~x05));
  ...
  assign new_n104_ = new_n60_ & ~x11 & x15 & new_n61_ & ~x17;
  ...
  assign new_n115_ = ~x17 & x18 & ((x07 & x08) | (x06 & ~x07 & ~x08 & ~x09));
  ...
  assign z27 = ~x09 & (new_n104_ | (~new_n124_ & ~x05));
  assign new_n124_ = (new_n125_ | ~x07) & (~x00 | x07 | ~x15 | ~x17 | x18);
  assign new_n125_ = (x15 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18 | ~x19);
  assign z28 = new_n132_ | (~new_n127_ & x15);
  assign new_n127_ = ~new_n131_ & (x05 | (~new_n130_ & ((~new_n128_ & ~new_n129_) | x17)));
  assign new_n128_ = (~x02 | ~x11) & ((x08 & x18) | (x07 & ~x09 & ~x18));
  assign new_n129_ = x18 & ((x07 & x08) | (~x07 & ~x08 & ~x09 & ~x19));
  assign new_n130_ = ~x09 & x17 & ~x18 & ~x19;
  assign new_n131_ = ~x07 & ~x09 & ((x17 & ~x18) | (x18 & x21 & x08 & ~x17));
  assign new_n132_ = x05 & ~x07 & ~x09 & x17 & ~x18;
  assign z23 = z05;
endmodule
