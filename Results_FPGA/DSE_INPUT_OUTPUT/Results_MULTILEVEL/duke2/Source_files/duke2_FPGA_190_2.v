...
module FAU ( 
  ...
  assign new_n149_ = ~new_n153_ & (x17 | ~x18 | (~new_n155_ & (new_n150_ | x09)));
  ...
  assign new_n153_ = new_n154_ & x04 & ~x05 & ~x09;
  assign new_n154_ = x12 & ~x14 & ~x18 & ~x21;
  assign new_n155_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign new_n156_ = new_n63_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign new_n177_ = x08 & x09 & ~x15 & x19;
  assign z28 = ~x17 & ((x18 & (new_n186_ | (~new_n179_ & ~x05))) | (new_n188_ & ~x05));
  ...
  assign new_n188_ = x07 & ~x09 & x15 & ~new_n70_ & ~x18;
  assign z15 = 1'b0;
  assign z19 = z13;
endmodule
