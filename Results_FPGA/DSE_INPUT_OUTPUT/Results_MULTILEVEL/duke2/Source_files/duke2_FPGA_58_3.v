...
module FAU ( 
  ...
  assign z09 = (~new_n108_ & x18) | (~x07 & new_n117_ & ~x09);
  ...
  assign new_n117_ = ~x15 & (x17 | (new_n118_ & x04 & ~x05 & x12));
  assign new_n118_ = ~x14 & ~x18 & ~x21;
  ...
  assign z11 = (x17 & x18) | (new_n124_ & ~x09 & ~x15 & ~x17 & ~x18);
  assign new_n124_ = x01 & ~x05 & x07;
  assign z12 = (x17 & x18) | (~x09 & (new_n103_ | (~new_n126_ & ~x07)));
  assign new_n126_ = ~new_n102_ & (~x18 | x21 | (new_n127_ & (new_n131_ | x04)));
  assign new_n127_ = (~new_n130_ | ~x04) & (x05 | (~new_n92_ & ~new_n128_ & ~new_n100_));
  ...
  assign new_n162_ = ~x06 & ~x08 & ~new_n88_ & (~x14 | ~x21);
  assign new_n163_ = x08 & x10 & ~x12 & ~x14 & ~new_n145_ & ~x21;
  assign new_n164_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n165_ = x04 & ~x05 & ~x09;
  assign new_n166_ = new_n167_ & new_n152_ & x08 & ~x09;
  assign new_n167_ = x18 & ~x21 & ~x11 & x15;
  assign z21 = x18 & (~new_n170_ | (~new_n169_ & ~x07));
  assign new_n169_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15 | x17))) & (x09 | x15 | x17 | ~x05 | ~x06 | x08);
  assign new_n170_ = ~x17 & (x05 | ~x07 | ~x08 | x09 | ~x15 | x17);
  assign z22 = ~x17 & ~new_n172_ & x18;
  assign new_n172_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
