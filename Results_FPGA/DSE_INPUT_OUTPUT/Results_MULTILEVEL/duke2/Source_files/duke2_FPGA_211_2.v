...
module FAU ( 
  ...
  assign new_n78_ = (~x07 | (~x05 ^ x15)) & (x15 | (x05 ? (x04 & x12) : x07)) & (x05 | new_n77_ | ~x15);
  ...
  assign z14 = new_n140_ | (~x05 & new_n146_ & ~x06);
  ...
  assign new_n144_ = new_n145_ & x04 & ~x05 & ~x06 & ~x07 & ~x09;
  assign new_n145_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n146_ = ~x09 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n148_ & ~x18;
  assign new_n148_ = x17 & ~x15 & ~x09 & ~x07 & x05 & ~x06;
  assign z16 = new_n68_ | (x08 & ~x17 & (x05 ? new_n155_ : ~new_n150_));
  assign new_n150_ = (x07 | new_n151_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n151_ = x09 ? (~x18 | x19) : (~new_n152_ | x14);
  assign new_n152_ = ~x21 & ((~new_n61_ & ~new_n153_) | (new_n154_ & x12));
  assign new_n153_ = (~x06 | (~x02 & ~x11)) & (~x18 | (x13 & (x02 | ~x11)));
  assign new_n154_ = (~x13 | (~x02 & x11)) & (x06 ? ~x16 : (x16 & x18));
  assign new_n155_ = x09 & ~x15 & x18 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n157_ | (new_n66_ & new_n162_ & new_n67_ & ~x17));
  assign new_n157_ = ~x05 & ((~new_n158_ & ~x07) | (new_n107_ & ~x06 & x07));
  assign new_n158_ = ~new_n161_ & (~new_n159_ | x08);
  ...
  assign new_n165_ = ~new_n167_ & (~x18 | (~new_n86_ & (x06 | new_n166_ | ~x12)));
  assign new_n166_ = (x04 | x08 | ~x21) & (~new_n91_ | ~x08 | ~x10);
  assign new_n167_ = new_n168_ & x06 & x08 & x10;
  assign new_n168_ = x16 & ~x21 & x12 & ~x13;
  assign z19 = ~x18 & (x06 | (new_n56_ & ~x09 & ~x15 & x17));
  assign z20 = new_n68_ | (~x07 & ~x17 & (new_n178_ | (~new_n171_ & ~x15)));
  assign new_n171_ = (new_n172_ | ~x18) & (~new_n177_ | ~x12 | x14 | x18 | x21);
  assign new_n172_ = (x09 | ((~new_n175_ | x05) & (~new_n173_ | ~x04))) & (~x04 | ~new_n176_ | ~x05);
  ...
  assign new_n178_ = new_n67_ & new_n162_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign z24 = new_n68_ | (~x09 & ~x17 & (new_n185_ | new_n189_));
  ...
  assign new_n198_ = ~x06 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n199_ = new_n200_ & x03 & ~x05 & ~x07 & x08;
  assign new_n200_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n209_ | (~new_n202_ & x18))) | (~x18 & (new_n213_ | x06));
  assign new_n202_ = (~x08 | ((~new_n208_ | x05) & (new_n203_ | x07))) & (x05 | x07 | ~new_n206_ | x08);
  assign new_n203_ = (~x12 | new_n204_ | x15) & (x09 | ~x15 | ~x21);
  assign new_n204_ = (x05 | ~new_n205_ | x09) & (x04 | ~x05 | (~x09 & x21));
  assign new_n205_ = x10 & ~x14 & ~x21 & (x02 | x11 | ~x13);
  assign new_n206_ = ~x09 & ((x15 & ~x19) | (new_n207_ & ~x14 & ~x15 & x21));
  assign new_n207_ = x04 & ~x06 & ~x12;
  assign new_n208_ = x15 & (~x02 | x07 | ~x11);
  assign new_n209_ = ~x05 & ~new_n210_ & ~x09;
  assign new_n210_ = (x02 | (~new_n211_ & (~x07 | ~x15 | x18))) & (~x07 | x11 | ~x15 | x18);
