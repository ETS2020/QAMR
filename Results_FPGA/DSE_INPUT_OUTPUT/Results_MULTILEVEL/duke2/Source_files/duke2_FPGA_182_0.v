...
module FAU ( 
  ...
  assign new_n78_ = ~x14 & ~x15 & (new_n79_ | (~new_n81_ & x06) | (~new_n84_ & ~x06));
  ...
  assign z06 = (~x17 & ~x18) | (~x09 & (new_n87_ | (new_n101_ & ~x15 & ~x18)));
  assign new_n87_ = ~x07 & (new_n100_ | (~x17 & (new_n98_ | (~new_n88_ & ~x05))));
  ...
  assign new_n91_ = ((~new_n92_ & ~new_n93_) | ~x06) & (~x08 | new_n94_ | x14);
  ...
  assign new_n100_ = x00 & ~x05 & x15 & ~x18;
  ...
  assign z12 = (~x17 & ~x18) | (~x09 & (new_n120_ | (new_n101_ & ~x15 & x17 & ~x18)));
  assign new_n120_ = ~x07 & (new_n127_ | (~x17 & ~x21 & (~new_n121_ | new_n125_)));
  ...
  assign new_n124_ = x08 & ~x12 & ~new_n99_ & ~x15;
  ...
  assign new_n143_ = (x07 | ((x08 | ~new_n144_ | x15) & (~new_n128_ | ~x00 | ~x15))) & (~new_n128_ | ~x07 | x15);
  ...
  assign new_n149_ = (new_n150_ | ~x12) & (~x02 | (~new_n80_ & ~new_n152_));
  assign new_n150_ = (x06 | (~new_n151_ & (~new_n85_ | ~x08 | ~x10))) & (~new_n83_ | ~x06 | ~x08 | ~x10);
  assign new_n151_ = ~x04 & ~x08 & x18 & x21;
  ...
  assign new_n163_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)))));
  ...
  assign new_n173_ = (new_n125_ | new_n174_) & ~x21;
  assign new_n174_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n175_ = new_n154_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n176_ = ~x05 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & ~new_n178_ & x18) | (~x09 & x17 & ~new_n189_ & ~x18);
  assign new_n178_ = ~new_n187_ & (x05 | (new_n179_ & (new_n185_ | x02)));
  assign new_n179_ = (~new_n184_ | ~x08) & (x07 | x09 | (x08 ? ~new_n182_ : new_n180_));
  assign new_n180_ = (~x15 | x19) & (~new_n181_ | x14 | x15 | ~x21);
