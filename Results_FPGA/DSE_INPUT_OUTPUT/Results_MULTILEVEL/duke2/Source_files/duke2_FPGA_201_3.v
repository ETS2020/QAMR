...
module FAU ( 
  ...
  assign new_n83_ = (~new_n88_ | x04 | x06) & (x17 | (x06 ? new_n84_ : new_n86_));
  ...
  assign new_n97_ = (x06 | ((~x10 | ~x12 | x13 | x16) & (~x02 | x10 | ~x13))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  ...
  assign new_n104_ = new_n105_ & ~x15 & x17 & ~x18;
  assign new_n105_ = ~x05 & x07;
  assign z07 = x18 & (~new_n107_ | (~x09 & ~new_n108_ & (~x07 ^ x08)));
  assign new_n107_ = ~x17 & (~new_n78_ | ~x09 | x15 | ~x16);
  ...
  assign z12 = new_n80_ | (~x09 & (new_n104_ | (~x07 & (new_n128_ | new_n103_))));
  ...
  assign new_n138_ = x18 & (x07 ? (~new_n108_ & ~x19) : new_n139_);
  ...
  assign new_n171_ = new_n156_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign z22 = x18 & (new_n176_ | x17 | (new_n105_ & x08 & x15));
  ...
  assign z24 = new_n80_ | (~x09 & (new_n180_ | new_n184_));
  ...
  assign new_n184_ = new_n105_ & x01 & ~x17 & ~x18 & x08 & ~x15;
