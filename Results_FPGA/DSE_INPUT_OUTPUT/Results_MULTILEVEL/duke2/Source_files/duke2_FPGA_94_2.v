...
module FAU ( 
  ...
  assign new_n54_ = ~x17 & (~new_n55_ | ~x12 | x14 | x15 | x21);
  assign new_n55_ = x04 & ~x05 & ~x07 & ~x09;
  assign z01 = new_n57_ | (x17 & ~x18) | (new_n64_ & new_n65_ & ~x17 & x18 & ~x21);
  assign new_n57_ = ~x05 & (new_n63_ | (~x07 & ~x17 & ~new_n58_ & x18));
  assign new_n58_ = (x09 | ((~new_n61_ | ~x06) & (~new_n59_ | x02))) & (~new_n62_ | x02);
  ...
  assign z02 = (~new_n67_ & ~x09) | (x17 & ~x18) | (x08 & ~x17 & ~new_n74_ & x18);
  assign new_n67_ = (x17 | new_n68_ | ~x18) & (x15 | (~new_n73_ & (x17 | new_n71_ | ~x18)));
  ...
  assign new_n77_ = (x09 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (x05 | x07 | ~x08 | ~x09 | x15);
  ...
  assign z06 = ~x07 & ~x09 & ~x17 & (new_n90_ | new_n101_) & x18;
  ...
  assign new_n116_ = new_n55_ & x12 & ~x14 & ~x15 & ~x18 & ~x21;
  ...
  assign z12 = (x17 & ~x18) | (~x07 & ~x09 & ~x17 & x18 & ~new_n122_ & ~x21);
  ...
  assign z17 = ~x07 & ~x09 & ~x17 & (new_n141_ | new_n143_) & x18;
  ...
  assign new_n145_ = (x14 | (~new_n82_ & ~new_n146_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n155_ = new_n156_ & new_n65_ & x18 & ~x21;
  ...
  assign z24 = ~x09 & (new_n164_ | new_n168_) & ~x17;
  ...
  assign new_n174_ = (new_n123_ | new_n175_) & ~x21;
