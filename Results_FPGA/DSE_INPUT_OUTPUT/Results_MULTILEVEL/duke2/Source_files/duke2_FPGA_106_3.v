...
module FAU ( 
  ...
  assign new_n107_ = ~x17 & (~new_n80_ | ~x09 | x15 | ~x16);
  ...
  assign new_n139_ = x08 & (x07 ? (~new_n108_ & ~x19) : new_n140_);
  ...
  assign new_n167_ = ~new_n168_ & (~new_n157_ | x04 | ~x05 | ~x08 | x09);
  assign new_n168_ = ~x15 & (new_n172_ | (x18 & (new_n173_ | (~new_n169_ & ~x09))));
  ...
  assign new_n172_ = x04 & ~x05 & ~x09 & new_n56_ & x12 & ~x14;
  ...
  assign z23 = x18 & (x17 | (new_n165_ & x08 & x09 & ~x15));
  assign z24 = (x17 & x18) | (~x09 & (new_n181_ | (new_n185_ & new_n186_ & ~x17 & ~x18)));
  assign new_n181_ = ~x07 & (new_n182_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n182_ = ~x21 & ((x04 & ~new_n183_ & ~x15) | (x08 & new_n184_ & x15));
  assign new_n183_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x17 | x18);
  assign new_n184_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n185_ = x01 & ~x05 & x07;
  ...
  assign new_n192_ = ~x21 & (new_n134_ | new_n193_);
  assign new_n193_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n194_ = new_n165_ & x03 & x08 & x09 & ~x15 & x19;
