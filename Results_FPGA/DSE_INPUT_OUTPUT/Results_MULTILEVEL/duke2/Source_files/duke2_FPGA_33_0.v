...
module FAU ( 
  ...
  assign z12 = (~x09 & (new_n102_ | (~new_n120_ & ~x07))) | (~x17 & ~x18);
  ...
  assign new_n150_ = ~x06 & ~x08 & ~new_n86_ & (~x14 | ~x21);
  assign new_n151_ = x08 & x10 & ~x12 & ~x14 & ~new_n135_ & ~x21;
  assign new_n152_ = x08 & ~new_n61_ & ~x12;
  ...
  assign new_n157_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n75_ & x08;
  assign z24 = ~x17 & ((new_n160_ & ~x07) | ~x18);
  assign new_n160_ = ~x09 & ((~x05 & ~x08 & ~x15) | (x08 & ~new_n161_ & ~x21));
  ...
  assign z27 = (~x09 & (new_n170_ | (~new_n166_ & ~x17))) | (~x17 & (new_n169_ | ~x18));
  assign new_n166_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n167_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n167_ = ~x21 & (new_n168_ | (~new_n125_ & ~x04));
  assign new_n168_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n169_ = new_n75_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n170_ = ~x05 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = new_n182_ | (~x17 & (~new_n180_ | (~new_n172_ & ~x05)));
  assign new_n172_ = ~new_n173_ & (~new_n176_ | x07) & (~x08 | ~x15 | (~x07 & x11));
  assign new_n173_ = ~new_n174_ & ~x02;
  assign new_n174_ = (~x08 | ~x15) & (~new_n175_ | ~x06 | x07 | x08 | x09);
  assign new_n175_ = x11 & ~x14 & ~x15 & x21;
  assign new_n176_ = ~x09 & (x08 ? (x10 & new_n179_ & x12) : ~new_n177_);
  assign new_n177_ = (~x15 | x19) & (~new_n178_ | x14 | x15 | ~x21);
  assign new_n178_ = x04 & ~x06 & ~x12;
  assign new_n179_ = ~x14 & ~x15 & ~x21 & (x02 | x11 | ~x13);
  assign new_n180_ = x18 & (x07 | new_n181_ | ~x08);
