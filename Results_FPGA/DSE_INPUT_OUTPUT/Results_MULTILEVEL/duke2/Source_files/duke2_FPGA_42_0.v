...
module FAU ( 
  ...
  assign new_n60_ = x08 & new_n61_ & x11;
  ...
  assign new_n65_ = x11 & x15 & x16 & ~x18;
  assign new_n66_ = new_n67_ & ~x09 & ~x11 & x15 & x18 & ~x21;
  assign new_n67_ = ~x04 & x05 & ~x07 & x08;
  assign z02 = new_n79_ | (~new_n69_ & ~x17);
  assign new_n69_ = ~new_n78_ & (~x18 | ((new_n70_ | x07) & (new_n76_ | ~x08)));
  assign new_n70_ = ~new_n74_ & (x09 | (~new_n71_ & (new_n75_ | x08) & (new_n73_ | ~x08)));
  assign new_n71_ = ~new_n72_ & ~x04;
  assign new_n72_ = (x06 | x08 | x15) & (~x05 | ~x08 | x11 | ~x15 | x21);
  assign new_n73_ = (x02 | x05 | ~new_n61_ | ~x11) & (~x15 | ~x21);
  assign new_n74_ = ~x05 & x08 & (~x15 | (~x02 & x11 & ~new_n63_ & x15));
  assign new_n75_ = x15 ? x05 : ((~x06 | (x02 & x11)) & ~x05 & (x06 | x12));
  assign new_n76_ = ((~new_n63_ & ~x07) | (~x05 ^ x15)) & (~x05 | new_n77_ | x15) & (x05 | x11 | ~x15);
  assign new_n77_ = x04 & x12;
  assign new_n78_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x18;
  assign new_n79_ = ~x16 & ~x18;
  assign z03 = new_n81_ | new_n79_ | (~new_n83_ & ~x09);
  ...
  assign new_n118_ = (x06 | x08 | x12) & (~x02 | ~x08 | ~x13 | x14);
  ...
  assign new_n123_ = ~x09 & ~x15 & x16 & ~x18 & (new_n124_ | x17);
  assign new_n124_ = x04 & ~x05 & x12 & ~x14 & ~x21;
  assign z10 = (~x17 & ~new_n127_ & x18) | (~x09 & x16 & x17 & ~new_n126_ & ~x18);
  assign new_n126_ = x05 & x07;
  assign new_n127_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = ~x18 & (new_n129_ | ~x16);
  assign new_n129_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = new_n79_ | (~new_n131_ & ~x09);
  assign new_n131_ = ~new_n140_ & (x07 | (~new_n139_ & (x17 | ~new_n132_ | ~x18)));
  assign new_n132_ = ~x21 & (new_n133_ | new_n138_ | (~x05 & (new_n97_ | ~new_n135_)));
  assign new_n133_ = ~new_n134_ & ~x04;
  assign new_n134_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n135_ = ~new_n105_ & (x15 | (~new_n136_ & ~new_n137_));
  assign new_n136_ = x06 & ~x08 & (~x02 ^ ~x11);
  assign new_n137_ = ~x13 & ~x14 & x08 & ~x10;
  assign new_n138_ = x04 & x08 & ~x12 & ~new_n107_ & ~x15;
  assign new_n139_ = x15 & x17 & ~x18 & x00 & ~x05;
  assign new_n140_ = ~x05 & x07 & ~x15 & x17 & ~x18;
  assign z13 = ~x18 & (~x16 | (~x09 & ~new_n126_ & x17));
  ...
  assign new_n159_ = (x07 | ((x08 | ~new_n160_ | x15) & (~new_n109_ | ~x00 | ~x15))) & (~new_n109_ | ~x07 | x15);
  assign new_n160_ = ~x17 & x18 & ~new_n161_ & (~x21 | (~x14 & x21));
  assign new_n161_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n162_ = new_n67_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n166_ = (x04 | x08 | ~x21) & (x13 | x16 | x21 | ~x08 | ~x10);
  assign z19 = ~x18 & (~x16 | (new_n56_ & ~x09 & ~x15 & x17));
  assign z20 = new_n79_ | (~x07 & ~x17 & (new_n175_ | (~new_n169_ & ~x15)));
  assign new_n169_ = (new_n170_ | ~x18) & (~new_n174_ | ~x12 | x14 | x18 | x21);
  assign new_n170_ = (x09 | ((~new_n171_ | ~x04) & (~new_n173_ | x05))) & (~x04 | ~new_n172_ | ~x05);
  assign new_n171_ = x08 & x10 & ~x12 & ~x14 & ~new_n156_ & ~x21;
  ...
  assign z24 = new_n79_ | (~x09 & ~x17 & (new_n183_ | new_n187_));
  ...
  assign z25 = (~x16 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n189_ & x18);
  ...
  assign new_n195_ = ~new_n79_ & (~new_n196_ | ~x03 | x05 | x07 | ~x08);
  assign new_n196_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n197_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n210_ & ~x18) | (~x17 & ((new_n212_ & ~x05) | (~new_n199_ & x18)));
  ...
  assign new_n210_ = ~new_n211_ & x16;
