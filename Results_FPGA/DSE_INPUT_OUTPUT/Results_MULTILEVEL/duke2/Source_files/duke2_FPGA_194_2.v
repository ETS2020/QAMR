...
module FAU ( 
  ...
  assign z01 = ~new_n61_ | (~x05 & (new_n56_ | new_n63_));
  ...
  assign new_n61_ = (~x17 | x18) & (~new_n62_ | x11 | ~x15 | x17 | ~x18 | x21);
  assign new_n62_ = ~x04 & x05 & ~x07 & x08 & ~x09;
  ...
  assign new_n73_ = (~x07 | (~x05 ^ x15)) & (x15 | (x05 ? (x04 & x12) : x07)) & (x05 | new_n74_ | ~x15);
  ...
  assign new_n144_ = ~x05 & ~x08 & ~x15 & ~new_n145_ & (~x14 | ~x21);
  assign new_n145_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n146_ = ~x11 & x15 & ~x21 & ~x04 & x05 & x08;
  assign z18 = (x17 & ~x18) | (~x05 & ~x07 & ~x09 & ~x17 & ~new_n148_ & x18);
  ...
  assign new_n172_ = ~x17 & x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  ...
  assign z27 = x17 ? ~x18 : (x18 & (new_n181_ | (~new_n178_ & ~x09)));
  ...
  assign new_n194_ = ~x05 & x07 & ~x09 & ~new_n74_ & x15;
  assign z15 = 1'b0;
  assign z19 = 1'b0;
endmodule
