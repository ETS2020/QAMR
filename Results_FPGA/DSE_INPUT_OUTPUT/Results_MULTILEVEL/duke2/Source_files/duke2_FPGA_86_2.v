...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n107_ | (~x07 & ~x17 & ~new_n93_ & x18));
  assign new_n93_ = ~new_n105_ & (x05 | (~new_n100_ & ((new_n94_ & ~new_n103_) | x21)));
  assign new_n94_ = ~new_n99_ & (x15 | (~new_n95_ & (~x08 | new_n98_ | x14)));
  assign new_n95_ = x06 & (new_n97_ | (new_n96_ & ~x02));
  ...
  assign new_n104_ = (x02 | ~x08 | ~x11 | x14) & (x06 | x08 | x15);
  assign new_n105_ = x04 & new_n106_ & x08;
  assign new_n106_ = ~x12 & ~x15 & ~x21 & (x05 | (~x13 & ~x14));
  assign new_n107_ = ~x00 & ~x05 & x07 & ~x15 & x17 & ~x18;
  assign z07 = ~x17 & ~new_n109_ & x18;
  assign new_n109_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~new_n67_ & ~x20;
  assign z09 = (~x17 & ~new_n112_ & x18) | (~new_n120_ & ~x18);
  assign new_n112_ = (~new_n119_ | ~x05) & (x07 | (x05 ? ~new_n118_ : new_n113_));
  assign new_n113_ = (x21 | ((~new_n117_ | x11 | ~x15) & (x09 | new_n114_ | x15))) & (~new_n117_ | ~x09 | x11 | ~x15);
  assign new_n114_ = (new_n115_ | ~x04) & (~new_n116_ | ~x02) & (~new_n96_ | x02 | ~x06);
  ...
  assign z10 = (new_n125_ & x08) | (~x09 & (new_n123_ | (new_n124_ & ~x06)));
  assign new_n123_ = ~x00 & x17 & ~x18 & (~x05 | ~x07);
  ...
  assign z12 = new_n67_ | (~x09 & (new_n135_ | (new_n129_ & ~x07)));
  assign new_n129_ = ~x17 & x18 & ~x21 & (~new_n130_ | (~new_n134_ & ~x04));
  assign new_n130_ = (~new_n133_ | ~x04) & (x05 | (~new_n103_ & ~new_n131_ & ~new_n99_));
  ...
  assign z16 = (x00 & ~x18) | (x08 & ~x17 & x18 & (new_n147_ | new_n151_));
  ...
  assign z17 = ~x09 & (new_n156_ | (~x05 & ~new_n153_ & ~x15));
  assign new_n153_ = (x07 | x08 | x17 | ~new_n154_ | ~x18) & (x00 | ~x07 | ~x17 | x18);
  ...
  assign new_n162_ = x17 & ~x15 & ~x09 & ~x07 & ~x00 & ~x05;
  ...
  assign new_n175_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)))));
  ...
  assign z27 = ~new_n189_ | (~x09 & (new_n135_ | (~x17 & ~new_n186_ & x18)));
  assign new_n186_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n187_ & (~x05 | x08 | x15 | ~x19));
  assign new_n187_ = ~x21 & (new_n188_ | (~new_n134_ & ~x04));
  ...
  assign z28 = (~x17 & (new_n202_ | (~new_n192_ & x18))) | (~x18 & (new_n204_ | x00));
  assign new_n192_ = (~new_n199_ | x07) & (x05 | (~new_n193_ & ~new_n201_ & (~new_n196_ | x07)));
