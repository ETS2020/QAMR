...
module FAU ( 
  ...
  assign z01 = (x18 & x20) | (~new_n58_ & ~x17);
  ...
  assign z02 = (x18 & x20) | (~x17 & (new_n68_ | (x08 & ~new_n75_ & x18)));
  ...
  assign new_n76_ = ~x07 & x11 & (x02 | x07 | new_n64_ | ~x11);
  assign z03 = (~new_n78_ & ~x09) | (x18 & (new_n79_ | x20));
  ...
  assign z06 = ~x09 & ((~x07 & (new_n90_ | new_n103_)) | (new_n105_ & ~x05 & x07));
  assign new_n90_ = ~x17 & x18 & ~x20 & (new_n101_ | (~new_n91_ & ~x05));
  ...
  assign z10 = (x18 & (x20 | (~new_n123_ & ~x17))) | (~x09 & x17 & ~new_n122_ & ~x18);
  ...
  assign z12 = ~x09 & ((~new_n127_ & ~x07) | (new_n105_ & ~x05 & x07));
  assign new_n127_ = ~new_n103_ & (x17 | ~x18 | x20 | new_n128_ | x21);
  assign new_n128_ = ~new_n129_ & ~new_n133_ & (x05 | (~new_n92_ & ~new_n131_ & ~new_n100_));
  ...
  assign new_n133_ = x04 & x08 & ~x12 & ~new_n102_ & ~x15;
  assign z13 = (x18 & x20) | (~x09 & x17 & ~new_n122_ & ~x18);
  assign z14 = ~new_n141_ | (~x17 & (new_n136_ | (x08 & ~new_n139_ & x18)));
  ...
  assign z15 = (x18 & x20) | (new_n105_ & new_n138_ & x05);
  assign z16 = x18 & (x20 | (x08 & ~new_n145_ & ~x17));
  ...
  assign z17 = ~x09 & (new_n152_ | (new_n156_ & new_n157_ & x15 & ~x17));
  assign new_n152_ = ~x05 & ((~x07 & (new_n153_ | (new_n104_ & x00 & x15))) | (new_n104_ & x07 & ~x15));
  assign new_n153_ = ~x08 & ~x15 & ~x17 & x18 & new_n154_ & ~x20;
  assign new_n154_ = ~new_n155_ & (~x14 | ~x21);
  assign new_n155_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n156_ = ~x04 & x05 & ~x07 & x08 & ~x11;
  assign new_n157_ = x18 & ~x20 & ~x21;
  assign z18 = x18 & (x20 | (~x05 & ~x07 & new_n159_ & ~x09));
  assign new_n159_ = ~x17 & ((~x14 & ~new_n160_ & ~x15) | (~x08 & x15 & x19));
  assign new_n160_ = ~new_n83_ & (~x12 | (~new_n162_ & (new_n161_ | x06)));
  assign new_n161_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n162_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = (x18 & x20) | (new_n105_ & new_n138_ & ~x05);
  assign z20 = ~x07 & ~x17 & (new_n171_ | (~new_n165_ & ~x15));
  assign new_n165_ = ~new_n170_ & (~x18 | x20 | (~new_n169_ & (new_n166_ | x09)));
  ...
  assign new_n171_ = new_n172_ & new_n157_ & ~x11 & x15;
  assign new_n172_ = ~x04 & x05 & x08 & ~x09;
  assign z21 = x18 & (x20 | (~new_n174_ & ~x17));
  assign new_n174_ = (new_n175_ | x07) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign new_n175_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15 | x20);
  assign z22 = ~x17 & x18 & ~new_n177_ & ~x20;
  assign new_n177_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = ~x20 & new_n179_ & x18;
  assign new_n179_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n185_ | (~new_n181_ & ~x07));
  assign new_n181_ = ~new_n182_ & (x05 | x08 | x15 | ~x18 | x20);
  assign new_n182_ = ~x21 & ((x04 & ~new_n183_ & ~x15) | (x08 & new_n184_ & x15));
  assign new_n183_ = (x14 | x18 | x05 | ~x12) & (~x05 | ~x08 | x12 | ~x18 | x20);
  assign new_n184_ = x18 & ~x20 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n185_ = x08 & ~x15 & ~x18 & x01 & ~x05 & x07;
  assign z25 = x18 & (new_n187_ | x20);
  assign new_n187_ = ~x05 & ~x07 & ~x17 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = x20 ? x18 : (x14 | x21);
  assign z27 = (~new_n193_ & x18) | (~x09 & (new_n195_ | (~x17 & ~new_n190_ & x18)));
  ...
  assign new_n193_ = ~x20 & (~new_n194_ | ~x03 | x05 | x07 | ~x08);
  assign new_n194_ = x09 & ~x15 & ~x17 & x19;
  assign new_n195_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n197_ & ~x17) | (x18 & x20) | (~x09 & x17 & ~new_n210_ & ~x18);
  assign new_n197_ = (~new_n209_ | x05) & (~x18 | (~new_n207_ & (x05 | (~new_n198_ & new_n201_))));
