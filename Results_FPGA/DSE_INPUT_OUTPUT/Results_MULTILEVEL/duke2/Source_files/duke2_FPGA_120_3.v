...
module FAU ( 
  ...
  assign new_n79_ = (~x18 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (~x17 | (x05 & x07));
  ...
  assign new_n83_ = x02 & (new_n84_ | (x06 & ~x08 & ~x11 & x21));
  assign new_n84_ = ~x06 & x08 & ~x10 & x13 & ~x21;
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n91_ | (new_n106_ & ~x15 & x17)));
  assign new_n91_ = ~x07 & (new_n104_ | (x18 & (new_n102_ | (~new_n92_ & ~x05))));
  ...
  assign new_n104_ = new_n105_ & x15 & x17;
  assign new_n105_ = x00 & ~x05;
  assign new_n106_ = ~x05 & x07;
  assign z07 = x18 & (new_n108_ | new_n109_ | x17);
  assign new_n108_ = ~x09 & (x07 ^ ~x08) & (x05 ^ x15);
  assign new_n109_ = ~x05 & ~x07 & x08 & x09 & ~x15 & x16;
  assign z08 = x14 & ~x20 & (~x17 | ~x18);
  assign z09 = (~new_n112_ & x18) | (~x07 & new_n121_ & ~x09);
  assign new_n112_ = (x07 | (x05 ? ~new_n119_ : new_n113_)) & ~x17 & (~new_n120_ | ~x05);
  ...
  assign new_n121_ = ~x15 & (x17 | (new_n122_ & x04 & ~x05 & x12));
  assign new_n122_ = ~x14 & ~x18 & ~x21;
  assign z10 = z13 | (~x17 & ~new_n124_ & x18);
  assign new_n124_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x06 | x07 | x08 | x09))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = new_n127_ & ~x18;
  assign new_n127_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n129_ & ~x07) | (~x05 & x07 & new_n136_ & ~x15));
  assign new_n129_ = (x17 | ~x18 | new_n130_ | x21) & (~new_n105_ | ~x15 | ~x17 | x18);
  assign new_n130_ = ~new_n131_ & ~new_n135_ & (x05 | (~new_n93_ & ~new_n133_ & ~new_n101_));
  assign new_n131_ = ~new_n132_ & ~x04;
  assign new_n132_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n133_ = ~x15 & (new_n134_ | (x06 & ~x08 & (~x02 ^ ~x11)));
  assign new_n134_ = x08 & ~x10 & ~x13 & ~x14;
  assign new_n135_ = x04 & x08 & ~x12 & ~new_n103_ & ~x15;
  assign new_n136_ = x17 & ~x18;
  assign z14 = (new_n143_ & ~x05) | (~x17 & (new_n141_ | (new_n138_ & x08)));
  ...
  assign new_n152_ = (x07 | ((x08 | ~new_n153_ | x15) & (~new_n136_ | ~x00 | ~x15))) & (~new_n136_ | ~x07 | x15);
  assign new_n153_ = ~x17 & x18 & ~new_n154_ & (~x21 | (~x14 & x21));
  assign new_n154_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n155_ = new_n66_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = x18 & (x17 | (~x05 & ~x07 & ~new_n157_ & ~x09));
  assign new_n157_ = (x14 | new_n158_ | x15) & (x08 | ~x15 | ~x19);
  assign new_n158_ = (new_n159_ | ~x12) & (~x02 | (~new_n84_ & ~new_n161_));
  assign new_n159_ = (x06 | (~new_n160_ & (~new_n89_ | ~x08 | ~x10))) & (~new_n87_ | ~x06 | ~x08 | ~x10);
  assign new_n160_ = ~x04 & ~x08 & ~x17 & x21;
  assign new_n161_ = x06 & ~x08 & ~x11 & ~x17 & x21;
  ...
  assign new_n165_ = (x09 | ((~new_n167_ | x05) & (~new_n166_ | ~x04))) & (~x04 | ~new_n168_ | ~x05);
  assign new_n166_ = x08 & x10 & ~x12 & ~x14 & ~new_n149_ & ~x21;
  assign new_n167_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n168_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n169_ = x04 & ~x05 & ~x09;
  assign new_n170_ = new_n171_ & x08 & ~x09 & ~x04 & x05;
  assign new_n171_ = x18 & ~x21 & ~x11 & x15;
  assign z21 = ~x17 & ~new_n173_ & x18;
  assign new_n173_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~new_n175_ & x18;
  assign new_n175_ = (new_n176_ | x07) & ~x17 & (~x08 | ~x15 | x05 | ~x07);
  assign new_n176_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign z24 = (x17 & x18) | (~x09 & (new_n178_ | new_n182_));
  ...
  assign new_n182_ = new_n106_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  ...
  assign new_n188_ = ~x21 & (new_n131_ | new_n189_);
  assign new_n189_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n190_ = new_n56_ & x03 & ~x15 & x19 & x08 & x09;
  assign new_n191_ = ~x05 & x17 & ((x07 & ~x15) | (x00 & ~x07 & x15));
