...
module FAU ( 
  ...
  assign z10 = ~x09 & ((~x07 & x17 & ~x18) | (~x05 & (new_n84_ | (x17 & ~x18))));
  ...
  assign z13 = (~x15 & x18) | (~x09 & x17 & ((~x05 & (~x18 | (x07 & ~x15))) | (~x07 & ~x18)));
  assign z14 = z05 | (~x05 & (new_n96_ | (~new_n94_ & ~x17)));
  assign new_n94_ = (x07 | (~new_n81_ & ~new_n95_)) & (~x07 | ~x08 | ~x18 | x19);
  ...
  assign z28 = (~new_n124_ & ~x05) | z05 | (~x07 & ~new_n128_ & ~x09);
  assign new_n124_ = ~new_n127_ & (x17 | (~new_n126_ & (new_n125_ | (x02 & x11))));
  assign new_n125_ = (~x08 | ~x18) & (~x07 | x09 | ~x15 | x18);
  assign new_n126_ = x18 & ((x07 & x08) | (~x07 & ~x08 & ~x09 & ~x19));
  assign new_n127_ = ~x09 & x15 & x17 & ~x18 & ~x19;
  assign new_n128_ = (~x17 | x18 | (~x05 & ~x15)) & (~x18 | ~x21 | ~x08 | x17);
  assign z23 = z05;
endmodule
