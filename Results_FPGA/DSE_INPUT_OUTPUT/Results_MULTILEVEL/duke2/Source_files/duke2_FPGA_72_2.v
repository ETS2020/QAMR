...
module FAU ( 
  ...
  assign z01 = (~x17 & (new_n65_ | (~new_n57_ & ~x05))) | (x14 & ~x18);
  ...
  assign z02 = (x14 & ~x18) | (~x17 & (new_n68_ | (x08 & ~new_n75_ & x18)));
  ...
  assign z23 = (x14 & ~x18) | (new_n79_ & new_n80_ & ~x17 & x18);
  ...
  assign z06 = (x14 & ~x18) | (~x09 & (new_n108_ | (~new_n93_ & ~x07)));
  ...
  assign z09 = (new_n113_ & ~x17) | (~x07 & ~x09 & new_n122_ & ~x14);
  ...
  assign new_n122_ = ~x15 & ~x18 & (x17 | (new_n123_ & x12 & ~x21));
  ...
  assign new_n128_ = ~x15 & ~x14 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (x14 & ~x18) | (~x09 & (new_n108_ | (~new_n130_ & ~x07)));
  assign new_n130_ = ~new_n106_ & (x17 | ~x18 | x21 | (new_n131_ & ~new_n135_));
  ...
  assign new_n140_ = new_n141_ & new_n123_ & ~x07 & ~x09;
  assign new_n141_ = x12 & ~x15 & ~x18 & ~x21;
  ...
  assign z21 = (x14 & ~x18) | (~x17 & ~new_n173_ & x18);
  ...
  assign new_n177_ = ((~new_n178_ & ~new_n181_) | x07) & (~new_n182_ | ~x01 | x05 | ~x07);
  ...
  assign new_n182_ = x08 & ~x14 & ~x15 & ~x18;
  ...
  assign new_n190_ = (~x14 | x18) & (~new_n191_ | ~new_n80_ | x17 | ~x18 | ~x19);
  assign new_n191_ = x03 & ~x05 & ~x07 & x08;
  assign new_n192_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n194_ & ~x17) | (~x18 & (x14 | (~x09 & ~new_n207_ & x17)));
