...
module FAU ( 
  ...
  assign new_n69_ = ~x09 & ((~new_n70_ & x18) | (~x15 & (new_n75_ | (~new_n73_ & x18))));
  ...
  assign z06 = (~x01 & ~x18) | (~x09 & (new_n106_ | (~new_n94_ & ~x07)));
  ...
  assign z07 = (~x01 & ~x18) | (~x17 & ~new_n109_ & x18);
  assign new_n109_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = (x14 & ~x20) | (~x01 & ~x18);
  assign z09 = (~x17 & ~new_n112_ & x18) | (~x18 & (~x01 | (new_n121_ & ~x07)));
  assign new_n112_ = (~new_n120_ | ~x05) & (x07 | (x05 ? ~new_n119_ : new_n113_));
  assign new_n113_ = (~new_n118_ | ~x09 | x11 | ~x15) & (x21 | ((~new_n118_ | x11 | ~x15) & (x09 | new_n114_ | x15)));
  ...
  assign new_n121_ = ~x09 & ~x15 & (x17 | (new_n122_ & x04 & ~x05));
  assign new_n122_ = x12 & ~x14 & ~x21;
  assign z10 = (~x17 & ~new_n124_ & x18) | (~x18 & (~x01 | (~x09 & ~new_n80_ & x17)));
  assign new_n124_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = ~new_n126_ & ~x18;
  assign new_n126_ = x01 & (x09 | x15 | x17 | x05 | ~x07);
  assign z12 = (~x01 & ~x18) | (~x09 & (new_n128_ | new_n136_));
  assign new_n128_ = ~x05 & (new_n135_ | (~x07 & ~x17 & new_n129_ & x18));
  assign new_n129_ = ~x21 & (new_n130_ | new_n134_ | (x04 & ~new_n133_ & ~x12));
  assign new_n130_ = ~x15 & ((~new_n132_ & ~x08) | (new_n131_ & x08 & ~x10));
  ...
  assign new_n135_ = x01 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n136_ = ~x07 & x08 & ~x17 & x18 & ~new_n137_ & ~x21;
  assign new_n137_ = (x11 | ~x15 | x04 | ~x05) & (~x04 | x12 | x15 | (~new_n131_ & ~x05));
  assign z13 = x01 & ~x09 & x17 & ~new_n80_ & ~x18;
  assign z14 = (~new_n145_ & ~x18) | (~x17 & (new_n143_ | (x08 & ~new_n140_ & x18)));
  ...
  assign new_n145_ = x01 & (x05 | x09 | ((~x15 | ~x17) & (~x07 | (~x15 & ~x17))));
  assign z15 = ~new_n147_ & ~x18;
  assign new_n147_ = x01 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign z17 = (~x01 & ~x18) | (~x09 & (new_n158_ | (~new_n155_ & ~x05)));
  assign new_n155_ = (x07 | ((x08 | ~new_n156_ | x15) & (~new_n107_ | ~x00 | ~x15))) & (~new_n107_ | ~x07 | x15);
  assign new_n156_ = ~x17 & x18 & ~new_n157_ & (~x21 | (~x14 & x21));
  assign new_n157_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n158_ = new_n67_ & ~x04 & x05 & new_n159_ & new_n66_ & ~x17;
  ...
  assign z20 = ~x07 & ~x17 & (new_n172_ | (~new_n166_ & ~x15));
  ...
  assign new_n171_ = x01 & x04 & ~x05 & ~x09;
  assign new_n172_ = new_n66_ & new_n159_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign new_n179_ = x05 ? (x07 | ~x08 | ~new_n182_ | ~x18) : new_n180_;
  assign new_n180_ = (new_n181_ | x15) & (~new_n67_ | x02 | ~new_n66_ | ~x11 | ~x15);
  assign new_n181_ = (x07 | x08 | ~x18) & (~x01 | x18 | ((~x07 | ~x08) & (~new_n122_ | ~x04 | x07)));
  ...
  assign z27 = (~new_n187_ & ~x09) | (new_n191_ & new_n67_ & x03 & ~x05);
  assign new_n187_ = x05 ? (x17 | new_n189_ | ~x18) : (~new_n135_ & (x17 | new_n188_ | ~x18));
  assign new_n188_ = (x07 | x08 | x15 | new_n157_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n189_ = (x07 | ((~new_n190_ | x04 | ~x08) & (x08 | x15 | ~x19))) & (x15 | ~x19 | ~x07 | ~x08);
  assign new_n190_ = ~x11 & x15 & ~x21;
  assign new_n191_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n193_ & ~x17) | (~x18 & (~x01 | (~x09 & ~new_n206_ & x17)));
  assign new_n193_ = (~new_n205_ | x05) & (~x18 | (~new_n203_ & (x05 | (~new_n194_ & new_n197_))));
  assign new_n194_ = ~new_n195_ & ~x02;
  assign new_n195_ = (~x08 | ~x15) & (~new_n196_ | x08 | x09 | ~x06 | x07);
