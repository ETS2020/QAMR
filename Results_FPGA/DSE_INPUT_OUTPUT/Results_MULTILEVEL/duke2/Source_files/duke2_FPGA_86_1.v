...
module FAU ( 
  ...
  assign new_n55_ = x17 & ((~x00 & (~x07 | (~x05 & x15))) | (x05 & (~x07 | ~x15)) | (~x07 & ~x15) | (~x05 & x07 & x15));
  ...
  assign z05 = x18 & (~x00 | (new_n83_ & ~x05));
  assign new_n83_ = ~x07 & ~x09 & ~x14 & ~x15 & ~new_n84_ & ~x17;
  assign new_n84_ = x08 ? (new_n87_ | x21) : (~x21 | (new_n86_ & (new_n85_ | ~x00)));
  ...
  assign z06 = ~x09 & (new_n99_ | (x00 & ~new_n89_ & ~x07));
  assign new_n89_ = (x17 | ~x18 | (~new_n97_ & (new_n90_ | x15))) & (x05 | ~x15 | ~x17 | x18);
  assign new_n90_ = ~new_n95_ & (x21 | (~new_n91_ & ~new_n96_ & (new_n93_ | ~x08)));
  ...
  assign new_n95_ = ~x05 & ~x08 & ~new_n85_ & ~x14;
  ...
  assign z07 = x00 & ~x17 & ~new_n101_ & x18;
  assign new_n101_ = (x09 | (~x07 ^ ~x08) | (x05 ^ ~x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20 & (x00 | ~x18);
  assign z09 = new_n113_ | (x18 & (~x00 | (~new_n104_ & ~x17)));
  assign new_n104_ = (~new_n112_ | ~x05) & (x07 | (x05 ? ~new_n111_ : new_n105_));
  assign new_n105_ = (x21 | ((~new_n106_ | x09) & (~new_n110_ | ~x02 | ~x08))) & (~x02 | ~x08 | ~new_n110_ | ~x09);
  assign new_n106_ = ~x15 & ((~new_n107_ & x04) | new_n108_ | new_n109_);
  ...
  assign z10 = (x00 & ~x17 & ~new_n117_ & x18) | (~x09 & x17 & ~new_n116_ & ~x18);
  ...
  assign z12 = (~x00 & x18) | (~x09 & (new_n99_ | (~new_n121_ & ~x07)));
  assign new_n121_ = ~new_n131_ & (x17 | ~x18 | (new_n122_ & ~new_n129_) | x21);
  assign new_n122_ = (~new_n128_ | ~x04) & (x05 | (new_n123_ & (~x04 | new_n127_ | x12)));
  ...
  assign z13 = (~x00 & x18) | (~x09 & x17 & ~new_n116_ & ~x18);
  ...
  assign new_n138_ = (x00 | ~x18) & (x05 | x09 | new_n139_ | x18);
  assign new_n139_ = (~x15 | (~x07 & ~x17)) & (~x07 | (x01 & ~x17));
  assign z15 = (~x00 & x18) | (new_n141_ & ~x15 & x17 & ~x18);
  assign new_n141_ = x05 & ~x07 & ~x09;
  assign z16 = x18 & (~x00 | (x08 & ~x17 & (new_n143_ | new_n148_)));
  ...
  assign z17 = ~x09 & (new_n99_ | (x00 & ~new_n150_ & ~x07));
  assign new_n150_ = (new_n151_ | x05) & (~new_n153_ | x04 | ~x05 | ~x08 | x11);
  assign new_n151_ = (~x15 | ~x17 | x18) & (x08 | x15 | x17 | ~new_n152_ | ~x18);
  assign new_n152_ = ~new_n86_ & (~x21 | (~x14 & x21));
  assign new_n153_ = x15 & ~x17 & x18 & ~x21;
  assign z18 = x00 & ~x05 & ~x07 & ~x09 & new_n155_ & ~x17;
  ...
  assign z20 = ~x07 & ~x17 & (new_n168_ | (x00 & ~new_n162_ & x18));
  assign new_n162_ = (new_n163_ | x15) & (~new_n167_ | x09 | x11 | ~x15 | x21);
  ...
  assign z21 = x18 & (~x00 | (~new_n171_ & ~x17));
  assign new_n171_ = (new_n172_ | x07) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign new_n172_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (x08 | x09 | x15 | ~x00 | ~x05 | ~x06);
  ...
  assign new_n186_ = ~new_n188_ & (x21 | (~new_n129_ & ~new_n187_));
  ...
  assign new_n193_ = ~x18 & (x05 | ~x07 | x09 | x15 | ~x17);
  assign z28 = (~new_n195_ & ~x17) | (~x00 & x18) | (~x09 & x17 & ~new_n203_ & (~x00 | ~x18));
  ...
  assign new_n198_ = (~x08 | ~x18) & (~x07 | x09 | (x00 & x18));
  assign new_n199_ = x18 & ((x07 & x08) | (~x07 & ~x08 & ~x09 & ~x19));
  assign new_n200_ = x18 & (x08 ? new_n201_ : (~new_n85_ & x21));
