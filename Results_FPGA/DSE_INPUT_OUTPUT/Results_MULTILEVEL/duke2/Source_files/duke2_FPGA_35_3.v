...
module FAU ( 
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n91_ | (new_n104_ & ~x15 & x17)));
  assign new_n91_ = ~x07 & (new_n103_ | (x18 & (new_n101_ | (~new_n92_ & ~x15))));
  assign new_n92_ = ~new_n99_ & (x21 | (~new_n93_ & ~new_n97_ & (new_n95_ | ~x08)));
  ...
  assign new_n97_ = new_n98_ & ~x06 & ~x08 & ~x12;
  ...
  assign new_n103_ = x00 & ~x05 & x15 & x17;
  ...
  assign z09 = (new_n109_ & ~x17) | (~x07 & ~x09 & new_n118_ & ~x15);
  assign new_n109_ = x18 & ((new_n117_ & x05) | (~x07 & (x05 ? new_n116_ : ~new_n110_)));
  ...
  assign new_n118_ = ~x18 & (x17 | (new_n98_ & x12 & ~x14 & ~x21));
  assign z10 = (~new_n120_ & x18) | (~x09 & x17 & (~x05 | ~x07));
  assign new_n120_ = (new_n121_ | x15) & ~x17 & (~new_n122_ | x08 | x09 | ~x15);
  assign new_n121_ = (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09);
  assign new_n122_ = ~x05 & ~x06 & ~x07;
  assign z11 = (x17 & x18) | (new_n104_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  assign z12 = (x17 & x18) | (~x09 & (new_n125_ | (new_n104_ & ~x15 & x17)));
  assign new_n125_ = ~x07 & (new_n103_ | (x18 & ~x21 & (~new_n126_ | new_n133_)));
  assign new_n126_ = (~new_n132_ | ~x04) & (x05 | (new_n127_ & (~x04 | new_n131_ | x12)));
  ...
  assign z14 = (new_n142_ & ~x05) | (~x17 & (new_n140_ | (new_n137_ & x08)));
  assign new_n137_ = x18 & (x07 ? new_n139_ : (~new_n138_ & (x09 | ~x21)));
  assign new_n138_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n139_ = ~x19 & (x05 ^ x15);
  assign new_n140_ = new_n141_ & new_n98_ & ~x07 & ~x09;
  ...
  assign z17 = (~new_n151_ & ~x09) | (x17 & x18);
  assign new_n151_ = (new_n152_ | x05) & (~new_n155_ | ~new_n65_ | x04 | ~x05);
  assign new_n152_ = x07 ? (x15 | ~x17) : ((x08 | ~new_n153_ | x15) & (~x00 | ~x15 | ~x17));
  assign new_n153_ = x18 & ~new_n154_ & (~x21 | (~x14 & ~x17 & x21));
  assign new_n154_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n155_ = x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n157_ & x18;
  assign new_n157_ = (x14 | x15 | (~new_n83_ & ~new_n158_)) & (x08 | ~x15 | ~x19);
  assign new_n158_ = x12 & ((~new_n159_ & ~x06) | (new_n87_ & x06 & x08 & x10));
  assign new_n159_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & new_n56_ & ~x09;
  assign z20 = ~x07 & ~new_n162_ & ~x17;
  assign new_n162_ = ~new_n163_ & (~new_n155_ | ~x08 | x09 | x04 | ~x05);
  assign new_n163_ = ~x15 & (new_n167_ | (x18 & (new_n169_ | (~new_n164_ & ~x09))));
  ...
  assign new_n169_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign z21 = x18 & (~new_n172_ | (~new_n171_ & ~x07));
  assign new_n171_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15 | x17))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign new_n172_ = ~x17 & (x05 | ~x07 | ~x08 | x09 | ~x15 | x17);
  assign z22 = ~x17 & ~new_n174_ & x18;
  assign new_n174_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x18 & (x17 | (new_n56_ & x08 & x09 & ~x15));
  assign z24 = (x17 & x18) | (~x09 & (new_n177_ | new_n181_));
  assign new_n177_ = ~x07 & (new_n178_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n178_ = ~x21 & ((x04 & ~new_n179_ & ~x15) | (x08 & new_n180_ & x15));
  assign new_n179_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x17 | x18 | x05 | ~x12);
  assign new_n180_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n181_ = new_n104_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  ...
  assign new_n187_ = ~x21 & (new_n133_ | new_n188_);
  ...
  assign z28 = (~x17 & (new_n192_ | (new_n203_ & ~x05))) | (~x09 & new_n204_ & x17);
