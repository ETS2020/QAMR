...
module FAU ( 
  ...
  assign new_n76_ = (x17 | new_n77_ | ~x18) & (x16 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n90_ = x18 & (new_n100_ | (~x15 & (new_n91_ | (new_n98_ & ~x05))));
  assign new_n91_ = ~x21 & (new_n92_ | new_n94_ | new_n97_);
  ...
  assign new_n118_ = ~x16 & (x07 | x09 | x15 | (~new_n119_ & ~x17));
  ...
  assign new_n124_ = ~x16 & ~x15 & ~x09 & x07 & x01 & ~x05;
  ...
  assign z14 = (~new_n136_ & ~x17) | (~x05 & new_n142_ & ~x09);
  assign new_n136_ = ~new_n140_ & (~x08 | new_n137_ | ~x18);
  ...
  assign new_n141_ = ~x14 & ~x15 & ~x16 & ~x18 & ~x21;
  assign new_n142_ = ~x16 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n144_ & ~x18;
  assign new_n144_ = ~x16 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign z17 = new_n80_ | (~x09 & (new_n155_ | (~new_n152_ & ~x05)));
  ...
  assign z18 = new_n80_ | (~x05 & ~x07 & ~x09 & ~new_n157_ & ~x17);
  assign new_n157_ = (x14 | new_n158_ | x15) & (~x18 | ~x19 | x08 | ~x15);
  assign new_n158_ = ~new_n159_ & (~x18 | (~new_n83_ & (x06 | new_n161_ | ~x12)));
  assign new_n159_ = new_n160_ & x06 & x08 & x10;
  assign new_n160_ = x16 & ~x21 & x12 & ~x13;
  ...
  assign new_n164_ = (new_n165_ | ~x18) & (~new_n169_ | x18 | x21 | x14 | x16);
  ...
  assign new_n169_ = ~x09 & x12 & x04 & ~x05;
  ...
  assign z23 = (x16 & ~x18) | (new_n78_ & ~x17 & x18 & x09 & ~x15);
  assign z24 = new_n80_ | (~x09 & ~x17 & (new_n178_ | new_n182_));
  ...
  assign new_n190_ = ~new_n80_ & (~new_n191_ | ~x03 | x05 | x07 | ~x08);
  assign new_n191_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n192_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = ((new_n194_ | new_n204_) & ~x17) | (~x09 & ~x16 & new_n206_ & x17);
  assign new_n194_ = x18 & (new_n202_ | (~x05 & (~new_n195_ | (~new_n200_ & ~x02))));
  assign new_n195_ = (~new_n199_ | ~x08) & (x07 | x09 | (x08 ? ~new_n197_ : new_n196_));
  assign new_n196_ = (~x15 | x19) & (~new_n99_ | x14 | x15 | ~x21);
  ...
  assign new_n205_ = ~x09 & x15 & ~x16 & ~x18 & (~x02 | ~x11);
