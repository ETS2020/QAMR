...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n59_, new_n60_, new_n61_, new_n62_,
    ...
    new_n105_, new_n110_, new_n111_, new_n113_, new_n115_, new_n117_,
  ...
  assign z02 = ~x17 & (new_n68_ | (~new_n64_ & ~x05));
  assign new_n64_ = (x09 | (~new_n65_ & (~new_n66_ | ~x15))) & (~x08 | ~new_n67_ | ~x15);
  assign new_n65_ = x01 & x07 & ~x15 & ~x18 & (x08 | x16);
  assign new_n66_ = x18 & (x08 ? x21 : ~x07);
  assign new_n67_ = x18 & ((~x02 & ~x07 & x11 & (x09 | ~x21)) | x07 | ~x11);
  assign new_n68_ = ~x07 & x08 & ~x09 & new_n69_ & x15;
  assign new_n69_ = x18 & (x21 | (~x04 & x05 & ~x11 & ~x21));
  assign z03 = ~new_n71_ & ~x09;
  assign new_n71_ = (x05 | ((~x07 | ~x08 | ~x15 | x17 | ~x18) & (~x17 | x18))) & (x07 | ~x17 | x18);
  ...
  assign z09 = ~x07 & ((~x05 & (new_n80_ | new_n82_)) | (~new_n84_ & ~x09));
  assign new_n80_ = x02 & new_n81_ & x08;
  assign new_n81_ = ~x11 & x15 & ~x17 & x18 & (x09 | ~x21);
  assign new_n82_ = new_n83_ & x04 & ~x09 & x12;
  ...
  assign new_n86_ = x15 & ~x17 & x18 & ~x06 & ~x07 & ~x08;
  assign z11 = ~new_n88_ & ~x15;
  assign new_n88_ = ~x18 & (~x01 | x05 | ~x07 | x09 | x17);
  assign z12 = z23 | (~x09 & ((~new_n90_ & ~x07) | (new_n93_ & ~x05 & x07)));
  assign new_n90_ = ((~new_n75_ & ~new_n91_) | x05) & (~new_n92_ | x04 | ~x05 | ~x08);
  assign new_n91_ = x00 & x15 & x17 & ~x18;
  assign new_n92_ = ~x11 & ~x17 & x18 & ~x21;
  assign new_n93_ = ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z14 = ~x05 & ((~new_n96_ & x15) | (~x09 & ~new_n98_ & ~x18));
  assign new_n96_ = (~x08 | x17 | new_n97_ | ~x18) & (x09 | x18 | (~x07 & ~x17));
  assign new_n97_ = (x02 | x07 | ~x11 | (~x09 & x21)) & (~x07 | x19);
  assign new_n98_ = (~x07 | (x01 & ~x17)) & (~new_n99_ | ~x04 | x07 | ~x12);
  assign new_n99_ = ~x14 & ~x15 & ~x17 & ~x21;
  ...
  assign new_n104_ = new_n61_ & new_n92_;
  ...
  assign z20 = z23 | (~x07 & ~x09 & ~x17 & ~new_n110_ & ~x21);
  assign new_n110_ = (~new_n111_ | x04 | ~x05) & (~x04 | x05 | ~x12 | x14 | x15);
  assign new_n111_ = x08 & ~x11 & x18;
  assign z21 = x18 & (~x15 | (new_n113_ & ~x05));
  assign new_n113_ = ~x09 & ~x17 & ((~x06 & ~x07 & ~x08) | (x07 & x08 & x15));
  assign z22 = ~x05 & new_n115_ & x15;
  assign new_n115_ = ~x17 & x18 & ((x07 & x08) | (~x08 & ~x09 & x06 & ~x07));
  assign z24 = z23 | (~x09 & ~x17 & (new_n121_ | (~new_n117_ & ~x05)));
  assign new_n117_ = (x07 | (~new_n118_ & ~new_n119_) | x21) & (~new_n120_ | ~x01 | ~x07);
  assign new_n118_ = x04 & x12 & ~x14 & ~x15;
  assign new_n119_ = ~x02 & x08 & x11 & x18;
  assign new_n120_ = x08 & ~x15;
  assign new_n121_ = ~x04 & x05 & ~x07 & new_n62_ & x08 & ~x11;
  ...
  assign z28 = (x15 & ((new_n130_ & ~x07) | (~new_n127_ & ~x05))) | (new_n131_ & x05 & ~x07);
