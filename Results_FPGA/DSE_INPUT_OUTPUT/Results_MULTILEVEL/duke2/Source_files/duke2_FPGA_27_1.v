...
module FAU ( 
  ...
  assign new_n76_ = ~x05 & x07 & ~x18 & ~x21 & (x08 | x16);
  ...
  assign new_n84_ = ~x17 & x18 & ((~new_n89_ & x02) | new_n85_ | new_n87_);
  ...
  assign z06 = new_n67_ | (~x09 & (new_n106_ | (~new_n91_ & ~x07)));
  ...
  assign z10 = (~x17 & ~new_n123_ & x18) | (~x09 & x17 & new_n124_ & ~x18);
  assign new_n123_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign new_n124_ = ~x21 & (~x05 | ~x07);
  assign z11 = ~x18 & (new_n126_ | x21);
  ...
  assign new_n137_ = ~new_n141_ & (~x08 | new_n138_ | ~x18);
  assign new_n138_ = x07 ? ~new_n140_ : (new_n139_ | (~x09 & x21));
  assign new_n139_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n140_ = ~x19 & (x05 ^ x15);
  assign new_n141_ = new_n142_ & new_n121_ & ~x07 & ~x09;
  assign new_n142_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n143_ = ~x18 & ~x21 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n145_ & ~x18;
  assign new_n145_ = ~x21 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = (~x18 & x21) | (x08 & ~x17 & ~new_n147_ & x18);
  assign new_n147_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n148_;
  assign new_n148_ = (x07 | x15 | (x09 ? x19 : ~new_n149_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n149_ = ~x14 & ~x21 & (new_n151_ | (~new_n60_ & ~new_n150_));
  ...
  assign new_n156_ = new_n65_ & new_n66_ & ~x17 & ~x11 & x15;
  assign z18 = new_n67_ | (~x05 & ~x07 & ~x09 & ~new_n158_ & ~x17);
  assign new_n158_ = (x14 | new_n159_ | x15) & (~x18 | ~x19 | x08 | ~x15);
  assign new_n159_ = (new_n160_ | ~x02) & (~x12 | (~new_n164_ & (new_n162_ | x06)));
  assign new_n160_ = (~x06 | x08 | x11 | ~x21) & (~new_n161_ | x06 | ~x08 | x10);
  assign new_n161_ = x13 & x18 & ~x21;
  assign new_n162_ = (x04 | x08 | ~x21) & (x16 | ~x18 | x21 | ~new_n163_ | ~x08);
  assign new_n163_ = x10 & ~x13;
  assign new_n164_ = x06 & x08 & x10 & new_n66_ & ~x13 & x16;
  assign z19 = ~new_n166_ & ~x18;
  assign new_n166_ = ~x21 & (x09 | x15 | ~x17 | x05 | x07);
  assign z20 = new_n67_ | (~x07 & ~new_n168_ & ~x17);
  assign new_n168_ = (new_n169_ | x15) & (~new_n175_ | ~new_n66_ | x11 | ~x15);
  assign new_n169_ = ~new_n174_ & (~x18 | (~new_n173_ & (new_n170_ | x09)));
  ...
  assign new_n174_ = x04 & ~x05 & ~x09 & x12 & ~x14 & ~x18;
  ...
  assign z24 = new_n67_ | (~x09 & ~x17 & (new_n185_ | (~new_n181_ & ~x07)));
  assign new_n181_ = (x15 | (~new_n182_ & (x05 | x08 | ~x18))) & (~x08 | ~x15 | ~new_n184_ | ~x18);
  assign new_n182_ = ~new_n183_ & x04;
  assign new_n183_ = (x14 | x18 | x05 | ~x12) & (~x05 | ~x08 | x12 | ~x18 | x21);
  assign new_n184_ = ~x21 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  ...
  assign new_n193_ = ~new_n67_ & (~new_n194_ | x07 | ~x08 | ~x03 | x05);
  ...
  assign new_n208_ = x07 & ~x09 & x15 & ~x18 & ~new_n72_ & ~x21;
  assign new_n209_ = ~x18 & ~x21 & ((~x07 & (x05 | x15)) | (~x05 & x15 & ~x19));
endmodule
