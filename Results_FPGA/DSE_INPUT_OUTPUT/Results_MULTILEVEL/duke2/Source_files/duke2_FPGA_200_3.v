...
module FAU ( 
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n90_ | (new_n104_ & ~x15 & x17)));
  assign new_n90_ = ~x07 & (new_n103_ | (x18 & (new_n101_ | (~new_n91_ & ~x15))));
  assign new_n91_ = ~new_n98_ & (x21 | (~new_n92_ & ~new_n100_ & (new_n94_ | ~x08)));
  assign new_n92_ = ~x02 & ~new_n93_ & x11;
  assign new_n93_ = (x05 | ~x06 | x08) & (~x04 | ~x08 | x12 | x14);
  assign new_n94_ = ~new_n95_ & (x05 | x14 | (~new_n97_ & (new_n96_ | x17)));
  assign new_n95_ = x04 & ~x12 & (x05 | (~x13 & ~x14));
  assign new_n96_ = (x06 | ((~x10 | ~x12 | x13 | x16) & (~x02 | x10 | ~x13))) & (~x06 | ~x10 | ~x12 | x13 | ~x16);
  assign new_n97_ = ~x10 & ~x13;
  assign new_n98_ = ~x05 & ~x08 & ~x14 & new_n99_ & ~x17;
  ...
  assign new_n122_ = (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09);
  assign new_n123_ = ~x05 & ~x06 & ~x07;
  assign z11 = (x17 & x18) | (new_n104_ & x01 & ~x09 & ~x15 & ~x17 & ~x18);
  assign z12 = (x17 & x18) | (~x09 & (new_n126_ | (new_n104_ & ~x15 & x17 & ~x18)));
  assign new_n126_ = ~x07 & (new_n136_ | (x18 & (~new_n127_ | new_n134_) & ~x21));
  ...
  assign z17 = (x17 & x18) | (~new_n153_ & ~x09);
  ...
  assign new_n170_ = new_n157_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign new_n182_ = new_n104_ & x01 & ~x17 & ~x18 & x08 & ~x15;
  ...
  assign new_n190_ = new_n191_ & ~x07 & x08 & x03 & ~x05;
