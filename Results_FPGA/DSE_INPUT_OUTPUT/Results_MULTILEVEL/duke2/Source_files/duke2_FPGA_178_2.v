...
module FAU ( 
  ...
  assign z01 = x17 ? ~x20 : (new_n66_ | (~new_n58_ & ~x05));
  ...
  assign z02 = x17 ? ~x20 : (new_n69_ | (x08 & ~new_n76_ & x18));
  ...
  assign z03 = (~new_n81_ & ~x09) | new_n79_ | (x17 & ~x20);
  ...
  assign z06 = (~x09 & (new_n106_ | (~new_n92_ & ~x07))) | (x17 & ~x20);
  ...
  assign z09 = (~x17 & ~new_n111_ & x18) | new_n120_ | (x17 & ~x20);
  ...
  assign z10 = x17 ? (~x20 | (~x09 & ~new_n123_ & ~x18)) : (~new_n124_ & x18);
  assign new_n123_ = x05 & x07;
  assign new_n124_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x06 | x07 | x08 | x09))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = (x17 & ~x20) | (new_n126_ & ~x09 & ~x15 & ~x17 & ~x18);
  assign new_n126_ = x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n128_ & ~x07) | (new_n136_ & ~x05 & x07 & ~x15));
  ...
  assign new_n135_ = new_n136_ & x00 & ~x05 & x15;
  assign new_n136_ = x17 & ~x18 & x20;
  assign z13 = ~x09 & x17 & ~x18 & ~new_n123_ & x20;
  assign z14 = (~new_n139_ & ~x17) | (x17 & ~x20) | (new_n144_ & ~x05);
  ...
  assign z15 = x17 & (~x20 | (x05 & ~x07 & new_n146_ & ~x09));
  ...
  assign new_n154_ = (x07 | ((x08 | ~new_n155_ | x15) & (~new_n136_ | ~x00 | ~x15))) & (~new_n136_ | ~x07 | x15);
  ...
  assign z18 = (x17 & ~x20) | (~x05 & ~x07 & ~x09 & new_n159_ & ~x17);
  ...
  assign z19 = x20 & ~x18 & x17 & ~x15 & new_n55_ & ~x09;
  ...
  assign z22 = x17 ? ~x20 : (~new_n176_ & x18);
  ...
  assign z24 = ~x09 & ~x17 & (new_n179_ | (new_n126_ & new_n146_ & x08));
  ...
  assign new_n191_ = x17 & ~x18 & x20 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n192_ = new_n193_ & x03 & ~x05 & ~x07 & x08;
  assign new_n193_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = x17 ? (new_n207_ | ~x20) : (new_n195_ | (new_n206_ & ~x05));
