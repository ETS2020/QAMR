...
module FAU ( 
  ...
  assign new_n55_ = x04 & ~x05 & ~x07 & new_n56_ & x12 & ~x14;
  ...
  assign z02 = (x10 & ~x18) | (~x17 & (new_n70_ | (x08 & ~new_n77_ & x18)));
  ...
  assign new_n80_ = (x17 | new_n81_ | ~x18) & (x10 | ~x17 | new_n82_ | x18);
  ...
  assign z06 = new_n68_ | (~x09 & (new_n109_ | ((new_n93_ | new_n107_) & ~x07)));
  assign new_n93_ = ~x17 & (new_n105_ | (x18 & (new_n104_ | (~new_n94_ & ~x05))));
  ...
  assign new_n104_ = x04 & x05 & x08 & new_n56_ & ~x12;
  assign new_n105_ = new_n56_ & new_n106_ & x10 & ~x12 & x04 & x08;
  ...
  assign new_n123_ = ~x07 & ~x09 & ~x10 & ~x15 & ~new_n124_ & ~x18;
  assign new_n124_ = ~x17 & (~x04 | x05 | ~x12 | x14 | x21);
  assign z10 = (~x17 & ~new_n126_ & x18) | (~x18 & (x10 | (~x09 & ~new_n82_ & x17)));
  assign new_n126_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign z11 = ~x18 & new_n128_ & ~x17;
  assign new_n128_ = ~x15 & ~x10 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n68_ | (~x09 & (new_n138_ | (~new_n130_ & ~x07)));
  assign new_n130_ = (x17 | ~x18 | new_n131_ | x21) & (~new_n137_ | ~x15 | ~x17 | x18);
  assign new_n131_ = ~new_n132_ & ~new_n136_ & (x05 | (~new_n95_ & ~new_n134_ & ~new_n103_));
  ...
  assign new_n136_ = x04 & x08 & ~x12 & ~x15 & (new_n106_ | x05);
  assign new_n137_ = x00 & ~x05 & ~x10;
  assign new_n138_ = new_n108_ & ~x15 & ~x05 & x07 & ~x10;
  assign z13 = ~x09 & ~x10 & x17 & ~new_n82_ & ~x18;
  ...
  assign z18 = new_n68_ | (~x05 & ~x07 & ~x09 & ~new_n161_ & ~x17);
  assign new_n161_ = (x14 | new_n162_ | x15) & (~x18 | ~x19 | x08 | ~x15);
  assign new_n162_ = (~new_n164_ | ~x08) & (~x18 | (~new_n163_ & (new_n91_ | ~x02)));
  assign new_n163_ = ~x04 & ~x06 & ~x08 & x12 & x21;
  assign new_n164_ = x10 & x12 & ~x13 & ~x21 & (x06 ^ ~x16);
  assign z19 = new_n166_ & ~x18;
  assign new_n166_ = x17 & ~x15 & ~x10 & ~x09 & ~x05 & ~x07;
  ...
  assign z23 = (x10 & ~x18) | (new_n83_ & x09 & ~x15 & ~x17 & x18);
  assign z24 = new_n68_ | (~x09 & ~x17 & (new_n183_ | new_n187_));
  ...
  assign new_n196_ = ~x10 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n197_ = new_n198_ & x03 & ~x05 & ~x07 & x08;
  assign new_n198_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = ((new_n200_ | new_n211_) & ~x17) | (~x09 & ~x10 & new_n213_ & x17);
  ...
  assign new_n212_ = ~x09 & ~x10 & x15 & ~x18 & (~x02 | ~x11);
