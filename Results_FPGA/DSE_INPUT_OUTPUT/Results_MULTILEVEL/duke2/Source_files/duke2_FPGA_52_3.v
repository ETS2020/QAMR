...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n95_ & ~x07) | (~x05 & x07 & new_n107_ & ~x15));
  assign new_n95_ = (x17 | ~x18 | (~new_n104_ & (new_n96_ | x15))) & (~new_n106_ | ~x15 | ~x17 | x18);
  ...
  assign new_n100_ = (x06 | ((~x02 | x10 | ~x13) & (~x10 | ~x12 | x13 | x16))) & (x13 | (x10 & (~x06 | ~x10 | ~x12 | ~x16)));
  ...
  assign new_n119_ = x08 & ~new_n79_ & ~x15;
  ...
  assign new_n141_ = new_n106_ & x15 & x17;
  ...
  assign new_n148_ = new_n149_ & new_n55_ & ~x07 & ~x09;
  ...
  assign new_n155_ = (new_n62_ | (new_n156_ & (~x02 | ~x06))) & (~x12 | new_n156_ | (~x06 ^ x16));
  assign new_n156_ = x13 & (x02 | ~x11);
  assign new_n157_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n162_ | (~new_n159_ & ~x05));
  assign new_n159_ = (x07 | ((x08 | ~new_n160_ | x15) & (~new_n107_ | ~x00 | ~x15))) & (~new_n107_ | ~x07 | x15);
  ...
  assign new_n183_ = (new_n184_ | x07) & ~x17 & (~x08 | ~x15 | x05 | ~x07);
  assign new_n184_ = (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  ...
  assign new_n197_ = ~x21 & (new_n131_ | new_n198_);
  assign new_n198_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n199_ = new_n170_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n200_ = ~x05 & x17 & ((x00 & ~x07 & x15) | (x07 & ~x15));
  assign z28 = (~x17 & (new_n202_ | (new_n213_ & ~x05))) | (~x09 & new_n214_ & x17);
  ...
  assign new_n210_ = ~x15 & x21 & x11 & ~x14;
