...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n118_, new_n120_, new_n123_, new_n124_, new_n125_, new_n126_,
  ...
  assign new_n102_ = x00 & ~x05 & x15 & ~x18;
  ...
  assign z12 = (~x17 & ~x18) | (~x09 & (new_n123_ | (new_n103_ & ~x15 & x17 & ~x18)));
  ...
  assign new_n133_ = x07 ? (new_n107_ | x19) : (new_n61_ | new_n134_);
  ...
  assign z17 = ~x09 & ((~new_n144_ & ~x05) | (new_n147_ & new_n106_ & ~x04 & x05));
  assign new_n144_ = (x07 | ((x08 | ~new_n145_ | x15) & (~new_n131_ | ~x00 | ~x15))) & (~new_n131_ | ~x07 | x15);
  ...
  assign new_n149_ = (x14 | (~new_n81_ & ~new_n150_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n170_ = (new_n128_ | new_n171_) & ~x21;
  assign new_n171_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n172_ = new_n75_ & x03 & x08 & x09 & ~x15 & x19;
