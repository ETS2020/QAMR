...
module FAU ( 
  ...
  assign z01 = (~x17 & (new_n66_ | (~new_n58_ & ~x05))) | (~x18 & x20);
  ...
  assign z06 = (~x09 & (new_n106_ | (~new_n94_ & ~x07))) | (~x18 & x20);
  ...
  assign new_n120_ = ~x07 & ~x09 & ~x15 & ~x18 & ~new_n121_ & ~x20;
  assign new_n121_ = ~x17 & (~x04 | x05 | ~x12 | x14 | x21);
  assign z10 = (~x17 & ~new_n123_ & x18) | (~x18 & (x20 | (~x09 & ~new_n81_ & x17)));
  assign new_n123_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = ~x18 & (x20 | (new_n125_ & ~x09 & ~x15 & ~x17));
  assign new_n125_ = x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n127_ & ~x07) | (new_n139_ & ~x05 & x07 & ~x15));
  assign new_n127_ = (x17 | ~new_n128_ | ~x18) & (~new_n138_ | ~x17 | x18 | x20);
  ...
  assign z16 = (~x18 & x20) | (x08 & ~x17 & x18 & (new_n151_ | new_n155_));
  ...
  assign new_n157_ = (x07 | ((x08 | ~new_n158_ | x15) & (~new_n139_ | ~x00 | ~x15))) & (~new_n139_ | ~x07 | x15);
  ...
  assign new_n167_ = (new_n168_ | ~x18) & (~new_n172_ | x20 | x21 | x14 | x18);
  assign new_n168_ = (x09 | ((~new_n169_ | x05) & (~new_n170_ | ~x04))) & (~x04 | ~new_n171_ | ~x05);
  assign new_n169_ = ~x06 & ~x08 & ~new_n92_ & (~x14 | ~x21);
  assign new_n170_ = x08 & x10 & ~x12 & ~x14 & ~new_n154_ & ~x21;
  assign new_n171_ = x08 & ~new_n64_ & ~x12;
  assign new_n172_ = x04 & ~x05 & ~x09 & x12;
  ...
  assign z22 = (~x18 & x20) | (~x17 & ~new_n178_ & x18);
  assign new_n178_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n56_ & x08;
  assign z24 = ~x09 & ~new_n181_ & ~x17;
  assign new_n181_ = ~new_n182_ & (~new_n125_ | ~x08 | x15 | x18 | x20);
  assign new_n182_ = ~x07 & (new_n183_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n183_ = ~x21 & ((x04 & ~new_n184_ & ~x15) | (x08 & new_n185_ & x15));
  assign new_n184_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x20 | x05 | ~x12);
  ...
  assign new_n191_ = ~x21 & (new_n129_ | new_n192_);
