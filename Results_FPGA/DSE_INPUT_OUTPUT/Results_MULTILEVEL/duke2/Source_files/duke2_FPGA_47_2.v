...
module FAU ( 
  ...
  assign z09 = ~x17 & (new_n106_ | new_n115_);
  ...
  assign z20 = z15 | (~x07 & (new_n155_ | (~new_n149_ & ~x15)));
  ...
  assign z24 = z15 | (~x09 & (new_n168_ | (~new_n164_ & ~x07)));
  ...
  assign new_n188_ = x07 & ~x09 & ~new_n68_ & x15;
  assign z13 = 1'b0;
  assign z19 = z15;
endmodule
