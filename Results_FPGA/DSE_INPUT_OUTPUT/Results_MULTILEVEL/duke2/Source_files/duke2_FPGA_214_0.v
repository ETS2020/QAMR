...
module FAU ( 
  ...
  assign new_n88_ = ~new_n103_ & (x17 | (~new_n101_ & (x05 | (~new_n89_ & ~new_n98_))));
  ...
  assign new_n151_ = (x14 | x15 | (~new_n80_ & ~new_n152_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n176_ = ~x21 & (new_n125_ | new_n177_);
  ...
  assign z28 = (~x17 & ~new_n182_ & x18) | (~x09 & x17 & ~new_n192_ & ~x18);
  assign new_n182_ = ~new_n190_ & (x05 | (new_n183_ & (new_n188_ | x02)));
  assign new_n183_ = (~new_n187_ | ~x08) & (x07 | x09 | (x08 ? ~new_n185_ : new_n184_));
