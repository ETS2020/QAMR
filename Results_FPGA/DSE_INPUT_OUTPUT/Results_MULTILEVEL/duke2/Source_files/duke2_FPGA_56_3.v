...
module FAU ( 
  ...
  assign new_n98_ = (x06 | ((~x10 | ~x12 | x13 | x16) & (~x02 | x10 | ~x13))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  ...
  assign new_n108_ = ~x17 & (~new_n79_ | x05 | ~x09 | x15 | ~x16);
  ...
  assign z12 = ~x09 & (new_n106_ | (~x07 & (new_n104_ | (new_n129_ & ~x17))));
  ...
  assign new_n140_ = x18 & (x07 ? (~new_n109_ & ~x19) : new_n141_);
  assign new_n141_ = ~new_n142_ & (x09 | ~x21);
  ...
  assign z17 = ~x09 & ((~new_n154_ & ~x05) | (new_n157_ & new_n79_ & ~x04 & x05));
  assign new_n154_ = (x07 | ((x08 | ~new_n155_ | x15) & (~new_n105_ | ~x00 | ~x15))) & (~new_n105_ | ~x07 | x15);
  ...
  assign new_n178_ = (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15))) & (x09 | x15 | x17 | ~x05 | ~x06 | x08);
  assign z23 = x18 & (x17 | (new_n180_ & ~x05 & ~x07));
  assign new_n180_ = x08 & x09 & ~x15;
  assign z24 = (x17 & x18) | (~x09 & (new_n182_ | (new_n186_ & new_n187_ & ~x17 & ~x18)));
  assign new_n182_ = ~x07 & (new_n183_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n183_ = ~x21 & ((x04 & ~new_n184_ & ~x15) | (x08 & new_n185_ & x15));
  assign new_n184_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x17 | x18);
  assign new_n185_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n186_ = x01 & ~x05 & x07;
  ...
  assign new_n195_ = new_n196_ & new_n79_ & x03 & ~x05;
  assign new_n196_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n197_ = ~x05 & x17 & ~x18 & ((x00 & ~x07 & x15) | (x07 & ~x15));
