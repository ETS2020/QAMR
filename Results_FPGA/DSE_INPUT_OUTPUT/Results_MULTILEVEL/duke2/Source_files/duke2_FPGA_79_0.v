...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n94_ & ~x07) | (new_n106_ & ~x05 & x07 & ~x15));
  assign new_n94_ = ~new_n105_ & (x17 | ~x18 | (~new_n107_ & (new_n95_ | x05)));
  ...
  assign z09 = (~x17 & (new_n123_ | (x18 & (new_n113_ | new_n122_)))) | (~new_n120_ & ~x18);
  assign new_n113_ = ~x07 & ((~new_n114_ & ~x05) | (new_n63_ & x05 & x08));
  ...
  assign z12 = new_n83_ | (~x09 & ((~new_n129_ & ~x07) | (new_n137_ & ~x05 & x07)));
  assign new_n129_ = (x17 | ~new_n130_ | ~x18) & (~x15 | ~x17 | x18 | ~x00 | x05);
  assign new_n130_ = ~x21 & (new_n131_ | new_n136_ | (~x05 & (new_n96_ | ~new_n133_)));
  ...
  assign new_n136_ = x04 & x08 & ~x12 & ~new_n108_ & ~x15;
  ...
  assign new_n144_ = ~x14 & ~x15 & ~x18 & x19 & ~x21;
  assign new_n145_ = ~x18 & x19 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n147_ & x19;
  assign new_n147_ = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = new_n83_ | (x08 & ~new_n149_ & ~x17);
  assign new_n149_ = (~x18 | (x05 ? ~new_n154_ : new_n150_)) & (~new_n155_ | x05 | x07);
  assign new_n150_ = (x07 | x09 | x14 | ~new_n151_ | x15) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n151_ = ~x21 & ((~new_n153_ & x12) | (~new_n152_ & (~x10 | (x04 & ~x12))));
  assign new_n152_ = (~x02 | ~x06) & x13 & (x02 | ~x11);
  assign new_n153_ = (~x06 | x10 | ~x11) & (((x02 | ~x11) & x13) | (x06 ^ ~x16));
  assign new_n154_ = x09 & ~x15 & (x07 | ~x12);
  assign new_n155_ = x09 & ~x15 & ~x19;
  assign z17 = ~x09 & (new_n160_ | (~new_n157_ & ~x05));
  assign new_n157_ = (x07 | ((x08 | ~new_n158_ | x15) & (~new_n106_ | ~x00 | ~x15))) & (~new_n106_ | ~x07 | x15);
  ...
  assign z20 = new_n83_ | (~x07 & ~x17 & (new_n174_ | (~new_n167_ & ~x15)));
  assign new_n167_ = (new_n168_ | ~x18) & (~new_n173_ | ~x12 | x14 | x18 | x21);
  assign new_n168_ = (x09 | ((~new_n169_ | x05) & (~new_n170_ | ~x04))) & (~x04 | ~new_n172_ | ~x05);
  ...
  assign new_n184_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | ~x19);
  assign new_n185_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n186_ = x01 & ~x05 & x07 & new_n65_ & x08 & ~x15;
  assign z25 = (~x18 & ~x19) | (~x05 & ~x07 & ~x17 & ~new_n188_ & x18);
  ...
  assign new_n192_ = ~x21 & (new_n131_ | new_n193_);
  assign new_n193_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n194_ = (x18 | x19) & (~new_n195_ | ~x09 | x15 | x17 | ~x18 | ~x19);
  assign new_n195_ = x03 & ~x05 & ~x07 & x08;
  assign new_n196_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (new_n210_ & ~x07) | (~x17 & (new_n198_ | (~x05 & new_n209_ & x07)));
  ...
  assign new_n209_ = ~x09 & x15 & ~x18 & ~new_n71_ & x19;
  assign new_n210_ = ~x09 & x17 & ~x18 & x19 & (x05 | x15);
endmodule
