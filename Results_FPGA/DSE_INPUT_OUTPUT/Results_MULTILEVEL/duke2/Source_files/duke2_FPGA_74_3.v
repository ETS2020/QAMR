...
module FAU ( 
  ...
  assign new_n55_ = new_n56_ & ~x07 & x12 & new_n57_ & ~x14 & ~x15;
  assign new_n56_ = x04 & ~x05;
  assign new_n57_ = ~x18 & ~x21;
  assign new_n58_ = x17 & x18;
  assign z01 = x17 ? x18 : (new_n67_ | (~new_n60_ & ~x05));
  assign new_n60_ = ~new_n66_ & (x07 | ~x18 | (~new_n65_ & (new_n61_ | x09)));
  assign new_n61_ = (~x06 | ~new_n64_ | x08) & (x02 | ~x08 | ~new_n62_ | ~x11);
  assign new_n62_ = x13 & ~x14 & ~new_n63_ & ~x21;
  assign new_n63_ = x10 & (~x04 | x12);
  assign new_n64_ = ~x15 & (~x14 | ~x21) & (~x02 ^ ~x11);
  ...
  assign z06 = new_n58_ | (~x09 & ((~new_n93_ & ~x07) | (new_n105_ & ~x05 & x07)));
  ...
  assign new_n99_ = new_n56_ & ~x06 & ~x08 & ~x12;
  ...
  assign new_n107_ = ~x17 & (~new_n81_ | ~x09 | x15 | ~x16);
  ...
  assign new_n120_ = ~x17 & (~x04 | x05 | ~x12 | ~new_n57_ | x14);
  ...
  assign new_n142_ = x18 & (x07 ? (~new_n108_ & ~x19) : new_n143_);
  assign new_n143_ = ~new_n144_ & (x09 | ~x21);
  assign new_n144_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n145_ = new_n146_ & new_n56_ & ~x07 & ~x09;
  assign new_n146_ = x12 & ~x14 & new_n57_ & ~x15;
  ...
  assign z20 = new_n58_ | (~new_n168_ & ~x07);
  ...
  assign new_n173_ = new_n56_ & ~x09 & x12 & new_n57_ & ~x14 & ~x17;
  ...
  assign z24 = new_n58_ | (~new_n182_ & ~x09);
  assign new_n182_ = (x07 | (~new_n183_ & ~new_n186_)) & (~new_n187_ | ~x01 | x05 | ~x07);
  assign new_n183_ = ~x21 & ((x04 & ~new_n184_ & ~x15) | (x08 & new_n185_ & x15));
  assign new_n184_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x17 | x18 | x05 | ~x12);
  assign new_n185_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n186_ = ~x15 & x18 & ~x05 & ~x08;
  assign new_n187_ = x08 & ~x15 & ~x17 & ~x18;
  ...
  assign new_n195_ = new_n166_ & x03 & ~x15 & x19 & x08 & x09;
