...
module FAU ( 
  ...
  assign new_n55_ = x17 & ((~x00 & ((~x05 & x15 & x20) | (~x07 & ~x20))) | (x05 & (~x07 | ~x15)) | (~x07 & ~x15) | (~x05 & x07 & x15));
  ...
  assign z03 = (~new_n79_ & ~x09) | (x18 & (new_n80_ | x20));
  ...
  assign z06 = new_n67_ | (~x09 & ((~new_n91_ & ~x07) | (new_n106_ & ~x05 & x07)));
  ...
  assign z07 = ~x17 & x18 & ~new_n108_ & ~x20;
  assign new_n108_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20;
  assign z09 = new_n120_ | (x18 & ((~new_n111_ & ~x17) | x20));
  ...
  assign z10 = (~x17 & x18 & ~new_n124_ & ~x20) | (~x09 & x17 & ~new_n123_ & ~x18);
  assign new_n123_ = x05 & x07;
  assign new_n124_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = new_n67_ | (new_n126_ & x01 & ~x05 & x07);
  assign new_n126_ = ~x17 & ~x18 & ~x09 & ~x15;
  assign z12 = new_n67_ | (~x09 & ((~new_n128_ & ~x07) | (new_n106_ & ~x05 & x07)));
  assign new_n128_ = ~new_n104_ & (x17 | ~x18 | x21 | (new_n129_ & ~new_n133_));
  assign new_n129_ = (~new_n132_ | ~x04) & (x05 | (~new_n93_ & ~new_n130_ & ~new_n101_));
  ...
  assign z13 = (x18 & x20) | (~x09 & x17 & ~new_n123_ & ~x18);
  assign z14 = new_n137_ | (new_n144_ & ~x05);
  assign new_n137_ = ~x17 & (new_n141_ | (x08 & new_n138_ & x18));
  assign new_n138_ = ~x20 & (x07 ? new_n140_ : (~new_n139_ & (x09 | ~x21)));
  assign new_n139_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n140_ = ~x19 & (~x05 ^ ~x15);
  assign new_n141_ = new_n143_ & new_n142_ & x04 & ~x05;
  assign new_n142_ = ~x07 & ~x09;
  assign new_n143_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n144_ = ~x09 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n67_ | (new_n106_ & new_n142_ & x05);
  assign z16 = x08 & ~x17 & x18 & ~x20 & (new_n147_ | new_n151_);
  ...
  assign z18 = x18 & (x20 | (~x05 & ~x07 & new_n158_ & ~x09));
  assign new_n158_ = ~x17 & ((~x08 & x15 & x19) | (~x14 & ~new_n159_ & ~x15));
  ...
  assign z19 = new_n67_ | (new_n106_ & new_n142_ & ~x05);
  assign z20 = new_n67_ | (~x07 & ~x17 & (new_n170_ | (~new_n164_ & ~x15)));
  assign new_n164_ = (new_n165_ | ~x18) & (~new_n169_ | x18 | x21 | ~x12 | x14);
  ...
  assign z21 = ~x17 & x18 & ~new_n173_ & ~x20;
  assign new_n173_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = x18 & (new_n175_ | x20);
  assign new_n175_ = ~x17 & ((~new_n176_ & ~x07) | (x08 & x15 & ~x05 & x07));
  assign new_n176_ = (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x20);
  assign z23 = ~x20 & new_n178_ & x18;
  assign new_n178_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = new_n67_ | (~x09 & (new_n180_ | new_n184_) & ~x17);
  ...
  assign new_n186_ = ~x17 & x18 & ~x20 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  ...
  assign z28 = (~x17 & (new_n206_ | (new_n196_ & x18))) | (~x09 & x17 & ~new_n208_ & ~x18);
  assign new_n196_ = ~x20 & (new_n204_ | (~x05 & (~new_n197_ | (~new_n202_ & ~x02))));
