...
module FAU ( 
  ...
  assign new_n88_ = ~new_n104_ & (x17 | (~new_n101_ & (x05 | (~new_n89_ & ~new_n98_))));
  ...
  assign new_n94_ = x16 & x18 & ~x13 & ~x14;
  ...
  assign z09 = (~new_n110_ & ~x17) | (new_n105_ & ~x07 & ~x09);
  assign new_n110_ = (x07 | (x05 ? ~new_n116_ : new_n111_)) & x18 & (~new_n117_ | ~x05);
  ...
  assign z12 = (~x17 & ~x18) | (~x09 & (new_n123_ | (new_n130_ & ~x15 & x17 & ~x18)));
  assign new_n123_ = ~x07 & (new_n129_ | (~x17 & (~new_n124_ | new_n127_) & ~x21));
  assign new_n124_ = ~new_n126_ & (x05 | (~new_n90_ & ~new_n97_ & (new_n125_ | x15)));
  assign new_n125_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n103_ | ~x08 | x10);
  assign new_n126_ = x04 & x08 & ~x12 & ~x15 & (new_n103_ | x05);
  ...
  assign new_n141_ = x12 & (x06 ^ x16) & (~x13 | (~x02 & x11));
  ...
  assign z23 = ~x17 & (~x18 | (new_n165_ & ~x05 & ~x07));
  assign new_n165_ = x08 & x09 & ~x15;
  ...
  assign new_n174_ = ~x21 & (new_n127_ | new_n175_);
  ...
  assign z28 = (~x17 & ~new_n180_ & x18) | (~x09 & x17 & ~new_n190_ & ~x18);
  assign new_n180_ = ~new_n188_ & (x05 | (new_n181_ & (new_n186_ | x02)));
  assign new_n181_ = (~new_n185_ | ~x08) & (x07 | x09 | (x08 ? ~new_n183_ : new_n182_));
  assign new_n182_ = (~x15 | x19) & (~new_n100_ | x14 | x15 | ~x21);
