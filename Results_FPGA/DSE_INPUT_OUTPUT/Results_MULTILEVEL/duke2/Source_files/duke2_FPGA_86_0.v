...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n207_;
  assign z00 = x00 & ~x09 & ~new_n54_ & ~x18;
  assign new_n54_ = (~x17 | ((~x05 | (x07 & x15)) & (x07 | x15) & (x05 | ~x07 | ~x15))) & (~new_n55_ | ~x04 | x05 | x07);
  assign new_n55_ = ~x15 & ~x21 & x12 & ~x14;
  assign z01 = new_n68_ | (~x17 & (new_n65_ | (~new_n57_ & ~x05)));
  ...
  assign new_n68_ = ~x00 & ~x18;
  assign z02 = (~x00 & ~x18) | (~x17 & (new_n70_ | (x08 & ~new_n77_ & x18)));
  ...
  assign new_n78_ = ~x07 & x11 & (x02 | x07 | new_n63_ | ~x11);
  assign z03 = z23 | (~new_n82_ & ~x09);
  assign z23 = new_n68_ | (new_n81_ & ~x05 & ~x07 & x08);
  ...
  assign z06 = ~x09 & (new_n106_ | (~x05 & (new_n108_ | (new_n94_ & ~x07))));
  assign new_n94_ = ~x17 & x18 & (new_n101_ | (~x21 & (~new_n95_ | new_n104_)));
  assign new_n95_ = ~new_n100_ & (x15 | (~new_n96_ & (~x08 | new_n99_ | x14)));
  assign new_n96_ = x06 & (new_n98_ | (new_n97_ & ~x02));
  assign new_n97_ = ~x08 & x11;
  assign new_n98_ = x08 & x10 & x12 & ~x13 & ~x14 & x16;
  assign new_n99_ = (x06 | ((~x02 | x10 | ~x13) & (~x10 | ~x12 | x13 | x16))) & (x10 | x13);
  assign new_n100_ = ~x02 & x08 & x11 & (x15 | (~x10 & ~x14));
  assign new_n101_ = ~x08 & ~x14 & new_n102_ & ~x15;
  assign new_n102_ = x21 & (new_n103_ | (~x02 & x06 & x11));
  assign new_n103_ = x04 & ~x06 & ~x12;
  assign new_n104_ = x04 & ~new_n105_ & ~x12;
  assign new_n105_ = (x02 | ~x08 | ~x11 | x14) & (x06 | x08 | x15);
  assign new_n106_ = x04 & ~x07 & x08 & ~x12 & new_n107_ & ~x15;
  assign new_n107_ = ~x17 & x18 & ~x21 & (x05 | (~x13 & ~x14));
  assign new_n108_ = x00 & x17 & ~x18 & (~x07 ^ ~x15);
  assign z07 = ~x17 & ~new_n110_ & x18;
  assign new_n110_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~new_n68_ & ~x20;
  assign z09 = (~x17 & ~new_n113_ & x18) | (~new_n121_ & ~x18);
  assign new_n113_ = (~new_n120_ | ~x05) & (x07 | (x05 ? ~new_n119_ : new_n114_));
  assign new_n114_ = (x21 | ((~new_n118_ | x11 | ~x15) & (x09 | new_n115_ | x15))) & (~new_n118_ | ~x09 | x11 | ~x15);
  assign new_n115_ = (new_n116_ | ~x04) & (~new_n117_ | ~x02) & (~new_n97_ | x02 | ~x06);
  ...
  assign new_n121_ = x00 & (x07 | x09 | x15 | (~new_n122_ & ~x17));
  assign new_n122_ = x04 & ~x05 & x12 & ~x14 & ~x21;
  assign z10 = (new_n126_ & x08) | (~x09 & (new_n124_ | (new_n125_ & ~x06)));
  assign new_n124_ = x00 & x17 & ~x18 & (~x05 | ~x07);
  assign new_n125_ = ~x07 & ~x08 & ~x17 & x18 & (x05 ^ x15);
  assign new_n126_ = ~x15 & ~x17 & x18 & (x05 ? x07 : (~x07 & x09));
  assign z11 = ~x18 & new_n128_ & ~x17;
  assign new_n128_ = ~x15 & ~x09 & x07 & ~x05 & x00 & x01;
  assign z12 = new_n68_ | (~new_n130_ & ~x09);
  assign new_n130_ = (x07 | ((x17 | ~new_n131_ | ~x18) & (~x17 | x18 | x05 | ~x15))) & (x05 | ~x07 | x15 | ~x17 | x18);
  assign new_n131_ = ~x21 & (new_n132_ | new_n137_ | (~x05 & (new_n104_ | ~new_n134_)));
  assign new_n132_ = ~new_n133_ & ~x04;
  assign new_n133_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n134_ = ~new_n100_ & (x15 | (~new_n135_ & ~new_n136_));
  ...
  assign z13 = ~x18 & (~x00 | (~x09 & x17 & (~x05 | ~x07)));
  assign z14 = (~new_n145_ & ~x18) | (~x17 & (new_n143_ | (x08 & ~new_n141_ & x18)));
  assign new_n141_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n63_ | new_n142_);
  assign new_n142_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n143_ = new_n144_ & ~x07 & ~x09 & x04 & ~x05;
  assign new_n144_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n145_ = ~new_n146_ & x00;
  assign new_n146_ = ~x05 & ~x09 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n148_ & ~x18;
  assign new_n148_ = x00 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = (~x00 & ~x18) | (x08 & ~x17 & x18 & (new_n150_ | new_n154_));
  assign new_n150_ = ~x05 & ((~x07 & ~new_n151_ & ~x15) | (x09 & x15 & (~x02 | x07)));
  assign new_n151_ = x09 ? x19 : (x14 | new_n152_ | x21);
  assign new_n152_ = (new_n60_ | (new_n153_ & (~x02 | ~x06))) & (~x12 | new_n153_ | (~x06 ^ x16));
  assign new_n153_ = x13 & (x02 | ~x11);
  assign new_n154_ = x05 & x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n156_ | (new_n66_ & new_n159_ & new_n67_ & ~x17));
  assign new_n156_ = ~x05 & (new_n108_ | (~x07 & new_n157_ & ~x08));
  assign new_n157_ = ~x15 & ~x17 & x18 & ~new_n158_ & (~x21 | (~x14 & x21));
  ...
  assign new_n165_ = x17 & ~x15 & ~x09 & ~x07 & x00 & ~x05;
  assign z20 = ~x07 & ~x17 & (new_n173_ | (~new_n167_ & ~x15));
  assign new_n167_ = (new_n168_ | ~x18) & (~new_n172_ | x18 | x21 | ~x12 | x14);
  assign new_n168_ = (x09 | ((~new_n169_ | ~x04) & (~new_n171_ | x05))) & (~x04 | ~new_n170_ | ~x05);
  assign new_n169_ = x08 & x10 & ~x12 & ~x14 & ~new_n153_ & ~x21;
  assign new_n170_ = x08 & ~new_n63_ & ~x12;
  assign new_n171_ = ~x06 & ~x08 & (~x14 | ~x21) & (x04 ^ x12);
  assign new_n172_ = ~x05 & ~x09 & x00 & x04;
  assign new_n173_ = new_n67_ & new_n159_ & x08 & ~x09 & ~x04 & x05;
  assign z21 = (~x17 & ~new_n175_ & x18) | (~x00 & ~x18);
  ...
  assign new_n191_ = ~new_n68_ & (~new_n192_ | x07 | ~x08 | ~x03 | x05);
  assign new_n192_ = ~x17 & x18 & x19 & x09 & ~x15;
  assign new_n193_ = ~x05 & x17 & ~x18 & (~x07 ^ ~x15);
  assign z28 = (~x17 & (new_n205_ | (~new_n195_ & x18))) | (~x18 & (new_n207_ | ~x00));
  assign new_n195_ = (~new_n202_ | x07) & (x05 | (~new_n196_ & ~new_n204_ & (~new_n199_ | x07)));
  ...
  assign new_n200_ = (~x15 | x19) & (~new_n103_ | x14 | x15 | ~x21);
