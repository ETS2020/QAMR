...
module FAU ( 
  ...
  assign new_n81_ = x16 & (x05 | x07 | x09 | ~new_n82_ | x14);
  assign new_n82_ = ~x15 & ~x17 & (new_n83_ | (~new_n85_ & x06) | (new_n87_ & ~x06));
  assign new_n83_ = ~new_n84_ & x02;
  assign new_n84_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n85_ = ~new_n86_ & (x02 | x08 | ~x11 | ~x16 | ~x21);
  assign new_n86_ = x12 & ~x13 & ~x21 & x08 & x10;
  assign new_n87_ = ~x08 & x21 & (x04 ? (~x12 & x16) : x12);
  ...
  assign new_n93_ = (x10 | ((~x02 | x06) & (x13 | (x02 & x12)))) & (~x06 | ~x12 | x13);
  ...
  assign z09 = new_n112_ | (x18 & (new_n104_ | ~x16));
  ...
  assign z17 = (~x16 & x18) | (~x09 & (new_n152_ | (~new_n149_ & ~x05)));
  ...
  assign new_n152_ = new_n153_ & new_n65_ & ~x17 & x18 & ~x21;
  ...
  assign z20 = (~x16 & x18) | (~x07 & ~new_n160_ & ~x17);
  assign new_n160_ = ~new_n166_ & (x15 | ((~new_n168_ | ~x04) & (new_n161_ | x09)));
  assign new_n161_ = (~new_n163_ | ~x04) & (x05 | ((~new_n165_ | ~x04) & (~new_n162_ | x06)));
  assign new_n162_ = ~x08 & x18 & ~new_n60_ & (x04 ^ x12);
  assign new_n163_ = x08 & x10 & new_n164_ & ~x12;
  assign new_n164_ = ~x14 & x18 & ~x21 & (~x13 | (~x02 & x11));
  assign new_n165_ = x12 & ~x14 & ~x21 & (~x16 | ~x18);
  assign new_n166_ = new_n167_ & new_n65_ & x18 & ~x21;
  ...
  assign new_n181_ = new_n118_ & x08 & ~x15 & ~x18;
  ...
  assign new_n187_ = ~x21 & (new_n122_ | new_n188_);
  ...
  assign z28 = (~new_n193_ & ~x17) | (~x09 & new_n205_ & x17);
  assign new_n193_ = (~new_n204_ | x05) & (~x16 | ~x18 | (~new_n202_ & (new_n194_ | x05)));
  assign new_n194_ = (new_n195_ | x02) & ~new_n201_ & (x07 | new_n197_ | x09);
