...
module FAU ( 
  ...
  assign z02 = (~x18 & ~x20) | (~x17 & ((~new_n70_ & ~x05) | (~new_n75_ & x18)));
  ...
  assign new_n121_ = ~x09 & ~x15 & ~x18 & x20 & (new_n122_ | x17);
  ...
  assign new_n153_ = (~x06 | x10 | ~x11) & (((x02 | ~x11) & x13) | (x06 ^ ~x16));
  ...
  assign z28 = (~x18 & (new_n208_ | ~x20)) | (~x17 & (new_n207_ | (~new_n196_ & x18)));
