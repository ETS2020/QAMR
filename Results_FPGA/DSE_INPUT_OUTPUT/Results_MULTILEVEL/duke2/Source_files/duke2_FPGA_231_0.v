...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n102_ | (~x07 & (new_n101_ | (new_n89_ & ~x17))));
  ...
  assign z12 = (~x17 & ~x18) | (~x09 & (new_n102_ | (~new_n121_ & ~x07)));
  assign new_n121_ = ~new_n101_ & (x17 | x21 | (new_n122_ & (new_n126_ | x04)));
  ...
  assign new_n147_ = x12 & ((~new_n148_ & ~x06) | (new_n85_ & x06 & x08 & x10));
  ...
  assign new_n152_ = ~x09 & ((x04 & new_n154_ & x08) | (new_n153_ & ~x05));
  assign new_n153_ = ~x06 & ~x08 & ~new_n87_ & (~x14 | ~x21);
  assign new_n154_ = x10 & ~x12 & ~x14 & ~new_n155_ & ~x21;
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n76_ | new_n119_);
