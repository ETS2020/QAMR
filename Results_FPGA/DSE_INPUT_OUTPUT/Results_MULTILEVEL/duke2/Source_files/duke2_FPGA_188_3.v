...
module FAU ( 
  ...
  assign z09 = (~new_n115_ & x18) | (~x07 & ~x09 & ~new_n124_ & ~x15);
  assign new_n115_ = (x07 | (x05 ? ~new_n123_ : new_n116_)) & ~x17 & (~new_n122_ | ~x05);
  ...
  assign new_n124_ = ~x17 & (~new_n125_ | x14 | x18 | x21);
  assign new_n125_ = x04 & ~x05 & x12;
  assign z10 = (~new_n127_ & x18) | (~x09 & x17 & (~x05 | ~x07));
  assign new_n127_ = ~new_n128_ & ~x17 & (~new_n129_ | x05 | x06 | x07);
  assign new_n128_ = ~x15 & ((x05 & ((x07 & x08) | (~x08 & ~x09 & ~x06 & ~x07))) | (~x05 & ~x07 & x08 & x09));
  assign new_n129_ = ~x08 & ~x09 & x15;
  assign z11 = (x17 & x18) | (new_n109_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  ...
  assign new_n139_ = x08 & (x07 ? (~new_n112_ & ~x19) : new_n140_);
  ...
  assign new_n159_ = (~x02 | (~new_n86_ & ~new_n162_)) & (new_n160_ | ~x12);
  assign new_n160_ = (x06 | (~new_n161_ & (~new_n91_ | ~x08 | ~x10))) & (~new_n89_ | ~x06 | ~x08 | ~x10);
  assign new_n161_ = ~x04 & ~x08 & ~x17 & x21;
  ...
  assign new_n177_ = (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  ...
  assign new_n184_ = new_n109_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  assign z25 = x18 & (x17 | (~x05 & ~x07 & (new_n81_ | new_n129_)));
  assign z26 = ~x20 & (x14 | x21) & (~x17 | ~x18);
  assign z27 = new_n188_ | (new_n193_ & new_n65_ & x03 & ~x05);
