...
module FAU ( 
  ...
  assign z09 = (~new_n111_ & ~x17) | (~x07 & ~x09 & ~x15 & ~x18);
  assign new_n111_ = (x07 | (x05 ? ~new_n118_ : new_n112_)) & x18 & (~new_n119_ | ~x05);
  ...
  assign new_n128_ = x08 & ~x12 & ~x15 & (new_n102_ | x05);
  ...
  assign new_n144_ = (x07 | ((x08 | ~new_n145_ | x15) & (~new_n104_ | ~x00 | ~x15))) & (~new_n104_ | ~x07 | x15);
  ...
  assign new_n151_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  ...
  assign new_n157_ = x08 & x10 & ~x12 & ~x14 & ~new_n140_ & ~x21;
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n76_ | new_n123_);
