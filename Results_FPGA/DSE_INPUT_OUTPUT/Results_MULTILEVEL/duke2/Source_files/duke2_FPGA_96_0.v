...
module FAU ( 
  ...
  assign new_n85_ = ~x17 & x18 & (new_n86_ | (~new_n88_ & x06) | (~new_n90_ & ~x06));
  ...
  assign z06 = ~x09 & (new_n109_ | (~new_n93_ & ~x07));
  assign new_n93_ = ~new_n107_ & (x17 | ~x18 | (~new_n104_ & (new_n94_ | x05)));
  ...
  assign new_n105_ = ~x12 & ~x15 & (new_n106_ | x05) & ~x21;
  assign new_n106_ = ~x13 & ~x14;
  assign new_n107_ = new_n108_ & x00 & ~x05 & x15;
  assign new_n108_ = x17 & ~x18 & x20;
  ...
  assign z09 = (~x17 & ~new_n114_ & x18) | (~new_n123_ & ~x18);
  ...
  assign new_n123_ = x20 & (x07 | x09 | new_n124_ | x15);
  ...
  assign z11 = x20 & new_n129_ & ~x18;
  assign new_n129_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n109_ | (~x07 & (new_n107_ | (new_n131_ & ~x17))));
  assign new_n131_ = x18 & ~x21 & ((~new_n135_ & ~x04) | new_n132_ | (new_n134_ & x04));
  assign new_n132_ = ~x05 & (new_n95_ | new_n103_ | (~new_n133_ & ~x15));
  assign new_n133_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n106_ | ~x08 | x10);
  assign new_n134_ = x08 & ~x12 & (new_n106_ | x05) & ~x15;
  assign new_n135_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign z14 = (~new_n141_ & ~x18) | (~x17 & (new_n139_ | (x08 & ~new_n137_ & x18)));
  assign new_n137_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n64_ | new_n138_);
  assign new_n138_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n139_ = new_n140_ & ~x07 & ~x09 & x04 & ~x05;
  assign new_n140_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n141_ = ~new_n142_ & x20;
  assign new_n142_ = ~x05 & ~x09 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~new_n144_ & ~x18;
  assign new_n144_ = x20 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = (~x18 & ~x20) | (x08 & ~x17 & ~new_n146_ & x18);
  assign new_n146_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n147_;
  assign new_n147_ = (x07 | x15 | (x09 ? x19 : ~new_n148_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n148_ = ~x14 & ~x21 & (new_n150_ | (~new_n61_ & ~new_n149_));
  assign new_n149_ = (~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11);
  assign new_n150_ = x12 & (x06 ^ x16) & (~x13 | (~x02 & x11));
  assign z17 = ~x09 & (new_n155_ | (~new_n152_ & ~x05));
  assign new_n152_ = (x07 | ((x08 | ~new_n153_ | x15) & (~new_n108_ | ~x00 | ~x15))) & (~new_n108_ | ~x07 | x15);
  assign new_n153_ = ~x17 & x18 & ~new_n154_ & (~x14 | ~x21);
  assign new_n154_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n155_ = new_n67_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = new_n68_ | (~x05 & ~x07 & ~x09 & new_n157_ & ~x17);
  assign new_n157_ = x18 & ((~x14 & ~new_n158_ & ~x15) | (~x08 & x15 & x19));
  assign new_n158_ = ~new_n86_ & (~x12 | (~new_n160_ & (new_n159_ | x06)));
  ...
  assign z20 = ~x07 & ~x17 & (new_n170_ | (~new_n163_ & ~x15));
  assign new_n163_ = (new_n164_ | ~x18) & (~new_n169_ | ~x20 | x21 | x14 | x18);
  assign new_n164_ = (x09 | ((~new_n165_ | ~x04) & (~new_n168_ | x05))) & (~x04 | ~new_n167_ | ~x05);
  assign new_n165_ = x08 & new_n166_ & x10;
  assign new_n166_ = ~x12 & ~x14 & ~x21 & (~x13 | (~x02 & x11));
  assign new_n167_ = x08 & ~new_n64_ & ~x12;
  assign new_n168_ = ~x06 & ~x08 & (~x14 | ~x21) & (x04 ^ x12);
  assign new_n169_ = x04 & ~x05 & ~x09 & x12;
  assign new_n170_ = new_n171_ & x08 & ~x09 & ~x04 & x05;
  assign new_n171_ = x18 & ~x21 & ~x11 & x15;
  assign z21 = (~x18 & ~x20) | (~x17 & ~new_n173_ & x18);
  ...
  assign z24 = ~x09 & ~new_n178_ & ~x17;
  assign new_n178_ = ((~new_n179_ & ~new_n182_) | x07) & (~new_n183_ | ~x01 | x05 | ~x07);
  assign new_n179_ = ~x21 & ((x08 & new_n181_ & x15) | (x04 & ~new_n180_ & ~x15));
  assign new_n180_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | ~x20);
  assign new_n181_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n182_ = ~x05 & ~x08 & ~x15 & x18;
  assign new_n183_ = x08 & ~x15 & ~x18 & x20;
  assign z25 = (~x18 & ~x20) | (~x05 & ~x07 & ~x17 & ~new_n185_ & x18);
  ...
  assign new_n189_ = ~x21 & (new_n190_ | (~new_n135_ & ~x04));
  assign new_n190_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n191_ = ~new_n68_ & (~new_n192_ | ~x03 | x05 | x07 | ~x08);
  assign new_n192_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n193_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n195_ & ~x17) | (~x18 & (~x20 | (~x09 & ~new_n208_ & x17)));
