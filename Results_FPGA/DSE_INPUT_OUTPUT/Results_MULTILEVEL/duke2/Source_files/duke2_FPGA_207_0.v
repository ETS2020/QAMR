...
module FAU ( 
  ...
  assign z06 = new_n78_ | (~x09 & ((~new_n89_ & ~x07) | (new_n106_ & ~x05 & x07)));
  ...
  assign z09 = (~x17 & ~new_n112_ & x18) | (~x15 & x17 & ~x18 & ~x07 & ~x09);
  ...
  assign new_n146_ = ~x17 & ~new_n147_ & (~x21 | (~x14 & x21));
  ...
  assign new_n161_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | ~x18))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign new_n162_ = x18 & (x05 | ~x07 | ~x08 | x09 | ~x15 | ~x18);
  assign z22 = ~x17 & ~new_n164_ & x18;
  assign new_n164_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
