...
module FAU ( 
  ...
  assign z01 = ~x17 & (new_n57_ | (new_n65_ & new_n64_ & ~x07 & x08));
  assign new_n57_ = ~x05 & (new_n63_ | (~x07 & ~new_n58_ & x18));
  ...
  assign new_n77_ = (x05 | x07 | ~x08 | ~x09 | x15) & (x09 | ((~x05 | x15 | (~x07 ^ ~x08)) & (x05 | ~x07 | ~x08 | ~x15)));
  assign z04 = ~x14 & ~z15 & ~x20;
  assign z15 = x17 & ~x18;
  assign z05 = z15 | (~x05 & ~x07 & ~x09 & new_n81_ & ~x14);
  ...
  assign z17 = (x17 & ~x18) | (~x07 & ~x09 & ~x17 & (new_n141_ | new_n143_) & x18);
  ...
  assign new_n155_ = new_n156_ & new_n64_ & x08 & ~x09;
  assign new_n156_ = x18 & ~x21 & ~x11 & x15;
  ...
  assign z28 = ~x17 & ((new_n187_ & ~x05) | (x18 & (new_n185_ | (~new_n178_ & ~x05))));
