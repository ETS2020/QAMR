...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n70_, new_n71_, new_n72_, new_n75_, new_n76_, new_n77_, new_n81_,
  ...
  assign z23 = ~x17 & (~x18 | (new_n75_ & new_n76_));
  ...
  assign z06 = z11 | (~x09 & (new_n105_ | (~x07 & (new_n90_ | new_n107_))));
  assign new_n90_ = ~x17 & (new_n102_ | (~x05 & (new_n99_ | (~new_n91_ & ~x21))));
  assign new_n91_ = ~new_n92_ & ~new_n98_ & (x15 | (~new_n96_ & (new_n94_ | ~x06)));
  assign new_n92_ = x04 & ~new_n93_ & ~x12;
  assign new_n93_ = (x06 | x08 | x15) & (x02 | ~x08 | ~x11 | x14);
  assign new_n94_ = (~new_n95_ | ~new_n85_ | ~x08) & (x02 | x08 | ~x11);
  assign new_n95_ = ~x13 & ~x14 & x16 & x18;
  ...
  assign new_n107_ = x00 & ~x05 & x15 & ~x18;
  ...
  assign new_n123_ = ~x15 & ((x05 & ((x07 & x08) | (~x06 & ~x07 & ~x08 & ~x09))) | (~x05 & ~x07 & x08 & x09));
  assign new_n124_ = ~x08 & ~x09 & x15;
  assign z12 = z11 | ((new_n126_ | new_n105_) & ~x09);
  assign new_n126_ = ~x07 & (new_n107_ | (~x17 & ~x21 & (~new_n127_ | new_n130_)));
  assign new_n127_ = ~new_n129_ & (x05 | (~new_n92_ & ~new_n98_ & (new_n128_ | x15)));
  ...
  assign new_n145_ = (new_n146_ | x05) & (~new_n150_ | x07 | ~x08 | x04 | ~x05);
  assign new_n146_ = (x07 | ((x08 | ~new_n147_ | x15) & (~new_n149_ | ~x00 | ~x15))) & (~new_n149_ | ~x07 | x15);
  ...
  assign new_n162_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n163_ = x08 & ~x09 & x15;
  assign z22 = ~x17 & (new_n165_ | ~x18 | (new_n106_ & x08 & x15));
  assign new_n165_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  ...
  assign z25 = ~x17 & (~x18 | (~x05 & (new_n76_ | new_n124_) & ~x07));
  ...
  assign new_n173_ = (new_n130_ | new_n174_) & ~x21;
  assign new_n174_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n175_ = new_n75_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n176_ = ~x05 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = new_n187_ | (~x17 & (~new_n185_ | (~new_n178_ & ~x05)));
