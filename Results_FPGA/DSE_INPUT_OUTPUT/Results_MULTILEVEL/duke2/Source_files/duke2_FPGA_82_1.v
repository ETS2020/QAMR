...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n62_,
    ...
    new_n96_, new_n97_, new_n98_, new_n101_, new_n103_, new_n105_,
  ...
  assign z12 = (~x15 & x18) | (~x09 & (new_n89_ | (new_n92_ & ~x15 & x17)));
  assign new_n89_ = ~x07 & ((new_n90_ & new_n91_) | ((new_n74_ | new_n75_) & ~x05));
  ...
  assign z17 = z23 | (~x09 & (new_n103_ | (new_n59_ & new_n91_)));
  assign new_n103_ = ~x05 & x17 & ((x07 & ~x15) | (x00 & ~x07 & x15 & ~x18));
  assign z18 = x18 & (new_n105_ | ~x15);
  assign new_n105_ = ~x09 & ~x17 & x19 & ~x05 & ~x07 & ~x08;
  assign z19 = ~x18 & x17 & ~x15 & new_n55_ & ~x09;
  assign z20 = z23 | (~x07 & ~x09 & ~x17 & ~new_n108_ & ~x21);
  assign new_n108_ = (~new_n109_ | x04 | ~x05) & (~x04 | x05 | ~x12 | x14 | x15);
  assign new_n109_ = x08 & ~x11 & x18;
  assign z21 = x18 & (~x15 | (new_n111_ & ~x05));
  assign new_n111_ = ~x09 & ~x17 & ((~x06 & ~x07 & ~x08) | (x07 & x08 & x15));
  assign z22 = ~x05 & new_n113_ & x15;
  assign new_n113_ = ~x17 & x18 & ((x07 & x08) | (~x08 & ~x09 & x06 & ~x07));
  assign z24 = ~x09 & ~x17 & (new_n119_ | (~x07 & ~new_n115_ & ~x21));
  assign new_n115_ = (x05 | (~new_n116_ & ~new_n117_)) & (~new_n90_ | ~new_n118_);
  assign new_n116_ = ~x02 & x08 & x11 & x15 & x18;
  assign new_n117_ = x04 & x12 & ~x14 & ~x15 & ~x18;
  assign new_n118_ = ~x11 & x15 & x18;
  assign new_n119_ = new_n92_ & x01 & x08 & ~x15 & ~x18;
  assign z25 = x18 & ~x17 & x15 & ~x09 & new_n55_ & ~x08;
  assign z26 = ~x20 & ~z23 & (x14 | x21);
  assign z27 = ~x09 & (new_n123_ | (~x05 & (new_n124_ | new_n125_)));
  assign new_n123_ = new_n59_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign new_n124_ = x07 & ((~x15 & x17 & ~x18) | (x08 & x15 & ~x17 & x18 & x19));
  assign new_n125_ = x00 & ~x07 & x15 & x17 & ~x18;
  assign z28 = (new_n131_ & x05 & ~x07) | (x15 & ((~new_n127_ & ~x05) | (new_n130_ & ~x07)));
