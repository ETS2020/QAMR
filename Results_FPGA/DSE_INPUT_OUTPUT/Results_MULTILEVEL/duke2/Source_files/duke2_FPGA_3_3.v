...
module FAU ( 
  ...
  assign z03 = (~new_n79_ & ~x09) | (new_n78_ & x09 & ~x15 & ~x17 & x18);
  ...
  assign z06 = new_n81_ | (~x09 & ((~new_n92_ & ~x07) | (new_n104_ & ~x05 & x07)));
  assign new_n92_ = (~x18 | (~new_n101_ & (new_n93_ | x15))) & (~new_n103_ | ~x15 | ~x17);
  ...
  assign z09 = (~new_n110_ & x18) | (~x07 & ~x09 & ~new_n119_ & ~x15);
  ...
  assign new_n119_ = ~x17 & (~x04 | x05 | ~x12 | ~new_n120_ | x14);
  assign new_n120_ = ~x18 & ~x21;
  assign z10 = (~new_n122_ & x18) | (~x09 & x17 & (~x05 | ~x07));
  assign new_n122_ = (new_n123_ | x15) & ~x17 & (~new_n124_ | x08 | x09 | ~x15);
  assign new_n123_ = (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09);
  assign new_n124_ = ~x05 & ~x06 & ~x07;
  assign z11 = (x17 & x18) | (new_n126_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  assign new_n126_ = ~x05 & x07;
  assign z12 = (x17 & x18) | (~x09 & (new_n128_ | (new_n126_ & ~x15 & x17 & ~x18)));
  assign new_n128_ = ~x07 & (new_n138_ | (x18 & ~x21 & (~new_n129_ | new_n136_)));
  ...
  assign new_n138_ = new_n103_ & x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z14 = (x18 & (new_n141_ | x17)) | (~x05 & ~new_n144_ & ~x09);
  assign new_n141_ = x08 & (x07 ? (~new_n107_ & ~x19) : new_n142_);
  assign new_n142_ = ~new_n143_ & (x09 | ~x21);
  assign new_n143_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n144_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n145_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n145_ = new_n146_ & new_n120_ & ~x15 & ~x17;
  assign new_n146_ = x12 & ~x14 & x04 & ~x07;
  ...
  assign z17 = new_n81_ | (~new_n155_ & ~x09);
  assign new_n155_ = (new_n156_ | x05) & (~new_n159_ | ~new_n65_ | x04 | ~x05);
  assign new_n156_ = x07 ? (x15 | ~x17) : ((x08 | ~new_n157_ | x15) & (~x00 | ~x15 | ~x17));
  assign new_n157_ = x18 & ~new_n158_ & (~x21 | (~x14 & x21));
  assign new_n158_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n159_ = x18 & ~x21 & ~x11 & x15;
  assign z18 = x18 & (x17 | (~x05 & ~x07 & ~new_n161_ & ~x09));
  assign new_n161_ = (x14 | x15 | (~new_n84_ & ~new_n162_)) & (x08 | ~x15 | ~x19);
  assign new_n162_ = x12 & ((~new_n163_ & ~x06) | (new_n88_ & x06 & x08 & x10));
  assign new_n163_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = x17 & (x18 | (new_n56_ & ~x09 & ~x15));
  assign z20 = ~x07 & ~new_n166_ & ~x17;
  assign new_n166_ = ~new_n167_ & (~new_n159_ | ~x08 | x09 | x04 | ~x05);
  ...
  assign new_n171_ = x04 & ~x05 & ~x09 & new_n120_ & x12 & ~x14;
  assign new_n172_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign z21 = x18 & (~new_n175_ | (~new_n174_ & ~x07));
  assign new_n174_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15 | x17))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  ...
  assign z28 = new_n205_ | (x18 & (~new_n203_ | (~x05 & (~new_n195_ | new_n200_))));
