...
module FAU ( 
  ...
  assign z06 = z11 | (~x09 & ((~new_n89_ & ~x07) | (new_n106_ & ~x05 & x07)));
  assign new_n89_ = ~new_n104_ & (x17 | (~new_n102_ & ((~new_n90_ & ~new_n99_) | x05)));
  ...
  assign new_n93_ = x06 & ((new_n84_ & new_n95_) | (new_n94_ & ~x02));
  ...
  assign new_n104_ = new_n105_ & x15 & ~x18;
  ...
  assign new_n113_ = (new_n114_ | ~x04) & (~new_n115_ | ~x02) & (~new_n94_ | x02 | ~x06);
  ...
  assign z12 = ~x09 & ((~new_n124_ & ~x07) | (new_n132_ & ~x05 & x07));
  assign new_n124_ = (x17 | ~x18 | new_n125_ | x21) & (~new_n105_ | ~x15 | ~x17 | x18);
  assign new_n125_ = ~new_n126_ & ~new_n130_ & (x05 | (~new_n91_ & ~new_n128_ & ~new_n98_));
  ...
  assign z25 = ~x17 & (~x18 | (~x05 & (new_n76_ | new_n122_) & ~x07));
  ...
  assign z28 = (~x17 & ~new_n179_ & x18) | (~x09 & x17 & ~new_n189_ & ~x18);
  assign new_n179_ = ~new_n187_ & (x05 | (new_n180_ & (new_n185_ | x02)));
  assign new_n180_ = (~new_n184_ | ~x08) & (x07 | x09 | (x08 ? ~new_n182_ : new_n181_));
  assign new_n181_ = (~x15 | x19) & (~new_n101_ | x14 | x15 | ~x21);
