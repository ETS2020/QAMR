...
module FAU ( 
  ...
  assign new_n76_ = (x05 | x07 | ~x08 | ~x09 | x15) & (x09 | ((~x05 | x15 | (x07 ^ x08)) & (~x08 | ~x15 | x05 | ~x07)));
  assign z04 = ~x14 & ~x20 & (~x17 | x18);
  assign z05 = new_n79_ | (x17 & ~x18);
  assign new_n79_ = ~x05 & ~x07 & ~x09 & ~x14 & new_n80_ & ~x15;
  assign new_n80_ = ~x17 & x18 & (new_n81_ | (~new_n85_ & ~x06) | (~new_n83_ & x06));
  ...
  assign new_n114_ = new_n54_ & new_n55_ & ~x15 & ~x18 & ~x21;
  ...
  assign z17 = ~x07 & ~x09 & ~x17 & x18 & (new_n140_ | new_n142_);
  ...
  assign z24 = (x17 & ~x18) | (~x09 & (new_n168_ | (~new_n164_ & ~x07)));
  ...
  assign new_n183_ = (~x15 | x19) & (~new_n95_ | x14 | x15 | ~x21);
  ...
  assign new_n187_ = x07 & ~x09 & ~new_n68_ & x15;
  assign z13 = 1'b0;
  assign z15 = 1'b0;
  assign z19 = 1'b0;
endmodule
