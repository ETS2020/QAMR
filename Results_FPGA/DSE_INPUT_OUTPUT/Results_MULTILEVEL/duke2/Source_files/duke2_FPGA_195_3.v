...
module FAU ( 
  ...
  assign new_n87_ = (x12 | ~x21 | ~x04 | x08) & (~new_n88_ | ~x08 | ~x10 | ~x12);
  assign new_n88_ = ~x13 & ~x16 & ~x21;
  assign new_n89_ = ~x08 & x12 & x21;
  assign new_n90_ = (x11 | ~x21 | ~x06 | x08) & (~new_n91_ | x06 | ~x08 | x10);
  ...
  assign z12 = ~x09 & (new_n107_ | (~x07 & (new_n106_ | (new_n128_ & ~x17))));
  assign new_n128_ = x18 & ~x21 & ((~new_n132_ & ~x04) | new_n129_ | (new_n131_ & x04));
  assign new_n129_ = ~x05 & (new_n95_ | new_n103_ | (~new_n130_ & ~x15));
  assign new_n130_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n105_ | ~x08 | x10);
  assign new_n131_ = x08 & ~x12 & ~x15 & (new_n105_ | x05);
  assign new_n132_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign z14 = (new_n139_ & ~x05) | (~x17 & (new_n134_ | (new_n136_ & x08)));
  assign new_n134_ = new_n135_ & new_n55_ & ~x07 & ~x09;
  assign new_n135_ = x12 & ~x14 & new_n56_ & ~x15;
  ...
  assign z18 = x18 & (x17 | (~x05 & new_n155_ & ~x07));
  assign new_n155_ = ~x09 & ((~x14 & ~new_n156_ & ~x15) | (~x08 & x15 & x19));
  assign new_n156_ = (new_n158_ | ~x02) & (~x12 | (~new_n159_ & (new_n157_ | x06)));
  assign new_n157_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  assign new_n158_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n159_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = x17 & (x18 | (new_n79_ & ~x09 & ~x15));
  assign z20 = ~x07 & ~new_n162_ & ~x17;
  assign new_n162_ = ~new_n163_ & (~new_n153_ | x04 | ~x05 | ~x08 | x09);
  ...
  assign new_n167_ = x04 & ~x05 & ~x09 & new_n56_ & x12 & ~x14;
  ...
  assign new_n173_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
