...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n123_, new_n125_, new_n128_, new_n130_, new_n131_, new_n132_,
  ...
  assign z00 = (~x09 & ~new_n54_ & ~x18) | (x03 & x18);
  ...
  assign new_n66_ = x03 & x18;
  assign z02 = ~x17 & ((~new_n68_ & ~x15) | (~x03 & x15 & ~new_n74_ & x18));
  assign new_n68_ = (x09 | ((new_n69_ | x05) & (x03 | ~new_n72_ | ~x05))) & (~new_n73_ | x03);
  assign new_n69_ = (~x01 | ~x07 | new_n70_ | x18) & (x03 | x07 | new_n71_ | ~x18);
  ...
  assign z03 = (~new_n78_ & ~x09) | (x18 & (new_n79_ | x03));
  ...
  assign z05 = ~x03 & ~x05 & ~x07 & ~x09 & new_n82_ & ~x14;
  ...
  assign new_n86_ = x11 & x21 & ~x02 & ~x08;
  assign new_n87_ = ~x13 & x16 & ~x21;
  assign new_n88_ = ~x06 & (new_n89_ | (~x08 & x21 & (~x04 ^ ~x12)));
  assign new_n89_ = x08 & x10 & x12 & ~x13 & ~x16 & ~x21;
  assign z06 = new_n66_ | (~x09 & (new_n109_ | (~x07 & (new_n91_ | new_n107_))));
  assign new_n91_ = ~x17 & x18 & (new_n105_ | (~x05 & (new_n92_ | new_n102_)));
  assign new_n92_ = ~x21 & (new_n93_ | new_n101_ | (~x15 & (new_n95_ | new_n99_)));
  assign new_n93_ = x04 & ~new_n94_ & ~x12;
  assign new_n94_ = (x02 | ~x08 | ~x11 | x14) & (x06 | x08 | x15);
  assign new_n95_ = x06 & ((new_n96_ & ~x02) | (new_n98_ & new_n97_ & ~x03));
  assign new_n96_ = ~x08 & x11;
  assign new_n97_ = x08 & x10;
  assign new_n98_ = x12 & ~x13 & ~x14 & x16;
  assign new_n99_ = x08 & ~x14 & ((~x10 & ~x13) | (new_n100_ & ~x03));
  assign new_n100_ = ~x06 & ((x02 & ~x10 & x13) | (x10 & x12 & ~x13 & ~x16));
  assign new_n101_ = ~x02 & x08 & x11 & (x15 | (~x10 & ~x14));
  assign new_n102_ = ~x08 & new_n103_ & ~x14;
  assign new_n103_ = ~x15 & (new_n104_ | (~x02 & x06 & x11));
  assign new_n104_ = x04 & ~x06 & ~x12;
  assign new_n105_ = x04 & x08 & ~x12 & ~x15 & ~new_n106_ & ~x21;
  assign new_n106_ = ~x05 & (x13 | x14);
  assign new_n107_ = x00 & ~x05 & new_n108_ & x15;
  assign new_n108_ = x17 & ~x18;
  assign new_n109_ = ~x05 & x07 & new_n108_ & ~x15;
  assign z07 = ~x03 & ~x17 & ~new_n111_ & x18;
  assign new_n111_ = (x09 | (~x07 ^ ~x08) | (x05 ^ ~x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~new_n66_ & ~x20;
  assign z09 = new_n122_ | (~x03 & new_n114_ & ~x17);
  assign new_n114_ = x18 & ((new_n121_ & x05) | (~x07 & (x05 ? new_n120_ : ~new_n115_)));
  assign new_n115_ = (x21 | ((x09 | new_n116_ | x15) & (~new_n119_ | x11 | ~x15))) & (~new_n119_ | ~x09 | x11 | ~x15);
  assign new_n116_ = (new_n117_ | ~x04) & (~new_n118_ | ~x02) & (~new_n96_ | x02 | ~x06);
  ...
  assign new_n122_ = ~x07 & ~x09 & ~x15 & ~x18 & (new_n123_ | x17);
  assign new_n123_ = x12 & ~x14 & ~x21 & x04 & ~x05;
  assign z10 = z13 | (x18 & (x03 | (~new_n125_ & ~x17)));
  assign new_n125_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = new_n66_ | (new_n128_ & x01 & ~x05 & x07);
  assign new_n128_ = ~x17 & ~x18 & ~x09 & ~x15;
  assign z12 = new_n66_ | (~x09 & (new_n109_ | (~new_n130_ & ~x07)));
  assign new_n130_ = ~new_n107_ & (x17 | ~x18 | (new_n131_ & ~new_n135_) | x21);
  assign new_n131_ = (~new_n134_ | ~x04) & (x05 | (~new_n93_ & ~new_n132_ & ~new_n101_));
  assign new_n132_ = ~x15 & (new_n133_ | (x06 & ~x08 & (~x02 ^ ~x11)));
  assign new_n133_ = ~x13 & ~x14 & x08 & ~x10;
  assign new_n134_ = x08 & ~x12 & ~new_n106_ & ~x15;
  ...
  assign z15 = new_n66_ | (x05 & ~x07 & ~x09 & new_n108_ & ~x15);
  ...
  assign new_n149_ = (~new_n151_ | ~x12) & (new_n150_ | (x10 & (~x04 | x12)));
  assign new_n150_ = (~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11);
  assign new_n151_ = (~x06 ^ ~x16) & (~x13 | (~x02 & x11));
  assign new_n152_ = x05 & x09 & ~x15 & (x07 | ~x12);
  assign z17 = new_n66_ | (~x09 & (new_n157_ | (~new_n154_ & ~x05)));
  assign new_n154_ = (x07 | ((x08 | ~new_n155_ | x15) & (~new_n108_ | ~x00 | ~x15))) & (~new_n108_ | ~x07 | x15);
  ...
  assign z18 = x18 & (x03 | (~x05 & ~x07 & new_n159_ & ~x09));
  assign new_n159_ = ~x17 & ((~x14 & ~new_n160_ & ~x15) | (~x08 & x15 & x19));
  assign new_n160_ = ~new_n83_ & (~x12 | ((new_n161_ | x06) & (~new_n87_ | ~new_n97_ | ~x06)));
  assign new_n161_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = new_n66_ | (~x05 & ~x07 & ~x09 & new_n108_ & ~x15);
  assign z20 = ~x07 & ~x17 & (new_n171_ | (~x03 & ~new_n164_ & x18));
  assign new_n164_ = (new_n165_ | x15) & (~new_n170_ | x09 | x11 | ~x15 | x21);
  assign new_n165_ = (x09 | ((~new_n166_ | ~x04) & (~new_n168_ | x05))) & (~x04 | ~new_n169_ | ~x05);
  assign new_n166_ = x08 & new_n167_ & x10;
  assign new_n167_ = ~x12 & ~x14 & ~x21 & (~x13 | (~x02 & x11));
  assign new_n168_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n169_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n170_ = ~x04 & x05 & x08;
  assign new_n171_ = new_n172_ & x04 & ~x05 & ~x09 & x12;
  assign new_n172_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign z21 = x18 & (x03 | (~new_n174_ & ~x17));
  assign new_n174_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = x18 & (x03 | (~new_n176_ & ~x17));
  assign new_n176_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)))));
  assign z23 = x18 & new_n178_ & ~x17;
  assign new_n178_ = ~x15 & x09 & x08 & ~x07 & ~x03 & ~x05;
  assign z24 = ~x09 & ~x17 & (new_n180_ | new_n185_);
  assign new_n180_ = ~x07 & ((~new_n181_ & ~x21) | (new_n184_ & ~x03 & ~x05));
  assign new_n181_ = (x03 | ~x08 | ~new_n183_ | ~x15) & (~x04 | new_n182_ | x15);
  assign new_n182_ = (x03 | ~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x05 | ~x12);
  assign new_n183_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n184_ = ~x08 & ~x15 & x18;
  ...
  assign z27 = (x03 & x18) | (~x09 & (new_n193_ | (~x17 & ~new_n190_ & x18)));
  ...
  assign z28 = ~new_n205_ | (~x17 & ((new_n207_ & ~x05) | (~new_n195_ & x18)));
  assign new_n195_ = (x05 | (~new_n196_ & ~new_n204_ & (~new_n199_ | x07))) & (~new_n202_ | x07);
  assign new_n196_ = ~new_n197_ & ~x02;
  assign new_n197_ = (~x08 | ~x15) & (~new_n198_ | ~x11 | x14 | x15 | ~x21);
  assign new_n198_ = ~x08 & ~x09 & x06 & ~x07;
  assign new_n199_ = ~x09 & (x08 ? (x10 & new_n201_ & x12) : ~new_n200_);
  assign new_n200_ = (~x15 | x19) & (~new_n104_ | x14 | x15 | ~x21);
  ...
  assign new_n204_ = x08 & x15 & (x07 | ~x11);
  assign new_n205_ = (~x03 | ~x18) & (x09 | ~x17 | new_n206_ | x18);
