...
module FAU ( 
  ...
  assign new_n55_ = x17 & ((~x00 & ((~x07 & x20) | (~x05 & x15 & ~x20))) | (x05 & (~x07 | ~x15)) | (~x07 & ~x15) | (~x05 & x07 & x15));
  ...
  assign new_n80_ = x18 & x20 & ~x15 & ~x17;
  ...
  assign z09 = new_n117_ | (x18 & ((~new_n109_ & ~x17) | ~x20));
  assign new_n109_ = (x15 | (~new_n116_ & (new_n110_ | x09))) & (~new_n115_ | x07);
  assign new_n110_ = (~x05 | ~x08 | ~x21) & (x07 | (x05 ? (x08 | x19) : (new_n111_ | x21)));
  ...
  assign new_n142_ = (~x18 | x20) & (x05 | x09 | new_n143_ | x18);
  assign new_n143_ = (~x15 | (~x07 & ~x17)) & (~x07 | (x01 & ~x17));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x18 & (~x20 | (x08 & ~x17 & (new_n146_ | new_n151_)));
  ...
  assign z17 = ~x09 & (new_n153_ | (new_n157_ & new_n158_ & x15 & ~x17));
  assign new_n153_ = ~x05 & ((~x07 & (new_n154_ | (new_n104_ & x00 & x15))) | (new_n104_ & x07 & ~x15));
  assign new_n154_ = ~x08 & ~x15 & ~x17 & x18 & new_n155_ & x20;
  assign new_n155_ = ~new_n156_ & (~x14 | ~x21);
  assign new_n156_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n157_ = ~x04 & x05 & ~x07 & x08 & ~x11;
  ...
  assign z19 = (x18 & ~x20) | (new_n165_ & ~x15 & x17 & ~x18);
  ...
  assign new_n174_ = new_n175_ & new_n158_ & ~x11 & x15;
  ...
  assign z22 = x18 & (~x20 | (~new_n179_ & ~x17));
  assign new_n179_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = x20 & new_n181_ & x18;
  assign new_n181_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n187_ | (~new_n183_ & ~x07));
  assign new_n183_ = ~new_n184_ & (x05 | x08 | x15 | ~x18 | ~x20);
  assign new_n184_ = ~x21 & ((x04 & ~new_n185_ & ~x15) | (x08 & new_n186_ & x15));
  assign new_n185_ = (x14 | x18 | x05 | ~x12) & (~x05 | ~x08 | x12 | ~x18 | ~x20);
  assign new_n186_ = x18 & x20 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n187_ = x08 & ~x15 & ~x18 & x01 & ~x05 & x07;
  assign z25 = ~x05 & new_n189_ & ~x07;
  assign new_n189_ = ~x17 & x18 & x20 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  ...
  assign new_n193_ = ~x21 & (new_n127_ | new_n194_);
  assign new_n194_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n195_ = x20 & (~new_n196_ | ~x03 | x05 | x07 | ~x08);
  assign new_n196_ = x09 & ~x15 & ~x17 & x19;
  assign new_n197_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n209_ | (new_n199_ & x18))) | (~x09 & x17 & ~new_n211_ & ~x18);
  assign new_n199_ = x20 & (new_n207_ | (~x05 & (~new_n200_ | (~new_n205_ & ~x02))));
