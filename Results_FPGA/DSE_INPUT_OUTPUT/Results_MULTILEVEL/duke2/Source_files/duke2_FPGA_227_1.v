...
module FAU ( 
  ...
  assign z03 = (~new_n81_ & ~x09) | new_n79_ | (~x18 & x19);
  ...
  assign z06 = (~x09 & (new_n108_ | (~new_n93_ & ~x07))) | (~x18 & x19);
  ...
  assign z09 = (~x17 & ~new_n113_ & x18) | (~new_n122_ & ~x18);
  ...
  assign new_n122_ = ~x19 & (x07 | x09 | x15 | (~new_n123_ & ~x17));
  ...
  assign z17 = (~x09 & (new_n159_ | (~new_n156_ & ~x05))) | (~x18 & x19);
  ...
  assign new_n182_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x19 | x05 | ~x12);
  ...
  assign new_n191_ = ~new_n193_ & (~x18 | (~new_n135_ & ~new_n192_) | x21);
  ...
  assign new_n209_ = x05 ? (x07 | ~x17) : (~x15 | (~x17 & (~x07 | (x02 & x11))));
endmodule
