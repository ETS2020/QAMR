...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n70_, new_n71_, new_n72_, new_n75_, new_n76_, new_n77_, new_n80_,
  ...
  assign z06 = ~x09 & ((~new_n90_ & ~x07) | (new_n104_ & ~x05 & x07));
  ...
  assign new_n131_ = x00 & ~x05 & x15 & ~x18;
  ...
  assign z16 = ~x17 & (~x18 | (x08 & (x05 ? new_n144_ : ~new_n140_)));
  assign new_n140_ = (x07 | x15 | (x09 ? x19 : ~new_n141_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n141_ = ~x14 & ~new_n142_ & ~x21;
  assign new_n142_ = ~new_n143_ & (new_n59_ | ((~x06 | (~x02 & ~x11)) & x13 & (x02 | ~x11)));
  assign new_n143_ = x12 & (~x13 | (~x02 & x11)) & (x06 ^ x16);
  assign new_n144_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = (~x17 & ~x18) | (~x09 & (new_n149_ | (~new_n146_ & ~x05)));
  assign new_n146_ = x07 ? (x15 | x18) : ((x08 | ~new_n147_ | x15) & (~x00 | ~x15 | x18));
  assign new_n147_ = ~x17 & ~new_n148_ & (~x21 | (~x14 & x21));
  assign new_n148_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n149_ = new_n150_ & ~x04 & x05 & ~x07 & x08;
  assign new_n150_ = ~x11 & x15 & ~x17 & ~x21;
  assign z18 = ~x17 & (~x18 | (~x05 & new_n152_ & ~x07));
  assign new_n152_ = ~x09 & ((~x14 & ~new_n153_ & ~x15) | (~x08 & x15 & x19));
  ...
  assign new_n159_ = ~new_n160_ & (~x04 | ~x05 | ~x08 | new_n61_ | x12);
  assign new_n160_ = ~x09 & ((new_n163_ & ~x05) | (x04 & new_n161_ & x08));
  assign new_n161_ = x10 & ~x12 & ~x14 & ~new_n162_ & ~x21;
  assign new_n162_ = x13 & (x02 | ~x11);
  assign new_n163_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign z21 = ~x17 & ((~new_n165_ & ~x07) | ~x18 | (new_n166_ & ~x05 & x07));
  assign new_n165_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n166_ = x08 & ~x09 & x15;
  assign z22 = ~x17 & (new_n168_ | ~x18 | (new_n132_ & x08 & x15));
  assign new_n168_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  assign z24 = ~x17 & (~x18 | (new_n170_ & ~x07));
  assign new_n170_ = ~x09 & ((~x05 & ~x08 & ~x15) | (x08 & ~new_n171_ & ~x21));
  assign new_n171_ = (x02 | x05 | ~x11 | ~x15) & (~x05 | (x04 ? (x12 | x15) : (x11 | ~x15)));
  assign z25 = ~x05 & ~x07 & ~x17 & (new_n76_ | new_n122_) & x18;
  ...
  assign new_n176_ = (new_n129_ | new_n177_) & ~x21;
