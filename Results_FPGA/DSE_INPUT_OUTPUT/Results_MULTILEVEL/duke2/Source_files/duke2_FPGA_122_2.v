...
module FAU ( 
  ...
  assign new_n77_ = x18 & ((~x05 & ~x07 & x08 & x09 & ~x15) | (~x09 & ((x05 & ~x15 & (x07 ^ ~x08)) | (x08 & x15 & ~x05 & x07))));
  ...
  assign z20 = ~x07 & ~x17 & (new_n152_ | new_n158_);
  assign new_n152_ = ~x15 & (new_n156_ | (x18 & (new_n157_ | (~new_n153_ & ~x09))));
  ...
  assign new_n161_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = x17 ? ~x18 : (~new_n163_ & x18);
  assign new_n163_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n165_ & x08;
  assign new_n165_ = ~x05 & ~x07;
  assign z24 = z15 | (~x09 & (new_n171_ | (~new_n167_ & ~x07)));
  assign new_n167_ = ~new_n168_ & (x05 | x08 | x15 | x17 | ~x18);
  assign new_n168_ = ~x21 & ((x04 & ~new_n169_ & ~x15) | (x08 & new_n170_ & x15));
  assign new_n169_ = (~x05 | ~x08 | x12 | x17 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n170_ = ~x17 & x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n171_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = (x17 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n173_ & x18);
  assign new_n173_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = ~x20 & ~z15 & (x14 | x21);
  assign z27 = x17 ? ~x18 : (x18 & (new_n179_ | (~new_n176_ & ~x09)));
  ...
  assign new_n179_ = new_n165_ & x03 & ~x15 & x19 & x08 & x09;
  assign z28 = (~x17 & x18 & (new_n189_ | (~new_n181_ & ~x05))) | (~x18 & (x17 | (new_n191_ & ~x05)));
  assign new_n181_ = (new_n182_ | x02) & ~new_n188_ & (x07 | new_n184_ | x09);
  ...
  assign new_n191_ = x07 & ~x09 & x15 & (~x02 | ~x11);
  assign z13 = 1'b0;
  assign z19 = 1'b0;
endmodule
