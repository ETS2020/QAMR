...
module FAU ( 
  ...
  assign new_n79_ = ~x14 & ~x15 & (new_n80_ | (~new_n82_ & x06) | (~new_n85_ & ~x06));
  ...
  assign z09 = (~new_n107_ & ~x17) | (new_n102_ & ~x07 & ~x09);
  ...
  assign new_n119_ = ~x08 & ~x09 & x15 & ~x05 & ~x06 & ~x07;
  assign z12 = (~x17 & ~x18) | (~x09 & (new_n121_ | (new_n129_ & ~x15 & x17 & ~x18)));
  ...
  assign z13 = ~x09 & x17 & ~new_n117_ & ~x18;
  ...
  assign z17 = new_n77_ | (~x09 & (new_n146_ | (~new_n143_ & ~x05)));
  ...
  assign z19 = ~x18 & x17 & ~x15 & new_n153_ & ~x09;
  ...
  assign new_n157_ = ~x06 & ~x08 & ~new_n86_ & (~x14 | ~x21);
  ...
  assign z22 = ~x17 & (new_n164_ | ~x18 | (new_n129_ & x08 & x15));
  assign new_n164_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((~x09 & x15 & x06 & ~x08) | (x08 & x09 & ~x15))));
  ...
  assign new_n174_ = (new_n126_ | new_n175_) & ~x21;
  assign new_n175_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n176_ = new_n153_ & x03 & x08 & x09 & ~x15 & x19;
