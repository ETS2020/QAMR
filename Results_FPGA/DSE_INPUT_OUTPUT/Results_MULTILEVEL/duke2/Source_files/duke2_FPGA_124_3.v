...
module FAU ( 
  ...
  assign z09 = (~new_n116_ & x18) | (~x07 & ~x09 & ~new_n125_ & ~x15);
  assign new_n116_ = (x07 | (x05 ? ~new_n123_ : new_n117_)) & (~new_n124_ | ~x05) & ~x17;
  ...
  assign new_n125_ = ~x17 & (~new_n56_ | x14 | ~x04 | x05 | ~x12);
  ...
  assign z12 = new_n82_ | (~x09 & (new_n132_ | new_n108_));
  assign new_n132_ = ~x07 & (new_n110_ | (x18 & (~new_n133_ | new_n136_) & ~x21));
  assign new_n133_ = ~new_n135_ & (x05 | (~new_n95_ & ~new_n101_ & (new_n134_ | x15)));
  assign new_n134_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n107_ | ~x08 | x10);
  assign new_n135_ = x04 & x08 & ~x12 & ~x15 & (new_n107_ | x05);
  ...
  assign new_n141_ = new_n142_ & new_n56_ & ~x15 & ~x17;
  ...
  assign z17 = new_n82_ | (~new_n154_ & ~x09);
  ...
  assign new_n176_ = (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  ...
  assign new_n183_ = new_n109_ & x01 & x08 & ~x15 & ~x18;
  assign z25 = ~x05 & ~x07 & ~x17 & (new_n80_ | new_n129_) & x18;
  assign z26 = new_n82_ | (~x20 & (x14 | x21));
  assign z27 = (x18 & (new_n190_ | x17)) | (~x09 & (new_n191_ | (~new_n187_ & x18)));
  ...
  assign new_n190_ = new_n79_ & x03 & x08 & x09 & ~x15 & x19;
  ...
  assign new_n194_ = (x07 | x09 | (x08 ? ~new_n196_ : new_n195_)) & (~new_n198_ | ~x08);
  assign new_n195_ = (~x15 | x19) & (~new_n104_ | x14 | x15 | ~x21);
