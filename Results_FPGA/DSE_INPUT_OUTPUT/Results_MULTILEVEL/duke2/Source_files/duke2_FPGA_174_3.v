...
module FAU ( 
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n93_ | (new_n105_ & ~x15 & x17)));
  assign new_n93_ = ~x07 & (new_n104_ | (x18 & (new_n102_ | (~new_n94_ & ~x15))));
  ...
  assign new_n111_ = (x07 | (x05 ? ~new_n118_ : new_n112_)) & (~x05 | ~new_n78_ | ~x08);
  ...
  assign new_n120_ = x12 & ~x14 & ~x21 & x04 & ~x05;
  ...
  assign z11 = (x17 & x18) | (new_n105_ & x01 & ~x09 & ~x15 & ~x17 & ~x18);
  assign z12 = (x17 & x18) | (~x09 & (new_n127_ | (new_n105_ & ~x15 & x17 & ~x18)));
  ...
  assign new_n141_ = x08 & (x07 ? (~new_n108_ & ~x19) : new_n142_);
  ...
  assign new_n145_ = new_n146_ & x04 & ~x07 & x12 & ~x14;
  assign new_n146_ = ~x18 & ~x21 & ~x15 & ~x17;
  assign z15 = x17 & ((~x09 & ~x15 & x05 & ~x07) | x18);
  ...
  assign z17 = ~x09 & ((~new_n155_ & ~x05) | (new_n158_ & new_n65_ & ~x04 & x05));
  assign new_n155_ = (x07 | ((x08 | ~new_n156_ | x15) & (~new_n138_ | ~x00 | ~x15))) & (~new_n138_ | ~x07 | x15);
  ...
  assign z21 = x18 & ((~new_n174_ & ~x07) | x17 | (new_n175_ & ~x05 & x07));
  assign new_n174_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n175_ = x08 & ~x09 & x15;
  assign z22 = x18 & (new_n177_ | x17 | (new_n105_ & x08 & x15));
  assign new_n177_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  assign z23 = x18 & (x17 | (new_n179_ & ~x05 & ~x07));
  ...
  assign new_n185_ = x08 & ~x15 & ~x18 & new_n105_ & x01;
  ...
  assign new_n193_ = new_n194_ & new_n65_ & x03 & ~x05;
  ...
  assign new_n207_ = ~x09 & ((x15 & ((~x07 & x17) | (~new_n208_ & ~x05))) | (x05 & ~x07 & x17));
