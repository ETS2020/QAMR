...
module FAU ( 
  ...
  assign new_n110_ = (x07 | (x05 ? ~new_n117_ : new_n111_)) & ~x17 & (~new_n118_ | ~x05);
  ...
  assign z10 = (x18 & (new_n123_ | new_n124_ | x17)) | (~x09 & ~new_n122_ & x17);
  assign new_n122_ = x05 & x07;
  assign new_n123_ = ~x15 & ((x05 & ((x07 & x08) | (~x08 & ~x09 & ~x06 & ~x07))) | (~x05 & ~x07 & x08 & x09));
  assign new_n124_ = ~x05 & ~x06 & ~x07 & ~x08 & ~x09 & x15;
  assign z11 = new_n126_ & ~x18;
  assign new_n126_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (~x09 & (new_n105_ | (~new_n128_ & ~x07))) | (x17 & x18);
  assign new_n128_ = ~new_n104_ & (~x18 | x21 | (new_n129_ & (new_n133_ | x04)));
  assign new_n129_ = (~new_n132_ | ~x04) & (x05 | (~new_n94_ & ~new_n130_ & ~new_n102_));
  ...
  assign z13 = ~x09 & x17 & ~new_n122_ & ~x18;
  ...
  assign new_n139_ = new_n140_ & x04 & ~x05 & ~x07 & ~x09;
  ...
  assign z17 = ~x09 & (new_n150_ | (new_n66_ & new_n154_ & new_n67_ & ~x17));
  ...
  assign new_n156_ = (x14 | new_n157_ | x15) & (x08 | ~x15 | ~x19);
  assign new_n157_ = (new_n158_ | ~x12) & (~x02 | (~new_n85_ & ~new_n160_));
  assign new_n158_ = (x06 | (~new_n159_ & (~new_n90_ | ~x08 | ~x10))) & (~new_n88_ | ~x06 | ~x08 | ~x10);
  assign new_n159_ = ~x04 & ~x08 & ~x17 & x21;
  assign new_n160_ = x06 & ~x08 & ~x11 & ~x17 & x21;
  ...
  assign new_n169_ = new_n67_ & new_n154_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign z24 = (x17 & x18) | (~x09 & (new_n176_ | (new_n180_ & new_n181_ & ~x17 & ~x18)));
  ...
  assign new_n188_ = ~x21 & (new_n189_ | (~new_n133_ & ~x04));
