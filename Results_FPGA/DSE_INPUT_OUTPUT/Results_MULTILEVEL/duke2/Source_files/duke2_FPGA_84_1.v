...
module FAU ( 
  ...
  assign z12 = (~x09 & (new_n106_ | (~new_n128_ & ~x07))) | (~x18 & x19);
  ...
  assign z16 = (~x18 & x19) | (x08 & ~x17 & (new_n145_ | new_n150_) & x18);
  ...
  assign z17 = (~x09 & (new_n156_ | (~new_n152_ & ~x05))) | (~x18 & x19);
  assign new_n152_ = (x07 | ((x08 | ~new_n153_ | x15) & (~new_n155_ | ~x00 | ~x15))) & (~new_n155_ | ~x07 | x15);
  ...
  assign new_n158_ = (x14 | (~new_n84_ & ~new_n159_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n163_ = (new_n164_ | ~x18) & (~new_n169_ | x19 | x21 | x14 | x18);
  ...
  assign new_n180_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | x19);
  assign new_n181_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n182_ = x01 & ~x05 & x07 & new_n65_ & x08 & ~x15;
  ...
  assign new_n206_ = (~x15 | ((x07 | ~x17) & (x05 | (~x17 & (new_n71_ | ~x07))))) & (~x05 | x07 | ~x17);
endmodule
