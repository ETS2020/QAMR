...
module FAU ( 
  ...
  assign z02 = (~x03 & x18) | (~x17 & (x15 ? (~new_n73_ & x18) : ~new_n68_));
  ...
  assign z09 = new_n116_ | (x18 & (new_n107_ | ~x03));
  ...
  assign new_n138_ = ~x17 & (new_n142_ | (x03 & x08 & ~new_n139_ & x18));
  assign new_n139_ = x07 ? (new_n140_ | x19) : (new_n141_ | (~x09 & x21));
  ...
  assign z27 = new_n194_ | (~x09 & (new_n196_ | (x03 & new_n190_ & ~x17)));
  assign new_n190_ = x18 & (x07 ? (x08 & ~new_n140_ & x19) : ~new_n191_);
  assign new_n191_ = ~new_n193_ & (x21 | (~new_n126_ & ~new_n192_));
  ...
  assign z28 = (~new_n198_ & ~x17) | (~x09 & new_n210_ & x17);
  assign new_n198_ = (~new_n209_ | x05) & (~x03 | ~x18 | (~new_n207_ & (new_n199_ | x05)));
  assign new_n199_ = (new_n200_ | x02) & ~new_n206_ & (x07 | new_n202_ | x09);
