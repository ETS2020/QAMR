...
module FAU ( 
  ...
  assign z06 = new_n79_ | (~x09 & ((~new_n90_ & ~x07) | (new_n107_ & ~x05 & x07)));
  ...
  assign new_n94_ = x06 & ((new_n85_ & new_n96_) | (new_n95_ & ~x02));
  ...
  assign new_n114_ = (new_n115_ | ~x04) & (~new_n116_ | ~x02) & (~new_n95_ | x02 | ~x06);
  ...
  assign z12 = ~x09 & ((~new_n125_ & ~x07) | (new_n133_ & ~x05 & x07));
  assign new_n125_ = (x17 | ~x18 | new_n126_ | x21) & (~new_n106_ | ~x15 | ~x17 | x18);
  assign new_n126_ = ~new_n127_ & ~new_n131_ & (x05 | (~new_n92_ & ~new_n129_ & ~new_n99_));
  ...
  assign new_n150_ = new_n151_ & ~x07 & x08 & ~x04 & x05;
  assign new_n151_ = ~x17 & ~x21 & ~x11 & x15;
  ...
  assign new_n166_ = (new_n167_ | x07) & x18 & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign z25 = ~x17 & (~x18 | (~x05 & ~x07 & (new_n76_ | new_n123_)));
  ...
  assign new_n177_ = new_n75_ & x03 & x08 & x09 & ~x15 & x19;
  ...
  assign new_n185_ = (~x15 | x19) & (~new_n102_ | x14 | x15 | ~x21);
