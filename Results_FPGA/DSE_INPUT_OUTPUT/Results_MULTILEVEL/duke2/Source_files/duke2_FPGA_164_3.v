...
module FAU ( 
  ...
  assign z03 = (~new_n79_ & ~x09) | (x18 & (x17 | (new_n56_ & new_n80_)));
  ...
  assign z06 = (~x09 & (new_n109_ | (~new_n92_ & ~x07))) | (x17 & x18);
  assign new_n92_ = ~new_n108_ & (~x18 | (~new_n105_ & (x05 | (~new_n93_ & ~new_n102_))));
  assign new_n93_ = ~x21 & (new_n94_ | new_n101_ | (~x15 & (new_n96_ | new_n99_)));
  assign new_n94_ = x04 & ~new_n95_ & ~x12;
  assign new_n95_ = (~x11 | x14 | x02 | ~x08) & (x06 | x08 | x15);
  assign new_n96_ = x06 & ((new_n87_ & new_n98_) | (new_n97_ & ~x02));
  assign new_n97_ = ~x08 & x11;
  assign new_n98_ = x16 & ~x17 & ~x13 & ~x14;
  assign new_n99_ = x08 & ~x14 & ((new_n100_ & ~x06) | (~x10 & ~x13));
  assign new_n100_ = ~x17 & ((x02 & ~x10 & x13) | (~x13 & ~x16 & x10 & x12));
  ...
  assign new_n108_ = x00 & ~x05 & x15 & x17;
  ...
  assign new_n117_ = (new_n118_ | ~x04) & (~new_n119_ | ~x02) & (~new_n97_ | x02 | ~x06);
  ...
  assign new_n123_ = ~x18 & (x17 | (new_n124_ & x04 & ~x05));
  assign new_n124_ = x12 & ~x14 & ~x21;
  ...
  assign z11 = (x17 & x18) | (new_n110_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  assign z12 = (x17 & x18) | (~x09 & (new_n131_ | (new_n110_ & ~x15 & x17 & ~x18)));
  assign new_n131_ = ~x07 & (new_n137_ | (x18 & ~x21 & (~new_n132_ | new_n135_)));
  assign new_n132_ = ~new_n134_ & (x05 | (~new_n94_ & ~new_n101_ & (new_n133_ | x15)));
  assign new_n133_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n107_ | ~x08 | x10);
  assign new_n134_ = x04 & x08 & ~x12 & (new_n107_ | x05) & ~x15;
  assign new_n135_ = ~new_n136_ & ~x04;
  assign new_n136_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n137_ = x00 & ~x05 & x15 & x17 & ~x18;
  ...
  assign z16 = x18 & (x17 | (x08 & (x05 ? new_n152_ : ~new_n148_)));
  ...
  assign z17 = ~x09 & (new_n154_ | (new_n66_ & new_n158_ & new_n67_ & ~x17));
  assign new_n154_ = ~x05 & ((~new_n155_ & ~x07) | (x07 & ~x15 & x17 & ~x18));
  assign new_n155_ = (x08 | x15 | x17 | ~new_n156_ | ~x18) & (~x17 | x18 | ~x00 | ~x15);
  assign new_n156_ = ~new_n157_ & (~x21 | (~x14 & x21));
  assign new_n157_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n158_ = ~x11 & x15;
  assign z18 = x18 & (x17 | (~x05 & ~x07 & ~new_n160_ & ~x09));
  assign new_n160_ = (x14 | new_n161_ | x15) & (x08 | ~x15 | ~x19);
  assign new_n161_ = (new_n162_ | ~x12) & (~x02 | (~new_n85_ & ~new_n164_));
  assign new_n162_ = (x06 | (~new_n163_ & (~new_n90_ | ~x08 | ~x10))) & (~new_n88_ | ~x06 | ~x08 | ~x10);
  assign new_n163_ = ~x04 & ~x08 & ~x17 & x21;
  assign new_n164_ = x06 & ~x08 & ~x11 & ~x17 & x21;
  assign z19 = ~x18 & x17 & ~x15 & new_n56_ & ~x09;
  assign z20 = (x17 & x18) | (~x07 & (new_n173_ | (~new_n167_ & ~x15)));
  assign new_n167_ = (new_n168_ | ~x18) & (~new_n172_ | x18 | x21 | x14 | x17);
  assign new_n168_ = (x09 | ((~new_n170_ | x05) & (~new_n169_ | ~x04))) & (~x04 | ~new_n171_ | ~x05);
  ...
  assign new_n173_ = new_n67_ & new_n158_ & x08 & ~x09 & ~x04 & x05;
  assign z21 = x18 & (~new_n176_ | (~new_n175_ & ~x07));
  assign new_n175_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15 | x17))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  ...
  assign new_n185_ = new_n110_ & x01 & x08 & ~x15 & ~x18;
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n80_ | new_n128_);
  assign z26 = (x17 & x18) | (~x20 & (x14 | x21));
  assign z27 = (~x09 & (new_n193_ | (~new_n189_ & x18))) | (x18 & (new_n192_ | x17));
  ...
  assign new_n192_ = new_n56_ & x03 & ~x15 & x19 & x08 & x09;
  assign new_n193_ = ~x05 & x17 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = new_n204_ | (x18 & (~new_n202_ | (~x05 & (~new_n195_ | new_n199_))));
  assign new_n195_ = (~new_n196_ | x07) & (~x08 | ~x15 | (~x07 & x11));
  assign new_n196_ = ~x09 & (x08 ? (x10 & new_n198_ & x12) : ~new_n197_);
  assign new_n197_ = (~x15 | x19) & (~new_n104_ | x14 | x15 | ~x21);
