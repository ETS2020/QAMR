...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n93_ & ~x07) | (~x05 & x07 & new_n107_ & ~x15));
  ...
  assign z11 = (x17 & x18) | (new_n128_ & x01 & ~x09 & ~x15 & ~x17 & ~x18);
  assign new_n128_ = ~x05 & x07;
  assign z12 = (x17 & x18) | (~x09 & (new_n130_ | (new_n128_ & ~x15 & x17)));
  assign new_n130_ = ~x07 & (new_n137_ | (x18 & (~new_n131_ | new_n135_) & ~x21));
  assign new_n131_ = (x05 | (~new_n95_ & ~new_n132_ & ~new_n103_)) & (~new_n134_ | ~x04);
  assign new_n132_ = ~x15 & (new_n133_ | (x06 & ~x08 & (x02 ^ x11)));
  assign new_n133_ = ~x13 & ~x14 & x08 & ~x10;
  assign new_n134_ = x08 & ~x12 & ~new_n105_ & ~x15;
  assign new_n135_ = ~new_n136_ & ~x04;
  assign new_n136_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n137_ = x00 & ~x05 & x15 & x17;
  assign z13 = x17 & (x18 | (~x09 & (~x05 | ~x07)));
  assign z14 = (x18 & (new_n140_ | x17)) | (~x05 & ~new_n143_ & ~x09);
  assign new_n140_ = x08 & (x07 ? (~new_n111_ & ~x19) : new_n141_);
  ...
  assign z17 = ~x09 & ((~new_n154_ & ~x05) | (new_n157_ & new_n110_ & ~x04 & x05));
  ...
  assign new_n184_ = new_n128_ & x01 & x08 & ~x15 & ~x18;
  assign z25 = new_n186_ & ~x05;
  assign new_n186_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & ~new_n124_ & (~x17 | ~x18);
  ...
  assign new_n192_ = new_n193_ & new_n110_ & x03 & ~x05;
