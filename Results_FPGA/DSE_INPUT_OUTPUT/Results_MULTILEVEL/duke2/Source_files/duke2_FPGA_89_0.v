...
module FAU ( 
  ...
  assign new_n125_ = ~x05 & (new_n92_ | new_n100_ | (~new_n126_ & ~x15));
  assign new_n126_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n102_ | ~x08 | x10);
  assign new_n127_ = x08 & ~x12 & (new_n102_ | x05) & ~x15;
  ...
  assign z17 = z11 | (~x09 & (new_n145_ | (~new_n142_ & ~x05)));
  assign new_n142_ = x07 ? (x15 | x18) : ((x08 | ~new_n143_ | x15) & (~x00 | ~x15 | x18));
  assign new_n143_ = ~x17 & ~new_n144_ & (~x21 | (~x14 & x18 & x21));
  assign new_n144_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n145_ = new_n146_ & ~x04 & x05 & ~x07 & x08;
  assign new_n146_ = ~x11 & x15 & ~x17 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & new_n148_ & ~x17;
  assign new_n148_ = x18 & ((~x14 & ~new_n149_ & ~x15) | (~x08 & x15 & x19));
  assign new_n149_ = (new_n151_ | ~x02) & (~x12 | (~new_n152_ & (new_n150_ | x06)));
  assign new_n150_ = (x04 | x08 | ~x21) & (~new_n85_ | ~x08 | ~x10);
  assign new_n151_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n152_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  ...
  assign new_n156_ = x08 & x10 & ~x12 & ~x14 & ~new_n139_ & ~x21;
  ...
  assign z24 = ~x17 & (~x18 | (new_n167_ & ~x07));
