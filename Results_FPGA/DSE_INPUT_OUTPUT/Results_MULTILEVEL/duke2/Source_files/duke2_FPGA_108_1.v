...
module FAU ( 
  ...
  assign new_n107_ = ~x09 & ~x17 & x19 & ~x05 & ~x07 & ~x08;
  ...
  assign new_n126_ = (new_n127_ | ~x07) & (~x00 | x07 | ~x15 | ~x17 | x18);
  assign new_n127_ = (x15 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18 | ~x19);
  assign z28 = (x15 & ((~new_n129_ & ~x05) | (new_n132_ & ~x07))) | (new_n133_ & x05 & ~x07);
  assign new_n129_ = (x17 | (~new_n130_ & (new_n131_ | ~x18))) & (x18 | x19 | x09 | ~x17);
  assign new_n130_ = (~x02 | ~x11) & ((x08 & x18) | (x07 & ~x09 & ~x18));
  assign new_n131_ = (~x07 | ~x08) & (x07 | x08 | x09 | x19);
  assign new_n132_ = ~x09 & ((x17 & ~x18) | (x08 & ~x17 & x18 & x21));
