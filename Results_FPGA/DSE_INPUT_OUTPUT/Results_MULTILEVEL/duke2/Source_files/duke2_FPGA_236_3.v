...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n106_ | (~x07 & (new_n108_ | (new_n93_ & ~x17))));
  ...
  assign new_n106_ = new_n107_ & ~x15 & x17 & ~x18;
  assign new_n107_ = ~x05 & x07;
  assign new_n108_ = x00 & ~x05 & x15 & x17 & ~x18;
  assign z07 = x18 & (new_n110_ | new_n111_ | x17);
  assign new_n110_ = ~x09 & (x07 ^ ~x08) & (x05 ^ x15);
  assign new_n111_ = ~x05 & ~x07 & x08 & x09 & ~x15 & x16;
  assign z08 = (x17 & x18) | (x14 & ~x20);
  assign z09 = (~new_n114_ & x18) | (~x07 & new_n123_ & ~x09);
  assign new_n114_ = (x07 | (x05 ? ~new_n121_ : new_n115_)) & ~x17 & (~new_n122_ | ~x05);
  ...
  assign new_n123_ = ~x15 & (x17 | (new_n124_ & x04 & ~x05 & x12));
  assign new_n124_ = ~x14 & ~x18 & ~x21;
  ...
  assign z12 = ~x09 & (new_n106_ | (~x07 & (new_n108_ | (new_n131_ & ~x17))));
  ...
  assign new_n134_ = x08 & ~x12 & ~x15 & (new_n105_ | x05);
  ...
  assign new_n160_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n165_ = (new_n166_ | ~x18) & (~new_n170_ | x18 | x21 | x14 | x17);
  ...
  assign new_n171_ = new_n67_ & new_n156_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n182_ = new_n107_ & x01 & x08 & ~x15 & ~x17 & ~x18;
