...
module FAU ( 
  ...
  assign z01 = ~x17 & (new_n64_ | (~new_n56_ & ~x05));
  assign new_n56_ = (x07 | new_n57_ | ~x18) & (~new_n63_ | ~x02 | ~x07 | x09);
  ...
  assign new_n63_ = x11 & ~x12 & x15 & ~x18;
  assign new_n64_ = new_n65_ & ~x09 & ~x11 & new_n66_ & x15;
  assign new_n65_ = ~x04 & x05 & ~x07 & x08;
  assign new_n66_ = x18 & ~x21;
  assign z02 = (~x17 & ((~new_n68_ & ~x05) | (~new_n73_ & x18))) | (x12 & ~x18);
  assign new_n68_ = ~new_n72_ & (x09 | (~new_n71_ & (x07 | new_n69_ | ~x18)));
  assign new_n69_ = (new_n70_ | ~x06) & (x08 | (~x15 & (x06 | (x04 & x12))));
  assign new_n70_ = x02 & x11;
  assign new_n71_ = x01 & x07 & ~x15 & ~x18 & (x08 | x16);
  assign new_n72_ = x08 & x18 & (x07 ? x15 : (~x02 | ~x11 | ~x15));
  assign new_n73_ = (new_n74_ | ~x08) & (~x05 | x07 | x08 | x09 | x15);
  assign new_n74_ = ~new_n75_ & (~new_n61_ | x07) & (~x05 | x15 | (~x07 & x12));
  assign new_n75_ = ~x04 & ((~x07 & ~x09 & ~x11) | (x05 & ~x15));
  assign z03 = (~new_n77_ & ~x09) | (new_n80_ & x09 & ~x15 & ~x17 & x18);
  assign new_n77_ = (x17 | new_n78_ | ~x18) & (x12 | ~x17 | new_n79_ | x18);
  ...
  assign z06 = new_n82_ | (~x09 & ((~new_n93_ & ~x07) | (new_n105_ & ~x05 & x07)));
  ...
  assign z10 = (~x17 & ~new_n120_ & x18) | (~x18 & (x12 | (~x09 & ~new_n79_ & x17)));
  assign new_n120_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = ~x18 & (new_n122_ | x12);
  assign new_n122_ = ~x09 & ~x15 & ~x17 & x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n124_ & ~x07) | (new_n105_ & ~x05 & x07 & ~x12));
  assign new_n124_ = (~new_n135_ | ~x15 | ~x17 | x18) & (x17 | ~new_n125_ | ~x18);
  ...
  assign new_n130_ = ~new_n133_ & (x15 | (~new_n132_ & (~new_n131_ | ~x08 | x10)));
  assign new_n131_ = ~x13 & ~x14;
  assign new_n132_ = x06 & ~x08 & (~x02 ^ ~x11);
  assign new_n133_ = ~x02 & x08 & x11 & (x15 | (~x10 & ~x14));
  assign new_n134_ = x04 & x08 & ~x12 & ~x15 & (new_n131_ | x05);
  assign new_n135_ = x00 & ~x05 & ~x12;
  assign z13 = ~x09 & ~x12 & x17 & ~new_n79_ & ~x18;
  assign z14 = (x08 & new_n138_ & ~x17) | (~x05 & new_n141_ & ~x09);
  assign new_n138_ = x18 & (x07 ? new_n140_ : (~new_n61_ & ~new_n139_));
  ...
  assign z15 = ~x18 & (x12 | (new_n143_ & x05 & ~x07));
  assign new_n143_ = ~x09 & ~x15 & x17;
  ...
  assign z17 = ~x09 & (new_n151_ | (new_n65_ & new_n156_ & new_n66_ & ~x17));
  assign new_n151_ = ~x05 & ((~new_n152_ & ~x07) | (new_n105_ & x07 & ~x12));
  assign new_n152_ = ~new_n155_ & (~new_n153_ | x08);
  assign new_n153_ = ~x15 & ~x17 & x18 & ~new_n154_ & (~x21 | (~x14 & x21));
  assign new_n154_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n155_ = x15 & x17 & ~x18 & x00 & ~x12;
  assign new_n156_ = ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n158_ & x18;
  assign new_n158_ = (x14 | (~new_n85_ & ~new_n159_) | x15) & (x08 | ~x15 | ~x19);
  assign new_n159_ = x12 & ((~new_n160_ & ~x06) | (new_n89_ & x06 & x08 & x10));
  assign new_n160_ = (x04 | x08 | ~x21) & (x13 | x16 | x21 | ~x08 | ~x10);
  assign z19 = ~x18 & (x12 | (new_n143_ & ~x05 & ~x07));
  assign z20 = new_n82_ | (~x07 & ~new_n163_ & ~x17);
  assign new_n163_ = ~new_n168_ & (x15 | ((new_n164_ | x09) & (~new_n167_ | ~x04)));
  assign new_n164_ = (x05 | x06 | ~new_n166_ | x08) & (~x04 | ~new_n165_ | ~x08);
  assign new_n165_ = x10 & ~x12 & ~x14 & x18 & ~new_n148_ & ~x21;
  assign new_n166_ = (~x14 | ~x21) & (x04 ? (~x12 & x18) : x12);
  assign new_n167_ = x05 & x08 & ~x12 & ~new_n61_ & x18;
  assign new_n168_ = new_n66_ & new_n156_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign z23 = (x12 & ~x18) | (new_n80_ & x09 & ~x15 & ~x17 & x18);
  assign z24 = ~x09 & ~x17 & (new_n177_ | (new_n175_ & ~x07));
  assign new_n175_ = x18 & ((~x05 & ~x08 & ~x15) | (x08 & ~new_n176_ & ~x21));
  assign new_n176_ = (x02 | x05 | ~x11 | ~x15) & (~x05 | (x04 ? (x12 | x15) : (x11 | ~x15)));
  assign new_n177_ = new_n178_ & x01 & ~x05 & x07;
  assign new_n178_ = x08 & ~x12 & ~x15 & ~x18;
  ...
  assign new_n203_ = ~x09 & ~x12 & x15 & ~new_n70_ & ~x18;
