...
module FAU ( 
  ...
  assign new_n131_ = x07 ? (new_n108_ | x19) : (new_n60_ | new_n132_);
  ...
  assign z17 = ~x09 & ((~new_n143_ & ~x05) | (new_n146_ & new_n107_ & ~x04 & x05));
  ...
  assign new_n161_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n76_ & x08;
  assign z24 = ~x17 & ((new_n164_ & ~x07) | ~x18);
  assign new_n164_ = ~x09 & ((x08 & ~new_n165_ & ~x21) | (~x05 & ~x08 & ~x15));
  ...
  assign z27 = new_n170_ | (new_n175_ & new_n107_ & x03 & ~x05);
