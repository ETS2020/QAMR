...
module FAU ( 
  ...
  assign new_n77_ = (x17 | ((~x05 | x15 | (~x07 ^ ~x08)) & (~x08 | ~x15 | x05 | ~x07))) & (x18 | (x05 & x07));
  ...
  assign z12 = z11 | (~x09 & (new_n104_ | (~new_n124_ & ~x07)));
  assign new_n124_ = ~new_n102_ & (x17 | x21 | (new_n125_ & (new_n129_ | x04)));
  ...
  assign new_n144_ = (x07 | ((x08 | ~new_n145_ | x15) & (~new_n103_ | ~x00 | ~x15))) & (~new_n103_ | ~x07 | x15);
  ...
  assign new_n154_ = (x09 | ((~new_n155_ | x05) & (~new_n156_ | ~x04))) & (~x04 | ~new_n157_ | ~x05);
  assign new_n155_ = ~x06 & ~x08 & ~new_n88_ & (~x14 | ~x21);
  ...
  assign z25 = ~x05 & ~x07 & ~x17 & x18 & (new_n76_ | new_n122_);
  ...
  assign new_n169_ = ~x21 & (new_n170_ | (~new_n129_ & ~x04));
  assign new_n170_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n171_ = new_n75_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n172_ = ~x05 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & ~new_n174_ & x18) | (~x09 & x17 & ~new_n185_ & ~x18);
  assign new_n174_ = ~new_n183_ & (x05 | (new_n175_ & (new_n181_ | x02)));
  assign new_n175_ = (~new_n180_ | ~x08) & (x07 | x09 | (x08 ? ~new_n178_ : new_n176_));
  assign new_n176_ = (~x15 | x19) & (~new_n177_ | x14 | x15 | ~x21);
  assign new_n177_ = x04 & ~x06 & ~x12;
  assign new_n178_ = x10 & new_n179_ & x12;
