...
module FAU ( 
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n109_ | (~new_n92_ & ~x07)));
  ...
  assign new_n96_ = x06 & ((new_n97_ & ~x02) | (new_n87_ & new_n98_));
  ...
  assign new_n109_ = ~x15 & x17 & ~x05 & x07;
  assign z07 = x18 & (~new_n111_ | (~x09 & ~new_n113_ & (x07 ^ ~x08)));
  assign new_n111_ = ~x17 & (~new_n112_ | x05 | ~x09 | x15 | ~x16);
  assign new_n112_ = ~x07 & x08;
  assign new_n113_ = x05 ^ ~x15;
  assign z08 = (x14 & ~x20) | (x17 & x18);
  assign z09 = (~new_n116_ & x18) | (~x07 & ~x09 & ~new_n124_ & ~x15);
  assign new_n116_ = (x07 | (x05 ? ~new_n122_ : new_n117_)) & (~new_n123_ | ~x05) & ~x17;
  assign new_n117_ = (x21 | ((~new_n121_ | x11 | ~x15) & (x09 | new_n118_ | x15))) & (~new_n121_ | ~x09 | x11 | ~x15);
  assign new_n118_ = (new_n119_ | ~x04) & (~new_n120_ | ~x02) & (~new_n97_ | x02 | ~x06);
  ...
  assign new_n124_ = ~x17 & (~new_n56_ | x14 | ~x04 | x05 | ~x12);
  assign z10 = (~new_n126_ & x18) | (~x09 & x17 & (~x05 | ~x07));
  assign new_n126_ = ~new_n127_ & ~x17 & (~new_n128_ | x05 | x06 | x07);
  assign new_n127_ = ~x15 & ((x05 & ((x07 & x08) | (~x06 & ~x07 & ~x08 & ~x09))) | (x08 & x09 & ~x05 & ~x07));
  ...
  assign new_n132_ = (x17 | ~x18 | new_n133_ | x21) & (~new_n108_ | ~x15 | ~x17 | x18);
  assign new_n133_ = ~new_n134_ & ~new_n138_ & (x05 | (~new_n94_ & ~new_n136_ & ~new_n101_));
  ...
  assign z14 = (x18 & (new_n143_ | x17)) | (~x05 & ~new_n146_ & ~x09);
  assign new_n143_ = x08 & (x07 ? (~new_n113_ & ~x19) : new_n144_);
  assign new_n144_ = ~new_n145_ & (x09 | ~x21);
  assign new_n145_ = (~x11 | ~x15 | x02 | x05) & (x12 | x15 | ~x04 | ~x05);
  assign new_n146_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n147_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n147_ = new_n148_ & new_n56_ & ~x15 & ~x17;
  assign new_n148_ = x04 & ~x07 & x12 & ~x14;
  ...
  assign z17 = ~x09 & ((~new_n157_ & ~x05) | (new_n160_ & new_n112_ & ~x04 & x05));
  ...
  assign new_n163_ = (~x02 | (~new_n85_ & ~new_n166_)) & (new_n164_ | ~x12);
  assign new_n164_ = (x06 | (~new_n165_ & (~new_n90_ | ~x08 | ~x10))) & (~new_n88_ | ~x06 | ~x08 | ~x10);
  ...
  assign new_n169_ = (new_n170_ | ~x18) & (~new_n174_ | x14 | x17 | x18 | x21);
  assign new_n170_ = (x09 | ((~new_n171_ | ~x04) & (~new_n172_ | x05))) & (~x04 | ~new_n173_ | ~x05);
  ...
  assign new_n179_ = ~x17 & (x05 | ~x07 | ~x08 | x09 | ~x15 | x17);
  assign z22 = ~x17 & ~new_n181_ & x18;
  assign new_n181_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z24 = (x17 & x18) | (~x09 & (new_n183_ | (new_n130_ & new_n187_ & ~x17 & ~x18)));
  assign new_n183_ = ~x07 & (new_n184_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n184_ = ~x21 & ((x04 & ~new_n185_ & ~x15) | (x08 & new_n186_ & x15));
  assign new_n185_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x17 | x18);
  assign new_n186_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n187_ = x08 & ~x15;
  assign z25 = ~x05 & ~x07 & ~x17 & (new_n79_ | new_n128_) & x18;
  ...
  assign new_n194_ = new_n195_ & new_n112_ & x03 & ~x05;
  assign new_n195_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n196_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n198_ | (new_n208_ & ~x05))) | (~x09 & new_n209_ & x17);
  assign new_n198_ = x18 & (new_n206_ | (~x05 & (~new_n199_ | (~new_n204_ & ~x02))));
  assign new_n199_ = (~new_n203_ | ~x08) & (x07 | x09 | (x08 ? ~new_n201_ : new_n200_));
