...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n70_, new_n71_, new_n72_, new_n73_, new_n75_, new_n76_, new_n80_,
  ...
  assign new_n83_ = (~new_n84_ | ~new_n85_) & (~x11 | ~x21 | x02 | x08);
  ...
  assign z09 = (~new_n111_ & ~x17) | (new_n106_ & ~x07 & ~x09);
  assign new_n111_ = (x07 | (x05 ? ~new_n117_ : new_n112_)) & x18 & (~new_n118_ | ~x05);
  ...
  assign z12 = ~x09 & ((~new_n123_ & ~x07) | (~x05 & x07 & new_n131_ & ~x15));
  assign new_n123_ = (x17 | ~x18 | new_n124_ | x21) & (~new_n105_ | ~x15 | ~x17 | x18);
  assign new_n124_ = ~new_n125_ & ~new_n129_ & (x05 | (~new_n91_ & ~new_n127_ & ~new_n98_));
