...
module FAU ( 
  ...
  assign z06 = new_n82_ | (~x09 & (new_n106_ | (~x07 & (new_n93_ | new_n108_))));
  assign new_n93_ = x18 & (new_n104_ | (~x15 & (new_n101_ | (~new_n94_ & ~x21))));
  assign new_n94_ = (x02 | new_n99_ | ~x11) & ~new_n100_ & (new_n95_ | ~x08);
  ...
  assign new_n99_ = (x05 | ~x06 | x08) & (~x04 | ~x08 | x12 | x14);
  ...
  assign new_n106_ = new_n107_ & ~x15 & x17;
  ...
  assign new_n126_ = (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07);
  assign new_n127_ = ~x05 & ~x06 & ~x07;
  assign z11 = (x17 & x18) | (new_n107_ & x01 & ~x09 & ~x15 & ~x17 & ~x18);
  assign z12 = new_n82_ | (~x09 & (new_n130_ | new_n106_));
  assign new_n130_ = ~x07 & (new_n108_ | (x18 & (~new_n131_ | new_n138_) & ~x21));
  ...
  assign new_n142_ = x18 & (x07 ? (~new_n111_ & ~x19) : new_n143_);
  assign new_n143_ = ~new_n144_ & (x09 | ~x21);
  assign new_n144_ = (x02 | x05 | ~x11 | ~x15) & (~x04 | ~x05 | x12 | x15);
  assign new_n145_ = new_n146_ & x12 & ~x14 & new_n56_ & ~x15;
  assign new_n146_ = ~x07 & ~x09 & x04 & ~x05;
  ...
  assign new_n173_ = x04 & ~x05 & ~x09 & new_n56_ & x12 & ~x14;
  ...
  assign new_n185_ = new_n107_ & x01 & x08 & ~x15 & ~x18;
  ...
  assign new_n198_ = (~x15 | x19) & (~new_n103_ | x14 | x15 | ~x21);
