...
module FAU ( 
  ...
  assign z05 = x18 & (x17 | (~x05 & ~x07 & new_n82_ & ~x09));
  assign new_n82_ = ~x14 & ~x15 & (new_n83_ | (~new_n85_ & x06) | (~new_n88_ & ~x06));
  assign new_n83_ = ~new_n84_ & x02;
  assign new_n84_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n85_ = (~x11 | ~x21 | x02 | x08) & (~new_n87_ | ~new_n86_ | ~x08);
  ...
  assign z06 = new_n80_ | (~x09 & ((~new_n91_ & ~x07) | (new_n103_ & ~x05 & x07)));
  assign new_n91_ = (~x18 | (~new_n100_ & (new_n92_ | x15))) & (~new_n102_ | ~x15 | ~x17);
  ...
  assign new_n96_ = (x06 | ((x13 | x16 | ~x10 | ~x12) & (~x02 | x10 | ~x13))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  ...
  assign z07 = x18 & (~new_n105_ | (~x09 & ~new_n106_ & (~x07 ^ x08)));
  assign new_n105_ = ~x17 & (~new_n78_ | ~x09 | x15 | ~x16);
  assign new_n106_ = x05 ^ ~x15;
  assign z08 = new_n80_ | (x14 & ~x20);
  assign z09 = (~new_n109_ & x18) | (~x07 & ~x09 & ~new_n118_ & ~x15);
  assign new_n109_ = (x07 | (x05 ? ~new_n116_ : new_n110_)) & ~x17 & (~new_n117_ | ~x05);
  ...
  assign new_n118_ = ~x17 & (~x04 | x05 | ~x12 | ~new_n119_ | x14);
  ...
  assign z12 = ~x09 & ((~new_n126_ & ~x07) | (~x05 & x07 & new_n137_ & ~x15));
  assign new_n126_ = ~new_n136_ & (x17 | ~x18 | x21 | (new_n127_ & ~new_n134_));
  assign new_n127_ = (~new_n133_ | ~x04) & (x05 | (new_n128_ & (~x04 | new_n132_ | x12)));
  ...
  assign new_n132_ = (x02 | ~x08 | ~x11 | x14) & (x06 | x08 | x15);
  ...
  assign new_n136_ = new_n102_ & new_n137_ & x15;
  assign new_n137_ = x17 & ~x18;
  assign z14 = (new_n144_ & ~x05) | (~x17 & (new_n142_ | (new_n139_ & x08)));
  assign new_n139_ = x18 & (x07 ? (~new_n106_ & ~x19) : new_n140_);
  assign new_n140_ = ~new_n141_ & (x09 | ~x21);
  assign new_n141_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n142_ = new_n143_ & x12 & ~x14 & new_n119_ & ~x15;
  assign new_n143_ = x04 & ~x05 & ~x07 & ~x09;
  ...
  assign z17 = new_n80_ | (~new_n153_ & ~x09);
  assign new_n153_ = (new_n154_ | x05) & (~new_n157_ | x04 | ~x05 | x07 | ~x08);
  assign new_n154_ = x07 ? (x15 | ~x17) : ((x08 | ~new_n155_ | x15) & (~x00 | ~x15 | ~x17));
  assign new_n155_ = x18 & ~new_n156_ & (~x21 | (~x14 & x21));
  assign new_n156_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n157_ = x18 & ~x21 & ~x11 & x15;
  assign z18 = x18 & (x17 | (~x05 & ~x07 & ~new_n159_ & ~x09));
  assign new_n159_ = (x14 | x15 | (~new_n83_ & ~new_n160_)) & (x08 | ~x15 | ~x19);
  assign new_n160_ = x12 & ((~new_n161_ & ~x06) | (new_n87_ & x06 & x08 & x10));
  assign new_n161_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & new_n56_ & ~x09;
  assign z20 = ~x07 & ~new_n164_ & ~x17;
  assign new_n164_ = ~new_n165_ & (~new_n157_ | x04 | ~x05 | ~x08 | x09);
  ...
  assign new_n169_ = x04 & ~x05 & ~x09 & new_n119_ & x12 & ~x14;
  assign new_n170_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign z21 = x18 & ((~new_n172_ & ~x07) | x17 | (new_n173_ & ~x05 & x07));
  assign new_n172_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n173_ = x08 & ~x09 & x15;
  assign z22 = x18 & (new_n176_ | x17 | (new_n175_ & x08 & x15));
  assign new_n175_ = ~x05 & x07;
  assign new_n176_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((~x09 & x15 & x06 & ~x08) | (x08 & x09 & ~x15))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n56_ & x08;
  assign z24 = new_n80_ | (~x09 & (new_n179_ | new_n183_));
  assign new_n179_ = ~x07 & (new_n180_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n180_ = ~x21 & ((x04 & ~new_n181_ & ~x15) | (x08 & new_n182_ & x15));
  assign new_n181_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x17 | x18);
  assign new_n182_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n183_ = new_n175_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  ...
  assign new_n191_ = new_n56_ & x03 & x08 & x09 & ~x15 & x19;
