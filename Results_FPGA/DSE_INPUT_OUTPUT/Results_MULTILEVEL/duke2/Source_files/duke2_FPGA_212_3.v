...
module FAU ( 
  ...
  assign new_n76_ = x08 & (x05 ? new_n78_ : (x15 ? ~new_n77_ : ~x07));
  assign new_n77_ = ~x07 & x11 & (x02 | x07 | ~x11 | x17 | (~x09 & x21));
  assign new_n78_ = ~x15 & (~x04 | x07 | ~x12);
  assign z03 = (~new_n80_ & ~x09) | (x18 & (x17 | (new_n56_ & new_n81_)));
  assign new_n80_ = (~x18 | ((~x05 | x15 | (x07 ^ x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (~x17 | (x05 & x07));
  ...
  assign z06 = ~x09 & (new_n107_ | (~x07 & (new_n105_ | (new_n93_ & ~x17))));
  assign new_n93_ = x18 & ((~new_n94_ & ~x05) | (x04 & new_n104_ & x08));
  ...
  assign new_n100_ = (x10 | x13) & (x06 | ((~x02 | x10 | ~x13) & (x13 | x16 | ~x10 | ~x12)));
  ...
  assign new_n104_ = ~x12 & ~x15 & ~x21 & (x05 | (~x13 & ~x14));
  ...
  assign new_n110_ = ~x17 & (~new_n65_ | x05 | ~x09 | x15 | ~x16);
  assign new_n111_ = ~x05 ^ x15;
  assign z08 = (x17 & x18) | (x14 & ~x20);
  assign z09 = new_n122_ | (~x17 & ~new_n114_ & x18);
  assign new_n114_ = (x07 | (x05 ? ~new_n121_ : new_n115_)) & (~x05 | ~new_n78_ | ~x08);
  ...
  assign new_n122_ = ~x07 & ~x09 & ~x15 & ~new_n123_ & ~x18;
  assign new_n123_ = ~x17 & (~x04 | x05 | ~x12 | x14 | x21);
  assign z10 = z13 | (~x17 & ~new_n125_ & x18);
  assign new_n125_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (x05 | x07 | ~x08 | ~x09))) & (x08 | x09 | ~x15 | x05 | x06 | x07);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = (x17 & x18) | (new_n108_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  assign z12 = (x17 & x18) | (~x09 & (new_n107_ | (~new_n129_ & ~x07)));
  assign new_n129_ = ~new_n105_ & (~x18 | x21 | (new_n130_ & (new_n134_ | x04)));
  ...
  assign z14 = (x18 & (new_n136_ | x17)) | (~x05 & ~new_n139_ & ~x09);
  assign new_n136_ = x08 & (x07 ? (~new_n111_ & ~x19) : new_n137_);
  assign new_n137_ = ~new_n138_ & (x09 | ~x21);
  assign new_n138_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n139_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n140_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n140_ = new_n141_ & x04 & ~x07 & x12 & ~x14;
  assign new_n141_ = ~x15 & ~x17 & ~x18 & ~x21;
  ...
  assign new_n150_ = (x07 | ((x08 | ~new_n151_ | x15) & (~new_n106_ | ~x00 | ~x15))) & (~new_n106_ | ~x07 | x15);
  ...
  assign new_n155_ = (x14 | x15 | (~new_n85_ & ~new_n156_)) & (x08 | ~x15 | ~x19);
  assign new_n156_ = x12 & ((~new_n157_ & ~x06) | (new_n89_ & x06 & x08 & x10));
  assign new_n157_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & new_n56_ & ~x09;
  assign z20 = ~x07 & ~x17 & (new_n166_ | (~new_n160_ & ~x15));
  assign new_n160_ = (new_n161_ | ~x18) & (~new_n165_ | ~x12 | x14 | x18 | x21);
  assign new_n161_ = (x09 | ((~new_n162_ | x05) & (~new_n163_ | ~x04))) & (~x04 | ~new_n164_ | ~x05);
  assign new_n162_ = ~x06 & ~x08 & ~new_n91_ & (~x14 | ~x21);
  assign new_n163_ = x08 & x10 & ~x12 & ~x14 & ~new_n147_ & ~x21;
  assign new_n164_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n165_ = x04 & ~x05 & ~x09;
  assign new_n166_ = new_n167_ & x08 & ~x09 & ~x04 & x05;
  assign new_n167_ = x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n171_ = (new_n172_ | x07) & ~x17 & (~x08 | ~x15 | x05 | ~x07);
  assign new_n172_ = (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n56_ & x08;
  assign z24 = (x17 & x18) | (~x09 & (new_n175_ | new_n179_));
  assign new_n175_ = ~x07 & (new_n176_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n176_ = ~x21 & ((x04 & ~new_n177_ & ~x15) | (x08 & new_n178_ & x15));
  assign new_n177_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x17 | x18 | x05 | ~x12);
  assign new_n178_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n179_ = new_n108_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  assign z25 = ~new_n181_ & x18;
  assign new_n181_ = ~x17 & (x05 | x07 | (x08 ? (~x09 | x15) : (x09 | ~x15)));
  assign z26 = ~x20 & (x14 | x21) & (~x17 | ~x18);
  assign z27 = new_n184_ | (new_n189_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n186_ = ~x21 & (new_n187_ | (~new_n134_ & ~x04));
  ...
  assign new_n198_ = (~x08 | ~x15) & (~new_n199_ | x08 | x09 | ~x06 | x07);
