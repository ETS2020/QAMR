...
module FAU ( 
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n91_ | (new_n103_ & ~x15 & x17)));
  assign new_n91_ = ~x07 & (new_n102_ | (x18 & (new_n100_ | (~new_n92_ & ~x15))));
  ...
  assign new_n102_ = x00 & ~x05 & x15 & x17;
  ...
  assign z09 = (new_n108_ & ~x17) | (~x07 & ~x09 & new_n117_ & ~x15);
  assign new_n108_ = x18 & ((new_n116_ & x05) | (~x07 & (x05 ? new_n115_ : ~new_n109_)));
  ...
  assign new_n117_ = ~x18 & (x17 | (x04 & ~x05 & new_n118_ & x12));
  ...
  assign z11 = (x17 & x18) | (new_n103_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  assign z12 = ~x09 & ((~new_n125_ & ~x07) | (~x05 & x07 & new_n136_ & ~x15));
  assign new_n125_ = ~new_n135_ & (x17 | ~x18 | x21 | (new_n126_ & ~new_n133_));
  ...
  assign new_n172_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | x17))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign new_n173_ = ~x17 & (x09 | ~x15 | x17 | x05 | ~x07 | ~x08);
  assign z22 = ~x17 & ~new_n175_ & x18;
  assign new_n175_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  ...
  assign new_n180_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x17 | x18 | x05 | ~x12);
  assign new_n181_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n182_ = new_n103_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  assign z25 = new_n184_ & ~x05;
  assign new_n184_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & ~new_n118_ & (~x17 | ~x18);
