...
module FAU ( 
  ...
  assign new_n94_ = x16 & ~x21 & x12 & ~x13;
  assign z06 = new_n83_ | (~x09 & (new_n96_ | new_n112_));
  assign new_n96_ = ~x07 & (new_n111_ | (~x17 & (new_n108_ | (~new_n97_ & ~x05))));
  assign new_n97_ = ~new_n106_ & (x21 | (~new_n104_ & (~x18 | (~new_n98_ & new_n100_))));
  assign new_n98_ = x04 & ~new_n99_ & ~x12;
  assign new_n99_ = (x06 | x08 | x15) & (~x11 | x14 | x02 | ~x08);
  assign new_n100_ = ~new_n103_ & (~x08 | (~new_n101_ & (x14 | new_n102_ | x15)));
  assign new_n101_ = ~x02 & x11 & (x15 | (~x10 & ~x14));
  assign new_n102_ = (x10 | x13) & (x06 | ((~x02 | x10 | ~x13) & (x13 | x16 | ~x10 | ~x12)));
  assign new_n103_ = ~x02 & x06 & ~x08 & x11 & ~x15;
  assign new_n104_ = new_n105_ & x10 & x12 & x06 & x08;
  assign new_n105_ = ~x13 & ~x14 & ~x15 & x16;
  assign new_n106_ = ~x08 & ~x14 & ~x15 & new_n107_ & x18;
  assign new_n107_ = x21 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  assign new_n108_ = x04 & x08 & new_n109_ & ~x12;
  assign new_n109_ = ~x15 & x18 & ~x21 & (new_n110_ | x05);
  assign new_n110_ = ~x13 & ~x14;
  assign new_n111_ = x15 & x17 & ~x18 & x00 & ~x05;
  ...
  assign z09 = (~new_n126_ & ~x18) | (~x17 & ~new_n117_ & x18);
  assign new_n117_ = (~new_n125_ | ~x05) & (x07 | (x05 ? ~new_n124_ : new_n118_));
  ...
  assign new_n126_ = ~x16 & (x07 | x09 | x15 | (~new_n127_ & ~x17));
  ...
  assign z11 = ~x18 & (new_n132_ | x16);
  assign new_n132_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = ~x09 & ((~new_n134_ & ~x07) | (new_n142_ & ~x05 & x07 & ~x15));
  assign new_n134_ = ~new_n141_ & (x17 | ~x18 | x21 | (new_n135_ & ~new_n139_));
  assign new_n135_ = ~new_n137_ & (x05 | (~new_n98_ & ~new_n138_ & (new_n136_ | x15)));
  assign new_n136_ = (~x06 | x08 | (~x02 ^ x11)) & (~new_n110_ | ~x08 | x10);
  assign new_n137_ = x04 & x08 & ~x12 & ~x15 & (new_n110_ | x05);
  ...
  assign new_n141_ = new_n142_ & x00 & ~x05 & x15;
  assign new_n142_ = ~x16 & x17 & ~x18;
  assign z14 = (~new_n148_ & ~x18) | (~x17 & (new_n146_ | (x08 & ~new_n144_ & x18)));
  assign new_n144_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n65_ | new_n145_);
  ...
  assign new_n159_ = (x07 | ((x08 | ~new_n160_ | x15) & (~new_n142_ | ~x00 | ~x15))) & (~new_n142_ | ~x07 | x15);
  assign new_n160_ = ~x17 & x18 & ~new_n161_ & (~x21 | (~x14 & x21));
  assign new_n161_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n162_ = new_n68_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n164_ & x18;
  assign new_n164_ = (x14 | x15 | (~new_n165_ & ~new_n91_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n172_ = x08 & x10 & ~x12 & ~x14 & ~new_n156_ & ~x21;
  ...
  assign z28 = (~new_n211_ & ~x18) | (~x17 & ((new_n213_ & ~x05) | (~new_n200_ & x18)));
