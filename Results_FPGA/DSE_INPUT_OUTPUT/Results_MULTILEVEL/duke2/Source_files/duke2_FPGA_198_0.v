...
module FAU ( 
  ...
  assign new_n123_ = ~x07 & (new_n129_ | (~x17 & ~x21 & (~new_n124_ | new_n127_)));
  ...
  assign new_n160_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n161_ = x08 & ~x09 & x15;
  assign z22 = ~x17 & (new_n163_ | ~x18 | (new_n130_ & x08 & x15));
  assign new_n163_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x06 & ~x08 & ~x09 & x15) | (x08 & x09 & ~x15))));
  assign z23 = new_n165_ & x18;
  assign new_n165_ = ~x17 & ~x15 & x09 & ~x05 & ~x07 & x08;
  ...
  assign new_n174_ = (new_n127_ | new_n175_) & ~x21;
