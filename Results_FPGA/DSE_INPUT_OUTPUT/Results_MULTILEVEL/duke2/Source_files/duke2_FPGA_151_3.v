...
module FAU ( 
  ...
  assign new_n56_ = x17 & ((~x00 & (x01 ? (~x05 & x15) : ~x07)) | (x05 & (~x07 | ~x15)) | (~x07 & ~x15) | (~x05 & x07 & x15));
  assign z01 = (~x17 & (new_n65_ | (~new_n58_ & ~x05))) | (x01 & x18);
  ...
  assign z02 = (x01 & x18) | (~x17 & (new_n68_ | (x08 & ~new_n75_ & x18)));
  ...
  assign new_n74_ = x01 & ~x05 & x07 & (x08 | x16);
  ...
  assign new_n78_ = (x01 | x17 | new_n79_ | ~x18) & (~x17 | new_n80_ | x18);
  ...
  assign new_n92_ = ~x01 & ~x17 & x18 & (new_n103_ | (~new_n93_ & ~x05));
  ...
  assign z09 = new_n121_ | (~x01 & ~x17 & ~new_n112_ & x18);
  ...
  assign z10 = (x18 & (x01 | (~new_n124_ & ~x17))) | (~x09 & x17 & ~new_n80_ & ~x18);
  ...
  assign z12 = (~x09 & (new_n107_ | (~new_n128_ & ~x07))) | (x01 & x18);
  assign new_n128_ = ~new_n105_ & (x17 | ~x18 | x21 | (new_n129_ & ~new_n133_));
  ...
  assign z13 = (x01 & x18) | (~x09 & x17 & ~new_n80_ & ~x18);
  assign z14 = ~new_n142_ | (~x17 & (new_n140_ | (x08 & ~new_n137_ & x18)));
  ...
  assign new_n140_ = new_n141_ & new_n55_ & ~x15 & ~x18 & ~x21;
  assign new_n141_ = ~x07 & ~x09 & x04 & ~x05;
  assign new_n142_ = (~x01 | ~x18) & (x05 | x09 | new_n143_ | x18);
  assign new_n143_ = (~x15 | (~x07 & ~x17)) & (~x07 | (x01 & ~x17));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = ~x01 & x08 & ~x17 & (new_n146_ | new_n150_) & x18;
  ...
  assign z17 = (~x09 & (new_n155_ | (~new_n152_ & ~x05))) | (x01 & x18);
  ...
  assign z18 = ~x01 & ~x05 & ~x07 & ~x09 & new_n157_ & ~x17;
  ...
  assign z20 = (~x07 & ~new_n163_ & ~x17) | (x01 & (new_n171_ | x18));
  assign new_n163_ = (new_n164_ | x15) & (~new_n170_ | ~x18 | x21 | x11 | ~x15);
  assign new_n164_ = ~new_n168_ & (~x18 | (~new_n169_ & (new_n165_ | x09)));
  ...
  assign new_n168_ = x04 & ~x05 & ~x09 & new_n55_ & ~x18 & ~x21;
  assign new_n169_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign new_n170_ = ~x04 & x05 & x08 & ~x09;
  assign new_n171_ = new_n141_ & new_n55_ & ~x15 & ~x17 & ~x21;
  assign z21 = x18 & (x01 | (~new_n173_ & ~x17));
  assign new_n173_ = (new_n174_ | x07) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign new_n174_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | x01 | ~x05 | ~x06);
  ...
  assign new_n180_ = ~x07 & ((new_n184_ & ~x01 & ~x05) | (~new_n181_ & ~x21));
  ...
  assign new_n190_ = x18 & (x07 ? (x08 & ~new_n138_ & x19) : ~new_n191_);
  assign new_n191_ = ~new_n193_ & (x21 | (~new_n133_ & ~new_n192_));
  ...
  assign z28 = (~x17 & (new_n208_ | (new_n198_ & ~x01))) | (~x09 & new_n210_ & x17);
