...
module FAU ( 
  ...
  assign z02 = (~x17 & (~new_n74_ | (~new_n69_ & ~x05))) | (~x18 & x21);
  ...
  assign new_n74_ = (~x08 | (~new_n75_ & (~new_n63_ | x07))) & (~new_n77_ | ~x05 | x07 | x08);
  assign new_n75_ = x18 & (new_n76_ | (x05 & ~x15 & (x07 | ~x12)));
  assign new_n76_ = ~x04 & ((~x07 & ~x09 & ~x11) | (x05 & ~x15));
  assign new_n77_ = ~x09 & ~x15 & x18;
  assign z03 = (~new_n81_ & ~x09) | new_n79_ | (~x18 & x21);
  ...
  assign z06 = (~x09 & (new_n108_ | (~new_n93_ & ~x07))) | (~x18 & x21);
  ...
  assign new_n107_ = x15 & x17 & ~x18 & x00 & ~x05;
  ...
  assign z09 = (~new_n121_ & ~x18) | (~x17 & (new_n124_ | (~new_n113_ & x18)));
  ...
  assign new_n119_ = ~x05 & ~x07 & x08 & ~x11 & ~new_n63_ & x15;
  assign new_n120_ = x05 & x08 & (~x04 | x07 | ~x12);
  assign new_n121_ = ~x21 & (x07 | ~new_n122_ | x09);
  assign new_n122_ = ~x15 & (x17 | (new_n123_ & x04 & ~x05));
  assign new_n123_ = x12 & ~x14;
  assign new_n124_ = new_n63_ & x08 & x05 & ~x07;
  ...
  assign z12 = ~x09 & ~x21 & (new_n108_ | (~x07 & (new_n131_ | new_n107_)));
  assign new_n131_ = ~x17 & x18 & ((~new_n135_ & ~x04) | new_n132_ | (new_n134_ & x04));
  ...
  assign z14 = (~new_n137_ & ~x17) | (~x18 & (new_n141_ | x21));
  assign new_n137_ = (~x08 | new_n138_ | ~x18) & (~new_n140_ | ~new_n123_ | x15 | x18);
  ...
  assign z17 = ~x09 & (new_n155_ | (~new_n151_ & ~x05));
  assign new_n151_ = (x07 | ((x08 | ~new_n152_ | x15) & (~new_n154_ | ~x00 | ~x15))) & (~new_n154_ | ~x07 | x15);
  assign new_n152_ = ~x17 & x18 & ~new_n153_ & (~x21 | (~x14 & x21));
  assign new_n153_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n154_ = x17 & ~x18 & ~x21;
  assign new_n155_ = new_n67_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = new_n157_ | (~x18 & x21);
  ...
  assign z20 = (~x18 & x21) | (~x07 & ~x17 & (new_n163_ | new_n169_));
  assign new_n163_ = ~x15 & (new_n168_ | (x18 & (new_n167_ | (~new_n164_ & ~x09))));
  assign new_n164_ = (~new_n165_ | x05) & (~x04 | ~x08 | ~new_n166_ | ~x10);
  assign new_n165_ = ~x06 & ~x08 & ~new_n91_ & (~x14 | ~x21);
  assign new_n166_ = ~x12 & ~x14 & ~new_n148_ & ~x21;
  assign new_n167_ = x04 & x05 & x08 & ~new_n63_ & ~x12;
  assign new_n168_ = x12 & ~x14 & ~x18 & x04 & ~x05 & ~x09;
  ...
  assign z28 = (~new_n194_ & ~x17) | (~x18 & (x21 | (~x09 & ~new_n201_ & x17)));
  assign new_n194_ = (~new_n199_ | x05) & (x07 | (~new_n195_ & (~new_n200_ | x09)));
  assign new_n195_ = ~x15 & ((x08 & new_n196_ & x12) | (~x05 & new_n198_ & ~x08));
  assign new_n196_ = x18 & ((~x05 & new_n197_ & ~x09) | (~x04 & x05 & (x09 | ~x21)));
  assign new_n197_ = x10 & ~x14 & ~x21 & (x02 | x11 | ~x13);
  assign new_n198_ = ~x09 & new_n102_ & ~x14;
  assign new_n199_ = x15 & ((x07 & x08 & x18) | (~new_n71_ & ((x08 & x18) | (x07 & ~x09 & ~x18))));
  assign new_n200_ = x15 & ((x08 & x21) | (~x05 & ~x08 & x18 & ~x19));
