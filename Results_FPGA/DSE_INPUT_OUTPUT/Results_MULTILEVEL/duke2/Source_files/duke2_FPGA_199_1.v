...
module FAU ( 
  ...
  assign new_n65_ = new_n66_ & new_n67_ & x16 & x18 & ~x21;
  ...
  assign new_n70_ = (x15 | (~new_n76_ & (~x16 | new_n74_ | ~x18))) & (~x16 | new_n71_ | ~x18);
  ...
  assign new_n86_ = x16 & (x05 | x07 | x09 | ~new_n87_ | x14);
  assign new_n87_ = ~x15 & ~x17 & (new_n88_ | (~new_n90_ & x06) | (new_n92_ & ~x06));
  assign new_n88_ = ~new_n89_ & x02;
  assign new_n89_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n90_ = ~new_n91_ & (x02 | x08 | ~x11 | ~x16 | ~x21);
  assign new_n91_ = x08 & x10 & x12 & ~x13 & ~x21;
  assign new_n92_ = ~x08 & x21 & (x04 ? (~x12 & x16) : x12);
  assign z06 = ~x09 & ((~x07 & (new_n100_ | (~new_n94_ & ~x05))) | (new_n103_ & ~x05 & x07));
  assign new_n94_ = (~x16 | x17 | new_n95_ | ~x18) & (~x17 | x18 | ~x00 | ~x15);
  assign new_n95_ = ~new_n96_ & (~new_n99_ | x02);
  assign new_n96_ = ~x15 & (x08 ? (~x14 & ~new_n98_ & ~x21) : (~new_n97_ & (~x14 | ~x21)));
  assign new_n97_ = (x02 | ~x06 | ~x11) & (~x04 | x06 | x12);
  assign new_n98_ = (x10 | ((~x02 | x06) & (x13 | (x02 & x12)))) & (~x06 | ~x12 | x13);
  assign new_n99_ = x08 & x11 & ~x21 & (x15 | (~x10 & ~x14));
  assign new_n100_ = x04 & x08 & new_n101_ & ~x12;
  assign new_n101_ = ~x15 & x16 & ~x17 & x18 & ~new_n102_ & ~x21;
  assign new_n102_ = ~x05 & (x14 | (x13 & (x02 | ~x11)));
  assign new_n103_ = new_n104_ & ~x15;
  assign new_n104_ = x17 & ~x18;
  assign z07 = x16 & new_n106_ & ~x17;
  assign new_n106_ = x18 & ((~x09 & (~x07 ^ x08) & (x05 ^ x15)) | (x08 & x09 & ~x15 & ~x05 & ~x07));
  assign z08 = x14 & ~x20 & (x16 | ~x18);
  assign z09 = new_n116_ | (x18 & (~x16 | (~new_n109_ & ~x17)));
  assign new_n109_ = (x07 | (x05 ? ~new_n115_ : new_n110_)) & (~x05 | ~new_n79_ | ~x08);
  assign new_n110_ = (x21 | ((~new_n111_ | x09) & (~new_n67_ | ~x02 | ~x08))) & (~new_n67_ | ~x09 | ~x02 | ~x08);
  assign new_n111_ = ~x15 & ((~new_n112_ & x04) | new_n113_ | new_n114_);
  ...
  assign z11 = (~x16 & x18) | (new_n122_ & ~x17 & ~x18 & ~x09 & ~x15);
  assign new_n122_ = x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n124_ & ~x07) | (new_n103_ & ~x05 & x07));
  assign new_n124_ = (~x16 | x17 | ~new_n125_ | ~x18) & (~new_n136_ | ~x15 | ~x17 | x18);
  ...
  assign z14 = ~new_n143_ | (~x17 & (new_n138_ | (x08 & ~new_n141_ & x18)));
  assign new_n138_ = new_n139_ & new_n140_ & x04 & ~x05;
  assign new_n139_ = new_n56_ & ~x15 & ~x18 & ~x21;
  ...
  assign z15 = (~x16 & x18) | (new_n103_ & new_n140_ & x05);
  assign z16 = x18 & (~x16 | (x08 & ~new_n147_ & ~x17));
  assign new_n147_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n148_;
  assign new_n148_ = (x07 | x15 | (x09 ? x19 : ~new_n149_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n149_ = ~x14 & ~x21 & (new_n151_ | new_n152_ | (~new_n61_ & ~new_n150_));
  assign new_n150_ = x13 & (~x06 | (~x02 & ~x11));
  assign new_n151_ = ~x06 & (~x13 | (~x02 & x11)) & (x04 | x12);
  assign new_n152_ = ~x02 & ~x10 & x11;
  assign z17 = (~x09 & (new_n157_ | (~new_n154_ & ~x05))) | (~x16 & x18);
  assign new_n154_ = (x07 | ((~new_n104_ | ~x00 | ~x15) & (x08 | ~new_n155_ | x15))) & (~new_n104_ | ~x07 | x15);
  assign new_n155_ = ~x17 & x18 & ~new_n156_ & (~x21 | (~x14 & x21));
  assign new_n156_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n157_ = new_n158_ & new_n67_ & ~x17 & x18 & ~x21;
  assign new_n158_ = ~x04 & x05 & ~x07 & x08;
  assign z18 = x18 & (~x16 | (~x05 & ~x07 & new_n160_ & ~x09));
  assign new_n160_ = ~x17 & ((~x14 & ~new_n161_ & ~x15) | (~x08 & x15 & x19));
  assign new_n161_ = ~new_n88_ & (new_n162_ | ~x12);
  assign new_n162_ = (x04 | x06 | x08 | ~x21) & (~x06 | ~x08 | ~x10 | x13 | x21);
  assign z19 = (new_n103_ & new_n140_ & ~x05) | (~x16 & x18);
  assign z20 = (~x16 & x18) | (~x07 & ~new_n165_ & ~x17);
  assign new_n165_ = (new_n166_ | x15) & (~new_n172_ | ~x18 | x21 | x11 | ~x15);
  assign new_n166_ = ~new_n171_ & (~x18 | (~new_n170_ & (new_n167_ | x09)));
  ...
  assign z24 = (~x16 & x18) | (~x09 & ~x17 & (new_n178_ | new_n182_));
  ...
  assign new_n193_ = ~x17 & x18 & x19 & ~x15 & x16;
  assign new_n194_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n206_ | (new_n196_ & x16))) | (~x09 & new_n208_ & x17);
