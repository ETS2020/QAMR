...
module FAU ( 
  ...
  assign new_n153_ = ~new_n157_ & (x17 | ~x18 | (~new_n158_ & (new_n154_ | x09)));
  ...
  assign new_n159_ = new_n63_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign new_n179_ = new_n180_ & x03 & ~x05 & ~x07;
  assign new_n180_ = ~x15 & x19 & x08 & x09;
  assign z28 = (~x17 & x18 & (new_n190_ | (~new_n182_ & ~x05))) | (~x18 & (x17 | (new_n192_ & ~x05)));
  assign new_n182_ = (new_n183_ | x02) & ~new_n189_ & (x07 | new_n185_ | x09);
  ...
  assign new_n192_ = x07 & ~x09 & x15 & (~x02 | ~x11);
  assign z19 = 1'b0;
  assign z15 = z13;
endmodule
