...
module FAU ( 
  ...
  assign new_n75_ = (x17 | ((~x05 | x15 | (x07 ^ x08)) & (x05 | ~x07 | ~x08 | ~x15))) & (x18 | (x05 & x07));
  ...
  assign new_n124_ = ~new_n125_ & ~new_n129_ & (x05 | (~new_n92_ & ~new_n127_ & ~new_n100_));
  ...
  assign new_n129_ = x04 & x08 & ~x12 & ~new_n102_ & ~x15;
  assign new_n130_ = x17 & ~x18;
  assign z14 = new_n134_ | (~x17 & (~x18 | (~new_n132_ & x08)));
  assign new_n132_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n60_ | new_n133_);
  ...
  assign new_n145_ = (x07 | ((x08 | ~new_n146_ | x15) & (~new_n130_ | ~x00 | ~x15))) & (~new_n130_ | ~x07 | x15);
  ...
  assign new_n153_ = ~x04 & ~x08 & x18 & x21;
  ...
  assign new_n158_ = x08 & x10 & ~x12 & ~x14 & ~new_n141_ & ~x21;
  assign new_n159_ = x08 & ~new_n60_ & ~x12;
  assign new_n160_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign z21 = ~x17 & (~new_n163_ | (~new_n162_ & ~x07));
  assign new_n162_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | ~x18))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
