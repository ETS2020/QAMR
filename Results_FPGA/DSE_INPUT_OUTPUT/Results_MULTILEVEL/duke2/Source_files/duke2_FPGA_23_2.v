...
module FAU ( 
  ...
  assign z03 = new_n74_ | (new_n55_ & new_n65_ & new_n63_ & ~x15 & ~x17);
  assign new_n74_ = ~x09 & (x17 ? (~new_n76_ & ~x18) : (new_n75_ & x18));
  assign new_n75_ = x21 & ((x05 & ~x15 & (x07 ^ ~x08)) | (x08 & x15 & ~x05 & x07));
  ...
  assign new_n94_ = x04 & ~x05 & x12 & ~x14 & ~x21;
  assign new_n95_ = new_n63_ & ~x17 & ~x11 & x15;
  assign new_n96_ = ~x17 & x18 & x21 & (~x04 | x07 | ~x12);
  assign z10 = (~x17 & x18 & ~new_n98_ & x21) | (~x09 & x17 & ~new_n76_ & ~x18);
  ...
  assign z13 = (x18 & ~x21) | (~x09 & x17 & ~new_n76_ & ~x18);
  ...
  assign z15 = new_n78_ | (new_n86_ & ~x15 & x05 & ~x07 & ~x09);
  assign z16 = x18 & (~x21 | (x08 & x09 & ~new_n113_ & ~x17));
  ...
  assign new_n126_ = (new_n127_ | x07) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign new_n127_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15 | ~x21))) & (x09 | x15 | ~x21 | ~x05 | ~x06 | x08);
  assign z22 = ~x17 & x18 & ~new_n129_ & x21;
  assign new_n129_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x21 & new_n131_ & x18;
  assign new_n131_ = ~x17 & ~x15 & x09 & new_n55_ & x08;
  assign z24 = ~x05 & ~x09 & new_n133_ & ~x15;
  assign new_n133_ = ~x17 & ((~new_n134_ & ~x07) | (x01 & x07 & x08 & ~x18));
  assign new_n134_ = (~new_n63_ | x08) & (~new_n107_ | ~x04 | ~x12);
  assign z25 = ~x05 & new_n136_ & ~x07;
  assign new_n136_ = ~x17 & x18 & x21 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = (x18 & ~x21) | (~x20 & (x14 | x21));
  assign z27 = new_n139_ | (~x09 & ((~new_n142_ & ~x15) | (~x05 & ~new_n144_ & x15)));
  assign new_n139_ = new_n140_ & x03 & ~x05 & new_n65_ & ~x07;
  assign new_n140_ = new_n141_ & x18 & ~x15 & ~x17;
  assign new_n141_ = x19 & x21;
  assign new_n142_ = (~x05 | x17 | ~new_n143_ | ~x18) & (x05 | ~x07 | ~x17 | x18);
  assign new_n143_ = x19 & x21 & (~x07 ^ x08);
  assign new_n144_ = (~x17 | x18 | ~x00 | x07) & (~new_n141_ | ~x18 | ~x07 | ~x08 | x17);
