...
module FAU ( 
  ...
  assign new_n93_ = ~new_n100_ & (x21 | (~new_n94_ & ~new_n102_ & (new_n96_ | ~x08)));
  ...
  assign new_n98_ = (x06 | ((~x02 | x10 | ~x13) & (x13 | x16 | ~x10 | ~x12))) & (~x06 | ~x10 | ~x12 | x13 | ~x16);
  ...
  assign new_n111_ = (x07 | (x05 ? ~new_n119_ : new_n112_)) & ~x17 & (~new_n118_ | ~x05);
  ...
  assign new_n118_ = x08 & ~new_n77_ & ~x15;
  ...
  assign z12 = (x17 & x18) | (~x09 & (new_n128_ | (new_n106_ & ~x15 & x17 & ~x18)));
  ...
  assign z14 = (~x05 & ~new_n140_ & ~x09) | (x18 & (new_n143_ | x17));
  assign new_n140_ = (~x15 | (~x17 & (~x07 | x18))) & ~new_n141_ & (~x07 | (~x17 & (x01 | x18)));
  assign new_n141_ = new_n142_ & x04 & ~x07 & x12 & ~x14;
  assign new_n142_ = ~x15 & ~x17 & ~x18 & ~x21;
  assign new_n143_ = x08 & (x07 ? new_n145_ : (~new_n144_ & (x09 | ~x21)));
  ...
  assign z17 = (~new_n155_ & ~x09) | (x17 & x18);
  assign new_n155_ = (new_n156_ | x05) & (~new_n159_ | x04 | ~x05 | x07 | ~x08);
  assign new_n156_ = x07 ? (x15 | ~x17) : ((x08 | ~new_n157_ | x15) & (~x00 | ~x15 | ~x17));
  assign new_n157_ = x18 & ~new_n158_ & (~x21 | (~x14 & ~x17 & x21));
  ...
  assign z20 = (x17 & x18) | (~x07 & (new_n172_ | (~new_n166_ & ~x15)));
  assign new_n166_ = (new_n167_ | ~x18) & (~new_n171_ | x18 | x21 | x14 | x17);
  assign new_n167_ = (x09 | ((~new_n168_ | x05) & (~new_n169_ | ~x04))) & (~x04 | ~new_n170_ | ~x05);
  assign new_n168_ = ~x06 & ~x08 & ~new_n90_ & (~x14 | ~x21);
  assign new_n169_ = x08 & x10 & ~x12 & ~x14 & ~new_n152_ & ~x21;
  assign new_n170_ = x08 & ~x12 & (x09 | ~x21);
  assign new_n171_ = ~x09 & x12 & x04 & ~x05;
  assign new_n172_ = new_n159_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n181_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x17 | x18 | x05 | ~x12);
  assign new_n182_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n183_ = new_n106_ & x01 & x08 & ~x15 & ~x17 & ~x18;
  ...
  assign new_n189_ = ~x21 & (new_n136_ | new_n190_);
  ...
  assign z28 = (~x17 & (new_n195_ | (new_n206_ & ~x05))) | (~x09 & new_n207_ & x17);
