...
module FAU ( 
  ...
  assign new_n94_ = ~new_n106_ & (x17 | ~x18 | new_n95_ | x20);
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n120_ | (~x17 & x18 & ~new_n113_ & ~x20);
  ...
  assign z10 = z13 | (x18 & ((~new_n123_ & ~x17) | x20));
  assign new_n123_ = (x15 | ((x05 | x07 | ~x08 | ~x09) & (~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = (x18 & x20) | (new_n126_ & ~x17 & ~x18 & ~x09 & ~x15);
  assign new_n126_ = x01 & ~x05 & x07;
  assign z12 = (~x09 & (new_n108_ | (~new_n128_ & ~x07))) | (x18 & x20);
  assign new_n128_ = ~new_n106_ & (x17 | ~x18 | x21 | (new_n129_ & ~new_n136_));
  ...
  assign z16 = x18 & (x20 | (x08 & ~x17 & (new_n147_ | new_n151_)));
  ...
  assign new_n160_ = (new_n161_ | ~x02) & (~x12 | (~new_n164_ & (new_n163_ | x06)));
  assign new_n161_ = (~new_n162_ | ~x06 | x08) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n162_ = ~x11 & ~x20 & x21;
  assign new_n163_ = (x20 | ~x21 | x04 | x08) & (~new_n91_ | ~x08 | ~x10);
  assign new_n164_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = (~x07 & ~new_n167_ & ~x17) | (x18 & x20);
  assign new_n167_ = ~new_n174_ & (x15 | ((new_n168_ | x09) & (~new_n173_ | ~x04)));
  assign new_n168_ = (~new_n169_ | ~x04) & (x05 | ((~new_n172_ | ~x04) & (~new_n171_ | x06)));
  assign new_n169_ = x08 & x10 & new_n170_ & ~x12;
  assign new_n170_ = ~x14 & x18 & ~x21 & (~x13 | (~x02 & x11));
  assign new_n171_ = ~x08 & x18 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n172_ = x12 & ~x14 & ~x21 & (~x18 | x20);
  assign new_n173_ = x05 & x08 & ~x12 & ~new_n64_ & x18;
  assign new_n174_ = new_n175_ & new_n67_ & x18 & ~x21;
  ...
  assign new_n182_ = x09 & ~x15 & ~x17 & ~x05 & ~x07 & x08;
  assign z24 = (x18 & x20) | (~x09 & ~x17 & (new_n184_ | new_n188_));
  ...
  assign z27 = (~x09 & (new_n198_ | (~x17 & ~new_n193_ & x18))) | (~new_n196_ & x18);
  assign new_n193_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n194_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n194_ = ~x21 & (new_n136_ | new_n195_);
  assign new_n195_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n196_ = ~x20 & (~new_n197_ | ~x03 | x05 | x07 | ~x08);
  assign new_n197_ = x09 & ~x15 & ~x17 & x19;
  assign new_n198_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n200_ & ~x17) | (x18 & x20) | (~x09 & x17 & ~new_n213_ & ~x18);
