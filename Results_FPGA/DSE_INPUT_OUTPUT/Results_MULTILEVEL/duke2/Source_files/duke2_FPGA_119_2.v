...
module FAU ( 
  ...
  assign new_n68_ = (x04 | ~x05 | x11 | ~x15) & (x02 | x05 | ~new_n69_ | ~x11);
  ...
  assign z06 = (x17 & ~x18) | (~x07 & ~x09 & ~x17 & x18 & (new_n89_ | new_n100_));
  ...
  assign new_n115_ = new_n54_ & new_n55_ & ~x15 & ~x18 & ~x21;
  assign z10 = x17 ? ~x18 : (~new_n117_ & x18);
  assign new_n117_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = ~new_n119_ & ~x18;
  assign new_n119_ = ~x17 & (~x01 | x05 | ~x07 | x09 | x15);
  assign z12 = ~x07 & ~x09 & ~x17 & x18 & ~new_n121_ & ~x21;
  assign new_n121_ = ~new_n122_ & ~new_n126_ & (x05 | (~new_n97_ & ~new_n124_ & ~new_n99_));
  ...
  assign new_n126_ = x04 & x08 & ~x12 & ~new_n101_ & ~x15;
  assign z14 = (x08 & ~x17 & ~new_n128_ & x18) | (~x18 & (new_n131_ | x17));
  assign new_n128_ = x07 ? ~new_n130_ : (new_n129_ | (~x09 & x21));
  assign new_n129_ = (~x11 | ~x15 | x02 | x05) & (~x04 | ~x05 | x12 | x15);
  ...
  assign new_n160_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign z27 = x17 ? ~x18 : (x18 & (new_n176_ | (~new_n173_ & ~x09)));
  ...
  assign z28 = (~x17 & x18 & (new_n186_ | (~new_n179_ & ~x05))) | (~x18 & (x17 | (new_n188_ & ~x05)));
  ...
  assign new_n184_ = (~x15 | x19) & (~new_n96_ | x14 | x15 | ~x21);
  ...
  assign new_n188_ = x07 & ~x09 & x15 & (~x02 | ~x11);
  assign z15 = 1'b0;
  assign z19 = z13;
endmodule
