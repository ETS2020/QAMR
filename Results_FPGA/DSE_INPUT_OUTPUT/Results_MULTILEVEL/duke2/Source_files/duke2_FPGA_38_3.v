...
module FAU ( 
  ...
  assign new_n76_ = ~x05 & x07 & ~x17 & ~x18 & (x08 | x16);
  assign new_n77_ = x08 & (x05 ? (~new_n79_ & ~x15) : (x15 ? ~new_n78_ : ~x07));
  assign new_n78_ = ~x07 & x11 & (x02 | x07 | ~x11 | x17 | (~x09 & x21));
  assign new_n79_ = x04 & ~x07 & x12;
  assign z03 = (~new_n82_ & ~x09) | (new_n81_ & ~x17 & x18 & x09 & ~x15);
  assign new_n81_ = new_n66_ & ~x05;
  assign new_n82_ = x17 ? (x18 | (x05 & x07)) : (~x18 | ((~x05 | x15 | (x07 ^ x08)) & (~x08 | ~x15 | x05 | ~x07)));
  assign z04 = new_n84_ | (~x14 & ~x20);
  assign new_n84_ = x17 & x18;
  assign z05 = x18 & (x17 | (~x05 & ~x07 & new_n86_ & ~x09));
  assign new_n86_ = ~x14 & ~x15 & (new_n87_ | (~new_n89_ & x06) | (~new_n92_ & ~x06));
  ...
  assign new_n95_ = (~x18 | (~new_n104_ & (new_n96_ | x15))) & (~new_n106_ | ~x15 | ~x17);
  assign new_n96_ = ~new_n102_ & (x21 | (~new_n97_ & ~new_n101_ & (new_n99_ | ~x08)));
  assign new_n97_ = ~x02 & ~new_n98_ & x11;
  assign new_n98_ = (x05 | ~x06 | x08) & (x12 | x14 | ~x04 | ~x08);
  assign new_n99_ = (~x04 | x12 | (~x05 & (x13 | x14))) & (x05 | new_n100_ | x14);
  assign new_n100_ = (x06 | ((~x02 | x10 | ~x13) & (x13 | x16 | ~x10 | ~x12))) & (x13 | (x10 & (~x06 | ~x10 | ~x12 | ~x16)));
  assign new_n101_ = new_n55_ & ~x06 & ~x08 & ~x12;
  ...
  assign new_n109_ = ~x17 & (~new_n81_ | ~x09 | x15 | ~x16);
  assign new_n110_ = x05 ^ ~x15;
  assign z08 = x14 & ~new_n84_ & ~x20;
  assign z09 = (new_n113_ & ~x17) | (~x07 & ~x09 & new_n122_ & ~x15);
  assign new_n113_ = x18 & ((new_n120_ & x05) | (~x07 & (x05 ? new_n121_ : ~new_n114_)));
  ...
  assign new_n120_ = x08 & ~new_n79_ & ~x15;
  assign new_n121_ = ~x09 & (x08 ? x21 : (~x15 & ~x19));
  assign new_n122_ = ~x18 & (x17 | (new_n55_ & x12 & ~x14 & ~x21));
  assign z10 = (~x17 & ~new_n124_ & x18) | (~x09 & x17 & ~x18 & (~x05 | ~x07));
  ...
  assign z12 = ~x09 & ((~new_n128_ & ~x07) | (~x05 & x07 & new_n139_ & ~x15));
  assign new_n128_ = ~new_n138_ & (x17 | ~x18 | x21 | (new_n129_ & ~new_n136_));
  ...
  assign new_n138_ = new_n106_ & new_n139_ & x15;
  assign new_n139_ = x17 & ~x18;
  assign z13 = x17 & (x18 | (~x09 & (~x05 | ~x07)));
  assign z14 = (new_n147_ & ~x05) | (~x17 & (new_n145_ | (new_n142_ & x08)));
  assign new_n142_ = x18 & (x07 ? (~new_n110_ & ~x19) : new_n143_);
  assign new_n143_ = ~new_n144_ & (x09 | ~x21);
  assign new_n144_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n145_ = new_n146_ & new_n55_ & ~x07 & ~x09;
  assign new_n146_ = x12 & ~x14 & new_n56_ & ~x15;
  ...
  assign new_n152_ = (new_n62_ | (new_n153_ & (~x02 | ~x06))) & (~x12 | new_n153_ | (~x06 ^ x16));
  assign new_n153_ = x13 & (x02 | ~x11);
  assign new_n154_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = new_n84_ | (~new_n156_ & ~x09);
  assign new_n156_ = (new_n157_ | x05) & (~new_n160_ | ~new_n66_ | x04 | ~x05);
  assign new_n157_ = x07 ? (x15 | ~x17) : ((x08 | ~new_n158_ | x15) & (~x00 | ~x15 | ~x17));
  assign new_n158_ = x18 & ~new_n159_ & (~x21 | (~x14 & ~x17 & x21));
  assign new_n159_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n160_ = ~x11 & x15 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n162_ & x18;
  assign new_n162_ = (x14 | x15 | (~new_n87_ & ~new_n163_)) & (x08 | ~x15 | ~x19);
  assign new_n163_ = x12 & ((~new_n164_ & ~x06) | (new_n91_ & x06 & x08 & x10));
  assign new_n164_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = x17 & (x18 | (new_n166_ & ~x09 & ~x15));
  assign new_n166_ = ~x05 & ~x07;
  assign z20 = new_n84_ | (~new_n168_ & ~x07);
  assign new_n168_ = ~new_n169_ & (~new_n160_ | x04 | ~x05 | ~x08 | x09);
  assign new_n169_ = ~x15 & (new_n173_ | (x18 & (new_n174_ | (~new_n170_ & ~x09))));
  assign new_n170_ = (~new_n171_ | x05) & (~x04 | ~x08 | ~new_n172_ | ~x10);
  assign new_n171_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n172_ = ~x12 & ~x14 & ~x21 & (~x13 | (~x02 & x11));
  assign new_n173_ = new_n55_ & ~x09 & x12 & new_n56_ & ~x14 & ~x17;
  assign new_n174_ = x04 & x05 & x08 & ~x12 & (x09 | ~x21);
  assign z21 = x18 & ((~new_n176_ & ~x07) | x17 | (new_n177_ & ~x05 & x07));
  assign new_n176_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n177_ = x08 & ~x09 & x15;
  assign z22 = x18 & (new_n180_ | x17 | (new_n179_ & x08 & x15));
  assign new_n179_ = ~x05 & x07;
  assign new_n180_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n166_ & x08;
  assign z24 = new_n84_ | (~x09 & (new_n183_ | new_n187_));
  assign new_n183_ = ~x07 & (new_n184_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n184_ = ~x21 & ((x04 & ~new_n185_ & ~x15) | (x08 & new_n186_ & x15));
  assign new_n185_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x17 | x18 | x05 | ~x12);
  assign new_n186_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n187_ = new_n179_ & x01 & ~x17 & ~x18 & x08 & ~x15;
  assign z25 = ~new_n189_ & x18;
  assign new_n189_ = ~x17 & (x05 | x07 | (x08 ? (~x09 | x15) : (x09 | ~x15)));
  assign z26 = new_n84_ | (~x20 & (x14 | x21));
  assign z27 = (~x09 & (new_n196_ | (~new_n192_ & x18))) | (x18 & (new_n195_ | x17));
  assign new_n192_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n193_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n193_ = ~x21 & (new_n136_ | new_n194_);
  assign new_n194_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n195_ = new_n166_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n196_ = ~x05 & x17 & ((x00 & ~x07 & x15) | (x07 & ~x15));
  assign z28 = (~x17 & (new_n198_ | (new_n209_ & ~x05))) | (~x09 & new_n210_ & x17);
