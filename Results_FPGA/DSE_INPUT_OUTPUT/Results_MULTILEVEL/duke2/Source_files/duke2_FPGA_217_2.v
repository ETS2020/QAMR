...
module FAU ( 
  ...
  assign z06 = new_n80_ | (~new_n91_ & ~x09);
  assign new_n91_ = (x07 | x17 | (~new_n102_ & (new_n92_ | ~x18))) & (x05 | ~x07 | ~x17 | x18);
  ...
  assign new_n101_ = ~x02 & ~x05 & x08 & new_n55_ & ~x10 & x11;
  assign new_n102_ = ~x02 & ~x05 & x08 & x11 & x15 & ~x21;
  assign z07 = ~x17 & ~new_n104_ & x18;
  assign new_n104_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (~x09 | x15 | ~x16 | x05 | x07 | ~x08);
  assign z08 = x14 & ~new_n80_ & ~x20;
  assign z09 = (new_n107_ & ~x17) | (~x07 & ~x09 & new_n116_ & ~x15);
  ...
  assign new_n116_ = ~x18 & (x17 | (x04 & ~x05 & new_n55_ & x12));
  ...
  assign new_n122_ = ~x15 & (~x01 | x05 | ~x07 | x09 | x17);
  assign z12 = ~x09 & (new_n132_ | (~x07 & ~x17 & new_n124_ & x18));
  assign new_n124_ = ~x21 & ((~new_n131_ & ~x04) | (new_n130_ & x04) | (~new_n125_ & ~x05));
  ...
  assign new_n130_ = x08 & ~x12 & (new_n127_ | x05) & ~x15;
  ...
  assign z14 = (new_n140_ & ~x05) | (~x17 & (new_n138_ | (new_n135_ & x08)));
  assign new_n135_ = x18 & (x07 ? new_n137_ : (~new_n61_ & ~new_n136_));
  ...
  assign new_n140_ = x07 & ~x09 & ~x15 & ~x18 & (~x01 | x17);
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = new_n80_ | (x08 & ~x17 & (x05 ? new_n148_ : ~new_n143_));
  assign new_n143_ = (x07 | ~new_n144_ | x15) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n144_ = x18 & (x09 ? ~x19 : (~x14 & ~new_n145_ & ~x21));
  assign new_n145_ = (new_n59_ | new_n146_) & (new_n147_ | ~x12);
  assign new_n146_ = (~x02 | ~x06) & x13 & (x02 | ~x11);
  assign new_n147_ = ((~x06 ^ x16) | (x13 & (x02 | ~x11))) & (~x06 | x10 | ~x11);
  assign new_n148_ = x09 & ~x15 & x18 & (x07 | ~x12);
  assign z17 = new_n80_ | (~x09 & (new_n153_ | (~new_n150_ & ~x05)));
  assign new_n150_ = x07 ? (~x17 | x18) : (x08 | x15 | x17 | ~new_n151_ | ~x18);
  assign new_n151_ = ~new_n152_ & (~x21 | (~x14 & x21));
  assign new_n152_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n153_ = new_n78_ & ~x04 & x05 & new_n154_ & ~x17 & ~x21;
  assign new_n154_ = ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n156_ & x18;
  assign new_n156_ = (x14 | (~new_n83_ & ~new_n157_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign z20 = new_n80_ | (~x07 & ~x17 & (new_n161_ | (new_n167_ & x04)));
  assign new_n161_ = ~x09 & ((~new_n165_ & ~x21) | (~x15 & ~new_n162_ & x18));
  ...
  assign new_n165_ = (~new_n154_ | ~x08 | x04 | ~x05) & (~x04 | x05 | ~new_n166_ | ~x12);
  assign new_n166_ = ~x14 & ~x18;
  assign new_n167_ = x05 & x08 & ~x12 & ~x15 & ~new_n61_ & x18;
  assign z21 = new_n80_ | (~x17 & (new_n170_ | (~new_n169_ & ~x07)));
  assign new_n169_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15 | ~x18))) & (x09 | x15 | ~x18 | ~x05 | ~x06 | x08);
  assign new_n170_ = ~x05 & x07 & x08 & ~x09 & x15 & x18;
  assign z22 = ~x17 & ~new_n172_ & x18;
  assign new_n172_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (~x08 | ~x15 | x05 | ~x07);
  assign z23 = new_n174_ & x18;
  assign new_n174_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = new_n80_ | (~x09 & ~new_n176_ & ~x17);
  assign new_n176_ = (new_n177_ | x07) & (~x01 | x05 | ~x07 | ~x08 | x18);
  assign new_n177_ = (x21 | (~new_n178_ & (~new_n180_ | ~x08))) & (~new_n179_ | x05 | x08);
  assign new_n178_ = x04 & ((x05 & x08 & new_n179_ & ~x12) | (new_n166_ & ~x05 & x12));
  assign new_n179_ = ~x15 & x18;
  assign new_n180_ = x15 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign z25 = new_n182_ & ~x05;
  assign new_n182_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = new_n80_ | (~new_n55_ & ~x20);
  assign z27 = ~new_n189_ | (~x09 & (new_n191_ | (~x17 & (new_n185_ | new_n192_))));
  assign new_n185_ = ~x07 & (new_n188_ | (~x21 & (new_n187_ | (~new_n186_ & ~x04))));
  assign new_n186_ = (~new_n154_ | ~x05 | ~x08) & (x05 | x06 | x08 | ~new_n179_ | ~x12);
  assign new_n187_ = x02 & ~x05 & x06 & new_n179_ & ~x08 & ~x11;
  assign new_n188_ = x05 & ~x08 & ~x15 & x18 & x19;
  assign new_n189_ = (~x15 | x18) & (~new_n190_ | ~x09 | x15 | x17 | ~x18 | ~x19);
  assign new_n190_ = new_n78_ & x03 & ~x05;
  assign new_n191_ = ~x05 & x07 & x17 & ~x18;
  assign new_n192_ = x07 & x08 & x19 & (x05 ? (~x15 & x18) : x15);
  assign z28 = new_n204_ | (~x17 & (new_n202_ | (~x05 & (~new_n194_ | new_n199_))));
  assign new_n194_ = (x07 | new_n195_ | x09) & (~x08 | ~x15 | (~x07 & x11));
  assign new_n195_ = x08 ? (~x10 | ~x12 | ~new_n198_ | x14) : new_n196_;
  assign new_n196_ = (~x15 | x19) & (~new_n197_ | ~x18 | ~x21 | x14 | x15);
  ...
  assign new_n204_ = ~x18 & (x15 | (x05 & ~x07 & ~x09 & x17));
endmodule
