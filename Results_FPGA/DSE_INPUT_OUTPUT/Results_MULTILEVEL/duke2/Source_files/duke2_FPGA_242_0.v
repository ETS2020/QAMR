...
module FAU ( 
  ...
  assign z12 = z11 | (~x09 & (new_n124_ | new_n104_));
  assign new_n124_ = ~x07 & (new_n103_ | (~x17 & ~x21 & (~new_n125_ | new_n128_)));
  assign new_n125_ = ~new_n127_ & (x05 | (~new_n90_ & ~new_n96_ & (new_n126_ | x15)));
  ...
  assign new_n172_ = (new_n128_ | new_n173_) & ~x21;
  assign new_n173_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n174_ = new_n153_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n175_ = ~x05 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & ~new_n177_ & x18) | (~x09 & x17 & ~new_n187_ & ~x18);
  assign new_n177_ = ~new_n185_ & (x05 | (new_n178_ & (new_n183_ | x02)));
  assign new_n178_ = (~new_n182_ | ~x08) & (x07 | x09 | (x08 ? ~new_n180_ : new_n179_));
  assign new_n179_ = (~x15 | x19) & (~new_n99_ | x14 | x15 | ~x21);
