...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n69_, new_n71_, new_n73_, new_n74_, new_n75_, new_n79_, new_n81_,
    new_n84_, new_n85_;
  ...
  assign z03 = (~x09 & x17 & ~x18 & (~x05 | ~x07)) | (~x17 & x18);
  ...
  assign z14 = (~x17 & x18) | (~x05 & ~x09 & (new_n73_ | (~new_n75_ & ~x18)));
  assign new_n73_ = new_n74_ & x04 & ~x07 & x12;
  assign new_n74_ = ~x17 & ~x21 & ~x14 & ~x15;
  assign new_n75_ = (~x15 | (~x07 & ~x17)) & (~x07 | (x01 & ~x17));
  assign z15 = (~x17 & x18) | (x05 & ~x07 & ~x09 & ~x15 & x17 & ~x18);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~new_n79_ & ~x17;
  assign new_n79_ = ~x18 & (~new_n56_ | x07 | x09 | ~x04 | x05);
  assign z24 = ~x17 & (x18 | (~x05 & new_n81_ & ~x09));
  assign new_n81_ = ~x15 & ((x01 & x07 & x08) | (new_n69_ & x04 & ~x07));
  assign z26 = ~x20 & ~z07 & (x14 | x21);
  assign z28 = ~x09 & ~new_n84_ & ~x18;
  assign new_n84_ = (~x15 | ((x05 | ((~x17 | x19) & (~x07 | new_n85_ | x17))) & (x07 | ~x17))) & (~x05 | x07 | ~x17);
