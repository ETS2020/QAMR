...
module FAU ( 
  ...
  assign new_n68_ = x06 ? x11 : new_n69_;
  ...
  assign new_n73_ = ~x02 & (new_n74_ | (x06 & ~x07 & ~x08 & x18));
  assign new_n74_ = x01 & ~x05 & x07 & ~x18 & (x08 | x16);
  assign new_n75_ = (~x07 | (~x05 ^ x15)) & (x15 | (x05 ? new_n69_ : x07)) & (x05 | ~x15 | (x02 & x11));
  assign z03 = (~new_n79_ & ~x09) | new_n77_ | (x02 & ~x18);
  assign new_n77_ = x09 & ~x15 & ~x17 & x18 & new_n78_ & ~x05;
  ...
  assign z06 = ~x09 & ((~new_n91_ & ~x07) | (new_n105_ & ~x02 & ~x05 & x07));
  ...
  assign new_n104_ = x00 & ~x02 & ~x05 & x15 & x17 & ~x18;
  ...
  assign z09 = (new_n110_ & ~x17) | (new_n119_ & ~x02);
  ...
  assign z10 = (~x09 & (new_n124_ | (new_n122_ & ~x06))) | (new_n125_ & x08);
  assign new_n122_ = ~x07 & ~x08 & ~x17 & ~new_n123_ & x18;
  assign new_n123_ = x05 ^ ~x15;
  assign new_n124_ = ~x02 & x17 & ~x18 & (~x05 | ~x07);
  assign new_n125_ = ~x15 & ~x17 & x18 & (x05 ? x07 : (~x07 & x09));
  assign z11 = ~x18 & (new_n127_ | x02);
  assign new_n127_ = ~x09 & ~x15 & ~x17 & x01 & ~x05 & x07;
  assign z12 = new_n136_ | (~x09 & ((~new_n129_ & ~x07) | (new_n105_ & ~x05 & x07)));
  assign new_n129_ = (x17 | ~x18 | new_n130_ | x21) & (~new_n135_ | ~x15 | ~x17 | x18);
  assign new_n130_ = (new_n133_ | x04) & (~new_n134_ | ~x04) & (x05 | (~new_n93_ & new_n131_));
  assign new_n131_ = (new_n132_ | ~x08) & (x02 | ~x06 | x08 | ~x11 | x15);
  assign new_n132_ = (x02 | ~x11 | (~x15 & (x10 | x14))) & (x14 | x15 | x10 | x13);
  ...
  assign new_n137_ = x18 & (~new_n138_ | x07 | x08 | x05 | ~x06);
  assign new_n138_ = ~x09 & ~x11 & ~x15 & ~x17 & ~x21;
  assign z13 = ~x18 & (x02 | (~x09 & x17 & (~x05 | ~x07)));
  assign z14 = (~new_n145_ & ~x18) | (~x17 & (new_n143_ | (x08 & ~new_n141_ & x18)));
  assign new_n141_ = x07 ? (new_n123_ | x19) : (new_n142_ | (~x09 & x21));
  ...
  assign new_n148_ = ~x02 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign z17 = ~x09 & ((~new_n156_ & ~x05) | (new_n160_ & new_n78_ & ~x04 & x05));
  assign new_n156_ = (~new_n105_ | x02 | ~x07) & (x07 | (~new_n159_ & (~new_n157_ | x08)));
  assign new_n157_ = ~x15 & ~x17 & x18 & ~new_n158_ & (~x21 | (~x14 & x21));
  assign new_n158_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n159_ = x00 & ~x02 & x15 & x17 & ~x18;
  ...
  assign z20 = ~x07 & ~x17 & (new_n177_ | (~new_n168_ & ~x15));
  assign new_n168_ = x04 ? new_n169_ : (x05 | ~new_n176_ | x06);
  assign new_n169_ = ~new_n175_ & (x09 | (~new_n170_ & ~new_n174_));
  assign new_n170_ = ~x14 & (new_n173_ | (~x21 & (new_n172_ | (~new_n171_ & ~x02))));
  assign new_n171_ = (~x08 | ~x10 | ~x11 | x12 | ~x18) & (x05 | ~x12 | x18);
  assign new_n172_ = x08 & x10 & ~x12 & ~x13 & x18;
  assign new_n173_ = ~x05 & ~x06 & ~x08 & ~x12 & x18;
  assign new_n174_ = ~x12 & x18 & ~x21 & ~x05 & ~x06 & ~x08;
  assign new_n175_ = x05 & x08 & ~x12 & x18 & (x09 | ~x21);
  assign new_n176_ = ~x08 & ~x09 & x12 & x18 & (~x14 | ~x21);
  assign new_n177_ = new_n178_ & x08 & ~x09 & ~x04 & x05;
  assign new_n178_ = x18 & ~x21 & ~x11 & x15;
  assign z21 = (x02 & ~x18) | (~x17 & ~new_n180_ & x18);
  ...
  assign z24 = (x02 & ~x18) | (~x09 & ~x17 & (new_n185_ | new_n189_));
  ...
  assign z25 = (~x05 & ~x07 & ~x17 & ~new_n191_ & x18) | (x02 & ~x18);
  assign new_n191_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = (x02 & ~x18) | (~x20 & (x14 | x21));
  assign z27 = new_n136_ | new_n194_ | (new_n198_ & new_n78_ & x03 & ~x05);
  ...
  assign new_n196_ = ~x04 & ~new_n133_ & ~x21;
  assign new_n197_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n198_ = ~x17 & x18 & x19 & x09 & ~x15;
  assign z28 = new_n210_ | (~x17 & (new_n212_ | (x18 & (new_n200_ | new_n208_))));
  assign new_n200_ = ~x05 & ((~new_n205_ & ~x02) | new_n207_ | (new_n201_ & ~x07));
  ...
  assign new_n210_ = ~x02 & new_n211_ & ~x09;
  assign new_n211_ = x17 & ~x18 & ((~x07 & (x05 | x15)) | (~x05 & x15 & ~x19));
  assign new_n212_ = ~x02 & ~x05 & x07 & ~x09 & x15 & ~x18;
endmodule
