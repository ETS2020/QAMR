...
module FAU ( 
  ...
  assign new_n59_ = ~x12 & x18 & (new_n63_ | (~x09 & ~new_n60_ & ~x15));
  assign new_n60_ = (~x06 | x08 | new_n61_ | (~x02 ^ x11)) & (x02 | ~x08 | ~new_n62_ | ~x11);
  assign new_n61_ = x14 & x21;
  assign new_n62_ = x13 & ~x14 & ~x21 & (x04 | ~x10);
  ...
  assign z02 = new_n57_ | (~x17 & ((new_n73_ & x08) | (~new_n69_ & ~x09)));
  assign new_n69_ = (x15 | (~new_n70_ & (x07 | new_n71_ | ~x18))) & (x07 | new_n72_ | ~x18);
  assign new_n70_ = x01 & ~x05 & x07 & ~x18 & (x08 | x16);
  assign new_n71_ = x02 & ~x05 & x06 & x11;
  assign new_n72_ = (~x08 | (~x21 & (x04 | x11))) & (x05 | x08 | ~x15);
  assign new_n73_ = x18 & ((~x15 & (x05 | ~x07)) | (~x05 & x15 & (~x02 | x07 | ~x11)));
  ...
  assign new_n103_ = x08 & ~x11 & x15 & ~x17 & ~new_n64_ & x18;
  ...
  assign new_n121_ = ~new_n64_ & (new_n116_ | (x04 & x05 & ~x15));
  assign new_n122_ = new_n55_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n123_ = (~x12 | ~x18) & (x05 | x09 | new_n124_ | x18);
  assign new_n124_ = (~x15 | (~x07 & ~x17)) & (~x07 | (x01 & ~x17));
  assign z15 = new_n57_ | (new_n91_ & ~x15 & x05 & ~x07 & ~x09);
  assign z16 = x18 & (x12 | (x08 & (new_n127_ | new_n130_) & ~x17));
  ...
  assign z20 = ~x07 & ~x17 & (new_n147_ | (x04 & ~new_n142_ & ~x15));
  assign new_n142_ = (x12 | new_n143_ | ~x18) & (~new_n146_ | x05 | x09 | ~x12);
  ...
  assign new_n147_ = new_n66_ & ~x04 & x05 & x08 & ~x09;
  assign z21 = x18 & (x12 | (~new_n149_ & ~x17));
  assign new_n149_ = (new_n150_ | x07) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign new_n150_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x12 | x15);
  assign z22 = ~x12 & ~x17 & ~new_n152_ & x18;
  assign new_n152_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15)));
  assign z23 = x18 & (new_n154_ | x12);
  assign new_n154_ = ~x05 & ~x07 & x08 & x09 & ~x15 & ~x17;
  assign z24 = new_n57_ | (~x09 & ~x17 & (new_n156_ | new_n160_));
  assign new_n156_ = ~x07 & (new_n157_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n157_ = ~x21 & ((x04 & ~new_n158_ & ~x15) | (x08 & new_n159_ & x15));
  assign new_n158_ = x05 ? (~x08 | ~x18) : (~x12 | x14);
  assign new_n159_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n160_ = x08 & ~x15 & ~x18 & x01 & ~x05 & x07;
  assign z25 = ~x05 & new_n162_ & ~x07;
  assign new_n162_ = ~x12 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & ~new_n57_ & (x14 | x21);
  assign z27 = new_n171_ | (~x09 & (new_n165_ | new_n173_));
  assign new_n165_ = ~x12 & ~x17 & x18 & (x05 ? ~new_n169_ : ~new_n166_);
  assign new_n166_ = (~new_n167_ | ~x07 | ~x08) & (~new_n168_ | ~x02 | ~x06 | x07);
  assign new_n167_ = x15 & x19;
  assign new_n168_ = ~x08 & ~x11 & ~x15 & ~x21;
  assign new_n169_ = (x07 | ((~new_n170_ | x04 | ~x08) & (x08 | x15 | ~x19))) & (~x07 | ~x08 | x15 | ~x19);
