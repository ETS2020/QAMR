...
module FAU ( 
  ...
  assign new_n87_ = (~new_n88_ | ~x06 | x08) & (~new_n70_ | ~x13 | x06 | ~x08 | x10);
  ...
  assign new_n167_ = (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15))) & (x09 | x15 | ~x18 | ~x05 | ~x06 | x08);
  ...
  assign new_n179_ = new_n157_ & x03 & x08 & x09 & ~x15 & x19;
