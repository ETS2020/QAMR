...
module FAU ( 
  ...
  assign new_n112_ = (x07 | (x05 ? ~new_n119_ : new_n113_)) & (~new_n120_ | ~x05) & ~x17;
  ...
  assign new_n121_ = ~x17 & (~new_n56_ | x14 | ~x04 | x05 | ~x12);
  ...
  assign z12 = (x17 & x18) | (~x09 & (new_n127_ | (new_n107_ & ~x15 & x17 & ~x18)));
  assign new_n127_ = ~x07 & (new_n137_ | (x18 & (~new_n128_ | new_n135_) & ~x21));
  ...
  assign new_n142_ = new_n143_ & new_n56_ & ~x15 & x12 & ~x14;
  ...
  assign z17 = (~new_n154_ & ~x09) | (x17 & x18);
  assign new_n154_ = (new_n155_ | x05) & (~new_n158_ | x04 | ~x05 | x07 | ~x08);
  assign new_n155_ = x07 ? (x15 | ~x17) : ((x08 | ~new_n156_ | x15) & (~x00 | ~x15 | ~x17));
  assign new_n156_ = x18 & ~new_n157_ & (~x21 | (~x14 & ~x17 & x21));
  ...
  assign new_n165_ = ~new_n166_ & (~new_n158_ | x04 | ~x05 | ~x08 | x09);
  ...
  assign new_n170_ = x04 & ~x05 & ~x09 & new_n56_ & x12 & ~x14;
  ...
  assign z22 = x18 & (new_n176_ | x17 | (new_n107_ & x08 & x15));
  ...
  assign new_n184_ = new_n107_ & x01 & x08 & ~x15 & ~x18;
