...
module FAU ( 
  ...
  assign z09 = ~x17 & (new_n111_ | (x18 & (new_n112_ | (~new_n103_ & ~x07))));
  ...
  assign new_n111_ = new_n54_ & new_n55_ & ~x15 & ~x18 & ~x21;
  ...
  assign z12 = (x17 & ~x18) | (~x07 & ~x09 & ~x17 & new_n118_ & x18);
  ...
  assign z28 = ~x17 & (new_n192_ | (x18 & (new_n181_ | new_n190_)));
  ...
  assign new_n192_ = ~x05 & x07 & ~x09 & x15 & ~new_n68_ & ~x18;
  assign z15 = 1'b0;
  assign z19 = 1'b0;
endmodule
