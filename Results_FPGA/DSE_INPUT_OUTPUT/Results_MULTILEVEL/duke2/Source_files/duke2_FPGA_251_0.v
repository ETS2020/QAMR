...
module FAU ( 
  ...
  assign z13 = ~x18 & ((~new_n118_ & ~x09) | ~x17);
  ...
  assign z17 = new_n77_ | (~x09 & (new_n147_ | (~new_n144_ & ~x05)));
  ...
  assign new_n150_ = (x14 | (~new_n80_ & ~new_n151_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n164_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)))));
  ...
  assign new_n174_ = (new_n124_ | new_n175_) & ~x21;
