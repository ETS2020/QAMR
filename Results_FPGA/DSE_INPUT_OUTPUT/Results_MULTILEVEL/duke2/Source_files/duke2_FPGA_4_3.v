...
module FAU ( 
  ...
  assign z12 = ~x09 & (new_n105_ | (~x07 & (new_n107_ | (new_n128_ & ~x17))));
  ...
  assign new_n156_ = (new_n157_ | ~x12) & (~x02 | (~new_n85_ & ~new_n159_));
  assign new_n157_ = (x06 | (~new_n158_ & (~new_n90_ | ~x08 | ~x10))) & (~new_n88_ | ~x06 | ~x08 | ~x10);
  ...
  assign new_n162_ = (new_n163_ | ~x18) & (~new_n167_ | x18 | x21 | x14 | x17);
  ...
  assign new_n180_ = new_n106_ & x01 & x08 & ~x15 & ~x17 & ~x18;
