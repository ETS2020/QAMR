...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n93_ & ~x07) | (~x05 & x07 & new_n105_ & ~x15));
  assign new_n93_ = (x17 | ~x18 | (~new_n102_ & (new_n94_ | x15))) & (~new_n104_ | ~x15 | ~x17 | x18);
  ...
  assign new_n98_ = (x06 | ((x13 | x16 | ~x10 | ~x12) & (~x02 | x10 | ~x13))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  ...
  assign z12 = new_n81_ | (~x09 & ((~new_n127_ & ~x07) | (new_n139_ & ~x05 & x07)));
  assign new_n127_ = (~new_n128_ | ~x18) & (~new_n104_ | ~x15 | ~x17);
  ...
  assign new_n164_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  assign new_n165_ = (~x06 | x08 | x11 | ~x21) & (x06 | ~x08 | x10 | ~x13 | x21);
  assign new_n166_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & new_n168_ & ~x09;
  assign new_n168_ = ~x05 & ~x07;
  assign z20 = new_n81_ | (~new_n170_ & ~x07);
  assign new_n170_ = ~new_n171_ & (~new_n160_ | x04 | ~x05 | ~x08 | x09);
  ...
  assign new_n175_ = new_n55_ & ~x09 & x12 & new_n56_ & ~x14 & ~x17;
  ...
  assign z23 = x18 & (x17 | (new_n168_ & x08 & x09 & ~x15));
  ...
  assign z27 = (x18 & (new_n195_ | x17)) | (~x09 & (new_n196_ | (~new_n192_ & x18)));
  ...
  assign new_n195_ = new_n168_ & x03 & x08 & x09 & ~x15 & x19;
