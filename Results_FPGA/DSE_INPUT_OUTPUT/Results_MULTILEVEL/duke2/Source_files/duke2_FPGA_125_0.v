...
module FAU ( 
  ...
  assign z06 = new_n68_ | (~x09 & ((~new_n94_ & ~x07) | (new_n108_ & ~x05 & x07)));
  ...
  assign z09 = (~new_n120_ & ~x18) | (~x17 & (new_n122_ | (~new_n113_ & x18)));
  assign new_n113_ = (x07 | ((new_n114_ | x05) & (~new_n64_ | ~x05 | ~x08))) & (~x05 | ~new_n79_ | ~x08);
  ...
  assign new_n122_ = ~x09 & ~x15 & ~x19 & x05 & ~x07 & ~x08;
  ...
  assign new_n130_ = (~new_n133_ | ~x04) & (x05 | (~new_n96_ & ~new_n131_ & ~new_n104_));
  assign new_n131_ = ~x15 & (new_n132_ | (x06 & ~x08 & (~x02 ^ ~x11)));
  assign new_n132_ = x08 & ~x10 & ~x13 & ~x14;
  assign new_n133_ = x08 & ~x12 & ~new_n106_ & ~x15;
  ...
  assign z14 = (~new_n139_ & ~x17) | (~x18 & (new_n144_ | ~x19));
  assign new_n139_ = ~new_n140_ & (~new_n143_ | ~x04 | x05 | x07 | x09);
  assign new_n140_ = x08 & (x07 ? new_n142_ : (~new_n64_ & ~new_n141_ & x18));
  ...
  assign z28 = (new_n207_ & ~x07) | (~x17 & (new_n195_ | (~x05 & new_n206_ & x07)));
  ...
  assign new_n206_ = ~x09 & x15 & ~x18 & x19 & (~x02 | ~x11);
  assign new_n207_ = ~x09 & x17 & ~x18 & x19 & (x05 | x15);
endmodule
