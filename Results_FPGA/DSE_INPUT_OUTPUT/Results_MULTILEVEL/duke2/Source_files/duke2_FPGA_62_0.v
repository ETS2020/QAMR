...
module FAU ( 
  ...
  assign new_n84_ = ~x17 & x18 & (new_n85_ | new_n88_ | (~new_n90_ & x02));
  ...
  assign z06 = (~x11 & ~x18) | (~x09 & (new_n105_ | (~new_n92_ & ~x07)));
  assign new_n92_ = ~new_n104_ & (x17 | new_n93_ | ~x18);
  ...
  assign z09 = new_n119_ | (~x17 & ~new_n110_ & x18);
  ...
  assign new_n119_ = ~x07 & ~x09 & x11 & ~x15 & ~new_n120_ & ~x18;
  ...
  assign new_n125_ = ~x15 & x11 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (~new_n127_ & ~x09) | (~x11 & ~x18);
  assign new_n127_ = ~new_n105_ & (x07 | (~new_n104_ & (x17 | new_n128_ | x21)));
  assign new_n128_ = ~new_n129_ & ~new_n135_ & (x05 | (~new_n137_ & (new_n131_ | ~x18)));
  assign new_n129_ = ~x04 & (new_n130_ | (x05 & x08 & ~x11 & x15));
  assign new_n130_ = x12 & ~x15 & x18 & ~x05 & ~x06 & ~x08;
  assign new_n131_ = (~x04 | new_n132_ | x12) & ~new_n134_ & (new_n133_ | ~x08);
  assign new_n132_ = (~x11 | x14 | x02 | ~x08) & (x06 | x08 | x15);
  assign new_n133_ = (x02 | ~x11 | (~x15 & (x10 | x14))) & (x14 | x15 | x10 | x13);
  assign new_n134_ = ~x02 & x06 & ~x08 & x11 & ~x15;
  assign new_n135_ = x04 & new_n136_ & x08;
  assign new_n136_ = ~x12 & ~x15 & x18 & (x05 | (~x13 & ~x14));
  assign new_n137_ = x02 & x06 & ~x08 & ~x11 & ~x15;
  ...
  assign new_n146_ = x17 & ~x15 & x11 & ~x09 & x05 & ~x07;
  assign z16 = (~x11 & ~x18) | (x08 & ~x17 & ~new_n148_ & x18);
  ...
  assign z17 = (~x11 & ~x18) | (~x09 & (new_n157_ | (~new_n154_ & ~x05)));
  assign new_n154_ = (x07 | (~new_n155_ & (~x17 | x18 | ~x00 | ~x15))) & (~x07 | x15 | ~x17 | x18);
  assign new_n155_ = ~x08 & ~x15 & ~x17 & ~new_n156_ & (~x21 | (~x14 & x21));
  assign new_n156_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12 | ~x18);
  assign new_n157_ = new_n67_ & ~x11 & x15 & ~x17 & ~x21;
  assign z18 = (~x11 & ~x18) | (~x05 & ~x07 & new_n159_ & ~x09);
  assign new_n159_ = ~x17 & (new_n160_ | (x18 & x19 & ~x08 & x15));
  assign new_n160_ = ~x14 & ~x15 & ((~new_n161_ & x02) | (new_n163_ & x12));
  assign new_n161_ = (~x06 | x08 | x11 | ~x21) & (~new_n162_ | x06 | ~x08 | x10);
  assign new_n162_ = x13 & x18 & ~x21;
  assign new_n163_ = x18 & ((~new_n164_ & ~x06) | (new_n87_ & x06 & x08 & x10));
  ...
  assign new_n168_ = (x09 | ((~new_n169_ | ~x04) & (~new_n172_ | x05))) & (~x04 | ~new_n171_ | ~x05);
  ...
  assign new_n198_ = ~x17 & x18 & x19 & x09 & ~x15;
  assign z28 = new_n210_ | (~x17 & (new_n200_ | (~x05 & ~new_n212_ & x15)));
  assign new_n200_ = x18 & (new_n208_ | (~x05 & (~new_n201_ | (~new_n206_ & ~x02))));
  assign new_n201_ = x07 ? (~x08 | ~x15) : (x09 | (x08 ? ~new_n204_ : new_n202_));
  ...
  assign new_n210_ = ~x18 & (new_n211_ | ~x11);
  assign new_n211_ = ~x09 & x17 & ((~x07 & (x05 | x15)) | (~x05 & x15 & ~x19));
  assign new_n212_ = (~x08 | x11) & (x02 | ~x07 | x09 | x18);
endmodule
