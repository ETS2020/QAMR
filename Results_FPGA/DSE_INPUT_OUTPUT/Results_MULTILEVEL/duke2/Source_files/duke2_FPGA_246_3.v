...
module FAU ( 
  ...
  assign z00 = (~x09 & ~new_n54_ & ~x18) | (x01 & x18);
  ...
  assign z02 = (x01 & x18) | (~x17 & (new_n70_ | (x08 & ~new_n77_ & x18)));
  ...
  assign new_n97_ = x06 & ((new_n98_ & ~x02) | (new_n100_ & new_n99_ & ~x01));
  assign new_n98_ = ~x08 & x11;
  assign new_n99_ = x08 & x10;
  assign new_n100_ = x12 & ~x13 & ~x14 & x16;
  assign new_n101_ = x08 & ~x14 & ((~x10 & ~x13) | (new_n102_ & ~x01));
  ...
  assign new_n105_ = ~x15 & (new_n106_ | (~x02 & x06 & x11));
  ...
  assign new_n118_ = (new_n119_ | ~x04) & (~new_n120_ | ~x02) & (~new_n98_ | x02 | ~x06);
  ...
  assign new_n124_ = ~x07 & ~x09 & ~x15 & ~new_n125_ & ~x18;
  assign new_n125_ = ~x17 & (~x04 | x05 | ~x12 | x14 | x21);
  assign z10 = z13 | (~x01 & ~x17 & ~new_n127_ & x18);
  assign new_n127_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = ~new_n130_ & x01;
  assign new_n130_ = ~x18 & (x05 | ~x07 | x09 | x15 | x17);
  assign z12 = new_n68_ | (~x09 & (new_n111_ | (~new_n132_ & ~x07)));
  assign new_n132_ = ~new_n109_ & (x17 | ~x18 | (new_n133_ & ~new_n137_) | x21);
  assign new_n133_ = (~new_n136_ | ~x04) & (x05 | (~new_n95_ & ~new_n134_ & ~new_n103_));
  assign new_n134_ = ~x15 & (new_n135_ | (x06 & ~x08 & (~x02 ^ ~x11)));
  assign new_n135_ = ~x13 & ~x14 & x08 & ~x10;
  assign new_n136_ = x08 & ~x12 & ~new_n108_ & ~x15;
  ...
  assign new_n144_ = (~x01 | ~x18) & (x05 | x09 | new_n145_ | x18);
  assign new_n145_ = (~x15 | (~x07 & ~x17)) & (~x07 | (x01 & ~x17));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x18 & (x01 | (x08 & ~x17 & (new_n148_ | new_n152_)));
  ...
  assign z17 = new_n68_ | (~x09 & (new_n157_ | (~new_n154_ & ~x05)));
  assign new_n154_ = (x07 | ((x08 | ~new_n155_ | x15) & (~new_n110_ | ~x00 | ~x15))) & (~new_n110_ | ~x07 | x15);
  ...
  assign z18 = ~x01 & ~x05 & ~x07 & ~x09 & new_n159_ & ~x17;
  assign new_n159_ = x18 & ((~x14 & ~new_n160_ & ~x15) | (~x08 & x15 & x19));
  assign new_n160_ = ~new_n85_ & (~x12 | ((new_n161_ | x06) & (~new_n89_ | ~new_n99_ | ~x06)));
  assign new_n161_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = new_n68_ | (~x05 & ~x07 & ~x09 & new_n110_ & ~x15);
  assign z20 = ~x07 & ~x17 & (new_n170_ | (~x01 & ~new_n164_ & x18));
  assign new_n164_ = (new_n165_ | x15) & (~new_n169_ | x09 | x11 | ~x15 | x21);
  assign new_n165_ = (x09 | ((~new_n166_ | ~x04) & (~new_n168_ | x05))) & (~x04 | ~new_n167_ | ~x05);
  assign new_n166_ = x08 & x10 & ~x12 & ~x14 & ~new_n151_ & ~x21;
  assign new_n167_ = x08 & ~new_n64_ & ~x12;
  assign new_n168_ = ~x06 & ~x08 & (~x14 | ~x21) & (x04 ^ x12);
  assign new_n169_ = ~x04 & x05 & x08;
  assign new_n170_ = new_n171_ & x04 & ~x05 & ~x09 & x12;
  assign new_n171_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign z21 = ~x01 & ~x17 & ~new_n173_ & x18;
  assign new_n173_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = x18 & (new_n175_ | x01);
  assign new_n175_ = ~x17 & ((~new_n176_ & ~x07) | (x08 & x15 & ~x05 & x07));
  assign new_n176_ = (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (x08 | x09 | x15 | x01 | ~x05 | ~x06);
  assign z23 = x18 & new_n178_ & ~x17;
  assign new_n178_ = ~x15 & x09 & x08 & ~x07 & ~x01 & ~x05;
  assign z24 = ~x09 & ~x17 & (new_n180_ | new_n185_);
  assign new_n180_ = ~x07 & ((~new_n181_ & ~x21) | (new_n184_ & ~x01 & ~x05));
  assign new_n181_ = (~x04 | new_n182_ | x15) & (x01 | ~x08 | ~new_n183_ | ~x15);
  assign new_n182_ = (x01 | ~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18);
  ...
  assign new_n191_ = ~new_n193_ & (x21 | (~new_n137_ & ~new_n192_));
  ...
  assign z28 = (~new_n199_ & ~x17) | (x01 & x18) | (~x09 & x17 & ~new_n211_ & ~x18);
  ...
  assign new_n204_ = (~x15 | x19) & (~new_n106_ | x14 | x15 | ~x21);
