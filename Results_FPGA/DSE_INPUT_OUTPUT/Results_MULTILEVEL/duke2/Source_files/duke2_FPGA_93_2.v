...
module FAU ( 
  ...
  assign new_n121_ = ~x07 & ~x09 & ~x13 & ~x15 & ~new_n122_ & ~x18;
  assign new_n122_ = ~x17 & (~x04 | x05 | ~x12 | x14 | x21);
  assign z10 = (~x17 & ~new_n124_ & x18) | (~x09 & ~x13 & x17 & ~new_n81_ & ~x18);
  assign new_n124_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x08 | x09 | x06 | x07))) & (~x08 | ~x09 | x05 | x07))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z11 = ~x18 & new_n126_ & ~x17;
  assign new_n126_ = ~x15 & ~x13 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n84_ | (~x09 & (new_n107_ | (~new_n128_ & ~x07)));
  ...
  assign new_n145_ = new_n146_ & new_n135_ & ~x15 & ~x18 & ~x21;
  assign new_n146_ = x04 & ~x05 & ~x07 & ~x09 & x12;
  ...
  assign new_n160_ = x15 & x17 & ~x18 & x00 & ~x13;
  ...
  assign z20 = new_n84_ | (~x07 & ~x17 & (new_n175_ | (~new_n169_ & ~x15)));
  ...
  assign new_n172_ = x08 & x10 & ~x12 & ~x14 & ~new_n154_ & ~x21;
  ...
  assign z24 = new_n84_ | (~x09 & ~x17 & (new_n182_ | new_n186_));
  ...
  assign z25 = (x13 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n188_ & x18);
  assign new_n188_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = ~x20 & ~new_n84_ & (x14 | x21);
  assign z27 = new_n196_ | (~x09 & (new_n194_ | (~x17 & ~new_n191_ & x18)));
  ...
  assign new_n195_ = ~x13 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n196_ = new_n197_ & ~x07 & x08 & x03 & ~x05;
  assign new_n197_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = ((new_n199_ | new_n210_) & ~x17) | (~x09 & ~x13 & new_n212_ & x17);
  ...
  assign new_n211_ = ~x09 & ~x13 & x15 & ~x18 & (~x02 | ~x11);
