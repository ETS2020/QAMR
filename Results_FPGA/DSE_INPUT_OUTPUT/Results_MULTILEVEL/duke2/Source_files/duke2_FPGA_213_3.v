...
module FAU ( 
  ...
  assign new_n98_ = (x06 | ((x13 | x16 | ~x10 | ~x12) & (~x02 | x10 | ~x13))) & (x10 | x13);
  ...
  assign z11 = (x17 & x18) | (new_n125_ & x01 & ~x17 & ~x18 & ~x09 & ~x15);
  assign new_n125_ = ~x05 & x07;
  assign z12 = (x17 & x18) | (~x09 & (new_n127_ | (new_n125_ & ~x15 & x17)));
  assign new_n127_ = ~x07 & (new_n134_ | (x18 & ~x21 & (~new_n128_ | new_n132_)));
  assign new_n128_ = (x05 | (~new_n93_ & ~new_n129_ & ~new_n101_)) & (~new_n131_ | ~x04);
  ...
  assign new_n172_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)))));
  assign z23 = x18 & (x17 | (new_n174_ & ~x05 & ~x07));
  ...
  assign new_n180_ = new_n125_ & x01 & x08 & ~x15 & ~x18;
  ...
  assign new_n188_ = new_n189_ & ~x07 & x08 & x03 & ~x05;
