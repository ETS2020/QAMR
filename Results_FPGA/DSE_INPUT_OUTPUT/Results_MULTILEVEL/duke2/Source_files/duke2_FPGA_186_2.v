...
module FAU ( 
  ...
  assign z02 = ~x17 & ((~new_n68_ & x18) | (new_n77_ & new_n76_ & ~x16 & ~x18));
  assign new_n68_ = ~new_n72_ & (~x08 | (~new_n69_ & new_n74_)) & (x07 | ~new_n75_ | x08);
  assign new_n69_ = ~x09 & ((~x07 & (x21 ? x15 : ~new_n70_)) | (x21 & (~x05 ^ ~x15)));
  assign new_n70_ = (x02 | x05 | ~new_n71_ | ~x11) & (x04 | ~x05 | x11 | ~x15);
  assign new_n71_ = x13 & ~x14 & (~x10 | (x04 & ~x12));
  assign new_n72_ = ~new_n73_ & (~x02 | ~x11);
  assign new_n73_ = (x05 | ~x08 | ~x15) & (~x06 | x07 | x08 | x09 | x15);
  assign new_n74_ = x05 ? (x15 | (x04 & ~x07 & x12)) : (x07 ^ x15);
  assign new_n75_ = ~x09 & (x15 ? ~x05 : (x05 | (~x06 & (~x04 | ~x12))));
  assign new_n76_ = ~x09 & ~x15;
  assign new_n77_ = x01 & ~x05 & x07 & x08;
  assign z03 = (~new_n79_ & ~x09) | (new_n82_ & x09 & ~x15 & ~x17 & x18);
  assign new_n79_ = (x17 | new_n80_ | ~x18) & (x16 | ~x17 | new_n81_ | x18);
  ...
  assign new_n107_ = x00 & ~x05 & x15 & new_n108_ & ~x16;
  assign new_n108_ = x17 & ~x18;
  assign new_n109_ = new_n108_ & ~x16 & ~x05 & x07 & ~x15;
  ...
  assign new_n123_ = ~x16 & (x07 | x09 | x15 | (~new_n124_ & ~x17));
  assign new_n124_ = x04 & ~x05 & x12 & ~x14 & ~x21;
  assign z10 = (~x17 & ~new_n126_ & x18) | (~x09 & ~x16 & x17 & ~new_n81_ & ~x18);
  ...
  assign z13 = ~x18 & (x16 | (~x09 & ~new_n81_ & x17));
  ...
  assign z17 = (x16 & ~x18) | (~x09 & (new_n156_ | (~new_n153_ & ~x05)));
  ...
  assign z24 = (x16 & ~x18) | (~x09 & ~x17 & (new_n177_ | new_n181_));
  ...
  assign z27 = new_n186_ | new_n191_ | (x16 & ~x18);
