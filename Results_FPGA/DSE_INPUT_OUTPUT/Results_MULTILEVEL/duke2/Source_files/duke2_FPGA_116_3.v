...
module FAU ( 
  ...
  assign z12 = (x15 & x18) | (~x09 & (new_n91_ | (~new_n113_ & ~x07)));
  assign new_n113_ = ~new_n93_ & (x17 | ~x18 | x21 | (~new_n114_ & ~new_n117_));
  ...
  assign z17 = (x15 & x18) | (~x05 & ~x09 & (new_n133_ | new_n136_));
  assign new_n133_ = ~x07 & ((~x08 & new_n134_ & ~x17) | (x00 & x15 & x17));
  assign new_n134_ = x18 & ~new_n135_ & (~x21 | (~x14 & ~x15 & x21));
  assign new_n135_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n136_ = x17 & ~x18 & x07 & ~x15;
  assign z18 = ~x05 & ~x07 & ~x09 & new_n138_ & ~x14;
  assign new_n138_ = ~x15 & ~x17 & x18 & (new_n139_ | (~new_n142_ & x02));
  ...
  assign new_n157_ = (x07 | (~new_n158_ & (x05 | x08 | ~x18))) & (~x07 | ~x08 | x18 | ~x01 | x05);
  ...
  assign z27 = (~new_n163_ & ~x09) | (new_n166_ & new_n167_ & x09 & ~x15);
  assign new_n163_ = (x15 | ((x17 | new_n164_ | ~x18) & (~new_n92_ | ~x17 | x18))) & (~new_n165_ | ~x15 | ~x17 | x18);
  assign new_n164_ = x05 ? (~x19 | (~x07 ^ ~x08)) : (x07 | x08 | new_n135_ | x21);
  assign new_n165_ = new_n56_ & x00;
  assign new_n166_ = x03 & ~x05 & ~x07 & x08;
  assign new_n167_ = ~x17 & x18 & x19;
  assign z28 = (~x09 & (new_n180_ | (~new_n169_ & ~x05))) | (~x04 & new_n178_ & x05);
  assign new_n169_ = ~new_n177_ & (x17 | (~new_n170_ & ~new_n176_ & (~new_n173_ | x07)));
  assign new_n170_ = ~x02 & ((new_n171_ & new_n172_) | (x07 & x15 & ~x18));
  assign new_n171_ = x06 & ~x07 & ~x08 & x11;
  assign new_n172_ = ~x14 & ~x15 & x18 & x21;
  assign new_n173_ = ~x14 & ~x15 & x18 & (new_n175_ | (new_n174_ & x08));
  assign new_n174_ = x10 & x12 & ~x21 & (x02 | x11 | ~x13);
  assign new_n175_ = x04 & ~x06 & ~x08 & ~x12 & x21;
  assign new_n176_ = x15 & ~x18 & x07 & ~x11;
  assign new_n177_ = x15 & x17 & ~x18 & ~x19;
  assign new_n178_ = ~x07 & new_n179_ & x08;
  assign new_n179_ = x12 & ~x15 & ~x17 & x18 & (x09 | ~x21);
