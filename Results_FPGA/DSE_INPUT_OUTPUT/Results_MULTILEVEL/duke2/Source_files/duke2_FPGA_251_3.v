...
module FAU ( 
  ...
  assign new_n106_ = ~x17 & (~new_n79_ | ~x09 | x15 | ~x16);
  ...
  assign new_n119_ = ~x17 & (~x04 | x05 | ~x12 | ~new_n56_ | x14);
  assign z10 = (x18 & (new_n122_ | new_n123_ | x17)) | (~x09 & ~new_n121_ & x17);
  assign new_n121_ = x05 & x07;
  assign new_n122_ = ~x15 & ((x05 & ((x07 & x08) | (~x06 & ~x07 & ~x08 & ~x09))) | (x08 & x09 & ~x05 & ~x07));
  ...
  assign new_n127_ = ~new_n137_ & (x17 | ~x18 | (new_n128_ & ~new_n135_) | x21);
  ...
  assign new_n137_ = new_n103_ & new_n138_ & x15;
  ...
  assign new_n145_ = new_n146_ & new_n56_ & ~x15 & ~x17;
  assign new_n146_ = x04 & ~x07 & x12 & ~x14;
  ...
  assign new_n177_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((x09 | ~x15 | ~x06 | x08) & (~x08 | ~x09 | x15)))));
  ...
  assign new_n192_ = new_n165_ & x03 & x08 & x09 & ~x15 & x19;
