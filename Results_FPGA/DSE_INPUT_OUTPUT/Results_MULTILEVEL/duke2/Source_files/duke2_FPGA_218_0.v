...
module FAU ( 
  ...
  assign new_n154_ = x08 & x10 & ~x12 & ~x14 & ~new_n137_ & ~x21;
  assign new_n155_ = x08 & ~new_n61_ & ~x12;
  assign new_n156_ = ~x06 & ~x08 & (~x14 | ~x21) & (~x04 ^ ~x12);
  assign z21 = ~x17 & ((~new_n158_ & ~x07) | ~x18 | (new_n159_ & ~x05 & x07));
  assign new_n158_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  assign new_n159_ = x08 & ~x09 & x15;
