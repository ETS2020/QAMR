// Benchmark "FAU" written by ABC on Wed Aug 19 00:23:54 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n197_, new_n199_, new_n201_, new_n204_, new_n205_, new_n206_,
  ...
  assign z03 = z32 | (x33 & (new_n139_ | (~x32 & (new_n121_ | new_n133_))));
  assign new_n121_ = ~x35 & (new_n122_ | (~x34 & (~new_n132_ | (~new_n130_ & x40))));
  assign new_n122_ = ~x36 & ((~x38 & (new_n123_ | (~new_n125_ & x37))) | (~new_n128_ & ~x37));
  assign new_n123_ = x02 & ((x37 & ~x39) | (new_n124_ & x00));
  assign new_n124_ = ~x01 & ~x03 & x04 & (~x39 | (~x37 & ~x40));
  assign new_n125_ = (~x40 | (~new_n127_ & x39)) & (x39 | (new_n126_ & ~x01));
  assign new_n126_ = ~x03 & ~x04;
  assign new_n127_ = ~x05 & x15 & (x11 | x12) & (~x21 | ~x22);
  assign new_n128_ = (~x38 | (~x39 & (~x34 | x39 | x40))) & (~new_n129_ | x04 | x39 | x40);
  assign new_n129_ = x00 & ~x01;
  assign new_n130_ = (new_n131_ | x38) & (~x00 | new_n84_ | (~x37 & (~x38 | ~x39)));
  ...
  assign new_n138_ = x39 & ((~x38 & ~x40) | (new_n129_ & ~x04 & x38 & x40));
  ...
  assign new_n143_ = x40 & (x05 | ~x13 | (~new_n98_ & x15));
  assign new_n144_ = (x34 | ~x39 | ~x40 | (~new_n100_ & ~x37)) & (~x34 | ~x36 | x37 | x39 | x40);
  assign new_n145_ = x00 & ~x01 & ~x04 & ((x39 & ~x40) | (~x37 & ~x39 & x40));
  assign new_n146_ = (x40 | ((x36 | x37 | x39) & (x34 | ~x37 | ~x39))) & (x34 | x37 | new_n88_ | x39);
  assign new_n147_ = (~x35 | ((new_n148_ | ~x38) & (x37 | ~new_n149_ | x38))) & (~new_n108_ | x37 | ~x38);
  ...
  assign new_n161_ = (~x35 | ~x39 | x40) & (x37 | ((~x39 | new_n98_ | ~x40) & (~x35 | (~new_n149_ & ~x39))));
  ...
  assign new_n166_ = (~new_n93_ | x37) & (~x00 | new_n167_ | x01);
  assign new_n167_ = (x04 | ((~x39 | x40) & (~x37 | x39 | ~x40))) & (~new_n159_ | ~x04 | ~x37);
  assign new_n168_ = ~x36 & ~x37 & x39 & (x40 | (new_n129_ & new_n159_));
  ...
  assign new_n180_ = (x35 | (~new_n183_ & (~x34 | new_n181_ | x36))) & (x34 | ~x35 | ~new_n184_ | ~x36);
  assign new_n181_ = (x37 | ~x38 | x39) & (~x40 | (x38 ? x39 : (~x39 | (~new_n182_ & x37))));
  assign new_n182_ = ~x05 & x15 & x21 & ~new_n98_ & x22;
  assign new_n183_ = new_n100_ & ~x34 & x36 & new_n89_ & ~x37 & ~x38;
  assign new_n184_ = ~x37 & x38 & (~x39 ^ ~x40);
  assign z08 = z32 | (x33 & ((~z32 & x07) | (~x32 & new_n186_ & ~x35)));
  assign new_n186_ = x40 & ((new_n187_ & ~x37 & ~x38 & x39) | (x38 & ~x39 & ~x36 & x37));
  ...
  assign new_n192_ = x21 & x22 & ~new_n98_ & (x20 | x25);
  ...
  assign new_n197_ = ~x40 & ((~x34 & x35 & x36 & x37 & x38) | (~x36 & ~x37 & ~x38 & x34 & ~x35));
  assign z13 = z32 | (x33 & (new_n199_ | x07));
  assign new_n199_ = ~x37 & ~x38 & ~x39 & new_n104_ & ~x32;
  assign z14 = x33 & (new_n110_ | (new_n201_ & new_n101_ & ~x38 & ~x39));
  assign new_n201_ = new_n104_ & x13 & ~x32;
  ...
  assign new_n206_ = new_n103_ & ~x38;
  assign new_n207_ = ~x02 & ~x03 & x04;
  assign new_n208_ = (~new_n103_ | ~x37) & (~x00 | ~new_n209_ | x01);
  ...
  assign z17 = x33 & (new_n110_ | (~new_n213_ & ~x32));
  assign new_n213_ = (x34 | ~x35 | ~new_n221_ | ~x36) & (x35 | (x34 ? (new_n214_ | x36) : (~new_n219_ | ~x36)));
  assign new_n214_ = (new_n215_ | ~x02) & ~new_n217_ & (x05 | ~new_n218_ | ~x15);
  assign new_n215_ = new_n83_ & (~x00 | ~new_n216_ | x01);
  assign new_n216_ = ~x03 & x04 & ((~x38 & ~x39) | (~x37 & x39 & ~x40));
  assign new_n217_ = ~new_n83_ & (~new_n126_ | x01);
  assign new_n218_ = x37 & new_n160_ & ~x38;
  assign new_n219_ = x38 & (new_n220_ | (new_n88_ & new_n103_ & ~x37));
  ...
  assign new_n236_ = x01 & x04 & x35 & new_n103_ & ~x38;
  ...
  assign new_n254_ = x37 & x38 & (new_n108_ | x35);
  assign new_n255_ = (~x34 | x36 | ~x37 | (x15 & (x11 | x12))) & (~x11 | x34 | ~x36 | x37);
  assign z21 = (~x33 & (x34 | x36)) | (~x07 & (x34 ? new_n261_ : (~new_n257_ & x36)));
  assign new_n257_ = (new_n258_ | ~x35) & ~x32 & (~new_n260_ | x00);
  ...
  assign new_n261_ = ~x35 & ((~new_n262_ & ~x36) | (new_n206_ & x32 & ~x37));
  ...
  assign new_n271_ = ~x01 & ~x02 & ~x03 & new_n103_ & ~x04;
  ...
  assign new_n277_ = (x34 | ~new_n286_ | ~x35) & (x35 | (new_n284_ & (new_n278_ | x36)));
  ...
  assign new_n284_ = (x34 | ~x38 | (~new_n220_ & ~new_n285_)) & (~new_n101_ | ~x34 | ~new_n103_ | x38);
  assign new_n285_ = x10 & x27 & x36 & new_n103_ & ~x37;
  assign new_n286_ = x37 & (new_n287_ | (new_n93_ & x36 & ~x38));
  assign new_n287_ = x00 & ((~x38 & ~new_n207_ & ~x40) | (~x01 & (new_n288_ | (~x38 & ~x40))));
  assign new_n288_ = x02 & ~x03 & x04 & x36 & x38;
  assign z25 = ~x07 & ~x32 & ~new_n290_ & x33;
  assign new_n290_ = (x35 | (~new_n292_ & (~x34 | new_n291_ | x38))) & (x34 | ~new_n293_ | ~x35);
  assign new_n291_ = (~new_n103_ | ~x36 | x37) & (x36 | (~new_n279_ & ~new_n281_));
  assign new_n292_ = new_n88_ & ~x34 & x36 & new_n103_ & ~x37 & x38;
  assign new_n293_ = x36 & x37 & (new_n294_ | (new_n93_ & ~x38));
  assign new_n294_ = ~x03 & x04 & x38 & x00 & ~x01 & x02;
  assign z26 = z32 | (~x07 & ~x32 & ~new_n296_ & x33);
  assign new_n296_ = ~new_n299_ & (x35 | (~new_n297_ & (~new_n206_ | ~new_n101_ | ~x34)));
  ...
  assign new_n302_ = x39 & ((new_n303_ & ~x05) | (new_n104_ & x36 & ~x40));
  assign new_n303_ = x15 & x34 & ~x35 & new_n304_ & ~x36;
  assign new_n304_ = x40 & ~new_n98_ & (~x21 | ~x22);
  ...
  assign new_n314_ = ~x35 & (new_n292_ | (~x05 & x15 & new_n218_ & ~x36));
  assign z33 = (x33 & (x07 | (~new_n316_ & ~x32))) | z32 | (x32 & ~x33);
  ...
  assign new_n319_ = x39 & x40 & (~x37 | (~new_n177_ & ~x05));
  ...
  assign new_n324_ = (x37 | (x38 ? (new_n88_ | x39) : (~x39 | new_n98_ | ~x40))) & (x39 | x40 | ~x37 | x38);
  assign z34 = x33 & (new_n326_ | new_n110_);
  ...
  assign new_n330_ = (~x00 | x01 | ~new_n126_ | x02) & x40 & (x00 | ~x05);
  assign new_n331_ = (new_n332_ | x39) & (~x34 | x36 | ~new_n334_ | ~x39);
  assign new_n332_ = (x34 | ~x36 | ((x38 | x40) & (~new_n333_ | ~new_n126_ | ~x38 | ~x40))) & (~x34 | x36 | ~x38 | x40);
  ...
  assign new_n338_ = (x00 | ~x05 | ~x38 | (~new_n108_ & ~x35)) & (~x06 | ~x35 | ~new_n108_ | x38);
