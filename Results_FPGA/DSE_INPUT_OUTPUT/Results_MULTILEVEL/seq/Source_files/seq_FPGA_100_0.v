// Benchmark "FAU" written by ABC on Wed Aug 19 00:23:46 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n195_, new_n197_, new_n198_, new_n200_, new_n202_, new_n205_,
  ...
  assign z01 = x33 & (new_n111_ | (~x32 & (~new_n105_ | (~new_n97_ & ~x38))));
  ...
  assign new_n105_ = ~new_n109_ & (x37 | (~new_n106_ & (~new_n104_ | ~new_n94_ | ~x36)));
  ...
  assign new_n109_ = new_n90_ & new_n110_ & ~x34 & ~x35 & x36;
  ...
  assign new_n115_ = (new_n119_ | x34) & (x36 | (~new_n118_ & (new_n116_ | ~x34)));
  assign new_n116_ = (x01 | ~new_n117_ | x02) & (~new_n103_ | x37 | ~x38);
  assign new_n117_ = ~x03 & ~x04 & ((~x37 & x38 & x39) | (x37 & ~x38 & ~x39 & x40));
  assign new_n118_ = new_n94_ & x37 & ~x38;
  assign new_n119_ = (~x36 | ~x37 | x38 | (~x39 & ~x40)) & (x37 | ~x38 | new_n88_ | x39);
  ...
  assign new_n140_ = (x36 | (~new_n142_ & (~x37 | ~x39 | (~new_n141_ & x40)))) & (~x36 | x37 | x39 | x40);
  ...
  assign new_n145_ = x36 & ((~new_n146_ & x35) | (new_n108_ & ~x37 & x38));
  ...
  assign new_n162_ = x38 & ((~new_n82_ & ~new_n163_) | new_n165_ | (new_n164_ & ~x34));
  assign new_n163_ = (x37 | ~x39 | ~x34 | x36) & (~x00 | x34 | ~x36 | ~x40);
  ...
  assign new_n167_ = (~new_n94_ | x37) & (~x00 | x01 | (~new_n168_ & ~new_n169_));
  assign new_n168_ = ~x04 & ((x39 & ~x40) | (~x39 & x40 & x37 & x38));
  assign new_n169_ = x02 & ~x03 & x04 & x37 & x38;
  assign z06 = new_n112_ | (~x07 & new_n171_ & ~x32);
  assign new_n171_ = x33 & (new_n172_ | (~x35 & ~x36 & ~new_n176_ & x40));
  assign new_n172_ = ~x34 & ((~new_n173_ & x35) | new_n89_ | (new_n175_ & ~x35));
  ...
  assign new_n176_ = ~new_n177_ & (~x37 | ((~x38 | x39) & (x05 | x38 | new_n178_ | ~x39)));
  assign new_n177_ = ~x01 & ~x02 & ~x03 & new_n128_ & ~x04 & ~x37;
  assign new_n178_ = (x13 | (x15 & (x11 | x12))) & (~x15 | ~x21 | ~x22 | (~x11 & ~x12));
  assign z07 = x33 & (new_n111_ | (~new_n180_ & ~x32));
  assign new_n180_ = (x35 | (~new_n183_ & (~x34 | new_n181_ | x36))) & (x34 | ~x35 | ~new_n185_ | ~x36);
  assign new_n181_ = (~x40 | (x38 ? x39 : (~x39 | (~new_n182_ & x37)))) & (x37 | ~x38 | x39);
  assign new_n182_ = ~x05 & x15 & x21 & ~new_n100_ & x22;
  assign new_n183_ = new_n184_ & new_n90_ & ~x11 & x12 & ~x34 & x36;
  assign new_n184_ = ~x37 & ~x38;
  assign new_n185_ = ~x37 & x38 & (~x39 ^ ~x40);
  assign z08 = new_n112_ | (x33 & ((~new_n112_ & x07) | (~x32 & new_n187_ & ~x35)));
  ...
  assign new_n195_ = ~x35 & ~x36 & ((~x37 & (x38 ? ~x39 : (x39 & x40))) | (x38 & ~x39 & x40));
  ...
  assign z13 = new_n112_ | (x33 & (new_n200_ | x07));
  assign new_n200_ = new_n104_ & ~x32 & new_n95_ & ~x37;
  assign z14 = new_n112_ | (x33 & (new_n202_ | x07));
  assign new_n202_ = x13 & ~x32 & ~x34 & new_n95_ & x35 & ~x37;
  assign z15 = new_n112_ | (x07 & x33);
  assign z16 = ~x07 & ~x32 & ~new_n205_ & x33;
  assign new_n205_ = (x34 | new_n206_ | ~x36) & (~x34 | x35 | x36 | ~new_n94_ | ~new_n110_);
  assign new_n206_ = (x35 | (~new_n207_ & (~new_n210_ | x37))) & (~new_n211_ | ~new_n209_ | ~x35 | ~x37);
  assign new_n207_ = x38 & ((new_n103_ & x37) | (x00 & new_n208_ & ~x01));
  assign new_n208_ = ~x02 & ~x03 & ~x04 & (x37 ? ~x39 : (x39 & x40));
  assign new_n209_ = new_n103_ & ~x38;
  assign new_n210_ = ~x38 & (~x39 | (~x11 & ~x12 & x40));
  assign new_n211_ = x00 & x01 & ~x02 & ~x03 & x04;
  assign z17 = new_n112_ | (x33 & (x07 | (~new_n213_ & ~x32)));
  assign new_n213_ = (x35 | ((new_n214_ | x36) & (~new_n220_ | x34))) & (x34 | ~new_n222_ | ~x35);
  assign new_n214_ = ~new_n219_ & (x38 | (~new_n215_ & ~new_n217_));
  assign new_n215_ = x02 & ((x37 & ~x39) | (new_n216_ & x00));
  assign new_n216_ = ~x01 & ~x03 & x04 & (~x39 | (~x37 & ~x40));
  assign new_n217_ = x37 & (new_n218_ | (~x05 & new_n159_ & x15));
  assign new_n218_ = ~x39 & (x01 | x03 | x04);
  assign new_n219_ = ~x37 & x38 & ~new_n82_ & x39;
  assign new_n220_ = x38 & (new_n221_ | (new_n88_ & new_n103_ & ~x37));
  ...
  assign z21 = new_n112_ | ~x33 | (~x07 & (new_n256_ | (~new_n260_ & ~x35)));
  ...
  assign new_n260_ = (new_n261_ | x36) & (~new_n209_ | ~x32 | x37);
  assign new_n261_ = new_n262_ & (x00 | x05 | x37 | new_n90_ | x38);
  assign new_n262_ = ~x32 & (~new_n90_ | ~x38 | x06 | ~x37);
  assign z22 = new_n112_ | (x05 & ~x07 & ~x32 & ~new_n264_ & x33);
  ...
  assign z23 = new_n112_ | (~new_n268_ & x33);
  ...
  assign new_n270_ = ~x01 & ~x02 & ~x03 & new_n103_ & ~x04;
  ...
  assign z24 = ~x07 & ~x32 & ~new_n276_ & x33;
  assign new_n276_ = (x34 | ~x35 | ~new_n222_ | ~x36) & (x35 | (x34 ? new_n277_ : (~new_n220_ | ~x36)));
  assign new_n277_ = ~new_n278_ & (x36 | (~new_n219_ & (x38 | (~new_n217_ & ~new_n279_))));
  assign new_n278_ = x36 & ~x37 & new_n103_ & ~x38;
  assign new_n279_ = x02 & ((x37 & ~x39) | (x00 & new_n280_ & ~x01));
  assign new_n280_ = ~x03 & x04 & ~x37 & (~x39 | ~x40);
  assign z25 = new_n112_ | (~x07 & ~x32 & ~new_n282_ & x33);
  assign new_n282_ = (x34 | ~x35 | ~new_n287_ | ~x36) & (x35 | (~new_n286_ & (~new_n283_ | ~x34)));
  assign new_n283_ = ~x38 & ((new_n103_ & x36 & ~x37) | (~x36 & (new_n284_ | new_n285_)));
  assign new_n284_ = x00 & ~x01 & new_n280_ & x02;
  assign new_n285_ = ~x05 & x15 & new_n159_ & x37;
  assign new_n286_ = new_n103_ & ~x37 & x38 & new_n88_ & ~x34 & x36;
  assign new_n287_ = x37 & ((new_n94_ & ~x38) | (new_n288_ & ~x03 & x04 & x38));
  assign new_n288_ = x00 & ~x01 & x02;
  assign z26 = new_n112_ | (~x07 & ~x32 & x33 & (new_n290_ | new_n293_));
  assign new_n290_ = ~x35 & (new_n291_ | (new_n209_ & x34 & x36 & ~x37));
  assign new_n291_ = ~new_n82_ & ((x38 & (new_n292_ | (~x36 & ~x37 & x39))) | (~x38 & ~x39 & ~x36 & x37));
  assign new_n292_ = x00 & ~x34 & x40 & (~x37 ^ ~x39);
  assign new_n293_ = x00 & ~x34 & x35 & x37 & new_n294_ & ~x38;
  assign new_n294_ = ~x39 & ~x40 & (x03 | ~x04 | ~x01 | x02);
  assign z27 = ~x07 & ~x32 & x33 & x37 & new_n296_ & ~x38;
  assign new_n296_ = x39 & (new_n298_ | (~x05 & x15 & new_n297_ & x34));
  assign new_n297_ = ~x35 & ~x36 & x40 & ~new_n100_ & (~x21 | ~x22);
  assign new_n298_ = new_n104_ & x36 & ~x40;
  assign z28 = new_n112_ | (~x07 & new_n300_ & ~x32);
  assign new_n300_ = x33 & ((new_n303_ & x00) | (~x34 & ~new_n301_ & x38));
  assign new_n301_ = ~new_n302_ & (~new_n288_ | x03 | ~x04 | ~x35 | ~x37);
  assign new_n302_ = x10 & x27 & ~x35 & new_n103_ & ~x37;
  assign new_n303_ = ~x01 & x02 & ~x03 & x04 & new_n252_ & ~x35;
  assign z29 = ~x07 & ~x32 & x33 & x37 & new_n305_ & ~x38;
  assign new_n305_ = x39 & (new_n298_ | (~x05 & x15 & new_n306_ & ~x21));
  assign new_n306_ = x22 & x34 & ~x35 & ~x36 & ~new_n100_ & x40;
  assign z30 = ~x07 & ~x32 & x33 & ~x35 & (new_n308_ | new_n286_);
  assign new_n308_ = ~x05 & x15 & x34 & ~x36 & new_n309_ & x37;
  assign new_n309_ = new_n159_ & ~x38;
  assign z31 = ~x07 & ~x32 & x33 & (new_n311_ | new_n313_);
  assign new_n311_ = x00 & ~x01 & x02 & ~x03 & ~new_n312_ & x04;
  assign new_n312_ = (~x34 | ~new_n252_ | x35) & (x34 | ~x35 | ~new_n110_ | ~x36);
  assign new_n313_ = new_n314_ & new_n88_ & ~x34 & ~x35;
  assign new_n314_ = x36 & ~x37 & new_n103_ & x38;
  assign z33 = (x33 & (x07 | (~new_n316_ & ~x32))) | new_n112_ | (x32 & ~x33);
  assign new_n316_ = (x35 | (~new_n317_ & (new_n324_ | x34))) & (x34 | (~new_n185_ & (new_n321_ | ~x35)));
  assign new_n317_ = ~x36 & (x38 ? ~new_n320_ : (new_n319_ | (new_n318_ & ~x01)));
  assign new_n318_ = ~x02 & ~x03 & ((new_n103_ & ~x04 & x37) | (x00 & x04 & ~x37));
  assign new_n319_ = x39 & x40 & (~x37 | (~new_n178_ & ~x05));
  assign new_n320_ = (x39 | (x37 & ~x40)) & (~x06 | ~x37 | ~x40);
  assign new_n321_ = new_n323_ & (~x00 | x02 | x03 | new_n322_ | ~x04);
  assign new_n322_ = (~x37 | ~x38 | x01 | ~x36) & (~new_n103_ | ~x01 | x38);
  assign new_n323_ = (x37 | x38 | x39) & (~x40 | ((~x37 | x38 | ~x39) & (~x06 | ((~x37 | x38) & (~x38 | ~x39 | ~x36 | x37)))));
  assign new_n324_ = (~x37 | x38 | x39 | x40) & (x37 | (x38 ? (new_n88_ | x39) : (~x39 | new_n100_ | ~x40)));
  assign z34 = x33 & (new_n326_ | new_n111_);
  assign new_n326_ = ~x32 & (new_n336_ | (~x35 & (x37 ? ~new_n332_ : ~new_n327_)));
  assign new_n327_ = (new_n328_ | x38) & (x34 | ~x36 | ~x38 | new_n330_ | ~x39);
  assign new_n328_ = (~x34 | x36 | new_n90_ | new_n329_) & (~x11 | x34 | ~new_n90_ | ~x36);
  assign new_n329_ = (x00 | ~x05) & (~x00 | x01 | x02 | x03 | ~x04);
  assign new_n330_ = (~x00 | x01 | ~new_n331_ | x02) & x40 & (x00 | ~x05);
  assign new_n331_ = ~x03 & ~x04;
  assign new_n332_ = (new_n333_ | x39) & (~x34 | x36 | ~new_n335_ | ~x39);
  assign new_n333_ = (x34 | ~x36 | ((x38 | x40) & (~new_n334_ | ~new_n331_ | ~x38 | ~x40))) & (~x34 | x36 | ~x38 | x40);
  ...
  assign new_n339_ = (x00 | ~x05 | ~x38 | (~new_n108_ & ~x35)) & (~x06 | ~x35 | ~new_n108_ | x38);
