...
module FAU ( 
  ...
  assign z5 = new_n29_ | new_n30_ | new_n31_;
  assign new_n29_ = x5 & (x7 | (~x0 & ~x1 & x2));
  assign new_n30_ = (~x5 | ~x7) & (x0 ? (~x1 & (x2 ^ x3)) : (x1 & x3));
  assign new_n31_ = ~x0 & ((~x2 & (x1 | (~x3 & x6))) | (~x1 & x2 & x3));
  assign z6 = (~new_n33_ & ~x1) | (~x0 & new_n34_ & x1);
  assign new_n33_ = (~x2 | x3 | (x5 & (~x0 | x7))) & (~x0 | x2 | ~x3 | (x5 & x7));
  assign new_n34_ = (~x5 | ~x7) & (x3 | (~x2 & ~x4));
endmodule
