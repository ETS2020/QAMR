...
module FAU ( 
  ...
  assign z4 = (~x0 & ((x1 & (~x2 | ~x7)) | (x2 & x3) | (~x2 & ~x3))) | (~x1 & ((x2 & ~x3) | (x0 & ~x2 & x3))) | (x2 & ~x7);
  assign z5 = new_n28_ | new_n29_;
  assign new_n28_ = ~x1 & ((x0 & (x2 ? (~x3 & x7) : x3)) | (x2 & ~x3 & x5 & x7));
  assign new_n29_ = ~x0 & ((x1 & (~x2 | (x3 & x7))) | (x2 & x3 & x7) | (~x2 & ~x3 & x6));
  assign z6 = new_n31_ | new_n32_;
  assign new_n31_ = ~x1 & ((~x5 & x7 & x2 & ~x3) | (x0 & (x2 ? (~x3 & x7) : x3)));
  assign new_n32_ = ~x0 & x1 & ((x3 & x7) | (~x2 & (x3 | ~x4)));
endmodule
