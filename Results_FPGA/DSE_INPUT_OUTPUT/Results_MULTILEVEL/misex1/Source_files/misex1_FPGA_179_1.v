...
module FAU ( 
  ...
  assign z5 = new_n28_ | (~new_n29_ & ~x0) | (new_n30_ & x0);
  assign new_n28_ = ~x4 & (x6 | (~x2 & ~x6 & ~x0 & x1));
  assign new_n29_ = (~x1 | ~x4 | (x2 & ~x3)) & (~x2 | (~x3 & (x1 | ~x5))) & (x2 | x3 | ~x6);
  assign new_n30_ = ~x1 & (x4 | ~x6) & (~x2 ^ ~x3);
  assign z6 = (new_n32_ & ~x1) | (~x0 & ~new_n33_ & x1);
  assign new_n32_ = (x4 | ~x6) & ((x2 & ~x3 & ~x5) | (x0 & (~x2 ^ ~x3)));
  assign new_n33_ = (~x3 | (~x4 & (~x2 | x6))) & (x2 | x4 | x6);
endmodule
