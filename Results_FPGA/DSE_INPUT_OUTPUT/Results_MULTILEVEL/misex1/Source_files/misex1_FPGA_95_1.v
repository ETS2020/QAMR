...
module FAU ( 
  ...
  assign z2 = (~new_n22_ & (x5 | ~x7)) | (new_n23_ & ~x0 & ~x3 & ~x5 & ~x7);
  ...
  assign z5 = (x7 & (~x5 | (new_n23_ & ~x0))) | (~new_n30_ & ~x0) | (~new_n29_ & (x5 | ~x7));
  assign new_n29_ = x0 ? (x1 | (~x2 ^ x3)) : (~x1 | ~x3);
  assign new_n30_ = (x1 | ~x2 | (~x3 & ~x5)) & (x2 | (~x1 & (x3 | ~x6)));
  assign z6 = (~new_n32_ & (x5 | ~x7)) | (new_n23_ & ~x3 & ~x5 & ~x7);
  assign new_n32_ = x0 ? (x1 | (~x2 ^ x3)) : (~x1 | (~x3 & (x2 | x4)));
endmodule
