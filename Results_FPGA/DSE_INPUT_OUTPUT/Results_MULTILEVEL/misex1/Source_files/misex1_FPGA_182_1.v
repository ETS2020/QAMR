...
module FAU ( 
  ...
  wire new_n19_, new_n21_, new_n22_, new_n24_, new_n25_, new_n26_, new_n29_,
    new_n30_, new_n32_;
  assign z0 = (x2 & (x0 ? (~x1 & ~x3) : (x1 & x3))) | (~x6 & x7);
  ...
  assign z5 = (new_n30_ & ~x0) | (~new_n29_ & (x6 | ~x7));
  assign new_n29_ = (x1 | ((~x0 | (~x2 ^ x3)) & (~x2 | x3 | ~x5))) & (x0 | ~x3 | (~x1 & ~x2));
  assign new_n30_ = ~x2 & ((~x3 & x6) | (x1 & (~x7 | (~x4 & x6))));
  assign z6 = ~new_n32_ & (x6 | ~x7);
  assign new_n32_ = (x1 | ((~x0 | (~x2 ^ x3)) & (~x2 | x3 | x5))) & (x0 | ~x1 | (~x3 & (x2 | x4)));
endmodule
