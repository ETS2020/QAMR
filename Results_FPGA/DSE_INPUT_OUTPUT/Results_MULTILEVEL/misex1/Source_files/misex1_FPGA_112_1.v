...
module FAU ( 
  ...
  assign new_n22_ = (~x0 | x1 | x2 | ~x3) & (x0 | ((~x1 | (~x3 & (x2 | ~x4))) & (x1 | x2 | x3 | x6)));
  ...
  assign z5 = x2 ? ~new_n30_ : new_n29_;
  assign new_n29_ = (x5 | ~x7) & (x0 ? (~x1 & x3) : (x1 | (~x3 & x6)));
  assign new_n30_ = (x0 | ((~x3 | (x7 & (~x1 | ~x5))) & (x1 | ~x5))) & (x1 | x3 | (~x5 & (~x0 | x7)));
  assign z6 = (~new_n32_ & ~x1) | new_n18_ | (~x0 & ~new_n33_ & x1);
  assign new_n32_ = (~x0 | (~x2 ^ x3)) & (~x2 | x3 | x5);
  assign new_n33_ = (~x3 | (x2 & (~x2 | (~x5 & x7)))) & (x2 | x4);
endmodule
