...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n76_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_, new_n94_,
    ...
    new_n159_, new_n162_, new_n165_, new_n166_, new_n167_, new_n168_;
  ...
  assign z11 = ~x2 & (~x0 | (new_n87_ & new_n89_ & x1));
  assign new_n89_ = ~x3 & ~x4;
  assign z12 = x7 & x6 & x5 & ~x4 & new_n91_ & ~x3;
  assign new_n91_ = x2 & x0 & ~x1;
  assign z14 = ~x2 & (~x0 | (new_n87_ & ~x1 & x3 & ~x4));
  ...
  assign z26 = (~x0 & ~x2) | (x0 & x2 & ~x3 & new_n103_ & ~x4 & ~x5);
  ...
  assign z31 = (~x0 & (~x2 | ~x5)) | ~new_n109_ | (x1 & (x0 | x2));
  assign new_n109_ = (~x2 | (~x0 & x3 & x4)) & (~x0 | (x4 ? x5 : (~x5 & ~x6)));
  ...
  assign z38 = (~x3 & (~x0 | ~x4)) | (~x0 & (~x2 | ~x4)) | new_n125_ | x1 | (x0 & x2);
  ...
  assign z42 = (~x0 & (~x2 | ~x5)) | (~new_n76_ & x5) | x4 | (~new_n133_ & ~x5);
  ...
  assign z44 = x2 | (x0 & (~new_n89_ | x5 | x6 | (x1 & ~x2 & ~x5)));
  assign z45 = x0 | (x2 & (new_n125_ | ~x1));
  assign z47 = (~new_n141_ & x0) | (x2 & (~x1 | (new_n125_ & ~x0)));
  ...
  assign z51 = (~x2 & (~x0 | (x0 & x3))) | (~new_n148_ & ~x4) | (x0 & ~x1) | (~x0 & (~x3 | x4 | (x1 & x2)));
  assign new_n148_ = (~x2 | (~x5 & ~x6)) & (~x0 | (x5 ? (x6 & x7) : ~x6));
  assign z52 = (x2 & (new_n125_ | (~x0 & (x1 | (x3 & x4))))) | (x0 & (new_n125_ | (~x1 & ~x2) | x3));
  assign z53 = new_n151_ | (~new_n152_ & ~x4) | (~new_n153_ & ~new_n154_) | ~new_n155_;
  ...
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n154_ & (x2 ? ~x3 : x0)) | (new_n157_ & x2) | (x0 & x3);
  assign new_n157_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = new_n159_ | (~x1 & (x2 | (x0 & ~x2))) | (x0 & (x2 ? ~new_n154_ : ~x3));
  assign new_n159_ = ~x4 & (x5 | x6) & (~x0 ^ ~x2);
  assign z56 = x0 | (x2 & (~new_n87_ | x4 | (~x1 & x3)));
  assign z57 = (~x1 & (x0 | (x2 & ~x3))) | (~new_n154_ & x2) | (x0 & (new_n162_ | x2 | ~x3));
  assign new_n162_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = (new_n125_ & ~x0) | (~new_n154_ & x0) | ~x1 | ~x2 | ~x3;
  assign z59 = x0 ? (new_n165_ | new_n166_ | ~new_n167_) : (~new_n168_ & x2);
  assign new_n165_ = (~x2 | (~x4 & x6)) & (~x1 | ~x3);
  assign new_n166_ = x5 & (~x4 | (x1 & x3));
  assign new_n167_ = x1 ? (~x3 | (~x2 & ~x4 & x6 & x7)) : x3;
  assign new_n168_ = ~x5 & x6 & x7 & ~x1 & ~x3 & ~x4;
  assign z60 = x0 ? (x3 | ~x4 | (~x1 & (~x2 | ~x3))) : (x2 & (~new_n87_ | x1 | ~x3 | x4));
  assign z61 = new_n125_ | ~x0 | x1 | ~x2 | ~x3;
  assign z62 = x0 ? (new_n125_ | ~x1 | x3) : x2;
  assign z13 = 1'b0;
  assign z23 = 1'b0;
  assign z24 = 1'b0;
  assign z25 = 1'b0;
