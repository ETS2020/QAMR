...
module FAU ( 
  ...
  wire new_n75_, new_n81_, new_n83_, new_n86_, new_n87_, new_n89_, new_n91_,
    new_n93_, new_n95_, new_n108_, new_n112_, new_n115_, new_n116_,
  ...
  assign z28 = (~x2 & ~x7) | (new_n89_ & new_n95_ & x2 & x3);
  assign z29 = x7 & new_n112_ & ~x6;
  assign new_n112_ = ~x5 & ~x4 & ~x3 & ~x0 & ~x1 & ~x2;
  assign z30 = z24 | (new_n89_ & new_n86_ & x0 & x1);
  assign z31 = new_n117_ | (x7 & (~new_n116_ | (~x0 & (new_n115_ | ~x4))));
  assign new_n115_ = ~x2 & x3;
  assign new_n116_ = (x4 | (~x5 & ~x6)) & ~x1 & (x2 | ~x4 | x5);
  assign new_n117_ = x2 & (x0 | x1 | ~x3 | ~x4 | ~x5);
  assign z32 = (~z24 & x1) | new_n119_ | new_n120_ | new_n121_ | new_n122_;
  assign new_n119_ = ~x3 & (x2 | ~x4);
  assign new_n120_ = x2 & (x0 | ~x4);
  assign new_n121_ = ~x2 & ((~x0 & (x4 | (x3 & x7))) | ~x7 | (x4 & ~x5 & x7));
  assign new_n122_ = ~x4 & x7 & (~x0 | x5 | x6);
  assign z33 = x2 ? (~new_n124_ | ~new_n125_) : x7;
  assign new_n124_ = x0 & ~x4 & (x1 | ~x5);
  assign new_n125_ = x6 & x7 & (~x1 | ~x3 | x5);
  assign z34 = ((~x2 | ~x3) & (x1 | x5)) | (~new_n127_ & x2) | (~new_n128_ & ~x2);
  assign new_n127_ = (~x3 | (x5 & ~x6)) & ~x4 & ~x7 & (x3 | (~x0 & x6));
  assign new_n128_ = x0 & (x4 | x6) & x7;
  assign z35 = (~x2 & (~x7 | (~x0 & x3))) | ((x0 | x2) & ~x5) | ~new_n130_ | (x0 & (x2 | ~x7));
  assign new_n130_ = ~x1 & x4 & (~x2 | x3);
  assign z36 = ~new_n132_ | (~z24 & (x1 | x5));
  assign new_n132_ = (~x7 | (x0 & ~x2 & x4)) & (~x2 | (~x4 & x6 & ~x0 & ~x3));
  assign z37 = (~x1 & (~x3 | (~x2 & ~x5))) | (~new_n135_ & x2) | (~new_n134_ & ~x2);
  ...
  assign z39 = (~new_n139_ & x2) | (~new_n140_ & ~x2) | x4;
  assign new_n139_ = x3 & x5 & ~x6 & ~x7;
  assign new_n140_ = x0 & ~x1 & ~x5 & x6 & x7;
  assign z40 = new_n142_ | new_n143_ | new_n144_ | (~new_n145_ & x0) | (new_n86_ & ~x0);
  ...
  assign z44 = (x0 & (x4 | x6)) | ~new_n155_ | (~new_n154_ & ~x4);
  ...
  assign z49 = new_n167_ | x0 | x1 | ~x2 | (x3 & x4);
  assign new_n167_ = ~x4 & (x5 | x6);
  assign z50 = x2 | (~new_n169_ & x7);
  assign new_n169_ = (~x0 | (x1 & x3)) & ~x4 & ~x5 & x6;
  assign z51 = (x0 & (new_n115_ | ~x1)) | ~new_n172_ | (~new_n171_ & ~x4);
  assign new_n171_ = ((x0 & x1 & ~x2) | (~x5 & ~x6)) & (x0 | x3) & (x2 | (~x5 ^ x6));
  assign new_n172_ = (x2 | (x7 & (x0 | x3))) & (x0 | (~x1 & (~x2 | ~x4)));
  assign z52 = (~new_n174_ & x0) | new_n175_ | ~new_n177_ | (~new_n176_ & ~x0);
  assign new_n174_ = (x1 | x2) & ~x3;
  assign new_n175_ = x2 & ((~x4 & x6) | (~x0 & x3 & x4));
  assign new_n176_ = ~x1 & (x2 | x3) & (x4 | ~x6);
  assign new_n177_ = (x2 | (x7 & (x4 | x5 | ~x6))) & (x4 | (~x5 & (x1 | ~x6)));
  assign z53 = new_n179_ | ~new_n182_ | ((new_n180_ | new_n181_) & ~x4);
  assign new_n179_ = (x4 | ~x5 | ~x6) & (x2 ? ~x1 : ~x3);
  assign new_n180_ = (x5 | x6) & ((~x0 & x1 & x2) | (~x2 & x3));
  assign new_n181_ = x0 & ((x5 & ~x7) | (x2 & (x5 ^ x6)));
  assign new_n182_ = (~x1 | (x0 ? x3 : (~x2 | ~x3))) & (~x2 | ((x1 | x3) & (~x0 | (x1 & x3)))) & (x2 | x7) & (x1 | (x7 & (x2 | ~x3)));
  assign z54 = (x7 & (new_n185_ | (~new_n184_ & ~x2))) | (x2 & (new_n185_ | ~new_n186_));
  assign new_n184_ = (x3 | (x1 & (x0 | x4 | (~x5 & ~x6)))) & ((~x0 & ~x3) | (~x4 & x5 & x6));
  assign new_n185_ = x0 & (~x1 | x3);
  assign new_n186_ = ((x6 & x7) | (x3 & (x4 | ~x5))) & (x3 | (~x4 & x5)) & (x1 | ~x3) & (x4 | x5 | ~x6);
  assign z55 = new_n188_ | new_n189_ | new_n190_ | ~x1;
  assign new_n188_ = ~x4 & (~x0 | ~x2) & (x5 | x6);
  assign new_n189_ = ~x2 & (~x7 | (x0 & ~x3));
  assign new_n190_ = x0 & (~x7 | (x2 & (x4 | ~x5 | ~x6)));
  assign z56 = (~x1 & (~x2 | x3)) | ~new_n192_ | (~x2 & (~x3 | (~x4 & x5)));
  assign new_n192_ = ~x0 & x7 & (~x2 | (~x4 & x5 & x6));
  assign z57 = new_n194_ | new_n195_ | (new_n196_ & ~x2) | (~new_n87_ & x2);
  assign new_n194_ = x0 & (x2 | (~x3 & x7));
  assign new_n195_ = ~x1 & (x2 ? ~x3 : x7);
  assign new_n196_ = x7 & ((~x0 & x3) | (~x4 & x5));
  assign z58 = new_n161_ | new_n162_ | ~new_n198_ | (~x2 & (x0 | x1));
  assign new_n198_ = (~x0 | (x1 & x5)) & x3 & (x1 | (~x2 & ~x5));
  assign z59 = (~new_n201_ & x0) | (new_n200_ & ~x2) | (x2 & (new_n202_ | ~new_n203_));
  assign new_n200_ = x7 & (x4 | x5 | ~x6);
  ...
  assign z61 = new_n167_ | ~new_n95_ | ~x2 | ~x3;
  assign z62 = new_n167_ | ~x0 | ~x1 | z24 | x3;
  assign z25 = 1'b0;
endmodule
