...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n80_, new_n82_, new_n85_, new_n90_, new_n91_, new_n99_, new_n102_,
    new_n104_, new_n105_, new_n107_, new_n108_, new_n110_, new_n111_,
    new_n113_, new_n114_, new_n117_, new_n119_, new_n120_, new_n121_,
  ...
  assign z13 = x6 & (x2 | (new_n85_ & ~x0 & x1 & x3));
  ...
  assign z24 = x6 & (new_n99_ | x2);
  assign new_n99_ = ~x0 & ~x1 & ~x3 & ~x4 & ~x5 & ~x7;
  assign z25 = ~x7 & x6 & new_n82_ & ~x5;
  assign z29 = (x2 & x6) | (new_n80_ & ~x2 & ~x3 & new_n102_ & ~x6 & x7);
  assign new_n102_ = ~x4 & ~x5;
  assign z31 = (~new_n104_ & ~x2) | (~x6 & (x1 | (~new_n105_ & x2)));
  assign new_n104_ = (x0 | (~x3 & x4)) & (x4 | (~x5 & ~x6)) & ~x1 & (~x4 | x5);
  assign new_n105_ = ~x0 & x3 & x4 & x5;
  assign z32 = ~new_n107_ | (~z08 & x1);
  assign new_n107_ = (x3 | ((~x0 | x2 | x4) & (~x2 | x6))) & (~x0 | (x2 ? x6 : (x4 | ~x6))) & (new_n108_ | x2) & (~x2 | x4 | x6);
  assign new_n108_ = (~x4 | (x0 & x5)) & (~x5 | (x0 & x4)) & (x0 | (~x3 & x6 & ~x7));
  ...
  assign new_n113_ = ~x1 & x4 & (~new_n114_ | x0);
  ...
  assign z38 = (x1 & (~x2 | ~x6)) | ~new_n119_ | (~x3 & (new_n121_ | (x2 & ~x6)));
  assign new_n119_ = (~x0 | (x2 ? x6 : (x4 | ~x6))) & (x4 | (x2 ? x6 : ~x5)) & (x0 | new_n120_ | x2);
  assign new_n120_ = ~x3 & ~x4 & ~x5 & x6 & ~x7;
  assign new_n121_ = x0 & ~x2 & ~x4;
  assign z39 = ~new_n123_ | (~z08 & x4);
  assign new_n123_ = (x6 | (x3 & x5 & ~x7)) & (x2 | ~x6 | (new_n91_ & ~x5 & x7));
  assign z40 = (x6 & (x2 | (x0 & ~x4))) | ~new_n125_ | (x0 & (x2 | (x4 & ~x5)));
  ...
  assign z45 = (x1 & (~x2 | x6)) | ~new_n140_ | (x5 & (~x1 | ~x4));
  ...
  assign new_n144_ = (~x5 | (x2 & (x4 | x6))) & (x6 | (x1 & x2)) & (x2 | (~x1 & ~x4 & x7));
  assign z48 = ~new_n80_ | ~new_n114_ | (~x4 & (x5 ? (~x6 | ~x7) : x6));
  assign z49 = ~x2 | (~x6 & (~new_n80_ | (x3 & x4) | (~x4 & x5)));
  assign z50 = ~x6 | (~x2 & (new_n148_ | x4 | x5 | ~x7));
  assign new_n148_ = x0 & (~x1 | ~x3);
  assign z51 = (x0 & (new_n114_ | ~x1)) | ~new_n152_ | (~new_n150_ & ~x0);
  assign new_n150_ = (x3 | (x2 & x4)) & ~new_n151_ & ~x1 & (~x2 | ~x4);
  assign new_n151_ = ~x4 & (x5 | x6);
  assign new_n152_ = (~x2 | (~x6 & (x4 | ~x5))) & (x4 | ((x5 | ~x6) & (x2 | ~x5 | (x6 & x7))));
  assign z52 = (x0 & (x3 | (~x1 & ~x2))) | (~new_n154_ & x2) | new_n155_ | (~x0 & (x1 | (~x2 & ~x3)));
  assign new_n154_ = ~x6 & (x0 | ~x3 | ~x4);
  assign new_n155_ = ~x4 & (x5 | (x6 & (~x0 | ~x5)));
  assign z53 = new_n157_ | new_n159_ | ((new_n132_ | ~x1) & (new_n114_ | ~x6));
  assign new_n157_ = ~x3 & ((~new_n158_ & ~x2) | (x0 & (~x6 | (x1 & ~x2))));
  assign new_n158_ = ~x4 & x5 & x6 & x7;
  assign new_n159_ = x3 & ((~x2 & ~x4 & x6) | (~x0 & x2 & ~x6));
  assign z54 = (~new_n161_ & ~x3) | (~new_n158_ & (x0 | (~x2 & x3))) | (x0 & x3) | (~new_n162_ & x2);
  assign new_n161_ = (~new_n151_ | x0) & x1 & ~x2;
  assign new_n162_ = x1 & ~new_n132_ & ~x6;
  assign z55 = (~new_n114_ & x0) | new_n151_ | z08 | ~x1;
  assign z56 = x2 ? ~x6 : (new_n142_ | x0 | ~x1 | ~x3);
  ...
  assign z59 = (~x2 & (new_n148_ | ~new_n102_ | ~x6 | ~x7)) | (~x6 & (~new_n170_ | ~new_n148_));
  assign new_n170_ = ~new_n132_ & (x1 | x3);
  ...
  assign z62 = new_n151_ | ~x0 | ~x1 | z08 | x3;
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z15 = 1'b0;
  assign z26 = 1'b0;
