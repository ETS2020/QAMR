...
module FAU ( 
  ...
  assign z14 = ~x2 & (~x0 | (new_n95_ & new_n79_ & ~x1));
  assign new_n95_ = x5 & x6 & x7;
  assign z15 = ~x0 & (~x2 | (new_n95_ & new_n79_ & x1));
  assign z16 = ~x2 & (~x0 | (new_n95_ & new_n79_ & x1));
  ...
  assign z30 = (~x0 & ~x2) | (new_n105_ & x2 & ~x3 & x0 & x1);
  ...
  assign z39 = (~x0 & (~x2 | ~x5)) | ~new_n127_ | (x5 & (~new_n76_ | ~x3));
  ...
  assign z42 = (x4 & (x0 | x2)) | (~new_n76_ & (x0 ? x5 : x2)) | (~new_n133_ & ~x5);
  ...
  assign z45 = new_n141_ | x0 | ~x1 | ~x2;
  assign new_n141_ = ~x4 & (x5 | x6);
  assign z47 = (new_n141_ & ~x0) | ~x1 | ~x2 | (x0 & (~new_n79_ | ~new_n95_));
  assign z49 = (~new_n83_ & ~x4) | x0 | x1 | ~x2 | (x3 & x4);
  assign z50 = x2 | (x0 & (~new_n79_ | ~x1 | ~new_n145_ | x5));
  ...
  assign z53 = new_n150_ | (~new_n151_ & ~x4) | (~new_n93_ & ~new_n152_) | ~new_n153_;
  assign new_n150_ = x1 & (x0 ? ~x3 : (x2 & x3));
  assign new_n151_ = (~x0 | (x5 ? (x6 & x7) : ~x6)) & ((~x5 & ~x6) | ((~x2 | x3) & (~x0 | x2 | ~x3)));
  assign new_n152_ = (x1 | ~x2) & (~x0 | x3);
  assign new_n153_ = (~x0 | (x3 ? x1 : ~x2)) & (x1 | ~x2 | x3);
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n93_ & (x2 ? ~x3 : x0)) | (x0 & x3) | (new_n155_ & x2);
  assign new_n155_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = (~x4 & ~new_n83_ & (x0 ^ x2)) | (~new_n157_ & x0) | (~x1 & (x2 | (x0 & ~x2)));
  assign new_n157_ = x2 ? (x6 & x7 & ~x4 & x5) : x3;
  assign z56 = x0 | (x2 & (~new_n95_ | x4 | (~x1 & x3)));
  assign z57 = (~x1 & (x2 ? ~x3 : x0)) | (~new_n93_ & x2) | (x0 & (x2 | (~x2 & (new_n160_ | ~x3))));
  assign new_n160_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = x2 ? ((new_n141_ & ~x0) | (~new_n93_ & x0) | ~x1 | ~x3) : x0;
  assign z59 = x0 ? (new_n163_ | new_n164_ | ~new_n165_) : (~new_n87_ & x2);
  assign new_n163_ = (~x2 | (~x4 & x6)) & (~x1 | ~x3);
  assign new_n164_ = x5 & (~x4 | (x1 & x3));
  assign new_n165_ = x1 ? (~x3 | (x6 & x7 & ~x2 & ~x4)) : x3;
  assign z60 = x0 ? (x3 | ~x4 | (~x1 & (~x2 | ~x3))) : (x2 & (~new_n95_ | x1 | ~x3 | x4));
  assign z61 = x0 ? (new_n141_ | x1 | ~x2 | ~x3) : x2;
  assign z62 = new_n141_ | ~x0 | ~x1 | x3;
  assign z24 = 1'b0;
  assign z48 = 1'b1;
  assign z44 = x2 | (x0 & (~new_n83_ | x4 | x1 | x3));
  assign z46 = ~z07;
  assign z13 = z07;
  assign z19 = z07;
  assign z23 = z07;
