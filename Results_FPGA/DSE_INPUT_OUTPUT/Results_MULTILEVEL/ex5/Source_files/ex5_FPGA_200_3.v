...
module FAU ( 
  ...
  wire new_n75_, new_n80_, new_n82_, new_n84_, new_n86_, new_n88_, new_n92_,
    new_n95_, new_n98_, new_n103_, new_n107_, new_n109_, new_n111_,
    ...
    new_n155_, new_n156_, new_n158_, new_n162_, new_n164_, new_n168_,
    new_n169_, new_n171_, new_n172_, new_n174_, new_n177_, new_n178_;
  ...
  assign z24 = (x2 & x3) | (new_n80_ & ~x0 & ~x1 & ~x2 & ~x3);
  ...
  assign z33 = ~new_n122_ | ~x2 | x3 | ~new_n121_ | ~x7;
  assign new_n121_ = ~x4 & x6;
  assign new_n122_ = x0 & (x1 | ~x5);
  ...
  assign z36 = (~x0 & (~x2 | x3)) | (~x4 & (x0 | ~x2)) | ~new_n130_ | (x0 & (x2 | x5));
  ...
  assign z40 = x2 ? new_n109_ : (new_n139_ | new_n140_ | new_n82_ | x1);
  ...
  assign new_n146_ = ~x3 & (x3 | ((~x5 | (~x6 & ~x7)) & ~x4 & (x5 | (x0 & x6 & x7))));
  ...
  assign z49 = ~x2 | (~x3 & (new_n82_ | x0 | (x2 & (new_n121_ | x1))));
  assign z50 = (x0 & (~x3 | (~x1 & ~x2))) | (~new_n103_ & ~x2) | (~x3 & (new_n82_ | x2));
  assign z51 = (~x0 & (x1 | ~x3)) | (x2 & (new_n82_ | x3)) | new_n162_ | (~x1 & ~x3) | (x3 & (x0 | x1));
  assign new_n162_ = ~x4 & ((~x5 & x6) | (x5 & (~x6 | ~x7)) | (x3 & (x5 | x6)));
  assign z52 = (x1 & (~x0 | x3)) | (x3 & (x0 | x2)) | new_n164_ | (~x1 & ~x2 & ~x3);
  assign new_n164_ = ~x4 & (x5 | x6);
  assign z53 = (x0 & (x2 | (x1 & ~x3))) | ((x2 | x3) & (new_n164_ | ~x1)) | (x2 & x3) | (~x2 & ~new_n84_ & ~x3);
  assign z54 = (~x2 & ~x3 & ((new_n164_ & ~x0) | ~x1)) | (~new_n84_ & (x0 | x2 | x3)) | (x2 & x3) | (x0 & (~x1 | x3));
  ...
  assign z57 = new_n174_ | (x0 & (x2 | ~x3)) | (~new_n84_ & x2) | ~x1 | (~x0 & x3);
  assign new_n174_ = ~x4 & ((x6 & ~x7) | (x5 & (x0 | ~x2)));
  assign z58 = ~new_n103_ | x0 | x1 | x2 | ~x3;
  assign z59 = (~new_n177_ & x0) | (~new_n178_ & ~x3) | (~new_n103_ & (x3 ? ~x2 : ~x0));
  assign new_n177_ = (x1 | (x2 & x3)) & (x3 | (x2 & (x4 | ~x6)));
  assign new_n178_ = (x0 | ~x1 | ~x2) & (x4 | ~x5);
  assign z60 = (x0 & (~x1 | ~x4)) | x3 | (~x0 & (~new_n86_ | x1 | x2 | x4));
  assign z61 = ~x3 | (~x2 & x3);
  assign z62 = x3 ? ~x2 : (new_n164_ | ~x0 | ~x1);
  assign z18 = 1'b0;
  assign z28 = 1'b0;
  assign z15 = z06;
endmodule
