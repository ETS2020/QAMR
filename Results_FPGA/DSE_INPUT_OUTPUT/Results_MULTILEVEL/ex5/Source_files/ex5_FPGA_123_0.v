...
module FAU ( 
  ...
  wire new_n75_, new_n77_, new_n84_, new_n86_, new_n87_, new_n89_, new_n91_,
    new_n94_, new_n101_, new_n104_, new_n107_, new_n110_, new_n112_,
    new_n114_, new_n116_, new_n117_, new_n118_, new_n119_, new_n122_,
    new_n124_, new_n127_, new_n128_, new_n130_, new_n131_, new_n134_,
  ...
  assign new_n112_ = (x3 | (~x2 & x4)) & (~x2 | (~x0 & x4)) & (x0 | x2) & (~x0 | (x4 ? x5 : (~x5 & ~x6)));
  ...
  assign z36 = (x1 & (x0 | x2)) | ~new_n122_ | (x5 & (x0 | (x2 & ~x3)));
  assign new_n122_ = (~x0 | (~x2 & x4)) & (~x2 | (~x3 & (x3 | (~x4 & x6 & ~x7))));
  ...
  assign z42 = (~x0 & (~x2 | ~x5)) | x4 | (~new_n134_ & ~x5) | (~new_n77_ & x5);
  assign new_n134_ = ~x1 & (~x2 | x3) & x6 & x7;
  assign z43 = new_n136_ | new_n137_ | (~new_n138_ & x2);
  assign new_n136_ = ~x4 & (((x6 | x7) & (x0 ? x5 : x2)) | (~x0 & x2 & ~x5) | (x0 & x6 & ~x7));
  assign new_n137_ = x1 & ((x4 & (x2 | (x0 & x5))) | (x0 & ~x5 & (~x2 | x3)));
  assign new_n138_ = (~x4 | (~x0 & x3)) & (~x0 | x5 | (x6 & x7));
  assign z44 = x2 | (x0 & (~new_n86_ | x5 | x6 | (x1 & ~x2 & ~x5)));
  assign z45 = x0 | (x2 & (~x1 | (new_n141_ & ~x0)));
  ...
  assign z51 = (~x1 & (x0 | ~x2)) | (~new_n147_ & ~x4) | (~x2 & (~x0 | x3)) | (~x0 & (x1 | ~x3 | x4));
  assign new_n147_ = ((x0 & ~x2) | (~x5 & ~x6)) & (x5 | ~x6) & (~x5 | (x6 & x7));
  assign z52 = (~new_n75_ & ~x4) | (~x0 & (x1 | ~x2 | (x3 & x4))) | (~x2 & (~x1 | x3)) | (x0 & x3);
  assign z53 = new_n150_ | (~new_n151_ & ~x4) | ~new_n153_ | (~new_n84_ & ~new_n152_);
  ...
  assign z55 = new_n157_ | (~x1 & (x2 | (x0 & ~x2))) | (x0 & (x2 ? ~new_n84_ : ~x3));
  assign new_n157_ = ~x4 & (x5 | x6) & (x0 ^ x2);
  assign z56 = x0 | (x2 & (~new_n91_ | x4 | (~x1 & x3)));
  assign z57 = (~x1 & (x2 ? ~x3 : x0)) | (~new_n84_ & x2) | (x0 & (x2 | (~x2 & (new_n160_ | ~x3))));
  assign new_n160_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = x2 ? ((new_n141_ & ~x0) | (~new_n84_ & x0) | ~x1 | ~x3) : x0;
  ...
  assign z61 = x0 ? (new_n141_ | x1 | ~x2 | ~x3) : x2;
