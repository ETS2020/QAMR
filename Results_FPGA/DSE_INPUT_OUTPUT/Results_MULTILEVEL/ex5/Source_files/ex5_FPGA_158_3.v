...
module FAU ( 
  ...
  wire new_n75_, new_n81_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    new_n93_, new_n96_, new_n102_, new_n107_, new_n109_, new_n113_,
    new_n115_, new_n116_, new_n118_, new_n119_, new_n120_, new_n123_,
    new_n125_, new_n127_, new_n128_, new_n129_, new_n130_, new_n132_,
    new_n133_, new_n135_, new_n136_, new_n139_, new_n140_, new_n142_,
    new_n143_, new_n144_, new_n147_, new_n149_, new_n152_, new_n156_,
  ...
  assign z09 = x2 & (x0 | (new_n87_ & ~x1 & ~x3 & ~x4));
  ...
  assign z22 = x0 & (x2 | (new_n87_ & ~x1 & ~x4));
  ...
  assign z31 = ~new_n113_ | (x0 & (x2 | (~x2 & ~x4 & x6)));
  assign new_n113_ = (~x1 | (x0 & x2)) & (~x2 | (x5 & (x0 | x3))) & (x0 | (x4 & (x2 | ~x3))) & (x2 | (x4 ^ ~x5));
  ...
  assign z42 = (~new_n139_ & ~x2) | (~x0 & (new_n140_ | x4));
  assign new_n139_ = ~x4 & (x5 | (x0 & ~x1 & x6 & x7)) & (~x5 | (~x6 & ~x7) | (~x0 & x4));
  assign new_n140_ = ~x4 & ((x2 & (~x5 | x6)) | (x5 & x6) | (~x5 & ~x6) | x7);
  assign z43 = (~x2 & (new_n142_ | new_n143_)) | (~x0 & (new_n140_ | new_n144_));
  ...
  assign z45 = (x1 & (~x2 | (~x0 & ~x4 & x6))) | (~new_n147_ & ~x0) | (x0 & ~x2);
  assign new_n147_ = (~x5 | (x1 & x4)) & (x1 | (~x2 & ~x4 & x6 & x7));
  assign z46 = x2 ? ~x0 : (~new_n149_ | x0 | (~x4 & (new_n81_ | x5)));
  assign new_n149_ = x1 & ~x3;
  assign z47 = (~x0 & x2 & (~x1 | (~new_n75_ & ~x4))) | (~x2 & (~new_n87_ | x0 | x1 | x4));
  assign z48 = ~new_n83_ | ~new_n152_ | (~x4 & (x5 ? (~x6 | ~x7) : x6));
  assign new_n152_ = ~x2 & x3;
  assign z49 = (~new_n75_ & ~x4) | ~new_n83_ | ~x2 | (x3 & x4);
  assign z50 = (x0 & (~x1 | ~x3)) | ~new_n87_ | x2 | x4;
  assign z51 = (x2 & (x0 | x4)) | (x0 & (~x1 | x3)) | (~new_n156_ & ~x4) | (~x0 & (x1 | ~x3));
  assign new_n156_ = (x0 | (~x5 & ~x6)) & (x5 | ~x6) & (~x5 | (x6 & x7));
  assign z52 = (~x2 & ((x0 & (~x1 | x3)) | (~new_n75_ & ~x4) | (~x0 & ~x3))) | (~x0 & ((~new_n75_ & ~x4) | x1 | (x2 & x3 & x4)));
  assign z53 = (x0 & (x2 | (x1 & ~x3))) | (~new_n93_ & (x2 ? ~x1 : ~x3)) | (~x1 & (~x2 ^ ~x3)) | new_n159_ | (x1 & x2 & x3);
  assign new_n159_ = ~x4 & (x5 | x6) & (x2 ? x1 : x3);
  assign z54 = (~x1 & ((~x2 & ~x3) | (~x0 & x2 & x3))) | (~new_n161_ & ~x0) | (~x2 & ((x0 & x3) | (~new_n93_ & (x0 | x3))));
  assign new_n161_ = x3 ? (x4 | (x5 ? (x6 & x7) : ~x6)) : (x2 ? (~x4 & x5 & x6 & x7) : (x4 | (~x5 & ~x6)));
  assign z55 = new_n129_ | ~x1 | (~new_n152_ & x0);
  assign z56 = (~x0 & (~new_n164_ | (~x1 & (~x2 | x3)))) | (~x2 & (x0 | ~x3));
  assign new_n164_ = (~x2 | (~x4 & x5 & x6 & x7)) & (x4 | ((~x6 | x7) & (x2 | ~x5)));
  assign z57 = (~x3 & (x0 | ~x1)) | new_n166_ | new_n167_ | ~new_n168_;
  assign new_n166_ = (x0 | (~x0 & ~x2)) & (~x1 | (~x4 & x5));
  assign new_n167_ = ~x7 & ((~x4 & x6) | (~x0 & x2));
  assign new_n168_ = x0 ? ~x2 : (x2 ? (~x4 & x5 & x6) : ~x3);
  assign z58 = (~new_n172_ & x1) | (x5 & (~x1 | ~x4)) | ~new_n170_ | (~new_n171_ & ~x1);
  assign new_n170_ = ~x0 & x3;
  assign new_n171_ = ~x2 & ~x4 & x6 & x7;
  assign new_n172_ = x2 & (x4 | ~x6);
  assign z59 = (~x2 & (~new_n174_ | ~new_n109_ | (x0 & (~x1 | ~x3)))) | (~x0 & (~new_n174_ | ~new_n109_ | (x2 & (x1 | x3))));
  assign new_n174_ = x6 & x7;
  assign z60 = (x2 & (x0 | ~x3)) | (x3 & (x0 | ~x2)) | (x0 & (~x1 | ~x4)) | (~x0 & (~new_n89_ | x1 | x4));
  assign z62 = ~x0 | (~x2 & (new_n129_ | ~new_n149_));
  assign z30 = 1'b0;
  assign z33 = 1'b1;
  assign z61 = 1'b1;
  assign z12 = z08;
