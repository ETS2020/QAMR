...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n77_, new_n84_, new_n86_, new_n88_, new_n90_, new_n92_,
    new_n94_, new_n97_, new_n99_, new_n105_, new_n107_, new_n110_,
    new_n112_, new_n114_, new_n116_, new_n118_, new_n119_, new_n120_,
    new_n121_, new_n124_, new_n126_, new_n129_, new_n131_, new_n132_,
  ...
  assign z08 = ~x3 & (new_n84_ | ~x2);
  assign new_n84_ = x0 & x1 & ~x4 & x5 & x6 & x7;
  ...
  assign z17 = ~x2 & (~x3 | (new_n99_ & x4 & ~x5));
  ...
  assign z26 = ~x3 & (~x2 | (x0 & ~x4 & new_n105_ & ~x5));
  assign new_n105_ = x6 & x7;
  assign z27 = ~x3 & (new_n107_ | ~x2);
  assign new_n107_ = ~x0 & x1 & ~x4 & ~x5 & x6 & ~x7;
  assign z28 = (~x2 & ~x3) | (new_n99_ & x2 & x3 & new_n105_ & ~x4 & ~x5);
  ...
  assign z38 = (x1 & (x2 | x3)) | (x2 & (x0 | ~x3 | ~x4)) | (x3 & ((~x0 & ~x2) | (~new_n75_ & ~x4)));
  assign z39 = (~new_n77_ & x5) | ~x3 | x4 | (~new_n129_ & ~x5);
  ...
  assign z42 = (x4 & (x3 | (x2 & x5))) | (x5 & ~new_n77_ & (x2 | x3)) | (~new_n138_ & ~x5);
  assign new_n138_ = x3 ? (x0 & ~x1 & x6 & x7) : ~x2;
  assign z43 = (~x3 & (~x2 | x4)) | ~new_n141_ | (~new_n140_ & ~x4);
  assign new_n140_ = (x5 | (x0 & (~x2 | (x6 & x7)))) & (~x5 | (~x6 & ~x7)) & (x2 | ~x6 | x7);
  assign new_n141_ = (x2 | ((~x1 | x5) & (x0 | (~x4 & x5)))) & (~x1 | (~x4 & (~x3 | x5))) & (~x0 | ~x2 | ~x4);
  assign z45 = (x0 & (x2 | x3)) | (x2 & (new_n131_ | ~x1)) | (~x2 & ~new_n143_ & x3);
  ...
  assign z50 = x2 | (x3 & (new_n99_ | x4 | (~x2 & (~new_n105_ | x5))));
  assign z51 = (x0 & (~x1 | ~x2)) | (~x3 & (~x2 | (~x0 & ~x4))) | (~new_n75_ & ~x4) | (~x0 & (x1 | (x2 & x4)));
  assign z52 = (x0 & (~x2 | x3)) | (~x0 & (x1 | (x2 & x3 & x4))) | (~x2 & ~x3) | (~new_n75_ & ~x4);
  assign z53 = new_n155_ | new_n156_ | (x3 & (new_n157_ | ~new_n158_));
  assign new_n155_ = (~x1 | (~x4 & x6)) & (x3 ? (~x2 | ~x5) : x2);
  assign new_n156_ = x2 & ((x0 & (~x1 | ~x3)) | (~x3 & ~x4 & x5) | (~x0 & x1 & x3));
  assign new_n157_ = (~x6 | ~x7) & (~x1 | (~x4 & x5));
  assign new_n158_ = (x1 | (~x0 & ~x4)) & (x2 | x4 | ~x5);
  assign z54 = (x0 & (x3 | (~x1 & x2))) | (~new_n88_ & (~x2 ^ ~x3)) | (x3 & (new_n160_ | (~x1 & x2)));
  assign new_n160_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = new_n162_ | ~x1 | (~x2 & ~x3) | (x0 & ~new_n88_ & x2);
  assign new_n162_ = ~x4 & (x5 | x6) & (~x0 | ~x2);
  assign z56 = (~x1 & (~x2 | x3)) | (~x2 & (new_n164_ | ~x3)) | x0 | (~new_n88_ & x2);
  ...
  assign z58 = (new_n169_ & ~x0) | (~x2 & (x0 | x1)) | ~new_n171_ | (~new_n170_ & (x0 | ~x1));
  ...
  assign z61 = x2 ? (new_n131_ | ~x0 | x1 | ~x3) : x3;
