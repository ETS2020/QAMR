...
module FAU ( 
  ...
  wire new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    new_n93_, new_n94_, new_n96_, new_n102_, new_n107_, new_n110_,
    new_n113_, new_n116_, new_n118_, new_n119_, new_n121_, new_n122_,
    new_n124_, new_n125_, new_n126_, new_n128_, new_n131_, new_n134_,
    new_n136_, new_n137_, new_n140_, new_n142_, new_n143_, new_n144_,
    new_n145_, new_n148_, new_n150_, new_n152_, new_n153_, new_n155_,
  ...
  assign z12 = (~x2 & ~x6) | (new_n94_ & new_n93_ & x2 & ~x3);
  assign new_n93_ = x0 & ~x1;
  assign new_n94_ = ~x4 & x5 & x6 & x7;
  assign z13 = x7 & new_n96_ & x6;
  assign new_n96_ = x5 & ~x4 & x3 & ~x2 & ~x0 & x1;
  assign z14 = ~x2 & (~x6 | (new_n83_ & x0 & ~x1 & x3));
  assign z15 = (~x2 & ~x6) | (new_n94_ & x2 & x3 & ~x0 & x1);
  assign z16 = x7 & x6 & x5 & ~x4 & new_n91_ & x3;
  assign z17 = x6 & ~x5 & x4 & new_n93_ & ~x2;
  assign z18 = (~x2 & ~x6) | (new_n102_ & ~x0 & ~x1 & x2);
  ...
  assign z35 = (x0 & (x2 | (~x5 & x6))) | (~new_n128_ & (x2 | x6)) | (~x0 & ~x2 & x3 & x6) | (x2 & (~x3 | ~x5));
  ...
  assign z38 = (~x4 & (x0 | x2)) | ~new_n118_ | (x0 & (x2 | ~x6));
  assign z39 = (~new_n134_ & x2) | x4 | (~x2 & (~new_n93_ | ~new_n122_ | x5));
  ...
  assign z42 = ~new_n140_ | (x4 & (x2 | x6));
  assign new_n140_ = (~x2 | (x6 ? x3 : (x5 & ~x7))) & (~x6 | (new_n93_ & ~x5 & x7));
  assign z43 = new_n144_ | ~new_n142_ | new_n145_;
  assign new_n142_ = (new_n143_ | x4) & (~x1 | (x2 ? ~x4 : ~x6)) & (~x2 | x3 | ~x4);
  assign new_n143_ = (x0 | (x2 ? x5 : (~x6 | ~x7))) & (~x5 | (~x6 & (~x2 | ~x7))) & (~x2 | x5 | (x6 & x7));
  assign new_n144_ = x0 & ((x2 & x4) | (~x2 & ~x4 & x6 & ~x7));
  assign new_n145_ = x3 & ((x1 & x2 & ~x5) | (~x0 & ~x2 & x6));
  assign z44 = (~x2 & x6 & (x1 | (~x0 & x3))) | x0 | x2 | ~x4 | ~x6;
  assign z45 = (x1 & (~x2 | (~x4 & x6))) | ~new_n148_ | (x5 & (~x1 | ~x4));
  assign new_n148_ = ~x0 & (x1 | (new_n122_ & ~x2 & ~x4));
  assign z46 = ~new_n150_ | (~x4 & (x5 | ~x7));
  assign new_n150_ = ~x0 & x1 & ~x2 & ~x3 & x6;
  assign z47 = ~new_n152_ | (~x0 & ~x4 & (x5 | (x1 & x6)));
  assign new_n152_ = (x2 | (~x0 & ~x1)) & (new_n153_ | (~x0 & x1)) & (~x0 | (x1 & x3 & x5)) & (x1 | (~x2 & ~x5));
  assign new_n153_ = ~x4 & x6 & x7;
  assign z48 = ~new_n155_ | (~x4 & (~x5 | ~x7));
  assign new_n155_ = new_n81_ & ~x2 & x3 & x6;
  assign z49 = new_n157_ | (~new_n158_ & x2) | (~x2 & x6);
  assign new_n157_ = ~x4 & (x6 | (x2 & x5));
  assign new_n158_ = ~x0 & ~x1 & (~x3 | ~x4);
  assign z50 = (~new_n160_ & x0) | x2 | x4 | ~new_n122_ | x5;
  assign new_n160_ = x1 & x3;
  assign z51 = (x0 & (~x1 | (~x2 & x3))) | ~new_n163_ | (~new_n162_ & ~x0);
  assign new_n162_ = (x2 | (x3 & x4)) & (x4 | (x3 & ~x5 & ~x6)) & ~x1 & (~x2 | ~x4);
  assign new_n163_ = (x2 | x6) & (x4 | (x2 ? (~x5 & ~x6) : (x5 & x7)));
  assign z52 = ~new_n165_ | (x0 & (x3 | (~x1 & ~x2)));
  assign new_n165_ = new_n166_ & (x4 | (x2 & ((x0 & ~x2) | (~x5 & ~x6))));
  assign new_n166_ = (x2 | (x6 & (x0 | x3))) & (x0 | (~x1 & (~x2 | ~x3 | ~x4)));
  assign z53 = new_n168_ | (~new_n171_ & x6) | (~new_n169_ & x2);
  assign new_n168_ = ~new_n83_ & (x2 ? ~x1 : (~x3 & x6));
  assign new_n169_ = (~x0 | (x1 & x3)) & ((x3 & x6) | (~new_n79_ & x1)) & ~new_n170_ & (x0 | ~x1 | ~x3);
  assign new_n170_ = ~x4 & x5 & ~x7;
  assign new_n171_ = (~x1 | (x3 ? (x4 | x5) : ~x0)) & (~x2 | x3 | x4) & (x2 | ~x3 | (x1 & x4));
  assign z54 = new_n173_ | (x2 & (~new_n175_ | (x0 & (~x1 | x3))));
  assign new_n173_ = x6 & ((~x1 & (x0 | (~x2 & ~x3))) | (x0 & x3) | (~new_n174_ & ~x2));
  assign new_n174_ = (x0 | x3 | x4) & ((~x0 & ~x3) | (~x4 & x5 & x7));
  assign new_n175_ = ((x6 & x7) | (x3 & (x4 | ~x5))) & (x3 | (~x4 & x5)) & (x1 | ~x3) & (x4 | x5 | ~x6);
  assign z55 = ~new_n177_ | (~x4 & ((~x2 & x6) | (~x0 & (x6 | (x2 & x5)))));
  assign new_n177_ = (x1 | (~x2 & (x2 | ~x6))) & (~x0 | (x2 ? new_n94_ : (x3 | ~x6)));
  assign z56 = (x0 & (x2 | x6)) | ~new_n179_ | (~x1 & (x2 ? x3 : x6));
  assign new_n179_ = x2 ? (~x4 & x5 & x6 & x7) : (~x6 | (x3 & (x4 | (~x5 & x7))));
  ...
  assign new_n184_ = (x0 | x4 | (~x5 & ~x6)) & new_n160_ & (~x0 | (~x4 & x5 & x6 & x7));
  assign new_n185_ = new_n81_ & ~x4 & ~x5 & x7;
  assign z59 = new_n187_ | (new_n189_ & ~x2) | (x2 & (~new_n188_ | (~new_n93_ & x3)));
  ...
  assign new_n191_ = x0 ? (x1 & ~x3 & x4) : (~x1 & ~x4 & x5 & x7);
  assign z61 = (x1 & (x2 | x6)) | (~x1 & (x2 ? ~x3 : x6)) | (~x4 & x6) | (~new_n193_ & x2);
  assign new_n193_ = ~new_n79_ & x0;
  assign z62 = (~x0 & (x2 | (x1 & x6))) | (x1 & x3 & (x2 | x6)) | new_n157_ | (~x1 & (x2 | (~x2 & x6)));
  assign z20 = 1'b0;
  assign z21 = 1'b0;
  assign z29 = 1'b0;
endmodule
