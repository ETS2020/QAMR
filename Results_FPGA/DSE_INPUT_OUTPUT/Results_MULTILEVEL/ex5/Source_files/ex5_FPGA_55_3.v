...
module FAU ( 
  ...
  wire new_n75_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_, new_n93_,
    ...
    new_n165_, new_n167_, new_n170_, new_n172_, new_n173_, new_n174_,
    new_n177_;
  assign z00 = z30 | (new_n75_ & ~x4);
  assign z30 = x0 & x2;
  assign new_n75_ = ~x5 & ~x6;
  assign z01 = ~x5 & ~x6 & ~z30 & ~x7;
  assign z02 = z30 | (~x3 & ~x4 & x5 & ~x6 & ~x7);
  assign z03 = z30 | (x3 & ~x4 & x5 & ~x6 & ~x7);
  ...
  assign z22 = x0 & (x2 | (~x1 & ~x4 & new_n103_ & ~x5));
  ...
  assign z40 = new_n136_ | new_n131_ | new_n137_ | x1 | (~x4 & x5);
  ...
  assign new_n140_ = (~x5 | (~x6 & ~x7) | (~x0 & x4)) & ~x4 & (x5 | (x0 & ~x1 & x6 & x7));
  assign new_n141_ = ~x4 & ((x2 & (~x5 | x6)) | (x5 & x6) | x7 | (~x5 & ~x6));
  ...
  assign z62 = ~x0 | (~x2 & (new_n158_ | ~x1 | x3));
  assign z08 = 1'b0;
  assign z12 = 1'b0;
  assign z26 = 1'b0;
  assign z28 = 1'b0;
