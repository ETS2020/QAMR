...
module FAU ( 
  ...
  wire new_n75_, new_n80_, new_n82_, new_n85_, new_n86_, new_n88_, new_n90_,
    new_n92_, new_n95_, new_n101_, new_n104_, new_n106_, new_n108_,
    ...
    new_n147_, new_n149_, new_n150_, new_n154_, new_n157_, new_n159_,
    new_n160_, new_n164_, new_n167_, new_n169_;
  ...
  assign new_n106_ = ~x0 & x1 & ~x4 & new_n82_ & ~x5;
  ...
  assign z30 = (~x2 & x3) | (new_n90_ & x2 & ~x3 & x0 & x1);
  assign z31 = ~new_n114_ | (~z13 & x1);
  assign new_n114_ = (x5 | (~x2 & (x3 | ~x4))) & (~x2 | (~x0 & x3 & x4)) & (x3 | x4 | (x0 & ~x5 & ~x6));
  assign z32 = ~new_n116_ | (~x4 & (x0 | x2));
  assign new_n116_ = (~x0 | (~x2 & x5)) & (x2 | ((new_n80_ | x0) & ~x3)) & ~x1 & (~x2 | x3);
  assign z33 = ~new_n118_ | ~x7 | x4 | ~x6;
  assign new_n118_ = new_n108_ & (x1 | ~x5) & (~x1 | ~x3 | x5);
  assign z34 = (~new_n120_ & ~x3) | (x2 & (~new_n121_ | (x3 & (~x5 | x6))));
  assign new_n120_ = (~x2 | (~x0 & x6)) & new_n122_ & (x2 | (~new_n121_ & x0));
  assign new_n121_ = ~x4 & ~x7;
  assign new_n122_ = ~x1 & ~x5 & (x4 | x6);
  assign z35 = (x0 & (x2 | (~x3 & ~x5))) | ((x2 | ~x3) & (x1 | ~x4)) | (x2 & (~x3 | ~x5));
  assign z36 = (x1 & (~x2 | (x2 & ~x3))) | ~new_n125_ | (~x1 & (x5 | (~x2 & ~x4)));
  assign new_n125_ = ~x3 & (x0 | x2) & (~x2 | (new_n82_ & ~x5 & ~x4 & (~x0 | x3)));
  assign z37 = (~x1 & (~x2 | x5)) | (~x2 & (~x0 | x3)) | (~new_n127_ & x2);
  assign new_n127_ = x3 & ~x4 & new_n82_ & ~x5;
  assign z38 = (x3 & (x0 | ~x2)) | (x0 & (x2 | ~x4)) | (x2 & (~x3 | ~x4)) | x1 | (~x0 & ~new_n80_ & ~x2);
  assign z39 = ~new_n130_ | (x2 & (x6 | x7 | ~x3 | ~x5));
  assign new_n130_ = ~x4 & (x2 | (new_n131_ & x0 & ~x1 & ~x3));
  assign new_n131_ = ~x5 & x6 & x7;
  assign z40 = (x1 & (~x0 | ~x2)) | (x3 & (x0 | ~x2)) | new_n134_ | (~new_n133_ & x0) | (~x0 & x2 & ~x3);
  assign new_n133_ = (~x4 | (~x2 & x5)) & (~x2 | (new_n86_ & ~x5));
  ...
  assign new_n145_ = ~x0 & (x1 | (new_n86_ & ~x4 & ~x2 & ~x3));
  assign z46 = x2 | (~x3 & (x0 | ~x1 | (new_n147_ & ~x2)));
  assign new_n147_ = ~x4 & (new_n82_ | x5);
  assign z47 = new_n150_ | (x2 & ((new_n149_ & ~x0) | ~x1 | (~new_n92_ & x0)));
  assign new_n149_ = ~new_n75_ & ~x4;
  assign new_n150_ = ~x3 & (x0 | (~x2 & (~new_n131_ | x1 | x4)));
  assign z49 = (x0 & (x2 | ~x3)) | (~x2 & ~x3) | (x2 & ((~new_n75_ & ~x4) | x1 | (x3 & x4)));
  assign z50 = x2 | x3 | (~x3 & (x0 | (~new_n90_ & ~x2)));
  assign z51 = (~x1 & (x0 | (~x2 & ~x3))) | (~x2 & (~x0 | x3)) | (~new_n154_ & ~x4) | (~x0 & ((x1 & x2) | ~x3 | x4));
  assign new_n154_ = (~x2 | (~x5 & ~x6)) & (~x0 | (x5 ? (x6 & x7) : ~x6));
  assign z52 = (~x3 & ((x0 & ~new_n75_ & ~x4) | (~x2 & (~x0 | ~x1)))) | (x2 & ((x3 & (x0 | (~x0 & x4))) | (~x0 & (x1 | (~new_n75_ & ~x4)))));
  assign z53 = (x1 & (x0 ? ~x3 : (x2 & x3))) | (x2 & (~new_n157_ | (x0 & (~x1 | ~x3)))) | (~x2 & ~new_n92_ & ~x3);
  assign new_n157_ = ((x3 & x5) | (x1 & (x4 | ~x6))) & ((x6 & x7) | (x1 & (x4 | ~x5))) & (x1 | ~x4) & (x3 | x4 | ~x5);
  assign z54 = ~new_n159_ | (~new_n160_ & ~x4);
  assign new_n159_ = ((~x0 & x2) | (x1 & ~x3)) & (x1 | ~x3) & (new_n92_ | (~x0 & (~x2 | x3)));
  assign new_n160_ = (x0 | x2 | (~x5 & ~x6)) & (~x3 | (x5 ? (x6 & x7) : ~x6));
  assign z55 = (new_n149_ & ~x0) | ~x1 | (~new_n92_ & x0) | (~x2 & (x0 | x3));
  assign z56 = x2 ? (~new_n85_ | x0 | x4 | (~x1 & x3)) : ~x3;
  assign z57 = (~x1 & (~x2 | ~x3)) | ~new_n164_ | (~x2 & (x3 | (~x4 & x5)));
  assign new_n164_ = (x7 | (~x2 & (x4 | ~x6))) & ~x0 & (~x2 | (~x4 & x5 & x6));
  assign z58 = (new_n149_ & ~x0) | (~new_n92_ & x0) | ~x1 | ~x2 | ~x3;
  assign z59 = (x1 & (x0 ? x3 : x2)) | (~x2 & (x0 | (~x0 & x3))) | (~new_n167_ & ~x0) | (x0 & (new_n149_ | (~x1 & ~x3)));
  assign new_n167_ = ~x4 & ~x5 & new_n86_ & (~x3 | x5);
  assign z60 = x0 ? (~x1 | ~x4 | (x1 & x3)) : ~new_n169_;
  assign new_n169_ = (~x1 | (~x2 & ~x5)) & new_n86_ & x5 & (x2 | ~x3) & ~x4 & (~x2 | x3 | ~x5);
  assign z61 = ~x3 | (x2 & (new_n149_ | ~x0 | x1));
