...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n80_, new_n83_, new_n85_, new_n88_, new_n90_, new_n91_,
    new_n93_, new_n95_, new_n103_, new_n106_, new_n107_, new_n109_,
  ...
  assign z32 = (~x0 & ((~x2 & (x3 | x4)) | x1 | (~new_n79_ & ~x4))) | (x2 & (x0 | ~x3 | ~x4));
  assign z33 = ~x0 | (~new_n115_ & x2);
  assign new_n115_ = ~x4 & (x1 | ~x5) & new_n107_ & (~x1 | ~x3 | x5);
  ...
  assign z36 = ~new_n80_ | x4 | x5 | ~new_n83_ | ~x2 | x3;
  ...
  assign new_n126_ = ~x4 & (x5 | (x0 & ~x1 & new_n107_ & x3));
  ...
  assign z45 = (x2 & (new_n135_ | x0 | ~x1)) | (~x0 & ~x2 & (~new_n106_ | x1 | x4));
  assign new_n135_ = ~x4 & (x5 | x6);
  assign z46 = (~new_n137_ & ~x4) | ~new_n91_ | x2 | x3;
  assign new_n137_ = ~x5 & (~x6 | x7);
  assign z47 = ((~x0 ^ x2) & (~new_n107_ | x4)) | (~new_n139_ & x2) | (~new_n140_ & ~x0);
  assign new_n139_ = (~x0 | (x3 & x5)) & x1 & (~new_n135_ | x0);
  assign new_n140_ = (x2 | (~x1 & ~x5)) & (x4 | new_n107_ | ~x5);
  assign z48 = x2 | (~x0 & (new_n142_ | ~x3 | (x1 & ~x2)));
  assign new_n142_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z49 = new_n135_ | ~new_n83_ | ~x2 | (x3 & x4);
  assign z50 = x2 | (~x0 & (~new_n107_ | x4 | x5));
  assign z51 = (x0 & (~x1 | ~x2)) | new_n135_ | (~x0 & ((~x3 & (~x2 | ~x4)) | x1 | (x2 & x4)));
  assign z52 = (x2 & (new_n135_ | (x3 & (x0 | (~x0 & x4))))) | (~x0 & (new_n135_ | x1 | (~x2 & ~x3)));
  assign z53 = (~new_n148_ & (x2 ? ~x1 : ~x3)) | (~x3 & (x0 | (~x1 & x2))) | (~x1 & (x0 | (~x2 & x3))) | new_n149_ | (x0 & ~x2) | (~x0 & x1 & x2 & x3);
  assign new_n148_ = new_n107_ & ~x4 & x5;
  ...
  assign z55 = (~x1 & (x2 | (~x0 & ~x2))) | (new_n135_ & ~x0) | (x0 & ~new_n148_ & x2);
  assign z56 = ~new_n156_ | (~x1 & (x2 ? x3 : ~x0));
  assign new_n156_ = (x0 | x2 | (x3 & (new_n137_ | x4))) & (~x2 | (new_n85_ & ~x0 & ~x4));
  assign z57 = (x2 & (~new_n85_ | x0 | x4)) | (~new_n158_ & ~x0);
  assign new_n158_ = (x1 | (x2 & x3)) & (x2 | (~x3 & (x4 | ~x5))) & (~new_n80_ | x4);
  assign z58 = (~x0 & (~new_n160_ | (x1 & (new_n162_ | ~x2)))) | (x2 & (~x1 | (~new_n161_ & x0)));
  assign new_n160_ = (~x5 | (x1 & x4)) & x3 & (x1 | (new_n107_ & ~x4));
  assign new_n161_ = new_n85_ & x3 & ~x4;
  assign new_n162_ = ~x4 & x6;
  assign z59 = (~new_n164_ & x2) | (~x0 & (~new_n107_ | x4 | x5));
  assign new_n164_ = (~x0 | ((x1 | x3) & (x4 | ~x6))) & (x0 | (~x1 & ~x3)) & (x4 | ~x5) & (~x1 | (~x3 & (x4 | ~x6)));
  assign z60 = (~x2 & (x0 | x3)) | (x0 & (~x1 | x3 | ~x4)) | (~x0 & (~new_n85_ | x1 | x4 | (x2 & ~x3)));
  assign z61 = new_n135_ | ~x0 | x1 | ~x2 | (~x1 & ~x3);
  assign z62 = new_n135_ | ~x0 | ~x1 | ~x2 | (x1 & x3);
  assign z20 = 1'b0;
