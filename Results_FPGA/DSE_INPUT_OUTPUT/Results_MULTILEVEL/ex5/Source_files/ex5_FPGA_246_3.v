...
module FAU ( 
  ...
  wire new_n81_, new_n83_, new_n85_, new_n87_, new_n90_, new_n93_, new_n95_,
    new_n100_, new_n102_, new_n104_, new_n107_, new_n108_, new_n112_,
  ...
  assign z40 = new_n136_ | new_n135_ | new_n137_ | x1 | (~x4 & x5);
  ...
  assign z53 = (x1 & (x0 ? (~x2 & ~x3) : (x2 & x3))) | (~new_n160_ & ((~x2 & ~x3) | (~x0 & ~x1 & x3))) | (((~x0 & x2 & ~x3) | (~x2 & x3)) & (new_n154_ | ~x1));
  assign new_n160_ = ~x4 & x5 & x6 & x7;
  assign z54 = (~x1 & ((~x2 & ~x3) | (~x0 & x2 & x3))) | (~new_n162_ & ~x0) | (~x2 & ((x0 & x3) | (~new_n160_ & (x0 | x3))));
  assign new_n162_ = x3 ? (x4 | (x5 ? (x6 & x7) : ~x6)) : (x2 ? (x6 & x7 & ~x4 & x5) : (x4 | (~x5 & ~x6)));
  assign z55 = (x0 & ~x2 & ~x3) | ((~x0 | ~x2) & (new_n154_ | ~x1));
  assign z56 = (~x0 & (~new_n165_ | (~x1 & (~x2 | x3)))) | (~x2 & (x0 | ~x3));
  assign new_n165_ = (~x2 | (x6 & x7 & ~x4 & x5)) & (x4 | ((x2 | ~x5) & (~x6 | x7)));
  assign z57 = new_n167_ | new_n168_ | ~new_n169_ | (~x3 & (x0 | ~x1));
  assign new_n167_ = (x0 | (~x0 & ~x2)) & (~x1 | (~x4 & x5));
  assign new_n168_ = ~x7 & ((~x0 & x2) | (~x4 & x6));
  assign new_n169_ = x0 ? ~x2 : (x2 ? (~x4 & x5 & x6) : ~x3);
  assign z58 = new_n172_ | (x0 & ~x2) | (~x0 & (new_n171_ | ~new_n173_));
  assign new_n171_ = x5 & (~x1 | ~x4);
  assign new_n172_ = x1 & (~x2 | (~x0 & ~x4 & x6));
  assign new_n173_ = x3 & (x1 | (x6 & x7 & ~x2 & ~x4));
  assign z59 = (x0 & (~x1 | ~x3)) | ~new_n104_ | ~new_n107_ | (x2 & (x1 | x3));
