...
module FAU ( 
  ...
  wire new_n76_, new_n82_, new_n84_, new_n86_, new_n88_, new_n90_, new_n92_,
    ...
    new_n142_, new_n144_, new_n146_, new_n150_, new_n153_, new_n154_,
  ...
  assign z31 = (~x0 & (~x2 | ~x5)) | ~new_n111_ | (x1 & (x0 | x2));
  assign new_n111_ = (~x2 | (~x0 & x3 & x4)) & (~x0 | (x4 ? x5 : (~x5 & ~x6)));
  ...
  assign z36 = new_n122_ | new_n123_ | (~new_n124_ & x0) | x1 | (~new_n125_ & ~x0);
  assign new_n122_ = x3 & (~x0 | ~x4);
  assign new_n123_ = x5 & (x0 | (~x0 & ~x3));
  ...
  assign z61 = x0 ? ((~x1 & (~x2 | ~x3)) | new_n144_ | x1) : x2;
  ...
  assign z24 = 1'b0;
  assign z25 = 1'b0;
  assign z44 = x2 | (x0 & (x1 | x3 | ~new_n99_ | x4));
  assign z46 = ~z13;
  assign z29 = z13;
  assign z48 = z46;
endmodule
