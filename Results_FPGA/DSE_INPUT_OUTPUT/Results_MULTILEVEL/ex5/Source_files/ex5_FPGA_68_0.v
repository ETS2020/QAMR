...
module FAU ( 
  ...
  wire new_n75_, new_n80_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    ...
    new_n144_, new_n148_, new_n150_, new_n153_, new_n154_, new_n155_,
    new_n156_, new_n158_, new_n160_, new_n162_, new_n164_, new_n167_,
    new_n168_;
  ...
  assign z15 = ~x0 & (~x2 | (new_n89_ & new_n80_ & x1));
  assign z16 = ~x2 & (~x0 | (new_n89_ & new_n80_ & x1));
  ...
  assign z43 = (~new_n139_ & ~x4) | (~new_n140_ & x0) | (x2 & ~new_n83_ & x4);
  assign new_n139_ = ((~x6 & ~x7) | (x0 ? ~x5 : ~x2)) & (~x0 | ~x6 | x7) & (x0 | ~x2 | x5);
  assign new_n140_ = ((~x1 & ~x2) | (~x4 & (x5 | x6))) & (~x1 | (x2 & ~x3) | x5);
  ...
  assign z47 = (x2 & (~x1 | (new_n144_ & ~x0))) | (x0 & (~new_n89_ | ~new_n80_ | ~x2));
  assign z49 = x0 | (x2 & ((~new_n75_ & ~x4) | x1 | (x3 & x4)));
  assign z50 = ~x0 | x2 | (x0 & (~new_n80_ | ~x1 | ~new_n148_ | x5));
  ...
  assign z53 = new_n153_ | (~new_n154_ & ~x4) | (~new_n85_ & ~new_n155_) | ~new_n156_;
  ...
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n85_ & (x2 ? ~x3 : x0)) | (new_n158_ & x2) | (x0 & x3);
  assign new_n158_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = new_n160_ | (~x1 & (x0 | x2)) | (x0 & (x2 ? ~new_n85_ : ~x3));
  assign new_n160_ = ~x4 & (x5 | x6) & (~x0 ^ ~x2);
  assign z56 = ~new_n162_ | ~x7 | ~x5 | ~x6;
  assign new_n162_ = x2 & ~x4 & ~x0 & (x1 | ~x3);
  assign z57 = (~x1 & (x0 | (x2 & ~x3))) | (~new_n85_ & x2) | (x0 & (new_n164_ | x2 | ~x3));
  assign new_n164_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = (new_n144_ & ~x0) | (~new_n85_ & x0) | ~x1 | ~x2 | ~x3;
