...
module FAU ( 
  ...
  wire new_n75_, new_n78_, new_n81_, new_n83_, new_n85_, new_n87_, new_n89_,
    new_n91_, new_n93_, new_n95_, new_n97_, new_n107_, new_n109_,
  ...
  assign z13 = ~x0 & (x2 | (new_n93_ & x1 & x3 & ~x4));
  ...
  assign z25 = ~x0 & (x2 | (new_n81_ & x1 & ~x3 & ~x4));
  ...
  assign z32 = new_n118_ | (~x2 & (new_n116_ | new_n117_ | new_n83_ | x1));
  ...
  assign new_n132_ = (~x3 | x6 | x7) & (x0 ? x5 : ~x2);
