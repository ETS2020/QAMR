...
module FAU ( 
  ...
  wire new_n75_, new_n78_, new_n79_, new_n81_, new_n85_, new_n87_, new_n89_,
    new_n91_, new_n93_, new_n95_, new_n101_, new_n103_, new_n106_,
  ...
  assign z22 = (~x0 & x2) | (new_n103_ & x0 & ~x1 & ~x2);
  ...
  assign z26 = x2 & (~x0 | (new_n78_ & new_n109_ & ~x5));
  ...
  assign z34 = ((~new_n79_ | ~new_n81_) & (x0 ? x5 : ~x2)) | (~x5 & (x0 ? ~new_n122_ : ~x2));
  ...
  assign z38 = ~new_n128_ | (x5 & (x0 ? ~x4 : ~x2)) | (x1 & (x0 | ~x2));
  ...
  assign z44 = ~new_n144_ | (x3 & (x0 | (~x2 & x4)));
  assign new_n144_ = (x2 | (~x1 & (x4 | (x0 & ~x5)))) & (~x0 | (~x2 & ~x4 & ~x5 & ~x6));
  assign z45 = x0 | (~x2 & (x1 | x4 | (~x4 & ((~new_n109_ & ~x0) | x5))));
  ...
  assign z53 = x3 ? (new_n158_ | (~x1 & (x0 | ~x2))) : ((~new_n95_ & ~x2) | (x0 & (x1 | x2)));
  assign new_n158_ = ~x4 & ((x0 & (x5 ? (~x6 | ~x7) : x6)) | (~x2 & (x5 | x6)));
  assign z54 = (~new_n87_ & x0) | (~x2 & (x3 ? ~new_n95_ : ~new_n160_));
  assign new_n160_ = x1 & (x0 | x4 | (~x5 & ~x6));
  assign z55 = (~x1 & (x0 | ~x2)) | (~x2 & (new_n162_ | (x0 & ~x3))) | (x0 & ~new_n95_ & x2);
  assign new_n162_ = ~x4 & (x5 | x6);
  assign z56 = new_n147_ | x2 | ~x3 | x0 | ~x1;
  assign z57 = ((x0 | ~x2) & (new_n147_ | ~x1)) | (~x0 & ~x2 & x3) | (x0 & (x2 | ~x3));
  assign z58 = (x0 & (~x1 | ~x2 | ~x5)) | ~new_n81_ | ~new_n109_ | (~x0 & (x1 | x2 | x5));
  assign z59 = (~x2 & (~new_n103_ | (x0 & (~x1 | ~x3)))) | new_n167_ | (x2 & (~x0 | (x1 & x3) | (~x1 & ~x3)));
