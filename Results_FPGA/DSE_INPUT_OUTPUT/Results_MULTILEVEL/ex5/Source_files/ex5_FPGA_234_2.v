...
module FAU ( 
  ...
  wire new_n81_, new_n83_, new_n84_, new_n86_, new_n88_, new_n90_, new_n92_,
    new_n94_, new_n96_, new_n101_, new_n104_, new_n106_, new_n107_,
    new_n110_, new_n114_, new_n116_, new_n118_, new_n119_, new_n126_,
    new_n128_, new_n130_, new_n131_, new_n132_, new_n133_, new_n136_,
    new_n138_, new_n140_, new_n141_, new_n142_, new_n143_, new_n145_,
    new_n147_, new_n152_, new_n153_, new_n154_, new_n156_, new_n157_,
  ...
  assign z10 = (x0 & ~x2) | (new_n84_ & new_n90_ & ~x0 & x1 & x2);
  ...
  assign z32 = (~x0 & ((~x2 & (x3 | x4)) | x1 | (~new_n114_ & ~x4))) | (x2 & (x0 | ~x3 | ~x4));
  assign new_n114_ = new_n107_ & ~x5;
  ...
  assign z36 = ~new_n106_ | ~new_n81_ | ~x2 | x3;
  assign z37 = ~new_n119_ | x7 | x4 | z11 | ~x3;
  assign z38 = (x2 & (~x3 | ~x4)) | ~new_n81_ | (~x2 & (~new_n114_ | x3 | x4));
  ...
  assign new_n128_ = ~x4 & (x5 | (x0 & ~x1 & new_n84_ & x3));
  ...
  assign z45 = (~new_n136_ & ~x4) | (x2 & (x0 | ~x1)) | (~x0 & ~x2 & (~new_n104_ | x1 | x4));
  assign new_n136_ = (x0 | (~x5 & (~x6 | x7))) & (~x2 | (~x5 & ~x6));
  assign z46 = x2 | (~x0 & (new_n138_ | ~x1 | x3));
  assign new_n138_ = ~x4 & (new_n107_ | x5);
  assign z47 = (~new_n143_ & (~x0 ^ x2)) | (~new_n140_ & x2) | (~new_n142_ & ~x0);
  assign new_n140_ = (~x0 | (x3 & x5)) & x1 & (~new_n141_ | x0);
  assign new_n141_ = ~x4 & (x5 | x6);
  assign new_n142_ = (x2 | (~x1 & ~x5)) & (x4 | new_n84_ | ~x5);
  assign new_n143_ = ~x4 & x6 & x7;
  assign z48 = x2 | (~x0 & ((~new_n145_ & ~x4) | ~x3 | (x1 & ~x2)));
  assign new_n145_ = x5 ? (x6 & x7) : ~x6;
  assign z49 = (x2 & (x1 | (~x4 & x6))) | ~new_n147_ | x0 | ~x2;
  assign new_n147_ = x4 ? ~x3 : ~x5;
  assign z50 = (x4 & (~x2 | x3)) | (x5 & (~x2 | ~x4)) | x0 | x2 | (~new_n84_ & ~x2);
  assign z51 = (x0 & (~x1 | ~x2)) | new_n141_ | (~x0 & ((~x3 & (~x2 | ~x4)) | x1 | (x2 & x4)));
  assign z52 = (x2 & (new_n141_ | (x3 & (x0 | (~x0 & x4))))) | (~x0 & (new_n141_ | x1 | (~x2 & ~x3)));
  assign z53 = (~new_n152_ & ~x0) | (x2 & ((x0 & (~x1 | ~x3)) | new_n154_ | (~x1 & ~x3) | (~x0 & x1 & x3)));
  assign new_n152_ = (new_n153_ | ~x3) & (x2 | x3 | (new_n84_ & new_n90_));
  assign new_n153_ = x1 ? (x4 | (~x5 & ~x6)) : (x2 & ~x4 & x5 & x6 & x7);
  assign new_n154_ = ~x4 & ((~x3 & (x5 | x6)) | (x1 & (x5 ? (~x6 | ~x7) : x6)));
  assign z54 = (x2 & (~new_n157_ | (x0 & (~x1 | x3)))) | (~x0 & ~new_n156_ & ~x2);
  assign new_n156_ = x3 ? (new_n84_ & new_n90_) : (~new_n141_ & x1);
  assign new_n157_ = ((x6 & x7) | (x3 & (x4 | ~x5))) & (x3 | (~x4 & x5)) & (x1 | ~x3) & (x4 | x5 | ~x6);
  assign z55 = (~x1 & (x2 | (~x0 & ~x2))) | (new_n141_ & ~x0) | (x0 & x2 & (~new_n84_ | ~new_n90_));
  assign z56 = (~x1 & (x2 ? x3 : ~x0)) | (~new_n160_ & x2) | (~x0 & ~x2 & (new_n138_ | ~x3));
  assign new_n160_ = ~x0 & ~x4 & new_n84_ & x5;
  assign z57 = (~new_n162_ & ~x0) | (~new_n160_ & x2);
  assign new_n162_ = (x1 | (x2 & x3)) & (x2 | (~x3 & (x4 | ~x5))) & (~new_n107_ | x4);
  assign z58 = ~new_n164_ | (~x0 & ~x4 & (x5 | (x1 & x6)));
  assign new_n164_ = (x2 | (~x0 & ~x1)) & (new_n143_ | (~x0 & x1)) & (~x0 | (x1 & x5)) & x3 & (x1 | (~x2 & ~x5));
  assign z59 = (~new_n166_ & ~x0) | (x2 & (x0 ? (new_n141_ | (x1 & x3) | (~x1 & ~x3)) : (x1 | x3)));
  assign new_n166_ = new_n84_ & ~x4 & ~x5;
  assign z60 = (x3 & (~x0 ^ x2)) | (x2 & (x0 ? (~x4 | (~x1 & ~x3)) : ~x3)) | (~x0 & (~new_n83_ | x1 | x4));
  assign z61 = new_n141_ | ~x0 | x1 | ~x2 | ~x3;
  assign z62 = ~x0 | (x2 & (new_n141_ | ~x1 | x3));
  assign z17 = 1'b0;
  assign z20 = 1'b0;
  assign z21 = 1'b0;
  assign z22 = 1'b0;
