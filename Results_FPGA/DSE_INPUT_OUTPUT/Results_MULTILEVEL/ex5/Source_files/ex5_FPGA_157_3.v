...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n81_, new_n83_, new_n85_, new_n87_, new_n90_, new_n93_, new_n95_,
    new_n100_, new_n102_, new_n106_, new_n107_, new_n111_, new_n113_,
    ...
    new_n155_, new_n158_, new_n162_, new_n165_, new_n166_, new_n168_,
  ...
  assign z13 = (x0 & x2) | (new_n90_ & ~x0 & x1 & ~x2 & x3);
  ...
  assign z32 = (~z08 & x1) | new_n115_ | new_n116_ | new_n117_ | new_n118_;
  assign new_n115_ = ~x3 & (x0 ? ~x4 : x2);
  assign new_n116_ = x0 & (x2 | (~x2 & ~x4 & x6));
  assign new_n117_ = ~x2 & ((~x0 & (x3 | x4)) | (~x4 & x5) | (x4 & ~x5));
  assign new_n118_ = ~x0 & ~x4 & (x2 | ~x6 | x7);
  ...
  assign z38 = (~x2 & (new_n129_ | x1 | (~new_n130_ & ~x0))) | (~x0 & (x1 | (~new_n131_ & x2)));
  assign new_n129_ = ~x4 & (x5 | (x0 & (~x3 | x6)));
  assign new_n130_ = ~x3 & ~x4 & ~x5 & x6 & ~x7;
  assign new_n131_ = x3 & x4;
  assign z39 = (x2 & (x0 | ~x5)) | ~new_n134_ | (~new_n133_ & x5);
  assign new_n133_ = x3 & ~x6 & ~x7;
  assign new_n134_ = ~x4 & (x5 | (x0 & ~x1 & x6 & x7));
  assign z40 = (~new_n136_ & ~x2) | (~x0 & (~new_n137_ | (~new_n131_ & x2)));
  assign new_n136_ = (~x0 | (x4 ? x5 : ~x6)) & ~x1 & (x4 | ~x5) & (x0 | ~x3);
  assign new_n137_ = ~x1 & (x4 | (~x5 & x6 & ~x7));
  assign z41 = (~x1 & (~x3 | ~x5)) | ~x0 | x2 | (x1 & x3);
  assign z42 = (~new_n140_ & ~x2) | (~x0 & (new_n141_ | x4));
  assign new_n140_ = ~x4 & (x5 | (x0 & ~x1 & x6 & x7)) & (~x5 | (~x6 & ~x7) | (~x0 & x4));
  assign new_n141_ = ~x4 & ((x2 & (~x5 | x6)) | (x5 & x6) | (~x5 & ~x6) | x7);
  assign z43 = (~x2 & (new_n143_ | new_n144_)) | ((new_n141_ | new_n145_) & ~x0);
  ...
  assign z46 = x2 ? ~x0 : (~new_n150_ | x0 | (~x4 & (new_n107_ | x5)));
  ...
  assign z49 = ~x2 | (~x0 & (new_n155_ | new_n131_ | x1));
  assign new_n155_ = ~x4 & (x5 | x6);
  assign z50 = (x0 & (~x1 | ~x3)) | ~new_n85_ | x2 | x4;
  assign z51 = (~new_n158_ & ~x0) | (~x2 & (new_n153_ | (~new_n150_ & x0)));
  assign new_n158_ = (x4 | (~x5 & ~x6)) & ~x1 & x3 & (~x2 | ~x4);
  assign z52 = (~x0 & (x1 | (~x2 & ~x3))) | (x2 & (x0 | (x3 & x4))) | (~new_n100_ & ~x4) | (x0 & (~x1 | x3));
  assign z53 = (x1 & (x0 ? (~x2 & ~x3) : (x2 & x3))) | (~new_n90_ & ((~x2 & ~x3) | (~x0 & ~x1 & x3))) | ((new_n155_ | ~x1) & ((~x0 & x2 & ~x3) | (~x2 & x3)));
  assign z54 = (~x1 & ((~x2 & ~x3) | (~x0 & x2 & x3))) | (~new_n162_ & ~x0) | (~x2 & ((~new_n90_ & (x0 | x3)) | (x0 & x3)));
  assign new_n162_ = x3 ? (x4 | (x5 ? (x6 & x7) : ~x6)) : (x2 ? (~x4 & x5 & x6 & x7) : (x4 | (~x5 & ~x6)));
  assign z55 = new_n155_ | ~x1 | (x0 & (x2 | ~x3));
  assign z56 = (~x1 & (~x2 | x3)) | ~new_n166_ | (~x2 & (new_n165_ | ~x3));
  assign new_n165_ = ~x4 & x5;
  assign new_n166_ = (x7 | (~x2 & (x4 | ~x6))) & ~x0 & (~x2 | (~x4 & x5 & x6));
  assign z57 = new_n170_ | new_n169_ | ~new_n171_ | (~new_n168_ & (new_n165_ | ~x1));
  assign new_n168_ = ~x0 & x2;
  assign new_n169_ = ~x7 & (x2 | (~x4 & x6));
  assign new_n170_ = ~x3 & (x0 | ~x1);
  assign new_n171_ = (~x2 | (~x0 & ~x4 & x5 & x6)) & (x0 | x2 | ~x3);
  ...
  assign z59 = (~x2 & (~new_n177_ | ~new_n106_ | (x0 & (~x1 | ~x3)))) | (~x0 & (~new_n177_ | ~new_n106_ | (x2 & (x1 | x3))));
