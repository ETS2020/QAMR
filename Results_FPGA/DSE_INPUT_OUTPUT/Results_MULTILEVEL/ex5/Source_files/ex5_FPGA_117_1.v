...
module FAU ( 
  ...
  assign z33 = ~x7 | (~new_n118_ & x2);
  assign new_n118_ = x0 & ~x4 & (x1 | ~x5) & x6 & (~x1 | ~x3 | x5);
  assign z34 = (~x7 & (~new_n121_ | (~new_n120_ & (~x3 | x4)))) | (x2 & (x4 | x7));
  assign new_n120_ = ~x1 & ~x5;
  assign new_n121_ = x4 ? x0 : (x3 ? (x5 & ~x6) : (~x0 & x2 & x6));
  assign z35 = (~x2 & (x7 | (~x0 & x3))) | (~x5 & (x0 | x2)) | ~new_n123_ | (x0 & (x2 | x7));
  assign new_n123_ = ~x1 & x4 & (~x2 | x3);
  assign z36 = (x0 & (x2 | ~x4)) | ~new_n125_ | (~x0 & (x4 | ~x6 | ~x2 | x3));
  assign new_n125_ = ~x1 & ~x5 & ~x7;
  assign z37 = ((~x3 | x5) & (x2 | (~x0 & ~x7))) | (~new_n127_ & ~x7) | (x2 & x7);
  assign new_n127_ = x3 ? (x5 ? ~x1 : (~x4 & x6)) : x1;
  assign z38 = (~z07 & x1) | new_n131_ | ~new_n129_ | new_n132_;
  assign new_n129_ = (x4 | (~x2 & (~x5 | x7))) & (x0 | x2 | new_n130_ | x7);
  assign new_n130_ = ~x3 & ~x4 & ~x5 & x6;
  assign new_n131_ = ~x3 & (x2 | (x0 & ~x4 & ~x7));
  assign new_n132_ = x0 & (x2 | (~x4 & x6 & ~x7));
  assign z39 = x7 ? x2 : (~x3 | x4 | ~x5 | x6);
  assign z40 = (x1 & (x2 ? ~x0 : ~x7)) | (~new_n135_ & x2) | (~new_n136_ & ~x7);
  assign new_n135_ = x0 ? new_n130_ : (x3 & x4);
  ...
  assign new_n148_ = (~x0 | (~x4 & ~x5 & ~x6)) & ~x1 & ~x3 & (x0 | x4);
  assign z45 = new_n115_ | x0 | ~x1 | ~x2;
  assign z46 = new_n115_ | ~new_n87_ | x2 | x3 | x7;
  assign z47 = (~new_n152_ & x2) | (~x7 & (x0 | ~x2));
  assign new_n152_ = (x0 | x4 | (~x5 & ~x6)) & x1 & (~x0 | (x3 & ~x4 & x5 & x6));
  assign z48 = x2 | (~x7 & (new_n115_ | x0 | x1 | (~x2 & ~x3)));
  assign z49 = (~new_n155_ & (x2 | ~x7)) | (~x2 & ~x7) | (x2 & x3 & x4);
  assign new_n155_ = ~new_n115_ & ~x0 & ~x1;
  assign z51 = (~new_n157_ & ~x0) | (new_n158_ & ~x4) | z07 | (~new_n159_ & x0);
  assign new_n157_ = (~x1 | (~x2 & x7)) & (~x2 | (x3 & ~x4)) & (~x4 | ~x7) & (x7 | (~new_n115_ & (x2 | x3)));
  ...
  assign new_n163_ = (x5 | x6) & (x2 | ((~x0 | x1) & ~x7));
  assign new_n164_ = (x2 | x3 | x7) & (~x1 | (~x2 & x7));
  assign z53 = (~new_n166_ & x2) | (~new_n167_ & ~x7);
  assign new_n166_ = (~x0 | (x1 & x3)) & ((x3 & x6) | (x1 & (x4 | ~x5))) & (x1 | (~x4 & x5)) & (x4 | ~x6 | (x3 & x5)) & (x0 | ~x1 | ~x3);
  assign new_n167_ = (x2 | (x3 & (x4 | ~x6))) & (~x3 | (x1 & (x4 | ~x5)));
  assign z54 = ~new_n169_ | (~x4 & ((x2 & (~x5 ^ ~x6)) | (~x7 & (x5 | (~x2 & x6)))));
  assign new_n169_ = ((x1 & ~x3) | (x2 ? ~x0 : x7)) & (x7 | (x2 ? x3 : ~x0)) & (~x2 | (x3 ? x1 : new_n170_));
  assign new_n170_ = ~x4 & x5 & x6;
  assign z55 = new_n173_ | (~new_n172_ & x0) | (~x1 & (x2 | (~x2 & ~x7)));
  assign new_n172_ = (new_n170_ | ~x2) & (x7 | (~x2 & x3));
  assign new_n173_ = ~x4 & (x5 | x6) & (x2 ? ~x0 : ~x7);
  assign z56 = (x0 & (x2 | ~x7)) | ~new_n175_ | (~x1 & (x2 ? x3 : ~x7));
  assign new_n175_ = (new_n170_ | ~x2) & (x7 | (~x2 & x3 & (~new_n115_ | x2)));
  assign z57 = (~x3 & (x0 | ~x1)) | (~new_n177_ & (x0 | ~x2)) | (~new_n178_ & x2) | (~x0 & ~x2 & x3);
  assign new_n177_ = ~new_n115_ & x1 & ~x7;
  assign new_n178_ = ~x0 & ~x4 & new_n179_ & x5;
  assign new_n179_ = x6 & x7;
  assign z58 = (~x7 & (x0 | ~x2)) | (x2 & ((new_n115_ & ~x0) | ~new_n181_ | (~new_n170_ & x0)));
  assign new_n181_ = x1 & x3;
  assign z59 = (x3 & (~x0 | x1)) | (~x1 & ((new_n115_ & x0) | (~x3 & (x0 | x5)))) | ~new_n183_ | (x1 & (new_n115_ | ~x0));
  assign new_n183_ = x2 & (x0 | (new_n179_ & ~x4));
  assign z60 = ~new_n185_ | (~x2 & (~x1 | x7));
  assign new_n185_ = (x1 | (~x0 & x3)) & (~x3 | (~x1 & (x0 | x5))) & (x0 | (new_n179_ & ~x4)) & (~x1 | (x0 & x4));
  assign z61 = x2 ? (new_n115_ | ~x0 | x1 | ~x3) : ~x7;
  assign z62 = new_n115_ | ~x0 | ~x1 | z07 | x3;
  assign z11 = 1'b0;
  assign z14 = 1'b0;
  assign z16 = 1'b0;
  assign z29 = 1'b0;
