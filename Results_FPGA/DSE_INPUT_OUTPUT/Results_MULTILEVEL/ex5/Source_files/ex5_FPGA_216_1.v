...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n80_, new_n83_, new_n85_, new_n86_, new_n88_, new_n90_,
    new_n93_, new_n95_, new_n96_, new_n98_, new_n104_, new_n106_,
  ...
  assign z31 = ~new_n117_ | (~z14 & x1);
  assign new_n117_ = (x5 | (~x2 & (x3 | ~x4))) & (~x2 | (~x0 & x3 & x4)) & (x3 | x4 | (x0 & ~x5 & ~x6));
  ...
  assign new_n125_ = (x3 | (~x0 & x6)) & ~x4 & ~x7;
  ...
  assign z39 = ~new_n132_ | (~z14 & x4);
  assign new_n132_ = (~x2 | (x5 & ~x6 & ~x7)) & (x3 | (new_n96_ & ~x5 & x6 & x7));
  ...
  assign z42 = (x5 & (x6 | x7)) | (~new_n138_ & ~x5) | z14 | x4;
  assign new_n138_ = new_n96_ & new_n86_ & (~x2 | x3);
  ...
  assign z45 = ~new_n148_ | (~z14 & (x0 | (~x4 & x5)));
  ...
  assign new_n153_ = (x2 | (~x0 & ~x1)) & (new_n154_ | (~x0 & x1)) & (~x0 | (x1 & x3 & x5)) & (x1 | (~x2 & ~x3 & ~x5));
  assign new_n154_ = ~x4 & x6 & x7;
  assign z49 = (x0 & (x2 | ~x3)) | (~x2 & ~x3) | (x2 & ((~new_n75_ & ~x4) | x1 | (x3 & x4)));
  assign z50 = x2 | (~x3 & (x0 | (~new_n90_ & ~x2)));
  ...
  assign z53 = (x1 & (~x0 ^ ~x3)) | (x0 & (x3 ? ~x1 : x2)) | (~new_n88_ & (~x2 | (~x0 & x3))) | new_n161_ | (~x1 & x2 & ~x3) | (~x2 & x3);
  assign new_n161_ = ~x4 & ((x2 & ~x3 & (x5 | x6)) | (x3 & (x5 ? (~x6 | ~x7) : x6)));
  assign z54 = (~new_n163_ & ~x3) | (x2 & (new_n165_ | (x3 & (x0 | ~x1))));
  assign new_n163_ = (x2 | ((~new_n164_ | x0) & x1)) & (~x0 | x1) & (new_n88_ | (~x0 & ~x2));
  ...
  assign z58 = ~x3 | (x2 & ((new_n164_ & ~x0) | ~x1 | (~new_n88_ & x0)));
  assign z59 = new_n174_ | (~new_n173_ & x2);
  assign new_n173_ = (~x3 | (x0 & ~x1 & (~x0 | new_n75_ | x4))) & (x0 | (new_n86_ & ~x1 & ~x4));
  assign new_n174_ = ~x3 & (x0 ? (new_n164_ | ~x1 | ~x2) : ~new_n90_);
  assign z60 = (~new_n176_ & ~x0) | (x2 & x3 & (x0 | x1)) | (x0 & ~x3 & (~x1 | ~x4));
  assign new_n176_ = (~x1 | (~x2 & (x3 | ~x5))) & (new_n154_ | (~x2 & x3)) & (x3 | x5) & (~x2 | (~x3 ^ x5));
  assign z61 = new_n164_ | ~new_n96_ | ~x2 | ~x3;
