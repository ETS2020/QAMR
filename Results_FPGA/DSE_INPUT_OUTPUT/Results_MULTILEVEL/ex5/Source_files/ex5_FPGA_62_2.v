...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n82_, new_n84_, new_n86_, new_n89_, new_n91_, new_n94_,
    new_n102_, new_n104_, new_n106_, new_n108_, new_n110_, new_n112_,
    new_n114_, new_n116_, new_n117_, new_n121_, new_n123_, new_n125_,
    ...
    new_n172_, new_n174_, new_n177_, new_n179_;
  ...
  assign z05 = z12 | (new_n79_ & ~x4 & x5);
  assign z06 = x2 & (~x3 | (new_n82_ & ~x4 & ~x5 & ~x6));
  ...
  assign z44 = (~new_n141_ & x3) | (~x2 & (new_n139_ | ~new_n140_));
  assign new_n139_ = (x4 | ~x5) & (x1 | (~x0 & x3));
  assign new_n140_ = (~x6 | (~x0 & (x4 | ~x5))) & (~x0 | (~x4 & ~x5)) & (x4 | (x0 & (~x5 | ~x7)));
  assign new_n141_ = ~x0 & ~x2 & (x0 | (x4 ? ~x1 : (x5 & ~x7)));
  assign z45 = (x0 & (~x2 | x3)) | (~new_n144_ & ~x2) | (x2 & x3 & (new_n143_ | ~x1));
  assign new_n143_ = ~x4 & (x5 | x6);
  assign new_n144_ = ~x1 & ~x4 & ~x5 & x6 & x7;
  assign z46 = x3 | (~x2 & (new_n146_ | x0 | ~x1));
  assign new_n146_ = ~x4 & (x5 | (x6 & ~x7));
  assign z47 = new_n149_ | (~new_n82_ & ~new_n148_) | new_n150_ | ~new_n151_;
  assign new_n148_ = x2 & x3;
  assign new_n149_ = ~x0 & ~x4 & (x5 | (x1 & x6));
  assign new_n150_ = (x0 | ~x1) & (x4 | ~x6 | ~x7);
  assign new_n151_ = (~x0 | (x1 & x5)) & (x1 | (~x2 & ~x5));
  assign z48 = x2 ? x3 : (new_n153_ | x0 | x1 | ~x3);
  assign new_n153_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z49 = ~x2 | (x3 & (~new_n155_ | (x2 & (x0 | x1 | x6))));
  assign new_n155_ = ~x4 & ~x5;
  assign z50 = (~x2 & (~new_n157_ | (x0 & (~x1 | ~x3)))) | (x3 & (~new_n155_ | x2));
  ...
  assign z53 = (x0 & (x1 ^ x3)) | (x2 & (~x3 | (~x0 & x1))) | (~new_n89_ & (~x1 | ~x3)) | new_n166_ | (~x1 & ~x2 & x3);
  assign new_n166_ = ~x4 & ((~x5 & x6) | (x5 & (~x6 | ~x7)) | (~x2 & x3 & (x5 | x6)));
  assign z54 = (~x2 & (new_n170_ | (~new_n169_ & ~x3))) | ((~new_n168_ | new_n153_) & x3);
  ...
  assign z57 = (x0 & (x2 ^ ~x3)) | (~x2 & (new_n146_ | ~x1 | (~x0 & x3))) | (x2 & ~new_n89_ & x3);
  assign z58 = new_n149_ | new_n150_ | ~new_n177_ | (~new_n82_ & ~x2);
  assign new_n177_ = (~x0 | (x1 & x5)) & x3 & (x1 | (~x2 & ~x5));
  assign z59 = (x0 & (~x3 | (~x1 & ~x2))) | new_n179_ | (~new_n157_ & ~x2) | (x2 & (~x0 | x1 | ~x3));
  assign new_n179_ = ~x4 & (x5 | (x2 & x6));
  assign z60 = ((x3 | (~x0 & ~x2)) & (~new_n84_ | x1 | x4)) | (x3 & (x0 | ~x2)) | (x0 & ~x2 & (~x1 | ~x4));
  assign z61 = (~new_n148_ & ~x1) | new_n143_ | ~x0 | x1;
  assign z62 = new_n143_ | ~x0 | ~x1 | (x1 & (x2 | x3));
  assign z08 = 1'b0;
  assign z09 = 1'b0;
  assign z27 = 1'b0;
  assign z30 = 1'b0;
