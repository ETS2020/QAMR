...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n83_, new_n84_, new_n87_, new_n89_, new_n91_, new_n93_,
    new_n95_, new_n100_, new_n103_, new_n105_, new_n108_, new_n110_,
  ...
  assign z32 = (x2 & (~x3 | ~x4)) | (~x2 & (x3 | x4)) | x0 | x1 | (~new_n100_ & ~x4);
  assign z33 = ~x0 | (~new_n114_ & x2);
  assign new_n114_ = ~x4 & (x1 | ~x5) & new_n84_ & (~x1 | ~x3 | x5);
  ...
  assign z53 = (~new_n149_ & x2) | (~x0 & ((~x2 & ~new_n95_ & ~x3) | (~new_n150_ & x3)));
  assign new_n149_ = (~x0 | (x1 & x3)) & (x4 | ((new_n142_ | ~x1) & (new_n75_ | x3))) & (x1 | x3) & (x0 | ~x1 | ~x3);
  ...
  assign z55 = (~x1 & (x2 | (~x0 & ~x2))) | (new_n155_ & ~x0) | (x0 & ~new_n95_ & x2);
  assign new_n155_ = ~x4 & (x5 | x6);
  assign z56 = (~x1 & (x2 ? x3 : ~x0)) | (~new_n157_ & x2) | (~x0 & ~x2 & (new_n137_ | ~x3));
  assign new_n157_ = ~x0 & ~x4 & new_n84_ & x5;
  ...
  assign new_n167_ = new_n84_ & x5 & ~x4 & (~x2 | x3 | ~x5);
