...
module FAU ( 
  ...
  wire new_n81_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_, new_n94_,
    new_n102_, new_n105_, new_n108_, new_n110_, new_n112_, new_n113_,
    new_n115_, new_n116_, new_n120_, new_n122_, new_n123_, new_n124_,
    ...
    new_n154_, new_n157_, new_n159_, new_n161_, new_n163_, new_n164_,
    new_n165_, new_n166_, new_n168_, new_n172_, new_n173_, new_n175_,
    new_n176_, new_n178_;
  ...
  assign z20 = ~x3 & (x2 | (new_n94_ & new_n81_ & ~x4));
  assign z21 = (x2 & ~x3) | (x0 & ~x1 & ~x2 & new_n81_ & x3 & ~x4);
  ...
  assign z31 = ~new_n108_ | (x0 & (x2 ? x3 : (~x4 & x6)));
  assign new_n108_ = (x2 | ((x0 | (~x3 & x4)) & ~x1 & (~x4 | x5) & (x4 | ~x5))) & (~x3 | (~x1 & (~x2 | x4))) & (~x2 | (x3 & x5));
  assign z32 = (x1 & (~x2 | x3)) | (~new_n110_ & ~x2) | (x3 & (x2 ? (x0 | ~x4) : ~x0));
  assign new_n110_ = x4 ? (x0 & x5) : ((~x0 | (x3 & ~x6)) & ~x5 & (x0 | (x6 & ~x7)));
  assign z33 = ~new_n113_ | ~new_n112_ | ~x3 | x4;
  assign new_n112_ = x6 & x7;
  assign new_n113_ = x0 & x2 & (~x1 | x5) & (x1 | ~x5);
  assign z34 = (~new_n115_ & (x2 ? x3 : x5)) | (~x2 & (x5 ? ~x3 : ~new_n116_)) | (x2 & x3 & ~x5);
  assign new_n115_ = ~x4 & ~x6 & ~x7;
  assign new_n116_ = x0 & ~x1 & (x4 | (x6 & x7));
  assign z35 = (x0 & (x2 | ~x5)) | (x2 & (~x3 | ~x5)) | x1 | ~x4 | (~x0 & ~x2 & x3);
  assign z36 = x2 ? x3 : (~new_n94_ | ~x4 | x5);
  assign z37 = (~x0 & (x3 ? x5 : ~x2)) | (x3 & (x5 ? (x1 | x2) : ~new_n120_)) | (~x1 & ~x2 & ~x3);
  ...
  assign z42 = (x5 & (x6 | x7)) | (~x5 & (~new_n94_ | ~x6 | ~x7)) | z08 | x4;
  ...
  assign z45 = new_n142_ | (x1 & (~x2 | ~x3)) | x0 | (~new_n143_ & ~x1);
  assign new_n142_ = ~x4 & (x5 | (x1 & x6));
  assign new_n143_ = ~x2 & ~x4 & ~x5 & x6 & x7;
  assign z46 = new_n145_ | x0 | ~x1 | x2 | x3;
  assign new_n145_ = ~x4 & (x5 | (x6 & ~x7));
  assign z47 = (x3 & ((~new_n147_ & x2) | (~new_n89_ & x0))) | (~new_n148_ & ~x2);
  assign new_n147_ = x1 & (x0 | x4 | (~x5 & ~x6));
  assign new_n148_ = ~x0 & ~x1 & ~x4 & ~x5 & x6 & x7;
  assign z48 = new_n151_ | ~new_n152_ | (~new_n112_ & ~new_n150_);
  assign new_n150_ = (~x0 | ~x3) & (x2 | x4 | ~x5);
  assign new_n151_ = ~x5 & ((x0 & x3) | (~x2 & ~x4 & x6));
  assign new_n152_ = (~x0 | (x2 & (~x3 | ~x4))) & (~x2 | ~x3) & (x2 | (~x1 & x3));
  assign z49 = ~x2 | ~x3 | (x3 & (~new_n154_ | (x2 & (x0 | x1 | x6))));
  assign new_n154_ = ~x4 & ~x5;
  assign z50 = (~x2 & (~new_n112_ | ~new_n154_ | (x0 & (~x1 | ~x3)))) | (x3 & (~new_n154_ | x2));
  assign z51 = (x0 & (~x1 | (~x2 & x3))) | (x2 & (~x3 | (~x0 & x4))) | ~new_n157_ | (~x0 & (x1 | ~x3));
  assign new_n157_ = (x1 | x3) & (x4 | ((~x3 | (~x5 & ~x6)) & (x5 | ~x6) & (~x5 | (x6 & x7))));
  assign z52 = (x0 & (~x1 | x3)) | (x2 & (~x3 | (~x0 & x4))) | (~x0 & (x1 | ~x3)) | (~new_n159_ & ~x4) | (~x1 & ~x3);
  assign new_n159_ = ~x5 & (~x6 | (~x3 & x5));
  assign z53 = (x0 & (x1 ? (~x2 & ~x3) : x3)) | (~new_n89_ & (x3 ? ~x1 : ~x2)) | (x3 & (new_n161_ | (~x1 & ~x2) | (~x0 & x1 & x2)));
  assign new_n161_ = ~x4 & ((~x5 & x6) | (x5 & (~x6 | ~x7)) | (~x2 & (x5 | x6)));
  assign z54 = (~new_n163_ & ~x4) | new_n164_ | (~new_n89_ & ~new_n165_) | ~new_n166_;
  assign new_n163_ = (x0 | x3 | (~x5 & ~x6)) & (~x2 | (x5 ? (x6 & x7) : ~x6));
  assign new_n164_ = (~x1 | x2) & (x0 | ~x3);
  assign new_n165_ = ~x0 & (x2 | ~x3);
  assign new_n166_ = (x1 | ~x2) & (~x0 | ~x3);
  assign z55 = new_n168_ | (~x1 & (~x2 | x3)) | (x0 & (x2 ? (~new_n89_ & x3) : ~x3));
  assign new_n168_ = ~x4 & (x5 | x6) & (~x2 | (~x0 & x3));
  assign z56 = ((x0 | ~x1) & (~x2 | x3)) | (x2 & ~new_n89_ & x3) | (~x2 & (new_n145_ | ~x3));
  assign z57 = (x0 & (x2 ^ ~x3)) | (x2 & ~new_n89_ & x3) | (~x2 & (new_n145_ | ~x1 | (~x0 & x3)));
  assign z58 = (new_n142_ & ~x0) | (~x2 & (x0 | x1)) | ~new_n173_ | (~new_n172_ & (x0 | ~x1));
  assign new_n172_ = ~x4 & x6 & x7;
  assign new_n173_ = (~x0 | (x1 & x5)) & x3 & (x1 | (~x2 & ~x5));
  assign z59 = (x0 & (~x3 | (~x1 & ~x2))) | new_n176_ | (x2 & (~x0 | x1 | ~x3)) | (~new_n175_ & ~x2);
  ...
  assign z61 = new_n124_ | ~new_n94_ | ~x2 | ~x3;
