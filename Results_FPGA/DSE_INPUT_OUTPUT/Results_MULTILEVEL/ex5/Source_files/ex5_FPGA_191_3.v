...
module FAU ( 
  ...
  wire new_n81_, new_n83_, new_n87_, new_n89_, new_n91_, new_n93_, new_n97_,
    ...
    new_n184_, new_n186_, new_n188_, new_n189_, new_n191_;
  ...
  assign z31 = (~new_n109_ & ~x2) | (~x7 & (x1 | (~new_n110_ & x2)));
  assign new_n109_ = (x0 | (~x3 & x4)) & (x4 | (~x5 & ~x6)) & ~x1 & (~x4 | x5);
  assign new_n110_ = ~x0 & x3 & x4 & x5;
  assign z32 = new_n112_ | new_n113_ | new_n114_ | (~new_n115_ & ~x2) | (new_n116_ & x2);
  assign new_n112_ = x1 & (~x2 | ~x7);
  assign new_n113_ = ~x3 & ((x0 & ~x2 & ~x4) | (x2 & ~x7));
  assign new_n114_ = x0 & (x2 ? ~x7 : (~x4 & x6));
  assign new_n115_ = (~x4 | (x0 & x5)) & (~x5 | (x0 & x4)) & (x0 | (~x3 & x6 & ~x7));
  assign new_n116_ = ~x4 & ~x7;
  assign z34 = (~x5 & (~new_n118_ | (x0 & (new_n116_ | x2)))) | (~new_n116_ & (~x0 | x5)) | (~new_n119_ & x5);
  assign new_n118_ = (x6 | (x0 & x4)) & ~x1 & (x0 | (x2 & ~x3));
  assign new_n119_ = x3 & ~x6;
  assign z35 = (x0 & (x2 ? ~x7 : ~x5)) | ~new_n121_ | (x1 & (~x2 | ~x7));
  assign new_n121_ = (x7 | ((~x3 | x4) & (~x2 | (x3 & (~x3 | x5))))) & (x2 | (x4 & (x0 | ~x3)));
  assign z36 = (x1 & (~x2 | ~x7)) | (~new_n124_ & ~x2) | (~new_n123_ & ~x7);
  assign new_n123_ = (~x3 | (~x2 & x4)) & (~x2 | (~x0 & (x3 | (~x4 & ~x5 & x6))));
  assign new_n124_ = x0 & x4 & ~x5;
  assign z37 = ((~x3 | x5) & (~x0 | x2)) | (x3 & (x5 ? x1 : ~new_n126_)) | (~x1 & ~x3);
  assign new_n126_ = ~x4 & x6 & ~x7;
  assign z38 = new_n112_ | new_n113_ | new_n114_ | new_n128_ | (new_n129_ & ~x0);
  ...
  assign z42 = (x4 & (~x2 | ~x7)) | (~x7 & (~x5 | x6)) | (~x2 & x7 & (~new_n91_ | x5 | ~x6));
  ...
  assign new_n141_ = ~x4 & ((x2 & (~x5 | (~x0 & x6))) | (~x0 & (x7 | (~x5 & ~x6))) | (x5 & (x6 | x7)));
  assign new_n142_ = x2 & ((~x3 & x4) | (~x0 & x7));
  assign z44 = (x6 & (x0 | (~x4 & x5))) | ~new_n144_ | (x5 & (x0 | (~x4 & x7)));
  assign new_n144_ = (x4 | (x0 & (~x2 | x5))) & (x0 | (~x2 & (x2 | ~x3 | (~x4 & x5)))) & (~x2 | ((x3 | ~x4) & (~x0 | x5))) & (~x4 | (~x0 & ~x1)) & (~x0 | (~x3 & (~x1 | x5))) & (~x1 | x2 | x5);
  assign z45 = new_n146_ | x0 | (~new_n147_ & ~x1) | (x1 & (~x2 | x7));
  assign new_n146_ = ~x4 & (x5 | (x1 & x6));
  assign new_n147_ = ~x2 & ~x4 & ~x5 & x6 & x7;
  assign z46 = new_n149_ | x0 | ~x1 | x2 | x3;
  assign new_n149_ = ~x4 & (x5 | (x6 & ~x7));
  assign z48 = new_n151_ | ~new_n93_ | x2 | ~x3;
  assign new_n151_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z49 = new_n153_ | ~new_n154_;
  assign new_n153_ = ~x4 & (x5 | (x2 & x6));
  assign new_n154_ = (~x0 | (x1 & ~x2 & x3)) & x2 & (~x3 | ~x4) & (~x2 | (~x1 & ~x7));
  assign z50 = new_n157_ | (x4 & (~x2 | x3)) | (x5 & (~x2 | ~x4)) | x2 | (~new_n156_ & ~x2);
  ...
  assign new_n160_ = ~x4 & ((~x7 & ((~x2 & x5) | (x0 & (x5 | (x2 & x6))))) | (~x2 & ((~x0 & (x5 | x6)) | (x5 & ~x6) | (~x5 & x6))));
  assign new_n161_ = ~x7 & (x4 | x5 | x6);
  assign z52 = (~new_n163_ & x0) | new_n164_ | ~new_n166_ | (~new_n165_ & ~x0);
  assign new_n163_ = ~x3 & (x1 | x2);
  assign new_n164_ = ~x2 & ((~x4 & ~x5 & x6) | (~x0 & ~x3));
  assign new_n165_ = ~x1 & (x4 | ~x6);
  assign new_n166_ = (x4 | (~x5 & (~x2 | ~x6))) & (~x2 | (~x7 & (~x3 | ~x4)));
  assign z53 = ((new_n168_ | new_n169_) & ~x3) | (~new_n170_ & ~new_n171_) | new_n172_;
  ...
  assign z54 = new_n175_ | new_n176_ | new_n177_ | new_n179_ | (~new_n174_ & ~new_n178_);
  assign new_n174_ = ~x4 & x5 & x6 & x7;
  assign new_n175_ = ~x4 & (x5 | x6) & (x2 | (~x0 & ~x3));
  assign new_n176_ = ~x1 & (x2 | ~x3);
  assign new_n177_ = x2 & (~x3 | x7);
  ...
  assign z58 = ~new_n184_ | (~z08 & (x0 | ~x3));
  assign new_n184_ = (x7 | (x1 & x2 & (x4 | (~x5 & ~x6)))) & (x2 | (~x5 & x6 & ~x1 & ~x4));
  assign z59 = (~x2 & (new_n157_ | ~new_n101_ | ~new_n156_)) | new_n153_ | (x2 & (~new_n157_ | ~new_n186_));
  ...
  assign z61 = ~x2 | (~x7 & (new_n191_ | ~x0 | x1 | (~x1 & ~x3)));
  assign new_n191_ = ~x4 & (x5 | x6);
  assign z62 = ((new_n191_ | ~x0 | ~x1) & (~x2 | ~x7)) | (x3 & (~x2 | (x1 & ~x7)));
  assign z12 = 1'b0;
  assign z15 = 1'b0;
  assign z33 = 1'b1;
  assign z09 = z08;
  ...
  assign z28 = z08;
  assign z30 = z08;
  assign z47 = new_n146_ | x0 | (~new_n147_ & ~x1) | (x1 & (~x2 | x7));
endmodule
