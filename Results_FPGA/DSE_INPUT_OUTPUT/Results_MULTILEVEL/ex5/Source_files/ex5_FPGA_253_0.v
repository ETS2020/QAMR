...
module FAU ( 
  ...
  wire new_n75_, new_n78_, new_n80_, new_n84_, new_n86_, new_n88_, new_n90_,
    new_n92_, new_n94_, new_n97_, new_n102_, new_n105_, new_n110_,
    new_n112_, new_n114_, new_n116_, new_n118_, new_n119_, new_n120_,
    new_n123_, new_n125_, new_n128_, new_n130_, new_n131_, new_n134_,
    new_n136_, new_n137_, new_n138_, new_n139_, new_n140_, new_n142_,
    new_n144_, new_n149_, new_n152_, new_n153_, new_n154_, new_n155_,
    new_n157_, new_n159_, new_n161_, new_n163_, new_n164_, new_n167_,
    new_n168_, new_n169_, new_n171_;
  assign z00 = z19 | (new_n75_ & ~x4);
  assign z19 = ~x0 & ~x2;
  assign new_n75_ = ~x5 & ~x6;
  assign z01 = ~x5 & ~x6 & ~z19 & ~x7;
  assign z02 = z19 | (~x3 & ~x4 & new_n78_ & x5);
  assign new_n78_ = ~x6 & ~x7;
  assign z03 = z19 | (new_n80_ & new_n78_ & x5);
  ...
  assign z39 = (~x0 & (~x2 | ~x5)) | ~new_n128_ | (x5 & (~new_n78_ | ~x3));
  ...
  assign z45 = x0 | ~x2 | (x2 & (~x1 | (new_n144_ & ~x0)));
  assign new_n144_ = ~x4 & (x5 | x6);
  assign z47 = (x2 & (~x1 | (new_n144_ & ~x0))) | (x0 & (~new_n90_ | ~new_n80_ | ~x2));
  ...
  assign z53 = new_n152_ | (~new_n153_ & ~x4) | (~new_n86_ & ~new_n154_) | ~new_n155_;
  ...
  assign z55 = new_n159_ | (~x2 & (~x0 | ~x3)) | ~x1 | (x0 & ~new_n86_ & x2);
  ...
  assign z58 = (~new_n164_ & x0) | (x2 & (~x1 | ~x3 | (new_n144_ & ~x0)));
  assign z59 = (~new_n167_ & (~new_n105_ | x4)) | ~new_n169_ | (~new_n168_ & x0);
  assign new_n167_ = x0 ? (~x1 | ~x3) : ~x2;
  assign new_n168_ = (x3 | (x1 & (x4 | ~x6))) & (x1 | (x2 & (x4 | ~x6))) & (~x5 | (x4 & (~x1 | ~x3)));
  assign new_n169_ = (~x2 | ((~x1 | ~x3) & (x0 | (~x1 & (x3 | ~x5))))) & (x2 | x3) & (x0 | (x2 & ~x3));
  assign z60 = (x2 & ((~new_n171_ & ~x0) | (x1 & (~x0 | x3)))) | (x0 & (x3 | ~x4 | (~x1 & (~x2 | ~x3))));
  assign new_n171_ = x3 & ~x4 & x6 & x7 & (~x3 | x5);
