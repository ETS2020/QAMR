...
module FAU ( 
  ...
  wire new_n80_, new_n82_, new_n84_, new_n85_, new_n88_, new_n90_, new_n93_,
    ...
    new_n137_, new_n139_, new_n140_, new_n142_, new_n144_, new_n147_,
    new_n150_, new_n151_, new_n152_, new_n154_, new_n155_, new_n158_,
    new_n160_, new_n162_, new_n164_, new_n165_, new_n167_;
  ...
  assign new_n100_ = ~x1 & ~x3 & ~x4 & new_n80_ & ~x5;
  ...
  assign z28 = x0 & (~x2 | (new_n107_ & ~x1 & x3 & ~x4));
  assign new_n107_ = new_n85_ & ~x5;
  assign z29 = x7 & new_n109_ & ~x6;
  assign new_n109_ = ~x5 & ~x4 & ~x3 & new_n82_ & ~x2;
  assign z30 = x0 & (~x2 | (new_n107_ & x1 & ~x3 & ~x4));
  assign z31 = ((~x0 | x2) & (x1 | ~x4 | ~x5)) | (x2 & (x0 | ~x3)) | (~x0 & ~x2 & x3);
  assign z32 = (x2 & (~x3 | ~x4)) | ~new_n82_ | (~x2 & (x3 | x4 | ~new_n80_ | x5));
  ...
  assign z45 = (~new_n135_ & ~x4) | (x2 & (x0 | ~x1)) | (~x0 & ~x2 & (~new_n107_ | x1 | x4));
  ...
  assign z53 = (~new_n150_ & x2) | (~x0 & ((~x2 & ~new_n95_ & ~x3) | (~new_n152_ & x3)));
  ...
  assign new_n155_ = x3 ? (~x4 & x5 & x6 & x7) : (x1 & (x4 | (~x5 & ~x6)));
  assign z55 = (~x1 & (~x0 | (x0 & x2))) | (new_n147_ & ~x0) | (x0 & (~x2 | (~new_n95_ & x2)));
  assign z56 = (~new_n158_ & ~x0) | (x2 & (~new_n84_ | x0 | x4));
  assign new_n158_ = (x1 | (x2 & ~x3)) & (~new_n80_ | x4) & (x2 | (x3 & (x4 | ~x5)));
  assign z57 = (~new_n160_ & ~x0) | (x2 & (~new_n84_ | x0 | x4));
  assign new_n160_ = (x1 | (x2 & x3)) & (~new_n80_ | x4) & (x2 | (~x3 & (x4 | ~x5)));
  assign z58 = ~new_n162_ | (~x0 & ~x4 & (x5 | (x1 & x6)));
  assign new_n162_ = (x2 | (~x0 & ~x1)) & ~new_n140_ & (~x0 | (x1 & x5)) & x3 & (x1 | (~x2 & ~x5));
  assign z59 = (x1 & (x0 ? x3 : x2)) | new_n165_ | (~new_n164_ & ~x0) | (x0 & (~x2 | (~x1 & ~x3)));
  assign new_n164_ = ~x4 & ~x5 & new_n85_ & (~x2 | ~x3 | x5);
  assign new_n165_ = ~x4 & (x5 | (x0 & x6));
  assign z60 = x0 ? (x2 & (~x1 | x3 | ~x4)) : ~new_n167_;
  assign new_n167_ = (~x1 | (~x2 & ~x5)) & new_n85_ & ~x4 & x5 & (~x5 | (~x2 ^ x3));
  assign z61 = ~x0 | (x2 & (~new_n127_ | new_n147_));
  assign z62 = new_n147_ | ~x2 | x3 | ~x0 | ~x1;
  assign z14 = 1'b0;
  assign z20 = 1'b0;
  assign z21 = 1'b0;
  assign z41 = ~z11;
