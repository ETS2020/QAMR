...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n80_, new_n82_, new_n85_, new_n88_, new_n89_, new_n99_, new_n101_,
    ...
    new_n162_, new_n163_, new_n169_, new_n170_, new_n172_, new_n173_;
  ...
  assign z13 = x6 & (x2 | (new_n82_ & ~x0 & x1 & x3));
  ...
  assign z31 = (x0 & (x2 | (~x4 & x6))) | ~new_n105_ | (~x0 & (~x4 | (~x2 & x3)));
  assign new_n105_ = (x4 | (~x2 & ~x5)) & (new_n106_ | ~x2) & ~x1 & (~x4 | x5);
  assign new_n106_ = x3 & ~x6;
  assign z32 = ~new_n108_ | new_n109_;
  assign new_n108_ = (new_n106_ | (~x2 & (~x0 | x4))) & (~x2 | (~x0 & x4)) & ~x1 & (x4 | ~x5) & (x2 | ~x4 | x5);
  assign new_n109_ = ~x0 & ((~x2 & (x3 | x4)) | (~x4 & (x3 | ~x6 | x7)));
  assign z34 = (~new_n112_ & (x2 ? ~x6 : x5)) | (~new_n111_ & ~x5) | (~x2 & x5 & x6);
  assign new_n111_ = (x4 | (x6 & (x2 | x7))) & (new_n89_ | x2) & (~x2 | x6);
  assign new_n112_ = x3 & ~x4 & ~x7;
  assign z35 = (x0 & (x2 ? ~x6 : ~x5)) | (~new_n114_ & (~x2 | ~x6)) | (~x0 & ~x2 & x3) | (x2 & ~x6 & (~x3 | ~x5));
  assign new_n114_ = ~x1 & x4;
  assign z36 = ~new_n88_ | ~x4 | x5;
  ...
  assign new_n123_ = new_n89_ & ~x2 & x6 & x7;
  assign z40 = (x1 & (~x2 | ~x6)) | (~new_n125_ & ~x2) | (~new_n126_ & ~x6);
  assign new_n125_ = (~x0 | (x4 ? x5 : ~x6)) & (x4 | ~x5) & (x0 | (~x3 & (x4 | ~x7)));
  assign new_n126_ = (x4 | (x0 & ~x2)) & (~x2 | (~x0 & x3));
  assign z41 = x2 ? ~x6 : ((~x1 & (~x3 | ~x5)) | ~x0 | (x1 & x3));
  assign z42 = (x4 & (~x2 | ~x6)) | (~x6 & (~x5 | x7)) | (~x2 & x6 & (~new_n89_ | x5 | ~x7));
  assign z43 = new_n134_ | ~new_n132_ | (~new_n130_ & ~x2);
  assign new_n130_ = (new_n131_ | (~x4 & x5)) & (x4 | ((~x5 | (~x6 & ~x7)) & (x0 | ~x7)));
  assign new_n131_ = ~x1 & (x0 | ~x3);
  assign new_n132_ = x6 ? ~x2 : (x4 ? (~x1 & (~x2 | x3)) : new_n133_);
  assign new_n133_ = (x0 | x5) & (~x2 | (x5 & ~x7));
  assign new_n134_ = x0 & ((x2 & x4 & ~x6) | (~x2 & ~x4 & x6 & ~x7));
  assign z44 = (~x2 & (~new_n137_ | (~new_n136_ & ~new_n131_))) | (~x6 & (~new_n138_ | x2));
  assign new_n136_ = ~x4 & x5;
  assign new_n137_ = (~x6 | (~x0 & (x4 | ~x5))) & (x4 | (x0 & (~x5 | ~x7))) & (~x0 | (~x3 & ~x4 & ~x5));
  assign new_n138_ = (~x1 | ~x4) & (x0 | x4 | x5);
  assign z45 = ~new_n140_ | (~z09 & x0);
  assign new_n140_ = (x6 | (x2 & (~x2 | (x1 & (x4 | ~x5))))) & (x2 | (~x5 & x7 & ~x1 & ~x4));
  assign z46 = (x0 & (~x2 | ~x6)) | (x2 & ~x6) | (~x2 & (new_n142_ | ~x1 | x3));
  assign new_n142_ = ~x4 & (x5 | (x6 & ~x7));
  assign z47 = ~new_n144_ | (~z09 & x0);
  assign new_n144_ = (~x5 | (x2 & (x4 | x6))) & (x6 | (x1 & x2)) & (x2 | (~x1 & ~x4 & x7));
  assign z48 = new_n146_ | ~new_n80_ | x2 | ~x3;
  assign new_n146_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z49 = ~x2 | (~x6 & (~new_n80_ | (x3 & x4) | (~x4 & x5)));
  assign z50 = ~x6 | (~x2 & (new_n149_ | x4 | x5 | ~x7));
  ...
  assign z53 = ~new_n159_ | (~x3 & ((~new_n158_ & ~x2) | (x0 & (x1 | x2))));
  assign new_n158_ = new_n136_ & x6 & x7;
  assign new_n159_ = (new_n160_ | (~x2 & ~x3)) & (~x2 | (~x6 & (x0 | ~x3))) & (~x3 | x4 | ~x6);
  assign new_n160_ = x1 & (x4 | ~x5);
  assign z54 = (~new_n162_ & ~x3) | (~new_n158_ & (x0 | (~x2 & x3))) | (x0 & x3) | (~new_n163_ & x2);
  assign new_n162_ = (~new_n152_ | x0) & x1 & ~x2;
  assign new_n163_ = x1 & ~new_n136_ & ~x6;
  assign z55 = (x0 & (x2 | ~x3)) | new_n152_ | ~x1 | (x2 & x6);
  assign z56 = x2 ? ~x6 : (new_n142_ | x0 | ~x1 | ~x3);
  assign z57 = new_n142_ | ~x1 | x2 | (x0 & ~x3) | (~x0 & x3);
  assign z58 = ~new_n144_ | (~z09 & (x0 | ~x3));
  assign z59 = (~x2 & (new_n149_ | ~new_n169_ | x4 | x5)) | (~x4 & x5) | (x2 & (~new_n149_ | ~new_n170_));
  assign new_n169_ = x6 & x7;
  assign new_n170_ = ~x6 & (x1 | x3);
  assign z60 = (~new_n172_ & (~x6 | (x0 & ~x2))) | (x3 & (~x2 | ~x6)) | (~x0 & (~x6 | (~new_n173_ & ~x2)));
  assign new_n172_ = x1 & x4;
  assign new_n173_ = ~x1 & ~x4 & x5 & x7;
  assign z61 = x1 | new_n136_ | ~x0 | x6 | ~x2 | ~x3;
  assign z62 = new_n152_ | ~x0 | ~x1 | z09 | x3;
  assign z08 = 1'b0;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
  assign z26 = 1'b0;
