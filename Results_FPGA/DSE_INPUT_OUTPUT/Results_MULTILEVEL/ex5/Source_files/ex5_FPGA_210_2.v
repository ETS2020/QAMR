...
module FAU ( 
  ...
  wire new_n80_, new_n82_, new_n84_, new_n85_, new_n88_, new_n90_, new_n92_,
    ...
    new_n139_, new_n141_, new_n147_, new_n148_, new_n150_, new_n152_,
  ...
  assign z09 = (x0 & ~x2) | (new_n85_ & new_n88_ & x2 & ~x3 & ~x0 & ~x1);
  ...
  assign new_n104_ = new_n85_ & ~x5;
  assign z27 = (x0 & ~x2) | (new_n80_ & new_n88_ & ~x0 & x1 & x2 & ~x3);
  ...
  assign z32 = (~x0 & ((~x2 & (x3 | x4)) | x1 | (~new_n100_ & ~x4))) | (x2 & (x0 | ~x3 | ~x4));
  ...
  assign z36 = ~new_n80_ | ~new_n88_ | ~x2 | x3 | x0 | x1;
  assign z37 = ~z14 & (~new_n100_ | ~x3 | x4);
  ...
  assign z45 = (x2 & (x0 | ~x1 | (~new_n82_ & ~x4))) | (~x0 & ~x2 & (~new_n104_ | x1 | x4));
  ...
  assign z48 = x2 | (~x0 & (~new_n127_ | (~new_n141_ & ~x4)));
  assign new_n141_ = x5 ? (x6 & x7) : ~x6;
  assign z49 = x2 ? ((~new_n82_ & ~x4) | x0 | x1 | (x3 & x4)) : ~x0;
  assign z50 = x0 | x2 | (~x0 & ~x2 & (~new_n85_ | ~new_n88_));
  assign z51 = (~x0 & ((~x3 & (~x2 | ~x4)) | (~new_n82_ & ~x4) | x1 | (x2 & x4))) | (x2 & ((~new_n82_ & ~x4) | (x0 & ~x1)));
  assign z52 = (x0 & (~x2 | x3)) | (~new_n82_ & ~x4) | (~x0 & (x1 | (~x2 & ~x3) | (x2 & x3 & x4)));
  assign z53 = (~new_n147_ & x2) | (~x0 & ((~x2 & ~new_n90_ & ~x3) | (~new_n148_ & x3)));
  assign new_n147_ = (~x0 | (x1 & x3)) & (x4 | ((new_n141_ | ~x1) & (new_n82_ | x3))) & (x1 | x3) & (x0 | ~x1 | ~x3);
  assign new_n148_ = x1 ? (x4 | (~x5 & ~x6)) : (x2 & ~x4 & x5 & x6 & x7);
  assign z54 = (~new_n90_ & (~x2 ^ ~x3)) | new_n150_ | (~x2 & (x0 | (~x1 & ~x3))) | (x0 & (~x1 | x3)) | (~x1 & x2 & x3);
  assign new_n150_ = ~x4 & ((~x2 & ~new_n82_ & ~x3) | (~new_n141_ & x3));
  ...
  assign z57 = (~new_n156_ & ~x0) | (x2 & (~new_n84_ | x0 | x4));
  assign new_n156_ = (x1 | (x2 & x3)) & (x2 | (~x3 & (x4 | ~x5))) & (~new_n80_ | x4);
  assign z58 = ~new_n158_ | (~x0 & ~x4 & (x5 | (x1 & x6)));
  assign new_n158_ = (x2 | (~x0 & ~x1)) & ~new_n139_ & (~x0 | (x1 & x5)) & x3 & (x1 | (~x2 & ~x5));
  ...
  assign new_n163_ = new_n85_ & x5 & ~x4 & (~x2 | x3 | ~x5);
