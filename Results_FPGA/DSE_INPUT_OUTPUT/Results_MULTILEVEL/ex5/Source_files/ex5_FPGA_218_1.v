...
module FAU ( 
  ...
  wire new_n75_, new_n82_, new_n84_, new_n86_, new_n88_, new_n90_, new_n92_,
    new_n94_, new_n100_, new_n103_, new_n106_, new_n108_, new_n112_,
    ...
    new_n147_, new_n149_, new_n152_, new_n155_, new_n157_, new_n159_,
    new_n164_, new_n166_;
  ...
  assign z32 = new_n114_ | new_n115_ | new_n116_ | x1 | x2;
  ...
  assign z53 = x3 ? (new_n155_ | (~x1 & (x0 | ~x2))) : ((~new_n94_ & ~x2) | (x0 & (x1 | x2)));
  assign new_n155_ = ~x4 & ((x0 & (x5 ? (~x6 | ~x7) : x6)) | (~x2 & (x5 | x6)));
  assign z54 = (~new_n82_ & x0) | (~x2 & (x3 ? ~new_n94_ : ~new_n157_));
  assign new_n157_ = x1 & (x0 | x4 | (~x5 & ~x6));
  assign z55 = (~x1 & (x0 | ~x2)) | (~x2 & (new_n159_ | (x0 & ~x3))) | (x0 & ~new_n94_ & x2);
  ...
  assign z59 = (~x2 & (~new_n100_ | (x0 & (~x1 | ~x3)))) | new_n164_ | (x2 & (~x0 | (~x1 & ~x3) | (x1 & x3)));
  assign new_n164_ = ~x4 & (x5 | (x2 & x6));
  assign z60 = (x0 & (~x1 | ~x4)) | x3 | (~x0 & (~new_n166_ | x1 | x2 | x4));
