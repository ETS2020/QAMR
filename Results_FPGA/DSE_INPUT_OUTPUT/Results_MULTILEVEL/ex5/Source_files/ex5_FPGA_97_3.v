...
module FAU ( 
  ...
  wire new_n75_, new_n83_, new_n85_, new_n86_, new_n88_, new_n90_, new_n92_,
    new_n94_, new_n97_, new_n106_, new_n111_, new_n113_, new_n114_,
    ...
    new_n164_, new_n165_, new_n167_, new_n169_, new_n173_, new_n174_,
    new_n175_;
  ...
  assign z09 = x2 & (x0 | (new_n86_ & new_n85_ & ~x1));
  ...
  assign z44 = new_n146_ | new_n147_ | x2 | ((new_n140_ | new_n145_) & ~x2);
  assign new_n145_ = ~x4 & x5 & (x6 | x7);
  assign new_n146_ = ~x0 & (~x4 | (x1 & x4));
  ...
  assign z49 = ~x2 | (~x0 & (~new_n158_ | (x2 & (x1 | (~x4 & x6)))));
  assign new_n158_ = x4 ? ~x3 : ~x5;
  assign z50 = (~x2 & (~new_n160_ | (x0 & (~x1 | ~x3)))) | (~x0 & (~new_n158_ | x2));
  assign new_n160_ = ~x4 & ~x5 & x6 & x7;
  assign z51 = (~new_n162_ & ~x0) | (~x2 & ((x0 & (~x1 | x3)) | new_n156_ | (~x0 & ~x3)));
  assign new_n162_ = (x4 | (x3 & ~x5 & ~x6)) & ~x1 & (~x2 | ~x4);
  assign z52 = (x2 & (x0 | (new_n134_ & ~x0))) | ~new_n165_ | (~new_n164_ & ~x2);
  assign new_n164_ = (~x0 | (x1 & ~x3)) & (x0 | x3) & (x4 | x5 | ~x6);
  assign new_n165_ = (x4 | ~x5) & (x0 | (~x1 & (x4 | ~x6)));
  assign z53 = (x1 & (x0 ? (~x2 & ~x3) : (x2 & x3))) | (~new_n167_ & ((~x2 & ~x3) | (~x0 & ~x1 & x3))) | ((new_n127_ | ~x1) & ((~x2 & x3) | (~x0 & x2 & ~x3)));
  assign new_n167_ = ~x4 & x5 & x6 & x7;
  assign z54 = (~x1 & ((~x2 & ~x3) | (~x0 & x2 & x3))) | (~new_n169_ & ~x0) | (~x2 & ((x0 & x3) | (~new_n167_ & (x0 | x3))));
  assign new_n169_ = x3 ? (x4 | (x5 ? (x6 & x7) : ~x6)) : (x2 ? (~x4 & x5 & x6 & x7) : (x4 | (~x5 & ~x6)));
  assign z55 = new_n127_ | ~x1 | (x0 & (x2 | ~x3));
  assign z56 = (~x1 & (~x2 | (~x0 & x3))) | (~x2 & (new_n150_ | x0 | ~x3)) | (~x0 & ~new_n167_ & x2);
  assign z57 = new_n173_ | new_n174_ | ~new_n175_ | (~x3 & (x0 | ~x1));
  ...
  assign z59 = (x0 & (~x1 | ~x3)) | ~new_n160_ | (x2 & (x1 | x3));
