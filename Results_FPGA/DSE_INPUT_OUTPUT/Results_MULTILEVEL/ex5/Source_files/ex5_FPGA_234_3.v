...
module FAU ( 
  ...
  wire new_n81_, new_n83_, new_n85_, new_n87_, new_n90_, new_n93_, new_n96_,
    new_n104_, new_n107_, new_n109_, new_n111_, new_n113_, new_n114_,
    ...
    new_n157_, new_n161_, new_n164_, new_n166_, new_n167_, new_n168_,
    new_n169_, new_n171_, new_n172_, new_n173_, new_n175_;
  assign z00 = z26 | (~x4 & ~x5 & ~x6);
  assign z26 = x0 & x2;
  ...
  assign z32 = new_n116_ | (~x2 & (new_n113_ | new_n114_ | ~new_n115_));
  ...
  assign z34 = new_n118_ | new_n119_ | (x5 & (~x3 | x6)) | (~new_n120_ & ~x5);
  ...
  assign z43 = ((new_n142_ | new_n143_) & ~x0) | (~x2 & (new_n140_ | new_n141_));
  assign new_n140_ = (x4 | ~x5) & (x1 | (~x0 & x3));
  assign new_n141_ = ~x4 & ((x5 & (x6 | x7)) | (x0 & x6 & ~x7));
  assign new_n142_ = x4 & (x1 | (x2 & ~x3));
  assign new_n143_ = ~x4 & ((x2 & (~x5 | x6)) | (x5 & x6) | (~x5 & ~x6) | x7);
  assign z44 = (~x0 & (x2 | ~x4)) | (~new_n145_ & ~x2);
  assign new_n145_ = (~x3 | (~x0 & ~x4)) & (~x5 | (~x0 & x4)) & ~x1 & (~x0 | (~x4 & ~x6));
  assign z45 = (~new_n147_ & ~x0) | (~x2 & (x0 | x1 | x4 | (~x4 & x5)));
  assign new_n147_ = (~x2 | (x1 & (x4 | ~x6))) & (x4 | (~x5 & (x2 | (x6 & x7))));
  assign z46 = x2 ? ~x0 : (new_n149_ | x0 | ~x1 | x3);
  assign new_n149_ = ~x4 & (x5 | (x6 & ~x7));
  assign z47 = (~x0 & x2 & (new_n127_ | ~x1)) | (~x2 & (~new_n151_ | x0 | x1 | x4));
  assign new_n151_ = ~x5 & x6 & x7;
  assign z48 = x0 ? ~x2 : (new_n153_ | x1 | x2 | ~x3);
  assign new_n153_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z49 = new_n127_ | ~new_n81_ | ~x2 | (x3 & x4);
  assign z50 = (x0 & (~x1 | ~x3)) | ~new_n151_ | x2 | x4;
  assign z51 = (x2 & (x0 | x4)) | (x0 & (~x1 | x3)) | (~new_n157_ & ~x4) | (~x0 & (x1 | ~x3));
  assign new_n157_ = (x0 | (~x5 & ~x6)) & (x5 | ~x6) & (~x5 | (x6 & x7));
  assign z52 = (~x2 & ((x0 & (~x1 | x3)) | new_n127_ | (~x0 & ~x3))) | (~x0 & (new_n127_ | x1 | (x2 & x3 & x4)));
  assign z53 = (x1 & (x0 ? (~x2 & ~x3) : (x2 & x3))) | (~new_n83_ & ((~x2 & ~x3) | (~x0 & ~x1 & x3))) | ((new_n127_ | ~x1) & ((~x0 & x2 & ~x3) | (~x2 & x3)));
  assign z54 = (~x1 & ((~x2 & ~x3) | (~x0 & x2 & x3))) | (~new_n161_ & ~x0) | (~x2 & ((x0 & x3) | (~new_n83_ & (x0 | x3))));
  assign new_n161_ = x3 ? (x4 | (x5 ? (x6 & x7) : ~x6)) : (x2 ? (~x4 & x5 & x6 & x7) : (x4 | (~x5 & ~x6)));
  assign z55 = (x0 & ~x2 & ~x3) | ((~x0 | ~x2) & (new_n127_ | ~x1));
  assign z56 = (~x1 & (~x2 | (~x0 & x3))) | new_n164_ | (~x2 & (x0 | ~x3)) | (~x0 & ~new_n83_ & x2);
  assign new_n164_ = ~x4 & ((~x2 & x5) | (~x0 & x6 & ~x7));
  assign z57 = (~x2 & (~new_n167_ | (~new_n166_ & x0))) | (~x0 & (new_n168_ | ~new_n169_));
  assign new_n166_ = x3 & (x4 | ~x6 | x7);
  assign new_n167_ = x1 & (x4 | ~x5) & (x0 | ~x3);
  assign new_n168_ = ~x7 & (x2 | (~x4 & x6));
  assign new_n169_ = (x1 | x3) & (~x2 | (~x4 & x5 & x6));
  assign z58 = new_n171_ | new_n172_ | new_n173_ | x0 | ~x3;
  assign new_n171_ = x1 & (~x2 | (~x4 & x6));
  assign new_n172_ = x5 & (~x1 | ~x4);
  assign new_n173_ = ~x1 & (x2 | x4 | ~x6 | ~x7);
  assign z59 = (~x2 & (~new_n175_ | (x0 & (~x1 | ~x3)))) | (~x0 & (~new_n175_ | (x2 & (x1 | x3))));
  assign new_n175_ = ~x4 & ~x5 & x6 & x7;
  assign z60 = (~x2 & (x3 | (x0 & (~x1 | ~x4)))) | (~x0 & (~new_n87_ | x1 | x4 | (x2 & ~x3)));
  assign z62 = ~x0 | (~x2 & (x3 | (x0 & (new_n127_ | ~x1))));
  assign z08 = 1'b0;
  assign z12 = 1'b0;
  assign z28 = 1'b0;
  assign z30 = 1'b0;
