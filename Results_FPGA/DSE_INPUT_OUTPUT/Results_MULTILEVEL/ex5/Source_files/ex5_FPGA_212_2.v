...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n81_, new_n83_, new_n85_, new_n86_, new_n88_, new_n91_, new_n95_,
    new_n100_, new_n104_, new_n106_, new_n107_, new_n109_, new_n113_,
    new_n115_, new_n117_, new_n119_, new_n120_, new_n124_, new_n125_,
    new_n126_, new_n128_, new_n130_, new_n132_, new_n134_, new_n138_,
    new_n140_, new_n142_, new_n143_, new_n144_, new_n145_, new_n147_,
    new_n148_, new_n154_, new_n156_;
  ...
  assign z13 = ~x4 & (x2 | (new_n85_ & ~x0 & new_n86_ & x5));
  assign new_n85_ = x1 & x3;
  assign new_n86_ = x6 & x7;
  assign z14 = x7 & new_n88_ & x6;
  assign new_n88_ = x5 & ~x4 & x3 & ~x2 & x0 & ~x1;
  assign z16 = ~x4 & (x2 | (new_n86_ & x5 & new_n85_ & x0));
  assign z17 = (x2 & ~x4) | (new_n91_ & ~x2 & x4 & ~x5);
  assign new_n91_ = x0 & ~x1;
  assign z18 = ~x5 & x4 & x3 & x2 & ~x0 & ~x1;
  assign z19 = (x2 & ~x4) | (~x0 & ~x1 & ~x2 & ~x3 & x4);
  assign z20 = ~x4 & (x2 | (new_n91_ & new_n95_ & ~x3));
  assign new_n95_ = ~x5 & ~x6;
  assign z21 = ~x4 & (x2 | (new_n91_ & new_n95_ & x3));
  ...
  assign new_n104_ = (x0 | (x4 & (x2 | ~x3))) & (~x1 | (x2 & ~x4)) & (~x2 | (x4 & (x3 | ~x4))) & (~x4 | x5) & (x2 | x4 | ~x5);
  ...
  assign z34 = (x4 & (x2 | x5)) | (~x2 & (x5 ? ~new_n109_ : (~new_n91_ | (~new_n86_ & ~x4))));
  ...
  assign z40 = (x1 & (~x2 | x4)) | (~new_n119_ & x4) | (~new_n120_ & ~x2);
  ...
  assign z43 = new_n124_ | new_n125_ | new_n126_ | (x2 & (x1 | ~x3));
  assign new_n124_ = x0 & (x2 | (~x4 & x6 & ~x7));
  assign new_n125_ = (x4 | ~x5) & (x1 | (~x0 & ~x2 & x3));
  assign new_n126_ = ~x4 & ((~x0 & (x7 | (~x5 & ~x6))) | x2 | (x5 & (x6 | x7)));
  assign z44 = new_n125_ | ~new_n128_ | (x6 & (x0 | (~x4 & x5)));
  assign new_n128_ = (x4 | (x0 & (~x5 | ~x7))) & ~x2 & (~x0 | (~x3 & ~x4 & ~x5));
  assign z45 = (x1 & (~x2 | ~x4)) | x0 | (~x1 & (~new_n130_ | x2 | x4));
  assign new_n130_ = ~x5 & x6 & x7;
  assign z46 = x2 ? x4 : (new_n132_ | x0 | ~x1 | x3);
  assign new_n132_ = ~x4 & (x5 | (x6 & ~x7));
  assign z48 = ~new_n134_ | (~x4 & (x5 ? (~x6 | ~x7) : x6));
  assign new_n134_ = ~x0 & ~x1 & ~x2 & x3;
  assign z49 = (x0 & (~x1 | x2 | ~x3)) | ~x2 | (x2 & (x1 | x3 | ~x4));
  assign z50 = (~new_n85_ & x0) | x2 | (~x2 & (~new_n86_ | x4 | x5));
  assign z51 = (~x2 & ((x0 & (~x1 | x3)) | (~new_n138_ & ~x4) | (~x0 & (x1 | ~x3)))) | (~x0 & (x2 | (x1 & x4))) | (x2 & (~x1 | ~x4));
  assign new_n138_ = (~x5 | (x6 & x7)) & (x5 | ~x6) & (x0 | (~x5 & ~x6));
  assign z52 = (~x2 & ((x0 & (~x1 | x3)) | (~new_n140_ & ~x4) | (~x0 & (x1 | ~x3)))) | (x4 & ((x2 & x3) | (~x0 & x1)));
  assign new_n140_ = ~x5 & (~x6 | (x0 & x5));
  assign z53 = (~x3 & (new_n142_ | (~new_n143_ & ~x2))) | new_n144_ | (~new_n145_ & x3);
  ...
  assign z54 = (~new_n148_ & ~x3) | (~new_n147_ & x2) | (x0 & x3) | (~new_n143_ & (x0 | (~x2 & x3)));
  assign new_n147_ = x1 & x4;
  assign new_n148_ = x1 & ~x2 & (x0 | x4 | (~x5 & ~x6));
  assign z55 = (x0 & (x2 | ~x3)) | ~x1 | (~x4 & (~new_n95_ | x2));
  assign z56 = new_n132_ | x2 | ~x3 | x0 | ~x1;
  assign z57 = new_n132_ | ~x1 | x2 | (x0 & ~x3) | (~x0 & x3);
  assign z58 = (x1 & (~x2 | ~x4)) | x0 | ~x3 | (~x1 & (~new_n130_ | x2 | x4));
  assign z59 = x4 ? (~x0 | ~x2 | (x1 & x3) | (~x1 & ~x3)) : (~new_n154_ | (x0 & (~x1 | ~x3)));
  assign new_n154_ = ~x2 & ~x5 & x6 & x7;
  assign z60 = (x1 & (x4 ? x3 : x5)) | (~x1 & (x4 | (x0 & ~x4))) | (~x0 & x4) | (~x4 & (~new_n156_ | (x0 & (~x3 | x5))));
  assign new_n156_ = x5 & x6 & x7 & ~x2 & (~x3 | ~x5);
  assign z61 = (~x1 & (~x2 | ~x3 | ~x4)) | ~x0 | x1 | (~x4 & (~new_n95_ | x2));
  assign z62 = (~x4 & (~new_n95_ | x2)) | ~x0 | ~x1 | (x1 & x3);
  assign z08 = 1'b0;
  assign z09 = 1'b0;
  assign z26 = 1'b0;
  assign z27 = 1'b0;
  ...
  assign z12 = z06;
  assign z15 = z06;
  assign z47 = (x1 & (~x2 | ~x4)) | x0 | (~x1 & (~new_n130_ | x2 | x4));
endmodule
