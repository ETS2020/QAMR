...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n77_, new_n83_, new_n85_, new_n88_, new_n90_, new_n92_,
    new_n94_, new_n96_, new_n98_, new_n100_, new_n106_, new_n108_,
    ...
    new_n168_;
  assign z00 = z23 | new_n75_;
  assign z23 = ~x0 & ~x2;
  assign new_n75_ = ~x4 & ~x5 & ~x6;
  assign z01 = z23 | (new_n77_ & ~x5);
  assign new_n77_ = ~x6 & ~x7;
  assign z02 = ~x3 & ~x4 & x5 & ~x6 & ~z23 & ~x7;
  assign z03 = x3 & ~x4 & x5 & ~x6 & ~z23 & ~x7;
  ...
  assign z11 = ~x2 & (~x0 | (new_n88_ & new_n90_ & x1));
  assign new_n90_ = ~x3 & ~x4;
  assign z12 = x7 & x6 & x5 & ~x4 & new_n92_ & ~x3;
  assign new_n92_ = x2 & x0 & ~x1;
  assign z14 = ~x2 & (~x0 | (new_n88_ & new_n94_ & ~x1));
  ...
  assign z26 = (~x0 & ~x2) | (x0 & x2 & ~x3 & new_n106_ & ~x4 & ~x5);
  ...
  assign z38 = (x1 & (x0 | x2)) | (~x3 & (x2 | (x0 & ~x4))) | (x2 & (x0 | ~x4)) | (x0 & ~new_n127_ & ~x4);
  ...
  assign z42 = (~x0 & (~x2 | ~x5)) | x4 | (~new_n135_ & ~x5) | (~new_n77_ & x5);
  ...
  assign z44 = x2 | (x0 & (~new_n90_ | x5 | x6 | (x1 & ~x2 & ~x5)));
  assign z45 = (new_n142_ & ~x0) | x0 | ~x1 | ~x2;
  assign new_n142_ = ~x4 & (x5 | x6);
  assign z47 = (new_n142_ & ~x0) | ~x1 | ~x2 | (x0 & (~new_n88_ | ~new_n94_));
  assign z49 = (~new_n127_ & ~x4) | x0 | x1 | ~x2 | (x3 & x4);
  assign z50 = x2 | (x0 & (~new_n94_ | ~x1 | ~new_n106_ | x5));
  assign z51 = x0 ? (new_n147_ | ~x1 | (~x2 & x3)) : (x2 & (~new_n75_ | x1 | ~x3));
  assign new_n147_ = ~x4 & ((x2 & (x5 | x6)) | (~x5 & x6) | (x5 & (~x6 | ~x7)));
  assign z52 = (x0 & (x3 | (~x1 & ~x2))) | (~x0 & (x1 | ~x2)) | (~new_n127_ & ~x4) | (x3 & x4);
  assign z53 = new_n150_ | (~new_n151_ & ~x4) | ~new_n154_ | (~new_n152_ & ~new_n153_);
  ...
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n153_ & (x2 ? ~x3 : x0)) | (x0 & x3) | (new_n156_ & x2);
  assign new_n156_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = new_n158_ | (~x2 & (~x0 | ~x3)) | ~x1 | (x0 & ~new_n153_ & x2);
  assign new_n158_ = ~x4 & (~x0 | ~x2) & (x5 | x6);
  assign z56 = ~new_n160_ | ~x7 | ~x5 | ~x6;
  assign new_n160_ = x2 & ~x4 & ~x0 & (x1 | ~x3);
  assign z57 = (~x1 & (x2 ? ~x3 : x0)) | (~new_n153_ & x2) | (x0 & (x2 | (~x2 & (new_n162_ | ~x3))));
  assign new_n162_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = x2 ? ((new_n142_ & ~x0) | (~new_n153_ & x0) | ~x1 | ~x3) : x0;
  assign z59 = x0 ? (new_n165_ | new_n166_ | ~new_n167_) : (~new_n168_ & x2);
  assign new_n165_ = (~x1 | ~x3) & (~x2 | (~x4 & x6));
  assign new_n166_ = x5 & (~x4 | (x1 & x3));
  assign new_n167_ = x1 ? (~x3 | (~x2 & ~x4 & x6 & x7)) : x3;
  assign new_n168_ = ~x1 & ~x3 & ~x4 & ~x5 & x6 & x7;
  assign z60 = x0 ? (x3 | ~x4 | (~x1 & (~x2 | ~x3))) : (x2 & (~new_n88_ | x1 | ~x3 | x4));
