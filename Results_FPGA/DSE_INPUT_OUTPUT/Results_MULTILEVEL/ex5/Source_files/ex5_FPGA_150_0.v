...
module FAU ( 
  ...
  wire new_n78_, new_n79_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    new_n95_, new_n101_, new_n103_, new_n105_, new_n107_, new_n109_,
    ...
    new_n142_, new_n144_, new_n146_, new_n152_, new_n155_, new_n156_,
  ...
  assign z03 = z13 | (new_n78_ & new_n79_ & x5);
  assign new_n78_ = x3 & ~x4;
  assign new_n79_ = ~x6 & ~x7;
  assign z04 = z13 | (new_n78_ & ~x5 & x6 & ~x7);
  ...
  assign z14 = ~x2 & (~x0 | (new_n89_ & new_n78_ & ~x1));
  assign z15 = x7 & new_n95_ & x6;
  assign new_n95_ = x5 & ~x4 & x3 & x2 & ~x0 & x1;
  assign z16 = ~x2 & (~x0 | (new_n89_ & new_n78_ & x1));
  ...
  assign z30 = (~x0 & ~x2) | (new_n103_ & new_n111_ & x0 & x1 & x2 & ~x3);
  assign new_n111_ = ~x4 & ~x5;
  assign z31 = (~x0 & (~x2 | ~x5)) | ~new_n113_ | (x1 & (x0 | x2));
  assign new_n113_ = (~x2 | (~x0 & x3 & x4)) & (~x0 | (x4 ? x5 : (~x5 & ~x6)));
  assign z32 = (x1 & (x0 | x2)) | (~x3 & (x2 | (x0 & ~x4))) | (~new_n115_ & x0) | (x2 & (x0 | ~x4));
  ...
  assign z42 = (x4 & (x0 | x2)) | (~new_n136_ & ~x5) | (~new_n79_ & (x0 ? x5 : x2));
  ...
  assign z44 = ~new_n144_ | ~new_n111_ | x6;
  assign new_n144_ = ~x2 & ~x3 & x0 & (~x1 | x2 | x5);
  assign z45 = new_n146_ | x0 | ~x1 | ~x2;
  assign new_n146_ = ~x4 & (x5 | x6);
  assign z47 = (x2 & (~x1 | (new_n146_ & ~x0))) | (x0 & (~new_n89_ | ~new_n78_ | ~x2));
  assign z48 = x2 | (x0 & (~new_n89_ | ~new_n78_ | ~x2));
  assign z49 = x0 | (x2 & ((~new_n83_ & ~x4) | x1 | (x3 & x4)));
  assign z50 = x2 | (x0 & (~new_n78_ | ~x1 | ~new_n103_ | x5));
  assign z51 = (~x2 & (~x0 | (x0 & x3))) | (~new_n152_ & ~x4) | (x0 & ~x1) | (~x0 & ((x1 & x2) | ~x3 | x4));
  ...
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n85_ & (x2 ? ~x3 : x0)) | (x0 & x3) | (new_n159_ & x2);
  assign new_n159_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = (~x4 & ~new_n83_ & (x0 ^ x2)) | (~new_n161_ & x0) | (~x1 & (x0 | x2));
  assign new_n161_ = x2 ? (x6 & x7 & ~x4 & x5) : x3;
  ...
  assign z58 = (~new_n166_ & x0) | (x2 & ((new_n146_ & ~x0) | ~x1 | ~x3));
  assign z59 = (~new_n169_ & (~new_n103_ | x4)) | ~new_n171_ | (~new_n170_ & x0);
  assign new_n169_ = x0 ? (~x1 | ~x3) : ~x2;
  assign new_n170_ = (x3 | (x1 & (x4 | ~x6))) & (x1 | (x2 & (x4 | ~x6))) & (~x5 | (x4 & (~x1 | ~x3)));
  assign new_n171_ = (~x2 | ((~x1 | ~x3) & (x0 | (~x1 & (x3 | ~x5))))) & (x2 | x3) & (x0 | (x2 & ~x3));
  assign z60 = (x2 & ((~new_n173_ & ~x0) | (x1 & (~x0 | x3)))) | (x0 & (x3 | ~x4 | (~x1 & (~x2 | ~x3))));
  assign new_n173_ = x3 & ~x4 & x6 & x7 & (~x3 | x5);
