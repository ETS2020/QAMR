...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n81_, new_n83_, new_n85_, new_n87_, new_n91_, new_n93_, new_n94_,
    new_n99_, new_n102_, new_n104_, new_n105_, new_n107_, new_n110_,
    ...
    new_n170_, new_n172_, new_n173_, new_n175_;
  ...
  assign z12 = (~x2 & x3) | (new_n85_ & new_n91_ & x2 & ~x3);
  ...
  assign z46 = ~new_n94_ | x2 | x3 | (~x4 & (new_n105_ | x5));
  ...
  assign z50 = x2 | x3 | (~x3 & (x0 | (~new_n114_ & ~x2)));
  ...
  assign z53 = (x1 & (~x0 ^ ~x3)) | (x0 & (x3 ? ~x1 : x2)) | (~new_n85_ & (~x2 | (~x0 & x3))) | new_n160_ | (~x2 & x3) | (~x1 & x2 & ~x3);
  assign new_n160_ = ~x4 & ((x2 & ~x3 & (x5 | x6)) | (x3 & (x5 ? (~x6 | ~x7) : x6)));
  assign z54 = (~new_n162_ & ~x3) | (x2 & (new_n163_ | (~new_n94_ & x3)));
  assign new_n162_ = (x2 | (x1 & (x0 | new_n81_ | x4))) & (~x0 | x1) & (new_n85_ | (~x0 & ~x2));
  ...
  assign z57 = (x0 & (x2 | ~x3)) | (~new_n168_ & ~x3) | (~new_n85_ & x2);
  assign new_n168_ = x1 & (x4 | (~new_n105_ & (x2 | ~x5)));
  assign z58 = (~x0 & ~new_n81_ & ~x4) | ~new_n170_ | (~new_n85_ & x0);
  assign new_n170_ = x1 & x2 & x3;
  assign z59 = (x1 & (x3 | (~x0 & x2 & ~x3))) | (~x2 & (x0 | x3)) | new_n172_ | (~new_n173_ & ~x0) | (x0 & ~x1 & ~x3);
  assign new_n172_ = ~x4 & ~new_n81_ & (x3 | (x0 & ~x3));
  assign new_n173_ = ~x3 & ~x5 & (new_n152_ | x3);
  assign z60 = ~new_n175_ | (~new_n85_ & (x3 ? x2 : ~x0));
  assign new_n175_ = (~x2 | ((x0 | x3 | (~x1 & ~x5)) & (~x3 | (~x0 & ~x1)))) & (x3 | (x0 ? (x1 & x4) : (~x1 | ~x5)));
  assign z61 = (~new_n81_ & ~x4) | ~new_n91_ | ~x2 | ~x3;
