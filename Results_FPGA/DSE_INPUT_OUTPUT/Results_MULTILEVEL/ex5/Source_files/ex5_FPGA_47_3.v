...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n80_, new_n82_, new_n84_, new_n87_, new_n88_, new_n90_, new_n92_,
    new_n94_, new_n96_, new_n103_, new_n107_, new_n112_, new_n114_,
  ...
  assign z21 = ~new_n103_ & x0;
  assign new_n103_ = ~x2 & (x4 | x5 | x6 | x1 | ~x3);
  ...
  assign z31 = ~new_n112_ | (~z08 & x1);
  assign new_n112_ = (x0 | ((~x2 | (x3 & x5)) & x4 & (x2 | ~x3))) & (x2 | (x4 ? x5 : (~x5 & ~x6)));
  assign z32 = (~new_n114_ & ~x2) | (~x0 & (x1 | (x2 & (~x3 | ~x4))));
  assign new_n114_ = (x4 | (~x5 & (~x0 | (x3 & ~x6)))) & new_n115_ & (~x4 | (x0 & x5));
  assign new_n115_ = ~x1 & (x0 | (~x3 & ~x5 & x6 & ~x7));
  assign z34 = new_n117_ | new_n119_ | (~new_n118_ & ~x0);
  assign new_n117_ = x1 & ((~x0 & x2 & ~x3) | (~x2 & ~x5));
  assign new_n118_ = (~x3 | (x5 & (~x2 | ~x6))) & (x3 | (~x5 & (~x2 | x6))) & (x2 | x5) & (~x2 | (~x4 & ~x7));
  assign new_n119_ = ~x2 & ((~x4 & ~x5 & (~x6 | ~x7)) | (x5 & (x6 | x7 | ~x3 | x4)));
  assign z35 = (x0 & (x2 | ~x5)) | (x2 & (~x3 | ~x5)) | x1 | ~x4 | (~x0 & ~x2 & x3);
  assign z36 = (x0 & (x2 | ~x4)) | ~new_n123_ | (~x0 & (~new_n122_ | ~x2 | x3));
  ...
  assign z42 = ~new_n137_ | (x2 & (x0 | ~x5));
  assign new_n137_ = (~x5 | (~x6 & ~x7)) & ~x4 & (x5 | (x0 & ~x1 & x6 & x7));
  assign z43 = (~new_n139_ & ~x2) | (~new_n141_ & ~x0);
  assign new_n139_ = ~new_n140_ & (x4 | ((~x5 | (~x6 & ~x7)) & (~x0 | ~x6 | x7)));
  assign new_n140_ = (x4 | ~x5) & (x1 | (~x0 & x3));
  assign new_n141_ = x4 ? (~x1 & (~x2 | x3)) : new_n142_;
  assign new_n142_ = (~x2 | (x5 & ~x6)) & (~x5 | ~x6) & ~x7 & (x5 | x6);
  assign z44 = (~x2 & (new_n140_ | ~new_n144_)) | (~x0 & (x2 | ~x4 | (x1 & x4)));
  ...
  assign z50 = (~x0 & (~new_n152_ | x2)) | (~x2 & (~new_n154_ | (x0 & (~x1 | ~x3))));
  assign new_n154_ = new_n88_ & ~x4 & ~x5;
  ...
  assign z53 = (x1 & (x0 ? (~x2 & ~x3) : (x2 & x3))) | (~new_n161_ & ((~x2 & ~x3) | (~x0 & ~x1 & x3))) | ((new_n127_ | ~x1) & ((~x2 & x3) | (~x0 & x2 & ~x3)));
  assign new_n161_ = new_n80_ & new_n88_;
  assign z54 = (~new_n163_ & ~x2) | ~new_n164_ | (~x1 & (x0 | (x2 & x3)));
  assign new_n163_ = x3 ? (new_n80_ & new_n88_) : (x1 & (~new_n127_ | x0));
  assign new_n164_ = ((new_n80_ & new_n88_) | (~x0 & (~x2 | x3))) & (~new_n150_ | ~x2) & (~x0 | (~x2 & ~x3));
  assign z55 = (x0 & ~x2 & ~x3) | ((new_n127_ | ~x1) & (~x0 | ~x2));
  assign z56 = (~x1 & (~x2 | x3)) | ~new_n167_ | (~x2 & (new_n80_ | ~x3));
  assign new_n167_ = (x7 | (~x2 & (x4 | ~x6))) & ~x0 & (~x2 | (~x4 & x5 & x6));
  assign z57 = (~x3 & (x0 | ~x1)) | ~new_n169_ | ((new_n80_ | ~x1) & (x0 | ~x2));
  assign new_n169_ = new_n170_ & (x7 | (~x2 & (x4 | ~x6)));
  ...
  assign z62 = new_n127_ | ~x0 | ~x1 | x2 | x3;
  assign z12 = 1'b0;
  assign z26 = 1'b0;
  assign z33 = 1'b1;
  assign z61 = ~z08;
