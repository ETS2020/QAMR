...
module FAU ( 
  ...
  wire new_n79_, new_n82_, new_n84_, new_n86_, new_n87_, new_n89_, new_n91_,
    new_n92_, new_n97_, new_n106_, new_n107_, new_n109_, new_n111_,
    ...
    new_n143_, new_n144_, new_n147_, new_n150_, new_n152_, new_n155_,
  ...
  assign z21 = x0 & (x2 | (~x1 & x3 & new_n82_ & ~x4));
  assign z22 = x0 & (x2 | (new_n92_ & ~x5 & ~x1 & ~x4));
  assign z23 = x5 & x3 & new_n87_ & ~x2;
  assign z24 = z08 | (new_n106_ & new_n87_ & new_n79_ & new_n107_);
  ...
  assign new_n111_ = new_n79_ & ~x5 & x1 & ~x3 & ~x4;
  assign z29 = z08 | (new_n106_ & new_n87_ & new_n107_ & ~x6 & x7);
  ...
  assign new_n116_ = (~x0 | new_n82_ | x4) & ~x1 & (~new_n117_ | x0);
  ...
  assign z36 = (x0 & (x2 | ~x4)) | ~new_n123_ | (~x0 & (~new_n79_ | x4 | ~x2 | x3));
  assign new_n123_ = ~x1 & ~x5;
  assign z37 = ((~x3 | x5) & (~x0 | x2)) | (x3 & (x5 ? x1 : ~new_n125_)) | (x0 & x2) | (~x1 & ~x3);
  assign new_n125_ = new_n79_ & ~x4;
  assign z38 = (~x2 & (new_n128_ | (~new_n127_ & ~x0) | x1)) | (~x0 & (x1 | (~new_n129_ & x2)));
  assign new_n127_ = ~x3 & ~x4 & new_n79_ & ~x5;
  assign new_n128_ = ~x4 & (x5 | (x0 & (~x3 | x6)));
  assign new_n129_ = x3 & x4;
  assign z39 = (~new_n132_ & (~x0 | (~x2 & x5))) | (~x0 & (x4 | ~x5)) | (~x2 & (x4 | (~new_n131_ & ~x5)));
  assign new_n131_ = new_n92_ & ~x1;
  assign new_n132_ = x3 & ~x6 & ~x7;
  assign z40 = (~new_n135_ & ~x2) | (~x0 & (~new_n134_ | (~new_n129_ & x2)));
  assign new_n134_ = ~x1 & (x4 | (new_n79_ & ~x5));
  ...
  assign z43 = new_n142_ | (~x2 & (new_n140_ | new_n144_));
  assign new_n140_ = ~new_n141_ & (x1 | (~x0 & x3));
  assign new_n141_ = ~x4 & x5;
  assign new_n142_ = ~x0 & (x4 ? (x1 | (x2 & ~x3)) : ~new_n143_);
  assign new_n143_ = (~x2 | (x5 & ~x6)) & (~x5 | ~x6) & ~x7 & (x5 | x6);
  assign new_n144_ = ~x4 & ((x5 & (x6 | x7)) | (x0 & x6 & ~x7));
  assign z44 = ((~x0 | ~x2) & (x1 | x3)) | (~x0 & (x2 | ~x4)) | (x0 & ~x2 & (~new_n82_ | x4));
  assign z45 = (x1 & (~x2 | (~x4 & x6))) | ~new_n147_ | (x5 & (~x1 | ~x4));
  assign new_n147_ = ~x0 & (x1 | (new_n92_ & ~x2 & ~x4));
  assign z46 = (~x4 & (new_n79_ | x5)) | ~new_n106_ | x0 | ~x1;
  assign z48 = new_n150_ | ~new_n87_ | x2 | ~x3;
  assign new_n150_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z49 = new_n152_ | ~new_n87_ | new_n129_ | ~x2;
  assign new_n152_ = ~new_n82_ & ~x4;
  assign z50 = x2 ? ~x0 : (~new_n92_ | ~new_n107_ | (x0 & (~x1 | ~x3)));
  assign z51 = (~new_n155_ & ~x0) | (~x2 & (new_n150_ | (x0 & (~x1 | x3))));
  assign new_n155_ = (new_n82_ | x4) & ~x1 & x3 & (~x2 | ~x4);
  assign z52 = (~x2 & ((x0 & (~x1 | x3)) | (~new_n82_ & ~x4) | (~x0 & ~x3))) | (~x0 & ((~new_n82_ & ~x4) | x1 | (x2 & x3 & x4)));
  assign z53 = (x0 & (x2 | (x1 & ~x3))) | (~new_n84_ & (x2 ? ~x1 : ~x3)) | (~x1 & (~x2 ^ ~x3)) | new_n158_ | (x1 & x2 & x3);
  assign new_n158_ = ~x4 & ~new_n82_ & (x2 ? x1 : x3);
  assign z54 = ~new_n161_ | (~x2 & (x3 ? ~new_n84_ : ~new_n160_));
  assign new_n160_ = x1 & (x0 | new_n82_ | x4);
  assign new_n161_ = (x1 | (~x0 & (~x2 | ~x3))) & (new_n84_ | (~x0 & (~x2 | x3))) & (~new_n150_ | ~x2) & (~x0 | (~x2 & ~x3));
  assign z55 = new_n152_ | ~x1 | (x0 & (x2 | ~x3));
  assign z56 = (~x0 & (~new_n164_ | (~x1 & (~x2 | x3)))) | (~x2 & (x0 | ~x3));
  assign new_n164_ = (x4 | ((~x6 | x7) & (x2 | ~x5))) & (~x2 | (~x4 & x5 & x6 & x7));
  assign z57 = (~x3 & (x0 | ~x1)) | ~new_n166_ | ((new_n141_ | ~x1) & (x0 | (~x0 & ~x2)));
  assign new_n166_ = (x7 | ((x0 | ~x2) & (x4 | ~x6))) & (new_n167_ | x0) & (~x0 | ~x2);
  assign new_n167_ = x2 ? (~x4 & x5 & x6) : ~x3;
  assign z58 = (x1 & (~x2 | (~x4 & x6))) | ~new_n169_ | (x5 & (~x1 | ~x4));
  assign new_n169_ = ~x0 & x3 & (x1 | (new_n92_ & ~x2 & ~x4));
  assign z59 = (~x2 & (~new_n92_ | ~new_n107_ | (x0 & (~x1 | ~x3)))) | (~x0 & (~new_n92_ | ~new_n107_ | (x2 & (x1 | x3))));
  assign z60 = (~x2 & (x3 | (x0 & (~x1 | ~x4)))) | (~x0 & (~new_n91_ | x1 | x4 | (x2 & ~x3)));
  assign z62 = new_n152_ | ~new_n106_ | ~x0 | ~x1;
  assign z26 = 1'b0;
  assign z30 = 1'b0;
  assign z61 = 1'b1;
  assign z33 = ~z08;
