...
module FAU ( 
  ...
  wire new_n76_, new_n78_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    new_n93_, new_n96_, new_n102_, new_n105_, new_n107_, new_n109_,
  ...
  assign z02 = z19 | (new_n78_ & new_n76_ & x5);
  assign new_n78_ = ~x3 & ~x4;
  assign z03 = x3 & ~x4 & x5 & ~x6 & ~z19 & ~x7;
  assign z04 = z19 | (x3 & ~x4 & ~x5 & x6 & ~x7);
  ...
  assign z30 = (~x0 & ~x2) | (new_n109_ & x0 & x1 & x2 & ~x3);
  assign z31 = (~x0 & (~x2 | ~x5)) | ~new_n112_ | (x1 & (x0 | x2));
  assign new_n112_ = (~x2 | (~x0 & x3 & x4)) & (~x0 | (x4 ? x5 : (~x5 & ~x6)));
  ...
  assign z36 = (x1 & (x0 | x2)) | ~new_n124_ | (x5 & (x0 | (x2 & ~x3)));
  assign new_n124_ = (~x0 | (~x2 & x4)) & (~x2 | (~x3 & (x3 | (~x4 & x6 & ~x7))));
  ...
  assign z40 = (x1 & (x0 ^ x2)) | (~new_n133_ & x2) | (~new_n134_ & x0);
  assign new_n133_ = x0 ? (~x3 & ~x4 & ~x5 & x6 & x7) : (x3 & x4);
  assign new_n134_ = x4 ? x5 : (~x5 & (x2 | ~x6));
  assign z41 = (~x1 & (~x3 | ~x5)) | ~x0 | x2 | (x1 & x3);
  assign z42 = (x4 & (x0 | x2)) | (~new_n137_ & ~x5) | (~new_n76_ & (x0 ? x5 : x2));
  assign new_n137_ = (~x2 | (x0 & x3)) & (~x0 | (~x1 & x6 & x7));
  assign z43 = new_n139_ | new_n140_ | (~new_n141_ & x2);
  assign new_n139_ = ~x4 & (((x6 | x7) & (x0 ? x5 : x2)) | (~x0 & x2 & ~x5) | (x0 & x6 & ~x7));
  assign new_n140_ = x1 & ((x4 & (x2 | (x0 & x5))) | (x0 & ~x5 & (~x2 | x3)));
  assign new_n141_ = (~x4 | (~x0 & x3)) & (~x0 | x5 | (x6 & x7));
  ...
  assign z50 = ~x0 | x2 | (~new_n149_ & x0);
  assign new_n149_ = x1 & x3 & ~x4 & ~x5 & x6 & x7;
  assign z51 = x0 ? (new_n151_ | ~x1 | (~x2 & x3)) : (x2 & (~new_n83_ | x1 | ~x3));
  assign new_n151_ = ~x4 & ((x2 & (x5 | x6)) | (~x5 & x6) | (x5 & (~x6 | ~x7)));
  assign z52 = (x0 & (x3 | (~x1 & ~x2))) | (~x0 & (x1 | ~x2)) | (~new_n128_ & ~x4) | (x3 & x4);
  assign z53 = new_n154_ | (~new_n155_ & ~x4) | (~new_n93_ & ~new_n156_) | ~new_n157_;
  ...
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n93_ & (x2 ? ~x3 : x0)) | (x0 & x3) | (new_n159_ & x2);
  assign new_n159_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = new_n161_ | (~x1 & (x2 | (x0 & ~x2))) | (x0 & (x2 ? ~new_n93_ : ~x3));
  assign new_n161_ = ~x4 & (x5 | x6) & (~x0 ^ ~x2);
  assign z56 = x0 | (x2 & (~new_n89_ | x4 | (~x1 & x3)));
  assign z57 = (~x1 & (x0 | (x2 & ~x3))) | (~new_n93_ & x2) | (x0 & (new_n164_ | x2 | ~x3));
  ...
  assign z61 = new_n144_ | ~new_n102_ | ~x2 | ~x3;
