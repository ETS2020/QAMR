...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n83_, new_n85_, new_n87_, new_n89_, new_n92_, new_n95_,
    new_n99_, new_n102_, new_n104_, new_n107_, new_n109_, new_n111_,
    new_n113_, new_n115_, new_n117_, new_n118_, new_n119_, new_n120_,
    new_n123_, new_n125_, new_n128_, new_n129_, new_n131_, new_n134_,
    new_n136_, new_n137_, new_n138_, new_n139_, new_n140_, new_n143_,
    new_n145_, new_n150_, new_n153_, new_n154_, new_n155_, new_n157_,
    new_n159_, new_n162_, new_n165_, new_n166_, new_n167_, new_n169_;
  ...
  assign z12 = (~x0 & ~x2) | (new_n83_ & x0 & ~x1 & x2 & ~x3);
  ...
  assign z31 = (x0 & (x2 | (x4 & ~x5))) | ~new_n111_ | (~x4 & (~x0 | x5 | x6));
  assign new_n111_ = ~x1 & (x0 | (x2 & x3 & x5));
  ...
  assign z36 = (x1 & (x0 | x2)) | ~new_n123_ | (x5 & (x0 | (x2 & ~x3)));
  assign new_n123_ = (~x0 | (~x2 & x4)) & (~x2 | (~x3 & (x3 | (~x4 & x6 & ~x7))));
  ...
  assign z39 = (~x0 & (~x2 | ~x5)) | ~new_n129_ | (x5 & (~new_n128_ | ~x3));
  ...
  assign z42 = (~x0 & (~x2 | ~x5)) | (~new_n128_ & x5) | x4 | (~new_n134_ & ~x5);
  ...
  assign z47 = (x2 & (~x1 | (new_n143_ & ~x0))) | (x0 & (~new_n89_ | ~new_n145_ | ~x2));
  assign new_n145_ = x3 & ~x4;
  assign z48 = x2 | (x0 & (~new_n89_ | ~new_n145_ | ~x2));
  assign z49 = x0 | (x2 & ((~new_n75_ & ~x4) | x1 | (x3 & x4)));
  assign z50 = ~x0 | x2 | (x0 & (~new_n102_ | x5 | ~new_n145_ | ~x1));
  ...
  assign z57 = (~x1 & (x0 | (x2 & ~x3))) | (~new_n83_ & x2) | (x0 & (new_n162_ | x2 | ~x3));
  assign new_n162_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = (new_n143_ & ~x0) | (~new_n83_ & x0) | ~x1 | ~x2 | ~x3;
  assign z59 = (~new_n165_ & (~new_n102_ | x4)) | ~new_n167_ | (~new_n166_ & x0);
  ...
  assign z61 = x0 ? (new_n143_ | x1 | ~x2 | ~x3) : x2;
