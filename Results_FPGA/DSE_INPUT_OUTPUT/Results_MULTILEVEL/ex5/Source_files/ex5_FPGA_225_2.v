...
module FAU ( 
  ...
  wire new_n75_, new_n80_, new_n84_, new_n86_, new_n88_, new_n89_, new_n91_,
    new_n93_, new_n95_, new_n101_, new_n104_, new_n106_, new_n109_,
    ...
    new_n150_, new_n152_, new_n155_, new_n157_, new_n159_, new_n161_,
    new_n162_, new_n164_;
  ...
  assign z13 = ~x2 & (x0 | (new_n95_ & new_n89_ & x5));
  assign new_n95_ = x1 & x3 & ~x4;
  ...
  assign z45 = (~new_n134_ & ~x4) | (x2 & (x0 | ~x1)) | (~x0 & ~x2 & (~new_n104_ | x1 | x4));
  assign new_n134_ = (new_n135_ | x0) & (new_n75_ | ~x2);
  assign new_n135_ = ~x5 & (~x6 | x7);
  assign z46 = x2 | (~x0 & (new_n137_ | ~x1 | x3));
  assign new_n137_ = ~new_n135_ & ~x4;
  ...
  assign z48 = x2 | (~x0 & (~new_n126_ | (~new_n142_ & ~x4)));
  ...
  assign z53 = (~new_n91_ & (x2 ? ~x1 : ~x3)) | (~x3 & (x0 | (~x1 & x2))) | ~new_n148_ | (~x1 & (x0 | (~x2 & x3)));
  assign new_n148_ = new_n150_ & (x4 | (~new_n149_ & (new_n142_ | ~x0)));
  assign new_n149_ = (x5 | x6) & ((~x2 & x3) | (~x0 & x1 & x2));
  assign new_n150_ = (~x0 | x2) & (x0 | ~x1 | ~x2 | ~x3);
  assign z54 = (~new_n91_ & (~x2 ^ ~x3)) | new_n152_ | (~x2 & (x0 | (~x1 & ~x3))) | (x0 & (~x1 | x3)) | (~x1 & x2 & x3);
  assign new_n152_ = ~x4 & ((~new_n142_ & x3) | (~x2 & ~new_n75_ & ~x3));
  assign z55 = (~x1 & (x2 | (~x0 & ~x2))) | (~x0 & ~new_n75_ & ~x4) | (x0 & ~new_n91_ & x2);
  assign z56 = (~x1 & (x2 ? x3 : ~x0)) | (~new_n155_ & x2) | (~x0 & ~x2 & (new_n137_ | ~x3));
  ...
  assign z59 = (x1 & (x0 ? x3 : x2)) | new_n162_ | (~new_n161_ & ~x0) | (x0 & (~x2 | (~x1 & ~x3)));
  assign new_n161_ = ~x4 & ~x5 & new_n89_ & (~x2 | ~x3 | x5);
  assign new_n162_ = ~x4 & (x5 | (x0 & x6));
  assign z60 = x0 ? (x2 & (~x1 | x3 | ~x4)) : ~new_n164_;
  assign new_n164_ = (~x1 | (~x2 & ~x5)) & new_n89_ & ~x4 & x5 & (~x5 | (x2 ^ ~x3));
  assign z61 = (~new_n75_ & ~x4) | ~x0 | x1 | ~x2 | (~x1 & ~x3);
  assign z62 = (~new_n75_ & ~x4) | ~x0 | ~x1 | ~x2 | (x1 & x3);
  assign z17 = 1'b0;
  assign z20 = 1'b0;
  assign z22 = 1'b0;
  assign z04 = ~z37;
