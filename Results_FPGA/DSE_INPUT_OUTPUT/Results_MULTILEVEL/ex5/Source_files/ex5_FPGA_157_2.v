...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n81_, new_n83_, new_n85_, new_n86_, new_n88_, new_n90_, new_n94_,
    new_n99_, new_n104_, new_n106_, new_n108_, new_n112_, new_n114_,
    new_n115_, new_n118_, new_n123_, new_n125_, new_n126_, new_n128_,
    new_n129_, new_n130_, new_n131_, new_n134_, new_n136_, new_n138_,
    new_n139_, new_n141_, new_n143_, new_n148_, new_n149_, new_n150_,
  ...
  assign z32 = (x2 & (~x3 | ~x4)) | x0 | x1 | (~x2 & (~new_n99_ | x3 | x4));
  ...
  assign z36 = x0 ? x2 : (~new_n118_ | x1 | ~x2 | x3);
  assign new_n118_ = ~x4 & ~x5 & x6 & ~x7;
  assign z37 = ~z11 & (~new_n99_ | ~x3 | x4);
  assign z38 = (x2 & (x0 | ~x3 | ~x4)) | (~x0 & (x1 | (~x2 & (~new_n99_ | x3 | x4))));
  assign z39 = x4 | z11 | ~x3 | x7 | ~x5 | x6;
  assign z40 = (x3 & (x0 ^ ~x2)) | ~new_n123_ | (~new_n115_ & (x0 ? x2 : ~x4));
  ...
  assign z53 = (~new_n148_ & x2) | (~x0 & ((~x2 & ~new_n90_ & ~x3) | (~new_n150_ & x3)));
  ...
  assign z58 = (~new_n160_ & ~x0) | (x2 & ((~new_n90_ & x0) | ~x1 | ~x3));
  assign new_n160_ = new_n161_ & (~x1 | (x2 & (x4 | ~x6)));
  assign new_n161_ = (~x5 | (x1 & x4)) & x3 & (x1 | (~x4 & x6 & x7));
  assign z59 = (~new_n88_ & ~x0) | (x2 & (x0 ? (new_n143_ | (x1 & x3) | (~x1 & ~x3)) : (x1 | x3)));
