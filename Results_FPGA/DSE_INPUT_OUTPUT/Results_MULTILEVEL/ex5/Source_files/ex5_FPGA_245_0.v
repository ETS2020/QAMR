...
module FAU ( 
  ...
  wire new_n75_, new_n77_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    new_n93_, new_n96_, new_n103_, new_n105_, new_n108_, new_n111_,
    new_n113_, new_n115_, new_n117_, new_n118_, new_n119_, new_n122_,
    new_n124_, new_n127_, new_n129_, new_n130_, new_n133_, new_n135_,
    new_n136_, new_n139_, new_n141_, new_n145_, new_n148_, new_n149_,
    new_n150_, new_n152_, new_n154_, new_n157_, new_n160_, new_n161_,
    new_n162_;
  ...
  assign z06 = ~x0 & (~x2 | (new_n83_ & new_n75_ & ~x4));
  ...
  assign z21 = ~x2 & (~x0 | (new_n83_ & new_n75_ & ~x4));
  ...
  assign z40 = (x1 & (~x0 ^ ~x2)) | (~new_n130_ & x0) | (~new_n129_ & x2);
  ...
  assign z43 = (~new_n135_ & ~x4) | (~new_n136_ & x0) | (x2 & ~new_n83_ & x4);
  assign new_n135_ = ((~x6 & ~x7) | (x0 ? ~x5 : ~x2)) & (x0 | ~x2 | x5) & (~x0 | ~x6 | x7);
  assign new_n136_ = ((~x1 & ~x2) | (~x4 & (x5 | x6))) & (~x1 | (x2 & ~x3) | x5);
  assign z44 = (~new_n75_ & (x0 | ~x4)) | ~x0 | (x0 & (x1 | x2 | x3 | x4));
  assign z45 = new_n139_ | x0 | (~x0 & (~x1 | ~x2));
  assign new_n139_ = ~x4 & (x5 | x6);
  assign z47 = (new_n139_ & ~x0) | (~new_n141_ & x0) | ~x1 | ~x2;
  ...
  assign new_n145_ = ((~x5 & ~x6) | (x0 & ~x2)) & (x5 | ~x6) & (~x5 | (x6 & x7));
  ...
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n93_ & (x2 ? ~x3 : x0)) | (new_n152_ & x2) | (x0 & x3);
  assign new_n152_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = (~x4 & ~new_n75_ & (~x0 ^ ~x2)) | (~new_n154_ & x0) | (~x1 & (x2 | (x0 & ~x2)));
  assign new_n154_ = x2 ? (x6 & x7 & ~x4 & x5) : x3;
  assign z56 = x0 | (x2 & (~new_n89_ | new_n83_ | x4));
  assign z57 = (~x1 & (x0 | (x2 & ~x3))) | (~new_n93_ & x2) | (x0 & (new_n157_ | x2 | ~x3));
  assign new_n157_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = (new_n139_ & ~x0) | (~new_n93_ & x0) | ~x1 | ~x2 | ~x3;
  assign z59 = x0 ? (new_n160_ | new_n161_ | ~new_n162_) : (~new_n87_ & x2);
  assign new_n160_ = (~x1 | ~x3) & (~x2 | (~x4 & x6));
  assign new_n161_ = x5 & (~x4 | (x1 & x3));
  assign new_n162_ = x1 ? (~x3 | (x6 & x7 & ~x2 & ~x4)) : x3;
  assign z60 = x0 ? (x3 | ~x4 | (~x1 & (~x2 | ~x3))) : (x2 & (~new_n89_ | x1 | ~x3 | x4));
  assign z61 = x0 ? (new_n139_ | x1 | (~x1 & (~x2 | ~x3))) : x2;
  assign z62 = x0 ? (new_n139_ | ~x1 | (x1 & x3)) : x2;
  assign z07 = 1'b0;
  assign z23 = 1'b0;
  assign z25 = 1'b0;
  assign z29 = 1'b0;
