...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n82_, new_n84_, new_n86_, new_n88_, new_n92_, new_n94_,
    new_n97_, new_n102_, new_n105_, new_n108_, new_n109_, new_n111_,
    ...
    new_n148_, new_n149_, new_n151_, new_n154_, new_n155_, new_n157_,
    new_n158_, new_n160_, new_n161_, new_n162_, new_n164_, new_n165_,
    new_n166_, new_n167_, new_n169_, new_n170_, new_n171_, new_n172_,
    new_n173_, new_n175_, new_n176_, new_n177_, new_n178_, new_n179_,
    new_n180_, new_n183_, new_n185_, new_n187_, new_n189_, new_n190_,
    new_n192_, new_n193_;
  ...
  assign z06 = x2 & ((new_n75_ & new_n82_) | x7);
  assign new_n82_ = ~x0 & ~x1 & x3;
  assign z07 = x7 & new_n84_ & x5 & x6;
  assign new_n84_ = ~x4 & ~x3 & ~x2 & ~x0 & x1;
  assign z11 = new_n86_ & x6 & x7;
  assign new_n86_ = x5 & ~x4 & ~x3 & x0 & x1 & ~x2;
  assign z13 = x7 & (x2 | (new_n88_ & ~x0 & x1 & x3));
  assign new_n88_ = ~x4 & x5 & x6;
  assign z14 = x7 & (x2 | (new_n88_ & x0 & ~x1 & x3));
  ...
  assign z27 = x2 & (new_n105_ | x7);
  assign new_n105_ = ~x4 & ~x5 & x6 & ~x0 & x1 & ~x3;
  ...
  assign z36 = ~new_n123_ | (~z08 & (x1 | x5));
  assign new_n123_ = x2 ? (x7 | (~x4 & x6 & ~x0 & ~x3)) : (x0 & x4);
  assign z37 = ((~x3 | x5) & (~x0 | x2)) | (~x1 & ~x3) | (x3 & (x5 ? x1 : ~new_n125_));
  assign new_n125_ = ~x4 & x6 & ~x7;
  assign z38 = new_n128_ | new_n129_ | (new_n127_ & x0) | x1 | (~new_n130_ & ~x0);
  ...
  assign new_n143_ = ~x4 & ((x2 & (~x5 | (~x0 & x6))) | (~x0 & (x7 | (~x5 & ~x6))) | (x5 & (x6 | x7)));
  ...
  assign z45 = new_n148_ | x0 | (~new_n149_ & ~x1) | (x1 & (~x2 | x7));
  assign new_n148_ = ~x4 & (x5 | (x1 & x6));
  assign new_n149_ = ~x2 & ~x4 & ~x5 & x6 & x7;
  assign z46 = ~new_n151_ | (~x4 & (x5 | (x6 & ~x7)));
  assign new_n151_ = ~x2 & ~x3 & ~x0 & x1;
  assign z48 = (~x4 & ((x5 & ~x7) | (~x2 & (~x5 ^ ~x6)))) | (~new_n82_ & ~x2) | (x2 & ~x7);
  assign z49 = new_n154_ | ~new_n155_;
  assign new_n154_ = ~x4 & (x5 | (x2 & x6));
  assign new_n155_ = (~x0 | (x1 & ~x2 & x3)) & x2 & (~x3 | ~x4) & (~x2 | (~x1 & ~x7));
  assign z50 = new_n157_ | ~new_n158_;
  assign new_n157_ = x0 & (~x1 | ~x3);
  assign new_n158_ = (~x4 | (x2 & ~x3)) & (~x5 | (x2 & x4)) & ~x2 & (x2 | (x6 & x7));
  assign z51 = (~new_n162_ & ~x2) | (~new_n161_ & ~x7) | (~new_n160_ & (~x2 | ~x7));
  assign new_n160_ = x0 ? x1 : (~x1 & (x4 | ~x6));
  assign new_n161_ = (x4 | (~x5 & (~x2 | ~x6))) & (x0 | (x4 ? ~x2 : x3));
  assign new_n162_ = (x0 | (x3 & (x4 | ~x5))) & (~x0 | ~x3) & (x4 | (x5 ^ ~x6));
  assign z52 = (~new_n164_ & (~x2 | ~x7)) | new_n165_ | new_n167_ | (~new_n166_ & ~x2);
  assign new_n164_ = (x0 | (~x1 & (x4 | ~x6))) & (x4 | ~x5) & (~x0 | ~x3);
  assign new_n165_ = ~x0 & ((~x2 & ~x3) | (x4 & ~x7 & x2 & x3));
  assign new_n166_ = (~x0 | x1) & (x4 | x5 | ~x6);
  assign new_n167_ = x2 & ~x4 & x6 & ~x7;
  assign z53 = ((new_n169_ | new_n170_) & ~x3) | (~new_n171_ & ~new_n172_) | new_n173_;
  assign new_n169_ = x0 & (~x7 | (x1 & ~x2));
  assign new_n170_ = ~x2 & (x4 | ~x5 | ~x6 | ~x7);
  assign new_n171_ = x7 & (x2 | ~x3);
  assign new_n172_ = x1 & (x4 | (~x5 & ~x6));
  assign new_n173_ = ~x0 & x2 & x3 & ~x7;
  assign z54 = new_n177_ | new_n178_ | new_n179_ | new_n175_ | (~new_n176_ & ~new_n180_);
  assign new_n175_ = x0 & x3;
  assign new_n176_ = ~x4 & x5 & x6 & x7;
  assign new_n177_ = ~x4 & (x5 | x6) & (x2 | (~x0 & ~x3));
  assign new_n178_ = ~x1 & (x2 | ~x3);
  assign new_n179_ = x2 & (~x3 | x7);
  assign new_n180_ = ~x0 & (x2 | ~x3);
  assign z55 = (x0 & (x2 ? ~x7 : ~x3)) | (~new_n172_ & (~x2 | ~x7));
  assign z56 = ~new_n183_ | (~z08 & (~x1 | (~x4 & x5)));
  assign new_n183_ = (x2 | (~x0 & x3)) & (x7 | (~x2 & (x4 | ~x6)));
  assign z57 = (~new_n185_ & ~x2) | (x2 & ~x7) | (~x4 & ((x6 & ~x7) | (x5 & (~x2 | ~x7))));
  assign new_n185_ = x1 & (x0 | ~x3) & (~x0 | x3);
  assign z58 = ~new_n187_ | ((x0 | ~x3) & (~x2 | (x2 & ~x7)));
  assign new_n187_ = (x7 | ((x4 | (~x5 & ~x6)) & x2 & (x1 | ~x2))) & (x2 | (~x5 & x6 & ~x1 & ~x4));
  assign z59 = (~x2 & (new_n157_ | ~new_n189_)) | new_n154_ | (x2 & (~new_n157_ | ~new_n190_));
  ...
  assign z61 = ~x2 | (~x7 & (new_n127_ | ~x0 | x1 | (~x1 & ~x3)));
  assign z62 = ((new_n127_ | ~x0 | ~x1) & (~x2 | ~x7)) | (x3 & (~x2 | (x1 & ~x7)));
  assign z10 = 1'b0;
  assign z26 = 1'b0;
  assign z28 = 1'b0;
  assign z33 = 1'b1;
  ...
  assign z15 = z08;
  assign z30 = z08;
  assign z47 = new_n148_ | x0 | (~new_n149_ & ~x1) | (x1 & (~x2 | x7));
endmodule
