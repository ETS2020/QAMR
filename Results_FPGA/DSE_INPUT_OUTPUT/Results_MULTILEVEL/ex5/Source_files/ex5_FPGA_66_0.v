...
module FAU ( 
  ...
  assign new_n137_ = (~x5 | (x1 & x4)) & ~x0 & (x1 | (new_n89_ & ~x2 & ~x4));
  assign new_n138_ = ~x4 & x6;
  assign z46 = x2 | x0 | ~x1 | ~x5 | x3 | ~x4;
  assign z47 = (~new_n141_ & x3) | (x5 & (x0 ? ~x3 : ~new_n142_));
  assign new_n141_ = (~x1 | (x2 & (~new_n138_ | x0))) & (new_n87_ | (~x0 & x1)) & (x1 | (~x0 & ~x2)) & (~x0 | (x2 & x5));
  assign new_n142_ = x1 & x2 & x4;
  assign z48 = ~new_n83_ | ~new_n95_ | (~x4 & (x5 ? (~x6 | ~x7) : x6));
  assign z49 = (~new_n83_ & (x5 | (x2 & x3))) | ~new_n145_ | (~x2 & (x3 | x5));
  assign new_n145_ = (x4 | ~x5) & (~x3 | (~new_n98_ & ~x4 & (~x2 | ~x6)));
  assign z50 = x5 | (x3 & ((~new_n89_ & ~x2) | new_n98_ | x2 | x4));
  assign z51 = ~new_n148_ | (~z09 & (~x0 ^ ~x1));
  assign new_n148_ = (~x2 | ((x4 | ~x5) & (x0 | ~x3 | ~x4))) & (new_n149_ | x4) & (~x0 | x2 | ~x3) & (x0 | x3 | ~x5);
  assign new_n149_ = (x0 | (~x5 & (~x3 | ~x6))) & (~x3 | x5 | ~x6) & (~x5 | (x6 & x7));
  assign z52 = ~new_n151_ | (x0 & (x3 | (~x1 & ~x2 & x5)));
  assign new_n151_ = (new_n152_ | x0) & (x4 | (~x5 & (~x3 | x5 | ~x6)));
  assign new_n152_ = (~x1 | (~x3 & ~x5)) & (~x3 | (x4 ? ~x2 : ~x6)) & (x2 | x3 | ~x5);
  assign z53 = (x1 & (x0 ? (~x3 & x5) : (x2 & x3))) | ~new_n154_ | (x0 & ((x2 & ~x3 & x5) | (~x1 & x3)));
  assign new_n154_ = (new_n156_ | ~x3) & (new_n155_ | ~x5);
  assign new_n155_ = x3 ? (x4 | (x2 & x6 & x7)) : (x2 ? (x1 & x4) : (~x4 & x6 & x7));
  assign new_n156_ = ((x2 & x5) | (x1 & (x4 | ~x6))) & (x1 | (~x4 & x6 & x7));
  assign z54 = (x2 & (x3 ? ~x1 : x4)) | (~x1 & (x0 | (~x3 & x4))) | ~new_n158_ | (x0 & (x3 | x4));
  assign new_n158_ = new_n159_ & (new_n89_ | ((x2 | ~x3) & (x4 | (x3 & ~x5))));
  assign new_n159_ = (x3 | (x5 & (x0 | x2 | x4))) & (x2 | (x5 & (~x3 | ~x4))) & (x4 | x5 | ~x6);
  assign z55 = ~new_n162_ | (~new_n161_ & (~x0 | ~x2));
  assign new_n161_ = ~new_n81_ & (~x3 | (~new_n138_ & x1));
  assign new_n162_ = (~x5 | ((x1 | (x0 & ~x2)) & (~x0 | (x2 ? new_n87_ : x3)))) & (~x3 | x5 | ~x0 | ~x2);
  assign z56 = ~new_n164_ | (x0 & (x2 ? x5 : x3));
  assign new_n164_ = (new_n165_ | x2) & (~x3 | (x1 & (~x2 | x5))) & (~x2 | new_n87_ | ~x5);
  assign new_n165_ = (x3 | ~x5) & (x4 | (~x5 & (~x3 | ~x6 | x7)));
  assign z57 = new_n167_ | ~new_n168_ | (~x1 & (x3 ? x0 : x5));
  assign new_n167_ = ~x2 & (x3 ? ~x0 : new_n81_);
  assign new_n168_ = (new_n87_ | ((~x2 | x3 | ~x5) & (x0 | ~x3))) & ~new_n169_ & (~x0 | (x3 ? ~x2 : ~x5)) & (x0 | ~x3 | x5);
  assign new_n169_ = ~x4 & ((x0 & x5) | (x3 & x6 & ~x7));
  assign z58 = ~new_n171_ | new_n172_;
  assign new_n171_ = (~x5 | (x1 & x3)) & (~x3 | ((x2 | (~x0 & ~x1)) & (new_n87_ | (~x0 & x1)) & (x1 | ~x2) & (~x0 | (x1 & x5))));
  ...
  assign z60 = ~new_n177_ | ((x3 | (~x0 & ~x3)) & (~new_n89_ | x1 | x4));
  assign new_n177_ = (~x0 | ((x1 | (x2 & x3)) & ~x3 & (x3 | x4))) & (x0 | ~x2 | x3) & x5 & (x2 | ~x3);
  assign z61 = (~x0 & (x3 | x5)) | (~x4 & (x5 | (x3 & x6))) | (~x3 & x5) | (~new_n93_ & x3);
