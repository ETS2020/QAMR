...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n77_, new_n83_, new_n85_, new_n88_, new_n90_, new_n99_,
  ...
  assign z21 = ~x2 & (~x0 | (new_n99_ & new_n75_ & ~x4));
  ...
  assign z43 = (~new_n137_ & ~x4) | (~new_n138_ & x0) | (x2 & ~new_n99_ & x4);
  ...
  assign z45 = new_n141_ | x0 | (~x0 & (~x1 | ~x2));
  assign new_n141_ = ~x4 & (x5 | x6);
  assign z46 = x2 | (~new_n143_ & x0);
  assign new_n143_ = x2 & x3 & ~x4 & x5 & x6 & x7;
  assign z47 = (~new_n143_ & x0) | (x2 & (~x1 | (new_n141_ & ~x0)));
  assign z49 = (~new_n75_ & ~x4) | x0 | x1 | ~x2 | (x3 & x4);
  assign z50 = x2 | (~new_n147_ & x0);
  assign new_n147_ = x1 & x3 & ~x4 & ~x5 & x6 & x7;
  assign z51 = (~x1 & (x0 | ~x2)) | (~new_n149_ & ~x4) | (~x2 & (~x0 | x3)) | (~x0 & (x1 | ~x3 | x4));
  assign new_n149_ = ((x0 & ~x2) | (~x5 & ~x6)) & (x5 | ~x6) & (~x5 | (x6 & x7));
  ...
  assign z60 = x0 ? (x3 | ~x4 | (~x1 & (~x2 | ~x3))) : (x2 & (~new_n90_ | x1 | ~x3 | x4));
