...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n81_, new_n83_, new_n84_, new_n87_, new_n90_, new_n92_, new_n94_,
    new_n99_, new_n101_, new_n103_, new_n105_, new_n108_, new_n110_,
    new_n114_, new_n116_, new_n117_, new_n124_, new_n126_, new_n128_,
    ...
    new_n162_, new_n164_, new_n165_, new_n167_, new_n169_;
  ...
  assign z06 = (x0 & ~x2) | (~x0 & ~x1 & x2 & new_n81_ & x3 & ~x4);
  ...
  assign z10 = (x0 & ~x2) | (~x0 & x1 & x2 & new_n84_ & ~x4 & x5);
  ...
  assign z31 = (x2 & (~x3 | ~x5)) | (~x2 & (x3 | (x4 & ~x5))) | x0 | x1 | ~x4;
  assign z32 = (x2 & (~x3 | ~x4)) | (~x2 & (x3 | x4)) | (~new_n101_ & ~x4) | x0 | x1;
  assign z33 = ~new_n114_ | ~x7 | x4 | ~x6;
  assign new_n114_ = new_n103_ & (x1 | ~x5) & (~x1 | ~x3 | x5);
  ...
  assign z38 = (x2 & (x0 | ~x3 | ~x4)) | (~x0 & (x1 | (~x2 & (~new_n101_ | x3 | x4))));
  ...
  assign new_n126_ = ~x4 & (x5 | (x0 & ~x1 & new_n84_ & x3));
  ...
  assign z47 = (~new_n139_ & (x0 ^ ~x2)) | (~new_n138_ & ~x0) | (~new_n140_ & x2);
  assign new_n138_ = (x2 | (~x1 & ~x5)) & (x4 | new_n84_ | ~x5);
  assign new_n139_ = ~x4 & x6 & x7;
  assign new_n140_ = (~x0 | (x3 & x5)) & x1 & (x0 | x4 | (~x5 & ~x6));
  assign z48 = x2 | (~x0 & ((~new_n142_ & ~x4) | ~x3 | (x1 & ~x2)));
  assign new_n142_ = x5 ? (x6 & x7) : ~x6;
  assign z49 = (~new_n81_ & ~x4) | x0 | x1 | ~x2 | (x3 & x4);
  assign z50 = x2 | (~x0 & (~new_n84_ | x4 | x5));
  assign z51 = (~x0 & ((~x3 & (~x2 | ~x4)) | (~new_n81_ & ~x4) | x1 | (x2 & x4))) | (x2 & ((~new_n81_ & ~x4) | (x0 & ~x1)));
  assign z52 = (x0 & (~x2 | x3)) | (~new_n81_ & ~x4) | (~x0 & (x1 | (~x2 & ~x3) | (x2 & x3 & x4)));
  assign z53 = (~new_n149_ & ~x0) | (x2 & ((x0 & (~x1 | ~x3)) | new_n148_ | (~x1 & ~x3) | (~x0 & x1 & x3)));
  assign new_n148_ = ~x4 & ((~new_n81_ & ~x3) | (~new_n142_ & x1));
  assign new_n149_ = (new_n150_ | ~x3) & (x2 | x3 | (new_n84_ & ~x4 & x5));
  ...
  assign z55 = (~new_n155_ & ~x4) | ~x1 | (x0 & (~new_n83_ | ~x2 | x4));
  assign new_n155_ = (x0 | (~x5 & ~x6)) & (x2 | ~x5) & (~x6 | x7);
  assign z56 = (~x1 & (~x2 | x3)) | ~new_n157_ | (~x2 & (~x3 | (~x4 & x5)));
  assign new_n157_ = (x7 | (~x2 & (x4 | ~x6))) & ~x0 & (~x2 | (~x4 & x5 & x6));
  assign z57 = (~new_n159_ & x2) | (~x0 & (~new_n160_ | (~x1 & (~x2 | ~x3))));
  assign new_n159_ = ~x0 & ~x4 & new_n84_ & x5;
  assign new_n160_ = (x2 | (~x3 & (x4 | ~x5))) & (x4 | ~x6 | x7);
  assign z58 = ~new_n162_ | (~x0 & ~x4 & (x5 | (x1 & x6)));
  assign new_n162_ = (x2 | (~x0 & ~x1)) & (new_n139_ | (~x0 & x1)) & (~x0 | (x1 & x5)) & x3 & (x1 | (~x2 & ~x5));
  ...
  assign z61 = new_n169_ | ~x0 | x1 | ~x2 | (~x1 & ~x3);
  assign new_n169_ = ~new_n81_ & ~x4;
  assign z62 = new_n169_ | ~x0 | ~x1 | ~x2 | (x1 & x3);
  assign z16 = 1'b0;
  assign z20 = 1'b0;
  assign z21 = 1'b0;
  assign z41 = ~z11;
