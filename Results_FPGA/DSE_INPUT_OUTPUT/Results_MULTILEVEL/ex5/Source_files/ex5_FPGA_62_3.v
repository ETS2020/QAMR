...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n79_, new_n82_, new_n84_, new_n86_, new_n88_, new_n91_, new_n94_,
    new_n97_, new_n99_, new_n106_, new_n108_, new_n111_, new_n114_,
    ...
    new_n155_, new_n157_, new_n159_, new_n161_, new_n163_, new_n167_,
  ...
  assign z12 = x2 & (x3 | (new_n91_ & x0 & ~x1 & ~x4));
  ...
  assign z19 = (x2 & x3) | (new_n99_ & ~x2 & ~x3 & x4);
  ...
  assign z24 = (x2 & x3) | (new_n79_ & new_n99_ & ~x2 & ~x3);
  assign z25 = ~x7 & new_n106_ & x6;
  assign new_n106_ = ~x5 & ~x4 & ~x3 & ~x2 & ~x0 & x1;
  assign z26 = x2 & (x3 | (x0 & ~x4 & new_n108_ & ~x5));
  ...
  assign z32 = (~x4 & (x5 | (~new_n116_ & x0))) | (x4 & (~x0 | ~x5)) | ~new_n118_ | (~new_n117_ & ~x0);
  ...
  assign z39 = (x5 & (~x3 | x6 | x7)) | ~new_n135_ | (~x5 & (~new_n97_ | ~x6 | ~x7));
  ...
  assign z43 = x2 ? new_n145_ : ((~new_n143_ & (x4 | ~x5)) | (~new_n144_ & ~x4));
  assign new_n143_ = ~x1 & (x0 | ~x3);
  assign new_n144_ = (x0 | (~x7 & (x5 | x6))) & (~x5 | (~x6 & ~x7)) & (~x0 | ~x6 | x7);
  assign new_n145_ = ~x3 & (((x6 | x7) & (~x0 | x5)) | x4 | (~x5 & (~x0 | ~x6 | ~x7)));
  assign z44 = (~new_n147_ & ~x2) | (~x3 & (x2 | (~x4 & x5)));
  assign new_n147_ = (~x3 | (~x0 & ~x4)) & (x4 | (x0 & ~x5)) & ~x1 & (~x0 | (~x4 & ~x5 & ~x6));
  assign z45 = (x0 & (~x2 | (x2 & ~x3))) | (~new_n149_ & ~x2) | (~new_n150_ & ~x3);
  assign new_n149_ = ~x1 & ~x4 & (x4 | (~x5 & (x0 | (x6 & x7))));
  assign new_n150_ = (x4 | ~x5) & (~x2 | (x1 & (x4 | ~x6)));
  assign z46 = x2 ? ~x3 : (new_n152_ | x0 | ~x1 | x3);
  assign new_n152_ = ~x4 & (x5 | (x6 & ~x7));
  assign z47 = new_n154_ | (x1 & (~x2 | x3)) | x0 | (~new_n155_ & ~x1);
  assign new_n154_ = ~x4 & (x5 | (x1 & x6));
  assign new_n155_ = ~x2 & ~x4 & ~x5 & x6 & x7;
  assign z48 = ~x3 | (~new_n157_ & ~x2);
  assign new_n157_ = ~x0 & ~x1 & (x4 | (x5 ? (x6 & x7) : ~x6));
  assign z49 = ~x2 | (~x3 & (~new_n99_ | new_n159_));
  assign new_n159_ = ~x4 & (x5 | x6);
  assign z50 = (x0 & ((~x1 & ~x2) | ~x3)) | (~new_n161_ & ~x2) | (x2 & ~x3);
  assign new_n161_ = ~x4 & ~x5 & x6 & x7;
  assign z51 = (~x2 & (~new_n163_ | (x0 & (~x1 | x3)))) | (~x3 & (~x0 | ~x1 | (new_n159_ & x2)));
  assign new_n163_ = (x0 | ~x1) & (x4 | ((x5 | ~x6) & (~x5 | (x6 & x7)) & (x0 | (~x5 & ~x6))));
  assign z52 = (x0 & ((~x1 & ~x2) | x3)) | (~x0 & (x1 | (~x2 & ~x3))) | new_n159_ | (x2 & x3);
  assign z53 = (x0 & (x2 | (x1 & ~x3))) | ((x2 | x3) & (new_n159_ | ~x1)) | (x2 & x3) | (~x2 & ~new_n82_ & ~x3);
  assign z54 = (~x3 & (new_n97_ | new_n168_ | (~new_n167_ & ~x2))) | (~x2 & ~new_n169_ & x3);
  ...
  assign new_n171_ = ~x4 & (x5 | x6) & (~x0 | x3);
  ...
  assign z57 = (~x1 & (~x2 | ~x3)) | (~x2 & (new_n152_ | (~x0 & x3))) | (~x3 & (x0 | (~new_n82_ & x2)));
  assign z58 = ~new_n161_ | ~new_n99_ | x2 | ~x3;
  assign z59 = (~new_n161_ & (~x0 | ~x2)) | new_n179_ | (x0 & (~x1 | (~x2 & ~x3))) | (x2 & (x3 | (~x0 & x1)));
  assign new_n179_ = ~x4 & (x5 | (x0 & x2 & x6));
  assign z60 = x3 ? ~x2 : (x0 ? (~x1 | ~x4) : (~new_n91_ | x1 | x2 | x4));
  assign z62 = ~x0 | x3 | (x0 & ~x3 & (new_n159_ | ~x1));
  assign z15 = 1'b0;
  assign z18 = 1'b0;
  assign z28 = 1'b0;
  assign z61 = 1'b1;
