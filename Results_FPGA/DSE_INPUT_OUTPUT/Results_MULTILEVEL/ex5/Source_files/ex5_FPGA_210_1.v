...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n77_, new_n78_, new_n82_, new_n84_, new_n87_, new_n89_, new_n91_,
    new_n93_, new_n98_, new_n100_, new_n102_, new_n106_, new_n108_,
    ...
    new_n155_, new_n157_, new_n160_, new_n162_, new_n168_;
  ...
  assign z08 = x2 & (~x0 | (new_n84_ & new_n77_ & x1));
  assign z11 = x7 & new_n87_ & x6;
  assign new_n87_ = x5 & ~x4 & ~x3 & ~x2 & x0 & x1;
  assign z12 = x7 & x6 & x5 & ~x4 & new_n89_ & ~x3;
  assign new_n89_ = x2 & x0 & ~x1;
  assign z13 = ~x0 & (x2 | (new_n84_ & new_n91_ & x1));
  ...
  assign z24 = ~x0 & (x2 | (new_n77_ & ~x1 & new_n82_ & ~x5));
  assign z25 = ~x7 & new_n106_ & x6;
  assign new_n106_ = ~x5 & ~x4 & ~x3 & ~x2 & ~x0 & x1;
  assign z26 = x2 & (~x0 | (new_n77_ & new_n108_ & ~x5));
  ...
  assign z34 = (~x0 & (x2 | ~x5)) | (~new_n124_ & ~x5) | (x5 & (~new_n78_ | ~new_n91_));
  ...
  assign z44 = (~new_n146_ & ~x2) | (x0 & (~new_n98_ | x3 | x4)) | x2 | (~x0 & ~x4);
  assign new_n146_ = (~x1 | (x5 & (x0 | ~x4))) & (x4 | ~x5 | ~x6) & (x0 | ~x3 | (~x4 & x5));
  assign z45 = x0 | (~x2 & (x1 | x4 | ~new_n108_ | x5));
  ...
  assign z53 = x3 ? (new_n160_ | (~x1 & (x0 | ~x2))) : ((x0 & (x1 | x2)) | (~new_n93_ & ~x2));
  assign new_n160_ = ~x4 & ((x0 & (x5 ? (~x6 | ~x7) : x6)) | (~x2 & (x5 | x6)));
  assign z54 = (~x1 & (x0 | ~x3)) | (~x0 & (x2 | (new_n162_ & ~x3))) | (x0 & x3) | (~new_n93_ & (x0 | x3));
  assign new_n162_ = ~x4 & (x5 | x6);
  assign z55 = (~x1 & (x0 | ~x2)) | (~x2 & (new_n162_ | (x0 & ~x3))) | (x0 & ~new_n93_ & x2);
  assign z56 = new_n149_ | x2 | ~x3 | x0 | ~x1;
  assign z57 = ((x0 | ~x2) & (new_n149_ | ~x1)) | (x0 & (x2 | ~x3)) | (~x0 & ~x2 & x3);
  assign z58 = (x0 & (~x1 | ~x2 | ~x5)) | ~new_n108_ | ~new_n91_ | (~x0 & (x1 | x2 | x5));
  assign z59 = (~x2 & (~new_n102_ | (x0 & (~x1 | ~x3)))) | new_n168_ | (x2 & (~x0 | (~x1 & ~x3) | (x1 & x3)));
