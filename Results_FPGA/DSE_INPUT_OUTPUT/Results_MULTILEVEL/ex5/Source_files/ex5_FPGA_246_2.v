...
module FAU ( 
  ...
  wire new_n81_, new_n83_, new_n85_, new_n87_, new_n88_, new_n90_, new_n92_,
    new_n94_, new_n96_, new_n101_, new_n104_, new_n107_, new_n113_,
    new_n115_, new_n116_, new_n119_, new_n124_, new_n126_, new_n127_,
  ...
  assign new_n113_ = ~x4 & (x1 | ~x5) & new_n88_ & (~x1 | ~x3 | x5);
  ...
  assign z36 = (~x0 & (x1 | ~x2 | x3)) | (x2 & (x0 | (~new_n119_ & ~x3)));
  assign new_n119_ = new_n87_ & x6 & ~x7;
  ...
  assign new_n154_ = x3 ? (x6 & x7 & ~x4 & x5) : (x1 & (x4 | (~x5 & ~x6)));
  assign z55 = (~x1 & (x2 | (~x0 & ~x2))) | (new_n144_ & ~x0) | (x0 & ~new_n90_ & x2);
  assign z56 = (~x1 & (x2 ? x3 : ~x0)) | (~new_n157_ & x2) | (~x0 & ~x2 & (new_n137_ | ~x3));
  assign new_n157_ = ~x0 & ~x4 & new_n88_ & x5;
  assign z57 = (~x1 & (~x2 | ~x3)) | ~new_n159_ | (~x2 & (x3 | (~x4 & x5)));
  assign new_n159_ = (x7 | (~x2 & (x4 | ~x6))) & ~x0 & (~x2 | (~x4 & x5 & x6));
  assign z58 = (~new_n161_ & ~x0) | (x2 & (~x1 | ~x3 | (~new_n90_ & x0)));
  ...
  assign new_n164_ = x0 ? (~new_n144_ & (x1 | x3)) : new_n165_;
  assign new_n165_ = ~x4 & ~x5 & x6 & x7 & (~x2 | ~x3 | x5);
  assign z60 = ~new_n168_ | (~x0 & (~new_n167_ | (x1 & (x2 | x5))));
  assign new_n167_ = new_n88_ & x5 & ~x4 & (~x2 | x3 | ~x5);
  assign new_n168_ = (x2 | (~x0 & (~x3 | ~x5))) & (~x0 | (x1 & x4 & (~x1 | ~x3)));
  assign z61 = new_n144_ | ~x0 | x1 | ~x2 | (~x1 & ~x3);
  assign z62 = new_n144_ | ~x0 | ~x1 | ~x2 | (x1 & x3);
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z21 = 1'b0;
  assign z41 = ~z11;
