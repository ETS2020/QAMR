...
module FAU ( 
  ...
  wire new_n76_, new_n81_, new_n82_, new_n84_, new_n86_, new_n88_, new_n90_,
    new_n92_, new_n94_, new_n97_, new_n101_, new_n106_, new_n109_,
    new_n112_, new_n115_, new_n117_, new_n118_, new_n120_, new_n122_,
    new_n123_, new_n127_, new_n129_, new_n131_, new_n132_, new_n134_,
  ...
  assign z14 = ~x1 & (x2 | (new_n94_ & x0 & x3 & ~x4));
  assign new_n94_ = x5 & x6 & x7;
  assign z15 = x7 & x6 & x5 & ~x4 & new_n88_ & x3;
  assign z16 = (~x1 & x2) | (new_n97_ & x0 & x1 & ~x2 & x3);
  ...
  assign z22 = x7 & x6 & ~x5 & new_n101_ & ~x4;
  assign z23 = ~x1 & (x2 | (~x0 & x3 & x5));
  assign z24 = ~x1 & (x2 | (new_n106_ & ~x0 & new_n82_ & ~x5));
  assign new_n106_ = ~x3 & ~x4;
  assign z25 = ~x7 & x6 & new_n84_ & ~x5;
  assign z26 = x2 & (new_n109_ | ~x1);
  assign new_n109_ = x0 & ~x3 & ~x4 & ~x5 & x6 & x7;
  assign z27 = x2 & (~x1 | (new_n106_ & ~x0 & new_n82_ & ~x5));
  ...
  assign z39 = (~new_n131_ & (x1 | (~x2 & x5))) | (x1 & (x4 | ~x5)) | (~x2 & (x4 | (~new_n132_ & ~x5)));
  assign new_n131_ = x3 & ~x6 & ~x7;
  assign new_n132_ = x0 & x6 & x7;
  assign z40 = (~new_n109_ & x1) | (~x2 & (new_n134_ | new_n135_ | new_n81_ | x1));
  assign new_n134_ = x0 & (x4 ? ~x5 : x6);
  assign new_n135_ = ~x0 & (x3 | (~x4 & (~x6 | x7)));
  assign z41 = (~x1 & (~x3 | ~x5)) | ~x0 | x2 | (x1 & x3);
  assign z42 = ~new_n138_ | (x2 & (~x1 | ~x5));
  ...
  assign new_n141_ = x3 & (~x0 | x1);
  assign new_n142_ = (x0 | (~x1 & (x4 | x6))) & (~x1 | (x2 & x6 & x7));
  assign new_n143_ = (x1 | ~x4) & (x6 | x7);
  assign new_n144_ = ~x1 & (x2 | (~x4 & (x0 ? (x6 & ~x7) : x7)));
  assign z44 = (x4 & (x0 | (~x0 & x3))) | (~x0 & (~x4 | (x3 & ~x5))) | ~new_n146_ | (x5 & (x0 | (~new_n76_ & ~x4)));
  assign new_n146_ = (~x0 | (~x3 & ~x6)) & ~x1 & (x1 | ~x2);
  assign z45 = ~new_n148_ | (~z06 & x0);
  assign new_n148_ = (~x1 | (x2 & (~x2 | x4 | (~x5 & ~x6)))) & (x2 | (x6 & x7 & ~x4 & ~x5));
  assign z46 = (x0 & (x1 | ~x2)) | (x1 & x2) | (~x2 & (new_n150_ | ~x1 | x3));
  ...
  assign new_n160_ = ~x4 & ((~x5 & x6) | (x5 & (~x6 | ~x7)) | ((~x0 | x2) & (x5 | x6)));
  assign z52 = (x0 & (~x1 | x3)) | ~new_n163_ | (x2 & (new_n162_ | ~x0));
  assign new_n162_ = ~x4 & x6;
  assign new_n163_ = (x4 | (~x5 & (~x6 | (x0 & x5)))) & (x0 | (~x1 & x3));
  assign z53 = (~x3 & (~new_n165_ | (x0 & (x1 | x2)))) | (~x1 & (x2 | x3)) | (x3 & (new_n166_ | (~x0 & x2)));
  assign new_n165_ = x2 ? (x4 | (~x5 & ~x6)) : (x6 & x7 & ~x4 & x5);
  assign new_n166_ = ~x4 & ((~x5 & x6) | (x5 & (~x6 | ~x7)) | (~x2 & (x5 | x6)));
  assign z54 = ((new_n168_ | ~new_n169_) & ~x2) | (x1 & (new_n170_ | ~new_n171_));
  assign new_n168_ = ~x3 & (~x1 | (~x0 & ~x4 & (x5 | x6)));
  assign new_n169_ = (~x0 | ~x3) & ((~x0 & ~x3) | (~x4 & x5 & x6 & x7));
  assign new_n170_ = (~x6 | ~x7) & (x3 ? (~x4 & x5) : x2);
  assign new_n171_ = (~x2 | x3 | (~x4 & x5)) & (~x3 | (~x0 & (x4 | x5 | ~x6)));
  assign z55 = new_n173_ | (~x2 & (~x1 | (x0 & ~x3))) | (x0 & x1 & ~new_n97_ & x2);
  assign new_n173_ = ~x4 & (~x2 | (~x0 & x1)) & (x5 | x6);
  assign z56 = (~x2 & (new_n81_ | ~x3)) | ~new_n175_ | (~x7 & (new_n162_ | x2));
  assign new_n175_ = ~x0 & x1 & (~x2 | (~x4 & x5 & x6));
  assign z57 = (~x2 & (new_n81_ | (~x0 & x3))) | new_n177_ | ~new_n178_ | (x0 & (x2 | ~x3));
  assign new_n177_ = ~x4 & ((x6 & ~x7) | (x0 & x5));
  assign new_n178_ = x1 & (~x2 | (~x4 & x5 & x6 & x7));
  assign z58 = new_n152_ | new_n153_ | ~new_n180_ | (~x2 & (x0 | x1));
  assign new_n180_ = (~x0 | (x1 & x5)) & x3 & (x1 | (~x2 & ~x5));
  assign z59 = (~new_n184_ & x1) | ((new_n182_ | ~new_n183_) & ~x2);
  assign new_n182_ = x0 & (~x1 | (x1 & ~x3 & ~x4));
  assign new_n183_ = ~x4 & (x1 | ~x5) & ((x6 & x7) | (x1 & (~x1 | x4)));
  assign new_n184_ = ((x0 & ~x3) | (~x2 & ~x4)) & (x4 | (~x5 & (~x2 | ~x6)));
  assign z60 = x1 ? (~x4 | ((~x0 | x3) & (x2 | x4))) : (~x2 & (~new_n94_ | x0 | x3 | x4));
