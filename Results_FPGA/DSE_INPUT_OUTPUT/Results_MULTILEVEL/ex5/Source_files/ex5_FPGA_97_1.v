...
module FAU ( 
  ...
  wire new_n75_, new_n80_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    new_n93_, new_n95_, new_n103_, new_n106_, new_n108_, new_n111_,
  ...
  assign z34 = new_n122_ | (~new_n124_ & x5) | (~new_n123_ & ~x5);
  assign new_n122_ = ~x0 & (x2 | ~x5);
  ...
  assign z38 = new_n130_ | new_n131_ | x1 | x2;
  assign new_n130_ = ~x4 & (x5 | (x0 & (~x3 | x6)));
  assign new_n131_ = ~x0 & (x3 | x4 | x5 | ~x6 | x7);
  assign z39 = new_n122_ | ~new_n133_ | (x5 & (~x3 | x6 | x7));
  assign new_n133_ = ~x4 & (x5 | (~x1 & ~x2 & x6 & x7));
  ...
  assign z42 = new_n122_ | (x5 & (x6 | x7)) | x4 | (~x5 & (~new_n139_ | ~x6 | ~x7));
  ...
  assign z44 = (~new_n147_ & ~x2) | (x0 & (~new_n75_ | x3 | x4)) | x2 | (~x0 & ~x4);
  assign new_n147_ = (~x1 | (x5 & (x0 | ~x4))) & (x4 | ~x5 | ~x6) & (x0 | ~x3 | (~x4 & x5));
  assign z45 = x0 | (~x2 & (~new_n149_ | x5 | x1 | x4));
  ...
  assign z53 = x3 ? (new_n163_ | (~x1 & (x0 | ~x2))) : ((~new_n87_ & ~x2) | (x0 & (x1 | x2)));
  assign new_n163_ = ~x4 & ((x0 & (x5 ? (~x6 | ~x7) : x6)) | (~x2 & (x5 | x6)));
  assign z54 = (~new_n85_ & x0) | (~x2 & (x3 ? ~new_n87_ : ~new_n165_));
  ...
  assign z58 = (x0 & (~x1 | ~x2 | ~x5)) | ~new_n80_ | ~new_n149_ | (~x0 & (x1 | x2 | x5));
  assign z59 = (~x2 & (~new_n158_ | (x0 & (~x1 | ~x3)))) | new_n173_ | (x2 & (~x0 | (~x1 & ~x3) | (x1 & x3)));
  assign new_n173_ = ~x4 & (x5 | (x2 & x6));
  assign z60 = (x3 & (x0 | ~x2)) | (x0 & (~x1 | ~x4)) | (~x0 & ~x2 & (~new_n89_ | x1 | x4));
  assign z61 = (~x1 & (~x2 | (x0 & ~x3))) | (~x0 & ~x2) | (x0 & (x1 | (~new_n75_ & ~x4)));
  assign z62 = (~x1 & (x0 | ~x2)) | (~x0 & ~x2) | (x0 & ((~new_n75_ & ~x4) | (x1 & x3)));
  assign z10 = 1'b0;
  assign z15 = 1'b0;
  assign z27 = 1'b0;
  assign z09 = z06;
