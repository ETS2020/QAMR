...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n78_, new_n79_, new_n83_, new_n84_, new_n86_, new_n88_, new_n90_,
    new_n93_, new_n96_, new_n98_, new_n102_, new_n105_, new_n107_,
    new_n109_, new_n112_, new_n114_, new_n116_, new_n118_, new_n120_,
    new_n121_, new_n122_, new_n125_, new_n127_, new_n129_, new_n131_,
  ...
  assign z03 = z07 | (new_n78_ & new_n79_ & x5);
  assign new_n78_ = x3 & ~x4;
  assign new_n79_ = ~x6 & ~x7;
  assign z04 = x3 & ~x4 & ~x5 & x6 & ~z07 & ~x7;
  assign z05 = ~x4 & x5 & x6 & ~z07 & ~x7;
  assign z06 = ~x0 & (~x2 | (new_n83_ & new_n84_));
  ...
  assign z14 = ~x2 & (~x0 | (new_n90_ & new_n78_ & ~x1));
  ...
  assign z30 = (~x0 & ~x2) | (new_n112_ & x0 & x1 & x2 & ~x3);
  assign new_n112_ = ~x4 & ~x5 & x6 & x7;
  assign z31 = (x0 & (x2 | (x4 & ~x5))) | ~new_n114_ | (~x4 & (~x0 | x5 | x6));
  assign new_n114_ = ~x1 & (x0 | (x2 & x3 & x5));
  assign z32 = (x0 & (x2 | (x4 & ~x5))) | (~x3 & (~x0 | ~x4)) | ~new_n116_ | (~x0 & (~x2 | ~x4));
  assign new_n116_ = ~x1 & (x4 | (~x5 & ~x6));
  assign z33 = ~new_n118_ | ~x7 | x4 | ~x6;
  assign new_n118_ = x0 & x2 & (x1 | ~x5) & (~x1 | ~x3 | x5);
  assign z34 = new_n120_ | new_n122_ | (~new_n121_ & x2);
  assign new_n120_ = x1 & (x0 ? ~x5 : (x2 & ~x3));
  assign new_n121_ = (~x3 | (x5 & (x0 | ~x6))) & (x3 | (~x5 & (x0 | x6))) & (~x0 | x5) & (x0 | (~x4 & ~x7));
  assign new_n122_ = x0 & ((~x4 & ~x5 & (~x6 | ~x7)) | (x5 & (x6 | x7 | ~x3 | x4)));
  ...
  assign z38 = (x1 & (x0 | x2)) | (~x3 & (x2 | (x0 & ~x4))) | (x2 & (x0 | ~x4)) | (x0 & ~new_n129_ & ~x4);
  ...
  assign z44 = (x0 & ~new_n141_ & ~x5) | ~new_n84_ | ~x0 | x3;
  assign new_n141_ = (~x2 | x6) & (~x1 | (x2 & x6));
  assign z45 = new_n143_ | x0 | ~x1 | ~x2;
  assign new_n143_ = ~x4 & (x5 | x6);
  assign z47 = (x2 & (~x1 | (new_n143_ & ~x0))) | (x0 & (~new_n90_ | ~new_n78_ | ~x2));
  assign z48 = x2 | (x0 & (~new_n90_ | ~new_n78_ | ~x2));
  assign z49 = (~new_n129_ & ~x4) | x0 | x1 | ~x2 | (x3 & x4);
  assign z50 = x2 | (x0 & (~new_n105_ | x5 | ~new_n78_ | ~x1));
  assign z51 = x0 ? (new_n149_ | ~x1 | (~x2 & x3)) : (x2 & (~new_n84_ | x1 | ~x3));
  ...
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n86_ & (x2 ? ~x3 : x0)) | (new_n157_ & x2) | (x0 & x3);
  ...
  assign z57 = (~x1 & (x0 | (x2 & ~x3))) | (~new_n86_ & x2) | (x0 & (new_n163_ | x2 | ~x3));
  assign new_n163_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = (new_n143_ & ~x0) | (~new_n86_ & x0) | ~x1 | ~x2 | ~x3;
  assign z59 = (~new_n166_ & (~new_n105_ | x4)) | ~new_n168_ | (~new_n167_ & x0);
