...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n81_, new_n83_, new_n85_, new_n88_, new_n90_, new_n93_, new_n98_,
    new_n101_, new_n104_, new_n106_, new_n108_, new_n111_, new_n113_,
  ...
  assign z12 = x2 & (~x0 | (new_n81_ & ~x1 & ~x3 & ~x4));
  ...
  assign z32 = (x1 & (x0 | (~x0 & ~x2))) | (x4 & (x0 ? ~x5 : ~x2)) | ~new_n113_ | (x5 & (x0 ? ~x4 : ~x2));
  assign new_n113_ = x0 ? (~x2 & (x4 | (x3 & ~x6))) : (x2 | (~x3 & x6 & ~x7));
  assign z33 = ~x2 | (~new_n115_ & x0);
  assign new_n115_ = ~x4 & (x1 | ~x5) & x6 & x7 & (~x1 | ~x3 | x5);
  assign z34 = (~new_n117_ & (x0 ? x5 : ~x2)) | (~x5 & (x0 ? ~new_n118_ : ~x2));
  ...
  assign z38 = ~new_n124_ | (x5 & (x0 ? ~x4 : ~x2)) | (x1 & (x0 | ~x2));
  ...
  assign z42 = new_n133_ | new_n134_ | (~z09 & (x4 | (x1 & ~x5)));
  assign new_n133_ = ~x0 & ~x2 & (~x5 | (~x4 & (x7 | (x5 & x6))));
  assign new_n134_ = x0 & (x5 ? (x6 | x7) : ((x2 & ~x3) | ~x6 | ~x7));
  ...
  assign z52 = (~x4 & ~new_n154_ & (x0 | (~x0 & ~x2))) | (x0 & ((~x1 & ~x2) | x3)) | (~x0 & ~x2 & (x1 | ~x3));
  ...
  assign z54 = (~x1 & (x0 | ~x3)) | (~x0 & (x2 | (new_n159_ & ~x3))) | (x0 & x3) | (~new_n90_ & (x0 | x3));
  assign new_n159_ = ~x4 & (x5 | x6);
  assign z55 = (~x1 & (x0 | ~x2)) | (~x2 & (new_n159_ | (x0 & ~x3))) | (x0 & ~new_n90_ & x2);
  assign z56 = x0 | (~x2 & (new_n145_ | ~x1 | ~x3));
  assign z57 = new_n145_ | ~x1 | x2 | (x0 & ~x3) | (~x0 & x3);
  assign z58 = new_n164_ | (x0 & (~x1 | ~x2 | ~x5)) | (~x2 & (x1 | x5));
  assign new_n164_ = (x0 | ~x2) & (~x6 | ~x7 | ~x3 | x4);
  assign z59 = (~new_n98_ & ~x2) | (~new_n166_ & x0);
  assign new_n166_ = (~x2 | ((x4 | ~x6) & (~x1 | ~x3))) & (x2 | (x1 & x3)) & (x4 | ~x5) & (x1 | (x3 & (x4 | ~x6)));
