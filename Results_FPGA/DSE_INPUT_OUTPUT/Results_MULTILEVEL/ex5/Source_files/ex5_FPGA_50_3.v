...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n81_, new_n83_, new_n85_, new_n87_, new_n89_, new_n92_, new_n96_,
    new_n100_, new_n105_, new_n107_, new_n110_, new_n111_, new_n112_,
    ...
    new_n154_, new_n156_, new_n158_, new_n160_, new_n163_, new_n168_,
    new_n170_, new_n171_;
  ...
  assign z25 = (x0 & x2) | (new_n107_ & ~x0 & x1 & ~x2 & ~x3);
  assign new_n107_ = ~x4 & ~x5 & x6 & ~x7;
  assign z27 = ~x7 & x6 & ~x5 & ~x4 & new_n87_ & ~x3;
  assign z29 = z12 | (new_n110_ & new_n111_ & new_n112_ & ~x6 & x7);
  ...
  assign z38 = (~x2 & (new_n128_ | (~new_n130_ & ~x0) | x1)) | (~x0 & (x1 | (~new_n129_ & x2)));
  ...
  assign z40 = (~new_n135_ & ~x2) | (~x0 & (~new_n136_ | (~new_n129_ & x2)));
  ...
  assign z48 = new_n152_ | ~new_n111_ | x2 | ~x3;
  assign new_n152_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z49 = new_n154_ | ~new_n111_ | new_n129_ | ~x2;
  assign new_n154_ = ~x4 & (x5 | x6);
  assign z50 = x2 ? ~x0 : (~new_n156_ | (x0 & (~x1 | ~x3)));
  assign new_n156_ = ~x4 & ~x5 & x6 & x7;
  assign z51 = (~new_n158_ & ~x0) | (~x2 & ((x0 & (~x1 | x3)) | new_n152_ | (~x0 & ~x3)));
  assign new_n158_ = (x4 | (x3 & ~x5 & ~x6)) & ~x1 & (~x2 | ~x4);
  assign z52 = (~new_n160_ & ~x2) | (~x0 & (new_n154_ | x1 | (new_n129_ & x2)));
  assign new_n160_ = (~x0 | (x1 & ~x3)) & (x0 | x3) & (x4 | (~x5 & (x5 | ~x6)));
  assign z53 = (x1 & (x0 ? (~x2 & ~x3) : (x2 & x3))) | (~new_n83_ & ((~x2 & ~x3) | (~x0 & ~x1 & x3))) | ((new_n154_ | ~x1) & ((~x0 & x2 & ~x3) | (~x2 & x3)));
  assign z54 = (~x1 & ((~x2 & ~x3) | (~x0 & x2 & x3))) | (~new_n163_ & ~x0) | (~x2 & ((~new_n83_ & (x0 | x3)) | (x0 & x3)));
  assign new_n163_ = x3 ? (x4 | (x5 ? (x6 & x7) : ~x6)) : (x2 ? (x6 & x7 & ~x4 & x5) : (x4 | (~x5 & ~x6)));
  assign z55 = (x0 & ~x2 & ~x3) | ((~x0 | ~x2) & (new_n154_ | ~x1));
  assign z56 = (~x1 & (~x2 | (~x0 & x3))) | (~x2 & (new_n150_ | x0 | ~x3)) | (~x0 & ~new_n83_ & x2);
  assign z57 = (~x1 & (~x2 | (~x0 & x2 & ~x3))) | (~x0 & ~new_n83_ & x2) | (~x2 & (new_n150_ | (x0 & ~x3) | (~x0 & x3)));
  assign z58 = (~new_n168_ & ~x0) | (~x2 & (~new_n156_ | x0 | x1 | ~x3));
  assign new_n168_ = (~x2 | (x1 & (x4 | ~x6))) & x3 & (x4 | ~x5);
  assign z59 = (~x0 & (~new_n156_ | (~new_n100_ & x2))) | (~x2 & (new_n171_ | (~new_n170_ & x0)));
  assign new_n170_ = x1 & x3 & (~x3 | ~x5);
  assign new_n171_ = x3 & (x4 | ~x6 | ~x7);
  assign z60 = (~x2 & (x3 | (x0 & (~x1 | (~x3 & ~x4))))) | (~x0 & (~new_n92_ | x1 | x4 | (x2 & ~x3)));
  assign z62 = new_n154_ | ~new_n110_ | ~x0 | ~x1;
  assign z08 = 1'b0;
  assign z28 = 1'b0;
  assign z33 = ~z12;
  assign z26 = z12;
