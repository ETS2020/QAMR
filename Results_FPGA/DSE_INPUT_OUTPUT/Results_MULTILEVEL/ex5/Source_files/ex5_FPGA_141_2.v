...
module FAU ( 
  ...
  wire new_n79_, new_n82_, new_n84_, new_n86_, new_n88_, new_n89_, new_n91_,
    new_n93_, new_n95_, new_n97_, new_n102_, new_n106_, new_n113_,
    new_n115_, new_n116_, new_n122_, new_n124_, new_n126_, new_n127_,
    new_n128_, new_n129_, new_n132_, new_n134_, new_n136_, new_n137_,
    new_n139_, new_n141_, new_n146_, new_n147_, new_n149_, new_n151_,
    new_n153_, new_n155_, new_n157_, new_n158_, new_n160_;
  ...
  assign z13 = ~x2 & (x0 | (new_n95_ & x1 & x3 & ~x4));
  assign new_n95_ = new_n89_ & x5;
  assign z15 = (x0 & ~x2) | (new_n97_ & ~x0 & x1 & x2 & x3);
  assign new_n97_ = new_n89_ & ~x4 & x5;
  ...
  assign z36 = (~x0 & (x1 | ~x2 | x3)) | (x2 & (x0 | (~new_n106_ & ~x3)));
  ...
  assign z53 = (~new_n97_ & (x2 ? ~x1 : ~x3)) | (~x3 & (x0 | (~x1 & x2))) | (~x1 & (x0 | (~x2 & x3))) | new_n146_ | (x0 & ~x2) | (~x0 & x1 & x2 & x3);
  assign new_n146_ = ~x4 & (new_n147_ | (x0 & (x5 ? (~x6 | ~x7) : x6)));
  assign new_n147_ = (x5 | x6) & ((~x2 & x3) | (~x0 & x1 & x2));
  assign z54 = (~new_n97_ & (~x2 ^ ~x3)) | new_n149_ | (~x2 & (x0 | (~x1 & ~x3))) | (x0 & (~x1 | x3)) | (~x1 & x2 & x3);
  assign new_n149_ = ~x4 & ((x3 & (x5 ? (~x6 | ~x7) : x6)) | (~x2 & ~x3 & (x5 | x6)));
  assign z55 = (~x1 & (x2 | (~x0 & ~x2))) | (new_n151_ & ~x0) | (x0 & ~new_n97_ & x2);
  assign new_n151_ = ~new_n82_ & ~x4;
  assign z56 = (~x1 & (x2 ? x3 : ~x0)) | (~new_n153_ & x2) | (~x0 & ~x2 & (new_n134_ | ~x3));
  assign new_n153_ = ~x0 & ~x4 & new_n89_ & x5;
  assign z57 = (~x1 & (~x2 | ~x3)) | ~new_n155_ | (~x2 & (x3 | (~x4 & x5)));
  assign new_n155_ = (x7 | (~x2 & (x4 | ~x6))) & ~x0 & (~x2 | (~x4 & x5 & x6));
  assign z58 = (~new_n157_ & ~x0) | (x2 & ((~new_n97_ & x0) | ~x1 | ~x3));
  assign new_n157_ = new_n158_ & (~x1 | (x2 & (x4 | ~x6)));
  assign new_n158_ = (~x5 | (x1 & x4)) & x3 & (x1 | (~x4 & x6 & x7));
  assign z59 = (~new_n160_ & x2) | (~new_n88_ & ~x0);
  assign new_n160_ = (~x0 | ((x1 | x3) & (x4 | ~x6))) & (x0 | (~x1 & ~x3)) & (x4 | ~x5) & (~x1 | (~x3 & (x4 | ~x6)));
  assign z60 = (~x2 & (x0 | x3)) | (x0 & (~x1 | x3 | ~x4)) | (~x0 & (~new_n95_ | x1 | x4 | (x2 & ~x3)));
  assign z61 = ~x0 | (x2 & (new_n151_ | x1 | (~x1 & ~x3)));
  assign z62 = ~x0 | (x2 & (new_n151_ | ~x1 | (x1 & x3)));
  assign z17 = 1'b0;
  assign z21 = 1'b0;
  assign z22 = 1'b0;
  assign z04 = ~z37;
