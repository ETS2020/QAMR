...
module FAU ( 
  ...
  wire new_n75_, new_n80_, new_n83_, new_n85_, new_n87_, new_n89_, new_n92_,
    new_n97_, new_n100_, new_n103_, new_n106_, new_n108_, new_n112_,
  ...
  assign z13 = ~x0 & (x2 | (new_n89_ & new_n80_ & x1));
  ...
  assign z21 = (~x0 & x2) | (new_n75_ & new_n80_ & x0 & ~x1 & ~x2);
  ...
  assign new_n115_ = (x0 | (~x4 & (x2 | ~x3))) & ~x2 & (x2 | (~x1 & (~x4 | x5)));
  ...
  assign z42 = new_n119_ | (x5 & (x6 | x7)) | x4 | (~x5 & (~new_n137_ | ~x6 | ~x7));
  ...
  assign z62 = x0 ? (new_n167_ | ~x1 | x3) : ~x2;
  assign z06 = 1'b0;
  assign z27 = 1'b0;
  assign z10 = z09;
  assign z15 = z09;
