...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n79_, new_n84_, new_n86_, new_n88_, new_n90_, new_n92_,
    new_n94_, new_n97_, new_n99_, new_n107_, new_n110_, new_n112_,
  ...
  assign z03 = z07 | (new_n79_ & x5 & ~x6 & ~x7);
  ...
  assign z16 = ~x2 & (~x0 | (new_n79_ & x1 & new_n97_ & x5));
  ...
  assign z22 = ~x2 & (~x0 | (new_n97_ & ~x5 & ~x1 & ~x4));
  assign z26 = (~x0 & ~x2) | (x0 & x2 & ~x3 & new_n97_ & ~x4 & ~x5);
  assign z27 = ~x7 & x6 & ~x5 & ~x4 & new_n88_ & ~x3;
  assign z28 = z07 | (new_n97_ & ~x4 & ~x5 & new_n99_ & new_n107_);
  assign new_n107_ = x2 & x3;
  assign z30 = x7 & x6 & new_n84_ & ~x5;
  assign z31 = (x2 & (x0 | ~x4)) | ~new_n110_ | (~x0 & (~x2 | ~x3 | ~x4));
  assign new_n110_ = ~x1 & (~x4 | x5) & (x4 | (~x5 & ~x6));
  ...
  assign z39 = (~x0 & (~x2 | ~x5)) | ~new_n128_ | (~new_n127_ & x5);
  assign new_n127_ = x3 & ~x6 & ~x7;
  assign new_n128_ = ~x4 & (x5 | (~x1 & ~x2 & x6 & x7));
  assign z40 = (x1 & (x0 ^ x2)) | (~new_n130_ & x2) | (~new_n131_ & x0);
  ...
  assign z47 = (new_n144_ & ~x0) | ~x1 | ~x2 | (~new_n146_ & x0);
  ...
  assign z51 = (~x2 & (~x0 | (x0 & x3))) | (~new_n151_ & ~x4) | (x0 & ~x1) | (~x0 & (~x3 | x4 | (x1 & x2)));
  ...
  assign z55 = (~x4 & ~new_n75_ & (x0 ^ x2)) | (~new_n162_ & x0) | (~x1 & (x0 | x2));
  assign new_n162_ = x2 ? (~x4 & x5 & x6 & x7) : x3;
  assign z56 = ~new_n164_ | ~x7 | ~x5 | ~x6;
  assign new_n164_ = x2 & ~x4 & ~x0 & (x1 | ~x3);
  assign z57 = (~x1 & (x2 ? ~x3 : x0)) | (~new_n157_ & x2) | (x0 & (x2 | (~x2 & (new_n166_ | ~x3))));
  assign new_n166_ = ~x4 & (x5 | (x6 & ~x7));
  assign z58 = x2 ? ((new_n144_ & ~x0) | (~new_n157_ & x0) | ~x1 | ~x3) : x0;
  assign z59 = new_n169_ | new_n170_ | new_n171_ | new_n172_ | new_n173_;
  ...
  assign z60 = new_n175_ | (x1 & (~x0 | ~x4)) | (~x0 & (~new_n97_ | x4)) | (~x1 & (~new_n107_ | x0));
  assign new_n175_ = x3 & (x1 | (~x0 & ~x5));
  assign z61 = x0 ? (new_n144_ | x1 | ~x2 | ~x3) : x2;
