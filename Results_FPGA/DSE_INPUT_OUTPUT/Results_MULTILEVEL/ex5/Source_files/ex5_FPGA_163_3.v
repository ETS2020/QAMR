...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n81_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_, new_n101_,
  ...
  assign z21 = x0 & (x2 | (~x1 & x3 & new_n81_ & ~x4));
  assign z22 = x0 & (x2 | (new_n101_ & ~x5 & ~x1 & ~x4));
  ...
  assign z32 = (~z12 & x1) | new_n113_ | new_n114_ | new_n115_ | new_n116_;
  assign new_n113_ = ~x3 & (x0 ? ~x4 : x2);
  assign new_n114_ = x0 & (x2 | (~x2 & ~x4 & x6));
  assign new_n115_ = ~x2 & ((~x0 & (x3 | x4)) | (x4 & ~x5) | (~x4 & x5));
  assign new_n116_ = ~x0 & ~x4 & (x2 | ~x6 | x7);
  ...
  assign z49 = ~x2 | (~x0 & ((~new_n81_ & ~x4) | x1 | (x3 & x4)));
  ...
  assign z53 = (x0 & (x2 | (x1 & ~x3))) | (~new_n91_ & (x2 ? ~x1 : ~x3)) | (~x1 & (~x2 ^ ~x3)) | new_n164_ | (x1 & x2 & x3);
  assign new_n164_ = ~x4 & (x5 | x6) & (x2 ? x1 : x3);
  assign z54 = (~x1 & ((~x2 & ~x3) | (~x0 & x2 & x3))) | (~new_n166_ & ~x0) | (~x2 & ((~new_n91_ & (x0 | x3)) | (x0 & x3)));
  assign new_n166_ = x3 ? (x4 | (x5 ? (x6 & x7) : ~x6)) : (x2 ? (~x4 & x5 & x6 & x7) : (x4 | (~x5 & ~x6)));
  assign z55 = ((~x0 | ~x2) & (new_n129_ | ~x1)) | (x0 & ~x2 & ~x3);
  assign z56 = (~x1 & (~x2 | (~x0 & x3))) | new_n169_ | (~x2 & (x0 | ~x3)) | (~x0 & ~new_n91_ & x2);
  ...
  assign z59 = (~x2 & (~new_n101_ | ~new_n177_ | (x0 & (~x1 | ~x3)))) | (~x0 & (~new_n101_ | ~new_n177_ | (x2 & (x1 | x3))));
