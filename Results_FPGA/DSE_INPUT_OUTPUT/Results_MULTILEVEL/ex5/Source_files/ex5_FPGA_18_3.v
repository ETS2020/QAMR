...
module FAU ( 
  ...
  wire new_n75_, new_n82_, new_n84_, new_n86_, new_n88_, new_n91_, new_n94_,
    new_n96_, new_n101_, new_n104_, new_n107_, new_n111_, new_n113_,
  ...
  assign z20 = ~x6 & ~x5 & ~x4 & new_n101_ & ~x3;
  assign new_n101_ = ~x2 & x0 & ~x1;
  assign z21 = ~x6 & ~x5 & ~x4 & new_n101_ & x3;
  assign z22 = x0 & (x2 | (new_n104_ & ~x5 & ~x1 & ~x4));
  ...
  assign new_n119_ = ~x0 & ~x2 & (x3 | x5 | ~x6 | x7);
  ...
  assign new_n123_ = ~x2 & ((~x4 & ~x5 & (~x6 | ~x7)) | (x5 & (~x3 | x4 | x6 | x7)));
  ...
  assign z38 = new_n115_ | new_n116_ | (new_n130_ & x0) | x1 | (new_n131_ & ~x0);
  ...
  assign z40 = new_n136_ | new_n137_ | new_n138_ | x1 | (~x4 & x5);
  ...
  assign z44 = ((x1 | x3) & (~x0 | ~x2)) | (~x0 & (x2 | ~x4)) | (x0 & ~x2 & (~new_n75_ | x4));
  ...
  assign z49 = new_n130_ | ~new_n82_ | ~new_n137_;
  assign z50 = x2 ? ~x0 : (~new_n104_ | ~new_n159_ | (x0 & (~x1 | ~x3)));
  assign new_n159_ = ~x4 & ~x5;
  assign z51 = (~new_n161_ & ~x0) | (~x2 & (new_n156_ | (x0 & (~x1 | x3))));
  assign new_n161_ = (x4 | (~x5 & ~x6)) & ~x1 & x3 & (~x2 | ~x4);
  assign z52 = (~x2 & ((x0 & (~x1 | x3)) | (~new_n75_ & ~x4) | (~x0 & ~x3))) | (~x0 & ((~new_n75_ & ~x4) | x1 | (x2 & x3 & x4)));
  assign z53 = (x0 & (x2 | (x1 & ~x3))) | (~new_n164_ & (x2 ? ~x1 : ~x3)) | (~x1 & (~x2 ^ ~x3)) | new_n165_ | (x1 & x2 & x3);
  assign new_n164_ = ~x4 & x5 & x6 & x7;
  assign new_n165_ = ~x4 & (x5 | x6) & (x2 ? x1 : x3);
  assign z54 = (~x1 & ((~x2 & ~x3) | (~x0 & x2 & x3))) | (~new_n167_ & ~x0) | (~x2 & ((~new_n164_ & (x0 | x3)) | (x0 & x3)));
  assign new_n167_ = x3 ? (x4 | (x5 ? (x6 & x7) : ~x6)) : (x2 ? (x6 & x7 & ~x4 & x5) : (x4 | (~x5 & ~x6)));
  assign z55 = ((~x0 | ~x2) & (new_n130_ | ~x1)) | (x0 & ~x2 & ~x3);
  assign z56 = (~x1 & (~x2 | x3)) | ~new_n170_ | (~x2 & (~x3 | (~x4 & x5)));
  assign new_n170_ = ~x0 & (x0 | ((x7 | (~x2 & (x4 | ~x6))) & (~x2 | (~x4 & x5 & x6))));
  assign z57 = (~x2 & (~new_n174_ | (~new_n173_ & x0))) | (~x0 & (new_n172_ | ~new_n175_));
  assign new_n172_ = ~x7 & (x2 | (~x4 & x6));
  assign new_n173_ = x3 & (x4 | ~x6 | x7);
  assign new_n174_ = x1 & (x4 | ~x5) & (x0 | ~x3);
  assign new_n175_ = (x1 | x3) & (~x2 | (~x4 & x5 & x6));
  assign z58 = new_n150_ | new_n151_ | new_n152_ | x0 | ~x3;
  assign z59 = (x0 & (~x1 | ~x3)) | ~new_n104_ | ~new_n159_ | (x2 & (x1 | x3));
