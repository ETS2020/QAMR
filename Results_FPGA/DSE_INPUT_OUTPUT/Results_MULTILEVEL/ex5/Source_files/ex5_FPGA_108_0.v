...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62;
  wire new_n75_, new_n78_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    ...
    new_n160_, new_n162_, new_n165_, new_n166_;
  ...
  assign new_n114_ = ~x1 & (x4 | (~x5 & ~x6)) & (x0 | (x2 & x4));
  ...
  assign z42 = (~x0 & (~x2 | ~x5)) | x4 | (~new_n135_ & ~x5) | (~new_n78_ & x5);
  ...
  assign z47 = (x2 & (~x1 | (new_n142_ & ~x0))) | (~new_n144_ & x0);
  assign new_n144_ = x2 & x3 & ~x4 & x5 & x6 & x7;
  assign z48 = x2 | (~new_n144_ & x0);
  assign z49 = x0 | (x2 & ((~new_n75_ & ~x4) | x1 | (x3 & x4)));
  assign z50 = x2 | (x0 & (~new_n87_ | ~x1 | ~x3 | x4));
  assign z51 = (~x2 & (~x0 | (x0 & x3))) | (~new_n149_ & ~x4) | (x0 & ~x1) | (~x0 & (~x3 | x4 | (x1 & x2)));
  ...
  assign z54 = (~x1 & (x0 | (x2 & x3))) | (~new_n93_ & (x2 ? ~x3 : x0)) | (new_n156_ & x2) | (x0 & x3);
  assign new_n156_ = ~x4 & (x5 ? (~x6 | ~x7) : x6);
  assign z55 = new_n158_ | (~x1 & (x0 | x2)) | (x0 & (x2 ? ~new_n93_ : ~x3));
  ...
  assign z58 = (new_n142_ & ~x0) | (~new_n93_ & x0) | ~x1 | ~x2 | ~x3;
  assign z59 = (x2 & (~new_n165_ | (x1 & (~x0 | x3)))) | (x0 & (~new_n166_ | (~x3 & (~x1 | ~x2))));
  assign new_n165_ = x0 ? (x4 | ~x6) : (~x3 & ~x4 & ~x5 & x6 & x7);
  assign new_n166_ = (x1 | (x2 & (x4 | ~x6))) & (~x5 | (x2 & x4)) & (x2 | (~x4 & x6 & x7));
  assign z60 = x0 ? (~x1 | x3 | ~x4) : (~new_n93_ | x1 | ~x2 | ~x3);
  assign z61 = new_n142_ | ~x0 | x1 | ~x2 | ~x3;
  assign z62 = x0 ? (new_n142_ | ~x1 | x3) : x2;
  assign z07 = 1'b0;
  assign z24 = 1'b0;
  assign z25 = 1'b0;
  assign z29 = 1'b0;
