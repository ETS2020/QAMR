...
module FAU ( 
  ...
  nand2  g120(.a(x20), .b(new_n68_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n35_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n36_), .c(x03), .O(new_n156_));
  nand2  g123(.a(new_n71_), .b(x14), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x06), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x11), .c(new_n34_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n121_), .c(new_n156_), .d(new_n49_), .O(z6));
  inv1   g127(.a(new_n121_), .O(z7));
endmodule
