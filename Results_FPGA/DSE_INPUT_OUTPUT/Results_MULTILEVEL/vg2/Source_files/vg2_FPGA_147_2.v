...
module FAU ( 
  ...
  assign new_n62_ = x11 & x14 & x20 & ~new_n63_ & (~x08 | x23);
  ...
  assign new_n73_ = (~x08 | x23) & (x05 | new_n74_ | x13);
  ...
  assign z4 = (~new_n37_ & (x08 ? x23 : new_n78_)) | (~new_n63_ & (new_n79_ | ~x08));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & x23 & (~x09 | (x22 & (~x04 | ~x17)));
  assign z5 = ~new_n37_ & (~x08 | (x08 & x23));
  assign z6 = (new_n82_ | new_n83_) & (~x08 | x23);
  ...
  assign new_n85_ = ~new_n64_ & (~x08 | x23);
endmodule
