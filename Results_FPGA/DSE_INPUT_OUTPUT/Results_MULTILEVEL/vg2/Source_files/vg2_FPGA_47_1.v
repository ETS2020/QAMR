...
module FAU ( 
  ...
  assign new_n47_ = ~new_n48_ & (~new_n52_ | ~new_n54_ | ~x03 | ~x04 | ~x06);
  ...
  assign new_n71_ = ~new_n72_ & (~new_n74_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n72_ = new_n73_ & ~x06 & x07 & ~x01 & ~x03;
  assign new_n73_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n74_ = x18 & x20 & x11 & x14;
  assign new_n75_ = (new_n76_ | x01) & (~new_n79_ | ~new_n78_ | ~x01 | ~x03);
  assign new_n76_ = ~x12 & (~new_n77_ | x06 | x08 | x03 | x05);
  assign new_n77_ = ~x11 & ~x13 & ~x14 & x19 & ~x20;
  assign new_n78_ = ~x05 & x06 & x08;
