...
module FAU ( 
  ...
  assign z3 = (~x12 & (new_n67_ | new_n72_ | new_n78_)) | (x02 & (new_n72_ | new_n82_));
  ...
  assign new_n72_ = x24 & ~new_n77_ & (new_n73_ | new_n75_);
  ...
  assign z4 = new_n84_ | (new_n91_ & x24) | new_n88_ | (~new_n92_ & ~x02);
  assign new_n84_ = ~new_n85_ & (x08 ? ~x12 : new_n87_);
  ...
  assign new_n89_ = (~x02 | ~x08 | ~x19) & (~x15 | (~new_n90_ & x08));
  assign new_n90_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n91_ = ~new_n77_ & ((x18 & (new_n90_ | ~x08)) | (x02 & x07 & x08));
  assign new_n92_ = ~x12 & (x10 | ~x21 | x24 | (~new_n90_ & x08));
  assign z5 = (~new_n39_ & (x02 | ~x12)) | (x00 & ~x02 & ~x10 & ~x12 & ~x24);
  assign z6 = new_n95_ | new_n96_ | (~x02 & x12);
  assign new_n95_ = ~new_n85_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
