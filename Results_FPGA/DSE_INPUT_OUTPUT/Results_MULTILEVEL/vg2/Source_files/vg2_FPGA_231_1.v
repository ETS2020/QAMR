...
module FAU ( 
  ...
  assign z3 = ~new_n67_ | (x24 & (new_n77_ | (~new_n73_ & (x05 | x13))));
  assign new_n67_ = (x01 | x03 | ~new_n68_ | x06) & ~new_n39_ & (~x01 | ~x03 | ~new_n70_ | ~x06);
  assign new_n68_ = ~x08 & ~x11 & new_n69_ & ~x14;
  assign new_n69_ = ~x20 & (new_n38_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n70_ = x08 & x11 & x14 & x20 & new_n71_ & ~x24;
  assign new_n71_ = ~new_n39_ & ~new_n72_;
  assign new_n72_ = (x02 | x10 | ~x21) & (~x15 | (~x05 ^ ~x13));
  assign new_n73_ = ~new_n74_ & (~new_n76_ | ~x06 | ~x08 | ~x01 | ~x03);
  ...
  assign new_n78_ = x11 & ~x13 & x14 & x15 & x20;
  ...
  assign z6 = (~new_n37_ & (new_n86_ | x03)) | new_n39_ | (~new_n64_ & (new_n87_ | ~x03));
  assign new_n86_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n87_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n89_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n89_ = ~new_n65_ & (x05 | x13 | ~x15) & ~new_n39_ & (~new_n90_ | ~x13);
