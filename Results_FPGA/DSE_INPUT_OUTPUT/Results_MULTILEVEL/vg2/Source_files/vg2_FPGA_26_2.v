...
module FAU ( 
  ...
  assign z7 = (~new_n47_ & x05) | new_n48_ | (~x05 & ~x13 & x15);
  assign new_n47_ = (x13 | ~x18 | ~x24) & (~x21 | x24 | ~x13 | ~x15);
  assign new_n48_ = x21 & ((x13 & x18 & x24) | (~x02 & ~x10 & ~x24));
  assign z2 = (new_n50_ & x01) | (x13 & ~x21);
  assign new_n50_ = x03 & x06 & x11 & x14 & ~new_n51_ & x20;
  assign new_n51_ = (x24 | (~new_n52_ & (~x05 | ~x13 | ~x15))) & (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n52_ = ~x02 & ~x10 & (x13 | x21);
  assign z3 = x01 ? (x03 & x06 & new_n54_ & x08) : (~x03 & ~x06 & new_n36_ & ~x08);
  assign new_n54_ = x11 & x14 & z7 & x20;
  assign z4 = (~new_n51_ & (new_n59_ | ~x08)) | new_n58_ | (~new_n56_ & (new_n60_ | x08));
  assign new_n56_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n57_ & (x05 | x13 | ~x19);
  assign new_n57_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n58_ = x13 & (new_n57_ | ~x21);
  assign new_n59_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n60_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = (~new_n62_ & x05) | new_n57_ | (~x05 & ~x13 & x19) | (~new_n63_ & x13);
  assign new_n62_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n63_ = x21 & (~x07 | ~x24);
  assign z6 = (~new_n65_ & (new_n68_ | x03)) | new_n70_ | (z7 & (new_n69_ | ~x03));
  assign new_n65_ = (new_n66_ | ~x05) & ~new_n67_ & (x13 | (~new_n57_ & (x05 | ~x19)));
  assign new_n66_ = (~x07 | x13 | ~x24) & (~x21 | x24 | ~x13 | ~x19);
  assign new_n67_ = x07 & x13 & x21 & x24;
  assign new_n68_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n69_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n70_ = x13 & x21 & ~x24 & x00 & ~x02 & ~x10;
endmodule
