...
module FAU ( 
  ...
  assign z3 = (new_n71_ & x01) | (x21 & ((~new_n68_ & ~x24) | (new_n74_ & ~x01)));
  ...
  assign new_n77_ = (new_n78_ | (~x14 & ~x21)) & (~new_n39_ | x10 | ~x14 | x24);
  assign new_n78_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n79_ = ~new_n66_ & (new_n73_ | (~x14 & ~x21));
  ...
  assign new_n85_ = (x05 | x13 | ~x19) & (x14 | x21);
  assign z6 = ~new_n87_ | (~new_n77_ & (x03 | (x06 & ~x11)));
  assign new_n87_ = (~x24 | new_n88_ | (~x05 & ~x13)) & ~new_n92_ & (new_n91_ | (x05 ? (~x13 | x24) : x13));
  assign new_n88_ = (new_n89_ | ~x18) & (~x07 | x11 | ~new_n90_ | x14);
  assign new_n89_ = (~x11 | ~x14 | x20) & ((~x14 & ~x21) | (x03 & (x06 | ~x11)));
  assign new_n90_ = x20 & x21;
  assign new_n91_ = (new_n89_ | ~x15) & (x11 | x14 | ~new_n90_ | ~x19);
  ...
  assign new_n95_ = ~new_n66_ & (x14 | x21);
endmodule
