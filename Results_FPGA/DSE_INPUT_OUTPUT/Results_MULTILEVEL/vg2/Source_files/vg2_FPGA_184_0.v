...
module FAU ( 
  ...
  assign z2 = (~x13 & ~x21) | (new_n51_ & x01);
  ...
  assign z7 = new_n56_ | (~new_n57_ & x21) | (x13 & x18 & x24);
  assign new_n56_ = x05 & ((x18 & x21 & x24) | (x13 & x15 & ~x24));
  assign new_n57_ = (x05 | x13 | ~x15) & (x02 | x10 | x24);
  assign z4 = (~new_n52_ & (new_n62_ | ~x08)) | new_n61_ | (~new_n59_ & (new_n63_ | x08));
  assign new_n59_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n60_ & (x05 | x13 | ~x19);
  assign new_n60_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n61_ = ~x13 & (new_n60_ | ~x21);
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n63_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = (~new_n66_ & x05) | ~new_n65_ | (~x13 & (~x21 | (~x05 & x19)));
  assign new_n65_ = ~new_n60_ & (~x07 | ~x13 | ~x24);
  assign new_n66_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n71_ & (~new_n68_ | new_n72_)) | new_n70_ | new_n73_;
  assign new_n68_ = (new_n69_ | ~x13) & (~x19 | ~x21 | x05 | x13);
  assign new_n69_ = ~new_n60_ & (~x07 | ~x24);
  assign new_n70_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n71_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n72_ = x05 & ((x13 & x19 & ~x24) | (x07 & x21 & x24));
