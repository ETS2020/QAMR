...
module FAU ( 
  ...
  assign z7 = new_n49_ | new_n50_ | (x15 & ~x21 & ~x05 & ~x13);
  assign new_n49_ = x13 & ((x18 & ~x21 & x24) | (x05 & x15 & ~x24));
  assign new_n50_ = x05 & ((x18 & x24) | (x21 & ~x24 & ~x02 & ~x10));
  ...
  assign new_n65_ = (~x05 | ~x13 | ~x15) & (x02 | x10 | ~x21);
  assign new_n66_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n67_ & ~x20;
  assign new_n67_ = (~x05 | ~x13 | ~x19) & (~x00 | x02 | x10);
  assign z4 = (~new_n37_ & (new_n69_ | x08)) | new_n39_ | (~new_n53_ & (new_n70_ | ~x08));
  ...
  assign z6 = new_n75_ | new_n76_ | new_n80_ | (~x03 & (new_n49_ | new_n50_));
  assign new_n75_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n76_ = x11 & ~new_n77_ & (x24 ? ~new_n78_ : ~new_n79_);
  assign new_n77_ = x06 & (~x14 | x20);
  assign new_n78_ = (~x05 | ~x18) & (~x03 | ((x05 | x13 | ~x15) & (~x13 | ~x18)));
  assign new_n79_ = (~x15 | x21 | x05 | x13) & (~x05 | ((~x13 | ~x15) & (x02 | x10 | ~x21)));
  assign new_n80_ = ~x05 & (x21 | (~x03 & ~x13 & x15 & ~x21));
endmodule
