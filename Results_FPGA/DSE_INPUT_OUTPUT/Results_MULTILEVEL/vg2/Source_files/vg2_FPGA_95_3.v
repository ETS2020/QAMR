...
module FAU ( 
  ...
  assign new_n66_ = (~x18 | x21 | new_n62_ | ~x24) & (x02 | x10 | x18 | ~x21 | x24);
  ...
  assign z4 = (~new_n37_ & (x08 ? ~new_n39_ : new_n77_)) | new_n39_ | (~new_n75_ & (new_n78_ | ~x08));
  ...
  assign z6 = ~new_n81_ | (~x11 & ~new_n92_ & (~new_n89_ | new_n93_));
  assign new_n81_ = (new_n82_ | ~x24) & new_n85_ & (new_n88_ | (x05 ? (~x13 | x24) : x13));
  assign new_n82_ = (new_n62_ | (x03 ? new_n83_ : (~x18 | x21))) & (~x18 | x21 | x03 | ~x15);
  assign new_n83_ = ~x07 & (~x11 | new_n84_ | ~x18);
  assign new_n84_ = x06 & (~x14 | x20);
  assign new_n85_ = ~new_n39_ & (x24 | (~new_n87_ & (x02 | new_n86_ | x10)));
  assign new_n86_ = x03 ? (~x00 & (~x11 | new_n84_ | ~x21)) : (x18 | ~x21);
  assign new_n87_ = ~x03 & x15 & ~x21 & (x05 ^ ~x13);
  assign new_n88_ = x03 ? (~x19 & (~x11 | new_n84_ | ~x15)) : (~x15 | x18);
  assign new_n89_ = ~new_n90_ & ~new_n91_ & (~x07 | ~x13 | x18 | ~x24);
  assign new_n90_ = x19 & (new_n62_ | (~x03 & x18 & x24));
  assign new_n91_ = x00 & ~x02 & ~x10 & ~x21 & ~x24;
  assign new_n92_ = ~x06 & (x14 | ~x20);
  assign new_n93_ = x05 & ((x13 & x19 & ~x24) | (x07 & ~x18 & x24));
endmodule
