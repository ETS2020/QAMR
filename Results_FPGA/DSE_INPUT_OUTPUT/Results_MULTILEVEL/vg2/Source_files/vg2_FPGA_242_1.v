...
module FAU ( 
  ...
  assign new_n56_ = ~x11 & ~x14 & ~new_n43_ & ~x20;
  assign new_n57_ = x11 & x14 & ~new_n48_ & x20;
  assign z4 = (~new_n37_ & (new_n59_ | x08)) | new_n39_ | (~new_n53_ & (new_n60_ | ~x08));
  assign new_n59_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n60_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n63_ & x05) | ~new_n62_ | (~x05 & (x21 | (~x13 & x19)));
  assign new_n62_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n63_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n65_ | x03)) | new_n39_ | (~new_n53_ & (new_n66_ | ~x03));
  assign new_n65_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n66_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n69_ & x05) | ~new_n68_ | (~x05 & (x21 | (~x13 & x15)));
  assign new_n68_ = ~new_n54_ & (~x13 | ~x18 | ~x24);
  assign new_n69_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
endmodule
