...
module FAU ( 
  ...
  assign z4 = (~new_n82_ & (x08 | (~new_n84_ & ~x16))) | (~new_n64_ & (~x08 | (~new_n85_ & x16)));
  assign new_n82_ = ~new_n38_ & (new_n83_ | (x02 & x12));
  ...
  assign z6 = (~new_n82_ & (x03 | (~new_n90_ & ~x11))) | (~new_n64_ & (~x03 | (~new_n91_ & x11)));
