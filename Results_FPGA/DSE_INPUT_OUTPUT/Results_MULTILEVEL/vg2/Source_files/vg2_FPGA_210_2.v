...
module FAU ( 
  ...
  assign z2 = (new_n63_ & x01) | (x09 & ~x12);
  ...
  assign new_n74_ = (~x09 | x12) & (x05 | new_n75_ | x13);
  ...
  assign z4 = ~new_n79_ | (~new_n82_ & (~x09 | x12));
  assign new_n79_ = x16 ? (new_n64_ | new_n81_) : (new_n38_ | new_n80_);
  assign new_n80_ = x09 ? ~x12 : (x22 | (~x17 & (~x04 | x23)));
  assign new_n81_ = x09 & (~x12 | ~x22 | (x17 & (x04 | ~x23)));
  ...
  assign z6 = (new_n87_ | new_n88_) & (~x09 | x12);
