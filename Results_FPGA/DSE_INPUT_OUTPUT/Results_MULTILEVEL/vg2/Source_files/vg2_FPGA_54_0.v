...
module FAU ( 
  ...
  assign z4 = (~new_n81_ & (new_n88_ | ~x08)) | new_n90_ | (~new_n85_ & (new_n89_ | x08));
  assign new_n81_ = (new_n82_ | ~x05) & new_n84_ & (~new_n83_ | x05);
  assign new_n82_ = (~x18 | ~x24) & (~x13 | ~x15 | ~x21 | x24);
  assign new_n83_ = ~x13 & x15 & (x21 | x24);
  assign new_n84_ = (~x13 | ~x18 | ~x24) & (~x21 | x24 | x02 | x10);
  ...
  assign new_n90_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z5 = new_n86_ | new_n87_ | new_n90_ | (x07 & x13 & x24);
  assign z6 = (~new_n65_ & (new_n93_ | ~x03)) | new_n96_ | (~new_n95_ & (new_n94_ | x03));
  ...
  assign new_n96_ = ~x24 & (~x21 | (x00 & ~x02 & ~x10));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (~new_n98_ & ~x24) | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n98_ = x21 & (x02 | x10);
endmodule
