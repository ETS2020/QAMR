...
module FAU ( 
  ...
  assign z6 = new_n90_ | (new_n91_ & x11) | new_n96_ | (new_n95_ & ~x03);
  assign new_n90_ = ~new_n81_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n91_ = (~x06 | (x14 & ~x20)) & (new_n94_ | (~new_n92_ & ~x24));
  assign new_n92_ = (~new_n93_ | x02) & (~x05 | ~x13 | ~x15 | (~x02 & x12));
  assign new_n93_ = ~x10 & x21 & (x05 ? ~x12 : x03);
  assign new_n94_ = x03 & ((~x05 & ~x13 & x15) | (x18 & x24 & (x05 | x13)));
  assign new_n95_ = ~new_n85_ & ~new_n63_;
  assign new_n96_ = ~x02 & (x12 | (~x03 & ~x10 & ~x12 & x21 & ~x24));
  assign z7 = (~x02 & ~x10 & ~x12 & x21 & ~x24) | (~new_n63_ & (x02 | ~x12));
endmodule
