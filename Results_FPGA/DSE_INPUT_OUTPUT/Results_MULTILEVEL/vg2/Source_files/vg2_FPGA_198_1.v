...
module FAU ( 
  ...
  assign new_n44_ = new_n45_ & ~x16 & ~x17 & ~x11 & ~x14;
  ...
  assign new_n54_ = ~x22 & ~x23 & x19 & ~x20;
  ...
  assign z4 = (~new_n82_ & (x08 | (~new_n83_ & ~x16))) | (~new_n63_ & (~x08 | (~new_n84_ & x16)));
  assign new_n82_ = (new_n39_ | (~x02 & x12)) & (~x00 | x02 | x10 | x12 | x24);
  assign new_n83_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n84_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n39_ | (~x02 & (x12 | (x00 & ~x10 & ~x24)));
  assign z6 = new_n87_ | new_n90_ | (~x02 & x12);
