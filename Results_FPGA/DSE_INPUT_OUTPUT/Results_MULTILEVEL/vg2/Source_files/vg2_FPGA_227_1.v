...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n74_, new_n75_, new_n78_, new_n79_, new_n82_, new_n83_;
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n78_ & ~x16))) | (z7 & (~x08 | (~new_n79_ & x16)));
  ...
  assign z6 = (~new_n37_ & (x03 | (~new_n82_ & ~x11))) | (z7 & (~x03 | (~new_n83_ & x11)));
