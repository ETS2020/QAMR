...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (x08 ? ~new_n58_ : new_n77_)) | new_n58_ | (~new_n75_ & (new_n78_ | ~x08));
  ...
  assign z6 = new_n81_ | new_n82_ | (~new_n75_ & (~x03 | (~x06 & x11)));
  assign new_n81_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n82_ = x14 & (x21 | (x11 & ~new_n63_ & ~x20));
