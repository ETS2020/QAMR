...
module FAU ( 
  ...
  assign z2 = x06 & (new_n62_ | ~x12);
  assign new_n62_ = x01 & x03 & x11 & x14 & ~new_n63_ & x20;
  assign new_n63_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n64_ & (x05 | x13 | ~x15);
  assign new_n64_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = ~new_n66_ | (~x24 & (x01 ? (new_n75_ & x03) : (new_n76_ & ~x03)));
  ...
  assign z4 = (~new_n63_ & (new_n78_ | ~x08)) | new_n74_ | (~new_n37_ & (x08 ? ~new_n74_ : new_n79_));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & ~new_n74_;
  assign z6 = (~new_n84_ & ~new_n74_) | (new_n83_ & x11) | (new_n82_ & ~x11);
  assign new_n82_ = ~new_n37_ & (x06 ? x12 : (~x14 & x20));
  assign new_n83_ = ~new_n63_ & (~x06 | (x12 & x14 & ~x20));
  assign new_n84_ = (x24 | (~new_n85_ & (~x05 | new_n86_ | ~x13))) & (x05 | new_n86_ | x13) & (~x24 | new_n87_ | (~x05 & ~x13));
  assign new_n85_ = ~x02 & ~x10 & (x03 ? x00 : x21);
  assign new_n86_ = x03 ? ~x19 : ~x15;
  assign new_n87_ = x03 ? ~x07 : ~x18;
  assign z7 = ~new_n89_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n89_ = ~new_n64_ & (x05 | x13 | ~x15) & ~new_n74_ & (~new_n90_ | ~x13);
