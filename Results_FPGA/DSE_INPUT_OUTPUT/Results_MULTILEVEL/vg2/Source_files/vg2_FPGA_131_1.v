...
module FAU ( 
  ...
  assign z1 = (~new_n42_ & ~x24) | ~new_n59_ | (~new_n49_ & x24);
  ...
  assign new_n49_ = ((~x05 & ~x13) | (~new_n50_ & (~new_n54_ | ~new_n56_))) & (~new_n54_ | ~new_n58_);
  ...
  assign new_n56_ = new_n57_ & x14 & x16 & x17;
  assign new_n57_ = x22 & x23 & x18 & x20;
  assign new_n58_ = new_n57_ & x16 & x17 & x14 & x15;
  assign new_n59_ = ~new_n40_ & (x05 | (~new_n60_ & ~new_n62_) | x13);
  assign new_n60_ = new_n54_ & new_n61_ & x15 & x16 & x12 & x14;
  assign new_n61_ = x22 & x23 & x17 & x20;
  assign new_n62_ = new_n63_ & new_n53_ & ~x06 & ~x08 & ~x09 & ~x11;
  ...
  assign new_n70_ = (~x24 | new_n71_ | (~x05 & ~x13)) & ~new_n40_ & (x05 | new_n75_ | x13);
  ...
  assign z4 = (~new_n67_ & (new_n81_ | ~x08)) | new_n40_ | (~new_n38_ & (x08 ? ~new_n40_ : new_n82_));
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = (~new_n84_ & ~new_n40_) | (x24 & ~new_n89_ & (x05 | x13));
  assign new_n84_ = (new_n38_ | ~x03) & (new_n87_ | new_n88_) & (~new_n85_ | x11);
  assign new_n85_ = ~new_n86_ & (new_n39_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n86_ = ~x06 & (x14 | ~x20);
  assign new_n87_ = ~new_n68_ & (~x15 | (x05 ? (~x13 | x24) : x13));
  assign new_n88_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n89_ = (~x07 | x11 | new_n86_ | x18) & (~x12 | new_n88_ | ~x18);
  assign z7 = (~new_n87_ & (x12 | ~x18)) | (x12 & x18 & x24 & (x05 | x13));
endmodule
