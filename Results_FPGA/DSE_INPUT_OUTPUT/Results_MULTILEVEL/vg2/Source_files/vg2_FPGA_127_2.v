...
module FAU ( 
  ...
  assign new_n45_ = ~x09 & ~x11 & ~x12 & new_n46_ & ~x14;
  ...
  assign new_n50_ = new_n51_ & ~x09 & ~x11 & ~x06 & x07;
  ...
  assign new_n60_ = new_n51_ & ~x11 & ~x12 & ~x06 & ~x09;
  ...
  assign z4 = (~new_n37_ & (x08 ? x12 : new_n78_)) | (~new_n64_ & (~x08 | (new_n79_ & x12)));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (~x08 | (x08 & x12));
  ...
  assign new_n85_ = ~new_n65_ & (x05 | x13 | ~x15) & ~new_n39_ & (~new_n86_ | ~x13);
