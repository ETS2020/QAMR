...
module FAU ( 
  ...
  assign z4 = ((new_n83_ | new_n38_) & (new_n84_ | x08)) | (~new_n65_ & (new_n85_ | ~x08));
  ...
  assign z6 = (~new_n37_ & (new_n91_ | x03)) | new_n39_ | (~new_n90_ & (new_n92_ | ~x03));
  assign new_n90_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign new_n91_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n92_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n94_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n94_ = ~new_n67_ & (x05 | x13 | ~x15) & ~new_n39_ & (~new_n95_ | ~x13);
