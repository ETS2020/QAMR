...
module FAU ( 
  ...
  assign new_n67_ = x11 & ~new_n42_ & (~x06 | (x14 & ~x20));
  assign new_n68_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & ~new_n43_ & (x05 | (x13 ? (~x18 | ~x24) : ~x15));
  assign new_n69_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n71_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n71_ = ~new_n43_ & (x05 | x13 | ~x15) & ~new_n55_ & (~new_n72_ | ~x13);
