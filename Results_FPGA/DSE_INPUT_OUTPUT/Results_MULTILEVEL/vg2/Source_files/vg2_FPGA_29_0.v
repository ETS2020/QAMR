...
module FAU ( 
  ...
  assign z2 = (x01 & x03 & x06 & new_n45_ & x11) | (~x11 & ~x12);
  assign new_n45_ = x14 & ~new_n42_ & x20;
  ...
  assign z4 = (~new_n42_ & (new_n61_ | ~x08)) | new_n60_ | (~new_n37_ & (x08 ? ~new_n60_ : new_n62_));
  ...
  assign z6 = (~new_n67_ & (x11 | x12)) | (~x11 & new_n65_ & x12) | (new_n66_ & x11);
  assign new_n65_ = ~new_n37_ & (x06 | (~x14 & x20));
  assign new_n66_ = ~new_n42_ & (~x06 | (x14 & ~x20));
