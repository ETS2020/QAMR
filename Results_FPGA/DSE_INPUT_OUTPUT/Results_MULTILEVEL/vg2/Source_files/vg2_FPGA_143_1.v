...
module FAU ( 
  ...
  assign new_n43_ = new_n44_ & ~x22 & ~x23 & ~x24 & ~x17 & ~x20;
  ...
  assign new_n54_ = (~new_n46_ | ~new_n55_) & (~new_n50_ | ~new_n57_ | ~new_n44_ | ~new_n58_);
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n76_ & ~x16))) | (z7 & (~x08 | (~new_n77_ & x16)));
