...
module FAU ( 
  ...
  assign z4 = (~new_n44_ & (new_n61_ | ~x08)) | new_n55_ | (~new_n37_ & (x08 ? ~new_n55_ : new_n62_));
  assign new_n61_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n62_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & ~new_n55_;
  assign z6 = (~new_n67_ & ~new_n55_) | (new_n65_ & ~x11) | (new_n66_ & x11);
  ...
  assign new_n72_ = ~new_n45_ & (x05 | x13 | ~x15) & ~new_n55_ & (~new_n73_ | ~x13);
