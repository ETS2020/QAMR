...
module FAU ( 
  ...
  assign z4 = new_n80_ | new_n86_ | ~new_n87_ | (~x16 & ~new_n90_ & ~new_n82_);
  assign new_n80_ = x24 & (new_n85_ | (~new_n60_ & (new_n81_ | (~new_n83_ & x18))));
  assign new_n81_ = x07 & (x08 ? (~x02 | x12) : (~new_n82_ & ~x16));
  ...
  assign new_n86_ = ~new_n83_ & (new_n64_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n87_ = (~x02 | x12) & (new_n88_ | ~x08);
  ...
  assign z5 = new_n38_ | (~new_n92_ & (~x02 | x12));
  assign new_n92_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = new_n94_ | new_n95_ | (x02 & ~x12) | (~new_n100_ & ~x03);
  ...
  assign new_n102_ = (~x18 | (~x05 & ~x13) | (x02 & ~x12)) & (x13 | ~x15 | x05 | ~x12);
  assign z7 = new_n64_ | (~new_n104_ & (~x02 | x12));
