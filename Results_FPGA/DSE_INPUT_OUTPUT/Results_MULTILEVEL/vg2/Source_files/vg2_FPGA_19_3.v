...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n82_, new_n85_, new_n87_, new_n88_, new_n89_, new_n90_;
  ...
  assign z4 = ~new_n78_ | (x21 & (x16 | (new_n82_ & ~x02 & ~x08)));
  assign new_n78_ = (new_n79_ | (~new_n80_ & x08)) & (new_n37_ | (~new_n81_ & (new_n39_ | ~x08)));
  ...
  assign new_n82_ = ~x10 & ~x24;
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = new_n85_ | new_n87_ | (x00 & ~x02 & new_n90_ & ~x10);
  assign new_n85_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n79_ & (~x16 | ~x21)) | (~x02 & ~x10 & ~x16 & x21 & ~x24);
  assign new_n87_ = ~new_n39_ & (new_n88_ | (x00 & ~x02 & new_n82_ & x03));
  assign new_n88_ = ~new_n89_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n89_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n90_ = ~x11 & ~x21 & ~x24 & (x06 | (~x14 & x20));
endmodule
