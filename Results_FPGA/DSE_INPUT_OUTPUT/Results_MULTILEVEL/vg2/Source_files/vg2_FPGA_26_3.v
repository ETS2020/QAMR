...
module FAU ( 
  ...
  assign z7 = (~new_n47_ & x05) | new_n49_ | (~x13 & (new_n48_ | (~x05 & x15)));
  ...
  assign z4 = (~new_n57_ & (new_n61_ | x08)) | new_n53_ | (~new_n52_ & (new_n62_ | ~x08));
  assign new_n57_ = ~new_n60_ & new_n58_ & (~x07 | ~x13 | ~x24);
  assign new_n58_ = ~new_n59_ & (x05 | x13 | ~x19);
  assign new_n59_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n60_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = new_n60_ | ~new_n58_ | (x13 & (x21 | (x07 & x24)));
  assign z6 = (~new_n37_ & (x03 | (~new_n66_ & ~x11))) | (z7 & (~x03 | (~new_n65_ & x11)));
  assign new_n65_ = x06 & (~x14 | x20);
  assign new_n66_ = ~x06 & (x14 | ~x20);
endmodule
