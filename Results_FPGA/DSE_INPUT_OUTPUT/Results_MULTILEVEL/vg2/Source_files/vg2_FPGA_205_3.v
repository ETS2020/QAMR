...
module FAU ( 
  ...
  assign z4 = new_n80_ | (new_n84_ & x00) | (z7 & (new_n85_ | ~x08));
  assign z7 = (~new_n79_ & (~x12 | ~x21)) | (~x02 & ~x10 & ~x12 & x21 & ~x24);
  assign new_n79_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n80_ = ~new_n39_ & (new_n83_ | (~new_n81_ & (x08 | (~new_n82_ & ~x16))));
  ...
  assign new_n84_ = ~x02 & ~x10 & ~x16 & ~x21 & ~new_n82_ & ~x24;
