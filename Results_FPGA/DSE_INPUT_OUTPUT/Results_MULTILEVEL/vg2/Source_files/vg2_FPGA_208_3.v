...
module FAU ( 
  ...
  assign z3 = new_n74_ | (~new_n39_ & ((~new_n69_ & ~new_n77_) | new_n64_ | new_n72_));
  assign new_n64_ = x24 & (new_n65_ | new_n67_) & (x05 | x13);
  assign new_n65_ = new_n66_ & x11 & x14 & x18 & x20;
  assign new_n66_ = x01 & x03 & x06 & x08;
  assign new_n67_ = new_n68_ & ~x06 & x07 & ~x01 & ~x03;
  ...
  assign new_n75_ = x01 & ~x02 & x03 & ~x04 & x06 & x08;
  assign new_n76_ = x20 & x21 & ~x24 & ~x10 & x11 & x14;
  assign new_n77_ = x05 ? (~x13 | x24) : x13;
  assign z4 = new_n79_ | (~x04 & (new_n83_ | new_n86_ | (~new_n61_ & ~new_n85_)));
  assign new_n79_ = ~x21 & ((~new_n37_ & (new_n80_ | x08)) | (~new_n82_ & (new_n81_ | ~x08)));
  assign new_n80_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n81_ = x16 & (~x09 | (~x17 & x22));
  assign new_n82_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n83_ = ~new_n84_ & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  assign new_n84_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n85_ = x08 & (~x16 | (x09 & (~x22 | (x17 & ~x23))));
  assign new_n86_ = x00 & ~x02 & x08 & ~x10 & ~x24;
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = new_n89_ | new_n92_ | (~new_n39_ & (new_n91_ | new_n94_));
  assign new_n89_ = ~new_n90_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = (new_n82_ | (x04 & x21)) & (x02 | x04 | x10 | ~x21 | x24);
  assign new_n91_ = ~new_n84_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n92_ = x00 & ~x02 & new_n93_ & ~x10;
  assign new_n93_ = ~x11 & ~x21 & ~x24 & (x06 | (~x14 & x20));
  assign new_n94_ = x00 & ~x02 & x03 & ~x10 & ~x24;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n96_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n96_ = x21 & (x04 | (~x02 & ~x10 & ~x24));
endmodule
