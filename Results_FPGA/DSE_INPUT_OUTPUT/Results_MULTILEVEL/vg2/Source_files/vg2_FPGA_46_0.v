// Benchmark "FAU" written by ABC on Tue Aug 18 17:43:37 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n74_, new_n76_, new_n77_, new_n78_, new_n81_, new_n82_;
  ...
  assign z3 = (~new_n72_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n69_ | (x24 & ~new_n65_ & (x05 | x13));
  ...
  assign new_n70_ = (~new_n37_ | ~new_n67_) & (~new_n68_ | ~new_n71_);
  assign new_n71_ = x11 & x14 & x20 & x21;
  ...
  assign z4 = (~new_n76_ & (x08 | (~new_n77_ & ~x16))) | (~new_n62_ & (~x08 | (~new_n78_ & x16)));
  assign new_n76_ = (new_n39_ | (~x02 & ~x12)) & (~x00 | x02 | x10 | ~x12 | x24);
  assign new_n77_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n78_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n39_ | (~x02 & (~x12 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n76_ & (x03 | (~new_n81_ & ~x11))) | (~new_n62_ & (~x03 | (~new_n82_ & x11)));
