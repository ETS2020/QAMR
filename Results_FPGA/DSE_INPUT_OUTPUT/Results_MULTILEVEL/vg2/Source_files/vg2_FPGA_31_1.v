...
module FAU ( 
  ...
  assign z7 = (~new_n56_ & x05) | (~new_n55_ & x13) | (~x05 & ~x13 & x15 & ~x21);
  assign new_n55_ = ~new_n51_ & (~x18 | ~x24);
  assign new_n56_ = (~x13 | ~x15 | x24) & (~x18 | x21 | ~x24);
  assign z3 = (~x24 & (new_n70_ | (~new_n58_ & x13))) | (~new_n62_ & x24) | (~new_n66_ & ~x13);
  assign new_n58_ = (~x01 | ~x03 | ~new_n59_ | ~x06) & (~new_n61_ | x01 | x03 | ~x05 | x06);
  assign new_n59_ = x08 & x11 & new_n60_ & x14;
  assign new_n60_ = x20 & ((x05 & x15) | (~x02 & ~x10 & x21));
  assign new_n61_ = ~x08 & ~x11 & ~x14 & x19 & ~x20;
  assign new_n62_ = x01 ? (~x03 | ~new_n63_ | ~x06) : (x03 | x06 | ~new_n65_ | ~x07);
  assign new_n63_ = x08 & new_n64_ & x11;
  assign new_n64_ = x14 & x18 & x20 & (x13 | (x05 & ~x21));
  assign new_n65_ = ~x08 & ~x11 & ~x14 & ~x20 & (x05 | x13);
  assign new_n66_ = ~x21 & (new_n67_ | x05);
