...
module FAU ( 
  ...
  assign z4 = (~new_n65_ & (new_n79_ | ~x08)) | new_n80_ | (~new_n37_ & (x08 ? ~new_n80_ : new_n81_));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n80_ = x03 & ~x12;
  assign new_n81_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & ~new_n80_;
  assign z6 = (~new_n37_ & (x03 ? x12 : new_n84_)) | (~new_n65_ & (new_n85_ | ~x03));
  assign new_n84_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n85_ = x11 & x12 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n65_ & ~new_n80_;
endmodule
