...
module FAU ( 
  ...
  assign new_n73_ = (new_n74_ | (x01 & x21)) & (~x00 | ~new_n78_ | x02);
  ...
  assign z7 = (~new_n61_ & (~x01 | ~x21)) | (~x01 & ~x02 & ~x10 & x21 & ~x24);
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (~x01 | ~x21);
  assign z6 = new_n83_ | new_n86_ | (~new_n84_ & (~x01 | ~x21));
  assign new_n83_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n84_ = ~new_n85_ & (~x00 | x02 | ~x03 | x10 | x24);
  assign new_n85_ = ~new_n75_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n86_ = x00 & ~x02 & ~x10 & new_n87_ & ~x11;
  assign new_n87_ = ~x21 & ~x24 & (x06 | (~x14 & x20));
endmodule
