...
module FAU ( 
  ...
  assign z4 = (~new_n43_ & ~new_n63_) | (~new_n37_ & ~new_n61_);
  assign new_n61_ = ((~x12 & ~x22) | (~x08 & (~x09 | x16))) & (~x12 | x16 | new_n62_ | x22);
  assign new_n62_ = ~x17 & (~x04 | x23);
  assign new_n63_ = (~x16 | new_n64_ | ~x22) & ((~x12 & ~x22) | (x08 & (x09 | ~x16)));
  ...
  assign z6 = (~new_n37_ & (new_n69_ | x03)) | new_n39_ | (~new_n43_ & (new_n70_ | ~x03));
  ...
  assign new_n72_ = ~new_n39_ & ~new_n44_;
endmodule
