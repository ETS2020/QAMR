...
module FAU ( 
  ...
  assign z2 = x01 & x03 & new_n42_ & x06;
  assign new_n42_ = x11 & x14 & ~new_n39_ & x20;
  assign z3 = x01 & x03 & x06 & new_n42_ & x08;
  assign z4 = ~z0 & ((~new_n45_ & (new_n47_ | x08)) | (~new_n39_ & (new_n48_ | ~x08)));
  ...
  assign z6 = ~new_n51_ | (~new_n45_ & (x03 | (x06 & ~x11)));
  assign new_n51_ = (x11 | x14) & (new_n39_ | ((x03 | (~x11 & ~x14)) & (~x11 | (x06 & (~x14 | x20)))));
  assign z7 = ~new_n39_ & ~z0;
endmodule
