...
module FAU ( 
  ...
  assign z2 = x01 & x03 & x06 & x11 & new_n60_ & x14;
  assign new_n60_ = x20 & (new_n61_ | new_n63_);
  assign new_n61_ = ~new_n62_ & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  assign new_n62_ = ~x02 & x12;
  assign new_n63_ = ~x02 & ~x10 & ~x12 & x21 & ~x24;
  assign z3 = (~new_n73_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n69_ | (x24 & ~new_n65_ & (x05 | x13));
  assign new_n65_ = ~new_n66_ & (~new_n68_ | ~x11 | ~x14 | ~x18 | ~x20);
  assign new_n66_ = new_n67_ & ~x01 & ~x03 & ~x06 & x07;
  assign new_n67_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n68_ = x01 & x03 & x06 & x08;
  assign new_n69_ = ~x02 & (x12 | (~x10 & ~new_n70_ & ~x24));
  assign new_n70_ = (~new_n67_ | ~new_n71_) & (~new_n68_ | ~new_n72_);
  assign new_n71_ = x00 & ~x01 & ~x03 & ~x06;
  assign new_n72_ = x11 & x14 & x20 & x21;
  assign new_n73_ = (~new_n74_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n75_ | x06 | x08 | x01 | x03);
  assign new_n74_ = x11 & x14 & x15 & x20;
  assign new_n75_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n77_ & (new_n81_ | x08)) | new_n62_ | (~new_n79_ & (new_n82_ | ~x08));
  assign new_n77_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n78_ & (x05 | x13 | ~x19);
  ...
  assign z6 = new_n85_ | (new_n86_ & x11) | new_n90_ | (new_n61_ & ~x03);
  assign new_n85_ = ~new_n77_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n86_ = (~x06 | (x14 & ~x20)) & (new_n89_ | (~new_n87_ & ~x24));
  assign new_n87_ = (~new_n88_ | x02) & (~x05 | ~x13 | ~x15 | (~x02 & x12));
  assign new_n88_ = ~x10 & x21 & (x05 ? ~x12 : x03);
  assign new_n89_ = x03 & ((~x05 & ~x13 & x15) | (x18 & x24 & (x05 | x13)));
  assign new_n90_ = ~x02 & (x12 | (~x03 & ~x10 & ~x12 & x21 & ~x24));
  assign z7 = new_n61_ | new_n63_;
endmodule
