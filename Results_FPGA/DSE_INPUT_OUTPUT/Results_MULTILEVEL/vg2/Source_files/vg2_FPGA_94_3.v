...
module FAU ( 
  ...
  assign new_n49_ = x11 & ~x12 & x14 & ~new_n50_ & x20;
  ...
  assign new_n55_ = x11 & ~x12 & x14 & x18 & x20;
  ...
  assign z6 = (~new_n37_ & (new_n67_ | x03)) | new_n39_ | (~new_n45_ & (new_n68_ | ~x03));
  assign new_n67_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n70_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
