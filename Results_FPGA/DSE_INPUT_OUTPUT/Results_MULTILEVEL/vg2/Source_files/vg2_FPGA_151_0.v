...
module FAU ( 
  ...
  assign new_n36_ = ~x20 & ~new_n37_ & x21;
  ...
  assign z2 = (x01 & x03 & new_n57_ & x06) | (~x06 & ~x21);
  assign new_n57_ = x11 & x14 & ~new_n58_ & x20;
  ...
  assign new_n68_ = ~new_n69_ & (~x00 | x02 | ~x06 | x10 | x24);
  assign new_n69_ = ~new_n70_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n70_ = ~x06 & ~x21;
  assign z7 = new_n59_ | (~new_n55_ & ~new_n70_);
  assign new_n72_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n73_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n74_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z5 = (~new_n77_ & x05) | ~new_n76_ | new_n70_ | (~x05 & ~x13 & x19);
  assign new_n76_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n77_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n79_ & ~x24) | (~new_n88_ & x24) | new_n70_ | (new_n93_ & ~x05);
  assign new_n79_ = new_n80_ & (~x03 | (~new_n87_ & (~x05 | ~x13 | ~x19)));
  assign new_n80_ = (~new_n81_ | x02) & (~new_n83_ | ~x05) & (x05 | ~new_n86_ | ~x11);
  assign new_n81_ = ~x10 & ((~new_n82_ & x21) | (x00 & (x06 ? ~x11 : x21)));
  assign new_n82_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n83_ = x13 & ((new_n85_ & ~x11) | (~new_n84_ & x15));
  assign new_n84_ = (x03 | (~x06 & ~x21)) & (~x11 | (x06 ? (~x14 | x20) : ~x21));
  assign new_n85_ = x19 & (x06 | (~x14 & x20));
  assign new_n86_ = ~x13 & x15 & (x06 ? (x14 & ~x20) : x21);
  assign new_n87_ = x00 & ~x02 & x06 & ~x10;
  assign new_n88_ = (~x03 | (~new_n89_ & (~x07 | (~x05 & ~x13)))) & (new_n91_ | (~x05 & ~x13));
  assign new_n89_ = x11 & ~new_n90_ & (~x06 | (x14 & ~x20));
  assign new_n90_ = (x05 | x13 | ~x15) & (~x18 | (~x05 & ~x13));
  assign new_n91_ = (x03 | new_n70_ | ~x18) & (~new_n92_ | ~x07);
  assign new_n92_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n93_ = ~x13 & ((~x03 & ~new_n70_ & x15) | (x19 & (new_n92_ | x03)));
endmodule
