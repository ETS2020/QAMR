...
module FAU ( 
  ...
  assign z4 = (~new_n45_ & (~x08 | (~new_n66_ & x16))) | (z5 & (x08 | (~new_n67_ & ~x16)));
  assign new_n66_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n67_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z6 = new_n69_ | (~new_n45_ & ~new_n70_);
  assign new_n69_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n70_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign z7 = ~new_n72_ | (~x05 & (x21 | (~x13 & x15)));
  assign new_n72_ = (~x05 | (x24 ? ~x18 : new_n73_)) & ~new_n74_ & (~x13 | ~x18 | ~x24);
  assign new_n73_ = (~x13 | ~x15) & (x02 | x10 | new_n70_ | ~x21);
  assign new_n74_ = ~x02 & x03 & ~x10 & x21 & ~x24;
endmodule
