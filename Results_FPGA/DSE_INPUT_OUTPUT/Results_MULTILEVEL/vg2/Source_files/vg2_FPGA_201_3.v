...
module FAU ( 
  ...
  assign z4 = (~new_n83_ & (~x08 | (~new_n86_ & x16))) | (z5 & (x08 | (~new_n85_ & ~x16)));
  assign z5 = (~new_n82_ & (~x02 | ~x12)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n82_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n83_ = ~new_n65_ & (new_n84_ | (x02 & x12));
  ...
  assign z6 = (~new_n83_ & (~x03 | (~new_n89_ & x11))) | (z5 & (x03 | (~new_n88_ & ~x11)));
  assign new_n88_ = ~x06 & (x14 | ~x20);
  assign new_n89_ = x06 & (~x14 | x20);
  assign z7 = (~new_n91_ & x05) | ~new_n92_ | new_n65_ | (~x05 & ~x13 & x15);
