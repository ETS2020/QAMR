...
module FAU ( 
  ...
  assign z7 = (~new_n66_ & (x12 | x21)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = ~new_n71_ | (~x24 & (x01 ? (new_n68_ & x03) : (new_n80_ & ~x03)));
  assign new_n68_ = x06 & x08 & x11 & x14 & ~new_n69_ & x20;
  assign new_n69_ = ~new_n70_ & (x02 | x10 | ~x21);
  assign new_n70_ = x15 & ~new_n39_ & (x05 ^ ~x13);
  assign new_n71_ = ~new_n78_ & ~new_n39_ & (~x24 | (~new_n76_ & (new_n72_ | new_n62_)));
  ...
  assign z4 = (~new_n82_ & (new_n84_ | x08)) | new_n86_ | (z7 & (new_n85_ | ~x08));
  assign new_n82_ = ~new_n83_ & (~x00 | x02 | x10 | ~x12 | x24);
  assign new_n83_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  ...
  assign z6 = (~new_n82_ & (new_n91_ | x03)) | new_n86_ | (z7 & (new_n92_ | ~x03));
