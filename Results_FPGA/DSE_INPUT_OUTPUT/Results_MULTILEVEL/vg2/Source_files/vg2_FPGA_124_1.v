...
module FAU ( 
  ...
  assign new_n40_ = x01 ? (~x03 | ~new_n41_ | ~x04) : (x03 | x04 | ~new_n44_ | x06);
  ...
  assign z4 = (~new_n64_ & (new_n78_ | ~x08)) | new_n61_ | (~new_n37_ & (x08 ? ~new_n61_ : new_n79_));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & ~new_n61_;
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | new_n61_ | (~new_n64_ & (x03 ? new_n83_ : ~new_n61_));
  assign new_n82_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n83_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n64_ & ~new_n61_;
endmodule
