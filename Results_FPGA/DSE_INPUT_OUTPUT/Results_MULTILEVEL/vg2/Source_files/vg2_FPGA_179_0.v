...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n53_ | (~new_n61_ & (new_n45_ | new_n49_));
  ...
  assign new_n53_ = x24 & ~new_n60_ & (new_n56_ | (new_n46_ & new_n54_));
  ...
  assign new_n71_ = ~x02 & (~x12 | (~x10 & ~x24 & (new_n72_ | new_n73_)));
  assign new_n72_ = new_n69_ & x00 & ~x01 & ~x03 & ~x06;
  assign new_n73_ = new_n70_ & x11 & x14 & x20 & x21;
  ...
  assign z4 = ~new_n78_ | (~new_n83_ & (x08 ? x12 : new_n85_));
  assign new_n78_ = (~new_n79_ | ~x24) & ~new_n81_ & (new_n82_ | x02);
  assign new_n79_ = ~new_n60_ & ((x18 & (new_n80_ | ~x08)) | (x02 & x07 & x08));
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n81_ = ~new_n61_ & ((x15 & (new_n80_ | ~x08)) | (x02 & x08 & x19));
  assign new_n82_ = x12 & (x10 | ~x21 | x24 | (~new_n80_ & x08));
