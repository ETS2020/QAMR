...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n45_,
    new_n46_, new_n47_, new_n48_, new_n51_;
  ...
  assign z4 = ~new_n39_ & ((~new_n37_ & (new_n47_ | x08)) | (~new_n45_ & (new_n48_ | ~x08)));
  ...
  assign z6 = new_n51_ | (x11 & x14) | (~new_n45_ & ((~x03 & (~x11 | ~x14)) | (~x06 & x11 & ~x14)));
  assign new_n51_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
