...
module FAU ( 
  ...
  assign z2 = (~x11 & ~x12) | (x01 & x03 & x06 & new_n46_ & x11);
  assign new_n46_ = x14 & ~new_n42_ & x20;
  assign z3 = ~new_n48_ | (~x24 & (x01 ? (new_n56_ & x03) : (new_n58_ & ~x03)));
  assign new_n48_ = (~x24 | new_n49_ | (~x05 & ~x13)) & ~new_n44_ & (x05 | new_n53_ | x13);
  ...
  assign z6 = new_n67_ | (~x11 & ~x12) | (~new_n42_ & ((~x03 & (x11 | x12)) | (~new_n68_ & x11)));
