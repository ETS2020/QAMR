...
module FAU ( 
  ...
  assign z4 = (~new_n82_ & (~x08 | (~new_n84_ & x16))) | (z5 & (x08 | (~new_n83_ & ~x16)));
  assign new_n82_ = (new_n64_ | (~x02 & x12)) & (x02 | x10 | x12 | ~x21 | x24);
  assign new_n83_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n84_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n82_ & (~x03 | (~new_n87_ & x11))) | (z5 & (x03 | (~new_n86_ & ~x11)));
