...
module FAU ( 
  ...
  assign z6 = new_n87_ | (~new_n80_ & ~new_n89_) | (~x02 & ~x12) | (new_n88_ & x02);
  assign new_n87_ = ~new_n78_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n88_ = ~new_n65_ & ~x03;
  assign new_n89_ = x03 ? (~x11 | (x06 & (~x14 | x20))) : ~x12;
endmodule
