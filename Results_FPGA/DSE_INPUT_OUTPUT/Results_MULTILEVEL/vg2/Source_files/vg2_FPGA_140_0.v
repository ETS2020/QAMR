...
module FAU ( 
  ...
  assign z4 = ~new_n62_ | (~new_n43_ & (new_n69_ | ~x08));
  assign new_n62_ = ~new_n63_ & ~new_n39_ & (x16 | ~new_n64_ | x22);
  assign new_n63_ = ~new_n37_ & ((x08 & (x09 | x12)) | (x09 & ~x16));
  assign new_n64_ = (x17 | (x04 & ~x23)) & (~new_n65_ | (~new_n68_ & x05));
  assign new_n65_ = ~new_n66_ & ~new_n67_ & (~x13 | ~x24 | ~x07 | x08);
  assign new_n66_ = ~x05 & ~x13 & x19 & (x24 ? ~x08 : x12);
  assign new_n67_ = x00 & ~x02 & ~x10 & x12 & ~x24;
  assign new_n68_ = (~x07 | x08 | ~x24) & (~x19 | x24 | ~x12 | ~x13);
  assign new_n69_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = ~new_n39_ & (new_n72_ | new_n73_);
  assign new_n72_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n73_ = ~new_n43_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
