...
module FAU ( 
  ...
  assign new_n44_ = ~x06 & ~x08 & ~x09 & ~x11 & new_n45_ & ~x14;
  ...
  assign z2 = (~x06 & x12) | (x01 & x03 & new_n63_ & x06);
  ...
  assign z6 = (~new_n37_ & (new_n86_ | x03)) | new_n84_ | new_n61_ | (~new_n85_ & ~x03);
  assign new_n84_ = x11 & ~new_n64_ & (~x06 | (x14 & ~x20));
  assign new_n85_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & ~new_n65_ & (x05 | (x13 ? (~x18 | ~x24) : ~x15));
  assign new_n86_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n88_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n88_ = ~new_n65_ & (x05 | x13 | ~x15) & ~new_n61_ & (~new_n89_ | ~x13);
