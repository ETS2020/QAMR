...
module FAU ( 
  ...
  assign new_n53_ = x01 & x03 & x04 & x06 & new_n54_ & x08;
  assign new_n54_ = x09 & x11 & x12 & new_n55_ & x14;
  assign new_n55_ = x16 & x17 & x20 & x22 & ~new_n56_ & x23;
  assign new_n56_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z2 = (~x12 & ~x21) | (new_n58_ & x01);
  ...
  assign z3 = new_n72_ | (~new_n62_ & (x12 | x21));
  ...
  assign z4 = (~new_n37_ & (new_n75_ | x08)) | ~new_n77_ | (~new_n59_ & (new_n76_ | ~x08));
  assign new_n75_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n76_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n77_ = (x12 | x21) & (~x00 | x02 | x10 | ~x21 | x24);
  assign z5 = new_n79_ | ~new_n80_ | new_n38_ | (x07 & x13 & x24);
  assign new_n79_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n80_ = (x05 | x13 | ~x19) & (x12 | x21);
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | ~new_n77_ | (~new_n59_ & (new_n83_ | ~x03));
  ...
  assign new_n85_ = ~new_n60_ & (x12 | x21);
endmodule
