...
module FAU ( 
  ...
  assign new_n61_ = (new_n62_ | (~x10 & x12)) & (x02 | x10 | x12 | ~x21 | x24);
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n78_ & ~x16))) | (~new_n61_ & (~x08 | (~new_n79_ & x16)));
  assign new_n78_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n79_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = (x05 & ((x13 & x19 & ~x24) | (x07 & x24))) | new_n81_ | (x07 & x13 & x24) | (~x05 & ~x13 & x19);
  assign new_n81_ = ~x10 & (x12 | (x00 & ~x02 & ~x24));
  assign z6 = new_n83_ | new_n86_ | (~x10 & x12);
  ...
  assign new_n90_ = ~x10 & (x12 | (~x02 & x21 & ~x24));
endmodule
