...
module FAU ( 
  ...
  assign z1 = (~x02 & (new_n40_ | ~x12)) | new_n44_ | new_n53_;
  assign new_n40_ = new_n41_ & new_n43_ & x01 & x03 & x04 & x06;
  assign new_n41_ = new_n42_ & x14 & x16 & x17 & x20;
  assign new_n42_ = x21 & x22 & x23 & ~x24;
  ...
  assign new_n53_ = x24 & (new_n56_ | (new_n45_ & new_n54_)) & (x05 | x13);
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n83_ & ~x16))) | (z7 & (~x08 | (~new_n84_ & x16)));
