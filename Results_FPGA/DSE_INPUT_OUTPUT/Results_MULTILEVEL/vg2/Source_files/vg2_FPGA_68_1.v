...
module FAU ( 
  ...
  assign z4 = (~new_n64_ & ~new_n79_) | (~new_n37_ & ~new_n81_);
  assign new_n79_ = ((~x04 & x12) | (x08 & (new_n80_ | ~x16))) & (x04 | x12 | ~new_n55_ | ~x16);
  assign new_n80_ = x09 & (x17 | ~x22);
  assign new_n81_ = (new_n82_ | (~x04 & x12)) & (x22 | x23 | ~x04 | x16);
  ...
  assign new_n85_ = (x05 | x13 | ~x19) & (x04 | ~x12);
  assign z6 = new_n87_ | (~x04 & x12) | (~new_n64_ & (x03 ? new_n88_ : (x04 | ~x12)));
