...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n85_;
  assign z0 = (new_n36_ & ~x01) | (~x12 & x22);
  ...
  assign new_n74_ = (x12 | ~x22) & (x05 | new_n75_ | x13);
  ...
  assign z4 = ~new_n79_ | (~new_n64_ & (new_n81_ | ~x08));
  assign new_n79_ = (x12 | ~x22) & (new_n37_ | ((~x08 | (~x12 & x22)) & (new_n80_ | x16)));
  assign new_n80_ = (x08 | ~x09) & (x22 | (~x17 & (~x04 | x23)));
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (x12 | ~x22);
  assign z6 = new_n84_ | (~x12 & x22) | (~new_n64_ & (x03 ? new_n85_ : (x12 | ~x22)));
