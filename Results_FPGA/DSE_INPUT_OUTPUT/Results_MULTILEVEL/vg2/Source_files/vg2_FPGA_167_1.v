...
module FAU ( 
  ...
  assign z1 = new_n41_ | new_n58_ | (new_n50_ & x24);
  ...
  assign new_n50_ = ~new_n55_ & (new_n51_ | (new_n42_ & new_n56_ & new_n57_));
  ...
  assign new_n58_ = new_n59_ & new_n60_ & ~x02 & ~x03 & x00 & ~x01;
  assign new_n59_ = new_n53_ & ~x22 & ~x23 & ~x24 & ~x17 & ~x20;
  ...
  assign new_n71_ = x24 & ~new_n55_ & (new_n72_ | new_n74_);
  ...
  assign new_n89_ = ~new_n55_ & ((x18 & (new_n88_ | ~x08)) | (x02 & x07 & x08));
