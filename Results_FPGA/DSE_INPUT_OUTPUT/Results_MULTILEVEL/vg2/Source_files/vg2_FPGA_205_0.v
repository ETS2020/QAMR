...
module FAU ( 
  ...
  assign new_n62_ = (~x24 | new_n63_ | (~x05 & ~x13)) & ~new_n39_ & (x05 | new_n67_ | x13);
  ...
  assign z4 = (~new_n74_ & (new_n77_ | x08)) | new_n79_ | (z7 & (new_n78_ | ~x08));
  assign new_n74_ = ~new_n75_ & (~x00 | x02 | x10 | ~x12 | x24);
  assign new_n75_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign z7 = new_n60_ | (~new_n39_ & ~new_n56_);
  ...
  assign z6 = (~new_n74_ & (new_n82_ | x03)) | new_n79_ | (z7 & (new_n83_ | ~x03));
