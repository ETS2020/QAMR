...
module FAU ( 
  ...
  assign z2 = (x02 & ~x12) | (x01 & x03 & new_n62_ & x06);
  ...
  assign new_n80_ = ~new_n64_ & (new_n81_ | (x02 & ~x12));
  ...
  assign z6 = (~new_n80_ & (~x03 | (~new_n86_ & x11))) | (z5 & (x03 | (~new_n85_ & ~x11)));
  assign new_n85_ = ~x06 & (x14 | ~x20);
  assign new_n86_ = x06 & (~x14 | x20);
  assign z7 = (~new_n88_ & x05) | ~new_n89_ | new_n64_ | (~x05 & ~x13 & x15);
