...
module FAU ( 
  ...
  assign z0 = (new_n36_ & ~x01) | (x21 & x22);
  ...
  assign new_n73_ = (~x21 | ~x22) & (x05 | new_n74_ | x13);
  ...
  assign z4 = new_n78_ | new_n81_ | (z7 & (~x08 | (~x09 & x16)));
  assign new_n78_ = ~x21 & ((~new_n37_ & (x08 | (x09 & ~x16))) | (new_n79_ & x16));
  assign new_n79_ = x22 & ~new_n80_ & (~x17 | (~x04 & x23));
  assign new_n80_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n81_ = ~x22 & ((~new_n37_ & ~new_n82_) | (x09 & ~new_n83_ & ~x16));
  assign new_n82_ = ~x08 & (x16 | (~x17 & (~x04 | x23)));
  assign new_n83_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n80_ & (~x21 | ~x22)) | (~x02 & ~x10 & x21 & ~x22 & ~x24);
  assign z5 = ~new_n37_ & (~x21 | ~x22);
  assign z6 = new_n87_ | new_n90_ | (~new_n88_ & (~x21 | ~x22));
  assign new_n87_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n88_ = ~new_n89_ & (~x00 | x02 | ~x03 | x10 | x24);
  assign new_n89_ = ~new_n83_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = x00 & ~x02 & ~x10 & new_n91_ & ~x11;
  assign new_n91_ = ~x21 & ~x24 & (x06 | (~x14 & x20));
endmodule
