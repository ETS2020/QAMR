...
module FAU ( 
  ...
  assign z6 = ~new_n84_ | (~x11 & ~new_n92_ & (x06 | (~x14 & x20)));
  assign new_n84_ = (~new_n85_ | ~x24) & ~new_n88_ & ~new_n39_ & (~new_n90_ | x02);
  assign new_n85_ = ~new_n86_ & ((x18 & (x03 ? new_n87_ : ~new_n39_)) | (x03 & x07));
  assign new_n86_ = ~x05 & ~x13;
  assign new_n87_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n88_ = ~new_n89_ & ((x03 & x19) | (x15 & (x03 ? new_n87_ : ~new_n39_)));
  assign new_n89_ = x05 ? (~x13 | x24) : x13;
  assign new_n90_ = ~x10 & ~x24 & (x03 ? ~new_n91_ : (~x12 & x21));
  assign new_n91_ = ~x00 & (~x11 | ~x21 | (x06 & (~x14 | x20)));
  assign new_n92_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n93_ & (x05 | x13 | ~x19);
  assign new_n93_ = x00 & ~x02 & ~x10 & ~x21 & ~x24;
  assign z7 = (~new_n95_ & (~x12 | ~x21)) | (~x02 & ~x10 & ~x12 & x21 & ~x24);
