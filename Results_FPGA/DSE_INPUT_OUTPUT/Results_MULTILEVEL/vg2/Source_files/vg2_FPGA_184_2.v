...
module FAU ( 
  ...
  assign z7 = (~new_n56_ & x05) | new_n57_ | (~x05 & ~x13 & x15);
  assign new_n56_ = (x13 | ~x18 | ~x24) & (~x21 | x24 | ~x13 | ~x15);
  assign new_n57_ = x21 & ((x13 & x18 & x24) | (~x02 & ~x10 & ~x24));
  ...
  assign z5 = (~new_n65_ & x05) | new_n60_ | (~x05 & ~x13 & x19) | (~new_n66_ & x13);
  assign new_n65_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n66_ = x21 & (~x07 | ~x24);
  assign z6 = (~new_n68_ & (new_n71_ | x03)) | new_n73_ | (z7 & (new_n72_ | ~x03));
  assign new_n68_ = (new_n69_ | ~x05) & ~new_n70_ & (x13 | (~new_n60_ & (x05 | ~x19)));
  assign new_n69_ = (~x07 | x13 | ~x24) & (~x21 | x24 | ~x13 | ~x19);
  assign new_n70_ = x07 & x13 & x21 & x24;
  assign new_n71_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n72_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n73_ = x13 & x21 & ~x24 & x00 & ~x02 & ~x10;
endmodule
