...
module FAU ( 
  ...
  assign z2 = (x12 & x17) | (new_n43_ & x01);
  ...
  assign new_n61_ = (~new_n62_ | x16) & ((x12 & x17) | (~x08 & (~x09 | x16)));
  assign new_n62_ = ~x22 & ((~x12 & x17) | (x04 & ~x17 & ~x23));
  assign new_n63_ = ((x12 & x17) | (x08 & (x09 | ~x16))) & (~new_n64_ | ~x16);
  assign new_n64_ = x22 & (~x17 | (~x04 & ~x12 & x23));
  assign z5 = ~new_n37_ & (~x12 | ~x17);
  assign z6 = new_n67_ | (x12 & x17) | (~new_n44_ & (x03 ? new_n68_ : (~x12 | ~x17)));
  assign new_n67_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n68_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n44_ & (~x12 | ~x17);
endmodule
