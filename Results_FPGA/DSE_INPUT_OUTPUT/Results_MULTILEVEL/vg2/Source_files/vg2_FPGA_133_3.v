...
module FAU ( 
  ...
  assign z1 = (~new_n41_ & ~x24) | new_n48_ | new_n57_ | (x18 & x22);
  ...
  assign new_n57_ = ~x01 & ~x03 & ~x04 & ~x06 & new_n58_ & x07;
  assign new_n58_ = ~x08 & ~x09 & ~x11 & new_n59_ & ~x12;
  assign new_n59_ = ~x14 & ~x16 & ~x17 & new_n60_ & ~x20;
  assign new_n60_ = ~x22 & ~x23 & x24 & (x05 | x13);
  assign z2 = (new_n62_ & x01) | (x18 & x22);
  assign new_n62_ = x03 & x06 & x11 & x14 & ~new_n63_ & x20;
  assign new_n63_ = ~new_n66_ & new_n64_ & (~x13 | ~x18 | ~x24);
  ...
  assign new_n75_ = (~x18 | ~x22) & (x05 | new_n76_ | x13);
  ...
  assign z4 = (~new_n86_ & (x05 ? (x13 & ~x24) : ~x13)) | ~new_n80_ | (x24 & ~new_n87_ & (x05 | x13));
  assign new_n80_ = (~new_n81_ | x02) & (~x18 | ~x22);
  assign new_n81_ = ~x10 & ~x24 & ((~new_n82_ & x00) | (~new_n84_ & x21));
  assign new_n82_ = (~x08 | (x18 & x22)) & (x16 | ((new_n83_ | x22) & (x08 | ~x09)));
  assign new_n83_ = ~x17 & (~x04 | x23);
  assign new_n84_ = ~new_n85_ & x08;
  assign new_n85_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n86_ = (new_n82_ | ~x19) & (new_n84_ | ~x15);
  assign new_n87_ = (new_n82_ | ~x07) & (~x18 | (x08 & (x09 | ~x16)));
  assign z6 = new_n90_ | new_n89_ | (x18 & x22);
  assign new_n89_ = ~new_n63_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign z7 = new_n66_ | ~new_n64_ | (x18 & (x22 | (x13 & x24)));
endmodule
