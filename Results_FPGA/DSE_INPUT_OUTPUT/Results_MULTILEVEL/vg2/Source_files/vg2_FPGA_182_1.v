...
module FAU ( 
  ...
  assign new_n36_ = ~x14 & (x01 | x03 | x06 | new_n37_ | x20);
  ...
  assign new_n41_ = x08 & x09 & x12 & new_n42_ & x14;
  ...
  assign new_n53_ = x09 & x12 & x06 & x08;
  assign new_n54_ = x22 & x23 & x18 & x20;
  assign new_n55_ = (x05 | (~new_n56_ & ~new_n58_) | x13) & (x11 | ~x14);
  ...
  assign new_n63_ = ~new_n66_ & new_n64_ & ~new_n67_;
  ...
  assign z4 = ~new_n80_ & (x11 | ~x14);
  assign new_n80_ = (new_n37_ | (~x08 & (new_n81_ | x16))) & (new_n63_ | (x08 & (new_n82_ | ~x16)));
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n37_ & (x11 | ~x14);
  assign z6 = ~new_n85_ | (~new_n37_ & (x03 | (~x11 & (x06 | x20))));
  assign new_n85_ = (new_n86_ | x03) & new_n89_ & (new_n91_ | (new_n64_ & ~new_n66_));
  assign new_n86_ = ~new_n88_ & ((~x11 & x14) | (~new_n66_ & (new_n87_ | x24)));
  assign new_n87_ = (x05 | x13 | ~x15) & (x02 | x10 | ~x21);
  assign new_n88_ = ~x05 & x24 & (x13 ? x18 : x15);
  assign new_n89_ = (~x14 | (~new_n90_ & x11)) & (~new_n67_ | x06 | ~x11);
  assign new_n90_ = ~x05 & ~x20 & x24 & (x13 ? x18 : x15);
  assign new_n91_ = (x06 | ~x11) & (~x03 | ~x14 | x20);
  assign z7 = ~new_n63_ & (x11 | ~x14);
endmodule
