...
module FAU ( 
  ...
  assign z1 = new_n65_ | (x00 & (~new_n48_ | (~new_n41_ & ~x24)));
  ...
  assign new_n47_ = ~x23 & ((x05 & x13 & x19) | (~x02 & ~x10));
  ...
  assign new_n59_ = (~new_n50_ | ~new_n60_) & (~new_n55_ | ~new_n62_ | ~new_n63_ | ~new_n64_);
  ...
  assign new_n65_ = ~x21 & (new_n49_ | (~new_n59_ & (x05 ? (x13 & ~x24) : ~x13)));
  ...
  assign z4 = new_n83_ | (~new_n37_ & (new_n84_ | x08)) | (~new_n85_ & (new_n86_ | ~x08));
  assign new_n83_ = x21 & (~x00 | (~x02 & ~x08 & ~x10 & ~x24));
  ...
  assign z6 = ~new_n91_ | (x21 & (new_n38_ | ~x00));
  assign new_n91_ = ~new_n92_ & (~new_n93_ | ~x11) & (x03 | new_n39_ | new_n85_);
  assign new_n92_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n93_ = (~x06 | (x14 & ~x20)) & (new_n95_ | (~new_n94_ & x15));
  assign new_n94_ = (x24 | new_n39_ | (~x05 ^ ~x13)) & (x13 | ~x24 | ~x03 | x05);
  assign new_n95_ = x03 & x18 & x24 & (x05 | x13);
  assign z7 = (~new_n85_ & (x00 | ~x21)) | (x00 & ~x02 & ~x10 & x21 & ~x24);
endmodule
