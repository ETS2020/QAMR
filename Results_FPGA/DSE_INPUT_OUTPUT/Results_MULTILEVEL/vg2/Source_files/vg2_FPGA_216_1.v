...
module FAU ( 
  ...
  assign z7 = new_n71_ | new_n70_ | (~x05 & ~x13 & x15 & ~x21);
  assign new_n70_ = x05 & (new_n66_ | (x18 & x24));
  assign new_n71_ = x13 & ((x18 & ~x21 & x24) | (x05 & x15 & ~x24));
  assign z4 = ~new_n73_ | (~new_n81_ & (x08 ? ~x21 : new_n77_));
  assign new_n73_ = (~x05 | (~new_n76_ & (new_n74_ | new_n80_))) & (new_n74_ | new_n79_) & (x05 | ~x21);
  assign new_n74_ = ~new_n75_ & x08;
  assign new_n75_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n76_ = (new_n77_ | x08) & (x24 ? x07 : ~new_n78_);
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = (~x13 | ~x19) & (~x00 | x02 | x10);
  assign new_n79_ = (x05 | x13 | ~x15) & ~new_n66_ & (~x13 | ~x18 | ~x24);
  assign new_n80_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n81_ = (x05 | x13 | ~x19) & ~new_n82_ & (~x07 | ~x13 | ~x24);
  assign new_n82_ = ~x10 & ~x24 & x00 & ~x02;
  assign z6 = new_n84_ | new_n86_ | new_n90_ | (~x03 & (new_n70_ | new_n71_));
  assign new_n84_ = ~new_n85_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n85_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n82_ & (x05 | x13 | ~x19);
  assign new_n86_ = x11 & ~new_n87_ & (x24 ? ~new_n88_ : ~new_n89_);
  assign new_n87_ = x06 & (~x14 | x20);
  assign new_n88_ = (~x03 | ((x05 | x13 | ~x15) & (~x13 | ~x18))) & (~x05 | ~x18);
  assign new_n89_ = (x05 | x13 | ~x15 | x21) & (~x05 | ((~x13 | ~x15) & (x02 | x10 | ~x21)));
  assign new_n90_ = ~x05 & (x21 | (~x03 & ~x13 & x15 & ~x21));
endmodule
