...
module FAU ( 
  ...
  assign new_n46_ = x11 & x14 & x20 & ~new_n43_ & (x08 | x23);
  ...
  assign new_n57_ = (x08 | x23) & (x05 | new_n58_ | x13);
  ...
  assign z4 = (~new_n43_ & ~new_n62_) | (~new_n38_ & ~new_n64_);
  assign new_n62_ = (x08 | ~x23) & (~x16 | ((new_n63_ | ~x08) & (x04 | ~x22 | ~x23)));
  assign new_n63_ = x09 & (x17 | ~x22);
  assign new_n64_ = ~x08 & (x16 | ~x23 | (~x09 & (~x17 | x22)));
  assign z6 = (x08 | x23) & (new_n66_ | new_n67_);
  ...
  assign new_n69_ = ~new_n44_ & (x08 | x23);
endmodule
