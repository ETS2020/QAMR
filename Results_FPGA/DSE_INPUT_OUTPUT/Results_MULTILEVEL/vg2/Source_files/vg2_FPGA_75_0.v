...
module FAU ( 
  ...
  assign z6 = (~new_n89_ & x20) | (~new_n90_ & x21);
  assign new_n89_ = (new_n37_ | (~x03 & (x11 | (~x06 & x14)))) & (new_n83_ | (x03 & (x06 | ~x11)));
  assign new_n90_ = ~new_n91_ & ~new_n38_ & (new_n81_ | (~x03 & (~x06 | x11)));
  assign new_n91_ = ~new_n92_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n92_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n93_ & (x05 | x13 | ~x15);
  assign new_n93_ = ~x02 & ~x10 & ~x24;
endmodule
