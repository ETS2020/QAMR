...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_,
    ...
    new_n76_, new_n79_, new_n80_, new_n81_, new_n82_;
  ...
  assign z3 = ~new_n57_ | (~x24 & (x01 ? (new_n67_ & x03) : (new_n65_ & ~x03)));
  assign new_n57_ = (~x24 | new_n58_ | (~x05 & ~x13)) & (x05 | (~x21 & (new_n62_ | x13)));
  assign new_n58_ = ~new_n59_ & (~new_n61_ | x01 | x03 | x06 | ~x07);
  ...
  assign new_n66_ = ~new_n39_ & (~x00 | x02 | x10);
  ...
  assign z5 = (~new_n76_ & x05) | ~new_n75_ | (~x05 & (x21 | (~x13 & x19)));
  assign new_n75_ = ~new_n71_ & (~x07 | ~x13 | ~x24);
  assign new_n76_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (x03 | (~new_n82_ & ~x11))) | (z7 & (~x03 | (~new_n81_ & x11)));
  assign z7 = (~new_n80_ & x13) | (~new_n79_ & x05) | (~x05 & ~x13 & x15 & ~x21);
  assign new_n79_ = ~new_n51_ & (~x18 | ~x24);
  assign new_n80_ = (~x18 | x21 | ~x24) & (~x05 | ~x15 | x24);
