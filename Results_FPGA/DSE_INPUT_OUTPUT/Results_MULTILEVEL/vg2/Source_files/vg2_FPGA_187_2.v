...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | (new_n47_ & x24) | new_n59_ | (~new_n56_ & x03);
  ...
  assign new_n49_ = new_n50_ & x14 & x16 & x17;
  ...
  assign new_n56_ = x12 & (~new_n57_ | ~new_n51_ | ~x01 | ~x04 | x05);
  assign new_n57_ = new_n58_ & x15 & x16 & ~x13 & x14;
  ...
  assign new_n69_ = x11 & x12 & x14 & ~new_n43_ & x20;
  ...
  assign z4 = ~new_n79_ & (~x03 | x12);
  assign new_n79_ = (new_n37_ | (~x08 & (new_n80_ | x16))) & (new_n65_ | (x08 & (new_n81_ | ~x16)));
  assign new_n80_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n81_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = new_n83_ | ~new_n84_ | new_n38_ | (x07 & x13 & x24);
  assign new_n83_ = x05 & ((x13 & x19 & ~x24) | (x07 & x24));
  assign new_n84_ = (x05 | x13 | ~x19) & (~x03 | x12);
  assign z6 = (~new_n37_ & (x03 ? x12 : new_n86_)) | (~new_n65_ & (new_n87_ | ~x03));
  assign new_n86_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n87_ = x11 & x12 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n65_ & (~x03 | x12);
endmodule
