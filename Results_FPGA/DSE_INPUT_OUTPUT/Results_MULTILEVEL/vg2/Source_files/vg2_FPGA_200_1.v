...
module FAU ( 
  ...
  assign new_n63_ = x06 & x11 & x14 & x17 & ~new_n64_ & x20;
  ...
  assign z4 = (~new_n37_ & (new_n78_ | x08)) | new_n39_ | (~new_n64_ & (new_n79_ | ~x08));
  ...
  assign z6 = (~new_n37_ & (new_n84_ | x03)) | new_n39_ | (~new_n64_ & (new_n85_ | (~new_n39_ & ~x03)));
  assign new_n84_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n85_ = x11 & ((x03 & ~x06) | (x14 & ~x20));
  assign z7 = ~new_n64_ & ~new_n39_;
endmodule
