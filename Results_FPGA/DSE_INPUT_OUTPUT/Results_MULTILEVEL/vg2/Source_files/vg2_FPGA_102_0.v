...
module FAU ( 
  ...
  assign z6 = new_n85_ | (~new_n78_ & ~new_n87_) | (new_n86_ & x02) | (~x02 & ~x12);
  assign new_n85_ = ~new_n76_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n86_ = ~new_n62_ & ~x03;
  assign new_n87_ = x03 ? (~x11 | (x06 & (~x14 | x20))) : ~x12;
endmodule
