...
module FAU ( 
  ...
  assign z2 = x01 & x03 & new_n64_ & x06;
  assign new_n64_ = x11 & x14 & ~new_n65_ & x20;
  assign new_n65_ = (new_n66_ | ~x13) & (new_n67_ | ~x05) & (x05 | x13 | ~x15 | x21);
  assign new_n66_ = (~x18 | x21 | ~x24) & (~x05 | ~x15 | x24);
  assign new_n67_ = (~x18 | ~x24) & (~x21 | x24 | x02 | x10);
  assign z3 = x01 ? (x03 & x06 & new_n64_ & x08) : (~x03 & ~x06 & new_n36_ & ~x08);
  assign z4 = (~new_n65_ & (~x08 | (~new_n70_ & x16))) | (~new_n37_ & (x08 | (~new_n71_ & ~x16)));
  assign new_n70_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n71_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z5 = (~new_n73_ & x05) | ~new_n74_ | (~x05 & (x21 | (~x13 & x19)));
  assign new_n73_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n74_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign z6 = new_n76_ | (~new_n65_ & ~new_n77_);
  assign new_n76_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n77_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign z7 = ~new_n79_ | (~x05 & (x21 | (~x13 & x15)));
  assign new_n79_ = (~x05 | (x24 ? ~x18 : new_n80_)) & ~new_n81_ & (~x13 | ~x18 | ~x24);
  assign new_n80_ = (~x13 | ~x15) & (x02 | x10 | new_n77_ | ~x21);
  assign new_n81_ = ~x02 & x03 & ~x10 & x21 & ~x24;
endmodule
