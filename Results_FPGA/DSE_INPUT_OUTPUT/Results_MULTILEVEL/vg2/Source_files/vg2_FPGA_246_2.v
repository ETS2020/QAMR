...
module FAU ( 
  ...
  assign new_n66_ = (~x24 | new_n67_ | (~x05 & ~x13)) & ~new_n39_ & (x05 | new_n71_ | x13);
  ...
  assign new_n74_ = x06 & x08 & x11 & x14 & ~new_n44_ & x20;
  assign new_n75_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n47_ & ~x20;
  assign z4 = (~new_n63_ & ~new_n79_) | (~new_n37_ & ~new_n77_);
  assign new_n77_ = (new_n78_ | (x12 & ~x23)) & (~x04 | x12 | x16 | x22 | x23);
  assign new_n78_ = ~x08 & (x16 | (~x09 & (~x17 | x22)));
  assign new_n79_ = (new_n80_ | (x12 & ~x23)) & (~x22 | ~x23 | x04 | ~x16);
  ...
  assign new_n86_ = ~new_n63_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n88_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n88_ = ~new_n39_ & ~new_n64_;
endmodule
