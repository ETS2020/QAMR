...
module FAU ( 
  ...
  assign z1 = new_n40_ | (x24 & ~new_n50_ & ~new_n60_) | (new_n56_ & ~x02);
  ...
  assign new_n50_ = (~new_n41_ | ~new_n51_) & (~new_n53_ | ~new_n46_ | ~new_n55_);
  ...
  assign new_n56_ = ~x10 & ~x24 & ((new_n41_ & new_n57_) | (new_n53_ & new_n58_));
  assign new_n57_ = new_n52_ & x20 & x21 & x22 & x23;
  assign new_n58_ = new_n59_ & x00 & ~x01 & ~x03;
  assign new_n59_ = ~x08 & ~x09 & ~x04 & ~x06;
  assign new_n60_ = ~x05 & ~x13;
  assign z2 = new_n62_ & x01;
  assign new_n62_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n64_ & (~x02 | x12)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~x02 & (new_n66_ | new_n75_ | (new_n70_ & ~x10))) | (x12 & (new_n66_ | new_n75_));
  assign new_n66_ = ~new_n67_ & (x05 ? (x13 & ~x24) : ~x13);
  ...
  assign new_n70_ = ~x24 & (new_n71_ | new_n73_);
  assign new_n71_ = new_n72_ & ~x03 & ~x06 & x00 & ~x01;
  assign new_n72_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n73_ = new_n74_ & x11 & x14 & x20 & x21;
  assign new_n74_ = x01 & x03 & x06 & x08;
  assign new_n75_ = x24 & ~new_n60_ & ((new_n74_ & new_n76_) | (new_n77_ & new_n72_));
  assign new_n76_ = x11 & x14 & x18 & x20;
  assign new_n77_ = ~x01 & ~x03 & ~x06 & x07;
  assign z4 = ((new_n79_ | new_n38_) & (new_n81_ | x08)) | (z7 & (new_n82_ | ~x08));
  assign new_n79_ = ~new_n80_ & (~x02 | x12);
  ...
  assign new_n85_ = (x05 | x13 | ~x19) & (~x02 | x12);
  assign z6 = new_n87_ | new_n88_ | (x02 & ~x12) | (~new_n93_ & ~x03);
  assign new_n87_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n88_ = x11 & (~new_n89_ | new_n92_) & (~x06 | (x14 & ~x20));
  assign new_n89_ = (~x03 | (~new_n90_ & (~x13 | ~x18 | ~x24))) & (x24 | (~new_n90_ & ~new_n91_));
  assign new_n90_ = ~x05 & ~x13 & x15;
  assign new_n91_ = ~x02 & ~x10 & x21;
  assign new_n92_ = x05 & ((x13 & x15 & ~x24) | (x03 & x18 & x24));
  assign new_n93_ = (new_n95_ | ~x24) & ~new_n94_ & (~x15 | x24 | (~x05 ^ ~x13));
  assign new_n94_ = ~x02 & (new_n90_ | (~x10 & x21 & ~x24));
  assign new_n95_ = (~x18 | (~x05 & ~x13) | (x02 & ~x12)) & (x13 | ~x15 | x05 | ~x12);
endmodule
