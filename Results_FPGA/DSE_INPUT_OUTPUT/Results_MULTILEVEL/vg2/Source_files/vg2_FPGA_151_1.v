...
module FAU ( 
  ...
  assign z2 = new_n66_ | (x01 & x03 & x11 & new_n63_ & x14);
  assign new_n63_ = x20 & (new_n65_ | (~new_n64_ & x06));
  ...
  assign z7 = (~new_n64_ & (x06 | ~x21)) | (~x02 & x06 & ~x10 & x21 & ~x24);
  assign new_n80_ = ~new_n66_ & (new_n83_ | (~new_n81_ & (x08 | (~new_n82_ & ~x16))));
  ...
  assign z5 = (~new_n88_ & x05) | ~new_n87_ | new_n66_ | (~x05 & ~x13 & x19);
  assign new_n87_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n88_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n90_ & ~x24) | new_n99_ | new_n66_ | (new_n96_ & x24);
  assign new_n90_ = ~new_n91_ & new_n92_ & (new_n47_ | (~x03 & (~x06 | x11)));
  assign new_n91_ = ~new_n43_ & ((~x03 & x06) | (x14 & ~x20 & x03 & x11));
  assign new_n92_ = (~new_n95_ | ~x05) & (x11 | (~new_n93_ & ~new_n94_));
  assign new_n93_ = x19 & (x05 ? (x13 & (x21 | (~x14 & x20))) : (~x13 & x21));
  assign new_n94_ = ~x14 & x20 & ~x21 & x00 & ~x02 & ~x10;
  assign new_n95_ = x13 & x15 & (x03 ? (~x06 & x11) : ~x21);
  assign new_n96_ = (x05 | x13) & ((~new_n97_ & x18) | (~new_n98_ & x07));
  assign new_n97_ = x03 ? (~x11 | (x06 & (~x14 | x20))) : (~x06 & x21);
  assign new_n98_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n99_ = ~x05 & ~x13 & ((~new_n98_ & x19) | (~new_n97_ & x15));
endmodule
