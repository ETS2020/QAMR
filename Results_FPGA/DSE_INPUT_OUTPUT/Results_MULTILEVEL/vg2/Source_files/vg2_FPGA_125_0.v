...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n82_, new_n85_, new_n86_, new_n87_;
  ...
  assign z2 = (new_n62_ & x01) | (~x02 & (new_n60_ | ~x12));
  assign new_n60_ = new_n61_ & x06 & ~x10 & x01 & x03;
  ...
  assign new_n66_ = new_n67_ & ~x06 & x07 & ~x01 & ~x03;
  assign new_n67_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n68_ = x01 & x03 & x06 & x08;
  assign new_n69_ = ~x02 & (~x12 | (~x10 & ~x24 & (new_n70_ | new_n71_)));
  assign new_n70_ = new_n67_ & x00 & ~x01 & ~x03 & ~x06;
  assign new_n71_ = new_n68_ & x11 & x14 & x20 & x21;
  ...
  assign z6 = (~new_n37_ & (x03 | (~new_n86_ & ~x11))) | (~new_n85_ & (~x03 | (~new_n87_ & x11)));
  assign new_n85_ = (new_n63_ | (~x02 & ~x12)) & (~x12 | ~x21 | x24 | x02 | x10);
