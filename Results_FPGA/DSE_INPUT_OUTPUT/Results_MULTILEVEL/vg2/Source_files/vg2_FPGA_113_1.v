...
module FAU ( 
  ...
  assign z3 = ~new_n67_ | (~x24 & (x01 ? (new_n76_ & x03) : (new_n77_ & ~x03)));
  ...
  assign z4 = (~new_n37_ & (x08 ? ~new_n75_ : new_n79_)) | new_n75_ | (~new_n64_ & (new_n80_ | ~x08));
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n75_;
  assign z6 = new_n83_ | new_n87_ | new_n75_ | (~new_n84_ & ~x24);
  assign new_n83_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n84_ = (new_n43_ | x03) & (new_n85_ | (x06 & (~x14 | x20)));
  assign new_n85_ = ~new_n86_ & (x02 | x10 | ~x21);
  assign new_n86_ = x13 & x15 & x05 & x11;
  assign new_n87_ = ~new_n88_ & ((~x05 & ~x13 & x15) | (x18 & x24 & (x05 | x13)));
  assign new_n88_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n90_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n90_ = x21 & (~x11 | (~x02 & ~x10 & ~x24));
endmodule
