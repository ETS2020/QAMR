...
module FAU ( 
  ...
  assign z2 = x20 & (new_n44_ | x12);
  assign new_n44_ = x01 & x03 & x06 & x11 & ~new_n45_ & x14;
  ...
  assign z6 = (~new_n37_ & (new_n67_ | x03)) | new_n39_ | (~new_n45_ & (new_n68_ | (~new_n39_ & ~x03)));
  assign new_n67_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & ((x03 & ~x06) | (x14 & ~x20));
