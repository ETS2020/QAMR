...
module FAU ( 
  ...
  assign z4 = ~new_n79_ | (~new_n64_ & (new_n86_ | ~x08));
  assign new_n79_ = ~new_n80_ & ~new_n39_ & (x16 | ~new_n81_ | x22);
  assign new_n80_ = ~new_n37_ & ((x08 & (x09 | ~x12)) | (x09 & ~x16));
  assign new_n81_ = (x17 | (x04 & ~x23)) & (~new_n82_ | (~new_n85_ & x05));
  assign new_n82_ = ~new_n83_ & ~new_n84_ & (~x13 | ~x24 | ~x07 | x08);
  assign new_n83_ = ~x05 & ~x13 & x19 & (x24 ? ~x08 : ~x12);
  assign new_n84_ = x00 & ~x02 & ~x10 & ~x12 & ~x24;
  assign new_n85_ = (~x07 | x08 | ~x24) & (~x19 | x24 | x12 | ~x13);
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = ~new_n39_ & (new_n89_ | new_n90_);
