...
module FAU ( 
  ...
  assign new_n43_ = x11 & x14 & x20 & ~new_n44_ & (~x12 | ~x22);
  ...
  assign new_n56_ = (~x12 | ~x22) & (x05 | new_n57_ | x13);
  ...
  assign z4 = ~new_n61_ | (~new_n44_ & (new_n63_ | ~x08));
  assign new_n61_ = (~x12 | ~x22) & (new_n37_ | ((~x08 | (x12 & x22)) & (new_n62_ | x16)));
  assign new_n62_ = (x22 | (~x17 & (~x04 | x23))) & (x08 | ~x09);
  assign new_n63_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (~x12 | ~x22);
  assign z6 = (~x12 | ~x22) & (new_n66_ | new_n67_);
  ...
  assign new_n69_ = ~new_n45_ & (~x12 | ~x22);
endmodule
