...
module FAU ( 
  ...
  assign new_n43_ = x06 & x11 & x14 & x20 & ~new_n44_ & ~x23;
  ...
  assign new_n60_ = (new_n61_ | (x14 & x23)) & (x22 | x23 | ~x04 | x16);
  assign new_n61_ = ~x08 & (x16 | (~x09 & (~x17 | x22)));
  assign new_n62_ = (new_n63_ | (x14 & x23)) & (x04 | x14 | ~x16 | ~x22 | ~x23);
  assign new_n63_ = x08 & (~x16 | (x09 & (x17 | ~x22)));
  assign z5 = new_n65_ | ~new_n66_ | new_n38_ | (x07 & x13 & x24);
  assign new_n65_ = x05 & ((x13 & x19 & ~x24) | (x07 & x24));
  assign new_n66_ = (x05 | x13 | ~x19) & (~x14 | ~x23);
  ...
  assign new_n71_ = ~new_n45_ & (~x14 | ~x23);
endmodule
