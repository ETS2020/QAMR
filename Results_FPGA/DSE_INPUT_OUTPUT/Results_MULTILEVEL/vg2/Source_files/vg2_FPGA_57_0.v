...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n62_, new_n63_, new_n64_, new_n65_, new_n68_, new_n69_;
  ...
  assign z7 = ~new_n42_ & (x12 | x17);
  assign z3 = (~new_n48_ & ~x24) | ~new_n57_ | (x24 & ~new_n53_ & (x05 | x13));
  ...
  assign new_n57_ = (x12 | x17) & (x05 | new_n58_ | x13);
  assign new_n58_ = (~new_n59_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n60_ | x01 | x03 | x06 | x08);
  assign new_n59_ = x11 & x14 & x15 & x20;
  assign new_n60_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n42_ & ~new_n64_) | (~new_n37_ & ~new_n62_);
  assign new_n62_ = ((~x12 & ~x17) | (~x08 & (~x09 | x16))) & (~new_n63_ | x16);
  assign new_n63_ = ~x22 & (x17 | (x04 & x12 & ~x23));
  assign new_n64_ = (~new_n65_ | ~x16) & ((~x12 & ~x17) | (x08 & (x09 | ~x16)));
  assign new_n65_ = x22 & ((x12 & ~x17) | (~x04 & x17 & x23));
  assign z5 = ~new_n37_ & (x12 | x17);
  assign z6 = (x12 | x17) & (new_n68_ | new_n69_);
  assign new_n68_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n69_ = ~new_n42_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
