...
module FAU ( 
  ...
  assign z4 = new_n53_ | (~new_n40_ & (new_n59_ | x08)) | (~new_n60_ & (new_n58_ | ~x08));
  assign new_n53_ = ~x24 & ((~new_n56_ & x21) | (~new_n54_ & (new_n59_ | x08)));
  assign new_n54_ = ~new_n39_ & (~new_n55_ | x05 | x10);
  assign new_n55_ = x00 & ~x02;
  assign new_n56_ = ((~new_n58_ & x08) | (~new_n57_ & (x02 | x10))) & (~x00 | x02 | ~x08 | x10);
  assign new_n57_ = x05 & x13 & x15;
  assign new_n58_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n59_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n60_ = ~new_n48_ & (~x21 | ~x24 | ~x05 | ~x18);
  assign z5 = ~new_n62_ | (x07 & x24 & (x05 | x13));
  assign new_n62_ = (~x05 | (x21 & (~x13 | ~x19 | x24))) & ~new_n63_ & (x05 | x13 | ~x19);
  assign new_n63_ = new_n55_ & ~x10 & ~x24;
  assign z6 = ~new_n65_ | (~new_n68_ & (x05 ? new_n69_ : ~new_n67_));
  assign new_n65_ = ~new_n66_ & (~new_n55_ | x10 | ~x21 | x24);
  assign new_n66_ = ~new_n46_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n67_ = (x13 | ~x19) & ~new_n63_ & (~x07 | ~x13 | ~x24);
  assign new_n68_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n69_ = x21 & ((x13 & x19 & ~x24) | (x07 & x24));
  assign z7 = ~new_n72_ | (~new_n71_ & ~x24);
  assign new_n71_ = ~new_n57_ & (x02 | x10 | (~x05 & ~x21));
  assign new_n72_ = (~x05 | (x21 & (~x18 | ~x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
endmodule
