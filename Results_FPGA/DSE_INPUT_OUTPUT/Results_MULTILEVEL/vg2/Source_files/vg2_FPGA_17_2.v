...
module FAU ( 
  ...
  assign new_n75_ = (~x12 | x16) & (x05 | new_n76_ | x13);
  ...
  assign z4 = (~new_n82_ & (~x12 | x16)) | (~x12 & new_n80_ & ~x16) | (new_n81_ & x16);
  assign new_n80_ = ~new_n38_ & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n81_ = ~new_n65_ & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n82_ = (x24 | (~new_n83_ & (~x05 | new_n84_ | ~x13))) & (~x24 | new_n85_ | (~x05 & ~x13)) & (x05 | new_n84_ | x13);
  assign new_n83_ = ~x02 & ~x10 & (x08 ? x00 : x21);
  assign new_n84_ = x08 ? ~x19 : ~x15;
  assign new_n85_ = x08 ? ~x07 : ~x18;
  assign z6 = new_n87_ | (x12 & ~x16) | (~new_n65_ & (x03 ? new_n88_ : (~x12 | x16)));
  assign new_n87_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
