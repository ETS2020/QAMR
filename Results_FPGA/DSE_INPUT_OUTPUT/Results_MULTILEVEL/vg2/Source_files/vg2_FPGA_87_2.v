...
module FAU ( 
  ...
  assign new_n56_ = (~x12 | x17) & (x05 | x13 | (~new_n57_ & ~new_n59_));
  ...
  assign new_n79_ = (~x12 | x17) & (new_n38_ | ((~x08 | (x12 & ~x17)) & (new_n80_ | x16)));
  assign new_n80_ = (x08 | (~x09 & (~x04 | x22 | x23))) & (~x17 | x22);
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (new_n83_ | new_n84_) & (~x12 | x17);
