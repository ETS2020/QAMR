...
module FAU ( 
  ...
  assign z1 = new_n41_ | new_n57_ | (x24 & ~new_n51_ & (x05 | x13));
  ...
  assign new_n62_ = (new_n63_ | (~x02 & ~x12)) & (~x12 | ~x21 | x24 | x02 | x10);
  ...
  assign z7 = ~new_n63_ | (~x02 & (~x12 | (~x10 & x21 & ~x24)));
endmodule
