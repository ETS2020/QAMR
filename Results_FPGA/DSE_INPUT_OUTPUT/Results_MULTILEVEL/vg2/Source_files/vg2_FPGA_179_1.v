...
module FAU ( 
  ...
  assign z4 = new_n76_ | new_n83_ | (~new_n85_ & ~x02) | (new_n80_ & x24);
  assign new_n76_ = ~new_n77_ & (x08 ? ~x12 : new_n79_);
  ...
  assign new_n80_ = ~new_n81_ & (x05 | x13);
  assign new_n81_ = (~x02 | ~x07 | ~x08) & (~x18 | (~new_n82_ & x08));
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n83_ = ~new_n84_ & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n84_ = (~x02 | ~x08 | ~x19) & (~x15 | (~new_n82_ & x08));
  assign new_n85_ = ~x12 & (x10 | ~x21 | x24 | (~new_n82_ & x08));
  assign z6 = (~new_n61_ & (~x03 | (~new_n88_ & x11))) | (z5 & (x03 | (~new_n87_ & ~x11)));
