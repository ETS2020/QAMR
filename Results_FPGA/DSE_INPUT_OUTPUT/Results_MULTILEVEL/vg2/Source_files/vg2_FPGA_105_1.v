...
module FAU ( 
  ...
  assign z4 = (~new_n81_ & (new_n88_ | ~x08)) | new_n83_ | (new_n87_ & x00);
  assign new_n81_ = (new_n82_ | (~x12 & x21)) & (~x12 | ~x21 | x24 | x02 | x10);
  assign new_n82_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
  assign new_n83_ = ~new_n39_ & (new_n86_ | (~new_n84_ & (x08 | (~new_n85_ & ~x16))));
  ...
  assign new_n87_ = ~x02 & ~x10 & ~x16 & ~x21 & ~new_n85_ & ~x24;
  ...
  assign z6 = new_n93_ | new_n95_ | (~new_n39_ & (new_n94_ | new_n97_));
  ...
  assign new_n99_ = x21 & (~x12 | (~x02 & ~x10 & ~x24));
endmodule
