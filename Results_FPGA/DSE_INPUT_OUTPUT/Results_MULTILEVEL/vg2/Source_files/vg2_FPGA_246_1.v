...
module FAU ( 
  ...
  assign new_n57_ = new_n58_ & new_n52_ & ~x06 & ~x08 & ~x09 & ~x11;
  assign new_n58_ = ~x12 & ~x14 & ~x16 & new_n51_ & ~x17 & x19;
  assign new_n59_ = new_n53_ & new_n60_ & x14 & x15 & x16;
  ...
  assign new_n77_ = (new_n78_ | (~x12 & x23)) & (x22 | x23 | ~x04 | x16);
  assign new_n78_ = ~x08 & (x16 | (~x09 & (~x17 | x22)));
  assign new_n79_ = (new_n80_ | (~x12 & x23)) & (~x16 | ~x22 | ~x23 | x04 | ~x12);
