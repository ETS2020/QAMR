...
module FAU ( 
  ...
  assign z0 = (new_n36_ & ~x01) | (~x12 & x23);
  ...
  assign new_n55_ = (x12 | ~x23) & (x05 | x13 | (~new_n56_ & ~new_n58_));
  ...
  assign z2 = (~x12 & x23) | (new_n61_ & x01);
  ...
  assign z4 = ~new_n77_ | (~new_n62_ & (new_n79_ | ~x08));
  assign new_n77_ = (x12 | ~x23) & (new_n37_ | ((~x08 | (~x12 & x23)) & (new_n78_ | x16)));
  assign new_n78_ = (~x04 | x22 | x23) & (x08 | (~x09 & (~x17 | x22)));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (x12 | ~x23);
  assign z6 = (x12 | ~x23) & (new_n82_ | new_n83_);
  assign new_n82_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n83_ = ~new_n62_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n62_ & (x12 | ~x23);
endmodule
