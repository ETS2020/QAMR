...
module FAU ( 
  ...
  assign z1 = new_n41_ | new_n54_ | (~new_n62_ & (new_n46_ | new_n50_));
  ...
  assign new_n54_ = x24 & ~new_n61_ & (new_n57_ | (new_n47_ & new_n55_));
  ...
  assign z2 = (new_n66_ & x01) | (~new_n64_ & ~x02);
  assign new_n64_ = x12 & (~new_n65_ | ~x06 | x10 | ~x01 | ~x03);
  ...
  assign new_n73_ = ~x02 & (~x12 | (~x10 & ~new_n74_ & ~x24));
  ...
  assign z4 = ~new_n80_ | (~new_n85_ & (x08 ? x12 : new_n87_));
  assign new_n80_ = (~new_n81_ | ~x24) & ~new_n83_ & (new_n84_ | x02);
  assign new_n81_ = ~new_n61_ & ((x18 & (new_n82_ | ~x08)) | (x02 & x07 & x08));
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n83_ = ~new_n62_ & ((x15 & (new_n82_ | ~x08)) | (x02 & x08 & x19));
  assign new_n84_ = x12 & (x10 | ~x21 | x24 | (~new_n82_ & x08));
  ...
  assign z7 = (~new_n67_ & (x02 | x12)) | (~x02 & ~x10 & x12 & x21 & ~x24);
