...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_,
    ...
    new_n51_, new_n52_, new_n54_, new_n58_, new_n59_, new_n60_, new_n61_,
  ...
  assign z4 = (~new_n59_ & (new_n61_ | x08)) | new_n52_ | (~new_n58_ & (new_n62_ | ~x08));
  assign new_n58_ = (new_n48_ | ~x05) & ~new_n49_ & ~new_n51_ & (~new_n50_ | x05);
  assign new_n59_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n60_ & (x05 | x13 | ~x19);
  assign new_n60_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n64_ | (x07 & x24 & (x05 | x13));
  assign new_n64_ = ~new_n60_ & (x05 | x13 | ~x19) & (new_n65_ | ~x05);
  assign new_n65_ = ~x21 & (~x13 | ~x19 | x24);
  assign z6 = (~new_n59_ & (new_n67_ | x03)) | new_n52_ | (z7 & (new_n68_ | ~x03));
