...
module FAU ( 
  ...
  assign z1 = x01 ? (x03 & x04 & new_n40_ & x06) : ~x12;
  ...
  assign new_n57_ = x12 & (~new_n58_ | x03 | x05 | x06 | x08);
  ...
  assign new_n70_ = ~new_n42_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
