...
module FAU ( 
  ...
  assign z1 = new_n57_ | (~new_n39_ & (new_n41_ | (new_n50_ & x24)));
  ...
  assign new_n58_ = new_n59_ & ~x14 & ~x16 & ~x17 & ~x11 & ~x12;
  ...
  assign z7 = ~new_n39_ & ~new_n64_;
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = ~new_n70_ | (x24 & (new_n78_ | (~new_n66_ & (x05 | x13))));
  assign new_n66_ = ~new_n67_ & (~new_n69_ | ~x01 | ~x03 | ~x06 | ~x08);
  assign new_n67_ = new_n68_ & ~x06 & x07 & ~x01 & ~x03;
  assign new_n68_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n69_ = x11 & x14 & x18 & x20;
  assign new_n70_ = new_n75_ & (x24 | (x01 ? (~new_n73_ | ~x03) : (~new_n71_ | x03)));
  ...
  assign new_n74_ = x15 & x20 & (x10 | ~x21) & (x05 ^ ~x13);
  assign new_n75_ = ~new_n39_ & (~new_n76_ | ~new_n77_);
  assign new_n76_ = ~x01 & ~x03 & ~x05 & ~x06 & ~x08;
  assign new_n77_ = ~x11 & ~x13 & ~x14 & x19 & ~x20;
  assign new_n78_ = new_n79_ & x01 & x03 & ~x05 & x06 & x08;
  assign new_n79_ = x11 & ~x13 & x14 & x15 & x20;
  assign z4 = (~new_n39_ & ~new_n64_ & (new_n84_ | ~x08)) | (z5 & (new_n83_ | x08));
  assign z5 = (~new_n82_ & (x10 | ~x21)) | (~x10 & ~x21 & ~x24 & x00 & ~x02);
  ...
  assign z6 = (~new_n39_ & ~new_n64_ & (new_n87_ | ~x03)) | (z5 & (new_n86_ | x03));
