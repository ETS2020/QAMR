...
module FAU ( 
  ...
  assign z7 = (~new_n63_ & (~x12 | ~x21)) | (~x02 & ~x10 & ~x12 & x21 & ~x24);
  ...
  assign z4 = new_n79_ | (new_n83_ & x00) | (z7 & (new_n84_ | ~x08));
  assign new_n79_ = ~new_n39_ & (new_n82_ | (~new_n80_ & (x08 | (~new_n81_ & ~x16))));
  ...
  assign new_n83_ = ~x02 & ~x10 & ~x16 & ~x21 & ~new_n81_ & ~x24;
  ...
  assign z6 = new_n89_ | new_n91_ | (~new_n39_ & (new_n90_ | new_n93_));
  assign new_n89_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = ~new_n80_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n91_ = x00 & ~x02 & new_n92_ & ~x10;
  assign new_n92_ = ~x11 & ~x21 & ~x24 & (x06 | (~x14 & x20));
