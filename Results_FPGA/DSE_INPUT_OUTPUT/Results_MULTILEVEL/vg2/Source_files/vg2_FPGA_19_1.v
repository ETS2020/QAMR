...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n89_, new_n92_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_;
  ...
  assign z2 = (~x16 & x21) | (new_n63_ & x01);
  ...
  assign z3 = (new_n77_ & new_n78_) | (~new_n67_ & (x16 | ~x21));
  ...
  assign new_n78_ = x20 & x21 & ~x24 & x11 & x14 & x16;
  assign z4 = (~new_n88_ & (new_n89_ | ~x08)) | ~new_n86_ | (~new_n80_ & ~x24);
  assign new_n80_ = new_n81_ & (~x08 | new_n47_ | (~x16 & x21));
  assign new_n81_ = ~new_n84_ & (x02 | x10 | (~new_n82_ & (new_n85_ | ~x21)));
  assign new_n82_ = x00 & ~x16 & ~new_n83_ & (x05 ? ~x21 : ~x08);
  assign new_n83_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n84_ = x05 & x13 & ~x16 & x19 & ~new_n83_ & ~x21;
  assign new_n85_ = x08 & x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n86_ = (x16 | ~x21) & (new_n87_ | (x08 ? (~x16 & x21) : (new_n83_ | x16)));
  ...
  assign z6 = new_n92_ | new_n97_ | (~new_n94_ & (x16 | ~x21));
  assign new_n92_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n88_ & (x16 | ~x21)) | (x16 & x21 & ~x24 & ~x02 & ~x10);
  assign new_n94_ = ~new_n95_ & (~x00 | x02 | ~x03 | x10 | x24);
  assign new_n95_ = ~new_n96_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n96_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n97_ = x00 & ~x02 & ~x10 & new_n98_ & ~x11;
  assign new_n98_ = ~x21 & ~x24 & (x06 | (~x14 & x20));
endmodule
