...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (~x12 | ~x21)) | (~x02 & ~x10 & ~x12 & x21 & ~x24);
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (new_n75_ & new_n76_) | (~new_n64_ & ~new_n39_);
  ...
  assign new_n76_ = x20 & x21 & ~x24 & x11 & ~x12 & x14;
  assign z4 = new_n78_ | (new_n82_ & x00) | (z7 & (new_n83_ | ~x08));
  assign new_n78_ = ~new_n39_ & (new_n81_ | (~new_n79_ & (x08 | (~new_n80_ & ~x16))));
  assign new_n79_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n80_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n81_ = x00 & ~x02 & x08 & ~x10 & ~x24;
  assign new_n82_ = ~x02 & ~x10 & ~x16 & ~x21 & ~new_n80_ & ~x24;
  ...
  assign z6 = new_n88_ | new_n90_ | (~new_n39_ & (new_n89_ | new_n92_));
  assign new_n88_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n89_ = ~new_n79_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = x00 & ~x02 & new_n91_ & ~x10;
  assign new_n91_ = ~x11 & ~x21 & ~x24 & (x06 | (~x14 & x20));
  assign new_n92_ = x00 & ~x02 & x03 & ~x10 & ~x24;
endmodule
