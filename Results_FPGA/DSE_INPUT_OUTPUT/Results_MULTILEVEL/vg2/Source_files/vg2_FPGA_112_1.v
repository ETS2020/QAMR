...
module FAU ( 
  ...
  assign new_n72_ = x24 & ~new_n55_ & (new_n73_ | new_n75_);
  ...
  assign z4 = new_n83_ | (new_n90_ & x24) | new_n87_ | (~new_n91_ & ~x02);
  assign new_n83_ = ~new_n84_ & (x08 ? ~x12 : new_n86_);
  ...
  assign new_n87_ = ~new_n88_ & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n88_ = (~x02 | ~x08 | ~x19) & (~x15 | (~new_n89_ & x08));
  assign new_n89_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n90_ = ~new_n55_ & ((x18 & (new_n89_ | ~x08)) | (x02 & x07 & x08));
  assign new_n91_ = ~x12 & (x10 | ~x21 | x24 | (~new_n89_ & x08));
  assign z5 = (~new_n39_ & (x02 | ~x12)) | (x00 & ~x02 & ~x10 & ~x12 & ~x24);
  assign z6 = new_n94_ | new_n95_ | (~x02 & x12);
  assign new_n94_ = ~new_n84_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
