...
module FAU ( 
  ...
  assign z3 = (~new_n66_ & ~x24) | ~new_n75_ | (x24 & ~new_n71_ & ~new_n60_);
  ...
  assign new_n70_ = (~x05 | ~x13 | ~x19) & (~x00 | x02 | x10);
  ...
  assign new_n75_ = (~x02 | x12) & (x05 | new_n76_ | x13);
  ...
  assign z4 = ((new_n84_ | x08) & (new_n80_ | new_n38_)) | (z7 & (new_n85_ | ~x08));
  assign new_n80_ = ~new_n81_ & (~x02 | x12);
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n64_ | (~new_n83_ & (~x02 | x12));
  ...
  assign z5 = new_n87_ | ~new_n88_ | new_n38_ | (x07 & x13 & x24);
  assign new_n87_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n88_ = (x05 | x13 | ~x19) & (~x02 | x12);
  assign z6 = new_n90_ | new_n91_ | (x02 & ~x12) | (~new_n96_ & ~x03);
  assign new_n90_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n91_ = x11 & (~new_n92_ | new_n95_) & (~x06 | (x14 & ~x20));
  assign new_n92_ = (~x03 | (~new_n93_ & (~x13 | ~x18 | ~x24))) & (x24 | (~new_n93_ & ~new_n94_));
  assign new_n93_ = ~x05 & ~x13 & x15;
  assign new_n94_ = ~x02 & ~x10 & x21;
  assign new_n95_ = x05 & ((x13 & x15 & ~x24) | (x03 & x18 & x24));
  assign new_n96_ = (new_n98_ | ~x24) & ~new_n97_ & (~x15 | x24 | (~x05 ^ ~x13));
  assign new_n97_ = ~x02 & (new_n93_ | (~x10 & x21 & ~x24));
  assign new_n98_ = (~x18 | (~x05 & ~x13) | (x02 & ~x12)) & (x13 | ~x15 | x05 | ~x12);
endmodule
