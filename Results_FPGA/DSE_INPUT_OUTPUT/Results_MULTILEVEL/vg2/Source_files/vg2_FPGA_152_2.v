...
module FAU ( 
  ...
  assign z1 = new_n64_ | (x21 & (~new_n47_ | (~new_n40_ & ~x24)));
  ...
  assign new_n47_ = ~new_n48_ & (x05 | new_n57_ | x13);
  ...
  assign new_n57_ = (~new_n49_ | ~new_n58_) & (~new_n60_ | ~new_n62_);
  ...
  assign new_n64_ = ~x00 & (new_n48_ | (~new_n57_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign z2 = new_n66_ & x01;
  assign new_n66_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n68_ & (~x00 | x21)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n68_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = ~new_n70_ | (x00 & (new_n80_ | ~x21));
  assign new_n70_ = (new_n75_ | (x05 ? (~x13 | x24) : x13)) & ~new_n78_ & (~x24 | new_n71_ | (~x05 & ~x13));
  ...
  assign new_n75_ = (~new_n76_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n77_ | x06 | x08 | x01 | x03);
  ...
  assign new_n80_ = new_n81_ & ~x03 & ~x06 & ~x08 & ~x01 & ~x02;
  assign new_n81_ = ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  assign z4 = ~new_n83_ | (z7 & (new_n86_ | ~x08));
  assign new_n83_ = (~x00 | x02 | x10 | ~x21 | x24) & (~new_n84_ | (x00 & ~x21));
  assign new_n84_ = ~new_n38_ & (new_n85_ | x08);
  assign new_n85_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = new_n97_ | ~new_n88_ | (x24 & (new_n95_ | (new_n98_ & ~x03)));
  assign new_n88_ = ~new_n92_ & ~new_n89_ & (x03 | new_n94_ | x24);
  assign new_n89_ = x11 & ~new_n90_ & (~x06 | (x14 & ~x20));
  assign new_n90_ = ~new_n91_ & (~x21 | x24 | x02 | x10);
  assign new_n91_ = x15 & (x05 ? (x13 & ~x24) : (~x13 & (x03 | ~x24)));
  assign new_n92_ = x19 & (new_n93_ | x03) & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n93_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n94_ = (~x15 | (~x05 ^ ~x13)) & (x02 | x10 | ~x21);
  assign new_n95_ = (x05 | x13) & ((new_n93_ & x07) | (x03 & (new_n96_ | x07)));
  assign new_n96_ = x11 & x18 & (~x06 | (x14 & ~x20));
  assign new_n97_ = x00 & (~x21 | (~x02 & x03 & ~x10 & ~x24));
  assign new_n98_ = (~x00 | x21) & ((~x05 & ~x13 & x15) | (x18 & (x05 | x13)));
endmodule
