...
module FAU ( 
  ...
  assign new_n36_ = ~x06 & ~x11 & ~x14 & ~x20 & ~new_n37_ & x23;
  ...
  assign new_n50_ = ~x11 & ~x14 & ~x20 & ~new_n51_ & x23;
  ...
  assign new_n55_ = ~x08 & ~x11 & ~x14 & ~x20 & x23;
  assign new_n56_ = (~new_n57_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n58_ | x01 | x03 | x06 | x08);
  assign new_n57_ = x11 & x14 & x15 & x20;
  assign new_n58_ = ~x11 & ~x14 & x19 & ~x20 & x23;
  assign z4 = (~new_n42_ & ~new_n62_) | (~new_n37_ & ~new_n60_);
  assign new_n60_ = (new_n61_ | (~x14 & ~x23)) & (~x04 | ~x14 | x16 | x22 | x23);
  assign new_n61_ = ~x08 & (x16 | (~x09 & (~x17 | x22)));
  assign new_n62_ = (new_n63_ | (~x14 & ~x23)) & (~x22 | ~x23 | x04 | ~x16);
  assign new_n63_ = x08 & (~x16 | (x09 & (x17 | ~x22)));
  assign z5 = new_n65_ | ~new_n66_ | new_n38_ | (x07 & x13 & x24);
  assign new_n65_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n66_ = (x14 | x23) & (x05 | x13 | ~x19);
  assign z6 = new_n68_ | new_n69_ | (~x14 & ~x23);
  ...
  assign new_n71_ = ~new_n43_ & (x14 | x23);
endmodule
