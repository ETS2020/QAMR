...
module FAU ( 
  ...
  assign new_n50_ = (~new_n41_ | ~new_n51_) & (~new_n53_ | ~new_n55_ | ~new_n46_ | ~new_n54_);
  ...
  assign z3 = (x12 & (new_n64_ | new_n69_ | new_n74_)) | (x10 & (new_n69_ | new_n78_));
  ...
  assign z4 = (~new_n80_ & (x08 | (~new_n82_ & ~x16))) | (~new_n61_ & (~x08 | (~new_n83_ & x16)));
  assign new_n80_ = (new_n81_ | (~x10 & ~x12)) & (~x00 | x02 | x10 | ~x12 | x24);
  ...
  assign z5 = (x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | new_n85_ | (x07 & x13 & x24) | (~x05 & ~x13 & x19);
  assign new_n85_ = ~x10 & (~x12 | (x00 & ~x02 & ~x24));
  assign z6 = (~new_n80_ & (x03 | (~new_n87_ & ~x11))) | (~new_n61_ & (~x03 | (~new_n88_ & x11)));
