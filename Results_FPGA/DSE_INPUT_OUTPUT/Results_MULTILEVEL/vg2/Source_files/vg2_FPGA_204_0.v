...
module FAU ( 
  ...
  assign z4 = (~new_n43_ & ~new_n64_) | (~new_n37_ & ~new_n62_);
  assign new_n62_ = ((~x12 & ~x22) | (~x08 & (~x09 | x16))) & (~x12 | x16 | new_n63_ | x22);
  assign new_n63_ = ~x17 & (~x04 | x23);
  assign new_n64_ = (~x16 | new_n65_ | ~x22) & ((~x12 & ~x22) | (x08 & (x09 | ~x16)));
  assign new_n65_ = x17 & (x04 | ~x23);
  assign z5 = (~new_n68_ & x05) | ~new_n67_ | new_n39_ | (~x05 & ~x13 & x19);
  assign new_n67_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n68_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = ~new_n39_ & (new_n70_ | new_n71_);
  assign new_n70_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n71_ = ~new_n43_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n73_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n73_ = ~new_n39_ & ~new_n44_;
endmodule
