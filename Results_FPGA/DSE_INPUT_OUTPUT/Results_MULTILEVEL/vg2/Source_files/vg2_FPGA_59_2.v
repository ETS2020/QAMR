...
module FAU ( 
  ...
  assign z2 = (x12 & ~x18) | (new_n70_ & x01);
  ...
  assign new_n72_ = x21 & ~x24 & ~x02 & ~x10;
  assign z3 = ~new_n74_ | (~x24 & (x01 ? (new_n84_ & x03) : (new_n86_ & ~x03)));
  assign new_n74_ = ~new_n75_ & (~x12 | x18) & (x05 | new_n81_ | x13);
  assign new_n75_ = x24 & ((~new_n64_ & (new_n76_ | (new_n78_ & new_n79_))) | (new_n78_ & new_n80_));
  ...
  assign z4 = (x24 & ~new_n94_ & (x05 | x13)) | ~new_n88_ | (~new_n93_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n88_ = (~x12 | x18) & (x02 | ~new_n89_ | x10);
  assign new_n89_ = ~x24 & ((~new_n90_ & x00) | (x21 & (new_n92_ | ~x08)));
  assign new_n90_ = x08 ? (x12 & ~x18) : ~new_n91_;
  assign new_n91_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n92_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n93_ = (new_n90_ | ~x19) & (~x15 | (~new_n92_ & x08));
  assign new_n94_ = (~x18 | (~new_n92_ & ~x07 & x08)) & (x08 | ~x12) & (~x07 | (x08 ? x12 : ~new_n91_));
  assign z6 = (~new_n38_ & (new_n98_ | x03)) | new_n97_ | (~new_n96_ & (new_n99_ | ~x03));
  assign new_n96_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n72_ & (x05 | x13 | ~x15);
  assign new_n97_ = x12 & (~x18 | (~x03 & ~new_n64_ & x24));
  assign new_n98_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n99_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n101_ | (x15 & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n101_ = (~x24 | new_n64_ | (~x12 & ~x18)) & ~new_n72_ & (~x12 | x18);
endmodule
