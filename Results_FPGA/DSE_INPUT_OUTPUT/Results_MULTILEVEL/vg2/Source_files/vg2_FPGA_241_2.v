...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~new_n62_) | new_n49_ | (new_n57_ & ~x02) | (x02 & ~x12);
  ...
  assign new_n74_ = x24 & ~new_n56_ & ((new_n76_ & new_n77_) | (new_n75_ & new_n72_));
  assign new_n75_ = new_n73_ & x18 & x20;
  assign new_n76_ = new_n53_ & ~x01 & ~x03;
  ...
  assign z4 = new_n81_ | ~new_n87_ | (~new_n84_ & (new_n67_ | (~new_n62_ & x15)));
  assign new_n81_ = x24 & (new_n86_ | (~new_n56_ & (new_n82_ | (~new_n84_ & x18))));
  assign new_n82_ = x07 & (x08 ? (~x02 | x12) : (~new_n83_ & ~x16));
  ...
  assign new_n87_ = (~new_n88_ | x16) & (~x02 | x12) & (new_n90_ | ~x08);
  assign new_n88_ = ~new_n83_ & (new_n89_ | (~x10 & ~x24 & x00 & ~x02));
  assign new_n89_ = x19 & (x05 ? (x13 & ~x24) : (~x13 & (~x08 | ~x24)));
  assign new_n90_ = (x02 | (~new_n91_ & (x05 | x13 | ~x19))) & (~x19 | x24 | (x05 ^ x13));
  assign new_n91_ = x00 & ~x10 & ~x24;
  assign z6 = (~new_n65_ & (~x03 | (~new_n94_ & x11))) | (z5 & (x03 | (~new_n93_ & ~x11)));
  assign new_n93_ = ~x06 & (x14 | ~x20);
  assign new_n94_ = x06 & (~x14 | x20);
  assign z7 = (~new_n96_ & x05) | ~new_n97_ | new_n67_ | (~x05 & ~x13 & x15);
  assign new_n96_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n97_ = (~x02 | x12) & (~x13 | ~x18 | ~x24);
endmodule
