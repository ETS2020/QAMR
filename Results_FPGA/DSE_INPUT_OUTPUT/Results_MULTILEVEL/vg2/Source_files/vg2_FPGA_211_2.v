...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_,
    ...
    new_n62_, new_n64_, new_n66_, new_n67_, new_n68_, new_n69_;
  ...
  assign z4 = (~new_n59_ & (new_n61_ | x08)) | new_n50_ | (~new_n58_ & (new_n62_ | ~x08));
  assign new_n58_ = new_n49_ & (new_n48_ | x24);
  ...
  assign new_n64_ = ~new_n60_ & (x05 | x13 | ~x19) & (~x05 | (x21 & (~x13 | ~x19 | x24)));
  assign z6 = (~new_n66_ & (new_n67_ | x03)) | new_n69_ | (z7 & (new_n68_ | ~x03));
  assign new_n66_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | (~new_n60_ & (x13 | ~x19)));
  assign new_n67_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n69_ = x05 & (~x21 | (x00 & ~x02 & ~x10 & x21 & ~x24));
endmodule
