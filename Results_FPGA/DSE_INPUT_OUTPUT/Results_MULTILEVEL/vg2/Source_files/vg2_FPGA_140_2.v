...
module FAU ( 
  ...
  assign z2 = (x09 & ~x12) | (new_n62_ & x01);
  ...
  assign z4 = (~new_n63_ & (new_n90_ | ~x08)) | ~new_n78_ | (z5 & x08);
  assign new_n78_ = (~x09 | x12) & (x16 | ((~new_n79_ | x22) & (new_n84_ | ~x09)));
  assign new_n79_ = (x17 | (x04 & ~x23)) & (~new_n80_ | (~new_n83_ & x05));
  assign new_n80_ = ~new_n81_ & ~new_n82_ & (~x07 | x08 | ~x13 | ~x24);
  assign new_n81_ = ~x05 & ~x13 & x19 & (x24 ? ~x08 : ~x09);
  assign new_n82_ = x00 & ~x02 & ~x09 & ~x10 & ~x24;
  assign new_n83_ = (~x07 | x08 | ~x24) & (~x19 | x24 | x09 | ~x13);
  assign new_n84_ = (new_n87_ | ~x05) & new_n85_ & (~new_n88_ | x05);
  assign new_n85_ = ~new_n86_ & (~x13 | ~x24 | ~x07 | x08);
  assign new_n86_ = x00 & ~x02 & ~x10 & x12 & ~x24;
  assign new_n87_ = (~x07 | x08 | ~x24) & (~x19 | x24 | ~x12 | ~x13);
  assign new_n88_ = ~x13 & x19 & (x24 ? ~x08 : x12);
  assign z5 = ~new_n37_ & (~x09 | x12);
  assign new_n90_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~x09 | x12) & (new_n92_ | new_n93_);
  assign new_n92_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n93_ = ~new_n63_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n63_ & (~x09 | x12);
endmodule
