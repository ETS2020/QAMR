...
module FAU ( 
  ...
  assign z0 = (~x01 & ~x03 & new_n36_ & ~x06) | (x06 & x12);
  ...
  assign z1 = (x06 & x12) | (~x01 & ~x03 & ~x04 & new_n40_ & ~x06);
  ...
  assign z4 = (~new_n44_ & (new_n61_ | ~x08)) | new_n60_ | (~new_n37_ & (x08 ? ~new_n60_ : new_n62_));
  ...
  assign z6 = (~new_n67_ & ~new_n60_) | (new_n65_ & ~x11) | (new_n66_ & x11);
  assign new_n65_ = ~new_n37_ & (x06 ? ~x12 : (~x14 & x20));
  assign new_n66_ = ~new_n44_ & (~x06 | (~x12 & x14 & ~x20));
  assign new_n67_ = (x24 | (~new_n68_ & (~x05 | new_n69_ | ~x13))) & (~x24 | new_n70_ | (~x05 & ~x13)) & (x05 | new_n69_ | x13);
  assign new_n68_ = ~x02 & ~x10 & (x03 ? x00 : x21);
  assign new_n69_ = x03 ? ~x19 : ~x15;
  assign new_n70_ = x03 ? ~x07 : ~x18;
  assign z7 = ~new_n72_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n72_ = ~new_n45_ & (x05 | x13 | ~x15) & ~new_n60_ & (~new_n73_ | ~x13);
  assign new_n73_ = x18 & x24;
endmodule
