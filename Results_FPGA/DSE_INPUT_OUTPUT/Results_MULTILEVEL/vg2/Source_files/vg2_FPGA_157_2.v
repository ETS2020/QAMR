// Benchmark "FAU" written by ABC on Tue Aug 18 17:44:06 2020
...
module FAU ( 
  ...
  assign new_n64_ = ~new_n66_ & (new_n39_ | new_n65_);
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n66_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~new_n68_ & ~x24) | ~new_n77_ | (x24 & ~new_n73_ & ~new_n61_);
  ...
  assign new_n72_ = (~x00 | x02 | x10) & (~x05 | ~x13 | ~x19);
  ...
  assign new_n77_ = ~new_n39_ & (x05 | new_n78_ | x13);
  ...
  assign z4 = ((new_n82_ | new_n38_) & (new_n83_ | x08)) | (~new_n64_ & (new_n84_ | ~x08));
  assign new_n82_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  ...
  assign z6 = (~new_n37_ & (new_n90_ | x03)) | new_n39_ | (~new_n89_ & (new_n91_ | ~x03));
  ...
  assign new_n93_ = ~new_n66_ & (x05 | x13 | ~x15) & ~new_n39_ & (~new_n94_ | ~x13);
