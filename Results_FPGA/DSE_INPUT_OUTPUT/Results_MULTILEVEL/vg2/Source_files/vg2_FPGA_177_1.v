...
module FAU ( 
  ...
  assign new_n62_ = x11 & x14 & x20 & ~new_n63_ & (x12 | ~x22);
  ...
  assign new_n73_ = (x12 | ~x22) & (x05 | new_n74_ | x13);
  ...
  assign z4 = ~new_n78_ | (~new_n63_ & (new_n80_ | ~x08));
  assign new_n78_ = (x12 | ~x22) & (new_n37_ | ((~x08 | (~x12 & x22)) & (new_n79_ | x16)));
  assign new_n79_ = (x22 | (~x17 & (~x04 | x23))) & (x08 | ~x09);
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (x12 | ~x22);
  assign z6 = (x12 | ~x22) & (new_n83_ | new_n84_);
  ...
  assign new_n86_ = ~new_n64_ & (x12 | ~x22);
endmodule
