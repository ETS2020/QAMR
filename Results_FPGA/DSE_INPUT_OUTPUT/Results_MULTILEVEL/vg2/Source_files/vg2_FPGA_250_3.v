...
module FAU ( 
  ...
  assign z4 = new_n81_ | (~new_n83_ & ~x21);
  assign new_n81_ = ~x09 & ((~new_n64_ & (~x08 | x16)) | (~new_n37_ & (x08 | (new_n82_ & ~x16))));
  assign new_n82_ = ~x22 & (x17 | (x04 & ~x23));
  assign new_n83_ = (new_n37_ | (~x08 & (~x09 | x16))) & (new_n85_ | (x08 & (~new_n84_ | ~x16)));
  ...
  assign z6 = ~new_n88_ | (~x11 & ~new_n94_ & (x06 | (~x14 & x20)));
  assign new_n88_ = (~new_n89_ | ~x24) & ~new_n91_ & ~new_n39_ & (~new_n92_ | x02);
  assign new_n89_ = ~new_n56_ & ((x03 & x07) | (x18 & (x03 ? new_n90_ : ~new_n39_)));
  assign new_n90_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n91_ = ~new_n50_ & ((x03 & x19) | (x15 & (x03 ? new_n90_ : ~new_n39_)));
  assign new_n92_ = ~x10 & ~x24 & (x03 ? ~new_n93_ : (~x09 & x21));
  assign new_n93_ = ~x00 & (~x11 | ~x21 | (x06 & (~x14 | x20)));
  assign new_n94_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n95_ & (x05 | x13 | ~x19);
  assign new_n95_ = x00 & ~x02 & ~x10 & ~x21 & ~x24;
  assign z7 = (~new_n85_ & (~x09 | ~x21)) | (~x02 & ~x09 & ~x10 & x21 & ~x24);
endmodule
