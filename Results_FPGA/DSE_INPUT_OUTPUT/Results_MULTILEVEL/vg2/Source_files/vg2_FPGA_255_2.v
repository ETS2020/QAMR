// Benchmark "FAU" written by ABC on Tue Aug 18 17:44:34 2020
...
module FAU ( 
  ...
  assign new_n43_ = x16 & x17 & x20 & x22 & (new_n44_ | new_n45_);
  assign new_n44_ = ~x02 & ~x10 & x21;
  assign new_n45_ = x05 & x13 & x15 & x23;
  ...
  assign z7 = (~new_n67_ & (~x21 | x23)) | (x21 & x23 & ~x24 & ~x02 & ~x10);
  ...
  assign new_n78_ = ~new_n44_ & (~x05 | ~x13 | ~x15);
  assign new_n79_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n48_ & ~x20;
  assign z4 = ~new_n81_ | (~new_n37_ & (x08 ? ~new_n39_ : new_n89_));
  assign new_n81_ = (~x16 | (~new_n82_ & (new_n87_ | x09))) & ~new_n39_ & (new_n87_ | x08);
  assign new_n82_ = x22 & (new_n83_ | (~new_n85_ & ~new_n86_));
  assign new_n83_ = ~x24 & (new_n84_ | (x05 & x13 & ~new_n85_ & x15));
  assign new_n84_ = ~x02 & ~x10 & x21 & (~x04 | ~x17);
  assign new_n85_ = x17 & (x04 | ~x23);
  assign new_n86_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  ...
  assign z6 = ~new_n92_ | (~x11 & ~new_n99_ & (x06 | (~x14 & x20)));
  assign new_n92_ = (~x24 | new_n93_ | (~x05 & ~x13)) & new_n97_ & (new_n96_ | (x05 ? (~x13 | x24) : x13));
  assign new_n93_ = (~x03 | ~x07) & (new_n94_ | ~x18);
  assign new_n94_ = x03 ? (new_n95_ | ~x11) : new_n39_;
  assign new_n95_ = x06 & (~x14 | x20);
  assign new_n96_ = (~x03 | ~x19) & (new_n94_ | ~x15);
  assign new_n97_ = ~new_n39_ & (x02 | x10 | new_n98_ | x24);
  assign new_n98_ = x03 ? (~x00 & (~x11 | new_n95_ | ~x21)) : (~x21 | ~x23);
  assign new_n99_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n100_ & (x05 | x13 | ~x19);
  assign new_n100_ = x00 & ~x02 & ~x10 & ~x21 & ~x24;
endmodule
