...
module FAU ( 
  ...
  assign new_n71_ = (~new_n69_ | ~new_n72_) & (~new_n37_ | ~new_n68_);
  ...
  assign z4 = (~new_n78_ & (~x08 | (~new_n80_ & x16))) | (z5 & (x08 | (~new_n79_ & ~x16)));
  assign z5 = (~new_n39_ & (x02 | ~x12)) | (x00 & ~x02 & ~x10 & ~x12 & ~x24);
  assign new_n78_ = (new_n64_ | (~x02 & x12)) & (x02 | x10 | x12 | ~x21 | x24);
  assign new_n79_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n80_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n78_ & (~x03 | (~new_n83_ & x11))) | (z5 & (x03 | (~new_n82_ & ~x11)));
