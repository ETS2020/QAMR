...
module FAU ( 
  ...
  assign z4 = (~x24 & (~new_n78_ | (~new_n74_ & ~x08))) | ~new_n89_ | (~new_n85_ & x24);
  assign new_n78_ = new_n81_ & (~x05 | ~x13 | (~new_n79_ & (~new_n84_ | ~x15)));
  assign new_n79_ = x19 & ((~new_n80_ & ~x16) | (~new_n39_ & x08));
  assign new_n80_ = x09 ? x21 : (x22 | (~x17 & (~x04 | x23)));
  assign new_n81_ = (x16 | new_n80_ | new_n82_) & (~new_n83_ | x02);
  assign new_n82_ = (~x00 | x02 | x10) & (x05 | x13 | ~x19);
  assign new_n83_ = ~x10 & ((x16 & x21) | (x00 & x08 & (~x09 | ~x21)));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n85_ = (new_n86_ | (~x05 & ~x13)) & (x05 | x08 | x13 | ~new_n88_ | x16);
  assign new_n86_ = (~x07 | (x08 ? new_n39_ : ~new_n87_)) & (~x18 | (~new_n84_ & x08));
  assign new_n87_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n88_ = x19 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n89_ = ~new_n39_ & (x05 | new_n90_ | x13);
  assign new_n90_ = (~x08 | new_n39_ | ~x19) & (~x15 | (~new_n84_ & x08));
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = (~new_n37_ & (new_n95_ | x03)) | new_n39_ | (~new_n93_ & (new_n96_ | ~x03));
  ...
  assign new_n98_ = x21 & (x09 | (~x02 & ~x10 & ~x24));
endmodule
