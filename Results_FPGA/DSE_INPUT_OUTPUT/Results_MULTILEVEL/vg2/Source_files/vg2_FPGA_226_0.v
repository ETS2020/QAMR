...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (x02 | x12)) | (x12 & x21 & ~x24 & ~x02 & ~x10);
  ...
  assign z6 = new_n84_ | (~new_n87_ & ~new_n90_) | (new_n89_ & x02) | (~x02 & ~x12);
  ...
  assign new_n89_ = ~new_n62_ & ~x03;
  assign new_n90_ = x03 ? (~x11 | (x06 & (~x14 | x20))) : ~x12;
endmodule
