...
module FAU ( 
  ...
  assign z3 = (~x02 & (new_n67_ | new_n71_ | (new_n77_ & ~x10))) | (x12 & (new_n67_ | new_n71_));
  ...
  assign new_n71_ = x24 & ~new_n72_ & ~new_n61_;
  assign new_n72_ = (~new_n75_ | ~new_n76_) & (~new_n73_ | ~new_n74_ | ~x18 | ~x20);
  assign new_n73_ = x01 & x03 & x06 & x08;
  assign new_n74_ = x11 & x14;
  assign new_n75_ = ~x01 & ~x03 & ~x06 & x07;
  assign new_n76_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n77_ = ~x24 & (new_n78_ | (new_n73_ & new_n74_ & x20 & x21));
  ...
  assign new_n84_ = (~x13 | ~x19 | x24) & (~x07 | ~x24);
