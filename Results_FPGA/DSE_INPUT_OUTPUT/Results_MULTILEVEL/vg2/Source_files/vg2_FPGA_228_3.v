...
module FAU ( 
  ...
  assign z1 = new_n41_ | new_n58_ | (x24 & ~new_n52_ & ~new_n63_);
  ...
  assign new_n53_ = new_n45_ & ~x06 & x07 & ~x08 & ~x09;
  ...
  assign z3 = (~new_n70_ & ~x24) | ~new_n79_ | (x24 & ~new_n75_ & ~new_n63_);
  ...
  assign new_n79_ = ~new_n39_ & (x05 | new_n80_ | x13);
  ...
  assign z4 = new_n84_ | ~new_n90_ | (~new_n87_ & (new_n68_ | (~new_n51_ & x15)));
  assign new_n84_ = x24 & (new_n89_ | (~new_n63_ & (new_n85_ | (~new_n87_ & x18))));
  assign new_n85_ = x07 & (x08 ? ~new_n39_ : (~new_n86_ & ~x16));
  ...
  assign new_n90_ = (x16 | new_n91_ | new_n86_) & ~new_n39_ & (new_n92_ | ~x08);
  assign new_n91_ = ~new_n38_ & (~x19 | (x05 ? (~x13 | x24) : (x13 | (x08 & x24))));
  assign new_n92_ = (x02 | (~new_n93_ & (x05 | x13 | ~x19))) & (~x19 | x24 | (~x05 ^ ~x13));
  assign new_n93_ = x00 & ~x10 & ~x24;
  assign z5 = new_n38_ | (~new_n39_ & ~new_n95_);
  assign new_n95_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = (~new_n66_ & (~x03 | (~new_n98_ & x11))) | (z5 & (x03 | (~new_n97_ & ~x11)));
  assign new_n97_ = ~x06 & (x14 | ~x20);
  assign new_n98_ = x06 & (~x14 | x20);
  assign z7 = ~new_n100_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n100_ = ~new_n39_ & (~new_n101_ | ~x13) & ~new_n68_ & (x05 | x13 | ~x15);
