...
module FAU ( 
  ...
  assign z7 = (~new_n63_ & (x02 | ~x12)) | (~x02 & ~x10 & ~x12 & x21 & ~x24);
  ...
  assign new_n70_ = x24 & (new_n71_ | new_n73_) & (x05 | x13);
  ...
  assign z4 = (~new_n81_ & (x08 | (~new_n82_ & ~x16))) | (z7 & (~x08 | (~new_n83_ & x16)));
  assign new_n81_ = (new_n39_ | (~x02 & x12)) & (~x00 | x02 | x10 | x12 | x24);
  ...
  assign new_n88_ = ~x10 & ~x24 & x00 & ~x02;
