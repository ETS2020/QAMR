...
module FAU ( 
  ...
  assign z2 = x11 & (new_n43_ | x12);
  assign new_n43_ = x01 & x03 & x06 & x14 & ~new_n44_ & x20;
  ...
  assign z4 = (~new_n44_ & (new_n60_ | ~x08)) | new_n61_ | (~new_n37_ & (x08 ? ~new_n61_ : new_n62_));
  ...
  assign z6 = (~new_n67_ & (~x11 | ~x12)) | (new_n65_ & ~x11) | (x11 & new_n66_ & ~x12);
  assign new_n65_ = ~new_n37_ & (x06 | (~x14 & x20));
  assign new_n66_ = ~new_n44_ & (~x06 | (x14 & ~x20));
