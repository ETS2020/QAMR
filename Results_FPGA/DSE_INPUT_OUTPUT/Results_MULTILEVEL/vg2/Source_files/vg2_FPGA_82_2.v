...
module FAU ( 
  ...
  assign new_n42_ = x14 & x16 & x17 & x22 & ~new_n43_ & x23;
  ...
  assign z4 = ~new_n61_ & ((~new_n37_ & (new_n78_ | x08)) | (~new_n64_ & (new_n79_ | ~x08)));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n61_;
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | new_n61_ | (~new_n64_ & (new_n83_ | ~x03));
  assign new_n82_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n83_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n85_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n85_ = ~new_n61_ & ~new_n65_;
endmodule
