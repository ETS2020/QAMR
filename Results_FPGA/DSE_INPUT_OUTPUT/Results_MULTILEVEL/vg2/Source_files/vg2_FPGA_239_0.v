...
module FAU ( 
  ...
  assign new_n49_ = x01 & x03 & x04 & new_n50_ & x09 & x11;
  ...
  assign z7 = (~new_n68_ & (x10 | x21)) | (~x02 & ~x10 & x21 & ~x24);
  assign new_n68_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n70_ & ~x24) | (~new_n74_ & x24) | new_n80_ | (~x10 & ~x21);
  assign new_n70_ = x01 ? (~x03 | ~x06 | ~new_n72_ | ~x08) : (x03 | x06 | ~new_n71_ | x08);
  assign new_n71_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign new_n72_ = x11 & x14 & ~new_n73_ & x20;
  assign new_n73_ = (~x15 | (~x10 & ~x21) | (~x05 ^ ~x13)) & (x02 | x10 | ~x21);
  assign new_n74_ = (new_n75_ | (~x05 & ~x13)) & (~new_n78_ | ~new_n79_ | ~x11 | x13);
  assign new_n75_ = (~new_n76_ | ~new_n50_ | ~x01 | ~x03) & (~new_n77_ | ~new_n55_ | x01 | x03);
  assign new_n76_ = x11 & x14 & x18 & x20;
  assign new_n77_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n78_ = x01 & x03 & new_n50_ & ~x05;
  assign new_n79_ = x14 & x15 & x20;
  assign new_n80_ = new_n81_ & ~x01 & ~x03 & ~x05 & ~x06 & ~x08;
  assign new_n81_ = ~x11 & ~x13 & ~x14 & x19 & ~x20;
  assign z4 = ~new_n83_ | (z7 & (new_n87_ | ~x08));
  assign new_n83_ = ~new_n86_ & ((~x10 & ~x21) | new_n84_ | (~new_n85_ & ~x08));
  ...
  assign z5 = new_n86_ | (~new_n84_ & (x10 | x21));
  assign z6 = new_n90_ | new_n86_ | (new_n91_ & (x10 | x21));
