...
module FAU ( 
  ...
  assign new_n63_ = x11 & x14 & x20 & ~new_n64_ & (x08 | ~x23);
  ...
  assign new_n74_ = (x08 | ~x23) & (x05 | new_n75_ | x13);
  ...
  assign z4 = (~new_n38_ & (new_n79_ | x08)) | (~new_n64_ & (x08 ? new_n80_ : ~x23));
  assign new_n79_ = ~x16 & ~x23 & (x09 | (~x22 & (x04 | x17)));
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (x08 | ~x23) & (new_n82_ | new_n83_);
  assign new_n82_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n83_ = ~new_n64_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n85_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n85_ = ~new_n65_ & (x08 | ~x23);
endmodule
