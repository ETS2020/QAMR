...
module FAU ( 
  ...
  wire new_n36_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_, new_n44_,
    ...
    new_n62_, new_n64_, new_n65_, new_n66_, new_n68_;
  ...
  assign new_n49_ = (~x18 | (~x05 & ~x13) | ~x24) & (x05 | x13 | ~x15);
  assign z2 = x01 & x03 & new_n51_ & x06;
  assign new_n51_ = x11 & x14 & ~new_n52_ & x20;
  assign new_n52_ = ~new_n54_ & (~x21 | (~new_n53_ & (x02 | x10 | x24)));
  assign new_n53_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n54_ = ~x05 & (x13 ? (x18 & x24) : x15);
  assign z3 = x01 ? (x03 & x06 & new_n51_ & x08) : (~x03 & ~x06 & new_n36_ & ~x08);
  assign z4 = (~new_n57_ & (new_n60_ | x08)) | new_n62_ | (~new_n52_ & (new_n61_ | ~x08));
  assign new_n57_ = x05 ? ~new_n58_ : (new_n59_ & (x13 | ~x19));
  assign new_n58_ = x21 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n59_ = (~x07 | ~x13 | ~x24) & (x10 | x24 | ~x00 | x02);
  assign new_n60_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n61_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n62_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z6 = (~new_n57_ & (new_n64_ | x03)) | new_n66_ | (~new_n52_ & (new_n65_ | ~x03));
  assign new_n64_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n65_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n66_ = ~x10 & x21 & ~x24 & x00 & ~x02 & x05;
  assign z7 = ~new_n68_ | (~new_n48_ & ~x24);
  assign new_n68_ = (~x05 | (x21 & (~x18 | ~x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
endmodule
