...
module FAU ( 
  ...
  assign z4 = new_n78_ | new_n85_ | (~new_n87_ & ~x02) | (new_n82_ & x24);
  ...
  assign new_n83_ = (~x02 | ~x07 | ~x08) & (~x18 | (~new_n84_ & x08));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n85_ = ~new_n86_ & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n86_ = (~x02 | ~x08 | ~x19) & (~x15 | (~new_n84_ & x08));
  assign new_n87_ = ~x12 & (x10 | ~x21 | x24 | (~new_n84_ & x08));
