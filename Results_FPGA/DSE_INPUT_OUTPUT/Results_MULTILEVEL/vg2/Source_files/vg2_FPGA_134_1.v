...
module FAU ( 
  ...
  assign z3 = (~new_n72_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n68_ | (x24 & ~new_n64_ & (x05 | x13));
  assign new_n64_ = ~new_n65_ & (~new_n67_ | ~x11 | ~x14 | ~x18 | ~x20);
  assign new_n65_ = new_n66_ & ~x01 & ~x03 & ~x06 & x07;
  assign new_n66_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n67_ = x01 & x03 & x06 & x08;
  assign new_n68_ = ~x02 & (x12 | (~x10 & ~new_n69_ & ~x24));
  assign new_n69_ = (~new_n66_ | ~new_n70_) & (~new_n67_ | ~new_n71_);
  assign new_n70_ = x00 & ~x01 & ~x03 & ~x06;
  ...
  assign z6 = (~new_n76_ & (new_n85_ | x03)) | new_n80_ | (~new_n78_ & (new_n86_ | ~x03));
