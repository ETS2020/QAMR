...
module FAU ( 
  ...
  assign z4 = (~new_n45_ & (new_n64_ | ~x08)) | new_n39_ | (~new_n37_ & (new_n62_ | (~new_n39_ & x08)));
  assign new_n62_ = ~new_n63_ & ~x16;
  assign new_n63_ = (x08 | (~x09 & (~x17 | x22))) & (~x04 | x22 | x23);
  assign new_n64_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = ~new_n39_ & (new_n67_ | new_n68_);
  assign new_n67_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n68_ = ~new_n45_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
