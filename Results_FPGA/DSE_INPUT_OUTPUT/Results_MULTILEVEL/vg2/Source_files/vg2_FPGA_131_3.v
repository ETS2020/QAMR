...
module FAU ( 
  ...
  assign z1 = (~new_n42_ & ~x24) | new_n49_ | new_n58_ | new_n40_;
  ...
  assign new_n58_ = ~x01 & ~x03 & ~x04 & ~x06 & new_n59_ & x07;
  assign new_n59_ = ~x08 & ~x09 & ~x11 & new_n60_ & ~x12;
  assign new_n60_ = ~x14 & ~x16 & ~x17 & new_n61_ & ~x20;
  assign new_n61_ = ~x22 & ~x23 & (x05 | x13) & x24;
  assign z2 = new_n40_ | (new_n63_ & x01);
  ...
  assign new_n67_ = (~x24 | new_n68_ | (~x05 & ~x13)) & ~new_n40_ & (x05 | new_n72_ | x13);
  ...
  assign new_n75_ = x06 & x08 & x11 & x14 & ~new_n45_ & x20;
  assign new_n76_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n48_ & ~x20;
  assign z4 = (~new_n64_ & (new_n78_ | ~x08)) | new_n40_ | (~new_n38_ & (x08 ? ~new_n40_ : new_n79_));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = (~new_n81_ & ~new_n40_) | (x24 & ~new_n86_ & (x05 | x13));
  assign new_n81_ = (new_n38_ | ~x03) & (new_n84_ | new_n85_) & (~new_n82_ | x11);
  assign new_n82_ = ~new_n83_ & (new_n39_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n83_ = ~x06 & (x14 | ~x20);
  assign new_n84_ = ~new_n65_ & (~x15 | (x05 ? (~x13 | x24) : x13));
  assign new_n85_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n86_ = (~x07 | x11 | new_n83_ | x18) & (x12 | new_n85_ | ~x18);
  assign z7 = (~new_n84_ & (~x12 | ~x18)) | (~x12 & x18 & x24 & (x05 | x13));
endmodule
