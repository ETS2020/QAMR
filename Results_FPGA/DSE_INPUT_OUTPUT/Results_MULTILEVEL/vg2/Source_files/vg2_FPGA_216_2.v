...
module FAU ( 
  ...
  assign z2 = (x05 & ~x21) | (x01 & new_n51_ & x03);
  assign new_n51_ = x06 & x11 & x14 & ~new_n52_ & x20;
  ...
  assign z7 = new_n57_ | (x21 & (new_n56_ | (~x02 & ~x10 & ~x24)));
  assign new_n56_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n57_ = ~x05 & (x13 ? (x18 & x24) : x15);
  assign z4 = (~new_n59_ & (new_n68_ | x08)) | ~new_n67_ | (~new_n63_ & ~x24);
  assign new_n59_ = x05 ? (new_n62_ | ~x21) : (new_n60_ & (x13 | ~x19));
  assign new_n60_ = ~new_n61_ & (~x07 | ~x13 | ~x24);
  assign new_n61_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n62_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n63_ = (~new_n66_ | x02) & (~x05 | ~x13 | new_n64_ | ~x15);
  assign new_n64_ = ~new_n65_ & x08;
  assign new_n65_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n66_ = ~x10 & ((x21 & (new_n65_ | ~x08 | (x00 & (x05 | x08)))) | (x05 & (new_n65_ | ~x08)));
  assign new_n67_ = (new_n64_ | new_n49_) & (~x05 | x21);
  ...
  assign z6 = (~new_n75_ & (new_n76_ | x03)) | new_n78_ | (z7 & (new_n77_ | ~x03));
  assign new_n75_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | (~new_n61_ & (x13 | ~x19)));
  assign new_n76_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n77_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n78_ = x05 & (~x21 | (x00 & ~x02 & ~x10 & x21 & ~x24));
endmodule
