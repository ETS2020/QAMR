...
module FAU ( 
  ...
  assign z4 = new_n74_ | (new_n81_ & x00) | (z7 & (new_n82_ | ~x08));
  assign new_n74_ = ~new_n75_ & (~x20 | ~x21);
  assign new_n75_ = (new_n78_ | (~x08 & (new_n79_ | x16))) & (~new_n76_ | ~new_n77_ | ~x08);
  ...
  assign new_n81_ = ~x02 & ~x10 & ~x16 & ~x21 & ~new_n79_ & ~x24;
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (~x20 | ~x21);
  assign z6 = (~new_n85_ & ~x20) | (~new_n89_ & ~x21);
  ...
  assign new_n88_ = (new_n78_ | (~x03 & (~x06 | x11))) & (~new_n76_ | ~new_n77_ | ~x03);
  assign new_n89_ = (new_n37_ | (~x03 & (x11 | (~new_n90_ & ~x06)))) & (new_n61_ | (x03 & (x06 | ~x11)));
