...
module FAU ( 
  ...
  assign new_n54_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = new_n57_ | new_n56_ | (~x05 & ~x13 & x15 & ~x21);
  assign new_n56_ = x05 & (new_n51_ | (x18 & x24));
  assign new_n57_ = x13 & ((x18 & ~x21 & x24) | (x05 & x15 & ~x24));
  assign z3 = (~x24 & (new_n71_ | (~new_n59_ & x05))) | (~new_n63_ & x24) | (~new_n67_ & ~x05);
  assign new_n59_ = (~x01 | ~x03 | ~x06 | ~new_n60_ | ~x08) & (~new_n62_ | x01 | x03 | x06 | x08);
  assign new_n60_ = x11 & new_n61_ & x14;
  assign new_n61_ = x20 & ((x13 & x15) | (~x02 & ~x10 & x21));
  assign new_n62_ = ~x11 & x13 & ~x14 & x19 & ~x20;
  assign new_n63_ = x01 ? (~x03 | ~new_n64_ | ~x06) : (x03 | x06 | ~new_n66_ | ~x07);
  assign new_n64_ = x08 & new_n65_ & x11;
  assign new_n65_ = x14 & x18 & x20 & (x05 | (x13 & ~x21));
  assign new_n66_ = ~x08 & ~x11 & ~x14 & ~x20 & (x05 | x13);
  assign new_n67_ = ~x21 & (new_n68_ | x13);
  ...
  assign z4 = (~new_n75_ & (new_n77_ | x08)) | new_n52_ | (~new_n74_ & (new_n78_ | ~x08));
  assign new_n74_ = ~new_n48_ & ~new_n49_ & ~new_n50_ & ~new_n51_;
  ...
  assign new_n80_ = ~new_n76_ & (~x07 | ~x13 | ~x24);
  assign new_n81_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n75_ & (x03 | (~new_n88_ & ~x11))) | ~new_n83_ | (new_n85_ & x11);
  assign new_n83_ = (new_n84_ | x03) & (x05 | (~x21 & (~x15 | x21 | x03 | x13)));
  assign new_n84_ = ~new_n56_ & ~new_n57_;
  assign new_n85_ = (~x06 | (x14 & ~x20)) & (x24 ? ~new_n86_ : ~new_n87_);
  assign new_n86_ = (~x05 | ~x18) & (~x03 | ((x05 | x13 | ~x15) & (~x13 | ~x18)));
  assign new_n87_ = (~x15 | x21 | x05 | x13) & (~x05 | ((~x13 | ~x15) & (x02 | x10 | ~x21)));
