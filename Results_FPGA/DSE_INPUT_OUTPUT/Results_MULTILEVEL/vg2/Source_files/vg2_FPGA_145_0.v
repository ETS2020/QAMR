...
module FAU ( 
  ...
  assign z1 = (x01 & x03 & x04 & new_n40_ & x06) | (~x03 & ~x12);
  ...
  assign z2 = (~x03 & ~x12) | (x01 & new_n45_ & x03);
  ...
  assign z6 = (~new_n37_ & (new_n65_ | x03)) | (~x03 & ~x12) | (~new_n42_ & (x03 ? new_n66_ : x12));
  assign new_n65_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n66_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n42_ & (x03 | (~x03 & x12));
endmodule
