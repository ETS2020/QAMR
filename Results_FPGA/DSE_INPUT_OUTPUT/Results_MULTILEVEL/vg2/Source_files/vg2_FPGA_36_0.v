...
module FAU ( 
  ...
  assign new_n37_ = (x15 | x21) & (new_n38_ | new_n39_ | new_n40_ | new_n41_);
  ...
  assign z5 = new_n38_ | new_n39_ | new_n40_ | new_n41_ | (~x15 & ~x21);
  assign z6 = ~new_n67_ | (~x11 & ~new_n74_ & (x06 | (~x14 & x20)));
  assign new_n67_ = (x24 | (~new_n68_ & (~x05 | new_n73_ | ~x13))) & (x05 | new_n73_ | x13) & (new_n71_ | ~x24);
  assign new_n68_ = new_n69_ & ~x02;
  assign new_n69_ = ~x10 & ((x00 & (x21 | (x03 & x15))) | (x21 & (new_n70_ | ~x03)));
  assign new_n70_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n71_ = (new_n72_ | new_n49_) & (~x15 | ~x18 | (~new_n70_ & x03));
  assign new_n72_ = (~x03 | ~x07 | (~x15 & ~x21)) & (~x18 | ~x21 | (~new_n70_ & x03));
  assign new_n73_ = (~x15 | (~new_n70_ & x03 & ~x19)) & (~x03 | ~x19 | ~x21);
  assign new_n74_ = ~new_n62_ & (~x15 | (~new_n40_ & (x03 | ~x07 | ~x24)));
endmodule
