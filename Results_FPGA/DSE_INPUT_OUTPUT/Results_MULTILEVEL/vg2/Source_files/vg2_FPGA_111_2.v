...
module FAU ( 
  ...
  assign new_n52_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = new_n55_ | (x21 & (new_n54_ | (~x02 & ~x10 & ~x24)));
  assign new_n54_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n55_ = ~x05 & (x13 ? (x18 & x24) : x15);
  assign z3 = ~new_n57_ | (~x24 & (x01 ? (new_n65_ & x03) : (new_n67_ & ~x03)));
  assign new_n57_ = (new_n58_ | ~x24) & (~x05 | x21) & (x05 | new_n62_ | x13);
  assign new_n58_ = x01 ? (~x03 | ~x06 | ~new_n61_ | ~x08) : (x03 | ~new_n59_ | x06);
  assign new_n59_ = new_n60_ & x07;
  assign new_n60_ = ~x08 & ~x11 & ~x14 & ~x20 & (x05 | x13);
  assign new_n61_ = x11 & x14 & x18 & x20 & (x05 | (~x05 & x13));
  ...
  assign new_n66_ = x21 & ((x05 & x13 & x15) | (~x02 & ~x10));
  assign new_n67_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n68_ & ~x20;
  assign new_n68_ = (~x00 | x02 | x10) & (~x05 | ~x13 | ~x19);
  assign z4 = (~new_n71_ & (new_n73_ | x08)) | new_n50_ | (~new_n70_ & (new_n74_ | ~x08));
  assign new_n70_ = new_n49_ & (new_n48_ | x24);
  assign new_n71_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n72_ & (x05 | x13 | ~x19);
  assign new_n72_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n73_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n74_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n76_ | (x07 & x24 & (x05 | x13));
  assign new_n76_ = ~new_n72_ & (x05 | x13 | ~x19) & (~x05 | (x21 & (~x13 | ~x19 | x24)));
  assign z6 = (~new_n78_ & (new_n79_ | x03)) | new_n81_ | (z7 & (new_n80_ | ~x03));
  assign new_n78_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | (~new_n72_ & (x13 | ~x19)));
  assign new_n79_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n80_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n81_ = x05 & (~x21 | (x00 & ~x02 & ~x10 & x21 & ~x24));
endmodule
