...
module FAU ( 
  ...
  assign new_n55_ = (~new_n56_ | ~new_n58_) & (~x14 | ~x21);
  ...
  assign z3 = (~new_n63_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n71_ | (x24 & ~new_n67_ & (x05 | x13));
  assign new_n63_ = (~new_n66_ | x01 | x03 | x06 | x08) & (~new_n64_ | ~x01 | ~x03 | ~x06 | ~x08);
  assign new_n64_ = new_n65_ & x15 & x20 & ~x21;
  ...
  assign z4 = ~new_n74_ | (~new_n80_ & (new_n81_ | ~x08));
  assign new_n74_ = (new_n75_ | (x14 & x21)) & (~x00 | ~new_n79_ | x02);
  assign new_n75_ = ~new_n78_ & (new_n76_ | (~x08 & (new_n77_ | x16)));
  assign new_n76_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n77_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n78_ = x00 & ~x02 & x08 & ~x10 & ~x24;
  assign new_n79_ = ~x10 & ~x16 & ~x21 & ~new_n77_ & ~x24;
  assign new_n80_ = (new_n61_ | (x14 & x21)) & (x02 | x10 | x14 | ~x21 | x24);
  ...
  assign new_n84_ = (~x14 | ~x21) & (x05 | x13 | ~x19);
  assign z6 = ~new_n86_ | (~new_n80_ & (~x03 | (~x06 & x11)));
  assign new_n86_ = (new_n87_ | (x05 ? (~x13 | x24) : x13)) & ~new_n90_ & (~x24 | new_n89_ | (~x05 & ~x13));
  assign new_n87_ = (new_n88_ | ~x19) & (~new_n65_ | ~x15 | x20 | x21);
  assign new_n88_ = ((x14 & x21) | (~x03 & (~x06 | x11))) & (x11 | x14 | ~x20);
  assign new_n89_ = (new_n88_ | ~x07) & (~new_n65_ | ~x18 | x20 | x21);
  assign new_n90_ = x00 & ~x02 & ~x10 & ~new_n91_ & ~x24;
  assign new_n91_ = (~x03 | (x14 & x21)) & (x11 | ((x14 | ~x20) & (~x06 | x21)));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n93_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n93_ = x21 & (x14 | (~x02 & ~x10 & ~x24));
endmodule
