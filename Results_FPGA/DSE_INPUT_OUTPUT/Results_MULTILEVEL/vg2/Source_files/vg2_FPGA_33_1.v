...
module FAU ( 
  ...
  assign new_n63_ = x06 & x11 & x14 & (new_n65_ | (~new_n64_ & x20));
  ...
  assign new_n68_ = (~x24 | new_n69_ | (~x05 & ~x13)) & ~new_n66_ & (x05 | new_n74_ | x13);
  assign new_n69_ = ~new_n70_ & (~new_n72_ | ~new_n73_ | ~x18 | ~x20);
  ...
  assign new_n75_ = new_n73_ & x15 & x20;
  assign new_n76_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n77_ = x06 & x08 & x11 & ~new_n78_ & x14;
  assign new_n78_ = ~new_n79_ & (x02 | x10 | ~x21);
  assign new_n79_ = x15 & x20 & x05 & x13;
  assign new_n80_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n47_ & ~x20;
  assign z4 = (~new_n37_ & (x08 ? ~new_n66_ : new_n83_)) | new_n66_ | (~new_n82_ & (new_n84_ | ~x08));
  ...
  assign z5 = ~new_n37_ & ~new_n66_;
  assign z6 = ~new_n87_ | (~new_n93_ & (~x03 | (~x06 & x11)));
  assign new_n87_ = (new_n88_ | (x05 ? (~x13 | x24) : x13)) & ~new_n91_ & (~x24 | new_n90_ | (~x05 & ~x13));
  assign new_n88_ = (new_n89_ | ~x19) & (~new_n73_ | ~x15 | x20 | x21);
  assign new_n89_ = ((~x20 & x21) | (~x03 & (~x06 | x11))) & (x11 | x14 | ~x20);
  assign new_n90_ = (new_n89_ | ~x07) & (~new_n73_ | ~x18 | x20 | x21);
  assign new_n91_ = x00 & ~x02 & ~x10 & ~new_n92_ & ~x24;
  assign new_n92_ = (~x03 | (~x20 & x21)) & (x11 | ((x14 | ~x20) & (~x06 | x21)));
  assign new_n93_ = (new_n64_ | (~x20 & x21)) & (~x20 | ~x21 | x24 | x02 | x10);
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n95_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n95_ = x21 & (~x20 | (~x02 & ~x10 & ~x24));
endmodule
