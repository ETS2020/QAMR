...
module FAU ( 
  ...
  assign z2 = x14 & (new_n63_ | ~x16);
  assign new_n63_ = x01 & x03 & x06 & x11 & ~new_n64_ & x20;
  ...
  assign z4 = (~new_n80_ & (~x14 | x16)) | (new_n79_ & x16) | (~x14 & new_n78_ & ~x16);
  assign new_n78_ = ~new_n37_ & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = ~new_n64_ & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n80_ = (x24 | (~new_n81_ & (~x05 | new_n82_ | ~x13))) & (x05 | new_n82_ | x13) & (~x24 | new_n83_ | (~x05 & ~x13));
  ...
  assign z6 = ~new_n89_ | (~new_n88_ & ~new_n39_);
  assign new_n88_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n64_ | (x03 & (x06 | ~x11)));
  assign new_n89_ = (x24 | (~new_n90_ & (~x05 | new_n92_ | ~x13))) & (x05 | new_n92_ | x13) & (~x24 | new_n93_ | (~x05 & ~x13));
  assign new_n90_ = ~x02 & ~new_n91_ & ~x10;
  assign new_n91_ = (~x00 | x11 | x14 | ~x20) & (~x11 | ~x14 | ~x16 | x20 | ~x21);
  assign new_n92_ = (~x19 | ~x20 | x11 | x14) & (~x11 | ~x14 | ~x15 | ~x16 | x20);
  assign new_n93_ = (~x07 | x11 | x14 | ~x20) & (~x16 | ~x18 | x20 | ~x11 | ~x14);
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n95_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n95_ = ~new_n39_ & ~new_n65_;
endmodule
