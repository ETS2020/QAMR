...
module FAU ( 
  ...
  assign z2 = new_n39_ | (new_n44_ & x01);
  assign new_n44_ = x03 & x06 & x11 & x14 & ~new_n45_ & x20;
  ...
  assign z4 = (~new_n45_ & ~new_n63_) | (~new_n37_ & ~new_n61_);
  assign new_n61_ = (x16 | new_n62_ | x22) & ((x12 & x22) | (~x08 & (~x09 | x16)));
  assign new_n62_ = ~x17 & (~x04 | x23);
  assign new_n63_ = ((x12 & x22) | (x08 & (x09 | ~x16))) & (x12 | ~x16 | new_n64_ | ~x22);
  assign new_n64_ = x17 & (x04 | ~x23);
  ...
  assign z6 = (~new_n37_ & (new_n69_ | x03)) | new_n39_ | (~new_n45_ & (new_n70_ | ~x03));
  ...
  assign new_n72_ = ~new_n39_ & ~new_n46_;
endmodule
