...
module FAU ( 
  ...
  assign z4 = (~new_n81_ & (x08 | (~new_n83_ & ~x16))) | (~new_n63_ & (~x08 | (~new_n84_ & x16)));
  assign new_n81_ = ~new_n38_ & (new_n82_ | (x02 & ~x12));
  ...
  assign z6 = (~new_n81_ & (x03 | (~new_n89_ & ~x11))) | (~new_n63_ & (~x03 | (~new_n90_ & x11)));
  assign new_n89_ = ~x06 & (x14 | ~x20);
  assign new_n90_ = x06 & (~x14 | x20);
  assign z7 = (~new_n92_ & x05) | ~new_n93_ | new_n65_ | (~x05 & ~x13 & x15);
  assign new_n92_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n93_ = (~x02 | x12) & (~x13 | ~x18 | ~x24);
endmodule
