...
module FAU ( 
  ...
  assign z4 = (~new_n82_ & (x08 | (~new_n84_ & ~x16))) | (z7 & (~x08 | (~new_n85_ & x16)));
  ...
  assign z6 = new_n88_ | (~new_n91_ & ~new_n94_) | (new_n93_ & x02) | (~x02 & x12);
  ...
  assign new_n93_ = ~new_n64_ & ~x03;
  assign new_n94_ = x03 ? (~x11 | (x06 & (~x14 | x20))) : x12;
endmodule
