...
module FAU ( 
  ...
  assign new_n71_ = (~new_n37_ | ~new_n68_) & (~new_n69_ | ~new_n72_);
  ...
  assign new_n84_ = ~new_n60_ & ((x18 & (new_n83_ | ~x08)) | (x02 & x07 & x08));
  assign new_n85_ = x12 & (x10 | ~x21 | x24 | (~new_n83_ & x08));
  assign z5 = (~new_n39_ & (x02 | x12)) | (x00 & ~x02 & ~x10 & x12 & ~x24);
  assign z6 = new_n88_ | new_n89_ | (~x02 & ~x12);
  assign new_n88_ = ~new_n78_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
