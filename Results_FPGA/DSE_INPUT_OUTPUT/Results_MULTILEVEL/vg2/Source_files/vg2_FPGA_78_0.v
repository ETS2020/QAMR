...
module FAU ( 
  ...
  assign z2 = (~new_n61_ & ~x02) | (new_n63_ & x01);
  ...
  assign z4 = (~new_n82_ & (new_n86_ | x08)) | new_n88_ | (~new_n84_ & (new_n87_ | ~x08));
  ...
  assign new_n88_ = ~x02 & ~x12;
  assign z5 = ~new_n39_ | (~x02 & (~x12 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n91_ & (x03 | (~new_n93_ & ~x11))) | (z7 & (~x03 | (~new_n94_ & x11)));
  assign new_n91_ = (new_n39_ | (~x02 & ~x12)) & (~x00 | x02 | x10 | ~x12 | x24);
  assign z7 = (~new_n64_ & (x02 | x12)) | (x12 & x21 & ~x24 & ~x02 & ~x10);
