...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n78_ | x08)) | new_n65_ | (~new_n63_ & (new_n79_ | ~x08));
  ...
  assign new_n87_ = (~x00 | x11 | x12 | x14 | ~x20) & (x20 | ~x21 | ~x11 | ~x14);
  assign new_n88_ = (x11 | x12 | x14 | ~x19 | ~x20) & (~x11 | ~x14 | ~x15 | x20);
  assign new_n89_ = (~x07 | x11 | x12 | x14 | ~x20) & (~x18 | x20 | ~x11 | ~x14);
