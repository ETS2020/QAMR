...
module FAU ( 
  ...
  assign z2 = (x21 & x23) | (new_n60_ & x01);
  ...
  assign z4 = (~new_n37_ & (new_n80_ | x08)) | new_n78_ | (~new_n61_ & (new_n81_ | ~x08));
  assign new_n78_ = x23 & (x21 | (~x04 & x16 & ~new_n79_ & x22));
  ...
  assign new_n84_ = (~x21 | ~x23) & (x05 | x13 | ~x19);
  assign z6 = new_n86_ | new_n88_ | (x00 & ~x02 & new_n92_ & ~x10);
  assign new_n86_ = ~new_n87_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n87_ = (new_n79_ | (x21 & x23)) & (x02 | x10 | ~x21 | x23 | x24);
  assign new_n88_ = (~x21 | ~x23) & (new_n89_ | new_n91_);
