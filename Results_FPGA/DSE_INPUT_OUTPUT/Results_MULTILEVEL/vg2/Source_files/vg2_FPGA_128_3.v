...
module FAU ( 
  ...
  assign new_n49_ = x05 ? ~new_n51_ : ((x13 | ~x15) & ~new_n52_ & (~new_n50_ | ~x13));
  assign new_n50_ = x18 & x24;
  assign new_n51_ = ~x21 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n52_ = ~x02 & ~x10 & x21 & ~x24;
  assign z2 = new_n54_ & x01;
  assign new_n54_ = x03 & x06 & x11 & x14 & ~new_n49_ & x20;
  assign z3 = ~new_n56_ | (~x24 & (x01 ? (new_n64_ & x03) : (new_n66_ & ~x03)));
  assign new_n56_ = (new_n57_ | ~x24) & (~x05 | ~x21) & (x05 | new_n61_ | x13);
  assign new_n57_ = x01 ? (~x03 | ~new_n58_ | ~x06) : (x03 | x06 | ~new_n60_ | ~x07);
  assign new_n58_ = x08 & new_n59_ & x11;
  assign new_n59_ = x14 & x18 & x20 & (x05 ? ~x21 : x13);
  assign new_n60_ = ~x08 & ~x11 & ~x14 & ~x20 & (x05 | x13);
  assign new_n61_ = (~new_n62_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n63_ | x01 | x03 | x06 | x08);
  assign new_n62_ = x11 & x14 & x15 & x20;
  assign new_n63_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n64_ = x06 & x08 & x11 & x14 & ~new_n65_ & x20;
  assign new_n65_ = (x02 | x05 | x10 | ~x21) & (~x15 | x21 | ~x05 | ~x13);
  assign new_n66_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n67_ & ~x20;
  assign new_n67_ = (~x00 | x02 | x10) & (~x05 | ~x13 | ~x19);
  assign z4 = (~new_n37_ & (new_n70_ | x08)) | new_n39_ | (~new_n69_ & (new_n71_ | ~x08));
  assign new_n69_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n52_ & (x05 | x13 | ~x15);
  assign new_n70_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n71_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n73_ | (x07 & x24 & (x05 | x13));
  assign new_n73_ = ~new_n38_ & (x05 | x13 | ~x19) & (new_n74_ | ~x05);
  assign new_n74_ = ~x21 & (~x13 | ~x19 | x24);
  assign z6 = (~new_n49_ & (~x03 | (~new_n76_ & x11))) | (~new_n43_ & (x03 | (~new_n77_ & ~x11)));
  assign new_n76_ = x06 & (~x14 | x20);
  assign new_n77_ = ~x06 & (x14 | ~x20);
  assign z7 = ~new_n79_ | (x13 & ((x18 & x24) | (x05 & x15 & ~x24)));
  assign new_n79_ = ~new_n52_ & (x05 | x13 | ~x15) & (~x05 | (~new_n50_ & ~x21));
endmodule
