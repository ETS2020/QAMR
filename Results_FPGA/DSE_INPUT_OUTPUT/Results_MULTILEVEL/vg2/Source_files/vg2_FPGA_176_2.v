...
module FAU ( 
  ...
  assign new_n48_ = ~new_n49_ & ~new_n39_ & (~x01 | ~new_n58_ | ~x03);
  ...
  assign z4 = (~new_n79_ & ~new_n39_) | (x24 & ~new_n86_ & (x05 | x13));
  assign new_n79_ = (new_n63_ | x08) & ~new_n80_ & (x02 | ~new_n85_ | x10);
  assign new_n80_ = ~new_n83_ & ((~new_n81_ & x19) | (x15 & ~new_n84_ & x16));
  ...
  assign new_n85_ = ~x24 & ((x16 & ~new_n84_ & x21) | (~new_n81_ & x00));
  assign new_n86_ = x07 ? (new_n81_ | ~x12) : (~x16 | new_n84_ | ~x18);
  assign z5 = (x07 & new_n88_ & x12) | ((~x07 | x12) & (new_n38_ | (~new_n83_ & x19)));
  assign new_n88_ = x24 & (x05 | x13);
  assign z6 = (~new_n37_ & (new_n90_ | x03)) | new_n39_ | (~new_n63_ & (new_n91_ | ~x03));
  assign new_n90_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n91_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n93_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n93_ = ~new_n64_ & (x05 | x13 | ~x15) & ~new_n39_ & (~new_n94_ | ~x13);
