...
module FAU ( 
  ...
  assign new_n48_ = (~x24 | new_n49_ | (~x05 & ~x13)) & ~new_n42_ & (x05 | new_n53_ | x13);
  ...
  assign z4 = ~new_n42_ & ((~new_n37_ & (new_n61_ | x08)) | (~new_n45_ & (new_n62_ | ~x08)));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n42_;
  assign z6 = (~new_n37_ & (new_n65_ | x03)) | new_n42_ | (~new_n45_ & (new_n66_ | (~new_n42_ & ~x03)));
  assign new_n65_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n66_ = x11 & ((x03 & ~x06) | (x14 & ~x20));
  assign z7 = ~new_n45_ & ~new_n42_;
endmodule
