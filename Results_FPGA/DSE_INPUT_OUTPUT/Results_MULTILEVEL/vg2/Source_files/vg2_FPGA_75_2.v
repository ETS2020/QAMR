...
module FAU ( 
  ...
  assign z3 = ~new_n68_ | (~x24 & (x01 ? (new_n77_ & x03) : (new_n79_ & ~x03)));
  ...
  assign z6 = ~new_n90_ | (~new_n81_ & (x03 | (x06 & ~x11)));
  assign new_n90_ = (~x24 | new_n91_ | (~x05 & ~x13)) & ~new_n94_ & (new_n93_ | (x05 ? (~x13 | x24) : x13));
  assign new_n91_ = (new_n92_ | ~x18) & (~x07 | x11 | ~new_n75_ | x14);
  assign new_n92_ = ((x20 & ~x21) | (x03 & (x06 | ~x11))) & (~x11 | ~x14 | x20);
  assign new_n93_ = (new_n92_ | ~x15) & (x11 | x14 | ~new_n75_ | ~x19);
  assign new_n94_ = ~x02 & ~x10 & x21 & ~new_n95_ & ~x24;
  assign new_n95_ = (~x11 | (x06 & (~x14 | x20))) & ~x00 & x03;
endmodule
