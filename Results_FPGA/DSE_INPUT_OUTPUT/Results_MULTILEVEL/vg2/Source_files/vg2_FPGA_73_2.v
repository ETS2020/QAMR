...
module FAU ( 
  ...
  assign z4 = (~new_n65_ & (new_n79_ | ~x08)) | new_n39_ | (~new_n37_ & (x08 ? ~new_n39_ : new_n80_));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n80_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = (~new_n37_ & (new_n83_ | x03)) | new_n39_ | (~new_n65_ & (x03 ? new_n84_ : ~new_n39_));
