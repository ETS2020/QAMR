...
module FAU ( 
  ...
  wire new_n36_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_, new_n44_,
    ...
    new_n76_, new_n78_, new_n79_, new_n80_, new_n81_, new_n83_;
  assign z0 = ~x01 & ~x03 & new_n36_ & ~x06;
  assign new_n36_ = ~x11 & ~x14 & z5 & ~x20;
  assign z5 = new_n38_ | ~new_n40_;
  assign new_n38_ = ~x24 & (new_n39_ | (x05 & x13 & x19 & ~x21));
  assign new_n39_ = x00 & ~x02 & ~x10 & (~x05 | ~x21);
  assign new_n40_ = (x05 | ((x13 | ~x19) & (~x07 | ~x13 | ~x24))) & (~x05 | ~x07 | x21 | ~x24);
  assign z1 = (~new_n42_ & ~x24) | ~new_n56_ | (~new_n49_ & x24);
  ...
  assign new_n49_ = x01 ? (~x03 | ~x04 | ~new_n50_ | ~x06) : (x03 | x04 | ~new_n53_ | x06);
  assign new_n50_ = x08 & new_n51_ & x09;
  assign new_n51_ = x11 & x12 & x14 & x16 & new_n52_ & x17;
  assign new_n52_ = x18 & x20 & x22 & x23 & (x05 | x13);
  assign new_n53_ = x07 & new_n54_ & ~x08;
  assign new_n54_ = ~x09 & ~x11 & ~x12 & ~x14 & new_n55_ & ~x16;
  assign new_n55_ = ~x17 & ~x20 & ~x22 & ~x23 & (x05 | (~x05 & x13));
  assign new_n56_ = x05 ? ~x21 : (x13 | (~new_n57_ & ~new_n61_));
  assign new_n57_ = new_n58_ & new_n60_ & x01 & x03 & x04;
  assign new_n58_ = new_n59_ & x12 & x14 & x15 & x16;
  assign new_n59_ = x17 & x20 & x22 & x23;
  assign new_n60_ = x06 & x08 & x09 & x11;
  assign new_n61_ = new_n62_ & new_n64_ & ~x01 & ~x03 & ~x04;
  assign new_n62_ = new_n63_ & ~x16 & ~x17 & ~x12 & ~x14;
  assign new_n63_ = x19 & ~x20 & ~x22 & ~x23;
  assign new_n64_ = ~x06 & ~x08 & ~x09 & ~x11;
  assign z2 = (new_n66_ & x01) | (x05 & x21);
  ...
  assign z3 = x01 ? (x03 & x06 & new_n70_ & x08) : (~x03 & ~x06 & new_n36_ & ~x08);
  assign new_n70_ = x11 & x14 & ~new_n71_ & x20;
  assign new_n71_ = x05 ? ~new_n73_ : ((x13 | ~x15) & ~new_n68_ & (~new_n72_ | ~x13));
  assign new_n72_ = x18 & x24;
  assign new_n73_ = ~x21 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign z4 = (~new_n71_ & (~x08 | (~new_n75_ & x16))) | (z5 & (x08 | (~new_n76_ & ~x16)));
  assign new_n75_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n76_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z6 = new_n78_ | new_n81_ | (x05 & x21);
  assign new_n78_ = ~new_n79_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n79_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n80_ & (x05 | x13 | ~x19);
  assign new_n80_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n81_ = ~new_n67_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n83_ | (x13 & ((x18 & x24) | (x05 & x15 & ~x24)));
  assign new_n83_ = ~new_n68_ & (x05 | x13 | ~x15) & (~x05 | (~new_n72_ & ~x21));
endmodule
