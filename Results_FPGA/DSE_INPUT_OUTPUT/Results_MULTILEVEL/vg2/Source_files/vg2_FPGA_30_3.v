...
module FAU ( 
  ...
  assign new_n61_ = (new_n62_ | (x04 & x12)) & (~x04 | x12 | x16 | x22 | x23);
  assign new_n62_ = ~x08 & (x16 | (~x09 & (~x17 | x22)));
  assign new_n63_ = (new_n64_ | (x04 & x12)) & (~x22 | ~x23 | x04 | ~x16);
  assign new_n64_ = x08 & (~x16 | (x09 & (x17 | ~x22)));
  assign z5 = ~new_n37_ & (~x04 | ~x12);
  assign z6 = (~x04 | ~x12) & (new_n67_ | new_n68_);
  assign new_n67_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n68_ = ~new_n44_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n70_ & x05) | ~new_n71_ | new_n45_ | (~x05 & ~x13 & x15);
  assign new_n70_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n71_ = (~x04 | ~x12) & (~x13 | ~x18 | ~x24);
endmodule
