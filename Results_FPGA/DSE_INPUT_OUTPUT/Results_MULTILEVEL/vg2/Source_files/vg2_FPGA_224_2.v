...
module FAU ( 
  ...
  assign z6 = new_n84_ | (~x03 & ~new_n63_ & (~x11 | x12)) | (x11 & (new_n85_ | ~x12));
  assign new_n84_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n85_ = (~x06 | (x14 & ~x20)) & (~new_n86_ | (~new_n89_ & x05));
  assign new_n86_ = (~x03 | new_n87_ | ~x24) & (~x12 | new_n88_ | x24);
  assign new_n87_ = (x05 | x13 | ~x15) & (~x13 | ~x18);
  assign new_n88_ = (x05 | x13 | ~x15) & (x02 | x10 | ~x21);
  assign new_n89_ = (~x03 | ~x18 | ~x24) & (~x15 | x24 | ~x12 | ~x13);
