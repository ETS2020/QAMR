...
module FAU ( 
  ...
  assign new_n64_ = (new_n65_ | (~x09 & x21)) & (x02 | ~x09 | x10 | ~x21 | x24);
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (new_n77_ & new_n78_) | (~new_n67_ & (x09 | ~x21));
  ...
  assign new_n77_ = x01 & ~x02 & x03 & x06 & x08 & x09;
  assign new_n78_ = x20 & x21 & ~x24 & ~x10 & x11 & x14;
  assign z4 = new_n80_ | (~new_n84_ & ~x21);
  assign new_n80_ = x09 & ((~new_n37_ & (x08 | ~x16)) | (~new_n81_ & (~x08 | (new_n83_ & x16))));
  ...
  assign new_n84_ = (new_n37_ | (~x08 & (~new_n85_ | x16))) & (new_n65_ | (x08 & (x09 | ~x16)));
  assign new_n85_ = ~x22 & (x17 | (x04 & ~x23));
  assign z5 = ~new_n37_ & (x09 | ~x21);
  assign z6 = new_n88_ | new_n89_ | (~x09 & x21);
  assign new_n88_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n89_ = ~new_n81_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n91_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n91_ = x21 & (~x09 | (~x02 & ~x10 & ~x24));
endmodule
