...
module FAU ( 
  ...
  assign z0 = (new_n36_ & ~x01) | (x10 & ~x21);
  ...
  assign z1 = (~x10 & (new_n40_ | new_n47_ | new_n56_)) | (x21 & (new_n47_ | new_n63_));
  ...
  assign new_n43_ = x23 & ((x05 & x13 & x15) | (~x02 & x21));
  assign new_n44_ = ~x06 & ~x08 & ~x09 & ~x11 & new_n45_ & ~x12;
  assign new_n45_ = ~x14 & ~x16 & ~x17 & ~x20 & new_n46_ & ~x22;
  assign new_n46_ = ~x23 & ((x00 & ~x02) | (x05 & x13 & x19));
  assign new_n47_ = x24 & (x05 | x13) & (new_n48_ | new_n52_);
  assign new_n48_ = new_n49_ & new_n51_ & x18 & x20 & x22 & x23;
  ...
  assign new_n56_ = ~x05 & ~new_n57_ & ~x13;
  assign new_n57_ = (~new_n55_ | ~new_n60_ | ~new_n61_ | ~new_n62_) & (~new_n49_ | ~new_n58_);
  assign new_n58_ = new_n59_ & x15 & x16 & x12 & x14;
  assign new_n59_ = x22 & x23 & x17 & x20;
  assign new_n60_ = ~x09 & ~x11 & ~x06 & ~x08;
  assign new_n61_ = ~x16 & ~x17 & ~x12 & ~x14;
  assign new_n62_ = x19 & ~x20 & ~x22 & ~x23;
  assign new_n63_ = ~new_n57_ & (x05 ? (x13 & ~x24) : ~x13);
  assign z2 = new_n65_ & x01;
  assign new_n65_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n67_ & (~x10 | x21)) | (~x02 & ~x10 & x21 & ~x24);
  assign new_n67_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n69_ & ~x24) | ~new_n78_ | (x24 & ~new_n74_ & (x05 | x13));
  assign new_n69_ = x01 ? (~x03 | ~x06 | ~new_n70_ | ~x08) : (x03 | x06 | ~new_n72_ | x08);
  assign new_n70_ = x11 & x14 & ~new_n71_ & x20;
  ...
  assign new_n78_ = (~x10 | x21) & (x05 | new_n79_ | x13);
  ...
  assign z4 = (z5 & (x08 | (~new_n85_ & ~x16))) | (z7 & (~x08 | (~new_n86_ & x16)));
  assign z5 = new_n38_ | (~new_n84_ & (~x10 | x21));
