...
module FAU ( 
  ...
  assign z2 = x20 & (new_n61_ | x21);
  assign new_n61_ = x01 & x03 & x06 & x11 & ~new_n62_ & x14;
  ...
  assign new_n71_ = (~x20 | ~x21) & (~new_n72_ | ~new_n73_ | x14 | x20 | x24);
  assign new_n72_ = x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n73_ = ~x08 & ~x10 & ~x11;
  assign z4 = new_n76_ | (new_n80_ & x00) | (z7 & (new_n81_ | ~x08));
  assign z7 = (~new_n62_ & (~x20 | ~x21)) | (~x02 & ~x10 & ~x20 & x21 & ~x24);
  assign new_n76_ = ~new_n39_ & (new_n79_ | (~new_n77_ & (x08 | (~new_n78_ & ~x16))));
  assign new_n77_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n78_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n79_ = x00 & ~x02 & x08 & ~x10 & ~x24;
  assign new_n80_ = ~x02 & ~x10 & ~x16 & ~x21 & ~new_n78_ & ~x24;
  ...
  assign z6 = (~new_n86_ & ~x20) | (~new_n91_ & ~x21);
  assign new_n86_ = new_n89_ & (new_n87_ | (x03 & (~x11 | (x06 & ~x14))));
  assign new_n87_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n88_ & (x05 | x13 | ~x15);
  assign new_n88_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n89_ = ~new_n90_ & (new_n77_ | (~x03 & (~x06 | x11)));
  assign new_n90_ = x00 & ~x02 & x03 & ~x10 & ~x24;
  assign new_n91_ = (new_n37_ | (~x03 & (x11 | (~new_n92_ & ~x06)))) & (new_n62_ | (x03 & (x06 | ~x11)));
