...
module FAU ( 
  ...
  assign new_n65_ = (~x11 | ~x12) & (x05 | x13 | ~x19);
  assign z6 = (~new_n69_ & (~x11 | ~x12)) | (new_n67_ & ~x11) | (x11 & new_n68_ & ~x12);
  assign new_n67_ = ~new_n37_ & (x06 | (~x14 & x20));
  assign new_n68_ = ~new_n44_ & (~x06 | (x14 & ~x20));
  ...
  assign new_n75_ = (~x13 | ~x18 | ~x24) & (~x11 | ~x12);
endmodule
