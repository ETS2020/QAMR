...
module FAU ( 
  ...
  assign new_n70_ = (~new_n68_ | ~new_n71_) & (~new_n37_ | ~new_n67_);
  ...
  assign z4 = (~new_n76_ & (new_n81_ | x08)) | new_n80_ | (~new_n78_ & (new_n82_ | ~x08));
  assign new_n76_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n77_ & (x05 | x13 | ~x19);
  assign new_n77_ = x00 & ~x02 & ~x10 & ~x24;
  ...
  assign z6 = (~new_n85_ & (x03 | (~new_n86_ & ~x11))) | (z7 & (~x03 | (~new_n87_ & x11)));
  assign new_n85_ = (new_n39_ | (~x02 & x12)) & (~x00 | x02 | x10 | x12 | x24);
