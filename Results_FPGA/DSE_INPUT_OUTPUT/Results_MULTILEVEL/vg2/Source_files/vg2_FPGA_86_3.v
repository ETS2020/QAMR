...
module FAU ( 
  ...
  assign z4 = (~new_n64_ & (~x08 | (~new_n86_ & x16))) | (z5 & (x08 | (~new_n85_ & ~x16)));
  assign z5 = new_n84_ | (~new_n83_ & (~x02 | ~x12));
  assign new_n83_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n84_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n85_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n86_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n88_ | new_n90_ | (x02 & x12);
  assign new_n88_ = ~new_n89_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n89_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n84_ & (x05 | x13 | ~x19);
  assign new_n90_ = ~new_n91_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n91_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n66_ & (x05 | x13 | ~x15);
  assign z7 = (~new_n93_ & x05) | ~new_n94_ | new_n66_ | (~x05 & ~x13 & x15);
  assign new_n93_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n94_ = (~x02 | ~x12) & (~x13 | ~x18 | ~x24);
endmodule
