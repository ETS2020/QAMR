...
module FAU ( 
  ...
  assign z4 = ~new_n81_ | (~new_n37_ & (new_n87_ | x08));
  assign new_n81_ = (~x16 | (~new_n82_ & (new_n66_ | x09))) & ~new_n39_ & (new_n66_ | x08);
  ...
  assign z5 = (~new_n90_ & x05) | ~new_n89_ | new_n39_ | (~x05 & ~x13 & x19);
  assign new_n89_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n90_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = new_n92_ | new_n97_ | (~new_n39_ & (new_n95_ | new_n99_));
  assign new_n92_ = ~new_n93_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n93_ = (new_n94_ | (x21 & ~x23)) & (~x21 | ~x23 | x24 | x02 | x10);
  assign new_n94_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
  assign new_n95_ = ~new_n96_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n96_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n97_ = x00 & ~x02 & new_n98_ & ~x10;
  assign new_n98_ = ~x11 & ~x21 & ~x24 & (x06 | (~x14 & x20));
  assign new_n99_ = x00 & ~x02 & x03 & ~x10 & ~x24;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n101_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n101_ = x21 & (~x23 | (~x02 & ~x10 & ~x24));
endmodule
