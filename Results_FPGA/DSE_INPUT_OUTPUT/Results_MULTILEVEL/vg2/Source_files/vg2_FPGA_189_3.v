...
module FAU ( 
  ...
  assign new_n64_ = x20 & (new_n65_ | (~x02 & ~x10 & new_n66_ & ~x19));
  assign new_n65_ = ~new_n39_ & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  assign new_n66_ = x21 & ~x24;
  assign z3 = (~new_n68_ & ~new_n39_) | (new_n77_ & ~x01) | (new_n79_ & new_n80_);
  assign new_n68_ = ~new_n73_ & ~new_n75_ & (~x24 | new_n69_ | (~x05 & ~x13));
  assign new_n69_ = ~new_n70_ & (~new_n72_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n70_ = new_n71_ & ~x06 & x07 & ~x01 & ~x03;
  assign new_n71_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n72_ = x11 & x14 & x18 & x20;
  assign new_n73_ = x01 & x03 & x06 & x08 & new_n74_ & x11;
  assign new_n74_ = x14 & x15 & x20 & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n75_ = new_n76_ & ~x02 & ~x03 & ~x06 & x00 & ~x01;
  assign new_n76_ = ~x08 & ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  assign new_n77_ = ~x03 & ~x06 & ~x08 & ~x11 & new_n78_ & ~x14;
  assign new_n78_ = x19 & ~x20 & ~x21 & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n79_ = x11 & x14 & ~x19 & new_n66_ & x20;
  assign new_n80_ = x06 & x08 & ~x10 & x01 & ~x02 & x03;
  assign z4 = (~new_n37_ & (new_n84_ | x08)) | new_n39_ | (~new_n82_ & (new_n85_ | ~x08));
  assign new_n82_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n83_ & (x05 | x13 | ~x15);
  assign new_n83_ = new_n66_ & ~x02 & ~x10;
  assign new_n84_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n85_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n88_ & x05) | ~new_n87_ | (x19 & (x21 | (~x05 & ~x13)));
  assign new_n87_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n88_ = (~x13 | ~x19 | x24) & (~x07 | ~x24);
  assign z6 = (~new_n37_ & (new_n90_ | x03)) | new_n39_ | (~new_n82_ & (new_n91_ | ~x03));
  assign new_n90_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n91_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n93_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n93_ = x21 & (x19 | (~x02 & ~x10 & ~x24));
endmodule
