...
module FAU ( 
  ...
  assign z1 = new_n41_ | (new_n51_ & x24) | (~x10 & (new_n58_ | x12));
  ...
  assign new_n46_ = new_n47_ & new_n48_ & new_n50_ & new_n49_ & ~x12 & ~x14;
  ...
  assign new_n58_ = new_n59_ & new_n61_ & new_n53_ & ~x04 & ~x06;
  assign new_n59_ = new_n60_ & new_n49_ & ~x11 & ~x14;
  assign new_n60_ = ~x23 & ~x24 & ~x20 & ~x22;
  assign new_n61_ = x00 & ~x01 & ~x02 & ~x03;
  assign z2 = new_n63_ & x01;
  assign new_n63_ = x03 & x06 & x11 & x14 & ~new_n64_ & x20;
  assign new_n64_ = (new_n65_ | (~x10 & x12)) & (x02 | x10 | x12 | ~x21 | x24);
  ...
  assign z6 = (~new_n88_ & (x03 | (~new_n90_ & ~x11))) | (~new_n64_ & (~x03 | (~new_n91_ & x11)));
  assign new_n88_ = (new_n89_ | (~x10 & x12)) & (~x00 | x02 | x10 | x12 | x24);
  ...
  assign new_n93_ = ~x10 & (x12 | (~x02 & x21 & ~x24));
endmodule
