...
module FAU ( 
  ...
  assign new_n63_ = x06 & x11 & x12 & x14 & ~new_n64_ & x20;
  ...
  assign new_n74_ = ~new_n61_ & (x05 | new_n75_ | x13);
  assign new_n75_ = (~new_n77_ | x01 | x03 | x06 | x08) & (~new_n76_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n76_ = x11 & x12 & x14 & x15 & x20;
  assign new_n77_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n64_ & (new_n79_ | ~x08)) | new_n61_ | (~new_n37_ & (x08 ? ~new_n61_ : new_n80_));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n80_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & ~new_n61_;
  assign z6 = (~new_n37_ & (new_n83_ | x03)) | new_n61_ | (~new_n64_ & (new_n84_ | (~new_n61_ & ~x03)));
  assign new_n83_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n84_ = x11 & (~x06 | (x03 & x14 & ~x20));
