...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n84_, new_n85_;
  assign z0 = (new_n36_ & ~x01) | (~x12 & x17);
  ...
  assign z2 = (~x12 & x17) | (new_n62_ & x01);
  ...
  assign z3 = (~new_n66_ & ~x24) | ~new_n73_ | (x24 & ~new_n69_ & (x05 | x13));
  ...
  assign new_n73_ = (x12 | ~x17) & (x05 | new_n74_ | x13);
  ...
  assign z4 = (~new_n63_ & ~new_n80_) | (~new_n37_ & ~new_n78_);
  assign new_n78_ = ((~x12 & x17) | (~x08 & (~x09 | x16))) & (~new_n79_ | x16);
  assign new_n79_ = ~x22 & ((x12 & x17) | (x04 & ~x17 & ~x23));
  assign new_n80_ = ((~x12 & x17) | (x08 & (x09 | ~x16))) & (~new_n81_ | ~x16);
  assign new_n81_ = x22 & (~x17 | (~x04 & x12 & x23));
  assign z5 = ~new_n37_ & (x12 | ~x17);
  assign z6 = new_n84_ | (~x12 & x17) | (~new_n63_ & (x03 ? new_n85_ : (x12 | ~x17)));
  assign new_n84_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n85_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n63_ & (x12 | ~x17);
endmodule
