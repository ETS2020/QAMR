...
module FAU ( 
  ...
  assign new_n37_ = (new_n38_ | (~x10 & ~x12)) & (~x00 | x02 | x10 | ~x12 | x24);
  ...
  assign new_n46_ = ~x01 & ~x03 & ~x04 & ~x06;
  ...
  assign new_n54_ = x07 & ~x08 & ~x09 & x10;
  assign new_n55_ = ~x11 & ~x12 & ~x14 & ~x16;
  assign new_n56_ = new_n57_ & new_n58_ & x01 & ~x02 & x03 & x04;
  ...
  assign new_n61_ = (new_n62_ | (~x10 & ~x12)) & (~x12 | ~x21 | x24 | x02 | x10);
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = ~new_n64_ | (~x24 & (x01 ? (new_n74_ & x03) : (new_n76_ & ~x03)));
  assign new_n64_ = (~x24 | new_n65_ | (~x05 & ~x13)) & ~new_n73_ & (x05 | new_n70_ | x13);
  assign new_n65_ = (~new_n66_ | ~new_n67_) & (~new_n68_ | ~new_n69_);
  assign new_n66_ = x01 & x03 & x06 & x08;
  assign new_n67_ = x11 & x14 & x18 & x20;
  assign new_n68_ = ~x06 & x07 & ~x01 & ~x03;
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n79_ & ~x16))) | (~new_n61_ & (~x08 | (~new_n80_ & x16)));
  assign new_n79_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n80_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = (x05 & ((x13 & x19 & ~x24) | (x07 & x24))) | new_n82_ | (x07 & x13 & x24) | (~x05 & ~x13 & x19);
  assign new_n82_ = ~x10 & (~x12 | (x00 & ~x02 & ~x24));
  assign z6 = (~new_n84_ & (new_n88_ | x03)) | new_n73_ | (~new_n86_ & (new_n89_ | ~x03));
  ...
  assign new_n87_ = ~x02 & ~x10 & x21 & ~x24;
  ...
  assign new_n91_ = ~x10 & (~x12 | (~x02 & x21 & ~x24));
endmodule
