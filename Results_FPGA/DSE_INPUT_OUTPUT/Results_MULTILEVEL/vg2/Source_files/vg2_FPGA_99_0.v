...
module FAU ( 
  ...
  assign z1 = (new_n53_ & x01) | (x21 & ((~new_n40_ & ~x24) | (new_n49_ & ~x01)));
  ...
  assign new_n44_ = new_n45_ & new_n48_ & x11 & x12 & x14 & x16;
  ...
  assign new_n49_ = ~x03 & ~x04 & ~x06 & new_n50_ & ~x08;
  assign new_n50_ = ~x09 & ~x11 & ~x12 & ~x14 & new_n51_ & ~x16;
  assign new_n51_ = ~x17 & ~x20 & ~x22 & ~new_n52_ & ~x23;
  ...
  assign z6 = (~new_n37_ & (x03 | (~new_n89_ & ~x11))) | ~new_n85_ | (new_n82_ & x11);
  assign new_n82_ = (~x06 | (x14 & ~x20)) & (~new_n83_ | (~new_n84_ & x15));
  assign new_n83_ = ~new_n60_ & (~x03 | ~x18 | ~x24 | (~x05 & ~x13));
  assign new_n84_ = (x24 | (~x12 & ~x21) | (~x05 ^ ~x13)) & (~x03 | x05 | x13 | ~x24);
  assign new_n85_ = (~x21 | (~new_n86_ & (new_n88_ | x03))) & (x12 | x21) & (x03 | new_n56_ | ~x12);
  assign new_n86_ = ~x24 & (new_n87_ | (~x02 & ~x10 & (x00 | ~x03)));
  assign new_n87_ = x13 & x15 & ~x03 & x05;
  assign new_n88_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n89_ = ~x06 & (x14 | ~x20);
  assign z7 = new_n60_ | (~new_n56_ & (x12 | x21));
endmodule
