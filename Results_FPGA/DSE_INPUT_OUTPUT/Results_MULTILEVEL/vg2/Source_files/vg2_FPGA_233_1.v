...
module FAU ( 
  ...
  assign z0 = (new_n36_ & ~x01) | (~x10 & x12);
  ...
  assign new_n42_ = x08 & x09 & x10 & x11;
  ...
  assign z7 = (~new_n62_ & (x10 | ~x12)) | (~x02 & ~x10 & ~x12 & x21 & ~x24);
  ...
  assign new_n73_ = (x10 | ~x12) & (x05 | new_n74_ | x13);
  ...
  assign z4 = (~new_n78_ & (x08 | (~new_n80_ & ~x16))) | (z7 & (~x08 | (~new_n81_ & x16)));
  assign new_n78_ = (new_n79_ | (~x10 & x12)) & (x10 | x12 | x24 | ~x00 | x02);
  ...
  assign z5 = (x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | new_n83_ | (x07 & x13 & x24) | (~x05 & ~x13 & x19);
  assign new_n83_ = ~x10 & (x12 | (x00 & ~x02 & ~x24));
  assign z6 = new_n85_ | ~new_n86_;
  assign new_n85_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n86_ = (new_n87_ | (x03 ? ~new_n89_ : x12)) & (x10 | ~x12) & (x03 | new_n62_ | ~x10);
