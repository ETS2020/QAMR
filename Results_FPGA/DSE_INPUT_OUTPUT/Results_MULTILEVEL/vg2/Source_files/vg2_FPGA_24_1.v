...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n43_, new_n44_,
    ...
    new_n55_, new_n56_, new_n58_, new_n59_, new_n61_, new_n62_;
  ...
  assign new_n44_ = (~x07 | ~x24 | (~x05 & (~x13 | x21))) & (x05 | x13 | ~x19 | x21);
  assign new_n45_ = x08 & x09 & x11 & x12 & new_n46_ & x14;
  assign new_n46_ = x16 & x17 & x20 & x22 & z7 & x23;
  assign z7 = (~new_n48_ & x13) | (~new_n49_ & x05) | (x15 & ~x21 & ~x05 & ~x13);
  assign new_n48_ = (~x18 | x21 | ~x24) & (~x05 | ~x15 | x24);
  assign new_n49_ = (~x18 | ~x24) & (~x21 | x24 | x02 | x10);
  assign z2 = (~x05 & x21) | (new_n51_ & x01);
  assign new_n51_ = x03 & x06 & x11 & x14 & ~new_n52_ & x20;
  assign new_n52_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n53_ & (x05 | x13 | ~x15);
  assign new_n53_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = x01 ? (x03 & x06 & new_n56_ & x08) : (~x03 & ~x06 & new_n55_ & ~x08);
  assign new_n55_ = ~x11 & ~x14 & z5 & ~x20;
  assign new_n56_ = x11 & x14 & z7 & x20;
  assign z4 = (z5 & (x08 | (~new_n59_ & ~x16))) | (z7 & (~x08 | (~new_n58_ & x16)));
  assign new_n58_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n59_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z6 = (z5 & (x03 | (~new_n62_ & ~x11))) | (z7 & (~x03 | (~new_n61_ & x11)));
