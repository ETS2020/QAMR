...
module FAU ( 
  ...
  assign new_n53_ = new_n55_ & new_n56_ & new_n46_ & new_n54_ & ~x08 & ~x09;
  assign new_n54_ = ~x06 & x07;
  assign new_n55_ = ~x14 & ~x16 & ~x11 & ~x12;
  assign new_n56_ = ~x22 & ~x23 & ~x17 & ~x20;
  assign new_n57_ = ~x10 & ~x24 & ((new_n42_ & new_n59_) | (new_n58_ & new_n60_));
  ...
  assign new_n65_ = ~new_n67_ & (new_n66_ | (x02 & ~x12));
  ...
  assign new_n69_ = ~new_n62_ & (new_n70_ | (new_n72_ & new_n73_ & x15 & x20));
  ...
  assign new_n76_ = ~x06 & x07 & ~x01 & ~x03;
  ...
  assign z4 = (~new_n65_ & (~x08 | (~new_n82_ & x16))) | (z5 & (x08 | (~new_n81_ & ~x16)));
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n84_ | new_n86_ | (x02 & ~x12);
  assign new_n84_ = ~new_n85_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n85_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n39_ & (x05 | x13 | ~x19);
  assign new_n86_ = ~new_n87_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n87_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign z7 = (~new_n89_ & x05) | ~new_n90_ | new_n67_ | (~x05 & ~x13 & x15);
  assign new_n89_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n90_ = (~x02 | x12) & (~x13 | ~x18 | ~x24);
endmodule
