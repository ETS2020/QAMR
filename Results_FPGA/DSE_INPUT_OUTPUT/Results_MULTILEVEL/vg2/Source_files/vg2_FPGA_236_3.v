...
module FAU ( 
  ...
  assign new_n49_ = new_n50_ & x18 & x20 & x11 & x14;
  ...
  assign z6 = (~new_n37_ & (new_n69_ | x03)) | new_n67_ | new_n55_ | (~new_n68_ & ~x03);
  assign new_n67_ = x11 & ~new_n44_ & (~x06 | (x14 & ~x20));
  assign new_n68_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & ~new_n45_ & (x05 | (x13 ? (~x18 | ~x24) : ~x15));
  assign new_n69_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n71_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n71_ = ~new_n45_ & (x05 | x13 | ~x15) & ~new_n55_ & (~new_n72_ | ~x13);
