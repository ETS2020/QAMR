...
module FAU ( 
  ...
  assign z2 = (~x05 & x21) | (new_n53_ & x01);
  assign new_n53_ = x03 & x06 & x11 & x14 & ~new_n54_ & x20;
  assign new_n54_ = ~new_n48_ & ~new_n49_ & ~new_n50_ & ~new_n51_;
  assign z3 = ~new_n56_ | (~x24 & (x01 ? (new_n66_ & x03) : (new_n64_ & ~x03)));
  assign new_n56_ = (~x24 | new_n57_ | (~x05 & ~x13)) & (x05 | (~x21 & (new_n61_ | x13)));
  assign new_n57_ = ~new_n58_ & (~new_n60_ | x06 | ~x07 | x01 | x03);
  assign new_n58_ = new_n59_ & x11 & x14 & x18 & x20;
  assign new_n59_ = x01 & x03 & x06 & x08;
  assign new_n60_ = ~x08 & ~x11 & ~x14 & ~x20;
  ...
  assign z4 = (~new_n69_ & (new_n76_ | ~x08)) | new_n78_ | (~new_n72_ & (new_n77_ | x08));
  assign new_n69_ = (new_n71_ | ~x13) & (new_n70_ | ~x05) & (x05 | x13 | ~x15 | x21);
  assign new_n70_ = ~new_n51_ & (~x18 | ~x24);
  assign new_n71_ = (~x18 | x21 | ~x24) & (~x05 | ~x15 | x24);
  assign new_n72_ = (new_n75_ | ~x05) & (x21 | (new_n73_ & (x05 | x13 | ~x19)));
  assign new_n73_ = ~new_n74_ & (~x07 | ~x13 | ~x24);
  assign new_n74_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n75_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n76_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x00 & ~x02 & x05 & x08 & ~x10 & ~x24;
  assign z6 = new_n80_ | new_n82_ | (~x05 & x21);
  assign new_n80_ = ~new_n81_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n74_ & (x05 | x13 | ~x19);
  assign new_n82_ = ~new_n54_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = new_n48_ | new_n84_ | new_n49_ | new_n51_;
  assign new_n84_ = ~x05 & (x21 | (~x13 & x15));
endmodule
