...
module FAU ( 
  ...
  assign z4 = ~new_n60_ | (~x24 & (new_n57_ | (~new_n63_ & x21)));
  assign new_n57_ = ~new_n58_ & (new_n59_ | x08);
  assign new_n58_ = ~new_n39_ & (~x00 | x02 | x05 | x10);
  assign new_n59_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n60_ = (new_n40_ | (~new_n59_ & ~x08)) & (new_n61_ | (~new_n62_ & x08));
  assign new_n61_ = ~new_n54_ & (~x21 | ~x24 | ~x05 | ~x18);
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n63_ = ((~new_n64_ & (x02 | x10)) | (~new_n62_ & x08)) & (~x08 | x10 | ~x00 | x02);
  assign new_n64_ = x05 & x13 & x15;
  assign z5 = ~new_n66_ | (x07 & x24 & (x05 | x13));
  assign new_n66_ = (~x05 | (x21 & (~x13 | ~x19 | x24))) & ~new_n67_ & (x05 | x13 | ~x19);
  assign new_n67_ = ~x10 & ~x24 & x00 & ~x02;
  assign z6 = (~new_n71_ & (x05 ? new_n72_ : ~new_n70_)) | new_n69_ | new_n73_;
  assign new_n69_ = ~new_n52_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n70_ = (x13 | ~x19) & ~new_n67_ & (~x07 | ~x13 | ~x24);
  assign new_n71_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n72_ = x21 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n73_ = x00 & ~x02 & x05 & ~x10 & x21 & ~x24;
  assign z7 = ~new_n75_ | (~new_n48_ & ~x24);
  assign new_n75_ = (~x05 | (x21 & (~x18 | ~x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
endmodule
