...
module FAU ( 
  ...
  assign new_n66_ = ~new_n38_ & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  ...
  assign z4 = new_n80_ | ~new_n86_ | (~new_n83_ & (new_n67_ | (~new_n52_ & x15)));
  ...
  assign z6 = (~new_n91_ & (new_n93_ | x03)) | new_n38_ | (~new_n92_ & (new_n94_ | ~x03));
  ...
  assign new_n96_ = ~new_n67_ & (x05 | x13 | ~x15) & ~new_n38_ & (~new_n97_ | ~x13);
