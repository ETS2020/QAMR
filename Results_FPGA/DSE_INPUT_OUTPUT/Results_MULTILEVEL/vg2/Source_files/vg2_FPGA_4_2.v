// Benchmark "FAU" written by ABC on Tue Aug 18 17:43:25 2020
...
module FAU ( 
  ...
  assign new_n64_ = ~new_n66_ & (new_n65_ | (x02 & ~x12));
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n66_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~x02 & (new_n68_ | new_n72_ | (new_n76_ & ~x10))) | (x12 & (new_n68_ | new_n72_));
  assign new_n68_ = ~new_n50_ & (new_n69_ | (new_n70_ & new_n71_ & x15 & x20));
  assign new_n69_ = new_n60_ & ~x06 & ~x08 & new_n49_ & ~x11 & ~x14;
  assign new_n70_ = x01 & x03 & x06 & x08;
  assign new_n71_ = x11 & x14;
  assign new_n72_ = x24 & ~new_n61_ & ((new_n74_ & new_n75_) | (new_n73_ & new_n70_));
  assign new_n73_ = new_n71_ & x18 & x20;
  assign new_n74_ = new_n60_ & ~x06 & x07;
  ...
  assign z4 = new_n79_ | ~new_n85_ | (~new_n82_ & (new_n66_ | (~new_n50_ & x15)));
  assign new_n79_ = x24 & (new_n84_ | (~new_n61_ & (new_n80_ | (~new_n82_ & x18))));
  assign new_n80_ = x07 & (x08 ? (~x02 | x12) : (~new_n81_ & ~x16));
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = ~new_n83_ & x08;
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n84_ = ~x05 & x08 & x12 & ~x13 & x19;
  assign new_n85_ = (~new_n86_ | x16) & (~x02 | x12) & (new_n88_ | ~x08);
  assign new_n86_ = ~new_n81_ & (new_n87_ | (~x10 & ~x24 & x00 & ~x02));
  assign new_n87_ = x19 & (x05 ? (x13 & ~x24) : (~x13 & (~x08 | ~x24)));
  assign new_n88_ = (x02 | (~new_n89_ & (x05 | x13 | ~x19))) & (~x19 | x24 | (x05 ^ x13));
  assign new_n89_ = x00 & ~x10 & ~x24;
  assign z6 = (~new_n64_ & (~x03 | (~new_n92_ & x11))) | (z5 & (x03 | (~new_n91_ & ~x11)));
  assign new_n91_ = ~x06 & (x14 | ~x20);
  assign new_n92_ = x06 & (~x14 | x20);
  assign z7 = (~new_n94_ & x05) | ~new_n95_ | new_n66_ | (~x05 & ~x13 & x15);
  assign new_n94_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n95_ = (~x02 | x12) & (~x13 | ~x18 | ~x24);
endmodule
