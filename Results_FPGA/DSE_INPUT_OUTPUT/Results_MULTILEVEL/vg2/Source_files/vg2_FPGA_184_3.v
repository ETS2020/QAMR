...
module FAU ( 
  ...
  assign z7 = (~new_n59_ & x05) | new_n60_ | (~x13 & (new_n51_ | (~x05 & x15)));
  assign new_n59_ = (x13 | ~x18 | ~x24) & (~x13 | ~x15 | x21 | x24);
  assign new_n60_ = x13 & x18 & ~x21 & x24;
  assign z4 = (~new_n62_ & (new_n66_ | x08)) | new_n52_ | (~new_n55_ & (new_n67_ | ~x08));
  assign new_n62_ = ~new_n65_ & new_n63_ & (~x07 | ~x13 | ~x24);
  assign new_n63_ = ~new_n64_ & (x05 | x13 | ~x19);
  assign new_n64_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n65_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n66_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n67_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = new_n65_ | ~new_n63_ | (x13 & (x21 | (x07 & x24)));
