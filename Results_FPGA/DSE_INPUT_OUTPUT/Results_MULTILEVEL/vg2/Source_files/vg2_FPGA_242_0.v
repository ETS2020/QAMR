...
module FAU ( 
  ...
  assign new_n56_ = x11 & x14 & ~new_n47_ & x20;
  assign z4 = (~new_n52_ & (new_n59_ | ~x08)) | new_n58_ | (~new_n37_ & (new_n60_ | x08));
  assign new_n58_ = ~x05 & (new_n38_ | ~x21);
  ...
  assign z6 = (~new_n52_ & (new_n65_ | ~x03)) | new_n58_ | (~new_n37_ & (new_n66_ | x03));
  assign new_n65_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n66_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n68_ | (~x24 & (new_n53_ | (x05 & x13 & x15)));
  assign new_n68_ = (~x18 | ~x24 | (~x05 & ~x13)) & (x05 | (x21 & (x13 | ~x15)));
endmodule
