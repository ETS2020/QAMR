...
module FAU ( 
  ...
  assign z4 = ~new_n61_ | (~new_n42_ & (new_n63_ | ~x08));
  assign new_n61_ = (x12 | x17) & (new_n37_ | ((~x08 | (~x12 & ~x17)) & (new_n62_ | x16)));
  assign new_n62_ = (x08 | (~x09 & (~x04 | x22 | x23))) & (~x17 | x22);
  assign new_n63_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (x12 | x17);
  assign z6 = (x12 | x17) & (new_n66_ | new_n67_);
  ...
  assign new_n69_ = ~new_n43_ & (x12 | x17);
endmodule
