...
module FAU ( 
  ...
  assign z4 = (~new_n65_ & (new_n81_ | ~x08)) | new_n40_ | (~new_n38_ & (x08 ? ~new_n40_ : new_n82_));
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = (~new_n38_ & (new_n84_ | x03)) | new_n40_ | (~new_n65_ & (new_n85_ | ~x03));
  assign new_n84_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n85_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n68_ | ~new_n66_ | (x18 & (x12 | (x13 & x24)));
endmodule
