...
module FAU ( 
  ...
  assign new_n79_ = (new_n80_ | (x14 & ~x21)) & (~new_n39_ | x10 | x14 | x24);
  assign new_n80_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n81_ = (new_n82_ | (x14 & ~x21)) & (~x21 | x24 | x02 | x10);
  ...
  assign new_n88_ = (~x14 | x21) & (x05 | x13 | ~x19);
  assign z6 = (~new_n90_ & ~x14) | (~new_n91_ & x21);
  assign new_n90_ = (new_n37_ | (~x03 & (x11 | (~x06 & ~x20)))) & (new_n82_ | (x03 & (x06 | ~x11)));
  assign new_n91_ = ~new_n92_ & ~new_n38_ & (new_n80_ | (~x03 & (~x06 | x11)));
  assign new_n92_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n94_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n94_ = (~x14 | x21) & (x02 | x10 | ~x21 | x24);
endmodule
