...
module FAU ( 
  ...
  assign z2 = (x01 & x03 & new_n45_ & x06) | (~x06 & ~x12);
  ...
  assign z4 = (~new_n37_ & (new_n61_ | x08)) | new_n60_ | (~new_n42_ & (new_n62_ | ~x08));
  assign new_n60_ = ~x06 & ~x12;
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n65_ & x05) | ~new_n64_ | new_n60_ | (~x05 & ~x13 & x19);
  assign new_n64_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n65_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n72_ | x03)) | (~x03 & ~new_n42_ & ~new_n60_) | new_n67_ | new_n60_;
  assign new_n67_ = x11 & ((new_n68_ & ~x24) | (x03 & new_n70_ & x24));
  assign new_n68_ = ~new_n69_ & (x06 ? (x14 & ~x20) : x12);
  assign new_n69_ = (x02 | x10 | ~x21) & (~x15 | (~x05 ^ ~x13));
  assign new_n70_ = ~new_n71_ & (~x06 | (x14 & ~x20));
  assign new_n71_ = (x05 | x13 | ~x15) & (~x18 | (~x05 & ~x13));
