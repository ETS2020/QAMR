...
module FAU ( 
  ...
  assign new_n60_ = ~x20 & ~x22 & ~x23 & ~x17 & x19;
  ...
  assign z4 = (~new_n80_ & (new_n82_ | ~x08)) | new_n39_ | (~new_n37_ & (x08 ? ~new_n39_ : new_n83_));
  ...
  assign z6 = (~new_n86_ & ~new_n39_) | (~new_n91_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n86_ = (new_n37_ | ~x03) & ~new_n88_ & (x11 | new_n87_ | new_n90_);
  assign new_n87_ = ~new_n38_ & (~x07 | new_n61_ | ~x24);
  assign new_n88_ = ~new_n89_ & (new_n81_ | (x18 & ~new_n61_ & x24));
  assign new_n89_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n90_ = ~x06 & (x14 | ~x20);
  assign new_n91_ = (x12 | new_n89_ | ~x15) & (x11 | x15 | new_n90_ | ~x19);
  assign z7 = new_n94_ | ~new_n93_ | (x15 & (new_n61_ | x12));
  assign new_n93_ = ~new_n81_ & (~x13 | ~x18 | ~x24);
  assign new_n94_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
endmodule
