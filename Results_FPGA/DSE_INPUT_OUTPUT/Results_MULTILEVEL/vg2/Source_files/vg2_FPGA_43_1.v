...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n85_;
  assign z0 = ~new_n36_ & ~x14;
  assign new_n36_ = ~x20 & (x01 | x03 | x06 | new_n37_ | x11);
  ...
  assign new_n55_ = ~new_n60_ & (x05 | (~new_n56_ & ~new_n58_) | x13);
  ...
  assign z6 = (~new_n83_ & (x14 | ~x20)) | (x11 & x14 & ~new_n63_ & ~x20);
