...
module FAU ( 
  ...
  assign z5 = ~new_n37_ & (~x03 | x12);
  assign z6 = (~new_n37_ & (x03 ? x12 : new_n82_)) | (~new_n63_ & (new_n83_ | ~x03));
  assign new_n82_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n83_ = x11 & x12 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n63_ & (~x03 | x12);
endmodule
