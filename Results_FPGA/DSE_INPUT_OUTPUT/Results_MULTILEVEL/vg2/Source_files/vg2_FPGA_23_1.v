...
module FAU ( 
  ...
  assign new_n72_ = (~new_n70_ | ~new_n73_) & (~new_n37_ | ~new_n69_);
  ...
  assign new_n85_ = ~new_n55_ & ((x18 & (new_n84_ | ~x08)) | (x02 & x07 & x08));
  assign new_n86_ = ~x12 & (x10 | ~x21 | x24 | (~new_n84_ & x08));
  assign z5 = (~new_n39_ & (x02 | ~x12)) | (x00 & ~x02 & ~x10 & ~x12 & ~x24);
  assign z6 = new_n89_ | (~new_n90_ & ~new_n93_) | (new_n92_ & x02) | (~x02 & x12);
