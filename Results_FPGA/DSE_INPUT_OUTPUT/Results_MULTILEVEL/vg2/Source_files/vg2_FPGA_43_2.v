...
module FAU ( 
  ...
  assign new_n36_ = ~x14 & (x01 | x03 | x06 | new_n37_ | x11);
  ...
  assign z2 = ~new_n63_ & x14;
  assign new_n63_ = x20 & (~x01 | ~x03 | ~x06 | new_n64_ | ~x11);
  ...
  assign z6 = (~new_n84_ & (~x14 | x20)) | (~x11 & ~x14 & ~new_n37_ & x20);
