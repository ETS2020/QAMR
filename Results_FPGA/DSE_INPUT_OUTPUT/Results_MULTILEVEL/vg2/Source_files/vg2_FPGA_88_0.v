...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n56_ | (x24 & ~new_n50_ & ~new_n59_);
  ...
  assign z4 = new_n77_ | (new_n84_ & x24) | new_n81_ | (~new_n85_ & ~x02);
  assign new_n77_ = ~new_n78_ & (x08 ? x12 : new_n80_);
  ...
  assign new_n81_ = ~new_n82_ & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n82_ = (~x02 | ~x08 | ~x19) & (~x15 | (~new_n83_ & x08));
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n84_ = ~new_n59_ & ((x18 & (new_n83_ | ~x08)) | (x02 & x07 & x08));
  assign new_n85_ = x12 & (x10 | ~x21 | x24 | (~new_n83_ & x08));
  assign z6 = (~new_n87_ & (~x03 | (~new_n89_ & x11))) | (z5 & (x03 | (~new_n88_ & ~x11)));
  assign new_n87_ = (new_n64_ | (~x02 & ~x12)) & (~x12 | ~x21 | x24 | x02 | x10);
