...
module FAU ( 
  ...
  assign z2 = (~x04 & ~x12) | (new_n45_ & x01);
  ...
  assign z4 = (~new_n42_ & ~new_n61_) | (~new_n37_ & ~new_n63_);
  ...
  assign new_n68_ = ~new_n42_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n70_ & x05) | ~new_n71_ | new_n43_ | (~x05 & ~x13 & x15);
