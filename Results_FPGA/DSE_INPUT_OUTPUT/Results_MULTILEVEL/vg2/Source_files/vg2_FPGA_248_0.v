// Benchmark "FAU" written by ABC on Tue Aug 18 17:44:31 2020
...
module FAU ( 
  ...
  assign z4 = ~new_n55_ & ((~new_n37_ & (new_n61_ | x08)) | (~new_n42_ & (new_n62_ | ~x08)));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n55_;
  assign z6 = (~new_n67_ & ~new_n55_) | (new_n66_ & x11) | (new_n65_ & ~x11);
  assign new_n65_ = ~new_n37_ & (x06 | (x12 & ~x14 & x20));
  assign new_n66_ = ~new_n42_ & (x06 ? (x14 & ~x20) : x12);
  assign new_n67_ = (x24 | (~new_n68_ & (~x05 | new_n69_ | ~x13))) & (x05 | new_n69_ | x13) & (~x24 | new_n70_ | (~x05 & ~x13));
  assign new_n68_ = ~x02 & ~x10 & (x03 ? x00 : x21);
  assign new_n69_ = x03 ? ~x19 : ~x15;
  assign new_n70_ = x03 ? ~x07 : ~x18;
  assign z7 = ~new_n42_ & ~new_n55_;
endmodule
