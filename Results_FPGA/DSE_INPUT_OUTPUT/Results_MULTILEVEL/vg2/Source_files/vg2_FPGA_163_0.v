...
module FAU ( 
  ...
  assign z4 = (~new_n78_ & (x08 | (~new_n80_ & ~x16))) | (~new_n79_ & (~x08 | (~new_n81_ & x16)));
  assign new_n78_ = (new_n39_ | (~x02 & ~x12)) & (~x00 | x02 | x10 | ~x12 | x24);
  assign new_n79_ = (new_n65_ | (~x02 & ~x12)) & (x02 | x10 | ~x12 | ~x21 | x24);
  assign new_n80_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n81_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n39_ | (~x02 & (~x12 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n78_ & (x03 | (~new_n84_ & ~x11))) | (~new_n79_ & (~x03 | (~new_n85_ & x11)));
