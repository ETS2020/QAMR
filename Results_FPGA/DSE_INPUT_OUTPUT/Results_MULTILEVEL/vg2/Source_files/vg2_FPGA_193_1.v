...
module FAU ( 
  ...
  assign new_n65_ = x14 & x20 & ((~new_n66_ & (x12 | ~x15)) | (x12 & ~new_n68_ & x15));
  assign new_n66_ = (~x18 | new_n67_ | ~x24) & (~x21 | x24 | x02 | x10);
  assign new_n67_ = ~x05 & ~x13;
  assign new_n68_ = x05 ? (~x13 | x24) : x13;
  assign z3 = new_n70_ | (x01 & x03 & x06 & new_n80_ & x08);
  assign new_n70_ = ~new_n39_ & ((~new_n71_ & ~x24) | new_n78_ | (x24 & ~new_n74_ & ~new_n67_));
  assign new_n71_ = (x01 | ~new_n72_ | x03) & (~new_n73_ | ~new_n52_ | ~x03 | ~x01 | x02);
  assign new_n72_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n48_ & ~x20;
  assign new_n73_ = ~x10 & x11 & x14 & x20 & x21;
  assign new_n74_ = (~new_n75_ | ~new_n52_ | ~x01 | ~x03) & (~new_n77_ | ~new_n76_ | x01 | x03);
  ...
  assign new_n80_ = x11 & x12 & x14 & x15 & ~new_n68_ & x20;
  assign z4 = (~new_n87_ & ~new_n68_) | (~new_n39_ & (~new_n82_ | (~new_n37_ & x08)));
  assign new_n82_ = (x16 | new_n83_ | new_n86_) & (new_n66_ | new_n84_);
  assign new_n83_ = ~new_n38_ & (~x07 | new_n67_ | ~x24);
  assign new_n84_ = ~new_n85_ & x08;
  assign new_n85_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n86_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n87_ = (~x12 | new_n84_ | ~x15) & (x15 | x16 | new_n86_ | ~x19);
  ...
  assign z6 = (~new_n92_ & (x12 | ~x15)) | (~new_n68_ & (new_n95_ | (x12 & ~new_n94_ & x15)));
  assign new_n92_ = (new_n37_ | ~x03) & ~new_n93_ & (new_n66_ | new_n94_);
  assign new_n93_ = ~x11 & ~new_n83_ & (x06 | (~x14 & x20));
  assign new_n94_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n95_ = ~x11 & ~x15 & x19 & (x06 | (~x14 & x20));
  assign z7 = (~new_n97_ & x05) | ~new_n98_ | (x15 & (~x12 | (~x05 & ~x13)));
  assign new_n97_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n98_ = (~x13 | ~x18 | ~x24) & (~x21 | x24 | x02 | x10);
endmodule
