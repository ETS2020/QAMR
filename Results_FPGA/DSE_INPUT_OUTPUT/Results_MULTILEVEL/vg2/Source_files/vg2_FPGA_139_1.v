...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n80_ | x08)) | new_n79_ | (~new_n65_ & (new_n81_ | ~x08));
  assign new_n79_ = ~x03 & x12;
  assign new_n80_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n84_ & x05) | ~new_n83_ | new_n79_ | (~x05 & ~x13 & x19);
  assign new_n83_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n84_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n86_ | x03)) | (~new_n65_ & (x03 ? new_n87_ : ~x12));
  assign new_n86_ = ~x11 & ~x12 & (x06 | (~x14 & x20));
  assign new_n87_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n89_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n89_ = ~new_n66_ & (x05 | x13 | ~x15) & ~new_n79_ & (~new_n90_ | ~x13);
