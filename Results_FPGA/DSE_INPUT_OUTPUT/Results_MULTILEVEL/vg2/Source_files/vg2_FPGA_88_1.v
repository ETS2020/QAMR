...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n57_ | (new_n49_ & x24);
  ...
  assign new_n49_ = ~new_n54_ & (new_n50_ | (new_n41_ & new_n55_ & new_n56_));
  ...
  assign new_n58_ = new_n52_ & ~x22 & ~x23 & ~x24 & ~x17 & ~x20;
  ...
  assign new_n85_ = ~new_n54_ & ((x18 & (new_n84_ | ~x08)) | (x02 & x07 & x08));
  assign new_n86_ = ~x12 & (x10 | ~x21 | x24 | (~new_n84_ & x08));
  assign z6 = (~new_n88_ & (~x03 | (~new_n90_ & x11))) | (z5 & (x03 | (~new_n89_ & ~x11)));
  assign new_n88_ = (new_n64_ | (~x02 & x12)) & (x02 | x10 | x12 | ~x21 | x24);
