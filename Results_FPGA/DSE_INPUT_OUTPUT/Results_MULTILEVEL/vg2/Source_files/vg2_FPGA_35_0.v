...
module FAU ( 
  ...
  assign new_n56_ = ~x10 & (~x12 | (new_n57_ & new_n58_));
  assign new_n57_ = new_n43_ & x03 & x04 & x01 & ~x02;
  assign new_n58_ = new_n59_ & x14 & x16 & x17 & x20;
  assign new_n59_ = x21 & x22 & x23 & ~x24;
  assign z2 = new_n61_ & x01;
  assign new_n61_ = x03 & x06 & x11 & x14 & ~new_n62_ & x20;
  assign new_n62_ = (new_n63_ | (~x10 & ~x12)) & (~x12 | ~x21 | x24 | x02 | x10);
  assign new_n63_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n65_ & ~x24) | ~new_n74_ | (x24 & ~new_n70_ & (x05 | x13));
  ...
  assign z6 = (~new_n86_ & (x03 | (~new_n88_ & ~x11))) | (~new_n62_ & (~x03 | (~new_n89_ & x11)));
  assign new_n86_ = (new_n87_ | (~x10 & ~x12)) & (~x00 | x02 | x10 | ~x12 | x24);
