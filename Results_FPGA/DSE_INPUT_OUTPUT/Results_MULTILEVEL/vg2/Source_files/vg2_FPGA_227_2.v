...
module FAU ( 
  ...
  assign z2 = (new_n62_ & x01) | (x02 & ~x12);
  ...
  assign z7 = new_n64_ | (~new_n81_ & (~x02 | x12));
  ...
  assign z5 = ~new_n85_ | (x05 & ((x13 & x19 & ~x24) | (x07 & x24)));
  assign new_n85_ = new_n86_ & (~x02 | x12) & (x05 | x13 | ~x19);
  assign new_n86_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
