// Benchmark "FAU" written by ABC on Tue Aug 18 17:43:55 2020
...
module FAU ( 
  ...
  assign z2 = (x02 & x12) | (x01 & x03 & new_n63_ & x06);
  ...
  assign z3 = (~new_n67_ & ~x24) | ~new_n76_ | (x24 & ~new_n72_ & (x05 | x13));
  ...
  assign new_n71_ = (~x05 | ~x13 | ~x19) & (~x00 | x02 | x10);
  ...
  assign new_n76_ = (~x02 | ~x12) & (x05 | new_n77_ | x13);
  ...
  assign z4 = (~new_n81_ & (~x08 | (~new_n84_ & x16))) | (z5 & (x08 | (~new_n83_ & ~x16)));
  assign new_n81_ = ~new_n65_ & (new_n82_ | (x02 & x12));
  ...
  assign z6 = (~new_n81_ & (~x03 | (~new_n87_ & x11))) | (z5 & (x03 | (~new_n86_ & ~x11)));
  assign new_n86_ = ~x06 & (x14 | ~x20);
  assign new_n87_ = x06 & (~x14 | x20);
  assign z7 = (~new_n89_ & x05) | ~new_n90_ | new_n65_ | (~x05 & ~x13 & x15);
