...
module FAU ( 
  ...
  assign z4 = ((new_n88_ | ~x08) & (~new_n85_ | new_n89_)) | (z5 & (new_n87_ | x08));
  assign z5 = (~new_n84_ & x05) | ~new_n83_ | (~x05 & ~x13 & ~new_n39_ & x19);
  assign new_n83_ = ~new_n38_ & (~x21 | ~x24 | ~x07 | ~x13);
  assign new_n84_ = (~x13 | ~x19 | x24) & (~x07 | ~x21 | ~x24);
  assign new_n85_ = (x05 | x13 | ~x15 | (~x21 & x24)) & (new_n86_ | ~x21);
  assign new_n86_ = (~x13 | ~x18 | ~x24) & (x02 | x10 | x24);
  assign new_n87_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n88_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n89_ = x05 & ((x13 & x15 & ~x24) | (x18 & x21 & x24));
  assign z6 = (~new_n37_ & (new_n91_ | x03)) | new_n39_ | (~new_n65_ & (new_n92_ | ~x03));
