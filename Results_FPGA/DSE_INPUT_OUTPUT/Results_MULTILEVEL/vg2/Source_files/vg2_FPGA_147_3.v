...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n43_, new_n44_,
    ...
    new_n61_, new_n62_, new_n63_, new_n66_, new_n67_, new_n69_;
  assign z0 = ~x01 & ~x03 & new_n36_ & ~x06;
  assign new_n36_ = ~x11 & ~x14 & ~x20 & ~new_n37_ & (~x08 | ~x23);
  ...
  assign new_n43_ = x11 & x14 & x20 & ~new_n44_ & (~x08 | ~x23);
  ...
  assign new_n56_ = (~x08 | ~x23) & (x05 | new_n57_ | x13);
  ...
  assign z4 = (~new_n44_ & ~new_n63_) | (~new_n37_ & ~new_n61_);
  assign new_n61_ = (x16 | ((new_n62_ | x08) & (~x04 | x22 | x23))) & (~x08 | x23);
  assign new_n62_ = ~x09 & (~x17 | x22);
  assign new_n63_ = x08 & (~x16 | x23 | (x09 & (x17 | ~x22)));
  assign z5 = ~new_n37_ & (~x08 | (~x23 & (x08 | (x04 & ~x16 & ~x22))));
  assign z6 = (new_n66_ | new_n67_) & (~x08 | ~x23);
  assign new_n66_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n67_ = ~new_n44_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n69_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n69_ = ~new_n45_ & (~x08 | ~x23);
endmodule
