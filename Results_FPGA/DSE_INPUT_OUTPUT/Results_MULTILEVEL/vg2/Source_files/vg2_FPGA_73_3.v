...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n43_, new_n45_,
    ...
    new_n62_, new_n63_, new_n64_, new_n67_, new_n68_;
  ...
  assign new_n57_ = (~x12 | ~x22) & (x05 | new_n58_ | x13);
  ...
  assign z4 = ~new_n62_ | (~new_n45_ & (new_n64_ | ~x08));
  assign new_n62_ = (~x12 | ~x22) & (new_n37_ | ((~x08 | (x12 & x22)) & (new_n63_ | x16)));
  assign new_n63_ = (x22 | (~x17 & (~x04 | x23))) & (x08 | ~x09);
  assign new_n64_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (~x12 | ~x22);
  assign z6 = new_n67_ | (x12 & x22) | (~new_n45_ & (x03 ? new_n68_ : (~x12 | ~x22)));
