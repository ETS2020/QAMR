...
module FAU ( 
  ...
  assign new_n62_ = (~new_n63_ | x16) & ((x12 & x17) | (~x08 & (~x09 | x16)));
  assign new_n63_ = ~x22 & ((~x12 & x17) | (x04 & ~x17 & ~x23));
  assign new_n64_ = ((x12 & x17) | (x08 & (x09 | ~x16))) & (~new_n65_ | ~x16);
  assign new_n65_ = x22 & (~x17 | (~x04 & ~x12 & x23));
  assign z5 = ~new_n37_ & (~x12 | ~x17);
  assign z6 = (~x12 | ~x17) & (new_n68_ | new_n69_);
  assign new_n68_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n69_ = ~new_n45_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
