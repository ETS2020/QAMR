...
module FAU ( 
  ...
  assign new_n65_ = (x05 | x13 | ~x19) & (~x12 | ~x14);
  assign z6 = ~new_n68_ | (~new_n67_ & (~x12 | ~x14));
  assign new_n67_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n44_ | (x03 & (x06 | ~x11)));
  assign new_n68_ = (x24 | (~new_n69_ & (~x05 | new_n71_ | ~x13))) & (~x24 | new_n72_ | (~x05 & ~x13)) & (x05 | new_n71_ | x13);
  assign new_n69_ = ~x02 & ~new_n70_ & ~x10;
  assign new_n70_ = (~x00 | x11 | x14 | ~x20) & (~x11 | x12 | ~x14 | x20 | ~x21);
  assign new_n71_ = (~x19 | ~x20 | x11 | x14) & (~x11 | x12 | ~x14 | ~x15 | x20);
