...
module FAU ( 
  ...
  assign new_n74_ = (x12 | ~x17) & (x05 | new_n75_ | x13);
  ...
  assign z4 = (~new_n64_ & ~new_n81_) | (~new_n37_ & ~new_n79_);
  assign new_n79_ = ((~x12 & x17) | (~x08 & (~x09 | x16))) & (~new_n80_ | x16);
  assign new_n80_ = ~x22 & ((x12 & x17) | (x04 & ~x17 & ~x23));
  assign new_n81_ = ((~x12 & x17) | (x08 & (x09 | ~x16))) & (~new_n82_ | ~x16);
  assign new_n82_ = x22 & (~x17 | (~x04 & x12 & x23));
  assign z5 = ~new_n37_ & (x12 | ~x17);
  assign z6 = (x12 | ~x17) & (new_n85_ | new_n86_);
