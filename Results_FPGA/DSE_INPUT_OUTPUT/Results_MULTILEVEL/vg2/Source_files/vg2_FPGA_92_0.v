...
module FAU ( 
  ...
  assign new_n61_ = (new_n62_ | (~x02 & ~x12)) & (~x12 | ~x21 | x24 | x02 | x10);
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (x12 & (new_n64_ | new_n69_ | new_n74_)) | (x02 & (new_n69_ | new_n78_));
  ...
  assign new_n72_ = new_n73_ & ~x06 & x07 & ~x01 & ~x03;
  ...
  assign z4 = (~new_n61_ & (~x08 | (~new_n81_ & x16))) | (z5 & (x08 | (~new_n80_ & ~x16)));
  assign new_n80_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n81_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n83_ | new_n86_ | (~x02 & ~x12);
  ...
  assign z7 = ~new_n62_ | (~x02 & (~x12 | (~x10 & x21 & ~x24)));
endmodule
