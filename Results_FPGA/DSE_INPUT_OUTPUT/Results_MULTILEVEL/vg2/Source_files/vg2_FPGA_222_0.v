...
module FAU ( 
  ...
  assign z0 = ~x20 & (new_n36_ | ~x21);
  assign new_n36_ = ~x01 & ~x03 & ~x06 & ~x11 & ~new_n37_ & ~x14;
  ...
  assign z2 = (new_n64_ & x01) | (~x20 & ~x21);
  ...
  assign z3 = (~new_n68_ & ~x24) | ~new_n75_ | (x24 & ~new_n71_ & (x05 | x13));
  ...
  assign new_n75_ = (x20 | x21) & (x05 | new_n76_ | x13);
  ...
  assign z6 = (~new_n91_ & x20) | (~new_n92_ & x21);
  assign new_n91_ = (new_n37_ | (~x03 & (x11 | (~x06 & x14)))) & (new_n83_ | (x03 & (x06 | ~x11)));
  assign new_n92_ = ~new_n93_ & ~new_n38_ & (new_n81_ | (~x03 & (~x06 | x11)));
  assign new_n93_ = ~new_n94_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n94_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n95_ & (x05 | x13 | ~x15);
  assign new_n95_ = ~x02 & ~x10 & ~x24;
endmodule
