...
module FAU ( 
  ...
  assign new_n68_ = ~new_n49_ & (new_n69_ | (new_n71_ & new_n72_ & x15 & x20));
  ...
  assign z4 = (~new_n80_ & (x08 | (~new_n82_ & ~x16))) | (~new_n64_ & (~x08 | (~new_n83_ & x16)));
  assign new_n80_ = ~new_n38_ & (new_n81_ | (x02 & x12));
  ...
  assign z5 = new_n85_ | ~new_n86_ | new_n38_ | (x07 & x13 & x24);
  assign new_n85_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n86_ = (x05 | x13 | ~x19) & (~x02 | ~x12);
  assign z6 = (~new_n80_ & (x03 | (~new_n88_ & ~x11))) | (~new_n64_ & (~x03 | (~new_n89_ & x11)));
  ...
  assign new_n92_ = (~x02 | ~x12) & (~x13 | ~x18 | ~x24);
endmodule
