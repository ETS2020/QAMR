// Benchmark "FAU" written by ABC on Tue Aug 18 17:44:17 2020
...
module FAU ( 
  ...
  assign z2 = x06 & (new_n43_ | x12);
  assign new_n43_ = x01 & x03 & x11 & x14 & ~new_n44_ & x20;
  ...
  assign new_n57_ = x11 & ~x12 & x14 & x15 & x20;
  assign new_n58_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n37_ & (new_n60_ | x08)) | new_n62_ | (~new_n44_ & (new_n61_ | ~x08));
  assign new_n60_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n61_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n62_ = x06 & x12;
  assign z5 = (~new_n65_ & x05) | ~new_n64_ | new_n62_ | (~x05 & ~x13 & x19);
  assign new_n64_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n65_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = new_n67_ | new_n68_ | new_n72_ | new_n62_ | (new_n75_ & ~x05);
  assign new_n67_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n68_ = x24 & (new_n69_ | (x18 & ~new_n71_ & (x05 | x13)));
  assign new_n69_ = new_n70_ & x03 & ~x05 & x11;
  assign new_n70_ = x15 & ~x20 & ~x13 & x14;
  assign new_n71_ = (x03 | (x06 & x12)) & (~x11 | (x06 & (~x03 | ~x14 | x20)));
  assign new_n72_ = ~x24 & ((~new_n73_ & x11) | (~x03 & ~new_n49_ & ~new_n62_));
  assign new_n73_ = ~new_n74_ & (new_n49_ | (x06 & (x12 | ~x14 | x20)));
  assign new_n74_ = x14 & x15 & ~x20 & ~x05 & ~x12 & ~x13;
  assign new_n75_ = ~x13 & x15 & ((~x03 & (~x06 | ~x12)) | (~x06 & x11));
  assign z7 = ~new_n44_ & ~new_n62_;
endmodule
