...
module FAU ( 
  ...
  assign new_n57_ = x20 & x23 & x16 & x17;
  ...
  assign new_n78_ = (x12 | x16 | new_n79_ | x22) & ((x12 & ~x22) | (~x08 & (~x09 | x16)));
  assign new_n79_ = ~x17 & (~x04 | x23);
  assign new_n80_ = (~x16 | new_n81_ | ~x22) & ((x12 & ~x22) | (x08 & (x09 | ~x16)));
  assign new_n81_ = x17 & (x04 | ~x23);
  assign z5 = new_n83_ | ~new_n84_ | new_n38_ | (x07 & x13 & x24);
  assign new_n83_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n84_ = (~x12 | x22) & (x05 | x13 | ~x19);
  assign z6 = (new_n86_ | new_n87_) & (~x12 | x22);
  assign new_n86_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n87_ = ~new_n63_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n89_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n89_ = ~new_n64_ & (~x12 | x22);
endmodule
