...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n82_ | x08)) | ((new_n81_ | new_n66_) & (new_n83_ | ~x08));
  ...
  assign z6 = (~new_n88_ & (new_n89_ | x03)) | new_n38_ | (~new_n65_ & (new_n90_ | ~x03));
  assign new_n88_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n40_ & (x05 | x13 | ~x19);
