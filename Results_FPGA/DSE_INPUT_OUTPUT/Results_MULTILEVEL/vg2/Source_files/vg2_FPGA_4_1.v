...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n49_ | new_n57_;
  ...
  assign new_n70_ = x24 & ~new_n56_ & (new_n71_ | new_n73_);
  ...
  assign z4 = new_n81_ | (new_n88_ & x24) | new_n85_ | (~new_n89_ & ~x02);
  assign new_n81_ = ~new_n82_ & (x08 ? ~x12 : new_n84_);
  ...
  assign new_n85_ = ~new_n86_ & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n86_ = (~x02 | ~x08 | ~x19) & (~x15 | (~new_n87_ & x08));
  assign new_n87_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n88_ = ~new_n56_ & ((x18 & (new_n87_ | ~x08)) | (x02 & x07 & x08));
  assign new_n89_ = ~x12 & (x10 | ~x21 | x24 | (~new_n87_ & x08));
  assign z6 = (~new_n62_ & (~x03 | (~new_n92_ & x11))) | (z5 & (x03 | (~new_n91_ & ~x11)));
