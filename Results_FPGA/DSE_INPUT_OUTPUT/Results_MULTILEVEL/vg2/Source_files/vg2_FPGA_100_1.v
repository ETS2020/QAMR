...
module FAU ( 
  ...
  assign z2 = (~x03 & x12) | (x01 & new_n62_ & x03);
  ...
  assign z4 = (~new_n63_ & (new_n78_ | ~x08)) | new_n77_ | (~new_n37_ & (x08 ? ~new_n77_ : new_n79_));
  assign new_n77_ = ~x03 & x12;
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & ~new_n77_;
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | (~x03 & x12) | (~new_n63_ & (new_n83_ | ~x03));
  assign new_n82_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n83_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n85_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n85_ = ~new_n64_ & (x05 | x13 | ~x15) & ~new_n77_ & (~new_n86_ | ~x13);
