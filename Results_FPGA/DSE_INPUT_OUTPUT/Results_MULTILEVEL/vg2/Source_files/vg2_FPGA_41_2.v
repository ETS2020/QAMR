...
module FAU ( 
  ...
  assign new_n56_ = ~new_n57_ & (~new_n59_ | ~new_n60_ | ~new_n55_ | ~x19 | x20);
  assign new_n57_ = new_n49_ & new_n58_ & x15 & x16 & x12 & x14;
  assign new_n58_ = x22 & x23 & x17 & x20;
  assign new_n59_ = new_n53_ & ~x09 & ~x11 & ~x06 & ~x08;
  ...
  assign new_n78_ = (~x12 | x17) & (new_n37_ | ((~x08 | (x12 & ~x17)) & (new_n79_ | x16)));
  assign new_n79_ = (x08 | (~x09 & (~x04 | x22 | x23))) & (~x17 | x22);
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (~x12 | x17);
  assign z6 = (~x12 | x17) & (new_n83_ | new_n84_);
  ...
  assign new_n86_ = ~new_n64_ & (~x12 | x17);
endmodule
