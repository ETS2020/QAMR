...
module FAU ( 
  ...
  assign z3 = (~new_n61_ & (x05 ? (x13 & ~x24) : ~x13)) | ~new_n58_ | (x24 & ~new_n54_ & (x05 | x13));
  assign new_n54_ = ~new_n55_ & (~new_n57_ | x01 | x03 | x06 | ~x07);
  assign new_n55_ = new_n56_ & x18 & x20 & x11 & x14;
  assign new_n56_ = x01 & x03 & x06 & x08;
  assign new_n57_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n58_ = (~x05 | x21) & (x02 | x10 | new_n59_ | x24);
  assign new_n59_ = (~x01 | ~x03 | ~new_n60_ | ~x06) & (~new_n57_ | ~x00 | x01 | x03 | x06);
  assign new_n60_ = x08 & x11 & x14 & x20 & (x05 | x21);
  ...
  assign z4 = (~new_n65_ & (new_n72_ | x08)) | new_n74_ | (~new_n69_ & (new_n73_ | ~x08));
  assign new_n65_ = x05 ? ~new_n68_ : new_n66_;
  assign new_n66_ = (x13 | ~x19) & ~new_n67_ & (~x07 | ~x13 | ~x24);
  assign new_n67_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n68_ = x21 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n69_ = ~new_n71_ & (~x21 | (~new_n70_ & (x02 | x10 | x24)));
  assign new_n70_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n71_ = ~x05 & (x13 ? (x18 & x24) : x15);
  assign new_n72_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n73_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n74_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z6 = new_n76_ | new_n77_ | (x05 & (new_n67_ | ~x21));
  assign new_n76_ = ~new_n52_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n77_ = ~new_n78_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n78_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n67_ & (x05 | x13 | ~x19);
