// Benchmark "FAU" written by ABC on Tue Aug 18 17:43:27 2020
...
module FAU ( 
  ...
  assign new_n47_ = ~new_n48_ & (~new_n52_ | ~new_n54_ | ~x12 | ~x16 | ~x17);
  assign new_n48_ = new_n49_ & new_n51_ & ~x11 & ~x14 & ~x16;
  assign new_n49_ = new_n50_ & ~x08 & ~x09 & ~x06 & x07;
  ...
  assign new_n55_ = ~new_n61_ & (x05 | (~new_n56_ & ~new_n58_) | x13);
  assign new_n56_ = new_n52_ & new_n57_ & x12 & x15 & x16;
  assign new_n57_ = x22 & x23 & x17 & x20;
  assign new_n58_ = new_n59_ & new_n60_ & ~x14 & ~x16 & ~x17;
  assign new_n59_ = new_n50_ & ~x09 & ~x11 & ~x06 & ~x08;
  ...
  assign new_n67_ = (~x24 | new_n68_ | (~x05 & ~x13)) & ~new_n61_ & (x05 | new_n72_ | x13);
  ...
  assign z4 = (~new_n37_ & (new_n78_ | x08)) | new_n61_ | (~new_n64_ & (new_n79_ | ~x08));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n82_ & x05) | ~new_n81_ | new_n61_ | (~x05 & ~x13 & x19);
  assign new_n81_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n82_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n84_ | x03)) | new_n61_ | (~new_n64_ & (new_n85_ | ~x03));
  assign new_n84_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n85_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n87_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n87_ = ~new_n61_ & ~new_n65_;
endmodule
