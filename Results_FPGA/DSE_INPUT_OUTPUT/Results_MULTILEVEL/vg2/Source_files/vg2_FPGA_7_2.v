...
module FAU ( 
  ...
  assign new_n51_ = (x24 | (~new_n52_ & (~x05 | ~x13 | ~x15))) & (~x18 | ~x24 | (~x05 & ~x13)) & (x05 | x13 | ~x15);
  assign new_n52_ = ~x02 & ~x10 & (x05 | x21);
  ...
  assign z4 = (~new_n65_ & (new_n68_ | x08)) | new_n70_ | (~new_n46_ & (new_n69_ | ~x08));
  assign new_n65_ = x05 ? ~new_n66_ : (new_n67_ & (x13 | ~x19));
  assign new_n66_ = x21 & ((x13 & x19 & ~x24) | (x07 & x24));
  assign new_n67_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign new_n68_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n69_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n70_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z6 = (~new_n65_ & (new_n72_ | x03)) | new_n70_ | (~new_n46_ & (new_n73_ | ~x03));
  assign new_n72_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n73_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n75_ | (~x24 & (new_n52_ | (x05 & x13 & x15)));
  assign new_n75_ = (~x05 | (x21 & (~x18 | ~x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
endmodule
