...
module FAU ( 
  ...
  assign z2 = (~x12 & ~x17) | (new_n45_ & x01);
  ...
  assign new_n56_ = (x12 | x17) & (x05 | new_n57_ | x13);
  ...
  assign new_n61_ = ((~x12 & ~x17) | (~x08 & (~x09 | x16))) & (~new_n62_ | x16);
  assign new_n62_ = ~x22 & (x17 | (x04 & x12 & ~x23));
  assign new_n63_ = (~new_n64_ | ~x16) & ((~x12 & ~x17) | (x08 & (x09 | ~x16)));
  assign new_n64_ = x22 & ((x12 & ~x17) | (~x04 & x17 & x23));
  assign z5 = ~new_n37_ & (x12 | x17);
  assign z6 = new_n67_ | (~x12 & ~x17) | (~new_n42_ & (x03 ? new_n68_ : (x12 | x17)));
