...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~new_n61_) | new_n49_ | (new_n56_ & ~x02) | (x02 & ~x12);
  ...
  assign z2 = (new_n63_ & x01) | (x02 & ~x12);
  ...
  assign z3 = (~x02 & (new_n67_ | new_n72_ | (new_n76_ & ~x10))) | (x12 & (new_n67_ | new_n72_));
  assign new_n67_ = ~new_n61_ & (new_n68_ | (new_n70_ & new_n71_ & x15 & x20));
  ...
  assign new_n79_ = ~new_n65_ & (new_n80_ | (x02 & ~x12));
  ...
  assign z7 = (~new_n87_ & x05) | ~new_n88_ | new_n65_ | (~x05 & ~x13 & x15);
