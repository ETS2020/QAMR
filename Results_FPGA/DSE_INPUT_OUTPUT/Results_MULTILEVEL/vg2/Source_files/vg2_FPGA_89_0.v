// Benchmark "FAU" written by ABC on Tue Aug 18 17:43:48 2020
...
module FAU ( 
  ...
  assign new_n50_ = (~new_n41_ | ~new_n51_) & (~new_n46_ | ~new_n53_ | ~new_n54_ | ~new_n55_);
  ...
  assign new_n60_ = x12 & (~new_n61_ | ~x06 | x10 | ~x01 | ~x03);
  ...
  assign z3 = (x12 & (new_n65_ | new_n70_ | new_n75_)) | (x02 & (new_n70_ | new_n79_));
  ...
  assign new_n70_ = x24 & (x05 | x13) & (new_n71_ | new_n73_);
  ...
  assign new_n79_ = ~new_n76_ & (x05 ? (x13 & ~x24) : ~x13);
  assign z4 = (~new_n37_ & (x08 | (~new_n82_ & ~x16))) | (z7 & (~x08 | (~new_n83_ & x16)));
  assign z7 = (~new_n63_ & (x02 | x12)) | (x12 & x21 & ~x24 & ~x02 & ~x10);
  assign new_n82_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n83_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n38_ | (~x02 & (~x12 | (x00 & ~x10 & ~x24)));
  assign z6 = new_n86_ | (~new_n89_ & ~new_n92_) | (new_n91_ & x02) | (~x02 & ~x12);
  assign new_n86_ = ~new_n87_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n87_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n88_ & (x05 | x13 | ~x19);
  ...
  assign new_n91_ = ~new_n63_ & ~x03;
  assign new_n92_ = x03 ? (~x11 | (x06 & (~x14 | x20))) : ~x12;
endmodule
