...
module FAU ( 
  ...
  assign z4 = (~new_n64_ & ~new_n80_) | (~new_n37_ & ~new_n78_);
  assign new_n78_ = (x16 | new_n79_ | x22) & ((~x12 & x22) | (~x08 & (~x09 | x16)));
  assign new_n79_ = ~x17 & (~x04 | x23);
  assign new_n80_ = (~x12 | ~x16 | new_n81_ | ~x22) & ((~x12 & x22) | (x08 & (x09 | ~x16)));
  ...
  assign new_n89_ = ~new_n39_ & ~new_n65_;
endmodule
