...
module FAU ( 
  ...
  assign new_n54_ = ~x11 & ~x14 & ~new_n43_ & ~x20;
  assign z4 = (~new_n37_ & (new_n58_ | x08)) | new_n39_ | (~new_n56_ & (new_n59_ | ~x08));
  assign new_n56_ = (x24 | (~new_n57_ & (~x05 | ~x13 | ~x15))) & (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n57_ = ~x02 & ~x10 & (~x05 | x21);
  ...
  assign new_n61_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n62_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n64_ & (new_n67_ | x03)) | new_n69_ | (~new_n48_ & (new_n68_ | ~x03));
  assign new_n64_ = ~new_n65_ & (x05 | x13 | ~x19 | ~x21) & (~new_n66_ | ~x05);
  assign new_n65_ = x07 & x24 & (x05 | (x13 & x21));
  assign new_n66_ = ~x24 & ((x13 & x19) | (x00 & ~x02 & ~x10));
  assign new_n67_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n69_ = x00 & ~x02 & ~x05 & ~x10 & x21 & ~x24;
  assign z7 = ~new_n71_ | (~x24 & (new_n57_ | (x05 & x13 & x15)));
  assign new_n71_ = (~x18 | ~x24 | (~x05 & ~x13)) & (x05 | (x21 & (x13 | ~x15)));
endmodule
