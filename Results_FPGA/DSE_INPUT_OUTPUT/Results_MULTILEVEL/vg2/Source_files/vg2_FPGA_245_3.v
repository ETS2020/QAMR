...
module FAU ( 
  ...
  assign z4 = ((new_n81_ | new_n86_) & (new_n85_ | x08)) | (z7 & (new_n87_ | ~x08));
  assign new_n81_ = ~new_n82_ & (~x02 | ~x12);
  assign new_n82_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign z7 = new_n65_ | (~new_n84_ & (~x02 | ~x12));
  ...
  assign z5 = new_n89_ | ~new_n90_ | new_n86_ | (x07 & x13 & x24);
  assign new_n89_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n90_ = (x05 | x13 | ~x19) & (~x02 | ~x12);
  assign z6 = new_n92_ | new_n94_ | (x02 & x12) | (~new_n99_ & ~x03);
  assign new_n92_ = ~new_n93_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n93_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n86_ & (x05 | x13 | ~x19);
  assign new_n94_ = x11 & (~new_n95_ | new_n98_) & (~x06 | (x14 & ~x20));
  assign new_n95_ = (~x03 | (~new_n96_ & (~x13 | ~x18 | ~x24))) & (x24 | (~new_n96_ & ~new_n97_));
  ...
  assign new_n101_ = (~x18 | (~x05 & ~x13) | (x02 & x12)) & (x13 | ~x15 | x05 | x12);
endmodule
