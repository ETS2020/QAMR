...
module FAU ( 
  ...
  assign z2 = x14 & (new_n44_ | x12);
  assign new_n44_ = x01 & x03 & x06 & x11 & ~new_n45_ & x20;
  ...
  assign z4 = ~new_n39_ & ((~new_n37_ & (new_n61_ | x08)) | (~new_n45_ & (new_n62_ | ~x08)));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = ~new_n66_ | (~new_n65_ & ~new_n39_);
  assign new_n65_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n45_ | (x03 & (x06 | ~x11)));
  assign new_n66_ = (x24 | (~new_n67_ & (~x05 | new_n69_ | ~x13))) & (x05 | new_n69_ | x13) & (~x24 | new_n70_ | (~x05 & ~x13));
  assign new_n67_ = ~x02 & ~new_n68_ & ~x10;
  assign new_n68_ = (x14 | ~x20 | ~x00 | x11) & (~x11 | x12 | ~x14 | x20 | ~x21);
  assign new_n69_ = (~x19 | ~x20 | x11 | x14) & (~x11 | x12 | ~x14 | ~x15 | x20);
  assign new_n70_ = (~x07 | x11 | x14 | ~x20) & (~x14 | ~x18 | x20 | ~x11 | x12);
