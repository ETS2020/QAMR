...
module FAU ( 
  ...
  assign z3 = ~new_n51_ | (~x24 & (new_n63_ | (~new_n59_ & x13)));
  assign new_n51_ = (~x24 | new_n52_ | (~x05 & ~x13)) & (x13 | (~x21 & (new_n56_ | x05)));
  ...
  assign new_n59_ = (~x01 | ~x03 | ~new_n60_ | ~x06) & (~new_n62_ | x01 | x03 | ~x05 | x06);
  assign new_n60_ = x08 & x11 & new_n61_ & x14;
  assign new_n61_ = x20 & ((x05 & x15) | (~x02 & ~x10 & x21));
  assign new_n62_ = ~x08 & ~x11 & ~x14 & x19 & ~x20;
  assign new_n63_ = new_n64_ & x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n64_ = ~x08 & ~x10 & ~x11 & ~x14 & ~x20;
  assign z4 = (~new_n37_ & (x08 | (~new_n67_ & ~x16))) | (z7 & (~x08 | (~new_n66_ & x16)));
  assign new_n66_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n67_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z5 = (~new_n69_ & x05) | ~new_n70_ | (~x13 & (x21 | (~x05 & x19)));
  assign new_n69_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n70_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign z6 = (~new_n37_ & (x03 | (~new_n73_ & ~x11))) | (z7 & (~x03 | (~new_n72_ & x11)));
