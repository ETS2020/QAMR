...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n75_, new_n77_, new_n78_, new_n81_, new_n82_;
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n77_ & ~x16))) | (z7 & (~x08 | (~new_n78_ & x16)));
  assign new_n77_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n78_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n38_ | (~x02 & (~x12 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n37_ & (x03 | (~new_n81_ & ~x11))) | (z7 & (~x03 | (~new_n82_ & x11)));
