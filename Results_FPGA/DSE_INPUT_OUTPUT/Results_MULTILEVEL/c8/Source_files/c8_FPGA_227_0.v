...
module FAU ( 
  ...
  assign z06 = (~x25 & ~x27) | (~x14 & x27) | (~x04 & ~x18);
  ...
  assign z11 = (~x16 & (x18 ? x02 : x10)) | (~x04 & ~x18) | (~new_n62_ & x16);
  ...
  assign z13 = (x04 & (x16 ? ~new_n68_ : (x12 | x18))) | (x16 & ~new_n68_ & x18);
  ...
  assign z15 = (~new_n74_ & ~x16) | (~x04 & ~x18) | (x16 & (new_n72_ | new_n73_));
  ...
  assign z17 = (~new_n78_ & x16) | (~x04 & ~x18);
