...
module FAU ( 
  ...
  assign z11 = x16 ? (~new_n63_ & (~x03 | x18)) : ((x02 & x18) | (~x03 & x10 & ~x18));
  assign new_n63_ = ~new_n65_ & (new_n64_ | ~x21);
  assign new_n64_ = ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (x03 & (~x16 | ~x18)) | (~new_n67_ & x16) | (x11 & ~x16 & ~x18);
  ...
  assign z14 = x16 ? (~new_n71_ & (~x03 | x18)) : ((x05 & x18) | (~x03 & x13 & ~x18));
  ...
  assign new_n75_ = (~x06 | ~x18) & (x03 | ~x14 | x18);
  assign z16 = x16 ? (~new_n77_ & (~x03 | x18)) : ((x07 & x18) | (~x03 & x15 & ~x18));
