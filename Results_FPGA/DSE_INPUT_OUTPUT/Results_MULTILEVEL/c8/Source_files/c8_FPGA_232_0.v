...
module FAU ( 
  ...
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n70_ & x16) | (~x18 & ~x25);
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign z15 = ~new_n72_ | (~x16 & (x18 ? x06 : x14));
  assign new_n72_ = (x25 | (x18 & (~new_n74_ | ~new_n73_ | ~x16 | x17))) & (~x16 | ~x25 | (new_n74_ & new_n73_ & ~x17));
  assign new_n73_ = ~x19 & ~x20;
  assign new_n74_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z16 = x16 ? (new_n76_ | (x25 & x26)) : ~new_n78_;
  assign new_n76_ = x18 & ((new_n64_ & new_n77_) | (x26 & (~new_n63_ | ~new_n74_)));
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n78_ = (~x07 | ~x18) & (~x15 | x18 | ~x25);
  assign z17 = (~x18 & ~x25) | (~new_n80_ & x16);
