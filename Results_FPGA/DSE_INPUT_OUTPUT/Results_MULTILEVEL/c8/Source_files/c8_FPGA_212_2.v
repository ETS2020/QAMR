...
module FAU ( 
  ...
  assign z00 = (~x08 & (~x19 | x27)) | (x19 & ~x24) | (~x19 & ~x27);
  ...
  assign new_n72_ = (~x24 | (new_n73_ & ~x21 & ~x22 & ~x23)) & (~new_n73_ | x23 | x24 | x21 | x22);
  assign new_n73_ = ~x17 & ~x19 & ~x20;
  assign z15 = (~new_n76_ & ~x16) | (x19 & (~x24 | (x16 & x25))) | (~new_n75_ & x16);
  assign new_n75_ = (~x25 | (new_n66_ & ~x22 & ~x23 & ~x24)) & (~new_n66_ | x24 | x25 | x22 | x23);
  assign new_n76_ = x18 ? ~x06 : ~x14;
  assign z16 = (~new_n81_ & ~x16) | (x19 & (~x24 | (x16 & x26))) | (~new_n78_ & x16);
  ...
  assign z17 = new_n50_ | (x16 & x17 & x27);
endmodule
