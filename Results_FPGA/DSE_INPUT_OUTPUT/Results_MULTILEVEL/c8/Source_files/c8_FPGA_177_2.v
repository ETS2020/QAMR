// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:55 2020
...
module FAU ( 
  ...
  assign z02 = (~x02 & ~x10 & (~x21 | x27)) | (x10 & ~x21 & ~x27);
  ...
  assign z11 = (x02 & (~x10 | ~x16)) | (~new_n63_ & x16) | (x10 & ~x16 & ~x18);
  ...
  assign z14 = (~x16 & (x18 ? x05 : x13)) | new_n49_ | (~new_n71_ & x16);
