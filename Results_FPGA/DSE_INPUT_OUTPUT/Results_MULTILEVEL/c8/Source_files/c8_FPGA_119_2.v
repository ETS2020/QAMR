...
module FAU ( 
  ...
  assign z11 = x16 ? (~new_n63_ & (~x14 | x18)) : ((x02 & x18) | (x10 & ~x14 & ~x18));
  ...
  assign z13 = x16 ? (~new_n69_ & (~x14 | x18)) : ((x04 & x18) | (x12 & ~x14 & ~x18));
  ...
  assign z15 = (x16 & (~x14 | x18) & (new_n73_ | new_n74_)) | (x06 & ~x16 & x18);
  assign new_n73_ = x25 & (~new_n64_ | x23 | x24 | x21 | x22);
  assign new_n74_ = new_n65_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (x14 & ~x18) | (~new_n76_ & x16);
