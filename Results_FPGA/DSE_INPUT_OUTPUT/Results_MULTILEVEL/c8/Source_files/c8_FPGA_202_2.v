...
module FAU ( 
  ...
  assign z09 = x16 ? (x17 ? (x18 | x19) : ~x19) : (x18 ? (x00 | ~x19) : x08);
  ...
  assign z13 = x16 ? ((x19 & x23) | (~new_n65_ & ~x18)) : ~new_n68_;
  assign new_n65_ = (~x23 | (new_n67_ & ~x21 & ~x22)) & (~new_n66_ | x21 | x22 | x23);
  assign new_n66_ = ~x17 & ~x19 & ~x20;
  assign new_n67_ = ~x17 & ~x20;
  assign new_n68_ = (~x12 | x18) & (~x04 | ~x18 | ~x19);
  assign z14 = x16 ? ((x19 & x24) | (~new_n70_ & ~x18)) : ~new_n71_;
  assign new_n70_ = (~x24 | (new_n67_ & ~x21 & ~x22 & ~x23)) & (~new_n66_ | x23 | x24 | x21 | x22);
  assign new_n71_ = (~x13 | x18) & (~x05 | ~x18 | ~x19);
  ...
  assign z17 = x16 & (new_n83_ | (x17 & x27 & (~x18 | x19)));
  assign new_n83_ = new_n84_ & ~x20 & ~x21 & ~x17 & x19;
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x22 & ~x23;
endmodule
