...
module FAU ( 
  ...
  assign z11 = x16 ? (~new_n63_ & (x07 | ~x18)) : ((x10 & ~x18) | (x02 & x07 & x18));
  ...
  assign z13 = x16 ? (~new_n69_ & (x07 | ~x18)) : ((x12 & ~x18) | (x04 & x07 & x18));
