// Benchmark "FAU" written by ABC on Mon Aug 17 20:03:25 2020
...
module FAU ( 
  ...
  assign z09 = (~new_n58_ & x16) | (~x14 & ~x18) | (~x16 & (x18 ? x00 : x08));
  ...
  assign z15 = (~x16 & (x06 | ~x18)) | (~x14 & ~x18) | (x16 & (new_n72_ | new_n73_));
  ...
  assign new_n75_ = (~x26 | (new_n64_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n64_ | x22 | x23 | x24 | x25 | x26);
