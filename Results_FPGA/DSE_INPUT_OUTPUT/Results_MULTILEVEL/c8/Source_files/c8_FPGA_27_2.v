...
module FAU ( 
  ...
  assign z01 = (~x09 & (x20 ? x27 : ~x18)) | (~x18 & ~x20 & ~x27);
  ...
  assign z13 = x16 ? ((x20 & x23) | (~new_n67_ & ~x18)) : ~new_n66_;
  assign new_n66_ = (~x12 | x18) & (~x04 | ~x18 | ~x20);
  ...
  assign new_n71_ = x20 & (~x16 | ~x24);
  assign z15 = x16 ? ((x20 & x25) | (~new_n73_ & ~x18)) : ~new_n76_;
  ...
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n78_ & x16) | (~new_n79_ & x18);
  assign new_n78_ = (~x26 | (new_n74_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n74_ | x22 | x23 | x24 | x25 | x26);
  assign new_n79_ = x20 & (~x16 | ~x26);
  assign z17 = (x18 & ~x20) | (~new_n81_ & x16);
