...
module FAU ( 
  ...
  assign z04 = (~x23 & ~x27) | (~x12 & x27) | (~x21 & x23);
  ...
  assign z12 = (~new_n65_ & ~x16) | (~new_n66_ & ~x21) | (x16 & ~new_n67_ & x22);
  assign new_n65_ = x18 ? ~x03 : ~x11;
  assign new_n66_ = ~x23 & (x19 | x20 | x22 | ~x16 | x17);
  ...
  assign new_n71_ = (x21 | (~new_n72_ & ~x23)) & (~x16 | new_n73_ | ~x24);
  assign new_n72_ = x16 & ~x17 & ~x19 & ~x20 & ~x22 & ~x24;
  assign new_n73_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z15 = x16 ? ~new_n75_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n75_ = (~x21 | ~x25) & (x23 | ((~new_n76_ | ~new_n78_) & (new_n77_ | ~x25)));
  assign new_n76_ = ~x17 & ~x19 & ~x20;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x22 & ~x24;
  assign new_n78_ = ~x24 & ~x25 & ~x21 & ~x22;
  assign z16 = (~new_n83_ & ~x16) | (~new_n80_ & ~x21) | (new_n82_ & x16);
  assign new_n80_ = ~x23 & (~new_n81_ | x19 | x20 | ~x16 | x17);
  assign new_n81_ = ~x25 & ~x26 & ~x22 & ~x24;
  assign new_n82_ = x26 & (~new_n67_ | x22 | x23 | x24 | x25);
  assign new_n83_ = x18 ? ~x07 : ~x15;
  assign z17 = new_n49_ | (~new_n85_ & x16);
  assign new_n85_ = (~new_n81_ | x17 | ~x19 | x20 | x21) & (~x17 | ~x27);
endmodule
