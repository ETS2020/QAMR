...
module FAU ( 
  ...
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (x18 & x24) | (~new_n70_ & x16);
  ...
  assign z16 = (~new_n78_ & ~x16) | (~new_n75_ & x16) | (x24 & (x18 | (x16 & x26)));
  assign new_n75_ = (~new_n64_ | ~new_n77_) & (~x26 | (new_n63_ & new_n76_));
  assign new_n76_ = ~x23 & ~x25 & ~x21 & ~x22;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n78_ = x18 ? ~x07 : ~x15;
  assign z17 = (x18 & x24) | (~new_n80_ & x16);
  assign new_n80_ = (~new_n77_ | x20 | x21 | x17 | ~x19) & (~x17 | ~x27);
endmodule
