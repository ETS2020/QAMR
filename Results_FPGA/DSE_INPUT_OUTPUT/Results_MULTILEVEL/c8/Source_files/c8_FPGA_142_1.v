...
module FAU ( 
  ...
  assign new_n67_ = (new_n65_ | ~x22) & (~new_n63_ | x21 | x22 | x23);
  assign z13 = (~new_n69_ & x16) | new_n49_ | (~x16 & (x18 ? x04 : x12));
  assign new_n69_ = ~x23 & (x17 | x19 | x20 | x21 | x22);
  assign z14 = x16 ? ~new_n71_ : (~new_n49_ & (x18 ? x05 : x13));
  assign new_n71_ = (x23 | ((new_n65_ | ~x24) & (~new_n63_ | x21 | x22 | x24))) & (~x22 | ~x24);
  assign z15 = (~x16 & (x18 ? x06 : x14)) | new_n73_ | (new_n75_ & x16);
  assign new_n73_ = ~x22 & (x23 | (new_n74_ & x16 & ~x17 & ~x19));
  assign new_n74_ = ~x24 & ~x25 & ~x20 & ~x21;
  assign new_n75_ = x25 & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z16 = x16 ? ((x22 & x26) | (~new_n77_ & ~x23)) : (~new_n79_ & (x22 | ~x23));
  assign new_n77_ = (new_n78_ | ~x26) & (~new_n65_ | x22 | x24 | x25 | x26);
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x24 & ~x25;
