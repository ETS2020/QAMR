...
module FAU ( 
  ...
  assign new_n61_ = (~x19 | (x18 & (~x16 | ~x21))) & (~x16 | ((~x21 | (~x17 & ~x20)) & (x20 | x21 | x17 | x19)));
  ...
  assign z14 = (~new_n72_ & ~x16) | (x19 & (~x18 | (x16 & x24))) | (~new_n70_ & x16);
  assign new_n70_ = (~x24 | (new_n68_ & ~x21 & ~x22 & ~x23)) & (~new_n71_ | x21 | x22 | x23 | x24);
  assign new_n71_ = ~x17 & ~x19 & ~x20;
  assign new_n72_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ((x18 & x19 & x25) | (~new_n74_ & ~x19)) : ~new_n75_;
  assign new_n74_ = (~x25 | (new_n64_ & ~x22 & ~x23 & ~x24)) & (~new_n64_ | x24 | x25 | x22 | x23);
  assign new_n75_ = (~x06 | ~x18) & (~x14 | x18 | x19);
  assign z16 = x16 ? ((x18 & x19 & x26) | (~new_n77_ & ~x19)) : ~new_n80_;
  assign new_n77_ = (~x26 | (new_n64_ & new_n79_)) & (~new_n65_ | ~new_n78_ | x25 | x26);
  assign new_n78_ = ~x23 & ~x24;
  assign new_n79_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n80_ = (~x07 | ~x18) & (~x15 | x18 | x19);
  assign z17 = x16 & ((z08 & x17) | (new_n83_ & new_n82_ & ~x17 & x18));
