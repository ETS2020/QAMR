...
module FAU ( 
  ...
  assign z09 = x16 ? (x17 ? x19 : (x18 | ~x19)) : (x18 ? (x00 | x19) : x08);
  ...
  assign z15 = (~new_n75_ & ~x16) | (x19 & (x18 | (x16 & x25))) | (~new_n73_ & x16);
  assign new_n73_ = (~x25 | (new_n64_ & ~x22 & ~x23 & ~x24)) & (~new_n74_ | x22 | x23 | x24 | x25);
  ...
  assign new_n80_ = (~x15 | x18) & (~x07 | ~x18 | x19);
  assign z17 = x16 & (new_n82_ | (x17 & x27 & (~x18 | ~x19)));
