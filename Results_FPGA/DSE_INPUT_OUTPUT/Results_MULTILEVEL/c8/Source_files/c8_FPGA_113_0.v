...
module FAU ( 
  ...
  assign z10 = x16 ? (~new_n61_ & (x18 | x23)) : ((x01 & x18) | (x09 & ~x18 & x23));
  ...
  assign new_n69_ = (~x23 | (new_n70_ & ~x20 & ~x21 & ~x22)) & (~new_n71_ | x20 | x21 | x22 | x23);
  assign new_n70_ = ~x17 & ~x19;
  assign new_n71_ = ~x17 & x18 & ~x19;
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n74_ & ~x18) | (~new_n73_ & x16);
  assign new_n73_ = (~x24 | (new_n64_ & ~x21 & ~x22 & ~x23)) & (~new_n64_ | x23 | x24 | x21 | x22);
  assign new_n74_ = x23 & (~x16 | ~x24);
  assign z15 = (~new_n78_ & ~x16) | new_n79_ | (x16 & (new_n77_ | (~new_n76_ & x25)));
  assign new_n76_ = new_n64_ & ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n77_ = new_n65_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n78_ = x18 ? ~x06 : ~x14;
  assign new_n79_ = ~x18 & (~x23 | (x16 & x25));
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n82_ & ~x18) | (~new_n81_ & x16);
  assign new_n81_ = (~x26 | (new_n65_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n65_ | x22 | x23 | x24 | x25 | x26);
  assign new_n82_ = x23 & (~x16 | ~x26);
