...
module FAU ( 
  ...
  assign z12 = x16 ? (~new_n64_ & (x18 | x24)) : ((x03 & x18) | (x11 & ~x18 & x24));
  assign new_n64_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n66_ & x16) | (~x18 & ~x24);
  ...
  assign z15 = x16 ? ~new_n73_ : ((x06 & x18) | (x14 & ~x18 & x24));
  assign new_n73_ = (~x18 | ((new_n70_ | ~x25) & (~new_n74_ | ~new_n75_ | x24 | x25))) & (~x24 | ~x25);
