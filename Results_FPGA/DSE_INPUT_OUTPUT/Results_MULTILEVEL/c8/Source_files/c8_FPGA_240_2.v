...
module FAU ( 
  ...
  assign z07 = (~x26 & ~x27) | (~x15 & x27) | (x18 & ~x19);
  ...
  assign z14 = x16 ? ((x19 & x24) | (~new_n69_ & ~x18)) : ~new_n72_;
  assign new_n69_ = (~x24 | (new_n70_ & ~x21 & ~x22 & ~x23)) & (~new_n71_ | x21 | x22 | x23 | x24);
  assign new_n70_ = ~x17 & ~x20;
  assign new_n71_ = ~x17 & ~x19 & ~x20;
  assign new_n72_ = (~x13 | x18) & (~x05 | ~x18 | ~x19);
  assign z15 = (~new_n78_ & ~x16) | new_n79_ | (x16 & (new_n75_ | (~new_n74_ & x25)));
  assign new_n74_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n75_ = new_n77_ & new_n76_ & ~x17 & ~x19;
  assign new_n76_ = ~x20 & ~x21;
  assign new_n77_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n78_ = x18 ? ~x06 : ~x14;
  assign new_n79_ = x18 & (~x19 | (x16 & x25));
  assign z16 = x16 ? ((x19 & x26) | (~new_n81_ & ~x18)) : ~new_n83_;
  assign new_n81_ = (~x26 | (new_n77_ & new_n76_ & ~x17)) & (~new_n82_ | ~new_n76_ | x17 | x19);
  assign new_n82_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n83_ = (~x15 | x18) & (~x07 | ~x18 | ~x19);
  assign z17 = (x18 & ~x19) | (~new_n85_ & x16);
  assign new_n85_ = (~x17 | ~x27) & (~new_n82_ | ~new_n76_ | x17 | ~x19);
endmodule
