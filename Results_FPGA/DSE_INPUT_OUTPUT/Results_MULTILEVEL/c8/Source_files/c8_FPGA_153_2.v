...
module FAU ( 
  ...
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (x10 & ~x18) | (~new_n69_ & x16);
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (x10 & ~x18) | (~new_n71_ & x16);
  ...
  assign z16 = x16 ? (~new_n77_ & (~x10 | x18)) : ((x07 & x18) | (~x10 & x15 & ~x18));
