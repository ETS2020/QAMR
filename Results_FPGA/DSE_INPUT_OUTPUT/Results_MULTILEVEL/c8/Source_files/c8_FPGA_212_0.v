...
module FAU ( 
  ...
  wire new_n50_, new_n59_, new_n61_, new_n63_, new_n65_, new_n67_, new_n68_,
    new_n69_, new_n70_, new_n72_, new_n73_, new_n77_, new_n78_;
  ...
  assign z05 = (~x13 & x27) | (~x24 & (~x19 | ~x27));
  ...
  assign new_n68_ = (x19 | x24) & (x18 ? x04 : x12);
  assign new_n69_ = ~x19 & (~x24 | (~x21 & ~x22 & ~x17 & ~x20));
  assign new_n70_ = ~x21 & ~x22 & ~x23 & x24;
  assign z14 = x16 ? (~new_n73_ & x24) : (~new_n72_ & (x19 | x24));
  ...
  assign z17 = new_n50_ | (x16 & ((new_n77_ & new_n78_) | (x17 & x27)));
