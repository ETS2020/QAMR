...
module FAU ( 
  ...
  assign new_n72_ = ~x23 & ((~new_n68_ & x24) | (new_n63_ & ~x21 & ~x22 & ~x24));
  assign z15 = x16 ? ~new_n74_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n74_ = (x24 | ((~x23 | ~x25) & (~new_n63_ | x23 | x25 | x21 | x22))) & (x23 | ~x25 | (new_n63_ & ~x21 & ~x22 & ~x24));
  assign z16 = x16 ? ((new_n77_ & ~x23) | (~new_n76_ & ~x24)) : (~new_n78_ & (~x23 | ~x24));
  assign new_n76_ = (~x23 | ~x26) & (~new_n65_ | x22 | x23 | x25 | x26);
  assign new_n77_ = x26 & (~new_n63_ | x21 | x22 | x24 | x25);
  assign new_n78_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & (new_n80_ | (x17 & ~new_n49_ & x27));
  assign new_n80_ = new_n81_ & ~x20 & ~x21 & ~x17 & x19;
