...
module FAU ( 
  ...
  assign z05 = (~x13 & (~x24 | x27)) | (x19 & x24) | (~x24 & ~x27);
  ...
  assign new_n65_ = x19 ? (~x22 | x24) : ((~x22 | (~x17 & ~x20 & ~x21)) & (x21 | x22 | x17 | x20));
  assign z13 = x16 ? (x19 ? (x23 & ~x24) : ~new_n68_) : (~new_n67_ & (~x19 | ~x24));
  assign new_n67_ = x18 ? ~x04 : ~x12;
  assign new_n68_ = (~x23 | (~x21 & ~x22 & ~x17 & ~x20)) & (x17 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n71_ & ~x19) : (~new_n70_ & (~x19 | ~x24));
  assign new_n70_ = x18 ? ~x05 : ~x13;
  assign new_n71_ = (~x24 | (~x17 & ~x20 & ~x21 & ~x22 & ~x23)) & (x17 | x20 | x21 | x22 | x23 | x24);
  assign z15 = (~new_n76_ & ~x16) | (x19 & (x24 | (x16 & x25))) | (~new_n73_ & x16);
  ...
  assign z16 = (~new_n80_ & ~x16) | (x19 & (x24 | (x16 & x26))) | (~new_n78_ & x16);
  ...
  assign z17 = new_n50_ | (x16 & (new_n82_ | (x17 & x27)));
  assign new_n82_ = new_n83_ & ~x20 & ~x21 & ~x17 & x19;
  assign new_n83_ = ~x25 & ~x26 & ~x22 & ~x23;
endmodule
