...
module FAU ( 
  ...
  assign new_n65_ = (~x20 | ~x22) & (~x16 | ((~x22 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x20 | x21 | x22)));
  assign z13 = x16 ? ~new_n67_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n67_ = (x22 | ((~x20 | ~x23) & (x17 | x19 | x20 | x21 | x23))) & (x20 | ~x23 | (~x17 & ~x19 & ~x21 & ~x22));
  assign z14 = x16 ? ((~new_n69_ & ~x22) | (new_n71_ & ~x20)) : (~new_n73_ & (~x20 | ~x22));
  assign new_n69_ = (~x20 | ~x24) & (~new_n70_ | x21 | x23 | x24);
  assign new_n70_ = ~x17 & ~x19 & ~x20;
  assign new_n71_ = x24 & (x17 | x19 | ~new_n72_ | x21);
  assign new_n72_ = ~x22 & ~x23;
  assign new_n73_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ~new_n75_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n75_ = (x22 | ((~new_n70_ | ~new_n76_) & (~x20 | ~x25))) & (x20 | new_n77_ | ~x25);
  assign new_n76_ = ~x24 & ~x25 & ~x21 & ~x23;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x17 & ~x19 & ~x21;
  assign z16 = (~new_n82_ & ~x16) | (x20 & (x22 | (x16 & x26))) | (~new_n79_ & x16);
  assign new_n79_ = (~x26 | (new_n80_ & new_n72_ & ~x24 & ~x25)) & (~new_n81_ | ~new_n72_ | x24 | x25 | x26);
  assign new_n80_ = ~x17 & ~x19 & ~x21;
  assign new_n81_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n82_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & (new_n84_ | (x17 & ~new_n49_ & x27));
