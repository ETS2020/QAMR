// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:06 2020
...
module FAU ( 
  ...
  assign z09 = x16 ? (~new_n59_ & (x18 | x24)) : ((x00 & x18) | (x08 & ~x18 & x24));
  assign new_n59_ = ~x17 ^ ~x19;
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x18 & ~x24) | (~new_n61_ & x16);
  assign new_n61_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n63_ & (x18 | x24)) : ((x02 & x18) | (x10 & ~x18 & x24));
  assign new_n63_ = ~new_n65_ & (new_n64_ | ~x21);
  assign new_n64_ = ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~x18 & ~x24) | (~new_n67_ & x16);
  assign new_n67_ = (x17 | x19 | x20 | x21 | new_n49_ | x22) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z13 = x16 ? (~new_n69_ & (x18 | x24)) : ((x04 & x18) | (x12 & ~x18 & x24));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = ~new_n71_ | (~x16 & (x18 ? x05 : x13));
  assign new_n71_ = (x24 | (x18 & (~new_n74_ | ~new_n72_ | ~x16))) & (~x16 | new_n73_ | ~x24);
  assign new_n72_ = ~x17 & ~x19;
  assign new_n73_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n74_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~new_n79_ & ~x18) | (~new_n76_ & x16);
  assign new_n76_ = (~x25 | (new_n64_ & new_n78_)) & (~new_n65_ | ~new_n77_ | x24 | x25);
  assign new_n77_ = ~x22 & ~x23;
  assign new_n78_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n79_ = x24 & (~x16 | ~x25);
  assign z16 = x16 ? (new_n81_ | (x24 & x26)) : ~new_n84_;
  assign new_n81_ = x18 & ((x26 & (~new_n64_ | ~new_n82_)) | (new_n65_ & new_n83_));
  assign new_n82_ = ~x23 & ~x25 & ~x21 & ~x22;
  assign new_n83_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n84_ = (~x07 | ~x18) & (~x15 | x18 | ~x24);
