...
module FAU ( 
  ...
  assign z14 = x16 ? ((~new_n70_ & x18) | (x22 & x24)) : ~new_n73_;
  assign new_n70_ = (new_n71_ | ~x24) & (~new_n67_ | ~new_n72_);
  assign new_n71_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23;
  assign new_n72_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n73_ = (~x05 | ~x18) & (~x13 | x18 | ~x22);
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~new_n75_ & x16) | (~new_n77_ & ~x18);
  assign new_n75_ = (~x25 | (new_n67_ & new_n72_)) & (~new_n68_ | ~new_n76_ | x24 | x25);
  assign new_n76_ = ~x22 & ~x23;
  assign new_n77_ = x22 & (~x16 | ~x25);
  assign z16 = x16 ? (new_n79_ | (x22 & x26)) : ~new_n82_;
  assign new_n79_ = x18 & ((new_n68_ & new_n81_) | (x26 & (~new_n67_ | ~new_n80_)));
