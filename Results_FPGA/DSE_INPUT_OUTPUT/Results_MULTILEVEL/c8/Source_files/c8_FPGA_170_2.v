// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:52 2020
...
module FAU ( 
  ...
  assign z08 = x18 | x27;
  assign z09 = (~new_n58_ & x16) | (~x16 & (x18 ? x00 : x08)) | (x18 & ~x27);
  ...
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~new_n66_ & x16) | (x18 & ~x27);
  assign new_n66_ = (~x22 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? (~new_n68_ & (~x18 | x27)) : ((x12 & ~x18) | (x04 & x18 & x27));
  ...
  assign z16 = x16 ? (~new_n76_ & (~x18 | x27)) : ((x15 & ~x18) | (x07 & x18 & x27));
  ...
  assign new_n79_ = ~x24 & ~x25 & ~x26 & ((~x17 & ~x18) | x27);
endmodule
