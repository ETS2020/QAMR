...
module FAU ( 
  ...
  assign z13 = x16 ? (~new_n69_ & (~x06 | ~x18)) : ((x04 & ~x06 & x18) | (x12 & ~x18));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n71_ & (~x06 | ~x18)) : ((x05 & ~x06 & x18) | (x13 & ~x18));
  assign new_n71_ = (~x24 | (new_n64_ & ~x21 & ~x22 & ~x23)) & (~new_n64_ | x21 | x22 | x23 | x24);
  assign z15 = ((new_n73_ | new_n74_) & x16) | (x06 & x18) | (x14 & ~x16 & ~x18);
  assign new_n73_ = x25 & (~new_n64_ | x21 | x22 | x23 | x24);
  assign new_n74_ = new_n65_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (x06 & x18) | (~new_n76_ & x16);
  assign new_n76_ = (~x26 | (new_n65_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n65_ | x22 | x23 | x24 | x25 | x26);
