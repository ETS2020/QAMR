// Benchmark "FAU" written by ABC on Mon Aug 17 20:03:06 2020
...
module FAU ( 
  ...
  assign z00 = (~x08 & (x18 | x27)) | (~x19 & ~x27);
  ...
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n76_ & x16) | (~x08 & x18);
