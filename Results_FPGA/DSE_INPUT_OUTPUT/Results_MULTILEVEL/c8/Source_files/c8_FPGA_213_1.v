...
module FAU ( 
  ...
  assign z05 = (~x24 & ~x27) | (~x13 & (~x24 | (x23 & x27)));
  ...
  assign z14 = x16 ? ((new_n63_ & new_n70_ & ~x23 & ~x24) | (x23 & x24)) : (~new_n72_ & (x23 | ~x24));
  assign new_n72_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ((x23 & x25) | (~new_n74_ & ~x24)) : (~new_n75_ & (x23 | ~x24));
  ...
  assign new_n77_ = (~x23 | ~x26) & (x24 | ((new_n78_ | ~x26) & (~new_n65_ | ~new_n79_)));
