...
module FAU ( 
  ...
  assign z13 = (~new_n69_ & ~x16) | (x22 & (x16 | ~x23)) | (~new_n70_ & x16);
  ...
  assign new_n72_ = (x22 | ((new_n65_ | ~x24) & (~new_n64_ | x21 | x23 | x24))) & (~x23 | ~x24);
  assign z15 = (~new_n75_ & ~x16) | (x22 & (~x23 | (x16 & x25))) | (~new_n74_ & x16);
  assign new_n74_ = (~x25 | (new_n64_ & ~x21 & ~x23 & ~x24)) & (~new_n64_ | x24 | x25 | x21 | x23);
  assign new_n75_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((x23 & x26) | (~new_n77_ & ~x22)) : (~new_n79_ & (~x22 | x23));
  assign new_n77_ = (new_n78_ | ~x26) & (~new_n65_ | x23 | x24 | x25 | x26);
