...
module FAU ( 
  ...
  assign z09 = x16 ? (x17 ? x19 : (x18 & ~x19)) : ((x00 & x18) | (x08 & ~x18 & x19));
  assign z10 = x16 ? ~new_n59_ : ((x01 & x18) | (x09 & ~x18 & x19));
  assign new_n59_ = (~x19 | ~x20) & (~x18 | (x17 ? ~x20 : (x19 | x20)));
  ...
  assign z13 = x16 ? ((~new_n67_ & x18) | (x19 & x23)) : ~new_n66_;
  assign new_n66_ = (~x04 | ~x18) & (~x12 | x18 | ~x19);
  assign new_n67_ = (~x23 | (~x21 & ~x22 & ~x17 & ~x20)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? ~new_n69_ : ((x05 & x18) | (x13 & ~x18 & x19));
  ...
  assign z15 = x16 ? ((~new_n74_ & x18) | (x19 & x25)) : ~new_n77_;
  ...
  assign new_n77_ = (~x06 | ~x18) & (~x14 | x18 | ~x19);
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n79_ & x16) | (~new_n80_ & ~x18);
  assign new_n79_ = (~x26 | (new_n75_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n75_ | x22 | x23 | x24 | x25 | x26);
  assign new_n80_ = x19 & (~x16 | ~x26);
  assign z17 = x16 & (new_n82_ | (x17 & (x18 | x19) & x27));
