// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:30 2020
...
module FAU ( 
  ...
  assign z09 = (x08 & (~x16 | x18)) | (x16 & (~x17 ^ x19)) | (x00 & ~x16 & x18);
  assign z10 = x16 ? (~new_n59_ & (~x08 | ~x18)) : ((x01 & ~x08 & x18) | (x09 & ~x18));
  assign new_n59_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = (~x16 & (x18 ? x02 : x10)) | (x08 & x18) | (~new_n61_ & x16);
  ...
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (x08 & x18) | (~new_n67_ & x16);
