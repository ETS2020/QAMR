...
module FAU ( 
  ...
  assign z11 = x16 ? (~new_n63_ & (~x18 | ~x25)) : ((x10 & ~x18) | (x02 & x18 & ~x25));
  ...
  assign z13 = x16 ? (~new_n69_ & (~x18 | ~x25)) : ((x12 & ~x18) | (x04 & x18 & ~x25));
  ...
  assign new_n75_ = (~x14 | x18) & (~x06 | ~x18 | x25);
  ...
  assign new_n82_ = new_n78_ & ~x20 & ~x21 & ~x17 & x19;
endmodule
