// Benchmark "FAU" written by ABC on Mon Aug 17 20:03:02 2020
...
module FAU ( 
  ...
  assign z09 = x16 ? (~new_n59_ & (~x13 | ~x18)) : ((x00 & ~x13 & x18) | (x08 & ~x18));
  assign new_n59_ = x17 ^ x19;
  assign z10 = x16 ? (~new_n61_ & (~x13 | ~x18)) : ((x01 & ~x13 & x18) | (x09 & ~x18));
  assign new_n61_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n63_ & (~x13 | ~x18)) : ((x02 & ~x13 & x18) | (x10 & ~x18));
  assign new_n63_ = ~new_n65_ & (new_n64_ | ~x21);
  assign new_n64_ = ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (x13 & x18) | (~new_n67_ & x16);
  assign new_n67_ = (x17 | x19 | x20 | x21 | new_n49_ | x22) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z13 = x16 ? (~new_n69_ & (~x13 | ~x18)) : ((x04 & ~x13 & x18) | (x12 & ~x18));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (x13 & (~x16 | x18)) | (~new_n71_ & x16) | (x05 & ~x16 & x18);
  ...
  assign z16 = x16 ? (~new_n77_ & (~x13 | ~x18)) : ((x07 & ~x13 & x18) | (x15 & ~x18));
