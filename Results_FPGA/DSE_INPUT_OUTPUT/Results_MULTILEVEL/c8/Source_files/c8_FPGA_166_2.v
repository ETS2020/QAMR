// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:50 2020
...
module FAU ( 
  ...
  assign z07 = (~x18 & (x15 | x27)) | (~x15 & x27) | (~x26 & ~x27);
  assign z08 = x27 & (~x15 | x18);
  assign z09 = (~new_n58_ & x16) | (x15 & ~x18) | (~x16 & (x18 ? x00 : x08));
  assign new_n58_ = x17 ^ x19;
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~new_n60_ & x16) | (x15 & ~x18);
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = (~x16 & (x18 ? x02 : x10)) | (~new_n62_ & x16) | (x15 & ~x18);
  ...
  assign z16 = (~new_n76_ & x16) | (x15 & ~x18) | (x07 & ~x16 & x18);
