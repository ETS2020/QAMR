...
module FAU ( 
  ...
  assign z13 = (~new_n66_ & ~x16) | (~new_n67_ & x16) | (x19 & (~x18 | (x16 & x23)));
  ...
  assign new_n70_ = (x17 | x20 | x21 | x22 | x23 | x24) & (~x24 | (~x17 & ~x20 & ~x21 & ~x22 & ~x23));
  ...
  assign new_n81_ = new_n77_ & ~x24 & ~x25 & ~x26;
