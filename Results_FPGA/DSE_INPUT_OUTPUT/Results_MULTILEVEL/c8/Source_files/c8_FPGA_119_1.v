...
module FAU ( 
  ...
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x14 & x18) | (~new_n61_ & x16);
  assign new_n61_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n63_ & (x14 | ~x18)) : ((x10 & ~x18) | (x02 & x14 & x18));
  ...
  assign z13 = x16 ? (~new_n69_ & (x14 | ~x18)) : ((x12 & ~x18) | (x04 & x14 & x18));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~x14 & x18) | (~new_n71_ & x16);
