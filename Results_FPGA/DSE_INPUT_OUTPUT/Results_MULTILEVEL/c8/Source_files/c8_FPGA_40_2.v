...
module FAU ( 
  ...
  assign z14 = x16 ? ~new_n72_ : ((x13 & ~x18) | (x05 & x18 & x23));
  assign new_n72_ = (~x23 | ~x24) & (x18 | ((new_n67_ | ~x24) & (~new_n63_ | ~new_n73_ | x23 | x24)));
  ...
  assign new_n76_ = new_n64_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n77_ = x18 ? ~x06 : ~x14;
  assign new_n78_ = x18 & (~x23 | (x16 & x25));
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n80_ & x16) | (~new_n81_ & x18);
  assign new_n80_ = (~x26 | (new_n64_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n64_ | x22 | x23 | x24 | x25 | x26);
