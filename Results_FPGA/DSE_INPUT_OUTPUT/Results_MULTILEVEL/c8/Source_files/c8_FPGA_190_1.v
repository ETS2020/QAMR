// Benchmark "FAU" written by ABC on Mon Aug 17 20:03:00 2020
...
module FAU ( 
  ...
  assign z09 = x16 ? (~x17 ^ x19) : (x08 | x18);
  assign z10 = (x16 & (((x17 | x19) & x20) | (~x17 & ~x19 & ~x20))) | (x09 & ~x16 & ~x18);
  assign z11 = (x16 & (new_n61_ | (~new_n60_ & x21))) | (x10 & ~x16 & ~x18);
  assign new_n60_ = ~x17 & ~x19 & ~x20;
  assign new_n61_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z12 = (~new_n63_ & x16) | (x11 & ~x16 & ~x18);
  ...
  assign z14 = (~new_n67_ & x16) | (x13 & ~x16 & ~x18);
  assign new_n67_ = (~x24 | (new_n60_ & ~x21 & ~x22 & ~x23)) & (~new_n60_ | x23 | x24 | x21 | x22);
  assign z15 = (x14 & ~x16 & ~x18) | (x16 & (new_n69_ | new_n70_));
