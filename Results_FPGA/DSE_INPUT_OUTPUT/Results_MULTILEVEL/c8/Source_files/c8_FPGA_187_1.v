...
module FAU ( 
  ...
  assign z10 = x16 ? (~new_n61_ & (x18 | ~x27)) : ((x01 & x18) | (x09 & ~x18 & ~x27));
  ...
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~x18 & x27) | (~new_n67_ & x16);
  assign new_n67_ = (x17 | x19 | x20 | x21 | new_n59_ | x22) & (~x22 | (~x20 & ~x21 & ~x17 & ~x19));
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~x18 & x27) | (~new_n69_ & x16);
  ...
  assign z17 = x16 & (x17 ? z08 : new_n79_);
  assign new_n79_ = x19 & ~x20 & ~x21 & new_n80_ & ~x22;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & (x18 | ~x27);
endmodule
