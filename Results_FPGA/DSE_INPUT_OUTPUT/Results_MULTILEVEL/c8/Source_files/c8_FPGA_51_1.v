...
module FAU ( 
  ...
  assign new_n66_ = (x22 | ((~x23 | (new_n67_ & ~x20 & ~x21)) & (~new_n67_ | x20 | x21 | x23))) & (~x18 | ~x22 | ~x23);
  assign new_n67_ = ~x17 & ~x19;
  assign z14 = x16 ? ((~new_n70_ & ~x22) | (x18 & x22 & x24)) : ~new_n69_;
  assign new_n69_ = (~x05 | ~x18) & (~x13 | x18 | x22);
  assign new_n70_ = (~x24 | (~x17 & ~x19 & ~x20 & ~x21 & ~x23)) & (x17 | x19 | x20 | x21 | x23 | x24);
  assign z15 = (~new_n75_ & ~x16) | (x22 & (~x18 | (x16 & x25))) | (~new_n72_ & x16);
  assign new_n72_ = (new_n74_ | ~x25) & (~new_n73_ | x22 | x23 | x24 | x25);
  assign new_n73_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n74_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n75_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((x18 & x22 & x26) | (~new_n77_ & ~x22)) : ~new_n81_;
  assign new_n77_ = (~x26 | (new_n78_ & new_n79_)) & (~new_n73_ | ~new_n80_);
