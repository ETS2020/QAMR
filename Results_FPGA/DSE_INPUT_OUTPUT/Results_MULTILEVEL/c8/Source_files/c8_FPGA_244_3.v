...
module FAU ( 
  ...
  assign z02 = (~x10 & (~x21 | x27)) | (~x21 & ~x27) | (x10 & x18);
  ...
  assign z10 = x16 ? (~new_n61_ & (~x10 | ~x18)) : ((x01 & ~x10 & x18) | (x09 & ~x18));
  ...
  assign z13 = x16 ? (~new_n69_ & (~x10 | ~x18)) : ((x12 & ~x18) | (x04 & ~x10 & x18));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n71_ & (~x10 | ~x18)) : ((x13 & ~x18) | (x05 & ~x10 & x18));
