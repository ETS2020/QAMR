...
module FAU ( 
  ...
  assign z14 = x16 ? ~new_n69_ : ((x05 & x18) | (x13 & ~x18 & x22));
  assign new_n69_ = (~x18 | ((~new_n70_ | ~new_n72_) & (new_n71_ | ~x24))) & (~x22 | ~x24);
  ...
  assign new_n74_ = (~x18 | ((~new_n75_ | ~new_n77_) & (new_n76_ | ~x25))) & (~x22 | ~x25);
  ...
  assign new_n79_ = (~new_n75_ | ~new_n80_) & (~x26 | (new_n75_ & new_n77_));
  assign new_n80_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n81_ = x22 & (~x16 | ~x26);
  assign z17 = (~x18 & ~x22) | (~new_n83_ & x16);
