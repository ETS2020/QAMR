...
module FAU ( 
  ...
  assign z09 = x16 ? (~new_n59_ & (x07 | x18)) : ((x00 & x18) | (x07 & x08 & ~x18));
  assign new_n59_ = ~x17 ^ ~x19;
  assign z10 = x16 ? (~new_n61_ & (x07 | x18)) : ((x01 & x18) | (x07 & x09 & ~x18));
  ...
  assign new_n75_ = (~x06 | ~x18) & (~x07 | ~x14 | x18);
  assign z16 = (x07 & (x16 ? ~new_n77_ : (x15 | x18))) | (x16 & ~new_n77_ & x18);
