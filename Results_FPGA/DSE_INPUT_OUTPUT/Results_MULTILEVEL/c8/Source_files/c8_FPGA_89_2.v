...
module FAU ( 
  ...
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~new_n65_ & x16) | (x18 & ~x25);
  assign new_n65_ = (x17 | x19 | x20 | x21 | new_n49_ | x22) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n67_ & x16) | (x18 & ~x25);
  assign new_n67_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n69_ & x16) | (x18 & ~x25);
  assign new_n69_ = (~x24 | (new_n70_ & ~x17 & ~x21 & ~x22 & ~x23)) & (~new_n70_ | x17 | x21 | x22 | x23 | x24);
  assign new_n70_ = ~x19 & ~x20;
  assign z15 = ~new_n72_ | (~x16 & (x18 ? x06 : x14));
  assign new_n72_ = (x25 | (~x18 & (~new_n73_ | ~new_n70_ | ~x16 | x17))) & (~x16 | ~x25 | (new_n73_ & new_n70_ & ~x17));
  assign new_n73_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n77_ & x18) | (~new_n75_ & x16);
  assign new_n75_ = (~x26 | (new_n76_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n76_ | x22 | x23 | x24 | x25 | x26);
  assign new_n76_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n77_ = x25 & (~x16 | ~x26);
  assign z17 = x16 & ((z08 & x17) | (new_n79_ & new_n80_ & ~x17 & ~x18));
