...
module FAU ( 
  ...
  assign z01 = (~x20 & ~x27) | (~x12 & x18) | (~x09 & x27);
  ...
  assign z12 = x16 ? (~new_n66_ & (x12 | ~x18)) : ((x11 & ~x18) | (x03 & x12 & x18));
  ...
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n70_ & x16) | (~x12 & x18);
  ...
  assign z16 = x16 ? (~new_n76_ & (x12 | ~x18)) : ((x15 & ~x18) | (x07 & x12 & x18));
