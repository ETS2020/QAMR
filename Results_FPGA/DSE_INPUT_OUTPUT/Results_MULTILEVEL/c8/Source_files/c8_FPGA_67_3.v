...
module FAU ( 
  ...
  assign new_n64_ = (~x22 | (~x19 & ~x20 & ~x21)) & (x20 | x21 | x22 | x17 | x19);
  assign z13 = (~new_n68_ & ~x16) | (x17 & (x18 | (x16 & x23))) | (~new_n66_ & x16);
  assign new_n66_ = (~x23 | (new_n67_ & ~x21 & ~x22)) & (x21 | x22 | x23 | ~new_n67_ | x17);
  assign new_n67_ = ~x19 & ~x20;
  assign new_n68_ = x18 ? ~x04 : ~x12;
  assign z14 = (~new_n71_ & ~x16) | (x17 & (x18 | (x16 & x24))) | (~new_n70_ & x16);
  assign new_n70_ = (~x24 | (new_n67_ & ~x21 & ~x22 & ~x23)) & (~new_n67_ | x17 | x21 | x22 | x23 | x24);
  assign new_n71_ = x18 ? ~x05 : ~x13;
  assign z15 = (~new_n76_ & ~x16) | (x17 & (x18 | (x16 & x25))) | (~new_n73_ & x16);
  ...
  assign z16 = (~new_n80_ & ~x16) | (x17 & (x18 | (x16 & x26))) | (~new_n78_ & x16);
  assign new_n78_ = (~x26 | (new_n74_ & new_n79_ & ~x24 & ~x25)) & (~new_n75_ | ~new_n79_ | x24 | x25 | x26);
  assign new_n79_ = ~x22 & ~x23;
  assign new_n80_ = (~x15 | (~x17 & x18)) & (~x07 | ~x18);
  assign z17 = x16 & (new_n82_ | (x17 & ~x18 & x27));
