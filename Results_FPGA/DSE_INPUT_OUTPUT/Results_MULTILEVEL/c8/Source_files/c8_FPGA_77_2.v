...
module FAU ( 
  ...
  assign z03 = (~x11 & (x22 ? x27 : ~x20)) | (~x20 & ~x22 & ~x27);
  ...
  assign z09 = ((~x20 | x22) & (x16 ? (~x17 & ~x19) : ~new_n59_)) | (x16 & x17 & x19 & (~x20 | (x20 & x22)));
  ...
  assign new_n65_ = (~x20 | (~x16 & x22)) & (~x16 | ((~x22 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x20 | x21 | x22)));
  assign z13 = x16 ? ~new_n67_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n67_ = (~x22 | ~x23) & (x20 | ((~x23 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x21 | x22 | x23)));
  assign z14 = x16 ? ((~new_n70_ & ~x20) | (x22 & x24)) : (~new_n69_ & (~x20 | x22));
  assign new_n69_ = x18 ? ~x05 : ~x13;
  assign new_n70_ = (~x24 | (~x17 & ~x19 & ~x21 & ~x23)) & (x22 | x23 | x24 | x17 | x19 | x21);
  assign z15 = x16 ? ((x22 & x25) | (~new_n72_ & ~x20)) : (~new_n75_ & (~x20 | x22));
  assign new_n72_ = (new_n74_ | ~x25) & (~new_n73_ | x22 | x23 | x24 | x25);
  assign new_n73_ = ~x17 & ~x19 & ~x21;
  assign new_n74_ = ~x17 & ~x19 & ~x21 & ~x23 & ~x24;
  assign new_n75_ = x18 ? ~x06 : ~x14;
  assign z16 = (~new_n80_ & ~x16) | new_n81_ | (x16 & (new_n78_ | (~new_n77_ & x26)));
  assign new_n77_ = new_n73_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n78_ = new_n79_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n79_ = ~x25 & ~x26 & ~x23 & ~x24;
  assign new_n80_ = x18 ? ~x07 : ~x15;
  assign new_n81_ = x20 & (~x22 | (x16 & x26));
