// Benchmark "FAU" written by ABC on Mon Aug 17 20:03:10 2020
...
module FAU ( 
  ...
  assign new_n61_ = (x17 | (~x18 & (x20 | x21 | ~x16 | x19))) & (~x16 | ~x21 | (~x19 & ~x20 & ~x17 & ~x18));
  ...
  assign z14 = (~x16 & (x18 ? x05 : x13)) | new_n68_ | (new_n70_ & x16);
  assign new_n68_ = ~x17 & (x18 | (new_n69_ & new_n66_ & x16));
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n70_ = x24 & (~new_n72_ | ~new_n71_ | x22 | x23);
  assign new_n71_ = ~x20 & ~x21;
  assign new_n72_ = ~x17 & ~x18 & ~x19;
  assign z15 = x16 ? ((x17 & x25) | (~new_n74_ & ~x18)) : ~new_n77_;
  assign new_n74_ = (new_n75_ | ~x25) & (~new_n76_ | x24 | x25 | x22 | x23);
  ...
  assign new_n79_ = ~x17 & (x18 | (new_n80_ & new_n71_ & x16 & ~x19));
  assign new_n80_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n81_ = x26 & (~new_n82_ | ~new_n66_ | x17 | x18);
  assign new_n82_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z17 = (~new_n84_ & x16) | (~x17 & x18);
  assign new_n84_ = (~new_n80_ | ~new_n71_ | x17 | ~x19) & (~x17 | ~x27);
endmodule
