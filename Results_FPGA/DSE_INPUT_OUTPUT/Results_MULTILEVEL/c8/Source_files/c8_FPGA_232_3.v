...
module FAU ( 
  ...
  assign z06 = (~x14 & (~x25 | x27)) | (x18 & x25) | (~x25 & ~x27);
  ...
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (x18 & x25) | (~new_n60_ & x16);
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = (~x16 & (x18 ? x02 : x10)) | (x18 & x25) | (~new_n62_ & x16);
  assign new_n62_ = ~new_n64_ & (new_n63_ | ~x21);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (x18 & x25) | (~new_n66_ & x16);
  ...
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (x18 & x25) | (~new_n70_ & x16);
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z15 = (~new_n76_ & ~x16) | (x18 & x25) | (x16 & (new_n74_ | (~new_n72_ & x25)));
