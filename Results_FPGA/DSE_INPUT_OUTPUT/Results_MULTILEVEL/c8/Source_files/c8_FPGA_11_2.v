...
module FAU ( 
  ...
  assign z10 = x16 ? (~new_n60_ & (~x00 | x18)) : ((x01 & x18) | (~x00 & x09 & ~x18));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n62_ & (~x00 | x18)) : ((x02 & x18) | (~x00 & x10 & ~x18));
  ...
  assign z14 = x16 ? (~new_n70_ & (~x00 | x18)) : ((x05 & x18) | (~x00 & x13 & ~x18));
