// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:46 2020
...
module FAU ( 
  ...
  assign z03 = (~x22 & ~x27) | (x12 & x18) | (~x11 & x27);
  assign z04 = (~x12 & (~x23 | x27)) | (~x18 & ~x23 & ~x27);
  ...
  assign z09 = x16 ? (~new_n58_ & (~x12 | ~x18)) : ((x00 & ~x12 & x18) | (x08 & ~x18));
  assign new_n58_ = x17 ^ x19;
  assign z10 = x16 ? (~new_n60_ & (~x12 | ~x18)) : ((x01 & ~x12 & x18) | (x09 & ~x18));
