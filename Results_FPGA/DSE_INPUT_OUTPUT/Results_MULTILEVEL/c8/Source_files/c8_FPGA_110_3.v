// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:27 2020
...
module FAU ( 
  ...
  assign z03 = (~x11 & (~x22 | x27)) | (x18 & x22) | (~x22 & ~x27);
  ...
  assign z11 = x16 ? ~new_n62_ : ((x10 & ~x18) | (x02 & x18 & ~x22));
  assign new_n62_ = (~x21 | (~x17 & ~x19 & ~x20) | (x22 & (x18 | ~x22))) & (x17 | x19 | x20 | x21 | (x18 & x22));
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~new_n64_ & x16) | (x18 & x22);
  assign new_n64_ = (~x22 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = (~new_n69_ & ~x16) | (x22 & (x18 | (x16 & x23))) | (~new_n66_ & x16);
  assign new_n66_ = (new_n68_ | ~x23) & (~new_n67_ | x21 | x22 | x23);
  assign new_n67_ = ~x17 & ~x19 & ~x20;
  assign new_n68_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n69_ = x18 ? ~x04 : ~x12;
  assign z14 = (~new_n73_ & ~x16) | (x22 & (x18 | (x16 & x24))) | (~new_n71_ & x16);
  assign new_n71_ = (new_n72_ | ~x24) & (~new_n67_ | x21 | x22 | x23 | x24);
  assign new_n72_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23;
  assign new_n73_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ((~new_n75_ & ~x22) | (~x18 & x22 & x25)) : ~new_n76_;
  assign new_n75_ = (~x25 | (new_n67_ & ~x21 & ~x23 & ~x24)) & (~new_n67_ | x24 | x25 | x21 | x23);
  assign new_n76_ = (~x14 | x18) & (~x06 | ~x18 | x22);
  assign z16 = x16 ? ((~new_n78_ & ~x22) | (~x18 & x22 & x26)) : ~new_n81_;
  assign new_n78_ = (~x26 | (new_n67_ & new_n80_)) & (~new_n68_ | ~new_n79_ | x25 | x26);
