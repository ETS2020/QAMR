// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:25 2020
...
module FAU ( 
  ...
  assign new_n68_ = (x22 | (~new_n69_ & (new_n64_ | ~x23))) & (~x18 | ~x22 | ~x23);
  assign new_n69_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23;
  assign z14 = (~new_n72_ & ~x16) | (~new_n71_ & x16) | (x22 & (~x18 | (x16 & x24)));
  assign new_n71_ = (new_n69_ | ~x24) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign new_n72_ = x18 ? ~x05 : ~x13;
  assign z15 = (~new_n76_ & ~x16) | (~new_n74_ & x16) | (x22 & (~x18 | (x16 & x25)));
  ...
  assign z17 = (~new_n83_ & x16) | (~x18 & x22);
