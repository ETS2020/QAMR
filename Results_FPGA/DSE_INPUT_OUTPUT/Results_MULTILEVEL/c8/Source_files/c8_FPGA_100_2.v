// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:22 2020
...
module FAU ( 
  ...
  assign z02 = (~x21 & ~x27) | (x18 & ~x22) | (~x10 & x27);
  ...
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n68_ & x18) | (~new_n69_ & x16);
  assign new_n68_ = x22 & (~x16 | ~x23);
  assign new_n69_ = (x17 | x19 | x20 | x21 | x22 | x23) & (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22));
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n71_ & x16) | (~new_n72_ & x18);
  assign new_n71_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign new_n72_ = x22 & (~x16 | ~x24);
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~new_n74_ & x16) | (~new_n77_ & x18);
  ...
  assign new_n82_ = (~x15 | x18) & (~x07 | ~x18 | ~x22);
