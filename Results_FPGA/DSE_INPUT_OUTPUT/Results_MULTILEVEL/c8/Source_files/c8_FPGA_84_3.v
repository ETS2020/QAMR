...
module FAU ( 
  ...
  assign z00 = (~x08 & (~x19 | x27)) | (x08 & x20) | (~x19 & ~x27);
  assign z01 = (~x09 & (~x20 | (~x08 & x27))) | (~x20 & ~x27);
  ...
  assign z09 = x16 ? ~new_n59_ : ((x00 & (x08 ? ~x20 : x18)) | (x08 & ~x18 & ~x20));
  ...
  assign new_n79_ = (~x26 | (new_n76_ & new_n82_)) & (~new_n80_ | ~new_n81_ | x25 | x26);
