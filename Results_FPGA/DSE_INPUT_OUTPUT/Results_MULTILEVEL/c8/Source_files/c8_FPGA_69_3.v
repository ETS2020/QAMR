...
module FAU ( 
  ...
  assign z13 = x16 ? (~new_n69_ & (~x15 | ~x18)) : ((x04 & ~x15 & x18) | (x12 & ~x18));
  ...
  assign z16 = x16 ? (~new_n77_ & (~x15 | ~x18)) : ((x07 & ~x15 & x18) | (x15 & ~x18));
