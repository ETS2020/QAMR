// Benchmark "FAU" written by ABC on Mon Aug 17 20:01:56 2020
...
module FAU ( 
  ...
  assign z03 = (~x22 & ~x27) | (x11 & ~x18) | (~x11 & x27);
  ...
  assign z16 = x16 ? (~new_n77_ & (~x11 | x18)) : ((x07 & x18) | (~x11 & x15 & ~x18));
