...
module FAU ( 
  ...
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~new_n67_ & x16) | (~x18 & ~x25);
  assign new_n67_ = (x17 | x19 | x20 | x21 | new_n49_ | x22) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z13 = x16 ? (~new_n69_ & (x18 | x25)) : ((x04 & x18) | (x12 & ~x18 & x25));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n71_ & x16) | (~x18 & ~x25);
  assign new_n71_ = (~x24 | (new_n64_ & ~x21 & ~x22 & ~x23)) & (~new_n64_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? ~new_n73_ : ((x06 & x18) | (x14 & ~x18 & x25));
  assign new_n73_ = (~x25 | (new_n64_ & new_n74_ & ~x23 & ~x24)) & (~new_n75_ | ~new_n74_ | x23 | x24 | x25);
  assign new_n74_ = ~x21 & ~x22;
  assign new_n75_ = ~x19 & ~x20 & ~x17 & x18;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n78_ & ~x18) | (~new_n77_ & x16);
  assign new_n77_ = (~x26 | (new_n65_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n65_ | x22 | x23 | x24 | x25 | x26);
  assign new_n78_ = x25 & (~x16 | ~x26);
  assign z17 = x16 & (new_n80_ | (x17 & ~new_n49_ & x27));
