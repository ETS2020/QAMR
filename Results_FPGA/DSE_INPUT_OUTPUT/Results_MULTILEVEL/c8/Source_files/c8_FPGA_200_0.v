// Benchmark "FAU" written by ABC on Mon Aug 17 20:03:04 2020
...
module FAU ( 
  ...
  assign z12 = ~new_n66_ | (~x16 & (x18 ? x03 : x11));
  assign new_n66_ = (x18 | (x22 & (~x16 | ~x21))) & (~x16 | ((~x22 | (new_n67_ & ~x20 & ~x21)) & (~new_n67_ | x20 | x21 | x22)));
  assign new_n67_ = ~x17 & ~x19;
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n69_ & ~x18) | (~new_n70_ & x16);
  assign new_n69_ = x22 & (~x16 | ~x23);
  ...
  assign new_n73_ = x22 & (~x16 | ~x24);
  assign z15 = x16 ? ~new_n75_ : ((x06 & x18) | (x14 & ~x18 & x22));
  assign new_n75_ = (~x18 | ((~new_n64_ | ~new_n77_) & (new_n76_ | ~x25))) & (~x22 | ~x25);
  assign new_n76_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? (new_n79_ | (x22 & x26)) : ~new_n82_;
  assign new_n79_ = x18 & ((new_n64_ & new_n81_) | (x26 & (~new_n63_ | ~new_n80_)));
