...
module FAU ( 
  ...
  assign z13 = (~new_n66_ & ~x16) | (x19 & (x18 | (x16 & x23))) | (~new_n67_ & x16);
  ...
  assign z15 = (~new_n75_ & ~x16) | (x19 & (x18 | (x16 & x25))) | (~new_n72_ & x16);
  ...
  assign z16 = x16 ? ((~x18 & x19 & x26) | (~new_n77_ & ~x19)) : ~new_n81_;
  assign new_n77_ = (~x26 | (new_n73_ & new_n80_)) & (~new_n78_ | ~new_n79_ | x25 | x26);
