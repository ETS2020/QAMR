...
module FAU ( 
  ...
  assign z13 = x16 ? ((~new_n66_ & x18) | (x19 & x23)) : ~new_n65_;
  assign new_n65_ = (~x04 | ~x18) & (~x12 | x18 | ~x19);
  ...
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~new_n72_ & x16) | (~new_n76_ & ~x18);
  assign new_n72_ = (~x25 | (new_n69_ & new_n75_)) & (~new_n73_ | ~new_n74_ | x24 | x25);
  assign new_n73_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n74_ = ~x22 & ~x23;
  assign new_n75_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n76_ = x19 & (~x16 | ~x25);
  assign z16 = x16 ? ((~new_n78_ & x18) | (x19 & x26)) : ~new_n80_;
  assign new_n78_ = (~x26 | (new_n79_ & new_n74_ & ~x24 & ~x25)) & (~new_n73_ | ~new_n74_ | x24 | x25 | x26);
