...
module FAU ( 
  ...
  assign z13 = x16 ? (~new_n69_ & (~x18 | ~x24)) : ((x12 & ~x18) | (x04 & x18 & ~x24));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (x18 & x24) | (~new_n71_ & x16);
  assign new_n71_ = (~x24 | (new_n64_ & ~x21 & ~x22 & ~x23)) & (~new_n64_ | x21 | x22 | x23 | x24);
  assign z15 = (~new_n76_ & ~x16) | (~new_n73_ & x16) | (x24 & (x18 | (x16 & x25)));
  assign new_n73_ = (new_n75_ | ~x25) & (~new_n65_ | ~new_n74_ | x24 | x25);
  assign new_n74_ = ~x22 & ~x23;
  assign new_n75_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n76_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((~new_n78_ & ~x24) | (~x18 & x24 & x26)) : ~new_n80_;
  assign new_n78_ = (~x26 | (new_n64_ & new_n79_)) & (~new_n65_ | ~new_n74_ | x25 | x26);
  assign new_n79_ = ~x23 & ~x25 & ~x21 & ~x22;
  assign new_n80_ = (~x15 | x18) & (~x07 | ~x18 | x24);
  assign z17 = new_n49_ | (~new_n82_ & x16);
