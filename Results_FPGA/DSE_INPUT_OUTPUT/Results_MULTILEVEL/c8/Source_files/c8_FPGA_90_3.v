...
module FAU ( 
  ...
  assign z01 = (~x02 | ~x18) & (x27 ? ~x09 : ~x20);
  assign z02 = (~x02 | ~x18) & (x27 ? ~x10 : ~x21);
  assign z03 = (~x02 | ~x18) & (x27 ? ~x11 : ~x22);
  assign z04 = (~x23 & ~x27) | (~x12 & x27) | (x02 & x18);
  assign z05 = (~x24 & ~x27) | (~x13 & x27) | (x02 & x18);
  assign z06 = (~x02 | ~x18) & (x27 ? ~x14 : ~x25);
  ...
  assign z16 = x16 ? (~new_n76_ & (~x02 | ~x18)) : ((x15 & ~x18) | (~x02 & x07 & x18));
