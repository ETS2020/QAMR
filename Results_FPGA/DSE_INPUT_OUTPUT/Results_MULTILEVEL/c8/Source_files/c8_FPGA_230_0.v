...
module FAU ( 
  ...
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~new_n61_ & x16) | (~x18 & ~x27);
  assign new_n61_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n63_ & (x18 | x27)) : ((x02 & x18) | (x10 & ~x18 & x27));
  assign new_n63_ = ~new_n65_ & (new_n64_ | ~x21);
  assign new_n64_ = ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~new_n67_ & x16) | (~x18 & ~x27);
  assign new_n67_ = (x17 | x19 | x20 | x21 | new_n59_ | x22) & (~x22 | (~x20 & ~x21 & ~x17 & ~x19));
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n69_ & x16) | (~x18 & ~x27);
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n71_ & x16) | (~x18 & ~x27);
  ...
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n77_ & x16) | (~x18 & ~x27);
  assign new_n77_ = (~x26 | (new_n65_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n65_ | x22 | x23 | x24 | x25 | x26);
  assign z17 = new_n59_ | (~new_n79_ & x16);
