// Benchmark "FAU" written by ABC on Mon Aug 17 20:03:01 2020
...
module FAU ( 
  ...
  assign z00 = (~x08 & (~x19 | x27)) | (~x18 & x19) | (~x19 & ~x27);
  ...
  assign z15 = (~new_n76_ & ~x16) | (x19 & (~x18 | (x16 & x25))) | (~new_n74_ & x16);
  assign new_n74_ = (~x25 | (new_n64_ & ~x22 & ~x23 & ~x24)) & (~new_n75_ | x22 | x23 | x24 | x25);
  assign new_n75_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n76_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((x18 & x19 & x26) | (~new_n78_ & ~x19)) : ~new_n81_;
  assign new_n78_ = (~x26 | (new_n64_ & new_n80_)) & (~new_n65_ | ~new_n79_ | x25 | x26);
  assign new_n79_ = ~x23 & ~x24;
  assign new_n80_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n81_ = (~x07 | ~x18) & (~x15 | x18 | x19);
  assign z17 = (~new_n83_ & x16) | (~x18 & x19);
