...
module FAU ( 
  ...
  assign z12 = (~new_n63_ & ~x16) | (~new_n64_ & ~x17) | (new_n65_ & x16);
  assign new_n63_ = x18 ? ~x03 : ~x11;
  assign new_n64_ = ~x18 & (~x16 | x19 | x20 | x21 | x22);
  assign new_n65_ = x22 & (x17 | x18 | x19 | x20 | x21);
  ...
  assign new_n75_ = ~x17 & (x18 | (new_n76_ & new_n77_));
  assign new_n76_ = x16 & ~x19 & ~x20 & ~x21;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n78_ = x25 & (~new_n79_ | x23 | x24 | x21 | x22);
  assign new_n79_ = ~x17 & ~x18 & ~x19 & ~x20;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | new_n81_ | (new_n83_ & x16);
  assign new_n81_ = ~x17 & (x18 | (new_n76_ & new_n82_));
  assign new_n82_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n83_ = x26 & (~new_n79_ | ~new_n84_);
