...
module FAU ( 
  ...
  assign new_n75_ = (~x03 | ~x06 | ~x18) & (~x14 | x18);
  assign z16 = x16 ? (~new_n77_ & (x03 | ~x18)) : ((x15 & ~x18) | (x03 & x07 & x18));
