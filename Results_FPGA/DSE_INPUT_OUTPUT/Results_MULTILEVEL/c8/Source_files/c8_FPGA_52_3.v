...
module FAU ( 
  ...
  assign z12 = x16 ? ~new_n64_ : ((x11 & ~x18) | (x03 & x18 & ~x22));
  assign new_n64_ = (x18 | ~x22 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  ...
  assign z15 = (~new_n77_ & ~x16) | (x22 & (x18 | (x16 & x25))) | (~new_n75_ & x16);
  assign new_n75_ = (new_n76_ | ~x25) & (~new_n68_ | x22 | x23 | x24 | x25);
  assign new_n76_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n77_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((~new_n79_ & ~x22) | (~x18 & x22 & x26)) : ~new_n82_;
  assign new_n79_ = (~new_n68_ | ~new_n81_) & (~x26 | (new_n67_ & new_n80_));
