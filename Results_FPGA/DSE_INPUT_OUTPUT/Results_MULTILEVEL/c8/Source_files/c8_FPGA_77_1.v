...
module FAU ( 
  ...
  assign z01 = (~x09 & (x20 ? x27 : ~x22)) | (~x20 & ~x22 & ~x27);
  ...
  assign new_n63_ = (~x21 | (~x20 & ((~x17 & ~x19) | x22))) & (x17 | x19 | x20 | x21 | x22);
  assign z12 = (~new_n65_ & x16) | new_n49_ | (~x16 & (x18 ? x03 : x11));
  assign new_n65_ = ~x22 & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? ~new_n67_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n67_ = (~x20 | ~x23) & (x22 | ((~x23 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x20 | x21 | x23)));
  assign z14 = x16 ? ((~new_n70_ & ~x22) | (x20 & x24)) : (~new_n69_ & (x20 | ~x22));
  assign new_n69_ = x18 ? ~x05 : ~x13;
  assign new_n70_ = (~x24 | (~x17 & ~x19 & ~x21 & ~x23)) & (x17 | x19 | x20 | x21 | x23 | x24);
  assign z15 = x16 ? ~new_n72_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n72_ = (~x20 | ~x25) & (x22 | ((~new_n73_ | ~new_n75_) & (new_n74_ | ~x25)));
  ...
  assign new_n77_ = ~x20 & (x22 | (new_n78_ & new_n79_));
  assign new_n78_ = ~x19 & ~x21 & x16 & ~x17;
  assign new_n79_ = ~x25 & ~x26 & ~x23 & ~x24;
  assign new_n80_ = x26 & (~new_n81_ | x17 | x19 | x20 | x21);
