...
module FAU ( 
  ...
  assign z05 = (~x13 & (x24 ? x27 : x23)) | (x23 & ~x24 & ~x27);
  ...
  assign new_n61_ = (x23 | x24) & (~x16 | ((~x20 | (~x17 & ~x19)) & (x17 | x19 | x20)));
  ...
  assign z13 = x16 ? ((~new_n68_ & x23) | (new_n67_ & new_n70_)) : new_n69_;
  assign new_n67_ = ~x17 & ~x19 & ~x20;
  assign new_n68_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n69_ = (x23 | x24) & (x18 ? x04 : x12);
  assign new_n70_ = ~x21 & ~x22 & ~x23 & x24;
  assign z14 = x16 ? (~new_n73_ & x24) : (~new_n72_ & (x23 | x24));
