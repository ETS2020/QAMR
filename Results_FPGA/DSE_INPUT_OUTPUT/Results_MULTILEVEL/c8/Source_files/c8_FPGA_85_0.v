...
module FAU ( 
  ...
  assign new_n61_ = (x21 | x23) & (~x16 | ((~x20 | (~x17 & ~x19)) & (x17 | x19 | x20)));
  assign z11 = x16 ? ~new_n63_ : (~new_n49_ & (x18 ? x02 : x10));
  assign new_n63_ = (~x21 | (~x17 & ~x19 & ~x20)) & (x17 | x19 | x20 | x21 | ~x23);
  assign z12 = (~new_n65_ & ~x16) | (new_n67_ & x16) | (~new_n66_ & ~x21);
  assign new_n65_ = x18 ? ~x03 : ~x11;
  assign new_n66_ = x23 & (~x16 | x17 | x19 | x20 | x22);
  assign new_n67_ = x22 & (x20 | x21 | x17 | x19);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | new_n49_ | (~new_n69_ & x16);
  assign new_n69_ = x21 ? ~x23 : (~x17 & ~x19 & ~x20 & ~x22);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | new_n49_ | (x16 & x24);
  assign z15 = ~new_n49_ & (x16 ? x25 : (x18 ? x06 : x14));
  assign z16 = (~x16 & (x18 ? x07 : x15)) | new_n49_ | (x16 & x26);
  assign z17 = new_n49_ | (x16 & x17 & x27);
endmodule
