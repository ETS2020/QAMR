...
module FAU ( 
  ...
  assign z06 = (~x14 & (~x25 | x27)) | (x25 & ~x26) | (~x25 & ~x27);
  ...
  assign z15 = (~new_n75_ & ~x16) | (x25 & ~x26) | (x16 & (new_n74_ | (~new_n73_ & x25)));
  assign new_n73_ = new_n63_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n74_ = new_n65_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n75_ = x18 ? ~x06 : ~x14;
  assign z16 = (~new_n78_ & ~x16) | (x25 & (x16 | ~x26)) | (x16 & (new_n77_ | (~new_n73_ & x26)));
  assign new_n77_ = new_n65_ & ~x22 & ~x23 & ~x24 & ~x26;
