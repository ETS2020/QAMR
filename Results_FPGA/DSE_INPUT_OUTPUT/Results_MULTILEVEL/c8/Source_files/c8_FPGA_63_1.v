// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:07 2020
...
module FAU ( 
  ...
  assign z04 = (~x23 & ~x27) | (~x12 & (~x23 | (x18 & x27)));
  ...
  assign z09 = x16 ? (~new_n59_ & (x18 | ~x23)) : ((x00 & x18) | (x08 & ~x18 & ~x23));
  assign new_n59_ = ~x17 ^ ~x19;
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x18 & x23) | (~new_n61_ & x16);
  assign new_n61_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n63_ & (x18 | ~x23)) : ((x02 & x18) | (x10 & ~x18 & ~x23));
  assign new_n63_ = ~new_n65_ & (new_n64_ | ~x21);
  assign new_n64_ = ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~x18 & x23) | (~new_n67_ & x16);
  ...
  assign z16 = x16 ? ((~new_n79_ & ~x23) | (x18 & x23 & x26)) : ~new_n82_;
  assign new_n79_ = (~new_n65_ | ~new_n81_) & (~x26 | (new_n64_ & new_n80_));
  assign new_n80_ = ~x24 & ~x25 & ~x21 & ~x22;
  assign new_n81_ = ~x25 & ~x26 & ~x22 & ~x24;
