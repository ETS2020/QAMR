...
module FAU ( 
  ...
  assign z00 = (~x19 & ~x27) | (~x08 & x27) | (~x02 & ~x18);
  assign z01 = (~x20 & ~x27) | (~x09 & x27) | (~x02 & ~x18);
  assign z02 = (x02 | x18) & (x27 ? ~x10 : ~x21);
  assign z03 = (x02 | x18) & (x27 ? ~x11 : ~x22);
  assign z04 = (x02 | x18) & (x27 ? ~x12 : ~x23);
  assign z05 = (~x24 & ~x27) | (~x13 & x27) | (~x02 & ~x18);
  assign z06 = (~x25 & ~x27) | (~x14 & x27) | (~x02 & ~x18);
  assign z07 = (x02 | x18) & (x27 ? ~x15 : ~x26);
  assign z08 = x27 & (x02 | x18);
  assign z09 = (~new_n58_ & x16) | (~x02 & ~x18) | (~x16 & (x18 ? x00 : x08));
  assign new_n58_ = ~x17 ^ ~x19;
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~new_n60_ & x16) | (~x02 & ~x18);
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = (x02 & (x16 ? ~new_n62_ : (x10 | x18))) | (x16 & ~new_n62_ & x18);
  assign new_n62_ = ~new_n64_ & (new_n63_ | ~x21);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z12 = x16 ? (~new_n66_ & (x02 | x18)) : ((x03 & x18) | (x02 & x11 & ~x18));
  assign new_n66_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n68_ & x16) | (~x02 & ~x18);
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n70_ & (x02 | x18)) : ((x05 & x18) | (x02 & x13 & ~x18));
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z15 = x16 ? ((new_n72_ | new_n73_) & (x02 | x18)) : ~new_n74_;
  assign new_n72_ = x25 & (~new_n63_ | x23 | x24 | x21 | x22);
  assign new_n73_ = new_n64_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n74_ = (~x06 | ~x18) & (~x02 | ~x14 | x18);
  assign z16 = x16 ? (~new_n76_ & (x02 | x18)) : ((x07 & x18) | (x02 & x15 & ~x18));
  assign new_n76_ = (~x26 | (new_n64_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n64_ | x22 | x23 | x24 | x25 | x26);
  assign z17 = (~new_n78_ & x16) | (~x02 & ~x18);
