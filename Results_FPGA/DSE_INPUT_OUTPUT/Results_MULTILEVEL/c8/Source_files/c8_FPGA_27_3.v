...
module FAU ( 
  ...
  assign z09 = (~new_n58_ & ~x16) | (x18 & x20) | (x16 & (x17 ? (x19 & (~x20 | (~x18 & x20))) : ~x19));
  ...
  assign new_n64_ = (x20 | ((~x22 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x21 | x22))) & (x18 | ~x20 | ~x22);
  ...
  assign z14 = (~new_n71_ & ~x16) | (x20 & (x18 | (x16 & x24))) | (~new_n69_ & x16);
  assign new_n69_ = (~x24 | (new_n67_ & ~x21 & ~x22 & ~x23)) & (~new_n70_ | x21 | x22 | x23 | x24);
  assign new_n70_ = ~x17 & ~x19 & ~x20;
  assign new_n71_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ((~new_n73_ & ~x20) | (~x18 & x20 & x25)) : ~new_n75_;
  ...
  assign z16 = (~new_n80_ & ~x16) | (x20 & (x18 | (x16 & x26))) | (~new_n77_ & x16);
  assign new_n77_ = (~x26 | (new_n74_ & new_n79_ & ~x24 & ~x25)) & (~new_n78_ | ~new_n79_ | x24 | x25 | x26);
  assign new_n78_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n79_ = ~x22 & ~x23;
  assign new_n80_ = x18 ? ~x07 : ~x15;
  assign z17 = (x18 & x20) | (~new_n82_ & x16);
