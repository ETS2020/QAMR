...
module FAU ( 
  ...
  assign new_n61_ = (x18 | (x19 & (~x16 | ~x21))) & (~x16 | ((~x21 | (~x17 & ~x19 & ~x20)) & (x17 | x19 | x20 | x21)));
  assign z12 = x16 ? ~new_n63_ : ((x03 & x18) | (x11 & ~x18 & x19));
  assign new_n63_ = (~x18 | ((~x22 | (~x17 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22))) & (~x19 | ~x22);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n65_ & ~x18) | (~new_n66_ & x16);
  assign new_n65_ = x19 & (~x16 | ~x23);
  assign new_n66_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x21 | x22 | x23 | x17 | x19 | x20);
  ...
  assign z15 = x16 ? ((~new_n72_ & x18) | (x19 & x25)) : ~new_n75_;
  ...
  assign z16 = x16 ? ((~new_n77_ & x18) | (x19 & x26)) : ~new_n79_;
