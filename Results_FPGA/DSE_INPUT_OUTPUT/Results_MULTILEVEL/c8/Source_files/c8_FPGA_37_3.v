...
module FAU ( 
  ...
  assign z09 = (x16 & (x17 ^ ~x19)) | (~new_n59_ & ~x16) | (x17 & x24);
  assign new_n59_ = x18 ? ~x00 : ~x08;
  assign z10 = (~new_n61_ & ~x16) | (x17 & (x24 | (x16 & x20))) | (x16 & ((x19 & x20) | (~x17 & ~x19 & ~x20)));
  ...
  assign z12 = (~new_n65_ & ~x16) | (x17 & ((x16 & x22) | x24)) | (~new_n66_ & x16);
  assign new_n65_ = x18 ? ~x03 : ~x11;
  assign new_n66_ = (~x22 | (~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? ~new_n68_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n68_ = x17 ? (~x23 | x24) : ((~x23 | (new_n69_ & ~x21 & ~x22)) & (~new_n69_ | x21 | x22 | x23));
  assign new_n69_ = ~x19 & ~x20;
  assign z14 = (~x16 & (x18 ? x05 : x13)) | new_n49_ | (~new_n71_ & x16);
  assign new_n71_ = (~x24 | (new_n69_ & ~x21 & ~x22 & ~x23)) & (~new_n69_ | x17 | x21 | x22 | x23 | x24);
  assign z15 = x16 ? ~new_n73_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n73_ = (x24 | ((~x17 | ~x25) & (~new_n74_ | ~new_n69_ | x17))) & (x17 | new_n75_ | ~x25);
  assign new_n74_ = ~x23 & ~x25 & ~x21 & ~x22;
  assign new_n75_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z16 = (~new_n81_ & ~x16) | (x17 & (x24 | (x16 & x26))) | (~new_n77_ & x16);
  assign new_n77_ = (~x26 | (new_n78_ & new_n79_ & ~x24 & ~x25)) & (~new_n80_ | ~new_n79_ | x24 | x25 | x26);
