...
module FAU ( 
  ...
  assign z06 = (~x14 & (~x25 | x27)) | (~x25 & ~x27) | (x14 & x18);
  ...
  assign z15 = x16 ? ((~x14 | ~x18) & (new_n73_ | new_n74_)) : ((x06 & ~x14 & x18) | (x14 & ~x18));
  ...
  assign new_n76_ = (~x26 | (new_n65_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n65_ | x22 | x23 | x24 | x25 | x26);
