...
module FAU ( 
  ...
  assign new_n63_ = x17 ? (x18 | ~x22) : ((~x22 | (~x19 & ~x20 & ~x21)) & (x21 | x22 | x19 | x20));
  assign z13 = x16 ? ~new_n65_ : ((x04 & ~x17 & x18) | (x12 & ~x18));
  assign new_n65_ = x17 ? (x18 | ~x23) : ((~x23 | (new_n66_ & ~x21 & ~x22)) & (~new_n66_ | x21 | x22 | x23));
  assign new_n66_ = ~x19 & ~x20;
  assign z14 = (~new_n69_ & ~x16) | (x17 & (x18 | (x16 & x24))) | (~new_n68_ & x16);
  assign new_n68_ = (~x24 | (new_n66_ & ~x21 & ~x22 & ~x23)) & (x23 | x24 | x21 | x22 | ~new_n66_ | x17);
  assign new_n69_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? (x17 ? (~x18 & x25) : ~new_n71_) : ~new_n73_;
  assign new_n71_ = (~x25 | (new_n72_ & ~x22 & ~x23 & ~x24)) & (~new_n72_ | x24 | x25 | x22 | x23);
  assign new_n72_ = ~x19 & ~x20 & ~x21;
  assign new_n73_ = (~x06 | x17 | ~x18) & (~x14 | x18);
  assign z16 = (~new_n78_ & ~x16) | (x17 & (x18 | (x16 & x26))) | (~new_n75_ & x16);
  assign new_n75_ = (~x26 | (new_n72_ & new_n77_ & ~x24 & ~x25)) & (~new_n76_ | ~new_n77_ | x24 | x25 | x26);
  assign new_n76_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n77_ = ~x22 & ~x23;
  assign new_n78_ = (~x15 | (~x17 & x18)) & (~x07 | ~x18);
  assign z17 = (x17 & x18) | (~new_n80_ & x16);
