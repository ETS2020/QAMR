// Benchmark "FAU" written by ABC on Mon Aug 17 20:03:26 2020
...
module FAU ( 
  ...
  assign z00 = (~x19 & ~x27) | (~x08 & x27) | (x07 & x18);
  assign z01 = (~x20 & ~x27) | (~x09 & x27) | (x07 & x18);
  assign z02 = (~x07 | ~x18) & (x27 ? ~x10 : ~x21);
  assign z03 = (~x22 & ~x27) | (~x11 & x27) | (x07 & x18);
  assign z04 = (~x23 & ~x27) | (~x12 & x27) | (x07 & x18);
  assign z05 = (~x24 & ~x27) | (~x13 & x27) | (x07 & x18);
  assign z06 = (~x07 | ~x18) & (x27 ? ~x14 : ~x25);
  assign z07 = (~x07 | ~x18) & (x27 ? ~x15 : ~x26);
  ...
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (x07 & x18) | (~new_n68_ & x16);
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (x07 & x18) | (~new_n70_ & x16);
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z15 = (~new_n74_ & ~x16) | (x07 & x18) | (x16 & (new_n72_ | new_n73_));
