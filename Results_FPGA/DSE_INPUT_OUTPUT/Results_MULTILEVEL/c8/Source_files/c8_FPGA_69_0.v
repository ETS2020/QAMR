// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:09 2020
...
module FAU ( 
  ...
  assign z07 = (x18 & (x27 ? ~x15 : ~x26)) | (x15 & ~x26 & ~x27);
  assign z08 = x27 & (x15 | (~x15 & x18));
  assign z09 = x16 ? (~new_n59_ & (x15 | x18)) : ((x00 & x18) | (x08 & x15 & ~x18));
  assign new_n59_ = ~x17 ^ ~x19;
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x15 & ~x18) | (~new_n61_ & x16);
  assign new_n61_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n63_ & (x15 | x18)) : ((x02 & x18) | (x10 & x15 & ~x18));
  assign new_n63_ = ~new_n65_ & (new_n64_ | ~x21);
  assign new_n64_ = ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~x15 & ~x18) | (~new_n67_ & x16);
  assign new_n67_ = (x17 | x19 | x20 | x21 | new_n49_ | x22) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z13 = x16 ? (~new_n69_ & (x15 | x18)) : ((x04 & x18) | (x12 & x15 & ~x18));
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~x15 & ~x18) | (~new_n71_ & x16);
  ...
  assign z16 = x16 ? (~new_n77_ & (x15 | x18)) : (x18 ? x07 : x15);
