// Benchmark "FAU" written by ABC on Mon Aug 17 20:01:55 2020
...
module FAU ( 
  ...
  assign z05 = (~x24 & ~x27) | (~x13 & x27) | (~x18 & x19);
  assign z06 = (~x25 & ~x27) | (~x14 & x27) | (~x18 & x19);
  ...
  assign z12 = (~new_n63_ & ~x16) | (~new_n64_ & x16) | (x19 & (~x18 | (x16 & x22)));
  assign new_n63_ = x18 ? ~x03 : ~x11;
  assign new_n64_ = (~x22 | (~x17 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? ~new_n66_ : ((x04 & x18) | (x12 & ~x18 & ~x19));
  assign new_n66_ = (x19 | ((~x23 | (new_n67_ & ~x21 & ~x22)) & (~new_n67_ | x21 | x22 | x23))) & (~x18 | ~x19 | ~x23);
  assign new_n67_ = ~x17 & ~x20;
  assign z14 = x16 ? ((x18 & x19 & x24) | (~new_n70_ & ~x19)) : ~new_n69_;
  assign new_n69_ = (~x05 | ~x18) & (~x13 | x18 | x19);
  assign new_n70_ = (~x24 | (~x17 & ~x20 & ~x21 & ~x22 & ~x23)) & (x22 | x23 | x24 | x17 | x20 | x21);
  assign z15 = x16 ? ((x18 & x19 & x25) | (~new_n72_ & ~x19)) : ~new_n74_;
  ...
  assign z16 = (~new_n79_ & ~x16) | (x19 & (~x18 | (x16 & x26))) | (~new_n76_ & x16);
  assign new_n76_ = (~x26 | (new_n73_ & new_n77_ & ~x24 & ~x25)) & (~new_n78_ | ~new_n77_ | x24 | x25 | x26);
  assign new_n77_ = ~x22 & ~x23;
  assign new_n78_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n79_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & (new_n81_ | (x17 & x27 & (x18 | ~x19)));
