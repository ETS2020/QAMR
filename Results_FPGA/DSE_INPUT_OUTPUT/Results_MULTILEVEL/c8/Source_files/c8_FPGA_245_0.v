...
module FAU ( 
  ...
  assign z09 = (x00 & (x16 ? (~x17 ^ x19) : (x08 | x18))) | (x16 & x18 & (~x17 ^ x19));
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x00 & ~x18) | (~new_n59_ & x16);
  ...
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~x00 & ~x18) | (~new_n65_ & x16);
  ...
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~x00 & ~x18) | (~new_n75_ & x16);
