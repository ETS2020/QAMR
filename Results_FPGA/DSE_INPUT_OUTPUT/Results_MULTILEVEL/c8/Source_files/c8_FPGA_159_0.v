...
module FAU ( 
  ...
  assign z14 = x16 ? ((~new_n71_ & x18) | (x21 & x24)) : ~new_n74_;
  assign new_n71_ = (new_n73_ | ~x24) & (~new_n72_ | x21 | x22 | x23 | x24);
  assign new_n72_ = ~x17 & ~x19 & ~x20;
  assign new_n73_ = ~x17 & ~x19 & ~x20 & ~x22 & ~x23;
  assign new_n74_ = (~x05 | ~x18) & (~x13 | x18 | ~x21);
  assign z15 = x16 ? ((~new_n76_ & x18) | (x21 & x25)) : ~new_n77_;
  ...
  assign new_n79_ = (~x26 | (new_n66_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n66_ | x22 | x23 | x24 | x25 | x26);
