// Benchmark "FAU" written by ABC on Mon Aug 17 20:02:36 2020
...
module FAU ( 
  ...
  assign z14 = x16 ? (~new_n70_ & (~x08 | x18)) : ((x05 & x18) | (~x08 & x13 & ~x18));
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign z15 = (~new_n74_ & ~x16) | new_n50_ | (x16 & (new_n72_ | new_n73_));
  ...
  assign z17 = new_n50_ | (~new_n78_ & x16);
