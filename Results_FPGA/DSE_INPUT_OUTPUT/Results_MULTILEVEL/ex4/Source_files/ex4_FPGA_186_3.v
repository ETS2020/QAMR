// Benchmark "FAU" written by ABC on Sat Aug 22 18:00:12 2020
...
module FAU ( 
  ...
  assign z05 = z17 | (x045 & (~new_n194_ | (~new_n185_ & x053)));
  ...
  assign z06 = x046 & ~z17 & (~new_n211_ | (~new_n198_ & x054));
  ...
  assign z08 = z17 | (~x040 & (~new_n232_ | (~new_n219_ & ~x048)));
  ...
  assign z09 = ~x041 & ~z17 & (~new_n240_ | new_n243_);
  ...
  assign z10 = ~x042 & ~z17 & (~new_n245_ | new_n248_);
  ...
  assign z11 = ~x043 & ~z17 & (~new_n250_ | new_n253_);
  ...
  assign z12 = z17 | (~x044 & (~new_n255_ | new_n258_));
  ...
  assign new_n273_ = ~z17 & ((x037 & x053) | (x013 & x077));
  ...
  assign z14 = ~x046 & ~z17 & (~new_n294_ | (~new_n281_ & ~x054));
