...
module FAU ( 
  ...
  assign z06 = (~x002 & x054) | (x046 & (~new_n219_ | (x054 & (new_n206_ | ~new_n209_))));
  ...
  assign z10 = ~x042 & ((new_n253_ & x002) | (~new_n252_ & (x002 | ~x054)));
  assign new_n252_ = (~x010 | (~x074 & (~x018 | x034 | ~x066))) & (~x034 | (~x050 & (x010 | ~x018 | ~x066))) & (x010 | ~x018 | ~x066 | (x050 & x074));
  assign new_n253_ = x082 & (x010 ? (x034 | ~x050) : (~x034 | ~x074));
  ...
  assign z14 = (~x002 & x054) | (~x046 & (~new_n299_ | (~x054 & (new_n286_ | ~new_n289_))));
