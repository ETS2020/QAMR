// Benchmark "FAU" written by ABC on Sat Aug 22 17:59:38 2020
...
module FAU ( 
  ...
  assign z08 = z07 | (~x040 & (~new_n240_ | (~new_n227_ & ~x048)));
  ...
  assign new_n238_ = x064 & ((~x016 & x024) | x056 | x088);
  ...
  assign z13 = z07 | (~x045 & (~new_n281_ | (~new_n268_ & ~x053)));
  ...
  assign new_n279_ = x069 & ((~x021 & x029) | x061 | x093);
