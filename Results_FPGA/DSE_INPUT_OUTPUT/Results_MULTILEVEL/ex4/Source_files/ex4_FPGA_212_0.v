...
module FAU ( 
  ...
  assign z14 = ~x046 & ~new_n287_ & x086;
  assign new_n287_ = (new_n288_ | x078) & (~x038 | ~x054) & (~x078 | (new_n289_ & (~x006 | (x038 & ~x054))));
  assign new_n288_ = (~x006 | (x014 & x054)) & (~x022 | ~x070 | (x014 & x038 & ~x054));
  assign new_n289_ = ~x014 & (~x022 | x054 | ~x070);
  assign z19 = 1'b0;
  assign z20 = 1'b0;
  assign z21 = 1'b0;
  assign z22 = 1'b0;
