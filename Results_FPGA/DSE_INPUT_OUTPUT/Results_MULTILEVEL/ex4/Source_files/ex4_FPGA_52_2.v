...
module FAU ( 
  ...
  assign new_n201_ = ~x028 & (~new_n204_ | ((~new_n202_ | new_n205_) & x077));
  ...
  assign z06 = x046 & ~z07 & (~new_n219_ | (x054 & (new_n207_ | ~new_n211_)));
  ...
  assign z08 = z07 | (~x040 & (~new_n238_ | (~x048 & (~new_n226_ | new_n235_))));
  ...
  assign z10 = z07 | (~x042 & (~new_n250_ | new_n253_));
  ...
  assign z13 = z07 | (~x045 & ((~new_n265_ & ~x053) | ~new_n278_ | (~new_n280_ & x053)));
