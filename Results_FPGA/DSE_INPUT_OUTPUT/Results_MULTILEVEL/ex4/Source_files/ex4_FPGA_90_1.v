...
module FAU ( 
  ...
  assign z08 = ~x040 & ~z07 & (~new_n238_ | (~new_n225_ & ~x048));
  ...
  assign z13 = ~x045 & ~z07 & (~new_n279_ | (~new_n266_ & ~x053));
  ...
  assign z14 = ~x046 & (new_n302_ | new_n287_ | new_n290_ | ~new_n293_);
  ...
  assign new_n293_ = (new_n294_ | ~x006) & ~x054 & (x078 | new_n299_ | x086);
  assign new_n294_ = ~new_n298_ & (x078 | (new_n297_ & (x070 | (~new_n295_ & ~new_n296_))));
  ...
  assign new_n298_ = ~x038 & x086;
  assign new_n299_ = (~x030 | new_n301_ | (~x038 & (new_n300_ | (x062 & x094)))) & (~x038 | (~x062 & ~x094));
  assign new_n300_ = ~x102 & ~x126;
  assign new_n301_ = x022 & (x014 | x070);
  assign new_n302_ = x078 & (x014 | (x022 & x070));
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
  assign z20 = 1'b0;
