...
module FAU ( 
  ...
  assign z06 = (~x054 & x085) | (x046 & (~new_n220_ | (x054 & (new_n206_ | ~new_n210_))));
  ...
  assign new_n210_ = new_n216_ & (x006 | ((~x038 | x086) & (new_n211_ | ~x078)));
  ...
  assign new_n214_ = x022 & ~new_n215_ & ~x126;
  assign new_n215_ = ~x110 & ~x118;
  assign new_n216_ = ~new_n217_ & (x030 | ~x078 | ~new_n219_ | ~x086);
  assign new_n217_ = ~x070 & ((~x022 & (x014 | x038 | ~x078)) | (new_n218_ & x078));
  assign new_n218_ = x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n219_ = (~x102 | ~x126) & ~new_n209_ & (x022 | (x014 & x070));
  ...
  assign new_n222_ = ~new_n218_ & (x006 | ~x070 | (x102 & x126));
  ...
  assign new_n279_ = x054 & (~new_n282_ | (~x077 & (~new_n280_ | new_n283_)));
  ...
  assign new_n287_ = ~new_n215_ & ((x014 & ~x086) | (~x078 & (new_n288_ | (~new_n289_ & ~x086))));
