// Benchmark "FAU" written by ABC on Sat Aug 22 17:59:26 2020
...
module FAU ( 
  ...
  assign z06 = z15 | (x046 & (~new_n211_ | (~new_n198_ & x054)));
  ...
  assign z08 = ~x040 & ~z15 & (~new_n232_ | (~new_n219_ & ~x048));
  ...
  assign z09 = ~x041 & ~z15 & (~new_n240_ | new_n243_);
  ...
  assign z10 = z15 | (~x042 & (~new_n245_ | new_n248_));
  ...
  assign z12 = z15 | (~x044 & (~new_n255_ | new_n258_));
