...
module FAU ( 
  ...
  assign z01 = x041 & ((~new_n165_ & (~x054 | x081)) | (~x001 & ~x054 & ~new_n166_ & ~x081));
  ...
  assign z09 = z07 | (~x041 & (~new_n245_ | new_n249_));
  assign new_n245_ = (new_n246_ | x049) & (new_n247_ | ~x081) & new_n248_ & (~x033 | ~x049);
  assign new_n246_ = (x009 | ~x017 | ~x065) & (~x001 | ~x009 | ~x081);
  assign new_n247_ = (~x001 | (x009 ? ~x033 : x073)) & (~x033 | ~x065 | x009 | ~x017);
  assign new_n248_ = (~x009 | ~x073) & (~x065 | x073 | x009 | ~x017);
  ...
  assign z14 = (x054 & ~x081) | (~x046 & (~new_n300_ | (~x054 & (new_n287_ | ~new_n290_))));
  ...
  assign new_n300_ = (new_n301_ | x014) & (new_n303_ | ~x038) & ~new_n305_ & (~x014 | ~x078);
  assign new_n301_ = (~x006 | ~x054 | ~x086) & (~new_n302_ | x070 | x078 | x086);
  assign new_n302_ = x030 & x038;
  assign new_n303_ = ~x054 & (x078 | (~new_n297_ & ~new_n304_));
  assign new_n304_ = x006 & ~x070 & (x102 | x126);
  assign new_n305_ = x054 & ((x022 & x070 & ~x078) | (x006 & x078 & x086));
  assign z15 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
  assign z21 = 1'b0;
