...
module FAU ( 
  ...
  assign z05 = z17 | (x045 & (~new_n193_ | (~x005 & (new_n185_ | ~new_n202_))));
  assign new_n185_ = x053 & (new_n191_ | (x077 & (~new_n192_ | (~new_n186_ & x069))));
  assign new_n186_ = ~new_n187_ & (new_n188_ | (new_n189_ & ~x021)) & (new_n190_ | ~x021);
  assign new_n187_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n188_ = x101 & x125;
  assign new_n189_ = ~x061 & ~x093;
  assign new_n190_ = x109 & x117;
  assign new_n191_ = x037 & ~x069 & (~new_n190_ | ~x101);
  assign new_n192_ = x085 & (~x021 | x125 | (~x109 & ~x117));
  assign new_n193_ = (new_n200_ | x053) & new_n201_ & (~x085 | (~new_n198_ & (new_n194_ | ~x053)));
  assign new_n194_ = (new_n190_ | new_n195_) & ~new_n196_ & (x029 | new_n188_ | ~new_n197_);
  assign new_n195_ = x013 & x021 & (x029 | ~x069 | (~x061 & ~x093));
  assign new_n196_ = ~x069 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n197_ = (x061 | x093) & (x021 | (x013 & x069));
  assign new_n198_ = ~x037 & (new_n199_ | ~x061 | ~x093);
  assign new_n199_ = ~x029 & (x021 | (x013 & x069));
  assign new_n200_ = x037 & (x021 | x069 | ~x077);
  assign new_n201_ = (x021 | x069 | (x077 ? (~x013 & ~x037) : ~x053)) & (x013 | x077);
  assign new_n202_ = (x077 | (~x037 & x053)) & (~x013 | ~x077 | x085);
  assign z06 = z17 | (x046 & (~new_n217_ | (~new_n204_ & x054)));
  ...
  assign z08 = z17 | (~x040 & (~new_n238_ | (~new_n225_ & ~x048)));
  ...
  assign z13 = z17 | (~x045 & (new_n285_ | new_n266_ | ~new_n270_ | new_n284_));
  assign new_n266_ = (x109 | x117) & (new_n269_ | (~new_n267_ & ~x053));
  assign new_n267_ = ~x013 & (x077 | (new_n268_ & (~x005 | (x037 & x069))));
  assign new_n268_ = ~x021 & (~x029 | x069 | (x061 & x093));
  assign new_n269_ = x021 & x069 & ~x077;
  assign new_n270_ = ~new_n283_ & (x077 | (~new_n271_ & ~new_n273_ & ~new_n275_ & ~new_n280_));
  assign new_n271_ = x069 & ((~new_n189_ & (x021 | ~x053)) | (~new_n272_ & ~x053) | (~x013 & x021));
  assign new_n272_ = (x021 | ~x029) & (~x005 | x037 | ~x101);
  assign new_n273_ = (~x013 | ~x021) & (new_n274_ | (x029 & x037 & ~x069));
  assign new_n274_ = x005 & ~x053 & (x061 | x093);
  assign new_n275_ = ~x069 & (new_n279_ | (~x053 & (new_n278_ | (~new_n276_ & ~new_n277_))));
  assign new_n276_ = ~x101 & ~x125;
  assign new_n277_ = (~x005 | x021) & ((x061 & x093) | (~x005 & (x013 | ~x029)));
  assign new_n278_ = x005 & ~x013 & x029;
  assign new_n279_ = x037 & (x061 | x093);
  assign new_n280_ = ~x021 & ~x053 & (new_n281_ | new_n282_);
  assign new_n281_ = x029 & (x005 | ((~x061 | ~x093) & (x101 | x125)));
  assign new_n282_ = x005 & x125 & (~x109 | ~x117);
  assign new_n283_ = x037 & x053;
  assign new_n284_ = (~x037 | x053) & (new_n269_ | (x005 & x085));
  assign new_n285_ = x077 & (x013 | (x021 & ~x053 & x069));
  ...
  assign new_n298_ = x070 & ((~x022 & x030) | x062 | x094);
