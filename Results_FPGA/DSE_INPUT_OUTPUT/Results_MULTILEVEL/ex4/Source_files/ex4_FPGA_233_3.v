...
module FAU ( 
  ...
  assign z06 = x046 & ~z16 & (~new_n209_ | (x054 & (new_n197_ | ~new_n201_)));
  ...
  assign z08 = z16 | (~x040 & (~new_n228_ | ((~new_n216_ | new_n225_) & ~x048)));
  ...
  assign z11 = z16 | (~x043 & (~new_n245_ | new_n248_));
  ...
  assign z12 = z16 | (~x044 & (~new_n250_ | new_n253_));
  ...
  assign z13 = z16 | (~x045 & (~new_n255_ | (~new_n273_ & x053)));
  ...
  assign z14 = ~x046 & ~z16 & (~new_n285_ | (~x054 & (new_n275_ | ~new_n278_)));
