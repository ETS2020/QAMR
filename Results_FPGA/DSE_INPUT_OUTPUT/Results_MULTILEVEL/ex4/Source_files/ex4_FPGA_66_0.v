...
module FAU ( 
  ...
  wire new_n159_, new_n160_, new_n161_, new_n162_, new_n164_, new_n165_,
    ...
    new_n305_;
  assign z00 = (x040 & (new_n161_ | ~new_n162_ | (~new_n159_ & x048))) | (~x048 & ~x054);
  assign new_n159_ = (~x032 | (~new_n160_ & (x000 | x080))) & (x000 | x080 | (x008 & ~x072));
  assign new_n160_ = ~x016 & ~x064;
  assign new_n161_ = x008 & ((~x016 & x048 & ~x064) | (~x000 & ~x048 & ~x080));
  assign new_n162_ = (x008 | (x072 & (x016 | x048 | x064))) & (x048 | (x032 & (x016 | x064 | ~x072)));
  assign z01 = z15 | (x041 & (~new_n164_ | new_n168_));
