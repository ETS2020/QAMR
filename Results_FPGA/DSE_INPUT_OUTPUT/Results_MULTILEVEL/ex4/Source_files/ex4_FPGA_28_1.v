...
module FAU ( 
  ...
  assign z00 = x040 ? (~new_n159_ | new_n162_) : x054;
  ...
  assign new_n204_ = (x037 | x053) & (x077 | (x013 & (x005 | (~x037 & x053) | x085)));
  ...
  assign z08 = ~x040 & (~new_n239_ | (~new_n226_ & ~x048));
  ...
  assign new_n239_ = (x072 | (~new_n240_ & new_n243_)) & new_n246_ & (new_n245_ | ~x072);
  ...
  assign new_n246_ = ~x054 & (~x032 | ~x048);
  ...
  assign z11 = z16 | (~x043 & (~new_n258_ | new_n261_));
  ...
  assign z14 = (~x040 & x054) | (~x046 & (~new_n302_ | (~x054 & (new_n289_ | ~new_n292_))));
