...
module FAU ( 
  ...
  assign z13 = ~x045 & (new_n284_ | new_n285_ | new_n266_ | ~new_n270_);
  ...
  assign new_n270_ = ~x085 & (x077 | (~new_n271_ & ~new_n274_ & ~new_n276_ & ~new_n281_));
  assign new_n271_ = x069 & (new_n272_ | ~new_n273_);
  assign new_n272_ = ~x037 & (x021 | (x005 & ~x053 & x101));
  assign new_n273_ = ((~x061 & ~x093) | (~x021 & x053)) & (x013 | ~x021) & (x021 | ~x029 | x053);
  assign new_n274_ = (~x013 | ~x021) & (new_n275_ | (x029 & x037 & ~x069));
  assign new_n275_ = x005 & ~x053 & (x061 | x093);
  assign new_n276_ = ~x069 & (new_n280_ | (~x053 & (new_n279_ | (~new_n277_ & ~new_n278_))));
  assign new_n277_ = ~x101 & ~x125;
  assign new_n278_ = (~x005 | x021) & ((x061 & x093) | (~x005 & (x013 | ~x029)));
  assign new_n279_ = x005 & ~x013 & x029;
  assign new_n280_ = x037 & (x061 | x093);
  assign new_n281_ = ~x021 & ~x053 & (new_n282_ | new_n283_);
  assign new_n282_ = x029 & (x005 | ((x101 | x125) & (~x061 | ~x093)));
  assign new_n283_ = x005 & x125 & (~x109 | ~x117);
  assign new_n284_ = x053 & (new_n269_ | x037);
