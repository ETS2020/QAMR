...
module FAU ( 
  ...
  assign z05 = z07 | (x045 & (~new_n193_ | (~new_n185_ & x053)));
  assign new_n185_ = (new_n190_ | (x109 & x117)) & ~new_n191_ & ~new_n186_ & ~new_n192_;
  assign new_n186_ = ~x005 & (new_n187_ | (x037 & (x069 | ~x085)) | (~x021 & ~x069 & ~x085));
  assign new_n187_ = x077 & (~new_n189_ | (x021 & ~new_n188_ & ~x125));
  assign new_n188_ = ~x109 & ~x117;
  assign new_n189_ = ~x069 & x085 & (~x037 | x101);
  assign new_n190_ = (~x085 | (x013 & x021)) & (x005 | ~x037 | ~x077);
  assign new_n191_ = x085 & (((~x021 | x077) & (~x061 | ~x093)) | (x021 & ~x029 & x077));
  assign new_n192_ = ~x021 & ~x069 & (x013 | x037 | ~x077);
  assign new_n193_ = (x053 | (new_n195_ & (x005 | new_n194_ | (~x013 & x077)))) & (x013 | x077);
  assign new_n194_ = ~x069 & x085;
  assign new_n195_ = x037 & (x021 | x069 | ~x077);
  assign z06 = x046 & ~z07 & (~new_n209_ | (x054 & (new_n197_ | ~new_n201_)));
  assign new_n197_ = (~x110 | ~x118) & ((~x014 & x086) | (~new_n198_ & x078));
  ...
  assign new_n206_ = x086 & ((new_n207_ & ~x030) | (~x070 & (~new_n208_ | (x022 & ~x030))));
  ...
  assign new_n219_ = (x024 | x056 | x088) & (~x016 | (~x008 & ~x032));
  ...
  assign new_n237_ = (~x017 | ~x065) & (~x001 | ~x081);
  ...
  assign new_n242_ = (~x018 | ~x066) & (~x002 | ~x082);
  ...
  assign new_n247_ = (~x019 | ~x067) & (~x003 | ~x083);
  ...
  assign new_n252_ = (~x020 | ~x068) & (~x004 | ~x084);
  assign new_n253_ = ~x036 & ((x012 & x020 & x068) | (x004 & ~x012 & x084));
  assign z13 = z07 | (~x045 & (~new_n255_ | (~new_n273_ & x053)));
  assign new_n255_ = (~x077 | (new_n272_ & ~x013)) & ~new_n266_ & (x077 | (~new_n256_ & new_n269_));
  assign new_n256_ = ~x053 & (new_n257_ | new_n264_ | new_n265_ | new_n259_ | new_n262_);
  assign new_n257_ = ~new_n188_ & (new_n258_ | (x005 & (x069 ? ~x037 : ~x021)));
  assign new_n258_ = ~x085 & (x021 | (x029 & ~x069 & (~x061 | ~x093)));
  assign new_n259_ = (x101 | x125) & (new_n261_ | (~new_n260_ & (~x061 | ~x093)));
  assign new_n260_ = (~x029 | x085 | (x021 & (x013 | x069))) & (~x005 | x069);
  assign new_n261_ = x005 & ~x021 & ~x069;
  ...
  assign new_n266_ = ~x053 & (new_n267_ | new_n268_);
  assign new_n267_ = ~new_n188_ & ((x021 & x069) | (x013 & (x069 | ~x085)));
  assign new_n268_ = x021 & x069 & (x061 | x093 | ~x013 | ~x037);
  assign new_n269_ = ~new_n270_ & (~new_n271_ | ~x037);
  assign new_n270_ = ~x013 & ((x005 & x085) | (~x069 & ~x085 & x029 & x037));
  assign new_n271_ = ~x069 & ~x085 & (x061 | x093 | (~x021 & x029));
