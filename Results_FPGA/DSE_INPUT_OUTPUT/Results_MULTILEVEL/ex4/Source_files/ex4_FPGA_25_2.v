...
module FAU ( 
  ...
  assign z00 = z19 | (x040 & (~new_n159_ | new_n162_));
  ...
  assign z03 = z19 | (x043 & (~new_n175_ | new_n178_));
  ...
  assign z08 = ~x040 & ~z19 & (~new_n238_ | (~new_n225_ & ~x048));
  ...
  assign z09 = ~x041 & ~z19 & (~new_n246_ | new_n249_);
  ...
  assign z10 = ~x042 & ~z19 & (~new_n251_ | new_n254_);
  ...
  assign z11 = ~x043 & ~z19 & (~new_n256_ | new_n259_);
  ...
  assign z12 = ~x044 & ~z19 & (~new_n261_ | new_n264_);
  ...
  assign z13 = z19 | (~x045 & (~new_n279_ | (~new_n266_ & ~x053)));
