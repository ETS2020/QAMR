...
module FAU ( 
  ...
  assign z03 = x043 & ((~new_n175_ & (~x058 | ~x067)) | (~x019 & ~new_n176_ & ~x067));
  assign new_n175_ = (x003 | x083 | (x011 ? (~x035 & ~x075) : (x035 & ~x051))) & (x035 | x051) & (x011 | x075);
  assign new_n176_ = x011 ? (x035 & ~x051 & ~x075) : ~x035;
  ...
  assign z06 = z07 | (x046 & (~new_n217_ | (~new_n204_ & x054)));
  ...
  assign z11 = ~x043 & ((~new_n256_ & (~x058 | ~x067)) | (x019 & ~x058 & ~new_n257_ & x067));
  assign new_n256_ = (~x003 | ~x083 | (x011 ? (~x035 & x051) : (x035 & x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign new_n257_ = x011 ? x035 : (~x035 & x051 & x075);
  ...
  assign z13 = ~x045 & ~z07 & (~new_n277_ | (~new_n264_ & ~x053));
