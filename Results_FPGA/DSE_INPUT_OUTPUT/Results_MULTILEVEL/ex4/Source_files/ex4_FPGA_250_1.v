// Benchmark "FAU" written by ABC on Sat Aug 22 18:00:50 2020
...
module FAU ( 
  ...
  assign new_n201_ = ~x091 & (~new_n204_ | (x077 & (~new_n202_ | new_n205_)));
  ...
  assign z08 = z07 | (~x040 & (~new_n238_ | ((~new_n226_ | new_n235_) & ~x048)));
  ...
  assign z09 = ~x041 & ~z07 & (~new_n245_ | new_n248_);
  ...
  assign z13 = ~x045 & ((~new_n280_ & x085) | (~x091 & (~new_n265_ | new_n282_)));
  assign new_n265_ = (new_n279_ | ~x077) & (new_n277_ | x077) & (x053 | (~new_n266_ & (new_n269_ | x077)));
  assign new_n266_ = (x109 | x117) & ((~new_n267_ & ~x077) | (x013 & ~x085));
  assign new_n267_ = ~new_n268_ & (~x005 | ((x037 | ~x069) & (x021 | x061 | x069)));
  assign new_n268_ = ~x085 & (x021 | (x029 & ~x069 & (~x061 | ~x093)));
  assign new_n269_ = ~new_n270_ & (x085 | ((new_n275_ | ~x069) & (~new_n276_ | ~x029)));
  assign new_n270_ = x005 & (new_n271_ | new_n272_ | ~new_n274_ | (~new_n273_ & x125));
  assign new_n271_ = (x029 | x093) & (x021 ? ~x013 : (~x061 & ~x069));
  assign new_n272_ = ~x037 & ((x069 & x101) | (~x021 & x061 & ~x069));
  assign new_n273_ = (x021 | ~x069 | (x109 & x117)) & (x069 | (x061 & (~x021 | x093)));
  assign new_n274_ = (~x021 | ((x069 | x093 | ~x101) & (x013 | ~x061))) & (x061 | x069 | ~x101);
  assign new_n275_ = new_n193_ & (x021 | ~x029);
  assign new_n276_ = (x101 | x125) & ~new_n191_ & (~x021 | (~x013 & ~x069));
  assign new_n277_ = ~new_n278_ & (~x037 | new_n275_ | x085) & (~x021 | x037 | ~x069);
  assign new_n278_ = ~x013 & ((x021 & x069) | (~x069 & ~x085 & x029 & x037));
  assign new_n279_ = ~x013 & (~x021 | x053 | ~x069);
  assign new_n280_ = (new_n281_ | x077) & (~x037 | ~x053) & (~x077 | (new_n279_ & (~x005 | (x037 & ~x053))));
  assign new_n281_ = (~x005 | (x013 & x053)) & (~x021 | ~x069 | (x013 & x037 & ~x053));
  ...
  assign new_n286_ = x030 & ~new_n218_ & ~x070;
  ...
  assign new_n289_ = ~new_n290_ & ((~x102 & ~x126) | (new_n218_ & x022));
  assign new_n290_ = (~x022 | (~x014 & ~x038)) & (x030 | x062 | x094);
  assign new_n291_ = ~x022 & x126 & (~x110 | ~x118);
  assign new_n292_ = ~x086 & ((new_n293_ & x030) | (x070 & (~new_n210_ | (~x022 & x030))));
  assign new_n293_ = (x102 | x126) & ~new_n218_ & (~x022 | (~x014 & ~x070));
  assign new_n294_ = (x078 | (new_n297_ & (new_n295_ | ~x038))) & (~x038 | ~x054) & (new_n299_ | ~x078);
  assign new_n295_ = (new_n296_ | x070) & (x086 | (new_n210_ & (x022 | ~x030)));
