...
module FAU ( 
  ...
  assign z06 = x046 & ~z15 & (~new_n219_ | (~new_n206_ & x054));
  ...
  assign z09 = z15 | (~x041 & (~new_n248_ | new_n251_));
  ...
  assign z10 = z15 | (~x042 & (~new_n253_ | new_n256_));
  ...
  assign z11 = z15 | (~x043 & (~new_n258_ | new_n261_));
  ...
  assign z13 = z15 | (~x045 & (~new_n281_ | (~new_n268_ & ~x053)));
  ...
  assign z14 = ~x046 & ~z15 & (~new_n302_ | (~new_n289_ & ~x054));
