...
module FAU ( 
  ...
  assign new_n201_ = ~x079 & (~new_n204_ | (x077 & (~new_n202_ | new_n205_)));
  ...
  assign z13 = z15 | (~x045 & ((~new_n265_ & ~x053) | ~new_n278_ | (~new_n280_ & x053)));
  ...
  assign z14 = z15 | (~x046 & (~new_n293_ | (~x054 & (new_n283_ | ~new_n286_))));
