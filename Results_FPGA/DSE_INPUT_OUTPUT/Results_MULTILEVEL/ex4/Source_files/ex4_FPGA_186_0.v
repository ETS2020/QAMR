...
module FAU ( 
  ...
  assign z05 = z17 | (x045 & (~new_n185_ | (~new_n205_ & ~x053)));
  ...
  assign z08 = z17 | (~x040 & (~new_n238_ | (~x048 & (~new_n226_ | new_n235_))));
  ...
  assign z14 = ~x046 & ~z17 & (~new_n285_ | (~x054 & (new_n275_ | ~new_n278_)));
