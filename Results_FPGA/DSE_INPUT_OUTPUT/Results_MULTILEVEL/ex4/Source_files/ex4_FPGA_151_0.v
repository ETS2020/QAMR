...
module FAU ( 
  ...
  assign z04 = (~x052 & ~x054) | (x044 & (new_n182_ | ~new_n183_ | (~new_n180_ & x052)));
  assign new_n180_ = (~x036 | ((x020 | x068) & (x004 | x084))) & (x004 | new_n181_ | x084);
  assign new_n181_ = x012 & ~x076;
  assign new_n182_ = x012 & ((~x020 & x052 & ~x068) | (~x004 & ~x052 & ~x084));
  assign new_n183_ = (x012 | (x076 & (x020 | x052 | x068))) & (x052 | (x036 & (x020 | x068 | ~x076)));
  ...
  assign z06 = (~x052 & ~x054) | (x046 & (~new_n219_ | (x054 & (new_n206_ | ~new_n209_))));
  ...
  assign z12 = ~x044 & (~new_n262_ | (~new_n266_ & (x052 | (~x036 & x054))));
  assign new_n262_ = (~x054 | (new_n264_ & (new_n263_ | (~x036 & x052)))) & (~x052 | (new_n265_ & ~x036));
  assign new_n263_ = (x012 | ~x020 | ~x068) & (~x004 | ~x012 | ~x084);
  assign new_n264_ = (~x012 | ~x076) & (~x004 | x012 | x076 | ~x084);
  assign new_n265_ = (~x012 | ~x076) & (~x020 | ~x068 | x076);
  ...
  assign z14 = (~x052 & ~x054) | (~x046 & (~new_n302_ | (~x054 & (new_n289_ | ~new_n292_))));
