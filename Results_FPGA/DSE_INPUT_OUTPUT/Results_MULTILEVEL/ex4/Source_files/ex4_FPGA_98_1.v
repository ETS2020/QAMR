// Benchmark "FAU" written by ABC on Sat Aug 22 17:59:03 2020
...
module FAU ( 
  ...
  assign z06 = x046 & (~new_n219_ | (~new_n206_ & x054));
  ...
  assign new_n219_ = new_n223_ & (~x078 | (new_n220_ & (x038 | new_n222_ | ~x086)));
  ...
  assign new_n223_ = (x038 | x054) & (x078 | (x014 & (x006 | x086 | (~x038 & x054))));
  ...
  assign z14 = ~x046 & (new_n305_ | new_n306_ | new_n287_ | ~new_n291_);
  assign new_n287_ = (x110 | x118) & (new_n290_ | (~new_n288_ & ~x054));
  assign new_n288_ = ~x014 & (x078 | (new_n289_ & (~x006 | (x038 & x070))));
  assign new_n289_ = ~x022 & (~x030 | x070 | (x062 & x094));
  assign new_n290_ = x022 & x070 & ~x078;
  assign new_n291_ = ~x086 & (x078 | (~new_n292_ & ~new_n295_ & ~new_n297_ & ~new_n302_));
  assign new_n292_ = x070 & (new_n293_ | ~new_n294_);
  assign new_n293_ = ~x038 & (x022 | (x006 & ~x054 & x102));
  assign new_n294_ = ((~x062 & ~x094) | (~x022 & x054)) & (x014 | ~x022) & (x022 | ~x030 | x054);
  assign new_n295_ = (~x014 | ~x022) & (new_n296_ | (x030 & x038 & ~x070));
  assign new_n296_ = x006 & ~x054 & (x062 | x094);
  assign new_n297_ = ~x070 & (new_n301_ | (~x054 & (new_n300_ | (~new_n298_ & ~new_n299_))));
  assign new_n298_ = ~x102 & ~x126;
  assign new_n299_ = (~x006 | x022) & ((x062 & x094) | (~x006 & (x014 | ~x030)));
  assign new_n300_ = x006 & ~x014 & x030;
  assign new_n301_ = x038 & (x062 | x094);
  assign new_n302_ = ~x022 & ~x054 & (new_n303_ | new_n304_);
  assign new_n303_ = x030 & (x006 | ((x102 | x126) & (~x062 | ~x094)));
  assign new_n304_ = x006 & x126 & (~x110 | ~x118);
  assign new_n305_ = x054 & (new_n290_ | x038);
  assign new_n306_ = x078 & (x014 | (x022 & ~x054 & x070));
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
  assign z20 = 1'b0;
