...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (~new_n185_ | (~new_n205_ & ~x053)));
  ...
  assign z06 = z16 | (x046 & (~new_n219_ | (x054 & (new_n207_ | ~new_n211_))));
  ...
  assign z14 = z16 | (~x046 & (~new_n285_ | (~x054 & (new_n275_ | ~new_n278_))));
