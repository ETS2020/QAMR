...
module FAU ( 
  ...
  assign z05 = z20 | (x045 & (~new_n185_ | (~new_n205_ & ~x053)));
  ...
  assign new_n200_ = x069 & x085 & (~x061 | ~x093 | (x021 & ~x029));
  ...
  assign z06 = x046 & ~z20 & (~new_n219_ | (x054 & (new_n207_ | ~new_n211_)));
  ...
  assign z08 = ~x040 & ~z20 & (~new_n238_ | (~x048 & (~new_n226_ | new_n235_)));
  ...
  assign z09 = ~x041 & ~z20 & (~new_n245_ | new_n248_);
  ...
  assign z10 = z20 | (~x042 & (~new_n250_ | new_n253_));
  ...
  assign z11 = z20 | (~x043 & (~new_n255_ | new_n258_));
  ...
  assign z12 = ~x044 & ~z20 & (~new_n260_ | new_n263_);
  ...
  assign z14 = ~x046 & ~z20 & (~new_n285_ | (~x054 & (new_n275_ | ~new_n278_)));
