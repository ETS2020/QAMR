...
module FAU ( 
  ...
  assign new_n287_ = (new_n288_ | (x014 & ~x078)) & ~new_n289_ & ~new_n290_ & x086 & (~x014 | ~x078);
  assign new_n288_ = (~x022 | x054 | ~x070) & (~x006 | ~x054);
  assign new_n289_ = ~x054 & ((x006 & (~x038 | ~x078)) | (x022 & ~x038 & x070));
  assign new_n290_ = x054 & (x038 | (x022 & x070 & ~x078));
  assign z15 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
  assign z21 = 1'b0;
