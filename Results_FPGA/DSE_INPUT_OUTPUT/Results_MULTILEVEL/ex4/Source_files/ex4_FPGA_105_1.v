...
module FAU ( 
  ...
  assign z08 = z15 | (~x040 & (~new_n241_ | (~new_n226_ & ~x048)));
  assign new_n226_ = ~new_n227_ & ~new_n240_ & (x072 | (~new_n231_ & ~new_n234_ & ~new_n238_));
  assign new_n227_ = ~new_n228_ & ((x008 & ~x080) | (~x072 & (new_n229_ | (~new_n230_ & ~x080))));
  assign new_n228_ = ~x104 & ~x112;
  assign new_n229_ = x000 & ~x024 & (~x032 | ~x064);
  assign new_n230_ = ~x016 & (~x024 | (x056 & ~x064 & x088));
  assign new_n231_ = x064 & (new_n232_ | new_n233_);
  assign new_n232_ = ~x032 & ((x024 & ~x080) | (x000 & ~x024 & x096));
  assign new_n233_ = ~x080 & (x056 | x088 | (x024 & (~x008 | ~x016)));
  assign new_n234_ = x000 & (~new_n237_ | (~x064 & (new_n235_ | new_n236_)));
  assign new_n235_ = (~x008 | ~x016) & (x024 | x056 | x088);
  assign new_n236_ = (x096 | x120) & (~x016 | ~x056 | ~x088);
  assign new_n237_ = ~x080 & (x016 | x024 | ~x120 | (x104 & x112));
  assign new_n238_ = x024 & new_n239_ & ~x080;
  assign new_n239_ = (x096 | x120) & (~x008 | ~x016) & (~x056 | ~x088);
  assign new_n240_ = x016 & x064 & x072;
  assign new_n241_ = new_n244_ & (x072 | (new_n242_ & (~new_n233_ | ~x032)));
  ...
  assign z14 = (~x024 & x054) | (~x046 & (~new_n300_ | (~x054 & (new_n287_ | ~new_n290_))));
