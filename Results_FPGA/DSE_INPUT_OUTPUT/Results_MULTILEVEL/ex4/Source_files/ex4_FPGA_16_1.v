...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (new_n185_ | ~new_n196_ | (~new_n192_ & x077)));
  ...
  assign z06 = x046 & ~z15 & (~new_n211_ | (~new_n198_ & x054));
  ...
  assign z08 = z15 | (~x040 & (~new_n232_ | (~new_n219_ & ~x048)));
  ...
  assign new_n230_ = x064 & ((~x016 & x024) | x056 | x088);
  ...
  assign new_n277_ = ~z15 & ((x037 & x053) | (x013 & x077));
  assign z14 = ~x046 & ~z15 & (~new_n292_ | (~new_n279_ & ~x054));
  ...
  assign new_n290_ = x070 & ((~x022 & x030) | x062 | x094);
