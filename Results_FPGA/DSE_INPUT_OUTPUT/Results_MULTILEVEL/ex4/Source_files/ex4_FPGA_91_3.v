// Benchmark "FAU" written by ABC on Sat Aug 22 17:58:58 2020
...
module FAU ( 
  ...
  assign z06 = z07 | (x046 & (~new_n219_ | (x054 & (new_n206_ | ~new_n209_))));
  ...
  assign z14 = z07 | (~x046 & (~new_n300_ | (~x054 & (new_n286_ | ~new_n289_))));
