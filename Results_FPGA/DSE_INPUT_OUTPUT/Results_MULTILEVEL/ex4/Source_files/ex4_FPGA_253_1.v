...
module FAU ( 
  ...
  assign new_n201_ = ~x096 & (~new_n204_ | (x077 & (~new_n202_ | new_n205_)));
  ...
  assign z08 = z07 | (~x040 & (~new_n236_ | ((~new_n226_ | new_n241_) & ~x048)));
  assign new_n226_ = new_n231_ & (~x000 | ((x032 | ~x080) & (new_n227_ | x072)));
  ...
  assign new_n237_ = (~x032 | (~x048 & (new_n238_ | x072))) & (new_n239_ | ~x048) & (~x008 | ~x072);
  assign new_n238_ = ~new_n233_ & (~x000 | x064 | (~x096 & ~x120));
  assign new_n239_ = (~x016 | ~x064 | x072) & (~x000 | ~x072 | ~x080);
  assign new_n240_ = x024 & x032 & ~x064 & ~x072 & ~x080;
  ...
  assign z13 = ~x045 & ((~new_n280_ & x085) | ((~new_n265_ | new_n282_) & ~x096));
