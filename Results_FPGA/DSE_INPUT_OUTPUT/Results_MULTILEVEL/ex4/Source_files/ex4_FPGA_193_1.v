...
module FAU ( 
  ...
  assign new_n201_ = ~x087 & (~new_n204_ | (x077 & (~new_n202_ | new_n205_)));
  ...
  assign z06 = z17 | (x046 & (~new_n219_ | (x054 & (new_n207_ | ~new_n211_))));
  ...
  assign z08 = z17 | (~x040 & (~new_n238_ | ((~new_n226_ | new_n235_) & ~x048)));
