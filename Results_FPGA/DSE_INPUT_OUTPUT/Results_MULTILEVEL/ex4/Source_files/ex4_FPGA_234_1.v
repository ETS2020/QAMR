...
module FAU ( 
  ...
  assign z06 = x046 & (new_n220_ | ((~new_n206_ | new_n227_) & x086));
  assign new_n206_ = (new_n219_ | x078) & (new_n217_ | ~x078) & (~x054 | (~new_n207_ & (new_n210_ | ~x078)));
  ...
  assign new_n210_ = ~new_n212_ & ~new_n213_ & ~new_n216_ & (new_n211_ | (~new_n214_ & ~new_n215_));
  assign new_n211_ = ~x062 & ~x094;
  assign new_n212_ = (~x070 | (~x006 & (x014 | x022))) & (~x062 | ~x094);
  assign new_n213_ = ~x070 & ((x022 & ~x030) | (~x006 & x038 & ~x102));
  assign new_n214_ = ~x030 & (x022 | (x014 & x070)) & (~x102 | ~x126);
  assign new_n215_ = ~x006 & x070 & ~x102;
  assign new_n216_ = ~x006 & ((x022 & (~x030 | (x070 & ~x102))) | (x014 & ~x030 & x070));
  assign new_n217_ = (~x014 | ((x022 | x070) & (x030 | x038 | ~x070))) & (x038 | (new_n218_ & (~x022 | x030))) & (x022 | ~x038 | x070);
  assign new_n218_ = x062 & x094;
  assign new_n219_ = x014 & (x022 | ~x054 | x070);
  assign new_n220_ = ~x126 & (~new_n226_ | (~new_n221_ & x078));
  assign new_n221_ = ~new_n222_ & ~new_n223_ & (x006 | ~x054 | (~new_n224_ & new_n225_));
  assign new_n222_ = x014 & ((~x022 & ~x070) | (~x006 & ~x086));
  assign new_n223_ = ~x022 & ~x070 & (x038 | ~x054);
  assign new_n224_ = x022 & (x070 | x110 | x118);
  assign new_n225_ = x086 & (~x070 | (~x062 & ~x094));
  assign new_n226_ = (x038 | x054) & (x078 | (new_n219_ & (x006 | x086 | (~x038 & x054))));
  assign new_n227_ = ~x054 & (~x038 | (~x022 & ~x070 & x078));
  assign z08 = ~x040 & ~z16 & (~new_n242_ | (~new_n229_ & ~x048));
  ...
  assign z09 = ~x041 & ~z16 & (~new_n250_ | new_n253_);
  ...
  assign z12 = z16 | (~x044 & (~new_n265_ | new_n268_));
  ...
  assign z13 = ~x045 & ~z16 & (~new_n283_ | (~new_n270_ & ~x053));
  ...
  assign new_n281_ = x069 & ((~x021 & x029) | x061 | x093);
  ...
  assign new_n286_ = (x013 | ~x029 | x085) & (~x005 | (~x101 & ~x125));
  ...
  assign z14 = z16 | (~x046 & (~new_n300_ | (~new_n291_ & ~x054)));
  assign new_n291_ = ~new_n292_ & (x078 | (~new_n296_ & ~new_n298_)) & (~x022 | ~x070 | ~x078);
  assign new_n292_ = (x110 | x118) & (new_n295_ | (~x078 & (new_n293_ | new_n294_)));
  assign new_n293_ = x006 & (x070 ? ~x038 : ~x022);
  assign new_n294_ = ~x086 & (x022 | (x030 & ~x070 & (~x062 | ~x094)));
  assign new_n295_ = x014 & ~x086;
  assign new_n296_ = x006 & ((~new_n297_ & ~x070) | x086 | (~x038 & x070 & x102));
  assign new_n297_ = ((x014 & x022) | (~x030 & ~x062 & ~x094)) & (~x102 | (x022 & x062 & x094));
  assign new_n298_ = ~x086 & ((~new_n299_ & x030) | (~new_n211_ & x070));
  assign new_n299_ = (x022 | ~x070) & (~x102 | (x062 & x094) | (x022 & (x014 | x070)));
  assign new_n300_ = new_n304_ & (x078 | (new_n302_ & (~x038 | new_n301_ | x086)));
  assign new_n301_ = new_n211_ & (~x030 | (x022 & (x014 | x070)));
