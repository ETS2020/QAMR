...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (~new_n193_ | (~new_n185_ & x053)));
  ...
  assign z06 = z15 | (x046 & (~new_n209_ | (x054 & (new_n197_ | ~new_n201_))));
  ...
  assign z08 = ~x040 & ~z15 & (~new_n228_ | ((~new_n216_ | new_n225_) & ~x048));
  ...
  assign z09 = z15 | (~x041 & (~new_n235_ | new_n238_));
  ...
  assign z10 = ~x042 & ~z15 & (~new_n240_ | new_n243_);
  ...
  assign z11 = z15 | (~x043 & (~new_n245_ | new_n248_));
  ...
  assign z12 = ~x044 & ~z15 & (~new_n250_ | new_n253_);
  ...
  assign z13 = z15 | (~x045 & (~new_n255_ | (~new_n273_ & x053)));
