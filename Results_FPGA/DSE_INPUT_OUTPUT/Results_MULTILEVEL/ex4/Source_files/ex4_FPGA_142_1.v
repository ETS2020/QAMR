...
module FAU ( 
  ...
  assign z05 = x045 & (((~new_n185_ | new_n204_) & x058) | (~new_n202_ & ~x085));
  ...
  assign z08 = z15 | (~x040 & (~new_n237_ | (~x048 & (~new_n225_ | new_n234_))));
  ...
  assign z12 = z15 | (~x044 & (~new_n259_ | new_n262_));
  ...
  assign new_n278_ = x058 & (~new_n281_ | ((~new_n279_ | new_n282_) & ~x077));
