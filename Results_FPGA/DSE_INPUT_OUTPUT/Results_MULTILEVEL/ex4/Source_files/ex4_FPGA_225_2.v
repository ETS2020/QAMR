...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n220_ & ~x054) | (x078 & (~new_n217_ | (~new_n206_ & x054))));
  assign new_n206_ = (new_n207_ | (x110 & x118)) & ~new_n209_ & (new_n214_ | ~x086);
  assign new_n207_ = (x006 | (x070 ? ~x022 : ~x038)) & (new_n208_ | ~x086);
  assign new_n208_ = x014 & x022 & (x030 | ~x070 | (~x062 & ~x094));
  ...
  assign new_n217_ = (x022 | x070 | (~x014 & ~x038)) & (new_n218_ | x038) & (new_n219_ | ~x014);
  assign new_n218_ = (x006 | ~x070 | (x102 & x126)) & (new_n215_ | ~x086);
  assign new_n219_ = (x006 | x086) & (x030 | x038 | ~x070 | ~x086);
  assign new_n220_ = (new_n221_ | x078) & x038 & (x022 | x070 | ~x078);
  assign new_n221_ = x014 & (x006 | x086);
  ...
  assign z13 = z07 | (~x045 & (~new_n277_ | (~new_n264_ & ~x053)));
  ...
  assign z14 = ~x046 & ((~new_n285_ & ~x054) | (~new_n302_ & x078));
  assign new_n285_ = ~new_n286_ & (new_n290_ | ~x070) & (x078 | (new_n297_ & (new_n293_ | x070)));
  ...
  assign new_n300_ = x030 & ~x086 & (x038 | (x102 & (~x062 | ~x094)));
  assign new_n301_ = (~x006 | ~x086) & (~x038 | x086 | (~x062 & ~x094));
  assign new_n302_ = (~x006 | ~x086 | (x038 & ~x054)) & ~x014 & ~new_n303_ & (~x038 | ~x054);
