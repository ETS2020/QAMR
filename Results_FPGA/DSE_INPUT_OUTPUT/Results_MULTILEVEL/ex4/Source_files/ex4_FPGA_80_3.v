// Benchmark "FAU" written by ABC on Sat Aug 22 17:58:53 2020
...
module FAU ( 
  ...
  assign new_n170_ = (x054 | ((x034 | x050) & (~x010 | new_n171_ | ~x074))) & (x010 | (x074 & (x034 | x050)));
  assign new_n171_ = (x018 | x066) & (x002 | x082);
  assign new_n172_ = (x010 | x018 | x066) & (x002 | ~x010 | x054 | x082);
  assign new_n173_ = (x054 | x066 | ~x010 | x018) & (x002 | x010 | x082);
  ...
  assign new_n199_ = ~x037 & ((~new_n201_ & x069) | (~new_n200_ & x085));
  ...
  assign z06 = (x010 & x054) | (x046 & (~new_n219_ | (x054 & (new_n206_ | ~new_n209_))));
  ...
  assign z10 = ~x042 & ((~new_n254_ & ~x034) | (~new_n252_ & x034) | new_n255_ | ~new_n256_);
  assign new_n252_ = (x010 | (~new_n253_ & ~x050)) & (x054 | (~x050 & (~x002 | ~x010 | ~x082)));
  assign new_n253_ = x018 & x066;
  assign new_n254_ = (~x002 | x010 | ~x082) & (x054 | ~x066 | ~x010 | ~x018);
  assign new_n255_ = x002 & x082 & (x010 ? (~x050 & ~x054) : ~x074);
  assign new_n256_ = x010 ? (x054 | ~x074) : (~x018 | ~x066 | (x050 & x074));
  ...
  assign new_n268_ = ~new_n269_ & (~x021 | ~x069 | ~x077) & (x077 | (~new_n273_ & ~new_n278_));
  ...
  assign z14 = (x010 & x054) | (~x046 & (~new_n302_ | (~x054 & (new_n289_ | ~new_n292_))));
  assign new_n289_ = (x110 | x118) & ((~new_n290_ & ~x078) | (x014 & ~x086));
  assign new_n290_ = (~x006 | (x070 ? x038 : x022)) & (x086 | (~new_n291_ & ~x022));
  assign new_n291_ = x030 & ~x070 & (~x062 | ~x094);
  assign new_n292_ = ~new_n298_ & ~new_n300_ & (~x006 | (~new_n293_ & (x038 | ~x086)));
  assign new_n293_ = ~x078 & (new_n296_ | ~new_n297_ | (~x070 & (new_n294_ | new_n295_)));
  ...
  assign new_n300_ = x030 & ~x078 & ~x086 & new_n301_ & (x102 | x126);
  assign new_n301_ = (~x062 | ~x094) & (~x022 | (~x014 & ~x070));
  assign new_n302_ = (new_n303_ | x014) & (new_n305_ | ~x038) & ~new_n307_ & (~x014 | ~x078);
  assign new_n303_ = (~x006 | ~x054 | ~x086) & (~new_n304_ | x070 | x078 | x086);
  assign new_n304_ = x030 & x038;
  assign new_n305_ = ~x054 & (x078 | (~new_n299_ & ~new_n306_));
  assign new_n306_ = x006 & ~x070 & (x102 | x126);
  assign new_n307_ = x054 & ((x022 & x070 & ~x078) | (x006 & x078 & x086));
  assign z17 = 1'b0;
  assign z20 = 1'b0;
  assign z23 = 1'b0;
  assign z24 = 1'b0;
