// Benchmark "FAU" written by ABC on Sat Aug 22 17:58:16 2020
...
module FAU ( 
  ...
  assign z14 = ~x046 & (~new_n287_ | (x006 & x086 & (~x014 | x078)));
  assign new_n287_ = ~x038 & (~x014 | ~x078) & x054 & (~x022 | ~x070 | x078);
  assign z07 = 1'b0;
  assign z19 = 1'b0;
  assign z20 = 1'b0;
  assign z25 = 1'b0;
