...
module FAU ( 
  ...
  assign new_n201_ = ~x106 & (~new_n204_ | (x077 & (~new_n202_ | new_n205_)));
  ...
  assign z13 = ~x045 & ((~new_n280_ & x085) | (~x106 & (~new_n265_ | new_n282_)));
  ...
  assign z14 = ~x046 & ~z15 & (~new_n294_ | (~x054 & (new_n284_ | ~new_n287_)));
