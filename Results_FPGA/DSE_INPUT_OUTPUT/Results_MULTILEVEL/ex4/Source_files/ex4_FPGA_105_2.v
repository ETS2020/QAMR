...
module FAU ( 
  ...
  assign z06 = (x024 & ~x054) | (x046 & (~new_n219_ | (x054 & (new_n206_ | ~new_n209_))));
  ...
  assign z08 = z15 | (~x040 & (~new_n239_ | (~new_n226_ & ~x048)));
  ...
  assign new_n232_ = (~x008 | ~x016) & (x024 | x056 | x088);
  ...
  assign new_n239_ = new_n243_ & (x072 | (new_n240_ & (~x032 | new_n242_ | x080)));
  assign new_n240_ = (x008 | ((~x016 | ~x064) & (~x000 | ~x080))) & (~x016 | new_n241_ | ~x064);
  assign new_n241_ = x032 & ~x048;
  assign new_n242_ = ~x056 & ~x088 & (~x024 | (x016 & (x008 | x064)));
  ...
  assign z13 = ~x045 & ~z15 & (~new_n278_ | (~new_n265_ & ~x053));
  ...
  assign z14 = (x024 & ~x054) | (~x046 & (~new_n299_ | (~x054 & (new_n286_ | ~new_n289_))));
