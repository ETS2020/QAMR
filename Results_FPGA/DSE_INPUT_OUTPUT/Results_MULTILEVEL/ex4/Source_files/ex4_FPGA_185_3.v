...
module FAU ( 
  ...
  assign z08 = z16 | (~x040 & (~new_n221_ | (~new_n208_ & ~x048)));
  ...
  assign z09 = ~x041 & ~z16 & (~new_n229_ | new_n232_);
  ...
  assign z10 = z16 | (~x042 & (~new_n234_ | new_n237_));
  ...
  assign z11 = z16 | (~x043 & (~new_n239_ | new_n242_));
  ...
  assign z12 = ~x044 & ~z16 & (~new_n244_ | new_n247_);
  ...
  assign z13 = z16 | (~x045 & (~new_n262_ | (~new_n249_ & ~x053)));
