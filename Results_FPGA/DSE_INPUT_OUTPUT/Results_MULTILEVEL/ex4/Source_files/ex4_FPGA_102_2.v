// Benchmark "FAU" written by ABC on Sat Aug 22 17:59:06 2020
...
module FAU ( 
  ...
  assign new_n201_ = ~x059 & (~new_n204_ | (x077 & (~new_n202_ | new_n205_)));
  ...
  assign z08 = ~x040 & ~z07 & (~new_n238_ | ((~new_n226_ | new_n235_) & ~x048));
