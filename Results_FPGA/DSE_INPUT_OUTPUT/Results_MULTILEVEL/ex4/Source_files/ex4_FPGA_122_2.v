// Benchmark "FAU" written by ABC on Sat Aug 22 17:59:15 2020
...
module FAU ( 
  ...
  assign z02 = z15 | (x042 & (~new_n170_ | new_n174_));
  assign new_n170_ = (new_n171_ | ~x050) & (new_n172_ | x010) & (new_n173_ | ~x010) & (x034 | x050);
  assign new_n171_ = (~x010 | x018 | x066) & (x002 | x010 | x082);
  assign new_n172_ = x074 & (x002 | x034 | x082);
  assign new_n173_ = (x002 | ((x018 | x034 | x066) & (~x074 | x082))) & (x018 | x066 | ~x074);
  assign new_n174_ = x034 & ((~x010 & ~x018 & ~x066) | (~x002 & x010 & ~x082));
  assign z03 = x043 & ~z15 & (~new_n176_ | new_n179_);
  ...
  assign z04 = z15 | (x044 & (~new_n181_ | new_n184_));
  ...
  assign z05 = x045 & ~z15 & (~new_n199_ | (~new_n186_ & x053));
  ...
  assign z06 = (x002 & ~x054) | (x046 & (~new_n220_ | (x054 & (new_n207_ | ~new_n210_))));
  ...
  assign new_n210_ = ~new_n216_ & ~new_n218_ & (x006 | (~new_n211_ & (~x038 | x086)));
  ...
  assign new_n220_ = (new_n221_ | ~x014) & (new_n223_ | x038) & ~new_n225_ & (x014 | x078);
  assign new_n221_ = (~new_n222_ | ~x070 | ~x078 | ~x086) & (x006 | x054 | x086);
  assign new_n222_ = ~x030 & ~x038;
  assign new_n223_ = x054 & (~x078 | (~new_n217_ & ~new_n224_));
  assign new_n224_ = ~x006 & x070 & (~x102 | ~x126);
  ...
  assign z10 = ~x042 & ((~new_n253_ & (~x002 | x054)) | (x002 & new_n254_ & x054));
  assign new_n253_ = (~x010 | (~x074 & (~x018 | x034 | ~x066))) & (~x034 | (~x050 & (x010 | ~x018 | ~x066))) & (x010 | ~x018 | ~x066 | (x050 & x074));
  assign new_n254_ = x082 & (x010 ? (x034 | ~x050) : (~x034 | ~x074));
  ...
  assign z14 = (x002 & ~x054) | (~x046 & (~new_n300_ | (~x054 & (new_n287_ | ~new_n290_))));
