// Benchmark "FAU" written by ABC on Sat Aug 22 17:58:30 2020
...
module FAU ( 
  ...
  assign z06 = (x048 & ~x054) | (x046 & (~new_n219_ | (x054 & (new_n206_ | ~new_n209_))));
  ...
  assign z08 = (x048 & ~x054) | (~x040 & (~new_n239_ | (~x048 & (new_n226_ | ~new_n229_))));
  ...
  assign new_n229_ = ~new_n235_ & ~new_n237_ & (~x000 | (~new_n230_ & (x032 | ~x080)));
  assign new_n230_ = ~x072 & (new_n233_ | ~new_n234_ | (~x064 & (new_n231_ | new_n232_)));
  ...
  assign new_n235_ = x064 & ((x016 & (~x008 | ~x032 | x072)) | (new_n236_ & ~x072));
  assign new_n236_ = ~x080 & (x056 | x088 | (~x016 & x024));
  assign new_n237_ = x024 & ~x072 & ~x080 & new_n238_ & (x096 | x120);
  assign new_n238_ = (~x056 | ~x088) & (~x016 | (~x008 & ~x064));
  assign new_n239_ = (new_n240_ | x008) & (new_n242_ | ~x032) & ~new_n244_ & (~x008 | ~x072);
  assign new_n240_ = (~x000 | ~x048 | ~x080) & (~new_n241_ | x064 | x072 | x080);
  assign new_n241_ = x024 & x032;
  assign new_n242_ = ~x048 & (x072 | (~new_n236_ & ~new_n243_));
  assign new_n243_ = x000 & ~x064 & (x096 | x120);
  assign new_n244_ = x048 & ((x016 & x064 & ~x072) | (x000 & x072 & x080));
  ...
  assign z14 = (x048 & ~x054) | (~x046 & (~new_n300_ | (~x054 & (new_n287_ | ~new_n290_))));
