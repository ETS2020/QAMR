// Benchmark "FAU" written by ABC on Sat Aug 22 17:59:10 2020
...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n202_ & ~x085) | (x119 & (~new_n185_ | new_n204_)));
  ...
  assign z08 = z07 | (~x040 & (~new_n237_ | ((~new_n225_ | new_n234_) & ~x048)));
  ...
  assign z10 = ~x042 & ~z07 & (~new_n249_ | new_n252_);
  ...
  assign z11 = z07 | (~x043 & (~new_n254_ | new_n257_));
  ...
  assign new_n278_ = x119 & (~new_n281_ | (~x077 & (~new_n279_ | new_n282_)));
  ...
  assign z14 = ~x046 & ~z07 & (~new_n294_ | (~x054 & (new_n284_ | ~new_n287_)));
