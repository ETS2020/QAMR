...
module FAU ( 
  ...
  assign z06 = (x046 & (~new_n206_ | new_n223_)) | (~x054 & (x038 | x046));
  assign new_n206_ = ~new_n207_ & (new_n211_ | x070) & ~new_n219_ & (new_n214_ | x006);
  ...
  assign new_n211_ = (~x078 | (~new_n212_ & ~new_n213_)) & (x022 | (~x014 & ~x038));
  assign new_n212_ = x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n213_ = ~x006 & x038 & ~x102;
  assign new_n214_ = ~new_n218_ & (~x078 | (new_n217_ & (~x070 | (~new_n215_ & ~new_n216_))));
  assign new_n215_ = x038 & (x014 | x022) & (~x030 | ~x062 | ~x094);
  assign new_n216_ = (~x102 | ~x126) & (x062 | x094 | x022 | ~x038);
  assign new_n217_ = x086 & (~x022 | x126 | (~x110 & ~x118));
  assign new_n218_ = x038 & ~x086;
  assign new_n219_ = x078 & x086 & (new_n222_ | (~x030 & ~new_n220_ & ~new_n221_));
  assign new_n220_ = ~x022 & (~x014 | ~x070);
  assign new_n221_ = x038 & ((~x062 & ~x094) | (x102 & x126));
  assign new_n222_ = ~x038 & (~x062 | ~x094);
  assign new_n223_ = ~x078 & (~x014 | (~x022 & ~x070));
  ...
  assign z14 = (x038 & (~x046 | ~x054)) | (~x046 & (new_n297_ | ~new_n298_ | (~new_n287_ & ~x054)));
  assign new_n287_ = ~new_n288_ & ~new_n295_ & ~new_n296_ & (x078 | (~new_n290_ & new_n293_));
  assign new_n288_ = (x110 | x118) & ((~new_n289_ & ~x078) | (x014 & ~x086));
  assign new_n289_ = (~x006 | x022) & (x086 | (~x022 & (~x030 | (x062 & x094))));
  assign new_n290_ = (~x014 | ~x022) & ((x030 & (new_n292_ | x006)) | (~new_n291_ & x006));
  assign new_n291_ = ~x062 & ~x094;
  assign new_n292_ = ~x086 & (x102 | x126) & (~x062 | ~x094);
  assign new_n293_ = ~new_n294_ & (~x070 | x086 | (new_n291_ & ~x030));
  assign new_n294_ = x006 & (x102 | x126) & (~x022 | ~x062 | ~x094);
  assign new_n295_ = x022 & x070;
  assign new_n296_ = x006 & x086;
  assign new_n297_ = x078 & (new_n296_ | x014);
  assign new_n298_ = (~new_n210_ | ~x006) & (~x022 | ~x070 | x078);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z18 = 1'b0;
  assign z20 = 1'b0;
