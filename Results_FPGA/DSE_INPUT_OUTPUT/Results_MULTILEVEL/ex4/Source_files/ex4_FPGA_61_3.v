...
module FAU ( 
  ...
  assign z05 = x045 & ((~x054 & (~new_n185_ | new_n204_)) | (~new_n202_ & ~x085));
  ...
  assign z06 = (x054 & x085) | (x046 & (~new_n216_ | (x054 & (~new_n206_ | new_n221_))));
  assign new_n206_ = new_n211_ & (x006 | ((~x038 | x086) & (new_n207_ | ~x078)));
  assign new_n207_ = (new_n208_ | ~x070) & ~new_n210_ & x086 & (~x038 | x070 | x102);
  assign new_n208_ = ~new_n209_ & ((x102 & x126) | (~x022 & ~x062 & ~x094));
  assign new_n209_ = (~x030 | ~x062 | ~x094) & (x022 | (x014 & x038));
  assign new_n210_ = x022 & ~x126 & (x110 | x118);
  assign new_n211_ = ~new_n212_ & (x030 | ~new_n214_ | ~x078);
  assign new_n212_ = ~x070 & ((~x022 & (x014 | x038 | ~x078)) | (new_n213_ & x078));
  assign new_n213_ = x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n214_ = x086 & (~x102 | ~x126) & ~new_n215_ & (x062 | x094);
  assign new_n215_ = ~x022 & (~x014 | ~x070);
  assign new_n216_ = new_n217_ & (~x014 | (~new_n220_ & (x006 | x054 | x086)));
  assign new_n217_ = (x038 | (x054 & (new_n218_ | ~x078))) & (x014 | x078) & (new_n219_ | x054);
  assign new_n218_ = ~new_n213_ & (x006 | ~x070 | (x102 & x126));
  assign new_n219_ = (x022 | x070 | ~x078) & (x006 | x078 | x086);
  assign new_n220_ = ~x030 & ~x038 & x070 & x078 & x086;
  ...
  assign z12 = z07 | (~x044 & (~new_n259_ | new_n262_));
  ...
  assign new_n278_ = ~x054 & (~new_n281_ | (~x077 & (~new_n279_ | new_n282_)));
  ...
  assign new_n287_ = (x030 | x062 | x094) & (~x022 | (~x014 & ~x038));
  ...
  assign new_n296_ = (x038 | x070) & (x062 | x094 | (~x022 & x030));
  assign new_n297_ = ~x085 & (x038 | (x022 & x070 & ~x078));
  assign new_n298_ = x022 & ~x038 & x070;
  assign new_n299_ = (~x078 | (x054 & x085)) & (x054 | x086 | (~x110 & ~x118));
  assign new_n300_ = (~x022 | x054 | ~x070) & (~x006 | ~x054 | x085 | ~x086);
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
  assign z20 = 1'b0;
