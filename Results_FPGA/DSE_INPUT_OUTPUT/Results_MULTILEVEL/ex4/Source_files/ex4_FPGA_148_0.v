...
module FAU ( 
  ...
  assign z08 = ~x040 & (~new_n236_ | (~x048 & (new_n227_ | ~new_n232_)));
  assign new_n227_ = ~x080 & (new_n231_ | (~x072 & (new_n230_ | (~new_n228_ & x024))));
  assign new_n228_ = (new_n229_ | (~x104 & (~x120 | (x016 & (x008 | x064))))) & (~x064 | (~x104 & (x016 | ~x120)));
  assign new_n229_ = x056 & x088;
  assign new_n230_ = x064 & ~z17 & (x056 | x088);
  assign new_n231_ = (x104 | (x112 & x120)) & (x008 | (x016 & ~x072));
  assign new_n232_ = ~new_n233_ & (~x000 | x072 | (~new_n235_ & (new_n234_ | ~x120)));
  assign new_n233_ = ~z17 & ((x016 & x064 & x072) | (x000 & ~x072 & x080));
  assign new_n234_ = (x016 | (x064 & x104 & x112)) & (x064 | (new_n229_ & x008));
  assign new_n235_ = x104 & (x016 | ~x032 | ~x064);
  assign new_n236_ = ~new_n240_ & (z17 | (new_n242_ & (new_n237_ | x072)));
  assign new_n237_ = ~new_n238_ & (~new_n239_ | ~x032) & (~x016 | ~x064 | (x032 & ~x048));
  assign new_n238_ = ~x008 & ((x016 & x064) | (x000 & x080));
  assign new_n239_ = ~x080 & (x056 | x088);
  assign new_n240_ = x032 & ~x072 & ~new_n241_ & x120;
  assign new_n241_ = (~x000 | x064) & (x008 | ~x016 | ~x024 | x080);
  ...
  assign z12 = z17 | (~x044 & (~new_n259_ | new_n262_));
  ...
  assign z13 = z17 | (~x045 & (~new_n277_ | (~new_n264_ & ~x053)));
  assign new_n264_ = ~new_n265_ & (~x021 | ~x069 | ~x077) & (x077 | (~new_n269_ & ~new_n274_));
  ...
  assign new_n285_ = ~new_n286_ & (~x022 | ~x070 | ~x078) & (x078 | (~new_n290_ & ~new_n295_));
