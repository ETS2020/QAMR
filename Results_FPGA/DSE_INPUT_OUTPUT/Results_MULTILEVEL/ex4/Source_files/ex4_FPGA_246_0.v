...
module FAU ( 
  ...
  assign z06 = x046 & (~new_n218_ | (x054 & (new_n206_ | ~new_n209_)));
  assign new_n206_ = (~x110 | ~x118) & ((~x014 & x086) | (~new_n207_ & x078));
  assign new_n207_ = (x006 | ((~x022 | ~x070) & (~x038 | x070 | ~x086))) & (~x086 | (~new_n208_ & x022));
  assign new_n208_ = ~x030 & x070 & (x062 | x094);
  assign new_n209_ = (~x078 | ((new_n214_ | ~x086) & (new_n210_ | ~x070))) & (x022 | x070 | x078 | ~x086);
  assign new_n210_ = (~new_n213_ | ~x014) & (x006 | (~new_n211_ & new_n212_));
  assign new_n211_ = (x022 | (x014 & x038)) & (~x030 | ~x062 | ~x094);
  assign new_n212_ = x086 & ((x102 & x126) | (~x022 & ~x062 & ~x094));
  assign new_n213_ = ~x030 & x086 & (~x102 | ~x126) & (x062 | x094);
  assign new_n214_ = ~new_n217_ & (~x022 | (~new_n216_ & (new_n215_ | x126)));
  assign new_n215_ = (x006 | (~x110 & ~x118)) & (x030 | (~x062 & ~x094));
  assign new_n216_ = ~x030 & (~x070 | (~x102 & (x062 | x094)));
  assign new_n217_ = ~x070 & (~x062 | ~x094 | (~x006 & x038 & ~x102));
  assign new_n218_ = ~new_n219_ & (new_n220_ | ~x078) & (x006 | ~x070 | ~new_n225_ | x078);
  assign new_n219_ = ~z15 & ((~x038 & ~x054) | (~x014 & ~x078));
  assign new_n220_ = (~new_n224_ | x006) & (~x086 | (~new_n221_ & ~new_n222_ & ~new_n223_));
  assign new_n221_ = x014 & ((~x022 & ~x070) | (~x030 & ~x038 & x070));
  assign new_n222_ = ~x022 & ~x070 & (x038 | ~x054);
  assign new_n223_ = ~x038 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n224_ = x070 & ((~x038 & (~x102 | ~x126)) | (x014 & ~x086));
  assign new_n225_ = ~x086 & (x038 | ~x054);
  assign z08 = z15 | (~x040 & (~new_n240_ | (~new_n227_ & ~x048)));
  ...
  assign z14 = z15 | (~x046 & (~new_n298_ | (~new_n289_ & ~x054)));
  assign new_n289_ = (new_n294_ | new_n295_) & ~new_n296_ & ~new_n297_ & (new_n290_ | ~x006);
  assign new_n290_ = new_n293_ & (x078 | (~new_n291_ & new_n292_));
  assign new_n291_ = ~x022 & x126 & (~x110 | ~x118);
  assign new_n292_ = x070 & ~x086 & (x038 | ~x102);
  assign new_n293_ = (x038 | (x070 & ~x086)) & (~x022 | ~x070 | ~x086);
  assign new_n294_ = ~x110 & ~x118;
  assign new_n295_ = (x086 | (~x014 & ~x022)) & (~x006 | x038 | x078);
  assign new_n296_ = ~x086 & (((x062 | x094) & (x022 | ~x078)) | (~x022 & x030 & ~x078));
  assign new_n297_ = x022 & x070 & (~x014 | ~x038 | x078);
  assign new_n298_ = (~x054 | (new_n300_ & (~x006 | new_n299_ | (x014 & ~x078)))) & (~x014 | ~x078);
  assign new_n299_ = x070 & ~x086;
  assign new_n300_ = ~x038 & (~x022 | ~x070 | x078);
  assign z07 = 1'b0;
  assign z19 = 1'b0;
  assign z22 = 1'b0;
  assign z27 = 1'b0;
