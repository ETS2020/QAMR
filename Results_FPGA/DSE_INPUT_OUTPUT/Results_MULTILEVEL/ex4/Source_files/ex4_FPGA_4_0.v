...
module FAU ( 
  ...
  assign z06 = z07 | (x046 & (~new_n204_ | (~new_n224_ & ~x054)));
  assign new_n204_ = (x078 | (new_n223_ & x014)) & ~new_n220_ & (~x078 | (~new_n205_ & new_n217_));
  assign new_n205_ = x054 & (new_n206_ | new_n215_ | new_n216_ | new_n209_ | new_n213_);
  assign new_n206_ = (new_n207_ | new_n208_) & (~x110 | ~x118);
  assign new_n207_ = ~x006 & (x070 ? x022 : x038);
  assign new_n208_ = x086 & (~x022 | (~x030 & x070 & (x062 | x094)));
  assign new_n209_ = (~x102 | ~x126) & ((~new_n211_ & ~new_n212_) | (new_n210_ & ~x006));
  assign new_n210_ = x022 & x070;
  assign new_n211_ = ~x062 & ~x094;
  assign new_n212_ = (x030 | ~x086 | (~x022 & (~x014 | ~x070))) & (x006 | ~x070);
  assign new_n213_ = ~x006 & (~new_n214_ | (~x030 & (x022 | (x014 & x070))));
  assign new_n214_ = x086 & (~x022 | x126 | (~x110 & ~x118));
  assign new_n215_ = (~x070 | (~x006 & (x014 | x022))) & (~x062 | ~x094);
  assign new_n216_ = ~x070 & ((x022 & ~x030) | (~x006 & x038 & ~x102));
  assign new_n217_ = ~new_n218_ & (~new_n219_ | x038);
  assign new_n218_ = x014 & ((~x030 & ~x038 & x070 & x086) | (~x006 & ~x086));
  assign new_n219_ = x070 & x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n220_ = x054 & (new_n221_ | new_n222_);
  assign new_n221_ = (~x110 | ~x118) & ((~x022 & ~x070) | (~x014 & (~x070 | x086)));
  assign new_n222_ = ~x022 & ~x070 & (x014 | x038 | ~x062 | ~x094);
  assign new_n223_ = (x022 | ~x054 | x070) & (x006 | ~x038 | x086);
  assign new_n224_ = x038 & (x022 | x070 | ~x078) & (x006 | x078 | x086);
  ...
  assign z14 = ~x046 & ((~new_n282_ & ~x078) | ~new_n290_ | (~new_n288_ & x078));
  assign new_n282_ = (x014 | (~new_n210_ & (~x006 | ~x086))) & ~new_n283_ & (~x006 | x054 | ~x086);
  assign new_n283_ = x070 & (new_n284_ | (~new_n286_ & ~x054) | (x022 & (~x038 | x054)));
  assign new_n284_ = ~new_n285_ & ((x022 & ~x086) | (x006 & ~x038 & ~x054));
  assign new_n285_ = ~x110 & ~x118;
  assign new_n286_ = (new_n287_ | ~x006) & (x086 | (new_n211_ & (x022 | ~x030)));
  assign new_n287_ = (x038 | ~x102) & (x022 | ~x126 | (x110 & x118));
  assign new_n288_ = (~x086 | (~new_n289_ & ~x014)) & (~x070 | (~x014 & (~x022 | x054)));
  assign new_n289_ = x006 & (~x038 | x054);
  assign new_n290_ = (~x070 | ((~x038 | ~x054) & (~x014 | x054 | new_n285_ | x086))) & (~x038 | ~x054 | ~x086);
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z25 = 1'b0;
  assign z26 = 1'b0;
