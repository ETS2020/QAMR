...
module FAU ( 
  ...
  assign z04 = x044 & ((~new_n180_ & (x081 | x084)) | (~x004 & x081 & ~new_n181_ & ~x084));
  ...
  assign new_n249_ = (~x009 | ~x073) & (~x065 | x073 | x009 | ~x017);
  ...
  assign z12 = z22 | (~x044 & (~new_n262_ | new_n266_));
  assign new_n262_ = (new_n263_ | x052) & (new_n264_ | ~x084) & new_n265_ & (~x036 | ~x052);
  assign new_n263_ = (x012 | ~x020 | ~x068) & (~x004 | ~x012 | ~x084);
  assign new_n264_ = (~x004 | (x012 ? ~x036 : x076)) & (~x036 | ~x068 | x012 | ~x020);
  assign new_n265_ = (~x012 | ~x076) & (~x068 | x076 | x012 | ~x020);
  assign new_n266_ = ~x036 & ((x012 & x020 & x068) | (x004 & ~x012 & x084));
  assign z13 = ~x045 & ~z22 & (~new_n281_ | (~new_n268_ & ~x053));
  ...
  assign z14 = ~x046 & ~z22 & (~new_n302_ | (~new_n289_ & ~x054));
