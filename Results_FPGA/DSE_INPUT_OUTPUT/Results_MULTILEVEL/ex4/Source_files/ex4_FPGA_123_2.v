// Benchmark "FAU" written by ABC on Sat Aug 22 17:59:16 2020
...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (new_n185_ | ~new_n203_ | (~new_n198_ & x077)));
  assign new_n185_ = x053 & (new_n186_ | new_n197_ | (x077 & (new_n190_ | new_n194_)));
  assign new_n186_ = (~x109 | ~x117) & (new_n189_ | (x077 & (new_n187_ | new_n188_)));
  assign new_n187_ = ~x005 & (x069 ? x021 : x037);
  assign new_n188_ = x085 & (~x021 | (~x029 & x069 & (x061 | x093)));
  assign new_n189_ = ~x013 & x085;
  assign new_n190_ = ~x005 & ((x069 & (new_n191_ | new_n192_)) | ~x085 | (~new_n193_ & ~x069));
  assign new_n191_ = (x013 | x021) & (~x093 | (x037 & (~x029 | ~x061)));
  assign new_n192_ = (x061 | x093) & (~x101 | ~x125);
  assign new_n193_ = (~x021 | x125 | (~x109 & ~x117)) & (~x037 | x101);
  assign new_n194_ = x085 & (new_n195_ | (~x029 & new_n196_ & (~x101 | ~x125)));
  assign new_n195_ = ~x069 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n196_ = (x061 | x093) & (x021 | (x013 & x069));
  assign new_n197_ = ~x021 & ~x069 & ~x077;
  assign new_n198_ = new_n199_ & (x005 | (~new_n202_ & (x037 | ~x069 | x093)));
  assign new_n199_ = ~new_n200_ & (x021 | x069 | (~x037 & x053)) & (~new_n201_ | x037);
  assign new_n200_ = x013 & ((~x021 & ~x069) | (~x029 & ~x037 & x069 & x085));
  assign new_n201_ = x085 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n202_ = x013 & ~x085;
  assign new_n203_ = (x037 | x053) & (x077 | (x013 & (x005 | x085 | (~x037 & x053))));
  assign z06 = (x054 & ~x093) | (x046 & (~new_n218_ | (x054 & (new_n205_ | ~new_n208_))));
  assign new_n205_ = (~x110 | ~x118) & ((~new_n206_ & x078) | (~x014 & x086));
  assign new_n206_ = (x006 | (x070 ? ~x022 : ~x038)) & (~x086 | (~new_n207_ & x022));
  assign new_n207_ = ~x030 & x070 & (x062 | x094);
  assign new_n208_ = ~new_n214_ & ~new_n216_ & (x006 | (~new_n209_ & (~x038 | x086)));
  assign new_n209_ = x078 & ((x070 & (new_n210_ | new_n211_)) | new_n212_ | ~new_n213_);
  ...
  assign new_n213_ = x086 & (~x038 | x070 | x102);
  assign new_n214_ = ~x070 & ((~x022 & (x014 | x038 | ~x078)) | (new_n215_ & x078));
  assign new_n215_ = x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n216_ = ~x030 & x078 & x086 & new_n217_ & (~x102 | ~x126);
  assign new_n217_ = (x062 | x094) & (x022 | (x014 & x070));
  assign new_n218_ = (new_n219_ | ~x014) & (new_n221_ | x038) & ~new_n223_ & (x014 | x078);
  assign new_n219_ = (~new_n220_ | ~x070 | ~x078 | ~x086) & (x006 | x054 | x086);
  assign new_n220_ = ~x030 & ~x038;
  assign new_n221_ = x054 & (~x078 | (~new_n215_ & ~new_n222_));
  assign new_n222_ = ~x006 & x070 & (~x102 | ~x126);
  assign new_n223_ = ~x054 & ((~x022 & ~x070 & x078) | (~x006 & ~x078 & ~x086));
  assign z08 = z16 | (~x040 & (~new_n238_ | (~new_n225_ & ~x048)));
  assign new_n225_ = ~new_n226_ & (~x016 | ~x064 | ~x072) & (x072 | (~new_n230_ & ~new_n235_));
  ...
  assign z09 = ~x041 & ~z16 & (~new_n246_ | new_n249_);
  ...
  assign z10 = z16 | (~x042 & (~new_n251_ | new_n254_));
  ...
  assign z11 = ~x043 & ~z16 & (~new_n256_ | new_n259_);
  ...
  assign z12 = z16 | (~x044 & (~new_n261_ | new_n264_));
  ...
  assign z13 = z16 | (~x045 & (~new_n279_ | (~new_n266_ & ~x053)));
  assign new_n266_ = ~new_n267_ & ~new_n278_ & (x077 | (~new_n270_ & (new_n274_ | x085)));
  assign new_n267_ = (x109 | x117) & (new_n202_ | (~x077 & (new_n268_ | new_n269_)));
  assign new_n268_ = x005 & ((~x021 & ~x069) | (~x037 & x069 & ~x093));
  assign new_n269_ = ~x085 & (x021 | (x029 & (x093 ? ~x061 : ~x069)));
  assign new_n270_ = x005 & (new_n271_ | ~new_n273_ | (~new_n272_ & x125));
  assign new_n271_ = (~x013 | ~x021) & (x093 | (~x069 & (x029 | x061)));
  assign new_n272_ = (x069 | x093) & (x061 | ~x093) & (x021 | (x109 & x117));
  assign new_n273_ = ~x085 & (~x101 | (x093 ? x061 : (x037 & x069)));
  assign new_n274_ = (new_n275_ | ~x069) & (~x029 | ((new_n276_ | new_n277_) & (x021 | ~x069)));
  assign new_n275_ = ~x061 & ~x093;
  assign new_n276_ = ~x101 & ~x125;
  assign new_n277_ = (x013 | (x093 ? x061 : x069)) & (x021 | (x061 & x093));
  assign new_n278_ = x021 & x069 & x077;
  assign new_n279_ = new_n284_ & (x077 | (~new_n280_ & new_n281_));
  assign new_n280_ = x005 & (new_n189_ | (x037 & x093));
  assign new_n281_ = ~new_n282_ & (~new_n283_ | ~x037) & (~x021 | ~x069 | (x037 & ~x053));
  assign new_n282_ = ~x013 & ((x021 & x069) | (x029 & x037 & ~x069 & ~x085));
  assign new_n283_ = ~x085 & (x061 | x093 | (~x021 & x029));
  assign new_n284_ = (~x037 | ~x053) & (~x077 | (~x013 & (~x005 | ~x085 | (x037 & ~x053))));
  assign z14 = (x054 & ~x093) | (~x046 & (~new_n299_ | (~x054 & (new_n286_ | ~new_n289_))));
  assign new_n286_ = (x110 | x118) & ((x014 & ~x086) | (~new_n287_ & ~x078));
