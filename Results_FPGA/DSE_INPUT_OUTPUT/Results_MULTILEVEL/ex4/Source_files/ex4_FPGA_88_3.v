// Benchmark "FAU" written by ABC on Sat Aug 22 17:58:56 2020
...
module FAU ( 
  ...
  assign z03 = x043 & ~z20 & (~new_n175_ | new_n178_);
  ...
  assign z04 = z20 | (x044 & (~new_n180_ | new_n183_));
  ...
  assign z05 = z20 | (x045 & (~new_n194_ | (~new_n185_ & x053)));
  assign new_n185_ = (new_n190_ | new_n191_) & ~new_n192_ & ~new_n193_ & (new_n186_ | x005);
  assign new_n186_ = new_n189_ & (~x077 | (~new_n187_ & new_n188_));
  assign new_n187_ = x021 & ~x125 & (x109 | x117);
  assign new_n188_ = ~x069 & x085 & (~x037 | x101);
  assign new_n189_ = (~x037 | (~x069 & x085)) & (x021 | x069 | x085);
  assign new_n190_ = x109 & x117;
  assign new_n191_ = (~x085 | (x013 & x021)) & (x005 | ~x037 | ~x077);
  assign new_n192_ = x085 & (((~x021 | x077) & (~x061 | ~x093)) | (x021 & ~x029 & x077));
  assign new_n193_ = ~x021 & ~x069 & (x013 | x037 | ~x077);
  assign new_n194_ = (x053 | (new_n196_ & (x005 | new_n195_ | (~x013 & x077)))) & (x013 | x077);
  assign new_n195_ = ~x069 & x085;
  assign new_n196_ = x037 & (x021 | x069 | ~x077);
  assign z06 = x046 & ~z20 & (~new_n211_ | (~new_n198_ & x054));
  assign new_n198_ = ~new_n199_ & (~x078 | (~new_n203_ & ~new_n208_)) & (x022 | x070 | x078);
  assign new_n199_ = ~new_n200_ & ((~x014 & x086) | (x078 & (new_n201_ | (~new_n202_ & x086))));
  ...
  assign new_n209_ = ~x070 & (~x062 | ~x094 | (x022 & ~x030));
  assign new_n210_ = (x062 | x094) & (x022 | (x014 & x070));
  assign new_n211_ = new_n217_ & (~x078 | (~new_n212_ & new_n215_));
  assign new_n212_ = ~x038 & ((~new_n213_ & x086) | (~new_n214_ & x070));
  ...
  assign z08 = ~x040 & ~z20 & (~new_n232_ | (~new_n219_ & ~x048));
  ...
  assign z09 = ~x041 & ~z20 & (~new_n240_ | new_n243_);
  ...
  assign z10 = z20 | (~x042 & (~new_n245_ | new_n248_));
  ...
  assign z11 = z20 | (~x043 & (~new_n250_ | new_n253_));
  ...
  assign z12 = ~x044 & ~z20 & (~new_n255_ | new_n258_);
  ...
  assign z13 = ~x045 & (~new_n272_ | (~x053 & (new_n260_ | ~new_n263_)));
  assign new_n260_ = (x109 | x117) & ((~new_n261_ & ~x077) | (x013 & ~x085));
  assign new_n261_ = (~x005 | ((x021 | x069) & (x037 | ~x069 | x085))) & (x085 | (~new_n262_ & ~x021));
  assign new_n262_ = x029 & ~x069 & (~x061 | ~x093);
  assign new_n263_ = (x077 | ((new_n264_ | x069) & (new_n268_ | x085))) & (~x021 | ~x069 | ~x077 | x085);
  assign new_n264_ = (~x005 | (~new_n265_ & new_n266_)) & (~new_n267_ | x013);
  assign new_n265_ = (~x021 | (~x013 & ~x037)) & (x029 | x061 | x093);
  assign new_n266_ = ~x085 & ((~x101 & ~x125) | (x021 & x061 & x093));
  assign new_n267_ = x029 & ~x085 & (x101 | x125) & (~x061 | ~x093);
  assign new_n268_ = ~new_n271_ & (x021 | (~new_n270_ & (new_n269_ | ~x125)));
  assign new_n269_ = (~x005 | (x109 & x117)) & (~x029 | (x061 & x093));
  assign new_n270_ = x029 & (x069 | (x101 & (~x061 | ~x093)));
  assign new_n271_ = x069 & (x061 | x093 | (x005 & ~x037 & x101));
  assign new_n272_ = ~new_n273_ & (new_n274_ | x077) & (~x005 | x069 | ~new_n279_ | ~x077);
  assign new_n273_ = ~z20 & ((x037 & x053) | (x013 & x077));
  assign new_n274_ = (~new_n278_ | ~x005) & (x085 | (~new_n275_ & ~new_n276_ & ~new_n277_));
  assign new_n275_ = ~x013 & ((x021 & x069) | (x029 & x037 & ~x069));
  assign new_n276_ = x021 & x069 & (~x037 | x053);
  assign new_n277_ = x037 & (x061 | x093 | (~x021 & x029));
  assign new_n278_ = ~x069 & ((x037 & (x101 | x125)) | (~x013 & x085));
  assign new_n279_ = x085 & (~x037 | x053);
  assign z14 = ~x046 & ~z20 & (~new_n294_ | (~new_n281_ & ~x054));
  assign new_n281_ = ~new_n282_ & (x078 | (~new_n286_ & ~new_n291_)) & (~x022 | ~x070 | ~x078);
  assign new_n282_ = ~new_n283_ & ((~x078 & (new_n284_ | (~new_n285_ & ~x086))) | (x014 & ~x086));
  assign new_n283_ = ~x110 & ~x118;
  assign new_n284_ = x006 & (x070 ? ~x038 : ~x022);
  assign new_n285_ = ~x022 & (~x030 | x070 | (x062 & x094));
  ...
  assign new_n291_ = ~x086 & (new_n292_ | (x030 & new_n293_ & (x102 | x126)));
  assign new_n292_ = x070 & (x062 | x094 | (~x022 & x030));
  assign new_n293_ = (~x062 | ~x094) & (~x022 | (~x014 & ~x070));
  assign new_n294_ = new_n300_ & (x078 | (~new_n295_ & new_n298_));
  ...
  assign new_n300_ = (~x038 | ~x054) & (~x078 | (~x014 & (~x006 | ~x086 | (x038 & ~x054))));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
