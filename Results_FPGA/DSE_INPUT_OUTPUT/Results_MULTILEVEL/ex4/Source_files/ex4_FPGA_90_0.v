...
module FAU ( 
  ...
  assign z08 = ~x040 & ~z07 & (~new_n244_ | (~new_n231_ & ~x048));
  ...
  assign z09 = z07 | (~x041 & (~new_n252_ | new_n255_));
  ...
  assign z13 = ~x045 & ~z07 & (~new_n285_ | (~new_n272_ & ~x053));
  ...
  assign z14 = ~x046 & (~new_n293_ | (x006 & x086 & (~x014 | x078)));
  assign new_n293_ = ~x038 & (~x014 | ~x078) & x054 & (~x022 | ~x070 | x078);
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
  assign z20 = 1'b0;
