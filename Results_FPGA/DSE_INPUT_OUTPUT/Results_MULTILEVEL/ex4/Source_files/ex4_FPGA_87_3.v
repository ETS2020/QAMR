...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n202_ & ~x085) | (~x106 & (~new_n185_ | new_n204_)));
  ...
  assign z06 = z15 | (x046 & (~new_n218_ | (x054 & (new_n206_ | ~new_n210_))));
  ...
  assign z10 = ~x042 & ~z15 & (~new_n249_ | new_n252_);
  ...
  assign z11 = ~x043 & ~z15 & (~new_n254_ | new_n257_);
  ...
  assign new_n278_ = ~x106 & (~new_n281_ | (~x077 & (~new_n279_ | new_n282_)));
