...
module FAU ( 
  ...
  assign z08 = ~x040 & ~z16 & (~new_n238_ | (~new_n225_ & ~x048));
  ...
  assign z10 = ~x042 & ~z16 & (~new_n251_ | new_n254_);
  ...
  assign z11 = z16 | (~x043 & (~new_n256_ | new_n259_));
  ...
  assign z12 = ~x044 & ~z16 & (~new_n261_ | new_n264_);
  ...
  assign z13 = ~x045 & ~z16 & (~new_n279_ | (~new_n266_ & ~x053));
