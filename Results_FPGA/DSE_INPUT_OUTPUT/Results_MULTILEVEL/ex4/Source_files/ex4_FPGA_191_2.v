...
module FAU ( 
  ...
  assign z06 = x046 & (~new_n206_ | (~x078 & (~x014 | (~x022 & ~x070))));
  assign new_n206_ = ~new_n207_ & ~new_n211_ & (new_n215_ | x006) & ~new_n220_ & x054;
  ...
  assign new_n215_ = ~new_n219_ & (~x078 | (new_n218_ & (~x070 | (~new_n216_ & ~new_n217_))));
  assign new_n216_ = (x022 | (x014 & x038)) & (~x030 | ~x062 | ~x094);
  assign new_n217_ = (~x102 | ~x126) & (x062 | x094 | x022 | ~x038);
  assign new_n218_ = x086 & (~x022 | x126 | (~x110 & ~x118));
  assign new_n219_ = x038 & ~x086;
  assign new_n220_ = x078 & x086 & (new_n223_ | (~x030 & ~new_n221_ & ~new_n222_));
  assign new_n221_ = ~x022 & (~x014 | ~x070);
  assign new_n222_ = x038 & ((~x062 & ~x094) | (x102 & x126));
  assign new_n223_ = ~x038 & (~x062 | ~x094);
  ...
  assign z14 = ~x046 & (~new_n300_ | new_n303_ | (~x054 & (new_n287_ | ~new_n290_)));
  assign new_n287_ = (x110 | x118) & ((~new_n288_ & ~x078) | (x014 & ~x086));
  assign new_n288_ = (~x006 | (x070 ? x038 : x022)) & (x086 | (~new_n289_ & ~x022));
  assign new_n289_ = x030 & ~x070 & (~x062 | ~x094);
  assign new_n290_ = ~new_n296_ & ~new_n298_ & (~x006 | (~new_n291_ & (x038 | ~x086)));
  assign new_n291_ = ~x078 & (new_n294_ | ~new_n295_ | (~x070 & (new_n292_ | new_n293_)));
  assign new_n292_ = (~x022 | (~x014 & ~x038)) & (x030 | x062 | x094);
  assign new_n293_ = (x102 | x126) & (~x022 | ~x062 | ~x094);
  assign new_n294_ = ~x022 & x126 & (~x110 | ~x118);
  ...
  assign new_n298_ = x030 & ~x078 & ~x086 & new_n299_ & (x102 | x126);
  assign new_n299_ = (~x062 | ~x094) & (~x022 | (~x014 & ~x070));
  assign new_n300_ = (~x038 | (~x054 & (new_n301_ | x078))) & (~x014 | ~x078) & (new_n302_ | ~x054);
  assign new_n301_ = ~new_n297_ & (~x006 | x070 | (~x102 & ~x126));
  assign new_n302_ = (~x022 | ~x070 | x078) & (~x006 | ~x078 | ~x086);
  assign new_n303_ = ~x014 & (new_n304_ | (x006 & x054 & x086));
  assign new_n304_ = x030 & x038 & ~x070 & ~x078 & ~x086;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
  assign z19 = 1'b0;
