...
module FAU ( 
  ...
  assign z05 = z07 | (x045 & (~new_n185_ | (~new_n204_ & ~x053)));
  assign new_n185_ = (x077 | (new_n203_ & x013)) & ~new_n200_ & (~x077 | (~new_n186_ & new_n197_));
  assign new_n186_ = x053 & (new_n187_ | new_n195_ | new_n196_ | new_n190_ | new_n193_);
  ...
  assign new_n190_ = (~x101 | ~x125) & (new_n192_ | (~new_n191_ & (x061 | x093)));
  assign new_n191_ = (x029 | ~x085 | (~x021 & (~x013 | ~x069))) & (x005 | ~x069);
  assign new_n192_ = ~x005 & x021 & x069;
  assign new_n193_ = ~x005 & (~new_n194_ | (~x029 & (x021 | (x013 & x069))));
  assign new_n194_ = x085 & (~x021 | x125 | (~x109 & ~x117));
  assign new_n195_ = (~x069 | (~x005 & (x013 | x021))) & (~x061 | ~x093);
  assign new_n196_ = ~x069 & ((x021 & ~x029) | (~x005 & x037 & ~x101));
  assign new_n197_ = ~new_n198_ & (~new_n199_ | x037);
  assign new_n198_ = x013 & ((~x029 & ~x037 & x069 & x085) | (~x005 & ~x085));
  assign new_n199_ = x069 & x085 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n200_ = x053 & (new_n201_ | new_n202_);
  assign new_n201_ = (~x109 | ~x117) & ((~x021 & ~x069) | (~x013 & (~x069 | x085)));
  assign new_n202_ = ~x021 & ~x069 & (~x061 | ~x093 | x013 | x037);
  assign new_n203_ = (x021 | ~x053 | x069) & (x005 | ~x037 | x085);
  assign new_n204_ = x037 & (x021 | x069 | ~x077) & (x005 | x077 | x085);
  assign z06 = x046 & ~z07 & (~new_n218_ | (x054 & (new_n206_ | ~new_n210_)));
  ...
  assign z13 = z07 | (~x045 & (~new_n271_ | (~new_n264_ & ~x053)));
  assign new_n264_ = (new_n268_ | (~x109 & ~x117)) & ~new_n269_ & ~new_n265_ & ~new_n270_;
  assign new_n265_ = x005 & (new_n266_ | (x021 & x069 & x085) | (~x037 & (~x069 | x085)));
  assign new_n266_ = ~x077 & (~new_n267_ | (~x021 & x125 & (~x109 | ~x117)));
  assign new_n267_ = x069 & ~x085 & (x037 | ~x101);
  assign new_n268_ = (x085 | (~x013 & ~x021)) & (~x005 | x037 | x077);
  assign new_n269_ = ~x085 & (((x061 | x093) & (x021 | ~x077)) | (~x021 & x029 & ~x077));
  assign new_n270_ = x021 & x069 & (~x013 | ~x037 | x077);
  assign new_n271_ = (~x013 | ~x077) & (~x053 | (new_n273_ & (~x005 | new_n272_ | (x013 & ~x077))));
  assign new_n272_ = x069 & ~x085;
  assign new_n273_ = ~x037 & (~x021 | ~x069 | x077);
  ...
  assign new_n277_ = x030 & ~new_n217_ & ~x070;
  ...
  assign new_n280_ = ~new_n281_ & ((~x102 & ~x126) | (new_n217_ & x022));
  assign new_n281_ = (~x022 | (~x014 & ~x038)) & (x030 | x062 | x094);
  assign new_n282_ = ~x022 & x126 & (~x110 | ~x118);
  assign new_n283_ = ~x086 & ((new_n284_ & x030) | (x070 & (~new_n209_ | (~x022 & x030))));
  assign new_n284_ = (x102 | x126) & ~new_n217_ & (~x022 | (~x014 & ~x070));
  assign new_n285_ = (x078 | (new_n288_ & (new_n286_ | ~x038))) & (~x038 | ~x054) & (new_n290_ | ~x078);
  assign new_n286_ = (new_n287_ | x070) & (x086 | (new_n209_ & (x022 | ~x030)));
