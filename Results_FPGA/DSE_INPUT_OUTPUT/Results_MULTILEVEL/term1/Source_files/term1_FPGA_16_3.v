...
module FAU ( 
  ...
  assign z5 = x01 & (x26 | (new_n57_ & x25));
  ...
  assign z7 = ~x01 | (~x26 & (~new_n61_ | new_n65_));
  assign new_n61_ = ~new_n62_ & new_n64_ & (~x02 | ~x03);
  assign new_n62_ = (x19 | x24) & new_n63_ & (x18 | x23);
  assign new_n63_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n64_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n65_ = x31 & (~x27 | ~x28 | ~x29 | ~x30);
  assign z8 = (x01 & x26) | (x00 & ~x26 & (~new_n71_ | (new_n67_ & x29)));
  ...
  assign z9 = (x01 & x26) | (x00 & ~x26 & (~new_n81_ | (new_n80_ & x29)));
