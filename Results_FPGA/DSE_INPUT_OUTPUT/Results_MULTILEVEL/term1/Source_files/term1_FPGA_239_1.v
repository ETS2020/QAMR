...
module FAU ( 
  ...
  assign z8 = ~x26 & (x33 | (x00 & (new_n70_ | new_n75_)));
  assign new_n70_ = x31 & ~new_n71_ & ~new_n74_;
  ...
  assign new_n74_ = (~x29 | (~x27 & ~x28) | (~x30 ^ ~x32)) & (~x30 | x32 | (x29 & (x27 | x28)));
  assign new_n75_ = x32 & (new_n81_ | (~new_n80_ & ~x30) | new_n76_ | ~new_n78_);
