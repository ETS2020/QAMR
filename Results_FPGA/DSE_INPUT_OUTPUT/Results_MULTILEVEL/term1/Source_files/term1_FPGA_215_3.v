...
module FAU ( 
  ...
  assign new_n59_ = (~x29 | (x27 & x28) | new_n55_ | (x26 & ~x30)) & (x26 | ~x27 | ~x28 | new_n55_ | x29);
  assign z6 = new_n47_ | (x01 & x25 & new_n61_ & (~x02 | ~x03));
  assign new_n61_ = ~new_n55_ & (x29 ? ((x30 & (~x27 | ~x28)) | (~x26 & x27 & x28 & ~x30)) : x30);
  ...
  assign new_n69_ = (new_n70_ | (x26 & ~x30)) & (x26 | x30 | (~new_n76_ & x29)) & (~x29 | new_n76_ | ~x30);
  assign new_n70_ = ~new_n71_ & ~new_n72_ & ~new_n73_ & ~new_n74_ & new_n75_;
  ...
  assign new_n77_ = ~new_n78_ & ((~x26 & x29 & ~new_n76_ & ~x30) | (x30 & (new_n76_ | ~x29)));
  ...
  assign z9 = new_n47_ | (x00 & (x33 ? (new_n82_ | ~new_n85_) : new_n84_));
  assign new_n82_ = (~x26 | x30) & (new_n71_ | new_n72_ | ~new_n83_ | new_n73_);
  assign new_n83_ = ~new_n74_ & (x13 | x18) & (x17 | (x12 & x18));
  assign new_n84_ = ~new_n78_ & ((~x26 & ~x30 & ~x31 & (new_n76_ | ~x29)) | (x29 & x30 & ~new_n76_ & x31));
  assign new_n85_ = (x26 | x30 | (~x31 & (new_n76_ | ~x29))) & (~x30 | (~new_n76_ & x29 & x31));
endmodule
