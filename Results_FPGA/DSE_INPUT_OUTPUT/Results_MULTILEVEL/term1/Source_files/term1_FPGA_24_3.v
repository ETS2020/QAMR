...
module FAU ( 
  ...
  assign new_n61_ = ~new_n55_ & ((~x29 & x30) | (~x26 & x29 & ((x30 & (~x27 | ~x28)) | (x27 & x28 & ~x30))));
  ...
  assign z9 = new_n47_ | (x00 & (x33 ? (new_n83_ | ~new_n86_) : new_n85_));
  assign new_n83_ = (~x26 | x30) & (new_n77_ | new_n78_ | ~new_n84_ | new_n79_);
  assign new_n84_ = ~new_n80_ & (x13 | x18) & (x17 | (x12 & x18));
  assign new_n85_ = ~new_n70_ & ((~x26 & ~x30 & ~x31 & (new_n73_ | ~x29)) | (x29 & x30 & ~new_n73_ & x31));
  assign new_n86_ = (x26 | x30 | (~x31 & (new_n73_ | ~x29))) & (~x30 | (~new_n73_ & x29 & x31));
endmodule
