...
module FAU ( 
  ...
  assign z7 = (~x26 & (new_n66_ | ~new_n64_ | (new_n62_ & x17))) | (x22 & (new_n62_ | x26));
  assign new_n62_ = new_n63_ & (x19 | x24);
  assign new_n63_ = (x18 | x23) & (x16 | x21) & (x15 | x20);
  assign new_n64_ = new_n65_ & x01 & (~x02 | ~x03);
  assign new_n65_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n66_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign z8 = (~x22 & x26) | (x00 & ~x26 & (~new_n72_ | (new_n68_ & x29)));
  ...
  assign z9 = (~x22 & x26) | (x00 & ~x26 & (~new_n82_ | (new_n81_ & x29)));
