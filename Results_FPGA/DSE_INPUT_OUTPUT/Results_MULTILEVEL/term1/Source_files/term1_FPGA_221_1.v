...
module FAU ( 
  ...
  assign new_n58_ = ~new_n55_ & (~x02 | ~x03) & (x27 ? (~x28 & ~x29) : x28);
  assign z5 = new_n47_ | (x01 & x25 & new_n60_ & ~x26);
  assign new_n60_ = ~new_n55_ & (~x02 | ~x03) & (x27 ? (x28 & ~x29) : x29);
  assign z6 = x01 & x25 & ~x26 & new_n62_ & (~x02 | ~x03);
  assign new_n62_ = ~new_n55_ & ((~x29 & x30) | (x28 & x29 & (x27 ^ x30)));
  assign z7 = (~new_n64_ & (x28 | ~x29)) | (~x29 & x31) | (x28 & ((x31 & (~x27 | ~x30)) | (x30 & ~x31 & x27 & x29)));
  ...
  assign new_n68_ = ~new_n69_ & ((~x29 & x30) | (x28 & x29 & ~x30));
  ...
  assign new_n72_ = ((x29 & (~x28 | x30)) | (~new_n73_ & new_n75_ & ~new_n77_)) & (x29 | x30) & (~x28 | ~x29 | ~x30);
  assign new_n73_ = ~x19 & (~new_n74_ | ~x15 | ~x16);
  assign new_n74_ = x17 & x18;
  assign new_n75_ = (x15 | (new_n74_ & x10 & x16)) & new_n76_ & (x16 | (new_n74_ & x11));
  assign new_n76_ = (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign new_n77_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign z9 = x00 & ~x26 & (x33 ? ~new_n80_ : new_n79_);
  assign new_n79_ = ~new_n69_ & ((x28 & x29 & x30 & x31) | (~x29 & ~x30 & ~x31));
  assign new_n80_ = ((x29 & (~x28 | ~x30)) | (new_n81_ & ~new_n77_)) & (~x28 | (x30 ? x31 : ~x29)) & (x29 | (~x30 & ~x31));
  assign new_n81_ = (x19 | (new_n74_ & x15 & x16)) & new_n82_ & (x15 | (new_n74_ & x10 & x16));
