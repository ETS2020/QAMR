...
module FAU ( 
  ...
  assign z8 = (x26 & x33) | (x00 & ~x26 & (~new_n74_ | (new_n69_ & x29)));
  ...
  assign z9 = new_n47_ | (x00 & (new_n84_ | new_n85_ | (new_n83_ & x29)));
  assign new_n83_ = ~new_n73_ & ((~x30 & x33) | (~x26 & x30 & x31 & ~new_n70_ & ~x33));
  assign new_n84_ = ~new_n75_ & ((x30 & x33) | (~x26 & ~x30 & ~x31 & ~new_n70_ & ~x33));
  assign new_n85_ = x33 & (new_n77_ | new_n78_ | new_n79_ | new_n80_ | ~new_n86_);
