...
module FAU ( 
  ...
  assign new_n56_ = ~x03 & (~x01 | ~x25 | new_n53_ | ((x03 | x27 | ~x28) & (~x27 | x28)));
  assign z5 = ~x26 & (new_n58_ | x03);
  ...
  assign new_n63_ = x01 & ~x03 & x25 & ~new_n64_ & ~x26;
  assign new_n64_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n65_ = (x17 | x22) & (x16 | x21) & (x15 | x20);
  assign z8 = ~x26 & (x03 | (x00 & (~new_n71_ | (new_n67_ & x29))));
  ...
  assign z9 = x00 & ~x03 & ~x26 & (~new_n81_ | (new_n80_ & x29));
