...
module FAU ( 
  ...
  assign z4 = (~x14 & x26) | (x01 & x25 & new_n57_ & ~x26);
  ...
  assign new_n61_ = ~new_n53_ & (x29 ? ((x30 & (~x27 | ~x28)) | (x27 & x28 & ~x30)) : x30);
  assign z7 = x26 ? x14 : (~new_n63_ | new_n67_);
  ...
  assign z8 = new_n82_ | (x00 & ~x26 & (new_n69_ | new_n74_ | new_n75_));
  ...
  assign new_n75_ = x32 & (new_n79_ | new_n80_ | ~new_n76_ | new_n81_);
  assign new_n76_ = ~new_n77_ & (x13 | x18) & ~new_n78_ & x31;
  assign new_n77_ = ~x17 & (~x12 | ~x18);
  assign new_n78_ = x15 & x16 & x17 & x18 & x19;
  assign new_n79_ = ~x19 & (~x17 | ~x18 | ~x15 | ~x16);
  assign new_n80_ = ~x15 & (~x17 | ~x18 | ~x10 | ~x16);
  assign new_n81_ = ~x16 & (~x11 | ~x17 | ~x18);
  assign new_n82_ = ~x14 & (x26 | (new_n83_ & x17 & x18 & x32));
  assign new_n83_ = x00 & x15 & x16;
  assign z9 = new_n89_ | (x00 & ~x26 & (new_n85_ | new_n86_ | new_n87_));
  assign new_n85_ = x29 & ~new_n73_ & (x30 ? (x31 & ~new_n70_ & ~x33) : x33);
  assign new_n86_ = (new_n73_ | ~x29) & (x30 ? x33 : (~x31 & ~new_n70_ & ~x33));
  assign new_n87_ = x33 & (new_n79_ | new_n80_ | ~new_n88_ | new_n81_);
  assign new_n88_ = ~new_n77_ & ~new_n78_ & (x13 | x18) & (~x30 | x31) & (x30 | ~x31);
  assign new_n89_ = ~x14 & (x26 | (new_n83_ & x17 & x18 & x33));
endmodule
