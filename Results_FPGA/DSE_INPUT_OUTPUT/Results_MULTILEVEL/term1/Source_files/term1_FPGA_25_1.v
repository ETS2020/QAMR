// Benchmark "FAU" written by ABC on Tue Aug 18 17:34:57 2020
...
module FAU ( 
  ...
  assign z8 = new_n81_ | (x00 & ~x26 & (new_n68_ | new_n73_ | new_n74_));
  ...
  assign new_n74_ = x32 & (new_n78_ | new_n79_ | ~new_n75_ | new_n80_);
  assign new_n75_ = ~new_n76_ & (x13 | x18) & ~new_n77_ & x31;
  assign new_n76_ = ~x17 & (~x12 | ~x18);
  assign new_n77_ = x15 & x16 & x17 & x18 & x19;
  assign new_n78_ = ~x19 & (~x17 | ~x18 | ~x15 | ~x16);
  assign new_n79_ = ~x15 & (~x17 | ~x18 | ~x10 | ~x16);
  assign new_n80_ = ~x16 & (~x11 | ~x17 | ~x18);
  assign new_n81_ = ~x14 & (x26 | (new_n82_ & x17 & x18 & x32));
  assign new_n82_ = x00 & x15 & x16;
  assign z9 = new_n88_ | (x00 & ~x26 & (new_n84_ | new_n85_ | new_n86_));
  assign new_n84_ = x29 & ~new_n72_ & (x30 ? (x31 & ~new_n69_ & ~x33) : x33);
  assign new_n85_ = (new_n72_ | ~x29) & (x30 ? x33 : (~x31 & ~new_n69_ & ~x33));
  assign new_n86_ = x33 & (new_n78_ | new_n79_ | ~new_n87_ | new_n80_);
  assign new_n87_ = ~new_n76_ & ~new_n77_ & (x13 | x18) & (x30 | ~x31) & (~x30 | x31);
  assign new_n88_ = ~x14 & (x26 | (new_n82_ & x17 & x18 & x33));
endmodule
