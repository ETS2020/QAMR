...
module FAU ( 
  ...
  assign z3 = (~x11 & x26) | (x01 & x25 & ~x26 & new_n53_ & ~x27);
  ...
  assign z5 = (~x11 & x26) | (x01 & x25 & new_n58_ & ~x26);
  ...
  assign z9 = new_n87_ | (x00 & ~x26 & (~new_n81_ | (new_n80_ & x29)));
  assign new_n80_ = (x27 | x28) & (x30 ? (x31 & ~new_n68_ & ~x33) : x33);
  assign new_n81_ = (new_n82_ | ~x33) & (new_n78_ | (x30 ? ~x33 : (x31 | new_n68_ | x33)));
  assign new_n82_ = ~new_n73_ & ~new_n83_ & ~new_n84_ & ~new_n85_ & new_n86_;
  assign new_n83_ = ~x16 & (~x18 | ~x19 | ~x15 | ~x17);
  assign new_n84_ = ~x19 & (~x15 | ~x17 | ~x18);
  assign new_n85_ = ~x15 & (~x10 | ~x17 | ~x18);
  assign new_n86_ = (x17 | (x12 & x18)) & (x13 | x18) & (x30 | ~x31) & (~x30 | x31);
  assign new_n87_ = ~x11 & (x26 | (~x16 & x33 & x00 & x15));
endmodule
