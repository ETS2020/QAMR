...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (~new_n72_ | (new_n67_ & x29));
  assign new_n67_ = ~new_n71_ & (x30 ? x32 : (x31 & ~new_n68_ & ~x32));
  ...
  assign z9 = (x26 & x30) | (x00 & (x33 ? ~new_n81_ : new_n84_));
  assign new_n81_ = (new_n82_ | (x26 & ~x30)) & (x26 | x30 | (~x31 & (new_n71_ | ~x29))) & (~x30 | (~new_n71_ & x29 & x31));
  assign new_n82_ = ~new_n75_ & ~new_n76_ & ~new_n77_ & new_n83_;
  assign new_n83_ = (x16 | (x11 & x17 & x18)) & (x13 | x18) & (x17 | (x12 & x18));
  assign new_n84_ = ~new_n68_ & ((~x26 & ~x30 & ~x31 & (new_n71_ | ~x29)) | (x29 & x30 & ~new_n71_ & x31));
endmodule
