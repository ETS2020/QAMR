...
module FAU ( 
  ...
  assign z8 = ~x26 & ((new_n70_ & x00) | x32);
  assign new_n70_ = x31 & ~new_n71_ & ((x29 & ~x30 & (x27 | x28)) | (x30 & (~x29 | (~x27 & ~x28))));
  ...
  assign z9 = x00 & ~x26 & ~x32 & (~new_n76_ | (new_n75_ & x29));
  assign new_n75_ = (x27 | x28) & (x30 ? (x31 & ~new_n71_ & ~x33) : x33);
  assign new_n76_ = (new_n83_ | (x30 ? ~x33 : (x31 | new_n71_ | x33))) & (new_n77_ | ~x33);
