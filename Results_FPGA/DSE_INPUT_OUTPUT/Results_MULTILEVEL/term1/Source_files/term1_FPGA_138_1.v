...
module FAU ( 
  ...
  assign z8 = new_n80_ | (x00 & ~x26 & (new_n67_ | new_n72_ | new_n73_));
  ...
  assign new_n73_ = x32 & (new_n77_ | new_n78_ | ~new_n74_ | new_n79_);
  assign new_n74_ = ~new_n75_ & (x13 | x18) & ~new_n76_ & x31;
  assign new_n75_ = ~x17 & (~x12 | ~x18);
  assign new_n76_ = x15 & x16 & x17 & x18 & x19;
  assign new_n77_ = ~x19 & (~x17 | ~x18 | ~x15 | ~x16);
  assign new_n78_ = ~x15 & (~x17 | ~x18 | ~x10 | ~x16);
  assign new_n79_ = ~x16 & (~x11 | ~x17 | ~x18);
  assign new_n80_ = ~x14 & (x26 | (new_n81_ & x17 & x18 & x32));
  assign new_n81_ = x00 & x15 & x16;
  assign z9 = new_n87_ | (x00 & ~x26 & (new_n83_ | new_n84_ | new_n85_));
  assign new_n83_ = x29 & ~new_n71_ & (x30 ? (x31 & ~new_n68_ & ~x33) : x33);
  assign new_n84_ = (new_n71_ | ~x29) & (x30 ? x33 : (~x31 & ~new_n68_ & ~x33));
  assign new_n85_ = x33 & (new_n77_ | new_n78_ | ~new_n86_ | new_n79_);
  assign new_n86_ = ~new_n75_ & (x30 | ~x31) & (~x30 | x31) & ~new_n76_ & (x13 | x18);
  assign new_n87_ = ~x14 & (x26 | (new_n81_ & x17 & x18 & x33));
endmodule
