...
module FAU ( 
  ...
  assign z5 = (x15 & x26) | (x01 & x25 & new_n58_ & ~x26);
  ...
  assign new_n72_ = (~new_n73_ | ~x15) & ~new_n74_ & (new_n75_ | x15) & ~new_n76_ & new_n77_;
  ...
  assign z9 = (x15 & x26) | (x00 & (new_n80_ | new_n86_ | new_n89_));
  assign new_n80_ = x29 & (x27 | x28) & (new_n81_ | (~new_n84_ & x15));
  assign new_n81_ = ~x26 & ((~x30 & x33) | (new_n83_ & new_n82_ & x30 & x31 & ~x33));
  assign new_n82_ = x18 & x19;
  assign new_n83_ = x16 & x17 & x10 & ~x15;
  assign new_n84_ = x30 ? (~x31 | x33 | (~new_n85_ & (new_n69_ | ~x16))) : ~x33;
  assign new_n85_ = x11 & ~x16 & x17 & x18 & x19;
  assign new_n86_ = ~new_n78_ & (new_n87_ | (x15 & (x30 ? x33 : new_n88_)));
  assign new_n87_ = ~x26 & ((x30 & x33) | (new_n83_ & new_n82_ & ~x30 & ~x31 & ~x33));
  assign new_n88_ = ~x31 & ~x33 & (new_n85_ | (~new_n69_ & x16));
  assign new_n89_ = x33 & ((~new_n92_ & ~x26) | (x15 & (~new_n90_ | new_n73_)));
  assign new_n90_ = (x19 | (x16 & x17 & x18)) & new_n91_ & (x16 | (x11 & x17 & x18));
  assign new_n91_ = (x17 | (x12 & x18)) & (x13 | x18) & (x30 | ~x31) & (~x30 | x31);
  assign new_n92_ = (x30 | ~x31) & (~x30 | x31) & (x15 | (new_n70_ & x10 & x16));
endmodule
