...
module FAU ( 
  ...
  assign z9 = new_n86_ | (x00 & ~x26 & (~new_n81_ | (new_n80_ & x29)));
  assign new_n80_ = (x27 | x28) & (x30 ? (x31 & ~new_n68_ & ~x33) : x33);
  assign new_n81_ = (new_n82_ | ~x33) & (new_n78_ | (x30 ? ~x33 : (x31 | new_n68_ | x33)));
  assign new_n82_ = ~new_n74_ & ~new_n75_ & ~new_n76_ & ~new_n83_ & new_n84_ & new_n85_;
  assign new_n83_ = ~x17 & (~x12 | ~x18);
  assign new_n84_ = (x13 | x18) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n85_ = ~x30 ^ x31;
  assign new_n86_ = ~x14 & (new_n87_ | x26);
  assign new_n87_ = x00 & x15 & x16 & x17 & x18 & x33;
endmodule
