...
module FAU ( 
  ...
  assign z5 = x01 ? (x25 & new_n58_ & ~x26) : x26;
  ...
  assign z7 = x01 ? (~new_n62_ | new_n66_) : ~x26;
  assign new_n62_ = ~new_n63_ & new_n65_ & x25 & (~x02 | ~x03);
  ...
  assign new_n72_ = (new_n73_ | ~x32) & (new_n79_ | (x30 ? (~x31 | new_n69_ | x32) : ~x32));
