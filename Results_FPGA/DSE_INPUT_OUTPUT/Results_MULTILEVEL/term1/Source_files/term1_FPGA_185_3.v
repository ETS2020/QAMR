...
module FAU ( 
  ...
  assign new_n58_ = ~new_n55_ & (~x02 | ~x03) & (x27 ^ x28);
  ...
  assign z8 = new_n47_ | (x00 & (new_n74_ | new_n76_ | (new_n69_ & x29)));
  assign new_n69_ = ~new_n73_ & ((~x30 & x31 & ~new_n70_ & ~x32) | (~x26 & x30 & x32));
  ...
  assign new_n74_ = ~new_n75_ & ((x30 & x31 & ~new_n70_ & ~x32) | (~x26 & ~x30 & x32));
  assign new_n75_ = ~new_n73_ & x29;
  assign new_n76_ = ~x26 & x32 & (new_n79_ | new_n80_ | ~new_n77_ | new_n81_);
  assign new_n77_ = (x16 | (x11 & x17 & x18)) & new_n78_ & (x17 | (x12 & x18));
  assign new_n78_ = x31 & (x13 | x18);
  assign new_n79_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n80_ = ~x19 & (~x15 | ~x16 | ~x17 | ~x18);
  assign new_n81_ = ~x15 & (~x17 | ~x18 | ~x10 | ~x16);
  assign z9 = new_n47_ | (x00 & (x33 ? ~new_n83_ : (~new_n70_ & ~new_n86_)));
  assign new_n83_ = (new_n84_ | (x26 & ~x31)) & (x26 | x31 | (~x30 & (new_n73_ | ~x29))) & (~x31 | (~new_n73_ & x29 & x30));
  assign new_n84_ = ~new_n79_ & ~new_n80_ & ~new_n81_ & new_n85_;
  assign new_n85_ = (x16 | (x11 & x17 & x18)) & (x13 | x18) & (x17 | (x12 & x18));
  assign new_n86_ = (x26 | x30 | x31 | (~new_n73_ & x29)) & (~x29 | ~x30 | new_n73_ | ~x31);
endmodule
