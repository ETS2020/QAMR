...
module FAU ( 
  ...
  assign z7 = x26 ? ~x32 : (~new_n64_ | new_n68_);
  ...
  assign z8 = new_n50_ | (x00 & (new_n75_ | new_n77_ | (new_n70_ & x29)));
  assign new_n70_ = ~new_n74_ & ((~x26 & ~x30 & x31 & ~new_n71_ & ~x32) | (x30 & x32));
  ...
  assign new_n75_ = ~new_n76_ & ((~x26 & x30 & x31 & ~new_n71_ & ~x32) | (~x30 & x32));
  ...
  assign new_n84_ = ~new_n74_ & (x30 ? (x31 & ~new_n71_ & ~x33) : x33);
  assign new_n85_ = (new_n76_ | (x30 ? ~x33 : (x31 | new_n71_ | x33))) & (new_n86_ | ~x33);
