...
module FAU ( 
  ...
  assign z8 = (~x31 & (x26 | (x00 & x32))) | (x00 & ~x26 & (new_n68_ | ~new_n73_));
  ...
  assign z9 = (x26 & ~x31) | (x00 & (x33 ? ~new_n81_ : new_n82_));
  assign new_n81_ = (new_n75_ | (x26 & x31)) & (x31 | (~x30 & (new_n72_ | ~x29))) & (x26 | ~x31 | (~new_n72_ & x29 & x30));
  assign new_n82_ = ~new_n69_ & ((~x26 & x29 & x30 & ~new_n72_ & x31) | (~x30 & ~x31 & (new_n72_ | ~x29)));
endmodule
