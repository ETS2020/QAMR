// Benchmark "FAU" written by ABC on Tue Aug 18 17:35:25 2020
...
module FAU ( 
  ...
  assign new_n55_ = (x18 | x23) & (x26 | (new_n56_ & new_n57_));
  assign new_n56_ = (x15 | x20) & (x16 | x21);
  assign new_n57_ = (x17 | x22) & (x19 | x24);
  assign z4 = new_n47_ | (x01 & x25 & new_n54_ & (x27 ^ x28));
  assign z5 = new_n47_ | (x01 & new_n60_ & x25);
  ...
  assign new_n65_ = new_n56_ & (x17 | x22);
