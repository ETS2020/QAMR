// Benchmark "FAU" written by ABC on Tue Aug 18 17:35:18 2020
...
module FAU ( 
  ...
  assign z1 = (x11 | ~x26) & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  assign z2 = x08 & new_n49_ & ~x09;
  assign new_n49_ = (x11 | ~x26) & ((~new_n50_ & (~x04 ^ x07)) | (~new_n51_ & (x04 ^ x07)));
  ...
  assign z4 = (~x11 & x26) | (x01 & x25 & new_n57_ & ~x26);
  assign new_n57_ = (x27 ^ x28) & ~new_n53_ & ~new_n55_;
  assign z5 = (~x11 & x26) | (x01 & x25 & new_n59_ & ~x26);
  ...
  assign z8 = new_n80_ | (x00 & ~x26 & (~new_n72_ | (new_n68_ & x29)));
  ...
  assign new_n75_ = ~x16 & (~x18 | ~x19 | ~x15 | ~x17);
  assign new_n76_ = ~x19 & (~x15 | ~x17 | ~x18);
  assign new_n77_ = ~x15 & (~x10 | ~x17 | ~x18);
  assign new_n78_ = (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign new_n79_ = x29 & (x27 | x28);
  assign new_n80_ = ~x11 & (x26 | (~x16 & x32 & x00 & x15));
  assign z9 = new_n86_ | (x00 & ~x26 & (~new_n83_ | (new_n82_ & x29)));
  assign new_n82_ = (x27 | x28) & (x30 ? (x31 & ~new_n69_ & ~x33) : x33);
  ...
  assign new_n86_ = ~x11 & (x26 | (~x16 & x33 & x00 & x15));
endmodule
