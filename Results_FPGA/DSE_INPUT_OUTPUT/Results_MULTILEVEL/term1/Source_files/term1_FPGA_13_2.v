...
module FAU ( 
  ...
  assign z4 = (x26 & ~x30) | (x01 & x25 & new_n57_ & ~x26);
  ...
  assign z6 = x01 & x25 & new_n61_ & ~new_n55_ & ~x26;
  ...
  assign z9 = new_n81_ | (x26 & ~x30);
  assign new_n81_ = x00 & (x33 ? (new_n82_ | ~new_n84_) : (~new_n69_ & ~new_n85_));
  assign new_n82_ = (~x26 | ~x30) & (new_n74_ | new_n75_ | new_n76_ | ~new_n83_);
  assign new_n83_ = (x16 | (x11 & x17 & x18)) & (x13 | x18) & (x17 | (x12 & x18));
  assign new_n84_ = (x30 | (~x31 & (~x29 | (~x27 & ~x28)))) & (x26 | ~x30 | ((x27 | x28) & x29 & x31));
  assign new_n85_ = (x26 | ~x29 | ~x30 | ~x31 | (~x27 & ~x28)) & (x30 | x31 | (x29 & (x27 | x28)));
endmodule
