// Benchmark "FAU" written by ABC on Tue Aug 18 17:35:16 2020
...
module FAU ( 
  ...
  assign z3 = ~x26 & (~x01 | (x25 & new_n53_ & ~x27));
  ...
  assign z6 = ~x26 & (~x01 | (x25 & new_n60_ & (~x02 | ~x03)));
  assign new_n60_ = ~new_n54_ & (x29 ? ((x01 & x30 & (~x27 | ~x28)) | (x27 & x28 & ~x30)) : x30);
  assign z7 = x26 | (x01 & (~new_n62_ | new_n66_));
  ...
  assign z8 = x00 & x01 & ~x26 & (~new_n72_ | (new_n68_ & x29));
  ...
  assign z9 = x00 & x01 & ~x26 & (~new_n82_ | (new_n81_ & x29));
