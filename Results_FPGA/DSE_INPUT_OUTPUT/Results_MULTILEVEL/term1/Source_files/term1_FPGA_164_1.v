...
module FAU ( 
  ...
  assign new_n49_ = x01 ? (x02 ? ~x03 : (x03 | x26)) : ((x02 | ~x06 | (~x03 & (x05 | x26))) & (x03 | ~x05 | x26 | (~x02 & x06)));
  assign new_n50_ = x01 ? (x02 ? (x03 | x26) : ~x03) : (((~x03 & (x05 | x26)) | (~x02 & x06)) & (x02 | x03 | ~x05 | ~x06 | x26));
  assign z3 = (~x03 & x26) | (new_n52_ & x01);
  assign new_n52_ = x25 & ~x27 & ~new_n53_ & (~x03 | (~x02 & ~x26));
  assign new_n53_ = new_n54_ & (x16 | x21) & (x15 | x20);
  assign new_n54_ = (x17 | x22) & (x19 | x24) & (x18 | x23);
  assign z4 = x01 & new_n56_ & x25;
  assign new_n56_ = ~x26 & (~x27 ^ ~x28) & ~new_n53_ & (~x02 | ~x03);
  assign z5 = (~x03 & x26) | (x01 & x25 & new_n58_ & (~x03 | (~x02 & ~x26)));
  assign new_n58_ = ~new_n53_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  ...
  assign new_n75_ = ~x15 & (~x10 | ~x16 | ~x17 | ~x18);
