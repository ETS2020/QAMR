...
module FAU ( 
  ...
  assign z7 = (x28 & (new_n67_ | x26)) | (~new_n63_ & ~x26);
  ...
  assign new_n67_ = x30 & ~x31 & x27 & x29;
  ...
  assign z9 = (x26 & ~x28) | (x00 & (new_n88_ | (~x26 & (new_n83_ | ~new_n84_))));
  assign new_n83_ = x29 & ~new_n73_ & (x30 ? (x31 & ~new_n70_ & ~x33) : x33);
  assign new_n84_ = (new_n85_ | ~x33) & (x29 | x30 | x31 | new_n70_ | x33);
  assign new_n85_ = ~new_n77_ & ~new_n86_ & ~new_n78_ & ~new_n79_ & ~new_n80_ & new_n87_;
  assign new_n86_ = x30 & (~x29 | ~x31);
  assign new_n87_ = (x17 | (x12 & x18)) & (x13 | x18) & (x30 | ~x31);
  assign new_n88_ = ~x27 & ~x28 & (x30 ? x33 : (~x31 & ~new_n70_ & ~x33));
endmodule
