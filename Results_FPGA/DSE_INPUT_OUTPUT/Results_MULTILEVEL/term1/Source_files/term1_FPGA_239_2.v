...
module FAU ( 
  ...
  assign z7 = x26 ? x33 : (~new_n62_ | new_n66_);
  ...
  assign z8 = (x26 & ~x33) | (x00 & ~x26 & (~new_n74_ | (new_n68_ & x29)));
  assign new_n68_ = ~new_n73_ & (x30 ? x32 : (x31 & ~new_n69_ & ~x32));
  ...
  assign new_n74_ = (new_n75_ | (x30 ? (~x31 | new_n69_ | x32) : ~x32)) & (new_n76_ | ~x32);
  ...
  assign z9 = (x26 & ~x33) | (x00 & (new_n83_ | new_n86_ | (~x26 & ~new_n87_ & x33)));
  assign new_n83_ = x29 & ~new_n73_ & (new_n85_ | (x30 & new_n84_ & x31));
  assign new_n84_ = ~x33 & (new_n72_ | (x15 & (new_n71_ | (~new_n70_ & x16))));
  assign new_n85_ = ~x26 & ~x30 & x33;
  assign new_n86_ = ~new_n75_ & ((~x30 & ~x31 & ~new_n69_ & ~x33) | (~x26 & x30 & x33));
  assign new_n87_ = ~new_n77_ & ~new_n78_ & ~new_n79_ & ~new_n80_ & new_n88_;
