...
module FAU ( 
  ...
  assign z3 = (~x12 & x26) | (x01 & x25 & new_n53_ & ~x26);
  ...
  assign z8 = (~x12 & (new_n82_ | x26)) | (x00 & (new_n69_ | ~new_n74_) & ~x26);
  ...
  assign new_n78_ = ~x17 & (~x18 | ~x19 | ~x15 | ~x16);
  assign new_n79_ = ~x19 & (~x15 | ~x16 | ~x18);
  assign new_n80_ = ~x15 & (~x10 | ~x16 | ~x18);
  assign new_n81_ = (x16 | (x11 & x18)) & x31 & (x13 | x18);
  assign new_n82_ = x00 & x15 & x16 & ~x17 & x32;
  assign z9 = (~x12 & (new_n88_ | x26)) | (x00 & (new_n84_ | ~new_n85_) & ~x26);
  assign new_n84_ = x29 & ~new_n73_ & (x30 ? (x31 & ~new_n70_ & ~x33) : x33);
  assign new_n85_ = (new_n86_ | ~x33) & (new_n75_ | (x30 ? ~x33 : (x31 | new_n70_ | x33)));
  assign new_n86_ = ~new_n77_ & ~new_n78_ & ~new_n79_ & ~new_n80_ & new_n87_;
  assign new_n87_ = (x16 | (x11 & x18)) & (x13 | x18) & (x30 | ~x31) & (~x30 | x31);
  assign new_n88_ = x00 & x15 & x16 & ~x17 & x33;
endmodule
