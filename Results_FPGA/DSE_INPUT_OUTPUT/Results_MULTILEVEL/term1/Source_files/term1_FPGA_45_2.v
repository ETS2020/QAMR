...
module FAU ( 
  ...
  assign new_n68_ = ((new_n69_ & ~new_n74_) | (x26 & x30)) & (x26 | ~x29 | new_n75_ | ~x30) & (x30 | (~new_n75_ & x29));
  assign new_n69_ = ~new_n70_ & ~new_n71_ & ~new_n72_ & new_n73_;
  ...
  assign new_n81_ = ~new_n75_ & (x30 ? (x31 & ~new_n77_ & ~x33) : x33);
  assign new_n82_ = (new_n84_ | ~x33) & (new_n83_ | (x30 ? ~x33 : (x31 | new_n77_ | x33)));
  assign new_n83_ = ~new_n75_ & x29;
  assign new_n84_ = ~new_n74_ & ~new_n70_ & ~new_n71_ & ~new_n72_ & new_n85_;
