...
module FAU ( 
  ...
  assign z3 = (x26 & x31) | (x01 & x25 & ~x26 & new_n54_ & ~x27);
  ...
  assign z8 = new_n47_ | (x00 & (new_n73_ | new_n75_ | (new_n68_ & x29)));
  assign new_n68_ = ~new_n72_ & ((~x30 & x31 & ~new_n69_ & ~x32) | (~x26 & x30 & x32));
  ...
  assign new_n73_ = ~new_n74_ & ((x30 & x31 & ~new_n69_ & ~x32) | (~x26 & ~x30 & x32));
  assign new_n74_ = ~new_n72_ & x29;
  assign new_n75_ = ~x26 & x32 & (new_n78_ | new_n79_ | ~new_n76_ | new_n80_);
  assign new_n76_ = ~new_n77_ & (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign new_n77_ = ~x16 & (~x11 | ~x17 | ~x18);
  assign new_n78_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n79_ = ~x19 & (~x15 | ~x16 | ~x17 | ~x18);
  assign new_n80_ = ~x15 & (~x17 | ~x18 | ~x10 | ~x16);
  assign z9 = x00 & ~x26 & (~new_n83_ | (new_n82_ & x29));
  assign new_n82_ = ~new_n72_ & ((~x31 & x33) | (x30 & x31 & ~new_n69_ & ~x33));
  assign new_n83_ = (new_n74_ | ((~x31 | ~x33) & (x30 | x31 | new_n69_ | x33))) & (new_n84_ | ~x33);
