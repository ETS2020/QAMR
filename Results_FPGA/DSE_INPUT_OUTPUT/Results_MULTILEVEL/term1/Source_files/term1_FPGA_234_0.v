...
module FAU ( 
  ...
  assign z8 = x00 & x14 & ~new_n69_ & ~x26;
  ...
  assign new_n83_ = x29 & ~new_n81_ & (x30 ? (x31 & ~new_n84_ & ~x33) : x33);
  assign new_n84_ = ~new_n73_ & ((~new_n71_ & ~new_n72_) | ~x15);
  assign new_n85_ = (new_n81_ | ~x29) & (x30 ? x33 : (~x31 & ~new_n84_ & ~x33));
