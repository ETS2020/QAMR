// Benchmark "FAU" written by ABC on Tue Aug 18 17:35:38 2020
...
module FAU ( 
  ...
  assign z8 = (x26 & x28) | (x00 & (new_n67_ | (~new_n72_ & ~x26)));
  ...
  assign new_n71_ = ~x28 & (x26 | ~x27);
  assign new_n72_ = (new_n79_ | (x30 ? (~x31 | new_n68_ | x32) : ~x32)) & (new_n73_ | ~x32);
  ...
  assign z9 = (x26 & x28) | (x00 & (new_n81_ | (~new_n82_ & ~x26)));
  assign new_n81_ = x29 & ~new_n71_ & (x30 ? (x31 & ~new_n68_ & ~x33) : x33);
  assign new_n82_ = (new_n83_ | ~x33) & (new_n79_ | (x30 ? ~x33 : (x31 | new_n68_ | x33)));
