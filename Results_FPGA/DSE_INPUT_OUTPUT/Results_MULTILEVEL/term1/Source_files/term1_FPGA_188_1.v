...
module FAU ( 
  ...
  assign z7 = (~x26 & (new_n67_ | ~new_n65_ | (new_n64_ & x23))) | (x18 & (new_n64_ | x26));
  assign new_n64_ = (x19 | x24) & new_n56_ & (x17 | x22);
  ...
  assign new_n83_ = ~new_n73_ & ((~x18 & (new_n84_ | new_n89_)) | (~x26 & (new_n89_ | (new_n86_ & x18))));
  assign new_n84_ = new_n85_ & x31 & ~x33 & x19 & x30;
  assign new_n85_ = x13 & x15 & x16 & x17;
  assign new_n86_ = x30 & x31 & ~x33 & (new_n88_ | (~new_n87_ & x15));
  assign new_n87_ = (~x16 | ((~x12 | x17 | ~x19) & (~x14 | ~x17 | x19))) & (~x11 | x16 | ~x17 | ~x19);
  assign new_n88_ = x10 & ~x15 & x16 & x17 & x19;
  assign new_n89_ = ~x30 & x33;
  assign new_n90_ = ~new_n75_ & ((~x18 & (new_n91_ | new_n93_)) | (~x26 & (new_n93_ | (new_n92_ & x18))));
  assign new_n91_ = new_n85_ & ~x31 & ~x33 & x19 & ~x30;
  assign new_n92_ = ~x30 & ~x31 & ~x33 & (new_n88_ | (~new_n87_ & x15));
  assign new_n93_ = x30 & x33;
  assign new_n94_ = x33 & (new_n97_ | (~x26 & (~new_n95_ | new_n77_)));
