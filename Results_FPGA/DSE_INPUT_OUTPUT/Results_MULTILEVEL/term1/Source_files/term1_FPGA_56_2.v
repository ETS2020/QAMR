...
module FAU ( 
  ...
  assign z6 = x01 & ~x18 & x25 & new_n62_ & ~new_n54_ & ~x26;
  assign new_n62_ = (~new_n55_ | ~new_n56_) & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = x26 | (~x18 & (~new_n64_ | new_n68_));
  ...
  assign new_n78_ = x29 & ~new_n71_ & ((new_n72_ & new_n79_) | (~x30 & x33));
  assign new_n79_ = x31 & ~x33 & x19 & x30;
  assign new_n80_ = ~new_n74_ & ((x30 & x33) | (new_n72_ & x19 & ~x30 & ~x31 & ~x33));
