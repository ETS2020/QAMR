...
module FAU ( 
  ...
  assign z3 = x01 & ~x17 & x25 & ~x26 & new_n53_ & ~x27;
  assign new_n53_ = ~new_n54_ & (~new_n55_ | ~new_n56_);
  assign new_n54_ = x02 & x03;
  assign new_n55_ = (x15 | x20) & (x16 | x21);
  assign new_n56_ = x22 & (x19 | x24) & (x18 | x23);
  assign z4 = x01 & ~x17 & x25 & new_n58_ & ~x26;
  ...
  assign z6 = x01 & ~x17 & x25 & new_n62_ & ~new_n54_ & ~x26;
  assign new_n62_ = (~new_n55_ | ~new_n56_) & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = x26 | (~x17 & (~new_n64_ | new_n68_));
  assign new_n64_ = new_n66_ & new_n67_ & (~x22 | ~new_n65_ | (~x19 & ~x24));
  assign new_n65_ = (x16 | x21) & (x15 | x20) & (x18 | x23);
  assign new_n66_ = x01 & (~x02 | ~x03);
  assign new_n67_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n68_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign z8 = x00 & ~x17 & ~x26 & (~new_n73_ | (new_n70_ & x29));
  ...
  assign new_n76_ = x12 & x15 & x16 & x18 & x19 & x31;
  assign z9 = x00 & ~x17 & ~x26 & (new_n78_ | new_n80_ | new_n81_);
  ...
  assign new_n81_ = x33 & (~new_n82_ | ~x12 | ~x15 | ~x16);
  assign new_n82_ = (~x30 | x31) & (x30 | ~x31) & x18 & x19;
endmodule
