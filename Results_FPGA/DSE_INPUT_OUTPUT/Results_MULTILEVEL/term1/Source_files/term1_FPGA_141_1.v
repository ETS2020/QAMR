...
module FAU ( 
  ...
  assign z4 = ~x26 & ((new_n57_ & x01) | x32);
  ...
  assign new_n65_ = x01 & x25 & (~x02 | ~x03) & new_n66_ & ~x26;
  assign new_n66_ = ~x32 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n67_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign z8 = ~x26 & ((new_n69_ & x00) | x32);
  assign new_n69_ = x31 & ~new_n70_ & ((x29 & ~x30 & (x27 | x28)) | (x30 & (~x29 | (~x27 & ~x28))));
  ...
  assign z9 = x00 & ~x26 & ~x32 & (~new_n75_ | (new_n74_ & x29));
  assign new_n74_ = (x27 | x28) & (x30 ? (x31 & ~new_n70_ & ~x33) : x33);
  assign new_n75_ = (new_n82_ | (x30 ? ~x33 : (x31 | new_n70_ | x33))) & (new_n76_ | ~x33);
