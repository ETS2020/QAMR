...
module FAU ( 
  ...
  assign z8 = (~x31 & (x26 | (x00 & x32))) | (x00 & ~x26 & (new_n67_ | ~new_n72_));
  ...
  assign new_n80_ = ~new_n71_ & ((~x31 & x33) | (x30 & x31 & ~new_n68_ & ~x33));
  assign new_n81_ = (new_n82_ | ~x33) & (new_n73_ | ((~x31 | ~x33) & (x30 | x31 | new_n68_ | x33)));
  assign new_n82_ = ~new_n75_ & ~new_n76_ & ~new_n77_ & ~new_n83_ & new_n84_;
