...
module FAU ( 
  ...
  assign z8 = x00 & ~new_n67_ & ~x26;
  assign new_n67_ = (~x29 | new_n78_ | (x30 ? ~x32 : ~new_n68_)) & ((~new_n78_ & x29) | (x30 ? ~new_n68_ : ~x32)) & (new_n72_ | ~x32);
  assign new_n68_ = x31 & ~new_n69_ & ~x32;
  ...
  assign new_n72_ = ~new_n75_ & ~new_n76_ & new_n73_ & ~new_n77_;
  assign new_n73_ = ~new_n74_ & (x17 | (x12 & x18)) & x31 & (x13 | x18);
  ...
  assign z9 = (x14 & x26) | (x00 & (new_n80_ | new_n87_ | (new_n89_ & ~x26)));
  assign new_n80_ = x29 & ~new_n78_ & (new_n86_ | (x30 & new_n81_ & x31));
  assign new_n81_ = ~x33 & ((~new_n82_ & x15) | (new_n85_ & x10 & ~x15 & x16));
  assign new_n82_ = (~x16 | ((new_n83_ | ~x17) & (~new_n84_ | ~x12 | x17))) & (~new_n84_ | ~x11 | x16 | ~x17);
  assign new_n83_ = (~x14 | ~x18 | x19) & (~x13 | x18 | ~x19 | x26);
  assign new_n84_ = x18 & x19 & ~x26;
  assign new_n85_ = x17 & x18 & x19 & ~x26;
  assign new_n86_ = ~x26 & ~x30 & x33;
  assign new_n87_ = ~new_n88_ & ((~x30 & new_n81_ & ~x31) | (~x26 & x30 & x33));
  assign new_n88_ = ~new_n78_ & x29;
  assign new_n89_ = x33 & (new_n75_ | new_n76_ | new_n77_ | new_n74_ | ~new_n90_);
