...
module FAU ( 
  ...
  assign z06 = (~new_n46_ & ~x03) | new_n44_ | ~new_n48_;
  assign new_n46_ = x07 & (~new_n47_ | ~x06 | ~x08);
  assign new_n47_ = ~x09 & ~x10;
  assign new_n48_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~x07 & (~x03 | x11 | x16)) | ~new_n50_ | (x16 & (~x02 | x03));
  assign new_n50_ = ~new_n51_ & x04 & (~x11 | (new_n47_ & x06 & x08));
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x07 & (~x03 | x12 | x16)) | ~new_n53_ | (x16 & (~x02 | x03));
  assign new_n53_ = ~new_n54_ & x04 & (~new_n55_ | ~x06 | ~x07 | ~x08);
  assign new_n54_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = ~new_n57_ | (~x07 & (~x03 | x13 | x16));
  assign new_n57_ = ~new_n44_ & (new_n59_ | ~x13) & x04 & (~new_n58_ | ~new_n60_);
  assign new_n58_ = x08 & ~x09 & x06 & x07;
  assign new_n59_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n60_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 & ((new_n63_ & x03) | (x07 & (new_n62_ | (new_n63_ & ~x02))));
  assign new_n62_ = x06 & x08 & ~x09 & ~new_n44_ & (new_n60_ | x00);
  assign new_n63_ = x14 & x16;
  assign z11 = x02 | (~x03 & ~x07);
  assign z12 = (~x03 & ~x07) | (x04 & (x03 | (~x02 & x16)));
