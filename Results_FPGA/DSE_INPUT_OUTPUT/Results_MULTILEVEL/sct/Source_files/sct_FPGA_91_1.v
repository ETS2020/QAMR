...
module FAU ( 
  ...
  assign z07 = ((x11 | ~x17) & (new_n40_ | ~x04)) | new_n49_ | (~new_n47_ & x11);
  assign new_n49_ = new_n44_ & ~x11 & ~x17 & ~x09 & ~x10;
  assign z08 = new_n51_ | new_n40_ | ~x04 | (~new_n49_ & x12);
  assign new_n51_ = ~x11 & (x17 | (new_n44_ & ~x09 & ~x10 & ~x12));
  assign z09 = (~new_n53_ & ~x11) | new_n40_ | new_n54_ | ~x04;
  assign new_n53_ = ~x17 & (~new_n44_ | x12 | x13 | x09 | x10);
  assign new_n54_ = x13 & (~new_n45_ | x10 | x11 | x12 | x17);
