...
module FAU ( 
  ...
  assign z06 = new_n46_ | new_n40_ | new_n48_ | ~x04;
  assign new_n46_ = x07 & (x15 | (new_n47_ & x06 & x08));
  assign new_n47_ = ~x09 & ~x10;
  assign new_n48_ = x10 & (~x06 | ~x07 | ~x08 | x09 | x15);
  assign z07 = new_n44_ | ~new_n50_;
  assign new_n50_ = (~x11 | (x07 & (x15 | (new_n47_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n47_ | x11 | x15);
  assign z08 = new_n44_ | new_n52_ | (x12 & (new_n54_ | ~x07));
  assign new_n52_ = new_n53_ & ~x10 & ~x11 & ~x12 & ~x15;
  assign new_n53_ = x06 & x07 & x08 & ~x09;
  assign new_n54_ = ~x15 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | new_n56_ | (x13 & (~x07 | (~new_n57_ & ~x15)));
  assign new_n56_ = new_n53_ & ~x10 & ~x11 & ~x12 & ~x13 & ~x15;
