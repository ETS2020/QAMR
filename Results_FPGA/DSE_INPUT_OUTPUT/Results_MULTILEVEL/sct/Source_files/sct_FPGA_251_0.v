...
module FAU ( 
  ...
  assign z09 = ~new_n51_ | new_n39_ | (~x06 & (~x07 | x13));
  assign new_n51_ = (new_n52_ | ~x13) & x04 & (~new_n53_ | ~new_n54_);
  assign new_n52_ = ~x10 & ~x11 & ~x12 & x07 & x08 & ~x09;
  assign new_n53_ = x08 & ~x09 & x06 & x07;
  assign new_n54_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 & ((x06 & ((new_n56_ & x07) | (new_n39_ & x14))) | (x07 & new_n39_ & x14));
