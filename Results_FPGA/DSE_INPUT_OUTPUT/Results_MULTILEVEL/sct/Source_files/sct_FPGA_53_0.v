...
module FAU ( 
  ...
  assign z04 = new_n37_ | (~new_n42_ & x04);
  assign new_n42_ = (~x02 | x03 | (x06 ? x08 : (~x07 | ~x08))) & (x16 | (x07 ? (x06 ^ ~x08) : ~x08));
  assign z05 = ~new_n44_ | (~x07 & (~x03 | x09 | x16));
  ...
  assign z06 = (~x04 & (x07 | (x03 & ~x10))) | (x03 & ((~x07 & x10) | x16)) | (~new_n49_ & x07);
  assign new_n49_ = (~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08) & (x02 | ~x16);
  assign z07 = (~x07 & (~x03 | x11 | x16)) | ~new_n51_ | ((~x02 | x03) & x16);
  assign new_n51_ = (~x11 | (new_n46_ & ~x09 & ~x10)) & x04 & (~new_n52_ | x09 | x10 | x11);
  assign new_n52_ = x06 & x07 & x08;
  assign z08 = (~x04 & (x07 | (x03 & ~x12))) | (x03 & ((~x07 & x12) | x16)) | (~new_n54_ & x07);
  assign new_n54_ = ~new_n55_ & ~new_n56_ & (x02 | ~x16);
  assign new_n55_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n56_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = (~x03 & (new_n58_ | ~x07)) | ~new_n60_ | (~x07 & (x13 | x16));
  assign new_n58_ = new_n59_ & new_n46_ & x02 & x04;
  assign new_n59_ = ~x09 & ~x10 & ~x11 & ~x12 & ~x13;
  assign new_n60_ = ~new_n45_ & (new_n56_ | ~x13) & x04 & (~new_n47_ | ~new_n61_);
  assign new_n61_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign z10 = new_n37_ | (x04 & (new_n65_ | (x06 & new_n63_ & x08)));
  assign new_n63_ = ~x09 & ~new_n64_ & ((x02 & ~x03) | (x07 & ~x16));
  assign new_n64_ = ~x00 & (x12 | x13 | x10 | x11);
  assign new_n65_ = x14 & x16 & (~x02 | x03 | ~x07);
