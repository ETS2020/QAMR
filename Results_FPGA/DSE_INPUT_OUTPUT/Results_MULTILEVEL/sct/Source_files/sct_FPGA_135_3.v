...
module FAU ( 
  ...
  assign z06 = ~new_n46_ | (x07 & (x03 | (new_n48_ & x06 & x08)));
  assign new_n46_ = (~x03 | (~x10 & ~x16)) & (new_n47_ | ~x10) & x04 & (x02 | ~x16);
  assign new_n47_ = x08 & ~x09 & x06 & x07;
  assign new_n48_ = ~x09 & ~x10;
  assign z07 = ~new_n50_ | (x07 & (new_n52_ | x03));
  assign new_n50_ = (~x03 | (~x11 & ~x16)) & (new_n51_ | ~x11) & x04 & (x02 | ~x16);
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (~x03 | ~x07)) | (~new_n54_ & ~x03) | (~x07 & (x12 | (x03 & x16)));
  assign new_n54_ = (new_n52_ | ~x12) & ~new_n55_ & (~new_n44_ | ~new_n48_ | x11 | x12);
  assign new_n55_ = ~x02 & x16;
  assign z09 = (~x04 & (~x03 | ~x07)) | (~new_n57_ & ~x03) | (~x07 & (x13 | (x03 & x16)));
  assign new_n57_ = (new_n58_ | ~x13) & ~new_n55_ & (~new_n47_ | ~new_n59_);
  ...
  assign new_n61_ = x06 & x07 & x08 & ~x09 & ~new_n55_ & ~new_n62_;
