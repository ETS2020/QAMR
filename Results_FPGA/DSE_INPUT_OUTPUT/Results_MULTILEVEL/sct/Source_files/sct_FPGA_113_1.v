...
module FAU ( 
  ...
  assign new_n51_ = (new_n49_ | ~x12) & (~new_n45_ | x12 | x13 | x10 | x11);
  assign z09 = x13 ? x12 : (~new_n53_ | new_n40_);
  assign new_n53_ = x04 & (~new_n44_ | x11 | x12 | x09 | x10);
  assign z10 = new_n37_ | (x04 & (new_n55_ | (new_n40_ & x14)));
  assign new_n55_ = x06 & x07 & x08 & ~x09 & ~new_n40_ & ~new_n56_;
  assign new_n56_ = ~x00 & (x10 | x11 | x12);
