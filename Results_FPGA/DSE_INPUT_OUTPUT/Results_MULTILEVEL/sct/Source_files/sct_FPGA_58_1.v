...
module FAU ( 
  ...
  assign z07 = ~new_n50_ | (x07 & (~x02 | (new_n52_ & x06 & x08)));
  assign new_n50_ = (x02 | (~x11 & ~x16)) & new_n45_ & (new_n51_ | ~x11);
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign new_n52_ = ~x09 & ~x10 & ~x11;
  assign z08 = (x07 & (new_n55_ | ~x02)) | ~new_n54_ | (~x02 & (x12 | x16));
  assign new_n54_ = new_n45_ & (~x12 | (new_n44_ & new_n52_));
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x02 | ~x07)) | (~new_n57_ & x02) | (~x07 & (x13 | (~x02 & x16)));
  assign new_n57_ = (new_n55_ | ~x13) & (~new_n48_ | ~new_n58_) & (~x03 | ~x16);
  assign new_n58_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign z10 = (~x02 & x07) | (x04 & (new_n61_ | (x06 & new_n60_ & x07)));
  assign new_n60_ = x08 & ~x09 & (new_n58_ | x00) & (~x03 | ~x16);
