...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (~x07 | ~x14)) | (x09 & (~x07 | (~x14 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & ~x14);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = ~new_n46_ | (~new_n44_ & ~new_n38_);
  assign new_n46_ = (~x10 | (x07 & (x14 | (x06 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | x14);
  assign z07 = (~new_n49_ & x07) | new_n40_ | ~x04 | (~new_n48_ & x11);
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x14;
  assign new_n49_ = ~x14 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n51_ | new_n40_ | new_n53_ | ~x04;
  assign new_n51_ = x07 & (new_n52_ | x14);
  assign new_n52_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n53_ = x12 & (~new_n54_ | ~x06 | ~x07 | ~x08);
  assign new_n54_ = ~x09 & ~x10 & ~x11 & ~x14;
  assign z09 = (~new_n44_ & ~new_n38_) | new_n56_ | (~new_n51_ & x13);
  assign new_n56_ = new_n57_ & x06 & x07 & x08 & ~x09;
  assign new_n57_ = ~x10 & ~x11 & ~x12 & ~x13 & ~x14;
  assign z10 = (x07 & x14) | (x04 & ((x06 & new_n59_ & x07) | (new_n40_ & x14)));
