...
module FAU ( 
  ...
  assign z04 = (~x07 & x09) | (x04 & ~new_n39_ & (x06 ? (x07 ^ x08) : x08));
  ...
  assign z09 = (~new_n44_ & (x07 | (~x09 & ~x13))) | (x07 & ~new_n53_ & x13) | (~x09 & (new_n51_ | (~x07 & x13)));
  ...
  assign z12 = (~x07 & x09) | (x04 & (x03 | (~x02 & x16)));
