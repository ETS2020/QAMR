...
module FAU ( 
  ...
  assign new_n41_ = (x03 | ((~x08 | (~x02 & x16) | (x06 & (~x06 | x07))) & (~x07 | x08 | ~x02 | ~x06))) & (~x07 | x16 | (~x06 ^ x08));
  assign z05 = ~new_n43_ | (x16 & ((~x02 & (x09 ? x07 : ~x03)) | (x03 & x07)));
  assign new_n43_ = (x03 | (x09 ? x07 : x04)) & (~x07 | ((~x09 | (x06 & x08)) & x04 & (~x06 | ~x08 | x09)));
  assign z06 = new_n46_ | new_n47_ | ~x04 | new_n45_ | new_n48_;
  assign new_n45_ = ~x02 & x16;
  assign new_n46_ = x03 & (~x07 | x16);
  assign new_n47_ = x10 & (~x08 | x09 | ~x06 | ~x07);
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = new_n46_ | ~x04 | new_n45_ | new_n50_ | (~new_n48_ & x11);
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n46_ | (~new_n50_ & x12) | ~new_n52_ | ~x04;
  assign new_n52_ = ~new_n45_ & (~new_n53_ | ~x06 | ~x07 | ~x08);
  assign new_n53_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n57_ | (~x03 & (x13 ? ~x07 : ~x04)) | (~new_n55_ & x07);
  assign new_n55_ = (~x13 | (new_n56_ & ~x10 & ~x11 & ~x12)) & x04 & (~new_n56_ | x12 | x13 | x10 | x11);
  assign new_n56_ = x06 & x08 & ~x09;
  assign new_n57_ = x16 & ((x03 & x07) | (~x02 & (x13 ? x07 : ~x03)));
  assign z10 = x04 & (new_n63_ | (~new_n59_ & x07));
