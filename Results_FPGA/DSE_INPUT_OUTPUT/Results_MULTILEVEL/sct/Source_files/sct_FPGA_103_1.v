...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n40_, new_n42_, new_n44_, new_n46_, new_n48_, new_n50_, new_n51_,
  ...
  assign z05 = ~new_n44_ | (~x07 & (x09 | x16));
  assign new_n44_ = (~x09 | (x06 & x08)) & ~new_n40_ & x04 & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = (~x04 & (x07 | (~x10 & ~x16))) | (~new_n46_ & x07) | (~x07 & x10 & ~x16);
  assign new_n46_ = ~new_n40_ & (~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08);
  assign z07 = (~x04 & (x07 | (~x11 & ~x16))) | (~new_n48_ & x07) | (~x07 & x11 & ~x16);
  assign new_n48_ = ~new_n40_ & (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~x07 & (x12 | x16)) | new_n40_ | ~new_n50_ | (~new_n52_ & x12);
  assign new_n50_ = x04 & (~new_n51_ | ~x06 | ~x07 | ~x08);
  assign new_n51_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = (~x04 & (x07 | (~x13 & ~x16))) | (~new_n54_ & x07) | (~x07 & x13 & ~x16);
  assign new_n54_ = ~new_n40_ & (~x13 | (new_n55_ & ~x10 & ~x11 & ~x12)) & (~new_n55_ | x12 | x13 | x10 | x11);
  assign new_n55_ = x06 & x08 & ~x09;
  assign z10 = (~x07 & x16) | (x04 & (new_n57_ | (new_n40_ & x14)));
  assign new_n57_ = x06 & x08 & ~x09 & ~new_n58_ & ~new_n59_;
  assign new_n58_ = (~x07 | x16) & (~x02 | x03 | ~x16);
