...
module FAU ( 
  ...
  assign z06 = (x06 & (new_n44_ | ~x04)) | (x04 & (new_n39_ | new_n45_));
  ...
  assign z08 = (x06 & (new_n50_ | ~x04)) | (x04 & (new_n39_ | (~new_n48_ & x12)));
  assign new_n50_ = new_n51_ & ~x10 & ~x11 & ~x12;
  assign new_n51_ = x07 & x08 & ~x09;
  assign z09 = (x06 & (~x04 | (new_n51_ & new_n55_))) | (x04 & (new_n53_ | new_n39_));
