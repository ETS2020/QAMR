...
module FAU ( 
  ...
  assign z07 = (x04 & (~new_n46_ | new_n39_)) | (~x06 & (~x04 | x11));
  assign new_n46_ = (~x11 | (new_n47_ & ~x09 & ~x10)) & (~new_n47_ | ~x06 | x09 | x10 | x11);
  assign new_n47_ = x07 & x08;
  assign z08 = (x04 & (~new_n49_ | new_n39_)) | (~x06 & (~x04 | x12));
  assign new_n49_ = (~x12 | (new_n47_ & ~x09 & ~x10 & ~x11)) & (~new_n47_ | ~x06 | x11 | x12 | x09 | x10);
  assign z09 = new_n39_ | ~new_n52_ | (~new_n51_ & x13);
  assign new_n51_ = new_n47_ & x06 & ~x11 & ~x12 & ~x09 & ~x10;
