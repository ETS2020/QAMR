...
module FAU ( 
  ...
  assign z00 = x01 ? (~x02 & (~x12 | x14)) : (~x12 & ~x14);
  ...
  assign z06 = new_n40_ | (~new_n45_ & x10) | ~x04 | new_n47_ | new_n38_;
  assign new_n47_ = x06 & x07 & new_n48_ & x08;
  assign new_n48_ = ~x09 & ~x10;
  assign z07 = new_n40_ | (~new_n47_ & x11) | ~x04 | new_n50_ | new_n38_;
  assign new_n50_ = new_n44_ & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n52_ | new_n40_;
  assign new_n52_ = (~x12 | (new_n44_ & new_n48_ & ~x11 & x14)) & x04 & (~new_n44_ | ~new_n48_ | x11 | x12);
  assign z09 = ((new_n40_ | ~x04) & (~x12 | (~x13 & x14))) | (~new_n54_ & ~x12) | (x12 & x13 & x14);
  assign new_n54_ = (~x13 | (new_n44_ & ~x09 & ~x10 & ~x11)) & (~new_n44_ | x09 | x10 | x11 | x13);
  assign z10 = new_n38_ | (x04 & (new_n58_ | (x06 & new_n56_ & x07)));
  assign new_n56_ = x08 & ~x09 & ((~new_n40_ & (new_n57_ | x00)) | (x00 & x12));
  assign new_n57_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n58_ = x16 & (x12 | x14) & (~x02 | x03);
