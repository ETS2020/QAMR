...
module FAU ( 
  ...
  assign z06 = new_n39_ | (~new_n44_ & x10) | ~x04 | new_n45_ | ~x07;
  assign new_n44_ = x06 & x08 & ~x09;
  assign new_n45_ = x06 & x08 & ~x09 & ~x10;
  assign z07 = new_n39_ | (~new_n45_ & x11) | ~new_n47_ | ~x04;
  assign new_n47_ = x07 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = ~x04 | (x07 & (new_n39_ | ~new_n49_));
  assign new_n49_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = ~x04 | (x07 & (~new_n51_ | new_n39_));
