...
module FAU ( 
  ...
  assign new_n41_ = (~x08 | ((x06 | ~x07 | x16) & (~x02 | x03 | ~x16 | (x06 & (~x06 | x07))))) & (~x06 | ~x07 | x08 | ((~x02 | x03) & x16));
  assign z05 = ~new_n43_ | ((~x07 | x16) & (~x02 | x03));
  assign new_n43_ = (x07 | (~x09 & x16)) & (~x09 | (x06 & x08)) & x04 & (~x08 | x09 | ~x06 | ~x07);
  assign z06 = (~x04 & (x07 | (~x10 & x16))) | (~new_n45_ & x16) | (~new_n46_ & x07);
  assign new_n45_ = x02 & ~x03 & (x07 | ~x10);
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x07 | (~x11 & x16))) | (~new_n48_ & x16) | (~new_n49_ & x07);
  assign new_n48_ = x02 & ~x03 & (x07 | ~x11);
  assign new_n49_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = ~new_n51_ | (x06 & new_n54_ & x08);
  assign new_n51_ = (x07 | (~x12 & x16)) & ~new_n52_ & x04 & (new_n53_ | ~x12);
  assign new_n52_ = x16 & (~x02 | x03);
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n54_ = ~x09 & ~x10 & ~x11 & ~x12 & (x07 | ~x16);
  assign z09 = (~x04 & (x07 | (~x13 & x16))) | (~new_n58_ & x16) | (~new_n56_ & x07);
  ...
  assign z10 = (~x07 & ~x16) | (x04 & (new_n60_ | (new_n52_ & x14)));
