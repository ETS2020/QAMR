...
module FAU ( 
  ...
  assign z07 = new_n48_ | new_n40_ | ~x04 | (~new_n50_ & x11);
  assign new_n48_ = x07 & (~x18 | (x06 & x08 & new_n49_ & ~x09));
  assign new_n49_ = ~x10 & ~x11;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & x18;
  assign z08 = new_n44_ | (~new_n48_ & x12) | (new_n52_ & new_n49_ & ~x12 & x18);
  assign new_n52_ = x08 & ~x09 & x06 & x07;
  assign z09 = new_n44_ | new_n54_ | (x13 & (~x07 | (~new_n55_ & x18)));
  assign new_n54_ = new_n52_ & new_n49_ & ~x12 & ~x13 & x18;
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x18 & (new_n57_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
