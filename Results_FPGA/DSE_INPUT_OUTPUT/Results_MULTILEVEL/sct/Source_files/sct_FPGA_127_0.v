...
module FAU ( 
  ...
  assign z07 = (x07 & (new_n46_ | ~x04)) | (x04 & (new_n39_ | new_n47_));
  assign new_n46_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n47_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = (x07 & (new_n49_ | ~x04)) | (x04 & (new_n39_ | (~new_n51_ & x12)));
  assign new_n49_ = new_n50_ & ~x10 & ~x11 & ~x12;
  assign new_n50_ = x06 & x08 & ~x09;
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = (x07 & (~x04 | (new_n50_ & new_n55_))) | (x04 & (new_n53_ | new_n39_));
