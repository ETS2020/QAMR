...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (x07 | (~x09 & x12))) | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (~x07 & x09 & x12);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = (~new_n44_ & (x07 | (~x10 & x12))) | (~new_n46_ & x07) | (~x07 & x10 & x12);
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x07 & (x11 | ~x12)) | ~new_n48_ | new_n40_;
  assign new_n48_ = (~x11 | (new_n49_ & ~x09 & ~x10)) & x04 & (~new_n50_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x08;
  assign new_n50_ = x06 & x07 & x08;
  assign z08 = ~new_n52_ | (~new_n44_ & ~new_n37_);
  assign new_n52_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & (~new_n50_ | x11 | x12 | x09 | x10);
  assign z09 = (~new_n44_ & (x07 | x12)) | (~new_n54_ & x07) | (x12 & x13);
  assign new_n54_ = (~x13 | (x06 & x08 & new_n55_ & ~x09)) & (~x06 | ~x08 | x09 | ~new_n55_ | x12 | x13);
  assign new_n55_ = ~x10 & ~x11;
  assign z10 = new_n37_ | (x04 & ((new_n57_ & x06) | (new_n40_ & x14)));
  assign new_n57_ = x08 & ~x09 & ~new_n40_ & ~new_n58_;
