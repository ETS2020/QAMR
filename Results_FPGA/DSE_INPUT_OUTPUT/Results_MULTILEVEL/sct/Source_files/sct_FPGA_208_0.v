...
module FAU ( 
  ...
  assign z05 = new_n40_ | new_n44_ | ~x04 | new_n37_ | new_n45_;
  assign new_n44_ = x09 & (~x06 | ~x07 | ~x08);
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z06 = new_n47_ | new_n48_ | (~new_n45_ & x10);
  assign new_n47_ = (x10 | x13) & (~x04 | ((~x02 | x03) & x16));
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10 & x13;
  assign z07 = (~new_n50_ & ~x10) | new_n40_ | ~x04 | (~new_n48_ & x11);
  assign new_n50_ = x13 & (~x06 | ~x07 | ~x08 | x09 | x11);
  assign z08 = new_n47_ | (x12 & (new_n50_ | x10)) | (new_n45_ & new_n52_);
  assign new_n52_ = ~x10 & ~x11 & ~x12 & x13;
  assign z09 = new_n47_ | (x13 & (~new_n54_ | ~x06 | ~x07 | ~x08));
