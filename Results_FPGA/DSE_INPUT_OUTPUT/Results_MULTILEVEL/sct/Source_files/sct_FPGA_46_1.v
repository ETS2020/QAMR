...
module FAU ( 
  ...
  assign z07 = (~x11 & (new_n48_ | x12)) | new_n40_ | ~x04 | (~new_n48_ & x11);
  assign new_n48_ = x06 & x07 & new_n49_ & x08;
  assign new_n49_ = ~x09 & ~x10;
  assign z08 = new_n40_ | ~x04 | new_n51_ | x12;
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = ((x11 | ~x12) & (new_n40_ | ~x04)) | (~new_n53_ & ~x12) | (x11 & x13);
  assign new_n53_ = (~x13 | (x06 & x07 & new_n49_ & x08)) & (~x06 | ~x07 | ~x08 | ~new_n49_ | x11 | x13);
