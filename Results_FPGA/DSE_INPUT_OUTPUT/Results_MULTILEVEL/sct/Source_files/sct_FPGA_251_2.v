...
module FAU ( 
  ...
  assign z05 = (~new_n43_ & (~x06 | x07)) | (x07 & ((~x08 & x09) | (x06 & x08 & ~x09))) | (~x06 & x09);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = (~new_n43_ & (~x06 | x07)) | (x07 & ((x10 & (~x08 | x09)) | (x06 & x08 & ~x09 & ~x10))) | (~x06 & x10);
  assign z07 = ~new_n46_ | (~new_n43_ & (~x06 | x07));
  assign new_n46_ = (~x07 | ((~x11 | (x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11))) & (x06 | ~x11);
  assign z08 = (~new_n43_ & (~x06 | x07)) | (~x06 & x12) | (~new_n48_ & x07);
  assign new_n48_ = (~x12 | (x08 & ~x09 & ~x10 & ~x11)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = (~new_n50_ & x06) | new_n39_ | ~x04 | (~new_n52_ & x13);
  assign new_n50_ = x07 & (~new_n51_ | ~x08 | x11 | x12 | x13);
  assign new_n51_ = ~x09 & ~x10;
  assign new_n52_ = x06 & x07 & x08 & new_n51_ & ~x11 & ~x12;
  assign z10 = x04 & ((x07 & (new_n56_ | (x06 & new_n54_ & x08))) | (new_n56_ & ~x06));
