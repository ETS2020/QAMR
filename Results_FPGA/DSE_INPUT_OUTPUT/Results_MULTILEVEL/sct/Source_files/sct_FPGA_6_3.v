...
module FAU ( 
  ...
  assign new_n54_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n51_ | ~x06 | x09 | x10 | x11 | x12);
  assign z09 = (~x04 & (~x06 | ~x16)) | (~x06 & (new_n39_ | x13)) | (~new_n56_ & ~x16);
  assign new_n56_ = (~x13 | (new_n45_ & ~x10 & ~x11 & ~x12)) & (~new_n57_ | x10 | x11 | x12 | x13);
  assign new_n57_ = x06 & x07 & x08 & ~x09;
  assign z10 = x04 & (x06 ? new_n59_ : (new_n39_ & x14));
  assign new_n59_ = x07 & x08 & new_n60_ & ~x09;
