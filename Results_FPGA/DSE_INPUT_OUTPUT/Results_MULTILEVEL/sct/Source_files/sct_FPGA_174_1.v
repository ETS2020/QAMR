...
module FAU ( 
  ...
  assign z02 = x04 ? (~new_n39_ & ~x06) : x05;
  ...
  assign z06 = x04 ? (new_n39_ | new_n45_ | (~new_n44_ & x10)) : ~x05;
  ...
  assign z09 = new_n39_ | (~new_n49_ & x13) | ~x04 | (new_n44_ & new_n52_);
  assign new_n52_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign z10 = x04 ? ((new_n54_ & x06) | (new_n39_ & x14)) : x05;
