...
module FAU ( 
  ...
  assign z06 = (~x04 & (x03 | ~x07)) | (~new_n46_ & x03) | (~x07 & (new_n45_ | x10));
  assign new_n45_ = ~x02 & x16;
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & ~x16 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x03 | ~x07)) | (~x07 & (new_n45_ | x11)) | (~new_n48_ & x03);
  assign new_n48_ = (~x11 | (new_n50_ & ~x09 & ~x10)) & ~x16 & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x07 & x08;
  assign new_n50_ = x06 & x08;
  assign z08 = (~x04 & (x03 | ~x07)) | (~x07 & (new_n45_ | x12)) | (~new_n52_ & x03);
  assign new_n52_ = ~new_n53_ & ~x16 & (~new_n49_ | ~new_n54_);
  assign new_n53_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n54_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = (~x03 & (x07 | x13)) | new_n59_ | ~new_n57_ | (~new_n56_ & x13);
