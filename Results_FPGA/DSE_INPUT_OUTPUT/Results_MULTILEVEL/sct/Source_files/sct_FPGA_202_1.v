...
module FAU ( 
  ...
  assign z07 = new_n39_ | new_n49_ | new_n48_ | ~x04;
  assign new_n48_ = new_n43_ & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = ~new_n51_ | new_n39_;
  assign new_n51_ = (~x12 | (new_n43_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n43_ | x11 | x12 | x09 | x10);
  assign z09 = (x04 & (~new_n53_ | new_n39_)) | (~x07 & (~x04 | x13));
  assign new_n53_ = (~new_n44_ | x12 | x13 | x10 | x11) & (~x13 | (new_n54_ & ~x10 & ~x11 & ~x12));
