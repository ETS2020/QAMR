...
module FAU ( 
  ...
  assign new_n41_ = (~x08 | x16) & (~x02 | x03 | (x06 ? (~x07 ^ x08) : ~x08));
  ...
  assign z09 = (~x04 & (~x07 | x16)) | (~new_n58_ & x16) | (~x07 & x13);
  assign new_n58_ = (new_n59_ | ~x13) & x02 & ~x03 & (~new_n60_ | ~new_n61_);
  assign new_n59_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n60_ = x08 & ~x09 & x06 & x07;
  assign new_n61_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = (x07 & ~x16) | (x04 & (new_n63_ | (x14 & ~new_n43_ & x16)));
