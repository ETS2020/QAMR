...
module FAU ( 
  ...
  assign z05 = ((x06 | ~x07) & (new_n39_ | ~x04)) | (x06 & ((~x08 & x09) | (x07 & x08 & ~x09))) | (~x07 & x09);
  assign z06 = ~new_n44_ | (~x06 & (x07 | x10));
  assign new_n44_ = ~new_n39_ & (~x10 | (x07 & x08 & ~x09)) & x04 & (~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n46_ | ((x06 | ~x07) & (new_n39_ | ~x04));
  ...
  assign z09 = ~new_n52_ | new_n39_ | (~x06 & (x07 | x13));
  assign new_n52_ = (~x13 | (new_n49_ & ~x10 & ~x11 & ~x12)) & x04 & (~new_n49_ | x10 | x11 | x12 | x13);
  assign z10 = (~x06 & x07) | (x04 & ((new_n54_ & x07) | (new_n39_ & x14)));
