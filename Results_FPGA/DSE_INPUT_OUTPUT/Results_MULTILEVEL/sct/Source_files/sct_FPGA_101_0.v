...
module FAU ( 
  ...
  assign new_n48_ = (~x12 | (~x10 & ~x11 & x07 & x08)) & (x10 | x11 | x12 | ~x07 | ~x08 | x09);
  assign z09 = ((x06 | x09) & (new_n39_ | ~x04)) | (~new_n50_ & x06) | (x09 & x13);
  assign new_n50_ = (~x13 | (new_n51_ & x07 & x08)) & (~new_n52_ | ~x07 | ~x08 | x09);
