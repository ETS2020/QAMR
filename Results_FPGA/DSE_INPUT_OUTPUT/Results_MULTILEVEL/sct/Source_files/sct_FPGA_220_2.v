...
module FAU ( 
  ...
  assign new_n46_ = (~x10 | ~x15 | (x06 & x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ((new_n40_ | ~x04) & (~x10 | (~x11 & x15))) | (~new_n48_ & ~x10) | (x10 & x11 & x15);
  assign new_n48_ = (~x06 | ~x07 | ~x08 | x09 | x11) & (~x11 | (x06 & x07 & x08 & ~x09));
  assign z08 = ((new_n40_ | ~x04) & (~x10 | (~x12 & x15))) | (~new_n50_ & ~x10) | (x10 & x12 & x15);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x09 & ~x11)) & (~x06 | ~x07 | ~x08 | x09 | x11 | x12);
  assign z09 = (x10 & (x13 | ~x15)) | new_n40_ | ~new_n52_ | (~new_n54_ & x13);
