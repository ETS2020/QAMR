...
module FAU ( 
  ...
  assign z00 = (~x07 & x15) | (~x01 & ~x14) | (x01 & ~x02);
  ...
  assign z08 = (~new_n43_ & (x07 | (~x12 & ~x15))) | (~new_n49_ & x07) | (~x07 & x12 & ~x15);
  assign new_n49_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~x07 & (x13 | x15)) | new_n39_ | ~new_n51_ | (~new_n53_ & x13);
  assign new_n51_ = x04 & (~new_n52_ | ~x08 | x09 | ~x06 | ~x07);
  assign new_n52_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = (~x07 & x15) | (x04 & (new_n56_ | (x06 & new_n55_ & x07)));
  assign new_n55_ = x08 & ~x09 & ~new_n39_ & (new_n52_ | x00);
  assign new_n56_ = new_n39_ & x14;
  assign z11 = x02 | (~x07 & x15);
  assign z12 = x04 & (x07 | ~x15) & (x03 | (~x02 & x16));
