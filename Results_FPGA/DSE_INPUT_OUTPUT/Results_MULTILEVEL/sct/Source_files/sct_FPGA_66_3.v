...
module FAU ( 
  ...
  assign z08 = new_n52_ | new_n40_ | ~x04 | (~new_n51_ & x12);
  assign new_n51_ = x06 & x07 & x08 & new_n49_ & ~x11 & ~x15;
  assign new_n52_ = x07 & (new_n53_ | x15);
  assign new_n53_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n44_ | new_n55_ | (~new_n52_ & x13);
