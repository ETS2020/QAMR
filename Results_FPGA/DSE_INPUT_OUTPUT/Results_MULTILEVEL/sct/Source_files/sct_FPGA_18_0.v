...
module FAU ( 
  ...
  assign z03 = x04 ? (~new_n39_ & (x06 ^ x07)) : ~x09;
  ...
  assign new_n52_ = x04 & (~new_n53_ | x10 | x11 | x12 | x13);
  assign new_n53_ = x08 & ~x09 & x06 & x07;
  assign z10 = (~x09 & (new_n55_ | ~x04)) | (x04 & new_n39_ & x14);
  assign new_n55_ = x06 & x07 & x08 & ~new_n39_ & ~new_n56_;
