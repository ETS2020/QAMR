...
module FAU ( 
  ...
  assign z07 = (new_n48_ & x06) | new_n40_ | ~x04 | (~new_n49_ & x11);
  assign new_n48_ = x07 & x08 & ~x09 & ~x10 & (~x11 | ~x12);
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10 & x12;
  assign z08 = new_n40_ | new_n51_ | ~x04 | new_n53_ | x11;
  assign new_n51_ = x12 & (~x06 | ~x07 | ~new_n52_ | ~x08);
  assign new_n52_ = ~x09 & ~x10;
  assign new_n53_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x12;
  assign z09 = ((new_n40_ | ~x04) & (~x11 | x12)) | (x12 & x13) | (~new_n55_ & ~x11);
  assign new_n55_ = (~x13 | (x06 & x07 & new_n52_ & x08)) & (~x06 | ~x07 | ~x08 | ~new_n52_ | x12 | x13);
