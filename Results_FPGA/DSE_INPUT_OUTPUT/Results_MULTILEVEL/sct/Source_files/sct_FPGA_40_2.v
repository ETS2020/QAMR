...
module FAU ( 
  ...
  assign z08 = (~new_n48_ & x06) | new_n39_ | ~x04 | (~new_n49_ & x12);
  assign new_n48_ = x07 & (~x08 | x09 | x10 | x11 | x12);
  assign new_n49_ = ~x09 & ~x10 & ~x11 & x06 & x07 & x08;
  assign z09 = (x06 & (new_n53_ | ~x07)) | new_n39_ | new_n51_ | ~x04;
  assign new_n51_ = x13 & (~new_n52_ | ~x06 | ~x07 | ~x08);
  assign new_n52_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n53_ = ~x11 & ~x12 & ~x13 & x08 & ~x09 & ~x10;
