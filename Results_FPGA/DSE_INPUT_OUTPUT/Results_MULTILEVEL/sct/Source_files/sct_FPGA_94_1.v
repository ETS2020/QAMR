...
module FAU ( 
  ...
  assign z07 = (x04 & (~new_n48_ | new_n39_)) | (~x07 & (~x04 | x11));
  assign new_n48_ = (~x11 | (new_n49_ & ~x09 & ~x10)) & (~new_n43_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x08;
  assign z08 = (x04 & (~new_n51_ | new_n39_)) | (~x07 & (~x04 | x12));
  assign new_n51_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & (~new_n43_ | x11 | x12 | x09 | x10);
  assign z09 = new_n39_ | new_n53_ | ~new_n54_;
  assign new_n53_ = x13 & (~new_n43_ | x09 | x10 | x11 | x12);
  assign new_n54_ = x04 & (~new_n44_ | x12 | x13 | x10 | x11);
