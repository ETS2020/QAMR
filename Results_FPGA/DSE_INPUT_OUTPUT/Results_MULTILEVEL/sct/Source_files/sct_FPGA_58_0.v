...
module FAU ( 
  ...
  assign new_n45_ = ~x02 & (~x07 | x16);
  assign z06 = new_n45_ | new_n47_ | new_n44_ | new_n48_ | ~x04;
  assign new_n47_ = x10 & (~x06 | ~x07 | ~x08 | x09);
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = new_n45_ | new_n44_ | new_n50_ | ~x04 | (~new_n48_ & x11);
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n45_ | (~new_n50_ & x12) | ~new_n52_ | ~x04;
  assign new_n52_ = ~new_n44_ & (~new_n53_ | ~x06 | ~x07 | ~x08);
  assign new_n53_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n57_ | (x02 & (x13 ? ~x07 : ~x04)) | (~new_n55_ & x07);
  assign new_n55_ = (~x13 | (new_n56_ & ~x10 & ~x11 & ~x12)) & x04 & (~new_n56_ | x12 | x13 | x10 | x11);
  assign new_n56_ = x06 & x08 & ~x09;
  assign new_n57_ = x16 & ((~x02 & x07) | (x03 & (x13 ? x07 : x02)));
  assign z10 = (~x02 & ~x07) | (x04 & (new_n59_ | new_n62_));
  assign new_n59_ = x06 & x08 & ~x09 & ~new_n60_ & ~new_n61_;
  assign new_n60_ = ~x00 & (x12 | x13 | x10 | x11);
  assign new_n61_ = (x02 | x16) & (~x07 | (x16 & (~x02 | x03)));
