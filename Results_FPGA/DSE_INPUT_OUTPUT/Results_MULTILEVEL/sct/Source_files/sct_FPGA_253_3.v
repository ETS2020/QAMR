...
module FAU ( 
  ...
  assign new_n41_ = (~x08 | (x16 & (~x02 | x03)) | (x06 & (~x06 | x07))) & (~x06 | ~x07 | x08 | x16);
  assign z05 = (~x04 & (~x02 | ~x07)) | (~x07 & (new_n43_ | x09)) | (~new_n44_ & ~x02);
  assign new_n43_ = x03 & x16;
  assign new_n44_ = (~x09 | (x06 & x08)) & ~x16 & (~x08 | x09 | ~x06 | ~x07);
  assign z06 = (x02 & (x07 | x10)) | ~new_n46_ | (x16 & (~x02 | x03 | x10));
  assign new_n46_ = (new_n47_ | ~x10) & ~new_n48_ & x04;
  assign new_n47_ = x08 & ~x09 & x06 & x07;
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = (x02 & (x07 | x11)) | ~new_n50_ | (x16 & (~x02 | x03 | x11));
  assign new_n50_ = (new_n48_ | ~x11) & x04 & (~new_n51_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x07 & x08;
  assign z08 = (~x04 & (~x02 | ~x07)) | (~x07 & (new_n43_ | x12)) | (~new_n53_ & ~x02);
  assign new_n53_ = ~new_n54_ & ~x16 & (~new_n51_ | ~new_n55_);
  assign new_n54_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = (~x04 & (~x02 | ~x07)) | (~x07 & (new_n43_ | x13)) | (~new_n57_ & ~x02);
  assign new_n57_ = (new_n58_ | ~x13) & ~x16 & (~new_n47_ | ~new_n59_);
  assign new_n58_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n59_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = (x02 & x07) | (x04 & (new_n62_ | (x06 & new_n61_ & x07)));
  assign new_n61_ = x08 & ~x09 & ~x16 & (new_n59_ | x00);
