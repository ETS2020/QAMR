...
module FAU ( 
  ...
  assign z04 = (x07 & ~x16) | (x04 & ((x08 & (~x06 | (x06 & ~x07)) & (new_n41_ | ~x16)) | (new_n41_ & x06 & x07 & ~x08)));
  assign new_n41_ = x02 & ~x03;
  assign z05 = (~x04 & (~x07 | x16)) | (~new_n43_ & x16) | (~x07 & x09);
  assign new_n43_ = (~x09 | (x06 & x08)) & x02 & ~x03 & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = (~new_n41_ & (x10 | x16)) | new_n45_ | ~x04 | (~new_n47_ & x10);
  assign new_n45_ = x07 & (new_n46_ | ~x16);
  assign new_n46_ = x06 & x08 & ~x09 & ~x10;
  assign new_n47_ = x06 & x07 & x08 & ~x09 & x16;
  assign z07 = (~x04 & (~x07 | x16)) | (~x07 & x11) | (x16 & (~new_n49_ | (~new_n46_ & x11)));
  assign new_n49_ = x02 & ~new_n50_ & ~x03;
