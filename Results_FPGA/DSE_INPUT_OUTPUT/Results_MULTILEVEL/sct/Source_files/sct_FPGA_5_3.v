...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (~x01 | ~x07)) | (~x07 & x09) | (~x01 & ((x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07)));
  ...
  assign z10 = new_n38_ | (x04 & ((new_n58_ & x06) | (new_n40_ & x14)));
  assign new_n58_ = x07 & x08 & ~x09 & ~new_n40_ & ~new_n59_;
