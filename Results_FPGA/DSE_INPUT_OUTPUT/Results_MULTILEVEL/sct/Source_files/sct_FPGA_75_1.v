...
module FAU ( 
  ...
  assign z06 = new_n39_ | new_n46_ | ~x04 | (~new_n44_ & x10);
  assign new_n46_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = ~new_n48_ | new_n39_;
  assign new_n48_ = (new_n46_ | ~x11) & x04 & (~new_n43_ | x09 | x10 | x11);
  assign z08 = (x04 & (~new_n50_ | new_n39_)) | (~x07 & (~x04 | x12));
  assign new_n50_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n43_ | x11 | x12 | x09 | x10);
  assign new_n51_ = x06 & x08;
  assign z09 = (x04 & (~new_n53_ | new_n39_)) | (~x07 & (~x04 | x13));
  assign new_n53_ = (~x13 | (new_n54_ & ~x10 & ~x11 & ~x12)) & (~new_n44_ | x12 | x13 | x10 | x11);
  assign new_n54_ = x06 & x08 & ~x09;
  assign z10 = (x07 & (~x04 | (new_n56_ & x06))) | (x04 & new_n39_ & x14);
