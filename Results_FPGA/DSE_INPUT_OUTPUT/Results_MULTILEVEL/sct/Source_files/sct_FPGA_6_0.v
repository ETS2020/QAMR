...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n42_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n55_, new_n57_, new_n58_, new_n59_,
    new_n61_, new_n62_;
  assign z00 = (x06 | x16) & (x01 ? ~x02 : ~x14);
  ...
  assign z05 = ~new_n44_ | (~new_n39_ & (~x06 | x16));
  ...
  assign z08 = (~x04 & (x06 | (~x12 & x16))) | (~new_n54_ & x16) | (~new_n55_ & x06);
  assign new_n54_ = x02 & ~x03 & (x06 | ~x12);
  assign new_n55_ = (~x12 | (x07 & x08 & ~x09 & ~x10 & ~x11)) & (~x07 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~x04 & (x06 | (~x13 & x16))) | (~new_n59_ & x16) | (~new_n57_ & x06);
  assign new_n57_ = (~x13 | (new_n58_ & ~x10 & ~x11 & ~x12)) & (~new_n58_ | x12 | x13 | x10 | x11);
  assign new_n58_ = x07 & x08 & ~x09;
  assign new_n59_ = x02 & ~x03 & (x06 | ~x13);
  assign z10 = x04 & ((new_n61_ & x06) | (new_n51_ & x14));
  assign new_n61_ = x07 & x08 & ~x09 & ~new_n51_ & (new_n62_ | x00);
  assign new_n62_ = ~x12 & ~x13 & ~x10 & ~x11;
