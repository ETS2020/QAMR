...
module FAU ( 
  ...
  assign z06 = (x06 & (~x04 | (new_n45_ & ~x09 & ~x10))) | (~new_n44_ & x04);
  assign new_n44_ = ~new_n40_ & (~x10 | (x08 & ~x09 & x06 & x07));
  assign new_n45_ = x07 & x08;
  assign z07 = (x06 & (new_n47_ | ~x04)) | (x04 & (new_n40_ | new_n48_));
  assign new_n47_ = new_n45_ & ~x09 & ~x10 & ~x11;
  assign new_n48_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = (x06 & (new_n50_ | ~x04)) | (x04 & (new_n40_ | (~new_n52_ & x12)));
  assign new_n50_ = new_n51_ & ~x10 & ~x11 & ~x12;
  assign new_n51_ = x07 & x08 & ~x09;
  assign new_n52_ = new_n45_ & x06 & ~x09 & ~x10 & ~x11;
  assign z09 = (x06 & (~x04 | (new_n51_ & new_n56_))) | (x04 & (new_n54_ | new_n40_));
  assign new_n54_ = x13 & (~new_n55_ | ~new_n45_ | ~x06);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign new_n56_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 ? ((new_n58_ & x06) | (new_n40_ & x14)) : ~x06;
