...
module FAU ( 
  ...
  assign z06 = ((x10 | ~x13) & (new_n40_ | ~x04)) | new_n47_ | (~new_n45_ & x10);
  assign new_n47_ = new_n44_ & ~x09 & ~x10 & ~x13;
  assign z07 = (~new_n49_ & ~x10) | new_n40_ | ~x04 | (~new_n47_ & x11);
  assign new_n49_ = ~x13 & (~x06 | ~x07 | ~x08 | x09 | x11);
  assign z08 = ~new_n51_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n51_ = (~x12 | (~new_n49_ & ~x10)) & (~new_n45_ | x10 | x11 | x12 | x13);
  assign z09 = x13 ? x10 : (~new_n53_ | new_n40_);
  assign new_n53_ = x04 & (~new_n44_ | x09 | x10 | x11 | x12);
