...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n40_ & ((~x06 & x07) | (x00 & x06 & ~x07));
  assign z04 = (~x00 & ~x07) | (x04 & ~new_n40_ & (x07 ? (x06 ^ x08) : x08));
  assign z05 = (~new_n44_ & (x07 | (x00 & ~x09))) | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (x00 & ~x07 & x09);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = (~new_n44_ & (x07 | (x00 & ~x10))) | (~new_n46_ & x07) | (x00 & ~x07 & x10);
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~new_n44_ & (x07 | (x00 & ~x11))) | (~new_n48_ & x07) | (x00 & ~x07 & x11);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~new_n44_ & (x07 | (x00 & ~x12))) | (~new_n50_ & x07) | (x00 & ~x07 & x12);
  assign new_n50_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~new_n44_ & (x07 | (x00 & ~x13))) | (~new_n52_ & x07) | (x00 & ~x07 & x13);
  ...
  assign new_n55_ = x07 & x08 & ~new_n40_ & ~new_n56_ & ~x09;
