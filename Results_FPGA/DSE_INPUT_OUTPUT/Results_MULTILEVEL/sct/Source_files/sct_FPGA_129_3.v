...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (~x07 | ~x12)) | (x09 & (~x07 | (~x12 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & ~x12);
  ...
  assign z07 = (~new_n50_ & x07) | new_n40_ | ~x04 | (~new_n48_ & x11);
  assign new_n48_ = new_n49_ & ~x09 & ~x10 & ~x12;
  assign new_n49_ = x06 & x07 & x08;
  assign new_n50_ = ~x12 & (~new_n51_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x08;
  assign z08 = new_n40_ | ~x04 | new_n53_ | x12;
  assign new_n53_ = new_n49_ & ~x09 & ~x10 & ~x11;
  assign z09 = (~new_n44_ & (~x07 | ~x12)) | (~new_n55_ & ~x12) | (~x07 & x13);
  assign new_n55_ = (~x13 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n49_ | x11 | x13 | x09 | x10);
