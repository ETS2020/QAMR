...
module FAU ( 
  ...
  assign z06 = (~x04 & (x07 | (~x10 & x16))) | (~new_n47_ & x16) | (~new_n48_ & x07);
  assign new_n47_ = x02 & ~x03 & (x07 | ~x10);
  assign new_n48_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x07 | (~x11 & x16))) | (~new_n50_ & x16) | (~new_n51_ & x07);
  assign new_n50_ = x02 & ~x03 & (x07 | ~x11);
  assign new_n51_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~x04 & (x07 | (~x12 & x16))) | (~new_n53_ & x16) | (~new_n54_ & x07);
  assign new_n53_ = x02 & ~x03 & (x07 | ~x12);
  assign new_n54_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~x04 & (x07 | (~x13 & x16))) | (~new_n56_ & x07) | (~new_n58_ & x16);
