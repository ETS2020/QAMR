...
module FAU ( 
  ...
  assign z04 = (~x07 & ~x11) | (x04 & ~new_n40_ & (x07 ? (x06 ^ x08) : x08));
  assign z05 = ~new_n44_ | (~x07 & (x09 | ~x11));
  assign new_n44_ = (~x09 | (x06 & x08)) & ~new_n40_ & x04 & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = ((x07 | (~x10 & x11)) & (new_n40_ | ~x04)) | (~new_n46_ & x07) | (~x07 & x10 & x11);
  ...
  assign z08 = ((new_n40_ | ~x04) & (x07 | x11)) | (~new_n50_ & x07) | (x11 & x12);
  assign new_n50_ = (~x12 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = ((new_n40_ | ~x04) & (x07 | x11)) | (x11 & x13) | (~new_n52_ & x07);
  ...
  assign new_n56_ = x08 & ~x09 & ~new_n40_ & (new_n54_ | (x00 & x07));
