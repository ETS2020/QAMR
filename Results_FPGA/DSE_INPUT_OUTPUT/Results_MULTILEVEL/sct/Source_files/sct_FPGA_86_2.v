...
module FAU ( 
  ...
  assign z05 = ~new_n44_ | (x16 & (~x02 | x03) & (~x09 | (x09 & x10)));
  assign new_n44_ = (x04 | (x09 & ~x10)) & (~x09 | ~x10 | (x06 & x07 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign z06 = ~new_n46_ | (~new_n37_ & ~x04);
  assign new_n46_ = (x09 | (~new_n40_ & (~x06 | ~x07 | ~x08 | x10))) & ~x09 & (~x10 | (x06 & x07 & x08));
  assign z07 = ~new_n48_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n48_ = (x09 | ((~x11 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x10 | x11))) & (~x10 | ~x11);
  assign z08 = ((~x09 | x10) & (new_n40_ | ~x04)) | (~new_n50_ & ~x09) | (x10 & x12);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x11)) & (~x06 | ~x07 | ~x08 | x10 | x11 | x12);
  assign z09 = ~new_n52_ | new_n40_ | (x09 & (~x10 | x13));
  assign new_n52_ = (~x13 | (new_n53_ & ~x10 & ~x11 & ~x12)) & x04 & (~new_n53_ | x12 | x13 | x10 | x11);
