...
module FAU ( 
  ...
  assign z09 = new_n55_ | (~x07 & (x13 | ~x14)) | ~new_n57_ | (~new_n59_ & x13);
  assign new_n55_ = x16 & ~new_n56_ & (x07 | (x04 & (~x07 | x14)));
  assign new_n56_ = x02 & ~x03;
  assign new_n57_ = x04 & (~new_n58_ | ~x08 | x09 | ~x06 | ~x07);
  assign new_n58_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n59_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = (~x07 & ~x14) | (x04 & (new_n61_ | (x16 & ~new_n56_ & (~x07 | x14))));
