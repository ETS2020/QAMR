...
module FAU ( 
  ...
  assign z05 = (~x09 & (new_n44_ | ~x12)) | new_n40_ | ~x04 | (~new_n44_ & x09);
  ...
  assign z08 = new_n40_ | (~new_n51_ & ~x09) | ~x04 | (x09 & x12);
  assign new_n51_ = new_n44_ & ~x10 & ~x11 & x12;
  assign z09 = ~new_n37_ & (new_n40_ | ~x04 | x13);
  assign z10 = x04 & ((x12 & (new_n54_ | (new_n40_ & x14))) | (x09 & new_n40_ & x14));
