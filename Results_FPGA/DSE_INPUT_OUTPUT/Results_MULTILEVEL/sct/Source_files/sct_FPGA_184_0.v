...
module FAU ( 
  ...
  assign z03 = (~x04 & ~x06) | (~new_n39_ & ((~x06 & x07) | (x04 & x06 & ~x07)));
  assign z04 = x04 & ~new_n39_ & (x06 ? (x07 ^ x08) : x08);
  assign z05 = new_n39_ | (x09 & (~x06 | ~x07 | ~x08)) | ~x04 | (x06 & x07 & x08 & ~x09);
  assign z06 = (~new_n44_ & x04) | (x06 & (~x04 | (new_n45_ & ~x09 & ~x10)));
  ...
  assign z09 = (x06 & (~x04 | (new_n51_ & new_n56_))) | (x04 & (new_n54_ | new_n39_));
