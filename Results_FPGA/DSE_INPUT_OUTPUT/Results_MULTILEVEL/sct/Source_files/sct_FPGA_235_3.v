...
module FAU ( 
  ...
  assign z07 = x11 ? ~x07 : (new_n40_ | ~x04 | (new_n48_ & x06 & x07));
  assign new_n48_ = x08 & ~x09 & ~x10;
  assign z08 = (~new_n44_ & (~x07 | ~x11)) | (~new_n50_ & ~x11) | (~x07 & x12);
  assign new_n50_ = (~x12 | (new_n51_ & ~x09 & ~x10)) & (~new_n52_ | x09 | x10 | x12);
  assign new_n51_ = x06 & x08;
  assign new_n52_ = x06 & x07 & x08;
  assign z09 = (~new_n44_ & (~x07 | ~x11)) | (~new_n54_ & ~x11) | (~x07 & x13);
  assign new_n54_ = (~x13 | (new_n51_ & ~x09 & ~x10 & ~x12)) & (~new_n52_ | x12 | x13 | x09 | x10);
  assign z10 = x04 & ((~x11 & (new_n58_ | (x06 & new_n56_ & x07))) | (new_n58_ & ~x07));
