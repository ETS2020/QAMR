...
module FAU ( 
  ...
  assign z06 = ~x04 | (x07 & (new_n39_ | new_n44_ | (~new_n43_ & x10)));
  assign new_n43_ = x06 & x08 & ~x09;
  assign new_n44_ = x06 & x08 & ~x09 & ~x10;
  assign z07 = new_n39_ | (~new_n44_ & x11) | ~x04 | new_n46_ | ~x07;
  assign new_n46_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n39_ | (~new_n46_ & x12) | ~x04 | new_n48_ | ~x07;
  assign new_n48_ = new_n43_ & ~x10 & ~x11 & ~x12;
  assign z09 = new_n39_ | (~new_n48_ & x13) | ~new_n50_ | ~x04;
  assign new_n50_ = x07 & (~new_n43_ | x10 | x11 | x12 | x13);
  assign z10 = x04 & x07 & (new_n52_ | (new_n39_ & x14));
  assign new_n52_ = x06 & x08 & ~x09 & ~new_n39_ & ~new_n53_;
