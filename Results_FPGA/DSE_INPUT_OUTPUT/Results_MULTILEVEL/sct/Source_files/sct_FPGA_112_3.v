...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n40_ & ((x08 & (~x07 | (~x06 & ~x18))) | (x06 & x07 & ~x08 & ~x18));
  assign z05 = (~new_n44_ & (~x07 | ~x18)) | (x09 & (~x07 | (~x18 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & ~x18);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = new_n46_ | new_n40_ | new_n47_ | ~x04;
  assign new_n46_ = x07 & (x18 | (x06 & x08 & ~x09 & ~x10));
  assign new_n47_ = x10 & (~x06 | ~x07 | ~x08 | x09 | x18);
  assign z07 = new_n49_ | (~new_n46_ & x11) | (~new_n44_ & ~new_n37_);
  assign new_n49_ = new_n50_ & x06 & x07 & x08;
  assign new_n50_ = ~x09 & ~x10 & ~x11 & ~x18;
  assign z08 = new_n52_ | new_n40_ | ~x04 | (~new_n49_ & x12);
  assign new_n52_ = x07 & (new_n53_ | x18);
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~new_n44_ & ~new_n37_) | new_n55_ | (~new_n52_ & x13);
  assign new_n55_ = new_n56_ & x06 & x07 & x08 & ~x09;
  assign new_n56_ = ~x10 & ~x11 & ~x12 & ~x13 & ~x18;
