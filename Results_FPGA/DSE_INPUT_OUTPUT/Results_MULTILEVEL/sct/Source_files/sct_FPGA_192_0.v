...
module FAU ( 
  ...
  assign z06 = (x07 & (new_n46_ | ~x04)) | (x04 & (new_n39_ | (~new_n44_ & x10)));
  assign new_n46_ = ~x09 & ~x10 & x06 & x08;
  assign z07 = (x07 & (new_n48_ | ~x04)) | (x04 & (new_n39_ | new_n49_));
  assign new_n48_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = ~new_n51_ | new_n39_;
  assign new_n51_ = (~x12 | (new_n43_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n43_ | x09 | x10 | x11 | x12);
  assign z09 = new_n39_ | new_n53_ | ~x04 | (new_n44_ & new_n54_);
  assign new_n53_ = x13 & (~new_n43_ | x11 | x12 | x09 | x10);
