...
module FAU ( 
  ...
  assign new_n37_ = x12 & ~x15;
  assign z01 = (x12 & (~x05 | ~x15)) | (~x05 & (x15 | ~x18)) | (~x04 & x05);
  ...
  assign z07 = new_n40_ | new_n50_ | ~x04 | new_n49_ | new_n37_;
  assign new_n49_ = new_n44_ & ~x09 & ~x10 & ~x11;
  assign new_n50_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = ~new_n52_ | ((new_n40_ | ~x04) & (~x12 | (~x11 & x15)));
  assign new_n52_ = (~x12 | ~x15 | (new_n44_ & ~x09 & ~x10 & ~x11)) & (~new_n44_ | x11 | x12 | x09 | x10);
  assign z09 = (x12 & (x13 | ~x15)) | new_n40_ | ~new_n54_ | (~new_n49_ & x13);
