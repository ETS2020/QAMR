...
module FAU ( 
  ...
  assign z02 = (x06 & ~x09) | (x04 & ~new_n40_ & ~x06);
  assign new_n40_ = x16 & (~x02 | x03);
  assign z03 = x04 & ~new_n40_ & (x06 ? (~x07 & x09) : x07);
  assign z04 = (x06 & ~x09) | (x04 & ~new_n40_ & (x06 ? (x07 ? ~x08 : (x08 & x09)) : x08));
  assign z05 = new_n40_ | (x06 & (~x07 | ~x08 | ~x09)) | ~x04 | (~x06 & x09);
  assign z06 = new_n40_ | ~x04 | new_n37_ | x10;
