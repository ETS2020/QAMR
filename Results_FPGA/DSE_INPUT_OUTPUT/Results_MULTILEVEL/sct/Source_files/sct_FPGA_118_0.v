...
module FAU ( 
  ...
  assign z08 = new_n39_ | (~new_n48_ & x12) | new_n50_ | ~x04;
  assign new_n50_ = new_n43_ & ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = new_n39_ | ~new_n52_ | (~new_n50_ & x13);
  assign new_n52_ = x04 & (~new_n44_ | x10 | x11 | x12 | x13);
  assign z10 = new_n54_ | (~x04 & ~x13) | (x04 & new_n39_ & x14);
  assign new_n54_ = x06 & x07 & x08 & ~x09 & ~new_n39_ & ~new_n55_;
  assign new_n55_ = (~x00 | ~x04) & (x10 | x11 | x12 | x13);
