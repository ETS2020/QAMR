...
module FAU ( 
  ...
  assign new_n41_ = (x16 | ((x07 | ~x08) & (~x03 | (x06 ? (~x07 | x08) : ~x08)))) & (~x02 | x03 | x07 | ~x08);
  ...
  assign z06 = (~x03 & (x07 | x10)) | ~new_n47_ | (x16 & (~x02 | x03 | x10));
  assign new_n47_ = (new_n45_ | ~x10) & ~new_n48_ & x04;
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = (~x03 & (x07 | x11)) | ~new_n50_ | (x16 & (~x02 | x03 | x11));
  assign new_n50_ = (new_n48_ | ~x11) & x04 & (~new_n44_ | x09 | x10 | x11);
  assign z08 = (~x04 & (x03 | ~x07)) | (~new_n52_ & x03) | (~new_n55_ & ~x07);
  assign new_n52_ = ~new_n53_ & ~x16 & (~new_n44_ | ~new_n54_);
  assign new_n53_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n54_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n55_ = ~x12 & (x02 | ~x16);
  assign z09 = ~z13 | new_n57_ | (~x07 & (x13 | (~x02 & x16)));
  assign new_n57_ = x03 & ((~new_n58_ & x13) | x16 | (new_n45_ & new_n59_));
