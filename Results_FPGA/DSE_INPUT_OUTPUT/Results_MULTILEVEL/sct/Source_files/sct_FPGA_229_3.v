...
module FAU ( 
  ...
  assign new_n41_ = (~x08 | new_n42_ | (x06 & (~x06 | x07))) & (~x06 | ~x07 | x08 | x16);
  assign new_n42_ = x16 & (~x02 | x03);
  assign z05 = (x02 & (x07 | x09)) | ~new_n44_ | (x16 & (~x02 | x03 | x09));
  ...
  assign z07 = (x02 & (x07 | x11)) | ~new_n48_ | (x16 & (~x02 | x03 | x11));
  assign new_n48_ = (new_n50_ | ~x11) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x07 & x08;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = (x02 & (x07 | x12)) | ~new_n52_ | (x16 & (~x02 | x03 | x12));
  assign new_n52_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n49_ | x11 | x12 | x09 | x10);
  assign z09 = (x02 & (x07 | x13)) | new_n42_ | ~new_n55_ | (~new_n54_ & x13);
  assign new_n54_ = new_n49_ & ~x11 & ~x12 & ~x09 & ~x10;
  assign new_n55_ = x04 & (~new_n56_ | ~x08 | x09 | ~x06 | ~x07);
  assign new_n56_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = (x02 & x07) | (x04 & (new_n58_ | (new_n42_ & x14)));
  assign new_n58_ = x06 & x07 & x08 & new_n59_ & ~x09;
