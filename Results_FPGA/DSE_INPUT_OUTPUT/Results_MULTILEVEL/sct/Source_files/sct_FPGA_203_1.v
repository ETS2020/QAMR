...
module FAU ( 
  ...
  assign z07 = (~new_n43_ & (x08 | (~x11 & ~x14))) | (~new_n47_ & x08) | (~x08 & x11 & ~x14);
  assign new_n47_ = (~x11 | (x06 & x07 & ~x09 & ~x10)) & (~x06 | ~x07 | x09 | x10 | x11);
  assign z08 = (~x08 & (x12 | x14)) | new_n39_ | ~new_n49_ | (~new_n51_ & x12);
  ...
  assign z10 = x04 & x08 & (new_n57_ | (new_n39_ & x14));
  assign new_n57_ = x06 & x07 & ~x09 & ~new_n39_ & (new_n54_ | x00);
