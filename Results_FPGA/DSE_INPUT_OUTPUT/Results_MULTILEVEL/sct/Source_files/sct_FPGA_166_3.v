...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n39_ & ((~x01 & ~x06 & x07) | (x06 & ~x07));
  assign z04 = x04 & ~new_n39_ & ((~x07 & x08) | (~x01 & x07 & (x06 ^ x08)));
  assign z05 = (~new_n43_ & (~x01 | ~x07)) | (~x07 & x09) | (~x01 & ((x09 & (~x06 | ~x08)) | (x06 & x07 & x08 & ~x09)));
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = ~new_n45_ | (~new_n43_ & (~x01 | ~x07));
  assign new_n45_ = (x01 | ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (x07 | ~x10);
  assign z07 = (~new_n43_ & (~x01 | ~x07)) | (~new_n47_ & ~x01) | (~x07 & x11);
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & (~new_n49_ | x09 | x10 | x11);
  assign new_n48_ = x06 & x08;
  assign new_n49_ = x06 & x07 & x08;
  assign z08 = (~new_n43_ & (~x01 | ~x07)) | (~new_n51_ & ~x01) | (~x07 & x12);
  assign new_n51_ = (~x12 | (new_n48_ & ~x09 & ~x10 & ~x11)) & (~new_n49_ | x11 | x12 | x09 | x10);
  assign z09 = (~new_n43_ & (~x01 | ~x07)) | (~new_n53_ & ~x01) | (~x07 & x13);
  assign new_n53_ = (~x13 | (new_n55_ & ~x10 & ~x11 & ~x12)) & (~new_n54_ | x12 | x13 | x10 | x11);
  assign new_n54_ = x06 & x07 & x08 & ~x09;
  assign new_n55_ = x06 & x08 & ~x09;
  assign z10 = x04 & ((~x01 & (new_n59_ | (x06 & new_n57_ & x07))) | (new_n59_ & ~x07));
  ...
  assign z12 = x04 & (~x01 | ~x07) & (x03 | (~x02 & x16));
