...
module FAU ( 
  ...
  assign z01 = (~x04 & x05 & (~x10 | x18)) | (~x05 & (x18 ? x15 : ~x10));
  ...
  assign z06 = ~new_n46_ | ((~x10 | (~x09 & x18)) & (new_n40_ | ~x04));
  assign new_n46_ = (~x10 | ~x18 | (x06 & x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ((new_n40_ | ~x04) & (~x10 | (~x11 & x18))) | (~new_n48_ & ~x10) | (x10 & x11 & x18);
  assign new_n48_ = (~x06 | ~x07 | ~x08 | x09 | x11) & (~x11 | (x06 & x07 & x08 & ~x09));
  assign z08 = ((new_n40_ | ~x04) & (~x10 | (~x12 & x18))) | (~new_n50_ & ~x10) | (x10 & x12 & x18);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x09 & ~x11)) & (~x06 | ~x07 | ~x08 | x09 | x11 | x12);
  assign z09 = (x10 & (x13 | ~x18)) | new_n40_ | ~new_n52_ | (~new_n54_ & x13);
  assign new_n52_ = x04 & (~new_n53_ | ~x08 | x09 | ~x06 | ~x07);
  assign new_n53_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign new_n54_ = x06 & x07 & x08 & ~x09 & ~x11 & ~x12;
  assign z10 = new_n37_ | (x04 & ((new_n56_ & x06) | (new_n40_ & x14)));
  assign new_n56_ = x07 & x08 & ~x09 & ~new_n40_ & (new_n53_ | x00);
