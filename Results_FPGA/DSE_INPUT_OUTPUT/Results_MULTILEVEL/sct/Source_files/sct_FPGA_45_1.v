...
module FAU ( 
  ...
  assign z07 = ~new_n49_ | (~new_n38_ & (new_n40_ | ~x04));
  assign new_n49_ = (new_n47_ | ~x11) & (~new_n44_ | x09 | x10 | x11 | x14);
  assign z08 = ~new_n51_ | (~new_n38_ & (new_n40_ | ~x04));
  assign new_n51_ = (~new_n45_ | x10 | x11 | x12 | x14) & (~x12 | (~x11 & (new_n47_ | x14)));
  assign z09 = (~new_n38_ & (new_n40_ | ~x04)) | new_n54_ | (~new_n53_ & x13);
  assign new_n53_ = ~x11 & (x14 | (new_n44_ & ~x09 & ~x10 & ~x12));
  assign new_n54_ = new_n45_ & ~x10 & ~x11 & ~x12 & ~x13 & ~x14;
