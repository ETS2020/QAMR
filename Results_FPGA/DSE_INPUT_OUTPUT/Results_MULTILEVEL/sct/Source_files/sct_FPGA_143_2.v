...
module FAU ( 
  ...
  assign new_n41_ = (~x02 | x03 | (~x06 ^ x08)) & (x16 | (x06 ? (~x07 ^ x08) : ~x08));
  assign z05 = (~x04 & (x07 | (~x02 & ~x09))) | (~new_n43_ & x07) | (~x02 & (x16 | (~x07 & x09)));
  assign new_n43_ = (~x09 | (x06 & x08)) & ~new_n44_ & (~x06 | ~x08 | x09);
  assign new_n44_ = x03 & x16;
  assign z06 = new_n46_ | ~new_n48_ | (~new_n47_ & x02);
  ...
  assign z08 = (~x04 & (x07 | (~x02 & ~x12))) | (~new_n54_ & x07) | (~x02 & (x16 | (~x07 & x12)));
  assign new_n54_ = (~x12 | (new_n52_ & x06 & x08)) & ~new_n44_ & ~new_n55_;
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x07 | (~x02 & ~x13))) | (~new_n57_ & x07) | (~x02 & (x16 | (~x07 & x13)));
  assign new_n57_ = (~x13 | (new_n58_ & ~x10 & ~x11 & ~x12)) & ~new_n44_ & (~new_n58_ | x12 | x13 | x10 | x11);
  assign new_n58_ = x06 & x08 & ~x09;
  assign z10 = x04 & ((new_n62_ & ~x02) | (x07 & (new_n60_ | (new_n62_ & x03))));
  assign new_n60_ = x06 & x08 & ~x09 & ~new_n46_ & ~new_n61_;
