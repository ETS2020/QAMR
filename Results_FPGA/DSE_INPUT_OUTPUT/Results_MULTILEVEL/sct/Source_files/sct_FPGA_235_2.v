...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (~x07 | x11)) | (x09 & (~x07 | (x11 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & x11);
  ...
  assign z07 = (~new_n44_ & (~x07 | x11)) | (x11 & (~new_n48_ | ~x06 | ~x07));
  assign new_n48_ = x08 & ~x09 & ~x10;
  assign z08 = ~new_n37_ & (new_n40_ | ~x04 | x12);
  assign z09 = ~new_n37_ & (new_n40_ | ~x04 | x13);
  assign z10 = x04 & ((x11 & (new_n52_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
