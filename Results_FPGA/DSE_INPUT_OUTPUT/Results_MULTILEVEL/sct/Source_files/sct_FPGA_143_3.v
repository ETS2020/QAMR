...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n41_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
  ...
  assign z05 = ~z13 | new_n44_ | (~x07 & (x09 | (x03 & x16)));
  assign z13 = x04 | (x02 & x07);
  assign new_n44_ = ~x02 & ((x09 & (~x06 | ~x08)) | x16 | (x08 & ~x09 & x06 & x07));
  ...
  assign z08 = (~x04 & (~x02 | ~x07)) | (~new_n56_ & ~x07) | (~new_n53_ & ~x02);
  assign new_n53_ = ~new_n54_ & ~x16 & (~new_n51_ | ~new_n55_);
  assign new_n54_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign new_n56_ = ~x12 & (~x03 | ~x16);
  assign z09 = ~z13 | new_n58_ | (~x07 & (x13 | (x03 & x16)));
  assign new_n58_ = ~x02 & ((~new_n59_ & x13) | x16 | (new_n47_ & new_n60_));
