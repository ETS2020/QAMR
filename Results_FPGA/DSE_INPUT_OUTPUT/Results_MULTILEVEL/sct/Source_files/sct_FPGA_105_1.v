...
module FAU ( 
  ...
  assign z05 = (~x04 & (x06 | (~x09 & ~x16))) | (~x06 & x09 & ~x16) | (~new_n43_ & x06);
  assign new_n43_ = (new_n44_ | ~x09) & ~new_n40_ & ~new_n45_;
  ...
  assign z09 = (~x04 & (x06 | (~x13 & ~x16))) | (~x06 & x13 & ~x16) | (~new_n55_ & x06);
  assign new_n55_ = ~new_n40_ & (~x13 | (new_n45_ & ~x10 & ~x11 & ~x12)) & (~new_n45_ | x12 | x13 | x10 | x11);
  assign z10 = (~x06 & x16) | (x04 & (new_n57_ | (new_n40_ & x14)));
  assign new_n57_ = x07 & x08 & ~x09 & ~new_n58_ & ~new_n59_;
  assign new_n58_ = (~x06 | x16) & (~x02 | x03 | ~x16);
