...
module FAU ( 
  ...
  assign z04 = (~x07 & x12) | (x04 & ~new_n39_ & (x06 ? (x07 ^ x08) : x08));
  ...
  assign z09 = (~new_n43_ & (x07 | (~x12 & ~x13))) | (~x12 & (new_n53_ | (~x07 & x13))) | (x07 & ~new_n54_ & x13);
  assign new_n53_ = new_n49_ & ~x11 & ~x13 & ~x09 & ~x10;
