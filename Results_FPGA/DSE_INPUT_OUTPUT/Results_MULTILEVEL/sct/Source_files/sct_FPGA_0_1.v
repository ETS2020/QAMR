...
module FAU ( 
  ...
  assign z05 = (~new_n43_ & (x05 | ~x07)) | (~x07 & x09) | (x05 & ((x09 & (~x06 | ~x08)) | (x06 & x07 & x08 & ~x09)));
  ...
  assign z07 = (~new_n43_ & (x05 | ~x07)) | (~x07 & x11) | (~new_n47_ & x05);
  assign new_n47_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = ~new_n49_ | new_n39_ | (~x05 & (x07 | x12));
  assign new_n49_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n50_ | x11 | x12 | x09 | x10);
  assign new_n50_ = x06 & x07 & x08;
  assign z09 = (~new_n43_ & (x05 | ~x07)) | (~x07 & x13) | (~new_n52_ & x05);
  ...
  assign z10 = x04 & ((x05 & (new_n58_ | (x06 & new_n56_ & x07))) | (new_n58_ & ~x07));
