...
module FAU ( 
  ...
  assign z05 = (~new_n43_ & (~x07 | x17)) | (x09 & (~x07 | (x17 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & x17);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = (~new_n43_ & (~x07 | x17)) | new_n46_ | (x10 & (~x07 | (~new_n45_ & x17)));
  assign new_n45_ = x06 & x08 & ~x09;
  assign new_n46_ = x06 & x07 & x08 & ~x09 & ~x10 & x17;
  assign z07 = (~new_n48_ & x07) | new_n39_ | ~x04 | (~new_n46_ & x11);
  assign new_n48_ = x17 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (x07 & (new_n50_ | ~x17)) | new_n39_ | new_n51_ | ~x04;
  assign new_n50_ = new_n45_ & ~x10 & ~x11 & ~x12;
  assign new_n51_ = x12 & (~new_n52_ | ~x06 | ~x07 | ~x08);
  assign new_n52_ = ~x11 & x17 & ~x09 & ~x10;
  assign z09 = ~new_n54_ | (x07 & (~x17 | (new_n45_ & new_n57_)));
  assign new_n54_ = ~new_n39_ & x04 & (~x13 | (new_n55_ & new_n56_));
  assign new_n55_ = x08 & ~x09 & x06 & x07;
  assign new_n56_ = ~x12 & x17 & ~x10 & ~x11;
  assign new_n57_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 & ((x17 & (new_n60_ | (x06 & new_n59_ & x07))) | (new_n60_ & ~x07));
  assign new_n59_ = x08 & ~x09 & ~new_n39_ & (new_n57_ | x00);
