...
module FAU ( 
  ...
  assign z01 = (~x10 & (~x05 | ~x15)) | (~x05 & (x15 | ~x18)) | (~x04 & x05);
  ...
  assign z06 = new_n47_ | (~new_n45_ & x10) | (new_n44_ & ~x09 & ~x10 & x15);
  assign new_n47_ = ~new_n37_ & (new_n40_ | ~x04);
  assign z07 = new_n47_ | ~new_n49_;
  assign new_n49_ = (~x11 | (~x10 & (new_n45_ | ~x15))) & (~new_n44_ | x11 | ~x15 | x09 | x10);
  assign z08 = new_n47_ | new_n51_ | (x12 & (new_n52_ | x10));
  assign new_n51_ = new_n45_ & ~x12 & x15 & ~x10 & ~x11;
  assign new_n52_ = x15 & (~x06 | ~x07 | ~x08 | x09 | x11);
  assign z09 = (~new_n54_ & ~x10) | new_n40_ | ~x04 | (~new_n51_ & x13);
  assign new_n54_ = x15 & (~new_n44_ | x09 | x11 | x12 | x13);
