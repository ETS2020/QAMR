...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n40_, new_n44_, new_n45_, new_n47_, new_n49_, new_n53_,
    new_n54_;
  assign z00 = (~x01 & ~x14) | new_n37_ | (x01 & ~x02);
  assign new_n37_ = x06 & ~x11;
  assign z01 = (~x05 & (x15 | ~x18)) | new_n37_ | (~x04 & x05);
  assign z02 = (x06 & ~x11) | (x04 & ~new_n40_ & ~x06);
  ...
  assign new_n44_ = x06 & (~x11 | (x07 & x08 & ~x09));
  assign new_n45_ = x04 & (~x09 | (x06 & x07 & x08 & x11));
  assign z06 = ~new_n47_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n47_ = (~x10 | (x06 & (~x11 | (x07 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | ~x11);
  assign z07 = new_n40_ | (~new_n49_ & x06) | ~x04 | (~x06 & x11);
  assign new_n49_ = x07 & x08 & ~x09 & ~x10 & x11;
  assign z08 = new_n40_ | ~x04 | new_n37_ | x12;
  assign z09 = ~new_n37_ & (new_n40_ | ~x04 | x13);
  assign z10 = (x06 & ~x11) | (x04 & (new_n54_ | (x00 & new_n53_ & x06)));
