...
module FAU ( 
  ...
  assign z08 = ~new_n51_ | new_n39_ | (~x07 & (x12 | ~x13));
  assign new_n51_ = ~new_n52_ & x04 & (~new_n49_ | ~new_n53_);
  assign new_n52_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n53_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = new_n39_ | (~new_n55_ & x13) | ~new_n57_ | ~x04;
  assign new_n55_ = new_n56_ & ~x10 & ~x11 & ~x12;
  assign new_n56_ = x06 & x08 & ~x09;
  assign new_n57_ = x07 & (~new_n56_ | x10 | x11 | x12 | x13);
