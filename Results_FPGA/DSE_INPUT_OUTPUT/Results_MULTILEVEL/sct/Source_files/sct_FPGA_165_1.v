...
module FAU ( 
  ...
  assign new_n41_ = x07 ? ((~x06 ^ x08) | (x03 & x16)) : (~x08 | (x16 & (~x02 | x03)));
  ...
  assign z06 = (~x04 & (x02 | ~x07)) | (~x07 & (x10 | (~x02 & x16))) | (~new_n47_ & x02);
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n44_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n49_ | (x07 & (new_n51_ | ~x02));
  assign new_n49_ = (x02 | (~x11 & ~x16)) & (new_n50_ | ~x11) & x04 & (~x03 | ~x16);
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x02 | ~x07)) | (~x07 & (x12 | (~x02 & x16))) | (~new_n53_ & x02);
