...
module FAU ( 
  ...
  assign z06 = new_n39_ | ~new_n45_ | (~x07 & (x10 | ~x15));
  assign new_n45_ = (~x10 | (x06 & x08 & ~x09)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n47_ | (~x07 & (x11 | ~x15));
  assign new_n47_ = ~new_n39_ & ~new_n48_ & ~new_n49_ & x04;
  assign new_n48_ = x11 & (~x06 | ~x08 | x09 | x10);
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~new_n43_ & (x07 | (~x12 & x15))) | (~new_n51_ & x07) | (~x07 & x12 & x15);
  ...
  assign z10 = (~x07 & ~x15) | (x04 & (new_n58_ | (x06 & new_n56_ & x07)));
