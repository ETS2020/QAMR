...
module FAU ( 
  ...
  assign z08 = (~new_n51_ & (x12 | ~x17)) | (~new_n49_ & x12) | (new_n46_ & new_n52_ & ~x12 & ~x17);
  assign new_n51_ = ~new_n40_ & x04;
  assign new_n52_ = ~x10 & ~x11;
  assign z09 = ~new_n54_ | (~new_n51_ & ~new_n37_);
  assign new_n54_ = (~x13 | (~x12 & (new_n49_ | x17))) & (~new_n46_ | ~new_n52_ | x12 | x13 | x17);
  ...
  assign z13 = (~x12 & x17) | (x04 & (~x17 | (x12 & x17)));
