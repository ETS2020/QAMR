...
module FAU ( 
  ...
  assign z07 = ~new_n48_ | new_n40_;
  assign new_n48_ = (~x11 | (new_n49_ & ~x09 & ~x10 & ~x12)) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x07 & x08;
  assign z08 = ~new_n51_ | new_n40_;
  assign new_n51_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n49_ | x11 | x12 | x09 | x10);
  assign z09 = ~new_n53_ | ((new_n40_ | ~x04) & (~x11 | (~x12 & ~x13)));
  assign new_n53_ = (x12 | ((~x11 | ~x13) & (~new_n49_ | x11 | x13 | x09 | x10))) & (x11 | ~x13 | (new_n49_ & ~x09 & ~x10 & ~x12));
