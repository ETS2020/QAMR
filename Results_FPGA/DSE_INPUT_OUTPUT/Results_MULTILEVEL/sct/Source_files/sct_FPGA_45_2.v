...
module FAU ( 
  ...
  assign z00 = x01 ? (~x02 & (~x11 | x14)) : (~x11 & ~x14);
  ...
  assign z10 = new_n38_ | (x04 & (new_n59_ | (new_n56_ & x06)));
  assign new_n56_ = x07 & x08 & ~x09 & (new_n58_ | (~new_n40_ & ~new_n57_));
  assign new_n57_ = ~x00 & (x12 | x13 | x10 | x11);
  assign new_n58_ = x00 & x11;
  assign new_n59_ = x16 & (x11 | x14) & (~x02 | x03);
