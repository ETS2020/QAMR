...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~new_n45_ & x09) | new_n43_ | new_n46_ | ~x04;
  assign new_n43_ = x03 & x16;
  assign new_n44_ = ~x02 & (~x07 | x16);
  assign new_n45_ = x06 & x07 & x08;
  assign new_n46_ = x06 & x07 & x08 & ~x09;
  assign z06 = new_n44_ | (~new_n46_ & x10) | new_n43_ | new_n48_ | ~x04;
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = new_n44_ | (~new_n48_ & x11) | ~x04 | new_n50_ | new_n43_;
  assign new_n50_ = new_n45_ & ~x09 & ~x10 & ~x11;
  assign z08 = new_n44_ | (~new_n50_ & x12) | ~x04 | new_n52_ | new_n43_;
  assign new_n52_ = new_n45_ & ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = new_n44_ | (~new_n52_ & x13) | ~new_n54_ | ~x04;
  assign new_n54_ = ~new_n43_ & (~new_n46_ | ~new_n55_);
  assign new_n55_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign z10 = (~x02 & ~x07) | (x04 & (new_n59_ | (x06 & new_n57_ & x07)));
  assign new_n57_ = x08 & ~x09 & ~new_n58_ & (new_n55_ | x00);
  assign new_n58_ = x16 & (~x02 | x03);
  assign new_n59_ = new_n58_ & x14;
  assign z11 = x02 | ~x07;
