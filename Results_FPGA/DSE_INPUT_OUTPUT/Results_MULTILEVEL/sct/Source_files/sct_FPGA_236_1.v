...
module FAU ( 
  ...
  assign new_n46_ = (~x11 | (new_n47_ & ~x09 & ~x10)) & (~new_n48_ | x09 | x10 | x11);
  assign new_n47_ = x06 & x08;
  assign new_n48_ = x06 & x07 & x08;
  assign z08 = (x04 & (~new_n50_ | new_n39_)) | (~x07 & (~x04 | x12));
  assign new_n50_ = (~x12 | (new_n47_ & ~x09 & ~x10 & ~x11)) & (~new_n48_ | x11 | x12 | x09 | x10);
  ...
  assign z10 = (x07 & (new_n56_ | ~x04)) | (x04 & new_n39_ & x14);
  assign new_n56_ = x06 & x08 & ~x09 & ~new_n39_ & (new_n54_ | x00);
