// Benchmark "FAU" written by ABC on Tue Aug 18 16:59:05 2020
...
module FAU ( 
  ...
  assign z05 = ~new_n43_ | (~x07 & (x09 | x16));
  assign new_n43_ = (~x09 | (x06 & x08)) & ~new_n40_ & x04 & (~x06 | ~x07 | ~x08 | x09);
  ...
  assign new_n51_ = ~new_n40_ & (~x13 | (new_n52_ & ~x10 & ~x11 & ~x12)) & (~new_n52_ | x10 | x11 | x12 | x13);
