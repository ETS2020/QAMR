...
module FAU ( 
  ...
  assign new_n50_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n47_ | x11 | x12 | x09 | x10);
  assign new_n51_ = x06 & x08;
  assign z09 = (x04 & (~new_n53_ | new_n39_)) | (~x07 & (~x04 | x13));
  ...
  assign z10 = (x07 & (~x04 | (new_n57_ & x06))) | (x04 & new_n39_ & x14);
  assign new_n57_ = x08 & ~x09 & ~new_n39_ & ~new_n58_;
  assign new_n58_ = ~x00 & (~x04 | x10 | x11 | x12 | x13);
