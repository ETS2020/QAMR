...
module FAU ( 
  ...
  assign z08 = ~new_n53_ | (x03 & (~x07 | x16));
  assign new_n53_ = (~x12 | (new_n54_ & new_n55_)) & x04 & ~new_n45_ & (~new_n54_ | ~new_n56_);
  assign new_n54_ = x06 & x07 & x08;
  assign new_n55_ = ~x09 & ~x10 & ~x11;
  assign new_n56_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n60_ | (~x03 & (x13 ? ~x07 : ~x04)) | (~new_n58_ & x07);
  assign new_n58_ = (~x13 | (new_n59_ & ~x10 & ~x11 & ~x12)) & x04 & (~new_n59_ | x12 | x13 | x10 | x11);
  assign new_n59_ = x06 & x08 & ~x09;
  assign new_n60_ = x16 & ((~x02 & (x13 ? x07 : ~x03)) | (x03 & x07));
  assign z10 = x04 & ((x07 & (new_n62_ | (new_n64_ & x03))) | (new_n64_ & ~x02 & ~x03));
  assign new_n62_ = x06 & x08 & ~x09 & ~new_n39_ & ~new_n63_;
