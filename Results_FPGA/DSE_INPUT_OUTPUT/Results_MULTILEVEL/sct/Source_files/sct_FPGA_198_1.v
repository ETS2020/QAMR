...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (x07 | (~x09 & ~x13))) | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (~x07 & x09 & ~x13);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = (~new_n44_ & (x07 | (~x10 & ~x13))) | (~new_n46_ & x07) | (~x07 & x10 & ~x13);
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~new_n44_ & (x07 | (~x11 & ~x13))) | (~new_n48_ & x07) | (~x07 & x11 & ~x13);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~x07 & (x12 | x13)) | new_n40_ | ~new_n50_ | (~new_n52_ & x12);
  assign new_n50_ = x04 & (~new_n51_ | ~x06 | ~x07 | ~x08);
  assign new_n51_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = new_n54_ | (~new_n44_ & ~new_n37_);
  assign new_n54_ = x07 & ((x13 & (~new_n55_ | x10 | x11 | x12)) | (new_n55_ & ~x12 & ~x13 & ~x10 & ~x11));
