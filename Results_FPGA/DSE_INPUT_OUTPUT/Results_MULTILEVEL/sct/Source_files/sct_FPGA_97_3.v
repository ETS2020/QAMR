...
module FAU ( 
  ...
  assign z04 = (x00 & x07) | (x04 & ~new_n40_ & (x06 ? (x07 ^ x08) : x08));
  assign z05 = (~new_n44_ & (~x00 | ~x07)) | (~x07 & x09) | (~x00 & ((x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07)));
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = ~new_n46_ | (~new_n44_ & ~new_n37_);
  assign new_n46_ = (x00 | ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (x07 | ~x10);
  assign z07 = ~new_n48_ | (x00 & (x07 | x11));
  assign new_n48_ = ~new_n40_ & (new_n49_ | ~x11) & ~new_n50_ & x04;
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n52_ | new_n40_ | (x00 & (x07 | x12));
  assign new_n52_ = (new_n50_ | ~x12) & x04 & (~new_n53_ | ~new_n54_);
  assign new_n53_ = x06 & x07 & x08;
  assign new_n54_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = ~new_n58_ | (x07 & (x00 | (x04 & new_n56_ & x06)));
  assign new_n56_ = x08 & ~x09 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = ~new_n40_ & x04 & (~x13 | (new_n53_ & new_n54_));
  assign z10 = (x00 & x07) | (x04 & (new_n60_ | (x06 & new_n56_ & x07)));
