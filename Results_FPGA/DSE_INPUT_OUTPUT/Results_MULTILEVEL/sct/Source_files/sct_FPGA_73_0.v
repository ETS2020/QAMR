...
module FAU ( 
  ...
  assign z06 = new_n39_ | ~new_n44_ | (~x06 & (~x07 | x10));
  assign new_n44_ = (~x10 | (x07 & x08 & ~x09)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n46_ | ((new_n39_ | ~x04) & (x06 | (x07 & ~x11)));
  assign new_n46_ = (~x07 | ((x06 | ~x11) & (~x06 | ~x08 | x09 | x10 | x11))) & (~x06 | ~x11 | (x07 & x08 & ~x09 & ~x10));
  assign z08 = ~new_n48_ | new_n39_ | (~x06 & (~x07 | x12));
  assign new_n48_ = ~new_n49_ & x04 & (~new_n50_ | ~x06 | ~x07 | ~x08);
  assign new_n49_ = x12 & (~x07 | ~x08 | x09 | x10 | x11);
  assign new_n50_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = ~new_n52_ | (~x06 & (~x07 | x13));
  assign new_n52_ = ~new_n39_ & (new_n54_ | ~x13) & x04 & (~new_n53_ | ~new_n55_);
  assign new_n53_ = x06 & x07 & x08 & ~x09;
  assign new_n54_ = ~x10 & ~x11 & ~x12 & x07 & x08 & ~x09;
  assign new_n55_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 & ((x06 & ((new_n57_ & x07) | (new_n39_ & x14))) | (x07 & new_n39_ & x14));
