...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n39_ & (x06 ? ~x07 : (x07 & ~x15));
  assign z04 = x04 & ~new_n39_ & (x07 ? (~x15 & (x06 ^ x08)) : x08);
  ...
  assign new_n45_ = (~x10 | (x07 & (x15 | (x06 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | x15);
  assign z07 = (~new_n48_ & x07) | new_n39_ | ~x04 | (~new_n47_ & x11);
  assign new_n47_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x15;
  assign new_n48_ = ~x15 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n50_ | new_n39_ | new_n52_ | ~x04;
  assign new_n50_ = x07 & (new_n51_ | x15);
  assign new_n51_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n52_ = x12 & (~new_n53_ | ~x06 | ~x07 | ~x08);
  assign new_n53_ = ~x09 & ~x10 & ~x11 & ~x15;
  assign z09 = new_n43_ | new_n55_ | (~new_n50_ & x13);
  assign new_n55_ = new_n56_ & x08 & ~x09 & x06 & x07;
  assign new_n56_ = ~x12 & ~x13 & ~x15 & ~x10 & ~x11;
