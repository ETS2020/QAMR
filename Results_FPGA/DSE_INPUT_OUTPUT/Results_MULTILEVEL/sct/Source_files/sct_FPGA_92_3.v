...
module FAU ( 
  ...
  assign z09 = (~x04 & (~x13 | ~x16)) | (~x13 & (new_n54_ | new_n41_)) | (x13 & ~new_n54_ & ~x16);
  assign new_n54_ = new_n49_ & ~x11 & ~x12 & ~x09 & ~x10;
  assign z10 = new_n37_ | (x04 & (new_n58_ | (x06 & new_n56_ & x07)));
  assign new_n56_ = x08 & ~x09 & ((~new_n41_ & (new_n57_ | x00)) | (x00 & x13));
  assign new_n57_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n58_ = ~x13 & new_n41_ & x14;
