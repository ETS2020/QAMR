...
module FAU ( 
  ...
  assign z02 = x04 ? (~new_n39_ & ~x06) : x06;
  ...
  assign z07 = (~x06 & (~x04 | x11)) | (x04 & (new_n39_ | ~new_n48_));
  assign new_n48_ = (~x11 | (x07 & x08 & ~x09 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  ...
  assign new_n52_ = (~new_n44_ | x12 | x13 | x10 | x11) & (~x13 | (new_n53_ & ~x10 & ~x11 & ~x12));
  assign new_n53_ = x07 & x08 & ~x09;
  assign z10 = (x06 & (~x04 | (new_n55_ & x07))) | (x04 & new_n39_ & x14);
