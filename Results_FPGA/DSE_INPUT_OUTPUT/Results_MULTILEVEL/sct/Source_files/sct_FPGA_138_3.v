...
module FAU ( 
  ...
  assign z01 = (~x04 & ((x05 & ~x12) | ~x18)) | (~x05 & (~x18 | (~x12 & x15)));
  ...
  assign z07 = new_n40_ | (~new_n47_ & x11) | ~x04 | new_n49_ | new_n37_;
  assign new_n49_ = new_n44_ & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n51_ | ((~x12 | (~x11 & ~x18)) & (new_n40_ | ~x04));
  assign new_n51_ = (~x12 | x18 | (new_n44_ & ~x09 & ~x10 & ~x11)) & (~new_n44_ | x11 | x12 | x09 | x10);
  assign z09 = ((new_n40_ | ~x04) & (~x12 | (~x13 & ~x18))) | (x12 & x13 & ~x18) | (~new_n53_ & ~x12);
  assign new_n53_ = (~new_n44_ | x11 | x13 | x09 | x10) & (~x13 | (new_n44_ & ~x09 & ~x10 & ~x11));
