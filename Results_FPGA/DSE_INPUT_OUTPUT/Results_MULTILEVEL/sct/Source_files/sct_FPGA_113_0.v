...
module FAU ( 
  ...
  assign z08 = new_n52_ | (~new_n49_ & x12) | (new_n45_ & new_n51_ & ~x12 & x13);
  assign new_n51_ = ~x10 & ~x11;
  assign new_n52_ = (x12 | x13) & (~x04 | ((~x02 | x03) & x16));
  assign z09 = new_n52_ | (x13 & (~new_n44_ | ~new_n54_));
  assign new_n54_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = new_n37_ | (x04 & (new_n57_ | (x00 & new_n56_ & x06)));
  assign new_n56_ = x07 & x08 & ~x09 & ((x02 & ~x03) | ~x16);
