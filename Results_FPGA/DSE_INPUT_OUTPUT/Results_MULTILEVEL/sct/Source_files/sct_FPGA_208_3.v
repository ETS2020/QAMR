...
module FAU ( 
  ...
  assign z06 = ~new_n47_ | ((~x10 | (~x09 & ~x13)) & (new_n40_ | ~x04));
  assign new_n47_ = (~x10 | x13 | (x06 & x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n49_ | new_n40_ | (x10 & (x11 | x13));
  assign new_n49_ = (new_n45_ | ~x11) & x04 & (~new_n44_ | x09 | x10 | x11);
  ...
  assign z09 = new_n53_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n53_ = ~x10 & ((x13 & (~new_n44_ | x09 | x11 | x12)) | (new_n44_ & ~x09 & ~x11 & ~x12 & ~x13));
