...
module FAU ( 
  ...
  assign z06 = (~new_n43_ & (x07 | (~x10 & ~x18))) | (~x07 & x10 & ~x18) | (x07 & (new_n46_ | (~new_n45_ & x10)));
  assign new_n45_ = x06 & x08 & ~x09;
  assign new_n46_ = x06 & x08 & ~x09 & ~x10;
  assign z07 = ~new_n48_ | new_n39_ | (~x07 & (x11 | x18));
  assign new_n48_ = (new_n46_ | ~x11) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x07 & x08;
  assign z08 = (~new_n43_ & (x07 | (~x12 & ~x18))) | (~new_n51_ & x07) | (~x07 & x12 & ~x18);
  assign new_n51_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~new_n43_ & (x07 | (~x13 & ~x18))) | (~new_n53_ & x07) | (~x07 & x13 & ~x18);
  assign new_n53_ = (~x13 | (new_n45_ & ~x10 & ~x11 & ~x12)) & (~new_n45_ | x12 | x13 | x10 | x11);
  assign z10 = x04 & ((x07 & (new_n55_ | (new_n39_ & x14))) | (new_n57_ & x14));
