...
module FAU ( 
  ...
  assign new_n41_ = ((x16 & (~x02 | x03)) | (x06 ? (~x07 | x08) : ~x08)) & (~x02 | ~x06 | x07 | ~x08 | (x03 & x16));
  assign z05 = ~new_n43_ | (~x02 & (~x07 | x16));
  assign new_n43_ = (~x09 | (x06 & x07 & x08)) & x04 & ~new_n44_ & (~x08 | x09 | ~x06 | ~x07);
  assign new_n44_ = x03 & x16;
  assign z06 = new_n46_ | (x02 & (x10 ? ~x07 : ~x04)) | (~new_n47_ & x07);
  assign new_n46_ = x16 & ((~x02 & x07) | (x03 & (x10 ? x07 : x02)));
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & x04 & (~x06 | ~x08 | x09 | x10);
  assign z07 = new_n49_ | (x02 & (x11 ? ~x07 : ~x04)) | (~new_n50_ & x07);
  assign new_n49_ = x16 & ((~x02 & x07) | (x03 & (x11 ? x07 : x02)));
  assign new_n50_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & x04 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~x02 & (~x07 | x16)) | new_n52_ | ~new_n54_ | ~x04;
  assign new_n52_ = x12 & (~new_n53_ | x09 | x10 | x11);
  assign new_n53_ = x06 & x07 & x08;
  assign new_n54_ = ~new_n44_ & (~new_n53_ | x11 | x12 | x09 | x10);
  ...
  assign z10 = x04 & ((x07 & (new_n60_ | (new_n63_ & ~x02))) | (new_n63_ & x02 & x03));
  assign new_n60_ = x06 & x08 & ~x09 & ~new_n61_ & ~new_n62_;
  assign new_n61_ = x16 & (~x02 | x03);
