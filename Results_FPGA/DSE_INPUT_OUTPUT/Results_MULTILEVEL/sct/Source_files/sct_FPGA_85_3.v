...
module FAU ( 
  ...
  assign z08 = ~new_n52_ | ((new_n40_ | ~x04) & (~x12 | (~x11 & ~x14)));
  assign new_n52_ = (~x12 | x14 | (new_n44_ & ~x09 & ~x10 & ~x11)) & (~new_n44_ | x11 | x12 | x09 | x10);
  assign z09 = (x12 & (x13 | x14)) | new_n40_ | ~new_n54_ | (~new_n49_ & x13);
  ...
  assign new_n57_ = (x12 | x13 | x10 | x11) & (~x00 | (x12 & x14));
