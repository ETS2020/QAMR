...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n43_, new_n46_, new_n47_, new_n48_, new_n50_, new_n52_,
  ...
  assign new_n43_ = (x06 | (~new_n39_ & ~x09)) & (x16 | ((~x09 | (x07 & x08)) & (~x06 | ~x07 | ~x08 | x09)));
  assign z13 = x04 | (x06 & x16);
  assign z06 = new_n47_ | new_n48_ | ~x04 | (~new_n46_ & x10);
  assign new_n46_ = x06 & x07 & x08 & ~x09;
  assign new_n47_ = x06 & (x16 | (x07 & x08 & ~x09 & ~x10));
  assign new_n48_ = x16 & (~x02 | x03 | x10);
  assign z07 = (~x04 & (~x06 | ~x16)) | (~x06 & (new_n39_ | x11)) | (~new_n50_ & ~x16);
  assign new_n50_ = (~x11 | (x07 & x08 & ~x09 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = ~new_n52_ | (x06 & (new_n54_ | x16));
  assign new_n52_ = x04 & (new_n53_ | ~x12) & (~x16 | (x02 & ~x03 & ~x12));
  ...
  assign new_n56_ = (new_n54_ | ~x13) & (~new_n46_ | ~new_n57_);
  assign new_n57_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign z10 = (x06 & x16) | (x04 & ((new_n59_ & x06) | (new_n39_ & x14)));
  assign new_n59_ = x07 & x08 & ~x09 & (new_n57_ | x00);
