...
module FAU ( 
  ...
  assign z07 = ((x07 | (~x11 & ~x17)) & (new_n39_ | ~x04)) | (~new_n47_ & x07) | (~x07 & x11 & ~x17);
  assign new_n47_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = ((x07 | (~x12 & ~x17)) & (new_n39_ | ~x04)) | (~new_n49_ & x07) | (~x07 & x12 & ~x17);
  assign new_n49_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = ((x07 | (~x13 & ~x17)) & (new_n39_ | ~x04)) | (~x07 & x13 & ~x17) | (~new_n51_ & x07);
  assign new_n51_ = (~x13 | (new_n52_ & ~x10 & ~x11 & ~x12)) & (~new_n52_ | x12 | x13 | x10 | x11);
  assign new_n52_ = x06 & x08 & ~x09;
  assign z10 = (~x07 & x17) | (x04 & (new_n56_ | (x06 & new_n54_ & x07)));
  assign new_n54_ = x08 & ~x09 & ~new_n39_ & (new_n55_ | x00);
