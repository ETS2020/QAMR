...
module FAU ( 
  ...
  assign z05 = ~new_n43_ | (x16 & (x04 | x09) & (~x02 | x03));
  assign new_n43_ = (~x09 | (x04 & x06 & x07 & x08)) & (~x04 | ~x06 | ~x07 | ~x08 | x09);
  assign z06 = new_n39_ | new_n46_ | ~x04 | (~new_n45_ & x10);
  ...
  assign new_n51_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n49_ | x09 | x10 | x11 | x12);
  assign z09 = (x04 & (~new_n53_ | new_n39_)) | (x09 & (~x04 | x13));
  assign new_n53_ = (~new_n45_ | x10 | x11 | x12 | x13) & (~x13 | (new_n49_ & ~x10 & ~x11 & ~x12));
