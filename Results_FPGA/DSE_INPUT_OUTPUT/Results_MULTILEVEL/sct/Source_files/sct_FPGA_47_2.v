...
module FAU ( 
  ...
  assign z05 = ~new_n43_ | (x03 & (~x07 | x16));
  assign new_n43_ = (~x09 | (x06 & x07 & x08)) & x04 & ~new_n44_ & (~x08 | x09 | ~x06 | ~x07);
  assign new_n44_ = ~x02 & x16;
  assign z06 = ~new_n46_ | (x16 & ((x03 & x07) | (~x02 & (x10 ? x07 : ~x03))));
  assign new_n46_ = (x03 | (x10 ? x07 : x04)) & (~x07 | ((new_n47_ | ~x10) & ~new_n48_ & x04));
  assign new_n47_ = x06 & x08 & ~x09;
  assign new_n48_ = x06 & x08 & ~x09 & ~x10;
  assign z07 = ~new_n50_ | (x16 & ((x03 & x07) | (~x02 & (x11 ? x07 : ~x03))));
  assign new_n50_ = (x03 | (x11 ? x07 : x04)) & (~x07 | ((new_n48_ | ~x11) & ~new_n51_ & x04));
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n53_ | (x16 & ((x03 & x07) | (~x02 & (x12 ? x07 : ~x03))));
  assign new_n53_ = (x03 | (x12 ? x07 : x04)) & (~x07 | ((new_n51_ | ~x12) & ~new_n54_ & x04));
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n57_ | (~x03 & (x13 ? ~x07 : ~x04)) | (~new_n56_ & x07);
  assign new_n56_ = (~x13 | (new_n47_ & ~x10 & ~x11 & ~x12)) & x04 & (~new_n47_ | x10 | x11 | x12 | x13);
  assign new_n57_ = x16 & ((x03 & x07) | (~x02 & (x13 ? x07 : ~x03)));
  assign z10 = x04 & ((x07 & (new_n59_ | (new_n62_ & x03))) | (new_n62_ & ~x02 & ~x03));
