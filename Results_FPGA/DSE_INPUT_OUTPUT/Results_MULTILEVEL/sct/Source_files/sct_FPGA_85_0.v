...
module FAU ( 
  ...
  assign z05 = new_n40_ | (~new_n44_ & x09) | ~x04 | new_n38_ | new_n45_;
  assign new_n44_ = x06 & x07 & x08;
  assign new_n45_ = x08 & ~x09 & x06 & x07;
  assign z06 = ~new_n38_ & (new_n40_ | ~new_n47_);
  assign new_n47_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n40_ | new_n50_ | ~x04 | new_n49_ | new_n38_;
  assign new_n49_ = new_n44_ & ~x09 & ~x10 & ~x11;
  assign new_n50_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = ((x12 | x14) & (new_n40_ | ~x04)) | new_n52_ | (~new_n49_ & x12);
  assign new_n52_ = new_n45_ & ~x12 & x14 & ~x10 & ~x11;
  assign z09 = (~new_n54_ & ~x12) | new_n40_ | ~x04 | (~new_n52_ & x13);
  assign new_n54_ = x14 & (~new_n44_ | x11 | x13 | x09 | x10);
  assign z10 = x04 & (new_n56_ | (new_n40_ & x14));
  assign new_n56_ = x06 & x07 & x08 & (new_n57_ | new_n58_) & ~x09;
  assign new_n57_ = x00 & (x14 | (x12 & (~x16 | (x02 & ~x03))));
  assign new_n58_ = ~x10 & ~x11 & ~x12 & ~x13 & x14;
