...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n39_ & ((~x06 & x07) | (x01 & x06 & ~x07));
  assign z04 = (~x01 & x06) | (x04 & ~new_n39_ & (x06 ? ((x01 & ~x07 & x08) | (x07 & ~x08)) : x08));
  assign z05 = (~new_n43_ & (x01 | ~x06)) | (x01 & ((x09 & (~x07 | ~x08)) | (x08 & ~x09 & x06 & x07))) | (~x06 & x09);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = new_n39_ | ~new_n45_ | (~x01 & (x06 | x10));
  assign new_n45_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~new_n43_ & (x01 | ~x06)) | (~new_n47_ & x01) | (~x06 & x11);
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & (~new_n48_ | ~x06 | x09 | x10 | x11);
  assign new_n48_ = x07 & x08;
  assign z08 = (~new_n43_ & (x01 | ~x06)) | (~new_n50_ & x01) | (~x06 & x12);
  assign new_n50_ = (~x12 | (new_n48_ & ~x09 & ~x10 & ~x11)) & (~new_n48_ | ~x06 | x11 | x12 | x09 | x10);
  assign z09 = (~new_n43_ & (x01 | ~x06)) | (~new_n52_ & x01) | (~x06 & x13);
  ...
  assign z10 = (~x01 & x06) | (x04 & ((new_n56_ & x06) | (new_n39_ & x14)));
