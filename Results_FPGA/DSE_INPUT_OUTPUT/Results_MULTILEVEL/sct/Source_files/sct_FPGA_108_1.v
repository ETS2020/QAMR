...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n39_ & (x07 | ~x14);
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = (~x07 & x14) | (x04 & ~new_n39_ & (x06 ^ x07));
  assign z04 = x04 & ~new_n39_ & (x07 ? (x06 ^ x08) : (x08 & ~x14));
  assign z05 = (~new_n43_ & (x07 | (~x09 & ~x14))) | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (~x07 & x09 & ~x14);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = (~new_n43_ & (x07 | (~x10 & ~x14))) | (~new_n45_ & x07) | (~x07 & x10 & ~x14);
  assign new_n45_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = ~new_n47_ | new_n39_ | (~x07 & (x11 | x14));
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n48_ = x06 & x08;
  assign new_n49_ = x06 & x07 & x08;
  assign z08 = ~new_n51_ | new_n39_ | (~x07 & (x12 | x14));
  assign new_n51_ = ~new_n52_ & x04 & (~new_n49_ | ~new_n53_);
  assign new_n52_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n53_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = (~new_n43_ & (x07 | (~x13 & ~x14))) | (~new_n55_ & x07) | (~x07 & x13 & ~x14);
  assign new_n55_ = (~x13 | (new_n56_ & ~x10 & ~x11 & ~x12)) & (~new_n56_ | x12 | x13 | x10 | x11);
  assign new_n56_ = x06 & x08 & ~x09;
  assign z10 = (~x07 & x14) | (x04 & ((x06 & new_n58_ & x07) | (new_n39_ & x14)));
  assign new_n58_ = x08 & ~x09 & ~new_n39_ & ~new_n59_;
