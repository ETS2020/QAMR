...
module FAU ( 
  ...
  assign new_n46_ = x07 & (~new_n47_ | x09 | x10);
  ...
  assign new_n50_ = (~x11 | (new_n47_ & ~x09 & ~x10)) & x04 & (~new_n51_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x07 & x08;
  assign z08 = (~x04 & (x07 | (x03 & ~x12))) | (x03 & (x16 | (~x07 & x12))) | (~new_n53_ & x07);
  ...
  assign new_n58_ = (~x13 | (new_n59_ & ~x10 & ~x11 & ~x12)) & ~new_n56_ & (~new_n59_ | x10 | x11 | x12 | x13);
  assign new_n59_ = x06 & x08 & ~x09;
  assign z10 = x04 & ((x07 & (new_n61_ | (new_n63_ & ~x02))) | (new_n63_ & x03));
  assign new_n61_ = x06 & x08 & ~x09 & ~new_n44_ & ~new_n62_;
