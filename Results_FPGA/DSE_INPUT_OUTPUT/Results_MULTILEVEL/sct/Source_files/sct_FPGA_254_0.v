...
module FAU ( 
  ...
  assign z01 = (~x04 & x05 & (x12 | x18)) | (~x05 & (x18 ? x15 : x12));
  ...
  assign z07 = ~new_n37_ & (new_n40_ | (~new_n47_ & x11) | new_n49_ | ~x04);
  assign new_n49_ = new_n44_ & ~x09 & ~x10 & ~x11;
  assign z08 = ((x12 | x18) & (new_n40_ | ~x04)) | new_n51_ | (~new_n49_ & x12);
  assign new_n51_ = new_n45_ & ~x12 & x18 & ~x10 & ~x11;
  assign z09 = (~new_n53_ & ~x12) | new_n40_ | ~x04 | (~new_n51_ & x13);
  assign new_n53_ = x18 & (~new_n44_ | x11 | x13 | x09 | x10);
