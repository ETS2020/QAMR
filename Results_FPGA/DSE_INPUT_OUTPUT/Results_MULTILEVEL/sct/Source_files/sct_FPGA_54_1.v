...
module FAU ( 
  ...
  assign z05 = ~new_n43_ | (x07 & (~x02 | (x06 & x08 & ~x09)));
  assign new_n43_ = (x02 | (~x09 & ~x16)) & (new_n44_ | ~x09) & x04 & (~x03 | ~x16);
  assign new_n44_ = x06 & x07 & x08;
  assign z06 = (~x04 & (x02 | ~x07)) | (~x07 & (x10 | (~x02 & x16))) | (~new_n46_ & x02);
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n47_ & (~x08 | x09 | x10 | ~x06 | ~x07);
  assign new_n47_ = x03 & x16;
  assign z07 = (~x04 & (x02 | ~x07)) | (~x07 & (x11 | (~x02 & x16))) | (~new_n49_ & x02);
  assign new_n49_ = ~new_n50_ & ~new_n47_ & ~new_n51_;
  assign new_n50_ = x11 & (~x06 | ~x08 | x09 | x10);
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n53_ | (x07 & (new_n54_ | ~x02));
  assign new_n53_ = (x02 | (~x12 & ~x16)) & (new_n51_ | ~x12) & x04 & (~x03 | ~x16);
  assign new_n54_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = (~x04 & (x02 | ~x07)) | (~x07 & (x13 | (~x02 & x16))) | (~new_n56_ & x02);
  assign new_n56_ = (new_n54_ | ~x13) & ~new_n47_ & (~new_n57_ | ~new_n58_);
  assign new_n57_ = x08 & ~x09 & x06 & x07;
  assign new_n58_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 & ((x02 & (new_n60_ | (new_n62_ & x03))) | (new_n62_ & ~x02 & ~x07));
