...
module FAU ( 
  ...
  assign new_n49_ = ~new_n50_ & ~new_n47_ & ~new_n51_;
  assign new_n50_ = x11 & (x09 | x10 | ~x06 | ~x08);
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n53_ | (x07 & (new_n54_ | x03));
  assign new_n53_ = (~x03 | (~x12 & ~x16)) & (new_n51_ | ~x12) & x04 & (x02 | ~x16);
  assign new_n54_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = (~x04 & (~x03 | ~x07)) | (~x07 & (x13 | (x03 & x16))) | (~new_n56_ & ~x03);
  assign new_n56_ = (new_n54_ | ~x13) & ~new_n47_ & (~new_n57_ | ~new_n58_);
  assign new_n57_ = x08 & ~x09 & x06 & x07;
  assign new_n58_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign z10 = x04 & ((~x03 & (new_n60_ | (new_n62_ & ~x02))) | (new_n62_ & x03 & ~x07));
  assign new_n60_ = x06 & x07 & x08 & ~x09 & ~new_n47_ & ~new_n61_;
