...
module FAU ( 
  ...
  assign new_n43_ = ~new_n40_ & ~new_n45_ & (new_n44_ | ~x09);
  assign new_n44_ = x07 & x08;
  assign new_n45_ = x07 & x08 & ~x09;
  assign z06 = (~x04 & (x06 | (~x10 & ~x16))) | (~new_n47_ & x06) | (~x06 & x10 & ~x16);
  ...
  assign z08 = (~x04 & (x06 | (~x12 & ~x16))) | (x06 & (new_n40_ | ~new_n51_)) | (~x06 & x12 & ~x16);
  assign new_n51_ = (~x12 | (x07 & x08 & ~x09 & ~x10 & ~x11)) & (~x07 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~x04 & (x06 | (~x13 & ~x16))) | (~new_n53_ & x06) | (~x06 & x13 & ~x16);
  assign new_n53_ = ~new_n40_ & (~x13 | (new_n45_ & ~x10 & ~x11 & ~x12)) & (~new_n45_ | x12 | x13 | x10 | x11);
  assign z10 = x04 & x06 & (new_n55_ | (new_n40_ & x14));
