...
module FAU ( 
  ...
  assign new_n41_ = x07 ? ((~x06 ^ x08) | (x16 & (~x02 | x03))) : (~x08 | (x03 & x16));
  assign z05 = ~new_n43_ | (x16 & ((~x02 & x07) | (x03 & (x09 ? x07 : x02))));
  assign new_n43_ = (~x02 | (x09 ? x07 : x04)) & (~x07 | ((~x09 | (x06 & x08)) & x04 & (~x06 | ~x08 | x09)));
  assign z06 = ~new_n45_ | (~x02 & (~x07 | x16));
  assign new_n45_ = ~new_n46_ & x04 & ~new_n47_ & (~x03 | ~x16);
  assign new_n46_ = x10 & (~x08 | x09 | ~x06 | ~x07);
  assign new_n47_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = ~new_n49_ | (~x02 & (~x07 | x16));
  assign new_n49_ = (new_n47_ | ~x11) & x04 & ~new_n50_ & (~x03 | ~x16);
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n52_ | (x16 & ((~x02 & x07) | (x03 & (x12 ? x07 : x02))));
  ...
  assign z09 = new_n58_ | (~new_n56_ & x07) | (x02 & (x13 ? ~x07 : ~x04));
