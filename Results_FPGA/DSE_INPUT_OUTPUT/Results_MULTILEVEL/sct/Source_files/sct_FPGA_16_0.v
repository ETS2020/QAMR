...
module FAU ( 
  ...
  assign z07 = ~new_n47_ | (~new_n43_ & (x07 | (x08 & ~x11)));
  assign new_n47_ = (~x08 | ((x07 | ~x11) & (~x06 | ~x07 | x09 | x10 | x11))) & (~x07 | ~x11 | (~x09 & ~x10 & x06 & x08));
  assign z08 = (~new_n43_ & (x07 | (x08 & ~x12))) | (~new_n49_ & x08) | (x07 & ~new_n50_ & x12);
  assign new_n49_ = (x07 | ~x12) & (x10 | x11 | x12 | ~x06 | ~x07 | x09);
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = ~new_n52_ | new_n39_ | (~x07 & (~x08 | x13));
  ...
  assign z10 = x04 & ((x07 & (new_n57_ | (new_n39_ & x14))) | (x08 & new_n39_ & x14));
