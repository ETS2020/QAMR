...
module FAU ( 
  ...
  assign z07 = ~new_n47_ | new_n39_ | (~x07 & (x11 | x12));
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n48_ = x06 & x08;
  assign new_n49_ = x06 & x07 & x08;
  assign z08 = (~new_n43_ & (x07 | ~x12)) | (x07 & (new_n52_ | (x12 & (~new_n48_ | ~new_n51_))));
  assign new_n51_ = ~x09 & ~x10 & ~x11;
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~new_n43_ & (x07 | (~x12 & ~x13))) | (~x12 & (new_n54_ | (~x07 & x13))) | (x07 & ~new_n52_ & x13);
  assign new_n54_ = new_n49_ & ~x11 & ~x13 & ~x09 & ~x10;
