...
module FAU ( 
  ...
  assign z01 = (x05 & (~x04 | x09)) | (x04 & x09) | (~x05 & (x15 | ~x18));
  assign z02 = x04 & (x09 | (~new_n39_ & ~x06));
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = x04 & (x09 | (~new_n39_ & (x06 ^ x07)));
  assign z04 = x04 & (x09 | (~new_n39_ & (x06 ? (x07 ^ x08) : x08)));
  assign z05 = ~x04 | (~x09 & (new_n39_ | new_n43_));
  assign new_n43_ = x06 & x07 & x08;
  assign z06 = (~x09 & (new_n39_ | new_n45_)) | ~x04 | x09 | (~new_n43_ & x10);
  assign new_n45_ = x08 & ~x10 & x06 & x07;
  assign z07 = new_n39_ | (~new_n45_ & x11) | ~x04 | new_n47_ | x09;
  assign new_n47_ = x06 & x07 & x08 & ~x10 & ~x11;
  assign z08 = new_n39_ | (~new_n47_ & x12) | ~x04 | new_n49_ | x09;
  assign new_n49_ = new_n43_ & ~x10 & ~x11 & ~x12;
  assign z09 = new_n39_ | (~new_n49_ & x13) | ~new_n51_ | ~x04;
  assign new_n51_ = ~x09 & (~new_n43_ | x10 | x11 | x12 | x13);
  assign z10 = x04 & ~x09 & (new_n53_ | (new_n39_ & x14));
