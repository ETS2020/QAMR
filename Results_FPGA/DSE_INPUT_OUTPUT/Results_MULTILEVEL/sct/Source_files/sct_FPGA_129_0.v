...
module FAU ( 
  ...
  assign new_n48_ = (new_n49_ | ~x11) & x04 & (~new_n50_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x08 & ~x09 & ~x10;
  assign new_n50_ = x06 & x07 & x08;
  assign z08 = new_n40_ | new_n52_ | ~x04 | new_n54_ | ~x07;
  assign new_n52_ = x12 & (~x06 | ~x08 | ~new_n53_ | x09);
  assign new_n53_ = ~x10 & ~x11;
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~new_n44_ & (x07 | x12)) | (~new_n56_ & x07) | (x12 & x13);
  assign new_n56_ = (~x13 | (x06 & x08 & new_n53_ & ~x09)) & (~x06 | ~x08 | x09 | ~new_n53_ | x12 | x13);
  assign z10 = new_n37_ | (x04 & ((new_n58_ & x06) | (new_n40_ & x14)));
  assign new_n58_ = x08 & ~x09 & ~new_n40_ & ~new_n59_;
