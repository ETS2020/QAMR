...
module FAU ( 
  ...
  assign z05 = ~new_n43_ | ((~x02 | x03) & (x09 | x16));
  assign new_n43_ = (~x06 | (x16 & (~x07 | ~x08 | x09))) & x04 & (~x09 | (x08 & x16 & x06 & x07));
  assign z06 = (~x04 & (~x06 | x16)) | (~new_n45_ & x16) | (~x06 & x10);
  assign new_n45_ = (new_n46_ | ~x10) & x02 & ~new_n47_ & ~x03;
  assign new_n46_ = x07 & x08 & ~x09;
  assign new_n47_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = ~new_n49_ | ((~x02 | x03) & (x11 | x16));
  assign new_n49_ = (~x06 | (~new_n50_ & x16)) & x04 & (new_n51_ | ~x11);
  assign new_n50_ = x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & x16;
  assign z08 = (~x04 & (~x06 | x16)) | (~x06 & x12) | (x16 & (~new_n53_ | (~new_n50_ & x12)));
  assign new_n53_ = x02 & ~x03 & (~new_n54_ | ~x06 | ~x07 | ~x08);
  assign new_n54_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (~x06 | x16)) | (~new_n56_ & x16) | (~x06 & x13);
  assign new_n56_ = (new_n57_ | ~x13) & x02 & ~x03 & (~new_n58_ | ~new_n59_);
  assign new_n57_ = x07 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n58_ = x06 & x07 & x08 & ~x09;
  assign new_n59_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign z10 = x04 & x16 & ((x02 & new_n61_ & ~x03) | (x14 & (~x02 | x03)));
  assign new_n61_ = x06 & x07 & x08 & ~x09 & (new_n59_ | x00);
