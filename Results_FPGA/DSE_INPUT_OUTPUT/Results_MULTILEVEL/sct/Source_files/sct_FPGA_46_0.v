...
module FAU ( 
  ...
  assign z05 = new_n40_ | (~new_n44_ & x09) | ~new_n45_ | ~x04;
  assign new_n44_ = x06 & x07 & x08;
  assign new_n45_ = (x11 | x12) & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = ~new_n37_ & (new_n40_ | ~new_n47_);
  assign new_n47_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~x11 & (new_n49_ | ~x12)) | new_n40_ | ~x04 | (~new_n49_ & x11);
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = new_n40_ | (~new_n51_ & ~x11) | ~x04 | (x11 & x12);
