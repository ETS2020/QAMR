...
module FAU ( 
  ...
  assign z08 = ((~x12 | x13) & (new_n40_ | ~x04)) | new_n51_ | (x12 & ~new_n49_ & x13);
  assign new_n51_ = new_n44_ & ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = ((~x12 | x13) & (new_n40_ | ~x04)) | new_n53_ | (~new_n51_ & x13);
  assign new_n53_ = new_n45_ & ~x12 & ~x13 & ~x10 & ~x11;
