...
module FAU ( 
  ...
  assign new_n41_ = x07 ? ((x03 & x16) | (~x06 ^ x08)) : (~x08 | (x16 & (~x02 | x03)));
  assign z05 = (~x04 & (x02 | ~x07)) | (~x07 & (x09 | (~x02 & x16))) | (~new_n43_ & x02);
  assign new_n43_ = (~x09 | (x06 & x08)) & ~new_n44_ & ~new_n45_;
  assign new_n44_ = x03 & x16;
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z06 = ~new_n47_ | (x07 & (~x02 | (new_n48_ & x06 & x08)));
  assign new_n47_ = (x02 | (~x10 & ~x16)) & (new_n45_ | ~x10) & x04 & (~x03 | ~x16);
  assign new_n48_ = ~x09 & ~x10;
  assign z07 = ~new_n50_ | (x07 & (new_n52_ | ~x02));
  ...
  assign z08 = (~x04 & (x02 | ~x07)) | (~x07 & (x12 | (~x02 & x16))) | (~new_n54_ & x02);
  assign new_n54_ = (new_n52_ | ~x12) & ~new_n44_ & (~new_n55_ | ~new_n48_ | x11 | x12);
  assign new_n55_ = x06 & x07 & x08;
  assign z09 = (~x04 & (x02 | ~x07)) | (~x07 & (x13 | (~x02 & x16))) | (~new_n57_ & x02);
