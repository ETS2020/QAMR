...
module FAU ( 
  ...
  assign new_n46_ = x04 & ~x10 & (~x08 | x09 | ~x06 | ~x07);
  assign z07 = ~new_n48_ | (~new_n44_ & ~new_n37_);
  assign new_n48_ = (x10 | ((~x11 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x11))) & (~x09 | ~x11);
  assign z08 = (~new_n44_ & (x09 | ~x10)) | (~new_n50_ & ~x10) | (x09 & x12);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x11)) & (~x06 | ~x07 | ~x08 | x09 | x11 | x12);
  assign z09 = (~x09 & (new_n54_ | x10)) | new_n40_ | new_n52_ | ~x04;
  assign new_n52_ = x13 & (~new_n53_ | ~x06 | ~x07 | ~x08);
  assign new_n53_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n54_ = x06 & x07 & x08 & ~x11 & ~x12 & ~x13;
  assign z10 = x04 & ((~x10 & (new_n58_ | (new_n56_ & x06))) | (new_n58_ & x09));
