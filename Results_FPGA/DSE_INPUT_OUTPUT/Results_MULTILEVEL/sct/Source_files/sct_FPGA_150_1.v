// Benchmark "FAU" written by ABC on Tue Aug 18 16:59:11 2020
...
module FAU ( 
  ...
  assign z02 = ~x06 & (x18 | (~new_n39_ & x04));
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = x04 & ~new_n39_ & (x06 ? ~x07 : (x07 & ~x18));
  assign z04 = x04 & ~new_n39_ & (x06 ? (~x07 ^ ~x08) : (x08 & ~x18));
  assign z05 = ~new_n43_ | (~x06 & (x09 | x18));
  assign new_n43_ = (~x09 | (x07 & x08)) & ~new_n39_ & x04 & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = new_n39_ | ~new_n45_ | (~x06 & (x10 | x18));
  assign new_n45_ = (~x10 | (x07 & x08 & ~x09)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ((new_n39_ | ~x04) & (x06 | (~x11 & ~x18))) | (~new_n47_ & x06) | (~x06 & x11 & ~x18);
  assign new_n47_ = (~x11 | (~x09 & ~x10 & x07 & x08)) & (~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = ((new_n39_ | ~x04) & (x06 | (~x12 & ~x18))) | (~new_n49_ & x06) | (~x06 & x12 & ~x18);
  assign new_n49_ = (~x12 | (x07 & x08 & ~x09 & ~x10 & ~x11)) & (~x07 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = ((x06 | (~x13 & ~x18)) & (new_n39_ | ~x04)) | (~x06 & x13 & ~x18) | (~new_n51_ & x06);
