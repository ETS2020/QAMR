...
module FAU ( 
  ...
  assign z07 = (~x04 & (x03 | ~x07)) | (~x07 & (new_n47_ | x11)) | (~new_n50_ & x03);
  assign new_n50_ = (~x11 | (new_n51_ & ~x09 & ~x10)) & ~x16 & (~new_n44_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x08;
  assign z08 = (~x04 & (x03 | ~x07)) | (~x07 & (new_n47_ | x12)) | (~new_n53_ & x03);
  assign new_n53_ = ~new_n54_ & ~x16 & (~new_n44_ | ~new_n55_);
  assign new_n54_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = (~x04 & (x03 | ~x07)) | (~x07 & (new_n47_ | x13)) | (~new_n57_ & x03);
