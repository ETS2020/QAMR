...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (x09 | ~x17)) | (x09 & (~x06 | ~x07 | ~x08)) | (x06 & x07 & x08 & ~x09 & ~x17);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = new_n46_ | new_n40_ | new_n47_ | ~x04;
  assign new_n46_ = ~x09 & (x17 | (x06 & x07 & x08 & ~x10));
  assign new_n47_ = x10 & (~x06 | ~x07 | ~x08 | x09 | x17);
  assign z07 = (~new_n51_ & ~x09) | new_n40_ | ~x04 | (~new_n49_ & x11);
  assign new_n49_ = new_n50_ & ~x09 & ~x10 & ~x17;
  assign new_n50_ = x06 & x07 & x08;
  assign new_n51_ = ~x17 & (~x06 | ~x07 | ~x08 | x10 | x11);
  assign z08 = new_n53_ | new_n40_ | new_n54_ | ~x04;
  assign new_n53_ = ~x09 & (x17 | (new_n50_ & ~x10 & ~x11 & ~x12));
  assign new_n54_ = x12 & (~new_n50_ | x11 | x17 | x09 | x10);
  assign z09 = (~new_n44_ & ~new_n37_) | new_n56_ | (~new_n53_ & x13);
  assign new_n56_ = new_n57_ & x08 & ~x09 & x06 & x07;
  assign new_n57_ = ~x12 & ~x13 & ~x17 & ~x10 & ~x11;
  assign z10 = x04 & ((~x17 & (new_n59_ | (new_n40_ & x14))) | (x09 & new_n40_ & x14));
