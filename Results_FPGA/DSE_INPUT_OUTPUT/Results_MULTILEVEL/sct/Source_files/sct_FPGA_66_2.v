...
module FAU ( 
  ...
  assign z04 = (x07 & ~x15) | (x04 & ~new_n39_ & (x06 ? (x07 ^ x08) : x08));
  ...
  assign new_n47_ = (~x11 | (x07 & (~x15 | (new_n48_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n48_ | x11 | ~x15);
  assign new_n48_ = ~x09 & ~x10;
  assign z08 = new_n51_ | new_n39_ | ~x04 | (~new_n50_ & x12);
  assign new_n50_ = x06 & x07 & x08 & new_n48_ & ~x11 & x15;
  assign new_n51_ = x07 & (new_n52_ | ~x15);
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n43_ | new_n54_ | (~new_n51_ & x13);
  assign new_n54_ = new_n55_ & x08 & ~x09 & x06 & x07;
  assign new_n55_ = ~x10 & ~x11 & ~x12 & ~x13 & x15;
