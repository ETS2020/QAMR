...
module FAU ( 
  ...
  assign z04 = (~x07 & x17) | (x04 & ~new_n39_ & (x06 ? (x07 ^ x08) : x08));
  assign z05 = (~new_n43_ & (x07 | (~x09 & ~x17))) | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (~x07 & x09 & ~x17);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = (~new_n43_ & (x07 | (~x10 & ~x17))) | (~new_n45_ & x07) | (~x07 & x10 & ~x17);
  assign new_n45_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = ~new_n47_ | new_n39_ | (~x07 & (x11 | x17));
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n48_ = x06 & x08;
  assign new_n49_ = x06 & x07 & x08;
  assign z08 = ~new_n51_ | new_n39_ | (~x07 & (x12 | x17));
  assign new_n51_ = ~new_n52_ & x04 & (~new_n49_ | ~new_n53_);
  assign new_n52_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n53_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = (~x07 & (x13 | x17)) | new_n39_ | ~new_n55_ | (~new_n57_ & x13);
  assign new_n55_ = x04 & (~new_n56_ | ~x08 | x09 | ~x06 | ~x07);
  assign new_n56_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n57_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x07 & (new_n59_ | (new_n39_ & x14))) | (new_n60_ & x14));
  assign new_n59_ = x06 & x08 & ~x09 & ~new_n39_ & (new_n56_ | x00);
  assign new_n60_ = x16 & ~x17 & (~x02 | x03);
