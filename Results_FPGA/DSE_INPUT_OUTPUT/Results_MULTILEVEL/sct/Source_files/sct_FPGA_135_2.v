...
module FAU ( 
  ...
  assign z06 = new_n45_ | (~new_n47_ & x10) | ~x04 | new_n44_ | new_n48_;
  assign new_n47_ = x08 & ~x09 & x06 & x07;
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = new_n45_ | (~new_n48_ & x11) | ~x04 | new_n44_ | new_n50_;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n52_ | (x16 & ((x03 & x07) | (~x02 & (x12 ? x07 : ~x03))));
  assign new_n52_ = (x03 | (x12 ? x07 : x04)) & (~x07 | ((new_n53_ | ~x12) & ~new_n54_ & x04));
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n54_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n58_ | (~x03 & (x13 ? ~x07 : ~x04)) | (~new_n56_ & x07);
  assign new_n56_ = (~x13 | (new_n57_ & ~x10 & ~x11 & ~x12)) & x04 & (~new_n57_ | x12 | x13 | x10 | x11);
  assign new_n57_ = x06 & x08 & ~x09;
  assign new_n58_ = x16 & ((x03 & x07) | (~x02 & (x13 ? x07 : ~x03)));
  assign z10 = x04 & ((x07 & (new_n60_ | (new_n63_ & x03))) | (new_n63_ & ~x02 & ~x03));
