...
module FAU ( 
  ...
  nand4  g42(.a(new_n76_), .b(new_n72_), .c(new_n67_), .d(new_n66_), .O(new_n77_));
  or2    g43(.a(new_n77_), .b(new_n59_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n44_), .d(x04), .O(z09));
  inv1   g45(.a(x00), .O(new_n80_));
  nand2  g46(.a(new_n77_), .b(new_n80_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n44_), .c(new_n58_), .d(x08), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(x07), .c(x06), .O(new_n84_));
  inv1   g50(.a(x14), .O(new_n85_));
  or2    g51(.a(new_n44_), .b(new_n85_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n84_), .c(new_n40_), .O(z10));
