...
module FAU ( 
  ...
  assign new_n24_ = ~x08 & (x04 ? ((x09 & (~x02 | ~x03)) | (x02 & x03 & ~x09)) : ~x00);
  assign z1 = (~new_n26_ & x04) | (~x01 & ~x04) | ~x05 | x08;
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = ~x05 | (~x08 & (x04 ? ~new_n28_ : ~x06));
  ...
  assign new_n33_ = x05 & (x04 | x07) & (~x05 | ~x08);
  assign z4 = x08 & (x05 | (x14 & x15 & x03 & x10));
endmodule
