...
module FAU ( 
  ...
  assign z1 = (x09 & (x08 | (x04 & x11))) | ~new_n27_ | (x04 & (new_n26_ ? (~x09 & ~x11) : x11));
  ...
  assign new_n31_ = (x09 | ((~x12 | (x02 & x03 & ~x11)) & (x11 | x12 | ~x02 | ~x03))) & (x08 | ~x09 | ~x12);
  assign z3 = new_n33_ | (~new_n34_ & x04) | ~x05 | (~x04 & ~x07);
  assign new_n33_ = x09 & (x08 | (x04 & x13));
  assign new_n34_ = (~x13 | (x02 & x03 & ~x11 & ~x12)) & (~x02 | ~x03 | x09 | x11 | x12 | x13);
