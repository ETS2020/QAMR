...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    new_n185_, new_n188_, new_n195_, new_n196_, new_n197_, new_n199_,
  ...
  assign z36 = x79 & (x01 | (~x04 & new_n199_ & x54));
  ...
  assign z46 = x79 & (x01 | (~x04 & new_n199_ & x64));
  ...
  assign z49 = (~x01 & new_n221_ & x04) | (x79 & (x01 | (new_n222_ & x69)));
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign new_n222_ = x77 & ~x78 & (~x81 ^ x84);
  assign z50 = (~x01 & new_n224_ & x04) | (x79 & (x01 | (new_n222_ & x70)));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = (~x01 & new_n226_ & x04) | (x79 & (x01 | (new_n222_ & x71)));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n219_ & x72) | (new_n228_ & x04));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = (~x01 & new_n230_ & x04) | (x79 & (x01 | (new_n222_ & x73)));
  ...
  assign new_n234_ = ~x01 & (~new_n235_ | x04 | ~x77 | ~x78 | x80);
  assign new_n235_ = ~x81 & ~x82 & x83 & x84;
  assign z56 = x01 ? ~x79 : ((x79 & ~new_n237_ & (~x77 | ~x78)) | ~x00 | (~x77 & ~x78));
  assign new_n237_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = (x01 & x79) | (~x02 & x03 & x00 & ~x01);
  assign z58 = ~x01 & (new_n244_ | (x77 & (new_n240_ | new_n243_)));
  assign new_n240_ = x04 & x78 & x79 & (new_n241_ | (new_n181_ & new_n242_));
  assign new_n241_ = ~x40 & x42;
  assign new_n242_ = ~x42 & x43 & ~x74 & x80;
  assign new_n243_ = ~x78 & ~x79 & x40 & ~x42;
  assign new_n244_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = (x77 & ((new_n246_ & x04) | (~x01 & ~new_n247_ & ~x79))) | (x01 & x79) | (~x01 & ~x04 & ~x79);
  assign new_n246_ = x78 & x79 & (x40 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n247_ = ~x40 & ~x78;
  assign z60 = (~x01 & ~x79 & (~x04 | x78)) | (x79 & (new_n250_ | x01 | (new_n249_ & x04)));
  assign new_n249_ = ~x42 & x77 & x78 & (~new_n180_ | ~new_n181_);
  assign new_n250_ = (~x81 ^ ~x84) & (x77 ^ x78);
  assign z61 = x79 & (x01 | (~new_n252_ & x80));
  assign new_n252_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (x79 & (new_n254_ | x01)) | (~x01 & x04 & x78 & (new_n179_ | ~x79));
  assign new_n254_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = x79 & (x01 | (~new_n252_ & x82));
  assign z64 = (x79 & (new_n257_ | x01)) | (~x01 & x04 & ~x77 & x78 & ~x79);
  assign new_n257_ = ~new_n252_ & x83;
  assign z65 = ~new_n259_ & x79;
  assign new_n259_ = ~x01 & (~x84 | (x77 ? (x78 ? x04 : ~x81) : (~x78 | ~x81)));
endmodule
