...
module FAU ( 
  ...
  assign z23 = ~x00 | x01 | (~x79 & (x13 | (~x04 & x05)));
  ...
  assign z48 = ~x01 & ((x04 & new_n218_ & ~x13) | (new_n219_ & x68));
  ...
  assign new_n229_ = new_n230_ & x04 & ~x13 & x21;
  assign new_n230_ = x52 & ~x77 & x78 & ~x79;
  assign z54 = ~x79 & (x13 | (new_n232_ & ~x01));
  ...
  assign z60 = ~x01 & ((x79 & (new_n250_ | new_n252_)) | (~x13 & ~new_n251_ & ~x79));
  assign new_n250_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n251_ = x04 & ~x78;
  assign new_n252_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z61 = (x13 & ~x79) | (~x01 & x79 & ~new_n254_ & x80);
  assign new_n254_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x79 & (new_n250_ | new_n256_)) | (new_n257_ & x78 & ~x79));
  assign new_n256_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign new_n257_ = x04 & ~x13;
  assign z63 = ~x01 & x79 & ~new_n254_ & x82;
  assign z64 = ~x01 & ((new_n260_ & x79) | (new_n257_ & ~x77 & x78 & ~x79));
  assign new_n260_ = ~new_n254_ & x83;
  assign z65 = (x13 & ~x79) | (~x01 & new_n262_ & x79);
