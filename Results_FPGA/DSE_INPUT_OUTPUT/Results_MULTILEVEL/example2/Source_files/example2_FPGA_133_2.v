...
module FAU ( 
  ...
  assign new_n182_ = x78 & ~x79 & x04 & ~x75;
  ...
  assign z52 = ~x01 & ((new_n219_ & x72) | (x04 & new_n227_ & ~x75));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n219_ & x73) | (x04 & new_n229_ & ~x75));
  ...
  assign new_n240_ = x40 & ~x42 & ~x75 & ~x78 & ~x79;
  assign new_n241_ = ~x75 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & (new_n245_ | (x77 & (new_n244_ | (~new_n243_ & x78))));
  assign new_n243_ = (x75 | x79) & (~x04 | x42 | ~x79 | (new_n179_ & new_n180_));
  assign new_n244_ = x40 & ((~x75 & ~x79) | (x04 & x78 & x79));
  assign new_n245_ = ~x04 & ~x75 & ~x79;
  assign z60 = new_n155_ | (~x01 & (new_n248_ | new_n249_ | (new_n247_ & x04)));
  assign new_n247_ = ~x42 & x77 & x78 & x79 & (~new_n179_ | ~new_n180_);
  ...
  assign z65 = (x75 & ~x79) | (~x01 & new_n258_ & x79);
