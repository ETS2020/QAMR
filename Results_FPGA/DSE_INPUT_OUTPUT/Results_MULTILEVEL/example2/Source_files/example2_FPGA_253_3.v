...
module FAU ( 
  ...
  assign z50 = ~x01 & ((x04 & new_n224_ & ~x77) | (x70 & new_n225_ & x77));
  assign new_n224_ = x78 & ~x79 & (x52 ? x18 : x10);
  assign new_n225_ = ~x78 & x79 & (~x81 ^ x84);
  assign z51 = (~x01 & new_n227_ & x04) | (x79 & (x01 | (new_n220_ & x71)));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = (~x01 & new_n229_ & x04) | (x79 & (x01 | (new_n220_ & x72)));
  ...
  assign new_n249_ = ~x42 & x77 & x78 & x79 & (~new_n180_ | ~new_n181_);
  ...
  assign z62 = ~x01 & ((new_n254_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n254_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = ~x01 & new_n256_ & x79;
  assign new_n256_ = x82 & ((~x04 & x77 & x78) | ((~x77 ^ ~x78) & (x81 ^ ~x84)));
  assign z64 = (x79 & (new_n258_ | x01)) | (~x01 & x04 & ~x77 & x78 & ~x79);
  assign new_n258_ = x83 & ((~x04 & x77 & x78) | ((~x77 ^ ~x78) & (x81 ^ ~x84)));
  assign z65 = ~new_n260_ & x79;
  assign new_n260_ = ~x01 & (~x84 | (x77 ? (x78 ? x04 : ~x81) : (~x78 | ~x81)));
endmodule
