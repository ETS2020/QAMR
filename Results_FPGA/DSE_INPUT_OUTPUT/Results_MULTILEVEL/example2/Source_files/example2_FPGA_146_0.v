...
module FAU ( 
  ...
  assign new_n154_ = ~x13 & ~x79;
  assign new_n155_ = ~x79 & (~x13 | (x77 & x78));
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : x13);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & x78 & x52 & ~x01 & x13;
  ...
  assign z23 = (~x79 & (~x13 | (~x04 & x05))) | ~x00 | x01;
  ...
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & x13));
  ...
  assign z50 = ~x01 & ((x04 & new_n223_ & x13) | (new_n219_ & x70));
  ...
  assign z53 = ~x01 & ((new_n219_ & x73) | (new_n229_ & x04));
  assign new_n229_ = x13 & ~x77 & x78 & ~x79 & (x21 | ~x52);
  assign z54 = ~x79 & (~x13 | (new_n231_ & ~x01));
  ...
  assign z64 = ~x01 & ((new_n259_ & x79) | (new_n256_ & ~x77 & x78 & ~x79));
  assign new_n259_ = ~new_n253_ & x83;
  assign z65 = (~x13 & ~x79) | (~x01 & new_n261_ & x79);
