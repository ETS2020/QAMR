// Benchmark "FAU" written by ABC on Mon Aug 17 18:26:09 2020
...
module FAU ( 
  ...
  assign z26 = x79 & (x01 | (~x04 & ~x42 & new_n187_ & x44));
  assign new_n187_ = x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z27 = x79 & (x01 | (~x04 & ~x42 & new_n187_ & x45));
  assign z28 = x79 & (x01 | (~x04 & ~x42 & new_n187_ & x46));
  ...
  assign z35 = x79 & (x01 | (~x04 & new_n202_ & x53));
  assign new_n202_ = x77 & ~new_n200_ & x78;
  assign z36 = x79 & (x01 | (~x04 & new_n202_ & x54));
  assign z37 = x79 & (x01 | (~x04 & new_n202_ & x55));
  assign z38 = ~x01 & ~x04 & new_n199_ & x56;
  assign z39 = x79 & (x01 | (~x04 & new_n202_ & x57));
  assign z40 = ~x01 & ~x04 & new_n199_ & x58;
  assign z41 = x79 & (x01 | (~x04 & new_n202_ & x59));
  assign z42 = ~x01 & ~x04 & new_n199_ & x60;
  assign z43 = x79 & (x01 | (~x04 & new_n202_ & x61));
  assign z44 = ~x01 & ~x04 & new_n199_ & x62;
  assign z45 = x79 & (x01 | (~x04 & new_n202_ & x63));
  assign z46 = x79 & (x01 | (~x04 & new_n202_ & x64));
  ...
  assign z51 = ~x01 & ((new_n219_ & x71) | (new_n226_ & x04));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = (~x01 & new_n228_ & x04) | (x79 & (x01 | (new_n222_ & x72)));
  ...
  assign z54 = x01 ? x79 : (x04 & ~x77 & x78 & ~new_n232_ & ~x79);
  assign new_n232_ = x52 ? ~x22 : ~x14;
  ...
  assign z58 = ~new_n243_ | (x77 & (new_n242_ | (x04 & new_n240_ & x78)));
  assign new_n240_ = x79 & ((~x40 & x42) | (new_n181_ & new_n241_ & ~x42 & x43));
  assign new_n241_ = ~x74 & x80;
  assign new_n242_ = ~x01 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n243_ = x01 ? ~x79 : (x79 | (x04 & (x77 | ~x78)));
  ...
  assign z61 = x79 & (x01 | (~new_n251_ & x80));
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (x79 & (new_n253_ | x01)) | (~x01 & x04 & x78 & (new_n179_ | ~x79));
  ...
  assign new_n256_ = ~new_n251_ & x83;
  assign z65 = ~new_n258_ & x79;
  assign new_n258_ = ~x01 & (~x84 | (x77 ? (x78 ? x04 : ~x81) : (~x78 | ~x81)));
endmodule
