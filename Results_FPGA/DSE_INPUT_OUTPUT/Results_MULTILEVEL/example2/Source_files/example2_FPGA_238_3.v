...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n158_, new_n179_, new_n180_, new_n181_,
    ...
    new_n194_, new_n196_, new_n201_, new_n202_, new_n203_, new_n205_,
  ...
  assign z23 = ~x00 | x01 | (x70 & x79) | (~x04 & x05 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & (~x79 | (~x70 & x77 & x78));
  assign z25 = x79 & (x70 | (~x01 & ~x04 & new_n187_ & x05));
  assign new_n187_ = ~x42 & x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z26 = x79 & (x70 | (~x01 & ~x04 & new_n189_ & ~x42));
  ...
  assign z28 = x79 & (x70 | (~x01 & ~x04 & new_n194_ & ~x42));
  ...
  assign z33 = x79 & (x70 | (~x01 & new_n201_ & ~x04));
  ...
  assign z40 = x79 & (x70 | (~x01 & ~x04 & new_n209_ & x58));
  assign z41 = x79 & (x70 | (~x01 & ~x04 & new_n209_ & x59));
  assign z42 = x79 & (x70 | (~x01 & ~x04 & new_n209_ & x60));
  ...
  assign z50 = new_n154_ | (~x01 & new_n229_ & x04);
  ...
  assign new_n245_ = ~x70 & x78 & x79 & (new_n246_ | (new_n182_ & new_n247_));
  ...
  assign new_n251_ = x79 & (~x04 | x42 | x70 | (new_n181_ & new_n182_));
  assign new_n252_ = x40 & (~x79 | (x04 & ~x70 & x78));
  assign new_n253_ = ~x04 & ~x79;
  assign z60 = ~x01 & (new_n257_ | (~x70 & (new_n255_ | new_n256_)));
  ...
  assign z62 = ~x01 & (new_n262_ | (~x70 & (new_n255_ | new_n261_)));
  assign new_n261_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign new_n262_ = x04 & x78 & ~x79;
  assign z63 = x79 & (x70 | (~x01 & ~new_n264_ & x82));
  assign new_n264_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z64 = ~x01 & (new_n266_ | (~x70 & x79 & ~new_n264_ & x83));
  assign new_n266_ = x78 & ~x79 & x04 & ~x77;
  assign z65 = x79 & (new_n268_ | x70);
