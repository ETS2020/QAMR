...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n200_, new_n204_, new_n215_, new_n223_, new_n225_, new_n228_,
    new_n230_, new_n232_, new_n233_, new_n235_, new_n237_, new_n241_;
  ...
  assign new_n204_ = x77 & x78 & ~new_n200_ & x79;
  ...
  assign new_n228_ = (x40 | ~x42) & (~new_n180_ | x74 | ~x80 | x42 | ~x43);
  assign z59 = ~x01 & x04 & x77 & x78 & ~new_n230_ & x79;
  assign new_n230_ = ~x40 & (x42 | (new_n179_ & new_n180_));
  assign z60 = ~x01 & (new_n233_ | ~x79 | (x04 & new_n232_ & ~x42));
  assign new_n232_ = x77 & x78 & x79 & (~new_n179_ | ~new_n180_);
  assign new_n233_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = ~x01 & x79 & ~new_n235_ & x80;
  assign new_n235_ = (x04 | ~x77 | ~x78) & (new_n177_ | (~x77 ^ x78));
  assign z62 = ~x01 & (new_n237_ | ~x79 | (x04 & new_n178_ & ~x42));
