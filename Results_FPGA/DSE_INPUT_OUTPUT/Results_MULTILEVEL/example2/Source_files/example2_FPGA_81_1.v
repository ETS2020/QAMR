...
module FAU ( 
  ...
  assign new_n242_ = x40 & ~x42 & ~x78 & ~x79 & ~x80;
  assign new_n243_ = ~x79 & ~x80 & (~x04 | (~x77 & x78));
  assign z59 = new_n154_ | (~x01 & (new_n249_ | (x77 & (new_n245_ | new_n247_))));
  assign new_n245_ = x40 & (new_n246_ | ~x79);
  assign new_n246_ = x04 & x78;
  assign new_n247_ = x78 & ((~x80 & (~x79 | (x04 & ~x42 & x79))) | (x04 & ~x42 & ~new_n248_ & x79));
  assign new_n248_ = x43 & ~x74 & x81 & x82 & ~x83 & x84;
  assign new_n249_ = ~x04 & ~x79 & ~x80;
  assign z60 = ~x01 & (x79 ? (new_n251_ | new_n252_) : new_n253_);
  assign new_n251_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n252_ = (~x81 ^ ~x84) & (x77 ^ x78);
  assign new_n253_ = ~x80 & (~x04 | x78);
  assign z61 = ~x01 & x79 & ~new_n255_ & x80;
  assign new_n255_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z62 = (~x79 & (x80 | (new_n246_ & ~x01))) | (~x01 & (new_n251_ | (new_n257_ & x79)));
