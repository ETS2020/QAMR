...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n200_, new_n203_, new_n215_, new_n217_, new_n224_, new_n226_,
  ...
  assign z62 = ~x01 & (new_n238_ | ~x79 | (x04 & new_n178_ & ~x42));
  assign new_n238_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = ~x01 & (~x79 | (~new_n236_ & x82));
  assign z64 = ~x01 & (~x79 | (~new_n241_ & x83));
  assign new_n241_ = (x04 | ~x77 | ~x78) & ((x77 ^ ~x78) | ((x81 | x84) & (~x79 | ~x81 | ~x84)));
