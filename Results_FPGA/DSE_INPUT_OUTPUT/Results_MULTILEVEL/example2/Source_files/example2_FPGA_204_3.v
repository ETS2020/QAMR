...
module FAU ( 
  ...
  assign z02 = ~x01 & ~x54 & ~new_n158_ & x79;
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = (x54 & x79) | (x78 & ~x79 & ~x01 & x52);
  ...
  assign z31 = x79 & (x54 | (~x01 & ~x04 & new_n197_ & ~x42));
  ...
  assign z33 = x79 & (x54 | (~x01 & new_n201_ & ~x04));
  ...
  assign z34 = x79 & (x54 | (~x01 & ~x04 & new_n205_ & x52));
  assign new_n205_ = x77 & ~new_n206_ & x78;
  assign new_n206_ = ((~x82 ^ x84) | ((x81 | (x42 & x83)) & (~x42 | ~x81 | ~x83))) & ((x82 ^ x84) | ((~x81 | (x42 & x83)) & (~x42 | x81 | ~x83)));
  assign z35 = ~x01 & ~x04 & x53 & new_n208_ & ~x54;
  assign new_n208_ = x77 & x78 & ~new_n206_ & x79;
  assign z37 = ~x01 & ~x04 & ~x54 & new_n208_ & x55;
  assign z38 = ~x01 & ~x04 & ~x54 & new_n208_ & x56;
  assign z39 = ~x01 & ~x04 & ~x54 & new_n208_ & x57;
  assign z40 = x79 & (x54 | (~x01 & ~x04 & new_n205_ & x58));
  assign z41 = x79 & (x54 | (~x01 & ~x04 & new_n205_ & x59));
  assign z42 = ~x01 & ~x04 & ~x54 & new_n208_ & x60;
  assign z43 = x79 & (x54 | (~x01 & ~x04 & new_n205_ & x61));
  assign z44 = x79 & (x54 | (~x01 & ~x04 & new_n205_ & x62));
  assign z45 = x79 & (x54 | (~x01 & ~x04 & new_n205_ & x63));
  assign z46 = x79 & (x54 | (~x01 & ~x04 & new_n205_ & x64));
  assign z47 = ~x01 & ((x04 & new_n220_ & ~x77) | (~x54 & new_n221_ & x77));
  ...
  assign new_n240_ = ~x54 & ((x77 & x78) | (~x76 & (x81 | ~x84) & (~x81 | x84)));
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = ~x01 & (new_n247_ | (x77 & (new_n246_ | (new_n243_ & x04))));
  assign new_n243_ = ~x54 & x78 & x79 & (new_n244_ | (new_n182_ & new_n245_));
  ...
  assign new_n249_ = x79 & (~x04 | x42 | x54 | (new_n181_ & new_n182_));
  assign new_n250_ = x40 & (~x79 | (x04 & ~x54 & x78));
  assign new_n251_ = ~x04 & ~x79;
  assign z60 = new_n154_ | (~x01 & (new_n254_ | new_n255_ | (new_n253_ & x04)));
  assign new_n253_ = ~x42 & ~x54 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n254_ = (~x81 ^ ~x84) & (x77 ? (~x78 & x79) : x78);
  assign new_n255_ = ~x79 & (~x04 | x78);
  assign z61 = ~x01 & ~x54 & x79 & ~new_n257_ & x80;
  ...
  assign z63 = x79 & (x54 | (~x01 & ~new_n257_ & x82));
  assign z64 = new_n154_ | (~new_n262_ & ~x01);
  assign new_n262_ = (~x79 | new_n257_ | ~x83) & (~x78 | x79 | ~x04 | x77);
  assign z65 = x79 & (new_n264_ | x54);
