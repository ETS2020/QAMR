...
module FAU ( 
  ...
  assign new_n180_ = x79 & (x42 | ~x77 | (new_n182_ & new_n181_ & x43));
  assign new_n181_ = ~x74 & x80;
  ...
  assign new_n244_ = x78 & (~x79 | (x04 & ~x42 & (~x80 | (~new_n245_ & x79))));
  assign new_n245_ = x43 & ~x74 & x81 & x82 & ~x83 & x84;
  assign new_n246_ = x40 & (~x79 | (x04 & x78));
  assign new_n247_ = ~x04 & ~x79;
  assign z60 = new_n154_ | (~x01 & (new_n250_ | new_n251_ | (new_n249_ & x04)));
  assign new_n249_ = ~x42 & x77 & x78 & (~x80 | (~new_n245_ & x79));
  ...
  assign new_n255_ = ~x42 & x77 & x78 & (~new_n182_ | ~new_n181_ | ~x43);
  assign new_n256_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign new_n257_ = x04 & x78 & ~x79 & x80;
