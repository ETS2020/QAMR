...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | x72)) | (~x01 & (~x77 ^ x78));
  ...
  assign z22 = (x72 & ~x79) | (~x01 & (new_n179_ | (~x41 & new_n182_ & x79)));
  ...
  assign new_n185_ = x05 & ~x43 & ((~x72 & ~x79) | (x77 & x78 & x79));
  ...
  assign z52 = ~x01 & ((new_n219_ & x72) | (x04 & new_n227_ & ~x72));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n229_ & ~x72) | (new_n219_ & x73));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (x72 | (new_n231_ & ~x01));
  ...
  assign new_n241_ = x40 & ~x42 & ~x72 & ~x78 & ~x79;
  assign new_n242_ = ~x72 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = (x72 & ~x79) | (~x01 & ((~new_n244_ & x77) | (~x04 & ~x72 & ~x79)));
  assign new_n244_ = (~x40 | (x79 & (~x04 | ~x78))) & (~x78 | ((~new_n245_ | ~x04) & (x72 | x79)));
  assign new_n245_ = ~x42 & x79 & (~new_n181_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((~new_n247_ & x79) | (~x72 & ~x79 & (~x04 | x78)));
  assign new_n247_ = (new_n236_ | (x77 ^ ~x78)) & (~x04 | x42 | ~x77 | new_n180_ | ~x78);
  assign z61 = ~x01 & x79 & ~new_n249_ & x80;
  assign new_n249_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~new_n251_ & ~x01) | (~x79 & (x72 | (~x01 & x04 & x78)));
  assign new_n251_ = ~new_n252_ & (~x04 | x42 | ~x77 | new_n180_ | ~x78);
  assign new_n252_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (x72 & ~x79) | (~x01 & x79 & ~new_n249_ & x82);
  assign z64 = ~x01 & (new_n255_ | (x79 & ~new_n249_ & x83));
  assign new_n255_ = x04 & ~x72 & ~x77 & x78 & ~x79;
