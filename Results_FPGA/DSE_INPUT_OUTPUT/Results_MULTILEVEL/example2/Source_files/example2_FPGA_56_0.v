...
module FAU ( 
  ...
  assign z27 = ~x01 & (~x79 | (~x04 & ~x42 & new_n188_ & x45));
  ...
  assign new_n228_ = (x40 | ~x42) & (~new_n180_ | x42 | ~x43 | x74 | ~x80);
  assign z59 = ~x01 & (~x79 | (x04 & x77 & ~new_n230_ & x78));
  assign new_n230_ = ~x40 & (x42 | ~x79 | (new_n179_ & new_n180_));
  assign z60 = ~x01 & x79 & (new_n178_ | new_n232_);
  assign new_n232_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = ~x01 & x79 & ~new_n234_ & x80;
  assign new_n234_ = (x04 | ~x77 | ~x78) & (new_n177_ | (~x77 ^ x78));
  assign z62 = ~x01 & (new_n236_ | new_n178_ | ~x79);
