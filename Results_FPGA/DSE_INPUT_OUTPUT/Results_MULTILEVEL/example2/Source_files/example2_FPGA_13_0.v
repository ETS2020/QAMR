...
module FAU ( 
  ...
  assign new_n185_ = x05 & ~x43 & ((x49 & ~x79) | (x77 & x78 & x79));
  ...
  assign z31 = (~x49 & ~x79) | (~x01 & ~x04 & ~x42 & new_n187_ & x49);
  ...
  assign z52 = ~x01 & ((x04 & new_n227_ & x49) | (new_n219_ & x72));
  ...
  assign z54 = ~x01 & x04 & new_n231_ & x49;
  ...
  assign new_n240_ = x40 & ~x42 & x49 & ~x78 & ~x79;
  assign new_n241_ = x49 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & (new_n245_ | (x77 & (new_n244_ | (~new_n243_ & x78))));
  assign new_n243_ = (~x49 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n244_ = x40 & ((x49 & ~x79) | (x04 & x78 & x79));
  assign new_n245_ = ~x04 & x49 & ~x79;
  assign z60 = ~x01 & ((x49 & ~new_n248_ & ~x79) | (x79 & (new_n247_ | new_n249_)));
  assign new_n247_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n248_ = x04 & ~x78;
  assign new_n249_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = (~x49 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (~x49 | (new_n253_ & ~x01))) | (~x01 & (new_n247_ | (new_n254_ & x79)));
