...
module FAU ( 
  ...
  assign z05 = ~z29 & (x40 ? x65 : x23);
  assign z29 = ~x01 & x79;
  assign z06 = ~z29 & (x40 ? x64 : x24);
  assign z07 = z29 | (x25 & ~x40) | (x40 & x63);
  assign z08 = z29 | (x26 & ~x40) | (x40 & x62);
  assign z09 = z29 | (x27 & ~x40) | (x40 & x61);
  assign z10 = z29 | (x28 & ~x40) | (x40 & x60);
  assign z11 = z29 | (x29 & ~x40) | (x40 & x59);
  assign z12 = z29 | (x30 & ~x40) | (x40 & x58);
  assign z13 = z29 | (x31 & ~x40) | (x40 & x57);
  assign z14 = z29 | (x32 & ~x40) | (x40 & x51);
  assign z15 = ~z29 & (x40 ? x50 : x33);
  assign z16 = z29 | (x34 & ~x40) | (x40 & x49);
  assign z17 = ~z29 & (x40 ? x48 : x35);
  assign z18 = z29 | (x36 & ~x40) | (x40 & x47);
  assign z19 = z29 | (x37 & ~x40) | (x40 & x46);
  assign z20 = z29 | (x38 & ~x40) | (x40 & x45);
  assign z21 = ~z29 & (x40 ? x44 : x39);
  ...
  assign z48 = ~x01 & (new_n181_ | x79);
  assign new_n181_ = x04 & ~x77 & x78 & (x52 ? x16 : x08);
  assign z49 = ~x01 & (new_n183_ | x79);
  assign new_n183_ = x04 & ~x77 & x78 & (x52 ? x17 : x09);
  assign z50 = ~x01 & new_n185_ & x04;
  assign new_n185_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & (new_n187_ | x79);
  assign new_n187_ = x04 & ~x77 & x78 & (x52 ? x19 : x11);
  assign z52 = ~x01 & (new_n189_ | x79);
  assign new_n189_ = x04 & ~x77 & x78 & (x52 ? x20 : x12);
  assign z53 = ~x01 & new_n191_ & x04;
  assign new_n191_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  ...
  assign z60 = ~x01 & (x78 | x79 | (~x04 & ~x79));
  assign z62 = ~x79 & x78 & ~x01 & x04;
