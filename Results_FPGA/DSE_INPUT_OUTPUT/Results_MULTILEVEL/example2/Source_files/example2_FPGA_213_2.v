...
module FAU ( 
  ...
  assign z47 = ~x01 & ((x04 & ~x42 & new_n218_ & ~x77) | (new_n217_ & x77));
  assign new_n217_ = ~x78 & x79 & ~new_n179_ & (x67 | x75);
  assign new_n218_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign z48 = new_n154_ | (~x01 & ((new_n221_ & x04) | (new_n220_ & x68)));
  assign new_n220_ = x77 & ~x78 & ~new_n179_ & x79;
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((new_n220_ & x69) | (x04 & new_n223_ & ~x42));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n220_ & x70) | (x04 & new_n225_ & ~x42));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = new_n154_ | (~x01 & ((new_n227_ & x04) | (new_n220_ & x71)));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n220_ & x72) | (x04 & new_n229_ & ~x42));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n220_ & x73) | (x04 & new_n231_ & ~x42));
  ...
  assign new_n245_ = ~x42 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & (new_n249_ | (x77 & (new_n247_ | new_n248_)));
  assign new_n247_ = ~x42 & x78 & (~x79 | (x04 & x79 & (~new_n181_ | ~new_n182_)));
  assign new_n248_ = x40 & ((~x42 & ~x79) | (x04 & x78 & x79));
  assign new_n249_ = ~x04 & ~x42 & ~x79;
  assign z60 = ~x01 & ((x79 & (new_n251_ | new_n252_)) | (~x42 & ~new_n253_ & ~x79));
  assign new_n251_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n252_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign new_n253_ = x04 & ~x78;
  assign z61 = ~x01 & x79 & ~new_n255_ & x80;
  assign new_n255_ = (new_n179_ | (~x77 ^ x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n260_ | (x78 & (new_n257_ | (new_n259_ & x79))));
  assign new_n257_ = ~x42 & ((x04 & (~x79 | (x77 & ~x81))) | (x77 & x79 & ~new_n258_ & x81));
  assign new_n258_ = x43 & ~x74 & x80 & x82 & ~x83 & x84;
  assign new_n259_ = x81 & ((~x04 & x77 & (x42 | x80)) | (~x77 & x84));
  assign new_n260_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n255_ & x82;
  assign z64 = new_n154_ | (~new_n263_ & ~x01);
  assign new_n263_ = (~x79 | ~x83 | ((new_n179_ | (~x77 ^ x78)) & (x04 | ~x77 | ~x78))) & (~x78 | x79 | ~x04 | x77);
