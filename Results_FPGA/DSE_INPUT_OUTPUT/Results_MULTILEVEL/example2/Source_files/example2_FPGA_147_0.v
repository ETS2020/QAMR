...
module FAU ( 
  ...
  assign new_n198_ = (new_n155_ | new_n199_ | (x82 ^ x84)) & ((x82 ^ ~x84) | new_n155_ | new_n200_);
  ...
  assign new_n205_ = x79 & ((~new_n155_ & ~new_n206_ & (~x82 ^ ~x84)) | ((~x82 ^ x84) & ~new_n155_ & ~new_n207_));
  ...
  assign z47 = ~x01 & ((x04 & ~x77 & new_n221_ & x78) | (x77 & new_n220_ & ~x78));
  assign new_n220_ = x79 & (~x81 ^ x84) & ~new_n155_ & (x67 | x75);
  assign new_n221_ = ~x79 & ((x07 & (x15 | ~x52)) | (x15 & x46 & x52));
  assign z48 = new_n155_ | (~x01 & ((new_n223_ & x04) | (new_n224_ & x68)));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n224_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ~new_n155_ & ((new_n224_ & x69) | (new_n226_ & x04));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = new_n155_ | (~x01 & ((new_n224_ & x70) | (new_n228_ & x04)));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ~new_n155_ & ((new_n224_ & x71) | (new_n230_ & x04));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = new_n155_ | (~x01 & ((new_n224_ & x72) | (new_n232_ & x04)));
  assign new_n232_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ~new_n155_ & ((new_n224_ & x73) | (new_n234_ & x04));
  assign new_n234_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & ~x77 & new_n236_ & x78;
  assign new_n236_ = ~x79 & ~new_n155_ & (x52 ? x22 : x14);
  assign z55 = new_n238_ | new_n155_;
  assign new_n238_ = new_n239_ & ~x01 & ~x04 & x77 & x78 & x79;
  assign new_n239_ = ~x80 & ~x81 & ~x82 & x83 & x84;
  assign z56 = new_n241_ | ~x00 | x01 | new_n155_ | (~x77 & ~x78);
  assign new_n241_ = x79 & (~x77 | ~x78) & (x76 | (x81 & ~x84) | (~x81 & x84));
  assign z57 = x00 & ~x01 & ~x02 & ~new_n155_ & x03;
  assign z58 = new_n155_ | (~x01 & (new_n248_ | (x77 & (new_n244_ | new_n247_))));
