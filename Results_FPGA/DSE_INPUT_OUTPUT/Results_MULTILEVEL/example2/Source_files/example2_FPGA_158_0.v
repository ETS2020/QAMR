...
module FAU ( 
  ...
  assign new_n155_ = ~x51 & ~x79;
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : x51);
  assign z02 = (~x51 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & x52 & ~x01 & x51;
  assign z04 = (~x01 & (~x77 | ~x78 | x79)) | (~x51 & ~x79);
  ...
  assign z14 = (x40 & (x51 | ~x79)) | (~x51 & ~x79) | (x32 & ~x40);
  ...
  assign z23 = ~x00 | x01 | (~x79 & (~x51 | (~x04 & x05)));
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x51 & ~x79) | (x77 & x78 & x79));
  ...
  assign z49 = ~x01 & ((x04 & new_n221_ & x51) | (new_n219_ & x69));
  ...
  assign new_n240_ = x40 & ~x42 & x51 & ~x78 & ~x79;
  assign new_n241_ = x51 & ~x79 & (~x04 | (~x77 & x78));
