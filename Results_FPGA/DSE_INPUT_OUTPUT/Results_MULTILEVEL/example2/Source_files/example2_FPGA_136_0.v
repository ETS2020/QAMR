...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x70 | (x77 & x78));
  assign z01 = (~x79 & (~x01 | ~x70)) | (~x01 & (~x77 ^ x78));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & x78 & x70 & ~x01 & x52;
  assign z04 = (~x70 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign z23 = ((x70 | x79) & (~x00 | x01)) | (~x04 & x05 & x70 & ~x79);
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & x70 & new_n215_ & ~x77));
  ...
  assign z49 = ~x01 & ((new_n219_ & x69) | (x04 & new_n221_ & x70));
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = (~x70 & ~x79) | (~x01 & ((new_n219_ & x70) | (new_n223_ & x04)));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n219_ & x71) | (x04 & new_n225_ & x70));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n219_ & x72) | (x04 & new_n227_ & x70));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n219_ & x73) | (x04 & new_n229_ & x70));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x70 | (new_n231_ & ~x01));
