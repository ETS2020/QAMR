...
module FAU ( 
  ...
  assign z49 = ~x01 & ((new_n222_ & x69) | (x04 & new_n221_ & ~x68));
  ...
  assign z51 = new_n154_ | (~x01 & ((new_n222_ & x71) | (new_n226_ & x04)));
  ...
  assign new_n241_ = x40 & ~x42 & ~x68 & ~x78 & ~x79;
  assign new_n242_ = ~x68 & ~x79 & (~x04 | (~x77 & x78));
  ...
  assign z60 = ~x01 & ((x79 & (new_n248_ | new_n250_)) | (~x68 & ~new_n249_ & ~x79));
  ...
  assign new_n255_ = x04 & ~x68;
  assign z63 = (x68 & ~x79) | (~x01 & x79 & ~new_n252_ & x82);
  assign z64 = new_n154_ | (~new_n258_ & ~x01);
  assign new_n258_ = (~x79 | new_n252_ | ~x83) & (~x78 | x79 | ~x04 | x77);
  assign z65 = (x68 & ~x79) | (~x01 & new_n260_ & x79);
