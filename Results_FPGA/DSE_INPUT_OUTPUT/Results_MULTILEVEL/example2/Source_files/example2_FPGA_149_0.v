...
module FAU ( 
  ...
  assign new_n155_ = ~x67 & ~x79;
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : x67);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & x78 & x67 & ~x01 & x52;
  assign z04 = (~x01 & (~x77 | ~x78 | x79)) | (~x67 & ~x79);
  ...
  assign z23 = ((x67 | x79) & (~x00 | x01)) | (~x04 & x05 & x67 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x67 & ~x79) | (x77 & x78 & x79));
  ...
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & x67));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n219_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((x04 & new_n221_ & x67) | (new_n219_ & x69));
  ...
  assign new_n238_ = x78 & x79 & ((~x40 & x42) | (new_n182_ & new_n239_));
  assign new_n239_ = ~x42 & x43 & ~x74 & x80;
  assign new_n240_ = x40 & ~x42 & x67 & ~x78 & ~x79;
  assign new_n241_ = x67 & ~x79 & (~x04 | (~x77 & x78));
  ...
  assign z60 = ~x01 & ((x79 & (new_n247_ | new_n249_)) | (x67 & ~new_n248_ & ~x79));
  ...
  assign z62 = ~x01 & (((new_n247_ | new_n253_) & x79) | (new_n254_ & x78 & ~x79));
  assign new_n253_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign new_n254_ = x04 & x67;
  assign z63 = (~x67 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
