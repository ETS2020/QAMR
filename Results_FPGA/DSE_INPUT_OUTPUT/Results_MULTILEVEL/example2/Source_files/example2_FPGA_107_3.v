...
module FAU ( 
  ...
  assign z27 = x79 & (x01 | (~x04 & ~x42 & new_n189_ & x45));
  assign new_n189_ = x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z28 = x79 & (x01 | (~x04 & ~x42 & new_n189_ & x46));
  assign z29 = x79 & (x01 | (~x04 & ~x42 & new_n189_ & x47));
  assign z30 = x79 & (x01 | (~x04 & ~x42 & new_n189_ & x48));
