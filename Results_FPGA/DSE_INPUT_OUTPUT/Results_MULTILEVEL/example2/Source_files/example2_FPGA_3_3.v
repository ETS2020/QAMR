...
module FAU ( 
  ...
  wire new_n154_, new_n159_, new_n178_, new_n179_, new_n180_, new_n181_,
    new_n182_, new_n186_, new_n189_, new_n196_, new_n197_, new_n198_,
  ...
  assign z56 = (x79 & ~new_n238_ & (~x77 | ~x78)) | ~x00 | x01 | (~x77 & ~x78);
  ...
  assign z59 = ~new_n249_ | (x77 & (new_n248_ | (~x01 & ~new_n247_ & x78)));
  assign new_n247_ = x79 & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n248_ = x40 & ((x04 & x78 & x79) | (~x01 & ~x79));
  assign new_n249_ = x01 ? ~x79 : (x04 | x79);
  assign z60 = ~x01 & (new_n252_ | (new_n251_ & x04) | (~x79 & (~x04 | x78)));
  assign new_n251_ = ~x42 & x77 & x78 & x79 & (~new_n181_ | ~new_n182_);
  assign new_n252_ = (x81 ^ x84) & (x77 ? (~x78 & x79) : x78);
  assign z61 = x79 & (x01 | (~new_n254_ & x80));
  assign new_n254_ = (x04 | ~x77 | ~x78) & ((x77 ^ ~x78) | ((x81 | x84) & (x01 | ~x81 | ~x84)));
  assign z62 = ~x01 & ((new_n256_ & x79) | (x04 & x78 & (new_n180_ | ~x79)));
  assign new_n256_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = x79 & (new_n258_ | x01);
  assign new_n258_ = x82 & ((~x04 & x77 & x78) | ((~x77 ^ ~x78) & (~x81 ^ x84)));
  assign z64 = ~x01 & ((new_n260_ & x79) | (x78 & ~x79 & x04 & ~x77));
  assign new_n260_ = x83 & ((~x04 & x77 & x78) | ((~x77 ^ ~x78) & (~x81 ^ x84)));
