...
module FAU ( 
  ...
  assign z20 = (x38 & ~x40 & (~x39 | (x39 & x79))) | (x40 & x45 & (~x39 | x79));
  ...
  assign z23 = ~x00 | x01 | (~x79 & (x39 | (~x04 & x05)));
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((~x39 & ~x79) | (x77 & x78 & x79));
  ...
  assign z59 = new_n154_ | (~x01 & (new_n245_ | (x04 & new_n244_ & x77)));
  assign new_n244_ = x78 & (x40 | (~x42 & x79 & (~new_n181_ | ~new_n182_)));
  assign new_n245_ = ~x79 & ((x40 & x77) | (~x39 & (~x04 | (x77 & x78))));
  assign z60 = ~x01 & ((x79 & (new_n247_ | new_n249_)) | (~x39 & ~new_n248_ & ~x79));
