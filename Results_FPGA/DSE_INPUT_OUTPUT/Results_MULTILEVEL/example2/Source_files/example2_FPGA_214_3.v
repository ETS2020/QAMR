...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n158_, new_n179_, new_n180_, new_n181_,
    ...
    new_n256_, new_n258_, new_n260_, new_n261_, new_n264_, new_n265_,
    new_n267_;
  assign z00 = (~new_n154_ & (x40 ? x52 : x06)) | (~x01 & ~new_n155_ & x40);
  assign new_n154_ = x73 & x79;
  assign new_n155_ = x79 ? x73 : (x77 & x78);
  assign z01 = ~x01 & (~x79 | (~x73 & (~x77 ^ x78)));
  ...
  assign z22 = ~x01 & (new_n183_ | (~x73 & (new_n179_ | new_n180_)));
  ...
  assign z23 = ((~x73 | ~x79) & (~x00 | x01)) | (~x04 & x05 & ~x79);
  ...
  assign z33 = x79 & (x73 | (~x01 & new_n201_ & ~x04));
  ...
  assign z34 = x79 & (x73 | (~x01 & ~x04 & new_n205_ & x52));
  ...
  assign new_n208_ = ~x73 & x77 & x78 & ~new_n206_ & x79;
  assign z36 = x79 & (x73 | (~x01 & ~x04 & new_n205_ & x54));
  assign z37 = ~x01 & ~x04 & new_n208_ & x55;
  assign z38 = ~x01 & ~x04 & new_n208_ & x56;
  assign z39 = x79 & (x73 | (~x01 & ~x04 & new_n205_ & x57));
  assign z40 = ~x01 & ~x04 & new_n208_ & x58;
  assign z41 = x79 & (x73 | (~x01 & ~x04 & new_n205_ & x59));
  assign z42 = ~x01 & ~x04 & new_n208_ & x60;
  assign z43 = x79 & (x73 | (~x01 & ~x04 & new_n205_ & x61));
  ...
  assign z50 = ~x01 & ((new_n229_ & x04) | (x70 & new_n225_ & ~x73));
  ...
  assign z52 = new_n154_ | (~x01 & ((new_n233_ & x04) | (new_n225_ & x72)));
  assign new_n233_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = new_n154_ | (~x01 & new_n235_ & x04);
  ...
  assign new_n244_ = ~x73 & x78 & x79 & (new_n245_ | (new_n182_ & new_n246_));
