...
module FAU ( 
  ...
  assign new_n154_ = x29 & ~x79;
  assign new_n155_ = ~x79 & (x29 | (x77 & x78));
  assign z01 = (~x79 & (~x01 | x29)) | (~x01 & (~x77 ^ x78));
  assign z02 = (x29 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & x52 & ~x01 & ~x29;
  ...
  assign z23 = ~x00 | x01 | (~x79 & (x29 | (~x04 & x05)));
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x77 & x78 & x79) | (~x29 & ~x79));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x29 & new_n215_ & ~x77));
  assign new_n215_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & ~x29));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n219_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((x04 & new_n221_ & ~x29) | (new_n219_ & x69));
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n223_ & ~x29) | (new_n219_ & x70));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n225_ & ~x29) | (new_n219_ & x71));
  ...
  assign z53 = ~x01 & ((x04 & new_n229_ & ~x29) | (new_n219_ & x73));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n231_ & ~x29;
  ...
  assign new_n256_ = x04 & ~x29 & x78 & ~x79;
  assign z63 = (x29 & ~x79) | (~x01 & x79 & ~new_n252_ & x82);
