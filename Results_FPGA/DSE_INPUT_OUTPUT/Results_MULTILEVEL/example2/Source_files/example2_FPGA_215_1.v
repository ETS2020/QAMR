...
module FAU ( 
  ...
  assign z01 = (~x32 & x79) | (~x01 & ((x77 & x78) | ~x79 | (~x77 & ~x78)));
  ...
  assign z50 = ~x01 & ((new_n229_ & x04) | (x32 & new_n225_ & x70));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n231_ & x04) | (x32 & new_n225_ & x71));
  assign new_n231_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n233_ & x04) | (x32 & new_n225_ & x72));
  assign new_n233_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n235_ & x04) | (x32 & new_n225_ & x73));
