...
module FAU ( 
  ...
  assign new_n185_ = x05 & ~x43 & (new_n186_ | (~x62 & ~x79));
  ...
  assign z44 = x62 & (~x79 | (~x01 & ~x04 & new_n213_ & x77));
  ...
  assign z47 = ~x01 & ((new_n218_ & x77) | (x04 & ~x62 & new_n217_ & ~x77));
  assign new_n217_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n218_ = ~x78 & x79 & (~x81 ^ x84) & (x67 | x75);
  assign z48 = ~x01 & ((new_n221_ & x68) | (x04 & new_n220_ & ~x62));
  ...
  assign z60 = ~x01 & ((x79 & (new_n250_ | new_n252_)) | (~x62 & ~new_n251_ & ~x79));
