...
module FAU ( 
  ...
  wire new_n175_, new_n176_, new_n177_, new_n178_, new_n179_, new_n182_,
    ...
    new_n226_, new_n229_, new_n231_, new_n233_, new_n234_, new_n236_,
    new_n238_, new_n239_, new_n240_, new_n244_;
  ...
  assign z22 = ~x01 & x79 & (new_n175_ | (x04 & new_n177_ & ~x42));
  assign new_n175_ = ~x41 & ~new_n176_ & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign new_n176_ = ~x81 ^ ~x84;
  assign new_n177_ = x77 & x78 & (~new_n178_ | ~new_n179_);
  ...
  assign new_n229_ = (x40 | ~x42) & (~new_n179_ | x74 | ~x80 | x42 | ~x43);
  ...
  assign new_n233_ = ~x42 & x77 & x78 & x79 & (~new_n178_ | ~new_n179_);
  assign new_n234_ = ~x77 ^ x78;
  assign z61 = ~x01 & (~x79 | (~new_n236_ & x80));
  assign new_n236_ = (x04 | ~x77 | ~x78) & (new_n176_ | (~x77 ^ x78));
