...
module FAU ( 
  ...
  assign new_n186_ = x05 & ~x43 & (new_n187_ | (x44 & ~x79));
  ...
  assign z30 = new_n155_ | (~x01 & ~x04 & ~x42 & new_n189_ & x48);
  assign z31 = new_n155_ | (~x01 & ~x04 & ~x42 & new_n189_ & x49);
  ...
  assign z47 = new_n155_ | (~x01 & ((x04 & new_n217_ & ~x77) | (new_n218_ & x77)));
  assign new_n217_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n218_ = ~x78 & x79 & (x67 | x75) & (x81 ^ ~x84);
  assign z48 = ~x01 & ((new_n221_ & x68) | (x04 & new_n220_ & x44));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n221_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = new_n155_ | (~x01 & ((new_n221_ & x69) | (new_n223_ & x04)));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n225_ & x44) | (new_n221_ & x70));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n227_ & x44) | (new_n221_ & x71));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n229_ & x44) | (new_n221_ & x72));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = new_n155_ | (~x01 & ((new_n221_ & x73) | (new_n231_ & x04)));
  assign new_n231_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x44 | (new_n233_ & ~x01));
  assign new_n233_ = x04 & ~x77 & x78 & (x52 ? x22 : x14);
  assign z55 = new_n155_ | (new_n235_ & new_n187_ & ~x01 & ~x04);
  assign new_n235_ = ~x80 & ~x81 & ~x82 & x83 & x84;
  assign z56 = new_n237_ | (~new_n155_ & (~x00 | x01 | (~x77 & ~x78)));
  ...
  assign z59 = ~x01 & (new_n248_ | (x77 & (new_n247_ | (~new_n246_ & x78))));
  assign new_n246_ = (~x44 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n247_ = x40 & ((x44 & ~x79) | (x04 & x78 & x79));
  assign new_n248_ = ~x04 & x44 & ~x79;
  assign z60 = ~x01 & ((x79 & (new_n180_ | new_n251_)) | (x44 & ~new_n250_ & ~x79));
  assign new_n250_ = x04 & ~x78;
  assign new_n251_ = (~x81 ^ ~x84) & (~x77 ^ ~x78);
  assign z61 = (~x44 & ~x79) | (~x01 & x79 & ~new_n253_ & x80);
  ...
  assign new_n258_ = x04 & x44 & ~x77 & x78 & ~x79;
