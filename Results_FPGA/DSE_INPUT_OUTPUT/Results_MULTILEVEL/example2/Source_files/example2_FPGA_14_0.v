...
module FAU ( 
  ...
  assign z49 = (~x69 & ~x79) | (~x01 & ((new_n221_ & x04) | (new_n219_ & x69)));
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n223_ & x69) | (new_n219_ & x70));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n225_ & x69) | (new_n219_ & x71));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n227_ & x69) | (new_n219_ & x72));
  ...
  assign new_n240_ = x40 & ~x42 & x69 & ~x78 & ~x79;
  ...
  assign new_n255_ = x78 & ~x79 & x04 & x69;
  assign z63 = (~x69 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
