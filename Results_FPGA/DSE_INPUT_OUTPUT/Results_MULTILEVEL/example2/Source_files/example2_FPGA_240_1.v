...
module FAU ( 
  ...
  assign z31 = ~x01 & x79;
  assign z06 = z31 | (x24 & ~x40) | (x40 & x64);
  assign z07 = ~z31 & (x40 ? x63 : x25);
  assign z08 = ~z31 & (x40 ? x62 : x26);
  assign z09 = ~z31 & (x40 ? x61 : x27);
  assign z10 = ~z31 & (x40 ? x60 : x28);
  assign z11 = z31 | (x29 & ~x40) | (x40 & x59);
  assign z12 = ~z31 & (x40 ? x58 : x30);
  assign z13 = ~z31 & (x40 ? x57 : x31);
  assign z14 = ~z31 & (x40 ? x51 : x32);
  assign z15 = z31 | (x33 & ~x40) | (x40 & x50);
  assign z16 = ~z31 & (x40 ? x49 : x34);
  assign z17 = ~z31 & (x40 ? x48 : x35);
  assign z18 = z31 | (x36 & ~x40) | (x40 & x47);
  assign z19 = z31 | (x37 & ~x40) | (x40 & x46);
  assign z20 = z31 | (x38 & ~x40) | (x40 & x45);
