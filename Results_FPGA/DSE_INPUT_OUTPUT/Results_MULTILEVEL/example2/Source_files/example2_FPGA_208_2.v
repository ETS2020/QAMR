...
module FAU ( 
  ...
  assign z00 = (x40 & (x52 | (~new_n154_ & ~x01))) | (x06 & ~x40) | (x01 & ~x79);
  ...
  assign z59 = new_n245_ | (x77 & (new_n244_ | (~new_n243_ & x78)));
  assign new_n243_ = x79 & (x01 | ~x04 | x42 | ~x79 | (new_n180_ & new_n181_));
  assign new_n244_ = x40 & (~x79 | (~x01 & x04 & x78));
  assign new_n245_ = ~x79 & (x01 | ~x04);
  assign z60 = (~x01 & (new_n248_ | (new_n247_ & x04))) | (~x79 & (x01 | ~x04 | x78));
  assign new_n247_ = ~x42 & x77 & x78 & x79 & (~new_n180_ | ~new_n181_);
  ...
  assign z64 = ~x01 & ((new_n255_ & x78 & ~x79) | (x79 & ~new_n250_ & x83));
