...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | x65)) | (~x01 & (~x77 ^ x78));
  assign z02 = (x65 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & ~x65 & ~x01 & x52;
  ...
  assign z23 = ~x00 | x01 | (~x79 & (x65 | (~x04 & x05)));
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x77 & x78 & x79) | (~x65 & ~x79));
  ...
  assign z48 = ~x01 & ((x04 & new_n218_ & ~x65) | (new_n219_ & x68));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n219_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((x04 & new_n221_ & ~x65) | (new_n219_ & x69));
  ...
  assign z52 = ~x01 & ((x04 & new_n227_ & ~x65) | (new_n219_ & x72));
  ...
  assign z54 = ~x79 & (x65 | (new_n231_ & ~x01));
