...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    new_n184_, new_n186_, new_n192_, new_n196_, new_n197_, new_n198_,
    ...
    new_n250_, new_n252_, new_n254_, new_n257_, new_n258_, new_n260_;
  ...
  assign z51 = (~x01 & new_n227_ & x04) | (x79 & (x01 | (new_n223_ & x71)));
  ...
  assign z53 = ~x01 & ((new_n220_ & x73) | (new_n231_ & x04));
  ...
  assign new_n235_ = ~x01 & (~new_n236_ | ~x78 | x80 | x04 | ~x77);
  assign new_n236_ = ~x81 & ~x82 & x83 & x84;
  assign z56 = x01 ? ~x79 : ((x79 & ~new_n238_ & (~x77 | ~x78)) | ~x00 | (~x77 & ~x78));
  ...
  assign new_n244_ = x01 ? ~x79 : (x79 | (x04 & (x77 | ~x78)));
  assign z59 = ~x01 & ((x77 & (new_n246_ | new_n247_)) | (~x04 & ~x79));
  assign new_n246_ = x78 & (~x79 | (x04 & ~x42 & x79 & (~new_n180_ | ~new_n181_)));
  assign new_n247_ = x40 & (~x79 | (x04 & x78));
  assign z60 = (x79 & (new_n250_ | x01 | (~x01 & new_n249_ & x04))) | (~x01 & ~x79 & (~x04 | x78));
  ...
  assign z62 = (~x01 & x04 & x78 & (new_n179_ | ~x79)) | (x79 & (new_n254_ | x01));
  ...
  assign new_n257_ = ~new_n258_ & x83;
  assign new_n258_ = (x04 | ~x77 | ~x78) & ((~x77 ^ x78) | ((x81 | x84) & (x01 | ~x81 | ~x84)));
