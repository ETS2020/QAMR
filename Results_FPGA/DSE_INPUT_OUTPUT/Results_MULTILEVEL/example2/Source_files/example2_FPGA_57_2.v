...
module FAU ( 
  ...
  assign new_n221_ = x04 & x09 & ~x52 & ~x77 & x78 & ~x79;
  assign z50 = ~x01 & ((x04 & new_n223_ & ~x17) | (new_n219_ & x70));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n225_ & ~x17) | (new_n219_ & x71));
  ...
  assign z54 = ~x79 & (x17 | (new_n231_ & ~x01));
  ...
  assign new_n256_ = x78 & ~x79 & x04 & ~x17;
