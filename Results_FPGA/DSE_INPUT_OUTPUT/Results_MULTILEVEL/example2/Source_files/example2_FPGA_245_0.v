...
module FAU ( 
  ...
  assign z39 = (~x57 & ~x79) | (~x01 & ~x04 & new_n200_ & x57);
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & x57 & new_n215_ & ~x77));
  assign new_n215_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & x57));
  ...
  assign z53 = ~x01 & ((x04 & new_n229_ & x57) | (new_n219_ & x73));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x57 | (new_n231_ & ~x01));
  ...
  assign z63 = (~x57 & ~x79) | (~x01 & x79 & ~new_n253_ & x82);
  assign z64 = ~x01 & (new_n258_ | (x79 & ~new_n253_ & x83));
  assign new_n258_ = x04 & x57 & ~x77 & x78 & ~x79;
  assign z65 = (~x57 & ~x79) | (~x01 & new_n260_ & x79);
