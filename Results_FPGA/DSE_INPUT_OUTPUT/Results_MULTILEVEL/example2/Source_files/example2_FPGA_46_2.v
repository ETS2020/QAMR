...
module FAU ( 
  ...
  assign z59 = new_n245_ | (x77 & (new_n243_ | (~new_n244_ & x78)));
  assign new_n243_ = x40 & (~x79 | (new_n181_ & ~x01));
  assign new_n244_ = x79 & (x01 | ~x04 | x42 | ~x79 | (new_n178_ & new_n179_));
  assign new_n245_ = ~x79 & (x01 | ~x04);
  assign z60 = (~x01 & (new_n248_ | (new_n247_ & x04))) | (~x79 & (x01 | ~x04 | x78));
  assign new_n247_ = ~x42 & x77 & x78 & x79 & (~new_n178_ | ~new_n179_);
  assign new_n248_ = (x81 ^ x84) & (x77 ? (~x78 & x79) : x78);
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n253_ & x79) | (x04 & x78 & (new_n252_ | ~x79)));
  assign new_n252_ = ~x42 & x77 & (~new_n178_ | ~new_n179_);
  assign new_n253_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = x01 ? ~x79 : (x79 & ~new_n250_ & x82);
  assign z64 = (~x01 & x79 & ~new_n250_ & x83) | (~x79 & (new_n256_ | x01));
  assign new_n256_ = x04 & ~x77 & x78;
  assign z65 = new_n258_ & ~x01;
  assign new_n258_ = x79 & x84 & (x77 ? ((~x78 & x81) | (~x04 & (x78 | x81))) : (x78 & x81));
endmodule
