...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n200_, new_n201_, new_n211_, new_n216_, new_n217_, new_n219_,
  ...
  assign new_n154_ = x61 & ~x79;
  assign new_n155_ = ~x79 & (x61 | (x77 & x78));
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : ~x61);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (x61 | (~x01 & x52 & x78));
  assign z04 = (x61 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign new_n178_ = x04 & new_n179_ & ~x42;
  assign new_n179_ = x77 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n180_ = x81 & x82 & ~x83 & x84;
  assign new_n181_ = ((x75 & ~x77 & x78) | (x66 & x77 & ~x78)) & (~x81 ^ x84);
  assign new_n182_ = x04 & ~x61 & x78 & ~x79;
  ...
  assign z43 = x61 & (~x79 | (~x01 & ~x04 & new_n211_ & x77));
  assign new_n211_ = x78 & (((x82 ^ x84) & ((~x81 & (~x42 | ~x83)) | (x42 & x81 & x83))) | ((~x82 ^ x84) & ((x81 & (~x42 | ~x83)) | (x42 & ~x81 & x83))));
  ...
  assign z54 = ~x01 & x04 & new_n232_ & ~x61;
  ...
  assign z58 = ~x01 & (new_n239_ | new_n242_);
  assign new_n239_ = x77 & (new_n241_ | (x04 & x78 & ~new_n240_ & x79));
  assign new_n240_ = (x40 | ~x42) & (~new_n180_ | x42 | ~x43 | x74 | ~x80);
  assign new_n241_ = x40 & ~x42 & ~x61 & ~x78 & ~x79;
  assign new_n242_ = ~x61 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = (x61 & ~x79) | (~x01 & ((~new_n244_ & x77) | (~x04 & ~x61 & ~x79)));
  assign new_n244_ = (~x40 | (x79 & (~x04 | ~x78))) & (~x78 | ((~new_n245_ | ~x04) & (x61 | x79)));
  assign new_n245_ = ~x42 & x79 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((~x61 & ~new_n247_ & ~x79) | (x79 & (new_n178_ | new_n248_)));
  assign new_n247_ = x04 & ~x78;
  assign new_n248_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z61 = (x61 & ~x79) | (~x01 & x79 & ~new_n250_ & x80);
  assign new_n250_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (x61 | (new_n252_ & ~x01))) | (~x01 & (new_n178_ | (new_n253_ & x79)));
  assign new_n252_ = x04 & x78;
  assign new_n253_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (x61 & ~x79) | (~x01 & x79 & ~new_n250_ & x82);
  assign z64 = new_n154_ | (~new_n256_ & ~x01);
  assign new_n256_ = (~x79 | new_n250_ | ~x83) & (~x78 | x79 | ~x04 | x77);
