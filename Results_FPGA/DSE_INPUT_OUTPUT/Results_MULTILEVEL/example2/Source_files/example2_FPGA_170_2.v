// Benchmark "FAU" written by ABC on Mon Aug 17 18:26:34 2020
...
module FAU ( 
  ...
  assign z23 = ((~x00 | x01) & (~x73 | x79)) | (~x04 & x05 & ~x73 & ~x79);
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x73 & new_n215_ & ~x77));
  ...
  assign z53 = ~x01 & ((new_n219_ & x73) | (x04 & new_n229_ & ~x73));
  ...
  assign new_n257_ = x04 & ~x73 & x78 & ~x79;
  assign z63 = ~x01 & x79 & ~new_n253_ & x82;
  assign z64 = ~x01 & (new_n260_ | (x79 & ~new_n253_ & x83));
  assign new_n260_ = x04 & ~x73 & ~x77 & x78 & ~x79;
  assign z65 = (x73 & ~x79) | (~x01 & new_n262_ & x79);
