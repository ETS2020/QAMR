...
module FAU ( 
  ...
  assign z04 = (x02 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign z54 = ~x79 & (x02 | (new_n231_ & ~x01));
  ...
  assign z59 = ~x01 & (new_n246_ | (x77 & (new_n245_ | (new_n244_ & x04))));
  assign new_n244_ = x78 & x79 & (x40 | (~x42 & (~new_n181_ | ~new_n182_)));
  assign new_n245_ = ~x02 & ~x79 & (x40 | x78);
  assign new_n246_ = ~x02 & ~x04 & ~x79;
  ...
  assign z61 = (x02 & ~x79) | (~x01 & x79 & ~new_n252_ & x80);
