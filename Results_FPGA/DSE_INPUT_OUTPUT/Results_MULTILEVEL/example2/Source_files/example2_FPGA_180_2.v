...
module FAU ( 
  ...
  assign z04 = (x32 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign new_n182_ = x04 & ~x32 & x78 & ~x79;
  assign z23 = ~x00 | x01 | (~x79 & (x32 | (~x04 & x05)));
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((~x32 & ~x79) | (x77 & x78 & x79));
  ...
  assign z48 = ~x01 & ((x04 & new_n218_ & ~x32) | (new_n219_ & x68));
  ...
  assign z54 = ~x79 & (x32 | (new_n231_ & ~x01));
  ...
  assign new_n240_ = ~x32 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n241_ = ~x32 & ~x79 & (~x04 | (~x77 & x78));
  ...
  assign z61 = (x32 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  ...
  assign z63 = (x32 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
