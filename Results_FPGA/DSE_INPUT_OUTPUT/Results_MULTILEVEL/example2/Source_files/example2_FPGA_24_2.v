...
module FAU ( 
  ...
  assign z03 = ~x79 & (x55 | (~x01 & x52 & x78));
  assign z04 = (x55 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign z22 = (x55 & ~x79) | (~x01 & (new_n178_ | (~x41 & new_n181_ & x79)));
  ...
  assign z23 = ((~x00 | x01) & (~x55 | x79)) | (~x04 & x05 & ~x55 & ~x79);
  assign z24 = ~x01 & new_n184_ & ~x04;
  assign new_n184_ = x05 & ~x43 & ((~x55 & ~x79) | (x77 & x78 & x79));
  ...
  assign z35 = new_n154_ | (~x01 & ~x04 & new_n199_ & x53);
  ...
  assign z47 = ~x01 & ((new_n215_ & x77) | (x04 & ~x55 & new_n214_ & ~x77));
  ...
  assign z51 = new_n154_ | (~x01 & ((new_n218_ & x71) | (new_n224_ & x04)));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n226_ & ~x55) | (new_n218_ & x72));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n228_ & ~x55) | (new_n218_ & x73));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (x55 | (new_n230_ & ~x01));
  assign new_n230_ = x04 & ~x77 & x78 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & new_n232_ & ~x81;
  assign new_n232_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z56 = new_n234_ | (~new_n154_ & (~x00 | x01 | (~x77 & ~x78)));
  assign new_n234_ = x79 & (~new_n235_ | x76) & (~x77 | ~x78);
  assign new_n235_ = x81 ^ ~x84;
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = ~x01 & (new_n238_ | new_n241_);
  assign new_n238_ = x77 & (new_n240_ | (x04 & x78 & ~new_n239_ & x79));
  assign new_n239_ = (x40 | ~x42) & (~new_n180_ | x42 | ~x43 | x74 | ~x80);
  assign new_n240_ = x40 & ~x42 & ~x55 & ~x78 & ~x79;
  assign new_n241_ = ~x55 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = (x55 & ~x79) | (~x01 & ((~new_n243_ & x77) | (~x04 & ~x55 & ~x79)));
  assign new_n243_ = (~x40 | (x79 & (~x04 | ~x78))) & (~x78 | ((~new_n244_ | ~x04) & (x55 | x79)));
  assign new_n244_ = ~x42 & x79 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((~new_n246_ & x79) | (~x55 & ~x79 & (~x04 | x78)));
  assign new_n246_ = (new_n235_ | (x77 ^ ~x78)) & (~x04 | x42 | ~x77 | new_n179_ | ~x78);
  assign z61 = ~x01 & x79 & ~new_n248_ & x80;
  assign new_n248_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~new_n250_ & ~x01) | (~x79 & (x55 | (~x01 & x04 & x78)));
  assign new_n250_ = ~new_n251_ & (~x04 | x42 | ~x77 | new_n179_ | ~x78);
  assign new_n251_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (x55 & ~x79) | (~x01 & x79 & ~new_n248_ & x82);
  assign z64 = ~x01 & (new_n254_ | (x79 & ~new_n248_ & x83));
  assign new_n254_ = x04 & ~x55 & ~x77 & x78 & ~x79;
  assign z65 = new_n256_ & ~x01;
  assign new_n256_ = x79 & x84 & (x77 ? (x78 ? ~x04 : x81) : (x78 & x81));
endmodule
