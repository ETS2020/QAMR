...
module FAU ( 
  ...
  assign new_n204_ = ((~x82 ^ x84) | ((x81 | x83) & (~x79 | (x42 ? (~x81 | ~x83) : x81)))) & ((x82 ^ x84) | ((~x81 | x83) & (~x79 | (x42 ? (x81 | ~x83) : ~x81))));
  ...
  assign z47 = ~x01 & ((x77 & new_n218_ & ~x78) | (x04 & ~x77 & new_n217_ & x78));
  assign new_n217_ = ~x79 & x83 & (x52 ? x15 : x07);
  ...
  assign new_n243_ = x81 & x82 & ~x83 & x84;
  ...
  assign new_n252_ = ~x42 & x77 & x78 & x79 & (~new_n248_ | ~new_n243_);
  ...
  assign new_n258_ = (~x81 | (x77 ? x04 : ~x84)) & (~x04 | x42 | new_n181_ | ~x77);
  assign new_n259_ = x04 & x83 & (~x79 | (~x42 & x77));
  assign new_n260_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = (~x79 & ~x83) | (~x01 & x79 & ~new_n256_ & x82);
  assign z64 = ~x01 & ~new_n263_ & x83;
  assign new_n263_ = (new_n256_ | ~x79) & (~x78 | x79 | ~x04 | x77);
