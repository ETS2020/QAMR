...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n158_, new_n179_, new_n180_, new_n181_,
    new_n182_, new_n183_, new_n186_, new_n188_, new_n190_, new_n198_,
    new_n199_, new_n200_, new_n202_, new_n203_, new_n217_, new_n218_,
    new_n220_, new_n221_, new_n223_, new_n225_, new_n227_, new_n229_,
    new_n231_, new_n233_, new_n235_, new_n236_, new_n238_, new_n241_,
  ...
  assign new_n183_ = x04 & ~x44 & x78 & ~x79;
  ...
  assign z26 = x44 & (~x79 | (~x01 & new_n190_ & ~x04));
  assign new_n190_ = ~x42 & x77 & x78 & (x81 ? (~x82 ^ x84) : (~x82 ^ ~x84));
  ...
  assign z35 = new_n154_ | (~x01 & ~x04 & new_n202_ & x53);
  assign z36 = new_n154_ | (~x01 & ~x04 & new_n202_ & x54);
  ...
  assign z48 = new_n154_ | (~x01 & ((new_n221_ & x68) | (new_n220_ & x04)));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n221_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((x04 & new_n223_ & ~x44) | (new_n221_ & x69));
  ...
  assign z53 = ~x01 & ((x04 & new_n231_ & ~x44) | (new_n221_ & x73));
  assign new_n231_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n233_ & ~x44;
  ...
  assign z59 = ~x01 & (new_n249_ | (x77 & (new_n248_ | (~new_n247_ & x78))));
  assign new_n247_ = (x44 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n248_ = x40 & ((~x44 & ~x79) | (x04 & x78 & x79));
  assign new_n249_ = ~x04 & ~x44 & ~x79;
  ...
  assign new_n253_ = ~x79 & (x78 | (~x04 & ~x44));
  assign z61 = ~x01 & x79 & ~new_n255_ & x80;
  assign new_n255_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (x44 | (new_n257_ & ~x01))) | (~x01 & (new_n180_ | (new_n258_ & x79)));
  assign new_n257_ = x04 & x78;
  assign new_n258_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (x44 & ~x79) | (~x01 & x79 & ~new_n255_ & x82);
  assign z64 = ~x01 & (new_n261_ | (x79 & ~new_n255_ & x83));
  assign new_n261_ = x04 & ~x44 & ~x77 & x78 & ~x79;
  assign z65 = (x44 & ~x79) | (~x01 & new_n263_ & x79);
