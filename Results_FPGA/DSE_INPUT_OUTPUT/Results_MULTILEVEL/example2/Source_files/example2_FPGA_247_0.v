...
module FAU ( 
  ...
  assign z43 = (~x61 & ~x79) | (~x01 & ~x04 & new_n200_ & x61);
  ...
  assign z54 = ~x01 & x04 & new_n231_ & x61;
  ...
  assign new_n240_ = x40 & ~x42 & x61 & ~x78 & ~x79;
  assign new_n241_ = x61 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = (~x61 & ~x79) | (~x01 & ((~new_n243_ & x77) | (~x04 & x61 & ~x79)));
  assign new_n243_ = (~x40 | (x79 & (~x04 | ~x78))) & (~x78 | ((~new_n244_ | ~x04) & (~x61 | x79)));
  assign new_n244_ = ~x42 & x79 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((x61 & ~new_n246_ & ~x79) | (x79 & (new_n178_ | new_n247_)));
  assign new_n246_ = x04 & ~x78;
  assign new_n247_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z61 = (~x61 & ~x79) | (~x01 & x79 & ~new_n249_ & x80);
  assign new_n249_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (~x61 | (new_n251_ & ~x01))) | (~x01 & (new_n178_ | (new_n252_ & x79)));
  assign new_n251_ = x04 & x78;
  assign new_n252_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (~x61 & ~x79) | (~x01 & x79 & ~new_n249_ & x82);
