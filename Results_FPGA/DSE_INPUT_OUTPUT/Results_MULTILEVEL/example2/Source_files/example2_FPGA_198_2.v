...
module FAU ( 
  ...
  assign new_n154_ = x26 & ~x79;
  assign new_n155_ = ~x79 & (x26 | (x77 & x78));
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : ~x26);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (x26 | (~x01 & x52 & x78));
  ...
  assign z08 = x26 ? (x79 & (~x40 | x62)) : (x40 & x62);
  ...
  assign z23 = ((~x00 | x01) & (~x26 | x79)) | (~x04 & x05 & ~x26 & ~x79);
  assign z24 = ~x01 & ~x04 & x05 & ~x43 & (new_n185_ | new_n186_);
  assign new_n185_ = ~x26 & ~x79;
  ...
  assign z49 = new_n154_ | (~x01 & ((new_n222_ & x04) | (new_n220_ & x69)));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n224_ & ~x26) | (new_n220_ & x70));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = new_n154_ | (~x01 & ((new_n226_ & x04) | (new_n220_ & x71)));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n228_ & ~x26) | (new_n220_ & x72));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n230_ & ~x26) | (new_n220_ & x73));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (x26 | (new_n232_ & ~x01));
  ...
  assign new_n241_ = ~x26 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n242_ = ~x26 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((new_n185_ & ~x04) | (x77 & (new_n245_ | (new_n244_ & x04))));
  assign new_n244_ = x78 & x79 & (x40 | (~x42 & (~new_n181_ | ~new_n182_)));
  assign new_n245_ = ~x26 & ~x79 & (x40 | x78);
  assign z60 = ~x01 & ((~x26 & ~new_n248_ & ~x79) | (x79 & (new_n247_ | new_n249_)));
  assign new_n247_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n248_ = x04 & ~x78;
  assign new_n249_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z61 = (x26 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  ...
  assign new_n254_ = x04 & ~x26;
  assign z63 = (x26 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
  assign z64 = ~x01 & ((new_n257_ & x79) | (new_n254_ & ~x77 & x78 & ~x79));
  assign new_n257_ = ~new_n251_ & x83;
  assign z65 = (x26 & ~x79) | (~x01 & new_n259_ & x79);
