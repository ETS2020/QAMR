...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | x11)) | (~x01 & (~x77 ^ x78));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (x11 | (~x01 & x52 & x78));
  ...
  assign new_n182_ = x04 & ~x11 & x78 & ~x79;
  assign z23 = ~x00 | x01 | (~x79 & (x11 | (~x04 & x05)));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x11 & new_n215_ & ~x77));
  assign new_n215_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((x04 & new_n218_ & ~x11) | (new_n219_ & x68));
  ...
  assign z50 = ~x01 & ((x04 & new_n223_ & ~x11) | (new_n219_ & x70));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = new_n154_ | (~x01 & (new_n225_ | (new_n219_ & x71)));
  assign new_n225_ = x04 & x19 & x52 & ~x77 & x78 & ~x79;
  assign z52 = ~x01 & ((x04 & new_n227_ & ~x11) | (new_n219_ & x72));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n229_ & ~x11) | (new_n219_ & x73));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (x11 | (new_n231_ & ~x01));
  ...
  assign new_n240_ = ~x11 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n241_ = ~x11 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & ((x77 & (new_n244_ | (new_n243_ & x04))) | (new_n245_ & ~x04));
  assign new_n243_ = x78 & x79 & (x40 | (~x42 & (~new_n179_ | ~new_n180_)));
  assign new_n244_ = ~x11 & ~x79 & (x40 | x78);
  assign new_n245_ = ~x11 & ~x79;
  ...
  assign new_n249_ = ~x79 & (x78 | (~x04 & ~x11));
  assign z61 = ~x01 & x79 & ~new_n251_ & x80;
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (x11 | (new_n253_ & ~x01))) | (~x01 & (new_n178_ | (new_n254_ & x79)));
