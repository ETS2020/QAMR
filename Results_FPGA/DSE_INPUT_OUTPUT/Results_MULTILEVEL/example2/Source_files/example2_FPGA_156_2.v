...
module FAU ( 
  ...
  assign new_n227_ = new_n228_ & x04 & x12 & ~x20;
  assign new_n228_ = x78 & ~x79 & ~x52 & ~x77;
  assign z53 = new_n154_ | (~x01 & ((new_n219_ & x73) | (new_n230_ & x04)));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (x20 | (new_n232_ & ~x01));
  ...
  assign z60 = ~x01 & ((x79 & (new_n250_ | new_n252_)) | (~x20 & ~new_n251_ & ~x79));
  assign new_n250_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n251_ = x04 & ~x78;
  assign new_n252_ = (~x81 ^ ~x84) & (~x77 ^ ~x78);
  assign z61 = (x20 & ~x79) | (~x01 & x79 & ~new_n254_ & x80);
  assign new_n254_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (x20 | (new_n256_ & ~x01))) | (~x01 & (new_n250_ | (new_n257_ & x79)));
