...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n201_, new_n214_, new_n215_, new_n217_, new_n218_, new_n220_,
  ...
  assign z34 = x79 & (x01 | (~x04 & new_n198_ & x52));
  ...
  assign z36 = x79 & (x01 | (~x04 & new_n198_ & x54));
  assign z37 = ~x01 & ~x04 & new_n201_ & x55;
  assign z38 = x79 & (x01 | (~x04 & new_n198_ & x56));
  assign z39 = x79 & (x01 | (~x04 & new_n198_ & x57));
  assign z40 = x79 & (x01 | (~x04 & new_n198_ & x58));
  assign z41 = x79 & (x01 | (~x04 & new_n198_ & x59));
  assign z42 = ~x01 & ~x04 & new_n201_ & x60;
  assign z43 = ~x01 & ~x04 & new_n201_ & x61;
  assign z44 = x79 & (x01 | (~x04 & new_n198_ & x62));
  assign z45 = ~x01 & ~x04 & new_n201_ & x63;
  assign z46 = ~x01 & ~x04 & new_n201_ & x64;
  assign z47 = (~x01 & x04 & new_n214_ & ~x77) | (x79 & (x01 | (new_n215_ & x77)));
  assign new_n214_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n215_ = ~x78 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = (~x01 & new_n217_ & x04) | (x79 & (x01 | (new_n218_ & x68)));
  assign new_n217_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n218_ = x77 & ~x78 & (~x81 ^ x84);
  assign z49 = (~x01 & new_n220_ & x04) | (x79 & (x01 | (new_n218_ & x69)));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n222_ & x04) | (new_n223_ & x70));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign new_n223_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z51 = ~x01 & ((new_n223_ & x71) | (new_n225_ & x04));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = (~x01 & new_n227_ & x04) | (x79 & (x01 | (new_n218_ & x72)));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = (~x01 & new_n229_ & x04) | (x79 & (x01 | (new_n218_ & x73)));
  ...
  assign z56 = (x79 & ~new_n235_ & (~x77 | ~x78)) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n235_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = (x01 & x79) | (~x02 & x03 & x00 & ~x01);
  assign z58 = ~new_n241_ | (x77 & (new_n240_ | (x04 & new_n238_ & x78)));
  assign new_n238_ = x79 & ((~x40 & x42) | (new_n181_ & new_n239_ & ~x42 & x43));
  assign new_n239_ = ~x74 & x80;
  assign new_n240_ = ~x01 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n241_ = x01 ? ~x79 : (x79 | (x04 & (x77 | ~x78)));
  assign z59 = ~x01 & ((x77 & (new_n243_ | new_n244_)) | (~x04 & ~x79));
  assign new_n243_ = x78 & (~x79 | (x04 & ~x42 & x79 & (~new_n180_ | ~new_n181_)));
  assign new_n244_ = x40 & (~x79 | (x04 & x78));
  assign z60 = (x79 & (new_n247_ | x01 | (~x01 & new_n246_ & x04))) | (~x01 & ~x79 & (~x04 | x78));
  assign new_n246_ = ~x42 & x77 & x78 & (~new_n180_ | ~new_n181_);
  assign new_n247_ = (~x81 ^ ~x84) & (x77 ^ x78);
  assign z61 = x79 & (x01 | (~new_n249_ & x80));
  assign new_n249_ = (x04 | ~x77 | ~x78) & ((x77 ^ ~x78) | ((x81 | x84) & (x01 | ~x81 | ~x84)));
  ...
  assign new_n253_ = x82 & ((~x04 & x77 & x78) | ((~x77 ^ ~x78) & (x81 ^ ~x84)));
  assign z64 = (x79 & (new_n255_ | x01)) | (~x01 & x04 & ~x77 & x78 & ~x79);
  assign new_n255_ = ~new_n249_ & x83;
