...
module FAU ( 
  ...
  assign z55 = (~x79 & x80) | (new_n233_ & new_n234_ & ~x80 & ~x81);
  assign new_n233_ = ~x01 & ~x04 & x77 & x78 & x79;
  assign new_n234_ = ~x82 & x83 & x84;
  ...
  assign z58 = (~x79 & x80) | (~x01 & ((~new_n239_ & x77) | (~new_n243_ & ~x79)));
  assign new_n239_ = ~new_n242_ & (~x04 | ~x78 | (~new_n240_ & (~new_n182_ | ~new_n241_)));
  assign new_n240_ = ~x40 & x42 & x79;
  ...
  assign z60 = ~x01 & (x79 ? (new_n249_ | new_n250_) : new_n251_);
  assign new_n249_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n250_ = (x81 ^ x84) & (x77 ^ x78);
  assign new_n251_ = ~x80 & (~x04 | x78);
  assign z61 = x80 & (~x79 | (~new_n253_ & ~x01));
  assign new_n253_ = (x04 | ~x77 | ~x78) & ((x77 ^ ~x78) | ((x81 | x84) & (~x79 | ~x81 | ~x84)));
  assign z62 = ~x01 & ((x78 & (new_n255_ | new_n258_)) | (new_n257_ & x77 & ~x78));
  assign new_n255_ = x04 & ((~x80 & (~x79 | (~x42 & x77))) | (~x42 & x77 & ~new_n256_ & x79));
  assign new_n256_ = x43 & ~x74 & x81 & x82 & ~x83 & x84;
  assign new_n257_ = x79 & x81 & x84;
  assign new_n258_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign z63 = (~x01 & new_n260_ & x79) | (~x79 & x80);
  assign new_n260_ = x82 & ((~x04 & x77 & x78) | ((~x81 ^ x84) & (~x77 ^ ~x78)));
  assign z64 = new_n154_ | (~x01 & (new_n264_ | (~new_n262_ & x83)));
  assign new_n262_ = x77 ? (~new_n263_ & (x78 | ~x79 | (x81 ^ x84))) : (~x78 | ~x79 | (x81 ^ x84));
  assign new_n263_ = ~x04 & x78 & (x79 | (x80 & x84));
