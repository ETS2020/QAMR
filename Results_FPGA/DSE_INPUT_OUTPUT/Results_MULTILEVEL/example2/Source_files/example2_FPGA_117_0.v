...
module FAU ( 
  ...
  assign z21 = (x40 & x44) | (x39 & (x44 | (~x40 & x79)));
  ...
  assign z23 = ((x44 | x79) & (~x00 | x01)) | (~x04 & x05 & x44 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x44 & (~x79 | (x77 & x78))) | (x77 & x78 & x79));
  assign z25 = ~x01 & ~x04 & x05 & new_n187_ & ~x42;
  assign new_n187_ = x77 & x78 & x79 & (x81 ? (~x82 ^ x84) : (~x82 ^ ~x84));
  assign z26 = (~x44 & ~x79) | (~x01 & ~x04 & ~x42 & new_n187_ & x44);
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & x44 & new_n215_ & ~x77));
  ...
  assign z54 = ~x79 & (~x44 | (new_n231_ & ~x01));
  ...
  assign new_n244_ = (~x44 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n245_ = x40 & ((x44 & ~x79) | (x04 & x78 & x79));
  assign new_n246_ = ~x04 & x44 & ~x79;
  ...
  assign new_n250_ = ~x79 & (x78 | (~x04 & x44));
  ...
  assign new_n255_ = ~x79 & (~x44 | (~x01 & x04 & x78));
  assign new_n256_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (~x44 & ~x79) | (~x01 & x79 & ~new_n252_ & x82);
