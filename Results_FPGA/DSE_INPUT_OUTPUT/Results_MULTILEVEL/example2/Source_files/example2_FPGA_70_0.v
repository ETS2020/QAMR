...
module FAU ( 
  ...
  assign z48 = new_n154_ | (~x01 & (new_n218_ | (new_n219_ & x68)));
  assign new_n218_ = x04 & ~x77 & ~x79 & (x52 ? x16 : x08);
  assign new_n219_ = x77 & ~x78 & (x81 ^ ~x84);
  assign z49 = new_n154_ | (~x01 & (new_n221_ | (new_n219_ & x69)));
  assign new_n221_ = x04 & ~x77 & ~x79 & (x52 ? x17 : x09);
  assign z50 = new_n154_ | (~x01 & (new_n223_ | (new_n219_ & x70)));
  assign new_n223_ = x04 & ~x77 & ~x79 & (x52 ? x18 : x10);
  assign z51 = new_n154_ | (~x01 & (new_n225_ | (new_n219_ & x71)));
  ...
  assign z54 = ~x79 & (new_n232_ | ~x78);
  assign new_n232_ = ~x01 & x04 & ~x77 & (x52 ? x22 : x14);
  ...
  assign z59 = (~x78 & ~x79) | (~x01 & ((~x79 & (~x04 | x77)) | (x04 & x77 & ~new_n241_ & x78)));
  assign new_n241_ = ~x40 & (x42 | (new_n181_ & new_n182_));
  assign z60 = (~x78 & ~x79) | (~x01 & (new_n244_ | ~x79 | (new_n243_ & x04)));
  assign new_n243_ = ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n244_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = ~x01 & new_n246_ & x79;
  assign new_n246_ = x80 & (((~x81 ^ x84) & (~x77 ^ ~x78)) | (~x04 & x77 & x78));
  assign z62 = (~x78 & (new_n250_ | ~x79)) | (~x01 & ((x04 & ~x79) | (~new_n248_ & x78)));
  assign new_n248_ = ~new_n249_ & (~x04 | x42 | ~x77 | (new_n181_ & new_n182_));
  assign new_n249_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n250_ = ~x01 & x77 & x81 & x84;
  assign z63 = new_n154_ | (~x01 & ~new_n252_ & x82);
  assign new_n252_ = (x04 | ~x77 | ~x78 | ~x79) & ((x81 ^ x84) | (x77 ? x78 : (~x78 | ~x79)));
  assign z64 = (~x79 & (~x78 | (new_n254_ & ~x01))) | (~x01 & ~new_n255_ & x83);
  assign new_n254_ = x04 & ~x77;
  assign new_n255_ = (~x79 | (x77 ? (x78 ? x04 : (~x81 | ~x84)) : (~x78 | (x81 ^ x84)))) & (~x77 | x78 | x81 | x84);
