...
module FAU ( 
  ...
  assign z47 = ~x01 & ((x04 & new_n221_ & ~x77) | (x54 & new_n222_ & x77));
  ...
  assign new_n241_ = x54 & ((x77 & x78) | (~x76 & (x81 | ~x84) & (~x81 | x84)));
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = ~x01 & (new_n248_ | (x77 & (new_n247_ | (new_n244_ & x04))));
  assign new_n244_ = x54 & x78 & x79 & (new_n245_ | (new_n182_ & new_n246_));
