...
module FAU ( 
  ...
  assign new_n237_ = x04 & x78 & x79 & (new_n238_ | (new_n181_ & new_n239_));
  ...
  assign new_n243_ = x78 & (~x79 | (x04 & ~x42 & x79 & (~new_n180_ | ~new_n181_)));
  assign new_n244_ = x40 & (~x79 | (x04 & x78));
  assign z60 = ~x01 & (new_n247_ | (new_n246_ & x04) | (~x79 & (~x04 | x78)));
  assign new_n246_ = ~x42 & x77 & x78 & x79 & (~new_n180_ | ~new_n181_);
  ...
  assign z64 = ~x01 & ((new_n254_ & x78 & ~x79) | (x79 & ~new_n249_ & x83));
