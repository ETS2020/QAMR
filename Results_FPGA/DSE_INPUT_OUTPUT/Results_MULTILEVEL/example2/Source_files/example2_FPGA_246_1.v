...
module FAU ( 
  ...
  assign z31 = ~x01 & ~x04 & new_n191_ & ~x42;
  assign z32 = ~x01 & ~x04 & ~x42 & x49 & new_n192_ & x50;
  assign z33 = ~x01 & ~x04 & x49 & new_n202_ & x77;
  ...
  assign z50 = ~x01 & ((x49 & new_n226_ & x70) | (new_n230_ & x04));
  ...
  assign z53 = ~x01 & ((x49 & new_n226_ & x73) | (new_n236_ & x04));
  ...
  assign z60 = ~x01 & (new_n256_ | (x49 & (new_n181_ | new_n255_)));
  assign new_n255_ = (x81 ^ x84) & (x77 ? (~x78 & x79) : x78);
  assign new_n256_ = ~x79 & (~x04 | x78);
  assign z61 = x79 & (~x49 | (~x01 & ~new_n258_ & x80));
  assign new_n258_ = (~x78 | (x77 ? x04 : (x81 ^ x84))) & (~x77 | x78 | ((x81 | x84) & (~x49 | ~x81 | ~x84)));
  assign z62 = ~x01 & (new_n184_ | (x49 & (new_n181_ | new_n260_)));
  assign new_n260_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = x79 & (~x49 | (new_n262_ & ~x01));
  assign new_n262_ = x82 & (((~x81 ^ x84) & (~x77 ^ ~x78)) | (~x04 & x77 & x78));
  assign z64 = new_n162_ | (~x01 & ((~new_n264_ & x78) | (x77 & new_n265_ & ~x78)));
  assign new_n264_ = (x77 | (~new_n265_ & (~x04 | (x49 & x79)))) & (~x79 | ~x83 | x04 | ~x77);
  assign new_n265_ = x79 & x83 & ((~x81 & ~x84) | (x49 & x81 & x84));
