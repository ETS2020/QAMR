...
module FAU ( 
  ...
  assign z51 = ~x01 & ((x04 & new_n225_ & x68) | (new_n219_ & x71));
  ...
  assign z54 = ~x79 & (~x68 | (new_n231_ & ~x01));
  ...
  assign new_n244_ = (~x68 | x79) & (~x04 | x42 | (new_n181_ & new_n182_) | ~x79);
  assign new_n245_ = x40 & ((x68 & ~x79) | (x04 & x78 & x79));
  assign new_n246_ = ~x04 & x68 & ~x79;
  ...
  assign new_n256_ = x78 & ~x79 & x04 & x68;
  assign z63 = ~x01 & x79 & ~new_n252_ & x82;
  assign z64 = ~x01 & (new_n259_ | (x79 & ~new_n252_ & x83));
  assign new_n259_ = x04 & x68 & ~x77 & x78 & ~x79;
  assign z65 = (~x68 & ~x79) | (~x01 & new_n261_ & x79);
