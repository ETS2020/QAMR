...
module FAU ( 
  ...
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : x34);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (~x34 | (~x01 & x52 & x78));
  ...
  assign new_n182_ = x04 & x34 & x78 & ~x79;
  assign z23 = ((x34 | x79) & (~x00 | x01)) | (~x04 & x05 & x34 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x34 & ~x79) | (x77 & x78 & x79));
  ...
  assign z54 = ~x79 & (~x34 | (new_n231_ & ~x01));
  ...
  assign z60 = ~x01 & ((x79 & (new_n178_ | new_n249_)) | (x34 & ~new_n248_ & ~x79));
  assign new_n248_ = x04 & ~x78;
  assign new_n249_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z61 = (~x34 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (~x34 | (new_n253_ & ~x01))) | (~x01 & (new_n178_ | (new_n254_ & x79)));
  ...
  assign new_n257_ = x04 & x34 & ~x77 & x78 & ~x79;
