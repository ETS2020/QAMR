...
module FAU ( 
  ...
  assign z58 = (~x79 & x80) | (~x01 & ((~new_n238_ & x77) | (~new_n242_ & ~x79)));
  assign new_n238_ = ~new_n241_ & (~x04 | ~x78 | (~new_n239_ & (~new_n182_ | ~new_n240_)));
  assign new_n239_ = ~x40 & x42 & x79;
  ...
  assign z61 = x80 & (~x79 | (~new_n252_ & ~x01));
  assign new_n252_ = (x04 | ~x77 | ~x78) & (((x81 | x84) & (~x79 | ~x81 | ~x84)) | (x77 ^ ~x78));
  assign z62 = ~x01 & ((x78 & (new_n254_ | new_n257_)) | (new_n256_ & x77 & ~x78));
  assign new_n254_ = x04 & ((~x80 & (~x79 | (~x42 & x77))) | (~x42 & x77 & ~new_n255_ & x79));
  assign new_n255_ = x43 & ~x74 & x81 & x82 & ~x83 & x84;
  assign new_n256_ = x79 & x81 & x84;
  assign new_n257_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign z63 = (~x79 & x80) | (~x01 & x79 & ~new_n259_ & x82);
  assign new_n259_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z64 = ~x01 & (new_n261_ | (x79 & ~new_n259_ & x83));
