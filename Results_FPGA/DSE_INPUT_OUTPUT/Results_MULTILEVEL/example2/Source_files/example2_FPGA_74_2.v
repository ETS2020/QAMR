...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (x67 | (x77 & x78));
  assign z01 = (~x79 & (~x01 | x67)) | (~x01 & (~x77 ^ x78));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x67 & new_n215_ & ~x77));
  ...
  assign z51 = ~x01 & ((x04 & new_n225_ & ~x67) | (new_n219_ & x71));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n227_ & ~x67) | (new_n219_ & x72));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n229_ & ~x67) | (new_n219_ & x73));
  ...
  assign z59 = ~x01 & (new_n245_ | (x77 & (new_n244_ | (~new_n243_ & x78))));
  assign new_n243_ = (x67 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n244_ = x40 & ((~x67 & ~x79) | (x04 & x78 & x79));
  assign new_n245_ = ~x04 & ~x67 & ~x79;
  assign z60 = new_n154_ | (~x01 & (new_n248_ | new_n249_ | (new_n247_ & x04)));
  assign new_n247_ = ~x42 & x77 & x78 & x79 & (~new_n181_ | ~new_n182_);
  ...
  assign new_n255_ = x04 & ~x67 & x78 & ~x79;
  assign z63 = ~x01 & x79 & ~new_n251_ & x82;
  assign z64 = ~x01 & (new_n258_ | (x79 & ~new_n251_ & x83));
  assign new_n258_ = x04 & ~x67 & ~x77 & x78 & ~x79;
  assign z65 = (x67 & ~x79) | (~x01 & new_n260_ & x79);
