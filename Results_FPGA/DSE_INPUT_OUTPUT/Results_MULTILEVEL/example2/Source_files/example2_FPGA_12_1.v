...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n158_, new_n162_, new_n180_, new_n181_,
    ...
    new_n192_, new_n196_, new_n198_, new_n202_, new_n203_, new_n204_,
  ...
  assign z31 = ~x01 & ~x04 & new_n189_ & ~x42;
  assign z32 = ~x01 & ~x04 & ~x42 & x49 & new_n190_ & x50;
  assign z33 = x79 & (~x49 | (~x01 & new_n202_ & ~x04));
  ...
  assign z34 = ~x01 & ~x04 & x49 & new_n206_ & x52;
  assign new_n206_ = x77 & x78 & ~new_n207_ & x79;
  assign new_n207_ = ((~x82 ^ x84) | ((x81 | (x42 & x83)) & (~x42 | ~x81 | ~x83))) & ((x82 ^ x84) | ((~x81 | (x42 & x83)) & (~x42 | x81 | ~x83)));
  assign z35 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x53));
  assign new_n209_ = x77 & ~new_n207_ & x78;
  assign z36 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x54));
  assign z37 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x55));
  assign z38 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x56));
  assign z39 = ~x01 & ~x04 & x49 & new_n206_ & x57;
  assign z40 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x58));
  assign z41 = ~x01 & ~x04 & x49 & new_n206_ & x59;
  assign z42 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x60));
  assign z43 = ~x01 & ~x04 & x49 & new_n206_ & x61;
  assign z44 = ~x01 & ~x04 & x49 & new_n206_ & x62;
  assign z45 = ~x01 & ~x04 & x49 & new_n206_ & x63;
  assign z46 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x64));
  ...
  assign z49 = ~x01 & ((x49 & new_n226_ & x69) | (new_n228_ & x04));
