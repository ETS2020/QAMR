...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | x42)) | (~x01 & (~x77 ^ x78));
  ...
  assign z22 = ~x01 & (new_n178_ | (x04 & ~x42 & ~new_n180_ & x78));
  assign new_n178_ = ~x41 & new_n179_ & x79;
  assign new_n179_ = ((x75 & ~x77 & x78) | (x66 & x77 & ~x78)) & (~x81 ^ x84);
  assign new_n180_ = x79 & (~x77 | (new_n181_ & new_n182_));
  ...
  assign new_n185_ = x05 & ~x43 & ((~x42 & (~x79 | (x77 & x78))) | (x77 & x78 & x79));
  assign z25 = ~x01 & ~x04 & x05 & new_n187_ & ~x42;
  assign new_n187_ = x77 & x78 & x79 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z26 = ~x01 & ~x04 & ~x42 & new_n187_ & x44;
  assign z27 = (~x01 & ~x04 & ~x42 & new_n187_ & x45) | (x42 & ~x79);
  assign z28 = (~x01 & ~x04 & ~x42 & new_n187_ & x46) | (x42 & ~x79);
  assign z29 = ~x01 & ~x04 & ~x42 & new_n187_ & x47;
  assign z30 = (~x01 & ~x04 & ~x42 & new_n187_ & x48) | (x42 & ~x79);
  assign z31 = (~x01 & ~x04 & ~x42 & new_n187_ & x49) | (x42 & ~x79);
  assign z32 = (~x01 & ~x04 & ~x42 & new_n187_ & x50) | (x42 & ~x79);
  assign z33 = new_n154_ | (~x01 & new_n196_ & ~x04);
  assign new_n196_ = x77 & x78 & ((~new_n197_ & (~x82 ^ x84)) | (~new_n198_ & (x82 ^ x84)));
  assign new_n197_ = (~x05 | ~x42 | (~x81 ^ x83)) & (x42 | ~x51 | ~x79 | ~x81);
  assign new_n198_ = (~x05 | ~x42 | (x81 ^ x83)) & (~x79 | x81 | x42 | ~x51);
  assign z34 = new_n154_ | (~x01 & ~x04 & new_n200_ & x52);
  assign new_n200_ = x77 & ~new_n201_ & x78;
  assign new_n201_ = ((x82 ^ ~x84) | ((~x79 | x81 | (x42 & x83)) & (~x42 | ~x81 | ~x83))) & ((x82 ^ x84) | ((~x79 | ~x81 | (x42 & x83)) & (~x42 | x81 | ~x83)));
  ...
  assign z47 = ~x01 & ((x04 & ~x42 & new_n217_ & ~x77) | (new_n218_ & x77));
  ...
  assign z49 = ~x01 & ((x04 & new_n223_ & ~x42) | (new_n221_ & x69));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n225_ & ~x42) | (new_n221_ & x70));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n227_ & ~x42) | (new_n221_ & x71));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = new_n154_ | (~x01 & ((new_n229_ & x04) | (new_n221_ & x72)));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = new_n154_ | (~x01 & ((new_n231_ & x04) | (new_n221_ & x73)));
  assign new_n231_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (x42 | (new_n233_ & ~x01));
  ...
  assign new_n244_ = ~x42 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & (new_n248_ | (x77 & (new_n246_ | new_n247_)));
  assign new_n246_ = ~x42 & x78 & (~x79 | (x04 & (~new_n181_ | ~new_n182_)));
  assign new_n247_ = x40 & ((x04 & x78 & x79) | (~x42 & ~x79));
  assign new_n248_ = ~x04 & ~x42 & ~x79;
  assign z60 = new_n154_ | (~x01 & (new_n251_ | new_n250_ | new_n252_));
  assign new_n250_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n251_ = (~x81 ^ ~x84) & (x77 ? (~x78 & x79) : x78);
  assign new_n252_ = ~x79 & (x78 | (~x04 & ~x42));
  assign z61 = (x42 & ~x79) | (~x01 & x79 & ~new_n254_ & x80);
  assign new_n254_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n256_ | (x04 & ~x42 & ~new_n180_ & x78));
  ...
  assign new_n259_ = x04 & ~x42 & ~x77 & x78 & ~x79;
  assign z65 = (x42 & ~x79) | (~x01 & new_n261_ & x79);
