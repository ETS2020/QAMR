...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n200_, new_n205_, new_n215_, new_n223_, new_n224_, new_n226_,
  ...
  assign z38 = ~x01 & (~x79 | (~x04 & new_n205_ & x56));
  ...
  assign z43 = ~x01 & (~x79 | (~x04 & new_n205_ & x61));
  assign z44 = ~x01 & ~x04 & new_n199_ & x62;
  assign z45 = ~x01 & (~x79 | (~x04 & new_n205_ & x63));
  assign z46 = ~x01 & (~x79 | (~x04 & new_n205_ & x64));
  ...
  assign new_n236_ = ((x77 ^ ~x78) | ((x81 | x84) & (~x79 | ~x81 | ~x84))) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & x79 & (new_n178_ | new_n238_);
  assign new_n238_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = ~x01 & (new_n240_ | ~x79);
  assign new_n240_ = x82 & ((~x04 & x77 & x78) | (~new_n177_ & (x77 ^ x78)));
