...
module FAU ( 
  ...
  assign new_n154_ = ~x54 & ~x79;
  assign new_n155_ = ~x79 & (~x54 | (x77 & x78));
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : x54);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (~x54 | (~x01 & x52 & x78));
  ...
  assign z23 = (~x79 & (~x54 | (~x04 & x05))) | ~x00 | x01;
  ...
  assign z52 = ~x01 & ((x04 & new_n227_ & x54) | (new_n219_ & x72));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n229_ & x54) | (new_n219_ & x73));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x54 | (new_n231_ & ~x01));
  ...
  assign new_n240_ = x40 & ~x42 & x54 & ~x78 & ~x79;
  assign new_n241_ = x54 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & (new_n245_ | (x77 & (new_n244_ | (~new_n243_ & x78))));
  assign new_n243_ = (~x54 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n244_ = x40 & ((x54 & ~x79) | (x04 & x78 & x79));
  assign new_n245_ = ~x04 & x54 & ~x79;
  ...
  assign new_n249_ = ~x79 & (x78 | (~x04 & x54));
  assign z61 = ~x01 & x79 & ~new_n251_ & x80;
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = new_n254_ | (~x01 & (new_n255_ | (x04 & new_n253_ & ~x42)));
  assign new_n253_ = x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n254_ = ~x79 & (~x54 | (~x01 & x04 & x78));
  assign new_n255_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (~x54 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
  assign z64 = new_n154_ | (~new_n258_ & ~x01);
  assign new_n258_ = (~x79 | new_n251_ | ~x83) & (~x78 | x79 | ~x04 | x77);
  assign z65 = (~x54 & ~x79) | (~x01 & new_n260_ & x79);
