...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | ~x50)) | (~x01 & (~x77 ^ x78));
  ...
  assign z15 = (x40 & x50) | (x33 & (x50 | (~x40 & x79)));
  ...
  assign z32 = (~x50 & ~x79) | (~x01 & ~x04 & ~x42 & new_n187_ & x50);
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & x50 & new_n215_ & ~x77));
  assign new_n215_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & x50));
  ...
  assign z54 = ~x79 & (~x50 | (new_n231_ & ~x01));
  ...
  assign new_n245_ = (~x50 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n246_ = x40 & ((x50 & ~x79) | (x04 & x78 & x79));
  assign new_n247_ = ~x04 & x50 & ~x79;
  assign z60 = ~x01 & ((x79 & (new_n249_ | new_n251_)) | (x50 & ~new_n250_ & ~x79));
  assign new_n249_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n250_ = x04 & ~x78;
  assign new_n251_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = (~x50 & ~x79) | (~x01 & x79 & ~new_n253_ & x80);
  ...
  assign new_n256_ = x04 & x50;
  assign z63 = (~x50 & ~x79) | (~x01 & x79 & ~new_n253_ & x82);
