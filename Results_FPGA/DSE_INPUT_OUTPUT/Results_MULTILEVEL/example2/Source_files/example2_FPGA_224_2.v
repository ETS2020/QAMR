...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | x27)) | (~x01 & (~x77 ^ x78));
  assign z02 = (x27 & ~x79) | (~x01 & ~new_n158_ & x79);
  ...
  assign z23 = ((~x00 | x01) & (~x27 | x79)) | (~x04 & x05 & ~x27 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((~x27 & ~x79) | (x77 & x78 & x79));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x27 & new_n215_ & ~x77));
  ...
  assign z59 = new_n154_ | (~x01 & (new_n247_ | (x77 & (new_n244_ | new_n246_))));
