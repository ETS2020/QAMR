...
module FAU ( 
  ...
  assign new_n182_ = x04 & x46 & x78 & ~x79;
  assign z23 = ~x00 | x01 | (~x79 & (~x46 | (~x04 & x05)));
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x46 & ~x79) | (x77 & x78 & x79));
  ...
  assign new_n238_ = x78 & x79 & ((~x40 & x42) | (new_n180_ & new_n239_));
  assign new_n239_ = ~x42 & x43 & ~x74 & x80;
  assign new_n240_ = x40 & ~x42 & x46 & ~x78 & ~x79;
  assign new_n241_ = x46 & ~x79 & (~x04 | (~x77 & x78));
  ...
  assign z61 = (~x46 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
