...
module FAU ( 
  ...
  assign z34 = x79 & (x65 | (~x01 & ~x04 & new_n204_ & x52));
  assign new_n204_ = x77 & ~new_n205_ & x78;
  assign new_n205_ = ((~x82 ^ x84) | ((x81 | (x42 & x83)) & (~x42 | ~x81 | ~x83))) & ((x82 ^ x84) | ((~x81 | (x42 & x83)) & (~x42 | x81 | ~x83)));
  assign z35 = x79 & (x65 | (~x01 & ~x04 & new_n204_ & x53));
  assign z36 = x79 & (x65 | (~x01 & ~x04 & new_n204_ & x54));
  assign z37 = x79 & (x65 | (~x01 & ~x04 & new_n204_ & x55));
  assign z38 = ~x01 & ~x04 & new_n210_ & x56;
  assign new_n210_ = ~x65 & x77 & x78 & ~new_n205_ & x79;
  assign z39 = x79 & (x65 | (~x01 & ~x04 & new_n204_ & x57));
  assign z40 = x79 & (x65 | (~x01 & ~x04 & new_n204_ & x58));
  assign z41 = ~x01 & ~x04 & new_n210_ & x59;
  assign z42 = ~x01 & ~x04 & new_n210_ & x60;
  assign z43 = x79 & (x65 | (~x01 & ~x04 & new_n204_ & x61));
  assign z44 = x79 & (x65 | (~x01 & ~x04 & new_n204_ & x62));
  ...
  assign z48 = ~x01 & ((new_n223_ & x04) | (~x65 & new_n224_ & x68));
  ...
  assign z51 = ~x01 & ((new_n230_ & x04) | (~x65 & new_n224_ & x71));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n232_ & x04) | (~x65 & new_n224_ & x72));
  assign new_n232_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n234_ & x04) | (~x65 & new_n224_ & x73));
  ...
  assign new_n238_ = x79 & x78 & x77 & ~x65 & ~x01 & ~x04;
  assign z56 = (~new_n240_ & (~x65 | ~x79)) | (~x65 & new_n241_ & x79);
  ...
  assign new_n244_ = ~x65 & x78 & x79 & (new_n245_ | (new_n182_ & new_n246_));
  ...
  assign new_n250_ = x79 & (~x04 | x42 | x65 | (new_n181_ & new_n182_));
  assign new_n251_ = x40 & (~x79 | (x04 & ~x65 & x78));
  assign new_n252_ = ~x04 & ~x79;
  assign z60 = new_n154_ | (~x01 & (new_n255_ | new_n256_ | (new_n254_ & x04)));
  assign new_n254_ = ~x42 & ~x65 & x77 & x78 & (~new_n181_ | ~new_n182_);
  ...
  assign z62 = (x65 & x79) | (~x01 & ((new_n260_ & x04) | (new_n261_ & x79)));
  assign new_n260_ = x78 & (~x79 | (~x42 & x77 & (~new_n181_ | ~new_n182_)));
  assign new_n261_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = x79 & (x65 | (~x01 & ~new_n258_ & x82));
  assign z64 = ~x01 & (new_n264_ | (~x65 & x79 & ~new_n258_ & x83));
