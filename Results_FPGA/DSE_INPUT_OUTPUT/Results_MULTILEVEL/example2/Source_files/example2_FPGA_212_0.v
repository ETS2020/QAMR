...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x22 | (x77 & x78));
  assign z01 = (~x79 & (~x01 | ~x22)) | (~x01 & (~x77 ^ x78));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (~x22 | (~x01 & x52 & x78));
  assign z04 = (~x22 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign z23 = ((x22 | x79) & (~x00 | x01)) | (~x04 & x05 & x22 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x22 & ~x79) | (x77 & x78 & x79));
  ...
  assign z54 = ~x79 & (new_n231_ | ~x22);
  assign new_n231_ = ~x01 & x04 & ~x77 & x78 & (x14 | x52);
  ...
  assign z59 = ~x01 & ((x77 & (new_n246_ | (new_n244_ & x04))) | (new_n245_ & ~x04));
  assign new_n244_ = x78 & x79 & (x40 | (~x42 & (~new_n181_ | ~new_n182_)));
  assign new_n245_ = x22 & ~x79;
  assign new_n246_ = x22 & ~x79 & (x40 | x78);
  assign z60 = ~x01 & ((x79 & (new_n248_ | new_n250_)) | (x22 & ~new_n249_ & ~x79));
  ...
  assign z62 = (~x79 & (~x22 | (new_n254_ & ~x01))) | (~x01 & (new_n248_ | (new_n255_ & x79)));
