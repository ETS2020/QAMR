...
module FAU ( 
  ...
  assign z01 = ~x01 & (~x79 | (x69 & (~x77 ^ x78)));
  ...
  assign z27 = x79 & (~x69 | (~x01 & ~x04 & new_n192_ & ~x42));
  assign new_n192_ = x45 & x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z28 = x79 & (~x69 | (~x01 & ~x04 & new_n194_ & ~x42));
  assign new_n194_ = x46 & x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z29 = x79 & (~x69 | (~x01 & ~x04 & new_n196_ & ~x42));
  ...
  assign z39 = x79 & (~x69 | (~x01 & ~x04 & new_n210_ & x57));
  assign z40 = ~x01 & ~x04 & new_n205_ & x58;
  assign z41 = x79 & (~x69 | (~x01 & ~x04 & new_n210_ & x59));
  assign z42 = ~x01 & ~x04 & new_n205_ & x60;
  assign z43 = ~x01 & ~x04 & new_n205_ & x61;
  assign z44 = x79 & (~x69 | (~x01 & ~x04 & new_n210_ & x62));
  assign z45 = x79 & (~x69 | (~x01 & ~x04 & new_n210_ & x63));
  assign z46 = x79 & (~x69 | (~x01 & ~x04 & new_n210_ & x64));
  assign z47 = ~x01 & ((x04 & new_n221_ & ~x77) | (x69 & new_n222_ & x77));
  ...
  assign z49 = new_n154_ | (~x01 & (new_n225_ | (new_n227_ & x04)));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n229_ & x04) | (x69 & new_n225_ & x70));
  ...
  assign z52 = ~x01 & ((new_n233_ & x04) | (x69 & new_n225_ & x72));
  assign new_n233_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n235_ & x04) | (x69 & new_n225_ & x73));
  ...
  assign new_n239_ = x79 & x78 & x77 & x69 & ~x01 & ~x04;
  assign z56 = (~new_n241_ & (x69 | ~x79)) | (x69 & new_n242_ & x79);
  ...
  assign new_n245_ = x69 & x78 & x79 & (new_n246_ | (new_n183_ & new_n247_));
  ...
  assign z61 = ~x01 & x69 & x79 & ~new_n259_ & x80;
  assign new_n259_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n160_ & x04) | (x69 & (new_n262_ | (new_n261_ & x04))));
  assign new_n261_ = ~x42 & x77 & x78 & (~new_n182_ | ~new_n183_);
  assign new_n262_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = x79 & (~x69 | (new_n264_ & ~x01));
  assign new_n264_ = x82 & ((~x04 & x77 & x78) | ((~x81 ^ x84) & (x77 ? (~x04 | ~x78) : x78)));
  assign z64 = ~x01 & (new_n266_ | (new_n160_ & x04 & ~x77));
  assign new_n266_ = x69 & x79 & ~new_n259_ & x83;
  assign z65 = ~x01 & new_n268_ & x69;
