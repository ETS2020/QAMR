...
module FAU ( 
  ...
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : ~x69);
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x69 & new_n215_ & ~x77));
  ...
  assign z49 = (x69 & ~x79) | (~x01 & ((new_n221_ & x04) | (new_n222_ & x69)));
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign new_n222_ = x77 & ~x78 & (~x81 ^ x84);
  assign z50 = ~x01 & ((x04 & new_n224_ & ~x69) | (new_n219_ & x70));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n226_ & ~x69) | (new_n219_ & x71));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n228_ & ~x69) | (new_n219_ & x72));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n230_ & ~x69) | (new_n219_ & x73));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n232_ & ~x69;
  ...
  assign new_n241_ = x40 & ~x42 & ~x69 & ~x78 & ~x79;
  assign new_n242_ = ~x69 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = new_n154_ | (~x01 & (new_n246_ | (x77 & (new_n244_ | new_n245_))));
  assign new_n244_ = x78 & (~x79 | (x04 & ~x42 & x79 & (~new_n181_ | ~new_n182_)));
  assign new_n245_ = x40 & (~x79 | (x04 & x78));
  assign new_n246_ = ~x04 & ~x79;
  assign z60 = new_n154_ | (~x01 & (new_n249_ | new_n250_ | (new_n248_ & x04)));
  assign new_n248_ = ~x42 & x77 & x78 & x79 & (~new_n181_ | ~new_n182_);
  ...
  assign z62 = ~x01 & (new_n256_ | (x79 & (new_n255_ | (new_n254_ & x04))));
  assign new_n254_ = ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n255_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign new_n256_ = x04 & ~x69 & x78 & ~x79;
  assign z63 = (x69 & ~x79) | (~x01 & x79 & ~new_n252_ & x82);
  assign z64 = ~x01 & (new_n259_ | (x79 & ~new_n252_ & x83));
  assign new_n259_ = x04 & ~x69 & ~x77 & x78 & ~x79;
