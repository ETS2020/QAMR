// Benchmark "FAU" written by ABC on Mon Aug 17 18:26:14 2020
...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x50 | (x77 & x78));
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : x50);
  assign z02 = (~x50 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & (~x50 | (~x01 & x52 & x78));
  assign z04 = (~x50 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign z15 = (~x50 & ~x79) | (x40 & x50) | (x33 & ~x40);
  ...
  assign new_n183_ = x78 & ~x79 & x04 & x50;
  assign z23 = ((~x00 | x01) & (x50 | x79)) | (~x04 & x05 & x50 & ~x79);
  ...
  assign z48 = ~x01 & ((new_n220_ & x68) | (x04 & new_n219_ & x50));
  assign new_n219_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n220_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((x04 & new_n222_ & x50) | (new_n220_ & x69));
  ...
  assign z52 = ~x01 & ((x04 & new_n228_ & x50) | (new_n220_ & x72));
  ...
  assign z54 = ~x79 & (~x50 | (new_n232_ & ~x01));
  ...
  assign new_n246_ = (~x50 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n247_ = x40 & ((x50 & ~x79) | (x04 & x78 & x79));
  assign new_n248_ = ~x04 & x50 & ~x79;
  ...
  assign new_n252_ = ~x79 & (x78 | (~x04 & x50));
  assign z61 = ~x01 & x79 & ~new_n254_ & x80;
  assign new_n254_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (~x50 | (new_n256_ & ~x01))) | (~x01 & (new_n180_ | (new_n257_ & x79)));
  ...
  assign new_n260_ = x04 & x50 & ~x77 & x78 & ~x79;
  assign z65 = (~x50 & ~x79) | (~x01 & new_n262_ & x79);
