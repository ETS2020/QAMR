...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | ~x45)) | (~x01 & (~x77 ^ x78));
  assign z02 = (~x45 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & x52 & ~x01 & x45;
  ...
  assign new_n185_ = x05 & ~x43 & ((x77 & x78 & x79) | (x45 & ~x79));
  ...
  assign z27 = (~x45 & ~x79) | (~x01 & ~x04 & ~x42 & new_n187_ & x45);
  ...
  assign z49 = ~x01 & ((x04 & new_n221_ & x45) | (new_n219_ & x69));
  ...
  assign z51 = ~x01 & ((x04 & new_n225_ & x45) | (new_n219_ & x71));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n227_ & x45) | (new_n219_ & x72));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n229_ & x45) | (new_n219_ & x73));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x45 | (new_n231_ & ~x01));
  ...
  assign z58 = new_n154_ | (~x01 & (new_n242_ | (x77 & (new_n238_ | new_n241_))));
  ...
  assign new_n244_ = (~x45 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n245_ = x40 & ((x45 & ~x79) | (x04 & x78 & x79));
  assign new_n246_ = ~x04 & x45 & ~x79;
  assign z60 = ~x01 & ((x79 & (new_n248_ | new_n250_)) | (x45 & ~new_n249_ & ~x79));
  assign new_n248_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n249_ = x04 & ~x78;
  assign new_n250_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = (~x45 & ~x79) | (~x01 & x79 & ~new_n252_ & x80);
  assign new_n252_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x79 & (new_n248_ | new_n254_)) | (new_n255_ & x78 & ~x79));
  assign new_n254_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign new_n255_ = x04 & x45;
  assign z63 = ~x01 & x79 & ~new_n252_ & x82;
  assign z64 = new_n154_ | (~new_n258_ & ~x01);
  assign new_n258_ = (~x79 | new_n252_ | ~x83) & (~x78 | x79 | ~x04 | x77);
  assign z65 = (~x45 & ~x79) | (~x01 & new_n260_ & x79);
