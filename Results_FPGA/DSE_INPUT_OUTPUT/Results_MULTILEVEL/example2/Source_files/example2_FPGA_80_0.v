...
module FAU ( 
  ...
  assign new_n185_ = x05 & ~x43 & ((x63 & ~x79) | (x77 & x78 & x79));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & x63 & new_n215_ & ~x77));
  assign new_n215_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & x63));
  ...
  assign z50 = ~x01 & ((x04 & new_n223_ & x63) | (new_n219_ & x70));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n225_ & x63) | (new_n219_ & x71));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n227_ & x63) | (new_n219_ & x72));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n229_ & x63) | (new_n219_ & x73));
  ...
  assign new_n244_ = (~x63 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n245_ = x40 & ((x63 & ~x79) | (x04 & x78 & x79));
  assign new_n246_ = ~x04 & x63 & ~x79;
  ...
  assign new_n250_ = ~x79 & (x78 | (~x04 & x63));
  ...
  assign new_n255_ = ~x79 & (~x63 | (~x01 & x04 & x78));
