...
module FAU ( 
  ...
  assign z01 = ~x01 & (x79 ? (~x77 ^ x78) : ~x29);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (x29 | (~x01 & x52 & x78));
  assign z04 = (x29 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign new_n182_ = x04 & ~x29 & x78 & ~x79;
  assign z23 = ((~x00 | x01) & (~x29 | x79)) | (~x04 & x05 & ~x29 & ~x79);
  ...
  assign new_n244_ = x78 & x79 & (x40 | (~x42 & (~new_n179_ | ~new_n180_)));
  assign new_n245_ = ~x29 & ~x79;
  assign new_n246_ = ~x29 & ~x79 & (x40 | x78);
  assign z60 = ~x01 & ((x79 & (new_n178_ | new_n249_)) | (~x29 & ~new_n248_ & ~x79));
