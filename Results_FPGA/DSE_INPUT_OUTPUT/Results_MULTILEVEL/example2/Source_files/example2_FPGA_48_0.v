...
module FAU ( 
  ...
  assign z04 = (~x15 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & x15 & new_n215_ & ~x77));
  assign new_n215_ = x78 & ~x79 & (x07 | x52);
  assign new_n216_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & x15));
  ...
  assign z54 = ~x79 & (~x15 | (new_n231_ & ~x01));
  ...
  assign new_n245_ = x15 & ~x79;
  assign new_n246_ = x15 & ~x79 & (x40 | x78);
  ...
  assign new_n256_ = x78 & ~x79 & x04 & x15;
