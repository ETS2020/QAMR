...
module FAU ( 
  ...
  assign z27 = ~x01 & x79;
  assign z06 = ~z27 & (x40 ? x64 : x24);
  assign z07 = z27 | (x40 & x63) | (x25 & ~x40);
  assign z08 = z27 | (x40 & x62) | (x26 & ~x40);
  assign z09 = z27 | (x40 & x61) | (x27 & ~x40);
  assign z10 = z27 | (x40 & x60) | (x28 & ~x40);
  assign z11 = z27 | (x40 & x59) | (x29 & ~x40);
  assign z12 = z27 | (x40 & x58) | (x30 & ~x40);
  assign z13 = ~z27 & (x40 ? x57 : x31);
  assign z14 = z27 | (x40 & x51) | (x32 & ~x40);
  assign z15 = ~z27 & (x40 ? x50 : x33);
  assign z16 = ~z27 & (x40 ? x49 : x34);
  assign z17 = z27 | (x40 & x48) | (x35 & ~x40);
  assign z18 = ~z27 & (x40 ? x47 : x36);
  assign z19 = ~z27 & (x40 ? x46 : x37);
  assign z20 = z27 | (x40 & x45) | (x38 & ~x40);
  assign z21 = ~z27 & (x40 ? x44 : x39);
