...
module FAU ( 
  ...
  assign z01 = (~x72 & x79) | (~x01 & ((x77 & x78) | ~x79 | (~x77 & ~x78)));
  ...
  assign z23 = ((x72 | ~x79) & (~x00 | x01)) | (~x04 & x05 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & (~x79 | (x72 & x77 & x78));
  ...
  assign z28 = x79 & (~x72 | (~x01 & ~x04 & new_n194_ & ~x42));
  ...
  assign z32 = x79 & (~x72 | (~x01 & ~x04 & new_n200_ & ~x42));
  ...
  assign new_n206_ = x72 & x77 & x78 & ~new_n207_ & x79;
  ...
  assign z39 = x79 & (~x72 | (~x01 & ~x04 & new_n213_ & x57));
  assign new_n213_ = x77 & ~new_n207_ & x78;
  assign z40 = ~x01 & ~x04 & new_n206_ & x58;
  assign z41 = ~x01 & ~x04 & new_n206_ & x59;
  assign z42 = ~x01 & ~x04 & new_n206_ & x60;
  assign z43 = x79 & (~x72 | (~x01 & ~x04 & new_n213_ & x61));
  assign z44 = ~x01 & ~x04 & new_n206_ & x62;
  assign z45 = x79 & (~x72 | (~x01 & ~x04 & new_n213_ & x63));
  ...
  assign z51 = ~x01 & ((new_n232_ & x04) | (x71 & new_n226_ & x72));
  assign new_n232_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n226_ & x72) | (new_n234_ & x04));
  assign new_n234_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n236_ & x04) | (x72 & new_n226_ & x73));
  ...
  assign new_n240_ = x79 & x78 & x77 & x72 & ~x01 & ~x04;
  assign z56 = (~new_n242_ & x79) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n242_ = x72 & ((x77 & x78) | (~x76 & (x81 | ~x84) & (~x81 | x84)));
  assign z57 = new_n154_ | (x00 & ~x01 & ~x02 & x03);
  assign z58 = ~x01 & (new_n249_ | (x77 & (new_n248_ | (new_n245_ & x04))));
  assign new_n245_ = x72 & x78 & x79 & (new_n246_ | (new_n182_ & new_n247_));
  ...
  assign z63 = x79 & (~x72 | (~x01 & ~new_n259_ & x82));
  assign z64 = ~x01 & (new_n264_ | (x72 & x79 & ~new_n259_ & x83));
  assign new_n264_ = x78 & ~x79 & x04 & ~x77;
  assign z65 = ~x01 & new_n266_ & x72;
