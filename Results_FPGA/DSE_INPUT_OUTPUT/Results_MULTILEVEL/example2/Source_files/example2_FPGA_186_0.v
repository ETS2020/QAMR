...
module FAU ( 
  ...
  assign new_n183_ = x78 & ~x79 & x04 & x56;
  assign z23 = ((x56 | x79) & (~x00 | x01)) | (~x04 & x05 & x56 & ~x79);
  ...
  assign z47 = ~x01 & ((new_n217_ & x77) | (x04 & x56 & new_n216_ & ~x77));
  ...
  assign z49 = ~x01 & ((x04 & new_n222_ & x56) | (new_n220_ & x69));
  ...
  assign z53 = ~x01 & ((x04 & new_n230_ & x56) | (new_n220_ & x73));
  ...
  assign z56 = new_n237_ | (~new_n154_ & (~x00 | x01 | (~x77 & ~x78)));
  ...
  assign new_n242_ = x40 & ~x42 & x56 & ~x78 & ~x79;
  assign new_n243_ = x56 & ~x79 & (~x04 | (~x77 & x78));
  ...
  assign z60 = ~x01 & ((x79 & (new_n180_ | new_n250_)) | (x56 & ~new_n249_ & ~x79));
  ...
  assign z62 = ~x01 & (new_n183_ | (x79 & (new_n180_ | new_n254_)));
  assign new_n254_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = ~x01 & x79 & ~new_n252_ & x82;
  assign z64 = ~x01 & (new_n257_ | (x79 & ~new_n252_ & x83));
  assign new_n257_ = x04 & x56 & ~x77 & x78 & ~x79;
  assign z65 = (~x56 & ~x79) | (~x01 & new_n259_ & x79);
