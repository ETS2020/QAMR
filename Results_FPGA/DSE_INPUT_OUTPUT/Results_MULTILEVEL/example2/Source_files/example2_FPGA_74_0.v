...
module FAU ( 
  ...
  assign z51 = ~x01 & ((x04 & new_n224_ & x67) | (new_n216_ & x71));
  ...
  assign z53 = ~x01 & ((x04 & new_n228_ & x67) | (new_n216_ & x73));
  ...
  assign z56 = new_n234_ | ~x00 | x01 | new_n154_ | (~x77 & ~x78);
  ...
  assign new_n237_ = x78 & x79 & ((new_n182_ & new_n238_) | (~x40 & x42));
  assign new_n238_ = ~x74 & x80 & ~x42 & x43;
  assign new_n239_ = x40 & ~x42 & x67 & ~x78 & ~x79;
  assign new_n240_ = x67 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & (new_n244_ | (x77 & (new_n243_ | (~new_n242_ & x78))));
  assign new_n242_ = (~x67 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n243_ = x40 & ((x67 & ~x79) | (x04 & x78 & x79));
  assign new_n244_ = ~x04 & x67 & ~x79;
  assign z60 = new_n154_ | (~x01 & (new_n247_ | new_n248_ | (new_n246_ & x04)));
  assign new_n246_ = ~x42 & x77 & x78 & x79 & (~new_n181_ | ~new_n182_);
  ...
  assign z62 = ~x01 & (new_n254_ | (x79 & (new_n253_ | (new_n252_ & x04))));
  assign new_n252_ = ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n253_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign new_n254_ = x04 & x67 & x78 & ~x79;
  assign z63 = ~x01 & x79 & ~new_n250_ & x82;
  assign z64 = ~x01 & (new_n257_ | (x79 & ~new_n250_ & x83));
  assign new_n257_ = x04 & x67 & ~x77 & x78 & ~x79;
  assign z65 = (~x67 & ~x79) | (~x01 & new_n259_ & x79);
