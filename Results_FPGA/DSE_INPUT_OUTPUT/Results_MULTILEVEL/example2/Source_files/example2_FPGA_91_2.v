...
module FAU ( 
  ...
  assign new_n154_ = x00 & ~x79;
  assign new_n155_ = ~x79 & (x00 | (x77 & x78));
  assign z01 = (~x79 & (x00 | ~x01)) | (~x01 & (~x77 ^ x78));
  assign z02 = (x00 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & (x00 | (~x01 & x52 & x78));
  ...
  assign new_n183_ = ~x00 & x04 & x78 & ~x79;
  assign z23 = ~x00 | (x01 & x79);
  ...
  assign new_n198_ = (x42 | ~x51 | ~x81) & (~x05 | ~x42 | (x81 ^ ~x83));
  ...
  assign z48 = ~x01 & ((new_n220_ & x68) | (~x00 & new_n219_ & x04));
  assign new_n219_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n220_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((~x00 & new_n222_ & x04) | (new_n220_ & x69));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((~x00 & new_n224_ & x04) | (new_n220_ & x70));
  ...
  assign z53 = ~x01 & ((~x00 & new_n230_ & x04) | (new_n220_ & x73));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x00 & ~x01 & new_n232_ & x04;
  ...
  assign z56 = (~new_n237_ & (~x77 | ~x78)) | ~x00 | x01 | ~x79 | (~x77 & ~x78);
  ...
  assign new_n246_ = x78 & (~x79 | (x04 & ~x42 & x79 & (~new_n181_ | ~new_n182_)));
  ...
  assign z61 = (x00 & ~x79) | (~x01 & x79 & ~new_n254_ & x80);
  assign new_n254_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n183_ | (x79 & (new_n180_ | new_n256_)));
  assign new_n256_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = ~x01 & x79 & ~new_n254_ & x82;
  assign z64 = new_n154_ | (~new_n259_ & ~x01);
  assign new_n259_ = (~x79 | new_n254_ | ~x83) & (~x78 | x79 | ~x04 | x77);
  assign z65 = (x00 & ~x79) | (~x01 & new_n261_ & x79);
