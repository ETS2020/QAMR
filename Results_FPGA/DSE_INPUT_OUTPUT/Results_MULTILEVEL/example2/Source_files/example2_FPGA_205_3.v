...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n200_, new_n207_, new_n215_, new_n216_, new_n218_, new_n219_,
  ...
  assign z40 = x79 & (x01 | (~x04 & new_n207_ & x58));
  assign new_n207_ = x77 & ~new_n200_ & x78;
  assign z41 = x79 & (x01 | (~x04 & new_n207_ & x59));
  assign z42 = ~x01 & ~x04 & new_n199_ & x60;
  assign z43 = ~x01 & ~x04 & new_n199_ & x61;
  assign z44 = ~x01 & ~x04 & new_n199_ & x62;
  assign z45 = x79 & (x01 | (~x04 & new_n207_ & x63));
  ...
  assign z52 = (~x01 & new_n227_ & x04) | (x79 & (x01 | (new_n228_ & x72)));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign new_n228_ = x77 & ~x78 & (~x81 ^ x84);
  assign z53 = (~x01 & new_n230_ & x04) | (x79 & (x01 | (new_n228_ & x73)));
  ...
  assign z62 = (~x01 & x04 & x78 & (new_n179_ | ~x79)) | (x79 & (new_n252_ | x01));
