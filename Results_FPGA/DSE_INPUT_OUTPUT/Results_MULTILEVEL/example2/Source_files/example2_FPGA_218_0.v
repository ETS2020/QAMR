...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n182_, new_n184_,
    ...
    new_n201_, new_n214_, new_n222_, new_n224_, new_n227_, new_n229_,
    new_n231_, new_n233_, new_n235_, new_n239_;
  ...
  assign new_n214_ = ~x78 & x79 & ~new_n177_ & (x67 | x75);
  ...
  assign new_n227_ = (x40 | ~x42) & (~new_n179_ | x74 | ~x80 | x42 | ~x43);
  assign z59 = ~x01 & (~x79 | (x04 & x77 & ~new_n229_ & x78));
  assign new_n229_ = ~x40 & (x42 | (new_n179_ & x43 & ~x74 & x80));
  assign z60 = ~x01 & (new_n231_ | ~x79 | (x04 & new_n178_ & ~x42));
