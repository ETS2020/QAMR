...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n178_, new_n179_, new_n180_, new_n181_,
    new_n182_, new_n185_, new_n187_, new_n195_, new_n197_, new_n198_,
  ...
  assign z32 = x50 & (~x79 | (~x01 & new_n195_ & ~x04));
  assign new_n195_ = ~x42 & x77 & x78 & (x81 ? (~x82 ^ x84) : (~x82 ^ ~x84));
  ...
  assign z53 = new_n154_ | (~x01 & ((new_n230_ & x04) | (new_n220_ & x73)));
  ...
  assign new_n257_ = x04 & ~x50;
  assign z63 = (x50 & ~x79) | (~x01 & x79 & ~new_n254_ & x82);
