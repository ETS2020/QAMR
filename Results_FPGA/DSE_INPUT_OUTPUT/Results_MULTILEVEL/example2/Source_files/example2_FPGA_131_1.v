...
module FAU ( 
  ...
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & ~x77));
  ...
  assign z60 = (~x79 & x80) | (~x01 & (new_n250_ | new_n249_ | (~new_n251_ & ~x79)));
  ...
  assign new_n253_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z62 = (~x79 & (x80 | (new_n245_ & ~x01))) | (~x01 & (new_n249_ | (new_n255_ & x79)));
  assign new_n255_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (~x79 & x80) | (~x01 & x79 & ~new_n253_ & x82);
