...
module FAU ( 
  ...
  assign z03 = ~x79 & (~x20 | (~x01 & x52 & x78));
  ...
  assign z23 = (~x79 & (~x20 | (~x04 & x05))) | ~x00 | x01;
  ...
  assign z54 = ~x79 & (~x20 | (new_n231_ & ~x01));
  ...
  assign new_n246_ = x20 & ~x79;
  assign new_n247_ = x20 & ~x79 & (x40 | x78);
  assign z60 = ~x01 & ((x79 & (new_n249_ | new_n251_)) | (x20 & ~new_n250_ & ~x79));
  assign new_n249_ = x04 & ~x42 & x77 & x78 & (~new_n181_ | ~new_n182_);
  assign new_n250_ = x04 & ~x78;
  assign new_n251_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign z61 = (~x20 & ~x79) | (~x01 & x79 & ~new_n253_ & x80);
  assign new_n253_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (~x20 | (new_n255_ & ~x01))) | (~x01 & (new_n249_ | (new_n256_ & x79)));
