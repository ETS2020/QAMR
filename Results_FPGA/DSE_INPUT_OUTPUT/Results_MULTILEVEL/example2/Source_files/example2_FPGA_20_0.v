...
module FAU ( 
  ...
  assign new_n182_ = x04 & x22 & x78 & ~x79;
  ...
  assign new_n240_ = x22 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n241_ = x22 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = new_n154_ | (~x01 & (new_n245_ | (x77 & (new_n243_ | new_n244_))));
  assign new_n243_ = x78 & (~x79 | (x04 & ~x42 & x79 & (~new_n179_ | ~new_n180_)));
  ...
  assign z65 = (~x22 & ~x79) | (~x01 & new_n258_ & x79);
