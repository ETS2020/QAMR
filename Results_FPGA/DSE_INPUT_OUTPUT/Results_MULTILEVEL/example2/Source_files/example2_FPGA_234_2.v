...
module FAU ( 
  ...
  assign z04 = (x72 & ~x79) | (~x01 & (~x77 | ~x78 | x79));
  ...
  assign z23 = ((~x00 | x01) & (~x72 | x79)) | (~x04 & x05 & ~x72 & ~x79);
  ...
  assign z48 = ~x01 & ((x04 & new_n218_ & ~x72) | (new_n219_ & x68));
  ...
  assign z50 = ~x01 & ((new_n219_ & x70) | (x04 & new_n223_ & ~x72));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n219_ & x71) | (x04 & new_n225_ & ~x72));
  ...
  assign new_n245_ = (x72 | x79) & (~x04 | x42 | ~x79 | (new_n181_ & new_n182_));
  assign new_n246_ = x40 & ((~x72 & ~x79) | (x04 & x78 & x79));
  assign new_n247_ = ~x04 & ~x72 & ~x79;
  ...
  assign z61 = (x72 & ~x79) | (~x01 & x79 & ~new_n253_ & x80);
