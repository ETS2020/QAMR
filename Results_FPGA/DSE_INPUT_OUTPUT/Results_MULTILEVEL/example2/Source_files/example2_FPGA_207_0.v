...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n200_, new_n203_, new_n215_, new_n223_, new_n225_, new_n228_,
  ...
  assign z22 = ~x01 & (new_n176_ | new_n178_ | ~x79);
  ...
  assign z60 = ~x01 & (new_n232_ | new_n178_ | ~x79);
  assign new_n232_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = ~x01 & (~x79 | (~new_n234_ & x80));
  assign new_n234_ = (x04 | ~x77 | ~x78) & (new_n177_ | (~x77 ^ x78));
  assign z62 = ~x01 & (~new_n238_ | (~new_n236_ & x81));
  assign new_n236_ = (~x84 | (~x77 ^ x78)) & (~x77 | ~x78 | (x04 & (new_n237_ | x42)));
  assign new_n237_ = x82 & ~x83 & x84 & x43 & ~x74 & x80;
  assign new_n238_ = x79 & (~x04 | x42 | ~x77 | ~x78 | x81);
