...
module FAU ( 
  ...
  assign z04 = (x79 & (~x01 | x65)) | (~x01 & (~x77 | ~x78));
  ...
  assign z22 = ~x01 & (new_n183_ | (~x65 & (new_n179_ | new_n180_)));
  ...
  assign z34 = x79 & (x65 | (~x01 & ~x04 & new_n206_ & x52));
  ...
  assign new_n209_ = ~x65 & x77 & x78 & ~new_n207_ & x79;
  assign z36 = ~x01 & ~x04 & new_n209_ & x54;
  assign z37 = ~x01 & ~x04 & new_n209_ & x55;
  assign z38 = ~x01 & ~x04 & new_n209_ & x56;
  assign z39 = x79 & (x65 | (~x01 & ~x04 & new_n206_ & x57));
  assign z40 = ~x01 & ~x04 & new_n209_ & x58;
  assign z41 = x79 & (x65 | (~x01 & ~x04 & new_n206_ & x59));
  assign z42 = x79 & (x65 | (~x01 & ~x04 & new_n206_ & x60));
  assign z43 = ~x01 & ~x04 & new_n209_ & x61;
  assign z44 = ~x01 & ~x04 & new_n209_ & x62;
  assign z45 = x79 & (x65 | (~x01 & ~x04 & new_n206_ & x63));
  assign z46 = x79 & (x65 | (~x01 & ~x04 & new_n206_ & x64));
  assign z47 = ~x01 & ((x04 & new_n222_ & ~x77) | (~x65 & new_n223_ & x77));
  assign new_n222_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n223_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n225_ & x04) | (~x65 & new_n226_ & x68));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n226_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((new_n228_ & x04) | (~x65 & new_n226_ & x69));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n230_ & x04) | (~x65 & new_n226_ & x70));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n232_ & x04) | (~x65 & new_n226_ & x71));
  assign new_n232_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n234_ & x04) | (~x65 & new_n226_ & x72));
  assign new_n234_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n236_ & x04) | (~x65 & new_n226_ & x73));
  ...
  assign new_n240_ = x79 & x78 & x77 & ~x65 & ~x01 & ~x04;
  assign z56 = (~new_n242_ & x79) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n242_ = ~x65 & ((x77 & x78) | (~x76 & (x81 | ~x84) & (~x81 | x84)));
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = new_n154_ | (~x01 & (new_n249_ | (x77 & (new_n245_ | new_n248_))));
  ...
  assign new_n251_ = x79 & (~x04 | x42 | x65 | (new_n181_ & new_n182_));
  assign new_n252_ = x40 & (~x79 | (x04 & ~x65 & x78));
  assign new_n253_ = ~x04 & ~x79;
  assign z60 = ~x01 & (new_n256_ | (~x65 & (new_n180_ | new_n255_)));
  assign new_n255_ = (~x81 ^ ~x84) & (x77 ? (~x78 & x79) : x78);
  assign new_n256_ = ~x79 & (~x04 | x78);
  assign z61 = x79 & (x65 | (~x01 & ~new_n258_ & x80));
  assign new_n258_ = (~x78 | (x77 ? x04 : (x81 ^ x84))) & (~x77 | x78 | ((x81 | x84) & (x65 | ~x81 | ~x84)));
  assign z62 = ~x01 & (new_n183_ | (~x65 & (new_n180_ | new_n260_)));
  assign new_n260_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = ~x01 & ~x65 & x79 & ~new_n262_ & x82;
  assign new_n262_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z64 = ~x01 & (new_n264_ | (~x65 & x79 & ~new_n262_ & x83));
  assign new_n264_ = x78 & ~x79 & x04 & ~x77;
  assign z65 = x79 & (new_n266_ | x65);
