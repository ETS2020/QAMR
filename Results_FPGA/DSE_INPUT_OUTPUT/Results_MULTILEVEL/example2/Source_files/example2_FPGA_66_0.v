...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x53 | (x77 & x78));
  ...
  assign new_n183_ = x78 & ~x79 & x04 & x53;
  assign z23 = ((x53 | x79) & (~x00 | x01)) | (~x04 & x05 & x53 & ~x79);
  ...
  assign z35 = (~x01 & ~x04 & new_n201_ & x53) | (~x53 & ~x79);
  ...
  assign z50 = ~x01 & ((x04 & new_n224_ & x53) | (new_n220_ & x70));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n226_ & x53) | (new_n220_ & x71));
  ...
  assign z53 = ~x01 & ((x04 & new_n230_ & x53) | (new_n220_ & x73));
  ...
  assign new_n242_ = x40 & ~x42 & x53 & ~x78 & ~x79;
  assign new_n243_ = x53 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = (~x53 & ~x79) | (~x01 & ((~new_n245_ & x77) | (~x04 & x53 & ~x79)));
  assign new_n245_ = (~x40 | (x79 & (~x04 | ~x78))) & (~x78 | ((~new_n246_ | ~x04) & (~x53 | x79)));
  assign new_n246_ = ~x42 & x79 & (~new_n181_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((x53 & ~new_n248_ & ~x79) | (x79 & (new_n179_ | new_n249_)));
  ...
  assign z62 = (~x79 & (~x53 | (new_n253_ & ~x01))) | (~x01 & (new_n179_ | (new_n254_ & x79)));
  assign new_n253_ = x04 & x78;
  assign new_n254_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (~x53 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
