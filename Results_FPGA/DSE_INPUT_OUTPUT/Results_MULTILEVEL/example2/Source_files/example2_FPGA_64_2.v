...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | x34)) | (~x01 & (~x77 ^ x78));
  ...
  assign z16 = x34 ? (x79 & (~x40 | x49)) : (x40 & x49);
  ...
  assign z22 = new_n154_ | (~x01 & (new_n178_ | (x04 & ~new_n180_ & x78)));
  ...
  assign z23 = ~x00 | x01 | (~x79 & (x34 | (~x04 & x05)));
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x77 & x78 & x79) | (~x34 & ~x79));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x34 & new_n215_ & ~x77));
  ...
  assign z56 = new_n235_ | (~new_n154_ & (~x00 | x01 | (~x77 & ~x78)));
  ...
  assign new_n245_ = ~x34 & ~x79;
  assign new_n246_ = ~x34 & ~x79 & (x40 | x78);
  ...
  assign z61 = (x34 & ~x79) | (~x01 & x79 & ~new_n252_ & x80);
  ...
  assign new_n256_ = x04 & ~x34 & x78 & ~x79;
  assign z63 = ~x01 & x79 & ~new_n252_ & x82;
  assign z64 = new_n154_ | (~new_n259_ & ~x01);
  assign new_n259_ = (~x79 | new_n252_ | ~x83) & (~x78 | x79 | ~x04 | x77);
