...
module FAU ( 
  ...
  assign new_n248_ = ~x40 & ~x78;
  assign z60 = (~x01 & ~x79 & (~x04 | x78)) | (x79 & (new_n251_ | x01 | (new_n250_ & x04)));
  assign new_n250_ = ~x42 & x77 & x78 & (~new_n180_ | ~new_n181_);
  assign new_n251_ = (x81 ^ x84) & (x77 ^ x78);
  assign z61 = x79 & (x01 | (~new_n253_ & x80));
  assign new_n253_ = (x04 | ~x77 | ~x78) & ((~x77 ^ x78) | ((x81 | x84) & (x01 | ~x81 | ~x84)));
  assign z62 = ~x01 & ((new_n255_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
