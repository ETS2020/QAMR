...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | ~x20)) | (~x01 & (~x77 ^ x78));
  ...
  assign new_n182_ = x04 & x20 & x78 & ~x79;
  assign z23 = (~x79 & (~x20 | (~x04 & x05))) | ~x00 | x01;
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x77 & x78 & x79) | (x20 & ~x79));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & x20 & new_n215_ & ~x77));
  ...
  assign z52 = new_n154_ | (~x01 & (new_n227_ | (new_n219_ & x72)));
  assign new_n227_ = x04 & ~x77 & x78 & ~x79 & (x12 | x52);
  ...
  assign new_n240_ = x20 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n241_ = x20 & ~x79 & (~x04 | (~x77 & x78));
  ...
  assign z60 = ~x01 & ((x79 & (new_n178_ | new_n248_)) | (x20 & ~new_n247_ & ~x79));
  ...
  assign z65 = (~x20 & ~x79) | (~x01 & new_n257_ & x79);
