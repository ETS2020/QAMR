...
module FAU ( 
  ...
  assign z02 = ~x01 & x70 & ~new_n158_ & x79;
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = (x79 & (~x01 | ~x70)) | (~x01 & (~x77 | ~x78));
  ...
  assign z22 = ~x01 & (new_n183_ | (x70 & (new_n179_ | new_n180_)));
  ...
  assign z33 = ~x01 & ~x04 & x70 & new_n201_ & x77;
  ...
  assign new_n205_ = x70 & x77 & x78 & ~new_n206_ & x79;
  ...
  assign z39 = x79 & (~x70 | (~x01 & ~x04 & new_n212_ & x57));
  assign new_n212_ = x77 & ~new_n206_ & x78;
  assign z40 = x79 & (~x70 | (~x01 & ~x04 & new_n212_ & x58));
  assign z41 = ~x01 & ~x04 & new_n205_ & x59;
  assign z42 = x79 & (~x70 | (~x01 & ~x04 & new_n212_ & x60));
  assign z43 = ~x01 & ~x04 & new_n205_ & x61;
  assign z44 = x79 & (~x70 | (~x01 & ~x04 & new_n212_ & x62));
  assign z45 = ~x01 & ~x04 & new_n205_ & x63;
  assign z46 = x79 & (~x70 | (~x01 & ~x04 & new_n212_ & x64));
  assign z47 = ~x01 & ((x04 & new_n221_ & ~x77) | (x70 & new_n222_ & x77));
  assign new_n221_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n222_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n224_ & x04) | (x68 & new_n225_ & x70));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n225_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((new_n227_ & x04) | (x69 & new_n225_ & x70));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = new_n154_ | (~x01 & (new_n225_ | (new_n229_ & x04)));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n231_ & x04) | (x70 & new_n225_ & x71));
  assign new_n231_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n233_ & x04) | (x70 & new_n225_ & x72));
  assign new_n233_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n235_ & x04) | (x70 & new_n225_ & x73));
  ...
  assign new_n239_ = x70 & (~new_n240_ | ~x77 | ~x78 | x01 | x04);
  assign new_n240_ = ~x80 & ~x81 & ~x82 & x83 & x84;
  assign z56 = (~new_n242_ & x79) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n242_ = x70 & ((x77 & x78) | (~x76 & (x81 | ~x84) & (~x81 | x84)));
  ...
  assign z60 = new_n154_ | (~x01 & (new_n256_ | new_n257_ | (new_n255_ & x04)));
  ...
  assign new_n259_ = (~x78 | (x77 ? x04 : (x81 ^ x84))) & (~x77 | x78 | ((x81 | x84) & (~x70 | ~x81 | ~x84)));
  assign z62 = ~x01 & (new_n183_ | (x70 & (new_n180_ | new_n261_)));
  assign new_n261_ = x79 & x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = ~x01 & x70 & x79 & ~new_n263_ & x82;
  assign new_n263_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z64 = ~x01 & (new_n265_ | (x70 & x79 & ~new_n263_ & x83));
  assign new_n265_ = x78 & ~x79 & x04 & ~x77;
  assign z65 = x79 & (new_n267_ | ~x70);
