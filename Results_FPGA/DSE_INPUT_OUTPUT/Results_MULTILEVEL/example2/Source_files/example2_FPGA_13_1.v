...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n158_, new_n179_, new_n180_, new_n181_,
    new_n182_, new_n185_, new_n187_, new_n188_, new_n193_, new_n195_,
  ...
  assign new_n154_ = ~x49 & x79;
  assign new_n155_ = x79 ? ~x49 : (x77 & x78);
  assign z01 = ~x01 & (~x79 | (x49 & (~x77 ^ x78)));
  assign z02 = ~x01 & x49 & ~new_n158_ & x79;
  ...
  assign z16 = (x40 & (x49 | x79)) | (~x49 & x79) | (x34 & ~x40);
  ...
  assign z23 = ((~x00 | x01) & (x49 | ~x79)) | (~x04 & x05 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & (~x79 | (x49 & x77 & x78));
  ...
  assign z29 = x79 & (~x49 | (~x01 & ~x04 & new_n193_ & ~x42));
  assign new_n193_ = x47 & x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z30 = x79 & (~x49 | (~x01 & ~x04 & new_n195_ & ~x42));
  assign new_n195_ = x48 & x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z31 = x79 & (~x49 | (~x01 & new_n197_ & ~x04));
  assign new_n197_ = ~x42 & x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z32 = ~x01 & ~x04 & ~x42 & x49 & new_n188_ & x50;
  assign z33 = ~x01 & ~x04 & x49 & new_n200_ & x77;
  ...
  assign z34 = ~x01 & ~x04 & x49 & new_n204_ & x52;
  assign new_n204_ = x77 & x78 & ~new_n205_ & x79;
  assign new_n205_ = ((~x82 ^ x84) | ((x81 | (x42 & x83)) & (~x42 | ~x81 | ~x83))) & ((x82 ^ x84) | ((~x81 | (x42 & x83)) & (~x42 | x81 | ~x83)));
  assign z35 = ~x01 & ~x04 & x49 & new_n204_ & x53;
  assign z36 = ~x01 & ~x04 & x49 & new_n204_ & x54;
  assign z37 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x55));
  assign new_n209_ = x77 & ~new_n205_ & x78;
  assign z38 = ~x01 & ~x04 & x49 & new_n204_ & x56;
  assign z39 = ~x01 & ~x04 & x49 & new_n204_ & x57;
  assign z40 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x58));
  assign z41 = ~x01 & ~x04 & x49 & new_n204_ & x59;
  assign z42 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x60));
  assign z43 = ~x01 & ~x04 & x49 & new_n204_ & x61;
  assign z44 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x62));
  assign z45 = x79 & (~x49 | (~x01 & ~x04 & new_n209_ & x63));
  assign z46 = ~x01 & ~x04 & x49 & new_n204_ & x64;
  ...
  assign z52 = ~x01 & ((x49 & new_n224_ & x72) | (new_n232_ & x04));
  ...
  assign new_n238_ = x79 & x78 & x77 & x49 & ~x01 & ~x04;
  assign z56 = (~new_n240_ & (x49 | ~x79)) | (x49 & new_n241_ & x79);
  ...
  assign new_n244_ = x49 & x78 & x79 & (new_n245_ | (new_n182_ & new_n246_));
  ...
  assign new_n250_ = x79 & (~x04 | x42 | ~x49 | ~x79 | (new_n181_ & new_n182_));
  assign new_n251_ = x40 & (~x79 | (x04 & x49 & x78));
  assign new_n252_ = ~x04 & ~x79;
  assign z60 = ~x01 & (new_n256_ | (x49 & (new_n255_ | (new_n254_ & x04))));
  assign new_n254_ = ~x42 & x77 & x78 & x79 & (~new_n181_ | ~new_n182_);
  assign new_n255_ = (~x81 ^ ~x84) & (x77 ? (~x78 & x79) : x78);
  assign new_n256_ = ~x79 & (~x04 | x78);
  assign z61 = x79 & (~x49 | (~x01 & ~new_n258_ & x80));
  ...
  assign z63 = ~x01 & x49 & x79 & ~new_n258_ & x82;
  assign z64 = new_n154_ | (~x01 & ((~new_n263_ & x78) | (x77 & new_n264_ & ~x78)));
  assign new_n263_ = (x77 | (~new_n264_ & (~x04 | (x49 & x79)))) & (~x79 | ~x83 | x04 | ~x77);
  assign new_n264_ = x79 & x83 & ((~x81 & ~x84) | (x49 & x81 & x84));
  assign z65 = ~x01 & new_n266_ & x49;
