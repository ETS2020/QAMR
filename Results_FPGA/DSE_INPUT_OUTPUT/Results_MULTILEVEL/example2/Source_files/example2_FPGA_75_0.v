...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | ~x51)) | (~x01 & (~x77 ^ x78));
  ...
  assign new_n185_ = x05 & ~x43 & ((x77 & x78 & x79) | (x51 & ~x79));
  ...
  assign z50 = ~x01 & ((x04 & new_n223_ & x51) | (new_n219_ & x70));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n225_ & x51) | (new_n219_ & x71));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n227_ & x51) | (new_n219_ & x72));
  ...
  assign z54 = ~x79 & (~x51 | (new_n231_ & ~x01));
  ...
  assign new_n256_ = x04 & x51 & x78 & ~x79;
  assign z63 = (~x51 & ~x79) | (~x01 & x79 & ~new_n252_ & x82);
  assign z64 = ~x01 & (new_n259_ | (x79 & ~new_n252_ & x83));
  assign new_n259_ = x04 & x51 & ~x77 & x78 & ~x79;
