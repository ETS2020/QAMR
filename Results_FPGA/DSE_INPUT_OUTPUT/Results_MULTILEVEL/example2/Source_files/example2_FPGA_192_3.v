...
module FAU ( 
  ...
  wire new_n154_, new_n159_, new_n178_, new_n179_, new_n180_, new_n181_,
    new_n182_, new_n186_, new_n191_, new_n196_, new_n197_, new_n198_,
  ...
  assign z22 = (x79 & (new_n178_ | x01)) | (~x01 & x04 & x78 & (new_n180_ | ~x79));
  ...
  assign z29 = x79 & (x01 | (~x04 & ~x42 & new_n191_ & x47));
  assign new_n191_ = x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z30 = x79 & (x01 | (~x04 & ~x42 & new_n191_ & x48));
  assign z31 = x79 & (x01 | (~x04 & ~x42 & new_n191_ & x49));
  assign z32 = x79 & (x01 | (~x04 & ~x42 & new_n191_ & x50));
  ...
  assign z51 = (~x01 & new_n226_ & x04) | (x79 & (new_n227_ | x01));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign new_n227_ = x71 & x77 & ~x78 & (~x81 ^ x84);
