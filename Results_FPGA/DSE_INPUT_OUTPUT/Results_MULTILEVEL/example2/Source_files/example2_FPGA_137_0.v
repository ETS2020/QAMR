...
module FAU ( 
  ...
  assign z26 = (~x44 & ~x79) | (~x01 & ~x04 & ~x42 & new_n188_ & x44);
  ...
  assign z51 = ~x01 & ((x04 & new_n226_ & x44) | (new_n220_ & x71));
  ...
  assign new_n252_ = ~x79 & (x78 | (~x04 & x44));
  assign z61 = ~x01 & x79 & ~new_n254_ & x80;
  assign new_n254_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~x79 & (~x44 | (new_n256_ & ~x01))) | (~x01 & (new_n180_ | (new_n257_ & x79)));
  assign new_n256_ = x04 & x78;
  assign new_n257_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = (~x44 & ~x79) | (~x01 & x79 & ~new_n254_ & x82);
  assign z64 = ~x01 & (new_n260_ | (x79 & ~new_n254_ & x83));
  assign new_n260_ = x04 & x44 & ~x77 & x78 & ~x79;
  assign z65 = (~x44 & ~x79) | (~x01 & new_n262_ & x79);
