...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n200_, new_n205_, new_n215_, new_n216_, new_n218_, new_n219_,
  ...
  assign z28 = x79 & (x01 | (~x04 & ~x42 & new_n185_ & x46));
  assign z29 = x79 & (x01 | (~x04 & ~x42 & new_n185_ & x47));
  assign z30 = x79 & (x01 | (~x04 & ~x42 & new_n185_ & x48));
  assign z31 = ~x01 & ~x04 & ~x42 & new_n187_ & x49;
  assign z32 = x79 & (x01 | (~x04 & ~x42 & new_n185_ & x50));
  assign z33 = x79 & (x01 | (new_n195_ & ~x04));
  ...
  assign z38 = x79 & (x01 | (~x04 & new_n205_ & x56));
  assign new_n205_ = x77 & ~new_n200_ & x78;
  assign z39 = x79 & (x01 | (~x04 & new_n205_ & x57));
  assign z40 = x79 & (x01 | (~x04 & new_n205_ & x58));
  assign z41 = x79 & (x01 | (~x04 & new_n205_ & x59));
  assign z42 = ~x01 & ~x04 & new_n199_ & x60;
  assign z43 = x79 & (x01 | (~x04 & new_n205_ & x61));
  assign z44 = x79 & (x01 | (~x04 & new_n205_ & x62));
  assign z45 = x79 & (x01 | (~x04 & new_n205_ & x63));
  ...
  assign z49 = (~x01 & new_n221_ & x04) | (x79 & (x01 | (new_n219_ & x69)));
  assign new_n221_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = (~x01 & new_n223_ & x04) | (x79 & (x01 | (new_n219_ & x70)));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = (~x01 & new_n225_ & x04) | (x79 & (x01 | (new_n219_ & x71)));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n227_ & ~x77) | (x72 & new_n228_ & x77));
  assign new_n227_ = x78 & ~x79 & (x52 ? x20 : x12);
  assign new_n228_ = ~x78 & x79 & (~x81 ^ x84);
  assign z53 = (~x01 & new_n230_ & x04) | (x79 & (x01 | (new_n219_ & x73)));
  ...
  assign z60 = (x79 & (new_n249_ | x01 | (~x01 & new_n248_ & x04))) | (~x01 & ~x79 & (~x04 | x78));
  ...
  assign z62 = (~x01 & x04 & x78 & (new_n179_ | ~x79)) | (x79 & (new_n253_ | x01));
  assign new_n253_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = x79 & (x01 | (~new_n251_ & x82));
  assign z64 = ~x01 & ((new_n256_ & x78 & ~x79) | (x79 & ~new_n251_ & x83));
