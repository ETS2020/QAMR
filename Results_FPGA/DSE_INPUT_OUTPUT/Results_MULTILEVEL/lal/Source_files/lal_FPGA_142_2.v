...
module FAU ( 
  ...
  assign z09 = ~new_n63_ & ~x15;
  assign new_n63_ = ~new_n52_ & ~x07;
  assign z10 = ~x15 & (x07 | (~new_n52_ & ~x17));
  assign z11 = ~x15 & (x07 | (~new_n52_ & (x17 ^ x18)));
  assign z12 = ~x15 & (x07 | (~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n63_ | x15 | (x17 & x18 & x19 & ~x20);
  assign z14 = (~new_n69_ & x21) | ~new_n63_ | new_n70_ | x15;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n70_ & x22) | ~new_n63_ | new_n72_ | x15;
  assign new_n72_ = x17 & x18 & x19 & new_n73_ & ~x20;
  assign new_n73_ = ~x21 & ~x22;
  assign z16 = (~new_n72_ & x23) | ~new_n63_ | new_n75_ | x15;
  assign new_n75_ = new_n76_ & x17 & x18 & x19;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (~new_n78_ | (~new_n75_ & x24)));
  assign new_n78_ = ~new_n52_ & (~new_n69_ | ~new_n73_ | x23 | x24);
  assign z18 = x15 | (~new_n80_ & ~x07);
  assign new_n80_ = (~x25 | (new_n69_ & new_n73_ & ~x23 & ~x24)) & ~new_n52_ & (~new_n69_ | ~new_n73_ | x23 | x24 | x25);
endmodule
