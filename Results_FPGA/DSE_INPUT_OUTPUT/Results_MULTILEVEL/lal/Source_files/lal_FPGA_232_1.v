...
module FAU ( 
  ...
  assign z09 = ~x16 & new_n52_ & ~x07 & ~x15;
  ...
  assign new_n69_ = (new_n70_ | ~x20) & ~new_n52_ & ~new_n71_ & ~x07;
  assign new_n70_ = x17 & x18 & x19;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n71_ & x21) | ~new_n51_ | x15 | new_n73_ | x16;
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n73_ & x22) | ~new_n51_ | x15 | new_n75_ | x16;
  assign new_n75_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~x16 & ((~new_n75_ & x23) | ~new_n77_ | new_n52_));
