...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n53_, new_n55_, new_n56_, new_n65_, new_n67_,
  ...
  assign z03 = ~x25 & (~x24 | (~x23 & (new_n53_ | ~x21 | ~x22)));
  ...
  assign z08 = x25 | (x24 & (x23 | (x21 & ~new_n53_ & x22)));
  ...
  assign z13 = (~new_n67_ & x20) | ~new_n50_ | x15 | new_n68_ | x25;
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n68_ & x21) | ~new_n50_ | ~new_n70_ | x15;
  assign new_n70_ = ~x25 & (~x17 | ~x18 | ~x19 | x20 | x21);
  ...
  assign z16 = (~new_n72_ & x23) | ~new_n50_ | ~new_n75_ | x15;
  assign new_n75_ = ~x25 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x25 & (new_n77_ | new_n51_ | new_n78_ | x07));
  assign new_n77_ = x24 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign new_n78_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | x25 | x07 | new_n78_ | new_n51_;
endmodule
