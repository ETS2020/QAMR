...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n56_, new_n61_, new_n64_,
  ...
  assign z04 = ~x08 & ((~new_n56_ & (~x01 | x03)) | (~x01 & (x10 | (~x03 & x12))) | (x03 & (~x12 | (x01 & ~x10))));
  assign new_n56_ = (x00 | ~x09) & (~x00 | x09) & (x02 | ~x11) & (~x02 | x11);
  ...
  assign z16 = (~new_n74_ & x23) | ~new_n64_ | x07 | new_n76_ | x15;
  assign new_n76_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n76_ & x24) | ~new_n64_ | x07 | new_n78_ | x15;
