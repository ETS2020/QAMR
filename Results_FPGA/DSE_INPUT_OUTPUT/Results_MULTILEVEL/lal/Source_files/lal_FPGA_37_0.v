...
module FAU ( 
  ...
  assign z14 = x15 | (x10 & (new_n51_ | ~new_n71_ | (~new_n70_ & x21)));
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n74_ | ~new_n73_ | ~x10 | new_n75_ | x15;
  assign new_n73_ = ~new_n51_ & ~x07;
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n75_ & x23) | ~new_n73_ | ~x10 | new_n77_ | x15;
  assign new_n77_ = new_n78_ & x17 & x18 & x19;
  assign new_n78_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x10 & (~new_n80_ | new_n51_ | (~new_n77_ & x24)));
  assign new_n80_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = new_n82_ | ~new_n73_ | ~x10 | new_n83_ | x15;
