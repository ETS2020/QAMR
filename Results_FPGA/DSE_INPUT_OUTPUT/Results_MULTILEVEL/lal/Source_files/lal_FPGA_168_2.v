...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n55_, new_n57_, new_n58_,
    new_n63_, new_n64_, new_n70_, new_n72_, new_n73_, new_n75_, new_n77_,
  ...
  assign z08 = ~new_n63_ | (~new_n64_ & ~x19);
  assign new_n63_ = ~x25 & (~x24 | (~x23 & (~new_n51_ | ~x20)));
  assign new_n64_ = ~x15 & (x17 | x18 | ~x21 | ~x22 | ~x24);
  assign z09 = ~x15 & new_n52_ & ~x07;
  assign z10 = ~x07 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = (x15 & ~x19) | (~x07 & ~x15 & ~new_n52_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n70_ | x15 | (x19 & ~x20 & x17 & x18);
  assign new_n70_ = ~new_n52_ & ~x07;
  assign z14 = (~new_n72_ & x21) | ~new_n70_ | new_n73_ | x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20;
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n73_ & x22) | ~new_n70_ | new_n75_ | x15;
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (x19 & (new_n77_ | x15)) | (~x15 & (~new_n70_ | (~new_n75_ & x23)));
  assign new_n77_ = ~x21 & ~x22 & ~x23 & x17 & x18 & ~x20;
  assign z17 = new_n79_ | ~new_n70_ | new_n81_ | x15;
  assign new_n79_ = x24 & (~new_n80_ | ~x17 | ~x18 | ~x19);
  assign new_n80_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n81_ = new_n72_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n81_ & x25) | ~new_n70_ | new_n83_ | x15;
