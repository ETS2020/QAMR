...
module FAU ( 
  ...
  assign z10 = ~x15 & (x21 | (~x07 & ~new_n50_ & ~x17));
  assign z11 = ~x15 & (x21 | (~x07 & ~new_n50_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n66_ & ~x15;
  assign new_n66_ = ~x21 & ~new_n50_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n68_ & ~x21);
  assign new_n68_ = (~x20 | (x17 & x18 & x19)) & ~new_n50_ & ~x07 & (~x17 | ~x18 | ~x19 | x20);
  assign z14 = x15 | (~x21 & (new_n50_ | new_n70_ | x07));
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z15 = (~x21 & (new_n50_ | ~new_n72_)) | (~new_n70_ & x22) | x15 | x21;
  assign new_n72_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x22);
  assign z16 = new_n75_ | ~new_n74_ | x15 | new_n76_ | x21;
  assign new_n74_ = ~new_n50_ & ~x07;
  ...
  assign z18 = x15 | (~x21 & ((~new_n78_ & x25) | ~new_n81_ | new_n50_));
  assign new_n81_ = ~x07 & (~new_n70_ | x24 | x25 | x22 | x23);
endmodule
