...
module FAU ( 
  ...
  assign z03 = ~x25 & (new_n56_ | (~new_n48_ & (new_n55_ | ~x24)));
  assign new_n55_ = ~new_n51_ & ~x23;
  assign new_n56_ = ~x15 & ~x20 & ~x23 & (x17 | x18 | x19);
  ...
  assign z08 = (x24 & ((~new_n55_ & x20) | (~new_n64_ & ~x15))) | (x25 & (~x15 | x20));
  assign new_n64_ = ~x23 & (x17 | x18 | ~new_n51_ | x19);
  ...
  assign z13 = (~new_n70_ & x20) | new_n52_ | x07 | new_n71_ | x15;
  ...
  assign z16 = (x20 & (x15 | x23)) | (~x15 & (~new_n79_ | new_n52_ | (~new_n80_ & x23)));
  assign new_n79_ = ~x07 & (~new_n70_ | x20 | x21 | x22 | x23);
  assign new_n80_ = x17 & x18 & x19 & ~x21 & ~x22;
  assign z17 = (x20 & (x15 | x24)) | (~x15 & (~new_n83_ | new_n52_ | (~new_n82_ & x24)));
  assign new_n82_ = new_n70_ & ~x21 & ~x22 & ~x23;
  assign new_n83_ = ~x07 & (~new_n71_ | x21 | x22 | x23 | x24);
  assign z18 = new_n85_ | new_n52_ | x07 | new_n86_ | x15;
  assign new_n85_ = x25 & (~new_n71_ | x21 | x22 | x23 | x24);
  assign new_n86_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
