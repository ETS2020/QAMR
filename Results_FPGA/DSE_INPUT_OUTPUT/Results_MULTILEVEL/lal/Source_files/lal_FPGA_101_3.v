...
module FAU ( 
  ...
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n67_ | x15 | (x19 & ~x20 & x17 & x18);
  assign new_n67_ = ~new_n52_ & ~x07;
  assign z14 = (~new_n69_ & x21) | ~new_n67_ | new_n70_ | x15;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 ? ~x15 : ((~new_n70_ & x22) | new_n52_ | new_n72_ | x15);
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n72_ & x23) | ~new_n67_ | new_n74_ | x15;
  assign new_n74_ = new_n75_ & x17 & x18 & x19;
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n74_ & x24) | ~new_n67_ | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 ? ~x15 : ((~new_n77_ & x25) | new_n52_ | new_n79_ | x15);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
