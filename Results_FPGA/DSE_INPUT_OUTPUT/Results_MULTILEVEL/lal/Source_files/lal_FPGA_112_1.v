...
module FAU ( 
  ...
  assign z11 = ~x15 & (x16 | (~x07 & ~new_n51_ & (x17 ^ x18)));
  assign z12 = ~x15 & (new_n66_ | x16);
  assign new_n66_ = ~x07 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n68_ & ~x16);
  assign new_n68_ = (~x20 | (x17 & x18 & x19)) & ~new_n51_ & ~x07 & (~x19 | x20 | ~x17 | ~x18);
  assign z14 = (~new_n71_ & x21) | ~new_n70_ | ~new_n72_ | x15;
  assign new_n70_ = ~new_n51_ & ~x07;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign new_n72_ = ~x16 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x16 & (new_n74_ | new_n51_ | new_n75_ | x07));
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n75_ & x23) | ~new_n70_ | x15 | new_n77_ | x16;
  assign new_n77_ = new_n78_ & x17 & x18 & x19;
  assign new_n78_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n77_ & x24) | ~new_n70_ | x15 | new_n80_ | x16;
  assign new_n80_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n80_ & x25) | ~new_n70_ | x15 | new_n82_ | x16;
