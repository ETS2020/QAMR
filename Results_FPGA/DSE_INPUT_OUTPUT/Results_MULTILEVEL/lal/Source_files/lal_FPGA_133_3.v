// Benchmark "FAU" written by ABC on Tue Aug 18 17:08:15 2020
...
module FAU ( 
  ...
  assign z01 = new_n49_ | new_n51_ | x07 | (x09 & x15);
  ...
  assign z04 = (x09 & (x15 | (~x00 & ~x08))) | (~x08 & (~new_n56_ | ~new_n55_ | (x00 & ~x09)));
  ...
  assign z07 = (~x06 | x08) & (~x09 | ~x15);
  assign z08 = (~x09 | ~x15) & (x25 | (x24 & (new_n61_ | x23)));
  assign new_n61_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = (x09 & x15) | (new_n51_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = (x09 & x15) | (~x07 & ~x15 & ~new_n51_ & (x17 ^ x18));
  ...
  assign z15 = x15 ? ~x09 : (new_n75_ | new_n51_ | new_n74_ | x07);
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 ? ~x09 : ((~new_n74_ & x23) | ~new_n77_ | new_n51_);
  assign new_n77_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? ~x09 : (new_n79_ | ~new_n80_ | new_n51_);
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = new_n82_ | new_n51_ | x07 | new_n83_ | x15;
