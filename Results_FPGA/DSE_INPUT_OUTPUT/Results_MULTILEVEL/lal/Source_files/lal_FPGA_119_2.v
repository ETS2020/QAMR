...
module FAU ( 
  ...
  assign z12 = (x15 & ~x18) | (~x07 & ~new_n51_ & ((~x15 & (x17 ? (x18 & ~x19) : x19)) | (~x18 & x19)));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n50_ | x15 | (x17 & x18 & x19 & ~x20);
  assign z14 = (x18 & (new_n73_ | x15)) | (~x15 & (~new_n50_ | (~new_n72_ & x21)));
  assign new_n72_ = x17 & x18 & x19 & ~x20;
  assign new_n73_ = x17 & x19 & ~x20 & ~x21;
  assign z15 = (x18 & (new_n75_ | x15)) | (~x15 & (~new_n50_ | new_n76_));
  assign new_n75_ = x17 & x19 & ~x20 & ~x21 & ~x22;
  assign new_n76_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (x18 & (new_n78_ | x15)) | (~x15 & (~new_n50_ | (~new_n79_ & x23)));
  assign new_n78_ = x17 & x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = new_n81_ | ~new_n50_ | new_n83_ | x15;
  assign new_n81_ = x24 & (~new_n82_ | ~x17 | ~x18 | ~x19);
  assign new_n82_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n83_ = new_n72_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x18 & (new_n85_ | x15)) | (~x15 & (~new_n50_ | (~new_n83_ & x25)));
  assign new_n85_ = new_n73_ & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
