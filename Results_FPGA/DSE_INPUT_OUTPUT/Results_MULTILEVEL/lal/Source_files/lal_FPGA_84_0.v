...
module FAU ( 
  ...
  assign z08 = (x09 | x15) & (x25 | (x24 & (new_n62_ | x23)));
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & (~x09 | (x04 & x05 & ~x07));
  assign z10 = ~x07 & x09 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = ~x15 & (~x09 | (~x07 & ~new_n52_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n67_ & x09;
  assign new_n67_ = ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n69_ & x20) | ~new_n51_ | ~x09 | new_n70_ | x15;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (x09 & (new_n52_ | ~new_n72_ | (~new_n70_ & x21)));
  assign new_n72_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x09 & (new_n75_ | new_n52_ | new_n74_ | x07));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n74_ & x23) | ~new_n51_ | ~x09 | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x09 & (~new_n79_ | new_n52_ | (~new_n77_ & x24)));
  assign new_n79_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = new_n81_ | ~new_n51_ | ~x09 | new_n82_ | x15;
