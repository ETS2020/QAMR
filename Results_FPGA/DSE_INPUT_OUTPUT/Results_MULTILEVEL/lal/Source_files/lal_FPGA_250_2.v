// Benchmark "FAU" written by ABC on Tue Aug 18 17:08:44 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n61_, new_n67_,
    new_n68_, new_n70_, new_n72_, new_n73_, new_n75_, new_n77_, new_n79_;
  assign z00 = ~z02 & x08;
  assign z02 = x16 | (x07 & ~x15);
  assign z01 = x07 ? x15 : (new_n52_ | (~new_n50_ & ~x25));
  ...
  assign z08 = (x24 & (new_n61_ | x23)) | x25 | (x07 & ~x15);
  assign new_n61_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & (new_n52_ | x07);
  assign z10 = ~x07 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = ~x15 & (x07 | (~new_n52_ & (x17 ^ x18)));
  assign z12 = ~x15 & (x07 | (~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  assign z13 = x15 | (~x07 & ((~new_n67_ & x20) | new_n52_ | new_n68_));
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n68_ & x21) | new_n52_ | x07 | new_n70_ | x15;
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n70_ & x22) | new_n72_ | x15 | new_n52_ | x07;
  assign new_n72_ = new_n67_ & new_n73_ & ~x20;
  assign new_n73_ = ~x21 & ~x22;
  assign z16 = x15 | (~x07 & (new_n75_ | new_n52_ | (~new_n72_ & x23)));
  assign new_n75_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (~new_n77_ | (~new_n75_ & x24)));
  assign new_n77_ = ~new_n52_ & (~new_n68_ | ~new_n73_ | x23 | x24);
  assign z18 = x15 | (~new_n79_ & ~x07);
  assign new_n79_ = (~x25 | (new_n68_ & new_n73_ & ~x23 & ~x24)) & ~new_n52_ & (~new_n68_ | ~new_n73_ | x23 | x24 | x25);
endmodule
