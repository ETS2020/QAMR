...
module FAU ( 
  ...
  assign z11 = ~new_n66_ & ~x15;
  assign new_n66_ = x20 & (x07 | (x04 & x05) | (~x17 ^ x18));
  assign z12 = ~x07 & new_n68_ & ~x15;
  assign new_n68_ = x20 & (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n70_ & x20);
  assign new_n70_ = ~x07 & (~x04 | ~x05) & x17 & x18 & x19;
  assign z14 = x15 | (x20 & ((x04 & x05) | x07 | x21));
  assign z15 = ~x20 | x22 | x15 | x07 | (x04 & x05);
  assign z16 = ~x20 | x23 | x15 | x07 | (x04 & x05);
  assign z17 = ~x20 | x24 | x15 | x07 | (x04 & x05);
  assign z18 = ~x20 | x25 | x15 | x07 | (x04 & x05);
endmodule
