...
module FAU ( 
  ...
  assign z12 = ~x07 & (x05 | (~x15 & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  assign z13 = x07 | (~x05 & ((~new_n66_ & x20) | new_n67_ | x15));
  assign new_n66_ = x17 & x18 & x19;
  assign new_n67_ = x17 & x18 & x19 & ~x20;
  assign z14 = x07 | (~x05 & ((~new_n67_ & x21) | new_n69_ | x15));
  assign new_n69_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 | (~x05 & ((~new_n69_ & x22) | new_n71_ | x15));
  assign new_n71_ = new_n66_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n71_ & x23) | new_n73_ | x15 | x05 | x07;
  assign new_n73_ = new_n66_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 | (~x05 & ((~new_n73_ & x24) | new_n75_ | x15));
  assign new_n75_ = new_n67_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n75_ & x25) | new_n77_ | x15 | x05 | x07;
  assign new_n77_ = new_n67_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
