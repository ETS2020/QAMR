...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & ~x25) | new_n51_ | x07 | (~x10 & x15);
  ...
  assign z08 = (x24 & (new_n61_ | x23)) | (~x10 & x15) | x25;
  ...
  assign z13 = x15 ? x10 : ~new_n67_;
  assign new_n67_ = (~x20 | (x17 & x18 & x19)) & ~new_n51_ & ~x07 & (~x19 | x20 | ~x17 | ~x18);
  assign z14 = x15 ? x10 : (new_n51_ | ~new_n70_ | (~new_n69_ & x21));
  ...
  assign z17 = x15 ? x10 : (~new_n78_ | new_n51_ | (~new_n75_ & x24));
