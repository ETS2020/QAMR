...
module FAU ( 
  ...
  assign z09 = (x15 & x21) | (new_n50_ & ~x07 & ~x15);
  ...
  assign z14 = (~new_n71_ & x21) | ~new_n73_ | new_n74_ | x15;
  assign new_n73_ = ~new_n50_ & ~x07;
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~x21 & (new_n76_ | x15)) | (~x15 & (~new_n73_ | (~new_n74_ & x22)));
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x22;
  assign z16 = (~new_n78_ & x23) | ~new_n73_ | new_n79_ | x15;
  assign new_n78_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign new_n79_ = new_n70_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~x21 & (new_n81_ | x15)) | (~x15 & (~new_n73_ | (~new_n79_ & x24)));
  assign new_n81_ = new_n70_ & ~x20 & ~x22 & ~x23 & ~x24;
  assign z18 = (x25 & (~new_n71_ | ~new_n83_)) | ~new_n73_ | (new_n71_ & new_n84_) | x15;
