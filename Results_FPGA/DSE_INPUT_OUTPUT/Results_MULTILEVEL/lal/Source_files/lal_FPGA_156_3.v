...
module FAU ( 
  ...
  assign z09 = (x01 & x15) | (new_n51_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = (x01 & x15) | (~x07 & ~x15 & ~new_n51_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? ~x01 : ~new_n67_;
  ...
  assign z16 = x15 ? ~x01 : (~new_n75_ | new_n51_ | (~new_n73_ & x23));
  assign new_n75_ = ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? ~x01 : (new_n77_ | ~new_n78_ | new_n51_);
