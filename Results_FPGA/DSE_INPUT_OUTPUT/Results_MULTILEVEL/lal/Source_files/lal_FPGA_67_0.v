...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n53_, new_n56_, new_n58_,
    new_n59_, new_n64_, new_n65_, new_n72_, new_n73_, new_n74_, new_n76_,
  ...
  assign z08 = ~new_n65_ | (~new_n64_ & ~x19);
  assign new_n64_ = x15 & (x17 | x18 | ~x21 | ~x22 | ~x24);
  assign new_n65_ = ~x25 & (~x24 | (~x23 & (~x20 | ~x21 | ~x22)));
  assign z09 = x19 & ~x15 & new_n51_ & ~x07;
  assign z10 = ~x07 & ~x15 & ~x17 & ~new_n51_ & x19;
  assign z11 = ~x15 & (~x19 | (~x07 & ~new_n51_ & (~x17 ^ ~x18)));
  assign z12 = ~x07 & ~x15 & x19 & ~new_n51_ & (~x17 | ~x18);
  ...
  assign z16 = new_n79_ | ~new_n50_ | x15 | new_n78_ | ~x19;
  ...
  assign z18 = new_n83_ | ~new_n50_ | ~new_n84_ | x15;
  assign new_n83_ = x25 & (~new_n73_ | x21 | x22 | x23 | x24);
  assign new_n84_ = x19 & (~new_n74_ | x22 | x23 | x24 | x25);
endmodule
