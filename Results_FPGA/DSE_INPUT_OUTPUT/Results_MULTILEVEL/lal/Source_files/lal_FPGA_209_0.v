...
module FAU ( 
  ...
  assign z03 = ~x25 & (((x15 | x20) & (new_n53_ | ~x24)) | (x15 & new_n54_ & ~x20));
  assign new_n53_ = ~x23 & (~x21 | ~x22);
  assign new_n54_ = ~x23 & (x17 | x18 | x19);
  assign z04 = ~x08 & (~new_n56_ | ~new_n57_) & (x15 | x20);
  ...
  assign z08 = (x24 & ((~new_n62_ & x15) | (~new_n53_ & x20))) | (x25 & (x15 | x20));
  assign new_n62_ = ~x23 & (x17 | x18 | x19 | ~x21 | ~x22);
  assign z09 = x20 & ~x15 & new_n64_ & ~x07;
  assign new_n64_ = x04 & x05;
  assign z10 = ~x07 & ~x15 & ~x17 & ~new_n64_ & x20;
  assign z11 = ~x15 & (~x20 | (~x07 & ~new_n64_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n68_ & ~x15;
  assign new_n68_ = x20 & (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~x07 & ~x15 & x19 & x20 & ~new_n64_ & ~new_n70_) | new_n64_ | x07 | x15 | ~x19 | ~x20;
  assign new_n70_ = x17 & x18;
  assign z14 = ~x20 | x21 | x15 | new_n64_ | x07;
  assign z15 = x15 | (x20 & (new_n64_ | x07 | x22));
  assign z16 = x15 | (x20 & (new_n64_ | x07 | x23));
  assign z17 = x15 | (x20 & (new_n64_ | x07 | x24));
  assign z18 = ~x20 | x25 | x15 | new_n64_ | x07;
endmodule
