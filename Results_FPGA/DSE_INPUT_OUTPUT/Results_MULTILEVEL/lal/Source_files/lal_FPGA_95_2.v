...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n62_ | x23)) | x15 | x25;
  ...
  assign z17 = x15 ? x25 : (~new_n78_ | new_n50_ | (~new_n75_ & x24));
  assign new_n78_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = new_n81_ | (~x15 & (new_n50_ | new_n80_ | x07));
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n81_ = x25 & (~new_n82_ | x15 | ~x17 | ~x18 | ~x19);
