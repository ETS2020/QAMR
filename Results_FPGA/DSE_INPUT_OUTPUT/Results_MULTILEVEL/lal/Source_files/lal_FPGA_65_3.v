...
module FAU ( 
  ...
  assign z12 = (x05 & x15) | (~x07 & ~x15 & ~new_n65_ & (~x04 | ~x05));
  assign new_n65_ = (~x19 | (x17 & x18)) & (~x17 | ~x18 | x19);
  assign z13 = x15 ? ~x05 : ~new_n67_;
  assign new_n67_ = (new_n68_ | ~x20) & ~new_n69_ & ~x07 & (~x04 | ~x05);
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n69_ & x21) | ~new_n71_ | x07 | (x04 & x05);
  ...
  assign z17 = x15 ? ~x05 : (new_n78_ | new_n79_ | x07 | (x04 & x05));
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x05 : (new_n81_ | new_n82_ | x07 | (x04 & x05));
