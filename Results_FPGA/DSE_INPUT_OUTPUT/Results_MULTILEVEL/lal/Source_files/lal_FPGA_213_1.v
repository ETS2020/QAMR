...
module FAU ( 
  ...
  assign z12 = (~x12 & x15) | (~x07 & new_n66_ & ~x15);
  assign new_n66_ = ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? x12 : ~new_n68_;
  assign new_n68_ = (~x20 | (x17 & x18 & x19)) & ~new_n52_ & ~x07 & (~x17 | ~x18 | ~x19 | x20);
  assign z14 = (~new_n70_ & x21) | new_n52_ | x07 | new_n71_ | x15;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n71_ & x22) | new_n52_ | x07 | new_n73_ | x15;
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n73_ & x23) | new_n75_ | x15 | new_n52_ | x07;
  assign new_n75_ = new_n76_ & x17 & x18 & x19;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 ? x12 : (~new_n78_ | new_n52_ | (~new_n75_ & x24));
  assign new_n78_ = ~x07 & (~new_n70_ | x23 | x24 | x21 | x22);
  assign z18 = x15 ? x12 : (~new_n81_ | new_n52_ | (~new_n80_ & x25));
