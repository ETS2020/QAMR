...
module FAU ( 
  ...
  assign z07 = x08 | ~x06 | (x01 & ~x15);
  assign z08 = (~x01 | x15) & (x25 | (x24 & (new_n61_ | x23)));
  assign new_n61_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & ~x07 & x05 & ~x01 & x04;
  assign z10 = ~x01 & ~x07 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = ~x01 & ~x07 & ~x15 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x01 & new_n66_ & ~x07;
  assign new_n66_ = ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n69_ & x20) | ~new_n68_ | x07 | new_n70_ | x15;
  assign new_n68_ = ~new_n51_ & ~x01;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n70_ & x21) | ~new_n68_ | ~new_n72_ | x07;
  assign new_n72_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x01 & (new_n75_ | new_n51_ | new_n74_ | x07));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n74_ & x23) | ~new_n68_ | x07 | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n77_ & x24) | ~new_n68_ | x07 | new_n79_ | x15;
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x01 & (~new_n81_ | new_n51_ | (~new_n79_ & x25)));
