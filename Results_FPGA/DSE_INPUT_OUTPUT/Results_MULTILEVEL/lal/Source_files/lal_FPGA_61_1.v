...
module FAU ( 
  ...
  assign z04 = (~x15 & x19) | (~x08 & (~new_n57_ | ~new_n58_));
  ...
  assign z13 = x15 | (~x19 & (new_n66_ | x07 | x20));
  assign z14 = x15 | (~x19 & (new_n66_ | x07 | x21));
  assign z15 = x15 | (~x19 & (new_n66_ | x07 | x22));
  assign z16 = x19 | x23 | ~new_n50_ | x15;
  assign z17 = x19 | x24 | ~new_n50_ | x15;
  assign z18 = x19 | x25 | ~new_n50_ | x15;
endmodule
