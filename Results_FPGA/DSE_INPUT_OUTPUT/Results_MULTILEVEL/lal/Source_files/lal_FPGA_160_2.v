...
module FAU ( 
  ...
  assign z10 = (x15 & ~x19) | (~x07 & ~x15 & ~new_n51_ & ~x17);
  ...
  assign z14 = (x19 & (x15 | (new_n72_ & ~x20 & ~x21))) | (~x15 & (~new_n50_ | (x21 & (~new_n72_ | ~x19 | x20))));
  assign new_n72_ = x17 & x18;
  assign z15 = new_n74_ | ~new_n50_ | new_n75_ | x15;
  assign new_n74_ = x22 & (~new_n72_ | ~x19 | x20 | x21);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (x19 & (new_n77_ | x15)) | (~x15 & (~new_n50_ | (~new_n75_ & x23)));
  assign new_n77_ = ~x21 & ~x22 & ~x23 & x17 & x18 & ~x20;
  assign z17 = new_n79_ | ~new_n50_ | new_n81_ | x15;
  ...
  assign z18 = ~new_n50_ | new_n84_ | x15 | (~new_n81_ & x25);
