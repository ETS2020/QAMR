...
module FAU ( 
  ...
  assign z01 = new_n50_ | (x04 & x05) | x07 | (~x24 & ~x25);
  assign new_n50_ = ~x23 & (new_n51_ | x20);
  assign new_n51_ = ~x25 & (x17 | x18 | x19 | ~x21 | ~x22);
  assign z02 = ~new_n48_ & x16;
  assign z03 = new_n50_ | (~x24 & ~x25);
  ...
  assign z13 = (x20 & (~new_n69_ | ~x19 | ~x23)) | ~new_n70_ | x15 | (new_n69_ & x19 & ~x20);
  assign new_n69_ = x17 & x18;
  assign new_n70_ = ~x07 & (~x04 | ~x05);
  assign z14 = (x20 & (x21 | ~x23)) | (~new_n73_ & x21) | ~new_n72_ | ~new_n70_;
  assign new_n72_ = ~x15 & (~new_n69_ | ~x19 | x20 | x21);
  assign new_n73_ = x17 & x18 & x19;
  assign z15 = (~new_n75_ & (~x20 | (~x22 & x23))) | (~new_n76_ & ~x20) | (x20 & x22 & x23);
  assign new_n75_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign new_n76_ = (~x22 | (x17 & x18 & x19 & ~x21)) & (~x17 | ~x18 | ~x19 | x21 | x22);
  assign z16 = (~new_n75_ & (~x20 | x23)) | (x23 & (~new_n73_ | x20 | x21 | x22)) | (new_n73_ & ~x22 & ~x23 & ~x20 & ~x21);
  assign z17 = new_n79_ | (x23 & x24) | (~new_n80_ & ~x20);
  assign new_n79_ = ~new_n48_ & ~new_n75_;
  assign new_n80_ = (~x24 | (x17 & x18 & new_n81_ & x19)) & (~x17 | ~x18 | ~x19 | ~new_n81_ | x23 | x24);
  assign new_n81_ = ~x21 & ~x22;
  assign z18 = new_n79_ | (x23 & x25) | (~new_n83_ & ~x20);
  assign new_n83_ = (~new_n84_ | x24 | x25 | x22 | x23) & (new_n85_ | ~x25);
  assign new_n84_ = x17 & x18 & x19 & ~x21;
  assign new_n85_ = x17 & x18 & x19 & ~x21 & ~x22 & ~x24;
endmodule
