...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n52_, new_n56_, new_n57_, new_n62_,
    new_n67_, new_n70_, new_n71_, new_n73_, new_n75_, new_n76_, new_n78_,
  ...
  assign z11 = (x15 & ~x24) | (~x07 & ~x15 & ~new_n52_ & (x17 ^ x18));
  assign z12 = (x15 & ~x24) | (~x07 & new_n67_ & ~x15);
  assign new_n67_ = ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n51_ | x15 | (x17 & x18 & x19 & ~x20);
  assign z14 = (~new_n70_ & x21) | ~new_n51_ | new_n71_ | x15;
  ...
  assign z16 = x15 ? x24 : (~new_n75_ | (~new_n73_ & x23));
  assign new_n75_ = ~new_n52_ & ~x07 & (~new_n76_ | ~x17 | ~x18 | ~x19);
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = ~new_n78_ | (~new_n51_ & (~x15 | x24));
  assign new_n78_ = (~x24 | (new_n79_ & ~x20 & ~x21 & ~x22 & ~x23)) & (~new_n79_ | x20 | x21 | x22 | x23 | x24);
  assign new_n79_ = ~x15 & x17 & x18 & x19;
  assign z18 = (x25 & (~new_n70_ | ~new_n81_)) | ~new_n51_ | x15 | (new_n70_ & new_n82_);
