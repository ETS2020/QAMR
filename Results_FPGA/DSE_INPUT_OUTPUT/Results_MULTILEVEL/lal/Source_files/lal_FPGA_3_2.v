...
module FAU ( 
  ...
  assign z15 = new_n75_ | new_n74_ | x15 | new_n50_ | x07;
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = ((new_n50_ | x07) & (~x15 | x23)) | new_n79_ | (~new_n77_ & x23);
  assign new_n77_ = new_n78_ & ~x15 & x17 & x18;
  assign new_n78_ = ~x21 & ~x22 & x19 & ~x20;
  assign new_n79_ = new_n80_ & x18 & x19 & ~x15 & x17;
  assign new_n80_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = new_n82_ | new_n83_ | x15 | new_n50_ | x07;
  assign new_n82_ = x24 & (~new_n69_ | ~new_n80_);
  assign new_n83_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n83_ & x25) | new_n85_ | x15 | new_n50_ | x07;
