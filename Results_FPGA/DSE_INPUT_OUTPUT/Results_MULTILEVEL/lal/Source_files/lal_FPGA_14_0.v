...
module FAU ( 
  ...
  assign z14 = (~new_n71_ & x21) | ~new_n70_ | ~new_n72_ | x07;
  assign new_n70_ = ~new_n51_ & x02;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign new_n72_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x02 & (new_n74_ | new_n51_ | new_n75_ | x07));
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n75_ & x23) | ~new_n70_ | x07 | new_n77_ | x15;
  ...
  assign z18 = new_n82_ | ~new_n70_ | x07 | new_n83_ | x15;
