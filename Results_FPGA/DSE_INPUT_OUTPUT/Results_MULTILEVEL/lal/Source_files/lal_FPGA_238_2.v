// Benchmark "FAU" written by ABC on Tue Aug 18 17:08:41 2020
...
module FAU ( 
  ...
  assign z17 = (~new_n75_ & x24) | ~new_n63_ | ~new_n78_;
  assign new_n78_ = ~x15 & (~new_n69_ | ~new_n73_ | x23 | x24);
  assign z18 = x15 | (~new_n80_ & ~x07);
  assign new_n80_ = (~x25 | (new_n69_ & new_n73_ & ~x23 & ~x24)) & ~new_n51_ & (~new_n69_ | ~new_n73_ | x23 | x24 | x25);
endmodule
