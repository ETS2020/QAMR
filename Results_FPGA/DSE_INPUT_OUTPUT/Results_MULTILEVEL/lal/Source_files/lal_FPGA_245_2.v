...
module FAU ( 
  ...
  assign z08 = (~x03 | x15) & (x25 | (x24 & (new_n61_ | x23)));
  ...
  assign new_n68_ = ~new_n51_ & ~x03;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~x03 & ((~new_n70_ & x21) | new_n51_ | ~new_n72_));
  ...
  assign z17 = x15 | (~x03 & (~new_n79_ | new_n51_ | (~new_n77_ & x24)));
  assign new_n79_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = new_n81_ | ~new_n68_ | x07 | new_n82_ | x15;
