...
module FAU ( 
  ...
  assign z01 = (~x13 | ~x15) & (~new_n51_ | (~new_n49_ & ~x25));
  ...
  assign z15 = x15 ? ~x13 : (new_n72_ | new_n52_ | new_n73_ | x07);
  assign new_n72_ = x22 & (~new_n70_ | ~x19 | x20 | x21);
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n51_ | new_n75_ | x15 | (~new_n73_ & x23);
  ...
  assign z18 = (~new_n78_ & x25) | ~new_n51_ | new_n81_ | x15;
  assign new_n81_ = new_n79_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
