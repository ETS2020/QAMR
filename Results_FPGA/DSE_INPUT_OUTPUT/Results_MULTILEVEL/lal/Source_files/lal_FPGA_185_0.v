...
module FAU ( 
  ...
  assign z01 = (x02 | x15) & (new_n49_ | new_n51_ | x07);
  ...
  assign z04 = (~new_n55_ & ~x08) | (~x02 & (~x15 | (~x08 & x11)));
  ...
  assign z09 = ~x15 & (~x02 | (x04 & x05 & ~x07));
  assign z10 = ~x15 & (~x02 | (~x07 & ~new_n51_ & ~x17));
  assign z11 = x02 & ~x07 & ~x15 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x15 & (new_n66_ | ~x02);
  assign new_n66_ = ~x07 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n68_ & x02);
  assign new_n68_ = (~x20 | (x17 & x18 & x19)) & ~new_n51_ & ~x07 & (~x19 | x20 | ~x17 | ~x18);
  assign z14 = x15 | (x02 & ((~new_n70_ & x21) | new_n51_ | ~new_n71_));
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n74_ | ~new_n73_ | x07 | new_n75_ | x15;
  assign new_n73_ = ~new_n51_ & x02;
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n75_ & x23) | ~new_n73_ | x07 | new_n77_ | x15;
  assign new_n77_ = new_n78_ & x17 & x18 & x19;
  assign new_n78_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x02 & (~new_n80_ | new_n51_ | (~new_n77_ & x24)));
  assign new_n80_ = ~x07 & (~new_n70_ | x23 | x24 | x21 | x22);
  assign z18 = new_n82_ | ~new_n73_ | x07 | new_n83_ | x15;
