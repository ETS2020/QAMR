...
module FAU ( 
  ...
  assign z08 = ((new_n61_ | x23) & x24) | ~x15 | x25;
  ...
  assign z13 = (~new_n68_ & x20) | ~new_n50_ | x15 | new_n69_ | ~x25;
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n69_ & x21) | ~new_n50_ | ~new_n71_ | x15;
  assign new_n71_ = x25 & (~x17 | ~x18 | ~x19 | x20 | x21);
  ...
  assign z16 = (~new_n73_ & x23) | ~new_n50_ | x15 | new_n76_ | ~x25;
  assign new_n76_ = new_n68_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x25 & (~new_n78_ | new_n51_ | (~new_n76_ & x24)));
  assign new_n78_ = ~x07 & (~new_n69_ | x21 | x22 | x23 | x24);
  assign z18 = ~new_n80_ | ~new_n50_ | x15 | ~x19 | ~x17 | ~x18;
  assign new_n80_ = x25 & ~x23 & ~x24 & ~x22 & ~x20 & ~x21;
endmodule
