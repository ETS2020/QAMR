...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & ~x25) | new_n51_ | x07 | (~x14 & ~x15);
  ...
  assign z09 = ~x15 & (~x14 | (x04 & x05 & ~x07));
  ...
  assign z13 = (~new_n69_ & x20) | ~new_n68_ | ~x14 | new_n70_ | x15;
  assign new_n68_ = ~new_n51_ & ~x07;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n70_ & x21) | ~new_n68_ | ~x14 | new_n72_ | x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n72_ & x22) | ~new_n68_ | ~x14 | new_n74_ | x15;
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x14 & (~new_n76_ | new_n51_ | (~new_n74_ & x23)));
  assign new_n76_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = new_n78_ | ~new_n68_ | ~x14 | new_n79_ | x15;
  assign new_n78_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n79_ & x25) | ~new_n68_ | ~x14 | new_n81_ | x15;
