...
module FAU ( 
  ...
  assign z15 = x15 | (~x07 & ((~new_n70_ & x22) | new_n51_ | new_n72_));
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n72_ & x23) | ~new_n63_ | new_n74_ | x15;
  assign new_n74_ = new_n75_ & x17 & x18 & x19;
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (new_n77_ | new_n51_ | (~new_n74_ & x24)));
  assign new_n77_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n77_ & x25) | ~new_n63_ | new_n79_ | x15;
