...
module FAU ( 
  ...
  assign z01 = (~x02 | ~x15) & (~new_n51_ | (~new_n49_ & ~x25));
  ...
  assign z04 = (x02 & (x15 | (~x08 & ~x11))) | (~new_n56_ & ~x08);
  ...
  assign z08 = (x24 & (new_n62_ | x23)) | x25 | (x02 & x15);
  ...
  assign z12 = (x02 & x15) | (~x07 & new_n67_ & ~x15);
  ...
  assign z16 = x15 ? ~x02 : ((~new_n74_ & x23) | ~new_n76_ | new_n52_);
  assign new_n76_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? ~x02 : (new_n78_ | new_n52_ | new_n79_ | x07);
  assign new_n78_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x02 : ((~new_n79_ & x25) | ~new_n81_ | new_n52_);
