...
module FAU ( 
  ...
  assign z16 = x07 ? ~x15 : ((~new_n72_ & x23) | new_n53_ | new_n74_ | x15);
  assign new_n74_ = new_n75_ & x17 & x18 & x19;
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 ? ~x15 : ((~new_n74_ & x24) | new_n53_ | new_n77_ | x15);
  assign new_n77_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n77_ & x25) | ~new_n52_ | new_n79_ | x15;
