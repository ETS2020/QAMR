...
module FAU ( 
  ...
  assign z14 = (x19 & (x15 | (new_n72_ & ~x20 & ~x21))) | (~x15 & (~new_n68_ | (x21 & (~new_n72_ | ~x19 | x20))));
  assign new_n72_ = x17 & x18;
  assign z15 = (x19 & (x15 | (new_n72_ & new_n75_))) | (~x15 & (~new_n68_ | new_n74_));
  assign new_n74_ = x22 & (~new_n72_ | ~x19 | x20 | x21);
  assign new_n75_ = ~x20 & ~x21 & ~x22;
  assign z16 = (x23 & (~new_n69_ | ~new_n75_)) | ~new_n68_ | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (x19 & (new_n79_ | x15)) | (~x15 & (~new_n68_ | (~new_n77_ & x24)));
  assign new_n79_ = new_n80_ & x17 & x18 & ~x20;
  assign new_n80_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x19 & (x15 | (new_n82_ & new_n84_))) | ((~new_n68_ | new_n83_) & ~x15);
  assign new_n82_ = new_n72_ & ~x20 & ~x21;
  assign new_n83_ = x25 & (~new_n70_ | ~new_n80_);
