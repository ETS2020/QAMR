...
module FAU ( 
  ...
  assign z01 = (x03 | x15) & (new_n49_ | new_n51_ | x07);
  ...
  assign z14 = (~new_n70_ & x21) | ~new_n69_ | ~new_n71_ | x07;
  assign new_n69_ = ~new_n51_ & x03;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x03 & (new_n73_ | new_n51_ | new_n74_ | x07));
  assign new_n73_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | ~new_n69_ | x07 | new_n76_ | x15;
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n76_ & x24) | ~new_n69_ | x07 | new_n79_ | x15;
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n79_ & x25) | ~new_n69_ | x07 | new_n81_ | x15;
