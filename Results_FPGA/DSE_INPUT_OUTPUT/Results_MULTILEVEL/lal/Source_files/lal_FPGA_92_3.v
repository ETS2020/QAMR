...
module FAU ( 
  ...
  assign new_n51_ = ((~x17 & ~x18 & ~x19) | x20) & x21 & x22;
  ...
  assign new_n61_ = x21 & x22 & ((~x17 & ~x18 & ~x19) | x20);
  assign z09 = ~x15 & new_n52_ & ~x07;
  assign z10 = x07 ? x15 : (~x15 & ~new_n52_ & ~x17);
  assign z11 = x07 ? x15 : (~x15 & ~new_n52_ & (x17 ^ x18));
  assign z12 = x07 ? x15 : (~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19)));
  assign z13 = x07 ? ~x15 : ((~new_n67_ & x20) | new_n52_ | new_n68_ | x15);
  ...
  assign z16 = x07 ? ~x15 : ((~new_n72_ & x23) | new_n52_ | new_n74_ | x15);
  assign new_n74_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 ? ~x15 : ((~new_n74_ & x24) | new_n52_ | new_n76_ | x15);
