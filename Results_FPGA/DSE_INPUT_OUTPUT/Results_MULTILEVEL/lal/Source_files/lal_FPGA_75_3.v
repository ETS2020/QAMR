...
module FAU ( 
  ...
  assign z01 = (x04 & (x05 | x15)) | x07 | (~new_n50_ & ~x25);
  ...
  assign z12 = (x04 & x15) | (~x07 & ~x15 & ~new_n66_ & (~x04 | ~x05));
  assign new_n66_ = (~x19 | (x17 & x18)) & (~x17 | ~x18 | x19);
  assign z13 = x15 ? ~x04 : ~new_n68_;
  assign new_n68_ = (new_n69_ | ~x20) & ~new_n63_ & ~new_n70_ & ~x07;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 ? ~x04 : ((~new_n70_ & x21) | ~new_n72_ | (x04 & x05));
  assign new_n72_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x04 : (new_n75_ | (x04 & x05) | new_n74_ | x07);
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 ? ~x04 : ((~new_n74_ & x23) | ~new_n77_ | (x04 & x05));
  assign new_n77_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = new_n79_ | new_n63_ | x07 | new_n80_ | x15;
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x04 : (new_n82_ | (x04 & x05) | new_n83_ | x07);
