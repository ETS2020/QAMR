...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & (~x15 | x17)) | (new_n51_ & ~x20);
  ...
  assign z08 = (~new_n62_ & (~x15 | x17)) | (new_n63_ & ~x15 & ~x17 & ~x18);
  ...
  assign z11 = (x15 & ~x17) | (~x07 & ~new_n65_ & ((~x17 & x18) | (~x15 & x17 & ~x18)));
  assign z12 = (x15 & ~x17) | (~x07 & ~new_n65_ & ((~x15 & ((~x18 & x19) | (x17 & x18 & ~x19))) | (~x17 & x19)));
  assign z13 = (x17 & (x15 | (x18 & x19 & ~x20))) | (~x15 & (~new_n50_ | (x20 & (~x17 | ~x18 | ~x19))));
  assign z14 = (x17 & (new_n71_ | x15)) | (~x15 & (~new_n50_ | (~new_n72_ & x21)));
