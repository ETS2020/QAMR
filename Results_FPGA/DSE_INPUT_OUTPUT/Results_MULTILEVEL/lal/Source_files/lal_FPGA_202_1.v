...
module FAU ( 
  ...
  assign z01 = (new_n49_ | new_n51_ | x07) & (x12 | ~x15);
  ...
  assign z09 = (~x12 & x15) | (new_n51_ & ~x07 & ~x15);
  ...
  assign z16 = (~new_n73_ & x23) | new_n51_ | x07 | new_n76_ | x15;
  assign new_n76_ = new_n68_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n76_ & x24) | new_n51_ | x07 | new_n78_ | x15;
  assign new_n78_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? x12 : (~new_n80_ | new_n51_ | (~new_n78_ & x25));
