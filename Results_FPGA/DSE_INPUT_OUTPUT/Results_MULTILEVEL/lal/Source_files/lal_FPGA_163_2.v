...
module FAU ( 
  ...
  assign z09 = (x15 & ~x19) | (new_n51_ & ~x07 & ~x15);
  ...
  assign z13 = (x19 & (x15 | (x17 & x18 & ~x20))) | (~x15 & (~new_n68_ | (x20 & (~x17 | ~x18 | ~x19))));
  assign new_n68_ = ~new_n51_ & ~x07;
  assign z14 = (x21 & (~new_n70_ | ~x19 | x20)) | ~new_n68_ | x15 | (new_n70_ & x19 & ~x20 & ~x21);
  assign new_n70_ = x17 & x18;
  assign z15 = (x19 & (new_n72_ | x15)) | (~x15 & (~new_n68_ | new_n73_));
  assign new_n72_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign new_n73_ = x22 & (~new_n70_ | ~x19 | x20 | x21);
  assign z16 = (x19 & (new_n75_ | x15)) | (~x15 & (~new_n68_ | (~new_n76_ & x23)));
  assign new_n75_ = x17 & x18 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = new_n78_ | ~new_n68_ | new_n80_ | x15;
  assign new_n78_ = x24 & (~new_n79_ | ~x17 | ~x18 | ~x19);
  assign new_n79_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n80_ = new_n81_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n81_ = x17 & x18 & x19 & ~x20;
  assign z18 = (x19 & (new_n83_ | x15)) | (~x15 & (~new_n68_ | (~new_n80_ & x25)));
  assign new_n83_ = new_n84_ & new_n70_ & ~x20 & ~x21;
