...
module FAU ( 
  ...
  assign new_n54_ = (x15 | ~x19) & (~x24 | (~x23 & (~x21 | ~x22)));
  assign new_n55_ = ~x20 & ~x23 & (x19 ? x15 : (x17 | x18));
  assign z04 = ~x08 & (~new_n57_ | ~new_n58_) & (x15 | ~x19);
  ...
  assign z13 = x19 | x20 | x15 | new_n51_ | x07;
  assign z14 = x19 | x21 | x15 | new_n51_ | x07;
  assign z15 = x19 | x22 | x15 | new_n51_ | x07;
  assign z16 = x15 | (~x19 & (new_n51_ | x07 | x23));
  assign z17 = x19 | x24 | x15 | new_n51_ | x07;
  assign z18 = x19 | x25 | x15 | new_n51_ | x07;
endmodule
