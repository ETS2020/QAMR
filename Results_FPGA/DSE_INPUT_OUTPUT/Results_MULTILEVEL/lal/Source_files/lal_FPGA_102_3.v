...
module FAU ( 
  ...
  assign z01 = (~x09 | ~x15) & (~new_n51_ | (~new_n49_ & ~x25));
  ...
  assign z03 = ~x25 & ~new_n49_ & (~x09 | ~x15);
  assign z04 = (x09 & (x15 | (~x00 & ~x08))) | (~x08 & (~new_n57_ | ~new_n56_ | (x00 & ~x09)));
  ...
  assign z08 = (x24 & (new_n62_ | x23)) | (x09 & x15) | x25;
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & new_n52_ & ~x07;
  assign z10 = ~x07 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = (x09 & x15) | (~x07 & ~x15 & ~new_n52_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n68_ & x20) | ~new_n51_ | new_n69_ | x15;
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = (x21 & (~new_n71_ | ~x19 | x20)) | ~new_n51_ | x15 | (new_n71_ & x19 & ~x20 & ~x21);
  assign new_n71_ = x17 & x18;
  assign z15 = x15 ? ~x09 : (new_n73_ | new_n52_ | new_n74_ | x07);
  assign new_n73_ = x22 & (~new_n71_ | ~x19 | x20 | x21);
  assign new_n74_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 ? ~x09 : ((~new_n74_ & x23) | ~new_n76_ | new_n52_);
  assign new_n76_ = ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = new_n78_ | ~new_n51_ | new_n79_ | x15;
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n79_ & x25) | ~new_n51_ | new_n81_ | x15;
  assign new_n81_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
