...
module FAU ( 
  ...
  assign z01 = (~x14 | x15) & (~new_n51_ | (~new_n49_ & ~x25));
  ...
  assign z11 = ~x15 & (x14 | (~x07 & ~new_n52_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n67_ & ~x14;
  ...
  assign z17 = x15 | (~x14 & (~new_n80_ | new_n52_ | (~new_n77_ & x24)));
  assign new_n80_ = ~x07 & (~new_n71_ | x23 | x24 | x21 | x22);
  assign z18 = new_n82_ | ~new_n51_ | x14 | new_n83_ | x15;
  assign new_n82_ = x25 & (~new_n71_ | x21 | x22 | x23 | x24);
  assign new_n83_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
