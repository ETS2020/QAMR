...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n56_, new_n57_, new_n62_,
    new_n67_, new_n69_, new_n70_, new_n71_, new_n74_, new_n75_, new_n77_,
  ...
  assign z12 = (x15 & x21) | (~x07 & new_n67_ & ~x15);
  assign new_n67_ = ~new_n50_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? ~x21 : ~new_n69_;
  assign new_n69_ = (new_n70_ | ~x20) & ~new_n50_ & ~new_n71_ & ~x07;
  assign new_n70_ = x17 & x18 & x19;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~x21 & (new_n71_ | x15)) | (~x15 & ((~new_n71_ & x21) | new_n50_ | x07));
  assign z15 = (~x21 & (new_n74_ | x15)) | (~x15 & (new_n75_ | new_n50_ | x07));
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n77_ & x23) | new_n50_ | x07 | new_n78_ | x15;
  assign new_n77_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign new_n78_ = new_n70_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~x21 & (new_n80_ | x15)) | (~x15 & (new_n81_ | new_n50_ | x07));
  assign new_n80_ = new_n70_ & ~x20 & ~x22 & ~x23 & ~x24;
  assign new_n81_ = x24 & (~new_n70_ | x20 | x21 | x22 | x23);
  assign z18 = new_n83_ | new_n50_ | x07 | new_n84_ | x15;
