...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n53_, new_n56_, new_n58_,
    new_n59_, new_n64_, new_n65_, new_n71_, new_n72_, new_n74_, new_n75_,
  ...
  assign z13 = (~new_n71_ & x20) | ~new_n50_ | new_n72_ | x15;
  assign new_n71_ = x17 & x18 & x19;
  assign new_n72_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~x19 & (x15 | x21)) | (~x15 & (new_n51_ | ~new_n75_ | (~new_n74_ & x21)));
  assign new_n74_ = x17 & x18 & ~x20;
  assign new_n75_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~new_n77_ & ~x15) | (~x19 & (x15 | x22));
  assign new_n77_ = ~new_n78_ & ~new_n51_ & ~new_n79_ & ~x07;
  assign new_n78_ = x22 & (~x17 | ~x18 | x20 | x21);
  assign new_n79_ = ~x20 & ~x21 & ~x22 & x17 & x18 & x19;
  assign z16 = (~new_n81_ & ~x15) | (~x19 & (x15 | x23));
  assign new_n81_ = ~new_n82_ & ~new_n51_ & ~x07 & (~new_n71_ | ~new_n83_);
  assign new_n82_ = x23 & (~x17 | ~x18 | x20 | x21 | x22);
  assign new_n83_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~x19 & (x15 | x24)) | (~x15 & (~new_n86_ | new_n51_ | (~new_n85_ & x24)));
  assign new_n85_ = new_n74_ & ~x21 & ~x22 & ~x23;
  assign new_n86_ = ~x07 & (~new_n72_ | ~new_n87_);
  assign new_n87_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x25 & (~new_n72_ | ~new_n87_)) | ~new_n50_ | x15 | (new_n72_ & new_n89_);
