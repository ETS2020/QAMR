...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n55_, new_n57_, new_n58_,
    new_n63_, new_n64_, new_n70_, new_n72_, new_n74_, new_n75_, new_n76_,
  ...
  assign z08 = ~new_n63_ | (~new_n64_ & ~x17);
  ...
  assign z11 = (x15 & ~x17) | (~x07 & ~new_n52_ & ((~x17 & x18) | (~x15 & x17 & ~x18)));
  ...
  assign z14 = (x21 & (~new_n72_ | ~x19 | x20)) | ~new_n70_ | x15 | (new_n72_ & x19 & ~x20 & ~x21);
  assign new_n72_ = x17 & x18;
  assign z15 = new_n74_ | ~new_n70_ | new_n76_ | x15;
  assign new_n74_ = x22 & (~new_n72_ | ~new_n75_ | ~x19);
  assign new_n75_ = ~x20 & ~x21;
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n76_ & x23) | ~new_n70_ | new_n78_ | x15;
  assign new_n78_ = x17 & x18 & x19 & new_n75_ & ~x22 & ~x23;
  assign z17 = ~new_n70_ | new_n80_ | x15 | (~new_n78_ & x24);
  assign new_n80_ = new_n81_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n81_ = x17 & x18 & x19 & ~x20;
  assign z18 = (x17 & (new_n83_ | x15)) | (~x15 & (~new_n70_ | (~new_n80_ & x25)));
  assign new_n83_ = new_n84_ & new_n75_ & x18 & x19;
