...
module FAU ( 
  ...
  assign z10 = ~x15 & (x12 | (~x07 & ~new_n51_ & ~x17));
  assign z11 = ~x15 & (x12 | (~x07 & ~new_n51_ & (x17 ^ x18)));
  assign z12 = ~x15 & (new_n66_ | x12);
  ...
  assign z14 = x15 | (~x12 & ((~new_n70_ & x21) | new_n51_ | ~new_n72_));
  ...
  assign z16 = (~new_n74_ & x23) | ~new_n68_ | x12 | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x12 & (~new_n79_ | new_n51_ | (~new_n77_ & x24)));
  assign new_n79_ = ~x07 & (~new_n70_ | x23 | x24 | x21 | x22);
  assign z18 = x15 | (~x12 & (~new_n82_ | new_n51_ | (~new_n81_ & x25)));
