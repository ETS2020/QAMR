...
module FAU ( 
  ...
  assign z00 = (x08 & ~x16) | (x13 & x15);
  assign z01 = (new_n49_ | new_n51_ | x07) & (~x13 | ~x15);
  ...
  assign z09 = (x13 & x15) | (new_n51_ & ~x07 & ~x15);
  assign z10 = (x13 & x15) | (~x07 & ~x15 & ~new_n51_ & ~x17);
  assign z11 = (x13 & x15) | (~x07 & ~x15 & ~new_n51_ & (x17 ^ x18));
  assign z12 = (x13 & x15) | (~x07 & new_n66_ & ~x15);
  ...
  assign z14 = x15 ? ~x13 : (new_n51_ | ~new_n71_ | (~new_n69_ & x21));
  assign new_n71_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x13 : (new_n74_ | new_n51_ | new_n73_ | x07);
  assign new_n73_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 ? ~x13 : ((~new_n73_ & x23) | ~new_n76_ | new_n51_);
  assign new_n76_ = ~x07 & (~new_n68_ | x22 | x23 | x20 | x21);
  assign z17 = x15 ? ~x13 : (new_n78_ | new_n51_ | new_n79_ | x07);
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x13 : ((~new_n79_ & x25) | ~new_n81_ | new_n51_);
