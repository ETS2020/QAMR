...
module FAU ( 
  ...
  assign z10 = (x15 & ~x19) | (~x07 & ~x15 & ~new_n65_ & ~x17);
  assign z11 = (x15 & ~x19) | (~x07 & ~x15 & ~new_n65_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n65_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (x19 & (x15 | (x17 & x18 & ~x20))) | (~x15 & (~new_n50_ | (x20 & (~x17 | ~x18 | ~x19))));
  assign z14 = (x21 & (~new_n71_ | ~x19 | x20)) | ~new_n50_ | x15 | (new_n71_ & x19 & ~x20 & ~x21);
  assign new_n71_ = x17 & x18;
  assign z15 = (x19 & (x15 | (new_n71_ & new_n74_))) | (~x15 & (new_n73_ | ~new_n50_));
  assign new_n73_ = x22 & (~new_n71_ | ~x19 | x20 | x21);
  assign new_n74_ = ~x20 & ~x21 & ~x22;
  assign z16 = (x23 & (~new_n77_ | ~new_n74_)) | ~new_n50_ | new_n76_ | x15;
  assign new_n76_ = new_n77_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n77_ = x17 & x18 & x19;
  assign z17 = (x19 & (new_n79_ | x15)) | (~x15 & (~new_n50_ | (~new_n76_ & x24)));
  assign new_n79_ = new_n80_ & x17 & x18 & ~x20;
  assign new_n80_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x19 & (new_n82_ | x15)) | (~x15 & (new_n84_ | ~new_n50_));
  assign new_n82_ = new_n83_ & new_n71_ & ~x20 & ~x21;
  assign new_n83_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n84_ = x25 & (~new_n80_ | ~new_n71_ | ~x19 | x20);
endmodule
