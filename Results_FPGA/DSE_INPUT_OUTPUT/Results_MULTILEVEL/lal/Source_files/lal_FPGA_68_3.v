...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n56_, new_n57_, new_n67_,
    new_n69_, new_n71_, new_n72_, new_n74_, new_n75_, new_n77_, new_n79_,
    new_n80_;
  assign z00 = (x15 & x21) | (x08 & ~x16);
  ...
  assign z07 = x08 | ~x06 | (x15 & x21);
  assign z08 = (~x15 & (x25 | (x24 & (x23 | (new_n54_ & x21))))) | (~x21 & (x25 | (x23 & x24)));
  assign z09 = ~x15 & new_n50_ & ~x07;
  assign z10 = (x15 & x21) | (~x07 & ~x15 & ~new_n50_ & ~x17);
  assign z11 = (x15 & x21) | (~x07 & ~x15 & ~new_n50_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n50_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? ~x21 : ~new_n67_;
  assign new_n67_ = (~x20 | (x17 & x18 & x19)) & ~new_n50_ & ~x07 & (~x17 | ~x18 | ~x19 | x20);
  assign z14 = ((~x15 | ~x21) & (new_n50_ | x07)) | (~x21 & (new_n69_ | x15)) | (~x15 & ~new_n69_ & x21);
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z15 = new_n71_ | new_n50_ | x07 | new_n72_ | x15;
  assign new_n71_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n72_ & x23) | new_n50_ | x07 | new_n74_ | x15;
  assign new_n74_ = new_n75_ & x17 & x18 & x19;
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n74_ & x24) | new_n50_ | x07 | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~x21 & (new_n79_ | x15)) | (~x15 & (new_n80_ | new_n50_ | x07));
  assign new_n79_ = new_n69_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n80_ = x25 & (~new_n69_ | x21 | x22 | x23 | x24);
endmodule
