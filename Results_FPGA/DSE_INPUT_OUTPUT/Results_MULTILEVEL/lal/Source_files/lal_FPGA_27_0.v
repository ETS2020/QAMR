...
module FAU ( 
  ...
  assign z14 = (~new_n70_ & x21) | ~new_n51_ | ~new_n72_ | ~x11;
  assign new_n72_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x11 & (new_n75_ | new_n52_ | new_n74_ | x07));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n74_ & x23) | ~new_n51_ | ~x11 | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n77_ & x24) | ~new_n51_ | ~x11 | new_n79_ | x15;
