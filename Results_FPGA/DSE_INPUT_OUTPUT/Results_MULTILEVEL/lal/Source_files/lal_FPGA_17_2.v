...
module FAU ( 
  ...
  assign z15 = (x19 & (new_n74_ | x15)) | (~x15 & (~new_n68_ | (~new_n72_ & x22)));
  assign new_n74_ = x17 & x18 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n76_ & x23) | ~new_n68_ | new_n77_ | x15;
  ...
  assign z18 = (x25 & (~new_n70_ | ~new_n80_)) | ~new_n68_ | x15 | (new_n70_ & new_n82_);
