...
module FAU ( 
  ...
  assign z13 = x15 | (~x07 & ((~new_n68_ & x20) | new_n52_ | new_n69_));
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n69_ & x21) | ~new_n63_ | new_n71_ | x15;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n71_ & x22) | ~new_n63_ | new_n73_ | x15;
  assign new_n73_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n73_ & x23) | ~new_n63_ | new_n75_ | x15;
  assign new_n75_ = new_n68_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n75_ & x24) | ~new_n63_ | new_n77_ | x15;
