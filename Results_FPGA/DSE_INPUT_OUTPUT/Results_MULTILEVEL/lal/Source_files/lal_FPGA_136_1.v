...
module FAU ( 
  ...
  assign z01 = new_n50_ | new_n52_ | x07 | x15;
  ...
  assign z15 = (~new_n70_ & x22) | ~new_n67_ | new_n72_ | x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x07 | (~x15 & (new_n74_ | new_n52_ | (~new_n72_ & x23)));
  assign new_n74_ = new_n75_ & x17 & x18 & x19;
  assign new_n75_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = x07 | (~x15 & (new_n77_ | new_n52_ | (~new_n74_ & x24)));
  assign new_n77_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n77_ & x25) | ~new_n67_ | new_n79_ | x15;
