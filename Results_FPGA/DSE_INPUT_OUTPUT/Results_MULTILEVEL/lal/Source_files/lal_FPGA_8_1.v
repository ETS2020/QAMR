...
module FAU ( 
  ...
  assign z01 = (x01 | ~x15) & (new_n49_ | ~new_n51_);
  ...
  assign z04 = (~x01 & ((~x08 & x10) | x15)) | (~new_n56_ & ~x08);
  ...
  assign z08 = (x24 & (new_n62_ | x23)) | x25 | (~x01 & x15);
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & new_n52_ & ~x07;
  assign z10 = (~x01 & x15) | (~x07 & ~x15 & ~new_n52_ & ~x17);
  ...
  assign z17 = x15 ? x01 : (~new_n77_ | new_n52_ | (~new_n74_ & x24));
  assign new_n77_ = ~x07 & (~new_n69_ | ~new_n78_);
  assign new_n78_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x25 & (~new_n69_ | ~new_n78_)) | ~new_n51_ | x15 | (new_n69_ & new_n80_);
