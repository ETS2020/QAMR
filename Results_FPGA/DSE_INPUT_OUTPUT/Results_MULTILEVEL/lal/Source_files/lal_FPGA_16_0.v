...
module FAU ( 
  ...
  assign z13 = (~new_n69_ & x20) | ~new_n51_ | ~x14 | new_n70_ | x15;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n70_ & x21) | ~new_n51_ | ~x14 | new_n72_ | x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n72_ & x22) | ~new_n51_ | ~x14 | new_n74_ | x15;
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x14 & (~new_n76_ | new_n52_ | (~new_n74_ & x23)));
  ...
  assign z18 = new_n81_ | ~new_n51_ | ~x14 | new_n82_ | x15;
