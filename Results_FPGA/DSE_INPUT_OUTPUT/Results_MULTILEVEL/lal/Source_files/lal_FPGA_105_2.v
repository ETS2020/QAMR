// Benchmark "FAU" written by ABC on Tue Aug 18 17:08:08 2020
...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n56_, new_n57_, new_n62_,
    new_n63_, new_n65_, new_n71_, new_n73_, new_n74_, new_n76_, new_n77_,
  ...
  assign z08 = (~new_n62_ & (~x15 | x19)) | (new_n63_ & ~x15 & ~x17 & ~x18);
  assign new_n62_ = ~x25 & (~x24 | (~x23 & (~x20 | ~x21 | ~x22)));
  assign new_n63_ = ~x19 & x21 & x22 & x24;
  assign z09 = (x15 & ~x19) | (new_n65_ & ~x07 & ~x15);
  assign new_n65_ = x04 & x05;
  assign z10 = ~x07 & ~x15 & ~new_n65_ & ~x17;
  assign z11 = ~x07 & ~x15 & ~new_n65_ & (x17 ^ x18);
  assign z12 = (x15 & ~x19) | (~x07 & ~new_n65_ & ((~x15 & x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19)));
  assign z13 = (x19 & (x15 | (x17 & x18 & ~x20))) | (~x15 & (~new_n50_ | (x20 & (~x17 | ~x18 | ~x19))));
  assign z14 = (x19 & (x15 | (new_n71_ & ~x20 & ~x21))) | (~x15 & (~new_n50_ | (x21 & (~new_n71_ | ~x19 | x20))));
  assign new_n71_ = x17 & x18;
  assign z15 = (x19 & (new_n73_ | x15)) | (~x15 & (new_n74_ | ~new_n50_));
  assign new_n73_ = new_n71_ & ~x20 & ~x21 & ~x22;
  assign new_n74_ = x22 & (~new_n71_ | ~x19 | x20 | x21);
  assign z16 = (x19 & (new_n76_ | x15)) | (~x15 & (~new_n50_ | (~new_n78_ & x23)));
  assign new_n76_ = new_n77_ & ~x21 & ~x22 & ~x23;
  assign new_n77_ = x17 & x18 & ~x20;
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = (x19 & (x15 | (new_n77_ & new_n82_))) | (~x15 & (new_n80_ | ~new_n50_));
  assign new_n80_ = x24 & (~new_n81_ | ~x17 | ~x18 | ~x19);
  assign new_n81_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n82_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x19 & (x15 | (new_n84_ & new_n86_))) | (~x15 & (new_n85_ | ~new_n50_));
  assign new_n84_ = new_n71_ & ~x20 & ~x21;
  assign new_n85_ = x25 & (~new_n82_ | ~new_n71_ | ~x19 | x20);
