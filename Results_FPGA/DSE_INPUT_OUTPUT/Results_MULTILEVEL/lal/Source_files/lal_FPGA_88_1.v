...
module FAU ( 
  ...
  assign z03 = ~x25 & (~x24 | (~new_n53_ & ~x23));
  ...
  assign z08 = (x24 & ~x25 & (new_n61_ | x23)) | (x15 & x25);
  ...
  assign z14 = x15 | (~x25 & (new_n51_ | ~new_n71_ | (~new_n70_ & x21)));
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x25 & (new_n73_ | new_n51_ | new_n74_ | x07));
  assign new_n73_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | ~new_n50_ | x15 | new_n76_ | x25;
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n79_ | (~new_n76_ & x24) | x15 | x25;
  assign new_n79_ = ~x25 & (new_n51_ | x07 | (new_n70_ & new_n80_));
  assign new_n80_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n79_ | x15;
endmodule
