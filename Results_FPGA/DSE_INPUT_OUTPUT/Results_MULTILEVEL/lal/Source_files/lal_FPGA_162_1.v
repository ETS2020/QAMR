...
module FAU ( 
  ...
  assign z10 = ~x15 & (x20 | (~x07 & ~new_n52_ & ~x17));
  assign z11 = ~x15 & (x20 | (~x07 & ~new_n52_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n69_ & ~x15;
  assign new_n69_ = ~x20 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~x20 & (new_n52_ | new_n71_ | x07));
  assign new_n71_ = x17 & x18 & x19;
  assign z14 = x15 | (~new_n73_ & ~x20);
  assign new_n73_ = (new_n71_ | ~x21) & ~new_n52_ & ~new_n74_ & ~x07;
  assign new_n74_ = x17 & x18 & x19 & ~x21;
  assign z15 = (~new_n74_ & x22) | ~new_n76_ | x15 | new_n77_ | x20;
  assign new_n76_ = ~new_n52_ & ~x07;
  assign new_n77_ = x17 & x18 & x19 & ~x21 & ~x22;
  assign z16 = (~new_n77_ & x23) | ~new_n76_ | x15 | new_n79_ | x20;
  assign new_n79_ = new_n71_ & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n79_ & x24) | ~new_n76_ | x15 | new_n81_ | x20;
  assign new_n81_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n81_ & x25) | ~new_n76_ | ~new_n83_ | x15;
  assign new_n83_ = ~x20 & (~new_n74_ | x22 | x23 | x24 | x25);
endmodule
