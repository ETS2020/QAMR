...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & ~x25) | new_n51_ | x07 | (x12 & x15);
  ...
  assign z08 = (x24 & (new_n61_ | x23)) | (x12 & x15) | x25;
  ...
  assign z13 = (~new_n67_ & x20) | new_n51_ | x07 | new_n68_ | x15;
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 ? ~x12 : (new_n51_ | ~new_n70_ | (~new_n68_ & x21));
  assign new_n70_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n73_ | new_n51_ | x07 | new_n72_ | x15;
  ...
  assign new_n75_ = ~x07 & (~new_n67_ | x22 | x23 | x20 | x21);
  assign z17 = new_n77_ | new_n51_ | x07 | new_n78_ | x15;
