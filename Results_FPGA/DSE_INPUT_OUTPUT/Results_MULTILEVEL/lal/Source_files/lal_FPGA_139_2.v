...
module FAU ( 
  ...
  assign z01 = ~new_n49_ | (~x21 & (x15 | (~x23 & ~x25)));
  assign new_n49_ = ~new_n51_ & ~x07 & (x25 | (x24 & (new_n50_ | x23)));
  ...
  assign z08 = (x24 & (x23 | (new_n50_ & x21))) | x25 | (x15 & ~x21);
  assign z09 = (x15 & ~x21) | (new_n51_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = ~x07 & ~x15 & ~new_n51_ & (x17 ^ x18);
  assign z12 = (x15 & ~x21) | (~x07 & new_n65_ & ~x15);
  ...
  assign z14 = (~new_n69_ & x21) | ~new_n71_ | new_n51_ | x07;
  assign new_n71_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (x21 & (x15 | x22)) | (~x15 & (~new_n73_ | (~new_n69_ & x22)));
  assign new_n73_ = ~new_n51_ & ~x07 & (~new_n68_ | x20 | x21 | x22);
  assign z16 = (~new_n75_ & x23) | ~new_n76_ | new_n51_ | x07;
  assign new_n75_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n76_ = ~x15 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (x21 & (x15 | x24)) | (~x15 & (~new_n79_ | new_n51_ | (~new_n78_ & x24)));
  assign new_n78_ = new_n68_ & ~x20 & ~x22 & ~x23;
  assign new_n79_ = ~x07 & (~new_n69_ | x21 | x22 | x23 | x24);
  assign z18 = new_n81_ | new_n51_ | x07 | new_n82_ | x15;
  assign new_n81_ = x25 & (~new_n69_ | x23 | x24 | x21 | x22);
