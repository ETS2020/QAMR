...
module FAU ( 
  ...
  assign z11 = ~x15 & (x24 | (~x07 & ~new_n51_ & (x17 ^ x18)));
  assign z12 = ~x15 & (new_n66_ | x24);
  assign new_n66_ = ~x07 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n69_ & x20) | ~new_n68_ | x15 | new_n70_ | x24;
  assign new_n68_ = ~new_n51_ & ~x07;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n70_ & x21) | ~new_n68_ | x15 | new_n72_ | x24;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n72_ & x22) | ~new_n68_ | x15 | new_n74_ | x24;
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~x24 & (~new_n76_ | (~new_n74_ & x23)));
  assign new_n76_ = ~new_n51_ & ~x07 & (~new_n69_ | ~new_n77_);
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~new_n76_ & ~x24);
  assign z18 = (~x24 & (~new_n81_ | new_n51_)) | x15 | x24 | (~new_n80_ & x25);
  assign new_n80_ = new_n69_ & new_n77_;
  assign new_n81_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x25);
endmodule
