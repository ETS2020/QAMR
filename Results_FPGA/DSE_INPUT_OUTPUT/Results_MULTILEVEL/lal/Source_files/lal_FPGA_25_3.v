...
module FAU ( 
  ...
  assign z01 = ~new_n52_ | (~new_n50_ & ~x25);
  ...
  assign z04 = ~x08 & ~new_n56_ & (~x07 | ~x15);
  ...
  assign z11 = x07 ? x15 : (~x15 & ~new_n53_ & (x17 ^ x18));
  assign z12 = x07 ? x15 : (~x15 & ~new_n53_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19)));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n52_ | x15 | (x19 & ~x20 & x17 & x18);
  assign z14 = (~new_n69_ & x21) | ~new_n52_ | new_n70_ | x15;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n70_ & x22) | ~new_n52_ | new_n72_ | x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n72_ & x23) | ~new_n52_ | new_n74_ | x15;
  assign new_n74_ = new_n75_ & x17 & x18 & x19;
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n74_ & x24) | ~new_n52_ | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 ? ~x15 : ((~new_n77_ & x25) | new_n53_ | new_n79_ | x15);
