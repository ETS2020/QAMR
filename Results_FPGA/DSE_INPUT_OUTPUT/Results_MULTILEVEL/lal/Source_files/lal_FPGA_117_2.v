...
module FAU ( 
  ...
  assign z01 = (x05 & (x04 | ~x15)) | x07 | (~new_n49_ & ~x25);
  ...
  assign z13 = (~new_n65_ & x20) | x05 | x07 | new_n66_ | x15;
  assign new_n65_ = x17 & x18 & x19;
  assign new_n66_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n66_ & x21) | x05 | x07 | new_n68_ | x15;
  ...
  assign z16 = x15 | (~x05 & (new_n73_ | x07 | (~new_n70_ & x23)));
