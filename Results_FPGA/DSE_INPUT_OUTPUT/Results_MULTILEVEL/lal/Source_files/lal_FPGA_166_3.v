...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n61_ | x23)) | (x15 & x16) | x25;
  ...
  assign z14 = x15 ? ~x16 : (new_n51_ | ~new_n71_ | (~new_n70_ & x21));
  ...
  assign z17 = x15 ? ~x16 : (~new_n79_ | new_n51_ | (~new_n76_ & x24));
  assign new_n79_ = ~x07 & (~new_n70_ | x23 | x24 | x21 | x22);
  assign z18 = x15 ? ~x16 : (~new_n82_ | new_n51_ | (~new_n81_ & x25));
