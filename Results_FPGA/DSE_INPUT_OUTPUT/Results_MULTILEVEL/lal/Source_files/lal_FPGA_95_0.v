...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & (x15 | x25)) | (x15 & ~x25 & (new_n51_ | ~x24));
  ...
  assign z03 = ~x25 & (new_n51_ | ~x15 | ~x24);
  ...
  assign z08 = ~x15 | x25 | (x24 & (new_n62_ | x23));
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = x25 & ~x15 & new_n50_ & ~x07;
  assign z10 = ~x15 & (~x25 | (~x07 & ~new_n50_ & ~x17));
  assign z11 = ~x07 & ~x15 & x25 & ~new_n50_ & (x17 ^ x18);
  assign z12 = ~x15 & (new_n67_ | ~x25);
  assign new_n67_ = ~x07 & ~new_n50_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n69_ & x20) | ~new_n49_ | x15 | new_n70_ | ~x25;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n70_ & x21) | ~new_n49_ | x15 | new_n72_ | ~x25;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n72_ & x22) | ~new_n49_ | x15 | new_n74_ | ~x25;
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | ~new_n49_ | x15 | new_n76_ | ~x25;
  assign new_n76_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x25 & ((~new_n76_ & x24) | ~new_n78_ | new_n50_));
  assign new_n78_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = x15 | (x25 & (~new_n80_ | ~new_n49_ | ~new_n69_));
