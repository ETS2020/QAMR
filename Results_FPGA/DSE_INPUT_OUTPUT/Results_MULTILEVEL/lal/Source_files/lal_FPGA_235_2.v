...
module FAU ( 
  ...
  assign z12 = ~x07 & (new_n66_ | x02);
  assign new_n66_ = ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x07 | (~new_n68_ & ~x02);
  assign new_n68_ = (~x20 | (x17 & x18 & x19)) & ~new_n51_ & ~x15 & (~x19 | x20 | ~x17 | ~x18);
  ...
  assign z16 = (~new_n74_ & x23) | ~new_n76_ | x07 | new_n77_ | x15;
  assign new_n76_ = ~new_n51_ & ~x02;
  assign new_n77_ = new_n78_ & x17 & x18 & x19;
  assign new_n78_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 | (~x02 & (~new_n80_ | new_n51_ | (~new_n77_ & x24)));
  assign new_n80_ = ~x15 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = new_n82_ | ~new_n76_ | x07 | new_n83_ | x15;
