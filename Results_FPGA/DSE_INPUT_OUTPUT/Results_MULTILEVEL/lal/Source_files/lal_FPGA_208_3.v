...
module FAU ( 
  ...
  assign z11 = (x14 & x15) | (~x07 & ~x15 & ~new_n51_ & (x17 ^ x18));
  ...
  assign z14 = (~new_n69_ & x21) | new_n51_ | x07 | new_n71_ | x15;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n71_ & x22) | new_n51_ | x07 | new_n73_ | x15;
  assign new_n73_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 ? ~x14 : ((~new_n73_ & x23) | ~new_n75_ | new_n51_);
  assign new_n75_ = ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? ~x14 : (new_n77_ | new_n51_ | new_n78_ | x07);
  assign new_n77_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n78_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x14 : ((~new_n78_ & x25) | ~new_n80_ | new_n51_);
