...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n51_, new_n52_, new_n54_, new_n55_, new_n60_, new_n65_, new_n67_,
    new_n69_, new_n70_, new_n72_, new_n73_, new_n75_, new_n76_, new_n78_;
  assign z00 = ~z02 & x08;
  assign z02 = x16 | (x15 & x25);
  assign z01 = z03 | ((new_n52_ | x07) & (~x15 | ~x25));
  ...
  assign z09 = (x15 & x25) | (new_n52_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = (x15 & x25) | (~x07 & ~x15 & ~new_n52_ & (x17 ^ x18));
  assign z12 = (x15 & x25) | (~x07 & new_n65_ & ~x15);
  assign new_n65_ = ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? ~x25 : ~new_n67_;
  assign new_n67_ = (~x20 | (x17 & x18 & x19)) & ~new_n52_ & ~x07 & (~x17 | ~x18 | ~x19 | x20);
  assign z14 = x15 ? ~x25 : (new_n52_ | ~new_n70_ | (~new_n69_ & x21));
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign new_n70_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x25 : (new_n72_ | new_n52_ | new_n73_ | x07);
  assign new_n72_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n73_ & x23) | new_n52_ | x07 | new_n75_ | x15;
  assign new_n75_ = new_n76_ & x17 & x18 & x19;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n75_ & x24) | new_n52_ | x07 | new_n78_ | x15;
  assign new_n78_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ((new_n52_ | x07) & (~x15 | ~x25)) | (~x25 & (new_n78_ | x15)) | (~x15 & ~new_n78_ & x25);
endmodule
