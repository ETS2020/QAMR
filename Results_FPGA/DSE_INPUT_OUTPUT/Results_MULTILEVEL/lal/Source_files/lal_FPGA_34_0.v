...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n53_, new_n54_, new_n56_, new_n57_, new_n62_,
  ...
  assign new_n51_ = (~x04 | ~x05) & ~x07 & (x15 | x20);
  ...
  assign z10 = ~x15 & (~x20 | (~x07 & ~new_n65_ & ~x17));
  assign new_n65_ = x04 & x05;
  assign z11 = ~x15 & (~x20 | (~x07 & ~new_n65_ & (x17 ^ x18)));
  ...
  assign z17 = ~x20 | x24 | x15 | new_n65_ | x07;
  assign z18 = x15 | (x20 & (new_n65_ | x07 | x25));
endmodule
