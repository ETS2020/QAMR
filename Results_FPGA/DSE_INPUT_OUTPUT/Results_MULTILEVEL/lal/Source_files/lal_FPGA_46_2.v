...
module FAU ( 
  ...
  assign z01 = new_n50_ | new_n52_ | x07 | (x03 & ~x15);
  ...
  assign z08 = (x24 & (new_n61_ | x23)) | x25 | (x03 & ~x15);
  assign new_n61_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & ~x07 & ~x03 & x04 & x05;
  ...
  assign z14 = (~new_n71_ & x21) | ~new_n70_ | x07 | new_n72_ | x15;
  assign new_n70_ = ~new_n52_ & ~x03;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n72_ & x22) | ~new_n70_ | x07 | new_n74_ | x15;
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | ~new_n70_ | x07 | new_n76_ | x15;
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n76_ & x24) | ~new_n70_ | x07 | new_n79_ | x15;
  assign new_n79_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x03 & (~new_n81_ | new_n52_ | (~new_n79_ & x25)));
  assign new_n81_ = ~x07 & (~new_n71_ | ~new_n82_);
