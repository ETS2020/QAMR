...
module FAU ( 
  ...
  assign z14 = x15 | (~x07 & ((~new_n68_ & x21) | new_n52_ | new_n70_));
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x07 & (new_n72_ | new_n52_ | (~new_n70_ & x22)));
  ...
  assign z17 = (~new_n75_ & x24) | ~new_n77_ | new_n52_ | x07;
  assign new_n77_ = ~x15 & (~new_n68_ | ~new_n73_ | x23 | x24);
