...
module FAU ( 
  ...
  assign z01 = ((x15 | ~x19) & (new_n49_ | ~new_n50_)) | (new_n51_ & ~x20);
  ...
  assign z10 = ~x07 & ~x15 & ~x17 & ~new_n67_ & ~x19;
  assign new_n67_ = x04 & x05;
  assign z11 = ~x07 & ~x15 & ~x19 & ~new_n67_ & (x17 ^ x18);
  assign z12 = ~x15 & (x19 | (~x07 & x17 & ~new_n67_ & x18));
  assign z13 = x15 | (~x19 & (new_n67_ | x07 | x20));
  assign z14 = x15 | (~x19 & (new_n67_ | x07 | x21));
  assign z15 = x15 | (~x19 & (new_n67_ | x07 | x22));
  assign z16 = x15 | (~x19 & (new_n67_ | x07 | x23));
  assign z17 = x15 | (~x19 & (new_n67_ | x07 | x24));
  assign z18 = x15 | (~x19 & (new_n67_ | x07 | x25));
endmodule
