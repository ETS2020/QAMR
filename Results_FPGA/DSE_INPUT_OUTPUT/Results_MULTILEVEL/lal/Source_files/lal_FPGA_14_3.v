...
module FAU ( 
  ...
  assign z08 = (~x02 | ~x15) & (x25 | (x24 & (new_n61_ | x23)));
  assign new_n61_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = (x02 & x15) | (new_n51_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = (x02 & x15) | (~x07 & ~x15 & ~new_n51_ & (x17 ^ x18));
  ...
  assign z14 = (~new_n69_ & x21) | ~new_n70_ | new_n51_ | x07;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign new_n70_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x02 : (new_n72_ | new_n51_ | new_n73_ | x07);
  ...
  assign z17 = x15 ? ~x02 : (~new_n78_ | new_n51_ | (~new_n75_ & x24));
  assign new_n78_ = ~x07 & (~new_n69_ | x21 | x22 | x23 | x24);
  assign z18 = new_n80_ | new_n51_ | x07 | new_n81_ | x15;
