...
module FAU ( 
  ...
  assign z13 = (~new_n69_ & x20) | ~new_n68_ | x15 | new_n70_ | x16;
  ...
  assign z15 = new_n75_ | ~new_n68_ | x15 | new_n74_ | x16;
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n74_ & x23) | ~new_n68_ | x15 | new_n77_ | x16;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n77_ & x24) | ~new_n68_ | x15 | new_n79_ | x16;
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n79_ & x25) | ~new_n68_ | x15 | new_n81_ | x16;
