...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n63_ | x23)) | new_n48_ | x25;
  assign new_n63_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x19 & ~x15 & new_n65_ & ~x07;
  ...
  assign z14 = x15 | (~x19 & (new_n65_ | x07 | x21));
  assign z15 = x15 | (~x19 & (new_n65_ | x07 | x22));
  assign z16 = ~new_n51_ | x15 | x19 | x23;
  assign z17 = x15 | (~x19 & (new_n65_ | x07 | x24));
