...
module FAU ( 
  ...
  assign z14 = (~new_n70_ & x21) | ~new_n72_ | ~x14 | new_n73_ | x15;
  assign new_n72_ = ~new_n51_ & ~x07;
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n73_ & x22) | ~new_n72_ | ~x14 | new_n75_ | x15;
  assign new_n75_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x14 & ((~new_n75_ & x23) | ~new_n77_ | new_n51_));
