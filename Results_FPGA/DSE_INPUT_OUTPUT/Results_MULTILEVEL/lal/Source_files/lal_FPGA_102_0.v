...
module FAU ( 
  ...
  assign z09 = ~x15 & x09 & new_n52_ & ~x07;
  ...
  assign z14 = (~new_n70_ & x21) | ~new_n51_ | ~new_n72_ | ~x09;
  ...
  assign z16 = x15 | (x09 & ((~new_n74_ & x23) | ~new_n77_ | new_n52_));
  assign new_n77_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = new_n79_ | ~new_n51_ | ~x09 | new_n80_ | x15;
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n80_ & x25) | ~new_n51_ | ~x09 | new_n82_ | x15;
