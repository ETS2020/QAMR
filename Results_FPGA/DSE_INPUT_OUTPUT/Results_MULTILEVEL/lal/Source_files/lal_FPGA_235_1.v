...
module FAU ( 
  ...
  assign z04 = (~x02 & (x07 | (~x08 & x11))) | (~new_n55_ & ~x08);
  assign new_n55_ = new_n56_ & (x00 | ~x09) & (~x00 | x09) & (x01 | ~x10);
  assign new_n56_ = (~x01 | x10) & (~x02 | x11) & (x03 | ~x12) & (~x03 | x12);
  assign z05 = (~x02 & x07) | (~x08 & ~x13);
  assign z06 = (~x02 & x07) | (~x08 & x14);
  assign z07 = (~x06 | x08) & (x02 | ~x07);
  assign z08 = (x24 & (new_n61_ | x23)) | x25 | (~x02 & x07);
  ...
  assign z12 = x07 ? ~x02 : new_n66_;
  assign new_n66_ = ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x07 ? x02 : ~new_n68_;
  assign new_n68_ = (~x20 | (x17 & x18 & x19)) & ~new_n51_ & ~x15 & (~x17 | ~x18 | ~x19 | x20);
  assign z14 = x07 ? x02 : (new_n51_ | ~new_n71_ | (~new_n70_ & x21));
  assign new_n70_ = x19 & ~x20 & x17 & x18;
  assign new_n71_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 ? x02 : (new_n73_ | new_n51_ | new_n74_ | x15);
  assign new_n73_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | new_n76_ | x15 | new_n51_ | x07;
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 ? x02 : ((~new_n76_ & x24) | ~new_n79_ | new_n51_);
  assign new_n79_ = ~x15 & (~new_n70_ | x21 | x22 | x23 | x24);
