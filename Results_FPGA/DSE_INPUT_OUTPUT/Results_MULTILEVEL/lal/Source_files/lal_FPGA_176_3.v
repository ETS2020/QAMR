...
module FAU ( 
  ...
  assign new_n53_ = x18 ? x15 : (~x17 & ~x19);
  ...
  assign z09 = (x15 & x18) | (new_n52_ & ~x07 & ~x15);
  assign z10 = (x15 & x18) | (~x07 & ~x15 & ~new_n52_ & ~x17);
  assign z11 = (x15 & x18) | (~x07 & ~new_n52_ & ((~x17 & x18) | (~x15 & x17 & ~x18)));
  assign z12 = ~x07 & ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~x18 & (x15 | x20)) | (~new_n70_ & ~x15);
  assign new_n70_ = (~x20 | (x17 & x19)) & ~new_n52_ & ~x07 & (~x17 | ~x18 | ~x19 | x20);
  assign z14 = (~x18 & (x15 | x21)) | (~x15 & (new_n52_ | ~new_n73_ | (~new_n72_ & x21)));
  assign new_n72_ = x17 & x19 & ~x20;
  assign new_n73_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n75_ | new_n76_ | x15 | new_n52_ | x07;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n76_ = ~x20 & ~x21 & ~x22 & x17 & x18 & x19;
  assign z16 = (~new_n76_ & x23) | new_n52_ | x07 | new_n78_ | x15;
  assign new_n78_ = new_n79_ & x17 & x18 & x19;
  assign new_n79_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = (~new_n78_ & x24) | new_n81_ | x15 | new_n52_ | x07;
  assign new_n81_ = new_n82_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n82_ = x17 & x18 & x19 & ~x20;
  assign z18 = (~new_n81_ & x25) | new_n84_ | x15 | new_n52_ | x07;
  assign new_n84_ = new_n82_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
