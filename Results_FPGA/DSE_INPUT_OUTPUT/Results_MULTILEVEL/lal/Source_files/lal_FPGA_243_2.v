...
module FAU ( 
  ...
  assign z07 = x08 | ~x06 | (x05 & ~x15);
  assign z08 = (x24 & (new_n60_ | x23)) | x25 | (x05 & ~x15);
  assign new_n60_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z10 = ~x17 & ~x15 & ~x05 & ~x07;
  assign z11 = ~x05 & ~x07 & ~x15 & (x17 ^ x18);
  assign z12 = ~x15 & (x05 | (~x07 & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  ...
  assign z15 = (~new_n68_ & x22) | x05 | x07 | new_n70_ | x15;
  ...
  assign z17 = (~new_n73_ & x24) | ~new_n75_ | x05 | x07;
  assign new_n75_ = ~x15 & (~new_n66_ | ~new_n71_ | x23 | x24);
