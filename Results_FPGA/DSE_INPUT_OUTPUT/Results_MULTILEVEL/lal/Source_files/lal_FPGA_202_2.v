...
module FAU ( 
  ...
  assign z01 = (~x12 | x15) & (new_n49_ | ~new_n51_);
  ...
  assign z08 = (x24 & (new_n62_ | x23)) | (x12 & ~x15) | x25;
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & (x12 | (x04 & x05 & ~x07));
  assign z10 = ~x07 & ~x12 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = ~x07 & ~x12 & ~x15 & ~new_n52_ & (x17 ^ x18);
  assign z12 = ~x15 & (new_n67_ | x12);
  assign new_n67_ = ~x07 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n69_ & x20) | ~new_n51_ | x12 | new_n70_ | x15;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x19 & ~x20 & x17 & x18;
  assign z14 = x15 | (~x12 & ((~new_n70_ & x21) | new_n52_ | ~new_n72_));
  assign new_n72_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n75_ | ~new_n51_ | x12 | new_n74_ | x15;
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n74_ & x23) | ~new_n51_ | x12 | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n77_ & x24) | ~new_n51_ | x12 | new_n79_ | x15;
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x12 & (~new_n81_ | new_n52_ | (~new_n79_ & x25)));
