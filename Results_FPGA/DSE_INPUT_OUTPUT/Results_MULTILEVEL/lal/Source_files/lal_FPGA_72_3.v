...
module FAU ( 
  ...
  assign z00 = x08 & ~x16;
  assign z01 = (~x15 | ~x16) & (new_n51_ | x07 | (~new_n49_ & ~x25));
  ...
  assign z08 = (~x15 | ~x16) & (x25 | (x24 & (new_n61_ | x23)));
  ...
  assign z12 = (x15 & x16) | (~x07 & new_n66_ & ~x15);
  ...
  assign z14 = x15 ? ~x16 : (new_n51_ | ~new_n71_ | (~new_n69_ & x21));
  ...
  assign z16 = x15 ? ~x16 : ((~new_n73_ & x23) | ~new_n76_ | new_n51_);
  assign new_n76_ = ~x07 & (~new_n68_ | x22 | x23 | x20 | x21);
  assign z17 = x15 ? ~x16 : (new_n78_ | ~new_n79_ | new_n51_);
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = ~x07 & (~new_n69_ | x23 | x24 | x21 | x22);
