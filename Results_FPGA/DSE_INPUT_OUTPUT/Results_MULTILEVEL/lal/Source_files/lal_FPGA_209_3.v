...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n55_, new_n57_, new_n58_,
    new_n63_, new_n64_, new_n70_, new_n71_, new_n72_, new_n74_, new_n76_,
  ...
  assign z08 = (~new_n48_ & x25) | (~new_n63_ & x24);
  assign new_n63_ = (x15 | (~x23 & (~new_n51_ | ~x20))) & (x20 | (~new_n64_ & ~x23));
  ...
  assign z13 = (~new_n71_ & x20) | ~new_n70_ | new_n72_ | x15;
  assign new_n70_ = ~new_n52_ & ~x07;
  assign new_n71_ = x17 & x18 & x19;
  assign new_n72_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n72_ & x21) | ~new_n70_ | new_n74_ | x15;
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~x20 & (new_n76_ | x15)) | (~x15 & (~new_n70_ | (~new_n74_ & x22)));
  assign new_n76_ = x17 & x18 & x19 & ~x21 & ~x22;
  assign z16 = (~x20 & (new_n78_ | x15)) | (~x15 & (~new_n70_ | (~new_n79_ & x23)));
  assign new_n78_ = new_n71_ & ~x21 & ~x22 & ~x23;
  assign new_n79_ = new_n71_ & ~x20 & ~x21 & ~x22;
  assign z17 = (~x20 & (x15 | (new_n71_ & new_n82_))) | (~x15 & (~new_n70_ | new_n81_));
  assign new_n81_ = x24 & (~new_n71_ | x20 | x21 | x22 | x23);
  assign new_n82_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z18 = (x25 & (~new_n72_ | ~new_n82_)) | ~new_n70_ | x15 | (new_n72_ & new_n84_);
