...
module FAU ( 
  ...
  assign new_n65_ = x05 & (x04 | x07 | ((~x19 | (x17 & x18)) & (~x17 | ~x18 | x19)));
  assign z13 = x15 | (~new_n67_ & x05);
  assign new_n67_ = (new_n68_ | ~x20) & ~x04 & ~new_n69_ & ~x07;
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (x05 & ((~new_n69_ & x21) | ~new_n71_ | x04));
  assign new_n71_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n74_ | x04 | ~x05 | x07 | new_n73_ | x15;
  assign new_n73_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (x05 & ((~new_n73_ & x23) | ~new_n76_ | x04));
  assign new_n76_ = ~x07 & (~new_n68_ | x22 | x23 | x20 | x21);
  assign z17 = new_n78_ | x04 | ~x05 | x07 | new_n79_ | x15;
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (x05 & (new_n81_ | x04 | new_n82_ | x07));
