...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n62_ | x23)) | x25 | (x07 & ~x15);
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~new_n52_ & ~x15;
  ...
  assign z16 = (~new_n72_ & x23) | ~new_n52_ | new_n75_ | x15;
  assign new_n75_ = new_n76_ & x17 & x18 & x19;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (~new_n78_ | (~new_n75_ & x24)));
  assign new_n78_ = ~new_n53_ & (~new_n69_ | ~new_n73_ | x23 | x24);
  assign z18 = x15 | (~new_n80_ & ~x07);
  assign new_n80_ = (~x25 | (new_n69_ & new_n73_ & ~x23 & ~x24)) & ~new_n53_ & (~new_n69_ | ~new_n73_ | x23 | x24 | x25);
endmodule
