...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n53_, new_n54_, new_n56_, new_n57_,
    new_n62_, new_n63_, new_n65_, new_n69_, new_n71_, new_n72_, new_n73_,
  ...
  assign z06 = (~x08 & x14) | (~x16 & x18);
  assign z07 = (~x06 | x08) & (x16 | ~x18);
  assign z08 = (~new_n62_ & (x16 | ~x18)) | (new_n63_ & ~x17 & ~x18 & ~x19);
  ...
  assign z11 = ~x07 & ~x15 & ~new_n65_ & ((x16 & ~x17 & x18) | (x17 & ~x18));
  assign z12 = ~x07 & new_n69_ & ~x15;
  assign new_n69_ = ~new_n65_ & ((~x18 & x19) | (x16 & (x17 ? (x18 & ~x19) : x19)));
  assign z13 = ~new_n71_ | (~x16 & (x18 | x20));
  assign new_n71_ = (new_n72_ | ~x20) & new_n51_ & ~new_n73_ & ~x15;
  assign new_n72_ = x17 & x18 & x19;
  assign new_n73_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~x16 & (x18 | x21)) | ~new_n75_ | ~new_n51_ | (~new_n73_ & x21);
  assign new_n75_ = ~x15 & (~new_n76_ | ~x17 | ~x18);
  assign new_n76_ = x19 & ~x20 & ~x21;
  assign z15 = (~x16 & (x18 | x22)) | ~new_n78_ | (x22 & (~new_n76_ | ~x17 | ~x18));
  assign new_n78_ = new_n51_ & ~x15 & (~new_n72_ | x20 | x21 | x22);
  assign z16 = (~new_n80_ & (x16 | ~x18)) | (~x18 & x23) | (x16 & (new_n81_ | (~new_n82_ & x23)));
  assign new_n80_ = ~new_n65_ & ~x07 & ~x15;
  assign new_n81_ = new_n72_ & ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n82_ = ~x20 & ~x21 & ~x22 & x17 & x19;
  assign z17 = (~x16 & (x18 | x24)) | ~new_n84_ | ~new_n51_ | (~new_n81_ & x24);
  assign new_n84_ = ~x15 & (~new_n73_ | x23 | x24 | x21 | x22);
  assign z18 = new_n88_ | new_n86_ | ~new_n51_ | new_n87_ | x15;
  assign new_n86_ = x25 & (~new_n73_ | x23 | x24 | x21 | x22);
  assign new_n87_ = new_n73_ & ~x23 & ~x24 & ~x25 & ~x21 & ~x22;
  assign new_n88_ = ~x16 & (x18 | x25);
  assign z02 = x16;
endmodule
