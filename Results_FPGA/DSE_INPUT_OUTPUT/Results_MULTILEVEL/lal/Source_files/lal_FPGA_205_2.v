...
module FAU ( 
  ...
  assign z04 = ~x08 & ~new_n56_ & (~x15 | x22);
  ...
  assign z08 = (x24 & (new_n62_ | x23)) | x25 | (x15 & ~x22);
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = (x15 & ~x22) | (new_n52_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = (x15 & ~x22) | (~x07 & ~x15 & ~new_n52_ & (x17 ^ x18));
  ...
  assign z14 = x15 ? x22 : (~new_n71_ | (~new_n69_ & x21));
  assign new_n71_ = ~new_n52_ & ~new_n72_ & ~x07;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~x15 & (new_n52_ | new_n74_ | x07)) | (~new_n75_ & x22);
  assign new_n74_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x19 & ~x20 & ~x21 & ~x15 & x17 & x18;
  assign z16 = (x22 & (x15 | x23)) | (~x15 & (~new_n77_ | new_n52_ | (~new_n72_ & x23)));
  assign new_n77_ = ~x07 & (~new_n68_ | x22 | x23 | x20 | x21);
  assign z17 = new_n79_ | ~new_n51_ | new_n80_ | x15;
  assign new_n79_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n80_ & x25) | ~new_n51_ | new_n82_ | x15;
