...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & (~x15 | x24)) | (~x25 & ((~x23 & ~new_n51_ & x24) | (~x15 & ~x24)));
  assign new_n49_ = ~new_n50_ & ~x07;
  assign new_n50_ = x04 & x05;
  assign new_n51_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign z02 = x16 | (x15 & ~x24);
  assign z03 = (~x24 & (x15 | ~x25)) | (~x23 & ~new_n51_ & ~x25);
  assign z04 = new_n55_ | (x15 & ~x24);
