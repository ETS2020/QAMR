...
module FAU ( 
  ...
  assign new_n68_ = (~x20 | (x17 & x18)) & ~new_n51_ & ~x07 & (~x17 | ~x18 | x20);
  assign z14 = (~new_n71_ & x21) | ~new_n70_ | x15 | new_n72_ | ~x19;
  assign new_n70_ = ~new_n51_ & ~x07;
  assign new_n71_ = x17 & x18 & ~x20;
  assign new_n72_ = x17 & x18 & ~x20 & ~x21;
  assign z15 = x15 | (x19 & (new_n51_ | ~new_n74_ | (~new_n72_ & x22)));
  assign new_n74_ = ~x07 & (~x17 | ~x18 | x20 | x21 | x22);
  assign z16 = x15 | (x19 & (new_n77_ | new_n51_ | new_n76_ | x07));
  assign new_n76_ = new_n71_ & ~x21 & ~x22 & ~x23;
  assign new_n77_ = x23 & (~x17 | ~x18 | x20 | x21 | x22);
  assign z17 = (~new_n76_ & x24) | ~new_n70_ | x15 | new_n79_ | ~x19;
  assign new_n79_ = new_n71_ & ~x23 & ~x24 & ~x21 & ~x22;
  assign z18 = x15 | (x19 & (~new_n81_ | new_n51_ | (~new_n79_ & x25)));
  assign new_n81_ = ~x07 & (~new_n72_ | x22 | x23 | x24 | x25);
endmodule
