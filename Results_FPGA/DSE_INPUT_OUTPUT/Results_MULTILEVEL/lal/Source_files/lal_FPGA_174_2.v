...
module FAU ( 
  ...
  assign z01 = (~x21 & (x15 | (~x23 & ~x25))) | ~new_n52_ | (~new_n50_ & ~x25);
  ...
  assign z14 = ~new_n72_ | (~new_n52_ & (~x15 | x21));
  assign new_n72_ = (~x21 | (~x15 & x17 & x18 & x19 & ~x20)) & (x15 | ~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n75_ | ~new_n52_ | new_n74_ | x15;
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n74_ & x23) | ~new_n52_ | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n77_ & x24) | ~new_n52_ | new_n79_ | x15;
