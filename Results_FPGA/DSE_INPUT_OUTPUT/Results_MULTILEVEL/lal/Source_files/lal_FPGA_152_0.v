...
module FAU ( 
  ...
  assign z09 = ~x15 & (~x09 | (x04 & x05 & ~x07));
  assign z10 = ~x15 & (~x09 | (~x07 & ~new_n51_ & ~x17));
  assign z11 = ~x15 & (~x09 | (~x07 & ~new_n51_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n66_ & x09;
  assign new_n66_ = ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n68_ & x09);
  assign new_n68_ = (new_n69_ | ~x20) & ~new_n51_ & ~new_n70_ & ~x07;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n70_ & x21) | new_n51_ | x07 | ~new_n72_ | ~x09;
  ...
  assign z16 = x15 | (x09 & (~new_n77_ | new_n51_ | (~new_n74_ & x23)));
  assign new_n77_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = new_n79_ | new_n51_ | x07 | ~x09 | new_n80_ | x15;
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n82_ | new_n51_ | x07 | ~x09 | new_n83_ | x15;
