...
module FAU ( 
  ...
  assign z12 = (x15 & ~x22) | (~x07 & new_n66_ & ~x15);
  assign new_n66_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? x22 : ~new_n68_;
  assign new_n68_ = (new_n69_ | ~x20) & (~x04 | ~x05) & ~new_n70_ & ~x07;
  ...
  assign z16 = (~new_n74_ & x23) | ~new_n51_ | new_n76_ | x15;
  assign new_n76_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n76_ & x24) | ~new_n51_ | new_n78_ | x15;
  assign new_n78_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n78_ & x25) | ~new_n51_ | new_n80_ | x15;
