...
module FAU ( 
  ...
  assign z10 = ~x07 & ~x15 & ~x17 & ~new_n52_ & ~x20;
  assign z11 = ~x07 & ~x15 & ~x20 & ~new_n52_ & (x17 ^ x18);
  assign z12 = ~x07 & new_n69_ & ~x15;
  assign new_n69_ = ~x20 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | x20 | x07 | new_n52_ | new_n71_;
  assign new_n71_ = x17 & x18 & x19;
  assign z14 = (~new_n71_ & x21) | ~new_n73_ | new_n52_ | x07;
  assign new_n73_ = ~x15 & ~new_n74_ & ~x20;
  assign new_n74_ = x17 & x18 & x19 & ~x21;
  assign z15 = x15 | (~x20 & (new_n52_ | ~new_n76_ | (~new_n74_ & x22)));
  assign new_n76_ = ~x07 & (~x17 | ~x18 | ~x19 | x21 | x22);
  assign z16 = x15 | (~x20 & (new_n79_ | new_n52_ | new_n78_ | x07));
  assign new_n78_ = new_n71_ & ~x21 & ~x22 & ~x23;
  assign new_n79_ = x23 & (~x17 | ~x18 | ~x19 | x21 | x22);
  assign z17 = x15 | (~x20 & (~new_n81_ | new_n52_ | (~new_n78_ & x24)));
  assign new_n81_ = ~x07 & (~new_n71_ | x21 | x22 | x23 | x24);
  assign z18 = new_n83_ | new_n52_ | x07 | ~new_n84_ | x15;
  assign new_n83_ = x25 & (~new_n71_ | x21 | x22 | x23 | x24);
  assign new_n84_ = ~x20 & (~new_n74_ | x22 | x23 | x24 | x25);
endmodule
