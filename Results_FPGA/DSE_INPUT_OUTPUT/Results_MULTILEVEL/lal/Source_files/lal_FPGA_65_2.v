...
module FAU ( 
  ...
  assign z02 = z09 | x16;
  assign z09 = x05 & ~x15;
  assign z01 = (x05 & (x04 | ~x15)) | x07 | (~new_n51_ & ~x25);
  ...
  assign z11 = ~x15 & (x05 | (~x07 & (x17 ^ x18)));
  assign z12 = ~x15 & (x05 | (~x07 & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  assign z13 = x15 | (~x05 & (new_n67_ | x07 | (~new_n66_ & x20)));
  assign new_n66_ = x17 & x18 & x19;
  assign new_n67_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n67_ & x21) | x05 | x07 | new_n69_ | x15;
  assign new_n69_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x05 & ((~new_n69_ & x22) | new_n71_ | x07));
  assign new_n71_ = new_n66_ & new_n72_ & ~x20;
  assign new_n72_ = ~x21 & ~x22;
  assign z16 = x15 | (~x05 & (new_n74_ | x07 | (~new_n71_ & x23)));
  assign new_n74_ = new_n66_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x05 & (~new_n76_ | (~new_n74_ & x24)));
  assign new_n76_ = ~x07 & (~new_n67_ | ~new_n72_ | x23 | x24);
  assign z18 = (~new_n78_ & ~x05) | x15;
