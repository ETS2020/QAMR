...
module FAU ( 
  ...
  assign z14 = (~new_n71_ & x21) | ~new_n70_ | x15 | new_n72_ | x22;
  assign new_n70_ = ~new_n51_ & ~x07;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | x22 | x07 | new_n51_ | new_n72_;
  assign z16 = (~new_n72_ & x23) | ~new_n70_ | x15 | new_n75_ | x22;
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x23;
  assign z17 = (~new_n75_ & x24) | ~new_n70_ | x15 | new_n77_ | x22;
  assign new_n77_ = new_n78_ & x17 & x18 & x19;
  assign new_n78_ = ~x20 & ~x21 & ~x23 & ~x24;
  assign z18 = (~new_n77_ & x25) | ~new_n70_ | ~new_n80_ | x15;
  assign new_n80_ = ~x22 & (~new_n71_ | x24 | x25 | x21 | x23);
endmodule
