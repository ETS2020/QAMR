...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n62_ | x23)) | (x14 & x15) | x25;
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = (x14 & x15) | (new_n52_ & ~x07 & ~x15);
  assign z10 = (x14 & x15) | (~x07 & ~x15 & ~new_n52_ & ~x17);
  assign z11 = ~x07 & ~x15 & ~new_n52_ & (x17 ^ x18);
  assign z12 = (x14 & x15) | (~x07 & new_n67_ & ~x15);
  assign new_n67_ = ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n69_ & x20) | ~new_n51_ | new_n70_ | x15;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n70_ & x21) | ~new_n51_ | new_n72_ | x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n51_ | new_n74_ | x15 | (~new_n72_ & x22);
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 ? ~x14 : ((~new_n74_ & x23) | ~new_n76_ | new_n52_);
  assign new_n76_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? ~x14 : (new_n78_ | ~new_n79_ | new_n52_);
  assign new_n78_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n79_ = ~x07 & (~new_n70_ | ~new_n80_);
  assign new_n80_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ((~new_n70_ | ~new_n80_) & x25) | ~new_n51_ | x15 | (new_n70_ & new_n82_);
