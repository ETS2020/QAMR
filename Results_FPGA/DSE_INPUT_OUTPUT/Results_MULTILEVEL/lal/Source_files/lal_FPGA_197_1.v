...
module FAU ( 
  ...
  assign z04 = ~x08 & ~new_n56_ & (x15 | ~x24);
  ...
  assign z08 = (x15 & (x25 | (x24 & (new_n62_ | x23)))) | (~x24 & x25);
  ...
  assign new_n81_ = ~x24 & (~new_n71_ | x21 | x22 | x23 | x25);
endmodule
