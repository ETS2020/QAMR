...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n52_, new_n53_, new_n56_, new_n58_,
    new_n59_, new_n64_, new_n70_, new_n71_, new_n73_, new_n75_, new_n76_,
    new_n77_, new_n79_, new_n81_, new_n82_, new_n83_, new_n85_;
  ...
  assign z13 = (~new_n70_ & x20) | ~new_n51_ | new_n71_ | x15;
  assign new_n70_ = x17 & x18 & x19;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign z14 = (x21 & (~new_n73_ | ~x19 | x20)) | ~new_n51_ | x15 | (new_n73_ & x19 & ~x20 & ~x21);
  assign new_n73_ = x17 & x18;
  assign z15 = (~new_n75_ & ~x15) | (x20 & (x15 | x22));
  assign new_n75_ = ~new_n76_ & ~new_n52_ & ~new_n77_ & ~x07;
  assign new_n76_ = x22 & (~x17 | ~x18 | ~x19 | x21);
  assign new_n77_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n51_ | ~new_n79_ | (~new_n77_ & x23);
  assign new_n79_ = ~x15 & (~new_n70_ | x20 | x21 | x22 | x23);
  assign z17 = (x20 & (x15 | x24)) | (~x15 & ((~new_n81_ & x24) | ~new_n82_ | new_n52_));
  assign new_n81_ = new_n70_ & ~x21 & ~x22 & ~x23;
  assign new_n82_ = ~x07 & (~new_n71_ | ~new_n83_);
  assign new_n83_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x25 & (~new_n71_ | ~new_n83_)) | ~new_n51_ | x15 | (new_n71_ & new_n85_);
