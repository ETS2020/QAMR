...
module FAU ( 
  ...
  assign z09 = (~x10 & x15) | (new_n51_ & ~x07 & ~x15);
  assign z10 = (~x10 & x15) | (~x07 & ~x15 & ~new_n51_ & ~x17);
  assign z11 = (~x10 & x15) | (~x07 & ~x15 & ~new_n51_ & (x17 ^ x18));
  ...
  assign z15 = x15 ? x10 : (new_n72_ | new_n51_ | new_n73_ | x07);
  ...
  assign z18 = x15 ? x10 : (~new_n80_ | new_n51_ | (~new_n78_ & x25));
