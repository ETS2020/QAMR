...
module FAU ( 
  ...
  assign z14 = (new_n71_ & x17) | (x15 & ~x22) | (~new_n69_ & ~x15);
  assign new_n69_ = new_n67_ & (new_n70_ | ~x21);
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = x18 & x19 & ~x20 & ~x21 & (~x15 | ~x22);
  assign z15 = (~x22 & (new_n73_ | x15)) | (~x15 & (~new_n67_ | (~new_n73_ & x22)));
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z16 = (~x22 & (new_n75_ | x15)) | (~x15 & (~new_n67_ | (~new_n76_ & x23)));
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x23;
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = new_n78_ | ~new_n67_ | new_n80_ | x15;
  assign new_n78_ = x24 & (~new_n79_ | ~x17 | ~x18 | ~x19);
  assign new_n79_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n67_ | new_n82_ | x15 | (~new_n80_ & x25);
