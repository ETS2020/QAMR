...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & ~x25) | (x04 & x05) | x07 | (~x05 & x15);
  ...
  assign z10 = (~x05 & (x15 | (~x07 & ~x17))) | (~x04 & ~x07 & ~x15 & ~x17);
  assign z11 = ~x07 & ~x15 & (~x04 | ~x05) & (x17 ^ x18);
  assign z12 = new_n65_ & ~x07;
  assign new_n65_ = ~x15 & (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n67_ & x20) | ~new_n68_ | new_n69_ | x15;
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = ~x07 & (~x04 | ~x05);
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n69_ & x21) | ~new_n68_ | new_n71_ | x15;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n73_ & ~x15) | (x05 & (x04 | x15));
  assign new_n73_ = (new_n71_ | ~x22) & ~x07 & (~new_n67_ | x20 | x21 | x22);
  assign z16 = (~new_n75_ & ~x15) | (x05 & (x04 | x15));
  assign new_n75_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = (x05 & (x04 | x15)) | (~x15 & (~new_n78_ | (~new_n77_ & x24)));
  assign new_n77_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n78_ = ~x07 & (~new_n69_ | ~new_n79_ | x23 | x24);
  assign new_n79_ = ~x21 & ~x22;
  assign z18 = (~new_n81_ & ~x15) | (x05 & (x04 | x15));
