...
module FAU ( 
  ...
  assign z01 = new_n50_ | new_n52_ | x07 | (x15 & ~x17);
  ...
  assign new_n61_ = ~x15 & (x18 | x19 | ~x21 | ~x22 | ~x24);
  assign new_n62_ = ~x25 & (~x24 | (~x23 & (~x20 | ~x21 | ~x22)));
  assign z09 = (x15 & ~x17) | (new_n52_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = ~x07 & ~x15 & ~new_n52_ & (~x17 ^ ~x18);
  assign z12 = (x15 & ~x17) | (~x07 & ~new_n52_ & ((~x15 & ((~x18 & x19) | (x17 & x18 & ~x19))) | (~x17 & x19)));
  assign z13 = (x17 & (x15 | (x18 & x19 & ~x20))) | (~x15 & (~new_n68_ | (x20 & (~x17 | ~x18 | ~x19))));
  assign new_n68_ = ~new_n52_ & ~x07;
  assign z14 = (~new_n70_ & x21) | ~new_n68_ | new_n71_ | x15;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n71_ & x22) | ~new_n68_ | new_n73_ | x15;
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n73_ & x23) | ~new_n68_ | new_n75_ | x15;
  assign new_n75_ = new_n76_ & x17 & x18 & x19;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n75_ & x24) | ~new_n68_ | new_n78_ | x15;
  assign new_n78_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n78_ & x25) | ~new_n68_ | new_n80_ | x15;
