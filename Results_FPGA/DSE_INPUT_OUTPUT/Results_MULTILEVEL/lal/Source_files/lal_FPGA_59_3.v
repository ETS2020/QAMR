...
module FAU ( 
  ...
  assign z09 = (x15 & x23) | (new_n51_ & ~x07 & ~x15);
  ...
  assign z14 = (x21 & (~new_n72_ | ~x19 | x20)) | ~new_n68_ | x15 | (new_n72_ & x19 & ~x20 & ~x21);
  assign new_n72_ = x17 & x18;
  assign z15 = x15 ? ~x23 : (new_n74_ | new_n51_ | new_n75_ | x07);
  assign new_n74_ = x22 & (~new_n72_ | ~x19 | x20 | x21);
  assign new_n75_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n75_ & x23) | ~new_n68_ | new_n77_ | x15;
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~x23 & (new_n79_ | x15)) | (~x15 & (~new_n68_ | (~new_n77_ & x24)));
  assign new_n79_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x24;
  assign z18 = (~x23 & (new_n81_ | x15)) | (~x15 & (~new_n68_ | new_n82_));
  assign new_n81_ = new_n70_ & ~x21 & ~x22 & ~x24 & ~x25;
