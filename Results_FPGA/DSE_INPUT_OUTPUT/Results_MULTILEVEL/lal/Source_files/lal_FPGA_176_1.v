...
module FAU ( 
  ...
  assign z09 = ~x15 & (x18 | (x04 & x05 & ~x07));
  assign z10 = ~x15 & (x18 | (~x07 & ~x17 & (~x04 | ~x05)));
  assign z11 = ~x15 & (x18 | (~x07 & x17 & (~x04 | ~x05)));
  assign z12 = ~x07 & ~x15 & ~x18 & x19 & (~x04 | ~x05);
  assign z13 = x15 | (~x18 & ((x04 & x05) | x07 | x20));
  assign z14 = x15 | (~x18 & ((x04 & x05) | x07 | x21));
  assign z15 = x18 | x22 | ~new_n51_ | x15;
  assign z16 = x18 | x23 | ~new_n51_ | x15;
  assign z17 = x18 | x24 | ~new_n51_ | x15;
  assign z18 = x18 | x25 | ~new_n51_ | x15;
endmodule
