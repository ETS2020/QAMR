...
module FAU ( 
  ...
  assign z01 = (x11 | x15) & (new_n49_ | ~new_n51_);
  ...
  assign z09 = ~x15 & x11 & new_n52_ & ~x07;
  assign z10 = ~x07 & x11 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = ~x07 & x11 & ~x15 & ~new_n52_ & (x17 ^ x18);
  assign z12 = ~x07 & new_n67_ & x11;
  assign new_n67_ = ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n69_ & x11);
  assign new_n69_ = (~x20 | (x17 & x18 & x19)) & ~new_n52_ & ~x07 & (~x19 | x20 | ~x17 | ~x18);
  assign z14 = (~new_n71_ & x21) | ~new_n51_ | ~new_n72_ | ~x11;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign new_n72_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x11 & (new_n74_ | new_n52_ | new_n75_ | x07));
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n75_ & x23) | ~new_n51_ | ~x11 | new_n77_ | x15;
  assign new_n77_ = new_n78_ & x17 & x18 & x19;
  assign new_n78_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = (~new_n77_ & x24) | ~new_n51_ | ~x11 | new_n80_ | x15;
  assign new_n80_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (x11 & (~new_n82_ | new_n52_ | (~new_n80_ & x25)));
