...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & ~x25) | new_n51_ | x07 | (x03 & x15);
  ...
  assign z09 = (x03 & x15) | (new_n51_ & ~x07 & ~x15);
  ...
  assign z15 = x15 ? ~x03 : (new_n71_ | new_n51_ | new_n72_ | x07);
  ...
  assign z18 = x15 ? ~x03 : (~new_n80_ | new_n51_ | (~new_n77_ & x25));
  assign new_n80_ = ~x07 & (~new_n78_ | ~new_n81_);
