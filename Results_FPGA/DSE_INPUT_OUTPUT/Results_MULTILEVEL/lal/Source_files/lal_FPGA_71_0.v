...
module FAU ( 
  ...
  assign new_n71_ = (~x21 | (new_n72_ & x19 & ~x20)) & ~new_n51_ & ~x07 & (~new_n72_ | ~x19 | x20 | x21);
  assign new_n72_ = x17 & x18;
  assign z15 = x15 | (x25 & (new_n74_ | new_n51_ | new_n75_ | x07));
  assign new_n74_ = x22 & (~new_n72_ | ~x19 | x20 | x21);
  assign new_n75_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x25 & ((~new_n75_ & x23) | ~new_n77_ | new_n51_));
  assign new_n77_ = ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (x25 & (new_n79_ | ~new_n80_ | new_n51_));
  assign new_n79_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n80_ = ~x07 & (~new_n69_ | x21 | x22 | x23 | x24);
  assign z18 = ~new_n82_ | ~new_n72_ | ~x19 | x15 | new_n51_ | x07;
