...
module FAU ( 
  ...
  assign z14 = (~x19 & (x15 | x21)) | (~x15 & (new_n51_ | ~new_n72_ | (~new_n71_ & x21)));
  assign new_n71_ = x17 & x18 & ~x20;
  assign new_n72_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~new_n74_ & ~x15) | (~x19 & (x15 | x22));
  assign new_n74_ = ~new_n75_ & ~new_n51_ & ~new_n76_ & ~x07;
  assign new_n75_ = x22 & (~x17 | ~x18 | x20 | x21);
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n50_ | ~new_n78_ | (~new_n76_ & x23);
  assign new_n78_ = ~x15 & (~new_n79_ | ~x17 | ~x18 | ~x19);
  assign new_n79_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~x19 & (x15 | x24)) | (~x15 & (~new_n82_ | new_n51_ | (~new_n81_ & x24)));
  ...
  assign z18 = (x25 & (~new_n83_ | ~new_n84_)) | ~new_n50_ | x15 | (new_n83_ & new_n86_);
