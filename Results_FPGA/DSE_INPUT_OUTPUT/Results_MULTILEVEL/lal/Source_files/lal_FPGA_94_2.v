...
module FAU ( 
  ...
  assign z01 = ~new_n49_ | (~x23 & (x15 | (~new_n51_ & ~x25)));
  ...
  assign z13 = (~new_n68_ & x20) | ~new_n67_ | new_n69_ | x15;
  assign new_n67_ = ~new_n50_ & ~x07;
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n69_ & x21) | ~new_n67_ | new_n71_ | x15;
  assign new_n71_ = new_n72_ & x19 & ~x20 & ~x21;
  assign new_n72_ = x17 & x18;
  assign z15 = x15 ? x23 : (~new_n74_ | (~new_n71_ & x22));
  assign new_n74_ = ~new_n50_ & ~x07 & (~new_n68_ | x20 | x21 | x22);
  assign z16 = (~new_n67_ & (~x15 | x23)) | new_n76_ | (x23 & (~new_n78_ | ~new_n72_ | x15));
  assign new_n76_ = new_n77_ & x18 & x19 & ~x15 & x17;
  assign new_n77_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n78_ = ~x21 & ~x22 & x19 & ~x20;
  assign z17 = (x24 & (~new_n68_ | ~new_n77_)) | ~new_n67_ | new_n80_ | x15;
  assign new_n80_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n80_ & x25) | ~new_n67_ | new_n82_ | x15;
