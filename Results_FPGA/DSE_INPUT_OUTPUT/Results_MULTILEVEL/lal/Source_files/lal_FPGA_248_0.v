...
module FAU ( 
  ...
  assign z13 = (~new_n68_ & x20) | ~new_n67_ | x15 | new_n69_ | ~x16;
  ...
  assign z15 = new_n74_ | ~new_n67_ | x15 | new_n73_ | ~x16;
  assign new_n73_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n73_ & x23) | ~new_n67_ | x15 | new_n76_ | ~x16;
  assign new_n76_ = new_n68_ & ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = (~new_n76_ & x24) | ~new_n67_ | x15 | new_n78_ | ~x16;
  assign new_n78_ = new_n69_ & ~x23 & ~x24 & ~x21 & ~x22;
  assign z18 = (~new_n78_ & x25) | ~new_n67_ | x15 | new_n80_ | ~x16;
