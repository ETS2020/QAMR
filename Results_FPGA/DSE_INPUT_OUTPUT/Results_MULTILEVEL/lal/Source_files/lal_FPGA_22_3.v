...
module FAU ( 
  ...
  assign z16 = x15 ? ~x25 : (~new_n76_ | new_n51_ | (~new_n73_ & x23));
  assign new_n76_ = ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = new_n78_ | new_n51_ | x07 | new_n79_ | x15;
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n51_ | x07 | new_n81_ | x15 | (~new_n79_ & x25);
