// Benchmark "FAU" written by ABC on Tue Aug 18 17:08:12 2020
...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n53_, new_n56_, new_n58_,
    new_n59_, new_n64_, new_n65_, new_n72_, new_n73_, new_n75_, new_n76_,
  ...
  assign new_n53_ = ~x23 & ~x25 & (x18 ? ~x15 : (x17 | x19));
  assign z02 = ~new_n48_ & x16;
  assign z03 = ~x25 & (new_n56_ | (~new_n48_ & ~new_n52_));
  assign new_n56_ = ~x20 & ~x23 & (x18 ? ~x15 : (x17 | x19));
  ...
  assign z08 = (~new_n64_ & (~x15 | ~x18)) | (new_n65_ & ~x17 & ~x18 & ~x19);
  assign new_n64_ = ~x25 & (~x24 | (~x23 & (~x20 | ~x21 | ~x22)));
  assign new_n65_ = x21 & x22 & x24;
  assign z09 = (x15 & x18) | (new_n51_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = (x15 & x18) | (~x07 & ~new_n51_ & ((~x17 & x18) | (~x15 & x17 & ~x18)));
  assign z12 = (x15 & x18) | (~x07 & ~new_n51_ & ((~x15 & x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19)));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n50_ | x15 | (x17 & x18 & x19 & ~x20);
  ...
  assign z15 = (~new_n75_ & ~x15) | (~x18 & (x15 | x22));
  assign new_n75_ = ~new_n76_ & ~new_n51_ & ~new_n77_ & ~x07;
  assign new_n76_ = x22 & (~x17 | ~x19 | x20 | x21);
  assign new_n77_ = ~x20 & ~x21 & ~x22 & x17 & x18 & x19;
  assign z16 = new_n81_ | (~x15 & (new_n82_ | new_n51_ | new_n79_ | x07));
  assign new_n79_ = new_n80_ & x17 & x18 & x19;
  assign new_n80_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n81_ = ~x18 & (x15 | x23);
  assign new_n82_ = x23 & (~x17 | ~x19 | x20 | x21 | x22);
  assign z17 = (~new_n79_ & x24) | ~new_n50_ | x15 | (new_n84_ & new_n85_);
  assign new_n84_ = x17 & x18 & x19 & ~x20;
  assign new_n85_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~x18 & (x15 | x25)) | (~x15 & (~new_n87_ | (x25 & (~new_n72_ | ~new_n85_))));
  assign new_n87_ = ~new_n51_ & ~x07 & (~new_n84_ | ~new_n88_);
