...
module FAU ( 
  ...
  assign z04 = ~x08 & ~new_n56_ & (x15 | ~x16);
  ...
  assign z08 = (x15 | ~x16) & (x25 | (x24 & (new_n62_ | x23)));
  assign new_n62_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & (x16 | (x04 & x05 & ~x07));
  assign z10 = ~x07 & ~x15 & ~x16 & ~new_n52_ & ~x17;
  assign z11 = ~x15 & (x16 | (~x07 & ~new_n52_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n67_ & ~x15;
  assign new_n67_ = ~x16 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n69_ & ~x16);
  assign new_n69_ = (~x20 | (x17 & x18 & x19)) & ~new_n52_ & ~x07 & (~x19 | x20 | ~x17 | ~x18);
  assign z14 = (~new_n71_ & x21) | ~new_n51_ | x15 | new_n72_ | x16;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n72_ & x22) | ~new_n51_ | x15 | new_n74_ | x16;
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | ~new_n51_ | x15 | new_n76_ | x16;
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x16 & (~new_n79_ | new_n52_ | (~new_n76_ & x24)));
  assign new_n79_ = ~x07 & (~new_n71_ | x23 | x24 | x21 | x22);
  assign z18 = new_n81_ | ~new_n51_ | x15 | new_n82_ | x16;
  assign new_n81_ = x25 & (~new_n71_ | x21 | x22 | x23 | x24);
