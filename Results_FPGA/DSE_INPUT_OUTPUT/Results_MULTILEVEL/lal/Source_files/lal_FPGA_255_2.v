// Benchmark "FAU" written by ABC on Tue Aug 18 17:08:45 2020
...
module FAU ( 
  ...
  assign z01 = ~new_n51_ | (~new_n49_ & ~x25);
  ...
  assign z08 = (~x07 | x15) & (x25 | (x24 & (new_n62_ | x23)));
  ...
  assign z14 = (~new_n69_ & x21) | ~new_n51_ | new_n70_ | x15;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x07 & (new_n52_ | new_n72_ | (~new_n70_ & x22)));
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n72_ & x23) | ~new_n51_ | new_n74_ | x15;
  assign new_n74_ = new_n75_ & x17 & x18 & x19;
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (new_n77_ | new_n52_ | (~new_n74_ & x24)));
  assign new_n77_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n77_ & x25) | ~new_n51_ | new_n79_ | x15;
