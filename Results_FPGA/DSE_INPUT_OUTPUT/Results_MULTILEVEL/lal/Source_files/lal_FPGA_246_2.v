// Benchmark "FAU" written by ABC on Tue Aug 18 17:08:43 2020
...
module FAU ( 
  ...
  assign z01 = (new_n49_ | new_n51_ | x07) & (~x14 | x15);
  ...
  assign z10 = ~x15 & (x14 | (~x07 & ~new_n51_ & ~x17));
  assign z11 = ~x07 & ~x14 & ~x15 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x15 & (new_n66_ | x14);
  ...
  assign z17 = x15 | (~x14 & (new_n79_ | ~new_n80_ | new_n51_));
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = new_n82_ | new_n51_ | x07 | x14 | new_n83_ | x15;
