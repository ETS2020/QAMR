...
module FAU ( 
  ...
  assign z14 = ~new_n53_ & ((~new_n71_ & x21) | ~new_n49_ | new_n73_ | x15);
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n73_ & x22) | ~new_n49_ | x15 | new_n75_ | new_n53_;
  assign new_n75_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n75_ & x23) | ~new_n49_ | x15 | new_n77_ | new_n53_;
  assign new_n77_ = new_n70_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = ((~x16 | ~x24) & (new_n50_ | ~new_n64_)) | new_n79_ | (~x16 & ~new_n77_ & x24);
  assign new_n79_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x24 & (x16 | x25)) | ~new_n81_ | (~new_n77_ & x25);
  assign new_n81_ = ~new_n50_ & ~x07 & ~x15 & (~new_n71_ | ~new_n82_);
