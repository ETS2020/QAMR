...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n61_ | x23)) | x25 | (~x01 & ~x15);
  assign new_n61_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & ~x07 & x05 & x01 & x04;
  assign z10 = ~x15 & (~x01 | (~x07 & ~new_n51_ & ~x17));
  assign z11 = ~x15 & (~x01 | (~x07 & ~new_n51_ & (x17 ^ x18)));
  ...
  assign z16 = (~new_n74_ & x23) | ~new_n68_ | x07 | new_n76_ | x15;
  assign new_n76_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x01 & (~new_n78_ | new_n51_ | (~new_n76_ & x24)));
  assign new_n78_ = ~x07 & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = new_n80_ | ~new_n68_ | x07 | new_n81_ | x15;
  assign new_n80_ = x25 & (~new_n70_ | x21 | x22 | x23 | x24);
