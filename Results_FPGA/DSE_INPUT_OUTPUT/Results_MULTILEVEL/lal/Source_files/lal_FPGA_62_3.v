...
module FAU ( 
  ...
  assign z09 = (x07 & x15) | (new_n51_ & ~x07 & ~x15);
  ...
  assign z13 = x07 ? ~x15 : ((~new_n67_ & x20) | new_n51_ | new_n68_ | x15);
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x19 & ~x20 & x17 & x18;
  assign z14 = (~new_n68_ & x21) | new_n51_ | x07 | new_n70_ | x15;
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n70_ & x22) | new_n72_ | x15 | new_n51_ | x07;
  ...
  assign z17 = x07 ? ~x15 : ((~new_n74_ & x24) | new_n51_ | new_n76_ | x15);
  assign new_n76_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 ? ~x15 : ((~new_n76_ & x25) | new_n51_ | new_n78_ | x15);
