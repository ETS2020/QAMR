...
module FAU ( 
  ...
  assign z16 = (~new_n73_ & x23) | ~new_n51_ | new_n76_ | x15;
  assign new_n76_ = new_n68_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n76_ & x24) | ~new_n51_ | ~new_n78_;
  assign new_n78_ = ~x15 & (~new_n69_ | ~new_n74_ | x23 | x24);
  assign z18 = x15 | (~new_n80_ & ~x07);
  assign new_n80_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~new_n52_ & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
