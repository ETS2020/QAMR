...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n54_, new_n55_, new_n60_, new_n65_, new_n67_,
    ...
    new_n79_, new_n81_;
  assign z00 = ~z02 & x08;
  assign z02 = (~x04 & x15) | x16;
  assign z01 = (~new_n50_ & ~x25) | (x04 & x05) | x07 | (~x04 & x15);
  assign new_n50_ = x24 & (new_n51_ | x23);
  assign new_n51_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign z03 = ~x25 & ~new_n50_ & (x04 | ~x15);
  ...
  assign z12 = (~x04 & x15) | (~x07 & ~new_n65_ & (~x04 | (~x05 & ~x15)));
  ...
  assign z17 = new_n78_ | ~new_n79_ | x07 | (x04 & x05);
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = ~x15 & (~new_n69_ | ~new_n74_ | x23 | x24);
