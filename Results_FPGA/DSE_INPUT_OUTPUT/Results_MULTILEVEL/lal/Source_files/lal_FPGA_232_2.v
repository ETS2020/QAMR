...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n60_, new_n65_,
    new_n67_, new_n68_, new_n69_, new_n71_, new_n73_, new_n75_, new_n77_,
  ...
  assign z15 = (~new_n71_ & x22) | new_n73_ | x15 | new_n51_ | x07;
  assign new_n73_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 ? x16 : (~new_n75_ | new_n51_ | (~new_n73_ & x23));
  assign new_n75_ = ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? x16 : (new_n77_ | ~new_n78_ | new_n51_);
