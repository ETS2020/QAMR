...
module FAU ( 
  ...
  assign z0 = x4 ? ((~x5 & (~x0 | x3)) | (~x0 & new_n20_ & x5)) : (new_n21_ & x5);
  assign new_n20_ = ~x6 & (~x1 | ~x2 | ~x3);
  assign new_n21_ = x6 & ((x3 & (x0 | x2)) | (~x0 & x1));
  ...
  assign z3 = x0 ? (x3 & ((~x1 & ~x5 & (~x2 | ~x6)) | (x5 & (x1 | (x2 & x6))))) : (x5 ? ((~x1 & ~x6) | ((~x1 | ~x6) & (~x2 | ~x3))) : ((x2 & x3 & x6) | (x1 & (x6 | (x2 & x3)))));
  ...
  assign z8 = ~x0 & ~x3;
  assign z9 = (x0 & (~x3 | (x4 & x5))) | (x4 & ~new_n20_ & x5);
endmodule
