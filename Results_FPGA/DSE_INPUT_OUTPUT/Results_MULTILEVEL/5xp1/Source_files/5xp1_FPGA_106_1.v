...
module FAU ( 
  ...
  assign z0 = x5 ? (~x4 | (~x0 & ~new_n20_ & ~x6)) : x4;
  assign new_n20_ = x1 & x2 & x3;
  assign z1 = x5 ? (~x4 | (~x0 & ~new_n20_ & ~x6)) : ((~new_n22_ & x0) | (x4 & x6));
  assign new_n22_ = (~x2 | (~x6 & (~x1 | ~x4))) & (~x1 | (~x6 & (~x3 | ~x4)));
  assign z2 = (~new_n24_ & x3) | new_n25_ | (~new_n26_ & x4) | (new_n27_ & ~x4);
  assign new_n24_ = (~x2 | ~x4 | ~x5 | ~x6) & (~x0 | ~x1 | x4 | x5 | x6);
  assign new_n25_ = x0 & ((x1 & ((x4 & x6) | (x2 & ~x4 & ~x5 & ~x6))) | (x4 & x6 & (x2 | x5)));
