...
module FAU ( 
  ...
  assign z1 = (~new_n23_ & x4) | (~x4 & x5 & (new_n22_ | ~x6)) | (~x5 & x6);
  assign new_n22_ = ~x0 & ~x1 & (~x2 | ~x3);
  assign new_n23_ = x0 ? (~x1 | x5 | (~x2 & ~x3)) : (~x5 | x6 | (x1 & x2 & x3));
  ...
  assign z3 = (x1 & ((x2 & (x0 ? x5 : (x3 & ~x5))) | (x0 & (x6 | (x3 & x5))))) | (x6 & (~x5 | (x0 & x2))) | (x0 & ~x5 & (~x1 | (~x2 & ~x3))) | (~x0 & x5 & (((~x2 | ~x3) & (~x1 | ~x6)) | (~x1 & ~x6)));
