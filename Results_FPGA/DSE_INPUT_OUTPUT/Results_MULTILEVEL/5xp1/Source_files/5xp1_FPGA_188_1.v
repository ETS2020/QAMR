...
module FAU ( 
  ...
  assign z0 = (~x5 & (x4 | x6)) | (~x0 & x4 & x5 & ~x6 & (~new_n20_ | ~x1)) | (~x4 & x6);
  assign new_n20_ = x2 & x3;
  assign z1 = (~new_n22_ & x4) | (~x4 & (x5 | x6)) | (~x5 & x6);
  assign new_n22_ = x0 ? (~x1 | x5 | (~x2 & ~x3)) : (~x5 | x6 | (x1 & x2 & x3));
  ...
  assign z3 = new_n27_ | (~new_n28_ & x5) | (~x4 & x6) | (~new_n29_ & ~x5);
  assign new_n27_ = x2 & (x1 | x6) & (x0 ? x5 : (x3 & ~x5));
  assign new_n28_ = x0 ? (~x1 | (~x3 & ~x6)) : ((x1 | x6) & ((x2 & x3) | (x1 & x6)));
  assign new_n29_ = x0 ? ((x1 | (x2 & x6)) & (x2 | x3 | x6)) : (~x1 | ~x6);
  ...
  assign z8 = ~x3 | (~x4 & x6);
  assign z9 = (~x4 & x6) | (x5 & (x6 | (x4 & (x0 | (new_n20_ & x1)))));
endmodule
