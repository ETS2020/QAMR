// Benchmark "FAU" written by ABC on Mon Aug 17 19:54:31 2020
...
module FAU ( 
  ...
  assign z4 = (x1 & (x6 ? ((x2 & x3) | (x0 & (x2 | x3))) : ((~x2 & ~x3) | (~x0 & (~x2 | ~x3))))) | new_n34_ | (~x1 & ((x2 & (x0 | x3) & ~x6) | (x6 & (~x2 | (~x0 & ~x3)))));
  assign new_n34_ = ~x4 & x5;
  assign z5 = ~new_n34_ & (x0 ? (x2 ? x3 : (~x1 | ~x3)) : ((x1 & ~x2 & x3) | (x2 & ~x3)));
  assign z6 = ~new_n34_ & (~x1 ^ (x2 | ~x3));
