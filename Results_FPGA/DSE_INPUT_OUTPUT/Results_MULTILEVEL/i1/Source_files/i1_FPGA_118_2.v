// Benchmark "FAU" written by ABC on Tue Aug 18 17:01:53 2020
...
module FAU ( 
  ...
  assign new_n46_ = ~x05 & ~x06 & ~x07 & (x08 ? x09 : (~x09 & x19));
  assign z02 = x19 ? (new_n48_ | new_n50_) : x09;
  ...
  assign z04 = z03 | x21;
  assign z05 = new_n55_ | (x10 & (~x09 | x19));
  assign new_n55_ = new_n51_ & ~x07 & ~x08 & x19 & ~x05 & ~x06;
