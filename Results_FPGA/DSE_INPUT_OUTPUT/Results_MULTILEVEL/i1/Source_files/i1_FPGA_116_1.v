// Benchmark "FAU" written by ABC on Tue Aug 18 17:01:52 2020
...
module FAU ( 
  ...
  assign new_n45_ = ~x06 & (x07 | (~x01 & new_n46_ & ~x02));
  assign new_n46_ = ~x03 & ~x04 & ~x05 & x19 & (~x08 ^ x09);
  assign z02 = (~new_n48_ & ~x06) | (x00 & ~new_n50_ & x19);
  assign new_n48_ = ~x07 & (~new_n49_ | x05 | ~x08 | x09 | ~x19);
  assign new_n49_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n50_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x05 & ~x06;
  assign z03 = x20 & (x06 | ~x07);
  assign z04 = x21 | x20 | (~x06 & x07);
  assign z05 = (~x07 & (x10 | (new_n49_ & new_n54_ & ~x05 & ~x06))) | (x06 & x10);
