// Benchmark "FAU" written by ABC on Tue Aug 18 17:01:46 2020
...
module FAU ( 
  ...
  assign z02 = (x07 & (x00 | ~x19)) | (x19 & (new_n48_ | (~new_n50_ & x00)));
  ...
  assign new_n54_ = (~x07 | x19) & (~new_n49_ | x05 | x06 | x07 | x08 | ~x19);
  assign z06 = x19 | (x07 & ~x19);
