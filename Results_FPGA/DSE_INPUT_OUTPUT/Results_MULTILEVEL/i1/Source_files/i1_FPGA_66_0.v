...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_;
  assign z00 = x00 | (~x07 & ~x19);
  assign z01 = x19 & (~x00 | (~x01 & ~x02 & new_n45_ & ~x03));
  assign new_n45_ = ~x04 & ~x05 & ~x06 & ~x07 & (~x08 ^ x09);
  assign z02 = (~x07 & (new_n47_ | ~x19)) | (x00 & ~new_n50_ & x19);
  assign new_n47_ = new_n48_ & new_n49_ & x08 & ~x09;
  ...
  assign z04 = z03 | x21;
  assign z05 = (x10 & (x07 | x19)) | (new_n48_ & new_n49_ & ~x07 & ~x08 & x19);
