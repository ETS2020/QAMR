// Benchmark "FAU" written by ABC on Tue Aug 18 17:01:39 2020
...
module FAU ( 
  ...
  assign z02 = (x06 & (x00 | ~x19)) | (x19 & (new_n48_ | (~new_n50_ & x00)));
  ...
  assign new_n54_ = (~x06 | x19) & (~new_n49_ | x05 | x06 | x07 | x08 | ~x19);
