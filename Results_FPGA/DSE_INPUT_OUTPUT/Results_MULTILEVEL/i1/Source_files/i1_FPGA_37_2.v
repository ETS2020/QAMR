...
module FAU ( 
  ...
  assign z05 = (~x07 & (x10 | (new_n50_ & new_n55_))) | (x10 & x11);
  assign new_n55_ = ~x05 & ~x06 & ~x08 & x19;
  ...
  assign z15 = (~x07 | x11) & (x14 | x15 | x12 | x13);
endmodule
