...
module FAU ( 
  ...
  assign new_n45_ = (x01 | x02 | ~new_n46_ | x03) & x00 & x16;
  ...
  assign new_n50_ = x16 & (~new_n51_ | x01 | x02 | x03 | x04);
  assign new_n51_ = ~x05 & ~x06 & ~x07 & x08 & ~x09;
  assign z03 = x20 & (x16 | ~x19);
  assign z04 = (x16 | ~x19) & (x20 | x21);
  assign z05 = (x10 & (x16 | ~x19)) | (new_n55_ & new_n49_ & ~x08 & x16 & x19);
  assign new_n55_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x05;
  assign z06 = x16 & x19;
  assign z07 = (~x16 & x19) | (x18 & x24);
  assign z08 = x11 & (x16 | ~x19);
  assign z09 = (~x16 & x19) | (x11 & x24);
  assign z10 = (~x16 & x19) | (x14 & x22 & ~x24);
  assign z11 = x17 & x22 & ~x24 & (x16 | ~x19);
  assign z12 = x14 & x23 & (x16 | ~x19) & ~x24;
  assign z13 = x17 & x23 & ~x24 & (x16 | ~x19);
  assign z14 = x16 ? ~x24 : x19;
  assign z15 = (x16 | ~x19) & (x14 | x15 | x12 | x13);
endmodule
