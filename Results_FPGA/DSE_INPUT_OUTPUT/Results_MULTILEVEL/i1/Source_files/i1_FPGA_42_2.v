...
module FAU ( 
  ...
  assign z00 = x00 & x19;
  assign z01 = x00 ? (~x19 | (~x01 & ~x02 & new_n45_ & ~x03)) : x19;
  assign new_n45_ = ~x04 & ~x05 & ~x06 & ~x07 & (~x08 ^ x09);
  assign z02 = ((~new_n47_ | ~new_n48_) & x00) | (new_n49_ & new_n50_);
  assign new_n47_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n48_ = ~x05 & ~x06 & ~x07 & x19;
  assign new_n49_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x05;
  assign new_n50_ = ~x06 & ~x07 & x08 & ~x09 & x19;
  assign z03 = x20 | (x00 & ~x19);
  assign z04 = (x20 | x21) & (~x00 | x19);
  assign z05 = x10 | (new_n47_ & new_n54_) | (x00 & ~x19);
