// Benchmark "FAU" written by ABC on Tue Aug 18 17:02:12 2020
...
module FAU ( 
  ...
  assign z05 = x10 | (new_n49_ & new_n54_) | (x16 & ~x19);
  assign new_n54_ = ~x05 & ~x06 & ~x07 & ~x08 & x19;
  assign z06 = x19 | (x16 & ~x19);
  ...
  assign z15 = x14 | x15 | x13 | x12 | (x16 & ~x19);
endmodule
