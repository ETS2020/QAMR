// Benchmark "FAU" written by ABC on Tue Aug 18 17:02:46 2020
...
module FAU ( 
  ...
  assign new_n47_ = new_n48_ & ~x05 & ~x07 & x08 & ~x09;
  ...
  assign z05 = (x10 & (x06 | x19)) | (new_n48_ & new_n54_ & ~x05 & ~x06);
  assign new_n54_ = ~x07 & ~x08 & x19;
  assign z06 = x19 | (~x06 & ~x19);
