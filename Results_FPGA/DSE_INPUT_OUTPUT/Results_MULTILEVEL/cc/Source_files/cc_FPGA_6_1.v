// Benchmark "FAU" written by ABC on Mon Aug 17 19:58:06 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n58_, new_n62_, new_n63_, new_n65_, new_n68_,
    new_n70_;
  ...
  assign new_n58_ = ~x18 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = (~x15 & x18) | (x12 & ((x15 & (new_n45_ | x14)) | (x14 & (~new_n45_ | ~x01))));
  assign z14 = (~x15 & x18) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = x12 & (new_n62_ | new_n63_);
  assign new_n62_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & ~x18));
  assign new_n63_ = x03 & x08 & x10 & ~x15 & ~x18;
  assign z16 = (~new_n65_ & ~x15) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n65_ = ~x18 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = (~x15 & x18) | (x12 & (x18 | (x05 & x08 & x10 & ~x15)));
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (x18 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15))) & (~x15 | ~x19);
  assign z19 = ~new_n70_ & x12;
  assign new_n70_ = (x18 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15))) & (~x15 | ~x20);
endmodule
