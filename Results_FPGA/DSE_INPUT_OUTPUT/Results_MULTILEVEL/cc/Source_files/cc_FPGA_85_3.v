...
module FAU ( 
  ...
  assign z12 = x12 & (((~new_n47_ | ~x08) & x13) | x17 | (new_n47_ & x00 & x08));
  assign z13 = ~new_n57_ & x12;
  assign new_n57_ = (~x14 | (x01 & x08 & x10)) & ~x17 & (~x08 | ~x10 | ~x15);
  assign z14 = x12 & (((~x08 | ~x10) & x15) | x17 | (x02 & x08 & x10 & ~x15));
  ...
  assign z19 = x12 & (((~new_n47_ | ~x08) & x20) | x17 | (new_n47_ & x07 & x08));
  assign z09 = ~z10;
endmodule
