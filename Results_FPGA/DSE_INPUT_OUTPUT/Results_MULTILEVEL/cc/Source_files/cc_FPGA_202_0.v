...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n54_, new_n58_, new_n59_, new_n61_, new_n63_, new_n66_;
  ...
  assign new_n54_ = x19 & (~x00 | ~x08 | ~x10 | ~x12);
  ...
  assign new_n58_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & x19));
  assign new_n59_ = x03 & x08 & x10 & ~x15 & x19;
  assign z16 = (~new_n61_ & ~x15) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n61_ = x19 & (~x04 | ~x08 | ~x10 | ~x12);
