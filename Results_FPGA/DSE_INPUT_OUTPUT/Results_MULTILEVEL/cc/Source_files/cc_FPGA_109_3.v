...
module FAU ( 
  ...
  assign z02 = ~x11 & x12 & ((~x13 & (new_n46_ | x14)) | (~x10 & x14));
  ...
  assign z12 = (x10 & (x13 | (x00 & x08 & x12 & ~x15))) | (x12 & x13);
  ...
  assign z16 = (~new_n63_ & x10) | (x12 & ~new_n46_ & x17);
  assign new_n63_ = ~x13 & (~x04 | ~x08 | ~x12 | x15);
  assign z17 = (~new_n65_ & x10) | (x12 & ~new_n46_ & x18);
  assign new_n65_ = ~x13 & (~x05 | ~x08 | ~x12 | x15);
  assign z18 = ~new_n67_ & x12;
  assign new_n67_ = (x10 | ~x19) & (x13 | ((~x06 | ~x08 | ~x10 | x15) & (~x19 | (x08 & ~x15))));
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = (x10 | ~x20) & (x13 | ((~x07 | ~x08 | ~x10 | x15) & (~x20 | (x08 & ~x15))));
endmodule
