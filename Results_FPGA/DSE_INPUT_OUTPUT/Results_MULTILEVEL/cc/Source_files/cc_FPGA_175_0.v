...
module FAU ( 
  ...
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x10))) & (~x04 | ~x14 | (x01 & x08 & x10));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x08 & x10 & ~x15 & x02 & x04));
  ...
  assign new_n65_ = x04 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = (~new_n67_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n67_ = x04 & (~x06 | ~x08 | ~x10 | ~x12);
