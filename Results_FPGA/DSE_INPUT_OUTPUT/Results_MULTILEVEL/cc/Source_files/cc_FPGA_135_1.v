...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n48_, new_n59_, new_n61_, new_n63_, new_n65_;
  ...
  assign z16 = (~new_n61_ & x12) | (x15 & (~x13 | (x12 & x17)));
  assign new_n61_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (~new_n63_ & x12) | (x15 & (~x13 | (x12 & x18)));
  assign new_n63_ = (~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = (~new_n65_ & x12) | (x15 & (~x13 | (x12 & x19)));
