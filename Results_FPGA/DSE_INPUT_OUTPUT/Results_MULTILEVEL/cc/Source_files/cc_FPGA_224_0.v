...
module FAU ( 
  ...
  assign z01 = ~x14 & (~x09 | (x08 & x10 & x15));
  assign z02 = (~x09 & ~x14) | (~x11 & x12 & (x14 | (new_n47_ & x08)));
  ...
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x09 | ~x10))) & (~x14 | (x01 & x08 & x10));
  ...
  assign z17 = new_n44_ | (x12 & ((x18 & (~new_n47_ | ~x08)) | (new_n47_ & x05 & x08)));
