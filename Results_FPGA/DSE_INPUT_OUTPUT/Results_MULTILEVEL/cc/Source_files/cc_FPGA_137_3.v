...
module FAU ( 
  ...
  assign z03 = x10 & (x19 | (x08 & x12 & ~x14 & x15));
  ...
  assign new_n66_ = ~x19 & (~x05 | ~x08 | ~x12 | x15);
  assign z18 = x12 & ((x06 & x08 & x10 & ~x15 & ~x19) | (~x10 & x19));
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = (x10 | ~x20) & (x19 | ((~x07 | ~x08 | ~x10 | x15) & (~x20 | (x08 & ~x15))));
  assign z05 = x19;
endmodule
