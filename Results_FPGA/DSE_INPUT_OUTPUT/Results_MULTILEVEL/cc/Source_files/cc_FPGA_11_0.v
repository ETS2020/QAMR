// Benchmark "FAU" written by ABC on Mon Aug 17 19:58:08 2020
...
module FAU ( 
  ...
  assign z12 = (~x10 & ~x15) | (x12 & ((x08 & ~x15) ? x00 : x13));
  assign z13 = (~x10 & (~x15 | (x12 & x14))) | (x12 & ((x15 & (x14 | (x08 & x10))) | ((~x01 | ~x08) & x14)));
  assign z14 = (~x10 & (x12 | ~x15)) | (x12 & ((~x08 & x15) | (x02 & x08 & ~x15)));
  assign z15 = new_n57_ | (~x10 & ~x15);
  assign new_n57_ = x12 & ((x03 & x08 & ~x15) | (~x14 & x16 & (~x08 | x15)));
  assign z16 = (~x15 & (~x10 | (x04 & x08 & x12))) | (x12 & x17 & (~x08 | x15));
  assign z17 = (~x15 & (~x10 | (x05 & x08 & x12))) | (x12 & x18 & (~x08 | x15));
