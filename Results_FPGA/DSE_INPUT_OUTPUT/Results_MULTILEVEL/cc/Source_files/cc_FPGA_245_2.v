...
module FAU ( 
  ...
  assign new_n47_ = x12 & ((~x07 & (x14 | (x08 & x10 & ~x15))) | (x14 & x15));
  ...
  assign new_n65_ = (~x15 | ~x17) & (x07 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15)));
  assign z17 = ~new_n67_ & x12;
  assign new_n67_ = (~x15 | ~x18) & (x07 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15)));
  assign z18 = ~new_n69_ & x12;
  assign new_n69_ = (~x15 | ~x19) & (x07 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15)));
