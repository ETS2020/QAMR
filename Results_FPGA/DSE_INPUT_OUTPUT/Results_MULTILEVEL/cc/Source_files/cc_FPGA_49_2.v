...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n57_, new_n59_, new_n62_, new_n65_;
  ...
  assign z12 = x12 & ~new_n45_ & ((x13 & (~new_n57_ | ~x08)) | (new_n57_ & x00 & x08));
  ...
  assign z17 = x12 & ((x05 & (new_n65_ | (x18 & x20))) | (x18 & ~new_n47_ & x20));
  assign new_n65_ = x08 & x10 & ~x15 & ~x18;
  assign z18 = x12 & ~new_n45_ & ((x19 & (~new_n57_ | ~x08)) | (new_n57_ & x06 & x08));
  assign z19 = x12 & ((~new_n47_ & x20) | (x07 & (new_n65_ | x20)));
  assign z04 = ~x18;
endmodule
