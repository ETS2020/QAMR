...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n55_, new_n59_, new_n60_, new_n62_, new_n64_, new_n67_;
  ...
  assign new_n55_ = ~x19 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = x12 & ((x15 & (new_n45_ | x14)) | (x14 & (~new_n45_ | ~x01) & ~x19));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15 & ~x19));
  assign z15 = x12 & (new_n59_ | new_n60_);
  assign new_n59_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & ~x19));
  assign new_n60_ = x03 & x08 & x10 & ~x15 & ~x19;
  assign z16 = (~new_n62_ & ~x15) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n62_ = ~x19 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = (~new_n64_ & ~x15) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n64_ = ~x19 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = (~x15 & x19) | (x12 & (x19 | (x06 & x08 & x10 & ~x15)));
  assign z19 = ~new_n67_ & x12;
  assign new_n67_ = (x19 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15))) & (~x15 | ~x20);
  assign z09 = ~z10;
  assign z06 = x15;
endmodule
