...
module FAU ( 
  ...
  assign new_n55_ = (~x13 | ~x15) & (~x04 | ((~x13 | (x08 & x10)) & (~x10 | x15 | ~x00 | ~x08)));
  assign z13 = ~new_n57_ & x12;
  assign new_n57_ = (~x15 | (~x14 & (~x08 | ~x10))) & (~x04 | ~x14 | (x01 & x08 & x10));
  assign z14 = (~x04 & ~x15) | (x12 & ((x10 & ~x15 & x02 & x08) | (x15 & (~x08 | ~x10))));
  assign z15 = x12 & ((~new_n60_ & x04) | (~x14 & x15 & x16));
  assign new_n60_ = (x14 | (x08 & x10) | ~x16) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = (~x04 & ~x15) | (x12 & (x17 | (x08 & x10 & ~x15)));
  assign z17 = ~new_n63_ & x12;
  assign new_n63_ = (~x15 | ~x18) & (~x04 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15)));
  assign z18 = (~new_n65_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n65_ = x04 & (~x06 | ~x08 | ~x10 | ~x12);
  assign z19 = ~new_n67_ & x12;
  assign new_n67_ = (~x15 | ~x20) & (~x04 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15)));
  assign z09 = ~z10;
  assign z06 = x15;
endmodule
