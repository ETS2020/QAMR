...
module FAU ( 
  ...
  assign new_n57_ = x10 ? ((~x14 | (x01 & x08)) & (~x08 | ~x15)) : (x13 | ~x14);
  assign z14 = (~x10 & (x13 | (x12 & x15))) | (x12 & ((x02 & x08 & x10 & ~x15) | (~x08 & x15)));
  assign z15 = (~new_n60_ & x12) | (~x10 & (x13 | (x12 & ~x14 & x16)));
  assign new_n60_ = (x14 | ~x16 | (x08 & ~x15)) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = x12 & (x10 ? (new_n62_ ? x04 : x17) : (~x13 & x17));
  assign new_n62_ = x08 & ~x15;
  assign z17 = (~new_n64_ & x12) | (~x10 & (x13 | (x12 & x18)));
  assign new_n64_ = (~x18 | (x08 & ~x15)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = x12 & (x10 ? (new_n62_ ? x06 : x19) : (~x13 & x19));
