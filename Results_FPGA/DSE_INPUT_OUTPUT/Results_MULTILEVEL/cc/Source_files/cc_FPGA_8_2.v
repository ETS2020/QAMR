...
module FAU ( 
  ...
  assign z02 = (x06 & ~x15) | (~x11 & x12 & (new_n46_ | x14));
  ...
  assign new_n56_ = ~x06 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (~x15 | (~x14 & (~x08 | ~x10))) & (x06 | ~x14 | (x01 & x08 & x10));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & ~x06 & x08 & x10 & ~x15));
  assign z15 = new_n61_ | (x12 & ~x14 & ~new_n46_ & x16);
  assign new_n61_ = ~x15 & (x06 | (x03 & x08 & x10 & x12));
  assign z16 = ~new_n63_ & x12;
  assign new_n63_ = (x06 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15))) & (~x15 | ~x17);
  assign z17 = (~new_n65_ & ~x15) | (x12 & ~new_n46_ & x18);
  assign new_n65_ = ~x06 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = x12 & x19 & (x15 | (~x06 & (~x08 | ~x10)));
  assign z19 = ~new_n68_ & x12;
  assign new_n68_ = (~x15 | ~x20) & (x06 | ((~x20 | (x08 & x10)) & (~x10 | x15 | ~x07 | ~x08)));
  assign z06 = x15;
endmodule
