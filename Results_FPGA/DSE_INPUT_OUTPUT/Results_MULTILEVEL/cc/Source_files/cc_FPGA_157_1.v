// Benchmark "FAU" written by ABC on Mon Aug 17 19:58:59 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n47_, new_n55_, new_n57_, new_n60_, new_n64_;
  ...
  assign z12 = (~new_n55_ & x12) | (x15 & (~x09 | (x12 & x13)));
  assign new_n55_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = x12 & ((x09 & x15 & (new_n57_ | x14)) | (x14 & (~new_n57_ | ~x01) & ~x15));
  ...
  assign z16 = x12 & ((~x15 & (new_n57_ ? x04 : x17)) | (x09 & x15 & x17));
  assign z17 = x12 & ((~x15 & (new_n57_ ? x05 : x18)) | (x09 & x15 & x18));
  assign z18 = (~new_n64_ & x12) | (x15 & (~x09 | (x12 & x19)));
  assign new_n64_ = (~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = x12 & ((~x15 & (new_n57_ ? x07 : x20)) | (x09 & x15 & x20));
  assign z10 = ~z09;
  assign z06 = x15;
endmodule
