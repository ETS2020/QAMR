...
module FAU ( 
  ...
  assign z12 = (~new_n58_ & x12) | (x15 & (~x09 | (x12 & x13)));
  assign new_n58_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = x12 & ((x09 & x15 & (new_n49_ | x14)) | (x14 & (~new_n49_ | ~x01) & ~x15));
  ...
  assign z18 = x12 & ((~x15 & (new_n49_ ? x06 : x19)) | (x09 & x15 & x19));
  assign z19 = x12 & ((~x15 & (new_n49_ ? x07 : x20)) | (x09 & x15 & x20));
endmodule
