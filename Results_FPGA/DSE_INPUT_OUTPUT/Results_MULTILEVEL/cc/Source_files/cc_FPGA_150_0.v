// Benchmark "FAU" written by ABC on Mon Aug 17 19:58:55 2020
...
module FAU ( 
  ...
  assign new_n57_ = (~x13 | (~x15 & (~x16 | (x08 & x10)))) & (~x00 | ~x08 | ~x10 | x15 | ~x16);
  assign z13 = (~x15 & ~x16) | (x12 & ((x15 & (new_n45_ | x14)) | (x14 & (~new_n45_ | ~x01))));
  assign z14 = (~x15 & ~x16) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = new_n61_ & x12;
  assign new_n61_ = x16 & ((x03 & x08 & x10 & ~x15) | (~x14 & (~x08 | ~x10 | x15)));
