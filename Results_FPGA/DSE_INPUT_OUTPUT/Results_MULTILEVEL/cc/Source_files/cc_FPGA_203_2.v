...
module FAU ( 
  ...
  assign z18 = x12 & (x15 ? (x18 & x19) : (new_n48_ ? x06 : x19));
  assign z19 = (~new_n65_ & x12) | (x15 & (~x18 | (x12 & x20)));
  assign new_n65_ = (~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15);
  assign z04 = ~x18;
endmodule
