// Benchmark "FAU" written by ABC on Mon Aug 17 19:59:10 2020
...
module FAU ( 
  ...
  assign new_n58_ = (~x15 | ~x19 | (~x14 & (~x08 | ~x10))) & (~x14 | x15 | (x01 & x08 & x10));
  ...
  assign z16 = (~new_n63_ & x12) | (x15 & (~x19 | (x12 & x17)));
  assign new_n63_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (~new_n65_ & x12) | (x15 & (~x19 | (x12 & x18)));
  assign new_n65_ = (~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = (x15 & ~x19) | (x12 & ((x06 & (x19 | (x08 & x10))) | x15 | (x19 & (~x08 | ~x10))));
  assign z19 = (~new_n68_ & x12) | (x15 & (~x19 | (x12 & x20)));
