...
module FAU ( 
  ...
  assign z03 = x15 & (x07 | (x08 & x10 & x12 & ~x14));
  ...
  assign z12 = (x15 & (x07 | (x12 & x13))) | (~new_n56_ & x12);
  ...
  assign z16 = (~new_n63_ & x12) | (x15 & (x07 | (x12 & x17)));
  ...
  assign z19 = x12 & ((~x15 & ((x08 & x10) ? x07 : x20)) | (~x07 & x15 & x20));
  assign z06 = x15;
endmodule
