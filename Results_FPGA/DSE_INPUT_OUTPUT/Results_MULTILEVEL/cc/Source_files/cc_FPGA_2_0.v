...
module FAU ( 
  ...
  assign z08 = x16 | (~x10 & ~x16);
  assign z10 = (~x08 | ~x09) & (x10 | x16);
  assign z11 = x14 & (x10 | x16);
  assign z12 = x12 & (x10 ? (new_n56_ ? x00 : x13) : (x13 & x16));
  assign new_n56_ = x08 & ~x15;
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = x10 ? ((~x14 | (x01 & x08)) & (~x08 | ~x15)) : (~x14 | ~x16);
  assign z14 = x12 & (x10 ? ((~x08 & x15) | (x02 & x08 & ~x15)) : (x15 & x16));
  assign z15 = ~new_n61_ & x12;
  assign new_n61_ = (x14 | ~x16 | (x08 & x10 & ~x15)) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = (~x10 & (~x16 | (x12 & x17))) | (~new_n63_ & x12);
  assign new_n63_ = (~x17 | (x08 & ~x15)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (~x10 & (~x16 | (x12 & x18))) | (~new_n65_ & x12);
  assign new_n65_ = (~x18 | (x08 & ~x15)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = x12 & (x10 ? (new_n56_ ? x06 : x19) : (x16 & x19));
  assign z19 = (~x10 & (~x16 | (x12 & x20))) | (~new_n68_ & x12);
  assign new_n68_ = (~x20 | (x08 & ~x15)) & (~x07 | ~x08 | ~x10 | x15);
  assign z09 = ~z10;
endmodule
