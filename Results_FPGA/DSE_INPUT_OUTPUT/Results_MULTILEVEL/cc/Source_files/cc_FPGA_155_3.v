// Benchmark "FAU" written by ABC on Mon Aug 17 19:58:58 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n56_, new_n61_;
  ...
  assign z05 = x15 ? (x16 | (~x16 & x19)) : x19;
  assign z06 = x15 & ~x16;
  assign z07 = x17 & (~x15 | ~x16);
  assign z08 = ~x15 & x16;
  assign z10 = (~x08 | ~x09) & (~x15 | ~x16);
  assign z12 = (~new_n56_ & x12) | (x15 & ((x12 & x13) | x16));
  ...
  assign z16 = (~new_n61_ & x12) | (x15 & (x16 | (x12 & x17)));
  assign new_n61_ = ((x08 & x10) | ~x17) & (~x04 | ~x08 | ~x10 | x15);
