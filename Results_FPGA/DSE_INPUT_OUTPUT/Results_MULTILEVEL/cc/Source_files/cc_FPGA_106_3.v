...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n48_, new_n57_, new_n61_;
  ...
  assign z03 = x15 & (x01 | (new_n48_ & x12 & ~x14));
  ...
  assign z15 = (x15 & (x01 | (x12 & ~x14 & x16))) | (~new_n61_ & x12);
  assign new_n61_ = (x14 | (x08 & x10) | ~x16) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = x12 & ((~x15 & (new_n48_ ? x04 : x17)) | (~x01 & x15 & x17));
  assign z17 = x12 & ((~x15 & (new_n48_ ? x05 : x18)) | (~x01 & x15 & x18));
  assign z18 = x12 & ((~x15 & (new_n48_ ? x06 : x19)) | (~x01 & x15 & x19));
  assign z19 = x12 & ((~x15 & (new_n48_ ? x07 : x20)) | (~x01 & x15 & x20));
  assign z06 = x15;
endmodule
