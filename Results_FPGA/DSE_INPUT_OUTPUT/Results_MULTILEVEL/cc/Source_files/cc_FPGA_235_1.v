// Benchmark "FAU" written by ABC on Mon Aug 17 19:59:32 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n57_, new_n58_, new_n62_, new_n64_, new_n67_;
  ...
  assign new_n57_ = ~x15 & ((x08 & x10) | x20);
  ...
  assign z15 = x12 & (new_n62_ | (new_n58_ & x03 & x08));
  assign new_n62_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & ~x20));
  assign z16 = (~new_n64_ & ~x15) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n64_ = ~x20 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = x12 & ((~new_n57_ & x18) | (new_n58_ & x05 & x08));
  assign z18 = (~new_n67_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n67_ = ~x20 & (~x06 | ~x08 | ~x10 | ~x12);
