...
module FAU ( 
  ...
  assign z02 = (x09 & ~x15) | (~x11 & x12 & (new_n46_ | x14));
  ...
  assign z12 = (~new_n55_ & ~x15) | (x12 & ~new_n46_ & x13);
  assign new_n55_ = ~x09 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = ~new_n57_ & x12;
  assign new_n57_ = (~x15 | (~x14 & (~x08 | ~x10))) & (x09 | ~x14 | (x01 & x08 & x10));
  assign z14 = (x09 & ~x15) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = new_n60_ | (x12 & ~x14 & ~new_n46_ & x16);
  assign new_n60_ = ~x15 & (x09 | (x03 & x08 & x10 & x12));
  assign z16 = (~new_n62_ & ~x15) | (x12 & ~new_n46_ & x17);
  assign new_n62_ = ~x09 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = ~new_n64_ & x12;
  assign new_n64_ = (x09 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15))) & (~x15 | ~x18);
  assign z18 = (~new_n66_ & ~x15) | (x12 & ~new_n46_ & x19);
  assign new_n66_ = ~x09 & (~x06 | ~x08 | ~x10 | ~x12);
  assign z19 = (~new_n68_ & ~x15) | (x12 & ~new_n46_ & x20);
  assign new_n68_ = ~x09 & (~x07 | ~x08 | ~x10 | ~x12);
  assign z10 = ~z09;
  assign z06 = x15;
endmodule
