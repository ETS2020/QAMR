...
module FAU ( 
  ...
  assign z05 = x15 ? (~x20 | (x19 & x20)) : x19;
  assign z06 = x15 & x20;
  ...
  assign z12 = (~new_n57_ & x12) | (x15 & (~x20 | (x12 & x13)));
  assign new_n57_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (x15 & (~x20 | (x08 & x10 & x12))) | (new_n59_ & x12);
  assign new_n59_ = x14 & (~x01 | ~x08 | ~x10);
  assign z14 = (x15 & ~x20) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = (~new_n62_ & x12) | (x15 & (~x20 | (x12 & ~x14 & x16)));
  assign new_n62_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | ~x16 | (x08 & x10));
  assign z16 = (~new_n64_ & x12) | (x15 & (~x20 | (x12 & x17)));
  assign new_n64_ = (~x04 | ~x08 | ~x10 | x15) & (~x17 | (x08 & x10));
  assign z17 = (~new_n66_ & x12) | (x15 & (~x20 | (x12 & x18)));
  assign new_n66_ = (~x05 | ~x08 | ~x10 | x15) & (~x18 | (x08 & x10));
  assign z18 = (~new_n68_ & x12) | (x15 & (~x20 | (x12 & x19)));
  assign new_n68_ = (~x06 | ~x08 | ~x10 | x15) & (~x19 | (x08 & x10));
