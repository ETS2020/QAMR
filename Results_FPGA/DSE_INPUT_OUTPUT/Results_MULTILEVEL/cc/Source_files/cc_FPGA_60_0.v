...
module FAU ( 
  ...
  assign new_n58_ = (~x15 | (~x14 & (~x08 | ~x10))) & (~x14 | ~x19 | (x01 & x08 & x10));
  ...
  assign new_n64_ = (~x17 | (~x15 & (~x19 | (x08 & x10)))) & (~x04 | ~x08 | ~x10 | x15 | ~x19);
  assign z17 = ~new_n66_ & x12;
  assign new_n66_ = (~x18 | (~x15 & (~x19 | (x08 & x10)))) & (~x05 | ~x08 | ~x10 | x15 | ~x19);
  assign z18 = (~x15 & ~x19) | (x12 & x19 & (x06 | ~x08 | ~x10 | x15));
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = (~x19 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15))) & (~x15 | ~x20);
  assign z06 = x15;
endmodule
