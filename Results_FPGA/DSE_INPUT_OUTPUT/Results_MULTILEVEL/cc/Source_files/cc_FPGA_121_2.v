...
module FAU ( 
  ...
  assign new_n58_ = (~x15 | ((~x08 | ~x10) & ~x14)) & (x09 | ~x14 | (x01 & x08 & x10));
  ...
  assign new_n67_ = (x09 | (((x08 & x10) | ~x19) & (~x06 | ~x08 | ~x10 | x15))) & (~x15 | ~x19);
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = (x09 | (((x08 & x10) | ~x20) & (~x07 | ~x08 | ~x10 | x15))) & (~x15 | ~x20);
  assign z06 = x15;
endmodule
