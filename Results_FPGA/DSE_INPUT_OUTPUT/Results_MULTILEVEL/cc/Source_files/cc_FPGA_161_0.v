...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n57_, new_n61_, new_n63_, new_n65_, new_n67_,
    new_n69_;
  assign z00 = x11 & x20 & (x09 | x15);
  assign z01 = x15 & new_n45_ & ~x14;
  assign new_n45_ = x08 & x10;
  assign z02 = new_n47_ & ~x11;
  assign new_n47_ = x12 & ((x09 & (x14 | (x08 & x10 & ~x15))) | (x14 & x15));
  ...
  assign new_n57_ = (~x13 | ~x15) & (~x09 | ((~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15)));
  assign z13 = (~x09 & ~x15) | (x12 & ((x15 & (new_n45_ | x14)) | ((~new_n45_ | ~x01) & x14)));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x09 & x10 & ~x15));
  assign z15 = x12 & ((~new_n61_ & x09) | (~x14 & x15 & x16));
  assign new_n61_ = (x14 | ~x16 | (x08 & x10)) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = ~new_n63_ & x12;
  assign new_n63_ = (~x15 | ~x17) & (~x09 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15)));
  assign z17 = ~new_n65_ & x12;
  assign new_n65_ = (~x15 | ~x18) & (~x09 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15)));
  assign z18 = ~new_n67_ & x12;
  assign new_n67_ = (~x15 | ~x19) & (~x09 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15)));
