...
module FAU ( 
  ...
  assign z02 = (x07 & ~x15) | (~x11 & x12 & (new_n46_ | x14));
  ...
  assign new_n57_ = ~x07 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = ~new_n59_ & x12;
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x10))) & (x07 | ~x14 | (x01 & x08 & x10));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & ~x07 & x08 & x10 & ~x15));
  assign z15 = new_n62_ | (x12 & ~x14 & ~new_n46_ & x16);
  assign new_n62_ = ~x15 & (x07 | (x03 & x08 & x10 & x12));
  assign z16 = ~new_n64_ & x12;
  assign new_n64_ = (x07 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15))) & (~x15 | ~x17);
  ...
  assign z19 = (x12 & ~new_n46_ & x20) | (x07 & ~x15);
endmodule
