...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n56_, new_n57_, new_n61_, new_n65_, new_n67_;
  ...
  assign z13 = (~x15 & ~x18) | (x12 & ((x14 & (~new_n45_ | ~x01)) | (x15 & (new_n45_ | x14))));
  ...
  assign z17 = (~x15 & ~x18) | (x12 & x18 & (~x10 | x15 | x05 | ~x08));
  assign z18 = (~new_n65_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n65_ = x18 & (~x06 | ~x08 | ~x10 | ~x12);
  assign z19 = (~new_n67_ & ~x15) | (x12 & x20 & (~x08 | ~x10 | x15));
  assign new_n67_ = x18 & (~x07 | ~x08 | ~x10 | ~x12);
  assign z04 = ~x18;
  assign z06 = x15;
endmodule
