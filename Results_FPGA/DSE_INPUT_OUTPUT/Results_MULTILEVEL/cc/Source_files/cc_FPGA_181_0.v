...
module FAU ( 
  ...
  assign z02 = (~x15 & ~x16) | (~x11 & x12 & (new_n46_ | x14));
  ...
  assign new_n58_ = (~x15 | (~x14 & (~x08 | ~x10))) & (~x14 | ~x16 | (x01 & x08 & x10));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15 & x16));
  assign z15 = (~x15 & (new_n61_ | ~x16)) | (x12 & ~x14 & ~new_n46_ & x16);
  assign new_n61_ = x03 & x08 & x10 & x12;
