...
module FAU ( 
  ...
  assign z02 = (x10 & (~x12 | (x08 & ~x11 & ~x15))) | (~x11 & x12 & x14);
  ...
  assign z10 = (~x10 | x12) & (~x08 | ~x09);
  assign z11 = x14 & (~x10 | x12);
  assign z12 = (x10 & (~x12 | (x00 & x08 & ~x15))) | (x12 & x13 & (~x08 | ~x10 | x15));
  assign z13 = (x10 & (~x12 | (x08 & x15))) | (x12 & x14 & (~x01 | ~x08 | ~x10));
  assign z14 = (x10 & (~x12 | (x02 & x08 & ~x15))) | (x12 & x15 & (~x08 | ~x10));
  assign z15 = (x10 & (~x12 | (x03 & x08 & ~x15))) | (new_n58_ & x12);
  ...
  assign z18 = (x10 & (~x12 | (x06 & x08 & ~x15))) | (x12 & x19 & (~x08 | ~x10 | x15));
