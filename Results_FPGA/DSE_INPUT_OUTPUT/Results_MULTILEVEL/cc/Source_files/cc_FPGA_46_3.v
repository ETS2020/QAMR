...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n48_, new_n56_, new_n60_, new_n63_;
  ...
  assign z13 = x12 & ((x15 & ~x20 & (new_n48_ | x14)) | (x14 & ~x15 & (~new_n48_ | ~x01)));
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (x15 & ~x20 & (~x08 | ~x10)));
  assign z15 = (~new_n60_ & x12) | (x15 & (x20 | (x12 & ~x14 & x16)));
  assign new_n60_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | ~x16 | (x08 & x10));
  assign z16 = x12 & (x15 ? (x17 & ~x20) : (new_n48_ ? x04 : x17));
  assign z17 = (~new_n63_ & x12) | (x15 & (x20 | (x12 & x18)));
  assign new_n63_ = (~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = x12 & (x15 ? (x19 & ~x20) : (new_n48_ ? x06 : x19));
  assign z19 = x12 & ~x15 & ((~new_n48_ & x20) | (x07 & (new_n48_ | x20)));
  assign z06 = x15;
endmodule
