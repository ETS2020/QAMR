...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n56_, new_n57_, new_n61_, new_n63_, new_n66_;
  assign z00 = x20 & x11 & x15;
  assign z01 = (~x15 & x20) | (new_n45_ & ~x14 & x15);
  assign new_n45_ = x08 & x10;
  assign z02 = ~x11 & x12 & ((x14 & (x15 | ~x20)) | (new_n45_ & ~x15 & ~x20));
  assign z03 = (~x15 & x20) | (new_n45_ & x12 & ~x14 & x15);
  ...
  assign new_n56_ = ~x15 & ((x08 & x10) | x20);
  assign new_n57_ = x10 & ~x15 & ~x20;
  assign z13 = (~x15 & x20) | (x12 & ((x15 & (new_n45_ | x14)) | ((~new_n45_ | ~x01) & x14)));
  assign z14 = (~x15 & x20) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = x12 & (new_n61_ | (new_n57_ & x03 & x08));
  assign new_n61_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & ~x20));
  assign z16 = (~new_n63_ & ~x15) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n63_ = ~x20 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = x12 & ((~new_n56_ & x18) | (new_n57_ & x05 & x08));
  assign z18 = (~new_n66_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n66_ = ~x20 & (~x06 | ~x08 | ~x10 | ~x12);
