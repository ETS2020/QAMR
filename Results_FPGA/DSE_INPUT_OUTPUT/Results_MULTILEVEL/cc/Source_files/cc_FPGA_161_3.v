...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n57_, new_n59_, new_n62_, new_n64_, new_n68_;
  assign z00 = x11 & x20 & (~x09 | ~x15);
  assign z01 = x15 & ~x14 & x10 & x08 & ~x09;
  assign z02 = new_n46_ & ~x11;
  assign new_n46_ = x12 & ((x14 & (~x09 | ~x15)) | (x08 & x10 & ~x15));
  ...
  assign z16 = x12 & ((~x15 & (new_n64_ ? x04 : x17)) | (~x09 & x15 & x17));
  assign new_n64_ = x08 & x10;
  assign z17 = x12 & ((~x15 & (new_n64_ ? x05 : x18)) | (~x09 & x15 & x18));
  assign z18 = x12 & ((~x15 & (new_n64_ ? x06 : x19)) | (~x09 & x15 & x19));
  assign z19 = (x15 & (x09 | (x12 & x20))) | (~new_n68_ & x12);
