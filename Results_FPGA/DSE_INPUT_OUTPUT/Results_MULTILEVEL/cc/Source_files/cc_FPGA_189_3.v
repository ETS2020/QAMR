...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n48_, new_n54_, new_n58_, new_n62_;
  ...
  assign new_n54_ = (~x13 | (x15 ? x18 : (x08 & x10))) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = x12 & ((x15 & ~x18 & (new_n48_ | x14)) | (x14 & ~x15 & (~new_n48_ | ~x01)));
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (x15 & (~x08 | ~x10) & ~x18));
  assign z15 = (~new_n58_ & x12) | (x15 & (x18 | (x12 & ~x14 & x16)));
  assign new_n58_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | (x08 & x10) | ~x16);
  assign z16 = x12 & (x15 ? (x17 & ~x18) : (new_n48_ ? x04 : x17));
  assign z17 = (x15 & x18) | (x12 & ((x05 & x08 & x10 & ~x15) | ((~x08 | ~x10) & x18)));
  assign z18 = (~new_n62_ & x12) | (x15 & (x18 | (x12 & x19)));
  assign new_n62_ = ((x08 & x10) | ~x19) & (~x06 | ~x08 | ~x10 | x15);
