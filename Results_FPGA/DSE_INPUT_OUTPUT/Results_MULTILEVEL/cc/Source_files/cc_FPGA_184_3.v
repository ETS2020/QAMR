// Benchmark "FAU" written by ABC on Mon Aug 17 19:59:11 2020
...
module FAU ( 
  ...
  assign z03 = ~x19 & x15 & ~x14 & x12 & x08 & x10;
  ...
  assign new_n59_ = (~x15 | x19 | (~x14 & (~x08 | ~x10))) & (~x14 | x15 | (x01 & x08 & x10));
  ...
  assign z17 = (~new_n66_ & x12) | (x15 & (x19 | (x12 & x18)));
  assign new_n66_ = ((x08 & x10) | ~x18) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = (x15 & x19) | (x12 & ((x06 & x08 & x10 & ~x15) | ((~x08 | ~x10) & x19)));
  assign z19 = (~new_n69_ & x12) | (x15 & (x19 | (x12 & x20)));
  assign new_n69_ = ((x08 & x10) | ~x20) & (~x07 | ~x08 | ~x10 | x15);
endmodule
