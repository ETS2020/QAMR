...
module FAU ( 
  ...
  assign z12 = (~x10 & (~x12 | x13)) | (x12 & ((x13 & (~x08 | x15)) | (x00 & x08 & x10 & ~x15)));
  assign z13 = (~x10 & (~x12 | x14)) | (x12 & (((~x01 | ~x08) & x14) | (x08 & x10 & x15)));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15));
  assign z15 = ~new_n59_ & x12;
  assign new_n59_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | ~x16 | (x08 & x10 & ~x15));
  assign z16 = (~x10 & (~x12 | x17)) | (x12 & ((x04 & x08 & x10 & ~x15) | (x17 & (~x08 | x15))));
  assign z17 = x12 & ((x05 & x08 & x10 & ~x15) | (x18 & (~x08 | ~x10 | x15)));
  assign z18 = (~x10 & (~x12 | x19)) | (x12 & ((x06 & x08 & x10 & ~x15) | (x19 & (~x08 | x15))));
