...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n57_, new_n59_, new_n62_, new_n66_;
  ...
  assign z13 = x12 & ((~x07 & x15 & (new_n59_ | x14)) | (x14 & ~x15 & (~new_n59_ | ~x01)));
  assign new_n59_ = x08 & x10;
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (~x07 & x15 & (~x08 | ~x10)));
  assign z15 = (~new_n62_ & x12) | (x15 & (x07 | (x12 & ~x14 & x16)));
  assign new_n62_ = (x14 | (x08 & x10) | ~x16) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = x12 & ((~x15 & (new_n59_ ? x04 : x17)) | (~x07 & x15 & x17));
  assign z17 = x12 & ((~x15 & (new_n59_ ? x05 : x18)) | (~x07 & x15 & x18));
  assign z18 = (~new_n66_ & x12) | (x15 & (x07 | (x12 & x19)));
  assign new_n66_ = (~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = x12 & ((~x15 & (new_n59_ ? x07 : x20)) | (~x07 & x15 & x20));
endmodule
