// Benchmark "FAU" written by ABC on Mon Aug 17 19:59:36 2020
...
module FAU ( 
  ...
  assign new_n46_ = x12 & ((~x02 & (x14 | (x08 & x10 & ~x15))) | (x14 & x15));
  ...
  assign new_n57_ = (~x13 | ~x15) & (x02 | ((~x13 | (x08 & x10)) & (~x10 | x15 | ~x00 | ~x08)));
  assign z13 = ~new_n59_ & x12;
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x10))) & (x02 | ~x14 | (x01 & x08 & x10));
  assign z14 = x12 & x15 & (~x08 | ~x10);
  assign z15 = x12 & ((~new_n62_ & ~x02) | (~x14 & x15 & x16));
  assign new_n62_ = (x14 | (x08 & x10) | ~x16) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = ~new_n64_ & x12;
  assign new_n64_ = (~x15 | ~x17) & (x02 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15)));
  assign z17 = (~new_n66_ & ~x15) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n66_ = ~x02 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (~x15 | ~x19) & (x02 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15)));
  assign z19 = (~new_n70_ & ~x15) | (x12 & x20 & (~x08 | ~x10 | x15));
  assign new_n70_ = ~x02 & (~x07 | ~x08 | ~x10 | ~x12);
endmodule
