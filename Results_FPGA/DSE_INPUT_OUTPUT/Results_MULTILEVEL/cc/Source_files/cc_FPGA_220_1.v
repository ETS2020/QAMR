...
module FAU ( 
  ...
  assign z15 = new_n60_ | (x03 & x08 & x10 & x12 & ~x15);
  assign new_n60_ = x16 & (~x12 | (~x14 & (~x08 | ~x10 | x15)));
  assign z16 = x12 ? ~new_n62_ : x16;
  assign new_n62_ = (~x17 | (x08 & x10 & ~x15)) & (~x04 | ~x08 | ~x10 | x15);
