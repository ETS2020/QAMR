...
module FAU ( 
  ...
  assign z12 = (~x10 & ~x13) | (x12 & ((x00 & (new_n46_ | x13)) | ~x10 | (~new_n46_ & x13)));
  assign z13 = (~x10 & (~x13 | (x12 & x14))) | (~new_n58_ & x12);
  ...
  assign z16 = (~x10 & (~x13 | (x12 & x17))) | (~new_n63_ & x12);
  assign new_n63_ = (~x17 | (x08 & ~x15)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (~x10 & (~x13 | (x12 & x18))) | (~new_n65_ & x12);
