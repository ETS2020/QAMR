...
module FAU ( 
  ...
  assign z12 = (x15 & (~x18 | (x12 & x13))) | (~new_n54_ & x12);
  assign new_n54_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (new_n56_ & x12) | (x15 & (~x18 | (x08 & x10 & x12)));
  ...
  assign z16 = (~new_n61_ & x12) | (x15 & (~x18 | (x12 & x17)));
  assign new_n61_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = x12 & ((x05 & (x18 | (x08 & x10 & ~x15))) | (x18 & (~x08 | ~x10 | x15)));
  assign z18 = ~new_n64_ & x12;
  assign new_n64_ = x15 ? (~x18 | ~x19) : ((x08 & x10) ? ~x06 : ~x19);
  assign z19 = (~new_n66_ & x12) | (x15 & (~x18 | (x12 & x20)));
