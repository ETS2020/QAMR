...
module FAU ( 
  ...
  assign z12 = (~x10 & (~x20 | (x12 & x13))) | (~new_n56_ & x12);
  ...
  assign z16 = (~x10 & (~x20 | (x12 & x17))) | (~new_n63_ & x12);
  assign new_n63_ = (~x17 | (x08 & ~x15)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (~x10 & (~x20 | (x12 & x18))) | (~new_n65_ & x12);
  assign new_n65_ = (~x18 | (x08 & ~x15)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = (~x10 & (~x20 | (x12 & x19))) | (~new_n67_ & x12);
  assign new_n67_ = (~x19 | (x08 & ~x15)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = (~x10 & ~x20) | (x12 & ((x07 & (x20 | (x08 & ~x15))) | ~x10 | (x20 & (~x08 | x15))));
  assign z09 = ~z10;
endmodule
