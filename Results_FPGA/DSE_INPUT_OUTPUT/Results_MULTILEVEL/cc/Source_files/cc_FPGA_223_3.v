// Benchmark "FAU" written by ABC on Mon Aug 17 19:59:27 2020
...
module FAU ( 
  ...
  assign z10 = ~x09 | ~x08 | (x15 & x17);
  assign z12 = (x15 & ((x12 & x13) | x17)) | (~new_n54_ & x12);
  assign new_n54_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = ~new_n56_ & x12;
  assign new_n56_ = (~x15 | x17 | (~x14 & (~x08 | ~x10))) & (~x14 | x15 | (x01 & x08 & x10));
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (x15 & (~x08 | ~x10) & ~x17));
  assign z15 = x12 & (new_n59_ | (x03 & x08 & x10 & ~x15));
  assign new_n59_ = ~x14 & x16 & (x15 ? ~x17 : (~x08 | ~x10));
  assign z16 = x12 & ~x15 & ((x04 & ((x08 & x10) | x17)) | ((~x08 | ~x10) & x17));
  ...
  assign z19 = (~new_n66_ & x12) | (x15 & (x17 | (x12 & x20)));
  assign new_n66_ = (~x07 | ~x08 | ~x10 | x15) & ((x08 & x10) | ~x20);
  assign z06 = x15;
  assign z07 = x17;
endmodule
