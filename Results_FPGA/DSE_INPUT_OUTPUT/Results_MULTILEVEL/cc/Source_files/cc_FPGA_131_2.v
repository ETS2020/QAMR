...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n58_, new_n62_, new_n65_, new_n67_, new_n69_;
  assign z00 = x11 & x20 & (~x04 | x15);
  assign z01 = (x04 & ~x15) | (new_n45_ & ~x14 & x15);
  assign new_n45_ = x08 & x10;
  assign z02 = new_n47_ | (x04 & ~x15);
  ...
  assign new_n58_ = ~x04 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = (x04 & ~x15) | (x12 & ((x15 & (new_n45_ | x14)) | ((~new_n45_ | ~x01) & x14)));
  ...
  assign new_n65_ = ~x04 & (~x10 | ~x12 | ~x05 | ~x08);
  ...
  assign new_n69_ = ~x04 & (~x10 | ~x12 | ~x07 | ~x08);
endmodule
