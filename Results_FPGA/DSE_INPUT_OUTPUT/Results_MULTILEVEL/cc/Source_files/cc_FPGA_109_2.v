...
module FAU ( 
  ...
  assign new_n46_ = x12 & ((x13 & (x14 | (x08 & x10 & ~x15))) | (~x10 & x14));
  assign z03 = x10 & (~x13 | (~x14 & x15 & x08 & x12));
  ...
  assign z12 = (x10 & ~x13) | (x12 & x13 & (~x10 | x15 | x00 | ~x08));
  assign z13 = (x10 & (~x13 | (x08 & x12 & x15))) | (new_n58_ & x12);
  assign new_n58_ = x14 & (~x01 | ~x08 | ~x10);
  assign z14 = x12 & ((x13 & ((~x08 & x15) | (x02 & x08 & x10 & ~x15))) | (~x10 & x15));
  assign z15 = new_n61_ | new_n62_;
  assign new_n61_ = x10 & (~x13 | (x03 & x08 & x12 & ~x15));
  assign new_n62_ = x12 & ~x14 & x16 & (~x08 | ~x10 | x15);
  assign z16 = (~new_n64_ & x10) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n64_ = x13 & (~x04 | ~x08 | ~x12 | x15);
  assign z17 = (~new_n66_ & x10) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n66_ = x13 & (~x05 | ~x08 | ~x12 | x15);
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (x10 | ~x19) & (~x13 | ((~x06 | ~x08 | ~x10 | x15) & (~x19 | (x08 & ~x15))));
  assign z19 = ~new_n70_ & x12;
  assign new_n70_ = (x10 | ~x20) & (~x13 | ((~x07 | ~x08 | ~x10 | x15) & (~x20 | (x08 & ~x15))));
endmodule
