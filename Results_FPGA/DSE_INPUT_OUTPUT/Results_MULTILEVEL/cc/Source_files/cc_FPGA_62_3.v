// Benchmark "FAU" written by ABC on Mon Aug 17 19:58:30 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n55_, new_n57_, new_n60_, new_n62_, new_n65_, new_n67_;
  ...
  assign z12 = (x15 & ((x12 & x13) | x18)) | (~new_n55_ & x12);
  assign new_n55_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (x15 & (x18 | (x08 & x10 & x12))) | (new_n57_ & x12);
  ...
  assign z16 = (~new_n62_ & x12) | (x15 & (x18 | (x12 & x17)));
  assign new_n62_ = ((x08 & x10) | ~x17) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = x12 & ~x15 & ((x05 & ((x08 & x10) | x18)) | ((~x08 | ~x10) & x18));
  assign z18 = ~new_n65_ & x12;
  assign new_n65_ = x15 ? (x18 | ~x19) : ((x08 & x10) ? ~x06 : ~x19);
  assign z19 = (~new_n67_ & x12) | (x15 & (x18 | (x12 & x20)));
