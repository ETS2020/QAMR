...
module FAU ( 
  ...
  assign new_n56_ = (~x13 | (x10 & (~x16 | (x08 & ~x15)))) & (~x00 | ~x08 | ~x10 | x15 | ~x16);
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (~x14 | (x10 & ((x01 & x08) | ~x16))) & (~x08 | ~x10 | ~x15 | ~x16);
  ...
  assign z16 = (~new_n63_ & x10) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n63_ = x16 & (~x04 | ~x08 | ~x12 | x15);
  assign z17 = (~new_n65_ & x10) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n65_ = x16 & (~x05 | ~x08 | ~x12 | x15);
  assign z18 = ~new_n67_ & x12;
  assign new_n67_ = (~x16 | ((~x06 | ~x08 | ~x10 | x15) & (~x19 | (x08 & ~x15)))) & (x10 | ~x19);
  assign z19 = (~new_n69_ & x10) | (x12 & x20 & (~x08 | ~x10 | x15));
  assign new_n69_ = x16 & (~x07 | ~x08 | ~x12 | x15);
  assign z09 = ~z10;
endmodule
