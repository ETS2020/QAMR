...
module FAU ( 
  ...
  assign new_n55_ = ~x09 & x10 & ~x11 & ~x12 & (~x15 | x23);
  ...
  assign new_n65_ = x01 & x18 & ~x19 & ~x20 & (~x15 | x23);
  ...
  assign z11 = new_n46_ | (~x00 & ~x22 & (new_n73_ | (new_n70_ & new_n74_)));
  ...
  assign new_n77_ = ~x00 & ~x01 & ((x17 & (x23 | (~x02 & ~x19))) | (x23 & (x02 | x19)));
