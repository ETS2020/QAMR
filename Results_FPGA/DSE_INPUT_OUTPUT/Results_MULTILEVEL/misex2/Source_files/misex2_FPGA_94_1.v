...
module FAU ( 
  ...
  assign z04 = (~x01 & x09) | (new_n49_ & ~x09 & x10 & ~x11 & ~x12);
  ...
  assign new_n57_ = x17 & ~x09 & ~x07 & new_n58_ & ~x06 & ~x08;
  assign new_n58_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n60_ | new_n62_);
  assign new_n60_ = new_n61_ & ~x01 & x02 & ~x09 & ~x11 & x12;
  ...
  assign new_n65_ = ~x11 & x12 & ~x13 & ~x01 & x02 & ~x09;
  assign new_n66_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = z01 | (~x00 & ~x22 & (new_n68_ | (new_n69_ & new_n70_)));
