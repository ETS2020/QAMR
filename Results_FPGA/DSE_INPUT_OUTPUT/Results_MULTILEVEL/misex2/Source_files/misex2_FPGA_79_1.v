...
module FAU ( 
  ...
  assign z06 = (~x01 & x08) | (new_n56_ & x00 & x01 & x02);
  assign new_n56_ = ~x09 & x10 & x11;
  assign z07 = (~x01 & x08) | (x00 & x02 & (new_n58_ | ~x01));
  ...
  assign z11 = ~x00 & ~x22 & (new_n71_ | new_n73_);
  assign new_n71_ = new_n72_ & ~x01 & x02 & ~x08 & ~x11 & x12;
  assign new_n72_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (~x01 & x08) | (new_n75_ & x09);
