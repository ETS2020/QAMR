...
module FAU ( 
  ...
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19 & (x13 | ~x22);
  ...
  assign new_n51_ = ~x10 & ~x17 & ~x18 & ~x19 & (x13 | ~x22);
  assign z03 = new_n48_ | new_n53_ | (new_n54_ & new_n55_);
  ...
  assign z06 = new_n48_ | (new_n54_ & ~x09 & x10 & x11);
