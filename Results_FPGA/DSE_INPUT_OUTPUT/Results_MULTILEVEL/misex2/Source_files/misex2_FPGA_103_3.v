...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n52_, new_n55_, new_n58_, new_n59_, new_n61_,
    ...
    new_n72_, new_n73_;
  assign z00 = (x01 & x12) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = (x01 & x12) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = (x01 & x12) | (new_n49_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = ~x19 & x18 & ~x17 & ~x02 & ~x00 & ~x01;
  assign z04 = ~new_n52_ & x01;
  assign new_n52_ = ~x12 & (~x00 | ~x02 | x09 | ~x10 | x11);
  assign z05 = ~x12 & x10 & x09 & x02 & x00 & x01;
  assign z06 = x01 & (x12 | (new_n55_ & x00 & x02));
  assign new_n55_ = ~x09 & x10 & x11;
  assign z07 = (x01 & x12) | (x00 & x02 & (new_n55_ | ~x01));
  assign z08 = x19 & new_n58_ & ~x18;
  assign new_n58_ = x17 & ~x08 & ~x07 & ~x06 & new_n59_ & ~x05;
  assign new_n59_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (x01 & x12) | (~x00 & ~x21 & ~new_n61_ & ~x22);
  assign new_n61_ = ~new_n63_ & (~new_n62_ | x14 | x15 | x16 | ~x20);
  assign new_n62_ = x02 & ~x11 & x12 & ~x13;
  assign new_n63_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (x01 & x12) | (~x00 & (new_n65_ | new_n67_));
  assign new_n65_ = new_n66_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n66_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = (x01 & x12) | (~x00 & ~x22 & (new_n69_ | new_n70_));
  assign new_n69_ = new_n62_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (x01 & x12) | (new_n72_ & x09);
  assign new_n72_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n73_ & ~x01));
  assign new_n73_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = (x01 & x12) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (x01 & x12) | (new_n49_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = (~x02 & ((x00 & (~x01 | ~x12)) | (~x01 & x19))) | (~x10 & ~x12 & x00 & x01);
