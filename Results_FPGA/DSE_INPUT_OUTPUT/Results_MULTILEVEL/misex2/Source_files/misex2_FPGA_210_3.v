...
module FAU ( 
  ...
  assign z04 = x01 & (new_n53_ | x17);
  assign new_n53_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (x17 | (x09 & x10 & x00 & x02));
  assign z06 = new_n56_ & ~x17;
  assign new_n56_ = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = (x00 & x02 & (new_n58_ | ~x01)) | (x01 & x17);
  assign new_n58_ = ~x09 & x10 & x11 & ~x12;
  assign z08 = x17 & (new_n60_ | x01);
  assign new_n60_ = new_n61_ & ~x00 & x02 & ~x03 & x04 & ~x05;
  assign new_n61_ = ~x06 & ~x07 & ~x08 & ~x18 & x19;
  assign z09 = (x01 & x17) | (~x00 & ~x21 & ~new_n63_ & ~x22);
