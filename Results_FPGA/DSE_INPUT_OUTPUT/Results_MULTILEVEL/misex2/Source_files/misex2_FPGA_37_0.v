...
module FAU ( 
  ...
  assign z00 = ~x09 & (~x13 | (new_n46_ & new_n47_ & x10 & ~x17));
  ...
  assign z03 = new_n52_ | (~x09 & (new_n53_ | ~x13));
  assign new_n52_ = new_n46_ & ~x17 & x18 & ~x19;
  assign new_n53_ = x00 & x01 & x02 & x10 & x11 & x12;
  assign z04 = x13 & new_n55_ & ~x12;
  assign new_n55_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = (~x09 & ~x13) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = ~new_n58_ & ~x09;
  assign new_n58_ = x13 & (~x00 | ~x01 | ~x02 | ~x10 | ~x11);
  assign z07 = new_n60_ | (new_n61_ & x00);
  assign new_n60_ = ~x09 & ~x13;
  assign new_n61_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = ~x00 & ~x01 & new_n63_ & x02;
  assign new_n63_ = ~x03 & x04 & ~x05 & ~x06 & new_n64_ & ~x07;
  assign new_n64_ = ~x08 & x17 & ~x18 & x19 & (x09 | x13);
  assign z09 = new_n60_ | (~x00 & ~x21 & ~new_n66_ & ~x22);
  assign new_n66_ = ~new_n68_ & (~new_n67_ | x01 | ~x02 | x11 | ~x12);
  assign new_n67_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n68_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = new_n60_ | (~x00 & (new_n70_ | (new_n71_ & new_n72_)));
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n71_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n72_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n60_ | (~x00 & ~x22 & (new_n74_ | new_n75_));
  ...
  assign z13 = new_n60_ | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x09 & (~x13 | (new_n46_ & new_n47_ & ~x10 & ~x17));
  assign z15 = ~new_n60_ & ((x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19));
  assign z16 = new_n60_ | (~x00 & x01);
  assign z17 = ~x00 & ~x01 & ~new_n60_ & x02;
endmodule
