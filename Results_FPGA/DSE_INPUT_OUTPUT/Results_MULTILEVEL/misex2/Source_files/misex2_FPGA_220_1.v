...
module FAU ( 
  ...
  assign z02 = ~x01 & (x23 | (new_n50_ & ~x00 & ~x02 & x09));
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (new_n53_ & new_n54_) | (~new_n52_ & ~x01);
  assign new_n52_ = ~x23 & (x00 | x02 | x17 | ~x18 | x19);
  ...
  assign z08 = ~x01 & (x23 | (new_n62_ & new_n63_));
  ...
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20 & ~x23;
  ...
  assign z11 = new_n56_ | (~x00 & ~x22 & (new_n73_ | (new_n66_ & new_n74_)));
  ...
  assign new_n77_ = ~x00 & ~x01 & ~x02 & x17 & ~x19 & ~x23;
