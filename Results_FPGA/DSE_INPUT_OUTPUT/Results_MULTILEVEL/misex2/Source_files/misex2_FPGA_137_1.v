...
module FAU ( 
  ...
  assign new_n68_ = ~x11 & x12 & ~x13 & ~x01 & x02 & ~x07;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n71_ | new_n73_);
  assign new_n71_ = new_n72_ & ~x01 & x02 & ~x07 & ~x11 & x12;
  ...
  assign new_n76_ = ~x07 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
