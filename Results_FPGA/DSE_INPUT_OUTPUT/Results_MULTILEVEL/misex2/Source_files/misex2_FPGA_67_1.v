...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n57_, new_n60_,
    ...
    new_n71_, new_n72_, new_n73_, new_n74_, new_n76_, new_n77_, new_n80_;
  ...
  assign z03 = new_n52_ | (~new_n51_ & ~x01);
  assign new_n51_ = ~x11 & (x00 | x02 | x17 | ~x18 | x19);
  assign new_n52_ = x00 & x02 & ~x09 & x10 & x11 & x12;
  assign z04 = new_n54_ & ~x12;
  assign new_n54_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = (~x01 & x11) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x11 & (~x01 | (new_n57_ & x00 & x02));
  assign new_n57_ = ~x09 & x10;
  assign z07 = (~x01 & x11) | (x00 & x02 & (~x01 | (new_n57_ & x11 & ~x12)));
  ...
  assign z11 = new_n71_ | (~x00 & ~x22 & (new_n72_ | (new_n73_ & new_n74_)));
  assign new_n71_ = ~x01 & x11;
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n73_ = ~x01 & x02 & x12 & ~x13;
  assign new_n74_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = new_n71_ | (x09 & ~x24 & (x00 ? new_n76_ : new_n77_));
  ...
  assign new_n80_ = ~x11 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
