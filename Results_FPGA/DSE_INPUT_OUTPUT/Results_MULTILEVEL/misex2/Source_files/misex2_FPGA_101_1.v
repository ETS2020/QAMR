...
module FAU ( 
  ...
  assign z05 = new_n51_ | (x02 & x09 & x10 & x00 & x01);
  ...
  assign z10 = ~x00 & x01 & new_n69_ & x18;
  assign new_n69_ = ~x19 & ~x20 & x21 & x22 & (x14 | ~x16);
  assign z11 = new_n51_ | (~x00 & ~x22 & (new_n71_ | (new_n66_ & new_n72_)));
  assign new_n71_ = ~x19 & ~x20 & x21 & x01 & x18;
  assign new_n72_ = ~x13 & ~x14 & x15 & x20 & ~x21;
  assign z12 = new_n51_ | (x09 & ~x24 & (new_n74_ | new_n75_));
  assign new_n74_ = x00 & x01 & (~x02 | ~x10);
  assign new_n75_ = ~x00 & ~x01 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = new_n51_ | (~x02 & x17 & ~x19 & ~x00 & ~x01);
  assign z14 = new_n51_ | (new_n78_ & ~x02 & ~x09 & ~x00 & ~x01);
  assign new_n78_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | new_n51_ | (~x01 & ~x02 & x19);
  assign z16 = ~x00 & ~new_n51_ & x01;
