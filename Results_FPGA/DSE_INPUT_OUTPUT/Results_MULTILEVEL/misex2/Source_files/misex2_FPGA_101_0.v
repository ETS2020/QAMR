...
module FAU ( 
  ...
  assign new_n65_ = ~x19 & ~x20 & ~x21 & ~x22 & (x14 | x16);
  ...
  assign z11 = new_n51_ | (new_n71_ & ~x00 & x01 & x18);
  assign new_n71_ = ~x19 & ~x20 & x21 & ~x22;
  assign z12 = new_n51_ | (x09 & ~x24 & (new_n73_ | new_n74_));
  assign new_n73_ = x00 & x01 & (~x02 | ~x10);
  assign new_n74_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = new_n51_ | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = new_n51_ | (new_n77_ & ~x02 & ~x09 & ~x00 & ~x01);
