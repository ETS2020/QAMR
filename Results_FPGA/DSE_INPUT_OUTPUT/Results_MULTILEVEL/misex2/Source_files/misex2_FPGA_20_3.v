...
module FAU ( 
  ...
  assign z01 = (x02 & x19) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & x09;
  assign z03 = (x02 & (new_n51_ | x19)) | (new_n52_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = x00 & x01 & ~x09 & x10 & x11 & x12;
  ...
  assign new_n59_ = x00 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z09 = (x02 & x19) | (~x00 & ~x21 & ~new_n61_ & ~x22);
  ...
  assign z11 = ~x00 & ~x19 & ~x22 & (new_n69_ | new_n70_);
  assign new_n69_ = new_n66_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n70_ = x01 & x18 & ~x20 & x21;
  assign z12 = x09 & ~new_n72_ & ~x24;
  assign new_n72_ = x00 ? (~x01 | (x02 & (x10 | x19))) : (new_n73_ | x01);
  assign new_n73_ = x02 ? (x19 | ~x23) : (x19 ? ~x23 : ~x17);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = (x02 & x19) | (new_n76_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n76_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x19 & (~x01 | x02));
  assign z16 = ~x00 & x01 & (~x02 | ~x19);
  assign z17 = x02 & (x19 | (~x00 & ~x01));
  assign z08 = 1'b0;
endmodule
