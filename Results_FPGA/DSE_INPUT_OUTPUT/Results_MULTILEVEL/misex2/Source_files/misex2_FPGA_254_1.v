...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n57_, new_n59_,
    ...
    new_n71_, new_n72_, new_n74_, new_n77_;
  assign z00 = ~x23 & ~x19 & new_n46_ & ~x18;
  assign new_n46_ = ~x17 & x10 & ~x09 & ~x02 & ~x00 & ~x01;
  assign z01 = ~x23 & ~x19 & ~x18 & ~x17 & new_n48_ & x10;
  assign new_n48_ = x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x23 & ~x18 & ~x17 & new_n48_ & ~x10 & ~x19;
  assign z03 = (~x01 & (x23 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  ...
  assign z06 = (~x01 & x23) | (new_n57_ & x00 & x01 & x02);
  assign new_n57_ = ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x23);
  assign z08 = ~x01 & (x23 | (new_n61_ & new_n62_));
  assign new_n61_ = ~x00 & x02 & ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n64_ | (new_n65_ & new_n66_));
  assign new_n64_ = x01 & x18 & ~x19 & ~x20;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20 & ~x23;
  assign z10 = (~x01 & x23) | (~x00 & (new_n68_ | (new_n65_ & new_n69_)));
  ...
  assign new_n72_ = ~x14 & x15 & ~x16 & x20 & ~x21 & ~x23;
  assign z12 = (~x01 & x23) | (x09 & ~new_n74_ & ~x24);
  assign new_n74_ = (~x00 | ~x01 | (x02 & x10)) & (x00 | x01 | x02 | ~x17 | x19);
  assign z13 = ~x01 & (x23 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (x23 | (new_n77_ & ~x00 & ~x02 & ~x09));
  assign new_n77_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & ~x23))) | (~x01 & ~x02 & x19 & ~x23);
  assign z16 = x01 ? ~x00 : x23;
  assign z17 = ~x23 & x02 & ~x00 & ~x01;
endmodule
