...
module FAU ( 
  ...
  assign z00 = (x04 & x09) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = x09 & (x04 | (new_n46_ & ~x00 & ~x01 & ~x02));
  assign z02 = x09 & (x04 | (new_n49_ & ~x00 & ~x01 & ~x02));
  ...
  assign z07 = new_n51_ | (new_n59_ & x00);
  assign new_n59_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = x04 & (new_n61_ | x09);
  assign new_n61_ = new_n62_ & ~x00 & ~x01 & x02 & ~x03 & ~x05;
  ...
  assign z14 = (x04 & x09) | (new_n49_ & ~x00 & ~x01 & ~x02 & ~x09);
