...
module FAU ( 
  ...
  assign z11 = (~x01 & x12) | (new_n67_ & ~x00 & x01 & x18);
  assign new_n67_ = ~x19 & ~x20 & x21 & ~x22;
  assign z12 = x09 & ~x24 & (x00 ? (~new_n69_ & x01) : (new_n70_ & ~x01));
  assign new_n69_ = x02 & x10;
  assign new_n70_ = ~x12 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (x12 | (~x00 & ~x02 & x17 & ~x19));
  assign z14 = ~x01 & (x12 | (new_n73_ & ~x00 & ~x02 & ~x09));
