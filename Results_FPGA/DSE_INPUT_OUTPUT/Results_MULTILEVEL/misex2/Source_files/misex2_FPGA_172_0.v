...
module FAU ( 
  ...
  assign z03 = x12 & ((new_n52_ & x00 & x01 & x02) | (new_n53_ & ~x00 & ~x01 & ~x02));
  ...
  assign z07 = (x00 & x02 & (~x01 | (new_n59_ & x11 & ~x12))) | (~x01 & ~x12);
  ...
  assign z10 = (~x01 & ~x12) | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  ...
  assign z14 = ~x01 & (~x12 | (new_n80_ & ~x00 & ~x02 & ~x09));
