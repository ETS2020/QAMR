...
module FAU ( 
  ...
  assign z08 = (x01 & x07) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  ...
  assign new_n66_ = x01 & ~x07 & x18 & ~x19 & ~x20;
  ...
  assign z15 = (~x02 & ((x00 & (~x01 | ~x07)) | (~x01 & x19))) | (~x07 & ~x10 & x00 & x01);
