...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n56_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n64_, new_n65_, new_n69_, new_n70_;
  ...
  assign z08 = (x01 & ~x19) | (new_n61_ & new_n60_ & ~x00 & ~x01 & x02);
  assign new_n60_ = ~x03 & x04 & ~x05;
  assign new_n61_ = x17 & ~x18 & x19 & ~x06 & ~x07 & ~x08;
  assign z09 = new_n63_ | (new_n64_ & new_n65_ & ~x14 & ~x15 & ~x16);
  assign new_n63_ = x01 & ~x19;
  assign new_n64_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = x20 & ~x21 & ~x22;
  assign z10 = new_n63_ | (new_n64_ & new_n65_ & ~x14 & x15 & x16);
  assign z11 = new_n63_ | (new_n64_ & new_n65_ & ~x14 & x15 & ~x16);
