...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n60_,
    new_n61_, new_n63_, new_n65_, new_n68_, new_n69_, new_n72_;
  ...
  assign new_n52_ = ~x12 & ~x17 & x18 & ~x19;
  ...
  assign z07 = (~x01 & x12) | (x00 & x02 & (~x01 | (new_n55_ & x11 & ~x12)));
  ...
  assign z10 = (~x01 & x12) | (new_n65_ & ~x00 & x01 & x18);
  ...
  assign z14 = ~x01 & (x12 | (new_n72_ & ~x00 & ~x02 & ~x09));
