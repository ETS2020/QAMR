...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n53_, new_n55_, new_n58_,
    ...
    new_n81_;
  assign z00 = (x09 & x20) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = x09 & (x20 | (new_n46_ & ~x00 & ~x01 & ~x02));
  assign z02 = ~x20 & ~x19 & new_n49_ & ~x18;
  ...
  assign z06 = (x09 & x20) | (new_n58_ & ~x09 & x10 & x11);
  assign new_n58_ = x00 & x01 & x02;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | (x09 & x20)) & (x09 | ~x10 | ~x11 | x12);
