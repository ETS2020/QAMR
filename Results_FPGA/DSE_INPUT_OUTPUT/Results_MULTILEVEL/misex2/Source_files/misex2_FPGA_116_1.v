...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    ...
    new_n71_, new_n72_, new_n73_, new_n75_, new_n76_, new_n79_;
  assign z00 = ~x01 & (x13 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x01 & (x13 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = ~x19 & ~x18 & new_n49_ & ~x17;
  assign new_n49_ = ~x13 & ~x10 & x09 & ~x02 & ~x00 & ~x01;
  ...
  assign new_n58_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x13);
  assign z08 = ~x01 & (new_n60_ | x13);
  ...
  assign z10 = (~x01 & x13) | (~x00 & (new_n67_ | new_n69_));
  ...
  assign new_n76_ = ~x13 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (x13 | (~x00 & ~x02 & x17 & ~x19));
  assign z14 = ~x19 & ~x18 & new_n79_ & ~x17;
  assign new_n79_ = ~x13 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & ~x13))) | (~x01 & ~x02 & ~x13 & x19);
  assign z16 = ~x00 & x01;
