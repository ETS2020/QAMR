...
module FAU ( 
  ...
  assign new_n59_ = x01 & (x09 | ~x10 | ~x11 | x12 | ~x22);
  assign z08 = x19 & new_n61_ & ~x18;
  assign new_n61_ = x17 & ~x08 & ~x07 & ~x06 & new_n62_ & ~x05;
  assign new_n62_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x22 & (x01 | (new_n64_ & new_n65_ & ~x14 & ~x15));
  assign new_n64_ = ~x00 & x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = ~x16 & x20 & ~x21;
  assign z10 = (x01 & ~x22) | (~x00 & (new_n67_ | (new_n69_ & x01 & x18)));
  assign new_n67_ = new_n68_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n68_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n69_ = ~x19 & ~x20 & x21;
  assign z11 = ~x22 & (x01 | (new_n64_ & new_n65_ & ~x14 & x15));
  ...
  assign z14 = (x01 & ~x22) | (new_n76_ & ~x00 & ~x01 & ~x02 & ~x09);
