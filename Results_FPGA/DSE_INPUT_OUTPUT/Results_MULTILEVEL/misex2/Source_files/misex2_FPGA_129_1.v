...
module FAU ( 
  ...
  assign z03 = (~x01 & (x14 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & x14) | (new_n55_ & x00 & x01 & x02);
  ...
  assign z10 = (~x01 & x14) | (~x00 & (new_n69_ | new_n71_));
  assign new_n69_ = new_n70_ & x15 & x16 & x20 & ~x21 & ~x22;
  ...
  assign new_n77_ = ~x14 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
