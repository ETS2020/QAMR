...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n56_, new_n59_, new_n60_,
  ...
  assign z09 = new_n59_ | (new_n60_ & new_n61_ & ~x14 & ~x15 & ~x16);
  assign new_n59_ = x01 & (x00 | (new_n52_ & ~x20 & ~x21 & ~x22));
  assign new_n60_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n61_ = x20 & ~x21 & ~x22;
  assign z10 = new_n63_ | (new_n60_ & new_n61_ & ~x14 & x15 & x16);
  assign new_n63_ = x01 & (x00 | (new_n52_ & ~x20 & x21 & x22));
  assign z11 = new_n65_ | (new_n60_ & new_n61_ & ~x14 & x15 & ~x16);
  assign new_n65_ = x01 & (x00 | (new_n52_ & ~x20 & x21 & ~x22));
