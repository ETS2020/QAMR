...
module FAU ( 
  ...
  assign new_n54_ = ~x11 & ~x17 & x18 & ~x19;
  assign z04 = new_n56_ & ~x12;
  assign new_n56_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = (~x01 & x11) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x11 & (~x01 | (new_n53_ & x00 & x02));
  assign z07 = (~x01 & x11) | (x00 & x02 & (~x01 | (new_n53_ & x11 & ~x12)));
  assign z08 = x19 & ~x18 & new_n61_ & x17;
  assign new_n61_ = ~x11 & ~x08 & ~x07 & ~x06 & new_n62_ & ~x05;
  ...
  assign z11 = (~x01 & x11) | (~x00 & ~x22 & (new_n72_ | new_n73_));
