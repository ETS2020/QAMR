...
module FAU ( 
  ...
  assign new_n59_ = x01 & (~x11 | x12 | x21 | x09 | ~x10);
  assign z08 = x19 & ~x18 & x17 & new_n61_ & ~x08;
  assign new_n61_ = ~x07 & ~x06 & ~x05 & x04 & new_n62_ & ~x03;
  ...
  assign z10 = ~x22 & ~x21 & x20 & new_n68_ & x16;
  assign new_n68_ = x15 & ~x14 & ~x13 & x12 & new_n62_ & ~x11;
  assign z11 = ~x22 & ~x21 & x20 & new_n68_ & ~x16;
  assign z12 = (new_n71_ & x09) | (x01 & x21);
