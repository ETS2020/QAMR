...
module FAU ( 
  ...
  assign z06 = (~x01 & x05) | (new_n58_ & x00 & x01 & x02);
  assign new_n58_ = ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | x05) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x01 & (new_n62_ | x05);
  assign new_n62_ = new_n63_ & ~x00 & x02 & ~x03 & x04 & ~x06;
  assign new_n63_ = ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = (~x01 & x05) | (~x00 & ~x21 & ~new_n65_ & ~x22);
  ...
  assign new_n79_ = ~x05 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
