...
module FAU ( 
  ...
  assign z02 = (x02 & x10) | (new_n49_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n49_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = ~x19 & x18 & new_n46_ & ~x17;
  assign z04 = x02 & x10;
  assign z07 = x02 & (x10 | (x00 & ~x01));
  assign z08 = x19 & new_n54_ & ~x18;
  assign new_n54_ = x17 & ~x10 & ~x08 & ~x07 & new_n55_ & ~x06;
  assign new_n55_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = z04 | (~x00 & ~x21 & ~new_n57_ & ~x22);
  assign new_n57_ = ~new_n59_ & (~new_n58_ | x01 | ~x02 | x11 | ~x12);
  assign new_n58_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n59_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ((new_n62_ & new_n63_) | (x01 & new_n61_ & x18));
  assign new_n61_ = ~x19 & ~x20 & x21 & ~z04 & x22;
  assign new_n62_ = ~x01 & x02 & ~x10 & ~x11 & x12 & ~x13;
  assign new_n63_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n66_ | (new_n65_ & x01));
  assign new_n65_ = x18 & ~x19 & ~x20 & ~z04 & x21;
  assign new_n66_ = new_n67_ & ~x01 & x02 & ~x10 & ~x11 & x12;
  assign new_n67_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
  assign z12 = x09 & ~x24 & (x00 ? (~z04 & x01) : (~new_n69_ & ~x01));
  assign new_n69_ = x02 ? (x10 | ~x23) : (x19 ? ~x23 : ~x17);
