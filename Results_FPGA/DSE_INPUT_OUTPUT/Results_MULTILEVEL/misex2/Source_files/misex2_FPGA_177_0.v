...
module FAU ( 
  ...
  assign z12 = (new_n77_ & x09) | (~x13 & ~x19);
  ...
  assign z14 = ~x19 & (~x13 | (new_n81_ & ~x00 & ~x01 & ~x02));
  assign new_n81_ = ~x09 & ~x10 & ~x17 & ~x18;
