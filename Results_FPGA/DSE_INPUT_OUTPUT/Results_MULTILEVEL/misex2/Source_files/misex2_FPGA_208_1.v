...
module FAU ( 
  ...
  assign new_n65_ = ~x01 & x02 & ~x05 & ~x11 & x12;
  assign new_n66_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (~x01 & x05) | (~x00 & (new_n68_ | new_n70_));
  ...
  assign z11 = ~x00 & ~x22 & (new_n72_ | (new_n65_ & new_n73_));
  ...
  assign new_n76_ = ~x05 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (x05 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & ((~x02 & ~x05) | (x01 & (~x02 | ~x10)))) | (~x05 & x19 & ~x01 & ~x02);
