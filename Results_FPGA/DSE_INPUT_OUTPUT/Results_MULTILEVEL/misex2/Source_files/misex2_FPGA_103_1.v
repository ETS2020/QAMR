...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n53_, new_n57_, new_n60_,
  ...
  assign z04 = (~x01 & x12) | (x00 & x01 & x02 & new_n52_ & ~x11 & ~x12);
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = (~x01 & x12) | (new_n57_ & x00 & x01 & x02);
  assign new_n57_ = ~x09 & x10 & x11;
  assign z07 = (~x01 & x12) | (x00 & x02 & (~x01 | (new_n52_ & x11 & ~x12)));
  ...
  assign new_n63_ = ~x01 & x12;
  assign new_n64_ = ~x00 & x01 & x18;
  assign z10 = new_n63_ | (new_n64_ & ~x19 & ~x20 & x21 & x22);
  assign z11 = new_n63_ | (new_n64_ & ~x19 & ~x20 & x21 & ~x22);
  assign z12 = new_n63_ | (new_n68_ & x09);
