...
module FAU ( 
  ...
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~new_n68_ & ~x19;
  assign z14 = ~x20 & ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | new_n68_ | (~x01 & ~x02 & x19);
  assign z16 = new_n68_ | (~x00 & x01);
  assign z17 = ~x00 & ~x01 & ~new_n68_ & x02;
endmodule
