...
module FAU ( 
  ...
  assign z00 = ~x01 & (~x23 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x01 & (~x23 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = x23 & ~x19 & new_n49_ & ~x18;
  ...
  assign z05 = (~x01 & ~x23) | (x02 & x09 & x10 & x00 & x01);
  ...
  assign new_n74_ = x00 ? (~x01 | (x02 & x10)) : (x01 | (~x02 & ~x17 & ~x19));
  assign z13 = x23 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x01 & (~x23 | (new_n77_ & ~x00 & ~x02 & ~x09));
  assign new_n77_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x23))) | (x19 & x23 & ~x01 & ~x02);
