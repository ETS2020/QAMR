...
module FAU ( 
  ...
  assign z08 = ~x06 & (new_n62_ | ~x17);
  assign new_n62_ = new_n63_ & ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n63_ = ~x05 & ~x07 & ~x08 & ~x18 & x19;
  ...
  assign z14 = ~x17 & (~x06 | (new_n49_ & new_n50_ & ~x09 & ~x10));
