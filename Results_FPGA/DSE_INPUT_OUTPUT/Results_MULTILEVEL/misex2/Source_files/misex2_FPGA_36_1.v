...
module FAU ( 
  ...
  assign z09 = (~x02 & x10) | (~x00 & ~x21 & ~new_n60_ & ~x22);
  ...
  assign new_n64_ = ~x19 & ~x20 & x21 & x22 & (x02 | ~x10);
  ...
  assign new_n69_ = x18 & ~x19 & ~x20 & x21 & (x02 | ~x10);
  assign z12 = x09 & ~x24 & (x00 ? (x01 & ~x10) : (~new_n71_ & ~x01));
  assign new_n71_ = (x10 | ((~x19 | ~x23) & (x02 | ~x17 | x19))) & (~x02 | ~x23);
