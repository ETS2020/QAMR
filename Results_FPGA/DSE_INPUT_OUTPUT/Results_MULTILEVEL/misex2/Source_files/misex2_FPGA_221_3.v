...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n52_ | x22)) | (new_n53_ & ~x00 & ~x01 & ~x02);
  ...
  assign new_n60_ = x01 & (~x11 | x12 | x22 | x09 | ~x10);
  assign z08 = (x01 & x22) | (new_n63_ & new_n62_ & ~x00 & ~x01 & x02);
  ...
  assign new_n76_ = ~x22 & (~x02 | ~x10);
  assign new_n77_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = (x01 & x22) | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
