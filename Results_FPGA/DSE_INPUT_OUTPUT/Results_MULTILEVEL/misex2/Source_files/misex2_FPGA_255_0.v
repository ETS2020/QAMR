...
module FAU ( 
  ...
  assign new_n68_ = ~x01 & x02 & x04 & ~x11 & x12 & ~x13;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n71_ | new_n73_);
  assign new_n71_ = new_n72_ & ~x01 & x02 & x04 & ~x11 & x12;
  ...
  assign new_n76_ = x04 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (~x04 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & new_n79_ & ~x17;
  assign new_n79_ = ~x10 & ~x09 & x04 & ~x02 & ~x00 & ~x01;
