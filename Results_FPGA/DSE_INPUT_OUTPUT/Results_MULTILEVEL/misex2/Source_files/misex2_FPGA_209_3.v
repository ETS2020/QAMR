...
module FAU ( 
  ...
  assign z10 = new_n52_ | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  ...
  assign z12 = x09 & ~x24 & (new_n75_ | (new_n76_ & ~x00));
  assign new_n75_ = ~new_n52_ & ((x00 & x01 & (~x02 | ~x10)) | (~x00 & ~x01 & x02 & x23));
  assign new_n76_ = ~x01 & ((~x17 & x19 & x23) | (~x08 & x17 & (x23 | (~x02 & ~x19))));
