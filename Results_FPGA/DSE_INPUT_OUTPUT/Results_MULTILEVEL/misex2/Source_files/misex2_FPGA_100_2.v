...
module FAU ( 
  ...
  assign new_n52_ = ~x09 & x10 & x11 & ~new_n49_ & x12;
  ...
  assign new_n58_ = x02 & ~x09 & x10 & ~new_n49_ & x11;
  ...
  assign new_n69_ = new_n70_ & x01 & ~x17 & x18;
  ...
  assign new_n75_ = x01 & ~x17 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (new_n77_ | (new_n78_ & ~x00));
  assign new_n77_ = ~new_n49_ & ((x00 & x01 & (~x02 | ~x10)) | (~x00 & ~x01 & x02 & x23));
  assign new_n78_ = ~x01 & (x17 ? (x20 & (x23 | (~x02 & ~x19))) : (x19 & x23));
  assign z13 = x17 & (~x20 | (~x00 & ~x01 & ~x02 & ~x19));
  assign z14 = new_n49_ | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = ~new_n49_ & ((x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19));
