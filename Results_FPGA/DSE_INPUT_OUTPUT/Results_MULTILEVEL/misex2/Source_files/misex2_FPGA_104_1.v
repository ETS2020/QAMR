...
module FAU ( 
  ...
  assign new_n61_ = ~x08 & ~x07 & ~x06 & ~x05 & z17 & x04;
  assign z17 = ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (~x01 & x03) | (~x00 & ~x21 & ~new_n64_ & ~x22);
  ...
  assign new_n72_ = new_n73_ & ~x01 & x02 & ~x03 & ~x11 & x12;
  assign new_n73_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (~x01 & x03) | (new_n76_ & x09);
  ...
  assign z14 = ~x01 & (x03 | (new_n46_ & new_n47_ & ~x10 & ~x17));
