...
module FAU ( 
  ...
  assign z01 = (x01 & x03) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  ...
  assign z05 = x01 & (x03 | (x00 & x02 & x09 & x10));
  assign z06 = new_n57_ & x11;
  assign new_n57_ = x10 & ~x09 & ~x03 & x02 & x00 & x01;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (x03 | x09 | ~x10 | ~x11 | x12);
  assign z08 = (x01 & x03) | (new_n62_ & ~x00 & ~x01 & x02 & new_n61_ & ~x03);
  ...
  assign z10 = (x01 & x03) | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  ...
  assign z12 = (x01 & x03) | (x09 & ~x24 & (new_n75_ | new_n76_));
