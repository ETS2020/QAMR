...
module FAU ( 
  ...
  assign z00 = ~x17 & (~x13 | (new_n46_ & ~x00 & ~x01 & ~x02));
  ...
  assign new_n51_ = ~x09 & x10 & x11 & x12 & (x13 | x17);
  ...
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (x13 | x17);
  assign z07 = x00 & x02 & ~new_n54_ & ~new_n60_;
  assign new_n60_ = x01 & (x09 | ~x10 | ~x11 | x12);
  assign z08 = new_n54_ | (new_n62_ & new_n63_);
  ...
  assign new_n80_ = x13 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | new_n54_ | (~x01 & ~x02 & x19);
