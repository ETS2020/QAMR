...
module FAU ( 
  ...
  assign z02 = (x10 & ~x15) | (new_n50_ & new_n47_ & ~x10 & ~x17);
  ...
  assign new_n58_ = x15 & (~x00 | ~x01 | ~x02 | x09 | ~x11);
  ...
  assign new_n65_ = new_n66_ & ~x01 & x02 & ~x10 & ~x11 & x12;
  assign new_n66_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20 & (~x10 | x15);
  ...
  assign z11 = (x10 & ~x15) | (~x00 & ~x22 & (new_n73_ | new_n74_));
  ...
  assign z16 = ~x00 & x01 & (~x10 | x15);
  assign z17 = (x10 & ~x15) | (~x00 & ~x01 & x02);
endmodule
