...
module FAU ( 
  ...
  assign z10 = new_n67_ | (new_n65_ & ~x19 & ~x20 & x21 & x22);
  assign new_n67_ = ~x01 & (x00 | (new_n63_ & new_n64_ & x15 & x16));
  assign z11 = new_n69_ | (new_n65_ & x21 & ~x22 & ~x19 & ~x20);
  assign new_n69_ = ~x01 & (x00 | (new_n63_ & new_n64_ & x15 & ~x16));
