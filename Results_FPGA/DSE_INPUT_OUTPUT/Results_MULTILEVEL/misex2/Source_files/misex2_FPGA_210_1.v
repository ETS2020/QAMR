...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n58_, new_n60_, new_n61_,
  ...
  assign z07 = (~x01 & x17) | (x00 & x02 & (new_n58_ | ~x01));
  assign new_n58_ = ~x09 & x10 & x11 & ~x12;
  assign z09 = z08 | (~x00 & ~x21 & ~new_n60_ & ~x22);
  ...
  assign new_n66_ = x15 & x16 & ~x17 & x20 & ~x21 & ~x22;
  assign z11 = z08 | (~x00 & ~x22 & (new_n68_ | new_n70_));
  assign new_n68_ = new_n69_ & ~x11 & x12 & ~x13 & ~x01 & x02;
  ...
  assign z14 = ~x01 & (new_n75_ | x17);
  assign new_n75_ = ~x00 & ~x02 & ~x09 & ~x10 & ~x18 & ~x19;
