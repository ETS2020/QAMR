...
module FAU ( 
  ...
  assign z01 = z05 | (new_n49_ & x10 & ~x17 & ~x18 & ~x19);
  assign z05 = x00 & x01;
  assign new_n49_ = ~x00 & ~x01 & ~x02 & x09;
  assign z02 = z05 | (new_n49_ & ~x18 & ~x19 & ~x10 & ~x17);
  ...
  assign z10 = ~x00 & (new_n61_ | (new_n62_ & new_n58_ & ~x01 & x02));
  assign new_n61_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n62_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = (x01 & (new_n64_ | x00)) | (new_n65_ & new_n58_ & ~x00 & ~x01 & x02);
