...
module FAU ( 
  ...
  assign new_n59_ = x01 & (x09 | ~x10 | ~x11 | x12 | ~x21);
  assign z08 = x19 & new_n61_ & ~x18;
  assign new_n61_ = x17 & ~x08 & ~x07 & ~x06 & new_n62_ & ~x05;
  assign new_n62_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x21 & (new_n64_ | x01);
  assign new_n64_ = new_n65_ & ~x00 & x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20 & ~x22;
  ...
  assign z12 = (new_n74_ & x09) | (x01 & ~x21);
