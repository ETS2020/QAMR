...
module FAU ( 
  ...
  assign z03 = (x01 & x12) | (new_n51_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign z04 = ~x12 & new_n53_ & ~x11;
  assign new_n53_ = x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x01 & (x12 | (x00 & x02 & x09 & x10));
  assign z06 = ~x12 & new_n53_ & x11;
  assign z07 = (x01 & x12) | (x00 & x02 & (new_n57_ | ~x01));
  ...
  assign new_n64_ = x01 & ~x12 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ((new_n66_ & new_n67_) | (new_n68_ & new_n69_));
  assign new_n66_ = x01 & ~x12 & x18;
