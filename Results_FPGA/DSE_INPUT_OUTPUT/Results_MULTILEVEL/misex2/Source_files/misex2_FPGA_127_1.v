...
module FAU ( 
  ...
  assign new_n72_ = ~x17 & x23 & (x02 | x19);
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & ~x09;
  assign z15 = (x00 & ((~x02 & ~x17) | (x01 & (~x02 | ~x10)))) | (~x01 & ~x02 & ~x17 & x19);
  assign z16 = ~x00 & x01;
