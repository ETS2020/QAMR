...
module FAU ( 
  ...
  assign new_n58_ = x14 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  ...
  assign new_n67_ = x01 & x14 & x18 & ~x19 & ~x20;
  ...
  assign new_n75_ = x01 & x14 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n77_ & ~x24;
  assign new_n77_ = x00 ? (~x01 | ~x14 | (x02 & x10)) : (new_n78_ | x01);
