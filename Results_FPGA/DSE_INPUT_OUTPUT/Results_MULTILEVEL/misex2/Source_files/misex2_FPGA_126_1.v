...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n53_, new_n55_, new_n58_, new_n60_,
  ...
  assign z01 = (~x06 & x19) | (new_n48_ & x10 & ~x17 & ~x18 & ~x19);
  ...
  assign z11 = ~x00 & ~x22 & ((new_n70_ & ~x01) | (new_n72_ & x01 & x18));
  assign new_n70_ = x02 & ~x11 & x12 & ~x13 & new_n71_ & ~x14;
  assign new_n71_ = x15 & ~x16 & x20 & ~x21 & (x06 | ~x19);
  ...
  assign z13 = (~x06 & x19) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (~x06 & x19) | (new_n78_ & ~x18 & ~x19 & ~x10 & ~x17);
  assign new_n78_ = ~x00 & ~x01 & ~x02 & ~x09;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x19 & (~x06 | (~x01 & ~x02)));
  assign z16 = ~x00 & ~z08 & x01;
  assign z17 = ~x00 & ~x01 & ~z08 & x02;
endmodule
