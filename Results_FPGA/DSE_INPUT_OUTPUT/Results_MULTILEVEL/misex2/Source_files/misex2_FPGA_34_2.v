...
module FAU ( 
  ...
  assign z03 = (x00 & (~x01 | (new_n50_ & x02 & ~x09))) | (new_n51_ & ~x01 & ~x02);
  ...
  assign new_n58_ = x02 & ~x03 & x04 & ~x05 & ~x06;
  ...
  assign z10 = (~x01 & (x00 | (new_n61_ & new_n65_))) | (new_n66_ & ~x00 & x01 & x18);
  assign new_n65_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n66_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & ~x22 & (new_n68_ | (new_n69_ & new_n70_));
