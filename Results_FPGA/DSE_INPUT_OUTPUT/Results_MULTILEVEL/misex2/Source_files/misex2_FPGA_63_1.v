...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  assign z01 = ~x02 & (x24 | (new_n48_ & new_n49_ & x10 & ~x17));
  assign new_n48_ = ~x00 & ~x01 & x09;
  assign new_n49_ = ~x18 & ~x19;
  assign z02 = ~x02 & (x24 | (new_n48_ & new_n49_ & ~x10 & ~x17));
  assign z03 = (new_n54_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02);
  assign new_n52_ = new_n53_ & x11 & x12;
  assign new_n53_ = ~x09 & x10;
  assign new_n54_ = ~x17 & x18 & ~x19 & ~x24;
  assign z04 = (new_n56_ & new_n53_ & ~x11 & ~x12) | (~x02 & x24);
  assign new_n56_ = x00 & x01 & x02;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = (~x02 & x24) | (new_n56_ & ~x09 & x10 & x11);
  assign z07 = x00 & x02 & (~x01 | (new_n53_ & x11 & ~x12));
  assign z08 = x19 & new_n61_ & ~x18;
  assign new_n61_ = x17 & ~x08 & ~x07 & ~x06 & new_n62_ & ~x05;
  assign new_n62_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (~x02 & x24) | (~x00 & ~x21 & ~new_n64_ & ~x22);
  ...
  assign new_n68_ = ~x19 & ~x20 & x21 & x22 & (x02 | ~x24);
  ...
  assign new_n73_ = x18 & ~x19 & ~x20 & x21 & (x02 | ~x24);
  ...
  assign z15 = (x00 & ((x01 & x02 & ~x10) | (~x02 & ~x24))) | (x19 & ~x24 & ~x01 & ~x02);
  assign z16 = (~x00 & x01) | (~x02 & x24);
  assign z17 = (~x00 & ~x01 & x02) | (~x02 & x24);
endmodule
