...
module FAU ( 
  ...
  assign new_n57_ = x10 & ~x09 & ~x05 & x02 & x00 & x01;
  assign z07 = (x01 & x05) | (x00 & x02 & (new_n59_ | ~x01));
  assign new_n59_ = ~x09 & x10 & x11 & ~x12;
  assign z08 = (x01 & x05) | (new_n62_ & new_n61_ & ~x03 & x04 & ~x05);
  ...
  assign z11 = (x01 & x05) | (~x00 & ~x22 & (new_n72_ | new_n73_));
  ...
  assign z15 = (~x02 & ((x00 & (~x01 | ~x05)) | (~x01 & x19))) | (~x05 & ~x10 & x00 & x01);
  assign z16 = x01 & (~x00 | x05);
  assign z17 = new_n61_ | (x01 & x05);
endmodule
