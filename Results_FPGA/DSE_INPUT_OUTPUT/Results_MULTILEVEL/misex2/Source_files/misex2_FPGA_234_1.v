...
module FAU ( 
  ...
  assign new_n51_ = ~x04 & ~x17 & x18 & ~x19;
  ...
  assign new_n61_ = ~x01 & x02 & ~x04 & ~x11 & x12;
  ...
  assign new_n66_ = ~x01 & x02 & ~x04 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = z08 | (~x00 & ~x22 & (new_n69_ | (new_n70_ & new_n71_)));
  ...
  assign new_n74_ = ~x04 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x17 & ~x04 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & new_n77_ & ~x17;
  assign new_n77_ = ~x10 & ~x09 & ~x04 & ~x02 & ~x00 & ~x01;
