...
module FAU ( 
  ...
  assign z02 = ~x01 & (x08 | (new_n49_ & ~x00 & ~x02 & x09));
  assign new_n49_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (~x01 & (x08 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign z04 = new_n54_ | (~x01 & x08);
  assign new_n54_ = new_n55_ & ~x09 & x10 & ~x11 & ~x12;
  assign new_n55_ = x00 & x01 & x02;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = (~x01 & x08) | (new_n55_ & ~x09 & x10 & x11);
  assign z07 = (~x01 & x08) | (x00 & x02 & (new_n59_ | ~x01));
  assign new_n59_ = ~x09 & x10 & x11 & ~x12;
  assign z08 = ~x01 & (new_n61_ | x08);
  assign new_n61_ = new_n62_ & ~x00 & x02 & ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & x17 & ~x18 & x19;
  assign z09 = (~x01 & x08) | (~x00 & ~x21 & ~new_n64_ & ~x22);
  ...
  assign z14 = ~x01 & (x08 | (new_n49_ & ~x00 & ~x02 & ~x09));
  assign z15 = (x00 & ((~x02 & ~x08) | (x01 & (~x02 | ~x10)))) | (~x08 & x19 & ~x01 & ~x02);
  assign z16 = ~x00 & x01;
