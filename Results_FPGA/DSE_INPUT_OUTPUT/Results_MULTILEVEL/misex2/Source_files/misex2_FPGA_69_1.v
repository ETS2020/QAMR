...
module FAU ( 
  ...
  assign z03 = (~x01 & (x06 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  ...
  assign z06 = (~x01 & x06) | (new_n58_ & x00 & x01 & x02);
  assign new_n58_ = ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | x06) & (~x01 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z10 = ~x00 & (new_n71_ | (new_n69_ & new_n72_));
  assign new_n69_ = new_n70_ & ~x01 & x02 & ~x06;
  assign new_n70_ = ~x11 & x12 & ~x13;
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n72_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (new_n74_ & ~x00) | (~x01 & x06);
  assign new_n74_ = ~x22 & (new_n75_ | (new_n76_ & new_n70_ & ~x01 & x02));
  ...
  assign new_n79_ = ~x06 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
