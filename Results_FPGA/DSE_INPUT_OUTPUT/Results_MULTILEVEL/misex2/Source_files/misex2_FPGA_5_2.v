...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n54_, new_n56_,
    ...
    new_n79_;
  assign z00 = ~x19 & (x16 | (new_n46_ & new_n47_ & ~x09 & x10));
  assign new_n46_ = ~x00 & ~x01 & ~x02;
  assign new_n47_ = ~x17 & ~x18;
  assign z01 = ~x19 & ~x18 & new_n49_ & ~x17;
  assign new_n49_ = ~x16 & x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x19 & (x16 | (new_n46_ & new_n47_ & x09 & ~x10));
  assign z03 = (x00 & x01 & new_n52_ & x02) | (new_n54_ & ~x00 & ~x01 & ~x02);
  assign new_n52_ = ~x09 & x10 & x11 & ~new_n53_ & x12;
  assign new_n53_ = x16 & ~x19;
  assign new_n54_ = ~x16 & ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n56_ & x02;
  assign new_n56_ = ~x09 & x10 & ~x11 & ~new_n53_ & ~x12;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n53_ & x10;
  assign z06 = new_n53_ | new_n59_;
  assign new_n59_ = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = new_n53_ | (new_n61_ & x00);
  assign new_n61_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = (x16 & ~x19) | (new_n63_ & new_n64_ & x17 & ~x18 & x19);
  ...
  assign new_n70_ = new_n71_ & x01 & ~x16 & x18;
  assign new_n71_ = ~x19 & ~x20 & x21 & x22;
  assign new_n72_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n73_ = x15 & x16 & x19 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x16 & ~x22 & (new_n75_ | new_n76_);
  assign new_n75_ = new_n67_ & ~x13 & ~x14 & x15 & x20 & ~x21;
  assign new_n76_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n78_ & x01) : (~new_n79_ & ~x01));
  assign new_n78_ = ~new_n53_ & (~x02 | ~x10);
  assign new_n79_ = (x16 | (x02 ? ~x23 : (~x17 | x19))) & (~x19 | ~x23);
  assign z13 = ~x19 & (x16 | (~x00 & ~x01 & ~x02 & x17));
  assign z14 = ~x19 & (x16 | (new_n46_ & new_n47_ & ~x09 & ~x10));
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x16 & ~x19) | (~x01 & ~x02 & x19);
