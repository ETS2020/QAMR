...
module FAU ( 
  ...
  assign z05 = x01 & (x08 | (x00 & x02 & x09 & x10));
  assign z06 = ~new_n56_ & x01;
  assign new_n56_ = ~x08 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = (x00 & x02 & (new_n58_ | ~x01)) | (x01 & x08);
  ...
  assign z10 = (x01 & x08) | (~x00 & (new_n67_ | (new_n68_ & new_n69_)));
  ...
  assign z12 = (x01 & x08) | (new_n74_ & x09);
