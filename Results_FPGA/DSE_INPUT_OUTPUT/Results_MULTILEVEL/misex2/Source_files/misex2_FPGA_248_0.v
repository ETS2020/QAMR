...
module FAU ( 
  ...
  assign new_n64_ = ~x01 & x02 & x04 & ~x11 & x12;
  assign new_n65_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (~x01 & ~x04) | (~x00 & (new_n67_ | new_n69_));
  ...
  assign new_n75_ = x04 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (~x04 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & new_n78_ & ~x17;
  assign new_n78_ = ~x10 & ~x09 & x04 & ~x02 & ~x00 & ~x01;
