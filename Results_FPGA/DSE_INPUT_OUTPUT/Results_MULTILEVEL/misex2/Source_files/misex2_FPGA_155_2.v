...
module FAU ( 
  ...
  assign z00 = ~x17 & (x16 | (new_n46_ & new_n47_ & ~x09 & x10));
  assign new_n46_ = ~x00 & ~x01 & ~x02;
  assign new_n47_ = ~x18 & ~x19;
  assign z01 = ~x19 & ~x18 & ~x17 & ~x16 & new_n49_ & x10;
  assign new_n49_ = x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x16 & new_n49_ & ~x10;
  ...
  assign z08 = (x16 & ~x17) | (new_n63_ & new_n64_ & x17 & ~x18 & x19);
  ...
  assign z12 = new_n53_ | (new_n77_ & x09);
  assign new_n77_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n78_ & ~x01));
  assign new_n78_ = (~x17 | (~x23 & (x02 | x19))) & (~x23 | (~x02 & ~x19));
  assign z13 = (x16 & ~x17) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x17 & (x16 | (new_n46_ & new_n47_ & ~x09 & ~x10));
