...
module FAU ( 
  ...
  assign new_n48_ = ~x05 & ~x02 & ~x00 & ~x01;
  ...
  assign z06 = (~x01 & x05) | (new_n57_ & x00 & x01 & x02);
  assign new_n57_ = ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (x01 | x05) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x01 & (new_n61_ | x05);
  assign new_n61_ = new_n62_ & ~x00 & x02 & ~x03 & x04 & ~x06;
  assign new_n62_ = ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = (~x01 & x05) | (~x00 & ~x21 & ~new_n64_ & ~x22);
  ...
  assign new_n78_ = ~x05 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & new_n48_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n48_ & ~x09;
  assign z15 = (x00 & ((~x02 & ~x05) | (x01 & (~x02 | ~x10)))) | (~x01 & ~x02 & ~x05 & x19);
