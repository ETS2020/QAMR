...
module FAU ( 
  ...
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (x15 | ~x24);
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n65_ | new_n66_);
  assign new_n65_ = x01 & x18 & ~x19 & ~new_n46_ & ~x20;
  assign new_n66_ = new_n67_ & ~x14 & ~x15 & ~x16 & x20 & ~x24;
  assign new_n67_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign z10 = new_n46_ | (~x00 & (new_n69_ | (new_n67_ & new_n70_)));
  assign new_n69_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n46_ | (~x00 & ~x22 & (new_n72_ | new_n73_));
  assign new_n72_ = new_n67_ & ~x14 & x15 & ~x16 & x20 & ~x21;
