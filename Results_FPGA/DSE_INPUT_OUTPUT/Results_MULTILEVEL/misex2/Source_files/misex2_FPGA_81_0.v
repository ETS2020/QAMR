...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    ...
    new_n73_, new_n76_;
  assign z00 = ~x01 & (~x15 | (new_n46_ & ~x00 & ~x02 & ~x09));
  ...
  assign z03 = (~x01 & (~x15 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  ...
  assign new_n60_ = x17 & x15 & ~x08 & ~x07 & new_n61_ & ~x06;
  ...
  assign new_n76_ = x15 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
