...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n55_, new_n58_,
    new_n60_, new_n62_, new_n64_, new_n66_, new_n67_, new_n68_, new_n70_,
  ...
  assign new_n64_ = ~x14 & ~x13 & x12 & ~x11 & new_n47_ & x02;
  assign z10 = (x01 & ~x21) | (~x00 & (new_n66_ | (new_n68_ & x01 & x18)));
  assign new_n66_ = new_n67_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n67_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n68_ = ~x19 & ~x20 & x22;
