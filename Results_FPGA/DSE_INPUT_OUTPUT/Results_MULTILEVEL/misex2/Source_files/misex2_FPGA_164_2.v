...
module FAU ( 
  ...
  assign new_n57_ = x16 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (x09 | ~x10 | ~x11 | x12 | ~x16);
  assign z08 = (x01 & ~x16) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  ...
  assign z10 = (x01 & ~x16) | (~x00 & (new_n68_ | new_n70_));
