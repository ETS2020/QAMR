...
module FAU ( 
  ...
  assign z08 = ~x01 & (x03 | (new_n60_ & new_n61_));
  assign new_n60_ = ~x00 & x02 & x04 & ~x05 & ~x06;
  ...
  assign z11 = ~x00 & ~x22 & (new_n71_ | (new_n63_ & new_n72_));
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n72_ = ~x13 & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = (~x01 & x03) | (x09 & ~x24 & (new_n74_ | new_n75_));
