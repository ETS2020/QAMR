...
module FAU ( 
  ...
  assign z10 = (~x13 & ~x22) | (new_n67_ & ~x19 & ~x20 & x21 & x22);
  assign new_n67_ = ~x00 & x01 & x18;
  assign z11 = ~x22 & (~x13 | (new_n67_ & ~x19 & ~x20 & x21));
  assign z12 = new_n48_ | (x09 & ~x24 & (new_n70_ | new_n71_));
  assign new_n70_ = x00 & x01 & (~x02 | ~x10);
  assign new_n71_ = ~x00 & ~x01 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = new_n48_ | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = new_n48_ | (new_n74_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n74_ = ~x18 & ~x19 & ~x10 & ~x17;
