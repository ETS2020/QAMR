...
module FAU ( 
  ...
  assign z03 = (new_n52_ & new_n53_) | (~new_n51_ & ~x01);
  assign new_n51_ = x14 & (x00 | x02 | x17 | ~x18 | x19);
  assign new_n52_ = x00 & x01 & x02;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = new_n55_ | (new_n52_ & ~x09 & x10 & ~x11 & ~x12);
  assign new_n55_ = ~x01 & ~x14;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n55_ | (new_n52_ & ~x09 & x10 & x11);
  ...
  assign z14 = ~x01 & (~x14 | (new_n73_ & ~x00 & ~x02 & ~x09));
  assign new_n73_ = ~x18 & ~x19 & ~x10 & ~x17;
