...
module FAU ( 
  ...
  assign z05 = (~x01 & ~x02) | (x00 & x01 & x02 & x09 & x10);
  ...
  assign z09 = z00 | (~x00 & ~x21 & ~new_n56_ & ~x22);
  assign new_n56_ = ~new_n58_ & (~new_n57_ | x01 | x11 | ~x12 | x13);
  ...
  assign z11 = ~x00 & (new_n64_ | new_n65_) & ~x22;
