...
module FAU ( 
  ...
  assign z03 = (x00 & (new_n50_ | ~x01)) | (new_n51_ & ~x01 & ~x02);
  assign new_n50_ = x02 & ~x09 & x10 & x11 & x12;
  ...
  assign new_n57_ = x01 & (~x02 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z11 = (~x01 & (x00 | (new_n70_ & new_n71_))) | (new_n72_ & ~x00 & x01 & x18);
  assign new_n70_ = x02 & ~x11 & x12 & ~x13 & ~x14;
  ...
  assign z14 = ~x01 & (new_n78_ | x00);
  assign new_n78_ = ~x02 & ~x09 & ~x10 & ~x17 & ~x18 & ~x19;
