...
module FAU ( 
  ...
  assign z04 = new_n47_ | (new_n55_ & ~x11 & ~x12 & ~x09 & x10);
  assign new_n55_ = x00 & x01 & x02;
  assign z05 = new_n47_ | (x02 & x09 & x10 & x00 & x01);
  assign z06 = new_n47_ | (new_n55_ & ~x09 & x10 & x11);
  assign z07 = x00 & x02 & ~new_n47_ & ~new_n59_;
  assign new_n59_ = x01 & (x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x08 & (new_n61_ | ~x22);
  assign new_n61_ = new_n62_ & ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n62_ = x17 & ~x18 & x19 & ~x05 & ~x06 & ~x07;
