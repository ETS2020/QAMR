...
module FAU ( 
  ...
  assign z06 = (~x01 & ~x04) | (new_n57_ & x00 & x01 & x02);
  ...
  assign new_n69_ = ~x01 & x02 & x04 & ~x11 & x12 & ~x13;
  ...
  assign new_n77_ = x04 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x17 & x04 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & new_n80_ & ~x17;
  assign new_n80_ = ~x10 & ~x09 & x04 & ~x02 & ~x00 & ~x01;
