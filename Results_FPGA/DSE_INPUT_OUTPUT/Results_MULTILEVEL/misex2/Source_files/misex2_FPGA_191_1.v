...
module FAU ( 
  ...
  assign new_n48_ = x10 & x09 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x01 & (x03 | (new_n50_ & ~x00 & ~x02 & x09));
  assign new_n50_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (~x01 & (x03 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & x03) | (new_n55_ & x00 & x01 & x02);
  ...
  assign z12 = (~x01 & x03) | (new_n75_ & x09);
  assign new_n75_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n76_ & ~x01));
  assign new_n76_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x01 & (x03 | (new_n50_ & ~x00 & ~x02 & ~x09));
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & (x03 | (~x02 & x19)));
  assign z16 = ~x00 & x01;
