...
module FAU ( 
  ...
  assign z01 = ~x01 & (~x06 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = ~x19 & ~x18 & new_n49_ & ~x17;
  assign new_n49_ = ~x10 & x09 & x06 & ~x02 & ~x00 & ~x01;
  assign z03 = (~x01 & (~x06 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  ...
  assign new_n73_ = x06 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x17 & x06 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x01 & (~x06 | (new_n76_ & ~x00 & ~x02 & ~x09));
