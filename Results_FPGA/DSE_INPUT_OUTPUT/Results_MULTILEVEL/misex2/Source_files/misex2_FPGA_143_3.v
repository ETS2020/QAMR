...
module FAU ( 
  ...
  assign z01 = (x05 & x17) | (new_n48_ & x10 & ~x17 & ~x18 & ~x19);
  ...
  assign z09 = ~x00 & ~x21 & ~x22 & ~new_n65_ & ~new_n52_;
  assign new_n65_ = ~new_n67_ & (~new_n66_ | x01 | ~x02 | x11 | ~x12);
  assign new_n66_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ~new_n52_ & (new_n69_ | (new_n70_ & new_n71_));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & ~new_n52_ & (new_n73_ | new_n74_);
  assign new_n73_ = new_n70_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (new_n76_ | (new_n77_ & ~x00));
  assign new_n76_ = ~new_n52_ & ((x00 & x01 & (~x02 | ~x10)) | (~x00 & ~x01 & x02 & x23));
  assign new_n77_ = ~x01 & ((~x17 & x19 & x23) | (~x05 & x17 & (x23 | (~x02 & ~x19))));
  assign z13 = ~x19 & x17 & new_n46_ & ~x05;
