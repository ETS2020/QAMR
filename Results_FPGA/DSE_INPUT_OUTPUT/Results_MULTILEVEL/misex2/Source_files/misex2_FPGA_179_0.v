...
module FAU ( 
  ...
  assign z03 = (~new_n51_ & ~x19) | (new_n52_ & x00 & x01 & x02);
  assign new_n51_ = x16 & (x00 | x01 | x02 | x17 | ~x18);
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign z04 = x00 & x01 & new_n54_ & x02;
  assign new_n54_ = ~x09 & x10 & ~x11 & ~new_n55_ & ~x12;
  assign new_n55_ = ~x16 & ~x19;
  assign z05 = new_n55_ | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & ~new_n55_ & x11;
  assign z07 = new_n55_ | (new_n60_ & x00);
  ...
  assign z15 = (x00 & (x16 | x19) & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19);
  assign z16 = ~x00 & ~new_n55_ & x01;
  assign z17 = ~x00 & ~x01 & ~new_n55_ & x02;
endmodule
