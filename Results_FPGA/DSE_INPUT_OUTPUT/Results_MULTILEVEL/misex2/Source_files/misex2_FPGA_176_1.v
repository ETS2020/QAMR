...
module FAU ( 
  ...
  assign z01 = ~x01 & (x24 | (new_n48_ & new_n49_ & x10 & ~x17));
  assign new_n48_ = ~x00 & ~x02 & x09;
  assign new_n49_ = ~x18 & ~x19;
  assign z02 = ~x01 & (x24 | (new_n48_ & new_n49_ & ~x10 & ~x17));
  assign z03 = (~x01 & (x24 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & x24) | (new_n55_ & x00 & x01 & x02);
  assign new_n55_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = (~x01 & x24) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = (~x01 & x24) | (new_n58_ & x00 & x01 & x02);
  assign new_n58_ = ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x24);
  assign z08 = ~x24 & x19 & new_n62_ & ~x18;
  assign new_n62_ = x17 & ~x08 & ~x07 & ~x06 & new_n63_ & ~x05;
  assign new_n63_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n65_ | new_n67_);
  assign new_n65_ = new_n66_ & ~x14 & ~x15 & ~x16 & x20 & ~x24;
  assign new_n66_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (~x01 & x24) | (~x00 & (new_n69_ | (new_n66_ & new_n70_)));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n72_ | (new_n66_ & new_n73_));
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n73_ = ~x14 & x15 & ~x16 & x20 & ~x21 & ~x24;
  assign z12 = (~x01 & x24) | (x09 & (x00 ? (x01 & ~new_n75_ & ~x24) : (~new_n76_ & ~x01)));
  ...
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & ~x24))) | (~x01 & ~x02 & x19 & ~x24);
  assign z16 = ~x00 & x01;
