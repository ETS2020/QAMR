...
module FAU ( 
  ...
  assign new_n49_ = x09 & new_n47_ & ~x02;
  ...
  assign z07 = (x00 & x02 & (new_n60_ | ~x01)) | (x01 & x21);
  assign new_n60_ = x11 & ~x12 & ~x09 & x10;
  assign z08 = x19 & ~x18 & x17 & ~x08 & new_n62_ & ~x07;
  assign new_n62_ = ~x06 & ~x05 & x04 & ~x03 & new_n47_ & x02;
  ...
  assign new_n71_ = ~x14 & ~x13 & x12 & ~x11 & new_n47_ & x02;
