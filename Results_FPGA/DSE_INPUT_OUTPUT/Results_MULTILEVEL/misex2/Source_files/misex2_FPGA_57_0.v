...
module FAU ( 
  ...
  assign z08 = ~x08 & (new_n62_ | ~x21);
  assign new_n62_ = new_n63_ & ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n63_ = x17 & ~x18 & x19 & ~x05 & ~x06 & ~x07;
  assign z09 = ~x00 & x08 & ~x21 & ~new_n65_ & ~x22;
  ...
  assign new_n70_ = ~x01 & x02 & x08 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n73_ | new_n75_);
  assign new_n73_ = new_n74_ & x08 & ~x11 & x12 & ~x01 & x02;
