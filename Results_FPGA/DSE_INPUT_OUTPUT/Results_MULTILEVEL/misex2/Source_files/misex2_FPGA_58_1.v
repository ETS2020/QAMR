...
module FAU ( 
  ...
  assign new_n46_ = ~x10 & x23;
  assign new_n47_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = new_n46_ | (new_n47_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = ~x10 & (x23 | (new_n50_ & ~x00 & ~x01 & ~x02));
  assign new_n50_ = ~x18 & ~x19 & x09 & ~x17;
  ...
  assign new_n59_ = (x01 | (~x10 & x23)) & (x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x00 & ~x01 & new_n61_ & x02;
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & new_n62_ & ~x07;
  assign new_n62_ = ~x08 & x17 & ~x18 & x19 & (x10 | ~x23);
  ...
  assign z14 = ~x23 & ~x19 & new_n79_ & ~x18;
