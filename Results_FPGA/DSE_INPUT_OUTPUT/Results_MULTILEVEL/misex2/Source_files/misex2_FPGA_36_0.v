...
module FAU ( 
  ...
  assign z02 = ~x02 & ~x10;
  assign z03 = x10 & (new_n51_ | (new_n50_ & ~x09 & x11 & x12));
  assign new_n50_ = x00 & x01 & x02;
  assign new_n51_ = ~x00 & ~x01 & ~x02 & ~x17 & x18 & ~x19;
  assign z04 = (~x02 & ~x10) | (new_n50_ & ~x09 & x10 & ~x11 & ~x12);
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = (~x02 & ~x10) | (x00 & x02 & (~x01 | (new_n56_ & ~x09 & x10)));
