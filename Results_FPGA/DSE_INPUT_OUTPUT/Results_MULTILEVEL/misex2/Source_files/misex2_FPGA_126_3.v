...
module FAU ( 
  ...
  assign new_n51_ = ~x09 & x10 & x11 & x12 & (~x06 | ~x19);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n54_ & x02;
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12 & (~x06 | ~x19);
  assign z05 = new_n56_ | (x06 & x19);
  assign new_n56_ = x00 & x01 & x02 & x09 & x10;
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (~x06 | ~x19);
  assign z07 = x00 & x02 & ~new_n60_ & (~x06 | ~x19);
  assign new_n60_ = x01 & (x09 | ~x10 | ~x11 | x12);
  assign z08 = x19 & (new_n62_ | x06);
  assign new_n62_ = new_n63_ & ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n63_ = ~x05 & ~x07 & ~x08 & x17 & ~x18;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n65_ | new_n67_);
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & new_n66_ & ~x13;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20 & (~x06 | ~x19);
  assign new_n67_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (x06 & x19) | (~x00 & (new_n69_ | new_n71_));
  ...
  assign new_n74_ = x15 & ~x16 & x20 & ~x21 & (~x06 | ~x19);
  assign new_n75_ = ~x19 & ~x20 & x21;
  assign z12 = (new_n77_ & x09) | (x06 & x19);
  ...
  assign z14 = (x06 & x19) | (new_n81_ & ~x18 & ~x19 & ~x10 & ~x17);
