...
module FAU ( 
  ...
  assign z09 = (~x01 & ~x15) | (new_n64_ & ~x00 & x01 & x18);
  assign new_n64_ = ~x21 & ~x22 & ~x19 & ~x20;
  assign z10 = (~x01 & ~x15) | (~x00 & (new_n66_ | new_n68_));
  assign new_n66_ = new_n67_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x14 & x16 & x20 & ~x21 & ~x22;
  assign new_n68_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = (~x01 & ~x15) | (~x00 & ~new_n70_ & ~x22);
  assign new_n70_ = ~new_n71_ & (~new_n72_ | x01 | ~x02 | x11 | ~x12);
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n72_ = ~x13 & ~x14 & ~x16 & x20 & ~x21;
  assign z12 = (~x01 & ~x15) | (new_n74_ & x09);
