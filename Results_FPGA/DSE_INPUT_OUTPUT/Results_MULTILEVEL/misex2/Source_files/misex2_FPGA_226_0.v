...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n59_, new_n61_,
  ...
  assign new_n59_ = (x01 | ~x03) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n63_ | (new_n61_ & new_n62_));
  assign new_n61_ = ~x01 & x02 & x03 & ~x11 & x12;
  ...
  assign z12 = z08 | (x09 & ~x24 & (new_n72_ | new_n73_));
  assign new_n72_ = x00 & x01 & (~x02 | ~x10);
  assign new_n73_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = ~x01 & (~x03 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & new_n76_ & ~x17;
  assign new_n76_ = ~x10 & ~x09 & x03 & ~x02 & ~x00 & ~x01;
