...
module FAU ( 
  ...
  assign z09 = ~x22 & (new_n65_ | x02);
  assign new_n65_ = ~x00 & x01 & x18 & ~x19 & ~x20 & ~x21;
  assign z10 = new_n67_ & x22;
  assign new_n67_ = x21 & ~x20 & ~x19 & x18 & ~x00 & x01;
  assign z11 = ~x22 & new_n69_ & x21;
  assign new_n69_ = ~x20 & ~x19 & x18 & ~x02 & ~x00 & x01;
  assign z12 = x09 & ~new_n71_ & ~x24;
  assign new_n71_ = x00 ? (~x01 | (x02 & (x10 | ~x22))) : (new_n72_ | x01);
  assign new_n72_ = x02 ? (~x22 | ~x23) : (x19 ? ~x23 : ~x17);
