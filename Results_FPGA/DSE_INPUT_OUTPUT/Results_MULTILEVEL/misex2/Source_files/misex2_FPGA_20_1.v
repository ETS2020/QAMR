...
module FAU ( 
  ...
  assign z09 = (~x02 & x19) | (~x00 & ~x21 & ~new_n63_ & ~x22);
  ...
  assign new_n74_ = x00 ? (~x01 | (x02 ? x10 : x19)) : (new_n75_ | x01);
  assign new_n75_ = x02 ? ~x23 : (~x17 | x19);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x02 & (new_n78_ | x19);
  assign new_n78_ = ~x00 & ~x01 & ~x09 & ~x10 & ~x17 & ~x18;
  assign z15 = (~x02 & x19) | (x00 & (~x02 | (x01 & ~x10)));
  assign z16 = ~x00 & x01 & (x02 | ~x19);
  assign z17 = (~x00 & ~x01 & x02) | (~x02 & x19);
endmodule
