...
module FAU ( 
  ...
  assign new_n57_ = ~x14 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x11 | x12 | x14 | x09 | ~x10);
  assign z08 = x19 & new_n61_ & ~x18;
  assign new_n61_ = ~x08 & ~x07 & ~x06 & new_n62_ & ~x05 & x17;
