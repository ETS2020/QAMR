...
module FAU ( 
  ...
  assign new_n74_ = x18 & ~x19 & ~x20 & x21 & (~x02 | x10);
  assign z12 = (~new_n76_ & x02) | (x09 & ~new_n77_ & ~x24);
  assign new_n76_ = x10 & (x00 | x01 | ~x09 | ~x23 | x24);
  assign new_n77_ = x00 ? (~x01 | x02) : (x01 | ((~x19 | ~x23) & (x02 | ~x17 | x19)));
  assign z13 = ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = ~x02 & (x00 | (~x01 & x19));
  assign z16 = (x02 & ~x10) | (~x00 & x01);
