...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n57_, new_n59_,
    ...
    new_n81_;
  assign z00 = (~x10 & ~x20) | (new_n46_ & x10 & ~x17 & ~x18 & ~x19);
  ...
  assign new_n51_ = ~x17 & x18 & ~x19 & (x10 | x20);
  ...
  assign z06 = (~x10 & ~x20) | (new_n57_ & ~x09 & x10 & x11);
  assign new_n57_ = x00 & x01 & x02;
  assign z07 = new_n59_ | (new_n60_ & x00);
  assign new_n59_ = ~x10 & ~x20;
  assign new_n60_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = new_n59_ | (new_n62_ & new_n63_);
  ...
  assign new_n67_ = x01 & x10 & x18 & ~x19 & ~x20;
  ...
  assign z11 = new_n59_ | (~x00 & ~x22 & (new_n74_ | (new_n71_ & new_n75_)));
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n75_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = new_n59_ | (x09 & ~x24 & (new_n77_ | new_n78_));
  assign new_n77_ = x00 & x01 & (~x02 | ~x10);
  assign new_n78_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~new_n59_ & ~x19;
  assign z14 = x20 & ~x19 & new_n81_ & ~x18;
  assign new_n81_ = ~x17 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x10 & ~x20) | (~x01 & ~x02 & x19);
  assign z16 = ~x00 & ~new_n59_ & x01;
  assign z17 = ~x00 & ~x01 & ~new_n59_ & x02;
endmodule
