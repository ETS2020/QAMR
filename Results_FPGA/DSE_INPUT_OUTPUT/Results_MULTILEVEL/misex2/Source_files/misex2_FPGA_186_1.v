...
module FAU ( 
  ...
  assign new_n50_ = ~x10 & x09 & ~x06 & ~x02 & ~x00 & ~x01;
  ...
  assign z07 = (~x01 & x06) | (x00 & x02 & (new_n60_ | ~x01));
  ...
  assign new_n73_ = new_n74_ & ~x01 & x02 & ~x06 & ~x11 & x12;
  assign new_n74_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
  assign new_n75_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (~x01 & x06) | (new_n77_ & x09);
