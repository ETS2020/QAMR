...
module FAU ( 
  ...
  assign z07 = (~x01 & ~x05) | (x00 & x02 & (new_n58_ | ~x01));
  ...
  assign new_n73_ = ~x01 & x05 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (~x05 | (~x00 & ~x02 & x17 & ~x19));
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x05))) | (~x01 & ~x02 & x05 & x19);
  assign z16 = ~x00 & x01;
