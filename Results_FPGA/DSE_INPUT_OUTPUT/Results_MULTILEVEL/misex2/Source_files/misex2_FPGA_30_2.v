...
module FAU ( 
  ...
  assign z06 = x00 & (~x01 | (x10 & x11 & x02 & ~x09));
  ...
  assign z11 = (~x01 & (new_n72_ | x00)) | (new_n74_ & ~x00 & x01 & x18);
  assign new_n72_ = new_n73_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n73_ = x15 & ~x16 & x20 & ~x21 & ~x22;
  assign new_n74_ = new_n66_ & x21 & ~x22;
  assign z12 = (x00 & ~x01) | (x09 & ~x24 & ((~new_n76_ & x00) | (~new_n77_ & ~x01)));
