...
module FAU ( 
  ...
  assign z01 = ~x01 & (~x11 | (new_n48_ & ~x00 & ~x02 & x09));
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x01 & (~x11 | (new_n50_ & ~x00 & ~x02 & x09));
  ...
  assign z12 = (~x01 & ~x11) | (x09 & ~x24 & (new_n69_ | new_n70_));
  assign new_n69_ = x00 & x01 & (~x02 | ~x10);
  assign new_n70_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = ~x01 & (~x11 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (~x11 | (new_n50_ & ~x00 & ~x02 & ~x09));
