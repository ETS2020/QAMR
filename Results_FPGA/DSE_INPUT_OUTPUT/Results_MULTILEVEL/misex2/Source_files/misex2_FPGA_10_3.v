...
module FAU ( 
  ...
  assign z03 = (x00 & (new_n51_ | x05)) | (new_n52_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = x01 & x02 & ~x09 & x10 & x11 & x12;
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = ~x12 & new_n54_ & ~x11;
  assign new_n54_ = x10 & ~x09 & ~x05 & x02 & x00 & x01;
  assign z05 = x00 & (x05 | (x09 & x10 & x01 & x02));
  ...
  assign z14 = (x00 & x05) | (new_n78_ & ~x00 & ~x01 & ~x02 & ~x09);
