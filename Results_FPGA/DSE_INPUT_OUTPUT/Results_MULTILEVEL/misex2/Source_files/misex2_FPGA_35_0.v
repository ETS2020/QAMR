...
module FAU ( 
  ...
  assign z01 = ~x02 & (~x08 | (new_n48_ & new_n49_ & x10 & ~x17));
  assign new_n48_ = ~x00 & ~x01 & x09;
  assign new_n49_ = ~x18 & ~x19;
  assign z02 = ~x02 & (~x08 | (new_n48_ & new_n49_ & ~x10 & ~x17));
  ...
  assign new_n73_ = x18 & ~x19 & ~x20 & (x02 | x08) & x21;
  assign z12 = (~x02 & ~x08) | (new_n75_ & x09);
  ...
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x02 & (~x08 | (~x01 & x19)));
  assign z16 = ~x00 & x01 & (x02 | x08);
endmodule
