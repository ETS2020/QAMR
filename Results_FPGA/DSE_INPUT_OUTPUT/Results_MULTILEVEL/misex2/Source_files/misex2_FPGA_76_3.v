...
module FAU ( 
  ...
  assign z01 = (x01 & x12) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = (x01 & x12) | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (x01 & x12) | (new_n52_ & ~x00 & ~x01 & ~x02);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = ~new_n54_ & x01;
  assign new_n54_ = ~x12 & (~x00 | ~x02 | x09 | ~x10 | x11);
  assign z05 = ~x12 & x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n57_ & ~x12;
  ...
  assign z10 = (x01 & x12) | (~x00 & (new_n68_ | new_n70_));
