...
module FAU ( 
  ...
  assign z04 = x02 & (new_n55_ | ~x24);
  assign new_n55_ = x00 & x01 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x24 & x10 & x09 & x02 & x00 & x01;
  assign z06 = ~new_n58_ & x02;
  assign new_n58_ = x24 & (~x00 | ~x01 | x09 | ~x10 | ~x11);
  assign z07 = x00 & new_n60_ & x02;
  assign new_n60_ = x24 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = x24 & new_n62_ & x19;
  assign new_n62_ = ~x18 & x17 & ~x08 & ~x07 & new_n63_ & ~x06;
  assign new_n63_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = new_n48_ | (~x00 & ~x21 & ~new_n65_ & ~x22);
  ...
  assign new_n69_ = ~x19 & ~x20 & x21 & ~new_n48_ & x22;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n71_ = x15 & x16 & x20 & ~x21 & ~x22 & x24;
  assign z11 = ~x00 & ~x22 & (new_n74_ | (new_n73_ & x01));
  assign new_n73_ = x18 & ~x19 & ~x20 & ~new_n48_ & x21;
  assign new_n74_ = new_n75_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n75_ = ~x14 & x15 & ~x16 & x20 & ~x21 & x24;
  assign z12 = ~x02 & new_n77_ & x09;
  assign new_n77_ = ~x24 & (x00 ? x01 : (~x01 & (x19 ? x23 : x17)));
  assign z13 = (x02 & ~x24) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10 & x24))) | (~x01 & ~x02 & x19);
  assign z16 = new_n48_ | (~x00 & x01);
  assign z17 = x02 & (~x24 | (~x00 & ~x01));
endmodule
