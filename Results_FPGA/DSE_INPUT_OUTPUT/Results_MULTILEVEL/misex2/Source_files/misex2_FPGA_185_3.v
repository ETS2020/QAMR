...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n54_, new_n55_, new_n57_, new_n58_, new_n59_,
  ...
  assign z08 = (x00 & x01) | (new_n55_ & new_n54_ & ~x00 & ~x01 & x02);
  assign new_n54_ = ~x03 & x04 & ~x05;
  assign new_n55_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = (x01 & (new_n57_ | x00)) | (new_n59_ & new_n58_ & ~x00 & ~x01 & x02);
  assign new_n57_ = x18 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n58_ = ~x11 & x12 & ~x13;
  assign new_n59_ = ~x14 & ~x15 & ~x16 & x20 & ~x21 & ~x22;
  assign z10 = (x01 & (new_n61_ | x00)) | (new_n62_ & new_n58_ & ~x00 & ~x01 & x02);
  assign new_n61_ = x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n62_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = ~x00 & ~x22 & (new_n64_ | (new_n65_ & new_n66_));
  assign new_n64_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x00 ? x01 : (new_n68_ & ~x01);
  assign new_n68_ = x09 & ~x24 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = (x00 & x01) | (new_n71_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n71_ = ~x10 & ~x17 & ~x18 & ~x19;
