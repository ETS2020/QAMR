...
module FAU ( 
  ...
  assign z04 = (~x01 & ~x16) | (new_n54_ & x00 & x01 & x02);
  ...
  assign new_n58_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | ~x16);
  assign z08 = x19 & new_n60_ & ~x18;
  assign new_n60_ = x17 & x16 & ~x08 & ~x07 & new_n61_ & ~x06;
  assign new_n61_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (~x01 & ~x16) | (new_n63_ & ~x00 & x01 & x18);
  assign new_n63_ = ~x19 & ~x20 & ~x21 & ~x22;
  assign z10 = ~x00 & (new_n65_ | new_n67_);
  ...
  assign new_n72_ = x16 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
