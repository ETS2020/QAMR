...
module FAU ( 
  ...
  assign z01 = x09 & (x01 | (new_n48_ & ~x00 & ~x02 & x10));
  assign new_n48_ = ~x17 & ~x18 & ~x19;
  assign z02 = x09 & (x01 | (new_n48_ & ~x00 & ~x02 & ~x10));
  assign z03 = (x01 & (x09 | (new_n51_ & x00 & x02))) | (new_n52_ & ~x00 & ~x01 & ~x02);
