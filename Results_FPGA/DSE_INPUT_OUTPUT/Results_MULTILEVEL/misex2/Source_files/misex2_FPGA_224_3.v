...
module FAU ( 
  ...
  assign z01 = (x01 & x22) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & x09;
  assign z03 = (x01 & (new_n51_ | x22)) | (new_n52_ & ~x00 & ~x01 & ~x02);
  ...
  assign z05 = ~x22 & x10 & x09 & x02 & x00 & x01;
  assign z06 = ~new_n57_ & x01;
  assign new_n57_ = ~x22 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x11 | x12 | x22 | x09 | ~x10);
  assign z08 = x19 & new_n61_ & ~x18;
  assign new_n61_ = x17 & ~x08 & ~x07 & ~x06 & new_n62_ & ~x05;
  assign new_n62_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (x01 & x22) | (~x00 & ~x21 & (new_n64_ | new_n66_));
  assign new_n64_ = new_n65_ & ~x14 & ~x15 & ~x16 & x20 & ~x22;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (x01 & x22) | (new_n69_ & new_n68_ & ~x00 & ~x01 & x02);
  assign new_n68_ = ~x11 & x12 & ~x13;
  assign new_n69_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = (x01 & x22) | (~x00 & (new_n71_ | (new_n65_ & new_n72_)));
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n72_ = ~x14 & x15 & ~x16 & x20 & ~x21 & ~x22;
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | x22 | (x02 & x10)) : (new_n75_ | x01);
  assign new_n75_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = (x01 & x22) | (new_n78_ & ~x00 & ~x01 & ~x02 & ~x09);
