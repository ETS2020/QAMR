...
module FAU ( 
  ...
  assign z13 = ~x00 & (~x03 | (~x01 & ~x02 & x17 & ~x19));
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x03 & x19);
  assign z16 = ~x00 & (x01 | ~x03);
