...
module FAU ( 
  ...
  assign z00 = (x01 & ~x03) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  ...
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02 & x03);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign new_n52_ = x11 & x12 & ~x09 & x10;
  assign z04 = x01 & (new_n54_ | ~x03);
  assign new_n54_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x10 & x09 & x03 & x02 & x00 & x01;
  assign z06 = ~new_n57_ & x01;
  assign new_n57_ = x03 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x03 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x03 & (x01 | (new_n61_ & new_n62_));
  assign new_n61_ = ~x00 & x02 & x04 & ~x05 & ~x06;
