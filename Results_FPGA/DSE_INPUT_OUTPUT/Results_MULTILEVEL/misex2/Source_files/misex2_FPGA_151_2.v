...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n55_, new_n58_,
    new_n60_, new_n62_, new_n65_, new_n66_, new_n68_, new_n69_, new_n70_,
  ...
  assign z09 = ~x21 & (new_n65_ | x01);
  assign new_n65_ = new_n66_ & ~x00 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20 & ~x22;
  assign z10 = (x01 & ~x21) | (~x00 & (new_n68_ | (new_n70_ & x01 & x18)));
  assign new_n68_ = new_n69_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n69_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n70_ = ~x19 & ~x20 & x22;
  assign z11 = new_n46_ | (~x00 & ~new_n72_ & ~x22);
  assign new_n72_ = ~new_n73_ & (~new_n74_ | ~x02 | x11 | ~x12 | x13);
  assign new_n73_ = ~x19 & ~x20 & x01 & x18;
