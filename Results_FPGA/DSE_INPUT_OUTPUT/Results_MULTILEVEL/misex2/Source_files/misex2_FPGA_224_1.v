...
module FAU ( 
  ...
  assign z00 = ~x22 & ~x19 & new_n46_ & ~x18;
  assign new_n46_ = ~x17 & x10 & ~x09 & ~x02 & ~x00 & ~x01;
  assign z01 = ~x01 & (x22 | (new_n48_ & ~x00 & ~x02 & x09));
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x22 & ~x19 & new_n50_ & ~x18;
  assign new_n50_ = ~x17 & ~x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z03 = (~x01 & (x22 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  ...
  assign new_n77_ = ~x22 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = ~x22 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x01 & (x22 | (new_n80_ & ~x00 & ~x02 & ~x09));
