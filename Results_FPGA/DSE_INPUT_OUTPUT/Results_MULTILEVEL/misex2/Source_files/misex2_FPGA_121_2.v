...
module FAU ( 
  ...
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02 & x04);
  ...
  assign new_n57_ = x04 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  ...
  assign new_n68_ = new_n69_ & x01 & x04 & x18;
  ...
  assign new_n74_ = x01 & x04 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n76_ & ~x24;
  assign new_n76_ = x00 ? (~x01 | ~x04 | (x02 & x10)) : (new_n77_ | x01);
