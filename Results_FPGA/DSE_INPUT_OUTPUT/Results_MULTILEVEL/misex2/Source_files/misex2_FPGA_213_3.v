...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n51_, new_n53_, new_n56_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n64_, new_n65_, new_n67_, new_n68_, new_n69_,
    new_n71_, new_n72_, new_n73_, new_n75_, new_n76_, new_n79_;
  assign z00 = x10 & (x19 | (new_n46_ & ~x09 & ~x17 & ~x18));
  assign new_n46_ = ~x00 & ~x01 & ~x02;
  assign z01 = x10 & (x19 | (new_n46_ & x09 & ~x17 & ~x18));
  assign z02 = (x10 & x19) | (new_n49_ & ~x18 & ~x19 & ~x10 & ~x17);
  assign new_n49_ = ~x00 & ~x01 & ~x02 & x09;
  assign z03 = (x10 & (new_n51_ | x19)) | (new_n46_ & ~x17 & x18 & ~x19);
  ...
  assign z06 = ~new_n56_ & x10;
  assign new_n56_ = ~x19 & (~x00 | ~x01 | ~x02 | x09 | ~x11);
  assign z07 = (new_n58_ & x00) | (x10 & x19);
  ...
  assign z16 = (x10 & x19) | (~x00 & x01);
  assign z17 = ~x00 & ~x01 & x02 & (~x10 | ~x19);
endmodule
