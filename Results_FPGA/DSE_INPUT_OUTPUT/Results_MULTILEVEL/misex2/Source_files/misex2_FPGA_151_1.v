...
module FAU ( 
  ...
  assign z14 = ~x01 & (x21 | (new_n46_ & new_n47_ & ~x10 & ~x17));
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & ~x21))) | (~x01 & ~x02 & x19 & ~x21);
  assign z16 = ~x00 & x01;
