...
module FAU ( 
  ...
  assign z02 = (x01 & x04) | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (new_n52_ & ~x00 & ~x01 & ~x02) | (new_n53_ & x00 & x01 & x02 & ~x04);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = x11 & x12 & ~x09 & x10;
  assign z04 = ~x12 & new_n55_ & ~x11;
  assign new_n55_ = x10 & ~x09 & ~x04 & x02 & x00 & x01;
  assign z05 = x10 & x09 & ~x04 & x02 & x00 & x01;
  assign z06 = ~new_n58_ & x01;
  assign new_n58_ = ~x04 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (x04 | x09 | ~x10 | ~x11 | x12);
  assign z08 = x04 & (new_n62_ | x01);
  assign new_n62_ = new_n63_ & ~x00 & x02 & ~x03 & ~x05 & ~x06;
  assign new_n63_ = ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = (x01 & x04) | (~x00 & ~x21 & ~new_n65_ & ~x22);
  assign new_n65_ = ~new_n67_ & (~new_n66_ | x01 | ~x02 | x11 | ~x12);
  assign new_n66_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (x01 & x04) | (~x00 & (new_n69_ | (new_n70_ & new_n71_)));
