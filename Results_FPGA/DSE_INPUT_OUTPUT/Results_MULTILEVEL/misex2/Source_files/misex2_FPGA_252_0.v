...
module FAU ( 
  ...
  assign z04 = z08 | (new_n54_ & ~x09 & x10 & ~x11 & ~x12);
  assign new_n54_ = x00 & x01 & x02;
  assign z08 = ~x01 & ~x08;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = z08 | (new_n54_ & ~x09 & x10 & x11);
  ...
  assign new_n66_ = ~x01 & x02 & x08 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n69_ | new_n71_);
  assign new_n69_ = new_n70_ & ~x01 & x02 & x08 & ~x11 & x12;
  ...
  assign z13 = ~x01 & (~x08 | (x17 & ~x19 & ~x00 & ~x02));
