...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n57_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n66_, new_n67_, new_n69_, new_n70_, new_n73_;
  ...
  assign z03 = (~x00 & (new_n50_ | x01)) | (new_n51_ & x01 & x02 & ~x09);
  assign new_n50_ = ~x02 & ~x17 & x18 & ~x19;
  ...
  assign z07 = x00 ? (x02 & (new_n57_ | ~x01)) : x01;
  assign new_n57_ = x11 & ~x12 & ~x09 & x10;
  assign z08 = ~x00 & (new_n59_ | x01);
  assign new_n59_ = new_n60_ & x02 & ~x03 & x04 & ~x05 & ~x06;
  assign new_n60_ = ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = ~x22 & ~x21 & x20 & ~x16 & new_n62_ & ~x15;
  assign new_n62_ = new_n63_ & ~x14;
  assign new_n63_ = ~x13 & x12 & ~x11 & x02 & ~x00 & ~x01;
  ...
  assign z12 = (~x00 & x01) | (x09 & ~x24 & ((~new_n69_ & x01) | (~new_n70_ & ~x00)));
  assign new_n69_ = x02 & x10;
  assign new_n70_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x00 & (new_n73_ | x01);
  assign new_n73_ = ~x02 & ~x09 & ~x10 & ~x17 & ~x18 & ~x19;
