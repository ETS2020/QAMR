...
module FAU ( 
  ...
  assign z07 = (x00 & x02 & (new_n58_ | ~x01)) | (~x01 & ~x14);
  assign new_n58_ = x11 & ~x12 & ~x09 & x10;
  assign z08 = ~x01 & (~x14 | (new_n60_ & new_n61_));
  ...
  assign z10 = (~x01 & ~x14) | (new_n65_ & ~x00 & x01 & x18);
  assign new_n65_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x22 & new_n63_ & x21;
  assign z12 = x09 & ~x24 & (x00 ? new_n68_ : new_n69_);
  assign new_n68_ = x01 & (~x02 | ~x10);
  assign new_n69_ = ~x01 & x14 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
