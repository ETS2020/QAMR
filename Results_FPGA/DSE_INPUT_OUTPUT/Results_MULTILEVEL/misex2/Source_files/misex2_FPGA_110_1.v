...
module FAU ( 
  ...
  assign z08 = ~x22 & x19 & new_n61_ & ~x18;
  assign new_n61_ = x17 & ~x08 & ~x07 & ~x06 & new_n62_ & ~x05;
  assign new_n62_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (~x01 & x22) | (~x00 & ~new_n64_ & ~x21);
  assign new_n64_ = ~new_n66_ & (~new_n65_ | x01 | ~x02 | x11 | ~x12);
  assign new_n65_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = x01 & x18 & ~x19 & ~x20 & ~x22;
  assign z10 = (~x01 & x22) | (~x00 & (new_n68_ | new_n70_));
  assign new_n68_ = new_n69_ & ~x14 & x15 & x16 & x20 & ~x21;
  ...
  assign new_n76_ = ~x22 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
