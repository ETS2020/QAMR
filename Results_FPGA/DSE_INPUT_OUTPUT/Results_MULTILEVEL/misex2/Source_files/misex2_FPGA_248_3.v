...
module FAU ( 
  ...
  assign z05 = x01 & (x04 | (x09 & x10 & x00 & x02));
  assign z06 = new_n57_ & x11;
  assign new_n57_ = x10 & ~x09 & ~x04 & x02 & x00 & x01;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (x04 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n75_ = x00 ? (~x01 | x04 | (x02 & x10)) : (new_n76_ | x01);
