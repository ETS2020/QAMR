...
module FAU ( 
  ...
  assign new_n51_ = x11 & (x00 | x01 | x02 | x17 | ~x18);
  ...
  assign new_n71_ = x20 & ~x21 & ~x22 & x15 & x16 & x19;
  assign z11 = (~x11 & ~x19) | (~x00 & ~x22 & (new_n73_ | new_n75_));
  ...
  assign new_n77_ = (~x02 | ~x10) & (x11 | x19);
  assign new_n78_ = (~x19 | ~x23) & (~x11 | (x02 ? ~x23 : (~x17 | x19)));
  assign z13 = ~x19 & (~x11 | (~x00 & ~x01 & ~x02 & x17));
  assign z14 = ~x19 & ~x18 & ~x17 & x11 & new_n46_ & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x11 & ~x19) | (~x01 & ~x02 & x19);
  assign z16 = (~x00 & x01) | (~x11 & ~x19);
