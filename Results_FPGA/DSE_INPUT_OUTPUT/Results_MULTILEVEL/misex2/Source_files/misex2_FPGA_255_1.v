...
module FAU ( 
  ...
  assign z07 = (x00 & x02 & (new_n58_ | ~x01)) | (~x01 & x04);
  assign new_n58_ = ~x09 & x10 & x11 & ~x12;
  assign z09 = (~x01 & x04) | (~x00 & ~x21 & ~new_n60_ & ~x22);
  ...
  assign new_n65_ = ~x01 & x02 & ~x04 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n68_ | new_n70_);
  assign new_n68_ = new_n69_ & ~x01 & x02 & ~x04 & ~x11 & x12;
  ...
  assign new_n73_ = ~x04 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (x04 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & new_n76_ & ~x17;
  assign new_n76_ = ~x10 & ~x09 & ~x04 & ~x02 & ~x00 & ~x01;
  assign z15 = (x00 & ((~x02 & ~x04) | (x01 & (~x02 | ~x10)))) | (~x04 & x19 & ~x01 & ~x02);
  assign z16 = ~x00 & x01;
