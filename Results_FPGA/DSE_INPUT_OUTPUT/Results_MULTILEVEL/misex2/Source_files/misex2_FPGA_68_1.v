...
module FAU ( 
  ...
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19 & (x13 | ~x21);
  assign z03 = new_n46_ | new_n52_ | (new_n53_ & x00 & x01 & x02);
  ...
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (x13 | ~x21);
  ...
  assign z09 = new_n46_ | (~x00 & ~x22 & (new_n67_ | (new_n65_ & new_n66_)));
  ...
  assign new_n69_ = x01 & x13 & x18;
  assign new_n70_ = x21 & x22 & ~x19 & ~x20;
  assign new_n71_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n72_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n46_ | (~x00 & ~x22 & (new_n75_ | (new_n65_ & new_n74_)));
  assign new_n74_ = ~x13 & ~x14 & x15 & ~x16 & x20;
  assign new_n75_ = ~x19 & ~x20 & x21 & x01 & x18;
  assign z12 = x09 & ~x24 & ~new_n46_ & (new_n77_ | new_n78_);
