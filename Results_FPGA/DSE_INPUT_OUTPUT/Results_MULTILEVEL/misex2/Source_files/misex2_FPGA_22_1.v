...
module FAU ( 
  ...
  assign z00 = ~x01 & (x13 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x19 & ~x18 & new_n48_ & ~x17;
  assign new_n48_ = ~x13 & x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x01 & (x13 | (new_n50_ & ~x00 & ~x02 & x09));
  ...
  assign z06 = (~x01 & x13) | (new_n58_ & x00 & x01 & x02);
  assign new_n58_ = ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x13);
  assign z08 = x19 & ~x18 & new_n62_ & x17;
  assign new_n62_ = ~x13 & ~x08 & ~x07 & ~x06 & new_n63_ & ~x05;
  assign new_n63_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (~x01 & x13) | (~x00 & ~x21 & ~new_n65_ & ~x22);
  ...
  assign new_n77_ = ~x13 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (x13 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (x13 | (new_n50_ & ~x00 & ~x02 & ~x09));
