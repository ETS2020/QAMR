...
module FAU ( 
  ...
  assign z03 = new_n53_ | (x10 & (new_n52_ | x07));
  ...
  assign new_n58_ = ~x07 & (~x00 | ~x01 | ~x02 | x09 | ~x11);
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | (x07 & x10)) & (x07 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z11 = new_n49_ | (~x00 & ~x22 & (new_n73_ | new_n74_));
  ...
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~new_n49_ & ~x19;
  assign z14 = new_n49_ | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = (~x02 & (~x07 | ~x10) & (x00 | (~x01 & x19))) | (x00 & x01 & ~x10);
