...
module FAU ( 
  ...
  assign new_n61_ = ~x01 & x02 & x07 & ~x11 & x12;
  ...
  assign z11 = z08 | (~x00 & ~x22 & (new_n69_ | (new_n66_ & new_n70_)));
  ...
  assign new_n73_ = ~x01 & x07 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x17 & x07 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & new_n76_ & ~x17;
  assign new_n76_ = ~x10 & ~x09 & x07 & ~x02 & ~x00 & ~x01;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x07))) | (~x01 & ~x02 & x07 & x19);
