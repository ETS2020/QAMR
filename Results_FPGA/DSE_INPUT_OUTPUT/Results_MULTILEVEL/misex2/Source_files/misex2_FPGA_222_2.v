...
module FAU ( 
  ...
  assign z01 = (x00 & ~x03) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x19 & new_n50_ & ~x18;
  assign new_n50_ = ~x17 & ~x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z03 = (x00 & (new_n52_ | ~x03)) | (new_n53_ & ~x00 & ~x01 & ~x02);
  assign new_n52_ = x01 & x02 & ~x09 & x10 & x11 & x12;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = ~x12 & new_n55_ & ~x11;
  assign new_n55_ = x10 & ~x09 & x03 & x02 & x00 & x01;
  assign z05 = x00 & (~x03 | (x09 & x10 & x01 & x02));
  assign z06 = ~new_n58_ & x00;
  assign new_n58_ = x03 & (~x01 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & (new_n60_ | ~x03);
  assign new_n60_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = ~x03 & (x00 | (new_n62_ & new_n63_));
  assign new_n62_ = ~x01 & x02 & x04 & ~x05 & ~x06;
  assign new_n63_ = ~x07 & ~x08 & x17 & ~x18 & x19;
  ...
  assign z10 = x00 ? ~x03 : (new_n69_ | (new_n70_ & new_n71_));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = x00 ? ~x03 : (~x22 & (new_n73_ | (new_n70_ & new_n74_)));
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n74_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = (x00 & ~x03) | (x09 & ~x24 & (x00 ? new_n76_ : new_n77_));
  assign new_n76_ = x01 & (~x02 | ~x10);
  assign new_n77_ = ~x01 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = (x00 & ~x03) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & x03 & (~x02 | (x01 & ~x10))) | (~x00 & ~x01 & ~x02 & x19);
  assign z16 = x00 ? ~x03 : x01;
  assign z17 = x00 ? ~x03 : (~x01 & x02);
endmodule
