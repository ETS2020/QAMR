...
module FAU ( 
  ...
  assign new_n72_ = ~x04 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (x04 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & new_n75_ & ~x17;
  assign new_n75_ = ~x10 & ~x09 & ~x04 & ~x02 & ~x00 & ~x01;
