...
module FAU ( 
  ...
  assign z03 = (~x01 & (new_n51_ | x12)) | (new_n52_ & x10 & x11 & x12);
  assign new_n51_ = ~x00 & ~x02 & ~x17 & x18 & ~x19;
  ...
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x00 & x02;
  ...
  assign z11 = (~x01 & x12) | (new_n66_ & ~x00 & x01 & x18);
