...
module FAU ( 
  ...
  assign z04 = x13 & new_n54_ & ~x12;
  assign new_n54_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x13 & x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n57_ & x13;
  assign new_n57_ = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (x09 | ~x10 | ~x11 | x12 | ~x13);
  assign z08 = (x01 & ~x13) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  assign new_n61_ = ~x03 & x04 & ~x05;
  assign new_n62_ = x17 & ~x18 & x19 & ~x06 & ~x07 & ~x08;
  assign z09 = (x01 & ~x13) | (~x00 & ~x21 & ~new_n64_ & ~x22);
  assign new_n64_ = ~new_n66_ & (~new_n65_ | ~x12 | x13 | ~x02 | x11);
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (x01 & ~x13) | (~x00 & (new_n68_ | new_n70_));
  ...
  assign new_n74_ = x01 & x13 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n76_ & ~x24;
  assign new_n76_ = x00 ? (~x01 | ~x13 | (x02 & x10)) : (new_n77_ | x01);
