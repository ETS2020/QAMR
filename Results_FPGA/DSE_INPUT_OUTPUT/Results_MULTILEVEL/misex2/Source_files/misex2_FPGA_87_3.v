...
module FAU ( 
  ...
  assign z03 = (~x00 & ~x01 & new_n52_ & ~x02) | (new_n53_ & x00 & x01 & x02 & ~x04);
  assign new_n52_ = ~x17 & x18 & ~x19 & (~x04 | ~x12);
