...
module FAU ( 
  ...
  assign new_n64_ = ~x08 & x17 & ~x18 & x19 & (~x16 | x22);
  assign z09 = ~x22 & (x16 | (~x00 & ~new_n66_ & ~x21));
  assign new_n66_ = ~new_n68_ & (~new_n67_ | x13 | x14 | x15 | ~x20);
  assign new_n67_ = ~x01 & x02 & ~x11 & x12;
  assign new_n68_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = new_n70_ & x22;
  assign new_n70_ = x21 & ~x20 & ~x19 & x18 & ~x00 & x01;
  assign z11 = ~x00 & ~x16 & ~x22 & (new_n72_ | new_n73_);
  assign new_n72_ = new_n67_ & ~x13 & ~x14 & x15 & x20 & ~x21;
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & ~new_n75_ & ~new_n46_;
