...
module FAU ( 
  ...
  assign z04 = ~x23 & new_n54_ & ~x12;
  assign new_n54_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = ~x23 & x10 & x09 & x02 & x00 & x01;
  assign z06 = ~new_n57_ & x01;
  assign new_n57_ = ~x23 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (x09 | ~x10 | ~x11 | x12 | x23);
  assign z08 = (x01 & x23) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  ...
  assign z10 = (x01 & x23) | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  assign new_n68_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n69_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = ~x00 & ~x22 & (new_n73_ | (new_n69_ & new_n72_));
  assign new_n72_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21 & ~x23;
  assign z12 = (x01 & x23) | (x09 & ~x24 & (new_n75_ | new_n76_));
  assign new_n75_ = x00 & x01 & (~x02 | ~x10);
  assign new_n76_ = ~x00 & ((x23 & (x02 | x19)) | (~x01 & ~x02 & x17 & ~x19));
  assign z13 = (x01 & x23) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (x01 & x23) | (new_n79_ & ~x02 & ~x09 & ~x00 & ~x01);
