...
module FAU ( 
  ...
  assign z00 = z06 | (new_n47_ & x10 & ~x17 & ~x18 & ~x19);
  assign z06 = x00 & x01;
  assign new_n47_ = ~x00 & ~x01 & ~x02 & ~x09;
  assign z01 = ~x19 & ~x18 & ~x17 & x10 & new_n49_ & x09;
  assign new_n49_ = ~x02 & ~x00 & ~x01;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & x09;
  assign z03 = ~x19 & x18 & new_n49_ & ~x17;
  ...
  assign z10 = (x01 & (new_n61_ | x00)) | (new_n63_ & new_n62_ & ~x00 & ~x01 & x02);
  ...
  assign z14 = z06 | (new_n47_ & ~x18 & ~x19 & ~x10 & ~x17);
