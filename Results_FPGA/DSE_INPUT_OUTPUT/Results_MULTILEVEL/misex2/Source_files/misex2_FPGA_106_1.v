...
module FAU ( 
  ...
  assign z00 = (~x15 & x19) | (new_n46_ & x10 & ~x17 & ~x18 & ~x19);
  assign new_n46_ = ~x00 & ~x01 & ~x02 & ~x09;
  assign z01 = (~x15 & x19) | (new_n48_ & x10 & ~x17 & ~x18 & ~x19);
  ...
  assign new_n53_ = ~x15 & x19;
  assign new_n54_ = ~x17 & x18 & ~x19;
  assign z04 = new_n53_ | (new_n56_ & ~x11 & ~x12 & ~x09 & x10);
  assign new_n56_ = x00 & x01 & x02;
  assign z05 = new_n53_ | (x00 & x01 & x02 & x09 & x10);
  ...
  assign z09 = new_n53_ | (~x00 & ~x21 & ~new_n65_ & ~x22);
