...
module FAU ( 
  ...
  assign z03 = (x02 & (new_n52_ | x22)) | (new_n53_ & ~x00 & ~x01 & ~x02);
  assign new_n52_ = x00 & x01 & ~x09 & x10 & x11 & x12;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = ~x22 & new_n55_ & ~x12;
  assign new_n55_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x02 & (x22 | (x00 & x01 & x09 & x10));
  assign z06 = ~new_n58_ & x02;
  assign new_n58_ = ~x22 & (~x00 | ~x01 | x09 | ~x10 | ~x11);
  assign z07 = x02 & (new_n60_ | x22);
  assign new_n60_ = x00 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = ~x22 & x19 & new_n62_ & ~x18;
  assign new_n62_ = x17 & ~x08 & ~x07 & ~x06 & new_n63_ & ~x05;
  assign new_n63_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = new_n46_ | (~x00 & ~new_n65_ & ~x21);
  ...
  assign new_n69_ = new_n70_ & x01 & ~x02 & x18;
  ...
  assign new_n77_ = x00 ? (~x01 | (x02 & (x10 | x22))) : (new_n78_ | x01);
  assign new_n78_ = x02 ? (x22 | ~x23) : (x19 ? ~x23 : ~x17);
  assign z13 = (x02 & x22) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = new_n46_ | (new_n47_ & ~x18 & ~x19 & ~x10 & ~x17);
  assign z15 = (x00 & (~x02 | (x01 & ~x10 & ~x22))) | (~x01 & ~x02 & x19);
