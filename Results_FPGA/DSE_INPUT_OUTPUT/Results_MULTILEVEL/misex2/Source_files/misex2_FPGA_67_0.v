...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n66_, new_n68_, new_n69_, new_n72_;
  ...
  assign z07 = (~x01 & ~x11) | (x00 & x02 & (~x01 | (new_n58_ & x11 & ~x12)));
  ...
  assign z14 = ~x19 & ~x18 & new_n72_ & ~x17;
  assign new_n72_ = x11 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
