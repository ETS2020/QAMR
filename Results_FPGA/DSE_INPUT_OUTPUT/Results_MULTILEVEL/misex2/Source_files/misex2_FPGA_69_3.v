// Benchmark "FAU" written by ABC on Tue Aug 18 17:00:30 2020
...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n52_ | x06)) | (new_n53_ & ~x00 & ~x01 & ~x02);
  ...
  assign z05 = x01 & (x06 | (x09 & x10 & x00 & x02));
  assign z06 = ~new_n58_ & x01;
  assign new_n58_ = ~x06 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (x06 | x09 | ~x10 | ~x11 | x12);
