...
module FAU ( 
  ...
  assign z10 = ~x00 & ~x19 & (new_n69_ | (new_n70_ & new_n71_));
  assign new_n69_ = x01 & x18 & ~x20 & x21 & x22;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n52_ | (~x00 & ~x22 & (new_n73_ | new_n74_));
  ...
  assign z13 = (x15 & x19) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & ((~x02 & (~x19 | (x01 & ~x15))) | (x01 & ~x10 & (~x15 | ~x19)))) | (~x01 & ~x02 & ~x15 & x19);
