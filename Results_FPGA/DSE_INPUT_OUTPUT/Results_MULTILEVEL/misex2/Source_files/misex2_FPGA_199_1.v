...
module FAU ( 
  ...
  assign z06 = (~x01 & x15) | (new_n57_ & x00 & x01 & x02);
  ...
  assign new_n61_ = x17 & ~x15 & ~x08 & ~x07 & new_n62_ & ~x06;
  ...
  assign new_n67_ = ~x01 & x15;
  assign z10 = new_n67_ | (new_n69_ & ~x19 & ~x20 & x21 & x22);
  assign new_n69_ = ~x00 & x01 & x18;
  assign z11 = new_n67_ | (new_n69_ & ~x19 & ~x20 & x21 & ~x22);
  assign z12 = new_n67_ | (new_n72_ & x09);
  ...
  assign z14 = ~x01 & (x15 | (new_n76_ & ~x00 & ~x02 & ~x09));
  assign new_n76_ = ~x18 & ~x19 & ~x10 & ~x17;
