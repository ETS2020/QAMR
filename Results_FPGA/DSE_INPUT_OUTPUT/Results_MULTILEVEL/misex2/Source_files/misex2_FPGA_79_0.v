...
module FAU ( 
  ...
  assign new_n68_ = new_n69_ & ~x01 & x02 & x08 & ~x11 & x12;
  assign new_n69_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (~x01 & ~x08) | (new_n72_ & x09);
