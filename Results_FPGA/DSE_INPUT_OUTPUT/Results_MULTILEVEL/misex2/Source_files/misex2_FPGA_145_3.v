...
module FAU ( 
  ...
  assign z09 = (~new_n56_ & x01) | (new_n57_ & new_n58_);
  assign new_n56_ = ~x00 & (~x18 | x19 | x20 | x21 | x22);
  assign new_n57_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  ...
  assign z11 = ~x00 & ~x22 & (new_n63_ | new_n65_);
