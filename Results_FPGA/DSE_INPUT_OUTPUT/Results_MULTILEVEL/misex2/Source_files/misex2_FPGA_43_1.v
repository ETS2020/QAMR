...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n56_, new_n58_, new_n61_, new_n63_,
    new_n64_, new_n67_, new_n68_, new_n71_;
  ...
  assign z07 = x00 ? (x02 & (new_n56_ | ~x01)) : x01;
  assign new_n56_ = ~x09 & x10 & x11 & ~x12;
  assign z08 = x19 & ~x18 & x17 & new_n58_ & ~x08;
  assign new_n58_ = ~x07 & ~x06 & ~x05 & x04 & z17 & ~x03;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = ~x22 & ~x21 & x20 & ~x16 & new_n61_ & ~x15;
  assign new_n61_ = ~x14 & ~x13 & x12 & z17 & ~x11;
  assign z10 = ~x00 & (new_n63_ | x01);
  assign new_n63_ = new_n64_ & x12 & ~x13 & ~x14 & x02 & ~x11;
  assign new_n64_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x22 & ~x21 & x20 & ~x16 & new_n61_ & x15;
  assign z12 = (~x00 & x01) | (x09 & ~x24 & ((~new_n68_ & ~x00) | (~new_n67_ & x01)));
