...
module FAU ( 
  ...
  assign z02 = (x01 & x23) | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (x01 & (new_n52_ | x23)) | (new_n53_ & ~x00 & ~x01 & ~x02);
  assign new_n52_ = x00 & x02 & ~x09 & x10 & x11 & x12;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n55_ | x23);
  assign new_n55_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = ~x23 & x10 & x09 & x02 & x00 & x01;
  assign z06 = ~new_n58_ & x01;
  assign new_n58_ = ~x23 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = (x01 & x23) | (x00 & x02 & (new_n60_ | ~x01));
  assign new_n60_ = ~x09 & x10 & x11 & ~x12;
  assign z08 = (x01 & x23) | (new_n63_ & new_n62_ & ~x00 & ~x01 & x02);
  ...
  assign new_n67_ = x01 & x18 & ~x19 & ~x20 & ~x23;
  ...
  assign new_n71_ = x01 & x18 & ~x19;
  assign new_n72_ = ~x20 & x21 & x22 & ~x23;
  assign z11 = new_n74_ | (~x00 & ~x22 & (new_n75_ | (new_n69_ & new_n76_)));
  assign new_n74_ = x01 & x23;
  assign new_n75_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n76_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n78_ & x01) : (~new_n79_ & ~x01));
  assign new_n78_ = ~x23 & (~x02 | ~x10);
  assign new_n79_ = (~x17 | (~x23 & (x02 | x19))) & (~x23 | (~x02 & ~x19));
