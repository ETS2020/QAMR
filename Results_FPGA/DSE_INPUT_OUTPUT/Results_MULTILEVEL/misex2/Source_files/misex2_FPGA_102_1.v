...
module FAU ( 
  ...
  assign new_n48_ = ~x11 & x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x02 & (x11 | (new_n50_ & ~x00 & ~x01 & x09));
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (~x02 & (new_n52_ | x11)) | (new_n53_ & x10 & x11 & x12);
  assign new_n52_ = ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign new_n53_ = x00 & x01 & ~x09;
  assign z04 = (~x02 & x11) | (x00 & x01 & x02 & new_n55_ & ~x11 & ~x12);
  assign new_n55_ = ~x09 & x10;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = (~x02 & x11) | (x00 & ((~x01 & x02) | (new_n55_ & x11 & ~x12)));
