...
module FAU ( 
  ...
  assign z09 = new_n58_ | (new_n60_ & new_n61_ & ~x14 & ~x15 & ~x16);
  assign new_n58_ = x01 & (x00 | (new_n59_ & ~x20 & ~x21 & ~x22));
  assign new_n59_ = x18 & ~x19;
  assign new_n60_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n61_ = x20 & ~x21 & ~x22;
  assign z10 = new_n63_ | (new_n60_ & new_n61_ & ~x14 & x15 & x16);
  assign new_n63_ = x01 & (x00 | (new_n59_ & ~x20 & x21 & x22));
  assign z11 = new_n65_ | (new_n60_ & new_n61_ & ~x14 & x15 & ~x16);
  assign new_n65_ = x01 & (x00 | (new_n59_ & ~x20 & x21 & ~x22));
