...
module FAU ( 
  ...
  assign new_n63_ = x01 & x11 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ((new_n65_ & new_n66_) | (new_n67_ & new_n68_));
  assign new_n65_ = x01 & x11 & x18;
  assign new_n66_ = ~x19 & ~x20 & x21 & x22;
  assign new_n67_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n70_ | (~x00 & ~x22 & (new_n71_ | (new_n72_ & new_n73_)));
  ...
  assign z12 = new_n70_ | (x09 & ~x24 & (new_n75_ | new_n76_));
