...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n51_ | ~x07)) | (new_n52_ & ~x00 & ~x01 & ~x02);
  ...
  assign new_n57_ = x07 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x07 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z11 = (x01 & ~x07) | (~x00 & ~x22 & (new_n73_ | new_n74_));
