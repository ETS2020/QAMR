...
module FAU ( 
  ...
  assign z05 = x01 & (~x13 | (x00 & x02 & x09 & x10));
  assign z06 = new_n58_ & x13;
  assign new_n58_ = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (x09 | ~x10 | ~x11 | x12 | ~x13);
  ...
  assign new_n65_ = ~new_n67_ & (~new_n66_ | ~x02 | x11 | ~x12 | x13);
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = new_n48_ | (~x00 & (new_n69_ | new_n71_));
  ...
  assign z12 = new_n48_ | (new_n77_ & x09);
  ...
  assign z15 = (~x02 & ((x00 & (~x01 | x13)) | (~x01 & x19))) | (x00 & x01 & ~x10 & x13);
