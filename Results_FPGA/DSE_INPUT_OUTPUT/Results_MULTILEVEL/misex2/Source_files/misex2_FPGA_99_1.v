...
module FAU ( 
  ...
  assign z02 = ~x10 & (x15 | (new_n50_ & ~x00 & ~x01 & ~x02));
  ...
  assign z06 = (~x10 & x15) | (new_n58_ & ~x09 & x10 & x11);
  ...
  assign new_n76_ = x00 ? (~x01 | (x10 ? x02 : x15)) : (x01 | new_n77_ | (~x10 & x15));
  assign new_n77_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~new_n46_ & ~x19;
  assign z14 = ~x19 & ~x18 & new_n80_ & ~x17;
  assign new_n80_ = ~x15 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
  assign z15 = (~x02 & ((x00 & (x10 | (~x01 & ~x15))) | (~x01 & x19 & (x10 | ~x15)))) | (x00 & x01 & ~x10 & ~x15);
