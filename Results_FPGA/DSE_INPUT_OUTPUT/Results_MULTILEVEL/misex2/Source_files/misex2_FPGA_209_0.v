...
module FAU ( 
  ...
  assign new_n53_ = ~x08 & ~x17;
  assign new_n54_ = x08 & ~x17 & x18 & ~x19;
  assign z04 = new_n53_ | (new_n56_ & ~x09 & x10 & ~x11 & ~x12);
  assign new_n56_ = x00 & x01 & x02;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n53_ & x10;
  assign z06 = new_n53_ | (new_n56_ & ~x09 & x10 & x11);
  assign z07 = new_n53_ | (new_n60_ & x00);
  ...
  assign new_n76_ = ~new_n53_ & (~x02 | ~x10);
  assign new_n77_ = (~x23 | (~x17 & (~x08 | (~x02 & ~x19)))) & (x02 | ~x17 | x19);
  assign z13 = (~x08 & ~x17) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x17 & (~x08 | (new_n46_ & new_n47_ & ~x09 & ~x10));
