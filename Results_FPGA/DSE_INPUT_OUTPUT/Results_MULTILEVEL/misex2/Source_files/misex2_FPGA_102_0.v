...
module FAU ( 
  ...
  assign z03 = (~x02 & (~x11 | (new_n54_ & ~x00 & ~x01))) | (new_n52_ & x00 & x01 & x02);
  assign new_n52_ = new_n53_ & x11 & x12;
  assign new_n53_ = ~x09 & x10;
  assign new_n54_ = ~x17 & x18 & ~x19;
  assign z04 = ~new_n56_ & ~x11;
  assign new_n56_ = x02 & (~x00 | ~x01 | x09 | ~x10 | x12);
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = (x00 & x02 & (~x01 | (new_n53_ & x11 & ~x12))) | (~x02 & ~x11);
  ...
  assign z15 = (x00 & ((~x02 & x11) | (x01 & x02 & ~x10))) | (~x01 & ~x02 & x11 & x19);
