...
module FAU ( 
  ...
  assign z06 = (~x01 & x15) | (new_n58_ & x00 & x01 & x02);
  assign new_n58_ = ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x15);
  assign z08 = x19 & new_n62_ & ~x18;
  assign new_n62_ = x17 & ~x08 & ~x07 & new_n63_ & ~x06 & ~x15;
  ...
  assign z10 = new_n69_ | (new_n70_ & ~x19 & ~x20 & x21 & x22);
  assign new_n69_ = ~x01 & x15;
  assign new_n70_ = ~x00 & x01 & x18;
  assign z11 = new_n69_ | (new_n70_ & ~x19 & ~x20 & x21 & ~x22);
  assign z12 = new_n69_ | (new_n73_ & x09);
