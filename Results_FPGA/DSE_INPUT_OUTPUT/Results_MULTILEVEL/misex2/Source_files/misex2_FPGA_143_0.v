...
module FAU ( 
  ...
  assign z01 = ~x17 & (~x05 | (new_n48_ & ~x00 & ~x01 & ~x02));
  assign new_n48_ = x09 & x10 & ~x18 & ~x19;
  ...
  assign new_n54_ = x05 & ~x17 & x18 & ~x19;
  ...
  assign new_n59_ = x02 & ~x09 & x10 & ~new_n53_ & x11;
  assign z07 = x00 & x02 & ~new_n53_ & ~new_n61_;
  ...
  assign new_n77_ = ~new_n53_ & (~x02 | ~x10);
