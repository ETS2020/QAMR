...
module FAU ( 
  ...
  assign z06 = x10 & (~x01 | (x00 & x02 & ~x09 & x11));
  assign z07 = new_n56_ & x00;
  assign new_n56_ = x02 & ((~x01 & ~x10) | (x01 & ~x09 & x10 & x11 & ~x12));
  ...
  assign new_n66_ = ~x11 & x12 & ~x13 & ~x01 & x02 & ~x10;
  assign new_n67_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = z00 | (~x00 & ~x22 & (new_n69_ | (new_n70_ & new_n71_)));
  ...
  assign new_n73_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~x01 & ~new_n74_ & ~x10));
  assign new_n74_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & ~x10 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x01 & (new_n77_ | x10);
  assign new_n77_ = ~x00 & ~x02 & ~x09 & ~x17 & ~x18 & ~x19;
