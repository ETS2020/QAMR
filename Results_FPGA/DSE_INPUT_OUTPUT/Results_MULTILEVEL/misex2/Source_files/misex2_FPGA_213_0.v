...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
  ...
  assign z02 = ~x10 & ~x19;
  assign z03 = new_n50_ | (new_n52_ & ~x09 & x10 & x11 & x12);
  assign new_n50_ = ~x19 & (~x10 | (new_n51_ & ~x02 & ~x17 & x18));
  ...
  assign z06 = (~x10 & ~x19) | (new_n52_ & ~x09 & x10 & x11);
  assign z07 = z02 | (new_n58_ & x00);
  assign new_n58_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = x19 & ~x18 & x17 & ~x08 & new_n60_ & ~x07;
  assign new_n60_ = ~x06 & ~x05 & x04 & ~x03 & new_n51_ & x02;
  assign z09 = z02 | (~x00 & ~x21 & ~new_n62_ & ~x22);
