...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n57_, new_n59_,
    ...
    new_n70_, new_n72_, new_n73_, new_n75_, new_n78_;
  ...
  assign new_n51_ = ~x19 & ~x23 & ~x17 & x18;
  ...
  assign new_n70_ = x15 & x16 & x20 & ~x21 & ~x22 & ~x23;
  assign z11 = (~x01 & x23) | (~x00 & ~x22 & (new_n72_ | new_n73_));
  assign new_n72_ = new_n65_ & ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (~x01 & x23) | (x09 & ~new_n75_ & ~x24);
  assign new_n75_ = (~x00 | ~x01 | (x02 & x10)) & (x00 | x01 | x02 | ~x17 | x19);
  assign z13 = ~x23 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x23 & ~x19 & new_n78_ & ~x18;
