...
module FAU ( 
  ...
  assign z11 = ~x00 & ~x22 & ~new_n46_ & (new_n74_ | new_n75_);
  assign new_n74_ = new_n71_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n75_ = ~x19 & ~x20 & x21 & x01 & x18;
  assign z12 = ~x24 & (~x23 | (~new_n77_ & x09));
  assign new_n77_ = x00 ? (~x01 | (x02 & x10)) : (x01 | (~x02 & ~x17 & ~x19));
