...
module FAU ( 
  ...
  assign z10 = ~x00 & (new_n69_ | (new_n67_ & new_n70_));
  assign new_n67_ = new_n68_ & ~x01 & x02 & ~x07;
  assign new_n68_ = ~x11 & x12 & ~x13;
  assign new_n69_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (new_n72_ & ~x00) | (~x01 & x07);
  assign new_n72_ = ~x22 & (new_n73_ | (new_n74_ & new_n68_ & ~x01 & x02));
  ...
  assign new_n77_ = ~x07 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
