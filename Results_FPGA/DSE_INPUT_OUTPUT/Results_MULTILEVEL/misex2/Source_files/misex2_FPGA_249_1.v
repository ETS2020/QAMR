...
module FAU ( 
  ...
  assign z00 = ~x01 & (x21 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x21 & ~x19 & new_n48_ & ~x18;
  assign new_n48_ = ~x17 & x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x01 & (x21 | (new_n50_ & ~x00 & ~x02 & x09));
  assign new_n50_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (~x01 & (x21 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  ...
  assign z06 = (~x01 & x21) | (new_n58_ & x00 & x01 & x02);
  assign new_n58_ = ~x09 & x10 & x11;
  assign z07 = (~x01 & x21) | (x00 & x02 & (new_n60_ | ~x01));
  assign new_n60_ = ~x09 & x10 & x11 & ~x12;
  assign z08 = ~x21 & x19 & new_n62_ & ~x18;
  assign new_n62_ = x17 & ~x08 & ~x07 & ~x06 & new_n63_ & ~x05;
  assign new_n63_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n65_ | new_n67_);
  assign new_n65_ = new_n66_ & ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x01 & x02 & ~x11 & x12;
  assign new_n67_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (~x01 & x21) | (~x00 & (new_n69_ | new_n71_));
  assign new_n69_ = new_n70_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x22;
  assign new_n71_ = x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = (~x01 & x21) | (~x00 & ~x22 & (new_n73_ | new_n74_));
  assign new_n73_ = new_n66_ & ~x13 & ~x14 & x15 & ~x16 & x20;
  assign new_n74_ = x18 & ~x19 & ~x20 & x21;
  assign z12 = (~x01 & x21) | (new_n76_ & x09);
  assign new_n76_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n77_ & ~x01));
  assign new_n77_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x21 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x01 & (x21 | (new_n50_ & ~x00 & ~x02 & ~x09));
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & (x21 | (~x02 & x19)));
  assign z16 = x01 ? ~x00 : x21;
  assign z17 = ~x21 & x02 & ~x00 & ~x01;
endmodule
