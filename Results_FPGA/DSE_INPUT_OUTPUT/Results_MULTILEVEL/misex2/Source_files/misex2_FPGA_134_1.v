...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n53_, new_n55_, new_n58_,
    ...
    new_n81_;
  assign z00 = ~x09 & (x20 | (new_n46_ & ~x00 & ~x01 & ~x02));
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = (~x09 & x20) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  ...
  assign new_n58_ = ~x20 & (~x00 | ~x01 | ~x02 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | (~x09 & x20)) & (x09 | ~x10 | ~x11 | x12 | x20);
  assign z08 = new_n52_ | (new_n62_ & new_n63_);
  ...
  assign new_n70_ = ~x11 & x12 & ~x13 & ~x01 & x02 & x09;
  assign new_n71_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = ~x00 & ~x22 & (new_n73_ | new_n75_);
  assign new_n73_ = new_n74_ & ~x01 & x02 & x09 & ~x11 & x12;
  assign new_n74_ = ~x13 & ~x14 & x15 & ~x16 & x20 & ~x21;
  ...
  assign z14 = ~x20 & ~x19 & new_n81_ & ~x18;
