...
module FAU ( 
  ...
  assign new_n46_ = ~x09 & x04 & ~x02 & ~x00 & ~x01;
  assign z01 = ~x19 & ~x18 & new_n48_ & ~x17;
  assign new_n48_ = x10 & x09 & x04 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x01 & (~x04 | (new_n50_ & ~x00 & ~x02 & x09));
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (new_n52_ & ~x00 & ~x01 & ~x02) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = x04 & ~x17 & x18 & ~x19;
  ...
  assign z06 = (~x01 & ~x04) | (new_n58_ & x00 & x01 & x02);
  assign new_n58_ = ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | ~x04) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x01 & (new_n62_ | ~x04);
  ...
  assign z10 = (~x01 & ~x04) | (~x00 & (new_n69_ | new_n71_));
  ...
  assign new_n73_ = new_n74_ & ~x01 & x02 & x04 & ~x11 & x12;
  ...
  assign new_n78_ = x04 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
