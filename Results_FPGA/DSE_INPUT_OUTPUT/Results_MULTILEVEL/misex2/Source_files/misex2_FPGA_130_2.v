...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  assign z02 = ~x10 & (x07 | (new_n49_ & new_n50_ & x09 & ~x17));
  assign new_n49_ = ~x00 & ~x01 & ~x02;
  assign new_n50_ = ~x18 & ~x19;
  assign z03 = new_n54_ | new_n52_ | (new_n49_ & ~x17 & x18 & ~x19);
  ...
  assign z06 = (x07 & ~x10) | (new_n53_ & ~x09 & x10 & x11);
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | (x07 & ~x10)) & (~x11 | x12 | x09 | ~x10);
  assign z08 = (x07 & ~x10) | (new_n62_ & new_n63_ & ~x06 & ~x07 & ~x08);
