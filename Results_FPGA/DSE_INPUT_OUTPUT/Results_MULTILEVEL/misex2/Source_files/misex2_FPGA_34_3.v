...
module FAU ( 
  ...
  wire new_n46_, new_n52_, new_n53_, new_n55_, new_n56_, new_n57_, new_n59_,
    new_n60_, new_n62_, new_n63_, new_n64_, new_n66_, new_n69_;
  ...
  assign z10 = (x01 & (new_n59_ | x00)) | (new_n60_ & new_n56_ & ~x00 & ~x01 & x02);
  assign new_n59_ = x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n60_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = ~x00 & ~x22 & (new_n62_ | (new_n63_ & new_n64_));
