...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n51_ | x14)) | (new_n52_ & ~x00 & ~x01 & ~x02);
  ...
  assign z10 = ~x00 & ~x14 & (new_n68_ | new_n70_);
  assign new_n68_ = new_n69_ & x20 & ~x21 & ~x22 & x15 & x16;
  ...
  assign z14 = (x01 & x14) | (new_n79_ & ~x00 & ~x01 & ~x02 & ~x09);
