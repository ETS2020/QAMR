...
module FAU ( 
  ...
  assign z04 = (~x01 & ~x10) | (new_n51_ & ~x11 & ~x12 & ~x09 & x10);
  assign z05 = (~x01 & ~x10) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = (~x01 & ~x10) | (x00 & x02 & (~x01 | (new_n57_ & ~x09 & x10)));
  assign new_n57_ = x11 & ~x12;
  assign z08 = ~x01 & (~x10 | (new_n59_ & new_n60_));
  ...
  assign new_n67_ = ~x11 & x12 & ~x13 & ~x01 & x02 & x10;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = z02 | (~x00 & ~x22 & (new_n70_ | (new_n71_ & new_n72_)));
  ...
  assign z15 = (x00 & (~x02 | ~x10)) | (~x01 & (~x10 | (~x02 & x19)));
  assign z16 = ~x00 & x01;
