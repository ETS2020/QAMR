...
module FAU ( 
  ...
  assign new_n55_ = ~x09 & x10 & ~x11 & ~x12 & (~x21 | x23);
  assign z05 = x00 & x01 & x02 & x09 & ~new_n46_ & x10;
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (~x21 | x23);
  ...
  assign new_n76_ = (~x21 | x23) & (~x02 | ~x10);
  assign new_n77_ = (~x17 | (~x23 & (x02 | x19 | x21))) & (~x23 | (~x02 & ~x19));
