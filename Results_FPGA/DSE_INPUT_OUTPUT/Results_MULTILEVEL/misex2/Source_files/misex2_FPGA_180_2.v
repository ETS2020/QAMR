...
module FAU ( 
  ...
  assign z09 = new_n48_ | (~x00 & ~x21 & ~new_n62_ & ~x22);
  assign new_n62_ = ~new_n64_ & (~new_n63_ | ~x02 | x11 | ~x12 | x13);
  assign new_n63_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n64_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n66_ | (new_n68_ & new_n69_));
  assign new_n66_ = new_n67_ & x01 & x11 & x18;
  ...
  assign new_n72_ = x01 & x11 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | ~x11 | (x02 & x10)) : (new_n75_ | x01);
