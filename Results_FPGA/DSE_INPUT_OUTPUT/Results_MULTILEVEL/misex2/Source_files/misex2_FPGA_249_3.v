...
module FAU ( 
  ...
  assign new_n58_ = ~x21 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  ...
  assign z10 = new_n69_ | (new_n70_ & new_n71_ & ~x14 & x15 & x16);
  assign new_n69_ = x01 & x21;
  assign new_n70_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = x20 & ~x21 & ~x22;
  assign z11 = new_n69_ | (new_n70_ & new_n71_ & ~x14 & x15 & ~x16);
  assign z12 = new_n69_ | (new_n74_ & x09);
