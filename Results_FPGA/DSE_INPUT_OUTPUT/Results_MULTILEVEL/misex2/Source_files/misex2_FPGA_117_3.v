...
module FAU ( 
  ...
  assign z01 = (x01 & x06) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  ...
  assign z05 = x01 & (x06 | (x00 & x02 & x09 & x10));
  assign z06 = ~new_n57_ & x01;
  assign new_n57_ = ~x06 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = (x01 & x06) | (x00 & x02 & (new_n59_ | ~x01));
  assign new_n59_ = ~x09 & x10 & x11 & ~x12;
  assign z08 = (x01 & x06) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  assign new_n61_ = ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = (x01 & x06) | (~x00 & ~x21 & ~new_n64_ & ~x22);
