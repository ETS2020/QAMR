...
module FAU ( 
  ...
  assign new_n49_ = ~x10 & x09 & x05 & ~x02 & ~x00 & ~x01;
  ...
  assign z14 = ~x00 & (~x05 | (new_n75_ & ~x01 & ~x02 & ~x09));
  assign new_n75_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x05 & x19);
