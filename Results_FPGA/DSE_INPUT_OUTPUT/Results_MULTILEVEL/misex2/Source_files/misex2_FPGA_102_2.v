...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n53_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n65_, new_n68_, new_n69_;
  ...
  assign z02 = (x02 & ~x11) | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (x02 & (~x11 | (new_n52_ & x00 & x01))) | (new_n53_ & ~x00 & ~x01 & ~x02);
  ...
  assign new_n58_ = x11 & (~x00 | (x01 & (x09 | ~x10 | x12)));
  assign z08 = x19 & ~x18 & new_n60_ & x17;
  assign new_n60_ = x11 & ~x08 & ~x07 & ~x06 & new_n61_ & ~x05;
  assign new_n61_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & x01 & new_n63_ & x18;
  assign new_n63_ = ~x19 & ~x20 & ~x21 & ~z04 & ~x22;
  assign z10 = z04 | (new_n65_ & ~x19 & ~x20 & x21 & x22);
  assign new_n65_ = ~x00 & x01 & x18;
  assign z11 = z04 | (new_n65_ & ~x19 & ~x20 & x21 & ~x22);
  assign z12 = z04 | (new_n68_ & x09);
  assign new_n68_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n69_ & ~x01));
  assign new_n69_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = (x02 & ~x11) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10 & x11))) | (~x01 & ~x02 & x19);
  assign z16 = ~x00 & ~z04 & x01;
