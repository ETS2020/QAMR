...
module FAU ( 
  ...
  assign z02 = ~x19 & ~x17 & ~x13 & new_n48_ & ~x10 & ~x18;
  assign z03 = (x00 & x01 & new_n51_ & x02) | (new_n52_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = ~x09 & x10 & x11 & x12 & (~x13 | x19);
  assign new_n52_ = ~x13 & ~x17 & x18 & ~x19;
  assign z04 = (x13 & ~x19) | (new_n54_ & x00 & x01 & x02);
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = new_n56_ | (x13 & ~x19);
  assign new_n56_ = x00 & x01 & x02 & x09 & x10;
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (~x13 | x19);
  assign z07 = x00 & x02 & ~new_n60_ & (~x13 | x19);
  ...
  assign z12 = (new_n76_ & x09) | (x13 & ~x19);
  ...
  assign z14 = ~x19 & (x13 | (new_n80_ & ~x00 & ~x01 & ~x02));
  assign new_n80_ = ~x09 & ~x10 & ~x17 & ~x18;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x13 & ~x19) | (~x01 & ~x02 & x19);
