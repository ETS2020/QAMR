...
module FAU ( 
  ...
  assign z09 = (~new_n55_ & x01) | (new_n56_ & new_n57_);
  assign new_n55_ = ~x00 & (~x18 | x19 | x20 | x21 | x22);
  assign new_n56_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  ...
  assign new_n61_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = (~new_n63_ & x01) | (new_n56_ & new_n64_);
  assign new_n63_ = ~x00 & (~x18 | x19 | x20 | ~x21 | x22);
  assign new_n64_ = ~x14 & x15 & ~x16 & x20 & ~x21 & ~x22;
  assign z12 = x00 ? x01 : (new_n66_ & ~x01);
