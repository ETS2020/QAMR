...
module FAU ( 
  ...
  assign z04 = (x09 & x20) | (new_n56_ & ~x09 & x10 & ~x11 & ~x12);
  assign new_n56_ = x00 & x01 & x02;
  assign z05 = x09 & (x20 | (x00 & x01 & x02 & x10));
  assign z06 = (x09 & x20) | (new_n56_ & ~x09 & x10 & x11);
  ...
  assign new_n70_ = ~x01 & x02 & ~x09 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n52_ | (~x00 & ~x22 & (new_n73_ | (new_n74_ & new_n75_)));
