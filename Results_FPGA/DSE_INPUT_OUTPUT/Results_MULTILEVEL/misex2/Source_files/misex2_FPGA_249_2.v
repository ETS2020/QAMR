...
module FAU ( 
  ...
  assign new_n48_ = ~x17 & x10 & x09 & new_n49_ & ~x02;
  assign new_n49_ = ~x00 & ~x01;
  assign z02 = (x01 & ~x21) | (new_n51_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n51_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (x01 & (new_n53_ | ~x21)) | (new_n54_ & ~x00 & ~x01 & ~x02);
  ...
  assign new_n59_ = x21 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  ...
  assign new_n65_ = ~x14 & ~x13 & x12 & ~x11 & new_n49_ & x02;
  ...
  assign z11 = (x01 & ~x21) | (~x00 & ~x22 & (new_n71_ | new_n73_));
  assign new_n71_ = new_n72_ & x02 & ~x11 & x12 & ~x13;
  ...
  assign z14 = (x01 & ~x21) | (new_n51_ & ~x00 & ~x01 & ~x02 & ~x09);
