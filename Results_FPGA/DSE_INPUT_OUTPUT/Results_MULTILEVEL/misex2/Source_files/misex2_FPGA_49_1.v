...
module FAU ( 
  ...
  assign z00 = ~x01 & x10;
  assign z02 = ~x01 & (new_n47_ | x10);
  assign new_n47_ = ~x00 & ~x02 & x09 & ~x17 & ~x18 & ~x19;
  ...
  assign new_n52_ = x01 & (x09 | x11 | x12 | ~x00 | ~x02);
  assign z05 = x10 & (~x01 | (x00 & x02 & x09));
  assign z06 = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = (~x01 & x10) | (x00 & x02 & (~x01 | (new_n56_ & ~x09 & x10)));
  assign new_n56_ = x11 & ~x12;
  assign z08 = ~x01 & (x10 | (new_n58_ & new_n59_));
