...
module FAU ( 
  ...
  assign new_n58_ = ~x05 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (x05 | x09 | ~x10 | ~x11 | x12);
  assign z08 = (x01 & x05) | (new_n63_ & new_n62_ & ~x03 & x04 & ~x05);
  ...
  assign new_n74_ = new_n71_ & ~x16 & x20 & ~x21 & ~x14 & x15;
