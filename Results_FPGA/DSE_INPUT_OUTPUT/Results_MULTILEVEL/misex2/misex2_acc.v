...
module FAU ( 
  ...
  nor2   g64(.a(x13), .b(new_n76_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n94_), .c(new_n93_), .O(new_n109_));
  nor3   g66(.a(new_n97_), .b(new_n96_), .c(x14), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n92_), .c(new_n91_), .d(x20), .O(new_n111_));
  or2    g68(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n107_), .c(x00), .O(z10));
  nand4  g70(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n63_), .O(new_n114_));
  nor2   g71(.a(new_n96_), .b(x14), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n91_), .c(x20), .d(new_n97_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n109_), .c(new_n114_), .O(new_n117_));
