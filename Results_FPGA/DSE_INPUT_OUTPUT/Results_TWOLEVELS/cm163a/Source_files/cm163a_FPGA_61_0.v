...
module FAU ( 
  ...
  assign z1 = (~x05 & (x10 | x12)) | (~new_n26_ & x04) | (~x10 & ~x12) | (~x01 & ~x04);
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = ((x10 | x12) & (~x05 | (~x04 & ~x06))) | (~new_n28_ & x04);
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | ~x10 | x11 | x12);
  assign z3 = (~x05 & (x10 | x12)) | ~new_n30_ | (~x12 & (new_n32_ | ~x10));
  assign new_n30_ = x04 ? ~new_n31_ : x07;
  assign new_n31_ = x13 & (~x02 | ~x03 | x09 | x11 | x12);
  assign new_n32_ = x02 & x03 & x04 & ~x09 & ~x11 & ~x13;
