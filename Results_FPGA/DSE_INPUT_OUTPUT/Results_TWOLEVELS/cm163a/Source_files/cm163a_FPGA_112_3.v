...
module FAU ( 
  ...
  assign z2 = (~x05 & (~x10 | ~x12)) | (~new_n28_ & x04) | (x10 & x12) | (~x04 & ~x06);
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~new_n30_ & (~x10 | ~x12)) | (x04 & ((~new_n31_ & ~x12) | (~x10 & x12 & x13)));
  assign new_n30_ = x05 & (x04 | x07);
  assign new_n31_ = (~x13 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x13);
  assign z4 = x10 & (x12 | (x14 & x15 & x03 & x08));
endmodule
