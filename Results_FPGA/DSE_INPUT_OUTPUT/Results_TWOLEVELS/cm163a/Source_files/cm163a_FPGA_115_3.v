...
module FAU ( 
  ...
  assign new_n30_ = (x09 | ((~x11 | ~x12) & (~x02 | ~x03 | x11 | x12))) & (~x12 | (x02 & x03));
  assign z3 = ((~x09 | ~x13) & (~x05 | (~x04 & ~x07))) | (x04 & ~new_n32_ & ~x09);
  assign new_n32_ = (~x13 | (~x11 & ~x12 & x02 & x03)) & (~x02 | ~x03 | x11 | x12 | x13);
