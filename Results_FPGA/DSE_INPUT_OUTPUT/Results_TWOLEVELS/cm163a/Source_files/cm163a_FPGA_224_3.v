...
module FAU ( 
  ...
  assign z0 = ~new_n24_ & (~x06 | ~x10);
  assign new_n24_ = (~x04 | (((x02 & x03) | ~x09) & (~x02 | ~x03 | x09))) & x05 & (x00 | x04);
  assign z1 = (~x05 & (~x06 | ~x10)) | (~new_n26_ & x04) | (x06 & x10) | (~x01 & ~x04);
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = (~new_n28_ & (~x06 | (x04 & ~x10))) | (~x05 & (~x06 | ~x10)) | (~x04 & ~x06);
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~x06 | ~x10) & ((~new_n30_ & x04) | ~x05 | (~x04 & ~x07));
