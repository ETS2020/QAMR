...
module FAU ( 
  ...
  assign z1 = (~x05 & (x08 | ~x11)) | (~new_n26_ & x04) | (~x08 & x11) | (~x01 & ~x04);
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = ((x08 | ~x11) & (~x05 | (~x04 & ~x06))) | (~new_n28_ & x04);
  assign new_n28_ = (x11 | ((~x12 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x12))) & (~x08 | ~x11 | ~x12);
  assign z3 = new_n30_ | new_n31_ | (~new_n32_ & x04) | (~x04 & ~x07);
  assign new_n30_ = ~x05 & (x08 | ~x11);
  assign new_n31_ = x11 & (~x08 | (x04 & x13));
