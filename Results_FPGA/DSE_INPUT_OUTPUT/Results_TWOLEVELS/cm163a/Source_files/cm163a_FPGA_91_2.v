...
module FAU ( 
  ...
  assign z2 = (x03 & (new_n27_ | ~x05)) | ~new_n28_ | (~x03 & (~x05 | (x04 & x12)));
  assign new_n27_ = x02 & x04 & ~x09 & ~x11 & ~x12;
  assign new_n28_ = x04 ? (~x12 | (x02 & ~x09 & ~x11)) : x06;
  assign z3 = (~x03 & (~x05 | (x04 & x13))) | (x05 & (x04 ? ~new_n30_ : ~x07));
  assign new_n30_ = (~x13 | (x02 & ~x09 & ~x11 & ~x12)) & (~x02 | ~x03 | x09 | x11 | x12 | x13);
