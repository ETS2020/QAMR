...
module FAU ( 
  ...
  assign z0 = (~x03 & (x10 | (x04 & x09))) | ~new_n24_ | (x04 & (x02 ? (x03 & ~x09) : x09));
  ...
  assign new_n29_ = ~x03 & (x10 | (x04 & x12));
  assign new_n30_ = (~x12 | (x02 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = new_n32_ | (~new_n33_ & x04) | ~x05 | (~x04 & ~x07);
  assign new_n32_ = ~x03 & (x10 | (x04 & x13));
  assign new_n33_ = (x09 | ((~x12 | ~x13) & (~x02 | ~x03 | x11 | x12 | x13))) & (~x13 | (x02 & ~x09 & ~x11));
