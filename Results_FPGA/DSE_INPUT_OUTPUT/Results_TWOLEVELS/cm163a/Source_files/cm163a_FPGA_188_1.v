...
module FAU ( 
  ...
  assign new_n30_ = (~x02 | ~x03 | x09) & (x06 ? x04 : ~x07);
  assign new_n31_ = ~x04 & ~x06 & ~x07;
  assign z3 = (~new_n33_ & (~x07 | (x04 & x06))) | (~x05 & (x06 | ~x07)) | (~x04 & ~x07);
  assign new_n33_ = (~x13 | (x02 & x03 & ~x09 & ~x11 & ~x12)) & (~x02 | ~x03 | x09 | x11 | x12 | x13);
  assign z4 = new_n24_ | (x03 & x08 & x10 & x14 & x15);
endmodule
