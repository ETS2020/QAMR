// Benchmark "FAU" written by ABC on Fri Aug 21 19:40:00 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_,
    new_n34_;
  assign z0 = (~x03 & (~x05 | (x04 & x09))) | (x05 & (x04 ? (x02 ? (x03 & ~x09) : x09) : ~x00));
  assign z1 = (x03 & (new_n25_ | ~x05)) | ~new_n26_ | (~x03 & (~x05 | (x04 & x11)));
  assign new_n25_ = x02 & x04 & ~x09 & ~x11;
  assign new_n26_ = x04 ? (~x11 | (x02 & ~x09)) : x01;
  assign z2 = (x03 & (new_n28_ | ~x05)) | ~new_n29_ | (~x03 & (~x05 | (x04 & x12)));
  assign new_n28_ = x02 & x04 & ~x09 & ~x11 & ~x12;
  assign new_n29_ = x04 ? (~x12 | (x02 & ~x09 & ~x11)) : x06;
  assign z3 = (x03 & (new_n31_ | ~x05)) | new_n33_ | new_n34_ | (~x03 & (new_n32_ | ~x05));
  assign new_n31_ = x02 & x04 & ~x09 & ~x11 & ~x12 & ~x13;
  assign new_n32_ = x04 & x13;
  assign new_n33_ = x04 & x13 & (x11 | x12 | ~x02 | x09);
