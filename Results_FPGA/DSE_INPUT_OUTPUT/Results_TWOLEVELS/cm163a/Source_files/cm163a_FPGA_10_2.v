// Benchmark "FAU" written by ABC on Fri Aug 21 19:39:53 2020
...
module FAU ( 
  ...
  assign z1 = (~new_n26_ & x04) | (~x01 & ~x04) | ~x05 | (x05 & ~x10);
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = (~new_n28_ & x04) | ~x05 | (x05 & ~x10) | (~x04 & ~x06);
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~new_n30_ & x04) | ~x05 | (x05 & ~x10) | (~x04 & ~x07);
