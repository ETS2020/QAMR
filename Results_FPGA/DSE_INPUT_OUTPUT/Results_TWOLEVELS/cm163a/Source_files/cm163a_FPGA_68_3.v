...
module FAU ( 
  ...
  assign new_n28_ = x09 ? (~x12 | x15) : ((~x12 | (x02 & x03 & ~x11)) & (~x02 | ~x03 | x11 | x12));
  assign z3 = new_n30_ | new_n31_ | (~x04 & ~x07) | (~new_n32_ & x04);
  assign new_n30_ = ~x05 & (~x09 | ~x15);
  assign new_n31_ = x09 & (x15 | (x04 & x13));
