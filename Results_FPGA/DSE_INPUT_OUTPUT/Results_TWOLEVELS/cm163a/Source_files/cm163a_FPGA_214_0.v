...
module FAU ( 
  ...
  assign new_n28_ = (~x03 | ((~x11 | ~x12) & (~x02 | x09 | x11 | x12))) & (~x05 | ~x12 | (x02 & x03 & ~x09));
  assign z3 = (x03 & (new_n30_ | ~x05)) | new_n32_ | new_n33_ | (~x03 & (new_n31_ | ~x05));
  assign new_n30_ = x02 & x04 & ~x09 & ~x11 & ~x12 & ~x13;
  assign new_n31_ = x04 & x13;
  assign new_n32_ = x04 & x13 & (~x02 | x09 | x11 | x12);
