...
module FAU ( 
  ...
  assign new_n24_ = ~x14 & (~x02 | ~x04 | x09);
  assign new_n25_ = (x02 | ~x04 | ~x09) & (x00 | x04) & (x05 | x14);
  assign z1 = ((~x03 | ~x14) & (~x05 | (~x01 & ~x04))) | (~new_n27_ & x04);
  assign new_n27_ = (~x11 | (x03 & (x14 | (x02 & ~x09)))) & (~x02 | ~x03 | x09 | x11 | x14);
  assign z2 = (~new_n29_ & x04) | ((~x03 | ~x14) & (~x05 | (~x04 & ~x06)));
  assign new_n29_ = (~x12 | (x03 & (x14 | (x02 & ~x09 & ~x11)))) & (~x02 | ~x03 | x09 | x11 | x12 | x14);
  assign z3 = (x03 & (new_n31_ | x14)) | (~new_n32_ & ~x03) | new_n33_ | ~new_n34_;
  assign new_n31_ = x02 & x04 & ~x09 & ~x11 & ~x12 & ~x13;
  assign new_n32_ = x05 & (~x04 | ~x13);
  assign new_n33_ = x04 & x13 & (~x02 | x09 | x11 | x12);
