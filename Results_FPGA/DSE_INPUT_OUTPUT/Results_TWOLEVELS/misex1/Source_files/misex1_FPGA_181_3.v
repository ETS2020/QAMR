...
module FAU ( 
  ...
  assign new_n25_ = (x1 | ~x2 | (x4 & x7) | (~x0 & (x0 | x5))) & (x0 | ~x1 | x2);
  assign new_n26_ = (~x4 | ~x7) & (x0 | ~x1 | x2 | x7);
  assign z4 = (~new_n18_ & ~new_n28_) | (new_n29_ & ~x0);
  assign new_n28_ = (x1 | (x0 ? (~x2 ^ x3) : (~x2 | (~x3 & ~x5 & (x3 | x5))))) & (x0 | ((x2 | x3 | ~x6) & (~x1 | ~x3)));
  assign new_n29_ = ~x2 & ((~x3 & ~x6 & (x4 ? ~x7 : ~x1)) | (x1 & ~x4));
  assign z5 = new_n32_ | (new_n34_ & x0) | (~x0 & (new_n33_ | (~new_n18_ & ~new_n31_)));
  ...
  assign z6 = (~new_n36_ & (~x4 | ~x7)) | (~x2 & ~x4 & ~x0 & x1);
