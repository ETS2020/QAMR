...
module FAU ( 
  ...
  assign z1 = new_n20_ | (~new_n19_ & ~x0);
  assign new_n19_ = (x2 | x7 | (~x1 & (x3 | ~x6))) & (x1 | ~x2 | (~x3 & ~x5));
  assign new_n20_ = ~x2 & (x7 | (x0 & ~x1 & x3 & ~x7));
  assign z2 = new_n20_ | (~x0 & (x1 ? ~new_n23_ : new_n22_));
  assign new_n22_ = ~x3 & (x2 ? ~x5 : (~x6 & ~x7));
  assign new_n23_ = (~x3 | (~x2 & x7)) & (x2 | ~x4 | x7);
  assign z3 = (~x0 & ((x1 & ~x2 & ~x7) | (~x3 & ~x5 & ~x1 & x2))) | (x0 & ~x1 & x2 & ~x3);
  assign z4 = new_n27_ | (~new_n26_ & ~x1);
  assign new_n26_ = x0 ? (x2 ? x3 : (~x3 | x7)) : ((~x2 | (~x3 & ~x5)) & (x3 | (x2 ? x5 : (x6 | x7))));
  assign new_n27_ = ~x0 & ((x1 & (x2 ? x3 : ~x7)) | (~x2 & ~x3 & x6 & ~x7));
  assign z5 = new_n27_ | (~x1 & (new_n30_ | (~x0 & ~new_n29_ & x2)));
  assign new_n29_ = ~x3 & ~x5;
  assign new_n30_ = x0 & (x2 ? ~x3 : (x3 & ~x7));
  assign z6 = (~x1 & (new_n30_ | (new_n29_ & ~x0 & x2))) | (~x0 & ~new_n32_ & x1);
