...
module FAU ( 
  ...
  assign new_n24_ = (~x4 | ~x7) & (x0 | ~x1 | (~x3 & (x2 | ~x4 | x7)));
  assign z3 = ~new_n27_ | (~new_n26_ & ~x3);
  assign new_n26_ = (x1 | ~x2 | (x0 ? (x4 & x7) : x5)) & (x0 | ~x1 | x2);
  assign new_n27_ = (~x4 | ~x7) & (x2 | x7 | x0 | ~x1);
  ...
  assign new_n34_ = (x3 | x5 | x1 | ~x2) & (~x1 | (~x3 & (x2 | x4)));
endmodule
