...
module FAU ( 
  ...
  assign new_n28_ = (x1 | (x0 ? (~x2 ^ x3) : ((~x2 | (~x3 & ~x5)) & (x3 | (x2 ? x5 : x6))))) & (x3 | ~x6 | x0 | x2);
  assign new_n29_ = ~x0 & x1 & (x3 | (~x2 & (x4 | (~x3 & ~x4))));
  assign z5 = new_n29_ | (~new_n31_ & x7);
  assign new_n31_ = (x3 | ~x6 | x0 | x2) & (x1 | (x0 ? (~x2 ^ x3) : (~x2 | (~x3 & ~x5))));
  assign z6 = (~new_n33_ & ~x1) | (~x0 & x1 & (x2 ? x3 : (x3 | (~x3 & ~x4))));
  assign new_n33_ = x7 & (~x7 | ((~x0 | (x2 ^ ~x3)) & (x0 | ~x2 | x3 | x5)));
endmodule
