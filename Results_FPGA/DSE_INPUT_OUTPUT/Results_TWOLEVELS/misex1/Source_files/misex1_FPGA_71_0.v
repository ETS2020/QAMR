...
module FAU ( 
  ...
  assign z1 = (~x0 & ((~x1 & x2 & (new_n19_ | x3)) | (~new_n20_ & ~x2))) | (x0 & ~x1 & ~x2 & x3);
  ...
  assign z5 = new_n29_ | (~x3 & ~x7) | (~new_n27_ & ~x0);
  assign new_n29_ = ~x1 & (x0 ? (x2 ? (~x3 & x7) : x3) : (x2 & (x3 | (x5 & x7))));
  assign z6 = (~new_n31_ & ~x1) | (~x0 & ~new_n32_ & x1);
  assign new_n31_ = (~x0 | (x2 ? (x3 | ~x7) : ~x3)) & (x0 | ~x2 | x3 | x5 | ~x7);
  assign new_n32_ = x2 ? ~x3 : (~x3 & (x3 | x4 | ~x7));
endmodule
