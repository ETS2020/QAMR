...
module FAU ( 
  ...
  assign new_n20_ = (x1 | ~x2 | (~x3 & ~x5)) & (x2 | ((x3 | (~x6 & (~x1 | x4 | ~x5))) & (~x1 | (~x3 & ~x4))));
  ...
  assign z4 = new_n27_ | new_n18_ | (~new_n28_ & ~x0);
  assign new_n27_ = ~x1 & ((x0 & (~x2 ^ ~x3)) | (~x3 & ((x2 & ~x5 & x6) | (~x0 & ~x2 & ~x6))) | (~x0 & x2 & (x3 | x5)));
  assign new_n28_ = (~x1 | (~x3 & (x2 | (~x4 & (x3 | x4 | ~x5))))) & (x2 | x3 | ~x6);
  assign z5 = new_n30_ | new_n18_ | (~new_n28_ & ~x0);
