...
module FAU ( 
  ...
  assign z1 = (~new_n19_ & ~x0) | (~x2 & (x6 | (x0 & ~x1 & x3 & ~x6)));
  ...
  assign z5 = new_n28_ | new_n26_ | (~x2 & x6);
  assign new_n28_ = ~x1 & (x0 ? (x2 ? ~x3 : (x3 & ~x6)) : (x2 & (x3 | x5)));
  assign z6 = (~new_n30_ & ~x1) | (~x0 & ~new_n31_ & x1);
  assign new_n30_ = (~x0 | (x2 ? x3 : (~x3 | x6))) & (x3 | x5 | x0 | ~x2);
  assign new_n31_ = x2 ? ~x3 : (x6 | (~x3 & (x3 | x4)));
endmodule
