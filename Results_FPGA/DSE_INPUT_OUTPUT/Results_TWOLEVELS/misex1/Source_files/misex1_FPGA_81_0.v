...
module FAU ( 
  ...
  assign new_n19_ = (~x3 | (x0 ? (x1 | (~x4 & ~x7)) : (~x1 | ~x7))) & (x0 | ((~x1 | (~x4 & (x3 | x4))) & (x3 | ~x6)));
  assign new_n20_ = ~x1 & x2 & (x3 | x5);
  assign z2 = (new_n23_ & ~x0) | (~new_n22_ & (x4 | x7));
  assign new_n22_ = (x0 | ~x2 | (x1 ? ~x3 : (x3 | x5))) & (~x0 | x1 | x2 | ~x3);
  assign new_n23_ = ~x2 & ((x1 & (x4 | (x3 & x7))) | (~x3 & ~x6 & (x4 | (~x1 & x7))));
  assign z3 = new_n26_ | (~new_n25_ & ~x3);
  assign new_n25_ = (x1 | ~x2 | (~x4 & ~x7) | (~x0 & (x0 | x5))) & (x2 | x4 | x0 | ~x1);
  assign new_n26_ = ~x7 & (~x4 | (~x0 & x1 & ~x2));
  assign z4 = ~new_n30_ | (~x0 & (new_n28_ | new_n20_ | (~new_n29_ & ~x3)));
  assign new_n28_ = x1 & (x3 | (~x2 & ~x3 & ~x4));
  assign new_n29_ = (x1 | (x2 ? (x5 | (~x4 & ~x7)) : (x6 | ~x7))) & (x2 | (~x6 & (~x4 | x6)));
  assign new_n30_ = (x4 | x7) & (~x0 | x1 | (~x4 & ~x7) | (~x2 ^ x3));
  assign z5 = new_n33_ | (~new_n34_ & ~x0) | (new_n32_ & x0);
  assign new_n32_ = ~x1 & (x4 | x7) & (~x2 ^ ~x3);
  assign new_n33_ = ~x4 & (~x7 | (~x2 & ~x3 & ~x0 & x1));
  assign new_n34_ = (~x1 | (~x3 & (x2 | ~x4))) & (x1 | ~x2 | (~x3 & ~x5)) & (x2 | x3 | ~x6);
  assign z6 = ~new_n30_ | (~new_n36_ & ~x0);
  assign new_n36_ = x1 ? (~x3 & (x2 | x3 | x4)) : (~x2 | x3 | x5 | (~x4 & ~x7));
endmodule
