...
module FAU ( 
  ...
  assign z1 = (~new_n19_ & (~x4 | x7)) | (~x0 & x1 & ~x2 & (~x4 | (x4 & x7)));
  ...
  assign new_n23_ = (~x4 | x7) & (x0 | ~x1 | ((~x3 | (~x2 & x4)) & (x2 | ~x4 | ~x7)));
  assign z3 = (~new_n26_ & ~x3) | (new_n25_ & ~x2 & ~x4 & ~x7);
  assign new_n25_ = ~x0 & x1;
  assign new_n26_ = (x1 | ~x2 | (x4 & ~x7) | (~x0 & (x0 | x5))) & (x0 | ~x1 | x2 | x4);
  assign z4 = (x4 & (~x7 | (new_n25_ & ~x2 & x7))) | new_n29_ | (~new_n28_ & (~x4 | x7));
  assign new_n28_ = (x1 | (x0 ? (~x2 ^ x3) : (~x2 | (~x3 & ~x5 & (x3 | x5))))) & (x0 | ((~x1 | ~x3) & (x2 | x3 | ~x6)));
  assign new_n29_ = ~x0 & ~x2 & ~x3 & (x1 ? ~x4 : ~x6);
  assign z5 = new_n32_ | (~new_n31_ & (~x4 | x7));
  assign new_n31_ = (x0 | ((~x1 | ~x3) & (x2 | x3 | ~x6))) & (x1 | (x0 ? (~x2 ^ x3) : (~x2 | (~x3 & ~x5))));
  assign new_n32_ = ~x0 & x1 & ~x2 & (x4 ? x7 : ~x3);
