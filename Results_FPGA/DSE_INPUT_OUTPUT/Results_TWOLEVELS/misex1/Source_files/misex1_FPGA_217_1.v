...
module FAU ( 
  ...
  assign z5 = new_n30_ | new_n28_ | (~x2 & x6);
  assign new_n30_ = ~x1 & (x0 ? (x2 ? ~x3 : (x3 & ~x6)) : (x2 & (x3 | x5)));
  assign z6 = new_n32_ | ~new_n33_;
  assign new_n32_ = ~x1 & ((x0 & (x2 ? ~x3 : (x3 & ~x6))) | (~x3 & ~x5 & ~x0 & x2));
  assign new_n33_ = (x2 | ~x6) & (x0 | ~x1 | (x2 ? ~x3 : (x6 | (~x3 & (x3 | x4)))));
endmodule
