...
module FAU ( 
  ...
  assign z05 = z00 | (x29 & ((~z00 & ~new_n135_) | new_n136_));
  assign new_n135_ = ~x15 & (x15 | (~x37 & (x37 | (~x28 & (x28 | (~x43 & (~x14 | x43)))))));
  assign new_n136_ = ~x14 & ~x15 & ~x28 & ~x37 & ~x43;
  assign z06 = x14 & new_n138_ & ~x15;
  assign new_n138_ = ~x28 & x29 & ~x37 & ~x43 & (x10 | x58);
  assign z07 = ~x15 & ~x28 & x29 & ~x37 & ~z00 & x43;
  assign z10 = ~x15 & x28 & x29 & ~z00 & ~x37;
  assign z11 = ~x15 & x29 & ~z00 & x37;
  assign z15 = ~x58 & (~x10 | (new_n143_ & x29 & ~x37 & ~x43));
  assign new_n143_ = ~x14 & ~x15 & ~x28;
  assign z34 = (~x10 & ~x58) | (new_n143_ & x29 & ~x37 & ~x43 & x58);
  assign z01 = 1'b0;
  assign z09 = 1'b0;
  assign z14 = 1'b0;
  assign z16 = 1'b0;
