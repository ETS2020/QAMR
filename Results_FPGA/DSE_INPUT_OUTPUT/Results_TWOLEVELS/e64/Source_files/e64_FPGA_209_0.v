...
module FAU ( 
  ...
  assign z05 = x29 & (x15 ? (x10 | x43) : (x37 ? (x10 | x43) : (x43 | (x10 & (x28 | (~x28 & ~x43))))));
  assign z06 = ~new_n136_ & ~x43;
  assign new_n136_ = x10 & (~x10 | ~x14 | x15 | x28 | ~x29 | x37);
  assign z07 = x43 & ~x37 & ~x15 & ~x28 & x29;
  assign z10 = z00 | (~x15 & x28 & x29 & ~z00 & ~x37);
  assign z11 = ~x15 & x29 & ~z00 & x37;
  assign z15 = ~x58 & new_n141_ & ~x43;
  assign new_n141_ = ~x37 & x29 & ~x28 & ~x15 & x10 & ~x14;
  assign z34 = x58 & new_n141_ & ~x43;
  assign z03 = 1'b0;
  assign z08 = 1'b0;
  assign z13 = 1'b0;
  assign z16 = 1'b0;
