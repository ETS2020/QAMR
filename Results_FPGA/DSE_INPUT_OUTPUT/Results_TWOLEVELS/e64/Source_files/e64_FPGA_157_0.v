...
module FAU ( 
  ...
  assign new_n142_ = x29 & ~x28 & ~x15 & ~x14 & ~x10 & x11;
  assign z15 = ~x58 & ~x43 & new_n144_ & ~x37;
  assign new_n144_ = x29 & ~x28 & ~x15 & ~x14 & x10 & x11;
  assign z24 = ~x58 & (~x11 | (new_n146_ & new_n148_));
  assign new_n146_ = new_n147_ & ~x24 & ~x25 & ~x28 & x29;
  assign new_n147_ = ~x10 & ~x14 & ~x15;
  assign new_n148_ = new_n149_ & ~x37 & ~x39 & ~x40;
  assign new_n149_ = ~x43 & ~x46 & ~x50 & ~x60;
  assign z25 = ~x58 & (~x11 | (new_n148_ & new_n151_));
  assign new_n151_ = new_n147_ & ~x28 & x29 & x24 & ~x25;
  assign z28 = ~x58 & (~x11 | (new_n148_ & new_n153_));
  assign new_n153_ = new_n147_ & x25 & ~x28 & x29;
  assign z29 = ~x58 & (~x11 | (new_n155_ & new_n156_));
  assign new_n155_ = new_n147_ & ~x28 & x29 & ~x37;
  assign new_n156_ = ~x39 & ~x40 & ~x43 & ~x46 & ~x50 & x60;
  assign z32 = ~x58 & (new_n158_ | ~x11);
  assign new_n158_ = new_n159_ & ~x10 & ~x14 & ~x15 & ~x28 & x29;
  assign new_n159_ = ~x37 & ~x39 & ~x40 & ~x43 & x46 & ~x50;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n141_ & x39;
  assign z34 = new_n162_ & x58;
  assign new_n162_ = ~x43 & ~x37 & x29 & ~x14 & ~x15 & ~x28;
