...
module FAU ( 
  ...
  assign z05 = (~x28 & ~x60) | (x29 & (((x28 | x60) & (x15 | (~x15 & x37))) | (~x15 & ~x37 & (x28 | (~new_n135_ & ~x28)))));
  assign new_n135_ = ~x43 & (x43 | (x14 ? ~x60 : (x58 ? ~x60 : new_n136_)));
  assign new_n136_ = ~x10 & (x10 | (~x50 & (x50 | (x40 ? ~x60 : (~x39 & (x39 | (~x46 & (x46 | ~x60))))))));
  ...
  assign z14 = ~new_n143_ & ~x28;
  assign new_n143_ = x60 & (~new_n144_ | x15 | ~x29 | x10 | x14);
  assign new_n144_ = ~x37 & ~x43 & x50 & ~x58;
  assign z15 = ~x28 & (~x60 | (new_n146_ & x10 & ~x14 & ~x15));
  ...
  assign z32 = ~x28 & (~x60 | (new_n151_ & new_n152_));
  assign new_n151_ = ~x10 & ~x14 & ~x15 & x29 & ~x37;
  assign new_n152_ = ~x39 & ~x40 & ~x43 & x46 & ~x50 & ~x58;
  assign z33 = ~x28 & (new_n154_ | ~x60);
  assign new_n154_ = new_n151_ & x39 & ~x40 & ~x43 & ~x50 & ~x58;
