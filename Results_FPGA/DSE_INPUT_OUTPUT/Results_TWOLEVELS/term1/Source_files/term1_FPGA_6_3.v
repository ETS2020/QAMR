...
module FAU ( 
  ...
  assign new_n76_ = new_n77_ & (x28 | (x27 ? (~x29 | ~x30) : x30));
  assign new_n77_ = ~new_n78_ & ~new_n79_ & ~new_n80_ & ~new_n81_ & new_n82_ & new_n83_;
  assign new_n78_ = ~x15 & (~x17 | ~x18 | ~x19 | ~x10 | ~x16);
  assign new_n79_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign new_n80_ = ~x17 & (~x12 | ~x18 | ~x19);
  assign new_n81_ = ~x18 & (~x13 | ~x19);
  assign new_n82_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n83_ = (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign z9 = new_n47_ | (x00 & (new_n92_ | new_n95_ | (new_n85_ & x29)));
  assign new_n85_ = ~new_n75_ & (new_n86_ | (x18 & x30 & new_n89_ & x31));
  assign new_n86_ = ~x26 & ((~x31 & x33) | (new_n88_ & new_n87_ & x30 & x31 & ~x33));
  assign new_n87_ = ~x18 & x19;
  assign new_n88_ = x13 & x15 & x16 & x17;
  assign new_n89_ = ~x33 & ((~new_n90_ & x15) | (new_n91_ & x10 & ~x15));
  assign new_n90_ = (~x16 | ((~x12 | x17 | ~x19) & (~x14 | ~x17 | x19))) & (~x11 | x16 | ~x17 | ~x19);
  assign new_n91_ = x16 & x17 & x19;
  assign new_n92_ = ~new_n93_ & (new_n94_ | (x18 & ~x30 & new_n89_ & ~x31));
  assign new_n93_ = ~new_n75_ & x29;
  assign new_n94_ = ~x26 & ((x31 & x33) | (new_n88_ & new_n87_ & ~x30 & ~x31 & ~x33));
  assign new_n95_ = x33 & (new_n98_ | (~new_n96_ & ~x26));
  assign new_n96_ = (x15 | (x16 & x17 & x18 & x19)) & (x16 | (x17 & x18 & x19)) & new_n97_ & (x17 | (x18 & x19));
  assign new_n97_ = (x18 | (x13 & x19)) & (~x30 | x31) & (x30 | ~x31);
  assign new_n98_ = x18 & (~new_n99_ | (~x11 & ~x16) | (~x10 & ~x15));
  assign new_n99_ = (x12 | x17) & (~x15 | ~x16 | ~x17 | ~x19) & (x14 | x19);
endmodule
