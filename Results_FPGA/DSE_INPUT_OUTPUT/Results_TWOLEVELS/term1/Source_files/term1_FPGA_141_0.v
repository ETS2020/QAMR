...
module FAU ( 
  ...
  assign new_n70_ = x01 & ~new_n61_ & x25 & ~x26 & ~new_n71_ & (x14 | x26);
  assign new_n71_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n72_ = (x17 | x22) & (x16 | x21) & (x15 | x20);
  assign z8 = ~x26 & (~x14 | (~new_n74_ & x00));
  ...
  assign new_n76_ = x16 & ((x17 & ((x18 & ~x19) | (x13 & ~x18 & x19))) | (x18 & x19 & x12 & ~x17));
  ...
  assign z9 = x00 & x14 & ~x26 & (new_n88_ | new_n90_ | new_n91_);
  assign new_n88_ = x29 & ~new_n86_ & ((~x31 & x33) | (x30 & x31 & ~new_n89_ & ~x33));
  assign new_n89_ = ~new_n78_ & ((~new_n76_ & ~new_n77_) | ~x15);
  assign new_n90_ = (new_n86_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n89_ & ~x33));
  assign new_n91_ = x33 & (new_n80_ | new_n81_ | ~new_n92_ | new_n82_);
  assign new_n92_ = ~new_n83_ & new_n93_ & (x30 | ~x31) & (~x30 | x31);
  assign new_n93_ = (x13 | x18) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
endmodule
