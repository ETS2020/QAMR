...
module FAU ( 
  ...
  assign z6 = (x26 & ~x32) | (x01 & x25 & new_n62_ & ~x26);
  assign new_n62_ = ~new_n56_ & ~new_n54_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x29 & ~x30 & x27 & x28));
  ...
  assign z8 = (x26 & ~x32) | (x00 & ((x31 & new_n69_ & ~x32) | (~x26 & ~new_n73_ & x32)));
  ...
  assign new_n73_ = ~new_n78_ & (x15 | (new_n72_ & new_n79_)) & new_n74_ & ~new_n80_;
