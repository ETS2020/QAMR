...
module FAU ( 
  ...
  assign new_n59_ = ~x26 & (~new_n54_ | new_n55_ | (~x18 & ~x23));
  ...
  assign z7 = new_n66_ | new_n65_ | new_n56_ | ~x01 | ~new_n67_ | ~x25;
  assign new_n65_ = (x19 | x24) & (x18 | x23) & new_n54_ & ~new_n55_;
  assign new_n66_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign new_n67_ = ~x26 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign z8 = (~x24 & x26) | (x00 & ~x26 & (new_n74_ | (new_n69_ & x31)));
