// Benchmark "FAU" written by ABC on Mon Aug 24 22:09:24 2020
...
module FAU ( 
  ...
  assign z0 = ~z8 & ~x32;
  assign z8 = x00 & ~x26;
  assign z1 = (x02 & (x03 ? ~x33 : ~x32)) | z8 | (~x02 & (x03 ? ~x32 : ~x33));
  ...
  assign z5 = ~x00 & x01 & x25 & new_n61_ & ~x26;
  assign new_n61_ = ~new_n55_ & (~new_n56_ | ~new_n57_) & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = ~x26 & (x00 | (x01 & ~new_n63_ & ~new_n64_ & x25));
  assign new_n63_ = new_n56_ & new_n57_;
  assign new_n64_ = (new_n55_ | ((~x30 | (x27 & x29)) & (~x27 | ~x28 | ~x29 | x30))) & (x28 | new_n65_ | ~x30);
  assign new_n65_ = x02 & (x00 | x03);
  assign z7 = (~new_n67_ & ~x00) | x26;
  assign new_n67_ = ~new_n70_ & (new_n69_ | new_n68_ | ~new_n71_) & new_n72_ & new_n73_;
  assign new_n68_ = ~x18 & ~x23;
  assign new_n69_ = ~x19 & ~x24;
  assign new_n70_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign new_n71_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n72_ = x01 & (~x02 | ~x03);
