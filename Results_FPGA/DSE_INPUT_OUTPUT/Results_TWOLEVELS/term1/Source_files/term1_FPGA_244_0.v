...
module FAU ( 
  ...
  assign z7 = x26 | (x14 & (~new_n69_ | new_n73_));
  ...
  assign z8 = ~x26 & (~x14 | (x00 & (new_n75_ | new_n82_ | new_n85_)));
  assign new_n75_ = ~new_n76_ & ((x30 & x31 & ~new_n78_ & ~x32) | (x14 & ~x30 & x32));
  assign new_n76_ = ~new_n77_ & x29;
  assign new_n77_ = ~x27 & ~x28;
  assign new_n78_ = ~new_n81_ & ((~new_n79_ & ~new_n80_) | ~x15);
  assign new_n79_ = x16 & ((x17 & ((x18 & ~x19) | (x13 & ~x18 & x19))) | (x12 & ~x17 & x18 & x19));
  ...
  assign new_n83_ = ~new_n77_ & (new_n81_ | (x15 & (new_n79_ | new_n80_)));
  assign new_n84_ = ~x27 & (~x14 | ~x28);
  ...
  assign z9 = ~x26 & (~x14 | (x00 & (~new_n94_ | (new_n93_ & x29))));
  assign new_n93_ = ~new_n77_ & ((~x31 & x33) | (x14 & x30 & x31 & ~new_n78_ & ~x33));
  assign new_n94_ = (new_n76_ | ((~x31 | ~x33) & (x30 | x31 | new_n78_ | x33))) & (new_n95_ | ~x33);
  assign new_n95_ = ~new_n89_ & ~new_n90_ & ~new_n91_ & ~new_n87_ & new_n96_ & new_n97_;
  assign new_n96_ = (x13 | x18) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
