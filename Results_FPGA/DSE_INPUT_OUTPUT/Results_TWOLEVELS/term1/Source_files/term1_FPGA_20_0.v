// Benchmark "FAU" written by ABC on Mon Aug 24 22:07:36 2020
...
module FAU ( 
  ...
  assign new_n65_ = x01 & ~new_n56_ & x25 & ~x26 & ~new_n66_ & (x26 | x33);
  assign new_n66_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n67_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign z8 = x00 & ~x26 & x33 & (new_n73_ | (new_n69_ & x31));
  ...
  assign new_n74_ = ~x15 & (~new_n72_ | ~x10 | ~x16);
  ...
  assign z9 = x00 & ~x26 & x33 & (~new_n82_ | new_n86_);
  assign new_n82_ = (x31 | (~x30 & (~x29 | (~x27 & ~x28)))) & new_n83_ & (~x31 | ((x27 | x28) & x29 & x30));
  assign new_n83_ = (x19 | (new_n84_ & x15 & x16)) & new_n85_ & (x15 | (new_n84_ & x10 & x16));
