...
module FAU ( 
  ...
  assign z7 = new_n71_ | ~new_n69_ | (x15 & new_n72_ & (x19 | x24));
  assign new_n69_ = x01 & ~new_n61_ & x25 & ~x26 & ~new_n70_ & (~x20 | x26);
  assign new_n70_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n71_ = x31 & (~x27 | ~x28 | ~x29 | ~x30);
  assign new_n72_ = (x18 | x23) & (x17 | x22) & (x16 | x21);
  assign z8 = x00 & ~x20 & ~x26 & (new_n79_ | (new_n74_ & x31));
  ...
  assign z9 = ~x26 & (x20 | (x00 & (new_n88_ | new_n89_ | new_n90_)));
