...
module FAU ( 
  ...
  assign new_n50_ = (x26 | ~x27) & ((~new_n51_ & (x04 ^ x07)) | (~new_n52_ & (~x04 ^ x07)));
  ...
  assign new_n54_ = ~x01 & ~x27 & ((x03 & ~x06) | (x02 & ~x05));
  assign new_n55_ = ~new_n56_ & (x02 | x03 | ~x26 | (~x05 ^ x06));
  assign new_n56_ = ~x01 & ~x27 & ((~x02 & ~x05 & x06) | (~x03 & x05 & ~x06));
  ...
  assign z4 = ~x26 & (x27 | (x01 & x25 & new_n58_ & x28));
  assign z5 = x01 & x25 & ~x26 & ~x27 & new_n58_ & x29;
  assign z6 = ~x26 & (x27 | (x01 & x25 & new_n58_ & x30));
  assign z7 = ~new_n65_ | ((x19 | x24) & new_n66_ & (x18 | x23));
  assign new_n65_ = x01 & ~new_n59_ & x25 & ~x26 & ~x31 & (x26 | ~x27);
  assign new_n66_ = (x17 | x22) & (x16 | x21) & (x15 | x20);
  assign z8 = ~x26 & (x27 | (x00 & (~new_n68_ | new_n85_)));
  assign new_n68_ = ~new_n69_ & (~new_n80_ | ~x28) & (~x32 | (~new_n82_ & new_n83_));
  ...
  assign new_n76_ = x14 & ~x19 & x28;
  assign new_n77_ = x31 & ~x32 & x29 & ~x30;
  assign new_n78_ = x19 & x28 & x13 & ~x18;
  assign new_n79_ = x28 & x29 & ~x30 & x31 & ~x32;
  ...
  assign new_n85_ = (~x28 | ~x29) & (x30 ? (x31 & ~new_n86_ & ~x32) : x32);
  ...
  assign z9 = x00 & ~x26 & ~new_n89_ & ~x27;
  assign new_n89_ = ~new_n90_ & new_n96_ & (~x15 | (~new_n91_ & (~new_n72_ | ~new_n95_)));
  assign new_n90_ = (~x28 | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n86_ & ~x33));
  assign new_n91_ = x16 & ((new_n70_ & new_n95_) | (x17 & (new_n92_ | new_n94_)));
  assign new_n92_ = x19 & ((x18 & x33) | (new_n93_ & x13 & ~x18 & x28));
  assign new_n93_ = x29 & x30 & x31 & ~x33;
  assign new_n94_ = x18 & ((new_n76_ & new_n93_) | (~x14 & x33));
  assign new_n95_ = x28 & x29 & x30 & x31 & ~x33;
  assign new_n96_ = (~x28 | new_n97_ | ~x29) & (~x33 | (~new_n98_ & new_n100_));
