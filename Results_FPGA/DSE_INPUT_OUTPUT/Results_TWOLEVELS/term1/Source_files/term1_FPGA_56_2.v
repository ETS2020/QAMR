...
module FAU ( 
  ...
  assign z6 = (x01 & x25 & new_n62_ & ~x26) | (x26 & ~x28);
  ...
  assign z8 = new_n47_ | (x00 & ((x31 & new_n69_ & ~x32) | (~new_n73_ & x32)));
  assign new_n69_ = ~new_n70_ & ((~x26 & ((~x29 & x30) | (x28 & x29 & ~x30))) | (~x28 & (x27 ? (x29 & ~x30) : x30)));
  assign new_n70_ = (~x15 | ((new_n71_ | ~x16) & (~new_n72_ | ~x11 | x16))) & (~new_n72_ | ~x10 | x15 | ~x16);
  assign new_n71_ = (~x17 | ((~x14 | ~x18 | x19) & (~x13 | x18 | ~x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n72_ = x17 & x18 & x19;
  assign new_n73_ = ~new_n79_ & (x26 | (~new_n74_ & new_n75_ & ~new_n80_));
  ...
  assign new_n90_ = (x26 | ((~x28 | ~x29 | ~x30 | ~x31) & (x29 | x30 | x31))) & (x28 | ((~x30 | ~x31 | ~x27 | ~x29) & (x27 | x30 | x31)));
endmodule
