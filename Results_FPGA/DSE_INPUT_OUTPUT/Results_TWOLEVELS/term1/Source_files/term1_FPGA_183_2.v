// Benchmark "FAU" written by ABC on Mon Aug 24 22:09:05 2020
...
module FAU ( 
  ...
  assign z7 = (x02 & x03 & (x33 | (~x26 & ~x33))) | (x26 & x33) | (~new_n62_ & ~x26);
  assign new_n62_ = ~new_n65_ & new_n66_ & x01 & (~new_n63_ | (~x19 & ~x24));
  ...
  assign z8 = (x26 & ~x33) | (x00 & ~x26 & (new_n72_ | (new_n68_ & x31)));
  ...
  assign new_n75_ = (x13 | x18) & (~x28 | ~x29 | ~x30) & (x29 | x30) & x31;
  ...
  assign new_n82_ = (new_n85_ | ((~x31 | ~x33) & (x30 | x31 | new_n69_ | x33))) & (new_n83_ | ~x33);
  assign new_n83_ = ~new_n76_ & ~new_n78_ & ~new_n79_ & ~new_n74_ & new_n84_;
