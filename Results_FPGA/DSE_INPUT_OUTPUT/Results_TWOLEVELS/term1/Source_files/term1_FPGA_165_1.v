// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:55 2020
...
module FAU ( 
  ...
  assign z1 = (x02 & (x03 ? ~x33 : ~x32)) | (~x25 & x26) | (~x02 & (x03 ? ~x32 : ~x33));
  assign z2 = new_n49_ | (~x25 & x26);
  ...
  assign z6 = (~x25 & x26) | (x01 & x25 & ~x26 & new_n60_ & (~x02 | ~x03));
  ...
  assign z8 = x00 & ~x26 & ((x31 & new_n67_ & ~x32) | (~new_n72_ & x32));
  assign new_n67_ = ~new_n68_ & ((x29 & ~new_n71_ & ~x30) | (x30 & (new_n71_ | ~x29)));
  ...
  assign new_n72_ = ~new_n77_ & new_n73_ & ~new_n79_ & (x15 | (new_n70_ & new_n78_));
  ...
  assign z9 = (~x25 & x26) | (x00 & ~x26 & (new_n81_ | new_n82_ | new_n83_));
  assign new_n81_ = x29 & ~new_n71_ & ((~x31 & x33) | (x30 & x31 & ~new_n68_ & ~x33));
  assign new_n82_ = (new_n71_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n68_ & ~x33));
