...
module FAU ( 
  ...
  assign new_n74_ = (new_n82_ | (x30 ? (~x31 | new_n71_ | x32) : ~x32)) & (new_n75_ | ~x32);
  assign new_n75_ = ~new_n76_ & ~new_n77_ & ~new_n78_ & ~new_n79_ & ~new_n80_ & new_n81_;
  assign new_n76_ = ~x15 & (~x10 | ~x16 | ~x17 | ~x18 | ~x19);
  ...
  assign z9 = ~x26 & (new_n85_ | ~new_n86_ | (new_n84_ & x29));
  assign new_n84_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n71_ & ~x33));
  assign new_n85_ = ~new_n82_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n71_ & ~x33));
  assign new_n86_ = x00 & (~x33 | (~new_n76_ & ~new_n77_ & new_n87_ & ~new_n78_));
  assign new_n87_ = ~new_n79_ & new_n88_ & (x30 | ~x31) & (~x30 | x31);
  assign new_n88_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
endmodule
