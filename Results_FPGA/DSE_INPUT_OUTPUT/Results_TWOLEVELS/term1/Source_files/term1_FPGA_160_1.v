...
module FAU ( 
  ...
  assign new_n65_ = x01 & ~new_n56_ & x25 & ~x26 & ~new_n66_ & (x26 | ~x32);
  assign new_n66_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n67_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign z8 = x00 & ~x26 & new_n69_ & x31;
  ...
  assign z9 = x00 & ~x26 & (new_n75_ | ~new_n76_) & ~x32;
  assign new_n75_ = x29 & ~new_n73_ & ((~x31 & x33) | (x30 & x31 & ~new_n70_ & ~x33));
  assign new_n76_ = (new_n77_ | ((~x31 | ~x33) & (x30 | x31 | new_n70_ | x33))) & (new_n78_ | ~x33);
  assign new_n77_ = ~new_n73_ & x29;
  assign new_n78_ = ~new_n79_ & ~new_n80_ & ~new_n81_ & ~new_n82_ & new_n83_ & new_n84_;
  assign new_n79_ = ~x15 & (~x10 | ~x16 | ~x17 | ~x18 | ~x19);
