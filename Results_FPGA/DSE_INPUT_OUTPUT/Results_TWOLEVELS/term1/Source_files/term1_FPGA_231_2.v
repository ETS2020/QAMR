...
module FAU ( 
  ...
  assign z8 = ~x26 & (x14 | (~new_n76_ & x00));
  assign new_n76_ = (~x19 | ~x31 | ~new_n77_ | x32) & (~x32 | (new_n81_ & ~new_n87_));
  ...
  assign new_n82_ = x29 & x30 & (x28 | (~x14 & x27));
  assign new_n83_ = ~x14 & ~x30 & (~x29 | (~x27 & ~x28));
  assign new_n84_ = ~x18 & (~x15 | ~x16 | ~x17);
  assign new_n85_ = ~x15 & (~x10 | ~x16 | ~x17);
  assign new_n86_ = (x16 | (x11 & x17)) & (x12 | x17) & x19 & x31;
  assign new_n87_ = x15 & x16 & x17 & (~x13 | (~x14 & x18));
  assign z9 = ~x26 & (x14 | (~new_n89_ & x00));
  assign new_n89_ = (~x33 | (new_n91_ & ~new_n87_)) & (~x19 | x33 | new_n90_ | new_n96_);
  assign new_n90_ = ~new_n80_ & (new_n79_ | ~x15);
  assign new_n91_ = ~new_n93_ & ~new_n84_ & ~new_n85_ & ~new_n92_ & ~new_n94_ & new_n95_;
  assign new_n92_ = ~x16 & (~x11 | ~x17);
  assign new_n93_ = ~x31 & (x30 | (x29 & (x27 | x28)));
  assign new_n94_ = x31 & (~x29 | ~x30 | (~x27 & ~x28));
  assign new_n95_ = x19 & (x12 | x17);
  assign new_n96_ = (~x29 | ~x30 | ~x31 | (~x28 & (x14 | ~x27))) & (x30 | x31 | (x29 & (x27 | x28)));
endmodule
