...
module FAU ( 
  ...
  assign z8 = x00 & x10 & ~x26 & (new_n74_ | new_n79_ | new_n80_);
  assign new_n74_ = x29 & ~new_n78_ & (x30 ? x32 : (x31 & ~new_n75_ & ~x32));
  assign new_n75_ = (~x15 | ((new_n77_ | ~x16) & (~x11 | x16 | ~new_n76_ | ~x17))) & (x15 | ~x16 | ~new_n76_ | ~x17);
  assign new_n76_ = x18 & x19;
  assign new_n77_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n78_ = ~x27 & ~x28;
  assign new_n79_ = (new_n78_ | ~x29) & (x30 ? (x31 & ~new_n75_ & ~x32) : x32);
  assign new_n80_ = x32 & (new_n81_ | ~new_n82_);
  assign new_n81_ = ~x15 & (~new_n76_ | ~x16 | ~x17);
  assign new_n82_ = ~new_n83_ & ~new_n84_ & ~new_n85_ & new_n86_ & (x14 | x19);
