...
module FAU ( 
  ...
  assign z4 = ~x26 & (x09 | (new_n58_ & x01));
  assign new_n58_ = x25 & ~new_n54_ & ~new_n56_ & (x27 ^ x28);
  assign z5 = x01 & ~x09 & x25 & new_n60_ & ~x26;
  assign new_n60_ = ~new_n56_ & ~new_n54_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = ~x26 & (x09 | (x01 & new_n62_ & ~new_n56_ & x25));
  assign new_n62_ = ~new_n54_ & ((x30 & (~x27 | ~x29 | (~x09 & ~x28))) | (x27 & x28 & x29 & ~x30));
  assign z7 = ~new_n64_ | (x31 & (~x27 | ~x28 | ~x29 | ~x30));
  assign new_n64_ = new_n65_ & ((~x19 & ~x24) | ~new_n67_ | (~x18 & ~x23));
  assign new_n65_ = x01 & ~new_n56_ & x25 & ~x26 & ~new_n66_ & (~x09 | x26);
  assign new_n66_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n67_ = (x17 | x22) & (x16 | x21) & (x15 | x20);
  assign z8 = x00 & ~x09 & ~x26 & (new_n74_ | (new_n69_ & x31));
  ...
  assign z9 = ~x26 & (x09 | (x00 & (new_n83_ | new_n84_ | new_n85_)));
