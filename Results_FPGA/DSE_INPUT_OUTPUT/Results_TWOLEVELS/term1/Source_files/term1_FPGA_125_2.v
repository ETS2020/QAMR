// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:33 2020
...
module FAU ( 
  ...
  assign z7 = new_n68_ | new_n65_ | ~new_n67_ | x26 | new_n69_ | (x00 & ~x26);
  assign new_n65_ = ~new_n66_ & (x18 | x23) & new_n56_ & (x17 | x22);
  assign new_n66_ = ~x19 & ~x24;
  assign new_n67_ = x01 & ~new_n55_ & x25;
