...
module FAU ( 
  ...
  assign new_n58_ = ~x33 & (~x27 ^ ~x28) & ~new_n54_ & ~new_n56_;
  ...
  assign z8 = ~x26 & (x33 | (x00 & (new_n70_ | new_n76_ | new_n77_)));
  assign new_n70_ = ~new_n71_ & (x30 ? (x31 & ~new_n73_ & ~x32) : (x32 & ~x33));
  ...
  assign new_n76_ = x29 & ~new_n72_ & (x30 ? x32 : (x31 & ~new_n73_ & ~x32));
  assign new_n77_ = x32 & (new_n82_ | new_n78_ | ~new_n80_);
  ...
  assign z9 = x00 & ~x26 & new_n84_ & ~x33;
  assign new_n84_ = ~new_n73_ & ((x29 & x30 & ~new_n72_ & x31) | (~x30 & ~x31 & (new_n72_ | ~x29)));
endmodule
