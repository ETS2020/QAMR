// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:56 2020
...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_, new_n57_,
  ...
  assign new_n59_ = ~new_n53_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x29 & ~x30 & x27 & x28));
  assign z7 = x26 ? x32 : (~new_n61_ | new_n65_);
  assign new_n61_ = ~new_n62_ & new_n64_ & x01 & (~x02 | ~x03);
  ...
  assign z8 = (x26 & ~x32) | (x00 & ((x31 & new_n67_ & ~x32) | (~x26 & ~new_n71_ & x32)));
