...
module FAU ( 
  ...
  assign z8 = ~x26 & (new_n75_ | ~new_n76_ | (new_n70_ & x29));
  ...
  assign new_n76_ = x00 & (~x32 | (~new_n77_ & ~new_n81_ & new_n78_ & ~new_n82_));
  assign new_n77_ = ~x15 & (~new_n73_ | ~x10 | ~x16);
  assign new_n78_ = ~new_n79_ & (x14 | x19) & ~new_n80_ & x31;
  ...
  assign new_n86_ = x33 & (new_n77_ | new_n81_ | ~new_n87_ | new_n82_);
  assign new_n87_ = ~new_n79_ & ~new_n80_ & (x14 | x19) & (~x30 | x31) & (x30 | ~x31);
endmodule
