...
module FAU ( 
  ...
  assign z4 = (~x07 & x26) | (x01 & x25 & new_n58_ & ~x26);
  assign new_n58_ = ~new_n54_ & ~new_n56_ & (x27 ^ x28);
  assign z5 = (~x07 & x26) | (x01 & x25 & new_n60_ & ~x26);
  assign new_n60_ = ~new_n56_ & ~new_n54_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = (~x07 & x26) | (x01 & x25 & new_n62_ & ~x26);
