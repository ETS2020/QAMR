...
module FAU ( 
  ...
  assign z9 = x00 & ((new_n83_ & ~x33) | x26 | (x33 & (~new_n84_ | new_n88_)));
  assign new_n83_ = ~new_n71_ & ((~x28 & ((x30 & x31 & x27 & x29) | (~x27 & ~x30 & ~x31))) | (x28 & x29 & x30 & x31) | (~x29 & ~x30 & ~x31));
  assign new_n84_ = (x31 | (~x30 & (~x29 | (~x27 & ~x28)))) & new_n85_ & (~x31 | ((x27 | x28) & x29 & x30));
  assign new_n85_ = (x19 | (new_n86_ & x15 & x16)) & new_n87_ & (x15 | (new_n86_ & x10 & x16));
  assign new_n86_ = x17 & x18;
  assign new_n87_ = (x16 | (x11 & x17 & x18)) & (x13 | x18) & (x17 | (x12 & x18));
