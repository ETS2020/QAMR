...
module FAU ( 
  ...
  assign z8 = x00 & x23 & ~x26 & (new_n79_ | (new_n74_ & x31));
  ...
  assign new_n84_ = (~x27 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n85_ = ~x27 & (x28 ? (x29 & x30) : ~x30);
  assign new_n86_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign z9 = ~x26 & (~x23 | (x00 & (new_n88_ | new_n89_ | new_n90_)));
