...
module FAU ( 
  ...
  assign z8 = (~x13 & (x26 | (x00 & ~x18 & x32))) | (x00 & ~new_n67_ & ~x26);
  assign new_n67_ = (~x31 | x32 | new_n68_ | new_n70_) & (~x32 | (new_n73_ & ~new_n80_));
  assign new_n68_ = (~x30 | (~new_n69_ & x29)) & (~x29 | new_n69_ | x30);
  ...
  assign new_n77_ = ~x17 & (~x12 | ~x19);
  assign new_n78_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n79_ = (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n80_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign z9 = new_n88_ | (x00 & ~x26 & (new_n82_ | new_n83_ | new_n84_));
  assign new_n82_ = x29 & ~new_n69_ & ((~x31 & x33) | (x30 & x31 & ~new_n70_ & ~x33));
  assign new_n83_ = (new_n69_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n70_ & ~x33));
  assign new_n84_ = x33 & (new_n87_ | ~new_n85_ | new_n74_);
  assign new_n85_ = (x19 | (x15 & x16 & x17)) & new_n86_ & (x15 | (x10 & x16 & x17));
  assign new_n86_ = (x16 | (x11 & x17)) & (x12 | x17) & (x30 | ~x31) & (~x30 | x31);
  assign new_n87_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n88_ = ~x13 & (x26 | (x00 & ~x18 & x33));
endmodule
