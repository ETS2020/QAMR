...
module FAU ( 
  ...
  assign z3 = ~x26 & (x18 | (x01 & x25 & new_n53_ & ~x27));
  ...
  assign z4 = x01 & ~x18 & x25 & new_n58_ & ~x26;
  ...
  assign z7 = new_n66_ | new_n64_ | ~new_n65_ | x26 | new_n67_ | (x18 & ~x26);
  assign new_n64_ = x23 & (x19 | x24) & new_n55_ & (x17 | x22);
  assign new_n65_ = x01 & ~new_n54_ & x25;
  assign new_n66_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign new_n67_ = x27 & x28 & x29 & x30 & ~x31;
  assign z8 = x00 & ~x18 & ~x26 & (~new_n72_ | (~new_n69_ & x29));
  assign new_n69_ = ~new_n71_ & (~x13 | ~x15 | ~x16 | ~new_n70_ | ~x17);
  assign new_n70_ = x19 & ~x30 & x31 & ~x32 & (x27 | x28);
  assign new_n71_ = x30 & x32 & (x28 | (x27 & ~x28));
  assign new_n72_ = (new_n73_ | ((~new_n74_ | ~new_n75_) & (x30 | ~x32))) & (new_n76_ | ~x32);
  assign new_n73_ = x29 & (x27 | x28);
  assign new_n74_ = x16 & x17 & x13 & x15;
  assign new_n75_ = x31 & ~x32 & x19 & x30;
  assign new_n76_ = x13 & x15 & x16 & x17 & x19 & x31;
  assign z9 = x00 & ~x18 & ~x26 & (new_n78_ | new_n81_ | new_n82_);
  assign new_n78_ = x29 & ~new_n79_ & ((~x31 & x33) | (new_n74_ & new_n80_ & x31 & ~x33));
  assign new_n79_ = ~x27 & ~x28;
  assign new_n80_ = x19 & x30;
  assign new_n81_ = ~new_n73_ & ((x31 & x33) | (new_n74_ & x19 & ~x30 & ~x31 & ~x33));
  assign new_n82_ = x33 & (~new_n83_ | ~x13 | ~x15 | ~x16);
  assign new_n83_ = (~x30 | x31) & (x30 | ~x31) & x17 & x19;
endmodule
