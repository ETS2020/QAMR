...
module FAU ( 
  ...
  assign z3 = ~x26 & (x00 | (x01 & x25 & new_n53_ & ~x27));
  assign new_n53_ = ~new_n54_ & (~new_n55_ | ~new_n56_);
  assign new_n54_ = x02 & x03;
  assign new_n55_ = (x15 | x20) & (x16 | x21);
  assign new_n56_ = (x17 | x22) & (x19 | x24) & (x18 | x23);
  assign z4 = ~x26 & (x00 | (x01 & new_n58_ & x25));
