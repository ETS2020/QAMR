...
module FAU ( 
  ...
  assign new_n52_ = (~x01 | (~x02 ^ x03)) & (~x02 | (x03 ? x01 : x05)) & (x01 | ((x02 | x03 | ~x05 | ~x06) & (x05 | x06))) & (x02 | ~x03 | x06);
  assign z8 = ~x26 & (x01 | (x00 & (new_n54_ | new_n59_ | new_n60_)));
  ...
  assign z9 = ~x26 & (x01 | (x00 & (new_n67_ | new_n68_ | new_n69_)));
