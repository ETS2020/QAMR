...
module FAU ( 
  ...
  assign z4 = (~x20 & x26) | (new_n58_ & x01);
  assign new_n58_ = x25 & ~new_n59_ & (~x02 | ~x03) & (x27 ^ x28);
  assign new_n59_ = (x15 | x20) & (x26 | (new_n56_ & new_n60_));
  assign new_n60_ = (x16 | x21) & (x17 | x22);
  assign z5 = (~x20 & x26) | (x01 & new_n62_ & x25);
