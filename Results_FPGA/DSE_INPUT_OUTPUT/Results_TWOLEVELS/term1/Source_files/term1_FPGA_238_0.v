...
module FAU ( 
  ...
  assign z8 = x00 & x14 & ~x26 & (new_n80_ | (new_n76_ & x31));
  ...
  assign new_n78_ = (~x17 | ((~x18 | x19) & (~x13 | x18 | ~x19))) & (~x18 | ~x19 | ~x12 | x17);
  assign new_n79_ = x17 & x18 & x19;
  assign new_n80_ = x32 & (~new_n81_ | (~x28 & (x27 ? (x29 & x30) : ~x30)));
  ...
  assign new_n86_ = (x13 | x18) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n87_ = x31 & (x29 | x30) & (~x28 | ~x29 | ~x30);
  assign z9 = x00 & x14 & ~x26 & (~new_n90_ | (new_n89_ & x29));
  assign new_n89_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n77_ & ~x33));
  assign new_n90_ = (new_n93_ | ((~x31 | ~x33) & (x30 | x31 | new_n77_ | x33))) & (new_n91_ | ~x33);
  assign new_n91_ = ~new_n82_ & ~new_n83_ & ~new_n84_ & ~new_n85_ & new_n86_ & new_n92_;
