// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:09 2020
...
module FAU ( 
  ...
  assign z5 = ~x26 & (x00 | (x01 & new_n61_ & ~new_n55_ & x25));
  assign new_n61_ = (~new_n56_ | ~new_n57_) & ((x29 & (~x27 | (~x00 & ~x28))) | (x27 & x28 & ~x29));
  ...
  assign z7 = new_n69_ | ~new_n67_ | (new_n66_ & (x19 | x24));
  assign new_n66_ = (x18 | x23) & new_n56_ & (x17 | x22);
  assign new_n67_ = x01 & ~new_n55_ & x25 & ~x26 & ~new_n68_ & (~x00 | x26);
