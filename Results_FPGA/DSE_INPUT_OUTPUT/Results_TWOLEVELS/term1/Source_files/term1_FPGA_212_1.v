...
module FAU ( 
  ...
  assign new_n59_ = (x27 ^ x28) & ~new_n57_ & (new_n60_ | (~x19 & ~x24));
  assign new_n60_ = ~x26 & (~new_n55_ | new_n56_ | (~x18 & ~x23));
  assign z5 = x01 & x25 & new_n62_ & ~x26;
  assign new_n62_ = ~new_n57_ & ~new_n54_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = x01 & x25 & ~x26 & new_n64_ & ~new_n57_;
  assign new_n64_ = ~new_n54_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = new_n67_ | new_n66_ | new_n57_ | ~x01 | ~new_n68_ | ~x25;
  assign new_n66_ = (x19 | x24) & (x18 | x23) & new_n55_ & ~new_n56_;
  ...
  assign new_n74_ = (~x29 | x30 | (~x27 & ~x28)) & (~x30 | (x29 & (x27 | x28)));
  ...
  assign new_n88_ = (~x17 | ((~x14 | ~x18 | x19) & (~x13 | x18 | ~x19))) & (~x12 | x17 | ~x18 | ~x19);
