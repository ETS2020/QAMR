...
module FAU ( 
  ...
  assign z5 = (~x10 & x26) | (x01 & x25 & new_n58_ & ~x26);
  ...
  assign new_n72_ = ~new_n78_ & ~new_n73_ & new_n74_ & ~new_n79_;
  ...
  assign z9 = new_n88_ | (x00 & ~x26 & (new_n81_ | new_n82_ | new_n83_));
  assign new_n81_ = x29 & ~new_n71_ & ((~x31 & x33) | (x30 & x31 & ~new_n68_ & ~x33));
  assign new_n82_ = (new_n71_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n68_ & ~x33));
  assign new_n83_ = x33 & ((new_n86_ & x15) | ~new_n84_ | (~new_n87_ & ~x15));
  assign new_n84_ = (x19 | (x16 & x17 & x18)) & new_n85_ & (x16 | (x11 & x17 & x18));
  assign new_n85_ = (x17 | (x12 & x18)) & (x13 | x18) & (x30 | ~x31) & (~x30 | x31);
  assign new_n86_ = x16 & x17 & x18 & (~x14 | x19);
  assign new_n87_ = x18 & x19 & x16 & x17;
  assign new_n88_ = ~x10 & (x26 | (x00 & ~x15 & x33));
endmodule
