// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:40 2020
...
module FAU ( 
  ...
  assign z6 = ~x26 & (x21 | (x01 & new_n62_ & ~new_n56_ & x25));
  assign new_n62_ = ~new_n54_ & ((x30 & (~x27 | ~x29 | (~x21 & ~x28))) | (x27 & x28 & x29 & ~x30));
  assign z7 = new_n66_ | ~new_n64_ | (x16 & new_n67_ & (x19 | x24));
  assign new_n64_ = x01 & ~new_n56_ & x25 & ~x26 & ~new_n65_ & (~x21 | x26);
  assign new_n65_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n66_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign new_n67_ = (x18 | x23) & (x17 | x22) & (x15 | x20);
  assign z8 = ~x26 & (x21 | (x00 & (new_n74_ | (new_n69_ & x31))));
  ...
  assign z9 = ~x26 & (x21 | (x00 & (new_n83_ | new_n84_ | new_n85_)));
