...
module FAU ( 
  ...
  assign new_n60_ = (~x02 | ~x03) & ~new_n55_ & (x27 ? (~x28 | ~x29) : x29);
  ...
  assign z7 = (~x28 & (~x29 | x31)) | ~new_n65_ | (x31 & (~x27 | ~x29 | ~x30));
  ...
  assign z8 = new_n47_ | (x00 & ~x26 & (new_n70_ | (~new_n75_ & x32)));
  assign new_n70_ = x31 & ~new_n71_ & ~new_n74_ & ~x32;
  ...
  assign new_n75_ = (x28 | (x27 ^ x30)) & ~new_n76_ & new_n77_ & ~new_n81_;
  ...
  assign new_n83_ = new_n88_ & (new_n47_ | (new_n84_ & ~new_n87_));
  ...
  assign new_n88_ = (~x30 | (x29 ? x31 : ~x28)) & (x30 | ((~x27 | ~x29) & (~x28 | (~x29 & ~x31)))) & (x27 | x28 | ~x29 | ~x31);
  assign new_n89_ = ~new_n71_ & ((x28 & (x29 ? (x30 & x31) : (~x30 & ~x31))) | (x29 & ((x27 & x30 & x31) | (~x27 & ~x28 & ~x30 & ~x31))));
endmodule
