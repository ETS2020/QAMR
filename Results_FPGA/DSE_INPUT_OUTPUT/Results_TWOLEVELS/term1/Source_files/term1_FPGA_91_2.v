...
module FAU ( 
  ...
  assign z8 = ~x26 & (x25 | (x00 & (~new_n58_ | (new_n54_ & x29))));
  ...
  assign new_n67_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n55_ & ~x33));
  assign new_n68_ = (new_n69_ | ~x33) & (new_n65_ | ((~x31 | ~x33) & (x30 | x31 | new_n55_ | x33)));
