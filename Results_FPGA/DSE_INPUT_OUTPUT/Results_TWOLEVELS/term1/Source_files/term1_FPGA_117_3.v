...
module FAU ( 
  ...
  assign new_n59_ = ~new_n55_ & ((x28 & (~x27 ^ ~x29)) | (~x26 & ~x28 & x29));
  assign z6 = new_n47_ | (x01 & x25 & new_n61_ & (~x02 | ~x03));
  assign new_n61_ = ~new_n55_ & ((x30 & ((~x27 & x28) | (~x26 & (~x28 | ~x29)))) | (x27 & x28 & x29 & ~x30));
  ...
  assign z9 = (x26 & x28) | (x00 & (new_n81_ | (~x26 & (new_n83_ | new_n85_))));
  assign new_n81_ = x29 & ~new_n82_ & ((~x31 & x33) | (x30 & x31 & ~new_n69_ & ~x33));
