...
module FAU ( 
  ...
  assign z8 = ~x26 & (~x13 | (~new_n69_ & x00));
  ...
  assign new_n83_ = ~new_n81_ & ((~x31 & x33) | (x30 & x31 & ~new_n84_ & ~x33));
  assign new_n84_ = ~new_n73_ & ((~new_n71_ & ~new_n72_) | ~x15);
  assign new_n85_ = (new_n86_ | ((~x31 | ~x33) & (x30 | x31 | new_n84_ | x33))) & (new_n87_ | ~x33);
  assign new_n86_ = ~new_n81_ & x29;
  assign new_n87_ = ~new_n88_ & ~new_n75_ & ~new_n89_ & ~new_n90_ & new_n91_;
  assign new_n88_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n89_ = ~x19 & (~x15 | ~x16 | ~x17);
  assign new_n90_ = ~x15 & (~x10 | ~x16 | ~x17);
