...
module FAU ( 
  ...
  assign z5 = (~x22 & x26) | (x01 & new_n59_ & x25);
  assign new_n59_ = ~new_n54_ & ~new_n60_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign new_n60_ = (x17 | x22) & (x26 | (new_n55_ & new_n56_));
  assign z6 = (~x22 & x26) | (x01 & new_n62_ & x25);
  assign new_n62_ = ~new_n54_ & ~new_n60_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = (~x26 & (new_n67_ | ~new_n65_ | (new_n64_ & x17))) | (x22 & (new_n64_ | x26));
  assign new_n64_ = (x19 | x24) & new_n55_ & (x18 | x23);
  assign new_n65_ = new_n66_ & ~new_n54_ & x01;
  assign new_n66_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n67_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign z8 = (~x22 & x26) | (x00 & ~x26 & (new_n74_ | (new_n69_ & x31)));
  ...
  assign z9 = (~x22 & x26) | (x00 & ~x26 & (new_n83_ | new_n84_ | new_n85_));
