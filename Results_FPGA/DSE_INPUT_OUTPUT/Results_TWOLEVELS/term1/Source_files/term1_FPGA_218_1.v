// Benchmark "FAU" written by ABC on Mon Aug 24 22:09:23 2020
...
module FAU ( 
  ...
  assign z9 = new_n87_ | (x00 & ~x26 & (~new_n83_ | (new_n82_ & x29)));
  assign new_n82_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n69_ & ~x33));
  assign new_n83_ = (new_n86_ | ((~x31 | ~x33) & (x30 | x31 | new_n69_ | x33))) & (new_n84_ | ~x33);
  assign new_n84_ = ~new_n73_ & ~new_n74_ & ~new_n75_ & ~new_n76_ & new_n77_ & new_n85_;
