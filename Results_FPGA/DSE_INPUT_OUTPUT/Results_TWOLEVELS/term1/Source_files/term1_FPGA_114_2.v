// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:27 2020
...
module FAU ( 
  ...
  assign z3 = ~x26 & (x00 | (x01 & x25 & new_n58_ & ~x27));
  ...
  assign z4 = ~x00 & x01 & x25 & new_n63_ & ~x26;
  ...
  assign z6 = ~x00 & x01 & x25 & new_n67_ & ~new_n59_ & ~x26;
  assign new_n67_ = (~new_n60_ | ~new_n61_) & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = x26 | (~new_n69_ & ~x00);
  assign new_n69_ = ~new_n72_ & (new_n71_ | new_n70_ | ~new_n73_) & new_n74_ & new_n75_;
  assign new_n70_ = ~x18 & ~x23;
  assign new_n71_ = ~x19 & ~x24;
  assign new_n72_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign new_n73_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n74_ = x01 & (~x02 | ~x03);
  assign new_n75_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign z8 = 1'b0;
  assign z9 = 1'b0;
endmodule
