...
module FAU ( 
  ...
  assign new_n77_ = x00 & (~x32 | (~new_n82_ & ~new_n78_ & new_n80_));
  ...
  assign new_n84_ = ~new_n75_ & ((~x31 & x33) | (x30 & x31 & ~new_n71_ & ~x33));
  assign new_n85_ = (new_n75_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n71_ & ~x33));
  assign new_n86_ = x33 & (~new_n87_ | (~x15 & (~new_n73_ | ~x10 | ~x16)));
  assign new_n87_ = ~new_n88_ & ~new_n89_ & ~new_n90_ & new_n91_ & (~x30 | x31) & (x30 | ~x31);
  assign new_n88_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign new_n89_ = ~x17 & (~x12 | ~x18 | ~x19);
  assign new_n90_ = ~x18 & (~x13 | ~x19);
  assign new_n91_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
endmodule
