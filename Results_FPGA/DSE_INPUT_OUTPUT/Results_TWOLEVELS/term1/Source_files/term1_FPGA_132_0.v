// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:37 2020
...
module FAU ( 
  ...
  assign new_n73_ = (new_n81_ | (x30 ? (~x31 | new_n70_ | x32) : ~x32)) & (new_n74_ | ~x32);
  ...
  assign new_n79_ = ~x14 & ~x19;
  assign new_n80_ = x31 & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n81_ = x29 & (x27 | x28);
  assign z9 = x00 & ~x26 & (new_n84_ | new_n85_ | (new_n83_ & x29));
  assign new_n83_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n70_ & ~x33));
  assign new_n84_ = ~new_n81_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n70_ & ~x33));
  assign new_n85_ = x33 & (new_n75_ | new_n76_ | ~new_n86_ | new_n77_);
  assign new_n86_ = ~new_n78_ & new_n87_ & (x30 | ~x31) & (~x30 | x31);
  assign new_n87_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
endmodule
