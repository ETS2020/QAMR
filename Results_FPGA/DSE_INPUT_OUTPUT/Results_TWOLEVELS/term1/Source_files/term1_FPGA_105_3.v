...
module FAU ( 
  ...
  assign z8 = x00 & (new_n69_ | ~new_n75_ | (new_n74_ & x29));
  ...
  assign new_n74_ = (x27 | x28) & (x30 ? x32 : (x31 & ~new_n70_ & ~x32));
  assign new_n75_ = ~x26 & (~x32 | (~new_n76_ & ~new_n80_ & new_n77_ & ~new_n81_));
  ...
  assign z9 = x00 & (new_n84_ | ~new_n85_ | (new_n83_ & x29));
  assign new_n83_ = (x27 | x28) & ((x30 & x31 & ~new_n70_ & ~x33) | (~x31 & x33));
  assign new_n84_ = ~new_n73_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n70_ & ~x33));
  assign new_n85_ = ~x26 & (~x33 | (~new_n76_ & ~new_n80_ & new_n86_ & ~new_n81_));
