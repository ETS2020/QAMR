...
module FAU ( 
  ...
  assign z5 = (~x23 & x26) | (x01 & x25 & new_n60_ & ~new_n57_);
  assign new_n60_ = ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29)) & (new_n61_ | (~x18 & ~x23));
  assign new_n61_ = ~x26 & (~new_n55_ | new_n56_ | (~x19 & ~x24));
  ...
  assign z9 = (~x23 & x26) | (x00 & ~x26 & (new_n83_ | new_n84_ | new_n85_));
