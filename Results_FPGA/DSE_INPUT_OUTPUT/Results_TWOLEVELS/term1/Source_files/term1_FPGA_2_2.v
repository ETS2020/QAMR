...
module FAU ( 
  ...
  assign z0 = z9 | ~x32;
  assign z9 = x00 & ~x26;
  assign z1 = ~z9 & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  assign z2 = x08 & ~x09 & ((~new_n50_ & (x04 ^ ~x07)) | (~new_n54_ & (~x04 ^ ~x07)));
  assign new_n50_ = (new_n51_ | x02) & ~new_n53_ & (~new_n52_ | ~x02);
  assign new_n51_ = ((x00 & ~x26) | (x01 ? x03 : (~x03 | ~x06))) & (x03 | ~x26 | (~x05 ^ x06)) & (x05 | ~x06 | x00 | x01);
  ...
  assign z7 = x26 | (~new_n70_ & ~x00);
  assign new_n70_ = ~new_n73_ & (new_n72_ | new_n71_ | ~new_n74_) & new_n75_ & new_n76_;
  ...
  assign new_n76_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign z8 = 1'b0;
endmodule
