...
module FAU ( 
  ...
  assign z3 = x01 & x25 & ~x26 & ~x27 & new_n58_ & ~x28;
  assign new_n58_ = (~new_n59_ | ~new_n60_) & (~x02 | ~x03);
  assign new_n59_ = (x15 | x20) & (x16 | x21);
  assign new_n60_ = (x17 | x22) & (x18 | x23) & (x19 | x24);
  assign z4 = x01 & x25 & ~x26 & x27 & new_n58_ & ~x28;
  assign z5 = x01 & x25 & ~x26 & ~x28 & new_n58_ & x29;
  assign z6 = x01 & x25 & ~x26 & ~x28 & new_n58_ & x30;
  assign z7 = x26 | (~x28 & (~new_n66_ | (new_n65_ & (x19 | x24))));
  assign new_n65_ = (x18 | x23) & new_n59_ & (x17 | x22);
  assign new_n66_ = x25 & ~x31 & x01 & (~x02 | ~x03);
  ...
  assign new_n101_ = (x17 | (x12 & x18)) & (x13 | x18) & (~x30 | x31);
endmodule
