// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:05 2020
...
module FAU ( 
  ...
  assign z4 = (~x12 & x26) | (x01 & x25 & new_n57_ & ~x26);
  ...
  assign z6 = (~x12 & x26) | (x01 & x25 & new_n61_ & ~x26);
  assign new_n61_ = ~new_n55_ & ~new_n53_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = x26 ? x12 : (~new_n63_ | (x31 & (~new_n67_ | ~new_n68_)));
  ...
  assign z8 = (~x12 & (x26 | (x00 & ~x17 & x32))) | (x00 & ~new_n70_ & ~x26);
  assign new_n70_ = (~x31 | x32 | new_n71_ | new_n81_) & (~x32 | (new_n74_ & ~new_n82_));
  ...
  assign new_n76_ = ~x15 & (~x18 | ~x19 | ~x10 | ~x16);
  assign new_n77_ = ~x16 & (~x11 | ~x18 | ~x19);
  assign new_n78_ = ~x18 & (~x13 | ~x19);
  assign new_n79_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n80_ = (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n81_ = (~x29 | x30 | (~x27 & ~x28)) & (~x30 | (x29 & (x27 | x28)));
  assign new_n82_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign z9 = x00 & ~x26 & (new_n85_ | new_n87_ | (new_n84_ & x29));
  assign new_n84_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n71_ & ~x33));
  assign new_n85_ = ~new_n86_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n71_ & ~x33));
