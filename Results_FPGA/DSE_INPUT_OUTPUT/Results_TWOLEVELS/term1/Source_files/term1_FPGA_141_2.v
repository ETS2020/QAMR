...
module FAU ( 
  ...
  assign z8 = ~x26 & (x14 | (x00 & (~new_n79_ | (new_n74_ & x29))));
  assign new_n74_ = ~new_n78_ & ((x30 & x32) | (x19 & new_n75_ & ~x30));
  assign new_n75_ = x31 & ~x32 & (new_n77_ | (~new_n76_ & x15));
  assign new_n76_ = (~x16 | ((~x12 | x17 | ~x18) & (~x13 | ~x17 | x18))) & (~x11 | x16 | ~x17 | ~x18);
  assign new_n77_ = x10 & ~x15 & x16 & x17 & x18;
  assign new_n78_ = ~x27 & ~x28;
  assign new_n79_ = (new_n80_ | ((x30 | ~x32) & (~x19 | ~new_n75_ | ~x30))) & (new_n81_ | ~x32);
  assign new_n80_ = ~new_n78_ & x29;
  assign new_n81_ = ~new_n82_ & ~new_n83_ & ~new_n84_ & new_n85_ & x19 & x31;
  assign new_n82_ = ~x15 & (~x17 | ~x18 | ~x10 | ~x16);
  assign new_n83_ = ~x16 & (~x11 | ~x17 | ~x18);
  assign new_n84_ = ~x17 & (~x12 | ~x18);
  assign new_n85_ = (~x17 | ~x18 | ~x15 | ~x16) & (x13 | x18);
  assign z9 = x00 & ~x14 & ~x26 & (~new_n89_ | (new_n87_ & x29));
  assign new_n87_ = ~new_n78_ & ((~x31 & x33) | (x19 & x30 & x31 & ~new_n88_ & ~x33));
  assign new_n88_ = ~new_n77_ & (new_n76_ | ~x15);
  assign new_n89_ = (new_n91_ | ~x33) & (new_n80_ | ((~x31 | ~x33) & (~new_n90_ | ~x19)));
