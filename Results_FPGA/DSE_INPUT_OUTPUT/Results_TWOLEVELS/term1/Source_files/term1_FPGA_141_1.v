...
module FAU ( 
  ...
  assign z3 = (~x14 & x26) | (x01 & x25 & new_n53_ & ~x26);
  ...
  assign z8 = (~x14 & (x26 | (x00 & ~x19 & x32))) | (x00 & ~new_n68_ & ~x26);
  ...
  assign new_n77_ = (x13 | x18) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  ...
  assign new_n83_ = (new_n87_ | ((~x31 | ~x33) & (x30 | x31 | new_n69_ | x33))) & (new_n84_ | ~x33);
  assign new_n84_ = ~new_n85_ & ~new_n73_ & ~new_n74_ & ~new_n75_ & new_n86_;
