// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:38 2020
...
module FAU ( 
  ...
  assign z8 = (x21 & x26) | (x00 & ~x26 & (new_n71_ | (new_n67_ & x31)));
  assign new_n67_ = ~x32 & ~new_n68_ & ((x29 & ~x30 & (x27 | x28)) | (x30 & (~x29 | (~x27 & ~x28))));
  ...
  assign new_n71_ = x32 & (new_n77_ | new_n72_ | ~new_n73_ | new_n78_);
  assign new_n72_ = ~x15 & (~new_n70_ | ~x10 | ~x16);
