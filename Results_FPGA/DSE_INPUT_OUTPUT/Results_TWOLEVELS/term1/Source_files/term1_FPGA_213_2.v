...
module FAU ( 
  ...
  assign z3 = ~x00 & x01 & x25 & ~x26 & new_n59_ & ~x27;
  ...
  assign z4 = ~x00 & x01 & x25 & new_n64_ & ~x26;
  ...
  assign z6 = ~x26 & (x00 | (x01 & new_n68_ & ~new_n60_ & x25));
  assign new_n68_ = ~new_n69_ & (~new_n61_ | ~new_n62_);
  assign new_n69_ = (~x30 | (x27 & x29 & (x00 | x28))) & (~x29 | x30 | ~x27 | ~x28);
  assign z7 = (~new_n71_ & ~x00) | x26;
  assign new_n71_ = ~new_n74_ & (new_n73_ | new_n72_ | ~new_n75_) & new_n76_ & new_n77_;
  assign new_n72_ = ~x18 & ~x23;
  assign new_n73_ = ~x19 & ~x24;
  assign new_n74_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign new_n75_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n76_ = x01 & (~x02 | ~x03);
  assign new_n77_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign z9 = 1'b0;
endmodule
