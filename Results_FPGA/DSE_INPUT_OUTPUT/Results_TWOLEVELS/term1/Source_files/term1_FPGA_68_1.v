...
module FAU ( 
  ...
  assign new_n54_ = (x16 | x21) & (x26 | (new_n55_ & new_n56_));
  assign new_n55_ = (x15 | x20) & (x17 | x22);
  assign new_n56_ = (x18 | x23) & (x19 | x24);
  assign z4 = x01 & new_n58_ & x25;
  assign new_n58_ = ~x26 & ~new_n59_ & (~x02 | ~x03) & (x27 ^ x28);
  assign new_n59_ = new_n60_ & (x15 | x20) & (x16 | x21);
  assign new_n60_ = (x17 | x22) & (x18 | x23) & (x19 | x24);
  assign z5 = x01 & x25 & new_n62_ & ~x26;
  assign new_n62_ = (~x02 | ~x03) & ~new_n59_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = x01 & x25 & ~x26 & new_n64_ & (~x02 | ~x03);
  assign new_n64_ = ~new_n59_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = (~x26 & (new_n69_ | ~new_n67_ | (new_n66_ & x16))) | (x21 & (new_n66_ | x26));
  assign new_n66_ = (x19 | x24) & new_n55_ & (x18 | x23);
  ...
  assign z9 = (~x21 & x26) | (x00 & ~x26 & (new_n85_ | new_n86_ | new_n87_));
