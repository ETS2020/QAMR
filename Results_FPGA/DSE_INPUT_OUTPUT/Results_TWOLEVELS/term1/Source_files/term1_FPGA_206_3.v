// Benchmark "FAU" written by ABC on Mon Aug 24 22:09:17 2020
...
module FAU ( 
  ...
  assign z3 = new_n47_ | (new_n53_ & x01);
  ...
  assign z4 = new_n47_ | (x01 & new_n57_ & x25);
  assign new_n57_ = ~x26 & ~new_n54_ & (~x02 | ~x03) & (x27 ^ x28);
  assign z5 = new_n47_ | (x01 & x25 & new_n59_ & ~x26);
  assign new_n59_ = (~x02 | ~x03) & ~new_n54_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = new_n47_ | (x01 & x25 & new_n61_ & ~x26);
  ...
  assign new_n65_ = x01 & ~new_n47_ & (~x02 | ~x03) & new_n66_ & x25;
  assign new_n66_ = ~x26 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n67_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign z8 = new_n47_ | (x00 & ~x26 & (new_n74_ | (new_n69_ & x31)));
  ...
  assign z9 = x00 & ~x26 & ~new_n47_ & (new_n83_ | new_n84_ | new_n85_);
