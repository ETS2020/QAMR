...
module FAU ( 
  ...
  assign z1 = (x02 & (x03 ? ~x33 : ~x32)) | (~x06 & x26) | (~x02 & (x03 ? ~x32 : ~x33));
  ...
  assign z5 = (~x06 & x26) | (x01 & x25 & new_n59_ & ~x26);
  assign new_n59_ = ~new_n56_ & ~new_n54_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = (~x06 & x26) | (x01 & x25 & new_n61_ & ~x26);
  ...
  assign z8 = (~x06 & x26) | (x00 & ~x26 & (new_n73_ | (new_n68_ & x31)));
  ...
  assign z9 = (~x06 & x26) | (x00 & ~x26 & (new_n82_ | new_n83_ | new_n84_));
