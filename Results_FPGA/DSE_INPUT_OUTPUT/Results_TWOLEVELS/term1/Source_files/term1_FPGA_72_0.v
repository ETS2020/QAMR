...
module FAU ( 
  ...
  assign z6 = ~x26 & (~x00 | (x01 & x25 & new_n62_ & ~new_n56_));
  assign new_n62_ = ~new_n54_ & ((x30 & (~x27 | (x00 & (~x28 | ~x29)))) | (x27 & x28 & x29 & ~x30));
  ...
  assign z8 = ~x26 & (new_n73_ | ~x00 | (new_n69_ & x31));
  ...
  assign new_n73_ = x32 & (~new_n74_ | (~x28 & (x27 ? (x29 & x30) : ~x30)));
  ...
  assign new_n80_ = x31 & (x29 | x30) & (~x28 | ~x29 | ~x30);
  ...
  assign new_n84_ = ~new_n75_ & ~new_n76_ & ~new_n77_ & ~new_n78_ & new_n79_ & new_n85_;
  assign new_n85_ = x30 ^ ~x31;
