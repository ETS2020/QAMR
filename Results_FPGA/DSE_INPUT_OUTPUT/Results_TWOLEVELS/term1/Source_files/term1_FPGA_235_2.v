...
module FAU ( 
  ...
  assign z4 = x01 & ~x19 & x25 & new_n58_ & ~x26;
  ...
  assign z6 = ~x26 & (x19 | (x01 & new_n62_ & ~new_n54_ & x25));
  assign new_n62_ = (~new_n55_ | ~new_n56_) & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = x26 | (~x19 & (~new_n64_ | new_n68_));
  assign new_n64_ = new_n66_ & new_n67_ & (~x24 | ~new_n65_ | (~x18 & ~x23));
  ...
  assign z8 = ~x26 & (x19 | (x00 & (~new_n73_ | (new_n70_ & x29))));
  assign new_n70_ = ~new_n71_ & ((x30 & x32) | (new_n72_ & x18 & ~x30 & x31 & ~x32));
  assign new_n71_ = ~x27 & ~x28;
  assign new_n72_ = x16 & x17 & x14 & x15;
  assign new_n73_ = (new_n74_ | ((x30 | ~x32) & (~new_n72_ | ~new_n75_))) & (new_n76_ | ~x32);
  assign new_n74_ = x29 & (x27 | x28);
  assign new_n75_ = x31 & ~x32 & x18 & x30;
  assign new_n76_ = x14 & x15 & x16 & x17 & x18 & x31;
  assign z9 = ~x26 & (x19 | (x00 & (new_n78_ | new_n80_ | new_n81_)));
  assign new_n78_ = x29 & ~new_n71_ & ((~x31 & x33) | (new_n72_ & new_n79_ & x31 & ~x33));
  assign new_n79_ = x18 & x30;
  assign new_n80_ = ~new_n74_ & ((x31 & x33) | (new_n72_ & x18 & ~x30 & ~x31 & ~x33));
  assign new_n81_ = x33 & (~new_n82_ | ~x14 | ~x15 | ~x16);
  assign new_n82_ = (~x30 | x31) & (x30 | ~x31) & x17 & x18;
endmodule
