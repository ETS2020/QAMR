...
module FAU ( 
  ...
  assign z1 = (~x16 | ~x26) & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  ...
  assign z7 = x26 ? ~x16 : (~new_n63_ | new_n67_);
  ...
  assign z8 = (x16 & x26) | (x00 & (new_n74_ | (new_n69_ & x31)));
  assign new_n69_ = ~x32 & ~new_n70_ & ((x29 & ~x30 & (x27 | x28)) | (x30 & (~x29 | (~x27 & ~x28))));
  assign new_n70_ = ~new_n73_ & (~x15 | (~new_n72_ & (new_n71_ | ~x16)));
  assign new_n71_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n72_ = x18 & x19 & ~x26 & x11 & ~x16 & x17;
  assign new_n73_ = x10 & ~x15 & x16 & x17 & x18 & x19;
  assign new_n74_ = x32 & (new_n77_ | (~x26 & (new_n79_ | ~new_n75_ | new_n80_)));
  assign new_n75_ = (x17 | (x16 & x18 & x19)) & (x18 | (x16 & x19)) & new_n76_ & (x16 | (x11 & x19));
  assign new_n76_ = x31 & (x29 | x30) & (~x28 | ~x29 | ~x30);
  assign new_n77_ = x16 & (~new_n78_ | (~x10 & ~x15) | (~x12 & ~x17));
  assign new_n78_ = (x13 | x18) & (x14 | x19) & (~x15 | ~x17 | ~x18 | ~x19);
  assign new_n79_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign new_n80_ = ~x15 & (~x16 | ~x17 | ~x18 | ~x19);
  assign z9 = x00 & ~x26 & (~new_n85_ | (new_n82_ & x29));
  assign new_n82_ = (x27 | x28) & ((~x31 & x33) | (x30 & new_n83_ & x31));
  assign new_n83_ = ~x33 & (new_n73_ | (x15 & (new_n84_ | (~new_n71_ & x16))));
  assign new_n84_ = x11 & ~x16 & x17 & x18 & x19;
  assign new_n85_ = (new_n92_ | ((~x31 | ~x33) & (x30 | ~new_n83_ | x31))) & (new_n86_ | ~x33);
