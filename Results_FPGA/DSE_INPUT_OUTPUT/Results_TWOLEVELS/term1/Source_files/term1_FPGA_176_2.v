...
module FAU ( 
  ...
  assign new_n63_ = (~x30 | (x27 & x29 & (x18 | x28))) & (~x27 | ~x28 | ~x29 | x30);
  assign z7 = x26 | (~x18 & (~new_n65_ | new_n69_));
  assign new_n65_ = new_n67_ & new_n68_ & (~x23 | ~new_n66_ | (~x19 & ~x24));
  ...
  assign z8 = x00 & ~x18 & ~x26 & (~new_n74_ | (new_n71_ & x29));
  assign new_n71_ = ~new_n72_ & ((x30 & x32) | (new_n73_ & x19 & ~x30 & x31 & ~x32));
  ...
  assign new_n76_ = x31 & ~x32 & x19 & x30;
  assign new_n77_ = x13 & x15 & x16 & x17 & x19 & x31;
  assign z9 = x00 & ~x18 & ~x26 & (new_n79_ | new_n81_ | new_n82_);
  assign new_n79_ = x29 & ~new_n72_ & ((~x31 & x33) | (new_n73_ & new_n80_ & x31 & ~x33));
  assign new_n80_ = x19 & x30;
  assign new_n81_ = ~new_n75_ & ((x31 & x33) | (new_n73_ & x19 & ~x30 & ~x31 & ~x33));
