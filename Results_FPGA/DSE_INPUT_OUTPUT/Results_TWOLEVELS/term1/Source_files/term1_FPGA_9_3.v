...
module FAU ( 
  ...
  assign z7 = (~x31 & (new_n65_ | x26)) | (~x26 & (~new_n62_ | (~new_n65_ & x31)));
  ...
  assign z8 = x00 & ~x26 & (new_n72_ | new_n73_ | (new_n67_ & x29));
  ...
  assign new_n78_ = x31 & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign z9 = x00 & ~x26 & (new_n81_ | new_n82_ | (new_n80_ & x29));
  assign new_n80_ = ~new_n71_ & ((x30 & x31 & ~new_n68_ & ~x33) | (~x31 & x33));
