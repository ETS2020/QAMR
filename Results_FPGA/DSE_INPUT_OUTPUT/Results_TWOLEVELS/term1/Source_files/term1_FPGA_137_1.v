...
module FAU ( 
  ...
  assign z1 = (x02 & (x03 ? ~x33 : ~x32)) | (~x04 & x26) | (~x02 & (x03 ? ~x32 : ~x33));
  ...
  assign z3 = (~x04 & x26) | (x01 & x25 & new_n53_ & ~x26);
  ...
  assign z4 = (~x04 & x26) | (x01 & x25 & new_n58_ & ~x26);
  assign new_n58_ = ~new_n54_ & ~new_n56_ & (x27 ^ x28);
  assign z5 = (~x04 & x26) | (x01 & x25 & new_n60_ & ~x26);
  assign new_n60_ = ~new_n56_ & ~new_n54_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = (~x04 & x26) | (x01 & x25 & new_n62_ & ~x26);
  ...
  assign z8 = (~x04 & x26) | (x00 & ~x26 & (new_n73_ | (new_n69_ & x31)));
