// Benchmark "FAU" written by ABC on Mon Aug 24 22:09:07 2020
...
module FAU ( 
  ...
  assign new_n50_ = (~x01 | (~x02 ^ ~x03)) & (x03 | ~x05 | (x02 ? x01 : x06)) & (x01 | x02 | ~x06 | (~x03 & x05));
  assign new_n51_ = (~x01 | (~x02 ^ x03)) & (x01 | ((~x02 | (~x03 & x05)) & (x02 | x03 | ~x05 | ~x06) & (x05 | x06))) & (x02 | ~x03 | x06);
  assign z3 = ~x26 & (new_n53_ | ~x06);
  ...
  assign new_n65_ = x01 & ~new_n56_ & x25 & ~x26 & ~new_n66_ & (x06 | x26);
  assign new_n66_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n67_ = (x17 | x22) & (x16 | x21) & (x15 | x20);
  assign z8 = x00 & x06 & ~x26 & (new_n74_ | (new_n69_ & x31));
  ...
  assign z9 = ~x26 & (~x06 | (x00 & (new_n83_ | new_n84_ | new_n85_)));
