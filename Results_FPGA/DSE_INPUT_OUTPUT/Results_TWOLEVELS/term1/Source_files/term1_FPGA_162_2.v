...
module FAU ( 
  ...
  assign new_n70_ = x31 & ~x32 & (new_n72_ | (~new_n71_ & x15));
  assign new_n71_ = (~x16 | ((~x12 | x17 | ~x18) & (~x13 | ~x17 | x18))) & (~x11 | x16 | ~x17 | ~x18);
  assign new_n72_ = x10 & ~x15 & x16 & x17 & x18;
  ...
  assign new_n82_ = ~new_n73_ & ((~x31 & x33) | (x19 & x30 & x31 & ~new_n83_ & ~x33));
  assign new_n83_ = ~new_n72_ & (new_n71_ | ~x15);
  assign new_n84_ = (new_n86_ | ~x33) & (new_n75_ | ((~x31 | ~x33) & (~new_n85_ | ~x19)));
  assign new_n85_ = ~x30 & ~x31 & ~x33 & (new_n72_ | (~new_n71_ & x15));
  assign new_n86_ = ~new_n77_ & ~new_n78_ & ~new_n79_ & ~new_n87_ & new_n88_;
  assign new_n87_ = ~x16 & (~x11 | ~x17);
  assign new_n88_ = (x30 | ~x31) & (~x30 | x31) & x19 & (x12 | x17);
endmodule
