...
module FAU ( 
  ...
  assign z8 = x00 & (new_n68_ | ~new_n74_ | (new_n73_ & x29));
  ...
  assign new_n73_ = (x27 | x28) & (x30 ? x32 : (x31 & ~new_n69_ & ~x32));
  assign new_n74_ = ~x26 & (~x32 | (~new_n75_ & ~new_n79_ & new_n76_ & ~new_n80_));
  assign new_n75_ = ~x15 & (~new_n71_ | ~x10 | ~x16);
  assign new_n76_ = ~new_n77_ & (x14 | x19) & ~new_n78_ & x31;
  ...
  assign z9 = x00 & (new_n83_ | ~new_n84_ | (new_n82_ & x29));
  assign new_n82_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n69_ & ~x33));
  assign new_n83_ = ~new_n72_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n69_ & ~x33));
  assign new_n84_ = ~x26 & (~x33 | (~new_n75_ & ~new_n79_ & new_n85_ & ~new_n80_));
  assign new_n85_ = ~new_n77_ & (x30 | ~x31) & (~x30 | x31) & ~new_n78_ & (x14 | x19);
endmodule
