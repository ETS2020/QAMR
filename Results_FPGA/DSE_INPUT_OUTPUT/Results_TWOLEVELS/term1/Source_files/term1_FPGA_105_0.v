...
module FAU ( 
  ...
  assign z8 = ~x26 & (new_n70_ | ~new_n76_ | (new_n75_ & x29));
  assign new_n70_ = ~new_n74_ & ((x30 & x31 & ~new_n71_ & ~x32) | (x00 & ~x30 & x32));
  ...
  assign new_n75_ = (x27 | x28) & (x30 ? x32 : (x31 & ~new_n71_ & ~x32));
  ...
  assign z9 = ~x26 & ((new_n83_ & x29) | new_n84_ | new_n85_ | ~x00);
  assign new_n83_ = (x27 | x28) & ((x30 & x31 & ~new_n71_ & ~x33) | (~x31 & x33));
  assign new_n84_ = ~new_n74_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n71_ & ~x33));
  assign new_n85_ = x33 & (new_n79_ | new_n80_ | new_n81_ | new_n78_ | ~new_n86_);
