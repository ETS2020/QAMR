...
module FAU ( 
  ...
  assign z5 = x01 & ~x14 & x25 & new_n60_ & ~x26;
  assign new_n60_ = ~new_n56_ & ~new_n54_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = ~x26 & (x14 | (x01 & new_n62_ & ~new_n56_ & x25));
  assign new_n62_ = ~new_n54_ & ((x30 & (~x27 | ~x29 | (~x14 & ~x28))) | (x27 & x28 & x29 & ~x30));
  ...
  assign new_n69_ = (~x19 | ~x31 | ~new_n70_ | x32) & (~x32 | (new_n74_ & ~new_n81_));
  assign new_n70_ = ((x29 & ~new_n71_ & ~x30) | (x30 & (new_n71_ | ~x29))) & (new_n73_ | (~new_n72_ & x15));
  assign new_n71_ = ~x27 & ~x28;
  assign new_n72_ = (~x16 | ((~x12 | x17 | ~x18) & (~x13 | ~x17 | x18))) & (~x11 | x16 | ~x17 | ~x18);
  assign new_n73_ = x10 & ~x15 & x16 & x17 & x18;
  assign new_n74_ = ~new_n75_ & ~new_n76_ & ~new_n77_ & ~new_n78_ & new_n79_ & new_n80_;
  assign new_n75_ = ~x27 & (x28 ? (x29 & x30) : ~x30);
  assign new_n76_ = ~x18 & (~x15 | ~x16 | ~x17);
  assign new_n77_ = ~x15 & (~x10 | ~x16 | ~x17);
  assign new_n78_ = ~x16 & (~x11 | ~x17);
  assign new_n79_ = x19 & (x12 | x17);
  assign new_n80_ = (~x27 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n81_ = x15 & x16 & x17 & (~x13 | x18);
  assign z9 = ~x26 & (x14 | (x00 & (~new_n85_ | (new_n83_ & x29))));
  assign new_n83_ = ~new_n71_ & ((~x31 & x33) | (x19 & x30 & x31 & ~new_n84_ & ~x33));
  assign new_n84_ = ~new_n73_ & (new_n72_ | ~x15);
  assign new_n85_ = (new_n86_ | ((~x31 | ~x33) & (~new_n87_ | ~x19))) & (new_n88_ | ~x33);
  assign new_n86_ = ~new_n71_ & x29;
  assign new_n87_ = ~x30 & ~x31 & ~x33 & (new_n73_ | (~new_n72_ & x15));
  assign new_n88_ = ~new_n81_ & ~new_n76_ & ~new_n77_ & ~new_n78_ & new_n89_;
  assign new_n89_ = (x30 | ~x31) & (~x30 | x31) & x19 & (x12 | x17);
endmodule
