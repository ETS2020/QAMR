...
module FAU ( 
  ...
  assign z5 = ~x26 & (~x00 | (x01 & new_n60_ & x25));
  assign new_n60_ = ~new_n56_ & ~new_n54_ & ((x29 & (~x27 | (x00 & ~x28))) | (x27 & x28 & ~x29));
  ...
  assign new_n65_ = x01 & ~new_n56_ & x25 & ~x26 & ~new_n66_ & (x00 | x26);
  assign new_n66_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n67_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign z8 = ~x26 & (new_n74_ | ~new_n75_ | (new_n69_ & x29));
  ...
  assign new_n75_ = x00 & (~x32 | (~new_n76_ & ~new_n80_ & new_n77_ & ~new_n81_));
  assign new_n76_ = ~x15 & (~new_n72_ | ~x10 | ~x16);
  assign new_n77_ = ~new_n78_ & (x14 | x19) & ~new_n79_ & x31;
  assign new_n78_ = ~x18 & (~x13 | ~x19);
  assign new_n79_ = x15 & x16 & x17 & x18 & x19;
  assign new_n80_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign new_n81_ = ~x17 & (~x12 | ~x18 | ~x19);
  assign z9 = ~x26 & (new_n84_ | ~new_n85_ | (new_n83_ & x29));
  assign new_n83_ = ~new_n73_ & ((~x31 & x33) | (x30 & x31 & ~new_n70_ & ~x33));
  assign new_n84_ = (new_n73_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n70_ & ~x33));
  assign new_n85_ = x00 & (~x33 | (~new_n76_ & ~new_n80_ & new_n86_ & ~new_n81_));
  assign new_n86_ = ~new_n78_ & ~new_n79_ & (x14 | x19) & (~x30 | x31) & (x30 | ~x31);
endmodule
