// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:53 2020
...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  assign z1 = (x02 & (x03 ? (x32 & ~x33) : (~x26 & ~x32))) | (~x02 & (x03 ? (~x26 & ~x32) : (x32 & ~x33))) | (~x26 & ~x32 & ~x33);
  ...
  assign z4 = (x26 & ~x32) | (x01 & x25 & new_n56_ & ~x26);
  ...
  assign z6 = (x26 & ~x32) | (x01 & x25 & new_n60_ & ~x26);
  assign new_n60_ = ~new_n54_ & ~new_n52_ & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  ...
  assign new_n71_ = ~new_n76_ & (x15 | (new_n70_ & new_n77_)) & new_n72_ & ~new_n78_;
