// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:16 2020
...
module FAU ( 
  ...
  assign z5 = (x26 & x27) | (x01 & new_n59_ & x25);
  assign new_n59_ = ~new_n56_ & ~new_n54_ & ((~x26 & x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = x01 & x25 & ~x26 & new_n61_ & ~new_n56_;
