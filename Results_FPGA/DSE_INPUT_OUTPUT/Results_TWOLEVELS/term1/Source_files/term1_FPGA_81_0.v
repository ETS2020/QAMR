...
module FAU ( 
  ...
  assign new_n73_ = new_n74_ & (x28 | (x27 ? (~x29 | ~x30) : x30));
  ...
  assign z9 = ~x26 & (new_n83_ | ~new_n85_ | (new_n82_ & x29));
  ...
  assign new_n85_ = x00 & (~x33 | (~new_n75_ & ~new_n76_ & new_n86_ & ~new_n77_));
  assign new_n86_ = ~new_n78_ & new_n79_ & (x30 | ~x31) & (~x30 | x31);
endmodule
