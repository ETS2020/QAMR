...
module FAU ( 
  ...
  assign z1 = (~x05 | x26) & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  ...
  assign z8 = x00 & ~x05 & ~x26 & (new_n70_ | new_n75_ | new_n76_);
  ...
  assign z9 = x00 & ~x05 & ~x26 & (new_n83_ | new_n84_ | new_n85_);
  assign new_n83_ = x29 & ~new_n74_ & ((~x31 & x33) | (x30 & x31 & ~new_n71_ & ~x33));
  assign new_n84_ = (new_n74_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n71_ & ~x33));
