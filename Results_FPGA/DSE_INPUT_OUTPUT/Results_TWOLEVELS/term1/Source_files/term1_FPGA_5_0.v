...
module FAU ( 
  ...
  assign new_n69_ = x02 & (~x00 | x03);
  assign z7 = x26 | (x00 & (~new_n71_ | new_n75_));
  assign new_n71_ = ~new_n72_ & new_n74_ & ~new_n61_ & x01;
  assign new_n72_ = (x19 | x24) & new_n73_ & (x18 | x23);
  assign new_n73_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n74_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n75_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign z8 = x00 & ~x26 & (~new_n81_ | (new_n77_ & x29));
  ...
  assign new_n81_ = (new_n89_ | (x30 ? (~x31 | new_n78_ | x32) : ~x32)) & (new_n82_ | ~x32);
  assign new_n82_ = ~new_n83_ & ~new_n84_ & ~new_n85_ & ~new_n86_ & ~new_n87_ & new_n88_;
  assign new_n83_ = ~x15 & (~x10 | ~x16 | ~x17 | ~x18 | ~x19);
  ...
  assign z9 = x00 & ~x26 & (new_n92_ | new_n93_ | (new_n91_ & x29));
  assign new_n91_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n78_ & ~x33));
  assign new_n92_ = ~new_n89_ & ((x31 & x33) | (~x30 & ~x31 & ~new_n78_ & ~x33));
  assign new_n93_ = x33 & (new_n83_ | new_n84_ | ~new_n94_ | new_n85_);
  assign new_n94_ = ~new_n86_ & new_n95_ & (x30 | ~x31) & (~x30 | x31);
  assign new_n95_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
endmodule
