...
module FAU ( 
  ...
  assign z1 = (x02 & (x03 ? ~x33 : ~x32)) | (x08 & ~x26) | (~x02 & (x03 ? ~x32 : ~x33));
  ...
  assign z6 = ~x26 & (x08 | (x01 & new_n62_ & ~new_n56_ & x25));
  assign new_n62_ = ~new_n54_ & ((x30 & (~x27 | ~x29 | (~x08 & ~x28))) | (x27 & x28 & x29 & ~x30));
  assign z7 = ~new_n64_ | (x31 & (~x27 | ~x28 | ~x29 | ~x30));
  assign new_n64_ = new_n65_ & ((~x19 & ~x24) | ~new_n67_ | (~x18 & ~x23));
  assign new_n65_ = x01 & ~new_n56_ & x25 & ~x26 & ~new_n66_ & (~x08 | x26);
  assign new_n66_ = x27 & x28 & x29 & x30 & ~x31;
  assign new_n67_ = (x17 | x22) & (x16 | x21) & (x15 | x20);
  assign z8 = x00 & ~x08 & ~x26 & (new_n74_ | (new_n69_ & x31));
  ...
  assign z9 = ~x26 & (x08 | (x00 & (new_n83_ | new_n84_ | new_n85_)));
