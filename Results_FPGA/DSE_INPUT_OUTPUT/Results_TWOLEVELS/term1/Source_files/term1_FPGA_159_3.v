// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:52 2020
...
module FAU ( 
  ...
  assign z3 = (x26 & x27) | (x01 & x25 & ~x26 & new_n53_ & ~x27);
  ...
  assign new_n75_ = x31 & (x29 | x30) & (~x27 | ~x29 | ~x30);
  assign new_n76_ = ~x27 & (x28 ? (x29 & x30) : ~x30);
