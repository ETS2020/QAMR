// Benchmark "FAU" written by ABC on Mon Aug 24 22:09:39 2020
...
module FAU ( 
  ...
  assign z1 = (x02 & (x03 ? ~x33 : ~x32)) | (x24 & x26) | (~x02 & (x03 ? ~x32 : ~x33));
  ...
  assign z9 = (x24 & x26) | (x00 & ~x26 & (new_n82_ | new_n83_ | new_n84_));
