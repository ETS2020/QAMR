...
module FAU ( 
  ...
  assign z3 = ~x00 & x01 & x25 & ~x26 & new_n54_ & ~x27;
  ...
  assign new_n63_ = ~new_n64_ & (~new_n56_ | ~new_n57_);
  assign new_n64_ = (~x30 | (x27 & x29 & (x00 | x28))) & (~x27 | ~x28 | ~x29 | x30);
  assign z7 = new_n69_ | new_n66_ | ~new_n68_ | x26 | new_n70_ | (x00 & ~x26);
  assign new_n66_ = ~new_n67_ & (x18 | x23) & new_n56_ & (x17 | x22);
  assign new_n67_ = ~x19 & ~x24;
  assign new_n68_ = x01 & ~new_n55_ & x25;
