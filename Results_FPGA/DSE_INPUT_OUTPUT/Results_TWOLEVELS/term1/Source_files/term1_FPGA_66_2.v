// Benchmark "FAU" written by ABC on Mon Aug 24 22:08:02 2020
...
module FAU ( 
  ...
  assign z6 = ~x00 & x01 & x25 & new_n63_ & ~new_n55_ & ~x26;
  assign new_n63_ = (~new_n56_ | ~new_n57_) & ((x30 & (~x27 | ~x28 | ~x29)) | (x27 & x28 & x29 & ~x30));
  assign z7 = new_n68_ | ~new_n66_ | (new_n65_ & (x19 | x24));
  assign new_n65_ = (x18 | x23) & new_n56_ & (x17 | x22);
  assign new_n66_ = x01 & ~new_n55_ & x25 & ~x26 & ~new_n67_ & (~x00 | x26);
