...
module FAU ( 
  ...
  assign z7 = x26 ? x14 : (~new_n63_ | (x31 & (~new_n67_ | ~new_n68_)));
  ...
  assign z8 = (~x14 & (x26 | (x00 & ~x19 & x32))) | (x00 & ~new_n70_ & ~x26);
  ...
  assign z9 = new_n89_ | (x00 & ~x26 & (~new_n85_ | (new_n84_ & x29)));
  assign new_n84_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n71_ & ~x33));
  assign new_n85_ = (new_n88_ | ((~x31 | ~x33) & (x30 | x31 | new_n71_ | x33))) & (new_n86_ | ~x33);
  assign new_n86_ = ~new_n75_ & ~new_n76_ & ~new_n77_ & ~new_n78_ & new_n79_ & new_n87_;
  assign new_n87_ = ~x30 ^ x31;
  assign new_n88_ = x29 & (x27 | x28);
  assign new_n89_ = ~x14 & (new_n90_ | x26);
  assign new_n90_ = x00 & x15 & x16 & x17 & x18 & x33;
endmodule
