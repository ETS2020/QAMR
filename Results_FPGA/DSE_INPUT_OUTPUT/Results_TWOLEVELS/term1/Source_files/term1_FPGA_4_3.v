...
module FAU ( 
  ...
  assign z3 = (x20 & x26) | (x01 & x25 & new_n53_ & ~x26);
  ...
  assign z4 = (x20 & x26) | (x01 & x25 & new_n58_ & ~x26);
  assign new_n58_ = (x27 ^ x28) & ~new_n54_ & ~new_n56_;
  assign z5 = (x20 & x26) | (x01 & x25 & new_n60_ & ~x26);
  assign new_n60_ = ~new_n56_ & ~new_n54_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = (x20 & x26) | (x01 & x25 & new_n62_ & ~x26);
  ...
  assign z9 = (x20 & x26) | (x00 & ~x26 & (new_n83_ | new_n84_ | new_n85_));
