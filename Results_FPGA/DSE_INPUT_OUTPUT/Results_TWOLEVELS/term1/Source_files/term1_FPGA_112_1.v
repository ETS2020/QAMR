...
module FAU ( 
  ...
  assign z4 = (~x20 & x26) | (new_n57_ & x01);
  assign new_n57_ = x25 & ~new_n58_ & ~new_n55_ & (x27 ^ x28);
  assign new_n58_ = (x15 | x20) & (x26 | (new_n59_ & new_n60_));
  assign new_n59_ = (x19 | x24) & (x18 | x23);
  assign new_n60_ = (x17 | x22) & (x16 | x21);
  assign z5 = x01 & x25 & new_n62_ & ~x26;
  assign new_n62_ = ~new_n55_ & ~new_n53_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  ...
  assign new_n66_ = (x19 | x24) & new_n60_ & (x18 | x23);
  assign new_n67_ = new_n68_ & ~new_n55_ & x01;
  assign new_n68_ = x25 & (~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign new_n69_ = x31 & (~x29 | ~x30 | ~x27 | ~x28);
  assign z8 = (~x20 & x26) | (x00 & ~x26 & (new_n76_ | (new_n71_ & x31)));
  assign new_n71_ = ~x32 & ~new_n72_ & ((x29 & ~new_n75_ & ~x30) | (x30 & (new_n75_ | ~x29)));
  ...
  assign new_n81_ = (~x27 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n82_ = ~x27 & (x28 ? (x29 & x30) : ~x30);
  assign new_n83_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign z9 = (~x20 & x26) | (x00 & ~x26 & (new_n85_ | new_n86_ | new_n87_));
