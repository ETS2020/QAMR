...
module FAU ( 
  ...
  assign z8 = ~x26 & (~x11 | (x00 & (new_n79_ | (new_n74_ & x31))));
  assign new_n74_ = ~x32 & ~new_n75_ & ((x29 & ~new_n78_ & ~x30) | (x30 & (new_n78_ | ~x29)));
  assign new_n75_ = (~x15 | ((new_n77_ | ~x16) & (~new_n76_ | x16 | ~x17))) & (~new_n76_ | ~x17 | ~x10 | x15 | ~x16);
  assign new_n76_ = x18 & x19;
  assign new_n77_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n78_ = ~x27 & ~x28;
  assign new_n79_ = x32 & (new_n86_ | new_n80_ | new_n81_ | ~new_n82_);
  assign new_n80_ = ~x16 & (~new_n76_ | ~x15 | ~x17);
  assign new_n81_ = ~x15 & (~new_n76_ | ~x10 | ~x17);
  ...
  assign z9 = x00 & x11 & ~x26 & (new_n88_ | new_n89_ | new_n90_);
  assign new_n88_ = x29 & ~new_n78_ & ((~x31 & x33) | (x30 & x31 & ~new_n75_ & ~x33));
  assign new_n89_ = (new_n78_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n75_ & ~x33));
  assign new_n90_ = x33 & (new_n93_ | new_n80_ | ~new_n91_);
  assign new_n91_ = (x19 | (x15 & x17 & x18)) & new_n92_ & (x15 | (x10 & x17 & x18));
