...
module FAU ( 
  ...
  assign z6 = ~x26 & (~x14 | (x01 & x25 & new_n62_ & ~new_n56_));
  ...
  assign z8 = ~x26 & (~x14 | (x00 & (new_n73_ | (new_n69_ & x31))));
  ...
  assign new_n71_ = (~x17 | ((~x18 | x19) & (~x13 | x18 | ~x19))) & (~x18 | ~x19 | ~x12 | x17);
  assign new_n72_ = x17 & x18 & x19;
  assign new_n73_ = x32 & (~new_n74_ | (~x27 & (x28 ? (x29 & x30) : ~x30)));
  ...
  assign new_n80_ = x31 & (x29 | x30) & (~x27 | ~x29 | ~x30);
  assign z9 = ~x26 & (~x14 | (x00 & (~new_n83_ | (new_n82_ & x29))));
