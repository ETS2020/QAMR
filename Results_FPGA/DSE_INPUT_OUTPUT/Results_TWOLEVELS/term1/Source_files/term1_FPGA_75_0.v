...
module FAU ( 
  ...
  assign z8 = ~x26 & (~x11 | (x00 & (new_n74_ | (new_n69_ & x31))));
  ...
  assign new_n74_ = x32 & (new_n81_ | new_n75_ | new_n76_ | ~new_n77_);
  assign new_n75_ = ~x16 & (~new_n71_ | ~x15 | ~x17);
  assign new_n76_ = ~x15 & (~new_n71_ | ~x10 | ~x17);
