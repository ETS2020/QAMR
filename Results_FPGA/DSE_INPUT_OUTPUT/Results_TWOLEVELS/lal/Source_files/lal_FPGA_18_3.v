...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n53_, new_n57_, new_n62_,
    new_n64_, new_n68_, new_n70_, new_n71_, new_n73_, new_n75_, new_n76_,
  ...
  assign z04 = ~x08 & ((~new_n57_ & (~x10 | ~x13)) | (x01 & ~x10) | (~x01 & x10 & ~x13));
  ...
  assign z09 = new_n64_ | new_n48_;
  assign new_n64_ = new_n53_ & ~x07 & ~x15;
  assign z10 = ~x07 & ~x15 & ~new_n48_ & ~new_n53_ & ~x17;
  ...
  assign z14 = ~new_n48_ & ((~new_n71_ & x21) | ~new_n52_ | ~new_n73_);
  assign new_n73_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~new_n48_ & (x07 | x15)) | new_n76_ | new_n48_ | new_n75_ | (new_n53_ & ~x07 & ~x15);
  assign new_n75_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign new_n76_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = ~new_n48_ & ((~new_n75_ & x23) | ~new_n52_ | ~new_n78_);
  assign new_n78_ = ~x15 & (~new_n70_ | x22 | x23 | x20 | x21);
  assign z17 = (~new_n48_ & ~new_n81_) | (~new_n75_ & x24) | new_n64_ | new_n80_ | new_n48_;
  assign new_n80_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n81_ = ~x07 & ~x15 & (~x23 | ~x24);
  assign z18 = (~new_n48_ & (x07 | x15)) | new_n83_ | new_n48_ | new_n84_ | (new_n53_ & ~x07 & ~x15);
