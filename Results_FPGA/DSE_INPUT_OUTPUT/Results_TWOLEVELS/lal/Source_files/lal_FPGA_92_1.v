...
module FAU ( 
  ...
  assign new_n80_ = (x07 | ~new_n81_ | ~x09) & x09 & x18 & x19 & ~x20;
  assign new_n81_ = ~x15 & ~x17 & x18 & (~x04 | ~x05);
  ...
  assign z16 = new_n79_ | (x09 & x21 & x23) | (~new_n86_ & ~x21);
  ...
  assign z18 = new_n79_ | (~x21 & (new_n93_ | (~new_n92_ & x25))) | (x09 & x21 & x25);
  assign new_n92_ = new_n65_ & new_n64_ & x17;
  assign new_n93_ = new_n77_ & ~x24 & ~x25 & ~x22 & ~x23;
endmodule
