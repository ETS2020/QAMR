...
module FAU ( 
  ...
  assign z02 = ~x15 & x16;
  assign z03 = ~x25 & (~x15 | ~x16) & (~x24 | (~new_n53_ & ~x23));
  ...
  assign z07 = (x08 & (~x15 | ~x16)) | ~x06 | (x15 & x16);
  ...
  assign z15 = x15 ? ~x16 : (new_n83_ | x07 | new_n82_ | new_n77_);
  ...
  assign z17 = x15 | new_n87_ | (~new_n89_ & ~x15) | (~new_n82_ & x24);
  assign new_n87_ = x17 & x18 & x19 & new_n88_ & ~x20;
  assign new_n88_ = ~x21 & ~x22 & ~x23 & ~x24 & (~x25 | (~x15 & x25));
  assign new_n89_ = ~x07 & ~new_n77_ & (~x23 | ~x24);
  assign z18 = x15 | new_n92_ | (~x15 & (new_n91_ | new_n77_ | x07));
  assign new_n91_ = x25 & (~new_n65_ | ~new_n66_);
  assign new_n92_ = new_n65_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
