...
module FAU ( 
  ...
  assign z01 = ((x05 | x15) & (x07 | (~new_n51_ & ~x25))) | (x04 & x05);
  ...
  assign z11 = ~x15 & (~x05 | (~x04 & ~x07 & (x17 ^ x18)));
  assign z12 = ~new_n72_ & ~x15;
  assign new_n72_ = x05 & (x04 | x07 | ((~x19 | (x17 & x18)) & (~x17 | ~x18 | x19)));
  assign z13 = new_n74_ | (~new_n75_ & x20) | x15 | new_n65_ | (~x05 & ~x15);
  assign new_n74_ = x05 & (x07 | (x04 & ~x07 & ~x15));
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = x15 | (x05 & (new_n77_ | x07 | new_n78_ | (x04 & ~x07 & ~x15)));
  assign new_n77_ = ~new_n65_ & x21;
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n74_ | (~new_n78_ & x22) | x15 | new_n80_ | (~x05 & ~x15);
  assign new_n80_ = new_n75_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x05 & (new_n82_ | x07 | new_n83_ | (x04 & ~x07 & ~x15)));
  assign new_n82_ = x23 & (~new_n75_ | x20 | x21 | x22);
  assign new_n83_ = new_n75_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n74_ | new_n85_ | (~new_n83_ & x24) | x15 | (~x05 & ~x15);
  assign new_n85_ = x17 & new_n86_ & x18;
  assign new_n86_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n74_ | new_n88_ | x15 | new_n89_ | (~x05 & ~x15);
