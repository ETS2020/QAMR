...
module FAU ( 
  ...
  assign z16 = x15 | (~x07 & (new_n76_ | new_n68_ | (~new_n73_ & x23)));
  assign new_n76_ = new_n67_ & ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = x15 | (~x07 & (~new_n78_ | (~new_n76_ & x24)));
  assign new_n78_ = ~new_n68_ & (~new_n69_ | ~new_n74_ | x23 | x24);
  assign z18 = ~new_n80_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n80_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~x15 & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
