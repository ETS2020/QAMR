...
module FAU ( 
  ...
  assign new_n65_ = x04 & (x05 | x07 | ((~x19 | (x17 & x18)) & (~x17 | ~x18 | x19)));
  assign z13 = x15 | (x04 & (new_n67_ | x07 | new_n69_ | (x05 & ~x07 & ~x15)));
  assign new_n67_ = ~new_n68_ & x20;
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = new_n71_ | (~new_n69_ & x21) | x15 | new_n72_ | (~x04 & ~x15);
  assign new_n71_ = x04 & (x07 | (x05 & ~x07 & ~x15));
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n71_ | (~new_n72_ & x22) | x15 | new_n74_ | (~x04 & ~x15);
  assign new_n74_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x04 & (new_n76_ | x07 | new_n77_ | (x05 & ~x07 & ~x15)));
  assign new_n76_ = x23 & (~new_n68_ | x20 | x21 | x22);
  assign new_n77_ = new_n68_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x04 & (new_n79_ | x07 | new_n80_ | (x05 & ~x07 & ~x15)));
  assign new_n79_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n71_ | (~new_n80_ & x25) | x15 | new_n82_ | (~x04 & ~x15);
