...
module FAU ( 
  ...
  assign z13 = (~x07 & (new_n51_ | x15)) | (~x15 & ((~new_n67_ & x20) | new_n68_ | x07));
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x19 & ~x20 & x17 & x18;
  assign z14 = (~x07 & (new_n51_ | x15)) | (~x15 & ((~new_n68_ & x21) | new_n70_ | x07));
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~x07 & (new_n51_ | x15)) | (~x15 & ((~new_n70_ & x22) | new_n72_ | x07));
  assign new_n72_ = new_n67_ & new_n73_ & ~x20;
  assign new_n73_ = ~x21 & ~x22;
  assign z16 = x07 | ~new_n75_ | (~x07 & (new_n51_ | x15));
  assign new_n75_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | (~x07 & (new_n51_ | x15)) | new_n78_ | (~new_n77_ & x24);
  assign new_n77_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n78_ = new_n68_ & new_n73_ & ~x23 & ~x24;
  assign z18 = (~new_n80_ & ~x15) | (~x07 & (new_n51_ | x15));
  assign new_n80_ = (~x25 | (new_n68_ & new_n73_ & ~x23 & ~x24)) & ~x07 & (~new_n68_ | ~new_n73_ | x23 | x24 | x25);
endmodule
