...
module FAU ( 
  ...
  assign z14 = x15 | (~x07 & (new_n79_ | new_n80_ | (~new_n64_ & x21)));
  assign new_n79_ = x04 & x05 & ~x15;
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n76_ | (~new_n80_ & x22) | new_n82_ | x15;
  assign new_n82_ = new_n77_ & new_n83_ & ~x20;
  assign new_n83_ = ~x21 & ~x22;
  assign z16 = x15 | (~new_n85_ & ~x07);
  assign new_n85_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~new_n79_ & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = new_n76_ | new_n87_ | x15 | (~new_n82_ & x24);
  assign new_n87_ = ~x07 & ((x23 & x24) | (x17 & new_n88_ & x18));
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~new_n90_ & ~x07);
  assign new_n90_ = (~x25 | (new_n64_ & new_n83_ & ~x23 & ~x24)) & ~new_n79_ & (~new_n64_ | ~new_n83_ | x23 | x24 | x25);
endmodule
