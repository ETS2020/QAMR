...
module FAU ( 
  ...
  assign z08 = (x15 & x25) | (x24 & ~x25 & (new_n60_ | x23));
  ...
  assign z13 = (~new_n67_ & ~x15) | new_n68_ | x07 | new_n69_ | x15;
  assign new_n67_ = ~x25 & (~new_n51_ | x07 | x25);
  assign new_n68_ = x20 & (~x17 | ~x18 | ~x19);
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n67_ & ~x15) | x07 | new_n71_ | x15 | (~new_n69_ & x21);
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x25 & (~new_n73_ | (~new_n71_ & x22)));
  ...
  assign new_n77_ = ~new_n74_ & (~new_n78_ | ~x17 | ~x18 | ~x19);
  assign new_n78_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n67_ & ~x15) | new_n80_ | new_n84_ | x07 | x15;
  assign new_n80_ = ~x23 & (new_n83_ | (~x20 & (new_n82_ | (~new_n81_ & x17))));
  assign new_n81_ = (~x18 | ~x19 | x21 | x22 | x24) & (x19 | ~x24 | x25);
  assign new_n82_ = x24 & ~x25 & (x18 ? x21 : x19);
  assign new_n83_ = x24 & ~x25 & ~x21 & x22;
  assign new_n84_ = x24 & ~x25 & (~x17 | x20 | x23);
  assign z18 = (~new_n67_ & ~x15) | x07 | new_n86_ | x15;
  assign new_n86_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
endmodule
