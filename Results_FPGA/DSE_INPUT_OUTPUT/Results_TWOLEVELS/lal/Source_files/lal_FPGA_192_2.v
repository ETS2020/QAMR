...
module FAU ( 
  ...
  assign z01 = new_n50_ | x07 | (x04 & x05);
  ...
  assign z14 = x15 | (~x07 & (new_n77_ | new_n79_ | (~new_n64_ & x21)));
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n82_ | (~new_n79_ & x22) | new_n81_ | x15;
  assign new_n81_ = new_n76_ & ~x20 & ~x21 & ~x22;
  assign new_n82_ = ~x15 & (x07 | (x04 & x05 & ~x07));
  assign z16 = ~new_n84_ | new_n82_;
  assign new_n84_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = new_n82_ | (~new_n86_ & ~x07) | ~new_n87_ | (~new_n81_ & x24);
  ...
  assign z18 = new_n82_ | ~new_n87_ | (~x07 & (~new_n64_ | ~new_n65_) & x25);
endmodule
