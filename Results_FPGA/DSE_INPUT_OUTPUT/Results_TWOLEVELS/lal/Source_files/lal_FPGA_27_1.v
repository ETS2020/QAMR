...
module FAU ( 
  ...
  assign z13 = new_n51_ | (x20 & (~x17 | ~x18 | ~x19)) | x07 | (x19 & ~x20 & x17 & x18);
  assign z14 = x07 | (~x15 & (new_n70_ | new_n71_ | (~new_n69_ & x21)));
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign new_n70_ = x04 & x05 & ~x07;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n51_ | new_n73_ | x07 | (~new_n71_ & x22);
  assign new_n73_ = x17 & x18 & x19 & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign z16 = x07 | (~x15 & (new_n76_ | new_n70_ | (~new_n73_ & x23)));
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 | (~x15 & (~new_n79_ | (~new_n76_ & x24)));
