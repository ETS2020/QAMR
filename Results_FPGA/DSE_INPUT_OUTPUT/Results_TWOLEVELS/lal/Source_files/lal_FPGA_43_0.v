...
module FAU ( 
  ...
  assign z08 = new_n67_ | (x16 & (new_n61_ | new_n69_ | new_n63_ | new_n70_));
  ...
  assign z12 = ~x15 & (new_n75_ | ~x16);
  assign new_n75_ = ~x07 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~x15 & (~x16 | (new_n51_ & ~x07 & x16))) | new_n77_ | x07 | new_n65_ | x15;
  assign new_n77_ = ~new_n78_ & x20;
  ...
  assign z15 = x15 | (x16 & (new_n84_ | x07 | new_n83_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n83_ = new_n78_ & ~x20 & ~x21 & ~x22;
  assign new_n84_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (x16 & (~new_n86_ | x07 | (~new_n83_ & x23)));
  ...
  assign z18 = (~x15 & (~x16 | (new_n51_ & ~x07 & x16))) | x07 | x15 | (~new_n92_ & x16);
  assign new_n92_ = (~x25 | (new_n65_ & ~x23 & ~x24 & ~x21 & ~x22)) & (~new_n65_ | x21 | x22 | x23 | x24 | x25);
endmodule
