...
module FAU ( 
  ...
  assign new_n74_ = ((x04 & x05) | (x17 ? (~x18 | x19) : ~x19)) & ~x07 & (x18 | ~x19 | (x04 & (x05 | x07)));
  assign z13 = x15 | (~x07 & (new_n76_ | new_n64_ | (x04 & x05 & ~x15)));
  assign new_n76_ = ~new_n77_ & x20;
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = z09 | new_n79_ | x15 | (~new_n64_ & x21);
  ...
  assign new_n83_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = z09 | (~new_n85_ & ~x07) | ~new_n86_ | (~new_n81_ & x24);
  assign new_n85_ = (~x23 | ~x24) & (~new_n64_ | x21 | x22 | x23 | x24 | ~x25);
  assign new_n86_ = ~x15 & (~new_n64_ | ~new_n87_);
  assign new_n87_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z18 = z09 | ~new_n86_ | (~x07 & (~new_n64_ | ~new_n65_) & x25);
endmodule
