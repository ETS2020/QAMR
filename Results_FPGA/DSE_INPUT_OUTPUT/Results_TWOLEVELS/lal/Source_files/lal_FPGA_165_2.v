...
module FAU ( 
  ...
  assign z01 = (x04 & (x05 | ~x15)) | new_n49_ | x07;
  ...
  assign new_n65_ = x17 & x19 & (x15 | x18);
  assign new_n66_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~x04 & (new_n68_ | ~new_n69_));
  assign new_n68_ = x21 & (~x19 | x20 | ~x17 | (~x15 & ~x18));
  assign new_n69_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x04 & (new_n71_ | x07 | (~new_n73_ & x22)));
  assign new_n71_ = x17 & x18 & x19 & new_n72_ & ~x20;
  assign new_n72_ = ~x21 & ~x22;
  assign new_n73_ = x17 & (x15 | x18) & x19 & ~x20 & ~x21;
  assign z16 = x15 | (~x04 & (new_n75_ | ~new_n76_));
  assign new_n75_ = x23 & (~new_n65_ | ~new_n72_ | x20);
  assign new_n76_ = ~x07 & (~new_n77_ | ~x17 | ~x18 | ~x19);
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x04 & (~new_n79_ | (x24 & (~new_n65_ | ~new_n77_))));
  assign new_n79_ = ~x07 & (~new_n66_ | ~new_n72_ | x23 | x24);
  assign z18 = x15 | (~new_n81_ & ~x04);
  assign new_n81_ = (~x25 | (new_n66_ & new_n72_ & ~x23 & ~x24)) & ~x07 & (~new_n66_ | ~new_n72_ | x23 | x24 | x25);
  assign z09 = 1'b0;
endmodule
