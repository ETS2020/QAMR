...
module FAU ( 
  ...
  assign z01 = (x05 & (x15 | (x04 & ~x07 & ~x15))) | new_n49_ | x07;
  ...
  assign z12 = (x05 & x15) | (~x07 & ~x15 & ~new_n74_ & (~x04 | ~x05));
  ...
  assign z14 = ~new_n79_ | (x05 & (x15 | (x04 & ~x07 & ~x15)));
  assign new_n79_ = (new_n64_ | ~x21) & (x05 | ~x15) & ~new_n80_ & (~x07 | x15);
  ...
  assign z16 = x15 ? ~x05 : (new_n85_ | x07 | new_n86_ | (x04 & x05 & ~x07));
  assign new_n85_ = x23 & (~new_n77_ | x20 | x21 | x22);
  assign new_n86_ = new_n77_ & new_n87_;
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 ? ~x05 : (~new_n89_ | (x17 & new_n90_ & x18));
  assign new_n89_ = (~x24 | (new_n77_ & new_n87_)) & ~x07 & (~x04 | ~x05 | x07);
  assign new_n90_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x05 : (new_n92_ | x07 | new_n93_ | (x04 & x05 & ~x07));
  assign new_n92_ = x25 & (~new_n64_ | ~new_n65_);
  assign new_n93_ = new_n64_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
