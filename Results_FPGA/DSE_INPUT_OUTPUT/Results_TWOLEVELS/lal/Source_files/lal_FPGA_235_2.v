...
module FAU ( 
  ...
  assign z13 = x15 | (~x07 & (new_n68_ | new_n69_ | (~new_n67_ & x20)));
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x04 & x05 & ~x15;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~x07 & ((~new_n69_ & x21) | new_n68_ | new_n71_));
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n73_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n73_ = (new_n71_ | ~x22) & ~x15 & (~new_n67_ | x20 | x21 | x22);
  assign z16 = ~new_n75_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n75_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n67_ | x22 | x23 | x20 | x21);
  assign z17 = x15 | (~x07 & (new_n77_ | new_n78_ | new_n68_));
  assign new_n77_ = x24 & (~new_n67_ | x22 | x23 | x20 | x21);
  assign new_n78_ = new_n69_ & new_n79_ & ~x23 & ~x24;
  assign new_n79_ = ~x21 & ~x22;
  assign z18 = ~new_n81_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n81_ = (~x25 | (new_n69_ & new_n79_ & ~x23 & ~x24)) & ~x15 & (~new_n69_ | ~new_n79_ | x23 | x24 | x25);
endmodule
