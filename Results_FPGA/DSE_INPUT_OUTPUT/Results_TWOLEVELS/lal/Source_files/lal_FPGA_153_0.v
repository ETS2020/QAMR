...
module FAU ( 
  ...
  assign z04 = (~new_n55_ & ~x08) | (~x03 & (~x15 | (~x08 & x12)));
  ...
  assign z14 = z09 | (~new_n71_ & x21) | x07 | new_n73_ | x15;
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = z09 | (~new_n73_ & x22) | x07 | new_n75_ | x15;
  assign new_n75_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = z09 | ~new_n77_ | x07 | (~new_n75_ & x23);
  assign new_n77_ = ~x15 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (x03 & (new_n79_ | x07 | new_n80_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (x03 & (~new_n82_ | x07 | (~new_n80_ & x25)));
  assign new_n82_ = ~new_n70_ & (~new_n71_ | ~new_n83_);
