...
module FAU ( 
  ...
  assign z13 = (~new_n51_ & ~x07) | (~new_n68_ & x20) | new_n69_ | x07;
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = ~new_n71_ | (~new_n51_ & ~x07);
  assign new_n71_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | (~x15 & (new_n75_ | new_n73_ | new_n76_));
  ...
  assign new_n78_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n51_ & ~x07) | new_n80_ | new_n81_ | x07;
  assign new_n80_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n81_ = new_n69_ & new_n74_ & ~x23 & ~x24;
  assign z18 = x07 | (~new_n83_ & ~x15);
  assign new_n83_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~new_n76_ & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
