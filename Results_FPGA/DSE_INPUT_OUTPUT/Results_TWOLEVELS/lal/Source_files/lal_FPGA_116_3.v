...
module FAU ( 
  ...
  assign z04 = ~x08 & ((~new_n56_ & (~x03 | ~x25)) | (~x03 & x12) | (x03 & ~x12 & ~x25));
  ...
  assign z08 = new_n61_ | new_n66_ | (x23 & (x24 | x25)) | (~new_n63_ & x25);
  ...
  assign z13 = (~new_n75_ & x20) | ~new_n74_ | new_n48_ | new_n65_ | (new_n52_ & new_n74_);
  assign new_n74_ = ~x07 & ~x15;
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = (~new_n65_ & x21) | ~new_n74_ | ~new_n77_ | (new_n52_ & new_n74_);
  assign new_n77_ = ~new_n48_ & (~new_n78_ | ~x19 | ~x17 | ~x18);
  assign new_n78_ = ~x20 & ~x21;
  assign z15 = new_n80_ | ~new_n74_ | new_n81_ | new_n48_ | (new_n52_ & new_n74_);
  assign new_n80_ = x22 & (~x17 | ~x18 | ~new_n78_ | ~x19);
  assign new_n81_ = new_n75_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n81_ & x23) | ~new_n83_ | ~new_n74_;
  assign new_n83_ = ~new_n68_ & ~new_n48_ & (~new_n75_ | ~new_n78_ | x22 | x23);
  assign z17 = new_n85_ | new_n87_ | z09 | ~new_n74_;
  assign new_n85_ = x17 & x18 & x19 & ~x20 & new_n86_ & ~x21;
  assign new_n86_ = ~x22 & ~x23 & ~x24;
  assign new_n87_ = x24 & (~new_n75_ | ~new_n78_ | x22 | x23);
  assign z18 = new_n89_ | ~new_n74_ | new_n91_ | (new_n52_ & new_n74_);
  assign new_n89_ = x25 & (~new_n90_ | ~x18 | ~x19 | x03 | ~x17);
