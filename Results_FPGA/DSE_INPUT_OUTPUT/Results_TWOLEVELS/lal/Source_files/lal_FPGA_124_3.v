...
module FAU ( 
  ...
  assign z17 = (~x15 & (new_n85_ | ~new_n87_)) | (~x07 & (x15 | (x23 & x24)));
  assign new_n85_ = x17 & new_n86_ & x18;
  assign new_n86_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n87_ = (new_n88_ | ~x24) & ~x07 & (~x04 | ~x05 | x07);
  assign new_n88_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z18 = (~x07 & (x15 | (x04 & x05 & ~x15))) | (~new_n90_ & ~x15);
  assign new_n90_ = (~x25 | (new_n64_ & new_n91_ & ~x23 & ~x24)) & ~x07 & (~new_n64_ | ~new_n91_ | x23 | x24 | x25);
