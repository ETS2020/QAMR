...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n62_,
    ...
    new_n70_, new_n76_, new_n77_, new_n79_, new_n81_, new_n82_, new_n84_,
  ...
  assign z13 = x07 | new_n76_ | new_n65_ | (~new_n77_ & x20);
  assign new_n76_ = ~x07 & (new_n51_ | x15);
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = (~x07 & (new_n51_ | x15)) | (~x15 & (new_n79_ | x07 | (~new_n65_ & x21)));
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~x07 & (new_n51_ | x15)) | (~x15 & ((~new_n79_ & x22) | new_n81_ | x07));
  assign new_n81_ = new_n77_ & new_n82_ & ~x20;
  assign new_n82_ = ~x21 & ~x22;
  assign z16 = new_n76_ | (~new_n84_ & ~x15);
  assign new_n84_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | new_n76_ | new_n86_ | new_n87_ | (~new_n81_ & x24);
  assign new_n86_ = ~x15 & ((x23 & x24) | (new_n65_ & new_n82_ & ~x23 & ~x24 & x25));
  assign new_n87_ = new_n65_ & new_n82_ & ~x23 & ~x24 & ~x25;
  assign z18 = x07 | (~x07 & (new_n51_ | x15)) | new_n87_ | (~x15 & ~new_n89_ & x25);
  assign new_n89_ = new_n65_ & new_n66_;
endmodule
