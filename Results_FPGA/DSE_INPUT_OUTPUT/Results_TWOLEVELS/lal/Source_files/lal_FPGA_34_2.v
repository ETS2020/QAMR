...
module FAU ( 
  ...
  assign z10 = ~x15 & (x08 | (~x07 & ~new_n63_ & ~x17));
  assign z11 = ~x15 & (x08 | (~x07 & ~new_n63_ & (~x17 ^ ~x18)));
  assign z12 = ~x07 & new_n67_ & ~x08;
  assign new_n67_ = ~x15 & ~new_n63_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = ~new_n71_ | (~new_n69_ & ~x08);
  assign new_n69_ = ~new_n70_ & ~x07;
  assign new_n70_ = x04 & x05 & ~x07 & ~x15;
  assign new_n71_ = (~x20 | (x17 & x18 & x19)) & ~x15 & (~x08 | x15) & (~x19 | x20 | ~x17 | ~x18);
  assign z14 = x15 | (~x08 & (~new_n73_ | x07 | (~new_n74_ & x21)));
  assign new_n73_ = ~new_n70_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n74_ = x17 & x18 & x19 & ~x20;
  assign z15 = x15 | (~x08 & (new_n76_ | x07 | new_n70_ | new_n77_));
  assign new_n76_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n77_ = ~x20 & ~x21 & ~x22 & x17 & x18 & x19;
  assign z16 = (~new_n69_ & ~x08) | (~new_n77_ & x23) | x15 | new_n79_ | (x08 & ~x15);
  assign new_n79_ = new_n80_ & x17 & x18 & x19;
  assign new_n80_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x08 & (~new_n82_ | x07 | (~new_n79_ & x24)));
  assign new_n82_ = ~new_n70_ & (~new_n74_ | x23 | x24 | x21 | x22);
  assign z18 = x15 | (~x08 & (new_n84_ | ~new_n85_ | x07));
  assign new_n84_ = x25 & (~new_n74_ | x21 | x22 | x23 | x24);
  assign new_n85_ = ~new_n70_ & (~new_n74_ | ~new_n86_);
