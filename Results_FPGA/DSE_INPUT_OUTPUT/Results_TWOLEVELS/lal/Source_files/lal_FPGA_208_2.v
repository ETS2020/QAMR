...
module FAU ( 
  ...
  assign new_n77_ = ~x15 & (x03 | (~x03 & x04 & x05 & ~x07));
  assign new_n78_ = (~x17 | ((~x18 | ~x19) & (~x15 | x23 | x25))) & (~x15 | x23 | x25 | (~x18 & ~x19));
  assign z14 = (~new_n80_ & ~x20) | new_n84_ | new_n85_ | (~new_n83_ & x21);
  assign new_n80_ = ~new_n81_ & (~x15 | x23 | x25 | (~x18 & ~x19));
  assign new_n81_ = x17 & (new_n82_ | (~x03 & x18 & x19 & ~x21));
  ...
  assign new_n85_ = ~x03 & (x07 | (x04 & x05 & ~x07 & ~x15));
  assign z15 = new_n77_ | (~new_n87_ & ~x21) | new_n88_ | new_n89_ | x07;
  assign new_n87_ = ~new_n82_ & (~x17 | ~x18 | ~x19 | x20 | x22);
  assign new_n88_ = x15 & (x25 | (x23 & x24) | (~x25 & (~x24 | (~x22 & ~x23))));
  assign new_n89_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = new_n77_ | (~new_n91_ & ~x23) | ~new_n94_ | (~x17 & (new_n76_ | x23));
  ...
  assign new_n94_ = ~new_n96_ & new_n95_ & (~x15 | ((~x23 | ~x24) & ~x25 & (x24 | x25)));
  assign new_n95_ = ~x07 & (new_n93_ | ~x23);
  assign new_n96_ = x20 & (x23 | (x22 & x24 & x15 & x21));
  assign z17 = new_n98_ | (x25 & (new_n105_ | x15)) | new_n102_ | new_n85_;
  ...
  assign new_n104_ = ~x21 & ~x22 & ~x24 & ~x03 & x18 & x19;
  assign new_n105_ = new_n106_ & ~x03 & x17 & x18 & x19;
  assign new_n106_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n77_ | new_n102_ | new_n108_ | ~new_n109_ | (~new_n112_ & x20);
  assign new_n108_ = ~x17 & (new_n76_ | (~x03 & x25));
  assign new_n109_ = (~x15 | (~new_n111_ & ~x25)) & ~x07 & (x03 | new_n110_ | ~x25);
  assign new_n110_ = new_n62_ & ~x22 & ~x23 & ~x24;
  assign new_n111_ = x23 & x24;
  assign new_n112_ = (x03 | ~x25) & (~x15 | ~x21 | ~x22 | ~x24);
endmodule
