...
module FAU ( 
  ...
  wire new_n49_, new_n51_, new_n52_, new_n53_, new_n55_, new_n57_, new_n58_,
    ...
    new_n70_, new_n72_, new_n77_, new_n78_, new_n80_, new_n82_, new_n83_,
  ...
  assign z08 = (~new_n67_ & ~x18) | new_n68_ | new_n69_ | new_n63_ | new_n70_;
  ...
  assign new_n67_ = ~x25 & (x17 | x19 | ~x21 | ~x22 | ~x24);
  assign new_n68_ = ~x17 & (x15 | x25);
  assign new_n69_ = x20 & (x25 | (x21 & x22 & x24));
  assign new_n70_ = x23 & (x24 | x25);
  assign z09 = new_n72_ & ~x07 & ~x15;
  assign new_n72_ = x04 & x05;
  assign z10 = ~x17 & ((~new_n72_ & ~x07) | x15);
  assign z11 = (x15 & ~x17) | (~x07 & ~new_n72_ & ((~x17 & x18) | (~x15 & x17 & ~x18)));
  assign z12 = (x15 & ~x17) | (~x07 & ~new_n72_ & ((~x15 & ((~x18 & x19) | (x17 & x18 & ~x19))) | (~x17 & x19)));
  assign z13 = x15 | (~new_n77_ & ~x15) | new_n65_ | (~new_n78_ & x20);
  assign new_n77_ = ~x07 & (~x04 | ~x05 | x07);
  assign new_n78_ = x17 & x18 & x19;
  assign z14 = (x17 & (new_n80_ | x15)) | (~x15 & (~new_n77_ | (~new_n65_ & x21)));
  assign new_n80_ = x18 & x19 & ~x20 & ~x21;
  assign z15 = (x17 & (new_n82_ | x15)) | (~x15 & (~new_n77_ | new_n83_));
  assign new_n82_ = x18 & x19 & ~x20 & ~x21 & ~x22;
  assign new_n83_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | ~new_n85_ | (~new_n77_ & ~x15);
  assign new_n85_ = (~x23 | (new_n78_ & ~x20 & ~x21 & ~x22)) & (~new_n78_ | x22 | x23 | x20 | x21);
  assign z17 = x15 | (~new_n77_ & ~x15) | new_n88_ | (~new_n87_ & x24);
  assign new_n87_ = new_n78_ & ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n88_ = x17 & x18 & new_n89_ & x19;
  assign new_n89_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | ~new_n91_ | (~new_n77_ & ~x15);
