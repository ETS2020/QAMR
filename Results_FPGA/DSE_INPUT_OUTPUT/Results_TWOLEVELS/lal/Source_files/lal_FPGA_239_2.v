...
module FAU ( 
  ...
  assign z01 = new_n50_ | (x04 & x05) | x07 | (x06 & ~x15);
  ...
  assign z08 = new_n66_ | (~x06 & (new_n60_ | new_n68_ | new_n62_ | new_n69_));
  ...
  assign z12 = ~x15 & (new_n75_ | x06);
  assign new_n75_ = ~x07 & (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n77_ | (~new_n78_ & x20) | x07 | new_n64_ | x15;
  assign new_n77_ = ~x15 & (x06 | (x04 & x05 & ~x06 & ~x07));
  assign new_n78_ = x17 & x18 & x19;
  assign z14 = new_n77_ | (~new_n64_ & x21) | x07 | new_n80_ | x15;
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n77_ | (~new_n80_ & x22) | x07 | new_n82_ | x15;
  assign new_n82_ = new_n78_ & ~x20 & ~x21 & ~x22;
  assign z16 = new_n77_ | ~new_n84_ | x07 | (~new_n82_ & x23);
  assign new_n84_ = ~x15 & (~new_n78_ | x20 | x21 | x22 | x23);
  assign z17 = new_n77_ | (~new_n86_ & ~x06) | ~new_n87_ | (~new_n82_ & x24);
  assign new_n86_ = (~x23 | ~x24) & (~new_n64_ | x21 | x22 | x23 | x24 | ~x25);
  assign new_n87_ = ~x07 & ~x15 & (~new_n64_ | ~new_n88_);
  assign new_n88_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z18 = new_n77_ | ~new_n87_ | (~x06 & x25 & (~new_n64_ | ~new_n65_));
endmodule
