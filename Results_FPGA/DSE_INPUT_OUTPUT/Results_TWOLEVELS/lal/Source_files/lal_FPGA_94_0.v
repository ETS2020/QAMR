...
module FAU ( 
  ...
  assign z09 = ~x15 & (~x08 | (new_n51_ & ~x07 & x08));
  assign z10 = ~x07 & x08 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = ~x07 & x08 & ~x15 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x07 & new_n74_ & x08;
  assign new_n74_ = ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = z09 | (~new_n76_ & x20) | x07 | new_n64_ | x15;
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = z09 | (~new_n64_ & x21) | ~new_n78_ | x07;
  assign new_n78_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x08 & (new_n81_ | x07 | new_n80_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n80_ = new_n76_ & ~x20 & ~x21 & ~x22;
  assign new_n81_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = z09 | (~new_n80_ & x23) | ~new_n83_ | x07;
  assign new_n83_ = ~x15 & (~new_n76_ | ~new_n84_);
  assign new_n84_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x08 & (~new_n86_ | (x17 & new_n87_ & x18)));
  assign new_n86_ = (~x24 | (new_n76_ & new_n84_)) & ~x07 & (~new_n51_ | x07 | x15);
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~x15 & (~x08 | (new_n51_ & ~x07 & x08))) | x07 | x15 | (~new_n89_ & x08);
  assign new_n89_ = (~x25 | (new_n64_ & ~x23 & ~x24 & ~x21 & ~x22)) & (~new_n64_ | x21 | x22 | x23 | x24 | x25);
endmodule
