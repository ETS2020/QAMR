...
module FAU ( 
  ...
  assign z15 = ~new_n49_ & ((~new_n72_ & x22) | ~new_n68_ | new_n74_ | (new_n53_ & new_n68_));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n49_ & ((~new_n74_ & x23) | ~new_n68_ | new_n76_ | (new_n53_ & new_n68_));
  assign new_n76_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = ~new_n49_ & ((~new_n76_ & x24) | ~new_n68_ | new_n78_ | (new_n53_ & new_n68_));
  assign new_n78_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n49_ & ((~new_n78_ & x25) | ~new_n80_ | ~new_n68_);
  assign new_n80_ = (~new_n53_ | ~new_n68_) & (~new_n70_ | ~new_n81_);
