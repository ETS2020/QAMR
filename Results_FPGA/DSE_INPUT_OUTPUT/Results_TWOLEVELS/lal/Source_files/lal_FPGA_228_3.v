...
module FAU ( 
  ...
  assign z09 = (x07 & x15) | (new_n71_ & ~x07 & ~x15);
  ...
  assign z13 = (~x07 & (new_n71_ | x15)) | (~x15 & (new_n64_ | x07 | (~new_n76_ & x20)));
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = (~x07 & (new_n71_ | x15)) | (~new_n78_ & ~x15);
  assign new_n78_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | ~new_n80_ | (~x07 & (new_n71_ | x15));
  ...
  assign z17 = new_n84_ | (~x07 & (new_n71_ | x15)) | (~x15 & (new_n86_ | x07));
  ...
  assign z18 = (~x15 & (new_n88_ | x07)) | (~x07 & (new_n89_ | new_n71_ | x15));
  assign new_n88_ = new_n64_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n89_ = x25 & (~new_n64_ | ~new_n65_);
endmodule
