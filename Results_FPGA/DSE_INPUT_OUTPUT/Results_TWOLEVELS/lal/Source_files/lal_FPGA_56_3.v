...
module FAU ( 
  ...
  assign z01 = x07 ? ~x15 : ((~new_n49_ & ~x25) | (x04 & x05));
  ...
  assign z08 = (x24 & (new_n60_ | x23)) | x25 | (x07 & x15);
  ...
  assign z13 = (~x07 & (x15 | (x04 & x05 & ~x15))) | (~x15 & (new_n67_ | new_n69_ | x07));
  assign new_n67_ = ~new_n68_ & x20;
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = x07 | ~new_n71_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n71_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | ~new_n73_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n73_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = x07 | ~new_n75_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n75_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~x07 & (~new_n79_ | x15)) | (~x15 & ((~new_n77_ & x24) | new_n78_ | x07));
  assign new_n77_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign new_n78_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n79_ = (~x23 | ~x24) & (~x04 | ~x05 | x15);
  assign z18 = x07 | ~new_n81_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
