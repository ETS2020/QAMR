...
module FAU ( 
  ...
  assign new_n67_ = ~x06 & (x25 | (x24 & (new_n68_ | x23)));
  ...
  assign z12 = (x06 & x15) | (~x07 & new_n75_ & ~x15);
  assign new_n75_ = ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n77_ | (new_n52_ & new_n77_) | (x17 & x18 & x19 & ~x20);
  assign new_n77_ = ~x07 & ~x15;
  assign z14 = (~new_n65_ & x21) | ~new_n77_ | new_n79_ | (new_n52_ & new_n77_);
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n79_ & x22) | ~new_n77_ | (new_n52_ & new_n77_) | new_n81_;
  assign new_n81_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n81_ & x23) | ~new_n77_ | new_n83_ | (new_n52_ & new_n77_);
  assign new_n83_ = new_n84_ & x17 & x18 & x19;
  assign new_n84_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = ~new_n86_ | (x17 & x18 & x19 & new_n88_ & ~x20);
  assign new_n86_ = (x15 | (~new_n87_ & (~x23 | ~x24))) & ~x07 & ~x15 & (new_n81_ | ~x24);
  assign new_n87_ = x04 & x05 & ~x07;
  assign new_n88_ = ~x21 & ~x22 & ~x23 & ~x24 & (~x25 | (~x15 & x25));
  assign z18 = x07 | new_n91_ | x15 | (~x15 & (new_n90_ | new_n87_));
