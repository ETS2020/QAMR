...
module FAU ( 
  ...
  assign z10 = ~x15 & (x24 | (~x07 & ~new_n68_ & ~x17));
  assign z11 = ~x15 & (x24 | (~x07 & ~new_n68_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n72_ & ~x15;
  assign new_n72_ = ~x24 & ~new_n68_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  ...
  assign z14 = z09 | (~new_n76_ & x21) | x15 | new_n78_ | new_n79_;
  assign new_n78_ = x17 & x18 & new_n64_ & x19;
  assign new_n79_ = x07 & ~x24;
  assign z15 = z09 | (~new_n78_ & x22) | ~new_n81_ | x15;
  assign new_n81_ = ~new_n79_ & (~new_n63_ | x20 | x21 | x22);
  assign z16 = z09 | ~new_n85_ | (~x24 & (new_n83_ | x07));
  assign new_n83_ = new_n84_ & x17;
  assign new_n84_ = x18 & x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n85_ = ~x15 & (~x23 | (new_n63_ & ~x20 & ~x21 & ~x22));
  assign z17 = x15 | (~x24 & (new_n83_ | new_n75_ | x07));
  assign z18 = z09 | x15 | (~x24 & (new_n88_ | ~new_n89_));
  assign new_n88_ = x25 & (~new_n63_ | ~new_n64_ | x22 | x23);
  assign new_n89_ = ~x07 & (~new_n76_ | x23 | x25 | x21 | x22);
endmodule
