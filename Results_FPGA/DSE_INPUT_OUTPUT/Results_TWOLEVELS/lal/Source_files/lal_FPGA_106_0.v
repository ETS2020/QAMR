...
module FAU ( 
  ...
  assign z04 = ~x08 & ((~new_n56_ & (x11 | x15)) | (~x02 & x11) | (x02 & ~x11 & x15));
  ...
  assign z09 = ~x15 & (~x11 | (new_n52_ & ~x07 & x11));
  assign z10 = ~x15 & (~x11 | (~x07 & ~new_n52_ & ~x17));
  assign z11 = ~x15 & (~x11 | (~x07 & ~new_n52_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n72_ & x11;
  assign new_n72_ = ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n74_ | (~new_n75_ & x20) | x15 | new_n65_ | (~x11 & ~x15);
  assign new_n74_ = x11 & (x07 | (new_n52_ & ~x07 & ~x15));
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = new_n74_ | (~new_n65_ & x21) | x15 | new_n77_ | (~x11 & ~x15);
  assign new_n77_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (x11 & (new_n79_ | x07 | new_n80_ | (new_n52_ & ~x07 & ~x15)));
  assign new_n79_ = ~new_n77_ & x22;
  assign new_n80_ = new_n75_ & ~x20 & ~x21 & ~x22;
  assign z16 = new_n74_ | (~new_n80_ & x23) | x15 | new_n82_ | (~x11 & ~x15);
  assign new_n82_ = new_n75_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n74_ | new_n84_ | (~new_n82_ & x24) | x15 | (~x11 & ~x15);
  assign new_n84_ = x17 & new_n85_ & x18;
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n74_ | new_n87_ | x15 | new_n88_ | (~x11 & ~x15);
