...
module FAU ( 
  ...
  assign z13 = x15 | (~x07 & (new_n76_ | new_n64_ | (x04 & x05 & ~x15)));
  assign new_n76_ = ~new_n77_ & x20;
  ...
  assign z16 = ~new_n84_ | z09;
  assign new_n84_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x07 & (new_n86_ | new_n88_ | (x04 & x05 & ~x15)));
  assign new_n86_ = x17 & new_n87_ & x18;
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n88_ = x24 & (~new_n77_ | x22 | x23 | x20 | x21);
  assign z18 = z09 | x15 | (~new_n90_ & ~x07);
  assign new_n90_ = (~x25 | (new_n64_ & ~x23 & ~x24 & ~x21 & ~x22)) & (~new_n64_ | x21 | x22 | x23 | x24 | x25);
endmodule
