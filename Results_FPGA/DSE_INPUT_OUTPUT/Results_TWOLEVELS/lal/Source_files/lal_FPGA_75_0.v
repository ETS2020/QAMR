...
module FAU ( 
  ...
  assign z08 = ~new_n52_ & ~z12;
  assign z13 = ~new_n64_ & ~z12;
  assign new_n64_ = (~x24 | (~x23 & (~x21 | new_n53_ | ~x22))) & ~x25 & (x25 | (x24 & (x23 | (~new_n53_ & x21 & x22))));
  assign z14 = z12 | (~new_n64_ & ~z12);
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z15 = z12 | (~new_n64_ & ~z12);
  assign z16 = ~new_n64_ & ~z12;
  assign z17 = ~new_n64_ & ~z12;
  assign z18 = z12 | (~new_n64_ & ~z12);
endmodule
