...
module FAU ( 
  ...
  assign z16 = ~new_n85_ | z09;
  assign new_n85_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = z09 | new_n87_ | x15 | (~new_n81_ & x24);
  assign new_n87_ = ~x07 & ((x23 & x24) | (x17 & new_n88_ & x18));
