...
module FAU ( 
  ...
  assign z08 = ~new_n52_ & ~z11;
  assign z13 = ~new_n63_ & ~z11;
  assign new_n63_ = (~x24 | (~x23 & (~x21 | new_n53_ | ~x22))) & ~x25 & (x25 | (x24 & (x23 | (~new_n53_ & x21 & x22))));
  assign z18 = z11 | (~new_n63_ & ~z11);
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
  assign z14 = ~new_n63_ & ~z11;
  assign z15 = ~new_n63_ & ~z11;
  assign z16 = ~new_n63_ & ~z11;
  assign z17 = ~new_n63_ & ~z11;
endmodule
