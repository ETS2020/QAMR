...
module FAU ( 
  ...
  assign z13 = new_n77_ | (~new_n78_ & x20) | new_n65_ | x07;
  assign new_n77_ = ~x07 & (x15 | (x04 & x05 & ~x15));
  assign new_n78_ = x17 & x18 & x19;
  assign z14 = x07 | (~x15 & (new_n51_ | new_n80_ | (~new_n65_ & x21)));
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n77_ | (~new_n80_ & x22) | new_n82_ | x07;
  assign new_n82_ = new_n78_ & ~x20 & ~x21 & ~x22;
  assign z16 = x07 | (~new_n84_ & ~x15);
  assign new_n84_ = (~x23 | (new_n78_ & ~x20 & ~x21 & ~x22)) & ~new_n51_ & (~new_n78_ | x20 | x21 | x22 | x23);
  assign z17 = new_n77_ | (~new_n86_ & ~x15) | ~new_n87_ | (~new_n82_ & x24);
  assign new_n86_ = (~x23 | ~x24) & (~new_n65_ | x21 | x22 | x23 | x24 | ~x25);
  assign new_n87_ = ~x07 & (~new_n65_ | ~new_n88_);
  assign new_n88_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z18 = new_n77_ | ~new_n87_ | (~x15 & x25 & (~new_n65_ | ~new_n66_));
endmodule
