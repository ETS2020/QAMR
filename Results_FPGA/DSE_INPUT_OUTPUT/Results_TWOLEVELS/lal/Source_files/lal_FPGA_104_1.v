...
module FAU ( 
  ...
  assign new_n66_ = x04 & (x25 | (x24 & (new_n67_ | x23)));
  ...
  assign new_n76_ = x04 & (x15 | (x05 & ~x07 & ~x15));
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = new_n76_ | (~new_n64_ & x21) | ~new_n79_ | (~x04 & x15);
  assign new_n79_ = ~new_n80_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n80_ = x07 & ~x15;
  assign z15 = (x04 & (x15 | (x05 & ~x07 & ~x15))) | new_n84_ | (~x04 & x15) | new_n82_ | (x07 & ~x15);
  assign new_n82_ = new_n77_ & new_n83_ & ~x20;
  assign new_n83_ = ~x21 & ~x22;
  assign new_n84_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = new_n76_ | (~new_n82_ & x23) | ~new_n86_ | (~x04 & x15);
  assign new_n86_ = ~new_n80_ & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = new_n76_ | (~new_n88_ & ~x15) | (~x04 & x15) | (~new_n82_ & x24);
  assign new_n88_ = (~x17 | ~new_n89_ | ~x18) & ~x07 & (~x23 | ~x24);
  assign new_n89_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n76_ | (~new_n91_ & ~x15);
  assign new_n91_ = (~x25 | (new_n64_ & new_n83_ & ~x23 & ~x24)) & ~x07 & (~new_n64_ | ~new_n83_ | x23 | x24 | x25);
endmodule
