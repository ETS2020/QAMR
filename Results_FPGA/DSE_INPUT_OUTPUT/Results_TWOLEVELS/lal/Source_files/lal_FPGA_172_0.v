...
module FAU ( 
  ...
  assign z13 = new_n71_ | (~new_n48_ & (new_n69_ | ~new_n70_));
  assign new_n69_ = x20 & (~x17 | ~x18 | ~x19);
  assign new_n70_ = ~x07 & ~x15 & (x07 | x15 | ~x04 | ~x05);
  assign new_n71_ = x17 & x18 & x19 & ~x20 & (x21 | (~x21 & x23));
  assign z14 = new_n73_ | new_n76_ | (x19 & (new_n75_ | (new_n74_ & ~x07)));
  assign new_n73_ = (x21 | x23) & (x07 | x15 | (~x07 & ~x15 & x04 & x05));
  assign new_n74_ = ~x15 & x21 & (~x04 | ~x05) & (~x17 | ~x18);
  assign new_n75_ = x17 & x18 & ~x20 & ~x21 & x23;
  assign new_n76_ = x21 & (~x19 | x20);
  assign z15 = new_n73_ | new_n79_ | (~new_n78_ & ~x21);
  assign new_n78_ = x23 & (~x17 | ~x18 | ~x19 | x20 | x22 | ~x23);
  assign new_n79_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = new_n73_ | (x23 & (~new_n83_ | ~x19 | (x19 & (new_n81_ | new_n82_))));
  assign new_n81_ = ~x07 & ~x15 & (~x04 | ~x05) & (~x17 | ~x18);
  assign new_n82_ = x17 & x18 & ~x20 & ~x21 & x22;
  assign new_n83_ = ~x20 & (x20 | ~x21);
  assign z17 = ~new_n48_ & (x07 | x15 | x24 | (~x07 & ~x15 & x04 & x05));
  assign z18 = ~new_n48_ & (x07 | x15 | x25 | (~x07 & ~x15 & x04 & x05));
endmodule
