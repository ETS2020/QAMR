...
module FAU ( 
  ...
  assign z01 = x07 | new_n51_ | (x04 & x05);
  ...
  assign z14 = x07 | new_n74_ | new_n77_ | (~new_n65_ & x21);
  assign new_n77_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n74_ | (~new_n79_ & ~x15);
  assign new_n79_ = (new_n77_ | ~x22) & ~x07 & (~new_n75_ | x20 | x21 | x22);
