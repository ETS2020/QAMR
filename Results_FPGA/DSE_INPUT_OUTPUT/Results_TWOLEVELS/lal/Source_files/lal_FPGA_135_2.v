...
module FAU ( 
  ...
  assign new_n65_ = ~x07 & ((x04 & x05) | (((x17 & x18) | ~x19) & (~x17 | ~x18 | x19)));
  assign z13 = (~new_n67_ & ~x15) | (x20 & (~x17 | ~x18 | ~x19)) | x15 | (x19 & ~x20 & x17 & x18);
  assign new_n67_ = ~x07 & (~x04 | ~x05 | x07);
  assign z14 = ~new_n69_ | (~new_n67_ & ~x15);
  assign new_n69_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~new_n67_ & ~x15) | new_n73_ | new_n71_ | x15;
  assign new_n71_ = x17 & x18 & x19 & new_n72_ & ~x20;
  assign new_n72_ = ~x21 & ~x22;
  assign new_n73_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (~x07 & (new_n75_ | new_n77_ | (~new_n71_ & x23)));
  assign new_n75_ = new_n76_ & x17 & x18 & x19;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n77_ = x04 & x05 & ~x15;
  assign z17 = x15 | (~x07 & (new_n79_ | new_n77_ | (~new_n75_ & x24)));
  assign new_n79_ = new_n80_ & new_n72_ & ~x23 & ~x24;
  assign new_n80_ = x17 & x18 & x19 & ~x20;
  assign z18 = ~new_n82_ | (~new_n67_ & ~x15);
  assign new_n82_ = (~x25 | (new_n80_ & new_n72_ & ~x23 & ~x24)) & ~x15 & (~new_n80_ | ~new_n72_ | x23 | x24 | x25);
endmodule
