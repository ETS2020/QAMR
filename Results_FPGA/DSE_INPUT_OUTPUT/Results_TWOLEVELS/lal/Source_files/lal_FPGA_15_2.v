...
module FAU ( 
  ...
  assign new_n68_ = ~x18 & (x15 | x25);
  assign new_n69_ = x20 & (x25 | (x21 & x22 & x24));
  assign new_n70_ = x23 & (x24 | x25);
  assign z09 = ~x15 & new_n72_ & ~x07;
  assign new_n72_ = x04 & x05;
  assign z10 = ~x07 & ~x15 & ~new_n72_ & ~x17;
  assign z11 = (x15 & ~x18) | (~x07 & ~new_n72_ & ((~x15 & ~x17 & x18) | (x17 & ~x18)));
  assign z12 = (x15 & ~x18) | (~x07 & ~new_n72_ & ((~x15 & (x17 ? (x18 & ~x19) : x19)) | (~x18 & x19)));
  assign z13 = (x18 & (x15 | (~x17 & x20) | (x17 & x19 & ~x20))) | (~x15 & (~new_n77_ | (x20 & (~x18 | ~x19))));
  assign new_n77_ = ~x07 & (~x04 | ~x05 | x07);
  assign z14 = x15 | ~new_n79_ | (~new_n77_ & ~x15);
  assign new_n79_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | ~new_n81_ | (~new_n77_ & ~x15);
  assign new_n81_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = (x18 & (~new_n83_ | x15)) | (~x15 & (~new_n77_ | new_n84_));
  assign new_n83_ = (x17 | ~x23) & (~x17 | ~x19 | x20 | x21 | x22 | x23);
  assign new_n84_ = x23 & (~x18 | ~x19 | x20 | x21 | x22);
  assign z17 = x15 | (~new_n77_ & ~x15) | new_n86_ | (x17 & new_n88_ & x18);
  assign new_n86_ = x24 & (~new_n87_ | ~x17 | ~x18 | ~x19);
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | ~new_n90_ | (~new_n77_ & ~x15);
  assign new_n90_ = (~x25 | (new_n65_ & ~x23 & ~x24 & ~x21 & ~x22)) & (~new_n65_ | x21 | x22 | x23 | x24 | x25);
endmodule
