...
module FAU ( 
  ...
  assign z13 = x07 | new_n68_ | new_n70_ | (~new_n69_ & x20);
  assign new_n68_ = ~x07 & (x15 | (x04 & x05 & ~x15));
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = new_n68_ | ~new_n72_ | x07;
  assign new_n72_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n68_ | (~x15 & (new_n75_ | new_n74_ | x07));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = ~new_n77_ | x07;
  assign new_n77_ = ~new_n68_ & (~x23 | (new_n69_ & ~x20 & ~x21 & ~x22)) & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = (~x07 & (~new_n80_ | x15)) | (~x15 & ((~new_n74_ & x24) | new_n79_ | x07));
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n80_ = (~x23 | ~x24) & (~x04 | ~x05 | x15);
  assign z18 = x07 | ~new_n82_ | new_n68_;
