...
module FAU ( 
  ...
  assign z13 = x07 | (~x15 & (new_n52_ | new_n65_ | (~new_n77_ & x20)));
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = ~new_n80_ | (~new_n79_ & ~x07);
  assign new_n79_ = ~x15 & (~x04 | ~x05 | x15);
  assign new_n80_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~new_n79_ & ~x07) | new_n84_ | new_n82_ | x07;
  assign new_n82_ = new_n77_ & new_n83_ & ~x20;
  assign new_n83_ = ~x21 & ~x22;
  assign new_n84_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x07 | (~new_n86_ & ~x15);
  assign new_n86_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~new_n52_ & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n79_ & ~x07) | new_n88_ | x07 | (~new_n82_ & x24);
  assign new_n88_ = ~x15 & ((x23 & x24) | (x17 & new_n89_ & x18));
  assign new_n89_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 | (~new_n91_ & ~x15);
  assign new_n91_ = (~x25 | (new_n65_ & new_n83_ & ~x23 & ~x24)) & ~new_n52_ & (~new_n65_ | ~new_n83_ | x23 | x24 | x25);
endmodule
