...
module FAU ( 
  ...
  assign new_n66_ = ~x08 & (x25 | (x24 & (new_n67_ | x23)));
  ...
  assign z13 = x15 | (~x15 & (new_n76_ | x07)) | new_n64_ | (~new_n77_ & x20);
  assign new_n76_ = x04 & x05 & ~x07;
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = x15 | ~new_n79_ | (~x15 & (new_n76_ | x07));
  assign new_n79_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x08 : (new_n82_ | x07 | new_n81_ | new_n76_);
  ...
  assign z17 = x15 ? ~x08 : (~new_n86_ | (x17 & new_n88_ & x18));
  assign new_n86_ = ~new_n76_ & ~x07 & (~x24 | (new_n77_ & new_n87_));
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x15 & (new_n90_ | x07 | new_n91_ | new_n76_));
