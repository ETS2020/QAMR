...
module FAU ( 
  ...
  assign z14 = z09 | new_n78_ | x15 | (~new_n64_ & x21);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = z09 | (~new_n78_ & x22) | new_n80_ | x15;
  assign new_n80_ = new_n76_ & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n82_ | z09;
  assign new_n82_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n84_ & ~x07) | z09 | ~new_n85_ | (~new_n80_ & x24);
  assign new_n84_ = (~x23 | ~x24) & (~new_n64_ | x21 | x22 | x23 | x24 | ~x25);
  assign new_n85_ = ~x15 & (~new_n64_ | ~new_n86_);
  assign new_n86_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z18 = z09 | ~new_n85_ | (~x07 & (~new_n64_ | ~new_n65_) & x25);
endmodule
