...
module FAU ( 
  ...
  assign z08 = new_n63_ | new_n65_ | (x25 & (~x18 | (~new_n67_ & ~x15)));
  assign new_n63_ = ~x17 & ((new_n64_ & ~x18 & ~x19) | (~x15 & x25));
  assign new_n64_ = x21 & x22 & x24;
  assign new_n65_ = x24 & ((~x15 & x25) | (~new_n66_ & (~x15 | ~x18)));
  ...
  assign z13 = (~x18 & (x15 | x20)) | (~new_n76_ & ~x15);
  assign new_n76_ = (~x20 | (x17 & x19)) & ~x07 & ~new_n77_ & (~x19 | x20 | ~x17 | ~x18);
  assign new_n77_ = x04 & x05 & ~x07;
  assign z14 = x15 | ~new_n79_ | (~x15 & (new_n77_ | x07));
  assign new_n79_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~x18 & (x15 | x22)) | (~new_n81_ & ~x15);
  assign new_n81_ = ~new_n82_ & ~x07 & ~new_n77_ & ~new_n83_;
  assign new_n82_ = x22 & (~x17 | ~x19 | x20 | x21);
  assign new_n83_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | ~new_n85_ | (~x15 & (new_n77_ | x07));
  assign new_n85_ = (~x23 | (new_n86_ & ~x20 & ~x21 & ~x22)) & (~new_n86_ | x22 | x23 | x20 | x21);
  assign new_n86_ = x17 & x18 & x19;
  assign z17 = (~x15 & (~new_n88_ | (x17 & new_n90_ & x18))) | (~x18 & (x15 | x24));
  assign new_n88_ = (new_n89_ | ~x24) & ~new_n77_ & ~x07;
  assign new_n89_ = x17 & x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n90_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x18 & x25) | (~x15 & (~new_n94_ | x07 | (~new_n92_ & x25)));
  assign new_n92_ = new_n93_ & ~x23 & ~x24 & x17 & x19 & ~x20;
  assign new_n93_ = ~x21 & ~x22;
  assign new_n94_ = ~new_n77_ & (~new_n69_ | ~new_n93_ | x23 | x24 | x25);
endmodule
