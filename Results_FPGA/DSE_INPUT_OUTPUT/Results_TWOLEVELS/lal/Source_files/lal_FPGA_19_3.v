...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n53_, new_n55_, new_n56_, new_n61_, new_n62_,
    ...
    new_n70_, new_n75_, new_n77_, new_n78_, new_n80_, new_n82_, new_n84_,
  ...
  assign new_n63_ = x25 & (~new_n64_ | x22 | (new_n65_ & new_n66_) | x24);
  ...
  assign z13 = x15 ? ~x16 : ~new_n77_;
  assign new_n77_ = (~x20 | (x17 & x18 & x19)) & ~x07 & ~new_n78_ & (~x17 | ~x18 | ~x19 | x20);
  assign new_n78_ = x04 & x05 & ~x07;
  assign z14 = x15 ? ~x16 : (~new_n80_ | x07 | (~new_n65_ & x21));
  assign new_n80_ = ~new_n78_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | ~new_n82_ | (~x15 & (new_n78_ | x07));
  assign new_n82_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = x15 ? ~x16 : (~new_n84_ | x07 | (~new_n86_ & x23));
  assign new_n84_ = ~new_n78_ & (~new_n85_ | ~x17 | ~x18 | ~x19);
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n86_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = x15 | (~new_n86_ & x24) | (~new_n88_ & ~x15);
  assign new_n88_ = new_n90_ & (~x17 | ~new_n89_ | ~x18);
  assign new_n89_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n90_ = ~x07 & (~x23 | ~x24) & (~x04 | ~x05 | x07);
  assign z18 = x15 ? ~x16 : (new_n92_ | ~new_n93_ | x07);
