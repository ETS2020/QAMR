...
module FAU ( 
  ...
  assign new_n82_ = ~x20 & (new_n83_ | (~x07 & x18 & x19 & ~x21));
  ...
  assign z18 = new_n105_ | ~new_n108_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n105_ = ~x25 & ((x15 & ~x24) | (~x23 & (new_n106_ | (~new_n51_ & x15))));
  ...
  assign new_n109_ = (~x15 | (~x25 & (~x23 | ~x24))) & (x07 | new_n110_ | ~x25);
