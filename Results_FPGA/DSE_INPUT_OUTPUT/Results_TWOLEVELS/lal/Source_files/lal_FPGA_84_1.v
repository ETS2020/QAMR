...
module FAU ( 
  ...
  assign new_n48_ = ~x15 & x24;
  assign z01 = (x04 & x05 & (x15 | (~x07 & ~x15 & ~x24))) | new_n50_ | (x07 & (x15 | ~x24));
  assign new_n50_ = ~x25 & ((x15 & ~new_n51_ & ~x23) | ~x24);
  ...
  assign z08 = new_n61_ | new_n65_ | new_n66_ | new_n48_ | (~new_n63_ & x25);
  assign new_n61_ = ~new_n62_ & ~x17;
  assign new_n62_ = ~x25 & (x18 | x19 | ~x21 | ~x22 | ~x24);
  assign new_n63_ = new_n64_ & ~x21 & ~x22 & (~new_n64_ | ~x17 | x22 | x23 | x20 | x21);
  ...
  assign z12 = ~x15 & (new_n72_ | x24);
  assign new_n72_ = ~x07 & ~new_n68_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n74_ & ~x24);
  assign new_n74_ = (~x20 | (x17 & x18 & x19)) & ~x07 & ~new_n75_ & (~x17 | ~x18 | ~x19 | x20);
  assign new_n75_ = x04 & x05 & ~x07 & ~x15;
  assign z14 = z09 | ~new_n77_ | x15 | (~new_n79_ & x21);
  assign new_n77_ = ~new_n78_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n78_ = x07 & ~x24;
  assign new_n79_ = x17 & x18 & x19 & ~x20;
  assign z15 = x15 | (~x24 & (new_n82_ | x07 | new_n81_ | (new_n68_ & ~x07 & ~x15)));
  assign new_n81_ = new_n64_ & x17 & ~x20 & ~x21 & ~x22;
  assign new_n82_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = z09 | new_n84_ | (~new_n81_ & x23) | new_n78_ | x15;
  assign new_n84_ = new_n85_ & x17;
  assign new_n85_ = x18 & x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = z09 | new_n84_ | new_n78_ | x15;
  assign z18 = z09 | ~new_n89_ | x15 | (~new_n88_ & x25);
  assign new_n88_ = new_n64_ & x17 & ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n89_ = ~new_n78_ & (~new_n79_ | x23 | x25 | x21 | x22);
endmodule
