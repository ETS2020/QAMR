...
module FAU ( 
  ...
  assign new_n78_ = ~new_n51_ & (~new_n69_ | ~new_n74_ | x23 | x24);
  assign z18 = ~new_n80_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n80_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~x07 & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
