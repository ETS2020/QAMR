...
module FAU ( 
  ...
  assign z14 = (~new_n71_ & ~x15) | (~new_n69_ & x21) | new_n72_ | x15;
  assign new_n71_ = ~x07 & (~x04 | ~x05 | x07);
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n74_ | (~new_n71_ & ~x15);
  assign new_n74_ = (new_n72_ | ~x22) & ~x15 & (~new_n67_ | x20 | x21 | x22);
  assign z16 = ~new_n76_ | (~new_n71_ & ~x15);
  assign new_n76_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n71_ & ~x15) | new_n78_ | new_n79_ | x15;
  assign new_n78_ = x24 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & new_n80_ & ~x23 & ~x24;
  assign new_n80_ = ~x21 & ~x22;
  assign z18 = x15 | (~new_n82_ & ~x07);
  assign new_n82_ = (~x25 | (new_n69_ & new_n80_ & ~x23 & ~x24)) & ~new_n68_ & (~new_n69_ | ~new_n80_ | x23 | x24 | x25);
endmodule
