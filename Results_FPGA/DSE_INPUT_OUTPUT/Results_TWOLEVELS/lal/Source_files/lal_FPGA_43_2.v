...
module FAU ( 
  ...
  assign z12 = (x15 & ~x16) | (~x07 & new_n75_ & ~x15);
  assign new_n75_ = ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n77_ & x20) | x07 | new_n65_ | (new_n51_ & ~x07 & ~x15);
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = x15 ? x16 : (~new_n79_ | x07 | (~new_n65_ & x21));
  assign new_n79_ = ~new_n80_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n80_ = x04 & x05 & ~x07;
  assign z15 = x15 ? x16 : (new_n84_ | new_n82_ | new_n80_ | x07);
  ...
  assign new_n89_ = (~x24 | (new_n77_ & new_n87_)) & ~new_n80_ & ~x07;
  assign new_n90_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | x07 | (~new_n92_ & ~x15);
  assign new_n92_ = (~x25 | (new_n65_ & new_n83_ & ~x23 & ~x24)) & ~new_n80_ & (~new_n65_ | ~new_n83_ | x23 | x24 | x25);
endmodule
