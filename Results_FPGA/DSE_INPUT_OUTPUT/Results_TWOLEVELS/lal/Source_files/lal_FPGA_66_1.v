// Benchmark "FAU" written by ABC on Mon Aug 24 18:24:53 2020
...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n55_, new_n56_, new_n61_, new_n62_, new_n63_,
    ...
    new_n74_, new_n76_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_,
    new_n86_;
  ...
  assign z14 = z09 | new_n78_ | x07 | (~new_n65_ & x21);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = z09 | (~new_n78_ & x22) | new_n80_ | x07;
  ...
  assign z17 = z09 | (~new_n84_ & ~x15) | ~new_n85_ | (~new_n80_ & x24);
  assign new_n84_ = (~x23 | ~x24) & (~new_n65_ | x21 | x22 | x23 | x24 | ~x25);
  assign new_n85_ = ~x07 & (~new_n65_ | ~new_n86_);
  assign new_n86_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z18 = z09 | ~new_n85_ | (~x15 & x25 & (~new_n65_ | ~new_n66_));
endmodule
