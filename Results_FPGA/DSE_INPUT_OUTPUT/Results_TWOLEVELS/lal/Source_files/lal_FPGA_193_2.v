...
module FAU ( 
  ...
  assign new_n79_ = ~x14 & (x07 | (x04 & x05 & ~x07 & ~x15));
  assign new_n80_ = (~x17 | ((~x18 | ~x19) & (~x15 | x23 | x25))) & (~x15 | x23 | x25 | (~x18 & ~x19));
  assign z14 = (~new_n82_ & ~x20) | new_n86_ | new_n79_ | (~new_n85_ & x21);
  ...
  assign z15 = new_n79_ | (new_n88_ & x19) | new_n89_ | new_n49_ | new_n90_;
  assign new_n88_ = ~x20 & (new_n84_ | (~x21 & ~x22 & x17 & x18));
  assign new_n89_ = x15 & (x25 | (x23 & x24) | (~x25 & (~x24 | (~x22 & ~x23))));
  assign new_n90_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = new_n79_ | ~new_n95_ | (~new_n92_ & ~x23);
  ...
  assign new_n95_ = (x17 | (~new_n78_ & ~x23)) & new_n96_ & (~x20 | (~new_n97_ & ~x23));
  assign new_n96_ = (~x15 | ((~x23 | ~x24) & ~x25 & (x24 | x25))) & (~x14 | x15) & (new_n94_ | ~x23);
  assign new_n97_ = x15 & x21 & x22 & x24;
  assign z17 = z09 | (~new_n99_ & ~x14) | new_n89_ | (~new_n101_ & x24);
  ...
  assign z18 = (~new_n103_ & ~x25) | ~new_n106_ | (~x17 & (new_n78_ | (~x14 & x25)));
  assign new_n103_ = (~x15 | x24) & (x23 | (~new_n104_ & (new_n53_ | ~x15)));
  assign new_n104_ = ~x20 & (((new_n105_ | x15) & x17) | (x15 & (x18 | x19)));
  assign new_n105_ = ~x21 & ~x22 & ~x24 & ~x14 & x18 & x19;
  assign new_n106_ = (~x20 | (~new_n97_ & (x14 | ~x25))) & ~new_n109_ & (new_n107_ | x14);
  assign new_n107_ = (new_n108_ | ~x25) & ~x07 & (~x04 | ~x05 | x07 | x15);
