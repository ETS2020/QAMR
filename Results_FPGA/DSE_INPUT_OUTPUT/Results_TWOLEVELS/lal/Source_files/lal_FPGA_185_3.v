...
module FAU ( 
  ...
  assign z14 = (~x07 & (new_n52_ | x15)) | (~x15 & (new_n78_ | x07 | (~new_n65_ & x21)));
  ...
  assign z17 = x07 | new_n86_ | ((~new_n87_ | new_n52_) & ~x07) | (~new_n84_ & x24);
  ...
  assign z18 = (~x15 & (new_n89_ | x07)) | (~x07 & (new_n90_ | new_n52_ | x15));
