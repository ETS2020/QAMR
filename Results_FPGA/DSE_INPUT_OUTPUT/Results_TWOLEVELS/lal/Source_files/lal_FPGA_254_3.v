...
module FAU ( 
  ...
  assign z03 = ~x25 & ~new_n50_ & (~x15 | (~x07 & x15));
  ...
  assign z08 = (~x15 & (~new_n61_ | (~new_n66_ & ~x17))) | (~x07 & ~new_n68_ & x15);
  ...
  assign z13 = (~new_n75_ & ~x20) | ~new_n79_ | (~x17 & (new_n81_ | (~x15 & x20)));
  assign new_n75_ = ~new_n76_ & (~x17 | (~new_n78_ & (~new_n77_ | x15)));
  assign new_n76_ = ~x07 & x15 & ~x23 & ~new_n67_ & ~x25;
  assign new_n77_ = x18 & x19;
  assign new_n78_ = ~x07 & x15 & ~x23 & ~x25;
  assign new_n79_ = (x07 | (~new_n70_ & (new_n80_ | ~x15))) & (x15 | (~x07 & (new_n77_ | ~x20)));
  ...
  assign z14 = x07 | new_n84_ | (~new_n64_ & x21) | (~new_n85_ & ~x07);
  assign new_n84_ = x19 & ~x20 & (new_n78_ | (x17 & x18 & ~x21));
  assign new_n85_ = ~new_n70_ & (~x15 | ((x25 | (x24 & (x21 | x23))) & ~x25 & (~x23 | ~x24)));
  assign z15 = ~new_n87_ | (~x20 & (new_n76_ | (~new_n90_ & x17)));
  assign new_n87_ = (new_n88_ | ~x22) & (~x07 | x15) & (x07 | (~new_n70_ & (new_n89_ | ~x15)));
  assign new_n88_ = (new_n64_ | x15) & (~x21 | (x15 & (x07 | ~x15 | new_n51_ | ~x24)));
  assign new_n89_ = (x25 | (x24 & (new_n52_ | x23))) & ~x25 & (~x23 | ~x24);
  assign new_n90_ = ~new_n78_ & (x15 | ~x18 | ~new_n91_ | ~x19);
  ...
  assign new_n94_ = (~x17 | (~new_n95_ & (x07 | ~x15 | x25))) & (x07 | ~x15 | new_n67_ | x25);
  ...
  assign new_n107_ = ~x20 & ((x17 & (new_n108_ | (~x07 & x15))) | (~x07 & ~new_n67_ & x15));
