...
module FAU ( 
  ...
  assign z00 = x08 & ~x16;
  assign z01 = new_n49_ | (x04 & x05) | x07 | (~x15 & x16);
  ...
  assign z08 = new_n66_ | (~x16 & (new_n60_ | new_n68_ | new_n62_ | new_n69_));
  ...
  assign new_n77_ = ~x15 & (x16 | (x04 & x05 & ~x07 & ~x16));
  ...
  assign z17 = new_n77_ | (~new_n86_ & ~x16) | ~new_n87_ | (~new_n82_ & x24);
  ...
  assign z18 = new_n77_ | ~new_n87_ | (~x16 & x25 & (~new_n64_ | ~new_n65_));
endmodule
