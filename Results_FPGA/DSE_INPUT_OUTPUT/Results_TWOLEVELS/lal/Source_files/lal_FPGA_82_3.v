...
module FAU ( 
  ...
  assign z01 = x07 | (~x07 & (new_n53_ | (~new_n51_ & ~x25)));
  ...
  assign z14 = x07 | ~new_n76_ | (~x07 & (new_n53_ | x15));
  assign new_n76_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | ~new_n78_ | (~x07 & (new_n53_ | x15));
  assign new_n78_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = (~new_n80_ & ~x15) | (~x07 & (new_n53_ | x15));
  assign new_n80_ = (~x23 | (new_n74_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n74_ | x20 | x21 | x22 | x23);
