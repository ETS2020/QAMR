...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n62_,
    ...
    new_n70_, new_n75_, new_n78_, new_n80_, new_n81_, new_n82_, new_n84_,
  ...
  assign z13 = z09 | (x20 & (~x17 | ~x18 | ~x19)) | x07 | (x17 & x18 & x19 & ~x20);
  assign z14 = z09 | ~new_n78_;
  assign new_n78_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = z09 | new_n82_ | new_n80_ | x07;
  assign new_n80_ = x17 & x18 & x19 & new_n81_ & ~x20;
  assign new_n81_ = ~x21 & ~x22;
  assign new_n82_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x07 | (~x15 & (new_n84_ | new_n51_ | (~new_n80_ & x23)));
  assign new_n84_ = new_n85_ & x17 & x18 & x19;
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 | (~x15 & (new_n87_ | new_n51_ | (~new_n84_ & x24)));
  assign new_n87_ = x17 & new_n88_ & x18;
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 | (~new_n90_ & ~x15);
  assign new_n90_ = (~x25 | (new_n65_ & new_n81_ & ~x23 & ~x24)) & ~new_n51_ & (~new_n65_ | ~new_n81_ | x23 | x24 | x25);
endmodule
