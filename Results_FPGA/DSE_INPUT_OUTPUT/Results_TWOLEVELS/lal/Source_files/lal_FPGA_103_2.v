// Benchmark "FAU" written by ABC on Mon Aug 24 18:25:07 2020
...
module FAU ( 
  ...
  assign z04 = ~x08 & ((~new_n56_ & (~x11 | x14)) | (x02 & ~x11) | (~x02 & x11 & x14));
  ...
  assign z08 = ~new_n48_ & ((~new_n65_ & ~x17) | new_n66_ | new_n61_ | new_n67_);
  ...
  assign z12 = new_n48_ | (new_n72_ & ~x07);
  assign new_n72_ = ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = ~new_n48_ & ((~new_n74_ & x20) | ~new_n75_ | new_n63_ | (new_n52_ & new_n75_));
  assign new_n74_ = x17 & x18 & x19;
  assign new_n75_ = ~x07 & ~x15;
  assign z14 = (~new_n48_ & ~new_n75_) | (~new_n63_ & x21) | new_n52_ | new_n48_ | new_n77_;
  assign new_n77_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n48_ & ((~new_n77_ & x22) | ~new_n75_ | new_n79_ | (new_n52_ & new_n75_));
  assign new_n79_ = new_n74_ & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n48_ & (~new_n81_ | ~new_n75_ | (~new_n79_ & x23));
  assign new_n81_ = (~new_n74_ | ~new_n82_) & (~new_n52_ | ~new_n75_);
  assign new_n82_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = ~new_n48_ & (~new_n84_ | (x17 & new_n85_ & x18));
  assign new_n84_ = (~x24 | (new_n74_ & new_n82_)) & ~x07 & ~x15 & (~new_n52_ | x07 | x15);
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n48_ & ((x25 & (~new_n63_ | ~new_n64_)) | ~new_n87_ | ~new_n75_);
  assign new_n87_ = (~new_n63_ | ~new_n88_) & (~new_n52_ | ~new_n75_);
