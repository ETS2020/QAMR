...
module FAU ( 
  ...
  assign z14 = (~new_n48_ & ~new_n68_) | (~new_n70_ & x21) | new_n52_ | new_n48_ | new_n72_;
  ...
  assign z17 = new_n78_ | ~new_n79_ | new_n52_ | (~new_n74_ & x24);
  assign new_n78_ = ~new_n48_ & (x07 | x15 | (x23 & x24));
  assign new_n79_ = ~new_n48_ & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = ~new_n48_ & (new_n81_ | ~new_n68_ | new_n82_ | (new_n52_ & new_n68_));
