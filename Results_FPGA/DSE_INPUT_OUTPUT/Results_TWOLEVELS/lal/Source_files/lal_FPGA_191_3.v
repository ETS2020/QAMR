...
module FAU ( 
  ...
  assign z15 = (~x07 & (x15 | (x04 & x05 & ~x15))) | (~x15 & (new_n81_ | new_n82_ | x07));
  assign new_n81_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n82_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x07 | ~new_n84_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n84_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n86_ & ~x15) | (~x07 & (x15 | (x23 & x24)));
  assign new_n86_ = (~x17 | ~new_n87_ | ~x18) & new_n88_ & (new_n82_ | ~x24);
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n88_ = ~x07 & (~x04 | ~x05 | x07);
  assign z18 = x07 | (~x07 & (x15 | (x04 & x05 & ~x15))) | (~new_n90_ & ~x15);
