...
module FAU ( 
  ...
  assign z01 = new_n49_ | (x04 & x05) | x07 | (x15 & x25);
  ...
  assign z08 = new_n60_ | new_n65_ | new_n66_ | (~x15 & ~new_n62_ & x25);
  assign new_n60_ = ~x17 & ((~x15 & x25) | (new_n61_ & x22 & x24 & ~x25));
  ...
  assign new_n65_ = x20 & ((~x15 & x25) | (x21 & x22 & x24 & ~x25));
  assign new_n66_ = x23 & (x25 ? ~x15 : x24);
  assign z09 = ~x15 & ~x07 & x04 & x05;
  assign z10 = ~x07 & ~x15 & ~x17 & (~x04 | ~x05);
  assign z11 = (x15 & x25) | (~x07 & new_n70_ & ~x15);
  assign new_n70_ = (~x04 | ~x05) & (~x17 ^ ~x18);
  assign z12 = (x15 & x25) | (~x07 & new_n72_ & ~x15);
  assign new_n72_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? ~x25 : ~new_n74_;
  assign new_n74_ = (new_n75_ | ~x20) & ~x07 & ~new_n64_ & (~x04 | ~x05 | x07);
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = x15 | ~new_n77_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n77_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | ~new_n79_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n79_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = x15 | ~new_n81_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n81_ = (~x23 | (new_n75_ & ~x20 & ~x21 & ~x22)) & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | new_n83_ | new_n85_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n83_ = x17 & x18 & x19 & new_n84_ & ~x20;
  assign new_n84_ = ~x21 & ~x22 & ~x23 & ~x24 & (~x25 | (~x15 & x25));
  assign new_n85_ = x24 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z18 = (~x25 & (new_n87_ | x15)) | (~x15 & ((~new_n87_ & x25) | x07 | (x04 & x05 & ~x07)));
  assign new_n87_ = new_n64_ & ~x21 & ~x22 & ~x23 & ~x24;
endmodule
