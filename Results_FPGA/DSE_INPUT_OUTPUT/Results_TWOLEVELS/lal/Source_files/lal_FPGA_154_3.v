...
module FAU ( 
  ...
  assign z12 = x07 ? x15 : (new_n65_ & ~x15);
  assign new_n65_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x07 | (~new_n67_ & ~x07) | new_n69_ | (~new_n68_ & x20);
  assign new_n67_ = ~x15 & (~x04 | ~x05 | x15);
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = x07 | (~new_n67_ & ~x07) | new_n71_ | (~new_n69_ & x21);
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n67_ & ~x07) | (~new_n73_ & ~x15);
  assign new_n73_ = (new_n71_ | ~x22) & ~x07 & (~new_n68_ | x20 | x21 | x22);
  assign z16 = x07 | ~new_n75_ | (~new_n67_ & ~x07);
  assign new_n75_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n67_ & ~x07) | (~x15 & (new_n77_ | new_n78_ | x07));
  assign new_n77_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n78_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 | ~new_n80_ | (~new_n67_ & ~x07);
  assign new_n80_ = (~x25 | (new_n69_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n69_ | x21 | x22 | x23 | x24 | x25);
endmodule
