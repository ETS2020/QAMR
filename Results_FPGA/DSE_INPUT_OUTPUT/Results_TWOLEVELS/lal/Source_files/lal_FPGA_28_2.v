...
module FAU ( 
  ...
  assign z08 = (~new_n66_ & ~x17) | new_n67_ | new_n68_ | new_n62_ | new_n48_;
  ...
  assign z14 = x15 ? x25 : ((~new_n64_ & x21) | ~new_n77_ | x07);
  assign new_n77_ = ~new_n75_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | new_n79_ | x07 | new_n80_ | (new_n52_ & ~x07 & ~x15);
  assign new_n79_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~new_n80_ & x23) | x07 | new_n82_ | (new_n52_ & ~x07 & ~x15);
  assign new_n82_ = new_n83_ & x17 & x18 & x19;
  assign new_n83_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~new_n85_ & ~x15) | new_n87_ | x07 | (~new_n82_ & x24);
  assign new_n85_ = ~new_n75_ & (~new_n64_ | ~new_n86_);
  assign new_n86_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n87_ = new_n64_ & ~x21 & ~x22 & ~x23 & ~x24 & x25;
  assign z18 = new_n89_ | (~x15 & (~new_n85_ | x07));
  assign new_n89_ = x25 & (~new_n90_ | ~x18 | ~x19 | x15 | ~x17);
