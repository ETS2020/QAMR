...
module FAU ( 
  ...
  assign z13 = x15 | (~new_n73_ & x20) | x07 | new_n74_ | (new_n52_ & ~x07 & ~x15);
  assign new_n73_ = x17 & x18 & x19;
  assign new_n74_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~x19 & (x15 | x21)) | (~x15 & (~new_n76_ | x07 | (~new_n78_ & x21)));
  assign new_n76_ = ~new_n77_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n77_ = x04 & x05 & ~x07;
  assign new_n78_ = x17 & x18 & ~x20;
  assign z15 = (~new_n80_ & ~x15) | (~x19 & (x15 | x22));
  assign new_n80_ = ~new_n81_ & ~x07 & ~new_n77_ & ~new_n82_;
  assign new_n81_ = x22 & (x20 | x21 | ~x17 | ~x18);
  assign new_n82_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n84_ & ~x15) | (~x19 & (x15 | x23));
  assign new_n84_ = ~new_n85_ & ~x07 & ~new_n77_ & (~new_n73_ | ~new_n86_);
  assign new_n85_ = x23 & (~x17 | ~x18 | x20 | x21 | x22);
  ...
  assign new_n90_ = ~new_n77_ & ~x07 & (new_n91_ | ~x24);
  assign new_n91_ = x17 & x18 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z18 = x15 | new_n94_ | x07 | (~x15 & (new_n93_ | new_n77_));
  assign new_n93_ = new_n74_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n94_ = x25 & (~new_n74_ | x23 | x24 | x21 | x22);
endmodule
