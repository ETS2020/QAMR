...
module FAU ( 
  ...
  assign z15 = (~x15 & (x18 | (x04 & x05 & ~x07 & ~x18))) | (x07 & ~x18) | x15 | x22;
  assign z16 = x15 | (~x18 & (x07 | x23 | (x04 & x05 & ~x07 & ~x15)));
  assign z17 = (~x15 & (x18 | (x04 & x05 & ~x07 & ~x18))) | (x07 & ~x18) | x15 | x24;
  assign z18 = (~x15 & (x18 | (x04 & x05 & ~x07 & ~x18))) | (x07 & ~x18) | x15 | x25;
endmodule
