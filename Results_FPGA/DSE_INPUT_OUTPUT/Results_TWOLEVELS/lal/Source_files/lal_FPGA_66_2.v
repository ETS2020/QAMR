...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n56_, new_n57_, new_n62_,
    ...
    new_n70_, new_n71_, new_n77_, new_n79_, new_n81_, new_n83_, new_n84_,
  ...
  assign z08 = new_n68_ | (~x07 & (new_n62_ | new_n70_ | new_n64_ | new_n71_));
  ...
  assign new_n68_ = x15 & (x25 | ((new_n69_ | x23) & x24));
  assign new_n69_ = x21 & x22 & ((~x17 & ~x18 & ~x19) | x20);
  ...
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n77_ | new_n48_ | (x17 & x18 & x19 & ~x20);
  assign new_n77_ = ~new_n52_ & ~x15;
  assign z14 = (~new_n66_ & x21) | ~new_n77_ | new_n48_ | new_n79_;
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n79_ & x22) | ~new_n77_ | new_n48_ | new_n81_;
  assign new_n81_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n77_ | ~new_n83_ | (~new_n81_ & x23);
  assign new_n83_ = ~new_n48_ & (~new_n84_ | ~x17 | ~x18 | ~x19);
  assign new_n84_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n86_ & ~x07) | ~new_n87_ | (~new_n81_ & x24);
  assign new_n86_ = (~x23 | ~x24) & (~new_n66_ | x21 | x22 | x23 | x24 | ~x25);
  assign new_n87_ = ~new_n52_ & ~x15 & (~new_n66_ | ~new_n88_) & (~x07 | x15);
  assign new_n88_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z18 = ~new_n87_ | (~x07 & x25 & (~new_n66_ | ~new_n67_));
endmodule
