...
module FAU ( 
  ...
  assign z01 = (x04 & x05 & (x15 | (~x07 & ~x12 & ~x15))) | ((~x12 | x15) & (new_n51_ | x07));
  ...
  assign z09 = ~x15 & new_n70_ & ~x07 & ~x12;
  assign new_n70_ = x04 & x05;
  assign z10 = ~x15 & (x12 | (~x07 & ~new_n70_ & ~x17));
  assign z11 = ~x15 & (x12 | (~x07 & ~new_n70_ & (~x17 ^ ~x18)));
  assign z12 = (new_n74_ | x12) & ~x15;
  assign new_n74_ = ~x07 & ~new_n70_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n78_ | (~new_n80_ & ~x20) | ~new_n76_ | (~x17 & (new_n79_ | x20));
  assign new_n76_ = (new_n77_ | ~x15) & (~x12 | x15) & (~x20 | (x18 & x19));
  assign new_n77_ = (x25 | (x24 & (new_n53_ | x23))) & ~x25 & (~x24 | (~x23 & (~new_n53_ | ~x20)));
  assign new_n78_ = ~x12 & (x07 | (new_n70_ & ~x07 & ~x15));
  assign new_n79_ = new_n66_ & x15 & ~x18 & ~x19;
  assign new_n80_ = (~x17 | ((~x18 | ~x19) & (~x15 | x23 | x25))) & (~x15 | x23 | x25 | (~x18 & ~x19));
  assign z14 = new_n78_ | ~new_n82_ | (x17 & ~x20 & (new_n64_ | new_n84_));
  assign new_n82_ = ~new_n83_ & ~new_n49_ & (new_n65_ | ~x21);
  assign new_n83_ = x15 & ((~x25 & (~x24 | (~x21 & ~x23))) | x25 | (x23 & x24));
  assign new_n84_ = x15 & ~x23 & ~x25;
  assign z15 = new_n78_ | (~new_n86_ & ~x21) | new_n87_ | new_n49_ | new_n88_;
  assign new_n86_ = ~new_n84_ & (~x17 | ~x18 | ~x19 | x20 | x22);
  assign new_n87_ = x15 & ((~x25 & (~x24 | (~x22 & ~x23))) | x25 | (x23 & x24));
  assign new_n88_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = new_n78_ | (~new_n90_ & ~x23) | ~new_n93_ | (~x17 & (new_n79_ | x23));
  assign new_n90_ = (new_n91_ | x20) & (~x15 | new_n53_ | x25);
  assign new_n91_ = (~x17 | (~new_n92_ & (~x15 | x25))) & (~x15 | x25 | (~x18 & ~x19));
  assign new_n92_ = x18 & x19 & ~x21 & ~x22;
  assign new_n93_ = (~x20 | (~new_n94_ & ~x23)) & ~new_n95_ & ~new_n49_ & (new_n92_ | ~x23);
  assign new_n94_ = x15 & x21 & x22 & x24;
  assign new_n95_ = x15 & ((x23 & x24) | x25 | (~x24 & ~x25));
  assign z17 = ~new_n97_ | (~x15 & (x12 | (new_n70_ & ~x07 & ~x12)));
  assign new_n97_ = (~new_n98_ | x21) & new_n100_ & (x12 | (~new_n102_ & ~x07));
  assign new_n98_ = ~x23 & ((x15 & ~x25) | (x17 & new_n99_ & x18));
  assign new_n99_ = x19 & ~x20 & ~x22 & ~x24 & (~x25 | (~x12 & x25));
  assign new_n100_ = ~new_n95_ & (new_n101_ | ~x24);
  assign new_n101_ = ~x20 & ~x21 & ~x22 & x17 & x18 & x19;
  assign new_n102_ = x23 & x24;
  assign z18 = new_n104_ | ~new_n107_ | (~x15 & (x12 | (new_n70_ & ~x07 & ~x12)));
  ...
  assign new_n107_ = (x17 | (~new_n79_ & ~new_n110_)) & new_n108_ & (~x20 | (~new_n94_ & ~new_n110_));
  assign new_n108_ = (~x15 | (~new_n102_ & ~x25)) & (x12 | (~x07 & (new_n109_ | ~x25)));
  assign new_n109_ = ~x22 & ~x23 & ~x24 & x18 & x19 & ~x21;
  assign new_n110_ = ~x12 & x25;
endmodule
