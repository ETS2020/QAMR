...
module FAU ( 
  ...
  assign z01 = (x04 & x05 & (x15 | (~x07 & ~x15))) | (new_n51_ & ~x07) | (x07 & x15);
  ...
  assign new_n72_ = ~x15 & (~x04 | ~x05) & (((~x17 | ~x18) & x19) | (x17 & x18 & ~x19));
  assign z13 = new_n74_ | (~new_n75_ & x20) | new_n65_ | x15;
  assign new_n74_ = ~x15 & (x07 | (x04 & x05 & ~x07));
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = new_n74_ | ~new_n77_;
  assign new_n77_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x07 & (new_n81_ | new_n79_ | (x04 & x05 & ~x15)));
  ...
  assign new_n83_ = (~x23 | (new_n75_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z17 = new_n74_ | new_n85_ | x15 | (x17 & new_n86_ & x18);
  assign new_n85_ = x24 & (~new_n75_ | x22 | x23 | x20 | x21);
