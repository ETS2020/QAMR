...
module FAU ( 
  ...
  assign z09 = (~x04 & x15) | (~x07 & ~x15 & x04 & x05);
  assign z10 = ~x07 & ~x15 & ~x17 & (~x04 | ~x05);
  assign z11 = (~x04 & x15) | (~x07 & (x17 ^ x18) & (~x04 | (~x05 & ~x15)));
  assign z12 = (~x04 & x15) | (~x07 & ~new_n72_ & (~x04 | (~x05 & ~x15)));
  assign new_n72_ = (~x17 | ~x18 | x19) & (~x19 | (x17 & x18));
  assign z13 = new_n74_ | (~x15 & ((~new_n75_ & x20) | new_n65_ | x07));
  assign new_n74_ = x04 & (x15 | (x05 & ~x07 & ~x15));
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = new_n74_ | (~new_n65_ & x21) | new_n48_ | new_n77_ | new_n78_;
  assign new_n77_ = x07 & ~x15;
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n74_ | (~x15 & ((~new_n78_ & x22) | new_n80_ | x07));
  assign new_n80_ = new_n75_ & ~x20 & ~x21 & ~x22;
  assign z16 = new_n74_ | (~new_n80_ & x23) | new_n48_ | new_n82_ | new_n77_;
  assign new_n82_ = new_n75_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n74_ | new_n84_ | new_n48_ | new_n77_ | (~new_n82_ & x24);
  assign new_n84_ = x17 & new_n85_ & x18;
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n74_ | new_n87_ | new_n48_ | new_n88_ | new_n77_;
  assign new_n87_ = x25 & (~new_n65_ | x21 | x22 | x23 | x24);
  assign new_n88_ = new_n65_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
