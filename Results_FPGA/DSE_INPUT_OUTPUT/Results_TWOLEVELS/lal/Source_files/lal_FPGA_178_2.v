...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n51_, new_n52_, new_n54_, new_n55_, new_n60_, new_n61_, new_n66_,
  ...
  assign z13 = (~new_n68_ & ~x15) | (x19 & ((x20 & (~x17 | ~x18)) | x15 | (x17 & x18 & ~x20)));
  assign new_n68_ = ~x07 & (~x04 | ~x05 | x07) & (x19 | ~x20);
  assign z14 = (~x15 & (~new_n71_ | (x21 & (~x19 | x20)))) | (x19 & ((~new_n70_ & x21) | x15 | (new_n70_ & ~x20 & ~x21)));
  assign new_n70_ = x17 & x18;
  assign new_n71_ = ~x07 & (~x04 | ~x05 | x07);
  assign z15 = x15 | ~new_n73_ | (~new_n71_ & ~x15);
  assign new_n73_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = x15 | ~new_n75_ | (~new_n71_ & ~x15);
  assign new_n75_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & (~new_n76_ | x20 | x21 | x22 | x23);
  assign new_n76_ = x17 & x18 & x19;
  assign z17 = x15 | (~new_n71_ & ~x15) | new_n80_ | (~new_n78_ & x24);
  assign new_n78_ = new_n76_ & new_n79_ & ~x22 & ~x23;
  assign new_n79_ = ~x20 & ~x21;
  assign new_n80_ = new_n81_ & new_n70_ & x19 & ~x20;
  assign new_n81_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n83_ | (~new_n71_ & ~x15) | (x19 & (new_n85_ | x15));
  assign new_n83_ = x25 & ((~new_n84_ & x19) | (~x15 & (~x19 | x20 | x23)));
  assign new_n84_ = x17 & x18 & ~x21 & ~x22 & ~x24;
  assign new_n85_ = new_n70_ & new_n79_ & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
