...
module FAU ( 
  ...
  assign z12 = x07 ? x15 : (~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19)));
  assign z13 = (~x07 & (new_n51_ | x15)) | (~x15 & ((~new_n76_ & x20) | new_n65_ | x07));
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = x07 | ~new_n78_ | (~x07 & (new_n51_ | x15));
  assign new_n78_ = (~x21 | (x19 & ~x20 & x17 & x18)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  ...
  assign z17 = (~x07 & (new_n51_ | x15)) | (~x15 & (new_n84_ | new_n86_ | x07));
  assign new_n84_ = x17 & new_n85_ & x18;
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n86_ = x24 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z18 = x07 | (~new_n88_ & ~x15) | (~x07 & (new_n51_ | x15));
  assign new_n88_ = (~x25 | (new_n65_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n65_ | x21 | x22 | x23 | x24 | x25);
endmodule
