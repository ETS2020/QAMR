...
module FAU ( 
  ...
  assign z01 = (x04 & x05 & (x03 | (~x07 & ~x15))) | ((x03 | ~x15) & (new_n49_ | x07));
  ...
  assign z11 = (~x03 & x15) | (~x07 & new_n64_ & ~x15);
  assign new_n64_ = (~x04 | ~x05) & (x17 ^ x18);
  assign z12 = (~x03 & x15) | (~x07 & new_n66_ & ~x15);
  assign new_n66_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? x03 : ~new_n68_;
  ...
  assign z15 = x15 ? x03 : (new_n76_ | x07 | new_n75_ | new_n70_);
  ...
  assign z17 = x15 ? x03 : (new_n80_ | ~new_n81_ | x07);
  assign new_n80_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n81_ = ~new_n70_ & (~new_n71_ | x23 | x24 | x21 | x22);
  assign z18 = x15 | ~new_n83_ | (~x15 & (new_n70_ | x07));
  assign new_n83_ = (~x25 | (new_n71_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n71_ | x21 | x22 | x23 | x24 | x25);
endmodule
