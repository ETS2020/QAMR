...
module FAU ( 
  ...
  assign z14 = new_n76_ | (~x15 & (new_n79_ | x07 | (~new_n64_ & x21)));
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n76_ | (~x15 & (new_n81_ | x07 | (~new_n79_ & x22)));
  assign new_n81_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = new_n76_ | (~new_n83_ & ~x15);
  assign new_n83_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n85_ & ~x15) | (~x07 & (x15 | (x23 & x24)));
  assign new_n85_ = (~x17 | ~new_n86_ | ~x18) & new_n87_ & (new_n81_ | ~x24);
  assign new_n86_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n87_ = ~x07 & (~x04 | ~x05 | x07);
  assign z18 = x07 | new_n76_ | (~new_n89_ & ~x15);
  assign new_n89_ = (~x25 | (new_n64_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n64_ | x21 | x22 | x23 | x24 | x25);
endmodule
