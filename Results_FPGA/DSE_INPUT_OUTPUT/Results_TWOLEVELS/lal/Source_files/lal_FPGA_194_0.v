...
module FAU ( 
  ...
  assign z03 = (~x15 & ~x23) | (~x25 & ((~x24 & (x15 | x23)) | (x15 & ~new_n51_ & ~x23)));
  assign z04 = (~x15 & ~x23) | (~x08 & (~new_n55_ | ~new_n56_));
  ...
  assign z13 = z09 | new_n69_ | ~new_n70_;
  assign new_n69_ = x23 & (x07 | (x17 & x18 & x19 & ~x20));
  assign new_n70_ = ~x15 & (~x20 | (x17 & x18 & x19));
  assign z14 = x15 | (x23 & (new_n72_ | new_n73_ | x07 | (new_n64_ & ~x07 & ~x15)));
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign new_n73_ = x21 & (~x17 | ~x18 | ~x19 | x20);
  assign z15 = x15 | (x23 & (new_n75_ | x07 | new_n76_ | (new_n64_ & ~x07 & ~x15)));
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x23 & ((~x07 & ~new_n78_ & ~x15) | new_n79_ | x07 | x20));
  ...
  assign z18 = z09 | x15 | x25 | (x07 & x23);
endmodule
