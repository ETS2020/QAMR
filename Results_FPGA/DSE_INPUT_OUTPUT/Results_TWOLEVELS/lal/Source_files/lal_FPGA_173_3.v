...
module FAU ( 
  ...
  assign z17 = (~new_n87_ & ~x07) | new_n85_ | x07 | x15 | (~new_n80_ & x24);
  assign new_n85_ = x17 & x18 & x19 & new_n86_ & ~x20;
  assign new_n86_ = ~x21 & ~x22 & ~x23 & ~x24 & (~x25 | (~x15 & x25));
  assign new_n87_ = (~x23 | ~x24) & (~x04 | ~x05 | x15);
  assign z18 = (~x15 & (new_n89_ | (x04 & x05 & ~x07))) | x07 | new_n90_ | x15;
