...
module FAU ( 
  ...
  assign z01 = (~x07 & ~new_n50_ & ~x25) | x07 | (x04 & x05);
  ...
  assign new_n72_ = ~x07 & ((x04 & x05) | ((~x19 | (x17 & (x07 | x18))) & (~x17 | ~x18 | x19)));
  assign z13 = x15 | (~x07 & (new_n74_ | new_n65_ | (x04 & x05 & ~x15)));
  ...
  assign z15 = x15 | (~x07 & (new_n82_ | new_n80_ | (x04 & x05 & ~x15)));
  assign new_n80_ = new_n75_ & new_n81_ & ~x20;
  assign new_n81_ = ~x21 & ~x22;
  assign new_n82_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = ~new_n84_ | (~new_n77_ & ~x15);
  assign new_n84_ = (~x23 | (new_n75_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n77_ & ~x15) | (x17 & new_n87_ & x18) | new_n86_ | x15;
