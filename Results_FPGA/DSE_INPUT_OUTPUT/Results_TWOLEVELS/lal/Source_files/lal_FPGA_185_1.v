...
module FAU ( 
  ...
  assign new_n84_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~new_n52_ & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = z09 | new_n86_ | x07 | (~new_n81_ & x24);
  assign new_n86_ = ~x15 & ((x23 & x24) | (x17 & new_n87_ & x18));
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 | (~new_n89_ & ~x15);
  assign new_n89_ = (~x25 | (new_n65_ & new_n82_ & ~x23 & ~x24)) & ~new_n52_ & (~new_n65_ | ~new_n82_ | x23 | x24 | x25);
endmodule
