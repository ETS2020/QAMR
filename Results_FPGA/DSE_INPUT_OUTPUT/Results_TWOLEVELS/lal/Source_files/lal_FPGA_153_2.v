...
module FAU ( 
  ...
  assign z14 = new_n73_ | (~new_n71_ & x21) | x15 | new_n74_ | (x03 & ~x15);
  assign new_n73_ = ~x03 & (new_n70_ | x07);
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n73_ | (~new_n74_ & x22) | x15 | new_n76_ | (x03 & ~x15);
  assign new_n76_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = new_n73_ | (~new_n76_ & x23) | x15 | new_n78_ | (x03 & ~x15);
  assign new_n78_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x03 & (new_n80_ | x07 | new_n81_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n80_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n81_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x03 & (~new_n83_ | x07 | (~new_n81_ & x25)));
