...
module FAU ( 
  ...
  assign z14 = (~new_n79_ & ~x15) | new_n80_ | x15 | (~new_n64_ & x21);
  assign new_n79_ = ~x07 & (~x04 | ~x05 | x07);
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n82_ | (~new_n79_ & ~x15);
  assign new_n82_ = (new_n80_ | ~x22) & ~x15 & (~new_n76_ | x20 | x21 | x22);
  assign z16 = ~new_n84_ | (~new_n79_ & ~x15);
  assign new_n84_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x07 & (new_n86_ | new_n88_ | new_n77_));
  ...
  assign new_n90_ = (~x25 | (new_n64_ & new_n91_ & ~x23 & ~x24)) & ~new_n77_ & (~new_n64_ | ~new_n91_ | x23 | x24 | x25);
