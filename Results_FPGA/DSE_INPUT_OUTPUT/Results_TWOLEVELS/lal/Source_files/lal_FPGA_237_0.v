...
module FAU ( 
  ...
  assign z12 = ~x15 & (~x19 | (~x07 & ~new_n51_ & (x17 ? ~x18 : x19)));
  assign z13 = (~x15 & (~x19 | (new_n51_ & ~x07 & x19))) | new_n68_ | x07 | new_n70_ | x15;
  assign new_n68_ = ~new_n69_ & x20;
  assign new_n69_ = x17 & x18;
  assign new_n70_ = x17 & x18 & ~x20;
  assign z14 = x15 | (~new_n72_ & x19);
  assign new_n72_ = (new_n70_ | ~x21) & ~x07 & ~new_n73_ & ~new_n74_;
  assign new_n73_ = x04 & x05 & ~x07 & ~x15;
  assign new_n74_ = x17 & x18 & ~x20 & ~x21;
  assign z15 = x15 | (~new_n76_ & x19);
  assign new_n76_ = (~x22 | (new_n69_ & ~x20 & ~x21)) & ~x07 & ~new_n73_ & (~new_n69_ | x20 | x21 | x22);
  assign z16 = x15 | (x19 & (new_n78_ | x07 | new_n79_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n78_ = x23 & (~new_n69_ | x20 | x21 | x22);
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x19 & (~new_n81_ | x07 | (~new_n79_ & x24)));
  assign new_n81_ = ~new_n73_ & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = (~x15 & (~x19 | (new_n51_ & ~x07 & x19))) | new_n83_ | x07 | new_n84_ | x15;
  assign new_n83_ = x25 & (~new_n70_ | x23 | x24 | x21 | x22);
  assign new_n84_ = new_n74_ & ~x24 & ~x25 & ~x22 & ~x23;
endmodule
