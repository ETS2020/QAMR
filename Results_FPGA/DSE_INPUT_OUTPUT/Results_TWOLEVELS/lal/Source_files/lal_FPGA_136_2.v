...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n55_, new_n57_, new_n58_,
    new_n63_, new_n64_, new_n69_, new_n71_, new_n73_, new_n75_, new_n76_,
  ...
  assign z08 = (~x15 & (new_n64_ | (~x18 & (new_n63_ | x25)))) | (x18 & (new_n64_ | x25));
  assign new_n63_ = ~x17 & ~x19 & x21 & x22 & x24;
  assign new_n64_ = x24 & (x23 | (x20 & x21 & x22));
  ...
  assign z13 = (x18 & (x15 | (~x17 & x20) | (x17 & x19 & ~x20))) | (~x15 & (~new_n71_ | (x20 & (~x18 | ~x19))));
  assign new_n71_ = ~x07 & (~x04 | ~x05 | x07);
  assign z14 = x15 | ~new_n73_ | (~new_n71_ & ~x15);
  assign new_n73_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~new_n77_ & ~x15) | (x18 & (~new_n75_ | x15));
  assign new_n75_ = (x17 | ~x22) & (~new_n76_ | ~x17 | ~x19);
  assign new_n76_ = ~x20 & ~x21 & ~x22;
  assign new_n77_ = new_n71_ & (~x22 | (~x20 & ~x21 & x18 & x19));
  ...
  assign z17 = (~new_n82_ & x24) | (~new_n71_ & ~x15) | (x18 & (new_n83_ | x15));
  assign new_n82_ = (~x18 | (x17 & ~x23)) & (x15 | (new_n76_ & x18 & x19));
  assign new_n83_ = new_n84_ & new_n85_ & ~x23 & ~x24;
  assign new_n84_ = x17 & x19 & ~x20;
  assign new_n85_ = ~x21 & ~x22;
  assign z18 = x15 | ~new_n87_ | (~new_n89_ & ~x15);
  assign new_n87_ = (~x25 | (new_n84_ & new_n85_ & ~x23 & ~x24)) & (~new_n88_ | ~new_n85_ | x23 | x24 | x25);
  assign new_n88_ = x17 & x18 & x19 & ~x20;
  assign new_n89_ = ~x07 & (~x04 | ~x05 | x07) & (x18 | ~x25);
endmodule
