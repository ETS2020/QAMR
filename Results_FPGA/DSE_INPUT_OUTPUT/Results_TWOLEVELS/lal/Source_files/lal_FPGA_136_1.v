...
module FAU ( 
  ...
  assign z10 = ~x07 & ~x15 & ~x17 & ~x18 & (~x04 | ~x05);
  assign z11 = ~x07 & ~x15 & x17 & ~x18 & (~x04 | ~x05);
  assign z12 = ~x07 & ~x15 & ~x18 & x19 & (~x04 | ~x05);
  assign z13 = x15 | (~x18 & (x07 | x20 | (x04 & x05 & ~x07 & ~x15)));
  assign z14 = (~x15 & (x18 | (x04 & x05 & ~x07 & ~x18))) | (x07 & ~x18) | x15 | x21;
  assign z15 = x15 | (~x18 & (x07 | x22 | (x04 & x05 & ~x07 & ~x15)));
  assign z16 = (~x15 & (x18 | (x04 & x05 & ~x07 & ~x18))) | (x07 & ~x18) | x15 | x23;
  assign z17 = x15 | (~x18 & (x07 | x24 | (x04 & x05 & ~x07 & ~x15)));
  assign z18 = (~x15 & (x18 | (x04 & x05 & ~x07 & ~x18))) | x15 | (~x18 & (x07 | x25));
endmodule
