...
module FAU ( 
  ...
  assign z13 = x07 | (~x15 & (new_n66_ | new_n76_ | (~new_n75_ & x20)));
  assign new_n75_ = x17 & x18 & x19;
  assign new_n76_ = x04 & x05 & ~x07;
  assign z14 = ~new_n78_ | (~new_n53_ & ~x07);
  assign new_n78_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | (~x15 & (new_n80_ | new_n76_ | new_n82_));
  assign new_n80_ = new_n75_ & new_n81_ & ~x20;
  assign new_n81_ = ~x21 & ~x22;
  assign new_n82_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x07 | (~x15 & (new_n84_ | new_n76_ | (~new_n80_ & x23)));
  assign new_n84_ = new_n75_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n53_ & ~x07) | new_n86_ | x07 | (~new_n84_ & x24);
  assign new_n86_ = x17 & new_n87_ & x18;
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n89_ | (~new_n53_ & ~x07);
