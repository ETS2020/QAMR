...
module FAU ( 
  ...
  assign z08 = new_n49_ | x25 | (x24 & (new_n62_ | x23));
  ...
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n68_ | new_n49_ | (x17 & x18 & x19 & ~x20);
  assign new_n68_ = ~x15 & (~x04 | ~x05 | x07);
  assign z14 = (~new_n70_ & x21) | ~new_n68_ | new_n49_ | new_n71_;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x07 & ((~new_n71_ & x22) | new_n53_ | new_n73_));
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n73_ & x23) | new_n75_ | new_n49_ | ~new_n68_;
  assign new_n75_ = new_n76_ & x17 & x18 & x19;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (new_n78_ | new_n53_ | (~new_n75_ & x24)));
  assign new_n78_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n78_ & x25) | ~new_n68_ | new_n80_ | new_n49_;
