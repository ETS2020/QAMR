...
module FAU ( 
  ...
  assign z01 = x07 | (~x15 & ((~new_n50_ & ~x25) | (x04 & x05 & ~x07)));
  ...
  assign z13 = x07 | (~x15 & (new_n74_ | new_n65_ | (x04 & x05 & ~x07)));
  assign new_n74_ = ~new_n75_ & x20;
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = (~new_n77_ & ~x07) | new_n78_ | x07 | (~new_n65_ & x21);
  assign new_n77_ = ~x15 & (~x04 | ~x05 | x15);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n80_ | (~new_n77_ & ~x07);
  assign new_n80_ = (new_n78_ | ~x22) & ~x07 & (~new_n75_ | x20 | x21 | x22);
  assign z16 = ~new_n82_ | (~new_n77_ & ~x07);
  assign new_n82_ = (~x23 | (new_n75_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n77_ & ~x07) | (x17 & new_n85_ & x18) | new_n84_ | x07;
  assign new_n84_ = x24 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n87_ | (~new_n77_ & ~x07);
  assign new_n87_ = (~x25 | (new_n65_ & new_n88_ & ~x23 & ~x24)) & ~x07 & (~new_n65_ | ~new_n88_ | x23 | x24 | x25);
