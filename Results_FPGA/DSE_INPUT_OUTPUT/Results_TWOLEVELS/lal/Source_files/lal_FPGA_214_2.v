...
module FAU ( 
  ...
  assign z11 = ~x15 & (x07 | (~new_n63_ & (x17 ^ x18)));
  assign z12 = ~x15 & (x07 | (~new_n63_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  ...
  assign z16 = x15 | (~x07 & (new_n76_ | new_n63_ | (~new_n73_ & x23)));
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n76_ & x24) | ~new_n68_ | new_n79_ | new_n48_;
  assign new_n79_ = new_n70_ & new_n74_ & ~x23 & ~x24;
