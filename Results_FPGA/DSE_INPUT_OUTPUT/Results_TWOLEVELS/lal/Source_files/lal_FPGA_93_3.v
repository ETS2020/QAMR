...
module FAU ( 
  ...
  assign z13 = x07 | (~new_n76_ & ~x07) | new_n64_ | (~new_n77_ & x20);
  assign new_n76_ = ~x15 & (~x04 | ~x05 | x15);
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = (~new_n76_ & ~x07) | (~new_n79_ & ~x15);
  assign new_n79_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | ~new_n81_ | (~new_n76_ & ~x07);
  assign new_n81_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = (~new_n76_ & ~x07) | (~new_n83_ & ~x15);
  ...
  assign z18 = x07 | ~new_n91_ | (~new_n76_ & ~x07);
