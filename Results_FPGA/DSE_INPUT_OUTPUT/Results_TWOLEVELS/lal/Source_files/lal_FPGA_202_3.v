...
module FAU ( 
  ...
  assign z13 = x07 | (~x07 & (new_n51_ | x15)) | new_n68_ | (~new_n67_ & x20);
  ...
  assign z15 = (~x07 & (new_n51_ | x15)) | (~x15 & (new_n72_ | x07 | (~new_n70_ & x22)));
  assign new_n72_ = new_n67_ & new_n73_ & ~x20;
  assign new_n73_ = ~x21 & ~x22;
  assign z16 = (~new_n75_ & ~x15) | (~x07 & (new_n51_ | x15));
  assign new_n75_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = (~x07 & (new_n51_ | x15)) | (~x15 & (new_n77_ | new_n78_ | x07));
