...
module FAU ( 
  ...
  assign z08 = new_n61_ | new_n66_ | new_n67_ | (x15 & ~x25) | (~new_n63_ & x25);
  ...
  assign new_n67_ = x23 & (x25 | (~x15 & x24));
  ...
  assign new_n72_ = ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n74_ & x20) | x07 | new_n65_ | (new_n51_ & ~x07 & ~x15);
  assign new_n74_ = x17 & x18 & x19;
  assign z14 = x15 ? x25 : (~new_n76_ | x07 | (~new_n65_ & x21));
  assign new_n76_ = ~new_n77_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n77_ = x04 & x05 & ~x07;
  assign z15 = x15 ? x25 : (new_n80_ | x07 | new_n79_ | new_n77_);
  assign new_n79_ = new_n74_ & ~x20 & ~x21 & ~x22;
  assign new_n80_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 ? x25 : (~new_n82_ | x07 | (~new_n79_ & x23));
  assign new_n82_ = ~new_n77_ & (~new_n74_ | ~new_n83_);
  assign new_n83_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n85_ | (~new_n87_ & ~x15) | (x15 & x25);
  assign new_n85_ = x17 & x18 & x19 & new_n86_ & ~x20;
  assign new_n86_ = ~x21 & ~x22 & ~x23 & ~x24 & (x25 | (~x15 & ~x25));
  assign new_n87_ = (~x24 | (new_n74_ & new_n83_)) & ~new_n77_ & ~x07;
  assign z18 = x15 | new_n90_ | x07 | (~x15 & (new_n89_ | new_n77_));
  assign new_n89_ = new_n65_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n90_ = x25 & (~new_n65_ | x21 | x22 | x23 | x24);
endmodule
