...
module FAU ( 
  ...
  assign z15 = ~new_n73_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n73_ = (new_n71_ | ~x22) & ~x07 & (~new_n68_ | x20 | x21 | x22);
  assign z16 = ~new_n75_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n75_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n68_ | x22 | x23 | x20 | x21);
  assign z17 = x07 | (~x15 & (new_n77_ | new_n78_ | new_n51_));
  assign new_n77_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n78_ = new_n69_ & new_n79_ & ~x23 & ~x24;
  assign new_n79_ = ~x21 & ~x22;
  assign z18 = ~new_n81_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
