...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n54_, new_n55_, new_n60_, new_n61_, new_n62_,
    ...
    new_n74_, new_n76_, new_n77_, new_n79_, new_n81_, new_n83_, new_n84_,
  ...
  assign z08 = new_n66_ | (x05 & (new_n60_ | new_n68_ | new_n62_ | new_n69_));
  ...
  assign new_n74_ = x05 & (x04 | x07 | ((~x19 | (x17 & x18)) & (~x17 | ~x18 | x19)));
  assign z13 = (~new_n76_ & x20) | ~new_n77_ | x15 | new_n64_ | (~x05 & ~x15);
  assign new_n76_ = x17 & x18 & x19;
  assign new_n77_ = ~x07 & (~x04 | ~x05);
  assign z14 = (~new_n64_ & x21) | ~new_n77_ | x15 | new_n79_ | (~x05 & ~x15);
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n81_ | ~new_n77_ | (~new_n79_ & x22);
  assign new_n81_ = ~x15 & (x05 | x15) & (~new_n76_ | x20 | x21 | x22);
  assign z16 = x15 | (x05 & (new_n83_ | x07 | new_n84_ | (x04 & ~x07 & ~x15)));
  assign new_n83_ = x23 & (~new_n76_ | x20 | x21 | x22);
  assign new_n84_ = new_n76_ & new_n85_;
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x05 & (~new_n87_ | (x17 & new_n88_ & x18)));
  assign new_n87_ = (~x24 | (new_n76_ & new_n85_)) & ~x07 & (~x04 | x07 | x15);
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (x05 & (new_n90_ | x07 | new_n91_ | (x04 & ~x07 & ~x15)));
  assign new_n90_ = x25 & (~new_n64_ | ~new_n65_);
  assign new_n91_ = new_n64_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
