...
module FAU ( 
  ...
  assign z12 = x07 ? x15 : (new_n74_ & ~x15);
  assign new_n74_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n76_ | (~x15 & ((~new_n77_ & x20) | new_n64_ | x07));
  assign new_n76_ = ~x07 & (x15 | (x04 & x05));
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = x07 | new_n76_ | new_n79_ | (~new_n64_ & x21);
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 | ~new_n81_ | new_n76_;
  assign new_n81_ = (new_n79_ | ~x22) & (~new_n77_ | x20 | x21 | x22);
  assign z16 = x07 | ~new_n83_ | new_n76_;
  assign new_n83_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | new_n76_ | new_n87_ | new_n88_ | (~new_n85_ & x24);
  assign new_n85_ = new_n77_ & new_n86_ & ~x20;
  assign new_n86_ = ~x21 & ~x22;
  assign new_n87_ = ~x15 & ((x23 & x24) | (new_n64_ & new_n86_ & ~x23 & ~x24 & x25));
  assign new_n88_ = new_n64_ & new_n86_ & ~x23 & ~x24 & ~x25;
  assign z18 = x07 | new_n76_ | new_n88_ | (~x15 & ~new_n90_ & x25);
