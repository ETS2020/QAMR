...
module FAU ( 
  ...
  assign z01 = (x04 & (x07 | (x05 & ~x07))) | new_n50_ | (~x04 & x07);
  ...
  assign z09 = x04 & (x07 | (x05 & ~x15));
  assign z10 = ~x07 & ~x15 & (~x04 | ~x05) & ~x17;
  assign z11 = ~x07 & ~x15 & (~x04 | ~x05) & (x17 ^ x18);
  assign z12 = x07 ? x04 : (~x15 & ~new_n72_ & (~x04 | ~x05));
  assign new_n72_ = (~x17 | ~x18 | x19) & (~x19 | (x17 & x18));
  assign z13 = (x04 & (x07 | (x05 & ~x07))) | new_n74_ | (~x04 & x07) | new_n65_ | (~x07 & x15);
  assign new_n74_ = ~new_n75_ & x20;
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = x07 ? ~x04 : ((~new_n65_ & x21) | ~new_n77_ | (x04 & x05));
  assign new_n77_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (x04 & (x07 | (x05 & ~x07))) | new_n80_ | (~x04 & x07) | new_n79_ | (~x07 & x15);
  assign new_n79_ = new_n75_ & ~x20 & ~x21 & ~x22;
  assign new_n80_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x07 ? ~x04 : ((~new_n79_ & x23) | ~new_n82_ | (x04 & x05));
  assign new_n82_ = ~x15 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z17 = (x04 & (x07 | (x05 & ~x07))) | new_n84_ | new_n86_ | (~x04 & x07) | (~x07 & x15);
  assign new_n84_ = x17 & new_n85_ & x18;
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n86_ = x24 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z18 = (x04 & (x07 | (x05 & ~x07))) | new_n88_ | (~x04 & x07) | new_n89_ | (~x07 & x15);
