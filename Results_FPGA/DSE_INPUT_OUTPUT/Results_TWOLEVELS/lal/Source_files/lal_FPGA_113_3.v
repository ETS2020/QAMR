...
module FAU ( 
  ...
  assign z15 = (~x07 & (new_n51_ | x15)) | (~x15 & (new_n80_ | x07 | (~new_n78_ & x22)));
  ...
  assign z17 = new_n84_ | (~x07 & (new_n51_ | x15)) | (~x15 & (new_n86_ | x07));
  assign new_n84_ = x17 & x18 & x19 & ~x20 & new_n85_ & ~x21;
  assign new_n85_ = ~x22 & ~x23 & ~x24 & (x25 ? ~x07 : ~x15);
  assign new_n86_ = x24 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z18 = (~x15 & (new_n88_ | x07)) | (~x07 & (new_n89_ | new_n51_ | x15));
