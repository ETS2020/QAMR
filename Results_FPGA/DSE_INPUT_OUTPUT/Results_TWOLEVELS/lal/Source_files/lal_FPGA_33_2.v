...
module FAU ( 
  ...
  assign z14 = ~new_n71_ | (~new_n67_ & ~x15);
  assign new_n71_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x07 & (new_n75_ | new_n73_ | new_n76_));
  ...
  assign z16 = ~new_n78_ | (~new_n67_ & ~x15);
  assign new_n78_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n67_ & ~x15) | new_n80_ | new_n81_ | x15;
  assign new_n80_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n81_ = new_n69_ & new_n74_ & ~x23 & ~x24;
  assign z18 = x15 | (~new_n83_ & ~x07);
