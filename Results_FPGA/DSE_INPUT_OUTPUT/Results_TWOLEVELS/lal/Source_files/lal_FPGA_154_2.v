...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n62_,
    new_n64_, new_n69_, new_n71_, new_n72_, new_n74_, new_n76_, new_n77_,
    new_n79_, new_n81_;
  ...
  assign z08 = (x20 & (new_n61_ | x25)) | (~new_n62_ & x24) | new_n48_ | (~x20 & x25);
  assign new_n61_ = x21 & x22 & x24;
  assign new_n62_ = ~x23 & (x17 | x18 | x19 | ~x21 | ~x22);
  assign z09 = ~x15 & (new_n64_ | x07);
  assign new_n64_ = x04 & x05;
  assign z10 = ~x15 & (x07 | (~new_n64_ & ~x17));
  assign z11 = ~x07 & ~x15 & ~new_n64_ & (x17 ^ x18);
  assign z12 = ~x15 & (x07 | (~new_n64_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n69_ | new_n48_ | (x19 & ~x20 & x17 & x18);
  assign new_n69_ = ~x15 & (~x04 | ~x05 | x07);
  assign z14 = (~new_n71_ & x21) | ~new_n69_ | new_n48_ | new_n72_;
  assign new_n71_ = x19 & ~x20 & x17 & x18;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x07 & ((~new_n72_ & x22) | new_n64_ | new_n74_));
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | ~new_n69_ | new_n76_ | new_n48_;
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (new_n79_ | new_n64_ | (~new_n76_ & x24)));
  assign new_n79_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n79_ & x25) | ~new_n69_ | new_n81_ | new_n48_;
