...
module FAU ( 
  ...
  assign z13 = z09 | (~new_n78_ & ~x20) | ~new_n76_ | (~x17 & (new_n79_ | x20));
  assign new_n76_ = (new_n77_ | ~x15) & (~x20 | (x18 & x19));
  assign new_n77_ = (x25 | (x24 & (x23 | (x21 & x22)))) & ~x25 & (~x24 | (~x23 & (~x20 | ~x21 | ~x22)));
  assign new_n78_ = (~x17 | ((~x18 | ~x19) & (~x15 | x23 | x25))) & (~x15 | x23 | x25 | (~x18 & ~x19));
  assign new_n79_ = x21 & x22 & x24 & x15 & ~x18 & ~x19;
  assign z14 = ~new_n81_ | (x17 & ~x20 & (new_n84_ | new_n85_));
  assign new_n81_ = ~new_n82_ & (x07 | (~new_n83_ & (new_n64_ | ~x21)));
  assign new_n82_ = x15 & ((~x25 & (~x24 | (~x21 & ~x23))) | x07 | x25 | (x23 & x24));
  assign new_n83_ = x04 & x05 & ~x15;
  assign new_n84_ = x15 & ~x23 & ~x25;
  assign new_n85_ = x19 & ~x21 & ~x07 & x18;
  assign z15 = (~new_n87_ & ~x21) | new_n89_ | (~x07 & (new_n83_ | new_n90_));
  ...
  assign new_n94_ = (x17 | (~new_n79_ & ~x23)) & ~new_n95_ & ~new_n96_ & (new_n93_ | ~x23);
  assign new_n95_ = x20 & (x23 | (x22 & x24 & x15 & x21));
  assign new_n96_ = x15 & ((x23 & x24) | x25 | (~x24 & ~x25));
  assign new_n97_ = x15 & ~x25 & (~x21 | ~x22);
  assign z17 = x07 | new_n99_ | ~new_n102_ | (~x07 & (new_n83_ | (x23 & x24)));
  assign new_n99_ = ~x21 & ~x23 & (new_n100_ | (x17 & new_n101_ & x18));
  assign new_n100_ = x15 & ~x25;
  assign new_n101_ = x19 & ~x20 & ~x22 & ~x24 & (~x25 | (~x07 & x25));
  assign new_n102_ = (new_n103_ | ~x24) & (~x15 | (~x25 & (x24 | x25)));
  assign new_n103_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z18 = z09 | (~x25 & (new_n105_ | new_n114_)) | new_n109_ | ~new_n110_;
  ...
  assign new_n109_ = ~x17 & (new_n79_ | (~x07 & x25));
  assign new_n110_ = (~x20 | (~new_n111_ & (x07 | ~x25))) & ~new_n112_ & (x07 | new_n113_ | ~x25);
  assign new_n111_ = x15 & x21 & x22 & x24;
