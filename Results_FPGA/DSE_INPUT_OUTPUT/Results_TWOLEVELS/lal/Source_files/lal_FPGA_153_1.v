...
module FAU ( 
  ...
  assign new_n67_ = (~x20 | (x17 & x18 & x19)) & ~x07 & ~new_n68_ & (~x19 | x20 | ~x17 | ~x18);
  assign new_n68_ = x04 & x05 & ~x07;
  assign z14 = x15 | (~new_n70_ & x21) | x07 | new_n71_ | (new_n51_ & ~x07 & ~x15);
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~new_n71_ & x22) | x07 | new_n73_ | (new_n51_ & ~x07 & ~x15);
  ...
  assign z17 = x15 ? x03 : (~new_n78_ | x07 | (~new_n75_ & x24));
  assign new_n78_ = ~new_n68_ & (~new_n70_ | x21 | x22 | x23 | x24);
  assign z18 = x15 ? x03 : (~new_n81_ | x07 | (~new_n80_ & x25));
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n81_ = ~new_n68_ & (~new_n70_ | ~new_n82_);
