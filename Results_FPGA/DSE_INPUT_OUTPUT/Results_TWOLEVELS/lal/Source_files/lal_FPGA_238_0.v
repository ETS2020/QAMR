...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n61_, new_n64_,
    new_n67_, new_n69_, new_n71_, new_n72_, new_n74_, new_n75_, new_n77_,
    new_n78_;
  assign z00 = ~z02 & x08;
  assign z02 = x16 | (~x15 & ~x23);
  assign z01 = new_n50_ | (~new_n51_ & (x15 | x23)) | (x15 & ~x23 & ~new_n52_ & ~x25);
  assign new_n50_ = x04 & x05 & (x15 | (~x07 & ~x15 & x23));
  assign new_n51_ = ~x07 & (x24 | x25);
  assign new_n52_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign z03 = (~x15 & ~x23) | (~x25 & ((~x24 & (x15 | x23)) | (x15 & ~new_n52_ & ~x23)));
  ...
  assign z08 = ((new_n61_ | x23) & x24) | x25 | (~x15 & ~x23);
  ...
  assign z13 = z09 | (x17 & x18 & x19 & ~x20) | ~new_n69_ | (x20 & (~x17 | ~x18 | ~x19));
  assign new_n69_ = ~x15 & (~x07 | ~x23);
  assign z14 = z09 | new_n71_ | ~new_n69_ | new_n72_;
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign new_n72_ = x21 & (~x17 | ~x18 | ~x19 | x20);
  assign z15 = (~x15 & (~x23 | (new_n64_ & ~x07 & x23))) | new_n74_ | x15 | new_n75_ | (x07 & x23);
  assign new_n74_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~x15 & ((~new_n77_ & ~x07) | ~x23)) | new_n78_ | x15 | x20 | (x07 & x23);
  assign new_n77_ = ((x04 & x05) | (x17 ? (x18 & (~x18 | x19)) : ~x23)) & (~x04 | ~x05 | ~x23);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & (x21 | (~x21 & x22));
  assign z17 = z09 | x15 | (x23 & (x07 | x24));
