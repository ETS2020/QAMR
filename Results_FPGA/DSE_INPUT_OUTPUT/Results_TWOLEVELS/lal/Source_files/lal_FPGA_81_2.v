...
module FAU ( 
  ...
  assign z04 = (x09 & ((~x00 & ~x08) | ~x11)) | (~x08 & (~new_n57_ | ~new_n56_ | (x00 & ~x09)));
  ...
  assign z13 = ~new_n48_ & ((~new_n75_ & x20) | ~new_n76_ | new_n66_ | (new_n52_ & new_n76_));
  assign new_n75_ = x17 & x18 & x19;
  assign new_n76_ = ~x07 & ~x15;
  assign z14 = ~new_n48_ & ((~new_n66_ & x21) | ~new_n76_ | new_n78_ | (new_n52_ & new_n76_));
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n80_ | new_n81_ | new_n48_ | (~new_n78_ & x22);
  assign new_n80_ = ~new_n48_ & (x07 | x15 | (new_n52_ & ~x07 & ~x15));
  assign new_n81_ = new_n75_ & new_n82_ & ~x20;
  assign new_n82_ = ~x21 & ~x22;
  assign z16 = ~new_n48_ & ((~new_n81_ & x23) | ~new_n76_ | new_n84_ | (new_n52_ & new_n76_));
  assign new_n84_ = new_n75_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n80_ | new_n86_ | new_n48_ | (~new_n84_ & x24);
  assign new_n86_ = x17 & x18 & new_n87_ & x19;
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n80_ | ~new_n89_;
  assign new_n89_ = (~x25 | (new_n66_ & new_n82_ & ~x23 & ~x24)) & ~new_n48_ & (~new_n66_ | ~new_n82_ | x23 | x24 | x25);
endmodule
