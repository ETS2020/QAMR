...
module FAU ( 
  ...
  assign z08 = new_n67_ | (x11 & (new_n61_ | new_n69_ | new_n63_ | new_n70_));
  ...
  assign z10 = ~x15 & (~x11 | (~x07 & ~new_n51_ & ~x17));
  assign z11 = ~x15 & (~x11 | (~x07 & ~new_n51_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n75_ & x11;
  assign new_n75_ = ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n77_ & ~x15) | (~new_n78_ & x20) | x07 | new_n65_ | x15;
  assign new_n77_ = x11 & (~new_n51_ | x07 | ~x11);
  assign new_n78_ = x17 & x18 & x19;
  assign z14 = x15 | (x11 & ((~new_n65_ & x21) | ~new_n80_ | x07));
  assign new_n80_ = ~new_n81_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n81_ = x04 & x05 & ~x07 & ~x15;
  assign z15 = (~new_n77_ & ~x15) | new_n84_ | x07 | new_n83_ | x15;
  assign new_n83_ = new_n78_ & ~x20 & ~x21 & ~x22;
  assign new_n84_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (x11 & (~new_n86_ | x07 | (~new_n83_ & x23)));
  assign new_n86_ = ~new_n81_ & (~new_n78_ | ~new_n87_);
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x11 & (~new_n89_ | (x17 & new_n90_ & x18)));
  assign new_n89_ = ~new_n81_ & ~x07 & (~x24 | (new_n78_ & new_n87_));
  assign new_n90_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (x11 & (~new_n93_ | x07 | (~new_n92_ & x25)));
