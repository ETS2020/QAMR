...
module FAU ( 
  ...
  assign z14 = (~new_n68_ & x21) | ~new_n70_ | new_n71_ | (x07 & ~x15);
  assign new_n70_ = ~x15 & (~x04 | ~x05 | x07);
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n71_ & x22) | ~new_n70_ | new_n73_ | (x07 & ~x15);
  assign new_n73_ = new_n67_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n73_ & x23) | ~new_n70_ | new_n75_ | (x07 & ~x15);
  assign new_n75_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (new_n77_ | new_n51_ | (~new_n75_ & x24)));
  assign new_n77_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n77_ & x25) | ~new_n70_ | new_n79_ | (x07 & ~x15);
