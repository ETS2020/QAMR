...
module FAU ( 
  ...
  assign z09 = ~x15 & (x10 | (~x07 & ~x10 & x04 & x05));
  ...
  assign new_n89_ = x19 & ~x21 & ~x22 & ~x10 & x18;
  assign new_n90_ = (~x20 | (~new_n93_ & (x10 | ~x23))) & ~new_n94_ & (new_n91_ | x10);
  ...
  assign new_n102_ = ~x21 & ~x22 & ~x24 & ~x10 & x18 & x19;
  ...
  assign new_n106_ = (~x20 | (~new_n93_ & (x10 | ~x25))) & ~new_n108_ & (new_n107_ | x10);
