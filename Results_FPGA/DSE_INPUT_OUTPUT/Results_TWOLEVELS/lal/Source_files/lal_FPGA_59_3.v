...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n53_, new_n55_, new_n56_, new_n61_, new_n65_,
  ...
  assign z01 = (x04 & x05 & (~x11 | (~x07 & ~x15))) | ((~x11 | ~x15) & (new_n50_ | x07));
  assign new_n50_ = ~x25 & (~x24 | (~x23 & (new_n51_ | ~x21 | ~x22)));
  assign new_n51_ = ~x20 & (x17 | x18 | x19);
  assign z03 = (x11 & x15) | (~x25 & (~x11 | ~x15) & (~x24 | (~new_n53_ & ~x23)));
  ...
  assign z15 = x15 | ~new_n76_ | (~x15 & (new_n71_ | x07));
  assign new_n76_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = x15 ? ~x11 : (~new_n79_ | x07 | (~new_n78_ & x23));
  assign new_n78_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign new_n79_ = ~new_n71_ & (~new_n70_ | x22 | x23 | x20 | x21);
  assign z17 = x15 | (~x15 & (new_n71_ | x07)) | new_n81_ | new_n82_;
