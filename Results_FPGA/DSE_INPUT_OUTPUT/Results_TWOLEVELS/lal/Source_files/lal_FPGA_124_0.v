...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n62_;
  assign z00 = (x08 & ~x16) | (~x07 & ~x15);
  assign z01 = z03 | (~new_n51_ & x07) | (x04 & x05 & x15);
  assign z03 = ~x25 & (x07 | x15) & (~x24 | (~new_n50_ & ~x23));
  assign new_n50_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign new_n51_ = ~x25 & (~x24 | (~x23 & (~x21 | new_n52_ | ~x22)));
  ...
  assign z08 = ~new_n51_ & (x07 | x15);
  assign z13 = ~new_n62_ & (x07 | x15);
  assign new_n62_ = (~x24 | (~x23 & (~x21 | new_n52_ | ~x22))) & ~x25 & (x25 | (x24 & (x23 | (~new_n52_ & x21 & x22))));
  assign z14 = (~x07 & ~x15) | (~new_n62_ & (x07 | x15));
  assign z09 = 1'b0;
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z12 = 1'b0;
  assign z15 = (~x07 & ~x15) | (~new_n62_ & (x07 | x15));
  assign z16 = ~new_n62_ & (x07 | x15);
  assign z17 = ~new_n62_ & (x07 | x15);
  assign z18 = ~new_n62_ & (x07 | x15);
endmodule
