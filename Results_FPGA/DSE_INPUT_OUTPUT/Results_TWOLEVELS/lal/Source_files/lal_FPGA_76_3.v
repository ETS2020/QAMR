...
module FAU ( 
  ...
  assign z08 = new_n59_ | new_n65_ | (~x15 & ~new_n66_ & x24) | (new_n61_ & ~x24);
  assign new_n59_ = ~x17 & ((new_n60_ & x21 & x22 & x24) | (~x24 & x25));
  ...
  assign new_n65_ = x20 & ((~x24 & x25) | (~x15 & x21 & x22 & x24));
  ...
  assign new_n73_ = (new_n63_ | ~x20) & ~x07 & ~new_n74_ & (~x04 | ~x05 | x07);
  assign new_n74_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | ~new_n77_ | (~new_n76_ & ~x15);
  assign new_n76_ = ~x07 & (~x04 | ~x05 | x07);
  assign new_n77_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x19 | x20 | x21 | ~x17 | ~x18);
  assign z15 = x15 | ~new_n79_ | (~new_n76_ & ~x15);
  assign new_n79_ = (~x22 | (x19 & ~x20 & ~x21 & x17 & x18)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = x15 | ~new_n81_ | (~new_n76_ & ~x15);
  assign new_n81_ = (~new_n63_ | x22 | x23 | x20 | x21) & (~x23 | (new_n63_ & ~x20 & ~x21 & ~x22));
  assign z17 = (~x24 & (x15 | (new_n84_ & x17))) | (~x15 & (~new_n76_ | (~new_n83_ & x24)));
  assign new_n83_ = new_n63_ & new_n64_ & ~x22 & ~x23;
  assign new_n84_ = x18 & x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z18 = x15 | (~new_n87_ & ~x15) | (~x24 & (new_n86_ | (~new_n83_ & x25)));
  assign new_n86_ = new_n74_ & new_n66_ & ~x21 & ~x22;
  assign new_n87_ = ~x07 & (~x24 | ~x25) & (~x04 | ~x05 | x07);
endmodule
