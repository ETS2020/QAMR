...
module FAU ( 
  ...
  assign new_n65_ = ~x15 & ((x04 & x05) | ((~x19 | (x17 & (x15 | x18))) & (~x17 | ~x18 | x19)));
  ...
  assign z15 = x07 | (~x15 & (new_n73_ | new_n68_ | (~new_n71_ & x22)));
  assign new_n73_ = new_n67_ & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign z16 = ~new_n76_ | z09;
  assign new_n76_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | (~x15 & (new_n78_ | new_n79_ | new_n68_));
  assign new_n78_ = x24 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & new_n74_ & ~x23 & ~x24;
  assign z18 = x07 | (~new_n81_ & ~x15);
  assign new_n81_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~new_n68_ & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
