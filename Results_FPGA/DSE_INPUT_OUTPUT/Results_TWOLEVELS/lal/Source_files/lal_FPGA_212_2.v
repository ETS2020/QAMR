...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n60_, new_n61_,
    ...
    new_n69_, new_n75_, new_n77_, new_n79_, new_n81_, new_n82_, new_n84_,
  ...
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n75_ | (new_n51_ & new_n75_) | (x17 & x18 & x19 & ~x20);
  assign new_n75_ = ~x07 & ~x15;
  assign z14 = (~new_n64_ & x21) | ~new_n75_ | new_n77_ | (new_n51_ & new_n75_);
  assign new_n77_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n77_ & x22) | ~new_n75_ | new_n79_ | (new_n51_ & new_n75_);
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n79_ & x23) | ~new_n75_ | new_n81_ | (new_n51_ & new_n75_);
  assign new_n81_ = new_n82_ & x17 & x18 & x19;
  assign new_n82_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = ~new_n84_ | (x17 & x18 & x19 & new_n86_ & ~x20);
  assign new_n84_ = (x15 | (~new_n85_ & (~x23 | ~x24))) & ~x07 & ~x15 & (new_n79_ | ~x24);
  assign new_n85_ = x04 & x05 & ~x07;
  assign new_n86_ = ~x21 & ~x22 & ~x23 & ~x24 & (~x25 | (~x15 & x25));
  assign z18 = x07 | new_n89_ | x15 | (~x15 & (new_n88_ | new_n85_));
