...
module FAU ( 
  ...
  assign z13 = z09 | (~new_n67_ & x20) | new_n68_ | x07;
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z14 = z09 | ~new_n70_;
  assign new_n70_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | ((new_n74_ | new_n72_ | new_n75_) & ~x15);
  ...
  assign new_n77_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | (~x15 & (new_n79_ | new_n80_ | new_n75_));
  assign new_n79_ = x24 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n68_ & new_n73_ & ~x23 & ~x24;
  assign z18 = x07 | (~new_n82_ & ~x15);
  assign new_n82_ = (~x25 | (new_n68_ & new_n73_ & ~x23 & ~x24)) & ~new_n75_ & (~new_n68_ | ~new_n73_ | x23 | x24 | x25);
endmodule
