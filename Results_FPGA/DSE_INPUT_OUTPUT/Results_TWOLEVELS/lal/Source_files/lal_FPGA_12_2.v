...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n54_, new_n55_, new_n60_, new_n61_, new_n62_,
    ...
    new_n74_, new_n76_, new_n77_, new_n79_, new_n81_, new_n82_, new_n84_,
  ...
  assign z13 = new_n76_ | (~new_n77_ & x20) | new_n64_ | x15;
  assign new_n76_ = ~x15 & (x07 | (x04 & x05 & ~x07));
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = new_n76_ | ~new_n79_;
  assign new_n79_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x07 & (new_n82_ | new_n81_ | (x04 & x05 & ~x15)));
  assign new_n81_ = new_n77_ & ~x20 & ~x21 & ~x22;
  assign new_n82_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = ~new_n84_ | new_n76_;
  assign new_n84_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = new_n76_ | (~new_n86_ & ~x07) | ~new_n87_ | (~new_n81_ & x24);
  assign new_n86_ = (~x23 | ~x24) & (~new_n64_ | x21 | x22 | x23 | x24 | ~x25);
  assign new_n87_ = ~x15 & (~new_n64_ | ~new_n88_);
  assign new_n88_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z18 = new_n76_ | ~new_n87_ | (~x07 & (~new_n64_ | ~new_n65_) & x25);
endmodule
