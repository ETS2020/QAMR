...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n60_, new_n61_,
    new_n62_, new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_,
    new_n69_, new_n74_, new_n76_, new_n78_, new_n79_, new_n81_, new_n82_,
    new_n83_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_;
  ...
  assign new_n66_ = ~x16 & (x25 | (x24 & (new_n67_ | x23)));
  ...
  assign z12 = (x15 & x16) | (~x07 & new_n74_ & ~x15);
  assign new_n74_ = ~new_n51_ & (((~x17 | ~x18) & x19) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n76_ & x20) | x07 | new_n64_ | (new_n51_ & ~x07 & ~x15);
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = x15 ? ~x16 : (~new_n78_ | x07 | (~new_n64_ & x21));
  assign new_n78_ = ~new_n79_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n79_ = x04 & x05 & ~x07;
  assign z15 = x15 ? ~x16 : (new_n83_ | x07 | new_n81_ | new_n79_);
  assign new_n81_ = new_n76_ & new_n82_ & ~x20;
  assign new_n82_ = ~x21 & ~x22;
  assign new_n83_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 ? ~x16 : (~new_n85_ | x07 | (~new_n81_ & x23));
  assign new_n85_ = ~new_n79_ & (~new_n76_ | ~new_n86_);
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 ? ~x16 : (~new_n88_ | (x17 & new_n89_ & x18));
  assign new_n88_ = (~x24 | (new_n76_ & new_n86_)) & ~new_n79_ & ~x07;
  assign new_n89_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | x07 | (~new_n91_ & ~x15);
  assign new_n91_ = (~x25 | (new_n64_ & new_n82_ & ~x23 & ~x24)) & ~new_n79_ & (~new_n64_ | ~new_n82_ | x23 | x24 | x25);
  assign z02 = x16;
endmodule
