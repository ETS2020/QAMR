...
module FAU ( 
  ...
  assign z08 = (~x15 & (new_n60_ | new_n62_ | new_n67_)) | (~new_n66_ & x23);
  ...
  assign z13 = x15 | (~new_n74_ & ~x15) | new_n64_ | (~new_n75_ & x20);
  ...
  assign z15 = x15 ? x23 : (new_n80_ | x07 | new_n79_ | new_n81_);
  ...
  assign z17 = (~new_n85_ & ~x15) | (x23 & (x15 | x24));
  assign new_n85_ = (~x17 | ~new_n86_ | ~x18) & new_n74_ & (new_n81_ | ~x24);
  assign new_n86_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x23 & (x15 | x25)) | (~x15 & (~new_n89_ | x07 | (~new_n88_ & x25)));
  assign new_n88_ = new_n75_ & ~x22 & ~x24 & ~x20 & ~x21;
  assign new_n89_ = ~new_n79_ & (~new_n64_ | x21 | x22 | ~new_n66_ | x23);
endmodule
