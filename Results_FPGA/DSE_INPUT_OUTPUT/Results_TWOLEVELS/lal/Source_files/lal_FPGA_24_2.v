// Benchmark "FAU" written by ABC on Mon Aug 24 18:24:38 2020
...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n53_, new_n57_, new_n58_,
    ...
    new_n70_, new_n75_, new_n77_, new_n78_, new_n80_, new_n82_, new_n83_,
  ...
  assign new_n63_ = ~x17 & ((new_n64_ & ~x11 & ~x18 & ~x19) | (x18 & x25));
  assign new_n64_ = x21 & x22 & x24;
  assign new_n65_ = x24 & ((x18 & x25) | (~new_n66_ & (~x11 | x18)));
  assign new_n66_ = ~x23 & (~x20 | ~x21 | ~x22);
  assign new_n67_ = new_n68_ & ~x22 & ~x23 & (~new_n69_ | ~new_n70_);
  ...
  assign z11 = (x11 & ~x18) | (~x07 & ~x15 & ~new_n52_ & (x17 ^ x18));
  assign z12 = new_n48_ | (new_n75_ & ~x07);
  assign new_n75_ = ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n77_ | ~new_n78_;
  assign new_n77_ = ~new_n48_ & (x07 | (new_n52_ & ~x07 & ~x15));
  assign new_n78_ = (x18 | (~x11 & ~x20)) & (~x20 | (x17 & x19)) & ~x15 & (~x19 | x20 | ~x17 | ~x18);
  assign z14 = new_n77_ | ~new_n80_ | (~x18 & (x11 | x21));
  assign new_n80_ = (~x21 | (x17 & x19 & ~x20)) & ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n77_ | ~new_n82_ | (~x18 & (x11 | x22));
  assign new_n82_ = (new_n83_ | ~x22) & ~x15 & (~new_n84_ | x20 | x21 | x22);
  assign new_n83_ = ~x20 & ~x21 & x17 & x19;
  assign new_n84_ = x17 & x18 & x19;
  assign z16 = new_n77_ | (~x18 & (x11 | x23)) | ~new_n86_ | (~new_n87_ & x23);
  assign new_n86_ = ~x15 & (~new_n84_ | x20 | x21 | x22 | x23);
  assign new_n87_ = x17 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = new_n77_ | new_n89_ | ~new_n91_;
  assign new_n89_ = x18 & ((x17 & new_n90_ & x19) | (x23 & x24));
  assign new_n90_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n91_ = (x18 | (~x11 & ~x24)) & ~x15 & (new_n87_ | ~x24);
  assign z18 = new_n77_ | (~x18 & (x11 | (~x11 & x25))) | x15 | (~new_n93_ & x18);
  assign new_n93_ = (~new_n83_ | ~new_n94_) & (~x25 | (new_n69_ & new_n70_));
