...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n54_, new_n55_, new_n60_, new_n61_, new_n62_,
    ...
    new_n71_, new_n76_, new_n78_, new_n80_, new_n82_, new_n84_, new_n85_,
    new_n86_, new_n88_;
  assign z00 = (x08 & ~x16) | (x07 & x15);
  assign z01 = x07 | new_n49_ | (x04 & x05 & ~x07);
  ...
  assign z12 = x07 ? x15 : (~x15 & ~new_n71_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19)));
  assign z13 = (~x07 & (new_n71_ | x15)) | (~x15 & ((~new_n76_ & x20) | new_n64_ | x07));
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = x07 | (~x07 & (new_n71_ | x15)) | new_n78_ | (~new_n64_ & x21);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n80_ & ~x15) | (~x07 & (new_n71_ | x15));
  assign new_n80_ = (new_n78_ | ~x22) & ~x07 & (~new_n76_ | x20 | x21 | x22);
  assign z16 = x07 | ~new_n82_ | (~x07 & (new_n71_ | x15));
  assign new_n82_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = (~x07 & (new_n71_ | x15)) | (~x15 & (new_n84_ | new_n86_ | x07));
  assign new_n84_ = x17 & new_n85_ & x18;
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n86_ = x24 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z18 = x07 | (~new_n88_ & ~x15) | (~x07 & (new_n71_ | x15));
