...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n62_,
    ...
    new_n74_, new_n76_, new_n77_, new_n78_, new_n80_, new_n81_, new_n84_,
  ...
  assign z10 = ~x15 & (x22 | (~x07 & ~new_n70_ & ~x17));
  assign z11 = ~x15 & (x22 | (~x07 & ~new_n70_ & (x17 ^ x18)));
  assign z12 = ~x07 & new_n74_ & ~x15;
  assign new_n74_ = ~x22 & ~new_n70_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = ~new_n76_ | (~x15 & (x22 | (new_n70_ & ~x07 & ~x22)));
  assign new_n76_ = (new_n77_ | ~x20) & ~x15 & ~new_n78_ & (~x07 | x22);
  assign new_n77_ = x17 & x18 & x19;
  assign new_n78_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~x15 & (x22 | (new_n70_ & ~x07 & ~x22))) | new_n80_ | x15 | new_n81_ | (x07 & ~x22);
  assign new_n80_ = ~new_n78_ & x21;
  assign new_n81_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~x15 & (x22 | (new_n70_ & ~x07 & ~x22))) | (x07 & ~x22) | new_n81_ | x15;
  assign z16 = x15 | (~x22 & (new_n84_ | x07 | new_n85_ | (new_n70_ & ~x07 & ~x15)));
  assign new_n84_ = ~new_n81_ & x23;
  assign new_n85_ = ~x20 & ~x21 & ~x23 & x17 & x18 & x19;
  assign z17 = x15 | (~x22 & (~new_n87_ | (new_n88_ & x17)));
  assign new_n87_ = (new_n85_ | ~x24) & ~x07 & (~new_n70_ | x07 | x15);
  assign new_n88_ = x18 & x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign z18 = x15 | (~x22 & (~new_n90_ | (x25 & (~new_n77_ | ~new_n65_))));
  assign new_n90_ = ~x07 & (~new_n78_ | ~new_n91_) & (~new_n70_ | x07 | x15);
  assign new_n91_ = ~x21 & ~x23 & ~x24 & ~x25;
endmodule
