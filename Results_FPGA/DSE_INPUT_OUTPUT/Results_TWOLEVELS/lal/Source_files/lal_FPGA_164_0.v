...
module FAU ( 
  ...
  assign new_n51_ = ~x25 & ~z12 & (~x24 | (~new_n52_ & ~x23));
  ...
  assign z10 = 1'b0;
  assign z11 = 1'b0;
  assign z14 = ~new_n64_ & ~z12;
  assign z16 = z12 | (~new_n64_ & ~z12);
  assign z17 = z12 | (~new_n64_ & ~z12);
  assign z18 = ~new_n64_ & ~z12;
endmodule
