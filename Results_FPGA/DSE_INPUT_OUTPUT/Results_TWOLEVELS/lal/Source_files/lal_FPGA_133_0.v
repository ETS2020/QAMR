...
module FAU ( 
  ...
  assign z08 = (~new_n67_ & x15) | (x14 & (~new_n61_ | (~new_n66_ & ~x17)));
  ...
  assign z09 = ~x15 & (~x14 | (new_n53_ & ~x07 & x14));
  assign z10 = ~x15 & (~x14 | (~x07 & ~new_n53_ & ~x17));
  assign z11 = ~x07 & x14 & ~x15 & ~new_n53_ & (x17 ^ x18);
  ...
  assign new_n83_ = x17 & (new_n76_ | (x19 & ~x21 & x14 & x18));
  assign new_n84_ = (new_n64_ | ~x14) & (~x15 | ~x22 | new_n52_ | ~x24);
  assign new_n85_ = (new_n86_ | ~x15) & (new_n81_ | ~x14);
  assign new_n86_ = (x25 | (x24 & (x23 | (x21 & x22)))) & ~x25 & (~x23 | ~x24);
  assign z15 = z09 | (~new_n88_ & ~x21) | new_n89_ | new_n90_ | x07;
  assign new_n88_ = ~new_n76_ & (~x17 | ~x18 | ~x19 | x20 | x22);
  assign new_n89_ = x15 & (x25 | (x23 & x24) | (~x25 & (~x24 | (~x22 & ~x23))));
  assign new_n90_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = (~new_n92_ & ~x23) | ~new_n95_ | (~x17 & (new_n78_ | (x14 & x23)));
  assign new_n92_ = (new_n93_ | x20) & (~x15 | x25 | (x21 & x22));
  assign new_n93_ = (~x17 | (~new_n94_ & (~x15 | x25))) & (~x15 | (~x18 & ~x19) | x25);
  assign new_n94_ = x14 & x18 & x19 & ~x21 & ~x22;
  assign new_n95_ = ~new_n96_ & ~new_n98_ & (~x15 | ((~x23 | ~x24) & ~x25 & (x24 | x25)));
  assign new_n96_ = x20 & (new_n97_ | (x14 & x23));
  assign new_n97_ = x15 & x21 & x22 & x24;
  assign new_n98_ = x14 & (~new_n81_ | (x23 & (~new_n75_ | x21 | x22)));
  assign z17 = z09 | (~new_n102_ & x14) | ~new_n100_ | (~new_n103_ & ~x25);
  assign new_n100_ = (~x15 | (~x25 & (~x23 | ~x24))) & ~x07 & (new_n101_ | ~x24);
  assign new_n101_ = new_n75_ & x17 & ~x20 & ~x21 & ~x22;
  assign new_n102_ = (~x23 | ~x24) & (~new_n64_ | x21 | x22 | x23 | x24 | ~x25);
  assign new_n103_ = (~new_n64_ | x21 | x22 | x23 | x24) & (~x15 | (x24 & (x21 | x23)));
  assign z18 = z09 | ~new_n108_ | (~new_n105_ & ~x25);
  assign new_n105_ = (~x15 | x24) & (x23 | (~new_n106_ & (~x15 | (x21 & x22))));
  assign new_n106_ = ~x20 & ((x17 & (x15 | (new_n107_ & x18 & x19))) | (x15 & (x18 | x19)));
  assign new_n107_ = ~x21 & ~x22 & ~x24;
  assign new_n108_ = (x17 | (~new_n78_ & ~new_n112_)) & new_n109_ & (~x20 | (~new_n97_ & ~new_n112_));
  assign new_n109_ = (~x15 | (~new_n110_ & ~x25)) & ~x07 & (~x14 | new_n111_ | ~x25);
  assign new_n110_ = x23 & x24;
  assign new_n111_ = x18 & x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n112_ = x14 & x25;
endmodule
