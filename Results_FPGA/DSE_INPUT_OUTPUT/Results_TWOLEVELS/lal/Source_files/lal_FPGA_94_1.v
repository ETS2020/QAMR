...
module FAU ( 
  ...
  assign z13 = x15 | (~x15 & (new_n75_ | x07)) | new_n63_ | (~new_n76_ & x20);
  assign new_n75_ = x04 & x05 & ~x07;
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = x15 | ~new_n78_ | (~x15 & (new_n75_ | x07));
  assign new_n78_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? x08 : (new_n81_ | x07 | new_n80_ | new_n75_);
  assign new_n80_ = new_n76_ & ~x20 & ~x21 & ~x22;
  assign new_n81_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | ~new_n83_ | (~x15 & (new_n75_ | x07));
  assign new_n83_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? x08 : (~new_n85_ | (x17 & new_n87_ & x18));
  assign new_n85_ = ~new_n75_ & ~x07 & (~x24 | (new_n76_ & new_n86_));
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x15 & (new_n89_ | x07 | new_n90_ | new_n75_));
