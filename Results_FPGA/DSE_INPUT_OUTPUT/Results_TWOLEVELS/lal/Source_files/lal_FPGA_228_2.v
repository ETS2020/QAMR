...
module FAU ( 
  ...
  assign z15 = ~new_n81_ | z09;
  assign new_n81_ = (new_n79_ | ~x22) & ~x15 & (~new_n76_ | x20 | x21 | x22);
  assign z16 = ~new_n83_ | z09;
  assign new_n83_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x07 & (new_n85_ | new_n87_ | new_n77_));
  ...
  assign new_n89_ = (~x25 | (new_n64_ & new_n90_ & ~x23 & ~x24)) & ~new_n77_ & (~new_n64_ | ~new_n90_ | x23 | x24 | x25);
