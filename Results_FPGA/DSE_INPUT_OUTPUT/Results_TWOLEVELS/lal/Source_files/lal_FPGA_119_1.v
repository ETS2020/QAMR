...
module FAU ( 
  ...
  assign z08 = x25 | (x24 & (new_n60_ | (x23 & ~x25)));
  assign new_n60_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & (x25 | (new_n51_ & ~x07 & ~x25));
  assign z10 = ~x15 & (x25 | (~x07 & ~new_n51_ & ~x17));
  assign z11 = ~x15 & (x25 | (~x07 & ~new_n51_ & (x17 ^ x18)));
  assign z12 = ~x15 & (new_n65_ | x25);
  assign new_n65_ = ~x07 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~x15 & (x25 | (new_n51_ & ~x07 & ~x25))) | new_n67_ | x15 | new_n68_ | (x07 & ~x25);
  assign new_n67_ = x20 & (~x17 | ~x18 | ~x19);
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~new_n70_ & ~x25);
  assign new_n70_ = (~x21 | (new_n71_ & x19 & ~x20)) & ~x07 & ~new_n72_ & (~new_n71_ | ~x19 | x20 | x21);
  assign new_n71_ = x17 & x18;
  assign new_n72_ = x04 & x05 & ~x07 & ~x15;
  assign z15 = x15 | (~x25 & (new_n74_ | x07 | new_n75_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n74_ = x22 & (~new_n71_ | ~x19 | x20 | x21);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~x25 & (~new_n77_ | x07 | (~new_n75_ & x23)));
  assign new_n77_ = ~new_n72_ & (~new_n78_ | ~x17 | ~x18 | ~x19);
  assign new_n78_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x25 & (new_n80_ | new_n82_ | x07 | (new_n51_ & ~x07 & ~x15)));
  assign new_n80_ = ~x23 & ((~new_n81_ & ~x20) | (~x21 & x22 & x24));
  assign new_n81_ = (~x17 | ((x19 | ~x24) & (~x18 | ~x19 | x21 | x22 | x24))) & (~x24 | ((x17 | ~x18) & (~x19 | ~x21)));
  assign new_n82_ = x24 & (~x18 | x20 | x23);
  assign z18 = (~x15 & (x25 | (new_n51_ & ~x07 & ~x25))) | x15 | (~x25 & (new_n84_ | x07));
  assign new_n84_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x24;
endmodule
