...
module FAU ( 
  ...
  assign z13 = x15 | (~new_n72_ & ~x15) | new_n63_ | (~new_n74_ & x20);
  assign new_n72_ = ~new_n73_ & ~x07;
  assign new_n73_ = x04 & x05 & ~x07;
  assign new_n74_ = x17 & x18 & x19;
  assign z14 = x15 ? ~x25 : ~new_n76_;
  assign new_n76_ = (~x21 | (new_n77_ & x19 & ~x20)) & ~x07 & ~new_n73_ & (~new_n77_ | ~x19 | x20 | x21);
  assign new_n77_ = x17 & x18;
  assign z15 = x15 | ~new_n79_ | (~new_n72_ & ~x15);
  assign new_n79_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = x15 ? ~x25 : (~new_n82_ | x07 | (~new_n81_ & x23));
  assign new_n81_ = new_n74_ & ~x20 & ~x21 & ~x22;
  assign new_n82_ = ~new_n73_ & (~new_n74_ | x20 | x21 | x22 | x23);
  assign z17 = new_n84_ | (x15 & ~x25) | (~x15 & (~new_n72_ | new_n86_));
  ...
  assign z18 = (~x25 & (new_n88_ | x15)) | (~x15 & (~new_n72_ | (~new_n88_ & x25)));
  assign new_n88_ = new_n63_ & ~x23 & ~x24 & ~x21 & ~x22;
endmodule
