...
module FAU ( 
  ...
  assign z01 = z09 | x07 | (~x15 & ~new_n49_ & ~x25);
  ...
  assign z15 = x07 | (~x15 & (new_n75_ | new_n73_ | new_n68_));
  ...
  assign new_n77_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n67_ | x22 | x23 | x20 | x21);
  assign z17 = z09 | new_n79_ | new_n80_ | x07;
  assign new_n79_ = x24 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n69_ & new_n74_ & ~x23 & ~x24;
  assign z18 = x07 | (~new_n82_ & ~x15);
  assign new_n82_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~new_n68_ & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
