...
module FAU ( 
  ...
  assign z01 = x07 | (~x15 & (new_n49_ | (x04 & x05 & ~x07)));
  ...
  assign z13 = z09 | (~new_n76_ & x20) | new_n64_ | x07;
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = z09 | new_n78_ | x07 | (~new_n64_ & x21);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 | (~x15 & (new_n80_ | new_n81_ | (x04 & x05 & ~x07)));
