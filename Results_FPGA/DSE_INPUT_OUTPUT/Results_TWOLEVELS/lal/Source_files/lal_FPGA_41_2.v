...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n55_, new_n57_, new_n58_,
    ...
    new_n70_, new_n72_, new_n77_, new_n79_, new_n81_, new_n82_, new_n84_,
  ...
  assign z13 = x15 | (~new_n77_ & ~x15) | (x17 & x18 & x19 & ~x20) | (x20 & (~x17 | ~x18 | ~x19));
  assign new_n77_ = ~x07 & (~x04 | ~x05 | x07);
  assign z14 = (~x15 & (~new_n77_ | (x21 & (~x19 | x20)))) | (x19 & ((~new_n79_ & x21) | x15 | (new_n79_ & ~x20 & ~x21)));
  assign new_n79_ = x17 & x18;
  assign z15 = (~new_n81_ & x22) | (~new_n77_ & ~x15) | (x19 & (new_n82_ | x15));
  assign new_n81_ = (x15 | (x19 & ~x20)) & (~x19 | (new_n64_ & x17));
  assign new_n82_ = new_n79_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n84_ & x23) | (~new_n77_ & ~x15) | (x19 & (new_n85_ | x15));
  assign new_n84_ = (x15 | (x19 & ~x20)) & (~x19 | (new_n79_ & ~x21 & ~x22));
  assign new_n85_ = x17 & x18 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n88_ & ~x15) | (x19 & (new_n87_ | x15 | (new_n89_ & x17)));
  assign new_n87_ = x24 & (~new_n79_ | x21 | x22);
  assign new_n88_ = new_n77_ & (~x24 | (x19 & ~x20 & ~x23));
