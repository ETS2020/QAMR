...
module FAU ( 
  ...
  assign z01 = ((~x04 | ~x15) & (x07 | (~new_n50_ & ~x25))) | (x04 & x05 & ~x07 & ~x15);
  ...
  assign z12 = (x04 & x15) | (~x07 & ~x15 & ~new_n72_ & (~x04 | ~x05));
  assign new_n72_ = (~x17 | ~x18 | x19) & (~x19 | (x17 & x18));
  assign z13 = x15 ? ~x04 : (new_n74_ | x07 | new_n65_ | (x04 & x05 & ~x07));
  assign new_n74_ = x20 & (~x17 | ~x18 | ~x19);
  assign z14 = z09 | (~new_n65_ & x21) | ~new_n76_ | new_n78_;
  assign new_n76_ = ~new_n77_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n77_ = x07 & ~x15;
  assign new_n78_ = ~x04 & x15;
  assign z15 = x15 ? ~x04 : (new_n80_ | x07 | new_n81_ | (x04 & x05 & ~x07));
  assign new_n80_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n81_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = z09 | (~new_n81_ & x23) | new_n78_ | new_n83_ | new_n77_;
  assign new_n83_ = new_n84_ & x17 & x18 & x19;
  assign new_n84_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = z09 | new_n86_ | new_n78_ | new_n77_ | (~new_n83_ & x24);
  assign new_n86_ = x17 & new_n87_ & x18;
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = z09 | new_n89_ | new_n78_ | new_n90_ | new_n77_;
  assign new_n89_ = x25 & (~new_n65_ | x23 | x24 | x21 | x22);
