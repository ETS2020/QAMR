...
module FAU ( 
  ...
  assign z08 = new_n66_ | (~x09 & (new_n60_ | new_n68_ | new_n62_ | new_n69_));
  ...
  assign z17 = (~x15 & (x09 | (new_n51_ & ~x07 & ~x09))) | (~new_n87_ & ~x09) | new_n89_ | x07 | x15;
  assign new_n87_ = (~x23 | ~x24) & (~x17 | ~new_n88_ | ~x18);
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n89_ = ~new_n82_ & x24;
  assign z18 = x15 | (~x09 & (new_n91_ | ~new_n92_ | x07));
  assign new_n91_ = x25 & (~new_n64_ | ~new_n65_);
  assign new_n92_ = ~new_n77_ & (~new_n64_ | ~new_n93_);
