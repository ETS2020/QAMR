...
module FAU ( 
  ...
  assign z01 = new_n50_ | (x04 & x05) | new_n52_ | x07;
  assign new_n50_ = ~x23 & (x15 | (~x25 & (~x21 | (~new_n51_ & ~x15))));
  assign new_n51_ = x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign new_n52_ = ~x24 & ~x25;
  ...
  assign z08 = (~new_n52_ & x23) | (~x15 & (new_n61_ | new_n63_ | new_n67_));
  ...
  assign new_n74_ = (new_n75_ | ~x20) & ~x07 & ~new_n65_ & ~new_n76_;
  assign new_n75_ = x17 & x18 & x19;
  assign new_n76_ = x04 & x05 & ~x07;
  assign z14 = x15 ? x23 : ~new_n78_;
  assign new_n78_ = (~x21 | (new_n79_ & x19 & ~x20)) & ~x07 & ~new_n76_ & (~new_n79_ | ~x19 | x20 | x21);
  assign new_n79_ = x17 & x18;
  assign z15 = x15 | ~new_n82_ | (~new_n81_ & ~x15);
  assign new_n81_ = ~x07 & (~x04 | ~x05 | x07);
  assign new_n82_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = (~x15 & (~new_n84_ | x07)) | (x23 & (~new_n85_ | ~new_n79_ | x15));
  assign new_n84_ = ~new_n76_ & (~new_n75_ | x20 | x21 | x22 | x23);
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22;
  assign z17 = (~new_n87_ & ~x15) | (x23 & (x15 | x24));
  assign new_n87_ = (~x17 | ~new_n89_ | ~x18) & new_n81_ & (new_n88_ | ~x24);
  assign new_n88_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign new_n89_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x23 & (x15 | x25)) | (~x15 & (~new_n92_ | x07 | (~new_n91_ & x25)));
  assign new_n91_ = new_n75_ & ~x20 & ~x21 & ~x22 & ~x24;
  assign new_n92_ = ~new_n76_ & (~new_n65_ | x21 | x22 | ~new_n52_ | x23);
endmodule
