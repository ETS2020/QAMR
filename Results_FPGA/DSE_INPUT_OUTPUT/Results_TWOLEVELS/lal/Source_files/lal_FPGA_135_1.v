...
module FAU ( 
  ...
  assign z13 = (~new_n69_ & ~x07) | (x20 & (~x17 | ~x18 | ~x19)) | x07 | (x19 & ~x20 & x17 & x18);
  assign new_n69_ = ~x15 & (~x04 | ~x05 | x15);
  assign z14 = ~new_n71_ | (~new_n69_ & ~x07);
  assign new_n71_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~new_n69_ & ~x07) | new_n75_ | new_n73_ | x07;
  ...
  assign z17 = x07 | (~x15 & (~new_n80_ | (~new_n77_ & x24)));
  assign new_n80_ = ~new_n51_ & (~new_n81_ | ~new_n74_ | x23 | x24);
  assign new_n81_ = x17 & x18 & x19 & ~x20;
  assign z18 = ~new_n83_ | (~new_n69_ & ~x07);
  assign new_n83_ = (~x25 | (new_n81_ & new_n74_ & ~x23 & ~x24)) & ~x07 & (~new_n81_ | ~new_n74_ | x23 | x24 | x25);
endmodule
