...
module FAU ( 
  ...
  assign z14 = x07 | (~x15 & ((~new_n70_ & x21) | new_n51_ | new_n71_));
  ...
  assign z16 = x07 | (~x15 & (new_n76_ | new_n51_ | (~new_n73_ & x23)));
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 | (~x15 & (~new_n79_ | (~new_n76_ & x24)));
  assign new_n79_ = ~new_n51_ & (~new_n70_ | ~new_n74_ | x23 | x24);
  assign z18 = x07 | (~new_n81_ & ~x15);
  assign new_n81_ = (~x25 | (new_n70_ & new_n74_ & ~x23 & ~x24)) & ~new_n51_ & (~new_n70_ | ~new_n74_ | x23 | x24 | x25);
endmodule
