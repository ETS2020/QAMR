...
module FAU ( 
  ...
  assign z13 = x15 | new_n73_ | new_n65_ | (~new_n74_ & x20);
  assign new_n73_ = ~x15 & (x07 | (x04 & x05 & ~x07));
  assign new_n74_ = x17 & x18 & x19;
  assign z14 = x15 | new_n73_ | ~new_n76_;
  assign new_n76_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x11 : ~new_n78_;
  assign new_n78_ = ~new_n79_ & ~x07 & ~new_n80_ & (~x04 | ~x05 | x07);
  assign new_n79_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | ~new_n82_ | new_n73_;
  ...
  assign z18 = x15 | ~new_n88_ | new_n73_;
