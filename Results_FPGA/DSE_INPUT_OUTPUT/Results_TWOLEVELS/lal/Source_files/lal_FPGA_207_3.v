...
module FAU ( 
  ...
  assign new_n52_ = ~x23 & ~x25 & (x18 ? ~x10 : (x17 | x19));
  assign z02 = new_n48_ | x16;
  assign z03 = (~new_n55_ & ~x25) | (x18 & (x10 | (~x10 & ~x20 & ~x23 & ~x25)));
  ...
  assign new_n65_ = x24 & ((~x10 & x25) | ((~x10 | ~x18) & (new_n66_ | x23)));
  ...
  assign z11 = ~x07 & ~x15 & ~new_n51_ & ((~x10 & ~x17 & x18) | (x17 & ~x18));
  assign z12 = new_n48_ | (new_n74_ & ~x07);
  assign new_n74_ = ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n76_ | (~x10 & ((x17 & x18 & x19 & ~x20) | (x20 & (~x17 | ~x19)))) | (~x18 & x20);
  assign new_n76_ = ~new_n48_ & (x07 | x15 | (new_n51_ & ~x07 & ~x15));
  assign z14 = new_n76_ | ~new_n78_;
  assign new_n78_ = (~x18 | (~x10 & (x20 | x21 | ~x17 | ~x19))) & (~x21 | (x19 & ~x20 & x17 & x18));
  assign z15 = new_n76_ | (~new_n80_ & x18) | (x22 & (~new_n68_ | ~x17 | ~x18));
  assign new_n80_ = ~x10 & (~x17 | ~x19 | ~new_n81_ | x20);
  assign new_n81_ = ~x21 & ~x22;
  assign z16 = new_n76_ | (x18 & (new_n84_ | x10)) | (~new_n83_ & x23);
  assign new_n83_ = new_n81_ & ~x20 & x17 & x18 & x19;
  assign new_n84_ = x17 & x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n76_ | ~new_n86_;
  assign new_n86_ = (x18 | ~x24) & (x10 | ((~x17 | ~new_n87_ | ~x18) & (new_n84_ | ~x24)));
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n76_ | (~new_n89_ & ~x10) | (~x18 & x25);
  assign new_n89_ = (~x25 | (new_n90_ & new_n81_ & ~x23 & ~x24)) & (~new_n69_ | ~new_n81_ | x23 | x24 | x25);
  assign new_n90_ = x17 & x19 & ~x20;
endmodule
