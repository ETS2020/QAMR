...
module FAU ( 
  ...
  assign z12 = ~x07 & ~x15 & x17 & x18 & ~new_n66_ & ~x19;
  assign z13 = (~x15 & (x19 | (new_n66_ & ~x07 & ~x19))) | (x07 & ~x19) | x15 | x20;
  assign z14 = (~x15 & (x19 | (new_n66_ & ~x07 & ~x19))) | (x07 & ~x19) | x15 | x21;
  assign z15 = (~x15 & (x19 | (new_n66_ & ~x07 & ~x19))) | (x07 & ~x19) | x15 | x22;
  assign z16 = x15 | (~x19 & (x07 | x23 | (new_n66_ & ~x07 & ~x15)));
  assign z17 = x15 | (~x19 & (x07 | x24 | (new_n66_ & ~x07 & ~x15)));
  assign z18 = (~x15 & (x19 | (new_n66_ & ~x07 & ~x19))) | x15 | (~x19 & (x07 | x25));
endmodule
