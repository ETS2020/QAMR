...
module FAU ( 
  ...
  assign z16 = (~new_n93_ & ~x23) | ~new_n98_ | (~x17 & (new_n82_ | (~x07 & x23)));
  assign new_n93_ = ~new_n97_ & (x20 | (~new_n96_ & (~x17 | (~new_n94_ & ~new_n95_))));
  assign new_n94_ = x19 & ~x21 & ~x22 & ~x07 & x18;
  assign new_n95_ = x15 & ~x25;
  assign new_n96_ = x15 & ~x25 & (x18 | x19);
  assign new_n97_ = x15 & ~x25 & (~x21 | ~x22);
  assign new_n98_ = (new_n99_ | ~x20) & ~new_n100_ & (x07 | (~new_n81_ & ~new_n101_));
  assign new_n99_ = (x07 | ~x23) & (~x15 | ~x21 | ~x22 | ~x24);
  assign new_n100_ = x15 & ((x23 & x24) | x25 | (~x24 & ~x25));
  assign new_n101_ = x23 & (~x18 | ~x19 | x21 | x22);
  assign z17 = x07 | new_n103_ | ~new_n105_ | (~x07 & (new_n81_ | (x23 & x24)));
  assign new_n103_ = ~x21 & ~x23 & (new_n95_ | (x17 & new_n104_ & x18));
  assign new_n104_ = x19 & ~x20 & ~x22 & ~x24 & (~x25 | (~x07 & x25));
  assign new_n105_ = (new_n106_ | ~x24) & (~x15 | (~x25 & (x24 | x25)));
  assign new_n106_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z18 = new_n86_ | new_n112_ | ~new_n113_ | (~x25 & (new_n108_ | new_n117_));
  assign new_n108_ = ~x23 & (new_n111_ | (~x20 & (new_n110_ | (~new_n109_ & x17))));
  assign new_n109_ = ~x15 & (~x18 | ~x19 | x21 | x22 | x24);
  assign new_n110_ = x15 & (x18 | x19);
  assign new_n111_ = x15 & (~x21 | ~x22);
  assign new_n112_ = ~x17 & (new_n82_ | (~x07 & x25));
  assign new_n113_ = (~x20 | (~new_n114_ & (x07 | ~x25))) & ~new_n115_ & (x07 | new_n116_ | ~x25);
  assign new_n114_ = x15 & x21 & x22 & x24;
  assign new_n115_ = x15 & (x25 | (x23 & x24));
