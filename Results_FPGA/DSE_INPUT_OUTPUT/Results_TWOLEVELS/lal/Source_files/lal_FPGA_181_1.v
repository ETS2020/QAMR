...
module FAU ( 
  ...
  assign z15 = z09 | new_n83_ | new_n81_ | x07;
  ...
  assign z17 = z09 | new_n87_ | x07 | (~new_n81_ & x24);
  assign new_n87_ = ~x15 & ((x23 & x24) | (x17 & new_n88_ & x18));
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 | (~new_n90_ & ~x15);
  assign new_n90_ = (~x25 | (new_n65_ & new_n82_ & ~x23 & ~x24)) & ~new_n51_ & (~new_n65_ | ~new_n82_ | x23 | x24 | x25);
endmodule
