...
module FAU ( 
  ...
  assign z08 = new_n65_ | ~new_n67_ | (~new_n63_ & ~x17);
  assign new_n63_ = ~x25 & (~new_n64_ | x18 | x19);
  assign new_n64_ = x21 & x22 & x24;
  assign new_n65_ = x19 & (x15 | (new_n66_ & ~x15 & x17 & x18 & ~x20));
  assign new_n66_ = ~x21 & ~x22 & ~x23 & ~x24 & x25;
  assign new_n67_ = (~x20 | (~new_n64_ & ~x25)) & (~x23 | (~x24 & ~x25)) & (new_n68_ | ~x25);
  assign new_n68_ = x18 & x19 & ~x21 & ~x22 & ~x24;
  assign z09 = (new_n70_ & ~x07 & ~x15) | (x15 & x19);
  assign new_n70_ = x04 & x05;
  assign z10 = ~x07 & ~x15 & ~new_n70_ & ~x17;
  assign z11 = (x15 & x19) | (~x07 & ~x15 & ~new_n70_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n70_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n75_ & ~x15) | new_n77_ | (~new_n76_ & x20);
  assign new_n75_ = ~x07 & (~x04 | ~x05 | x07);
  assign new_n76_ = x17 & x18 & x19;
  assign new_n77_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~x19 & (x15 | x21)) | (~x15 & (~new_n79_ | x07 | (~new_n81_ & x21)));
  assign new_n79_ = ~new_n80_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n80_ = x04 & x05 & ~x07;
  assign new_n81_ = x17 & x18 & ~x20;
  assign z15 = (~new_n83_ & ~x15) | (~x19 & (x15 | x22));
  assign new_n83_ = ~new_n84_ & ~new_n80_ & ~new_n85_ & ~x07;
  assign new_n84_ = x22 & (~x17 | ~x18 | x20 | x21);
  assign new_n85_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n87_ & ~x15) | (~x19 & (x15 | x23));
  assign new_n87_ = ~new_n88_ & ~x07 & ~new_n80_ & (~new_n76_ | ~new_n89_);
  assign new_n88_ = x23 & (~x17 | ~x18 | x20 | x21 | x22);
  assign new_n89_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n91_ & ~x15) | (~x19 & (x15 | x24));
  assign new_n91_ = (~x17 | ~new_n92_ | ~x18) & new_n75_ & (new_n93_ | ~x24);
  assign new_n92_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n93_ = x17 & x18 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z18 = x15 | new_n96_ | (~x15 & (new_n95_ | new_n80_ | x07));
  assign new_n95_ = new_n77_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n96_ = x25 & (~new_n77_ | x23 | x24 | x21 | x22);
endmodule
