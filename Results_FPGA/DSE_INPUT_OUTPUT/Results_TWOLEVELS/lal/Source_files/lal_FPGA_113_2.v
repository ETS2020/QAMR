...
module FAU ( 
  ...
  assign z15 = x15 | (~x07 & (new_n81_ | new_n77_ | (~new_n79_ & x22)));
  assign new_n81_ = new_n76_ & new_n82_ & ~x20;
  assign new_n82_ = ~x21 & ~x22;
  assign z16 = x15 | (~x07 & (new_n84_ | new_n77_ | (~new_n81_ & x23)));
  assign new_n84_ = new_n76_ & ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = x15 | (~x07 & (new_n86_ | new_n77_ | (~new_n84_ & x24)));
  assign new_n86_ = x17 & new_n87_ & x18;
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~new_n89_ & ~x07);
  assign new_n89_ = (~x25 | (new_n64_ & new_n82_ & ~x23 & ~x24)) & ~new_n77_ & (~new_n64_ | ~new_n82_ | x23 | x24 | x25);
endmodule
