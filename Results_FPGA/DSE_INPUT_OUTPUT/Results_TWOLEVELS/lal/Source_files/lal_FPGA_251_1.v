...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n62_,
    ...
    new_n70_, new_n75_, new_n77_, new_n79_, new_n81_, new_n83_, new_n85_,
    new_n86_, new_n87_;
  ...
  assign z13 = z09 | (~new_n77_ & x20) | new_n65_ | x07;
  ...
  assign z16 = x07 | (~new_n83_ & ~x15);
  assign new_n83_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~new_n51_ & (~new_n77_ | x20 | x21 | x22 | x23);
