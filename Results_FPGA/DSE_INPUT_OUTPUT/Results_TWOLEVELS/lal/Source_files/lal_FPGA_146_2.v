...
module FAU ( 
  ...
  assign z01 = x07 | (~x07 & ~new_n50_ & ~x25) | (x04 & x05);
  ...
  assign new_n67_ = (x20 | (new_n51_ & ~x17)) & x22;
  ...
  assign new_n93_ = (~x17 | (~new_n94_ & (~x15 | x25))) & (~x15 | new_n51_ | x25);
  assign new_n94_ = ~x07 & x18 & x19 & ~x21 & ~x22;
  assign new_n95_ = (~x20 | (~new_n97_ & (x07 | ~x23))) & ~new_n98_ & (new_n96_ | x07);
  assign new_n96_ = ~new_n77_ & (~x23 | (x18 & x19 & ~x21 & ~x22));
  ...
  assign new_n100_ = ~new_n77_ & (~x24 | (new_n101_ & x17 & x18 & x19));
  assign new_n101_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n102_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n103_ = x15 & (x07 | x25 | (~x25 & (~x24 | (~x21 & ~x23))));
  assign z18 = ~new_n107_ | (~x25 & ((~new_n105_ & ~x23) | (x15 & ~x24)));
  assign new_n105_ = (x20 | ((new_n51_ | ~x15) & (~x17 | (~new_n106_ & ~x15)))) & (new_n52_ | ~x15);
  assign new_n106_ = new_n79_ & ~x21 & ~x22 & ~x24;
  assign new_n107_ = (x17 | (~new_n80_ & ~new_n111_)) & new_n108_ & (~x20 | (~new_n97_ & ~new_n111_));
  assign new_n108_ = (~x15 | (~new_n109_ & ~x25)) & (x07 | (~new_n77_ & (new_n110_ | ~x25)));
