...
module FAU ( 
  ...
  assign z01 = new_n52_ | new_n50_ | x07;
  ...
  assign new_n67_ = x07 & (x25 | ((new_n68_ | x23) & x24));
  ...
  assign z14 = x07 | (~x15 & (new_n78_ | new_n80_ | (~new_n65_ & x21)));
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n52_ | (~new_n80_ & x22) | new_n82_ | x07;
  assign new_n82_ = new_n77_ & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n84_ | new_n52_;
  assign new_n84_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = new_n52_ | (~new_n86_ & ~x15) | ~new_n87_ | (~new_n82_ & x24);
  ...
  assign z18 = new_n52_ | ~new_n87_ | (~x15 & x25 & (~new_n65_ | ~new_n66_));
endmodule
