...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n51_, new_n52_, new_n56_, new_n57_, new_n62_, new_n63_,
    new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n72_, new_n75_,
    new_n76_, new_n78_, new_n79_, new_n81_, new_n82_, new_n84_, new_n85_,
    new_n87_;
  assign z00 = ~z02 & x08;
  assign z02 = new_n49_ | x16;
  assign new_n49_ = ~x07 & x15;
  assign z01 = z09 | new_n51_ | x07;
  ...
  assign new_n72_ = ((x04 & x05) | (x17 ? (~x18 | x19) : ~x19)) & ~x15 & (x18 | ~x19 | (x04 & (x05 | x15)));
  assign z13 = z09 | (x20 & (~x17 | ~x18 | ~x19)) | x07 | (x17 & x18 & x19 & ~x20);
  assign z14 = x07 | (~x15 & (new_n75_ | new_n76_ | (~new_n66_ & x21)));
  assign new_n75_ = x04 & x05 & ~x07;
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 | (~x15 & (new_n78_ | new_n75_ | (~new_n76_ & x22)));
  assign new_n78_ = x17 & x18 & x19 & new_n79_ & ~x20;
  assign new_n79_ = ~x21 & ~x22;
  assign z16 = z09 | (~new_n78_ & x23) | new_n81_ | x07;
  assign new_n81_ = new_n82_ & x17 & x18 & x19;
  assign new_n82_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = z09 | new_n84_ | x07 | (~new_n81_ & x24);
  assign new_n84_ = x17 & x18 & new_n85_ & x19;
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n87_ | z09;
  assign new_n87_ = (~x25 | (new_n66_ & new_n79_ & ~x23 & ~x24)) & ~x07 & (~new_n66_ | ~new_n79_ | x23 | x24 | x25);
endmodule
