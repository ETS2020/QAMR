...
module FAU ( 
  ...
  assign z01 = new_n49_ | new_n51_ | x07 | (x11 & x15);
  ...
  assign z04 = ~x08 & ((~new_n55_ & (~x11 | ~x15)) | (x02 & ~x11) | (~x02 & x11 & ~x15));
  ...
  assign z08 = (x24 & (new_n60_ | x23)) | (x11 & x15) | x25;
  assign new_n60_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = (x11 & x15) | (new_n51_ & ~x07 & ~x15);
  ...
  assign z13 = x15 | (~new_n67_ & x20) | x07 | new_n68_ | (new_n51_ & ~x07 & ~x15);
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~new_n68_ & x21) | x07 | new_n70_ | (new_n51_ & ~x07 & ~x15);
  assign new_n70_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 ? ~x11 : ~new_n72_;
  assign new_n72_ = (new_n70_ | ~x22) & ~x07 & ~new_n73_ & (~x04 | ~x05 | x07);
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~new_n73_ & x23) | x07 | new_n75_ | (new_n51_ & ~x07 & ~x15);
  assign new_n75_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 ? ~x11 : ((~new_n75_ & x24) | ~new_n77_ | x07);
  assign new_n77_ = (~new_n68_ | ~new_n78_) & (~x04 | ~x05 | x07);
  assign new_n78_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | new_n80_ | x07 | new_n81_ | (new_n51_ & ~x07 & ~x15);
  assign new_n80_ = x25 & (~new_n68_ | ~new_n78_);
  assign new_n81_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
