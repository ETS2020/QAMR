...
module FAU ( 
  ...
  assign z14 = z09 | (~new_n71_ & x21) | ~new_n73_ | x07;
  assign new_n73_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x16 & (new_n76_ | x07 | new_n75_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n75_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n76_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (x16 & ((~new_n75_ & x23) | ~new_n78_ | x07));
  assign new_n78_ = ~new_n70_ & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = z09 | new_n80_ | x07 | new_n81_ | x15;
  assign new_n80_ = x24 & (~new_n69_ | x22 | x23 | x20 | x21);
