...
module FAU ( 
  ...
  assign z15 = x15 | (~x07 & (new_n73_ | new_n68_ | (~new_n71_ & x22)));
  assign new_n73_ = new_n67_ & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign z16 = ~new_n76_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n76_ = (~x23 | (new_n67_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n67_ | x20 | x21 | x22 | x23);
  assign z17 = (~x15 & (x07 | (x04 & x05 & ~x07))) | new_n78_ | new_n79_ | x15;
  assign new_n78_ = x24 & (~new_n67_ | x22 | x23 | x20 | x21);
