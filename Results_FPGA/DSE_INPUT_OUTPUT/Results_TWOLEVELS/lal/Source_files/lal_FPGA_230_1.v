...
module FAU ( 
  ...
  assign z09 = (~x08 & x15) | (~x07 & ~x15 & x04 & x05);
  assign z10 = ~x07 & ~x15 & ~x17 & (~x04 | ~x05);
  assign z11 = (~x08 & x15) | (~x07 & new_n64_ & ~x15);
  ...
  assign z14 = x15 | ~new_n72_ | (~x15 & (new_n68_ | x07));
  ...
  assign z17 = x15 | new_n79_ | new_n80_ | (~x15 & (new_n68_ | x07));
