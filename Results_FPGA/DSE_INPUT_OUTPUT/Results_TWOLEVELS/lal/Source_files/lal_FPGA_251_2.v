// Benchmark "FAU" written by ABC on Mon Aug 24 18:25:59 2020
...
module FAU ( 
  ...
  assign z15 = x15 | (~x07 & (new_n81_ | new_n78_ | (~new_n79_ & x22)));
  assign new_n81_ = new_n76_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~new_n83_ & ~x07);
  assign new_n83_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & ~new_n78_ & (~new_n76_ | x20 | x21 | x22 | x23);
  ...
  assign z18 = z09 | ~new_n86_ | (~x07 & x25 & (~new_n64_ | ~new_n65_));
endmodule
