...
module FAU ( 
  ...
  assign z08 = (~x15 & ((x23 & x24) | (x22 & (new_n61_ | x25)))) | (~x22 & (x25 | (x23 & x24)));
  ...
  assign z14 = x15 ? ~x22 : ~new_n73_;
  assign new_n73_ = (~x21 | (new_n74_ & x19 & ~x20)) & ~x07 & ~new_n70_ & (~new_n74_ | ~x19 | x20 | x21);
  assign new_n74_ = x17 & x18;
  assign z15 = (~x22 & (new_n76_ | x15)) | (~x15 & (new_n70_ | x07 | (~new_n76_ & x22)));
  assign new_n76_ = new_n74_ & x19 & ~x20 & ~x21;
  assign z16 = (~new_n78_ & x23) | new_n79_ | (~x22 & (new_n80_ | x15));
  assign new_n78_ = (x15 | (~x20 & ~x22)) & (x22 | (new_n74_ & x19 & ~x21));
  assign new_n79_ = ~x15 & (new_n70_ | x07);
  assign new_n80_ = new_n69_ & ~x20 & ~x21 & ~x23;
  assign z17 = x15 | new_n79_ | ~new_n82_;
  assign new_n82_ = (x22 | ((~x23 | ~x24) & (~new_n69_ | x20 | x21 | x23 | x24))) & (~x24 | (new_n69_ & ~x20 & ~x21 & ~x22));
  assign z18 = new_n84_ | new_n79_ | (~new_n86_ & ~x22);
  assign new_n84_ = x25 & ((~new_n85_ & ~x22) | (~x15 & (x20 | x22 | x23)));
  assign new_n85_ = x17 & x18 & x19 & ~x21 & ~x24;
  assign new_n86_ = ~x15 & (~new_n71_ | x24 | x25 | x21 | x23);
endmodule
