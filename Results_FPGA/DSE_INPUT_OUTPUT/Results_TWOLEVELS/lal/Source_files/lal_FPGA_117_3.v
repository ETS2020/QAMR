...
module FAU ( 
  ...
  assign z08 = (~new_n63_ & ~x17) | ~new_n67_ | (~new_n65_ & x19);
  assign new_n63_ = ~x25 & (~new_n64_ | x18 | x19);
  assign new_n64_ = x21 & x22 & x24;
  assign new_n65_ = ~x15 & (~new_n66_ | x22 | x23 | x24 | ~x25);
  assign new_n66_ = x17 & x18 & ~x20 & ~x21;
  ...
  assign z10 = (x15 & x19) | (~x07 & ~x15 & ~new_n70_ & ~x17);
  assign z11 = (x15 & x19) | (~x07 & ~x15 & ~new_n70_ & (x17 ^ x18));
  assign z12 = (x15 & x19) | (~x07 & ~new_n70_ & ((x19 & (~x17 | ~x18)) | (~x15 & x17 & x18 & ~x19)));
  assign z13 = x15 | new_n75_ | new_n78_ | (~new_n77_ & x20);
  assign new_n75_ = ~x15 & (new_n76_ | x07);
  assign new_n76_ = x04 & x05 & ~x07;
  assign new_n77_ = x17 & x18 & x19;
  assign new_n78_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | new_n75_ | ~new_n80_;
  assign new_n80_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | new_n75_ | ~new_n82_;
  assign new_n82_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = (~new_n84_ & ~x15) | (~x19 & (x15 | x23));
  assign new_n84_ = ~new_n85_ & ~x07 & ~new_n76_ & (~new_n77_ | ~new_n86_);
  assign new_n85_ = x23 & (~x17 | ~x18 | x20 | x21 | x22);
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | new_n75_ | new_n88_ | (x24 & (~new_n77_ | ~new_n86_));
  assign new_n88_ = x17 & x18 & new_n89_ & x19;
  assign new_n89_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | new_n75_ | ~new_n91_;
  assign new_n91_ = (~x25 | (new_n78_ & ~x23 & ~x24 & ~x21 & ~x22)) & (~new_n78_ | x21 | x22 | x23 | x24 | x25);
endmodule
