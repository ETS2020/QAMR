...
module FAU ( 
  ...
  assign new_n73_ = ~x07 & ((x04 & x05) | ((~x19 | (x17 & (x07 | x18))) & (~x17 | ~x18 | x19)));
  ...
  assign new_n83_ = ~x07 & x18 & x19 & ~x21;
  ...
  assign new_n106_ = (x20 | ((new_n51_ | ~x15) & (~x17 | (~new_n107_ & ~x15)))) & (new_n52_ | ~x15);
