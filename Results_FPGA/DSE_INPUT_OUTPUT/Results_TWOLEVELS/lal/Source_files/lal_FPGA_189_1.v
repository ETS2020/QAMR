...
module FAU ( 
  ...
  assign z15 = ~new_n81_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n81_ = (new_n79_ | ~x22) & ~x07 & (~new_n77_ | x20 | x21 | x22);
  assign z16 = ~new_n83_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n83_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | (~x15 & (new_n85_ | new_n87_ | new_n51_));
  assign new_n85_ = x17 & new_n86_ & x18;
  assign new_n86_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n87_ = x24 & (~new_n77_ | x20 | x21 | x22 | x23);
