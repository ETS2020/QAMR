...
module FAU ( 
  ...
  assign z08 = new_n63_ | new_n65_ | (x25 & (~x19 | (~new_n67_ & ~x15)));
  assign new_n63_ = ~x17 & (new_n64_ | (~x15 & x25));
  assign new_n64_ = ~x18 & ~x19 & x21 & x22 & x24;
  assign new_n65_ = x24 & ((~x15 & x25) | (~new_n66_ & (~x15 | ~x19)));
  ...
  assign z09 = (new_n72_ & ~x07 & ~x15) | (x15 & x19);
  ...
  assign z13 = x15 | (~new_n77_ & ~x15) | new_n69_ | (~new_n78_ & x20);
  assign new_n77_ = ~x07 & (~x04 | ~x05 | x07);
  assign new_n78_ = x17 & x18 & x19;
  assign z14 = x15 | ~new_n80_ | (~new_n77_ & ~x15);
  assign new_n80_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | ~new_n82_ | (~new_n77_ & ~x15);
  assign new_n82_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = (~x19 & (x15 | x23)) | (~x15 & (~new_n84_ | (~new_n86_ & x23)));
  assign new_n84_ = ~x07 & (~new_n78_ | ~new_n85_) & (~x04 | ~x05 | x07);
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n86_ = x17 & x18 & ~x20 & ~x21 & ~x22;
  assign z17 = (~new_n88_ & ~x15) | (~x19 & (x15 | x24));
  assign new_n88_ = (~x17 | ~new_n89_ | ~x18) & new_n77_ & (new_n90_ | ~x24);
  assign new_n89_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n90_ = x17 & x18 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z18 = x15 | (~x19 & x25) | (~x15 & (~new_n93_ | (~new_n92_ & x25)));
  assign new_n92_ = new_n70_ & x17 & x18 & ~x20;
  assign new_n93_ = ~x07 & (~new_n69_ | ~new_n94_) & (~x04 | ~x05 | x07);
