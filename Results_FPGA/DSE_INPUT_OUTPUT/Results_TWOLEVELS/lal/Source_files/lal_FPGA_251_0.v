...
module FAU ( 
  ...
  assign new_n50_ = ~x25 & ~z09 & (~x24 | (~new_n51_ & ~x23));
  ...
  assign z13 = z09 | (~new_n64_ & ~z09);
  assign new_n64_ = (~x24 | (~x23 & (~x21 | new_n53_ | ~x22))) & ~x25 & (x25 | (x24 & (x23 | (~new_n53_ & x21 & x22))));
  assign z14 = ~new_n64_ & ~z09;
  assign z10 = 1'b0;
  assign z12 = 1'b0;
  assign z11 = z09;
  assign z15 = ~new_n64_ & ~z09;
  assign z16 = ~new_n64_ & ~z09;
  assign z17 = z09 | (~new_n64_ & ~z09);
  assign z18 = z09 | (~new_n64_ & ~z09);
endmodule
