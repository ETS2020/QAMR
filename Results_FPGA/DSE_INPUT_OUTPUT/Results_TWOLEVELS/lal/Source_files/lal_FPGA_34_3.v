...
module FAU ( 
  ...
  assign z09 = (x08 & x15) | (new_n63_ & ~x07 & ~x15);
  assign new_n63_ = x04 & x05;
  assign z10 = (x08 & x15) | (~x07 & ~x15 & ~new_n63_ & ~x17);
  assign z11 = (x08 & x15) | (~x07 & ~x15 & ~new_n63_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n63_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~x15 & (new_n68_ | x07)) | new_n70_ | (~new_n69_ & x20);
  assign new_n68_ = x04 & x05 & ~x07;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 ? ~x08 : (~new_n72_ | x07 | (~new_n70_ & x21));
  assign new_n72_ = ~new_n68_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x08 : (new_n75_ | x07 | new_n74_ | new_n68_);
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | ~new_n77_ | (~x15 & (new_n68_ | x07));
  assign new_n77_ = (~x23 | (new_n69_ & ~x20 & ~x21 & ~x22)) & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 ? ~x08 : (new_n79_ | x07 | new_n80_ | new_n68_);
