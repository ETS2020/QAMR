...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n53_, new_n55_, new_n56_, new_n61_, new_n66_,
  ...
  assign z01 = (x04 & x05 & (x02 | (~x07 & ~x15))) | ((x02 | ~x15) & (new_n49_ | x07));
  ...
  assign z14 = x15 ? x02 : ((~new_n71_ & x21) | ~new_n73_ | x07);
  ...
  assign z16 = x15 | ~new_n77_ | (~x15 & (new_n70_ | x07));
  assign new_n77_ = (~x23 | (new_n69_ & ~x20 & ~x21 & ~x22)) & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x15 & (new_n70_ | x07)) | new_n79_ | new_n80_;
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? x02 : (~new_n82_ | x07 | (~new_n80_ & x25));
