...
module FAU ( 
  ...
  assign z01 = z03 | new_n52_ | new_n48_ | x07;
  ...
  assign z10 = x02 & ~x07 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = x02 & ~x07 & ~x15 & ~new_n52_ & (x17 ^ x18);
  assign z12 = x02 & new_n71_ & ~x07;
  assign new_n71_ = ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n73_ & x02);
  assign new_n73_ = (new_n74_ | ~x20) & ~x07 & ~new_n64_ & ~new_n75_;
  assign new_n74_ = x17 & x18 & x19;
  assign new_n75_ = x04 & x05 & ~x07 & ~x15;
  assign z14 = new_n77_ | ~new_n78_ | x07 | (~new_n64_ & x21);
  assign new_n77_ = ~x15 & (~x02 | (x02 & x04 & x05 & ~x07));
  assign new_n78_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x02 & (new_n81_ | x07 | new_n80_ | (new_n52_ & ~x07 & ~x15)));
  assign new_n80_ = new_n74_ & ~x20 & ~x21 & ~x22;
  assign new_n81_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (x02 & (~new_n83_ | x07 | (~new_n80_ & x23)));
  assign new_n83_ = ~new_n75_ & (~new_n74_ | x20 | x21 | x22 | x23);
  assign z17 = new_n77_ | new_n86_ | x07 | x15 | (~new_n85_ & x24);
  assign new_n85_ = new_n74_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n86_ = x17 & x18 & new_n87_ & x19;
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n77_ | new_n89_ | x07 | new_n90_ | x15;
