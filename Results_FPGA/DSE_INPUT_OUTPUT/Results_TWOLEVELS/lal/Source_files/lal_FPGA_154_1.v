...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n55_, new_n56_, new_n61_, new_n62_, new_n66_,
  ...
  assign z14 = z09 | ~new_n69_;
  assign new_n69_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | ((new_n73_ | new_n71_ | new_n74_) & ~x15);
  ...
  assign z16 = z09 | (~new_n71_ & x23) | new_n76_ | x07;
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 | (~x15 & (new_n79_ | new_n74_ | (~new_n76_ & x24)));
  assign new_n79_ = new_n80_ & new_n72_ & ~x23 & ~x24;
  assign new_n80_ = x17 & x18 & x19 & ~x20;
  assign z18 = ~new_n82_ | z09;
  assign new_n82_ = (~x25 | (new_n80_ & new_n72_ & ~x23 & ~x24)) & ~x07 & (~new_n80_ | ~new_n72_ | x23 | x24 | x25);
endmodule
