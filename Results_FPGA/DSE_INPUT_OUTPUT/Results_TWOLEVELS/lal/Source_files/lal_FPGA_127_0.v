...
module FAU ( 
  ...
  assign z01 = (x04 & x05 & (x15 | (~x07 & x09 & ~x15))) | ((x09 | x15) & (new_n49_ | x07));
  ...
  assign z10 = ~x15 & (~x09 | (~x07 & ~x17 & (~x04 | ~x05)));
  assign z11 = ~new_n64_ & ~x15;
  assign new_n64_ = x09 & (x07 | (x04 & x05) | (x17 ^ ~x18));
  assign z12 = ~x15 & (new_n66_ | ~x09);
  ...
  assign z14 = new_n73_ | (~new_n71_ & x21) | x15 | new_n74_ | (~x09 & ~x15);
  assign new_n73_ = x09 & (new_n70_ | x07);
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n73_ | (~new_n74_ & x22) | x15 | new_n76_ | (~x09 & ~x15);
  assign new_n76_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x09 & ((~new_n76_ & x23) | ~new_n78_ | x07));
  assign new_n78_ = ~new_n70_ & (~new_n69_ | x22 | x23 | x20 | x21);
  assign z17 = new_n73_ | new_n80_ | x15 | new_n81_ | (~x09 & ~x15);
  assign new_n80_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n81_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (x09 & ((~new_n81_ & x25) | ~new_n83_ | x07));
