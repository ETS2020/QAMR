...
module FAU ( 
  ...
  assign z15 = ~new_n81_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n81_ = (new_n79_ | ~x22) & ~x15 & (~new_n76_ | x20 | x21 | x22);
  assign z16 = ~new_n83_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  ...
  assign new_n87_ = x24 & (~new_n76_ | x22 | x23 | x20 | x21);
  assign z18 = (~x15 & (x07 | (x04 & x05 & ~x07))) | x15 | (~new_n89_ & ~x07);
