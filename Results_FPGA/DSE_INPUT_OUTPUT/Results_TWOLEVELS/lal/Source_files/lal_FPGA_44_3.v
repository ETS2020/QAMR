...
module FAU ( 
  ...
  assign z01 = x07 ? ~x15 : (new_n53_ | (~new_n51_ & ~x25));
  ...
  assign z08 = new_n62_ | new_n67_ | new_n68_ | new_n49_ | (~new_n64_ & x25);
  ...
  assign z09 = (x07 & x15) | (new_n53_ & ~x07 & ~x15);
  assign z10 = x07 ? x15 : (~x15 & ~new_n53_ & ~x17);
  assign z11 = ~x07 & ~x15 & ~new_n53_ & (x17 ^ x18);
  assign z12 = ~x07 & ~x15 & ~new_n53_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~x07 & (new_n53_ | x15)) | (~x15 & ((~new_n74_ & x20) | new_n66_ | x07));
  assign new_n74_ = x17 & x18 & x19;
  assign z14 = (~x07 & (new_n53_ | x15)) | (~x15 & ((~new_n66_ & x21) | new_n76_ | x07));
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~x07 & (new_n53_ | x15)) | (~x15 & (new_n78_ | x07 | (~new_n76_ & x22)));
  assign new_n78_ = new_n74_ & ~x20 & ~x21 & ~x22;
  assign z16 = x07 | ~new_n80_ | (~x07 & (new_n53_ | x15));
  assign new_n80_ = (~x23 | (new_n74_ & ~x20 & ~x21 & ~x22)) & (~new_n74_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | (~x07 & (new_n53_ | x15)) | new_n83_ | (~new_n82_ & x24);
  assign new_n82_ = new_n74_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n83_ = x17 & x18 & new_n84_ & x19;
  assign new_n84_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 | ~new_n86_ | (~x07 & (new_n53_ | x15));
  assign new_n86_ = (~x25 | (new_n66_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n66_ | x21 | x22 | x23 | x24 | x25);
endmodule
