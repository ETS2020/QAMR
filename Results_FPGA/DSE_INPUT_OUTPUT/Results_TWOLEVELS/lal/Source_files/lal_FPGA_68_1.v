...
module FAU ( 
  ...
  assign z13 = new_n75_ | (x20 & (~x17 | ~x18 | ~x19)) | x07 | (x17 & x18 & x19 & ~x20);
  assign new_n75_ = ~x07 & (x15 | (x04 & x05 & ~x15));
  assign z14 = x07 | (~x15 & ((~new_n66_ & x21) | new_n52_ | new_n77_));
  assign new_n77_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n75_ | (~new_n77_ & x22) | new_n79_ | x07;
  assign new_n79_ = x17 & x18 & x19 & new_n80_ & ~x20;
  assign new_n80_ = ~x21 & ~x22;
  assign z16 = x07 | (~x15 & (new_n82_ | new_n52_ | (~new_n79_ & x23)));
  assign new_n82_ = new_n83_ & x17 & x18 & x19;
  assign new_n83_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n75_ | new_n85_ | x07 | (~new_n82_ & x24);
  assign new_n85_ = x17 & x18 & new_n86_ & x19;
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n88_ | new_n75_;
  assign new_n88_ = (~x25 | (new_n66_ & new_n80_ & ~x23 & ~x24)) & ~x07 & (~new_n66_ | ~new_n80_ | x23 | x24 | x25);
endmodule
