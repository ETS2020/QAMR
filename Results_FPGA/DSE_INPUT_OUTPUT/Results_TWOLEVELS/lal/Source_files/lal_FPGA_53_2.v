...
module FAU ( 
  ...
  assign z08 = new_n60_ | (x17 & (new_n67_ | new_n63_ | new_n68_));
  assign new_n60_ = ~x13 & (new_n62_ | (~new_n61_ & ~x17));
  ...
  assign new_n65_ = x18 & x19 & ~x20;
  assign new_n66_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n67_ = x20 & (x25 | (x21 & x22 & x24));
  assign new_n68_ = x23 & (x24 | x25);
  assign z09 = new_n70_ | (x13 & ~x17);
  assign new_n70_ = x04 & x05 & ~x07 & ~x15;
  assign z10 = ~x17 & (x13 | (~x07 & ~new_n52_ & ~x15));
  assign z11 = ~x07 & ~x15 & ~new_n52_ & ((~x13 & ~x17 & x18) | (x17 & ~x18));
  assign z12 = (x13 & ~x17) | (new_n74_ & ~x07);
  assign new_n74_ = ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n76_ | (x17 & ((x18 & x19 & ~x20) | (x20 & (~x18 | ~x19)))) | (~x13 & ~x17 & x20);
  assign new_n76_ = (new_n52_ | ~new_n77_) & (~x13 | x17);
  assign new_n77_ = ~x07 & ~x15;
  assign z14 = new_n76_ | (x17 & (new_n79_ | (~new_n65_ & x21))) | (~x13 & ~x17 & x21);
  assign new_n79_ = x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n77_ & (~x13 | x17)) | ~new_n81_ | (~x17 & (x13 | x22));
  assign new_n81_ = (~x22 | (new_n82_ & ~x20 & ~x21)) & ~new_n70_ & (~new_n82_ | ~x17 | x20 | x21 | x22);
  assign new_n82_ = x18 & x19;
  assign z16 = new_n76_ | (~new_n84_ & x17) | (~x13 & ~x17 & x23);
  assign new_n84_ = (new_n85_ | ~x23) & (~new_n65_ | x21 | x22 | x23);
  assign new_n85_ = x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = (~new_n77_ & (~x13 | x17)) | (~x17 & (x13 | x24)) | ~new_n89_ | (~new_n87_ & x17);
  assign new_n87_ = (~new_n88_ | ~x18) & (~x23 | ~x24);
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n89_ = ~new_n70_ & (new_n85_ | ~x24);
  assign z18 = (~new_n77_ & (~x13 | x17)) | (~x17 & (x13 | (~x13 & x25))) | (new_n52_ & new_n77_) | (~new_n91_ & x17);
  assign new_n91_ = (~new_n79_ | ~new_n92_) & (~x25 | (new_n65_ & new_n66_));
