...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n53_, new_n55_, new_n60_, new_n62_, new_n66_,
  ...
  assign z08 = new_n60_ | x25 | (~x08 & ~x15);
  assign new_n60_ = x24 & (x23 | (x21 & ~new_n50_ & x22));
  assign z09 = ~x15 & (~x08 | (new_n62_ & ~x07 & x08));
  assign new_n62_ = x04 & x05;
  assign z10 = ~x07 & x08 & ~x15 & ~new_n62_ & ~x17;
  assign z11 = ~x15 & (~x08 | (~x07 & ~new_n62_ & (~x17 ^ ~x18)));
  assign z12 = ~x15 & (new_n66_ | ~x08);
  assign new_n66_ = ~x07 & ~new_n62_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n68_ | (~new_n69_ & x20) | x15 | new_n70_ | (~x08 & ~x15);
  assign new_n68_ = x08 & (x07 | (new_n62_ & ~x07 & ~x15));
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = new_n68_ | (~new_n70_ & x21) | x15 | new_n72_ | (~x08 & ~x15);
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (x08 & (new_n74_ | x07 | new_n75_ | (new_n62_ & ~x07 & ~x15)));
  assign new_n74_ = ~new_n72_ & x22;
  assign new_n75_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = new_n68_ | (~new_n75_ & x23) | x15 | new_n77_ | (~x08 & ~x15);
  assign new_n77_ = new_n69_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n68_ | (~new_n77_ & x24) | x15 | new_n79_ | (~x08 & ~x15);
  assign new_n79_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (x08 & ((~new_n79_ & x25) | ~new_n81_ | x07));
  assign new_n81_ = (~new_n70_ | ~new_n82_) & (~new_n62_ | x07 | x15);
