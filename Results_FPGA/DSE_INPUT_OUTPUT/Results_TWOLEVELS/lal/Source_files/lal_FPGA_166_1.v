...
module FAU ( 
  ...
  assign z13 = x07 | (~x15 & ((~new_n68_ & x20) | new_n51_ | new_n69_));
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = x07 | (~x15 & ((~new_n69_ & x21) | new_n51_ | new_n71_));
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 | (~x15 & (new_n73_ | new_n51_ | (~new_n71_ & x22)));
  assign new_n73_ = new_n68_ & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign z16 = ~new_n76_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n76_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~x07 & (x15 | (x04 & x05 & ~x15))) | new_n78_ | new_n79_ | x07;
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & new_n74_ & ~x23 & ~x24;
  assign z18 = x07 | (~new_n81_ & ~x15);
  assign new_n81_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~new_n51_ & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
