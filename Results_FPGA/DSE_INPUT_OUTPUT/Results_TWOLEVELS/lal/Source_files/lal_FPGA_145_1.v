...
module FAU ( 
  ...
  assign z04 = ~x08 & ((~new_n57_ & (x01 | ~x10)) | (x01 & ~x10));
  ...
  assign z12 = ~x07 & ~x15 & new_n68_ & ~new_n53_;
  assign new_n68_ = ~new_n48_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = ~new_n70_ | (~new_n48_ & (x07 | x15));
  assign new_n70_ = (~x20 | (x17 & x18 & x19)) & ~new_n48_ & ~new_n64_ & (~x19 | x20 | ~x17 | ~x18);
  assign z14 = ~new_n48_ & ((~new_n72_ & x21) | ~new_n52_ | new_n73_ | x15);
  assign new_n72_ = x17 & x18 & x19 & ~x20;
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n48_ & ((~new_n73_ & x22) | ~new_n52_ | new_n75_ | x15);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n48_ & (x07 | x15)) | (~new_n75_ & x23) | ~new_n77_ | new_n48_;
  assign new_n77_ = ~new_n64_ & (~new_n78_ | ~x17 | ~x18 | ~x19);
  assign new_n78_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n48_ & ~new_n81_) | (~new_n75_ & x24) | new_n48_ | new_n80_ | new_n64_;
  assign new_n80_ = new_n72_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n81_ = ~x07 & ~x15 & (~x23 | ~x24);
  assign z18 = (~new_n48_ & (x07 | x15)) | ~new_n83_ | new_n48_ | (~new_n80_ & x25);
  assign new_n83_ = ~new_n64_ & (~new_n72_ | ~new_n84_);
