...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_;
  ...
  assign z13 = (~x15 & (x19 | (new_n51_ & ~x07 & ~x19))) | (x07 & ~x19) | x15 | x20;
  assign z14 = x15 | (~x19 & (x07 | x21 | (new_n51_ & ~x07 & ~x15)));
  assign z15 = x15 | (~x19 & (x07 | x22 | (new_n51_ & ~x07 & ~x15)));
  assign z16 = x15 | (~x19 & (x07 | x23 | (new_n51_ & ~x07 & ~x15)));
  assign z17 = x15 | (~x19 & (x07 | x24 | (new_n51_ & ~x07 & ~x15)));
  assign z18 = (~x15 & (x19 | (new_n51_ & ~x07 & ~x19))) | (x07 & ~x19) | x15 | x25;
endmodule
