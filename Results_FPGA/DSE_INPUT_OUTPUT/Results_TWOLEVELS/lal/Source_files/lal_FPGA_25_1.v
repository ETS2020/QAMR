...
module FAU ( 
  ...
  assign z13 = new_n68_ | (x20 & (~x17 | ~x18 | ~x19)) | new_n49_ | (x19 & ~x20 & x17 & x18);
  assign new_n68_ = ~new_n49_ & (x07 | x15 | (new_n53_ & ~x07 & ~x15));
  assign z14 = ~new_n49_ & ((~new_n71_ & x21) | ~new_n70_ | new_n72_ | (new_n53_ & new_n70_));
  assign new_n70_ = ~x07 & ~x15;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n68_ | (~new_n72_ & x22) | new_n49_ | new_n74_;
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n49_ & (~new_n76_ | (~new_n74_ & x23));
  assign new_n76_ = new_n70_ & (~new_n53_ | ~new_n70_) & (~new_n77_ | ~x17 | ~x18 | ~x19);
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n79_ & ~new_n49_) | new_n80_ | new_n49_ | (~new_n74_ & x24);
  assign new_n79_ = new_n70_ & (~new_n53_ | ~new_n70_) & (~x23 | ~x24);
  assign new_n80_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n49_ & ((~new_n80_ & x25) | ~new_n70_ | new_n82_ | (new_n53_ & new_n70_));
