...
module FAU ( 
  ...
  assign z13 = (~new_n48_ & ~new_n69_) | (~new_n70_ & x20) | new_n52_ | new_n48_ | new_n71_;
  assign new_n69_ = ~x07 & ~x15;
  assign new_n70_ = x17 & x18 & x19;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n48_ & ~new_n69_) | (~new_n71_ & x21) | new_n52_ | new_n48_ | new_n73_;
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n48_ & ~new_n69_) | new_n52_ | new_n75_ | new_n48_ | (~new_n73_ & x22);
  assign new_n75_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n48_ & ~new_n69_) | (~new_n75_ & x23) | new_n52_ | new_n77_ | new_n48_;
  assign new_n77_ = new_n70_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = ~new_n48_ & (~new_n79_ | (~new_n77_ & x24));
  assign new_n79_ = new_n69_ & (~new_n52_ | ~new_n69_) & (~new_n71_ | ~new_n80_);
  assign new_n80_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n48_ & ~new_n69_) | new_n82_ | new_n48_ | new_n52_ | (~new_n77_ & x25);
  assign new_n82_ = ~x20 & ((x24 & x25) | (new_n83_ & ~x22 & ~x23 & ~x24 & ~x25));
  assign new_n83_ = x17 & x18 & x19 & ~x21;
endmodule
