...
module FAU ( 
  ...
  assign z16 = (~x07 & (x15 | (x04 & x05 & ~x15))) | (~new_n75_ & ~x15);
  assign new_n75_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~x07 & (x15 | new_n80_ | (x04 & x05 & ~x15))) | (~new_n77_ & ~x15);
  assign new_n77_ = (new_n79_ | ~x24) & ~x07 & (~new_n69_ | ~new_n78_ | x23 | x24);
  assign new_n78_ = ~x21 & ~x22;
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign new_n80_ = x23 & x24;
  assign z18 = (~x07 & (x15 | (x04 & x05 & ~x15))) | (~new_n82_ & ~x15);
  assign new_n82_ = (~x25 | (new_n69_ & new_n78_ & ~x23 & ~x24)) & ~x07 & (~new_n69_ | ~new_n78_ | x23 | x24 | x25);
endmodule
