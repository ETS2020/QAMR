...
module FAU ( 
  ...
  assign new_n66_ = ~x19 & (x15 | x25);
  assign new_n67_ = x20 & (x25 | (x21 & x22 & x24));
  assign new_n68_ = x23 & (x24 | x25);
  assign z09 = ~x15 & new_n51_ & ~x07;
  assign z10 = ~x07 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = (x15 & ~x19) | (~x07 & ~x15 & ~new_n51_ & (~x17 ^ ~x18));
  assign z12 = (x15 & ~x19) | (~x07 & ~new_n51_ & ((~x15 & x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19)));
  assign z13 = x15 | new_n74_ | x07 | new_n63_ | (new_n51_ & ~x07 & ~x15);
  assign new_n74_ = x20 & (~x17 | ~x18 | ~x19);
  assign z14 = (~x15 & (~new_n77_ | ((~x19 | x20) & x21))) | (x19 & ((~new_n76_ & x21) | x15 | (new_n76_ & ~x20 & ~x21)));
  assign new_n76_ = x17 & x18;
  assign new_n77_ = ~x07 & (~x04 | ~x05 | x07);
  assign z15 = (~x15 & (~new_n77_ | ((~x19 | x20) & x22))) | (~new_n79_ & x19);
  assign new_n79_ = (x20 | ((~x21 | ~x22) & (~new_n76_ | x21 | x22))) & ~x15 & (new_n76_ | ~x22);
  assign z16 = (x19 & (new_n81_ | new_n83_ | x15)) | (~new_n82_ & ~x15);
  assign new_n81_ = x23 & (~new_n76_ | (~x20 & (x21 | x22)));
  assign new_n82_ = new_n77_ & (~x23 | (x19 & ~x20));
  assign new_n83_ = x17 & x18 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n85_ & ~x15) | (x19 & ((~new_n86_ & ~x20) | new_n87_ | x15));
  assign new_n85_ = new_n77_ & (~x24 | (x19 & ~x20));
  assign new_n86_ = (~x17 | ~x18 | x21 | x22 | x23 | x24) & (~x24 | (~x21 & ~x22));
  assign new_n87_ = x24 & (~x17 | ~x18 | x23);
  assign z18 = x15 | new_n89_ | x07 | new_n90_ | (new_n51_ & ~x07 & ~x15);
