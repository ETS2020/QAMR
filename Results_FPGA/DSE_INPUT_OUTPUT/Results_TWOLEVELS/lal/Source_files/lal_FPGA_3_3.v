...
module FAU ( 
  ...
  assign z14 = x07 | new_n76_ | ~new_n79_;
  assign new_n79_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n76_ | (~x15 & (new_n81_ | new_n82_ | x07));
  assign new_n81_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n82_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n84_ | x07;
  assign new_n84_ = ~new_n76_ & (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | (~new_n86_ & ~x15) | ~new_n88_ | (~x07 & (x15 | (x23 & x24)));
  assign new_n86_ = (~new_n64_ | ~new_n87_) & (~x04 | ~x05 | x07);
  assign new_n87_ = ~x21 & ~x22 & ~x23 & ~x24 & x25;
  assign new_n88_ = (new_n82_ | ~x24) & (~new_n64_ | ~new_n89_ | x23 | x24 | x25);
  assign new_n89_ = ~x21 & ~x22;
  assign z18 = x07 | ~new_n91_ | new_n76_;
  assign new_n91_ = (~new_n64_ | ~new_n89_ | x23 | x24 | x25) & (x15 | ~x25 | (new_n64_ & new_n89_ & ~x23 & ~x24));
endmodule
