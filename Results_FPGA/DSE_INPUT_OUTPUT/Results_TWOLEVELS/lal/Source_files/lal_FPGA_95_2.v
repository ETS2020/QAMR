...
module FAU ( 
  ...
  assign z01 = ((~x05 | x15) & (x07 | (~new_n51_ & ~x25))) | (x04 & x05 & x15);
  ...
  assign z13 = (~new_n72_ & x20) | x15 | (~x05 & x07) | new_n65_ | (x05 & ~x15);
  assign new_n72_ = x17 & x18 & x19;
  assign z14 = x15 | (~x05 & (new_n74_ | x07 | (~new_n65_ & x21)));
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n74_ & x22) | x15 | (~x05 & x07) | new_n76_ | (x05 & ~x15);
  assign new_n76_ = new_n72_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~x05 & (new_n78_ | x07 | (~new_n76_ & x23)));
  assign new_n78_ = new_n72_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (x17 & new_n80_ & x18) | ~new_n81_ | (~new_n78_ & x24);
  assign new_n80_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n81_ = (x05 | ~x07) & ~x15 & (~x05 | x15);
  assign z18 = new_n83_ | x15 | (~x05 & x07) | new_n84_ | (x05 & ~x15);
  assign new_n83_ = x25 & (~new_n65_ | x21 | x22 | x23 | x24);
  assign new_n84_ = new_n65_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z09 = 1'b0;
endmodule
