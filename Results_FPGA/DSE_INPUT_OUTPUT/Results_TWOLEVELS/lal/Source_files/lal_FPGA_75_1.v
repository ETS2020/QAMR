...
module FAU ( 
  ...
  assign z14 = ~new_n79_ | (~x07 & (x15 | (x04 & x05 & ~x15)));
  assign new_n79_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~x07 & (x15 | (x04 & x05 & ~x15))) | new_n82_ | new_n81_ | x07;
  ...
  assign z18 = (~x07 & (x15 | (x04 & x05 & ~x15))) | x07 | (~new_n89_ & ~x15);
  assign new_n89_ = (~x25 | (new_n65_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n65_ | x21 | x22 | x23 | x24 | x25);
endmodule
