...
module FAU ( 
  ...
  assign z13 = x07 | (~x15 & (new_n65_ | new_n78_ | (~new_n77_ & x20)));
  assign new_n77_ = x17 & x18 & x19;
  assign new_n78_ = x04 & x05 & ~x07;
  assign z14 = (~new_n51_ & ~x07) | new_n80_ | x07 | (~new_n65_ & x21);
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = ~new_n82_ | (~new_n51_ & ~x07);
  assign new_n82_ = (new_n80_ | ~x22) & ~x07 & (~new_n77_ | x20 | x21 | x22);
  assign z16 = ~new_n84_ | (~new_n51_ & ~x07);
  assign new_n84_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | (~x15 & (new_n86_ | new_n88_ | new_n78_));
  assign new_n86_ = x17 & new_n87_ & x18;
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n88_ = x24 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z18 = x07 | (~new_n90_ & ~x15);
  assign new_n90_ = (~x25 | (new_n65_ & new_n91_ & ~x23 & ~x24)) & ~new_n78_ & (~new_n65_ | ~new_n91_ | x23 | x24 | x25);
