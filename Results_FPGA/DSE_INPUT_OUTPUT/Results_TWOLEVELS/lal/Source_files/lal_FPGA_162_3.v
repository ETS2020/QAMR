...
module FAU ( 
  ...
  assign z15 = new_n68_ | (~x15 & ((~new_n72_ & x22) | new_n74_ | x07));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n76_ | x07;
  assign new_n76_ = ~new_n68_ & (~x23 | (new_n69_ & ~x20 & ~x21 & ~x22)) & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = (~x07 & (~new_n79_ | x15)) | (~x15 & ((~new_n74_ & x24) | new_n78_ | x07));
  assign new_n78_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n79_ = (~x23 | ~x24) & (~x04 | ~x05 | x15);
  assign z18 = x07 | ~new_n81_ | new_n68_;
  assign new_n81_ = (~x25 | (new_n70_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n70_ | x21 | x22 | x23 | x24 | x25);
endmodule
