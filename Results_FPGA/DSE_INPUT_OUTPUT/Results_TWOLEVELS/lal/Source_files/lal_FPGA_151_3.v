...
module FAU ( 
  ...
  assign z12 = (x08 & x15) | (~x07 & new_n74_ & ~x15);
  assign new_n74_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? ~x08 : ~new_n76_;
  ...
  assign z15 = x15 | ~new_n81_ | (~x15 & (new_n77_ | x07));
  assign new_n81_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = x15 ? ~x08 : (~new_n83_ | x07 | (~new_n85_ & x23));
  assign new_n83_ = ~new_n77_ & (~new_n84_ | ~x17 | ~x18 | ~x19);
  assign new_n84_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n85_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = x15 | new_n87_ | (~new_n85_ & x24) | (~new_n89_ & ~x15);
