...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n55_, new_n56_, new_n61_, new_n65_, new_n67_,
  ...
  assign new_n65_ = ((x04 & x05) | (x17 ? (~x18 | x19) : ~x19)) & ~x15 & (x18 | ~x19 | (x04 & (x05 | x15)));
  assign z13 = x07 | (~x15 & (new_n68_ | new_n69_ | (~new_n67_ & x20)));
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x04 & x05 & ~x07;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = x07 | (~x15 & (new_n68_ | new_n71_ | (~new_n69_ & x21)));
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = z09 | (~new_n71_ & x22) | new_n73_ | x07;
  assign new_n73_ = new_n67_ & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign z16 = x07 | (~x15 & (new_n76_ | new_n68_ | (~new_n73_ & x23)));
  assign new_n76_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = z09 | ~new_n78_ | (~new_n76_ & x24);
  assign new_n78_ = ~x07 & (~new_n69_ | ~new_n74_ | x23 | x24);
  assign z18 = x07 | (~new_n80_ & ~x15);
  assign new_n80_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~new_n68_ & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
