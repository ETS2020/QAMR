...
module FAU ( 
  ...
  assign z10 = ~x15 & (~x24 | (~x07 & ~x17 & ~new_n63_ & x24));
  assign z11 = ~x15 & (~x24 | (~x07 & ~new_n63_ & (x17 ? (~x18 & x24) : x18)));
  assign z12 = ~x07 & new_n67_ & ~x15;
  assign new_n67_ = x24 & ~new_n63_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = new_n69_ | x15;
  assign new_n69_ = x24 & ((x17 & x18 & x19 & ~x20) | ~new_n70_ | (x20 & (~x17 | ~x18 | ~x19)));
  assign new_n70_ = ~x07 & (x07 | x15 | ~x04 | ~x05);
  assign z14 = (~x15 & (~x24 | (new_n63_ & ~x07 & x24))) | ((new_n72_ | x07) & x24) | new_n73_ | x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign new_n73_ = x21 & (~x17 | ~x18 | ~x19 | x20);
  assign z15 = (~x15 & (~x24 | (new_n63_ & ~x07 & x24))) | ((new_n75_ | x07) & x24) | new_n76_ | x15;
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign new_n76_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = z09 | x15 | (~new_n78_ & x24);
  assign new_n78_ = (~x23 | (new_n79_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n79_ | x22 | x23 | x20 | x21);
  assign new_n79_ = x17 & x18 & x19;
  assign z17 = x15 | (x24 & (~new_n82_ | (~x07 & ~new_n81_ & ~x15)));
  assign new_n81_ = ~new_n63_ & (new_n63_ | (x17 & (~x17 | (x18 & (~x18 | x19)))));
  assign new_n82_ = (~x17 | ~x18 | ~x19 | new_n83_ | x20) & ~x07 & ~x20;
  assign new_n83_ = ~x21 & (x21 | (~x22 & (x22 | ~x23)));
  assign z18 = (~x15 & (~x24 | (new_n63_ & ~x07 & x24))) | x15 | (x24 & (x07 | x25));
endmodule
