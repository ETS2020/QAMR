...
module FAU ( 
  ...
  assign z03 = (x15 & x23) | (~x25 & ((~x24 & (~x15 | ~x23)) | (~new_n50_ & ~x23)));
  ...
  assign new_n66_ = x24 & (x23 | x25);
  assign new_n67_ = x23 & (x15 | x25);
  ...
  assign z13 = x15 | new_n74_ | (x17 & x18 & x19 & ~x20) | (x20 & (~x17 | ~x18 | ~x19));
  assign new_n74_ = ~x15 & (new_n75_ | x07);
  assign new_n75_ = x04 & x05 & ~x07;
  assign z14 = x15 ? ~x23 : ((~new_n62_ & x21) | ~new_n77_ | x07);
  assign new_n77_ = ~new_n75_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x23 : (new_n80_ | x07 | new_n79_ | new_n75_);
  assign new_n79_ = new_n61_ & x17 & ~x20 & ~x21 & ~x22;
  assign new_n80_ = x22 & (~x19 | x20 | x21 | ~x17 | ~x18);
  assign z16 = (~x23 & (new_n79_ | x15)) | (~x15 & (new_n75_ | x07 | (~new_n79_ & x23)));
  assign z17 = x15 | new_n74_ | new_n84_ | (x17 & new_n83_ & x18);
  assign new_n83_ = x19 & ~x20 & ~x21 & new_n63_ & ~x22;
  assign new_n84_ = x24 & (~new_n85_ | ~new_n61_ | ~x17);
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z18 = x15 | new_n74_ | ~new_n87_;
  assign new_n87_ = (~x25 | (new_n62_ & ~x23 & ~x24 & ~x21 & ~x22)) & (~new_n62_ | x21 | x22 | x23 | x24 | x25);
endmodule
