...
module FAU ( 
  ...
  assign new_n74_ = ((x04 & x05) | (x17 ? (~x18 | x19) : ~x19)) & ~x15 & (x18 | ~x19 | (x04 & (x05 | x15)));
  assign z13 = x07 | (~x15 & (new_n65_ | new_n77_ | (~new_n76_ & x20)));
  assign new_n76_ = x17 & x18 & x19;
  assign new_n77_ = x04 & x05 & ~x07;
  assign z14 = x07 | (~x15 & (new_n77_ | new_n79_ | (~new_n65_ & x21)));
  ...
  assign z17 = x07 | (~x15 & (new_n86_ | new_n88_ | new_n77_));
  assign new_n86_ = x17 & new_n87_ & x18;
  assign new_n87_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n88_ = x24 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z18 = x07 | (~new_n90_ & ~x15);
  assign new_n90_ = (~x25 | (new_n65_ & new_n82_ & ~x23 & ~x24)) & ~new_n77_ & (~new_n65_ | ~new_n82_ | x23 | x24 | x25);
endmodule
