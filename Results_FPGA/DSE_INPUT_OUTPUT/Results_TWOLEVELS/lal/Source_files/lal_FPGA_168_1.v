...
module FAU ( 
  ...
  assign new_n82_ = new_n78_ & new_n83_ & ~x20;
  assign new_n83_ = ~x21 & ~x22;
  assign z16 = x07 | (~new_n85_ & ~x15);
  assign new_n85_ = (~x23 | (new_n78_ & ~x20 & ~x21 & ~x22)) & ~new_n51_ & (~new_n78_ | x20 | x21 | x22 | x23);
  assign z17 = new_n77_ | new_n87_ | x07 | (~new_n82_ & x24);
  assign new_n87_ = ~x15 & ((x23 & x24) | (x17 & new_n88_ & x18));
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 | (~new_n90_ & ~x15);
  assign new_n90_ = (~x25 | (new_n65_ & new_n83_ & ~x23 & ~x24)) & ~new_n51_ & (~new_n65_ | ~new_n83_ | x23 | x24 | x25);
endmodule
