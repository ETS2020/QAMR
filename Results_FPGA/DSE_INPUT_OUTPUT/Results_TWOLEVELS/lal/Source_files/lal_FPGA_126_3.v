...
module FAU ( 
  ...
  assign new_n79_ = (x25 | ((x23 | (x21 & x22)) & x24)) & ~x25 & (~x24 | (~x23 & (~x20 | ~x21 | ~x22)));
  ...
  assign new_n86_ = x15 & ((~x25 & ((~x23 & (~x21 | ~x22)) | ~x24)) | x25 | (x23 & x24));
  assign new_n87_ = x17 & (new_n75_ | (x19 & ~x21 & ~x15 & x18));
