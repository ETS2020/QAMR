...
module FAU ( 
  ...
  assign z14 = ~new_n70_ | (~new_n68_ & x21);
  assign new_n70_ = ~x15 & (~x04 | ~x05 | x07) & ~new_n71_ & (~x07 | x15);
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x07 & (new_n73_ | new_n51_ | (~new_n71_ & x22)));
  assign new_n73_ = new_n67_ & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign z16 = x15 | (~x07 & (new_n76_ | new_n51_ | (~new_n73_ & x23)));
  assign new_n76_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (~new_n78_ | (~new_n76_ & x24)));
  assign new_n78_ = ~new_n51_ & (~new_n68_ | ~new_n74_ | x23 | x24);
  assign z18 = x15 | (~new_n80_ & ~x07);
  assign new_n80_ = (~x25 | (new_n68_ & new_n74_ & ~x23 & ~x24)) & ~new_n51_ & (~new_n68_ | ~new_n74_ | x23 | x24 | x25);
endmodule
