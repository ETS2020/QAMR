...
module FAU ( 
  ...
  assign z01 = (~x07 & ~new_n51_ & ~x25) | x07 | (x04 & x05);
  ...
  assign z13 = x15 | (~x07 & ((~new_n74_ & x20) | new_n65_ | new_n75_));
  ...
  assign z16 = x15 | (~x07 & (new_n82_ | new_n75_ | (~new_n79_ & x23)));
  assign new_n82_ = new_n74_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n86_ & ~x15) | new_n84_ | x15 | (~new_n82_ & x24);
  assign new_n84_ = x17 & new_n85_ & x18;
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n86_ = ~x07 & (~x04 | ~x05 | x07);
  assign z18 = ~new_n88_ | (~new_n86_ & ~x15);
