...
module FAU ( 
  ...
  assign new_n61_ = (new_n62_ | ~x24) & (x07 | ~x15) & (x20 | ~x25);
  ...
  assign z13 = (~new_n69_ & ~x07) | (~new_n70_ & x20) | new_n71_ | x07;
  assign new_n69_ = ~x15 & (~x04 | ~x05 | x15);
  assign new_n70_ = x17 & x18 & x19;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign z14 = x07 | (~x15 & ((~new_n71_ & x21) | new_n51_ | new_n73_));
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 | (~x15 & (new_n75_ | new_n51_ | (~new_n73_ & x22)));
  assign new_n75_ = new_n70_ & new_n76_ & ~x20;
  assign new_n76_ = ~x21 & ~x22;
  assign z16 = ~new_n78_ | (~new_n69_ & ~x07);
  assign new_n78_ = (~x23 | (new_n70_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n70_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | (~x15 & (new_n80_ | new_n81_ | new_n51_));
  assign new_n80_ = x24 & (~new_n70_ | x20 | x21 | x22 | x23);
  assign new_n81_ = new_n71_ & new_n76_ & ~x23 & ~x24;
  assign z18 = ~new_n83_ | (~new_n69_ & ~x07);
  assign new_n83_ = (~x25 | (new_n71_ & new_n76_ & ~x23 & ~x24)) & ~x07 & (~new_n71_ | ~new_n76_ | x23 | x24 | x25);
endmodule
