...
module FAU ( 
  ...
  assign z16 = x07 | ~new_n76_ | new_n67_;
  assign new_n76_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~x07 & (~new_n79_ | x15)) | (~x15 & ((~new_n73_ & x24) | new_n78_ | x07));
  assign new_n78_ = new_n69_ & new_n74_ & ~x23 & ~x24;
  assign new_n79_ = (~x04 | ~x05 | x15) & (~x23 | ~x24);
