...
module FAU ( 
  ...
  assign z01 = (x04 & x05 & (x15 | (~x07 & ~x11 & ~x15))) | ((~x11 | x15) & (new_n49_ | x07));
  ...
  assign z09 = ~x15 & ~x11 & new_n63_ & ~x07;
  assign new_n63_ = x04 & x05;
  assign z10 = ~x15 & (x11 | (~x07 & ~new_n63_ & ~x17));
  assign z11 = ~x15 & (x11 | (~x07 & ~new_n63_ & (~x17 ^ ~x18)));
  ...
  assign z14 = (~new_n74_ & ~x11) | (~new_n72_ & x21) | x15 | new_n75_ | (x11 & ~x15);
  assign new_n74_ = ~new_n71_ & ~x07;
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x11 & (new_n77_ | x07 | new_n78_ | new_n71_));
  assign new_n77_ = ~new_n75_ & x22;
  assign new_n78_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~x11 & (~new_n80_ | x07 | (~new_n78_ & x23)));
  assign new_n80_ = ~new_n71_ & (~new_n70_ | x22 | x23 | x20 | x21);
  assign z17 = (~new_n74_ & ~x11) | new_n82_ | x15 | new_n83_ | (x11 & ~x15);
  assign new_n82_ = x24 & (~new_n70_ | x20 | x21 | x22 | x23);
  assign new_n83_ = new_n72_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x11 & (~new_n85_ | x07 | (~new_n83_ & x25)));
  assign new_n85_ = ~new_n71_ & (~new_n72_ | ~new_n86_);
