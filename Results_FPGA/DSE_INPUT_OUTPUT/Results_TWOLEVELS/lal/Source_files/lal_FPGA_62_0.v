...
module FAU ( 
  ...
  assign z08 = new_n67_ | (x13 & (new_n61_ | new_n69_ | new_n63_ | new_n70_));
  ...
  assign z12 = ~x07 & new_n75_ & x13;
  assign new_n75_ = ~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n77_ & ~x15) | x07 | new_n65_ | x15 | (~new_n78_ & x20);
  assign new_n77_ = x13 & (~new_n52_ | x07 | ~x13);
  assign new_n78_ = x17 & x18 & x19;
  assign z14 = (~new_n77_ & ~x15) | (~new_n65_ & x21) | x07 | new_n80_ | x15;
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (x13 & (new_n82_ | x07 | new_n83_ | (new_n52_ & ~x07 & ~x15)));
  assign new_n82_ = ~new_n80_ & x22;
  assign new_n83_ = new_n78_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (x13 & (~new_n85_ | x07 | (~new_n83_ & x23)));
  assign new_n85_ = (~new_n78_ | ~new_n86_) & (~new_n52_ | x07 | x15);
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (x13 & (~new_n88_ | (x17 & new_n89_ & x18)));
  assign new_n88_ = (~x24 | (new_n78_ & new_n86_)) & ~x07 & (~new_n52_ | x07 | x15);
  assign new_n89_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (x13 & (~new_n92_ | x07 | (~new_n91_ & x25)));
  assign new_n91_ = new_n65_ & new_n66_;
  assign new_n92_ = (~new_n65_ | ~new_n93_) & (~new_n52_ | x07 | x15);
