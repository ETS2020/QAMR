...
module FAU ( 
  ...
  assign z15 = new_n79_ | (~new_n80_ & x19);
  assign new_n79_ = ~x15 & (x07 | (x04 & x05 & ~x07) | (~x19 & x22));
  assign new_n80_ = (~x22 | (x17 & x18 & ~x20 & ~x21)) & ~x15 & (~x17 | ~x18 | x20 | x21 | x22);
  assign z16 = x15 | ~new_n82_ | (~new_n74_ & ~x15);
  assign new_n82_ = (~x23 | (new_n75_ & ~x20 & ~x21 & ~x22)) & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z17 = (x19 & (new_n86_ | x15 | (new_n85_ & x17))) | (~new_n84_ & ~x15);
  assign new_n84_ = new_n74_ & (~x24 | (x19 & ~x23));
  assign new_n85_ = x18 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n86_ = x24 & (~x17 | ~x18 | x20 | x21 | x22);
  assign z18 = x15 | ~new_n88_ | (~new_n74_ & ~x15);
  assign new_n88_ = (~x25 | (new_n63_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n63_ | x21 | x22 | x23 | x24 | x25);
endmodule
