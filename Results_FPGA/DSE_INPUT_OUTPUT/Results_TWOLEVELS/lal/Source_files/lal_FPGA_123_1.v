...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n60_, new_n65_,
    ...
    new_n76_, new_n78_, new_n80_, new_n81_, new_n83_, new_n84_;
  assign z00 = x08 & ~x16;
  ...
  assign z09 = ~x15 & (x16 | (new_n51_ & ~x07 & ~x16));
  ...
  assign z14 = z09 | ~new_n72_;
  assign new_n72_ = (new_n70_ | ~x21) & ~x15 & ~new_n73_ & (~x07 | x16);
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x16 & (new_n75_ | x07 | new_n76_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n75_ = ~new_n73_ & x22;
  assign new_n76_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~x16 & ((~new_n76_ & x23) | ~new_n78_ | x07));
  assign new_n78_ = ~new_n69_ & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~x15 & (x16 | (new_n51_ & ~x07 & ~x16))) | new_n80_ | x15 | new_n81_ | (x07 & ~x16);
  assign new_n80_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n81_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x16 & ((~new_n81_ & x25) | ~new_n83_ | x07));
