...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n54_, new_n59_, new_n60_, new_n61_, new_n62_,
  ...
  assign z01 = new_n49_ | (x04 & x05) | x07 | (~x09 & x15);
  ...
  assign z08 = new_n65_ | (~x15 & (new_n59_ | new_n67_ | new_n61_ | new_n68_));
  ...
  assign new_n65_ = x09 & (x25 | (x24 & (new_n66_ | x23)));
  ...
  assign z11 = (~x09 & x15) | (~x07 & new_n72_ & ~x15);
  assign new_n72_ = (~x04 | ~x05) & (x17 ^ x18);
  assign z12 = (~x09 & x15) | (~x07 & new_n74_ & ~x15);
  assign new_n74_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? x09 : ~new_n76_;
  assign new_n76_ = (~x20 | (x17 & x18 & x19)) & ~x07 & ~new_n77_ & (~x17 | ~x18 | ~x19 | x20);
  assign new_n77_ = x04 & x05 & ~x07;
  assign z14 = x15 ? x09 : ((~new_n63_ & x21) | ~new_n79_ | x07);
  assign new_n79_ = ~new_n77_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? x09 : (new_n81_ | x07 | new_n77_ | new_n82_);
  assign new_n81_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n82_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = x15 ? x09 : ((~new_n82_ & x23) | ~new_n84_ | x07);
  assign new_n84_ = ~new_n77_ & (~new_n85_ | ~x17 | ~x18 | ~x19);
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~new_n87_ & ~x15) | x07 | (~new_n82_ & x24);
  assign new_n87_ = (~x17 | ~new_n88_ | ~x18) & ~new_n77_ & (~x23 | ~x24);
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? x09 : (new_n90_ | ~new_n91_ | x07);
  assign new_n90_ = x25 & (~new_n63_ | ~new_n64_);
  assign new_n91_ = ~new_n77_ & (~new_n63_ | ~new_n92_);
