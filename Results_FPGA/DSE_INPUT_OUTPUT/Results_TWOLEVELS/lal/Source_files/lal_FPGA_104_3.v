...
module FAU ( 
  ...
  assign z01 = z09 | new_n50_ | x07;
  assign new_n50_ = ~x25 & (~x24 | (~new_n51_ & ~x23));
  assign new_n51_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign z09 = x04 & (x15 | (x05 & ~x07 & ~x15));
  assign z03 = new_n50_ | (x04 & x15);
  ...
  assign new_n67_ = ~x04 & (x25 | ((new_n68_ | x23) & x24));
  ...
  assign z13 = x15 ? ~x04 : (new_n76_ | x07 | new_n65_ | (x04 & x05 & ~x07));
  assign new_n76_ = x20 & (~x17 | ~x18 | ~x19);
  assign z14 = z09 | ~new_n78_ | (~new_n65_ & x21);
  assign new_n78_ = (x04 | ~x15) & ~new_n79_ & (~x07 | x15);
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = z09 | ~new_n81_ | (~new_n79_ & x22);
  assign new_n81_ = (x04 | ~x15) & ~new_n82_ & (~x07 | x15);
  assign new_n82_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = z09 | (~new_n82_ & x23) | ~new_n84_ | (~x04 & x15);
  assign new_n84_ = (~x07 | x15) & (~new_n85_ | ~x17 | ~x18 | ~x19);
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = z09 | (~new_n87_ & ~x15) | (~new_n82_ & x24) | (~x04 & x15);
  assign new_n87_ = (~x17 | ~new_n88_ | ~x18) & ~x07 & (~x23 | ~x24);
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x04 : (new_n90_ | x07 | new_n91_ | (x04 & x05 & ~x07));
