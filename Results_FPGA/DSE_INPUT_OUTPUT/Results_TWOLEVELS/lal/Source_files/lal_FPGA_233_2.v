...
module FAU ( 
  ...
  wire new_n49_, new_n51_, new_n52_, new_n53_, new_n56_, new_n57_, new_n62_,
    new_n63_, new_n69_, new_n71_, new_n72_, new_n74_, new_n76_, new_n77_,
    new_n79_, new_n81_;
  assign z00 = ~z02 & x08;
  assign z02 = new_n49_ | x16;
  assign new_n49_ = x07 & ~x15;
  assign z01 = x07 ? x15 : (new_n51_ | new_n53_);
  ...
  assign z08 = (x20 & (new_n62_ | x25)) | (~new_n63_ & x24) | new_n49_ | (~x20 & x25);
  ...
  assign z11 = ~x15 & (x07 | (~new_n53_ & (x17 ^ x18)));
  assign z12 = ~x15 & (x07 | (~new_n53_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n69_ | new_n49_ | (x17 & x18 & x19 & ~x20);
  assign new_n69_ = ~x15 & (~x04 | ~x05 | x07);
  assign z14 = (~new_n71_ & x21) | ~new_n69_ | new_n49_ | new_n72_;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x07 & ((~new_n72_ & x22) | new_n53_ | new_n74_));
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | new_n76_ | new_n49_ | ~new_n69_;
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (new_n79_ | new_n53_ | (~new_n76_ & x24)));
  assign new_n79_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n79_ & x25) | ~new_n69_ | new_n81_ | new_n49_;
