...
module FAU ( 
  ...
  assign z01 = ~new_n48_ & ((~new_n50_ & ~x25) | new_n52_ | x07);
  ...
  assign z12 = ~x07 & new_n73_ & ~new_n48_ & ~x15;
  assign new_n73_ = ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = (~new_n75_ & ~new_n48_) | (x20 & (~x17 | ~x18 | ~x19)) | new_n48_ | (x17 & x18 & x19 & ~x20);
  assign new_n75_ = ~x07 & ~x15 & (~new_n52_ | x07 | x15);
  assign z14 = ~new_n48_ & ((~new_n64_ & x21) | ~new_n77_ | new_n78_ | (new_n52_ & new_n77_));
  assign new_n77_ = ~x07 & ~x15;
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n75_ & ~new_n48_) | (~new_n78_ & x22) | new_n48_ | new_n80_;
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = ~new_n48_ & ((~new_n80_ & x23) | ~new_n77_ | new_n82_ | (new_n52_ & new_n77_));
  assign new_n82_ = new_n83_ & x17 & x18 & x19;
  assign new_n83_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = ~new_n48_ & (new_n85_ | ~new_n75_ | (~new_n82_ & x24));
  assign new_n85_ = x17 & x18 & new_n86_ & x19;
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n48_ & (new_n88_ | ~new_n77_ | (new_n52_ & new_n77_) | (new_n64_ & new_n89_));
