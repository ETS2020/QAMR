...
module FAU ( 
  ...
  assign z01 = x07 | (~x15 & (new_n51_ | (x04 & x05 & ~x07)));
  ...
  assign z13 = new_n74_ | (~new_n75_ & x20) | new_n65_ | x07;
  assign new_n74_ = ~x07 & (x15 | (x04 & x05 & ~x15));
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = new_n74_ | ~new_n77_;
  assign new_n77_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | (~x15 & (new_n81_ | new_n79_ | (x04 & x05 & ~x07)));
  assign new_n79_ = new_n75_ & new_n80_ & ~x20;
  assign new_n80_ = ~x21 & ~x22;
  assign new_n81_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = ~new_n83_ | new_n74_;
  assign new_n83_ = (~x23 | (new_n75_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign z17 = new_n74_ | new_n85_ | x07 | (x17 & new_n86_ & x18);
  assign new_n85_ = x24 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign new_n86_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n88_ | new_n74_;
  assign new_n88_ = (~x25 | (new_n65_ & new_n80_ & ~x23 & ~x24)) & ~x07 & (~new_n65_ | ~new_n80_ | x23 | x24 | x25);
endmodule
