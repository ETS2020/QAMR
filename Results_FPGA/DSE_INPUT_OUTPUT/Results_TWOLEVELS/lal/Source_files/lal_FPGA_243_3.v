...
module FAU ( 
  ...
  assign new_n87_ = (new_n81_ | ~x24) & (~new_n64_ | ~new_n88_ | x23 | x24 | x25);
  assign new_n88_ = ~x21 & ~x22;
  assign z18 = x07 | ~new_n90_ | new_n76_;
  assign new_n90_ = (~new_n64_ | ~new_n88_ | x23 | x24 | x25) & (x15 | ~x25 | (new_n64_ & new_n88_ & ~x23 & ~x24));
endmodule
