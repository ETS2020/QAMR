...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n60_ | x23)) | x25 | (x15 & x16);
  assign new_n60_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = (x15 & x16) | (new_n51_ & ~x07 & ~x15);
  assign z10 = (x15 & x16) | (~x07 & ~x15 & ~new_n51_ & ~x17);
  assign z11 = (x15 & x16) | (~x07 & ~x15 & ~new_n51_ & (x17 ^ x18));
  assign z12 = (x15 & x16) | (~x07 & new_n65_ & ~x15);
  assign new_n65_ = ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? ~x16 : ~new_n67_;
  ...
  assign z14 = x15 | (~new_n70_ & x21) | x07 | new_n72_ | (new_n51_ & ~x07 & ~x15);
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 ? ~x16 : (new_n74_ | x07 | new_n75_ | new_n69_);
  assign new_n74_ = ~new_n72_ & x22;
  assign new_n75_ = new_n68_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 ? ~x16 : (~new_n77_ | x07 | (~new_n75_ & x23));
  assign new_n77_ = ~new_n69_ & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | new_n79_ | x07 | new_n80_ | (new_n51_ & ~x07 & ~x15);
  assign new_n79_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x16 : (~new_n82_ | x07 | (~new_n80_ & x25));
  assign new_n82_ = ~new_n69_ & (~new_n70_ | ~new_n83_);
