...
module FAU ( 
  ...
  assign z12 = ~x15 & (x07 | (~new_n63_ & ((x19 & (~x17 | (~x07 & ~x18))) | (x17 & x18 & ~x19))));
  assign z13 = x15 | (~x07 & ((~new_n68_ & x20) | new_n63_ | new_n69_));
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~x07 & ((~new_n69_ & x21) | new_n63_ | new_n71_));
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n71_ & x22) | new_n51_ | x15 | new_n73_ | (x07 & ~x15);
  ...
  assign z17 = (~new_n76_ & x24) | new_n51_ | x15 | new_n78_ | (x07 & ~x15);
  assign new_n78_ = new_n69_ & new_n74_ & ~x23 & ~x24;
  assign z18 = x15 | (~new_n80_ & ~x07);
  assign new_n80_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~new_n63_ & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
