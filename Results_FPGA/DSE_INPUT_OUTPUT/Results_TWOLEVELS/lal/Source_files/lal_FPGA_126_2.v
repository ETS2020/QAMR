...
module FAU ( 
  ...
  assign z08 = (~x10 & (~new_n61_ | (~new_n66_ & ~x17))) | (~new_n67_ & x15);
  ...
  assign new_n71_ = ~x10 & ~x15 & (~x04 | ~x05) & (~x17 ^ ~x18);
  assign z12 = ~x15 & (x10 | (~new_n73_ & ~x07));
  assign new_n73_ = ((x04 & x05) | (x17 ? (~x18 | x19) : ~x19)) & (x18 | ~x19 | (x04 & (x05 | x10)));
  assign z13 = (~new_n78_ & ~x20) | ~new_n75_ | (~x17 & (new_n81_ | (~x10 & x20)));
  assign new_n75_ = ~new_n76_ & (x10 | (new_n77_ & (~x20 | (x18 & x19))));
  assign new_n76_ = x15 & ((~x25 & (~x24 | (~new_n52_ & ~x23))) | x25 | (x24 & (x23 | (new_n52_ & x20))));
  assign new_n77_ = ~x07 & (~x04 | ~x05 | x07 | x15);
  assign new_n78_ = ~new_n80_ & (~x17 | (~new_n79_ & (x10 | ~x18 | ~x19)));
  ...
  assign new_n84_ = ~new_n77_ & ~x10;
  assign new_n85_ = x17 & (new_n79_ | (x19 & ~x21 & ~x10 & x18));
  assign new_n86_ = (new_n64_ | x10) & (~x15 | ~x22 | new_n51_ | ~x24);
  assign z15 = new_n84_ | (~new_n88_ & ~x21) | new_n89_ | new_n48_ | new_n90_;
  assign new_n88_ = ~new_n79_ & (~x17 | ~x18 | ~x19 | x20 | x22);
  assign new_n89_ = x15 & (x25 | (x23 & x24) | (~x25 & (~x24 | (~x22 & ~x23))));
  assign new_n90_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = new_n84_ | ~new_n95_ | (~new_n92_ & ~x23);
  ...
  assign new_n96_ = (~x15 | ((~x23 | ~x24) & ~x25 & (x24 | x25))) & (new_n94_ | ~x23) & (~x10 | x15);
  assign new_n97_ = x15 & x21 & x22 & x24;
  assign z17 = new_n99_ | new_n103_ | new_n84_ | (x25 & (new_n106_ | x15));
  assign new_n99_ = x24 & ((~x17 & (new_n100_ | ~x10)) | new_n101_ | (~new_n102_ & ~x10));
  assign new_n100_ = new_n52_ & ~x19 & x15 & ~x18;
  assign new_n101_ = x15 & (x23 | (new_n52_ & x20));
  assign new_n102_ = ~x21 & ~x22 & ~x23 & x18 & x19 & ~x20;
  assign new_n103_ = ~x25 & ((~x23 & (new_n104_ | (~new_n52_ & x15))) | (x15 & ~x24));
  assign new_n104_ = ~x20 & ((x17 & (new_n105_ | x15)) | (x15 & (x18 | x19)));
  assign new_n105_ = ~x21 & ~x22 & ~x24 & ~x10 & x18 & x19;
  assign new_n106_ = new_n107_ & ~x10 & x17 & x18 & x19;
  assign new_n107_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n103_ | ~new_n109_ | (~x17 & (new_n81_ | (~x10 & x25)));
  assign new_n109_ = new_n110_ & (~x20 | (~new_n97_ & (x10 | ~x25)));
  assign new_n110_ = (~x15 | (~new_n111_ & ~x25)) & (x10 | (new_n77_ & (new_n112_ | ~x25)));
