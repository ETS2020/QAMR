...
module FAU ( 
  ...
  assign z01 = x07 | new_n50_ | (x04 & x05 & ~x07);
  ...
  assign z13 = x07 | new_n67_ | new_n69_ | (~new_n68_ & x20);
  assign new_n67_ = ~x07 & ((x04 & x05) | x15);
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = new_n67_ | (~x15 & (new_n71_ | x07 | (~new_n69_ & x21)));
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n67_ | (~x15 & ((~new_n71_ & x22) | new_n73_ | x07));
  ...
  assign z17 = new_n67_ | (~x15 & (new_n78_ | new_n79_ | x07));
