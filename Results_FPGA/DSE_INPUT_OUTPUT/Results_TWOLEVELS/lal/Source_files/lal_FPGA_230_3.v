...
module FAU ( 
  ...
  assign z01 = (x04 & x05 & (~x08 | (~x07 & ~x15))) | ((~x08 | ~x15) & (new_n49_ | x07));
  ...
  assign z11 = (x08 & x15) | (~x07 & new_n65_ & ~x15);
  assign new_n65_ = (~x04 | ~x05) & (x17 ^ x18);
  assign z12 = (x08 & x15) | (~x07 & new_n67_ & ~x15);
  assign new_n67_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~x15 & (new_n69_ | x07)) | new_n71_ | (~new_n70_ & x20);
  assign new_n69_ = x04 & x05 & ~x07;
  assign new_n70_ = x17 & x18 & x19;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | ~new_n73_ | (~x15 & (new_n69_ | x07));
  assign new_n73_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x08 : (new_n76_ | x07 | new_n75_ | new_n69_);
  assign new_n75_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign new_n76_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | ~new_n78_ | (~x15 & (new_n69_ | x07));
  assign new_n78_ = (~x23 | (new_n70_ & ~x20 & ~x21 & ~x22)) & (~new_n70_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | new_n80_ | new_n81_ | (~x15 & (new_n69_ | x07));
  assign new_n80_ = x24 & (~new_n70_ | x20 | x21 | x22 | x23);
  assign new_n81_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x08 : (~new_n83_ | x07 | (~new_n81_ & x25));
  assign new_n83_ = ~new_n69_ & (~new_n71_ | ~new_n84_);
