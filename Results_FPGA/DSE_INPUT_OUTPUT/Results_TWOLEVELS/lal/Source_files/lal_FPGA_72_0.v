...
module FAU ( 
  ...
  assign new_n83_ = x17 & (new_n76_ | (x19 & ~x21 & x13 & x18));
  ...
  assign new_n93_ = (~x17 | (~new_n89_ & (~x15 | x25))) & (~x15 | (~x18 & ~x19) | x25);
  ...
  assign new_n102_ = (~new_n64_ | x21 | x22 | x23 | x24) & (~x15 | ((x22 | x23) & x24));
