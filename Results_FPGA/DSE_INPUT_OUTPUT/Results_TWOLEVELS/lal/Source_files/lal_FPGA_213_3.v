...
module FAU ( 
  ...
  assign z13 = x07 | new_n74_ | new_n66_ | (~new_n75_ & x20);
  assign new_n74_ = ~x07 & (new_n52_ | x15);
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = new_n74_ | (~new_n77_ & ~x15);
  assign new_n77_ = (~x21 | (x19 & ~x20 & x17 & x18)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | new_n74_ | ~new_n79_;
  assign new_n79_ = (~x22 | (x17 & x18 & x19 & ~x20 & ~x21)) & (~x17 | ~x18 | ~x19 | x20 | x21 | x22);
  assign z16 = new_n74_ | (~new_n81_ & ~x15);
  assign new_n81_ = (~x23 | (new_n75_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n75_ | x20 | x21 | x22 | x23);
  ...
  assign z18 = x07 | new_n74_ | ~new_n87_;
  assign new_n87_ = (~x25 | (new_n66_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n66_ | x21 | x22 | x23 | x24 | x25);
endmodule
