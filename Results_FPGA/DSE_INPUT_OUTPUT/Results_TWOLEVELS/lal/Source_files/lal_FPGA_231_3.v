...
module FAU ( 
  ...
  assign z14 = x07 | (~new_n71_ & ~x07) | new_n72_ | (~new_n69_ & x21);
  assign new_n71_ = ~x15 & (~x04 | ~x05 | x15);
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n71_ & ~x07) | (~new_n74_ & ~x15);
  assign new_n74_ = (new_n72_ | ~x22) & ~x07 & (~new_n68_ | x20 | x21 | x22);
  assign z16 = x07 | ~new_n76_ | (~new_n71_ & ~x07);
  assign new_n76_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = (~new_n71_ & ~x07) | (~x15 & (new_n78_ | new_n79_ | x07));
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x07 | ~new_n81_ | (~new_n71_ & ~x07);
