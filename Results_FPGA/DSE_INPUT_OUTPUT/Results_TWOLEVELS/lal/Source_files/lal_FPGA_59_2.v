...
module FAU ( 
  ...
  assign z09 = ~x15 & ~x11 & ~x07 & x04 & x05;
  assign z10 = ~x07 & ~x11 & ~x15 & ~x17 & (~x04 | ~x05);
  assign z11 = ~new_n65_ & ~x15;
  assign new_n65_ = ~x11 & (x07 | (x04 & x05) | (x17 ^ ~x18));
  assign z12 = ~x15 & (new_n67_ | x11);
  ...
  assign z14 = new_n74_ | (~new_n72_ & x21) | x15 | new_n75_ | (x11 & ~x15);
  assign new_n74_ = ~x11 & (new_n71_ | x07);
  assign new_n75_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n74_ | (~new_n75_ & x22) | x15 | new_n77_ | (x11 & ~x15);
  assign new_n77_ = new_n70_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~x11 & (~new_n79_ | x07 | (~new_n77_ & x23)));
  assign new_n79_ = ~new_n71_ & (~new_n70_ | x22 | x23 | x20 | x21);
  assign z17 = new_n74_ | new_n81_ | x15 | new_n82_ | (x11 & ~x15);
