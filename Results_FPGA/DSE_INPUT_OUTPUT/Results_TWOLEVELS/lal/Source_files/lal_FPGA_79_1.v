...
module FAU ( 
  ...
  assign z14 = z09 | ~new_n71_;
  assign new_n71_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x07 | (~x15 & (new_n75_ | new_n73_ | new_n51_));
  assign new_n73_ = new_n68_ & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x07 | (~x15 & (new_n77_ | new_n51_ | (~new_n73_ & x23)));
  assign new_n77_ = new_n68_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x07 | (~x15 & (~new_n79_ | (~new_n77_ & x24)));
  assign new_n79_ = ~new_n51_ & (~new_n69_ | ~new_n74_ | x23 | x24);
