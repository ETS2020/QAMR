...
module FAU ( 
  ...
  assign z01 = z03 | new_n51_ | x07 | (~x13 & ~x15);
  assign z03 = ~x25 & (x13 | x15) & (~x24 | (~new_n50_ & ~x23));
  assign new_n50_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign new_n51_ = x04 & x05;
  assign z02 = x16 & (x13 | x15);
  assign z04 = ~x08 & ~new_n54_ & (x13 | x15);
  ...
  assign z08 = (x24 & (new_n60_ | x23)) | (~x13 & ~x15) | x25;
  assign new_n60_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & (~x13 | (new_n51_ & ~x07 & x13));
  assign z10 = ~x07 & x13 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = ~x07 & x13 & ~x15 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x15 & (new_n65_ | ~x13);
  assign new_n65_ = ~x07 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = z09 | (~new_n67_ & x20) | x07 | new_n68_ | x15;
  assign new_n67_ = x17 & x18 & x19;
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z14 = z09 | ~new_n70_ | x07 | (~new_n68_ & x21);
  assign new_n70_ = ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (x13 & (new_n73_ | x07 | new_n72_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n72_ = new_n67_ & ~x20 & ~x21 & ~x22;
  assign new_n73_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (x13 & (new_n75_ | x07 | new_n76_ | (new_n51_ & ~x07 & ~x15)));
  assign new_n75_ = x23 & (~new_n67_ | x20 | x21 | x22);
  ...
  assign z18 = x15 | (x13 & ((~new_n78_ & x25) | ~new_n80_ | x07));
  assign new_n80_ = (~new_n68_ | ~new_n81_) & (~new_n51_ | x07 | x15);
