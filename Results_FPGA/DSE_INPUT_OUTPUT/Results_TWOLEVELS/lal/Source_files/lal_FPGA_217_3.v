...
module FAU ( 
  ...
  assign new_n52_ = x04 & x05 & (~x12 | (~x07 & ~x15));
  ...
  assign z10 = ~x07 & ~x15 & ~new_n70_ & ~x17;
  assign z11 = (x12 & x15) | (~x07 & ~x15 & ~new_n70_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n70_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? ~x12 : ~new_n75_;
  assign new_n75_ = (new_n76_ | ~x20) & ~x07 & ~new_n66_ & ~new_n77_;
  assign new_n76_ = x17 & x18 & x19;
  assign new_n77_ = x04 & x05 & ~x07;
  assign z14 = x15 ? ~x12 : ((~new_n66_ & x21) | ~new_n79_ | x07);
  assign new_n79_ = ~new_n77_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? ~x12 : (new_n82_ | x07 | new_n81_ | new_n77_);
  assign new_n81_ = new_n76_ & ~x20 & ~x21 & ~x22;
  assign new_n82_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 ? ~x12 : (~new_n84_ | x07 | (~new_n81_ & x23));
  assign new_n84_ = ~new_n77_ & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x15 & (new_n77_ | x07)) | new_n87_ | (~new_n86_ & x24);
  assign new_n86_ = new_n76_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n87_ = x17 & x18 & new_n88_ & x19;
  assign new_n88_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | ~new_n90_ | (~x15 & (new_n77_ | x07));
