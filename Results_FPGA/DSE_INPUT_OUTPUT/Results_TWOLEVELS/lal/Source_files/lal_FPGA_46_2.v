...
module FAU ( 
  ...
  assign z14 = ~new_n71_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n71_ = (~x21 | (x17 & x18 & x19 & ~x20)) & ~x15 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x07 & (new_n75_ | new_n73_ | new_n68_));
  assign new_n73_ = new_n67_ & new_n74_ & ~x20;
  assign new_n74_ = ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (~x07 & (new_n77_ | new_n68_ | (~new_n73_ & x23)));
  assign new_n77_ = new_n67_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 | (~x07 & (~new_n79_ | (~new_n77_ & x24)));
  assign new_n79_ = ~new_n68_ & (~new_n69_ | ~new_n74_ | x23 | x24);
  assign z18 = ~new_n81_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  assign new_n81_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & ~x15 & (~new_n69_ | ~new_n74_ | x23 | x24 | x25);
endmodule
