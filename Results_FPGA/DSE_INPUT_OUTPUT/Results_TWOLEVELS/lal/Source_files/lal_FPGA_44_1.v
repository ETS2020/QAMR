...
module FAU ( 
  ...
  assign z13 = x07 | (~x15 & (new_n53_ | new_n66_ | (~new_n75_ & x20)));
  assign new_n75_ = x17 & x18 & x19;
  assign z14 = x07 | (~x15 & (new_n53_ | new_n77_ | (~new_n66_ & x21)));
  assign new_n77_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 | (~x15 & (new_n79_ | new_n53_ | (~new_n77_ & x22)));
  ...
  assign z17 = z09 | (x17 & new_n85_ & x18) | new_n84_ | x07;
  assign new_n84_ = x24 & (~new_n75_ | x20 | x21 | x22 | x23);
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n87_ | z09;
  assign new_n87_ = (~x25 | (new_n66_ & new_n80_ & ~x23 & ~x24)) & ~x07 & (~new_n66_ | ~new_n80_ | x23 | x24 | x25);
endmodule
