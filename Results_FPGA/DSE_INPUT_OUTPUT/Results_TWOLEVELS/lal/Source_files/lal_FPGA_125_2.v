...
module FAU ( 
  ...
  assign z04 = (~new_n56_ & ~x08) | (x11 & (~x15 | (~x02 & ~x08)));
  ...
  assign z09 = ~x15 & (x11 | (~x07 & ~x11 & x04 & x05));
  ...
  assign new_n83_ = x17 & ~x20 & (new_n64_ | new_n84_);
  ...
  assign new_n105_ = ~x21 & ~x22 & ~x24 & ~x11 & x18 & x19;
