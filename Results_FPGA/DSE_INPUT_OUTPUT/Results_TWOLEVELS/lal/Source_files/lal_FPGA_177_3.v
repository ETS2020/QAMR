...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n61_, new_n62_,
    ...
    new_n70_, new_n76_, new_n78_, new_n79_, new_n81_, new_n83_, new_n85_,
    new_n86_, new_n87_, new_n88_, new_n90_;
  assign z00 = ~z02 & x08;
  assign z02 = x16 | (x07 & x15);
  assign z01 = x07 ? ~x15 : (new_n50_ | new_n52_);
  ...
  assign z09 = (x07 & x15) | (new_n52_ & ~x07 & ~x15);
  assign z10 = ~x07 & ~x15 & ~new_n52_ & ~x17;
  assign z11 = x07 ? x15 : (~x15 & ~new_n52_ & (x17 ^ x18));
  assign z12 = x07 ? x15 : (~x15 & ~new_n52_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19)));
  assign z13 = (~x07 & (new_n52_ | x15)) | (~x15 & ((~new_n76_ & x20) | new_n65_ | x07));
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = x07 | new_n78_ | new_n79_ | (~new_n65_ & x21);
  assign new_n78_ = ~x07 & (new_n52_ | x15);
  assign new_n79_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n78_ | ~new_n81_ | x07;
  assign new_n81_ = (new_n79_ | ~x22) & (~new_n76_ | x20 | x21 | x22);
  assign z16 = new_n78_ | ~new_n83_ | x07;
  assign new_n83_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | new_n78_ | new_n87_ | new_n88_ | (~new_n85_ & x24);
  assign new_n85_ = new_n76_ & new_n86_ & ~x20;
  assign new_n86_ = ~x21 & ~x22;
  assign new_n87_ = ~x15 & ((x23 & x24) | (new_n65_ & new_n86_ & ~x23 & ~x24 & x25));
  assign new_n88_ = new_n65_ & new_n86_ & ~x23 & ~x24 & ~x25;
  assign z18 = x07 | new_n78_ | new_n88_ | (~x15 & ~new_n90_ & x25);
  assign new_n90_ = new_n65_ & new_n66_;
endmodule
