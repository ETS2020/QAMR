...
module FAU ( 
  ...
  assign z15 = (~x15 & (x22 | (new_n70_ & ~x07 & ~x22))) | x15 | (~x22 & (new_n82_ | x07));
  assign z16 = new_n85_ | ~new_n86_ | x15 | (~new_n82_ & x23);
  assign new_n85_ = ~x15 & (x22 | (new_n70_ & ~x07 & ~x22));
  assign new_n86_ = (~x07 | x22) & (~new_n77_ | x20 | x21 | x23);
  assign z17 = new_n85_ | new_n88_ | x15 | (~new_n82_ & x24);
  assign new_n88_ = ~x22 & ((new_n89_ & x17) | x07 | (x23 & x24));
  assign new_n89_ = x18 & x19 & ~x20 & ~x21 & ~x23 & ~x24;
