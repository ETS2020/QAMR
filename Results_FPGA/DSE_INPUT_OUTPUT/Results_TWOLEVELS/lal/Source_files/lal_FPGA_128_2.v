...
module FAU ( 
  ...
  assign z14 = ~new_n79_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  ...
  assign z16 = ~new_n84_ | (~x15 & (x07 | (x04 & x05 & ~x07)));
  ...
  assign z18 = (~x15 & (x07 | (x04 & x05 & ~x07))) | x15 | (~new_n90_ & ~x07);
  assign new_n90_ = (~x25 | (new_n64_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n64_ | x21 | x22 | x23 | x24 | x25);
endmodule
