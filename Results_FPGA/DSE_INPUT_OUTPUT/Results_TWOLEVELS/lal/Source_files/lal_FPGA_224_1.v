...
module FAU ( 
  ...
  assign z01 = new_n49_ | (x04 & x05) | x07 | (~x05 & x15);
  ...
  assign new_n66_ = x05 & (x25 | (x24 & (new_n67_ | x23)));
  ...
  assign z12 = (~x05 & x15) | (~x07 & ~new_n74_ & (~x05 | (~x04 & ~x15)));
  assign new_n74_ = (~x17 | ~x18 | x19) & (~x19 | (x17 & x18));
  assign z13 = (x05 & (x15 | (x04 & ~x07 & ~x15))) | new_n76_ | (~x05 & x15) | new_n64_ | (x07 & ~x15);
  assign new_n76_ = ~new_n77_ & x20;
  assign new_n77_ = x17 & x18 & x19;
  assign z14 = (x05 & (x15 | (x04 & ~x07 & ~x15))) | new_n79_ | (~x05 & x15) | new_n80_ | (x07 & ~x15);
  assign new_n79_ = ~new_n64_ & x21;
  assign new_n80_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (x05 & (x15 | (x04 & ~x07 & ~x15))) | new_n82_ | (~x05 & x15) | new_n83_ | (x07 & ~x15);
  assign new_n82_ = ~new_n80_ & x22;
  assign new_n83_ = new_n77_ & new_n84_ & ~x20;
  assign new_n84_ = ~x21 & ~x22;
  assign z16 = (x05 & (x15 | (x04 & ~x07 & ~x15))) | (~new_n86_ & ~x15);
  assign new_n86_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = (x05 & (x15 | (x04 & ~x07 & ~x15))) | (~x15 & (new_n88_ | new_n90_ | x07));
  assign new_n88_ = x17 & new_n89_ & x18;
  assign new_n89_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n90_ = x24 & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z18 = (x05 & (x15 | (x04 & ~x07 & ~x15))) | (~new_n92_ & ~x15);
  assign new_n92_ = (~x25 | (new_n64_ & new_n84_ & ~x23 & ~x24)) & ~x07 & (~new_n64_ | ~new_n84_ | x23 | x24 | x25);
endmodule
