...
module FAU ( 
  ...
  assign z08 = (~new_n68_ & x15) | (x10 & (~new_n62_ | (~new_n67_ & ~x17)));
  ...
  assign new_n81_ = x15 & ~x23 & (x18 | x19) & ~x25;
  ...
  assign new_n87_ = (~x15 | ~x22 | new_n51_ | ~x24) & (new_n65_ | ~x10);
  ...
  assign new_n97_ = x20 & (x23 | (x22 & x24 & x15 & x21));
