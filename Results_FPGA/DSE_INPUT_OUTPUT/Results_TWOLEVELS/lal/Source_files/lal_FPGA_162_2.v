...
module FAU ( 
  ...
  assign z13 = (~new_n67_ & ~x15) | (~new_n68_ & x20) | new_n69_ | x15;
  assign new_n67_ = ~x07 & (~x04 | ~x05 | x07);
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~x07 & (new_n71_ | new_n72_ | (~new_n69_ & x21)));
  assign new_n71_ = x04 & x05 & ~x15;
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 | (~x07 & (new_n74_ | new_n71_ | (~new_n72_ & x22)));
  assign new_n74_ = new_n68_ & new_n75_ & ~x20;
  assign new_n75_ = ~x21 & ~x22;
  assign z16 = ~new_n77_ | (~new_n67_ & ~x15);
  assign new_n77_ = (~x23 | (new_n68_ & ~x20 & ~x21 & ~x22)) & ~x15 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x07 & (new_n79_ | new_n80_ | new_n71_));
  assign new_n79_ = x24 & (~new_n68_ | x22 | x23 | x20 | x21);
  assign new_n80_ = new_n69_ & new_n75_ & ~x23 & ~x24;
  assign z18 = ~new_n82_ | (~new_n67_ & ~x15);
  assign new_n82_ = (~x25 | (new_n69_ & new_n75_ & ~x23 & ~x24)) & ~x15 & (~new_n69_ | ~new_n75_ | x23 | x24 | x25);
endmodule
