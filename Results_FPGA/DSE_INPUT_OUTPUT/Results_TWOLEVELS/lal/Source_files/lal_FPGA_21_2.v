...
module FAU ( 
  ...
  assign z12 = (x15 & ~x24) | (~x07 & new_n71_ & ~x15);
  assign new_n71_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 ? x24 : ~new_n73_;
  assign new_n73_ = (new_n74_ | ~x20) & ~x07 & ~new_n63_ & ~new_n75_;
  assign new_n74_ = x17 & x18 & x19;
  assign new_n75_ = x04 & x05 & ~x07;
  assign z14 = x15 ? x24 : (~new_n77_ | x07 | (~new_n63_ & x21));
  assign new_n77_ = ~new_n75_ & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 ? x24 : (new_n80_ | x07 | new_n79_ | new_n75_);
  assign new_n79_ = new_n74_ & ~x20 & ~x21 & ~x22;
  assign new_n80_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | ~new_n82_ | (~x15 & (new_n75_ | x07));
  assign new_n82_ = (~x23 | (new_n74_ & ~x20 & ~x21 & ~x22)) & (~new_n74_ | x22 | x23 | x20 | x21);
  assign z17 = (~new_n84_ & ~x15) | (x24 & (~new_n86_ | ~new_n62_ | x15 | ~x17));
  assign new_n84_ = ~new_n75_ & ~x07 & (~x17 | ~new_n85_ | ~x18);
  assign new_n85_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z18 = (x24 & (x15 | x25)) | (~x15 & ((~new_n88_ & x25) | ~new_n89_ | x07));
  assign new_n88_ = new_n74_ & new_n86_;
  assign new_n89_ = ~new_n75_ & (~new_n63_ | ~new_n90_);
