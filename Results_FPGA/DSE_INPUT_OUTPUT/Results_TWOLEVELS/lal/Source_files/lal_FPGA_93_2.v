...
module FAU ( 
  ...
  assign new_n82_ = new_n77_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 | (~new_n84_ & ~x07);
  assign new_n84_ = (~x23 | (new_n77_ & ~x20 & ~x21 & ~x22)) & ~new_n79_ & (~new_n77_ | x20 | x21 | x22 | x23);
  assign z17 = new_n76_ | (~new_n86_ & ~x07) | ~new_n87_ | (~new_n82_ & x24);
  ...
  assign z18 = new_n76_ | ~new_n87_ | (~x07 & x25 & (~new_n64_ | ~new_n65_));
endmodule
