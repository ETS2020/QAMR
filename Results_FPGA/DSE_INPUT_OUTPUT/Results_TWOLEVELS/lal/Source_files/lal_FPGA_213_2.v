...
module FAU ( 
  ...
  assign new_n72_ = ~x07 & ((x04 & x05) | (((x17 & x18) | ~x19) & (~x17 | ~x18 | x19)));
  assign z13 = new_n74_ | (x20 & (~x17 | ~x18 | ~x19)) | x15 | (x17 & x18 & x19 & ~x20);
  assign new_n74_ = ~x15 & (x07 | (x04 & x05 & ~x07));
  assign z14 = x15 | (~x07 & (new_n76_ | new_n77_ | (~new_n65_ & x21)));
  assign new_n76_ = x04 & x05 & ~x15;
  assign new_n77_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n74_ | (~new_n77_ & x22) | new_n79_ | x15;
  assign new_n79_ = x17 & x18 & x19 & new_n80_ & ~x20;
  assign new_n80_ = ~x21 & ~x22;
  assign z16 = x15 | (~x07 & (new_n82_ | new_n76_ | (~new_n79_ & x23)));
  assign new_n82_ = new_n83_ & x17 & x18 & x19;
  assign new_n83_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = new_n74_ | new_n85_ | x15 | (~new_n82_ & x24);
  assign new_n85_ = x17 & x18 & new_n86_ & x19;
  assign new_n86_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = ~new_n88_ | new_n74_;
  assign new_n88_ = (~x25 | (new_n65_ & new_n80_ & ~x23 & ~x24)) & ~x15 & (~new_n65_ | ~new_n80_ | x23 | x24 | x25);
endmodule
