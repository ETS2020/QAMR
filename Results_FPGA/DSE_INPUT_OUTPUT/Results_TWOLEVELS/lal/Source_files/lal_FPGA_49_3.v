...
module FAU ( 
  ...
  assign z01 = x07 | (~x07 & (new_n52_ | (~new_n50_ & ~x25)));
  ...
  assign z13 = x07 | (~x07 & (new_n52_ | x15)) | new_n65_ | (~new_n76_ & x20);
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = x07 | (~x07 & (new_n52_ | x15)) | new_n78_ | (~new_n65_ & x21);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x07 | ~new_n80_ | (~x07 & (new_n52_ | x15));
  assign new_n80_ = (new_n78_ | ~x22) & (~new_n76_ | x20 | x21 | x22);
  assign z16 = (~new_n82_ & ~x15) | (~x07 & (new_n52_ | x15));
  assign new_n82_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & ~x07 & (~new_n76_ | x20 | x21 | x22 | x23);
  assign z17 = x07 | new_n86_ | (~x07 & (~new_n87_ | new_n52_)) | (~new_n84_ & x24);
  ...
  assign z18 = ((new_n89_ | x07) & ~x15) | (~x07 & (new_n90_ | new_n52_ | x15));
