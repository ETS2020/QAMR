...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n61_, new_n62_,
    ...
    new_n70_, new_n76_, new_n78_, new_n80_, new_n81_, new_n82_, new_n84_,
  ...
  assign new_n67_ = ~x13 & (x25 | (x24 & (new_n68_ | x23)));
  ...
  assign z10 = (x13 & x15) | (~x07 & ~x15 & ~new_n52_ & ~x17);
  assign z11 = (x13 & x15) | (~x07 & ~x15 & ~new_n52_ & (x17 ^ x18));
  assign z12 = ~x07 & ~x15 & ~new_n52_ & (((~x17 | ~x18) & x19) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n76_ & x20) | x07 | new_n65_ | (new_n52_ & ~x07 & ~x15);
  assign new_n76_ = x17 & x18 & x19;
  assign z14 = x15 | (~new_n65_ & x21) | x07 | new_n78_ | (new_n52_ & ~x07 & ~x15);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 ? ~x13 : (new_n80_ | x07 | new_n81_ | new_n82_);
  assign new_n80_ = ~new_n78_ & x22;
  assign new_n81_ = new_n76_ & ~x20 & ~x21 & ~x22;
  assign new_n82_ = x04 & x05 & ~x07;
  assign z16 = x15 ? ~x13 : (~new_n84_ | x07 | (~new_n81_ & x23));
  assign new_n84_ = ~new_n82_ & (~new_n76_ | ~new_n85_);
  assign new_n85_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = x15 ? ~x13 : (~new_n87_ | (x17 & new_n88_ & x18));
  assign new_n87_ = (~x24 | (new_n76_ & new_n85_)) & ~new_n82_ & ~x07;
  assign new_n88_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? ~x13 : (~new_n91_ | x07 | (~new_n90_ & x25));
  assign new_n90_ = new_n65_ & new_n66_;
  assign new_n91_ = ~new_n82_ & (~new_n65_ | ~new_n92_);
