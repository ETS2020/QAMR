...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n61_ | x23)) | x25 | (x15 & ~x16);
  ...
  assign z14 = x15 | (~new_n71_ & x21) | x07 | new_n73_ | (new_n51_ & ~x07 & ~x15);
  assign new_n73_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = x15 ? x16 : (new_n75_ | x07 | new_n76_ | new_n70_);
  assign new_n75_ = ~new_n73_ & x22;
  assign new_n76_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign z16 = x15 ? x16 : (~new_n78_ | x07 | (~new_n76_ & x23));
  assign new_n78_ = ~new_n70_ & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | new_n80_ | x07 | new_n81_ | (new_n51_ & ~x07 & ~x15);
  assign new_n80_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n81_ = new_n71_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? x16 : (~new_n83_ | x07 | (~new_n81_ & x25));
