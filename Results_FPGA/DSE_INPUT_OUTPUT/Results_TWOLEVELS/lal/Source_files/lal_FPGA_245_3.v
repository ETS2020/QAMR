...
module FAU ( 
  ...
  assign z13 = x15 ? ~x22 : ~new_n75_;
  assign new_n75_ = (new_n76_ | ~x20) & ~x07 & ~new_n77_ & ~new_n78_;
  assign new_n76_ = x17 & x18 & x19;
  assign new_n77_ = x04 & x05 & ~x07;
  assign new_n78_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 ? ~x22 : ~new_n80_;
  assign new_n80_ = (~x21 | (new_n81_ & x19 & ~x20)) & ~x07 & ~new_n77_ & (~new_n81_ | ~x19 | x20 | x21);
  assign new_n81_ = x17 & x18;
  assign z15 = x15 | ~new_n83_ | (~x15 & (new_n77_ | x07));
  ...
  assign z17 = x15 | ~new_n87_ | (~x15 & (new_n77_ | x07));
  assign new_n87_ = (x22 | ((~new_n89_ | ~x17) & (~x23 | ~x24))) & (new_n88_ | ~x24);
  assign new_n88_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign new_n89_ = x18 & x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign z18 = new_n91_ | (~x22 & (~new_n92_ | (x25 & (~new_n76_ | ~new_n65_))));
  assign new_n91_ = ~x15 & (x07 | new_n77_ | (x22 & x25));
  assign new_n92_ = ~x15 & (~new_n78_ | x21 | x23 | x24 | x25);
endmodule
