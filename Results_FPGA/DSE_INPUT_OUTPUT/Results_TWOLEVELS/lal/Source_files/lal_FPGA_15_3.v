...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n58_,
    ...
    new_n71_, new_n76_, new_n77_, new_n78_, new_n80_, new_n82_, new_n84_,
  ...
  assign z08 = (~new_n64_ & ~x17) | ~new_n68_ | (~new_n66_ & x18);
  assign new_n64_ = ~x25 & (~new_n65_ | x18 | x19);
  assign new_n65_ = x21 & x22 & x24;
  assign new_n66_ = ~x15 & (~new_n67_ | x22 | x23 | x24 | ~x25);
  assign new_n67_ = x17 & x19 & ~x20 & ~x21;
  assign new_n68_ = (~x20 | (~new_n65_ & ~x25)) & (~x23 | (~x24 & ~x25)) & (new_n69_ | ~x25);
  assign new_n69_ = x18 & x19 & ~x21 & ~x22 & ~x24;
  assign z09 = ~x15 & new_n71_ & ~x07;
  assign new_n71_ = x04 & x05;
  assign z10 = ~x07 & ~x15 & ~new_n71_ & ~x17;
  assign z11 = (x15 & x18) | (~x07 & ~new_n71_ & ((~x17 & x18) | (~x15 & x17 & ~x18)));
  assign z12 = (x15 & x18) | (~x07 & ~new_n71_ & ((x18 & (x17 ^ x19)) | (~x15 & ~x18 & x19)));
  assign z13 = (~x18 & (x15 | x20)) | (~x15 & (~new_n76_ | (x20 & (~x17 | ~x19))));
  assign new_n76_ = ~x07 & ~new_n77_ & ~new_n78_;
  assign new_n77_ = x04 & x05 & ~x07;
  assign new_n78_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | ~new_n80_ | (~x15 & (new_n77_ | x07));
  ...
  assign z16 = new_n84_ | (~x18 & (x15 | x23));
  assign new_n84_ = ~x15 & (new_n86_ | x07 | new_n77_ | (new_n85_ & new_n87_));
  assign new_n85_ = x17 & x18 & x19;
  assign new_n86_ = x23 & (~x17 | ~x19 | x20 | x21 | x22);
  assign new_n87_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = x15 | (~x15 & (new_n77_ | x07)) | new_n90_ | (~new_n89_ & x24);
  assign new_n89_ = new_n85_ & new_n87_;
  assign new_n90_ = x17 & x18 & new_n91_ & x19;
  assign new_n91_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | ~new_n93_ | (~x15 & (new_n77_ | x07));
  assign new_n93_ = (~x25 | (new_n78_ & ~x21 & ~x22 & ~x23 & ~x24)) & (~new_n78_ | x21 | x22 | x23 | x24 | x25);
endmodule
