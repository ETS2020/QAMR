...
module FAU ( 
  ...
  assign new_n66_ = ~x15 & ((x04 & x05) | ((~x19 | (x17 & (x15 | x18))) & (~x17 | ~x18 | x19)));
  ...
  assign z17 = (~x07 & (x15 | (x04 & x05 & ~x15))) | new_n77_ | new_n78_ | x07;
  ...
  assign new_n81_ = (~x25 | (new_n69_ & new_n79_ & ~x23 & ~x24)) & ~new_n51_ & (~new_n69_ | ~new_n79_ | x23 | x24 | x25);
endmodule
