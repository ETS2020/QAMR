...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n192_, new_n193_, new_n196_, new_n199_, new_n200_, new_n201_,
    new_n202_, new_n204_, new_n205_, new_n206_, new_n207_;
  ...
  assign z05 = ~x07 & ~x32 & x33 & x34 & new_n113_ & ~x35;
  ...
  assign z07 = x33 & (~x34 | (x34 & (x07 | (~x07 & ~x32 & new_n123_ & ~x35))));
  ...
  assign z16 = ~x40 & x39 & x38 & new_n141_ & x37;
  assign new_n141_ = ~x36 & ~x35 & x34 & x33 & ~x07 & ~x32;
  ...
  assign z18 = x33 & (~x34 | (~x07 & ~x32 & x34 & ~new_n150_ & ~x35));
  ...
  assign z20 = ~x07 & new_n163_ & ~x32;
  assign new_n163_ = x33 & x34 & ~x35 & ~x36 & ~new_n164_ & ~x38;
  assign new_n164_ = x05 ? ((x00 | x37 | (x39 & x40)) & (~x37 | ~x39 | ~x40)) : (~x37 | ~x39 | new_n89_ | ~x40);
  assign z21 = ~x33 | (x33 & ~x34) | (~x07 & ~new_n166_ & ~x35);
  ...
  assign z23 = x33 & x34 & (x07 | (~x07 & ~x32 & ~new_n172_ & ~x35));
  ...
  assign z25 = ~x07 & ~x32 & x33 & x34 & new_n180_ & ~x35;
  assign new_n180_ = ~x38 & ((~x36 & (new_n103_ | new_n181_)) | (new_n95_ & x36 & ~x37));
  assign new_n181_ = x00 & ~x01 & new_n145_ & x02;
  assign z26 = x33 & (~x34 | (~x07 & ~x32 & x34 & ~new_n183_ & ~x35));
  ...
  assign z28 = x00 & ~x01 & new_n188_ & x02;
  assign new_n188_ = ~x03 & x04 & ~x07 & ~x32 & new_n189_ & x33;
  assign new_n189_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n83_ & ~x38;
  ...
  assign z31 = x33 & (~x34 | (x00 & new_n196_ & ~x01));
  assign new_n196_ = x02 & ~x03 & x04 & ~x07 & new_n189_ & ~x32;
  assign z32 = x33 & ~x34;
  assign z33 = x33 ? (x34 & (x07 | (~x07 & new_n199_ & ~x32))) : x32;
  assign new_n199_ = ~x35 & ~x36 & (x38 ? ~new_n202_ : (new_n200_ | new_n201_));
  assign new_n200_ = ~x01 & ~x02 & ~new_n161_ & ~x03;
  assign new_n201_ = x39 & x40 & (~x37 | (~x05 & ~new_n120_ & x37));
  assign new_n202_ = (x37 | x39 | x40) & (~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39));
  assign z34 = new_n204_ & x33;
  assign new_n204_ = x34 & (x07 | (~x07 & ~x32 & ~x35 & ~new_n205_ & ~x36));
  assign new_n205_ = (x38 | ((x37 | new_n83_ | new_n206_) & (~new_n83_ | ~x05 | ~x37))) & (~x37 | new_n207_ | ~x38);
  assign new_n206_ = (x00 | ~x05) & (x02 | x03 | ~x04 | ~x00 | x01);
  assign new_n207_ = (x39 | x40) & (~x06 | ~x39 | ~x40);
  assign z13 = z09;
  assign z15 = z09;
endmodule
