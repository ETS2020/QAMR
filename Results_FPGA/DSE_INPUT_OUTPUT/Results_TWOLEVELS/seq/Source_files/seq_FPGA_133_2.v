...
module FAU ( 
  ...
  assign new_n101_ = ~new_n109_ & (x07 | ~x36 | (x35 ? new_n104_ : new_n102_));
  ...
  assign new_n105_ = ~new_n108_ & (~x00 | (~new_n107_ & (new_n106_ | ~x02)));
  assign new_n106_ = (x01 | x03 | ~x04 | ~x38) & (x38 | x39 | x40);
  assign new_n107_ = ~x39 & ~x40 & ((~x01 & (~x38 | (~x04 & x38))) | (~x38 & (x03 | ~x04)));
  ...
  assign z05 = x33 & (~x36 | (~x07 & ~x32 & ~x34 & ~new_n120_ & x36));
  ...
  assign new_n126_ = (x37 | ((~x39 | (x38 & (~x38 | x40))) & (~new_n114_ | x38))) & (~x37 | x38 | ~x39 | x40);
  ...
  assign z13 = x33 & (~x36 | (x36 & (x07 | (new_n145_ & ~x07))));
  ...
  assign z21 = (~x07 & (new_n181_ | new_n185_)) | ~x33 | (x33 & ~x36);
  ...
  assign z23 = x33 & (~x36 | (x36 & (x07 | (new_n190_ & ~x07))));
  ...
  assign new_n203_ = x35 & x37 & (new_n108_ | new_n204_);
  ...
  assign z28 = ~x07 & ~x32 & new_n211_ & x33;
  assign new_n211_ = ~x34 & x36 & x38 & (new_n212_ | new_n213_);
  assign new_n212_ = new_n157_ & x35 & x37 & x00 & ~x01 & x02;
  assign new_n213_ = new_n163_ & new_n118_ & ~x37;
  assign z30 = new_n215_ & ~x40;
  assign new_n215_ = ~x39 & x38 & ~x37 & x36 & new_n216_ & ~x35;
  assign new_n216_ = ~x34 & x33 & ~x32 & x27 & ~x07 & x10;
  assign z31 = x33 & (~x36 | (~x07 & new_n211_ & ~x32));
