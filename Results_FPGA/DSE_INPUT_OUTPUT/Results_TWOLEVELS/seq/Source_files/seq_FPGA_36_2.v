...
module FAU ( 
  ...
  assign z12 = (x07 & ~x33) | (~x00 & x05 & new_n355_ & ~x07);
  assign new_n355_ = x08 & ~x32 & new_n356_ & x33;
  ...
  assign z18 = ~x07 & x33 & (new_n397_ | new_n425_);
  ...
  assign z20 = x07 ? ~x33 : (~x32 & x33 & (new_n439_ | (new_n455_ & ~x34)));
  ...
  assign z23 = x07 | (~x07 & ~x32 & x33 & (new_n521_ | (~new_n479_ & ~x34)));
  ...
  assign z25 = x07 ? ~x33 : (~x32 & x33 & (x36 ? ~new_n548_ : ~new_n545_));
  ...
  assign z30 = x07 ? ~x33 : (~x32 & x33 & (new_n572_ | (new_n582_ & ~x05)));
  ...
  assign z34 = x33 ? (x07 | (~x07 & ~x32 & (new_n640_ | (~new_n618_ & ~x34)))) : x07;
