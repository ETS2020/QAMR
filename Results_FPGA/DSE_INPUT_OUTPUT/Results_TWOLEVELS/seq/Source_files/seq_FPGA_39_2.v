// Benchmark "FAU" written by ABC on Tue Aug 25 14:54:30 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n592_, new_n593_, new_n595_, new_n597_, new_n598_, new_n599_,
  ...
  assign z18 = x07 ? ~x33 : (~new_n396_ & x33);
  ...
  assign z19 = x07 ? ~x33 : (~x32 & x33 & (x38 ? ~new_n435_ : ~new_n430_));
  ...
  assign z23 = x33 & (x07 | (~x07 & ~x32 & (new_n522_ | (~new_n481_ & ~x34))));
  ...
  assign new_n522_ = ~x35 & ((~new_n523_ & ~x36) | (new_n302_ & x34 & x36 & ~x37));
  assign new_n523_ = x38 ? new_n524_ : (x37 ? new_n527_ : (~new_n528_ & ~new_n531_));
  assign new_n524_ = ~new_n525_ & (~new_n526_ | ~new_n138_ | ~x15 | x31);
  assign new_n525_ = x34 & (x37 ? (~x39 | (x39 & ~x40)) : (new_n193_ | ~x39 | (~new_n123_ & x39)));
  assign new_n526_ = ~x05 & x11 & x12 & ~x14;
  assign new_n527_ = (~x05 | ~x39 | ~x40) & (~x34 | (x39 ? (x40 & (x05 | ~x40)) : new_n217_));
  assign new_n528_ = ~new_n87_ & (new_n460_ | (new_n529_ & new_n530_));
  ...
  assign new_n543_ = (new_n391_ | x34) & (~new_n302_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n548_ : ~new_n545_);
  assign new_n545_ = (x05 | new_n535_ | x34) & (x38 | (~new_n546_ & ~new_n540_));
  assign new_n546_ = ~x35 & (new_n377_ | (x34 & (new_n219_ | (new_n547_ & x00))));
  assign new_n547_ = ~x01 & x02 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n548_ = (~new_n302_ | ~x34 | x35 | x37) & (x34 | (~new_n550_ & (~x35 | new_n549_ | ~x37)));
  assign new_n549_ = (~new_n126_ | x38) & (~new_n529_ | x03 | ~x04 | ~x38);
  assign new_n550_ = new_n112_ & new_n157_ & x10 & x27 & ~x35;
  assign z26 = x07 ? ~x33 : (~x32 & x33 & (new_n552_ | (~new_n553_ & ~x35)));
  assign new_n552_ = x00 & ~x34 & x35 & new_n132_ & x36;
  assign new_n553_ = (new_n123_ | new_n554_) & (~new_n302_ | ~x34 | ~x36 | x37);
  assign new_n554_ = (new_n555_ | ~x38) & (~new_n122_ | ~x34 | x36);
  assign new_n555_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (x37 ^ ~x39));
  assign z27 = x07 ? ~x33 : (~x32 & x33 & (new_n566_ | (new_n557_ & ~x05)));
  ...
  assign new_n560_ = (x38 | new_n542_ | x39) & (x37 | ~x38 | new_n225_ | ~x39);
  assign new_n561_ = ~x09 & ~x17 & (new_n303_ | new_n122_);
  ...
  assign new_n571_ = new_n140_ & ~x34 & ~x35 & new_n111_ & x36 & ~x37;
  assign z29 = ~x07 & ~x32 & x33 & (new_n566_ | (new_n573_ & ~x05));
  assign new_n573_ = ~x36 & ((~new_n574_ & ~x34) | (x15 & new_n329_ & ~x21));
  ...
  assign new_n584_ = (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n178_ | ~x40))) & (x37 | ~x38 | ~x39 | x40);
  assign z31 = ~x07 & ~x32 & x33 & (new_n593_ | (~new_n586_ & ~x34));
  assign new_n586_ = (new_n587_ | ~x35) & (~new_n112_ | ~new_n157_ | ~new_n140_ | x35 | ~x36);
  ...
  assign new_n590_ = ~x21 & x22 & ~x23 & x24 & ~new_n178_ & x37;
  assign new_n591_ = x39 & (~x24 | (x21 & x22 & ~x23 & x24 & ~x40));
  assign new_n592_ = new_n373_ & x04 & x36 & new_n291_ & x00 & ~x01;
  assign new_n593_ = x00 & ~x01 & x02 & ~x03 & new_n570_ & x04;
  assign z32 = ~x40 & ~x39 & x38 & new_n595_ & x37;
  assign new_n595_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z33 = x07 ? x33 : (x32 ? ~x33 : (x33 & (x34 ? new_n611_ : ~new_n597_)));
  assign new_n597_ = x35 ? (x37 ? new_n606_ : new_n598_) : new_n603_;
  ...
  assign new_n600_ = ~new_n92_ & ((x38 & ~new_n601_ & x39) | (x21 & ~x38 & ~x39 & ~x40));
  assign new_n601_ = x21 ? (~x23 & ~x40) : (new_n181_ | ~x40);
  assign new_n602_ = ~x13 & ~new_n86_ & (new_n302_ | new_n303_);
  assign new_n603_ = (new_n605_ | ~x36) & (x05 | x31 | x36 | (new_n604_ & ~new_n325_));
  assign new_n604_ = ~new_n442_ & ~new_n445_ & ~new_n448_ & (~new_n303_ | ~x09 | ~x37);
  assign new_n605_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n140_ | x40))) & (~x39 | (x38 ? x40 : (new_n293_ | ~x40)))));
  ...
  assign new_n610_ = x22 & x24 & ~new_n92_ & (x21 | (~x21 & ~new_n178_ & x23));
  assign new_n611_ = ~x35 & ~new_n612_ & ~x36;
  assign new_n612_ = x38 ? ((x37 | x39 | x40) & (~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39))) : new_n613_;
  assign new_n613_ = ~new_n614_ & (x01 | x02 | new_n433_ | x03);
  assign new_n614_ = x39 & x40 & (~x37 | (~x05 & ~new_n317_ & x37));
  assign z34 = x33 & (x07 | (~x07 & ~x32 & (new_n639_ | (~new_n616_ & ~x34))));
  assign new_n616_ = ~new_n628_ & ~new_n617_ & (x36 | (~new_n638_ & (new_n635_ | x35)));
  assign new_n617_ = x39 & (~new_n623_ | (x38 & (new_n627_ | (~new_n618_ & ~x37))));
  assign new_n618_ = (x35 | (x36 ? new_n407_ : new_n619_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n619_ = ~new_n622_ & (~x15 | (~new_n621_ & (x05 | new_n620_ | x31)));
  assign new_n620_ = (~x16 | ~x17 | new_n158_ | ~x40) & (~x09 | (x40 ? (new_n158_ | (~x16 & ~x17)) : new_n102_));
  assign new_n621_ = x11 & x12 & x14 & ~new_n149_ & x40;
  ...
  assign new_n625_ = (~x09 | ~x13 | x15) & (new_n447_ | (~new_n92_ & x15));
  ...
  assign new_n629_ = x00 ? (~new_n630_ | x01) : (~x05 | (~new_n128_ & ~x35));
  assign new_n630_ = ~x02 & ~x03 & ((x04 & x35) | (new_n128_ & ~x04 & ~x35));
  assign new_n631_ = ~x35 & ~x36 & (x05 ? x38 : (~x31 & new_n632_ & ~x38));
  assign new_n632_ = ~x39 & ((x15 & ~new_n149_ & ~new_n158_) | new_n92_ | ~x15);
  assign new_n633_ = ~x39 & (x35 ? (new_n634_ | (x06 & x40)) : ~x40);
  assign new_n634_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n635_ = x05 ? (~new_n153_ & new_n636_ & (new_n87_ | ~x38)) : ~new_n637_;
  assign new_n636_ = new_n102_ & x14 & ~new_n207_ & x15;
  ...
  assign new_n640_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((x00 | ~x05) & (~new_n530_ | ~new_n124_ | ~x00)));
