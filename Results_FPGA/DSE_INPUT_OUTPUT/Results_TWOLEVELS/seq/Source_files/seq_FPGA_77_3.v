// Benchmark "FAU" written by ABC on Tue Aug 25 14:55:21 2020
...
module FAU ( 
  ...
  assign z03 = (x07 & (x32 | (~x32 & x33))) | (~x32 & x33 & (new_n234_ | (~x07 & (new_n195_ | new_n227_))));
  ...
  assign z08 = x07 ? (x32 | (~x32 & x33)) : (~x32 & x33 & ~x35 & ~new_n335_ & x40);
  ...
  assign z11 = x07 ? x32 : (~x32 & x33 & ~new_n352_ & ~x36);
  ...
  assign z17 = ~x32 & x33 & (x07 | (~new_n376_ & ~x07));
  ...
  assign z20 = x07 ? x32 : (~x32 & x33 & (new_n440_ | (new_n458_ & ~x34)));
  ...
  assign z21 = (~x33 & (~x32 | (~x07 & x32))) | (~x07 & (new_n463_ | (~new_n469_ & ~x35)));
  ...
  assign z23 = ~x32 & x33 & (x07 | (~x07 & (new_n525_ | (~new_n482_ & ~x34))));
  ...
  assign new_n524_ = ~new_n153_ & ~new_n207_ & x11 & x12 & x14 & x15;
  ...
  assign new_n530_ = (~x05 | ~x39 | ~x40) & (~x34 | (x39 ? (x40 & (x05 | ~x40)) : new_n217_));
  ...
  assign z25 = x07 ? x32 : (~x32 & x33 & (x36 ? ~new_n551_ : ~new_n548_));
  assign new_n548_ = (x38 | (~new_n549_ & ~new_n543_)) & (x05 | new_n538_ | x34);
  assign new_n549_ = ~x35 & (new_n378_ | (x34 & (new_n219_ | (new_n550_ & x00))));
  ...
  assign new_n563_ = (x38 | new_n545_ | x39) & (x37 | ~x38 | new_n225_ | ~x39);
  ...
  assign new_n569_ = new_n199_ & ~x34 & x35 & x36;
  ...
  assign z30 = x07 ? x32 : (~x32 & x33 & (new_n583_ | new_n574_));
  ...
  assign z33 = x07 ? (~x32 & x33) : (x32 ? ~x33 : (x33 & (x34 ? new_n614_ : ~new_n600_)));
