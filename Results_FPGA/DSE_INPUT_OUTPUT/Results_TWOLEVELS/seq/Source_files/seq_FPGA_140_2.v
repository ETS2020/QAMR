// Benchmark "FAU" written by ABC on Tue Aug 25 14:56:49 2020
...
module FAU ( 
  ...
  assign z17 = x07 | (~x07 & ~x32 & ~new_n373_ & x33);
  ...
  assign z22 = x07 ? ~x33 : (x33 & (new_n476_ | (~new_n470_ & ~x34)));
  ...
  assign z24 = x07 ? ~x33 : (~x32 & x33 & (x36 ? ~new_n544_ : ~new_n533_));
  assign new_n533_ = new_n534_ & (x38 | (~new_n541_ & (x35 | (~new_n375_ & ~new_n376_))));
  ...
  assign new_n539_ = new_n540_ & x35 & x37;
  assign new_n540_ = new_n168_ & x38;
  ...
  assign new_n544_ = (new_n392_ | x34) & (~x34 | x35 | x37 | ~new_n168_ | x38);
  assign z25 = x07 ? ~x33 : (~x32 & x33 & (x36 ? ~new_n549_ : ~new_n546_));
  assign new_n546_ = (x05 | new_n535_ | x34) & (x38 | (~new_n547_ & ~new_n541_));
  assign new_n547_ = ~x35 & (new_n375_ | (x34 & (new_n216_ | (new_n548_ & x00))));
  ...
  assign new_n552_ = (~new_n123_ | x38) & (~new_n524_ | x03 | ~x04 | ~x38);
  assign z26 = x07 ? ~x33 : (~x32 & ~new_n554_ & x33);
  assign new_n554_ = (x35 | (~new_n531_ & ~new_n555_)) & (~x00 | x34 | ~new_n557_ | ~x35);
  ...
  assign z27 = x07 ? ~x33 : (~x32 & x33 & (new_n568_ | (new_n559_ & ~x05)));
  ...
  assign new_n573_ = new_n133_ & ~x34 & ~x35 & new_n540_ & x36 & ~x37;
  ...
  assign new_n582_ = x15 & ~x36 & ~new_n92_ & (new_n583_ | new_n565_);
  ...
  assign new_n587_ = ~x34 & ((~new_n588_ & x35) | (new_n551_ & new_n133_ & ~x35 & x36));
  ...
  assign new_n594_ = ~x01 & x02 & ~x03 & new_n572_ & x04;
  assign z32 = (x07 & ~x33) | (new_n596_ & ~x07 & ~x32 & x33 & ~x34 & x35);
  assign new_n596_ = new_n540_ & ~x36 & x37;
  assign z33 = x07 | (x32 & ~x33) | (~x07 & ~x32 & ~new_n598_ & x33);
  ...
  assign new_n637_ = ~x31 & ~new_n84_ & (new_n551_ | (~x38 & x40));
