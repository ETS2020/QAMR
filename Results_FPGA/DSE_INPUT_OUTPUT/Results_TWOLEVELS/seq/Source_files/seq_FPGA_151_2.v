// Benchmark "FAU" written by ABC on Tue Aug 25 14:57:04 2020
...
module FAU ( 
  ...
  assign z02 = x33 ? (x07 | (~x07 & ~new_n173_ & ~x32)) : x23;
  ...
  assign z03 = x33 ? (x07 | (~x32 & (new_n237_ | (~new_n197_ & ~x07)))) : x23;
  ...
  assign z04 = (~x07 & ~x32 & ~new_n240_ & x33) | (x23 & ~x33);
  assign new_n240_ = x34 ? (new_n258_ | x35) : (x35 ? new_n241_ : new_n251_);
  ...
  assign new_n251_ = (new_n257_ | ~x36) & (x05 | x36 | (~new_n149_ & (new_n252_ | x31)));
  assign new_n252_ = x38 ? (new_n254_ | ~x40) : (~new_n253_ & (~new_n256_ | ~x15));
  assign new_n253_ = x39 & ((new_n188_ & x37) | (~x13 & new_n161_ & ~x37));
  assign new_n254_ = ~new_n255_ & (x28 | x29 | x30 | x39);
  assign new_n255_ = x15 & ~x37 & x39 & ~new_n148_ & ~new_n157_;
  assign new_n256_ = x37 & ~x39 & ~new_n148_ & ~new_n157_;
  assign new_n257_ = (~x39 | ((~x37 | (x38 ^ ~x40)) & (~new_n163_ | x37 | x38 | ~x40))) & (x37 | ~x38 | x39 | (~x40 & (new_n139_ | x40)));
  assign new_n258_ = (~x36 | x37 | ~new_n171_ | x38) & (x36 | ((~new_n171_ | x37 | ~x38) & (x38 | (~new_n260_ & (~new_n259_ | ~x37)))));
  assign new_n259_ = x39 & (~x40 | (~x05 & x13 & ~new_n97_ & x40));
  ...
  assign z07 = x33 ? (x07 | (~x07 & ~new_n327_ & ~x32)) : x23;
  ...
  assign z09 = x33 ? (x07 | (~x05 & new_n343_ & ~x07)) : x23;
  ...
  assign new_n346_ = x23 & x24 & x35 & x40 & ~new_n84_ & ~new_n178_;
  ...
  assign z11 = (x23 & ~x33) | (~x07 & ~x32 & x33 & ~new_n357_ & ~x36);
  assign new_n357_ = ~new_n338_ & (x05 | x34 | (~new_n362_ & (new_n358_ | ~x15)));
  assign new_n358_ = (x31 | x35 | ~new_n220_ | ~x37) & (~new_n359_ | x37);
  assign new_n359_ = x38 & x39 & ~new_n360_ & x40;
  assign new_n360_ = (x31 | ~new_n184_ | x35) & (x21 | ~new_n361_ | ~x22);
  assign new_n361_ = x24 & x35 & ~new_n84_ & ~new_n181_;
  ...
  assign z13 = x33 ? (x07 | (~x07 & ~x32 & new_n367_ & ~x34)) : x23;
  assign new_n367_ = x35 & ~x37 & ((~x38 & (x36 ? ~x39 : (x39 & x40))) | (~x36 & x38 & ~x39 & ~x40));
  assign z14 = x33 ? ~new_n369_ : x23;
  ...
  assign new_n374_ = (new_n375_ | x35) & (~new_n378_ | ~new_n306_ | ~x35 | ~x37);
  assign new_n375_ = (x37 | new_n377_ | x38) & (~x38 | ((~new_n376_ | ~x00) & (~new_n171_ | ~x37)));
  ...
  assign z17 = x33 ? (x07 | (~x07 & ~new_n382_ & ~x32)) : x23;
  assign new_n382_ = (x34 | new_n399_ | ~x36) & (x36 | (~new_n383_ & ~new_n391_ & ~new_n402_));
  ...
  assign new_n387_ = ~new_n388_ & (x05 | ~new_n205_ | ~x15);
  ...
  assign new_n396_ = x24 & (~x24 | (x22 & (~x22 | (x21 ? (x23 | x40) : (x40 & (new_n181_ | ~x40))))));
  assign new_n397_ = ~x09 & ~x17 & ~x31 & ~x35 & x39;
  assign new_n398_ = ~x09 & ~x16 & ~x31 & ~x35 & ~x37 & x39;
  assign new_n399_ = (new_n401_ | x40) & (~x00 | (~new_n130_ & (new_n400_ | ~x38)));
  assign new_n400_ = ~new_n134_ & (~new_n295_ | x01 | ~x04 | ~x35 | ~x37);
  assign new_n401_ = (~x35 | ~x37 | x38 | ~x39) & (~x10 | ~x27 | x35 | x37 | ~x38 | x39);
  assign new_n402_ = x34 & ~x35 & ~x37 & x38 & ~new_n88_ & x39;
  ...
  assign new_n407_ = ~new_n408_ & (x05 | x31 | ~new_n188_ | ~x39);
  ...
  assign new_n415_ = x40 & (~new_n89_ | ~x00 | x03 | x04 | ~x40);
  assign new_n416_ = (~new_n417_ | ~x11) & (x05 | x31 | new_n185_ | x39);
  ...
  assign new_n420_ = (x05 | ~x15 | ~new_n421_ | ~x21) & (~x36 | x40);
  assign new_n421_ = x22 & x24 & ~x36 & ~new_n84_ & (x23 | x40);
  ...
  assign new_n424_ = new_n170_ & x00 & x01 & new_n171_ & x04 & x35;
  assign new_n425_ = ~x11 & x40 & (~x12 | (x12 & x39));
  assign new_n426_ = (new_n427_ | x36) & (~new_n306_ | ~x36 | x37);
  assign new_n427_ = x38 ? (x37 ? (x39 & (~x39 | x40)) : (~new_n195_ & x39)) : new_n428_;
  ...
  assign new_n439_ = new_n171_ & x37;
  ...
  assign new_n451_ = x37 ? (x38 | x39 | new_n218_ | new_n157_) : (~x38 | new_n452_ | ~x39);
  assign new_n452_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n453_ = ~x37 & ((~new_n454_ & x39) | (x38 & ~x39 & ~new_n97_ & ~x40));
  assign new_n454_ = (x11 | new_n455_ | x12) & (x15 | (new_n455_ & (~x09 | (~x13 & (~new_n455_ | x13)))));
  assign new_n455_ = x38 & ~x40;
  assign new_n456_ = ~x38 & ~new_n97_ & (x40 | (x37 & ~x39));
  assign new_n457_ = (new_n93_ | ((x34 | ~x38) & (x00 | x37 | x38))) & (new_n458_ | x34) & (~new_n93_ | ~x37 | x38);
  assign new_n458_ = ~new_n152_ & new_n459_ & ~new_n218_ & new_n315_;
  ...
  assign new_n465_ = x36 & (new_n466_ | (new_n468_ & new_n380_ & x35));
  ...
  assign z21 = (~x23 & ~x33) | (~x07 & x33 & (new_n470_ | (~new_n476_ & ~x35)));
  ...
  assign new_n473_ = ~x00 & (x38 ? ~x05 : new_n171_);
  ...
  assign z22 = (x23 & ~x33) | (~x07 & x33 & (new_n486_ | (~new_n480_ & ~x34)));
  ...
  assign new_n483_ = x11 & x12 & x14 & x15 & ~new_n218_ & ~new_n460_;
  ...
  assign new_n541_ = (x38 | (~new_n384_ & ~new_n547_)) & ~new_n402_ & (new_n542_ | x34);
  assign new_n542_ = (new_n543_ | x05) & (~new_n121_ | ~x35 | ~x37);
  assign new_n543_ = (x31 | ~new_n122_ | x35) & (~x15 | new_n544_ | new_n84_);
  assign new_n544_ = ~new_n398_ & (~x38 | (~new_n397_ & (x37 | (~new_n394_ & ~new_n545_))));
  ...
  assign new_n550_ = (new_n399_ | x34) & (~new_n306_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n555_ : ~new_n552_);
  assign new_n552_ = (x05 | new_n543_ | x34) & (x38 | (~new_n547_ & ~new_n553_));
  assign new_n553_ = ~x35 & (new_n389_ | (x34 & (new_n204_ | (new_n554_ & x00))));
  assign new_n554_ = ~x01 & x02 & ~x03 & x04 & ~new_n93_ & ~x37;
  assign new_n555_ = (~new_n306_ | ~x34 | x35 | x37) & (x34 | (~new_n557_ & (~x35 | new_n556_ | ~x37)));
  assign new_n556_ = (~new_n126_ | x38) & (~new_n537_ | x03 | ~x04 | ~x38);
  assign new_n557_ = new_n171_ & new_n156_ & x10 & x27 & ~x35;
  assign z26 = (~x07 & ~x32 & ~new_n559_ & x33) | (x23 & ~x33);
  assign new_n559_ = (new_n560_ | x35) & (~x00 | x34 | ~x35 | ~new_n131_ | ~x36);
  assign new_n560_ = ~new_n561_ & (~new_n306_ | ~new_n563_ | ~x34);
  assign new_n561_ = ~new_n88_ & ((~new_n562_ & x38) | (new_n87_ & x34 & ~x36));
  assign new_n562_ = (x37 | ~x39 | ~x34 | x36) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n563_ = x36 & ~x37;
  assign z27 = (x23 & ~x33) | (~x07 & ~x32 & x33 & (new_n565_ | new_n574_));
  assign new_n565_ = ~x05 & ~x36 & (new_n572_ | (x15 & ~new_n566_ & ~new_n84_));
  assign new_n566_ = ~new_n570_ & (x34 | ((new_n567_ | ~x35) & (x31 | new_n568_ | x35)));
  assign new_n567_ = (x37 | ~x38 | new_n227_ | ~x39) & (x38 | new_n549_ | x39);
  assign new_n568_ = (new_n569_ | x16) & (x09 | x17 | (~new_n307_ & ~new_n87_));
  assign new_n569_ = (x17 | ((~x37 | x38 | x39) & (~x39 | ~x40 | x37 | ~x38))) & (x09 | ((x38 | ((~x37 | x39) & ~x40)) & (x37 | (~x39 & (~x38 | x40)))));
  ...
  assign new_n577_ = ~new_n578_ & (~new_n380_ | ~x36 | x34 | ~x35);
  assign new_n578_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n93_ & ~x38;
  assign new_n579_ = new_n121_ & new_n563_ & new_n139_ & ~x34 & ~x35;
  assign z29 = (x23 & ~x33) | (~x07 & ~x32 & x33 & (new_n581_ | new_n574_));
  assign new_n581_ = ~x05 & ~x36 & (new_n582_ | (x15 & new_n334_ & ~x21));
  ...
  assign new_n585_ = ~x31 & ~x35 & x37 & ~x38 & ~new_n123_ & x39;
  assign new_n586_ = x38 & ~x39 & ~new_n123_ & x40;
  assign z30 = ~x07 & ~x32 & x33 & (new_n588_ | new_n579_);
  assign new_n588_ = ~x05 & x15 & ~x36 & ~new_n589_ & ~new_n84_;
  assign new_n589_ = ~new_n570_ & (~x24 | x34 | new_n590_ | ~x35);
  assign new_n590_ = x22 ? new_n591_ : ((~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? ~x39 : (x39 | x40))));
  assign new_n591_ = (new_n592_ | x21) & (~new_n126_ | ~x38 | ~x21 | x23 | x37);
  assign new_n592_ = (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n178_ | ~x40))) & (~x39 | x40 | x37 | ~x38);
  assign z31 = ~x07 & ~x32 & x33 & (new_n601_ | (~new_n594_ & ~x34));
  assign new_n594_ = (new_n595_ | ~x35) & (~new_n171_ | ~new_n156_ | ~new_n139_ | x35 | ~x36);
  ...
  assign new_n600_ = new_n380_ & x04 & x36 & new_n295_ & x00 & ~x01;
  assign new_n601_ = x00 & ~x01 & x02 & ~x03 & new_n578_ & x04;
  assign z32 = (x23 & ~x33) | (new_n603_ & new_n121_ & ~x36 & x37);
  assign new_n603_ = ~x07 & ~x32 & x33 & ~x34 & x35;
  assign z33 = (~x23 & x32 & ~x33) | (x33 & (x07 | (~x07 & ~x32 & (new_n605_ | new_n619_))));
  ...
  assign new_n610_ = ~x13 & ~new_n97_ & (new_n306_ | new_n307_);
  assign new_n611_ = (new_n613_ | ~x36) & (x05 | x31 | x36 | (new_n612_ & ~new_n330_));
  assign new_n612_ = ~new_n450_ & ~new_n453_ & ~new_n456_ & (~new_n307_ | ~x09 | ~x37);
  assign new_n613_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n139_ | x40))) & (~x39 | (x38 ? x40 : (new_n297_ | ~x40)))));
  assign new_n614_ = (new_n615_ | ~x36) & (x05 | x36 | x38 | ~new_n617_ | x39);
  assign new_n615_ = (~new_n616_ | ~x00) & (x38 | ~x40 | (~x39 & (~x06 | x39)));
  assign new_n616_ = ~x02 & ~x03 & x04 & ((~x01 & x38) | (new_n171_ & x01 & ~x38));
  assign new_n617_ = x40 & ((new_n618_ & x15) | (~x13 & (new_n84_ | ~x15)));
  assign new_n618_ = x22 & x24 & ~new_n84_ & (x21 | (~x21 & ~new_n178_ & x23));
  ...
  assign new_n622_ = x39 & x40 & (~x37 | (~x05 & ~new_n322_ & x37));
  ...
  assign new_n626_ = (x35 | (x36 ? new_n415_ : new_n627_)) & (~x36 | ~x40 | ~x06 | ~x35);
  assign new_n627_ = ~new_n630_ & (~x15 | (~new_n629_ & (x05 | new_n628_ | x31)));
  assign new_n628_ = (~x16 | ~x17 | new_n157_ | ~x40) & (~x09 | (x40 ? (new_n157_ | (~x16 & ~x17)) : new_n315_));
  assign new_n629_ = x11 & x12 & x14 & ~new_n148_ & x40;
  ...
  assign new_n633_ = (~x09 | ~x13 | x15) & (new_n455_ | (~new_n84_ & x15));
  ...
  assign new_n640_ = ~x39 & ((x15 & ~new_n148_ & ~new_n157_) | new_n84_ | ~x15);
  assign new_n641_ = ~x39 & (x35 ? (new_n642_ | (x06 & x40)) : ~x40);
  assign new_n642_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n643_ = x05 ? (~new_n152_ & new_n644_ & (new_n93_ | ~x38)) : ~new_n645_;
  assign new_n644_ = new_n315_ & x14 & ~new_n218_ & x15;
  assign new_n645_ = ~x31 & ~new_n97_ & ((~x38 & x40) | (~x37 & x38 & ~x39 & ~x40));
  assign new_n646_ = ~x39 & ((x05 & ~x38 & (~x37 | (x35 & x40))) | (x38 & ~x40 & x35 & ~x37));
  assign new_n647_ = ~x35 & ~x36 & (new_n649_ | (~new_n648_ & ~x38));
  assign new_n648_ = (~new_n93_ | ~x05 | ~x37) & (x37 | new_n93_ | ((~new_n538_ | ~new_n89_ | ~x00) & (x00 | ~x05)));
