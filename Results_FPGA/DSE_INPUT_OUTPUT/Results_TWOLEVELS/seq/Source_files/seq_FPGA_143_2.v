...
module FAU ( 
  ...
  assign z04 = x07 ? ~x33 : (~x32 & x33 & (x34 ? new_n253_ : ~new_n236_));
  ...
  assign z18 = ~x07 & x33 & (new_n398_ | new_n426_);
  ...
  assign z23 = x07 | (~x07 & ~x32 & x33 & (new_n522_ | (~new_n480_ & ~x34)));
  ...
  assign new_n534_ = new_n535_ & (x38 | (~new_n542_ & (x35 | (~new_n376_ & ~new_n377_))));
  ...
  assign new_n541_ = new_n168_ & x38;
  ...
  assign new_n545_ = (new_n393_ | x34) & (~x34 | x35 | x37 | ~new_n168_ | x38);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n550_ : ~new_n547_);
  assign new_n547_ = (x05 | new_n536_ | x34) & (x38 | (~new_n548_ & ~new_n542_));
  assign new_n548_ = ~x35 & (new_n376_ | (x34 & (new_n216_ | (new_n549_ & x00))));
  assign new_n549_ = ~x01 & x02 & ~x03 & x04 & ~new_n85_ & ~x37;
  assign new_n550_ = (new_n551_ | x34) & (~x34 | x35 | x37 | ~new_n168_ | x38);
  assign new_n551_ = (~x35 | new_n553_ | ~x37) & (~new_n552_ | ~x10 | ~x27 | x35);
  assign new_n552_ = new_n168_ & new_n149_;
  assign new_n553_ = (~new_n123_ | x38) & (~new_n525_ | x03 | ~x04 | ~x38);
  assign z26 = x07 ? ~x33 : (~x32 & ~new_n555_ & x33);
  assign new_n555_ = (x35 | (~new_n532_ & ~new_n556_)) & (~x00 | x34 | ~new_n558_ | ~x35);
  assign new_n556_ = ~new_n121_ & ((new_n120_ & x34 & ~x36) | (~new_n557_ & x38));
  assign new_n557_ = (~x34 | x36 | x37 | ~x39) & (~x00 | x34 | ~x36 | ~x40 | (~x37 ^ x39));
  assign new_n558_ = x36 & x37 & ~x38 & ~x39 & ~new_n136_ & ~x40;
  ...
  assign new_n563_ = (x21 | (~new_n178_ & (~x22 | ~x24 | x40))) & x24 & (~x24 | (x22 & (~x21 | ~x22 | x23 | x40)));
  assign new_n564_ = (new_n565_ | x16) & (x09 | x17 | (~new_n312_ & ~new_n120_));
  ...
  assign new_n568_ = ~x31 & ~x34 & ~x35 & x38 & ~new_n145_ & x39;
  ...
  assign new_n572_ = ~new_n573_ & (~new_n372_ | ~x36 | x34 | ~x35);
  assign new_n573_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n85_ & ~x38;
  assign new_n574_ = new_n133_ & ~x34 & ~x35 & new_n541_ & x36 & ~x37;
  ...
  assign new_n588_ = ~x34 & ((~new_n589_ & x35) | (new_n552_ & new_n133_ & ~x35 & x36));
