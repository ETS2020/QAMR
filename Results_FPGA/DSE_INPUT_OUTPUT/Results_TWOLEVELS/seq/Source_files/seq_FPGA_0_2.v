...
module FAU ( 
  ...
  assign z17 = x33 & (~x34 | (x34 & (x07 | (~x07 & ~x32 & new_n143_ & ~x35))));
  ...
  assign new_n185_ = x34 & (x05 | x07 | ~x15 | x32 | ~new_n186_ | ~x34);
  assign new_n186_ = ~x35 & ~x36 & x37 & new_n104_ & ~x38;
  ...
  assign z29 = ~x05 & ~x07 & x15 & ~x21 & new_n191_ & x22;
  assign new_n191_ = ~x32 & x33 & x34 & ~x35 & new_n192_ & ~x36;
  assign new_n192_ = x37 & ~x38 & x39 & x40 & (x11 | x12);
  assign z32 = x33 & ~x34;
  assign z33 = x33 ? (~x34 | (x34 & (x07 | (~x07 & new_n195_ & ~x32)))) : x32;
  assign new_n195_ = ~x35 & ~x36 & (x38 ? ~new_n198_ : (new_n196_ | new_n197_));
  assign new_n196_ = ~x01 & ~x02 & ~new_n161_ & ~x03;
  assign new_n197_ = x39 & x40 & (~x37 | (~x05 & ~new_n120_ & x37));
  assign new_n198_ = (x37 | x39 | x40) & (~x40 | (x37 ? (x39 & (~x06 | ~x39)) : x39));
  assign z34 = new_n200_ & x33;
  assign new_n200_ = x34 & (x07 | (~x07 & ~x32 & ~x35 & ~new_n201_ & ~x36));
