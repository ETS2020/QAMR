// Benchmark "FAU" written by ABC on Tue Aug 25 14:55:27 2020
...
module FAU ( 
  ...
  assign new_n129_ = ~x34 & x36 & (~new_n138_ | (x00 & (new_n130_ | new_n134_)));
  assign new_n130_ = x38 & ((~x35 & new_n131_ & x40) | (~x01 & new_n133_ & x35));
  assign new_n131_ = ~new_n123_ & ~new_n132_;
  assign new_n132_ = ~x37 ^ x39;
  assign new_n133_ = x37 & (~x04 | (x02 & ~x03 & x04));
  assign new_n134_ = new_n135_ & x35;
  assign new_n135_ = x37 & ~x38 & ~x39 & ~new_n136_ & ~x40;
  assign new_n136_ = new_n137_ & x01 & ~x02;
  assign new_n137_ = ~x03 & x04;
  assign new_n138_ = (x35 | ~new_n140_ | ~x38) & (x38 | ((new_n142_ | ~x35) & (~new_n139_ | ~x11 | x35)));
  assign new_n139_ = new_n87_ & ~x37;
  assign new_n140_ = ~x40 & ((x37 & x39) | (new_n141_ & ~x37 & ~x39));
  assign new_n141_ = x10 & x27;
  assign new_n142_ = (x25 | x26 | x37 | x39) & (~x37 | ~x39 | x40);
  assign z01 = x33 ? ~new_n144_ : ~x16;
  assign new_n144_ = ~x07 & (x07 | x32 | (x34 ? (new_n167_ | x35) : new_n145_));
  assign new_n145_ = (new_n146_ | x36) & ~new_n165_ & (~x36 | (~new_n166_ & (new_n163_ | ~x39)));
  assign new_n146_ = new_n160_ & (x05 | (x35 ? new_n156_ : (~new_n147_ & ~new_n151_)));
  ...
  assign new_n151_ = ~x31 & (new_n152_ | (x15 & new_n153_ & ~new_n155_));
  ...
  assign new_n172_ = (x36 | (~new_n188_ & (new_n173_ | x05))) & ~new_n165_ & (new_n186_ | ~x36);
  ...
  assign new_n182_ = ~new_n155_ & (~x11 ^ ~x12);
  ...
  assign new_n190_ = (~x39 | x40) & (x04 | x39 | ~x40 | ~new_n170_ | x01);
  assign new_n191_ = ~new_n112_ & ~new_n192_;
  assign new_n192_ = ~x01 & ~x02 & ~x03 & ~x04 & (~x40 | (x39 & x40));
  assign z03 = x33 ? (x07 | (~x32 & (new_n233_ | (~new_n194_ & ~x07)))) : ~x16;
  assign new_n194_ = (new_n195_ | x36) & (x34 | ~x36 | (x35 ? new_n229_ : new_n227_));
  assign new_n195_ = (x35 | (x34 ? new_n196_ : (~new_n202_ & ~new_n225_))) & (x34 | new_n219_ | ~x35);
  assign new_n196_ = (new_n120_ | new_n198_) & ~new_n197_ & (x38 | (~new_n199_ & ~new_n200_));
  assign new_n197_ = ~x37 & x38 & ~x40 & (new_n123_ | ~x39);
  assign new_n198_ = new_n124_ & ~x03 & ~x04 & (~new_n124_ | x03 | x04 | ~x40);
  ...
  assign new_n202_ = ~x05 & (new_n147_ | (~x31 & (new_n203_ | new_n206_ | ~new_n209_)));
  assign new_n203_ = ~x13 & (new_n204_ | new_n205_);
  assign new_n204_ = ~x11 & ~x12 & x37 & new_n128_ & ~x38;
  ...
  assign new_n226_ = x38 & x39 & ~new_n155_ & x40;
  assign new_n227_ = x40 ? new_n228_ : ((~x37 | ~x39) & (~new_n141_ | x37 | ~x38 | x39));
  assign new_n228_ = x38 ? ((~x37 | ~x39) & (~x00 | new_n123_ | (x37 ^ ~x39))) : (~x37 & (~new_n164_ | x37 | ~x39));
  ...
  assign z04 = (~x16 & ~x33) | (~x07 & ~x32 & ~new_n236_ & x33);
  ...
  assign new_n240_ = x24 & x40 & ~new_n92_ & ~new_n180_;
  ...
  assign new_n244_ = ~new_n92_ & (~x37 | (~x21 & x22 & x23 & ~new_n177_ & x37));
  assign new_n245_ = ~x25 & (x25 | x26);
  assign new_n246_ = (~x00 | x01 | x04 | ((~x39 | x40) & (~x37 | x39 | ~x40))) & (x37 | (x39 ^ ~x40));
  assign new_n247_ = (new_n253_ | ~x36) & (x05 | x36 | (~new_n147_ & (new_n248_ | x31)));
  assign new_n248_ = x38 ? (new_n250_ | ~x40) : (~new_n249_ & (~new_n252_ | ~x15));
  assign new_n249_ = x39 & ((new_n185_ & x37) | (~x13 & new_n159_ & ~x37));
  assign new_n250_ = ~new_n251_ & (x28 | x29 | x30 | x39);
  assign new_n251_ = x15 & ~x37 & x39 & ~new_n155_ & ~new_n154_;
  assign new_n252_ = x37 & ~x39 & ~new_n155_ & ~new_n154_;
  ...
  assign z05 = (~x16 & ~x33) | (~x07 & ~x32 & x33 & (new_n258_ | new_n286_));
  ...
  assign new_n261_ = (x38 | (~new_n200_ & (new_n262_ | x37))) & (x37 | new_n263_ | ~x38);
  assign new_n262_ = (~x39 | ~x40) & (~x00 | x01 | (~new_n84_ & (x04 | (x39 ^ ~x40))));
  assign new_n263_ = (x39 | x40) & (~new_n170_ | x01 | x04 | ~x39 | ~x40);
  assign new_n264_ = ~new_n265_ & (x34 | ((new_n272_ | ~x39) & ~new_n275_ & (new_n276_ | x39)));
  assign new_n265_ = x15 & (new_n271_ | (~x34 & (new_n266_ | new_n213_ | new_n270_)));
  ...
  assign new_n272_ = (new_n273_ | x37) & (x09 | ~x38 | (~x37 & x40)) & (~x37 | x38 | new_n208_ | x40);
  ...
  assign new_n287_ = x00 & (new_n134_ | (x38 & (new_n288_ | (new_n290_ & ~x01))));
  assign new_n288_ = x40 & ((new_n131_ & ~x35) | (new_n289_ & x35 & ~x01 & ~x04));
  assign new_n289_ = x37 & ~x39;
  assign new_n290_ = x35 & ((new_n126_ & ~x04) | (x02 & ~x03 & x04 & x37));
  assign new_n291_ = x40 ? (x37 ? (x38 ^ x39) : (x38 ? x39 : (new_n292_ | ~x39))) : ((~new_n141_ | x37 | ~x38 | x39) & (~x37 | x38 | ~x39));
  assign new_n292_ = ~x11 & (x11 | ~x12);
  assign new_n293_ = (~x37 | x38 | ~x39 | x40) & (x37 | ((x38 | new_n245_ | x39) & (~x39 | (x38 & (~x38 | x40)))));
  assign z06 = (~x16 & ~x33) | (~x07 & ~x32 & ~new_n295_ & x33);
  ...
  assign new_n303_ = new_n128_ & ~x37 & ~x38;
  assign new_n304_ = ~new_n86_ & ~new_n305_;
  ...
  assign new_n311_ = ~new_n86_ & ((~x38 & ((x13 & (x40 | (x37 & ~x39))) | (~x13 & x37 & ~x39 & x40))) | (x13 & ~x37 & x38 & ~x39 & ~x40));
  assign new_n312_ = (~x37 | x38 | ~x39 | x40) & (x37 | ((~x38 | x39 | new_n141_ | x40) & (~x39 | ~x40 | ~x11 | x38)));
  assign new_n313_ = ~x36 & ~new_n314_ & x40;
  assign new_n314_ = (new_n315_ | ~x37) & (~new_n170_ | x01 | ~new_n302_ | x04 | x37);
  ...
  assign new_n318_ = x00 & ~x01 & ~x04 & x38 & (new_n126_ | new_n289_);
  assign z07 = x33 ? (x07 | (~x07 & ~new_n320_ & ~x32)) : ~x16;
  ...
  assign new_n322_ = ~x31 & ~x35 & (new_n323_ | (x15 & ~new_n155_ & new_n324_));
  assign new_n323_ = ~x28 & ~x29 & ~x30 & (new_n207_ | (new_n128_ & x38));
  assign new_n324_ = (x11 ^ x12) & ((x39 & x40 & ~x37 & x38) | (x37 & ~x38 & ~x39));
  assign new_n325_ = x24 & x35 & ~new_n92_ & (new_n300_ | (~new_n298_ & x40));
  ...
  assign z09 = x33 ? (x07 | (~x05 & new_n336_ & ~x07)) : ~x16;
  assign new_n336_ = ~x32 & ~x34 & ~x36 & (new_n341_ | (~new_n337_ & x15));
  assign new_n337_ = (~new_n340_ | x31) & (~x37 | x38 | new_n338_ | x39);
  assign new_n338_ = (x21 | ~new_n339_ | ~x22) & (x31 | ~new_n182_ | x35);
  assign new_n339_ = x23 & x24 & x35 & x40 & ~new_n92_ & ~new_n177_;
  assign new_n340_ = ~x35 & ~x37 & x38 & x39 & new_n182_ & x40;
  assign new_n341_ = new_n342_ & ~x35 & x37 & new_n126_ & ~x38;
  assign new_n342_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z10 = (~x16 & ~x33) | (~x07 & ~x32 & x33 & ~new_n344_ & ~x36);
  ...
  assign new_n351_ = (x31 | x35 | ~new_n216_ | ~x37) & (~new_n352_ | x37);
  assign new_n352_ = x38 & x39 & ~new_n353_ & x40;
  assign new_n353_ = (x21 | ~new_n354_ | ~x22) & (x31 | ~new_n182_ | x35);
  assign new_n354_ = x24 & x35 & ~new_n92_ & ~new_n180_;
  assign new_n355_ = new_n342_ & new_n128_ & ~x35 & x38;
  ...
  assign z13 = x33 ? (x07 | (~x07 & ~x32 & new_n360_ & ~x34)) : ~x16;
  ...
  assign z15 = x33 ? x07 : ~x16;
  assign z16 = (~x16 & ~x33) | (~x07 & ~x32 & ~new_n366_ & x33);
  assign new_n366_ = (new_n367_ | x34) & (~new_n126_ | ~new_n373_ | ~x34 | x35 | x36);
  ...
  assign new_n370_ = ~x01 & ~x02 & ~x03 & ~x04 & ~new_n132_ & x40;
  assign new_n371_ = x39 & (x11 | x12 | ~x40);
  assign new_n372_ = x00 & x01 & new_n137_ & ~x02;
  ...
  assign new_n380_ = ~new_n381_ & (x05 | ~new_n201_ | ~x15);
  assign new_n381_ = ~x39 & (x01 | x03 | x04);
  assign new_n382_ = ~x05 & ~x31 & ~new_n88_ & ~x34;
  assign new_n383_ = x15 & ~x34 & x35 & ~x39 & ~new_n221_ & ~new_n92_;
  ...
  assign new_n392_ = (new_n395_ | x40) & (~x00 | (~new_n134_ & (new_n393_ | ~x38)));
  assign new_n393_ = (x35 | ~new_n131_ | ~x40) & (~new_n394_ | ~x04 | ~x35 | ~x37);
  ...
  assign new_n402_ = x11 & x12 & x14 & x15 & ~new_n155_ & ~x39;
  assign new_n403_ = ~x39 & (x39 | (x40 & (x05 | ~new_n404_ | ~x15)));
  assign new_n404_ = x21 & x22 & x24 & ~new_n92_ & x40;
  assign new_n405_ = ~x39 & ((new_n406_ & x15) | (new_n159_ & ~x13));
  assign new_n406_ = x24 & ~new_n92_ & (x40 | (x21 & x22 & ~x40));
  assign new_n407_ = ~x35 & (x36 ? ~new_n408_ : (new_n412_ | (~new_n410_ & x40)));
  assign new_n408_ = (new_n409_ | (~x37 ^ x39)) & (~x37 | ~x39) & (x37 | x39 | (~x40 & (new_n141_ | x40)));
  assign new_n409_ = x40 & (~new_n124_ | ~x00 | x03 | x04 | ~x40);
  assign new_n410_ = (~new_n411_ | ~x11) & (x05 | x31 | new_n183_ | x39);
  assign new_n411_ = x12 & x14 & x15 & ~x37 & ~new_n155_ & x39;
  ...
  assign new_n438_ = (~new_n112_ | x36 | x37) & (~new_n124_ | ~x00 | ~new_n137_ | ~x36 | ~x37);
  assign new_n439_ = x39 & x40 & ((~x36 & x37 & x34 & ~x35) | (~x34 & x35 & x36 & ~x37));
  assign z20 = ~x07 & ~x32 & x33 & (new_n441_ | (new_n459_ & ~x34));
  assign new_n441_ = ~x36 & (new_n455_ | (~x35 & (x05 ? ~new_n451_ : ~new_n442_)));
  assign new_n442_ = x34 ? (~x37 | x38 | ~new_n159_ | ~x39) : new_n443_;
  assign new_n443_ = ~new_n147_ & (x31 | (~new_n444_ & ~new_n447_ & ~new_n450_));
  assign new_n444_ = x15 & ((~new_n445_ & x09) | (x16 & new_n153_ & x17));
  assign new_n445_ = x37 ? (x38 | x39 | new_n214_ | new_n154_) : (~x38 | new_n446_ | ~x39);
  assign new_n446_ = x40 ? ((~x16 & ~x17) | (x12 ? (x11 & x14) : ~x11)) : (x11 & x12);
  assign new_n447_ = ~x37 & ((~new_n448_ & x39) | (x38 & ~x39 & ~new_n86_ & ~x40));
  assign new_n448_ = (x11 | new_n449_ | x12) & (x15 | (new_n449_ & (~x09 | (~x13 & (~new_n449_ | x13)))));
  assign new_n449_ = x38 & ~x40;
  assign new_n450_ = ~x38 & ~new_n86_ & (new_n289_ | x40);
  assign new_n451_ = (new_n87_ | ((x34 | ~x38) & (x00 | x37 | x38))) & (new_n452_ | x34) & (~new_n87_ | ~x37 | x38);
  assign new_n452_ = ~new_n150_ & new_n453_ & ~new_n214_ & new_n102_;
  assign new_n453_ = ~new_n454_ & ~new_n373_ & x14 & x15;
  ...
  assign new_n459_ = x36 & (new_n460_ | (new_n462_ & new_n373_ & x35));
  assign new_n460_ = x40 & (new_n461_ | (x11 & ~x35 & new_n454_ & ~x37));
  ...
  assign new_n469_ = new_n126_ & x38 & ~x00 & ~x05 & x37;
  ...
  assign z22 = (~x16 & ~x33) | (~x07 & x33 & (new_n480_ | (~new_n474_ & ~x34)));
  assign new_n474_ = (new_n475_ | x36) & (x00 | ~x05 | x32 | ~new_n479_ | ~x36);
  assign new_n475_ = (~x05 | new_n478_ | x32) & (x35 | (new_n427_ & (~x05 | new_n476_ | x32)));
  assign new_n476_ = ~new_n150_ & new_n477_ & (new_n139_ | ~x38);
  assign new_n477_ = x15 & ~new_n214_ & ~new_n454_ & x11 & x12 & x14;
  ...
  assign new_n487_ = (~x35 | new_n488_ | ~x40) & (x31 | x35 | (~new_n150_ & ~new_n214_));
  assign new_n488_ = (x21 | ((x09 | (x18 & x19)) & (x18 | x19) & (~x22 | ~x24 | ((~x18 | ~x19) & (~x09 | (~x18 & ~x19)))))) & (~x24 | (x22 & (~x21 | ~x22)));
  assign new_n489_ = ~x31 & ~x35 & ((x11 & x12 & ~x14) | (~new_n155_ & (~x11 ^ ~x12)));
  assign new_n490_ = x11 & x12 & x14 & ~new_n155_ & ~x35;
  ...
  assign new_n504_ = (new_n505_ | x05) & (new_n139_ | ~x05) & (~x11 | ~new_n511_ | ~x12);
  assign new_n505_ = x31 ? (~x37 & x40) : (new_n509_ & (x37 | (~new_n506_ & (new_n508_ | x40))));
  assign new_n506_ = x15 & ((~new_n212_ & x39) | (new_n507_ & ~x16));
  ...
  assign new_n511_ = x14 & x15 & ~x37 & x39 & ~new_n155_ & x40;
  ...
  assign new_n519_ = ~new_n132_ & (~x40 | (x00 & x40 & (~new_n124_ | x03 | x04 | (new_n124_ & ~x03 & ~x04))));
  ...
  assign new_n523_ = ~new_n150_ & ~new_n214_ & x11 & x12 & x14 & x15;
  assign new_n524_ = ~x35 & ((~new_n525_ & ~x36) | (new_n301_ & x34 & x36 & ~x37));
  assign new_n525_ = x38 ? new_n526_ : (x37 ? new_n529_ : (~new_n530_ & ~new_n533_));
  assign new_n526_ = ~new_n527_ & (~new_n528_ | ~new_n139_ | ~x15 | x31);
  assign new_n527_ = x34 & (x37 ? (~x39 | (x39 & ~x40)) : (new_n192_ | ~x39 | (~new_n123_ & x39)));
  assign new_n528_ = ~x05 & x11 & x12 & ~x14;
  assign new_n529_ = (~x05 | ~x39 | ~x40) & (~x34 | (x39 ? (x40 & (x05 | ~x40)) : new_n198_));
  ...
  assign new_n535_ = (x38 | (~new_n536_ & ~new_n542_)) & ~new_n396_ & (new_n537_ | x34);
  assign new_n536_ = ~x35 & (new_n377_ | new_n382_);
  assign new_n537_ = (new_n538_ | x05) & (~new_n111_ | ~x35 | ~x37);
  ...
  assign new_n545_ = (new_n392_ | x34) & (~new_n301_ | ~x34 | x35 | x37);
  assign z25 = (~x16 & ~x33) | (~x07 & ~x32 & ~new_n547_ & x33);
  assign new_n547_ = x36 ? new_n550_ : (~new_n548_ & (x05 | new_n538_ | x34));
  assign new_n548_ = ~x38 & (new_n542_ | (~x35 & (new_n382_ | new_n549_)));
  assign new_n549_ = x34 & (new_n200_ | (x00 & ~x01 & new_n379_ & x02));
  assign new_n550_ = (~new_n301_ | ~x34 | x35 | x37) & (x34 | (~new_n552_ & (~x35 | new_n551_ | ~x37)));
  assign new_n551_ = (~new_n126_ | x38) & (~new_n531_ | x03 | ~x04 | ~x38);
  assign new_n552_ = x10 & x27 & ~x35 & new_n112_ & ~x37 & x38;
  assign z26 = (~x16 & ~x33) | (~x07 & ~x32 & ~new_n554_ & x33);
  assign new_n554_ = (new_n555_ | x35) & (~x00 | x34 | ~x35 | ~new_n135_ | ~x36);
  assign new_n555_ = ~new_n556_ & (~new_n301_ | ~new_n558_ | ~x34);
  assign new_n556_ = ~new_n123_ & ((~new_n557_ & x38) | (new_n122_ & x34 & ~x36));
  ...
  assign new_n563_ = (x38 | new_n544_ | x39) & (x37 | ~x38 | new_n223_ | ~x39);
  assign new_n564_ = ~x09 & ~x17 & (new_n302_ | new_n122_);
  ...
  assign new_n569_ = new_n207_ & ~x34 & x35 & x36;
  ...
  assign new_n574_ = new_n111_ & new_n558_ & new_n141_ & ~x34 & ~x35;
  assign z29 = ~x07 & ~x32 & x33 & (new_n569_ | (new_n576_ & ~x05));
  assign new_n576_ = ~x36 & ((~new_n577_ & ~x34) | (x15 & new_n327_ & ~x21));
  ...
  assign new_n587_ = (x38 | x39 | ((x37 | x40) & (x23 | ~x37 | new_n177_ | ~x40))) & (x37 | ~x38 | ~x39 | x40);
  assign z31 = ~x07 & ~x32 & x33 & (new_n597_ | (~new_n589_ & ~x34));
  assign new_n589_ = ~new_n596_ & (~x35 | (~new_n594_ & (x05 | ~new_n590_ | ~x15)));
  assign new_n590_ = ~x36 & ~new_n92_ & ((new_n591_ & ~x38) | (~x37 & new_n593_ & x38));
  assign new_n591_ = ~x39 & ((~x24 & ~x37) | (x40 & (new_n592_ | ~x24)));
  assign new_n592_ = ~x21 & x22 & ~x23 & x24 & ~new_n177_ & x37;
  assign new_n593_ = x39 & (~x24 | (x21 & x22 & ~x23 & x24 & ~x40));
  assign new_n594_ = new_n595_ & new_n373_ & x04 & x36;
  assign new_n595_ = x02 & ~x03 & x00 & ~x01;
  assign new_n596_ = new_n112_ & ~x37 & x38 & new_n141_ & ~x35 & x36;
  assign new_n597_ = x00 & ~x01 & x02 & ~x03 & new_n573_ & x04;
  assign z32 = ~x40 & ~x39 & x38 & new_n599_ & x37;
  assign new_n599_ = ~x36 & x35 & ~x34 & x33 & ~x07 & ~x32;
  assign z33 = (x16 & x32 & ~x33) | (x33 & (x07 | (~x07 & ~x32 & (new_n601_ | new_n615_))));
  ...
  assign new_n605_ = x21 ? (~x23 & ~x40) : (new_n180_ | ~x40);
  assign new_n606_ = ~x13 & ~new_n86_ & (new_n301_ | new_n302_);
  assign new_n607_ = (new_n609_ | ~x36) & (x05 | x31 | x36 | (new_n608_ & ~new_n323_));
  assign new_n608_ = ~new_n444_ & ~new_n447_ & ~new_n450_ & (~new_n302_ | ~x09 | ~x37);
  assign new_n609_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (new_n141_ | x40))) & (~x39 | (x38 ? x40 : (new_n292_ | ~x40)))));
  ...
  assign new_n614_ = x22 & x24 & ~new_n92_ & (x21 | (~x21 & ~new_n177_ & x23));
  ...
  assign new_n622_ = (x35 | (x36 ? new_n409_ : new_n623_)) & (~x36 | ~x40 | ~x06 | ~x35);
  ...
  assign new_n625_ = x11 & x12 & x14 & ~new_n155_ & x40;
  assign new_n626_ = ~x15 & ~x31 & ~x40 & ~x05 & x09 & ~x13;
  assign new_n627_ = (~new_n630_ | ~x35 | x36) & (x35 | ((new_n628_ | x36) & (~new_n630_ | ~x11 | ~x36)));
  assign new_n628_ = x05 ? x38 : (x31 | new_n629_ | x37);
  assign new_n629_ = (~x09 | ~x13 | x15) & (new_n449_ | (~new_n92_ & x15));
  ...
  assign new_n636_ = ~x39 & ((x15 & ~new_n155_ & ~new_n154_) | new_n92_ | ~x15);
  assign new_n637_ = ~x39 & (x35 ? (new_n638_ | (x06 & x40)) : ~x40);
  assign new_n638_ = x00 & x01 & ~x02 & ~x03 & x04 & ~x40;
  assign new_n639_ = x05 ? (~new_n150_ & new_n640_ & (new_n87_ | ~x38)) : ~new_n641_;
  assign new_n640_ = new_n102_ & x14 & ~new_n214_ & x15;
  ...
  assign new_n644_ = (~new_n87_ | ~x05 | ~x37) & (x37 | new_n87_ | ((x00 | ~x05) & (~new_n532_ | ~new_n124_ | ~x00)));
