// Benchmark "FAU" written by ABC on Tue Aug 25 14:57:09 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n209_, new_n210_, new_n212_, new_n213_, new_n217_, new_n218_,
  ...
  assign z12 = ~x40 & x38 & x37 & x36 & new_n140_ & x35;
  assign new_n140_ = ~x34 & x33 & ~x32 & x08 & new_n141_ & ~x07;
  assign new_n141_ = ~x00 & x05;
  assign z13 = x33 & x36 & (x07 | (new_n143_ & ~x07));
  assign new_n143_ = ~x32 & ~x34 & x35 & ~x37 & ~x38 & ~x39;
  assign z14 = x33 & ((x07 & x36) | new_n145_ | ~x36);
  assign new_n145_ = new_n146_ & x13 & ~x32 & ~x34;
  assign new_n146_ = ~x38 & ~x39 & x35 & ~x37;
  assign z16 = x33 & (~x36 | (~x07 & ~x32 & ~x34 & ~new_n148_ & x36));
  assign new_n148_ = (new_n149_ | x35) & (~new_n153_ | ~new_n117_ | ~x35 | ~x37);
  assign new_n149_ = (new_n150_ | ~x38) & (x37 | new_n152_ | x38);
  assign new_n150_ = (~new_n118_ | ~x37) & (~x00 | x01 | ~new_n151_ | x02);
  assign new_n151_ = ~x03 & ~x04 & x40 & (x37 ^ x39);
  assign new_n152_ = x39 & (x11 | x12 | ~x40);
  assign new_n153_ = new_n154_ & ~x02 & x00 & x01;
  assign new_n154_ = ~x03 & x04;
  assign z17 = x33 & x36 & (x07 | (~x07 & new_n156_ & ~x32));
  assign new_n156_ = ~x34 & ((~new_n159_ & ~x40) | (~new_n157_ & x00));
  assign new_n157_ = ~new_n83_ & (~x38 | (~new_n158_ & (x35 | ~new_n81_ | ~x40)));
  assign new_n158_ = ~x01 & x02 & ~x03 & x04 & x35 & x37;
  assign new_n159_ = (~new_n160_ | x37 | ~x38 | x39) & (x38 | ~x39 | ~x35 | ~x37);
  assign new_n160_ = x10 & x27 & ~x35;
  assign z18 = ~x07 & ~x32 & new_n162_ & x33;
  assign new_n162_ = x36 & (new_n116_ | (~x34 & (x35 ? ~new_n167_ : ~new_n163_)));
  assign new_n163_ = x38 ? new_n164_ : new_n166_;
  assign new_n164_ = ((~new_n165_ & x40) | (~x37 ^ x39)) & (~x37 | ~x39) & (x37 | x39 | (~x40 & (new_n88_ | x40)));
  assign new_n165_ = x00 & ~x01 & ~x02 & ~x03 & ~x04 & x40;
  assign new_n166_ = (~x40 | (~x37 & (x11 | x37 | (x12 & (~x12 | ~x39))))) & (x37 | x39) & (~x37 | ~x39 | x40);
  assign new_n167_ = (x37 | (~new_n95_ & x38)) & (~x00 | new_n168_ | ~x37);
  assign new_n168_ = (x01 | x04 | ~x38) & (~x01 | x02 | x03 | ~new_n118_ | ~x04 | x38);
  assign z19 = ~x07 & ~x32 & x33 & ~x34 & ~new_n170_ & x36;
  assign new_n170_ = (new_n171_ | ~x35) & (~new_n117_ | x35 | ~x37);
  assign new_n171_ = ~new_n172_ & (~x40 | ((~x37 | x38 | ~x39) & (~x06 | (x37 ? (x38 | x39) : (~x38 | ~x39)))));
  assign new_n172_ = x00 & ~x01 & ~x02 & new_n154_ & x37 & x38;
  assign z20 = ~x07 & ~x32 & x33 & ~x34 & ~new_n174_ & x36;
  assign new_n174_ = (new_n175_ | ~x40) & (~new_n141_ | ~x35 | ~x37 | ~x38);
  assign new_n175_ = ~new_n176_ & (~x11 | x35 | x37 | x38 | ~x39);
  assign new_n176_ = ~x00 & x05 & x38 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign z21 = (~x07 & (new_n178_ | new_n182_)) | ~x33 | (x33 & ~x36);
  assign new_n178_ = ~x34 & ((~new_n179_ & x35) | x32 | (new_n181_ & ~x00));
  assign new_n179_ = (~x37 | (~new_n180_ & (x39 | ~x40 | x06 | x38))) & (x06 | x37 | ~x38 | ~x39 | ~x40);
  assign new_n180_ = ~x00 & (x38 ? ~x05 : new_n118_);
  assign new_n181_ = ~x05 & x38 & x40 & ((x37 & ~x39) | (~x35 & ~x37 & x39));
  assign new_n182_ = new_n117_ & x32 & ~x35 & ~x37;
  assign z22 = new_n184_ & ~x00;
  assign new_n184_ = x05 & ~x07 & ~x32 & x33 & new_n185_ & ~x34;
  assign new_n185_ = x36 & x38 & ((x37 & (x35 | (~x39 & x40))) | (x39 & x40 & ~x35 & ~x37));
  assign z23 = x33 & (~x36 | (x36 & (x07 | (new_n187_ & ~x07))));
  assign new_n187_ = ~x32 & (new_n116_ | (~x34 & (~new_n192_ | (~new_n188_ & ~x35))));
  assign new_n188_ = x38 ? (new_n189_ & (new_n190_ | (~x37 ^ x39))) : new_n191_;
  assign new_n189_ = (~x39 | (~x37 & (~new_n141_ | x37 | ~x40))) & (x37 | x39 | (~x40 & (x40 | (x10 & x27 & (~x10 | ~x27)))));
  assign new_n190_ = x40 & (~x00 | ~x40 | (~x01 & ~x02 & ~x03 & ~x04 & (x03 | x04 | x01 | x02)));
  assign new_n191_ = (x37 | x39) & (~x37 | ~x39 | x40) & (~x40 | (~x37 & (x37 | (x11 ? ~x39 : (x12 & (~x12 | ~x39))))));
  assign new_n192_ = (~x37 | ((new_n193_ | ~x38) & (~x35 | ~new_n195_ | x38))) & (~x35 | x37 | (~new_n95_ & x38));
  assign new_n193_ = (~x35 | (x00 ? (new_n82_ | x01) : ~x05)) & (~new_n194_ | x00 | ~x05);
  assign new_n194_ = ~x39 & x40;
  assign new_n195_ = ~new_n196_ & ~x40;
  assign new_n196_ = ~x39 & (~x00 | x39 | (x01 & ~x02 & ~x03 & x04 & (~x01 | x02 | x03 | ~x04)));
  assign z24 = ~x07 & ~x32 & x33 & x36 & (new_n156_ | new_n116_);
  assign z25 = x33 & (~x36 | (~x07 & ~x32 & x36 & (new_n116_ | new_n199_)));
  assign new_n199_ = ~x34 & (new_n200_ | (new_n160_ & new_n118_ & ~x37 & x38));
  assign new_n200_ = x35 & x37 & (new_n201_ | (new_n106_ & ~x38));
  assign new_n201_ = x00 & ~x01 & x02 & ~x03 & x04 & x38;
  assign z26 = ~new_n203_ & x33;
  assign new_n203_ = x36 & (x07 | x32 | ~x36 | (~new_n116_ & (~new_n204_ | ~x00)));
  assign new_n204_ = ~x34 & (new_n83_ | (~x35 & x38 & new_n81_ & x40));
  assign z27 = x33 & (~x36 | (new_n206_ & new_n106_ & ~x38 & x36 & x37));
  assign new_n206_ = ~x07 & ~x32 & ~x34 & x35;
  assign z28 = ~x07 & ~x32 & new_n208_ & x33;
  assign new_n208_ = ~x34 & x36 & x38 & (new_n209_ | new_n210_);
  assign new_n209_ = new_n154_ & x35 & x37 & x00 & ~x01 & x02;
  assign new_n210_ = new_n160_ & new_n118_ & ~x37;
  assign z30 = new_n212_ & ~x40;
  assign new_n212_ = ~x39 & x38 & ~x37 & x36 & new_n213_ & ~x35;
  assign new_n213_ = ~x34 & x33 & ~x32 & x27 & ~x07 & x10;
  assign z31 = x33 & (~x36 | (~x07 & new_n208_ & ~x32));
  assign z32 = x33 & ~x36;
  ...
  assign new_n224_ = x00 ? (~new_n225_ | x01) : (~x05 | (~new_n194_ & ~x35));
  assign new_n225_ = ~x02 & ~x03 & ((new_n194_ & ~x04 & ~x35) | (x04 & x35));
