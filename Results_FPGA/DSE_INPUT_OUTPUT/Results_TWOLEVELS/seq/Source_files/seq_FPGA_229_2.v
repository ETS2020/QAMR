...
module FAU ( 
  ...
  assign z17 = x07 | (~x07 & ~x32 & ~new_n376_ & x33);
  ...
  assign z18 = x07 ? ~x33 : (~new_n397_ & x33);
  ...
  assign z26 = ~x07 & ~x32 & x33 & (new_n553_ | (~new_n554_ & ~x35));
  ...
  assign z29 = x07 ? ~x33 : (~x32 & x33 & (new_n567_ | (new_n574_ & ~x05)));
  ...
  assign z30 = x07 ? ~x33 : (~x32 & x33 & (new_n581_ | new_n572_));
  ...
  assign z31 = x07 ? ~x33 : (~x32 & x33 & (new_n594_ | (~new_n587_ & ~x34)));
  ...
  assign z34 = x33 ? (x07 | (~x07 & ~x32 & (new_n640_ | (~new_n617_ & ~x34)))) : x07;
