// Benchmark "FAU" written by ABC on Tue Aug 25 14:54:14 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n644_;
  assign z00 = x07 ? x32 : (~x32 & x33 & (new_n129_ | (~new_n79_ & ~x36)));
  ...
  assign z01 = x07 ? (x32 | (~x32 & x33)) : (~x32 & x33 & (x34 ? new_n167_ : ~new_n144_));
  ...
  assign z02 = x07 ? (x32 | (~x32 & x33)) : (~x32 & x33 & (x34 ? new_n190_ : ~new_n173_));
  ...
  assign z03 = ~x32 & x33 & (new_n234_ | x07 | (~new_n195_ & ~x07));
  ...
  assign z07 = ~x32 & x33 & (x07 | (~new_n322_ & ~x07));
  ...
  assign z08 = ~x32 & x33 & (x07 | (~x07 & ~x35 & ~new_n335_ & x40));
  assign new_n335_ = (~new_n336_ | ~x36 | x37 | x38 | ~x39) & (~x34 | x36 | ~x37 | ~x38 | x39);
  assign new_n336_ = ~x11 & x12 & ~x34;
  assign z09 = (x07 & (x32 | (~x32 & x33))) | (~x05 & ~x07 & ~x32 & x33 & new_n338_ & ~x34);
  ...
  assign z12 = (x07 & x32) | (~x00 & x05 & ~x07 & x08 & new_n359_ & ~x32);
  assign new_n359_ = new_n360_ & x33;
  assign new_n360_ = ~x40 & ((~x34 & x35 & x36 & x37 & x38) | (x34 & ~x35 & ~x36 & ~x37 & ~x38));
  assign z13 = x07 ? (x32 | (~x32 & x33)) : (~x32 & x33 & new_n362_ & ~x34);
  assign new_n362_ = x35 & ~x37 & ((~x38 & (x36 ? ~x39 : (x39 & x40))) | (~x39 & ~x40 & ~x36 & x38));
  assign z14 = (x07 & (x32 | (~x32 & x33))) | (~x32 & x33 & ~x34 & new_n364_ & x35);
  assign new_n364_ = ~new_n365_ & ~x37;
  assign new_n365_ = (x07 | x36 | (x38 ? (x39 | x40) : (~x39 | ~x40))) & (~x13 | ~x36 | x38 | x39);
  assign z15 = x07 & (x32 | (~x32 & x33));
  assign z16 = x07 ? x32 : (~x32 & x33 & (new_n374_ | (~new_n368_ & ~x34)));
  assign new_n368_ = (new_n369_ | ~x36) & (~new_n128_ | ~x38 | ~x35 | x36 | ~x37);
  assign new_n369_ = (new_n370_ | x35) & (~new_n373_ | ~new_n302_ | ~x35 | ~x37);
  assign new_n370_ = (~x38 | ((~new_n112_ | ~x37) & (~new_n371_ | ~x00))) & (x37 | new_n372_ | x38);
  assign new_n371_ = ~x01 & ~x02 & ~x03 & ~x04 & ~new_n136_ & x40;
  assign new_n372_ = x39 & (x11 | x12 | ~x40);
  assign new_n373_ = x00 & x01 & new_n134_ & ~x02;
  assign new_n374_ = new_n126_ & new_n375_ & x34 & ~x35 & ~x36;
  assign new_n375_ = x37 & x38;
  assign z17 = x07 ? (x32 | (~x32 & x33)) : (~x32 & ~new_n377_ & x33);
  assign new_n377_ = (x34 | new_n393_ | ~x36) & (x36 | (~new_n378_ & ~new_n385_ & ~new_n396_));
  ...
  assign new_n381_ = x00 & ~x01 & ~x03 & x04 & ~new_n87_ & ~x37;
  assign new_n382_ = ~new_n383_ & (x05 | ~new_n202_ | ~x15);
  assign new_n383_ = ~x39 & (x01 | x03 | x04);
  assign new_n384_ = x15 & ~x34 & x35 & ~x39 & ~new_n222_ & ~new_n92_;
  ...
  assign new_n390_ = x24 & (~x24 | (x22 & (~x22 | (x21 ? (x23 | x40) : (x40 & (new_n181_ | ~x40))))));
  assign new_n391_ = ~x09 & ~x17 & ~x31 & ~x35 & x39;
  assign new_n392_ = ~x09 & ~x16 & ~x31 & ~x35 & ~x37 & x39;
  assign new_n393_ = (new_n395_ | x40) & (~x00 | (~new_n131_ & (new_n394_ | ~x38)));
  assign new_n394_ = ~new_n135_ & (~new_n291_ | x01 | ~x04 | ~x35 | ~x37);
  ...
  assign new_n401_ = ~new_n402_ & (x05 | x31 | ~new_n186_ | ~x39);
  assign new_n402_ = x11 & x12 & x14 & x15 & ~new_n149_ & ~x39;
  assign new_n403_ = ~x39 & (x39 | (x40 & (x05 | ~new_n404_ | ~x15)));
  assign new_n404_ = x21 & x22 & x24 & ~new_n92_ & x40;
  assign new_n405_ = ~x39 & ((new_n406_ & x15) | (new_n162_ & ~x13));
  assign new_n406_ = x24 & ~new_n92_ & (x40 | (x21 & x22 & ~x40));
  assign new_n407_ = ~x35 & (x36 ? ~new_n408_ : (new_n412_ | (~new_n410_ & x40)));
  assign new_n408_ = (new_n409_ | (~x37 ^ x39)) & (~x37 | ~x39) & (x37 | x39 | (~x40 & (new_n140_ | x40)));
  assign new_n409_ = x40 & (~new_n124_ | ~x00 | x03 | x04 | ~x40);
  assign new_n410_ = (~new_n411_ | ~x11) & (x05 | x31 | new_n184_ | x39);
  assign new_n411_ = x12 & x14 & x15 & ~x37 & ~new_n149_ & x39;
  ...
  assign new_n418_ = new_n171_ & x00 & x01 & new_n112_ & x04 & x35;
  assign new_n419_ = ~x11 & x40 & (~x12 | (x12 & x39));
  assign new_n420_ = (~new_n302_ | ~x36 | x37) & (new_n421_ | x36);
  ...
  assign new_n424_ = ~x04 & ~x39 & ((x00 & ~x37) | (new_n171_ & x37 & x40));
  ...
  assign new_n438_ = (~new_n124_ | ~x00 | ~new_n134_ | ~x36 | ~x37) & (~new_n112_ | x36 | x37);
  ...
  assign new_n442_ = x34 ? (~x37 | x38 | ~new_n162_ | ~x39) : new_n443_;
  assign new_n443_ = ~new_n150_ & (x31 | (~new_n444_ & ~new_n447_ & ~new_n450_));
  assign new_n444_ = x15 & ((~new_n445_ & x09) | (x16 & new_n156_ & x17));
  assign new_n445_ = x37 ? (x38 | x39 | new_n215_ | new_n158_) : (~x38 | new_n446_ | ~x39);
  ...
  assign new_n450_ = ~x38 & ~new_n86_ & (x40 | (x37 & ~x39));
  assign new_n451_ = (new_n87_ | ((x34 | ~x38) & (x00 | x37 | x38))) & (new_n452_ | x34) & (~new_n87_ | ~x37 | x38);
  assign new_n452_ = ~new_n153_ & new_n453_ & ~new_n215_ & new_n102_;
  assign new_n453_ = x14 & x15 & ~new_n454_ & ~new_n375_;
  ...
  assign new_n459_ = x36 & (new_n460_ | (new_n462_ & new_n375_ & x35));
  ...
  assign z21 = (~new_n464_ & ~x07) | ~x33 | (~new_n471_ & x32);
  assign new_n464_ = x34 ? (x35 | new_n470_ | x36) : (~new_n469_ & (new_n465_ | ~x36));
  assign new_n465_ = (~new_n468_ | x00) & (new_n466_ | ~x35);
  ...
  assign new_n469_ = new_n126_ & new_n375_ & ~x00 & ~x05 & x35;
  assign new_n470_ = (x00 | x05 | x37 | new_n87_ | x38) & (x06 | ~x37 | ~new_n87_ | ~x38);
  assign new_n471_ = (x34 | (~x35 & ~x36)) & ~x07 & (x35 | ((~x34 | x36) & (~new_n302_ | ~x36 | x37)));
  ...
  assign new_n476_ = x15 & ~new_n215_ & ~new_n454_ & x11 & x12 & x14;
  assign new_n477_ = new_n458_ & (~x35 | (~new_n121_ & (~new_n128_ | x38)));
  ...
  assign z23 = x07 ? (x32 | (~x32 & x33)) : (~x32 & x33 & (new_n525_ | (~new_n482_ & ~x34)));
  ...
  assign new_n531_ = ~new_n87_ & (new_n462_ | (new_n532_ & new_n533_));
  assign new_n532_ = x00 & ~x01 & x02;
  assign new_n533_ = ~x03 & x04 & x34;
  assign new_n534_ = x34 & ((x39 & (x40 | (x00 & ~x01 & ~x04 & ~x40))) | (x00 & ~x01 & ~x04 & ~x39));
  assign z24 = x07 ? x32 : (~x32 & x33 & (x36 ? ~new_n546_ : ~new_n536_));
  assign new_n536_ = new_n537_ & (x38 | (~new_n543_ & (x35 | (~new_n379_ & ~new_n380_))));
  assign new_n537_ = ~new_n396_ & (x34 | (~new_n542_ & (new_n538_ | x05)));
  assign new_n538_ = (x31 | ~new_n114_ | x35) & (~x15 | new_n539_ | new_n92_);
  assign new_n539_ = ~new_n392_ & (~x38 | (~new_n391_ & (x37 | (~new_n388_ & ~new_n540_))));
  ...
  assign new_n546_ = (new_n393_ | x34) & (~new_n302_ | ~x34 | x35 | x37);
  assign z25 = ~x07 & ~x32 & x33 & (x36 ? ~new_n551_ : ~new_n548_);
  assign new_n548_ = (x38 | (~new_n549_ & ~new_n543_)) & (x05 | new_n538_ | x34);
  assign new_n549_ = ~x35 & (new_n379_ | (x34 & (new_n201_ | (new_n550_ & x00))));
  ...
  assign z27 = x07 ? x32 : (~x32 & x33 & (new_n569_ | (new_n560_ & ~x05)));
  ...
  assign new_n572_ = ~new_n573_ & (~new_n375_ | ~x36 | x34 | ~x35);
  assign new_n573_ = x34 & ~x35 & ~x36 & ~x37 & ~new_n87_ & ~x38;
  assign new_n574_ = new_n111_ & x36 & ~x37 & new_n140_ & ~x34 & ~x35;
  ...
  assign z31 = x07 ? x32 : (~x32 & x33 & (new_n596_ | (~new_n589_ & ~x34)));
  ...
  assign new_n595_ = new_n375_ & x04 & x36 & new_n291_ & x00 & ~x01;
  assign new_n596_ = x00 & ~x01 & x02 & ~x03 & new_n573_ & x04;
  assign z32 = (x07 & x32) | (new_n598_ & ~x07 & ~x32 & new_n111_ & ~x36 & x37);
  assign new_n598_ = x33 & ~x34 & x35;
  assign z33 = (x07 & (x32 | (~x32 & x33))) | (x32 & ~x33) | (~x07 & ~x32 & x33 & (x34 ? new_n614_ : ~new_n600_));
  ...
  assign new_n607_ = ~new_n444_ & ~new_n447_ & ~new_n450_ & (~new_n303_ | ~x09 | ~x37);
  ...
  assign z34 = x32 ? x07 : (x33 & (x07 | (~x07 & (new_n642_ | (~new_n619_ & ~x34)))));
  ...
  assign new_n621_ = (x35 | (x36 ? new_n409_ : new_n622_)) & (~x06 | ~x35 | ~x36 | ~x40);
  ...
  assign new_n628_ = (~x09 | ~x13 | x15) & (new_n449_ | (~new_n92_ & x15));
