...
module FAU ( 
  ...
  assign z06 = x07 ? ~x33 : (~x32 & ~new_n296_ & x33);
  ...
  assign z12 = (x07 & ~x33) | (~x00 & x05 & new_n359_ & ~x07);
  assign new_n359_ = x08 & ~x32 & new_n360_ & x33;
  ...
  assign z23 = x33 & (x07 | (~x07 & ~x32 & (new_n523_ | (~new_n482_ & ~x34))));
  ...
  assign new_n547_ = ~x35 & (new_n378_ | (x34 & (new_n201_ | (new_n548_ & x00))));
  ...
  assign z33 = x07 ? x33 : (x32 ? ~x33 : (x33 & (x34 ? new_n612_ : ~new_n598_)));
