// Benchmark "FAU" written by ABC on Tue Aug 25 04:45:19 2020
...
module FAU ( 
  ...
  wire new_n93_, new_n94_, new_n95_, new_n96_, new_n98_, new_n100_,
    ...
    new_n533_, new_n534_, new_n536_, new_n537_, new_n539_;
  ...
  assign new_n137_ = (new_n138_ | x11) & (~new_n120_ | x21 | ~x22);
  ...
  assign new_n186_ = (~x18 | ~new_n192_ | ~x19) & (x29 | ((new_n187_ | x19) & (~x18 | ~new_n190_ | ~x19)));
  ...
  assign new_n202_ = ~new_n149_ & (new_n203_ | new_n204_);
  assign new_n203_ = x01 & ~x18 & x19 & new_n201_ & ~x20 & x21;
  ...
  assign new_n242_ = x00 & x18 & new_n201_ & ~x19;
  ...
  assign new_n246_ = x30 ? ((new_n250_ | ~x18) & (~new_n251_ | x18 | ~x20)) : new_n247_;
  ...
  assign new_n255_ = x18 & ~x20 & ((~new_n123_ & x30) | (x26 & (~x28 ^ ~x30)));
  ...
  assign z17 = x30 ? ~new_n265_ : (x21 | (~x21 & (~new_n281_ | (~new_n280_ & x18))));
  assign new_n265_ = ~new_n266_ & (new_n267_ | ~x29) & (new_n274_ | x29) & (~new_n279_ | x20);
  assign new_n266_ = ~new_n149_ & (new_n203_ | (x20 & ~x21 & x18 & ~x19));
  assign new_n267_ = new_n271_ & (~x20 | (x21 ? new_n268_ : new_n269_));
  assign new_n268_ = x19 ? (~x18 & (x18 | ~x22 | x28)) : (x18 & (x28 | new_n167_ | (~x11 & (x11 | ~x18))));
  ...
  assign new_n274_ = x18 ? ((new_n240_ | x21) & (~new_n278_ | ~x21 | ~x28)) : new_n275_;
  ...
  assign new_n284_ = (~x20 | ~x26 | ~new_n115_ | x28) & (new_n149_ | ((x20 | (~new_n285_ & ~new_n115_)) & (~new_n115_ | ~x20 | x28)));
  ...
  assign new_n290_ = ~x20 & ((new_n201_ & ~x18) | (x10 & x18 & x25));
  ...
  assign new_n297_ = (~x01 | x18 | new_n149_ | ~x19) & (~x00 | ~x18 | x19);
  assign z19 = new_n309_ | (~x21 & (new_n311_ | (~new_n299_ & ~x30) | (~new_n303_ & x30)));
  assign new_n299_ = (new_n300_ | ~x29) & (~new_n119_ | x03 | ~x20 | ~x27 | x29);
  ...
  assign z20 = z32 | (new_n314_ & new_n154_ & ~x17 & x18);
  assign new_n314_ = new_n139_ & ~x28 & x29 & x30;
  assign z21 = ~x30 & new_n316_ & x29;
  assign new_n316_ = x28 & x26 & ~x21 & x20 & x18 & ~x19;
  assign z22 = x30 ? (new_n202_ | (~new_n318_ & ~x21) | (~new_n327_ & x21)) : (x21 | (~new_n341_ & ~x21));
  assign new_n318_ = ~new_n319_ & ~new_n326_ & (~x18 | (x19 ? ~new_n324_ : new_n325_));
  assign new_n319_ = ~x29 & (x18 ? ~new_n321_ : (x19 ? new_n323_ : ~new_n320_));
  assign new_n320_ = (new_n238_ | ~x28) & (~x20 | (~x22 & ~x24)) & (x28 | (x20 & ~x23));
  ...
  assign new_n324_ = x29 & (x20 ? (~x27 & (x28 | (x05 & ~x28))) : ~new_n181_);
  assign new_n325_ = (x20 | ~x25) & (x17 | ~x20 | ~x26 | x28 | ~x29);
  assign new_n326_ = ~x18 & x29 & ((~x19 & ~x28) | (x20 & x22 & (~x28 | (x19 & x28))));
  assign new_n327_ = x19 ? (~new_n339_ & new_n340_) : new_n328_;
  assign new_n328_ = (x28 | (new_n332_ & (new_n329_ | x29))) & ~new_n335_ & (~new_n338_ | ~x28 | x29);
  assign new_n329_ = ~new_n330_ & ~new_n331_ & (~x20 | ~x25 | ~x05 | x10);
  ...
  assign new_n335_ = ~x18 & (x20 ? ~new_n337_ : (new_n336_ | new_n251_));
  assign new_n336_ = x23 & ~x29;
  assign new_n337_ = ~x29 & (x10 | ~x25);
  assign new_n338_ = x18 & ~x20;
  assign new_n339_ = x25 & (x10 ? (x18 & ~x20) : (x18 ? ~x20 : new_n201_));
  assign new_n340_ = (~x29 | (x18 ? ~x20 : (~x28 & (~x20 | ~x22 | x28)))) & (~x18 | x20 | (~x22 & ~x26));
  assign new_n341_ = x29 ? (x19 ? new_n247_ : new_n342_) : new_n344_;
  assign new_n342_ = (~x20 | (x18 ? ~new_n343_ : ~x24)) & (x18 | x20 | new_n232_ | x28);
  assign new_n343_ = x26 & (x28 | (x17 & ~x28));
  assign new_n344_ = (~x14 | x27 | x28) & (~x18 | (~new_n345_ & (new_n312_ | ~x28)));
  assign new_n345_ = x19 & x20 & x27 & (~x03 | (x00 & x03));
  assign z24 = (x21 & ~x30) | (new_n154_ & ~x18 & ~x29 & x30 & ~x21 & x22);
  assign z25 = x30 ? (new_n356_ | new_n352_ | (~new_n348_ & ~x19)) : x21;
  assign new_n348_ = (~x20 | (~new_n349_ & (~x18 | new_n149_ | x21))) & (~x18 | x20 | new_n160_ | x21);
  assign new_n349_ = ~x28 & ~x29 & (new_n350_ | new_n351_);
  assign new_n350_ = new_n139_ & x18;
  assign new_n351_ = ~x10 & x21 & x25 & (x05 | (x00 & ~x15));
  assign new_n352_ = x18 & ((~new_n353_ & x19) | (new_n355_ & x25 & ~x29));
  assign new_n353_ = x20 ? ((~x21 | ~x22) & (~new_n201_ | x21 | x27)) : new_n354_;
  assign new_n354_ = (x10 | ~x21 | ~x25) & (x21 | x29 | (~new_n182_ & ~x22));
  assign new_n355_ = ~x20 & ~x21;
  assign new_n356_ = ~x18 & (x21 ? ~new_n357_ : (~new_n358_ & ~x29));
  assign new_n357_ = (x10 | ~x25 | (x19 ? ~new_n201_ : ~x20)) & (~new_n336_ | x19 | x20);
  ...
  assign new_n364_ = (x20 | x28 | ~x29 | new_n232_ | x30) & (~x28 | x29 | new_n238_ | ~x30);
  ...
  assign new_n370_ = (new_n371_ | ~x18) & (new_n379_ | x18) & (new_n374_ | ~x20);
  assign new_n371_ = x20 ? (x19 ? (~x22 & ~x29) : new_n372_) : new_n373_;
  assign new_n372_ = (~x05 | ~new_n337_ | x28) & (~x28 | (x16 ? ~x08 : ~x07));
  assign new_n373_ = x19 ? (~x25 & ~x22 & ~x26) : (~x28 | x29);
  assign new_n374_ = ~new_n376_ & (x28 | (~new_n375_ & (x29 | (~new_n377_ & ~new_n378_))));
  assign new_n375_ = x11 & ~x19 & ~new_n167_ & x29;
  assign new_n376_ = ~x18 & ~new_n337_ & ~x19;
  assign new_n377_ = x05 & ((~x18 & x19 & x22) | (~x10 & ~x19 & x25));
  assign new_n378_ = x00 & ~x10 & ~x15 & ~x19 & x25;
  assign new_n379_ = (~x22 | ~x28 | x19 | x20) & (~x19 | ((~x28 | ~x29) & (~new_n380_ | x28 | x29)));
  assign new_n380_ = ~x10 & x25;
  assign new_n381_ = new_n154_ & ~x18 & ~x21 & x24 & x29;
  assign new_n382_ = x18 ? (x20 | (~x22 & ~x25)) : (~x20 | x29 | (~x22 & ~x26));
  assign z29 = z32 | (x00 & (~new_n388_ | (x20 & (new_n384_ | new_n392_))));
  assign new_n384_ = ~x29 & (new_n386_ | (x30 & (new_n387_ | (~new_n385_ & x21))));
  assign new_n385_ = x19 ? (~x18 & (~new_n113_ | ~new_n114_ | x18)) : (~new_n108_ & (x18 | ~x24));
  assign new_n386_ = new_n119_ & x03 & ~x21 & x27 & ~x30;
  assign new_n387_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n388_ = ~new_n391_ & (x20 | (~new_n390_ & (new_n389_ | x19)));
  assign new_n389_ = (x03 | x18 | new_n124_ | x21) & (~x18 | ~x21 | ~new_n115_ | x28);
  assign new_n390_ = new_n120_ & new_n182_ & x18 & x19 & ~x21;
  assign new_n391_ = ~x18 & x19 & x21 & new_n115_ & x28;
  ...
  assign new_n401_ = (~new_n402_ | ~x18) & (~new_n120_ | ~x22 | ~new_n175_ | x18);
  ...
  assign new_n430_ = new_n431_ & (new_n123_ | (~new_n436_ & (~new_n119_ | ~new_n355_)));
  ...
  assign new_n434_ = x00 & (x19 ? ((x20 & x21) | (~x20 & ~x21 & x26 & x28)) : ((~x20 & x21 & ~x28) | (x26 & x28 & x20 & ~x21)));
  assign new_n435_ = ~x21 & ((x20 & ((~x28 & (x19 ? ~x27 : x26)) | (x19 & (x27 | (~x27 & x28))))) | (x19 & ~x20 & x26 & ~x28));
  assign new_n436_ = new_n113_ & x00 & new_n154_ & x21 & ~x28;
  assign new_n437_ = ~x21 & ~x30 & (new_n438_ | (~new_n440_ & x29));
  assign new_n438_ = ~x03 & (new_n439_ | (new_n119_ & new_n198_ & x20));
  ...
  assign new_n451_ = new_n278_ & ~x14 & new_n201_ & ~x27;
  ...
  assign z37 = (~x21 & ~new_n498_ & ~x30) | (x30 & (~new_n464_ | new_n202_));
  ...
  assign new_n474_ = ~new_n481_ & (x19 | (~new_n480_ & (x28 | (~new_n350_ & ~new_n475_))));
  ...
  assign new_n483_ = (~x00 | ((x19 | ~x21 | x28) & (~x26 | ~x28 | ~x19 | x21))) & (new_n322_ | x21) & (x19 | ~x21 | ~x28);
  assign new_n484_ = x21 ? (~new_n485_ & ~new_n489_ & ~new_n493_) : (~new_n495_ & ~new_n326_);
  ...
  assign new_n489_ = ~x19 & ((~new_n490_ & x18) | (~new_n491_ & x29) | (new_n492_ & ~x18));
  ...
  assign new_n515_ = (~x21 | x28 | (~new_n113_ & x20)) & (~x11 | ~x20 | x21 | ~x26 | ~x28);
  ...
  assign new_n520_ = (~x19 | new_n181_ | x20) & (~x20 | ((~new_n182_ | x19) & (~new_n161_ | x04 | ~x19)));
  assign new_n521_ = ~new_n522_ & (~x20 | (x19 ? (~x22 | ~x28) : (~x23 | x28)));
  assign new_n522_ = ~x05 & ((x19 & x20 & x22) | (~x03 & ~x19 & ~x20 & ~x28));
  assign new_n523_ = new_n119_ & ~x05 & new_n157_ & x20 & ~x27;
  ...
  assign new_n532_ = (new_n533_ | ~x05) & (~new_n120_ | x21 | ~new_n278_ | ~x03);
  assign new_n533_ = (~x19 | ~x20 | ~x22 | (x21 ? (x29 | ~x30) : (~x29 | x30))) & (x19 | x20 | x21 | ~x29 | x30);
  assign new_n534_ = x30 & ((~x27 & x29 & x19 & ~x21) | (~x19 & x21 & ~new_n380_ & ~x29));
  assign z41 = ~new_n536_ & x21;
  assign new_n536_ = x30 & (~new_n537_ | ~x20 | ~x22 | x28 | x29 | ~x30);
