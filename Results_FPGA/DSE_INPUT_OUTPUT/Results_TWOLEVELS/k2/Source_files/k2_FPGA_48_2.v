// Benchmark "FAU" written by ABC on Tue Aug 25 04:42:34 2020
...
module FAU ( 
  ...
  assign new_n192_ = x19 & ~x20 & ~new_n95_ & x30;
  ...
  assign new_n208_ = (~x29 | ((~x01 | new_n149_ | x18) & (~x18 | ~x26 | ~x28))) & (~x18 | ~x26 | ~x28 | x29);
  assign new_n209_ = x27 & ~x29;
  assign new_n210_ = new_n211_ & x18;
  assign new_n211_ = ~x19 & x20 & x26 & x28 & (x29 | (x17 & ~x29));
  assign new_n212_ = ~new_n149_ & (new_n213_ | new_n214_);
  ...
  assign new_n223_ = (~x20 | ((~new_n224_ | x19) & (~new_n159_ | ~x19 | x21))) & (~x19 | x20 | new_n158_ | x21);
  assign new_n224_ = x26 & ~x28 & (x21 ? ~x11 : ~x17);
  assign new_n225_ = new_n155_ & x11 & x21 & x26 & ~x28 & x29;
  assign z15 = x21 ? ~new_n242_ : (x29 ? (new_n227_ | ~new_n230_) : ~new_n234_);
  ...
  assign new_n230_ = ~new_n183_ & (new_n231_ | x19);
  ...
  assign new_n241_ = (~x19 | (x20 ? ~x27 : ~new_n182_)) & (~new_n182_ | ~x20 | ~x17 | x19);
  assign new_n242_ = x30 & (x20 | ~x30 | (~new_n243_ & (new_n244_ | x18)));
  assign new_n243_ = new_n202_ & ~x19 & x00 & x18;
  ...
  assign new_n251_ = x20 ? (x27 | (~x28 & (~x05 | x28))) : new_n158_;
  ...
  assign new_n265_ = x30 & (x18 | x19 | ~new_n150_ | x20);
  ...
  assign new_n268_ = ~new_n149_ & (new_n213_ | (x20 & ~x21 & x18 & ~x19));
  ...
  assign new_n276_ = x18 ? ((new_n241_ | x21) & (~new_n280_ | ~x21 | ~x28)) : new_n277_;
  ...
  assign new_n286_ = (new_n149_ | ((x20 | (~new_n287_ & ~new_n117_)) & (~new_n117_ | ~x20 | x28))) & (~x20 | ~x26 | ~new_n117_ | x28);
  ...
  assign new_n299_ = (~x01 | x18 | new_n149_ | ~x19) & (~x00 | ~x18 | x19);
  assign z19 = x21 ? (new_n311_ | ~x30) : (new_n313_ | (~new_n301_ & x30) | (~new_n307_ & ~x30));
  assign new_n301_ = (x28 | (~new_n305_ & ~new_n306_)) & ~new_n304_ & (new_n302_ | ~x20);
  assign new_n302_ = x18 ? (x19 ? ~new_n209_ : ~x23) : ~new_n303_;
  assign new_n303_ = x22 & ~x29 & (~x19 | (x19 & ~new_n201_ & x28));
  ...
  assign new_n307_ = (~new_n120_ | x03 | ~x20 | ~x27 | x29) & (new_n308_ | ~x29);
  ...
  assign new_n311_ = ~x20 & x30 & (new_n243_ | (~new_n312_ & ~x18));
  ...
  assign z22 = (x30 & (new_n212_ | (~new_n320_ & ~x21) | (~new_n329_ & x21))) | (~x21 & ~new_n343_ & ~x30);
  ...
  assign new_n334_ = (~new_n336_ | ~x09 | x18 | x20) & (new_n335_ | ~x29);
  ...
  assign new_n341_ = x25 & (x10 ? (x18 & ~x20) : (x18 ? ~x20 : new_n202_));
  ...
  assign new_n346_ = (~x14 | x27 | x28) & (~x18 | (~new_n347_ & (new_n314_ | ~x28)));
  ...
  assign new_n366_ = (x20 | x28 | ~x29 | new_n233_ | x30) & (~x28 | x29 | new_n237_ | ~x30);
  ...
  assign new_n373_ = (~x05 | ~new_n339_ | x28) & (~x28 | (x16 ? ~x08 : ~x07));
  ...
  assign new_n377_ = ~x18 & ~new_n339_ & ~x19;
  ...
  assign new_n390_ = (new_n391_ | x19) & (~new_n121_ | ~new_n182_ | ~x18 | ~x19 | x21);
  ...
  assign new_n398_ = (~new_n252_ | x18 | ~x19) & (~new_n182_ | x19 | x17 | ~x18);
  ...
  assign new_n430_ = new_n431_ & (new_n124_ | (~new_n436_ & (~new_n120_ | ~new_n353_)));
  ...
  assign new_n436_ = new_n115_ & x00 & new_n155_ & x21 & ~x28;
  assign new_n437_ = ~x21 & (x21 | (~new_n438_ & (new_n440_ | ~x29)));
  assign new_n438_ = ~x03 & (new_n439_ | (new_n120_ & new_n209_ & x20));
  ...
  assign new_n520_ = (~x19 | new_n181_ | x20) & (~x20 | ((~new_n159_ | x04 | ~x19) & (~new_n182_ | x19)));
  assign new_n521_ = ~new_n522_ & (~x20 | (x19 ? (~x22 | ~x28) : (~x23 | x28)));
  assign new_n522_ = ~x05 & ((x19 & x20 & x22) | (~x03 & ~x19 & ~x20 & ~x28));
  assign new_n523_ = new_n120_ & ~x05 & new_n154_ & x20 & ~x27;
  ...
  assign new_n533_ = (new_n534_ | ~x05) & (~new_n121_ | x21 | ~new_n280_ | ~x03);
