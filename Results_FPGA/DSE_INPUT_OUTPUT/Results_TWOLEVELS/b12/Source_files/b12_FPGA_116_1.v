...
module FAU ( 
  ...
  assign z0 = (~x00 & ((x02 & ~x04 & (x01 | (~x01 & x03))) | (x01 & (x05 | (~x02 & x03))))) | (~x02 & x05);
  ...
  assign z6 = ~x07 & ~x10 & (new_n39_ | (~new_n38_ & ~x05));
  assign new_n38_ = (x08 | ((~x01 | x02) & (~x00 | (~x03 ^ x09)))) & (x00 | ((x02 | (~x01 & (~x03 | x09))) & (x01 | x03 | ~x09)));
  assign new_n39_ = x02 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = (~new_n43_ & x02) | (~x05 & (~new_n42_ | (~new_n41_ & ~x02)));
  assign new_n41_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign new_n42_ = (x03 | x08) & ~x07 & ~x10;
  assign new_n43_ = ~x07 & ~x10 & (x07 | x08);
  assign z8 = (~x00 & (x02 | (~x05 & ~x09))) | (~new_n45_ & (x02 | ~x05)) | (x09 & (x02 | (~new_n46_ & ~x05)));
