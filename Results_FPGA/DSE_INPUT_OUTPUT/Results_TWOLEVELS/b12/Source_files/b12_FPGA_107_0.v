...
module FAU ( 
  ...
  assign new_n32_ = (x02 | x06) & (x07 | (~new_n33_ & ~x02) | x08);
  assign new_n33_ = ~x01 & (x10 ? ~x03 : x09);
  assign new_n34_ = (~x01 | (x04 & ~x05)) & (~x04 | (x01 & x05)) & (x01 | ((~x03 | x04) & (x07 | x10)));
  ...
  assign z7 = (~new_n43_ & x06) | (x02 & (x07 | x10 | (~x07 & ~x08)));
  assign new_n43_ = (new_n44_ | x02) & (x03 | x08) & ~x07 & ~x10;
  assign new_n44_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign z8 = (~new_n30_ & (x07 | x10)) | (~new_n46_ & x09) | new_n30_ | (~x00 & ~x09);
