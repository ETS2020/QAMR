...
module FAU ( 
  ...
  assign z6 = (x02 & ~x04) | (~x07 & ~x10 & (x02 ? ~new_n38_ : new_n37_));
  assign new_n37_ = (~x00 | ~x08) & (x01 | (x03 & ~x09) | (~x03 & x09));
  assign new_n38_ = x00 ? x08 : (x14 & (x01 | ~x04));
  assign z7 = (~new_n40_ & x02) | new_n41_ | (~new_n42_ & ~x02) | (~x03 & ~x08);
  assign new_n40_ = x04 & (~x04 | x07 | x08);
  assign new_n41_ = (~x02 | x04) & (x07 | x10);
  assign new_n42_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign z8 = new_n44_ | new_n41_ | new_n47_ | (~x00 & (new_n45_ | new_n46_));
  assign new_n44_ = x01 & ((x04 & x05 & ~x00 & x02) | (~x02 & x09));
  assign new_n45_ = x02 & x04 & (~x05 | (~x01 & ~x07 & ~x10));
  assign new_n46_ = ~x02 & ~x09;
  assign new_n47_ = x09 & (x02 ? x04 : (~x03 | x12));
endmodule
