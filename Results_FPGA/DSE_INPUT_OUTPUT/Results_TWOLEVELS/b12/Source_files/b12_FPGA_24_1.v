...
module FAU ( 
  ...
  assign z3 = x11 ? ~x07 : (x00 | (~x00 & ~x12));
  assign z4 = x11 ? ~x07 : (~x00 | x07 | ~x08 | ~x09);
  assign z5 = (~x11 & (x00 | x10 | (~x00 & x12))) | x07 | ~x13 | (~x07 & x11);
  ...
  assign z7 = new_n44_ | x07;
  assign new_n44_ = ~x11 & ((~new_n45_ & ~x01) | x10 | (~x08 & (x01 | ~x03)));
  assign new_n45_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign z8 = x07 | (~x11 & ((~new_n47_ & x09) | x10 | (~x00 & ~x09)));
