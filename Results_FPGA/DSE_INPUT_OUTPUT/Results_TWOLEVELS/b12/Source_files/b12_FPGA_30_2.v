...
module FAU ( 
  ...
  assign z3 = (x00 & (~x11 | (~x07 & x12))) | (~x12 & (x08 | (~x08 & (~x07 | ~x11))));
  assign z4 = (~x11 & (x12 ? x07 : ~x08)) | (~x07 & ((~x08 & (x00 | ~x12)) | (x12 & (~x00 | ~x09))));
  assign z5 = ((~x08 | x12) & (x07 | (x00 & ~x07))) | (~x08 & (x10 | ~x13)) | (~x00 & ~x07 & x12);
  assign z6 = new_n39_ & ~x07;
  assign new_n39_ = ~x10 & ((~new_n40_ & (~x08 | (~x00 & x12))) | (x00 & x02 & ~x08));
  assign new_n40_ = (x01 | (~x02 & (x03 | ~x09))) & (x02 | (~x01 & (~x03 | x09))) & (~x02 | x14);
  assign z7 = ~new_n42_ | (~x01 & ~new_n44_ & x09);
  assign new_n42_ = ((x08 & ~x12) | (~x07 & ~x10)) & (x08 | (x03 & (new_n43_ | x07)));
  assign new_n43_ = ~x02 & (~x01 | x02 | x10);
  assign new_n44_ = (x07 | x08 | x10) & (x02 | ~x03 | ~x12);
  assign z8 = ~new_n46_ | (~x00 & ((~x07 & x12) | (~x08 & ~x09)));
  assign new_n46_ = ((x08 & ~x12) | (~x07 & ~x10)) & (~x09 | (~x12 & (new_n47_ | x08)));
  assign new_n47_ = ~x01 & ~x02 & (x01 | x03 | x07 | x10);
endmodule
