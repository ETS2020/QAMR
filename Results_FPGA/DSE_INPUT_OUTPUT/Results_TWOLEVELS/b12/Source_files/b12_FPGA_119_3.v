...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n32_, new_n33_, new_n35_, new_n36_, new_n38_,
    new_n39_, new_n40_, new_n42_, new_n44_, new_n46_, new_n47_;
  ...
  assign z7 = (x01 & (x02 | (~x08 & ~x10 & ~x02 & ~x07))) | ~new_n44_ | ((~x01 | ~x02) & (x07 | x10));
  assign new_n44_ = (x03 | x08) & (x01 | (x02 ? (x07 | x08) : (~x03 | ~x09)));
  assign z8 = (~x02 & ((~x00 & (~x09 | (new_n46_ & x01))) | ~new_n46_ | (~new_n47_ & x09))) | (~x01 & (~new_n46_ | (x02 & (x09 | (new_n46_ & ~x00)))));
