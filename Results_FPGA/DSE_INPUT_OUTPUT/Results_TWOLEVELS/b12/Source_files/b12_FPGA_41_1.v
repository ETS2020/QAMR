...
module FAU ( 
  ...
  assign new_n31_ = (new_n32_ | (~x07 & x09)) & (x01 | x07 | x09 | x10);
  assign new_n32_ = (~x01 | (x04 & ~x05)) & (~x04 | x05) & (x01 | (~x04 & (~x03 | x04)));
  assign new_n33_ = ~x01 & ~x03 & (x07 | (~x09 & x10));
  assign new_n34_ = ~x08 & ~x09 & (x02 | (~x01 & ~x03 & x10));
  assign z3 = z4 & (x00 | ~x12);
  assign z4 = x07 ? ~x11 : ~x09;
  assign z5 = x07 | (~x09 & ((~x07 & (x00 | x12)) | x10 | ~x13));
  assign z6 = ~x07 & ~x09 & ~new_n39_ & ~x10;
  assign new_n39_ = (x08 | ((x01 | ~x02) & (~x00 | (~x01 & ~x03)))) & (x00 | (x01 ? (x02 & x14) : (~x02 & ~x03)));
  assign z7 = x07 | (~new_n41_ & ~x09);
  assign new_n41_ = ~x10 & (x08 | (~x01 & x03 & (x01 | ~x02 | x07 | x10)));
  assign z8 = x07 | x09 | ~x00 | (~x09 & x10);
endmodule
