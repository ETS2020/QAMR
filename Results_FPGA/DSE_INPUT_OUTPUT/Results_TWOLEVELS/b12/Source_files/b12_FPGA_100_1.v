...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n30_, new_n31_, new_n33_, new_n34_, new_n35_,
    new_n36_, new_n41_, new_n42_, new_n44_, new_n45_, new_n46_, new_n48_;
  ...
  assign z3 = (x00 & (~x11 | (~x07 & x12))) | (~x12 & (~x11 | x13 | (~x07 & ~x13)));
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n27_ | (x07 & ~x11);
  assign z5 = (x07 & (x12 | ~x13)) | (~x07 & (x12 ? x00 : ~x13)) | (~x00 & x12);
  assign z6 = ~x07 & ~x10 & (new_n42_ | (~new_n27_ & ~new_n41_));
  assign new_n41_ = (~x01 | (x00 ? x08 : x02)) & ((x00 & x08) | ((x01 | (~x02 & (x03 | ~x09))) & (x02 | ~x03 | x09)));
  assign new_n42_ = ~x00 & ~x14 & ((x02 & x12) | (x01 & ~x13));
  assign z7 = (~new_n27_ & ~new_n44_) | new_n45_ | new_n27_ | new_n46_;
  assign new_n44_ = ~x07 & ~x10;
  assign new_n45_ = ~x08 & (x01 | ~x03 | (x02 & ~x07));
  assign new_n46_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (~x00 & (x12 | (~x09 & ~x13))) | (~new_n44_ & (x12 | ~x13)) | (x09 & (x12 | (~new_n48_ & ~x13)));
