...
module FAU ( 
  ...
  assign z1 = (~x02 & ~x06) | (~new_n29_ & ~x00);
  assign new_n29_ = (~x02 | ((x01 | (~x04 & (~x03 | x04))) & (x05 | (~x03 & ~x04)))) & (~x03 | (x06 & (~x01 | x02))) & (~x04 | x06);
  ...
  assign new_n36_ = x08 & x09 & (x00 | (x12 & (~x12 | (~x02 & ~x06))));
  ...
  assign z7 = (x06 & (~new_n44_ | (~new_n43_ & ~x02))) | (~new_n45_ & x02);
