...
module FAU ( 
  ...
  assign z4 = (~new_n32_ & ~x07) | (x07 & ~x11) | (~x01 & ~x02);
  assign new_n32_ = ((~x01 & ~x02) | (x08 & (x00 | ~x12))) & x09 & (x00 | x12);
  ...
  assign z8 = (~x00 & (x02 | (~x07 & ~x10 & x01 & ~x02))) | ((x01 | x02) & (x07 | x10)) | (~x01 & ~x02) | (~x07 & x09);
endmodule
