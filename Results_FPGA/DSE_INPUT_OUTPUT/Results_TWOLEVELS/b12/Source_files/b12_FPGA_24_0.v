...
module FAU ( 
  ...
  assign new_n34_ = ~x07 & (~x11 | (~x08 & (new_n35_ | (x02 & x11))));
  assign new_n35_ = ~x01 & (x10 ? ~x03 : x09);
  assign new_n36_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign z3 = (~x07 & ~x11) | ((x00 | ~x12) & (~x07 | ~x11));
  assign z4 = ~x11 | (~x07 & (~x00 | ~x08 | ~x09));
  assign z5 = (~x07 & (x00 | ~x11 | ~x13)) | x07 | x12 | (x10 & x11);
  ...
  assign new_n47_ = (x07 | (~x01 & x03)) & ~x02 & ~x12;
endmodule
