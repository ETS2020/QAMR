...
module FAU ( 
  ...
  assign new_n31_ = (x02 | ~x12) & (x07 | x08 | (~new_n32_ & ~x02));
  ...
  assign z4 = x07 ? (~x11 & (x02 | ~x12)) : ((~x00 & (~x12 | (x02 & x12))) | (~new_n37_ & (x02 | ~x12)));
  assign new_n37_ = x08 & x09;
  assign z5 = (~x07 & (x00 | (~x00 & x02 & x12))) | x07 | (~x02 & x12) | x10 | (~x12 & ~x13);
  assign z6 = (~x02 & x12) | (~x07 & ~x10 & (new_n40_ | new_n41_));
  ...
  assign z8 = ~new_n46_ | (x09 & (x01 | x02 | ~x03));
