...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ~x00) | (~x07 & ~x08 & (new_n32_ | x02)) | (~x02 & x08);
  assign new_n31_ = (~x02 | ((~x01 | (x04 & ~x05)) & (x01 | (~x04 & (~x03 | x04))) & x07 & (~x04 | x05))) & (x01 | x03 | ~x07);
  assign new_n32_ = ~x01 & (x10 ? ~x03 : x09);
  assign z3 = (x00 & (~x11 | (~new_n34_ & ~x07))) | new_n34_ | (~x12 & (~x07 | ~x11));
  assign new_n34_ = ~x02 & x08;
  assign z4 = (~x08 & (~x07 | ~x11)) | (x02 & (x07 ? ~x11 : (~x00 | (x00 & ~x09))));
  assign z5 = (~new_n34_ & (x07 | x10 | x12 | ~x13)) | (x00 & ~new_n34_ & ~x07);
