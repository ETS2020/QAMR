...
module FAU ( 
  ...
  assign z2 = (~x00 & (new_n34_ | (~new_n32_ & x02))) | (~new_n35_ & ~x08);
  assign new_n32_ = (~x01 | (x04 & ~x05)) & (x01 | (~new_n33_ & (~x03 | ~x08))) & (~x04 | x05 | ~x08);
  assign new_n33_ = ~x07 & ~x10;
  assign new_n34_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign new_n35_ = (x01 | ((x07 | ~x09 | x10) & (x03 | ~x10))) & ~x02 & ~x07;
  assign z3 = (x00 & (~x07 | (x08 & ~x11))) | (~x12 & ((~x00 & ~x07) | (x08 & ~x11)));
  assign z4 = x07 ? (x08 & ~x11) : (~x00 | ~x08 | ~x09);
  assign z5 = x07 ? x08 : (x00 | x10 | ~x13 | (~x00 & x12));
  ...
  assign z7 = ((new_n43_ | x07) & x08) | (~new_n44_ & ~x07);
  assign new_n43_ = ~x01 & ~x02 & x03 & x09;
  assign new_n44_ = ~x10 & (x08 | ((x01 | x10 | (~x02 & ~x09)) & ~x01 & x03));
  assign z8 = x07 ? x08 : ((~new_n46_ & x09) | x10 | (~x00 & ~x09));
