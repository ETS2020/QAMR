...
module FAU ( 
  ...
  assign z3 = (~x11 & (x00 | (x07 & ~x12))) | (x08 & x12) | (~x07 & (x00 ? (~x08 | ~x12) : ~x12));
  assign z4 = (~x07 & ((~x00 & (~x12 | (~x08 & x12))) | (x00 & ~x08) | (~x09 & ~x12))) | (~x11 & (~x08 | (x07 & ~x12)));
  assign z5 = ((~x08 | ~x12) & (x07 | (x00 & ~x07))) | (~x12 & (x10 | ~x13)) | (~x08 & x12 & ~x00 & ~x07);
  ...
  assign z8 = ~new_n46_ | (~x00 & ((~x09 & ~x12) | (~x07 & ~x08 & x12)));
  assign new_n46_ = ((x08 & x12) | (~x07 & ~x10)) & (~x09 | (x12 ? x08 : new_n47_));
