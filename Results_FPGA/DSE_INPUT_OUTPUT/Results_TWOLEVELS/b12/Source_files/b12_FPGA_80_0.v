...
module FAU ( 
  ...
  wire new_n28_, new_n31_, new_n33_, new_n35_, new_n37_;
  ...
  assign z5 = ((x01 | x02) & (~new_n35_ | x00 | x07)) | (x10 & (x01 | (~x00 & x02 & ~x07)));
  assign new_n35_ = ~x12 & x13;
  assign z6 = (~x01 & (~x02 | (~x00 & x02 & ~x07 & ~x10))) | (~x07 & ~new_n37_ & ~x10);
  assign new_n37_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n31_ & (x07 | x10 | (~x07 & ~x08));
  assign z8 = (~x00 & (x02 | (x01 & ~x07))) | ((x01 | x02) & (x07 | x10)) | (~x01 & ~x02) | (x00 & ~x07 & x09);
endmodule
