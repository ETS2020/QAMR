...
module FAU ( 
  ...
  assign z4 = (~x07 & (~x00 | ~x08 | (x00 & ~x09))) | new_n37_ | (x07 & ~x11);
  assign new_n37_ = ~x02 & ~x12;
  assign z5 = (x00 & (x09 ? x02 : ~x07)) | ~new_n39_ | (x02 & (x07 | x10));
  assign new_n39_ = (~x12 | (x00 & ~x07 & ~x09)) & x13 & (x02 | x12);
  assign z6 = new_n37_ | (~x07 & ~x10 & (new_n42_ | (~new_n41_ & ~x08)));
  ...
  assign new_n44_ = (new_n45_ | x02) & ~x07 & ~x10 & (x03 | x08);
  assign new_n45_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign z8 = new_n47_ | (x12 & (~x00 | x07 | x09 | x10));
  assign new_n47_ = x02 & ((~new_n48_ & ~x00) | x07 | x10 | (x00 & x09));
