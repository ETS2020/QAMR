...
module FAU ( 
  ...
  assign new_n31_ = ~x00 & ((~x03 & (x07 | x10)) | (x02 & x04));
  assign new_n32_ = x04 & (~x04 | ((x07 | x08) & (x00 | (x05 & (~x01 | ~x05)))));
  ...
  assign z7 = (~new_n44_ & x02) | new_n45_ | (~x03 & ~x08) | (~new_n46_ & ~x02);
  assign new_n44_ = x04 & (~x04 | x07 | x08);
  assign new_n45_ = (x07 | x10) & (~x02 | x04);
  assign new_n46_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign z8 = new_n48_ | new_n45_ | (x02 & ~new_n49_ & x04) | (~new_n50_ & ~x02);
