...
module FAU ( 
  ...
  assign z3 = (x00 & (~x07 | ~x11)) | (~x08 & x13) | (~x12 & (~x11 | (~x00 & ~x07)));
  assign z4 = (~new_n37_ & ~x07) | (~x08 & x13) | (x07 & ~x11);
  assign new_n37_ = new_n38_ & (x00 | (x12 & (~x08 | ~x12)));
  assign new_n38_ = x09 & (x08 | (~x02 & ~x10 & (x10 | (x01 ? (x02 | x13) : ~x09))));
  assign z5 = ~x13 | (x08 & (x00 | x07 | x10 | (~x00 & ~x07 & x12)));
  assign z6 = new_n41_ & ~x07;
  assign new_n41_ = ~x10 & ((~new_n42_ & (x08 ? ~x00 : ~x13)) | (~x08 & ~x13 & x00 & x02));
  assign new_n42_ = (~x01 | (x02 & x14)) & (x02 | ~x03 | x09) & (x01 | (~x02 & (x03 | ~x09)));
  assign z7 = ~new_n45_ | (~x02 & (new_n44_ | (~x01 & x03 & x09)));
  assign new_n44_ = x01 & ~x07 & ~x08 & ~x10 & ~x13;
  assign new_n45_ = (x08 | ((x07 | (~x02 & ~x10)) & x03 & ~x13)) & ~x07 & (~x08 | ~x10);
  assign z8 = (~x08 & (x13 | (~x07 & x10))) | new_n47_ | x07 | new_n48_ | (x08 & x10);
  assign new_n47_ = x09 & (x12 | (~x07 & (x01 | x02 | ~x03)));
