...
module FAU ( 
  ...
  assign z3 = (x00 & (x11 ? ~x07 : x09)) | (~x12 & ((x09 & ~x11) | (~x00 & ~x07 & x11)));
  assign z4 = (x09 & ((~x11 & (~x00 | x07)) | (~x07 & ~x08))) | (~x07 & x11 & (~x00 | ~x09));
  assign z5 = (x00 & (x11 ? ~x07 : x09)) | ~new_n38_ | ((x11 | (x09 & ~x11)) & (x07 | ~x13));
  assign new_n38_ = (~x09 | (~x10 & ~x12)) & (~x11 | (~x10 & (x00 | x07 | ~x12)));
  assign z6 = (~x09 & ~x11) | (~x07 & ~new_n40_ & ~x10);
  assign new_n40_ = (new_n41_ | (x00 ? x08 : x02)) & ~new_n42_ & (x00 | ~x02 | x14);
  assign new_n41_ = ~x01 & (~x03 | x09);
  assign new_n42_ = ~x01 & (x02 | (~x03 & x09)) & (~x00 | ~x08);
  assign z7 = (x07 & (x11 | (x09 & ~x11))) | ~new_n45_ | (~new_n44_ & ~x08);
  assign new_n44_ = (x07 | (~x09 & (~x02 | ~x11))) & (~x11 | (~x01 & x03));
  assign new_n45_ = (~x10 | ~x11) & (~x09 | (~x10 & (x01 | x02 | ~x03)));
  assign z8 = (x07 & (x11 | (x09 & ~x11))) | (~x09 & (~x00 | ~x11)) | (x10 & (x09 | x11)) | (~new_n47_ & x09);
