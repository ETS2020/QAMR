...
module FAU ( 
  ...
  assign new_n30_ = ~x00 & ((x02 & ((~x01 & (x04 | (x03 & ~x04))) | (~x05 & (x03 | x04)))) | (x01 & ~x02 & x03));
  assign z2 = (~new_n32_ & ~x00) | new_n28_ | (new_n35_ & ~x07);
  assign new_n32_ = (~x02 | ((~x01 | (x04 & ~x05)) & (~x04 | (x01 & x05)) & (new_n33_ | x01))) & (new_n34_ | x01);
  ...
  assign new_n45_ = (~x05 | x06) & (x01 | x02 | ~x03 | ~x09);
