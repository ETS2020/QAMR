...
module FAU ( 
  ...
  assign z3 = (x00 & ((~x08 & ~x11) | (~x07 & (~x08 | ~x12)))) | (~x12 & (x07 ? ~x11 : ~x00));
  assign z4 = (~x07 & ((~x00 & (~x12 | (~x08 & x12))) | (x00 & ~x08) | (~x09 & ~x12))) | (~x11 & (~x08 | (x07 & ~x12)));
  assign z5 = ((~x08 | ~x12) & (x07 | (x00 & ~x07))) | (x12 & (x08 | (~x00 & ~x07 & ~x08))) | (~x12 & (x10 | ~x13));
  assign z6 = (x08 & x12) | (new_n39_ & ~x07);
  assign new_n39_ = ~x10 & (new_n40_ | (~new_n41_ & ~x01) | (~x00 & x01 & ~x14));
  assign new_n40_ = (x01 | (x03 & ~x09)) & (x00 ? ~x08 : ~x02);
  assign new_n41_ = (x00 | ((~x02 | x12) & (x03 | ~x09))) & (x08 | (~x02 & (x03 | ~x09)));
  assign z7 = (new_n46_ & ~x02) | new_n43_ | (~x12 & (x07 | x10));
  assign new_n43_ = ~x08 & ((~x07 & ~new_n44_ & ~x10) | new_n45_ | ~x03 | x07 | x10);
  assign new_n44_ = x01 ? ~x00 : (~x02 & ~x09);
  assign new_n45_ = ~x00 & x02 & ((x04 & ~x05) | (x01 & (~x04 | x05)));
  assign new_n46_ = x03 & ((~x00 & x01 & ~x08) | (~x01 & x09 & ~x12));
  assign z8 = ~new_n48_ | (~x00 & ((~x09 & ~x12) | (~x07 & ~x08 & x12)));
  assign new_n48_ = ((x08 & x12) | (~x07 & ~x10)) & (~x09 | (x12 ? x08 : new_n49_));
