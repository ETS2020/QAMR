...
module FAU ( 
  ...
  assign z3 = ((~x07 | ~x11) & ((x00 & (~x02 | x09)) | (~x02 & ~x12))) | (x09 & ~x12 & (~x11 | (x02 & ~x07)));
  assign z4 = (~x09 & (x02 | ~x07)) | (~x07 & (~x00 | ~x08)) | (x07 & ~x11);
  assign z5 = ~new_n38_ & (~x02 | x09);
  ...
  assign z7 = (x02 & (~x09 | (~x07 & ~x08 & x09))) | ~new_n43_ | ((~x02 | x09) & (x07 | x10));
  assign new_n43_ = (new_n44_ | x02) & (x03 | x08);
  assign new_n44_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign z8 = (x02 & (~x09 | (~x07 & x09 & ~x12))) | ~new_n46_ | (~x02 & (x07 | x10));
  assign new_n46_ = x09 ? (~x01 & x03 & ~x07 & ~x12) : x00;
endmodule
