...
module FAU ( 
  ...
  assign z5 = (x00 & ~new_n35_ & ~x07) | new_n35_ | x07 | x10 | x12 | ~x13;
  assign z6 = ~x07 & ~new_n39_ & ~x10;
  assign new_n39_ = (x01 | ((new_n40_ | (x00 & x08)) & (x00 | ~x02))) & (~x02 | (x00 ? x08 : x14));
  assign new_n40_ = x03 ^ ~x09;
  assign z7 = (~new_n42_ & ~x02) | x07 | x10 | (~x08 & (~x03 | (x02 & ~x07)));
  assign new_n42_ = ~x01 & (~x03 | ~x09);
  assign z8 = (~new_n44_ & x09) | new_n35_ | x07 | x10 | (~x00 & ~x09);
