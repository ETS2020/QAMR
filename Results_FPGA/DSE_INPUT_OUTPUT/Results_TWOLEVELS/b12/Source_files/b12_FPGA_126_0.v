...
module FAU ( 
  ...
  assign z5 = (x00 & ~x07 & (x02 | x09)) | ~new_n36_ | x07 | (~x02 & ~x09);
  assign new_n36_ = ~x10 & ~x12 & x13;
  assign z6 = (~x02 & ~x09) | (~x07 & ~new_n38_ & ~x10);
  assign new_n38_ = x02 ? (x00 ? x08 : (x01 & x14)) : ((x00 & x08) | (~x01 & x03));
  assign z7 = ~new_n41_ | (~new_n40_ & ~x01);
  assign new_n40_ = (x02 | ~x03) & (x07 | x08 | ~x09 | x10);
  assign new_n41_ = (x02 | (x09 & (~x01 | x07 | x08 | x10))) & (~x02 | x07 | x08) & ~x07 & ~x10;
  assign z8 = (x02 & (~x00 | x09)) | (~new_n43_ & x09) | x07 | x10 | (~x02 & ~x09);
