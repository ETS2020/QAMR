...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n33_, new_n35_, new_n37_, new_n39_,
  ...
  assign new_n37_ = (x02 | (~x00 & (x00 | ~x12))) & (~x01 | (~x12 & (~x00 | (~x09 & (x07 | x09)))));
  ...
  assign z8 = (~new_n44_ & x09) | (~new_n42_ & ~new_n33_) | new_n33_ | new_n45_;
  assign new_n44_ = (~x00 | (~x01 & (x07 | ~x12))) & (x02 | x03);
  assign new_n45_ = ~x00 & ((x01 & ~x07) | ~x09 | (~x02 & x12));
endmodule
