...
module FAU ( 
  ...
  assign z4 = ((~x02 | ~x13) & (x07 ? ~x11 : ~new_n36_)) | (~x07 & ~x08 & (~x02 | (x02 & ~x13)));
  assign new_n36_ = x00 & x09;
  assign z5 = (~x02 & (x07 | x10)) | (~x07 & (x00 | (~x00 & ~x13))) | (x07 & ~x13) | x12 | (x02 & x13);
  ...
  assign new_n42_ = (~x02 | ~x13) & (x07 | x10);
  assign new_n43_ = x02 ? (x07 | x13) : (x03 & (~x01 | x07 | x10));
  assign new_n44_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (~x00 & (x02 ? ~x13 : ~x09)) | (x02 & (x09 | x13)) | new_n42_ | (~new_n46_ & x09);
