// Benchmark "FAU" written by ABC on Fri Aug 21 20:15:12 2020
...
module FAU ( 
  ...
  assign new_n30_ = (~x01 | (x04 & ~x05)) & (x01 | (~x04 & (~x03 | x04))) & x07 & (~x04 | x05);
  ...
  assign z6 = (x01 & ~x02) | (~x07 & ~x10 & ((~new_n38_ & ~x01) | (~new_n39_ & x02)));
  assign new_n38_ = ((x00 & x08) | (~x03 ^ x09)) & (x00 | ~x02);
  assign new_n39_ = x00 ? x08 : x14;
  assign z7 = ~new_n41_ | (~x02 & (x01 | (x03 & x09)));
  assign new_n41_ = ((x01 & ~x02) | (~x07 & ~x10)) & (x08 | ((x01 | x03) & (~x02 | x07)));
  assign z8 = new_n43_ | new_n44_ | (~new_n34_ & (x07 | x10));
  assign new_n43_ = ~x00 & ((x02 & ~x07) | (~x01 & ~x09));
  assign new_n44_ = x09 & (x02 | (~x01 & (~x03 | x12)));
endmodule
