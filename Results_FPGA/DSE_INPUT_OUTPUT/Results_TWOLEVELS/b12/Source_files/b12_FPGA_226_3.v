...
module FAU ( 
  ...
  assign z5 = ((~x02 | ~x04) & ((~new_n37_ & ~x07) | x07 | x10)) | (x12 & (~x04 | (~x02 & ~x07)));
  assign new_n37_ = ~x00 & x13;
  assign z6 = (x02 & x04) | (~x07 & ~x10 & (x02 ? ~new_n40_ : new_n39_));
  ...
  assign new_n43_ = x02 ? (x04 | x07) : (x03 & (~x01 | x07 | x10));
  assign new_n44_ = x03 & x09 & ~x01 & ~x02;
  assign z8 = (~x00 & (x02 ? ~x04 : ~x09)) | new_n42_ | (x09 & (x02 ? ~x04 : ~new_n46_));
