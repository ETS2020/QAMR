...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x07 | x10)) | new_n38_ | (~x07 & (x00 | x12 | ~x13));
  assign new_n38_ = ~x02 & x11;
  ...
  assign z7 = (~new_n38_ & (x07 | x10)) | new_n44_ | (~new_n43_ & ~x08);
  assign new_n43_ = x03 & (x07 | (~x02 & (x10 | x11 | ~x01 | x02)));
  assign new_n44_ = ~x02 & (x11 | (~x01 & x03 & x09));
  assign z8 = ~new_n46_ | (~new_n38_ & (x07 | x10));
