...
module FAU ( 
  ...
  assign z0 = new_n27_ | (x02 & ~x06);
  assign new_n27_ = ~x00 & ((x03 & (x01 ? ~x02 : (x02 & ~x04))) | (x01 & x02 & (~x04 | x05)));
  assign z1 = new_n29_ | (x02 & ~x06);
  assign new_n29_ = ~x00 & ((x02 & ((~x01 & (x04 | (x03 & ~x04))) | (~x05 & (x03 | x04)))) | (x01 & ~x02 & x03));
  assign z2 = (~new_n31_ & ~new_n32_) | (~x01 & ~new_n33_ & ~x02);
  assign new_n31_ = x00 & (x07 | x08);
  assign new_n32_ = (~x02 | ~x06) & (x01 | x02 | x03 | ~x10);
  ...
  assign new_n36_ = (x00 | (x12 & ((x02 & ~x06) | ~x12))) & x08 & x09;
  ...
  assign new_n41_ = x06 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = new_n43_ | new_n45_ | (~new_n44_ & ~x08);
  assign new_n43_ = (x07 | x10) & (~x02 | x06);
  assign new_n44_ = x02 ? (~x06 | x07) : (x03 & (~x01 | x07 | x10));
  assign new_n45_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (~x00 & (x02 ? x06 : ~x09)) | new_n43_ | (x09 & (x02 ? x06 : ~new_n47_));
