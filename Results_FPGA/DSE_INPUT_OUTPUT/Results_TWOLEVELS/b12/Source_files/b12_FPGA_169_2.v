...
module FAU ( 
  ...
  assign new_n34_ = ~x01 & x14 & ((~x03 & x10) | (~x07 & x09 & ~x10));
  assign new_n35_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = new_n27_ | ((x00 | ~x12) & (~x07 | ~x11));
  assign z4 = (~x08 & (~x07 | ~x11)) | (x14 & (x07 ? ~x11 : (~x00 | ~x09)));
  assign z5 = (~new_n27_ & (x07 | x10)) | x12 | (x00 & ~x07) | new_n27_ | ~x13;
  assign z6 = (x08 & ~x14) | (~x07 & ~x10 & (~new_n41_ | (~new_n40_ & ~x08)));
  assign new_n40_ = (~x00 | (~x01 & ~x02)) & (x02 | ~x03 | x09) & (x01 | x03 | ~x09);
  assign new_n41_ = (~x02 | (x14 & (x00 | x01))) & (x00 | x02 | (~x01 & (~x03 | x09) & (x03 | ~x09)));
  assign z7 = (~x08 & (new_n43_ | ~new_n44_)) | (~new_n45_ & x14);
  assign new_n43_ = x01 & (x00 ? (~x07 & ~x10) : (~x02 & x03));
  assign new_n44_ = (x07 | (~x02 & (x01 | ~x09 | x10))) & x03 & ~x07 & ~x10;
  assign new_n45_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n27_ & (x07 | x10)) | (~new_n47_ & x09) | new_n27_ | (~x00 & ~x09);
