...
module FAU ( 
  ...
  assign z3 = (x00 & (~x07 | ~x11)) | new_n27_ | (~x12 & (~x11 | (~x00 & ~x07)));
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n27_ | (x07 & ~x11);
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | ~x13 | (x13 & (x07 | x10));
  assign z6 = ~x07 & ~x10 & (new_n40_ | ~new_n42_);
  assign new_n40_ = ~new_n41_ & (x01 | (x03 & ~x09));
  assign new_n41_ = x00 ? (x08 | ~x14) : (x14 ? x02 : ~x13);
  assign new_n42_ = (~new_n44_ | x08) & (new_n43_ | (x00 & x08));
  assign new_n43_ = (~x02 | (x14 ? x01 : ~x13)) & (x01 | x03 | ~x09 | (~x13 & ~x14));
  assign new_n44_ = x13 & ((x00 & x03 & ~x09) | (x01 & ~x14));
  assign z7 = (~x08 & (new_n46_ | new_n47_ | (~new_n27_ & ~x03))) | (~new_n27_ & ~new_n48_);
  assign new_n46_ = x01 & (x14 | (x13 & ~x14 & ~x07 & ~x10));
  assign new_n47_ = x02 & ~x07 & ~x10 & (x14 ? ~x01 : x13);
  assign new_n48_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n27_ & (x07 | x10)) | (~new_n50_ & x09) | new_n27_ | (~x00 & ~x09);
