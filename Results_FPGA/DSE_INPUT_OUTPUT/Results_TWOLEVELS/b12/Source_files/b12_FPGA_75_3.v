...
module FAU ( 
  ...
  assign z2 = (~x01 & (new_n31_ | (~new_n30_ & ~x00))) | (x02 & (~new_n32_ | (~x00 & x01)));
  assign new_n30_ = (~x02 | (~x03 & (x07 | x10))) & (x03 | (~x07 & ~x10)) & (x07 | ~x09 | x10);
  assign new_n31_ = ~x07 & ~x08 & (x10 ? ~x03 : x09);
  assign new_n32_ = ~x04 & (x04 | x07 | x08);
  assign z3 = new_n34_ | ((~x07 | ~x11) & (x00 | ~x12));
  assign new_n34_ = x02 & x04;
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n34_ | (x07 & ~x11);
  assign z5 = (~new_n34_ & (x07 | x10)) | (~x07 & (x00 | ~x13)) | new_n34_ | x12;
  assign z6 = new_n34_ | (~x07 & ~x10 & (new_n38_ | new_n39_));
  assign new_n38_ = ~x08 & ((x00 & (x02 | (x03 & ~x09))) | (~x02 & (x01 | (~x03 & x09))));
  assign new_n39_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14) | (~x02 & (x01 | (x03 & ~x09))));
  assign z7 = (~new_n34_ & (x07 | x10)) | new_n42_ | (~new_n41_ & ~x08);
  assign new_n41_ = x02 ? (x04 | x07) : (x03 & (~x01 | x07 | x10));
  assign new_n42_ = x03 & x09 & ~x01 & ~x02;
  assign z8 = (x02 & (x04 | x09)) | ~new_n44_ | ((x07 | x10) & (~x02 | ~x04));
  assign new_n44_ = x09 ? (~x01 & x03 & ~x12) : x00;
endmodule
