...
module FAU ( 
  ...
  assign z1 = (x01 & (x02 | (~x00 & ~x02 & x03))) | (~x00 & x02 & (x04 | (~x01 & x03 & ~x04)));
  assign z2 = (~x01 & (~new_n30_ | (~new_n29_ & x02))) | (x02 & (new_n31_ | x01));
  assign new_n29_ = (x00 | ~x03 | x04) & (x07 | x08);
  assign new_n30_ = (x07 | ((x08 | (x10 ? x03 : ~x09)) & (x00 | ~x09 | x10))) & (x00 | x03 | (~x07 & ~x10));
  assign new_n31_ = ~x00 & (x04 | (~x07 & ~x10));
  ...
  assign new_n38_ = (x01 | ~x10) & (x07 | ((~x00 | (x02 & (x01 | (x09 & (~x02 | ~x09))))) & (x02 | ~x10)));
  ...
  assign z8 = new_n46_ | new_n47_ | new_n48_ | new_n49_ | new_n50_;
  assign new_n46_ = ~x00 & (~x09 | (x02 & ~x07 & ~x10));
  assign new_n47_ = x01 & (x02 | x09);
  assign new_n48_ = ~x02 & (x07 | (~x07 & x10));
  assign new_n49_ = ~x01 & (x07 | x10 | (~x07 & x09 & x00 & x02));
  assign new_n50_ = x09 & (~x03 | x12);
endmodule
