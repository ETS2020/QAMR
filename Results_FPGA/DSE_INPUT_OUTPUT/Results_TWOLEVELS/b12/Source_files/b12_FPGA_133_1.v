...
module FAU ( 
  ...
  assign new_n33_ = new_n34_ & (x04 | ((~x01 | (~x06 & x10)) & (~x03 | (x06 ? x01 : x10))));
  assign new_n34_ = (~x01 | ~x05 | (~x06 & x10)) & (~x04 | x05) & (x01 | (~x04 & (x07 | x10)));
  assign new_n35_ = (x06 | ~x10) & (~new_n36_ | x07);
  assign new_n36_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign new_n37_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign z3 = (x00 & (~x07 | ~x11)) | (~x06 & x10) | (~x12 & (~x11 | (~x00 & ~x07)));
  assign z4 = (~new_n40_ & ~x07) | (~x06 & x10) | (x07 & ~x11);
  assign new_n40_ = x00 & x08 & x09;
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | x07 | x10 | ~x13;
  assign z6 = (~x06 & x10) | (~x07 & ~new_n43_ & ~x10);
  ...
  assign z7 = (~new_n47_ & ~x01) | x07 | x10 | (~x08 & (x01 | ~x03));
  assign new_n47_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign z8 = (~new_n49_ & x09) | x07 | x10 | (~x00 & ~x09);
