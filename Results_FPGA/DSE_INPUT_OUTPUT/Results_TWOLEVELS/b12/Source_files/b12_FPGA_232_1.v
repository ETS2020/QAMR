...
module FAU ( 
  ...
  assign z2 = (~x00 & (x02 | (new_n31_ & x07 & ~x08))) | (~x07 & ~x08 & (new_n32_ | x02));
  assign new_n31_ = ~x01 & ~x03;
  assign new_n32_ = ~x01 & (x10 ? ~x03 : x09);
  assign z3 = ((~x07 | ~x11) & ((~x08 & (x00 | ~x12)) | (x02 & ~x12))) | (x00 & x02 & (~x07 | ~x11));
  assign z4 = (~x07 & (~x00 | (x00 & (~x08 | (x02 & ~x09))))) | (~x02 & x08) | (x07 & ~x11);
  assign z5 = (~new_n36_ & (x07 | x10 | x12 | ~x13)) | (x00 & ~new_n36_ & ~x07);
  ...
  assign z8 = new_n44_ | new_n43_ | (x09 & (new_n45_ | new_n46_));
  assign new_n43_ = (x07 | x10) & (x02 | ~x08);
  assign new_n44_ = ~x00 & (x02 | (~x08 & ~x09));
  assign new_n45_ = ~x07 & ((x00 & x02) | (~x02 & ~x03 & ~x08 & ~x10));
  assign new_n46_ = ~x08 & (x01 | x12);
endmodule
