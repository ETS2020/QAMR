...
module FAU ( 
  ...
  assign z1 = (~x00 & ((~x01 & (x04 ? x02 : x03)) | (x02 & ~new_n28_ & (x03 | x04)) | (x01 & ~x02 & x03))) | (~x02 & ~x04);
  ...
  assign z6 = ~x07 & ~x10 & ((~new_n39_ & ~x00) | (~new_n38_ & ~x08));
  assign new_n38_ = (~x00 | (~x02 & (~x03 | ~x04 | x09))) & (~x04 | (x01 ? x02 : (x03 | ~x09)));
  assign new_n39_ = (x01 | (~x02 & (x03 | ~x04 | ~x09))) & (x02 | ~x04 | (~x01 & (~x03 | x09))) & (~x02 | x14);
