...
module FAU ( 
  ...
  assign new_n32_ = (new_n33_ | ~x01) & ((x07 & x08) | (~new_n33_ & (x01 | ~x03))) & (x01 | x07 | x10);
  assign new_n33_ = x04 & ~x05;
  assign new_n34_ = x07 ? ~x08 : (new_n35_ | x08);
  ...
  assign z4 = (~x08 & ~x11) | (~x07 & (~x00 | ~x08 | ~x09));
  ...
  assign z7 = new_n45_ | (~new_n44_ & ~x08);
  assign new_n44_ = (~x01 | (x00 ? (x07 | x10) : (x02 | ~x03))) & x03 & ~x07 & (~x02 | x07);
  assign new_n45_ = ~x07 & (x10 | (~x01 & ~x02 & x03 & x09));
  assign z8 = x07 ? ~x08 : ((~new_n47_ & x09) | x10 | (~x00 & ~x09));
