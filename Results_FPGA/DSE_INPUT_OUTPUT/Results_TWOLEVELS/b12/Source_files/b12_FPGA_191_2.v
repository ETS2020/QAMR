...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n30_, new_n32_, new_n33_, new_n34_, new_n35_,
    new_n36_, new_n41_, new_n42_, new_n44_, new_n46_;
  ...
  assign new_n32_ = (new_n33_ | ~x01) & ((x07 & ~x11) | (~new_n33_ & (x01 | ~x03))) & (x01 | x07 | x10);
  assign new_n33_ = x04 & ~x05;
  assign new_n34_ = x07 ? x11 : ~new_n35_;
  assign new_n35_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign new_n36_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign z3 = ~x07 & (x00 | ~x12);
  assign z4 = ~x07 & (~x00 | ~x08 | ~x09);
  assign z5 = x07 ? x11 : (x00 | x10 | x12 | ~x13);
  assign z6 = ~x07 & ~new_n41_ & ~x10;
  assign new_n41_ = (new_n42_ | (x00 & x08)) & (~x01 | (x00 ? x08 : (x02 & x14)));
  assign new_n42_ = (x01 | (~x02 & (x03 | ~x09))) & (x02 | ~x03 | x09);
  assign z7 = (~new_n44_ & ~x01) | x07 | (~x08 & (x01 | ~x03)) | (~x07 & x10);
  assign new_n44_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign z8 = x07 | (~new_n46_ & x09) | (~x07 & x10) | (~x00 & ~x09);
  assign new_n46_ = (x07 | (~x02 & x03)) & ~x01 & ~x12;
endmodule
