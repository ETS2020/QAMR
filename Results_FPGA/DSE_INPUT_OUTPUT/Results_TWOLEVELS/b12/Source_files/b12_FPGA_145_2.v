...
module FAU ( 
  ...
  assign z3 = (x00 & (~x07 | ~x11)) | (~x12 & (x11 | (~x00 & ~x11)));
  assign z4 = (~x00 & (x12 ? ~x07 : ~x11)) | ((~x08 | ~x09) & (~x11 | (~x07 & x12))) | (x07 & ~x11);
  assign z5 = (x07 & (~x11 | x12)) | (x12 & (x09 | (~x07 & ~x09))) | (~new_n39_ & ~x11);
  assign new_n39_ = ~x00 & ~x10 & x13;
  assign z6 = ~x07 & ~x10 & (new_n41_ | new_n44_ | (~new_n27_ & ~new_n43_));
  assign new_n41_ = ~new_n42_ & (x00 ? ~x08 : ~x14);
  assign new_n42_ = (~x01 | x11) & (~x02 | ~x12);
  assign new_n43_ = ((x00 & x08) | ((x01 | x03 | ~x09) & (x02 | ~x03 | x09))) & (x00 | (~x01 ^ x02));
  assign new_n44_ = ~x08 & ((~x01 & x02 & ~x11) | (x00 & x01 & x12));
  assign z7 = new_n46_ | new_n27_ | new_n48_ | (~new_n27_ & (x07 | x10));
  assign new_n46_ = ~x01 & ((~x02 & x03 & x09) | (new_n47_ & x02 & ~x07));
  assign new_n47_ = ~x08 & ~x10 & ~x11;
  assign new_n48_ = ~x08 & (x01 | ~x03 | (x02 & ~x07 & x12));
  assign z8 = ~new_n50_ | (~x00 & ((~x09 & ~x11) | (~x07 & x12)));
  assign new_n50_ = ((x11 & ~x12) | (~x07 & ~x10)) & (~x09 | (~x12 & (new_n51_ | x11)));
