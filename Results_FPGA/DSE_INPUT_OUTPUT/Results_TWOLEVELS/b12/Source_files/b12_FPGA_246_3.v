...
module FAU ( 
  ...
  assign new_n34_ = ((x06 & x13) | (x01 ? x04 : ~new_n35_)) & (x13 | (x05 ? ~x01 : ~x04));
  ...
  assign z3 = ((~x07 | ~x11) & ((x00 & (~x06 | ~x13)) | (~x12 & ~x13))) | (~x06 & ~x12 & (~x11 | (~x00 & ~x07)));
  assign z4 = (~new_n28_ & (x07 ? ~x11 : (~x08 | ~x09))) | (~x00 & ~new_n28_ & ~x07);
  assign z5 = ((~x06 | ~x13) & (x07 | (x00 & ~x07))) | (~x00 & ~x07 & (~x13 | (~x06 & x12))) | (~x06 & x10);
