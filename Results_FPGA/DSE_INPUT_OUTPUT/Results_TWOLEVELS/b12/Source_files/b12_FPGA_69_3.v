...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n30_, new_n31_, new_n33_, new_n34_, new_n35_,
    new_n36_, new_n37_, new_n42_, new_n43_, new_n45_, new_n47_;
  ...
  assign new_n35_ = (~x01 | ((x04 | (x06 & x07)) & (~x05 | x07))) & (x07 | ((x01 | x10) & (~x04 | x05)));
  ...
  assign z7 = (~new_n45_ & ~x01) | x07 | (~x08 & (x01 | ~x03)) | (~x07 & x10);
  assign new_n45_ = (x02 | ~x03 | ~x09) & (x08 | x10 | ~x02 | x07);
  assign z8 = x07 ? ~x06 : ((~new_n47_ & x09) | x10 | (~x00 & ~x09));
