...
module FAU ( 
  ...
  assign new_n30_ = ~x13 & ((~x01 & (x04 | (x03 & ~x04))) | ((~x05 | ~x06) & (x03 | x04)));
  assign z2 = ((new_n32_ | new_n34_) & ~x00) | new_n28_ | (new_n35_ & ~x07);
  assign new_n32_ = x02 & ((x01 & (~x04 | x05)) | (~x13 & ((x04 & (~x01 | ~x05)) | (~new_n33_ & ~x01))));
  assign new_n33_ = (~x03 | x04) & (x07 | x10);
  ...
  assign z5 = ~x13 | (~x02 & (x00 | x07 | x10 | x12));
  assign z6 = ~x07 & ~x10 & (x02 ? new_n41_ : new_n40_);
  assign new_n40_ = (~x00 | ~x08) & (x01 | (~x03 & x09) | (x03 & ~x09));
  assign new_n41_ = ~x13 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = (x02 & (x13 | (~x07 & ~x08))) | ~new_n44_ | (~new_n43_ & ~x02);
  assign new_n43_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign new_n44_ = (x03 | x08) & ~x07 & ~x10;
  assign z8 = ~new_n46_ | (x02 & (x09 | x13));
  assign new_n46_ = (new_n47_ | ~x09) & ~x07 & ~x10 & (x00 | x09);
