...
module FAU ( 
  ...
  assign new_n31_ = (x03 | ~x11) & (~new_n32_ | x07);
  ...
  assign z4 = (~x11 & (x07 | (~x00 & x12))) | (~x03 & x11) | (~x07 & (~new_n37_ | (~x00 & (~x12 | (x03 & x12)))));
  assign new_n37_ = x08 & x09;
  assign z5 = ((~x11 | (x03 & ~x07)) & (x00 | (~x00 & x12))) | (x07 & (x03 | (~x11 & ~x12))) | (~new_n39_ & (x03 | ~x11));
  ...
  assign new_n42_ = ~x00 & ((x01 & (~x02 | ~x14)) | (~x02 & x03 & ~x09) | (~x01 & (x02 | (~x03 & x09))));
  assign z7 = ~new_n45_ | (~new_n44_ & ~x02);
  assign new_n44_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign new_n45_ = ((~x07 & ~x10) | (~x03 & x11)) & (x03 | (x08 & ~x11)) & (~x02 | x07 | x08);
  assign z8 = (~new_n47_ & (x03 | ~x11)) | (x09 & (x03 ? ~new_n48_ : ~x11));
