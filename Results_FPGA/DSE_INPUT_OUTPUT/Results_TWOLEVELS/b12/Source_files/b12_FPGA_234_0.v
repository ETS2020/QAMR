...
module FAU ( 
  ...
  assign z3 = (x00 & (x11 ? ~x07 : x02)) | (~x02 & ~x11) | (~x00 & ~x12 & (~x07 | (x02 & ~x11)));
  assign z4 = (~x11 & (~x02 | (x02 & (x07 | (~x00 & x12))))) | (~x07 & (~new_n37_ | (~x00 & (~x12 | (x11 & x12)))));
  assign new_n37_ = x08 & x09;
  assign z5 = ((x11 ? ~x07 : x02) & (x00 | (~x00 & x12))) | (x07 & (x11 | (x02 & ~x11))) | (~new_n39_ & (x02 | x11));
  assign new_n39_ = ~x10 & x13;
  assign z6 = ~x07 & ~x10 & ((~new_n42_ & ~x00) | (~new_n41_ & ~x08));
  assign new_n41_ = (~x00 | (~x02 & (~x03 | x09 | ~x11))) & (~x11 | (x01 ? x02 : (x03 | ~x09)));
  assign new_n42_ = (x01 | (~x02 & (x03 | ~x09 | ~x11))) & (x02 | ~x11 | (~x01 & (~x03 | x09))) & (~x02 | x14);
  assign z7 = (x07 & (x11 | (x02 & ~x11))) | ~new_n44_ | (x02 & (x10 | (~x07 & ~x08)));
  assign new_n44_ = new_n46_ & (new_n45_ | x08);
  assign new_n45_ = x03 & (~x01 | x02 | x07 | x10 | ~x11);
  assign new_n46_ = (~x10 | ~x11) & (x02 | (x11 & (x01 | ~x03 | ~x09)));
  assign z8 = ~new_n48_ | (x07 & (x11 | (x02 & ~x11)));
  assign new_n48_ = (~x02 | (~x09 & ~x10)) & (new_n49_ | ~x09) & (x00 | x09) & (~x10 | ~x11) & (x02 | x11);
