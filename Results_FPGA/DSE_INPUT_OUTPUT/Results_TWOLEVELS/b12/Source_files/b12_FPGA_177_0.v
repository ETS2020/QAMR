...
module FAU ( 
  ...
  assign z7 = (~x08 & (~x03 | (~new_n41_ & ~x07))) | new_n42_ | x07 | x10;
  assign new_n41_ = ~x02 & (~x01 | x02 | x10);
  assign new_n42_ = ~x02 & (~x04 | (~x01 & x03 & x09));
  assign z8 = (~new_n44_ & x09) | new_n34_ | x07 | x10 | (~x00 & ~x09);
