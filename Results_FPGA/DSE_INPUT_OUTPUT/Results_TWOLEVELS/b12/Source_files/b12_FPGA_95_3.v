...
module FAU ( 
  ...
  assign z0 = (~x00 & ((x01 & (x02 ? ~x04 : x03)) | (x02 & x03 & ~x04))) | (x02 & x05);
  assign z1 = (x02 & x05) | (~x00 & ((x02 & (x04 | (x03 & ~x04))) | (x01 & ~x02 & x03)));
