...
module FAU ( 
  ...
  assign z3 = (x00 & ((~x01 & (~x11 | (~x07 & ~x09))) | (x09 & (~x07 | ~x11)))) | (~x12 & ((~x01 & (~x07 | ~x11)) | (x09 & (~x11 | (x01 & ~x07)))));
  assign z4 = x07 ? (~x11 & (~x01 | x09)) : ((~x00 & (x09 | (~x01 & ~x09))) | (x00 & ~x01 & ~x09) | (~x08 & x09));
  assign z5 = (x00 & ~x07 & (x09 | (~x01 & ~x09))) | ((~x01 | x09) & (x07 | x12)) | ~new_n38_ | (x01 & ~x09);
  assign new_n38_ = ~x10 & x13;
  assign z6 = ~x07 & ~x10 & (new_n41_ | (~new_n40_ & x09));
  assign new_n40_ = (~x01 | (x00 ? x08 : x02)) & (x00 | ((x01 | x03) & (~x02 | x14))) & (x01 | x03 | x08);
  assign new_n41_ = ~x01 & (x02 | (x03 & ~x09)) & (~x00 | ~x08);
  assign z7 = (x07 & (~x01 | x09)) | (~new_n43_ & ~x01) | new_n44_ | x10 | (x01 & ~x09);
  assign new_n43_ = (x02 | ~x03 | ~x09) & (x08 | x10 | ~x02 | x07);
  assign new_n44_ = ~x08 & (~x03 | (~x07 & x09));
  assign z8 = (x07 & (~x01 | x09)) | (~new_n46_ & x09) | (~x01 & (x10 | (~x00 & ~x07 & ~x09)));
  assign new_n46_ = ~x02 & x03 & ~x12 & (~x01 | x07 | x12);
endmodule
