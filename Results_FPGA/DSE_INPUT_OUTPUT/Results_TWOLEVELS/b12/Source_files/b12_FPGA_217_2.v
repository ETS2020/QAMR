...
module FAU ( 
  ...
  assign new_n35_ = (~x01 | ((x04 | (x06 & ~x10)) & (~x05 | ~x10))) & (~x04 | x05 | ~x10) & (x01 | x06 | x07 | x10);
  assign new_n36_ = ~x01 & ((~x03 & (x10 | (~x06 & x07))) | (x09 & ~x10 & ~x06 & ~x07));
  assign new_n37_ = (x01 | ((x03 | ~x10) & (x06 | ~x09 | x10))) & (~x02 | (x06 & ~x10));
  assign z3 = ((~x07 | ~x11) & ((x10 & ~x12) | (x00 & (~x06 | x10)))) | (~x06 & ~x12 & (~x11 | (~x00 & ~x07)));
  assign z4 = (~new_n40_ & ~x07) | ((~x06 | x10) & (x07 ? ~x11 : ~x09));
  assign new_n40_ = ((x00 & x08) | ~x10) & (x06 | (x00 & (x08 | x10 | (x01 ? ~x00 : ~x09))));
  assign z5 = x10 | (~x06 & (x07 | ~x13 | (~x07 & (x00 | (~x00 & x12)))));
  assign z6 = ~x06 & ~x07 & ~new_n43_ & ~x10;
  assign new_n43_ = (new_n44_ | (x00 ? x08 : x02)) & ~new_n45_ & (x00 | ~x02 | x14);
  assign new_n44_ = ~x01 & (~x03 | x09);
  assign new_n45_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09));
  assign z7 = ~new_n48_ | (~x01 & (new_n47_ | (~x02 & x03 & x09)));
  assign new_n47_ = x02 & ~x06 & ~x07 & ~x08 & ~x10;
  assign new_n48_ = (x08 | (~x01 & x03)) & (x06 | ~x07) & ~x10 & (~x06 | x10);
  assign z8 = (~new_n50_ & x09) | x10 | (x06 & ~x10) | (~x00 & ~x09) | (~x06 & x07);
