...
module FAU ( 
  ...
  assign new_n41_ = (new_n42_ | (x00 & x08)) & (~new_n43_ | x08);
  assign new_n42_ = (~x02 | (x14 ? x01 : ~x13)) & (x01 | x03 | ~x09 | (~x13 & ~x14));
  assign new_n43_ = x13 & ((x00 & x03 & ~x09) | (x01 & ~x14));
  assign z7 = (~x08 & (new_n45_ | new_n46_ | (~new_n28_ & ~x03))) | (~new_n28_ & ~new_n47_);
  assign new_n45_ = x01 & (x14 | (x13 & ~x14 & ~x07 & ~x10));
  assign new_n46_ = x02 & ~x07 & ~x10 & (x14 ? ~x01 : x13);
  assign new_n47_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n28_ & (x07 | x10)) | (~new_n49_ & x09) | new_n28_ | (~x00 & ~x09);
