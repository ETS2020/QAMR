// Benchmark "FAU" written by ABC on Fri Aug 21 20:14:46 2020
...
module FAU ( 
  ...
  assign z8 = (x02 & (new_n43_ | ~new_n44_)) | (~new_n45_ & ~x01);
  assign new_n43_ = ~x00 & ((x04 & ~x05) | (x01 & (~x04 | x05)));
  assign new_n44_ = ~x07 & ~x09 & ~x10;
  assign new_n45_ = (~x09 | (x03 & ~x12)) & ~x07 & ~x10 & (x00 | x09);
endmodule
