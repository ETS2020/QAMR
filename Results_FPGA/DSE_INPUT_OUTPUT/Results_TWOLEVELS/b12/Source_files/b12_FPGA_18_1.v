...
module FAU ( 
  ...
  assign z4 = x07 ? (~new_n35_ & ~x11) : ~new_n40_;
  assign new_n40_ = (x00 | (x12 & (~x05 | ~x12))) & (~x05 | (x08 & (~x00 | x09))) & (x12 | (x08 & x09));
  assign z5 = (x00 & (~x12 | (x05 & ~x07 & ~x09))) | (x07 & (x05 | ~x12)) | (x05 & x12 & (x09 | (~x00 & ~x07))) | (~new_n42_ & ~x12);
  ...
  assign new_n47_ = ~x08 & ((~x01 & x02 & x05) | (x00 & x01 & ~x12));
  assign z7 = (~new_n35_ & x07) | new_n49_ | new_n50_ | new_n35_ | x10;
  assign new_n49_ = ~x08 & (x01 | ~x03 | (x02 & ~x07));
  assign new_n50_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (x05 & (x07 | (x09 & x12))) | ~new_n52_ | (~x12 & (x07 | (x01 & x09)));
  assign new_n52_ = (~x09 | (~x02 & x03)) & ~new_n35_ & ~x10 & (x00 | x09);
endmodule
