...
module FAU ( 
  ...
  assign z4 = (~new_n33_ & (x01 | x02)) | (~x00 & ~x07 & (x02 | (x01 & (x10 | (~x02 & ~x10)))));
  assign new_n33_ = x07 ? x11 : (x08 & (~x00 | x09));
  assign z5 = ((x01 | x02) & (~new_n35_ | x00)) | (~x00 & ((x02 & x07) | (x01 & ~x07 & x10))) | (x01 & x07) | (x02 & x10);
  assign new_n35_ = ~x12 & x13;
  assign z6 = new_n37_ & ~x07;
  assign new_n37_ = ~x10 & (x00 ? (~x08 & (x01 | x02)) : (x02 ? (~x01 | ~x14) : x01));
  assign z7 = new_n31_ | x07 | ~x08 | x10;
  assign z8 = (~x07 & (x00 ? x09 : (x02 | (x01 & ~x02 & ~x10)))) | x07 | x10 | (~x01 & ~x02);
endmodule
