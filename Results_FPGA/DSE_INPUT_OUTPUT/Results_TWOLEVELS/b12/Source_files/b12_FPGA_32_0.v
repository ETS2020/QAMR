...
module FAU ( 
  ...
  assign z3 = (~x11 & (x00 | ~x12)) | new_n31_ | (~x07 & (x00 | (~x00 & ~x12)));
  assign new_n31_ = ~x01 & ~x02;
  assign z4 = (~x07 & (~x00 | (~new_n31_ & ~x08) | (x00 & ~x09))) | new_n31_ | (x07 & ~x11);
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | (~new_n31_ & (x07 | x10)) | new_n31_ | ~x13;
  assign z6 = (~x01 & (~x02 | (~x00 & ~x07 & ~x10))) | (~x07 & ~new_n35_ & ~x10);
  assign new_n35_ = x00 ? x08 : (x02 & x14);
  assign z7 = ~new_n31_ & (x07 | x10 | (~x07 & ~x08));
  assign z8 = (~x07 & (~x00 | (x00 & x09))) | new_n31_ | (~new_n31_ & (x07 | x10));
endmodule
