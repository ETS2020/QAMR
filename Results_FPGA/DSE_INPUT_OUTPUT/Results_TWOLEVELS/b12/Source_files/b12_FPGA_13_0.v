...
module FAU ( 
  ...
  assign new_n31_ = x06 ? (x01 & x05) : ~x14;
  ...
  assign new_n35_ = ~x01 & ((x03 & x06) | (~x07 & ~x10 & x14));
  assign new_n36_ = x04 & (x06 ? ~x05 : x14);
  assign new_n37_ = (~x03 | x04) & (~x06 | x07 | x10 | x14);
  ...
  assign z6 = new_n44_ & ~x07;
  assign new_n44_ = ~x10 & ((~x08 & (~new_n46_ | (~new_n45_ & x00))) | (~new_n47_ & ~x00));
  assign new_n45_ = (~x03 | ~x06 | x09) & (~x01 | ~x14);
  assign new_n46_ = (~x02 | (x14 ? x01 : ~x06)) & (x01 | x03 | ~x09 | (~x06 & ~x14)) & (x09 | ~x14 | x02 | ~x03) & (~x01 | ~x06 | x14);
  assign new_n47_ = ((x14 ? x02 : ~x06) | (~x01 & (~x03 | x09))) & (~x02 | (x14 ? x01 : ~x06)) & (x01 | x03 | ~x09 | (~x06 & ~x14));
  ...
  assign new_n53_ = (~x09 | (~x02 & ~x12)) & ~x07 & ~x10 & (x00 | x09);
