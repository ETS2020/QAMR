...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x07 | x10)) | new_n38_ | (x00 & ~x07) | x12 | ~x13;
  assign new_n38_ = ~x02 & x11;
  assign z6 = new_n38_ | (~x07 & ~x10 & (new_n41_ | (~new_n40_ & ~x08)));
  assign new_n40_ = (~x00 | (~x02 & (~x03 | x09))) & (~x01 | x02 | x11) & (x01 | x03 | ~x09);
  assign new_n41_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14) | (~x02 & (x01 | (x03 & ~x09))));
  assign z7 = (~new_n43_ & ~x11) | (x02 & (x07 | x10 | (~x07 & ~x08)));
  assign new_n43_ = (new_n44_ | x02) & (x03 | x08) & ~x07 & ~x10;
  assign new_n44_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign z8 = (~new_n38_ & (x07 | x10)) | (~new_n46_ & x09) | new_n38_ | (~x00 & ~x09);
