...
module FAU ( 
  ...
  assign z5 = x07 | (~x07 & (x00 | x10 | x12 | ~x13));
  ...
  assign z7 = x07 ? x11 : ~new_n44_;
  assign new_n44_ = (x01 | (x02 ? (x08 | x10) : (~x03 | ~x09))) & ~x10 & (x08 | (~x01 & x03));
  assign z8 = x07 ? x11 : ((~new_n46_ & x09) | x10 | (~x00 & ~x09));
