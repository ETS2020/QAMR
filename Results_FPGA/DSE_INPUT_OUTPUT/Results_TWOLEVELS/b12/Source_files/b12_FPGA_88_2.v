...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | ((~x01 | x02) & (x01 | ~x02 | x04 | ~x12))) & (~x01 | ~x02 | ~x12 | (x04 & ~x05));
  ...
  assign new_n32_ = (x01 | x02 | x03 | ~x10) & (~x02 | ~x12);
  assign new_n33_ = (x00 | (x07 ? x03 : (~x09 | x10))) & (~x09 | x10 | x07 | x08);
  assign z3 = (x00 & x12 & (~x07 | ~x11)) | (~x02 & ~x12 & (~x07 | (x07 & ~x11)));
  assign z4 = x07 ? (~x11 & (x12 | (~x02 & ~x12))) : ((~new_n36_ & (~x02 | x12)) | (~x08 & (~x02 | (x02 & x12))));
  assign new_n36_ = x00 & x09;
  assign z5 = x10 | x00 | x07 | (~x02 & ~x13) | (x02 & ~x12) | (~x00 & ~x07 & x12);
  ...
  assign z7 = (x02 & (~x12 | (~x07 & ~x08 & x12))) | ~new_n43_ | (~new_n42_ & ~x02);
  assign new_n42_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign new_n43_ = (x03 | x08) & ~x07 & ~x10;
  assign z8 = ~new_n45_ | (x09 & (x01 | ~x03 | x12));
  assign new_n45_ = ~x07 & (x00 | x09) & ~x10 & (~x02 | x12);
endmodule
