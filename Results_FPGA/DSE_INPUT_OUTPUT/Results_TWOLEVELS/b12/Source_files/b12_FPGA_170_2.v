...
module FAU ( 
  ...
  assign z3 = (x00 & (x11 ? ~x07 : ~x10)) | (~x11 & (x10 | ~x12)) | (~x07 & ~x12);
  assign z4 = (~x11 & (x07 | x10)) | (~x07 & (~x00 | ~x08 | ~x09));
  assign z5 = (x00 & (x11 ? ~x07 : ~x10)) | (x10 & x11) | (~x10 & (x07 | x12 | (~x07 & ~x13)));
  assign z6 = (x10 & ~x11) | (~x07 & ~new_n41_ & ~x10);
  assign new_n41_ = (new_n42_ | (x00 & x08)) & (~x01 | (x00 ? x08 : (x02 & x14)));
  assign new_n42_ = (x01 | (~x02 & (x03 | ~x09))) & (x02 | ~x03 | x09);
  assign z7 = x10 ? x11 : ~new_n44_;
  assign new_n44_ = (x01 | (x02 ? (x07 | x08) : (~x03 | ~x09))) & ~x07 & (x08 | (~x01 & x03));
