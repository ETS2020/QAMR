...
module FAU ( 
  ...
  assign new_n30_ = (~x02 | x04 | (~x03 & (x07 | x10))) & (x03 | (~x07 & ~x10)) & (x07 | ~x09 | x10);
  assign new_n31_ = ~x07 & ~x08 & (x10 ? ~x03 : x09);
  assign new_n32_ = x02 & (x04 | (~x00 & x01 & ~x04) | (~x07 & ~x08));
  assign z3 = (~x11 & (x00 | ~x12)) | new_n34_ | (~x07 & (~x12 | (~new_n34_ & x00)));
  assign new_n34_ = x02 & x04;
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n34_ | (x07 & ~x11);
  assign z5 = ~new_n34_ & ((~x07 & (x00 | ~x13)) | x07 | x10 | x12);
  assign z6 = ~x07 & ~x10 & (x02 ? new_n39_ : new_n38_);
  assign new_n38_ = (~x00 | ~x08) & (x01 | (x03 & ~x09) | (~x03 & x09));
  assign new_n39_ = ~x04 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = (~new_n41_ & x02) | new_n42_ | (~x03 & ~x08) | (~new_n43_ & ~x02);
  assign new_n41_ = ~x04 & (x07 | x08);
  assign new_n42_ = (~x02 | ~x04) & (x07 | x10);
  assign new_n43_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign z8 = new_n42_ | ~new_n45_ | (x02 & (x04 | x09));
  assign new_n45_ = x09 ? (~x01 & ~x12 & (x03 | x07)) : x00;
endmodule
