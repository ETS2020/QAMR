...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & ~x07) | new_n35_ | (x07 & ~x11);
  assign new_n37_ = (x00 | (x12 & (~x12 | (~x01 & x02)))) & x08 & x09;
  ...
  assign z7 = (~x01 & (x02 | (x03 & x09))) | (~new_n43_ & (x01 | ~x02)) | (~x08 & (x01 | ~x03));
  assign new_n43_ = ~x07 & ~x10;
  assign z8 = (~new_n35_ & ~new_n43_) | (~new_n45_ & x09) | new_n35_ | (~x00 & ~x09);
