...
module FAU ( 
  ...
  assign new_n32_ = x02 & ((~x07 & ~x08) | (~x00 & ~x05));
  assign new_n33_ = x02 & ((~x07 & ~x08) | (~x00 & (~x04 | x05)));
  ...
  assign z6 = (~x01 & ~x04) | (~x07 & ~x10 & (new_n39_ | (~new_n40_ & x01)));
  assign new_n39_ = (~x00 | ~x08) & ((~x01 & (x02 | (~x03 & x09))) | (~x02 & x03 & ~x09));
  assign new_n40_ = x00 ? x08 : (x02 & x14);
  assign z7 = (~x01 & (new_n42_ | ~x04)) | new_n43_ | ((x07 | x10) & (x01 | x04));
  assign new_n42_ = ~x02 & x03 & x09;
  assign new_n43_ = ~x08 & (x01 | ~x03 | (x02 & x04 & ~x07));
