...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n30_, new_n31_, new_n33_, new_n34_, new_n35_,
    new_n36_, new_n37_, new_n38_, new_n43_, new_n44_, new_n45_, new_n47_,
  ...
  assign new_n33_ = (~x01 | (x04 & ~x05)) & new_n35_ & (~x06 | ((new_n34_ | x01) & (~x04 | x05)));
  assign new_n34_ = ~x03 & (x07 | x10);
  assign new_n35_ = (~x03 | x04) & (x14 | ((x07 | x10) & (~x04 | x06)));
  ...
  assign new_n43_ = (new_n44_ | (~x01 & (~x03 | x09))) & (~new_n45_ | (~x02 & (x03 | ~x09)));
  assign new_n44_ = (x00 | (x14 & (x02 | ~x06))) & (x08 | (x14 & (~x00 | ~x06)));
  assign new_n45_ = (~x14 | (~x01 & x06)) & (~x00 | ~x08);
  assign z7 = (~new_n28_ & ~new_n49_) | (~x08 & (new_n47_ | new_n48_ | (~new_n28_ & ~x03)));
  assign new_n47_ = x01 & (x06 | (~x07 & ~x10 & ~x14));
  assign new_n48_ = x02 & ~x07 & ~x10 & (~x14 | (~x01 & x06));
  assign new_n49_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n51_ & (x06 | ~x14)) | (x09 & ~new_n52_ & (~x14 | (x06 & ~x07)));
  assign new_n51_ = (~x09 | (~x02 & ~x12)) & ~x07 & ~x10 & (x00 | x09);
