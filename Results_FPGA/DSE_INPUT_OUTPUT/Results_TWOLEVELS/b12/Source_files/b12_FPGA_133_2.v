...
module FAU ( 
  ...
  assign new_n34_ = (x01 | (~x04 & (x07 | x10))) & (~x04 | (x05 & x06)) & (~x01 | ~x05 | ~x10);
  ...
  assign z6 = ~x10 & (x06 | (~new_n43_ & ~x07));
  ...
  assign z7 = (~new_n47_ & ~x01) | ~new_n48_ | (~x08 & (x01 | ~x03));
  assign new_n47_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign new_n48_ = ~x07 & ~x10 & (~x06 | x10);
  assign z8 = (~new_n50_ & x09) | x10 | (x06 & ~x10) | x07 | (~x00 & ~x09);
