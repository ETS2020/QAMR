...
module FAU ( 
  ...
  assign z1 = (x01 & (x02 | (~x00 & ~x02 & x03))) | (~x00 & ~x01 & x02 & (x04 | (x03 & ~x04)));
  ...
  assign z6 = new_n32_ | (~x07 & ~new_n37_ & ~x10);
  assign new_n37_ = (~x01 | (x00 & (x02 | x08))) & (~x02 | (x08 & (x00 | x01))) & ((x03 ^ ~x09) | (x00 & x08));
  assign z7 = (~new_n39_ & (~x01 | ~x02)) | (~new_n40_ & ~x01) | (~x02 & ~x08 & (~x03 | (new_n39_ & x01)));
  assign new_n39_ = ~x07 & ~x10;
  assign new_n40_ = x02 ? (x07 | x08) : (~x03 | ~x09);
  assign z8 = new_n42_ | new_n43_ | (~new_n39_ & ~new_n32_);
  assign new_n42_ = ~x00 & ((~x02 & ~x09) | (~x01 & x02 & ~x07 & ~x10));
  assign new_n43_ = x09 & ((~x01 & (x02 | ~x03)) | (~x02 & (x01 | x12)));
endmodule
