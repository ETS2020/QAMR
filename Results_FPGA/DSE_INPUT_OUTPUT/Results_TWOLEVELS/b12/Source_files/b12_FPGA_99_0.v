...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ~x00) | (~x08 & (new_n34_ | ~x13));
  ...
  assign z4 = (~x08 & (~x07 | ~x13)) | (~x07 & (~x00 | ~x09)) | (x07 & ~x11);
  assign z5 = x13 ? (x00 | x07 | x10 | x12) : x08;
  assign z6 = ~x07 & ~new_n39_ & ~x10;
  assign new_n39_ = (new_n40_ | (x08 ? x00 : ~x13)) & (~new_n41_ | x00) & (x08 | ~x13 | ~x00 | ~x02);
  assign new_n40_ = (x01 | (~x02 & (x03 | ~x09))) & (x02 | (~x01 & (~x03 | x09)));
  assign new_n41_ = x01 & (x08 | x13) & ~x14;
  assign z7 = ~new_n44_ | (~x02 & (new_n43_ | (~x01 & x03 & x09)));
  assign new_n43_ = x01 & ~x07 & ~x08 & ~x10 & x13;
  assign new_n44_ = ~x07 & ~x10 & (x08 | (x03 & x13 & (~x02 | x07)));
  assign z8 = ~new_n46_ | (x09 & (x01 | x02 | ~x03 | x12));
  assign new_n46_ = ~x07 & (x00 | x09) & ~x10 & (x08 | x13);
endmodule
