...
module FAU ( 
  ...
  assign z0 = (~x02 & (~x05 | (~x00 & x01 & x03 & x05))) | (~x00 & x02 & (x01 ? (~x04 | x05) : (x03 & ~x04)));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (~x02 | ((x01 | (~x04 & (~x03 | x04))) & ((x05 & x06) | (~x03 & ~x04)))) & (~x03 | ~x05 | ~x01 | x02);
  ...
  assign z7 = (x05 & (~new_n42_ | (~new_n41_ & ~x02))) | (~new_n43_ & x02);
