...
module FAU ( 
  ...
  assign z5 = (x07 & (x02 | ~x12)) | (x02 & (x00 ? (x09 | (~x07 & ~x09)) : (~x07 & x12))) | (~x12 & (~new_n39_ | x00));
  ...
  assign z8 = new_n47_ | ((x02 | ~x12) & (x07 | x10)) | new_n48_ | (~x02 & x12);
  assign new_n47_ = ~x00 & (~x09 | (~x01 & x02 & ~x07 & ~x10));
  assign new_n48_ = x09 & (x01 | ~x03 | (x00 & x02));
endmodule
