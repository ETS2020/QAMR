...
module FAU ( 
  ...
  assign z6 = (~x02 & x07) | (~x10 & ((~new_n36_ & ~new_n37_) | (x02 & ~new_n38_ & ~x07)));
  assign new_n36_ = x00 & x08;
  assign new_n37_ = (x02 | (~x01 & (~x03 | x09))) & (x07 | ~x09 | x01 | x03);
  assign new_n38_ = x00 ? x08 : (x01 & x14);
  assign z7 = (x02 & (x07 | (~x07 & ~x08))) | (~new_n40_ & ~x08) | (~x02 & (new_n41_ | x07)) | (~x07 & x10);
  assign new_n40_ = x03 & (~x01 | x02 | x10);
