...
module FAU ( 
  ...
  assign z5 = ~x13 | x10 | x12 | x07 | new_n28_ | (x00 & ~x07);
  assign z6 = new_n28_ | (~x07 & ~x10 & (new_n39_ | new_n40_));
  assign new_n39_ = (~x00 | ~x08) & ((~x01 & (x02 | (~x03 & x09))) | (~x02 & x03 & ~x09));
  assign new_n40_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = (~new_n42_ & ~x08) | ~new_n43_ | x07 | (~x04 & x08);
  assign new_n42_ = ~x01 & x03 & (~x02 | x07);
  assign new_n43_ = ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n45_ | (x09 & (x01 | x02 | ~x03 | x12));
  assign new_n45_ = ~x07 & (x04 | ~x08) & ~x10 & (x00 | x09);
endmodule
