...
module FAU ( 
  ...
  assign new_n32_ = x02 & ((x01 & (~x04 | x05)) | (~x01 & (x04 | (x03 & ~x04))) | new_n33_ | (x04 & ~x05));
  assign new_n33_ = ~x07 & ~x10 & ~x14;
  ...
  assign z5 = (~x07 & (x00 | ~x13)) | x10 | x12 | (~x10 & x14) | (x07 & ~x14);
  assign z6 = ~x07 & ~x10 & new_n40_ & ~x14;
  assign new_n40_ = (~x00 | ~x08) & (x01 | x02 | (x03 & ~x09) | (~x03 & x09));
  assign z7 = (~new_n42_ & ~x08) | (x07 & ~x14) | (~x10 & x14) | new_n43_ | x10;
  assign new_n42_ = x03 & (x07 | x10 | (~x01 & ~x02) | x14);
