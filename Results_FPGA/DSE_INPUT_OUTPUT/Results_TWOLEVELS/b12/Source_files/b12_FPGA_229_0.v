...
module FAU ( 
  ...
  assign z2 = (~new_n33_ & ~x00) | (~x07 & (new_n35_ | ~x14));
  assign new_n33_ = (new_n34_ | x01) & (~x02 | ((~x04 | x05) & (~x01 | new_n27_ | (x04 & ~x05))));
  assign new_n34_ = (~x02 | (~x03 & (x07 | x10 | ~x14))) & (x03 | (~x07 & ~x10)) & (x07 | ~x09 | x10);
  ...
  assign z5 = x07 | (x14 & ((~x07 & (x00 | (~x00 & x12))) | x10 | ~x13));
  assign z6 = ~x07 & ~x10 & ~new_n40_ & x14;
  assign new_n40_ = ((~x01 & (~x03 | x09)) | (x00 ? x08 : x02)) & (x01 | (~x02 & (x03 | ~x09)) | (x00 & x08));
  assign z7 = new_n42_ | x07;
  assign new_n42_ = x14 & ((~new_n43_ & ~x01) | x10 | (~x08 & (x01 | ~x03)));
  assign new_n43_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign z8 = (~new_n45_ & x09) | x07 | (~x00 & ~x09) | (~x07 & ~x14) | (x10 & x14);
