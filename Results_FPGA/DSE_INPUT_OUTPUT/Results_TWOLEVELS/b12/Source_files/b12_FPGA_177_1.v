...
module FAU ( 
  ...
  assign z6 = new_n35_ | (~x07 & ~x10 & (new_n39_ | new_n40_));
  assign new_n39_ = ~x08 & ((x00 & (x02 | (x03 & ~x09))) | (x01 & ~x02) | (~x01 & ~x03 & x09));
  assign new_n40_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14) | (~x02 & (x01 | (x03 & ~x09))));
  assign z7 = (~x08 & (~x03 | (~new_n42_ & ~x07))) | new_n43_ | x07 | x10;
  assign new_n42_ = ~x02 & (~x01 | x02 | x10);
  assign new_n43_ = ~x02 & (x04 | (~x01 & x03 & x09));
  assign z8 = (~new_n45_ & x09) | new_n35_ | x07 | x10 | (~x00 & ~x09);
