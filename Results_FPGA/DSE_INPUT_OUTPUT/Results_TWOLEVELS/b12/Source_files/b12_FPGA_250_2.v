...
module FAU ( 
  ...
  assign z5 = (~x07 & (x00 | ~x13)) | new_n33_ | x07 | x10 | x12;
  assign z6 = new_n33_ | (~x07 & ~x10 & (new_n37_ | new_n38_));
  assign new_n37_ = ~x08 & ((x00 & (x02 | (x03 & ~x09))) | (~x01 & ~x03 & x09));
  assign new_n38_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14) | (~x02 & x03 & ~x09));
  assign z7 = (~new_n40_ & ~x02) | (~x08 & (~x03 | (x02 & ~x07))) | x07 | x10;
  assign new_n40_ = ~x01 & (~x03 | ~x09);
  assign z8 = ~new_n42_ | (x09 & (x02 | ~x03 | x12));
  assign new_n42_ = ~x07 & (~x01 | x02) & ~x10 & (x00 | x09);
endmodule
