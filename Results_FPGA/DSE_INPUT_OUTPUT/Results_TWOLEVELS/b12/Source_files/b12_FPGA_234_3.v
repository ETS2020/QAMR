...
module FAU ( 
  ...
  assign z3 = (x00 & (~x11 | (~x02 & ~x07))) | (x02 & x11) | (~x12 & (x07 ? ~x11 : ~x00));
  assign z4 = (~x11 & (x07 | (~x00 & x12))) | (x02 & x11) | (~x07 & (~new_n36_ | (~x00 & (~x12 | (~x02 & x12)))));
  assign new_n36_ = x08 & x09;
  assign z5 = ((~x11 | (~x02 & ~x07)) & (x00 | (~x00 & x12))) | (x07 & (~x02 | (~x11 & ~x12))) | (~new_n38_ & (~x02 | ~x11));
  ...
  assign z7 = (~new_n43_ & x02) | new_n44_ | (~new_n45_ & ~x02) | (~x03 & ~x08);
  assign new_n43_ = ~x11 & (x07 | x08 | x11);
  assign new_n44_ = (~x02 | ~x11) & (x07 | x10);
  assign new_n45_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign z8 = new_n44_ | ~new_n47_ | (x02 & (x09 | x11));
