...
module FAU ( 
  ...
  assign new_n34_ = (~x01 | ~x05 | (~x06 & (~x04 | x06 | ~x10))) & (x01 | (~x04 & (x07 | x10))) & (~x04 | x05);
  assign new_n35_ = ~new_n30_ & (~new_n36_ | x07);
  assign new_n36_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign new_n37_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign z3 = (x00 & (~x07 | ~x11)) | new_n30_ | (~x12 & (~x11 | (~x00 & ~x07)));
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n30_ | (x07 & ~x11);
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | x07 | x10 | ~x13 | (~x06 & ~x10);
  assign z6 = ~x10 & (~x06 | (~new_n42_ & ~x07));
  ...
  assign z7 = (~new_n46_ & ~x01) | ~new_n47_ | (~x08 & (x01 | ~x03));
  assign new_n46_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign new_n47_ = ~x07 & ~x10 & (x06 | x10);
  assign z8 = (~new_n49_ & x09) | x10 | (~x06 & ~x10) | x07 | (~x00 & ~x09);
