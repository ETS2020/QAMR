...
module FAU ( 
  ...
  assign new_n40_ = (~x00 | (~x02 & (~x03 | x09))) & (x01 | x03 | ~x09) & (~x01 | x02 | ~x14);
  assign new_n41_ = ~x00 & ((x01 & (~x02 | ~x14)) | (~x01 & (x02 | (~x03 & x09))) | (~x02 & x03 & ~x09));
  assign z7 = (~x01 & ~new_n44_ & x09) | new_n43_ | (new_n45_ & ~x08);
  assign new_n43_ = (x08 | x14) & (x07 | x10);
  assign new_n44_ = (x02 | ~x03 | ~x08) & (x07 | x08 | x10 | ~x14);
  assign new_n45_ = x14 & (~x03 | (~x07 & (x02 | (x01 & ~x02 & ~x10))));
  assign z8 = new_n43_ | (~new_n47_ & x09) | new_n27_ | (~x00 & ~x09);
