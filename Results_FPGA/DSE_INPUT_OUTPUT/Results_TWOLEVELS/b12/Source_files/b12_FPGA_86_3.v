...
module FAU ( 
  ...
  assign new_n33_ = (~x03 | x04) & (x07 | x10 | (x11 & x12));
  assign new_n34_ = (x03 | (~x07 & ~x10)) & (x07 | ~x09 | x10);
  assign new_n35_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = (~x12 & (~x07 | ~x11)) | (x00 & ~x11 & (~x09 | (x09 & x12)));
  ...
  assign z6 = ~x07 & ~x10 & (new_n41_ | new_n44_ | (~new_n28_ & ~new_n43_));
  ...
  assign z7 = (~new_n28_ & ~new_n46_) | new_n47_ | new_n28_ | new_n48_;
  assign new_n46_ = ~x07 & ~x10 & (~x00 | ~x01 | x07 | x08 | x10);
  assign new_n47_ = ~x08 & ((~x00 & x01) | ~x03 | (x02 & ~x07));
  assign new_n48_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (~x00 & (x12 ? ~x11 : ~x09)) | (~new_n50_ & (~x11 | ~x12)) | (x09 & ((~new_n51_ & ~x12) | (x00 & ~x11 & x12)));
