...
module FAU ( 
  ...
  assign z3 = ((~x01 | x02) & ((~x11 & (x00 | ~x12)) | (~x00 & ~x07 & ~x12))) | (x00 & ~x07 & (~x01 | x02));
  assign z4 = (~new_n36_ & (~x01 | x02)) | (~x07 & ~x09 & (~x01 | (x00 & x02)));
  assign new_n36_ = x07 ? x11 : (x00 & x08);
  assign z5 = ((~x01 | x02) & (~new_n38_ | x07)) | (x02 & x10) | (~x07 & ((x00 & x02) | (~x01 & (x00 | x10))));
  assign new_n38_ = x13 & (x00 | x07 | ~x12);
  assign z6 = (x01 & ~x02) | (~x07 & ~new_n40_ & ~x10);
  assign new_n40_ = (x01 | ((new_n41_ | (x00 & x08)) & (x00 | ~x02))) & (~x02 | (x00 ? x08 : x14));
  assign new_n41_ = ~x03 ^ x09;
  assign z7 = (~new_n43_ & ~x01) | ~new_n44_ | (~x02 & (x01 | (x03 & x09)));
  assign new_n43_ = ~x07 & (x07 | ~x10);
  assign new_n44_ = (x08 | (x03 & (~x02 | x07))) & (~x02 | (~x07 & ~x10));
  assign z8 = ~new_n46_ | (~x00 & (~x09 | (x02 & ~x07 & ~x12)));
  assign new_n46_ = (x01 | (~x07 & (x07 | ~x10))) & (~x02 | (~x07 & ~new_n47_ & ~x10)) & ~new_n48_ & (~x01 | x02);
  assign new_n47_ = x00 & ~x07 & x09;
  assign new_n48_ = x09 & (~x03 | x12);
endmodule
