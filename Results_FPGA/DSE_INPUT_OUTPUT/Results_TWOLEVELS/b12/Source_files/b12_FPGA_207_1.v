...
module FAU ( 
  ...
  assign z0 = (~x00 & x02 & (x01 ? (~x04 | x05) : (x03 & ~x04))) | (~x02 & x03);
  ...
  assign new_n32_ = ~x08 & (x02 | (~x01 & ~x03 & (x10 | (x09 & ~x10))));
  assign z3 = ~new_n34_ & ((~x11 & (x00 | ~x12)) | (~x07 & (x00 | (~x00 & ~x12))));
  ...
  assign new_n38_ = ~x08 & ((x00 & (x02 | (x01 & ~x03))) | (~x01 & ~x03 & x09));
  assign new_n39_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14) | (x01 & ~x02 & ~x03));
  assign z7 = new_n34_ | (~new_n34_ & (x07 | x10 | (~x07 & ~x08)));
  assign z8 = ~new_n34_ & (x07 | x10 | (~x07 & (~x00 | (x00 & x09))));
endmodule
