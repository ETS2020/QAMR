...
module FAU ( 
  ...
  assign z4 = (~x07 & (x00 ? ~x08 : (x09 | (~x08 & ~x09)))) | (~x11 & (~x08 | (x07 & x09)));
  assign z5 = (x00 & ~new_n28_ & ~x07) | new_n28_ | x07 | x10 | x12 | ~x13;
  assign z6 = new_n28_ | (~x07 & ~x10 & (new_n39_ | new_n40_ | new_n41_));
  ...
  assign new_n44_ = (x08 | (~x01 & x03)) & ~x07 & ~x10 & (~x08 | x09);
  assign z8 = (~x09 & (x08 | (~x00 & ~x07 & ~x08))) | x07 | x10 | (~new_n46_ & x09);
