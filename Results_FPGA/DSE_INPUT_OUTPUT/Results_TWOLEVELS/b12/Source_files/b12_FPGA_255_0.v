...
module FAU ( 
  ...
  assign new_n33_ = (~x03 | x04) & (x07 | x10 | (~x05 & ~x13));
  assign new_n34_ = (x03 | (~x07 & ~x10)) & (x07 | ~x09 | x10);
  assign new_n35_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = ((~x07 | ~x11) & ((x00 & (x05 | x13)) | (~x12 & x13))) | (x05 & ~x12 & (~x11 | (~x07 & ~x13)));
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n28_ | (x07 & ~x11);
  assign z5 = (x05 & (x07 | (~x07 & ~x12 & ~x13))) | (x13 & (x07 | x10 | (x00 & ~x07))) | x12 | (~x05 & ~x13);
  ...
  assign new_n44_ = (new_n45_ | x01) & ~x07 & ~x10 & (x08 | (~x01 & x03));
