...
module FAU ( 
  ...
  assign z0 = (~x02 & (x12 | (~x00 & x01 & x03))) | (~x00 & ~new_n27_ & x02);
  assign new_n27_ = x01 ? (x04 & ~x05) : (~x03 | x04);
  assign z1 = (~new_n29_ & ~x00) | (~x02 & x12);
  ...
  assign new_n33_ = (x02 | ~x12) & (x07 | x08 | (~new_n34_ & ~x02));
  assign new_n34_ = ~x01 & (x10 ? ~x03 : x09);
  assign new_n35_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign z3 = (~x07 | ~x11) & (~x12 | (x00 & x02));
  assign z4 = (~new_n38_ & ~x07) | (x07 & ~x11) | (~x02 & x12);
  assign new_n38_ = x00 & x08 & x09;
  assign z5 = (x12 & (~x02 | (~x00 & x02))) | x00 | (~x12 & (x07 | x10 | ~x13));
  assign z6 = ~x07 & ~x10 & ((~new_n41_ & ~x08) | (~new_n42_ & ~x00));
  assign new_n41_ = (~x00 | (~x02 & (~x03 | x09 | x12))) & (x12 | (x01 ? x02 : (x03 | ~x09)));
  assign new_n42_ = (x01 | (~x02 & (x03 | ~x09 | x12))) & (x02 | x12 | (~x01 & (~x03 | x09))) & (~x02 | x14);
