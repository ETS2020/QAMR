...
module FAU ( 
  ...
  assign z5 = (x02 & (x10 | (x07 & ~x11))) | (x11 & (x07 | x10)) | (~x02 & ~x11) | (~new_n38_ & ~x07);
  assign new_n38_ = ~x00 & ~x12 & x13;
  assign z6 = ~x07 & ~x10 & ((~new_n41_ & ~x00) | (~new_n40_ & ~x08));
  assign new_n40_ = (~x00 | (~x02 & (~x03 | x09 | ~x11))) & (~x11 | (x01 ? x02 : (x03 | ~x09)));
  assign new_n41_ = (x01 | (~x02 & (x03 | ~x09 | ~x11))) & (x02 | ~x11 | (~x01 & (~x03 | x09))) & (~x02 | x14);
  assign z7 = (x07 & (x11 | (x02 & ~x11))) | ~new_n43_ | (x02 & (x10 | (~x07 & ~x08)));
  assign new_n43_ = new_n45_ & (new_n44_ | x08);
  assign new_n44_ = x03 & (~x01 | x02 | x07 | x10 | ~x11);
  assign new_n45_ = (~x10 | ~x11) & (x02 | (x11 & (x01 | ~x03 | ~x09)));
  assign z8 = (x07 & (x11 | (x02 & ~x11))) | ~new_n47_ | (x10 & (x02 | x11));
  assign new_n47_ = (x00 | ((new_n48_ | ~x02) & (x09 | ~x11))) & (~x09 | (~x02 & (new_n49_ | ~x11)));
