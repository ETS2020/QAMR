...
module FAU ( 
  ...
  assign z2 = (new_n34_ & ~x07) | (~new_n31_ & ~x00);
  assign new_n31_ = (~x02 | (~new_n32_ & (x01 | x07 | x10))) & (new_n33_ | x01);
  assign new_n32_ = (~x07 | x09) & ((x01 & (~x04 | x05)) | (x04 & ~x05) | (~x01 & (x04 | (x03 & ~x04))));
  assign new_n33_ = (x03 | (~x09 & (x07 | ~x10))) & (x07 | ~x09 | x10);
  assign new_n34_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = (x00 & (~x07 | (x09 & ~x11))) | (~x12 & ((x09 & ~x11) | (~x00 & ~x07)));
  assign z4 = x07 ? (x09 & ~x11) : (~x00 | ~x08 | ~x09);
  assign z5 = x07 ? x09 : (x00 | x10 | ~x13 | (~x00 & x12));
  ...
  assign z7 = ~new_n44_ | (~new_n43_ & ~x01);
  assign new_n43_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign new_n44_ = x07 ? ~x09 : (~x10 & (x08 | (~x01 & x03)));
  assign z8 = (~new_n46_ & x09) | x07 | (~x07 & x10) | (~x00 & ~x09);
