...
module FAU ( 
  ...
  assign new_n30_ = ~x00 & ((x02 & ((~x01 & (x04 | (x03 & ~x04))) | (~x06 & (x03 | x04)))) | (x01 & ~x02 & x03));
  assign z2 = (~x00 & (new_n32_ | new_n34_)) | new_n28_ | (new_n35_ & ~x07);
  assign new_n32_ = x02 & ((x01 & (~x04 | x05)) | (~new_n33_ & ~x01) | (x04 & (~x01 | ~x06)));
  assign new_n33_ = (~x03 | x04) & (x07 | x10 | (~x05 & x06));
  assign new_n34_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign new_n35_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = ~new_n28_ & ((x00 & (~x07 | ~x11)) | (~x12 & (~x11 | (~x00 & ~x07))));
  assign z4 = ~new_n28_ & (x07 ? ~x11 : (~x00 | ~x08 | ~x09));
  assign z5 = ~new_n28_ & ((~x07 & (x00 | (~x00 & x12))) | x07 | x10 | ~x13);
  assign z6 = ~x07 & ~new_n40_ & ~new_n28_ & ~x10;
  ...
  assign z7 = (~new_n28_ & (x07 | x10)) | new_n44_ | new_n28_ | new_n45_;
  assign new_n44_ = ~x08 & (x01 | ~x03 | (x02 & ~x07));
  assign new_n45_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (~new_n47_ & (x05 | ~x06)) | (~x03 & x09 & (x05 | (~x06 & ~x07)));
  assign new_n47_ = (new_n48_ | ~x09) & ~x07 & ~x10 & (x00 | x09);
