...
module FAU ( 
  ...
  assign new_n31_ = ~new_n33_ & (~x02 | ((new_n32_ | (~x07 & x14)) & (x07 | x10 | x14)));
  ...
  assign new_n37_ = (x00 | (~x10 & (x10 | (~x01 & (x01 | ~x09 | x14))))) & x08 & x09 & ~x14;
  assign z5 = (~x07 & (~x13 | (~x00 & x10) | x14 | (x00 & ~x14))) | x07 | x12;
  assign z6 = ~new_n40_ & ~x07;
  assign new_n40_ = ~x14 & (x10 | ((new_n41_ | (x00 & x08)) & (~x02 | (x08 & (x00 | x14)))));
  assign new_n41_ = ~x01 & (x03 | ~x09) & (~x03 | x09);
  assign z7 = (~new_n43_ & ~x07) | ~new_n44_ | x07 | (~x03 & ~x08);
  assign new_n43_ = ~x14 & (x08 | ((~x02 | x14) & (~x01 | x10)));
  assign new_n44_ = ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n46_ & x09) | x07 | (~x00 & ~x09) | x10 | (~x07 & x14);
