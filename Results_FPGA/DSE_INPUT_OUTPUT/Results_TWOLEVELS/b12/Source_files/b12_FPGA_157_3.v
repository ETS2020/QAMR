...
module FAU ( 
  ...
  assign z5 = (~x07 & (x00 | ~x13)) | new_n28_ | x07 | x10 | x12;
  ...
  assign z7 = (x02 & (x06 | (~x06 & ~x07 & ~x08))) | ~new_n42_ | (~new_n41_ & ~x02);
  assign new_n41_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign new_n42_ = (x03 | x08) & ~x07 & ~x10;
  assign z8 = (x02 & (x06 | x09)) | ~new_n45_ | (~new_n44_ & x09);
  assign new_n44_ = ~x01 & x03 & ~x12;
  assign new_n45_ = ~x07 & (x00 | x09) & ~x10;
endmodule
