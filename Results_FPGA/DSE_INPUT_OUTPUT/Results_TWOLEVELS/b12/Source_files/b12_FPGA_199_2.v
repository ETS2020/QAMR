...
module FAU ( 
  ...
  assign z7 = ((x07 | x10) & (~x01 | x02)) | (~new_n42_ & ~x01) | (x02 & ~x07 & ~x08);
  assign new_n42_ = (x03 | x08) & (x02 | ~x03 | ~x09);
  assign z8 = (~new_n44_ & x09) | (~new_n34_ & (x07 | x10)) | new_n34_ | new_n45_;
  assign new_n44_ = (~x00 | (~x02 & (x07 | ~x12))) & (x01 | x03);
  assign new_n45_ = ~x00 & ((x02 & ~x07) | (~x01 & (~x09 | x12)));
endmodule
