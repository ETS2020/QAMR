...
module FAU ( 
  ...
  assign z2 = (~new_n30_ & ~x00) | new_n34_ | (new_n33_ & ~x07);
  assign new_n30_ = (new_n31_ | x03) & ~new_n32_ & (~x02 | ~x04 | x05);
  assign new_n31_ = (~x02 | (x01 ? (x04 & ~x05) : (x07 | x10))) & (x01 | (~x07 & ~x10));
  assign new_n32_ = x09 & ~x10 & ~x01 & ~x07;
  ...
  assign z7 = (x03 & (x02 | (~x01 & x09))) | (~new_n42_ & (~x02 | ~x03)) | (~x08 & (~x03 | (new_n42_ & x01 & ~x02)));
  assign new_n42_ = ~x07 & ~x10;
  assign z8 = (~x00 & (~x03 | (new_n44_ & ~x02 & x03))) | new_n45_ | (~new_n42_ & (~x02 | ~x03));
  assign new_n44_ = ~x07 & ~x09 & ~x10;
  assign new_n45_ = x09 & (~x03 | (~x02 & (x01 | x12)));
endmodule
