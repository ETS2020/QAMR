...
module FAU ( 
  ...
  assign new_n27_ = (~x01 | (x02 ? (~x05 & (x04 | ~x07)) : (~x03 | (~x05 & ~x07)))) & (~x02 | ~x03 | x04 | (x05 ? x01 : ~x07));
  ...
  assign z2 = new_n32_ | (~x07 & (new_n35_ | ~x05));
  assign new_n32_ = ~x00 & (new_n34_ | (~new_n33_ & x02));
  assign new_n33_ = (~x01 | (~x05 & (x04 | ~x07))) & (~x03 | x04 | (x05 ? x01 : ~x07)) & (x01 | (~x04 & (x07 | x10))) & (~x04 | x05);
  assign new_n34_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign new_n35_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = (x00 & (~x07 | ~x11)) | (~x07 & (~x05 | (x05 & ~x12))) | (~x11 & ~x12);
  assign z4 = (x05 & ~x07 & (~x00 | ~x08 | ~x09)) | (x07 & ~x11);
  assign z5 = (~x07 & ((x05 & (x12 | ~x13)) | x00 | ~x05)) | x07 | (x05 & x10);
  ...
  assign z7 = (~new_n43_ & ~x01) | ~new_n44_ | (~x08 & (x01 | ~x03));
  assign new_n43_ = (x02 | ~x03 | ~x09) & (x08 | x10 | ~x02 | x07);
  assign new_n44_ = ~x07 & (x05 | x07) & (~x05 | ~x10);
  assign z8 = x07 | (x05 & ((~new_n46_ & x09) | x10 | (~x00 & ~x09)));
  assign new_n46_ = ~x02 & ~x12 & (x07 | (~x01 & x03));
endmodule
