...
module FAU ( 
  ...
  assign z6 = ~x07 & ~x10 & (new_n40_ | (~new_n39_ & ~x11));
  assign new_n39_ = (x08 | ((~x01 | x02) & (~x00 | (~x03 ^ x09)))) & (x00 | ((x02 | (~x01 & (~x03 | x09))) & (x01 | x03 | ~x09)));
  assign new_n40_ = x02 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = (~x11 & (~new_n43_ | (~new_n42_ & ~x02))) | (~new_n44_ & x02);
  assign new_n42_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign new_n43_ = (x03 | x08) & ~x07 & ~x10;
  assign new_n44_ = ~x07 & (x07 | x08) & ~x10;
  assign z8 = (~x00 & (x02 | (~x09 & ~x11))) | (~new_n46_ & (x02 | ~x11)) | (x09 & (x02 | (~new_n47_ & ~x11)));
