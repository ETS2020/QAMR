...
module FAU ( 
  ...
  assign z2 = (~new_n29_ & ~x01) | (~new_n31_ & x02);
  assign new_n29_ = (new_n30_ | x07) & (x00 | (x03 ? ~x02 : (~x07 & ~x10)));
  assign new_n30_ = (x08 | (x10 ? x03 : ~x09)) & (x00 | ~x09 | x10);
  assign new_n31_ = x03 & (~x03 | ((x07 | x08) & (x00 | (x05 & (~x01 | ~x05)))));
  ...
  assign z7 = (~new_n40_ & (~x02 | x03)) | (~new_n41_ & x03) | (~x02 & ~x08 & (~x03 | (new_n40_ & x01)));
  assign new_n40_ = ~x07 & ~x10;
  assign new_n41_ = (~x02 | x07 | x08) & (x01 | x02 | ~x09);
  assign z8 = (~new_n46_ & ~x02) | (x03 & (~new_n43_ | new_n45_));
  assign new_n43_ = (new_n44_ | x00) & new_n40_ & (~x09 | (~x02 & ~x12));
  assign new_n44_ = (~x02 | (x05 & (x01 | x07 | x10))) & (x09 | x10 | x02 | x07);
  assign new_n45_ = x01 & (x09 | (~x00 & x02 & x05));
