...
module FAU ( 
  ...
  assign z0 = (~x00 & ((x01 & (x02 | (~x02 & x03))) | (~x01 & x02 & x03 & ~x04 & x05))) | (x02 & ~x05);
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (~x02 | ~x05 | ((x01 | (~x04 & (~x03 | x04))) & (x06 | (~x03 & ~x04)))) & (~x01 | x02 | ~x03);
  ...
  assign new_n39_ = x05 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = new_n41_ | new_n43_ | (~new_n42_ & ~x08);
  assign new_n41_ = (x07 | x10) & (~x02 | x05);
  assign new_n42_ = x02 ? (~x05 | x07) : (x03 & (~x01 | x07 | x10));
  assign new_n43_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (~x00 & (x02 ? x05 : ~x09)) | new_n41_ | (x09 & (x02 ? x05 : ~new_n45_));
