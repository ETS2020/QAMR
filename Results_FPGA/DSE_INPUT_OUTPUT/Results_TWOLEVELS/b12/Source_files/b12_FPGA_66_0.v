...
module FAU ( 
  ...
  assign z1 = (~x00 & ((~new_n29_ & x02) | (x01 & ~x02 & x03 & x14))) | (~x02 & ~x14);
  ...
  assign new_n41_ = (x08 | x09 | ~x00 | ~x03) & (x00 | x14);
  assign z7 = (~new_n43_ & ~x08) | new_n44_ | x07 | x10;
  assign new_n43_ = (x07 | (~x02 & (~x01 | x02 | x10))) & (x03 | ~x14);
  assign new_n44_ = ~x02 & (~x14 | (~x01 & x03 & x09));
  assign z8 = (~x00 & (new_n46_ | (~x09 & x14))) | ~new_n48_ | (~new_n47_ & x09);
  assign new_n46_ = x02 & ((x01 & (~x04 | x05)) | (x04 & ~x05) | (~x01 & ~x07 & ~x10));
  assign new_n47_ = ~x01 & ~x02 & x03 & ~x12;
  assign new_n48_ = ~x07 & ~x10 & (x02 | x14);
endmodule
