...
module FAU ( 
  ...
  assign z0 = ~x00 & ((x01 & (x02 ? x05 : x03)) | (~x01 & x02 & x03 & ~x04 & x05));
  ...
  assign z5 = ((~x02 | x05) & ((~new_n37_ & ~x07) | x07 | x10)) | (x12 & (x05 | (~x02 & ~x07)));
  assign new_n37_ = ~x00 & x13;
  assign z6 = (x02 & ~x05) | (~x07 & ~x10 & (x02 ? ~new_n40_ : new_n39_));
  assign new_n39_ = (~x00 | ~x08) & (x01 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = x00 ? x08 : (x01 & x14);
  assign z7 = new_n42_ | new_n44_ | (~new_n43_ & ~x08);
  assign new_n42_ = (x07 | x10) & (~x02 | x05);
  assign new_n43_ = x02 ? (~x05 | x07) : (x03 & (~x01 | x07 | x10));
  assign new_n44_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (~x00 & (x02 ? x05 : ~x09)) | new_n42_ | (x09 & (x02 ? x05 : ~new_n46_));
