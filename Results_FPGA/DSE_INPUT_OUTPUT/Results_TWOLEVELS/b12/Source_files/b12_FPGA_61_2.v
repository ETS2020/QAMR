...
module FAU ( 
  ...
  assign z1 = (~x00 & ((x02 & (~new_n28_ | ~x01)) | (x01 & ~x02 & x03))) | (x02 & ~x04);
  assign new_n28_ = x06 & (~x04 | x05);
  ...
  assign new_n32_ = x04 & (~x04 | ((x00 | (x05 & (~x01 | ~x05))) & (x07 | x08)));
  ...
  assign z7 = (~new_n45_ & x02) | new_n44_ | (~x03 & ~x08) | (~new_n46_ & ~x02);
  assign new_n44_ = (~x02 | x04) & (x07 | x10);
  assign new_n45_ = x04 & (~x04 | x07 | x08);
  assign new_n46_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign z8 = new_n48_ | new_n44_ | (~new_n50_ & ~x02) | (x02 & ~new_n49_ & x04);
  assign new_n48_ = x01 & ((~x02 & x09) | (x04 & x05 & ~x00 & x02));
  assign new_n49_ = x00 ? (x07 | ~x09) : (x05 & (x01 | x07 | x10));
  assign new_n50_ = x09 ? (x03 & ~x12) : x00;
endmodule
