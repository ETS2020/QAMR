...
module FAU ( 
  ...
  assign z6 = (~new_n38_ & ~x02) | (~x07 & ~x10 & (new_n39_ | (~new_n40_ & x02)));
  assign new_n38_ = ~x01 & (~x03 | x07 | x08 | x09 | x10);
  assign new_n39_ = ~x01 & ((~x03 & x09 & (~x00 | ~x08)) | (~x00 & (x02 | (x03 & ~x09))));
  assign new_n40_ = x00 ? x08 : x14;
  assign z7 = ~new_n42_ | (~new_n34_ & (x07 | x10));
  assign new_n42_ = (x02 | (~x01 & (~x03 | ~x09))) & (x08 | (x03 & (~x02 | x07)));
  assign z8 = (~new_n46_ & ~x01) | (x02 & (new_n44_ | ~new_n45_));
