...
module FAU ( 
  ...
  assign new_n32_ = (x08 | ((~x09 | x10) & (x03 | ~x10 | x14))) & (x00 | ~x09 | x10);
  assign new_n33_ = ~x00 & ~x03 & (x10 ? ~x14 : x07);
  assign new_n34_ = x02 & (~x10 | ~x14) & (~x00 | (~x07 & ~x08));
  ...
  assign new_n41_ = ~x01 & (x02 | (~x03 & x09)) & (~x00 | ~x08);
  assign new_n42_ = ~x00 & x02 & ~x14;
