...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & ~x07) | (x10 & ~x14) | (x07 & ~x11);
  assign new_n37_ = x00 & x08 & x09;
  assign z5 = (~x07 & (x00 | ~x13)) | x10 | (x07 & ~x10) | x12;
  ...
  assign z7 = (~new_n44_ & ~x01) | (~x08 & (x01 | ~x03)) | x10 | (x07 & ~x10);
  assign new_n44_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign z8 = x10 ? x14 : ((~new_n46_ & x09) | x07 | (~x00 & ~x09));
