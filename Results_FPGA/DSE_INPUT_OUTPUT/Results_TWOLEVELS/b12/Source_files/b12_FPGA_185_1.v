...
module FAU ( 
  ...
  assign z4 = (~new_n34_ & ~x07) | ((x01 | ~x02) & (x07 ? ~x11 : ~x09));
  assign new_n34_ = (~x01 | (x00 & (~x02 | x08))) & (x02 | (x08 & (x00 | (~x10 & (x01 | ~x09 | x10)))));
  assign z5 = (x01 & (x07 | x10)) | (~x02 & (x07 | (~x00 & ~x07 & x10))) | ~new_n36_ | (~x01 & x02) | (x00 & ~x07);
  ...
  assign z8 = new_n43_ | new_n44_ | (~new_n41_ & (x01 | ~x02));
