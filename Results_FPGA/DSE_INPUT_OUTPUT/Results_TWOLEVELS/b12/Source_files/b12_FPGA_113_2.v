...
module FAU ( 
  ...
  assign z5 = ((~x01 | x02) & (~new_n38_ | x07 | (x00 & ~x07))) | (x12 & (~x01 | (~x00 & x02)));
  assign new_n38_ = ~x10 & x13;
  assign z6 = (x01 & ~x02) | (~x07 & ~new_n40_ & ~x10);
  assign new_n40_ = (x01 | ((x00 | ~x02) & (new_n41_ | (x00 & x08)))) & (~x02 | (x00 ? x08 : x14));
  assign new_n41_ = ~x03 ^ x09;
  assign z7 = ((~x01 | x02) & (x07 | x10)) | (~new_n43_ & ~x01) | (x02 & ~x07 & ~x08);
  assign new_n43_ = (x03 | x08) & (x02 | ~x03 | ~x09);
  assign z8 = ~new_n45_ | new_n47_ | ((~x01 | x02) & (x07 | x10));
  assign new_n45_ = (x00 | ((~new_n46_ | ~x02) & (x01 | x09))) & (~x09 | (~x02 & (x01 | x03)));
  assign new_n46_ = ~x07 & ~x12;
  assign new_n47_ = x12 & ((~x01 & x09) | (~x00 & x02));
endmodule
