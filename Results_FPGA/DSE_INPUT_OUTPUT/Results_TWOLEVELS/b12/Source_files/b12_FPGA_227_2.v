...
module FAU ( 
  ...
  assign z8 = new_n44_ | new_n45_ | new_n46_ | new_n47_;
  assign new_n44_ = (~x01 | x02) & (x07 | x10);
  assign new_n45_ = x12 & ((~x01 & x09) | (~x00 & x02 & ~x07));
  assign new_n46_ = ~x00 & ((~x01 & ~x09) | (x02 & ~x07 & ~x12));
  assign new_n47_ = x09 & ((~x01 & ~x03) | (x00 & x02 & ~x07));
endmodule
