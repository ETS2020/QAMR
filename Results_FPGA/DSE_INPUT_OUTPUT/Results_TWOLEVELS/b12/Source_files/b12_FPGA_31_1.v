...
module FAU ( 
  ...
  assign z2 = (~x00 & x07 & (x02 | (~x01 & ~x03))) | (new_n32_ & ~x07);
  assign new_n32_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = (x07 ? ~x11 : ~x08) & (x00 | ~x12);
  assign z4 = ~x07 | ~x11;
  assign z5 = x07 | (~x08 & ((~x07 & (x00 | x12)) | x10 | ~x13));
  assign z6 = ~x07 & ~x08 & ~new_n37_ & ~x10;
  assign new_n37_ = (~x01 | (x02 & x14)) & (x01 | (~x02 & (x03 | ~x09))) & (~x00 | ~x02) & (x02 | ~x03 | x09);
  assign z7 = x07 | (~new_n39_ & ~x08);
  assign new_n39_ = (x07 | (~x02 & (x10 | (x01 ? x02 : ~x09)))) & x03 & ~x10;
  assign z8 = x07 | (~x08 & ((~new_n41_ & x09) | x10 | (~x00 & ~x09)));
  assign new_n41_ = ~x01 & ~x02 & ~x12 & (x01 | x03 | x07 | x10);
endmodule
