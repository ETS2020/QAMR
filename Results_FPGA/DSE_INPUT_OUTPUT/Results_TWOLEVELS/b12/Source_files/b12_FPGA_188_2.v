...
module FAU ( 
  ...
  assign z4 = (~x00 & (x13 ? ~x07 : ~x11)) | ((~x08 | ~x09) & (~x11 | (~x07 & x13))) | (x07 & ~x11);
  assign z5 = (x00 & (~x07 | ~x11)) | (~x13 & (x11 | (~x00 & ~x11))) | (x13 & (x07 | x10 | x12));
  assign z6 = new_n27_ | (~x07 & ~x10 & (new_n40_ | new_n41_));
  assign new_n40_ = ~x08 & ((x00 & (x02 | (~x03 & x09))) | (~x02 & (x01 | (x03 & ~x09))));
  assign new_n41_ = ~x00 & ((x01 & (~x02 | ~x14)) | (~x01 & x02) | (~x02 & (~x03 ^ ~x09)));
  assign z7 = (~new_n27_ & ~new_n43_) | (~new_n44_ & ~x02) | new_n27_ | (~x03 & ~x08);
  assign new_n43_ = ~x07 & ~x10 & (~x02 | x07 | x08);
