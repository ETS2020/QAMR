...
module FAU ( 
  ...
  assign new_n39_ = ~new_n40_ & (x02 | (x03 & ~x09));
  assign new_n40_ = (x08 | (x14 & (~x00 | x13))) & (x00 | x14);
  assign new_n41_ = (new_n42_ | x00) & (new_n43_ | x08);
  assign new_n42_ = (~x01 | (x14 & (x02 | x13))) & (x13 | ((x01 | (~x02 & (x03 | ~x09))) & (x02 | ~x03 | x09))) & (x03 | ~x09 | x14);
  assign new_n43_ = (~x01 | (x14 & (x02 | x13))) & (x03 | ~x09 | (x14 & (x01 | x13)));
  assign z7 = (~x08 & ((~new_n28_ & ~x03) | (~new_n45_ & ~x07))) | (~new_n28_ & (~new_n46_ | x07));
  assign new_n45_ = (x10 | ((~x01 | (x14 & (x02 | x13))) & (~x02 | x14))) & (~x02 | x13);
  assign new_n46_ = ~x10 & (x01 | x02 | ~x03 | ~x09);
