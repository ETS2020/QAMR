...
module FAU ( 
  ...
  assign z6 = ~x07 & (new_n36_ | new_n37_) & ~x10;
  assign new_n36_ = ~x08 & ((x00 & (x02 | (x03 & ~x09))) | (x01 & ~x02) | (~x01 & ~x03 & x09));
  assign new_n37_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (~x02 & (x01 | (x03 & ~x09))) | (x02 & ~x14));
  assign z7 = (x02 & (x07 | (~x07 & ~x08))) | ~new_n39_ | (~x07 & (x10 | (x01 & ~x02 & ~x08 & ~x10)));
  assign new_n39_ = (x02 | (~x07 & (x01 | ~x03 | ~x09))) & (x03 | x08);
  assign z8 = (x02 & (x07 | x09)) | (~new_n41_ & x09) | (~x02 & x07) | (~x07 & x10) | (~x00 & ~x09);
  assign new_n41_ = ~x01 & x03 & ~x12;
endmodule
