// Benchmark "FAU" written by ABC on Fri Aug 21 20:15:48 2020
...
module FAU ( 
  ...
  assign z6 = (~new_n39_ & ~x01) | (~x07 & ~x10 & (new_n40_ | (~new_n41_ & x01)));
  assign new_n39_ = ~x02 & (x00 | x03 | x07 | ~x09 | x10);
  assign new_n40_ = ~x02 & ((~x00 & (x01 | (x03 & ~x09))) | (~x08 & (x03 ^ x09)));
  assign new_n41_ = x00 ? x08 : x14;
  assign z7 = (~new_n43_ & (x01 | ~x02)) | (~x02 & ((~x03 & ~x08) | (~x01 & x03 & x09))) | (x01 & ~x08);
  assign new_n43_ = ~x07 & ~x10;
  assign z8 = (~new_n34_ & ~new_n43_) | (~new_n45_ & x09) | new_n34_ | (~x00 & ~x09);
  assign new_n45_ = ~x01 & ~x12 & (x03 | x07);
endmodule
