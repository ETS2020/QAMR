...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n29_, new_n31_, new_n32_, new_n34_, new_n35_,
    ...
    new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n54_;
  ...
  assign z1 = ~x00 & (new_n32_ | (~new_n31_ & x03));
  assign new_n31_ = (~x01 | x02 | (~x06 & x13)) & (~x02 | ((x04 | (x06 ? x01 : x13)) & (x05 | ~x06)));
  ...
  assign z5 = (x07 & (x06 | ~x13)) | (x06 & (x10 | (x00 & ~x07))) | x12 | (~x06 & x13) | (~x07 & ~x12 & ~x13);
  assign z6 = ~x07 & ~x10 & ((~new_n44_ & ~x00) | (~new_n46_ & ~x08));
  assign new_n44_ = (new_n45_ | (~x06 & x13)) & (x14 | ((~x01 | ~x06) & (~x02 | x13)));
  assign new_n45_ = (x01 | (~x02 & (x03 | ~x09))) & (x02 | (~x01 & (~x03 | x09)));
  assign new_n46_ = ~new_n48_ & (new_n28_ | new_n47_);
  assign new_n47_ = x01 ? ~x00 : (~x02 & (x03 | ~x09));
  assign new_n48_ = x03 & ~x09 & ((x00 & x06) | (~x02 & ~x13));
  assign z7 = new_n50_ | (new_n52_ & x02);
  assign new_n50_ = ~new_n28_ & (~new_n51_ | (~x08 & (x01 | ~x03)));
  assign new_n51_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign new_n52_ = ~x07 & ~x08 & (~x13 | (~x01 & x06 & ~x10));
  assign z8 = ~new_n28_ & ((~new_n54_ & x09) | x07 | x10 | (~x00 & ~x09));
  assign new_n54_ = x03 & ~x12 & ~x01 & ~x02;
endmodule
