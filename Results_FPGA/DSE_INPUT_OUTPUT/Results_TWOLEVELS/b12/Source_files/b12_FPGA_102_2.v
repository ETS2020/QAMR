...
module FAU ( 
  ...
  assign z3 = ((~x07 | ~x11) & ((x00 & (~x06 | x13)) | (~x12 & x13))) | (~x06 & ~x12 & (~x11 | (~x07 & ~x13)));
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n28_ | (x07 & ~x11);
  assign z5 = (~x06 & (x07 | (~x07 & ~x12 & ~x13))) | (x13 & (x07 | x10 | (x00 & ~x07))) | x12 | (x06 & ~x13);
  assign z6 = ~x07 & ~x10 & ~new_n44_ & ~new_n28_;
  assign new_n44_ = ~new_n45_ & (x01 | new_n46_ | (x00 & x08)) & (x00 | ~x01 | x14);
  assign new_n45_ = (x01 | (x03 & ~x09)) & (x00 ? ~x08 : ~x02);
  assign new_n46_ = ~x02 & (x03 | ~x09);
  assign z7 = ~new_n28_ & ((~new_n48_ & ~x01) | ~new_n35_ | (~x08 & (x01 | ~x03)));
  assign new_n48_ = (x02 | ~x03 | ~x09) & (x08 | x10 | ~x02 | x07);
