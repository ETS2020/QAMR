...
module FAU ( 
  ...
  assign new_n37_ = (~x01 | (x00 & (x02 | x08))) & (~x02 | (x00 & (x01 | x08))) & ((~x03 ^ x09) | (x00 & x08));
  ...
  assign z8 = (x01 & (x02 | (~x02 & x09))) | ~new_n42_ | (~new_n39_ & (~x01 | ~x02));
  assign new_n42_ = x09 ? ((x01 | ~x02) & (x02 | x03) & ~x12) : x00;
endmodule
