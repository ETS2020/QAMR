...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n33_, new_n35_, new_n37_, new_n39_, new_n40_,
    new_n42_;
  ...
  assign z4 = (~new_n33_ & ~x07) | ((~x01 | ~x02) & (x07 ? ~x11 : ~x09));
  assign new_n33_ = (x01 | (x00 & (~x02 | x08))) & (x02 | (x08 & (x00 | (~x10 & (~x01 | x10)))));
  assign z5 = (~x01 & (x07 | x10)) | (~x02 & (x07 | (~x00 & ~x07 & x10))) | ~new_n35_ | (x00 & ~x07) | (x01 & x02);
  ...
  assign z8 = (~x00 & ((~x02 & ~x09) | (new_n39_ & ~x01 & x02))) | (~new_n39_ & (~x01 | ~x02)) | (~new_n42_ & x09);
  assign new_n42_ = (x02 | (~x01 & ~x12)) & (x01 | (~x02 & x03));
endmodule
