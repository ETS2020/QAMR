...
module FAU ( 
  ...
  assign z5 = x13 ? (x00 | x07 | x10 | x12) : x03;
  assign z6 = (~x03 & ~x13) | (~x07 & ~new_n41_ & ~x10);
  assign new_n41_ = (new_n42_ | (x00 ? x08 : x01)) & ~new_n43_ & (x00 | ~x01 | x14);
  assign new_n42_ = ~x02 & (x03 | ~x09);
  assign new_n43_ = (x01 | (x03 & ~x09)) & (x00 ? ~x08 : ~x02);
  assign z7 = ((x07 | x10) & (x03 | x13)) | (~new_n45_ & x03) | (~x03 & ~x07 & ~x08 & x13);
  assign new_n45_ = (x08 | (~x01 & ~x02)) & (x01 | x02 | ~x09);
  assign z8 = new_n49_ | new_n47_ | ~new_n51_ | (~x00 & (new_n48_ | ~new_n50_));
  assign new_n47_ = ~new_n32_ & (x03 | x13);
  assign new_n48_ = x02 & ((x03 & ~x05) | (new_n32_ & ~x01));
  assign new_n49_ = x01 & ((x03 & x09) | (~x00 & x02 & x05));
  assign new_n50_ = (x03 | ~x13) & (x02 | ~x03 | x07 | x09 | x10);
  assign new_n51_ = (x03 | (~x09 & x13)) & (~x09 | (~x12 & (~x02 | ~x03)));
endmodule
