...
module FAU ( 
  ...
  assign z5 = ((x01 | ~x02) & (~new_n38_ | x07 | (x00 & ~x07))) | (x12 & (~x02 | (~x00 & x01)));
  ...
  assign z8 = (~new_n36_ & ~new_n43_) | new_n45_ | new_n46_ | new_n47_;
  assign new_n45_ = x12 & ((~x02 & x09) | (~x00 & x01));
  assign new_n46_ = ~x00 & ((~x02 & ~x09) | (x01 & ~x07 & ~x12));
  assign new_n47_ = x09 & (x01 | (~x02 & ~x03));
endmodule
