...
module FAU ( 
  ...
  assign z4 = (~new_n34_ & ~x07) | (~x01 & x02) | (x07 & ~x11);
  assign new_n34_ = (x00 | (x12 & (~x12 | (~x01 & x02)))) & x08 & x09;
  assign z5 = ~new_n36_ & (x01 | ~x02);
  assign new_n36_ = (x07 | (~x00 & (x00 | ~x12))) & ~x07 & ~x10 & x13;
  assign z6 = (~x01 & x02) | (~x07 & ~x10 & ((~new_n39_ & x01) | (~new_n38_ & ~x02)));
  assign new_n38_ = ((x00 & x08) | (~x03 ^ x09)) & (x00 | ~x01);
  assign new_n39_ = x00 ? x08 : x14;
  assign z7 = (~x01 & (x02 | (x03 & x09))) | (~new_n41_ & (x01 | ~x02)) | (~x08 & (x01 | ~x03));
  assign new_n41_ = ~x07 & ~x10;
  assign z8 = ~new_n43_ | (~new_n41_ & (x01 | ~x02));
