...
module FAU ( 
  ...
  assign z4 = (~new_n35_ & (x01 | ~x02)) | (~x07 & ~x09 & (~x02 | (x00 & x01)));
  assign new_n35_ = x07 ? x11 : (x00 & x08);
  assign z5 = (~new_n37_ & (x07 | x10)) | (x00 & ~new_n37_ & ~x07) | new_n37_ | x12 | ~x13;
  ...
  assign z7 = ((x01 | ~x02) & (x07 | x10)) | (~new_n42_ & ~x02) | (x01 & ~x07 & ~x08);
  assign new_n42_ = (x03 | x08) & (x01 | ~x03 | ~x09);
  assign z8 = new_n44_ | new_n37_ | new_n45_ | (~new_n37_ & (x07 | x10));
  assign new_n44_ = ~x00 & (~x09 | (x01 & ~x07));
  assign new_n45_ = x09 & (~x03 | x12 | (x00 & x01 & ~x07));
endmodule
