...
module FAU ( 
  ...
  assign z6 = (~x01 & x02) | (~x07 & ~x10 & ((~new_n38_ & x01) | (~new_n37_ & ~x02)));
  assign new_n37_ = (x00 | ~x01) & ((x00 & x08) | (~x03 ^ x09));
  assign new_n38_ = x00 ? x08 : x14;
  assign z7 = (~x01 & (x02 | (x03 & x09))) | (~new_n40_ & (x01 | ~x02)) | (~x08 & (x01 | ~x03));
  assign new_n40_ = ~x07 & ~x10;
  assign z8 = (~new_n40_ & ~new_n33_) | new_n42_ | new_n43_;
