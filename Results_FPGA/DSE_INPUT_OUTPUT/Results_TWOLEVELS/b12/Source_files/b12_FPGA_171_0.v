...
module FAU ( 
  ...
  assign new_n43_ = (x02 | x06) & (x07 | x10);
  assign new_n44_ = x03 & (x07 | (~x02 & (~x01 | x02 | ~x06 | x10)));
  assign new_n45_ = ~x02 & (~x06 | (~x01 & x03 & x09));
  assign z8 = (~x00 & (new_n47_ | (x06 & ~x09))) | new_n43_ | (x09 & ((~new_n48_ & x06) | (new_n47_ & x00)));
