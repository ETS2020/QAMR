...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n33_, new_n36_, new_n38_, new_n39_,
  ...
  assign z3 = (~x11 & (x00 | ~x12)) | new_n33_ | (~x07 & (~x12 | (~new_n33_ & x00)));
  assign new_n33_ = x02 & x05;
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n33_ | (x07 & ~x11);
  assign z5 = ((~x02 | ~x05) & ((~new_n36_ & ~x07) | x07 | x10)) | (x12 & (~x05 | (~x02 & ~x07)));
