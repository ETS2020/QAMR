...
module FAU ( 
  ...
  assign z6 = (~new_n38_ & ~x01) | (~x07 & ~x10 & (new_n39_ | (~new_n40_ & x01)));
  assign new_n38_ = ~x02 & (x00 | x03 | x07 | ~x09 | x10);
  assign new_n39_ = ~x02 & ((~x00 & (x01 | (x03 & ~x09))) | (~x08 & (~x03 ^ ~x09)));
  assign new_n40_ = x00 ? x08 : x14;
  assign z7 = (~x01 & (x02 | (x03 & x09))) | ~new_n42_ | (~x08 & (x01 | ~x03));
  assign new_n42_ = ~x07 & ~x10;
  assign z8 = ~new_n44_ | (x09 & (x01 | ~x03 | x12));
  assign new_n44_ = ~x07 & (x01 | ~x02) & ~x10 & (x00 | x09);
endmodule
