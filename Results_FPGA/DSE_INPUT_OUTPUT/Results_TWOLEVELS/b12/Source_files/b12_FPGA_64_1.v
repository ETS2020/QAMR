...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n33_, new_n35_, new_n37_,
    ...
    new_n49_;
  assign z0 = (~x02 & (x04 | (~x00 & x01 & x03 & ~x04))) | (~x00 & x02 & (x01 ? (~x04 | x05) : (x03 & ~x04)));
  ...
  assign z8 = ~new_n46_ | (~new_n35_ & (x07 | x10));
  assign new_n46_ = (~x12 | (~new_n47_ & (x04 | ~x09))) & ~new_n48_ & (new_n49_ | ~x09);
  assign new_n47_ = ~x00 & x02 & ~x07;
  assign new_n48_ = ~x00 & ((~x04 & ~x09) | (x02 & ~x07 & ~x12));
  assign new_n49_ = (x04 | (~x01 & x03)) & (~x00 | ~x02 | x07);
endmodule
