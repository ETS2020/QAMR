...
module FAU ( 
  ...
  assign new_n33_ = (~x01 | (x04 & ~x05)) & (x07 | ((~x04 | (x01 & x05)) & (x01 | (x10 & (~x03 | x04)))));
  ...
  assign z7 = (x02 & (x07 | ~x08)) | ~new_n42_ | (~x07 & (x10 | (x01 & ~x02 & ~x08 & ~x10)));
  assign new_n42_ = (x03 | x08) & (x02 | (~x07 & (x01 | ~x03 | ~x09)));
  assign z8 = x07 ? ~x02 : ((~new_n44_ & x09) | x10 | (~x00 & ~x09));
