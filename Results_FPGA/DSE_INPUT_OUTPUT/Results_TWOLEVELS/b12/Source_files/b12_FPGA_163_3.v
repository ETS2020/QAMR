...
module FAU ( 
  ...
  assign new_n27_ = (~x01 | (x02 ? (x04 & (~x05 | x07)) : (~x03 | (x04 & x07)))) & (x01 | ~x02 | ~x03 | x04);
  assign z1 = ~new_n29_ & ~x00;
  assign new_n29_ = (~x03 | ((~x01 | x02 | (x04 & x07)) & (~x02 | x04 | (new_n30_ & x01)))) & (~x02 | ~x04 | x07 | (new_n30_ & x01));
  assign new_n30_ = x05 & x06;
  assign z2 = new_n32_ | (x04 & x07) | (new_n35_ & ~x07);
  assign new_n32_ = ~x00 & (new_n34_ | (~new_n33_ & x02));
  assign new_n33_ = (~x01 | (x04 & (~x05 | x07))) & (x07 | ((~x04 | x05) & (x01 | (~x04 & x10)))) & (x01 | ~x03 | x04);
