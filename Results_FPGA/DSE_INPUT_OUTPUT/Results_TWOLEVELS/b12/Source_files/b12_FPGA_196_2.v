...
module FAU ( 
  ...
  assign z5 = (~x02 & (x10 | (x07 & ~x11))) | (x11 & (x07 | x10)) | (~new_n38_ & ~x07) | (x02 & ~x11);
  ...
  assign z7 = (x02 & (~x11 | (~x07 & ~x08))) | (x07 & (x11 | (~x02 & ~x11))) | ~new_n44_ | (~new_n43_ & ~x08);
  assign new_n43_ = x03 & (~x01 | x02 | x07 | x10);
  assign new_n44_ = (x02 | (~x10 & (x01 | ~x03 | ~x09))) & (~x10 | ~x11);
