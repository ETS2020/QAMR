// Benchmark "FAU" written by ABC on Fri Aug 21 20:15:56 2020
...
module FAU ( 
  ...
  assign z6 = (~x01 & (~x02 | (~x00 & ~x07 & ~x10))) | (~x07 & ~new_n35_ & ~x10);
  assign new_n35_ = x00 ? x08 : (x02 & x14);
  assign z7 = new_n31_ | (~new_n31_ & (x07 | x10 | (~x07 & ~x08)));
  assign z8 = (~x01 & (~x02 | (~x00 & ~x07 & ~x10))) | (x01 & (x07 | x10 | (~x00 & ~x07))) | x09 | (x02 & (x07 | x10));
endmodule
