...
module FAU ( 
  ...
  assign new_n39_ = ~x00 & (x02 ? (~x01 | ~x14) : (x01 | (x03 & ~x09) | (~x03 & x09)));
  assign z7 = new_n41_ | new_n43_ | (~new_n42_ & ~x08);
  assign new_n41_ = (x07 | x10) & (~x02 | ~x06);
  assign new_n42_ = x02 ? (x06 | x07) : (x03 & (~x01 | x07 | x10));
  assign new_n43_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (x02 & (x06 | x09)) | new_n41_ | ~new_n45_;
  assign new_n45_ = x09 ? (~x01 & x03 & ~x12) : x00;
endmodule
