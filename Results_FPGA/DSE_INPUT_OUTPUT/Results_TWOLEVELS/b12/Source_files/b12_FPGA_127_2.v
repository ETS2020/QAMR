...
module FAU ( 
  ...
  assign z4 = ((~x02 | x05) & (x07 ? ~x11 : ~new_n36_)) | (~x07 & ~x08 & (~x02 | (x02 & x05)));
  assign new_n36_ = x00 & x09;
  assign z5 = (~new_n34_ & (x07 | x10)) | x12 | ~x13 | new_n34_ | (x00 & ~x07);
  assign z6 = ~x07 & ~x10 & (x02 ? new_n40_ : new_n39_);
  assign new_n39_ = (~x00 | ~x08) & (x01 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = x05 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = (x02 & (~x05 | (x05 & ~x07 & ~x08))) | (~new_n42_ & ~x02) | ((~x02 | x05) & (x07 | x10));
  assign new_n42_ = (x08 | (x03 & (~x01 | x07 | x10))) & (x01 | ~x03 | ~x09);
  assign z8 = (~x00 & (x02 ? x05 : ~x09)) | new_n44_ | (x09 & (x02 ? x05 : ~new_n45_));
