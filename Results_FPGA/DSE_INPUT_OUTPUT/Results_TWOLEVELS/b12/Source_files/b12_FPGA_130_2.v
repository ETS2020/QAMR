...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (~x02 | x13)) : ~new_n36_;
  assign new_n36_ = (x00 | (~x13 & (x02 | x13))) & (x02 | (x08 & x09)) & (~x13 | (x09 & (~x02 | x08)));
  assign z5 = (~x02 & (x07 | (~x00 & ~x07 & ~x13))) | (x13 & (x07 | x10)) | (x00 & ~x07) | x12 | (x02 & ~x13);
  ...
  assign z8 = new_n42_ | ~new_n46_ | (x02 & (x09 | ~x13));
  assign new_n46_ = x09 ? (~x01 & x03 & ~x12) : x00;
endmodule
