...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n30_, new_n31_, new_n33_, new_n34_, new_n35_,
    new_n36_, new_n37_, new_n42_, new_n43_, new_n44_, new_n46_, new_n48_;
  ...
  assign new_n30_ = (~x01 | x02 | (~x06 & x07)) & (~x02 | ((x04 | (x06 ? x01 : x07)) & (x05 | ~x06)));
  assign new_n31_ = x02 & x04 & (x06 ? (~x01 | ~x05) : ~x07);
  assign z2 = (~new_n33_ & ~x00) | (~x06 & x07) | (new_n37_ & ~x07);
  assign new_n33_ = ~new_n36_ & (~x02 | (~new_n34_ & new_n35_));
  assign new_n34_ = (x06 ? ~x01 : ~x07) & (x04 | (x03 & ~x04));
  assign new_n35_ = (~x01 | ((x04 | (~x06 & x07)) & (~x05 | ~x06))) & (~x04 | x05 | ~x06) & (x01 | x07 | x10);
  assign new_n36_ = ~x01 & ((~x03 & (x07 | x10)) | (~x07 & x09 & ~x10));
  assign new_n37_ = ~x08 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = (~x06 & x07) | ((x00 | ~x12) & (~x07 | ~x11));
  assign z4 = x07 ? (~x06 | ~x11) : (~x00 | ~x08 | ~x09);
  assign z5 = x07 ? x06 : (x12 | ~x13 | x00 | x10);
  assign z6 = ~x07 & ~new_n42_ & ~x10;
  assign new_n42_ = ~new_n43_ & (x01 | new_n44_ | (x00 & x08)) & (x00 | ~x01 | x14);
  assign new_n43_ = (x01 | (x03 & ~x09)) & (x00 ? ~x08 : ~x02);
  assign new_n44_ = ~x02 & (x03 | ~x09);
  assign z7 = (~new_n46_ & ~x01) | x07 | (~x08 & (x01 | ~x03)) | (~x07 & x10);
  assign new_n46_ = (x02 | ~x03 | ~x09) & (~x02 | x07 | x08 | x10);
  assign z8 = x07 ? x06 : ((~new_n48_ & x09) | x10 | (~x00 & ~x09));
