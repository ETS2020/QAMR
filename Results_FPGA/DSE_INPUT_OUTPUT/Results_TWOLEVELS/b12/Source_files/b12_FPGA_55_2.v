...
module FAU ( 
  ...
  assign new_n35_ = (x00 | (x12 & (~x12 | (x01 & ~x02)))) & x08 & x09;
  assign z5 = ~new_n37_ & (~x01 | x02);
  assign new_n37_ = (x07 | (~x00 & (x00 | ~x12))) & ~x07 & ~x10 & x13;
  assign z6 = (~new_n39_ & ~x02) | (~x07 & ~x10 & (new_n40_ | (~new_n41_ & x02)));
  assign new_n39_ = ~x01 & (x00 | ~x03 | x07 | x09 | x10);
  assign new_n40_ = ~x01 & ((~x00 & (x02 | (~x03 & x09))) | (~x08 & (x03 ^ x09)));
  assign new_n41_ = x00 ? x08 : x14;
  assign z7 = ~new_n43_ | ((~x01 | x02) & (x07 | x10));
  assign new_n43_ = (x02 | (~x01 & (~x03 | ~x09))) & (x08 | (x03 & (~x02 | x07)));
  assign z8 = ~new_n45_ | ((~x01 | x02) & (x07 | x10));
  assign new_n45_ = (~x09 | (~x02 & x03 & ~x12)) & (~x01 | x02) & (x00 | x09);
endmodule
