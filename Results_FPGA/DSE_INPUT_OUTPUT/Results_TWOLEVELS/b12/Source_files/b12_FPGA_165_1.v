...
module FAU ( 
  ...
  assign new_n31_ = (x02 | ~x13) & (x07 | x08 | (~new_n32_ & ~x02));
  ...
  assign new_n40_ = (~x00 | (~x02 & (~x03 | x09 | x13))) & (x13 | (x01 ? x02 : (x03 | ~x09)));
  assign new_n41_ = (x01 | (~x02 & (x03 | ~x09 | x13))) & (x02 | x13 | (~x01 & (~x03 | x09))) & (~x02 | x14);
  assign z7 = (~x08 & (~x03 | (~new_n43_ & ~x07))) | new_n44_ | x07 | x10;
  assign new_n43_ = ~x02 & (~x01 | x02 | x10 | x13);
  assign new_n44_ = ~x02 & (x13 | (~x01 & x03 & x09));
  assign z8 = (~new_n46_ & x09) | x07 | (~x00 & ~x09) | new_n36_ | x10;
  assign new_n46_ = ~x02 & x03 & ~x12 & (~x01 | x07);
endmodule
