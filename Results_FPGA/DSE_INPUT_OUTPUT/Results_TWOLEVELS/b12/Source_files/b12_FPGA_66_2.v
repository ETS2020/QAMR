...
module FAU ( 
  ...
  assign new_n40_ = x02 ? (x00 ? x08 : x01) : ((x00 & x08) | (~x01 & (x03 | ~x09) & (~x03 | x09)));
  assign z7 = (x02 & (~x14 | (~x07 & ~x08 & x14))) | (~new_n42_ & ~x02) | x07 | x10;
  assign new_n42_ = (x08 | (x03 & (~x01 | x07 | x10))) & (x01 | ~x03 | ~x09);
  assign z8 = (~x00 & (x02 ? x14 : ~x09)) | ~new_n44_ | (x02 & (x09 | ~x14));
