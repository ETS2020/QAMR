...
module FAU ( 
  ...
  assign z4 = (~x07 & (~x00 | ~x09 | (x00 & ~x08))) | (x08 & ~x13) | (x07 & ~x11);
  assign z5 = x13 ? (x07 | (x00 & ~x07) | x10 | x12) : ~x08;
  assign z6 = new_n40_ & ~x07;
  assign new_n40_ = ~x10 & ((~new_n41_ & (~x08 | (~x00 & x13))) | (x00 & x02 & ~x08));
  assign new_n41_ = (~x01 | (x02 & x14)) & (x02 | ~x03 | x09) & (x01 | (~x02 & (x03 | ~x09)));
  assign z7 = ~new_n44_ | (~new_n43_ & ~x02);
  assign new_n43_ = (x01 | ~x03 | ~x09) & (~x01 | x07 | x08 | x10);
  assign new_n44_ = (x07 | (~x10 & (~x02 | x08))) & (x03 | x08) & ~x07 & (~x08 | x13);
  assign z8 = (~new_n46_ & x09) | x07 | (~x00 & ~x09) | new_n28_ | (~x07 & x10);
  assign new_n46_ = x03 & ~x12 & ((~x01 & ~x02) | x07);
endmodule
