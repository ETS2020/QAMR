...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n34_, new_n38_;
  ...
  assign new_n38_ = (x08 | ((x01 | ~x09) & (~x00 | (~x01 & ~x02)))) & (x00 | ((x01 | (~x02 & ~x09)) & (~x01 | x02) & (~x02 | x14)));
  assign z7 = new_n34_ | (~new_n34_ & (x07 | x10 | (~x07 & ~x08)));
  assign z8 = ~new_n34_ & (x07 | (~x00 & ~x07) | x09 | x10);
endmodule
