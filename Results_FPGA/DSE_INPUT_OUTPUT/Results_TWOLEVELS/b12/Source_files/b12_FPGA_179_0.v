...
module FAU ( 
  ...
  assign new_n29_ = (~x02 | ((x01 | (~x04 & (~x03 | x04))) & (x05 | (~x03 & ~x04)))) & (~x03 | (x06 & (~x01 | x02 | ~x06))) & (~x04 | x06);
  ...
  assign z4 = (~new_n37_ & (x02 | x06)) | (~x07 & ~x09 & (x06 | (x00 & x02)));
  assign new_n37_ = x07 ? x11 : (x00 & x08);
  assign z5 = (x00 & ~new_n30_ & ~x07) | new_n30_ | x07 | x10 | x12 | ~x13;
  assign z6 = new_n30_ | (~x07 & ~x10 & (new_n40_ | new_n41_));
  ...
  assign z8 = (~x00 & (~x09 | (x02 & ~x07))) | ~new_n47_ | (~new_n46_ & x09);
  assign new_n46_ = ~x01 & x03 & ~x12 & (~x00 | ~x02 | x07);
  assign new_n47_ = (x02 | x06) & ~x07 & ~x10;
endmodule
