...
module FAU ( 
  ...
  assign new_n35_ = (x01 | ((x03 | ~x10) & (x06 | ~x09 | x10))) & (~x02 | x06);
  ...
  assign z5 = (~new_n40_ & ~x07) | ((x07 | ~x13) & (~x06 | x08)) | (x08 & x10);
  ...
  assign new_n46_ = (~x07 | (x06 & ~x08)) & (~x10 | (~x08 & (x06 | x07))) & (x06 | x08 | (x03 & (new_n47_ | x07)));
  assign new_n47_ = ~x02 & (~x01 | x02 | x10);
  assign new_n48_ = (x02 | ~x03 | ~x08) & (x06 | x07 | x08 | x10);
  assign z8 = (~x06 & (x07 | (~x07 & x10))) | (x08 & (x07 | x10)) | new_n50_ | new_n51_ | (x06 & ~x08);
  assign new_n50_ = x09 & (x01 | x02 | ~x03 | x12);
