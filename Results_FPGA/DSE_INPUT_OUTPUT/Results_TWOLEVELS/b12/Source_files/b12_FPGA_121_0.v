...
module FAU ( 
  ...
  assign new_n28_ = (x01 | (~x04 & (~x02 | ~x03 | x04))) & x02 & ((x05 & x06) | (~x03 & ~x04));
  ...
  assign z6 = (~x00 & ~x02) | (~x07 & ~x10 & (x00 ? new_n39_ : ~new_n38_));
  assign new_n38_ = x01 & x14;
  assign new_n39_ = ~x08 & (x01 | x02 | (~x03 & x09) | (x03 & ~x09));
  assign z7 = (~x00 & (~x02 | (x02 & x07))) | ~new_n42_ | (x00 & (x07 | (~new_n41_ & ~x07)));
  assign new_n41_ = (x01 | x02 | ~x03 | ~x09) & (~x01 | x08 | x10);
  assign new_n42_ = ~x10 & (x08 | (x03 & (~x02 | x07)));
  assign z8 = new_n45_ | new_n46_ | new_n44_ | new_n47_ | x10;
  assign new_n44_ = ~x00 & (~x02 | (x02 & ~x07 & ~x12));
  assign new_n45_ = x07 & (x00 | (~x00 & x02));
  assign new_n46_ = x12 & (x09 | (~x00 & x02 & ~x07));
  assign new_n47_ = x00 & ~x07 & x09 & (x01 | x02 | ~x03);
endmodule
