...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n33_, new_n37_, new_n38_, new_n39_,
    new_n41_, new_n43_;
  ...
  assign z5 = (~new_n33_ & (x07 | x10)) | new_n33_ | (~x07 & (x00 | x12 | ~x13));
  assign z6 = new_n33_ | (~x07 & ~x10 & (new_n37_ | new_n38_ | new_n39_));
  assign new_n37_ = (x01 | (x03 & ~x09)) & (x00 ? ~x08 : ~x02);
  assign new_n38_ = ~x00 & ((~x02 & ~x03 & x09) | (x01 & ~x14));
  assign new_n39_ = ~x08 & x09 & ~x02 & ~x03;
  assign z7 = (~new_n41_ & (x01 | ~x02)) | (~x02 & ((~x03 & ~x08) | (~x01 & x03 & x09))) | (x01 & ~x08);
  assign new_n41_ = ~x07 & ~x10;
  assign z8 = ~new_n43_ | (~new_n41_ & ~new_n33_);
  assign new_n43_ = (~x09 | (~x01 & x03 & ~x12)) & (x01 | ~x02) & (x00 | x09);
endmodule
