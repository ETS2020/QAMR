...
module FAU ( 
  ...
  assign z3 = (~x11 & (x00 | ~x12)) | (~x12 & ~x13) | (~x07 & (x00 ? (x12 | x13) : ~x12));
  assign z4 = (~x07 & (~x00 | ~x08 | ~x09)) | new_n27_ | (x07 & ~x11);
  assign z5 = ((x12 | x13) & (x07 | (x00 & ~x07))) | (~x07 & ((~x00 & x12) | (x10 & x13)));
  ...
  assign z7 = (x07 & (x12 | x13)) | ~new_n44_ | (~x07 & (new_n46_ | (x10 & x13)));
  assign new_n44_ = (x08 | (~x01 & x03)) & new_n45_ & (~x03 | ~x09 | x01 | x02);
  assign new_n45_ = x12 ? ~x10 : x13;
  assign new_n46_ = x02 & ~x08;
  assign z8 = (~x00 & ((~x09 & x13) | (~x07 & x12))) | ~new_n48_ | (x07 & (x12 | x13));
  assign new_n48_ = (~x10 | (~x12 & (x07 | ~x13))) & (~x09 | (~x12 & (new_n49_ | ~x13)));
  assign new_n49_ = ~x01 & (x07 | (~x02 & x03));
endmodule
