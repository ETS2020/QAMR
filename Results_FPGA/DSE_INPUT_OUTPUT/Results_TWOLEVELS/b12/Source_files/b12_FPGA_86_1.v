...
module FAU ( 
  ...
  assign z3 = (x00 & (x11 ? ~x07 : ~x12)) | (~x12 & (x07 ? ~x11 : ~x00));
  assign z4 = (~x07 & ((~x00 & (~x12 | (x11 & x12))) | (x11 & (~x08 | ~x09)))) | (~x11 & ~x12 & (x07 | ~x08 | ~x09));
  assign z5 = (x00 & (x11 ? ~x07 : ~x12)) | (x07 & (x11 | (~x11 & ~x12))) | (~x12 & (x10 | ~x13)) | (~x00 & ~x07 & x11 & x12);
  assign z6 = ~x07 & ~x10 & (new_n40_ | (~new_n39_ & (x11 | ~x12)));
  assign new_n39_ = (~x01 | (x00 ? x08 : x02)) & ((x00 & x08) | ((x01 | (~x02 & (x03 | ~x09))) & (x02 | ~x03 | x09)));
  assign new_n40_ = ~x00 & ~x14 & ((x02 & ~x12) | (x01 & x11));
  assign z7 = (x07 & (x11 | (~x11 & ~x12))) | (x10 & (x11 | ~x12)) | new_n42_ | new_n43_ | (~x11 & x12);
  assign new_n42_ = ~x08 & (x01 | ~x03 | (x02 & ~x07));
  assign new_n43_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = ~new_n45_ | (~x00 & ((~x07 & x11 & x12) | (~x09 & ~x12)));
  assign new_n45_ = (~x07 | (~x11 & (x11 | x12))) & (~x10 | (~x11 & x12)) & (~x09 | (x12 ? ~x11 : new_n46_));
