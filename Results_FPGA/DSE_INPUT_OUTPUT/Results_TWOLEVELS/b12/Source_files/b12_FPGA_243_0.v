...
module FAU ( 
  ...
  assign z4 = (~new_n32_ & (x01 | x02)) | (~x00 & ~x07 & (x01 | (x02 & (x10 | (~x01 & ~x10)))));
  assign new_n32_ = x07 ? x11 : (x08 & x09);
  assign z5 = ((x01 | x02) & (x07 | (x00 & ~x07))) | (x10 & (x01 | (~x00 & x02 & ~x07))) | ~new_n34_ | (~x01 & ~x02);
  assign new_n34_ = ~x12 & x13;
  assign z6 = new_n36_ & ~x07;
  assign new_n36_ = ~x10 & ((x01 & (x00 ? ~x08 : ~x02)) | (x02 & ((~x00 & (~x01 | ~x14)) | (~x01 & ~x08))));
  assign z7 = ((x01 | x02) & (x07 | x10)) | (~x07 & ~x08 & (x01 | (~x01 & x02 & ~x10)));
  assign z8 = (~x00 & ~x07 & (x01 | (~x01 & x02 & ~x10))) | ((x01 | x02) & (x07 | x10)) | x09 | (~x01 & ~x02);
endmodule
