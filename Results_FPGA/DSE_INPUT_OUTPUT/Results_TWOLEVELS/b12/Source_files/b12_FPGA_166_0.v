...
module FAU ( 
  ...
  assign z3 = (x00 & (x11 ? ~x07 : x03)) | (~x11 & (~x03 | (x03 & x07 & ~x12))) | (~x00 & ~x07 & ~x12);
  assign z4 = (~x11 & (~x03 | (x03 & (x07 | (~x00 & x12))))) | (~x07 & (~new_n37_ | (~x00 & (~x12 | (x11 & x12)))));
  assign new_n37_ = x08 & x09;
  assign z5 = (~new_n39_ & (x11 ? ~x07 : x03)) | (x03 & (x10 | (x07 & ~x11 & ~x12))) | (x11 & (x07 | x10));
  assign new_n39_ = ~x00 & x13 & (x00 | ~x12);
  ...
  assign new_n45_ = (~x03 | (~x10 & (~x07 | x11))) & (x03 | (x08 & x11)) & (~x11 | (~x07 & ~x10)) & (~x02 | x07 | x08);
  assign z8 = (~new_n47_ & (x03 | x11)) | (x07 & (x11 | (x03 & ~x11))) | (x09 & (x03 ? ~new_n48_ : x11));
  assign new_n47_ = ~x10 & (x00 | x09);
