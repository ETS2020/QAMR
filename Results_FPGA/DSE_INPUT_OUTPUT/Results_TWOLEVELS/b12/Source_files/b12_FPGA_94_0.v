...
module FAU ( 
  ...
  assign z3 = (x00 & (~x07 | ~x11)) | (~x07 & x11 & ~x12) | (~x11 & (~x02 | ~x12));
  assign z4 = ((x11 ? ~x07 : x02) & (~x00 | ~x09)) | (x02 & (x07 ? ~x11 : ~x08)) | (~x07 & ~x08 & x11);
  assign z5 = (x02 & (x10 | (x07 & ~x11))) | (x11 & (x07 | x10)) | ~new_n38_ | (x00 & ~x07) | (~x02 & ~x11);
  assign new_n38_ = ~x12 & x13;
  assign z6 = new_n40_ | (~x02 & ~x11);
  assign new_n40_ = ~x07 & ~x10 & (new_n42_ | (~new_n41_ & ~x08));
  assign new_n41_ = (~x00 | (~x02 & (~x03 | x09))) & (~x01 | x02 | ~x11) & (x01 | x03 | ~x09);
  assign new_n42_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14) | (~x02 & (x01 | (x03 & ~x09))));
  assign z7 = (~new_n44_ & x11) | (x02 & ((~x07 & ~x08) | x10 | (x07 & ~x11)));
  assign new_n44_ = (new_n45_ | x02) & ~x07 & ~x10 & (x03 | x08);
  assign new_n45_ = (x01 | ~x03 | ~x09) & (x08 | x10 | ~x01 | x07);
  assign z8 = ~new_n47_ | (x07 & (x11 | (x02 & ~x11)));
  assign new_n47_ = (~x02 | (~x09 & ~x10)) & (new_n48_ | ~x09) & (x00 | x09) & (~x10 | ~x11) & (x02 | x11);
