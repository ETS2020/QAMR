...
module FAU ( 
  ...
  assign z5 = (x00 & ~x07 & (~x02 | x09)) | ~new_n38_ | x07 | (x02 & ~x09);
  assign new_n38_ = ~x10 & ~x12 & x13;
  assign z6 = (x02 & ~x09) | (~x07 & ~new_n40_ & ~x10);
  ...
  assign new_n44_ = (x08 | (x03 & (x07 | ~x09))) & ~x07 & ~x10 & (~x02 | x09);
  assign z8 = (x02 & (~x09 | (~x07 & x09 & ~x12))) | ~new_n47_ | x07 | (~new_n46_ & x09);
