...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | ((~x01 | x02) & (x01 | ~x02 | x04 | ~x13))) & (~x01 | ~x02 | ~x13 | (x04 & ~x05));
  assign z1 = (~x00 & ((~new_n29_ & x02) | (x01 & ~x02 & x03))) | (x02 & ~x13);
  assign new_n29_ = (x01 | (~x04 & (~x03 | x04 | ~x13))) & ((x05 & x06) | (~x03 & ~x04));
  ...
  assign z3 = ((~x07 | ~x11) & ((x00 & (~x02 | x13)) | (~x12 & x13))) | (~x02 & ~x12 & (~x11 | (~x07 & ~x13)));
  assign z4 = (~new_n36_ & ~x07) | (x02 & ~x13) | (x07 & ~x11);
  assign new_n36_ = x00 & x08 & x09;
  assign z5 = (~x02 & (x07 | (~x07 & ~x12 & ~x13))) | (x13 & (x07 | x10 | (x00 & ~x07))) | x12 | (x02 & ~x13);
  ...
  assign new_n42_ = (x07 | x10) & (~x02 | x13);
  assign new_n43_ = x02 ? (x07 | ~x13) : (x03 & (~x01 | x07 | x10));
  assign new_n44_ = ~x01 & ~x02 & x03 & x09;
  assign z8 = (~x00 & (x02 ? x13 : ~x09)) | new_n42_ | (x09 & (x02 ? x13 : ~new_n46_));
