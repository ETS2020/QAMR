...
module FAU ( 
  ...
  assign z4 = (~x11 & (~x09 | (~x02 & x07))) | (~x07 & (~x09 | (~x02 & (~x00 | ~x08))));
  assign z5 = ((~x02 | ~x09) & (~new_n37_ | x07 | (x00 & ~x07))) | (x12 & ((~x02 & x09) | (~x00 & ~x07 & ~x09)));
  assign new_n37_ = ~x10 & x13;
  assign z6 = ~x07 & ~x10 & (new_n40_ | (~new_n39_ & ~x09));
  assign new_n39_ = x00 ? (x08 | (~x02 & ~x03)) : (x02 ? (x01 & x14) : ~x03);
  assign new_n40_ = ~x02 & (~x00 | ~x08) & (x01 | (~x03 & x09));
  assign z7 = new_n42_ | new_n43_ | new_n44_ | (~x01 & x03 & x09);
  assign new_n42_ = x02 & (x09 | (~x07 & ~x08 & ~x09));
  assign new_n43_ = (~x02 | ~x09) & (x07 | x10);
  assign new_n44_ = ~x08 & (~x03 | (x01 & ~x02 & ~x07 & ~x10));
  assign z8 = (~x09 & (x07 | x10 | (~x00 & ~x07))) | (~x02 & (x07 | x10 | (~new_n46_ & x09)));
