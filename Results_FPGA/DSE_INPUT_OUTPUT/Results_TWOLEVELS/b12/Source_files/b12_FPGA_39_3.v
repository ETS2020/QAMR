...
module FAU ( 
  ...
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | (~x14 & (x07 | x10)) | ~x13 | (x13 & x14);
  assign z6 = ~x07 & ~x10 & (new_n40_ | ~new_n42_);
  assign new_n40_ = ~new_n41_ & (x02 | (x03 & ~x09));
  assign new_n41_ = (x08 | (x14 & (~x00 | x13))) & (x00 | x14);
  assign new_n42_ = (new_n43_ | x00) & (new_n44_ | x08);
  assign new_n43_ = (~x01 | (x14 & (x02 | x13))) & (x13 | ((x01 | (~x02 & (x03 | ~x09))) & (x02 | ~x03 | x09))) & (x03 | ~x09 | x14);
  assign new_n44_ = (~x01 | (x14 & (x02 | x13))) & (x03 | ~x09 | (x14 & (x01 | x13)));
  assign z7 = (~x08 & ((~new_n27_ & ~x03) | (~new_n46_ & ~x07))) | (~new_n27_ & (~new_n47_ | x07));
  assign new_n46_ = (~x02 | x13) & (x10 | ((~x01 | (x14 & (x02 | x13))) & (~x02 | x14)));
  assign new_n47_ = ~x10 & (x01 | x02 | ~x03 | ~x09);
