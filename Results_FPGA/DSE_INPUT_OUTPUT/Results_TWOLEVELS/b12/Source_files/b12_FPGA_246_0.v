...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n29_, new_n31_, new_n32_, new_n34_, new_n35_,
    new_n36_, new_n37_, new_n38_, new_n39_, new_n42_, new_n45_, new_n46_,
  ...
  assign z3 = ((~x07 | ~x11) & ((x00 & (x06 | x13)) | (x06 & ~x12))) | (~x12 & x13 & (~x11 | (~x00 & ~x07)));
  assign z4 = ((x06 | x13) & (x07 ? ~x11 : ~new_n42_)) | (~x00 & ~x07 & (x13 | (x06 & ~x13)));
  assign new_n42_ = x08 & x09;
  assign z5 = ((x06 | x13) & (x07 | (x00 & ~x07))) | (~x00 & ~x07 & (x13 ? x12 : x06)) | (x10 & x13);
  assign z6 = ~x07 & ~x10 & ~new_n45_ & ~new_n28_;
  assign new_n45_ = (~x02 | (x00 ? x08 : x01)) & new_n47_ & ((~new_n46_ & ~x01) | (x00 ? x08 : x02));
  assign new_n46_ = x03 & ~x09;
  assign new_n47_ = (x00 | (x01 ? x14 : (x03 | ~x09))) & (x08 | ~x09 | x01 | x03);
  assign z7 = ~new_n49_ | (~new_n28_ & (x07 | (x02 & ~x07 & ~x08)));
  assign new_n49_ = (x08 | (~x01 & x03)) & new_n50_ & (~x03 | ~x09 | x01 | x02);
  assign new_n50_ = ~x10 & (x06 | x13);
  assign z8 = (~new_n28_ & x07) | (~new_n52_ & x09) | (~x00 & ~x09) | new_n28_ | x10;
