...
module FAU ( 
  ...
  assign z11 = new_n67_ | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = ((x29 & x40) | (new_n70_ & (~x04 | ~x27))) & (x08 | (new_n70_ & ~x04 & x27));
  assign z12 = new_n89_ | (~x39 & x40) | ((new_n88_ | ~x27) & (x04 | ~x40));
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign new_n89_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
  assign z13 = new_n94_ | (x27 & (new_n91_ | (new_n93_ & ~x18)));
  assign new_n91_ = x39 & (new_n92_ | (~x18 & ~x19 & ~new_n88_ & x20));
  assign new_n92_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x19 & x20 & ~new_n88_ & ~x40;
  assign new_n94_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n97_ | (~new_n96_ & (x04 | x13 | ~x40));
  assign new_n96_ = ~new_n88_ & ~x18 & ~x19 & x20;
  assign new_n97_ = new_n99_ & (x30 | x32 | (x27 & (new_n98_ | ~x28)));
  assign new_n98_ = ((~x18 & ~x19 & x20) | (x35 & x36)) & (x35 | x37);
  assign new_n99_ = (x39 | ~x40) & (x27 | (~x04 & x40 & (~x13 | ~x39)));
  assign z15 = x12 & x26 & x27 & ~new_n67_ & x34;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n104_ & (x39 | ~x40)) | (x08 & x29 & x39 & x40);
  assign new_n104_ = ~new_n105_ & ~x09 & ~x30;
  assign new_n105_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n67_ | (~x09 & ~new_n107_ & ~x30);
  assign new_n107_ = (x08 | (x27 & x35)) & ((x29 & x40) | ((x27 | ~x28) & x35));
  assign z19 = new_n67_ | (~x09 & ~new_n86_ & ~x30);
endmodule
