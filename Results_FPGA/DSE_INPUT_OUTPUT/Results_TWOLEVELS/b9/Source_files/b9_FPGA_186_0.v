...
module FAU ( 
  ...
  assign z12 = (x40 & ((~new_n91_ & ~x10) | (~new_n92_ & (x04 | ~x39)))) | (x10 & ~new_n92_ & ~x40);
  assign new_n91_ = x27 & (x35 | x36 | x37);
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n96_ | (x27 & ((x40 & (new_n94_ | new_n95_)) | (new_n95_ & x10)));
  ...
  assign new_n101_ = (~x10 | new_n92_ | x40) & (~x40 | (~new_n102_ & (new_n92_ | new_n100_)));
