...
module FAU ( 
  ...
  assign new_n72_ = ~x33 & (~x04 | (~x28 & x35));
  ...
  assign z07 = (x33 & x40) | (x03 & (new_n80_ | (~x31 & new_n79_ & ~x33)));
  ...
  assign new_n84_ = ~new_n70_ & ((x07 & (~x40 | (~x33 & ~x39))) | (x39 & x40 & x05 & ~x33));
  assign new_n85_ = x06 & ~new_n67_ & x37;
  assign new_n86_ = ~x33 & x39 & x40 & (x30 | x32);
  ...
  assign new_n98_ = x40 & (x33 | (~new_n99_ & x39 & (~x40 | (~x04 & ~x13))));
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = (new_n68_ | x40) & (x33 | (~new_n101_ & ~new_n102_ & ~new_n103_));
  ...
  assign z18 = (~new_n108_ & (~x33 | ~x40)) | (x08 & x29 & ~x33 & x39 & x40);
