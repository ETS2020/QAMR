...
module FAU ( 
  ...
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | z08 | (~x27 & ~x37);
  ...
  assign z11 = z08 | (~x09 & ~x30 & ~z08 & ~new_n79_);
  assign new_n79_ = ~x28 & x35 & (~x04 | ~x27) & (x08 | x27);
  assign z12 = new_n65_ | z08 | ~x27;
  assign z13 = z08 | (~x18 & ~x19 & x20 & ~new_n65_ & x27);
  assign z14 = new_n65_ | x18 | x19 | ~x20 | z08 | ~x27;
