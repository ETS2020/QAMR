...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x19;
  ...
  assign new_n90_ = (x27 | (x19 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n91_ = x40 ? (x29 & x39) : x19;
  assign new_n92_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n94_ | (x19 & ~x40) | (~new_n65_ & (x40 ? (x04 | ~x39) : ~x19));
  assign new_n94_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (x27 & (new_n96_ | (~x04 & new_n97_ & ~x13))) | (~x04 & new_n87_ & ~x13);
  assign new_n96_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n97_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x40 & (new_n99_ | new_n101_)) | (~x19 & ~new_n103_ & ~x40);
  assign new_n99_ = (new_n66_ | ~new_n100_) & (x04 | x13 | ~x39);
  assign new_n100_ = ~x18 & ~x19 & x20 & x27;
  assign new_n101_ = ~x30 & ~x32 & (~x27 | (~new_n102_ & x28));
  assign new_n102_ = (x35 | x37) & ((x35 & x36) | (~x18 & ~x19 & x20));
  assign new_n103_ = ~new_n66_ & ~x18 & x20 & x27;
  assign z15 = new_n67_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n67_ & ~x24;
  assign z18 = new_n109_ | (~new_n67_ & (new_n108_ | x09 | x30));
  assign new_n108_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n109_ = x08 & x29 & x39 & x40;
  assign z20 = (x19 & ~x40) | (~x09 & ~x30 & (~new_n111_ | (~new_n113_ & ~x19)));
