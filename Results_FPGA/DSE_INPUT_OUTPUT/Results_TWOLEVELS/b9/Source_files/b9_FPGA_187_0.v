...
module FAU ( 
  ...
  assign z10 = new_n85_ | (x27 & (new_n84_ | (x06 & ~new_n68_ & x37)));
  assign new_n84_ = ~x04 & ~new_n70_ & ((x07 & (~x39 ^ ~x40)) | (x05 & x39 & x40));
  assign new_n85_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n68_ | (~x09 & ~x30 & (~new_n87_ | (~new_n88_ & ~x08)));
  assign new_n87_ = (~x40 | ((~x04 | ~x27 | (x29 & x39)) & (new_n73_ | x39))) & (~x39 | ((new_n73_ | (x29 & x40)) & (~x04 | ~x27 | x40)));
  assign new_n88_ = (x27 | (~x39 & ~x40)) & (~x40 | (~x04 & x35)) & (~x28 | ~x39);
  ...
  assign z14 = (~new_n103_ & ~x27) | new_n98_ | new_n68_ | (~new_n101_ & ~x37);
  ...
  assign new_n113_ = (~x40 | ((x35 | x39) & (x08 | (x27 & x35)))) & (x27 | (x39 ? x08 : ~x28));
endmodule
