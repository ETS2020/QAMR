...
module FAU ( 
  ...
  assign z12 = (x40 & ((~new_n91_ & ~x10) | (~new_n66_ & (x04 | ~x39)))) | (x10 & ~new_n66_ & ~x40);
  assign new_n91_ = x27 & (x35 | x36 | x37);
  assign z13 = (x27 & (new_n95_ | (new_n94_ & ~x04))) | new_n65_ | (new_n93_ & ~x04);
  assign new_n93_ = new_n84_ & ~x13;
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n97_ | new_n99_ | (~x40 & (~x10 | (x10 & ~x27))) | (~x27 & ~new_n102_ & x40);
  assign new_n97_ = ~x37 & ((~new_n98_ & (~x28 | ~x35)) | (x28 & ~x30 & ~x32 & ~x35));
  assign new_n98_ = (~x40 | (~x04 & x39)) & ~x13 & (~x10 | x40);
  ...
  assign z18 = ~new_n107_ | (x08 & (new_n87_ | (new_n72_ & ~x27)));
  assign new_n107_ = ~new_n65_ & ~x30 & ~x09 & (~new_n72_ | x04 | ~x27);
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = ~new_n111_ & (new_n110_ | (x35 & (x27 | ~x28)));
  assign new_n110_ = x40 ? (x29 & x39) : ~x10;
  assign new_n111_ = ~x08 & ((~x27 & (x10 | x40)) | (~x35 & x40));
