...
module FAU ( 
  ...
  assign new_n73_ = (x02 | (x08 & x29)) & ~x25 & (new_n71_ | ~x04);
  ...
  assign new_n84_ = ~new_n85_ & (new_n71_ | x36);
  assign new_n85_ = (~x07 | (x40 & (x25 | x39))) & (~x39 | ~x40 | ~x05 | x25);
  assign new_n86_ = x06 & ~new_n67_ & x37;
  assign new_n87_ = x05 & ~x25 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n90_ | (~new_n89_ & ~x08));
  assign new_n89_ = (x27 | (x25 & x40)) & (x25 | (new_n71_ & ~x04));
  assign new_n90_ = ~new_n91_ & (~x40 | (~x25 & (~x29 | ~x39)));
  ...
  assign z14 = new_n103_ | new_n99_ | new_n102_ | new_n104_;
  ...
  assign new_n103_ = x40 & (x25 | (x13 & ~x27));
  assign new_n104_ = ~x27 & (~x39 | ~x40 | x04 | (~x30 & ~x32));
  ...
  assign new_n112_ = (~x29 | ~x39) & ((~x27 & x28) | (~x25 & ~x35));
  assign new_n113_ = (x08 | ((x27 | x40) & (x25 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
