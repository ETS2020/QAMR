...
module FAU ( 
  ...
  assign z08 = x39 & x40;
  assign z09 = (~x34 & ~x40) | (x27 & x34 & x11 & x26);
  ...
  assign z12 = new_n90_ | new_n91_ | (~new_n66_ & (x04 | ~x39));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n91_ = ~x40 & (~x27 | ~x34 | (~x37 & (~x35 | (~x28 & x34))));
  ...
  assign new_n96_ = x20 & x34 & (x37 | (x28 & x35));
  ...
  assign new_n101_ = ~new_n102_ & ~new_n91_ & (new_n66_ | (~x04 & ~x13 & x39));
  assign new_n102_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = (~x34 & ~x40) | (x27 & x34 & x12 & x26);
