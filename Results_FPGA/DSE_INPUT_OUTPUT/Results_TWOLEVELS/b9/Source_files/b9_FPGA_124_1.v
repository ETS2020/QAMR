...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n73_,
    ...
    new_n99_, new_n104_, new_n106_, new_n107_;
  ...
  assign new_n86_ = (~x40 | (~x29 & x39)) & (~new_n73_ | (x04 & x27));
  assign new_n87_ = (x27 | (~x39 & x40)) & (~x39 | (new_n73_ & ~x04));
  ...
  assign z14 = new_n98_ | new_n99_ | new_n95_ | (new_n97_ & x28);
  assign new_n95_ = (new_n66_ | ~new_n96_) & (x04 | x13 | ~x40);
  assign new_n96_ = ~x18 & ~x19 & x20;
  assign new_n97_ = ~x30 & ~x32 & ((~new_n96_ & (~x35 | ~x36)) | (~x35 & ~x37));
  assign new_n98_ = x40 & (~x39 | (x13 & ~x27));
  assign new_n99_ = ~x27 & (x04 | ~x40 | (~x30 & ~x32));
  assign z15 = new_n69_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = ~new_n104_ | (x08 & ((x29 & x40) | (new_n73_ & ~x27)));
  assign new_n104_ = ~x09 & (~new_n73_ | x04 | ~x27) & ~new_n69_ & ~x30;
