...
module FAU ( 
  ...
  assign z02 = ~x40 | (x25 & (~new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n88_ = (x27 | (~x25 & x40)) & (~x25 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (~x25 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x25 & (new_n92_ | (~new_n93_ & (x04 | ~x39)))) | (~new_n93_ & ~x40);
  ...
  assign new_n97_ = x25 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n102_ | ((new_n99_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n99_ = x25 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (new_n93_ | x40) & (~x25 | (~new_n103_ & (new_n93_ | new_n101_)));
  ...
  assign z18 = (~new_n108_ & x08) | ~new_n109_ | new_n69_ | x09;
  assign new_n108_ = (~new_n68_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n109_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n111_ & ~x09;
  assign new_n111_ = ~x30 & (new_n112_ | (~new_n89_ & (~x35 | (~x27 & x28))));
  assign new_n112_ = ~x08 & ((x25 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
