...
module FAU ( 
  ...
  assign z06 = ~x37 & ((~x23 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign new_n83_ = ~new_n71_ & ((x07 & (x40 ? ~x39 : ~x23)) | (x05 & x39 & x40));
  ...
  assign new_n89_ = x40 ? (x29 & x39) : x23;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & (new_n66_ | ~x27)))) | (~x23 & ~x40 & (new_n66_ | ~x27));
  ...
  assign z14 = new_n98_ | new_n100_ | (~x40 & (x23 | (~x23 & ~x27))) | (~x27 & ~new_n103_ & x40);
  assign new_n98_ = ~x37 & ((~new_n99_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n99_ = (~x40 | (~x04 & x39)) & ~x13 & (x23 | x40);
  ...
  assign z17 = x23 & (~x40 | (x01 & x22 & ~x24));
  ...
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x23 | x40)));
endmodule
