...
module FAU ( 
  ...
  assign z12 = new_n90_ | new_n91_ | (~x39 & (~x27 | ~x40)) | (~x27 & (~x40 | (x04 & x39)));
  assign new_n90_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  assign new_n91_ = ~x37 & (((~x28 | ~x35) & (x04 | ~x40)) | (~x39 & (~x35 | (~x28 & x40))));
  ...
  assign z14 = (~new_n103_ & x40) | ~new_n99_ | (~new_n97_ & ~x37);
  assign new_n97_ = (new_n98_ | (x28 & x35)) & (x35 | (x39 & (~x28 | x30 | x32)));
  assign new_n98_ = ~x04 & ~x13 & x40;
  assign new_n99_ = ~new_n68_ & (new_n102_ | x27) & (new_n100_ | (~new_n101_ & new_n102_));
  assign new_n100_ = ~x18 & ~x19 & x20;
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n103_ = (x27 | x30 | x32) & (x28 | x37 | x39);
  ...
  assign new_n112_ = ~new_n113_ & (x08 | ((x35 | ~x39) & (x27 | (~x39 & ~x40))));
