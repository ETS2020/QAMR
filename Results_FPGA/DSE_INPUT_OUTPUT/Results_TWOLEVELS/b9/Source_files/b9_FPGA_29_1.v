...
module FAU ( 
  ...
  assign z02 = ~x39 | ~x40 | (~new_n72_ & x40);
  assign new_n72_ = (~x04 | (~x28 & x35)) & x08 & (x02 | x29);
  ...
  assign new_n87_ = ~new_n89_ & (~x40 | (~new_n88_ & x08));
  assign new_n88_ = x29 & x39;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n91_ | (~x08 & x40) | (~new_n68_ & (x04 | ~x39 | ~x40));
  assign new_n91_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (~new_n93_ & x27) | (~x04 & x08 & new_n85_ & ~x13);
  assign new_n93_ = (~x08 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign z14 = new_n102_ | new_n98_ | new_n101_ | new_n103_;
  ...
  assign new_n102_ = x40 & (~x08 | (x13 & ~x27));
  assign new_n103_ = ~x27 & (~x39 | ~x40 | x04 | (~x30 & ~x32));
  assign z15 = new_n67_ | (x12 & x26 & x27 & x34);
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n108_ | ~new_n109_;
  assign new_n108_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & (x08 | (x27 & ~x40))));
  assign new_n109_ = ((~x08 & x40) | (~x09 & ~x30)) & (~x39 | ~x40 | ~x08 | ~x29);
  assign z19 = ~x09 & ~x30 & (new_n87_ | (~x08 & ~x27 & ~x40));
  assign z20 = new_n67_ | (~x09 & ~new_n112_ & ~x30);
  assign new_n112_ = (new_n88_ | ((x27 | ~x28) & (~x08 | x35))) & (x40 | (x35 & (x27 | (x08 & ~x28))));
endmodule
