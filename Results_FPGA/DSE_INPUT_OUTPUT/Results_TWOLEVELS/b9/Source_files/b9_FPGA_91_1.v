// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:11 2020
...
module FAU ( 
  ...
  assign z02 = new_n72_ | ~new_n74_ | (~x27 & (~x40 | (x04 & ~x08)));
  assign new_n72_ = x33 & (new_n73_ | (x04 & (x28 | ~x35)));
  assign new_n73_ = ~x02 & (~x08 | ~x29);
  assign new_n74_ = (x40 | ((~x27 | ~x28) & ~x37 & (x28 | x37))) & x39 & (x33 | ~x40);
  ...
  assign z07 = (~x33 & x40) | (x03 & (new_n81_ | (~x31 & new_n80_ & ~x33)));
  ...
  assign new_n104_ = (~x33 | (~x04 & x39)) & ~x13 & x40;
  assign new_n105_ = (x33 | ~x40) & (x27 | (x40 & (~x33 | (~x04 & ~x13 & x39))));
  assign z15 = x12 & x26 & x27 & ~new_n68_ & x34;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n68_ & ~x24;
  assign z18 = (~new_n110_ & x08) | ~new_n111_ | new_n68_ | x30;
  ...
  assign new_n113_ = (~x29 | ~x39) & ((~x27 & x28) | (x33 & ~x35));
  assign new_n114_ = (x08 | ((x27 | (~x33 & x40)) & (~x33 | x35))) & (x40 | (x35 & (x27 | ~x28)));
