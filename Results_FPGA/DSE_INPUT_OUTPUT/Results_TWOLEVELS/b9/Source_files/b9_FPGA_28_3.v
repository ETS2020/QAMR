...
module FAU ( 
  ...
  assign new_n100_ = ~x04 & new_n86_ & ~x13;
  assign z14 = ~new_n105_ | ((new_n102_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n102_ = ~x33 & (new_n103_ | ~new_n104_);
  assign new_n103_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n104_ = ~x04 & ~x13 & x39;
  assign new_n105_ = (x40 | (~new_n66_ & x27)) & (x33 | (~new_n106_ & (new_n104_ | (~new_n66_ & x27))));
  ...
  assign z18 = (~new_n111_ & x08) | ~new_n112_ | new_n68_ | x30;
  assign new_n111_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n112_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n114_ & ~x09;
  assign new_n114_ = ~x30 & (new_n115_ | (~new_n91_ & (~x35 | (~x27 & x28))));
  assign new_n115_ = ~x08 & ((~x33 & ~x35) | (~x27 & (~x33 | ~x40)));
  assign z05 = ~z06;
endmodule
