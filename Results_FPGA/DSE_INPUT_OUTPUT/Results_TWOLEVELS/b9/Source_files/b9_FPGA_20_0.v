...
module FAU ( 
  ...
  assign z18 = (~new_n108_ & (x39 | x40)) | (x08 & x29 & x39 & x40);
  assign new_n108_ = ~new_n109_ & ~x09 & ~x30;
  assign new_n109_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n65_ | (~x09 & ~x30 & (new_n111_ | ~new_n112_));
  assign new_n111_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n112_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((~x28 | x39) & (x08 | (~x39 & ~x40))));
endmodule
