...
module FAU ( 
  ...
  assign z11 = (x23 & ~x40) | (~x09 & ~x30 & (~new_n87_ | (~new_n90_ & ~x23)));
  ...
  assign z12 = new_n92_ | new_n93_ | ((x04 | ~x39) & (new_n66_ | ~x27));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = ~x40 & (x23 | ~x27 | (~x37 & (~x35 | (~x23 & ~x28))));
  ...
  assign new_n97_ = ~x19 & x20 & ~new_n66_ & ~x23;
  ...
  assign new_n102_ = ~new_n93_ & ((~new_n66_ & x27) | (~x04 & ~x13 & x39));
