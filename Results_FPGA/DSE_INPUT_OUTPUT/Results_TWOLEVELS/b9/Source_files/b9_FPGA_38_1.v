// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:38 2020
...
module FAU ( 
  ...
  assign z02 = (~new_n71_ & x40) | ~x40 | (x04 & (~x35 | (~x08 & ~x27)));
  assign new_n71_ = (x02 | (x08 & x29)) & x39 & (~x04 | ~x28);
  ...
  assign new_n96_ = ~x04 & ~x13 & x39 & ~new_n84_ & x40;
  assign z14 = new_n102_ | new_n98_ | new_n99_ | (new_n101_ & x28);
  assign new_n98_ = ~x27 & (x04 | new_n84_ | ~x40);
  assign new_n99_ = (new_n90_ | ~new_n100_) & (x04 | x13 | ~x40);
  assign new_n100_ = ~x18 & ~x19 & x20;
  assign new_n101_ = ~x30 & ~x32 & ((~new_n100_ & (~x35 | ~x36)) | (~x35 & ~x37));
  assign new_n102_ = x40 & (~x39 | (x13 & ~x27));
  assign z15 = x12 & x26 & x27 & ~new_n67_ & x34;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (x08 & x29 & x39 & x40) | (~new_n107_ & (x39 | ~x40));
