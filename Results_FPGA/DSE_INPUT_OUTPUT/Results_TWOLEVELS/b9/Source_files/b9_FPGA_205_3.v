...
module FAU ( 
  ...
  assign z09 = x26 & (x40 | (x11 & x27 & x34));
  assign z10 = (x27 & (new_n86_ | (new_n84_ & ~x04))) | (new_n87_ & ~x04);
  assign new_n84_ = ~new_n85_ & (x36 | (~x28 & x35));
  assign new_n85_ = (~x07 | (x40 & (x26 | x39))) & (~x39 | ~x40 | ~x05 | x26);
  assign new_n86_ = x06 & ~new_n69_ & x37;
  assign new_n87_ = x05 & ~x26 & x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n69_;
  assign z19 = ~x09 & ~x30 & ((~new_n91_ & ~new_n92_) | (~new_n90_ & ~x08));
  assign new_n90_ = (x27 | (x26 & x40)) & (x26 | (~x04 & ~x28 & x35));
  assign new_n91_ = x40 & (x26 | (x29 & x39));
  assign new_n92_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n94_ | new_n69_ | ((new_n66_ | ~x27) & (~new_n68_ | x04));
  ...
  assign new_n98_ = ~x26 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n105_ | new_n100_ | new_n103_ | new_n104_;
  assign new_n100_ = (new_n101_ | ~new_n102_) & (x18 | x19 | ~x20);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13 & x39 & x40;
  assign new_n103_ = ~x37 & ((~new_n102_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n104_ = ~x27 & (~new_n68_ | x04 | (~x30 & ~x32));
  assign new_n105_ = x40 & (x26 | (x13 & ~x27));
  assign z15 = x26 & (x40 | (x12 & x27 & x34));
  assign z16 = new_n69_ | (x01 & x22 & ~x23);
  assign z17 = new_n69_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n110_ & x08) | ~new_n111_ | new_n69_ | x09;
  assign new_n110_ = (x27 | x28 | ~x35) & (~new_n68_ | ~x29);
  assign new_n111_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n113_ | ~new_n114_));
  assign new_n113_ = (~x29 | ~x39) & ((~x27 & x28) | (~x26 & ~x35));
  assign new_n114_ = (x08 | ((x26 | (x27 & x35)) & (x27 | x40))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
