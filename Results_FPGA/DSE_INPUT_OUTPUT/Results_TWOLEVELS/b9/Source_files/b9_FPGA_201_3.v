...
module FAU ( 
  ...
  assign z02 = new_n72_ | (~x40 & (~x27 | (x27 & x28) | x37 | (~x28 & ~x37)));
  ...
  assign new_n100_ = (~x03 | ~x40) & (new_n68_ | ((x03 | (~x04 & x39)) & ~x13 & x40));
  assign new_n101_ = ~x32 & ((~x03 & ~x27) | (x28 & ~x35 & ~x37));
  assign z15 = x12 & x26 & x27 & ~new_n67_ & x34;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n106_ & (~x03 | ~x40)) | (~x03 & x08 & x29 & x39 & x40);
  ...
  assign new_n110_ = ~x08 & ((~x03 & (~x27 | ~x35)) | (~x27 & ~x40));
  assign z06 = ~z05;
