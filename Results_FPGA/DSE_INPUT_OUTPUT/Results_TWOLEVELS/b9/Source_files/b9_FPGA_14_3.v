// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:28 2020
...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (x40 & (x22 | x39))) & (~x39 | ~x40 | ~x05 | x22);
  assign new_n85_ = x05 & ~x22 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & (~x40 | (~x22 & (~x29 | ~x39)));
  ...
  assign new_n97_ = ~x13 & ~x22 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n102_ | ((x18 | x19 | ~x20) & (new_n99_ | ~x40));
  assign new_n99_ = ~x22 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (new_n68_ | x40) & (x22 | (~new_n103_ & (new_n68_ | new_n101_)));
  ...
  assign z18 = (~new_n108_ & (~x22 | ~x40)) | (x08 & ~x22 & x29 & x39 & x40);
  assign new_n108_ = ~new_n109_ & ~x09 & ~x30;
  assign new_n109_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n67_ | (~x09 & ~x30 & (new_n111_ | ~new_n112_));
  assign new_n111_ = (~x29 | ~x39) & ((~x27 & x28) | (~x22 & ~x35));
  assign new_n112_ = (x08 | ((x22 | (x27 & x35)) & (x27 | x40))) & (x40 | (x35 & (x27 | ~x28)));
