// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:42 2020
...
module FAU ( 
  ...
  assign z10 = (~new_n84_ & x27) | (new_n86_ & ~x03);
  assign new_n84_ = (x04 | new_n70_ | new_n85_) & (~x06 | new_n68_ | ~x37);
  assign new_n85_ = (x03 | ((~x07 | x39) & (~x05 | ~x39 | ~x40))) & (~x07 | x40);
  ...
  assign new_n90_ = x40 & (x03 | (x29 & x39));
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n93_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n93_ = (~x03 | ~x40) & ((~new_n66_ & x27) | (x40 & (x03 | (~x04 & x39))));
  assign z13 = (new_n98_ & ~x03) | (x27 & ((~new_n95_ & ~x03) | (new_n97_ & ~x18)));
  ...
  assign new_n100_ = ~x03 & (new_n101_ | ~new_n102_);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13 & x39;
  assign new_n103_ = (x03 | (~new_n104_ & (new_n102_ | (~new_n66_ & x27)))) & (x40 | (~new_n66_ & x27));
  ...
  assign z18 = (~new_n109_ & x08) | ~new_n110_ | new_n68_ | x09;
  ...
  assign new_n113_ = ~x08 & ((~x03 & (~x27 | ~x35)) | (~x27 & ~x40));
  assign z05 = ~z06;
endmodule
