...
module FAU ( 
  ...
  assign new_n87_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x28 & x35)) & (~x04 | ~x40);
  assign z12 = new_n89_ | new_n90_ | (~x39 & (~x40 | (~x27 & x40))) | (~x27 & (x40 ? x04 : x39));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n90_ = ~x37 & ((x04 & ((~x28 & x39) | (~x35 & x40))) | ((~x28 | ~x35) & (~x39 ^ ~x40)));
  ...
  assign new_n96_ = x40 ? (~new_n97_ & ~x04 & ~x13 & x39) : ~x39;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = (x30 | new_n99_ | x32) & ~new_n101_ & (new_n100_ | x37);
  assign new_n99_ = (x27 | ~x39) & (x37 | ~x40 | ~x28 | x35);
  assign new_n100_ = (~x04 | ((x35 | ~x40) & (x28 | ~x39))) & ((x28 & x35) | (x40 ? (~x13 & x39) : ~x39));
  assign new_n101_ = ~x27 & (x40 ? (x04 | x13 | ~x39) : x39);
