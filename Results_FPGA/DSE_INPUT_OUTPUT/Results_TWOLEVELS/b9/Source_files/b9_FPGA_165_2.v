...
module FAU ( 
  ...
  assign z10 = (x27 & (new_n85_ | (~new_n83_ & ~x04))) | (new_n86_ & ~x04);
  assign new_n83_ = (~x40 | new_n84_ | (~x36 & (x28 | ~x35))) & (~x07 | x28 | ~x35 | x36 | x40);
  assign new_n84_ = x39 ? ~x05 : ~x07;
  assign new_n85_ = x06 & ~new_n67_ & x37;
  assign new_n86_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n90_ & ~x08));
  assign new_n88_ = ~new_n89_ & (x40 ? (~x29 | ~x39) : ~x36);
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n90_ = (x27 | (x36 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n92_ | (x36 & ~x40) | (~new_n65_ & (x40 ? (x04 | ~x39) : ~x36));
