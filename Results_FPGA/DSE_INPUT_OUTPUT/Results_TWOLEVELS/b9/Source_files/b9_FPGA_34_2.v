...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : ~x38;
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (x40 ? ~x39 : ~x38)) | (x05 & x39 & x40));
  ...
  assign new_n89_ = x40 ? (x29 & x39) : x38;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n92_ | ~new_n94_ | (~new_n93_ & ~x37);
  assign new_n92_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n93_ = ((x28 & x35) | (~x04 & x39)) & (x40 | (x35 & (x28 | x38)));
  assign new_n94_ = (x40 | (x27 & ~x38)) & (x27 | (x39 & (~x04 | ~x40)));
  ...
  assign z14 = new_n99_ | (new_n105_ & ~x30) | new_n102_ | ~new_n103_;
  assign new_n99_ = (new_n100_ | ~new_n101_) & (x18 | x19 | ~x20);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n102_ = (x04 | x13) & (new_n66_ | (~x27 & x40));
  assign new_n103_ = (new_n104_ | (x39 & x40)) & (~x38 | x40) & (x28 | x37 | (x39 & (x38 | x40)));
  ...
  assign new_n114_ = (x35 | (x40 ? x08 : x38)) & (x27 | ((x08 | (x38 & ~x40)) & (~x28 | x40)));
endmodule
