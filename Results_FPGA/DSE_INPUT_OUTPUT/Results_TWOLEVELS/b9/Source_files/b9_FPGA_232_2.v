...
module FAU ( 
  ...
  assign z03 = (~x27 & ~x37 & (~x39 | (x39 & x40))) | (x27 & ~new_n74_ & (~x39 | x40)) | ~x21 | (x39 & ~x40);
  assign new_n74_ = x28 & x35;
  assign z04 = (~x27 & ~x37 & (~x39 | (x39 & x40))) | ((~x39 | x40) & (x21 | (~new_n74_ & x27)));
  ...
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n88_ & ~x08));
  assign new_n87_ = (~x39 | (~x29 & x40)) & (~new_n70_ | (x04 & x27));
  assign new_n88_ = (x27 | (x39 & ~x40)) & (~x40 | (new_n70_ & ~x04));
  assign z12 = ~new_n90_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n90_ = (x27 | (x39 & (~x04 | ~x39))) & (~x39 | x40) & (x37 | new_n74_ | (~x04 & x39));
  assign z13 = new_n96_ | (~new_n92_ & x27);
  assign new_n92_ = (~x40 | (~new_n93_ & (x18 | ~new_n94_ | x19))) & (x18 | ~new_n95_ | x19);
  assign new_n93_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n94_ = x20 & (x37 | (x28 & x35));
  assign new_n95_ = x20 & ~x39 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (x39 & (~x40 | (x04 & ~x27))) | ~new_n98_ | (~new_n102_ & ~x27);
  assign new_n98_ = (new_n99_ | new_n100_) & (~x28 | x30 | new_n101_ | x32);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n101_ = ((~x18 & ~x19 & x20) | (x35 & x36)) & (x35 | x37);
  assign new_n102_ = ~x13 & x39 & (x30 | x32 | ~x40);
  assign z15 = new_n67_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n107_ | (x08 & ((x29 & x39) | (new_n70_ & ~x27)));
  assign new_n107_ = ~x09 & (~new_n70_ | x04 | ~x27) & ~new_n67_ & ~x30;
  ...
  assign z19 = ~x09 & ~x30 & (new_n87_ | (~new_n88_ & ~x08));
endmodule
