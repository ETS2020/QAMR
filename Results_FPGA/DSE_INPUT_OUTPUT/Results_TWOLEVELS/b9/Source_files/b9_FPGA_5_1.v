...
module FAU ( 
  ...
  assign new_n86_ = ((x29 & x40) | (new_n72_ & (~x04 | ~x27))) & (x08 | (new_n72_ & ~x04 & x27));
  ...
  assign z14 = new_n96_ | ~new_n98_ | (~new_n101_ & (x04 | x13));
  assign new_n96_ = ~x37 & ((~new_n97_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n97_ = ~x13 & x40 & (~x04 | ~x39);
  assign new_n98_ = ~new_n99_ & ~new_n67_ & (new_n100_ | (~x18 & ~x19 & x20));
  assign new_n99_ = ~x27 & (~x40 | (~x30 & ~x32));
  assign new_n100_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n101_ = ~x18 & ~x19 & x20 & (x27 | ~x39);
  ...
  assign new_n106_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n67_ & ~x30;
