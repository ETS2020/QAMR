...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x06;
  ...
  assign z10 = (~new_n82_ & ~x04) | (~x06 & ~x40) | (x06 & x27 & x37);
  ...
  assign new_n86_ = x40 ? (x29 & x39) : ~x06;
  assign new_n87_ = (x27 | (~x06 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n89_ | (~x06 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x06));
  assign new_n89_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = new_n91_ | (~x04 & new_n83_ & ~x13);
  assign new_n91_ = x27 & ((new_n93_ & x06) | (x40 & (new_n92_ | new_n93_)));
  assign new_n92_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n98_ | (~new_n95_ & (x18 | x19 | ~x20));
  assign new_n95_ = x40 ? (~new_n96_ & new_n97_) : ~x06;
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = ~x04 & ~x13 & x39;
  assign new_n98_ = (~x40 | (~new_n99_ & (new_n66_ | new_n97_))) & (~x06 | new_n66_ | x40);
  ...
  assign new_n108_ = ~x08 & ((~x35 & x40) | (~x27 & (x06 | x40)));
