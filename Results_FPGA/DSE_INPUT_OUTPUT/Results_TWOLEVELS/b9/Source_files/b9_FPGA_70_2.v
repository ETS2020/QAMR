// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:57 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n78_,
    new_n79_, new_n81_, new_n82_, new_n83_, new_n86_, new_n87_, new_n89_,
  ...
  assign new_n71_ = x40 & (~x04 | (~x28 & x35));
  assign new_n72_ = (x27 | (x39 & (~x04 | x08))) & (x39 | ((~x27 | ~x28) & ~x37 & (x28 | x37)));
  ...
  assign z08 = x39 & x40 & (~new_n81_ | (~x09 & ~new_n83_ & ~x30));
  assign new_n81_ = new_n82_ & (~x08 | (~x29 & (x27 | x28 | ~x35)));
  ...
  assign z11 = ~x09 & ~x30 & ((~new_n91_ & ~x08) | (~new_n89_ & ~new_n90_));
  assign new_n89_ = x39 & (x29 | ~x39 | ~x40);
  ...
  assign z14 = new_n101_ | (~new_n99_ & (~x39 | (x40 & (x04 | x13))));
  assign new_n99_ = new_n100_ & (x37 | (x28 & x35));
  assign new_n100_ = x20 & x27 & ~x18 & ~x19;
