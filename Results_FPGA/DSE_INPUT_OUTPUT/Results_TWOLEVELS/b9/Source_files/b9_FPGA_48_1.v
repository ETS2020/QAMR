...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x34) | ~x40 | new_n73_ | ~x39 | (~x34 & x40);
  ...
  assign new_n84_ = (~new_n86_ | ~x05) & (~x27 | new_n70_ | (new_n85_ ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40;
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = new_n67_ | (~x09 & ~x30 & (new_n88_ | new_n89_));
  assign new_n88_ = (~new_n85_ | ~x29) & ((x04 & x27) | x28 | ~x35);
  assign new_n89_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x34));
  assign z12 = new_n91_ | new_n67_ | (~new_n68_ & (~new_n85_ | x04));
  assign new_n91_ = ~x10 & ((~x27 & x34) | (~x35 & ~x36 & ~x37));
  ...
  assign new_n95_ = x34 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n97_ & ~x27) | new_n98_ | new_n101_ | new_n67_;
  assign new_n97_ = new_n85_ & ~x04 & (~x34 | (~x13 & (x30 | x32)));
  ...
  assign new_n106_ = (~new_n85_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n107_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n67_ | (~x09 & ~new_n109_ & ~x30);
  assign new_n109_ = (x08 | (x27 & x35)) & ((new_n85_ & x29) | (x35 & (x27 | ~x28)));
  assign z19 = new_n67_ | (~x09 & ~x30 & (new_n88_ | new_n89_));
endmodule
