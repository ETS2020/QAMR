...
module FAU ( 
  ...
  assign new_n87_ = (x27 | (x34 & x40)) & (x34 | (~x04 & ~x28 & x35));
  ...
  assign z13 = (~new_n93_ & x27) | (~x04 & ~x13 & new_n85_ & ~x34);
  assign new_n93_ = (x34 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  ...
  assign new_n100_ = ~new_n69_ & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = new_n106_ | (~new_n69_ & (new_n107_ | x09 | x30));
  assign new_n106_ = x08 & x29 & new_n68_ & ~x34;
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = z11 | new_n69_;
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n110_ | ~new_n111_));
  assign new_n110_ = (~x29 | ~x39) & ((~x27 & x28) | (~x34 & ~x35));
  assign new_n111_ = (x08 | ((x27 | (x34 & x40)) & (x34 | x35))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
