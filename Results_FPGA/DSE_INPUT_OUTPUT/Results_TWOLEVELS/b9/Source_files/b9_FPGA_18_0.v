...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & (x10 | x27)) | (~new_n66_ & (x27 | (x10 & ~x27))) | (x10 & ~x27 & x04 & ~x08);
  assign new_n72_ = (x02 | (x08 & x29)) & (~x04 | (~x28 & x35));
  assign z03 = (~x27 & (~x10 | (x10 & ~x37))) | new_n74_ | ~x21;
  assign new_n74_ = x27 & (~x35 | (~x28 & ((~x04 & x35) | x37 | (x04 & ~x37))));
  assign z04 = (~x27 & (~x10 | (x10 & ~x37))) | new_n74_ | x21;
  assign z05 = (x27 & (x28 | (~x28 & x37))) | (x10 & x37);
  ...
  assign new_n84_ = x40 & ((~new_n70_ & x27) | ((x10 | x27) & (x30 | x32)));
  assign new_n85_ = x07 & x27 & ~new_n66_ & ~new_n70_;
  assign new_n86_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & ((new_n88_ & x27) | (~new_n89_ & x10));
  ...
  assign z14 = ~new_n99_ | (~new_n98_ & (~new_n66_ | x04));
  assign new_n98_ = (~new_n68_ | ~x27) & ~x18 & ~x19 & x20 & (~x10 | x27);
  assign new_n99_ = ~new_n101_ & new_n102_ & (new_n100_ | (~x18 & ~x19 & x20));
  assign new_n100_ = ~x13 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n101_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n102_ = (x27 | (x10 & ~x13)) & (~x13 | x37 | (x28 & x35));
  assign z15 = (~x10 & ~x27) | (x12 & x26 & x27 & x34);
  ...
  assign new_n110_ = (x08 | (x27 ? x35 : ~x10)) & (new_n90_ | ((~x27 | x35) & (~x10 | (x35 & (x27 | ~x28)))));
  assign z19 = ~x09 & ~x30 & ((new_n88_ & x27) | (~new_n89_ & x10));
endmodule
