...
module FAU ( 
  ...
  assign new_n82_ = (~new_n83_ | ~x05) & (~x27 | new_n70_ | (new_n67_ ? ~x05 : ~x07));
  ...
  assign new_n87_ = (x27 | (~x37 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n89_ | (~x10 & (new_n91_ | ~x27)))) | (~x27 & x37 & ~x40);
  assign new_n89_ = (x04 | ~x39) & (new_n90_ | ~x27);
  assign new_n90_ = ~x37 & (~x28 | ~x35);
  assign new_n91_ = ~x35 & ~x36 & ~x37;
  assign z13 = (~new_n93_ & x27) | new_n68_ | (~x04 & new_n83_ & ~x13);
  assign new_n93_ = (~new_n94_ | x04) & (x18 | x19 | new_n90_ | ~x20);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x40 & (new_n96_ | (~new_n98_ & (new_n90_ | ~new_n99_)))) | (x37 & ~new_n99_ & ~x40);
  ...
  assign z18 = (~new_n104_ & ~new_n68_) | (new_n67_ & x08 & x29);
  ...
  assign new_n108_ = ~x08 & ((~x27 & (x37 | x40)) | (~x35 & x40));
  assign z05 = ~z06;
