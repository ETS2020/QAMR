...
module FAU ( 
  ...
  assign z11 = new_n67_ | (new_n86_ & ~x09);
  assign new_n86_ = ~x30 & (new_n87_ | new_n89_ | (~new_n88_ & ~x08));
  assign new_n87_ = (~x29 | ~x40) & (x28 | (x04 & x27));
  assign new_n88_ = (x27 | (~x39 & x40)) & ~x04 & ~x28 & (x35 | ~x39);
  assign new_n89_ = ~x35 & (~x40 | (~x29 & x39));
  ...
  assign new_n94_ = ~x18 & ~x19 & ~new_n91_ & x20;
  ...
  assign new_n102_ = ~new_n67_ & (new_n96_ | x27);
  ...
  assign z19 = new_n67_ | (new_n86_ & ~x09);
endmodule
