...
module FAU ( 
  ...
  assign z12 = new_n92_ | new_n91_ | (~x39 & (~x27 | ~x40)) | (~x27 & (~x40 | (x04 & x39)));
  assign new_n91_ = ~x37 & (~x28 | ~x35) & (~new_n68_ | x04);
  assign new_n92_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
