...
module FAU ( 
  ...
  assign new_n87_ = x40 & (x30 | (~new_n88_ & (new_n89_ | ~x40) & (~x28 | x39)));
  assign new_n88_ = (~x29 | ~x39) & ((x04 & x27) | (~x35 & x40));
  assign new_n89_ = (~x28 | (x08 & x29)) & (x08 | (~x04 & x27 & x35));
  ...
  assign new_n99_ = ~new_n100_ & z08 & ~x04 & ~x13;
  ...
  assign z18 = new_n107_ | x09 | x30 | new_n108_ | (~x09 & ~x40);
  assign new_n107_ = x08 & ((x29 & x39) | (~x27 & ~x28 & x35));
  assign new_n108_ = ~x04 & x27 & ~x28 & x35;
  assign z20 = ~x09 & ~x30 & ~new_n110_ & x40;
  assign new_n110_ = (x08 | (x27 & x35)) & ((x29 & x39) | (x35 & (x27 | ~x28)));
