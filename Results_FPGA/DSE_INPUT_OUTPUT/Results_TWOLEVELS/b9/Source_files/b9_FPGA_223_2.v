...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (x40 ? x39 : x06)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n68_;
  assign z19 = ~x09 & ~x30 & ((~new_n89_ & ~new_n90_) | (~new_n88_ & ~x08));
  assign new_n88_ = (x27 | (x06 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 ? (x29 & x39) : x06;
  assign new_n90_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & (x04 | ~x39)))) | (~x06 & ~new_n93_ & ~x40);
  ...
  assign new_n99_ = x40 ? (~new_n100_ & new_n101_) : x06;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (x06 | new_n93_ | x40) & (~x40 | (~new_n103_ & (new_n93_ | new_n101_)));
  ...
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x06 | x40)));
endmodule
