// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:38 2020
...
module FAU ( 
  ...
  assign z02 = (x39 & (new_n71_ | (x04 & x28))) | (~new_n72_ & x04) | ~x40 | (~x39 & x40);
  assign new_n71_ = ~x02 & (~x08 | ~x29);
  assign new_n72_ = x35 & (x08 | x27);
  ...
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~x08) | (~new_n86_ & ~new_n87_));
  assign new_n86_ = x40 & (x29 | ~x39);
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (~x39 & x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign z12 = (x39 & (new_n91_ | (x04 & (new_n90_ | ~x27)))) | (~x40 & (new_n90_ | ~x27));
  assign new_n90_ = ~x37 & (~x28 | ~x35);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n96_ | (x27 & (new_n93_ | (new_n95_ & ~x18)));
  assign new_n93_ = x39 & (new_n94_ | (~x18 & ~x19 & ~new_n90_ & x20));
  assign new_n94_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x19 & x20 & ~new_n90_ & ~x40;
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n98_ | ~new_n100_ | (~new_n103_ & (x04 | x13));
  assign new_n98_ = ~x37 & ((~new_n99_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n99_ = ~x13 & x40 & (~x04 | ~x39);
  assign new_n100_ = ~new_n101_ & ~new_n67_ & (new_n102_ | (~x18 & ~x19 & x20));
  assign new_n101_ = ~x27 & (~x40 | (~x30 & ~x32));
  assign new_n102_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n103_ = ~x18 & ~x19 & x20 & (x27 | ~x39);
  assign z15 = x12 & x26 & x27 & ~new_n67_ & x34;
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n108_ | ~new_n109_ | new_n67_ | x30;
  assign new_n108_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x40));
  assign new_n109_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = z11 | new_n67_;
  assign z20 = new_n67_ | (~x09 & ~new_n112_ & ~x30);
  assign new_n112_ = ~new_n113_ & (x35 | (x40 & (~x39 | (x08 & x29))));
  assign new_n113_ = ~x27 & ((~x08 & (x39 | ~x40)) | (x28 & (~x29 | ~x40)));
endmodule
