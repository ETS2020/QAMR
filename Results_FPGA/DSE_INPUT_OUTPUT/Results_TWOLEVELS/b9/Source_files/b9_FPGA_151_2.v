...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x39) | new_n73_ | (~new_n74_ & ~x39);
  assign new_n72_ = (x02 | (x08 & x29)) & x40 & (~x04 | x35);
  ...
  assign z11 = new_n69_ | (~x09 & ~x30 & (new_n87_ | (~new_n88_ & ~x08)));
  assign new_n87_ = (~x29 | ~x39) & ((x04 & x27) | x28 | ~x35);
  assign new_n88_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = (~x10 & (new_n90_ | (~x27 & x39))) | ~new_n91_ | (~x27 & (~x39 | (x04 & x39)));
  assign new_n90_ = ~x35 & ~x36 & ~x37;
  assign new_n91_ = (~x39 | x40) & (x37 | (x28 & x35) | (~x04 & x39));
  ...
  assign z14 = ~new_n99_ | (~new_n98_ & (x04 | x13 | ~x39));
