...
module FAU ( 
  ...
  assign z07 = x03 & ((~x33 & (new_n79_ | (~new_n80_ & ~x14))) | (~x14 & ~new_n80_ & ~x40));
  ...
  assign new_n85_ = (~x07 | (x40 & (x33 | x39))) & (~x39 | ~x40 | ~x05 | x33);
  assign new_n86_ = x05 & ~x33 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n90_ & ~x08));
  assign new_n88_ = ~new_n89_ & (~x40 | (~x33 & (~x29 | ~x39)));
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n90_ = (x27 | (x33 & x40)) & (x33 | (~x04 & ~x28 & x35));
  assign z12 = (~x33 & (new_n92_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n94_ & x27) | (new_n98_ & ~x04);
  ...
  assign new_n98_ = ~x13 & ~x33 & x39 & x40 & (x30 | x32);
  ...
  assign z18 = (~new_n110_ & (~x33 | ~x40)) | (x08 & x29 & ~x33 & x39 & x40);
