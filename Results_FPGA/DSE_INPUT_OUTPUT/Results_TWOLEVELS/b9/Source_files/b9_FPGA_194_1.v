...
module FAU ( 
  ...
  assign new_n87_ = (x40 | (x35 & (x08 | x27))) & ~x28 & (~x04 | ~x27);
  assign z12 = (x09 & (new_n89_ | (~new_n90_ & (x04 | ~x39)))) | (~new_n90_ & ~x40);
  ...
  assign new_n94_ = x09 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n96_ & (x18 | x19 | ~x20)) | ~new_n98_ | new_n99_;
  assign new_n96_ = ~new_n97_ & ~x04 & ~x13 & x39 & x40;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = (x09 | ~x40) & (new_n90_ | (~x13 & x40 & (~x09 | (~x04 & x39))));
  ...
  assign z18 = x09 | new_n104_ | x30 | (~x09 & x40);
  assign new_n104_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n106_ & ~x09;
  assign new_n106_ = ~x30 & ~x40 & (~x35 | (~x27 & (~x08 | x28)));
  assign z19 = z11;
endmodule
