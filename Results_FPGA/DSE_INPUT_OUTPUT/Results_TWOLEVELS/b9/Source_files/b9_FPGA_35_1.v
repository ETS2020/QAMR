...
module FAU ( 
  ...
  assign z14 = ~new_n98_ | (~new_n97_ & (x04 | x13 | ~x40));
  assign new_n97_ = ~new_n90_ & ~x18 & ~x19 & x20;
  assign new_n98_ = new_n100_ & (x30 | x32 | (x27 & (new_n99_ | ~x28)));
  assign new_n99_ = ((~x18 & ~x19 & x20) | (x35 & x36)) & (x35 | x37);
  assign new_n100_ = (x39 | ~x40) & (x27 | (~x04 & x40 & (~x13 | ~x39)));
