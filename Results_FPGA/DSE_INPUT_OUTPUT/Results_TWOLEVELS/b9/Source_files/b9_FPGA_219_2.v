...
module FAU ( 
  ...
  assign z01 = (~new_n65_ & (~x04 | (new_n69_ & ~x30))) | (x28 & new_n70_ & ~x30);
  assign new_n69_ = ~x32 & (~x27 | (~x35 & ~x36));
  assign new_n70_ = ~x32 & ~x36 & (~x18 | (x18 & x40));
  ...
  assign z13 = (x27 & (new_n97_ | (~x04 & new_n96_ & ~x13))) | (~x04 & new_n85_ & ~x13);
  assign new_n96_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n99_ | (~new_n101_ & ~x37) | new_n103_ | (~new_n104_ & ~x27);
  assign new_n99_ = ~new_n100_ & (x19 | ~x20 | (x18 & x40));
  assign new_n100_ = ~x04 & ~x13 & (~x28 | x30 | x32 | x36);
  assign new_n101_ = ~new_n102_ & ((x28 & x35) | (z08 & ~x04 & ~x13));
  assign new_n102_ = x28 & ~x30 & ~x32 & ~x35;
  assign new_n103_ = (~z08 | new_n102_) & (x18 | x19 | ~x20);
  assign new_n104_ = x39 & x40 & (~x40 | (~x04 & ~x13 & (x30 | x32)));
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = (~new_n109_ & x08) | ~new_n110_ | new_n65_ | x30;
