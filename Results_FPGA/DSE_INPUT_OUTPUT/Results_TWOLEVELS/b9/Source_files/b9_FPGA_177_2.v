...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n92_ | (x04 & (new_n91_ | ~x27)))) | (~x39 & (new_n91_ | ~x27));
  ...
  assign new_n99_ = (new_n91_ | ~x27) & (x13 | ~x39 | (x04 & x40));
  assign new_n100_ = ~new_n101_ & ~x04 & ~x13 & x39;
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = (~x39 | x40) & (x30 | x32 | (~new_n103_ & (x27 | ~x40)));
  ...
  assign new_n108_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x39));
