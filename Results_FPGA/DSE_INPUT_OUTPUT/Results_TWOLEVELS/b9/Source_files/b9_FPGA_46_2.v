...
module FAU ( 
  ...
  assign z02 = ~new_n73_ | (x39 & (~x40 | (~x02 & (~x08 | ~x29))));
  assign new_n73_ = (x27 | (x39 & (~x04 | x08))) & (~x04 | (~x28 & x35)) & (x39 | (x04 & (~x27 | x28)));
  assign z03 = ~new_n71_ & ((~new_n66_ & x27) | ~x21 | (~x27 & ~x37));
  assign z04 = (~new_n71_ & (x27 ? ~new_n66_ : ~x37)) | new_n71_ | x21;
  assign z06 = ~x37 & ~new_n71_ & (~x27 | ~x28);
  assign z07 = x03 & ~new_n78_ & ~new_n71_;
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = x39 & x40;
  assign z09 = new_n71_ | (x11 & x26 & x27 & x34);
