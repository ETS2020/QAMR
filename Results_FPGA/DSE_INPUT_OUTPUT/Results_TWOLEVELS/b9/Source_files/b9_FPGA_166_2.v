...
module FAU ( 
  ...
  assign z01 = (~new_n69_ & (~x04 | (new_n71_ & ~x30))) | (x28 & new_n72_ & ~x30);
  assign new_n71_ = ~x32 & (~x27 | (~x35 & ~x36));
  assign new_n72_ = ~x32 & ~x36 & (~x19 | (x19 & x40));
  assign z02 = x40 ? (~new_n74_ | (~x02 & (~x08 | ~x29))) : ~x19;
  assign new_n74_ = x39 & (~x04 | ((x08 | x27) & ~x28 & x35));
  assign z03 = (~new_n69_ & (x27 ? (~x28 | ~x35) : ~x37)) | new_n69_ | ~x21;
  ...
  assign new_n84_ = (x36 | (~x28 & x35)) & (z08 ? x05 : x07);
  ...
  assign z12 = new_n92_ | (x19 & ~x40) | ((new_n66_ | ~x27) & (x40 ? ~new_n93_ : ~x19));
  assign new_n92_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n93_ = ~x04 & x39;
  assign z13 = (x27 & (new_n95_ | (~x04 & new_n96_ & ~x13))) | (~x04 & new_n86_ & ~x13);
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (~x19 | x40)));
