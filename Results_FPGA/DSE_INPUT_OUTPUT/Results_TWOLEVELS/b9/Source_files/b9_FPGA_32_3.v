...
module FAU ( 
  ...
  assign new_n70_ = x39 & (~x04 | (x08 & ~x28 & x35));
  assign z03 = (~x21 & (~x40 | (~x27 & x37))) | (~x40 & ((x27 & (~x35 | (~x28 & x37))) | (~x28 & ~x37))) | (~x27 & ~x37);
  assign z04 = (~x40 & ((x27 & (~x35 | (~x28 & x37))) | (~x28 & ~x37))) | (~x27 & ~x37) | (x21 & (~x40 | (~x27 & x37)));
  assign z05 = (x37 & (~x27 | (x27 & ~x28 & ~x40))) | (x27 & (x28 | x40));
  assign z06 = ~x37 & (~x27 | (~x28 & ~x40));
  assign z07 = (x27 & x40) | (x03 & (new_n77_ | (new_n76_ & ~x31)));
  ...
  assign z12 = (~x40 & (new_n88_ | ~x27)) | (~x27 & (x04 | ~x10 | ~x39));
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign z13 = (~new_n90_ & x40) | (~x18 & ~x19 & new_n66_ & x20);
  assign new_n90_ = ~x27 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~x40 & (new_n88_ | ~new_n92_)) | (~new_n93_ & ~x27) | (x40 & (x13 | x27));
  assign new_n92_ = ~x18 & ~x19 & x20 & x27;
  assign new_n93_ = ~x04 & x39 & (x30 | x32);
