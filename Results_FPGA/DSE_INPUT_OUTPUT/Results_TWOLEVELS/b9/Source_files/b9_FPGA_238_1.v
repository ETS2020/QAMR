...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n72_ | ~x40 | (~x39 & x40);
  ...
  assign new_n83_ = (~x27 | new_n70_ | (x40 ? ~x05 : ~x07)) & (~x05 | new_n84_ | ~x40);
  ...
  assign z13 = new_n91_ | (x40 & (~x39 | (~x04 & ~new_n84_ & ~x13)));
  assign new_n91_ = x27 & (new_n92_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n92_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign z14 = (~new_n94_ & (x04 | x13 | ~x40)) | new_n95_ | (~x39 & x40);
