...
module FAU ( 
  ...
  assign z11 = new_n67_ | (new_n84_ & ~x09);
  assign new_n84_ = ~x30 & (new_n85_ | new_n87_ | (~new_n86_ & ~x08));
  assign new_n85_ = (~x29 | ~x40) & (x28 | (x04 & x27));
  assign new_n86_ = (x27 | (~x39 & x40)) & ~x04 & ~x28 & (x35 | ~x39);
  assign new_n87_ = ~x35 & (~x40 | (~x29 & x39));
  ...
  assign z14 = new_n97_ | new_n98_ | new_n67_ | new_n101_;
  assign new_n97_ = (new_n89_ | ~x27) & (x13 | ~x40 | (x04 & x39));
  ...
  assign z08 = x40;
  assign z19 = new_n67_ | (new_n84_ & ~x09);
endmodule
