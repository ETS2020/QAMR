...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n78_,
    new_n79_, new_n81_, new_n84_, new_n85_, new_n87_, new_n88_, new_n89_,
  ...
  assign new_n89_ = (x27 | (~x16 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n91_ | (~x16 & ~x40) | (~new_n92_ & (x40 ? (x04 | ~x39) : x16));
  assign new_n91_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n94_ | (~x04 & new_n85_ & ~x13);
  assign new_n94_ = x27 & ((new_n96_ & x16) | (x40 & (new_n95_ | new_n96_)));
  assign new_n95_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : ~x16;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x40 | (~new_n102_ & (new_n92_ | new_n100_))) & (~x16 | new_n92_ | x40);
  ...
  assign z18 = (~new_n107_ & ~new_n70_) | (new_n81_ & x08 & x29);
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (x16 | x40)));
