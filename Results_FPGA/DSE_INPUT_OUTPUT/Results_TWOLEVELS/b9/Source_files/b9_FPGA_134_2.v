...
module FAU ( 
  ...
  assign new_n83_ = ~new_n69_ & ((x07 & (x40 ? ~x39 : ~x31)) | (x05 & x39 & x40));
  assign new_n84_ = x06 & ~new_n65_ & x37;
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = new_n65_ | (~x09 & ~x30 & (~new_n87_ | new_n88_));
  assign new_n87_ = (x08 | x27) & (new_n72_ | (x39 & x40 & (~x40 | (x08 & x29))));
  assign new_n88_ = x04 & ((~x08 & x40) | (x27 & (~x29 | ~x39 | ~x40)));
  ...
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : x31;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (x31 | new_n66_ | x40) & (~x40 | (~new_n100_ & (new_n66_ | new_n98_)));
  ...
  assign new_n105_ = (~new_n72_ | x27) & (~x29 | ~x39 | ~x40);
  assign new_n106_ = ~x09 & (~new_n72_ | x04 | ~x27);
  assign z20 = new_n65_ | (new_n108_ & ~x09);
  assign new_n108_ = ~x30 & (~new_n109_ | (~x08 & (~x27 | (~x35 & x40))));
  assign new_n109_ = (x29 | ((x27 | ~x28) & (x35 | ~x40))) & ((x39 & x40) | (x35 & (x27 | ~x28)));
  assign z19 = new_n65_ | (~x09 & ~x30 & (~new_n87_ | new_n88_));
endmodule
