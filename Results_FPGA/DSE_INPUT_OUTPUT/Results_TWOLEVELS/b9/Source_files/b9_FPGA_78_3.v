...
module FAU ( 
  ...
  assign z07 = x03 & ((~x33 & (new_n80_ | (~new_n81_ & ~x14))) | (~x14 & ~new_n81_ & ~x40));
  assign new_n80_ = ~x31 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  ...
  assign new_n85_ = ~new_n70_ & ((x07 & (~x40 | (~x33 & ~x39))) | (x05 & ~x33 & x39 & x40));
  ...
  assign new_n97_ = ~x33 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n113_ = (x08 | ((x33 | x35) & (x27 | (x33 & x40)))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
