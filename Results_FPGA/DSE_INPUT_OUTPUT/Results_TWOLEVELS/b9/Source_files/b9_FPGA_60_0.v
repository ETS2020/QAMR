...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & (x04 | ~x39)))) | (x33 & ~new_n93_ & ~x40);
  ...
  assign z14 = new_n98_ | new_n99_ | new_n69_ | new_n102_;
  assign new_n98_ = ~new_n93_ & ((x40 & (x04 | ~x39)) | x13 | (x33 & ~x40));
  ...
  assign z18 = (~new_n107_ & x08) | ~new_n108_ | new_n69_ | x30;
  assign new_n107_ = (~new_n68_ | ~x29) & (x27 | x28 | ~x35);
  ...
  assign new_n112_ = (~x33 | ((x08 | x27) & (x35 | x40))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
endmodule
