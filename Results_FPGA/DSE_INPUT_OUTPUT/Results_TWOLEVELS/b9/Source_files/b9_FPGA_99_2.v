...
module FAU ( 
  ...
  assign new_n79_ = x40 & (x14 | (~x00 & ~x25 & x38));
  ...
  assign new_n88_ = x40 ? (x29 & x39) : x03;
  assign new_n89_ = (x27 | (x03 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~x03 & ~new_n92_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n94_ & x27) | new_n68_ | (~x04 & new_n85_ & ~x13);
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : x03;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (x03 | new_n92_ | x40) & (~x40 | (~new_n101_ & (new_n92_ | new_n99_)));
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (~x03 | x40)));
