...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | ~new_n72_ | ~x40;
  assign new_n72_ = (~x04 | (new_n73_ & (x08 | x27))) & ~new_n67_ & x39;
  ...
  assign new_n88_ = (x27 | (x18 & x40)) & (x18 | (new_n73_ & ~x04));
  assign new_n89_ = ~new_n90_ & (~new_n73_ | (x04 & x27));
  assign new_n90_ = x40 & (x18 | (x29 & x39));
  assign z12 = (~x18 & (new_n92_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n94_ | (new_n96_ & ~x04))) | (~new_n97_ & x40);
  ...
  assign z14 = new_n99_ | (~new_n102_ & ~x18) | (~x40 & (new_n95_ | x18 | ~x27));
  assign new_n99_ = (x19 | ~x20) & (~x40 | (~x18 & (new_n100_ | ~new_n101_)));
  ...
  assign z18 = ~new_n108_ | (x08 & ((new_n73_ & ~x27) | (new_n85_ & x29)));
  assign new_n108_ = ~new_n67_ & ~x09 & ~x30 & (~new_n73_ | x04 | ~x27);
