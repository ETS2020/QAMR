...
module FAU ( 
  ...
  assign new_n97_ = ~new_n98_ & x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = (~new_n100_ | x30) & new_n102_ & (~new_n101_ | x37);
  assign new_n100_ = ~x32 & ((~x27 & x39) | (x28 & ~x35 & ~x37));
  assign new_n101_ = (~x28 | ~x35) & ((x39 & (x04 | ~x40)) | x13 | (~x39 & x40));
  assign new_n102_ = (x39 | (x40 & (x27 | ~x40))) & (x27 | ~x39 | (~x04 & ~x13 & x40));
