...
module FAU ( 
  ...
  assign z05 = (x37 | (x27 & x28)) & (x20 | (~x20 & ~x40));
  ...
  assign new_n96_ = x20 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n100_ | ~new_n102_ | (~new_n98_ & (x18 | x19));
  assign new_n98_ = new_n99_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n99_ = x39 & x40 & ~x04 & ~x13;
  assign new_n100_ = x28 & (new_n101_ | (~x20 & x27 & ~x40));
  assign new_n101_ = ~x35 & ~x37 & ~x30 & ~x32;
  assign new_n102_ = ~new_n103_ & (x27 | x30 | x32) & (new_n99_ | (~new_n66_ & x27));
  assign new_n103_ = ~x20 & (x40 | (x37 & ~x40));
  ...
  assign new_n111_ = (~x29 | ~x39) & ((x20 & ~x35) | (~x27 & x28));
  assign new_n112_ = (x08 | ((x27 | x40) & (~x20 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
