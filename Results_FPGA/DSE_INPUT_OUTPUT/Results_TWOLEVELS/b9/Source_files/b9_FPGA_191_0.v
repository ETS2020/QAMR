...
module FAU ( 
  ...
  assign z02 = x40 ? ((~x02 & (~x08 | ~x29)) | new_n71_ | ~x39) : x39;
  ...
  assign new_n85_ = (x27 | (~x39 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n86_ = x40 ? (x29 & x39) : ~x39;
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n89_ | (~x39 & ~x40) | (~new_n66_ & (x04 | ~x39 | ~x40));
  ...
  assign z14 = (~new_n95_ & (new_n96_ | ~new_n97_)) | new_n98_ | new_n65_ | (~new_n66_ & ~new_n97_);
