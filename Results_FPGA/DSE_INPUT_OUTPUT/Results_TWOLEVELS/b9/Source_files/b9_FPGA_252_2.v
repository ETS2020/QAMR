...
module FAU ( 
  ...
  assign z03 = (~x21 & (x37 | (x27 & x28))) | (x27 & (~x28 | ~x35)) | ~x40 | (~x27 & ~x37 & x40);
  ...
  assign new_n83_ = (~new_n84_ | ~x05) & (~x27 | new_n70_ | (z08 ? ~x05 : ~x07));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & (x40 ? (~x29 | ~x39) : ~x21);
  ...
  assign new_n91_ = ((x28 & x35) | (~x04 & x39)) & (x40 | (x35 & (x21 | x28)));
  assign new_n92_ = (x40 | (~x21 & x27)) & (x27 | (x39 & (~x04 | ~x40)));
  ...
  assign z14 = new_n97_ | new_n103_ | ~new_n101_ | (~new_n100_ & (x04 | x13));
  assign new_n97_ = (new_n98_ | ~new_n99_) & (x18 | x19 | ~x20);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n100_ = ~new_n66_ & (x27 | ~x40);
  assign new_n101_ = (new_n102_ | (x39 & x40)) & (~x21 | x40) & (x28 | x37 | (x39 & (x21 | x40)));
