// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:48 2020
...
module FAU ( 
  ...
  assign z06 = ~x37 & ((x07 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign z10 = ~new_n84_ | (~x04 & (new_n85_ | (new_n83_ & x27)));
  assign new_n83_ = (new_n70_ | x36) & ((x05 & x39) | ~x40 | (x07 & ~x39));
  assign new_n84_ = ~new_n65_ & (~x06 | ~x27 | ~x37);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n87_ & ~x08) | (~new_n88_ & ~new_n89_));
  assign new_n87_ = (x27 | (~x07 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : ~x07;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n91_ | (~x07 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x07));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n95_ | (x27 & ((x40 & (new_n93_ | new_n94_)) | (new_n94_ & x07)));
  assign new_n93_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n95_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n100_ | (~new_n97_ & (x18 | x19 | ~x20));
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x07;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n66_ | new_n99_))) & (~x07 | new_n66_ | x40);
  ...
  assign z18 = ~new_n106_ | (x08 & ((new_n70_ & ~x27) | (z08 & x29)));
  assign new_n106_ = ~new_n65_ & ~x30 & ~x09 & (~new_n70_ | x04 | ~x27);
  assign z19 = z11 | new_n65_;
  assign z20 = new_n109_ & ~x09;
  assign new_n109_ = ~x30 & (new_n110_ | (~new_n88_ & (~x35 | (~x27 & x28))));
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (x07 | x40)));
endmodule
