...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x38;
  ...
  assign new_n79_ = (x15 | ~x17) & (~x38 | (x00 & ~x25 & x40));
  assign new_n80_ = ~x14 & (~x38 | (x40 & (x00 | x25)));
  ...
  assign z12 = (x40 & (new_n90_ | (~new_n91_ & (x04 | ~x39)))) | (~x38 & ~new_n91_ & ~x40);
  ...
  assign new_n99_ = (x38 | new_n91_ | x40) & (~x40 | (~new_n100_ & (new_n91_ | new_n98_)));
