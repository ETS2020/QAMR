...
module FAU ( 
  ...
  assign z18 = (~new_n109_ & (~x21 | ~x40)) | (x08 & ~x21 & x29 & x39 & x40);
  ...
  assign new_n113_ = ~x08 & ((~x21 & (~x27 | ~x35)) | (~x27 & ~x40));
  assign z05 = ~z06;
endmodule
