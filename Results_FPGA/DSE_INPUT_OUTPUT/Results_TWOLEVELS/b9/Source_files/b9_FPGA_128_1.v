// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:33 2020
...
module FAU ( 
  ...
  assign new_n68_ = ~x14 & x40;
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | new_n68_ | ~x04;
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = (~new_n72_ & x14) | new_n73_ | ~x39 | ~x40 | (~x14 & x40);
  assign new_n72_ = (x02 | (x08 & x29)) & (~x04 | ~x28);
  ...
  assign new_n79_ = ~x40 & (x00 | x25 | ~x38);
  ...
  assign new_n84_ = (~x07 | (x40 & (~x14 | x39))) & (~x39 | ~x40 | ~x05 | ~x14);
  assign new_n85_ = x05 & x14 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & ((x04 & x27) | x28 | ~x35);
  assign new_n88_ = x40 & (~x14 | (x29 & x39));
  assign new_n89_ = (x27 | (~x14 & x40)) & (~x14 | (~x04 & ~x28 & x35));
  assign z12 = new_n91_ | (~x14 & x40) | (~new_n92_ & (~x40 | (x14 & (x04 | ~x39))));
  assign new_n91_ = ~x10 & ((x14 & ~x27) | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n95_ | (new_n94_ & ~x04))) | (~new_n96_ & x40);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = x14 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n101_ | ((new_n98_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n98_ = x14 & (new_n99_ | ~new_n100_);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x14 | (~new_n102_ & (new_n92_ | new_n100_))) & (new_n92_ | x40);
  ...
  assign z18 = (~new_n107_ & x08) | ~new_n108_ | new_n68_ | x09;
  assign new_n107_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n108_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n110_ & ~x09;
  assign new_n110_ = ~x30 & (new_n111_ | (~new_n88_ & (~x35 | (~x27 & x28))));
  assign new_n111_ = ~x08 & ((x14 & (~x27 | ~x35)) | (~x27 & ~x40));
  assign z05 = ~z06;
