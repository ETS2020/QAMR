...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
    ...
    new_n90_, new_n92_, new_n93_, new_n96_, new_n101_, new_n102_,
    new_n104_, new_n105_;
  ...
  assign z02 = (~x02 & ~new_n73_ & x13) | new_n74_ | ~x39 | ~x40 | (~x13 & x40);
  ...
  assign new_n88_ = (x27 | (~x13 & x40)) & (~x13 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (~x13 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x13 & (new_n92_ | (~new_n93_ & (new_n66_ | ~x27)))) | (~x40 & (new_n66_ | ~x27));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = ~x04 & x39;
  assign z13 = ~x18 & ~x19 & x20 & x27 & ~new_n66_ & ~new_n69_;
  assign z14 = ~new_n96_ | (~new_n69_ & (~x27 | (~x28 & ~x37)));
  assign new_n96_ = ~x18 & ~x19 & x20 & ~new_n69_ & (x35 | x37);
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = (~new_n101_ & x08) | ~new_n102_ | new_n69_ | x09;
  assign new_n101_ = (~new_n68_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n102_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n104_ & ~x09;
  assign new_n104_ = ~x30 & (new_n105_ | (~new_n89_ & (~x35 | (~x27 & x28))));
