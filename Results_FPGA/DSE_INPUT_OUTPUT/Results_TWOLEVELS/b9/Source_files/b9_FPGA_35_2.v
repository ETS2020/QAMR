...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n77_,
    new_n78_, new_n82_, new_n83_, new_n86_, new_n87_, new_n88_, new_n90_,
  ...
  assign new_n72_ = ~x39 & (x09 | ~x27 | (x27 & ~x28) | x30 | (~x09 & x28 & ~x30));
  ...
  assign z12 = new_n90_ | new_n91_ | (x39 & ~x40) | (~x27 & (~x39 | (x04 & x40)));
  assign new_n90_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign new_n91_ = ~x37 & (x04 | ~x39) & (~x28 | ~x35);
  assign z13 = new_n95_ | (x27 & (new_n93_ | new_n94_));
  assign new_n93_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n95_ = x39 & (~x40 | (~x04 & ~x13 & (x30 | x32)));
  assign z14 = new_n97_ | ~new_n99_ | (~x27 & (~x39 | (~x30 & ~x32)));
  assign new_n97_ = (x04 | x13) & (~new_n98_ | (~x37 & (~x28 | ~x35)));
  assign new_n98_ = ~x18 & ~x19 & x20 & (x27 | ~x40);
  assign new_n99_ = (new_n100_ | (~x18 & ~x19 & x20)) & ~new_n67_ & ~new_n101_;
  assign new_n100_ = x39 & (~x28 | x30 | x32 | (x35 & x36));
