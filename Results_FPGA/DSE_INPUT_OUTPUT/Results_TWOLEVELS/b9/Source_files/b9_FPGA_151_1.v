...
module FAU ( 
  ...
  assign new_n72_ = ~new_n75_ & (x40 | (new_n74_ & (~x27 | (~new_n73_ & x35))));
  ...
  assign new_n85_ = (~new_n86_ | ~x27) & (~x05 | ~x40 | (~x30 & ~x32));
  assign new_n86_ = (x36 | (~x28 & x35)) & (x40 ? x05 : x07);
  assign z11 = new_n69_ | (~x09 & ~x30 & (new_n88_ | new_n89_));
  assign new_n88_ = (~x29 | ~x40) & ((x04 & x27) | x28 | ~x35);
  assign new_n89_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = (~x10 & (new_n91_ | (~x27 & x40))) | ~new_n92_ | (~x27 & (~x40 | (x04 & x40)));
  assign new_n91_ = ~x35 & ~x36 & ~x37;
  assign new_n92_ = (x39 | ~x40) & (x37 | (x28 & x35) | (~x04 & x40));
  assign z13 = new_n96_ | (x27 & (new_n94_ | (x39 & (new_n73_ | new_n95_))));
  assign new_n94_ = ~x18 & ~x19 & x20 & ~new_n66_ & ~x40;
  assign new_n95_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n99_ | (~new_n98_ & (x04 | x13 | ~x40));
  assign new_n98_ = ~new_n66_ & ~x18 & ~x19 & x20;
  assign new_n99_ = new_n101_ & (x30 | x32 | (x27 & (new_n100_ | ~x28)));
  assign new_n100_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign new_n101_ = (x39 | ~x40) & (x27 | (x40 & (~x40 | (~x04 & ~x13))));
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = new_n69_ | (x01 & x22 & ~x23);
  assign z17 = new_n69_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n106_ | ~new_n107_ | new_n69_ | x30;
  assign new_n106_ = x08 & ((x29 & x40) | (~x27 & ~x28 & x35));
  assign new_n107_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n69_ | (~x09 & ~new_n109_ & ~x30);
  assign new_n109_ = (x08 | (x27 & x35)) & ((x29 & x40) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
  assign z19 = z11;
endmodule
