...
module FAU ( 
  ...
  assign z01 = (~x04 & (x40 | (x19 & ~x40))) | (~x30 & ~x32 & ~new_n71_ & (x19 | x40));
  assign new_n71_ = x27 & (x36 | (~x28 & x35));
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : x19;
  assign new_n73_ = x39 & (~x04 | ((x08 | x27) & ~x28 & x35));
  assign z03 = (~new_n75_ & (x19 | x40)) | (x27 & ~x28 & (x40 | (x19 & ~x40))) | ~x21 | (~x19 & ~x40);
  assign new_n75_ = x27 ? x35 : x37;
  assign z04 = (x27 & ~x28 & (x40 | (x19 & ~x40))) | ((x19 | x40) & (~new_n75_ | x21));
  ...
  assign new_n102_ = (~x28 | (~new_n103_ & (x35 | x37 | ~x40))) & (x27 | ~x40);
  ...
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (x19 | x40)));
