...
module FAU ( 
  ...
  assign new_n65_ = x27 & ((new_n66_ & ~x04) | x37 | (x28 & x35));
  ...
  assign new_n87_ = (x27 | (x20 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : x20;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~x20 & ~new_n92_ & ~x40);
  ...
  assign z14 = (x40 & (~new_n98_ | new_n102_)) | new_n103_ | new_n100_ | ~x40;
  assign new_n98_ = ~new_n99_ & (x27 | (x39 & (x30 | x32)));
  assign new_n99_ = ~x37 & (~x28 | ~x35) & (x04 | ~x39);
  assign new_n100_ = ~new_n101_ & (x18 | x19 | ~x20);
  assign new_n101_ = x39 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n102_ = (x04 | x13) & (~x20 | ~x27 | x18 | x19);
  assign new_n103_ = ~x37 & ((x13 & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = (~new_n108_ & ~new_n69_) | (z08 & x08 & x29);
  ...
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x20 | x40)));
endmodule
