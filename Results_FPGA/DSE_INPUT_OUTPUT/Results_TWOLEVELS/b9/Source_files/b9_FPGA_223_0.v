...
module FAU ( 
  ...
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : ~x06;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x06 | new_n92_ | x40) & (~x40 | (~new_n102_ & (new_n92_ | new_n100_)));
