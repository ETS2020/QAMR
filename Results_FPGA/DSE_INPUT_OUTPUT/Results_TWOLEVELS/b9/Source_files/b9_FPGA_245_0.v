...
module FAU ( 
  ...
  assign z12 = new_n89_ | (~x39 & ~x40) | (~new_n90_ & (x40 ? (x04 | ~x39) : x39));
  ...
  assign new_n97_ = x40 ? (~new_n98_ & ~x04 & ~x13 & x39) : ~x39;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = (~x40 | (~new_n100_ & (new_n90_ | (~x04 & ~x13 & x39)))) & (~x39 | new_n90_ | x40);
