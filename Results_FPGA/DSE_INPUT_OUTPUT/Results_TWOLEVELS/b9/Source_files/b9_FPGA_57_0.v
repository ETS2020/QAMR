...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n77_,
    new_n78_, new_n80_, new_n83_, new_n84_, new_n85_, new_n87_, new_n88_,
  ...
  assign new_n72_ = x04 & ((~x08 & ~x27) | (~new_n70_ & x40));
  ...
  assign new_n83_ = (new_n70_ | x36) & (new_n80_ ? x05 : x07);
  assign new_n84_ = ~new_n65_ & (~x06 | ~x27 | ~x37);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | (new_n70_ & (~x04 | ~x27))) & (x08 | ~x40 | (new_n70_ & ~x04 & x27));
  assign new_n88_ = (~x08 | (x29 & x40)) & (x39 | ~x40);
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (x08 & ~new_n66_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n94_ | (new_n93_ & ~x04))) | new_n65_ | (new_n92_ & ~x04);
  assign new_n92_ = new_n85_ & ~x13;
  ...
  assign new_n97_ = (~x40 | (~x04 & x39)) & ~x13 & (~x08 | x40);
  assign new_n98_ = ~new_n99_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = (x40 | (x08 & (~x08 | x27))) & (x27 | new_n101_ | ~x40);
  ...
  assign z18 = new_n106_ | ~new_n107_;
  assign new_n106_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & (x08 | (x27 & x40))));
  assign new_n107_ = ((~x08 & ~x40) | (~x09 & ~x30)) & (~x39 | ~x40 | ~x08 | ~x29);
  assign z20 = ~x09 & ~x30 & (new_n109_ | new_n110_);
  assign new_n109_ = x40 & ((~x08 & (~x27 | ~x35)) | (~x39 & (~x35 | (~x27 & x28))));
  assign new_n110_ = x08 & (~x29 | ~x40) & (~x35 | (~x27 & x28));
  assign z06 = ~z05;
