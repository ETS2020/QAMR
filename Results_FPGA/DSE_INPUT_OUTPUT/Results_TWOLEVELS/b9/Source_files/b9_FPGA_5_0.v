...
module FAU ( 
  ...
  assign new_n99_ = ~new_n100_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = new_n103_ & (new_n102_ | x37);
  assign new_n102_ = (~x04 | ((x28 | ~x39) & (x35 | ~x40))) & ((x28 & x35) | (~x13 & (x39 | ~x40) & (~x39 | x40)));
  assign new_n103_ = (x39 | (x40 & (x27 | ~x40))) & (x27 | (x40 ? (~x04 & ~x13) : ~x39));
  ...
  assign z20 = new_n69_ | (~x09 & ~new_n112_ & ~x30);
  assign new_n112_ = (x08 | (x27 & x35)) & ((z08 & x29) | (x35 & (x27 | ~x28)));
