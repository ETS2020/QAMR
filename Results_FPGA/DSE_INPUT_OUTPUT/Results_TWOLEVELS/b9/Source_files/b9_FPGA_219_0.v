...
module FAU ( 
  ...
  assign z01 = (~x04 & (x40 | (x18 & ~x40))) | (~x30 & ~x32 & ~new_n70_ & (x18 | x40));
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : x18;
  assign new_n72_ = x39 & (~x04 | (~x28 & x35 & (x08 | x27)));
  assign z03 = (~x21 & (x40 | (x18 & ~x40))) | ((x18 | x40) & (x27 ? ~new_n66_ : ~x37));
  assign z04 = ((x18 | x40) & (x27 ? ~new_n66_ : ~x37)) | (x21 & (x40 | (x18 & ~x40)));
  ...
  assign new_n88_ = (x27 | (~x18 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 ? (x29 & x39) : ~x18;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n92_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n92_ = ~new_n93_ & (x40 | (x18 & x27)) & (x27 | (x39 & (~x04 | ~x40)));
  assign new_n93_ = ~x37 & (~x28 | ~x35) & (x04 | ~x39 | ~x40);
  assign z13 = x40 & (new_n97_ | (x27 & (new_n95_ | new_n96_)));
  assign new_n95_ = ~x18 & ~x19 & x20 & (new_n66_ | x37);
  assign new_n96_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x04 & ~x13 & x39 & (x30 | x32);
  assign z14 = (~x40 & (~x18 | (~x04 & x18))) | new_n99_ | new_n101_ | new_n103_;
  assign new_n99_ = ~new_n100_ & (x04 | x13 | ~x39);
  assign new_n100_ = ~x18 & (x37 | (x28 & x35));
  assign new_n101_ = ~x30 & ~x32 & ((~new_n102_ & x28) | (~x27 & x40));
  assign new_n102_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign new_n103_ = ~new_n104_ & (x19 | ~x20 | ~x27);
  ...
  assign z18 = (~new_n109_ & x08) | ~new_n110_ | new_n67_ | x30;
  assign new_n109_ = (x27 | x28 | ~x35) & (~z08 | ~x29);
  assign new_n110_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n112_ & ~x09;
  assign new_n112_ = ~x30 & (new_n113_ | (~new_n89_ & (~x35 | (~x27 & x28))));
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (x18 | x40)));
endmodule
