...
module FAU ( 
  ...
  assign new_n88_ = ~new_n89_ & (~x39 | (~x29 & x39 & x40));
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n90_ = (x27 | (x39 & (~x39 | ~x40))) & (~x39 | ~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n93_ | (x04 & (new_n92_ | ~x27)))) | (~x39 & (new_n92_ | ~x27));
  ...
  assign new_n100_ = (new_n92_ | ~x27) & (x13 | ~x39 | (x04 & x40));
  assign new_n101_ = ~new_n102_ & ~x04 & ~x13 & x39;
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = (~x39 | x40) & (x30 | x32 | (~new_n104_ & (x27 | ~x40)));
  ...
  assign z18 = (x08 & x29 & x39 & x40) | (~new_n109_ & (~x39 | (x39 & x40)));
  assign new_n109_ = ~new_n110_ & ~x09 & ~x30;
  assign new_n110_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = ~x09 & ~new_n112_ & ~x30;
  assign new_n112_ = ~new_n113_ & (x35 | (x39 & (~x39 | ~x40 | (x08 & x29))));
  assign new_n113_ = ~x27 & ((~x08 & (~x39 | (x39 & x40))) | (x28 & (~x39 | (~x29 & x40))));
  assign z05 = ~z06;
