...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : x33;
  ...
  assign new_n78_ = (~x40 | ((new_n80_ | x14) & (x31 | ~new_n79_ | x33))) & (x14 | new_n80_ | ~x33);
  assign new_n79_ = (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign new_n80_ = ~x00 & ~x25 & x38;
  assign z08 = x40 ? x39 : ~x33;
  ...
  assign new_n90_ = x40 ? (x29 & x39) : ~x33;
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n93_ | (~new_n94_ & (new_n66_ | ~x27)))) | (x33 & ~x40 & (new_n66_ | ~x27));
  ...
  assign new_n98_ = ~x19 & x20 & ~new_n66_ & x33;
  assign new_n99_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n104_ | (~new_n101_ & (x18 | x19 | ~x20));
  assign new_n101_ = x40 ? (~new_n102_ & new_n103_) : ~x33;
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = ~x04 & ~x13 & x39;
  assign new_n104_ = (~x33 | x40 | (~new_n66_ & x27)) & (~x40 | (~new_n105_ & (new_n103_ | (~new_n66_ & x27))));
