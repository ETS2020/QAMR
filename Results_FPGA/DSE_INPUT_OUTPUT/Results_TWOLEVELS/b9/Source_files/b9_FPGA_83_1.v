...
module FAU ( 
  ...
  assign new_n74_ = (x40 | ((~x27 | ~x28) & ~x37 & (x28 | x37))) & x39 & (x21 | ~x40);
  assign z03 = (x27 & (~x28 | ~x35)) | ~x21 | (x21 & ~x27 & ~x37);
  assign z04 = (~x27 & ~x37 & (x21 | ~x40)) | (x21 & (x37 | (x27 & x28))) | (~x21 & x40) | (x27 & (~x28 | ~x35));
  ...
  assign new_n86_ = (~x07 | (x40 & (~x21 | x39))) & (~x05 | ~x21 | ~x39 | ~x40);
  ...
  assign z12 = new_n94_ | (~x21 & x40) | (~new_n68_ & (x04 | ~x39 | ~x40));
  ...
  assign z14 = (~new_n100_ & (new_n101_ | ~new_n102_)) | new_n103_ | new_n67_ | (~new_n68_ & ~new_n102_);
  ...
  assign new_n111_ = (~x29 | ~x39) & ((x21 & ~x35) | (~x27 & x28));
