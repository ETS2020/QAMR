...
module FAU ( 
  ...
  assign z00 = new_n65_ | ~x16 | (x16 & ~x40);
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : ~x16;
  ...
  assign z07 = new_n68_ | (~new_n77_ & x03);
  ...
  assign new_n86_ = (x27 | (x16 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n87_ = x40 ? (x29 & x39) : x16;
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n90_ | new_n68_ | (~new_n91_ & (~z08 | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n93_ & x27) | new_n68_ | (~x04 & new_n83_ & ~x13);
  assign new_n93_ = (~new_n95_ | x04) & (x18 | x19 | new_n94_ | ~x20);
  ...
  assign new_n99_ = ~new_n100_ & ~new_n68_ & (new_n91_ | (z08 & ~x04 & ~x13));
  ...
  assign z18 = (~new_n105_ & x08) | ~new_n106_ | new_n68_ | x30;
  ...
  assign new_n110_ = (x35 | x40) & (x08 | x27);
endmodule
