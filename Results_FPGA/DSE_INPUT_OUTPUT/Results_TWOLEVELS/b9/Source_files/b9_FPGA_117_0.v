...
module FAU ( 
  ...
  assign z12 = new_n91_ | (~x39 & ~x40) | (~new_n66_ & (x04 | ~x39 | ~x40));
  assign new_n91_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = ~new_n93_ | (x27 & (new_n95_ | (new_n94_ & ~x04)));
  assign new_n93_ = ~new_n65_ & (x04 | ~new_n84_ | x13);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = (~new_n101_ & ~x27) | new_n97_ | new_n100_ | new_n65_;
