...
module FAU ( 
  ...
  assign new_n82_ = ~x04 & ~new_n70_ & ((x07 & (~x39 ^ ~x40)) | (x05 & x39 & x40));
  ...
  assign new_n98_ = (x39 | x40) & ((~new_n66_ & x27) | (~x04 & ~x13 & x39 & x40));
  ...
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n107_ | ~new_n108_));
  assign new_n107_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n108_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((x08 | (~x39 & ~x40)) & (~x28 | x39)));
  assign z06 = ~z05;
