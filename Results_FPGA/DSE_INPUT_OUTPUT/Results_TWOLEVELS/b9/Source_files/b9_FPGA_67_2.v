...
module FAU ( 
  ...
  assign z08 = x40 ? x39 : x07;
  assign z09 = new_n65_ | (x11 & x26 & x27 & x34);
  assign z10 = ~new_n84_ | (~x04 & (new_n85_ | (new_n83_ & x27)));
  assign new_n83_ = (new_n70_ | x36) & ((x07 & ~x39) | (x05 & x39 & x40));
  assign new_n84_ = ~new_n65_ & (~x06 | ~x27 | ~x37);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = (x07 & ~x40) | (~x09 & ~x30 & (~new_n87_ | (~new_n90_ & ~x07)));
  assign new_n87_ = (new_n88_ | (~x28 & (~x04 | ~x27))) & ~new_n89_ & (x08 | (~x04 & ~x28));
  assign new_n88_ = x29 & x39 & x40;
  assign new_n89_ = x40 & ((~x08 & (~x27 | ~x35)) | (~x35 & (~x29 | ~x39)));
  assign new_n90_ = (x35 | x40) & (x08 | x27);
  assign z12 = new_n92_ | (x07 & ~x40) | (~new_n66_ & (x04 | ~x39 | ~x40));
  assign new_n92_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = new_n96_ | (x27 & ((x40 & (new_n94_ | new_n95_)) | (new_n95_ & ~x07)));
  assign new_n94_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n102_ & ~x27) | new_n98_ | new_n101_ | new_n65_;
  ...
  assign new_n102_ = ~x04 & x39 & x40 & (~x40 | (~x13 & (x30 | x32)));
  assign z15 = new_n65_ | (x12 & x26 & x27 & x34);
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = new_n65_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n107_ | (x08 & (new_n88_ | (new_n70_ & ~x27)));
  assign new_n107_ = ~x09 & (~new_n70_ | x04 | ~x27) & ~new_n65_ & ~x30;
  assign z20 = new_n109_ & ~x09;
  assign new_n109_ = ~x30 & (new_n111_ | (~new_n110_ & (~x35 | (~x27 & x28))));
  assign new_n110_ = x40 ? (x29 & x39) : x07;
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (~x07 | x40)));
  assign z19 = (x07 & ~x40) | (~x09 & ~x30 & (~new_n87_ | (~new_n90_ & ~x07)));
endmodule
