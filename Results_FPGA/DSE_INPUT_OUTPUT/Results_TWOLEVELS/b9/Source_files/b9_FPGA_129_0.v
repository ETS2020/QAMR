...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x40) | ~x40 | ~x39 | (x04 & ~x08 & ~x27);
  ...
  assign new_n87_ = (x27 | (~x18 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  ...
  assign z13 = x40 & (new_n95_ | (x27 & (new_n93_ | new_n94_)));
  assign new_n93_ = ~x18 & ~x19 & x20 & (new_n66_ | x37);
  assign new_n94_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x04 & ~x13 & x39 & (x30 | x32);
  assign z14 = ~new_n98_ | (x40 & (~new_n97_ | new_n102_));
  assign new_n97_ = (x37 | new_n66_ | (~x04 & x39)) & (x27 | x39);
  assign new_n98_ = ~new_n99_ & new_n101_ & (new_n100_ | (~x18 & ~x19 & x20));
  assign new_n99_ = ~x37 & ((x13 & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n100_ = x39 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n101_ = x40 & (x27 | x30 | x32);
  assign new_n102_ = (x04 | x13) & (x18 | x19 | ~x20 | ~x27);
