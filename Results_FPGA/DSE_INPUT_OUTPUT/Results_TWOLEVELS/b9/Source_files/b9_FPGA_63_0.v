// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:52 2020
...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x08;
  ...
  assign z06 = ~x37 & ((x08 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign z11 = new_n65_ | (~x09 & ~x30 & (~new_n85_ | new_n87_));
  assign new_n85_ = (new_n86_ | (~x28 & x35)) & (x08 | (x27 & x35 & (~x28 | ~x40)));
  assign new_n86_ = x39 & x40 & (x29 | ~x40);
  assign new_n87_ = x04 & ((x27 & (~x29 | ~x39 | ~x40)) | (~x08 & x40));
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (x08 & ~new_n66_ & ~x40);
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n93_ | (new_n92_ & ~x04))) | new_n65_ | (new_n91_ & ~x04);
  assign new_n91_ = new_n83_ & ~x13;
  ...
  assign new_n96_ = (~x40 | (~x04 & x39)) & ~x13 & (~x08 | x40);
  assign new_n97_ = ~new_n98_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = (x40 | (x08 & (~x08 | x27))) & (x27 | new_n100_ | ~x40);
  assign new_n100_ = ~x04 & ~x13 & x39 & (x30 | x32);
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = (~new_n105_ & x08) | ~new_n106_ | x30 | (~x08 & ~x40);
  assign new_n105_ = (~z08 | ~x29) & (x27 | x28 | ~x35);
  assign new_n106_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = (~x08 & ~x40) | (~x09 & ~x30 & (~new_n109_ | (~new_n108_ & ~x08)));
  assign new_n108_ = x27 & x35;
  assign new_n109_ = (x29 | ((x27 | ~x28) & (x35 | ~x40))) & ((x39 & x40) | (x35 & (x27 | ~x28)));
  assign z19 = new_n65_ | (~x09 & ~x30 & (~new_n85_ | new_n87_));
endmodule
