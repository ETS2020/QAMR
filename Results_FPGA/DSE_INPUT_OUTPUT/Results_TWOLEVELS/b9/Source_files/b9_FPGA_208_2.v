...
module FAU ( 
  ...
  assign z12 = new_n93_ | (x36 & ~x40) | (~new_n65_ & (x40 ? (x04 | ~x39) : ~x36));
  ...
  assign z14 = new_n100_ | (~x30 & ~x32 & (new_n102_ | (~x27 & x40)));
  assign new_n100_ = ~new_n101_ & (new_n66_ | x18 | x19 | ~x20 | ~x27);
  assign new_n101_ = x40 ? (~x04 & ~x13 & x39) : x36;
  assign new_n102_ = x28 & ((~new_n103_ & (~x36 | (~x35 & x40))) | (~x35 & ~x37 & x40));
  ...
  assign new_n112_ = (x35 | (x40 ? x08 : x36)) & (x27 | ((x08 | (x36 & ~x40)) & (~x28 | x40)));
endmodule
