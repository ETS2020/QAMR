...
module FAU ( 
  ...
  assign new_n87_ = (x27 | (x38 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : x38;
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n91_ | (x38 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : ~x38));
  ...
  assign new_n96_ = x20 & ~x38 & (x37 | (x28 & x35));
  ...
  assign new_n102_ = (~x40 | (~new_n103_ & (new_n66_ | new_n101_))) & (x38 | new_n66_ | x40);
  ...
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x38 | x40)));
endmodule
