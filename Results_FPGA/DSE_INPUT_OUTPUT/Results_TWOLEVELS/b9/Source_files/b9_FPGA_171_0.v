...
module FAU ( 
  ...
  assign z12 = new_n90_ | (~x39 & ~x40) | ((new_n66_ | ~x27) & (x40 ? (x04 | ~x39) : x39));
  ...
  assign new_n97_ = ~new_n98_ & (x40 ? (new_n99_ | x04 | x13 | ~x39) : x39);
  assign new_n98_ = ~x18 & ~x19 & x20;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = (new_n66_ | ~x27) & (x40 ? (x04 | x13 | ~x39) : x39);
  ...
  assign new_n110_ = (x39 ? (~x29 | ~x40) : x40) & (~x35 | (~x27 & x28));
