...
module FAU ( 
  ...
  assign z03 = new_n65_ | ~x21 | (~new_n65_ & ((x27 & (~x35 | (~x28 & x37))) | (~x37 & (~x27 | ~x28))));
  assign z04 = ~new_n65_ & ((x27 & (~x35 | (~x28 & x37))) | x21 | (~x37 & (~x27 | ~x28)));
  assign z05 = ~new_n65_ & (x27 ? (x28 | (~x28 & x37)) : x37);
  ...
  assign z11 = ~x09 & ~x30 & ~new_n65_ & ~new_n80_;
