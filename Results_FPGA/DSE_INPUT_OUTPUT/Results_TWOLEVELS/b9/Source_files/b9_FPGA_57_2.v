...
module FAU ( 
  ...
  assign new_n71_ = x04 & ((x40 & (x28 | ~x35)) | (~x08 & ~x27));
  ...
  assign z10 = ~new_n83_ | (~x04 & ((new_n82_ & x27) | (new_n84_ & x05)));
  assign new_n82_ = ~new_n69_ & (new_n72_ ? x05 : x07);
  assign new_n83_ = ~new_n65_ & (~x06 | ~x27 | ~x37);
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n87_ & ~x08) | (new_n86_ & x40));
  ...
  assign z18 = ((~x08 | x40) & (x09 | new_n87_ | x30)) | (x08 & ~new_n105_ & x40);
  assign new_n105_ = (~x29 | ~x39) & (x27 | x28 | ~x35);
