...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x30 | ~x40)) | (~x30 & ~x32 & (new_n70_ | ~x27));
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = x40 & ~new_n73_ & x39 & (~x30 | ~x40);
  assign new_n73_ = x04 & ((~x08 & ~x27) | x28 | (~x30 & ~x35));
  ...
  assign new_n84_ = (~x27 | new_n70_ | (new_n85_ ? ~x05 : ~x07)) & (~new_n85_ | ~x05 | ~x32);
  assign new_n85_ = x39 & x40;
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = (~x30 & (new_n90_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x27 & (new_n93_ | (new_n92_ & ~x04)));
  assign new_n92_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n94_ = x40 & (x30 | (x32 & x39 & ~x04 & ~x13));
  assign z14 = (~new_n99_ & (~x40 | (~new_n96_ & ~x30))) | (~new_n68_ & ~x40) | (~new_n98_ & ~x30);
  assign new_n96_ = new_n97_ & (~x28 | x32 | (x35 & x36));
  assign new_n97_ = ~x04 & ~x13 & x39;
  assign new_n98_ = (x32 | (x27 & (~x28 | x35 | x37))) & (new_n97_ | (x27 & (x37 | (x28 & x35))));
  ...
  assign z18 = x30 ? ~x40 : (~new_n105_ | (~new_n104_ & x08));
  assign new_n104_ = ~new_n88_ & (x27 | x28 | ~x35);
  assign new_n105_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = (x30 & x40) | (~x09 & ~new_n87_ & ~x30);
  assign z20 = ~x09 & ~x30 & (new_n108_ | (~x08 & (~x27 | ~x35)));
  assign new_n108_ = ~new_n88_ & (~x35 | (~x27 & x28));
endmodule
