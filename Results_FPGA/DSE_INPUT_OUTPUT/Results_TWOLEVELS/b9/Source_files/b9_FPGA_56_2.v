...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x33 & ~x40 & (new_n66_ | ~x27));
  ...
  assign new_n96_ = ~x19 & x20 & ~new_n66_ & ~x33;
  ...
  assign new_n102_ = (x33 | x40 | (~new_n66_ & x27)) & (~x40 | (~new_n103_ & (new_n101_ | (~new_n66_ & x27))));
  ...
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (~x33 | x40)));
endmodule
