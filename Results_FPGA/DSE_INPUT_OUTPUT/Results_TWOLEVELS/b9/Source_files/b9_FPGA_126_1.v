...
module FAU ( 
  ...
  assign z03 = new_n73_ | (~new_n65_ & (~x21 | (x27 & ~x35)));
  assign new_n73_ = (~x40 | (x39 & x40)) & (x27 ? ~x28 : ~x37);
  assign z04 = new_n73_ | new_n65_ | x21 | (x27 & ~new_n65_ & ~x35);
  ...
  assign z08 = x39 & x40 & (x27 | x37 | (~x27 & ~x37));
  ...
  assign z12 = (~new_n66_ & ~x40) | (x39 & (new_n91_ | (~new_n66_ & x04)));
  ...
  assign z14 = new_n99_ | (~new_n97_ & (~x40 | (x39 & (x04 | x13))));
