...
module FAU ( 
  ...
  assign new_n89_ = ~new_n90_ & (x40 ? (~x29 | ~x39) : ~x19);
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n91_ = (x27 | (x19 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n93_ | (x19 & ~x40) | (~new_n65_ & (x40 ? (x04 | ~x39) : ~x19));
  assign new_n93_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (x27 & (new_n95_ | (~x04 & new_n96_ & ~x13))) | (~x04 & new_n87_ & ~x13);
  assign new_n95_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n96_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (x40 & (new_n98_ | new_n100_)) | (~x19 & ~new_n102_ & ~x40);
  assign new_n98_ = (new_n66_ | ~new_n99_) & (x04 | x13 | ~x39);
  assign new_n99_ = x20 & x27 & ~x18 & ~x19;
  assign new_n100_ = ~x30 & ~x32 & (~x27 | (~new_n101_ & x28));
  assign new_n101_ = (x35 | x37) & ((x35 & x36) | (~x18 & ~x19 & x20));
  assign new_n102_ = ~new_n66_ & ~x18 & x20 & x27;
