...
module FAU ( 
  ...
  assign new_n73_ = (x27 | (x40 & (~x04 | x08))) & new_n75_ & (new_n74_ | ~x04);
  assign new_n74_ = ~x28 & x35;
  assign new_n75_ = (x40 | (x04 & (~x27 | x28))) & x20 & x39;
  ...
  assign z13 = x20 & (new_n96_ | (~x04 & new_n86_ & ~x13));
  assign new_n96_ = x27 & ((new_n97_ & ~x04) | (~x18 & ~new_n66_ & ~x19));
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n99_ | new_n101_ | ~new_n104_ | (new_n103_ & ~x30);
  assign new_n99_ = (x18 | x19) & (new_n100_ | ~new_n68_ | x04 | x13);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x37 & (~x28 | ~x35) & (new_n102_ | x13 | ~x40);
  assign new_n102_ = x20 & (x04 | ~x39);
  assign new_n103_ = ~x32 & ((x20 & ~x27) | (x28 & ~x35 & ~x37));
  assign new_n104_ = x20 & (x27 | (x40 & (~x20 | (~x04 & ~x13 & x39))));
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = new_n109_ | (~new_n69_ & (new_n110_ | x09 | x30));
  assign new_n109_ = x08 & x20 & new_n68_ & x29;
