...
module FAU ( 
  ...
  assign z19 = ~x09 & ~x30 & ((~new_n86_ & ~new_n87_) | (~new_n85_ & ~x08));
  assign new_n85_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign new_n86_ = x39 ? (x29 & x40) : ~x40;
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (x39 & ~new_n66_ & ~x40);
  ...
  assign new_n100_ = ~x32 & ((x28 & ~x35 & ~x37) | (~x27 & x39));
  assign new_n101_ = (~x28 | ~x35) & ((x40 & (x04 | ~x39)) | x13 | (x39 & ~x40));
  assign new_n102_ = (x39 | (x40 & (x27 | ~x40))) & (x27 | (x40 ? (~x04 & ~x13) : ~x39));
