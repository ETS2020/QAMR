...
module FAU ( 
  ...
  assign z12 = new_n89_ | (~x39 & x40) | ((~x40 | (x04 & x39)) & (new_n88_ | ~x27));
  ...
  assign z18 = ~new_n101_ | (x08 & ((x29 & x40) | (new_n72_ & ~x27)));
  assign new_n101_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n67_ & ~x30;
  assign z20 = new_n67_ | (~x09 & ~new_n103_ & ~x30);
  assign new_n103_ = (x08 | (x27 & x35)) & ((x29 & x40) | ((x27 | ~x28) & x35));
