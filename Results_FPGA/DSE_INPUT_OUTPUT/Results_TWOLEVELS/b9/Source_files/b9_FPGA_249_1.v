...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n75_, new_n80_, new_n81_, new_n85_, new_n86_, new_n87_,
  ...
  assign z02 = new_n72_ | (x24 & (~new_n75_ | (~x02 & (~x08 | ~x29))));
  assign new_n72_ = ~x40 & (~new_n74_ | (x27 & (new_n73_ | ~x35)));
  assign new_n73_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n74_ = ~x18 & ~x19 & x20 & x27 & (x28 | x37);
  assign new_n75_ = x39 & (~x04 | (~x28 & x35 & (x08 | x27)));
  ...
  assign new_n86_ = (~x07 | (x40 & (~x24 | x39))) & (~x39 | ~x40 | ~x05 | ~x24);
  assign new_n87_ = x05 & x24 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n89_ | (~new_n91_ & ~x08));
  assign new_n89_ = ~new_n90_ & (~x40 | (x24 & (~x29 | ~x39)));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n91_ = (x27 | (~x24 & x40)) & (~x24 | (~x04 & ~x28 & x35));
  assign z12 = (x24 & (new_n93_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n95_ & x27) | (new_n98_ & ~x04);
  assign new_n95_ = (~new_n97_ | x18) & (~x24 | (~new_n73_ & (~new_n96_ | x04)));
  assign new_n96_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign new_n98_ = ~x13 & x24 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n102_ | new_n103_ | (~new_n100_ & (x18 | x19 | ~x20));
  assign new_n100_ = ~new_n101_ & x39 & x40 & ~x04 & ~x13;
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = (x24 | ~x40) & (new_n68_ | ((~x24 | (~x04 & x39)) & ~x13 & x40));
  ...
  assign z18 = (~new_n108_ & x08) | ~new_n109_ | new_n67_ | x09;
  assign new_n108_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n109_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n67_ | (~x09 & ~x30 & (new_n111_ | ~new_n112_));
  assign new_n111_ = (~x29 | ~x39) & ((x24 & ~x35) | (~x27 & x28));
  assign new_n112_ = (x08 | ((x27 | x40) & (~x24 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
