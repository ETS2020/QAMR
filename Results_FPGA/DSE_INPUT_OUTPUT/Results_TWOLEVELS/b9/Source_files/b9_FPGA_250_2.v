...
module FAU ( 
  ...
  assign z10 = new_n84_ | (~new_n83_ & ~x04) | (x06 & x27 & x37);
  assign new_n83_ = (~x27 | new_n69_ | (new_n72_ ? ~x05 : ~x07)) & (~new_n72_ | ~x05 | ~x32);
  assign new_n84_ = x30 & (~x40 | (~x04 & x05 & x39));
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = (new_n87_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (~x04 & x27 & ~x28 & x35));
  ...
  assign new_n93_ = (~x30 | x40) & (x04 | x13 | ~x39 | (~x30 & (~x32 | ~x40)));
  assign z14 = new_n95_ | (~new_n98_ & ~x30) | (x40 & ~new_n66_ & ~new_n97_);
  assign new_n95_ = (x18 | x19 | ~x20) & (new_n96_ | (~new_n97_ & x40));
  assign new_n96_ = ~x30 & (~x40 | (x28 & ~x32 & (~x35 | ~x36)));
  assign new_n97_ = ~x04 & ~x13 & x39;
  assign new_n98_ = (x27 | (x32 & x40)) & (x37 | ((x35 | (x40 & (~x28 | x32))) & (x28 | x40)));
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = (~new_n103_ & x08) | (x30 & x40) | (~new_n104_ & ~x30);
  assign new_n103_ = ~new_n87_ & (x30 | ~x35 | x27 | x28);
  assign new_n104_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = (~x09 & ~new_n86_ & ~x30) | (x30 & ~x40);
  assign z20 = ~x09 & ~x30 & (new_n107_ | (~x08 & (~x27 | ~x35)));
  assign new_n107_ = ~new_n87_ & (~x35 | (~x27 & x28));
endmodule
