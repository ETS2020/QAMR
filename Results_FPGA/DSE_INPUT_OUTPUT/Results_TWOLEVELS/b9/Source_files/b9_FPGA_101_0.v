...
module FAU ( 
  ...
  assign z02 = x39 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x40;
  assign new_n71_ = (x27 | (x40 & (~x04 | x08))) & (~x04 | (~x28 & x35)) & (x40 | (x04 & (~x27 | x28)));
  assign z03 = ((x39 | x40) & (~new_n73_ | ~x21)) | (x27 & ~x28 & (x40 | (x39 & ~x40)));
  assign new_n73_ = x27 ? x35 : x37;
  assign z04 = (x27 & ~x28 & (x40 | (x39 & ~x40))) | ((x39 | x40) & (~new_n73_ | x21));
  ...
  assign z12 = x39 ? (new_n92_ | (~new_n66_ & (x04 | ~x40))) : (~new_n66_ & x40);
