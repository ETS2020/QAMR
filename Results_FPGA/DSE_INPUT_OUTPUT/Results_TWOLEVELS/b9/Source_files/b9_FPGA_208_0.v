...
module FAU ( 
  ...
  assign z01 = (new_n69_ & ~x30) | new_n65_ | ~x04;
  assign new_n69_ = ~x32 & (~x27 | (~x36 & (~x35 | (x28 & x40))));
  ...
  assign z10 = ~new_n84_ | (~x04 & (new_n85_ | (~new_n82_ & x27)));
  assign new_n82_ = (~x07 | x40) & (new_n83_ | ((~x07 | x39) & (~x05 | ~x39 | ~x40)));
  ...
  assign z18 = (~new_n109_ & ~new_n65_) | (z08 & x08 & x29);
  assign new_n109_ = ~new_n110_ & ~x09 & ~x30;
  assign new_n110_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n65_ | (~x09 & ~x30 & (new_n112_ | ~new_n113_));
  assign new_n112_ = (~x29 | ~x39) & ((~x35 & x40) | (~x27 & x28));
  assign new_n113_ = (x35 | (x40 ? x08 : ~x36)) & (x27 | ((x08 | (~x36 & ~x40)) & (~x28 | x40)));
endmodule
