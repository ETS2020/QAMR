...
module FAU ( 
  ...
  assign z12 = new_n90_ | (x39 & ~x40) | ((x04 | ~x39) & (new_n89_ | ~x27));
  ...
  assign new_n96_ = ~x27 & ((~new_n94_ & x40) | x04 | ~x39);
  assign new_n97_ = ~new_n89_ & ~x18 & ~x19 & x20;
  assign new_n98_ = ~new_n67_ & (~x28 | x30 | new_n99_ | x32);
  ...
  assign new_n109_ = ~x27 & ((x28 & (~x29 | ~x39)) | (~x08 & (~x39 | x40)));
  assign z08 = x39;
endmodule
