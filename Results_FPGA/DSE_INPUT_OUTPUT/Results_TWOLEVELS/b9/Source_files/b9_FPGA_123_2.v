// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:29 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n79_, new_n80_, new_n84_, new_n85_, new_n88_, new_n89_,
  ...
  assign z02 = new_n72_ | ~new_n74_ | (~x27 & (~x39 | (x04 & ~x08)));
  assign new_n72_ = x40 & ((~new_n73_ & ~x02) | (x04 & (x28 | ~x35)));
  assign new_n73_ = x08 & x29;
  assign new_n74_ = x39 ? x40 : ((~x27 | ~x28) & ~x37 & (x28 | x37));
  ...
  assign new_n84_ = (~x27 | new_n70_ | (x39 ? ~x05 : ~x07)) & (~x05 | new_n85_ | ~x39);
  assign new_n85_ = ~x30 & ~x32;
  assign z11 = z19 | new_n69_;
  assign z19 = ~x09 & ~x30 & ((~new_n90_ & ~x08) | (~new_n88_ & ~new_n89_));
  assign new_n88_ = x39 & (x29 | ~x40);
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n90_ = (x27 | (x39 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n92_ | (x39 & ~x40) | ((new_n66_ | ~x27) & (~x39 | (x04 & x40)));
  assign new_n92_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x39 & (~x40 | (~x04 & ~new_n85_ & ~x13)));
  ...
  assign z18 = ((~x39 | x40) & (new_n104_ | x09 | x30)) | (new_n73_ & x39 & x40);
