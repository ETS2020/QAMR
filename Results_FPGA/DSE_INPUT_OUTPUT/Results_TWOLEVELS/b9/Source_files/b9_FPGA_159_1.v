...
module FAU ( 
  ...
  assign new_n69_ = ~x21 & x40;
  assign z01 = (~x30 & ~x32 & (new_n71_ | ~x27)) | new_n69_ | ~x04;
  assign new_n71_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n73_ | (~x02 & (~x08 | ~x29));
  assign new_n73_ = ~new_n74_ & x39 & x40 & (x21 | ~x40);
  assign new_n74_ = x04 & ((~x08 & ~x27) | x28 | ~x35);
  assign z03 = (x27 & (~x28 | ~x35)) | ~x21 | (x21 & ~x27 & ~x37);
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | (~x21 & x40) | (~x27 & ~x37 & ~x40);
  ...
  assign z12 = (x21 & (new_n92_ | (~new_n93_ & (x04 | ~x39)))) | (~new_n93_ & ~x40);
  ...
  assign new_n99_ = x21 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (new_n93_ | x40) & (~x21 | (~new_n103_ & (new_n93_ | new_n101_)));
  ...
  assign new_n112_ = ~x08 & ((x21 & (~x27 | ~x35)) | (~x27 & ~x40));
  assign z05 = ~z06;
endmodule
