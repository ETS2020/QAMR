...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n80_, new_n81_, new_n85_, new_n86_, new_n89_, new_n90_,
  ...
  assign new_n85_ = ~new_n70_ & ((x06 & ((x07 & ~x39) | (x05 & x39 & x40))) | (x07 & ~x40));
  assign new_n86_ = x05 & x06 & x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n68_;
  assign z19 = ~x09 & ~x30 & ((~new_n90_ & ~new_n91_) | (~new_n89_ & ~x08));
  assign new_n89_ = (x27 | (~x06 & x40)) & (~x06 | (~x04 & ~x28 & x35));
  assign new_n90_ = x40 & (~x06 | (x29 & x39));
  assign new_n91_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = (x06 & (new_n93_ | (~new_n94_ & (x04 | ~x39)))) | (~new_n94_ & ~x40);
  ...
  assign new_n98_ = x06 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n103_ = (new_n94_ | x40) & (~x06 | (~new_n104_ & (new_n94_ | new_n102_)));
  ...
  assign z18 = (~new_n109_ & (x06 | ~x40)) | (x06 & x08 & x29 & x39 & x40);
