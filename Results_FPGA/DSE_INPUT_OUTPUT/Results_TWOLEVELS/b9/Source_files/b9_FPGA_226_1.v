...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x12) | ~x40 | new_n73_ | ~x39 | (~x12 & x40);
  ...
  assign z10 = (new_n86_ & ~x04) | (x27 & (new_n85_ | (new_n84_ & ~x04)));
  assign new_n84_ = ~new_n70_ & ((x07 & (~x40 | (x12 & ~x39))) | (x05 & x12 & x39 & x40));
  assign new_n85_ = x06 & ~new_n67_ & x37;
  assign new_n86_ = x05 & x12 & x39 & x40 & (x30 | x32);
  ...
  assign z12 = new_n92_ | (~x12 & x40) | (~new_n68_ & (~x40 | (x12 & (x04 | ~x39))));
  assign new_n92_ = ~x10 & ((x12 & ~x27) | (~x35 & ~x36 & ~x37));
  ...
  assign new_n101_ = (~x12 | (~new_n102_ & (new_n68_ | new_n100_))) & (new_n68_ | x40);
