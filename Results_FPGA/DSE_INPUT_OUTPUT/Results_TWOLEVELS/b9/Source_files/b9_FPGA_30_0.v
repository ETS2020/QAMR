...
module FAU ( 
  ...
  assign new_n85_ = (~x07 | (x40 ? x39 : ~x22)) & (~x05 | ~x39 | ~x40);
  assign new_n86_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n69_ | (~x09 & ~x30 & (new_n88_ | new_n89_));
  assign new_n88_ = (~new_n68_ | ~x29) & ((x04 & x27) | x28 | ~x35);
  assign new_n89_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (x22 & ~new_n92_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n95_ | (new_n94_ & ~x04))) | new_n69_ | (new_n96_ & ~x04);
  ...
  assign new_n99_ = (~x40 | (~x04 & x39)) & ~x13 & (~x22 | x40);
  assign new_n100_ = ~new_n101_ & ~x13 & x39 & x40 & (~x04 | ~x40);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = (x40 | (x22 & (~x22 | x27))) & (x27 | ((new_n103_ | ~x40) & (x30 | x32)));
