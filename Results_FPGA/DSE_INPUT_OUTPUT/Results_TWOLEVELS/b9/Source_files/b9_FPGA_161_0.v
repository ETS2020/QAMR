...
module FAU ( 
  ...
  assign z02 = x39 ? (new_n72_ | ~x40 | (~x02 & (~x08 | ~x29))) : x40;
  ...
  assign z12 = x39 ? (new_n91_ | (~new_n92_ & (x04 | ~x40))) : (~new_n92_ & x40);
  ...
  assign new_n99_ = x39 ? (~new_n100_ & ~x04 & ~x13 & x40) : ~x40;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = x39 ? (~new_n102_ & (new_n92_ | (~x04 & ~x13 & x40))) : (new_n92_ | ~x40);
