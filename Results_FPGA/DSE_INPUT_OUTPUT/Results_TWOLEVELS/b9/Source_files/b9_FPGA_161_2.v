...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n91_ | (x04 & (new_n90_ | ~x27)))) | (~x39 & (new_n90_ | ~x27));
  assign new_n90_ = ~x37 & (~x28 | ~x35);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n96_ | (x27 & (new_n93_ | (new_n95_ & ~x18)));
  assign new_n93_ = x40 & (new_n94_ | (~x18 & ~x19 & ~new_n90_ & x20));
  assign new_n94_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x19 & x20 & ~new_n90_ & ~x39;
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n99_ | (~new_n98_ & (~x39 | (x40 & (x04 | x13))));
  assign new_n98_ = ~new_n90_ & ~x18 & ~x19 & x20 & x27;
  assign new_n99_ = ~x30 & ~x32 & x40 & (~x27 | (~new_n100_ & x28));
  ...
  assign z18 = (x08 & x29 & x39 & x40) | (~new_n105_ & (~x39 | x40));
  assign new_n105_ = ~new_n106_ & ~x09 & ~x30;
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = ~x09 & ~new_n108_ & ~x30;
  assign new_n108_ = ~new_n109_ & (x08 | ((x35 | ~x40) & (x27 | (x39 & ~x40))));
  assign new_n109_ = (~x39 | (~x29 & x40)) & (~x35 | (~x27 & x28));
  assign z08 = x39;
endmodule
