...
module FAU ( 
  ...
  assign z06 = ~x37 & ((~x06 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign z10 = (~new_n84_ & ~x04) | (x06 & (~x40 | (x27 & x37)));
  ...
  assign new_n88_ = x40 ? (x29 & x39) : x06;
  assign new_n89_ = (x27 | (x06 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n91_ | ~new_n93_ | (~new_n92_ & ~x37);
  assign new_n91_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n92_ = ((~x04 & x39) | (x28 & x35)) & (x40 | (x35 & (x06 | x28)));
  assign new_n93_ = (x40 | (~x06 & x27)) & (x27 | (x39 & (~x04 | ~x40)));
  assign z13 = new_n95_ | (~x04 & new_n85_ & ~x13);
  assign new_n95_ = x27 & ((x40 & (new_n96_ | new_n97_)) | (new_n97_ & ~x06));
  assign new_n96_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n99_ | new_n101_ | ~new_n103_ | (~x27 & (~new_n68_ | new_n105_));
  assign new_n99_ = (x04 | x13) & (~new_n100_ | (~x37 & (~x28 | ~x35)));
  assign new_n100_ = ~x18 & ~x19 & x20 & (x27 | ~x40);
  assign new_n101_ = ~x37 & (new_n102_ | (~x28 & (~x39 | (~x06 & ~x40))));
  assign new_n102_ = ~x35 & (~x39 | ~x40 | (x28 & ~x30 & ~x32));
  assign new_n103_ = ~new_n69_ & ((~x18 & ~x19 & x20) | (new_n68_ & ~new_n104_));
  assign new_n104_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n105_ = ~x30 & ~x32;
  ...
  assign new_n110_ = (~new_n68_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n111_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n113_ & ~x09;
  assign new_n113_ = ~x30 & (new_n114_ | (~new_n88_ & (~x35 | (~x27 & x28))));
  assign new_n114_ = ~x08 & ((~x35 & x40) | (~x27 & (~x06 | x40)));
