...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n100_, new_n105_, new_n106_, new_n109_, new_n110_;
  ...
  assign z04 = (~new_n65_ & (x27 ? (~x28 | ~x35) : ~x37)) | new_n65_ | x21;
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : x12)) & (~x05 | ~x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n87_ & ~new_n88_) | (~new_n86_ & ~x08));
  assign new_n86_ = (x27 | (x12 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n87_ = x40 ? (x29 & x39) : x12;
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n90_ | (x12 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : ~x12));
  assign new_n90_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (x27 & (new_n93_ | (new_n92_ & ~x04))) | new_n65_ | (new_n94_ & ~x04);
  ...
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : x12;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (~x40 | (~new_n100_ & (new_n66_ | new_n98_))) & (x12 | new_n66_ | x40);
  assign new_n100_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x12 & (~x40 | (x26 & x27 & x34));
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (~x12 | x40)));
endmodule
