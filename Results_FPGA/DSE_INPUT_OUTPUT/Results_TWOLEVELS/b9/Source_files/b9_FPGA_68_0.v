...
module FAU ( 
  ...
  assign z12 = new_n89_ | (~x39 & ~x40) | ((new_n66_ | ~x27) & (x40 ? (x04 | ~x39) : x39));
  ...
  assign z14 = new_n96_ | new_n99_ | (~x30 & ~new_n100_ & ~x32);
  assign new_n96_ = ~new_n97_ & (x40 ? (new_n98_ | x04 | x13 | ~x39) : x39);
  assign new_n97_ = ~x18 & ~x19 & x20;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = (new_n66_ | ~x27) & (x40 ? (x04 | x13 | ~x39) : x39);
  assign new_n100_ = (x27 | ~x39) & (x37 | ~x40 | ~x28 | x35);
  ...
  assign z20 = new_n68_ | (new_n108_ & ~x09);
