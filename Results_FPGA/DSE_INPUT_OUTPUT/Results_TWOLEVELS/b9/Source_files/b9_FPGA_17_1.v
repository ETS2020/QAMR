...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n79_, new_n80_, new_n84_, new_n85_, new_n86_, new_n89_, new_n90_,
  ...
  assign z09 = x34 & x27 & x26 & x11 & x25;
  assign z10 = new_n86_ | (~x04 & (new_n85_ | (x05 & new_n84_ & x39)));
  assign new_n84_ = x40 & ((x25 & ((~new_n70_ & x27) | x30 | x32)) | (~x27 & (x30 | x32)));
  assign new_n85_ = x07 & x25 & x27 & ~new_n68_ & ~new_n70_;
  assign new_n86_ = x06 & x25 & x27 & x37;
  assign z11 = z19 | (~x25 & x27);
  assign z19 = ~x09 & ~x30 & (new_n91_ | (~new_n89_ & ~new_n90_));
  assign new_n89_ = x29 & x39 & x40;
  assign new_n90_ = (~x04 | ~x25 | ~x27) & ((~x25 & x27) | (~x28 & x35));
  assign new_n91_ = ~x08 & (~x27 | (x25 & (x04 | x28 | ~x35)));
  assign z12 = new_n93_ | ((~new_n68_ | x04) & (~x27 | (new_n66_ & x25)));
  assign new_n93_ = ~x10 & (~x27 | (x25 & ~x35 & ~x36 & ~x37));
  assign z13 = (x25 & ((~new_n95_ & x27) | (~x04 & new_n97_ & ~x13))) | (~x04 & ~x13 & new_n97_ & ~x27);
  assign new_n95_ = (~new_n96_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n96_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = new_n100_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n100_ = x39 & x40 & ~x13 & (~x04 | ~x25);
  assign new_n101_ = ~new_n102_ & new_n104_ & (x37 | new_n103_ | (x28 & x35));
  assign new_n102_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n103_ = ~x13 & (~x25 | (~x04 & x39 & x40));
  assign new_n104_ = x27 ? x25 : (~x04 & ~x13 & x39 & x40);
  assign z15 = x34 & x27 & x26 & x12 & x25;
  ...
  assign new_n110_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & x25 & x27));
  assign z20 = (~x25 & x27) | (~x09 & ~new_n112_ & ~x30);
  assign new_n112_ = (x08 | (x27 & (~x25 | x35))) & (new_n89_ | ((~x25 | x35) & (x27 | (~x28 & x35))));
endmodule
