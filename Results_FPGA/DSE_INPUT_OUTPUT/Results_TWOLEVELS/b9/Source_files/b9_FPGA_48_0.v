...
module FAU ( 
  ...
  assign z12 = new_n88_ | new_n89_ | (~new_n66_ & (x04 | ~x39));
  assign new_n88_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n89_ = ~x40 & (~x27 | ~x34 | (~x37 & (~x35 | (~x28 & x34))));
  ...
  assign z14 = (~new_n100_ & ~x27) | new_n95_ | new_n65_ | (~new_n98_ & ~x37);
  assign new_n95_ = (new_n96_ | ~new_n97_) & (x18 | x19 | ~x20);
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = ~x04 & ~x13 & x39 & x40;
  assign new_n98_ = new_n99_ & ((x28 & x35) | (~x04 & ~x13 & x39));
  assign new_n99_ = (x35 | (x40 & (~x28 | x30 | x32))) & (x28 | ~x34 | x40);
  assign new_n100_ = (~x40 | (~x13 & (x30 | x32))) & ~x04 & x39 & x40;
