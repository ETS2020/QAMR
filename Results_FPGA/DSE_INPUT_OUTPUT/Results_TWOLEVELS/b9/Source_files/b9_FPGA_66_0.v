...
module FAU ( 
  ...
  assign new_n88_ = x40 ? (x29 & x39) : ~x00;
  assign new_n89_ = (x27 | (~x00 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  ...
  assign new_n94_ = ~x18 & ~x19 & x20 & ~new_n66_ & ~new_n69_;
  ...
  assign new_n99_ = ~new_n100_ & ~new_n69_ & (new_n92_ | (new_n68_ & ~x04 & ~x13));
  ...
  assign z20 = (~x00 & ~x40) | (~x09 & ~x30 & (~new_n108_ | (~new_n110_ & x00)));
