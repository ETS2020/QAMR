...
module FAU ( 
  ...
  assign z11 = (x10 & ~x40) | (~x09 & ~x30 & (~new_n86_ | (~new_n89_ & ~x10)));
  ...
  assign new_n89_ = (x35 | x40) & (x08 | x27);
  ...
  assign new_n99_ = (~x40 | (~x04 & x39)) & ~x13 & (x10 | x40);
  assign new_n100_ = ~new_n101_ & z08 & ~x04 & ~x13;
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = (x40 | (~x10 & x27)) & (x27 | (~x13 & (new_n103_ | ~x40)));
  assign new_n103_ = ~x04 & x39 & (x30 | x32);
  assign z15 = new_n65_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = ~new_n108_ | (x08 & (new_n87_ | (new_n72_ & ~x27)));
  assign new_n108_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n65_ & ~x30;
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = ~new_n112_ & (new_n111_ | (x35 & (x27 | ~x28)));
  assign new_n111_ = x40 ? (x29 & x39) : x10;
  assign new_n112_ = ~x08 & ((~x27 & (~x10 | x40)) | (~x35 & x40));
  assign z19 = (x10 & ~x40) | (~x09 & ~x30 & (~new_n86_ | (~new_n89_ & ~x10)));
endmodule
