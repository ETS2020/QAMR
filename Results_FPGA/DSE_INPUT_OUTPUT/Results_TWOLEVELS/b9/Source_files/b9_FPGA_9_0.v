// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:26 2020
...
module FAU ( 
  ...
  assign z02 = x40 ? ((~x02 & (~x08 | ~x29)) | new_n72_ | ~x39) : x39;
  ...
  assign new_n86_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign new_n87_ = x39 ? (x29 & x40) : ~x40;
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n90_ | (~x39 & ~x40) | ((new_n66_ | ~x27) & (x04 | ~x39 | ~x40));
  assign new_n90_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  ...
  assign z14 = (~new_n101_ & ~x27) | new_n97_ | new_n100_ | new_n68_;
  ...
  assign new_n101_ = ~x04 & x39 & x40 & (~x40 | (~x13 & (x30 | x32)));
  ...
  assign new_n106_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n107_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = z11 | new_n68_;
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n110_ | ~new_n111_));
  assign new_n110_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n111_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((x08 | (~x39 & ~x40)) & (~x28 | x39)));
endmodule
