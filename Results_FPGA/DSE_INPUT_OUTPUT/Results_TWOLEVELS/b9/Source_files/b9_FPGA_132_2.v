...
module FAU ( 
  ...
  assign z01 = (~new_n68_ & (~x04 | (new_n70_ & ~x30))) | (x28 & new_n71_ & ~x30);
  assign new_n70_ = ~x32 & (~x27 | (~x35 & ~x36));
  assign new_n71_ = ~x32 & ~x36 & (~x19 | (x19 & x40));
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n73_ | ~x39 | ~x40;
  ...
  assign new_n84_ = ~x04 & ~new_n85_ & (x36 | (~x28 & x35));
  assign new_n85_ = (~x07 | (x40 ? x39 : x19)) & (~x05 | ~x39 | ~x40);
  assign new_n86_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = (x19 & ~x40) | (~x09 & ~x30 & (~new_n88_ | (~new_n91_ & ~x19)));
  assign new_n88_ = (new_n89_ | (~x28 & (~x04 | ~x27))) & ~new_n90_ & (x08 | (~x04 & ~x28));
  assign new_n89_ = x29 & x39 & x40;
  assign new_n90_ = x40 & ((~x08 & (~x27 | ~x35)) | (~x35 & (~x29 | ~x39)));
  assign new_n91_ = (x35 | x40) & (x08 | x27);
  assign z12 = (x40 & (new_n93_ | (~new_n94_ & (new_n66_ | ~x27)))) | (~x19 & ~x40 & (new_n66_ | ~x27));
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n94_ = ~x04 & x39;
  assign z13 = (x27 & (new_n96_ | (new_n97_ & ~x04))) | new_n68_ | (new_n98_ & ~x04);
  assign new_n96_ = ~x18 & ~x19 & ~new_n66_ & x20;
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n98_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (x40 & (new_n100_ | new_n102_)) | (~x19 & ~new_n104_ & ~x40);
  assign new_n100_ = (new_n66_ | ~new_n101_) & (x04 | x13 | ~x39);
  assign new_n101_ = x20 & x27 & ~x18 & ~x19;
  assign new_n102_ = ~x30 & ~x32 & (~x27 | (~new_n103_ & x28));
  assign new_n103_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign new_n104_ = ~new_n66_ & ~x18 & x20 & x27;
  assign z15 = x12 & x26 & x27 & ~new_n68_ & x34;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n110_ | (~new_n68_ & (new_n109_ | x09 | x30));
  assign new_n109_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n110_ = x08 & x29 & x39 & x40;
  assign z20 = new_n112_ & ~x09;
  assign new_n112_ = ~x30 & (new_n114_ | (~new_n113_ & (~x35 | (~x27 & x28))));
  assign new_n113_ = x40 ? (x29 & x39) : x19;
  assign new_n114_ = ~x08 & ((~x35 & x40) | (~x27 & (~x19 | x40)));
  assign z19 = (x19 & ~x40) | (~x09 & ~x30 & (~new_n88_ | (~new_n91_ & ~x19)));
endmodule
