...
module FAU ( 
  ...
  assign new_n88_ = x40 ? (x29 & x39) : x14;
  assign new_n89_ = (x27 | (x14 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (~x14 | x40)));
