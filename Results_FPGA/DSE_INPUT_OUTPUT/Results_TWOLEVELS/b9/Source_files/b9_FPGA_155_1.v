...
module FAU ( 
  ...
  assign z00 = (~x15 & (new_n68_ | (~new_n65_ & x27))) | new_n69_ | ~x16;
  ...
  assign z02 = ~new_n73_ | (x40 & (~x34 | (~x02 & (~x08 | ~x29))));
  assign new_n73_ = (new_n74_ | ~x04) & x39 & (x40 | (x04 & ~x37 & (x28 | x37)));
  assign new_n74_ = ~x28 & x35 & (x08 | x27);
  assign z03 = (~new_n67_ & x27) | (~x27 & ~new_n69_ & ~x37) | new_n69_ | ~x21;
  assign z04 = (~new_n67_ & x27) | new_n69_ | x21 | (~x27 & ~new_n69_ & ~x37);
  ...
  assign new_n85_ = ~new_n71_ & ((x07 & (~x40 | (x34 & ~x39))) | (x39 & x40 & x05 & x34));
  assign new_n86_ = x06 & ~new_n69_ & x37;
  assign new_n87_ = x34 & x39 & x40 & (x30 | x32);
  ...
  assign z12 = (x34 & (new_n93_ | (~new_n92_ & (x04 | ~x39)))) | (~new_n92_ & ~x40);
  assign new_n92_ = x27 & (new_n67_ | x37);
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n95_ & x27) | (~x04 & new_n87_ & ~x13);
  assign new_n95_ = (~x34 | ((~new_n96_ | x04) & (~new_n97_ | x18))) & (~new_n98_ | x18);
  ...
  assign new_n104_ = (~x34 | (~x04 & x39)) & ~x13 & x40;
  assign new_n105_ = (x34 | ~x40) & (x27 | (x40 & (~x34 | (~x04 & ~x13 & x39))));
  ...
  assign z19 = new_n69_ | (~x09 & ~new_n89_ & ~x30);
endmodule
