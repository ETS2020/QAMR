...
module FAU ( 
  ...
  assign z02 = new_n72_ | ~new_n73_ | (~x02 & x39 & (~x08 | ~x29));
  assign new_n72_ = ~x27 & ((x04 & ~x08) | (x08 & ~x28 & x35 & ~x40));
  ...
  assign z12 = new_n89_ | (~x39 & x40) | ((new_n66_ | ~x27) & (~x40 | (x04 & x39)));
  ...
  assign new_n106_ = (x08 | (x27 & x35)) & ((x29 & x40) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
  assign z19 = z11;
endmodule
