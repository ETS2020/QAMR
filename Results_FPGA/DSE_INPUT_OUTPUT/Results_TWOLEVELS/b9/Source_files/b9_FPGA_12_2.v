...
module FAU ( 
  ...
  assign z10 = (x27 & (new_n83_ | (~x04 & ~new_n71_ & ~new_n84_))) | (new_n85_ & ~x04);
  assign new_n83_ = x06 & ~new_n69_ & x37;
  assign new_n84_ = (~x07 | (x40 ? x39 : x21)) & (~x05 | ~x39 | ~x40);
  ...
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & (new_n66_ | ~x27)))) | (~x21 & ~x40 & (new_n66_ | ~x27));
  ...
  assign new_n97_ = ~x19 & x20 & ~new_n66_ & ~x21;
  assign new_n98_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n100_ | ~new_n104_ | (~new_n102_ & (x18 | x19 | ~x20));
  assign new_n100_ = ~x37 & ((~new_n101_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n101_ = (~x40 | (~x04 & x39)) & ~x13 & (x21 | x40);
  assign new_n102_ = ~new_n103_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n103_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n104_ = (x40 | (~x21 & (x21 | x27))) & (x27 | ((new_n105_ | ~x40) & (x30 | x32)));
  ...
  assign z18 = (~new_n110_ & ~new_n69_) | (z08 & x08 & x29);
  ...
  assign new_n114_ = ~x08 & ((~x35 & x40) | (~x27 & (~x21 | x40)));
endmodule
