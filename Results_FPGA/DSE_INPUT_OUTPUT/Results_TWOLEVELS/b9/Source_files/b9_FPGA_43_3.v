...
module FAU ( 
  ...
  assign z02 = ~x40 | (~x25 & (~new_n73_ | (~new_n72_ & x40)));
  ...
  assign new_n79_ = (x15 | ~x17) & ((~x25 & (x00 | ~x38)) | (~x38 & ~x40));
  ...
  assign new_n90_ = x40 & (x25 | (x29 & x39));
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (~x25 & (new_n93_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  ...
  assign new_n103_ = (x25 | (~x04 & x39)) & ~x13 & x40;
  assign new_n104_ = x40 & (x25 | (x13 & ~x27));
  assign new_n105_ = x40 & (x30 | x32) & (x25 | (~x04 & x39));
  ...
  assign new_n113_ = (~x29 | ~x39) & ((~x27 & x28) | (~x25 & ~x35));
  assign new_n114_ = (x08 | ((x27 | x40) & (x25 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
