...
module FAU ( 
  ...
  assign z12 = new_n88_ | (~x39 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x39));
  assign new_n88_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = ~new_n90_ | (x27 & (new_n92_ | (new_n91_ & ~x04)));
  assign new_n90_ = ~new_n65_ & (x04 | ~new_n83_ | x13);
  ...
  assign new_n96_ = (~x40 | (~new_n97_ & (new_n66_ | (~x04 & ~x13 & x39)))) & (~x39 | new_n66_ | x40);
  ...
  assign z20 = new_n65_ | (~x09 & ~new_n105_ & ~x30);
