...
module FAU ( 
  ...
  assign new_n88_ = (~new_n68_ | ~x29) & (x28 | ~x35 | (x04 & x27));
  ...
  assign new_n100_ = (~x40 | (~x04 & x39)) & ~x13 & (x34 | x40);
  assign new_n101_ = ~new_n102_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = (x40 | (~x34 & (x27 | x34))) & (x27 | new_n104_ | ~x40);
  assign new_n104_ = ~x04 & ~x13 & x39 & (x30 | x32);
