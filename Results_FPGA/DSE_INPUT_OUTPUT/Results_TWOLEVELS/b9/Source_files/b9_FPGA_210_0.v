...
module FAU ( 
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : ~x08)) & (~x05 | ~x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n86_ & ~x30;
  assign new_n86_ = (new_n87_ | ((x39 | ~x40) & (~x08 | (x29 & x40)))) & (x08 | new_n88_ | ~x40);
  ...
  assign z14 = (~new_n100_ & ~x27) | new_n96_ | new_n99_ | new_n65_;
