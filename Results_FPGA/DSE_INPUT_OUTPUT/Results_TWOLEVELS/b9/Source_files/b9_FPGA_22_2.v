// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:32 2020
...
module FAU ( 
  ...
  assign z06 = ~x37 & ((~x13 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign z10 = (~new_n83_ & ~x04) | new_n69_ | (x06 & x27 & x37);
  assign new_n83_ = (~x27 | new_n71_ | (z08 ? ~x05 : ~x07)) & (~new_n84_ | ~x05);
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n69_;
  assign z19 = ~x09 & ~x30 & ((~new_n87_ & ~x08) | (~new_n88_ & ~new_n89_));
  assign new_n87_ = (x27 | (x13 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : x13;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x13 & ~x40 & (new_n66_ | ~x27));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x04 & x39;
  assign z13 = new_n97_ | (x27 & (new_n94_ | (new_n96_ & ~x18)));
  assign new_n94_ = ~x13 & (new_n95_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n95_ = ~x04 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x19 & x20 & ~new_n66_ & x40;
  assign new_n97_ = ~x04 & new_n84_ & ~x13;
  assign z14 = new_n99_ | ~new_n103_ | (~new_n101_ & (x18 | x19 | ~x20));
  assign new_n99_ = ~x37 & ((~new_n100_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n100_ = (~x40 | (~x04 & x39)) & ~x13 & (x13 | x40);
  assign new_n101_ = ~new_n102_ & z08 & ~x04 & ~x13;
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = (~x13 | (x40 & (x27 | ~x40))) & (x27 | (x40 ? new_n104_ : x13));
  assign new_n104_ = ~x04 & x39 & (x30 | x32);
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = (~new_n109_ & x08) | ~new_n110_ | new_n69_ | x30;
  assign new_n109_ = (~z08 | ~x29) & (x27 | x28 | ~x35);
  assign new_n110_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n112_ & ~x09;
  assign new_n112_ = ~x30 & (new_n113_ | (~new_n88_ & (~x35 | (~x27 & x28))));
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (~x13 | x40)));
endmodule
