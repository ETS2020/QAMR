...
module FAU ( 
  ...
  assign z02 = ~x40 | (x39 & (new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z07 = new_n71_ | (~new_n78_ & x03);
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z09 = x11 & x26 & x27 & ~new_n71_ & x34;
  assign z10 = (~new_n82_ & ~x04) | new_n71_ | (x06 & x27 & x37);
  assign new_n82_ = (~new_n83_ | ~x27) & (~x05 | ~x40 | (~x30 & ~x32));
  assign new_n83_ = (x36 | (~x28 & x35)) & (x40 ? x05 : x07);
  assign z11 = ~x09 & ~x30 & (new_n85_ | (~new_n86_ & ~x08));
  assign new_n85_ = (~x40 | (~x29 & x39)) & (~new_n70_ | (x04 & x27));
  assign new_n86_ = (x27 | (~x39 & x40)) & (~x39 | (new_n70_ & ~x04));
  ...
  assign z18 = ~new_n102_ | (x08 & ((x29 & x40) | (new_n70_ & ~x27)));
  assign new_n102_ = ~x09 & (~new_n70_ | x04 | ~x27) & ~new_n71_ & ~x30;
  assign z20 = ~x09 & ~new_n104_ & ~x30;
  assign new_n104_ = ~new_n105_ & (x08 | ((x35 | ~x39) & (x27 | (~x39 & x40))));
  assign new_n105_ = (~x40 | (~x29 & x39)) & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
  assign z08 = x40;
