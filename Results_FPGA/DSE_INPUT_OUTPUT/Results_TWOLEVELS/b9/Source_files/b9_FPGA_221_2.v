...
module FAU ( 
  ...
  assign z02 = ~new_n72_ | (~x02 & (~x08 | (~x29 & x40)));
  assign new_n72_ = (x08 | (x40 & (~x04 | x27))) & (~x40 | (x39 & (new_n70_ | ~x04)));
  ...
  assign new_n84_ = (~x07 | (x40 ? x39 : x08)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n65_ | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (~x40 | new_n88_ | (new_n70_ & (~x04 | ~x27))) & (x08 | (new_n70_ & ~x04 & x27));
  ...
  assign z14 = new_n96_ | new_n97_ | new_n65_ | new_n100_;
  assign new_n96_ = ~new_n66_ & ((x40 & (x04 | ~x39)) | x13 | (~x08 & ~x40));
