...
module FAU ( 
  ...
  assign z02 = ~x40 | (x23 & (~new_n73_ | (~new_n72_ & x40)));
  ...
  assign new_n84_ = (~x07 | (x40 & (~x23 | x39))) & (~x39 | ~x40 | ~x05 | ~x23);
  assign new_n85_ = x05 & x23 & x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n68_;
  assign z19 = ~x09 & ~x30 & ((~new_n89_ & ~new_n90_) | (~new_n88_ & ~x08));
  assign new_n88_ = (x27 | (~x23 & x40)) & (~x23 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (~x23 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x23 & (new_n92_ | (~new_n93_ & (x04 | ~x39)))) | (~new_n93_ & ~x40);
  ...
  assign new_n97_ = x23 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n104_ & x40) | new_n99_ | new_n102_ | (~x27 & (new_n105_ | ~x40));
  ...
  assign new_n103_ = (~x23 | (~x04 & x39)) & ~x13 & x40;
  assign new_n104_ = x23 & (~x13 | ~x23 | x27);
  assign new_n105_ = x23 & (x04 | ~x39 | (~x30 & ~x32));
  assign z15 = new_n68_ | (x12 & x26 & x27 & x34);
  assign z16 = ~x23 & (x40 | (x01 & x22));
  assign z17 = (~x23 & x40) | (x01 & x22 & x23 & ~x24);
  ...
  assign new_n114_ = ~x08 & ((x23 & (~x27 | ~x35)) | (~x27 & ~x40));
  assign z05 = ~z06;
endmodule
