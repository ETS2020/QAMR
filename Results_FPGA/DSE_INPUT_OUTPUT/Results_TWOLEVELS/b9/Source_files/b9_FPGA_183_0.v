...
module FAU ( 
  ...
  assign new_n88_ = (x27 | (~x12 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 ? (x29 & x39) : ~x12;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n92_ | ~new_n94_ | (~new_n93_ & ~x37);
  assign new_n92_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n93_ = ((x28 & x35) | (~x04 & x39)) & (x40 | (x35 & (~x12 | x28)));
  assign new_n94_ = (x40 | (x12 & x27)) & (x27 | (x39 & (~x04 | ~x40)));
  assign z13 = (~new_n96_ & x27) | new_n67_ | (~x04 & new_n85_ & ~x13);
  assign new_n96_ = (~new_n97_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n99_ | new_n102_ | ~new_n103_ | (new_n105_ & ~x30);
  assign new_n99_ = (new_n100_ | ~new_n101_) & (x18 | x19 | ~x20);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = (~x40 | (~x04 & ~x13)) & x39 & x40;
  assign new_n102_ = (x04 | x13) & (new_n66_ | (~x27 & x40));
  assign new_n103_ = (new_n104_ | (x39 & x40)) & (x12 | x40) & (x28 | x37 | (x39 & (~x12 | x40)));
  assign new_n104_ = x27 & (x35 | x37);
  assign new_n105_ = ~x32 & ((~x27 & x40) | (x28 & ~x35 & ~x37));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n110_ & x08) | ~new_n111_ | new_n67_ | x30;
  assign new_n110_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n111_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n113_ & ~x09;
  assign new_n113_ = ~x30 & (new_n114_ | (~new_n89_ & (~x35 | (~x27 & x28))));
  assign new_n114_ = ~x08 & ((~x35 & x40) | (~x27 & (x12 | x40)));
endmodule
