...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n77_, new_n78_,
    ...
    new_n92_, new_n94_, new_n95_, new_n96_, new_n101_, new_n104_;
  ...
  assign z11 = ~x09 & ~x30 & ((~new_n86_ & x04) | (~new_n85_ & x27));
  assign new_n85_ = ((~x28 & x35) | (new_n71_ & x08 & x29)) & (~x04 | (new_n71_ & x29));
  assign new_n86_ = x08 & (new_n87_ | (x35 & (x27 | ~x28)));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = ~x27 | (~x37 & (new_n89_ | (~x10 & ~x35 & ~x36)));
  assign new_n89_ = (~x28 | ~x35) & (~new_n71_ | x04);
  assign z13 = x27 & (new_n91_ | (~x04 & ~x13 & new_n92_ & x39));
  assign new_n91_ = ~x18 & ~x19 & ~new_n65_ & x20;
  assign new_n92_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign z14 = (x04 & (~new_n94_ | ~x27)) | (~new_n94_ & (~new_n71_ | x13)) | new_n95_ | (~x04 & ~x27);
  assign new_n94_ = ~new_n65_ & ~x18 & ~x19 & x20;
  ...
  assign z18 = (~x04 & (new_n68_ | ~x27)) | ~new_n101_ | (x08 & (new_n87_ | (new_n68_ & ~x27)));
  assign new_n101_ = ~x09 & ~x30;
  assign z19 = (~x09 & ~x30 & ((~new_n86_ & x04) | (~new_n85_ & x27))) | (~x04 & ~x27);
  assign z20 = ~x09 & ~new_n104_ & ~x30;
  assign new_n104_ = (x08 | (x27 ? x35 : ~x04)) & (new_n87_ | ((~x27 | x35) & (~x04 | (x35 & (x27 | ~x28)))));
endmodule
