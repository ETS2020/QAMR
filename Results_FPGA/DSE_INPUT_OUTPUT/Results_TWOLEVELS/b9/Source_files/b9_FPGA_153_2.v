...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n77_,
    new_n78_, new_n81_, new_n82_, new_n84_, new_n85_, new_n87_, new_n89_,
  ...
  assign z10 = (~new_n81_ & ~x04) | new_n65_ | (x06 & x27 & x37);
  assign new_n81_ = (~x27 | new_n69_ | (x39 ? ~x05 : ~x07)) & (~x05 | new_n82_ | ~x39);
  assign new_n82_ = ~x30 & ~x32;
  assign z11 = ~x09 & ~x30 & (new_n84_ | (~new_n85_ & ~x08));
  assign new_n84_ = (~x39 | (~x29 & x40)) & (~new_n72_ | (x04 & x27));
  assign new_n85_ = (x27 | (x39 & ~x40)) & (~x40 | (new_n72_ & ~x04));
  assign z12 = (x40 & (new_n87_ | (~new_n66_ & x04))) | (~new_n66_ & ~x39);
  assign new_n87_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n89_ | (x27 & (new_n90_ | new_n91_));
  assign new_n89_ = x39 & (~x40 | (~x04 & ~new_n82_ & ~x13));
  assign new_n90_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n91_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n93_ | new_n94_ | new_n65_ | new_n97_;
  assign new_n93_ = ~new_n66_ & (x13 | ~x39 | (x04 & x40));
  assign new_n94_ = (new_n95_ | ~new_n96_) & (x18 | x19 | ~x20);
  ...
  assign new_n102_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n65_ & ~x30;
  assign z20 = ~x09 & ~new_n104_ & ~x30;
  assign new_n104_ = ~new_n105_ & (x08 | ((x35 | ~x40) & (x27 | (x39 & ~x40))));
  assign new_n105_ = (~x39 | (~x29 & x40)) & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
  assign z08 = x39;
