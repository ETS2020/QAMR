...
module FAU ( 
  ...
  assign new_n95_ = (x32 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  assign z14 = ~new_n100_ | (~new_n97_ & (x18 | x19 | ~x20));
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x32;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x32 | new_n66_ | x40) & (~x40 | ((new_n66_ | new_n99_) & (x30 | new_n101_ | x32)));
  assign new_n101_ = x27 & (~x28 | x35 | x37);
