...
module FAU ( 
  ...
  assign new_n87_ = (x27 | (~x25 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : ~x25;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (x25 & ~new_n92_ & ~x40);
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x25;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x25 | new_n92_ | x40) & (~x40 | (~new_n101_ & (new_n92_ | new_n99_)));
