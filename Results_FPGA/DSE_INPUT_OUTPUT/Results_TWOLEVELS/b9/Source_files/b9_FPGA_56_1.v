...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n105_, new_n106_, new_n111_, new_n112_, new_n115_, new_n116_;
  ...
  assign z02 = (x33 & (~new_n73_ | (~new_n72_ & x40))) | (~new_n74_ & ~x40);
  ...
  assign new_n85_ = ~new_n70_ & ((x07 & (~x40 | (x33 & ~x39))) | (x39 & x40 & x05 & x33));
  ...
  assign new_n90_ = x40 & (~x33 | (x29 & x39));
  ...
  assign new_n96_ = (~x33 | ((~new_n97_ | x04) & (~new_n98_ | x18))) & (~new_n99_ | x18);
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n98_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n99_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign z14 = (~new_n106_ & (~x40 | (~new_n101_ & x33))) | (~new_n94_ & ~x40) | (~new_n103_ & x33);
  ...
  assign new_n115_ = ~x30 & (new_n116_ | (~new_n90_ & (~x35 | (~x27 & x28))));
