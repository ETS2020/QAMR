...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n71_ | ~new_n72_;
  assign new_n71_ = x04 & ((~x08 & ~x27) | x28 | (~x35 & x40));
  assign new_n72_ = x39 & (x40 | (x19 & (~x19 | (x04 & ~x37 & (x28 | x37)))));
  assign z03 = ~new_n65_ & ((x27 & (~x28 | ~x35)) | ~x21 | (~x27 & ~x37));
  assign z04 = new_n65_ | x21 | (~new_n65_ & (x27 ? (~x28 | ~x35) : ~x37));
  assign z05 = (x19 & ((x27 & x28) | (x37 & ~x40))) | (x40 & (x37 | (x27 & x28)));
  ...
  assign new_n87_ = ~new_n88_ & (x40 ? (~x29 | ~x39) : x19);
  assign new_n88_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n89_ = (x27 | (~x19 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n91_ | (~new_n92_ & ~x40) | (x40 & ~new_n66_ & (x04 | ~x39));
  assign new_n91_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x19 & x27 & (x37 | (x35 & (~x19 | x28)));
  assign z13 = x40 & (new_n96_ | (x27 & (new_n94_ | new_n95_)));
  assign new_n94_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & (x30 | x32);
  assign z14 = new_n98_ | new_n102_ | (~x30 & ~new_n100_ & ~x32);
  assign new_n98_ = (x04 | x13 | ~x39) & (x19 | (~new_n99_ & x40));
  assign new_n99_ = (x37 | (x28 & x35)) & ~x18 & x20 & x27;
  assign new_n100_ = (x27 | ~x40) & (~x28 | (~new_n101_ & (x35 | x37 | ~x40)));
  assign new_n101_ = (~x35 | ~x36) & (x19 | (x40 & (x18 | ~x20)));
  assign new_n102_ = ~x04 & x19 & ~x40;
  ...
  assign z20 = (~x19 & ~x40) | (~x09 & ~x30 & (~new_n110_ | (~new_n112_ & x19)));
  assign new_n110_ = (new_n111_ | ~x40) & (x27 | ~x28 | (x29 & x39 & x40));
  assign new_n111_ = (x08 | (x27 & x35)) & (x35 | (x29 & x39));
