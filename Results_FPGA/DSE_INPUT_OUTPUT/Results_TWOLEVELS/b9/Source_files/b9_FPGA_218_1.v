...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x20) | ~x40 | new_n73_ | ~x39 | (~x20 & x40);
  ...
  assign new_n86_ = x05 & x20 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n90_ & ~x08));
  assign new_n88_ = ~new_n89_ & ((x04 & x27) | x28 | ~x35);
  assign new_n89_ = x40 & (~x20 | (x29 & x39));
  assign new_n90_ = (x27 | (~x20 & x40)) & (~x20 | (~x04 & ~x28 & x35));
  assign z12 = new_n92_ | (~x20 & x40) | ((new_n66_ | ~x27) & (~x40 | (~new_n93_ & x20)));
  assign new_n92_ = ~x10 & ((x20 & ~x27) | (~x35 & ~x36 & ~x37));
  assign new_n93_ = ~x04 & x39;
  assign z13 = x20 & ((new_n97_ & ~x04) | (x27 & (new_n95_ | (new_n96_ & ~x04))));
  assign new_n95_ = ~x18 & ~new_n66_ & ~x19;
  assign new_n96_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | ((x18 | x19) & (~x40 | (~new_n99_ & x20)));
  assign new_n99_ = new_n100_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x20 | (~new_n102_ & (new_n100_ | (~new_n66_ & x27)))) & (x40 | (~new_n66_ & x20 & x27));
  ...
  assign z18 = (~new_n107_ & (x20 | ~x40)) | (x08 & x20 & x29 & x39 & x40);
  ...
  assign new_n111_ = ~x08 & ((x20 & (~x27 | ~x35)) | (~x27 & ~x40));
