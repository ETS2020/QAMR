// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:31 2020
...
module FAU ( 
  ...
  assign new_n73_ = x39 & (~x04 | (new_n71_ & (x08 | x27)));
  ...
  assign new_n85_ = (~x07 | (x40 ? x39 : x09)) & (~x05 | ~x39 | ~x40);
  assign new_n86_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n88_ & ~x09;
  assign new_n88_ = ~x30 & ((~new_n89_ & (~new_n71_ | (x04 & x27))) | (~x08 & (~new_n71_ | x04 | ~x27)));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | (x09 & ~x40) | (~new_n92_ & (x40 ? (x04 | ~x39) : ~x09));
  assign new_n91_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n96_ | (x27 & ((x40 & (new_n94_ | new_n95_)) | (new_n95_ & ~x09)));
  ...
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : x09;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x40 | (~new_n102_ & (new_n92_ | new_n100_))) & (x09 | new_n92_ | x40);
  ...
  assign z18 = ~new_n107_ | (x08 & (new_n89_ | (new_n71_ & ~x27)));
  assign new_n107_ = ~x09 & ~x30 & (~new_n71_ | x04 | ~x27);
  assign z20 = (x09 & ~x40) | (~x30 & ((~new_n109_ & ~x09) | (~x27 & x28 & ~x40)));
  assign new_n109_ = (x08 | (x27 & x35)) & (x35 | x40) & (new_n110_ | (x35 & (x27 | ~x28)));
  assign new_n110_ = x29 & x39;
  assign z19 = new_n88_ & ~x09;
endmodule
