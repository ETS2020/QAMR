...
module FAU ( 
  ...
  assign z12 = (~new_n93_ & ~x40) | (~x33 & (new_n92_ | (~new_n93_ & (x04 | ~x39))));
  ...
  assign new_n101_ = (~x33 | ~x40) & (new_n93_ | (~x13 & x40 & (x33 | (~x04 & x39))));
  ...
  assign new_n111_ = (~x29 | ~x39) & ((~x27 & x28) | (~x33 & ~x35));
  assign new_n112_ = (x08 | ((x27 | (x33 & x40)) & (x33 | x35))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
