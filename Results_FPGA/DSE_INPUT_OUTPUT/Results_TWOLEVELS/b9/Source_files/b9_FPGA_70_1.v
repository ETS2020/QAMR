...
module FAU ( 
  ...
  assign new_n72_ = (x27 | (x40 & (~x04 | x08))) & (x40 | ((~x27 | ~x28) & ~x37 & (x28 | x37)));
  ...
  assign new_n89_ = x40 & (x29 | ~x39 | ~x40);
  assign new_n90_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n91_ = (x27 | (x40 & (~x39 | ~x40))) & (~x39 | (~x28 & (~x40 | (~x04 & x35))));
  assign z12 = (x39 & (new_n93_ | (~new_n66_ & x04))) | (~new_n66_ & ~x40);
  ...
  assign new_n97_ = x40 & (~x39 | (~x04 & ~x13 & (x30 | x32)));
  assign z14 = new_n101_ | (~new_n99_ & (~x40 | (x39 & (x04 | x13))));
  ...
  assign z18 = (x08 & x29 & x39 & x40) | (~new_n107_ & (~x40 | (x39 & x40)));
  ...
  assign new_n112_ = ~x27 & ((~x08 & (~x40 | (x39 & x40))) | (x28 & (~x29 | ~x40)));
endmodule
