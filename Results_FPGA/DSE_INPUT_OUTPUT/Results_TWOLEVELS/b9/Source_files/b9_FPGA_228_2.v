...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x32 | x40)) | (~x30 & ~new_n69_ & ~x32);
  ...
  assign z06 = ~x37 & ((~x27 & (~x32 | x40)) | (~x28 & (x40 | (~x32 & ~x40))));
  ...
  assign new_n82_ = ~x04 & ~new_n83_ & (x36 | (~x28 & x35));
  ...
  assign new_n87_ = (x27 | (x32 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : x32;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n91_ | (~new_n66_ & (x04 | ~x39)))) | (~x32 & ~new_n66_ & ~x40);
  ...
  assign new_n95_ = (~x32 | x40) & (x04 | x13 | ~x39 | (~x32 & (~x30 | ~x40)));
  assign z14 = new_n97_ | (~new_n100_ & ~x32) | (x40 & ~new_n66_ & ~new_n99_);
  assign new_n97_ = (x18 | x19 | ~x20) & (new_n98_ | (~new_n99_ & x40));
  assign new_n98_ = ~x32 & (~x40 | (x28 & ~x30 & (~x35 | ~x36)));
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (x27 | (x30 & x40)) & (x37 | ((x35 | (x40 & (~x28 | x30))) & (x28 | x40)));
  ...
  assign new_n105_ = (x27 | x28 | ~x35) & (~z08 | ~x29);
  assign new_n106_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n108_ & ~x09;
  assign new_n108_ = ~x30 & (new_n109_ | (~new_n88_ & (~x35 | (~x27 & x28))));
  assign new_n109_ = ~x08 & ((~x35 & x40) | (~x27 & (~x32 | x40)));
endmodule
