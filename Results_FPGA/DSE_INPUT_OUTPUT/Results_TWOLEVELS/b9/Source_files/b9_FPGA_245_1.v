...
module FAU ( 
  ...
  assign z02 = new_n71_ | new_n73_ | (x04 & (~x35 | (~x08 & ~x27)));
  assign new_n71_ = x40 & ((~new_n72_ & ~x02) | ~x39 | (x04 & x28));
  ...
  assign new_n84_ = (~x27 | new_n69_ | (x40 ? ~x05 : ~x07)) & (~x05 | new_n85_ | ~x40);
  assign new_n85_ = ~x30 & ~x32;
  assign z11 = new_n67_ | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (new_n88_ | (x40 & (x29 | ~x40))) & (~x28 | (x08 & x29 & x40)) & (new_n89_ | x08);
  assign new_n88_ = x35 & (~x04 | ~x27);
  assign new_n89_ = x27 & x35 & (~x04 | ~x40);
  assign z12 = new_n92_ | (~x39 & x40) | ((~x40 | (x04 & x39)) & (new_n91_ | ~x27));
  ...
  assign new_n97_ = ~x04 & ~x13 & x39 & ~new_n85_ & x40;
  ...
  assign z18 = ((x39 | ~x40) & (new_n106_ | x09 | x30)) | (new_n72_ & x39 & x40);
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n67_ | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & (x27 | ~x28 | (x29 & x40)) & (x35 | (x40 & (x29 | ~x40)));
