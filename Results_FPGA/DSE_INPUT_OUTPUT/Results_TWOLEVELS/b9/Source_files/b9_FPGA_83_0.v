// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:05 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n101_, new_n106_, new_n107_, new_n109_, new_n110_, new_n111_;
  ...
  assign new_n87_ = (x27 | (~x21 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : ~x21;
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n91_ | new_n92_ | (~new_n66_ & (x04 | ~x39));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x40 & (~x21 | ~x27 | (~x37 & (~x35 | (x21 & ~x28))));
  assign z13 = (x27 & (new_n96_ | (new_n95_ & ~x04))) | new_n65_ | (new_n94_ & ~x04);
  assign new_n94_ = new_n84_ & ~x13;
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n100_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = ~new_n99_ & ~x04 & ~x13 & x39 & x40;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~new_n101_ & ~new_n92_ & (new_n66_ | (~x04 & ~x13 & x39));
  ...
  assign z20 = (~x21 & ~x40) | (~x09 & ~x30 & (~new_n109_ | (~new_n111_ & x21)));
  assign new_n109_ = (new_n110_ | ~x40) & (x27 | ~x28 | (x29 & x39 & x40));
  assign new_n110_ = (x08 | (x27 & x35)) & (x35 | (x29 & x39));
  assign new_n111_ = (x08 | x27) & (x35 | x40);
endmodule
