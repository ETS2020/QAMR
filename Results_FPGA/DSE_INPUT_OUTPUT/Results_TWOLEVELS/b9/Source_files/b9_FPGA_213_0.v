...
module FAU ( 
  ...
  assign new_n69_ = ~x29 & ~x40;
  assign z01 = (~x30 & ~x32 & (new_n71_ | ~x27)) | new_n69_ | ~x04;
  assign new_n71_ = ~x36 & (x28 | ~x35);
  assign z02 = (~x02 & (~x29 | (~x08 & x40))) | new_n73_ | ~x39 | ~x40;
  assign new_n73_ = x04 & ((x40 & (x28 | ~x35)) | (~x08 & ~x27));
  ...
  assign new_n87_ = ~new_n88_ & (x40 ? (~x29 | ~x39) : x29);
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n89_ = (x27 | (~x29 & ~x40)) & (~x29 | (~x28 & x35)) & (~x04 | ~x40);
  assign z12 = ~new_n91_ | new_n93_;
  assign new_n91_ = ~new_n92_ & (x40 | (x27 & x29)) & (x27 | (x39 & (~x04 | ~x40)));
  assign new_n92_ = ~x37 & (x04 | ~x39 | ~x40) & (~x28 | ~x35);
  ...
  assign z14 = ~new_n101_ | new_n102_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = ~new_n99_ & (new_n100_ | ~x40) & x39 & x40;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13;
  assign new_n101_ = (new_n100_ | (~new_n66_ & (x27 | ~x40))) & (x29 | x40) & ((~new_n66_ & x27) | (x39 & x40));
  ...
  assign z18 = (x39 & x40 & x08 & x29) | (~new_n107_ & (x29 | x40));
  assign new_n107_ = ~new_n108_ & ~x09 & ~x30;
  assign new_n108_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = ~new_n111_ & (x08 | ((x27 | (~x29 & ~x40)) & (~x29 | x35)));
  assign new_n111_ = (x40 ? (~x29 | ~x39) : x29) & (~x35 | (~x27 & x28));
