...
module FAU ( 
  ...
  assign z06 = ~x37 & ((x10 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign new_n82_ = ~new_n69_ & ((x07 & (x40 ? ~x39 : x10)) | (x05 & x39 & x40));
  ...
  assign z12 = (x40 & ((~new_n89_ & ~x10) | (~new_n66_ & (x04 | ~x39)))) | (x10 & ~new_n66_ & ~x40);
  assign new_n89_ = x27 & (x35 | x36 | x37);
  ...
  assign new_n95_ = ~new_n66_ & ((x40 & (x04 | ~x39)) | x13 | (x10 & ~x40));
  ...
  assign new_n104_ = ~new_n87_ & (x27 | x28 | ~x35);
  assign new_n105_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n65_ | (~x09 & ~new_n107_ & ~x30);
