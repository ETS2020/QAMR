// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:19 2020
...
module FAU ( 
  ...
  assign new_n82_ = (~x27 | new_n70_ | (x40 ? ~x05 : ~x07)) & (~x05 | new_n83_ | ~x40);
  assign new_n83_ = ~x30 & ~x32;
  assign z11 = ~x09 & ~x30 & (new_n85_ | (~new_n87_ & ~x08));
  assign new_n85_ = ~new_n86_ & (~x40 | (~x29 & x39));
  assign new_n86_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n87_ = (x27 | (~x39 & x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign z12 = (x39 & (new_n89_ | (~new_n65_ & x04))) | (~new_n65_ & ~x40);
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n91_ | (x40 & (~x39 | (~x04 & ~new_n83_ & ~x13)));
  ...
  assign new_n94_ = ~new_n66_ & ~x18 & ~x19 & x20 & x27;
  ...
  assign z18 = (~new_n101_ & (x39 | ~x40)) | (x39 & x40 & x08 & x29);
  assign new_n101_ = ~new_n102_ & ~x09 & ~x30;
  assign new_n102_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n67_ | (~x09 & ~new_n104_ & ~x30);
  assign new_n104_ = ~new_n105_ & (x35 | (x40 & (~x39 | (x08 & x29))));
  assign new_n105_ = ~x27 & ((~x08 & (x39 | ~x40)) | (x28 & (~x29 | ~x40)));
  assign z08 = x40;
