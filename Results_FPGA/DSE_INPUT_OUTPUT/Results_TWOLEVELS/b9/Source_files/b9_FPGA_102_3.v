// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:16 2020
...
module FAU ( 
  ...
  assign new_n65_ = ~x04 & ~x06 & new_n66_ & ~x15;
  ...
  assign z02 = (~x06 & (~new_n73_ | (~new_n72_ & x40))) | (~new_n74_ & ~x40);
  assign new_n72_ = (x02 | (x08 & x29)) & (~x04 | (~x28 & x35));
  assign new_n73_ = x39 & (~x04 | x08 | x27);
  assign new_n74_ = (~x27 | (x28 & x35 & (x18 | x19 | ~x20 | ~x28 | ~x35))) & ~x18 & ~x19 & x20 & x27;
  ...
  assign z10 = (~new_n85_ & ~x04) | (x06 & (x40 | (x27 & x37)));
  assign new_n85_ = (~new_n87_ | ~x05) & (~x27 | new_n70_ | (new_n86_ ? ~x05 : ~x07));
  ...
  assign new_n90_ = x40 & (x06 | (x29 & x39));
  assign new_n91_ = (x27 | (x06 & x40)) & (x06 | (~x04 & ~x28 & x35));
  assign z12 = ~new_n93_ | (~new_n94_ & ~x10);
  assign new_n93_ = (~x06 | ~x40) & (new_n68_ | (x40 & (x06 | (~x04 & x39))));
  assign new_n94_ = (x35 | x36 | x37) & (x06 | x27 | ~x40);
  assign z13 = (~new_n96_ & x27) | (~x04 & ~x06 & new_n87_ & ~x13);
  assign new_n96_ = (x06 | ((~new_n97_ | x04) & (~new_n98_ | x18))) & (~new_n99_ | x18);
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n98_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n99_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign z14 = (~new_n106_ & (~x40 | (~new_n101_ & ~x06))) | (~new_n68_ & ~x40) | (~new_n103_ & ~x06);
  ...
  assign new_n105_ = ~x27 & (x04 | ~x39 | (x13 & x40));
  assign new_n106_ = ~x18 & ~x19 & x20;
  assign z15 = new_n67_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n111_ & x08) | ~new_n112_ | new_n67_ | x09;
  assign new_n111_ = (x27 | x28 | ~x35) & (~new_n86_ | ~x29);
  assign new_n112_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n114_ & ~x09;
  assign new_n114_ = ~x30 & (new_n115_ | (~new_n90_ & (~x35 | (~x27 & x28))));
  assign new_n115_ = ~x08 & ((~x27 & ~x40) | (~x06 & (~x27 | ~x35)));
