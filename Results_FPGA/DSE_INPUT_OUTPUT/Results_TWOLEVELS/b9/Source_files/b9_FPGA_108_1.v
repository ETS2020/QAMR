...
module FAU ( 
  ...
  assign z08 = x40 & ((x39 & (~x04 | x37 | (x04 & x28))) | ~x39 | (~x28 & ~x37));
  ...
  assign z14 = new_n98_ | ~new_n101_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n98_ = ~new_n66_ & (x13 | ~x40 | (x04 & x39));
  assign new_n99_ = ~new_n100_ & ~x04 & ~x13 & x40;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = (x39 | ~x40) & (x30 | x32 | (~new_n102_ & (x27 | ~x39)));
  assign new_n102_ = x28 & ~x35 & ~x37;
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = new_n65_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n107_ | ~new_n108_ | new_n65_ | x30;
