// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:21 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n77_,
    new_n78_, new_n81_, new_n82_, new_n85_, new_n86_, new_n87_, new_n89_,
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | ~x39 | new_n72_ | (x39 & ~x40);
  ...
  assign z18 = new_n103_ | ~new_n104_ | new_n69_ | x30;
  assign new_n103_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x39));
  assign new_n104_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = ~new_n107_ & (x08 | ((x35 | ~x40) & (x27 | (x39 & ~x40))));
  assign new_n107_ = (~x39 | (~x29 & x40)) & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
  assign z08 = x39;
endmodule
