...
module FAU ( 
  ...
  assign z03 = (~x21 & (~x04 | (x04 & (~x27 | x28)))) | ~new_n74_ | (x27 & (~x28 | ~x35));
  assign new_n74_ = ~new_n67_ & (x27 | x37);
  ...
  assign z10 = (new_n86_ & ~x04) | (x27 & (new_n84_ | (~x04 & ~new_n70_ & ~new_n85_)));
  ...
  assign z12 = (~x21 & (new_n93_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  ...
  assign new_n102_ = (~x21 | ~x40) & (new_n68_ | (~x13 & x40 & (x21 | (~x04 & x39))));
  assign new_n103_ = ~x32 & ((~x21 & ~x27) | (x28 & ~x35 & ~x37));
