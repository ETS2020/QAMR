...
module FAU ( 
  ...
  assign z12 = new_n93_ | (~new_n90_ & x40);
  ...
  assign new_n94_ = (x37 | ((x28 | (~x04 & x40)) & (x35 | x40))) & (x27 | x40);
  assign z13 = ~new_n96_ | (x27 & (new_n98_ | (new_n97_ & ~x04)));
  assign new_n96_ = ~new_n68_ & (x04 | ~new_n83_ | x13);
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n98_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n100_ | new_n93_ | (~new_n103_ & x40);
  assign new_n100_ = (x18 | x19 | ~x20) & (~new_n102_ | (new_n101_ & x28));
  assign new_n101_ = ~x30 & ~x32 & ((~x35 & x40) | (~x36 & x39));
  assign new_n102_ = x40 ? (~x04 & ~x13 & x39) : ~x39;
  assign new_n103_ = ~new_n104_ & (x27 | x30 | x32) & (new_n105_ | x37);
  assign new_n104_ = (~x27 | (~x35 & ~x37)) & (x04 | x13 | ~x39);
  assign new_n105_ = (x28 | (~x13 & x39)) & (x32 | x35 | ~x28 | x30);
  assign z15 = x12 & x26 & x27 & ~new_n68_ & x34;
  assign z16 = new_n68_ | (x01 & x22 & ~x23);
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n110_ & (x39 | x40)) | (x39 & x40 & x08 & x29);
  assign new_n110_ = ~new_n111_ & ~x09 & ~x30;
  assign new_n111_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n113_ | ~new_n114_));
  assign new_n113_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n114_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((x08 | (~x39 & ~x40)) & (~x28 | x39)));
endmodule
