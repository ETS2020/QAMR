...
module FAU ( 
  ...
  assign z03 = (~x27 & ~x37 & (~x40 | (x39 & x40))) | (x27 & ~new_n66_ & (x39 | ~x40)) | ~x21 | (~x39 & x40);
  assign z04 = (~x27 & ~x37 & (~x40 | (x39 & x40))) | ((x39 | ~x40) & (x21 | (~new_n66_ & x27)));
  assign z05 = (~x40 | (x39 & x40)) & (x37 | (x27 & x28));
  assign z06 = (~x39 & x40) | (~x37 & (~x27 | ~x28) & (~x40 | (x39 & x40)));
  ...
  assign new_n87_ = ((x29 & x40) | (new_n70_ & (~x04 | ~x27))) & (x08 | (new_n70_ & ~x04 & x27));
