...
module FAU ( 
  ...
  assign z02 = (~new_n73_ & ~x19) | (~x40 & (~x27 | (x27 & x28) | x37 | (~x28 & ~x37)));
  assign new_n73_ = (new_n74_ | ~x40) & x39 & (~x04 | x08 | x27);
  assign new_n74_ = (x02 | (x08 & x29)) & (~x04 | (~x28 & x35));
  ...
  assign z10 = ~new_n86_ | (~x04 & ((new_n87_ & x05) | (new_n85_ & x27)));
  assign new_n85_ = ~new_n71_ & (new_n68_ ? x05 : x07);
  assign new_n86_ = ~new_n69_ & (~x06 | ~x27 | ~x37);
  assign new_n87_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n89_ | (~new_n91_ & ~x08));
  assign new_n89_ = ~new_n90_ & ((x04 & x27) | x28 | ~x35);
  assign new_n90_ = x40 & (x19 | (x29 & x39));
  assign new_n91_ = (x27 | (x19 & x40)) & (x19 | (~x28 & x35 & (~x04 | ~x40)));
  assign z12 = (~new_n95_ & ~x10) | ~new_n93_ | new_n96_;
  assign new_n93_ = (~new_n94_ | x37) & (x27 | (x40 & (x19 | x39)));
  assign new_n94_ = (~x28 | ~x35) & (~x40 | (~x19 & (x04 | ~x39)));
  assign new_n95_ = (x35 | x36 | x37) & (x19 | x27 | ~x40);
  assign new_n96_ = x40 & (x19 | (x04 & ~x19 & ~x27));
  assign z13 = ~x19 & (new_n98_ | (~x04 & new_n87_ & ~x13));
  assign new_n98_ = x27 & ((new_n99_ & ~x04) | (~x18 & ~new_n66_ & x20));
  assign new_n99_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n101_ | new_n105_ | (~x19 & (~new_n104_ | new_n106_));
  assign new_n101_ = (x18 | ~x20) & (~x40 | (~x19 & (new_n102_ | ~new_n103_)));
  ...
  assign new_n105_ = ~x40 & (new_n66_ | x19 | ~x27);
  ...
  assign z18 = new_n111_ | (~new_n69_ & (new_n112_ | x09 | x30));
  assign new_n111_ = x08 & ~x19 & new_n68_ & x29;
  assign new_n112_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n114_ & ~x09;
  assign new_n114_ = ~x30 & (new_n115_ | (~new_n90_ & (~x35 | (~x27 & x28))));
  assign new_n115_ = ~x08 & ((~x19 & (~x27 | ~x35)) | (~x27 & ~x40));
