...
module FAU ( 
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (~x38 & ~x39))) | (x39 & x40 & x05 & ~x38));
  ...
  assign z12 = ~new_n92_ | (~x10 & (new_n94_ | (~x35 & ~x36 & ~x37)));
  assign new_n92_ = ~new_n93_ & (~x38 | ~x40) & (x27 | (x39 & x40 & (~x04 | x38)));
  assign new_n93_ = ~x37 & (~x28 | ~x35) & (x04 | ~x39 | ~x40);
  assign new_n94_ = ~x27 & ~x38;
  ...
  assign z14 = new_n103_ | ~new_n104_ | (~new_n100_ & (x18 | x19 | ~x20));
  assign new_n100_ = ~new_n101_ & new_n102_ & x39 & x40;
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13;
  assign new_n103_ = ~x30 & ~x32 & (new_n94_ | (x28 & ~x35 & ~x37));
  assign new_n104_ = (new_n102_ | (~new_n66_ & (x27 | x38))) & (~x38 | ~x40) & ((x39 & x40) | (~new_n66_ & x27));
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = new_n69_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n109_ & (~x38 | ~x40)) | (x08 & x29 & ~x38 & x39 & x40);
  assign new_n109_ = ~new_n110_ & ~x09 & ~x30;
  assign new_n110_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n112_ | ~new_n113_));
  assign new_n112_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & ~x38));
  assign new_n113_ = (x35 | (x40 & (x08 | x38))) & (x27 | ((x08 | (x38 & x40)) & (~x28 | x40)));
endmodule
