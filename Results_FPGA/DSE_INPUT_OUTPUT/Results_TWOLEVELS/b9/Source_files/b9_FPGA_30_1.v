// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:35 2020
...
module FAU ( 
  ...
  assign z10 = (x27 & (new_n85_ | (new_n84_ & ~x04))) | (new_n86_ & ~x04);
  assign new_n84_ = ~new_n70_ & ((x07 & (~x40 | (x22 & ~x39))) | (x39 & x40 & x05 & x22));
  assign new_n85_ = x06 & ~new_n68_ & x37;
  assign new_n86_ = x05 & x22 & x39 & x40 & (x30 | x32);
  ...
  assign z12 = (x22 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~new_n92_ & ~x40);
  ...
  assign z14 = new_n103_ | new_n98_ | new_n101_ | (~new_n104_ & ~x27);
  assign new_n98_ = (new_n99_ | ~new_n100_) & (x18 | x19 | ~x20);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = x39 & x40 & ~x04 & ~x13;
  assign new_n101_ = ~x37 & ((~new_n102_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n102_ = (~x22 | (~x04 & x39)) & ~x13 & x40;
  assign new_n103_ = x40 & (~x22 | (x13 & ~x27));
  assign new_n104_ = x40 & (x30 | x32) & (~x22 | (~x04 & x39));
  assign z15 = x12 & x26 & x27 & ~new_n68_ & x34;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = (~new_n109_ & (x22 | ~x40)) | (new_n89_ & x08 & x22);
  assign new_n109_ = ~new_n110_ & ~x09 & ~x30;
  assign new_n110_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n68_ | (new_n112_ & ~x09);
  assign new_n112_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n89_ & (~x35 | (~x27 & x28))));
