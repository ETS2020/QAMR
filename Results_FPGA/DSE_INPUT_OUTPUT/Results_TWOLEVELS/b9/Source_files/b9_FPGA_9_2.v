...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n99_, new_n100_, new_n105_, new_n106_, new_n109_, new_n110_;
  ...
  assign z14 = (~new_n100_ & ~x27) | new_n96_ | ~new_n98_;
  ...
  assign new_n100_ = ~x04 & x39 & (~x40 | (~x13 & (x30 | x32)));
  ...
  assign new_n105_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x39));
  ...
  assign new_n110_ = ~x27 & ((x28 & (~x29 | ~x39)) | (~x08 & (~x39 | x40)));
  assign z08 = x39;
endmodule
