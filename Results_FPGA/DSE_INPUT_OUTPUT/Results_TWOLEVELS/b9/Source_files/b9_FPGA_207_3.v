...
module FAU ( 
  ...
  assign new_n88_ = (x27 | (x22 & x40)) & ~x28 & (x22 | (~x04 & x35));
  assign new_n89_ = (~x04 | ~x27) & ~x28 & (x22 | x35);
  assign new_n90_ = ~x40 & ((x04 & x27) | x28 | ~x35);
  assign z12 = new_n92_ | (x22 & x40) | (~new_n93_ & (~x40 | (~x22 & (x04 | ~x39))));
  assign new_n92_ = ~x10 & ((~x22 & ~x27) | (~x35 & ~x36 & ~x37));
  ...
  assign new_n97_ = ~x22 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n102_ = (x22 | (~new_n103_ & (new_n93_ | new_n101_))) & (new_n93_ | x40);
  ...
  assign new_n112_ = x40 & (x22 | (x29 & x39));
  assign new_n113_ = ~x08 & ((~x22 & (~x27 | ~x35)) | (~x27 & ~x40));
