...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n73_, new_n79_,
  ...
  assign z00 = (~x15 & (new_n65_ | (new_n67_ & x39 & x40))) | (~x16 & x40);
  assign new_n65_ = x27 & (new_n66_ | (x16 & (x37 | (x28 & x35))));
  assign new_n66_ = ~x04 & x39 & x40 & (x35 | x36);
  assign new_n67_ = ~x04 & x10;
  assign z01 = ~new_n69_ & (~x04 | (~x30 & ~x32 & (new_n70_ | ~x27)));
  assign new_n69_ = ~x16 & ~x40;
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = (~x02 & (~x08 | ~x29)) | ~z08 | new_n73_;
  assign z08 = x39 & x40;
  ...
  assign z11 = (~x16 & ~x40) | (~x09 & ~x30 & (~new_n86_ | (~new_n89_ & x16)));
  assign new_n86_ = (new_n87_ | (~x28 & (~x04 | ~x27))) & ~new_n88_ & (x08 | (~x04 & ~x28));
  assign new_n87_ = x29 & x39 & x40;
  assign new_n88_ = x40 & ((~x08 & (~x27 | ~x35)) | (~x35 & (~x29 | ~x39)));
  assign new_n89_ = (x08 | x27) & (x35 | x40);
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (x16 & ~new_n92_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n96_ | (new_n95_ & ~x04))) | new_n69_ | (new_n94_ & ~x04);
  assign new_n94_ = new_n84_ & ~x13;
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n98_ | new_n100_ | (~x40 & (~x16 | (x16 & ~x27))) | (~x27 & ~new_n103_ & x40);
  assign new_n98_ = ~x37 & ((~new_n99_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n99_ = (~x40 | (~x04 & x39)) & ~x13 & (~x16 | x40);
  assign new_n100_ = ~new_n101_ & (new_n102_ | ~z08 | x04 | x13);
  ...
  assign z18 = (~new_n108_ & x08) | ~new_n109_ | new_n69_ | x30;
  assign new_n108_ = ~new_n87_ & (x27 | x28 | ~x35);
  assign new_n109_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n111_ & ~x09;
  assign new_n111_ = ~x30 & (new_n113_ | (~new_n112_ & (~x35 | (~x27 & x28))));
  assign new_n112_ = x40 ? (x29 & x39) : ~x16;
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (x16 | x40)));
  assign z19 = (~x16 & ~x40) | (~x09 & ~x30 & (~new_n86_ | (~new_n89_ & x16)));
endmodule
