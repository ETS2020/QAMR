...
module FAU ( 
  ...
  assign z02 = (~x02 & (x29 ? ~x08 : ~x05)) | (~new_n73_ & (~x05 | x29));
  ...
  assign new_n87_ = (x27 | (x05 & ~x29)) & (~x29 | (~x04 & ~x28 & x35));
  assign new_n88_ = x29 ? (x39 & x40) : x05;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n69_ & (new_n91_ | ((~new_n68_ | x04) & (new_n66_ | ~x27)));
  ...
  assign z18 = (~new_n104_ & (~x05 | x29)) | (new_n68_ & x08 & x29);
  ...
  assign new_n109_ = ~x08 & ((~x27 & (~x05 | x29)) | (x29 & ~x35));
endmodule
