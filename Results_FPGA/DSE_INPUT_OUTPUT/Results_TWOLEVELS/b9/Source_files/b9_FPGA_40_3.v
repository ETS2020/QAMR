...
module FAU ( 
  ...
  assign new_n73_ = ~x09 & (~x04 | (~x28 & x35));
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (~x09 & ~x39))) | (x39 & x40 & x05 & ~x09));
  ...
  assign new_n102_ = ~x09 & (x09 | ~x13 | x27);
  assign new_n103_ = ~x09 & (x04 | ~x39 | (~x30 & ~x32));
  assign z15 = x12 & x26 & x27 & ~new_n68_ & x34;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n108_ | (x08 & (new_n88_ | (~x27 & ~x28 & x35)));
  assign new_n108_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = ~x09 & ~new_n87_ & ~x30;
  assign z20 = x09 ? x40 : new_n111_;
  assign new_n111_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n88_ & (~x35 | (~x27 & x28))));
  assign z05 = ~z06;
endmodule
