...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n77_,
    new_n78_, new_n82_, new_n83_, new_n84_, new_n87_, new_n88_, new_n89_,
  ...
  assign z10 = new_n84_ | (x27 & (new_n82_ | (x06 & ~new_n68_ & x37)));
  assign new_n82_ = ~x04 & ~new_n83_ & (x36 | (~x28 & x35));
  assign new_n83_ = (~x07 | (~x39 ^ x40)) & (~x05 | ~x39 | ~x40);
  ...
  assign z12 = new_n91_ | new_n92_ | (~x39 & (~x27 | ~x40)) | (~x27 & (~x40 | (x04 & x39)));
  assign new_n91_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x37 & (~x28 | ~x35) & (x04 | ~x39 | ~x40);
  assign z13 = ~new_n96_ | (x27 & (new_n94_ | (new_n95_ & ~x04)));
  ...
  assign new_n98_ = ~new_n99_ & x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ((~x04 & ~x13) | (~new_n66_ & (x27 | ~x39))) & (x39 | x40) & ((x39 & x40) | (~new_n66_ & x27));
