...
module FAU ( 
  ...
  assign new_n72_ = (~x04 | (new_n73_ & (x08 | x27))) & new_n66_ & (x25 | ~x27);
  assign new_n73_ = ~x28 & x35;
  assign z03 = ~new_n75_ | (~x21 & (x25 | ~x27));
  assign new_n75_ = (x37 | (x27 & (~x04 | ~x25 | x28))) & (~x25 | ~x27 | (x35 & (x28 | (~x37 & (x04 | ~x35)))));
  assign z04 = ~new_n75_ | (x21 & (x25 | ~x27));
  assign z05 = (x25 & x27 & (x28 | (~x28 & x37))) | (~x27 & x37);
  ...
  assign z10 = (~new_n85_ & ~x04) | (x27 & (~x25 | (x06 & x37)));
  ...
  assign new_n91_ = (new_n92_ | x37) & (x25 | ~x27) & (x27 | (new_n66_ & ~x04));
  assign new_n92_ = (~x04 | (x35 & (~x25 | x28))) & ((x28 & x35) | (x39 & x40));
  assign z13 = (new_n94_ & ~x04) | (x27 & ((new_n95_ & ~x04) | new_n96_ | ~x25));
  assign new_n94_ = new_n86_ & ~x13;
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n98_ | new_n103_ | ~new_n102_ | (~new_n101_ & ~x37);
  assign new_n98_ = (new_n99_ | ~new_n100_) & (x18 | x19 | ~x20);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = x39 & x40 & ~x13 & (~x04 | ~x25);
  assign new_n101_ = (~x04 | (x35 & (~x25 | x28))) & ((new_n66_ & ~x13) | (x28 & x35));
  assign new_n102_ = x27 ? x25 : (new_n66_ & ~x04 & ~x13);
  ...
  assign new_n109_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & x25 & x27));
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = (x08 | (x27 & (~x25 | x35))) & (new_n89_ | ((x27 | (~x28 & x35)) & (~x25 | x35)));
