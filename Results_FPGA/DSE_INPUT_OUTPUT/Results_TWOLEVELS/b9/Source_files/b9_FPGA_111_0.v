// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:21 2020
...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x40) | (x04 & ~x08 & ~x27) | ~x39 | ~x40;
  assign new_n72_ = (x02 | (x08 & x29)) & (new_n70_ | ~x04);
  ...
  assign z08 = new_n65_ | new_n81_;
  assign new_n81_ = x39 & x40;
  assign z09 = new_n65_ | (x11 & x26 & x27 & x34);
  assign z10 = new_n86_ | (x27 & (new_n84_ | (x06 & ~new_n65_ & x37)));
  assign new_n84_ = ~x04 & ~new_n85_ & (new_n70_ | x36);
  assign new_n85_ = (~x07 | (x40 ? x39 : ~x24)) & (~x05 | ~x39 | ~x40);
  assign new_n86_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n65_ | (~x09 & ~x30 & (new_n88_ | new_n89_));
  assign new_n88_ = (~new_n81_ | ~x29) & (~new_n70_ | (x04 & x27));
  assign new_n89_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = (x40 & (new_n91_ | (~new_n66_ & (x04 | ~x39)))) | (x24 & ~new_n66_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n97_ | (~new_n93_ & x27);
  assign new_n93_ = (x18 | ~new_n96_ | x19) & (~x40 | (~new_n94_ & (x18 | ~new_n95_ | x19)));
  assign new_n94_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n95_ = x20 & (x37 | (x28 & x35));
  assign new_n96_ = x20 & x24 & (x37 | (x28 & x35));
  assign new_n97_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n99_ | ~new_n103_ | (~new_n101_ & (x18 | x19 | ~x20));
  assign new_n99_ = ~x37 & ((~new_n100_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n100_ = (~x40 | (~x04 & x39)) & ~x13 & (~x24 | x40);
  assign new_n101_ = ~new_n102_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = (x40 | (x24 & (~x24 | x27))) & (x27 | ((new_n104_ | ~x40) & (x30 | x32)));
  ...
  assign z18 = ~new_n109_ | (x08 & ((new_n70_ & ~x27) | (new_n81_ & x29)));
  assign new_n109_ = ~new_n65_ & ~x30 & ~x09 & (~new_n70_ | x04 | ~x27);
  assign z20 = new_n65_ | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = (x08 | (x27 & x35)) & ((new_n81_ & x29) | (x35 & (x27 | ~x28)));
  assign z19 = new_n65_ | (~x09 & ~x30 & (new_n88_ | new_n89_));
endmodule
