...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : x14;
  ...
  assign z07 = (~x14 & ~x40) | (x03 & ((new_n79_ & ~x31) | (~new_n80_ & ~x14)));
  ...
  assign new_n87_ = (~x04 | ((new_n88_ | ~x27) & (x08 | ~x40))) & ~new_n89_ & (x08 | x27);
  assign new_n88_ = x29 & x39 & x40;
  assign new_n89_ = (x28 | ~x35) & (~x39 | ~x40 | (x40 & (~x08 | ~x29)));
  assign z12 = new_n91_ | (~x14 & ~x40) | (~new_n92_ & (x40 ? (x04 | ~x39) : x14));
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x14;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n92_ | new_n99_))) & (~x14 | new_n92_ | x40);
  ...
  assign z18 = (~new_n106_ & ~new_n69_) | (new_n68_ & x08 & x29);
  assign new_n106_ = ~new_n107_ & ~x09 & ~x30;
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (new_n109_ & ~x09);
  assign new_n109_ = ~x30 & (~new_n110_ | (~x08 & (~x27 | (~x35 & x40))));
  assign new_n110_ = (x29 | ((x27 | ~x28) & (x35 | ~x40))) & ((x39 & x40) | (x35 & (x27 | ~x28)));
