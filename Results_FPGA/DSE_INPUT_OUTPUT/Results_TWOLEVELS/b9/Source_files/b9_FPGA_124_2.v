...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n72_, new_n77_,
    ...
    new_n99_, new_n100_, new_n105_, new_n107_, new_n108_;
  ...
  assign new_n83_ = ~x04 & x05 & x39 & ~new_n84_ & x40;
  ...
  assign z12 = (~x10 & (new_n89_ | (~x27 & x39))) | ~new_n90_ | (~x27 & (~x39 | (x04 & x39)));
  assign new_n89_ = ~x35 & ~x36 & ~x37;
  assign new_n90_ = (~x39 | x40) & (x37 | (x28 & x35) | (~x04 & x39));
  assign z13 = new_n92_ | (x27 & (new_n93_ | new_n94_));
  assign new_n92_ = x39 & (~x40 | (~x04 & ~new_n84_ & ~x13));
  ...
  assign new_n98_ = ~new_n99_ & x39 & (~x39 | (~x04 & ~x13));
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = (~x39 | x40) & (x27 | (~new_n84_ & x39 & (~x39 | (~x04 & ~x13))));
  assign z15 = new_n68_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n68_ & ~x24;
  assign z18 = ~new_n105_ | (x08 & ((x29 & x39) | (new_n72_ & ~x27)));
  assign new_n105_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n68_ & ~x30;
