...
module FAU ( 
  ...
  assign z08 = x40 & (~x39 | (x39 & (~new_n80_ | (~x09 & ~new_n82_ & ~x30))));
  ...
  assign new_n85_ = ~x04 & ~new_n69_ & ((x05 & x39 & x40) | (x07 & ~x40));
  assign new_n86_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n90_ & ~x08));
  assign new_n88_ = ~new_n89_ & (~x40 | (~x29 & x39 & x40));
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n90_ = (x27 | (x40 & (~x39 | ~x40))) & (~x39 | ~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x39 & (new_n93_ | (x04 & (new_n92_ | ~x27)))) | (~x40 & (new_n92_ | ~x27));
  assign new_n92_ = ~x37 & (~x28 | ~x35);
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n98_ | (x27 & (new_n95_ | (new_n97_ & ~x18)));
  assign new_n95_ = x39 & (new_n96_ | (~x18 & ~x19 & ~new_n92_ & x20));
  assign new_n96_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x19 & x20 & ~new_n92_ & ~x40;
  assign new_n98_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n100_ | ~new_n103_ | (~new_n101_ & (x18 | x19 | ~x20));
  assign new_n100_ = (new_n92_ | ~x27) & (x13 | ~x40 | (x04 & x39));
  assign new_n101_ = ~new_n102_ & ~x04 & ~x13 & x40;
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = (x39 | ~x40) & (x30 | x32 | (~new_n104_ & (x27 | ~x39)));
  assign new_n104_ = x28 & ~x35 & ~x37;
