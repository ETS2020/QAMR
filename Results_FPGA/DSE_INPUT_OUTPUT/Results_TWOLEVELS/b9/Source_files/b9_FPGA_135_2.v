...
module FAU ( 
  ...
  assign z08 = new_n65_ | new_n79_;
  assign new_n79_ = x39 & x40;
  assign z09 = x11 & x26 & x27 & ~new_n65_ & x34;
  assign z10 = (~new_n82_ & ~x04) | new_n65_ | (x06 & x27 & x37);
  assign new_n82_ = (~x27 | new_n69_ | (new_n79_ ? ~x05 : ~x07)) & (~new_n83_ | ~x05);
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = new_n65_ | (~x09 & ~new_n85_ & ~x30);
  assign new_n85_ = ~new_n87_ & (new_n86_ | (new_n79_ & x29));
  assign new_n86_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n87_ = ~x08 & (x04 | ~x27 | ~x35 | (x28 & x40));
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (~x22 & ~new_n66_ & ~x40);
  ...
  assign z14 = new_n95_ | new_n97_ | (~x40 & (x22 | (~x22 & ~x27))) | (~x27 & ~new_n100_ & x40);
  assign new_n95_ = ~x37 & ((~new_n96_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n96_ = (~x40 | (~x04 & x39)) & ~x13 & (x22 | x40);
  assign new_n97_ = ~new_n98_ & (new_n99_ | ~new_n79_ | x04 | x13);
  ...
  assign z16 = x22 & (~x40 | (x01 & ~x23));
  assign z17 = x22 & (~x40 | (x01 & x23 & ~x24));
  assign z18 = (~new_n105_ & ~new_n65_) | (new_n79_ & x08 & x29);
  assign new_n105_ = ~new_n106_ & ~x09 & ~x30;
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n65_ | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & ((new_n79_ & x29) | (x35 & (x27 | ~x28)));
  assign z06 = ~z05;
  assign z19 = new_n65_ | (~x09 & ~new_n85_ & ~x30);
endmodule
