...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n71_ | ~z08;
  ...
  assign z10 = new_n83_ | (x27 & (new_n81_ | (x06 & ~new_n65_ & x37)));
  assign new_n81_ = ~x04 & ~new_n82_ & (x36 | (~x28 & x35));
  ...
  assign new_n86_ = (x27 | (~x07 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n87_ = x40 ? (x29 & x39) : ~x07;
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n90_ | (~x07 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x07));
  ...
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : ~x07;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (~x40 | (~new_n100_ & (new_n66_ | new_n98_))) & (~x07 | new_n66_ | x40);
  ...
  assign z18 = (new_n106_ & ~x28) | new_n105_ | (~new_n65_ & (x09 | x30));
  assign new_n105_ = z08 & x08 & x29;
  assign new_n106_ = x35 & ((~x04 & x27 & (x40 | (x07 & ~x40))) | (x08 & ~x27 & (x07 | x40)));
  assign z20 = (~x07 & ~x40) | (~x09 & ~x30 & (~new_n108_ | (~new_n110_ & x07)));
