...
module FAU ( 
  ...
  assign z06 = ~x37 & ((~x05 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign new_n86_ = (x27 | (x05 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n87_ = x40 ? (x29 & x39) : x05;
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n90_ | (x05 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : ~x05));
  ...
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : x05;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (~x40 | (~new_n100_ & (new_n66_ | new_n98_))) & (x05 | new_n66_ | x40);
  ...
  assign new_n109_ = ~x08 & ((~x35 & x40) | (~x27 & (~x05 | x40)));
endmodule
