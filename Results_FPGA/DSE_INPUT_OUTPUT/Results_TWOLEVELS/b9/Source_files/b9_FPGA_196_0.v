...
module FAU ( 
  ...
  assign new_n86_ = ~new_n87_ & (x40 ? (~x29 | ~x39) : x23);
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (~x23 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n90_ | (~x23 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x23));
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x23;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n66_ | new_n99_))) & (~x23 | new_n66_ | x40);
  ...
  assign z20 = (~x23 & ~x40) | (~x09 & ~x30 & (~new_n109_ | (~new_n111_ & x23)));
