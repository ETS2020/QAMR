...
module FAU ( 
  ...
  assign new_n83_ = (~x27 | new_n69_ | (new_n84_ ? ~x05 : ~x07)) & (~new_n85_ | ~x05);
  ...
  assign new_n88_ = (x39 ? (~x29 | ~x40) : x40) & (~new_n72_ | (x04 & x27));
  assign z12 = x39 ? (new_n90_ | (~new_n66_ & (x04 | ~x40))) : (~new_n66_ & x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & x27) | (~x04 & new_n85_ & ~x13);
  ...
  assign new_n97_ = ~new_n98_ & new_n84_ & ~x04 & ~x13;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~new_n100_ & new_n102_ & (~new_n101_ | x37);
  ...
  assign z18 = ~new_n107_ | (x08 & ((new_n72_ & ~x27) | (new_n84_ & x29)));
  assign new_n107_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n65_ & ~x30;
  assign z20 = new_n65_ | (~x09 & ~x30 & (new_n109_ | ~new_n110_));
  assign new_n109_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n110_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((~x28 | x39) & (x08 | (~x39 & ~x40))));
