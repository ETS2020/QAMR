// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:57 2020
...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n71_ | ~x39 | (x39 & ~x40);
  ...
  assign z10 = (~new_n80_ & ~x04) | new_n67_ | (x06 & x27 & x37);
  assign new_n80_ = (~new_n81_ | ~x27) & (~x05 | ~x39 | (~x30 & ~x32));
  assign new_n81_ = (x36 | (~x28 & x35)) & (x39 ? x05 : x07);
  assign z11 = z19 | new_n67_;
  assign z19 = ~x09 & ~x30 & ((~new_n86_ & ~x08) | (~new_n84_ & ~new_n85_));
  assign new_n84_ = x39 & (x29 | ~x40);
  ...
  assign z18 = new_n104_ | ~new_n105_ | new_n67_ | x30;
