...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n74_,
    ...
    new_n111_, new_n112_;
  assign z00 = (~new_n67_ & ~x16) | (~new_n65_ & ~x15);
  ...
  assign new_n71_ = ~new_n72_ & x39 & x40 & (x37 | ~x40);
  assign new_n72_ = x04 & ((~x08 & ~x27) | ~x35 | (x28 & x37));
  assign z03 = (~x21 & (x37 | ~x40)) | (~new_n74_ & (x37 ? x27 : ~x40)) | (~x27 & ~x37 & ~x40);
  assign new_n74_ = x28 & x35;
  assign z04 = (~new_n74_ & (x37 ? x27 : ~x40)) | x21 | (~x37 & (x40 | (~x27 & ~x40)));
  ...
  assign new_n84_ = (~new_n86_ | ~x05) & (~x27 | new_n69_ | (new_n85_ ? ~x05 : ~x07));
  ...
  assign new_n89_ = (x27 | (~x37 & x40)) & ~x04 & ~x28 & (x35 | ~x37);
  assign new_n90_ = (~x04 | ~x27) & ~x28 & (x35 | ~x37);
  assign new_n91_ = ~x40 & ((x04 & x27) | x28 | ~x35);
  assign z12 = (~x40 & (~x27 | (~new_n74_ & ~x37))) | (~x27 & ~new_n93_ & x37);
  assign new_n93_ = ~x04 & x10 & x39;
  assign z13 = (x27 & (new_n95_ | (new_n96_ & ~x04))) | (~new_n97_ & x40);
  assign new_n95_ = ~x18 & ~x19 & x20 & (new_n74_ | x37);
  assign new_n96_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = x37 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n101_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = ~new_n100_ & new_n85_ & ~x04 & ~x13;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = (x27 | (~x13 & x40 & (new_n102_ | ~x37))) & (x37 | (~x40 & (new_n74_ | x40)));
  assign new_n102_ = ~x04 & x39 & (x30 | x32);
  ...
  assign new_n107_ = (~new_n85_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n108_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n110_ & ~x09;
  assign new_n110_ = ~x30 & (new_n112_ | (~new_n111_ & (~x35 | (~x27 & x28))));
  assign new_n111_ = x40 & (~x37 | (x29 & x39));
  assign new_n112_ = ~x08 & ((~x27 & (x37 | ~x40)) | (~x35 & x37));
