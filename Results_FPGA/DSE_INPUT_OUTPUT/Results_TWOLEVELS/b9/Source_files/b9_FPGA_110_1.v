...
module FAU ( 
  ...
  assign z02 = ~new_n71_ | new_n73_ | (~x02 & x39 & (~x08 | ~x29));
  assign new_n71_ = (new_n72_ | ~x04) & (x39 | ~x40) & (x40 | (x04 & ~x09 & ~x30));
  assign new_n72_ = ~x28 & x35 & (x09 | ~x27 | x30 | x40);
  ...
  assign new_n102_ = (x35 | x37) & ((~x18 & ~x19 & x20) | (x35 & x36));
  ...
  assign new_n110_ = ~new_n111_ & (x35 | (x40 & (~x39 | (x08 & x29))));
  assign new_n111_ = ~x27 & ((~x08 & (x39 | ~x40)) | (x28 & (~x29 | ~x40)));
endmodule
