...
module FAU ( 
  ...
  assign z12 = new_n95_ | (~x33 & x40) | ((new_n66_ | ~x27) & (~x40 | (~new_n96_ & x33)));
  ...
  assign new_n106_ = (~x33 | (~new_n107_ & (new_n105_ | (~new_n66_ & x27)))) & (x40 | (~new_n66_ & x27));
  ...
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n115_ | ~new_n116_));
  assign new_n115_ = (~x29 | ~x39) & ((~x27 & x28) | (x33 & ~x35));
  assign new_n116_ = (x08 | ((x27 | (~x33 & x40)) & (~x33 | x35))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
