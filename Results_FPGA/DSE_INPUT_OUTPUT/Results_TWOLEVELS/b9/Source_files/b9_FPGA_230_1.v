...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
    ...
    new_n104_, new_n105_, new_n108_, new_n109_;
  ...
  assign new_n87_ = (x27 | (~x05 & x29)) & (~x05 | (~x04 & ~x28 & x35));
  assign new_n88_ = x29 & (~x05 | (x39 & x40));
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n69_ & (new_n91_ | ((new_n66_ | ~x27) & (~new_n68_ | x04)));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = ~new_n69_ & ((~new_n93_ & x27) | (~x04 & new_n85_ & ~x13));
  assign new_n93_ = (~new_n94_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ~new_n69_ & (~new_n98_ | (~new_n96_ & (x18 | x19 | ~x20)));
  assign new_n96_ = ~new_n97_ & new_n68_ & ~x04 & ~x13;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~new_n99_ & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
