...
module FAU ( 
  ...
  assign z11 = ~x09 & ~x30 & ((~new_n86_ & ~x08) | (~new_n87_ & ~new_n88_));
  ...
  assign new_n96_ = ~new_n97_ & x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~new_n99_ & new_n101_ & (~new_n100_ | x37);
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n100_ = (~x28 | ~x35) & ((x39 & (x04 | ~x40)) | x13 | (~x39 & x40));
  assign new_n101_ = (x39 | (x40 & (x27 | ~x40))) & (x27 | ~x39 | (~x04 & ~x13 & x40));
  ...
  assign new_n110_ = (~x29 | ~x40) & ((~x35 & x39) | (~x27 & x28));
  assign new_n111_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((~x28 | x39) & (x08 | (~x39 & ~x40))));
endmodule
