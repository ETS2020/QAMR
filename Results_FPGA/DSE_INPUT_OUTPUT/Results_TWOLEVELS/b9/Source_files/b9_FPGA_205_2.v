...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x26;
  ...
  assign new_n83_ = ~new_n71_ & ((x07 & (x40 ? ~x39 : ~x26)) | (x05 & x39 & x40));
  ...
  assign z12 = new_n92_ | new_n69_ | (~new_n93_ & (~z08 | x04));
  ...
  assign new_n98_ = ~new_n99_ & z08 & ~x04 & ~x13;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~new_n101_ & ~new_n69_ & (new_n93_ | (z08 & ~x04 & ~x13));
