...
module FAU ( 
  ...
  assign new_n82_ = ~x04 & x05 & x39 & ~new_n83_ & x40;
  ...
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & x04))) | (~new_n66_ & ~x39);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n92_ | (x27 & (new_n93_ | new_n94_));
  assign new_n92_ = x39 & (~x40 | (~x04 & ~new_n83_ & ~x13));
  ...
  assign new_n100_ = (~x39 | x40) & (x27 | (~new_n83_ & x39 & (~x40 | (~x04 & ~x13))));
