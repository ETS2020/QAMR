...
module FAU ( 
  ...
  assign new_n85_ = ~new_n87_ & (~x27 | new_n86_ | (~x36 & (x28 | ~x35)));
  ...
  assign new_n90_ = (x27 | (~x00 & x40)) & (~x00 | (~x28 & x35 & (~x04 | ~x40)));
  assign new_n91_ = x40 & (~x00 | (x29 & x39));
  assign new_n92_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x00 & (~new_n94_ | new_n95_)) | (~x40 & (new_n66_ | ~x27));
  ...
  assign new_n99_ = x00 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n103_ | (~new_n101_ & (x18 | x19 | ~x20));
  assign new_n101_ = ~new_n102_ & x39 & x40 & ~x04 & ~x13;
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = ~new_n104_ & new_n106_ & (x37 | new_n75_ | new_n105_);
  assign new_n104_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n105_ = ~x13 & x40 & (~x00 | (~x04 & x39));
  assign new_n106_ = (x00 | ~x40) & (x27 | ((~x00 | (x39 & (~x04 | ~x40))) & x40 & (~x13 | ~x40)));
  assign z15 = new_n68_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n68_ & ~x24;
  assign z18 = (~new_n111_ & (x00 | ~x40)) | (x00 & x08 & x29 & x39 & x40);
  assign new_n111_ = ~new_n112_ & ~x09 & ~x30;
  assign new_n112_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n114_ | ~new_n115_));
  assign new_n114_ = (~x29 | ~x39) & ((x00 & ~x35) | (~x27 & x28));
  assign new_n115_ = (x08 | ((~x00 | (x27 & x35)) & (x27 | x40))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
