...
module FAU ( 
  ...
  assign z12 = (~x25 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~new_n92_ & ~x40);
  ...
  assign new_n96_ = ~x25 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n102_ = (x25 | (~x04 & x39)) & ~x13 & x40;
  assign new_n103_ = (~x25 | ~x40) & (x27 | (x40 & (x25 | (~x04 & ~x13 & x39))));
  assign z15 = new_n68_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n68_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n68_ & ~x24;
  assign z18 = (~new_n108_ & x08) | ~new_n109_ | new_n68_ | x09;
