...
module FAU ( 
  ...
  assign z12 = new_n93_ | (~x33 & ~x40) | ((new_n66_ | ~x27) & (x40 ? ~new_n94_ : x33));
  ...
  assign new_n104_ = (~x40 | (~new_n105_ & (new_n103_ | (~new_n66_ & x27)))) & (~x33 | x40 | (~new_n66_ & x27));
  ...
  assign new_n114_ = (~x33 | ((x08 | x27) & (x35 | x40))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
endmodule
