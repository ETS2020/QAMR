...
module FAU ( 
  ...
  assign new_n88_ = (x27 | (~x12 & x40)) & (~x12 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (~x12 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x12 & (new_n92_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  ...
  assign new_n96_ = x12 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n101_ | ((x18 | x19 | ~x20) & (new_n98_ | ~x40));
  assign new_n98_ = x12 & (new_n99_ | ~new_n100_);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (new_n68_ | x40) & (~x12 | (~new_n102_ & (new_n68_ | new_n100_)));
  ...
  assign z18 = (~new_n107_ & (x12 | ~x40)) | (x08 & x12 & x29 & x39 & x40);
  ...
  assign new_n111_ = ~x08 & ((x12 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
