...
module FAU ( 
  ...
  assign new_n82_ = (~x27 | new_n69_ | (x40 ? ~x05 : ~x07)) & (~x05 | new_n83_ | ~x40);
  ...
  assign z12 = new_n90_ | (~x39 & x40) | ((x04 | ~x40) & (new_n89_ | ~x27));
  assign new_n89_ = ~x37 & (~x28 | ~x35);
  assign new_n90_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n95_ | (x27 & (new_n92_ | (new_n94_ & ~x18)));
  assign new_n92_ = x39 & (new_n93_ | (~x18 & ~x19 & ~new_n89_ & x20));
  assign new_n93_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x19 & x20 & ~new_n89_ & ~x40;
  assign new_n95_ = ~x04 & ~x13 & x39 & ~new_n83_ & x40;
  assign z14 = new_n97_ | ~new_n99_ | (~new_n98_ & (x04 | x13 | ~x40));
  assign new_n97_ = ~x27 & (x04 | ~x40 | (x39 & (new_n83_ | x13)));
  assign new_n98_ = ~new_n89_ & ~x18 & ~x19 & x20;
  assign new_n99_ = ~new_n67_ & (~x28 | x30 | new_n100_ | x32);
  ...
  assign z18 = new_n105_ | ~new_n106_ | new_n67_ | x30;
