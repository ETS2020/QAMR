...
module FAU ( 
  ...
  assign new_n77_ = (~x40 | ((x31 | ~new_n78_ | x33) & (new_n79_ | x14))) & (x14 | new_n79_ | ~x33);
  assign new_n78_ = (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign new_n79_ = ~x00 & ~x25 & x38;
  assign z08 = x39 & x40;
  assign z09 = x11 & x26 & x27 & ~new_n65_ & x34;
  assign z10 = (x27 & (new_n83_ | (~x04 & ~new_n69_ & ~new_n84_))) | (new_n85_ & ~x04);
  assign new_n83_ = x06 & ~new_n65_ & x37;
  assign new_n84_ = (~x07 | (x40 ? x39 : ~x33)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & (x40 ? (~x29 | ~x39) : x33);
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n89_ = (x27 | (~x33 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n66_ & (x04 | ~x39)))) | (x33 & ~new_n66_ & ~x40);
  ...
  assign new_n100_ = (~x40 | (~x04 & x39)) & ~x13 & (~x33 | x40);
  assign new_n101_ = ~new_n102_ & z08 & ~x04 & ~x13;
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = (x40 | (x33 & (x27 | ~x33))) & (x27 | ((x30 | x32) & (new_n104_ | ~x40)));
  ...
  assign new_n112_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & x40));
  assign new_n113_ = (~x33 | ((x08 | x27) & (x35 | x40))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
