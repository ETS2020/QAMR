...
module FAU ( 
  ...
  assign z10 = new_n83_ | (~x04 & (new_n81_ | new_n82_));
  assign new_n81_ = x05 & ~x27 & x39 & x40 & (x30 | x32);
  ...
  assign z13 = (~new_n89_ & x40) | (new_n90_ & ~x18);
  assign new_n89_ = ~x27 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign new_n90_ = ~x19 & x20 & x27 & (x37 | (x28 & x35));
  ...
  assign z20 = ~x09 & ~x30 & ((~new_n101_ & ~x27) | (~x35 & ~x40));
  assign new_n101_ = ((x29 & x39) | (~x28 & x35)) & x08 & (~x28 | x40);
