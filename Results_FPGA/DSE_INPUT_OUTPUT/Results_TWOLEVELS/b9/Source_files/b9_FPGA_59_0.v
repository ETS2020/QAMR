...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n79_,
  ...
  assign z07 = new_n65_ | (~new_n79_ & x03);
  ...
  assign new_n83_ = (~x27 | new_n69_ | (z08 ? ~x05 : ~x07)) & (~new_n84_ | ~x05);
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = new_n65_ | (~x09 & ~x30 & (~new_n86_ | (~new_n87_ & ~x08)));
  assign new_n86_ = (~x40 | ((~x04 | ~x27 | (x29 & x39)) & (new_n72_ | x39))) & (~x39 | ((new_n72_ | (x29 & x40)) & (~x04 | ~x27 | x40)));
  assign new_n87_ = (x27 | (~x39 & ~x40)) & (~x40 | (~x04 & x35)) & (~x28 | ~x39);
  assign z12 = new_n89_ | new_n90_ | (~new_n66_ & (x04 | ~x39));
  assign new_n89_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n90_ = ~x40 & ((~x37 & (~x35 | (~x28 & x39))) | ~x27 | ~x39);
  assign z13 = ~new_n92_ | (x27 & (new_n94_ | (new_n93_ & ~x04)));
  assign new_n92_ = ~new_n65_ & (x04 | ~new_n84_ | x13);
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = (~new_n101_ & ~x27) | new_n96_ | new_n65_ | (~new_n99_ & ~x37);
  assign new_n96_ = (new_n97_ | ~new_n98_) & (x18 | x19 | ~x20);
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39 & x40;
  assign new_n99_ = new_n100_ & ((x28 & x35) | (~x04 & ~x13 & x39));
  assign new_n100_ = (x35 | (x40 & (~x28 | x30 | x32))) & (x28 | ~x39 | x40);
  assign new_n101_ = (~x40 | (~x13 & (x30 | x32))) & ~x04 & x39 & x40;
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = new_n65_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n106_ & (x39 | x40)) | (x08 & x29 & x39 & x40);
  ...
  assign new_n111_ = (~x40 | ((x35 | x39) & (x08 | (x27 & x35)))) & (x27 | (x39 ? x08 : ~x28));
endmodule
