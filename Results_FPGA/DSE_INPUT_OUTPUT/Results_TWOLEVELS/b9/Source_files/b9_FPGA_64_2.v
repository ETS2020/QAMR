...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x34;
  ...
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n71_ | (new_n68_ ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~new_n89_) | (~new_n87_ & ~x08));
  assign new_n87_ = (x27 | (x34 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : x34;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n91_ | new_n93_;
  assign new_n91_ = ~new_n92_ & (x40 | (x27 & ~x34)) & (x27 | (x39 & (~x04 | ~x40)));
  ...
  assign new_n97_ = ~x19 & x20 & ~new_n66_ & ~x34;
  assign new_n98_ = ~x04 & new_n85_ & ~x13;
  assign z14 = (~new_n100_ & (x18 | x19 | ~x20)) | ~new_n103_ | new_n104_;
  assign new_n100_ = ~new_n101_ & (new_n102_ | ~x40) & x39 & x40;
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13;
  assign new_n103_ = (new_n102_ | (~new_n66_ & (x27 | ~x40))) & (~x34 | x40) & ((~new_n66_ & x27) | (x39 & x40));
  ...
  assign z18 = (~new_n109_ & ~new_n69_) | (new_n68_ & x08 & x29);
  assign new_n109_ = ~new_n110_ & ~x09 & ~x30;
  assign new_n110_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = z11 | new_n69_;
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n113_ | ~new_n114_));
  assign new_n113_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & x40));
  assign new_n114_ = (x34 | ((x35 | x40) & (x08 | x27))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
endmodule
