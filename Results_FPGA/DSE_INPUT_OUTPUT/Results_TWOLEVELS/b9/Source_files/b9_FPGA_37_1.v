...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x40 | (x39 & x40))) | (~x30 & ~x32 & ~new_n69_ & (x39 | ~x40));
  assign new_n69_ = x27 & ((~x28 & x35) | x36);
  assign z02 = ~x40 | (x39 & (new_n71_ | (~x02 & (~x08 | ~x29))));
  assign new_n71_ = x04 & ((~x08 & ~x27) | ~x35 | (x28 & x40));
  assign z03 = new_n67_ | ~x21 | (~new_n67_ & (x27 ? (~x28 | ~x35) : ~x37));
  assign z04 = ~new_n67_ & ((x27 & (~x28 | ~x35)) | x21 | (~x27 & ~x37));
  assign z05 = (x27 & x28 & (x39 | ~x40)) | (x37 & (~x40 | (x39 & x40)));
  ...
  assign z08 = x40 & (~x39 | (x39 & ((x04 & (x28 | (~x28 & ~x37))) | ~x04 | x37)));
  ...
  assign new_n83_ = (~x05 | ~x39 | ~x40) & (~x07 | x40);
  ...
  assign new_n91_ = (new_n92_ | (x40 & (~x04 | ~x39))) & (x39 | ~x40) & (x28 | x37 | (x40 & (~x04 | ~x39 | ~x40)));
  assign new_n92_ = x27 & (x35 | x37);
  assign z13 = (x27 & (new_n94_ | new_n95_)) | (x40 & (new_n96_ | ~x39));
  assign new_n94_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & (x30 | x32);
  assign z14 = new_n102_ | (x39 & (new_n98_ | new_n100_ | (~new_n96_ & ~x27)));
  assign new_n98_ = ~x37 & (~new_n99_ | (x04 & (~x35 | (~x28 & x40))));
  assign new_n99_ = (~x13 | (x28 & x35)) & (x32 | x35 | ~x28 | x30);
  assign new_n100_ = (x18 | x19 | ~x20) & (new_n101_ | x04 | x13);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x40 & (~new_n103_ | (~x37 & (~x28 | ~x35)));
  assign new_n103_ = x20 & x27 & ~x18 & ~x19;
  ...
  assign new_n108_ = x08 & ((x29 & x40) | (~x27 & ~x28 & x35));
  assign new_n109_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n67_ | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = ~new_n112_ & (x35 | (x40 & (~x39 | (x08 & x29))));
  assign new_n112_ = ~x27 & ((~x08 & (x39 | ~x40)) | (x28 & (~x29 | ~x40)));
endmodule
