...
module FAU ( 
  ...
  assign new_n103_ = x40 & (~x34 | (x13 & ~x27));
  ...
  assign new_n108_ = x08 & x29 & new_n68_ & x34;
  assign new_n109_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = z11 | new_n69_;
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n112_ | ~new_n113_));
  assign new_n112_ = (~x29 | ~x39) & ((~x27 & x28) | (x34 & ~x35));
  assign new_n113_ = (x08 | ((x27 | (~x34 & x40)) & (~x34 | x35))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
