// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:49 2020
...
module FAU ( 
  ...
  assign new_n73_ = (x40 | (x04 & ~x37 & (x28 | x37))) & x39 & (~x34 | ~x40);
  ...
  assign new_n84_ = ~new_n70_ & ((x07 & (~x40 | (~x34 & ~x39))) | (x39 & x40 & x05 & ~x34));
  assign new_n85_ = x06 & ~new_n68_ & x37;
  assign new_n86_ = ~x34 & x39 & x40 & (x30 | x32);
  assign z11 = new_n68_ | (~x09 & ~new_n88_ & ~x30);
  assign new_n88_ = (new_n89_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = (~x34 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x40 & (new_n66_ | ~x27));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x04 & x39;
  assign z13 = (~new_n94_ & x27) | (~x04 & new_n86_ & ~x13);
  assign new_n94_ = (x34 | ((~new_n95_ | x04) & (~new_n96_ | x18))) & (~new_n97_ | x18);
  ...
  assign new_n101_ = (~new_n102_ | x30) & ~new_n68_ & (new_n103_ | (~new_n66_ & x27));
  assign new_n102_ = ~x32 & ((~x27 & ~x34) | (x28 & ~x35 & ~x37));
  assign new_n103_ = (x34 | (~x04 & x39)) & ~x13 & x40;
  assign z15 = ~x40 & x34 & x27 & x12 & x26;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n108_ & x08) | ~new_n109_ | new_n68_ | x30;
  assign new_n108_ = ~new_n89_ & (x27 | x28 | ~x35);
  assign new_n109_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n68_ | (new_n111_ & ~x09);
  assign new_n111_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n89_ & (~x35 | (~x27 & x28))));
  assign z19 = new_n68_ | (~x09 & ~new_n88_ & ~x30);
endmodule
