...
module FAU ( 
  ...
  assign new_n72_ = x40 & ~new_n73_ & x39 & (x33 | ~x40);
  assign new_n73_ = x04 & ((~x08 & ~x27) | x28 | (x33 & ~x35));
  ...
  assign new_n102_ = (x33 | ~x40) & (new_n94_ | (~x13 & x40 & (~x33 | (~x04 & x39))));
  ...
  assign new_n112_ = (~x29 | ~x39) & ((~x27 & x28) | (x33 & ~x35));
  assign new_n113_ = (x08 | ((x27 | (~x33 & x40)) & (~x33 | x35))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
