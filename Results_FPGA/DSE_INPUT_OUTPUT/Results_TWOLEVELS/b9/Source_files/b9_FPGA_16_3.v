...
module FAU ( 
  ...
  assign z03 = (~z08 & ((x27 & (~x35 | (~x28 & x37))) | (~x37 & (~x27 | ~x28)))) | z08 | ~x21;
  assign z04 = ~z08 & ((x27 & (~x35 | (~x28 & x37))) | x21 | (~x37 & (~x27 | ~x28)));
  assign z05 = (x27 & (x28 | (~x28 & ~z08 & x37))) | z08 | (~x27 & x37);
  ...
  assign z12 = new_n82_ | z08 | (~x27 & x37);
  assign new_n82_ = ~x37 & (~x35 | ((~x27 | ~x28) & (~x39 | ~x40)));
  assign z13 = z08 | (~x18 & ~x19 & new_n66_ & x20);
