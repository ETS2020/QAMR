...
module FAU ( 
  ...
  assign z02 = ~x40 | (x27 & (new_n71_ | ~x39 | (~new_n70_ & x04)));
  ...
  assign new_n82_ = (new_n68_ | ((x39 & x40) ? ~x05 : ~x07)) & (~x05 | ~x39 | new_n83_ | ~x40);
  assign new_n83_ = ~x30 & ~x32;
  assign z11 = ~x09 & ~new_n85_ & ~x30;
  assign new_n85_ = (~x27 | (((new_n70_ & ~x04) | (new_n86_ & x08)) & (~x04 | x40))) & (x40 | (new_n70_ & (x08 | x27)));
  assign new_n86_ = x29 & x39;
  assign z12 = (~new_n88_ & ~x37) | (~x27 & ~x40);
  assign new_n88_ = (new_n89_ | (x28 & x35)) & (x35 | x36 | x10 | ~x27);
  assign new_n89_ = x40 & (~x27 | (~x04 & x39));
  assign z13 = (new_n91_ & ~x18) | (x40 & (new_n92_ | ~x27));
  assign new_n91_ = ~x19 & x20 & ~new_n65_ & x27;
  assign new_n92_ = ~x04 & ~x13 & x39 & (~new_n93_ | ~x28 | x30);
  assign new_n93_ = ~x32 & (~x35 | ~x36);
  assign z14 = ~x27 | new_n97_ | (~new_n95_ & (x18 | x19 | ~x20));
  assign new_n95_ = (~x28 | ~new_n93_ | x30) & new_n96_ & ~x04 & ~x13;
  assign new_n96_ = x39 & x40;
  assign new_n97_ = ~x37 & ((~new_n98_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n98_ = (~x27 | (~x04 & x39)) & ~x13 & x40;
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = (~x27 & x40) | (x01 & x22 & ~x23);
  assign z17 = (~x27 & x40) | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n103_ | (x08 & ((new_n70_ & ~x27) | (new_n96_ & x29)));
  assign new_n103_ = ~x09 & (x27 | ~x40) & ~x30 & (~new_n70_ | x04 | ~x27);
  assign z20 = ~x09 & ~new_n105_ & ~x30;
  assign new_n105_ = (x08 | (x27 ? x35 : x40)) & (x35 | (x40 & (new_n86_ | ~x27))) & (x27 | ~x28 | x40);
