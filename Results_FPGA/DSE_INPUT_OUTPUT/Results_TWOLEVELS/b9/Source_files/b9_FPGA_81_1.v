...
module FAU ( 
  ...
  assign new_n67_ = ~x04 & ~x15 & new_n68_ & x33;
  ...
  assign new_n85_ = ~new_n71_ & ((x07 & (~x40 | (x33 & ~x39))) | (x05 & x33 & x39 & x40));
  ...
  assign z12 = (x33 & (new_n93_ | (~new_n65_ & (x04 | ~x39)))) | (~new_n65_ & ~x40);
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n95_ & x27) | (~x04 & new_n87_ & ~x13);
  assign new_n95_ = (~x33 | ((~new_n96_ | x04) & (~new_n97_ | x18))) & (~new_n98_ | x18);
  ...
  assign new_n102_ = (~new_n103_ | x30) & new_n105_ & (new_n66_ | new_n104_ | x37);
  assign new_n103_ = ~x32 & ((~x27 & x33) | (x28 & ~x35 & ~x37));
