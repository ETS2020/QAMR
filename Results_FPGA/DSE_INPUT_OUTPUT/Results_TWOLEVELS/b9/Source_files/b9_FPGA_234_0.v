...
module FAU ( 
  ...
  assign z12 = new_n90_ | new_n65_ | (~new_n66_ & (~new_n80_ | x04));
  ...
  assign new_n99_ = ~new_n65_ & (new_n66_ | new_n98_) & (~new_n100_ | x30);
  assign new_n100_ = ~x32 & ((x28 & ~x35 & ~x37) | (~x27 & x40));
  assign z15 = (~x34 & ~x40) | (x12 & x26 & x27 & x34);
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = (~new_n105_ & ~new_n65_) | (new_n80_ & x08 & x29);
  ...
  assign new_n109_ = ~x08 & ((~x35 & x40) | (~x27 & (x34 | x40)));
