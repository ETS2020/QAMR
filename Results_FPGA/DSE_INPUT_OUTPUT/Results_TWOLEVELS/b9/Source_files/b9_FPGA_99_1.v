...
module FAU ( 
  ...
  assign new_n83_ = (x04 | new_n70_ | new_n84_) & (~x06 | new_n68_ | ~x37);
  ...
  assign z12 = (x03 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~new_n92_ & ~x40);
  ...
  assign new_n96_ = x03 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n101_ | ((new_n98_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n98_ = x03 & (new_n99_ | ~new_n100_);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (new_n92_ | x40) & (~x03 | (~new_n102_ & (new_n92_ | new_n100_)));
