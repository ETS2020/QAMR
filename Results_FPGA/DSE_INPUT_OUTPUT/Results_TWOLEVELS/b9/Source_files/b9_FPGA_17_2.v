...
module FAU ( 
  ...
  assign z14 = ~new_n101_ | new_n104_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = new_n68_ & ~new_n100_ & (~x27 | (~x04 & ~x13));
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~new_n103_ & (x37 | new_n102_ | (x28 & x35));
  assign new_n102_ = ~x13 & (~x27 | (~x04 & x39 & x40));
  assign new_n103_ = ~x27 & (x25 | (~x25 & (x04 | x13 | ~x39 | ~x40)));
