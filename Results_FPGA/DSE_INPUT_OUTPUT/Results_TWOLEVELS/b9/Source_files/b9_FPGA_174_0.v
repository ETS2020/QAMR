...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : x24;
  ...
  assign new_n83_ = ~new_n71_ & ((x07 & (x40 ? ~x39 : x24)) | (x05 & x39 & x40));
  ...
  assign new_n89_ = x40 ? (x29 & x39) : ~x24;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n92_ | (~x24 & ~x40) | (~new_n93_ & (x40 ? (x04 | ~x39) : x24));
  ...
  assign new_n101_ = (~x40 | (~new_n102_ & (new_n93_ | new_n100_))) & (~x24 | new_n93_ | x40);
