...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (x40 ? x39 : ~x23)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & ((x04 & x27) | x28 | ~x35);
  assign new_n88_ = x40 ? (x29 & x39) : ~x23;
  assign new_n89_ = (x27 | (~x23 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (x23 & ~x40 & (new_n66_ | ~x27));
  ...
  assign new_n96_ = ~x19 & x20 & ~new_n66_ & x23;
  ...
  assign new_n100_ = (~x40 | (~x04 & x39)) & ~x13 & (~x23 | x40);
  assign new_n101_ = ~new_n102_ & x39 & x40 & ~x04 & ~x13;
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = (x40 | (x23 & (~x23 | x27))) & (x27 | ((new_n104_ | ~x40) & (x30 | x32)));
  ...
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (x23 | x40)));
