...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n73_, new_n78_,
    ...
    new_n92_, new_n94_, new_n95_, new_n97_, new_n98_, new_n99_, new_n104_,
  ...
  assign z03 = ((~x39 | x40) & (~x21 | (~new_n73_ & x27))) | (~x27 & ~x37 & (~x39 | (x39 & x40)));
  assign new_n73_ = x28 & x35;
  assign z04 = (~x27 & ~x37 & (~x39 | (x39 & x40))) | (x27 & ~new_n73_ & (~x39 | x40)) | x21 | (x39 & ~x40);
  assign z05 = (~x39 | (x39 & x40)) & (x37 | (x27 & x28));
  assign z06 = (x39 & ~x40) | (~x37 & (~x28 | (~x27 & (~x39 | (x39 & x40)))));
  assign z07 = new_n67_ | (~new_n78_ & x03);
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = x39 & ((~x37 & (~x28 | (~x27 & x40))) | ~x40 | (x40 & (x37 | (x27 & x28))));
  ...
  assign z12 = new_n92_ | (x39 & ~x40) | ((x04 | ~x39) & (new_n91_ | ~x27));
  assign new_n91_ = ~x37 & (~x28 | ~x35);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x39 & (~x40 | (~x04 & ~new_n84_ & ~x13)));
  assign new_n94_ = x27 & (new_n95_ | (~x18 & ~x19 & ~new_n91_ & x20));
  assign new_n95_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign z14 = new_n98_ | (x39 & ~x40) | (~new_n97_ & (x04 | x13 | ~x39));
  assign new_n97_ = ~new_n91_ & ~x18 & ~x19 & x20 & x27;
