// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:44 2020
...
module FAU ( 
  ...
  assign new_n86_ = ~new_n87_ & (x39 ? (~x29 | ~x40) : x40);
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x28 & x35)) & (~x04 | ~x40);
  assign z12 = new_n91_ | new_n90_ | (~x39 & (~x27 | ~x40)) | (~x27 & (~x40 | (x04 & x40)));
  assign new_n90_ = ~x37 & (~x28 | ~x35) & (~z08 | x04);
  ...
  assign z14 = (~new_n96_ & ~new_n99_) | ~new_n98_ | (new_n100_ & ~x30);
  assign new_n96_ = ~new_n97_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ((~x04 & ~x13) | (~new_n66_ & (x27 | ~x40))) & (x39 | x40) & ((~new_n66_ & x27) | (x39 & x40));
  assign new_n99_ = ~x18 & ~x19 & x20;
  assign new_n100_ = ~x32 & ((~x27 & x40) | (x28 & ~x35 & ~x37));
  ...
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n108_ | ~new_n109_));
  assign new_n108_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n109_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((x08 | (~x39 & ~x40)) & (~x28 | x39)));
