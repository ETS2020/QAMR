...
module FAU ( 
  ...
  assign new_n88_ = (x27 | (~x39 & ~x40)) & (~x28 | ~x39) & (~x40 | (~x04 & x35));
  assign z12 = new_n90_ | new_n91_ | (~x39 & (~x27 | ~x40)) | (~x27 & (~x40 | (x04 & x40)));
  assign new_n90_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign new_n91_ = ~x37 & (((~x28 | ~x35) & (x04 | ~x39)) | (~x40 & (~x35 | (~x28 & x39))));
  ...
  assign z14 = ~new_n99_ | ((x18 | x19 | ~x20) & (~new_n98_ | new_n103_));
  assign new_n98_ = z08 & ~x04 & ~x13;
  assign new_n99_ = (~new_n100_ | x30) & new_n102_ & (new_n101_ | (~x04 & ~x13));
  assign new_n100_ = ~x32 & ((~x27 & x40) | (x28 & ~x35 & ~x37));
  assign new_n101_ = (x27 | ~x40) & (x37 | (x28 & x35));
  assign new_n102_ = ((x39 & x40) | (x27 & (x35 | x37))) & (x39 | x40) & (x28 | x37 | (x39 & (~x39 | x40)));
  ...
  assign z18 = (~new_n108_ & (x39 | x40)) | (x39 & x40 & x08 & x29);
