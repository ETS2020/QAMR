// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:02 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n73_,
    ...
    new_n111_, new_n113_;
  assign z00 = (~new_n65_ & (~x29 | ~x40)) | (~x04 & ~x15 & new_n67_ & ~x29);
  ...
  assign z02 = (~x27 & (new_n72_ | ~x40)) | (~new_n73_ & ~x29) | (~new_n74_ & ~x40);
  assign new_n72_ = x04 & ~x08 & ~x29;
  assign new_n73_ = (~x04 | (x35 & (~x28 | ~x40))) & x02 & x39;
  assign new_n74_ = ~x09 & (~x27 | x28) & ~x30 & (x09 | ~x28 | x30);
  ...
  assign new_n85_ = ~new_n70_ & ((x07 & (~x40 | (~x29 & ~x39))) | (x39 & x40 & x05 & ~x29));
  assign new_n86_ = x06 & ~new_n69_ & x37;
  assign new_n87_ = ~x29 & x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n69_;
  assign z19 = ~x09 & ~x30 & ~new_n69_ & ~new_n90_;
  assign new_n90_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z12 = new_n94_ | ~new_n92_ | (x40 & (x29 | (x04 & ~x27 & ~x29)));
  assign new_n92_ = (~new_n93_ | x37) & (x27 | (x40 & (x29 | x39)));
  assign new_n93_ = (~x28 | ~x35) & (~x40 | (~x29 & (x04 | ~x39)));
  assign new_n94_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (~new_n96_ & x27) | (~x04 & new_n87_ & ~x13);
  assign new_n96_ = (x29 | ((~new_n98_ | x18) & (~new_n97_ | x04))) & (~new_n99_ | x18);
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n98_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n99_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign z14 = (~new_n101_ & ~new_n105_) | new_n104_ | (~x29 & (~new_n103_ | new_n106_));
  assign new_n101_ = x40 & (x29 | (~new_n102_ & x39 & (~x40 | (~x04 & ~x13))));
  ...
  assign z18 = ~new_n69_ & (new_n111_ | x09 | x30);
  assign new_n111_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (~x09 & ~new_n113_ & ~x30);
  assign new_n113_ = (new_n69_ | (x35 & (x08 | x27))) & (x27 | ~x28);
endmodule
