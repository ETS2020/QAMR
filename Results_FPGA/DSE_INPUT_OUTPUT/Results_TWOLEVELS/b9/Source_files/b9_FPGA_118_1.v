...
module FAU ( 
  ...
  assign z03 = ((x39 | ~x40) & (~x21 | (~new_n73_ & x27))) | (~x27 & ~x37 & (~x40 | (x39 & x40)));
  assign new_n73_ = x28 & x35;
  assign z04 = (~x27 & ~x37 & (~x40 | (x39 & x40))) | (x27 & ~new_n73_ & (x39 | ~x40)) | x21 | (~x39 & x40);
  assign z05 = (~x40 | (x39 & x40)) & (x37 | (x27 & x28));
  assign z06 = (~x39 & x40) | (~x37 & (~x28 | (~x27 & (~x40 | (x39 & x40)))));
  assign z07 = new_n67_ | (~new_n78_ & x03);
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = x40 & ((~x37 & (~x28 | (~x27 & x39))) | ~x39 | (x39 & (x37 | (x27 & x28))));
  ...
  assign z12 = new_n92_ | (~x39 & x40) | ((new_n91_ | ~x27) & (x04 | ~x40));
  assign new_n91_ = ~x37 & (~x28 | ~x35);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x40 & (~x39 | (~x04 & ~new_n84_ & ~x13)));
