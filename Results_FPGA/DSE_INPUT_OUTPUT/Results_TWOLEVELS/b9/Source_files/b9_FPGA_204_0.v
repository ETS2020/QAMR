...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n72_, new_n78_, new_n79_,
    ...
    new_n100_, new_n101_, new_n106_, new_n107_, new_n110_, new_n111_;
  ...
  assign z03 = ((x37 | x40) & (~x21 | (x27 & ~x35))) | (~x28 & (x37 ? x27 : x40)) | (~x27 & ~x37 & x40);
  assign z04 = (~x28 & (x37 ? x27 : x40)) | (x27 & ~x35 & (x37 | x40)) | x21 | (~x37 & (~x40 | (~x27 & x40)));
  ...
  assign z10 = (~new_n82_ & ~x04) | (~x37 & ~x40) | (x06 & x27 & x37);
  assign new_n82_ = (~new_n83_ | ~x05) & (~x27 | new_n70_ | (z08 ? ~x05 : ~x07));
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n86_ & ~new_n87_) | (~new_n85_ & ~x08));
  assign new_n85_ = (x27 | (~x37 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n86_ = x40 ? (x29 & x39) : ~x37;
  assign new_n87_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = (~x10 & (new_n89_ | (~x27 & x40))) | new_n90_ | (~x40 & (~x27 | ~x37));
  assign new_n89_ = ~x35 & ~x36 & ~x37;
  assign new_n90_ = (x04 | ~x39) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign z13 = new_n92_ | (~x04 & new_n83_ & ~x13);
  assign new_n92_ = x27 & (new_n95_ | (x40 & (new_n93_ | new_n94_)));
  assign new_n93_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & x28 & x35;
  assign new_n95_ = ~x18 & ~x19 & x20 & x37;
  assign z14 = new_n97_ | ~new_n98_ | (~new_n101_ & (x04 | x13 | ~x39));
  assign new_n97_ = ~new_n95_ & (~x40 | (x28 & ~x30 & ~x32 & ~x35));
  assign new_n98_ = (new_n100_ | x27) & (x30 | x32 | (~new_n99_ & x27));
  assign new_n99_ = x28 & ~x36 & (x18 | x19 | ~x20);
  assign new_n100_ = ~x04 & x39 & x40 & (~x13 | ~x40);
  assign new_n101_ = (x37 | (x28 & x35)) & ~x18 & ~x19 & x20;
  ...
  assign new_n106_ = (~z08 | ~x29) & (x27 | x28 | ~x35);
  assign new_n107_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = z11 | new_n68_;
  assign z20 = new_n110_ & ~x09;
  assign new_n110_ = ~x30 & (new_n111_ | (~new_n86_ & (~x35 | (~x27 & x28))));
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (x37 | x40)));
endmodule
