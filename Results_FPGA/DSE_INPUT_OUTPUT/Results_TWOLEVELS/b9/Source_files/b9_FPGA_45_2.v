...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x31;
  ...
  assign z07 = (x31 & ~x40) | (x03 & (new_n80_ | (new_n79_ & ~x31)));
  assign new_n79_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign new_n80_ = ~x14 & (x00 | x25 | ~x38);
  assign z09 = new_n69_ | (x27 & x34 & x11 & x26);
  assign z10 = (new_n85_ & ~x04) | (x27 & (new_n83_ | (~x04 & ~new_n71_ & ~new_n84_)));
  assign new_n83_ = x06 & ~new_n69_ & x37;
  assign new_n84_ = (~x07 | (x40 ? x39 : x31)) & (~x05 | ~x39 | ~x40);
  ...
  assign new_n89_ = x40 ? (x29 & x39) : x31;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n92_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n92_ = (~x31 | x40) & ((~new_n66_ & x27) | (x40 ? (~x04 & x39) : x31));
  ...
  assign new_n96_ = ~x19 & x20 & ~new_n66_ & ~x31;
  assign new_n97_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n102_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = x40 ? (~new_n100_ & new_n101_) : x31;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (~x40 | (~new_n103_ & (new_n101_ | (~new_n66_ & x27)))) & (x31 | x40 | (~new_n66_ & x27));
  ...
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n111_ | ~new_n112_));
  assign new_n111_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & x40));
  assign new_n112_ = (x31 | ((x35 | x40) & (x08 | x27))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
endmodule
