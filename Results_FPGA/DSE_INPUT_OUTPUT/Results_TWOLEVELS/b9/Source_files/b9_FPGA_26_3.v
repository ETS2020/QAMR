...
module FAU ( 
  ...
  assign z12 = (~x37 & (~x35 | (~new_n66_ & ~x28))) | new_n66_ | ~x27;
  assign z13 = ~x18 & ~x19 & x20 & x27 & ~new_n65_ & ~new_n66_;
  assign z14 = ~new_n84_ | (~x37 & (~x35 | (~new_n66_ & ~x28)));
  ...
  assign z18 = new_n89_ | x09 | new_n66_ | x30;
  assign new_n89_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = new_n66_ | (~x09 & ~x30 & ~new_n66_ & ~new_n80_);
