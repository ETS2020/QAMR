// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:10 2020
...
module FAU ( 
  ...
  assign new_n67_ = x40 & (x04 | ~x10 | ~x39);
  assign z01 = (~x30 & ~x32 & (new_n69_ | ~x27)) | new_n70_ | ~x04;
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign new_n70_ = ~x15 & ~x40;
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : x15;
  assign new_n72_ = x39 & (~x04 | (~x28 & x35 & (x08 | x27)));
  assign z03 = (~new_n70_ & (x27 ? ~x28 : ~x37)) | new_n74_ | new_n70_ | ~x21;
  assign new_n74_ = x27 & ~x35 & (x15 | (x28 & x40));
  assign z04 = new_n74_ | (~new_n70_ & (x21 | (x27 & ~x28) | (~x27 & ~x37)));
  assign z05 = (x15 & (x37 | (x27 & x28))) | (x40 & (x37 | (x27 & x28 & (~x35 | (~x15 & x35)))));
  assign z06 = new_n70_ | (~x37 & (~x28 | (~new_n70_ & ~x27)));
  assign z07 = new_n70_ | (~new_n79_ & x03);
  assign new_n79_ = (~new_n80_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n80_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = x40 ? x39 : ~x15;
  assign z09 = x11 & x26 & x27 & ~new_n70_ & x34;
  assign z10 = (new_n86_ & ~x04) | (x27 & (new_n84_ | (~x04 & ~new_n69_ & ~new_n85_)));
  assign new_n84_ = x06 & ~new_n70_ & x37;
  assign new_n85_ = (~x07 | (x40 ? x39 : ~x15)) & (~x05 | ~x39 | ~x40);
  assign new_n86_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n90_ & ~x08));
  assign new_n88_ = ~new_n89_ & (x40 ? (~x29 | ~x39) : x15);
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n90_ = (x27 | (~x15 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & (x04 | ~x39)))) | (x15 & ~new_n93_ & ~x40);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n96_ | (new_n95_ & ~x04))) | new_n70_ | (new_n97_ & ~x04);
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n97_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n102_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = x40 ? (~new_n100_ & new_n101_) : ~x15;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (~x15 | new_n93_ | x40) & (~x40 | (~new_n103_ & (new_n93_ | new_n101_)));
  ...
  assign z18 = new_n109_ | (~new_n70_ & (new_n108_ | x09 | x30));
  assign new_n108_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n109_ = x39 & x40 & x08 & x29;
  assign z20 = (~x15 & ~x40) | (~x09 & ~x30 & (~new_n111_ | (~new_n113_ & x15)));
