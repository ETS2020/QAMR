...
module FAU ( 
  ...
  assign new_n91_ = ~new_n92_ & (x40 | (x27 & x34)) & (x27 | (x39 & (~x04 | ~x39)));
  assign new_n92_ = ~x37 & (~x28 | ~x35) & (x04 | ~x39 | ~x40);
  assign new_n93_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
  ...
  assign new_n100_ = ~new_n101_ & (new_n102_ | ~x39) & x39 & x40;
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13;
  assign new_n103_ = (new_n102_ | (~new_n66_ & (x27 | ~x39))) & (x34 | x40) & ((~new_n66_ & x27) | (x39 & x40));
  ...
  assign new_n114_ = (~x34 | ((x08 | x27) & (x35 | x40))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
endmodule
