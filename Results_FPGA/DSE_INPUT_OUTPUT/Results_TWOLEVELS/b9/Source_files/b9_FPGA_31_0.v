...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : x20;
  ...
  assign new_n99_ = ~new_n100_ & ((~new_n66_ & x27) | (new_n68_ & ~x04 & ~x13));
  ...
  assign z18 = (~new_n105_ & ~new_n69_) | (new_n68_ & x08 & x29);
  assign new_n105_ = ~new_n106_ & ~x09 & ~x30;
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = (~x20 & ~x40) | (~x09 & ~x30 & (~new_n108_ | (~new_n110_ & x20)));
