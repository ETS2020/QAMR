...
module FAU ( 
  ...
  assign z18 = (~new_n104_ & x08) | ~new_n105_ | x09 | (~x27 & x40);
  assign new_n104_ = (~new_n70_ | x27) & (~x29 | ~x39 | ~x40);
  assign new_n105_ = ~x30 & (~new_n70_ | x04 | ~x27);
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (x08 | (x27 ? x35 : x40)) & (x35 | (x40 & (new_n86_ | ~x27))) & (x27 | ~x28 | x40);
