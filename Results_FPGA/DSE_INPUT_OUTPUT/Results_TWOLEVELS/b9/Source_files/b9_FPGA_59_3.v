// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:49 2020
...
module FAU ( 
  ...
  assign z07 = new_n65_ | (x03 & (new_n75_ | (new_n74_ & ~x31)));
  ...
  assign z11 = new_n65_ | (~x09 & ~x30 & ~new_n65_ & ~new_n80_);
  assign new_n80_ = ~x28 & x35 & (~x04 | ~x27) & (x08 | x27);
  assign z12 = new_n65_ | ~x27 | (~x37 & (~x35 | (~new_n65_ & ~x28)));
  assign z13 = new_n65_ | (~x18 & ~x19 & new_n66_ & x20);
  assign z14 = ~new_n84_ | (~x37 & (~x35 | (~new_n65_ & ~x28)));
  ...
  assign z19 = ~x09 & ~x30 & ~new_n65_ & ~new_n80_;
  assign z20 = new_n65_ | (~x09 & ~new_n92_ & ~x30);
