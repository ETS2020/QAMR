...
module FAU ( 
  ...
  assign new_n72_ = ~new_n73_ & x39 & x40 & (x09 | ~x40);
  ...
  assign new_n84_ = (~x07 | (x40 & (~x09 | x39))) & (~x39 | ~x40 | ~x05 | ~x09);
  assign new_n85_ = x05 & x09 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & (new_n87_ | x40);
  assign new_n87_ = new_n88_ & ~x30;
