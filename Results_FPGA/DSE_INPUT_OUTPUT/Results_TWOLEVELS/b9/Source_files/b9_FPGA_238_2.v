...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | new_n72_ | ~x39 | (x39 & ~x40);
  ...
  assign new_n86_ = (~x39 | (~x29 & x40)) & (~new_n73_ | (x04 & x27));
  assign new_n87_ = (x27 | (x39 & ~x40)) & (~x40 | (new_n73_ & ~x04));
  assign z12 = new_n89_ | (x39 & ~x40) | ((new_n66_ | ~x27) & (x04 | ~x39));
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n91_ | (x39 & (~x40 | (~x04 & ~new_n84_ & ~x13)));
  assign new_n91_ = x27 & (new_n92_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n92_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign z14 = (~new_n94_ & (x04 | x13 | ~x39)) | new_n95_ | (x39 & ~x40);
  ...
  assign new_n103_ = ~new_n104_ & (x35 | (x39 & (~x40 | (x08 & x29))));
  assign new_n104_ = ~x27 & ((~x08 & (~x39 | x40)) | (x28 & (~x29 | ~x39)));
  assign z08 = x39;
