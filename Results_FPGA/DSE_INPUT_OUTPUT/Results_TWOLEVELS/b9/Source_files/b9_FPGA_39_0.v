...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : x00;
  ...
  assign new_n84_ = (~x07 | (x40 ? x39 : ~x00)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~new_n89_) | (~new_n87_ & ~x08));
  assign new_n87_ = (x27 | (~x00 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n89_ = x40 ? (x29 & x39) : ~x00;
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (x00 & ~new_n92_ & ~x40);
  ...
  assign z18 = new_n109_ | (~new_n68_ & (new_n108_ | x09 | x30));
  ...
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (x00 | x40)));
endmodule
