...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n79_,
    ...
    new_n112_;
  assign z00 = new_n67_ | ~x16 | (~x15 & ~new_n65_ & x27);
  assign new_n65_ = new_n66_ & (x04 | ~x39 | ~x40 | (~x35 & ~x36));
  assign new_n66_ = ~x37 & (~x28 | ~x35);
  assign new_n67_ = x10 & (~x40 | (~x04 & ~x15 & x39));
  ...
  assign new_n84_ = (~x07 | (x40 ? x39 : x10)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~new_n89_) | (~new_n87_ & ~x08));
  assign new_n87_ = (x27 | (x10 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : x10;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n91_ | (~x27 & (~x10 | (x40 & (x04 | ~x39))));
  assign new_n91_ = ~x37 & ((~new_n92_ & (~x28 | ~x35)) | (~x10 & ~x35 & ~x36));
  assign new_n92_ = x40 ? (~x04 & x39) : x10;
  assign z13 = new_n96_ | (x27 & ((new_n94_ & ~x10) | (x40 & (new_n94_ | new_n95_))));
  ...
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : x10;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x40 | (~new_n102_ & (new_n100_ | (~new_n66_ & x27)))) & (x10 | (~new_n66_ & x27) | x40);
  ...
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x10 | x40)));
endmodule
