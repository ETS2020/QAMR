// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:23 2020
...
module FAU ( 
  ...
  assign z01 = (~x30 & (new_n70_ | ~x27) & ~x32) | new_n68_ | ~x04;
  ...
  assign z04 = (x27 & (~x28 | ~x35)) | new_n68_ | x21 | (~x27 & ~new_n68_ & ~x37);
  assign z05 = ~new_n68_ & (x37 | (x27 & x28));
  assign z06 = ~x37 & ((~x27 & (x39 | x40)) | (~x28 & (x40 | (x39 & ~x40))));
  ...
  assign z10 = new_n84_ | (x27 & (new_n83_ | (x06 & ~new_n68_ & x37)));
  assign new_n83_ = ~x04 & ~new_n70_ & ((x07 & (~x39 ^ ~x40)) | (x05 & x39 & x40));
  assign new_n84_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n68_ | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = (new_n87_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = new_n89_ | (~new_n90_ & x39) | new_n91_ | (~x39 & ~x40) | (~x27 & (~x39 | ~x40));
  assign new_n89_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  assign new_n90_ = (x28 | x37 | x40) & (~x04 | x27);
  assign new_n91_ = ~x37 & (((x04 | ~x39) & (~x28 | ~x35)) | (~x35 & ~x40));
  assign z13 = ~new_n95_ | (x27 & (new_n94_ | (new_n93_ & ~x04)));
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n95_ = (x39 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  assign z14 = (~new_n97_ & (x18 | x19 | ~x20)) | ~new_n99_ | new_n101_;
  assign new_n97_ = new_n98_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n98_ = x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n99_ = (new_n100_ | x37) & ~new_n68_ & (new_n98_ | x27);
  assign new_n100_ = ((x28 & x35) | (~x04 & ~x13 & x39)) & (x40 | (x35 & (x28 | ~x39)));
  ...
  assign z18 = (~new_n106_ & x08) | ~new_n107_ | new_n68_ | x30;
  assign new_n106_ = ~new_n87_ & (x27 | x28 | ~x35);
  assign new_n107_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n68_ | (new_n109_ & ~x09);
  assign new_n109_ = ~x30 & ((~x08 & (~x27 | ~x35)) | (~new_n87_ & (~x35 | (~x27 & x28))));
  assign z19 = new_n68_ | (~x09 & ~new_n86_ & ~x30);
endmodule
