...
module FAU ( 
  ...
  assign z01 = (~x30 & ~new_n70_ & ~x32) | ~x04 | (x32 & ~x40);
  ...
  assign new_n87_ = ~new_n88_ & (x40 ? (~x29 | ~x39) : ~x32);
  assign new_n88_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n89_ = (x27 | (x32 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~x32 & ~new_n92_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = ~new_n96_ | (x27 & (new_n95_ | (new_n94_ & ~x04)));
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = (~x32 | x40) & (x04 | x13 | ~x39 | (~x32 & (~x30 | ~x40)));
  assign z14 = new_n98_ | (~new_n101_ & ~x32) | (x40 & ~new_n92_ & ~new_n100_);
  assign new_n98_ = (x18 | x19 | ~x20) & (new_n99_ | (~new_n100_ & x40));
  assign new_n99_ = ~x32 & (~x40 | (x28 & ~x30 & (~x35 | ~x36)));
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (x27 | (x30 & x40)) & (x37 | ((x28 | x40) & (x35 | (x40 & (~x28 | x30)))));
  ...
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n109_ | ~new_n110_));
  assign new_n109_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & x40));
  assign new_n110_ = (x32 | ((x08 | x27) & (x35 | x40))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
