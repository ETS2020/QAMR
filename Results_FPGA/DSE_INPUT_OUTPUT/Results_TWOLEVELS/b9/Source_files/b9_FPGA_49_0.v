// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:43 2020
...
module FAU ( 
  ...
  assign z02 = (~new_n71_ & x40) | (x04 & ~x08 & ~x27) | ~x39 | ~x40;
  ...
  assign z06 = ~x37 & ((~x27 & (x38 | x40)) | (~x28 & (x40 | (x38 & ~x40))));
  assign z07 = new_n65_ | (~new_n77_ & x03);
  assign new_n77_ = (~new_n78_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n78_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = x40 ? x39 : ~x38;
  assign z09 = new_n65_ | (x11 & x26 & x27 & x34);
  assign z10 = (x27 & (new_n83_ | (new_n82_ & ~x04))) | (~x04 & new_n84_ & x05);
  assign new_n82_ = ~new_n69_ & ((x07 & (x40 ? ~x39 : x38)) | (x05 & x39 & x40));
  assign new_n83_ = x06 & ~new_n65_ & x37;
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & (x40 ? (~x29 | ~x39) : x38);
  assign new_n87_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n88_ = (x27 | (~x38 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n90_ | (~x38 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x38));
  assign new_n90_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (x27 & (new_n94_ | (new_n93_ & ~x04))) | new_n65_ | (new_n92_ & ~x04);
  assign new_n92_ = new_n84_ & ~x13;
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n99_ | (~new_n96_ & (x18 | x19 | ~x20));
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : ~x38;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (~x40 | (~new_n100_ & (new_n66_ | new_n98_))) & (~x38 | new_n66_ | x40);
  ...
  assign z18 = (~new_n105_ & x08) | ~new_n106_ | new_n65_ | x30;
  assign new_n105_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n106_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n65_ | (~x09 & ~x30 & (new_n108_ | ~new_n109_));
  assign new_n108_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & x40));
  assign new_n109_ = (x35 | (x40 ? x08 : ~x38)) & (x27 | ((x08 | (~x38 & ~x40)) & (~x28 | x40)));
