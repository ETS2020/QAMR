...
module FAU ( 
  ...
  assign new_n82_ = (~x27 | new_n70_ | (x39 ? ~x05 : ~x07)) & (~x05 | new_n83_ | ~x39);
  ...
  assign z12 = (x40 & (new_n89_ | (~new_n65_ & x04))) | (~new_n65_ & ~x39);
  ...
  assign new_n104_ = ~new_n105_ & (x35 | (x39 & (~x40 | (x08 & x29))));
  assign new_n105_ = ~x27 & ((x28 & (~x29 | ~x39)) | (~x08 & (~x39 | x40)));
  assign z08 = x39;
