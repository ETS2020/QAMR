...
module FAU ( 
  ...
  assign new_n74_ = x40 ? (~x20 & x39) : (x04 & (~x27 | x28));
  ...
  assign new_n84_ = ~new_n86_ & (~x27 | new_n85_ | (~new_n71_ & ~x36));
  ...
  assign z12 = (~x20 & (new_n93_ | (~new_n94_ & (new_n66_ | ~x27)))) | (~x40 & (new_n66_ | ~x27));
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n94_ = ~x04 & x39;
  assign z13 = (x27 & (new_n96_ | (~x04 & new_n97_ & ~x13))) | (~x04 & new_n98_ & ~x13);
