// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:34 2020
...
module FAU ( 
  ...
  assign z06 = ~x37 & ((x25 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  assign z07 = x03 & (new_n80_ | (~x31 & new_n79_ & ~x33));
  assign new_n79_ = (x15 | ~x17) & ((~x38 & (x25 | x40)) | (x00 & ~x25 & x40));
  assign new_n80_ = ~x14 & (x25 | (x40 & (x00 | ~x38)));
  ...
  assign new_n87_ = x40 ? (x29 & x39) : ~x25;
  assign new_n88_ = (x27 | (~x25 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~new_n91_ & (new_n66_ | ~x27)))) | (x25 & ~x40 & (new_n66_ | ~x27));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n91_ = ~x04 & x39;
  assign z13 = (~new_n93_ & x27) | new_n69_ | (~x04 & new_n84_ & ~x13);
  assign new_n93_ = (~new_n94_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n96_ | ~new_n100_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n96_ = ~x37 & ((~new_n97_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n97_ = (~x40 | (~x04 & x39)) & ~x13 & (~x25 | x40);
  assign new_n98_ = ~new_n99_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = (x40 | (x25 & (~x25 | x27))) & (x27 | ((new_n101_ | ~x40) & (x30 | x32)));
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (x25 | x40)));
