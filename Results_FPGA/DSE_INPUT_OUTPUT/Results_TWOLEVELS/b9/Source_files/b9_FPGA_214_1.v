...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n79_, new_n80_, new_n83_, new_n84_, new_n86_, new_n87_,
    new_n88_, new_n90_, new_n92_, new_n93_, new_n94_, new_n96_, new_n97_,
    new_n98_, new_n99_, new_n104_, new_n105_, new_n107_, new_n108_;
  ...
  assign z02 = ~new_n72_ | new_n74_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = (new_n73_ | ~x04) & (x39 | ~x40) & (x40 | (x04 & ~x09 & ~x30));
  assign new_n73_ = ~x28 & x35 & (x09 | ~x27 | x30 | x40);
  assign new_n74_ = ~x27 & (~x40 | (x04 & ~x08));
  ...
  assign new_n83_ = ~x04 & ~new_n70_ & ((x05 & x39 & x40) | (x07 & ~x40));
  assign new_n84_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & (~x40 | (~x29 & x39));
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (~x39 & x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign z12 = new_n90_ | (~x39 & x40) | ((new_n66_ | ~x27) & (x04 | ~x40));
  assign new_n90_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n92_ | (x40 & (~x39 | (new_n94_ & ~x04)));
  assign new_n92_ = x27 & (new_n93_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n93_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x13 & (x30 | x32);
  assign z14 = new_n96_ | ~new_n98_ | (~new_n97_ & (x04 | x13 | ~x40));
  assign new_n96_ = ~x27 & ((~new_n94_ & x39) | x04 | ~x40);
  assign new_n97_ = ~new_n66_ & ~x18 & ~x19 & x20;
  assign new_n98_ = ~new_n69_ & (~x28 | x30 | new_n99_ | x32);
  assign new_n99_ = (x35 | x37) & ((x35 & x36) | (~x18 & ~x19 & x20));
  assign z15 = new_n69_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = (x39 & x40 & x08 & x29) | (~new_n104_ & (x39 | ~x40));
  assign new_n104_ = ~new_n105_ & ~x09 & ~x30;
  assign new_n105_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (~x09 & ~new_n107_ & ~x30);
  assign new_n107_ = ~new_n108_ & (x35 | (x40 & (~x39 | (x08 & x29))));
  assign new_n108_ = ~x27 & ((~x08 & (x39 | ~x40)) | (x28 & (~x29 | ~x40)));
  assign z06 = ~z05;
  assign z08 = x40;
