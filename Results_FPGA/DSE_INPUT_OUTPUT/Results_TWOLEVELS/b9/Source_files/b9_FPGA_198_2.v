...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n77_,
    new_n78_, new_n81_, new_n82_, new_n84_, new_n85_, new_n86_, new_n88_,
  ...
  assign z10 = new_n82_ | (x27 & (new_n81_ | (x06 & ~new_n67_ & x37)));
  assign new_n81_ = ~x04 & ~new_n69_ & ((x07 & ~x39) | (x05 & x39 & x40));
  assign new_n82_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n84_ | (~new_n86_ & ~x08));
  assign new_n84_ = ~new_n85_ & (~x39 | (~x29 & x40));
  assign new_n85_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n86_ = (x27 | (x39 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  ...
  assign new_n96_ = ~x13 & x39 & (~x04 | ~x40);
  assign new_n97_ = ~new_n98_ & ~x04 & ~x13 & x39;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~new_n67_ & (new_n93_ | x27);
  ...
  assign z05 = ~z06;
  assign z08 = x39;
  assign z19 = ~x09 & ~x30 & (new_n84_ | (~new_n86_ & ~x08));
endmodule
