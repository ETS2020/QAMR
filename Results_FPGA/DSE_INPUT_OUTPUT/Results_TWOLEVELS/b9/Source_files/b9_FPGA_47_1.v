...
module FAU ( 
  ...
  assign z02 = (x03 & (~new_n73_ | (~new_n72_ & x40))) | (~new_n74_ & ~x40);
  ...
  assign z10 = (new_n86_ & x03) | (~new_n84_ & x27);
  ...
  assign z12 = new_n94_ | (~x03 & x40) | (~new_n93_ & (~x40 | (x03 & (x04 | ~x39))));
  assign new_n93_ = ~new_n66_ & x27;
  assign new_n94_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (new_n99_ & x03) | (x27 & ((~new_n96_ & x03) | (new_n98_ & ~x18)));
  ...
  assign z14 = (~new_n106_ & (~x40 | (~new_n101_ & x03))) | (~new_n103_ & x03) | (~new_n93_ & ~x40);
  ...
  assign z18 = (~new_n111_ & x08) | ~new_n112_ | new_n68_ | x09;
  assign new_n111_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n112_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = new_n114_ & ~x09;
  assign new_n114_ = ~x30 & (new_n115_ | (~new_n90_ & (~x35 | (~x27 & x28))));
  assign new_n115_ = ~x08 & ((~x27 & ~x40) | (x03 & (~x27 | ~x35)));
  assign z05 = ~z06;
endmodule
