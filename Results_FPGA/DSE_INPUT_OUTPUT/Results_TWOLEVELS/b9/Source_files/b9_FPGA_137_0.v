// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:37 2020
...
module FAU ( 
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : ~x33)) & (~x05 | ~x39 | ~x40);
  ...
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (x33 & ~new_n66_ & ~x40);
  ...
  assign z20 = new_n65_ | (~x09 & ~new_n109_ & ~x30);
  assign new_n109_ = (x08 | (x27 & x35)) & (new_n87_ | (x35 & (x27 | ~x28)));
