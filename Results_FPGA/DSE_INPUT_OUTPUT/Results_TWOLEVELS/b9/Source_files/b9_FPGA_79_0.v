...
module FAU ( 
  ...
  assign new_n87_ = (x27 | (~x26 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : ~x26;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n91_ | new_n65_ | (~new_n66_ & (~z08 | x04));
  ...
  assign new_n96_ = x20 & x26 & (x37 | (x28 & x35));
  ...
  assign new_n101_ = ~new_n65_ & (new_n66_ | (z08 & ~x04 & ~x13));
