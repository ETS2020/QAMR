...
module FAU ( 
  ...
  assign new_n84_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x04 & ~x28 & x35));
  assign new_n85_ = x39 ? (x29 & x40) : ~x40;
  assign new_n86_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n88_ | (~new_n66_ & (x04 | ~x39)))) | (x39 & ~new_n66_ & ~x40);
  ...
  assign new_n92_ = (x39 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  assign z14 = ~new_n96_ | (~new_n94_ & (x18 | x19 | ~x20));
  assign new_n94_ = x40 ? (~new_n95_ & ~x04 & ~x13 & x39) : ~x39;
  assign new_n95_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = (~x39 | new_n66_ | x40) & (~x40 | (~new_n97_ & (new_n66_ | (~x04 & ~x13 & x39))));
