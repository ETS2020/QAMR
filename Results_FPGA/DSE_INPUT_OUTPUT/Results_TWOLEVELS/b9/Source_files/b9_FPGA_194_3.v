...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n78_,
    ...
    new_n100_, new_n101_, new_n102_, new_n107_, new_n109_;
  ...
  assign new_n95_ = ~x09 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n99_ | (~new_n97_ & (x18 | x19 | ~x20));
  assign new_n97_ = ~new_n98_ & ~x04 & ~x13 & x39 & x40;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~new_n100_ & new_n102_ & (x37 | new_n101_ | (x28 & x35));
  assign new_n100_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n101_ = ~x13 & x40 & (x09 | (~x04 & x39));
  assign new_n102_ = (~x09 | ~x40) & (x27 | (x40 & (x09 | (~x04 & ~x13 & x39))));
  assign z15 = x12 & x26 & x27 & ~new_n68_ & x34;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n107_ | (x08 & (new_n88_ | (~x27 & ~x28 & x35)));
  assign new_n107_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & (new_n109_ | (~x08 & (~x27 | ~x35)));
  assign new_n109_ = ~new_n88_ & (~x35 | (~x27 & x28));
