...
module FAU ( 
  ...
  assign new_n72_ = new_n73_ & (x27 | (x39 & (~x04 | x08)));
  assign new_n73_ = (~x04 | (~x28 & x35)) & (~x39 | x40) & (x39 | (x04 & (~x27 | x28)));
  ...
  assign z11 = new_n69_ | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = ((x29 & x39) | (new_n87_ & (~x04 | ~x27))) & (x08 | (new_n87_ & ~x04 & x27));
  assign new_n87_ = ~x28 & x35;
  assign z12 = new_n89_ | (x39 & ~x40) | ((new_n66_ | ~x27) & (~x39 | (x04 & x40)));
  assign new_n89_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x27 & (new_n91_ | (new_n93_ & ~x18)));
  assign new_n91_ = x40 & (new_n92_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n92_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x19 & x20 & ~new_n66_ & ~x39;
  assign new_n94_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n97_ | (~new_n96_ & (~x39 | (x40 & (x04 | x13))));
  ...
  assign z18 = (x39 & x40 & x08 & x29) | (~new_n103_ & (~x39 | x40));
  assign new_n103_ = ~new_n104_ & ~x09 & ~x30;
  assign new_n104_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = (x08 | (x27 & x35)) & ((x29 & x39) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
  assign z19 = new_n69_ | (~x09 & ~new_n86_ & ~x30);
endmodule
