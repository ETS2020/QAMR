...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & ~x23) | new_n73_ | (~new_n74_ & ~x40) | ~x39 | (x23 & x40);
  assign new_n72_ = (x02 | (x08 & x29)) & (~x04 | (~x28 & x35));
  assign new_n73_ = ~x27 & (~x40 | (x04 & ~x08));
  assign new_n74_ = (~x27 | ~x28) & ~x37 & (x28 | x37);
  ...
  assign new_n105_ = (~x23 | ~x40) & (x27 | (x39 & x40 & ~x04 & (~x13 | x23)));
  ...
  assign new_n113_ = (~x29 | ~x39) & ((~x27 & x28) | (~x23 & ~x35));
  assign new_n114_ = (x08 | ((x27 | x40) & (x23 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
