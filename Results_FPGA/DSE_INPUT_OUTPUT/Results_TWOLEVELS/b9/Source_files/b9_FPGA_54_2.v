...
module FAU ( 
  ...
  assign new_n73_ = x39 & (~x04 | (new_n74_ & (x08 | x27)));
  ...
  assign new_n84_ = (~x27 | new_n71_ | (z08 ? ~x05 : ~x07)) & (~new_n85_ | ~x05);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = (x09 & ~x40) | (~x30 & ((~new_n89_ & ~x40) | (~x09 & (new_n87_ | ~new_n88_))));
  assign new_n87_ = (~x29 | ~x39) & (~new_n74_ | (x04 & x27));
  ...
  assign new_n94_ = x27 & ((x40 & (new_n95_ | new_n96_)) | (new_n96_ & ~x09));
  ...
  assign z18 = (~new_n107_ & x08) | (x09 & x40) | (~new_n108_ & ~x09);
  assign new_n107_ = (~new_n74_ | x09 | x27) & (~z08 | ~x29);
  assign new_n108_ = ~x30 & (~new_n74_ | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (new_n110_ | (~x08 & (~x27 | ~x35)));
  assign new_n110_ = (~z08 | ~x29) & (~x35 | (~x27 & x28));
  assign z19 = (x09 & ~x40) | (~x30 & ((~new_n89_ & ~x40) | (~x09 & (new_n87_ | ~new_n88_))));
endmodule
