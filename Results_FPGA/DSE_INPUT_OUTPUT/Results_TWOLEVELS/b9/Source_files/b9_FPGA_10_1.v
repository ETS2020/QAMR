...
module FAU ( 
  ...
  assign new_n71_ = new_n72_ & (x27 | (x40 & (~x04 | x08)));
  ...
  assign z14 = new_n97_ | (~new_n95_ & (~x40 | (x39 & (x04 | x13))));
  ...
  assign z18 = new_n103_ | ~new_n104_ | new_n65_ | x30;
  assign new_n103_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x40));
