...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n72_, new_n73_,
    ...
    new_n111_;
  assign z00 = (~new_n65_ & (~x21 | ~x40)) | (~x04 & ~x15 & new_n66_ & ~x21);
  assign new_n65_ = x16 & (x15 | ~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n66_ = x39 & x40 & (x10 | (x27 & (x35 | x36)));
  assign z01 = (~x30 & ~x32 & (new_n69_ | ~x27)) | new_n68_ | ~x04;
  assign new_n68_ = x21 & x40;
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = new_n71_ | (~new_n72_ & ~x40) | new_n73_ | ~x39 | (x21 & x40);
  assign new_n71_ = ~x02 & (~x08 | ~x29);
  assign new_n72_ = (~x27 | (x04 ? (x09 | x30) : (x28 | ~x35))) & (x09 | x30 | (~x28 & x35)) & ~x09 & x27 & ~x30;
  assign new_n73_ = x04 & (x28 | ~x35 | (~x08 & ~x27));
  assign z03 = (~x27 & ~x37 & (~x21 | ~x40)) | (~x21 & (x37 | (x27 & x28))) | (x21 & x40) | (x27 & (~x28 | ~x35));
  assign z04 = (~x27 & ~x37 & (~x21 | ~x40)) | (x27 & (~x28 | ~x35)) | (x21 & (x40 | (~x40 & (x37 | (x27 & x28)))));
  assign z05 = (x37 | (x27 & x28)) & (~x21 | (x21 & ~x40));
  assign z06 = ~x37 & ~new_n68_ & (~x27 | ~x28);
  assign z07 = x03 & ~new_n68_ & (new_n80_ | (new_n79_ & ~x31));
  ...
  assign z10 = ~new_n86_ | (~x04 & (new_n85_ | (x27 & ~new_n69_ & ~new_n84_)));
  assign new_n84_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n86_ = (~x06 | ~x27 | ~x37) & (~x21 | ~x40);
  assign z11 = ~x09 & ~x30 & ((~new_n89_ & ~new_n90_) | (~new_n88_ & ~x08));
  assign new_n88_ = (x27 | (x21 & x40)) & (x21 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (x21 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n93_ | (x21 & x40) | (~new_n92_ & (x04 | ~x39 | ~x40));
  ...
  assign new_n97_ = ~x21 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n99_ & (new_n100_ | ~new_n101_)) | new_n102_ | new_n68_ | (~new_n92_ & ~new_n101_);
  ...
  assign z18 = new_n108_ | (~new_n68_ & (new_n107_ | x09 | x30));
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n108_ = x08 & ~x21 & x29 & x39 & x40;
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n110_ | ~new_n111_));
  assign new_n110_ = (~x29 | ~x39) & ((~x27 & x28) | (~x21 & ~x35));
  assign new_n111_ = (x08 | ((x21 | (x27 & x35)) & (x27 | x40))) & (x40 | (x35 & (x27 | ~x28)));
