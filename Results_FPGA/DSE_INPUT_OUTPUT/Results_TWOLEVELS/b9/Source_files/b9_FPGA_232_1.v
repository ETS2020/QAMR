...
module FAU ( 
  ...
  assign z03 = new_n67_ | ~x21 | (~new_n67_ & (x27 ? ~new_n74_ : ~x37));
  assign new_n74_ = x28 & x35;
  assign z04 = ~new_n67_ & ((~new_n74_ & x27) | x21 | (~x27 & ~x37));
  ...
  assign new_n87_ = (~x40 | (~x29 & x39)) & (~new_n70_ | (x04 & x27));
  assign new_n88_ = (x27 | (~x39 & x40)) & (~x39 | (new_n70_ & ~x04));
  assign z12 = ~new_n90_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n90_ = (x27 | (x40 & (~x04 | ~x40))) & (x39 | ~x40) & (x37 | new_n74_ | (~x04 & x40));
  assign z13 = new_n96_ | (~new_n92_ & x27);
  assign new_n92_ = (~x39 | (~new_n93_ & (x18 | ~new_n94_ | x19))) & (x18 | ~new_n95_ | x19);
  ...
  assign z14 = (x40 & (~x39 | (x04 & ~x27))) | ~new_n98_ | (~new_n102_ & ~x27);
