...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : x03;
  ...
  assign new_n88_ = (x27 | (~x03 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n90_ = x40 ? (x29 & x39) : ~x03;
  assign z12 = new_n92_ | (~x03 & ~x40) | (~new_n93_ & (x40 ? (x04 | ~x39) : x03));
  assign new_n92_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n95_ | (~x04 & new_n96_ & ~x13))) | (~x04 & new_n85_ & ~x13);
  assign new_n95_ = ~x18 & ~x19 & x20 & ~new_n66_ & ~new_n68_;
  assign new_n96_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : ~x03;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x40 | (~new_n102_ & (new_n93_ | new_n100_))) & (~x03 | new_n93_ | x40);
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (x03 | x40)));
endmodule
