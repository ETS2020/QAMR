// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:00 2020
...
module FAU ( 
  ...
  assign z08 = x39 & (~x40 | (x40 & (~new_n82_ | (~x09 & ~new_n84_ & ~x30))));
  ...
  assign z10 = new_n88_ | (x27 & (new_n87_ | (x06 & ~new_n65_ & x37)));
  assign new_n87_ = ~x04 & ~new_n69_ & ((x07 & ~x39) | (x05 & x39 & x40));
  assign new_n88_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n90_ | (~new_n91_ & ~x08));
  assign new_n90_ = (~x39 | (~x29 & x39 & x40)) & (~new_n72_ | (x04 & x27));
  assign new_n91_ = (x27 | (x39 & (~x39 | ~x40))) & (~x40 | (~x28 & (~x39 | (~x04 & x35))));
  assign z12 = (x40 & (new_n93_ | (~new_n66_ & x04))) | (~new_n66_ & ~x39);
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n97_ | (x27 & (new_n95_ | new_n96_));
  assign new_n95_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n97_ = x39 & (~x40 | (~x04 & ~x13 & (x30 | x32)));
  assign z14 = new_n99_ | new_n100_ | new_n65_ | new_n103_;
  assign new_n99_ = ~new_n66_ & (x13 | ~x39 | (x04 & x40));
