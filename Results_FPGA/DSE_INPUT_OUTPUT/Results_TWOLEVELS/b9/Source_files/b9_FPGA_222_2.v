...
module FAU ( 
  ...
  assign z12 = new_n89_ | (x39 & ~x40) | ((~x39 | (x04 & x40)) & (new_n88_ | ~x27));
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign new_n89_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n91_ | (x39 & (~x40 | (~x04 & ~new_n83_ & ~x13)));
