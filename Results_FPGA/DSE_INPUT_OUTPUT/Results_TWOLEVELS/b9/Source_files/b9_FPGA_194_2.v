...
module FAU ( 
  ...
  assign z08 = x39 & x40;
  assign new_n69_ = x09 & ~x40;
  assign z01 = new_n71_ | new_n69_ | ~x04;
  assign new_n71_ = ~x30 & ~x32 & (~x27 | (~x36 & (~x35 | (x27 & x28))));
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x09;
  ...
  assign z06 = ~x37 & ((~x09 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign z10 = ~new_n84_ | (~x04 & ((new_n85_ & x05) | (new_n83_ & x27)));
  assign new_n83_ = (x36 | (~x28 & x35)) & (z08 ? x05 : x07);
  assign new_n84_ = ~new_n69_ & (~x06 | ~x27 | ~x37);
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = (x09 & ~x40) | (~x30 & ((~new_n89_ & ~x40) | (~x09 & (new_n87_ | ~new_n88_))));
  assign new_n87_ = (~x29 | ~x39) & (x28 | ~x35 | (x04 & x27));
  assign new_n88_ = (x35 | (x08 & x40)) & (x08 | (~x04 & x27 & ~x28));
  assign new_n89_ = ~x28 & (~x04 | ~x27);
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x09 & ~x40 & (new_n66_ | ~x27));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x04 & x39;
  assign z13 = (~new_n94_ & x27) | new_n69_ | (~x04 & new_n85_ & ~x13);
  assign new_n94_ = (~new_n95_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n97_ | ~new_n101_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n97_ = ~x37 & ((~new_n98_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n98_ = (~x40 | (~x04 & x39)) & ~x13 & (x09 | x40);
  assign new_n99_ = ~new_n100_ & ~x13 & x39 & x40 & (~x04 | ~x40);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = (x40 | (~x09 & (x09 | x27))) & (x27 | ((new_n102_ | ~x40) & (x30 | x32)));
  ...
  assign z18 = ~new_n108_ | (~new_n107_ & x08);
  assign new_n107_ = (x27 | x28 | ~x35) & (~z08 | ~x29);
  assign new_n108_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & (new_n110_ | (~x08 & (~x27 | ~x35)));
  assign new_n110_ = (~z08 | ~x29) & (~x35 | (~x27 & x28));
  assign z19 = z11;
endmodule
