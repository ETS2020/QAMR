// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:15 2020
...
module FAU ( 
  ...
  assign z12 = (x39 & (new_n90_ | (~new_n66_ & x04))) | (~new_n66_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x27 & (new_n92_ | new_n93_));
  assign new_n92_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n94_ = x40 & (~x39 | (~x04 & ~x13 & (x30 | x32)));
  assign z14 = new_n96_ | ~new_n99_ | (~new_n97_ & (x18 | x19 | ~x20));
  assign new_n96_ = ~new_n66_ & (x13 | ~x40 | (x04 & x39));
  assign new_n97_ = ~new_n98_ & ~x04 & ~x13 & x40;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = (x39 | ~x40) & (x30 | x32 | (~new_n100_ & (x27 | ~x39)));
  assign new_n100_ = x28 & ~x35 & ~x37;
  assign z15 = new_n65_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = new_n65_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n105_ | ~new_n106_ | new_n65_ | x30;
  assign new_n105_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x40));
