...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n78_,
    ...
    new_n93_, new_n94_, new_n96_, new_n97_, new_n98_, new_n103_, new_n104_,
    new_n106_, new_n107_;
  ...
  assign z02 = (~new_n72_ & x40) | ~x39 | (x39 & ~x40) | (x04 & ~x08 & ~x27);
  ...
  assign new_n87_ = x39 & (x29 | ~x40);
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n89_ = (x27 | (x39 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n65_ & x04))) | (~new_n65_ & ~x39);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n93_ | (x39 & (~x40 | (~x04 & ~new_n84_ & ~x13)));
  ...
  assign z20 = new_n67_ | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = ~new_n107_ & (x35 | (x39 & (~x40 | (x08 & x29))));
  assign new_n107_ = ~x27 & ((x28 & (~x29 | ~x39)) | (~x08 & (~x39 | x40)));
endmodule
