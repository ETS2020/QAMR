...
module FAU ( 
  ...
  assign new_n86_ = (~z08 | ~x29) & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = ~x08 & ((x40 & (x04 | x28)) | ~x27 | ~x35);
  assign z12 = new_n89_ | (~x39 & ~x40) | ((new_n66_ | ~x27) & (x04 | ~x39 | ~x40));
  assign new_n89_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x27 & (new_n91_ | (new_n93_ & ~x18)));
  assign new_n91_ = x39 & (new_n92_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n92_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x19 & x20 & ~new_n66_ & x40;
  assign new_n94_ = ~x04 & new_n84_ & ~x13;
  assign z14 = (~new_n100_ & ~x27) | new_n96_ | new_n99_ | new_n69_;
  ...
  assign new_n100_ = ~x04 & x39 & x40 & (~x40 | (~x13 & (x30 | x32)));
