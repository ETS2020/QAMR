// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:25 2020
...
module FAU ( 
  ...
  assign new_n83_ = ~x04 & ~new_n69_ & ((x07 & (~x39 ^ ~x40)) | (x05 & x39 & x40));
  assign new_n84_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n86_ & ~x08));
  assign new_n86_ = (x27 | (~x39 & ~x40)) & (~x39 | (new_n72_ & ~x04));
  assign new_n87_ = (x39 ? (~x29 | ~x40) : x40) & (~new_n72_ | (x04 & x27));
  assign z12 = new_n89_ | (~x39 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x39));
  ...
  assign new_n95_ = x40 ? (~new_n96_ & ~x04 & ~x13 & x39) : ~x39;
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = (~x40 | (~new_n98_ & (new_n66_ | (~x04 & ~x13 & x39)))) & (~x39 | new_n66_ | x40);
  ...
  assign z18 = (~new_n103_ & x08) | ~new_n104_ | new_n65_ | x30;
  assign new_n103_ = (~new_n72_ | x27) & (~x29 | ~x39 | ~x40);
  assign new_n104_ = ~x09 & (~new_n72_ | x04 | ~x27);
  ...
  assign z19 = ~x09 & ~x30 & (new_n87_ | (~new_n86_ & ~x08));
endmodule
