...
module FAU ( 
  ...
  assign z00 = (~x15 & ~new_n65_ & x27) | new_n67_ | ~x16;
  assign new_n65_ = new_n66_ & (x04 | ~x39 | ~x40 | (~x35 & ~x36));
  assign new_n66_ = ~x37 & (~x28 | ~x35);
  assign new_n67_ = x10 & x40;
  assign z01 = ~new_n67_ & (~x04 | (~x30 & (new_n69_ | ~x27) & ~x32));
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = (~new_n71_ & x40) | ~new_n72_ | (~x27 & (~x40 | (x04 & ~x08)));
  assign new_n71_ = ~x10 & (x02 | (x08 & x29));
  assign new_n72_ = (~x04 | (~x28 & x35)) & x39 & (x40 | (x04 & (~x27 | x28)));
  ...
  assign new_n83_ = ~new_n69_ & ((x07 & (~x40 | (~x10 & ~x39))) | (x05 & ~x10 & x39 & x40));
  assign new_n84_ = x06 & ~new_n67_ & x37;
  assign new_n85_ = x05 & new_n86_ & ~x10;
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~x08) | (~new_n89_ & ~new_n90_));
  assign new_n88_ = (x27 | (x10 & x40)) & (x10 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (x10 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (~new_n92_ & ~x37) | (~new_n67_ & ~x27);
  assign new_n92_ = ((x28 & x35) | (x40 & (new_n93_ | x10))) & (x10 | x35 | x36);
  assign new_n93_ = ~x04 & x39;
  assign z13 = new_n98_ | (x27 & ((~new_n95_ & ~x10) | (new_n97_ & ~x18)));
  ...
  assign new_n98_ = ~x04 & ~x10 & new_n86_ & ~x13;
  assign z14 = ~new_n102_ | (~new_n100_ & (x18 | x19 | ~x20));
  assign new_n100_ = x40 & (x10 | (~new_n101_ & x39 & (~x40 | (~x04 & ~x13))));
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = (x10 | (~new_n103_ & (new_n104_ | (~new_n66_ & x27)))) & ((~new_n66_ & x27) | x40);
  ...
  assign z18 = (~new_n109_ & (~x10 | ~x40)) | (x08 & ~x10 & x29 & x39 & x40);
  ...
  assign new_n114_ = ~x08 & ((~x10 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
