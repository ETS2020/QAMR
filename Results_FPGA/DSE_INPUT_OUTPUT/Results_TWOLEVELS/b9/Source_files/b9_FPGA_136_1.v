...
module FAU ( 
  ...
  assign z03 = ((x39 | ~x40) & (~x21 | (~new_n74_ & x27))) | (~x27 & ~x37 & (~x40 | (x39 & x40)));
  assign new_n74_ = x28 & x35;
  assign z04 = (~x27 & ~x37 & (~x40 | (x39 & x40))) | (x27 & ~new_n74_ & (x39 | ~x40)) | x21 | (~x39 & x40);
  ...
  assign new_n97_ = ~new_n66_ & (x13 | ~x40 | (x04 & x39));
