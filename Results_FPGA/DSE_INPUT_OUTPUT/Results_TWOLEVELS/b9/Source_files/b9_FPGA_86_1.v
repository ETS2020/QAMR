// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:07 2020
...
module FAU ( 
  ...
  assign z02 = new_n72_ | ~new_n73_ | (x04 & (~x35 | (~x08 & ~x27)));
  assign new_n72_ = x39 & ((~x02 & (~x08 | ~x29)) | (x04 & x28));
  assign new_n73_ = x40 ? x39 : (~x09 & x27 & (~x27 | x28) & ~x30 & (x09 | ~x28 | x30));
  ...
  assign new_n84_ = (~x27 | new_n70_ | (x40 ? ~x05 : ~x07)) & (~x05 | new_n85_ | ~x40);
  assign new_n85_ = ~x30 & ~x32;
  assign z11 = new_n69_ | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = ~new_n89_ & (new_n88_ | (x40 & (x29 | ~x39)));
  assign new_n88_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n89_ = ~x08 & (~x27 | ~x35 | (x39 & (x04 | x28)));
  assign z12 = new_n91_ | (~x39 & x40) | ((new_n66_ | ~x27) & (~x40 | (x04 & x39)));
  assign new_n91_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n93_ | (x40 & (~x39 | (~x04 & ~new_n85_ & ~x13)));
  assign new_n93_ = x27 & (new_n94_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n94_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n97_ | (~new_n96_ & (~x40 | (x39 & (x04 | x13))));
  assign new_n96_ = ~new_n66_ & x20 & x27 & ~x18 & ~x19;
  assign new_n97_ = ~x30 & ~x32 & x39 & (~x27 | (~new_n98_ & x28));
  ...
  assign z20 = new_n106_ | new_n69_;
  assign new_n106_ = ~x09 & ~x30 & (~new_n107_ | (~x08 & (~x27 | ~x35)));
  assign new_n107_ = (x27 | ~x28 | (x29 & x40)) & (x35 | (x40 & (x29 | ~x39)));
  assign z19 = new_n69_ | (~x09 & ~new_n87_ & ~x30);
endmodule
