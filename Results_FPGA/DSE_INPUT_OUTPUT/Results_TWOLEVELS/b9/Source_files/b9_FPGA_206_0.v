...
module FAU ( 
  ...
  assign new_n69_ = x40 & (x32 | ((x36 | (x35 & (~x28 | ~x40))) & (x27 | ~x40)));
  assign z02 = (~new_n71_ & x40) | (x04 & ~x08 & ~x27) | ~x39 | ~x40;
  assign new_n71_ = (x02 | (x08 & x29)) & (new_n72_ | ~x04);
  ...
  assign new_n83_ = ~x04 & ~new_n84_ & (new_n72_ | x36);
  assign new_n84_ = (~x07 | (x40 ? x39 : ~x30)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x30 & (~x40 | (new_n87_ & ~x09));
  assign new_n87_ = x40 & ((~new_n88_ & (~new_n72_ | (x04 & x27))) | (~x08 & (~new_n72_ | x04 | ~x27)));
  assign new_n88_ = x29 & x39;
  assign z12 = new_n90_ | (~x30 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x30));
  ...
  assign new_n95_ = x20 & x30 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : ~x30;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x40 | ((new_n66_ | new_n100_) & (~new_n102_ | x30))) & (~x30 | new_n66_ | x40);
  ...
  assign z18 = ~new_n107_ | (x08 & (new_n88_ | (new_n72_ & ~x27)));
  assign new_n107_ = (new_n108_ | ~x27) & (~x30 | (~x37 & (x27 | x37))) & ~x09 & (x30 | x40);
  assign new_n108_ = x28 ? ~x30 : (~x30 & (x04 | ~x35));
  assign z19 = ~x09 & new_n87_ & ~x30;
  assign z20 = ~x30 & (~x40 | (~new_n111_ & ~x09));
  assign new_n111_ = (~x40 | ((new_n88_ | x35) & (x08 | (x27 & x35)))) & (x27 | new_n88_ | ~x28);
endmodule
