...
module FAU ( 
  ...
  assign z02 = new_n73_ | (x18 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  assign new_n72_ = x39 & (~x04 | (~x28 & x35 & (x08 | x27)));
  assign new_n73_ = ~x40 & (x09 | ~x27 | (x27 & ~x28) | x30 | (~x09 & x28 & ~x30));
  assign z03 = new_n75_ | (~new_n67_ & (~x21 | (x27 & ~x35) | (~x27 & ~x37)));
  assign new_n75_ = x27 & ~x28 & (~x40 | (x18 & (x04 | (~x04 & x35))));
  assign z04 = (~new_n67_ & (x27 ? ~x35 : ~x37)) | new_n75_ | new_n67_ | x21;
  ...
  assign z10 = (new_n87_ & ~x04) | (x27 & (new_n86_ | (new_n85_ & ~x04)));
  assign new_n85_ = ~new_n70_ & ((x07 & (~x40 | (x18 & ~x39))) | (x05 & x18 & x39 & x40));
  ...
  assign new_n90_ = x40 & (~x18 | (x29 & x39));
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x18 & (new_n93_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  ...
  assign new_n97_ = x18 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n102_ | new_n103_ | (x18 & (~new_n99_ | (~new_n101_ & x04)));
  assign new_n99_ = ~new_n100_ & ~x13 & x39 & x40;
  assign new_n100_ = ~x30 & ~x32 & (~x27 | (x28 & (~x35 | ~x36)));
  assign new_n101_ = x27 & ~x28;
  assign new_n102_ = ~x28 & ((x04 & x18 & x27) | (~x37 & ~x40));
  assign new_n103_ = ~x40 & (x19 | ~x20 | ~x27 | (~x35 & ~x37));
  assign z15 = x12 & x26 & x27 & ~new_n67_ & x34;
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n67_ & ~x24;
  assign z18 = (~new_n108_ & (x18 | ~x40)) | (x08 & x18 & x29 & x39 & x40);
  ...
  assign new_n112_ = (~x29 | ~x39) & ((x18 & ~x35) | (~x27 & x28));
  assign new_n113_ = (x08 | ((~x18 | (x27 & x35)) & (x27 | x40))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
