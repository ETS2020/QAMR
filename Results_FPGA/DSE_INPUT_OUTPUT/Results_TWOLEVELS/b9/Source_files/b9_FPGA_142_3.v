...
module FAU ( 
  ...
  assign z03 = (~x21 & (~x04 | ~x27)) | (~x04 & x27 & (~x35 | (~x28 & x35))) | (~x27 & ~x37);
  assign z04 = (~x04 & x27 & (~x35 | (~x28 & x35))) | (~x27 & ~x37) | (x21 & (~x04 | ~x27));
  ...
  assign z08 = x39 & x40 & (~x04 | (x04 & ~x27));
  ...
  assign new_n86_ = (x04 | x08) & (new_n87_ | (x04 & x27));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = (x04 & (x27 | (new_n66_ & ~x27))) | (~x10 & (new_n89_ | ~x27)) | (~new_n66_ & (~x27 | (new_n90_ & ~x04)));
  assign new_n89_ = ~x35 & ~x36 & ~x37;
  assign new_n90_ = ~x37 & (~x28 | ~x35);
  assign z13 = ~x04 & (new_n94_ | (x27 & (new_n92_ | new_n93_)));
  assign new_n92_ = ~x18 & ~x19 & ~new_n90_ & x20;
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ((~new_n66_ | x13) & (~x27 | (~new_n96_ & ~x04))) | new_n97_ | (new_n66_ & x04 & ~x27);
  assign new_n96_ = ~new_n90_ & ~x18 & ~x19 & x20;
  assign new_n97_ = ~x30 & ~x32 & (~x27 | (~x04 & ~new_n98_ & x28));
  ...
  assign z18 = (x08 & (new_n71_ | new_n87_)) | ~new_n103_ | (x27 & (x04 | (new_n71_ & ~x04)));
  assign new_n103_ = ~x09 & ~x30;
  assign z20 = (x04 & x27) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (x27 & (x04 | x35))) & (new_n87_ | ((x04 | x35) & (x27 | (~x28 & x35))));
  assign z19 = ~x09 & ~x30 & ((~new_n86_ & ~new_n71_) | (~x08 & ~x27));
endmodule
