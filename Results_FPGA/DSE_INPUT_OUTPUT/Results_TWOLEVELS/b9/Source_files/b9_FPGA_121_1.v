...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x39) | (~x40 & (~x27 | (x27 & x28) | x37 | (~x28 & ~x37)));
  ...
  assign new_n85_ = (~x05 | ~x39 | ~x40) & (~x07 | x40);
  assign new_n86_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n74_ | (~x09 & ~x30 & (~new_n88_ | new_n89_));
  assign new_n88_ = (x08 | ((new_n70_ | ~x39) & (x27 | (~x39 & x40)))) & (new_n70_ | (x40 & (x29 | ~x39)));
  assign new_n89_ = x04 & ((x27 & (~x40 | (~x29 & x39 & x40))) | (~x08 & x39 & x40));
  assign z12 = (x39 & (new_n91_ | (x04 & (new_n66_ | (~x27 & x40))))) | (~x40 & (new_n66_ | ~x27));
  ...
  assign new_n102_ = ~x04 & ~x13 & x40;
  assign new_n103_ = x40 & (~x39 | (x04 & ~x27 & x39));
  assign new_n104_ = ~x27 & (x13 | ~x40 | (~x30 & ~x32 & x39));
  ...
  assign new_n110_ = ((x40 & (~x39 | ~x40)) | (~x09 & ~x30)) & (~x39 | ~x40 | ~x08 | ~x29);
  assign z19 = ~x09 & ~x30 & (~new_n88_ | new_n89_);
  assign z20 = ~x09 & ~new_n113_ & ~x30;
  assign new_n113_ = ~new_n114_ & (x08 | ((x27 | (~x39 & x40)) & (x35 | ~x39)));
  assign new_n114_ = (~x40 | (~x29 & x39)) & (~x35 | (~x27 & x28));
  assign z06 = ~z05;
endmodule
