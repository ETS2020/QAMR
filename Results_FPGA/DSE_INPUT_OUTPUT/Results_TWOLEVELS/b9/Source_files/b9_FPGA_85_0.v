...
module FAU ( 
  ...
  assign z06 = ~x37 & ((x00 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign new_n87_ = x40 ? (x29 & x39) : ~x00;
  assign new_n88_ = (x27 | (~x00 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n90_ | ~new_n92_ | (~new_n91_ & ~x37);
  assign new_n90_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n91_ = ((~x04 & x39) | (x28 & x35)) & (x40 | (x35 & (~x00 | x28)));
  assign new_n92_ = (x40 | (x00 & x27)) & (x27 | (x39 & (~x04 | ~x40)));
  assign z13 = (~new_n94_ & x27) | new_n67_ | (~x04 & new_n84_ & ~x13);
  assign new_n94_ = (~new_n95_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n97_ | new_n100_ | ~new_n101_ | (new_n103_ & ~x30);
  assign new_n97_ = (new_n98_ | ~new_n99_) & (x18 | x19 | ~x20);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n100_ = (x04 | x13) & (new_n66_ | (~x27 & x40));
  assign new_n101_ = (new_n102_ | (x39 & x40)) & (x00 | x40) & (x28 | x37 | (x39 & (~x00 | x40)));
  assign new_n102_ = x27 & (x35 | x37);
  assign new_n103_ = ~x32 & ((~x27 & x40) | (x28 & ~x35 & ~x37));
  assign z15 = new_n67_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n67_ & ~x24;
  assign z18 = (~new_n108_ & ~new_n67_) | (z08 & x08 & x29);
  assign new_n108_ = ~new_n109_ & ~x09 & ~x30;
  assign new_n109_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n111_ & ~x09;
  assign new_n111_ = ~x30 & (new_n112_ | (~new_n87_ & (~x35 | (~x27 & x28))));
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (x00 | x40)));
