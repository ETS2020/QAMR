...
module FAU ( 
  ...
  assign new_n89_ = (x27 | (x29 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n91_ | (x29 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : ~x29));
  ...
  assign new_n96_ = x20 & ~x29 & (x37 | (x28 & x35));
  assign new_n97_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n102_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = x40 ? (~new_n100_ & new_n101_) : x29;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (~x40 | (~new_n103_ & (new_n66_ | new_n101_))) & (x29 | new_n66_ | x40);
  ...
  assign z18 = (x08 & x29 & x39 & x40) | (~new_n108_ & (~x29 | x40));
  assign new_n108_ = ~new_n109_ & ~x09 & ~x30;
  assign new_n109_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n65_ | (~x09 & ~new_n111_ & ~x30);
  assign new_n111_ = ~new_n112_ & (x35 | (x29 & (~x40 | (x08 & x39))));
  assign new_n112_ = ~x27 & ((x28 & (~x29 | ~x39)) | (~x08 & (~x29 | x40)));
endmodule
