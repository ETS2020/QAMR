...
module FAU ( 
  ...
  assign new_n87_ = (x40 ? (~x29 | ~x39) : x39) & (~new_n72_ | (x04 & x27));
  ...
  assign new_n98_ = ~new_n99_ & ~new_n90_ & (new_n66_ | (~x04 & ~x13 & x39));
  ...
  assign new_n104_ = ~x09 & (~new_n72_ | x04 | ~x27) & ~new_n65_ & ~x30;
  assign z20 = ~x09 & ~new_n106_ & ~x30;
  assign new_n106_ = ~new_n107_ & (x08 | ((x35 | ~x40) & (x27 | (~x39 & ~x40))));
  assign new_n107_ = (x40 ? (~x29 | ~x39) : x39) & (~x35 | (~x27 & x28));
