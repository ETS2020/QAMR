...
module FAU ( 
  ...
  assign new_n84_ = ~new_n85_ & (~x28 | (x29 & x40)) & (x35 | (x40 & (x29 | ~x39)));
  assign new_n85_ = ~x08 & ((~x27 & (x39 | ~x40)) | x28 | (~x35 & x39));
  assign new_n86_ = x04 & ((x27 & (~x40 | (~x29 & x40))) | (~x08 & x40));
  ...
  assign new_n94_ = ~x04 & ~x13 & x39 & ~new_n82_ & x40;
  assign z14 = new_n102_ | new_n96_ | new_n99_ | (~new_n97_ & ~x37);
  assign new_n96_ = ~x27 & (new_n82_ | ~x40 | (x04 & x39));
  assign new_n97_ = (new_n98_ | (x28 & x35)) & (x32 | x35 | ~x28 | x30);
  ...
  assign new_n111_ = (~x40 | (~x29 & x39)) & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
  assign z19 = new_n67_ | (~x09 & ~x30 & (~new_n84_ | new_n86_));
endmodule
