...
module FAU ( 
  ...
  assign z07 = x03 & ~new_n65_ & (new_n78_ | (new_n77_ & ~x31));
  ...
  assign new_n84_ = (x39 | x40) & (~x06 | ~x27 | ~x37);
  assign z11 = ~x09 & ~x30 & ((~new_n87_ & ~new_n88_) | (~new_n86_ & ~x08));
  assign new_n86_ = (x27 | (~x39 & ~x40)) & (~x39 | (~x28 & x35)) & (~x04 | ~x40);
  assign new_n87_ = x39 ? (x29 & x40) : ~x40;
  assign new_n88_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n90_ | (~x39 & ~x40) | (~new_n66_ & (x04 | ~x39 | ~x40));
  ...
  assign z14 = (~new_n96_ & (new_n97_ | ~new_n98_)) | new_n99_ | new_n65_ | (~new_n66_ & ~new_n98_);
  ...
  assign z20 = new_n65_ | (~x09 & ~x30 & (new_n107_ | ~new_n108_));
  assign new_n107_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n108_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((~x28 | x39) & (x08 | (~x39 & ~x40))));
