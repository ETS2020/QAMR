...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
    new_n74_, new_n75_, new_n81_, new_n82_, new_n86_, new_n87_, new_n90_,
    new_n91_, new_n92_, new_n94_, new_n95_, new_n96_, new_n97_, new_n99_,
    new_n100_, new_n101_, new_n102_, new_n103_, new_n105_, new_n106_,
    new_n107_, new_n108_, new_n109_, new_n110_, new_n115_, new_n117_,
    new_n118_;
  ...
  assign z02 = (x40 & ((~new_n73_ & ~x02) | new_n74_ | ~x39)) | (x39 & ~new_n75_ & ~x40);
  assign new_n73_ = x08 & x29;
  assign new_n74_ = x04 & ((~x08 & ~x27) | x28 | ~x35);
  assign new_n75_ = (~x27 | (x28 & x35 & (x18 | x19 | ~x20 | ~x28 | ~x35))) & x20 & x27 & ~x18 & ~x19;
  ...
  assign z10 = new_n87_ | (x27 & (new_n86_ | (x06 & ~new_n69_ & x37)));
  assign new_n86_ = ~x04 & ~new_n71_ & ((x05 & x39 & x40) | (x07 & (~x39 ^ ~x40)));
  ...
  assign z13 = new_n103_ | (~new_n99_ & x27);
  ...
  assign z14 = ~new_n107_ | (~new_n105_ & (x18 | x19 | ~x20));
  assign new_n105_ = x40 ? (~new_n106_ & ~x04 & ~x13 & x39) : ~x39;
  assign new_n106_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n107_ = (x30 | new_n108_ | x32) & ~new_n110_ & (new_n109_ | x37);
  assign new_n108_ = (x27 | ~x39) & (x37 | ~x40 | ~x28 | x35);
  assign new_n109_ = (~x04 | ((x35 | ~x40) & (x28 | ~x39))) & ((x28 & x35) | (x40 ? (~x13 & x39) : ~x39));
  assign new_n110_ = ~x27 & (x40 ? (x04 | x13 | ~x39) : x39);
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = new_n69_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = ((x39 | x40) & (new_n115_ | x09 | x30)) | (new_n73_ & x39 & x40);
  assign new_n115_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n117_ | ~new_n118_));
  assign new_n117_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n118_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((~x28 | x39) & (x08 | (~x39 & ~x40))));
endmodule
