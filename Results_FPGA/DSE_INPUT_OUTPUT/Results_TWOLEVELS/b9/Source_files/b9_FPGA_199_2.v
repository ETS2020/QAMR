...
module FAU ( 
  ...
  assign z02 = new_n71_ | ~new_n72_ | (x04 & (~x35 | (~x08 & ~x27)));
  assign new_n71_ = x40 & ((~x02 & (~x08 | ~x29)) | (x04 & x28));
  assign new_n72_ = x39 ? x40 : (~x09 & x27 & (~x27 | x28) & ~x30 & (x09 | ~x28 | x30));
  ...
  assign z11 = new_n67_ | (~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08)));
  ...
  assign new_n101_ = ~new_n67_ & (new_n95_ | x27);
  ...
  assign z19 = new_n67_ | (~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08)));
endmodule
