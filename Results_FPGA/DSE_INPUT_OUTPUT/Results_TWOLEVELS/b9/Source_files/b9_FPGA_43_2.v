...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n78_,
    ...
    new_n101_, new_n102_, new_n107_, new_n109_, new_n110_, new_n111_;
  ...
  assign new_n83_ = (new_n72_ | x36) & (z08 ? x05 : x07);
  ...
  assign new_n89_ = x40 ? (x29 & x39) : x25;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n92_ | (~new_n66_ & (x04 | ~x39)))) | (~x25 & ~new_n66_ & ~x40);
  ...
  assign new_n98_ = ~new_n66_ & ((x40 & (x04 | ~x39)) | x13 | (~x25 & ~x40));
  ...
  assign z18 = ~new_n107_ | (x08 & ((new_n72_ & ~x27) | (z08 & x29)));
  assign new_n107_ = ~new_n65_ & ~x30 & ~x09 & (~new_n72_ | x04 | ~x27);
  assign z20 = (x25 & ~x40) | (~x09 & ~x30 & (~new_n109_ | (~new_n111_ & ~x25)));
