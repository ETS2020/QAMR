// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:40 2020
...
module FAU ( 
  ...
  assign new_n71_ = new_n66_ & (x02 | x29);
  assign z03 = (x04 & ~x27 & (~x21 | ~x37)) | (x27 & (~x21 | ~x28 | ~x35));
  assign z04 = (x04 & ~x27 & (x21 | ~x37)) | (x27 & (x21 | ~x28 | ~x35));
  assign z05 = x37 | (~x04 & ~x27) | (x27 & x28);
  assign z06 = (~x27 & (~x04 | (x04 & ~x37))) | (~x28 & ~x37);
  ...
  assign z12 = ~x27 | (~x37 & (new_n89_ | (~x10 & ~x35 & ~x36)));
  assign new_n89_ = (~x28 | ~x35) & (x04 | (~new_n66_ & x27));
  ...
  assign z14 = (x04 & (~new_n96_ | ~x27)) | (x27 & (new_n94_ | (~new_n96_ & (~new_n66_ | x13))));
  assign new_n94_ = x28 & ~x30 & ~new_n95_ & ~x32;
  assign new_n95_ = (x35 | x37) & ((x35 & x36) | (~x18 & ~x19 & x20));
  ...
  assign new_n103_ = (x08 | (x27 & (~x27 | x35))) & (new_n87_ | ((~x27 | x35) & (~x04 | (x35 & (x27 | ~x28)))));
