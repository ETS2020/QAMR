...
module FAU ( 
  ...
  assign z11 = new_n67_ | (new_n85_ & ~x09);
  assign new_n85_ = ~x30 & (new_n86_ | new_n88_ | (~new_n87_ & ~x08));
  assign new_n86_ = (~x29 | ~x39) & (x28 | (x04 & x27));
  assign new_n87_ = (x27 | (x39 & ~x40)) & ~x04 & ~x28 & (x35 | ~x40);
  assign new_n88_ = ~x35 & (~x39 | (~x29 & x40));
  ...
  assign z14 = new_n98_ | new_n99_ | new_n67_ | new_n102_;
  assign new_n98_ = (new_n90_ | ~x27) & (x13 | ~x39 | (x04 & x40));
  ...
  assign z08 = x39;
  assign z19 = new_n67_ | (new_n85_ & ~x09);
endmodule
