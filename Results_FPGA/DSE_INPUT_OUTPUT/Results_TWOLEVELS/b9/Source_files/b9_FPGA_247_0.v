...
module FAU ( 
  ...
  assign z01 = (x27 & (~x04 | (~x30 & new_n69_ & ~x32))) | (x04 & ~x27 & ~x30 & ~x32);
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n71_ | (~x02 & (~x08 | ~x29));
  assign new_n71_ = (~x04 | (~x28 & x35)) & new_n66_ & (x27 | (x04 & x08));
  assign z03 = (~x27 & (~x04 | (x04 & ~x37))) | ~x21 | (~new_n73_ & x27);
  assign new_n73_ = x28 & x35;
  assign z04 = (x04 & (x21 | (~x27 & ~x37))) | (x27 & (~x28 | x21 | ~x35));
  assign z05 = (x27 & (x28 | (~x28 & x37))) | (x04 & ~x27 & x37);
  assign z06 = x27 ? (~x28 & ~x37) : (~x04 | (x04 & ~x37));
  ...
  assign new_n83_ = (new_n69_ | ((x39 & x40) ? ~x05 : ~x07)) & (~x05 | ~x39 | new_n84_ | ~x40);
  assign new_n84_ = ~x30 & ~x32;
  assign z11 = ~x09 & ~x30 & ((~new_n86_ & x27) | (~new_n87_ & x04));
  assign new_n86_ = ((~x28 & x35) | (new_n66_ & x08 & x29)) & (~x04 | (new_n66_ & x29));
  assign new_n87_ = x08 & (new_n88_ | (x35 & (x27 | ~x28)));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = (~x37 & ((~new_n73_ & (x04 | (~new_n66_ & x27))) | new_n90_ | (x04 & ~x27))) | (~x27 & (~x04 | (x04 & x37)));
  assign new_n90_ = ~x10 & ~x35 & ~x36;
  assign z13 = x27 & (new_n92_ | (~x04 & ~x13 & new_n93_ & x39));
  assign new_n92_ = ~x18 & ~x19 & x20 & (new_n73_ | x37);
  assign new_n93_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign z14 = (x04 & (~new_n95_ | ~x27)) | (x27 & (new_n96_ | (~new_n95_ & (~new_n66_ | x13))));
  assign new_n95_ = (new_n73_ | x37) & ~x18 & ~x19 & x20;
  assign new_n96_ = x28 & ~x30 & ~new_n97_ & ~x32;
  ...
  assign new_n104_ = (x08 | (x27 & (~x27 | x35))) & (new_n88_ | ((~x27 | x35) & (~x04 | (x35 & (x27 | ~x28)))));
  assign z19 = ~x09 & ~x30 & ((~new_n86_ & x27) | (~new_n87_ & x04));
endmodule
