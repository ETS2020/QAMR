...
module FAU ( 
  ...
  assign z07 = (x31 & ~x40) | (x03 & (new_n78_ | (new_n77_ & ~x31)));
  ...
  assign z12 = new_n89_ | (x31 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : ~x31));
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : x31;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n66_ | new_n99_))) & (x31 | new_n66_ | x40);
