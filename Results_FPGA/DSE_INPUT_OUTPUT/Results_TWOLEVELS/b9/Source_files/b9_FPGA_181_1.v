...
module FAU ( 
  ...
  assign z02 = new_n72_ | (x39 & (new_n71_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z14 = new_n99_ | (~x39 & x40) | (~new_n98_ & (x04 | x13 | ~x40));
  assign new_n98_ = ~new_n90_ & x20 & x27 & ~x18 & ~x19;
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (~new_n100_ & x28));
  assign new_n100_ = ((~x18 & ~x19 & x20) | (x35 & x36)) & (x35 | x37);
