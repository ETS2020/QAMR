...
module FAU ( 
  ...
  assign z02 = new_n73_ | ~new_n71_ | (~x27 & (~x39 | (x04 & ~x08)));
  assign new_n71_ = (new_n72_ | ~x04) & (~x39 | x40) & (x39 | (x04 & ~x09 & ~x30));
  assign new_n72_ = x35 & (x09 | ~x27 | x30 | x39);
  ...
  assign z10 = new_n85_ | (x27 & (new_n84_ | (x06 & ~new_n67_ & x37)));
  assign new_n84_ = ~x04 & ~new_n69_ & ((x07 & ~x39) | (x05 & x39 & x40));
  ...
  assign new_n110_ = ~new_n111_ & (x35 | (x39 & (~x40 | (x08 & x29))));
  assign new_n111_ = ~x27 & ((x28 & (~x29 | ~x39)) | (~x08 & (~x39 | x40)));
endmodule
