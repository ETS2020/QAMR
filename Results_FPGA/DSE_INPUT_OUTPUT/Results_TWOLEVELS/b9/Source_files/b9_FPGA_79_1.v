// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:03 2020
...
module FAU ( 
  ...
  assign z02 = new_n73_ | (x26 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z04 = (~new_n67_ & (x27 ? (~x28 | ~x35) : ~x37)) | new_n67_ | x21;
  ...
  assign z09 = (~x26 & x40) | (x11 & x26 & x27 & x34);
  assign z10 = (x27 & (new_n85_ | (new_n84_ & ~x04))) | (~x04 & new_n86_ & x05);
  assign new_n84_ = ~new_n70_ & ((x07 & (~x40 | (x26 & ~x39))) | (x05 & x26 & x39 & x40));
  assign new_n85_ = x06 & ~new_n67_ & x37;
  assign new_n86_ = x26 & x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n67_;
  assign z19 = ~x09 & ~x30 & ((~new_n90_ & ~new_n91_) | (~new_n89_ & ~x08));
  assign new_n89_ = (x27 | (~x26 & x40)) & (~x26 | (~x04 & ~x28 & x35));
  assign new_n90_ = x40 & (~x26 | (x29 & x39));
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n93_ | (~x26 & x40) | (~new_n68_ & (x04 | ~x39 | ~x40));
  assign new_n93_ = ~x10 & ((x26 & ~x27) | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n95_ & x27) | (~x04 & new_n86_ & ~x13);
  assign new_n95_ = (~new_n98_ | x18) & (~x26 | ((~new_n96_ | x04) & (~new_n97_ | x18)));
  ...
  assign new_n100_ = new_n101_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n101_ = ~x04 & ~x13 & x39 & x40;
  assign new_n102_ = ~new_n103_ & new_n104_ & (x37 | new_n101_ | (x28 & x35));
  assign new_n103_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n104_ = (x26 | ~x40) & (x27 | (~x04 & (~x13 | ~x26) & x39 & x40));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n109_ & (x26 | ~x40)) | (x08 & x26 & x29 & x39 & x40);
  ...
  assign new_n113_ = ~x08 & ((x26 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
