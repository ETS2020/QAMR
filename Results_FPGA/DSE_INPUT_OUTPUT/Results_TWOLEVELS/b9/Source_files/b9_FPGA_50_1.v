...
module FAU ( 
  ...
  assign z14 = new_n95_ | ~new_n97_ | (~new_n100_ & (x04 | x13));
  assign new_n95_ = ~x37 & ((~new_n96_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n96_ = ~x13 & x40 & (~x04 | ~x39);
  assign new_n97_ = ~new_n98_ & ~new_n65_ & (new_n99_ | (~x18 & ~x19 & x20));
  assign new_n98_ = ~x27 & (~x40 | (~x30 & ~x32));
  assign new_n99_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n100_ = ~x18 & ~x19 & x20 & (x27 | ~x39);
