...
module FAU ( 
  ...
  assign new_n87_ = (x27 | (~x34 & ~x40)) & ~x04 & ~x28 & (x35 | ~x40);
  assign new_n88_ = (~x04 | ~x27) & ~x28 & (x35 | ~x40);
  assign new_n89_ = ~x40 & ((x04 & x27) | x28 | (x34 & ~x35));
  ...
  assign new_n112_ = x40 ? (x29 & x39) : ~x34;
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (x34 | x40)));
