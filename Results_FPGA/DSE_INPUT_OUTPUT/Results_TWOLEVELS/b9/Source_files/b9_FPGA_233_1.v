...
module FAU ( 
  ...
  assign new_n72_ = x39 & (~x04 | (new_n73_ & (x08 | x27)));
  ...
  assign new_n83_ = (~x27 | new_n70_ | (new_n84_ ? ~x05 : ~x07)) & (~new_n85_ | ~x05);
  assign new_n84_ = x39 & x40;
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = new_n67_ | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (new_n88_ | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & x27 & (~x02 | ~x04)));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = (~new_n68_ & ~x40) | (x02 & (new_n90_ | (~new_n68_ & (x04 | ~x39))));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n93_ | (new_n92_ & ~x04))) | (~new_n94_ & x40);
  ...
  assign new_n97_ = x39 & x40 & ~x13 & (~x02 | ~x04);
  assign new_n98_ = ~new_n99_ & new_n101_ & (x37 | new_n100_ | (x28 & x35));
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n100_ = (~x02 | (~x04 & x39)) & ~x13 & x40;
  assign new_n101_ = (x02 | ~x40) & (x27 | (x40 & (~x02 | (~x04 & ~x13 & x39))));
  assign z15 = new_n67_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n106_ | (x08 & (new_n88_ | (new_n73_ & ~x27)));
  assign new_n106_ = ~new_n67_ & ~x09 & ~x30 & (~new_n73_ | x04 | ~x27);
  assign z20 = new_n67_ | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & (new_n88_ | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
  assign z19 = new_n67_ | (~x09 & ~new_n87_ & ~x30);
endmodule
