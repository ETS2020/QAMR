...
module FAU ( 
  ...
  assign z02 = ~new_n73_ | (~x08 & (~x02 | (x04 & ~x27)));
  assign new_n73_ = (new_n75_ | x40) & x39 & (~x40 | (x29 & (new_n74_ | ~x04)));
  assign new_n74_ = ~x28 & x35;
  assign new_n75_ = (~x27 | (x04 ? (x09 | x30) : (x28 | ~x35))) & (x09 | x30 | (~x28 & x35)) & ~x09 & x27 & ~x30;
  ...
  assign z11 = ~x09 & ~x30 & (new_n89_ | (~new_n90_ & ~x08));
  assign new_n89_ = ~z08 & (~new_n74_ | (x04 & x27));
  assign new_n90_ = (x27 | (~x29 & x40)) & (~x29 | (new_n74_ & ~x04));
  ...
  assign new_n96_ = x29 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n103_ | new_n98_ | new_n101_ | new_n102_;
