...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (x21 & ~new_n92_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n94_ & x27) | new_n69_ | (~x04 & new_n84_ & ~x13);
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x21;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x21 | new_n92_ | x40) & (~x40 | (~new_n101_ & (new_n92_ | new_n99_)));
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (x21 | x40)));
endmodule
