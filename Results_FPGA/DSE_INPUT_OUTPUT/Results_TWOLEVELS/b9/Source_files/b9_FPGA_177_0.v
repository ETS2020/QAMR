...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n91_ | ((x04 | ~x39) & (new_n66_ | ~x27)))) | (x39 & ~x40 & (new_n66_ | ~x27));
  ...
  assign new_n100_ = (~new_n101_ | x30) & new_n103_ & (~new_n102_ | x37);
  assign new_n101_ = ~x32 & ((~x27 & x39) | (x28 & ~x35 & ~x37));
  assign new_n102_ = (~x28 | ~x35) & ((x40 & (x04 | ~x39)) | x13 | (x39 & ~x40));
