...
module FAU ( 
  ...
  assign z03 = (~new_n75_ & (x40 ? x27 : ~x37)) | ~x21 | (x37 & ~x40) | (~x27 & ~x37);
  assign new_n75_ = x28 & x35;
  assign z04 = (~new_n75_ & (x40 ? x27 : ~x37)) | x21 | (x37 & ~x40) | (~x27 & ~x37);
  ...
  assign z10 = (~new_n85_ & ~x04) | (x37 & (~x40 | (x06 & x27)));
  ...
  assign new_n90_ = (x27 | (x37 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = ~new_n92_ | (~x10 & (new_n93_ | (~x35 & ~x36 & ~x37)));
  assign new_n92_ = ((~x04 & x39) | ((x27 | ~x40) & (new_n75_ | x37))) & (x37 | x40 | (new_n75_ & x27));
  assign new_n93_ = ~x27 & x40;
  assign z13 = (x27 & (new_n95_ | (new_n97_ & ~x04))) | new_n69_ | (new_n96_ & ~x04);
  assign new_n95_ = ~x18 & ~x19 & x20 & (new_n75_ | x37);
  ...
  assign new_n102_ = ~x30 & ~x32 & (new_n93_ | (x28 & ~x35 & ~x37));
