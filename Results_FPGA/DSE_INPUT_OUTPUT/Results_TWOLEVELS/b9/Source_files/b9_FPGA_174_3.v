...
module FAU ( 
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (~x24 & ~x39))) | (x39 & x40 & x05 & ~x24));
  ...
  assign new_n88_ = (x27 | (x24 & x40)) & (x24 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (x24 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n92_ | (x24 & x40) | (~new_n93_ & (~x40 | (~x24 & (x04 | ~x39))));
  assign new_n92_ = ~x10 & ((~x24 & ~x27) | (~x35 & ~x36 & ~x37));
  ...
  assign new_n99_ = ~x24 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (x24 | (~new_n103_ & (new_n93_ | new_n101_))) & (new_n93_ | x40);
  ...
  assign z18 = (~new_n108_ & (~x24 | ~x40)) | (x08 & ~x24 & x29 & x39 & x40);
  assign new_n108_ = ~new_n109_ & ~x09 & ~x30;
  assign new_n109_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n111_ | ~new_n112_));
  assign new_n111_ = (~x29 | ~x39) & ((~x27 & x28) | (~x24 & ~x35));
  assign new_n112_ = (x08 | ((x24 | (x27 & x35)) & (x27 | x40))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
