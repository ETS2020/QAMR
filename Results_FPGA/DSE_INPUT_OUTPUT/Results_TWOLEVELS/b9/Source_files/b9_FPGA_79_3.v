...
module FAU ( 
  ...
  assign z14 = new_n104_ | new_n100_ | new_n103_ | new_n105_;
  assign new_n100_ = (new_n101_ | ~new_n102_) & (x18 | x19 | ~x20);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13 & x39 & x40;
  assign new_n103_ = ~x37 & ((~new_n102_ & (~x28 | ~x35)) | (x28 & ~x30 & ~x32 & ~x35));
  assign new_n104_ = x40 & (x26 | (x13 & ~x27));
  assign new_n105_ = ~x27 & (~x39 | ~x40 | x04 | (~x30 & ~x32));
  assign z15 = ~x40 & x34 & x27 & x12 & x26;
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n110_ & (~x26 | ~x40)) | (x08 & ~x26 & x29 & x39 & x40);
  ...
  assign new_n114_ = ~x08 & ((~x26 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
