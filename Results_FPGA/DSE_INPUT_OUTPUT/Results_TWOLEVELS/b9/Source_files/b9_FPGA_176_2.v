...
module FAU ( 
  ...
  assign z11 = new_n65_ | (new_n86_ & ~x09);
  assign new_n86_ = ~x30 & (new_n87_ | new_n89_ | (~new_n88_ & ~x08));
  assign new_n87_ = (~x29 | ~x39) & (x28 | (x04 & x27));
  assign new_n88_ = (x27 | (x29 & ~x40)) & ~x28 & (~x40 | (~x04 & x35));
  assign new_n89_ = ~x35 & (~x29 | (~x39 & x40));
  ...
  assign z18 = new_n108_ | ~new_n109_ | new_n65_ | x30;
  assign new_n108_ = x08 & ((x29 & x39) | (~x27 & ~x28 & x35));
  assign new_n109_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~x09 & ~new_n111_ & ~x30;
  assign new_n111_ = ~new_n112_ & (x08 | ((x35 | ~x40) & (x27 | (x29 & ~x40))));
  assign new_n112_ = (~x35 | (~x27 & x28)) & (~x29 | (~x39 & x40));
  assign z19 = new_n65_ | (new_n86_ & ~x09);
endmodule
