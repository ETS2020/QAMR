...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x33;
  ...
  assign z07 = (~x33 & ~x40) | (x03 & (new_n78_ | (~x31 & new_n77_ & ~x33)));
  assign new_n77_ = (x15 | ~x17) & (~x38 | (x00 & ~x25));
  ...
  assign new_n83_ = (~new_n84_ | ~x05) & (~x27 | new_n69_ | (new_n80_ ? ~x05 : ~x07));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n65_;
  assign z19 = ~x09 & ~x30 & ((~new_n88_ & ~new_n89_) | (~new_n87_ & ~x08));
  assign new_n87_ = (x27 | (~x33 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : ~x33;
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n91_ | new_n65_ | (~new_n66_ & (~new_n80_ | x04));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x27) | (~x04 & new_n84_ & ~x13);
  ...
  assign new_n96_ = x20 & x33 & (x37 | (x28 & x35));
  assign z14 = (~new_n98_ & (x18 | x19 | ~x20)) | ~new_n100_ | new_n101_;
  assign new_n98_ = ~new_n99_ & new_n80_ & ~x04 & ~x13;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~new_n65_ & (new_n66_ | (new_n80_ & ~x04 & ~x13));
  ...
  assign z20 = new_n65_ | (~x09 & ~x30 & (new_n109_ | ~new_n110_));
  assign new_n109_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & x40));
  assign new_n110_ = (~x33 | ((x08 | x27) & (x35 | x40))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
endmodule
