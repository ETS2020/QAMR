...
module FAU ( 
  ...
  assign new_n71_ = x04 & ((~x08 & ~x27) | ~x35 | (x28 & x39));
  assign z03 = (~new_n67_ & (x27 ? (~x28 | ~x35) : ~x37)) | new_n67_ | ~x21;
  ...
  assign z08 = x39 & (~x40 | (x40 & ((x04 & (x28 | (~x28 & ~x37))) | ~x04 | x37)));
  ...
  assign new_n91_ = (new_n92_ | (x39 & (~x04 | ~x40))) & (~x39 | x40) & (x28 | x37 | (x39 & (~x04 | ~x39 | ~x40)));
  assign new_n92_ = x27 & (x35 | x37);
  assign z13 = (x27 & (new_n94_ | new_n95_)) | (x39 & (new_n96_ | ~x40));
  assign new_n94_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & (x30 | x32);
  assign z14 = new_n102_ | (x40 & (new_n98_ | new_n100_ | (~new_n96_ & ~x27)));
  assign new_n98_ = ~x37 & (~new_n99_ | (x04 & (~x35 | (~x28 & x39))));
  assign new_n99_ = (~x13 | (x28 & x35)) & (~x28 | x30 | x32 | x35);
  assign new_n100_ = (x18 | x19 | ~x20) & (new_n101_ | x04 | x13);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x39 & (~new_n103_ | (~x37 & (~x28 | ~x35)));
  ...
  assign new_n108_ = x08 & ((x29 & x39) | (~x27 & ~x28 & x35));
