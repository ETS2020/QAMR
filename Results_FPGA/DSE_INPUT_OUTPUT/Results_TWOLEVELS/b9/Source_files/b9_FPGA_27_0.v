...
module FAU ( 
  ...
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n86_ & ~x08));
  assign new_n86_ = (x27 | (~x39 & ~x40)) & (~x39 | (new_n87_ & ~x04));
  assign new_n87_ = ~x28 & x35;
  assign new_n88_ = (x39 ? (~x29 | ~x40) : x40) & (~new_n87_ | (x04 & x27));
  assign z12 = (x40 & (new_n90_ | (~new_n91_ & (x04 | ~x39)))) | (x39 & ~new_n91_ & ~x40);
  ...
  assign new_n100_ = (~x39 | new_n91_ | x40) & (~x40 | (~new_n101_ & (new_n91_ | (~x04 & ~x13 & x39))));
  ...
  assign new_n106_ = (~new_n87_ | x27) & (~x29 | ~x39 | ~x40);
  assign new_n107_ = ~x09 & (~new_n87_ | x04 | ~x27);
  assign z20 = new_n68_ | (~x09 & ~x30 & (new_n109_ | ~new_n110_));
  assign new_n109_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n110_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((x08 | (~x39 & ~x40)) & (~x28 | x39)));
  assign z19 = ~x09 & ~x30 & (new_n88_ | (~new_n86_ & ~x08));
endmodule
