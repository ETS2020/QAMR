...
module FAU ( 
  ...
  assign new_n71_ = x04 & ((~x08 & ~x27) | x28 | (~x35 & x39));
  ...
  assign new_n84_ = (~x40 | (~x29 & x39)) & (~new_n85_ | (x04 & x27));
  assign new_n85_ = ~x28 & x35;
  assign new_n86_ = (x27 | (~x39 & x40)) & (~x39 | (new_n85_ & ~x04));
  ...
  assign z18 = ~new_n103_ | (x08 & ((x29 & x40) | (new_n85_ & ~x27)));
  assign new_n103_ = ~x09 & (~new_n85_ | x04 | ~x27) & ~new_n67_ & ~x30;
  assign z20 = new_n67_ | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = ~new_n106_ & (x35 | (x40 & (~x39 | (x08 & x29))));
  assign new_n106_ = ~x27 & ((~x08 & (x39 | ~x40)) | (x28 & (~x29 | ~x40)));
  assign z08 = x40;
