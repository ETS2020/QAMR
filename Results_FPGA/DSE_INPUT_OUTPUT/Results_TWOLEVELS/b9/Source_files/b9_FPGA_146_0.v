...
module FAU ( 
  ...
  assign z11 = new_n69_ | (~x09 & ~x30 & (~new_n87_ | (~new_n89_ & ~x08)));
  assign new_n87_ = ((x29 & x40) | (~new_n88_ & ~x28 & (x35 | ~x39))) & (x39 | (~new_n88_ & ~x28 & (x35 | ~x40)));
  assign new_n88_ = x04 & x27;
  assign new_n89_ = (x27 | (~x39 & ~x40)) & ~x28 & (~x39 | (~x04 & x35));
  assign z12 = x39 ? (new_n91_ | ((new_n66_ | ~x27) & (x04 | ~x40))) : (x40 & (new_n66_ | ~x27));
  ...
  assign new_n100_ = ~new_n101_ & new_n103_ & (~new_n102_ | x37);
  assign new_n101_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n102_ = (~x28 | ~x35) & ((x39 & (x04 | ~x40)) | x13 | (~x39 & x40));
  assign new_n103_ = (x39 | (x40 & (x27 | ~x40))) & (x27 | ~x39 | (~x04 & ~x13 & x40));
  ...
  assign new_n112_ = (~x35 | (~x27 & x28)) & (x39 ? (~x29 | ~x40) : x40);
  assign z19 = new_n69_ | (~x09 & ~x30 & (~new_n87_ | (~new_n89_ & ~x08)));
endmodule
