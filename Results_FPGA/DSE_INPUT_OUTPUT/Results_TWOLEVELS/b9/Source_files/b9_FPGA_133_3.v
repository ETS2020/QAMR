...
module FAU ( 
  ...
  assign z02 = (~new_n74_ & x40) | new_n75_ | ~x39 | (~new_n73_ & ~x40);
  assign new_n73_ = (x18 | x19 | ~x20 | new_n66_ | ~x27) & ~new_n66_ & ~x18 & ~x19 & x20 & x27;
  assign new_n74_ = (x02 | (x08 & x29)) & ~x06 & (~x04 | ~x28);
  ...
  assign new_n90_ = (x27 | (x06 & x40)) & (x06 | (~x28 & x35 & (~x04 | ~x40)));
  assign z12 = new_n93_ | ~new_n92_ | (x40 & (x06 | (x04 & ~x27)));
  assign new_n92_ = (x37 | (x28 & x35) | (new_n68_ & ~x04)) & (new_n68_ | x27);
  assign new_n93_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (~new_n95_ & x27) | (~x04 & ~x06 & new_n86_ & ~x13);
  assign new_n95_ = (x06 | ((~new_n96_ | x04) & (~new_n97_ | x18))) & (~new_n98_ | x18);
  ...
  assign new_n105_ = (~x06 | ~x40) & (x27 | (x39 & x40 & (~x40 | (~x04 & ~x13))));
