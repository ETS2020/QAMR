// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:20 2020
...
module FAU ( 
  ...
  assign new_n68_ = x06 & x40;
  assign z01 = new_n70_ | new_n68_ | ~x04;
  assign new_n70_ = ~x30 & ~x32 & (~x27 | (~x36 & (x28 | ~x35)));
  assign z02 = ~new_n72_ | new_n74_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = (~x04 | (~x28 & x35)) & ~new_n73_ & ~new_n68_ & x39;
  assign new_n73_ = ~x40 & (x09 | (x27 & ~x28) | x30 | (~x09 & x28 & ~x30));
  ...
  assign z18 = (~new_n110_ & (~x06 | ~x40)) | (~x06 & x08 & x29 & x39 & x40);
  ...
  assign new_n114_ = ~x08 & ((~x06 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
