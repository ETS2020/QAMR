...
module FAU ( 
  ...
  assign new_n82_ = ~new_n69_ & ((x07 & (x40 ? ~x39 : x24)) | (x05 & x39 & x40));
  assign new_n83_ = x06 & ~new_n65_ & x37;
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & (x40 ? (~x29 | ~x39) : x24);
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (~x24 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (x24 & ~new_n66_ & ~x40);
  ...
  assign z14 = new_n96_ | new_n98_ | (~x40 & (~x24 | (x24 & ~x27))) | (~x27 & ~new_n101_ & x40);
  assign new_n96_ = ~x37 & ((~new_n97_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n97_ = (~x40 | (~x04 & x39)) & ~x13 & (~x24 | x40);
  assign new_n98_ = ~new_n99_ & (new_n100_ | ~z08 | x04 | x13);
  assign new_n99_ = ~x18 & ~x19 & x20;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39 & (x30 | x32);
  ...
  assign new_n106_ = (x27 | x28 | ~x35) & (~z08 | ~x29);
  assign new_n107_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = (~x24 & ~x40) | (~x09 & ~x30 & (~new_n109_ | (~new_n111_ & x24)));
