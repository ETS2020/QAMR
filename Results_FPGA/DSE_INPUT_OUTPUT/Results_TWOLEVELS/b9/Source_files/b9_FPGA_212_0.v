// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:16 2020
...
module FAU ( 
  ...
  assign z11 = new_n69_ | (~x09 & ~x30 & (new_n86_ | new_n87_));
  assign new_n86_ = (~z08 | ~x29) & (x28 | ~x35 | (x04 & x27));
  assign new_n87_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = new_n90_ | new_n89_ | (~x39 & (~x27 | ~x40)) | (~x27 & (~x40 | (x04 & x40)));
  assign new_n89_ = ~x37 & (~x28 | ~x35) & (~z08 | x04);
  ...
  assign new_n95_ = ~x04 & new_n84_ & ~x13;
  ...
  assign new_n99_ = ((~x04 & ~x13) | (~new_n66_ & (x27 | ~x40))) & (x39 | x40) & ((x39 & x40) | (~new_n66_ & x27));
  ...
  assign z18 = (~new_n105_ & (x39 | x40)) | (x39 & x40 & x08 & x29);
  assign new_n105_ = ~new_n106_ & ~x09 & ~x30;
  assign new_n106_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & ((z08 & x29) | (x35 & (x27 | ~x28)));
  assign z19 = new_n69_ | (~x09 & ~x30 & (new_n86_ | new_n87_));
endmodule
