...
module FAU ( 
  ...
  assign new_n72_ = new_n73_ & (~x04 | (~x28 & x35 & (x08 | x27)));
  ...
  assign z10 = (new_n85_ & ~x04) | (x27 & (new_n84_ | (~x04 & ~new_n70_ & ~new_n87_)));
  assign new_n84_ = x06 & ~new_n69_ & x37;
  assign new_n85_ = new_n86_ & x05;
  assign new_n86_ = x19 & x39 & x40 & (x30 | x32);
  assign new_n87_ = (~x07 | (x40 & (~x19 | x39))) & (~x39 | ~x40 | ~x05 | ~x19);
  assign z11 = ~x09 & ~x30 & (new_n89_ | (~new_n91_ & ~x08));
  assign new_n89_ = ~new_n90_ & (~x40 | (x19 & (~x29 | ~x39)));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n91_ = (x27 | (~x19 & x40)) & (~x19 | (~x04 & ~x28 & x35));
  assign z12 = new_n94_ | new_n69_ | ((new_n66_ | ~x27) & (~new_n93_ | x04));
  ...
  assign new_n97_ = x19 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ~new_n99_ | (~x27 & (~x40 | (x19 & ~x30 & ~x32)));
  assign new_n99_ = ~new_n101_ & (~x19 | (~new_n100_ & new_n93_ & ~x04 & ~x13));
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x40 & (x18 | ~x20 | (~x37 & (~x28 | ~x35)));
  ...
  assign new_n106_ = (x27 | x28 | ~x35) & (~new_n93_ | ~x29);
  assign new_n107_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n109_ | ~new_n110_));
  assign new_n109_ = (~x29 | ~x39) & ((x19 & ~x35) | (~x27 & x28));
  assign new_n110_ = (x08 | ((x27 | x40) & (~x19 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
