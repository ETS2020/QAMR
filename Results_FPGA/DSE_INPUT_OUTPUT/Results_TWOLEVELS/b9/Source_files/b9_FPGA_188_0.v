...
module FAU ( 
  ...
  assign z13 = ~new_n91_ | (x27 & (new_n93_ | (new_n92_ & ~x04)));
  assign new_n91_ = ~new_n65_ & (x04 | ~new_n83_ | x13);
  ...
  assign new_n97_ = (new_n66_ | new_n99_) & (x30 | new_n98_ | x32);
  assign new_n98_ = (x27 | ~x39) & (x37 | ~x40 | ~x28 | x35);
  assign new_n99_ = x40 ? (~x04 & ~x13 & x39) : ~x39;
  ...
  assign new_n104_ = (x27 | x28 | ~x35) & (~z08 | ~x29);
