...
module FAU ( 
  ...
  assign z02 = ~new_n72_ | (x40 & (~new_n74_ | (~x02 & (~x08 | ~x29))));
  assign new_n72_ = (x27 | (~new_n73_ & x40)) & x39 & (x40 | ((~x27 | ~x28) & ~x37 & (x28 | x37)));
  assign new_n73_ = x04 & ~x08;
  assign new_n74_ = ~x07 & (~x04 | (~x28 & x35));
  ...
  assign new_n85_ = (~x05 | x07 | ~x39 | ~x40) & (~x07 | x40);
  assign new_n86_ = x05 & ~x07 & x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n67_;
  assign z19 = ~x09 & ~x30 & ((~new_n90_ & ~new_n91_) | (~new_n89_ & ~x08));
  assign new_n89_ = (x27 | (x07 & x40)) & (x07 | (~x04 & ~x28 & x35));
  assign new_n90_ = x40 & (x07 | (x29 & x39));
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n93_ | (x07 & x40) | (~new_n68_ & (~x40 | (~x07 & (x04 | ~x39))));
  ...
  assign new_n97_ = ~x07 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n101_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = x40 & (x07 | (~new_n100_ & x39 & (~x40 | (~x04 & ~x13))));
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = (x07 | (~new_n102_ & ~new_n103_ & ~new_n104_)) & (new_n68_ | x40);
  assign new_n102_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n103_ = ~x37 & (~x28 | ~x35) & (x04 | x13 | ~x39);
  assign new_n104_ = ~x27 & (x04 | ~x39 | (x13 & x40));
  assign z15 = x12 & x26 & x27 & ~new_n67_ & x34;
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n67_ & ~x24;
  assign z18 = (new_n109_ & ~x28) | new_n110_ | (~new_n67_ & (x09 | x30));
  assign new_n109_ = x35 & ((~x04 & x27 & (~x07 | (x07 & ~x40))) | (x08 & ~x27 & (~x07 | ~x40)));
  assign new_n110_ = ~x07 & x08 & x29 & x39 & x40;
  assign z20 = new_n67_ | (~x09 & ~x30 & (new_n112_ | ~new_n113_));
  assign new_n112_ = (~x29 | ~x39) & ((~x27 & x28) | (~x07 & ~x35));
  assign new_n113_ = (x08 | ((x27 | x40) & (x07 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
  assign z06 = ~z05;
endmodule
