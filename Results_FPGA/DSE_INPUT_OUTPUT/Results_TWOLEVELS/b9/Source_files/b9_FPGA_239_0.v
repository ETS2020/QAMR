...
module FAU ( 
  ...
  assign new_n87_ = (x27 | (~x12 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 ? (x29 & x39) : ~x12;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = (x40 & (new_n91_ | (~new_n66_ & (x04 | ~x39)))) | (x12 & ~new_n66_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n94_ | (new_n93_ & ~x04))) | new_n65_ | (new_n95_ & ~x04);
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x12;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x12 | new_n66_ | x40) & (~x40 | (~new_n101_ & (new_n66_ | new_n99_)));
