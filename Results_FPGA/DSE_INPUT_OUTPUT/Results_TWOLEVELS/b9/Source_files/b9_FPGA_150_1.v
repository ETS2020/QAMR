...
module FAU ( 
  ...
  assign z11 = (~x27 & (x40 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n86_ & ~x30);
  ...
  assign z13 = (new_n92_ & ~x18) | (x40 & (new_n93_ | ~x27));
  assign new_n92_ = ~x19 & x20 & ~new_n65_ & x27;
  assign new_n93_ = ~x04 & ~x13 & x39 & (~new_n94_ | ~x28 | x30);
  assign new_n94_ = ~x32 & (~x35 | ~x36);
  assign z14 = ~x27 | new_n97_ | (~new_n96_ & (x18 | x19 | ~x20));
  assign new_n96_ = (~x28 | ~new_n94_ | x30) & new_n83_ & ~x04 & ~x13;
  assign new_n97_ = ~x37 & ((~new_n98_ & (~x28 | ~x35)) | (x28 & ~x30 & ~x32 & ~x35));
  assign new_n98_ = ~x13 & x40 & (~x27 | (~x04 & x39));
  ...
  assign new_n103_ = ~x09 & (x27 | ~x40) & ~x30 & (~new_n69_ | x04 | ~x27);
  assign z20 = (~x27 & x40) | (~x09 & ~new_n105_ & ~x30);
  assign new_n105_ = (x08 | (x27 & x35)) & (x27 | ~x28) & (new_n87_ | x35);
  assign z19 = (~x27 & (x40 | (~x08 & ~x09 & ~x30))) | (~x09 & ~new_n86_ & ~x30);
endmodule
