...
module FAU ( 
  ...
  assign z02 = (~new_n73_ & x40) | (x04 & (x28 | (~x08 & ~x27))) | (~x40 & (~x04 | ~x27 | (x27 & ~x28)));
  assign new_n73_ = (x02 | (x08 & x29)) & x39 & (~x04 | x35);
  ...
  assign new_n86_ = (~x40 | (~x29 & x39)) & (~new_n70_ | (x04 & x27));
  assign new_n87_ = (x27 | (~x39 & x40)) & (~x39 | (new_n70_ & ~x04));
  assign z12 = ~new_n89_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n89_ = (x27 | (x40 & (~x04 | ~x40))) & (x39 | ~x40) & (x37 | new_n66_ | (~x04 & x40));
  assign z13 = new_n95_ | (~new_n91_ & x27);
  assign new_n91_ = (~x39 | (~new_n92_ & (x18 | ~new_n93_ | x19))) & (x18 | ~new_n94_ | x19);
  ...
  assign z14 = (x40 & (~x39 | (x04 & ~x27))) | ~new_n97_ | (~new_n101_ & ~x27);
