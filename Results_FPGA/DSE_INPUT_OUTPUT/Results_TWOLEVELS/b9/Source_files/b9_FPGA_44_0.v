...
module FAU ( 
  ...
  assign z01 = (~new_n69_ & (~x04 | (~x27 & ~x30 & ~x32))) | (~x30 & new_n71_ & ~x32);
  assign new_n71_ = ~x36 & x40 & (x28 | ~x35);
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : x36;
  ...
  assign z10 = ~new_n85_ | (~x04 & ((~new_n83_ & x27) | (new_n86_ & x05)));
  assign new_n83_ = (new_n84_ | ((~x07 | x39) & (~x05 | ~x39 | ~x40))) & (~x07 | x40);
  ...
  assign new_n88_ = (~z08 | ~x29) & ((x04 & x27) | x28 | ~x35);
  assign new_n89_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = new_n91_ | (~x36 & ~x40) | (~new_n92_ & (x40 ? (x04 | ~x39) : x36));
  assign new_n91_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n94_ & x27) | new_n69_ | (~x04 & new_n86_ & ~x13);
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x36;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n92_ | new_n99_))) & (~x36 | new_n92_ | x40);
  ...
  assign z18 = (z08 & x08 & x29) | (~new_n106_ & ~new_n69_);
  ...
  assign z19 = new_n69_ | (~x09 & ~x30 & (new_n88_ | new_n89_));
endmodule
