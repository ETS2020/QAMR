...
module FAU ( 
  ...
  assign z12 = (~new_n89_ & ~x37) | (~x27 & (new_n90_ | ~x10));
  assign new_n89_ = ((x28 & x35) | (~new_n90_ & (x10 | x40))) & (x10 | x35 | x36);
  assign new_n90_ = x40 & (x04 | ~x39);
  ...
  assign z14 = (~new_n96_ & ~x37) | ~new_n98_ | (~new_n102_ & (x04 | ~x39));
  assign new_n96_ = (new_n97_ | (x28 & x35)) & (x32 | x35 | ~x28 | x30);
  assign new_n97_ = (~x40 | (~x04 & x39)) & ~x13 & (x10 | x40);
  assign new_n98_ = ~new_n99_ & (~x10 | x40) & (new_n100_ | (~new_n101_ & ~x13 & x40));
  assign new_n99_ = ~x27 & (x13 | ~x40 | (~x30 & ~x32));
  ...
  assign new_n107_ = ~new_n87_ & (x27 | x28 | ~x35);
  assign new_n108_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n65_ | (~x09 & ~new_n110_ & ~x30);
