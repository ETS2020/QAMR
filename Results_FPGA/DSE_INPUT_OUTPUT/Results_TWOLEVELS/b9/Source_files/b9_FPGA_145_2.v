...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x40) | (~new_n74_ & ~x39);
  ...
  assign new_n88_ = ~x04 & ~new_n70_ & ((x07 & ~x39) | (x05 & x39 & x40));
  assign new_n89_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n91_ | (~new_n92_ & ~x08));
  assign new_n91_ = (~x39 | (~x29 & x39 & x40)) & (~new_n73_ | (x04 & x27));
  assign new_n92_ = (x27 | (x39 & (~x39 | ~x40))) & (~x39 | ~x40 | (new_n73_ & ~x04));
  assign z12 = new_n94_ | (x39 & ~x40) | ((new_n66_ | ~x27) & (~x39 | (x04 & x40)));
  assign new_n94_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  ...
  assign new_n100_ = ~new_n66_ & ~x18 & ~x19 & x20 & x27;
  ...
  assign z18 = (x39 & x40 & x08 & x29) | (~new_n107_ & (~x39 | (x39 & x40)));
  assign new_n107_ = ~new_n108_ & ~x09 & ~x30;
  assign new_n108_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = ~new_n111_ & (x35 | (x39 & (~x39 | ~x40 | (x08 & x29))));
  assign new_n111_ = ~x27 & ((~x08 & (~x39 | (x39 & x40))) | (x28 & (~x39 | (~x29 & x40))));
