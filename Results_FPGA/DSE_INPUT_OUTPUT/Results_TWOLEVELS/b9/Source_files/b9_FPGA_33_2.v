...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x08 | ~x29)) | ~x39 | new_n73_ | (x39 & ~x40);
  ...
  assign new_n86_ = ((x29 & x39) | (new_n70_ & (~x04 | ~x27))) & (x08 | (new_n70_ & ~x04 & x27));
  assign z12 = new_n88_ | (x39 & ~x40) | ((new_n66_ | ~x27) & (x04 | ~x39));
  assign new_n88_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n90_ | (x39 & (~x40 | (new_n92_ & ~x04)));
  assign new_n90_ = x27 & (new_n91_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n91_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n92_ = ~x13 & (x30 | x32);
  assign z14 = new_n94_ | ~new_n96_ | (~new_n95_ & (x04 | x13 | ~x39));
  assign new_n94_ = ~x27 & ((~new_n92_ & x40) | x04 | ~x39);
