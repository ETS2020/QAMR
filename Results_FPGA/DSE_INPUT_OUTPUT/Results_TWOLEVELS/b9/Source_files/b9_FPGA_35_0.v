...
module FAU ( 
  ...
  assign z12 = new_n91_ | new_n92_ | (~x39 & (~x27 | ~x40)) | (~x27 & (~x40 | (x04 & x40)));
  assign new_n91_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x37 & (((x04 | ~x39) & (~x28 | ~x35)) | (~x40 & (~x35 | (~x28 & x39))));
  ...
  assign new_n98_ = ~new_n99_ & ~x13 & x39 & x40 & (~x04 | ~x40);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = new_n101_ & ((~x04 & ~x13) | (~new_n66_ & (x27 | ~x40)));
  assign new_n101_ = ((x39 & x40) | (x27 & (x35 | x37))) & (x39 | x40) & (x28 | x37 | (x39 & (~x39 | x40)));
