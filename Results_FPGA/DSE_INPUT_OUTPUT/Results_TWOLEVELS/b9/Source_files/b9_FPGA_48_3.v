...
module FAU ( 
  ...
  assign new_n72_ = ~x34 & (~x04 | (~x28 & x35));
  ...
  assign new_n99_ = (~new_n100_ | x30) & ~new_n67_ & (new_n68_ | new_n98_);
  assign new_n100_ = ~x32 & ((~x27 & ~x34) | (x28 & ~x35 & ~x37));
  assign z15 = ~x40 & x34 & x27 & x12 & x26;
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n67_ & ~x24;
  assign z18 = (~new_n105_ & x08) | ~new_n106_ | new_n67_ | x30;
  assign new_n105_ = ~new_n89_ & (x27 | x28 | ~x35);
  ...
  assign z19 = new_n67_ | (~x09 & ~new_n88_ & ~x30);
endmodule
