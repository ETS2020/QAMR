...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (x40 ? x39 : x01)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = ~x04 & new_n86_ & x05;
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = (x01 & ~x40) | (~x09 & ~x30 & (~new_n88_ | (~new_n91_ & ~x01)));
  ...
  assign z12 = (x40 & (new_n93_ | (~new_n66_ & (x04 | ~x39)))) | (~x01 & ~new_n66_ & ~x40);
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n95_ | (~x04 & new_n97_ & ~x13))) | (~x04 & new_n86_ & ~x13);
  assign new_n95_ = ~x18 & new_n96_ & ~x19;
  assign new_n96_ = x20 & (~x01 | x40) & (x37 | (x28 & x35));
  assign new_n97_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ~new_n102_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = x40 ? (~new_n100_ & new_n101_) : x01;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (x01 | new_n66_ | x40) & (~x40 | (~new_n103_ & (new_n66_ | new_n101_)));
  ...
  assign z18 = ~new_n108_ | (x08 & (new_n89_ | (new_n70_ & ~x27)));
  assign new_n108_ = ~new_n65_ & ~x30 & ~x09 & (~new_n70_ | x04 | ~x27);
  assign z20 = new_n110_ & ~x09;
  assign new_n110_ = ~x30 & (new_n112_ | (~new_n111_ & (~x35 | (~x27 & x28))));
  assign new_n111_ = x40 ? (x29 & x39) : x01;
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x01 | x40)));
  assign z19 = (x01 & ~x40) | (~x09 & ~x30 & (~new_n88_ | (~new_n91_ & ~x01)));
endmodule
