// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:33 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
    new_n78_, new_n79_, new_n83_, new_n84_, new_n86_, new_n87_, new_n88_,
  ...
  assign z02 = ~x40 | (~x38 & (~new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n78_ = (x15 | ~x17) & (~x38 | (x00 & ~x25 & ~x40));
  assign new_n79_ = ~x14 & (~x38 | (~x40 & (x00 | x25)));
  assign z08 = x40 & ~x38 & x39;
  assign z09 = x11 & x26 & x27 & ~new_n69_ & x34;
  assign z10 = (~new_n83_ & ~x04) | new_n69_ | (x06 & x27 & x37);
  assign new_n83_ = (~new_n84_ | ~x05) & (~x27 | new_n71_ | (new_n68_ ? ~x05 : ~x07));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & (~x40 | (~x38 & (~x29 | ~x39)));
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (x38 & x40)) & (x38 | (~x04 & ~x28 & x35));
  assign z12 = (~x38 & (new_n90_ | (~new_n91_ & (x04 | ~x39)))) | (~new_n91_ & ~x40);
  ...
  assign new_n95_ = ~x38 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n100_ | ((new_n97_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n97_ = ~x38 & (new_n98_ | ~new_n99_);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (new_n91_ | x40) & (x38 | (~new_n101_ & (new_n91_ | new_n99_)));
  ...
  assign z18 = (~new_n106_ & x08) | ~new_n107_ | new_n69_ | x30;
  assign new_n106_ = (~new_n68_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n107_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n109_ | ~new_n110_));
  assign new_n109_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & ~x38));
  assign new_n110_ = (x35 | (x40 & (x08 | x38))) & (x27 | ((x08 | (x38 & x40)) & (~x28 | x40)));
  assign z05 = ~z06;
