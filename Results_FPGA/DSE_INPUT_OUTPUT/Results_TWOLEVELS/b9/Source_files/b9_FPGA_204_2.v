...
module FAU ( 
  ...
  assign z03 = (~x21 & (x40 | (x27 & ~x37))) | (x27 & x40 & (~x28 | ~x35)) | (~x37 & (~x27 | ~x28 | (~x35 & ~x40)));
  assign z04 = (x27 & x40 & (~x28 | ~x35)) | (~x40 & (x37 | (~x35 & ~x37))) | x21 | (~x37 & (~x27 | ~x28));
  ...
  assign new_n89_ = (new_n90_ | (x27 & (x37 | (x28 & x35)))) & (x40 | (~x37 & (x35 | x37) & x27 & x28));
  assign new_n90_ = ~x04 & x39;
  assign new_n91_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = ((new_n93_ | new_n95_) & x27) | (~x04 & new_n83_ & ~x13);
  ...
  assign z14 = (~new_n97_ & (x18 | x19 | ~x20)) | ~new_n99_ | new_n102_;
  assign new_n97_ = ~new_n98_ & new_n90_ & x40 & (~x13 | ~x40);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = (new_n100_ | x37) & (new_n101_ | x27) & (x40 | (x27 & x28 & ~x37));
  assign new_n100_ = (x35 | x40) & ((x28 & x35) | (~x04 & ~x13 & x39));
  assign new_n101_ = ~x04 & x39 & (~x13 | ~x40);
  ...
  assign new_n111_ = ~x30 & (new_n112_ | (~new_n86_ & (~x35 | (~x27 & x28))));
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x37 | x40)));
  assign z05 = ~z06;
endmodule
