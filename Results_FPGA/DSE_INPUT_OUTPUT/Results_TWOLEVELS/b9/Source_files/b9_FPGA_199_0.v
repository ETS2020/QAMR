...
module FAU ( 
  ...
  assign z11 = new_n68_ | (~x09 & ~x30 & (~new_n86_ | (~new_n88_ & ~x08)));
  assign new_n86_ = ((x29 & x40) | (~new_n87_ & ~x28 & (x35 | ~x39))) & (x39 | (~new_n87_ & ~x28 & (x35 | ~x40)));
  assign new_n87_ = x04 & x27;
  assign new_n88_ = (x27 | (~x39 & ~x40)) & (~x04 | ~x40) & ~x28 & (x35 | ~x39);
  ...
  assign new_n101_ = (x30 | new_n102_ | x32) & new_n104_ & (new_n103_ | x37);
  assign new_n102_ = (~x28 | x35 | x37) & (x27 | ~x40);
  ...
  assign z18 = (x39 & x40 & x08 & x29) | (~new_n109_ & (x39 | x40));
  ...
  assign new_n113_ = (~x35 | (~x27 & x28)) & (x39 ? (~x29 | ~x40) : x40);
  assign z19 = new_n68_ | (~x09 & ~x30 & (~new_n86_ | (~new_n88_ & ~x08)));
endmodule
