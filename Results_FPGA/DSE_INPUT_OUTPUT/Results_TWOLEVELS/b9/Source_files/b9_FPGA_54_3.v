// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:46 2020
...
module FAU ( 
  ...
  assign z02 = ~x40 | (~x09 & (~new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z08 = x40 & ~x09 & x39;
  assign z09 = x11 & x26 & x27 & ~new_n69_ & x34;
  assign z10 = ~new_n85_ | (~x04 & ((new_n86_ & x05) | (new_n84_ & x27)));
  assign new_n84_ = ~new_n71_ & (new_n68_ ? x05 : x07);
  assign new_n85_ = ~new_n69_ & (~x06 | ~x27 | ~x37);
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = x09 ? x40 : (~new_n88_ & ~x30);
  assign new_n88_ = (new_n89_ | ((~x04 | ~x27) & ~x28 & x35)) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n89_ = x29 & x39 & x40;
  assign z12 = new_n91_ | (x09 & x40) | ((~x40 | (~new_n92_ & ~x09)) & (new_n66_ | ~x27));
  assign new_n91_ = ~x10 & ((~x09 & ~x27) | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x04 & x39;
  assign z13 = (~new_n94_ & x27) | (~x04 & ~x09 & new_n86_ & ~x13);
  assign new_n94_ = (x09 | ((~new_n95_ | x04) & (~new_n96_ | x18))) & (~new_n97_ | x18);
  ...
  assign new_n99_ = ~x09 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (x09 | (~new_n103_ & (new_n101_ | (~new_n66_ & x27)))) & (x40 | (~new_n66_ & x27));
  ...
  assign z18 = x09 ? ~x40 : (~new_n109_ | (~new_n108_ & x08));
  assign new_n108_ = ~new_n89_ & (x27 | x28 | ~x35);
  assign new_n109_ = ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (new_n111_ | (~x08 & (~x27 | ~x35)));
  assign new_n111_ = ~new_n89_ & (~x35 | (~x27 & x28));
  assign z19 = x09 ? x40 : (~new_n88_ & ~x30);
endmodule
