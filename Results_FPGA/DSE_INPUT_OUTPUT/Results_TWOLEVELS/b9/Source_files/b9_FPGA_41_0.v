...
module FAU ( 
  ...
  assign new_n87_ = (x27 | (~x02 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign new_n88_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n89_ = x40 ? (x29 & x39) : ~x02;
  assign z12 = new_n91_ | (~x02 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x02));
  assign new_n91_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (x27 & (new_n93_ | (~x04 & new_n95_ & ~x13))) | (~x04 & new_n84_ & ~x13);
  ...
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n66_ | new_n99_))) & (~x02 | new_n66_ | x40);
  ...
  assign z20 = (~x02 & ~x40) | (~x09 & ~x30 & (~new_n109_ | (~new_n111_ & x02)));
