...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x18;
  ...
  assign new_n85_ = (~x07 | (x40 ? x39 : x18)) & (~x05 | ~x39 | ~x40);
  ...
  assign z12 = (x40 & (new_n92_ | (~new_n65_ & (x04 | ~x39)))) | (~x18 & ~new_n65_ & ~x40);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n94_ | (new_n95_ & ~x04))) | new_n67_ | (new_n96_ & ~x04);
  ...
  assign z18 = new_n108_ | (~new_n67_ & (new_n107_ | x09 | x30));
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n108_ = x08 & x29 & x39 & x40;
  assign z19 = z11 | new_n67_;
  assign z20 = (x18 & ~x40) | (~x09 & ~x30 & (~new_n111_ | (~new_n113_ & ~x18)));
