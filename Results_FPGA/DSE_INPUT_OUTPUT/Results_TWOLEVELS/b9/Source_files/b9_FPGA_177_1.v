...
module FAU ( 
  ...
  assign z14 = new_n99_ | ~new_n102_ | (~new_n100_ & (x18 | x19 | ~x20));
  assign new_n99_ = (new_n91_ | ~x27) & (x13 | ~x40 | (x04 & x39));
  assign new_n100_ = ~new_n101_ & ~x04 & ~x13 & x40;
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = (x39 | ~x40) & (x30 | x32 | (~new_n103_ & (x27 | ~x39)));
  assign new_n103_ = x28 & ~x35 & ~x37;
