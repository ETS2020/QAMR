...
module FAU ( 
  ...
  assign new_n69_ = x04 & ~x40;
  assign z01 = ~x04 | (~x30 & ~x32 & x40 & (new_n71_ | ~x27));
  assign new_n71_ = ~x36 & (x28 | ~x35);
  assign z02 = x40 ? (~new_n73_ | (~x02 & (~x08 | ~x29))) : ~x04;
  assign new_n73_ = x39 & (~x04 | (~x28 & x35 & (x08 | x27)));
  assign z03 = new_n75_ | (~new_n69_ & (~x21 | (x27 & ~x35) | (~x27 & ~x37)));
  assign new_n75_ = x27 & ~x28 & (x40 | (~x04 & x35));
  assign z04 = (~new_n69_ & (x27 ? ~x35 : ~x37)) | new_n75_ | new_n69_ | x21;
  assign z05 = x37 | new_n69_ | (x27 & x28);
  assign z06 = ~x37 & ((~x04 & (~x27 | (~x28 & ~x40))) | (x40 & (~x27 | ~x28)));
  ...
  assign new_n85_ = (new_n71_ | (new_n68_ ? ~x05 : ~x07)) & (~x06 | ~x37);
  assign new_n86_ = x06 & x37 & x40;
  assign new_n87_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (~new_n90_ | (~new_n89_ & (~x29 | ~x39)));
  assign new_n89_ = (~x28 | (x04 & (x27 | ~x40))) & (~x40 | (x35 & (~x04 | ~x27)));
  assign new_n90_ = (x04 | ((x08 | (x27 & ~x28)) & (x40 | (~x28 & x35)))) & (x08 | ~x40 | (~x04 & x35));
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & x04))) | (~x04 & ~new_n93_ & (~x39 | ~x40));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign z13 = (~new_n95_ & x27) | (x04 & ~x40) | (~x04 & new_n87_ & ~x13);
  ...
  assign new_n100_ = (~x04 | x40) & (new_n93_ | ((x04 | (x39 & x40)) & ~x13 & (~x04 | ~x40)));
  ...
  assign new_n107_ = (x27 | x28 | ~x35) & (~new_n68_ | ~x29);
