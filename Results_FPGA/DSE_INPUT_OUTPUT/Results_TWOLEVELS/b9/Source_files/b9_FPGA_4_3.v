...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n74_, new_n75_, new_n78_, new_n80_,
    new_n88_, new_n90_;
  assign z00 = (~x15 & ~new_n65_ & x27) | new_n66_ | ~x16;
  assign new_n65_ = ~x37 & (~x28 | ~x35);
  assign new_n66_ = x39 & x40;
  assign z01 = ~new_n66_ & (new_n68_ | ~x04);
  assign new_n68_ = ~x30 & ~x32 & (~x27 | (~x36 & (x28 | ~x35)));
  assign z03 = new_n66_ | ~x21 | (~new_n66_ & (x27 ? (~x28 | ~x35) : ~x37));
  assign z04 = ~new_n66_ & ((x27 & (~x28 | ~x35)) | x21 | (~x27 & ~x37));
  assign z05 = x37 | new_n66_ | (x27 & x28);
  assign z06 = new_n66_ | (~x37 & (~x28 | (~new_n66_ & ~x27)));
  assign z07 = new_n66_ | (x03 & (new_n75_ | (new_n74_ & ~x31)));
  assign new_n74_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign new_n75_ = ~x14 & (x00 | x25 | ~x38);
  assign z09 = new_n66_ | (x27 & x34 & x11 & x26);
  assign z10 = new_n66_ | (x27 & (new_n78_ | (x06 & x37)));
  assign new_n78_ = ~x04 & x07 & (x36 | (~x28 & x35));
  assign z11 = new_n66_ | (new_n80_ & ~x09);
  assign new_n80_ = ~x30 & (x28 | ~x35 | (x04 & x27) | (~x08 & ~x27));
  assign z12 = new_n65_ | new_n66_ | ~x27;
  assign z13 = ~x18 & ~x19 & x20 & x27 & ~new_n65_ & ~new_n66_;
  assign z14 = new_n65_ | x18 | x19 | ~x20 | new_n66_ | ~x27;
  assign z15 = new_n66_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n66_ & ~x23;
  assign z17 = new_n66_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n66_ & (new_n88_ | x09 | x30);
  assign new_n88_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n66_ | new_n90_;
  assign new_n90_ = ~x09 & ~x30 & (~x35 | (~x27 & (~x08 | x28)));
  assign z02 = 1'b1;
  assign z08 = 1'b0;
  assign z19 = new_n66_ | (new_n80_ & ~x09);
endmodule
