...
module FAU ( 
  ...
  assign z01 = (~x04 & (x30 | x40)) | (~x30 & ~x32 & x40 & (new_n69_ | ~x27));
  ...
  assign new_n94_ = (x30 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  assign z14 = ~new_n99_ | (~new_n96_ & (x18 | x19 | ~x20));
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : ~x30;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (~x30 | new_n66_ | x40) & (~x40 | ((new_n66_ | new_n98_) & (~new_n100_ | x30)));
  assign new_n100_ = ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = x30 | (x40 & (new_n105_ | new_n88_ | x09));
  assign new_n105_ = x08 & ((x29 & x39) | (~x27 & ~x28 & x35));
  assign z19 = ~x30 & (~x40 | (new_n86_ & ~x09));
  assign z20 = ~x09 & ~x30 & ~new_n108_ & x40;
  assign new_n108_ = (x08 | (x27 & x35)) & ((x29 & x39) | (x35 & (x27 | ~x28)));
endmodule
