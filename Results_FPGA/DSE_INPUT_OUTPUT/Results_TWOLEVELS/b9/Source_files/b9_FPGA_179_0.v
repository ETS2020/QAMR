...
module FAU ( 
  ...
  assign z12 = new_n90_ | (~x39 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x39));
  ...
  assign new_n100_ = (x30 | new_n101_ | x32) & (new_n66_ | new_n102_);
  assign new_n101_ = (x27 | ~x39) & (x37 | ~x40 | ~x28 | x35);
  assign new_n102_ = x40 ? (~x04 & ~x13 & x39) : ~x39;
  ...
  assign new_n110_ = ~new_n111_ & (x08 | ((x35 | ~x39) & (x27 | (~x39 & ~x40))));
  assign new_n111_ = (x39 ? (~x29 | ~x40) : x40) & (~x35 | (~x27 & x28));
endmodule
