...
module FAU ( 
  ...
  assign new_n72_ = x40 & (new_n73_ | ~x04) & x39 & (~x38 | ~x40);
  assign new_n73_ = (x08 | x27) & ~x28 & (x35 | x38);
  ...
  assign new_n85_ = (~x07 | (x40 & (x38 | x39))) & (~x39 | ~x40 | ~x05 | x38);
  assign new_n86_ = x05 & ~x38 & x39 & x40 & (x30 | x32);
  assign z11 = new_n68_ | (~x09 & ~new_n88_ & ~x30);
  assign new_n88_ = (new_n89_ | x08) & ~new_n91_ & (new_n90_ | (x29 & x39));
  assign new_n89_ = (x27 | (x38 & x40)) & ~x04 & ~x28 & (x35 | x38);
  assign new_n90_ = (~x04 | ~x27) & ~x28 & (x35 | x38);
  assign new_n91_ = ~x40 & ((x04 & x27) | x28 | ~x35);
  assign z12 = new_n93_ | (x38 & x40) | (~new_n94_ & (~x40 | (~x38 & (x04 | ~x39))));
  ...
  assign new_n98_ = ~x38 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n103_ | ((new_n100_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n100_ = ~x38 & (new_n101_ | ~new_n102_);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13 & x39;
  assign new_n103_ = (x38 | (~new_n104_ & (new_n94_ | new_n102_))) & (new_n94_ | x40);
  ...
  assign new_n113_ = x40 & (x38 | (x29 & x39));
  assign new_n114_ = ~x08 & ((~x35 & ~x38) | (~x27 & (~x38 | ~x40)));
