...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n66_, new_n68_, new_n74_, new_n75_, new_n78_, new_n80_, new_n84_,
    new_n89_, new_n92_;
  ...
  assign z11 = z08 | (~x09 & ~x30 & ~z08 & ~new_n80_);
  assign new_n80_ = ~x28 & x35 & (~x04 | ~x27) & (x08 | x27);
  assign z12 = (~x37 & (~x35 | (~z08 & ~x28))) | z08 | ~x27;
  assign z13 = ~x18 & ~x19 & x20 & x27 & ~z08 & ~new_n66_;
  assign z14 = ~new_n84_ | (~x37 & (~x35 | (~z08 & ~x28)));
  assign new_n84_ = ~x18 & ~x19 & x20 & x27 & (~x39 | ~x40);
  assign z15 = x12 & x26 & x27 & ~z08 & x34;
  assign z16 = z08 | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~z08 & ~x24;
  assign z18 = ~z08 & (new_n89_ | x09 | x30);
  assign new_n89_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = ~x09 & ~x30 & ~z08 & ~new_n80_;
  assign z20 = z08 | (~x09 & ~new_n92_ & ~x30);
  assign new_n92_ = (x27 | ~x28) & ((x39 & x40) | (x35 & (x08 | x27)));
  assign z02 = ~z08;
endmodule
