...
module FAU ( 
  ...
  assign new_n86_ = ((x29 & x39) | (~new_n87_ & ~x28 & (x35 | ~x40))) & (x40 | (~new_n87_ & ~x28 & (~x29 | x35)));
  assign new_n87_ = x04 & x27;
  assign new_n88_ = (x27 | (~x29 & ~x40)) & (~x04 | ~x40) & ~x28 & (~x29 | x35);
  assign z12 = new_n90_ | (~x29 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x29));
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x29;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n66_ | new_n99_))) & (~x29 | new_n66_ | x40);
