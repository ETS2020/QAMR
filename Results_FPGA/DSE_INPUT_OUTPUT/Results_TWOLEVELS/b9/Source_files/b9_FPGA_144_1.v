...
module FAU ( 
  ...
  assign z01 = ~new_n65_ & (~x04 | (~x30 & ~x32 & (new_n70_ | ~x27)));
  ...
  assign z11 = new_n65_ | (~x09 & ~x30 & (~new_n87_ | (~new_n90_ & ~x08)));
  assign new_n87_ = (new_n88_ | (~new_n89_ & ~x28 & (~x10 | x35))) & (x40 | (~new_n89_ & ~x28 & x35));
  assign new_n88_ = x29 & x39;
  assign new_n89_ = x04 & x27;
  assign new_n90_ = (~x10 | (x27 & x35)) & ~x04 & ~x28 & (x27 | x40);
  ...
  assign new_n95_ = x10 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n102_ = x10 & (~x10 | ~x13 | x27);
  assign new_n103_ = x10 & (x04 | ~x39 | (~x30 & ~x32));
  assign z15 = new_n65_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n65_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = (~new_n108_ & x08) | ~new_n109_ | new_n65_ | x09;
  assign new_n108_ = (~new_n68_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n109_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x09 & ~x30 & (new_n111_ | new_n112_);
  assign new_n111_ = (~x35 | (~x27 & x28)) & (~x40 | (~new_n88_ & x10));
  assign new_n112_ = ~x08 & ((x10 & (~x27 | ~x35)) | (~x27 & ~x40));
  assign z19 = new_n65_ | (~x09 & ~x30 & (~new_n87_ | (~new_n90_ & ~x08)));
endmodule
