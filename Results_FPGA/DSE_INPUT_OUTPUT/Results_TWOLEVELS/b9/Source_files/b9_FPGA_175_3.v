...
module FAU ( 
  ...
  assign new_n89_ = (x27 | (x24 & x40)) & (x24 | (~x04 & ~x28 & x35));
  assign new_n90_ = x40 & (x24 | (x29 & x39));
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n93_ | (x24 & x40) | (~new_n68_ & (~x40 | (~x24 & (x04 | ~x39))));
  ...
  assign z14 = ~new_n103_ | ((x18 | x19 | ~x20) & (new_n100_ | ~x40));
  assign new_n100_ = ~x24 & (new_n101_ | ~new_n102_);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13 & x39;
  assign new_n103_ = (x24 | (~new_n104_ & (new_n68_ | new_n102_))) & (new_n68_ | x40);
  ...
  assign new_n113_ = (~x29 | ~x39) & ((~x27 & x28) | (~x24 & ~x35));
  assign new_n114_ = (x08 | ((x27 | x40) & (x24 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
endmodule
