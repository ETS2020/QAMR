...
module FAU ( 
  ...
  assign new_n86_ = ~new_n87_ & (x40 ? (~x29 | ~x39) : ~x33);
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (x33 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~new_n91_ & (new_n66_ | ~x27)))) | (~x33 & ~x40 & (new_n66_ | ~x27));
  ...
  assign new_n97_ = (~x40 | (~x04 & x39)) & ~x13 & (x33 | x40);
  assign new_n98_ = ~new_n99_ & z08 & ~x04 & ~x13;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = (x40 | (~x33 & (x27 | x33))) & (x27 | ((new_n101_ | ~x40) & (x30 | x32)));
