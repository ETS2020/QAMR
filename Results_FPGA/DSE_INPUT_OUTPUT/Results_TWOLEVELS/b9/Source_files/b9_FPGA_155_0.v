...
module FAU ( 
  ...
  assign z02 = new_n73_ | ~new_n68_ | (x04 & (~x35 | (~x08 & ~x27)));
  assign new_n73_ = x39 & ((~x02 & (~x08 | ~x29)) | (x04 & x28));
  ...
  assign new_n85_ = (~x07 | (x40 ? x39 : ~x34)) & (~x05 | ~x39 | ~x40);
  ...
  assign new_n89_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x39));
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (x34 & ~new_n92_ & ~x40);
  ...
  assign new_n99_ = ~new_n92_ & ((x40 & (x04 | ~x39)) | x13 | (x34 & ~x40));
  assign new_n100_ = ~new_n101_ & x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = (x34 | x40) & (x30 | x32 | (~new_n103_ & (x27 | ~x40)));
