...
module FAU ( 
  ...
  assign new_n92_ = ~new_n65_ & (x04 | ~new_n83_ | x13);
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n96_ | new_n99_ | ~new_n101_ | (new_n100_ & ~x37);
  assign new_n96_ = ~new_n97_ & (new_n98_ | ~z08 | x04 | x13);
  assign new_n97_ = ~x18 & ~x19 & x20;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (x28 & ~x35 & ~x37));
  assign new_n100_ = (~x28 | ~x35) & ((x40 & (x04 | ~x39)) | x13 | (x39 & ~x40));
  assign new_n101_ = (x39 | (x40 & (x27 | ~x40))) & (x27 | (x40 ? (~x04 & ~x13) : ~x39));
