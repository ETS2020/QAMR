...
module FAU ( 
  ...
  assign z10 = (new_n85_ & ~x04) | (x27 & (new_n83_ | (~x04 & ~new_n70_ & ~new_n84_)));
  assign new_n83_ = x06 & ~new_n68_ & x37;
  assign new_n84_ = (~x07 | (x40 ? x39 : ~x38)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n68_ | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = (new_n88_ | x08) & ~new_n90_ & (new_n89_ | (x29 & x39));
  assign new_n88_ = (x27 | (~x38 & ~x40)) & ~x04 & ~x28 & (x35 | ~x40);
  assign new_n89_ = ~x28 & (x35 | ~x40) & (~x04 | ~x27);
  assign new_n90_ = ~x40 & (x28 | (~x35 & x38) | (x04 & x27));
  assign z12 = new_n92_ | (~x38 & ~x40) | (~new_n93_ & (x40 ? (x04 | ~x39) : x38));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n96_ | (new_n95_ & ~x04))) | new_n68_ | (new_n97_ & ~x04);
  ...
  assign new_n99_ = x40 ? (~new_n100_ & new_n101_) : ~x38;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (~x40 | (~new_n103_ & (new_n93_ | new_n101_))) & (~x38 | new_n93_ | x40);
  ...
  assign new_n112_ = x40 ? (x29 & x39) : ~x38;
  assign new_n113_ = ~x08 & ((~x35 & x40) | (~x27 & (x38 | x40)));
  assign z19 = new_n68_ | (~x09 & ~new_n87_ & ~x30);
endmodule
