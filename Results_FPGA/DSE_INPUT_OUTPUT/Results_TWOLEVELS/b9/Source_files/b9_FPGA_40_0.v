...
module FAU ( 
  ...
  assign new_n72_ = (x02 | (x08 & x29)) & (new_n73_ | ~x04);
  ...
  assign new_n84_ = ~new_n70_ & ((x07 & (x40 ? ~x39 : x09)) | (x05 & x39 & x40));
  assign new_n85_ = x06 & ~new_n68_ & x37;
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & (~x40 | (~x30 & ~new_n88_ & x40));
  ...
  assign z13 = (~new_n94_ & x27) | new_n68_ | (~x04 & new_n86_ & ~x13);
  ...
  assign new_n101_ = (x27 | new_n102_ | ~x40) & (x40 | (x09 & (~x09 | x27)));
  ...
  assign new_n107_ = ~x09 & (~new_n73_ | x04 | ~x27) & ~x30 & (x09 | x40);
  assign z19 = ~x09 & ~x30 & ~new_n88_ & x40;
  assign z20 = ~x09 & (~x40 | (~new_n110_ & ~x30));
  assign new_n110_ = (x27 | new_n89_ | ~x28) & (~x40 | ((x08 | (x27 & x35)) & (new_n89_ | x35)));
endmodule
