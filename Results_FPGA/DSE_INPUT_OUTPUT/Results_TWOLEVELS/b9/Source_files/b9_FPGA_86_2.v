...
module FAU ( 
  ...
  assign new_n74_ = x39 ? x40 : (~x09 & (~x27 | x28) & ~x30 & (x09 | ~x28 | x30));
  ...
  assign new_n88_ = (new_n89_ | (x35 & (~x04 | ~x27))) & ~new_n90_ & (x08 | (~x04 & x27 & x35));
  assign new_n89_ = x29 & x39;
  assign new_n90_ = x28 & (~x39 | (x40 & (~x08 | ~x29)));
  assign z12 = new_n92_ | (x39 & ~x40) | ((new_n66_ | ~x27) & (~x39 | (x04 & x40)));
  assign new_n92_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x39 & (~x40 | (~x04 & ~new_n86_ & ~x13)));
