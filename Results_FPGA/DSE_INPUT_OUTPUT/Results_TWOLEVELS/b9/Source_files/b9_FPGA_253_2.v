...
module FAU ( 
  ...
  assign z02 = (~new_n71_ & x39) | ~x39 | (x04 & ~x08 & ~x27);
  assign new_n71_ = (x02 | (x08 & x29)) & x40 & (new_n72_ | ~x04);
  assign new_n72_ = ~x28 & x35;
  assign z03 = new_n74_ | (~x21 & (~x39 | (x39 & x40)));
  assign new_n74_ = ~new_n65_ & (x27 ? (~x28 | ~x35) : ~x37);
  assign z04 = new_n74_ | (x21 & (~x39 | (x39 & x40)));
  ...
  assign z12 = (x40 & (new_n92_ | (~new_n66_ & x04))) | (~new_n66_ & ~x39);
  ...
  assign z14 = new_n100_ | (~new_n98_ & (~x39 | (x40 & (x04 | x13))));
  ...
  assign z18 = ~new_n106_ | (x08 & ((x29 & x39) | (new_n72_ & ~x27)));
