...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n100_, new_n105_, new_n106_, new_n109_;
  ...
  assign z14 = (x40 & (new_n96_ | ~new_n98_)) | (~x27 & (~new_n100_ | ~x39 | ~x40));
  assign new_n96_ = ~new_n97_ & (x04 | x13 | ~x39);
  assign new_n97_ = (x37 | (x28 & x35)) & ~x18 & ~x19 & x20;
  assign new_n98_ = (~x13 | x27) & (~x28 | x30 | new_n99_ | x32);
  assign new_n99_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign new_n100_ = ~x04 & (x30 | x32);
  assign z15 = x40 & x34 & x27 & x12 & x26;
  assign z16 = (x27 & ~x40) | (x01 & x22 & ~x23);
  assign z17 = (x27 & ~x40) | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n105_ & x08) | new_n106_ | x09 | x30;
  assign new_n105_ = (~new_n69_ | x27) & (~x29 | ~x39 | ~x40);
  assign new_n106_ = x27 & (~x40 | (new_n69_ & ~x04));
  assign z19 = ~x09 & ~new_n86_ & ~x30;
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (x08 | (x27 & (x35 | ~x40))) & (new_n87_ | ((x27 | ~x28) & (x35 | ~x40))) & (x27 | x40 | (~x28 & x35));
endmodule
