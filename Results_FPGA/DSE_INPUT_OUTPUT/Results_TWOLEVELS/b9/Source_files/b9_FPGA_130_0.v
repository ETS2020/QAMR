...
module FAU ( 
  ...
  assign z11 = new_n68_ | (~x09 & ~x30 & (~new_n86_ | (~new_n87_ & ~x08)));
  ...
  assign z12 = new_n90_ | (~new_n91_ & ~x40) | (~x10 & (new_n89_ | (~x27 & x40)));
  assign new_n89_ = ~x35 & ~x36 & ~x37;
  assign new_n90_ = (~x27 | (~x37 & (~x28 | ~x35))) & (x04 | ~x39);
  assign new_n91_ = (x37 | (x35 & (x28 | ~x39))) & x27 & x39;
  assign z13 = new_n93_ | new_n97_;
  assign new_n93_ = x27 & ((x39 & (new_n94_ | (new_n95_ & ~x18))) | (new_n96_ & ~x18));
  ...
  assign z14 = (~new_n104_ & ~x27) | new_n99_ | new_n68_ | (~new_n102_ & ~x37);
  assign new_n99_ = (new_n100_ | ~new_n101_) & (x18 | x19 | ~x20);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39 & x40;
  assign new_n102_ = new_n103_ & ((x28 & x35) | (~x04 & ~x13 & x39));
  assign new_n103_ = (x35 | (x40 & (~x28 | x30 | x32))) & (x28 | ~x39 | x40);
  assign new_n104_ = (~x40 | (~x13 & (x30 | x32))) & ~x04 & x39 & x40;
  assign z15 = x12 & x26 & x27 & ~new_n68_ & x34;
  assign z16 = new_n68_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n68_ & ~x24;
  assign z18 = (~new_n109_ & (x39 | x40)) | (x39 & x40 & x08 & x29);
  ...
  assign new_n114_ = (~x40 | ((x35 | x39) & (x08 | (x27 & x35)))) & (x27 | (x39 ? x08 : ~x28));
endmodule
