// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:56 2020
...
module FAU ( 
  ...
  assign z01 = (~new_n65_ & (~x04 | (~x27 & ~x30 & ~x32))) | (~x30 & new_n69_ & ~x32);
  assign new_n69_ = ~x36 & x40 & (x28 | ~x35);
  ...
  assign z10 = new_n84_ | (x27 & (new_n82_ | (x06 & ~new_n65_ & x37)));
  assign new_n82_ = ~x04 & ((~new_n83_ & x40) | (x07 & x36 & (~x39 | ~x40)));
  assign new_n83_ = (~x05 | ~x39 | (~x36 & (x28 | ~x35))) & (~x07 | x28 | ~x35 | x39);
  assign new_n84_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & (x40 ? (~x29 | ~x39) : x36);
  assign new_n87_ = ~x28 & x35 & (~x04 | ~x27);
  assign new_n88_ = (x27 | (~x36 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n90_ | (~x36 & ~x40) | (~new_n66_ & (x40 ? (x04 | ~x39) : x36));
  ...
  assign new_n95_ = x20 & x36 & (x37 | (x28 & x35));
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : ~x36;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (~x40 | (~new_n102_ & (new_n66_ | new_n100_))) & (~x36 | new_n66_ | x40);
  ...
  assign z18 = new_n108_ | (~new_n65_ & (new_n107_ | x09 | x30));
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign new_n108_ = x08 & x29 & x39 & x40;
  assign z20 = new_n65_ | (~x09 & ~x30 & (new_n110_ | ~new_n111_));
  assign new_n110_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & x40));
  assign new_n111_ = (x35 | (x40 ? x08 : ~x36)) & (x27 | ((x08 | (~x36 & ~x40)) & (~x28 | x40)));
