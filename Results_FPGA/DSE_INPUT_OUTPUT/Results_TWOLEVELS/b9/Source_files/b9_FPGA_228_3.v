...
module FAU ( 
  ...
  assign z02 = new_n72_ | ~new_n73_ | (x04 & (x28 | (~x08 & ~x27)));
  assign new_n72_ = ~x32 & ((~x02 & (~x08 | ~x29)) | (x04 & ~x35));
  assign new_n73_ = (x40 | (x04 & x27 & (~x27 | x28))) & x39 & (~x32 | ~x40);
  ...
  assign new_n88_ = (x27 | (x32 & x40)) & (x32 | (~x04 & ~x28 & x35));
  ...
  assign new_n96_ = x40 & (x32 | (~x04 & ~x13 & x30 & x39));
  assign z14 = (~new_n101_ & (~x40 | (~new_n98_ & ~x32))) | (~new_n68_ & ~x40) | (~new_n100_ & ~x32);
  assign new_n98_ = new_n99_ & (~x28 | x30 | (x35 & x36));
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (x30 | (x27 & (~x28 | x35 | x37))) & (new_n99_ | (x27 & (x37 | (x28 & x35))));
  ...
  assign new_n110_ = ~x08 & ((~x32 & ~x35) | (~x27 & (~x32 | ~x40)));
  assign z05 = ~z06;
endmodule
