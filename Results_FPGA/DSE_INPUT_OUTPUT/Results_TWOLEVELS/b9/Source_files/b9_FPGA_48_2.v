...
module FAU ( 
  ...
  assign z06 = ~x37 & ((~x27 & (~x34 | x40)) | (~x28 & (x40 | (~x34 & ~x40))));
  ...
  assign z12 = new_n89_ | ~new_n91_ | (~new_n90_ & ~x37);
  assign new_n89_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n90_ = ((x28 & x35) | (~x04 & x39)) & (x40 | (x35 & (x28 | x34)));
  assign new_n91_ = (x40 | (x27 & ~x34)) & (x27 | (x39 & (~x04 | ~x40)));
  assign z13 = (~new_n93_ & x27) | new_n67_ | (~x04 & new_n84_ & ~x13);
  assign new_n93_ = (~new_n94_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n94_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n96_ | new_n99_ | ~new_n100_ | (new_n102_ & ~x30);
  assign new_n96_ = (new_n97_ | ~new_n98_) & (x18 | x19 | ~x20);
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n99_ = (x04 | x13) & (new_n66_ | (~x27 & x40));
  assign new_n100_ = (new_n101_ | (x39 & x40)) & (~x34 | x40) & (x28 | x37 | (x39 & (x34 | x40)));
  assign new_n101_ = x27 & (x35 | x37);
  assign new_n102_ = ~x32 & ((~x27 & x40) | (x28 & ~x35 & ~x37));
  ...
  assign new_n107_ = (~z08 | ~x29) & (x27 | x28 | ~x35);
  ...
  assign z19 = new_n67_ | (~x09 & ~x30 & (new_n86_ | new_n87_));
endmodule
