...
module FAU ( 
  ...
  assign new_n83_ = ~new_n69_ & ((x07 & (x40 ? ~x39 : x25)) | (x05 & x39 & x40));
  ...
  assign new_n88_ = ~new_n89_ & (x40 ? (~x29 | ~x39) : x25);
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n90_ = (x27 | (~x25 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = new_n92_ | ~new_n94_ | (~new_n93_ & ~x37);
  assign new_n92_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n93_ = ((x28 & x35) | (~x04 & x39)) & (x40 | (x35 & (~x25 | x28)));
  assign new_n94_ = (x40 | (x25 & x27)) & (x27 | (x39 & (~x04 | ~x40)));
  assign z13 = (x27 & (new_n98_ | (new_n97_ & ~x04))) | new_n65_ | (new_n96_ & ~x04);
  assign new_n96_ = ~x13 & x39 & ~new_n86_ & x40;
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n98_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n100_ | new_n102_ | ~new_n104_ | (~x27 & (~new_n80_ | new_n86_));
  assign new_n100_ = (x04 | x13) & (~new_n101_ | (~x37 & (~x28 | ~x35)));
  assign new_n101_ = ~x18 & ~x19 & x20 & (x27 | ~x40);
  assign new_n102_ = ~x37 & (new_n103_ | (~x28 & (~x39 | (x25 & ~x40))));
  assign new_n103_ = ~x35 & (~x39 | ~x40 | (x28 & ~x30 & ~x32));
  assign new_n104_ = ~new_n65_ & ((new_n80_ & ~new_n105_) | (~x18 & ~x19 & x20));
  ...
  assign z18 = (~new_n110_ & x08) | ~new_n111_ | new_n65_ | x30;
  assign new_n110_ = (x27 | x28 | ~x35) & (~new_n80_ | ~x29);
  assign new_n111_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = (~x25 & ~x40) | (~x09 & ~x30 & (~new_n113_ | (~new_n115_ & x25)));
  assign new_n113_ = (new_n114_ | ~x40) & (x27 | ~x28 | (x29 & x39 & x40));
  assign new_n114_ = (x08 | (x27 & x35)) & (x35 | (x29 & x39));
  assign new_n115_ = (x08 | x27) & (x35 | x40);
