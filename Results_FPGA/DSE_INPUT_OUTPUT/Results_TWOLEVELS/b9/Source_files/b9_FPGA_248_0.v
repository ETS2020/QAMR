...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n73_, new_n74_,
    new_n80_, new_n81_, new_n84_, new_n85_, new_n87_, new_n88_, new_n90_,
    new_n91_, new_n93_, new_n94_, new_n95_, new_n96_, new_n98_, new_n99_,
    new_n100_, new_n101_, new_n106_, new_n108_, new_n109_;
  ...
  assign z02 = x40 ? ((~x02 & (~x08 | ~x29)) | new_n73_ | ~x39) : x39;
  ...
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n71_ | (z08 ? ~x05 : ~x07));
  assign new_n85_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~new_n87_ & ~x08));
  assign new_n87_ = (x27 | (~x39 & ~x40)) & (~x39 | (new_n74_ & ~x04));
  assign new_n88_ = (x39 ? (~x29 | ~x40) : x40) & (~new_n74_ | (x04 & x27));
  assign z12 = new_n90_ | (~x39 & ~x40) | (~new_n91_ & (x40 ? (x04 | ~x39) : x39));
  ...
  assign new_n96_ = ~x04 & new_n85_ & ~x13;
  assign z14 = ~new_n100_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & ~x04 & ~x13 & x39) : ~x39;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n91_ | (~x04 & ~x13 & x39)))) & (~x39 | new_n91_ | x40);
  ...
  assign z18 = ~new_n106_ | (x08 & ((new_n74_ & ~x27) | (z08 & x29)));
  assign new_n106_ = ~new_n69_ & ~x30 & ~x09 & (~new_n74_ | x04 | ~x27);
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n108_ | ~new_n109_));
  assign new_n108_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n109_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((~x28 | x39) & (x08 | (~x39 & ~x40))));
