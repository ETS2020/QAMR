...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n66_, new_n68_, new_n74_, new_n75_, new_n78_, new_n80_, new_n83_,
    new_n89_, new_n91_;
  assign z00 = ~z08 & (~x16 | (new_n66_ & ~x15));
  assign z08 = x39 & x40;
  assign new_n66_ = x27 & (x37 | (x28 & x35));
  assign z01 = new_n68_ | z08 | ~x04;
  assign new_n68_ = ~x30 & ~x32 & (~x27 | (~x36 & (x28 | ~x35)));
  assign z03 = ~z08 & ((x27 & (~x35 | (~x28 & x37))) | ~x21 | (~x37 & (~x27 | ~x28)));
  assign z04 = z08 | x21 | (~z08 & ((x27 & (~x35 | (~x28 & x37))) | (~x37 & (~x27 | ~x28))));
  assign z05 = ~z08 & (x27 ? (x28 | (~x28 & x37)) : x37);
  ...
  assign z09 = z08 | (x11 & x26 & x27 & x34);
  ...
  assign z12 = ~z08 & ~new_n66_;
  assign z13 = ~x18 & ~x19 & new_n83_ & x20;
  assign new_n83_ = x27 & (x37 | (x28 & x35)) & (~x39 | ~x40);
  assign z14 = (~z08 & ~new_n66_) | x18 | x19 | z08 | ~x20;
  ...
  assign z02 = 1'b1;
  assign z19 = ~x09 & ~x30 & ~z08 & ~new_n80_;
endmodule
