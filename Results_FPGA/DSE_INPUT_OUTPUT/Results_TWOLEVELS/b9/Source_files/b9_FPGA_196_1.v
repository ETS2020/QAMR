...
module FAU ( 
  ...
  assign z02 = ~x40 | (x23 & (~new_n73_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n85_ = ~new_n67_ & (~x06 | ~x27 | ~x37);
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n89_ | (~new_n88_ & ~x08));
  assign new_n88_ = (~x23 | (new_n71_ & ~x04)) & (x27 | (~x23 & x40));
  assign new_n89_ = ~new_n90_ & (~x40 | (x23 & (~x29 | ~x39)));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n92_ | (~new_n93_ & ~x10);
  assign new_n92_ = (x23 | ~x40) & (new_n68_ | (x40 & (~x23 | (~x04 & x39))));
  assign new_n93_ = (x35 | x36 | x37) & (~x23 | x27 | ~x40);
  assign z13 = (~new_n95_ & x27) | (~x04 & ~x13 & new_n86_ & x23);
  assign new_n95_ = (~new_n98_ | x18) & (~x23 | ((~new_n96_ | x04) & (~new_n97_ | x18)));
  assign new_n96_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n98_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign z14 = (~new_n105_ & (~x40 | (~new_n100_ & x23))) | (~new_n68_ & ~x40) | (~new_n102_ & x23);
