...
module FAU ( 
  ...
  assign new_n88_ = (x27 | (~x18 & x40)) & (~x18 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (~x18 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n92_ | new_n69_ | ((new_n66_ | ~x27) & (~new_n84_ | x04));
  assign new_n92_ = ~x10 & ((x18 & ~x27) | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n94_ | (~x04 & new_n96_ & ~x13))) | (~x04 & new_n95_ & ~x13);
  assign new_n94_ = ~x18 & ~x19 & x20 & ~new_n66_ & ~x40;
  assign new_n95_ = new_n85_ & x18;
  assign new_n96_ = x18 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (~x27 & (~x40 | (new_n101_ & x18))) | (~new_n98_ & x18) | (~x18 & x40) | (~new_n100_ & ~x40);
  assign new_n98_ = ~new_n99_ & new_n84_ & ~x04 & ~x13;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~new_n66_ & ~x19 & x20;
  ...
  assign z18 = (~new_n106_ & x08) | ~new_n107_ | new_n69_ | x09;
  assign new_n106_ = (x27 | x28 | ~x35) & (~new_n84_ | ~x29);
  assign new_n107_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n109_ & ~x09;
  assign new_n109_ = ~x30 & (new_n110_ | (~new_n89_ & (~x35 | (~x27 & x28))));
  assign new_n110_ = ~x08 & ((x18 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
