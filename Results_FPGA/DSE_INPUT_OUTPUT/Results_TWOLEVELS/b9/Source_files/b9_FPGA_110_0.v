// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:20 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n73_, new_n79_,
    ...
    new_n107_, new_n112_, new_n113_, new_n115_, new_n116_;
  ...
  assign new_n83_ = ~x04 & ~new_n71_ & ((x07 & (x39 ^ x40)) | (x05 & x39 & x40));
  ...
  assign new_n88_ = x39 ? (x29 & x40) : ~x40;
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n94_ | (~new_n91_ & x40);
  assign new_n91_ = (new_n92_ | (~x04 & x39)) & ~new_n93_ & (x28 | x37 | x39);
  assign new_n92_ = x27 & (x35 | x37);
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n94_ = ~new_n95_ & x39;
  assign new_n95_ = (x37 | ((x28 | (~x04 & x40)) & (x35 | x40))) & (x27 | x40);
  assign z13 = new_n100_ | (x27 & (new_n97_ | (new_n99_ & ~x18)));
  assign new_n97_ = x39 & (new_n98_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n98_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n99_ = ~x19 & x20 & ~new_n66_ & x40;
  assign new_n100_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n102_ | new_n94_ | (~new_n105_ & x40);
  assign new_n102_ = (x18 | x19 | ~x20) & (~new_n104_ | (new_n103_ & x28));
  assign new_n103_ = ~x30 & ~x32 & ((~x35 & x40) | (~x36 & x39));
  assign new_n104_ = x40 ? (~x04 & ~x13 & x39) : ~x39;
  assign new_n105_ = ~new_n106_ & (x27 | x30 | x32) & (new_n107_ | x37);
  assign new_n106_ = (~x27 | (~x35 & ~x37)) & (x04 | x13 | ~x39);
  assign new_n107_ = (x28 | (~x13 & x39)) & (x32 | x35 | ~x28 | x30);
  assign z15 = new_n69_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = new_n69_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (x39 & x40 & x08 & x29) | (~new_n112_ & (x39 | x40));
  assign new_n112_ = ~new_n113_ & ~x09 & ~x30;
  assign new_n113_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (~x09 & ~x30 & (new_n115_ | ~new_n116_));
  assign new_n115_ = (~x29 | ~x40) & ((~x27 & x28) | (~x35 & x39));
  assign new_n116_ = (x35 | (x39 ? x08 : ~x40)) & (x27 | ((x08 | (~x39 & ~x40)) & (~x28 | x39)));
endmodule
