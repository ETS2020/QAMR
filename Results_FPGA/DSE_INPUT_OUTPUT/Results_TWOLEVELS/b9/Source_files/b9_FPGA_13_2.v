...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n73_,
    new_n75_, new_n80_, new_n81_, new_n84_, new_n85_, new_n87_, new_n89_,
  ...
  assign z03 = (~x27 & ~x37 & (~x39 | (x39 & x40))) | (x27 & ~new_n75_ & (~x39 | x40)) | ~x21 | (x39 & ~x40);
  assign new_n75_ = x28 & x35;
  assign z04 = (~x27 & ~x37 & (~x39 | (x39 & x40))) | ((~x39 | x40) & (x21 | (~new_n75_ & x27)));
  assign z05 = (x37 | (x27 & x28)) & (~x39 | (x39 & x40));
  ...
  assign new_n87_ = ((x29 & x39) | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
