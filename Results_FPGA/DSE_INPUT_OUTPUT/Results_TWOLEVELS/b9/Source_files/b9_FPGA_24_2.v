...
module FAU ( 
  ...
  assign z02 = ~new_n71_ | new_n73_ | (~x02 & (~x08 | ~x29));
  assign new_n71_ = (~x04 | (x35 & (~x28 | ~x39))) & (~x39 | x40) & (new_n72_ | x39);
  assign new_n72_ = (~x27 | ~x28) & ~x37 & (x28 | x37);
  assign new_n73_ = ~x27 & ((x04 & ~x08) | (~x37 & ~x39));
  assign z03 = (x27 & (~x28 | ~x35)) | (~x27 & ~new_n67_ & ~x37) | new_n67_ | ~x21;
  assign z04 = (x27 & (~x28 | ~x35)) | (~x27 & ~new_n67_ & ~x37) | new_n67_ | x21;
  assign z05 = (x27 & x28 & (~x39 | x40)) | (x37 & (~x39 | (x39 & x40)));
  ...
  assign z08 = x39 & ((x40 & (~x04 | x37 | (~x28 & ~x37))) | ~x40 | (x04 & x28));
  ...
  assign z12 = new_n93_ | (x39 & ~x40) | ((x04 | ~x39) & (new_n92_ | ~x27));
  ...
  assign z14 = new_n100_ | (x39 & ~x40) | (~new_n99_ & (x04 | x13 | ~x39));
  assign new_n99_ = ~new_n92_ & x20 & x27 & ~x18 & ~x19;
  assign new_n100_ = ~x30 & ~x32 & ((~x27 & x40) | (~new_n101_ & x28));
  ...
  assign new_n106_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x39));
  assign new_n107_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = z11 | new_n67_;
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = ~new_n111_ & (x08 | ((x35 | ~x40) & (x27 | (x39 & ~x40))));
  assign new_n111_ = (~x39 | (~x29 & x40)) & (~x35 | (~x27 & x28));
endmodule
