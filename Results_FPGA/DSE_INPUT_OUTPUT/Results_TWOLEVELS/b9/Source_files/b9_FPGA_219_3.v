...
module FAU ( 
  ...
  assign z12 = new_n92_ | new_n67_ | (~new_n68_ & (~new_n84_ | x04));
  assign new_n92_ = ~x10 & ((~x18 & ~x27) | (~x35 & ~x36 & ~x37));
  assign z13 = ~x18 & ((new_n94_ & ~x04) | (x27 & (new_n96_ | (new_n95_ & ~x04))));
  assign new_n94_ = new_n85_ & ~x13;
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n98_ | new_n102_ | x18 | (~new_n100_ & (x19 | ~x20));
  assign new_n98_ = ~x27 & (new_n99_ | ~new_n84_ | x04);
  assign new_n99_ = ~x18 & (x13 | (~x30 & ~x32));
  assign new_n100_ = new_n101_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n101_ = ~x04 & ~x13 & x39 & x40;
  assign new_n102_ = ~x37 & ((~new_n101_ & (~x28 | ~x35)) | (x28 & ~x30 & ~x32 & ~x35));
  ...
  assign new_n107_ = (x27 | x28 | ~x35) & (~new_n84_ | ~x29);
