// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:06 2020
...
module FAU ( 
  ...
  assign z14 = new_n96_ | (~new_n95_ & (~x39 | (x40 & (x04 | x13))));
  assign new_n95_ = ~new_n66_ & ~x18 & ~x19 & x20 & x27;
  assign new_n96_ = ~x30 & ~x32 & x40 & (~x27 | (~new_n97_ & x28));
  ...
  assign new_n102_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x39));
  assign new_n103_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = z11 | new_n69_;
  assign z20 = new_n69_ | (~x09 & ~new_n106_ & ~x30);
  assign new_n106_ = ~new_n107_ & (x35 | (x39 & (~x40 | (x08 & x29))));
  assign new_n107_ = ~x27 & ((~x08 & (~x39 | x40)) | (x28 & (~x29 | ~x39)));
endmodule
