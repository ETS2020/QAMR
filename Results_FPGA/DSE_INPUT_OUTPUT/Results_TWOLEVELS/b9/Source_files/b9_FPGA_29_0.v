...
module FAU ( 
  ...
  assign z07 = x03 & ~new_n65_ & (new_n79_ | (new_n78_ & ~x31));
  ...
  assign new_n84_ = (~x06 | ~x27 | ~x37) & (x08 | x40);
  assign z11 = new_n65_ | (~x09 & ~x30 & (new_n88_ | (~new_n86_ & ~new_n87_)));
  assign new_n86_ = (x39 | ~x40) & (~x08 | (x29 & x40));
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = ~x08 & x40 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n90_ | new_n65_ | (~new_n66_ & (~z08 | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x27 & ((new_n93_ & x08) | (x40 & (new_n92_ | new_n93_))));
  ...
  assign z18 = new_n104_ | ~new_n105_;
  assign new_n104_ = ~x28 & x35 & ((~x04 & (x08 | (x27 & x40))) | (x08 & ~x27));
  assign new_n105_ = ((~x08 & ~x40) | (~x09 & ~x30)) & (~x08 | ~x29 | ~x39 | ~x40);
  assign z19 = ~x09 & ~x30 & (new_n88_ | (~new_n86_ & ~new_n87_));
  assign z20 = new_n65_ | (~x09 & ~x30 & (new_n108_ | ~new_n109_));
  assign new_n108_ = (~x29 | ~x40) & ((~x27 & x28) | (x08 & ~x35));
  assign new_n109_ = (~x40 | ((x35 | x39) & (x08 | (x27 & x35)))) & (x27 | ~x28 | x39);
endmodule
