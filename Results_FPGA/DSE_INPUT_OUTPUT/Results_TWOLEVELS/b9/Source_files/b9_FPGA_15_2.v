...
module FAU ( 
  ...
  assign z11 = (x02 & ~x40) | (~x09 & ~x30 & (~new_n86_ | (~new_n89_ & ~x02)));
  ...
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x02 & ~x40 & (new_n66_ | ~x27));
  ...
  assign z14 = new_n97_ | new_n99_ | (~x40 & (x02 | (~x02 & ~x27))) | (~x27 & ~new_n102_ & x40);
  assign new_n97_ = ~x37 & ((~new_n98_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n98_ = (~x40 | (~x04 & x39)) & ~x13 & (x02 | x40);
  ...
  assign new_n111_ = x40 ? (x29 & x39) : x02;
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (~x02 | x40)));
  assign z19 = (x02 & ~x40) | (~x09 & ~x30 & (~new_n86_ | (~new_n89_ & ~x02)));
endmodule
