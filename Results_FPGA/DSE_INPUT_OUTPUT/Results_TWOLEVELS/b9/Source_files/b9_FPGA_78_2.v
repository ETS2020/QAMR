// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:02 2020
...
module FAU ( 
  ...
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : x33;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (x33 | new_n66_ | x40) & (~x40 | (~new_n100_ & (new_n66_ | new_n98_)));
