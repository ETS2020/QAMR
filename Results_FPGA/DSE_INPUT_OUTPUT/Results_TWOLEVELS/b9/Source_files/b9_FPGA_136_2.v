...
module FAU ( 
  ...
  assign z03 = ((~x39 | x40) & (~x21 | (~new_n74_ & x27))) | (~x27 & ~x37 & (~x39 | (x39 & x40)));
  assign new_n74_ = x28 & x35;
  assign z04 = (~x27 & ~x37 & (~x39 | (x39 & x40))) | (x27 & ~new_n74_ & (~x39 | x40)) | x21 | (x39 & ~x40);
  assign z05 = (~x39 | (x39 & x40)) & (x37 | (x27 & x28));
  assign z06 = ~x37 & (~x27 | ~x28) & (~x39 | (x39 & x40));
  ...
  assign new_n86_ = (~x39 | (~x29 & x40)) & (~new_n70_ | (x04 & x27));
  assign new_n87_ = (x27 | (x39 & ~x40)) & (~x40 | (new_n70_ & ~x04));
  ...
  assign z14 = new_n97_ | new_n98_ | new_n65_ | new_n101_;
  assign new_n97_ = ~new_n66_ & (x13 | ~x39 | (x04 & x40));
  ...
  assign z18 = ~new_n106_ | (x08 & ((x29 & x39) | (new_n70_ & ~x27)));
  assign new_n106_ = ~x09 & (~new_n70_ | x04 | ~x27) & ~new_n65_ & ~x30;
