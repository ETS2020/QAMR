...
module FAU ( 
  ...
  assign z09 = (~x34 & x40) | (x11 & x26 & x27 & x34);
  assign z10 = ~new_n85_ | (~x04 & ((new_n84_ & x27) | (new_n86_ & x05)));
  assign new_n84_ = ~new_n71_ & (new_n68_ ? x05 : x07);
  assign new_n85_ = ~new_n69_ & (~x06 | ~x27 | ~x37);
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = new_n69_ | (~x09 & ~new_n88_ & ~x30);
  assign new_n88_ = (new_n89_ | x08) & ~new_n91_ & (new_n90_ | (x29 & x39));
  assign new_n89_ = (x27 | (~x34 & x40)) & ~x04 & ~x28 & (~x34 | x35);
  assign new_n90_ = (~x04 | ~x27) & ~x28 & (~x34 | x35);
  assign new_n91_ = ~x40 & ((x04 & x27) | x28 | ~x35);
  assign z12 = (x34 & (new_n93_ | (~new_n94_ & (new_n66_ | ~x27)))) | (~x40 & (new_n66_ | ~x27));
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n94_ = ~x04 & x39;
  assign z13 = (~new_n96_ & x27) | (~x04 & ~x13 & new_n86_ & x34);
  assign new_n96_ = (~x34 | ((~new_n97_ | x04) & (~new_n98_ | x18))) & (~new_n99_ | x18);
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n98_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n99_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign z14 = ~new_n104_ | ((new_n101_ | ~x40) & (x18 | x19 | ~x20));
  assign new_n101_ = x34 & (new_n102_ | ~new_n103_);
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = ~x04 & ~x13 & x39;
  assign new_n104_ = (x40 | (~new_n66_ & x27)) & (~x34 | (~new_n105_ & (new_n103_ | (~new_n66_ & x27))));
  ...
  assign z18 = new_n110_ | (~new_n69_ & (new_n111_ | x09 | x30));
  assign new_n110_ = x08 & x29 & new_n68_ & x34;
  assign new_n111_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n113_ & ~x09;
  assign new_n113_ = ~x30 & (new_n115_ | (~new_n114_ & (~x35 | (~x27 & x28))));
  assign new_n114_ = x40 & (~x34 | (x29 & x39));
  assign new_n115_ = ~x08 & ((~x27 & (x34 | ~x40)) | (x34 & ~x35));
  assign z19 = new_n69_ | (~x09 & ~new_n88_ & ~x30);
endmodule
