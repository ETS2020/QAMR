// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:39 2020
...
module FAU ( 
  ...
  assign z04 = (x27 & (~x28 | ~x35)) | (~x27 & ~new_n65_ & ~x37) | new_n65_ | x21;
  ...
  assign new_n83_ = (~x27 | new_n69_ | (new_n80_ ? ~x05 : ~x07)) & (~new_n84_ | ~x05);
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = new_n65_ | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = (~x04 | ((x08 | ~x40) & (new_n87_ | ~x27))) & ~new_n88_ & (x08 | x27);
  assign new_n87_ = x29 & x39 & x40;
  assign new_n88_ = (x28 | ~x35) & (~x39 | ~x40 | (x40 & (~x08 | ~x29)));
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : x24;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x40 | (~new_n101_ & (new_n66_ | new_n99_))) & (x24 | new_n66_ | x40);
