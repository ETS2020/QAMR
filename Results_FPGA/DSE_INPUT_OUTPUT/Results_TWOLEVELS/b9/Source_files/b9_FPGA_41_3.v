// Benchmark "FAU" written by ABC on Fri Aug 21 22:59:40 2020
...
module FAU ( 
  ...
  assign new_n65_ = ~x02 & ~x04 & new_n66_ & ~x15;
  assign new_n66_ = x39 & x40 & (x10 | (x27 & (x35 | x36)));
  assign new_n67_ = x02 & x40;
  assign new_n68_ = x27 & (x37 | (x28 & x35));
  assign z01 = ~new_n67_ & (~x04 | (~x30 & ~x32 & (new_n70_ | ~x27)));
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = (x04 & (x28 | ~x35)) | ~new_n72_ | (~x40 & (~x04 | x37 | (~x28 & ~x37)));
  assign new_n72_ = x08 & x29 & ~new_n67_ & x39;
  ...
  assign z07 = new_n67_ | (~new_n78_ & x03);
  assign new_n78_ = (~new_n79_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n79_ = ~x33 & (x15 | ~x17) & ((x00 & ~x25) | ~x38);
  assign z08 = x40 & (x02 | x39);
  assign z09 = x11 & x26 & x27 & ~new_n67_ & x34;
  assign z10 = (~new_n83_ & x27) | (new_n85_ & ~x02);
  assign new_n83_ = (x04 | new_n70_ | new_n84_) & (~x06 | new_n67_ | ~x37);
  assign new_n84_ = (x02 | ((~x07 | x39) & (~x05 | ~x39 | ~x40))) & (~x07 | x40);
  assign new_n85_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n67_;
  assign z19 = ~x09 & ~x30 & ((~new_n89_ & ~new_n90_) | (~new_n88_ & ~x08));
  assign new_n88_ = (x27 | (x02 & x40)) & (x02 | (~x04 & ~x28 & x35));
  assign new_n89_ = x40 & (x02 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n92_ | (x02 & x40) | (~new_n68_ & (~x40 | (~x02 & (x04 | ~x39))));
  assign new_n92_ = ~x10 & ((~x02 & ~x27) | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n94_ & x27) | (new_n98_ & ~x02);
  assign new_n94_ = (x02 | ((~new_n95_ | x04) & (~new_n96_ | x18))) & (~new_n97_ | x18);
  ...
  assign new_n100_ = ~x02 & (new_n101_ | ~new_n102_);
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = ~x04 & ~x13 & x39;
  assign new_n103_ = (x02 | (~new_n104_ & (new_n68_ | new_n102_))) & (new_n68_ | x40);
  ...
  assign z20 = new_n67_ | (~x09 & ~x30 & (new_n112_ | ~new_n113_));
  assign new_n112_ = (~x29 | ~x39) & ((~x27 & x28) | (~x02 & ~x35));
  assign new_n113_ = (x08 | ((x02 | (x27 & x35)) & (x27 | x40))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
