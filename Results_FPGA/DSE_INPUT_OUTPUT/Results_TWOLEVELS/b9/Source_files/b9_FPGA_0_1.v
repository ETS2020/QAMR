...
module FAU ( 
  ...
  assign new_n72_ = x05 & (~x04 | (~x28 & x35));
  ...
  assign z10 = (x27 & (new_n84_ | (~x04 & new_n85_ & x05))) | (~x04 & new_n86_ & x05);
  assign new_n84_ = ~new_n67_ & ((~x04 & ~new_n70_ & x07) | (x06 & x37));
  assign new_n85_ = x39 & ~new_n70_ & x40;
  ...
  assign new_n90_ = x40 & (~x05 | (x29 & x39));
  assign new_n91_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n93_ | (~x05 & x40) | (~new_n68_ & (~x40 | (x05 & (x04 | ~x39))));
  ...
  assign new_n97_ = x05 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = ~new_n101_ | (~new_n99_ & (x18 | x19 | ~x20));
  assign new_n99_ = x40 & (~x05 | (~new_n100_ & x39 & (~x40 | (~x04 & ~x13))));
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = (~x05 | (~new_n102_ & ~new_n103_ & ~new_n104_)) & (new_n68_ | x40);
  ...
  assign new_n113_ = ~x08 & ((x05 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
