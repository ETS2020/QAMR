...
module FAU ( 
  ...
  assign new_n90_ = x39 ? (x29 & x40) : ~x40;
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n94_ | new_n93_ | (~x39 & (~x27 | ~x40)) | (~x27 & (~x40 | (x04 & x39)));
  assign new_n93_ = ~x37 & (~x28 | ~x35) & (~new_n68_ | x04);
  assign new_n94_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
  assign z13 = (~new_n96_ & x27) | new_n69_ | (~x04 & new_n86_ & ~x13);
  ...
  assign new_n99_ = ~new_n100_ & x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ((~x04 & ~x13) | (~new_n66_ & (x27 | ~x39))) & (x39 | x40) & ((~new_n66_ & x27) | (x39 & x40));
