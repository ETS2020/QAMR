...
module FAU ( 
  ...
  assign z02 = (~new_n73_ & ~x40) | new_n74_ | ~x02 | ~x39 | (x29 & x40);
  assign new_n73_ = (~x27 | (x04 ? (x09 | x30) : (x28 | ~x35))) & (x09 | x30 | (~x28 & x35)) & ~x09 & x27 & ~x30;
  assign new_n74_ = x04 & ((x40 & (x28 | ~x35)) | (~x08 & ~x27));
  ...
  assign z11 = ~x09 & ~x30 & ~new_n69_ & ~new_n88_;
  ...
  assign z14 = new_n101_ | new_n96_ | new_n99_ | new_n100_;
  ...
  assign new_n100_ = ~x27 & (~new_n68_ | x04 | (~x30 & ~x32));
  assign new_n101_ = x40 & (x29 | (x13 & ~x27));
  assign z15 = new_n69_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n69_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = ~new_n69_ & (new_n106_ | x09 | x30);
