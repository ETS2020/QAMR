...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (x18 | ~x40)) | (~x04 & ~x15 & new_n66_ & x18);
  ...
  assign new_n68_ = ~x18 & x40;
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = new_n71_ | ~new_n72_ | (~x02 & x39 & (~x08 | ~x29));
  assign new_n71_ = x04 & (x28 | ~x35 | (~x08 & ~x27));
  assign new_n72_ = (x40 | (x04 & ~x37 & (x28 | x37))) & (x18 | ~x40) & (~x18 | x39);
  ...
  assign z07 = new_n68_ | (x03 & (new_n79_ | (new_n78_ & ~x31)));
  ...
  assign z10 = ~new_n85_ | (~x04 & (new_n84_ | (x27 & ~new_n69_ & ~new_n83_)));
  assign new_n83_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n85_ = (~x06 | ~x27 | ~x37) & (x18 | ~x40);
  assign z11 = ~x09 & ~x30 & ((~new_n88_ & ~new_n89_) | (~new_n87_ & ~x08));
  assign new_n87_ = (x27 | (~x18 & x40)) & (~x18 | (~x04 & ~x28 & x35));
  assign new_n88_ = x40 & (~x18 | (x29 & x39));
  assign new_n89_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = (x18 & (new_n92_ | (~new_n91_ & (x04 | ~x39)))) | (~new_n91_ & ~x40);
  ...
  assign new_n96_ = x18 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n98_ | new_n101_ | (x18 & (new_n99_ | ~new_n100_));
  assign new_n98_ = ~x27 & (~x40 | (x18 & ~x30 & ~x32));
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39 & x40;
  assign new_n101_ = ~x40 & (x19 | ~x20 | (~x37 & (~x28 | ~x35)));
  ...
  assign z20 = ~x09 & ~x30 & (new_n110_ | (~new_n88_ & ~new_n109_));
  assign new_n109_ = x35 & (x27 | ~x28);
