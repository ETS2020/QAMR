...
module FAU ( 
  ...
  assign z02 = ~x40 | (x20 & (~new_n73_ | (~new_n72_ & x40)));
  ...
  assign z12 = new_n93_ | (~x20 & x40) | ((new_n66_ | ~x27) & (~x40 | (~new_n94_ & x20)));
  assign new_n93_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign new_n94_ = ~x04 & x39;
  assign z13 = x20 & ((new_n98_ & ~x04) | (x27 & (new_n96_ | (new_n97_ & ~x04))));
  assign new_n96_ = ~x18 & ~new_n66_ & ~x19;
  assign new_n97_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n98_ = ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n100_ | (~new_n103_ & x20) | (~x40 & (new_n66_ | ~x20 | ~x27));
  assign new_n100_ = (x18 | x19) & (~x40 | (x20 & (new_n101_ | ~new_n102_)));
  ...
  assign z18 = (~new_n110_ & (x20 | ~x40)) | (x08 & x20 & x29 & x39 & x40);
  ...
  assign new_n114_ = ~x08 & ((x20 & (~x27 | ~x35)) | (~x27 & ~x40));
endmodule
