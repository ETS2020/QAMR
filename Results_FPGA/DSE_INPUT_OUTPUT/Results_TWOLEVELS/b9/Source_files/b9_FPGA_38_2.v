...
module FAU ( 
  ...
  assign z12 = new_n91_ | (x39 & ~x40) | ((x04 | ~x39) & (new_n90_ | ~x27));
  ...
  assign new_n98_ = ~x27 & (x04 | new_n84_ | ~x39);
  assign new_n99_ = (new_n90_ | ~new_n100_) & (x04 | x13 | ~x39);
  assign new_n100_ = ~x18 & ~x19 & x20;
  assign new_n101_ = ~x30 & ~x32 & ((~new_n100_ & (~x35 | ~x36)) | (~x35 & ~x37));
  assign new_n102_ = x39 & (~x40 | (x13 & ~x27));
