...
module FAU ( 
  ...
  assign z10 = (~new_n84_ & x27) | (new_n86_ & ~x04);
  assign new_n84_ = (~x07 | ((~new_n85_ | x04) & (~x06 | ~x37))) & (~x06 | ~x37 | x40);
  assign new_n85_ = (x36 | (~x28 & x35)) & (x05 | ~x39 | ~x40);
