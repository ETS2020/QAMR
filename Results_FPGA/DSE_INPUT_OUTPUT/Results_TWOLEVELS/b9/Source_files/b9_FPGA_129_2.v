...
module FAU ( 
  ...
  assign new_n86_ = (x27 | (x18 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  ...
  assign z14 = new_n95_ | new_n97_ | new_n100_ | (~new_n99_ & (x04 | x13));
  assign new_n95_ = ~x37 & ((~new_n96_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n96_ = (~x40 | (~x04 & x39)) & ~x13 & (x18 | x40);
  assign new_n97_ = (~z08 | new_n98_) & (x18 | x19 | ~x20);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x19 & x20 & (~x40 | (~x18 & x27));
  assign new_n100_ = ~x27 & ((~x30 & ~x32) | (~x18 & ~x40) | (~x39 & x40));
  ...
  assign z20 = (x18 & ~x40) | (~x09 & ~x30 & (~new_n108_ | (~new_n110_ & ~x18)));
