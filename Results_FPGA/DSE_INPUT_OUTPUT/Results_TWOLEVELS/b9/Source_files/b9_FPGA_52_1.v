...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n73_,
    ...
    new_n112_, new_n113_;
  assign z00 = ~x16 | (~x15 & (new_n65_ | (new_n67_ & ~x04 & x10)));
  ...
  assign z02 = ~x40 | (x16 & (~new_n73_ | (~new_n72_ & x40)));
  ...
  assign new_n84_ = (~new_n85_ | ~x05) & (~x27 | new_n69_ | (new_n67_ ? ~x05 : ~x07));
  ...
  assign new_n89_ = x40 & (~x16 | (x29 & x39));
  assign new_n90_ = ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n92_ | new_n70_ | (~new_n93_ & (~new_n67_ | x04));
  ...
  assign new_n97_ = x16 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  ...
  assign new_n103_ = ~x27 & (~new_n67_ | x04 | (~x30 & ~x32));
  assign new_n104_ = x40 & (~x16 | (x13 & ~x27));
  assign z15 = new_n70_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n70_ | (x01 & x22 & ~x23);
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n109_ & x08) | ~new_n110_ | new_n70_ | x09;
  assign new_n109_ = (~new_n67_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n110_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n70_ | (~x09 & ~x30 & (new_n112_ | ~new_n113_));
  assign new_n112_ = (~x29 | ~x39) & ((~x27 & x28) | (x16 & ~x35));
  assign new_n113_ = (x08 | ((x27 | x40) & (~x16 | (x27 & x35)))) & (x40 | (x35 & (x27 | ~x28)));
endmodule
