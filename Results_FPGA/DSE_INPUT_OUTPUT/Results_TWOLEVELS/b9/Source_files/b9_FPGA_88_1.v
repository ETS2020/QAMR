...
module FAU ( 
  ...
  assign z06 = (~x27 & (x40 | (~x37 & ~x40))) | (~x28 & ~x37);
  ...
  assign z11 = (~x27 & (x40 | (~x30 & ~x40 & ~x08 & ~x09))) | (~x09 & ~new_n86_ & ~x30);
  assign new_n86_ = (~x27 | (((new_n69_ & ~x04) | (new_n87_ & x08)) & (~x04 | x40))) & (new_n69_ | x40);
  ...
  assign new_n104_ = (~new_n69_ | x27) & (~x29 | ~x39 | ~x40);
  assign new_n105_ = ~x30 & (~new_n69_ | x04 | ~x27);
  assign z19 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = (~x27 | (((new_n69_ & ~x04) | (new_n87_ & x08)) & (~x04 | x40))) & (x40 | (new_n69_ & (x08 | x27)));
  assign z20 = ~x09 & ~new_n109_ & ~x30;
  assign new_n109_ = (x08 | (x27 ? x35 : x40)) & (x35 | (x40 & (new_n87_ | ~x27))) & (x27 | ~x28 | x40);
endmodule
