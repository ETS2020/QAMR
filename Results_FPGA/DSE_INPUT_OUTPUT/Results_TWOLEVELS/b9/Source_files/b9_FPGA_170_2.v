...
module FAU ( 
  ...
  assign z02 = (~new_n71_ & (~x16 | x27)) | (~new_n66_ & (x27 | (~x16 & ~x27))) | (x04 & ~x08 & ~x16 & ~x27);
  ...
  assign z07 = x03 & ~new_n77_ & (~x16 | x27);
  ...
  assign new_n95_ = ~x19 & x20 & ~new_n91_ & x27;
  ...
  assign z19 = ~x09 & ~x30 & ((new_n86_ & x27) | (~new_n87_ & ~x16));
