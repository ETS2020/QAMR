...
module FAU ( 
  ...
  assign new_n83_ = ~new_n71_ & ((x07 & (x40 ? ~x39 : x20)) | (x05 & x39 & x40));
  ...
  assign z12 = new_n91_ | (~x20 & ~x40) | ((new_n66_ | ~x27) & (x40 ? ~new_n92_ : x20));
  ...
  assign z14 = (x40 & (new_n97_ | new_n99_)) | (x20 & ~new_n101_ & ~x40);
  assign new_n97_ = (new_n66_ | ~new_n98_) & (x04 | x13 | ~x39);
  assign new_n98_ = ~x18 & ~x19 & x20 & x27;
  assign new_n99_ = ~x30 & ~x32 & (~x27 | (~new_n100_ & x28));
  assign new_n100_ = (x35 | x37) & ((x35 & x36) | (~x18 & ~x19 & x20));
  assign new_n101_ = ~new_n66_ & ~x18 & ~x19 & x27;
  assign z15 = new_n69_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = new_n69_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n106_ & ~new_n69_) | (z08 & x08 & x29);
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (x20 | x40)));
