...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (~x40 | (~x30 & (new_n70_ | (~x27 & x40)))));
  ...
  assign z13 = ~new_n96_ | (x27 & (new_n95_ | (~x04 & new_n94_ & ~x13)));
  assign new_n94_ = x39 & ((~x28 & x40) | (~x32 & x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n96_ = (x32 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  ...
  assign new_n101_ = (~x32 | new_n92_ | x40) & (~x40 | ((new_n92_ | new_n100_) & (x30 | new_n102_ | x32)));
  ...
  assign new_n111_ = (~x32 | ((x08 | x27) & (x35 | x40))) & (x08 | ~x40 | (x27 & x35)) & (x27 | ~x28 | x40);
