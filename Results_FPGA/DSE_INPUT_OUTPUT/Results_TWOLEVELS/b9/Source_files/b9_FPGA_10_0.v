...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n93_, new_n94_, new_n96_, new_n97_, new_n98_, new_n99_, new_n104_,
  ...
  assign z18 = (~new_n104_ & x08) | ~new_n105_ | new_n65_ | x30;
  assign new_n104_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n105_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~x09 & ~new_n107_ & ~x30;
  assign new_n107_ = ~new_n108_ & (x08 | ((x35 | ~x39) & (x27 | (~x39 & ~x40))));
  assign new_n108_ = (x39 ? (~x29 | ~x40) : x40) & (~x35 | (~x27 & x28));
endmodule
