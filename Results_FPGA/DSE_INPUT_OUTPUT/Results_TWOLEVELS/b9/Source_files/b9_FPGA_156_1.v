...
module FAU ( 
  ...
  assign z02 = (~new_n71_ & x39) | ~x40 | (~x39 & x40) | (x04 & ~x08 & ~x27);
  ...
  assign new_n86_ = (~x40 | (~x29 & x39)) & (~new_n72_ | (x04 & x27));
  assign new_n87_ = (x27 | (~x39 & x40)) & (~x39 | (new_n72_ & ~x04));
  assign z12 = (x39 & (new_n89_ | (~new_n66_ & x04))) | (~new_n66_ & ~x40);
  ...
  assign z14 = new_n97_ | ~new_n99_ | (~new_n102_ & (x04 | x13));
  assign new_n97_ = ~x37 & ((~new_n98_ & (~x28 | ~x35)) | (~x32 & ~x35 & x28 & ~x30));
  assign new_n98_ = ~x13 & x40 & (~x04 | ~x39);
  assign new_n99_ = ~new_n100_ & ~new_n65_ & (new_n101_ | (~x18 & ~x19 & x20));
  assign new_n100_ = ~x27 & (~x40 | (~x30 & ~x32));
  assign new_n101_ = x40 & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n102_ = ~x18 & ~x19 & x20 & (x27 | ~x39);
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = ~new_n107_ | (x08 & ((x29 & x40) | (new_n72_ & ~x27)));
  ...
  assign new_n110_ = (~x40 | (~x29 & x39)) & (~x35 | (~x27 & x28));
