...
module FAU ( 
  ...
  assign new_n72_ = x39 & ((~new_n73_ & ~x02) | (x04 & (x28 | ~x35)));
  assign new_n73_ = x08 & x29;
  assign new_n74_ = x40 ? x39 : ((~x27 | ~x28) & ~x37 & (x28 | x37));
  ...
  assign z12 = new_n92_ | (~x39 & x40) | ((new_n66_ | ~x27) & (~x40 | (x04 & x39)));
  assign new_n92_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x40 & (~x39 | (~x04 & ~new_n85_ & ~x13)));
