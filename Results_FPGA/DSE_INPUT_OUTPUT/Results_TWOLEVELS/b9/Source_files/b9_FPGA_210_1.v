...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n78_,
    ...
    new_n100_, new_n101_, new_n102_, new_n107_, new_n110_, new_n111_;
  ...
  assign new_n85_ = ~x04 & x05 & x08 & x39 & ~new_n86_ & x40;
  assign new_n86_ = ~x30 & ~x32;
  assign z11 = ~x09 & ~x30 & (new_n88_ | (~x08 & ~x27 & ~x40));
  assign new_n88_ = ~new_n89_ & ((x04 & x27) | x28 | ~x35);
  assign new_n89_ = x40 & (~x08 | (x29 & x39));
  assign z12 = ~new_n91_ | (~new_n92_ & ~x10);
  assign new_n91_ = (x08 | ~x40) & (new_n68_ | (~x04 & x39 & x40));
  assign new_n92_ = (x35 | x36 | x37) & (~x08 | x27 | ~x40);
  assign z13 = (~new_n94_ & x40) | (x27 & (new_n96_ | (new_n95_ & ~x04)));
  assign new_n94_ = x08 & (x04 | x13 | new_n86_ | ~x39);
  ...
  assign new_n98_ = ~x04 & x39 & x40 & (~x08 | (~new_n86_ & (~x13 | ~x40)));
  ...
  assign z18 = new_n107_ | new_n89_ | x09 | x30;
  assign new_n107_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z19 = (~x08 & (x40 | (~x09 & ~x27 & ~x30 & ~x40))) | (~x09 & new_n88_ & ~x30);
  assign z20 = new_n67_ | (~x09 & ~new_n110_ & ~x30);
  assign new_n110_ = (new_n111_ | ((x27 | ~x28) & (~x08 | x35))) & (x40 | (x35 & (x27 | (x08 & ~x28))));
