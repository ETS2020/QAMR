// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:25 2020
...
module FAU ( 
  ...
  assign new_n74_ = (x40 | (x04 & ~x09 & ~x30)) & x39 & (~x34 | ~x40);
  ...
  assign new_n85_ = ~new_n70_ & ((x39 & x40) ? x05 : x07);
  ...
  assign new_n90_ = x40 & (x34 | (x29 & x39));
  assign new_n91_ = (x27 | (x34 & x40)) & (x34 | (~x04 & ~x28 & x35));
  assign z12 = new_n93_ | (x34 & x40) | (~new_n68_ & (x04 | ~x39 | ~x40));
  assign new_n93_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n95_ & x27) | (~x04 & ~x13 & new_n87_ & ~x34);
  assign new_n95_ = (~new_n98_ | x18) & (x34 | ((~new_n96_ | x04) & (~new_n97_ | x18)));
  ...
  assign new_n102_ = ~new_n67_ & (new_n68_ | new_n101_) & (~new_n103_ | x30);
  assign new_n103_ = ~x32 & ((~x27 & ~x34) | (x28 & ~x35 & ~x37));
  assign z15 = x34 & (x40 | (x12 & x26 & x27));
  assign z16 = new_n67_ | (x01 & x22 & ~x23);
  assign z17 = x01 & x22 & x23 & ~new_n67_ & ~x24;
  assign z18 = (~new_n108_ & (~x34 | ~x40)) | (x08 & x29 & ~x34 & x39 & x40);
  assign new_n108_ = ~new_n109_ & ~x09 & ~x30;
  assign new_n109_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n111_ & ~x09;
  assign new_n111_ = ~x30 & (new_n112_ | (~new_n90_ & (~x35 | (~x27 & x28))));
  assign new_n112_ = ~x08 & ((~x34 & ~x35) | (~x27 & (~x34 | ~x40)));
