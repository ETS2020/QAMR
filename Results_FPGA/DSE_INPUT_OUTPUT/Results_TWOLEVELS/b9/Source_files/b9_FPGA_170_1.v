...
module FAU ( 
  ...
  assign new_n72_ = ~new_n73_ & new_n68_ & (~x04 | (~x28 & x35));
  ...
  assign new_n83_ = x40 & ((x16 & (x30 | x32 | (~new_n70_ & x27))) | (~x27 & (x30 | x32)));
  assign new_n84_ = x07 & x16 & x27 & ~new_n68_ & ~new_n70_;
  assign new_n85_ = x06 & x16 & x27 & x37;
  assign z11 = z19 | (~x16 & x27);
  assign z19 = ~x09 & ~x30 & (new_n90_ | (~new_n88_ & ~new_n89_));
  assign new_n88_ = x29 & x39 & x40;
  assign new_n89_ = (~x04 | ~x16 | ~x27) & ((~x16 & x27) | (~x28 & x35));
  assign new_n90_ = ~x08 & (~x27 | (x16 & (x04 | x28 | ~x35)));
  assign z12 = new_n92_ | (~x16 & x27) | ((~x27 | (new_n66_ & x16)) & (~new_n68_ | x04));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x16 & ((~new_n94_ & x27) | (~x04 & new_n96_ & ~x13))) | (~x04 & ~x13 & new_n96_ & ~x27);
  assign new_n94_ = (~new_n95_ | x04) & (x18 | x19 | new_n66_ | ~x20);
  assign new_n95_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n96_ = x39 & x40 & (x30 | x32);
  assign z14 = (~new_n101_ & ~x27) | (x16 & (new_n100_ | (~new_n98_ & ~new_n102_)));
  ...
  assign z18 = new_n108_ | (~new_n107_ & (x16 | ~x27));
  assign new_n107_ = ~x09 & ~x30 & (~new_n68_ | ~x08 | ~x29);
  assign new_n108_ = ~x28 & x35 & ((x08 & ~x27) | (~x04 & x16 & x27));
  assign z20 = ~x09 & ~new_n110_ & ~x30;
  assign new_n110_ = (x08 | (x27 & (~x16 | x35))) & (new_n88_ | ((~x16 | x35) & (x27 | (~x28 & x35))));
  assign z05 = ~z06;
endmodule
