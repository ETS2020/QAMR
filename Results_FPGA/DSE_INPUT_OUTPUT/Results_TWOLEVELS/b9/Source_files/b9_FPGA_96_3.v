// Benchmark "FAU" written by ABC on Fri Aug 21 23:00:13 2020
...
module FAU ( 
  ...
  assign z07 = (x14 & x40) | (x03 & ((new_n80_ & ~x31) | (~new_n81_ & ~x14)));
  assign new_n80_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign new_n81_ = ~x00 & ~x25 & x38;
  assign z08 = x40 & (x14 | x39);
  assign z09 = new_n69_ | (x27 & x34 & x11 & x26);
  assign z10 = (~new_n85_ & ~x04) | new_n69_ | (x06 & x27 & x37);
  assign new_n85_ = (~x27 | new_n71_ | (new_n68_ ? ~x05 : ~x07)) & (~new_n86_ | ~x05);
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = (x40 & (x14 | (new_n90_ & ~x09 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
  assign new_n88_ = (new_n89_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (x27 & ~x28 & x35));
  assign new_n89_ = x29 & x39 & x40;
  assign new_n90_ = x04 & ~x08;
  assign z12 = (~new_n94_ & ~x10) | ~new_n92_ | new_n95_;
  assign new_n92_ = (z08 | x27) & (~new_n93_ | x37);
  assign new_n93_ = (~x28 | ~x35) & (~x40 | (~x14 & (x04 | ~x39)));
  assign new_n94_ = (x35 | x36 | x37) & (x14 | x27 | ~x40);
  assign new_n95_ = x40 & (x14 | (x04 & ~x14 & ~x27));
  ...
  assign new_n99_ = ~x14 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n101_ & ~new_n105_) | new_n104_ | (~x14 & (~new_n103_ | new_n106_));
  assign new_n101_ = x40 & (x14 | (~new_n102_ & x39 & (~x40 | (~x04 & ~x13))));
  assign new_n102_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n103_ = ((~x04 & ~x13) | (~new_n66_ & (x27 | ~x40))) & (x39 | (~new_n66_ & x27));
  assign new_n104_ = ~x40 & (new_n66_ | ~x27);
  assign new_n105_ = ~x18 & ~x19 & x20;
  ...
  assign z18 = (new_n89_ & x08 & ~x14) | (~new_n111_ & (~x14 | ~x40));
  assign new_n111_ = ~new_n112_ & ~x09 & ~x30;
  assign new_n112_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n69_ | (~x09 & ~new_n114_ & ~x30);
  assign new_n114_ = (x08 | (x27 & x35)) & (new_n89_ | (x35 & (x27 | ~x28)));
  assign z19 = (x40 & (x14 | (new_n90_ & ~x09 & ~x30))) | (~x09 & ~new_n88_ & ~x30);
endmodule
