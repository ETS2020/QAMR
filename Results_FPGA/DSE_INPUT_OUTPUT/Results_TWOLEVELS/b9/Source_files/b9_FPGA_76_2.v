...
module FAU ( 
  ...
  assign z02 = ~x39 | (x40 & (new_n73_ | (~x02 & (~x08 | ~x29))));
  assign new_n73_ = x04 & (~new_n70_ | (~x08 & ~x27));
  assign z03 = (~x27 & ~x37 & (~x39 | (x39 & x40))) | (x27 & ~new_n66_ & (~x39 | x40)) | ~x21 | (x39 & ~x40);
  assign z04 = (~x27 & ~x37 & (~x39 | (x39 & x40))) | ((~x39 | x40) & (x21 | (~new_n66_ & x27)));
  assign z05 = (~x39 | (x39 & x40)) & (x37 | (x27 & x28));
  assign z06 = (x39 & ~x40) | (~x37 & (~x27 | ~x28) & (~x39 | (x39 & x40)));
  assign z07 = x03 & ~new_n79_ & ~new_n71_;
  assign new_n79_ = (~new_n80_ | x31) & (x14 | (~x00 & ~x25 & x38));
  assign new_n80_ = ~x33 & (x15 | ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = x39 & x40;
  assign z09 = new_n71_ | (x27 & x34 & x11 & x26);
  assign z10 = (~new_n84_ & ~x04) | new_n71_ | (x06 & x27 & x37);
  assign new_n84_ = (~new_n85_ | ~x27) & (~x05 | ~x39 | (~x30 & ~x32));
  assign new_n85_ = (x36 | (~x28 & x35)) & (x39 ? x05 : x07);
  assign z11 = new_n71_ | (~x09 & ~new_n87_ & ~x30);
  assign new_n87_ = ((x29 & x39) | (new_n70_ & (~x04 | ~x27))) & (x08 | (new_n70_ & ~x04 & x27));
  assign z12 = ~new_n89_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n89_ = (x27 | (x39 & (~x04 | ~x39))) & (~x39 | x40) & (x37 | new_n66_ | (~x04 & x39));
  assign z13 = new_n95_ | (~new_n91_ & x27);
  assign new_n91_ = (~x40 | (~new_n92_ & (x18 | ~new_n93_ | x19))) & (x18 | ~new_n94_ | x19);
