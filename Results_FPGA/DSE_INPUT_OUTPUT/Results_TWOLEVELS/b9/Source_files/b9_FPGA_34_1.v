...
module FAU ( 
  ...
  assign z02 = ~x40 | (x38 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n89_ = x40 & (~x38 | (x29 & x39));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n92_ | new_n67_ | (~new_n68_ & ~new_n93_);
  assign new_n92_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x38));
  ...
  assign new_n97_ = x38 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = new_n99_ | new_n100_ | new_n103_ | new_n67_;
  assign new_n99_ = ~x27 & (~new_n93_ | (x38 & (x13 | (~x30 & ~x32))));
  ...
  assign z18 = (~new_n108_ & (x38 | ~x40)) | (x08 & x29 & x38 & x39 & x40);
