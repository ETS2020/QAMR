// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:09 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n71_, new_n73_,
    ...
    new_n99_, new_n100_, new_n101_, new_n106_, new_n108_;
  ...
  assign z02 = x39 ? (new_n73_ | ~x40 | (~x02 & (~x08 | ~x29))) : x40;
  assign new_n73_ = x04 & (~new_n74_ | (~x08 & ~x27));
  ...
  assign new_n84_ = ~x04 & ~new_n71_ & ((x07 & (x39 ^ x40)) | (x05 & x39 & x40));
  assign new_n85_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n69_ | (~x09 & ~x30 & (new_n87_ | new_n88_));
  assign new_n87_ = (~new_n68_ | ~x29) & (~new_n74_ | (x04 & x27));
  assign new_n88_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x39));
  assign z12 = new_n90_ | (~x39 & ~x40) | ((new_n66_ | ~x27) & (x39 ? (x04 | ~x40) : x40));
  assign new_n90_ = ~x10 & ((~x27 & x39) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n95_ | (x27 & (new_n92_ | (new_n94_ & ~x18)));
  assign new_n92_ = x39 & (new_n93_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n93_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x19 & x20 & ~new_n66_ & x40;
  assign new_n95_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n97_ | new_n100_ | (~x30 & ~new_n101_ & ~x32);
  assign new_n97_ = ~new_n98_ & (x39 ? (new_n99_ | x04 | x13 | ~x40) : x40);
  assign new_n98_ = ~x18 & ~x19 & x20;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = (new_n66_ | ~x27) & (x39 ? (x04 | x13 | ~x40) : x40);
  assign new_n101_ = (x27 | ~x40) & (~x28 | x35 | x37 | ~x39);
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = new_n69_ | (x01 & x22 & ~x23);
  assign z17 = new_n69_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n106_ | (x08 & ((new_n68_ & x29) | (new_n74_ & ~x27)));
  assign new_n106_ = ~x09 & (~new_n74_ | x04 | ~x27) & ~new_n69_ & ~x30;
  assign z20 = new_n69_ | (~x09 & ~new_n108_ & ~x30);
  assign new_n108_ = (x08 | (x27 & x35)) & ((new_n68_ & x29) | (x35 & (x27 | ~x28)));
  assign z06 = ~z05;
  assign z19 = new_n69_ | (~x09 & ~x30 & (new_n87_ | new_n88_));
endmodule
