...
module FAU ( 
  ...
  assign new_n84_ = ~new_n71_ & ((x07 & (x40 ? ~x39 : ~x09)) | (x05 & x39 & x40));
  assign new_n85_ = x06 & ~new_n69_ & x37;
  assign new_n86_ = x39 & x40 & (x30 | x32);
  assign z11 = z19 | new_n69_;
  assign z19 = ~x09 & ~x30 & (new_n90_ | (~new_n89_ & (~new_n68_ | ~x29)));
  assign new_n89_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n90_ = ~x08 & (~x27 | x28 | ~x35 | (x04 & x40));
  assign z12 = (x40 & (new_n92_ | (~new_n93_ & (new_n66_ | ~x27)))) | (~x09 & ~x40 & (new_n66_ | ~x27));
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n93_ = ~x04 & x39;
  assign z13 = (~new_n95_ & x27) | new_n69_ | (~x04 & new_n86_ & ~x13);
  ...
  assign new_n99_ = (~x40 | (~x04 & x39)) & ~x13 & (x09 | x40);
  assign new_n100_ = ~new_n101_ & x39 & x40 & (~x40 | (~x04 & ~x13));
  assign new_n101_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n102_ = (x40 | (~x09 & (x09 | x27))) & (x27 | new_n103_ | ~x40);
  ...
  assign z18 = ~new_n109_ | (~new_n108_ & x08);
  assign new_n108_ = (~new_n68_ | ~x29) & (x27 | x28 | ~x35);
  assign new_n109_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = (x09 & ~x40) | (~x30 & ((~new_n111_ & ~x09) | (~x27 & x28 & ~x40)));
  assign new_n111_ = (x08 | (x27 & x35)) & (new_n112_ | (x35 & (x27 | ~x28))) & (x35 | x40);
  assign new_n112_ = x29 & x39;
endmodule
