...
module FAU ( 
  ...
  assign new_n89_ = ~new_n90_ & (~x40 | (x31 & (~x29 | ~x39)));
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n91_ = (x27 | (~x31 & x40)) & (~x31 | (~x04 & ~x28 & x35));
  assign z12 = (x31 & (new_n93_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n93_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign z13 = (new_n99_ & ~x04) | (~new_n95_ & x27);
  assign new_n95_ = (~new_n98_ | x18) & (~x31 | ((~new_n96_ | x04) & (~new_n97_ | x18)));
  assign new_n96_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n97_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n98_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign new_n99_ = ~x13 & x31 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n106_ & (~x40 | (~new_n101_ & x31))) | (~new_n68_ & ~x40) | (~new_n103_ & x31);
  ...
  assign z18 = (~new_n111_ & (x31 | ~x40)) | (x08 & x29 & x31 & x39 & x40);
  assign new_n111_ = ~new_n112_ & ~x09 & ~x30;
  assign new_n112_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n67_ | (~x09 & ~x30 & (new_n114_ | ~new_n115_));
  assign new_n114_ = (~x29 | ~x39) & ((~x27 & x28) | (x31 & ~x35));
  assign new_n115_ = (x08 | ((~x31 | x35) & (x27 | (~x31 & x40)))) & (x40 | (x35 & (x27 | ~x28)));
