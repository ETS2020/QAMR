...
module FAU ( 
  ...
  assign new_n82_ = ~new_n69_ & ((x07 & (x40 ? ~x39 : x18)) | (x05 & x39 & x40));
  ...
  assign z14 = (x40 & (new_n96_ | ~new_n98_)) | (x18 & (new_n100_ | ~x39 | ~x40));
  assign new_n96_ = (x04 | x13) & (~new_n97_ | (~x37 & (~x28 | ~x35)));
  assign new_n97_ = ~x18 & ~x19 & x20 & x27;
  assign new_n98_ = ~new_n99_ & ~new_n101_ & ((~x19 & x20) | (~new_n100_ & x39));
  assign new_n99_ = ~x27 & (~x39 | (~x30 & ~x32));
  ...
  assign z20 = (~x18 & ~x40) | (~x09 & ~x30 & (~new_n110_ | (~new_n112_ & x18)));
