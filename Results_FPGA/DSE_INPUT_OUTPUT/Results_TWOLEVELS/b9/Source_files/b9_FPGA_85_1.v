...
module FAU ( 
  ...
  assign z02 = (~new_n72_ & x00) | ~x40 | new_n73_ | ~x39 | (~x00 & x40);
  ...
  assign new_n79_ = (x15 | ~x17) & ((x00 & (~x25 | ~x38)) | (~x38 & ~x40));
  assign new_n80_ = ~x14 & (x00 | (~x40 & (x25 | ~x38)));
  assign z08 = x40 & x00 & x39;
  assign z09 = x11 & x26 & x27 & ~new_n67_ & x34;
  assign z10 = (~new_n84_ & ~x04) | new_n67_ | (x06 & x27 & x37);
  assign new_n84_ = (~x27 | new_n70_ | (new_n85_ ? ~x05 : ~x07)) & (~new_n86_ | ~x05);
  ...
  assign new_n90_ = (x27 | (~x00 & x40)) & (~x00 | (~x04 & ~x28 & x35));
  assign z12 = new_n92_ | new_n67_ | (~new_n68_ & (~new_n85_ | x04));
  assign new_n92_ = ~x10 & ((x00 & ~x27) | (~x35 & ~x36 & ~x37));
  ...
  assign new_n96_ = x00 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n98_ & ~x27) | new_n99_ | new_n102_ | new_n67_;
  assign new_n98_ = new_n85_ & ~x04 & (~x00 | (~x13 & (x30 | x32)));
  ...
  assign z18 = new_n107_ | (~new_n67_ & (new_n108_ | x09 | x30));
  assign new_n107_ = x00 & x08 & new_n85_ & x29;
  assign new_n108_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n110_ & ~x09;
  assign new_n110_ = ~x30 & (new_n111_ | (~new_n89_ & (~x35 | (~x27 & x28))));
  assign new_n111_ = ~x08 & ((x00 & (~x27 | ~x35)) | (~x27 & ~x40));
