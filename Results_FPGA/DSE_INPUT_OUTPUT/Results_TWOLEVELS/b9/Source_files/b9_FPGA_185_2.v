// Benchmark "FAU" written by ABC on Fri Aug 21 23:01:05 2020
...
module FAU ( 
  ...
  assign z01 = ~x04 | (x04 & ~x27) | (~x30 & new_n69_ & ~x32);
  assign new_n69_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n71_ | (~x02 & (~x08 | ~x29));
  assign new_n71_ = new_n72_ & (~x04 | ((~x27 | ~x28) & x27 & x35));
  assign new_n72_ = x39 & x40;
  assign z03 = (~x04 & (~x21 | (~x27 & ~x37))) | (x27 & (~x28 | ~x35 | (x04 & ~x21 & x28)));
  assign z04 = (~x04 & (x21 | (~x27 & ~x37))) | (x27 & (~x28 | ~x35 | (x04 & x21 & x28)));
  assign z05 = x37 | (x04 & ~x27) | (x27 & x28);
  assign z06 = ~x37 & (x04 ? (x27 & ~x28) : (~x27 | ~x28));
  ...
  assign new_n83_ = (~new_n84_ | ~x05) & (~x27 | new_n69_ | (new_n72_ ? ~x05 : ~x07));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & ((~new_n87_ & ~x04) | (~new_n86_ & x27));
  assign new_n86_ = (x08 | x35) & ((~x04 & ~x28) | (new_n72_ & x08 & x29));
  assign new_n87_ = (x08 | x27) & (new_n88_ | (x35 & (x27 | ~x28)));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = ~new_n90_ | (~x10 & (~x27 | (~x35 & ~x36 & ~x37)));
  assign new_n90_ = (x37 | ((~x04 | (x35 & (~x27 | x28))) & (new_n72_ | (x28 & x35)))) & (x27 | (new_n72_ & ~x04));
  assign z13 = (~x04 & new_n84_ & ~x13) | (x27 & (new_n93_ | (~x04 & new_n92_ & ~x13)));
  assign new_n92_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = (~new_n98_ & (~new_n95_ | new_n99_)) | new_n100_ | new_n96_ | (~new_n95_ & ~x27);
  assign new_n95_ = new_n72_ & ~x04 & ~x13;
  assign new_n96_ = ~x37 & ((x04 & (~x35 | (x27 & ~x28))) | (~new_n97_ & (~x28 | ~x35)));
  assign new_n97_ = ~x13 & x39 & x40;
  ...
  assign z18 = ~new_n105_ | (x08 & (new_n88_ | (~x27 & ~x28 & x35)));
  assign new_n105_ = ~x09 & (~x04 | x27) & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z19 = (~x09 & ~x30 & ((~new_n87_ & ~x04) | (~new_n86_ & x27))) | (x04 & ~x27);
