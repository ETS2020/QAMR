...
module FAU ( 
  ...
  assign new_n84_ = (~x08 | x40) & (~x06 | ~x27 | ~x37);
  assign z11 = (x08 & ~x40) | (~x09 & ~x30 & ((~new_n87_ & ~x08) | (new_n86_ & x40)));
  ...
  assign z13 = new_n93_ | (x27 & ((x40 & (new_n91_ | new_n92_)) | (new_n92_ & ~x08)));
  ...
  assign z18 = ((~x08 | x40) & (x09 | new_n87_ | x30)) | (x08 & ~new_n103_ & x40);
  assign new_n103_ = (~x29 | ~x39) & (x27 | x28 | ~x35);
  assign z19 = ~x09 & ~x30 & ((~new_n87_ & ~x08) | (new_n86_ & x40));
  assign z20 = (x08 & ~x40) | (~x09 & ~x30 & (new_n107_ | (~new_n106_ & ~x08)));
  assign new_n106_ = x27 & x35;
  assign new_n107_ = (~x29 | ~x39) & ((~x27 & x28) | (~x35 & x40));
endmodule
