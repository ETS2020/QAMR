...
module FAU ( 
  ...
  assign z12 = new_n90_ | (x39 & ~x40) | ((new_n66_ | ~x27) & (x04 | ~x39));
  assign new_n90_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign z13 = new_n92_ | (x39 & (~x40 | (new_n94_ & ~x04)));
  assign new_n92_ = x27 & (new_n93_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n93_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x13 & (x30 | x32);
  assign z14 = new_n96_ | ~new_n98_ | (~new_n97_ & (x04 | x13 | ~x39));
  assign new_n96_ = ~x27 & (x04 | ~x39 | (~new_n94_ & x40));
  ...
  assign z18 = new_n104_ | ~new_n105_ | new_n69_ | x30;
  assign new_n104_ = x08 & ((~x27 & ~x28 & x35) | (x29 & x39));
