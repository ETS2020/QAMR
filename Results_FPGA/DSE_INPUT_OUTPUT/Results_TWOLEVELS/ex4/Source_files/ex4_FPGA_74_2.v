// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:45 2020
...
module FAU ( 
  ...
  assign new_n172_ = ~new_n173_ & (x036 | x052) & x077 & (x012 | x076);
  assign new_n173_ = ~x020 & ~x068 & ((x012 & x052) | (x036 & x076));
  assign new_n174_ = ~x004 & ~x084 & ((x012 & x036) | (x052 & x076));
  assign z05 = x045 & (new_n176_ | new_n188_ | (x077 & (new_n179_ | ~new_n190_)));
  assign new_n176_ = ~x037 & ((~x044 & ~x053) | (x077 & (new_n177_ | ~x053)));
  ...
  assign new_n188_ = ~x044 & ~x077 & (~new_n189_ | ~x013);
  ...
  assign z13 = z07 | (~x045 & (new_n239_ | ~new_n254_ | (~new_n248_ & ~x085)));
