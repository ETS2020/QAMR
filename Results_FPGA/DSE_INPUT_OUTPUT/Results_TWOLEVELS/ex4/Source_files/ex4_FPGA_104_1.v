...
module FAU ( 
  ...
  assign new_n186_ = ~x037 & ((~x053 & ~x125) | (x077 & (new_n187_ | new_n188_ | ~x053)));
  assign new_n187_ = x013 & ((~x029 & x085) | (~x005 & x109 & ~x125));
  assign new_n188_ = x085 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n189_ = ~x125 & (~new_n190_ | ~x013);
  ...
  assign z13 = z15 | (~x045 & (new_n240_ | ~new_n251_ | (~new_n246_ & ~x085)));
  assign new_n240_ = x005 & ((~x013 & ~x037 & x085) | (new_n241_ & ~x053));
  assign new_n241_ = ~x077 & (new_n244_ | ~new_n245_ | (~new_n243_ & (~new_n242_ | x029)));
  assign new_n242_ = ~x061 & ~x093;
  assign new_n243_ = x013 & x021;
  assign new_n244_ = x101 & ((~x069 & ~x093) | (~x037 & ~x061));
  assign new_n245_ = ~x085 & ((~x109 & ~x117) | (x037 & x069));
  assign new_n246_ = ~new_n249_ & (x053 | (~new_n247_ & (new_n250_ | (~x109 & ~x117))));
  assign new_n247_ = ~x077 & ((~new_n248_ & x029) | (~new_n242_ & x069));
  assign new_n248_ = (x021 | ~x069) & (~x101 | (x013 & x021) | (x061 & x093));
  assign new_n249_ = x037 & ~x077 & (~new_n242_ | (~new_n243_ & x029));
  ...
  assign new_n255_ = (x030 | x062 | x094) & (~x014 | ~x022);
