// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:12 2020
...
module FAU ( 
  ...
  assign new_n186_ = (~x101 | ~x125) & (x013 | x021) & (x061 | x093);
  ...
  assign z13 = ~new_n238_ & ~x045;
  assign new_n238_ = ~x013 & (~x037 | ~x053) & new_n239_ & (~x021 | x053 | ~x069);
  assign new_n239_ = x077 & (~x005 | x037 | ~x085);
  ...
  assign new_n251_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n252_ = ~x078 & ((new_n253_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n253_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n254_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
