...
module FAU ( 
  ...
  assign new_n186_ = ~x037 & ((~x053 & ~x104) | (x077 & (new_n187_ | new_n188_ | ~x053)));
  assign new_n187_ = x013 & ((~x029 & x085) | (~x005 & x109 & ~x125));
  assign new_n188_ = x085 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n189_ = ~x104 & (~new_n190_ | ~x013);
  ...
  assign new_n215_ = x000 & x080 & ((~x048 & ~x072) | (~x008 & ~x032));
  assign new_n216_ = (new_n217_ | (x104 ? ~x077 : ~x112)) & (x072 | new_n220_ | x104);
  ...
  assign new_n224_ = (x016 | ~x120) & ((~x024 & ~x056 & ~x088) | (x008 & x016));
  assign new_n225_ = ~x016 & x024 & x064 & ~x080;
  assign new_n226_ = ~new_n227_ & ~x072;
  assign new_n227_ = (x008 | (~new_n228_ & (~x024 | x080 | x104))) & (x016 | ~x024 | x080 | x104);
  assign new_n228_ = x000 & x077 & ~x112 & x120;
  ...
  assign new_n252_ = ~x077 & ((x069 & (~new_n253_ | (~x021 & x029))) | (new_n254_ & x029));
  ...
  assign new_n261_ = (x030 | x062 | x094) & (~x014 | ~x022);
