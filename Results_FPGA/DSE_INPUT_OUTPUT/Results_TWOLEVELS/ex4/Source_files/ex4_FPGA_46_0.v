...
module FAU ( 
  ...
  assign z10 = ~x042 & (~new_n231_ | new_n234_ | (~new_n233_ & x074));
  assign new_n231_ = (~x050 | (~x034 & (~x018 | ~x066 | x074))) & (~x018 | ~new_n232_ | ~x066);
  assign new_n232_ = x077 & ((~x010 & ~x050) | (~x034 & ~x074));
  assign new_n233_ = (~x010 | (~x050 & ~x077)) & (~x077 | ~x082 | ~x002 | x034);
  assign new_n234_ = x002 & x082 & (x050 ? ~x010 : (~x074 & x077));
