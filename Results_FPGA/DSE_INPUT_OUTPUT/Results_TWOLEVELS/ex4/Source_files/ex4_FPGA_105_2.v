// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:21 2020
...
module FAU ( 
  ...
  assign z09 = z15 | (~x041 & (new_n227_ | ~new_n228_));
  ...
  assign new_n251_ = x037 & ((~x077 & (new_n252_ | x053)) | (x053 & x122));
  assign new_n252_ = ~x085 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n253_ = x122 & (~new_n254_ | x013);
