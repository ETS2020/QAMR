// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:42 2020
...
module FAU ( 
  ...
  assign z05 = (~x053 & (x077 | (~x037 & x045))) | (x045 & (new_n175_ | ~new_n182_));
  assign new_n175_ = ~x005 & (new_n181_ | (x077 & (new_n179_ | ~new_n176_ | new_n180_)));
  assign new_n176_ = (x117 | (~x037 & (~x109 | x125))) & new_n178_ & (~x037 | (~new_n177_ & x109));
  assign new_n177_ = x061 & ~x101;
  assign new_n178_ = x085 & (~x021 | ~x117 | x125);
  assign new_n179_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n180_ = x069 & (~x109 | ~x117 | (x093 & (~x101 | ~x125)));
  assign new_n181_ = x037 & (~x085 | (~x013 & x061 & ~x125));
  assign new_n182_ = new_n187_ & (~x077 | ((new_n189_ | x069) & (new_n183_ | ~x085)));
  assign new_n183_ = ~new_n184_ & ~new_n186_ & (x029 | new_n185_ | (~x013 & ~x021));
  assign new_n184_ = (~x109 | ~x117) & (~x021 | (~x029 & (x061 | x093)));
  assign new_n185_ = x037 & ((x101 & x125) | (~x061 & ~x093));
  assign new_n186_ = ~x037 & (~x061 | ~x093);
  assign new_n187_ = (new_n188_ | x013) & (~x013 | x021 | ~x053 | x069);
  assign new_n188_ = x077 & (~x085 | (x109 & x117));
  assign new_n189_ = (~x037 | (x021 & (x029 | ~x085))) & (~x085 | (x061 & x093));
  ...
  assign new_n222_ = (x096 | x120) & (~x056 | ~x088) & (~x008 | ~x016);
  ...
  assign new_n226_ = x001 & x081 & ((~x049 & ~x073) | (~x009 & ~x033));
  assign new_n227_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = ~x042 & ~z07 & (new_n229_ | ~new_n230_);
  assign new_n229_ = x002 & x082 & ((~x050 & ~x074) | (~x010 & ~x034));
  assign new_n230_ = (~x018 | ~x066 | ((x010 | x050) & (x034 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = z07 | (~x043 & (new_n232_ | ~new_n233_));
  assign new_n232_ = x003 & x083 & ((~x051 & ~x075) | (~x011 & ~x035));
  assign new_n233_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = z07 | (~x044 & (new_n235_ | ~new_n236_));
  assign new_n235_ = x004 & x084 & ((~x052 & ~x076) | (~x012 & ~x036));
  assign new_n236_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = (x077 & (~x053 | (x013 & ~x045))) | (~x045 & (~new_n248_ | (~new_n238_ & ~x053)));
  assign new_n238_ = ~new_n239_ & (new_n247_ | x037) & ~new_n241_ & ~new_n243_ & ~new_n245_;
  assign new_n239_ = (x109 | x117) & (new_n240_ | (x005 & (~x037 | ~x069)));
  assign new_n240_ = ~x085 & (x013 | x021 | (x029 & (~x061 | ~x093)));
  assign new_n241_ = ~new_n242_ & (x061 | x093);
  assign new_n242_ = (~x069 | x085) & (~x005 | (x013 & x021));
  assign new_n243_ = (x101 | x125) & (new_n244_ | (x005 & ~x069 & ~x093));
  assign new_n244_ = x029 & ~x085 & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n245_ = x005 & (~new_n246_ | (~x021 & (x029 | (~x117 & x125))));
  assign new_n246_ = (x013 | ~x029) & ~x085 & (x061 | ~x093 | ~x125);
  assign new_n247_ = (~x029 | ~x069 | x085) & (~x005 | x061 | ~x101);
  assign new_n248_ = new_n251_ & (new_n249_ | x013);
  assign new_n249_ = new_n250_ & (~x005 | (~x085 & (~x037 | x109 | ~x125)));
  assign new_n250_ = (~x021 | ~x069 | x077) & (~x029 | ~x037 | x085);
  assign new_n251_ = (~x021 | x037 | ~x069 | x077) & (new_n252_ | ~x037);
  assign new_n252_ = ~x053 & (x085 | ((x021 | ~x029) & ~x061 & ~x093));
  ...
  assign new_n264_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n265_ = ~x078 & ((new_n266_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n266_ = (x102 | x126) & (~x062 | ~x094) & (~x014 | ~x022);
  assign new_n267_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
