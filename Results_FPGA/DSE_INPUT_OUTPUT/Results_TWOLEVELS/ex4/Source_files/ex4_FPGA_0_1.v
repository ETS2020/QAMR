...
module FAU ( 
  ...
  assign z13 = ~x045 & (new_n249_ | new_n251_ | (~new_n238_ & ~x093));
  assign new_n238_ = (new_n248_ | x077) & (x053 | (~new_n239_ & (x077 | (~new_n241_ & ~new_n243_))));
  assign new_n239_ = (x109 | x117) & ((x013 & ~x085) | (~new_n240_ & ~x077));
  assign new_n240_ = (x085 | (~x021 & ~x029)) & (~x005 | (x037 & x069));
  assign new_n241_ = ~x085 & (new_n242_ | (x061 & x069));
  assign new_n242_ = x029 & ((~x021 & x069) | ((~x013 | ~x021) & (x101 | x125)));
  assign new_n243_ = x005 & (new_n244_ | new_n245_ | new_n246_ | ~new_n247_);
  assign new_n244_ = (x029 | x061) & (~x013 | ~x021);
  assign new_n245_ = ~x069 & (x101 | x125);
  assign new_n246_ = x125 & ((~x013 & ~x109) | (~x021 & ~x117));
  assign new_n247_ = ~x085 & (x037 | ~x101);
  assign new_n248_ = (x013 | ((~x005 | ~x085) & (~x021 | ~x069))) & (~x021 | x037 | ~x069);
  assign new_n249_ = x037 & ((x053 & x077) | (~x093 & (x053 | (new_n250_ & ~x077))));
  assign new_n250_ = ~x085 & (x061 | (x029 & (~x013 | ~x021)));
  assign new_n251_ = x077 & (~new_n252_ | x013);
  assign new_n252_ = (~x021 | x053 | ~x069) & (~x005 | x037 | ~x085);
