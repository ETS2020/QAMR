// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:01 2020
...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (~new_n183_ | (~new_n175_ & ~x005)));
  ...
  assign z13 = new_n256_ | (~x045 & (~new_n248_ | (~new_n240_ & x005)));
  ...
  assign new_n248_ = (x085 | ((new_n249_ | x053) & (~new_n254_ | ~x037))) & ~new_n255_ & (~x037 | ~x053);
  assign new_n249_ = (new_n250_ | new_n251_) & (x077 | (~new_n252_ & (~new_n253_ | ~x029)));
  assign new_n250_ = ~x109 & ~x117;
  assign new_n251_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
  assign new_n252_ = x069 & ((~x021 & x029) | x061 | x093);
  assign new_n253_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n254_ = ~x077 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n255_ = x021 & x069 & ((~x013 & ~x053) | (~x037 & ~x077));
  assign new_n256_ = x077 & (~x111 | (x013 & ~x045));
  assign z14 = z15 | (~x046 & (new_n258_ | ~new_n272_ | (~new_n267_ & ~x086)));
