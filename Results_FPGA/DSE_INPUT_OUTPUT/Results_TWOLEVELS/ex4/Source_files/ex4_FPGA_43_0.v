// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:07 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | (x053 & (new_n175_ | ~new_n182_)));
  ...
  assign new_n182_ = new_n187_ & (~x085 | (~new_n183_ & (new_n186_ | (x109 & x117))));
  assign new_n183_ = x077 & (new_n184_ | (new_n185_ & ~x029));
  ...
  assign new_n187_ = x013 ? (x021 | x069) : x077;
  assign new_n188_ = x077 & (new_n189_ | (~new_n190_ & ~x037) | (~x021 & x037 & ~x069));
  assign new_n189_ = x013 & ((~x029 & ~x037 & x085) | (~x005 & ~x085));
  assign new_n190_ = x053 & (~x085 | ((~x021 | x029) & x061 & x093));
  ...
  assign z13 = ~x045 & (new_n239_ | ~new_n240_);
  assign new_n239_ = x005 & x085 & ((~x013 & x053) | (~x037 & x077));
  assign new_n240_ = (~x037 | ~x053) & (~x013 | ~x077) & (~x021 | ~x069 | (x053 ^ ~x077));
  assign z14 = ~x046 & ~z15 & (new_n242_ | ~new_n256_ | (~new_n251_ & ~x086));
