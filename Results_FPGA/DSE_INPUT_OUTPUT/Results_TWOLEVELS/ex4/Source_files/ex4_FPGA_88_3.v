...
module FAU ( 
  ...
  assign z10 = ~x042 & ((~new_n230_ & (~x018 | ~x077)) | (x018 & x066 & ~new_n231_ & ~x077));
  assign new_n230_ = (~x002 | ~x082 | ((x010 | x034) & (x050 | x074))) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n231_ = (x010 | x050) & (x034 | x074);
