...
module FAU ( 
  ...
  assign z13 = ~x045 & (new_n240_ | ~new_n241_);
  assign new_n240_ = x005 & x085 & ((~x013 & x053) | (~x037 & x077));
  assign new_n241_ = (~x037 | ~x053) & (~x013 | ~x077) & (~x021 | ~x069 | (x053 ^ ~x077));
  assign z14 = z07 | (~x046 & (new_n243_ | ~new_n257_ | (~new_n252_ & ~x086)));
  assign new_n243_ = x006 & (new_n251_ | (~x054 & (new_n244_ | new_n250_)));
  ...
  assign new_n251_ = ~x014 & ~x038 & x086;
  assign new_n252_ = ~new_n256_ & (x054 | (~new_n254_ & (new_n253_ | (~x110 & ~x118))));
  assign new_n253_ = ~x014 & (x078 | (~x022 & (new_n206_ | ~x030)));
  assign new_n254_ = ~x078 & ((new_n255_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
  assign new_n255_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n256_ = x038 & ~x078 & (~new_n204_ | (x030 & (~x014 | ~x022)));
