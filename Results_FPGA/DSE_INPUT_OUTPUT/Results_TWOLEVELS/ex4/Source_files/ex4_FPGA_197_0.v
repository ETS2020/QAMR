// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:42 2020
...
module FAU ( 
  ...
  assign z05 = new_n192_ | (x045 & (new_n175_ | ~new_n193_ | (~new_n184_ & x085)));
  assign new_n175_ = ~x005 & (new_n183_ | (x053 & (~new_n181_ | (~new_n176_ & x077))));
  assign new_n176_ = ~new_n177_ & ~new_n178_ & ~new_n179_ & new_n180_;
  assign new_n177_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n178_ = x037 & (~x117 | (x061 & ~x101));
  assign new_n179_ = x069 & (~x117 | (x093 & (~x101 | ~x125)));
  assign new_n180_ = x085 & (~x021 | ~x109 | x125);
  assign new_n181_ = (~x037 | (x109 & (x013 | ~x061 | x125))) & (new_n182_ | x109);
  assign new_n182_ = ~x069 & (~x117 | x125);
  assign new_n183_ = x013 & x037 & ~x085;
  assign new_n184_ = ~new_n189_ & (~x053 | (~new_n191_ & ~new_n185_ & (new_n187_ | ~x077)));
  assign new_n185_ = (~x109 | (x077 & ~x117)) & (~x021 | (~new_n186_ & ~x029));
  assign new_n186_ = ~x061 & ~x093;
  assign new_n187_ = (x069 | ((~x021 | x029) & x061 & x093)) & (~new_n188_ | x029);
  assign new_n188_ = (~x101 | ~x125) & (x013 | x021) & (x061 | x093);
  assign new_n189_ = new_n190_ & ~x037;
  assign new_n190_ = x077 & (~x061 | ~x093 | (~x029 & (x013 | x021)));
  assign new_n191_ = ~x013 & (~x109 | ~x117);
  assign new_n192_ = ~x077 & (~x109 | (~x013 & x045));
  assign new_n193_ = (x021 | x069 | ((~x013 | ~x053) & (~x037 | ~x077))) & (x037 | x053);
  ...
  assign z13 = ~x045 & (new_n248_ | (~new_n242_ & x109) | (~new_n249_ & x077));
  assign new_n242_ = (~x037 | ~x053) & (x077 | (~new_n246_ & new_n243_ & ~new_n247_));
  assign new_n243_ = (x053 | (~new_n245_ & (new_n244_ | x085))) & (~x037 | new_n186_ | x085);
  assign new_n244_ = (~x029 | (x061 & x093)) & (~x069 | (~x061 & ~x093));
  assign new_n245_ = x005 & (~x037 | ~x069 | x085 | (~x117 & x125));
  assign new_n246_ = ~x013 & ((x021 & x069) | (x005 & x085));
  assign new_n247_ = x021 & ((~x037 & x069) | (~x053 & ~x085));
  assign new_n248_ = x013 & (x077 | (~x053 & ~x085 & x109));
  assign new_n249_ = (~x037 | ~x053) & (~x021 | x053 | ~x069) & (~x005 | x037 | ~x085);
  assign z14 = ~x046 & ~z07 & (new_n251_ | ~new_n265_ | (~new_n260_ & ~x086));
  assign new_n251_ = x006 & (new_n259_ | ((new_n252_ | new_n258_) & ~x054));
  ...
  assign new_n261_ = ~x014 & (x078 | (~x022 & (new_n208_ | ~x030)));
  assign new_n262_ = ~x078 & ((new_n263_ & x030) | (x070 & (~new_n206_ | (~x022 & x030))));
  assign new_n263_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n264_ = x038 & ~x078 & (~new_n206_ | (x030 & (~x014 | ~x022)));
