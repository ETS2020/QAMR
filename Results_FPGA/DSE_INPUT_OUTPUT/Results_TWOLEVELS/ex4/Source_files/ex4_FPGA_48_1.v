// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:14 2020
...
module FAU ( 
  ...
  assign z09 = ~x041 & ((x081 & (new_n228_ | ~new_n229_)) | (~new_n229_ & ~x115));
  assign new_n228_ = x001 & ((~x009 & ~x033) | (~x049 & ~x073));
  ...
  assign new_n252_ = (~x013 | ~x021) & (~x061 | ~x093) & (x101 | x125);
  ...
  assign new_n266_ = ~x014 & (x078 | (~x022 & (new_n206_ | ~x030)));
  assign new_n267_ = ~x078 & ((new_n268_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
  assign new_n268_ = (~x014 | ~x022) & (~x062 | ~x094) & (x102 | x126);
  assign new_n269_ = x038 & ~x078 & (~new_n204_ | (x030 & (~x014 | ~x022)));
