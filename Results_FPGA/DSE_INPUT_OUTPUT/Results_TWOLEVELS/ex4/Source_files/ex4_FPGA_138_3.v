...
module FAU ( 
  ...
  assign z11 = ~x043 & ((~new_n234_ & ~x003) | (~x077 & (~new_n234_ | (new_n233_ & x003))));
  assign new_n233_ = x083 & ((~x051 & ~x075) | (~x011 & ~x035));
  ...
  assign new_n255_ = (x013 | ((~x021 | ~x069) & (~x005 | ~x085))) & (~x021 | x037 | ~x069);
