...
module FAU ( 
  ...
  assign new_n186_ = ~x037 & ((~x053 & ~x090) | (x077 & (new_n187_ | new_n188_ | ~x053)));
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (~x090 & (new_n240_ | new_n255_)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (~x090 & (x053 | (new_n254_ & ~x077))));
