...
module FAU ( 
  ...
  assign z02 = x042 ? (new_n166_ | ~new_n167_) : ~x077;
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (x042 & ~x053));
  ...
  assign new_n187_ = x042 & ~x077 & (~new_n188_ | ~x013);
  ...
  assign z10 = ~x042 & (~new_n229_ | new_n231_);
  assign new_n229_ = ~new_n230_ & (~x034 | ~x050) & x077 & (~x010 | ~x074);
  assign new_n230_ = x018 & x066 & ((~x010 & ~x050) | (~x034 & ~x074));
  ...
  assign new_n249_ = ~x013 & (x077 | (~x021 & (new_n177_ | ~x029)));
  ...
  assign new_n256_ = x006 & (new_n264_ | ((new_n257_ | new_n263_) & ~x054));
