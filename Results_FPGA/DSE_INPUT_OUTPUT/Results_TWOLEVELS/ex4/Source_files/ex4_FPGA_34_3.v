// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:57 2020
...
module FAU ( 
  ...
  assign z06 = z07 | (x046 & (~new_n201_ | (~new_n193_ & ~x006)));
  ...
  assign new_n201_ = new_n208_ & (~x078 | (~new_n204_ & (new_n202_ | x070)));
  assign new_n202_ = (~x038 | (x022 & (x030 | ~x054 | ~x086))) & (~x054 | new_n203_ | ~x086);
  assign new_n203_ = x062 & x094;
  assign new_n204_ = x086 & (new_n207_ | (x054 & (new_n205_ | (new_n206_ & ~x030))));
  assign new_n205_ = (~x110 | ~x118) & (~x022 | (~x030 & (x062 | x094)));
  assign new_n206_ = (~x102 | ~x126) & (x062 | x094) & (x014 | x022);
  assign new_n207_ = ~x038 & (~x062 | ~x094 | (~x030 & (x014 | x022)));
  assign new_n208_ = (new_n209_ | x014) & (x038 | x054) & (~x014 | x022 | ~x054 | x070);
  assign new_n209_ = x078 & (~x054 | ~x086 | (x110 & x118));
  ...
  assign z13 = ~x045 & ~z07 & (new_n240_ | ~new_n254_ | (~new_n249_ & ~x085));
  assign new_n240_ = x005 & (new_n248_ | (~x053 & (new_n241_ | new_n247_)));
  ...
  assign new_n247_ = ~x061 & x125 & x013 & ~x037;
  assign new_n248_ = ~x013 & ~x037 & x085;
  assign new_n249_ = ~new_n253_ & (x053 | (~new_n251_ & (new_n250_ | (~x109 & ~x117))));
  assign new_n250_ = ~x013 & (x077 | (~x021 & (new_n188_ | ~x029)));
  assign new_n251_ = ~x077 & ((new_n252_ & x029) | (x069 & (~new_n186_ | (~x021 & x029))));
  assign new_n252_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n253_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
  assign new_n254_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & ((~new_n256_ & ~z07) | new_n275_ | (~new_n264_ & ~x078));
  assign new_n256_ = new_n259_ & (x054 | (~new_n257_ & ~new_n262_ & (~new_n263_ | ~x006)));
  assign new_n257_ = ~x086 & (new_n258_ | (x070 & ~x078 & (x062 | x094)));
  assign new_n258_ = (x110 | x118) & (x014 | (x022 & ~x078));
  assign new_n259_ = (new_n260_ | x038) & (~x014 | ~x078) & (~x038 | (~x054 & (~new_n261_ | x078)));
  assign new_n260_ = (~x022 | ~x070 | x078) & (~x006 | x014 | ~x086);
  assign new_n261_ = ~x086 & (x062 | x094);
  assign new_n262_ = ~x014 & ((x022 & x070) | (x006 & ~x078 & x094));
  assign new_n263_ = ~x078 & (x086 | (~x022 & (x062 | (~x118 & x126))));
  assign new_n264_ = (~x006 | (~new_n265_ & ~new_n274_)) & (~x030 | new_n270_ | x086);
  assign new_n265_ = ~x054 & (x102 ? new_n269_ : (new_n266_ | new_n267_ | ~new_n268_));
  assign new_n266_ = ~x014 & (x030 | x062);
  assign new_n267_ = ~x022 & (x030 | x094);
  assign new_n268_ = ((x038 & x070) | (~x110 & ~x118)) & (~x126 | ((x110 | ~x118) & (x070 | x094)));
  assign new_n269_ = ~x121 & ((~x070 & ~x094) | (~x038 & ~x062));
  assign new_n270_ = (new_n271_ | ((~x038 | x102) & (~new_n272_ | x054))) & (x054 | new_n273_ | x102);
  assign new_n271_ = x014 & x022;
  assign new_n272_ = (~x062 | ~x094) & (x102 ? ~x121 : x126);
  assign new_n273_ = ((x062 & x094) | (~x110 & ~x118)) & (x022 | ~x070);
  assign new_n274_ = ~x110 & ~x121 & x126 & ~x014 & x038;
  assign new_n275_ = new_n276_ & x006 & x014 & ~x038;
  assign new_n276_ = ~x054 & ~x062 & ~x102 & x126;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
  assign z21 = 1'b0;
