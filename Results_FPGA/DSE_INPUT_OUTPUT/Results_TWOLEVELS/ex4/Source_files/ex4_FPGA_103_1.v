...
module FAU ( 
  ...
  assign new_n186_ = ~x037 & ((~x053 & ~x124) | (x077 & (new_n187_ | new_n188_ | ~x053)));
  assign new_n187_ = x013 & ((~x029 & x085) | (~x005 & x109 & ~x125));
  assign new_n188_ = x085 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n189_ = ~x124 & (~new_n190_ | ~x013);
  ...
  assign new_n213_ = (x024 | x056 | x088) & (~x008 | ~x016);
  ...
  assign new_n242_ = (x029 | x061 | x093) & (~x013 | ~x021);
  ...
  assign new_n260_ = (x030 | x062 | x094) & (~x014 | ~x022);
