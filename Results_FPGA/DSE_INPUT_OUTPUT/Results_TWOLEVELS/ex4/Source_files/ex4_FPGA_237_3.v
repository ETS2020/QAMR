...
module FAU ( 
  ...
  assign new_n196_ = x094 & ((x038 & ~x102) | (x070 & ~x126));
  assign new_n197_ = (x038 | x070) & (~x110 | ~x118);
  assign new_n198_ = ~x126 & (x118 ? x022 : x110);
  assign new_n199_ = x086 & (~x062 | ~x070 | x102);
  ...
  assign new_n256_ = x006 & (new_n264_ | (~x078 & (new_n257_ | new_n263_)));
  assign new_n257_ = ~x054 & (new_n258_ | new_n259_ | new_n260_ | new_n261_ | ~new_n262_);
  assign new_n258_ = (~x014 | ~x022) & (x030 | x062 | x094);
  assign new_n259_ = ~x062 & ((~x070 & x102) | (x094 & x126));
  assign new_n260_ = ~x094 & ((~x038 & x102) | (~x070 & x126));
  assign new_n261_ = (x110 | x118) & (~x038 | ~x070);
  assign new_n262_ = ~x086 & (x022 | x118 | ~x126);
  assign new_n263_ = ~x014 & x038 & ~x110 & x126;
