...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x030 | (~x013 & x045));
  assign z06 = z16 | (x046 & (new_n193_ | ~new_n208_ | (~new_n202_ & x086)));
  ...
  assign z13 = z16 | (~x045 & (new_n239_ | ~new_n254_ | (~new_n248_ & ~x085)));
  ...
  assign new_n248_ = ~new_n252_ & (x053 | (~new_n249_ & (new_n253_ | (~x109 & ~x117))));
  ...
  assign new_n256_ = ~z16 & ((~new_n264_ & ~x014) | new_n257_ | ~new_n259_);
  assign new_n257_ = ~x038 & (new_n258_ | (x022 & x070 & ~x078));
  assign new_n258_ = ~x054 & ~x062 & x126 & x006 & x014;
