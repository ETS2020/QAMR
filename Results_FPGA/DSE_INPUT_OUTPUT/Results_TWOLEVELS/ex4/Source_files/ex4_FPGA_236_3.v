...
module FAU ( 
  ...
  assign new_n216_ = ~new_n217_ & (x072 | (~new_n226_ & (x112 | (~new_n221_ & new_n224_))));
  ...
  assign new_n221_ = (x096 | x120) & (new_n222_ | new_n223_);
  assign new_n222_ = x000 & ((~x032 & ~x056) | (~x064 & ~x088));
  assign new_n223_ = x024 & ~x080 & (~x008 | ~x016) & (~x056 | ~x088);
  assign new_n224_ = (new_n225_ | ~x000) & (x016 | ~x024 | ~x064 | x080);
  assign new_n225_ = (x016 | ~x120) & ((x008 & x016) | (~x024 & ~x056 & ~x088));
  assign new_n226_ = x000 & ~x096 & ~x104 & x112 & x120;
  assign new_n227_ = x032 & ~x072 & ~x080 & ~x112 & (~x008 | ~x016);
