// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:19 2020
...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x081 | (~x013 & x045));
  ...
  assign z09 = ~x041 & ((x077 & (~new_n229_ | (x001 & ~new_n228_ & x081))) | (~new_n229_ & ~x081));
  assign new_n228_ = (x049 | x073) & (x009 | x033);
  ...
  assign z13 = z15 | (~x045 & (new_n240_ | ~new_n255_ | (~new_n249_ & ~x085)));
  ...
  assign new_n249_ = ~new_n253_ & (x053 | (~new_n250_ & (new_n254_ | (~x109 & ~x117))));
  ...
  assign new_n269_ = (~x014 | ~x022) & (~x062 | ~x094) & (x102 | x126);
