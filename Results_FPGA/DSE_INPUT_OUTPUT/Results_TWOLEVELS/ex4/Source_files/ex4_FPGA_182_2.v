...
module FAU ( 
  ...
  assign z14 = z07 | (~x046 & (new_n258_ | ~new_n273_ | (~new_n267_ & ~x086)));
  ...
  assign new_n267_ = ~new_n272_ & (x054 | (~new_n269_ & (new_n268_ | (~x110 & ~x118))));
  assign new_n268_ = ~x014 & (x078 | (~x022 & (new_n197_ | ~x030)));
  assign new_n269_ = ~x078 & ((new_n271_ & x030) | (x070 & (~new_n270_ | (~x022 & x030))));
  assign new_n270_ = ~x062 & ~x094;
  assign new_n271_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n272_ = x038 & ~x078 & (~new_n270_ | (x030 & (~x014 | ~x022)));
