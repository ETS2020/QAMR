// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:27 2020
...
module FAU ( 
  ...
  assign z08 = new_n227_ | (~x040 & (~new_n219_ | (~new_n211_ & x000)));
  ...
  assign new_n219_ = ~new_n226_ & (~x032 | ~x048) & (x080 | ((new_n220_ | x048) & (~new_n225_ | ~x032)));
  ...
  assign new_n226_ = x016 & x064 & ((~x008 & ~x048) | (~x032 & ~x072));
  assign new_n227_ = x072 & (~x031 | (x008 & ~x040));
  assign z09 = ~x041 & ~z07 & (new_n229_ | ~new_n230_);
  ...
  assign z13 = ~x045 & ~z07 & (new_n241_ | ~new_n255_ | (~new_n250_ & ~x085));
