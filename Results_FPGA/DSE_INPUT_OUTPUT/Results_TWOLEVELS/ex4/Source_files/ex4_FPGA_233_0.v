// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:24 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (x015 & ~x053));
  ...
  assign new_n187_ = x015 & ~x077 & (~new_n188_ | ~x013);
  ...
  assign z13 = ~x045 & (new_n251_ | new_n255_ | (x015 & (new_n238_ | new_n253_)));
  ...
  assign new_n251_ = x037 & ((x053 & x077) | (x015 & (x053 | (new_n252_ & ~x077))));
  ...
  assign z14 = ~x046 & ~z17 & (new_n258_ | ~new_n272_ | (~new_n267_ & ~x086));
