// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:28 2020
...
module FAU ( 
  ...
  assign z08 = ~x040 & ((~z15 & (~new_n211_ | new_n222_)) | (~new_n215_ & ~x048));
  assign new_n211_ = (new_n212_ | ~x064) & ~new_n214_ & (~x008 | ~x072);
  assign new_n212_ = (~x016 | ((x008 | x048) & (x032 | x072))) & (x048 | ~new_n213_ | x072);
  assign new_n213_ = ~x080 & (x056 | x088);
  assign new_n214_ = x032 & (x048 | (new_n213_ & ~x072));
  assign new_n215_ = ~new_n216_ & (x080 | (~new_n220_ & (~x024 | ~new_n221_ | x072)));
  assign new_n216_ = x000 & ~x072 & (new_n219_ | ((new_n217_ | ~new_n218_) & x096));
  assign new_n217_ = ~x016 & (~x032 | (~x112 & x120));
  assign new_n218_ = x088 ? (x008 & x056) : x064;
  assign new_n219_ = x112 & (~x032 | ~x064 | (~x104 & x120));
  assign new_n220_ = (x112 | (x096 & x104)) & (x008 | (x016 & ~x072));
  assign new_n221_ = (~x056 | ~x088) & (x112 | (x096 & (~x008 | ~x016)));
  assign new_n222_ = x000 & x080 & ((~x008 & ~x032) | (~x048 & ~x072));
  ...
  assign z13 = z15 | (~x045 & (new_n236_ | ~new_n250_ | (~new_n245_ & ~x085)));
  assign new_n236_ = x005 & (new_n244_ | (~x053 & (new_n237_ | new_n243_)));
  ...
  assign new_n243_ = ~x061 & x125 & x013 & ~x037;
  assign new_n244_ = ~x013 & ~x037 & x085;
  assign new_n245_ = ~new_n249_ & (x053 | (~new_n247_ & (new_n246_ | (~x109 & ~x117))));
  assign new_n246_ = ~x013 & (x077 | (~x021 & (new_n188_ | ~x029)));
  assign new_n247_ = ~x077 & ((x069 & (~new_n186_ | (~x021 & x029))) | (new_n248_ & x029));
  assign new_n248_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n249_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n263_ = ~x078 & ((x070 & (~new_n204_ | (~x022 & x030))) | (new_n264_ & x030));
