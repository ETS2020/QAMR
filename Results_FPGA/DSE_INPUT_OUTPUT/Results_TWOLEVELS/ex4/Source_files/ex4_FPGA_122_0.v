...
module FAU ( 
  ...
  assign z02 = x042 & ((~new_n166_ & (x066 | x077)) | (~x018 & ~x066 & ~new_n167_ & x077));
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & x066));
  ...
  assign z10 = ~x042 & ((~new_n229_ & (x066 | x077)) | (x018 & ~new_n230_ & x066));
  ...
  assign new_n254_ = ~x061 & x125 & x005 & ~x037;
  ...
  assign new_n265_ = ~x062 & x126 & x014 & ~x038;
