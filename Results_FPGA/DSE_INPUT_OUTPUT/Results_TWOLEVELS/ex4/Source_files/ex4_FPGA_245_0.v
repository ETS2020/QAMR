// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:38 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & x063));
  ...
  assign z08 = z17 | (~x040 & (~new_n217_ | (~new_n209_ & x000)));
  ...
  assign new_n245_ = ~x061 & x125 & x013 & ~x037;
  assign new_n246_ = ~x013 & ~x037 & x085;
  assign new_n247_ = ~new_n252_ & (x053 | (~new_n249_ & (new_n248_ | (~x109 & ~x117))));
  assign new_n248_ = ~x013 & (x077 | (~x021 & (new_n177_ | ~x029)));
  assign new_n249_ = ~x077 & ((new_n251_ & x029) | (x069 & (~new_n250_ | (~x021 & x029))));
  assign new_n250_ = ~x061 & ~x093;
  assign new_n251_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n252_ = x037 & ~x077 & (~new_n250_ | (x029 & (~x013 | ~x021)));
  assign new_n253_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = z17 | (~x046 & (new_n255_ | ~new_n269_ | (~new_n264_ & ~x086)));
  assign new_n255_ = x006 & (new_n263_ | ((new_n256_ | new_n262_) & ~x054));
  assign new_n256_ = ~x078 & (new_n257_ | new_n258_ | new_n259_ | new_n260_ | ~new_n261_);
  assign new_n257_ = (~x014 | ~x022) & (x030 | x062 | x094);
  assign new_n258_ = ~x070 & (x110 | x118 | (~x094 & (x102 | x126)));
  assign new_n259_ = x118 & (~x038 | (~x110 & x126));
  assign new_n260_ = ~x038 & (x110 | (~x062 & x102));
  assign new_n261_ = ~x086 & (x022 | x118 | ~x126);
  assign new_n262_ = ~x062 & x126 & x014 & ~x038;
  assign new_n263_ = ~x014 & ~x038 & x086;
  assign new_n264_ = ~new_n268_ & (x054 | (~new_n266_ & (new_n265_ | (~x110 & ~x118))));
  assign new_n265_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n266_ = ~x078 & ((new_n267_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n267_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n268_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
  assign new_n269_ = (~x022 | ~x070 | ((x014 | x054) & (x038 | x078))) & (~x038 | ~x054) & (~x014 | ~x078);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
