...
module FAU ( 
  ...
  assign z03 = x043 ? (new_n169_ | ~new_n170_) : ~x077;
  ...
  assign new_n191_ = ~x077 & (~x043 | (~x013 & x045));
  ...
  assign z11 = ~x043 & x077 & (new_n234_ | ~new_n235_);
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (x043 & (new_n240_ | new_n255_)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (x043 & (x053 | (new_n254_ & ~x077))));
  ...
  assign z14 = ~x046 & ~z18 & (new_n260_ | ~new_n274_ | (~new_n269_ & ~x086));
