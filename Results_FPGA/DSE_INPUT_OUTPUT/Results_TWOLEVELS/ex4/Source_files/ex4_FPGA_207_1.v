...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & ~x090));
  ...
  assign new_n187_ = ~x090 & (~new_n188_ | ~x013);
  ...
  assign z13 = z16 | (~x045 & (new_n238_ | ~new_n253_ | (~new_n247_ & ~x085)));
  ...
  assign z14 = z16 | (~x046 & (new_n255_ | ~new_n269_ | (~new_n264_ & ~x086)));
