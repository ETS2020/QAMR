// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:11 2020
...
module FAU ( 
  ...
  assign new_n247_ = (x085 | ((~new_n253_ | ~x037) & (new_n248_ | x053))) & ~new_n254_ & (~x037 | ~x053);
  ...
  assign new_n255_ = x077 & (x066 | (x013 & ~x045));
