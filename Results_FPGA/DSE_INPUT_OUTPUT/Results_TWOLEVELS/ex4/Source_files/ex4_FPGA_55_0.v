// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:22 2020
...
module FAU ( 
  ...
  assign z05 = (~x077 & (~x021 | (~x013 & x045))) | ((new_n175_ | ~new_n189_) & x045);
  assign new_n175_ = x053 & (new_n176_ | (new_n186_ & x077) | (~new_n180_ & ~x005));
  ...
  assign new_n180_ = ~new_n185_ & (~x077 | (~new_n181_ & ~new_n182_ & ~new_n183_ & new_n184_));
  assign new_n181_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n182_ = x069 & x093 & (~x101 | ~x125);
  assign new_n183_ = ~x125 & (x117 ? x021 : x109);
  assign new_n184_ = x085 & (~x037 | ~x061 | x101);
  assign new_n185_ = ~x021 & x037 & x061 & ~x125;
  assign new_n186_ = x085 & ((new_n188_ & ~x029) | (~x069 & (~new_n187_ | (x021 & ~x029))));
  assign new_n187_ = x061 & x093;
  assign new_n188_ = (~x101 | ~x125) & (x061 | x093) & (x013 | x021);
  assign new_n189_ = (x021 | x069 | (~x013 & ~x037)) & (new_n191_ | ~x013) & (new_n190_ | x037);
  assign new_n190_ = x053 & (~x077 | ~x085 | (new_n187_ & (~x021 | x029)));
  assign new_n191_ = (~x077 | ~x085 | x029 | x037) & (x005 | ~x037 | x085);
  ...
  assign z13 = ~x045 & (new_n248_ | new_n250_ | (~new_n240_ & x021));
  assign new_n240_ = ~new_n246_ & (x077 | (~new_n247_ & ((~new_n241_ & new_n244_) | x053)));
  assign new_n241_ = (x101 | x125) & (new_n242_ | new_n243_);
  assign new_n242_ = x005 & ((~x037 & ~x061) | (~x069 & ~x093));
  assign new_n243_ = ~x013 & x029 & ~x085 & (~x061 | ~x093);
  assign new_n244_ = (x085 | (~x109 & ~x117)) & (~x005 | (~new_n245_ & ~x085));
  assign new_n245_ = ~x013 & (x029 | x061 | x093);
  assign new_n246_ = x069 & ((~x013 & ~x053) | (~x037 & ~x077));
  assign new_n247_ = x005 & ~x013 & x085;
  assign new_n248_ = x037 & ((x053 & (x021 | x077)) | (x021 & new_n249_ & ~x077));
  assign new_n249_ = ~x085 & ((~x013 & x029) | x061 | x093);
  assign new_n250_ = x077 & (x013 | (x005 & ~x037 & x085));
  ...
  assign new_n262_ = ~x014 & (x078 | (~x022 & (new_n206_ | ~x030)));
  assign new_n263_ = ~x078 & ((new_n264_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
  assign new_n264_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n265_ = x038 & ~x078 & (~new_n204_ | (x030 & (~x014 | ~x022)));
