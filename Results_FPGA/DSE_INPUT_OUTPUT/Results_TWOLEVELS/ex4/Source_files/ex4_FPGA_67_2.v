// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:36 2020
...
module FAU ( 
  ...
  assign z05 = z07 | (x045 & (new_n186_ | new_n175_ | new_n180_ | ~new_n187_));
  ...
  assign new_n179_ = (x109 | (~x037 & ~x069)) & x085 & (~x021 | x125);
  assign new_n180_ = x077 & (new_n185_ | (x085 & (new_n181_ | (~new_n183_ & ~x029))));
  assign new_n181_ = (~x037 | (x053 & ~x069)) & (~new_n182_ | (x021 & ~x029));
  assign new_n182_ = x061 & x093;
  assign new_n183_ = (~x013 | x037) & (~x053 | new_n184_ | (~x061 & ~x093));
  assign new_n184_ = x109 & ((~x013 & ~x021) | (x101 & x125));
  assign new_n185_ = ~x021 & ((x053 & x085 & ~x109) | (x037 & ~x069));
  assign new_n186_ = ~x013 & (~x077 | (x053 & x085 & ~x109));
  assign new_n187_ = (x037 | x053) & (~x013 | x021 | ~x053 | x069);
  ...
  assign new_n220_ = (~x008 | ~x016) & (~x056 | ~x088) & (x096 | x120);
  ...
  assign z13 = new_n252_ | (~x045 & (~new_n248_ | ((new_n236_ | ~new_n241_) & ~x053)));
  assign new_n236_ = ~x085 & (new_n237_ | ~new_n238_ | (x013 & (x109 | x117)));
  assign new_n237_ = (x117 ? ~x077 : x109) & (x021 | (~new_n182_ & x029));
  assign new_n238_ = (new_n239_ | ~x069) & (~x029 | ~new_n240_ | x117);
  assign new_n239_ = (x077 | (~x061 & ~x093)) & (x021 | ~x029 | x117);
  assign new_n240_ = (~x013 | ~x021) & (~x061 | ~x093) & (x101 | x125);
  assign new_n241_ = ~new_n247_ & (~x005 | ((new_n242_ | x117) & (new_n245_ | x077)));
  assign new_n242_ = ~new_n243_ & new_n244_ & (x037 | (~x109 & (x061 | ~x101)));
  assign new_n243_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n244_ = (x069 | (~x109 & (x093 | ~x101))) & (x061 | ~x093 | ~x125);
  assign new_n245_ = (x069 | (~x117 & (x093 | ~x125))) & new_n246_ & (x037 | ~x117);
  assign new_n246_ = ~x085 & (x021 | x109 | ~x125);
  assign new_n247_ = ~x013 & x021 & x069;
  assign new_n248_ = (new_n250_ | x013) & (~new_n251_ | ~x021 | x037) & (new_n249_ | ~x037);
  assign new_n249_ = ~x053 & (new_n239_ | x085);
  assign new_n250_ = (~x005 | (x037 ? (x117 | ~x125) : ~x085)) & (~x029 | ~x037 | x085 | x117);
  assign new_n251_ = x069 & ~x077;
  assign new_n252_ = x077 & (~x117 | (x013 & ~x045));
