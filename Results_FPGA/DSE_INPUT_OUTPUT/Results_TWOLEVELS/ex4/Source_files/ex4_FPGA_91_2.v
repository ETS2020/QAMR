// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:05 2020
...
module FAU ( 
  ...
  assign z18 = x063 & ~x077;
  assign z01 = z18 | (x041 & (new_n163_ | ~new_n164_));
  ...
  assign new_n191_ = ~x077 & (x063 | (~x013 & x045));
  assign z06 = z18 | (x046 & (new_n193_ | ~new_n209_ | (~new_n202_ & x086)));
  ...
  assign z08 = z18 | (~x040 & (~new_n219_ | (~new_n211_ & x000)));
  ...
  assign z14 = ~x046 & ~z18 & (new_n257_ | ~new_n271_ | (~new_n266_ & ~x086));
