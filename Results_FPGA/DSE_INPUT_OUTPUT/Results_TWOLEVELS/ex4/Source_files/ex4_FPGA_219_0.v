...
module FAU ( 
  ...
  assign z13 = z07 | (~x045 & (~new_n248_ | (~new_n239_ & ~x077)));
  assign new_n239_ = (new_n247_ | x037) & ((~new_n240_ & ~new_n243_) | x053) & (new_n245_ | ~x037);
  assign new_n240_ = ~x085 & (new_n241_ | ~new_n242_);
  assign new_n241_ = x029 & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n242_ = (~x021 | (~x109 & ~x117)) & (~x069 | (~x061 & ~x093));
  assign new_n243_ = x005 & (~new_n244_ | (x093 & (~x013 | ~x061)));
  assign new_n244_ = ~x085 & (x069 | x093) & (x021 | x117 | ~x125);
  assign new_n245_ = ~new_n246_ & (x085 | (~x061 & ~x093));
  assign new_n246_ = ~x109 & x125 & x005 & ~x013;
  assign new_n247_ = (~x021 | ~x069) & (~x005 | x021 | x053);
  assign new_n248_ = (new_n249_ | x013) & (~x037 | ~x053) & (~x013 | (~x077 & (~new_n250_ | x053)));
  assign new_n249_ = (~x021 | x053 | ~x069) & (~x005 | x037 | ~x085);
  assign new_n250_ = ~x085 & (x109 | x117);
