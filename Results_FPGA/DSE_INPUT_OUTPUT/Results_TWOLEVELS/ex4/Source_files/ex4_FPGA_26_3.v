// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:48 2020
...
module FAU ( 
  ...
  assign z10 = ~x042 & ~z17 & (new_n230_ | ~new_n231_);
  ...
  assign z12 = z17 | (~x044 & (new_n236_ | ~new_n237_));
  ...
  assign new_n255_ = x077 & (x127 | (x013 & ~x045));
