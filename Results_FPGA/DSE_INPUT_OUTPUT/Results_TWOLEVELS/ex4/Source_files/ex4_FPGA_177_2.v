// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:05 2020
...
module FAU ( 
  ...
  assign new_n251_ = x037 & ((~x077 & (new_n252_ | x053)) | (x053 & x105));
  assign new_n252_ = ~x085 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n253_ = x105 & (~new_n254_ | x013);
