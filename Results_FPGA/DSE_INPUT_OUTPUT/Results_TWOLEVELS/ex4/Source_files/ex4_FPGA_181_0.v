...
module FAU ( 
  ...
  assign z13 = ~x045 & (new_n239_ | ~new_n243_ | (~new_n247_ & x069));
  assign new_n239_ = x005 & ((new_n240_ & x013) | (~new_n242_ & ~x037));
  assign new_n240_ = ~x053 & (~new_n241_ | (~x069 & ~x093 & (x101 | x125)));
  assign new_n241_ = (~x093 | (x021 & (x061 | ~x125))) & ~x085 & (x021 | (~x029 & ~x061 & ~x125));
  assign new_n242_ = (~x077 | ~x085) & (~x013 | x053 | x061 | ~x101);
  assign new_n243_ = (~x037 | ((~new_n246_ | ~x013) & (~x053 | (~x013 & ~x077)))) & (~x013 | (~x077 & (~new_n244_ | x053)));
  assign new_n244_ = ~x085 & (new_n245_ | x109 | x117);
  assign new_n245_ = ~x021 & x029 & (x101 | x125) & (~x061 | ~x093);
  assign new_n246_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n247_ = (~x021 | ((~x013 | x037) & (x053 | ~x077))) & (~x013 | ~new_n248_ | x053);
  assign new_n248_ = ~x085 & ((x029 & ~x037) | x061 | x093);
  ...
  assign new_n260_ = ~x014 & (x078 | (~x022 & (new_n205_ | ~x030)));
  assign new_n261_ = ~x078 & ((new_n262_ & x030) | (x070 & (~new_n203_ | (~x022 & x030))));
