...
module FAU ( 
  ...
  assign new_n222_ = (~x000 | ((new_n224_ | x016) & (new_n223_ | x064))) & (x016 | ~new_n225_ | ~x064);
  ...
  assign new_n255_ = x029 & ~x085 & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n256_ = x005 & (~new_n257_ | (~x021 & (x029 | (~x117 & x125))));
  assign new_n257_ = (x013 | ~x029) & ~x085 & (x061 | ~x093 | ~x125);
  assign new_n258_ = x037 & ((~x077 & (new_n259_ | new_n260_ | x053)) | (~x016 & x053));
