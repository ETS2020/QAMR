...
module FAU ( 
  ...
  assign z08 = ~x040 & (new_n213_ | (new_n228_ & x032) | (~new_n218_ & ~x048));
  assign new_n213_ = ~z15 & (new_n217_ | ~new_n216_ | (~new_n214_ & x064));
  assign new_n214_ = (~x016 | ((x008 | x048) & (x032 | x072))) & (~new_n215_ | x048);
  ...
  assign new_n218_ = (new_n219_ | (x104 ? x077 : ~x112)) & (x072 | new_n222_ | x104);
  ...
  assign new_n230_ = x000 & ~x077 & ~x112 & x120;
  assign z09 = ~x041 & ~z15 & (new_n232_ | ~new_n233_);
  ...
  assign new_n260_ = x077 & (x104 | (x013 & ~x045));
