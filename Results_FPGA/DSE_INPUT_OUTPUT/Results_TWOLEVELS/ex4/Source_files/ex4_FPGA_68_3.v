// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:38 2020
...
module FAU ( 
  ...
  assign z08 = ~x040 & ~z17 & (~new_n204_ | (~new_n196_ & x000));
  ...
  assign z10 = z17 | (~x042 & (new_n216_ | ~new_n217_));
  ...
  assign z14 = z17 | (~x046 & (new_n242_ | ~new_n256_ | (~new_n251_ & ~x086)));
