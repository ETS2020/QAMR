...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (~x068 | (~x013 & x045));
  ...
  assign z09 = z18 | (~x041 & (new_n228_ | ~new_n229_));
  ...
  assign z12 = ~x044 & ((~new_n237_ & (x068 | x077)) | (x020 & ~new_n238_ & x068));
  assign new_n237_ = (~x004 | ~x084 | ((x052 | x076) & (x012 | x036))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign new_n238_ = (x012 | x052) & (x036 | x076);
