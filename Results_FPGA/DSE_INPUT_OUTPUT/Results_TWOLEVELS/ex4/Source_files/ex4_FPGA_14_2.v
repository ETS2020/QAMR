// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:33 2020
...
module FAU ( 
  ...
  assign z00 = x040 & ~z21 & (new_n160_ | ~new_n161_);
  assign z21 = x045 & ~x077;
  assign new_n160_ = ~x000 & ~x080 & ((x008 & x032) | (x048 & x072));
  assign new_n161_ = (x016 | x064 | ((~x008 | ~x048) & (~x032 | ~x072))) & (x032 | x048) & (x008 | x072);
  assign z01 = z21 | (x041 & (new_n163_ | ~new_n164_));
  assign new_n163_ = ~x001 & ~x081 & ((x009 & x033) | (x049 & x073));
  assign new_n164_ = (x017 | x065 | ((~x009 | ~x049) & (~x033 | ~x073))) & (x033 | x049) & (x009 | x073);
  assign z02 = z21 | (x042 & (new_n166_ | ~new_n167_));
  assign new_n166_ = ~x002 & ~x082 & ((x010 & x034) | (x050 & x074));
  assign new_n167_ = (x018 | x066 | ((~x010 | ~x050) & (~x034 | ~x074))) & (x034 | x050) & (x010 | x074);
  assign z03 = x043 & ~z21 & (new_n169_ | ~new_n170_);
  assign new_n169_ = ~x003 & ~x083 & ((x011 & x035) | (x051 & x075));
  assign new_n170_ = (x019 | x067 | ((~x011 | ~x051) & (~x035 | ~x075))) & (x035 | x051) & (x011 | x075);
  assign z04 = x044 & ~z21 & (new_n172_ | ~new_n173_);
  assign new_n172_ = ~x004 & ~x084 & ((x012 & x036) | (x052 & x076));
  assign new_n173_ = (x020 | x068 | ((~x012 | ~x052) & (~x036 | ~x076))) & (x036 | x052) & (x012 | x076);
  assign z05 = x045 & x077 & (~new_n182_ | (x053 & (~new_n175_ | new_n186_)));
  assign new_n175_ = (new_n180_ | ~x037) & ~new_n176_ & ~new_n181_ & (new_n178_ | x005);
  assign new_n176_ = (~x101 | ~x125) & (new_n177_ | (~x005 & x069 & x093));
  assign new_n177_ = ~x029 & x085 & (x061 | x093) & (x013 | x021);
  assign new_n178_ = new_n179_ & ((~x013 & ~x021) | (x029 & x061 & x093));
  assign new_n179_ = x085 & (x125 | ((~x061 | x093) & (~x021 | ~x117)));
  assign new_n180_ = (x029 | x069 | ~x085) & (x005 | ~x061 | x101);
  assign new_n181_ = ~x069 & x085 & (~x061 | ~x093);
  assign new_n182_ = (new_n183_ | ~x013) & (new_n185_ | x037) & (x021 | ~x037 | x069);
  assign new_n183_ = new_n184_ & (x005 | (x085 & (x037 | ~x109 | x125)));
  assign new_n184_ = (x021 | x069) & (x029 | x037 | ~x085);
  assign new_n185_ = x053 & (~x085 | ((~x021 | x029) & x061 & x093));
  assign new_n186_ = (~x109 | ~x117) & (new_n187_ | (~x005 & (x037 | x069)));
  assign new_n187_ = x085 & ((~x029 & (x061 | x093)) | ~x013 | ~x021);
  assign z06 = z21 | (x046 & (new_n189_ | ~new_n205_ | (~new_n198_ & x086)));
  ...
  assign new_n196_ = x062 & ~x126 & ~x014 & x038;
  ...
  assign z08 = z21 | (~x040 & (~new_n215_ | (~new_n207_ & x000)));
  ...
  assign new_n242_ = ~new_n246_ & (x053 | (new_n243_ & (new_n245_ | (~x109 & ~x117))));
  assign new_n243_ = (~new_n244_ | ~x029) & (~x069 | (~x061 & ~x093 & (~x029 | x037)));
  assign new_n244_ = (x101 | x125) & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n245_ = ~x013 & ~x021 & (~x029 | (x061 & x093));
  assign new_n246_ = x037 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n247_ = ~new_n248_ & ~x045;
  assign new_n248_ = (~x037 | ~x053) & (~x013 | ~x077) & (x053 | ~x069 | x013 | ~x021);
  assign new_n249_ = ~x045 & (~x021 | x037 | ~x069);
  assign z14 = z21 | (~x046 & (new_n251_ | ~new_n265_ | (~new_n260_ & ~x086)));
  ...
  assign new_n258_ = x014 & ~x038 & ~x062 & x126;
  assign new_n259_ = ~x014 & ~x038 & x086;
  assign new_n260_ = ~new_n264_ & (x054 | (~new_n262_ & (new_n261_ | (~x110 & ~x118))));
  assign new_n261_ = ~x014 & (x078 | (~x022 & (new_n202_ | ~x030)));
  assign new_n262_ = ~x078 & ((new_n263_ & x030) | (x070 & (~new_n200_ | (~x022 & x030))));
  assign new_n263_ = (x102 | x126) & (~x062 | ~x094) & (~x014 | ~x022);
  assign new_n264_ = x038 & ~x078 & (~new_n200_ | (x030 & (~x014 | ~x022)));
