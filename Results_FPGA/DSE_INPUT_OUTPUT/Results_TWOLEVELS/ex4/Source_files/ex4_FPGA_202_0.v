// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:48 2020
...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (new_n175_ | ~new_n191_ | (~new_n184_ & x085)));
  ...
  assign z06 = (~x005 & ~x086) | (x046 & (new_n193_ | ~new_n208_ | (~new_n202_ & x086)));
  ...
  assign z13 = z16 | (~x045 & (new_n239_ | ~new_n253_ | (~new_n248_ & ~x085)));
  ...
  assign z14 = ~x046 & (new_n272_ | (~new_n255_ & x005) | (~new_n271_ & (x005 | x086)));
  assign new_n255_ = ~new_n269_ & (x054 | (~new_n256_ & ~new_n266_ & (new_n260_ | ~x006)));
  assign new_n256_ = (x110 | x118) & (new_n259_ | (~x078 & (new_n257_ | new_n258_)));
  assign new_n257_ = x006 & (~x038 | ~x070);
  assign new_n258_ = ~x086 & (x022 | (x030 & (~x062 | ~x094)));
  assign new_n259_ = x014 & ~x086;
  assign new_n260_ = ~new_n265_ & (x078 | (~new_n261_ & ~new_n262_ & ~new_n263_ & ~new_n264_));
  assign new_n261_ = (~x014 | ~x022) & (x030 | x062 | x094);
  assign new_n262_ = ~x070 & ~x094 & (x102 | x126);
  assign new_n263_ = x126 & (x118 ? ~x110 : ~x022);
  assign new_n264_ = ~x038 & ~x062 & x102;
  assign new_n265_ = ~x062 & x126 & x014 & ~x038;
  assign new_n266_ = ~x078 & ~x086 & (new_n267_ | (new_n268_ & x030));
  assign new_n267_ = x070 & ((~x022 & x030) | x062 | x094);
  assign new_n268_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n269_ = x038 & new_n270_ & ~x078;
  assign new_n270_ = ~x086 & (x062 | x094 | (x030 & (~x014 | ~x022)));
  assign new_n271_ = (~x022 | ~x070 | ((x014 | x054) & (x038 | x078))) & (~x038 | ~x054) & (~x014 | ~x078);
  assign new_n272_ = x006 & x086 & ((~x014 & ~x038) | (~x054 & ~x078));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
