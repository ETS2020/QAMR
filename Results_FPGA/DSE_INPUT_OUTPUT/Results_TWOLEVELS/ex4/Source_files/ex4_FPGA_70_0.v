// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:40 2020
...
module FAU ( 
  ...
  assign z03 = x043 & ((x077 & (~new_n170_ | (~x003 & ~new_n169_ & ~x083))) | (~new_n170_ & x083));
  ...
  assign new_n191_ = ~x077 & (~x083 | (~x013 & x045));
  ...
  assign z11 = ~x043 & ((~new_n235_ & x077) | ((new_n234_ | ~new_n235_) & x083));
  assign new_n234_ = x003 & ((~x051 & ~x075) | (~x011 & ~x035));
