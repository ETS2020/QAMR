// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:44 2020
...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (new_n175_ | ~new_n190_ | (~new_n184_ & x085)));
  ...
  assign z06 = z16 | (x046 & (new_n192_ | ~new_n208_ | (~new_n201_ & x086)));
  ...
  assign z10 = z16 | (~x042 & (new_n230_ | ~new_n231_));
  ...
  assign z13 = ~x045 & (new_n251_ | new_n253_ | (~x077 & (new_n239_ | ~new_n255_)));
  assign new_n239_ = ~x053 & (new_n240_ | new_n242_ | new_n244_ | new_n246_ | new_n248_);
  ...
  assign new_n244_ = ~new_n245_ & (x061 | x093);
  assign new_n245_ = (~x069 | x085) & (~x005 | (x013 & x021));
  assign new_n246_ = (x101 | x125) & (new_n247_ | (x005 & ~x069 & ~x093));
  assign new_n247_ = x029 & ~x085 & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n248_ = x005 & (new_n249_ | new_n250_ | x085 | (~x013 & x029));
  assign new_n249_ = ~x021 & (x029 | (~x117 & x125));
  assign new_n250_ = x125 & ((~x061 & x093) | (~x109 & x117));
  assign new_n251_ = x037 & ((~x027 & x053) | (~x077 & (new_n252_ | x053)));
  assign new_n252_ = ~x085 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n253_ = ~x027 & x077 & (~new_n254_ | x013);
  assign new_n254_ = (~x005 | x037 | ~x085) & (~x021 | x053 | ~x069);
  assign new_n255_ = (x013 | ((~x005 | ~x085) & (~x021 | ~x069))) & (~x021 | x037 | ~x069);
