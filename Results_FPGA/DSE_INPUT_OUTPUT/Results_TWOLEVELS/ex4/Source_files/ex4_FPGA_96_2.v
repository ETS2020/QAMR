// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:10 2020
...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x066 | (~x013 & x045));
  ...
  assign new_n219_ = new_n226_ & (x080 | ((~new_n225_ | ~x032) & (new_n220_ | x048)));
  ...
  assign new_n264_ = x014 & ~x038 & ~x062 & x126;
