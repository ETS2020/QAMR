// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:33 2020
...
module FAU ( 
  ...
  assign new_n183_ = (~x085 | ((~new_n189_ | x037) & (new_n184_ | ~x053))) & ~new_n190_ & (x037 | x053);
  assign new_n184_ = (new_n185_ | new_n186_) & (~x077 | (~new_n187_ & (~new_n188_ | x029)));
  assign new_n185_ = x109 & x117;
  assign new_n186_ = x013 & (~x077 | (x021 & (x029 | (~x061 & ~x093))));
  assign new_n187_ = ~x069 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n188_ = (~x101 | ~x125) & (x061 | x093) & (x013 | x021);
  assign new_n189_ = x077 & (~x061 | ~x093 | (~x029 & (x013 | x021)));
  assign new_n190_ = ~x021 & ~x069 & ((x013 & x053) | (x037 & x077));
  assign new_n191_ = ~x077 & (~x051 | (~x013 & x045));
  assign z06 = z22 | (x046 & (new_n193_ | ~new_n209_ | (~new_n202_ & x086)));
  ...
  assign z08 = z22 | (~x040 & (~new_n219_ | (~new_n211_ & x000)));
  ...
  assign new_n247_ = ~x053 & ~x085 & (new_n248_ | new_n249_ | (new_n250_ & x029));
  assign new_n248_ = (x109 | x117) & (x021 | (x029 & (~x061 | ~x093)));
  assign new_n249_ = x069 & ((~x021 & x029) | x061 | x093);
  assign new_n250_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n251_ = ~x013 & x085;
  assign new_n252_ = x021 & x069 & (~x013 | ~x037);
  assign new_n253_ = x037 & ((x053 & x077) | (x051 & (x053 | (new_n254_ & ~x077))));
  assign new_n254_ = ~x085 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n255_ = x013 & ~x053 & (new_n256_ | (~x085 & (x109 | x117)));
  assign new_n256_ = ~x061 & x125 & x005 & ~x037;
  assign new_n257_ = x077 & (~new_n258_ | x013);
  assign new_n258_ = (~x021 | x053 | ~x069) & (~x005 | x037 | ~x085);
  assign z14 = z22 | (~x046 & (new_n260_ | ~new_n274_ | (~new_n269_ & ~x086)));
  ...
  assign new_n270_ = ~x014 & (x078 | (~x022 & (new_n206_ | ~x030)));
  assign new_n271_ = ~x078 & ((new_n272_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
  assign new_n272_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n273_ = x038 & ~x078 & (~new_n204_ | (x030 & (~x014 | ~x022)));
