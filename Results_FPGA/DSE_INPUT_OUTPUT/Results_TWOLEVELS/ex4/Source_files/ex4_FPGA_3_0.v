// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:20 2020
...
module FAU ( 
  ...
  assign z13 = ~new_n239_ & ~x045;
  assign new_n239_ = ~x013 & (~x037 | ~x053) & new_n240_ & (~x021 | x053 | ~x069);
  assign new_n240_ = x077 & (~x005 | x037 | ~x085);
  assign z14 = z07 | (~x046 & (new_n242_ | ~new_n256_ | (~new_n251_ & ~x086)));
  ...
  assign new_n252_ = ~x014 & (x078 | (~x022 & (new_n205_ | ~x030)));
  assign new_n253_ = ~x078 & ((new_n254_ & x030) | (x070 & (~new_n203_ | (~x022 & x030))));
  assign new_n254_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n255_ = x038 & ~x078 & (~new_n203_ | (x030 & (~x014 | ~x022)));
