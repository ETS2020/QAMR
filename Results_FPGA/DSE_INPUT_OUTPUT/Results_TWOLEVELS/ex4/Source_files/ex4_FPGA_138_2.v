// Benchmark "FAU" written by ABC on Sat Aug 22 16:12:00 2020
...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x003 | (~x013 & x045));
  assign z06 = z21 | (x046 & (new_n193_ | ~new_n209_ | (~new_n202_ & x086)));
  ...
  assign z08 = z21 | (~x040 & (~new_n219_ | (~new_n211_ & x000)));
  ...
  assign new_n250_ = (~x013 | ~x021) & (~x061 | ~x093) & (x101 | x125);
  assign new_n251_ = ~x013 & x085;
  assign new_n252_ = x021 & x069 & (~x013 | ~x037);
  assign new_n253_ = x037 & ((x053 & x077) | (~x003 & (x053 | (new_n254_ & ~x077))));
  ...
  assign z14 = z21 | (~x046 & (new_n260_ | ~new_n274_ | (~new_n269_ & ~x086)));
