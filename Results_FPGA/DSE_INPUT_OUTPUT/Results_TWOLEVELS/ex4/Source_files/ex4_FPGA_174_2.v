...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((~x044 & ~x053) | (x077 & (new_n176_ | ~x053)));
  ...
  assign new_n187_ = ~x044 & ~x077 & (~new_n188_ | ~x013);
  ...
  assign z08 = ~x040 & ~z17 & (~new_n217_ | (~new_n209_ & x000));
  ...
  assign z10 = z17 | (~x042 & (new_n229_ | ~new_n230_));
  ...
  assign new_n251_ = x037 & ((x053 & x077) | (~x044 & (x053 | (new_n252_ & ~x077))));
