// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:45 2020
...
module FAU ( 
  ...
  assign z09 = ~x041 & ((~new_n229_ & x073) | new_n227_ | new_n230_ | ~new_n231_);
  assign new_n227_ = ~x009 & (new_n228_ | (x017 & x033 & x065));
  assign new_n228_ = x001 & x049 & ~x077 & x081;
  assign new_n229_ = (~x009 | (~x033 & x077)) & (~x017 | x049 | ~x065 | x077);
  assign new_n230_ = x001 & x081 & (x033 ? ~x073 : (~x049 & ~x077));
  assign new_n231_ = (~x033 | ~x049) & (~x017 | x033 | ~x065 | x073 | x077);
  ...
  assign new_n258_ = x077 & (~x033 | (x013 & ~x045));
  ...
  assign new_n270_ = ~x014 & (x078 | (~x022 & (new_n205_ | ~x030)));
  assign new_n271_ = ~x078 & ((new_n272_ & x030) | (x070 & (~new_n203_ | (~x022 & x030))));
  assign new_n272_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n273_ = x038 & ~x078 & (~new_n203_ | (x030 & (~x014 | ~x022)));
