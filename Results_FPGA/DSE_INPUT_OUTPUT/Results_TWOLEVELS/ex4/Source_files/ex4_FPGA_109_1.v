// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:25 2020
...
module FAU ( 
  ...
  assign z09 = ~x041 & ((~new_n227_ & (x065 | ~x077)) | (x017 & ~new_n228_ & x065));
  assign new_n227_ = (~x001 | ~x081 | ((x009 | x033) & (x049 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign new_n228_ = (x009 | x049) & (x033 | x073);
  ...
  assign new_n255_ = x077 & (~x065 | (x013 & ~x045));
