// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:17 2020
...
module FAU ( 
  ...
  wire new_n160_, new_n161_, new_n163_, new_n164_, new_n166_, new_n167_,
    ...
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_;
  ...
  assign z06 = z16 | (x046 & (new_n191_ | ~new_n207_ | (~new_n200_ & x086)));
  ...
  assign z08 = ~x040 & ~z16 & (~new_n217_ | (~new_n209_ & x000));
  ...
  assign new_n244_ = x029 & ~x085 & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n245_ = new_n246_ & (x013 | ~x029) & (x021 | (~x029 & (x117 | ~x125)));
  assign new_n246_ = ~x085 & (x061 | ~x093 | ~x125);
  assign new_n247_ = (~x029 | ~x069 | x085) & (~x005 | x061 | ~x101);
  assign new_n248_ = (new_n249_ | x013) & (new_n251_ | ~x037) & (~x021 | x037 | ~x069);
  assign new_n249_ = new_n250_ & (~x005 | (~x085 & (~x037 | x109 | ~x125)));
  assign new_n250_ = (~x021 | ~x069) & (~x029 | ~x037 | x085);
  assign new_n251_ = ~x053 & (x085 | ((x021 | ~x029) & ~x061 & ~x093));
  assign z14 = z16 | (~x046 & (new_n253_ | ~new_n267_ | (~new_n262_ & ~x086)));
  assign new_n253_ = x006 & (new_n261_ | (~x054 & (new_n254_ | new_n260_)));
  ...
  assign new_n260_ = ~x062 & x126 & x014 & ~x038;
  assign new_n261_ = ~x014 & ~x038 & x086;
  assign new_n262_ = ~new_n266_ & (x054 | (~new_n264_ & (new_n263_ | (~x110 & ~x118))));
  assign new_n263_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n264_ = ~x078 & ((new_n265_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n265_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n266_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
