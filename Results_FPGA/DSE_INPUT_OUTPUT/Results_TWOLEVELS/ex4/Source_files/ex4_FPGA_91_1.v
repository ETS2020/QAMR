// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:04 2020
...
module FAU ( 
  ...
  assign z06 = z18 | (x046 & (new_n192_ | ~new_n208_ | (~new_n201_ & x086)));
  ...
  assign z08 = z18 | (~x040 & (~new_n218_ | (~new_n210_ & x000)));
  ...
  assign z09 = ~x041 & ~z18 & (new_n227_ | ~new_n228_);
  ...
  assign z12 = ~x044 & ~z18 & (new_n236_ | ~new_n237_);
  ...
  assign new_n255_ = x077 & (~x063 | (x013 & ~x045));
