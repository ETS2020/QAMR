...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & x123));
  ...
  assign new_n187_ = x123 & (~new_n188_ | ~x013);
  ...
  assign z13 = ~x045 & (new_n251_ | new_n255_ | (x123 & (new_n238_ | new_n253_)));
  ...
  assign new_n251_ = x037 & ((x053 & x077) | (x123 & (x053 | (new_n252_ & ~x077))));
