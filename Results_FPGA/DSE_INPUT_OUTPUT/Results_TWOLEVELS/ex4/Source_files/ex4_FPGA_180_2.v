// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:22 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n175_ | new_n186_ | new_n187_ | new_n185_ | ~x077);
  ...
  assign new_n185_ = ~x037 & (~x053 | (x085 & (~new_n181_ | (x021 & ~x029))));
  assign new_n186_ = ~x021 & ~x069 & (x013 | x037);
  assign new_n187_ = x013 & ((~x029 & ~x037 & x085) | (~x005 & ~x085));
  ...
  assign z10 = z07 | (~x042 & (new_n227_ | ~new_n228_));
  ...
  assign z12 = z07 | (~x044 & (new_n233_ | ~new_n234_));
