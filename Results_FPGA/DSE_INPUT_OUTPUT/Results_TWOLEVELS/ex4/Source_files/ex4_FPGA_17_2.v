...
module FAU ( 
  ...
  assign z09 = ~x041 & ((x009 & ~z07 & x073) | ~new_n228_ | (~new_n231_ & ~x009));
  assign new_n228_ = x049 ? ~new_n230_ : new_n229_;
  assign new_n229_ = (~x001 | ~x081 | (x033 & x073)) & (~x017 | x033 | ~x065);
  assign new_n230_ = x077 & (x033 | (x017 & x065 & ~x073));
  assign new_n231_ = (~x017 | x049 | ~x065) & (~x077 | ~x081 | ~x001 | ~x049);
