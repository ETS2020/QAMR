...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x122 | (~x013 & x045));
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (~x122 & (new_n240_ | new_n255_)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (~x122 & (x053 | (new_n254_ & ~x077))));
