// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:36 2020
...
module FAU ( 
  ...
  assign new_n177_ = ~x037 & ((x049 & ~x053) | (x077 & (new_n178_ | ~x053)));
  ...
  assign z09 = ~x041 & (~new_n228_ | new_n231_ | (~new_n230_ & x073));
  assign new_n228_ = (~x049 | (~x033 & (~x017 | ~x065 | x073))) & (~x017 | ~new_n229_ | ~x065);
  assign new_n229_ = x077 & ((~x009 & ~x049) | (~x033 & ~x073));
  assign new_n230_ = (~x009 | (~x049 & ~x077)) & (~x077 | ~x081 | ~x001 | x033);
  assign new_n231_ = x001 & x081 & (x049 ? ~x009 : (~x073 & x077));
  ...
  assign new_n242_ = x005 & (new_n250_ | ((new_n243_ | new_n249_) & ~x053));
  ...
  assign new_n252_ = ~x013 & (x077 | (~x021 & (new_n179_ | ~x029)));
  ...
  assign new_n270_ = ~x078 & ((new_n271_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
