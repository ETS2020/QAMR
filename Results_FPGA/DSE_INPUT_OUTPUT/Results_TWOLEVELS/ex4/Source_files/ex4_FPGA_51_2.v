// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:17 2020
...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x039 | (~x013 & x045));
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (~x039 & (new_n240_ | new_n255_)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (~x039 & (x053 | (new_n254_ & ~x077))));
