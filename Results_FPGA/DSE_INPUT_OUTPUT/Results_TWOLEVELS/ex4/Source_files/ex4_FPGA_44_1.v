// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:08 2020
...
module FAU ( 
  ...
  assign z03 = (~x083 & x091) | (x043 & (~new_n170_ | (~x003 & ~new_n169_ & ~x083)));
  ...
  assign z11 = ~x043 & ((x083 & (new_n234_ | ~new_n235_)) | (~new_n235_ & ~x091));
  assign new_n234_ = x003 & ((~x011 & ~x035) | (~x051 & ~x075));
  ...
  assign z13 = z07 | (~x045 & (new_n240_ | ~new_n254_ | (~new_n249_ & ~x085)));
  ...
  assign z14 = ~x046 & ~z07 & (new_n256_ | ~new_n270_ | (~new_n265_ & ~x086));
