...
module FAU ( 
  ...
  assign z05 = x045 & (new_n175_ | ~new_n176_);
  assign new_n175_ = ~x005 & ~x085 & ((x013 & ~x053) | (x037 & ~x077));
  assign new_n176_ = (x037 | x053) & (x013 | x077) & (x021 | x069 | (~x053 ^ x077));
  ...
  assign new_n213_ = x001 & x081 & ((~x009 & ~x033) | (~x049 & ~x073));
  assign new_n214_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = ~x042 & ~z15 & (new_n216_ | ~new_n217_);
  assign new_n216_ = x002 & x082 & ((~x010 & ~x034) | (~x050 & ~x074));
  assign new_n217_ = (~x018 | ~x066 | ((x010 | x050) & (x034 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = z15 | (~x043 & (new_n219_ | ~new_n220_));
  assign new_n219_ = x003 & x083 & ((~x011 & ~x035) | (~x051 & ~x075));
  assign new_n220_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = ~x044 & ~z15 & (new_n222_ | ~new_n223_);
  assign new_n222_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign new_n223_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & (new_n238_ | (~x053 & (new_n225_ | ~new_n232_)));
  assign new_n225_ = x005 & (new_n231_ | (~x077 & (new_n229_ | ~new_n226_ | new_n230_)));
  assign new_n226_ = (~x117 | (x037 & (x109 | ~x125))) & new_n228_ & (x037 | (~new_n227_ & ~x109));
  assign new_n227_ = ~x061 & x101;
  ...
  assign new_n231_ = ~x037 & (x085 | (x013 & ~x061 & x125));
  assign new_n232_ = new_n237_ & (x085 | (~new_n233_ & (new_n236_ | (~x109 & ~x117))));
  assign new_n233_ = ~x077 & (new_n234_ | (new_n235_ & x029));
  assign new_n234_ = x069 & ((~x021 & x029) | x061 | x093);
  assign new_n235_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n236_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
  assign new_n237_ = x013 ? ~x077 : (~x021 | ~x069);
  assign new_n238_ = ~x077 & (new_n239_ | (~new_n240_ & x037) | (x021 & ~x037 & x069));
  assign new_n239_ = ~x013 & ((x005 & x085) | (x029 & x037 & ~x085));
  assign new_n240_ = ~x053 & (x085 | ((x021 | ~x029) & ~x061 & ~x093));
