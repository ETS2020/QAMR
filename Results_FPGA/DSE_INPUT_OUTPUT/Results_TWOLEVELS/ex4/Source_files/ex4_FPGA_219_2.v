...
module FAU ( 
  ...
  assign z05 = z07 | (x045 & (~new_n182_ | (~new_n175_ & ~x005)));
  assign new_n175_ = (~x053 | (~new_n176_ & (~new_n181_ | x013 | ~x037))) & (~x013 | ~x037 | x085);
  assign new_n176_ = x077 & (new_n177_ | new_n178_ | new_n179_ | ~new_n180_);
  ...
  assign new_n182_ = new_n190_ & (~x077 | ((new_n183_ | x069) & (new_n185_ | ~x085)));
  assign new_n183_ = (~x037 | (x021 & (x029 | ~x053 | ~x085))) & (~x053 | new_n184_ | ~x085);
  assign new_n184_ = x061 & x093;
  assign new_n185_ = ~new_n189_ & (~x053 | (~new_n186_ & (x029 | new_n187_ | new_n188_)));
  assign new_n186_ = ~x021 & (~x109 | ~x117);
  assign new_n187_ = ~x061 & ~x093;
  assign new_n188_ = x109 & ((~x013 & ~x021) | (x101 & x125));
  ...
  assign z13 = z07 | (~x045 & (new_n240_ | ~new_n251_ | (~new_n246_ & ~x077)));
  assign new_n240_ = x005 & ((~x013 & ~x037 & x085) | (~new_n241_ & ~x053));
  assign new_n241_ = ~new_n245_ & (x077 | (~new_n242_ & ~new_n243_ & ~new_n244_ & ~x085));
  assign new_n242_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n243_ = (x109 | x117) & (~x037 | ~x069);
  assign new_n244_ = x125 & ((~x069 & ~x093) | (~x109 & x117) | (~x021 & ~x117));
  assign new_n245_ = x013 & ~x037 & ~x061 & x125;
  assign new_n246_ = (new_n247_ | ~x069) & (x085 | (~new_n250_ & (new_n248_ | x053)));
  assign new_n247_ = (x037 | (~x021 & (~x029 | x053 | x085))) & (x053 | new_n187_ | x085);
  assign new_n248_ = (new_n249_ | ~x021) & (~x029 | new_n184_ | (new_n249_ & (~x125 | (x013 & x021))));
  assign new_n249_ = ~x109 & ~x117;
  assign new_n250_ = x037 & (~new_n187_ | (x029 & (~x013 | ~x021)));
  assign new_n251_ = (new_n252_ | ~x013) & (~x037 | ~x053) & (x013 | ~x021 | x053 | ~x069);
  assign new_n252_ = ~x077 & (x053 | new_n249_ | x085);
  ...
  assign new_n264_ = ~x014 & (x078 | (~x022 & (new_n206_ | ~x030)));
  assign new_n265_ = ~x078 & ((new_n266_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
  assign new_n266_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n267_ = x038 & ~x078 & (~new_n204_ | (x030 & (~x014 | ~x022)));
