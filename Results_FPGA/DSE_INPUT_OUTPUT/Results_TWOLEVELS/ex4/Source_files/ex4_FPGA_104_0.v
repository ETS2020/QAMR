...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & x125));
  ...
  assign new_n183_ = ~new_n184_ & new_n185_ & ((~x013 & ~x021) | (new_n177_ & x029));
  assign new_n184_ = x061 & ((~x093 & ~x125) | (x037 & ~x101));
  assign new_n185_ = x085 & (x125 | (x117 ? ~x021 : ~x109));
  assign new_n186_ = ~x069 & x085 & (~new_n177_ | (x021 & ~x029));
  assign new_n187_ = x125 & (~new_n188_ | ~x013);
  ...
  assign z13 = z15 | (~x045 & (new_n238_ | ~new_n245_ | new_n247_));
  assign new_n238_ = ~x077 & (~new_n241_ | (~x085 & (new_n239_ | (~new_n244_ & x037))));
  assign new_n239_ = ~x053 & (~new_n240_ | (x029 & ~new_n177_ & (~x013 | ~x021)));
  assign new_n240_ = (~x021 | (~x109 & ~x117)) & (~x069 | (~x061 & ~x093));
  assign new_n241_ = (x037 | (~new_n242_ & (~x005 | x013 | x053))) & (~x005 | new_n243_ | x053);
  assign new_n242_ = x021 & x069;
  assign new_n243_ = ~x085 & (x069 | x093) & (x021 | x117) & (x109 | ~x117);
  assign new_n244_ = ~x061 & ~x093;
  assign new_n245_ = (new_n246_ | ~x013) & (~x037 | ~x053) & (x013 | ~x021 | x053 | ~x069);
  assign new_n246_ = ~x077 & (x053 | x085 | (~x109 & ~x117));
  assign new_n247_ = x005 & ~x037 & (x013 ? (~x053 & ~x061) : x085);
  assign z14 = z15 | (~x046 & (new_n249_ | ~new_n263_ | (~new_n258_ & ~x086)));
