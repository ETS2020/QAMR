// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:00 2020
...
module FAU ( 
  ...
  assign z02 = x042 & ((~new_n166_ & (~x018 | x077)) | (new_n167_ & ~x018));
  assign new_n166_ = (x002 | x082 | ((~x010 | ~x034) & (~x050 | ~x074))) & (x034 | x050) & (x010 | x074);
  assign new_n167_ = ~x066 & ((x010 & x050) | (x034 & x074));
  ...
  assign new_n191_ = ~x077 & (x018 | (~x013 & x045));
  ...
  assign z10 = ~x042 & ((~new_n231_ & (~x018 | x077)) | (x018 & x066 & ~new_n232_ & x077));
  assign new_n231_ = (~x002 | ~x082 | ((x050 | x074) & (x010 | x034))) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n232_ = (x010 | x050) & (x034 | x074);
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (~x018 & (new_n240_ | new_n255_)));
  assign new_n240_ = ~x077 & (new_n247_ | new_n252_ | (x005 & (new_n241_ | new_n251_)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (~x018 & (x053 | (new_n254_ & ~x077))));
