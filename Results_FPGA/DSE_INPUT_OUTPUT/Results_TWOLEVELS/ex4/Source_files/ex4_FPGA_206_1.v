// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:54 2020
...
module FAU ( 
  ...
  assign new_n197_ = ~x110 & (x038 | (x118 & ~x126));
  assign new_n198_ = x038 & (~x118 | (x062 & ~x102));
  assign new_n199_ = x086 & (~x022 | ~x110 | x126);
  ...
  assign z10 = z15 | (~x042 & (new_n231_ | ~new_n232_));
  ...
  assign z13 = ~x045 & ~z15 & (new_n240_ | ~new_n254_ | (~new_n249_ & ~x085));
  ...
  assign z14 = z15 | (~x046 & (new_n256_ | ~new_n270_ | (~new_n265_ & ~x086)));
  ...
  assign new_n260_ = x110 & (~x038 | (~x118 & x126));
  assign new_n261_ = ~x038 & (x118 | (~x062 & x102));
  assign new_n262_ = ~x086 & (x022 | x110 | ~x126);
