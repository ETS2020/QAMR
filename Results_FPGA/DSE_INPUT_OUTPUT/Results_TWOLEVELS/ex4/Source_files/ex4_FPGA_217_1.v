...
module FAU ( 
  ...
  assign z08 = z16 | (~x040 & (~new_n217_ | (~new_n209_ & x000)));
  ...
  assign z11 = z16 | (~x043 & (new_n232_ | ~new_n233_));
  ...
  assign z13 = ~x045 & ((~new_n238_ & ~x053) | ~new_n250_ | (~new_n248_ & ~x013));
  ...
  assign new_n248_ = new_n249_ & (~x005 | (~x085 & (~x037 | x109 | ~x125)));
  assign new_n249_ = (~x021 | ~x069) & (~x029 | ~x037 | x085);
  assign new_n250_ = (new_n251_ | ~x037) & ~x077 & (~x021 | x037 | ~x069);
