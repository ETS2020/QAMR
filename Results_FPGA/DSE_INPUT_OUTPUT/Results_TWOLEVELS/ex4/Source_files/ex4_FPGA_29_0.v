...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (~x026 | (~x013 & x045));
  ...
  assign z08 = z17 | (~x040 & (~new_n219_ | (~new_n211_ & x000)));
  ...
  assign z13 = z17 | (~x045 & (new_n240_ | ~new_n255_ | (~new_n249_ & ~x085)));
  ...
  assign new_n257_ = x006 & (new_n265_ | ((new_n258_ | new_n264_) & ~x054));
