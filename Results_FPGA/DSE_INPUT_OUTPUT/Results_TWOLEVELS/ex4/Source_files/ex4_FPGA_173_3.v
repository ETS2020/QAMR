...
module FAU ( 
  ...
  assign new_n257_ = x006 & (new_n265_ | (~x078 & (new_n258_ | new_n264_)));
  assign new_n258_ = ~x054 & (new_n259_ | new_n260_ | new_n261_ | new_n262_ | ~new_n263_);
  assign new_n259_ = (~x014 | ~x022) & (x030 | x062 | x094);
  assign new_n260_ = ~x062 & ((~x038 & x102) | (x094 & x126));
  assign new_n261_ = (~x038 | ~x070) & (x110 | x118);
  assign new_n262_ = ~x070 & ~x094 & (x102 | x126);
  assign new_n263_ = ~x086 & (x022 | x110 | ~x126);
  assign new_n264_ = ~x014 & x038 & ~x118 & x126;
