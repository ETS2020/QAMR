// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:37 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & x067));
  ...
  assign new_n187_ = x067 & ~x077 & (~new_n188_ | ~x013);
  assign new_n188_ = (x005 | ~x037 | x085) & (x021 | ~x053 | x069);
  assign new_n189_ = (~x013 | ((x005 | x085) & (x021 | x069))) & (x021 | ~x037 | x069);
  assign z06 = x046 & ~z19 & (new_n191_ | ~new_n207_ | (~new_n200_ & x086));
  assign new_n191_ = ~x006 & (new_n199_ | ((new_n192_ | new_n198_) & x054));
  ...
  assign new_n198_ = x062 & ~x126 & ~x014 & x038;
  ...
  assign z14 = ~x046 & ~z19 & (new_n258_ | ~new_n272_ | (~new_n267_ & ~x086));
  assign new_n258_ = x006 & (new_n266_ | ((new_n259_ | new_n265_) & ~x054));
