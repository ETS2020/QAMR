// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:54 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~z17 & (new_n180_ | new_n176_ | new_n179_ | (~x013 & ~x077));
  ...
  assign new_n181_ = (new_n182_ | (x117 ? x109 : ~x107)) & (~x077 | new_n185_ | ~x117);
  ...
  assign new_n188_ = ~x029 & x085 & (x013 | x021) & (x061 | x093);
  ...
  assign new_n193_ = ~x005 & x107 & x109 & ~x125;
  ...
  assign z13 = z17 | (~x045 & (new_n242_ | ~new_n257_ | (~new_n251_ & ~x085)));
  ...
  assign new_n251_ = ~new_n256_ & (x053 | (~new_n253_ & (new_n252_ | (~x109 & ~x117))));
  assign new_n252_ = ~x013 & (x077 | (~x021 & (new_n178_ | ~x029)));
  ...
  assign z14 = z17 | (~x046 & (new_n259_ | ~new_n273_ | (~new_n268_ & ~x086)));
