...
module FAU ( 
  ...
  assign new_n192_ = ~x006 & ((x054 & (new_n193_ | new_n199_)) | (new_n200_ & x014));
  ...
  assign z14 = ~x046 & (new_n265_ | new_n276_ | (~new_n256_ & ~z16));
  assign new_n256_ = (new_n264_ | x014) & new_n262_ & ((~new_n257_ & new_n259_) | x078);
  ...
  assign new_n266_ = ~new_n267_ & ((~x054 & (new_n269_ | (~new_n268_ & x030))) | (new_n200_ & x030));
  ...
  assign new_n271_ = x006 & ~x077 & ~x118 & x126;
