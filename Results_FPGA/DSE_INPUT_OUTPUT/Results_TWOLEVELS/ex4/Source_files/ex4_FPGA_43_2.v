...
module FAU ( 
  ...
  assign z05 = x045 & (new_n175_ | new_n189_ | (~new_n182_ & x077));
  assign new_n175_ = ~x005 & ((new_n176_ & x053) | (x013 & ~x053 & ~x085));
  assign new_n176_ = x077 & (new_n177_ | new_n178_ | new_n179_ | new_n180_ | ~new_n181_);
  assign new_n177_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n178_ = x061 & ((x037 & ~x101) | (~x093 & ~x125));
  assign new_n179_ = (x037 | x069) & (~x109 | ~x117);
  assign new_n180_ = x069 & x093 & (~x101 | ~x125);
  assign new_n181_ = x085 & (x125 | (x117 ? ~x021 : ~x109));
  assign new_n182_ = ~new_n188_ & (~x085 | (~new_n187_ & (~x053 | (~new_n183_ & new_n185_))));
  assign new_n183_ = (~x109 | ~x117) & (new_n184_ | ~x013 | ~x021);
  assign new_n184_ = ~x029 & (x061 | x093);
  assign new_n185_ = (~new_n186_ | x029) & (x069 | ((x029 | ~x037) & x061 & x093));
  ...
  assign new_n189_ = ~x053 & (~x037 | (~x013 & ~x077));
  ...
  assign z13 = ~x045 & (new_n238_ | new_n254_ | (~x053 & (new_n247_ | new_n253_)));
  ...
  assign new_n246_ = ~x037 & x077 & x085;
  assign new_n247_ = ~x085 & (new_n248_ | (~x077 & (new_n252_ | (~new_n250_ & x029))));
  assign new_n248_ = ~new_n249_ & (x109 | x117);
  assign new_n249_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
  assign new_n250_ = (x037 | ~x069) & ((x013 & x021) | (~new_n251_ & ~x037));
  assign new_n251_ = (x101 | x125) & (~x061 | ~x093);
  assign new_n252_ = (x037 | x069) & (x061 | x093);
  assign new_n253_ = x021 & x069 & (~x013 | ~x037);
  assign new_n254_ = x077 & (x013 | (x037 & x053));
