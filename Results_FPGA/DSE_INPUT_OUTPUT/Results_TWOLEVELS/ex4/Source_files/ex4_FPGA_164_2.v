// Benchmark "FAU" written by ABC on Sat Aug 22 16:12:51 2020
...
module FAU ( 
  ...
  assign z06 = x046 & ~z16 & (new_n189_ | ~new_n205_ | (~new_n198_ & x086));
  ...
  assign z08 = ~x040 & ~z16 & (~new_n215_ | (~new_n207_ & x000));
  ...
  assign z11 = ~x043 & ~z16 & (new_n230_ | ~new_n231_);
  ...
  assign new_n248_ = (~x037 | ~x053) & (~x013 | ~x077) & (x013 | ~x021 | x053 | ~x069);
  assign new_n249_ = ~x045 & (~x021 | x037 | ~x069);
  assign z14 = ~x046 & ~z16 & (new_n251_ | ~new_n265_ | (~new_n260_ & ~x086));
