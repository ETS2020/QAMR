// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:14 2020
...
module FAU ( 
  ...
  assign z06 = z16 | (x046 & (new_n192_ | ~new_n207_ | (~new_n201_ & x086)));
  ...
  assign new_n201_ = ~new_n205_ & (~x054 | (~new_n202_ & (new_n206_ | (x110 & x118))));
  ...
  assign new_n206_ = x014 & (~x078 | (x022 & (x030 | (~x062 & ~x094))));
  ...
  assign new_n224_ = (~x016 | ~x064 | ((x032 | x072) & (x008 | x048))) & (~x032 | ~x048) & (~x008 | ~x072);
  assign z09 = z16 | (~x041 & (new_n226_ | ~new_n227_));
  assign new_n226_ = x001 & x081 & ((~x009 & ~x033) | (~x049 & ~x073));
  assign new_n227_ = (~x017 | ~x065 | ((x033 | x073) & (x009 | x049))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = z16 | (~x042 & (new_n229_ | ~new_n230_));
  assign new_n229_ = x002 & x082 & ((~x010 & ~x034) | (~x050 & ~x074));
  assign new_n230_ = (~x018 | ~x066 | ((x034 | x074) & (x010 | x050))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = ~x043 & ~z16 & (new_n232_ | ~new_n233_);
  assign new_n232_ = x003 & x083 & ((~x011 & ~x035) | (~x051 & ~x075));
  assign new_n233_ = (~x019 | ~x067 | ((x035 | x075) & (x011 | x051))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = ~x044 & ~z16 & (new_n235_ | ~new_n236_);
  assign new_n235_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign new_n236_ = (~x020 | ~x068 | ((x036 | x076) & (x012 | x052))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = new_n254_ | (~x045 & (~new_n246_ | (~new_n238_ & x005)));
  ...
  assign new_n246_ = (x085 | ((new_n247_ | x053) & (~new_n252_ | ~x037))) & ~new_n253_ & (~x037 | ~x053);
  assign new_n247_ = (new_n248_ | new_n249_) & (x077 | (~new_n250_ & (~new_n251_ | ~x029)));
  assign new_n248_ = ~x109 & ~x117;
  assign new_n249_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
  assign new_n250_ = x069 & ((~x021 & x029) | x061 | x093);
  assign new_n251_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n252_ = ~x077 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n253_ = x021 & x069 & ((~x037 & ~x077) | (~x013 & ~x053));
  assign new_n254_ = x077 & (x030 | (x013 & ~x045));
  assign z14 = ~x046 & (new_n256_ | new_n277_ | (~new_n265_ & ~x078));
  assign new_n256_ = ~z16 & (new_n257_ | ~new_n259_ | (~new_n264_ & ~x014));
  assign new_n257_ = ~x038 & (new_n258_ | (x022 & x070 & ~x078));
  assign new_n258_ = x006 & x014 & ~x054 & ~x062 & x126;
  assign new_n259_ = ~new_n262_ & ~new_n263_ & (x054 | (~new_n260_ & (~new_n261_ | ~x006)));
  assign new_n260_ = ~x086 & (x110 | x118) & (x014 | (x022 & ~x078));
  assign new_n261_ = ~x078 & (x086 | (~x070 & ~x094 & (x102 | x126)));
  assign new_n262_ = x038 & (x054 | (~x078 & ~x086 & (x062 | x094)));
  assign new_n263_ = x014 & x078;
  assign new_n264_ = (~x022 | x054 | ~x070) & (~x006 | x038 | ~x086);
  assign new_n265_ = (new_n275_ | (~new_n276_ & (new_n266_ | x054))) & ((~new_n268_ & new_n270_) | x054);
  assign new_n266_ = (~x006 | (x030 ? x077 : (~x062 & ~x094))) & (~x030 | ~new_n267_ | x077);
  assign new_n267_ = ~x086 & (x102 | x126) & (~x062 | ~x094);
  assign new_n268_ = ~x022 & (new_n269_ | (~x077 & ~x086 & x030 & x070));
  assign new_n269_ = ~x118 & x126 & x006 & ~x030;
  assign new_n270_ = x030 ? ~new_n274_ : (~new_n271_ & ((~new_n272_ & new_n273_) | ~x006));
  assign new_n271_ = x070 & ~x086 & (x062 | x094);
  assign new_n272_ = (~x038 | ~x070) & (x110 | x118);
  assign new_n273_ = (x038 | x062 | ~x102) & (x110 | ~x118 | ~x126);
  assign new_n274_ = ~x077 & ~x086 & (~x062 | ~x094) & (x110 | x118);
  assign new_n275_ = x014 & x022;
  assign new_n276_ = x030 & x038 & ~x077 & ~x086;
  assign new_n277_ = new_n278_ & x006 & x014 & ~x038;
  assign new_n278_ = ~x054 & ~x062 & ~x077 & x102;
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z17 = 1'b0;
  assign z18 = 1'b0;
