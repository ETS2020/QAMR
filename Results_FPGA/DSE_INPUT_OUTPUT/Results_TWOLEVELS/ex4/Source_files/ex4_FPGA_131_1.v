// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:52 2020
...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x100 | (~x013 & x045));
  ...
  assign z13 = z07 | (~x045 & (~new_n248_ | (~new_n240_ & x005)));
  ...
  assign z14 = ~x046 & ~z07 & (new_n258_ | ~new_n272_ | (~new_n267_ & ~x086));
