...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n175_ & x077) | (~x013 & (~x077 | (~new_n188_ & x053))));
  assign new_n175_ = (x005 | (~new_n176_ & (~x013 | x085))) & new_n187_ & (new_n182_ | ~x085);
  ...
  assign new_n182_ = ~new_n186_ & (~x053 | (~new_n183_ & ~new_n184_ & (~new_n185_ | x029)));
  ...
  assign new_n188_ = (new_n189_ | ~x085) & (x005 | ~x061 | x093 | x125);
  ...
  assign z13 = ~x045 & (new_n238_ | (~new_n242_ & ~x013) | (x077 & (new_n246_ | x013)));
  assign new_n238_ = x005 & ((x085 & (x077 ? ~x037 : ~x013)) | (new_n239_ & ~x013));
  assign new_n239_ = ~x053 & ~x077 & (new_n240_ | ~new_n241_ | (~new_n189_ & x125));
  assign new_n240_ = (~x037 | ~x069) & (x101 | x109 | x117);
  assign new_n241_ = ~x029 & ~x061 & ~x093;
  assign new_n242_ = (~x037 | ~x053) & (x077 | (~new_n243_ & (~x021 | ~x069)));
  assign new_n243_ = ~x085 & ((~new_n241_ & x037) | (~x053 & (new_n244_ | ~new_n245_)));
  assign new_n244_ = (x109 | x117) & (x021 | (x029 & (~x061 | ~x093)));
  assign new_n245_ = (~x029 | (~x069 & ((~x101 & ~x125) | (x061 & x093)))) & (~x069 | (~x061 & ~x093));
  assign new_n246_ = x021 & ~x053 & x069;
  ...
  assign new_n258_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n259_ = ~x078 & ((new_n260_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n260_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n261_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
