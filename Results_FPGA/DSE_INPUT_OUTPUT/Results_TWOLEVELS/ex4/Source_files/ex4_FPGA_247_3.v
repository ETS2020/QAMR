...
module FAU ( 
  ...
  assign z08 = z15 | (~x040 & (~new_n212_ | (~new_n204_ & x000)));
  ...
  assign z09 = ~x041 & ~z15 & (new_n221_ | ~new_n222_);
  assign new_n221_ = x001 & x081 & ((~x049 & ~x073) | (~x009 & ~x033));
  assign new_n222_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = ~x042 & ~z15 & (new_n224_ | ~new_n225_);
  assign new_n224_ = x002 & x082 & ((~x050 & ~x074) | (~x010 & ~x034));
  assign new_n225_ = (~x018 | ~x066 | ((x010 | x050) & (x034 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = z15 | (~x043 & (new_n227_ | ~new_n228_));
  assign new_n227_ = x003 & x083 & ((~x051 & ~x075) | (~x011 & ~x035));
  assign new_n228_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = ~x044 & ~z15 & (new_n230_ | ~new_n231_);
  assign new_n230_ = x004 & x084 & ((~x052 & ~x076) | (~x012 & ~x036));
  assign new_n231_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & (new_n233_ | (new_n249_ & x077) | (~new_n237_ & ~x077));
  assign new_n233_ = x037 & ((~x077 & (new_n236_ | new_n234_ | x053)) | (x053 & ~x093));
  assign new_n234_ = ~x085 & (~new_n235_ | (~x021 & x029));
  assign new_n235_ = ~x061 & ~x093;
  assign new_n236_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n237_ = new_n248_ & (x053 | (~new_n238_ & ~new_n240_ & ~new_n242_ & new_n244_));
  assign new_n238_ = (new_n239_ | (x005 & (~x037 | ~x069))) & (x109 | x117);
  assign new_n239_ = ~x085 & (x013 | x021 | (x029 & (~x061 | ~x093)));
  assign new_n240_ = ~new_n241_ & ((~x061 & x101) | (~x093 & x125));
  assign new_n241_ = (~x029 | x085 | (x013 & x021)) & (~x005 | x069);
  assign new_n242_ = (~x013 | ~x021) & ((~new_n235_ & x005) | (x029 & (new_n243_ | x005)));
  assign new_n243_ = ~x085 & ((~x093 & x101) | (~x061 & x125));
  assign new_n244_ = (new_n245_ | x021) & ~new_n246_ & (new_n247_ | ~x005);
  assign new_n245_ = (~x029 | ~x069 | x085) & (~x005 | x117 | ~x125);
  assign new_n246_ = x069 & ~x085 & (x061 | x093);
  assign new_n247_ = ~x085 & (x037 | x093 | ~x101) & (x061 | ~x093 | ~x125);
  assign new_n248_ = (x013 | ((~x005 | ~x085) & (~x021 | ~x069))) & (~x021 | x037 | ~x069);
  assign new_n249_ = ~x093 & (~new_n250_ | x013);
  assign new_n250_ = (~x021 | x053 | ~x069) & (~x005 | x037 | ~x085);
  ...
  assign new_n263_ = ~x078 & ((x070 & (~new_n197_ | (~x022 & x030))) | (new_n264_ & x030));
