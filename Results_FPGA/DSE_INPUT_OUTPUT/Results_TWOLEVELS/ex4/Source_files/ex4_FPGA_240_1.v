// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:33 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (x068 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((x068 & (~x053 | (new_n189_ & x077))) | (~x053 & ~x077));
  ...
  assign new_n253_ = x037 & ((x053 & x068) | (~x077 & (new_n254_ | new_n255_ | x053)));
  assign new_n254_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n255_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n256_ = x068 & x077 & (~new_n257_ | x013);
