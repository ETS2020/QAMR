...
module FAU ( 
  ...
  assign z03 = x043 & (((new_n169_ | ~new_n170_) & ~x083) | (~new_n170_ & x077));
  assign new_n169_ = ~x003 & ((x011 & x035) | (x051 & x075));
  ...
  assign z11 = ~x043 & ((x077 & (~new_n235_ | (x003 & ~new_n234_ & x083))) | (~new_n235_ & ~x083));
