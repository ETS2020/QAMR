...
module FAU ( 
  ...
  assign z06 = z17 | (x046 & (new_n189_ | ~new_n205_ | (~new_n198_ & x086)));
  ...
  assign z08 = ~x040 & ~z17 & (~new_n215_ | (~new_n207_ & x000));
  ...
  assign z10 = ~x042 & ~z17 & (new_n227_ | ~new_n228_);
  ...
  assign z12 = z17 | (~x044 & (new_n233_ | ~new_n234_));
