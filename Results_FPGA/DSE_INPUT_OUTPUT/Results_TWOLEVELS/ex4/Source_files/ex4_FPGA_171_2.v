...
module FAU ( 
  ...
  assign new_n209_ = x086 & (~x062 | ~x094 | (~x030 & (x014 | x022)));
  ...
  assign z10 = ~x042 & ~z17 & (new_n231_ | ~new_n232_);
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (~x070 & (new_n240_ | new_n255_)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (~x070 & (x053 | (new_n254_ & ~x077))));
  ...
  assign new_n269_ = ~new_n273_ & (x054 | (~new_n270_ & (new_n274_ | (~x110 & ~x118))));
  assign new_n270_ = ~x078 & ((new_n272_ & x030) | (x070 & (~new_n271_ | (~x022 & x030))));
  assign new_n271_ = ~x062 & ~x094;
  assign new_n272_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n273_ = x038 & ~x078 & (~new_n271_ | (x030 & (~x014 | ~x022)));
