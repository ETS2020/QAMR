// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:06 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (x026 & ~x053));
  ...
  assign new_n187_ = x026 & ~x077 & (~new_n188_ | ~x013);
  ...
  assign z09 = z07 | (~x041 & (new_n226_ | ~new_n227_));
  ...
  assign z14 = z07 | (~x046 & (new_n255_ | ~new_n269_ | (~new_n264_ & ~x086)));
