...
module FAU ( 
  ...
  assign z05 = (x045 & (new_n175_ | ~new_n188_)) | (~x077 & (~x061 | (~x013 & x045)));
  assign new_n175_ = x053 & (new_n176_ | ~new_n187_ | (x077 & (new_n180_ | ~new_n182_)));
  ...
  assign z13 = ~x045 & ((~new_n247_ & ~x037) | new_n240_ | new_n249_ | (~new_n248_ & x037));
  assign new_n240_ = x061 & (new_n246_ | (~x053 & (new_n244_ | (~new_n241_ & ~x085))));
  ...
  assign new_n244_ = x005 & ~new_n245_ & ~x077;
  assign new_n245_ = x013 & x021 & ~x085 & (x093 | (~x101 & ~x125));
  assign new_n246_ = ~x013 & ~x077 & ((x021 & x069) | (x005 & x085));
  assign new_n247_ = (~x021 | ~x061 | ~x069 | x077) & (~x005 | ~x077 | ~x085);
  assign new_n248_ = (~x053 | (~x061 & ~x077)) & (~x061 | x077 | x085);
  assign new_n249_ = x077 & (x013 | (x021 & ~x053 & x069));
