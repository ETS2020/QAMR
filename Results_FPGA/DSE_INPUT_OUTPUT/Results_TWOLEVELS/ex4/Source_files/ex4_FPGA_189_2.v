// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:33 2020
...
module FAU ( 
  ...
  assign z03 = x043 & ~z16 & (new_n169_ | ~new_n170_);
  ...
  assign z05 = x045 & x077 & (new_n175_ | ~new_n185_);
  ...
  assign new_n185_ = (x021 | x069 | (~x013 & ~x037)) & (new_n187_ | ~x013) & (new_n186_ | x037);
  assign new_n186_ = x053 & (~x085 | (new_n181_ & (~x021 | x029)));
  assign new_n187_ = (x029 | x037 | ~x085) & (x005 | x085);
  assign z06 = z16 | (x046 & (new_n189_ | ~new_n205_ | (~new_n198_ & x086)));
  ...
  assign z08 = z16 | (~x040 & (~new_n215_ | (~new_n207_ & x000)));
  ...
  assign new_n244_ = ~new_n249_ & (x053 | (~new_n246_ & (new_n245_ | (~x109 & ~x117))));
  assign new_n245_ = ~x013 & (x077 | (~x021 & (new_n181_ | ~x029)));
  assign new_n246_ = ~x077 & ((new_n248_ & x029) | (x069 & (~new_n247_ | (~x021 & x029))));
  assign new_n247_ = ~x061 & ~x093;
  assign new_n248_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n249_ = x037 & ~x077 & (~new_n247_ | (x029 & (~x013 | ~x021)));
  assign new_n250_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  ...
  assign new_n262_ = ~x014 & (x078 | (~x022 & (new_n202_ | ~x030)));
  assign new_n263_ = ~x078 & ((new_n264_ & x030) | (x070 & (~new_n200_ | (~x022 & x030))));
  assign new_n264_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n265_ = x038 & ~x078 & (~new_n200_ | (x030 & (~x014 | ~x022)));
