...
module FAU ( 
  ...
  assign z08 = ~x040 & (new_n211_ | new_n216_ | (x032 & ~new_n226_ & ~x072));
  ...
  assign new_n216_ = ~x048 & ((~x080 & (new_n217_ | new_n225_)) | (new_n220_ & x000));
  assign new_n217_ = x024 & ~x072 & (new_n219_ | (~new_n218_ & (~x056 | ~x088)));
  assign new_n218_ = (~x104 | x112) & ((x008 & x016) | (~x096 & (x112 | ~x120)));
  assign new_n219_ = ~x016 & x064 & ~x112;
  assign new_n220_ = ~x072 & (new_n224_ | (~x112 & (new_n221_ | new_n222_ | ~new_n223_)));
  assign new_n221_ = (~x008 | ~x016) & (x024 | x056 | x088);
  assign new_n222_ = ~x032 & (x104 | (~x056 & x120));
  assign new_n223_ = (x016 | ~x120) & (x064 | (~x104 & (x088 | ~x120)));
  assign new_n224_ = x096 & ((~x064 & ~x088) | (~x032 & (~x016 | ~x056)));
  assign new_n225_ = (x112 ? x096 : x104) & (x008 | (x016 & ~x072));
  assign new_n226_ = (x008 | (~new_n227_ & (~x024 | x080 | x112))) & (x080 | x112 | x016 | ~x024);
  assign new_n227_ = x000 & x096 & ~x104 & x120;
