...
module FAU ( 
  ...
  assign z05 = x045 & (new_n175_ | ~new_n179_ | (~new_n183_ & ~x069));
  assign new_n175_ = ~x005 & ((~new_n178_ & x037) | (new_n176_ & ~x013));
  assign new_n176_ = x053 & (~new_n177_ | (x069 & x093 & (~x101 | ~x125)));
  assign new_n177_ = (x093 | (~x021 & (~x061 | x125))) & x085 & (~x021 | (x029 & x061 & x125));
  assign new_n178_ = (x077 | x085) & (x013 | ~x053 | ~x061 | x101);
  assign new_n179_ = (x037 | ((x053 | (x013 & x077)) & (~new_n182_ | x013))) & (x013 | (x077 & (~new_n180_ | ~x053)));
  assign new_n180_ = x085 & (new_n181_ | ~x109 | ~x117);
  assign new_n181_ = x021 & ~x029 & (x061 | x093) & (~x101 | ~x125);
  assign new_n182_ = x085 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n183_ = (x021 | ((x013 | ~x037) & (~x053 | x077))) & (x013 | ~new_n184_ | ~x053);
  assign new_n184_ = x085 & ((~x029 & x037) | ~x061 | ~x093);
  ...
  assign z13 = ~x045 & ((~new_n247_ & ~x013) | ((new_n233_ | ~new_n244_) & ~x077));
  assign new_n233_ = ~x053 & (new_n234_ | new_n236_ | new_n238_ | new_n240_ | new_n242_);
  assign new_n234_ = (x109 | x117) & (new_n235_ | (x005 & (~x037 | ~x069)));
  assign new_n235_ = ~x085 & (x013 | x021 | (x029 & (~x061 | ~x093)));
  assign new_n236_ = ~new_n237_ & ~x037;
  assign new_n237_ = (~x029 | ~x069 | x085) & (~x005 | x061 | ~x101);
  ...
  assign new_n242_ = x005 & (~new_n243_ | (~x021 & (x029 | (~x117 & x125))));
  assign new_n243_ = (x013 | ~x029) & ~x085 & (x061 | ~x093 | ~x125);
  assign new_n244_ = (~x037 | (~new_n245_ & new_n246_)) & (~x021 | x037 | ~x069);
  assign new_n245_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n246_ = ~x053 & (x085 | ((x021 | ~x029) & ~x061 & ~x093));
  assign new_n247_ = (~x037 | ~x053) & (~x005 | x037 | ~x085) & (~x021 | x053 | ~x069);
  ...
  assign new_n260_ = ~x078 & ((new_n261_ & x030) | (x070 & (~new_n197_ | (~x022 & x030))));
