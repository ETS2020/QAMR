// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:44 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (~x059 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((~x059 & (~x053 | (new_n189_ & x077))) | (~x053 & ~x077));
  ...
  assign new_n253_ = x037 & ((x053 & ~x059) | (~x077 & (new_n254_ | new_n255_ | x053)));
  assign new_n254_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n255_ = ~x085 & (x061 | x093 | (~x021 & x029));
  assign new_n256_ = ~x059 & x077 & (~new_n257_ | x013);
  assign new_n257_ = (~x005 | x037 | ~x085) & (~x021 | x053 | ~x069);
  assign new_n258_ = (x013 | ((~x021 | ~x069) & (~x005 | ~x085))) & (~x021 | x037 | ~x069);
  assign z14 = ~x046 & ~z15 & (new_n260_ | ~new_n274_ | (~new_n269_ & ~x086));
