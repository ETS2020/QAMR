// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:52 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & ~x088));
  ...
  assign new_n187_ = ~x088 & (~new_n188_ | ~x013);
  ...
  assign new_n209_ = (x048 | (~new_n210_ & ~new_n216_)) & (x008 | x032 | ~x080);
  ...
  assign new_n216_ = x088 & x120 & x008 & ~x056;
  ...
  assign z13 = ~x045 & (new_n251_ | new_n255_ | (~x088 & (new_n238_ | new_n253_)));
  ...
  assign new_n251_ = x037 & ((x053 & x077) | (~x088 & (x053 | (new_n252_ & ~x077))));
