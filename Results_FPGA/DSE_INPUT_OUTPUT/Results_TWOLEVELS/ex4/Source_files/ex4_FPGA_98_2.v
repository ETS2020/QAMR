// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:13 2020
...
module FAU ( 
  ...
  assign new_n211_ = ~z07 & (new_n215_ | ~new_n214_ | (~new_n212_ & x064));
  assign new_n212_ = (~x016 | ((x008 | x048) & (x032 | x072))) & (~new_n213_ | x048);
  ...
  assign new_n216_ = (new_n217_ | (x104 ? ~x114 : ~x112)) & (x072 | new_n220_ | x104);
  ...
  assign new_n227_ = (x008 | (~new_n228_ & (~x024 | x080 | x104))) & (x080 | x104 | x016 | ~x024);
  assign new_n228_ = x000 & ~x112 & x114 & x120;
  ...
  assign z13 = z07 | (~x045 & (new_n242_ | ~new_n256_ | (~new_n251_ & ~x085)));
  ...
  assign new_n269_ = ~x078 & ((x070 & (~new_n204_ | (~x022 & x030))) | (new_n270_ & x030));
