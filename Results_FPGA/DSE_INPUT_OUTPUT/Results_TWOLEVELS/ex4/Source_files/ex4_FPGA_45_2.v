// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:10 2020
...
module FAU ( 
  ...
  assign z10 = z15 | (~x042 & (new_n230_ | ~new_n231_));
  ...
  assign new_n255_ = x077 & (~x103 | (x013 & ~x045));
  assign z14 = z15 | (~x046 & (new_n257_ | ~new_n271_ | (~new_n266_ & ~x086)));
