...
module FAU ( 
  ...
  assign z10 = ~x042 & ((new_n232_ & x018) | (~new_n231_ & (x018 | ~x077)));
  assign new_n231_ = (~x002 | ~x082 | ((x050 | x074) & (x010 | x034))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign new_n232_ = x066 & ((~x034 & ~x074) | (~x010 & ~x050));
