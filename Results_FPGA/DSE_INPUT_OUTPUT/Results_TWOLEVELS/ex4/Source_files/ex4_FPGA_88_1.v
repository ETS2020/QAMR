...
module FAU ( 
  ...
  assign z02 = x042 & ((~new_n166_ & (x018 | ~x077)) | (~x018 & ~x066 & ~new_n167_ & ~x077));
  ...
  assign z10 = ~x042 & ((new_n231_ & x018) | (~new_n230_ & (x018 | ~x077)));
  assign new_n230_ = (~x002 | ~x082 | ((x010 | x034) & (x050 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign new_n231_ = x066 & ((~x034 & ~x074) | (~x010 & ~x050));
  ...
  assign new_n250_ = x037 & ((~x077 & (new_n251_ | new_n252_ | x053)) | (x018 & x053));
  assign new_n251_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n252_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n253_ = x018 & x077 & (~new_n254_ | x013);
