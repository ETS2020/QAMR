...
module FAU ( 
  ...
  assign z03 = x043 & ((~new_n170_ & x003) | (~x077 & (~new_n170_ | (new_n169_ & ~x003))));
  assign new_n169_ = ~x083 & ((x011 & x035) | (x051 & x075));
  ...
  assign z05 = z21 | (x045 & (new_n175_ | ~new_n190_ | (~new_n184_ & x085)));
  ...
  assign z06 = z21 | (x046 & (new_n192_ | ~new_n208_ | (~new_n201_ & x086)));
  ...
  assign z08 = z21 | (~x040 & (~new_n218_ | (~new_n210_ & x000)));
