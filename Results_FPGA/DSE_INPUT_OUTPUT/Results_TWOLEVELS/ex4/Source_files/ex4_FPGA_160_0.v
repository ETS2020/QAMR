...
module FAU ( 
  ...
  assign new_n181_ = (~x037 | (x117 & (x013 | ~x061 | x125))) & (new_n182_ | x117);
  assign new_n182_ = ~x069 & (~x109 | x125);
  assign new_n183_ = x013 & x037 & ~x085;
  assign new_n184_ = ~new_n189_ & (~x053 | (~new_n191_ & ~new_n185_ & (new_n187_ | ~x077)));
  assign new_n185_ = (~x117 | (x077 & ~x109)) & (~x021 | (~new_n186_ & ~x029));
  ...
  assign z13 = ~x045 & (new_n248_ | (~new_n242_ & x117) | (~new_n249_ & x077));
  ...
  assign new_n245_ = x005 & (~x037 | ~x069 | x085 | (~x109 & x125));
  assign new_n246_ = ~x013 & ((x021 & x069) | (x005 & x085));
  assign new_n247_ = x021 & ((~x037 & x069) | (~x053 & ~x085));
  assign new_n248_ = x013 & (x077 | (~x053 & ~x085 & x117));
