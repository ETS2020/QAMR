// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:46 2020
...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x024 | (~x013 & x045));
  assign z06 = z07 | (x046 & (new_n193_ | ~new_n209_ | (~new_n202_ & x086)));
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (~x024 & (new_n240_ | new_n255_)));
