...
module FAU ( 
  ...
  assign z05 = z07 | (x045 & (new_n175_ | ~new_n188_ | (~new_n181_ & x085)));
  assign new_n175_ = ~x005 & ((~new_n176_ & x053) | (x013 & x037 & ~x085));
  assign new_n176_ = ~new_n180_ & (~x077 | (~new_n177_ & ~new_n178_ & ~new_n179_ & x085));
  assign new_n177_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n178_ = (x037 | x069) & (~x109 | ~x117);
  assign new_n179_ = ~x125 & ((x069 & x093) | (x021 & x117) | (x109 & ~x117));
  assign new_n180_ = ~x013 & x037 & x061 & ~x125;
  assign new_n181_ = (~x053 | (~new_n186_ & (new_n182_ | ~x077))) & (x037 | new_n187_ | ~x077);
  assign new_n182_ = new_n185_ & (x029 | (~new_n184_ & (new_n183_ | (~x061 & ~x093))));
  assign new_n183_ = x109 & x117 & (x125 | (~x013 & ~x021));
  assign new_n184_ = x021 & ~x069;
  assign new_n185_ = (x021 | (x109 & x117)) & (x069 | (x061 & x093));
  assign new_n186_ = ~x013 & (~x109 | ~x117);
  assign new_n187_ = x061 & x093 & (x029 | (~x013 & ~x021));
  assign new_n188_ = (x021 | x069 | ((~x013 | ~x053) & (~x037 | ~x077))) & (x037 | x053) & (x013 | x077);
  ...
  assign z13 = z07 | (~x045 & (new_n237_ | ~new_n249_ | (~new_n244_ & ~x085)));
  assign new_n237_ = x005 & ((~x013 & ~x037 & x085) | (~new_n238_ & ~x053));
  assign new_n238_ = ~new_n243_ & (x077 | (~new_n239_ & ~new_n240_ & ~new_n241_ & new_n242_));
  assign new_n239_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n240_ = ~x037 & (x109 | (~x061 & x101));
  assign new_n241_ = ~x069 & (x109 | (~x093 & (x101 | x125)));
  assign new_n242_ = ~x085 & (~x125 | (x117 ? x109 : x021));
  assign new_n243_ = x013 & ~x037 & ~x061 & x125;
  assign new_n244_ = (x053 | (~new_n247_ & (new_n245_ | x077))) & (~x037 | new_n248_ | x077);
  assign new_n245_ = (~x029 | ((new_n246_ | (x061 & x093)) & (x021 | ~x069))) & (~x069 | (~x061 & ~x093));
  assign new_n246_ = ~x109 & ((x013 & x021) | (~x101 & ~x125));
  assign new_n247_ = (x109 | x117) & (x013 | (x021 & ~x077));
  assign new_n248_ = ~x061 & ~x093 & (~x029 | (x013 & x021));
  ...
  assign new_n262_ = ~x078 & ((new_n263_ & x030) | (x070 & (~new_n201_ | (~x022 & x030))));
