...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (x124 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((~x053 & ~x077) | (x124 & (~x053 | (new_n189_ & x077))));
  ...
  assign new_n258_ = x077 & (~x124 | (x013 & ~x045));
