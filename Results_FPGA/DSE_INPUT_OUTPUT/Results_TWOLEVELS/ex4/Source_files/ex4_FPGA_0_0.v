// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:16 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & x093));
  assign new_n176_ = x085 & ((~new_n177_ & ~x029) | ~x061 | ~x093);
  assign new_n177_ = ~x013 & ~x021;
  assign new_n178_ = x053 & (new_n179_ | new_n181_ | new_n186_ | (~new_n183_ & ~x005));
  ...
  assign new_n183_ = (new_n177_ | (x029 & x061 & x093)) & new_n185_ & (new_n184_ | ~x061);
  assign new_n184_ = (~x037 | x101) & (x093 | x125);
  assign new_n185_ = x085 & (x125 | (x117 ? ~x021 : ~x109));
  assign new_n186_ = ~x069 & x085 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n187_ = x093 & (~new_n188_ | ~x013);
  assign new_n188_ = (x021 | ~x053 | x069) & (x005 | ~x037 | x085);
  ...
  assign z13 = ~x045 & ((~new_n245_ & ~x037) | (~new_n246_ & x037) | new_n238_ | new_n247_);
  assign new_n238_ = x093 & (new_n244_ | (~x053 & (new_n242_ | (~new_n239_ & ~x085))));
  assign new_n239_ = (x077 | (~new_n241_ & ~x069)) & (new_n240_ | (~x109 & ~x117));
  assign new_n240_ = ~x013 & (x077 | (~x021 & (~x029 | x061)));
  assign new_n241_ = x029 & ~x061 & (~x013 | ~x021) & (x101 | x125);
  assign new_n242_ = x005 & ~new_n243_ & ~x077;
  assign new_n243_ = (x061 | (~x101 & ~x125)) & x013 & x021 & ~x085;
  assign new_n244_ = ~x013 & ~x077 & ((x021 & x069) | (x005 & x085));
  assign new_n245_ = (~x005 | ~x077 | ~x085) & (~x021 | ~x069 | x077 | ~x093);
  assign new_n246_ = (~x053 | (~x077 & ~x093)) & (x077 | x085 | ~x093);
  assign new_n247_ = x077 & (x013 | (x021 & ~x053 & x069));
  ...
  assign new_n259_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n260_ = ~x078 & ((new_n261_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n261_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n262_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
