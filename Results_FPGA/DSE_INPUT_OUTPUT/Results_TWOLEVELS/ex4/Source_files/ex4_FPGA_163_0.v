// Benchmark "FAU" written by ABC on Sat Aug 22 16:12:49 2020
...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (~x119 | (~x013 & x045));
  assign z06 = z15 | (x046 & (new_n193_ | ~new_n209_ | (~new_n202_ & x086)));
  ...
  assign z09 = z15 | (~x041 & (new_n228_ | ~new_n229_));
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (x119 & (new_n240_ | new_n255_)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (x119 & (x053 | (new_n254_ & ~x077))));
