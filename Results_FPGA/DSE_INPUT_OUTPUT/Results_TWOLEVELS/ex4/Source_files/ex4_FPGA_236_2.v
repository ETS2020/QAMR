...
module FAU ( 
  ...
  assign z08 = ~x040 & (new_n211_ | (new_n227_ & x024) | (~new_n216_ & ~x048));
  ...
  assign new_n216_ = ~new_n217_ & ~new_n226_ & (x072 | (~new_n225_ & (new_n221_ | x096)));
  assign new_n217_ = ~new_n218_ & ((~x072 & (new_n219_ | (~new_n220_ & ~x080))) | (x008 & ~x080));
  assign new_n218_ = ~x112 & (x096 | ~x104);
  assign new_n219_ = x000 & (~x032 | ~x064);
  assign new_n220_ = ~x016 & (~x024 | (x056 & x088));
  assign new_n221_ = (new_n222_ | (x008 & x016)) & ~new_n223_ & (~new_n224_ | x016 | ~x024);
  assign new_n222_ = (~x024 | (~x000 & (x080 | ~x120 | (x056 & x088)))) & (~x000 | (~x056 & ~x088));
  assign new_n223_ = x000 & x120 & ((~x064 & ~x088) | (~x016 & ~x112));
  assign new_n224_ = x064 & ~x080;
  assign new_n225_ = x000 & ~x104 & x112 & x120;
  assign new_n226_ = x000 & x008 & ~x032 & ~x056 & ~x096 & x120;
  assign new_n227_ = x032 & ~x072 & ~x080 & ~x096 & (~x008 | ~x016);
  ...
  assign z13 = z15 | (~x045 & (new_n241_ | ~new_n255_ | (~new_n250_ & ~x085)));
  ...
  assign new_n252_ = ~x077 & ((x069 & (~new_n186_ | (~x021 & x029))) | (new_n253_ & x029));
  ...
  assign new_n268_ = ~x078 & ((x070 & (~new_n204_ | (~x022 & x030))) | (new_n269_ & x030));
