// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:45 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (x025 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((x025 & (~x053 | (new_n189_ & x077))) | (~x053 & ~x077));
  ...
  assign new_n254_ = x069 & ((x029 & ~x037) | x061 | x093);
  ...
  assign new_n258_ = x077 & (~x025 | (x013 & ~x045));
