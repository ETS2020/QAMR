// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:52 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & ~x089));
  ...
  assign new_n187_ = ~x089 & (~new_n188_ | ~x013);
  ...
  assign z12 = ~x044 & ~z15 & (new_n235_ | ~new_n236_);
