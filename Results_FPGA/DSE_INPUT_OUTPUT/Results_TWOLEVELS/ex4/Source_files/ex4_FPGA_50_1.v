...
module FAU ( 
  ...
  assign z13 = ~x045 & (new_n250_ | new_n253_ | (~x077 & (new_n239_ | ~new_n255_)));
  ...
  assign new_n250_ = x037 & ((x053 & x055) | (~x077 & (new_n251_ | new_n252_ | x053)));
  assign new_n251_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n252_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n253_ = x055 & x077 & (~new_n254_ | x013);
