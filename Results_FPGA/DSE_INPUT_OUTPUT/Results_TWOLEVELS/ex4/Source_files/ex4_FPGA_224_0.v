...
module FAU ( 
  ...
  assign new_n193_ = ~x006 & ((new_n201_ & x014) | ((new_n194_ | new_n200_) & x054));
  ...
  assign z14 = ~x046 & ((~new_n256_ & ~z16) | new_n265_ | new_n276_);
  assign new_n256_ = (new_n264_ | x014) & new_n262_ & (x078 | (~new_n257_ & new_n259_));
  assign new_n257_ = ~x086 & (new_n258_ | (x038 & (x062 | x094)));
  assign new_n258_ = x022 & ~x054 & (x110 | x118);
  assign new_n259_ = (~new_n261_ | ~x006) & (new_n260_ | x038);
  assign new_n260_ = (~x022 | ~x070) & (x062 | ~x102 | ~x006 | x054);
  assign new_n261_ = ~x054 & (x086 | (~x070 & ~x094 & (x102 | x126)));
  assign new_n262_ = (~x038 | ~x054) & (~x014 | (~x078 & (~new_n263_ | x054)));
  assign new_n263_ = ~x086 & (x110 | x118);
  assign new_n264_ = (~x022 | x054 | ~x070) & (~x006 | x038 | ~x086);
  assign new_n265_ = ~x078 & (new_n266_ | (~x054 & (new_n270_ | new_n272_ | new_n274_)));
  assign new_n266_ = ~new_n267_ & ((~x054 & (new_n269_ | (~new_n268_ & x030))) | (new_n201_ & x030));
  assign new_n267_ = x014 & x022;
  assign new_n268_ = ~x006 & (x086 | (x062 & x094) | (~x102 & ~x126));
  assign new_n269_ = x006 & x077 & (x062 | x094);
  assign new_n270_ = ~x022 & (new_n271_ | (x030 & x070 & ~x086));
  assign new_n271_ = ~x118 & x126 & x006 & x077;
  assign new_n272_ = x077 & (new_n273_ | (x070 & ~x086 & (x062 | x094)));
  assign new_n273_ = x006 & (((~x038 | ~x070) & (x110 | x118)) | (~x110 & x118 & x126));
  assign new_n274_ = x030 & (new_n275_ | (x006 & ~x038 & ~x062 & x126));
  assign new_n275_ = ~x086 & (x110 | x118) & (~x062 | ~x094);
  assign new_n276_ = new_n277_ & x006 & x014 & ~x038;
  assign new_n277_ = ~x054 & ~x062 & x077 & x126;
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z17 = 1'b0;
  assign z18 = 1'b0;
