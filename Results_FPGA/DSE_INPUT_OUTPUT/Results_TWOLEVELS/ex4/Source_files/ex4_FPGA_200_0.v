// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:46 2020
...
module FAU ( 
  ...
  assign new_n188_ = (~x101 | ~x125) & (x013 | x021) & (x061 | x093);
  assign new_n189_ = x077 & (~x061 | ~x093 | (~x029 & (x013 | x021)));
  assign new_n190_ = ~x021 & ~x069 & ((x013 & x053) | (x037 & x077));
  assign new_n191_ = ~x077 & (~x060 | (~x013 & x045));
  assign z06 = x046 & ~z17 & (new_n193_ | ~new_n209_ | (~new_n202_ & x086));
  ...
  assign z08 = ~x040 & ~z17 & (~new_n219_ | (~new_n211_ & x000));
  ...
  assign new_n247_ = ~x061 & x125;
  assign new_n248_ = new_n255_ & (x077 | (~new_n251_ & (new_n249_ | ~x069)));
  assign new_n249_ = (x037 | (~x021 & (~x029 | x053 | x085))) & (x053 | new_n250_ | x085);
  assign new_n250_ = ~x061 & ~x093;
  assign new_n251_ = ~x085 & (new_n254_ | (~x053 & (new_n252_ | (new_n253_ & x029))));
  assign new_n252_ = (x109 | x117) & (x021 | (x029 & (~x061 | ~x093)));
  assign new_n253_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n254_ = x037 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n255_ = (new_n256_ | ~x013) & (~x037 | ~x053) & (x013 | ~x021 | x053 | ~x069);
  assign new_n256_ = ~x077 & (x053 | x085 | (~x109 & ~x117));
  assign z14 = z17 | (~x046 & (new_n258_ | ~new_n272_ | (~new_n267_ & ~x086)));
  ...
  assign new_n268_ = ~x014 & (x078 | (~x022 & (new_n206_ | ~x030)));
  assign new_n269_ = ~x078 & ((new_n270_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
  assign new_n270_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n271_ = x038 & ~x078 & (~new_n204_ | (x030 & (~x014 | ~x022)));
