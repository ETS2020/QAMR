...
module FAU ( 
  ...
  assign z05 = x045 & (new_n186_ | new_n189_ | (x077 & (new_n175_ | ~new_n191_)));
  ...
  assign new_n177_ = x085 & (~x013 | ~x021 | (~x029 & (x061 | x093)));
  ...
  assign z09 = ~x041 & ((~new_n229_ & ~x001) | (x077 & (~new_n229_ | (new_n228_ & x001))));
  assign new_n228_ = x081 & ((~x049 & ~x073) | (~x009 & ~x033));
  ...
  assign new_n253_ = (~x013 | ~x021) & (~x061 | ~x093) & (x101 | x125);
  ...
  assign new_n270_ = (~x014 | ~x022) & (~x062 | ~x094) & (x102 | x126);
