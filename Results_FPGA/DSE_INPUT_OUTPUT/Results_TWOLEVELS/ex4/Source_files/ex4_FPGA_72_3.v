// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:42 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (~x100 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((~x053 & ~x077) | (~x100 & (~x053 | (new_n189_ & x077))));
  ...
  assign z06 = z16 | (x046 & (new_n195_ | ~new_n211_ | (~new_n204_ & x086)));
  ...
  assign z08 = z16 | (~x040 & (~new_n221_ | (~new_n213_ & x000)));
  ...
  assign z09 = z16 | (~x041 & (new_n230_ | ~new_n231_));
  ...
  assign z11 = ~x043 & ~z16 & (new_n236_ | ~new_n237_);
  ...
  assign new_n258_ = x077 & (x100 | (x013 & ~x045));
  assign z14 = ~x046 & ~z16 & (new_n260_ | ~new_n274_ | (~new_n269_ & ~x086));
