// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:30 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (x089 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((~x053 & ~x077) | (x089 & (~x053 | (new_n189_ & x077))));
  ...
  assign z12 = ~x044 & ~z15 & (new_n239_ | ~new_n240_);
  ...
  assign new_n254_ = x037 & ((x053 & x089) | (~x077 & (new_n255_ | x053)));
  assign new_n255_ = ~x085 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n256_ = x089 & (~new_n257_ | x013);
