...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (~x065 | (~x013 & x045));
  ...
  assign z09 = ~x041 & ((~new_n228_ & (x065 | x077)) | (x017 & ~new_n229_ & x065));
  assign new_n228_ = (~x001 | ~x081 | ((x049 | x073) & (x009 | x033))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign new_n229_ = (x009 | x049) & (x033 | x073);
