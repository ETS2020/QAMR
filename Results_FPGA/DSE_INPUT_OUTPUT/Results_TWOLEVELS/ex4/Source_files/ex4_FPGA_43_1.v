...
module FAU ( 
  ...
  assign z05 = x045 & (new_n175_ | new_n191_ | (x053 & (new_n184_ | new_n190_)));
  ...
  assign new_n183_ = x037 & ~x077 & ~x085;
  assign new_n184_ = x085 & (new_n185_ | (x077 & (new_n189_ | (~new_n187_ & ~x029))));
  assign new_n185_ = ~new_n186_ & (~x109 | ~x117);
  assign new_n186_ = x013 & (~x077 | (x021 & (x029 | (~x061 & ~x093))));
  assign new_n187_ = ((~x013 & ~x021) | (~new_n188_ & x037)) & (~x037 | x069);
  assign new_n188_ = (x061 | x093) & (~x101 | ~x125);
  assign new_n189_ = (~x061 | ~x093) & (~x037 | ~x069);
  assign new_n190_ = ~x021 & ~x069 & (x013 | x037);
  assign new_n191_ = ~x077 & (~x013 | (~x037 & ~x053));
  ...
  assign z13 = ~x045 & ((~new_n240_ & x005) | new_n255_ | (~new_n248_ & ~x077));
  assign new_n240_ = (x077 | (~new_n247_ & (new_n241_ | x053))) & (x013 | ~x053 | ~x085);
  assign new_n241_ = ~new_n242_ & ~new_n243_ & ~new_n244_ & ~new_n245_ & new_n246_;
  assign new_n242_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n243_ = ~x061 & ((~x037 & x101) | (x093 & x125));
  assign new_n244_ = (x109 | x117) & (~x037 | ~x069);
  assign new_n245_ = ~x069 & ~x093 & (x101 | x125);
  assign new_n246_ = ~x085 & (x021 | x117 | ~x125);
  assign new_n247_ = ~x013 & x037 & ~x109 & x125;
  assign new_n248_ = ~new_n254_ & (x085 | (~new_n253_ & ((~new_n249_ & new_n251_) | x053)));
  assign new_n249_ = ~new_n250_ & (x109 | x117);
  assign new_n250_ = ~x013 & ~x021 & (~x029 | (x061 & x093));
  assign new_n251_ = (~new_n252_ | ~x029) & (~x069 | ((~x029 | x037) & ~x061 & ~x093));
  assign new_n252_ = (x101 | x125) & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n253_ = x037 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n254_ = x021 & x069 & (~x013 | ~x037);
  assign new_n255_ = x053 & (x037 | (x013 & x077));
