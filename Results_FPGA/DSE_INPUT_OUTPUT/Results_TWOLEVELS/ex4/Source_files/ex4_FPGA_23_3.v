// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:43 2020
...
module FAU ( 
  ...
  assign z05 = x045 & ~z15 & (new_n175_ | ~new_n191_ | (~new_n184_ & x085));
  ...
  assign new_n219_ = new_n226_ & (x072 | (~new_n222_ & (new_n220_ | ~x064)));
  assign new_n220_ = (x032 | (~x016 & (~x024 | x048 | x080))) & (x048 | new_n221_ | x080);
  assign new_n221_ = ~x056 & ~x088;
  assign new_n222_ = ~x080 & (new_n225_ | (~x048 & (new_n223_ | (new_n224_ & x024))));
  assign new_n223_ = (x104 | x112) & (x016 | (x024 & (~x056 | ~x088)));
  assign new_n224_ = (x096 | x120) & (~x008 | ~x016) & (~x056 | ~x088);
  assign new_n225_ = x032 & (x056 | x088 | (x024 & (~x008 | ~x016)));
  assign new_n226_ = (new_n227_ | ~x008) & (~x032 | ~x048) & (x008 | ~x016 | x048 | ~x064);
  assign new_n227_ = ~x072 & (x048 | x080 | (~x104 & ~x112));
  assign z09 = z15 | (~x041 & (new_n229_ | ~new_n230_));
  ...
  assign z12 = ~x044 & ~z15 & (new_n238_ | ~new_n239_);
  assign new_n238_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign new_n239_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & ~z15 & (new_n241_ | ~new_n255_ | (~new_n250_ & ~x085));
  assign new_n241_ = x005 & (new_n249_ | (~x053 & (new_n242_ | new_n248_)));
  assign new_n242_ = ~x077 & (new_n243_ | new_n244_ | new_n245_ | new_n246_ | ~new_n247_);
  assign new_n243_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n244_ = ~x069 & (x109 | x117 | (~x093 & (x101 | x125)));
  assign new_n245_ = x117 & (~x037 | (~x109 & x125));
  assign new_n246_ = ~x037 & (x109 | (~x061 & x101));
  assign new_n247_ = ~x085 & (x021 | x117 | ~x125);
  assign new_n248_ = ~x061 & x125 & x013 & ~x037;
  assign new_n249_ = ~x013 & ~x037 & x085;
  assign new_n250_ = ~new_n254_ & (x053 | (~new_n252_ & (new_n251_ | (~x109 & ~x117))));
  assign new_n251_ = ~x013 & (x077 | (~x021 & (new_n188_ | ~x029)));
  assign new_n252_ = ~x077 & ((new_n253_ & x029) | (x069 & (~new_n186_ | (~x021 & x029))));
  assign new_n253_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n254_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
  assign new_n255_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & ~z15 & (new_n257_ | ~new_n271_ | (~new_n266_ & ~x086));
  ...
  assign new_n267_ = ~x014 & (x078 | (~x022 & (new_n206_ | ~x030)));
  assign new_n268_ = ~x078 & ((new_n269_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
  assign new_n269_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n270_ = x038 & ~x078 & (~new_n204_ | (x030 & (~x014 | ~x022)));
