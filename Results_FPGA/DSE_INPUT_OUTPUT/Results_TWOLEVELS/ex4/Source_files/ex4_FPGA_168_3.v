// Benchmark "FAU" written by ABC on Sat Aug 22 16:12:55 2020
...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (~new_n183_ | (~new_n175_ & ~x005)));
  ...
  assign z08 = ~x040 & ~z16 & (~new_n219_ | (~new_n211_ & x000));
  ...
  assign z09 = ~x041 & ~z16 & (new_n228_ | ~new_n229_);
  assign new_n228_ = x001 & x081 & ((~x049 & ~x073) | (~x009 & ~x033));
  assign new_n229_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = ~x042 & ~z16 & (new_n231_ | ~new_n232_);
  assign new_n231_ = x002 & x082 & ((~x050 & ~x074) | (~x010 & ~x034));
  assign new_n232_ = (~x018 | ~x066 | ((x010 | x050) & (x034 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = ~x043 & ~z16 & (new_n234_ | ~new_n235_);
  assign new_n234_ = x003 & x083 & ((~x051 & ~x075) | (~x011 & ~x035));
  assign new_n235_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = z16 | (~x044 & (new_n237_ | ~new_n238_));
  assign new_n237_ = x004 & x084 & ((~x052 & ~x076) | (~x012 & ~x036));
  assign new_n238_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = new_n258_ | (~x045 & ((~new_n240_ & ~x053) | ~new_n254_ | new_n256_));
  assign new_n240_ = ~new_n241_ & ~new_n253_ & (x077 | (~new_n245_ & ~new_n247_ & ~new_n252_));
  assign new_n241_ = (x109 | x117) & (new_n244_ | (~x077 & (new_n242_ | new_n243_)));
  assign new_n242_ = x005 & (~x037 | ~x069);
  assign new_n243_ = ~x085 & (x021 | (x029 & (~x061 | ~x093)));
  assign new_n244_ = x013 & ~x085;
  assign new_n245_ = (x101 | x125) & (new_n246_ | (x005 & ~x069 & ~x093));
  assign new_n246_ = x029 & ~x085 & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n247_ = x005 & (new_n250_ | ~new_n251_ | (~new_n249_ & (~new_n248_ | x029)));
  assign new_n248_ = ~x061 & ~x093;
  assign new_n249_ = x013 & x021;
  assign new_n250_ = ~x061 & ((~x037 & x101) | (x093 & x125));
  assign new_n251_ = ~x085 & (x021 | x117 | ~x125);
  assign new_n252_ = x069 & ~x085 & (~new_n248_ | (~x021 & x029));
  assign new_n253_ = ~x013 & x021 & x069;
  assign new_n254_ = (~x021 | x037 | ~x069 | x077) & (~x037 | (~x053 & (~new_n255_ | x077)));
  assign new_n255_ = ~x085 & (~new_n248_ | (~x021 & x029));
  assign new_n256_ = ~x013 & (new_n257_ | (~x077 & ~x085 & x029 & x037));
  assign new_n257_ = x005 & ((~x037 & x085) | (x037 & ~x077 & ~x109 & x125));
  assign new_n258_ = x077 & (x022 | (x013 & ~x045));
  assign z14 = z16 | (~x046 & (new_n260_ | ~new_n274_ | (~new_n269_ & ~x086)));
