// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:59 2020
...
module FAU ( 
  ...
  assign z06 = z17 | (x046 & (new_n192_ | ~new_n208_ | (~new_n201_ & x086)));
  ...
  assign z08 = ~x040 & ~z17 & (~new_n218_ | (~new_n210_ & x000));
  ...
  assign z11 = z17 | (~x043 & (new_n233_ | ~new_n234_));
  ...
  assign new_n255_ = x077 & (x007 | (x013 & ~x045));
