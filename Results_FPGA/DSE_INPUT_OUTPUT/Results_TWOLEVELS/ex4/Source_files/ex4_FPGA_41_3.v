// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:05 2020
...
module FAU ( 
  ...
  assign new_n253_ = x037 & ((~x077 & (new_n254_ | new_n255_ | x053)) | (x053 & ~x100));
  assign new_n254_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n255_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n256_ = ~x100 & (~new_n257_ | x013);
