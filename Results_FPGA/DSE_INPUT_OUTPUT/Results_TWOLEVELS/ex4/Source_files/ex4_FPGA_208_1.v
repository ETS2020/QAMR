// Benchmark "FAU" written by ABC on Sat Aug 22 16:13:55 2020
...
module FAU ( 
  ...
  assign z05 = (x045 & (new_n175_ | ~new_n182_)) | (~x053 & (x077 | (~x037 & x045)));
  ...
  assign z13 = ~x045 & (new_n238_ | new_n252_ | (~new_n245_ & ~x077));
  assign new_n238_ = x005 & ((new_n239_ & ~x053) | (~x013 & x053 & x085));
  assign new_n239_ = ~x077 & (new_n240_ | new_n241_ | new_n242_ | new_n243_ | ~new_n244_);
  assign new_n240_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n241_ = ~x061 & ((~x037 & x101) | (x093 & x125));
  assign new_n242_ = (x109 | x117) & (~x037 | ~x069);
  assign new_n243_ = ~x069 & ~x093 & (x101 | x125);
  assign new_n244_ = ~x085 & (~x125 | (x117 ? x109 : x021));
  assign new_n245_ = ~new_n251_ & (x085 | (~new_n250_ & ((~new_n246_ & new_n248_) | x053)));
  assign new_n246_ = ~new_n247_ & (x109 | x117);
  assign new_n247_ = ~x013 & ~x021 & (~x029 | (x061 & x093));
  assign new_n248_ = (~new_n249_ | ~x029) & (~x069 | ((~x029 | x037) & ~x061 & ~x093));
  assign new_n249_ = (x101 | x125) & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n250_ = x037 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n251_ = x021 & x069 & (~x013 | ~x037);
  assign new_n252_ = x053 & (x037 | (x013 & x077));
  assign z14 = z07 | (~x046 & (new_n254_ | ~new_n268_ | (~new_n263_ & ~x086)));
