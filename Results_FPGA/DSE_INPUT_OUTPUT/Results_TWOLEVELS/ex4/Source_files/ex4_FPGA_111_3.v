// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:28 2020
...
module FAU ( 
  ...
  assign z00 = x040 & ~z18 & (new_n160_ | ~new_n161_);
  assign z18 = x043 & x077;
  ...
  assign new_n169_ = ~new_n170_ & (x035 | x051) & ~x077 & (x011 | x075);
  assign new_n170_ = ~x019 & ~x067 & ((x011 & x051) | (x035 & x075));
  assign new_n171_ = ~x003 & ~x083 & ((x011 & x035) | (x051 & x075));
  assign z04 = z18 | (x044 & (new_n173_ | ~new_n174_));
  assign new_n173_ = ~x004 & ~x084 & ((x012 & x036) | (x052 & x076));
  assign new_n174_ = (x020 | x068 | ((~x012 | ~x052) & (~x036 | ~x076))) & (x036 | x052) & (x012 | x076);
  assign z05 = z18 | (x045 & (new_n176_ | ~new_n191_ | (~new_n185_ & x085)));
  assign new_n176_ = ~x005 & (new_n184_ | (x053 & (new_n177_ | new_n183_)));
  assign new_n177_ = x077 & (new_n178_ | new_n179_ | new_n180_ | new_n181_ | ~new_n182_);
  ...
  assign new_n183_ = x061 & ~x125 & ~x013 & x037;
  assign new_n184_ = x013 & x037 & ~x085;
  assign new_n185_ = ~new_n189_ & (~x053 | (~new_n186_ & (new_n190_ | (x109 & x117))));
  ...
  assign new_n190_ = x013 & (~x077 | (x021 & (x029 | (~x061 & ~x093))));
  assign new_n191_ = (x021 | x069 | ((~x013 | ~x053) & (~x037 | ~x077))) & (x037 | x053) & (x013 | x077);
  assign z06 = x046 & ~z18 & (new_n193_ | ~new_n209_ | (~new_n202_ & x086));
  ...
  assign z08 = ~x040 & ~z18 & (~new_n219_ | (~new_n211_ & x000));
  ...
  assign z10 = z18 | (~x042 & (new_n231_ | ~new_n232_));
  ...
  assign new_n251_ = x037 & ((~x043 & x053) | (~x077 & (new_n252_ | new_n253_ | x053)));
  assign new_n252_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n253_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n254_ = ~x043 & x077 & (~new_n255_ | x013);
  assign new_n255_ = (~x005 | x037 | ~x085) & (~x021 | x053 | ~x069);
  assign new_n256_ = (x013 | ((~x005 | ~x085) & (~x021 | ~x069))) & (~x021 | x037 | ~x069);
  assign z14 = ~x046 & ~z18 & (new_n258_ | ~new_n272_ | (~new_n267_ & ~x086));
