...
module FAU ( 
  ...
  assign z13 = ~x045 & (new_n250_ | (new_n253_ & x077) | (~x077 & (new_n239_ | ~new_n255_)));
  ...
  assign new_n248_ = x005 & (~new_n249_ | (~x021 & (x029 | (~x117 & x125))));
  assign new_n249_ = (x013 | ~x029) & ~x085 & (x061 | ~x093 | ~x125);
  assign new_n250_ = x037 & ((~x077 & (new_n251_ | new_n252_ | x053)) | (x053 & ~x122));
  assign new_n251_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n252_ = ~x085 & ((~x021 & x029) | x061 | x093);
