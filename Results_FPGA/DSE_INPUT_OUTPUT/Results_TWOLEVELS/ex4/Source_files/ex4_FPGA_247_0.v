...
module FAU ( 
  ...
  assign z05 = new_n189_ | (x045 & ((~new_n175_ & x053) | ~new_n188_ | new_n190_));
  ...
  assign new_n181_ = ~x005 & x069 & x077 & x093;
  ...
  assign new_n185_ = x077 & (~x085 | (~x125 & (x117 ? x021 : x109)));
  assign new_n186_ = ~x069 & (new_n187_ | (x013 & ~x021));
  assign new_n187_ = x085 & (~x093 | (x077 & (~x061 | (x021 & ~x029))));
  assign new_n188_ = (x037 | (~new_n187_ & x053)) & (x021 | ~x037 | x069 | ~x077);
  assign new_n189_ = ~x077 & (~x093 | (~x013 & x045));
  ...
  assign z13 = ~x045 & ((~new_n246_ & ~x037) | new_n239_ | new_n248_ | (~new_n247_ & x037));
  assign new_n239_ = x093 & (new_n245_ | (~x053 & (new_n243_ | (~new_n240_ & ~x085))));
  assign new_n240_ = (x077 | (~new_n242_ & ~x069)) & (new_n241_ | (~x109 & ~x117));
  assign new_n241_ = ~x013 & (x077 | (~x021 & (~x029 | x061)));
  assign new_n242_ = x029 & ~x061 & (~x013 | ~x021) & (x101 | x125);
  assign new_n243_ = x005 & ~new_n244_ & ~x077;
  assign new_n244_ = (x061 | (~x101 & ~x125)) & x013 & x021 & ~x085;
  assign new_n245_ = ~x013 & ~x077 & ((x021 & x069) | (x005 & x085));
  assign new_n246_ = (~x005 | ~x077 | ~x085) & (~x021 | ~x069 | x077 | ~x093);
  assign new_n247_ = (~x053 | (~x077 & ~x093)) & (x077 | x085 | ~x093);
  assign new_n248_ = x077 & (x013 | (x021 & ~x053 & x069));
  assign z14 = ~x046 & ~z15 & (new_n250_ | ~new_n264_ | (~new_n259_ & ~x086));
