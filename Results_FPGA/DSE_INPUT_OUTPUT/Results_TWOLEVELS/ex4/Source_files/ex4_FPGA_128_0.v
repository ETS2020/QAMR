// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:49 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & x076));
  ...
  assign new_n187_ = x076 & ~x077 & (~new_n188_ | ~x013);
  ...
  assign z10 = z15 | (~x042 & (new_n229_ | ~new_n230_));
  ...
  assign new_n238_ = x005 & (new_n246_ | (~x053 & (new_n239_ | new_n245_)));
  ...
  assign new_n255_ = x006 & (new_n263_ | (~x054 & (new_n256_ | new_n262_)));
