...
module FAU ( 
  ...
  assign new_n185_ = ~new_n186_ & (~x117 | (x077 & ~x109));
  ...
  assign z13 = z07 | (~new_n242_ & ~x045);
  assign new_n242_ = (new_n248_ | ~x013) & (new_n249_ | x013) & ~new_n243_ & (~x037 | ~x053);
  assign new_n243_ = ~x077 & (new_n244_ | new_n247_ | (~x053 & (new_n245_ | new_n246_)));
  assign new_n244_ = x021 & ((~x037 & x069) | (~x053 & ~x085));
  assign new_n245_ = ~x085 & ((x029 & (~x061 | ~x093)) | (x069 & (x061 | x093)));
  assign new_n246_ = x005 & (~x037 | ~x069 | x085 | (~x109 & x125));
  assign new_n247_ = x037 & ~x085 & (x061 | x093);
  assign new_n248_ = ~x077 & (x053 | x085);
