// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:13 2020
...
module FAU ( 
  ...
  assign z05 = z18 | (x045 & (new_n175_ | ~new_n190_ | (~new_n184_ & x085)));
  ...
  assign z06 = x046 & ~z18 & (new_n192_ | ~new_n208_ | (~new_n201_ & x086));
  ...
  assign z08 = ~x040 & ~z18 & (~new_n218_ | (~new_n210_ & x000));
  ...
  assign new_n255_ = x077 & (x068 | (x013 & ~x045));
  assign z14 = z18 | (~x046 & (new_n257_ | ~new_n271_ | (~new_n266_ & ~x086)));
