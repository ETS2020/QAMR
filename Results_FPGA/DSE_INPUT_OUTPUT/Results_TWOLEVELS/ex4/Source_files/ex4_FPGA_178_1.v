...
module FAU ( 
  ...
  assign new_n186_ = ~x037 & ((~x053 & ~x123) | (x077 & (new_n187_ | new_n188_ | ~x053)));
  assign new_n187_ = x013 & ((~x029 & x085) | (~x005 & x109 & ~x125));
  assign new_n188_ = x085 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n189_ = ~x123 & (~new_n190_ | ~x013);
  ...
  assign z13 = ~x045 & (new_n253_ | new_n257_ | (~x123 & (new_n240_ | new_n255_)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (~x123 & (x053 | (new_n254_ & ~x077))));
