// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:06 2020
...
module FAU ( 
  ...
  assign z00 = x040 & ((~new_n159_ & (x016 | ~x077)) | (~x016 & ~x064 & ~new_n160_ & ~x077));
  assign new_n159_ = (x000 | x080 | ((~x008 | ~x032) & (~x048 | ~x072))) & (x032 | x048) & (x008 | x072);
  assign new_n160_ = (~x008 | ~x048) & (~x032 | ~x072);
  assign z01 = x041 & ~z15 & (new_n163_ | ~new_n164_);
  assign z15 = ~x016 & x077;
  ...
  assign z08 = ~x040 & (new_n231_ | new_n228_ | (~x048 & (new_n213_ | ~new_n217_)));
  ...
  assign new_n217_ = ~new_n227_ & (x072 | (~new_n218_ & ~new_n222_ & (~new_n226_ | ~x064)));
  assign new_n218_ = ~new_n219_ & (x016 ? (new_n220_ | (new_n216_ & ~x008)) : new_n221_);
  assign new_n219_ = ~x096 & ~x120;
  assign new_n220_ = x000 & ((~x064 & ~x088) | (~x032 & ~x056));
  assign new_n221_ = x024 & ~x077 & ~x080 & (~x056 | ~x088);
  assign new_n222_ = x000 & (new_n223_ | (~x077 & (new_n224_ | new_n225_)));
  assign new_n223_ = (x016 ? ~x008 : ~x077) & (x024 | x056 | x088);
  assign new_n224_ = ~x016 & ((~x064 & x096) | (~x112 & x120));
  assign new_n225_ = ~x032 & ~x088 & x096;
  assign new_n226_ = ~x077 & ~x080 & ((~x016 & x024) | x056 | x088);
  assign new_n227_ = ~x008 & x016 & x064;
  assign new_n228_ = ~x072 & ((~new_n229_ & x032) | (x016 & ~x032 & x064));
  assign new_n229_ = (x008 | (~new_n230_ & (~x016 | ~x024 | x080))) & (x077 | x080 | x016 | ~x024);
  assign new_n230_ = x000 & ~x077 & ~x104 & x120;
  assign new_n231_ = ~z15 & (new_n232_ | new_n233_ | (x008 & x072));
  assign new_n232_ = x000 & x080 & ((~x048 & ~x072) | (~x008 & ~x032));
  assign new_n233_ = x032 & (x048 | (~x072 & ~x080 & (x056 | x088)));
  assign z09 = ~x041 & ~z15 & (new_n235_ | ~new_n236_);
  assign new_n235_ = x001 & x081 & ((~x049 & ~x073) | (~x009 & ~x033));
  assign new_n236_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = z15 | (~x042 & (new_n238_ | ~new_n239_));
  assign new_n238_ = x002 & x082 & ((~x050 & ~x074) | (~x010 & ~x034));
  assign new_n239_ = (~x018 | ~x066 | ((x010 | x050) & (x034 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = ~x043 & ~z15 & (new_n241_ | ~new_n242_);
  assign new_n241_ = x003 & x083 & ((~x051 & ~x075) | (~x011 & ~x035));
  assign new_n242_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = z15 | (~x044 & (new_n244_ | ~new_n245_));
  assign new_n244_ = x004 & x084 & ((~x052 & ~x076) | (~x012 & ~x036));
  assign new_n245_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & (new_n258_ | new_n261_ | (~x077 & (new_n247_ | ~new_n263_)));
  assign new_n247_ = ~x053 & (new_n248_ | new_n250_ | new_n252_ | new_n254_ | new_n256_);
  assign new_n248_ = (x109 | x117) & (new_n249_ | (x005 & (~x037 | ~x069)));
  assign new_n249_ = ~x085 & (x013 | x021 | (x029 & (~x061 | ~x093)));
  assign new_n250_ = ~new_n251_ & ~x037;
  assign new_n251_ = (~x029 | ~x069 | x085) & (~x005 | x061 | ~x101);
  assign new_n252_ = ~new_n253_ & (x061 | x093);
  assign new_n253_ = (~x069 | x085) & (~x005 | (x013 & x021));
  assign new_n254_ = (x101 | x125) & (new_n255_ | (x005 & ~x069 & ~x093));
  assign new_n255_ = x029 & ~x085 & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n256_ = x005 & (~new_n257_ | (~x021 & (x029 | (~x117 & x125))));
  assign new_n257_ = (x013 | ~x029) & ~x085 & (x061 | ~x093 | ~x125);
  assign new_n258_ = x037 & ((x016 & x053) | (~x077 & (new_n259_ | new_n260_ | x053)));
  assign new_n259_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n260_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n261_ = x016 & x077 & (~new_n262_ | x013);
  assign new_n262_ = (~x005 | x037 | ~x085) & (~x021 | x053 | ~x069);
  assign new_n263_ = (x013 | ((~x021 | ~x069) & (~x005 | ~x085))) & (~x021 | x037 | ~x069);
  assign z14 = ~x046 & ~z15 & (new_n265_ | ~new_n279_ | (~new_n274_ & ~x086));
  ...
  assign new_n276_ = ~x078 & ((new_n277_ & x030) | (x070 & (~new_n206_ | (~x022 & x030))));
