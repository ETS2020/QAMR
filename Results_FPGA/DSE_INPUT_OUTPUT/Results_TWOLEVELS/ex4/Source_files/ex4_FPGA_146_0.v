// Benchmark "FAU" written by ABC on Sat Aug 22 16:12:30 2020
...
module FAU ( 
  ...
  assign z05 = (~x077 & (~x013 | ~x045)) | (x045 & (~new_n183_ | (~new_n175_ & ~x005)));
  ...
  assign new_n187_ = ~x069 & (~x061 | ~x093 | (~x029 & x037));
  ...
  assign z06 = x046 & ~z16 & (new_n192_ | ~new_n208_ | (~new_n201_ & x086));
  assign new_n192_ = ~x006 & (new_n200_ | ((new_n193_ | new_n199_) & x054));
  ...
  assign new_n251_ = ~x014 & (x078 | (~x022 & (new_n205_ | ~x030)));
  assign new_n252_ = ~x078 & ((new_n253_ & x030) | (x070 & (~new_n203_ | (~x022 & x030))));
  assign new_n253_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n254_ = x038 & ~x078 & (~new_n203_ | (x030 & (~x014 | ~x022)));
