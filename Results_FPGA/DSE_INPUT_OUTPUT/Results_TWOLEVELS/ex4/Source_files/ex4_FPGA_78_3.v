// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:49 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (~x031 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((~x031 & (~x053 | (new_n189_ & x077))) | (~x053 & ~x077));
  ...
  assign new_n258_ = x077 & (x031 | (x013 & ~x045));
