...
module FAU ( 
  ...
  assign z08 = ~x040 & (new_n215_ | new_n228_ | (~z07 & (~new_n211_ | new_n230_)));
  ...
  assign new_n215_ = ~x048 & (new_n216_ | new_n227_ | (x114 & (new_n220_ | new_n225_)));
  assign new_n216_ = ~new_n217_ & ((~x072 & (new_n218_ | (~new_n219_ & ~x080))) | (x008 & ~x080));
  assign new_n217_ = ~x104 & (~x112 | ~x114);
  assign new_n218_ = x000 & (~x032 | ~x064);
  assign new_n219_ = ~x016 & (~x024 | (x056 & x088));
  assign new_n220_ = x000 & (new_n224_ | (~x072 & (new_n221_ | new_n222_ | ~new_n223_)));
  assign new_n221_ = (~x008 | ~x016) & (x024 | x056 | x088);
  assign new_n222_ = ~x064 & ~x088 & (x096 | x120);
  assign new_n223_ = (x032 | x056 | ~x096) & (x016 | x104 | ~x120);
  assign new_n224_ = ~x056 & x120 & x008 & ~x032;
  assign new_n225_ = x024 & ~x072 & ~x080 & (new_n226_ | (~x016 & x064));
  assign new_n226_ = (x096 | x120) & (~x008 | ~x016) & (~x056 | ~x088);
  assign new_n227_ = x000 & ~x072 & x104 & ~x112 & x120;
  assign new_n228_ = new_n229_ & x024;
  assign new_n229_ = x032 & ~x072 & ~x080 & x114 & (~x008 | ~x016);
  assign new_n230_ = x000 & x080 & ((~x008 & ~x032) | (~x048 & ~x072));
  ...
  assign z13 = z07 | (~x045 & (new_n244_ | ~new_n258_ | (~new_n253_ & ~x085)));
  assign new_n244_ = x005 & (new_n252_ | (~x053 & (new_n245_ | new_n251_)));
  assign new_n245_ = ~x077 & (new_n246_ | new_n247_ | new_n248_ | new_n249_ | ~new_n250_);
  assign new_n246_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n247_ = ~x069 & ((~x093 & (x101 | x125)) | x109 | x117);
  assign new_n248_ = x117 & (~x037 | (~x109 & x125));
  assign new_n249_ = ~x037 & (x109 | (~x061 & x101));
  assign new_n250_ = ~x085 & (x021 | x117 | ~x125);
  assign new_n251_ = ~x061 & x125 & x013 & ~x037;
  assign new_n252_ = ~x013 & ~x037 & x085;
  assign new_n253_ = ~new_n257_ & (x053 | (~new_n255_ & (new_n254_ | (~x109 & ~x117))));
  assign new_n254_ = ~x013 & (x077 | (~x021 & (new_n188_ | ~x029)));
  assign new_n255_ = ~x077 & ((x069 & (~new_n186_ | (~x021 & x029))) | (new_n256_ & x029));
  assign new_n256_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n257_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n263_ = ~x070 & ((~x094 & (x102 | x126)) | x110 | x118);
  ...
  assign new_n271_ = ~x078 & ((x070 & (~new_n204_ | (~x022 & x030))) | (new_n272_ & x030));
