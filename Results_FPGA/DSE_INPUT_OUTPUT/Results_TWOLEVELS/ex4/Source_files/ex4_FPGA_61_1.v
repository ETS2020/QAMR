// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:29 2020
...
module FAU ( 
  ...
  assign z06 = x046 & ~z18 & (new_n191_ | ~new_n207_ | (~new_n200_ & x086));
  ...
  assign z08 = ~x040 & ~z18 & (~new_n217_ | (~new_n209_ & x000));
  ...
  assign new_n245_ = (x021 | (~x029 & (x117 | ~x125))) & new_n247_ & (new_n246_ | ~x125);
  assign new_n246_ = (x061 | ~x093) & (x109 | ~x117);
  assign new_n247_ = ~x085 & (x013 | ~x029);
  assign new_n248_ = (~x029 | ~x069 | x085) & (~x005 | x061 | ~x101);
  assign new_n249_ = (~x021 | ~x069 | (x013 & x037)) & (new_n250_ | x013) & (new_n251_ | ~x037);
  assign new_n250_ = (~x005 | ~x085) & (~x029 | ~x037 | x085);
  assign new_n251_ = ~x053 & (x085 | ((x021 | ~x029) & ~x061 & ~x093));
  assign z14 = ~x046 & ~z18 & (new_n253_ | ~new_n267_ | (~new_n262_ & ~x086));
