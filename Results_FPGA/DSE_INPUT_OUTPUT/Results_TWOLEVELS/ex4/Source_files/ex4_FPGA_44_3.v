// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:09 2020
...
module FAU ( 
  ...
  assign z11 = ~x043 & ((~x091 & (~new_n235_ | (x003 & ~new_n234_ & x083))) | (~new_n235_ & ~x083));
  assign new_n234_ = (x051 | x075) & (x011 | x035);
