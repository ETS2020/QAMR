...
module FAU ( 
  ...
  assign z05 = x045 & (new_n184_ | (x037 & (~new_n183_ | (~new_n175_ & x053))));
  assign new_n175_ = ~new_n176_ & (x005 | x085) & ((~new_n178_ & new_n181_) | ~x077);
  ...
  assign new_n181_ = ~new_n182_ & (x005 | (~x061 & ~x093) | (x101 & x125));
  assign new_n182_ = ~x069 & x085 & (~x029 | ~x061 | ~x093);
  assign new_n183_ = (x021 | x069 | ~x077) & (x005 | ~x013 | x085);
  assign new_n184_ = ~x077 & (~x013 | (~x037 & ~x053) | (~x021 & x053 & ~x069));
  assign z06 = x046 & ~z15 & (new_n186_ | ~new_n202_ | (~new_n195_ & x086));
  ...
  assign z13 = (~new_n233_ & ~x045) | (x077 & (~x037 | (x013 & ~x045)));
  assign new_n233_ = new_n245_ & (x053 | (~new_n234_ & ~new_n237_ & new_n240_));
  assign new_n234_ = (x109 | x117) & (new_n235_ | (~new_n236_ & ~x085));
  assign new_n235_ = x005 & (~x037 | (~x069 & ~x077));
  assign new_n236_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
  assign new_n237_ = (x101 | x125) & (new_n238_ | (new_n239_ & x029));
  assign new_n238_ = x005 & ((~x061 & ~x069 & ~x077) | (~x037 & ~x093));
  assign new_n239_ = ~x077 & ~x085 & (~x061 | ~x093) & (~x013 | ~x021);
  assign new_n240_ = ~new_n244_ & (x077 | (~new_n243_ & ((~new_n241_ & new_n242_) | ~x005)));
  assign new_n241_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n242_ = ~x085 & (~x125 | (x117 ? x109 : x021));
  assign new_n243_ = x069 & ~x085 & (x061 | x093);
  assign new_n244_ = x069 & ~x085 & x029 & ~x037;
  assign new_n245_ = ~new_n246_ & (~x037 | ~x053) & (x077 | (~new_n247_ & (~new_n248_ | ~x037)));
  assign new_n246_ = x021 & x069 & (~x013 | ~x037);
  assign new_n247_ = ~x013 & ((x005 & x085) | (x029 & x037 & ~x085));
  assign new_n248_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign z14 = z15 | (~x046 & (new_n250_ | ~new_n264_ | (~new_n259_ & ~x086)));
  ...
  assign new_n260_ = ~x014 & (x078 | (~x022 & (new_n199_ | ~x030)));
  assign new_n261_ = ~x078 & ((new_n262_ & x030) | (x070 & (~new_n197_ | (~x022 & x030))));
  assign new_n262_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n263_ = x038 & ~x078 & (~new_n197_ | (x030 & (~x014 | ~x022)));
