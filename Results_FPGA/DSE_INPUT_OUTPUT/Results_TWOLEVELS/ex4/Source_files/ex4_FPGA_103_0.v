// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:19 2020
...
module FAU ( 
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (~x053 & x124));
  ...
  assign new_n187_ = x124 & (~new_n188_ | ~x013);
  ...
  assign z11 = z07 | (~x043 & (new_n232_ | ~new_n233_));
  ...
  assign z13 = z07 | (~x045 & (new_n238_ | ~new_n253_ | (~new_n247_ & ~x085)));
  ...
  assign z14 = ~x046 & ~z07 & (new_n255_ | ~new_n269_ | (~new_n264_ & ~x086));
