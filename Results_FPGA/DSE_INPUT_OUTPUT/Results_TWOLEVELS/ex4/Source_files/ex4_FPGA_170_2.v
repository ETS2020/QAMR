...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x008 | (~x013 & x045));
  ...
  assign z08 = ~x040 & (new_n230_ | ~new_n226_ | ((new_n211_ | ~new_n215_) & ~x072));
  ...
  assign new_n230_ = ~z15 & ((new_n231_ & ~x072) | (x032 & x048));
  assign new_n231_ = ~x080 & (x056 | x088) & (x032 | (~x048 & x064));
  assign z09 = z15 | (~x041 & (new_n233_ | ~new_n234_));
  ...
  assign z13 = z15 | (~x045 & (new_n245_ | ~new_n260_ | (~new_n254_ & ~x085)));
  assign new_n245_ = x005 & (new_n253_ | (~x053 & (new_n246_ | new_n252_)));
  ...
  assign new_n252_ = x013 & ~x037 & ~x061 & x125;
  assign new_n253_ = ~x013 & ~x037 & x085;
  assign new_n254_ = ~new_n258_ & (x053 | (~new_n255_ & (new_n259_ | (~x109 & ~x117))));
  assign new_n255_ = ~x077 & ((new_n257_ & x029) | (x069 & (~new_n256_ | (~x021 & x029))));
  assign new_n256_ = ~x061 & ~x093;
  assign new_n257_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n258_ = x037 & ~x077 & (~new_n256_ | (x029 & (~x013 | ~x021)));
  assign new_n259_ = ~x013 & (x077 | (~x021 & (~x029 | (x061 & x093))));
