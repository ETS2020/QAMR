// Benchmark "FAU" written by ABC on Sat Aug 22 16:12:48 2020
...
module FAU ( 
  ...
  assign z03 = x043 & (new_n169_ | ~new_n170_);
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (x043 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((x043 & (~x053 | (new_n189_ & x077))) | (~x053 & ~x077));
  ...
  assign z11 = ~x043 & ~x077 & (new_n236_ | ~new_n237_);
  ...
  assign new_n258_ = x077 & (~x043 | (x013 & ~x045));
