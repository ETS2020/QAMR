...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (x119 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((~x053 & ~x077) | (x119 & (~x053 | (new_n189_ & x077))));
  ...
  assign z10 = ~x042 & ~z16 & (new_n233_ | ~new_n234_);
  ...
  assign z12 = z16 | (~x044 & (new_n239_ | ~new_n240_));
  ...
  assign new_n258_ = x077 & (~x119 | (x013 & ~x045));
