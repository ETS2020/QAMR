// Benchmark "FAU" written by ABC on Sat Aug 22 16:12:56 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (~x114 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((~x053 & ~x077) | (~x114 & (~x053 | (new_n189_ & x077))));
  ...
  assign new_n254_ = x037 & ((~x077 & (new_n255_ | x053)) | (x053 & ~x114));
  assign new_n255_ = ~x085 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n256_ = ~x114 & (~new_n257_ | x013);
