...
module FAU ( 
  ...
  assign z05 = new_n190_ | (x045 & (new_n175_ | ~new_n191_ | (~new_n182_ & x085)));
  assign new_n175_ = ~x005 & ((~new_n176_ & x053) | (x013 & x037 & ~x085));
  assign new_n176_ = new_n181_ & (~x077 | (~new_n177_ & ~new_n178_ & ~new_n179_ & new_n180_));
  assign new_n177_ = (x013 | x021) & (~x029 | ~x061 | ~x093);
  assign new_n178_ = x037 & (~x109 | (x061 & ~x101));
  assign new_n179_ = x069 & (~x109 | (x093 & (~x101 | ~x125)));
  assign new_n180_ = x085 & (x125 | (x109 ? ~x021 : ~x117));
  assign new_n181_ = (~x037 | (x117 & (x013 | ~x061 | x125))) & (~x069 | x117);
  assign new_n182_ = ~new_n187_ & (~x053 | (~new_n189_ & ~new_n183_ & (new_n185_ | ~x077)));
  assign new_n183_ = (~x117 | (x077 & ~x109)) & (~x021 | (~new_n184_ & ~x029));
  assign new_n184_ = ~x061 & ~x093;
  assign new_n185_ = (x069 | ((~x021 | x029) & x061 & x093)) & (~new_n186_ | x029);
  assign new_n186_ = (~x101 | ~x125) & (x061 | x093) & (x013 | x021);
  assign new_n187_ = new_n188_ & ~x037;
  assign new_n188_ = x077 & (~x061 | ~x093 | (~x029 & (x013 | x021)));
  assign new_n189_ = ~x013 & (~x109 | ~x117);
  assign new_n190_ = ~x077 & (~x117 | (~x013 & x045));
  assign new_n191_ = (x021 | x069 | ((~x013 | ~x053) & (~x037 | ~x077))) & (x037 | x053);
  ...
  assign z13 = ~x045 & (new_n246_ | (~new_n240_ & x117) | (~new_n247_ & x077));
  assign new_n240_ = (~x037 | ~x053) & (x077 | (~new_n244_ & new_n241_ & ~new_n245_));
  assign new_n241_ = (x053 | (~new_n243_ & (new_n242_ | x085))) & (~x037 | new_n184_ | x085);
  assign new_n242_ = (~x029 | (x061 & x093)) & (~x069 | (~x061 & ~x093));
  assign new_n243_ = x005 & (~x037 | ~x069 | x085 | (~x109 & x125));
  assign new_n244_ = ~x013 & ((x021 & x069) | (x005 & x085));
  assign new_n245_ = x021 & ((~x037 & x069) | (~x053 & ~x085));
  assign new_n246_ = x013 & (x077 | (~x053 & ~x085 & x117));
