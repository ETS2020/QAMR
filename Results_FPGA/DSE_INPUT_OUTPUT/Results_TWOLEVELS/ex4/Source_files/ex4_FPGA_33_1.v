// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:56 2020
...
module FAU ( 
  ...
  assign new_n191_ = ~x077 & (x115 | (~x013 & x045));
  ...
  assign z08 = z15 | (~x040 & (~new_n219_ | (~new_n211_ & x000)));
  ...
  assign new_n253_ = x037 & ((x053 & x077) | (~x115 & (x053 | (new_n254_ & ~x077))));
