// Benchmark "FAU" written by ABC on Sat Aug 22 16:14:52 2020
...
module FAU ( 
  ...
  assign new_n251_ = x037 & ((~x077 & (new_n252_ | new_n253_ | x053)) | (~x018 & x053));
  assign new_n252_ = ~x013 & ((x029 & ~x085) | (x005 & ~x109 & x125));
  assign new_n253_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n254_ = ~x018 & x077 & (~new_n255_ | x013);
