// Benchmark "FAU" written by ABC on Sat Aug 22 16:10:11 2020
...
module FAU ( 
  ...
  assign z02 = x042 & ((~new_n168_ & x010) | new_n169_ | (~new_n166_ & x077));
  assign new_n166_ = new_n167_ & (x002 | x082 | (x074 ? ~x050 : ~x034));
  assign new_n167_ = (x010 | x074) & (x018 | ~x034 | x066 | ~x074);
  assign new_n168_ = (x018 | ~x050 | x066 | ~x077) & (x002 | x050 | x082);
  assign new_n169_ = ~x050 & (~x034 | (~x010 & ~x074) | (~x018 & ~x066 & x074));
  assign z03 = x043 & ~z15 & (new_n171_ | ~new_n172_);
  assign new_n171_ = ~x003 & ~x083 & ((x011 & x035) | (x051 & x075));
  assign new_n172_ = (x019 | x067 | ((~x011 | ~x051) & (~x035 | ~x075))) & (x035 | x051) & (x011 | x075);
  assign z04 = x044 & ~z15 & (new_n174_ | ~new_n175_);
  ...
  assign new_n177_ = ~x037 & ((~x050 & ~x053) | (x077 & (new_n178_ | ~x053)));
  ...
  assign new_n189_ = ~x050 & ~x077 & (~new_n190_ | ~x013);
  ...
  assign z10 = ~x042 & ((x010 & ~z15 & x074) | ~new_n231_ | (~new_n234_ & ~x010));
  assign new_n231_ = x050 ? ~new_n233_ : new_n232_;
  assign new_n232_ = (~x002 | ~x082 | (x034 & x074)) & (~x018 | x034 | ~x066);
  assign new_n233_ = x077 & (x034 | (x018 & x066 & ~x074));
  assign new_n234_ = (~x018 | x050 | ~x066) & (~x077 | ~x082 | ~x002 | ~x050);
  ...
  assign z13 = ~x045 & (new_n255_ | new_n259_ | (~x050 & (new_n242_ | new_n257_)));
  ...
  assign new_n255_ = x037 & ((x053 & x077) | (~x050 & (x053 | (new_n256_ & ~x077))));
  ...
  assign z14 = ~x046 & ~z15 & (new_n262_ | ~new_n276_ | (~new_n271_ & ~x086));
  ...
  assign new_n272_ = ~x014 & (x078 | (~x022 & (new_n206_ | ~x030)));
  assign new_n273_ = ~x078 & ((new_n274_ & x030) | (x070 & (~new_n204_ | (~x022 & x030))));
  assign new_n274_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n275_ = x038 & ~x078 & (~new_n204_ | (x030 & (~x014 | ~x022)));
