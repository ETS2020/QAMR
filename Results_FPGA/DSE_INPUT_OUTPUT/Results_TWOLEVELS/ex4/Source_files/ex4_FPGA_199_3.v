...
module FAU ( 
  ...
  assign z09 = ~x041 & ((x009 & ~z07 & x073) | ~new_n229_ | (~new_n227_ & ~x009));
  assign new_n227_ = ~new_n228_ & (~x001 | x033 | ~x081);
  assign new_n228_ = x065 & ~x077 & x017 & ~x049;
  assign new_n229_ = new_n231_ & (x049 | (~new_n230_ & (~x017 | x033 | ~x065)));
  assign new_n230_ = x001 & x081 & (~x033 | (~x073 & ~x077));
  assign new_n231_ = (~x033 | ~x049 | x077) & (~x017 | x033 | ~x065 | x073);
