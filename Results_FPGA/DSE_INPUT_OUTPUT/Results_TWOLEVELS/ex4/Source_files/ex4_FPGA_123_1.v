// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:43 2020
...
module FAU ( 
  ...
  assign new_n186_ = ~x037 & ((~x053 & ~x119) | (x077 & (new_n187_ | new_n188_ | ~x053)));
  assign new_n187_ = x013 & ((~x029 & x085) | (~x005 & x109 & ~x125));
  assign new_n188_ = x085 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n189_ = ~x119 & (~new_n190_ | ~x013);
  ...
  assign z08 = z16 | (~x040 & (~new_n219_ | (~new_n211_ & x000)));
  ...
  assign z09 = z16 | (~x041 & (new_n228_ | ~new_n229_));
  ...
  assign z13 = z16 | (~x045 & (new_n240_ | ~new_n255_ | (~new_n249_ & ~x085)));
  ...
  assign z14 = ~x046 & ~z16 & (new_n257_ | ~new_n271_ | (~new_n266_ & ~x086));
  ...
  assign new_n259_ = (x030 | x062 | x094) & (~x014 | ~x022);
