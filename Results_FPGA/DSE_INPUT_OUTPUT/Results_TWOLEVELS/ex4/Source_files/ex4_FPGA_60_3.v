...
module FAU ( 
  ...
  assign z06 = x046 & ~z16 & (new_n178_ | ~new_n194_ | (~new_n187_ & x086));
  ...
  assign z08 = z16 | (~x040 & (~new_n204_ | (~new_n196_ & x000)));
  ...
  assign new_n233_ = ~new_n237_ & (x053 | (~new_n234_ & (new_n238_ | (~x109 & ~x117))));
  assign new_n234_ = ~x077 & ((new_n236_ & x029) | (x069 & (~new_n235_ | (~x021 & x029))));
  assign new_n235_ = ~x061 & ~x093;
  assign new_n236_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n237_ = x037 & ~x077 & (~new_n235_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n251_ = ~x014 & (x078 | (~x022 & (new_n191_ | ~x030)));
  assign new_n252_ = ~x078 & ((new_n253_ & x030) | (x070 & (~new_n189_ | (~x022 & x030))));
  assign new_n253_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n254_ = x038 & ~x078 & (~new_n189_ | (x030 & (~x014 | ~x022)));
