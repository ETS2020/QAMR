...
module FAU ( 
  ...
  assign z14 = ~x046 & (new_n274_ | new_n260_ | (~x070 & ~new_n268_ & ~x078));
  assign new_n260_ = x077 & (new_n261_ | (~x078 & (new_n267_ | (~new_n263_ & ~x054))));
  assign new_n261_ = ~x014 & (new_n262_ | (x022 & ~x054 & x070));
  assign new_n262_ = ~x078 & ~x110 & x126 & x006 & x038;
  assign new_n263_ = (new_n265_ | x022) & ~new_n266_ & (~x070 | new_n264_ | x086);
  assign new_n264_ = ~x062 & ~x094;
  assign new_n265_ = (~x030 | ~x070 | x086) & (~x006 | x118 | ~x126);
  assign new_n266_ = x006 & ~x038 & ((~x094 & x102) | x110 | x118);
  assign new_n267_ = x022 & ~x038 & x070;
  assign new_n268_ = ~new_n272_ & (x054 | (new_n269_ & (new_n273_ | (~x110 & ~x118))));
  assign new_n269_ = (~new_n271_ | ~x006) & (new_n270_ | ((new_n264_ | ~x006) & (~x030 | (~x006 & (~new_n271_ | x086)))));
  assign new_n270_ = x014 & x022;
  assign new_n271_ = (x102 | x126) & (~x062 | ~x094);
  assign new_n272_ = x038 & ~x086 & (~new_n264_ | (~new_n270_ & x030));
  assign new_n273_ = ~x006 & (x086 | (~x022 & (~x030 | (x062 & x094))));
  assign new_n274_ = ~z07 & (new_n275_ | new_n276_ | (x038 & x054));
  assign new_n275_ = x006 & x086 & ((~x054 & ~x078) | (~x014 & ~x038));
  assign new_n276_ = x014 & (x078 | (~x054 & ~x086 & (x110 | x118)));
  assign z17 = 1'b0;
  assign z20 = 1'b0;
  assign z23 = 1'b0;
  assign z27 = 1'b0;
