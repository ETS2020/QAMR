// Benchmark "FAU" written by ABC on Sat Aug 22 16:11:41 2020
...
module FAU ( 
  ...
  assign z02 = x042 & ((~new_n166_ & (~x066 | x077)) | (~x018 & ~new_n167_ & ~x066));
  assign new_n166_ = (x002 | x082 | ((~x010 | ~x034) & (~x050 | ~x074))) & (x034 | x050) & (x010 | x074);
  assign new_n167_ = (~x010 | ~x050) & (~x034 | ~x074);
  ...
  assign z05 = x045 & (new_n175_ | new_n187_ | (x077 & (new_n178_ | ~new_n189_)));
  assign new_n175_ = ~x037 & ((~x053 & ~x066) | (x077 & (new_n176_ | ~x053)));
  ...
  assign new_n182_ = ~x029 & x085 & (x061 | x093) & (x013 | x021);
  ...
  assign z08 = ~x040 & ~z15 & (~new_n217_ | (~new_n209_ & x000));
  ...
  assign z09 = z15 | (~x041 & (new_n226_ | ~new_n227_));
  assign new_n226_ = x001 & x081 & ((~x009 & ~x033) | (~x049 & ~x073));
  assign new_n227_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = ~x042 & ((~new_n229_ & (~x066 | x077)) | (x018 & x066 & ~new_n230_ & x077));
  assign new_n229_ = (~x002 | ~x082 | ((x010 | x034) & (x050 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign new_n230_ = (x010 | x050) & (x034 | x074);
  assign z11 = z15 | (~x043 & (new_n232_ | ~new_n233_));
  assign new_n232_ = x003 & x083 & ((~x011 & ~x035) | (~x051 & ~x075));
  assign new_n233_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = z15 | (~x044 & (new_n235_ | ~new_n236_));
  assign new_n235_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign new_n236_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & (new_n251_ | new_n255_ | (~x066 & (new_n238_ | new_n253_)));
  assign new_n238_ = ~x077 & (new_n245_ | new_n250_ | (x005 & (new_n239_ | new_n249_)));
  assign new_n239_ = ~x053 & (new_n240_ | new_n241_ | new_n242_ | new_n243_ | ~new_n244_);
  ...
  assign new_n245_ = ~x053 & ~x085 & (new_n246_ | new_n247_ | (new_n248_ & x029));
  assign new_n246_ = (x109 | x117) & (x021 | (x029 & (~x061 | ~x093)));
  assign new_n247_ = x069 & ((~x021 & x029) | x061 | x093);
  assign new_n248_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n249_ = ~x013 & x085;
  assign new_n250_ = x021 & x069 & (~x013 | ~x037);
  assign new_n251_ = x037 & ((~x066 & (x053 | (new_n252_ & ~x077))) | (x053 & x077));
  assign new_n252_ = ~x085 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n253_ = x013 & ~x053 & (new_n254_ | (~x085 & (x109 | x117)));
  assign new_n254_ = x005 & ~x037 & ~x061 & x125;
  assign new_n255_ = x077 & (~new_n256_ | x013);
  assign new_n256_ = (~x021 | x053 | ~x069) & (~x005 | x037 | ~x085);
  assign z14 = ~x046 & ~z15 & (new_n258_ | ~new_n272_ | (~new_n267_ & ~x086));
  assign new_n258_ = x006 & (new_n266_ | (~x054 & (new_n259_ | new_n265_)));
  assign new_n259_ = ~x078 & (new_n260_ | new_n261_ | new_n262_ | new_n263_ | ~new_n264_);
  ...
  assign new_n265_ = x014 & ~x038 & ~x062 & x126;
  assign new_n266_ = ~x014 & ~x038 & x086;
  assign new_n267_ = ~new_n271_ & (x054 | (~new_n269_ & (new_n268_ | (~x110 & ~x118))));
  assign new_n268_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n269_ = ~x078 & ((new_n270_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n270_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n271_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
  assign new_n272_ = (~x022 | ~x070 | ((x014 | x054) & (x038 | x078))) & (~x038 | ~x054) & (~x014 | ~x078);
  assign z07 = 1'b0;
  assign z16 = 1'b0;
  assign z19 = 1'b0;
  assign z21 = 1'b0;
