// Benchmark "FAU" written by ABC on Sat Aug 22 16:09:32 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n188_ | new_n192_ | (x007 & (new_n175_ | new_n190_)));
  ...
  assign new_n188_ = ~x037 & ((x007 & (~x053 | (new_n189_ & x077))) | (~x053 & ~x077));
  ...
  assign z06 = x046 & ~z17 & (new_n195_ | ~new_n211_ | (~new_n204_ & x086));
  ...
  assign new_n258_ = x077 & (~x007 | (x013 & ~x045));
