...
module FAU ( 
  ...
  assign z04 = x044 & (new_n172_ | ~new_n173_);
  ...
  assign new_n175_ = ~x037 & ((x077 & (new_n176_ | ~x053)) | (x044 & ~x053));
  ...
  assign z12 = ~x044 & (~new_n235_ | new_n237_);
  assign new_n235_ = ~new_n236_ & (~x036 | ~x052) & x077 & (~x012 | ~x076);
  assign new_n236_ = x020 & x068 & ((~x012 & ~x052) | (~x036 & ~x076));
  assign new_n237_ = x004 & x084 & ((~x012 & ~x036) | (~x052 & ~x076));
  assign z13 = ~x045 & (new_n252_ | new_n256_ | (x044 & (new_n239_ | new_n254_)));
  assign new_n239_ = ~x077 & ((x005 & (new_n240_ | new_n250_)) | new_n246_ | new_n251_);
  assign new_n240_ = ~x053 & (new_n241_ | new_n242_ | new_n243_ | new_n244_ | ~new_n245_);
  ...
  assign new_n246_ = ~x053 & ~x085 & (new_n247_ | new_n248_ | (new_n249_ & x029));
  assign new_n247_ = (x109 | x117) & (x021 | (x029 & (~x061 | ~x093)));
  assign new_n248_ = x069 & ((~x021 & x029) | x061 | x093);
  assign new_n249_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n250_ = ~x013 & x085;
  assign new_n251_ = x021 & x069 & (~x013 | ~x037);
  assign new_n252_ = x037 & ((x053 & x077) | (x044 & (x053 | (new_n253_ & ~x077))));
  assign new_n253_ = ~x085 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n254_ = x013 & ~x053 & (new_n255_ | (~x085 & (x109 | x117)));
  assign new_n255_ = ~x061 & x125 & x005 & ~x037;
  assign new_n256_ = x077 & (~new_n257_ | x013);
  assign new_n257_ = (~x021 | x053 | ~x069) & (~x005 | x037 | ~x085);
  ...
  assign new_n269_ = ~x014 & (x078 | (~x022 & (new_n204_ | ~x030)));
  assign new_n270_ = ~x078 & ((new_n271_ & x030) | (x070 & (~new_n202_ | (~x022 & x030))));
  assign new_n271_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n272_ = x038 & ~x078 & (~new_n202_ | (x030 & (~x014 | ~x022)));
