...
module FAU ( 
  ...
  assign z06 = (~x005 & x086) | (x046 & (new_n193_ | ~new_n209_ | (~new_n202_ & x086)));
  ...
  assign z13 = (~x005 & x086) | (~x045 & (~new_n248_ | (~new_n240_ & x005)));
  ...
  assign new_n248_ = new_n254_ & (x077 | (~new_n250_ & (new_n249_ | ~x069)));
  assign new_n249_ = (x037 | (~x021 & (~x029 | x053 | x085))) & (x053 | new_n186_ | x085);
  assign new_n250_ = ~x085 & (new_n253_ | (~x053 & (new_n251_ | (new_n252_ & x029))));
  assign new_n251_ = (x109 | x117) & (x021 | (x029 & (~x061 | ~x093)));
  assign new_n252_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n253_ = x037 & (x061 | x093 | (x029 & (~x013 | ~x021)));
  assign new_n254_ = (new_n255_ | ~x013) & (~x037 | ~x053) & (x013 | ~x021 | x053 | ~x069);
  assign new_n255_ = ~x077 & (x053 | x085 | (~x109 & ~x117));
  assign z14 = ~x046 & ((~new_n271_ & (x005 | ~x086)) | new_n257_ | (~new_n266_ & ~x086));
  assign new_n257_ = x006 & (new_n264_ | (~x054 & ~x086 & (new_n258_ | new_n265_)));
  ...
  assign new_n263_ = ~x022 & ~x118 & x126;
  assign new_n264_ = x005 & x086 & ((~x014 & ~x038) | (~x054 & ~x078));
