...
module FAU ( 
  ...
  assign z13 = ~x00 & (~x08 | (~x01 & ~x02 & x17 & ~x19));
  assign z14 = ~x00 & (~x08 | (new_n77_ & ~x01 & ~x02 & ~x09));
  assign new_n77_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x08 & x19);
