...
module FAU ( 
  ...
  assign new_n58_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x17);
  assign z08 = ~x01 & x17;
  ...
  assign new_n67_ = x20 & ~x21 & ~x22 & x15 & x16 & ~x17;
  assign z11 = ~x00 & ~x22 & (new_n69_ | (new_n61_ & new_n70_));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n70_ = ~x14 & x15 & ~x16 & ~x17 & x20 & ~x21;
  assign z12 = z08 | (x09 & ~new_n72_ & ~x24);
  assign new_n72_ = x00 ? (~x01 | (x02 & x10)) : (x01 | ~x23 | (~x02 & ~x19));
