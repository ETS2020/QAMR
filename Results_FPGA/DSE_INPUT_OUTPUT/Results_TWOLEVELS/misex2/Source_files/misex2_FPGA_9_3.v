...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_, new_n58_,
  ...
  assign new_n58_ = ~x12 & (x09 | ~x10 | x12 | ~x00 | ~x01 | ~x02);
  assign z07 = new_n60_ & x00;
  assign new_n60_ = x02 & ((~x01 & (~x11 | ~x12)) | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = ~x00 & ~x01 & new_n62_ & x02;
  assign new_n62_ = ~x03 & x04 & ~x05 & ~x06 & new_n63_ & ~x07;
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (~x11 | ~x12);
  ...
  assign new_n73_ = new_n66_ & ~x16 & x20 & ~x21 & ~x14 & x15;
