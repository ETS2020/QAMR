...
module FAU ( 
  ...
  assign z03 = (x01 & (~x08 | (new_n51_ & x00 & x02 & x08))) | (new_n52_ & ~x00 & ~x01 & ~x02);
  ...
  assign new_n57_ = x01 & x02 & x08 & ~x09 & x10 & x11;
  assign z07 = (x00 & x02 & (~x01 | (new_n59_ & x01 & x08 & ~x09))) | (x01 & ~x08);
  assign new_n59_ = x10 & x11 & ~x12;
  assign z08 = ~x08 & (new_n61_ | x01);
  ...
  assign z11 = (x01 & ~x08) | (~x00 & ~x22 & (new_n72_ | new_n73_));
  ...
  assign z14 = (x01 & ~x08) | (new_n79_ & ~x00 & ~x01 & ~x02 & ~x09);
