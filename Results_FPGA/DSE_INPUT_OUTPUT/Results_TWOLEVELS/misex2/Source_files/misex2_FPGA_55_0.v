...
module FAU ( 
  ...
  assign z06 = new_n47_ | (x00 & x01 & new_n58_ & x02);
  assign new_n58_ = ~x09 & x10 & x11 & (~x12 | (~new_n47_ & x12));
  assign z07 = new_n47_ | (new_n60_ & x00);
  assign new_n60_ = x02 & (~x01 | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = ~x05 & (new_n62_ | ~x13);
  assign new_n62_ = new_n63_ & ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n63_ = x17 & ~x18 & x19 & ~x06 & ~x07 & ~x08;
  ...
  assign new_n70_ = ~x01 & x02 & x05 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n47_ | (~x00 & ~x22 & (new_n73_ | (new_n74_ & new_n75_)));
  ...
  assign z14 = new_n47_ | (new_n81_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n81_ = ~x10 & ~x17 & ~x18 & ~x19;
