...
module FAU ( 
  ...
  assign z09 = ~x22 & (x20 | (new_n65_ & x18 & ~x19 & ~x21));
  assign new_n65_ = ~x00 & x01;
  assign z10 = (x20 & ~x22) | (new_n67_ & ~x19 & ~x20 & x21 & x22);
  assign new_n67_ = ~x00 & x01 & x18;
  assign z11 = ~x22 & x21 & ~x20 & ~x19 & new_n65_ & x18;
