...
module FAU ( 
  ...
  assign z06 = (~x01 & ~x06) | (x00 & new_n58_ & x01);
  ...
  assign new_n63_ = ~x01 & x02 & x06 & ~x11 & x12;
  ...
  assign new_n68_ = ~x01 & x02 & x06 & ~x11 & x12 & ~x13;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = z08 | (~x00 & ~x22 & (new_n71_ | (new_n72_ & new_n73_)));
  ...
  assign new_n76_ = ~x01 & x06 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (~x06 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x06))) | (~x01 & ~x02 & x06 & x19);
