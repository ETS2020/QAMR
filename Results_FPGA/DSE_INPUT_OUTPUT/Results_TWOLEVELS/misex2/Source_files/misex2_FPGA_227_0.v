...
module FAU ( 
  ...
  assign new_n60_ = ~x01 & x02 & x06 & ~x11 & x12;
  assign new_n61_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n62_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = new_n64_ | (~x00 & (new_n65_ | (new_n66_ & new_n67_)));
  ...
  assign z11 = ~x00 & ~x22 & (new_n69_ | (new_n60_ & new_n70_));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n70_ = ~x13 & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = new_n64_ | (x09 & ~x24 & (x00 ? new_n72_ : new_n73_));
  assign new_n72_ = x01 & (~x02 | ~x10);
  assign new_n73_ = ~x01 & ((x23 & (x02 | (x06 & x19))) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (~x06 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & new_n76_ & ~x17;
  assign new_n76_ = ~x10 & ~x09 & x06 & ~x02 & ~x00 & ~x01;
