// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:19 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n61_,
    ...
    new_n72_;
  assign z00 = ~x01 & (x19 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18;
  assign z01 = ~x01 & (x19 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & x09;
  assign new_n49_ = ~x02 & ~x00 & ~x01;
  assign z03 = (~x01 & (x19 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  ...
  assign new_n58_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x19);
  assign z08 = ~x01 & x19;
  ...
  assign z10 = ~x00 & ~x19 & (new_n65_ | (new_n66_ & new_n67_));
  assign new_n65_ = x01 & x18 & ~x20 & x21 & x22;
  ...
  assign z12 = z08 | (x09 & ~new_n72_ & ~x24);
  assign new_n72_ = x00 ? (~x01 | (x02 & x10)) : (x01 | (x02 ? ~x23 : ~x17));
  assign z13 = ~x19 & new_n49_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & ~x09;
  assign z15 = x00 & ((~x02 & ~x19) | (x01 & (~x02 | ~x10)));
  assign z16 = ~x00 & x01;
  assign z17 = ~x01 & (x19 | (~x00 & x02));
endmodule
