...
module FAU ( 
  ...
  assign new_n65_ = (~new_n66_ | ~x01) & (~new_n67_ | x11 | ~x12 | x01 | ~x02);
  assign new_n66_ = x18 & ~x19 & ~x20 & (x07 | ~x14);
  ...
  assign new_n80_ = ~x10 & ~x17 & ~x18 & ~new_n47_ & ~x19;
