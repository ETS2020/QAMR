...
module FAU ( 
  ...
  assign z02 = (x17 & x20) | (new_n49_ & ~x10 & ~x17 & ~x18 & ~x19);
  ...
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (~x17 | ~x20);
  assign z07 = new_n51_ | (new_n60_ & x00);
  assign new_n60_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = x17 & (x20 | (new_n62_ & new_n63_));
  ...
  assign z11 = new_n51_ | (~x00 & ~x22 & (new_n73_ | (new_n65_ & new_n74_)));
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n74_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n76_ & x01) : (~new_n77_ & ~x01));
  assign new_n76_ = (~x02 | ~x10) & (~x17 | ~x20);
  assign new_n77_ = x17 ? (x20 | (~x23 & (x02 | x19))) : (~x23 | (~x02 & ~x19));
  assign z13 = ~x20 & ~x19 & new_n46_ & x17;
