// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:26 2020
...
module FAU ( 
  ...
  assign new_n74_ = x18 & ~x19 & ~x20 & ~new_n46_ & x21;
  assign new_n75_ = new_n71_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (new_n78_ | (~new_n46_ & ~new_n77_));
  assign new_n77_ = (~x00 | ~x01 | (x02 & x10)) & (x00 | x01 | x02 | ~x17 | x19);
  assign new_n78_ = ~x00 & ~x01 & ~x16 & x23 & (x02 | x19);
