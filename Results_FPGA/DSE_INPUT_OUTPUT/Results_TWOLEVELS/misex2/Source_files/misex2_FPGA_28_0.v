...
module FAU ( 
  ...
  assign z02 = ~x01 & (~x14 | (new_n49_ & ~x00 & ~x02 & x09));
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02);
  assign new_n51_ = x14 & ~x17 & x18 & ~x19;
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & ~x14) | (new_n54_ & x00 & x01 & x02);
  assign new_n54_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = (~x01 & ~x14) | (x02 & x09 & x10 & x00 & x01);
  assign z06 = (~x01 & ~x14) | (x00 & new_n57_ & x01);
