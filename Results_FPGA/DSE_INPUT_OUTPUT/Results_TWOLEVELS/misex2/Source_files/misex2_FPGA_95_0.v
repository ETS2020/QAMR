...
module FAU ( 
  ...
  assign z03 = (~x01 & (~x08 | (new_n50_ & ~x00 & ~x02))) | (new_n51_ & x00 & x01 & x02);
  ...
  assign z06 = (~x01 & ~x08) | (x00 & new_n56_ & x01);
  assign new_n56_ = x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n58_ & x02;
  assign new_n58_ = (x01 | ~x08) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n62_ | (new_n60_ & new_n61_));
  assign new_n60_ = ~x01 & x02 & x08 & ~x11 & x12;
  assign new_n61_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n62_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (~x01 & ~x08) | (~x00 & (new_n64_ | (new_n65_ & new_n66_)));
  assign new_n64_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n68_ | (new_n60_ & new_n69_));
  assign new_n68_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n69_ = ~x13 & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = (~x01 & ~x08) | (x09 & ~x24 & (new_n71_ | new_n72_));
  assign new_n71_ = x00 & x01 & (~x02 | ~x10);
  assign new_n72_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x01 & (~x08 | (new_n75_ & ~x00 & ~x02 & ~x09));
  assign new_n75_ = ~x10 & ~x17 & ~x18 & ~x19;
