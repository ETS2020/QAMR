...
module FAU ( 
  ...
  assign z09 = ~x22 & (x17 | (~x00 & ~new_n66_ & ~x21));
  ...
  assign new_n72_ = x15 & x16 & ~x17 & x20 & ~x21 & ~x22;
  assign z11 = ~x22 & (x17 | (~x00 & (new_n74_ | new_n76_)));
  ...
  assign new_n78_ = ~new_n52_ & (~x02 | ~x10);
  assign new_n79_ = x17 ? (~x22 | (~x23 & (x02 | x19))) : (~x23 | (~x02 & ~x19));
  assign z13 = x17 & (~x22 | (~x00 & ~x01 & ~x02 & ~x19));
