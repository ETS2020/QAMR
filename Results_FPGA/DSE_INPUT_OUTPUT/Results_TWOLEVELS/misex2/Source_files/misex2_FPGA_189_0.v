...
module FAU ( 
  ...
  assign z00 = ~x01 & (~x05 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x01 & (~x05 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = ~x01 & (~x05 | (new_n49_ & ~x00 & ~x02 & x09));
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02);
  assign new_n51_ = x05 & ~x17 & x18 & ~x19;
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & ~x05) | (new_n54_ & x00 & x01 & x02);
  ...
  assign new_n58_ = (x01 | ~x05) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z09 = (~x01 & ~x05) | (~x00 & ~x21 & ~new_n60_ & ~x22);
  assign new_n60_ = ~new_n62_ & (~new_n61_ | x01 | ~x02 | x11 | ~x12);
  assign new_n61_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n62_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (~x01 & ~x05) | (~x00 & (new_n64_ | new_n66_));
  ...
  assign z11 = ~x00 & ~x22 & (new_n68_ | new_n70_);
  assign new_n68_ = new_n69_ & ~x01 & x02 & x05 & ~x11 & x12;
  ...
  assign new_n73_ = x05 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x17 & x05 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & new_n76_ & ~x17;
  assign new_n76_ = ~x10 & ~x09 & x05 & ~x02 & ~x00 & ~x01;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & (~x05 | (~x02 & x19)));
  assign z16 = ~x00 & x01;
  assign z17 = ~x01 & (~x05 | (~x00 & x02));
  assign z08 = 1'b0;
endmodule
