// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:50 2020
...
module FAU ( 
  ...
  assign z00 = (x01 & ~x08) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = (x01 & ~x08) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & x09;
  assign new_n49_ = ~x02 & ~x00 & ~x01;
  assign z03 = (x01 & (new_n51_ | ~x08)) | (new_n52_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = x00 & x02 & ~x09 & x10 & x11 & x12;
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n54_ | ~x08);
  assign new_n54_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x10 & x09 & x08 & x02 & x00 & x01;
  assign z06 = x01 & (~x08 | (new_n57_ & x00));
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (x12 | (x08 & ~x12));
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x01 | ~x08 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z13 = (x01 & ~x08) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & ~x09;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & ~x08) | (~x01 & ~x02 & x19);
