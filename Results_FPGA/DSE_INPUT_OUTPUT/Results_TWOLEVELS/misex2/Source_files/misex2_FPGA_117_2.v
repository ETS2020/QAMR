...
module FAU ( 
  ...
  assign z02 = ~x18 & (new_n50_ | x00);
  assign new_n50_ = ~x01 & ~x02 & x09 & ~x10 & ~x17 & ~x19;
  assign z03 = ~new_n52_ & x18;
  assign new_n52_ = (~new_n53_ | ~x00 | ~x01 | ~x02) & (x02 | x17 | x19 | x00 | x01);
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = x18 & new_n55_ & ~x12;
  assign new_n55_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x18 & x10 & x09 & x02 & x00 & x01;
  assign z06 = x00 & (~x18 | (new_n58_ & x01));
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (~x12 | (x12 & x18));
  assign z07 = x00 & (new_n60_ | ~x18);
  ...
  assign z09 = x00 ? ~x18 : (~x21 & ~new_n65_ & ~x22);
  ...
  assign z12 = (new_n76_ & x09) | (x00 & ~x18);
  assign new_n76_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n77_ & ~x01));
  assign new_n77_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = (x00 & ~x18) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (~x02 & (x00 | (~x01 & x19))) | (x00 & (~x18 | (x01 & ~x10)));
  assign z16 = ~x00 & x01;
  assign z17 = x00 ? ~x18 : (~x01 & x02);
endmodule
