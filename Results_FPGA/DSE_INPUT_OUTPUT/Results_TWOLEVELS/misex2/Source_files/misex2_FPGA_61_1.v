...
module FAU ( 
  ...
  assign z01 = ~x00 & (x08 | (new_n48_ & ~x01 & ~x02 & x09));
  ...
  assign new_n76_ = ~x08 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x00 & (x08 | (x17 & ~x19 & ~x01 & ~x02));
  assign z14 = ~x00 & (x08 | (new_n79_ & ~x01 & ~x02 & ~x09));
  assign new_n79_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x08 & x19 & ~x01 & ~x02);
  assign z16 = ~x08 & ~x00 & x01;
  assign z17 = ~x00 & (x08 | (~x01 & x02));
endmodule
