...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n49_, new_n52_, new_n54_, new_n56_, new_n57_, new_n59_,
  ...
  assign z06 = (~x01 & ~x17) | (x00 & new_n52_ & x01);
  assign new_n52_ = x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n54_ & x02;
  assign new_n54_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | ~x17);
  assign z08 = x19 & new_n56_ & ~x18;
  assign new_n56_ = x17 & ~x08 & ~x07 & ~x06 & new_n57_ & ~x05;
  assign new_n57_ = x04 & ~x03 & ~x00 & ~x01 & x02;
  assign z09 = ~x00 & ~x21 & (new_n59_ | new_n61_) & ~x22;
  assign new_n59_ = new_n60_ & ~x14 & ~x15 & ~x16 & x17 & x20;
  assign new_n60_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n61_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = z00 | (~x00 & (new_n63_ | (new_n60_ & new_n64_)));
  assign new_n63_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n64_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = z00 | (~x00 & ~x22 & (new_n66_ | new_n67_));
  assign new_n66_ = new_n60_ & ~x14 & x15 & ~x16 & x20 & ~x21;
