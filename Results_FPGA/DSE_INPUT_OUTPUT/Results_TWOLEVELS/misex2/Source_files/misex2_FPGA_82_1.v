...
module FAU ( 
  ...
  assign z09 = new_n64_ | (~x00 & ~x22 & (new_n67_ | (new_n65_ & new_n66_)));
  ...
  assign z11 = new_n64_ | (~x00 & ~x22 & (new_n74_ | (new_n65_ & new_n73_)));
  assign new_n73_ = ~x13 & ~x14 & x15 & ~x16 & x20;
  assign new_n74_ = x18 & ~x19 & ~x20 & x21;
  assign z12 = new_n64_ | (x09 & ~x24 & (x00 ? new_n76_ : new_n77_));
  assign new_n76_ = x01 & (~x02 | ~x10);
  assign new_n77_ = ~x01 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x21 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x21 & ~x19 & new_n80_ & ~x18;
