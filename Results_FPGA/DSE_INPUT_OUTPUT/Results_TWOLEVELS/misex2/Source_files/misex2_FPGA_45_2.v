...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n51_, new_n53_, new_n55_, new_n57_, new_n59_,
  ...
  assign z03 = (x12 & (new_n51_ | ~x17)) | (new_n46_ & ~x17 & x18 & ~x19);
  ...
  assign z07 = new_n55_ | (new_n59_ & x00);
  ...
  assign new_n64_ = x01 & x18 & ~x19 & ~new_n55_ & ~x20;
  assign new_n65_ = new_n66_ & ~x14 & ~x15 & ~x16 & x17 & x20;
  assign new_n66_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign z10 = new_n55_ | (~x00 & (new_n68_ | (new_n66_ & new_n69_)));
  assign new_n68_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n55_ | (~x00 & ~x22 & (new_n71_ | new_n72_));
  assign new_n71_ = new_n66_ & ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n74_ & x01) : (~new_n75_ & ~x01));
  assign new_n74_ = ~new_n55_ & (~x02 | ~x10);
  assign new_n75_ = (~x23 | (~x17 & (x12 | (~x02 & ~x19)))) & (x02 | ~x17 | x19);
  assign z13 = (x12 & ~x17) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
