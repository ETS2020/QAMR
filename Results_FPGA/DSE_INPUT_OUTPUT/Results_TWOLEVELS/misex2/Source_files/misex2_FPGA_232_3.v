// Benchmark "FAU" written by ABC on Mon Aug 24 16:43:05 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n54_, new_n57_, new_n58_, new_n59_, new_n60_,
  ...
  assign z09 = new_n57_ | (new_n59_ & new_n60_ & ~x14 & ~x15 & ~x16);
  assign new_n57_ = x01 & (x00 | (new_n58_ & ~x20 & ~x21 & ~x22));
  assign new_n58_ = x18 & ~x19;
  assign new_n59_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n60_ = x20 & ~x21 & ~x22;
  assign z10 = ~x00 & (new_n62_ | new_n63_);
  assign new_n62_ = new_n58_ & x01 & ~x20 & x21 & x22;
  assign new_n63_ = new_n64_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n64_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = new_n66_ | (new_n59_ & new_n60_ & ~x14 & x15 & ~x16);
  assign new_n66_ = x01 & (x00 | (new_n58_ & ~x20 & x21 & ~x22));
