// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:16 2020
...
module FAU ( 
  ...
  assign z01 = new_n46_ | (new_n47_ & new_n49_);
  assign new_n49_ = ~x00 & ~x01 & ~x02 & x09;
  assign z02 = new_n46_ | (new_n49_ & ~x10 & ~x17 & ~x18 & ~x19);
  ...
  assign new_n55_ = ~x09 & x10 & ~x11 & ~new_n46_ & ~x12;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n46_ & x10;
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & ~new_n46_ & x11;
  assign z07 = x00 & x02 & ~new_n46_ & ~new_n60_;
  assign new_n60_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x03 & (new_n62_ | x15);
  assign new_n62_ = new_n63_ & ~x00 & ~x01 & x02 & x04 & ~x05;
  ...
  assign new_n70_ = ~x01 & x02 & x03 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n46_ | (~x00 & ~x22 & (new_n73_ | (new_n74_ & new_n75_)));
  assign new_n73_ = ~x19 & ~x20 & x21 & x01 & x18;
  assign new_n74_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n75_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & ~new_n77_ & ~new_n46_;
  ...
  assign z14 = ~x00 & ~x01 & ~x02 & new_n81_ & ~x09;
  assign new_n81_ = ~x10 & ~x17 & ~x18 & ~new_n46_ & ~x19;
