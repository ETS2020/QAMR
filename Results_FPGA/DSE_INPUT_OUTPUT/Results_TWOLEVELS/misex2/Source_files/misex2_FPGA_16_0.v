...
module FAU ( 
  ...
  assign new_n65_ = ~x20 & ~x19 & x18 & x15 & ~x00 & x01;
  assign z10 = new_n46_ | (~x00 & (new_n67_ | (new_n68_ & new_n69_)));
  assign new_n67_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n68_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n69_ = ~x14 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & x15 & ~x22 & (new_n71_ | (new_n72_ & new_n73_));
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n72_ = ~x01 & x02 & ~x11 & x12;
