...
module FAU ( 
  ...
  assign new_n54_ = ~x11 & (~x00 | ~x02 | x09 | ~x10 | x12);
  ...
  assign z09 = z06 | (~x00 & ~x21 & ~new_n61_ & ~x22);
  ...
  assign z11 = z06 | (~x00 & ~x22 & (new_n69_ | new_n71_));
  ...
  assign new_n73_ = x00 ? (~x01 | x11 | (x02 & x10)) : (new_n74_ | x01);
