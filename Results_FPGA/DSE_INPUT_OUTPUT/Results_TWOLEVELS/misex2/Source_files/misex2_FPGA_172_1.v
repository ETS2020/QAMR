...
module FAU ( 
  ...
  assign z04 = (~x01 & x24) | (new_n54_ & x00 & x01 & x02);
  assign new_n54_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = (~x01 & x24) | (x00 & new_n57_ & x01);
  assign new_n57_ = x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x24);
  assign z08 = ~x24 & new_n61_ & x19;
  ...
  assign z14 = ~x24 & ~x19 & new_n79_ & ~x18;
