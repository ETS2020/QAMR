...
module FAU ( 
  ...
  assign z05 = (~x01 & x16) | (x02 & x09 & x10 & x00 & x01);
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x16);
  ...
  assign z10 = (~x01 & x16) | (new_n68_ & ~x00 & x01 & x18);
  assign new_n68_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = new_n70_ | (~x00 & ~x22 & (new_n71_ | (new_n64_ & new_n72_)));
  assign new_n70_ = ~x01 & x16;
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n72_ = ~x13 & ~x14 & x15 & x20 & ~x21;
  assign z12 = new_n70_ | (x09 & ~x24 & (new_n74_ | new_n75_));
