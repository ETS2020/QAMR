...
module FAU ( 
  ...
  assign z00 = ~x19 & (~x06 | (new_n46_ & new_n47_ & ~x09 & x10));
  assign new_n46_ = ~x00 & ~x01 & ~x02;
  assign new_n47_ = ~x17 & ~x18;
  assign z01 = ~x19 & (~x06 | (new_n46_ & new_n47_ & x09 & x10));
  assign z02 = ~x19 & (~x06 | (new_n46_ & new_n47_ & x09 & ~x10));
  assign z03 = (~new_n51_ & ~x19) | (new_n52_ & x00 & x01 & x02);
  assign new_n51_ = x06 & (x00 | x01 | x02 | x17 | ~x18);
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x06 & ~x19) | (new_n54_ & x00 & x01 & x02);
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = new_n56_ | (~x06 & ~x19);
  assign new_n56_ = x02 & x09 & x10 & x00 & x01;
  assign z06 = new_n58_ | (~x06 & ~x19);
  assign new_n58_ = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = (~x06 & ~x19) | (new_n60_ & x00);
  assign new_n60_ = x02 & (~x01 | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = ~x06 & (new_n62_ | ~x19);
  assign new_n62_ = new_n63_ & ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n63_ = ~x05 & ~x07 & ~x08 & x17 & ~x18;
  assign z09 = (~x06 & ~x19) | (~x00 & ~x21 & ~new_n65_ & ~x22);
  ...
  assign z12 = (~x06 & ~x19) | (new_n77_ & x09);
  ...
  assign z14 = ~x19 & (~x06 | (new_n46_ & new_n47_ & ~x09 & ~x10));
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x06 & ~x19) | (~x01 & ~x02 & x19);
  assign z16 = (~x00 & x01) | (~x06 & ~x19);
  assign z17 = (~x06 & ~x19) | (~x00 & ~x01 & x02);
endmodule
