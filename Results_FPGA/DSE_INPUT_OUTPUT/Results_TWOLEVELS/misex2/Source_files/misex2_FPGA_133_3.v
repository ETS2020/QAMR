...
module FAU ( 
  ...
  assign z07 = (x01 & x09) | (x00 & x02 & (~x01 | (new_n57_ & x01 & x10)));
  assign new_n57_ = x11 & ~x12;
  assign z08 = (x01 & x09) | (new_n60_ & new_n59_ & ~x00 & ~x01 & x02);
  ...
  assign new_n64_ = x01 & ~x09 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ((new_n66_ & new_n67_) | (new_n68_ & new_n69_));
  assign new_n66_ = x01 & ~x09 & x18;
  ...
  assign new_n71_ = x01 & ~x09 & x18 & ~x19 & ~x20 & x21;
