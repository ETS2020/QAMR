...
module FAU ( 
  ...
  assign z07 = (~x01 & x21) | (x00 & x02 & (~x01 | (new_n58_ & x01 & ~x09)));
  assign new_n58_ = x10 & x11 & ~x12;
  assign z08 = ~x01 & (x21 | (new_n60_ & new_n61_));
  assign new_n60_ = ~x00 & x02 & ~x03 & x04 & ~x05;
  assign new_n61_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = new_n63_ | (~x00 & ~x22 & (new_n66_ | (new_n64_ & new_n65_)));
  ...
  assign z10 = new_n63_ | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  assign new_n68_ = x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n69_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x22;
  assign z11 = new_n63_ | (~x00 & ~x22 & (new_n73_ | (new_n64_ & new_n72_)));
  assign new_n72_ = ~x13 & ~x14 & x15 & ~x16 & x20;
  assign new_n73_ = x18 & ~x19 & ~x20 & x21;
  assign z12 = new_n63_ | (x09 & ~x24 & (x00 ? new_n75_ : new_n76_));
