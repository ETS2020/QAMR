// Benchmark "FAU" written by ABC on Mon Aug 24 16:43:10 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n58_,
    ...
    new_n70_, new_n71_, new_n73_, new_n74_, new_n76_, new_n78_;
  assign z00 = x24 & ~x19 & ~x18 & ~x17 & new_n46_ & x10;
  assign new_n46_ = ~x09 & ~x02 & ~x00 & ~x01;
  assign z01 = x24 & ~x19 & new_n48_ & ~x18;
  assign new_n48_ = ~x17 & x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z02 = (x10 & ~x24) | (new_n50_ & ~x10 & ~x17 & ~x18 & ~x19);
  assign new_n50_ = ~x00 & ~x01 & ~x02 & x09;
  assign z03 = new_n53_ | (x10 & (new_n52_ | ~x24));
  ...
  assign z06 = ~new_n58_ & x10;
  assign new_n58_ = x24 & (~x00 | ~x01 | ~x02 | x09 | ~x11);
  assign z07 = (new_n60_ & x00) | (x10 & ~x24);
  assign new_n60_ = x02 & (~x01 | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = (new_n62_ & new_n63_) | (x10 & ~x24);
  assign new_n62_ = ~x03 & x04 & ~x05 & ~x00 & ~x01 & x02;
  assign new_n63_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = ~x00 & ~x21 & ~x22 & ~new_n65_ & (~x10 | x24);
  assign new_n65_ = ~new_n67_ & (~new_n66_ | x01 | ~x02 | x11 | ~x12);
  assign new_n66_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (x10 & ~x24) | (~x00 & (new_n69_ | (new_n70_ & new_n71_)));
  assign new_n69_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (x10 & ~x24) | (~x00 & ~x22 & (new_n73_ | new_n74_));
  assign new_n73_ = new_n70_ & ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = ~x24 & (x10 | (~new_n76_ & x09));
  assign new_n76_ = x00 ? ~x01 : (x01 | ((x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19))));
  assign z13 = new_n78_ | (x10 & ~x24);
  assign new_n78_ = ~x00 & ~x01 & ~x02 & x17 & ~x19;
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (~x02 & (~x10 | x24) & (x00 | (~x01 & x19))) | (x00 & x01 & ~x10);
  assign z16 = (~x00 & x01) | (x10 & ~x24);
  assign z17 = ~x00 & ~x01 & x02 & (~x10 | x24);
endmodule
