...
module FAU ( 
  ...
  assign z01 = (x02 & x15) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = (x02 & x15) | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  ...
  assign z04 = x02 & (new_n55_ | x15);
  assign new_n55_ = x00 & x01 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = ~x15 & x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n58_ & x00;
  assign new_n58_ = x01 & x02 & ~x09 & x10 & x11 & ~x15;
  assign z07 = x00 & new_n60_ & x02;
  assign new_n60_ = ~x15 & (~x01 | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = x02 & (new_n62_ | x15);
  assign new_n62_ = new_n63_ & ~x00 & ~x01 & ~x03 & x04 & ~x05;
  assign new_n63_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = (x02 & x15) | (~x00 & ~x21 & ~new_n65_ & ~x22);
  assign new_n65_ = ~new_n67_ & (~new_n66_ | x11 | ~x12 | x01 | ~x02);
  assign new_n66_ = ~x13 & ~x14 & ~x16 & x20;
  assign new_n67_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (x02 & x15) | (new_n69_ & ~x00 & x01 & x18);
  assign new_n69_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & x01 & new_n71_ & x18;
  assign new_n71_ = ~x19 & ~x20 & x21 & ~x22 & (~x02 | ~x15);
  assign z12 = x09 & ~new_n73_ & ~x24;
  assign new_n73_ = x00 ? (~x01 | (x02 & (x10 | x15))) : (new_n74_ | x01);
  assign new_n74_ = x02 ? (x15 | ~x23) : (x19 ? ~x23 : ~x17);
  assign z13 = ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = (x02 & x15) | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = (x00 & (~x02 | (x01 & ~x10 & ~x15))) | (~x01 & ~x02 & x19);
