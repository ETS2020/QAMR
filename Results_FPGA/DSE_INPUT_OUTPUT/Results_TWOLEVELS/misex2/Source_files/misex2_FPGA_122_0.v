...
module FAU ( 
  ...
  assign new_n71_ = ~x01 & x02 & x05 & ~x11 & x12 & ~x13;
  assign new_n72_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & x05 & ~x22 & (new_n74_ | (new_n75_ & new_n76_));
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n75_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n76_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = new_n46_ | (new_n78_ & x09);
