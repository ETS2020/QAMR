...
module FAU ( 
  ...
  assign z02 = ~x24 & ~x18 & ~x17 & new_n48_ & ~x10 & ~x19;
  ...
  assign new_n61_ = x17 & ~x07 & ~x06 & new_n62_ & ~x05 & ~x08;
  ...
  assign z13 = ~x00 & (x24 | (x17 & ~x19 & ~x01 & ~x02));
  assign z14 = ~x00 & (x24 | (new_n79_ & ~x01 & ~x02 & ~x09));
