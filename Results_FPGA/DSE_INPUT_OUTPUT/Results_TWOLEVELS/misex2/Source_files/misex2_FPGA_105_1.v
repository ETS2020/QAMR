...
module FAU ( 
  ...
  assign z03 = (~x00 & ~x01 & new_n53_ & ~x02) | (new_n54_ & x00 & x01 & x02 & x04);
  ...
  assign new_n59_ = x01 & x02 & x04 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n61_ & x02;
  assign new_n61_ = (x01 | (~x04 & x11)) & (~x01 | ~x04 | x09 | ~x10 | ~x11 | x12);
  assign z08 = (~x04 & x11) | (new_n64_ & new_n63_ & ~x03 & x04 & ~x05);
  assign new_n63_ = ~x00 & ~x01 & x02;
  assign new_n64_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n66_ | (new_n67_ & new_n68_));
  assign new_n66_ = x01 & x18 & ~x19 & ~x20 & (x04 | ~x11);
  ...
  assign z11 = ~x00 & ~x22 & ((new_n74_ & x01) | (new_n71_ & new_n75_));
  assign new_n74_ = x18 & ~x19 & ~x20 & x21 & (x04 | ~x11);
