...
module FAU ( 
  ...
  assign z04 = z01 | (new_n47_ & ~x09 & x10 & ~x11 & ~x12);
  assign z05 = x00 & x01 & x02 & x09 & ~z01 & x10;
  assign z06 = z01 | (x00 & x01 & new_n51_ & x02);
  assign new_n51_ = ~x09 & x10 & x11 & (x12 | (~z01 & ~x12));
  assign z07 = x00 & ~z01 & ~new_n53_ & x02;
  assign new_n53_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12);
