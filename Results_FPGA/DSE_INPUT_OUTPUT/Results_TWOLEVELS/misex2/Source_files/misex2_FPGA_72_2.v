...
module FAU ( 
  ...
  assign new_n53_ = x10 & x11 & x12 & x23;
  ...
  assign new_n60_ = x01 & ~x09 & x10 & x11 & ~x12 & x23;
  ...
  assign new_n76_ = ~new_n77_ & (x02 | ~x17 | x19 | x00 | x01);
  assign new_n77_ = x23 & (x00 ? (x01 & (~x02 | ~x10)) : (~x01 & (x02 | x19)));
