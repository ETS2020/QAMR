...
module FAU ( 
  ...
  assign new_n57_ = x24 & (~x00 | ~x02 | x09 | ~x10 | ~x11 | ~x24);
  ...
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21 & x24;
  assign z12 = ~x24 & (new_n75_ | x01);
  assign new_n75_ = ~x00 & x09 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
