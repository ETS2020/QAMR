// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:15 2020
...
module FAU ( 
  ...
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19 & (x15 | ~x20);
  ...
  assign new_n51_ = ~x10 & ~x17 & ~x18 & ~x19 & (x15 | ~x20);
  ...
  assign new_n59_ = x02 & ~x09 & x10 & x11 & (x15 | ~x20);
  assign z07 = new_n48_ | (x00 & x02 & (~x01 | (new_n61_ & x01)));
  assign new_n61_ = ~x09 & x10 & x11 & ~x12 & (x15 | ~x20);
  assign z08 = new_n48_ | (new_n63_ & new_n64_);
  assign new_n63_ = ~x00 & ~x01 & x02 & ~x03 & x04 & ~x05;
  assign new_n64_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = new_n48_ | (new_n66_ & ~x00 & x01 & x18);
  assign new_n66_ = ~x21 & ~x22 & ~x19 & ~x20;
  assign z10 = new_n48_ | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  assign new_n68_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n69_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n48_ | (~x00 & ~x22 & (new_n72_ | (new_n73_ & new_n74_)));
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n73_ = ~x01 & x02 & ~x11 & x12;
  assign new_n74_ = ~x13 & ~x14 & ~x16 & x20 & ~x21;
  assign z12 = new_n48_ | (x09 & ~x24 & (new_n76_ | new_n77_));
