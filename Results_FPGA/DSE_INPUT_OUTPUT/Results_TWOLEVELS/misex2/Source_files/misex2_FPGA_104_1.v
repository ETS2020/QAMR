...
module FAU ( 
  ...
  assign z01 = ~x17 & (x19 | (new_n48_ & x09 & x10 & ~x18));
  assign new_n48_ = ~x00 & ~x01 & ~x02;
  assign z02 = ~x17 & (x19 | (new_n48_ & x09 & ~x10 & ~x18));
  assign z03 = new_n51_ | (new_n52_ & ~x09 & x10 & x11 & x12);
  assign new_n51_ = ~x17 & (x19 | (~x00 & ~x01 & ~x02 & x18));
  assign new_n52_ = x00 & x01 & x02;
  assign z04 = new_n54_ | (new_n52_ & ~x09 & x10 & ~x11 & ~x12);
  assign new_n54_ = ~x17 & x19;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n54_ & x10;
  assign z06 = new_n54_ | (x00 & x01 & new_n57_ & x02);
  assign new_n57_ = ~x09 & x10 & x11 & (x12 | (~new_n54_ & ~x12));
  assign z07 = x00 & x02 & ~new_n54_ & ~new_n59_;
  assign new_n59_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = x19 & new_n61_ & ~x18;
  assign new_n61_ = x17 & ~x08 & ~x06 & new_n62_ & ~x05 & ~x07;
  assign new_n62_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = new_n54_ | (~x00 & ~x21 & ~new_n64_ & ~x22);
  assign new_n64_ = ~new_n66_ & (~new_n65_ | x01 | ~x02 | x11 | ~x12);
  assign new_n65_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = new_n54_ | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  assign new_n68_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n69_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n54_ | (~x00 & ~x22 & (new_n72_ | new_n73_));
  assign new_n72_ = new_n69_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n73_ = ~x19 & ~x20 & x21 & x01 & x18;
  assign z12 = new_n54_ | (new_n75_ & x09);
  assign new_n75_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n76_ & ~x01));
  assign new_n76_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = (~x17 & x19) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x17 & (x19 | (new_n48_ & ~x09 & ~x10 & ~x18));
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x19 & (~x17 | (~x01 & ~x02)));
  assign z16 = ~x00 & ~new_n54_ & x01;
