...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n55_, new_n59_,
    new_n61_, new_n62_, new_n64_, new_n68_, new_n70_, new_n71_;
  ...
  assign z05 = (~x01 & ~x22) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | ~x22);
  ...
  assign z16 = ~x00 & x01;
  assign z10 = x22 & new_n64_ & x21;
  assign z11 = ~new_n68_ & ~x22;
  assign new_n68_ = x01 & (x00 | ~x18 | x19 | x20 | ~x21);
  assign z12 = new_n70_ & x09;
  assign new_n70_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (new_n71_ & ~x01));
  assign new_n71_ = x22 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
