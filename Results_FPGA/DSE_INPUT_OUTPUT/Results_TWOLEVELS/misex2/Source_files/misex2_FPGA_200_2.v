...
module FAU ( 
  ...
  assign new_n51_ = ~x09 & x10 & x11 & x12 & (~x14 | x17);
  assign new_n52_ = ~x14 & ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n54_ & x02;
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12 & (~x14 | x17);
  assign z05 = new_n56_ | (x00 & x01 & x02 & x09 & x10);
  assign new_n56_ = x14 & ~x17;
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (~x14 | x17);
  assign z07 = new_n56_ | (x00 & x02 & (~x01 | (new_n60_ & x01)));
  assign new_n60_ = ~x09 & x10 & x11 & ~x12 & (~x14 | x17);
  assign z08 = new_n56_ | (new_n62_ & new_n63_);
  ...
  assign new_n65_ = x01 & x18 & ~x19 & ~x20 & (~x14 | x17);
  ...
  assign z11 = ~x00 & ~x22 & ((new_n70_ & new_n74_) | (new_n73_ & x01));
  assign new_n73_ = x18 & ~x19 & ~x20 & x21 & (~x14 | x17);
  assign new_n74_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n76_ & x01) : (~new_n77_ & ~x01));
  assign new_n76_ = (~x02 | ~x10) & (~x14 | x17);
  assign new_n77_ = (~x23 | (~x17 & (x14 | (~x02 & ~x19)))) & (x02 | ~x17 | x19);
