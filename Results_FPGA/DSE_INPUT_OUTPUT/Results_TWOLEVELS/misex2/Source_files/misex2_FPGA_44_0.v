...
module FAU ( 
  ...
  assign new_n72_ = x03 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & new_n49_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & ~x09;
  assign z15 = (x00 & ((~x02 & x03) | (x01 & (~x02 | ~x10)))) | (~x01 & ~x02 & x03 & x19);
