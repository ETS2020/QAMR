// Benchmark "FAU" written by ABC on Mon Aug 24 16:41:54 2020
...
module FAU ( 
  ...
  assign z00 = ~x01 & (~x04 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x01 & (~x04 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = ~x01 & (~x04 | (new_n49_ & ~x00 & ~x02 & x09));
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (~x01 & (~x04 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & ~x04) | (new_n54_ & x00 & x01 & x02);
  assign new_n54_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = (~x01 & ~x04) | (x00 & new_n57_ & x01);
  assign new_n57_ = x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (x01 | ~x04) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = new_n61_ & x19;
  assign new_n61_ = ~x18 & x17 & ~x08 & ~x07 & new_n62_ & ~x06;
  assign new_n62_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (~x01 & ~x04) | (~x00 & ~x21 & ~new_n64_ & ~x22);
  assign new_n64_ = ~new_n66_ & (~new_n65_ | x01 | ~x02 | x11 | ~x12);
  assign new_n65_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (~x01 & ~x04) | (~x00 & (new_n68_ | new_n70_));
  ...
  assign new_n72_ = new_n73_ & ~x01 & x02 & x04 & ~x11 & x12;
  assign new_n73_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (~x01 & ~x04) | (new_n76_ & x09);
  assign new_n76_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n77_ & ~x01));
  assign new_n77_ = (~x23 | (~x02 & (~x04 | ~x19))) & (x02 | ~x17 | x19);
  assign z13 = ~x01 & (~x04 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (~x04 | (new_n49_ & ~x00 & ~x02 & ~x09));
  assign z15 = (x00 & ((~x02 & x04) | (x01 & (~x02 | ~x10)))) | (~x01 & ~x02 & x04 & x19);
