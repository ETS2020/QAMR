...
module FAU ( 
  ...
  assign z10 = new_n71_ | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  assign new_n68_ = x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n69_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x15 & x16 & ~x21 & ~x22;
  assign new_n71_ = ~x01 & ~x20;
  assign z11 = new_n71_ | (~x00 & ~x22 & (new_n73_ | (new_n64_ & new_n74_)));
  assign new_n73_ = x18 & ~x19 & ~x20 & x21;
  assign new_n74_ = ~x13 & ~x14 & x15 & ~x16 & ~x21;
