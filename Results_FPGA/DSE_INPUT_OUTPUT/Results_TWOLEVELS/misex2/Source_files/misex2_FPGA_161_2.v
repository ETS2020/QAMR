// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:36 2020
...
module FAU ( 
  ...
  assign z00 = ~x18 & (new_n46_ | x01);
  assign new_n46_ = ~x00 & ~x02 & ~x09 & x10 & ~x17 & ~x19;
  assign z01 = ~x18 & (x01 | (new_n49_ & new_n48_ & x10));
  assign new_n48_ = ~x17 & ~x19;
  assign new_n49_ = ~x00 & ~x02 & x09;
  assign z02 = ~x18 & (x01 | (new_n49_ & new_n48_ & ~x10));
  assign z03 = x18 & ((new_n52_ & x00 & x01 & x02) | (~x00 & ~x01 & new_n48_ & ~x02));
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign z04 = x18 & new_n54_ & ~x12;
  assign new_n54_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x18 & x10 & x09 & x02 & x00 & x01;
  ...
  assign z08 = ~x18 & (x01 | (new_n61_ & new_n62_));
  assign new_n61_ = ~x00 & x02 & ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17 & x19;
  ...
  assign z11 = new_n74_ | (~x00 & ~x22 & (new_n72_ | (new_n69_ & new_n73_)));
  assign new_n72_ = x01 & ~x19 & ~x20 & x21;
  assign new_n73_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n74_ = x01 & ~x18;
  assign z12 = x09 & ~x24 & (x00 ? (new_n76_ & x01) : (~new_n77_ & ~x01));
  assign new_n76_ = x18 & (~x02 | ~x10);
