...
module FAU ( 
  ...
  assign new_n49_ = ~x17 & ~x18 & ~x19 & (x14 | ~x20);
  ...
  assign new_n56_ = ~x09 & x10 & ~x11 & ~x12 & (x14 | ~x20);
  assign z05 = x00 & x01 & x02 & x09 & ~new_n46_ & x10;
  assign z06 = new_n46_ | (x00 & x01 & new_n59_ & x02);
  assign new_n59_ = ~x09 & x10 & x11 & (~x12 | (x12 & (x14 | ~x20)));
  ...
  assign z09 = new_n66_ & ~x22;
  assign new_n66_ = ~x21 & ~x20 & ~x19 & x18 & ~x00 & x01;
  assign z10 = (~x14 & x20) | (new_n68_ & ~x19 & ~x20 & x21 & x22);
  assign new_n68_ = ~x00 & x01 & x18;
  assign z11 = (~x14 & x20) | (new_n68_ & ~x19 & ~x20 & x21 & ~x22);
  assign z12 = new_n46_ | (x09 & ~x24 & (new_n71_ | new_n72_));
