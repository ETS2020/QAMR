...
module FAU ( 
  ...
  wire new_n47_, new_n49_, new_n50_, new_n52_, new_n55_, new_n57_, new_n59_,
    ...
    new_n69_, new_n71_, new_n72_, new_n73_, new_n75_, new_n76_;
  assign z00 = x10 & ~x19;
  ...
  assign new_n75_ = x00 ? (~x01 | (x10 & (x02 | ~x19))) : (new_n76_ | x01);
  assign new_n76_ = (x10 | (x02 ? ~x23 : (~x17 | x19))) & (~x19 | ~x23);
  assign z13 = ~x19 & (x10 | (~x00 & ~x01 & ~x02 & x17));
  assign z14 = ~x19 & (x10 | (new_n47_ & ~x09 & ~x17 & ~x18));
  assign z15 = (x00 & ((x01 & ~x10) | (~x02 & (~x10 | x19)))) | (~x01 & ~x02 & x19);
  assign z16 = z00 | (~x00 & x01);
  assign z17 = z00 | (~x00 & ~x01 & x02);
  assign z01 = z00;
endmodule
