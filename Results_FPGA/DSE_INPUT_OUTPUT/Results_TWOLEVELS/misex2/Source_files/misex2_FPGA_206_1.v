...
module FAU ( 
  ...
  assign new_n63_ = x17 & ~x14 & ~x08 & ~x07 & new_n64_ & ~x06;
  assign new_n64_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & ~x21 & ~new_n66_ & ~x22;
  assign new_n66_ = (~new_n67_ | ~x01) & (~new_n68_ | x11 | ~x12 | x01 | ~x02);
  assign new_n67_ = x18 & ~x19 & ~x20 & (x08 | ~x14);
