...
module FAU ( 
  ...
  assign z09 = ~x00 & ~x16 & ~x21 & ~new_n64_ & ~x22;
  assign new_n64_ = ~new_n66_ & (~new_n65_ | x13 | x14 | x15 | ~x20);
  assign new_n65_ = ~x01 & x02 & ~x11 & x12;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = ~x00 & (new_n68_ | (new_n70_ & x01 & ~x16 & x18));
  ...
  assign new_n72_ = new_n65_ & ~x13 & ~x14 & x15 & x20 & ~x21;
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n75_ & ~x24;
  assign new_n75_ = x00 ? (~x01 | x16 | (x02 & x10)) : (new_n76_ | x01);
