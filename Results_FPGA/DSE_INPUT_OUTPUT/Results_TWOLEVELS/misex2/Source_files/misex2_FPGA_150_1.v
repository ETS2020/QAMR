...
module FAU ( 
  ...
  assign z10 = ~x00 & x18 & (new_n70_ | (new_n71_ & new_n72_));
  assign new_n70_ = x01 & ~x19 & ~x20 & x21 & x22;
  assign new_n71_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n72_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & x18 & ~x22 & (new_n74_ | new_n75_);
  assign new_n74_ = new_n71_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n75_ = ~x20 & x21 & x01 & ~x19;
