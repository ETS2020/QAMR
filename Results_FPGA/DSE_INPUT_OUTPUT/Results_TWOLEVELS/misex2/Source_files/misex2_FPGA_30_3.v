...
module FAU ( 
  ...
  assign z09 = (x01 & x21) | (~x00 & ~new_n64_ & ~x22);
  assign new_n64_ = (~new_n65_ | ~new_n66_) & (x19 | x20 | ~x01 | ~x18);
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20 & ~x21;
  assign z10 = (x01 & x21) | (new_n69_ & new_n68_ & ~x00 & ~x01 & x02);
  assign new_n68_ = ~x11 & x12 & ~x13;
  assign new_n69_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = ~x22 & ~x21 & x20 & new_n71_ & ~x16;
  assign new_n71_ = x15 & ~x14 & ~x13 & x12 & z17 & ~x11;
