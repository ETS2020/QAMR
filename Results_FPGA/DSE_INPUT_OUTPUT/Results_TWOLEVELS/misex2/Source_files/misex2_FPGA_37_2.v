...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n52_ | ~x13)) | (new_n53_ & ~x00 & ~x01 & ~x02);
  ...
  assign z06 = x01 & (~x13 | (new_n58_ & x00));
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (x12 | (~x12 & x13));
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12 | ~x13);
  ...
  assign new_n67_ = x01 & x13 & x18 & ~x19 & ~x20;
  ...
  assign new_n75_ = x01 & x13 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n77_ & ~x24;
  assign new_n77_ = x00 ? (~x01 | ~x13 | (x02 & x10)) : (new_n78_ | x01);
  assign new_n78_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = (x01 & ~x13) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = new_n46_ | (new_n47_ & ~x18 & ~x19 & ~x10 & ~x17);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & ~x13) | (~x01 & ~x02 & x19);
  assign z16 = x01 & (~x00 | ~x13);
  assign z17 = (x01 & ~x13) | (~x00 & ~x01 & x02);
endmodule
