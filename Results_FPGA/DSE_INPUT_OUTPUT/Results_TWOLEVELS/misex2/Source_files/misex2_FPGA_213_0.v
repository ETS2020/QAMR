...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n50_, new_n51_, new_n53_, new_n57_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n64_, new_n66_, new_n67_, new_n68_, new_n70_,
    new_n71_, new_n72_, new_n74_, new_n75_;
  assign z00 = ~x01 & ~x09;
  assign z01 = ~x19 & ~x18 & ~x17 & new_n47_ & x10;
  assign new_n47_ = x09 & ~x00 & ~x01 & ~x02;
  assign z02 = ~x19 & ~x18 & ~x17 & new_n47_ & ~x10;
  ...
  assign z06 = ~x09 & (~x01 | (x00 & x01 & x02 & x10 & x11));
  assign z07 = new_n57_ & x00;
  assign new_n57_ = x02 & ((~x01 & x09) | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = ~x01 & (~x09 | (new_n59_ & new_n60_));
  assign new_n59_ = ~x00 & x02 & ~x03 & x04 & ~x05;
  ...
  assign z11 = z00 | (~x00 & ~x22 & (new_n70_ | (new_n71_ & new_n72_)));
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n71_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n72_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (x00 ? new_n74_ : new_n75_);
  assign new_n74_ = x01 & (~x02 | ~x10);
  assign new_n75_ = ~x01 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & new_n47_ & x17;
