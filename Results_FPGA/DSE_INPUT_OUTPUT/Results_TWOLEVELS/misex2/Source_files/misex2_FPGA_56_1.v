...
module FAU ( 
  ...
  assign z01 = ~x01 & (x15 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = ~x19 & ~x18 & new_n49_ & ~x17;
  assign new_n49_ = ~x15 & ~x10 & x09 & ~x02 & ~x00 & ~x01;
  ...
  assign z06 = (~x01 & x15) | (x00 & new_n57_ & x01);
  ...
  assign z10 = new_n68_ & x22;
  assign new_n68_ = x21 & ~x20 & ~x19 & x18 & ~x00 & x01;
  assign z11 = new_n68_ & ~x22;
  assign z12 = (~x01 & x15) | (x09 & ~x24 & (new_n71_ | new_n72_));
  ...
  assign new_n75_ = ~x15 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
