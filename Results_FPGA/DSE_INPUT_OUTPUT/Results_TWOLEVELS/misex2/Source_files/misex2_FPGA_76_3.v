...
module FAU ( 
  ...
  assign z07 = (x00 & x02 & (new_n59_ | ~x01)) | (x01 & x21);
  assign new_n59_ = x11 & ~x12 & ~x21 & x01 & ~x09 & x10;
  assign z08 = (x01 & x21) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  assign new_n61_ = ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = new_n64_ | (~x00 & ~x22 & (new_n65_ | (new_n66_ & new_n67_)));
  assign new_n64_ = x01 & x21;
  assign new_n65_ = x01 & x18 & ~x19 & ~x20;
  assign new_n66_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20 & ~x21;
  assign z10 = new_n64_ | (new_n69_ & new_n70_ & ~x14 & x15 & x16);
  assign new_n69_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = x20 & ~x21 & ~x22;
  assign z11 = new_n64_ | (new_n69_ & new_n70_ & ~x14 & x15 & ~x16);
  assign z12 = new_n64_ | (x09 & ~x24 & (new_n73_ | new_n74_));
