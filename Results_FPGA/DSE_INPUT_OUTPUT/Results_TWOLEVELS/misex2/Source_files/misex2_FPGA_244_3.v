...
module FAU ( 
  ...
  assign z09 = (x01 & (new_n58_ | x00)) | (new_n60_ & new_n59_ & ~x00 & ~x01 & x02);
  assign new_n58_ = x18 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n59_ = ~x11 & x12 & ~x13;
  ...
  assign z12 = x00 ? x01 : (new_n69_ & ~x01);
