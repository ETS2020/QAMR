...
module FAU ( 
  ...
  assign z03 = (new_n53_ & ~x00 & ~x01 & ~x02) | (new_n51_ & x00 & x01 & x02);
  assign new_n51_ = new_n52_ & x11 & x12;
  assign new_n52_ = ~x09 & x10;
  assign new_n53_ = ~x11 & ~x17 & x18 & ~x19;
  assign z04 = (~x01 & x11) | (x00 & x01 & x02 & new_n52_ & ~x11 & ~x12);
  assign z05 = (~x01 & x11) | (x02 & x09 & x10 & x00 & x01);
  assign z06 = x11 & (~x01 | (x00 & x01 & new_n52_ & x02));
  ...
  assign z11 = (~x01 & x11) | (~x00 & ~new_n71_ & ~x22);
  assign new_n71_ = ~new_n72_ & (~new_n73_ | ~x12 | x13 | x01 | ~x02);
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n73_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = (~x01 & x11) | (new_n75_ & x09);
  ...
  assign z14 = ~x01 & (x11 | (new_n79_ & ~x00 & ~x02 & ~x09));
