...
module FAU ( 
  ...
  assign z03 = new_n54_ | (~new_n53_ & x12);
  assign new_n53_ = x11 & (~x00 | ~x01 | ~x02 | x09 | ~x10);
  ...
  assign z06 = new_n47_ | (new_n59_ & x00);
  assign new_n59_ = x01 & x02 & ~x09 & x10 & (x12 | (x11 & ~x12));
  assign z07 = new_n61_ & x00;
  assign new_n61_ = x02 & ((~x01 & (x11 | ~x12)) | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = ~x00 & ~x01 & new_n63_ & x02;
  assign new_n63_ = ~x03 & x04 & ~x05 & ~x06 & new_n64_ & ~x07;
  assign new_n64_ = ~x08 & x17 & ~x18 & x19 & (x11 | ~x12);
  assign z09 = new_n47_ | (new_n66_ & ~x21 & ~x22 & ~x19 & ~x20);
  assign new_n66_ = ~x00 & x01 & x18;
  assign z10 = ~x00 & x01 & new_n68_ & x18;
  assign new_n68_ = ~x19 & ~x20 & x21 & ~new_n47_ & x22;
  assign z11 = new_n47_ | (new_n66_ & ~x19 & ~x20 & x21 & ~x22);
  assign z12 = new_n47_ | (new_n71_ & x09);
