...
module FAU ( 
  ...
  assign z01 = ~x01 & (~x13 | (new_n48_ & ~x00 & ~x02 & x09));
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x19 & ~x18 & new_n50_ & ~x17;
  assign new_n50_ = x13 & ~x10 & x09 & ~x02 & ~x00 & ~x01;
  ...
  assign new_n61_ = x13 & ~x08 & ~x07 & ~x06 & new_n62_ & ~x05;
  ...
  assign z12 = new_n64_ | (new_n69_ & x09);
