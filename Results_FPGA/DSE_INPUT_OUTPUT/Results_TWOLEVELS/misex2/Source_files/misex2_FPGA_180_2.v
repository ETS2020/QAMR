...
module FAU ( 
  ...
  assign z02 = ~x01 & (new_n49_ | x00);
  assign new_n49_ = ~x02 & x09 & ~x10 & ~x17 & ~x18 & ~x19;
  ...
  assign new_n58_ = x01 & (~x01 | ~x02 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z10 = (new_n69_ & ~x00 & x01 & x18) | (~x01 & (x00 | (new_n67_ & new_n68_)));
  assign new_n67_ = x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n68_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n69_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = (new_n72_ & ~x00 & x01 & x18) | (~x01 & (x00 | (new_n67_ & new_n71_)));
  ...
  assign z15 = (~x01 & (x00 | (~x02 & x19))) | (x00 & (~x02 | ~x10));
  assign z16 = ~x00 & x01;
