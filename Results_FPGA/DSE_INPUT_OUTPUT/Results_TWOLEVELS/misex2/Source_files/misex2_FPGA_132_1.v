...
module FAU ( 
  ...
  assign z00 = (~x06 & x09) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = x09 & (~x06 | (new_n46_ & ~x00 & ~x01 & ~x02));
  assign z02 = x09 & (~x06 | (new_n49_ & ~x00 & ~x01 & ~x02));
  ...
  assign z06 = (~x06 & x09) | (x00 & x01 & x02 & new_n58_ & ~x09);
  assign new_n58_ = x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | (~x06 & x09)) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = x19 & new_n62_ & ~x18;
  assign new_n62_ = x17 & ~x09 & ~x08 & ~x07 & new_n63_ & ~x06;
  ...
  assign new_n77_ = (~x23 | (~x02 & (~x06 | ~x19))) & (x02 | ~x17 | x19);
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~new_n51_ & ~x19;
  assign z14 = (~x06 & x09) | (new_n49_ & ~x00 & ~x01 & ~x02 & ~x09);
