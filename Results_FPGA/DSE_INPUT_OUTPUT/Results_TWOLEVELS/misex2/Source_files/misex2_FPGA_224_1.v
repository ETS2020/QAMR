...
module FAU ( 
  ...
  assign z09 = (~x01 & x11) | (~x00 & ~x21 & ~new_n63_ & ~x22);
  assign new_n63_ = ~new_n65_ & (~new_n64_ | x14 | x15 | x16 | ~x20);
  assign new_n64_ = x12 & ~x13 & ~x01 & x02;
  ...
  assign z11 = (~x01 & x11) | (~x00 & ~x22 & (new_n71_ | new_n72_));
  ...
  assign new_n78_ = ~x11 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
