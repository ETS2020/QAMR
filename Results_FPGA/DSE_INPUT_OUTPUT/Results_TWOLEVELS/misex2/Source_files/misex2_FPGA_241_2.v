...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n57_, new_n60_, new_n61_, new_n62_,
    new_n63_, new_n65_, new_n67_, new_n69_, new_n70_;
  ...
  assign z09 = new_n60_ | (new_n63_ & ~x21 & ~x22 & ~x19 & ~x20);
  assign new_n60_ = ~x01 & (x00 | (new_n61_ & new_n62_ & ~x15 & ~x16));
  assign new_n61_ = x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n62_ = x20 & ~x21 & ~x22;
  assign new_n63_ = ~x00 & x01 & x18;
  assign z10 = new_n65_ | (new_n63_ & x21 & x22 & ~x19 & ~x20);
  assign new_n65_ = ~x01 & (x00 | (new_n61_ & new_n62_ & x15 & x16));
  assign z11 = new_n67_ | (new_n63_ & x21 & ~x22 & ~x19 & ~x20);
  assign new_n67_ = ~x01 & (x00 | (new_n61_ & new_n62_ & x15 & ~x16));
  assign z12 = (x09 & ~x24 & ((~new_n69_ & x00) | (~new_n70_ & ~x01))) | (x00 & ~x01);
