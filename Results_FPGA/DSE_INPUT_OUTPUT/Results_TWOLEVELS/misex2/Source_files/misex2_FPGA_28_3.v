// Benchmark "FAU" written by ABC on Mon Aug 24 16:41:53 2020
...
module FAU ( 
  ...
  assign z00 = (x01 & x14) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = (x01 & x14) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = (x01 & x14) | (new_n49_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02 & ~x09);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign new_n52_ = x10 & x11 & x12 & ~x14;
  assign z04 = x01 & (new_n54_ | x14);
  assign new_n54_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (x14 | (x00 & x02 & x09 & x10));
  assign z06 = x01 & (x14 | (new_n57_ & x00));
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (~x12 | (x12 & ~x14));
  assign z07 = (x01 & x14) | (x00 & x02 & (~x01 | (new_n59_ & x01 & ~x09)));
  assign new_n59_ = x10 & x11 & ~x12;
  assign z08 = (x01 & x14) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  assign new_n61_ = ~x03 & x04 & ~x05;
  ...
  assign z10 = (x01 & x14) | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  ...
  assign z12 = (new_n75_ & x09) | (x01 & x14);
  assign new_n75_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n76_ & ~x01));
  assign new_n76_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = (x01 & x14) | (new_n49_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & x14) | (~x01 & ~x02 & x19);
  assign z16 = ~x14 & ~x00 & x01;
  assign z17 = (x01 & x14) | (~x00 & ~x01 & x02);
endmodule
