...
module FAU ( 
  ...
  assign z03 = (x01 & (x06 | (new_n52_ & x00 & x02 & ~x06))) | (new_n53_ & ~x00 & ~x01 & ~x02);
  ...
  assign new_n58_ = x01 & x02 & ~x06 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (~x01 | x06 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z10 = (x01 & x06) | (~x00 & (new_n69_ | (new_n70_ & new_n71_)));
