...
module FAU ( 
  ...
  assign z02 = ~x02 & (x01 | (new_n49_ & ~x00 & x09 & ~x10));
  ...
  assign z06 = x01 & (~x02 | (x00 & ~x09 & x10 & x11));
  assign z07 = (x00 & ((~x01 & x02) | (new_n57_ & x01 & ~x09))) | (x01 & ~x02);
  assign new_n57_ = x10 & x11 & ~x12;
  assign z08 = x19 & ~x18 & x17 & new_n59_ & ~x08;
  assign new_n59_ = ~x07 & ~x06 & ~x05 & x04 & z17 & ~x03;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = (x01 & ~x02) | (~x00 & ~x21 & ~new_n62_ & ~x22);
  ...
  assign z12 = (x01 & (~x02 | (new_n74_ & x00 & x09))) | (~x00 & new_n75_ & x09);
  assign new_n74_ = ~x10 & ~x24;
  assign new_n75_ = ~x24 & ((~x02 & (x19 ? x23 : x17)) | (~x01 & x02 & x23));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x02 & (x01 | (new_n49_ & ~x00 & ~x09 & ~x10));
