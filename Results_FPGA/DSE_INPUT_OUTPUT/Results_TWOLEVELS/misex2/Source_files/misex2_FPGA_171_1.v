// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:40 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n57_, new_n59_, new_n60_,
    new_n62_, new_n65_, new_n68_, new_n69_, new_n72_;
  ...
  assign z06 = x01 & (~x00 | (x00 & x02 & ~x09 & x10 & x11));
  ...
  assign z14 = ~x19 & new_n72_ & ~x18;
  assign new_n72_ = ~x17 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
