...
module FAU ( 
  ...
  assign z08 = x19 & (new_n62_ | x03);
  assign new_n62_ = new_n63_ & x02 & x04 & ~x05 & ~x00 & ~x01;
  assign new_n63_ = ~x06 & ~x07 & ~x08 & x17 & ~x18;
  assign z09 = new_n51_ | (~x00 & ~x21 & ~new_n65_ & ~x22);
  ...
  assign new_n70_ = x16 & x20 & ~x21 & ~x22 & (~x03 | ~x19);
  assign new_n71_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign z11 = new_n51_ | (~x00 & ~x22 & (new_n73_ | new_n75_));
  ...
  assign new_n77_ = ~new_n51_ & (~x02 | ~x10);
  assign new_n78_ = (x19 | (x02 ? ~x23 : ~x17)) & (x03 | ~x19 | ~x23);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & (~x03 | ~x19) & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & ~x03 & x19);
