...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n57_, new_n59_,
    new_n61_, new_n62_, new_n64_, new_n65_, new_n69_, new_n70_;
  ...
  assign z09 = ~x00 & (x01 | (new_n64_ & new_n65_ & ~x15 & ~x16));
  assign new_n64_ = x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n65_ = x20 & ~x21 & ~x22;
  assign z10 = ~x00 & (x01 | (new_n64_ & new_n65_ & x15 & x16));
  assign z11 = ~x00 & (x01 | (new_n64_ & new_n65_ & x15 & ~x16));
