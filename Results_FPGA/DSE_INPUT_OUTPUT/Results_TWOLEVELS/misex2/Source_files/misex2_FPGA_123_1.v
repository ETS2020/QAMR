...
module FAU ( 
  ...
  assign z03 = (~x01 & (x20 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  ...
  assign new_n59_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x20);
  assign z08 = ~x01 & (x20 | (new_n61_ & new_n62_));
  assign new_n61_ = ~x00 & x02 & ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = ~x22 & ~x21 & ~x20 & ~x19 & z16 & x18;
  assign z16 = ~x00 & x01;
  assign z10 = (~x01 & x20) | (new_n66_ & ~x19 & ~x20 & x21 & x22);
  assign new_n66_ = ~x00 & x01 & x18;
  assign z11 = (~x01 & x20) | (new_n66_ & ~x19 & ~x20 & x21 & ~x22);
  assign z12 = (~x01 & x20) | (x09 & ~x24 & (new_n69_ | new_n70_));
