// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:24 2020
...
module FAU ( 
  ...
  assign z00 = ~x09 & (x06 | (new_n46_ & ~x00 & ~x01 & ~x02));
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = (x06 & ~x09) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = (x06 & ~x09) | (new_n49_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = new_n52_ | (~x09 & (new_n51_ | x06));
  assign new_n51_ = x00 & x01 & x02 & x10 & x11 & x12;
  assign new_n52_ = ~x00 & ~x01 & ~x02 & ~x17 & x18 & ~x19;
  assign z04 = ~x09 & (new_n54_ | x06);
  assign new_n54_ = x00 & x01 & x02 & x10 & ~x11 & ~x12;
  assign z05 = (x06 & ~x09) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = ~x09 & (x06 | (new_n57_ & x00));
  assign new_n57_ = x01 & x02 & x10 & x11 & (x12 | (~x06 & ~x12));
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (x01 | (x06 & ~x09)) & (~x01 | x06 | x09 | ~x10 | ~x11 | x12);
  assign z08 = x19 & new_n61_ & ~x18;
  assign new_n61_ = x17 & ~x08 & ~x07 & ~x06 & new_n62_ & ~x05;
  assign new_n62_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = new_n67_ | (~x00 & ~x21 & ~new_n64_ & ~x22);
  assign new_n64_ = ~new_n66_ & (~new_n65_ | x01 | ~x02 | x11 | ~x12);
  assign new_n65_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign new_n67_ = x06 & ~x09;
  assign z10 = new_n67_ | (~x00 & (new_n69_ | (new_n70_ & new_n71_)));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = new_n67_ | (~x00 & ~x22 & (new_n73_ | new_n74_));
  assign new_n73_ = new_n70_ & ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 ? new_n76_ : x06;
  assign new_n76_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n77_ & ~x01));
  assign new_n77_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~new_n67_ & ~x19;
  assign z14 = ~x09 & (x06 | (new_n49_ & ~x00 & ~x01 & ~x02));
  assign z15 = ~new_n67_ & ((x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19));
