...
module FAU ( 
  ...
  assign z00 = ~x02 & (x06 | (new_n46_ & ~x00 & ~x01 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x02 & (x06 | (new_n46_ & ~x00 & ~x01 & x09));
  assign z02 = ~x02 & (x06 | (new_n49_ & ~x00 & ~x01 & x09));
  ...
  assign z04 = (~x02 & x06) | (new_n54_ & x00 & x01 & x02);
  ...
  assign z16 = (~x00 & x01) | (~x02 & x06);
  assign z17 = (~x02 & x06) | (~x00 & ~x01 & x02);
endmodule
