...
module FAU ( 
  ...
  assign z03 = (~x01 & (~x11 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  ...
  assign z07 = (x00 & x02 & (~x01 | (new_n58_ & x01 & ~x09))) | (~x01 & ~x11);
