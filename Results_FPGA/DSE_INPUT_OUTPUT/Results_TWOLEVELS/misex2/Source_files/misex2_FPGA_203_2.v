...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n57_, new_n58_, new_n60_, new_n61_,
  ...
  assign new_n50_ = x00 & (~x01 | (new_n51_ & x01 & x10 & x11 & x12));
  assign new_n51_ = x02 & ~x09;
  assign z04 = x00 & (~x01 | (new_n51_ & x10 & ~x11 & ~x12));
  assign z05 = x00 & (~x01 | (x02 & x09 & x10));
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = x00 & (~x01 | (new_n51_ & x01 & x10 & x11 & ~x12));
