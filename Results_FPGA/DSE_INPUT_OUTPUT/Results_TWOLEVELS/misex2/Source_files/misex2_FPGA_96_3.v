...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n57_, new_n59_,
    ...
    new_n71_, new_n73_, new_n74_, new_n76_, new_n77_, new_n80_;
  assign z00 = (x01 & x06) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = (x01 & x06) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = (x01 & x06) | (new_n49_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (x01 & (x06 | (new_n51_ & x00 & x02 & ~x06))) | (new_n52_ & ~x00 & ~x01 & ~x02);
  ...
  assign new_n68_ = new_n69_ & x01 & ~x06 & x18;
  ...
  assign new_n74_ = x01 & ~x06 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n76_ & ~x24;
  assign new_n76_ = x00 ? (~x01 | x06 | (x02 & x10)) : (new_n77_ | x01);
  ...
  assign z15 = (~x02 & ((x00 & (~x01 | ~x06)) | (~x01 & x19))) | (~x06 & ~x10 & x00 & x01);
