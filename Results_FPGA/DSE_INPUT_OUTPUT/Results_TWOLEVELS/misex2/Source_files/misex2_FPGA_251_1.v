...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n64_, new_n66_, new_n67_, new_n70_, new_n71_,
    new_n74_;
  ...
  assign new_n63_ = x20 & ~x16 & ~x14 & new_n64_ & ~x13 & ~x15;
  assign new_n64_ = x12 & ~x11 & x02 & ~x00 & ~x01;
  assign z10 = ~x00 & (x01 | (new_n66_ & new_n67_ & x15 & x16));
  assign new_n66_ = x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n67_ = x20 & ~x21 & ~x22;
  assign z11 = ~x00 & (x01 | (new_n66_ & new_n67_ & x15 & ~x16));
  assign z12 = (~x00 & x01) | (x09 & ~x24 & ((~new_n71_ & ~x00) | (~new_n70_ & x01)));
  assign new_n70_ = x02 & x10;
  assign new_n71_ = x02 ? ~x23 : (x19 ? ~x23 : ~x17);
  assign z13 = ~x00 & (x01 | (~x02 & x17 & ~x19));
  assign z14 = ~x00 & (new_n74_ | x01);
  assign new_n74_ = ~x02 & ~x09 & ~x10 & ~x17 & ~x18 & ~x19;
