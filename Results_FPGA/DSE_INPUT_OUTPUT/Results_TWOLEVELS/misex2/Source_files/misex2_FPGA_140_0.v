// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:27 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n58_, new_n61_,
    new_n62_, new_n63_, new_n65_, new_n66_, new_n67_, new_n69_, new_n70_,
    new_n72_, new_n73_, new_n76_;
  assign z00 = ~x19 & ~x18 & new_n46_ & ~x17;
  assign new_n46_ = x10 & ~x09 & x08 & ~x02 & ~x00 & ~x01;
  assign z01 = ~x19 & ~x18 & ~x17 & new_n48_ & x10;
  assign new_n48_ = x09 & x08 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x18 & ~x17 & new_n48_ & ~x10 & ~x19;
  ...
  assign z14 = ~x01 & (~x08 | (new_n76_ & ~x00 & ~x02 & ~x09));
  assign new_n76_ = ~x10 & ~x17 & ~x18 & ~x19;
