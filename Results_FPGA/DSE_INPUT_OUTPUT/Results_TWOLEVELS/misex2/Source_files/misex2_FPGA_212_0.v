...
module FAU ( 
  ...
  assign z09 = ~x22 & (new_n66_ | ~x15);
  assign new_n66_ = ~x19 & ~x20 & ~x21 & ~x00 & x01 & x18;
  assign z10 = new_n47_ | (~x00 & (new_n68_ | new_n70_));
  assign new_n68_ = new_n69_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n69_ = ~x14 & x16 & x20 & ~x21 & ~x22;
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x22 & (~x15 | (~new_n72_ & ~x00));
  assign new_n72_ = ~new_n73_ & (~new_n74_ | x01 | ~x02 | x11 | ~x12);
