...
module FAU ( 
  ...
  assign new_n52_ = ~x17 & x18 & ~x19 & x20;
  ...
  assign z10 = (~x01 & ~x20) | (~x00 & (new_n69_ | new_n71_));
  assign new_n69_ = new_n70_ & ~x14 & x15 & x16 & ~x21 & ~x22;
  ...
  assign new_n77_ = x20 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
