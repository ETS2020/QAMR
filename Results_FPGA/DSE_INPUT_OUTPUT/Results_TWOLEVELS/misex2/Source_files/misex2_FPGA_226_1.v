...
module FAU ( 
  ...
  assign new_n54_ = x10 & x11 & x12 & ~x20;
  assign z04 = ~x20 & new_n56_ & ~x12;
  assign new_n56_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = (~x09 & x20) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = ~new_n59_ & ~x09;
  assign new_n59_ = ~x20 & (~x00 | ~x01 | ~x02 | ~x10 | ~x11 | x20);
  assign z07 = x00 & ~new_n61_ & x02;
  assign new_n61_ = (x01 | (~x09 & x20)) & (~x01 | x09 | ~x10 | ~x11 | x12 | x20);
  ...
  assign z11 = ~x00 & ~x22 & (new_n74_ | new_n76_);
  ...
  assign z14 = ~x09 & (x20 | (new_n50_ & ~x00 & ~x01 & ~x02));
