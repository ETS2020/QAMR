...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n57_, new_n60_,
  ...
  assign z07 = ~x12 & new_n54_ & x11;
  assign z08 = x19 & new_n60_ & ~x18;
  assign new_n60_ = x17 & ~x08 & ~x07 & ~x06 & new_n61_ & ~x05;
  assign new_n61_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = new_n63_ | (new_n66_ & ~x21 & ~x22 & ~x19 & ~x20);
  assign new_n63_ = ~x01 & (x00 | (new_n64_ & new_n65_ & ~x15 & ~x16));
  assign new_n64_ = x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n65_ = x20 & ~x21 & ~x22;
  assign new_n66_ = ~x00 & x01 & x18;
  assign z10 = new_n68_ | (new_n66_ & ~x19 & ~x20 & x21 & x22);
  assign new_n68_ = ~x01 & (x00 | (new_n64_ & new_n65_ & x15 & x16));
  assign z11 = new_n70_ | (new_n66_ & x21 & ~x22 & ~x19 & ~x20);
  assign new_n70_ = ~x01 & (x00 | (new_n64_ & new_n65_ & x15 & ~x16));
