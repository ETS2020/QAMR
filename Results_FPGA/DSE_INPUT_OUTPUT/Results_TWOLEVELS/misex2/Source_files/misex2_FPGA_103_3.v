...
module FAU ( 
  ...
  assign z04 = x01 & (new_n53_ | x15);
  assign new_n53_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = ~x15 & x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n56_ & x00;
  assign new_n56_ = x01 & x02 & ~x09 & x10 & x11 & ~x15;
  assign z07 = (x00 & x02 & (new_n58_ | ~x01)) | (x01 & x15);
  assign new_n58_ = x11 & ~x12 & ~x15 & x01 & ~x09 & x10;
  assign z08 = (x01 & x15) | (new_n61_ & new_n60_ & ~x00 & ~x01 & x02);
  ...
  assign z10 = ~x00 & (new_n67_ | (new_n69_ & x01 & ~x15 & x18));
  ...
  assign z14 = (x01 & x15) | (new_n79_ & ~x02 & ~x09 & ~x00 & ~x01);
