...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n53_, new_n54_, new_n56_, new_n57_, new_n58_,
    new_n60_, new_n61_, new_n62_, new_n64_, new_n65_, new_n67_;
  ...
  assign z09 = (x01 & (new_n56_ | x00)) | (new_n58_ & new_n57_ & ~x00 & ~x01 & x02);
  assign new_n56_ = x18 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n57_ = ~x11 & x12 & ~x13;
  ...
  assign z11 = ~x00 & ~x22 & (new_n64_ | (new_n61_ & new_n65_));
  assign new_n64_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n65_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = ~x00 & new_n67_ & ~x01;
