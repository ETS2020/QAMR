...
module FAU ( 
  ...
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x05 & x19 & ~x01 & ~x02);
  assign z16 = ~x00 & (x01 | x05);
  assign z17 = ~x00 & (x05 | (~x01 & x02));
endmodule
