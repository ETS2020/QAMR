...
module FAU ( 
  ...
  assign z03 = (x01 & (x06 | (new_n50_ & x00 & x02 & ~x06))) | (new_n51_ & ~x00 & ~x01 & ~x02);
  assign new_n50_ = ~x09 & x10 & x11 & x12;
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n53_ | x06);
  assign new_n53_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (x06 | (x00 & x02 & x09 & x10));
  assign z06 = new_n56_ & x00;
  assign new_n56_ = x01 & x02 & ~x06 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n58_ & x02;
  assign new_n58_ = x01 & (~x01 | x06 | x09 | ~x10 | ~x11 | x12);
  assign z08 = (x01 & x06) | (new_n61_ & new_n60_ & ~x00 & ~x01 & x02);
  ...
  assign new_n65_ = x01 & ~x06 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ((new_n67_ & new_n68_) | (new_n69_ & new_n70_));
  assign new_n67_ = x01 & ~x06 & x18;
  ...
  assign z12 = (x01 & x06) | (x09 & ~x24 & (new_n75_ | new_n76_));
