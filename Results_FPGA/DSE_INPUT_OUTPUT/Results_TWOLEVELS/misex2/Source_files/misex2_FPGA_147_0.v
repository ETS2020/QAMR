...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n59_, new_n60_,
    new_n62_, new_n66_, new_n68_, new_n69_, new_n72_;
  ...
  assign z14 = ~x01 & (~x11 | (new_n72_ & ~x00 & ~x02 & ~x09));
  assign new_n72_ = ~x18 & ~x19 & ~x10 & ~x17;
