...
module FAU ( 
  ...
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (x14 | ~x21);
  assign z09 = new_n47_ | (~x00 & ~new_n65_ & ~x22);
  ...
  assign new_n69_ = new_n70_ & x01 & x14 & x18;
  ...
  assign new_n81_ = ~x10 & ~x17 & ~x18 & ~new_n47_ & ~x19;
