...
module FAU ( 
  ...
  assign z05 = (~x02 & ~x06) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = (~x02 & ~x06) | (x00 & ~new_n58_ & x02);
  assign new_n58_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n72_ = x18 & ~x19 & ~x20 & x21 & (x02 | x06);
  ...
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x02 & (~x06 | (~x01 & x19)));
