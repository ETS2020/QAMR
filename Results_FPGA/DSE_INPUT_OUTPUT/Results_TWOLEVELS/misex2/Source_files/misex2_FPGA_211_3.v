...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n55_, new_n58_, new_n59_,
  ...
  assign z03 = (x00 & x01) | (~x00 & ~x01 & ~x02 & new_n52_ & ~x17);
  ...
  assign z10 = new_n62_ | (new_n63_ & new_n64_ & ~x14 & x15 & x16);
  assign new_n62_ = x01 & (x00 | (new_n52_ & ~x20 & x21 & x22));
  assign new_n63_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n64_ = x20 & ~x21 & ~x22;
  assign z11 = new_n66_ | (new_n63_ & new_n64_ & ~x14 & x15 & ~x16);
  assign new_n66_ = x01 & (x00 | (new_n52_ & ~x20 & x21 & ~x22));
