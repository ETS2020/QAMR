...
module FAU ( 
  ...
  assign z10 = (new_n62_ & new_n63_) | (~new_n61_ & x01);
  assign new_n61_ = ~x00 & (~x18 | x19 | x20 | ~x21 | ~x22);
  assign new_n62_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n63_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (~new_n65_ & x01) | (new_n62_ & new_n66_);
  assign new_n65_ = ~x00 & (~x18 | x19 | x20 | ~x21 | x22);
