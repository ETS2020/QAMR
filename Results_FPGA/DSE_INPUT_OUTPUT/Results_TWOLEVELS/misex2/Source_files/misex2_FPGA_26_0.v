...
module FAU ( 
  ...
  assign z03 = (~x01 & (~x22 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  ...
  assign z06 = (x00 & new_n57_ & x01) | (~x01 & ~x22);
  assign new_n57_ = x02 & ~x09 & x10 & x11;
  assign z07 = (~x01 & ~x22) | (x00 & x02 & (~x01 | (new_n59_ & x01 & ~x09)));
  assign new_n59_ = x10 & x11 & ~x12;
  assign z08 = ~x01 & (~x22 | (new_n61_ & new_n62_));
  assign new_n61_ = ~x00 & x02 & ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = ~new_n64_ & ~x22;
  assign new_n64_ = x01 & (x00 | ~x18 | x19 | x20 | x21);
  ...
  assign new_n70_ = x22 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = ~x01 & (~x22 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (~x22 | (new_n73_ & ~x00 & ~x02 & ~x09));
