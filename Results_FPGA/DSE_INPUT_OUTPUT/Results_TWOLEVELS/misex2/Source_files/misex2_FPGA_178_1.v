...
module FAU ( 
  ...
  assign z04 = x02 & (~x01 | (new_n54_ & x10 & ~x11 & ~x12));
  assign new_n54_ = x00 & ~x09;
  assign z05 = x02 & (~x01 | (x00 & x09 & x10));
  assign z06 = x02 & (~x01 | (x00 & ~x09 & x10 & x11));
  assign z07 = x02 & (~x01 | (new_n54_ & x10 & x11 & ~x12));
  assign z09 = (~x01 & x02) | (new_n59_ & ~x00 & x01 & x18);
  assign new_n59_ = ~x19 & ~x20 & ~x21 & ~x22;
  assign z10 = new_n61_ & x22;
  assign new_n61_ = x21 & ~x20 & ~x19 & x18 & ~x00 & x01;
  assign z11 = new_n61_ & ~x22;
  assign z12 = (~x01 & x02) | (x09 & ~x24 & (new_n64_ | new_n65_));
  assign new_n64_ = x00 & (x02 ? ~x10 : x01);
  assign new_n65_ = ~x00 & ~x01 & (x19 ? x23 : x17);
