...
module FAU ( 
  ...
  assign z02 = ~x10 & (x02 | (new_n50_ & ~x00 & ~x01 & x09));
  ...
  assign z06 = x02 & (~x10 | (x00 & x01 & ~x09 & x10 & x11));
  assign z07 = new_n59_ & x00;
  assign new_n59_ = x02 & x10 & (~x01 | (x01 & ~x09 & x11 & ~x12));
  assign z08 = x19 & new_n61_ & ~x18;
  assign new_n61_ = x17 & x10 & ~x07 & new_n62_ & ~x06 & ~x08;
  ...
  assign z14 = ~x10 & (x02 | (new_n50_ & ~x00 & ~x01 & ~x09));
