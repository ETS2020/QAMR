...
module FAU ( 
  ...
  assign z10 = ~x22 & new_n66_ & ~x21;
  assign new_n66_ = x20 & x16 & x15 & ~x14 & new_n67_ & ~x13;
  assign new_n67_ = x12 & ~x11 & x02 & ~x00 & ~x01;
  assign z11 = ~x00 & (x01 | (new_n63_ & new_n64_ & x15 & ~x16));
  assign z12 = (x09 & ~x24 & ((~new_n71_ & ~x00) | (~new_n70_ & x01))) | (~x00 & x01);
