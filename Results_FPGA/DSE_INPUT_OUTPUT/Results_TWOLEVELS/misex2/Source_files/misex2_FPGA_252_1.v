...
module FAU ( 
  ...
  assign new_n52_ = ~x11 & ~x17 & x18 & ~x19;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & x11) | (x00 & x01 & x02 & new_n55_ & ~x11 & ~x12);
  assign new_n55_ = ~x09 & x10;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = x11 & (~x01 | (x00 & x01 & new_n55_ & x02));
  assign z07 = new_n59_ & x00;
  assign new_n59_ = x02 & ((~x01 & ~x11) | (x01 & ~x09 & x10 & x11 & ~x12));
  ...
  assign z11 = new_n72_ | (~x00 & ~x22 & (new_n73_ | (new_n74_ & new_n75_)));
  assign new_n72_ = ~x01 & x11;
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n74_ = x12 & ~x13 & ~x01 & x02;
  assign new_n75_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = new_n72_ | (x09 & ~x24 & (new_n77_ | new_n78_));
