...
module FAU ( 
  ...
  assign new_n57_ = ~new_n59_ & (~new_n58_ | x14 | x15 | x16 | ~x20);
  assign new_n58_ = x02 & ~x11 & x12 & ~x13;
  assign new_n59_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n61_ | (new_n63_ & x01 & ~x02 & x18));
  assign new_n61_ = new_n62_ & ~x11 & x12 & ~x13 & ~x01 & x02;
  assign new_n62_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n63_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = z04 | (~x00 & ~x22 & (new_n65_ | new_n66_));
  assign new_n65_ = new_n58_ & ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n66_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (x01 & (x02 | (x00 & x09 & ~x24))) | (~x00 & x09 & ~new_n68_ & ~x24);
  assign new_n68_ = (x01 | ((x02 | ~x17 | x19) & (~x19 | ~x23))) & (~x02 | ~x23);
  assign z13 = (x01 & x02) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
