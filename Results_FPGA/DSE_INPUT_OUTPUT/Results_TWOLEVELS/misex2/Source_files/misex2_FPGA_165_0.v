...
module FAU ( 
  ...
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (x13 | x15);
  assign z09 = new_n46_ | (new_n65_ & ~x00 & x01 & x18);
  ...
  assign z11 = new_n46_ | (~x00 & ~new_n71_ & ~x22);
  assign new_n71_ = ~new_n72_ & (~new_n73_ | x01 | ~x02 | x11 | ~x12);
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n73_ = ~x13 & ~x14 & ~x16 & x20 & ~x21;
  assign z12 = new_n46_ | (new_n75_ & x09);
  ...
  assign z14 = ~x00 & ~x01 & ~x02 & new_n79_ & ~x09;
  assign new_n79_ = ~x10 & ~x17 & ~x18 & ~new_n46_ & ~x19;
