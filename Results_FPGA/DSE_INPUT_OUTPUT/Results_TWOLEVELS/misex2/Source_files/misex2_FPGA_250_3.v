...
module FAU ( 
  ...
  assign z04 = x00 & (new_n54_ | x24);
  assign new_n54_ = x01 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = ~x24 & x10 & x09 & x02 & x00 & x01;
  assign z06 = x00 & (x24 | (new_n57_ & x01));
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (~x12 | (x12 & ~x24));
  ...
  assign z10 = x00 ? x24 : (new_n68_ | (new_n69_ & new_n70_));
  ...
  assign z13 = (x00 & x24) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (x00 & x24) | (new_n79_ & ~x02 & ~x09 & ~x00 & ~x01);
  assign new_n79_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (~x02 & (x00 | (~x01 & x19))) | (x00 & (x24 | (x01 & ~x10)));
