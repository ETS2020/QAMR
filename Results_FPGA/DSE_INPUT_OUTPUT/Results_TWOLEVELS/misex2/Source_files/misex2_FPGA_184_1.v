...
module FAU ( 
  ...
  assign z00 = (~x06 & x17) | (new_n46_ & x10 & ~x17 & ~x18 & ~x19);
  ...
  assign new_n73_ = ~new_n51_ & (~x02 | ~x10);
  assign new_n74_ = (~x06 | ~x17 | (~x23 & (x02 | x19))) & (x17 | ~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & new_n48_ & x06;
