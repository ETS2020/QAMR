...
module FAU ( 
  ...
  assign z03 = new_n53_ | (x11 & (new_n52_ | ~x07));
  assign new_n52_ = x00 & x01 & x02 & ~x09 & x10 & x12;
  ...
  assign z06 = ~new_n58_ & x11;
  assign new_n58_ = x07 & (~x00 | ~x01 | ~x02 | x09 | ~x10);
  assign z07 = new_n46_ | (new_n60_ & x00);
  assign new_n60_ = x02 & (~x01 | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = x19 & new_n62_ & ~x18;
  assign new_n62_ = x17 & ~x11 & ~x08 & ~x07 & new_n63_ & ~x06;
  ...
  assign new_n74_ = new_n70_ & ~x16 & x20 & ~x21 & ~x14 & x15;
