// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:33 2020
...
module FAU ( 
  ...
  assign new_n55_ = ~x09 & x10 & ~x11 & ~x12 & (x13 | x22);
  ...
  assign new_n65_ = ~x20 & ~x19 & x18 & x13 & ~x00 & x01;
  assign z10 = new_n46_ | (new_n67_ & ~x00 & x01 & x18);
  ...
  assign z14 = ~x00 & ~x01 & ~x02 & new_n74_ & ~x09;
  assign new_n74_ = ~x10 & ~x17 & ~x18 & ~x19 & (x13 | x22);
