// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:29 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n57_, new_n59_,
    new_n61_, new_n62_, new_n64_, new_n67_, new_n68_, new_n69_, new_n72_,
    new_n73_;
  ...
  assign new_n52_ = x10 & x11 & x12 & x22;
  ...
  assign new_n57_ = x22 & (~x00 | ~x02 | x09 | ~x10 | ~x11 | ~x22);
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12 | ~x22);
  assign z08 = (x01 & ~x22) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  ...
  assign new_n72_ = x00 ? (~x01 | ~x22 | (x02 & x10)) : (new_n73_ | x01);
