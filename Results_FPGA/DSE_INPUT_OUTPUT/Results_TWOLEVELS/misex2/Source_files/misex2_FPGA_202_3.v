// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:53 2020
...
module FAU ( 
  ...
  assign new_n53_ = x12 & ~x14 & x10 & x11;
  ...
  assign new_n58_ = x01 & x02 & ~x09 & x10 & x11 & ~x14;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | (x11 & x14)) & (~x01 | x09 | ~x10 | ~x11 | x12 | x14);
  assign z08 = ~x00 & ~x01 & new_n62_ & x02;
  assign new_n62_ = ~x03 & x04 & ~x05 & ~x06 & new_n63_ & ~x07;
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (~x11 | ~x14);
  ...
  assign new_n74_ = new_n70_ & ~x14 & x15 & ~x16 & x20 & ~x21;
