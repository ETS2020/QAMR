...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n53_ | ~x22)) | (new_n54_ & ~x00 & ~x01 & ~x02);
  assign new_n53_ = x00 & x02 & ~x09 & x10 & x11 & x12;
  assign new_n54_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n56_ | ~x22);
  assign new_n56_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (~x22 | (x00 & x02 & x09 & x10));
  assign z06 = x01 & (~x22 | (new_n59_ & x00));
  assign new_n59_ = x02 & ~x09 & x10 & x11 & (x12 | (~x12 & x22));
  assign z07 = x00 & ~new_n61_ & x02;
  assign new_n61_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12 | ~x22);
  assign z08 = x19 & ~x18 & x17 & ~x08 & new_n63_ & ~x07;
  assign new_n63_ = ~x06 & ~x05 & x04 & ~x03 & new_n49_ & x02;
  assign z09 = ~x22 & (x01 | (new_n66_ & new_n65_ & ~x00 & x02));
  assign new_n65_ = ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20 & ~x21;
  assign z10 = ~x00 & (new_n68_ | (new_n69_ & new_n65_ & ~x01 & x02));
  assign new_n68_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n69_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = ~x22 & ~x21 & x20 & ~x16 & new_n71_ & x15;
  assign new_n71_ = ~x14 & ~x13 & x12 & ~x11 & new_n49_ & x02;
  assign z12 = (new_n73_ & x09) | (x01 & ~x22);
