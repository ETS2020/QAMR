...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n53_, new_n54_, new_n56_, new_n57_, new_n58_,
    new_n60_, new_n61_, new_n62_, new_n64_, new_n65_, new_n67_, new_n70_;
  ...
  assign z10 = (new_n61_ & new_n62_) | (~new_n60_ & x01);
  assign new_n60_ = ~x00 & (~x18 | x19 | x20 | ~x21 | ~x22);
  assign new_n61_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n62_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (~new_n64_ & x01) | (new_n61_ & new_n65_);
