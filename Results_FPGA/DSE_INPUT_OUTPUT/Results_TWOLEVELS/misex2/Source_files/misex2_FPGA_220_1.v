...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n58_,
    new_n60_, new_n62_, new_n63_, new_n65_, new_n66_, new_n67_, new_n71_,
    new_n72_, new_n74_, new_n75_;
  assign z00 = ~x19 & ~x18 & ~x17 & ~x16 & new_n46_ & x10;
  assign new_n46_ = ~x09 & ~x02 & ~x00 & ~x01;
  assign z01 = ~x19 & ~x18 & new_n48_ & ~x17;
  assign new_n48_ = ~x16 & x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x01 & (x16 | (new_n50_ & ~x00 & ~x02 & x09));
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (~x01 & (x16 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & x16) | (new_n55_ & x00 & x01 & x02);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = (~x01 & x16) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = (~x01 & x16) | (x00 & new_n58_ & x01);
  assign new_n58_ = x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x16);
  assign z08 = x19 & new_n62_ & ~x18;
  assign new_n62_ = x17 & ~x16 & ~x08 & ~x07 & new_n63_ & ~x06;
  assign new_n63_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = (~x01 & x16) | (~x00 & ~x21 & ~new_n65_ & ~x22);
  assign new_n65_ = ~new_n67_ & (~new_n66_ | x13 | x14 | x15 | ~x20);
  assign new_n66_ = ~x01 & x02 & ~x11 & x12;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = x22 & x21 & ~x20 & ~x19 & z16 & x18;
  assign z16 = ~x00 & x01;
  assign z11 = (~x01 & x16) | (~x00 & ~x22 & (new_n71_ | new_n72_));
  assign new_n71_ = new_n66_ & ~x13 & ~x14 & x15 & x20 & ~x21;
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (new_n74_ & x09) | (~x01 & x16);
  ...
  assign z14 = ~x19 & ~x18 & ~x17 & ~x16 & new_n46_ & ~x10;
  assign z15 = (x00 & ((~x02 & ~x16) | (x01 & (~x02 | ~x10)))) | (~x16 & x19 & ~x01 & ~x02);
