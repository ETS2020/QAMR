...
module FAU ( 
  ...
  assign z00 = ~x19 & (~x15 | (new_n46_ & new_n47_ & ~x09 & x10));
  assign new_n46_ = ~x00 & ~x01 & ~x02;
  assign new_n47_ = ~x17 & ~x18;
  assign z01 = ~x19 & (~x15 | (new_n46_ & new_n47_ & x09 & x10));
  assign z02 = ~x19 & (~x15 | (new_n46_ & new_n47_ & x09 & ~x10));
  assign z03 = (x00 & x01 & new_n51_ & x02) | (new_n53_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = ~x09 & x10 & x11 & ~new_n52_ & x12;
  assign new_n52_ = ~x15 & ~x19;
  assign new_n53_ = x18 & ~x19 & x15 & ~x17;
  assign z04 = new_n52_ | (new_n55_ & x00 & x01 & x02);
  assign new_n55_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = new_n52_ | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & ~new_n52_ & x11;
  assign z07 = new_n52_ | (x00 & x02 & (~x01 | (new_n60_ & x01)));
  assign new_n60_ = ~x09 & x10 & x11 & ~new_n52_ & ~x12;
  ...
  assign new_n76_ = ~new_n52_ & (~x02 | ~x10);
  assign new_n77_ = (~x19 | ~x23) & (~x15 | (x02 ? ~x23 : (~x17 | x19)));
  assign z13 = ~x19 & (~x15 | (~x00 & ~x01 & ~x02 & x17));
  assign z14 = ~x19 & (~x15 | (new_n46_ & new_n47_ & ~x09 & ~x10));
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x15 & ~x19) | (~x01 & ~x02 & x19);
