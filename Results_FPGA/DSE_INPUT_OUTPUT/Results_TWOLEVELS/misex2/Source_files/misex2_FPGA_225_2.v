...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n56_, new_n59_, new_n60_, new_n61_,
    new_n63_, new_n64_, new_n65_, new_n66_, new_n68_, new_n69_, new_n71_,
    new_n72_;
  assign z00 = ~x09 & (new_n46_ | x01);
  ...
  assign z03 = (x01 & ~x09) | (new_n51_ & ~x00 & ~x01 & ~x02);
  ...
  assign z09 = z04 | (~x00 & ~x21 & ~new_n59_ & ~x22);
  assign new_n59_ = ~new_n61_ & (~new_n60_ | x01 | ~x02 | x11 | ~x12);
  assign new_n60_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n61_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n63_ | (new_n65_ & new_n66_));
  assign new_n63_ = new_n64_ & x01 & x09 & x18;
  assign new_n64_ = ~x19 & ~x20 & x21 & x22;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = z04 | (~x00 & ~x22 & (new_n68_ | new_n69_));
  assign new_n68_ = new_n65_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (x01 & ~x09) | (~x24 & (x00 ? (~new_n71_ & x01) : (~x01 & ~new_n72_ & x09)));
  ...
  assign z15 = (~x02 & ((x00 & (~x01 | x09)) | (~x01 & x19))) | (x00 & x01 & x09 & ~x10);
