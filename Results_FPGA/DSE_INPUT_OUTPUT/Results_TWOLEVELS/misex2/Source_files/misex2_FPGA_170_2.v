...
module FAU ( 
  ...
  assign new_n54_ = x10 & (~x00 | ~x02 | x09 | x11 | x12);
  assign z05 = x01 & (~x10 | (x00 & x02 & x09));
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = (x01 & ~x10) | (x00 & x02 & (~x01 | (x01 & ~x09 & new_n58_ & x10)));
  ...
  assign new_n73_ = x01 & x10 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (x01 & (~x10 | (new_n75_ & x00 & ~x02))) | (~x00 & new_n76_ & ~x01);
