...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n50_, new_n55_, new_n58_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n64_, new_n65_, new_n67_, new_n69_;
  ...
  assign z10 = new_n62_ | (new_n64_ & new_n65_ & ~x14 & x15 & x16);
  assign new_n62_ = x01 & (x00 | (new_n63_ & ~x20 & x21 & x22));
  assign new_n63_ = x18 & ~x19;
  assign new_n64_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = x20 & ~x21 & ~x22;
  assign z11 = new_n67_ | (new_n64_ & new_n65_ & ~x14 & x15 & ~x16);
  assign new_n67_ = x01 & (x00 | (new_n63_ & ~x20 & x21 & ~x22));
