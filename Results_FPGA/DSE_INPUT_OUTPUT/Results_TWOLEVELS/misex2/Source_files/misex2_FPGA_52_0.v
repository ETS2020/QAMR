...
module FAU ( 
  ...
  assign z12 = (~x10 & ~x21) | (new_n77_ & x09);
  ...
  assign z14 = x21 & ~x19 & new_n82_ & ~x18;
  assign new_n82_ = ~x17 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
  assign z15 = (~x02 & (x10 | x21) & (x00 | (~x01 & x19))) | (x00 & x01 & ~x10 & x21);
