...
module FAU ( 
  ...
  assign z12 = x09 & (new_n78_ | new_n79_) & ~x24;
  assign new_n78_ = x17 & ((x00 & x01 & (~x02 | ~x10)) | (~x00 & ~x01 & ~x02 & ~x19));
  assign new_n79_ = ~x00 & ~x01 & x23 & (x02 | x19);
  assign z13 = ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x17 & (x01 | (new_n50_ & ~x00 & ~x02 & ~x09));
