...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n65_, new_n66_, new_n69_, new_n70_, new_n73_;
  ...
  assign new_n65_ = ~x01 & x12;
  assign new_n66_ = ~x00 & x01 & x18;
  assign z11 = new_n65_ | (new_n66_ & ~x19 & ~x20 & x21 & ~x22);
  assign z12 = new_n65_ | (x09 & ~x24 & (new_n69_ | new_n70_));
  assign new_n69_ = x00 & x01 & (~x02 | ~x10);
  assign new_n70_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = ~x19 & x17 & ~x12 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & ~x18 & new_n73_ & ~x17;
  assign new_n73_ = ~x12 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
