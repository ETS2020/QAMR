...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n56_, new_n58_,
    ...
    new_n79_, new_n82_;
  assign z00 = ~x19 & (~x03 | (new_n46_ & ~x00 & ~x01 & ~x02));
  ...
  assign new_n51_ = x03 & (x00 | x01 | x02 | x17 | ~x18);
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x03 & ~x19) | (new_n54_ & x00 & x01 & x02);
  assign new_n54_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = new_n56_ | (~x03 & ~x19);
  assign new_n56_ = x00 & x01 & x02 & x09 & x10;
  assign z06 = (~x03 & ~x19) | (x00 & x01 & new_n58_ & x02);
  assign new_n58_ = ~x09 & x10 & x11 & (x12 | (~x12 & (x03 | x19)));
  assign z07 = x00 & x02 & ~new_n60_ & (x03 | x19);
  assign new_n60_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x03 & (new_n62_ | ~x19);
  assign new_n62_ = new_n63_ & ~x00 & ~x01 & x02 & x04 & ~x05;
  assign new_n63_ = ~x06 & ~x07 & ~x08 & x17 & ~x18;
  assign z09 = (~x03 & ~x19) | (~x00 & ~x21 & ~new_n65_ & ~x22);
  ...
  assign new_n75_ = x15 & ~x16 & x20 & ~x21 & (x03 | x19);
  assign new_n76_ = ~x19 & ~x20 & x21;
  assign z12 = (~x03 & ~x19) | (new_n78_ & x09);
  ...
  assign z14 = ~x19 & (~x03 | (new_n82_ & ~x00 & ~x01 & ~x02));
  assign new_n82_ = ~x17 & ~x18 & ~x09 & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x03 & ~x19) | (~x01 & ~x02 & x19);
  assign z16 = (~x03 & ~x19) | (~x00 & x01);
