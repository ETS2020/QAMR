...
module FAU ( 
  ...
  assign z06 = x01 & (x15 | (new_n57_ & x00));
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (~x12 | (x12 & ~x15));
  assign z07 = (x01 & x15) | (x00 & x02 & (~x01 | (new_n59_ & x01 & ~x09)));
  assign new_n59_ = x10 & x11 & ~x12;
  assign z08 = (x01 & x15) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  assign new_n61_ = ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = ~x00 & ~x15 & ~x21 & ~new_n64_ & ~x22;
  assign new_n64_ = ~new_n66_ & (~new_n65_ | x11 | ~x12 | x01 | ~x02);
  assign new_n65_ = ~x13 & ~x14 & ~x16 & x20;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = ~x00 & (new_n68_ | (new_n70_ & new_n71_));
  assign new_n68_ = new_n69_ & x01 & ~x15 & x18;
  ...
  assign new_n74_ = x01 & ~x15 & x18 & ~x19 & ~x20 & x21;
