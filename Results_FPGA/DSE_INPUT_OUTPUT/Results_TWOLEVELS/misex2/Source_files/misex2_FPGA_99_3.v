...
module FAU ( 
  ...
  assign z00 = (x01 & x19) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  ...
  assign z03 = ~x19 & ((new_n51_ & x00 & x01 & x02) | (~x00 & ~x01 & new_n52_ & ~x02));
  ...
  assign z12 = (x01 & x19) | (new_n75_ & x09);
  assign new_n75_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : ~new_n76_);
  assign new_n76_ = (~x19 | ~x23) & (x01 | (x02 ? ~x23 : (~x17 | x19)));
  assign z13 = (x01 & x19) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
