...
module FAU ( 
  ...
  assign z03 = (~x01 & (~x09 | (new_n50_ & ~x00 & ~x02))) | (new_n51_ & x00 & x01 & x02);
  ...
  assign new_n59_ = ~x08 & ~x07 & ~x06 & new_n60_ & ~x05 & x09;
  assign new_n60_ = x04 & ~x03 & ~x00 & ~x01 & x02;
  assign z09 = z00 | (~x00 & ~x21 & ~new_n62_ & ~x22);
  ...
  assign z12 = (~x01 & ~x09) | (~x24 & (x00 ? (x01 & ~new_n74_ & x09) : (~new_n75_ & ~x01)));
