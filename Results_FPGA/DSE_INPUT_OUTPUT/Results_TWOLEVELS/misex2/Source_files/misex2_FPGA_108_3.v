...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n58_,
    ...
    new_n71_, new_n73_, new_n74_, new_n75_, new_n77_, new_n78_;
  ...
  assign z02 = (x01 & x20) | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (new_n52_ & ~x00 & ~x01 & ~x02) | (new_n53_ & x00 & x01 & x02 & ~x09);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = x10 & x11 & x12 & ~x20;
  assign z04 = x01 & (new_n55_ | x20);
  assign new_n55_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (x20 | (x00 & x02 & x09 & x10));
  assign z06 = ~new_n58_ & x01;
  assign new_n58_ = ~x20 & (~x00 | ~x02 | x09 | ~x10 | ~x11 | x20);
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (~x11 | x12 | x20 | ~x01 | x09 | ~x10);
  ...
  assign z10 = (x01 & x20) | (~x00 & (new_n69_ | (new_n71_ & x01 & x18)));
  assign new_n69_ = new_n70_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n70_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n71_ = ~x19 & x21 & x22;
  assign z11 = ~x00 & ~x22 & (new_n73_ | new_n75_);
  assign new_n73_ = new_n74_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n74_ = ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n75_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n77_ & ~x24;
  assign new_n77_ = x00 ? (~x01 | x20 | (x02 & x10)) : (new_n78_ | x01);
  assign new_n78_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = (x01 & x20) | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & x20) | (~x01 & ~x02 & x19);
