// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:28 2020
...
module FAU ( 
  ...
  assign z00 = (x01 & ~x16) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x19 & ~x18 & ~x17 & x10 & new_n48_ & x09;
  assign new_n48_ = ~x02 & ~x00 & ~x01;
  assign z02 = (x01 & ~x16) | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n50_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n52_ & ~x00 & ~x01 & ~x02) | (new_n53_ & x00 & x01 & x02 & ~x09);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = x10 & x11 & x12 & x16;
  assign z04 = x16 & new_n55_ & ~x12;
  assign new_n55_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x01 & (~x16 | (x00 & x02 & x09 & x10));
  assign z06 = x01 & (~x16 | (new_n58_ & x00));
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (~x12 | (x12 & x16));
  assign z07 = (x01 & ~x16) | (x00 & x02 & (~x01 | (new_n60_ & x01 & ~x09)));
  assign new_n60_ = x10 & x11 & ~x12;
  assign z08 = (x01 & ~x16) | (new_n63_ & new_n62_ & ~x00 & ~x01 & x02);
  ...
  assign new_n67_ = x01 & x16 & x18 & ~x19 & ~x20;
  assign z10 = (x01 & ~x16) | (~x00 & (new_n69_ | (new_n70_ & new_n71_)));
