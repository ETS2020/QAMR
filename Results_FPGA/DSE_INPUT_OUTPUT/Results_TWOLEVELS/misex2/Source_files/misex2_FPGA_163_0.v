...
module FAU ( 
  ...
  assign z07 = x00 & ~new_n46_ & ~new_n61_ & x02;
  assign new_n61_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x06 & (new_n63_ | ~x16);
  assign new_n63_ = new_n64_ & ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n64_ = x17 & ~x18 & x19 & ~x05 & ~x07 & ~x08;
  ...
  assign new_n75_ = new_n76_ & x06 & ~x11 & x12 & ~x01 & x02;
  assign new_n76_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
