...
module FAU ( 
  ...
  assign new_n57_ = x01 & (~x01 | ~x02 | x09 | ~x10 | ~x11 | x12);
  assign z08 = x19 & ~x18 & x17 & new_n59_ & ~x08;
  assign new_n59_ = ~x07 & ~x06 & ~x05 & x04 & z17 & ~x03;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n62_ | (new_n65_ & ~x21 & ~x22 & ~x19 & ~x20);
  assign new_n62_ = ~x01 & (x00 | (new_n63_ & new_n64_ & ~x15 & ~x16));
  ...
  assign z11 = new_n71_ | (new_n65_ & x21 & ~x22 & ~x19 & ~x20);
  assign new_n71_ = ~x01 & (x00 | (new_n63_ & new_n64_ & x15 & ~x16));
