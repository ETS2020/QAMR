...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n50_, new_n52_, new_n53_, new_n55_, new_n58_,
  ...
  assign z02 = new_n49_ | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n49_ = x15 & x17;
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = new_n49_ | (new_n52_ & ~x00 & ~x01 & ~x02) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = new_n49_ | (new_n55_ & x00 & x01 & x02);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n49_ & x10;
  assign z06 = new_n49_ | new_n58_;
  assign new_n58_ = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = new_n49_ | (new_n60_ & x00);
  assign new_n60_ = x02 & (~x01 | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = x17 & (x15 | (new_n62_ & new_n63_));
  assign new_n62_ = ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n63_ = ~x05 & ~x06 & ~x07 & ~x08 & ~x18 & x19;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n65_ | (new_n66_ & new_n67_));
  assign new_n65_ = x01 & x18 & ~x19 & ~x20 & (~x15 | ~x17);
  assign new_n66_ = ~x01 & x02 & ~x11 & x12;
  assign new_n67_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign z10 = new_n49_ | (~x00 & (new_n69_ | (new_n70_ & new_n71_)));
  ...
  assign new_n73_ = x18 & ~x19 & ~x20 & x21 & (~x15 | ~x17);
  assign new_n74_ = ~x14 & x15 & ~x16 & ~x17 & x20 & ~x21;
  assign z12 = new_n49_ | (x09 & ~x24 & (new_n76_ | new_n77_));
  assign new_n76_ = x00 & x01 & (~x02 | ~x10);
  assign new_n77_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = ~x19 & x17 & new_n46_ & ~x15;
  assign z14 = new_n49_ | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | new_n49_ | (~x01 & ~x02 & x19);
  assign z16 = new_n49_ | (~x00 & x01);
  assign z17 = new_n49_ | (~x00 & ~x01 & x02);
endmodule
