...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n53_, new_n58_, new_n60_,
  ...
  assign z04 = (~x00 & x11) | (x00 & x01 & x02 & new_n52_ & ~x11 & ~x12);
  ...
  assign new_n60_ = x17 & ~x08 & ~x07 & new_n61_ & ~x06 & ~x11;
  assign new_n61_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & (x11 | (~x21 & ~new_n63_ & ~x22));
  assign new_n63_ = ~new_n65_ & (~new_n64_ | x14 | x15 | x16 | ~x20);
  assign new_n64_ = ~x01 & x02 & x12 & ~x13;
  assign new_n65_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (x11 | new_n67_ | new_n69_);
  assign new_n67_ = new_n68_ & ~x01 & x02 & x12 & ~x13 & ~x14;
  assign new_n68_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n69_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign z11 = ~x00 & ~x11 & ~x22 & (new_n71_ | new_n72_);
  ...
  assign z14 = ~x00 & (x11 | (new_n78_ & ~x01 & ~x02 & ~x09));
  assign new_n78_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x00 & x11) | (~x01 & ~x02 & x19);
  assign z16 = ~x00 & (x01 | x11);
