...
module FAU ( 
  ...
  assign z02 = ~x01 & (new_n50_ | x00);
  assign new_n50_ = ~x02 & x09 & ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (x00 & (~x01 | (new_n52_ & x02 & ~x09))) | (new_n53_ & ~x01 & ~x02);
  assign new_n52_ = x10 & x11 & x12;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = ~new_n55_ & x00;
  assign new_n55_ = x01 & (~x02 | x09 | ~x10 | x11 | x12);
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = ~new_n58_ & x00;
  assign new_n58_ = x01 & (~x02 | x09 | ~x10 | ~x11 | (~x12 & (~x01 | x12)));
  assign z07 = new_n60_ & ~x12;
  assign new_n60_ = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z08 = ~x01 & (x00 | (new_n62_ & new_n63_));
  assign new_n62_ = x02 & ~x03 & x04 & ~x05 & ~x06;
  ...
  assign z10 = (~x01 & (x00 | (new_n69_ & new_n70_))) | (new_n71_ & ~x00 & x01 & x18);
  assign new_n69_ = x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n70_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n71_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = (~x01 & (x00 | (new_n69_ & new_n73_))) | (new_n74_ & ~x00 & x01 & x18);
  assign new_n73_ = x15 & ~x16 & x20 & ~x21 & ~x22;
  assign new_n74_ = ~x19 & ~x20 & x21 & ~x22;
  assign z12 = x09 & ~x24 & (new_n76_ | new_n77_);
  assign new_n76_ = x00 & x01 & (~x02 | ~x10);
  assign new_n77_ = ~x00 & ~x01 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
