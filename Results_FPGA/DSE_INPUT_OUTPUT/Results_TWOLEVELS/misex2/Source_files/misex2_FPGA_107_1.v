...
module FAU ( 
  ...
  assign z01 = new_n48_ | (new_n49_ & ~x02 & x09 & ~x00 & ~x01);
  ...
  assign z08 = new_n48_ | (new_n64_ & new_n63_ & ~x03 & x04 & ~x05);
  assign new_n63_ = ~x00 & ~x01 & x02;
  assign new_n64_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = new_n48_ | (~x00 & ~x21 & (new_n66_ | (new_n67_ & new_n68_)));
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign new_n67_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x16 & x20 & ~x22 & ~x14 & ~x15;
  assign z10 = new_n48_ | (new_n70_ & new_n63_ & ~x11 & x12 & ~x13);
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n48_ | (~x00 & (new_n72_ | (new_n67_ & new_n73_)));
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n73_ = x20 & ~x21 & ~x22 & ~x14 & x15 & ~x16;
  assign z12 = x09 & ~x24 & ~new_n48_ & (new_n75_ | new_n76_);
  assign new_n75_ = x00 & x01 & (~x02 | ~x10);
  assign new_n76_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
