...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n55_, new_n58_,
    ...
    new_n79_, new_n82_;
  assign z00 = ~x19 & (x03 | (new_n46_ & new_n47_ & ~x17 & ~x18));
  ...
  assign z03 = (~new_n52_ & ~x19) | (new_n53_ & new_n47_ & x11 & x12);
  assign new_n52_ = ~x03 & (x00 | x01 | x02 | x17 | ~x18);
  assign new_n53_ = x00 & x01 & x02;
  assign z04 = new_n55_ | (new_n53_ & new_n47_ & ~x11 & ~x12);
  ...
  assign z08 = (x03 & ~x19) | (new_n63_ & new_n62_ & ~x03 & x04 & ~x05);
  ...
  assign z12 = new_n55_ | (new_n78_ & x09);
  ...
  assign z14 = ~x19 & (x03 | (new_n46_ & new_n82_));
  assign new_n82_ = ~x09 & ~x10 & ~x17 & ~x18;
