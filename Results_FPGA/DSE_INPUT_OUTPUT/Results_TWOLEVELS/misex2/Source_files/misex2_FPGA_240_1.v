...
module FAU ( 
  ...
  assign z01 = ~x01 & (x05 | (new_n48_ & new_n49_ & x10 & ~x17));
  assign new_n48_ = ~x00 & ~x02 & x09;
  assign new_n49_ = ~x18 & ~x19;
  assign z02 = ~x01 & (x05 | (new_n48_ & new_n49_ & ~x10 & ~x17));
  assign z03 = (~x01 & (x05 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & x05) | (new_n55_ & x00 & x01 & x02);
  ...
  assign z11 = (~x01 & x05) | (new_n73_ & ~x00);
