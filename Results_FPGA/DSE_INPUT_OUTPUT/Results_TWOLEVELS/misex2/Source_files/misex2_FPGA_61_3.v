...
module FAU ( 
  ...
  assign z01 = (x00 & x08) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & x09;
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02 & ~x08);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign new_n52_ = x11 & x12 & ~x09 & x10;
  assign z04 = x00 & (new_n54_ | x08);
  assign new_n54_ = x01 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x10 & x09 & ~x08 & x02 & x00 & x01;
  assign z06 = ~new_n57_ & x00;
  assign new_n57_ = ~x08 & (~x01 | ~x02 | x08 | x09 | ~x10 | ~x11);
  assign z07 = x00 & new_n59_ & x02;
  assign new_n59_ = ~x08 & (~x01 | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = (x00 & x08) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  ...
  assign new_n75_ = x00 ? (~x01 | x08 | (x02 & x10)) : (new_n76_ | x01);
  assign new_n76_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = (x00 & x08) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (x00 & x08) | (new_n79_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n79_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (x00 & ~x08 & (~x02 | (x01 & ~x10))) | (~x00 & ~x01 & ~x02 & x19);
  assign z16 = ~x00 & x01;
