...
module FAU ( 
  ...
  assign z09 = ~x00 & (new_n62_ | x01);
  assign new_n62_ = new_n63_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n63_ = ~x15 & ~x16 & x20 & ~x21 & ~x22;
  assign z10 = ~x22 & ~x21 & x20 & new_n65_ & x16;
  assign new_n65_ = x15 & new_n66_ & ~x14;
  assign new_n66_ = ~x13 & x12 & ~x11 & x02 & ~x00 & ~x01;
  assign z11 = ~x22 & ~x21 & x20 & new_n65_ & ~x16;
  assign z12 = (x09 & ~x24 & ((~new_n70_ & ~x00) | (~new_n69_ & x01))) | (~x00 & x01);
