...
module FAU ( 
  ...
  assign z07 = (x00 & x02 & (~x01 | (new_n58_ & x01 & ~x09))) | (~x01 & x06);
  ...
  assign new_n64_ = ~x01 & x02 & ~x06 & ~x11 & x12;
  assign new_n65_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (~x01 & x06) | (~x00 & (new_n67_ | new_n69_));
  ...
  assign z12 = (~x01 & x06) | (new_n74_ & x09);
  assign new_n74_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n75_ & ~x01));
  assign new_n75_ = (~x23 | (~x02 & (x06 | ~x19))) & (x02 | ~x17 | x19);
  assign z13 = ~x01 & (x06 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & new_n78_ & ~x17;
  assign new_n78_ = ~x10 & ~x09 & ~x06 & ~x02 & ~x00 & ~x01;
  assign z15 = (x00 & ((~x02 & ~x06) | (x01 & (~x02 | ~x10)))) | (~x01 & ~x02 & ~x06 & x19);
