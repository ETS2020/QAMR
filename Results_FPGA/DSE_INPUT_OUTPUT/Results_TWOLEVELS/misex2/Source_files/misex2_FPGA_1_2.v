// Benchmark "FAU" written by ABC on Mon Aug 24 16:41:44 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n58_, new_n61_, new_n62_,
    new_n63_, new_n64_, new_n66_, new_n68_, new_n70_, new_n71_, new_n74_;
  ...
  assign z10 = new_n66_ | (new_n64_ & x21 & x22 & ~x19 & ~x20);
  assign new_n66_ = ~x01 & (x00 | (new_n62_ & new_n63_ & x15 & x16));
  assign z11 = new_n68_ | (new_n64_ & x21 & ~x22 & ~x19 & ~x20);
  assign new_n68_ = ~x01 & (x00 | (new_n62_ & new_n63_ & x15 & ~x16));
  assign z12 = (x09 & ~x24 & ((~new_n70_ & x00) | (~new_n71_ & ~x01))) | (x00 & ~x01);
  assign new_n70_ = x02 & x10;
  assign new_n71_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x19 & new_n74_ & ~x18;
  assign new_n74_ = ~x17 & ~x10 & ~x09 & ~x02 & ~x00 & ~x01;
