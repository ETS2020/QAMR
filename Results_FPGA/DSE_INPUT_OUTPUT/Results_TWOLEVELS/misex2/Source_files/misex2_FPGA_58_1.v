...
module FAU ( 
  ...
  assign new_n46_ = ~x17 & ~x18 & ~x19 & (x15 | ~x22);
  ...
  assign z03 = ~new_n48_ & ((new_n52_ & x00 & x01 & x02) | (new_n53_ & ~x00 & ~x01 & ~x02));
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n55_ & x02;
  assign new_n55_ = ~x09 & x10 & ~x11 & ~x12 & (x15 | ~x22);
  assign z05 = new_n48_ | (x02 & x09 & x10 & x00 & x01);
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (x15 | ~x22);
  ...
  assign z09 = new_n48_ | (~x00 & ~x21 & (new_n67_ | (new_n65_ & new_n66_)));
  assign new_n65_ = ~x01 & x02 & ~x11 & x12;
  assign new_n66_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20 & ~x22;
  assign z10 = ~x00 & x15 & (new_n69_ | (new_n70_ & new_n71_));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (~x15 & x22) | (~x00 & ~x22 & (new_n73_ | (new_n70_ & new_n74_)));
