...
module FAU ( 
  ...
  assign new_n48_ = x09 & ~x04 & ~x02 & ~x00 & ~x01;
  ...
  assign z06 = (x00 & new_n57_ & x01) | (~x01 & x04);
  ...
  assign z10 = (~x01 & x04) | (~x00 & (new_n65_ | (new_n66_ & new_n67_)));
  assign new_n65_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n66_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n69_ | (new_n61_ & new_n70_));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n70_ = ~x13 & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = (~x01 & x04) | (x09 & ~x24 & (new_n72_ | new_n73_));
