...
module FAU ( 
  ...
  assign new_n68_ = x01 & x17 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ((new_n70_ & new_n71_) | (new_n72_ & new_n73_));
  assign new_n70_ = x01 & x17 & x18;
  assign new_n71_ = ~x19 & ~x20 & x21 & x22;
  assign new_n72_ = ~x11 & x12 & ~x13 & ~x01 & x02;
  assign new_n73_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n57_ | (~x00 & ~x22 & (new_n75_ | (new_n72_ & new_n76_)));
  assign new_n75_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n76_ = ~x16 & x20 & ~x21 & ~x14 & x15;
  assign z12 = x09 & ~x24 & (x00 ? (new_n78_ & x01) : (~new_n79_ & ~x01));
  assign new_n78_ = (~x02 | ~x10) & (x17 | x20);
  assign new_n79_ = (~x17 | (~x23 & (x02 | x19))) & (~x20 | ~x23 | (~x02 & ~x19));
