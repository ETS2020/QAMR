...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n52_ | ~x03)) | (new_n53_ & ~x00 & ~x01 & ~x02);
  assign new_n52_ = x00 & x02 & ~x09 & x10 & x11 & x12;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n55_ | ~x03);
  assign new_n55_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (~x03 | (x09 & x10 & x00 & x02));
  assign z06 = x01 & (~x03 | (new_n58_ & x00));
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (x12 | (x03 & ~x12));
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (~x01 | ~x03 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x03 & (new_n62_ | x01);
  assign new_n62_ = new_n63_ & x04 & ~x05 & ~x06 & ~x00 & x02;
  assign new_n63_ = ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = (x01 & ~x03) | (~x00 & ~x21 & ~new_n65_ & ~x22);
  ...
  assign new_n77_ = x00 ? (~x01 | ~x03 | (x02 & x10)) : (new_n78_ | x01);
