...
module FAU ( 
  ...
  assign z10 = (new_n63_ & new_n64_) | (~new_n62_ & x01);
  assign new_n62_ = ~x00 & (~x18 | x19 | x20 | ~x21 | ~x22);
  assign new_n63_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n64_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (~new_n66_ & x01) | (new_n63_ & new_n67_);
  assign new_n66_ = ~x00 & (~x18 | x19 | x20 | ~x21 | x22);
