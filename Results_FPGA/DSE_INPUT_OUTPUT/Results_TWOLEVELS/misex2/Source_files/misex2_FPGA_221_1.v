...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n57_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n65_, new_n68_, new_n69_, new_n72_;
  ...
  assign new_n65_ = x15 & ~x14 & ~x13 & x12 & new_n60_ & ~x11;
  ...
  assign z14 = ~x00 & (new_n72_ | x01);
  assign new_n72_ = ~x02 & ~x09 & ~x10 & ~x17 & ~x18 & ~x19;
