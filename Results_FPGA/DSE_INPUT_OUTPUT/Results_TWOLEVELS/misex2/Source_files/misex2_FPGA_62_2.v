...
module FAU ( 
  ...
  assign z02 = ~x10 & (new_n49_ | x01);
  assign new_n49_ = ~x00 & ~x02 & x09 & ~x17 & ~x18 & ~x19;
  ...
  assign z10 = (x01 & ~x10) | (~x00 & (new_n67_ | (new_n68_ & new_n69_)));
  ...
  assign z12 = (x01 & (~x10 | (new_n74_ & x00 & ~x02))) | (~x00 & new_n75_ & ~x01);
  ...
  assign z17 = (~x00 & ~x01 & x02) | (x01 & ~x10);
endmodule
