...
module FAU ( 
  ...
  assign z00 = ~x01 & (x24 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = ~x01 & (x24 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = ~x24 & ~x19 & new_n49_ & ~x18;
  assign new_n49_ = ~x17 & ~x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02);
  assign new_n51_ = ~x19 & ~x24 & ~x17 & x18;
  ...
  assign z14 = ~x24 & ~x19 & new_n78_ & ~x18;
