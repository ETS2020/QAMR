...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n55_, new_n59_,
    new_n61_, new_n62_, new_n64_, new_n66_, new_n68_, new_n70_, new_n71_;
  ...
  assign z02 = ~x00 & ~x01 & ~x02 & x09 & new_n49_ & ~x10;
  assign z03 = (~x00 & ~x01 & new_n52_ & ~x02) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x17 & x18 & ~new_n46_ & ~x19;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = ~x11 & (new_n55_ | ~x14);
  assign new_n55_ = x00 & x01 & x02 & ~x09 & x10 & ~x12;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n46_ & x10;
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (x01 | (~x11 & ~x14)) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x00 & ~x01 & new_n61_ & x02;
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & new_n62_ & ~x07;
  assign new_n62_ = ~x08 & x17 & ~x18 & x19 & (x11 | x14);
  assign z09 = new_n46_ | (new_n64_ & ~x00 & x01 & x18);
  assign new_n64_ = ~x19 & ~x20 & ~x21 & ~x22;
  assign z10 = ~x00 & x01 & new_n66_ & x18;
  assign new_n66_ = ~x19 & ~x20 & x21 & ~new_n46_ & x22;
  assign z11 = ~x00 & x01 & new_n68_ & x18;
  assign new_n68_ = ~x19 & ~x20 & x21 & ~new_n46_ & ~x22;
  assign z12 = new_n46_ | (new_n70_ & x09);
