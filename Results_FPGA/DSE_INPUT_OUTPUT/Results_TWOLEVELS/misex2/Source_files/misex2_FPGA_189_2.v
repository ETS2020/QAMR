...
module FAU ( 
  ...
  assign z00 = (x01 & ~x05) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = (x01 & ~x05) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = (x01 & ~x05) | (new_n49_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02 & x05);
  ...
  assign new_n59_ = x01 & (~x01 | ~x05 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & ~x05) | (~x01 & ~x02 & x19);
