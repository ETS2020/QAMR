...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n49_, new_n51_, new_n53_, new_n54_, new_n57_,
  ...
  assign z06 = new_n47_ | new_n57_;
  assign new_n57_ = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = new_n59_ & x00;
  assign new_n59_ = x02 & ((~x01 & (x11 | x12)) | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = ~x00 & ~x01 & new_n61_ & x02;
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & new_n62_ & ~x07;
  assign new_n62_ = ~x08 & x17 & ~x18 & x19 & (x11 | x12);
  assign z09 = new_n47_ | (~x00 & ~x21 & ~new_n64_ & ~x22);
  assign new_n64_ = ~new_n66_ & (~new_n65_ | x14 | x15 | x16 | ~x20);
  assign new_n65_ = ~x11 & ~x13 & ~x01 & x02;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = ~x00 & (new_n69_ | (x01 & new_n68_ & x18));
