...
module FAU ( 
  ...
  assign new_n51_ = ~x10 & ~x17 & ~x18 & ~new_n47_ & ~x19;
  ...
  assign z07 = new_n47_ | (x00 & x02 & (~x01 | (new_n61_ & x01)));
  assign new_n61_ = ~x09 & x10 & x11 & ~new_n47_ & ~x12;
  assign z08 = new_n47_ | (new_n63_ & new_n64_);
  assign new_n63_ = ~x00 & ~x01 & x02 & ~x03 & x04 & ~x05;
  assign new_n64_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = new_n47_ | (~x00 & ~x21 & ~new_n66_ & ~x22);
  assign new_n66_ = (~new_n67_ | ~new_n68_) & (x19 | x20 | ~x01 | ~x18);
  assign new_n67_ = ~x01 & x02 & ~x11 & x12;
  assign new_n68_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign z10 = new_n47_ | (~x00 & (new_n70_ | new_n72_));
  assign new_n70_ = new_n71_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & ~x21 & ~x22;
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = new_n47_ | (~x00 & ~x22 & (new_n74_ | new_n75_));
  assign new_n74_ = new_n67_ & ~x13 & ~x14 & x15 & ~x16 & ~x21;
  assign new_n75_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = new_n47_ | (new_n77_ & x09);
