...
module FAU ( 
  ...
  assign z01 = (x01 & ~x07) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  ...
  assign z05 = x01 & (~x07 | (x09 & x10 & x00 & x02));
  assign z06 = new_n58_ & x00;
  assign new_n58_ = x01 & x02 & x07 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (~x01 | ~x07 | x09 | ~x10 | ~x11 | x12);
