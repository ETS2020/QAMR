...
module FAU ( 
  ...
  assign z07 = (x00 & x02 & (~x01 | (new_n59_ & x01 & ~x09))) | (x01 & ~x22);
  ...
  assign z09 = ~x22 & (x01 | (new_n65_ & new_n64_ & ~x00 & x02));
  assign new_n64_ = ~x11 & x12 & ~x13;
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20 & ~x21;
  assign z10 = ~x00 & (new_n67_ | (new_n68_ & new_n64_ & ~x01 & x02));
  assign new_n67_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x22 & ~x21 & x20 & new_n70_ & ~x16;
  assign new_n70_ = x15 & ~x14 & ~x13 & x12 & z17 & ~x11;
  ...
  assign z14 = (x01 & ~x22) | (new_n77_ & ~x02 & ~x09 & ~x00 & ~x01);
