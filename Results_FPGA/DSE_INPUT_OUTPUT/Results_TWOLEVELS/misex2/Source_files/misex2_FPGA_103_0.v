...
module FAU ( 
  ...
  assign z04 = (~x01 & ~x15) | (new_n54_ & x00 & x01 & x02);
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = (~x01 & ~x15) | (x00 & x02 & (~x01 | (new_n58_ & x01 & ~x09)));
  assign new_n58_ = x10 & x11 & ~x12;
  assign z08 = ~x01 & (~x15 | (new_n60_ & new_n61_));
  ...
  assign new_n71_ = ~x01 & x02 & ~x11 & x12;
  assign new_n72_ = ~x13 & ~x14 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (x00 ? new_n74_ : new_n75_);
  assign new_n74_ = x01 & (~x02 | ~x10);
  assign new_n75_ = ~x01 & x15 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x19 & x17 & x15 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x01 & (~x15 | (new_n78_ & ~x00 & ~x02 & ~x09));
