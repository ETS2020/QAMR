...
module FAU ( 
  ...
  assign new_n66_ = (~new_n67_ | ~x01) & (~new_n68_ | x01 | ~x02 | x11 | ~x12);
  assign new_n67_ = x18 & ~x19;
  assign new_n68_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & (new_n70_ | (new_n71_ & new_n72_));
  assign new_n70_ = new_n67_ & x01 & ~x20 & x21 & x22;
  assign new_n71_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n72_ = x20 & ~x21 & ~x22 & x15 & x16 & ~x18;
  assign z11 = ~x00 & ~x22 & (new_n74_ | new_n76_);
  assign new_n74_ = new_n75_ & ~x11 & x12 & ~x13 & ~x01 & x02;
  assign new_n75_ = ~x14 & x15 & ~x16 & ~x18 & x20 & ~x21;
  assign new_n76_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & ~new_n78_ & ~new_n53_;
