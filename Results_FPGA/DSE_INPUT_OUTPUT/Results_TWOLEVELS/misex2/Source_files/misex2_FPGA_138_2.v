...
module FAU ( 
  ...
  assign z02 = ~x19 & ~x17 & ~x11 & new_n48_ & ~x10 & ~x18;
  assign z03 = new_n51_ | new_n53_;
  assign new_n51_ = x11 & (~x18 | (new_n52_ & ~x09 & x10 & x12 & x18));
  ...
  assign new_n63_ = x17 & ~x08 & ~x07 & new_n64_ & ~x06 & ~x11;
  ...
  assign z11 = new_n57_ | (~x00 & ~x22 & (new_n74_ | new_n75_));
  assign new_n74_ = new_n71_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n75_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & ~new_n77_ & ~new_n57_;
  ...
  assign z14 = ~x18 & (x11 | (new_n81_ & ~x00 & ~x01 & ~x02));
