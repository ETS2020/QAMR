...
module FAU ( 
  ...
  assign z01 = ~x02 & x10;
  assign z02 = ~x02 & (x10 | (new_n47_ & ~x00 & ~x01 & x09));
  ...
  assign z06 = x10 & (~x02 | (x00 & x01 & x02 & ~x09 & x11));
  ...
  assign new_n65_ = ~x19 & ~x20 & x21 & ~z01 & x22;
  ...
  assign new_n72_ = x17 & ~x19 & ~x24 & ~x00 & ~x01 & x09;
  assign new_n73_ = x00 ? (~x01 | x10) : (x01 | ~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & ~x10 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x02 & (x10 | (new_n47_ & ~x00 & ~x01 & ~x09));
  assign z15 = ~x10 & ((~x01 & ~x02 & x19) | (x00 & (x01 | ~x02)));
