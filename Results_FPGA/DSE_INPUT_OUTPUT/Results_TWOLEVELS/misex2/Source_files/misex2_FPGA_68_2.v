...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n52_, new_n55_, new_n56_, new_n58_, new_n59_,
  ...
  assign z05 = x01 & (~x09 | (new_n52_ & x00));
  ...
  assign new_n67_ = x01 & x09 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (x01 & ~x09) | (~x24 & (x00 ? (~new_n52_ & x01) : (~x01 & ~new_n69_ & x09)));
  assign new_n69_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = (x01 & ~x09) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x09 & (new_n72_ | x01);
  assign new_n72_ = ~x00 & ~x02 & ~x10 & ~x17 & ~x18 & ~x19;
