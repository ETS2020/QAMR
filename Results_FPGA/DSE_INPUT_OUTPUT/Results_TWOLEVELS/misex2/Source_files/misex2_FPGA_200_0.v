...
module FAU ( 
  ...
  assign z10 = new_n56_ | (~x00 & (new_n69_ | (new_n66_ & new_n70_)));
  ...
  assign new_n72_ = x18 & ~x19 & ~x20 & x21 & (x14 | x17);
  assign new_n73_ = ~x14 & x15 & ~x16 & x17 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n75_ & x01) : (~new_n76_ & ~x01));
  assign new_n75_ = (~x02 | ~x10) & (x14 | x17);
  assign new_n76_ = (~x23 | (~x17 & (~x14 | (~x02 & ~x19)))) & (x02 | ~x17 | x19);
