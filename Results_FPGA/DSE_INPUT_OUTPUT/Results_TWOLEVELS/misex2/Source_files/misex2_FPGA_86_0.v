...
module FAU ( 
  ...
  assign z01 = ~x01 & (~x08 | (new_n48_ & ~x00 & ~x02 & x09));
  ...
  assign z06 = (~x01 & ~x08) | (x00 & new_n57_ & x01);
  assign new_n57_ = x02 & ~x09 & x10 & x11;
  assign z07 = (~x01 & ~x08) | (x00 & x02 & (~x01 | (new_n59_ & x01 & ~x09)));
  assign new_n59_ = x10 & x11 & ~x12;
  assign z08 = ~x01 & ~x08;
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n64_ | (new_n62_ & new_n63_));
  assign new_n62_ = ~x01 & x02 & x08 & ~x11 & x12;
  ...
  assign new_n71_ = ~x13 & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (x00 ? new_n73_ : new_n74_);
  assign new_n73_ = x01 & (~x02 | ~x10);
  assign new_n74_ = ~x01 & x08 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
