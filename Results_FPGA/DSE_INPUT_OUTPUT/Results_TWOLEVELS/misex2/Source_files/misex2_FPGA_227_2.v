...
module FAU ( 
  ...
  assign z00 = (x01 & ~x06) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  ...
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02 & x06);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign new_n52_ = x11 & x12 & ~x09 & x10;
  assign z04 = ~x12 & new_n54_ & ~x11;
  assign new_n54_ = x10 & ~x09 & x06 & x02 & x00 & x01;
  assign z05 = x10 & x09 & x06 & x02 & x00 & x01;
  assign z06 = new_n57_ & x00;
  assign new_n57_ = x01 & x02 & x06 & ~x09 & x10 & x11;
  assign z07 = (x01 & ~x06) | (x00 & x02 & (~x01 | (new_n59_ & x01 & x06 & ~x09)));
  ...
  assign new_n66_ = x01 & x06 & x18 & ~x19 & ~x20;
  assign z10 = (x01 & ~x06) | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  ...
  assign new_n73_ = x01 & x06 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (x01 & ~x06) | (new_n75_ & x09);
  ...
  assign z15 = (~x02 & ((x00 & (~x01 | x06)) | (~x01 & x19))) | (x00 & x01 & x06 & ~x10);
