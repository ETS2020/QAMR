// Benchmark "FAU" written by ABC on Mon Aug 24 16:41:55 2020
...
module FAU ( 
  ...
  assign z00 = ~x01 & (x13 | (new_n46_ & new_n47_ & x10 & ~x17));
  assign new_n46_ = ~x00 & ~x02 & ~x09;
  assign new_n47_ = ~x18 & ~x19;
  assign z01 = ~x19 & ~x18 & ~x17 & ~x13 & new_n49_ & x10;
  assign new_n49_ = x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x13 & new_n49_ & ~x10;
  assign z03 = (~x01 & (x13 | (new_n52_ & ~x00 & ~x02))) | (new_n53_ & x00 & x01 & x02);
  ...
  assign new_n78_ = ~x13 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (x13 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (x13 | (new_n46_ & new_n47_ & ~x10 & ~x17));
