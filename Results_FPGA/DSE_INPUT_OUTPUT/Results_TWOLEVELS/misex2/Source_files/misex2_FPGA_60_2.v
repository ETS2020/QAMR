...
module FAU ( 
  ...
  assign new_n53_ = x12 & x16 & x10 & x11;
  assign z04 = x01 & (new_n55_ | ~x16);
  assign new_n55_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x16 & x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n58_ & x00;
  assign new_n58_ = x01 & x02 & ~x09 & x10 & x11 & x16;
  assign z07 = (x01 & ~x16) | (x00 & x02 & (new_n60_ | ~x01));
  assign new_n60_ = x01 & ~x09 & x10 & x11 & ~x12 & x16;
  ...
  assign z10 = ~x00 & x16 & (new_n69_ | (new_n70_ & new_n71_));
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x20 & ~x21 & ~x22;
  ...
  assign z13 = (x01 & ~x16) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (x01 & ~x16) | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
