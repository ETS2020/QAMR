...
module FAU ( 
  ...
  assign z09 = ~x22 & (~x20 | (new_n66_ & new_n67_ & new_n68_ & ~x15));
  assign new_n66_ = ~x00 & ~x01 & x02 & ~x11 & x12;
  assign new_n67_ = ~x13 & ~x14;
  assign new_n68_ = ~x16 & ~x21;
  assign z10 = new_n48_ | (~x00 & (new_n70_ | (new_n71_ & new_n72_)));
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n71_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n72_ = ~x14 & x15 & x16 & ~x21 & ~x22;
  assign z11 = ~x22 & (~x20 | (new_n66_ & new_n67_ & new_n68_ & x15));
