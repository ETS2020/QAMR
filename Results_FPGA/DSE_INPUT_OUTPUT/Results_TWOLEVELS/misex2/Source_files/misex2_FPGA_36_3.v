...
module FAU ( 
  ...
  assign z01 = (x01 & x19) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & x09;
  assign new_n49_ = ~x02 & ~x00 & ~x01;
  assign z03 = (x01 & (new_n51_ | x19)) | (new_n52_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = x00 & x02 & ~x09 & x10 & x11 & x12;
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n54_ | x19);
  assign new_n54_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = ~x19 & x10 & x09 & x02 & x00 & x01;
  assign z06 = x01 & (x19 | (new_n57_ & x00));
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (x12 | (~x12 & ~x19));
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x11 | x12 | x19 | ~x01 | x09 | ~x10);
  ...
  assign z15 = (x00 & ~x19 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19);
