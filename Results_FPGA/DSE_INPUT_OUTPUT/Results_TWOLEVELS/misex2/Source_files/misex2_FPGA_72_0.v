...
module FAU ( 
  ...
  assign z00 = ~x01 & (~x23 | (new_n46_ & new_n47_ & x10 & ~x17));
  assign new_n46_ = ~x00 & ~x02 & ~x09;
  assign new_n47_ = ~x18 & ~x19;
  assign z01 = x23 & ~x19 & ~x18 & ~x17 & new_n49_ & x10;
  assign new_n49_ = x09 & ~x02 & ~x00 & ~x01;
  assign z02 = x23 & ~x19 & ~x18 & ~x17 & new_n49_ & ~x10;
  assign z03 = (new_n52_ & ~x00 & ~x01 & ~x02) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x17 & x18 & ~x19 & x23;
  assign new_n53_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & ~x23) | (new_n55_ & x00 & x01 & x02);
  assign new_n55_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = (~x01 & ~x23) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = (~x01 & ~x23) | (x00 & x02 & (~x01 | (new_n59_ & x01 & ~x09)));
  assign new_n59_ = x10 & x11 & ~x12;
  assign z08 = x23 & new_n61_ & x19;
  ...
  assign new_n64_ = new_n65_ & ~x14 & ~x15 & ~x16 & x20 & x23;
  ...
  assign new_n74_ = x00 ? (~x01 | (x02 & x10)) : (x01 | ~x23 | (new_n75_ & ~x02));
  assign new_n75_ = ~x17 & ~x19;
  assign z13 = x23 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x01 & (~x23 | (new_n46_ & new_n47_ & ~x10 & ~x17));
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & (~x23 | (~x02 & x19)));
