...
module FAU ( 
  ...
  assign z00 = (x01 & x20) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  ...
  assign z07 = (x01 & x20) | (x00 & x02 & (new_n60_ | ~x01));
  assign new_n60_ = x11 & ~x12 & ~x20 & x01 & ~x09 & x10;
  ...
  assign z10 = ~x00 & (new_n69_ | (new_n70_ & new_n71_));
  ...
  assign z12 = (x01 & x20) | (x09 & ~x24 & (new_n76_ | new_n77_));
  assign new_n76_ = x00 & x01 & (~x02 | ~x10);
  assign new_n77_ = ~x00 & ~x01 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
  assign z13 = (x01 & x20) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
