...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n53_, new_n57_, new_n59_,
  ...
  assign new_n51_ = x21 & (~new_n52_ | ~x10 | ~x11 | ~x12 | ~x21);
  assign new_n52_ = x00 & x02 & ~x09;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (~x21 | (new_n52_ & x10 & ~x11 & ~x12));
  assign z05 = x21 & x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n57_ & x00;
  assign new_n57_ = x01 & x02 & ~x09 & x10 & x11 & x21;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12 | ~x21);
  ...
  assign z12 = (x01 & ~x21) | (new_n73_ & x09);
