...
module FAU ( 
  ...
  assign z04 = (~x01 & ~x17) | (new_n49_ & x00 & x01 & x02);
  ...
  assign new_n65_ = x20 & ~x21 & ~x22 & x15 & x16 & x17;
  assign z11 = z00 | (~x00 & ~x22 & (new_n67_ | (new_n59_ & new_n68_)));
  ...
  assign new_n71_ = x17 & (x23 | (~x02 & ~x19));
