...
module FAU ( 
  ...
  assign z10 = x00 ? x23 : (new_n69_ | (new_n70_ & new_n71_));
  ...
  assign z12 = (x00 & x23) | (new_n76_ & x09);
  assign new_n76_ = ~x24 & ((~new_n77_ & ~x01) | (x00 & x01 & (~x02 | ~x10)));
  assign new_n77_ = x02 ? ~x23 : ((~x19 | ~x23) & (x00 | ~x17 | x19));
  assign z13 = (x00 & x23) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (x00 & x23) | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = (x00 & ~x23 & (~x02 | (x01 & ~x10))) | (~x00 & ~x01 & ~x02 & x19);
  assign z16 = ~x00 & x01;
