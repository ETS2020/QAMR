...
module FAU ( 
  ...
  assign z00 = ~x01 & (x17 | (new_n46_ & ~x00 & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x18 & ~x19;
  assign z01 = ~x01 & (x17 | (new_n46_ & ~x00 & ~x02 & x09));
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & x09;
  assign new_n49_ = ~x02 & ~x00 & ~x01;
  assign z03 = (~x01 & (x17 | (new_n51_ & ~x00 & ~x02))) | (new_n52_ & x00 & x01 & x02);
  ...
  assign new_n73_ = ~x17 & x23 & (x02 | x19);
