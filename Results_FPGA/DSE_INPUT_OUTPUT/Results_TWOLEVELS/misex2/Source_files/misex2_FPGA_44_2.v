...
module FAU ( 
  ...
  assign z01 = (x01 & ~x03) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n49_ & x09;
  assign new_n49_ = ~x02 & ~x00 & ~x01;
  assign z03 = (x01 & (new_n51_ | ~x03)) | (new_n52_ & ~x00 & ~x01 & ~x02);
  ...
  assign z07 = (x01 & ~x03) | (x00 & x02 & (~x01 | (new_n59_ & x01 & ~x09)));
