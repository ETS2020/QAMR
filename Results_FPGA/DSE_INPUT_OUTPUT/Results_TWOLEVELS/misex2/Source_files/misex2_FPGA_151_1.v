...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n60_, new_n62_,
    new_n65_, new_n66_;
  ...
  assign z06 = x02 & (~x01 | (x00 & x01 & ~x09 & x10 & x11));
  assign z07 = ~x12 & new_n54_ & x11;
  assign z08 = ~x01 & x02;
  assign z09 = ~x22 & new_n60_ & ~x21;
  assign new_n60_ = ~x20 & ~x19 & x18 & ~x00 & x01;
  assign z10 = (~x01 & x02) | (new_n62_ & ~x00 & x01 & x18);
  assign new_n62_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x22 & new_n60_ & x21;
  assign z12 = z08 | (x09 & ~x24 & (new_n65_ | new_n66_));
  assign new_n65_ = x00 & (x02 ? ~x10 : x01);
  assign new_n66_ = ~x00 & ~x01 & (x19 ? x23 : x17);
