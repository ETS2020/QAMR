...
module FAU ( 
  ...
  assign new_n46_ = ~x09 & ~x06 & ~x02 & ~x00 & ~x01;
  assign z01 = ~x19 & ~x18 & new_n48_ & ~x17;
  assign new_n48_ = x10 & x09 & ~x06 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x01 & (x06 | (new_n50_ & ~x00 & ~x02 & x09));
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (new_n52_ & ~x00 & ~x01 & ~x02) | (new_n53_ & x00 & x01 & x02);
  assign new_n52_ = ~x06 & ~x17 & x18 & ~x19;
  ...
  assign new_n70_ = ~x01 & x02 & ~x06 & ~x11 & x12 & ~x13;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n73_ | (~x00 & ~x22 & (new_n74_ | (new_n75_ & new_n76_)));
  ...
  assign z12 = x09 & ~x24 & (x00 ? new_n78_ : new_n79_);
  assign new_n78_ = x01 & (~x02 | ~x10);
  assign new_n79_ = ~x01 & ~x06 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (x06 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & ((~x02 & ~x06) | (x01 & (~x02 | ~x10)))) | (~x06 & x19 & ~x01 & ~x02);
