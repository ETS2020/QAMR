...
module FAU ( 
  ...
  assign z01 = (x01 & x08) | (new_n48_ & ~x00 & ~x01 & ~x02 & x09);
  ...
  assign z05 = x01 & (x08 | (x09 & x10 & x00 & x02));
  assign z06 = ~new_n57_ & x01;
  assign new_n57_ = ~x08 & (~x00 | ~x02 | x09 | ~x10 | ~x11);
  assign z07 = (x01 & x08) | (x00 & x02 & (~x01 | (new_n59_ & x01 & ~x09)));
  assign new_n59_ = x10 & x11 & ~x12;
  assign z08 = (x01 & x08) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  ...
  assign z10 = (x01 & x08) | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
