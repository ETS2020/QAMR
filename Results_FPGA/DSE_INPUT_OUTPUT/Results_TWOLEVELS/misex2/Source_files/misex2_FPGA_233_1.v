...
module FAU ( 
  ...
  assign z16 = ~x00 & x01;
  assign z11 = (~x01 & x15) | (new_n71_ & ~x00 & x01 & x18);
  ...
  assign z15 = (x00 & ((~x02 & ~x15) | (x01 & (~x02 | ~x10)))) | (~x01 & ~x02 & ~x15 & x19);
