// Benchmark "FAU" written by ABC on Mon Aug 24 16:43:02 2020
...
module FAU ( 
  ...
  assign z00 = (x01 & x09) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  ...
  assign z03 = (x01 & (x09 | (new_n51_ & x00 & x02 & ~x09))) | (new_n52_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = x10 & x11 & x12;
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = ~new_n54_ & x01;
  assign new_n54_ = ~x09 & (~x00 | ~x02 | ~x10 | x11 | x12);
