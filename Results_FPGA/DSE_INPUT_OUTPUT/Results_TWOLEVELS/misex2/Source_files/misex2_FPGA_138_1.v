...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n56_, new_n59_,
  ...
  assign new_n51_ = x11 & (x00 | x01 | x02 | x17 | x19);
  ...
  assign new_n64_ = new_n65_ & ~x14 & ~x15 & ~x16 & ~x18 & x20;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = x01 & x11 & x18 & ~x19 & ~x20;
  ...
  assign new_n71_ = x20 & ~x21 & ~x22 & x15 & x16 & ~x18;
  assign z11 = new_n56_ | (~x00 & ~x22 & (new_n73_ | new_n74_));
  assign new_n73_ = new_n65_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  ...
  assign z13 = new_n56_ | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (~x11 & x18) | (new_n80_ & ~x18 & ~x19 & ~x10 & ~x17);
  assign new_n80_ = ~x00 & ~x01 & ~x02 & ~x09;
