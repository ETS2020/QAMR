...
module FAU ( 
  ...
  assign z00 = (x12 & x17) | (new_n46_ & x10 & ~x17 & ~x18 & ~x19);
  assign new_n46_ = ~x00 & ~x01 & ~x02 & ~x09;
  assign z01 = (x12 & x17) | (new_n48_ & x10 & ~x17 & ~x18 & ~x19);
  assign new_n48_ = ~x00 & ~x01 & ~x02 & x09;
  assign z02 = (x12 & x17) | (new_n48_ & ~x18 & ~x19 & ~x10 & ~x17);
  assign z03 = (x12 & (new_n51_ | x17)) | (new_n52_ & ~x17 & x18 & ~x19);
  ...
  assign new_n65_ = x01 & x18 & ~x19 & ~new_n56_ & ~x20;
  assign new_n66_ = new_n67_ & ~x14 & ~x15 & ~x16 & ~x17 & x20;
  assign new_n67_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign z10 = new_n56_ | (~x00 & (new_n69_ | (new_n67_ & new_n70_)));
  assign new_n69_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n56_ | (~x00 & ~x22 & (new_n72_ | new_n73_));
  assign new_n72_ = new_n67_ & ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n75_ & x01) : (~new_n76_ & ~x01));
  assign new_n75_ = ~new_n56_ & (~x02 | ~x10);
  assign new_n76_ = (x12 | ~x17 | (~x23 & (x02 | x19))) & (x17 | ~x23 | (~x02 & ~x19));
  assign z13 = x17 & (x12 | (~x00 & ~x01 & ~x02 & ~x19));
  assign z14 = (x12 & x17) | (new_n46_ & ~x18 & ~x19 & ~x10 & ~x17);
