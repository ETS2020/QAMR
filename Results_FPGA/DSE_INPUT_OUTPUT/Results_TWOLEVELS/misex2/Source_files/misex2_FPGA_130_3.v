...
module FAU ( 
  ...
  assign z01 = ~x19 & ~x18 & ~x17 & ~x15 & new_n49_ & x10;
  assign new_n49_ = x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x15 & new_n49_ & ~x10;
  ...
  assign z05 = x09 & (x15 | (x00 & x01 & x02 & x10));
  assign z06 = (x09 & x15) | (x00 & x01 & x02 & new_n58_ & ~x09);
  assign new_n58_ = x10 & x11;
  assign z07 = (x09 & x15) | (x00 & x02 & (~x01 | (new_n60_ & x01 & ~x09)));
  ...
  assign new_n73_ = x18 & ~x19 & ~x20 & ~new_n46_ & x21;
  assign new_n74_ = new_n75_ & ~x01 & x02 & ~x09 & ~x11 & x12;
  assign new_n75_ = ~x13 & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & (new_n77_ | x15);
