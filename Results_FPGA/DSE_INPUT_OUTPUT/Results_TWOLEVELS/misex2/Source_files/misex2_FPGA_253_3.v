// Benchmark "FAU" written by ABC on Mon Aug 24 16:43:14 2020
...
module FAU ( 
  ...
  assign z02 = (x01 & x21) | (new_n50_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n50_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (x01 & (new_n52_ | x21)) | (new_n53_ & ~x00 & ~x01 & ~x02);
  ...
  assign z06 = x01 & (x21 | (new_n58_ & x00));
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (x12 | (~x12 & ~x21));
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = x01 & (~x11 | x12 | x21 | ~x01 | x09 | ~x10);
  assign z08 = (x01 & x21) | (new_n63_ & new_n62_ & ~x00 & ~x01 & x02);
  ...
  assign new_n69_ = x15 & new_n70_ & ~x14;
  assign new_n70_ = ~x13 & x12 & ~x11 & x02 & ~x00 & ~x01;
  ...
  assign z14 = (x01 & x21) | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
