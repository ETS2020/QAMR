...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n51_, new_n53_, new_n54_, new_n56_,
    new_n59_, new_n61_, new_n63_, new_n64_, new_n66_, new_n68_, new_n71_,
    new_n72_;
  ...
  assign z09 = ~x22 & (x20 | (new_n66_ & x18 & ~x19 & ~x21));
  assign new_n66_ = ~x00 & x01;
  assign z10 = (x20 & ~x22) | (new_n68_ & ~x19 & ~x20 & x21 & x22);
  assign new_n68_ = ~x00 & x01 & x18;
  assign z11 = ~x22 & (x20 | (new_n66_ & x18 & ~x19 & x21));
  assign z12 = x09 & ~x24 & ~new_n48_ & (new_n71_ | new_n72_);
