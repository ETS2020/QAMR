...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n50_ | x08)) | (new_n51_ & ~x00 & ~x01 & ~x02);
  assign new_n50_ = x00 & x02 & ~x09 & x10 & x11 & x12;
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n53_ | x08);
  assign new_n53_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (x08 | (x09 & x10 & x00 & x02));
  assign z06 = x01 & (x08 | (new_n56_ & x00));
  assign new_n56_ = x02 & ~x09 & x10 & x11 & (x12 | (~x08 & ~x12));
  assign z07 = x00 & ~new_n58_ & x02;
  assign new_n58_ = x01 & (~x01 | x08 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n65_ = x01 & ~x08 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n67_ | (new_n69_ & new_n70_));
  assign new_n67_ = new_n68_ & x01 & ~x08 & x18;
