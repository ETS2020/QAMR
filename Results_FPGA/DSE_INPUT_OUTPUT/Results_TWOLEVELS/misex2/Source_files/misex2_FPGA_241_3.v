...
module FAU ( 
  ...
  assign z03 = (x00 & x01) | (~x00 & ~x01 & ~x02 & new_n50_ & ~x17);
  ...
  assign z09 = new_n57_ | (new_n58_ & new_n59_ & ~x14 & ~x15 & ~x16);
  assign new_n57_ = x01 & (x00 | (new_n50_ & ~x20 & ~x21 & ~x22));
  assign new_n58_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n59_ = x20 & ~x21 & ~x22;
  assign z10 = new_n61_ | (new_n58_ & new_n59_ & ~x14 & x15 & x16);
  assign new_n61_ = x01 & (x00 | (new_n50_ & ~x20 & x21 & x22));
  assign z11 = new_n63_ | (new_n58_ & new_n59_ & ~x14 & x15 & ~x16);
  assign new_n63_ = x01 & (x00 | (new_n50_ & ~x20 & x21 & ~x22));
