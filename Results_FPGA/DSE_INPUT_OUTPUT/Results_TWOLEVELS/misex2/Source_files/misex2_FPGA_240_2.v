...
module FAU ( 
  ...
  assign z03 = (x01 & (~x05 | (new_n52_ & x00 & x02 & x05))) | (new_n53_ & ~x00 & ~x01 & ~x02);
  assign new_n52_ = ~x09 & x10 & x11 & x12;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n55_ | ~x05);
  assign new_n55_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x10 & x09 & x05 & x02 & x00 & x01;
  assign z06 = new_n58_ & x00;
  assign new_n58_ = x01 & x02 & x05 & ~x09 & x10 & x11;
  assign z07 = (x01 & ~x05) | (x00 & x02 & (~x01 | (new_n60_ & x01 & x05 & ~x09)));
  assign new_n60_ = x10 & x11 & ~x12;
  assign z08 = ~x05 & (new_n62_ | x01);
  assign new_n62_ = new_n63_ & ~x00 & x02 & ~x03 & x04 & ~x06;
