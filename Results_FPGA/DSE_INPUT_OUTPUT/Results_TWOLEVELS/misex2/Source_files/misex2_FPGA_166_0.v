...
module FAU ( 
  ...
  assign z01 = ~x02 & (~x15 | (new_n48_ & ~x00 & ~x01 & x09));
  assign new_n48_ = x10 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x02 & (~x15 | (new_n50_ & ~x00 & ~x01 & x09));
  ...
  assign z04 = (~x02 & ~x15) | (new_n55_ & x00 & x01 & x02);
  ...
  assign z08 = (~x02 & ~x15) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  assign new_n61_ = ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17 & ~x18 & x19;
  assign z09 = (~x02 & ~x15) | (~x00 & ~x21 & ~new_n64_ & ~x22);
  assign new_n64_ = ~new_n66_ & (~new_n65_ | x01 | x11 | ~x12 | x13);
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = (~x02 & ~x15) | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  assign new_n68_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n69_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n72_ | (new_n73_ & x01));
  assign new_n72_ = new_n69_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n73_ = x18 & ~x19 & ~x20 & x21 & (x02 | x15);
  assign z12 = x09 & ~new_n75_ & ~x24;
  assign new_n75_ = x00 ? (~x01 | (x02 ? x10 : ~x15)) : (new_n76_ | x01);
  assign new_n76_ = (~x15 | ((~x19 | ~x23) & (x02 | ~x17 | x19))) & (~x02 | ~x23);
  assign z13 = ~x19 & x17 & x15 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x02 & (~x15 | (new_n50_ & ~x00 & ~x01 & ~x09));
  assign z15 = (x00 & ((~x02 & x15) | (x01 & x02 & ~x10))) | (x15 & x19 & ~x01 & ~x02);
  assign z16 = (~x02 & ~x15) | (~x00 & x01);
  assign z17 = (~x02 & ~x15) | (~x00 & ~x01 & x02);
endmodule
