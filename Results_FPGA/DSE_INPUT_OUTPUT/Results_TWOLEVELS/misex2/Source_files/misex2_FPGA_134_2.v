...
module FAU ( 
  ...
  assign new_n75_ = ~x14 & x15 & ~x16 & x20 & ~x21 & x23;
  assign z12 = x09 & ~x24 & (x00 ? (new_n77_ & x01) : (~new_n78_ & ~x01));
  assign new_n77_ = ~new_n47_ & (~x02 | ~x10);
