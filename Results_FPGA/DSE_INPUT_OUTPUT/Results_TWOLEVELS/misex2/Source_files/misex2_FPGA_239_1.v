// Benchmark "FAU" written by ABC on Mon Aug 24 16:43:08 2020
...
module FAU ( 
  ...
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (x20 | ~x22);
  assign z09 = new_n47_ | (~x00 & ~x21 & (new_n65_ | new_n67_));
  assign new_n65_ = new_n66_ & ~x14 & ~x15 & ~x16 & x20 & ~x22;
  assign new_n66_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (~x20 & x22) | (new_n69_ & new_n70_ & x20 & ~x21 & ~x22);
  assign new_n69_ = ~x11 & x12 & ~x13 & ~x00 & ~x01 & x02;
  assign new_n70_ = ~x14 & x15 & x16;
  assign z11 = ~x00 & ~x22 & (new_n72_ | new_n73_);
  assign new_n72_ = new_n66_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n73_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = new_n47_ | (new_n75_ & x09);
  ...
  assign z14 = new_n47_ | (new_n79_ & ~x02 & ~x09 & ~x00 & ~x01);
  assign new_n79_ = ~x10 & ~x17 & ~x18 & ~x19;
