...
module FAU ( 
  ...
  assign new_n52_ = x12 & x21 & x10 & x11;
  ...
  assign z10 = (x01 & ~x21) | (~x00 & (new_n67_ | (new_n69_ & x01 & x18)));
  assign new_n67_ = new_n68_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n68_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n69_ = ~x19 & ~x20 & x22;
  assign z11 = (x01 & ~x21) | (~x00 & ~new_n71_ & ~x22);
  assign new_n71_ = ~new_n72_ & (~new_n73_ | ~x12 | x13 | ~x02 | x11);
