...
module FAU ( 
  ...
  assign z00 = (x01 & x23) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  ...
  assign new_n52_ = x10 & x11 & x12 & ~x23;
  assign z04 = x01 & (new_n54_ | x23);
  assign new_n54_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (x23 | (x00 & x02 & x09 & x10));
  assign z06 = new_n57_ & x00;
  assign new_n57_ = x01 & x02 & ~x09 & x10 & x11 & ~x23;
  assign z07 = (x01 & x23) | (x00 & x02 & (new_n59_ | ~x01));
  assign new_n59_ = x11 & ~x12 & ~x23 & x01 & ~x09 & x10;
  ...
  assign new_n66_ = x01 & x18 & ~x19 & ~x20 & ~x23;
  assign z10 = ~x00 & (new_n68_ | (new_n70_ & new_n71_));
  assign new_n68_ = new_n69_ & x01 & x18 & ~x19;
  ...
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21 & ~x23;
  assign z12 = (new_n76_ & x09) | (x01 & x23);
  assign new_n76_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : ~new_n77_);
  assign new_n77_ = (~x23 | (~x02 & ~x19)) & (x01 | x02 | ~x17 | x19);
  assign z13 = ~x19 & new_n48_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n48_ & ~x09;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & x23) | (~x01 & ~x02 & x19);
