...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n54_, new_n55_, new_n57_, new_n58_,
  ...
  assign z10 = new_n61_ | (new_n62_ & new_n63_ & ~x14 & x15 & x16);
  assign new_n61_ = x01 & (x00 | (new_n51_ & ~x20 & x21 & x22));
  assign new_n62_ = ~x00 & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n63_ = x20 & ~x21 & ~x22;
  assign z11 = new_n65_ | (new_n62_ & new_n63_ & ~x14 & x15 & ~x16);
  assign new_n65_ = x01 & (x00 | (new_n51_ & ~x20 & x21 & ~x22));
