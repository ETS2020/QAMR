...
module FAU ( 
  ...
  assign z06 = (~x01 & ~x03) | (x00 & new_n58_ & x01);
  assign new_n58_ = x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (x01 | ~x03) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x01 & ~x03;
  ...
  assign new_n68_ = ~x01 & x02 & x03 & ~x11 & x12 & ~x13;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n71_ | new_n73_);
  assign new_n71_ = new_n72_ & ~x01 & x02 & x03 & ~x11 & x12;
  ...
  assign new_n76_ = x03 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
