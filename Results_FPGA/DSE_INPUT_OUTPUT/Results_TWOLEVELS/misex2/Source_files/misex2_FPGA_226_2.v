...
module FAU ( 
  ...
  assign z10 = new_n53_ | (~x00 & (new_n70_ | (new_n71_ & new_n72_)));
  ...
  assign new_n75_ = x01 & ~x09 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & new_n77_ & x20;
  ...
  assign z14 = (x09 & ~x20) | (new_n50_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = ~new_n53_ & ((x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19));
