// Benchmark "FAU" written by ABC on Mon Aug 24 16:42:05 2020
...
module FAU ( 
  ...
  assign z03 = (~x01 & (x06 | (new_n50_ & ~x00 & ~x02))) | (new_n51_ & x00 & x01 & x02);
  assign new_n50_ = ~x17 & x18 & ~x19;
  assign new_n51_ = ~x09 & x10 & x11 & x12;
  assign z04 = (~x01 & x06) | (new_n53_ & x00 & x01 & x02);
  assign new_n53_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = (~x01 & x06) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n57_ & x02;
  assign new_n57_ = (x01 | x06) & (~x01 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n62_ = ~x01 & x02 & ~x06 & ~x11 & x12;
  ...
  assign new_n67_ = ~x01 & x02 & ~x06 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n70_ | (new_n62_ & new_n71_));
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n71_ = ~x16 & x20 & ~x21 & ~x13 & ~x14 & x15;
  assign z12 = (~x01 & x06) | (x09 & ~x24 & (new_n73_ | new_n74_));
