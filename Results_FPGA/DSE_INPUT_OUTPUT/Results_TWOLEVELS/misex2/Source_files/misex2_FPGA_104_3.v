...
module FAU ( 
  ...
  assign z01 = (x17 & x19) | (new_n48_ & x10 & ~x17 & ~x18 & ~x19);
  assign new_n48_ = ~x00 & ~x01 & ~x02 & x09;
  assign z02 = (x17 & x19) | (new_n48_ & ~x18 & ~x19 & ~x10 & ~x17);
  ...
  assign z06 = new_n51_ | (x00 & x01 & new_n58_ & x02);
  assign new_n58_ = ~x09 & x10 & x11 & (x12 | (~new_n51_ & ~x12));
  assign z07 = x00 & x02 & ~new_n51_ & ~new_n60_;
  ...
  assign z10 = new_n51_ | (~x00 & (new_n66_ | (new_n67_ & new_n68_)));
  assign new_n66_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign new_n67_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n51_ | (~x00 & ~x22 & (new_n70_ | new_n71_));
  assign new_n70_ = new_n67_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = new_n51_ | (new_n73_ & x09);
  assign new_n73_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n74_ & ~x01));
  assign new_n74_ = (x02 | ~x17) & (~x23 | (~x02 & ~x19));
  assign z13 = x17 & (x19 | (~x00 & ~x01 & ~x02));
  assign z14 = (x17 & x19) | (new_n77_ & ~x18 & ~x19 & ~x10 & ~x17);
  assign new_n77_ = ~x00 & ~x01 & ~x02 & ~x09;
