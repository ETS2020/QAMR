...
module FAU ( 
  ...
  assign new_n55_ = x01 & (~x02 | x09 | ~x10 | ~x11 | (~x12 & (~x01 | x12)));
  ...
  assign new_n62_ = new_n63_ & ~x15 & ~x16 & x20 & ~x21 & ~x22;
  assign new_n63_ = x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n64_ = ~x19 & ~x20 & ~x21 & ~x22;
  assign z10 = (~x01 & (new_n66_ | x00)) | (new_n67_ & ~x00 & x01 & x18);
  assign new_n66_ = new_n63_ & x20 & ~x21 & ~x22 & x15 & x16;
  assign new_n67_ = ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & ~x22 & (new_n69_ | new_n71_);
  assign new_n69_ = new_n70_ & ~x11 & x12 & ~x13 & ~x01 & x02;
