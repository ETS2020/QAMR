...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n53_, new_n57_, new_n59_,
  ...
  assign z01 = ~x18 & (new_n48_ | x01);
  assign new_n48_ = ~x00 & ~x02 & x09 & x10 & ~x17 & ~x19;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & x09;
  assign z03 = (~new_n51_ & x01) | (new_n53_ & ~x00 & ~x01 & ~x02);
  assign new_n51_ = x18 & (~new_n52_ | ~x10 | ~x11 | ~x12 | ~x18);
  assign new_n52_ = x00 & x02 & ~x09;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (~x18 | (new_n52_ & x10 & ~x11 & ~x12));
  assign z05 = x01 & (~x18 | (x09 & x10 & x00 & x02));
  assign z06 = new_n57_ & x00;
  assign new_n57_ = x01 & x02 & ~x09 & x10 & x11 & x18;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12 | ~x18);
  assign z08 = x19 & ~x18 & x17 & new_n61_ & ~x08;
  assign new_n61_ = ~x07 & ~x06 & ~x05 & x04 & z17 & ~x03;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = (~x00 & ~x21 & ~new_n64_ & ~x22) | (x01 & ~x18);
  assign new_n64_ = (~new_n66_ | ~x01) & (~new_n65_ | x11 | ~x12 | x01 | ~x02);
  ...
  assign new_n75_ = x00 ? (~x01 | ~x18 | (x02 & x10)) : (new_n76_ | x01);
  assign new_n76_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = (x01 & ~x18) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x18 & (new_n79_ | x01);
  assign new_n79_ = ~x00 & ~x02 & ~x09 & ~x10 & ~x17 & ~x19;
  assign z15 = (~x02 & ((x00 & (~x01 | x18)) | (~x01 & x19))) | (x00 & x01 & ~x10 & x18);
