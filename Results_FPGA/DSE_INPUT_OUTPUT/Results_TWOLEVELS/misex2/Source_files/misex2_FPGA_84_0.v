...
module FAU ( 
  ...
  assign z12 = new_n75_ | (x09 & ~x24 & (x00 ? new_n76_ : new_n77_));
  assign new_n75_ = ~x01 & ~x20;
  assign new_n76_ = x01 & (~x02 | ~x10);
  assign new_n77_ = ~x01 & ((x23 & (x02 | (x19 & x20))) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (~x20 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (~x20 | (new_n50_ & ~x00 & ~x02 & ~x09));
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x20))) | (x19 & x20 & ~x01 & ~x02);
  assign z16 = ~x00 & x01;
