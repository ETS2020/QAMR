...
module FAU ( 
  ...
  assign new_n46_ = x16 & x10 & ~x09 & ~x02 & ~x00 & ~x01;
  ...
  assign z12 = x09 & ~x24 & (x00 ? new_n71_ : new_n72_);
  assign new_n71_ = x01 & (~x02 | ~x10);
  assign new_n72_ = ~x01 & x16 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x01 & (~x16 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (~x16 | (new_n50_ & ~x00 & ~x02 & ~x09));
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x16))) | (x16 & x19 & ~x01 & ~x02);
