...
module FAU ( 
  ...
  assign z09 = new_n67_ | (~x00 & ~new_n64_ & ~x22);
  assign new_n64_ = (~new_n65_ | ~new_n66_) & (~x01 | ~x18 | x19 | x20);
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20 & ~x21;
  assign new_n67_ = x01 & x21;
  assign z10 = new_n67_ | (new_n69_ & new_n70_ & ~x14 & x15 & x16);
  assign new_n69_ = ~x11 & x12 & ~x13 & ~x00 & ~x01 & x02;
  assign new_n70_ = x20 & ~x21 & ~x22;
  assign z11 = new_n67_ | (new_n69_ & new_n70_ & ~x14 & x15 & ~x16);
  ...
  assign z14 = (x01 & x21) | (new_n49_ & ~x00 & ~x01 & ~x02 & ~x09);
