...
module FAU ( 
  ...
  assign new_n56_ = x02 & x11 & (~x01 | (x01 & ~x09 & x10 & ~x12));
  ...
  assign new_n61_ = ~x11 & (x00 | (new_n62_ & new_n63_ & ~x15 & ~x16));
  assign new_n62_ = ~x01 & x02 & x12 & ~x13 & ~x14;
  assign new_n63_ = x20 & ~x21 & ~x22;
  assign new_n64_ = ~x00 & x01 & x18;
  assign z10 = new_n66_ | (new_n64_ & x21 & x22 & ~x19 & ~x20);
  assign new_n66_ = ~x11 & (x00 | (new_n62_ & new_n63_ & x15 & x16));
  ...
  assign z14 = (x00 & ~x11) | (new_n76_ & ~x02 & ~x09 & ~x00 & ~x01);
