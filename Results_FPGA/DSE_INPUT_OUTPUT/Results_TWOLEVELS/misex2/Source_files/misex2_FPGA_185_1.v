...
module FAU ( 
  ...
  assign z01 = (~x10 & x19) | (new_n48_ & x10 & ~x17 & ~x18 & ~x19);
  ...
  assign z04 = (~x10 & x19) | (new_n52_ & ~x11 & ~x12 & ~x09 & x10);
  assign z05 = (~x10 & x19) | (x00 & x01 & x02 & x09 & x10);
  assign z06 = x00 & x01 & x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n57_ & x02;
  assign new_n57_ = (x01 | (~x10 & x19)) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z08 = x19 & (new_n59_ | ~x10);
  assign new_n59_ = new_n60_ & ~x00 & ~x01 & x02 & ~x03 & x04;
  assign new_n60_ = ~x05 & ~x06 & ~x07 & ~x08 & x17 & ~x18;
  ...
  assign z12 = (~x10 & x19) | (new_n74_ & x09);
  ...
  assign z14 = ~x10 & (new_n78_ | x19);
  assign new_n78_ = ~x00 & ~x01 & ~x02 & ~x09 & ~x17 & ~x18;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x19 & (~x10 | (~x01 & ~x02)));
  assign z16 = ~x00 & x01 & (x10 | ~x19);
