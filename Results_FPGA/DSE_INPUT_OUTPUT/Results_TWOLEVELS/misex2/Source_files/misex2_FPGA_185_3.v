...
module FAU ( 
  ...
  assign z01 = x10 & (new_n48_ | x19);
  assign new_n48_ = ~x00 & ~x01 & ~x02 & x09 & ~x17 & ~x18;
  assign z02 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & x09;
  assign z03 = ~new_n51_ & ~x19;
  assign new_n51_ = (~new_n52_ | ~x00 | ~x01 | ~x02) & (x00 | x01 | x02 | x17 | ~x18);
  assign new_n52_ = x11 & x12 & ~x09 & x10;
  assign z04 = x10 & (new_n54_ | x19);
  assign new_n54_ = x00 & x01 & x02 & ~x09 & ~x11 & ~x12;
  ...
  assign new_n59_ = (x01 | (x10 & x19)) & (~x11 | x12 | x19 | ~x01 | x09 | ~x10);
  ...
  assign z12 = (new_n76_ & x09) | (x10 & x19);
  ...
  assign z14 = (x10 & x19) | (new_n80_ & ~x10 & ~x17 & ~x18 & ~x19);
