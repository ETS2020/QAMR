...
module FAU ( 
  ...
  assign new_n46_ = x10 & ~x09 & x06 & ~x02 & ~x00 & ~x01;
  ...
  assign new_n71_ = x15 & ~x16 & x20 & ~x21 & (x06 | x18);
  assign new_n72_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & ~new_n74_ & ~z08;
  assign new_n74_ = x00 ? (~x01 | (x02 & x10)) : (new_n75_ | x01);
  assign new_n75_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~z08 & ~x19;
  assign z14 = ~x18 & (~x06 | (new_n78_ & ~x00 & ~x01 & ~x02));
  assign new_n78_ = ~x09 & ~x10 & ~x17 & ~x19;
