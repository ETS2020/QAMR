...
module FAU ( 
  ...
  assign z06 = x01 & (~x17 | (new_n57_ & x00));
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (x12 | (~x12 & x17));
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12 | ~x17);
  ...
  assign new_n66_ = x01 & x17 & x18 & ~x19 & ~x20;
  assign z10 = (~x00 & (new_n68_ | (new_n69_ & new_n70_))) | (x01 & ~x17);
  assign new_n68_ = new_n52_ & x01 & ~x20 & x21 & x22;
