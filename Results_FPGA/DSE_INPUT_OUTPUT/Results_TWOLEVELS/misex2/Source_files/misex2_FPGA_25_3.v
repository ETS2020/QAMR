...
module FAU ( 
  ...
  assign new_n54_ = x10 & ~x09 & ~x07 & x02 & x00 & x01;
  assign z05 = x01 & (x07 | (x00 & x02 & x09 & x10));
  assign z06 = new_n57_ & x00;
  assign new_n57_ = x01 & x02 & ~x07 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x01 | x07 | x09 | ~x10 | ~x11 | x12);
  ...
  assign z10 = (x01 & x07) | (~x00 & (new_n68_ | (new_n69_ & new_n70_)));
  ...
  assign new_n73_ = x01 & ~x07 & x18 & ~x19 & ~x20 & x21;
  assign z12 = (x01 & x07) | (new_n75_ & x09);
