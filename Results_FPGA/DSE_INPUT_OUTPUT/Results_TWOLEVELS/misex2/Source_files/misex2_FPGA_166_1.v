...
module FAU ( 
  ...
  assign z10 = (~x02 & x15) | (~x00 & (new_n68_ | new_n70_));
  ...
  assign new_n74_ = x18 & ~x19 & ~x20 & x21 & (x02 | ~x15);
  assign z12 = x09 & ~new_n76_ & ~x24;
  assign new_n76_ = x00 ? (~x01 | (x02 ? x10 : x15)) : (new_n77_ | x01);
  assign new_n77_ = (x15 | ((~x19 | ~x23) & (x02 | ~x17 | x19))) & (~x02 | ~x23);
