...
module FAU ( 
  ...
  assign z04 = ~new_n54_ & ~x11;
  assign new_n54_ = x00 & (~x01 | ~x02 | x09 | ~x10 | x12);
  ...
  assign z09 = ~x00 & (~x11 | (new_n63_ & ~x20 & ~x21 & ~x22));
  assign new_n63_ = x01 & x18 & ~x19;
  assign z10 = ~x00 & (~x11 | (new_n63_ & ~x20 & x21 & x22));
  assign z11 = ~x22 & new_n66_ & x21;
  assign new_n66_ = ~x20 & ~x19 & x18 & x11 & ~x00 & x01;
  ...
  assign z14 = ~x00 & (~x11 | (new_n72_ & ~x01 & ~x02 & ~x09));
