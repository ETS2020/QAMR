...
module FAU ( 
  ...
  assign z01 = (x19 & ~x21) | (new_n48_ & x10 & ~x17 & ~x18 & ~x19);
  ...
  assign z09 = ~x21 & (x19 | (~x00 & ~new_n66_ & ~x22));
  assign new_n66_ = (~new_n67_ | x01 | ~x02 | x11 | ~x12) & (~new_n68_ | ~x01);
  assign new_n67_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n68_ = x18 & ~x20;
  assign z10 = (x19 & ~x21) | (~x00 & (new_n70_ | (new_n71_ & new_n72_)));
  ...
  assign new_n75_ = x01 & x18 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n77_ & x01) : (~new_n78_ & ~x01));
  assign new_n77_ = (~x02 | ~x10) & (~x19 | x21);
  assign new_n78_ = x19 ? (~x21 | ~x23) : (x02 ? ~x23 : ~x17);
  assign z13 = (x19 & ~x21) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x19 & (~x21 | (~x01 & ~x02)));
