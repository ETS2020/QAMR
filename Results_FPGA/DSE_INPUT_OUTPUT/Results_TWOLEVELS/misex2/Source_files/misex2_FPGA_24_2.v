...
module FAU ( 
  ...
  assign z01 = (x01 & ~x24) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  assign z02 = (x01 & ~x24) | (new_n49_ & ~x00 & ~x01 & ~x02 & x09);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n51_ & ~x00 & ~x01 & ~x02) | (new_n52_ & x00 & x01 & x02 & ~x09);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign new_n52_ = x12 & x24 & x10 & x11;
  assign z04 = x01 & (new_n54_ | ~x24);
  assign new_n54_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x24 & x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n57_ & x00;
  assign new_n57_ = x01 & x02 & ~x09 & x10 & x11 & x24;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = x01 & (~x01 | x09 | ~x10 | ~x11 | x12 | ~x24);
  assign z08 = (x01 & ~x24) | (new_n62_ & new_n61_ & ~x00 & ~x01 & x02);
  assign new_n61_ = ~x03 & x04 & ~x05;
  assign new_n62_ = x17 & ~x18 & x19 & ~x06 & ~x07 & ~x08;
  assign z09 = (x01 & ~x24) | (~x00 & ~x21 & ~new_n64_ & ~x22);
  ...
  assign new_n69_ = x22 & x24 & ~x20 & x21;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = x20 & ~x21 & ~x22 & ~x14 & x15 & x16;
  assign z11 = (x01 & ~x24) | (~x00 & ~x22 & (new_n73_ | new_n74_));
  assign new_n73_ = new_n70_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n74_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = ~x00 & new_n76_ & ~x01;
  assign new_n76_ = x09 & ~x24 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = (x01 & ~x24) | (~x00 & ~x01 & ~x02 & x17 & ~x19);
  assign z14 = (x01 & ~x24) | (new_n49_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & ~x24) | (~x01 & ~x02 & x19);
