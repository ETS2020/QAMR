...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n51_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_,
  ...
  assign z04 = ~new_n51_ & x00;
  assign new_n51_ = ~x11 & (~x01 | ~x02 | x09 | ~x10 | x12);
  assign z05 = ~x11 & x10 & x09 & x02 & x00 & x01;
  assign z07 = ~x11 & x02 & x00 & ~x01;
  ...
  assign z10 = x00 ? x11 : (new_n62_ | (new_n63_ & new_n64_));
  ...
  assign z14 = (x00 & x11) | (new_n73_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n73_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z15 = (~x02 & (x00 | (~x01 & x19))) | (x00 & (x11 | (x01 & ~x10)));
  assign z16 = x00 ? x11 : x01;
  assign z17 = x00 ? x11 : (~x01 & x02);
  assign z06 = 1'b0;
endmodule
