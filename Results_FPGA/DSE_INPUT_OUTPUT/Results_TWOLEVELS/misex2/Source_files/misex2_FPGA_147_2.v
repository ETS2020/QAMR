...
module FAU ( 
  ...
  assign z00 = (x01 & ~x11) | (new_n46_ & ~x00 & ~x01 & ~x02 & ~x09);
  assign new_n46_ = x10 & ~x17 & ~x18 & ~x19;
  assign z01 = (x01 & ~x11) | (new_n46_ & ~x00 & ~x01 & ~x02 & x09);
  ...
  assign z04 = x01 & ~x11;
  assign z05 = x01 & (~x11 | (x09 & x10 & x00 & x02));
  assign z06 = x01 & (~x11 | (x00 & x02 & ~x09 & x10 & x11));
  ...
  assign z14 = (x01 & ~x11) | (new_n78_ & ~x00 & ~x01 & ~x02 & ~x09);
