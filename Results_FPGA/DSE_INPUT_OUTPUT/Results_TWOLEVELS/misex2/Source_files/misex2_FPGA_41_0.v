...
module FAU ( 
  ...
  assign z01 = ~x02 & (new_n48_ | ~x10);
  assign new_n48_ = ~x00 & ~x01 & x09 & ~x17 & ~x18 & ~x19;
  assign z02 = ~x02 & ~x10;
  assign z03 = x10 & ((new_n51_ & x00 & x01 & x02) | (new_n52_ & ~x00 & ~x01 & ~x02));
  assign new_n51_ = ~x09 & x11 & x12;
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = new_n54_ & ~x12;
  assign new_n54_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x10 & x09 & x02 & x00 & x01;
  assign z06 = (~x02 & ~x10) | (x00 & x01 & x02 & ~x09 & x10 & x11);
  assign z07 = new_n58_ & x00;
  assign new_n58_ = x02 & (~x01 | (x01 & ~x09 & x10 & x11 & ~x12));
  assign z08 = x19 & new_n60_ & ~x18;
  assign new_n60_ = x17 & ~x08 & ~x06 & new_n61_ & ~x05 & ~x07;
  assign new_n61_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = z02 | (~x00 & ~x21 & ~new_n63_ & ~x22);
  ...
  assign z15 = (x00 & ((~x02 & x10) | (x01 & x02 & ~x10))) | (x10 & x19 & ~x01 & ~x02);
  assign z16 = z02 | (~x00 & x01);
  assign z17 = (~x00 & ~x01 & x02) | (~x02 & ~x10);
  assign z14 = z02;
endmodule
