...
module FAU ( 
  ...
  assign z06 = (~x01 & x21) | (x00 & new_n58_ & x01);
  assign new_n58_ = x02 & ~x09 & x10 & x11;
  assign z07 = x00 & ~new_n60_ & x02;
  assign new_n60_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x21);
  assign z08 = ~x01 & (x21 | (new_n62_ & new_n63_));
  ...
  assign new_n77_ = ~x21 & ((~x02 & x17 & ~x19) | (x23 & (x02 | x19)));
