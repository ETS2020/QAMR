// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:30 2020
...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | x70)) | (~x01 & (x77 ? (x78 & x79) : ~x78));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & x78 & ~x70 & ~x01 & x52;
  assign z04 = (x70 & ~x79) | (~x01 & (~x77 | ~x78 | (x77 & x78 & x79)));
  ...
  assign new_n182_ = x04 & ~x70 & x78 & ~x79;
  assign z23 = ((~x00 | x01) & (~x70 | x79)) | (~x04 & x05 & ~x70 & ~x79);
  ...
  assign z48 = ~x01 & ((x04 & new_n218_ & ~x70) | (new_n219_ & x68));
  ...
  assign z50 = (x70 & ~x79) | (~x01 & ((new_n223_ & x04) | (new_n224_ & x70)));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign new_n224_ = x77 & ~x78 & (x81 ^ ~x84);
  assign z51 = ~x01 & ((x04 & new_n226_ & ~x70) | (new_n219_ & x71));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = new_n154_ | (~x01 & ((new_n219_ & x72) | (new_n228_ & x04)));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n230_ & ~x70) | (new_n219_ & x73));
  ...
  assign new_n244_ = ~x70 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((new_n247_ & ~x04) | (x77 & (new_n248_ | (new_n246_ & x04))));
  assign new_n246_ = x78 & ((~x70 & ~x79) | (~x42 & x79 & (~new_n179_ | ~new_n180_)));
  assign new_n247_ = ~x70 & ~x79;
  assign new_n248_ = x40 & ((x04 & x78 & x79) | (~x70 & ~x78 & ~x79));
  assign z60 = (x70 & ~x79) | (~x01 & ((x79 & (new_n178_ | new_n237_)) | (~x70 & ~new_n250_ & ~x79)));
  assign new_n250_ = x04 & (~x04 | ~x78);
  assign z61 = ~x01 & x79 & ~new_n252_ & x80;
  assign new_n252_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n256_ | (x78 & (new_n255_ | (~new_n254_ & x04))));
  assign new_n254_ = (x70 | x79) & (x42 | ~x77 | ~x79 | (new_n179_ & new_n180_));
  assign new_n255_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n256_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = (x70 & ~x79) | (~x01 & x79 & ~new_n252_ & x82);
  assign z64 = ~x01 & (new_n259_ | (x79 & ~new_n252_ & x83));
  assign new_n259_ = x04 & ~x70 & ~x77 & x78 & ~x79;
