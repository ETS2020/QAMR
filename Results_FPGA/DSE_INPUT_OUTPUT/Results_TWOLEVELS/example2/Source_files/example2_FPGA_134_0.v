...
module FAU ( 
  ...
  assign new_n180_ = x78 & ((x74 & (x77 ? ~x42 : ~x79)) | (x77 & (~x79 | (~new_n181_ & ~x42))));
  ...
  assign z47 = new_n154_ | (~x01 & ((x04 & new_n214_ & ~x77) | (new_n215_ & x77)));
  assign new_n214_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n215_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n218_ & x68) | (x04 & new_n217_ & x74));
  ...
  assign z52 = ~x01 & ((new_n218_ & x72) | (x04 & new_n226_ & x74));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n218_ & x73) | (x04 & new_n228_ & x74));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x74 | (new_n230_ & ~x01));
  assign new_n230_ = x04 & ~x77 & x78 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & new_n232_ & ~x81;
  assign new_n232_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z56 = (~x00 & (x79 | (~x01 & x74))) | (x01 & (x74 | x79)) | (new_n236_ & x74) | (~new_n234_ & x79);
  assign new_n234_ = (~x76 | (x77 & x78)) & (x01 | (~new_n235_ & (x77 | x78)));
  assign new_n235_ = (x81 ^ x84) & (~x77 ^ ~x78);
  assign new_n236_ = ~x77 & ~x78;
  assign z57 = new_n154_ | (~x02 & x03 & x00 & ~x01);
  assign z58 = ~x01 & (new_n244_ | (x77 & (new_n239_ | new_n243_)));
  ...
  assign new_n246_ = x04 & x78 & (~x79 | (~x42 & (~new_n242_ | ~new_n247_)));
  assign new_n247_ = x43 & ~x74 & x80;
  assign new_n248_ = x40 & ((x04 & x78) | (x74 & ~x78 & ~x79));
  assign new_n249_ = ~x04 & x74 & ~x79;
  assign z60 = (~x74 & ~x79) | (~x01 & ((new_n235_ & x79) | (new_n180_ & x04) | (~x04 & x74 & ~x79)));
  assign z61 = ~x01 & x79 & ~new_n252_ & x80;
  assign new_n252_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = new_n154_ | (~x01 & (new_n256_ | (x78 & (new_n254_ | new_n255_))));
  assign new_n254_ = x04 & ((x74 & (x77 ? ~x42 : ~x79)) | (x77 & (~x79 | (~new_n181_ & ~x42))));
  assign new_n255_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n256_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = (~x74 & ~x79) | (~x01 & x79 & ~new_n252_ & x82);
  assign z64 = (~x74 & ~x79) | (~x01 & (new_n259_ | (x79 & ~new_n252_ & x83)));
  assign new_n259_ = x04 & x74 & ~x77 & x78 & ~x79;
