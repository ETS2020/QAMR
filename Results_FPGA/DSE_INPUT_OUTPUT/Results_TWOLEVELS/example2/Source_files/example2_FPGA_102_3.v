...
module FAU ( 
  ...
  assign z53 = (~x01 & new_n230_ & x04) | (x79 & (x01 | (new_n181_ & x73)));
  ...
  assign z56 = x01 | new_n236_ | (~x01 & (~x00 | (~x77 & ~x78)));
  ...
  assign new_n240_ = x04 & x78 & x79 & (new_n241_ | (new_n179_ & new_n242_));
  ...
  assign new_n246_ = x78 & x79 & (x40 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n247_ = x78 ? ~x04 : ~x40;
  assign z60 = (x79 & (new_n237_ | x01 | (new_n249_ & x04))) | (~x01 & ~x79 & (~x04 | (x04 & x78)));
  ...
  assign z62 = (x78 & ((~new_n177_ & x04) | (new_n253_ & x79))) | (~new_n254_ & x79);
  assign new_n253_ = x81 & (x77 ? ~x04 : x84);
  assign new_n254_ = ~x01 & (~x77 | x78 | ~x81 | ~x84);
  assign z63 = x79 & (x01 | (~new_n251_ & x82));
  assign z64 = ~x01 & ((new_n257_ & x78 & ~x79) | (x79 & ~new_n251_ & x83));
