...
module FAU ( 
  ...
  assign new_n180_ = (x79 | (~x77 & (x74 | x77))) & (x42 | ~x77 | (new_n181_ & new_n182_));
  assign new_n181_ = x43 & ~x74 & x80;
  assign new_n182_ = ~x83 & x84 & x81 & x82;
  assign z23 = (~x00 & (x79 | (~x01 & ~x74))) | (x01 & (~x74 | x79)) | (~x79 & (x74 | (~x04 & x05)));
  ...
  assign z48 = ~x01 & ((x04 & new_n218_ & ~x74) | (new_n219_ & x68));
  ...
  assign z52 = ~x01 & ((new_n219_ & x72) | (x04 & new_n227_ & ~x74));
  ...
  assign z56 = (~x00 & (x79 | (~x01 & ~x74))) | (x01 & (~x74 | x79)) | (~new_n235_ & x79) | (new_n237_ & ~x74);
  ...
  assign z58 = ~x01 & (new_n245_ | (~new_n240_ & ~x74));
  assign new_n240_ = ~new_n244_ & (~x04 | ~x78 | (~new_n241_ & (~new_n242_ | ~new_n243_)));
  assign new_n241_ = ~x77 & ~x79;
  assign new_n242_ = x77 & x79 & ~x42 & x43;
  assign new_n243_ = x80 & x81 & x82 & ~x83 & x84;
  assign new_n244_ = ~x79 & (~x04 | (x77 & ~x78 & x40 & ~x42));
  assign new_n245_ = x04 & ~x40 & x42 & x77 & x78 & x79;
  assign z59 = new_n154_ | (~x01 & (new_n249_ | (x77 & (new_n247_ | new_n248_))));
  assign new_n247_ = x04 & x78 & (~x79 | (~x42 & (~new_n181_ | ~new_n182_)));
  assign new_n248_ = x40 & ((x04 & x78) | (~x74 & ~x78 & ~x79));
  assign new_n249_ = ~x04 & ~x74 & ~x79;
  assign z60 = new_n251_ | (~x01 & ((~new_n255_ & ~x79) | new_n253_ | (new_n236_ & x79)));
  assign new_n251_ = ~new_n252_ & x74;
  assign new_n252_ = x79 & (x01 | ~x04 | x42 | ~x77 | ~x78);
  assign new_n253_ = x04 & ~x42 & x77 & ~new_n254_ & x78;
  assign new_n254_ = x82 & ~x83 & x84 & x43 & x80 & x81;
  assign new_n255_ = x04 ? (~x78 | (~x77 & (x74 | x77))) : x74;
  assign z61 = ~x01 & x79 & ~new_n257_ & x80;
  assign new_n257_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = new_n251_ | (~x01 & (new_n261_ | (x78 & (new_n259_ | new_n260_))));
  assign new_n259_ = x77 & (x04 ? (~x79 | (~new_n254_ & ~x42)) : (x79 & x81));
  assign new_n260_ = ~x77 & ((x79 & x81 & x84) | (x04 & ~x74 & ~x79));
  assign new_n261_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = (x74 & ~x79) | (~x01 & x79 & ~new_n257_ & x82);
  assign z64 = (x74 & ~x79) | (~x01 & (new_n264_ | (x79 & ~new_n257_ & x83)));
  assign new_n264_ = x04 & ~x74 & ~x77 & x78 & ~x79;
