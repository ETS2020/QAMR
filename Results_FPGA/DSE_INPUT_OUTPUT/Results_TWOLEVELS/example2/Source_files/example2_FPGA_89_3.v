...
module FAU ( 
  ...
  assign new_n205_ = x77 & x78 & ~new_n201_ & x79;
  ...
  assign z43 = ~x01 & ~x04 & new_n205_ & x61;
  ...
  assign z49 = ~x01 & ((new_n222_ & x04) | (new_n220_ & x69));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = (~x01 & new_n224_ & x04) | (x79 & (x01 | (new_n225_ & x70)));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign new_n225_ = x77 & ~x78 & (~x81 ^ x84);
  assign z51 = (~x01 & new_n227_ & x04) | (x79 & (x01 | (new_n225_ & x71)));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n229_ & x04) | (new_n220_ & x72));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = (~x01 & new_n231_ & x04) | (x79 & (x01 | (new_n225_ & x73)));
  ...
  assign z56 = x01 | new_n238_ | (~x01 & (~x00 | (~x77 & ~x78)));
  assign new_n238_ = x79 & (new_n239_ | (x76 & (~x77 | ~x78)));
  ...
  assign z60 = (x79 & (new_n239_ | x01)) | (~x01 & (x04 ? (x78 & (new_n179_ | ~x79)) : ~x79));
  assign z61 = x79 & (x01 | (~new_n252_ & x80));
  assign new_n252_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n254_ : (new_n255_ | new_n256_))) | (new_n256_ & x77 & ~x78));
  assign new_n254_ = x04 ? (x79 & (x42 | (new_n180_ & new_n181_))) : (~x79 | ~x81);
  ...
  assign new_n261_ = ~x01 & (~x84 | ((x04 | ~x77 | ~x78) & (x01 | ~x81 | (x77 ^ ~x78))));
endmodule
