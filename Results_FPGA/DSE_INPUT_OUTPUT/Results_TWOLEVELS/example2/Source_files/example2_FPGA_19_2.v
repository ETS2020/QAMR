...
module FAU ( 
  ...
  assign z01 = ~x01 & (x79 ? (x77 ^ ~x78) : ~x10);
  ...
  assign z47 = ~x01 & ((new_n218_ & x77) | (x04 & ~x10 & new_n217_ & ~x77));
  ...
  assign z54 = ~x01 & x04 & new_n232_ & ~x10;
  ...
  assign z60 = ~x01 & ((x79 & (new_n251_ | new_n238_)) | (~x10 & ~new_n252_ & ~x79));
  assign new_n251_ = x04 & ~x42 & x77 & x78 & (~new_n180_ | ~new_n181_);
  assign new_n252_ = x04 & (~x04 | ~x78);
  assign z61 = (x10 & ~x79) | (~x01 & x79 & ~new_n254_ & x80);
