...
module FAU ( 
  ...
  assign new_n154_ = x28 & ~x79;
  assign new_n155_ = ~x79 & (x28 | (x77 & (~x77 | x78 | x79)));
  assign z01 = (x28 & ~x79) | (~x01 & (~x79 | (x79 & (x77 ^ ~x78))));
  assign z02 = (x28 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & x52 & ~x01 & ~x28;
  assign z04 = (x28 & ~x79) | (~x01 & (~x77 | ~x78 | (x77 & x78 & x79)));
  ...
  assign z22 = ~x01 & (new_n182_ | (x78 & (new_n184_ | (~new_n179_ & x04))));
  assign new_n179_ = (x28 | x79) & (x42 | ~x77 | new_n180_ | ~x79);
  assign new_n180_ = new_n181_ & x43 & ~x74 & x80;
  assign new_n181_ = ~x83 & x84 & x81 & x82;
  assign new_n182_ = ~x41 & new_n183_ & x66;
  assign new_n183_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign new_n184_ = ~x41 & x75 & ~x77 & x79 & (~x81 ^ x84);
  assign z23 = ((~x00 | x01) & (~x28 | x79)) | (~x79 & (x28 | (~x04 & x05)));
  ...
  assign z48 = ~x01 & ((x04 & new_n220_ & ~x28) | (new_n183_ & x68));
  ...
  assign z50 = ~x01 & ((x04 & new_n224_ & ~x28) | (new_n183_ & x70));
  ...
  assign z53 = new_n154_ | (~x01 & ((new_n183_ & x73) | (new_n230_ & x04)));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n232_ & ~x28;
  ...
  assign z56 = ((~x00 | x01) & (~x28 | x79)) | (new_n239_ & ~x28) | (~new_n237_ & x79);
  ...
  assign z58 = new_n154_ | (~new_n242_ & ~x01);
  assign new_n242_ = (new_n244_ | x79) & (~x04 | ~x77 | ~x78 | new_n243_ | ~x79);
  assign new_n243_ = (x40 | ~x42) & (~new_n181_ | x42 | ~x43 | x74 | ~x80);
  assign new_n244_ = (x28 | (x04 & (~x04 | x77 | ~x78))) & (~x40 | x42 | ~x77 | x78);
  assign z59 = (x28 & ~x79) | (~x01 & ((~new_n246_ & x77) | (~x04 & ~x28 & ~x79)));
  assign new_n246_ = (x28 | x79 | (x78 ? ~x04 : ~x40)) & (~x04 | ~x78 | (~new_n247_ & ~x40));
  assign new_n247_ = ~x42 & x79 & (~new_n181_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((~new_n249_ & x79) | (~x28 & ~x79 & (~x04 | (x04 & x78))));
  assign new_n249_ = (new_n238_ | (x77 ^ ~x78)) & (~x04 | x42 | ~x77 | new_n180_ | ~x78);
  assign z61 = ~x01 & x79 & ~new_n251_ & x80;
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n254_ | (x78 & (new_n253_ | (~new_n179_ & x04))));
  assign new_n253_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n254_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = (x28 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
  assign z64 = ~x01 & (new_n257_ | (x79 & ~new_n251_ & x83));
  assign new_n257_ = x04 & ~x28 & ~x77 & x78 & ~x79;
