...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n200_, new_n203_, new_n215_, new_n223_, new_n224_, new_n226_,
    new_n227_, new_n230_, new_n232_, new_n234_, new_n236_, new_n238_,
    new_n242_;
  ...
  assign z46 = ~x01 & (~x79 | (~x04 & new_n203_ & x64));
  ...
  assign z60 = ~x01 & (new_n227_ | ~x79 | (x04 & new_n234_ & ~x42));
  assign new_n234_ = x77 & x78 & x79 & (~new_n179_ | ~new_n180_);
  assign z61 = ~x01 & (~x79 | (~new_n236_ & x80));
  assign new_n236_ = (x04 | ~x77 | ~x78) & (new_n177_ | (~x77 ^ x78));
  assign z62 = ~x01 & x79 & (new_n178_ | new_n238_);
  assign new_n238_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
