// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:10 2020
...
module FAU ( 
  ...
  assign z02 = (x53 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & (x53 | (~x01 & x52 & x78));
  assign z04 = (x53 & ~x79) | (~x01 & (~x77 | ~x78 | (x77 & x78 & x79)));
  ...
  assign new_n179_ = x78 & ((x79 & (new_n183_ | (new_n180_ & x04))) | (x04 & ~x53 & ~x79));
  ...
  assign z48 = ~x01 & ((x04 & new_n220_ & ~x53) | (new_n184_ & x68));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((x04 & new_n222_ & ~x53) | (new_n184_ & x69));
  ...
  assign z51 = ~x01 & ((x04 & new_n226_ & ~x53) | (new_n184_ & x71));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = new_n154_ | (~x01 & ((new_n184_ & x72) | (new_n228_ & x04)));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = new_n154_ | (~x01 & ((new_n184_ & x73) | (new_n230_ & x04)));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n232_ & ~x53;
  ...
  assign z58 = (x53 & ~x79) | (~x01 & ((~new_n240_ & x77) | (~x53 & ~new_n242_ & ~x79)));
  ...
  assign z59 = (x53 & ~x79) | (~x01 & ((~new_n244_ & x77) | (~x04 & ~x53 & ~x79)));
  assign new_n244_ = (~x40 | ((~x04 | ~x78) & (x53 | x78 | x79))) & (~x04 | ~x78 | (~new_n245_ & (x53 | x79)));
  assign new_n245_ = ~x42 & x79 & (~new_n181_ | ~new_n182_);
  assign z60 = ~x01 & ((~new_n247_ & x79) | (~x53 & ~x79 & (~x04 | (x04 & x78))));
  ...
  assign new_n253_ = (x53 | x79) & (x42 | ~x77 | ~x79 | (new_n181_ & new_n182_));
  assign new_n254_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n255_ = x79 & x81 & x84;
  assign z63 = (x53 & ~x79) | (~x01 & x79 & ~new_n250_ & x82);
  assign z64 = (x53 & ~x79) | (~x01 & (new_n258_ | (x79 & ~new_n250_ & x83)));
  assign new_n258_ = x04 & ~x53 & ~x77 & x78 & ~x79;
  assign z65 = (x53 & ~x79) | (~x01 & new_n260_ & x79);
