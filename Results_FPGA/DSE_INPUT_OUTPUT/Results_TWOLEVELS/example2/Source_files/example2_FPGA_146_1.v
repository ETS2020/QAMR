// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:28 2020
...
module FAU ( 
  ...
  assign z01 = (~x79 & (~x01 | x80)) | (~x01 & (x77 ? (x78 & x79) : ~x78));
  assign z02 = (~x79 & x80) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x80 & ~x79 & x78 & ~x01 & x52;
  assign z04 = (~x79 & x80) | (~x01 & (~x77 | ~x78 | (x77 & x78 & x79)));
  ...
  assign z22 = (~x79 & x80) | (~x01 & (new_n182_ | (~new_n179_ & x79)));
  assign new_n179_ = ~new_n180_ & (x41 | new_n158_ | (x81 ^ x84));
  assign new_n180_ = x04 & ~x42 & x77 & ~new_n181_ & x78;
  assign new_n181_ = x43 & ~x74 & x81 & x82 & ~x83 & x84;
  assign new_n182_ = x04 & x78 & ~x80 & (x77 ? (~x42 | ~x79) : ~x79);
  assign z23 = (~x79 & (x80 | (~x04 & x05))) | ~x00 | x01;
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((x77 & x78 & x79) | (~x79 & ~x80));
  ...
  assign z41 = new_n154_ | (~x01 & ~x04 & new_n200_ & x59);
  ...
  assign z47 = new_n154_ | (~x01 & ((x04 & new_n215_ & ~x77) | (new_n216_ & x77)));
  assign new_n215_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = ~x78 & x79 & (~x81 ^ x84) & (x67 | x75);
  assign z48 = new_n154_ | (~x01 & ((new_n218_ & x04) | (new_n219_ & x68)));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n219_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = new_n154_ | (~x01 & ((new_n219_ & x69) | (new_n221_ & x04)));
  ...
  assign z56 = new_n235_ | ~x00 | x01 | new_n154_ | (~x01 & ~x77 & ~x78);
  assign new_n235_ = x79 & ((new_n236_ & ~x01) | (x76 & (~x77 | ~x78)));
  assign new_n236_ = (x81 ^ x84) & (x77 ^ x78);
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = (~x79 & x80) | (~x01 & ((~new_n239_ & x77) | (~x79 & ~new_n242_ & ~x80)));
  assign new_n239_ = (~x04 | ~x78 | (~new_n240_ & (x40 | ~x42 | ~x79))) & (~x40 | x42 | x78 | x79);
  assign new_n240_ = new_n241_ & ~x74 & x80 & ~x42 & x43;
  assign new_n241_ = ~x83 & x84 & x81 & x82;
  assign new_n242_ = x04 & (~x04 | x77 | ~x78);
  assign z59 = new_n154_ | (~new_n244_ & ~x01);
  assign new_n244_ = (~new_n246_ | x04) & (~x77 | ((~x40 | (x78 ? ~x04 : ~new_n246_)) & (~x04 | new_n245_ | ~x78)));
  assign new_n245_ = (x42 | new_n181_ | ~x79) & (x80 | (x42 & x79));
  assign new_n246_ = ~x79 & ~x80;
  assign z60 = ~x01 & (new_n248_ | (x79 & (new_n180_ | new_n236_)));
  assign new_n248_ = ~x80 & (x04 ? (x78 & (x77 ? (~x42 | ~x79) : ~x79)) : ~x79);
  assign z61 = x80 & (~x79 | (~new_n250_ & ~x01));
  assign new_n250_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = new_n154_ | (~new_n252_ & ~x01);
  assign new_n252_ = (~x78 | (x77 ? new_n253_ : (~new_n254_ & (~new_n246_ | ~x04)))) & (~new_n254_ | ~x77 | x78);
  assign new_n253_ = x04 ? ((x80 | (x42 & x79)) & (x42 | new_n181_ | ~x79)) : (~x79 | ~x81);
  assign new_n254_ = x79 & x81 & x84;
  assign z63 = (~x79 & x80) | (~x01 & x79 & ~new_n250_ & x82);
  assign z64 = ~x01 & (new_n257_ | (x79 & ~new_n250_ & x83));
  assign new_n257_ = x04 & ~x77 & new_n246_ & x78;
  assign z65 = (~x79 & x80) | (~x01 & new_n259_ & x79);
