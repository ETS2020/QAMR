...
module FAU ( 
  ...
  assign z04 = ~x01 & ((~x31 & (~x77 | ~x78)) | (x79 & (x31 | (x77 & x78))));
  ...
  assign z49 = ~x01 & ((x04 & new_n222_ & ~x31) | (new_n184_ & x69));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n224_ & ~x31) | (new_n184_ & x70));
  ...
  assign z52 = ~x01 & ((x04 & new_n228_ & ~x31) | (new_n184_ & x72));
  ...
  assign z58 = (x31 & ~x79) | (~x01 & ((~new_n240_ & x77) | (~new_n242_ & ~x79)));
  assign new_n240_ = (~x04 | ~x78 | ~x79 | (~new_n241_ & (x40 | ~x42))) & (~x40 | x42 | x78 | x79);
  assign new_n241_ = new_n182_ & ~x42 & x43 & ~x74 & x80;
  assign new_n242_ = x04 & (~x04 | x31 | x77 | ~x78);
  assign z59 = (x31 & ~x79) | (~x01 & ((~x04 & ~x79) | (~new_n244_ & x77)));
  assign new_n244_ = (x31 | x79 | (x78 ? ~x04 : ~x40)) & (~x04 | ~x78 | (~new_n245_ & ~x40));
  ...
  assign z61 = (x31 & ~x79) | (~x01 & x79 & ~new_n249_ & x80);
  ...
  assign z64 = (x31 & ~x79) | (~x01 & (new_n256_ | (x79 & ~new_n249_ & x83)));
  assign new_n256_ = x04 & ~x31 & ~x77 & x78 & ~x79;
  assign z65 = (x31 & ~x79) | (~x01 & new_n258_ & x79);
