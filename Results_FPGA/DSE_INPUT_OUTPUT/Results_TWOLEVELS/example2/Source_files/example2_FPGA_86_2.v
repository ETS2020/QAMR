...
module FAU ( 
  ...
  assign z23 = ((~x00 | x01) & (~x56 | x79)) | (~x79 & (x56 | (~x04 & x05)));
  assign z24 = ~x01 & new_n187_ & ~x04;
  assign new_n187_ = x05 & ~x43 & ((~x56 & ~x79) | (x77 & x78 & x79));
  ...
  assign z49 = ~x01 & ((x04 & new_n222_ & ~x56) | (new_n184_ & x69));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n224_ & ~x56) | (new_n184_ & x70));
  ...
  assign z58 = (x56 & ~x79) | (~x01 & ((~new_n241_ & x77) | (~x56 & ~new_n243_ & ~x79)));
  ...
  assign z59 = ~x01 & ((~new_n245_ & x77) | (~x04 & ~x56 & ~x79));
  assign new_n245_ = (~x40 | ((~x04 | ~x78 | ~x79) & (x56 | x78 | x79))) & (~x04 | ~x78 | (~new_n246_ & (x56 | x79)));
  assign new_n246_ = ~x42 & x79 & (~new_n181_ | ~new_n182_);
  assign z60 = (x56 & ~x79) | (~x01 & ((~new_n248_ & x79) | (~x56 & ~x79 & (~x04 | (x04 & x78)))));
  assign new_n248_ = (new_n237_ | (~x77 ^ x78)) & (~x04 | x42 | ~x77 | new_n249_ | ~x78);
  assign new_n249_ = new_n181_ & new_n182_;
  assign z61 = (x56 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  ...
  assign new_n254_ = (x56 | x79) & (x42 | ~x77 | ~x79 | (new_n181_ & new_n182_));
  assign new_n255_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n256_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n251_ & x82;
  assign z64 = (x56 & ~x79) | (~x01 & (new_n259_ | (x79 & ~new_n251_ & x83)));
