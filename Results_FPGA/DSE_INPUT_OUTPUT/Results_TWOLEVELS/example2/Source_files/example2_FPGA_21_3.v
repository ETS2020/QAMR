// Benchmark "FAU" written by ABC on Sat Aug 22 04:57:06 2020
...
module FAU ( 
  ...
  assign z04 = (x79 & (x01 | (~x01 & x77 & x78))) | (~x01 & (~x77 | ~x78));
  ...
  assign z23 = (~x79 & (x01 | (~x04 & x05))) | (~x00 & ~x01);
  assign z24 = (x01 & x79) | (~x04 & x05 & ~x43 & (new_n184_ | (~x01 & ~x79)));
  assign new_n184_ = x77 & x78 & x79;
  ...
  assign z28 = x79 & (x01 | (~x04 & ~x42 & new_n190_ & x46));
  assign new_n190_ = x77 & x78 & (x81 ? (x82 ^ ~x84) : (x82 ^ x84));
  assign z29 = ~x01 & ~x04 & ~x42 & new_n186_ & x47;
  assign z30 = x79 & (x01 | (~x04 & ~x42 & new_n190_ & x48));
  assign z31 = ~x01 & ~x04 & ~x42 & new_n186_ & x49;
  assign z32 = x79 & (x01 | (~x04 & ~x42 & new_n190_ & x50));
  ...
  assign z50 = (~x01 & new_n224_ & x04) | (x79 & (x01 | (new_n220_ & x70)));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n226_ & x04) | (new_n227_ & x71));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign new_n227_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z52 = ~x01 & ((new_n227_ & x72) | (new_n229_ & x04));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n227_ & x73) | (new_n231_ & x04));
  ...
  assign z56 = x01 ? ~x79 : ((~new_n237_ & x79) | ~x00 | (~x77 & ~x78));
  assign new_n237_ = ~new_n238_ & (~x76 | (x77 & x78));
  assign new_n238_ = (~x81 ^ ~x84) & (x77 ^ x78);
  assign z57 = (x01 & x79) | (~x02 & x03 & x00 & ~x01);
  assign z58 = ~x01 & (new_n245_ | (x77 & (new_n241_ | new_n244_)));
  assign new_n241_ = x04 & x78 & x79 & (new_n242_ | (new_n181_ & new_n243_));
  ...
  assign z59 = ~x01 & ((x77 & (new_n248_ | (new_n247_ & x04))) | (~x04 & ~x79));
  assign new_n247_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n248_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = x01 ? x79 : ((new_n238_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign z61 = x79 & (x01 | (~new_n251_ & x80));
  assign new_n251_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z62 = new_n256_ | (x78 & (x77 ? (new_n253_ | new_n255_) : ~new_n254_));
  assign new_n253_ = ~x01 & x04 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n254_ = (x01 | ~x04 | x79) & (~x79 | ~x81 | ~x84);
  assign new_n255_ = ~x04 & x79 & x81;
  assign new_n256_ = x79 & (x01 | (x77 & ~x78 & x81 & x84));
  assign z63 = x79 & (x01 | (~new_n251_ & x82));
  assign z64 = ~x01 & ((new_n259_ & x78 & ~x79) | (x79 & ~new_n251_ & x83));
  assign new_n259_ = x04 & ~x77;
  assign z65 = ~new_n261_ & x79;
