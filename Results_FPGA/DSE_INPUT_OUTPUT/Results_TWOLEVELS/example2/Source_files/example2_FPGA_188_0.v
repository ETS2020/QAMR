// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:56 2020
...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x02 | (x77 & (~x77 | x78 | x79)));
  assign z01 = (~x02 & ~x79) | (~x01 & ((~x77 & ((~x78 & x79) | (x02 & x04 & x78 & ~x79))) | (x02 & ~x79 & (~x04 | ~x78)) | (x77 & x78)));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (~x02 | (~x01 & x52 & x78));
  assign z04 = ~x01 & (x79 | (x02 & (~x77 | (~x78 & ~x79))));
  ...
  assign new_n178_ = x78 & (new_n182_ | (~new_n179_ & x04));
  assign new_n179_ = (~x02 | x79) & (x42 | ~x77 | ~x79 | (new_n180_ & new_n181_));
  ...
  assign z23 = (~x00 & (x79 | (~x01 & x02))) | (x01 & (x02 | x79)) | (~x79 & (~x02 | (~x04 & x05)));
  assign z24 = ~x01 & new_n186_ & ~x04;
  assign new_n186_ = x05 & ~x43 & (new_n187_ | (x02 & ~x79));
  ...
  assign z47 = ~x01 & ((new_n218_ & x77) | (x02 & x04 & new_n217_ & ~x77));
  assign new_n217_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n218_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((x02 & new_n220_ & x04) | (new_n183_ & x68));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((x02 & new_n222_ & x04) | (new_n183_ & x69));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x02 & new_n224_ & x04) | (new_n183_ & x70));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x02 & new_n226_ & x04) | (new_n183_ & x71));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = new_n154_ | (~x01 & ((new_n228_ & x04) | (new_n183_ & x72)));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = new_n154_ | (~x01 & ((new_n230_ & x04) | (new_n183_ & x73)));
  ...
  assign z56 = (~x00 & (x79 | (~x01 & x02))) | (x01 & (x02 | x79)) | (new_n238_ & x02) | (~new_n236_ & x79);
  ...
  assign z58 = new_n154_ | (~new_n241_ & ~x01);
  assign new_n241_ = (new_n243_ | x79) & (~x04 | ~x77 | ~x78 | new_n242_ | ~x79);
  assign new_n242_ = (x40 | ~x42) & (~new_n181_ | x74 | ~x80 | x42 | ~x43);
  assign new_n243_ = (~x02 | (x04 & (~x04 | x77 | ~x78))) & (~x77 | x78 | ~x40 | x42);
  assign z59 = (~x02 & ~x79) | (~x01 & ((~new_n245_ & x77) | (x02 & ~x04 & ~x79)));
  assign new_n245_ = (~x02 | x79 | (x78 ? ~x04 : ~x40)) & (~x04 | ~x78 | (~new_n246_ & ~x40));
  assign new_n246_ = ~x42 & x79 & (~new_n180_ | ~new_n181_);
  assign z60 = ~x01 & ((~new_n248_ & x79) | (x02 & ~x79 & (~x04 | (x04 & x78))));
  ...
  assign z62 = new_n154_ | (~new_n253_ & ~x01);
  assign new_n253_ = (~x78 | (~new_n254_ & (new_n179_ | ~x04))) & (~new_n255_ | ~x77 | x78);
  assign new_n254_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n255_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n251_ & x82;
  assign z64 = (~x02 & ~x79) | (~x01 & (new_n258_ | (x79 & ~new_n251_ & x83)));
