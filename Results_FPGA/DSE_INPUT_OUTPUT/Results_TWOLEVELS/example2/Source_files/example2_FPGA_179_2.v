// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:50 2020
...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (x66 | (x77 & (~x77 | x78 | x79)));
  assign z01 = (x66 & ~x79) | (~x01 & ((~x79 & (~x78 | (~x66 & (~x04 | (x04 & ~x77 & x78))))) | (x77 & x78) | (~x77 & ~x78 & x79)));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & x78 & ~x66 & ~x01 & x52;
  assign z04 = (~x79 & (x66 | (~x01 & ~x78))) | (~x01 & (~x77 | x79));
  ...
  assign new_n182_ = x04 & ~x66 & x78 & ~x79;
  assign z23 = (~x00 & (x79 | (~x01 & ~x66))) | (x01 & (~x66 | x79)) | (~x04 & x05 & ~x66 & ~x79);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((~x66 & ~x79) | (x77 & x78 & x79));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x66 & new_n215_ & ~x77));
  assign new_n215_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = ~x78 & x79 & (~x81 ^ x84) & (x67 | x75);
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & ~x66));
  ...
  assign new_n241_ = (x40 | ~x42) & (~new_n180_ | x74 | ~x80 | x42 | ~x43);
  assign new_n242_ = x40 & ~x42 & ~x66 & ~x78 & ~x79;
  assign new_n243_ = ~x66 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = (x66 & ~x79) | (~x01 & ((~new_n245_ & x77) | (~x04 & ~x66 & ~x79)));
  assign new_n245_ = (~x40 | ((x66 | x78 | x79) & (~x04 | ~x78))) & (~x04 | ~x78 | (~new_n246_ & (x66 | x79)));
  assign new_n246_ = ~x42 & x79 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign z60 = (x66 & ~x79) | (~x01 & ((x79 & (new_n178_ | new_n236_)) | (~x66 & ~new_n248_ & ~x79)));
  assign new_n248_ = x04 & (~x04 | ~x78);
  assign z61 = (x66 & ~x79) | (~x01 & x79 & ~new_n250_ & x80);
  assign new_n250_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (new_n252_ | new_n253_)) | (new_n254_ & x77 & ~x78));
  assign new_n252_ = x04 & ((~x66 & ~x79) | (~x42 & x77 & ~new_n179_ & x79));
  assign new_n253_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n254_ = x79 & x81 & x84;
  assign z63 = (x66 & ~x79) | (~x01 & x79 & ~new_n250_ & x82);
  assign z64 = (x66 & ~x79) | (~x01 & (new_n257_ | (x79 & ~new_n250_ & x83)));
  assign new_n257_ = x04 & ~x66 & ~x77 & x78 & ~x79;
  assign z65 = (x66 & ~x79) | (~x01 & new_n259_ & x79);
