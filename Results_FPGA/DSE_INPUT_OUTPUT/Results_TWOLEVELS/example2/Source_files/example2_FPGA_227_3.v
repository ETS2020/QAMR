...
module FAU ( 
  ...
  assign z52 = ~x01 & ((x04 & new_n228_ & ~x77) | (x72 & new_n229_ & x77));
  assign new_n228_ = x78 & ~x79 & (x52 ? x20 : x12);
  assign new_n229_ = ~x78 & x79 & (~x81 ^ x84);
  ...
  assign z56 = x01 ? ~x79 : (~new_n238_ | (x79 & (new_n237_ | (~new_n184_ & x76))));
  ...
  assign z60 = x01 ? x79 : ((new_n237_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
