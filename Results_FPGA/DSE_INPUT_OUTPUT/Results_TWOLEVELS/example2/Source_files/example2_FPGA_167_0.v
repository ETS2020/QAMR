...
module FAU ( 
  ...
  assign z22 = ~x01 & (new_n178_ | (x04 & ~new_n180_ & x78));
  assign new_n178_ = ~x41 & x79 & ~new_n179_ & (x81 ^ ~x84);
  assign new_n179_ = (~x66 | ~x77 | x78) & (~x75 | x77 | ~x78);
  ...
  assign z52 = new_n154_ | (~x01 & (new_n227_ | (new_n228_ & x72)));
  assign new_n227_ = x04 & ~x77 & ~x79 & (x52 ? x20 : x12);
  assign new_n228_ = x77 & ~x78 & (x81 ^ ~x84);
  assign z53 = new_n154_ | (~x01 & (new_n230_ | (new_n228_ & x73)));
  ...
  assign z58 = ~x01 & x78 & (x04 ? (x77 ? (~new_n240_ & x79) : ~x79) : ~x79);
  ...
  assign z60 = ~x01 & ((new_n237_ & x79) | (x78 & (x04 ? ~new_n180_ : ~x79)));
  assign z61 = new_n154_ | (~x01 & ~new_n245_ & x80);
  assign new_n245_ = ((~x81 ^ ~x84) | (x77 ? x78 : (~x78 | ~x79))) & (x04 | ~x77 | ~x78 | ~x79);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n247_ : (new_n248_ | new_n249_))) | (new_n249_ & x77 & ~x78));
  assign new_n247_ = x04 ? (x79 & (x42 | (new_n181_ & new_n182_))) : (~x79 | ~x81);
  assign new_n248_ = x04 & ~x79;
  assign new_n249_ = x79 & x81 & x84;
  assign z63 = ~x01 & new_n251_ & x79;
  assign new_n251_ = x82 & (((~x81 ^ x84) & (~x77 ^ ~x78)) | (~x04 & x77 & x78));
