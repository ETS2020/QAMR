...
module FAU ( 
  ...
  assign z01 = ~x01 & ~x79 & ((x78 & (~x77 | (x04 & x77))) | ~x04 | ~x78);
  assign z03 = ~x01 & (x79 | (x52 & x78));
  assign z04 = ~x01 & ~x79 & (~x78 | (~x77 & x78));
  assign z05 = ~z25 & (x40 ? x65 : x23);
  assign z25 = ~x01 & x79;
  assign z06 = ~z25 & (x40 ? x64 : x24);
  assign z07 = z25 | (x25 & ~x40) | (x40 & x63);
  ...
  assign new_n198_ = (x79 | (x04 & (x77 | ~x78))) & ~x79 & (~x40 | x42 | ~x77 | x78);
  assign z59 = ~x01 & ~x79 & (~x04 | (x77 & (x78 ? x04 : x40)));
  assign z60 = ~x01 & ~x79 & (~x04 | (x78 & (~x77 | (x04 & x77))));
