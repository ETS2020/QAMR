// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:16 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n200_, new_n201_, new_n206_, new_n216_, new_n217_, new_n219_,
  ...
  assign new_n206_ = x77 & x78 & ~new_n201_ & x79;
  ...
  assign z56 = (~new_n238_ & x79) | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  assign new_n238_ = (~new_n239_ | x01) & (~x76 | (x77 & x78));
  ...
  assign z60 = ~x01 & ((new_n239_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
  ...
  assign new_n259_ = ~new_n251_ & x83;
