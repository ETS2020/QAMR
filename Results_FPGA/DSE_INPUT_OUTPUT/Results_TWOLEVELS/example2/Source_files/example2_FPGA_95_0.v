...
module FAU ( 
  ...
  assign z23 = (~x00 & (x79 | (~x01 & x69))) | (x01 & (x69 | x79)) | (~x79 & (~x69 | (~x04 & x05)));
  ...
  assign z49 = (~x69 & ~x79) | (~x01 & ((new_n223_ & x04) | (new_n221_ & x69)));
  ...
  assign z51 = ~x01 & ((new_n221_ & x71) | (x04 & new_n227_ & x69));
  ...
  assign z54 = ~x79 & (~x69 | (new_n233_ & ~x01));
  ...
  assign z56 = (~x00 & (x79 | (~x01 & x69))) | (x01 & (x69 | x79)) | (new_n239_ & x69) | (~new_n237_ & x79);
  ...
  assign new_n245_ = x40 & ~x42 & x69 & ~x78 & ~x79;
  assign new_n246_ = x69 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((x77 & (new_n249_ | (new_n248_ & x04))) | (new_n187_ & ~x04));
  assign new_n248_ = x78 & ((x69 & ~x79) | (~x42 & x79 & (~new_n181_ | ~new_n182_)));
  assign new_n249_ = x40 & ((x69 & ~x78 & ~x79) | (x04 & x78 & x79));
  assign z60 = ~x01 & ((x79 & (new_n180_ | new_n238_)) | (x69 & ~new_n251_ & ~x79));
  ...
  assign new_n255_ = (~x69 | x79) & (x42 | ~x77 | ~x79 | (new_n181_ & new_n182_));
