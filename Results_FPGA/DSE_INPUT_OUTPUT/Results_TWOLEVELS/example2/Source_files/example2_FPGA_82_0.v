...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n180_, new_n182_,
    ...
    new_n199_, new_n212_, new_n220_, new_n221_, new_n223_, new_n224_,
  ...
  assign new_n180_ = x79 & (x04 | ~x05 | x43 | ~x77 | ~x78);
  ...
  assign z31 = ~x01 & (~x79 | (~x04 & ~x42 & new_n182_ & x49));
  ...
  assign z52 = ~x01 & (~x79 | (x72 & x77 & ~new_n175_ & ~x78));
  ...
  assign new_n227_ = (x40 | ~x42) & (~new_n177_ | x42 | ~x43 | x74 | ~x80);
