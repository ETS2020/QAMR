...
module FAU ( 
  ...
  assign z04 = (~x79 & (~x67 | (~x01 & x67 & ~x78))) | (~x01 & (~x77 | x79));
  ...
  assign z22 = (~x67 & ~x79) | (~x01 & ((~new_n178_ & x79) | (x04 & x67 & x78 & ~x79)));
  ...
  assign z23 = (~x00 & (x79 | (~x01 & x67))) | (x01 & (x67 | x79)) | (x67 & ~x79 & ~x04 & x05);
  ...
  assign z47 = ~x01 & ((new_n216_ & x75) | (x67 & (new_n216_ | (new_n215_ & x04))));
  assign new_n215_ = ~x77 & x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z48 = ~x01 & ((x04 & new_n218_ & x67) | (new_n216_ & x68));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = new_n154_ | (~x01 & ((new_n216_ & x69) | (new_n220_ & x04)));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = new_n154_ | (~x01 & ((new_n216_ & x70) | (new_n222_ & x04)));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = new_n154_ | (~x01 & ((new_n216_ & x71) | (new_n224_ & x04)));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n226_ & x67) | (new_n216_ & x72));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = new_n154_ | (~x01 & ((new_n216_ & x73) | (new_n228_ & x04)));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n230_ & x67;
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & new_n232_ & ~x81;
  assign new_n232_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z56 = (~x00 & (x79 | (~x01 & x67))) | (x01 & (x67 | x79)) | (new_n234_ & x67) | (~new_n235_ & x79);
  assign new_n234_ = ~x77 & ~x78;
  assign new_n235_ = (~x76 | (x77 & x78)) & (x01 | ((x77 | x78) & ((x81 ^ ~x84) | (~x77 ^ x78))));
  ...
  assign new_n241_ = x67 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = (~x67 & ~x79) | (~x01 & ((~new_n243_ & x77) | (~x04 & x67 & ~x79)));
  assign new_n243_ = (~x40 | ((~x04 | ~x78) & (~x67 | x78 | x79))) & (~x04 | ~x78 | (~new_n244_ & (~x67 | x79)));
  assign new_n244_ = ~x42 & x79 & (~new_n180_ | ~new_n181_);
  assign z60 = (~x67 & ~x79) | (~x01 & ((~new_n246_ & x79) | (x67 & ~x79 & (~x04 | (x04 & x78)))));
  assign new_n246_ = ~new_n179_ & ((x81 ^ ~x84) | (x77 ^ ~x78));
  assign z61 = ~x01 & x79 & ~new_n248_ & x80;
  assign new_n248_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n252_ & x77 & ~x78) | (~new_n250_ & x78));
  assign new_n250_ = (new_n251_ | ~x04) & (~x79 | ~x81 | (x77 ? x04 : ~x84));
  assign new_n251_ = (~x67 | x79) & (x42 | ~x77 | ~x79 | (new_n180_ & new_n181_));
  assign new_n252_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n248_ & x82;
  assign z64 = (~x67 & ~x79) | (~x01 & (new_n255_ | (x79 & ~new_n248_ & x83)));
  assign new_n255_ = x04 & x67 & ~x77 & x78 & ~x79;
  assign z65 = (~x67 & ~x79) | (~x01 & new_n257_ & x79);
