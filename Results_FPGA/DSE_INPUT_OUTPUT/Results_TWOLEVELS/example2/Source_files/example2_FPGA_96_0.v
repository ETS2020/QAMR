...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n182_, new_n184_,
    ...
    new_n202_, new_n214_, new_n222_, new_n224_, new_n225_, new_n228_,
  ...
  assign new_n224_ = ~x01 & (x00 | ~x79) & (x01 | (~new_n225_ & x79 & (x77 | x78 | ~x79)));
  ...
  assign z60 = ~x01 & (new_n225_ | ~x79 | (x04 & new_n178_ & ~x42));
