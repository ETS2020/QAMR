// Benchmark "FAU" written by ABC on Sat Aug 22 04:59:02 2020
...
module FAU ( 
  ...
  assign new_n217_ = x79 & (x81 ^ ~x84) & (x67 | x75);
  ...
  assign z50 = (~x01 & new_n224_ & x04) | (x79 & (new_n225_ | x01));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign new_n225_ = x70 & x77 & ~x78 & (x81 ^ ~x84);
  ...
  assign z56 = ~new_n239_ | (x79 & (new_n238_ | (~new_n184_ & x76)));
  assign new_n238_ = (~x81 ^ ~x84) & (x77 ^ x78);
  assign new_n239_ = x00 & ~x01 & (x01 | x77 | x78);
  ...
  assign z60 = ((new_n238_ | x01) & x79) | (~x01 & (x04 ? (x78 & (new_n179_ | ~x79)) : ~x79));
