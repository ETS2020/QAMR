...
module FAU ( 
  ...
  assign z01 = ~x01 & (~x78 | x79 | (~x79 & (~x04 | (x04 & x78))));
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (~x77 | ~x78 | x79);
  assign z05 = z26 | (x40 & x65) | (x23 & ~x40);
  assign z26 = ~x01 & x79;
  assign z06 = ~z26 & (x40 ? x64 : x24);
  assign z07 = z26 | (x40 & x63) | (x25 & ~x40);
  assign z08 = z26 | (x40 & x62) | (x26 & ~x40);
  assign z09 = z26 | (x40 & x61) | (x27 & ~x40);
  assign z10 = ~z26 & (x40 ? x60 : x28);
  assign z11 = z26 | (x40 & x59) | (x29 & ~x40);
  assign z12 = ~z26 & (x40 ? x58 : x30);
  assign z13 = ~z26 & (x40 ? x57 : x31);
  assign z14 = z26 | (x40 & x51) | (x32 & ~x40);
  assign z15 = ~z26 & (x40 ? x50 : x33);
  assign z16 = ~z26 & (x40 ? x49 : x34);
  assign z17 = z26 | (x40 & x48) | (x35 & ~x40);
  assign z18 = z26 | (x40 & x47) | (x36 & ~x40);
  assign z19 = ~z26 & (x40 ? x46 : x37);
  assign z20 = z26 | (x40 & x45) | (x38 & ~x40);
  assign z21 = ~z26 & (x40 ? x44 : x39);
  assign z22 = ~x01 & (x79 | (x04 & x78 & ~x79));
  assign z23 = ~x00 | x01 | (~x01 & x79) | (~x04 & x05);
  ...
  assign z51 = ~x01 & new_n188_ & x04;
  assign new_n188_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  ...
  assign z56 = ~x00 | x01 | (~x01 & x79) | (~x77 & ~x78);
  assign z57 = ~x79 & x03 & ~x02 & x00 & ~x01;
  assign z58 = ~new_n198_ & ~x01;
  assign new_n198_ = (x79 | (x04 & (~x04 | x77 | ~x78))) & ~x79 & (~x40 | x42 | ~x77 | x78);
  assign z59 = ~x01 & ~x79 & (~x04 | (x77 & (x78 ? x04 : x40)));
