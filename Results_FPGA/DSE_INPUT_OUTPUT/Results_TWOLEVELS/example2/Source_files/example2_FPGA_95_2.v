// Benchmark "FAU" written by ABC on Sat Aug 22 04:57:55 2020
...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (x69 | (x77 & (~x77 | x78 | x79)));
  assign z01 = (x69 & ~x79) | (~x01 & ((~x77 & ((~x78 & x79) | (x04 & ~x69 & x78 & ~x79))) | (~x69 & ~x79 & (~x04 | ~x78)) | (x77 & x78)));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (x69 | (~x01 & x52 & x78));
  assign z04 = ~x01 & (x79 | (~x69 & (~x77 | (~x78 & ~x79))));
  ...
  assign z22 = (x69 & ~x79) | (~x01 & (new_n183_ | (x79 & (new_n178_ | new_n180_))));
  ...
  assign z48 = ~x01 & ((new_n221_ & x68) | (x04 & new_n220_ & ~x69));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n221_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = (x69 & ~x79) | (~x01 & ((new_n224_ & x69) | (new_n223_ & x04)));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign new_n224_ = x77 & ~x78 & (x81 ^ ~x84);
  assign z50 = new_n154_ | (~x01 & ((new_n221_ & x70) | (new_n226_ & x04)));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n228_ & ~x69) | (new_n221_ & x71));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = new_n154_ | (~x01 & ((new_n221_ & x72) | (new_n230_ & x04)));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = new_n154_ | (~x01 & ((new_n221_ & x73) | (new_n232_ & x04)));
  assign new_n232_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (x69 | (new_n234_ & ~x01));
  assign new_n234_ = x04 & ~x77 & x78 & (x52 ? x22 : x14);
  assign z55 = new_n154_ | (new_n236_ & new_n186_ & ~x01 & ~x04);
  assign new_n236_ = ~x80 & ~x81 & ~x82 & x83 & x84;
  assign z56 = ((~x69 | x79) & (~x00 | x01)) | (new_n240_ & ~x69) | (~new_n238_ & x79);
  ...
  assign z58 = ~x01 & (new_n247_ | (x77 & (new_n243_ | new_n246_)));
  assign new_n243_ = x04 & x78 & x79 & (new_n244_ | (new_n182_ & new_n245_));
  assign new_n244_ = ~x40 & x42;
  assign new_n245_ = ~x74 & x80 & ~x42 & x43;
  assign new_n246_ = x40 & ~x42 & ~x69 & ~x78 & ~x79;
  assign new_n247_ = ~x69 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((new_n187_ & ~x04) | (x77 & (new_n250_ | (new_n249_ & x04))));
  assign new_n249_ = x78 & ((~x69 & ~x79) | (~x42 & x79 & (~new_n181_ | ~new_n182_)));
  assign new_n250_ = x40 & ((~x69 & ~x78 & ~x79) | (x04 & x78 & x79));
  assign z60 = ~x01 & ((x79 & (new_n180_ | new_n239_)) | (~x69 & ~new_n252_ & ~x79));
  assign new_n252_ = x04 & (~x04 | ~x78);
  assign z61 = ~x01 & x79 & ~new_n254_ & x80;
  assign new_n254_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n258_ | (x78 & (new_n257_ | (~new_n256_ & x04))));
  assign new_n256_ = (x69 | x79) & (x42 | ~x77 | ~x79 | (new_n181_ & new_n182_));
  ...
  assign new_n261_ = x04 & ~x69 & ~x77 & x78 & ~x79;
  assign z65 = (x69 & ~x79) | (~x01 & new_n263_ & x79);
