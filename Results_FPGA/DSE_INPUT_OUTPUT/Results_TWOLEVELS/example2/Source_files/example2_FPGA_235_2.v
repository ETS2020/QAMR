...
module FAU ( 
  ...
  assign z50 = ~x01 & ((x04 & new_n223_ & ~x43) | (new_n219_ & x70));
  ...
  assign z53 = ~x01 & ((x04 & new_n229_ & ~x43) | (new_n219_ & x73));
  ...
  assign new_n236_ = x79 & ((~new_n185_ & x76) | (new_n237_ & ~x01));
  assign new_n237_ = (~x81 ^ ~x84) & (~x77 ^ ~x78);
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = (x43 & ~x79) | (~x01 & ((~new_n240_ & x77) | (~x43 & ~new_n245_ & ~x79)));
  ...
  assign new_n247_ = x04 & x78 & ((~x43 & (~x42 | ~x79)) | (~x42 & ~new_n181_ & x79));
  assign new_n248_ = x40 & ((x04 & x78) | (~x43 & ~x78 & ~x79));
  assign new_n249_ = ~x04 & ~x43 & ~x79;
  assign z60 = ~x01 & (new_n251_ | (x79 & (new_n180_ | new_n237_)));
  assign new_n251_ = ~x43 & (x04 ? (x78 & (x77 ? (~x42 | ~x79) : ~x79)) : ~x79);
  assign z61 = ~x01 & x79 & ~new_n253_ & x80;
  assign new_n253_ = (x04 | ~x77 | ~x78) & ((x81 ^ x84) | (x77 ^ ~x78));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n255_ : (new_n256_ | new_n257_))) | (new_n257_ & x77 & ~x78));
  assign new_n255_ = x04 ? ((x43 | (x42 & x79)) & (x42 | new_n181_ | ~x79)) : (~x79 | ~x81);
  assign new_n256_ = x04 & ~x43 & ~x79;
  assign new_n257_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n253_ & x82;
  assign z64 = (x43 & ~x79) | (~x01 & (new_n260_ | (x79 & ~new_n253_ & x83)));
  assign new_n260_ = x04 & ~x43 & ~x77 & x78 & ~x79;
  assign z65 = (x43 & ~x79) | (~x01 & new_n262_ & x79);
