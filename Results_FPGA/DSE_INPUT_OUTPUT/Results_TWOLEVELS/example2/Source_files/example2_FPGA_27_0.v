// Benchmark "FAU" written by ABC on Sat Aug 22 04:57:09 2020
...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x22 | (x77 & (~x77 | x78 | x79)));
  assign z01 = ~x01 & (x79 ? (x77 ^ ~x78) : x22);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (~x22 | (~x01 & x52 & x78));
  assign z04 = (~x22 & ~x79) | (~x01 & (~x77 | ~x78 | (x77 & x78 & x79)));
  ...
  assign new_n179_ = (~x22 | x79) & (x42 | ~x77 | ~x79 | (new_n180_ & new_n181_));
  ...
  assign z23 = (~x79 & (~x22 | (~x04 & x05))) | ~x00 | x01;
  assign z24 = ~x01 & ~x04 & x05 & ~x43 & (new_n186_ | new_n187_);
  assign new_n186_ = x22 & ~x79;
  ...
  assign z47 = ~x01 & ((new_n218_ & x77) | (x04 & x22 & new_n217_ & ~x77));
  ...
  assign z49 = ~x01 & ((x04 & new_n222_ & x22) | (new_n183_ & x69));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n224_ & x22) | (new_n183_ & x70));
  ...
  assign z53 = ~x01 & ((x04 & new_n230_ & x22) | (new_n183_ & x73));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (new_n232_ | ~x22);
  assign new_n232_ = ~x01 & x04 & ~x77 & x78 & (x14 | x52);
  assign z55 = new_n154_ | (new_n234_ & new_n187_ & ~x01 & ~x04);
  assign new_n234_ = ~x80 & ~x81 & ~x82 & x83 & x84;
  assign z56 = new_n236_ | ~x00 | (~x77 & ~x78) | new_n154_ | x01;
  ...
  assign new_n242_ = x22 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n243_ = x22 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~new_n245_ & x77) | (new_n186_ & ~x04));
  assign new_n245_ = (~x22 | x79 | (x78 ? ~x04 : ~x40)) & (~x04 | ~x78 | ~x79 | (~new_n246_ & ~x40));
  assign new_n246_ = ~x42 & (~new_n180_ | ~new_n181_);
  assign z60 = ~x01 & ((~new_n248_ & x79) | (x22 & ~x79 & (~x04 | (x04 & x78))));
  assign new_n248_ = ~new_n237_ & (~x04 | ~new_n249_ | x42);
  assign new_n249_ = x77 & x78 & (~new_n180_ | ~new_n181_);
  ...
  assign z63 = (~x22 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
  assign z64 = ~x01 & (new_n258_ | (x79 & ~new_n251_ & x83));
  assign new_n258_ = x04 & x22 & ~x77 & x78 & ~x79;
  assign z65 = (~x22 & ~x79) | (~x01 & new_n260_ & x79);
