...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n200_, new_n202_, new_n215_, new_n217_, new_n224_, new_n225_,
  ...
  assign new_n178_ = x77 & x78 & (~new_n180_ | ~new_n179_ | ~x43);
  ...
  assign new_n227_ = ~new_n228_ & x79 & (x77 | x78 | ~x79);
  assign new_n228_ = (x81 ^ x84) & (x77 ^ x78);
  assign z57 = x79 & x03 & ~x02 & x00 & ~x01;
  assign z58 = ~x01 & x04 & x77 & x78 & ~new_n231_ & x79;
  assign new_n231_ = (x40 | ~x42) & (~new_n180_ | ~new_n179_ | x42 | ~x43);
  assign z59 = ~x01 & (~x79 | (x04 & x77 & ~new_n233_ & x78));
  assign new_n233_ = ~x40 & (x42 | ~x79 | (new_n180_ & new_n179_ & x43));
  assign z60 = ~x01 & (new_n228_ | ~x79 | (x04 & new_n235_ & ~x42));
  assign new_n235_ = x77 & x78 & x79 & (~new_n180_ | ~new_n179_ | ~x43);
  assign z61 = ~x01 & (~x79 | (~new_n237_ & x80));
  assign new_n237_ = (x04 | ~x77 | ~x78) & (new_n177_ | (~x77 ^ x78));
  assign z62 = ~x01 & (new_n239_ | ~x79 | (x04 & new_n235_ & ~x42));
