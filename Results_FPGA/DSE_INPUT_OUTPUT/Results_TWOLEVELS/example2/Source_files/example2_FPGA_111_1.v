...
module FAU ( 
  ...
  assign z26 = ~x01 & x79;
  assign z06 = z26 | (x40 & x64) | (x24 & ~x40);
  assign z07 = ~z26 & (x40 ? x63 : x25);
  ...
  assign z23 = x01 | (~x00 & ~x79) | (~x01 & x79) | (~x04 & x05);
  ...
  assign z59 = ~x01 & ((x77 & (x40 | (x04 & x78 & ~x79))) | x79 | (~x04 & ~x79));
