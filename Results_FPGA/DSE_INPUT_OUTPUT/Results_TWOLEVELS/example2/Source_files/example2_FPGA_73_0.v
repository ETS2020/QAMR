...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    new_n185_, new_n191_, new_n195_, new_n196_, new_n197_, new_n199_,
  ...
  assign new_n178_ = x77 & x78 & x79 & (~new_n179_ | ~new_n180_);
  ...
  assign z30 = ~x01 & (~x79 | (~x04 & ~x42 & new_n191_ & x48));
  assign new_n191_ = x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z31 = ~x01 & ~x04 & ~x42 & new_n185_ & x49;
  assign z32 = ~x01 & (~x79 | (~x04 & ~x42 & new_n191_ & x50));
  ...
  assign z37 = ~x01 & (~x79 | (~x04 & new_n204_ & x55));
  assign new_n204_ = x77 & ~new_n200_ & x78;
  ...
  assign z43 = ~x01 & (~x79 | (~x04 & new_n204_ & x61));
  assign z44 = ~x01 & (~x79 | (~x04 & new_n204_ & x62));
  assign z45 = ~x01 & (~x79 | (~x04 & new_n204_ & x63));
  ...
  assign new_n230_ = (x40 | ~x42) & (~new_n180_ | x74 | ~x80 | x42 | ~x43);
  assign z59 = ~x01 & (~x79 | (x04 & x77 & ~new_n232_ & x78));
  assign new_n232_ = ~x40 & (x42 | ~x79 | (new_n179_ & new_n180_));
  assign z60 = ~x01 & (~x79 | (x79 & (new_n234_ | new_n227_)));
  assign new_n234_ = x04 & ~x42 & x77 & x78 & (~new_n179_ | ~new_n180_);
  assign z61 = ~x01 & x79 & ~new_n236_ & x80;
  assign new_n236_ = (x04 | ~x77 | ~x78) & (new_n177_ | (~x77 ^ x78));
  assign z62 = ~x01 & x79 & (new_n234_ | new_n238_);
