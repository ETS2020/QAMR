// Benchmark "FAU" written by ABC on Sat Aug 22 04:57:44 2020
...
module FAU ( 
  ...
  assign z51 = (~x01 & new_n226_ & x04) | (x79 & (x01 | (new_n220_ & x71)));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = (~x01 & new_n228_ & x04) | (x79 & (x01 | (new_n220_ & x72)));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = (~x01 & new_n230_ & x04) | (x79 & (x01 | (new_n220_ & x73)));
  ...
  assign z62 = new_n255_ | (x78 & (x77 ? (new_n252_ | new_n254_) : ~new_n253_));
  assign new_n252_ = ~x01 & x04 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n253_ = (x01 | ~x04 | x79) & (~x79 | ~x81 | ~x84);
  assign new_n254_ = ~x04 & x79 & x81;
  assign new_n255_ = x79 & (x01 | (x77 & ~x78 & x81 & x84));
