// Benchmark "FAU" written by ABC on Sat Aug 22 04:59:39 2020
...
module FAU ( 
  ...
  assign z56 = new_n238_ | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  ...
  assign z60 = ((new_n239_ | x01) & x79) | (~x01 & (x04 ? (x78 & (new_n179_ | ~x79)) : ~x79));
  assign z61 = ~x01 & x79 & ~new_n252_ & x80;
  assign new_n252_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z62 = new_n257_ | (x78 & (x77 ? (new_n254_ | new_n256_) : ~new_n255_));
  assign new_n254_ = ~x01 & x04 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n255_ = (x01 | ~x04 | x79) & (~x79 | ~x81 | ~x84);
  assign new_n256_ = ~x04 & x79 & x81;
  assign new_n257_ = x79 & (x01 | (x77 & ~x78 & x81 & x84));
  assign z63 = x79 & (x01 | (~new_n252_ & x82));
  assign z64 = (x79 & (new_n260_ | x01)) | (~x01 & x04 & ~x77 & x78 & ~x79);
  assign new_n260_ = ~new_n252_ & x83;
