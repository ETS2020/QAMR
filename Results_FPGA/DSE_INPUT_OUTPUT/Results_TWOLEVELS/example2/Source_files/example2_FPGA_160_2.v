...
module FAU ( 
  ...
  assign z04 = ~x01 & (((~x77 | ~x78) & (~x76 | (x76 & x79))) | (x77 & x78 & x79));
  ...
  assign z22 = ~x01 & ((~new_n179_ & x79) | (x04 & ~x76 & x78 & ~x79));
  ...
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & ~x76));
  ...
  assign z50 = ~x01 & ((new_n219_ & x70) | (x04 & new_n223_ & ~x76));
  ...
  assign z54 = ~x79 & (x76 | (new_n231_ & ~x01));
  assign new_n231_ = x04 & ~x77 & x78 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & new_n233_ & ~x81;
  assign new_n233_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z56 = (~x00 & (x79 | (~x01 & ~x76))) | ~new_n235_ | (x01 & (~x76 | x79));
  assign new_n235_ = (x01 | ~x79 | ((~x76 | (x77 & x78)) & (new_n236_ | (x77 ^ ~x78)))) & (x76 | x77 | x78);
  ...
  assign new_n240_ = (x40 | ~x42) & (~new_n182_ | x42 | ~x43 | x74 | ~x80);
  assign new_n241_ = x40 & ~x42 & ~x76 & ~x78 & ~x79;
  assign new_n242_ = ~x76 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = (x76 & ~x79) | (~x01 & ((~new_n244_ & x77) | (~x04 & ~x76 & ~x79)));
  assign new_n244_ = (~x40 | ((~x04 | ~x78) & (x76 | x78 | x79))) & (~x04 | ~x78 | (~new_n245_ & (x76 | x79)));
  assign new_n245_ = ~x42 & x79 & (~new_n181_ | ~new_n182_);
  assign z60 = ~x01 & ((~new_n247_ & x79) | (~x76 & ~x79 & (~x04 | (x04 & x78))));
  assign new_n247_ = ~new_n180_ & (new_n236_ | (x77 ^ ~x78));
  assign z61 = (x76 & ~x79) | (~x01 & x79 & ~new_n249_ & x80);
  assign new_n249_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = new_n154_ | (~new_n251_ & ~x01);
  assign new_n251_ = (~x78 | (~new_n253_ & (new_n252_ | ~x04))) & (~new_n254_ | ~x77 | x78);
  assign new_n252_ = (x76 | x79) & (x42 | ~x77 | ~x79 | (new_n181_ & new_n182_));
  ...
  assign new_n257_ = x04 & ~x76 & ~x77 & x78 & ~x79;
