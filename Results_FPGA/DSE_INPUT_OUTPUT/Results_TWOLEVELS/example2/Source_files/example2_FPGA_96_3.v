...
module FAU ( 
  ...
  assign z56 = x01 | new_n237_ | (~x01 & (~x00 | (~x77 & ~x78)));
  assign new_n237_ = x79 & (new_n238_ | (x76 & (~x77 | ~x78)));
  ...
  assign z60 = (x79 & (new_n238_ | x01)) | (~x01 & (x04 ? (x78 & (new_n179_ | ~x79)) : ~x79));
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = new_n255_ | (~x01 & (new_n254_ | (x78 & (new_n252_ | new_n253_))));
  assign new_n252_ = x04 & x77 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n253_ = ~x77 & (x79 ? (x81 & x84) : x04);
  assign new_n254_ = x77 & ~x78 & x79 & x81 & x84;
  assign new_n255_ = x79 & (x01 | (~x04 & x77 & x78 & x81));
