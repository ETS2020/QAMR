...
module FAU ( 
  ...
  wire new_n174_, new_n175_, new_n176_, new_n177_, new_n178_, new_n181_,
    ...
    new_n198_, new_n200_, new_n213_, new_n215_, new_n222_, new_n224_,
  ...
  assign new_n232_ = x04 & ~x42 & x77 & x78 & (~new_n177_ | ~new_n178_);
  assign z61 = ~x01 & (~x79 | (~new_n234_ & x80));
  assign new_n234_ = (x04 | ~x77 | ~x78) & (new_n175_ | (~x77 ^ x78));
  assign z62 = ~x01 & (new_n237_ | ~x79 | (x79 & (new_n232_ | new_n236_)));
