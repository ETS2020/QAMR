...
module FAU ( 
  ...
  assign z30 = x79 & (x01 | (~x04 & ~x42 & new_n188_ & x48));
  assign z31 = x79 & (x01 | (~x04 & ~x42 & new_n188_ & x49));
  ...
  assign z44 = x79 & (x01 | (~x04 & new_n203_ & x62));
  ...
  assign z48 = (~x01 & new_n219_ & x04) | (x79 & (new_n220_ | x01));
  assign new_n219_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n220_ = x68 & x77 & ~x78 & (~x81 ^ x84);
  ...
  assign z53 = ~x01 & ((new_n223_ & x73) | (new_n231_ & x04));
