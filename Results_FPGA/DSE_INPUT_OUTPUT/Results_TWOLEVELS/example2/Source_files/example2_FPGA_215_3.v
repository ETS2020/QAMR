// Benchmark "FAU" written by ABC on Sat Aug 22 04:59:14 2020
...
module FAU ( 
  ...
  assign z04 = x79 | (~x01 & (~x77 | (~x78 & ~x79)));
  ...
  assign z26 = x79 & (x01 | (~x04 & ~x42 & new_n188_ & x44));
  ...
  assign new_n203_ = x77 & x78 & ~new_n201_ & x79;
  assign z36 = ~x01 & ~x04 & new_n203_ & x54;
  assign z37 = ~x01 & ~x04 & new_n203_ & x55;
  assign z38 = x79 & (x01 | (~x04 & new_n200_ & x56));
  assign z39 = x79 & (x01 | (~x04 & new_n200_ & x57));
  assign z40 = x79 & (x01 | (~x04 & new_n200_ & x58));
  assign z41 = x79 & (x01 | (~x04 & new_n200_ & x59));
  ...
  assign z49 = (~x01 & new_n222_ & x04) | (x79 & (x01 | (new_n220_ & x69)));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n224_ & x04) | (new_n225_ & x70));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign new_n225_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z51 = ~x01 & ((new_n225_ & x71) | (new_n227_ & x04));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n225_ & x72) | (new_n229_ & x04));
  ...
  assign z56 = (~new_n237_ & x79) | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  assign new_n237_ = (~new_n238_ | x01) & (~x76 | (x77 & x78));
  assign new_n238_ = (~x81 ^ ~x84) & (x77 ^ x78);
  assign z57 = x03 & ~x02 & x00 & ~x01;
  assign z58 = ~new_n244_ | (x77 & (new_n243_ | (x04 & new_n241_ & x78)));
  assign new_n241_ = x79 & ((~x40 & x42) | (new_n181_ & new_n242_ & ~x42 & x43));
  assign new_n242_ = ~x74 & x80;
  assign new_n243_ = ~x01 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n244_ = x01 ? ~x79 : (x79 | (x04 & (~x04 | x77 | ~x78)));
  assign z59 = ~x01 & ((x77 & (new_n247_ | (new_n246_ & x04))) | (~x04 & ~x79));
  assign new_n246_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n247_ = x40 & (x78 ? x04 : ~x79);
  ...
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n252_ : (new_n253_ | new_n254_))) | (new_n254_ & x77 & ~x78));
  assign new_n252_ = x04 ? (x79 & (x42 | (new_n180_ & new_n181_))) : (~x79 | ~x81);
  ...
  assign new_n257_ = ~new_n250_ & x83;
