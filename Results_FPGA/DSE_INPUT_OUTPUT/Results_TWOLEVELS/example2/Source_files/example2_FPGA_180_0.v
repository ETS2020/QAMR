...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x74 | (x77 & (~x77 | x78 | x79)));
  assign z01 = (~x74 & ~x79) | (~x01 & ((~x79 & (~x78 | (x74 & (~x04 | (x04 & ~x77 & x78))))) | (x77 & x78) | (~x77 & ~x78 & x79)));
  assign z02 = (~x74 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & (~x74 | (~x01 & x52 & x78));
  assign z04 = (~x79 & (~x74 | (~x01 & ~x78))) | (~x01 & (~x77 | x79));
  ...
  assign z22 = (~x74 & ~x79) | (~x01 & ((~new_n179_ & x79) | (x04 & new_n182_ & x74)));
  ...
  assign new_n182_ = x78 & (x77 ? (~x42 | ~x79) : ~x79);
  assign z23 = (~x00 & (x79 | (~x01 & x74))) | (x01 & (x74 | x79)) | (~x04 & x05 & x74 & ~x79);
  ...
  assign z48 = ~x01 & ((new_n219_ & x68) | (x04 & new_n218_ & x74));
  ...
  assign z50 = ~x01 & ((new_n219_ & x70) | (x04 & new_n223_ & x74));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n219_ & x71) | (x04 & new_n225_ & x74));
  ...
  assign z53 = ~x01 & ((new_n219_ & x73) | (x04 & new_n229_ & x74));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x74 | (new_n231_ & ~x01));
  ...
  assign z56 = (~x00 & (x79 | (~x01 & x74))) | (x01 & (x74 | x79)) | (new_n236_ & x74) | (~new_n237_ & x79);
  assign new_n236_ = ~x77 & ~x78;
  assign new_n237_ = (~x76 | (x77 & x78)) & (x01 | ((x77 | x78) & ((~x81 ^ x84) | (~x77 ^ x78))));
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = ~x01 & (new_n240_ | new_n244_);
  assign new_n240_ = x77 & (new_n243_ | (x04 & x78 & ~new_n241_ & x79));
  assign new_n241_ = (x40 | ~x42) & (~new_n242_ | x74 | ~x80 | x42 | ~x43);
  assign new_n242_ = ~x83 & x84 & x81 & x82;
  assign new_n243_ = x40 & ~x42 & x74 & ~x78 & ~x79;
  assign new_n244_ = x74 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = (~x74 & ~x79) | (~x01 & ((~new_n246_ & x77) | (~x04 & x74 & ~x79)));
  assign new_n246_ = (~x40 | ((~x04 | ~x78) & (~x74 | x78 | x79))) & (~x04 | new_n247_ | ~x78);
  assign new_n247_ = (x42 | new_n181_ | ~x79) & (~x74 | (x42 & x79));
  assign z60 = ~x01 & ((~new_n249_ & x79) | (x74 & (x04 ? new_n182_ : ~x79)));
  assign new_n249_ = ~new_n180_ & ((x81 ^ ~x84) | (x77 ^ ~x78));
  assign z61 = (~x74 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = new_n154_ | (~x01 & ((~new_n253_ & x78) | (new_n255_ & x77 & ~x78)));
  assign new_n253_ = x77 ? (x04 ? new_n247_ : (~x79 | ~x81)) : new_n254_;
  assign new_n254_ = ~new_n255_ & (~x04 | ~x74 | x79);
  assign new_n255_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n251_ & x82;
  assign z64 = (~x74 & ~x79) | (~x01 & (new_n258_ | (x79 & ~new_n251_ & x83)));
  assign new_n258_ = x04 & x74 & ~x77 & x78 & ~x79;
