// Benchmark "FAU" written by ABC on Sat Aug 22 04:57:02 2020
...
module FAU ( 
  ...
  assign z51 = ~x01 & ((x04 & new_n226_ & ~x77) | (x71 & new_n227_ & x77));
  assign new_n226_ = x78 & ~x79 & (x52 ? x19 : x11);
  assign new_n227_ = ~x78 & x79 & (~x81 ^ x84);
  ...
  assign z59 = ~x01 & ((x77 & (new_n249_ | (new_n248_ & x04))) | (~x04 & ~x79));
  assign new_n248_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n249_ = x40 & (x78 ? x04 : ~x79);
  ...
  assign z64 = ~x01 & ((new_n259_ & x78 & ~x79) | (x79 & ~new_n252_ & x83));
