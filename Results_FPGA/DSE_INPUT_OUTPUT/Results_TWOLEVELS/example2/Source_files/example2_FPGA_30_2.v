...
module FAU ( 
  ...
  assign new_n154_ = x17 & ~x79;
  assign new_n155_ = ~x79 & (x17 | (x77 & (~x77 | x78 | x79)));
  assign z01 = ~x01 & (x79 ? (x77 ^ ~x78) : ~x17);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (x17 | (~x01 & x52 & x78));
  assign z04 = (x17 & ~x79) | (~x01 & (~x77 | ~x78 | (x77 & x78 & x79)));
  ...
  assign z47 = ~x01 & ((new_n218_ & x77) | (x04 & ~x17 & new_n217_ & ~x77));
  ...
  assign z54 = ~x01 & x04 & new_n232_ & ~x17;
  ...
  assign z56 = (~new_n237_ & x79) | ~new_n238_ | x01 | (x17 & ~x79);
  assign new_n237_ = (~x76 | (x77 & x78)) & (x01 | (~x81 ^ x84) | (~x77 ^ x78));
  assign new_n238_ = x00 & (x77 | x78);
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = (x17 & ~x79) | (~x01 & ((~new_n241_ & x77) | (~new_n243_ & ~x79)));
  assign new_n241_ = (~x04 | ~x78 | ~x79 | (~new_n242_ & (x40 | ~x42))) & (x78 | x79 | ~x40 | x42);
  assign new_n242_ = new_n181_ & ~x74 & x80 & ~x42 & x43;
  assign new_n243_ = x04 & (~x04 | x17 | x77 | ~x78);
  assign z59 = (x17 & ~x79) | (~x01 & ((~new_n245_ & x77) | (~x04 & ~x79)));
  assign new_n245_ = (x17 | x79 | (x78 ? ~x04 : ~x40)) & (~x04 | ~x78 | (~new_n246_ & ~x40));
  assign new_n246_ = ~x42 & x79 & (~new_n180_ | ~new_n181_);
  assign z60 = new_n154_ | (~x01 & (~new_n250_ | (~new_n248_ & x78)));
  assign new_n248_ = (~x04 | (~new_n179_ & ~new_n182_)) & (~new_n249_ | x77);
  assign new_n249_ = x79 & (~x81 ^ ~x84);
  assign new_n250_ = (x04 | x79) & (~x77 | ~new_n249_ | x78);
  ...
  assign new_n254_ = x04 & (new_n179_ | new_n182_);
  assign new_n255_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n256_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n252_ & x82;
  assign z64 = (x17 & ~x79) | (~x01 & (new_n259_ | (x79 & ~new_n252_ & x83)));
  assign new_n259_ = x04 & ~x17 & ~x77 & x78 & ~x79;
  assign z65 = (x17 & ~x79) | (~x01 & new_n261_ & x79);
