...
module FAU ( 
  ...
  wire new_n175_, new_n176_, new_n177_, new_n178_, new_n181_, new_n183_,
    ...
    new_n207_, new_n213_, new_n215_, new_n222_, new_n224_, new_n225_,
  ...
  assign z25 = ~x01 & (~x79 | (~x04 & new_n183_ & x05));
  assign new_n183_ = ~x42 & x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  ...
  assign z42 = ~x01 & (~x79 | (~x04 & new_n207_ & x60));
  assign new_n207_ = x77 & ~new_n198_ & x78;
  assign z43 = ~x01 & ~x04 & new_n197_ & x61;
  assign z44 = ~x01 & ~x04 & new_n197_ & x62;
  assign z45 = ~x01 & (~x79 | (~x04 & new_n207_ & x63));
  ...
  assign new_n224_ = ~new_n225_ & x79 & (x77 | x78);
  ...
  assign new_n230_ = ~x40 & (x42 | ~x79 | (new_n176_ & new_n177_));
  assign z60 = ~x01 & (new_n225_ | ~x79 | (x04 & new_n232_ & ~x42));
  assign new_n232_ = x77 & x78 & x79 & (~new_n176_ | ~new_n177_);
