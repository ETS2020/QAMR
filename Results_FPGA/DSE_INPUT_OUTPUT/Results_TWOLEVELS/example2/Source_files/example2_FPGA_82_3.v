// Benchmark "FAU" written by ABC on Sat Aug 22 04:57:46 2020
...
module FAU ( 
  ...
  assign z01 = (~x01 & (~x79 | (~x77 & ~x78))) | (x79 & (x01 | (x77 & x78)));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = (~x01 & (~x77 | ~x78)) | (x79 & (x01 | (x77 & x78)));
  ...
  assign z22 = new_n180_ | (x78 & (new_n182_ | (~new_n177_ & x04)));
  assign new_n177_ = (x01 | x79) & (x42 | ~x77 | ~x79 | (new_n178_ & new_n179_));
  assign new_n178_ = x43 & ~x74 & x80;
  assign new_n179_ = x81 & x82 & ~x83 & x84;
  assign new_n180_ = x79 & (x01 | (~x41 & new_n181_ & x66));
  assign new_n181_ = x77 & ~x78 & (~x81 ^ x84);
  assign new_n182_ = ~x41 & x75 & ~x77 & x79 & (x81 ^ ~x84);
  assign z23 = (~x00 & ~x01) | (~x79 & (x01 | (~x04 & x05)));
  assign z24 = (x01 & x79) | (~x04 & x05 & ~x43 & (new_n185_ | (~x01 & ~x79)));
  assign new_n185_ = x77 & x78 & x79;
  assign z25 = x79 & (x01 | (~x04 & x05 & new_n187_ & ~x42));
  ...
  assign z29 = x79 & (x01 | (~x04 & ~x42 & new_n187_ & x47));
  assign z30 = ~x01 & ~x04 & ~x42 & new_n189_ & x48;
  assign z31 = x79 & (x01 | (~x04 & ~x42 & new_n187_ & x49));
  assign z32 = x79 & (x01 | (~x04 & ~x42 & new_n187_ & x50));
  assign z33 = x79 & (x01 | (new_n197_ & ~x04));
  ...
  assign new_n201_ = x77 & x78 & ~new_n202_ & x79;
  assign new_n202_ = ((~x82 ^ x84) | ((x81 | (x42 & x83)) & (~x42 | ~x81 | ~x83))) & ((x82 ^ x84) | ((~x81 | (x42 & x83)) & (~x42 | x81 | ~x83)));
  assign z35 = x79 & (x01 | (~x04 & new_n204_ & x53));
  assign new_n204_ = x77 & ~new_n202_ & x78;
  assign z36 = ~x01 & ~x04 & new_n201_ & x54;
  assign z37 = x79 & (x01 | (~x04 & new_n204_ & x55));
  assign z38 = x79 & (x01 | (~x04 & new_n204_ & x56));
  assign z39 = ~x01 & ~x04 & new_n201_ & x57;
  assign z40 = ~x01 & ~x04 & new_n201_ & x58;
  assign z41 = x79 & (x01 | (~x04 & new_n204_ & x59));
  assign z42 = ~x01 & ~x04 & new_n201_ & x60;
  assign z43 = x79 & (x01 | (~x04 & new_n204_ & x61));
  assign z44 = x79 & (x01 | (~x04 & new_n204_ & x62));
  ...
  assign new_n218_ = x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n220_ & x04) | (new_n221_ & x68));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n221_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = (~x01 & new_n223_ & x04) | (x79 & (x01 | (new_n181_ & x69)));
  assign new_n223_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = (~x01 & new_n225_ & x04) | (x79 & (x01 | (new_n181_ & x70)));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n221_ & x71) | (new_n227_ & x04));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = (~x01 & new_n229_ & x04) | (x79 & (x01 | (new_n181_ & x72)));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n221_ & x73) | (new_n231_ & x04));
  ...
  assign new_n242_ = x79 & ((~x40 & x42) | (new_n179_ & new_n243_ & ~x42 & x43));
  assign new_n243_ = ~x74 & x80;
  assign new_n244_ = ~x01 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n245_ = x01 ? ~x79 : (x79 | (x04 & (~x04 | x77 | ~x78)));
  assign z59 = (x77 & ((new_n247_ & x04) | (~x01 & ~new_n248_ & ~x79))) | (x01 & x79) | (~x01 & ~x04 & ~x79);
  assign new_n247_ = x78 & x79 & (x40 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n248_ = x78 ? ~x04 : ~x40;
  assign z60 = (x79 & ((new_n239_ & ~x01) | x01 | (new_n250_ & x04))) | (~x01 & ~x79 & (~x04 | (x04 & x78)));
  ...
  assign z62 = (x78 & (new_n255_ | (x77 & ~new_n254_ & x79))) | (~new_n256_ & x79);
  assign new_n254_ = x04 ? (x42 | (new_n178_ & new_n179_)) : ~x81;
  assign new_n255_ = ~x01 & ((x04 & ~x79) | (~x77 & x79 & x81 & x84));
  assign new_n256_ = ~x01 & (x01 | ~x77 | x78 | ~x81 | ~x84);
  assign z63 = x79 & (x01 | (~new_n252_ & x82));
  assign z64 = (x79 & (new_n259_ | x01)) | (~x01 & x04 & ~x77 & x78 & ~x79);
  assign new_n259_ = ~new_n252_ & x83;
