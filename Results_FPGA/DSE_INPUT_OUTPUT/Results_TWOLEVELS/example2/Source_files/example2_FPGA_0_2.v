...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (x72 | (x77 & (~x77 | x78 | x79)));
  assign z01 = ~x01 & (x79 ? (x77 ^ ~x78) : ~x72);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (x72 | (~x01 & x52 & x78));
  assign z04 = ~x01 & (x79 | (~x72 & (~x77 | (~x78 & ~x79))));
  ...
  assign new_n182_ = x04 & ~x72 & x78 & ~x79;
  assign z23 = ((~x00 | x01) & (~x72 | x79)) | (~x79 & (x72 | (~x04 & x05)));
  ...
  assign z48 = new_n154_ | (~x01 & ((new_n219_ & x68) | (new_n218_ & x04)));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n219_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z49 = ~x01 & ((new_n219_ & x69) | (x04 & new_n221_ & ~x72));
  ...
  assign z52 = (x72 & ~x79) | (~x01 & ((new_n227_ & x04) | (new_n228_ & x72)));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign new_n228_ = x77 & ~x78 & (x81 ^ ~x84);
  assign z53 = new_n154_ | (~x01 & ((new_n219_ & x73) | (new_n230_ & x04)));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n232_ & ~x72;
  ...
  assign z56 = ((~x00 | x01) & (~x72 | x79)) | (new_n239_ & ~x72) | (~new_n237_ & x79);
  ...
  assign z58 = (x72 & ~x79) | (~x01 & ((~new_n242_ & x77) | (~x72 & ~new_n244_ & ~x79)));
  assign new_n242_ = (~x04 | ~x78 | ~x79 | (~new_n243_ & (x40 | ~x42))) & (~x40 | x42 | x78 | x79);
  assign new_n243_ = new_n180_ & ~x74 & x80 & ~x42 & x43;
  assign new_n244_ = x04 & (~x04 | x77 | ~x78);
  assign z59 = (x72 & ~x79) | (~x01 & ((~new_n246_ & x77) | (~x04 & ~x72 & ~x79)));
  assign new_n246_ = (~x40 | ((~x04 | ~x78) & (x72 | x78 | x79))) & (~x04 | ~x78 | (~new_n247_ & (x72 | x79)));
  assign new_n247_ = ~x42 & x79 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((x79 & (new_n178_ | new_n238_)) | (~x72 & ~new_n249_ & ~x79));
  assign new_n249_ = x04 & (~x04 | ~x78);
  assign z61 = (x72 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  assign new_n251_ = ((~x81 ^ ~x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (new_n253_ | new_n254_)) | (new_n255_ & x77 & ~x78));
  assign new_n253_ = x04 & ((~x72 & ~x79) | (~x42 & x77 & ~new_n179_ & x79));
  assign new_n254_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n255_ = x79 & x81 & x84;
  assign z63 = (x72 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
  assign z64 = ~x01 & (new_n258_ | (x79 & ~new_n251_ & x83));
  assign new_n258_ = x04 & ~x72 & ~x77 & x78 & ~x79;
  assign z65 = (x72 & ~x79) | (~x01 & new_n260_ & x79);
