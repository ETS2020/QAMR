...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x12 | (x77 & (~x77 | x78 | x79)));
  assign z01 = new_n154_ | (~new_n157_ & ~x01);
  assign new_n157_ = (x79 | ((~x12 | (x04 & (~x04 | x52 | x77 | ~x78))) & x78 & (~x52 | ~x78))) & (~x77 | ~x78) & (x77 | x78 | ~x79);
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & (~x12 | (~x01 & x52 & x78));
  assign z04 = (~x79 & (~x12 | (~x01 & ~x78))) | (~x01 & (~x77 | x79));
  ...
  assign new_n179_ = (~x12 | x79) & (x42 | ~x77 | new_n180_ | ~x79);
  ...
  assign z23 = (~x00 & (x79 | (~x01 & x12))) | (x01 & (x12 | x79)) | (~x79 & (~x12 | (~x04 & x05)));
  ...
  assign z47 = ~x01 & ((new_n218_ & x77) | (x04 & x12 & new_n217_ & ~x77));
  assign new_n217_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n218_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = new_n154_ | (~x01 & ((new_n220_ & x04) | (new_n183_ & x68)));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = new_n154_ | (~x01 & ((new_n222_ & x04) | (new_n183_ & x69)));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n224_ & x12) | (new_n183_ & x70));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n226_ & x12) | (new_n183_ & x71));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n183_ & x72) | (new_n228_ & x04));
  assign new_n228_ = x12 & ~x77 & x78 & ~x79 & (x20 | ~x52);
  assign z53 = ~x01 & ((x04 & new_n230_ & x12) | (new_n183_ & x73));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x12 | (new_n232_ & ~x01));
  assign new_n232_ = x04 & ~x77 & x78 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & new_n234_ & ~x81;
  assign new_n234_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z56 = (~x00 & (x79 | (~x01 & x12))) | (x01 & (x12 | x79)) | (new_n238_ & x12) | (~new_n236_ & x79);
  ...
  assign new_n243_ = x12 & x40 & ~x42 & ~x78 & ~x79;
  assign new_n244_ = x12 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = (~x12 & ~x79) | (~x01 & ((~new_n246_ & x77) | (~x04 & x12 & ~x79)));
  assign new_n246_ = (~x12 | x79 | (x78 ? ~x04 : ~x40)) & (~x04 | ~x78 | (~new_n247_ & ~x40));
  assign new_n247_ = ~x42 & x79 & (~new_n181_ | ~x43 | x74 | ~x80);
  assign z60 = (~x12 & ~x79) | (~x01 & (x79 ? ~new_n249_ : ~new_n250_));
  assign new_n249_ = (new_n237_ | (~x77 ^ x78)) & (~x04 | x42 | ~x77 | new_n180_ | ~x78);
  assign new_n250_ = (~x52 | ~x78) & (~x12 | (x04 & (~x04 | ~x78 | (~x77 & (x52 | x77)))));
  assign z61 = ~x01 & x79 & ~new_n252_ & x80;
  assign new_n252_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n255_ | (x78 & (new_n254_ | (~new_n179_ & x04))));
  assign new_n254_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n255_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = (~x12 & ~x79) | (~x01 & x79 & ~new_n252_ & x82);
  assign z64 = (~x12 & ~x79) | (~x01 & (new_n258_ | (x79 & ~new_n252_ & x83)));
  assign new_n258_ = x04 & x12 & ~x77 & x78 & ~x79;
  assign z65 = (~x12 & ~x79) | (~x01 & new_n260_ & x79);
