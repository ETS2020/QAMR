...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x65 | (x77 & (~x77 | x78 | x79)));
  assign z01 = ~x01 & (x79 ? (x77 ^ ~x78) : x65);
  assign z02 = (~x65 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & (~x65 | (~x01 & x52 & x78));
  assign z04 = (~x79 & (~x65 | (~x01 & x65 & ~x78))) | (~x01 & (~x77 | x79));
  assign z05 = (~x65 & ~x79) | (x40 & x65) | (x23 & ~x40);
  ...
  assign new_n179_ = x78 & ((x79 & (new_n182_ | (new_n180_ & x04))) | (x04 & x65 & ~x79));
  ...
  assign z23 = (~x00 & (x79 | (~x01 & x65))) | (x01 & (x65 | x79)) | (~x04 & x05 & x65 & ~x79);
  assign z24 = ~x01 & ~x04 & x05 & ~x43 & (new_n186_ | new_n187_);
  assign new_n186_ = x65 & ~x79;
  ...
  assign z47 = ~x01 & ((new_n218_ & x77) | (x04 & x65 & new_n217_ & ~x77));
  assign new_n217_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n218_ = ~x78 & x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((x04 & new_n220_ & x65) | (new_n183_ & x68));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((x04 & new_n222_ & x65) | (new_n183_ & x69));
  ...
  assign z51 = ~x01 & ((x04 & new_n226_ & x65) | (new_n183_ & x71));
  ...
  assign z53 = ~x01 & ((x04 & new_n230_ & x65) | (new_n183_ & x73));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x79 & (~x65 | (new_n232_ & ~x01));
  ...
  assign z56 = (~x00 & (x79 | (~x01 & x65))) | (x01 & (x65 | x79)) | (~new_n236_ & x79) | new_n238_ | (~x65 & ~x79);
  ...
  assign new_n243_ = x40 & ~x42 & x65 & ~x78 & ~x79;
  assign new_n244_ = x65 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = (~x65 & ~x79) | (~x01 & ((~new_n246_ & x77) | (~x04 & x65 & ~x79)));
  assign new_n246_ = (~x40 | ((~x04 | ~x78) & (~x65 | x78 | x79))) & (~x04 | ~x78 | (~new_n247_ & (~x65 | x79)));
  assign new_n247_ = ~x42 & x79 & (~new_n181_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((~new_n249_ & x79) | (x65 & ~x79 & (~x04 | (x04 & x78))));
  ...
  assign new_n254_ = x04 & ((x65 & ~x79) | (~x42 & x77 & ~new_n250_ & x79));
  assign new_n255_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n256_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n252_ & x82;
  assign z64 = (~x65 & ~x79) | (~x01 & (new_n259_ | (x79 & ~new_n252_ & x83)));
  assign new_n259_ = x04 & x65 & ~x77 & x78 & ~x79;
  assign z65 = (~x65 & ~x79) | (~x01 & new_n261_ & x79);
