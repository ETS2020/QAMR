...
module FAU ( 
  ...
  assign z25 = x78 & x79;
  assign z01 = (x78 & x79) | (~x01 & (~x79 | (~x77 & ~x78)));
  ...
  assign z22 = z25 | (~x01 & (new_n178_ | (~x41 & new_n179_ & x66)));
  assign new_n178_ = x04 & x78 & ~x79;
  assign new_n179_ = x77 & x79 & (~x81 ^ x84);
  ...
  assign new_n184_ = x79 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n186_ & x04) | (new_n187_ & x68));
  assign new_n186_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n187_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = z25 | (~x01 & (new_n189_ | (new_n179_ & x69)));
  assign new_n189_ = x04 & ~x77 & x78 & (x52 ? x17 : x09);
  assign z50 = z25 | (~x01 & (new_n191_ | (new_n179_ & x70)));
  assign new_n191_ = x04 & ~x77 & x78 & (x52 ? x18 : x10);
  assign z51 = z25 | (~x01 & (new_n193_ | (new_n179_ & x71)));
  ...
  assign z53 = z25 | (~x01 & (new_n197_ | (new_n179_ & x73)));
  ...
  assign z57 = x00 & ~x01 & ~x02 & ~z25 & x03;
  ...
  assign z62 = (x78 & x79) | (~x01 & ((x04 & x78 & ~x79) | (new_n211_ & x77 & x79)));
