...
module FAU ( 
  ...
  assign z23 = ((x72 | x79) & (~x00 | x01)) | (~x79 & (~x72 | (~x04 & x05)));
  ...
  assign z52 = (~x72 & ~x79) | (~x01 & ((new_n227_ & x04) | (new_n219_ & x72)));
  ...
  assign z54 = ~x01 & x04 & new_n231_ & x72;
  ...
  assign z56 = ((~x00 | x01) & (x72 | x79)) | (new_n238_ & x72) | (~new_n236_ & x79);
  ...
  assign z58 = (~x72 & ~x79) | (~x01 & ((~new_n241_ & x77) | (x72 & ~new_n243_ & ~x79)));
  assign new_n241_ = (~x04 | ~x78 | ~x79 | (~new_n242_ & (x40 | ~x42))) & (~x40 | x42 | x78 | x79);
  assign new_n242_ = new_n180_ & ~x74 & x80 & ~x42 & x43;
  assign new_n243_ = x04 & (~x04 | x77 | ~x78);
  assign z59 = (~x72 & ~x79) | (~x01 & ((~new_n245_ & x77) | (~x04 & x72 & ~x79)));
  assign new_n245_ = (~x40 | ((~x04 | ~x78) & (~x72 | x78 | x79))) & (~x04 | ~x78 | (~new_n246_ & (~x72 | x79)));
  assign new_n246_ = ~x42 & x79 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((x79 & (new_n178_ | new_n237_)) | (x72 & ~new_n248_ & ~x79));
  assign new_n248_ = x04 & (~x04 | ~x78);
  assign z61 = (~x72 & ~x79) | (~x01 & x79 & ~new_n250_ & x80);
  assign new_n250_ = ((~x81 ^ ~x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (new_n252_ | new_n253_)) | (new_n254_ & x77 & ~x78));
  assign new_n252_ = x04 & ((x72 & ~x79) | (~x42 & x77 & ~new_n179_ & x79));
  assign new_n253_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n254_ = x79 & x81 & x84;
  assign z63 = (~x72 & ~x79) | (~x01 & x79 & ~new_n250_ & x82);
  assign z64 = ~x01 & (new_n257_ | (x79 & ~new_n250_ & x83));
  assign new_n257_ = x04 & x72 & ~x77 & x78 & ~x79;
  assign z65 = (~x72 & ~x79) | (~x01 & new_n259_ & x79);
