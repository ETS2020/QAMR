...
module FAU ( 
  ...
  assign z38 = x79 & (x01 | (~x04 & new_n206_ & x56));
  assign new_n206_ = x77 & ~new_n201_ & x78;
  assign z39 = x79 & (x01 | (~x04 & new_n206_ & x57));
  assign z40 = ~x01 & ~x04 & new_n200_ & x58;
  assign z41 = ~x01 & ~x04 & new_n200_ & x59;
  assign z42 = x79 & (x01 | (~x04 & new_n206_ & x60));
  assign z43 = x79 & (x01 | (~x04 & new_n206_ & x61));
  assign z44 = ~x01 & ~x04 & new_n200_ & x62;
  assign z45 = ~x01 & ~x04 & new_n200_ & x63;
  assign z46 = x79 & (x01 | (~x04 & new_n206_ & x64));
  ...
  assign new_n238_ = x79 & ((~new_n184_ & x76) | (new_n239_ & ~x01));
