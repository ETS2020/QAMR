...
module FAU ( 
  ...
  assign z01 = ~x01 & ((x04 & x78 & (x77 | (~x77 & ~x79))) | ~x04 | x79 | (~x78 & ~x79));
  ...
  assign z22 = ~x01 & (x79 | (x04 & x78 & (x77 | (~x77 & ~x79))));
  ...
  assign new_n198_ = x04 & (~x40 | x42 | ~x77 | x78) & ~x79 & (~x04 | x77 | ~x78 | x79);
  assign z59 = ~x01 & ((x77 & ((x04 & x78) | (x40 & ~x78 & ~x79))) | ~x04 | x79);
  assign z60 = ~x01 & ((x04 & x78 & (x77 | (~x77 & ~x79))) | ~x04 | x79);
