// Benchmark "FAU" written by ABC on Sat Aug 22 04:57:11 2020
...
module FAU ( 
  ...
  assign z08 = z28 | (x26 & ~x40) | (x40 & x62);
  assign z09 = z28 | (x27 & ~x40) | (x40 & x61);
  assign z10 = ~z28 & (x40 ? x60 : x28);
  assign z11 = z28 | (x29 & ~x40) | (x40 & x59);
  assign z12 = z28 | (x30 & ~x40) | (x40 & x58);
  assign z13 = z28 | (x31 & ~x40) | (x40 & x57);
  assign z14 = ~z28 & (x40 ? x51 : x32);
  assign z15 = z28 | (x33 & ~x40) | (x40 & x50);
  assign z16 = z28 | (x34 & ~x40) | (x40 & x49);
  assign z17 = z28 | (x35 & ~x40) | (x40 & x48);
  assign z18 = z28 | (x36 & ~x40) | (x40 & x47);
  assign z19 = ~z28 & (x40 ? x46 : x37);
  assign z20 = z28 | (x38 & ~x40) | (x40 & x45);
  assign z21 = z28 | (x39 & ~x40) | (x40 & x44);
