// Benchmark "FAU" written by ABC on Sat Aug 22 04:59:33 2020
...
module FAU ( 
  ...
  assign z37 = x79 & (x01 | (~x04 & new_n205_ & x55));
  assign new_n205_ = x77 & ~new_n201_ & x78;
  ...
  assign z42 = x79 & (x01 | (~x04 & new_n205_ & x60));
  ...
  assign z50 = (~x01 & new_n225_ & x04) | (x79 & (x01 | (new_n223_ & x70)));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n227_ & x04) | (new_n220_ & x71));
  ...
  assign z53 = ~x01 & ((new_n231_ & x04) | (new_n220_ & x73));
  ...
  assign z56 = x01 | (~new_n237_ & x79) | (~x01 & (~x00 | (~x77 & ~x78)));
  ...
  assign new_n253_ = x04 ? (x79 & (x42 | (new_n180_ & new_n181_))) : (~x79 | ~x81);
  ...
  assign new_n258_ = ~new_n251_ & x83;
