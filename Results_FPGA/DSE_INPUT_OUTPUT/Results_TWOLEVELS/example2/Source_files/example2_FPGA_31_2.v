...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (x50 | (x77 & (~x77 | x78 | x79)));
  assign z01 = (x50 & ~x79) | (~x01 & ((~x77 & (~x78 | (x04 & ~x50 & x78 & ~x79))) | (~x50 & ~x79 & (~x04 | ~x78)) | (x77 & x78)));
  ...
  assign new_n178_ = x78 & ((x79 & (new_n182_ | (new_n179_ & x04))) | (x04 & ~x50 & ~x79));
  ...
  assign z47 = ~x01 & ((new_n218_ & x77) | (x04 & ~x50 & new_n217_ & ~x77));
  ...
  assign z53 = ~x01 & ((x04 & new_n230_ & ~x50) | (new_n183_ & x73));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n232_ & ~x50;
  ...
  assign z56 = new_n236_ | ~x00 | x01 | new_n154_ | (~x01 & ~x77 & ~x78);
  ...
  assign z60 = ~x01 & ((~new_n248_ & x79) | (~x50 & ~x79 & (~x04 | (x04 & x78))));
  ...
  assign new_n254_ = (x50 | x79) & (x42 | ~x77 | ~x79 | (new_n180_ & new_n181_));
  ...
  assign new_n259_ = x04 & ~x50 & ~x77 & x78 & ~x79;
