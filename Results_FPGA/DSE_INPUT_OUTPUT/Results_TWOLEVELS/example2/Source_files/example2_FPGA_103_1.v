// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:00 2020
...
module FAU ( 
  ...
  assign new_n154_ = ~x01 & (x79 | (x40 & (~x77 | (x77 & ~x78 & ~x79))));
  assign z01 = ~x01 & ~x79;
  assign z02 = ~x01 & x79;
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & ~x79 & (~x77 | ~x78);
  assign z05 = z02 | (x23 & ~x40) | (x40 & x65);
  assign z06 = z02 | (x24 & ~x40) | (x40 & x64);
  assign z07 = z02 | (x25 & ~x40) | (x40 & x63);
  assign z08 = z02 | (x26 & ~x40) | (x40 & x62);
  assign z09 = z02 | (x27 & ~x40) | (x40 & x61);
  assign z10 = z02 | (x28 & ~x40) | (x40 & x60);
  assign z11 = z02 | (x29 & ~x40) | (x40 & x59);
  assign z12 = ~z02 & (x40 ? x58 : x30);
  assign z13 = ~z02 & (x40 ? x57 : x31);
  assign z14 = z02 | (x32 & ~x40) | (x40 & x51);
  assign z15 = ~z02 & (x40 ? x50 : x33);
  assign z16 = z02 | (x34 & ~x40) | (x40 & x49);
  assign z17 = ~z02 & (x40 ? x48 : x35);
  assign z18 = ~z02 & (x40 ? x47 : x36);
  assign z19 = z02 | (x37 & ~x40) | (x40 & x46);
  assign z20 = ~z02 & (x40 ? x45 : x38);
  assign z21 = ~z02 & (x40 ? x44 : x39);
