...
module FAU ( 
  ...
  assign z49 = ~x01 & ((x04 & new_n222_ & ~x77) | (x69 & new_n223_ & x77));
  assign new_n222_ = x78 & ~x79 & (x52 ? x17 : x09);
  assign new_n223_ = ~x78 & x79 & (~x81 ^ x84);
  ...
  assign z56 = x01 | (~new_n238_ & x79) | (~x01 & (~x00 | (~x77 & ~x78)));
