...
module FAU ( 
  ...
  assign z23 = ((~x00 | x01) & (~x43 | x79)) | (~x79 & (x43 | (x05 & ~x43 & ~x01 & ~x04)));
  ...
  assign z33 = new_n154_ | (~x01 & ~x04 & new_n195_ & x77);
  ...
  assign z49 = ~x01 & ((x04 & new_n220_ & ~x43) | (new_n218_ & x69));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n222_ & ~x43) | (new_n218_ & x70));
  ...
  assign z52 = ~x01 & ((x04 & new_n226_ & ~x43) | (new_n218_ & x72));
  ...
  assign z56 = ((~x43 | x79) & (~x00 | x01)) | (new_n234_ & ~x43) | (~new_n235_ & x79);
  ...
  assign z60 = ~x01 & (new_n246_ | new_n247_);
  assign new_n246_ = x79 & (new_n178_ | ((x81 ^ x84) & (~x77 ^ ~x78)));
  assign new_n247_ = ~x43 & (x04 ? (x78 & (x77 ? (~x42 | ~x79) : ~x79)) : ~x79);
  ...
  assign new_n251_ = x77 ? (x04 ? new_n244_ : (~x79 | ~x81)) : new_n252_;
  assign new_n252_ = ~new_n253_ & (~x04 | x43 | x79);
