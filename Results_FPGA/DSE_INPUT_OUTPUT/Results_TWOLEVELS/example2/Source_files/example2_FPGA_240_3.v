...
module FAU ( 
  ...
  assign z29 = x79 & (x01 | (~x04 & ~x42 & new_n190_ & x47));
  assign z30 = ~x01 & ~x04 & ~x42 & new_n186_ & x48;
  assign z31 = x79 & (x01 | (~x04 & ~x42 & new_n190_ & x49));
  ...
  assign z51 = ~x01 & ((new_n220_ & x71) | (new_n226_ & x04));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n220_ & x72) | (new_n228_ & x04));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = (~x01 & new_n230_ & x04) | (x79 & (new_n231_ | x01));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign new_n231_ = x73 & x77 & ~x78 & (~x81 ^ x84);
