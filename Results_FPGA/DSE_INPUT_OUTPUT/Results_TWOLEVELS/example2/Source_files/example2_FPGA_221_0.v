...
module FAU ( 
  ...
  assign z47 = ~x01 & ((x75 & (new_n216_ | (new_n215_ & x04))) | (new_n216_ & x67));
  assign new_n215_ = ~x77 & x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n216_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z48 = ~x01 & ((new_n216_ & x68) | (x04 & new_n218_ & x75));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((new_n216_ & x69) | (x04 & new_n220_ & x75));
  ...
  assign z51 = ~x01 & ((new_n216_ & x71) | (x04 & new_n224_ & x75));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = new_n154_ | (~x01 & ((new_n216_ & x72) | (new_n226_ & x04)));
  ...
  assign z54 = ~x79 & (~x75 | (new_n230_ & ~x01));
  assign new_n230_ = x04 & ~x77 & x78 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & new_n232_ & ~x81;
  assign new_n232_ = ~x80 & x79 & x78 & x77 & ~x01 & ~x04;
  assign z56 = new_n234_ | ~x00 | (~x77 & ~x78) | new_n154_ | x01;
  assign new_n234_ = x79 & ((x76 & (~x77 | ~x78)) | (~x01 & ~new_n235_ & (~x77 ^ ~x78)));
  assign new_n235_ = ~x81 ^ x84;
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = (~x75 & ~x79) | (~x01 & ((~new_n238_ & x77) | (x75 & ~new_n240_ & ~x79)));
  assign new_n238_ = (~x04 | ~x78 | ~x79 | (~new_n239_ & (x40 | ~x42))) & (~x40 | x42 | x78 | x79);
  assign new_n239_ = new_n181_ & ~x74 & x80 & ~x42 & x43;
  assign new_n240_ = x04 & (~x04 | x77 | ~x78);
  assign z59 = (~x75 & ~x79) | (~x01 & ((~new_n242_ & x77) | (~x04 & x75 & ~x79)));
  assign new_n242_ = (~x40 | ((~x04 | ~x78) & (~x75 | x78 | x79))) & (~x04 | ~x78 | (~new_n243_ & (~x75 | x79)));
  assign new_n243_ = ~x42 & x79 & (~new_n180_ | ~new_n181_);
  assign z60 = ~x01 & ((~new_n245_ & x79) | (x75 & ~x79 & (~x04 | (x04 & x78))));
  assign new_n245_ = ~new_n179_ & (new_n235_ | (~x77 ^ x78));
  assign z61 = (~x75 & ~x79) | (~x01 & x79 & ~new_n247_ & x80);
  assign new_n247_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = new_n154_ | (~new_n249_ & ~x01);
  assign new_n249_ = (~x78 | (~new_n251_ & (new_n250_ | ~x04))) & (~new_n252_ | ~x77 | x78);
  assign new_n250_ = (~x75 | x79) & (x42 | ~x77 | ~x79 | (new_n180_ & new_n181_));
  assign new_n251_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n252_ = x79 & x81 & x84;
  assign z63 = (~x75 & ~x79) | (~x01 & x79 & ~new_n247_ & x82);
  assign z64 = (~x75 & ~x79) | (~x01 & (new_n255_ | (x79 & ~new_n247_ & x83)));
  assign new_n255_ = x04 & x75 & ~x77 & x78 & ~x79;
