...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (x14 | (x77 & (~x77 | x78 | x79)));
  assign z01 = ~x01 & (x79 ? (x77 ^ ~x78) : ~x14);
  assign z02 = (x14 & ~x79) | (~x01 & ~new_n158_ & x79);
  ...
  assign z51 = ~x01 & ((x04 & new_n226_ & ~x14) | (new_n184_ & x71));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n228_ & ~x14) | (new_n184_ & x72));
  ...
  assign z54 = ~x79 & (new_n232_ | x14);
  assign new_n232_ = ~x01 & x04 & x22 & x52 & ~x77 & x78;
  ...
  assign new_n243_ = (x14 | (x04 & (~x04 | x77 | ~x78))) & (~x40 | x42 | ~x77 | x78);
  assign z59 = ~x01 & ((~new_n245_ & x77) | (new_n182_ & ~x04));
  assign new_n245_ = (x14 | x79 | (x78 ? ~x04 : ~x40)) & (~x04 | ~x78 | ~x79 | (~new_n246_ & ~x40));
  assign new_n246_ = ~x42 & (~new_n181_ | ~x43 | x74 | ~x80);
  assign z60 = ~x01 & ((~new_n248_ & x79) | (~x14 & ~x79 & (~x04 | (x04 & x78))));
  assign new_n248_ = ~new_n238_ & (~x04 | x42 | ~x77 | new_n249_ | ~x78);
  assign new_n249_ = new_n181_ & x43 & ~x74 & x80;
  assign z61 = (x14 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  assign new_n251_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z62 = ~x01 & ((x78 & (new_n253_ | new_n254_)) | (new_n255_ & x77 & ~x78));
  assign new_n253_ = x04 & (new_n182_ | (new_n180_ & ~x42));
  ...
  assign new_n258_ = x04 & ~x14 & ~x77 & x78 & ~x79;
  assign z65 = (x14 & ~x79) | (~x01 & new_n260_ & x79);
