// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:34 2020
...
module FAU ( 
  ...
  assign z05 = z28 | (x40 & x65) | (x23 & ~x40);
  assign z28 = ~x01 & x79;
  assign z06 = ~z28 & (x40 ? x64 : x24);
  assign z07 = z28 | (x40 & x63) | (x25 & ~x40);
  assign z08 = ~z28 & (x40 ? x62 : x26);
  assign z09 = z28 | (x40 & x61) | (x27 & ~x40);
  assign z10 = z28 | (x40 & x60) | (x28 & ~x40);
  assign z11 = z28 | (x40 & x59) | (x29 & ~x40);
  assign z12 = z28 | (x40 & x58) | (x30 & ~x40);
  assign z13 = z28 | (x40 & x57) | (x31 & ~x40);
  assign z14 = z28 | (x40 & x51) | (x32 & ~x40);
  assign z15 = ~z28 & (x40 ? x50 : x33);
  assign z16 = z28 | (x40 & x49) | (x34 & ~x40);
  assign z17 = ~z28 & (x40 ? x48 : x35);
  assign z18 = z28 | (x40 & x47) | (x36 & ~x40);
  assign z19 = z28 | (x40 & x46) | (x37 & ~x40);
  assign z20 = ~z28 & (x40 ? x45 : x38);
  assign z21 = z28 | (x40 & x44) | (x39 & ~x40);
  ...
  assign z62 = ~x01 & (x79 | (x04 & x78 & ~x79));
