// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:22 2020
...
module FAU ( 
  ...
  assign z22 = (x43 & ~x79) | (~x01 & (new_n182_ | (x79 & (new_n179_ | new_n180_))));
  assign new_n179_ = ~x41 & ~new_n158_ & (x81 ^ ~x84);
  assign new_n180_ = x04 & ~x42 & x77 & ~new_n181_ & x78;
  assign new_n181_ = ~x74 & x80 & x81 & x82 & ~x83 & x84;
  assign new_n182_ = x04 & ~x43 & x78 & (x77 ? (~x42 | ~x79) : ~x79);
  assign z23 = ((~x00 | x01) & (~x43 | x79)) | (~x01 & ~x04 & x05 & ~x43 & ~x79);
  assign z24 = (x43 & ~x79) | (~x01 & ~x04 & x05 & ~x43 & (new_n185_ | ~x79));
  ...
  assign z47 = ~x01 & ((new_n216_ & x77) | (x04 & ~x43 & new_n215_ & ~x77));
  ...
  assign z51 = ~x01 & ((x04 & new_n225_ & ~x43) | (new_n219_ & x71));
  ...
  assign z54 = ~x01 & x04 & new_n231_ & ~x43;
  ...
  assign z56 = ((~x00 | x01) & (~x43 | x79)) | (new_n237_ & ~x43) | (~new_n236_ & x79);
  assign new_n236_ = (new_n185_ | ~x76) & (x01 | (~new_n237_ & ~new_n238_));
  assign new_n237_ = ~x77 & ~x78;
  assign new_n238_ = (~x81 ^ ~x84) & (~x77 ^ ~x78);
  assign z57 = x00 & ~x01 & ~x02 & ~new_n154_ & x03;
  assign z58 = (x43 & ~x79) | (~x01 & ((~new_n241_ & x77) | (~x43 & ~new_n246_ & ~x79)));
  ...
  assign new_n246_ = x04 & (~x04 | x77 | ~x78);
  assign z59 = ~x01 & (new_n250_ | (x77 & (new_n248_ | new_n249_)));
  assign new_n248_ = x04 & x78 & ((~x43 & (~x42 | ~x79)) | (~x42 & ~new_n181_ & x79));
  assign new_n249_ = x40 & ((x04 & x78 & x79) | (~x43 & ~x78 & ~x79));
  assign new_n250_ = ~x04 & ~x43 & ~x79;
  assign z60 = ~x01 & (new_n252_ | (x79 & (new_n180_ | new_n238_)));
  assign new_n252_ = ~x43 & (x04 ? (x78 & (x77 ? (~x42 | ~x79) : ~x79)) : ~x79);
  assign z61 = (x43 & ~x79) | (~x01 & x79 & ~new_n254_ & x80);
  assign new_n254_ = (x04 | ~x77 | ~x78) & ((x81 ^ x84) | (x77 ^ ~x78));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n256_ : (new_n257_ | new_n258_))) | (new_n258_ & x77 & ~x78));
  assign new_n256_ = x04 ? ((x43 | (x42 & x79)) & (x42 | new_n181_ | ~x79)) : (~x79 | ~x81);
  assign new_n257_ = x04 & ~x43 & ~x79;
  assign new_n258_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n254_ & x82;
  assign z64 = (x43 & ~x79) | (~x01 & (new_n261_ | (x79 & ~new_n254_ & x83)));
  assign new_n261_ = x04 & ~x43 & ~x77 & x78 & ~x79;
