// Benchmark "FAU" written by ABC on Sat Aug 22 04:57:08 2020
...
module FAU ( 
  ...
  assign z36 = x79 & (x01 | (~x04 & new_n204_ & x54));
  ...
  assign z45 = x79 & (x01 | (~x04 & new_n204_ & x63));
  assign z46 = x79 & (x01 | (~x04 & new_n204_ & x64));
  ...
  assign z64 = ~x01 & ((new_n258_ & x78 & ~x79) | (x79 & ~new_n251_ & x83));
  assign new_n258_ = x04 & ~x77;
  assign z65 = ~new_n260_ & x79;
  assign new_n260_ = ~x01 & (~x84 | ((x04 | ~x77 | ~x78) & (x01 | ~x81 | (x77 ^ ~x78))));
endmodule
