...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n200_, new_n201_, new_n210_, new_n216_, new_n217_, new_n219_,
  ...
  assign z42 = x79 & (x01 | (~x04 & new_n210_ & x60));
  assign new_n210_ = x77 & ~new_n201_ & x78;
  assign z43 = ~x01 & ~x04 & new_n200_ & x61;
  assign z44 = ~x01 & ~x04 & new_n200_ & x62;
  assign z45 = x79 & (x01 | (~x04 & new_n210_ & x63));
  ...
  assign z56 = new_n236_ | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  assign new_n236_ = x79 & (new_n237_ | (x76 & (~x77 | ~x78)));
  ...
  assign new_n243_ = x01 ? ~x79 : (x79 | (x04 & (~x04 | x77 | ~x78)));
  assign z59 = (x77 & (new_n246_ | (~x01 & new_n245_ & x04))) | (x01 & x79) | (~x01 & ~x04 & ~x79);
  assign new_n245_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n246_ = x40 & ((x04 & x78 & x79) | (~x01 & ~x78 & ~x79));
  assign z60 = ((new_n237_ | x01) & x79) | (~x01 & (x04 ? (x78 & (new_n179_ | ~x79)) : ~x79));
  ...
  assign new_n256_ = ~new_n249_ & x83;
