...
module FAU ( 
  ...
  assign z22 = (x74 & ~x79) | (~x01 & ((~new_n179_ & x79) | (x04 & ~x74 & x78 & ~x79)));
  ...
  assign z56 = (~x00 & (x79 | (~x01 & ~x74))) | (x01 & (~x74 | x79)) | (~new_n236_ & x79) | (new_n238_ & ~x74);
  ...
  assign z58 = ~x01 & (new_n243_ | (~x74 & (new_n244_ | (new_n241_ & x04))));
  assign new_n241_ = x78 & ((~x77 & ~x79) | (new_n242_ & x77 & x79 & ~x42 & x43));
  assign new_n242_ = x80 & x81 & x82 & ~x83 & x84;
  assign new_n243_ = new_n233_ & x04 & ~x40 & x42;
  ...
  assign new_n247_ = (x74 | x79) & (x42 | ~x79 | (new_n182_ & x43 & ~x74 & x80));
  assign z60 = ~x01 & ((~new_n249_ & x79) | (~x74 & ~x79 & (~x04 | (x04 & x78))));
  assign new_n249_ = (new_n237_ | (~x77 ^ x78)) & (~x04 | x42 | ~x77 | new_n181_ | ~x78);
  assign z61 = (x74 & ~x79) | (~x01 & x79 & ~new_n251_ & x80);
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = (~new_n256_ & x74) | (~x01 & (new_n257_ | (~new_n253_ & x78)));
  assign new_n253_ = (new_n254_ | ~x04) & (~x79 | ~x81 | (x77 ? x04 : ~x84));
  assign new_n254_ = (x42 | ~x77 | new_n255_ | ~x79) & (x74 | x79);
  assign new_n255_ = x43 & x80 & x81 & x82 & ~x83 & x84;
  assign new_n256_ = x79 & (~new_n233_ | x01 | ~x04 | x42);
  assign new_n257_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n251_ & x82;
  assign z64 = (x74 & ~x79) | (~x01 & (new_n260_ | (x79 & ~new_n251_ & x83)));
