...
module FAU ( 
  ...
  assign z23 = (~x00 & (x79 | (~x01 & ~x80))) | (x01 & (x79 | ~x80)) | (~x79 & ~x80 & ~x04 & x05);
  assign z24 = ~x01 & new_n185_ & ~x04;
  assign new_n185_ = x05 & ~x43 & ((~x79 & ~x80) | (x77 & x78 & x79));
  ...
  assign z56 = (~x00 & (x79 | (~x01 & ~x80))) | (x01 & (x79 | ~x80)) | (~new_n235_ & x79) | (~x79 & x80) | (new_n236_ & ~x01);
  assign new_n235_ = (~x76 | (x77 & x78)) & (x01 | (~x81 ^ x84) | (~x77 ^ x78));
  assign new_n236_ = ~x77 & ~x78;
  assign z57 = new_n154_ | (x00 & ~x01 & ~x02 & x03);
  assign z58 = (~x79 & x80) | (~x01 & ((~new_n239_ & x77) | (~new_n242_ & ~x79)));
  assign new_n239_ = (~x04 | ~x78 | (~new_n240_ & (x40 | ~x42 | ~x79))) & (x78 | x79 | ~x40 | x42);
  assign new_n240_ = new_n241_ & ~x42 & x43 & ~x74 & x80;
  assign new_n241_ = ~x83 & x84 & x81 & x82;
  assign new_n242_ = x04 & (~x78 | x80 | ~x04 | x77);
  assign z59 = (~x79 & x80) | (~x01 & (new_n244_ | (~x04 & ~x79)));
  assign new_n244_ = x77 & ((x40 & (x78 ? x04 : new_n246_)) | (x04 & ~new_n245_ & x78));
  assign new_n245_ = (x42 | new_n181_ | ~x79) & (x80 | (x42 & x79));
  assign new_n246_ = ~x79 & ~x80;
  assign z60 = (~x79 & x80) | (~x01 & ((~new_n248_ & x79) | new_n182_ | (~x04 & ~x79)));
  assign new_n248_ = ~new_n180_ & ((x81 ^ ~x84) | (x77 ^ ~x78));
