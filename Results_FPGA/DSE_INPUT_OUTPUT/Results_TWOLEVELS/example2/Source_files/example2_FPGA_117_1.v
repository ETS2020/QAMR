// Benchmark "FAU" written by ABC on Sat Aug 22 04:58:09 2020
...
module FAU ( 
  ...
  assign new_n197_ = x04 & (~x40 | x42 | ~x77 | x78) & ~x79 & (~x78 | x79 | ~x04 | x77);
  assign z59 = ~x01 & ((x77 & ((x04 & x78 & ~x79) | (x40 & ~x78))) | ~x04 | x79);
  assign z60 = ~x01 & ((x04 & x78 & ~x79) | ~x04 | x79);
