...
module FAU ( 
  ...
  assign z54 = ~x01 & x04 & new_n231_ & x70;
  ...
  assign new_n243_ = x70 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((new_n246_ & ~x04) | (x77 & (new_n247_ | (new_n245_ & x04))));
  assign new_n245_ = x78 & ((x70 & ~x79) | (~x42 & x79 & (~new_n179_ | ~new_n180_)));
  assign new_n246_ = x70 & ~x79;
  assign new_n247_ = x40 & ((x04 & x78 & x79) | (x70 & ~x78 & ~x79));
  assign z60 = (~x70 & ~x79) | (~x01 & ((x79 & (new_n178_ | new_n236_)) | (x70 & ~new_n249_ & ~x79)));
  assign new_n249_ = x04 & (~x04 | ~x78);
  assign z61 = ~x01 & x79 & ~new_n251_ & x80;
  assign new_n251_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n255_ | (x78 & (new_n254_ | (~new_n253_ & x04))));
  assign new_n253_ = (~x70 | x79) & (x42 | ~x77 | ~x79 | (new_n179_ & new_n180_));
  assign new_n254_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n255_ = x79 & x81 & x84 & x77 & ~x78;
  assign z63 = (~x70 & ~x79) | (~x01 & x79 & ~new_n251_ & x82);
