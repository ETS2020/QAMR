...
module FAU ( 
  ...
  assign z02 = new_n154_ | (~new_n158_ & ~x01);
  assign new_n158_ = (~x66 | ~x77 | x78) & (~x78 | ~x79 | ~x75 | x77);
  ...
  assign z22 = new_n154_ | (~x01 & (new_n182_ | (x04 & ~new_n179_ & x78)));
  assign new_n179_ = (x66 | x79) & (x42 | ~x77 | new_n180_ | ~x79);
  assign new_n180_ = new_n181_ & x43 & ~x74 & x80;
  assign new_n181_ = ~x83 & x84 & x81 & x82;
  assign new_n182_ = ~x41 & ~new_n158_ & (x81 ^ ~x84);
  assign z23 = (~x00 & (x79 | (~x01 & ~x66))) | (x01 & (~x66 | x79)) | (~x79 & (x66 | (~x04 & x05)));
  ...
  assign z48 = ~x01 & ((x04 & new_n218_ & ~x66) | (new_n219_ & x68));
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n219_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((x04 & new_n221_ & ~x66) | (new_n219_ & x69));
  ...
  assign z51 = ~x01 & ((x04 & new_n225_ & ~x66) | (new_n219_ & x71));
  ...
  assign z58 = ~x01 & (new_n243_ | (~new_n240_ & x77));
  assign new_n240_ = (~x04 | ~x78 | new_n241_ | ~x79) & (~new_n242_ | x66 | x78 | x79);
  ...
  assign z60 = (x66 & ~x79) | (~x01 & ((~new_n248_ & x79) | (~x66 & ~x79 & (~x04 | (x04 & x78)))));
  assign new_n248_ = (new_n236_ | (~x77 ^ x78)) & (~x04 | x42 | ~x77 | new_n180_ | ~x78);
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n253_ | (x78 & (new_n252_ | (~new_n179_ & x04))));
  assign new_n252_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n253_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n250_ & x82;
  assign z64 = (x66 & ~x79) | (~x01 & (new_n256_ | (x79 & ~new_n250_ & x83)));
  assign new_n256_ = x04 & ~x66 & ~x77 & x78 & ~x79;
  assign z65 = (x66 & ~x79) | (~x01 & new_n258_ & x79);
