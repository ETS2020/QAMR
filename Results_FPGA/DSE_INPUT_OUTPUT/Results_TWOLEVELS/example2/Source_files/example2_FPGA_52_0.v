...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    new_n185_, new_n192_, new_n195_, new_n196_, new_n197_, new_n199_,
    new_n200_, new_n203_, new_n215_, new_n223_, new_n225_, new_n226_,
    new_n229_, new_n231_, new_n234_, new_n236_, new_n237_, new_n241_;
  ...
  assign z31 = ~x01 & (~x79 | (~x04 & ~x42 & new_n192_ & x49));
  assign new_n192_ = x77 & x78 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  assign z32 = ~x01 & (~x79 | (~x04 & ~x42 & new_n192_ & x50));
  ...
  assign new_n225_ = x79 & (x77 | x78) & (~new_n226_ | ~x79);
  ...
  assign z60 = ~x01 & x79 & (new_n178_ | new_n226_);
  assign z61 = ~x01 & x79 & ~new_n234_ & x80;
  assign new_n234_ = (x04 | ~x77 | ~x78) & (new_n177_ | (~x77 ^ x78));
  assign z62 = ~x01 & (new_n237_ | ~x79 | (x79 & (new_n178_ | new_n236_)));
  assign new_n236_ = x81 & x84 & (x77 ^ x78);
  assign new_n237_ = x78 & x81 & ~x04 & x77;
