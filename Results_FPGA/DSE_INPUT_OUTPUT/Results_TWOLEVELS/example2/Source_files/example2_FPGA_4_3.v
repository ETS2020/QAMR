...
module FAU ( 
  ...
  assign z52 = (~x01 & new_n229_ & x04) | (x79 & (x01 | (new_n227_ & x72)));
  ...
  assign z59 = (x77 & (new_n247_ | (~x01 & new_n246_ & x04))) | (x01 & x79) | (~x01 & ~x04 & ~x79);
  assign new_n246_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n247_ = x40 & ((x04 & x78 & x79) | (~x01 & ~x78 & ~x79));
  assign z60 = ~x01 & ((new_n238_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  ...
  assign new_n259_ = ~x01 & (~x84 | ((x04 | ~x77 | ~x78) & (x01 | ~x81 | (x77 ^ ~x78))));
endmodule
