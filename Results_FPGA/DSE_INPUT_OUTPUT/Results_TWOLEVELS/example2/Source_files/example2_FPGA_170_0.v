...
module FAU ( 
  ...
  assign new_n155_ = ~x79 & (~x76 | (x77 & (~x77 | x78 | x79)));
  assign z01 = ~x01 & (x79 ? (x77 ^ ~x78) : x76);
  assign z02 = (~x76 & ~x79) | (~x01 & ~new_n158_ & x79);
  assign new_n158_ = (~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  assign z03 = ~x79 & (~x76 | (~x01 & x52 & x78));
  ...
  assign new_n183_ = x04 & x76 & x78 & ~x79;
  assign z23 = (~x00 & (x79 | (~x01 & x76))) | (x01 & (x76 | x79)) | (~x79 & (~x76 | (~x04 & x05)));
  assign z24 = ~x01 & ~x04 & x05 & ~x43 & (new_n186_ | new_n187_);
  assign new_n186_ = x76 & ~x79;
  ...
  assign z49 = ~x01 & ((new_n221_ & x69) | (x04 & new_n223_ & x76));
  ...
  assign z52 = ~x01 & ((new_n221_ & x72) | (x04 & new_n229_ & x76));
  assign new_n229_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n221_ & x73) | (x04 & new_n231_ & x76));
  assign new_n231_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n233_ & x76;
  assign new_n233_ = ~x77 & x78 & ~x79 & (x52 ? x22 : x14);
  assign z55 = new_n154_ | (new_n235_ & new_n187_ & ~x01 & ~x04);
  assign new_n235_ = ~x80 & ~x81 & ~x82 & x83 & x84;
  assign z56 = (~x00 & (x79 | (~x01 & x76))) | ~new_n237_ | (x01 & (x76 | x79));
  assign new_n237_ = (~x79 | ((~x76 | (x77 & x78)) & (x01 | (~new_n238_ & (x77 | x78))))) & (~x76 | x77 | x78);
  ...
  assign new_n244_ = x40 & ~x42 & x76 & ~x78 & ~x79;
  assign new_n245_ = x76 & ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((new_n186_ & ~x04) | (x77 & (new_n248_ | (new_n247_ & x04))));
  assign new_n247_ = x78 & ((x76 & ~x79) | (~x42 & x79 & (~new_n181_ | ~new_n182_)));
  assign new_n248_ = x40 & ((x76 & ~x78 & ~x79) | (x04 & x78 & x79));
  assign z60 = (~x76 & ~x79) | (~x01 & ((x79 & (new_n180_ | new_n238_)) | (x76 & ~new_n250_ & ~x79)));
  assign new_n250_ = x04 & (~x04 | ~x78);
  assign z61 = (~x76 & ~x79) | (~x01 & x79 & ~new_n252_ & x80);
  assign new_n252_ = ((~x81 ^ ~x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n256_ | (x78 & (new_n255_ | (~new_n254_ & x04))));
  assign new_n254_ = (~x76 | x79) & (x42 | ~x77 | ~x79 | (new_n181_ & new_n182_));
  assign new_n255_ = x79 & x81 & (x77 ? ~x04 : x84);
  assign new_n256_ = x77 & ~x78 & x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n252_ & x82;
  assign z64 = (~x76 & ~x79) | (~x01 & (new_n259_ | (x79 & ~new_n252_ & x83)));
  assign new_n259_ = x04 & x76 & ~x77 & x78 & ~x79;
  assign z65 = (~x76 & ~x79) | (~x01 & new_n261_ & x79);
