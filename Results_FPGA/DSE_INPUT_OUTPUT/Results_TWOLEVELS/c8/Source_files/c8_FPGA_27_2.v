...
module FAU ( 
  ...
  assign z01 = (~x20 & ~x27) | (x08 & ~x18) | (~x09 & x27);
  assign z02 = (~x21 & ~x27) | (x08 & ~x18) | (~x10 & x27);
  assign z03 = (~x22 & ~x27) | (x08 & ~x18) | (~x11 & x27);
  assign z04 = (~x23 & ~x27) | (x08 & ~x18) | (~x12 & x27);
  assign z05 = (~x08 | x18) & (x27 ? ~x13 : ~x24);
  assign z06 = (~x08 | x18) & (x27 ? ~x14 : ~x25);
  assign z07 = (~x26 & ~x27) | (x08 & ~x18) | (~x15 & x27);
  assign z08 = x27 & (~x08 | x18);
  assign z09 = (x16 & (~x17 ^ x19)) | (x08 & ~x18) | (x00 & ~x16 & x18);
  ...
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (x08 & ~x18) | (~new_n69_ & x16);
