...
module FAU ( 
  ...
  assign new_n73_ = (~x04 | ~x18) & (~x12 | x18 | x25);
  assign z14 = x16 ? (~new_n75_ & (x18 | ~x25)) : ((x05 & x18) | (x13 & ~x18 & ~x25));
  ...
  assign new_n78_ = (x17 | x19 | x20 | new_n79_ | x21) & (~x25 | (~x17 & ~x19 & ~x20 & ~x21));
  assign new_n79_ = (x22 | ((x23 | x24 | x25) & (~x18 | ~x25 | (~x23 & (x23 | ~x24))))) & (~x18 | ~x22 | ~x25);
  assign z16 = (~new_n85_ & ~x16) | (x25 & (~x18 | (x16 & x26))) | (~new_n81_ & x16);
  assign new_n81_ = (~x26 | (new_n76_ & new_n83_)) & (~new_n82_ | ~new_n84_);
  ...
  assign new_n87_ = (~new_n84_ | x17 | ~x19 | x20 | x21) & (~x17 | ~x27);
endmodule
