...
module FAU ( 
  ...
  assign z11 = x16 ? ~new_n63_ : ((x02 & x18) | (x10 & ~x18 & ~x23));
  ...
  assign z12 = x16 ? (~new_n67_ & (x18 | ~x23)) : ((x03 & x18) | (x11 & ~x18 & ~x23));
  ...
  assign z16 = (~new_n84_ & ~x16) | (~new_n81_ & x16) | (x23 & (~x18 | (x16 & x26)));
  ...
  assign z17 = (~new_n86_ & x16) | (~x18 & x23);
  assign new_n86_ = (~new_n83_ | x17 | ~x19 | x20 | x21) & (~x17 | ~x27);
endmodule
