...
module FAU ( 
  ...
  assign z01 = (~x09 & x27 & (x20 | x21)) | (~x20 & x21 & ~x27);
  assign z02 = (~x21 & (~x20 | ~x27)) | (~x10 & x27);
  ...
  assign z10 = (~new_n61_ & ~x16) | (~x20 & ~x21) | (x16 & (x19 ? x20 : (~x17 ^ x20)));
  assign new_n61_ = x18 ? ~x01 : ~x09;
  assign z11 = x16 ? (x21 & (x19 | (x17 & ~x19) | x20)) : (~new_n63_ & (x20 | x21));
  assign new_n63_ = x18 ? ~x02 : ~x10;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | new_n49_ | (x16 & x22);
  assign z13 = ~new_n49_ & (x16 ? x23 : (x18 ? x04 : x12));
