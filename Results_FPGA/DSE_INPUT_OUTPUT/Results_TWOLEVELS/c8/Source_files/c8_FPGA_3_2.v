// Benchmark "FAU" written by ABC on Fri Aug 21 20:16:31 2020
...
module FAU ( 
  ...
  assign z13 = (~new_n67_ & ~x16) | (new_n68_ & x16) | (~x19 & (new_n65_ | x18));
  assign new_n65_ = x16 & ~x17 & ~x20 & new_n66_ & ~x21;
  assign new_n66_ = ~x22 & ~x23;
  assign new_n67_ = x18 ? ~x04 : ~x12;
  assign new_n68_ = x23 & (x17 | x19 | x20 | x21 | x22);
  assign z14 = x16 ? ~new_n70_ : ((x13 & ~x18) | (x05 & x18 & x19));
  assign new_n70_ = (~x19 | ~x24) & (x18 | ((~new_n71_ | ~new_n73_) & (new_n72_ | ~x24)));
  assign new_n71_ = ~x17 & ~x19 & ~x20;
  assign new_n72_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n73_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z15 = x16 ? ((x19 & x25) | (~new_n75_ & ~x18)) : ~new_n78_;
  assign new_n75_ = (~x25 | (new_n77_ & ~x22 & ~x23 & ~x24)) & (~new_n76_ | x24 | x25 | x22 | x23);
  assign new_n76_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n77_ = ~x17 & ~x20 & ~x21;
  assign new_n78_ = (~x14 | x18) & (~x06 | ~x18 | ~x19);
  assign z16 = x16 ? ((x19 & x26) | (~new_n80_ & ~x18)) : ~new_n81_;
  assign new_n80_ = (~x26 | (new_n77_ & new_n66_ & ~x24 & ~x25)) & (~new_n76_ | ~new_n66_ | x24 | x25 | x26);
  assign new_n81_ = (~x15 | x18) & (~x07 | ~x18 | ~x19);
  assign z17 = (x18 & ~x19) | (~new_n83_ & x16);
