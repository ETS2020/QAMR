...
module FAU ( 
  ...
  assign z01 = (x06 | x18) & (x27 ? ~x09 : ~x20);
  assign z02 = (~x21 & ~x27) | (~x10 & x27) | (~x06 & ~x18);
  assign z03 = (x06 | x18) & (x27 ? ~x11 : ~x22);
  assign z04 = (~x23 & ~x27) | (~x12 & x27) | (~x06 & ~x18);
  assign z05 = (x06 | x18) & (x27 ? ~x13 : ~x24);
  assign z06 = (~x25 & ~x27) | (~x14 & x27) | (~x06 & ~x18);
  ...
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x06 & ~x18) | (~new_n60_ & x16);
  ...
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~x06 & ~x18) | (~new_n66_ & x16);
  assign new_n66_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~x06 & ~x18) | (~new_n68_ & x16);
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~x06 & ~x18) | (~new_n70_ & x16);
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~x06 & ~x18) | (x16 & (new_n72_ | new_n73_));
  ...
  assign z17 = (~new_n77_ & x16) | (~x06 & ~x18);
