...
module FAU ( 
  ...
  assign z10 = x16 ? (~new_n60_ & (x15 | ~x18)) : ((x09 & ~x18) | (x01 & x15 & x18));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n62_ & (x15 | ~x18)) : ((x10 & ~x18) | (x02 & x15 & x18));
  assign new_n62_ = ~new_n64_ & (new_n63_ | ~x21);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = x16 ? (~new_n66_ & (x15 | ~x18)) : ((x11 & ~x18) | (x03 & x15 & x18));
