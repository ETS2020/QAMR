// Benchmark "FAU" written by ABC on Fri Aug 21 20:16:54 2020
...
module FAU ( 
  ...
  assign z04 = (~x12 & x27 & (x23 | ~x24)) | (~x23 & ~x24 & ~x27);
  assign z05 = (~x24 & ~x27) | (~x23 & x24) | (~x13 & x27);
  ...
  assign new_n69_ = (~x23 | (~x17 & ~x19 & new_n70_ & ~x20)) & (x17 | x19 | x20 | ~new_n70_ | x23 | x24);
  assign new_n70_ = ~x21 & ~x22;
  assign z14 = (~new_n72_ & (x24 ? x23 : ~x16)) | (x16 & ((x23 & x24) | (new_n63_ & new_n70_ & ~x23 & ~x24)));
  assign new_n72_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ((~new_n74_ & ~x24) | (x23 & x25)) : (~new_n75_ & (x23 | ~x24));
  assign new_n74_ = (x17 | x19 | x20 | ~new_n70_ | x23 | x25) & (~x25 | (~x17 & ~x19 & new_n70_ & ~x20));
  assign new_n75_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((~new_n77_ & ~x24) | (x23 & x26)) : (~new_n80_ & (x23 | ~x24));
  assign new_n77_ = (new_n78_ | ~x26) & (~new_n65_ | ~new_n79_);
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x25;
  assign new_n79_ = ~x25 & ~x26 & ~x22 & ~x23;
  assign new_n80_ = x18 ? ~x07 : ~x15;
  assign z17 = new_n49_ | (~new_n82_ & x16);
  assign new_n82_ = (~new_n79_ | x17 | ~x19 | x20 | x21) & (~x17 | ~x27);
endmodule
