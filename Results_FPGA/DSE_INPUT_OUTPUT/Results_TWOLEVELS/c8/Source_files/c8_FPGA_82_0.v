...
module FAU ( 
  ...
  assign z13 = x16 ? ~new_n67_ : ((x04 & x18) | (x12 & ~x18 & x26));
  assign new_n67_ = (new_n49_ | new_n68_ | ~x23) & (x17 | ~new_n69_ | x19);
  ...
  assign new_n71_ = x24 & ~new_n49_ & (~new_n72_ | x21 | x22 | x23);
  assign new_n72_ = ~x17 & ~x19 & ~x20;
  assign new_n73_ = ~x20 & ~x21 & ~x22 & ~x23 & ~new_n49_ & ~x24;
  assign new_n74_ = (~x05 | ~x18) & (~x13 | x18 | ~x26);
  assign z15 = (~new_n79_ & ~x16) | new_n49_ | ((new_n76_ | new_n78_) & x16);
  assign new_n76_ = ~x17 & ~x19 & ~x20 & new_n77_ & ~x21;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25 & (x26 | (x18 & ~x26));
  assign new_n78_ = x25 & (~new_n72_ | x21 | x22 | x23 | x24);
  assign new_n79_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? (new_n82_ | (~new_n81_ & x26)) : ~new_n84_;
  assign new_n81_ = new_n72_ & ~x21 & ~x22 & ~x23;
  assign new_n82_ = ~x17 & ~x19 & ~x20 & new_n83_ & ~x21;
  assign new_n83_ = ~x22 & ~x23 & (x24 ? x26 : ((x25 & x26) | (x18 & ~x25 & ~x26)));
  assign new_n84_ = (~x07 | ~x18) & (~x15 | x18 | ~x26);
  assign z17 = x16 & ((z08 & x17) | (new_n87_ & new_n86_ & ~x17 & x18));
