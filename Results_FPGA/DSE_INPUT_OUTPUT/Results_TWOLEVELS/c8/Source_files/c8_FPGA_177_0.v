// Benchmark "FAU" written by ABC on Fri Aug 21 20:17:33 2020
...
module FAU ( 
  ...
  assign z03 = (~x22 & ~x27) | (~x15 & ~x18) | (~x11 & x27);
  assign z04 = (~x23 & ~x27) | (~x15 & ~x18) | (~x12 & x27);
  assign z05 = (x15 | x18) & (x27 ? ~x13 : ~x24);
  assign z06 = (x15 | x18) & (x27 ? ~x14 : ~x25);
  assign z07 = (~x15 & (~x18 | x27)) | (~x26 & ~x27);
  ...
  assign z15 = x16 ? ((new_n72_ | new_n73_) & (x15 | x18)) : ~new_n75_;
  assign new_n72_ = x25 & (~new_n63_ | x21 | x22 | x23 | x24);
  assign new_n73_ = new_n64_ & new_n74_;
  assign new_n74_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n75_ = (~x06 | ~x18) & (~x14 | ~x15 | x18);
  assign z16 = (~x16 & (x18 ? x07 : x15)) | new_n77_ | (new_n78_ & x16);
  assign new_n77_ = x26 & (~new_n64_ | ~new_n74_) & (x18 ? x16 : x15);
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n79_ & ~x22;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & (x15 | x18) & ~x26;
  assign z17 = (~new_n81_ & x16) | (~x15 & ~x18);
