...
module FAU ( 
  ...
  assign z03 = (x14 | x18) & (x27 ? ~x11 : ~x22);
  ...
  assign z10 = x16 ? (~new_n60_ & (x14 | x18)) : ((x01 & x18) | (x09 & x14 & ~x18));
  ...
  assign z15 = (~x16 & (x18 ? x06 : x14)) | new_n72_ | (new_n74_ & x16);
  assign new_n72_ = x25 & (~new_n63_ | ~new_n73_) & (x18 ? x16 : x14);
  assign new_n73_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n74_ = ~x17 & ~x19 & ~x20 & new_n75_ & ~x21;
  assign new_n75_ = ~x22 & ~x23 & ~x24 & (x14 | x18) & ~x25;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n77_ & x16) | (~x14 & ~x18);
  assign new_n77_ = (~x26 | (new_n64_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n64_ | x22 | x23 | x24 | x25 | x26);
  assign z17 = x16 & ~new_n79_ & (x14 | x18);
