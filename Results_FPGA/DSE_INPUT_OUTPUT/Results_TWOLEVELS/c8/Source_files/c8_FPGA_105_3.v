...
module FAU ( 
  ...
  assign z10 = x16 ? ~new_n62_ : ((x09 & ~x18) | (x01 & x18 & ~x26));
  ...
  assign new_n69_ = (~x11 | x18) & (~x03 | ~x18 | x26);
  ...
  assign new_n75_ = (~x12 | x18) & (~x04 | ~x18 | x26);
  ...
  assign new_n82_ = (~x13 | x18) & (~x05 | ~x18 | x26);
  assign z15 = x16 ? (~new_n84_ & (~x18 | ~x26)) : ((x14 & ~x18) | (x06 & x18 & ~x26));
  ...
  assign new_n89_ = (~x15 | x18) & (~x07 | ~x18 | x26);
