...
module FAU ( 
  ...
  assign new_n58_ = x17 ? (~x19 | (~x18 & x22)) : (x19 | (x22 & (~x18 | (x20 & (~x20 | ~x22)))));
  ...
  assign new_n66_ = (x17 | x19 | ((~x18 | ~x20 | ~x22) & (x20 | x21 | x22))) & (~x22 | (~x19 & ~x21 & (~x17 | ~x18 | x21)));
  ...
  assign z14 = (~new_n72_ & ~x16) | (~new_n71_ & x16) | (x22 & (~x18 | (x16 & x18 & x24)));
  assign new_n71_ = (new_n69_ | ~x24) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign new_n72_ = x18 ? ~x05 : ~x13;
  assign z15 = (~new_n76_ & ~x16) | (~new_n74_ & x16) | (x22 & (~x18 | (x16 & x18 & x25)));
  assign new_n74_ = (new_n75_ | ~x25) & (~new_n64_ | x22 | x23 | x24 | x25);
  assign new_n75_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n76_ = x18 ? ~x06 : ~x14;
  assign z16 = (~new_n81_ & ~x16) | (~new_n78_ & x16) | (x22 & (~x18 | (x16 & x18 & x26)));
  assign new_n78_ = (~x26 | (new_n63_ & new_n79_)) & (~new_n64_ | ~new_n80_);
  ...
  assign new_n83_ = new_n80_ & ~x17 & x19 & ~x20 & ~x21;
endmodule
