...
module FAU ( 
  ...
  assign z04 = (~x23 & ~x27) | (~x12 & x27) | (~x17 & x18);
  ...
  assign z12 = (~new_n63_ & ~x16) | (~new_n64_ & ~x17) | (x16 & ~new_n65_ & x22);
  assign new_n63_ = x18 ? ~x03 : ~x11;
  assign new_n64_ = ~x18 & (~x16 | x19 | x20 | x21 | x22);
  assign new_n65_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z13 = (~new_n69_ & ~x16) | (new_n70_ & x16) | (~x17 & (new_n67_ | x18));
  assign new_n67_ = new_n68_ & x16 & ~x21 & ~x22 & ~x23;
  assign new_n68_ = ~x19 & ~x20;
  assign new_n69_ = x18 ? ~x04 : ~x12;
  assign new_n70_ = x23 & (x17 | x19 | x20 | x21 | x22);
  assign z14 = x16 ? ((x17 & x24) | (~new_n72_ & ~x18)) : ~new_n73_;
  assign new_n72_ = (~x24 | (new_n68_ & ~x21 & ~x22 & ~x23)) & (~new_n68_ | x17 | x21 | x22 | x23 | x24);
  assign new_n73_ = (~x05 | ~x17 | ~x18) & (~x13 | x18);
  assign z15 = x16 ? ((x17 & x25) | (~new_n75_ & ~x18)) : ~new_n77_;
  assign new_n75_ = (~x25 | (new_n76_ & ~x22 & ~x23 & ~x24)) & (~new_n65_ | x22 | x23 | x24 | x25);
  assign new_n76_ = ~x19 & ~x20 & ~x21;
  assign new_n77_ = (~x06 | ~x17 | ~x18) & (~x14 | x18);
  assign z16 = (~new_n82_ & ~x16) | (~new_n79_ & ~x17) | (new_n81_ & x16);
  assign new_n79_ = ~x18 & (~new_n80_ | x20 | x21 | ~x16 | x19);
  assign new_n80_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n81_ = x26 & (~new_n65_ | x24 | x25 | x22 | x23);
  assign new_n82_ = x18 ? ~x07 : ~x15;
  assign z17 = (~new_n84_ & x16) | (~x17 & x18);
