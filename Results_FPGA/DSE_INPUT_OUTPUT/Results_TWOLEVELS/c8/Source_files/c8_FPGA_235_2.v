...
module FAU ( 
  ...
  assign new_n59_ = (~x08 | x18) & (~x00 | ~x18 | ~x25);
  assign z10 = x16 ? (~new_n61_ & (~x18 | x25)) : ((x09 & ~x18) | (x01 & x18 & x25));
  ...
  assign z12 = x16 ? ~new_n67_ : ((x11 & ~x18) | (x03 & x18 & x25));
  assign new_n67_ = (~x22 | new_n49_ | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | new_n49_ | x22);
  assign z13 = x16 ? ~new_n69_ : ((x12 & ~x18) | (x04 & x18 & x25));
  assign new_n69_ = (~x23 | new_n49_ | (new_n70_ & ~x17 & ~x19)) & (x17 | ~new_n71_ | x19);
  assign new_n70_ = ~x20 & ~x21 & ~x22;
  assign new_n71_ = ~x20 & ~x21 & ~x22 & ~x23 & (~x18 | x25);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (x18 & ~x25) | (~new_n73_ & x16);
  assign new_n73_ = (x17 | x19 | ~new_n74_ | x20) & (~x24 | (new_n75_ & ~x17 & ~x19 & ~x20));
  assign new_n74_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n75_ = ~x21 & ~x22 & ~x23;
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (x18 & ~x25) | (~new_n77_ & x16);
  assign new_n77_ = (x17 | new_n78_ | x19) & (~x25 | (~x17 & ~x19 & ~x21 & ~x22));
  assign new_n78_ = x20 ? ~x25 : (x21 | x22 | (x23 ? ~x25 : (x24 ^ x25)));
  assign z16 = x16 ? (new_n80_ | (x25 & x26)) : ~new_n83_;
  assign new_n80_ = ~x18 & ((x26 & (~new_n63_ | ~new_n81_)) | (new_n65_ & new_n82_));
