...
module FAU ( 
  ...
  assign z02 = (x04 | ~x18) & (x27 ? ~x10 : ~x21);
  ...
  assign z07 = (~x26 & ~x27) | (~x15 & x27) | (~x04 & x18);
  ...
  assign z13 = (~x16 & (x12 | x18)) | (~x04 & x18) | (~new_n68_ & x16);
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~x04 & x18) | (~new_n70_ & x16);
