...
module FAU ( 
  ...
  assign new_n71_ = (x17 | x19 | x20 | new_n72_ | x21) & (~x24 | (~x17 & ~x19 & ~x20 & ~x21));
  assign new_n72_ = x22 ? ~x24 : ((~x23 | ~x24) & (~x18 | x23 | x24));
  assign z15 = (~new_n78_ & ~x16) | (new_n76_ & x16) | (~new_n74_ & ~x24);
  assign new_n74_ = x18 & (~new_n75_ | x19 | x20 | ~x16 | x17);
  assign new_n75_ = ~x23 & ~x25 & ~x21 & ~x22;
  assign new_n76_ = x25 & (~new_n77_ | x21 | x22 | x23 | x24);
