...
module FAU ( 
  ...
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n80_ & x16) | (x18 & ~x26);
  assign new_n80_ = (x17 | x19 | (x20 ? ~x26 : new_n81_)) & (~x26 | (~x17 & ~x19));
  assign new_n81_ = x21 ? ~x26 : ((x22 | x23 | (x24 ? ~x26 : (x25 ^ x26))) & ((~x22 & ~x23) | ~x26));
