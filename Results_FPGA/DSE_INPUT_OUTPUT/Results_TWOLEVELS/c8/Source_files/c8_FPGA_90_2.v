...
module FAU ( 
  ...
  assign z08 = x27 | (x21 & ~x27);
  assign z09 = (x16 & (x17 ^ ~x19)) | (x21 & ~x27) | (~new_n58_ & ~x16);
  assign new_n58_ = x18 ? ~x00 : ~x08;
  assign z10 = ~new_n60_ | (~x16 & (x18 ? x01 : x09));
  assign new_n60_ = (~x21 | x27) & (~x16 | ((x17 | x19 | x20) & (~x20 | (~x17 & ~x19))));
  assign z11 = x16 ? (new_n64_ | (x21 & ~new_n62_ & x27)) : (~new_n63_ & (~x21 | x27));
  assign new_n62_ = ~x17 & ~x19 & ~x20;
  assign new_n63_ = x18 ? ~x02 : ~x10;
  assign new_n64_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (~new_n66_ & ~x16) | (~new_n67_ & x16) | (x21 & (~x27 | (x16 & x22)));
  assign new_n66_ = x18 ? ~x03 : ~x11;
  assign new_n67_ = (~x22 | (~x17 & ~x19 & ~x20)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = (~new_n69_ & ~x16) | (~new_n70_ & x16) | (x21 & (~x27 | (x16 & x23)));
  assign new_n69_ = x18 ? ~x04 : ~x12;
  assign new_n70_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  ...
  assign z16 = (~new_n80_ & ~x16) | (x21 & (~x27 | (x16 & x26))) | (~new_n78_ & x16);
  ...
  assign z17 = (x21 & ~x27) | (~new_n82_ & x16);
  assign new_n82_ = (~new_n83_ | x17 | ~x19 | x20 | x21) & (~x17 | ~x27);
