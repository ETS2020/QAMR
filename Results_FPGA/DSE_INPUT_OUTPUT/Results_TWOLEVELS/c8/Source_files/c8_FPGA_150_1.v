...
module FAU ( 
  ...
  assign new_n75_ = ~x22 & ~x23 & ~x24 & (~x26 | (x18 & (~x25 | (x25 & x26))));
  assign new_n76_ = (~x05 | ~x18) & (~x13 | x18 | x26);
  assign z15 = (~new_n81_ & ~x16) | new_n49_ | (x16 & (new_n78_ | new_n80_));
  assign new_n78_ = ~x17 & ~x19 & ~x20 & new_n79_ & ~x21;
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & (x18 | ~x26);
  assign new_n80_ = x25 & (~new_n73_ | x23 | x24 | x21 | x22);
  assign new_n81_ = x18 ? ~x06 : ~x14;
  assign z16 = (~new_n86_ & ~x16) | (~x18 & x26) | (x16 & (new_n83_ | (~new_n85_ & x26)));
  assign new_n83_ = ~x17 & ~x19 & ~x20 & new_n84_ & ~x21;
  assign new_n84_ = ~x22 & ~x23 & ((~x24 & ~x25 & ~x26) | (x18 & x26 & (x24 | (~x24 & x25))));
  assign new_n85_ = new_n73_ & ~x21 & ~x22 & (~x18 | ~x23);
  assign new_n86_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & ((z08 & x17) | (new_n89_ & new_n88_ & ~x17 & x19));
