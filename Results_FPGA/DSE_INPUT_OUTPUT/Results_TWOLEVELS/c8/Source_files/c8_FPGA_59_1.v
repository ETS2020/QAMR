...
module FAU ( 
  ...
  assign new_n69_ = x23 & (x20 | x21 | x22 | x17 | x19);
  assign z14 = x16 ? ((x17 & x24) | (~new_n71_ & ~x18)) : ~new_n72_;
  assign new_n71_ = (~x24 | (new_n66_ & ~x21 & ~x22 & ~x23)) & (~new_n66_ | x17 | x23 | x24 | x21 | x22);
  assign new_n72_ = (~x13 | x18) & (~x05 | ~x17 | ~x18);
  ...
  assign new_n77_ = (~x14 | x18) & (~x06 | ~x17 | ~x18);
  assign z16 = x16 ? ((x17 & x26) | (~new_n79_ & ~x18)) : ~new_n80_;
  assign new_n79_ = (~x26 | (new_n75_ & new_n67_ & ~x24 & ~x25)) & (~new_n76_ | ~new_n67_ | x24 | x25 | x26);
  assign new_n80_ = (~x15 | x18) & (~x07 | ~x17 | ~x18);
