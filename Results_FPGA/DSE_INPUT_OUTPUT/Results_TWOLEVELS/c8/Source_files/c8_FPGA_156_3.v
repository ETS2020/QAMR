...
module FAU ( 
  ...
  assign new_n69_ = ~x21 & ~x22 & (~x26 | (~x25 & (x23 ? x26 : (~x24 | (x24 & x26)))));
  ...
  assign new_n73_ = ~x21 & ~x22 & ~x23 & (~x26 | (~x25 & (~x24 | (x24 & x26))));
  assign z14 = ~new_n49_ & (x16 ? ~new_n75_ : (x18 ? x05 : x13));
  assign new_n75_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z15 = (~new_n80_ & ~x16) | (x25 & x26) | (x16 & (new_n79_ | (~new_n77_ & x25)));
  assign new_n77_ = new_n63_ & new_n78_ & ~x23 & ~x24;
  assign new_n78_ = ~x21 & ~x22;
  assign new_n79_ = new_n65_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n80_ = x18 ? ~x06 : ~x14;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | new_n49_ | (~new_n82_ & x16);
  assign new_n82_ = (x17 | x19 | ~new_n83_ | x20) & (~x26 | (~x17 & ~x19 & new_n78_ & ~x20));
  assign new_n83_ = ~x21 & ~x22 & ~x25 & (x23 ? x26 : (~x24 ^ x26));
  assign z17 = x16 & ((z08 & x17) | (new_n86_ & new_n85_ & ~x17 & x19));
