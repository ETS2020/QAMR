...
module FAU ( 
  ...
  assign z14 = x16 ? (new_n70_ | new_n72_) : ~new_n74_;
  assign new_n70_ = x24 & ((~new_n63_ & (x10 | (~x10 & ~x18))) | ((x10 | ~x18) & (~new_n71_ | x21)));
  assign new_n71_ = ~x22 & ~x23;
  assign new_n72_ = ~x17 & ~x19 & ~x20 & new_n73_ & ~x21;
  assign new_n73_ = ~x22 & ~x23 & ~x24 & (x10 | ~x18);
  assign new_n74_ = (~x05 | ~x10 | ~x18) & (~x13 | x18);
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~new_n76_ & x16) | (~x10 & x18);
  assign new_n76_ = (~x25 | (new_n63_ & new_n77_)) & (~new_n64_ | ~new_n71_ | x24 | x25);
  assign new_n77_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n79_ & x16) | (~x10 & x18);
