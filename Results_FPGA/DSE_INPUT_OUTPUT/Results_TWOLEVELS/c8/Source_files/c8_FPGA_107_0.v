...
module FAU ( 
  ...
  assign z09 = x16 ? (x17 ? (~new_n49_ & x19) : (~new_n49_ & ~x19)) : ~new_n59_;
  assign new_n59_ = (~x00 | ~x18) & (~x08 | x18 | ~x26);
  assign z10 = x16 ? (~new_n61_ & (x18 | x26)) : ((x01 & x18) | (x09 & ~x18 & x26));
  ...
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n69_ & x16) | (~x18 & ~x26);
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n71_ & x16) | (~x18 & ~x26);
  assign new_n71_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~new_n73_ & x16) | (~x18 & ~x26);
  assign new_n73_ = (~new_n65_ | ~new_n76_) & (~x25 | (new_n63_ & new_n74_ & new_n75_));
  assign new_n74_ = ~x21 & ~x22;
  assign new_n75_ = ~x23 & ~x24;
  assign new_n76_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign z16 = (~new_n80_ & ~x16) | new_n49_ | (x16 & (new_n79_ | (new_n78_ & ~x17)));
  assign new_n78_ = ~x19 & ((x20 & x26) | (new_n74_ & ~x20 & new_n75_ & ~x25 & ~x26));
  assign new_n79_ = x26 & (~new_n74_ | x19 | ~new_n75_ | x25 | (x17 & ~x25));
  assign new_n80_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & (new_n82_ | (x17 & ~new_n49_ & x27));
  assign new_n82_ = new_n83_ & ~x17 & x18 & x19 & ~x20 & ~x21;
