// Benchmark "FAU" written by ABC on Fri Aug 21 20:16:33 2020
...
module FAU ( 
  ...
  assign z14 = x16 ? (new_n69_ | (~x17 & new_n71_ & ~x19)) : ~new_n72_;
  assign new_n69_ = x24 & ~new_n49_ & (~new_n70_ | x21 | x22 | x23);
  assign new_n70_ = ~x17 & ~x19 & ~x20;
  assign new_n71_ = ~x20 & ~x21 & ~x22 & ~x23 & ~new_n49_ & ~x24;
  assign new_n72_ = (~x13 | x18) & (~x05 | ~x18 | ~x26);
  assign z15 = x16 ? (new_n75_ | (new_n74_ & x25)) : ~new_n77_;
  assign new_n74_ = ~new_n49_ & (~new_n70_ | x21 | x22 | x23 | x24);
  assign new_n75_ = ~x17 & ~x19 & ~x20 & new_n76_ & ~x21;
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & (x26 | (~x18 & ~x26));
  assign new_n77_ = (~x14 | x18) & (~x06 | ~x18 | ~x26);
  assign z16 = x16 ? (new_n81_ | (~new_n79_ & x26)) : ~new_n83_;
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x23 & ~x24 & (x17 | x19 | new_n80_ | x20);
  assign new_n80_ = ~x21 & (x21 | (~x22 & (x22 | x23 | x24 | ~x25)));
  assign new_n81_ = new_n82_ & ~x17 & ~x18 & ~x19 & ~x20 & ~x21;
  assign new_n82_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n83_ = (~x15 | x18) & (~x07 | ~x18 | ~x26);
  assign z17 = x16 & ((z08 & x17) | (new_n82_ & new_n85_ & ~x17 & ~x18));
