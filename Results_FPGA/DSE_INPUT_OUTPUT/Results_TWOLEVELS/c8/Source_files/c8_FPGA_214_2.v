...
module FAU ( 
  ...
  assign z13 = (~new_n68_ & ~x16) | (~x22 & (new_n66_ | x18)) | (new_n69_ & x16);
  assign new_n66_ = new_n67_ & ~x20 & ~x21 & ~x23;
  assign new_n67_ = x16 & ~x17 & ~x19;
  assign new_n68_ = x18 ? ~x04 : ~x12;
  assign new_n69_ = x23 & (x17 | x19 | x20 | x21 | x22);
  assign z14 = (~new_n74_ & ~x16) | (~new_n71_ & ~x22) | (x16 & ~new_n72_ & x24);
  assign new_n71_ = ~x18 & (~new_n67_ | x20 | x21 | x23 | x24);
  assign new_n72_ = new_n73_ & ~x21 & ~x22 & ~x23;
  assign new_n73_ = ~x17 & ~x19 & ~x20;
  assign new_n74_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ~new_n76_ : ((x14 & ~x18) | (x06 & x18 & x22));
  assign new_n76_ = (~x22 | ~x25) & (x18 | ((~new_n77_ | ~new_n79_) & (new_n78_ | ~x25)));
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x23 & ~x24;
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? (new_n81_ | (x22 & x26)) : ~new_n84_;
  assign new_n81_ = ~x18 & ((x26 & (~new_n73_ | ~new_n82_)) | (new_n77_ & new_n83_));
  assign new_n82_ = ~x21 & ~x23 & ~x24 & ~x25;
  assign new_n83_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n84_ = (~x15 | x18) & (~x07 | ~x18 | ~x22);
  assign z17 = x16 & (new_n86_ | (x17 & x27 & (~x18 | x22)));
  assign new_n86_ = new_n83_ & ~x17 & ~x18 & x19 & ~x20 & ~x21;
endmodule
