// Benchmark "FAU" written by ABC on Fri Aug 21 20:17:17 2020
...
module FAU ( 
  ...
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~new_n60_ & x16) | (x18 & x20);
  ...
  assign z14 = (~new_n72_ & ~x16) | (x20 & (x18 | (x16 & x24))) | (~new_n70_ & x16);
  assign new_n70_ = (~x24 | (new_n68_ & ~x21 & ~x22 & ~x23)) & (~new_n71_ | x21 | x22 | x23 | x24);
  assign new_n71_ = ~x17 & ~x19 & ~x20;
  assign new_n72_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ((~new_n74_ & ~x20) | (~x18 & x20 & x25)) : ~new_n76_;
  assign new_n74_ = (~x25 | (new_n75_ & ~x22 & ~x23 & ~x24)) & (~new_n75_ | x24 | x25 | x22 | x23);
  assign new_n75_ = ~x17 & ~x19 & ~x21;
  assign new_n76_ = (~x14 | x18) & (~x06 | ~x18 | x20);
  assign z16 = (~new_n81_ & ~x16) | (x20 & (x18 | (x16 & x26))) | (~new_n78_ & x16);
  ...
  assign z17 = x16 & ((z08 & x17) | (new_n83_ & new_n84_ & ~x17 & x19));
