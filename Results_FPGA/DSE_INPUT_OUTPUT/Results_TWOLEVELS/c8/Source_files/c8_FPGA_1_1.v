...
module FAU ( 
  ...
  assign z11 = x16 ? ~new_n63_ : ((x02 & x18) | (x10 & ~x18 & ~x26));
  ...
  assign new_n70_ = (~x24 | (new_n71_ & ~x21 & ~x22 & ~x23)) & (~new_n71_ | x21 | x22 | x23 | x24);
  assign new_n71_ = ~x17 & ~x19 & ~x20;
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~new_n73_ & x16) | (~x18 & x26);
  assign new_n73_ = (~x25 | (new_n71_ & new_n76_)) & (~new_n74_ | ~new_n75_ | x24 | x25);
  assign new_n74_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n75_ = ~x22 & ~x23;
  assign new_n76_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z16 = (~new_n81_ & ~x16) | (~x18 & x26) | (x16 & (new_n78_ | (~new_n80_ & x26)));
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~new_n79_ & ~x21;
  assign new_n79_ = (~x18 | ~x22 | ~x26) & (x22 | x23 | x24 | x25 | x26);
  assign new_n80_ = new_n71_ & ~x21 & ~x23 & ~x25 & (~x18 | ~x24);
