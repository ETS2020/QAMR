...
module FAU ( 
  ...
  assign z03 = (~x22 & ~x27) | (~x11 & x27) | (~x12 & x18);
  ...
  assign z10 = x16 ? (~new_n60_ & (x12 | ~x18)) : ((x09 & ~x18) | (x01 & x12 & x18));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n62_ & (x12 | ~x18)) : ((x10 & ~x18) | (x02 & x12 & x18));
