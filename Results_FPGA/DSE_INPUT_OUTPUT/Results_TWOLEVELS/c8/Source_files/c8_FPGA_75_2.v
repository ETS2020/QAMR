...
module FAU ( 
  ...
  assign z04 = (~x12 & (~x23 | (x24 & x27))) | (~x23 & ~x27);
  ...
  assign new_n67_ = (x17 | x19 | x20 | x21 | new_n68_ | x22) & (~x22 | (~x20 & ~x21 & ~x17 & ~x19));
  assign new_n68_ = x23 & (~x23 | ~x24);
  assign z13 = x16 ? ~new_n70_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n70_ = (~new_n71_ | ~x23) & (~new_n63_ | x21 | x22 | x23);
  assign new_n71_ = x24 & (x17 | x19 | x20 | x21 | x22);
  assign z14 = x16 ? (new_n71_ | (new_n74_ & ~x17)) : new_n73_;
  assign new_n73_ = ~new_n49_ & (x18 ? x05 : x13);
  assign new_n74_ = ~x19 & ~x20 & ~x21 & ~x22 & (~x23 ^ x24);
  assign z15 = x16 ? ((x24 & x25) | (~new_n76_ & ~x23)) : (~new_n78_ & (~x23 | x24));
  assign new_n76_ = (~x25 | (~x17 & ~x19 & new_n77_ & ~x20)) & (x17 | x19 | x20 | ~new_n77_ | x24 | x25);
  assign new_n77_ = ~x21 & ~x22;
  assign new_n78_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((x24 & x26) | (~new_n80_ & ~x23)) : (~new_n83_ & (~x23 | x24));
  assign new_n80_ = (new_n81_ | ~x26) & (~new_n65_ | ~new_n82_);
  assign new_n81_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x25;
  assign new_n82_ = ~x25 & ~x26 & ~x22 & ~x24;
