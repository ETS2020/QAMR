// Benchmark "FAU" written by ABC on Fri Aug 21 20:17:36 2020
...
module FAU ( 
  ...
  assign z12 = x16 ? (~new_n66_ & (x14 | x18)) : ((x03 & x18) | (x11 & x14 & ~x18));
  assign new_n66_ = (~x22 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n68_ & x16) | (~x14 & ~x18);
  ...
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & (x14 | x18);
  assign z16 = x16 ? (~new_n77_ & (x14 | x18)) : ((x07 & x18) | (x14 & x15 & ~x18));
  assign new_n77_ = (~x26 | (new_n64_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n64_ | x22 | x23 | x24 | x25 | x26);
