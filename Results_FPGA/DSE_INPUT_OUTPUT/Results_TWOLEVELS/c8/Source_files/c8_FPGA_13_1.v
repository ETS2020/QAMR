// Benchmark "FAU" written by ABC on Fri Aug 21 20:16:35 2020
...
module FAU ( 
  ...
  assign z02 = (~x10 & (x18 | (~x18 & x27))) | (~x21 & ~x27);
  ...
  assign z11 = (~x16 & (x18 ? x02 : x10)) | (~x10 & x18) | (~new_n62_ & x16);
  ...
  assign z17 = (~x10 & x18) | (~new_n78_ & x16);
