...
module FAU ( 
  ...
  assign new_n59_ = (~x08 | x18) & (~x00 | ~x18 | ~x26);
  ...
  assign z12 = x16 ? ~new_n65_ : ((x11 & ~x18) | (x03 & x18 & x26));
  ...
  assign z15 = x16 ? (new_n77_ | (new_n76_ & x25)) : ~new_n79_;
  assign new_n76_ = ~new_n49_ & (~new_n72_ | x21 | x22 | x23 | x24);
  assign new_n77_ = ~x17 & ~x19 & ~x20 & new_n78_ & ~x21;
  assign new_n78_ = ~x22 & ~x23 & ~x24 & ~x25 & (x26 | (~x18 & ~x26));
  assign new_n79_ = (~x14 | x18) & (~x06 | ~x18 | ~x26);
  assign z16 = x16 ? ~new_n81_ : ((x15 & ~x18) | (x07 & x18 & x26));
  assign new_n81_ = (x17 | x19 | (x20 ? ~x26 : (x21 ? ~x26 : new_n82_))) & ((~x17 & ~x19) | ~x26);
  assign new_n82_ = x22 ? ~x26 : (x23 ? ~x26 : (x24 ? ~x26 : ((~x25 | ~x26) & (x18 | x25 | x26))));
  assign z17 = x16 & ((z08 & x17) | (new_n85_ & new_n84_ & ~x17 & ~x18));
  assign new_n84_ = x19 & ~x20 & ~x21;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x22 & ~x23;
endmodule
