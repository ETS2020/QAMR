...
module FAU ( 
  ...
  assign z01 = (x07 | x18) & (x27 ? ~x09 : ~x20);
  assign z02 = (~x21 & ~x27) | (~x10 & x27) | (~x07 & ~x18);
  assign z03 = (x07 | x18) & (x27 ? ~x11 : ~x22);
  assign z04 = (x07 | x18) & (x27 ? ~x12 : ~x23);
  assign z05 = (x07 | x18) & (x27 ? ~x13 : ~x24);
  ...
  assign z16 = (x07 & (x16 ? ~new_n76_ : (x15 | x18))) | (x16 & ~new_n76_ & x18);
