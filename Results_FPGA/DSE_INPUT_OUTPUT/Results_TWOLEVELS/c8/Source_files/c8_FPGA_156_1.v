...
module FAU ( 
  ...
  assign z07 = (~x26 & ~x27) | (~x15 & (~x26 | (x25 & x27)));
  ...
  assign z12 = (~new_n65_ & ~new_n49_) | (x16 & new_n67_ & ~x17);
  assign new_n65_ = x16 ? (new_n66_ | ~x22) : (x18 ? ~x03 : ~x11);
  assign new_n66_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n67_ = ~x19 & ~x20 & ~x21 & ~new_n49_ & ~x22;
  assign z13 = (~new_n69_ & ~new_n49_) | (x16 & new_n71_ & ~x17);
  assign new_n69_ = x16 ? (new_n70_ | ~x23) : (x18 ? ~x04 : ~x12);
  assign new_n70_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n71_ = ~x19 & ~x20 & ~x21 & ~x22 & ~new_n49_ & ~x23;
  assign z14 = new_n75_ | (~new_n73_ & ~new_n49_);
  assign new_n73_ = x16 ? (new_n74_ | ~x24) : (x18 ? ~x05 : ~x13);
  assign new_n74_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n75_ = x16 & ~x17 & ~x19 & new_n76_ & ~x20;
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & (x25 | (~x25 & ~x26));
  assign z15 = (~x16 & (x18 ? x06 : x14)) | new_n49_ | (~new_n78_ & x16);
  assign new_n78_ = (new_n70_ | ~x25) & (x17 | x19 | ~new_n79_ | x20);
  assign new_n79_ = ~x21 & ~x22 & (x23 ? x25 : (x24 ? x25 : (~x25 & ~x26)));
  assign z16 = (x16 & (x26 | (new_n66_ & new_n81_))) | (~new_n82_ & ~x16) | (~x25 & x26);
