// Benchmark "FAU" written by ABC on Fri Aug 21 20:17:31 2020
...
module FAU ( 
  ...
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x01 & ~x05) | (~new_n61_ & x16);
  ...
  assign z14 = x16 ? (~new_n71_ & (x01 | x05)) : ((x05 & (x13 | x18)) | (x01 & x13 & ~x18));
