...
module FAU ( 
  ...
  assign z09 = x16 ? (~new_n59_ & (~x18 | ~x23)) : ((x08 & ~x18) | (x00 & x18 & ~x23));
  ...
  assign new_n64_ = x23 & (x18 | (x22 & (~x22 | ~x23)));
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (x18 & x23) | (~new_n66_ & x16);
  assign new_n66_ = (x17 | x19 | x20 | x21 | new_n49_ | x22) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z13 = x16 ? ~new_n68_ : ((x12 & ~x18) | (x04 & x18 & ~x23));
  assign new_n68_ = (~new_n70_ | x17) & (x18 | new_n69_ | ~x23);
  assign new_n69_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n70_ = ~x19 & ~x20 & ~x21 & ((~x18 & x22 & x23) | (~x22 & ~x23));
  ...
  assign z15 = (~new_n77_ & ~x16) | (x23 & (x18 | (x16 & x25))) | (~new_n75_ & x16);
  assign new_n75_ = (new_n76_ | ~x25) & (~new_n69_ | x22 | x23 | x24 | x25);
  assign new_n76_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x24;
  assign new_n77_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((~x18 & x23 & x26) | (~new_n79_ & ~x23)) : ~new_n83_;
  assign new_n79_ = (~x26 | (new_n80_ & new_n81_)) & (~new_n69_ | ~new_n82_);
  assign new_n80_ = ~x17 & ~x19 & ~x20;
  assign new_n81_ = ~x24 & ~x25 & ~x21 & ~x22;
  assign new_n82_ = ~x25 & ~x26 & ~x22 & ~x24;
  assign new_n83_ = (~x15 | x18) & (~x07 | ~x18 | x23);
