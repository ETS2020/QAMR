...
module FAU ( 
  ...
  assign new_n71_ = (x17 | x19 | new_n72_ | x20) & (~x24 | (~x17 & ~x19 & ~x20));
  assign new_n72_ = x21 ? ~x24 : (x22 ? ~x24 : ((~x23 | ~x24) & (~x18 | x23 | x24)));
  assign z15 = x16 ? ~new_n74_ : ((x06 & x18) | (x14 & ~x18 & x24));
  assign new_n74_ = (~x18 | ((new_n77_ | ~x25) & (~new_n75_ | ~new_n76_ | x24 | x25))) & (~x24 | ~x25);
  assign new_n75_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n76_ = ~x22 & ~x23;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z16 = (~new_n82_ & ~x16) | (new_n81_ & x16) | (~new_n79_ & ~x24);
  assign new_n79_ = x18 & (~new_n80_ | ~x16 | x17 | x19 | x20);
  assign new_n80_ = ~x21 & ~x22 & ~x23 & ~x25 & ~x26;
  assign new_n81_ = x26 & (~new_n75_ | ~new_n76_ | x24 | x25);
