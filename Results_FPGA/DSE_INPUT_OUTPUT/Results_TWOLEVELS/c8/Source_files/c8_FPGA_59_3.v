...
module FAU ( 
  ...
  assign z09 = x16 ? (x17 ? (~x18 & x19) : ~x19) : ((x00 & ~x17 & x18) | (x08 & ~x18));
  assign z10 = x16 ? ~new_n59_ : ((x01 & ~x17 & x18) | (x09 & ~x18));
  assign new_n59_ = x17 ? (x18 | ~x20) : (x19 ^ x20);
  assign z11 = ~new_n61_ | (~x16 & (x18 ? x02 : x10));
  assign new_n61_ = (~x17 | (~x18 & (~x16 | ~x21))) & (~x16 | (((~x19 & ~x20) | ~x21) & (x17 | x19 | x20 | x21)));
  assign z12 = x16 ? ~new_n63_ : ((x03 & ~x17 & x18) | (x11 & ~x18));
  assign new_n63_ = x17 ? (x18 | ~x22) : (~new_n65_ & (new_n64_ | ~x22));
  assign new_n64_ = ~x19 & ~x20 & ~x21;
  assign new_n65_ = ~x21 & ~x22 & ~x19 & ~x20;
  assign z13 = (~new_n67_ & ~x16) | (x17 & (x18 | (x16 & x23))) | (~new_n68_ & x16);
  assign new_n67_ = x18 ? ~x04 : ~x12;
  assign new_n68_ = (~x23 | (~x21 & ~x22 & ~x19 & ~x20)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (x17 ? (~x18 & x24) : ~new_n71_) : ~new_n70_;
  assign new_n70_ = (~x05 | x17 | ~x18) & (~x13 | x18);
  assign new_n71_ = (x19 | x20 | x21 | x22 | x23 | x24) & (~x24 | (~x19 & ~x20 & ~x21 & ~x22 & ~x23));
  assign z15 = x16 ? (x17 ? (~x18 & x25) : ~new_n73_) : ~new_n74_;
  assign new_n73_ = (~x25 | (new_n64_ & ~x22 & ~x23 & ~x24)) & (~new_n64_ | x24 | x25 | x22 | x23);
  assign new_n74_ = (~x06 | x17 | ~x18) & (~x14 | x18);
  assign z16 = x16 ? (x17 ? (~x18 & x26) : ~new_n76_) : ~new_n79_;
  assign new_n76_ = (~x26 | (new_n64_ & new_n78_)) & (~new_n65_ | ~new_n77_ | x25 | x26);
  assign new_n77_ = ~x23 & ~x24;
  assign new_n78_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n79_ = (~x07 | x17 | ~x18) & (~x15 | x18);
  assign z17 = (x17 & x18) | (~new_n81_ & x16);
  assign new_n81_ = (~new_n82_ | x20 | x21 | x17 | ~x19) & (~x17 | ~x27);
