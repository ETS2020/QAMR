...
module FAU ( 
  ...
  assign z12 = new_n67_ | (~new_n49_ & (x16 ? ~new_n65_ : ~new_n69_));
  assign new_n65_ = (~new_n66_ | x17) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign new_n66_ = ~x19 & ~x20 & ~x21 & ~x22 & (x23 | (~x23 & x24));
  assign new_n67_ = x16 & ~x17 & ~x19 & new_n68_ & ~x20;
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24 & (x25 | (~x25 & x26));
  assign new_n69_ = x18 ? ~x03 : ~x11;
  assign z13 = new_n67_ | (~new_n49_ & (x16 ? ~new_n71_ : ~new_n73_));
  assign new_n71_ = (~x23 | (~x17 & ~x19 & new_n72_ & ~x20)) & (x17 | x19 | x20 | ~new_n72_ | x23 | ~x24);
  assign new_n72_ = ~x21 & ~x22;
  assign new_n73_ = x18 ? ~x04 : ~x12;
  assign z14 = new_n67_ | (~new_n75_ & ~new_n49_);
  assign new_n75_ = x16 ? (new_n76_ | ~x24) : (x18 ? ~x05 : ~x13);
  assign new_n76_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z15 = (~x16 & (x18 ? x06 : x14)) | new_n49_ | (~new_n78_ & x16);
  assign new_n78_ = (x17 | x19 | ~new_n79_ | x20) & (~x25 | (~x17 & ~x19 & new_n72_ & ~x20));
  assign new_n79_ = ~x21 & ~x22 & (x23 ? x25 : (x24 ? x25 : (~x25 & x26)));
  assign z16 = ~new_n81_ | (~x16 & (x18 ? x07 : x15));
  assign new_n81_ = (x25 | x26) & (~x16 | ~x26 | (new_n82_ & (~new_n66_ | x17)));
  assign new_n82_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x25;
