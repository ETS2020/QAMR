...
module FAU ( 
  ...
  assign z10 = x16 ? ~new_n60_ : ((x01 & x18) | (x08 & x09 & ~x18));
  ...
  assign new_n76_ = (~new_n64_ | ~new_n78_) & (~x25 | (new_n63_ & new_n77_));
  ...
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & (x08 | x18);
  assign new_n83_ = (~x07 | ~x18) & (~x08 | ~x15 | x18);
