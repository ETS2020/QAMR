...
module FAU ( 
  ...
  assign z08 = ~x18 & x27;
  assign z09 = x16 ? (~new_n58_ & (~x18 | ~x27)) : ((x08 & ~x18) | (x00 & x18 & ~x27));
  assign new_n58_ = x17 ^ x19;
  assign z10 = x16 ? (~new_n60_ & (~x18 | ~x27)) : ((x09 & ~x18) | (x01 & x18 & ~x27));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n62_ & (~x18 | ~x27)) : ((x10 & ~x18) | (x02 & x18 & ~x27));
