...
module FAU ( 
  ...
  assign z15 = x16 ? (new_n72_ | new_n76_) : ~new_n75_;
  assign new_n72_ = (x10 | ~x18) & ((~new_n73_ & x25) | (new_n64_ & new_n74_));
  assign new_n73_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n74_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n75_ = (~x06 | ~x10 | ~x18) & (~x14 | x18);
  assign new_n76_ = x20 & x25 & (x10 | (~x10 & ~x18));
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n78_ & x16) | (~x10 & x18);
  assign new_n78_ = (~new_n64_ | ~new_n79_) & (~x26 | (new_n64_ & new_n74_));
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z17 = x16 & ~new_n81_ & (x10 | ~x18);
  assign new_n81_ = (~x17 | ~x27) & (~new_n79_ | x20 | x21 | x17 | ~x19);
endmodule
