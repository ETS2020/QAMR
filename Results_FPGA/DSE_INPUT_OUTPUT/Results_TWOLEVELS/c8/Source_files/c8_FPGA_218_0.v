...
module FAU ( 
  ...
  assign new_n67_ = x22 & ~new_n65_ & (x18 ? x16 : x11);
  assign new_n68_ = ~x17 & ~x19 & ~x20 & ~x21 & ~new_n49_ & ~x22;
  assign z13 = x16 ? (~new_n70_ & (x11 | x18)) : ((x04 & x18) | (x11 & x12 & ~x18));
  assign new_n70_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n72_ & (x11 | x18)) : ((x05 & x18) | (x11 & x13 & ~x18));
  assign new_n72_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z15 = (~new_n76_ & ~x16) | new_n49_ | ((new_n74_ | new_n75_) & x16);
  assign new_n74_ = x25 & (~new_n63_ | x23 | x24 | x21 | x22);
  assign new_n75_ = new_n65_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n76_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? (~new_n78_ & (x11 | x18)) : ((x07 & x18) | (x11 & x15 & ~x18));
  assign new_n78_ = (~x26 | (new_n65_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n65_ | x22 | x23 | x24 | x25 | x26);
  assign z17 = x16 & ~new_n80_ & ~new_n49_;
