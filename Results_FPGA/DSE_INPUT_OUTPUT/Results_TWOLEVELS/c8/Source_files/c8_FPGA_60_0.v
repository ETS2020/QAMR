// Benchmark "FAU" written by ABC on Fri Aug 21 20:16:50 2020
...
module FAU ( 
  ...
  assign z10 = x16 ? (((x17 | x19) & x20) | (~x17 & ~x19 & ~x20)) : (x01 | ~x18);
  assign z11 = x16 ? (new_n61_ | (~new_n60_ & x21)) : (x02 | ~x18);
