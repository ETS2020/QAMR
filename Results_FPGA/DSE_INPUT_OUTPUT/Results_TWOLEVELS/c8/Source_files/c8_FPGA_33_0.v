...
module FAU ( 
  ...
  assign z15 = x16 ? (~new_n72_ & (x15 | x18)) : ((x06 & x18) | (x14 & x15 & ~x18));
  assign new_n72_ = (~x25 | (new_n63_ & new_n74_)) & (~new_n64_ | ~new_n73_ | x24 | x25);
  assign new_n73_ = ~x22 & ~x23;
  assign new_n74_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z16 = (~x16 & (x18 ? x07 : x15)) | new_n76_ | (new_n79_ & x16);
  assign new_n76_ = x26 & ((~new_n77_ & (x18 ? x16 : x15)) | (new_n78_ & x16));
  assign new_n77_ = ~x20 & ~x23 & ~x17 & ~x19;
  assign new_n78_ = (x15 | x18) & (x21 | x22 | x24 | x25);
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n80_ & ~x22;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & (x15 | x18);
  assign z17 = (~new_n82_ & x16) | (~x15 & ~x18);
