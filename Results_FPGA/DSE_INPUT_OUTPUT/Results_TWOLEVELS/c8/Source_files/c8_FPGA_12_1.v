...
module FAU ( 
  ...
  assign z07 = (~x26 & ~x27) | (~x15 & (~x26 | (x18 & x27)));
  ...
  assign z15 = (~new_n76_ & ~x16) | new_n49_ | (x16 & (new_n73_ | (~new_n72_ & x25)));
  assign new_n72_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  ...
  assign z16 = x16 ? (new_n80_ | (~x17 & ~new_n78_ & ~x19)) : ~new_n81_;
  assign new_n78_ = (~x18 | ~x20 | ~x26) & (~new_n79_ | x20 | x21 | x22);
  assign new_n79_ = ~x25 & ~x26 & ~x23 & ~x24;
  assign new_n80_ = x18 & x26 & (~new_n75_ | x17 | x19 | x21);
  assign new_n81_ = (~x07 | ~x18) & (~x15 | x18 | x26);
  assign z17 = x16 & ((z08 & x17) | (new_n83_ & new_n74_ & ~x17 & x19));
