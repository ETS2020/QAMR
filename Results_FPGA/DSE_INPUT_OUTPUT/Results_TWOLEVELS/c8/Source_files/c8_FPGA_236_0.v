...
module FAU ( 
  ...
  assign z15 = x16 ? (~new_n49_ & (new_n75_ | (~new_n73_ & x25))) : ~new_n76_;
  ...
  assign z16 = x16 ? (new_n78_ | new_n79_) : ~new_n81_;
  assign new_n78_ = x26 & (((~new_n64_ | ~new_n74_) & (x14 | (~x14 & x18))) | ((x14 | x18) & x25));
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n80_ & ~x22;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & (x14 | x18) & ~x26;
  assign new_n81_ = (~x07 | ~x18) & (~x14 | ~x15 | x18);
