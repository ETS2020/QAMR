...
module FAU ( 
  ...
  assign z12 = x16 ? ~new_n65_ : ((x03 & x18) | (x11 & ~x18 & x25));
  assign new_n65_ = (~x22 | new_n49_ | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | new_n49_ | x22);
  assign z13 = x16 ? ~new_n67_ : ((x04 & x18) | (x12 & ~x18 & x25));
  ...
  assign new_n73_ = (~x05 | ~x18) & (~x13 | x18 | ~x25);
  ...
  assign z16 = (~new_n83_ & ~x16) | (new_n81_ & x16) | (~new_n79_ & ~x25);
