...
module FAU ( 
  ...
  assign z04 = (~x23 & (x25 | ~x27)) | (~x12 & x27);
  assign z05 = ~new_n49_ & (x27 ? ~x13 : ~x24);
  assign z06 = (~x25 & ~x27) | (~x14 & x27) | (~x23 & x25);
  ...
  assign new_n68_ = ~x23 & (x23 | x25);
  assign z13 = x16 ? ~new_n70_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n70_ = (x17 | x19 | x20 | new_n71_ | x21) & (~x23 | (~x20 & ~x21 & ~x17 & ~x19));
  assign new_n71_ = x22 ? ~x23 : (x23 | x25);
  assign z14 = x16 ? ~new_n73_ : (~new_n49_ & (x18 ? x05 : x13));
  assign new_n73_ = (~x24 | (~x23 & (new_n75_ | x25))) & (~new_n74_ | x22 | x23 | x24 | x25);
  assign new_n74_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n75_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z15 = (~new_n77_ & x16) | new_n49_ | (~x16 & (x18 ? x06 : x14));
  assign new_n77_ = ~x25 & (~new_n74_ | x24 | x25 | x22 | x23);
  assign z16 = (~x16 & (x18 ? x07 : x15)) | new_n79_ | (new_n82_ & x16);
  assign new_n79_ = ~x23 & (x25 | (new_n80_ & new_n81_));
  assign new_n80_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n81_ = ~x24 & ~x26 & ~x21 & ~x22;
  assign new_n82_ = x26 & (~new_n64_ | x23 | x24 | x21 | x22);
  assign z17 = new_n49_ | (~new_n84_ & x16);
  assign new_n84_ = (~new_n85_ | x17 | ~x19 | x20 | x21) & (~x17 | ~x27);
  assign new_n85_ = ~x24 & ~x26 & ~x22 & ~x23;
endmodule
