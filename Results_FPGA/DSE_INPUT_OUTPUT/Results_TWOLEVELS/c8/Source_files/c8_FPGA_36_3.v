...
module FAU ( 
  ...
  assign z01 = (~x14 | ~x18) & (x27 ? ~x09 : ~x20);
  assign z02 = (~x21 & ~x27) | (x14 & x18) | (~x10 & x27);
  assign z03 = (~x22 & ~x27) | (x14 & x18) | (~x11 & x27);
  assign z04 = (~x14 | ~x18) & (x27 ? ~x12 : ~x23);
  assign z05 = (~x14 | ~x18) & (x27 ? ~x13 : ~x24);
  assign z06 = (~x14 & (~x25 | x27)) | (~x18 & ~x25 & ~x27);
  ...
  assign z11 = x16 ? (~new_n62_ & (~x14 | ~x18)) : ((x02 & ~x14 & x18) | (x10 & ~x18));
  assign new_n62_ = ~new_n64_ & (new_n63_ | ~x21);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = x16 ? (~new_n66_ & (~x14 | ~x18)) : ((x03 & ~x14 & x18) | (x11 & ~x18));
