...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n59_, new_n61_, new_n63_, new_n65_, new_n66_, new_n67_, new_n69_,
  ...
  assign z13 = (~new_n65_ & ~x16) | (new_n67_ & x16) | (~x19 & (new_n66_ | x18));
  assign new_n65_ = x18 ? ~x04 : ~x12;
  assign new_n66_ = ~x21 & ~x22 & ~x23 & x16 & ~x17 & ~x20;
  assign new_n67_ = x23 & (x17 | x19 | x20 | x21 | x22);
  assign z14 = (~new_n71_ & ~x16) | (~new_n69_ & ~x19) | (x16 & ~new_n72_ & x24);
  assign new_n69_ = ~x18 & (~new_n70_ | ~x16 | x17 | x20);
  assign new_n70_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n71_ = x18 ? ~x05 : ~x13;
  assign new_n72_ = ~x21 & ~x22 & ~x23 & ~x17 & ~x19 & ~x20;
  ...
  assign z16 = (~new_n82_ & ~x16) | (~new_n79_ & ~x19) | (new_n81_ & x16);
  assign new_n79_ = ~x18 & (~new_n80_ | ~x16 | x17 | x20 | x21);
  assign new_n80_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n81_ = x26 & (~new_n75_ | x24 | x25 | x22 | x23);
  assign new_n82_ = x18 ? ~x07 : ~x15;
  assign z17 = (x18 & ~x19) | (~new_n84_ & x16);
