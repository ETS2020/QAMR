...
module FAU ( 
  ...
  assign z05 = (~x13 & (~x24 | x27)) | (~x24 & ~x26 & ~x27);
  ...
  assign z15 = ~new_n49_ & (x16 ? ~new_n75_ : (x18 ? x06 : x14));
  assign new_n75_ = (~x25 | (new_n64_ & new_n77_)) & (~new_n68_ | ~new_n76_ | x24 | x25);
  assign new_n76_ = ~x22 & ~x23;
  assign new_n77_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z16 = (~new_n83_ & ~x16) | (x13 & x26) | (x16 & (new_n79_ | (~new_n81_ & x26)));
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~new_n80_ & ~x21;
  assign new_n80_ = (x13 | ~x26 | (~x22 & (x22 | ~x23))) & (x22 | x23 | x24 | x25 | x26);
  assign new_n81_ = new_n82_ & (x13 | (~x21 & ~x24));
  assign new_n82_ = ~x20 & ~x25 & ~x17 & ~x19;
