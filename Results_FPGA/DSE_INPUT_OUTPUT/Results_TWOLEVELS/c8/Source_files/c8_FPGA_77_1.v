...
module FAU ( 
  ...
  assign z05 = (~x24 & ~x27 & (x13 | ~x26)) | (~x13 & ~x26 & x27);
  assign z06 = (~x25 & ~x27) | new_n49_ | (~x14 & x27);
  assign z07 = (~x26 & ~x27) | (~x15 & x27) | (~x13 & x26);
  ...
  assign z11 = (~new_n63_ & ~new_n49_) | (x16 & ~x17 & new_n65_ & ~x19);
  assign new_n63_ = x16 ? (new_n64_ | ~x21) : (x18 ? ~x02 : ~x10);
  assign new_n64_ = ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x20 & ~x21 & (~x26 | (x13 & (x22 ? x26 : (~x23 | (x23 & x26)))));
  assign z12 = (~new_n67_ & ~new_n49_) | (x16 & ~x17 & new_n69_ & ~x19);
  assign new_n67_ = x16 ? (new_n68_ | ~x22) : (x18 ? ~x03 : ~x11);
  assign new_n68_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n69_ = ~x20 & ~x21 & ~x22 & (~x26 | (x13 & (~x23 | (x23 & x26))));
  assign z13 = ~new_n49_ & (x16 ? ~new_n71_ : (x18 ? x04 : x12));
  assign new_n71_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~x13 & x26) | (~new_n73_ & x16);
  assign new_n73_ = (~x24 | (new_n64_ & ~x21 & ~x22 & ~x23)) & (~new_n64_ | x23 | x24 | x21 | x22);
  assign z15 = (new_n78_ & x16) | (~new_n49_ & (x16 ? ~new_n75_ : ~new_n77_));
  assign new_n75_ = (~x25 | (new_n76_ & ~x22 & ~x23 & ~x24)) & (~new_n68_ | x22 | x23 | x24 | x25);
  assign new_n76_ = ~x17 & ~x19 & ~x21;
  assign new_n77_ = x18 ? ~x06 : ~x14;
  assign new_n78_ = x20 & x25 & (x13 | (~x13 & ~x26));
  assign z16 = (~new_n83_ & ~x16) | (~x13 & x26) | (x16 & (new_n80_ | (~new_n82_ & x26)));
  assign new_n80_ = ~x17 & ~x19 & ~x20 & ~new_n81_ & ~x21;
  assign new_n81_ = (~x13 | ~x26 | (~x22 & (x22 | ~x23))) & (x22 | x23 | x24 | x25 | x26);
  assign new_n82_ = new_n64_ & ~x21 & ~x24 & (~x13 | ~x25);
