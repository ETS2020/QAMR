...
module FAU ( 
  ...
  assign z15 = (~new_n78_ & ~x16) | (~new_n75_ & x16) | (x23 & (~x18 | (x16 & x18 & x25)));
  ...
  assign new_n84_ = (~x07 | ~x18) & (~x15 | x18 | x23);
  assign z17 = x16 & (new_n86_ | (x17 & ~new_n49_ & x27));
  assign new_n86_ = new_n87_ & ~x17 & x19 & ~x20 & ~x21;
