...
module FAU ( 
  ...
  assign z00 = (x27 ? ~x08 : ~x19) & (x02 | x18);
  assign z01 = (~x20 & ~x27) | (~x09 & x27) | (~x02 & ~x18);
  assign z02 = (x27 ? ~x10 : ~x21) & (x02 | x18);
  assign z03 = (x27 ? ~x11 : ~x22) & (x02 | x18);
  assign z04 = (x27 ? ~x12 : ~x23) & (x02 | x18);
  assign z05 = (~x24 & ~x27) | (~x13 & x27) | (~x02 & ~x18);
  assign z06 = (~x25 & ~x27) | (~x14 & x27) | (~x02 & ~x18);
  assign z07 = (x27 ? ~x15 : ~x26) & (x02 | x18);
  assign z08 = x27 | (~x02 & ~x18);
  assign z09 = x16 ? (~new_n58_ & (x02 | x18)) : ((x00 & x18) | (x02 & x08 & ~x18));
  assign new_n58_ = ~x17 ^ ~x19;
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x02 & ~x18) | (~new_n60_ & x16);
  ...
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n70_ & x16) | (~x02 & ~x18);
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z15 = (~new_n74_ & ~x16) | (~x02 & ~x18) | (x16 & (new_n72_ | new_n73_));
