// Benchmark "FAU" written by ABC on Fri Aug 21 20:16:57 2020
...
module FAU ( 
  ...
  assign z01 = (~x20 & ~x27) | (~x09 & x27) | (~x10 & ~x18);
  ...
  assign z06 = (x10 | x18) & (x27 ? ~x14 : ~x25);
  assign z07 = (x10 | x18) & (x27 ? ~x15 : ~x26);
  assign z08 = x27 & (x10 | (~x10 & x18));
  assign z09 = (~new_n58_ & x16) | (~x10 & ~x18) | (~x16 & (x18 ? x00 : x08));
  assign new_n58_ = x17 ^ x19;
  assign z10 = x16 ? (~new_n60_ & (x10 | x18)) : ((x01 & x18) | (x09 & x10 & ~x18));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = ~new_n62_ | (~x16 & (x18 ? x02 : x10));
  assign new_n62_ = (~x21 | new_n63_ | (x18 ? ~x16 : ~x10)) & (~new_n64_ | ~x16);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x17 & ~x19 & ~x20 & (x10 | x18) & ~x21;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~new_n66_ & x16) | (~x10 & ~x18);
  assign new_n66_ = (~x22 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~new_n68_ & x16) | (~x10 & ~x18);
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (~x16 & (x18 ? x05 : x13)) | (~new_n70_ & x16) | (~x10 & ~x18);
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x23 | x24 | x21 | x22);
  assign z15 = x16 ? ((x10 | x18) & (new_n72_ | new_n73_)) : ~new_n75_;
  assign new_n72_ = x25 & (~new_n63_ | x23 | x24 | x21 | x22);
  assign new_n73_ = new_n74_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n74_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n75_ = (~x06 | ~x18) & (~x10 | ~x14 | x18);
  assign z16 = (~x16 & (x18 ? x07 : x15)) | (~new_n77_ & x16) | (~x10 & ~x18);
  assign new_n77_ = (~x26 | (new_n74_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n74_ | x22 | x23 | x24 | x25 | x26);
  assign z17 = x16 & ~new_n79_ & (x10 | x18);
