// Benchmark "FAU" written by ABC on Fri Aug 21 20:16:29 2020
...
module FAU ( 
  ...
  assign new_n69_ = (x23 | (x18 & (~new_n71_ | x20 | ~new_n70_ | ~x16))) & (~x16 | ~x23 | (new_n70_ & new_n71_ & ~x20));
  assign new_n70_ = ~x17 & ~x19;
  assign new_n71_ = ~x21 & ~x22;
  assign z14 = x16 ? ~new_n73_ : ((x05 & x18) | (x13 & ~x18 & x23));
  assign new_n73_ = (~x18 | ((new_n67_ | ~x24) & (~new_n63_ | ~new_n71_ | x23 | x24))) & (~x23 | ~x24);
  assign z15 = (~x16 & (x18 ? x06 : x14)) | new_n75_ | (new_n77_ & x16);
  assign new_n75_ = ~x23 & (~x18 | (new_n76_ & new_n71_ & ~x24 & ~x25));
  assign new_n76_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n77_ = x25 & (~new_n63_ | ~new_n71_ | x23 | x24);
  assign z16 = (~x16 & (x18 ? x07 : x15)) | new_n79_ | (new_n81_ & x16);
  assign new_n79_ = ~x23 & (~x18 | (new_n76_ & new_n80_));
  assign new_n80_ = ~x21 & ~x22 & ~x24 & ~x25 & ~x26;
  assign new_n81_ = x26 & (~new_n64_ | x24 | x25 | x22 | x23);
