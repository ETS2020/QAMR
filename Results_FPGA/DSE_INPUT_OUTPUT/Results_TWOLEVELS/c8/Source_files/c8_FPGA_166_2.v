...
module FAU ( 
  ...
  assign z09 = x16 ? ~new_n58_ : ((x08 & ~x18) | (x00 & x18 & x22));
  ...
  assign z15 = (~new_n77_ & ~x16) | (~new_n74_ & ~x22) | (new_n76_ & x16);
  assign new_n74_ = ~x18 & (~new_n75_ | x21 | x23 | x24 | x25);
  assign new_n75_ = x16 & ~x17 & ~x19 & ~x20;
  assign new_n76_ = x25 & (~new_n63_ | x23 | x24 | x21 | x22);
