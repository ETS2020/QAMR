...
module FAU ( 
  ...
  assign z10 = (~x16 & (x01 | ~x18)) | (~new_n61_ & x16) | (~x09 & ~x18);
  ...
  assign new_n69_ = (~x03 | ~x18) & (~x09 | ~x11 | x18);
  assign z13 = x16 ? ~new_n71_ : ((x04 & x18) | (x09 & x12 & ~x18));
  ...
  assign new_n77_ = (~x05 | ~x18) & (~x09 | ~x13 | x18);
  ...
  assign new_n82_ = (~x06 | ~x18) & (~x09 | ~x14 | x18);
