...
module FAU ( 
  ...
  assign new_n76_ = (~x05 | ~x18) & (~x13 | x18 | ~x24);
  assign z15 = x16 ? ~new_n78_ : ((x06 & x18) | (x14 & ~x18 & x24));
  assign new_n78_ = (~x18 | ((new_n79_ | ~x25) & (~new_n65_ | ~new_n75_ | x24 | x25))) & (~x24 | ~x25);
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z16 = (~new_n84_ & ~x16) | (new_n83_ & x16) | (~new_n81_ & ~x24);
