...
module FAU ( 
  ...
  assign new_n61_ = (~x19 | (~x18 & (~x16 | ~x21))) & (~x16 | ((~x21 | (~x17 & ~x20)) & (x17 | x19 | x20 | x21)));
  ...
  assign z13 = (~new_n69_ & ~x16) | (x19 & (x18 | (x16 & x23))) | (~new_n67_ & x16);
  assign new_n67_ = (new_n65_ | ~x23) & (~new_n68_ | x21 | x22 | x23);
  assign new_n68_ = ~x17 & ~x19 & ~x20;
  assign new_n69_ = x18 ? ~x04 : ~x12;
  assign z14 = (~new_n73_ & ~x16) | (x19 & (x18 | (x16 & x24))) | (~new_n71_ & x16);
  assign new_n71_ = (~x24 | (new_n72_ & ~x21 & ~x22 & ~x23)) & (~new_n68_ | x21 | x22 | x23 | x24);
  assign new_n72_ = ~x17 & ~x20;
  assign new_n73_ = x18 ? ~x05 : ~x13;
  assign z15 = (~new_n77_ & ~x16) | (x19 & (x18 | (x16 & x25))) | (~new_n75_ & x16);
  assign new_n75_ = (~x25 | (new_n64_ & ~x22 & ~x23 & ~x24)) & (~new_n76_ | x22 | x23 | x24 | x25);
  assign new_n76_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n77_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((~new_n79_ & ~x19) | (~x18 & x19 & x26)) : ~new_n82_;
  assign new_n79_ = (~x26 | (new_n64_ & new_n81_)) & (~new_n65_ | ~new_n80_ | x25 | x26);
  assign new_n80_ = ~x23 & ~x24;
  assign new_n81_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n82_ = (~x15 | x18) & (~x07 | ~x18 | x19);
