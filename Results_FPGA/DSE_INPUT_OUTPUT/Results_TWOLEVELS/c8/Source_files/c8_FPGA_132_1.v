...
module FAU ( 
  ...
  assign z05 = (~x24 & ~x27) | (~x15 & x18) | (~x13 & x27);
  assign z06 = (~x25 & ~x27) | (~x15 & x18) | (~x14 & x27);
  assign z07 = (~x15 & (x18 | (~x18 & x27))) | (~x26 & ~x27);
  assign z08 = x27 & (x15 | (~x15 & ~x18));
  ...
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~new_n66_ & x16) | (~x15 & x18);
