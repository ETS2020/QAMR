...
module FAU ( 
  ...
  assign z10 = x16 ? ~new_n61_ : ((x01 & x18) | (x09 & ~x18 & ~x26));
  assign new_n61_ = (~x20 | (~x18 & x26) | (~x17 & ~x19)) & (x17 | x19 | x20 | (x26 & (~x18 | (x21 & (~x21 | ~x26)))));
  assign z11 = x16 ? (~new_n63_ & (x18 | ~x26)) : ((x02 & x18) | (x10 & ~x18 & ~x26));
  ...
  assign new_n72_ = (~x04 | ~x18) & (~x12 | x18 | x26);
  assign z14 = x16 ? (~new_n74_ & (x18 | ~x26)) : ((x05 & x18) | (x13 & ~x18 & ~x26));
  ...
  assign new_n87_ = new_n88_ & ~x17 & x19 & ~x20 & ~x21;
