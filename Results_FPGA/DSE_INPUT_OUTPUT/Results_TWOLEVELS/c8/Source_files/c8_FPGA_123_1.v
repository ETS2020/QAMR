...
module FAU ( 
  ...
  assign new_n70_ = x24 & (~new_n66_ | x17 | ~new_n71_ | x21);
  assign new_n71_ = ~x22 & ~x23;
  assign z15 = x16 ? ((x17 & x25) | (~new_n73_ & ~x18)) : ~new_n76_;
  ...
  assign new_n76_ = (~x14 | x18) & (~x06 | ~x17 | ~x18);
  assign z16 = x16 ? ((x17 & x26) | (~new_n78_ & ~x18)) : ~new_n79_;
  assign new_n78_ = (~x26 | (new_n75_ & new_n71_ & ~x24 & ~x25)) & (~new_n74_ | ~new_n71_ | x24 | x25 | x26);
  assign new_n79_ = (~x15 | x18) & (~x07 | ~x17 | ~x18);
  assign z17 = (~new_n81_ & x16) | (~x17 & x18);
