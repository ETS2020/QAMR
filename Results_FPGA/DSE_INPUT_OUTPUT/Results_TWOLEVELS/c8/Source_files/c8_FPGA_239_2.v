...
module FAU ( 
  ...
  assign new_n66_ = (~x23 | (new_n67_ & ~x21 & ~x22)) & (~new_n67_ | x17 | x21 | x22 | x23);
  assign new_n67_ = ~x19 & ~x20;
  assign new_n68_ = x18 ? ~x04 : ~x12;
  assign z14 = (~new_n71_ & ~x16) | (x17 & (~x18 | (x16 & x24))) | (~new_n70_ & x16);
  assign new_n70_ = (~x24 | (new_n67_ & ~x21 & ~x22 & ~x23)) & (~new_n67_ | x17 | x23 | x24 | x21 | x22);
  assign new_n71_ = x18 ? ~x05 : ~x13;
  assign z15 = (~new_n76_ & ~x16) | (x17 & (~x18 | (x16 & x25))) | (~new_n73_ & x16);
  assign new_n73_ = (~x25 | (new_n74_ & ~x22 & ~x23 & ~x24)) & (~new_n75_ | x24 | x25 | x22 | x23);
