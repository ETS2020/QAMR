...
module FAU ( 
  ...
  assign z10 = (~new_n61_ & ~x16) | (x20 & x21) | (x16 & ((~x17 & ~x19 & (x21 | (~x20 & ~x21))) | ((x17 | x19) & x20)));
  assign new_n61_ = x18 ? ~x01 : ~x09;
  assign z11 = x16 ? (~x20 & (((x17 | x19) & x21) | (~x17 & ~x19 & ~x21))) : (~new_n63_ & (~x20 | ~x21));
  assign new_n63_ = x18 ? ~x02 : ~x10;
  assign z12 = ~new_n65_ | (~x16 & (x18 ? x03 : x11));
  assign new_n65_ = (~x20 | (~x21 & (~x16 | ~x22))) & (~x16 | ((~x22 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x20 | x21 | x22)));
  assign z13 = x16 ? ~new_n67_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n67_ = (x20 | ((~x21 | ~x23) & (~new_n68_ | x21 | x22 | x23))) & (x21 | ~x23 | (new_n68_ & ~x20 & ~x22));
  assign new_n68_ = ~x17 & ~x19;
  assign z14 = (~new_n72_ & ~x16) | (x20 & (x21 | (x16 & x24))) | (~new_n70_ & x16);
  ...
  assign new_n74_ = (x20 | ((~new_n75_ | ~new_n76_) & (~x21 | ~x25))) & (x21 | new_n77_ | ~x25);
  assign new_n75_ = ~x17 & ~x19 & ~x21;
  assign new_n76_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x17 & ~x19 & ~x20;
  assign z16 = (~new_n82_ & ~x16) | (x20 & (x21 | (x16 & x26))) | (~new_n79_ & x16);
  assign new_n79_ = ((new_n75_ & new_n76_) | ~x26) & (~new_n80_ | ~new_n81_);
  assign new_n80_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n81_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n82_ = x18 ? ~x07 : ~x15;
  assign z17 = ~new_n84_ & x16;
  assign new_n84_ = (~x17 | (x20 & x21) | ~x27) & (~new_n81_ | x20 | x21 | x17 | ~x19);
endmodule
