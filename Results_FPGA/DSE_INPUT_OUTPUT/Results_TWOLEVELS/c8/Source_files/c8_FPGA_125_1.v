...
module FAU ( 
  ...
  assign z06 = (~x25 & ~x27) | (~x14 & (x18 | (~x18 & x27)));
  assign z07 = (~x26 & ~x27) | new_n49_ | (~x15 & x27);
  assign z08 = x27 & (x14 | (~x14 & ~x18));
  assign z09 = x16 ? (~new_n59_ & (x14 | ~x18)) : ((x00 & x14 & x18) | (x08 & ~x18));
  assign new_n59_ = ~x17 ^ ~x19;
  assign z10 = x16 ? (~new_n61_ & (x14 | ~x18)) : ((x01 & x14 & x18) | (x09 & ~x18));
  assign new_n61_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n63_ & (x14 | ~x18)) : ((x02 & x14 & x18) | (x10 & ~x18));
  assign new_n63_ = ~new_n65_ & (new_n64_ | ~x21);
  assign new_n64_ = ~x17 & ~x19 & ~x20;
  assign new_n65_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = (~x16 & (x18 ? x03 : x11)) | (~x14 & x18) | (~new_n67_ & x16);
  assign new_n67_ = (~x22 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~x14 & x18) | (~new_n69_ & x16);
  assign new_n69_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n71_ & (x14 | ~x18)) : ((x05 & x14 & x18) | (x13 & ~x18));
  assign new_n71_ = (~x24 | (new_n64_ & ~x21 & ~x22 & ~x23)) & (~new_n64_ | x21 | x22 | x23 | x24);
  assign z15 = (x14 & (x16 ? ~new_n73_ : (x06 | ~x18))) | (x16 & ~new_n73_ & ~x18);
  assign new_n73_ = (~x25 | (new_n64_ & new_n75_)) & (~new_n65_ | ~new_n74_ | x24 | x25);
  assign new_n74_ = ~x22 & ~x23;
  assign new_n75_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z16 = x16 ? (new_n77_ | new_n81_) : ~new_n80_;
  assign new_n77_ = ~new_n49_ & ((x26 & (~new_n64_ | ~new_n78_)) | (new_n65_ & new_n79_));
  assign new_n78_ = ~x23 & ~x25 & ~x21 & ~x22;
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n80_ = (~x07 | ~x14 | ~x18) & (~x15 | x18);
  assign new_n81_ = x24 & x26 & (x14 | (~x14 & ~x18));
  assign z17 = new_n49_ | (~new_n83_ & x16);
  assign new_n83_ = (~x17 | ~x27) & (~new_n79_ | x20 | x21 | x17 | ~x19);
endmodule
