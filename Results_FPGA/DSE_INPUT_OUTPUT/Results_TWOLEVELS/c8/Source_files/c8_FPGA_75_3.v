...
module FAU ( 
  ...
  assign new_n74_ = (x23 | ((~x24 | ~x25) & (~new_n63_ | x21 | x22 | x24 | x25))) & (x24 | ~x25 | (new_n63_ & ~x21 & ~x22 & ~x23));
  assign z16 = x16 ? ((~new_n76_ & ~x23) | (new_n77_ & ~x24)) : (~new_n78_ & (~x23 | ~x24));
  assign new_n76_ = (~x24 | ~x26) & (~new_n65_ | x25 | x26 | x22 | x24);
  assign new_n77_ = x26 & (~new_n63_ | x23 | x25 | x21 | x22);
