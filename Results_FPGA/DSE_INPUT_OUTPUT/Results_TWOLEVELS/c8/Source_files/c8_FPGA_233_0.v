...
module FAU ( 
  ...
  assign new_n61_ = (~x01 | ~x18) & (~x09 | x18 | ~x25);
  assign z11 = x16 ? ~new_n63_ : ((x02 & x18) | (x10 & ~x18 & x25));
  ...
  assign z13 = x16 ? ~new_n69_ : ((x04 & x18) | (x12 & ~x18 & x25));
  assign new_n69_ = (new_n49_ | new_n67_ | ~x23) & (x17 | ~new_n70_ | x19);
  ...
  assign new_n76_ = (~x05 | ~x18) & (~x13 | x18 | ~x25);
  assign z15 = x16 ? ~new_n78_ : ((x06 & x18) | (x14 & ~x18 & x25));
  assign new_n78_ = (x17 | x19 | new_n79_ | x20) & (~x25 | (~x17 & ~x19 & ~x20));
  ...
  assign new_n84_ = (~x07 | ~x18) & (~x15 | x18 | ~x25);
