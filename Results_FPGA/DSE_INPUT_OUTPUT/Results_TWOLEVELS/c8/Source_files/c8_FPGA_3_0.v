...
module FAU ( 
  ...
  assign z13 = (~new_n67_ & ~x16) | (new_n68_ & x16) | ((new_n65_ | ~x18) & ~x19);
  ...
  assign new_n70_ = (~x18 | ((~new_n71_ | ~new_n73_) & (new_n72_ | ~x24))) & (~x19 | ~x24);
  assign new_n71_ = ~x17 & ~x19 & ~x20;
  assign new_n72_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n73_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z15 = x16 ? ((~new_n75_ & x18) | (x19 & x25)) : ~new_n78_;
  ...
  assign new_n78_ = (~x06 | ~x18) & (~x14 | x18 | ~x19);
  assign z16 = x16 ? ((~new_n80_ & x18) | (x19 & x26)) : ~new_n81_;
