...
module FAU ( 
  ...
  assign z05 = (~x24 & ~x27) | (x10 & ~x18) | (~x13 & x27);
  ...
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~new_n60_ & x16) | (x10 & ~x18);
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = (~new_n62_ & x16) | (x10 & ~x18) | (x02 & ~x16 & x18);
