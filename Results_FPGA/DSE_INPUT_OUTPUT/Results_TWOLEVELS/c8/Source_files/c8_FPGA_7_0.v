...
module FAU ( 
  ...
  assign new_n72_ = (~x05 | ~x18) & (~x13 | x18 | ~x26);
  ...
  assign new_n77_ = (~x06 | ~x18) & (~x14 | x18 | ~x26);
  ...
  assign new_n81_ = new_n82_ & ~x19 & ~x20 & ~x21 & ~x17 & x18;
  assign new_n82_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n83_ = (~x07 | ~x18) & (~x15 | x18 | ~x26);
