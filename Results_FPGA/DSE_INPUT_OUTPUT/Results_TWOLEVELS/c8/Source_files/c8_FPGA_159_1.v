...
module FAU ( 
  ...
  assign z01 = (~x20 & ~x27) | (~x09 & (x18 | (~x18 & x27)));
  ...
  assign z10 = (~x16 & (x18 ? x01 : x09)) | (~x09 & x18) | (~new_n61_ & x16);
  ...
  assign new_n67_ = ~new_n68_ & (new_n49_ | (~x20 & ~x21));
  assign new_n68_ = (x09 | (~x09 & ~x18)) & (x17 | x19);
  assign new_n69_ = ~x19 & ~x20 & ~x21 & ~new_n49_ & ~x22;
  assign new_n70_ = (~x03 | ~x09 | ~x18) & (~x11 | x18);
  assign z13 = (~x16 & (x18 ? x04 : x12)) | (~x09 & x18) | (~new_n72_ & x16);
  assign new_n72_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (new_n74_ | (~x17 & new_n76_ & ~x19)) : ~new_n77_;
  assign new_n74_ = x24 & (new_n68_ | (~new_n49_ & (~new_n75_ | x20 | x21)));
  assign new_n75_ = ~x22 & ~x23;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & ~x23 & ~new_n49_ & ~x24;
  assign new_n77_ = (~x05 | ~x09 | ~x18) & (~x13 | x18);
  assign z15 = (~x16 & (x18 ? x06 : x14)) | (~x09 & x18) | (~new_n79_ & x16);
  assign new_n79_ = (~x25 | (new_n63_ & new_n80_)) & (~new_n65_ | ~new_n75_ | x24 | x25);
  assign new_n80_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z16 = x16 ? (new_n84_ | (~new_n82_ & x26)) : ~new_n86_;
  assign new_n82_ = ~new_n68_ & (new_n49_ | new_n83_);
  assign new_n83_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n84_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n85_ & ~x22;
  assign new_n85_ = ~x23 & ~x24 & ~x25 & (x09 | ~x18) & ~x26;
  assign new_n86_ = (~x07 | ~x09 | ~x18) & (~x15 | x18);
  assign z17 = x16 & ~new_n88_ & ~new_n49_;
