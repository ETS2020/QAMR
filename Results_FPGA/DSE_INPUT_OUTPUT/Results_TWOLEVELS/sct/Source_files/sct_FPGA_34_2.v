...
module FAU ( 
  ...
  assign new_n46_ = (x07 | (~x00 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | (~new_n48_ & x07) | (~x00 & ~x07 & x11);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~new_n50_ & x07) | (~x00 & ~x07 & x12);
  assign new_n50_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = new_n44_ | (x07 & (new_n52_ | (~new_n54_ & x13))) | (~x00 & ~x07 & x13);
  ...
  assign new_n56_ = (~x06 | ~x08 | x09 | new_n40_ | new_n57_) & (~new_n40_ | ~x14);
