...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~x08 & (x09 | x18)) | (x09 & (~x06 | ~x07)) | (x06 & x07 & x08 & ~x09);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = x08 ? ((~x10 | (x06 & x07 & ~x09)) & (~x06 | ~x07 | x09 | x10)) : (~x10 | x18);
  assign z07 = new_n44_ | (~new_n48_ & x08) | (~x08 & x11 & ~x18);
  ...
  assign new_n54_ = (x08 | (~x13 & ~x18)) & (new_n55_ | ~x13);
