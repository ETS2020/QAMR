...
module FAU ( 
  ...
  assign new_n46_ = (~x06 | ((x07 | ~x11) & (~x07 | ~x08 | x09 | x10 | x11))) & (~x07 | ~x11 | (~x09 & ~x10 & x06 & x08));
  assign z08 = new_n43_ | (x06 & (new_n48_ | (~x07 & x12))) | (x07 & ~new_n49_ & x12);
  assign new_n48_ = ~x10 & ~x11 & ~x12 & x07 & x08 & ~x09;
  ...
  assign new_n53_ = (new_n48_ | ~x13) & (x06 | (x07 & ~x13));
  assign z10 = x04 & ((x06 & (new_n57_ | (x07 & new_n55_ & x08))) | (new_n57_ & x07));
