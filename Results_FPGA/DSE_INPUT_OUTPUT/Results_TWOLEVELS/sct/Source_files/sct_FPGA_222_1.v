...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n43_, new_n45_, new_n46_, new_n48_, new_n50_, new_n52_,
  ...
  assign z03 = (~x07 & x11) | (x04 & ~new_n39_ & (x06 ^ x07));
  ...
  assign z06 = new_n43_ | (~x07 & (x10 | x11)) | new_n46_ | (~new_n45_ & x10);
  assign new_n45_ = x06 & x08 & ~x09;
  assign new_n46_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = new_n43_ | new_n48_;
  assign new_n48_ = x07 & ((x11 & (x09 | x10 | ~x06 | ~x08)) | (x06 & x08 & ~x09 & ~x10 & ~x11));
  assign z08 = new_n43_ | (x07 & (new_n50_ | (x11 & x12))) | (~x11 & ~new_n46_ & x12);
  ...
  assign new_n54_ = (x07 | (~x11 & ~x13)) & (~x13 | (new_n45_ & ~x10 & ~x11 & ~x12));
  assign z10 = (~x07 & x11) | (x04 & (new_n56_ | (new_n39_ & x14)));
  assign new_n56_ = x06 & x07 & x08 & ~x09 & ~new_n39_ & ~new_n57_;
  assign new_n57_ = ~x00 & (x12 | x13 | x10 | x11);
  assign z11 = x02 & (x07 | ~x11);
  assign z12 = (~x07 & x11) | (x04 & (x03 | (~x02 & x16 & (x07 | ~x11))));
