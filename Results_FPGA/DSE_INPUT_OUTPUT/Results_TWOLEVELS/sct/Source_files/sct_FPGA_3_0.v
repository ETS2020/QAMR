...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n40_ & (x06 ? (~x07 & x18) : x07);
  ...
  assign new_n45_ = ~new_n46_ & (x07 | (~x09 & x18)) & (~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign new_n46_ = x03 & x16 & (x07 | (x04 & x18));
  assign z06 = new_n44_ | new_n46_ | ~new_n48_;
  assign new_n48_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10)) : (~x10 | ~x18);
  ...
  assign z09 = new_n44_ | new_n46_ | ~new_n58_ | (new_n56_ & x04);
  assign new_n56_ = x06 & x07 & x08 & ~x09 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = (x07 | (~x13 & x18)) & (new_n59_ | ~x13);
