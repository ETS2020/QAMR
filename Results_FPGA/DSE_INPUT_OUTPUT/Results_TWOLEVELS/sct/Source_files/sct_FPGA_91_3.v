...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & ~x17 & (~x06 | ~x07 | ~x08)) | (x08 & ~x09 & x06 & x07);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x09 | (~x10 & ~x17)) & (~x10 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | ~new_n48_ | (x09 & (x11 | x17));
  assign new_n48_ = (~x11 | (x06 & x07 & x08 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~new_n50_ & ~x09) | (x09 & x12 & ~x17);
  assign new_n50_ = (~x06 | ~x07 | ~x08 | x10 | x11 | x12) & (~x12 | (x06 & x07 & x08 & ~x10 & ~x11));
  ...
  assign new_n54_ = (~x09 | (~x13 & ~x17)) & (new_n55_ | ~x13);
