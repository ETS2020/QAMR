...
module FAU ( 
  ...
  assign new_n46_ = x08 & ~x09 & (~x12 | (~x18 & (x10 ? x12 : (~x11 | (x11 & x12)))));
  assign z06 = (~new_n37_ & (new_n45_ | ~new_n48_)) | (x06 & new_n49_ & x07);
  assign new_n48_ = x04 & (~x10 | (x08 & ~x09 & x06 & x07));
  assign new_n49_ = x08 & ~x09 & ~x10 & (~x12 | (~x18 & (~x11 | (x11 & x12))));
  assign z07 = ~new_n37_ & (new_n45_ | new_n51_ | new_n52_ | ~x04);
  assign new_n51_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n54_ | (~new_n37_ & (new_n45_ | ~x04));
  assign new_n54_ = (~x06 | ~new_n55_ | ~x07) & (~x12 | (new_n56_ & x06 & x07));
  assign new_n55_ = x08 & ~x09 & (x10 ? (x12 & ~x18) : (x11 ? (x12 & ~x18) : ~x12));
  assign new_n56_ = x08 & ~x09 & ~x18;
  assign z09 = (~new_n37_ & (new_n45_ | ~x04)) | ~new_n60_ | (new_n58_ & x04);
  assign new_n58_ = x06 & x07 & x08 & ~x09 & new_n59_ & ~x10;
  assign new_n59_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n60_ = (new_n52_ | ~x13) & (~x12 | (~x13 & ~x18));
  assign z10 = x04 & (new_n58_ | (~new_n37_ & (new_n62_ | (new_n40_ & x14))));
