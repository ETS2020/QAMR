...
module FAU ( 
  ...
  assign z06 = (~x04 & (~x02 | x07)) | (~x02 & ((~x07 & x10) | (x04 & x16))) | (~new_n46_ & x07);
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n44_ & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x02 & (~x04 | (x04 & x16))) | ~new_n48_ | (~x07 & (x02 | x11));
  assign new_n48_ = ~new_n50_ & (~x07 | (x04 & ~new_n44_ & ~new_n49_));
  assign new_n49_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n50_ = x11 & (~x06 | ~x08 | x09 | x10);
  assign z08 = (~x04 & (~x02 | x07)) | (~x02 & ((~x07 & x12) | (x04 & x16))) | (~new_n52_ & x07);
  assign new_n52_ = (new_n49_ | ~x12) & ~new_n44_ & ~new_n53_;
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (~x02 | x07)) | (~new_n58_ & ~x02) | (x07 & (~new_n57_ | (new_n55_ & x04)));
  assign new_n55_ = x06 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = ~new_n44_ & (new_n53_ | ~x13);
  assign new_n58_ = (x07 | ~x13) & (~x04 | ~x16);
  assign z10 = (x02 & ~x07) | (x04 & (new_n62_ | (new_n60_ & x06)));
  assign new_n60_ = x08 & ~x09 & (new_n61_ | (x07 & new_n56_ & ~x10));
  assign new_n61_ = x00 & ((x02 & ~x03) | (x07 & ~x16));
