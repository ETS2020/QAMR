...
module FAU ( 
  ...
  assign z05 = (~new_n42_ & x04) | (x09 & (~x06 | ~x08)) | ~x04 | new_n43_ | (x06 & x08 & ~x09);
  assign new_n42_ = x07 & (x02 | ~x07 | ~x16);
  assign new_n43_ = x03 & x07 & x16;
  assign z06 = ~x04 | (x07 & (~new_n45_ | (x16 & (x03 | (~x02 & x04)))));
  ...
  assign z08 = (~new_n42_ & x04) | new_n49_ | ~x04 | new_n43_ | new_n50_;
  ...
  assign new_n54_ = (new_n50_ | ~x13) & (~x03 | ~x16);
  assign z10 = x04 & ((new_n56_ & x06) | ~x07 | (new_n39_ & x14));
  assign new_n56_ = x08 & ~x09 & ~new_n39_ & ~new_n57_;
  assign new_n57_ = ~x00 & (~x07 | x10 | x11 | x12 | x13);
  assign z11 = x02 | (x04 & ~x07);
  assign z12 = x04 & (~new_n42_ | x03);
  assign z13 = x04 & x07;
  assign z14 = z13 & x17;
  assign z03 = z02;
endmodule
