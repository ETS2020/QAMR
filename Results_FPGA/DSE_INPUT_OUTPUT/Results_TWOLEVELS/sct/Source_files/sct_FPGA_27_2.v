...
module FAU ( 
  ...
  assign new_n46_ = (~x06 | (x07 & (~x08 | x09 | x10 | x11))) & (~x11 | (~x09 & ~x10 & x06 & x08));
  ...
  assign new_n54_ = (~x06 | ~x08 | x09 | new_n39_ | new_n55_) & (~new_n39_ | ~x14);
  assign new_n55_ = ~x00 & (x12 | x13 | x10 | x11);
  assign z11 = x02 | (x06 & ~x07);
  assign z12 = x04 & (~x06 | x07) & (x03 | (~x02 & x16));
  assign z13 = x04 & (x07 | (~x06 & (x03 | (x02 & ~x03) | ~x16 | (~x02 & x16))));
