...
module FAU ( 
  ...
  assign z05 = new_n46_ | (~new_n44_ & ~new_n38_);
  ...
  assign z06 = new_n46_ | (~new_n38_ & (new_n48_ | ~x04 | new_n45_ | new_n49_));
  assign new_n48_ = x10 & (~x06 | ~x07 | ~x08 | x09);
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = (~new_n38_ & (new_n45_ | ~x04)) | new_n46_ | new_n51_ | new_n52_ | new_n38_;
  assign new_n51_ = ~new_n49_ & x11;
  assign new_n52_ = new_n53_ & ~x09 & ~x10 & ~x11;
  assign new_n53_ = x06 & x07 & x08;
  assign z08 = new_n46_ | (~new_n38_ & ((~new_n52_ & x12) | ~new_n55_ | ~x04));
  assign new_n55_ = ~new_n45_ & (~new_n53_ | x09 | x10 | x11 | x12);
  assign z09 = (~new_n38_ & (new_n45_ | ~x04)) | new_n46_ | new_n59_ | new_n38_ | (new_n57_ & x04);
  assign new_n57_ = x06 & x07 & x08 & ~x09 & new_n58_ & ~x10;
  assign new_n58_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n59_ = x13 & (~new_n53_ | x11 | x12 | x09 | x10);
