...
module FAU ( 
  ...
  assign new_n50_ = ~new_n51_ & ~new_n45_ & ~new_n52_;
  assign new_n51_ = x11 & (~x06 | ~x08 | x09 | x10);
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x02 & (~x04 | (x04 & x16))) | ~new_n54_ | (x07 & (new_n56_ | x02));
  assign new_n54_ = (x07 | (x04 & ~new_n46_ & ~x12)) & (new_n55_ | ~x12);
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n56_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~new_n58_ & ~x02) | (~x07 & (~x04 | new_n46_ | x13));
  assign new_n58_ = (~x04 | (~x16 & (~new_n44_ | ~new_n59_))) & x04 & (new_n56_ | ~x13);
