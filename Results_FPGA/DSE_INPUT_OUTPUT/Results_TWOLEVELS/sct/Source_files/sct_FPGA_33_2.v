...
module FAU ( 
  ...
  assign new_n47_ = x07 & (~x14 | (x06 & x08 & new_n48_ & ~x09));
  assign new_n48_ = ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n43_ | (~new_n47_ & x12) | (new_n51_ & new_n48_ & ~x12 & x14);
  assign new_n51_ = x08 & ~x09 & x06 & x07;
  assign z09 = new_n43_ | new_n53_ | (x13 & (~x07 | (~new_n55_ & x14)));
  assign new_n53_ = new_n54_ & x04 & x06 & x07 & x08 & ~x09;
  assign new_n54_ = ~x10 & ~x11 & ~x12 & ~x13 & x14;
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = (x07 & ~x14) | (x04 & ((x06 & new_n57_ & x07) | (new_n39_ & x14)));
  assign new_n57_ = x08 & ~x09 & (new_n54_ | x00);
