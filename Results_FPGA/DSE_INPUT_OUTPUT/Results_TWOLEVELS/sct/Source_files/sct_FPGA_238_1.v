...
module FAU ( 
  ...
  assign new_n45_ = x07 ? ((~x09 | (x06 & x08)) & (~x08 | x09 | ~x04 | ~x06)) : (~x09 | x12);
  assign z06 = new_n44_ | ~new_n47_;
  assign new_n47_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10)) : (~x10 | x12);
  assign z07 = new_n44_ | ~new_n49_ | (~x07 & (x11 | x12));
  assign new_n49_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | new_n51_ | (new_n53_ & x06 & x07 & x08);
  assign new_n51_ = x12 & ((x04 & ~new_n52_ & x07) | ~x07 | x10 | x11);
  assign new_n52_ = x06 & x08 & ~x09;
  assign new_n53_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n44_ | ~new_n57_ | (new_n55_ & x04);
  assign new_n55_ = x06 & x07 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = (x07 | (~x12 & ~x13)) & (~x13 | (new_n52_ & ~x10 & ~x11 & ~x12));
  assign z10 = x04 & ((x07 & (new_n59_ | (new_n40_ & x14))) | (~x12 & new_n40_ & x14));
  assign new_n59_ = x06 & x08 & ~x09 & ~new_n40_ & ~new_n60_;
  assign new_n60_ = ~x00 & (x12 | x13 | x10 | x11);
  assign z11 = new_n37_ | x02;
  assign z12 = x04 & ~new_n37_ & (x03 | (~x02 & x16));
  assign z13 = x04 & (~x12 | (x07 & (new_n52_ | (~new_n52_ & x12))));
