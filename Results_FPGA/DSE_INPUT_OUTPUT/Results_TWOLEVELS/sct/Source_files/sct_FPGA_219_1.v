...
module FAU ( 
  ...
  assign z07 = new_n44_ | (x05 & (new_n49_ | (~new_n48_ & x11))) | (~x07 & x11);
  assign new_n48_ = x06 & x08 & ~x09 & ~x10;
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n44_ | (~new_n49_ & x12) | (x07 & (new_n51_ | ~x05));
  assign new_n51_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n44_ | new_n55_ | (x07 & (~x05 | (x04 & new_n53_ & x05)));
  assign new_n53_ = x06 & x08 & ~x09 & new_n54_ & ~x10;
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = x13 & (~new_n56_ | ~x06 | ~x07 | ~x08);
  assign new_n56_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z10 = x04 & ((x05 & (new_n58_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
