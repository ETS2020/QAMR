...
module FAU ( 
  ...
  assign new_n45_ = (~x07 | (x15 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  ...
  assign z08 = new_n43_ | (x07 & (new_n50_ | ~x15)) | (~new_n51_ & x12);
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n51_ = ~x09 & ~x10 & ~x11 & x06 & x07 & x08;
  assign z09 = new_n43_ | new_n55_ | (x07 & (~x15 | (new_n53_ & x04)));
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & new_n54_ & ~x11;
  assign new_n54_ = ~x12 & ~x13 & x15 & ((x02 & ~x03) | ~x16);
