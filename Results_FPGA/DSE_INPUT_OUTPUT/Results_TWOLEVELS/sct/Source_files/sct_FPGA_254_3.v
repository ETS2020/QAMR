...
module FAU ( 
  ...
  wire new_n41_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n51_,
    new_n52_, new_n53_, new_n55_, new_n56_, new_n59_, new_n60_;
  ...
  assign z04 = x04 & ((x08 & ((~new_n41_ & ~x07) | (~x06 & ~x16))) | (~x08 & ~x16 & x06 & x07));
  assign new_n41_ = x16 & (~x02 | x03);
  assign z05 = ~new_n43_ | (~x07 & ((new_n41_ & x04) | ~x04 | x09));
  assign new_n43_ = (~x07 | (~x16 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x08)) & (x04 | x16);
  assign z06 = (~x07 & ((new_n41_ & x04) | ~x04 | x10)) | (~new_n45_ & ~x16);
  assign new_n45_ = (~x10 | (x06 & x08 & ~x09)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~new_n47_ & ~x07) | (x07 & (new_n48_ | x16)) | new_n49_ | (~x04 & ~x16);
  assign new_n47_ = (~new_n41_ | ~x04) & x04 & ~x11;
  assign new_n48_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x08 | x09 | x10);
  assign z08 = new_n51_ | new_n52_ | (~x04 & ~x16) | (~new_n48_ & x12);
  assign new_n51_ = ~x07 & ((new_n41_ & x04) | ~x04 | x12);
  assign new_n52_ = x07 & (new_n53_ | x16);
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = ~z13 | (~new_n55_ & x04) | (~new_n52_ & x13);
  assign new_n55_ = (~new_n41_ | x07) & (~new_n56_ | ~x06 | ~x07 | ~x08 | x09);
  assign new_n56_ = ~x12 & ~x13 & ~x16 & ~x10 & ~x11;
  assign z13 = x04 | (x07 & x16);
  assign z10 = x04 & ((x06 & new_n59_ & x07) | (~x07 & new_n41_ & x14));
