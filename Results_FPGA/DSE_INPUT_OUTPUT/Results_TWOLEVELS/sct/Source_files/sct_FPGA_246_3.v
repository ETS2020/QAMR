...
module FAU ( 
  ...
  assign new_n54_ = ~x10 & ~x11 & ~x12 & ~x14;
  assign new_n55_ = ~x14 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = (x04 & (new_n62_ | (new_n57_ & x06))) | ~new_n59_ | (~new_n38_ & ~x04);
  assign new_n57_ = x07 & x08 & ~x09 & ~x10 & new_n58_ & ~x11;
  assign new_n58_ = ~x12 & ~x13 & ~x14 & ((x02 & ~x03) | ~x16);
  assign new_n59_ = new_n61_ & (~x13 | (new_n60_ & x06 & x07 & x08));
  assign new_n60_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n61_ = (~x07 | ~x14) & (~x03 | x14 | ~x16);
  assign new_n62_ = x16 & ((~x02 & (~x14 | (~x07 & x14))) | (x03 & ~x07 & x14));
  assign z10 = x04 & ((x06 & new_n64_ & x07) | (~x07 & new_n40_ & x14));
  assign new_n64_ = x08 & ~x09 & ~x14 & ~new_n40_ & ~new_n65_;
