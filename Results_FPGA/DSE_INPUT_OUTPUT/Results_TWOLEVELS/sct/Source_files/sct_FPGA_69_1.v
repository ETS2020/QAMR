...
module FAU ( 
  ...
  assign z07 = (~new_n37_ & (new_n45_ | ~x04)) | new_n37_ | new_n52_ | (new_n50_ & x06);
  assign new_n50_ = x07 & x08 & ~x09 & ~x10 & ~new_n51_ & ~x11;
  assign new_n51_ = ~x12 & (~x04 | x12 | x13 | ((~x02 | x03) & x16));
  assign new_n52_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = ~new_n57_ | (x04 & (new_n56_ | (new_n54_ & x07)));
  assign new_n54_ = ~new_n40_ & ((~x06 & x12) | (new_n55_ & x06 & x08 & ~x09));
  assign new_n55_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign new_n56_ = ~x02 & ~new_n37_ & x16;
  assign new_n57_ = ((~x12 & x13) | (x04 & (~x03 | ~x16))) & (x12 | ~x13) & (new_n58_ | ~x12);
  assign new_n58_ = (~x06 | ~x07 | ~x08 | x09 | (~x10 & (x10 | ~x11))) & x07 & x08 & ~x09;
  assign z09 = (~x04 & (x12 | ~x13)) | (x04 & (x13 ? x12 : ~new_n60_)) | (x03 & ~x13 & x16);
  assign new_n60_ = ~new_n62_ & (~x06 | ~x07 | ~x08 | ~new_n61_ | x09);
  assign new_n61_ = ~x10 & ~x11 & ~x12 & ((x02 & ~x03) | ~x16);
  assign new_n62_ = ~x02 & x16;
  assign z10 = new_n37_ | (x04 & ((new_n64_ & x06) | (new_n40_ & x14)));
  assign new_n64_ = x07 & x08 & ~x09 & ~new_n40_ & (new_n55_ | x00);
  assign z11 = ~new_n37_ & x02;
  assign z12 = new_n37_ | (x04 & (new_n56_ | x03));
