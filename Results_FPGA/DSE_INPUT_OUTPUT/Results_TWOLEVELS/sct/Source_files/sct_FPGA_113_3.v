...
module FAU ( 
  ...
  assign z04 = (x05 & x07) | (x04 & ~new_n39_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n43_ | ~new_n44_;
  assign new_n43_ = x16 & ((x04 & ((~x02 & (~x05 | ~x07)) | (x03 & ~x07))) | (x03 & ~x05));
  assign new_n44_ = (x04 | (x05 & (~x05 | x07))) & (~x07 | (~x05 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign z06 = new_n43_ | ~new_n46_ | (~x04 & (~x05 | (x05 & ~x07)));
  assign new_n46_ = (~x07 | (~x05 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = new_n43_ | (~x04 & (~x05 | (x05 & ~x07))) | new_n49_ | (x07 & (new_n48_ | x05));
  assign new_n48_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n43_ | (~x04 & (~x05 | (x05 & ~x07))) | new_n51_ | (x07 & (new_n53_ | x05));
  assign new_n51_ = ~new_n52_ & x12;
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n53_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = (x04 & (new_n55_ | (new_n57_ & ~x05))) | ~new_n59_ | (~x04 & (~x05 | (x05 & ~x07)));
  assign new_n55_ = x16 & (~z11 | (x03 & ~x07));
  assign z11 = x02 | (x05 & x07);
  assign new_n57_ = x06 & x07 & x08 & ~x09 & new_n58_ & ~x10;
  assign new_n58_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n59_ = (x07 | ~x13) & (x05 | ((new_n53_ | ~x13) & (~x03 | ~x16)));
  assign z10 = (x05 & x07) | (x04 & (new_n61_ | (new_n39_ & x14)));
  assign new_n61_ = x06 & x07 & x08 & ~x09 & ~new_n39_ & ~new_n62_;
  assign new_n62_ = ~x00 & (x11 | x12 | x13 | x05 | x10);
  assign z12 = x04 & (~x05 | ~x07) & (x03 | (~x02 & x16));
