...
module FAU ( 
  ...
  assign z08 = new_n44_ | (~x04 & (~x15 | (x07 & x15))) | (~new_n51_ & x07) | (~x07 & x12 & ~x15);
  assign new_n51_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = new_n44_ | ~new_n55_ | (x07 & (x04 ? new_n53_ : x15));
  assign new_n53_ = x06 & x08 & ~x09 & new_n54_ & ~x10;
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = (x07 | (~x13 & ~x15)) & (new_n56_ | ~x13) & (x04 | x15);
