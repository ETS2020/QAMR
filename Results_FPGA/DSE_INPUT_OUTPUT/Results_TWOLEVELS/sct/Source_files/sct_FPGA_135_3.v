...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x07 & (x13 | (x06 & x08 & ~x09))) | (x09 & (~x06 | ~x07 | ~x08));
  ...
  assign z08 = new_n44_ | new_n54_ | (~x13 & (new_n53_ | (new_n51_ & x04)));
  assign new_n51_ = x06 & x07 & x08 & new_n52_ & ~x09;
  assign new_n52_ = ~x10 & ~x11 & ~x12 & ((x02 & ~x03) | ~x16);
  assign new_n53_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n54_ = ~x07 & x12;
  assign z09 = x13 ? ~x07 : (new_n57_ | ~x04 | (x04 & (new_n51_ | new_n56_)));
  ...
  assign z12 = x04 & ~new_n37_ & (new_n56_ | x03);
