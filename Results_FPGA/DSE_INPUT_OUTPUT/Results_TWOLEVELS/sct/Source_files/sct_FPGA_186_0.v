...
module FAU ( 
  ...
  assign new_n44_ = (x04 | (~x18 & (~x07 | x18))) & (x07 | (~x09 & x18)) & (~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  ...
  assign new_n48_ = (~x11 | (new_n49_ & ~x09 & ~x10)) & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x08;
  assign z08 = new_n43_ | (~x04 & (x18 | (x07 & ~x18))) | ~new_n51_ | (~x07 & (x12 | ~x18));
  assign new_n51_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & (~new_n52_ | x09 | x10 | x11 | x12);
  assign new_n52_ = x06 & x07 & x08;
  assign z09 = ~new_n56_ | (x04 & (new_n54_ | new_n59_));
  assign new_n54_ = x06 & x07 & x08 & ~x09 & new_n55_ & ~x10;
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = (x04 | (~x18 & (~x07 | x18))) & (x07 | ~x13 | ~x18) & (~x07 | (~new_n58_ & (new_n57_ | ~x13)));
  assign new_n57_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n58_ = x03 & x16;
  assign new_n59_ = x16 & ((x03 & x18) | (~x02 & (x07 | x18)));
