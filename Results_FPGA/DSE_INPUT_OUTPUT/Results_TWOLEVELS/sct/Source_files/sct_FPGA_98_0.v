...
module FAU ( 
  ...
  assign new_n46_ = (~x07 | ((x06 | ~x11) & (~x06 | ~x08 | x09 | x10 | x11))) & (~x06 | ~x11 | (~x09 & ~x10 & x07 & x08));
  assign z08 = new_n43_ | ~new_n48_ | (~x06 & (~x07 | x12));
  assign new_n48_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & (~new_n49_ | ~x06 | x09 | x10 | x11 | x12);
  ...
  assign new_n53_ = (x06 | (x07 & ~x13)) & (~x13 | (new_n54_ & x07 & x08 & ~x09));
  assign new_n54_ = ~x10 & ~x11 & ~x12;
  assign z10 = (~x06 & ~x07) | (x04 & ((x06 & new_n56_ & x07) | (new_n39_ & x14)));
