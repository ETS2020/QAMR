...
module FAU ( 
  ...
  assign new_n46_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10)) : (~x10 | x11);
  ...
  assign z09 = new_n44_ | (~x11 & (new_n54_ | (~new_n56_ & x13))) | (x07 & x11 & x13);
  assign new_n54_ = x04 & x06 & x07 & x08 & new_n55_ & ~x09;
  assign new_n55_ = ~x10 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = new_n52_ & ~x09 & ~x10 & ~x12;
