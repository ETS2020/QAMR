...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & x08) | (~x16 & (~x04 | (~x08 & x09)));
  assign new_n44_ = (~new_n45_ | ~x04) & (~x09 | (x06 & x07)) & x04 & (~x06 | ~x07 | x09);
  assign new_n45_ = x16 & (~x02 | x03);
  assign z06 = (~new_n47_ & x08) | (~x08 & (x10 | x16)) | (~new_n49_ & x10) | (~x04 & ~x16);
  assign new_n47_ = (~new_n45_ | ~x04) & ~new_n48_ & x04;
  assign new_n48_ = x06 & x07 & ~x09 & ~x10;
  assign new_n49_ = x06 & x07 & ~x09;
  assign z07 = (~new_n51_ & x08) | (~x08 & (x11 | x16)) | (~new_n48_ & x11) | (~x04 & ~x16);
  ...
  assign z09 = (~x04 & (x08 | ~x16)) | (x08 & ((~new_n55_ & x13) | (~new_n57_ & x04))) | (~x08 & x13 & ~x16);
  assign new_n57_ = ~new_n45_ & (~x06 | ~x07 | x09 | ~new_n58_ | x10);
  assign new_n58_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign z10 = (~x08 & x16) | (x04 & (new_n60_ | (new_n45_ & x14)));
  assign new_n60_ = x06 & x07 & x08 & ~x09 & ~new_n45_ & ~new_n61_;
