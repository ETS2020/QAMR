...
module FAU ( 
  ...
  assign new_n45_ = x07 ? ((~x09 | (x06 & x08)) & (~x08 | x09 | ~x04 | ~x06)) : (~x09 | x11);
  assign z06 = new_n44_ | ~new_n47_;
  assign new_n47_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10)) : (~x10 | x11);
  assign z07 = new_n44_ | (~new_n49_ & x07);
  assign new_n49_ = (~x11 | (~x10 & (~x04 | (x06 & x08 & ~x09)))) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~new_n51_ & x07) | (new_n53_ & ~x11);
  assign new_n51_ = (~x11 | ~x12) & (~new_n52_ | x10 | x11 | x12);
  assign new_n52_ = x06 & x08 & ~x09;
  assign new_n53_ = x12 & (~x06 | ~x07 | ~x08 | x09 | x10);
  ...
  assign new_n57_ = (x07 | (~x11 & ~x13)) & (~x13 | (new_n52_ & ~x10 & ~x11 & ~x12));
  ...
  assign z13 = x04 & (~x11 | (x07 & (new_n52_ | (~new_n52_ & x11))));
