...
module FAU ( 
  ...
  assign new_n46_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10)) : (~x10 | x17);
  ...
  assign new_n56_ = (x07 | (~x13 & ~x17)) & (new_n57_ | ~x13);
  assign new_n57_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & (new_n61_ | (~new_n59_ & x07));
  assign new_n59_ = (~x06 | ~x08 | x09 | new_n40_ | new_n60_) & (~new_n40_ | ~x14);
  assign new_n60_ = ~x00 & (x12 | x13 | x10 | x11);
  assign new_n61_ = x14 & x16 & ~x17 & (~x02 | x03);
