...
module FAU ( 
  ...
  assign z08 = (x04 & (~new_n48_ | new_n39_)) | (~x07 & (~x04 | x12));
  assign new_n48_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & (~new_n50_ | x11 | x12 | x09 | x10);
  assign new_n49_ = x06 & x08;
  assign new_n50_ = x06 & x07 & x08;
  assign z09 = (x04 & (new_n52_ | new_n39_ | (~new_n54_ & x13))) | (~x07 & (~x04 | x13));
