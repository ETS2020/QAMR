...
module FAU ( 
  ...
  assign z05 = new_n43_ | (x07 & (x06 ? (x08 & ~x09) : x09)) | (x06 & x09 & (~x07 | ~x08));
  assign new_n43_ = (x06 | x07) & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n43_ | (x10 & ((x06 & (~x07 | ~x08)) | (x07 & (~x06 | x09)))) | (x06 & x07 & x08 & ~x09 & ~x10);
  ...
  assign z09 = new_n43_ | ~new_n54_ | (new_n52_ & x04);
  assign new_n52_ = x06 & x07 & x08 & ~x09 & new_n53_ & ~x10;
  assign new_n53_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n54_ = (x06 | (x07 & ~x13)) & (~x13 | (new_n55_ & x07 & x08 & ~x09));
