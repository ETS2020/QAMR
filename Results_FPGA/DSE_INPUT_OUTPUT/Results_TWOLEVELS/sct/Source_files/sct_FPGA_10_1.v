...
module FAU ( 
  ...
  assign z07 = new_n44_ | new_n48_ | new_n37_ | new_n49_;
  assign new_n48_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n44_ | (~new_n49_ & x12) | new_n51_ | new_n37_;
  assign new_n51_ = new_n52_ & x06 & x07 & x08;
  assign new_n52_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n44_ | (x04 & new_n54_ & x06) | (~new_n51_ & x13);
  assign new_n54_ = x07 & x08 & ~x09 & ~x10 & new_n55_ & ~x11;
  ...
  assign new_n58_ = ~x00 & (x12 | x13 | x17 | x10 | x11);
