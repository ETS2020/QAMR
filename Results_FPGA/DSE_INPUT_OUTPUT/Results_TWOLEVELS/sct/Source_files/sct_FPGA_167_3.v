...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n39_ & (~x07 | (x07 & ~x15));
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = (x07 & x15) | (x04 & ~new_n39_ & (x06 ? ~x07 : (x07 & ~x15)));
  assign z04 = (x07 & x15) | (x04 & ~new_n39_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n43_ | ~new_n44_;
  assign new_n43_ = x16 & (~x07 | ~x15) & (x03 | (~x02 & x04));
  assign new_n44_ = (x04 | (x15 & (x07 | ~x15))) & (~x07 | (~x15 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign z06 = new_n43_ | ~new_n46_ | (~x04 & (~x15 | (~x07 & x15)));
  assign new_n46_ = (~x10 | (x07 & (x15 | (x06 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | x15);
  assign z07 = new_n43_ | (~x04 & (~x15 | (~x07 & x15))) | new_n49_ | (x07 & (new_n48_ | x15));
  assign new_n48_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n43_ | (~x04 & (~x15 | (~x07 & x15))) | new_n51_ | (x07 & (new_n53_ | x15));
  assign new_n51_ = x12 & (~new_n52_ | x09 | x10 | x11);
  assign new_n52_ = x06 & x07 & x08;
  assign new_n53_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n43_ | (x07 & (x15 | (new_n55_ & x04))) | new_n57_ | (~x04 & (~x15 | (~x07 & x15)));
  assign new_n55_ = x06 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = x13 & (~new_n52_ | x11 | x12 | x09 | x10);
