...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n40_ & (~x07 | (x07 & ~x14));
  assign new_n40_ = x16 & (~x02 | x03);
  assign z03 = (x07 & x14) | (x04 & ~new_n40_ & (x06 ? ~x07 : (x07 & ~x14)));
  ...
  assign new_n45_ = (x04 | (x07 & x14)) & (~x07 | (~x14 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign z06 = new_n44_ | ~new_n47_ | (~new_n38_ & ~x04);
  assign new_n47_ = (~x07 | (~x14 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x06 & x07 & x08 & ~x09));
  assign z07 = new_n44_ | new_n49_ | new_n51_ | (~new_n38_ & ~x04);
  assign new_n49_ = ~new_n50_ & x07;
  assign new_n50_ = ~x14 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n51_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | (~new_n38_ & ~x04) | new_n53_ | (~new_n49_ & x12);
  assign new_n53_ = new_n54_ & ~x12 & ~x14 & ~x10 & ~x11;
  assign new_n54_ = x06 & x07 & x08 & ~x09;
  assign z09 = (x04 & (new_n60_ | (new_n56_ & x06))) | ~new_n58_ | (~new_n38_ & ~x04);
  assign new_n56_ = x07 & x08 & ~x09 & ~x10 & new_n57_ & ~x11;
  assign new_n57_ = ~x12 & ~x13 & ~x14 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = (~x13 | (x07 & (new_n59_ | x14))) & (~x03 | x14 | ~x16);
  assign new_n59_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n60_ = x16 & ((~x02 & (~x14 | (~x07 & x14))) | (x03 & ~x07 & x14));
  assign z10 = (x07 & x14) | (x04 & ((x06 & new_n62_ & x07) | (~x07 & new_n40_ & x14)));
  assign new_n62_ = x08 & ~x09 & ~new_n40_ & ~new_n63_;
  assign new_n63_ = ~x00 & (x10 | x11 | x12 | x13 | x14);
  assign z11 = new_n38_ | x02;
  assign z12 = (x07 & x14) | (x04 & (x03 | (~x02 & x16 & (~x14 | (~x07 & x14)))));
  assign z13 = x04 & (~x14 | (~x07 & (~new_n40_ | (new_n40_ & x14))));
