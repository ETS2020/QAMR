...
module FAU ( 
  ...
  assign z08 = new_n43_ | (~new_n49_ & x07) | (x12 & (~new_n48_ | ~x07 | ~x08));
  assign new_n48_ = ~x09 & ~x10 & ~x11;
  assign new_n49_ = x06 & (x10 | x11 | x12 | ~x08 | x09);
  assign z09 = new_n43_ | (~new_n53_ & x13) | (~new_n51_ & x07);
  ...
  assign new_n55_ = (~x07 | ~x08 | x09 | new_n39_ | new_n56_) & (~new_n39_ | ~x14);
