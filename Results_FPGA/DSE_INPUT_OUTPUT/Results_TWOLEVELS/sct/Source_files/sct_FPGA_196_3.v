...
module FAU ( 
  ...
  assign z07 = new_n44_ | ~new_n49_ | (~new_n38_ & ~x04);
  assign new_n49_ = (~x11 | (x07 & (x14 | (new_n50_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n50_ | x11 | x14);
  assign new_n50_ = ~x09 & ~x10;
  assign z08 = new_n44_ | ~new_n52_ | (~new_n38_ & ~x04);
  assign new_n52_ = (~x12 | (x07 & (new_n55_ | x14))) & (~new_n53_ | ~new_n54_ | x12 | x14);
  assign new_n53_ = x06 & x07 & x08 & ~x09;
  assign new_n54_ = ~x10 & ~x11;
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = ((new_n57_ | new_n62_) & x04) | ~new_n59_ | (~new_n38_ & ~x04);
  ...
  assign z10 = (x07 & x14) | (x04 & ((x06 & new_n64_ & x07) | (~x07 & new_n40_ & x14)));
  assign new_n64_ = x08 & ~x09 & ~new_n40_ & ~new_n65_;
