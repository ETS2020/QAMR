...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n39_ & (~x07 | (x07 & ~x11));
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = (x07 & x11) | (x04 & ~new_n39_ & (x06 ? ~x07 : (x07 & ~x11)));
  assign z04 = x04 & ~new_n39_ & ((x08 & (~x07 | (~x06 & ~x11))) | (x06 & x07 & ~x08 & ~x11));
  assign z05 = new_n43_ | (x09 & (~x07 | (~x11 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & ~x11);
  assign new_n43_ = (~x07 | ~x11) & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n43_ | ~new_n45_;
  assign new_n45_ = (~x07 | (~x11 & (~x06 | ~x08 | x09 | x10 | x11))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = (x04 & ((~x07 & x11) | (~x02 & ~x11 & x16))) | (~new_n47_ & ~x11) | (~x04 & (~x07 | ~x11));
  assign new_n47_ = ~new_n48_ & (~x03 | ~x16);
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = new_n43_ | (x07 & (new_n50_ | x11)) | (~new_n48_ & x12);
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x12;
  assign z09 = new_n43_ | (~x11 & (new_n52_ | (~new_n50_ & x13))) | (~x07 & x13);
  assign new_n52_ = x04 & x06 & x07 & x08 & new_n53_ & ~x09;
  assign new_n53_ = ~x10 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign z10 = (x07 & x11) | (x04 & (new_n55_ | (new_n39_ & x14)));
