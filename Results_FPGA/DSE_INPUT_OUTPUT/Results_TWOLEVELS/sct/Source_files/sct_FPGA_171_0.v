...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (~x07 & x09 & x12);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08)) : (~x10 | ~x12);
  assign z07 = new_n44_ | (~new_n48_ & x07) | (~x07 & x11 & x12);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~new_n52_ & x04) | ~new_n50_ | (~new_n37_ & (~x04 | (x03 & x16)));
  assign new_n50_ = x12 ? (new_n51_ & x08 & ~x09) : (x07 & (~x06 | ~x08 | ~new_n51_ | x09));
  assign new_n51_ = ~x10 & ~x11;
  assign new_n52_ = (((~x02 | x03) & x16) | (x06 ? x07 : ~x12)) & (x02 | (~x07 & ~x12) | ~x16);
  assign z09 = new_n44_ | (x12 & x13) | (x07 & (new_n55_ | (~new_n54_ & x13)));
  assign new_n54_ = x06 & x08 & new_n51_ & ~x09;
