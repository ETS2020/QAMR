// Benchmark "FAU" written by ABC on Mon Aug 24 17:21:23 2020
...
module FAU ( 
  ...
  assign z02 = (x01 & ~x07) | (x04 & ~new_n39_ & ~x06);
  ...
  assign z08 = new_n43_ | ~new_n49_ | (~x07 & (x01 | x12));
  assign new_n49_ = (new_n50_ | ~x12) & (~new_n51_ | x11 | x12 | x09 | x10);
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n51_ = x06 & x07 & x08;
  assign z09 = new_n43_ | (x07 & (new_n53_ | (~new_n55_ & x13))) | (~x01 & ~x07 & x13);
  ...
  assign z10 = x04 & ((x07 & (new_n57_ | (new_n39_ & x14))) | (~x01 & new_n39_ & x14));
