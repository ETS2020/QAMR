...
module FAU ( 
  ...
  assign z02 = (x06 & ~x07) | (x04 & ~new_n40_ & ~x06);
  assign new_n40_ = x16 & (~x02 | x03);
  assign z03 = (x06 & ~x07) | (x04 & ~x06 & ~new_n40_ & x07);
  assign z04 = (x06 & ~x07) | (x04 & ~new_n40_ & (x06 ^ x08));
  assign z05 = new_n44_ | new_n45_ | (x07 & ((~x08 & x09) | (x06 & x08 & ~x09))) | (~x06 & x09);
  assign new_n44_ = ~new_n37_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = x03 & x16 & (x07 | (x04 & ~x06));
  assign z06 = new_n44_ | ~new_n47_;
  assign new_n47_ = ~new_n45_ & (~x07 | ((~x10 | (x08 & ~x09)) & (~x06 | ~x08 | x09 | x10))) & (x06 | ~x10);
  assign z07 = new_n44_ | new_n45_ | ~new_n49_;
  assign new_n49_ = (~x06 | (x07 & (~x08 | x09 | x10 | x11))) & (~x11 | (x06 & x08 & ~x09 & ~x10));
  assign z08 = new_n44_ | new_n45_ | new_n52_ | (~new_n51_ & x06);
  assign new_n51_ = x07 & (~x08 | x09 | x10 | x11 | x12);
  assign new_n52_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | new_n45_ | (~new_n54_ & x06) | (~new_n56_ & x13);
  assign new_n54_ = x07 & (~x04 | ~x07 | ~x08 | x09 | ~new_n55_ | x10);
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z10 = x04 & ((x07 & (new_n60_ | (x06 & new_n58_ & x08))) | (new_n60_ & ~x06));
