...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~x07 & (x00 | x09)) | (x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x07 | ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10))) & (x00 | x07 | ~x10);
  assign z07 = new_n44_ | (~new_n48_ & x07) | (~x00 & ~x07 & x11);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~x07 & (x00 | x12)) | new_n50_ | (~new_n52_ & x12);
  ...
  assign new_n56_ = (x07 | (~x00 & ~x13)) & (new_n57_ | ~x13);
