...
module FAU ( 
  ...
  assign new_n46_ = (x07 | (x04 & ~new_n43_ & ~x10)) & (new_n47_ | ~x10);
  assign new_n47_ = x06 & x08 & ~x09;
  assign new_n48_ = x06 & x08 & ~x09 & ~x10;
  assign z07 = (x03 & (~x04 | x16)) | ~new_n50_ | (x07 & (new_n51_ | ~x03));
  assign new_n50_ = (x07 | (x04 & ~new_n43_ & ~x11)) & (new_n48_ | ~x11);
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x03 | ~x07)) | (~x07 & (new_n43_ | x12)) | (~new_n53_ & x03);
  ...
  assign new_n59_ = (x04 | (~x03 & x07)) & (x07 | ~x13) & (~x03 | (~x16 & (new_n60_ | ~x13)));
  assign new_n60_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = (~new_n62_ & x04) | (~x03 & x07);
  assign new_n62_ = (~x03 | (~new_n64_ & (~new_n63_ | ~new_n58_))) & ~new_n65_ & (~new_n64_ | x02);
  assign new_n63_ = x08 & ~x09 & x06 & x07;
  assign new_n64_ = x14 & x16;
  assign new_n65_ = x00 & x06 & x07 & x08 & ~x09 & ~x16;
  assign z11 = x02 & (x03 | ~x07);
  assign z12 = (~x03 & x07) | (x04 & (x03 | (~x02 & ~x07 & x16)));
  assign z13 = (~x03 & x07) | (x04 & ((x02 & ~x03) | (~x07 & (x16 ? ~x02 : x06)) | x03 | (~x06 & ~x16)));
