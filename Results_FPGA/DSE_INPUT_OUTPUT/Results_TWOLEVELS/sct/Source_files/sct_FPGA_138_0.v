...
module FAU ( 
  ...
  wire new_n39_, new_n43_, new_n45_, new_n47_, new_n49_, new_n50_, new_n51_,
    new_n53_, new_n54_, new_n55_, new_n57_, new_n58_, new_n62_;
  ...
  assign z05 = new_n43_ | (~x07 & (~x01 | x09)) | (x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07);
  assign new_n43_ = (x01 | x07) & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n43_ | ~new_n45_;
  assign new_n45_ = (x07 | (x01 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  ...
  assign new_n62_ = ~x07 & (~x01 | (~x03 & (x02 | ~x16) & ((x16 & (~x02 | x03)) | (x06 & (~x06 | x07)))));
  assign z14 = (~x01 & ~x07) | (x04 & x17);
endmodule
