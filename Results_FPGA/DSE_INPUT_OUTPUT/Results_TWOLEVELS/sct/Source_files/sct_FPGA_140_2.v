...
module FAU ( 
  ...
  assign new_n46_ = x08 & ~x09 & (~x11 | (x11 & x12 & (x10 | (x04 & ~x10))));
  assign z06 = (~new_n37_ & (new_n45_ | ~new_n48_)) | (x06 & new_n49_ & x07);
  assign new_n48_ = x04 & (~x10 | (x08 & ~x09 & x06 & x07));
  assign new_n49_ = x08 & ~x09 & ~x10 & (~x11 | (x04 & x11 & x12));
  assign z07 = new_n51_ | (new_n52_ & x06) | (~new_n53_ & x11);
  assign new_n51_ = ~new_n37_ & (new_n45_ | ~x04);
  assign new_n52_ = x07 & x08 & ~x09 & (x10 ? (x11 & x12) : ~x11);
  assign new_n53_ = x07 & x08 & ~x09 & x12 & (~x04 | x06 | ~x12);
  assign z08 = (~new_n37_ & ~x04) | new_n55_ | ~new_n57_;
  assign new_n55_ = x07 & ((new_n56_ & x06) | (x04 & ~x06 & ~new_n40_ & x12));
  assign new_n56_ = x08 & ~x09 & ~x10 & (~x12 | (x04 & x11 & x12));
  assign new_n57_ = (~x11 | (x12 & (~x04 | x06 | ~x12))) & (~new_n45_ | x11) & (~x04 | new_n58_ | ~x12);
  assign new_n58_ = ~x09 & ~x10 & x07 & x08;
  assign z09 = new_n51_ | (x12 & x13) | (~x11 & (new_n60_ | (~new_n62_ & x13)));
  assign new_n60_ = x04 & x06 & x07 & x08 & new_n61_ & ~x09;
  assign new_n61_ = ~x10 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n62_ = x06 & x07 & x08 & ~x09 & ~x10;
  ...
  assign z13 = x04 & (~x11 | (x12 & (~new_n58_ | (x11 & (new_n62_ | ~x06)))));
