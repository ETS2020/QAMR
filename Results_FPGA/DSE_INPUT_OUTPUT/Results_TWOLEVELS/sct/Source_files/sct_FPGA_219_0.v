...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (x05 & ~x07 & x09);
  ...
  assign z07 = new_n44_ | (~new_n48_ & x07) | (x05 & ~x07 & x11);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | ~new_n50_ | (~x07 & (~x05 | x12));
  ...
  assign new_n56_ = (x07 | (x05 & ~x13)) & (new_n57_ | ~x13);
  assign new_n57_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x07 & (new_n59_ | (new_n40_ & x14))) | (x05 & new_n40_ & x14));
  assign new_n59_ = x06 & x08 & ~new_n40_ & ~new_n60_ & ~x09;
