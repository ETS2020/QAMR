...
module FAU ( 
  ...
  assign z04 = (x08 & x12) | (x04 & ~new_n40_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = ~new_n44_ | (x08 & (x12 | (x06 & x07 & ~x09)));
  assign new_n44_ = ~new_n45_ & x04 & (~x09 | (x06 & x07 & x08));
  assign new_n45_ = x16 & (x03 | (~x02 & x04));
  assign z06 = ~new_n47_ | (x08 & (x12 | (new_n48_ & ~x09 & ~x10)));
  assign new_n47_ = ~new_n45_ & x04 & (~x10 | (new_n48_ & x08 & ~x09));
  assign new_n48_ = x06 & x07;
  assign z07 = new_n50_ | new_n45_ | new_n51_ | ~x04;
  assign new_n50_ = x08 & (x12 | (new_n48_ & ~x09 & ~x10 & ~x11));
  assign new_n51_ = x11 & (~new_n48_ | ~x08 | x09 | x10);
  assign z08 = new_n45_ | ~x04 | new_n53_ | x12;
  assign new_n53_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = ~new_n57_ | (x04 & (new_n55_ | (~x02 & x16)));
  assign new_n55_ = x06 & x07 & x08 & new_n56_ & ~x09;
  assign new_n56_ = ~x10 & ~x11 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = (new_n53_ | ~x13) & x04 & ~new_n37_ & (~x03 | ~x16);
  assign z10 = new_n37_ | (x04 & (new_n59_ | (new_n40_ & x14)));
  assign new_n59_ = x06 & x07 & x08 & ~x09 & ~new_n40_ & ~new_n60_;
  assign new_n60_ = ~x00 & (x10 | x11 | x13);
