...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n40_ & x07;
  ...
  assign z06 = new_n44_ | (~x06 & (~x07 | x10)) | ((~x07 | ~x08 | x09) & x10) | (x06 & x07 & x08 & ~x09 & ~x10);
  assign z07 = new_n44_ | ~new_n47_;
  assign new_n47_ = (~x07 | ((x06 | ~x11) & (~x06 | ~x08 | x09 | x10 | x11))) & (~x06 | ~x11 | (x07 & x08 & ~x09 & ~x10));
  assign z08 = new_n44_ | (new_n50_ & x06) | (~new_n49_ & x07);
  ...
  assign z10 = (~x06 & ~x07) | (x04 & ((x06 & new_n56_ & x07) | (new_n40_ & x14)));
  assign new_n56_ = x08 & ~x09 & ~new_n40_ & ~new_n57_;
