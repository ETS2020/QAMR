...
module FAU ( 
  ...
  assign z01 = (~x05 & (x15 | ~x18)) | (~x00 & ~x07) | (~x04 & x05);
  ...
  assign z08 = new_n43_ | (~new_n49_ & x07) | (x00 & ~x07 & x12);
  assign new_n49_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = new_n43_ | (x07 & (new_n51_ | (~new_n53_ & x13))) | (x00 & ~x07 & x13);
  assign new_n51_ = x04 & x06 & x08 & ~x09 & new_n52_ & ~x10;
  assign new_n52_ = ~x11 & ~x12 & ~x13 & (~x16 | (x02 & ~x03));
  assign new_n53_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z10 = x04 & ((x07 & (new_n55_ | (new_n39_ & x14))) | (x00 & new_n39_ & x14));
  ...
  assign z13 = ~new_n60_ & x04;
  assign new_n60_ = ~x07 & (~x00 | (~x03 & (x02 | ~x16) & (((~x02 | x03) & x16) | (x06 & (~x06 | x07)))));
