...
module FAU ( 
  ...
  assign new_n46_ = (~x07 | (~x11 & (~x06 | ~x08 | x09 | x10 | x11))) & (~x10 | (x06 & x07 & x08 & ~x09));
  assign z07 = x11 ? ~x07 : ~new_n48_;
  assign new_n48_ = (~x16 | (~x03 & (x02 | ~x04))) & ~new_n49_ & x04;
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = new_n44_ | (~new_n51_ & ~x11) | (~x07 & x12);
  assign new_n51_ = (~x12 | (x06 & x08 & ~x09 & ~x10)) & (x09 | x10 | x12 | ~x06 | ~x07 | ~x08);
  assign z09 = new_n44_ | (~x11 & (new_n53_ | (~new_n55_ & x13))) | (~x07 & x13);
  assign new_n53_ = x04 & x06 & x07 & x08 & new_n54_ & ~x09;
  assign new_n54_ = ~x10 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x12;
