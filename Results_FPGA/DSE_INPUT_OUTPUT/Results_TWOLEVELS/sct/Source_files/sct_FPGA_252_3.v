...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n40_, new_n44_, new_n45_, new_n48_, new_n50_, new_n51_,
  ...
  assign z05 = new_n44_ | (x09 & (~x08 | (~new_n45_ & ~x18))) | (new_n45_ & x08 & ~x09 & ~x18);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign new_n45_ = x06 & x07;
  assign z06 = new_n44_ | (x08 & (x18 | (new_n45_ & ~x09 & ~x10))) | (x10 & (~new_n45_ | ~x08 | x09));
  assign z07 = new_n44_ | ~new_n48_;
  assign new_n48_ = (~x08 | (~x18 & (~new_n45_ | x09 | x10 | x11))) & (~x11 | (new_n45_ & x08 & ~x09 & ~x10));
  assign z08 = new_n44_ | ~new_n50_;
  assign new_n50_ = (~x12 | (x08 & (x18 | (new_n45_ & new_n51_ & ~x09)))) & (~new_n45_ | ~x08 | x09 | ~new_n51_ | x12 | x18);
  assign new_n51_ = ~x10 & ~x11;
  assign z09 = new_n44_ | new_n57_ | (~x18 & (new_n55_ | (new_n53_ & x04)));
  ...
  assign z10 = x04 & ((~x18 & (new_n59_ | (new_n40_ & x14))) | (~x08 & new_n40_ & x14));
