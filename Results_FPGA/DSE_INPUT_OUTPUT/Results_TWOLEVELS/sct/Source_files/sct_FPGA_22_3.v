...
module FAU ( 
  ...
  assign z05 = (x03 & (x07 | (~x07 & x16))) | ~new_n43_ | (~x03 & (~x04 | (~x02 & x04 & x16)));
  assign new_n43_ = (x07 | (x04 & ~x09)) & (~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign z06 = (~x04 & (~x03 | ~x07)) | (~x07 & (x10 | (x03 & x16))) | (~new_n45_ & ~x03);
  ...
  assign new_n51_ = ~new_n53_ & ~new_n46_ & (~new_n52_ | ~new_n54_);
  ...
  assign new_n59_ = x13 & (~new_n52_ | ~new_n54_);
