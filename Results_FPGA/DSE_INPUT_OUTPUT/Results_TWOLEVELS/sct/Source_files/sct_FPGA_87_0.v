...
module FAU ( 
  ...
  assign z06 = new_n43_ | ~new_n47_ | (x07 & (new_n46_ | ~x04));
  assign new_n46_ = x06 & x08 & ~x09 & ~x10;
  assign new_n47_ = (x07 | (~x10 & x16)) & (~x10 | (x06 & x08 & ~x09));
  assign z07 = new_n43_ | (~new_n49_ & x07) | (~x07 & (x11 | ~x16)) | (~new_n46_ & x11);
