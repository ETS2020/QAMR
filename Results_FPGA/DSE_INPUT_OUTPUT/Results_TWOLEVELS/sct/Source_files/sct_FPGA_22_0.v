...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n41_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
  ...
  assign z05 = new_n45_ | ~new_n43_ | (~x07 & (~x03 | x09));
  assign new_n43_ = (~x09 | (x06 & x08)) & (~x07 | (x04 & ~new_n44_ & (~x06 | ~x08 | x09)));
  assign new_n44_ = ~x02 & x04 & x16;
  assign new_n45_ = x03 & (~x04 | x16);
  assign z06 = (~x04 & (x03 | x07)) | (~new_n47_ & x07) | (x03 & (x16 | (~x07 & x10)));
  assign new_n47_ = (new_n48_ | ~x10) & ~new_n44_ & ~new_n49_;
  assign new_n48_ = x06 & x08 & ~x09;
  assign new_n49_ = ~x09 & ~x10 & x06 & x08;
  assign z07 = new_n45_ | ~new_n51_ | (~x07 & (~x03 | x11));
  assign new_n51_ = (~x07 | (x04 & ~new_n44_ & ~new_n52_)) & (new_n49_ | ~x11);
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x03 | x07)) | (~new_n54_ & x07) | (x03 & (x16 | (~x07 & x12)));
  assign new_n54_ = (new_n52_ | ~x12) & ~new_n44_ & (~new_n48_ | x10 | x11 | x12);
  assign z09 = new_n45_ | new_n56_ | new_n60_ | (x07 & (~x04 | (~new_n59_ & x04)));
  assign new_n56_ = ~x03 & (~x07 | (new_n58_ & new_n57_ & x06 & x07 & x08));
  assign new_n57_ = x02 & x04;
  assign new_n58_ = ~x11 & ~x12 & ~x13 & ~x09 & ~x10;
  assign new_n59_ = (x02 | ~x16) & (~new_n49_ | x11 | x12 | x13 | x16);
