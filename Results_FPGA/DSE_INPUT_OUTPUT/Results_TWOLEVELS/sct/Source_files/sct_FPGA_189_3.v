...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~x01 & ((x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07))) | (~x07 & x09);
  ...
  assign z07 = new_n44_ | (~x01 & (new_n49_ | (~new_n48_ & x11))) | (~x07 & x11);
  ...
  assign z10 = x04 & ((~x01 & (new_n58_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
