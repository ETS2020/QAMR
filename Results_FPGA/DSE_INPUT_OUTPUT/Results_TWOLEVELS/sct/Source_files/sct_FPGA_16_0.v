...
module FAU ( 
  ...
  assign new_n45_ = (x04 | (~x18 & (~x07 | x18))) & (x07 | (~x09 & x18)) & (~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign z06 = new_n44_ | ~new_n47_ | (~x04 & (x18 | (x07 & ~x18)));
  assign new_n47_ = (x07 | (~x10 & x18)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | (~x04 & (x18 | (x07 & ~x18))) | ~new_n49_ | (~x07 & (x11 | ~x18));
  assign new_n49_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~x04 & (x18 | (x07 & ~x18))) | (~new_n51_ & x07) | (~x07 & x12 & x18);
  assign new_n51_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = new_n44_ | new_n57_ | (x07 & (new_n53_ | ~new_n55_));
  ...
  assign new_n57_ = x18 & (~x04 | (~x07 & x13));
