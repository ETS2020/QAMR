...
module FAU ( 
  ...
  assign new_n45_ = x07 ? ((~x09 | (x06 & x08)) & (~x08 | x09 | ~x04 | ~x06)) : (~x09 | x13);
  assign z06 = new_n44_ | ~new_n47_;
  assign new_n47_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08)) : (~x10 | x13);
  assign z07 = new_n44_ | ~new_n49_ | (~x07 & (x11 | x13));
  assign new_n49_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~new_n51_ & x07) | (~x07 & x12 & ~x13);
  assign new_n51_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = new_n44_ | (x07 & (new_n55_ | (~new_n53_ & x04)));
  assign new_n53_ = (~x06 | ~x08 | x09 | ~new_n54_ | x10) & (~x13 | (x06 & x08 & ~x09));
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = x13 & (x10 | x11 | x12);
  assign z10 = x04 & ((x07 & (new_n57_ | (new_n40_ & x14))) | (~x13 & new_n40_ & x14));
