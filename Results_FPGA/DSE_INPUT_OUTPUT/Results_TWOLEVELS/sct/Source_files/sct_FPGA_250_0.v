...
module FAU ( 
  ...
  assign z09 = (x04 & (new_n54_ | new_n58_)) | ~new_n56_ | (~x04 & (x18 | (x07 & ~x18)));
  assign new_n54_ = x06 & x07 & x08 & ~x09 & new_n55_ & ~x10;
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = (x07 | (~x13 & x18)) & (new_n57_ | ~x13) & (~x03 | ~x07 | ~x16);
  assign new_n57_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n58_ = x16 & ((x03 & x18) | (~x02 & (x07 | x18)));
  assign z10 = x04 & (new_n62_ | (~new_n60_ & x07));
