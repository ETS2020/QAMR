...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & (~x07 | (~x17 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & ~x17);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x10 | (x07 & (x17 | (x06 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | x17);
  assign z07 = new_n44_ | ~new_n48_;
  assign new_n48_ = (~x11 | (x07 & (x17 | (new_n49_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n49_ | x11 | x17);
  assign new_n49_ = ~x09 & ~x10;
  assign z08 = new_n44_ | (x07 & (new_n51_ | x17)) | (~new_n52_ & x12);
  assign new_n51_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = new_n44_ | new_n57_ | (~x17 & (new_n56_ | (new_n54_ & x04)));
  assign new_n54_ = x06 & x07 & x08 & ~x09 & new_n55_ & ~x10;
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = ~new_n51_ & x13;
  assign new_n57_ = ~x07 & x13;
  assign z10 = x04 & ((~x17 & (new_n59_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
