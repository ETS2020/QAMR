...
module FAU ( 
  ...
  assign z03 = (~x07 & ~x15) | (x04 & ~new_n40_ & (x06 ? (~x07 & x15) : x07));
  ...
  assign new_n48_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08)) : (~x10 | ~x15);
  assign z07 = new_n44_ | new_n46_ | ~new_n50_ | (~x07 & (x11 | ~x15));
  assign new_n50_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | new_n46_ | (~new_n52_ & x07) | (~x07 & x12 & x15);
