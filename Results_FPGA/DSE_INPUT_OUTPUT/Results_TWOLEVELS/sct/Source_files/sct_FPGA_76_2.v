...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~new_n39_ & ~x04) | (~new_n45_ & x09) | new_n39_ | new_n46_;
  ...
  assign z07 = new_n44_ | (~new_n39_ & ((~new_n48_ & x11) | new_n50_ | ~x04));
  assign new_n50_ = new_n45_ & ~x09 & ~x10 & ~x11;
  assign z08 = new_n44_ | (~new_n52_ & ~new_n39_);
  ...
  assign new_n55_ = ~x13 & (x14 ? x15 : ((x02 & ~x03) | ~x16));
  assign new_n56_ = (new_n39_ | x04) & ~new_n39_ & ~new_n58_ & (~x13 | (new_n45_ & new_n57_));
  assign new_n57_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n58_ = x03 & ~x14 & x16;
  assign new_n59_ = x16 & ((~x02 & (~x14 | (x14 & x15))) | (x03 & x14 & x15));
  assign z10 = x04 & (new_n61_ | (x14 & new_n40_ & x15));
  assign new_n61_ = x06 & x07 & x08 & ~new_n62_ & ~new_n63_ & ~x09;
  assign new_n62_ = x14 ? ~x15 : ((~x02 | x03) & x16);
