...
module FAU ( 
  ...
  assign z05 = (x06 & (~x07 | (x08 & ~x09))) | new_n43_ | ~x04 | (x09 & (~x06 | ~x08));
  assign new_n43_ = x16 & (x03 | (~x02 & x04));
  assign z06 = ~new_n45_ | (x06 & (~x07 | (x08 & ~x09 & ~x10)));
  assign new_n45_ = ~new_n43_ & x04 & (~x10 | (x06 & x08 & ~x09));
  assign z07 = new_n47_ | new_n43_ | new_n48_ | ~x04;
  assign new_n47_ = x06 & (~x07 | (x08 & ~x09 & ~x10 & ~x11));
  assign new_n48_ = x11 & (~x06 | ~x08 | x09 | x10);
  assign z08 = new_n43_ | new_n51_ | ~x04 | (~new_n50_ & x06);
  assign new_n50_ = x07 & (~x08 | x09 | x10 | x11 | x12);
  assign new_n51_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = (x04 & (new_n53_ | new_n55_)) | (~new_n56_ & x13) | ~new_n57_ | ~x04;
