...
module FAU ( 
  ...
  assign z09 = new_n44_ | new_n46_ | (~new_n57_ & ~x01) | (~x07 & x13);
  ...
  assign z10 = x04 & ((~x01 & (new_n62_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
  assign new_n62_ = x06 & x07 & x08 & new_n63_ & ~x09;
  assign new_n63_ = ~new_n40_ & (x00 | (~x12 & ~x13 & ~x10 & ~x11));
