...
module FAU ( 
  ...
  assign new_n53_ = x07 & (new_n54_ | ~x14);
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n55_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = new_n44_ | new_n46_ | new_n57_ | (~new_n53_ & x13);
  assign new_n57_ = new_n58_ & x04 & x06 & x07 & x08 & ~x09;
  assign new_n58_ = ~x10 & ~x11 & ~x12 & ~x13 & x14;
  assign z10 = x04 & x14 & (new_n60_ | new_n40_);
