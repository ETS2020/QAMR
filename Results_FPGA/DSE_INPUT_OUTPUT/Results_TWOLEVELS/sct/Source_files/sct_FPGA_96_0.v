...
module FAU ( 
  ...
  assign new_n43_ = ~new_n44_ & (x07 | (~x09 & x15)) & (~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign new_n44_ = x03 & x16 & (x07 | (x04 & x15));
  assign new_n45_ = (x07 | x15) & (~x04 | (~x02 & x04 & x16));
  assign z06 = new_n45_ | new_n44_ | ~new_n47_;
  assign new_n47_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08)) : (~x10 | ~x15);
  assign z07 = new_n45_ | new_n44_ | (~new_n49_ & x07) | (~x07 & x11 & x15);
  assign new_n49_ = (~x11 | (new_n50_ & ~x09 & ~x10)) & (~new_n50_ | x09 | x10 | x11);
  assign new_n50_ = x06 & x08;
  assign z08 = new_n45_ | new_n44_ | ~new_n52_ | (~x07 & (x12 | ~x15));
  assign new_n52_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & (~new_n53_ | x09 | x10 | x11 | x12);
  assign new_n53_ = x06 & x07 & x08;
  assign z09 = new_n45_ | new_n44_ | ~new_n57_ | (new_n55_ & x04);
  assign new_n55_ = x06 & x07 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = (x07 | (~x13 & x15)) & (new_n58_ | ~x13);
  assign new_n58_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((~new_n60_ & x07) | (x14 & new_n39_ & x15));
