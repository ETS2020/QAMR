...
module FAU ( 
  ...
  assign z05 = new_n43_ | new_n44_ | (x06 & (x07 ? (x08 & ~x09) : x09)) | (x07 & x09 & (~x06 | ~x08));
  assign new_n43_ = (x06 | x07) & (~x04 | (~x02 & x04 & x16));
  assign new_n44_ = x03 & x16 & (x07 | (x04 & x06));
  assign z06 = ~new_n46_ | new_n43_;
  assign new_n46_ = ~new_n44_ & (x06 | (x07 & ~x10)) & (~x10 | (x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n43_ | new_n44_ | ~new_n48_;
  assign new_n48_ = (~x06 | ((x07 | ~x11) & (~x07 | ~x08 | x09 | x10 | x11))) & (~x07 | ~x11 | (x06 & x08 & ~x09 & ~x10));
  ...
  assign z09 = new_n43_ | new_n44_ | new_n57_ | (x07 & (new_n53_ | new_n55_));
  ...
  assign new_n57_ = x06 & ~x07 & x13;
  assign z10 = (~x06 & ~x07) | (x04 & ((x06 & new_n59_ & x07) | (new_n39_ & x14)));
  ...
  assign z13 = x04 & (x07 | (x06 & (new_n39_ | (~new_n39_ & ~x07))));
