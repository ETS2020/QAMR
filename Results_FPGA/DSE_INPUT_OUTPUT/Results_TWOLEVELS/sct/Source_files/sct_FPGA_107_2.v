...
module FAU ( 
  ...
  assign z02 = (x06 & ~x07) | (x04 & ~new_n39_ & ~x06);
  ...
  assign new_n46_ = ~new_n44_ & (~x06 | (x07 & (~x08 | x09 | x10))) & (~x10 | (x06 & x08 & ~x09));
  ...
  assign z09 = new_n43_ | new_n44_ | new_n55_ | (x07 & (new_n52_ | new_n54_));
  ...
  assign z10 = x04 & ((x07 & (new_n59_ | (x06 & new_n57_ & x08))) | (new_n59_ & ~x06));
