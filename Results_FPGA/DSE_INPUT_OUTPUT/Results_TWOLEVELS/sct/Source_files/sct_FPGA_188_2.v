...
module FAU ( 
  ...
  assign z06 = ~new_n37_ & (new_n44_ | ~new_n47_);
  assign new_n47_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n37_ & (~new_n49_ | new_n44_);
  assign new_n49_ = (new_n51_ | ~x11) & x04 & (~new_n50_ | x09 | x10 | x11);
  assign new_n50_ = x06 & x07 & x08;
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = ~new_n53_ | (~new_n37_ & (new_n44_ | ~x04));
  assign new_n53_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & ~new_n37_ & (~new_n50_ | x11 | x12 | x09 | x10);
  assign z09 = (~new_n37_ & (new_n44_ | ~x04)) | new_n57_ | new_n37_ | (new_n55_ & x04);
  assign new_n55_ = x06 & x07 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = x13 & (~new_n50_ | x11 | x12 | x09 | x10);
