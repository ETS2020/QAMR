...
module FAU ( 
  ...
  assign new_n46_ = (~x07 | (~x11 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x06 & x07 & x08 & ~x09));
  assign z07 = ~new_n48_ | (x04 & ((~x07 & x11) | (~x02 & ~x11 & x16)));
  assign new_n48_ = (x04 | (x07 & x11)) & (~x07 | (~new_n49_ & ~x11)) & (~x03 | x11 | ~x16);
  assign new_n49_ = x06 & x08 & ~x09 & ~x10;
  assign z08 = new_n44_ | (~x11 & (new_n51_ | (~new_n49_ & x12))) | (~x07 & x12);
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x12;
  assign z09 = new_n44_ | (~new_n53_ & x07) | (~new_n51_ & x13);
