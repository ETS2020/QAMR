...
module FAU ( 
  ...
  assign z06 = x04 ? (new_n39_ | ~new_n44_) : ~x13;
  assign new_n44_ = (~x10 | (x08 & ~x09 & x06 & x07)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n46_ | ~x04 | (new_n39_ & x04);
