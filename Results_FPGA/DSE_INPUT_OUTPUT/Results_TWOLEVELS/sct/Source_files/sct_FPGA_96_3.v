...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n40_ & (~x07 | (x07 & ~x15));
  assign new_n40_ = x16 & (~x02 | x03);
  assign z03 = (x07 & x15) | (x04 & ~new_n40_ & (x06 ? ~x07 : (x07 & ~x15)));
  ...
  assign new_n45_ = ~new_n46_ & (~x07 | (~x15 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign new_n46_ = x03 & x16 & (~x15 | (x04 & ~x07));
  ...
  assign z08 = new_n44_ | new_n46_ | new_n53_ | (x07 & (new_n55_ | x15));
  ...
  assign new_n57_ = ~x15 & (~x04 | ~x06 | ~x08 | ~new_n58_ | x09);
  assign new_n58_ = ~x10 & ~x11 & ~x12 & ~x13 & ~new_n40_ & ~x15;
  assign new_n59_ = x13 & (~new_n54_ | ~new_n51_ | x11 | x12);
  assign z10 = x04 & ((~x15 & (new_n61_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
