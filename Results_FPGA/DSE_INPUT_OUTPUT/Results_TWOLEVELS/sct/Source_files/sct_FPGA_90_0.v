...
module FAU ( 
  ...
  assign z03 = (~x07 & ~x12) | (x04 & ~new_n40_ & (x06 ? (~x07 & x12) : x07));
  assign z04 = x04 & ~new_n40_ & (x07 ? (x06 ^ x08) : (x08 & x12));
  assign z05 = new_n44_ | ~new_n45_;
  assign new_n44_ = ~new_n37_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = ~new_n46_ & (~x07 | ((~x09 | (x06 & x08)) & (~x06 | ~x08 | x09))) & (x07 | ~x09 | ~x12);
  assign new_n46_ = x03 & x16 & (x07 | (x04 & x12));
  assign z06 = new_n44_ | new_n46_ | ~new_n48_;
  assign new_n48_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08)) : (~x10 | ~x12);
  assign z07 = new_n44_ | new_n46_ | ~new_n50_ | (~x07 & (x11 | ~x12));
  assign new_n50_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n52_ | new_n54_;
  assign new_n52_ = x12 & ((~new_n53_ & x04) | ~x04 | x09 | x10 | x11);
  assign new_n53_ = (((~x02 | x03) & x16) | (x06 & (~x06 | x07))) & x08 & ((x02 & ~x03) | ~x16);
  assign new_n54_ = x07 & ((x16 & (x03 | (~x02 & x04))) | new_n55_ | ~x04);
  assign new_n55_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n44_ | new_n46_ | (~new_n57_ & ~x12) | (~new_n55_ & x13);
  assign new_n57_ = x07 & (~x04 | ~x06 | ~x08 | ~new_n58_ | x09);
  ...
  assign new_n61_ = (~x00 | ~x07) & (x12 | x13 | x10 | x11);
  assign z11 = new_n37_ | x02;
  assign z12 = new_n37_ | (x04 & (x03 | (~x02 & ~new_n37_ & x16)));
  assign z13 = x04 & (x07 | (x12 & (new_n40_ | ~x08 | (~x07 & ~new_n40_ & x08))));
