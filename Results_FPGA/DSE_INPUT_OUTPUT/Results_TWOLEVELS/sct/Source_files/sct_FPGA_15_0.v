...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~x06 & (~x07 | x09)) | (x09 & (~x07 | ~x08)) | (x08 & ~x09 & x06 & x07);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | (~x06 & (~x07 | x10)) | (x10 & (~x07 | ~x08 | x09)) | (x06 & x07 & x08 & ~x09 & ~x10);
  assign z07 = new_n44_ | ~new_n47_;
  assign new_n47_ = (~x06 | ((x07 | ~x11) & (~x07 | ~x08 | x09 | x10 | x11))) & (~x07 | ~x11 | (~x09 & ~x10 & x06 & x08));
  assign z08 = new_n44_ | (~new_n49_ & x06) | (new_n50_ & x07);
  assign new_n49_ = (x07 | ~x12) & (x10 | x11 | x12 | ~x07 | ~x08 | x09);
  assign new_n50_ = x12 & (x09 | x10 | x11 | ~x06 | ~x08);
  assign z09 = new_n44_ | (x07 & (new_n52_ | (~new_n54_ & x13))) | (x06 & ~x07 & x13);
