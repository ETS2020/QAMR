...
module FAU ( 
  ...
  assign z07 = ~new_n51_ | (~new_n37_ & (new_n45_ | (~new_n53_ & x11)));
  assign new_n51_ = ~new_n46_ & (~x06 | ~x07 | ~new_n52_ | ~x08);
  assign new_n52_ = ~x09 & ~x10 & ~x11 & (~x13 | (x18 & (~x12 | (x12 & x13))));
  assign new_n53_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = (~new_n55_ & ~new_n37_) | new_n46_ | (x06 & new_n57_ & x07);
  assign new_n55_ = ~new_n45_ & (new_n56_ | ~x12);
  assign new_n56_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n57_ = x08 & ~x09 & ~x10 & ~x11 & ~new_n58_ & ~x12;
  assign new_n58_ = ~x18 & (~x04 | x13 | ((~x02 | x03) & x16));
  assign z09 = new_n48_ | ~new_n63_ | (x06 & new_n60_ & x07);
  assign new_n60_ = x08 & ~x09 & ~x10 & ~x11 & (new_n61_ | new_n62_);
  assign new_n61_ = x04 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n62_ = x12 & x13 & x18;
  assign new_n63_ = (x04 | (~x18 & (x13 | x18))) & (~x13 | new_n56_ | ~x18);
