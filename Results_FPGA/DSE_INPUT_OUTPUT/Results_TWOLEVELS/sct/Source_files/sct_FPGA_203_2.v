...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n39_ & (~x07 | (x07 & x14));
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = (x07 & ~x14) | (x04 & ~new_n39_ & (x06 ? ~x07 : (x07 & x14)));
  assign z04 = (x07 & ~x14) | (x04 & ~new_n39_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = ~new_n43_ | new_n45_;
  assign new_n43_ = ~new_n44_ & (~x07 | (x14 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign new_n44_ = x03 & x16 & (~x07 | (x04 & x14));
  assign new_n45_ = (~x07 | x14) & (~x04 | (~x02 & x04 & x16));
  assign z06 = new_n45_ | new_n44_ | ~new_n47_;
  assign new_n47_ = (~x07 | (x14 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = new_n45_ | new_n44_ | new_n49_ | new_n51_;
  assign new_n49_ = x07 & (~x14 | (x06 & x08 & new_n50_ & ~x09));
  assign new_n50_ = ~x10 & ~x11;
  assign new_n51_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n45_ | new_n44_ | new_n53_ | (~new_n49_ & x12);
  assign new_n53_ = new_n54_ & new_n50_ & ~x12 & x14;
  assign new_n54_ = x08 & ~x09 & x06 & x07;
  assign z09 = new_n45_ | new_n44_ | new_n58_ | (~new_n56_ & x07);
  assign new_n56_ = x14 & (~new_n57_ | ~new_n50_ | x12 | x13 | ~x14);
  assign new_n57_ = x08 & ~x09 & x04 & x06;
  assign new_n58_ = x13 & (~new_n59_ | ~x06 | ~x07 | ~x08);
  assign new_n59_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & x14 & (new_n39_ | (x06 & new_n61_ & x07));
  assign new_n61_ = x08 & ~x09 & (x00 | (new_n50_ & ~x12 & ~x13));
