...
module FAU ( 
  ...
  assign z07 = new_n44_ | new_n48_ | new_n50_;
  assign new_n48_ = x07 & (x17 | (x06 & x08 & new_n49_ & ~x09));
  assign new_n49_ = ~x10 & ~x11;
  assign new_n50_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | (~new_n48_ & x12) | (new_n52_ & new_n49_ & ~x12 & ~x17);
  assign new_n52_ = x06 & x07 & x08 & ~x09;
  assign z09 = new_n44_ | new_n56_ | (x07 & (x17 | (new_n54_ & x04)));
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & new_n55_ & ~x11;
  assign new_n55_ = ~x12 & ~x13 & ~x17 & (~x16 | (x02 & ~x03));
