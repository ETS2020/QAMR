...
module FAU ( 
  ...
  assign new_n48_ = (~x07 | (~x18 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x06 & x07 & x08 & ~x09));
  ...
  assign z08 = new_n44_ | new_n46_ | new_n53_ | (x12 & (new_n55_ | ~x07));
  assign new_n53_ = new_n54_ & ~x12 & ~x18 & ~x10 & ~x11;
  assign new_n54_ = x06 & x07 & x08 & ~x09;
  assign new_n55_ = ~x18 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | new_n46_ | (~x07 & x13) | (~new_n57_ & ~x18);
  ...
  assign new_n63_ = ~x00 & (x10 | x11 | x12 | x13 | x18);
