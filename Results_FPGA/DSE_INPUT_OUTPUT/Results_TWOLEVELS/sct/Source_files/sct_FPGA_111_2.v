...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n40_ & (~x07 | (x07 & x17));
  assign new_n40_ = x16 & (~x02 | x03);
  assign z03 = (x07 & ~x17) | (x04 & ~new_n40_ & (x06 ? ~x07 : (x07 & x17)));
  ...
  assign new_n45_ = ~new_n46_ & (~x07 | (x17 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign new_n46_ = x03 & x16 & ((x04 & ~x07) | x17);
  assign z06 = new_n44_ | new_n46_ | ~new_n48_;
  assign new_n48_ = (~x10 | (x07 & (~x17 | (x06 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | ~x17);
  assign z07 = new_n44_ | ~new_n50_ | new_n46_;
  assign new_n50_ = (~x11 | (x07 & (~x17 | (new_n51_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n51_ | x11 | ~x17);
  assign new_n51_ = ~x09 & ~x10;
  assign z08 = new_n44_ | new_n46_ | new_n53_ | ((new_n55_ | ~x07) & x12);
  assign new_n53_ = new_n54_ & x08 & ~x09 & x06 & x07;
  assign new_n54_ = ~x10 & ~x11 & ~x12 & x17;
  assign new_n55_ = x17 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | new_n46_ | (~x07 & x13) | (~new_n57_ & x17);
  assign new_n57_ = (~new_n58_ | ~x04) & (new_n60_ | ~x13);
  ...
  assign new_n63_ = ~x00 & (x12 | x13 | ~x17 | x10 | x11);
