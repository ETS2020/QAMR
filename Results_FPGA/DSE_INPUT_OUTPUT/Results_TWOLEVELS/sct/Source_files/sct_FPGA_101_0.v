...
module FAU ( 
  ...
  assign z07 = (~x04 & (x03 | x07)) | (x03 & (x16 | (~x07 & x11))) | (~new_n48_ & x07);
  assign new_n48_ = (new_n49_ | ~x11) & ~new_n44_ & ~new_n50_;
  assign new_n49_ = ~x09 & ~x10 & x06 & x08;
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n54_ | (~x07 & (~x03 | x12)) | (~new_n52_ & x07) | (~new_n50_ & x12);
  assign new_n52_ = x04 & ~new_n44_ & ~new_n53_;
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n54_ = x03 & (~x04 | x16);
  assign z09 = new_n54_ | new_n56_ | new_n60_ | (x07 & (~x04 | (~new_n59_ & x04)));
