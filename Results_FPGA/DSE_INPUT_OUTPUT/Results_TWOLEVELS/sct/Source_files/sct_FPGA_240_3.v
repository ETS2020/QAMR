...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~x04 & (~x15 | (~x14 & x15))) | (~new_n45_ & (~x14 | ~x15));
  assign new_n44_ = x16 & ((x03 & ~x14) | (x04 & ((~x02 & (~x14 | (x14 & ~x15))) | (x03 & x14 & ~x15))));
  assign new_n45_ = (~x09 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = new_n44_ | ~new_n47_ | (~x04 & (~x15 | (~x14 & x15)));
  assign new_n47_ = (~x10 | (x08 & ~x09 & x06 & x07)) & ~new_n39_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | (~x04 & (~x15 | (~x14 & x15))) | new_n51_ | new_n49_ | (x14 & x15);
  assign new_n49_ = new_n50_ & ~x09 & ~x10 & ~x11;
  assign new_n50_ = x06 & x07 & x08;
  assign new_n51_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | ~new_n53_ | (~x04 & (~x15 | (~x14 & x15)));
  assign new_n53_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & ~new_n39_ & (~new_n50_ | x11 | x12 | x09 | x10);
  assign z09 = (x04 & (new_n55_ | new_n60_)) | ~new_n57_ | (~x04 & (~x15 | (~x14 & x15)));
  ...
  assign z10 = (x14 & x15) | (x04 & (new_n62_ | (x14 & new_n40_ & ~x15)));
