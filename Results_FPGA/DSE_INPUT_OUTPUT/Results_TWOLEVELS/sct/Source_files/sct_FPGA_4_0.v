...
module FAU ( 
  ...
  assign z06 = new_n44_ | (~x07 & (~x08 | x10)) | ((~x06 | ~x08 | x09) & x10) | (x06 & x07 & x08 & ~x09 & ~x10);
  assign z07 = new_n44_ | ~new_n47_;
  assign new_n47_ = (~x07 | ((x08 | ~x11) & (~x06 | ~x08 | x09 | x10 | x11))) & (~x08 | ~x11 | (x06 & x07 & ~x09 & ~x10));
  assign z08 = new_n44_ | (x07 & (new_n49_ | (~x08 & x12))) | (x08 & ~new_n50_ & x12);
  ...
  assign new_n54_ = (x07 | (x08 & ~x13)) & (new_n49_ | ~x13);
