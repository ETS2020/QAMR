...
module FAU ( 
  ...
  assign z05 = new_n46_ | (~new_n44_ & ~new_n39_);
  ...
  assign z06 = (~new_n39_ & (new_n45_ | ~x04)) | ~new_n48_ | new_n46_;
  assign new_n48_ = (~x10 | (x06 & x07 & x08 & ~x09)) & ~new_n39_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~new_n39_ & (new_n45_ | ~x04)) | ~new_n50_ | new_n46_;
  assign new_n50_ = (new_n52_ | ~x11) & ~new_n39_ & (~new_n51_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x07 & x08;
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = (~new_n39_ & (new_n45_ | ~x04)) | ~new_n54_ | new_n46_;
  assign new_n54_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & ~new_n39_ & (~new_n51_ | x11 | x12 | x09 | x10);
  assign z09 = (~new_n39_ & (new_n45_ | ~x04)) | new_n46_ | new_n58_ | new_n39_ | (new_n56_ & x04);
  assign new_n56_ = x06 & x07 & x08 & ~x09 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = x13 & (~new_n51_ | x11 | x12 | x09 | x10);
  assign z10 = (~x14 & ~x15) | (x04 & (new_n60_ | (new_n40_ & x14)));
