...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n39_ & (~x07 | (x07 & ~x18));
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = (x07 & x18) | (x04 & ~new_n39_ & (x06 ? ~x07 : (x07 & ~x18)));
  assign z04 = (x07 & x18) | (x04 & ~new_n39_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n43_ | (x09 & (~x07 | (~x18 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & ~x18);
  assign new_n43_ = (~x07 | ~x18) & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n43_ | ~new_n45_;
  assign new_n45_ = (~x07 | (~x18 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = ~new_n47_ | new_n43_;
  assign new_n47_ = (~x11 | (x07 & (x18 | (new_n48_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n48_ | x11 | x18);
  assign new_n48_ = ~x09 & ~x10;
  assign z08 = new_n43_ | (x07 & (new_n50_ | x18)) | (~new_n51_ & x12);
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n51_ = ~x09 & ~x10 & ~x11 & x06 & x07 & x08;
  assign z09 = new_n43_ | new_n55_ | (x07 & (x18 | (new_n53_ & x04)));
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & new_n54_ & ~x11;
  assign new_n54_ = ~x12 & ~x13 & ~x18 & (~x16 | (x02 & ~x03));
  assign new_n55_ = x13 & (~new_n56_ | ~x06 | ~x07 | ~x08);
  assign new_n56_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((~x18 & (new_n58_ | (new_n39_ & x14))) | (~x07 & new_n39_ & x14));
