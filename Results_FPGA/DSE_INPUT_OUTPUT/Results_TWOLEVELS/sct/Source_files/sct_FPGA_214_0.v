...
module FAU ( 
  ...
  assign new_n44_ = (~x02 | (x07 & (x03 | ~x04 | x06))) & x04 & (new_n45_ | ~x04);
  assign new_n45_ = (x16 | (x06 & (~x06 | x07))) & x08 & (x02 | ~x16);
  assign new_n46_ = x07 & (new_n47_ | ~x04 | (x16 & (x03 | (~x02 & x04))));
  assign new_n47_ = x06 & x08 & ~x09;
  assign z06 = new_n49_ | (~x09 & (~x07 | (x06 & x08 & ~x10))) | (x10 & (~x06 | ~x08 | x09));
  assign new_n49_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z07 = new_n49_ | ~new_n51_;
  assign new_n51_ = (~x07 | ((~x11 | (x06 & x08 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11))) & (~x09 | ~x11);
  assign z08 = new_n49_ | ~new_n53_;
  assign new_n53_ = (x09 | (x07 & (~new_n54_ | x10 | x11 | x12))) & (~x12 | (new_n54_ & ~x09 & ~x10 & ~x11));
  assign new_n54_ = x06 & x08;
  assign z09 = new_n49_ | (~new_n56_ & ~x09) | (~new_n58_ & x13);
  assign new_n56_ = x07 & (~x04 | ~x06 | ~x08 | ~new_n57_ | x10);
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = new_n47_ & ~x10 & ~x11 & ~x12;
  ...
  assign z11 = x02 & (x07 | (~x07 & x09));
  assign z12 = x04 & ~new_n37_ & (x03 | (~x02 & x16));
  assign z13 = ~new_n65_ & x04;
  assign new_n65_ = ~x07 & (~x09 | ((x07 | ~x08 | ((~x02 | x03) & x16)) & ~x03 & x08 & (x02 | ~x16)));
