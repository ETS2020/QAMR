...
module FAU ( 
  ...
  assign z05 = (~new_n37_ & ~new_n44_) | (~new_n45_ & x09) | new_n37_ | new_n46_;
  assign new_n44_ = x04 & (~x16 | (~x03 & (x02 | ~x04)));
  assign new_n45_ = x06 & x07 & x08;
  assign new_n46_ = x06 & x07 & x08 & ~x09;
  assign z06 = (~new_n48_ & x10) | (~x10 & (new_n46_ | x13)) | (~new_n44_ & ~x13);
  assign new_n48_ = (new_n49_ | ~x04) & x04 & x08 & ~x09 & (~x03 | ~x16);
  assign new_n49_ = (((~x02 | x03) & x16) | (x06 ? x07 : ~x08)) & (x02 | ~x16);
  assign z07 = new_n51_ | ~new_n52_;
  assign new_n51_ = ~new_n37_ & ~new_n44_;
  assign new_n52_ = (~x11 | (~x10 & (new_n46_ | x13))) & (~new_n45_ | x09 | x10 | x11 | x13);
  assign z08 = new_n51_ | new_n57_ | (~x13 & (new_n56_ | (new_n54_ & x04)));
  assign new_n54_ = x06 & x07 & x08 & new_n55_ & ~x09;
  assign new_n55_ = ~x10 & ~x11 & ~x12 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = x12 & (~x06 | ~x07 | ~x08 | x09 | x11);
  assign new_n57_ = x10 & x12;
  assign z09 = x13 | (~x13 & ((x04 & (new_n54_ | (~x02 & x16))) | ~x04 | (x03 & x16)));
