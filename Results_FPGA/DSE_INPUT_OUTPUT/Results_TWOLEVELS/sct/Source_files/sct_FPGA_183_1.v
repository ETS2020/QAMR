...
module FAU ( 
  ...
  assign new_n45_ = (x07 | (~x09 & ~x12)) & (~x09 | (x06 & x08)) & (~x04 | ~x06 | ~x07 | ~x08 | x09);
  ...
  assign z09 = new_n44_ | (~x12 & (new_n54_ | (~new_n56_ & x13))) | (x07 & x12 & x13);
  assign new_n54_ = x04 & x06 & x07 & x08 & new_n55_ & ~x09;
  assign new_n55_ = ~x10 & ~x11 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = ~x09 & ~x10 & ~x11 & x06 & x07 & x08;
  assign z10 = x04 & ((x07 & (new_n58_ | (new_n40_ & x14))) | (~x12 & new_n40_ & x14));
