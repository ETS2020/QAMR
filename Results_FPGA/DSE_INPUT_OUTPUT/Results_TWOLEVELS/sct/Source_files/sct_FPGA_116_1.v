...
module FAU ( 
  ...
  assign z05 = (~x04 & (x02 | ~x07)) | (~x07 & (x09 | (~x02 & x04 & x16))) | (~new_n43_ & x02);
  assign new_n43_ = (~x09 | (x06 & x08)) & ~new_n44_ & (~x08 | x09 | ~x06 | ~x07);
  assign new_n44_ = x03 & x16;
  assign z06 = (~x04 & (x02 | ~x07)) | (~x07 & (x10 | (~x02 & x04 & x16))) | (~new_n46_ & x02);
  ...
  assign z08 = new_n52_ | new_n54_ | ~new_n53_ | (~x07 & (~x04 | x12));
  assign new_n52_ = x02 & (new_n44_ | ~x04);
