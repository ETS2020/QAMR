...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~x07 & (x09 | ~x15)) | (x09 & (~x06 | ~x08)) | (x06 & x07 & x08 & ~x09);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08)) : (~x10 | ~x15);
  assign z07 = new_n44_ | ~new_n48_ | (~x07 & (x11 | ~x15));
  assign new_n48_ = (~x11 | (new_n49_ & ~x09 & ~x10)) & (~new_n50_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x08;
  assign new_n50_ = x06 & x07 & x08;
  assign z08 = new_n44_ | ~new_n52_ | (~x07 & (x12 | ~x15));
  ...
  assign new_n56_ = (x07 | (~x13 & x15)) & (new_n57_ | ~x13);
