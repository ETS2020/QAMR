...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~x07 & x09) | (~x00 & ((x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07)));
  ...
  assign new_n48_ = ~x00 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n49_ = x08 & ~x09 & ~x10;
  assign z08 = new_n44_ | ((new_n51_ | x00) & x07) | (~new_n52_ & x12);
  assign new_n51_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n52_ = ~x09 & ~x10 & ~x11 & x06 & x07 & x08;
  assign z09 = new_n44_ | new_n57_ | (~x00 & (new_n56_ | (new_n54_ & x04)));
