...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (~x07 & x09 & x18);
  ...
  assign z07 = new_n44_ | (~new_n48_ & x07) | (~x07 & x11 & x18);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | ~new_n50_ | (~x07 & (x12 | ~x18));
  assign new_n50_ = (new_n51_ | ~x12) & (~new_n52_ | x09 | x10 | x11 | x12);
  ...
  assign new_n56_ = (x07 | (~x13 & x18)) & (new_n57_ | ~x13);
  ...
  assign new_n61_ = x14 & x16 & x18 & (~x02 | x03);
