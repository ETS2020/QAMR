...
module FAU ( 
  ...
  assign z07 = (x04 & (x07 | (~x02 & ~x07 & x16))) | (x03 & ~x07 & x16) | ~x04 | x11;
  assign z08 = ~x04 | (~x07 & (x12 | (x16 & (x03 | (~x02 & x04)))));
  assign z09 = ~x04 | (~x07 & (x13 | (x16 & (x03 | (~x02 & x04)))));
  assign z10 = x04 & ~x07 & x14 & (~x02 | x03) & x16;
  assign z11 = x02 | (x04 & x07);
  assign z12 = x04 & (x07 | (~x07 & (x03 | (~x02 & x16))));
  assign z13 = x04 & ~x07 & (x03 | (~x02 & x16) | ~x16 | (x02 & ~x03));
