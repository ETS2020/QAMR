...
module FAU ( 
  ...
  assign z08 = new_n43_ | (~new_n49_ & x06) | (x12 & (~new_n48_ | ~x06 | ~x08));
  assign new_n48_ = ~x09 & ~x10 & ~x11;
  assign new_n49_ = x07 & (x10 | x11 | x12 | ~x08 | x09);
  assign z09 = new_n43_ | (~new_n51_ & x06) | (~new_n53_ & x13);
  assign new_n51_ = x07 & (~x04 | ~x07 | ~x08 | x09 | ~new_n52_ | x10);
  assign new_n52_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n53_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z10 = x04 & ((x07 & (new_n57_ | (x06 & new_n55_ & x08))) | (new_n57_ & ~x06));
