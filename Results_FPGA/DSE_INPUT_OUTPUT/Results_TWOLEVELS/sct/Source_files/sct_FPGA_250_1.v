...
module FAU ( 
  ...
  assign new_n45_ = ~new_n46_ & (x07 | (~x09 & ~x18)) & (~x09 | (x06 & x08)) & (~x06 | ~x07 | ~x08 | x09);
  ...
  assign z08 = new_n44_ | new_n46_ | ~new_n53_ | (~x07 & (x12 | x18));
  assign new_n53_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n54_ | x11 | x12 | x09 | x10);
