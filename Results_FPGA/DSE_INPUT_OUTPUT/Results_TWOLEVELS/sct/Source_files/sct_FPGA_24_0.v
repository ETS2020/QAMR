...
module FAU ( 
  ...
  assign z07 = (~new_n48_ & x04) | ~new_n49_ | (~new_n37_ & (~x04 | (x03 & x16)));
  assign new_n48_ = (((~x02 | x03) & x16) | (x06 ? x07 : ~x11)) & (x02 | (~x07 & ~x11) | ~x16);
  assign new_n49_ = x11 ? (x08 & ~x09 & ~x10) : (x07 & (x09 | x10 | ~x06 | ~x08));
  assign z08 = new_n44_ | new_n52_ | (~x11 & (new_n51_ | ~x07));
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x12;
  assign new_n52_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | (x11 & x13) | (x07 & (new_n54_ | (~new_n51_ & x13)));
