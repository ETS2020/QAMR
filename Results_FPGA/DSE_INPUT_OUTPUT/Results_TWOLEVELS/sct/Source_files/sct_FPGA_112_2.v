...
module FAU ( 
  ...
  assign z05 = new_n44_ | new_n47_ | (~new_n45_ & x09) | (new_n46_ & x08 & ~x09);
  assign new_n44_ = ~new_n38_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = (~x04 | x06 | ~x07 | new_n40_ | ~x14) & x07 & x08 & x14;
  assign new_n46_ = x06 & x07;
  assign new_n47_ = x03 & x16 & (~x09 | (x04 & x14));
  assign z06 = new_n44_ | new_n47_ | ~new_n49_;
  assign new_n49_ = (~x09 | (~x10 & x14)) & (~x10 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | new_n47_ | (~new_n51_ & ~x09) | (x09 & x11 & x14);
  assign new_n51_ = (~x11 | (new_n46_ & x08 & ~x10)) & (~new_n46_ | ~x08 | x10 | x11);
  assign z08 = new_n44_ | new_n47_ | (~new_n53_ & ~x09) | (x09 & x12 & x14);
  assign new_n53_ = (~x12 | (x06 & x07 & x08 & ~x10 & ~x11)) & (~x06 | ~x07 | ~x08 | x10 | x11 | x12);
  assign z09 = new_n44_ | new_n47_ | (new_n59_ & x09) | (~x09 & (new_n55_ | new_n57_));
  ...
  assign z10 = (x09 & ~x14) | (x04 & (new_n61_ | (new_n40_ & x14)));
