...
module FAU ( 
  ...
  assign new_n41_ = (x16 | ((x07 | ~x08) & (x02 | (x06 ? (~x07 | x08) : ~x08)))) & (~x02 | x03 | x07 | ~x08);
  ...
  assign z09 = ~new_n59_ | (~x02 & (~x04 | (~new_n58_ & x04)));
  assign new_n58_ = ~x16 & (~new_n44_ | x10 | x11 | x12 | x13 | x16);
  assign new_n59_ = (x07 | (x04 & ~new_n46_ & ~x13)) & (~x02 | ~x07) & (new_n60_ | ~x13);
  assign new_n60_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
