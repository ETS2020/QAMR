...
module FAU ( 
  ...
  assign new_n47_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08)) : (~x10 | x12);
  assign z07 = new_n44_ | (~new_n49_ & x07) | (~x07 & x11 & ~x12);
  assign new_n49_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | new_n51_;
  assign new_n51_ = x07 & ((x12 & ((~new_n52_ & x04) | x10 | x11)) | (new_n52_ & ~x10 & ~x11 & ~x12));
  ...
  assign new_n56_ = (x07 | (~x12 & ~x13)) & (~x13 | (new_n52_ & ~x10 & ~x11 & ~x12));
