...
module FAU ( 
  ...
  assign z06 = new_n43_ | (x06 & (~x07 | (x08 & ~x09 & ~x10))) | (x10 & (~x06 | ~x08 | x09));
  assign z07 = new_n43_ | ~new_n46_;
  assign new_n46_ = (~x06 | (x07 & (~x08 | x09 | x10 | x11))) & (~x11 | (x06 & x08 & ~x09 & ~x10));
  assign z08 = new_n43_ | new_n49_ | (x06 & (new_n48_ | ~x07));
  assign new_n48_ = x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n49_ = x12 & (x09 | x10 | x11 | ~x06 | ~x08);
  assign z09 = new_n43_ | (x07 & (new_n51_ | (~new_n48_ & x13))) | (~x06 & x13);
