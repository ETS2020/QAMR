...
module FAU ( 
  ...
  assign z05 = ~new_n45_ | (x16 & (~x04 | (x04 & (~x02 | x03))));
  assign new_n45_ = (~x09 | (x06 & x07 & x08)) & new_n46_ & (~x08 | x09 | ~x06 | ~x07);
  assign new_n46_ = x15 ? x04 : x16;
  assign z06 = (x16 & (~new_n48_ | (x04 & (~x02 | x03)))) | (~new_n48_ & x15);
  assign new_n48_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (x16 & (~new_n50_ | (x04 & (~x02 | x03)))) | (~new_n50_ & x15);
  assign new_n50_ = (new_n52_ | ~x11) & x04 & (~new_n51_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x07 & x08;
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = ~new_n54_ | (x16 & (~x04 | (x04 & (~x02 | x03))));
  assign new_n54_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & new_n46_ & (~new_n51_ | x11 | x12 | x09 | x10);
  assign z09 = (~new_n37_ & (new_n56_ | ~x04)) | (x04 & (new_n42_ | (new_n57_ & x06)));
  assign new_n56_ = x13 & (~new_n51_ | x09 | x10 | x11 | x12);
  assign new_n57_ = x07 & x08 & ~x09 & ~x10 & new_n58_ & ~x11;
  assign new_n58_ = ~x12 & ~x13 & ((x15 & ~x16) | (x02 & ~x03 & x16));
  assign z10 = x04 & (new_n60_ | (new_n42_ & x14));
