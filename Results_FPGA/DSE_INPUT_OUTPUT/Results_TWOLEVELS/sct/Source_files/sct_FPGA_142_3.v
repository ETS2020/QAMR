...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n40_ & (~x12 | (x12 & ~x17));
  ...
  assign new_n46_ = x08 & ~x09 & (~x12 | (~x17 & (x10 ? x12 : (~x11 | (x11 & x12)))));
  assign z06 = (~new_n37_ & (new_n45_ | ~new_n48_)) | (x06 & new_n49_ & x07);
  assign new_n48_ = x04 & (~x10 | (x08 & ~x09 & x06 & x07));
  assign new_n49_ = x08 & ~x09 & ~x10 & (~x12 | (~x17 & (~x11 | (x11 & x12))));
  ...
  assign z08 = new_n54_ | new_n55_ | (new_n57_ & x06 & x07 & x08);
  assign new_n54_ = ~new_n37_ & (new_n45_ | ~x04);
  assign new_n55_ = x12 & ~x17 & (~new_n56_ | (x04 & ~new_n40_ & ~x06));
  assign new_n56_ = (~x06 | ~x07 | ~x08 | x09 | (~x10 & (x10 | ~x11))) & x07 & x08 & ~x09;
  assign new_n57_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n54_ | (x12 & x13 & ~x17) | (~x12 & (new_n59_ | (~new_n52_ & x13)));
