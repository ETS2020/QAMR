...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x07 & (x17 | (x06 & x08 & ~x09))) | (x09 & (~x06 | ~x07 | ~x08));
  ...
  assign new_n53_ = ~x17 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | new_n59_ | (~x17 & (new_n57_ | (new_n55_ & x04)));
  ...
  assign new_n62_ = ~x00 & (x12 | x13 | x17 | x10 | x11);
