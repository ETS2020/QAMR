...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n39_ & (~x07 | (~x01 & x07));
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = (x01 & x07) | (x04 & ~new_n39_ & ((~x01 & ~x06 & x07) | (x06 & ~x07)));
  assign z04 = (x01 & x07) | (x04 & ~new_n39_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n43_ | (~x01 & ((x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07))) | (~x07 & x09);
