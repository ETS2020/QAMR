...
module FAU ( 
  ...
  assign new_n43_ = x16 & ((x04 & ((~x02 & (x07 | ~x15)) | (x03 & ~x15))) | (x03 & x07));
  assign new_n44_ = (x04 | (x15 & (~x07 | ~x15))) & (x07 | (~x09 & ~x15)) & (~x09 | (x06 & x08)) & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = new_n43_ | ~new_n46_ | (~x04 & (~x15 | (x07 & x15)));
  assign new_n46_ = (x07 | (~x10 & ~x15)) & (~x10 | (x06 & x08 & ~x09)) & (~x08 | x09 | x10 | ~x06 | ~x07);
  assign z07 = new_n43_ | (~x04 & (~x15 | (x07 & x15))) | ~new_n48_ | (~x07 & (x11 | x15));
  assign new_n48_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n43_ | (~x04 & (~x15 | (x07 & x15))) | (~x07 & x12 & ~x15) | (~new_n50_ & x07);
  assign new_n50_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = (x04 & (new_n52_ | new_n56_)) | ~new_n54_ | (~x04 & (~x15 | (x07 & x15)));
  assign new_n52_ = x06 & x07 & x08 & ~x09 & new_n53_ & ~x10;
  assign new_n53_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n54_ = x07 ? ((new_n55_ | ~x13) & (~x03 | ~x16)) : (~x13 | x15);
  assign new_n55_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n56_ = x16 & ((x03 & ~x15) | (~x02 & (x07 | ~x15)));
  assign z10 = (~x07 & x15) | (x04 & (new_n58_ | (new_n39_ & x14)));
