...
module FAU ( 
  ...
  assign new_n44_ = (x04 | (x07 & x14)) & (~x07 | (~x14 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign z06 = new_n43_ | ~new_n46_ | (~x04 & (~x07 | ~x14));
  assign new_n46_ = (~x07 | (~x14 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = new_n43_ | ~new_n48_ | (~x04 & (~x07 | ~x14));
  assign new_n48_ = (~x11 | (x07 & (x14 | (new_n49_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n49_ | x11 | x14);
  assign new_n49_ = ~x09 & ~x10;
  assign z08 = new_n43_ | ~new_n51_ | (~x04 & (~x07 | ~x14));
  assign new_n51_ = (~x12 | (x07 & (new_n54_ | x14))) & (~new_n52_ | ~new_n53_ | x12 | x14);
  assign new_n52_ = x08 & ~x09 & x06 & x07;
  assign new_n53_ = ~x10 & ~x11;
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = (x04 & (new_n56_ | new_n61_)) | ~new_n58_ | (~x04 & (~x07 | ~x14));
  assign new_n56_ = x06 & x07 & x08 & ~x09 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & (~x16 | (x02 & ~x03));
  assign new_n58_ = new_n60_ & (~x13 | (new_n59_ & x06 & x07 & x08));
  assign new_n59_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n60_ = (~x07 | ~x14) & (~x03 | x14 | ~x16);
  assign new_n61_ = x16 & ((~x02 & (~x14 | (~x07 & x14))) | (x03 & ~x07 & x14));
  assign z10 = (x07 & x14) | (x04 & ((x06 & new_n63_ & x07) | (~x07 & new_n39_ & x14)));
  assign new_n63_ = x08 & ~x09 & ~new_n39_ & ~new_n64_;
  assign new_n64_ = ~x00 & (x12 | x13 | x10 | x11);
  assign z11 = x02 | (x07 & x14);
  assign z12 = x04 & ((~x02 & x16 & (~x14 | (~x07 & x14))) | (x03 & (~x07 | ~x14)));
  assign z13 = x04 & (~x14 | (~x07 & (~new_n39_ | (new_n39_ & x14))));
