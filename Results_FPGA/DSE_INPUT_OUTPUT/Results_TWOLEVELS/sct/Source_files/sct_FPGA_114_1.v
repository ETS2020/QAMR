...
module FAU ( 
  ...
  assign z06 = (x03 & (~x04 | x16)) | ~new_n46_ | (x07 & (new_n48_ | ~x03));
  assign new_n46_ = (x07 | (x04 & ~x10 & (x02 | ~x04 | ~x16))) & (new_n47_ | ~x10);
  assign new_n47_ = x06 & x08 & ~x09;
  assign new_n48_ = x06 & x08 & ~x09 & ~x10;
  assign z07 = (x03 & (~x04 | x16)) | ~new_n50_ | (x07 & (new_n51_ | ~x03));
  assign new_n50_ = (x07 | (x04 & ~x11 & (x02 | ~x04 | ~x16))) & (new_n48_ | ~x11);
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (x03 & (~x04 | x16)) | ~new_n53_ | (x07 & (new_n54_ | ~x03));
  assign new_n53_ = (x07 | (x04 & ~x12 & (x02 | ~x04 | ~x16))) & (new_n51_ | ~x12);
  ...
  assign new_n58_ = (x04 | (~x03 & x07)) & (~x03 | (~x16 & (new_n54_ | ~x13))) & (x07 | ~x13);
