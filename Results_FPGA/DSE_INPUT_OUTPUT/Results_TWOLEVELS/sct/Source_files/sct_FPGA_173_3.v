...
module FAU ( 
  ...
  assign z03 = (x02 & (x07 | (~x03 & x04 & x06 & ~x07))) | (x04 & ~x16 & ((x06 & ~x07) | (~x02 & ~x06 & x07)));
  ...
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n48_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign new_n48_ = x04 & x16;
  assign z07 = (~x02 & (~x04 | (x04 & x16))) | ~new_n50_ | (x07 & (new_n52_ | x02));
  assign new_n50_ = (x07 | (x04 & ~new_n44_ & ~x11)) & (new_n51_ | ~x11);
  assign new_n51_ = x06 & x08 & ~x09 & ~x10;
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (~x02 | ~x07)) | (~x07 & (new_n44_ | x12)) | (~new_n54_ & ~x02);
  assign new_n54_ = ~new_n55_ & ~new_n48_ & (~new_n56_ | ~x06 | ~x07 | ~x08);
