...
module FAU ( 
  ...
  assign new_n41_ = (~x07 | ((x03 | (~x06 ^ x08)) & (~x06 | x08 | x16))) & (~x08 | ((x06 | x16) & (x07 | (x16 & (~x02 | x03)))));
  ...
  assign new_n45_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n46_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign new_n46_ = x03 & x16;
  assign z07 = (~x04 & (x02 | ~x07)) | (~x07 & (x11 | (~x02 & x04 & x16))) | (~new_n48_ & x02);
  assign new_n48_ = (~x11 | (new_n49_ & x06 & x08)) & ~new_n46_ & ~new_n50_;
  assign new_n49_ = ~x09 & ~x10;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x02 | ~x07)) | (~x07 & (x12 | (~x02 & x04 & x16))) | (~new_n52_ & x02);
  assign new_n52_ = ~new_n53_ & ~new_n46_ & (~new_n54_ | ~x06 | ~x07 | ~x08);
  assign new_n53_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n54_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x02 | ~x07)) | (~new_n60_ & ~x07) | (x02 & (~new_n58_ | (new_n56_ & x04)));
  assign new_n56_ = x06 & x07 & x08 & new_n57_ & ~x09;
  assign new_n57_ = ~x10 & ~x11 & ~x12 & ~x13 & (~x03 | ~x16);
  assign new_n58_ = ~new_n46_ & (new_n59_ | ~x13);
  assign new_n59_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n60_ = ~x13 & (x02 | ~x04 | ~x16);
  assign z10 = (~x02 & x07) | (x04 & (new_n64_ | (x06 & new_n62_ & x07)));
  assign new_n62_ = x08 & ~x09 & ~new_n46_ & ~new_n63_;
  assign new_n63_ = ~x00 & (x11 | x12 | x13 | ~x02 | x10);
