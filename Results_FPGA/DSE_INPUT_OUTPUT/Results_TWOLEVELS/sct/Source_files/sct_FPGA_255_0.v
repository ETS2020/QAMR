...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n40_ & (x06 ? (~x07 & x12) : x07);
  assign z04 = (~x07 & ~x12) | (x04 & ~new_n40_ & ((x08 & (~x06 | (~x07 & x12))) | (x06 & x07 & ~x08)));
  ...
  assign new_n48_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10)) : (~x10 | ~x12);
  assign z07 = new_n44_ | new_n46_ | (~new_n50_ & x07) | (~x07 & x11 & x12);
  ...
  assign z09 = new_n44_ | new_n46_ | (~new_n55_ & x13) | (~new_n57_ & ~x12);
