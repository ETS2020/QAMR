...
module FAU ( 
  ...
  assign z02 = (x07 & x15) | (x04 & ~x06 & ~new_n40_ & (~x07 | (x07 & ~x15)));
  assign new_n40_ = x16 & (~x02 | x03);
  assign z03 = x04 & ~new_n40_ & (x06 ? ~x07 : (x07 & ~x15));
  assign z04 = x04 & ~new_n40_ & ((x08 & (~x07 | (~x06 & ~x15))) | (x06 & x07 & ~x08 & ~x15));
  assign z05 = new_n44_ | ~new_n45_;
  assign new_n44_ = ~new_n37_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = ~new_n46_ & (~x09 | (x07 & (x15 | (x06 & x08)))) & (~x06 | ~x07 | ~x08 | x09 | x15);
  ...
  assign new_n62_ = ~x00 & (x12 | x13 | x15 | x10 | x11);
