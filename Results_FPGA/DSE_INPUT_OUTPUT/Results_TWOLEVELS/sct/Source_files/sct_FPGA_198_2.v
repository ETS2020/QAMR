...
module FAU ( 
  ...
  assign new_n46_ = (~x07 | (x17 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  ...
  assign new_n51_ = new_n52_ & ~x12 & x17 & ~x10 & ~x11;
  ...
  assign z13 = new_n37_ | (~new_n66_ & x04);
  assign new_n66_ = (((~x02 | x03) & x16) | (x06 & (~x06 | x07))) & ~x03 & ~x17 & (x02 | x07 | ~x16);
  assign z14 = x04 & x17;
endmodule
