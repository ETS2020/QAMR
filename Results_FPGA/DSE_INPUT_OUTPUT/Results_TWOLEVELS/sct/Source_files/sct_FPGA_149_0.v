...
module FAU ( 
  ...
  assign z04 = x04 & ((x07 & (x06 ^ x08) & (new_n41_ | ~x16)) | (new_n41_ & ~x07 & x08 & x16));
  assign new_n41_ = x02 & ~x03;
  assign z05 = (x16 & ((~new_n41_ & x04) | ~x04 | (~x07 & x09))) | (~new_n43_ & x07);
  assign new_n43_ = (~x09 | (x06 & x08)) & x04 & (~x06 | ~x08 | x09);
  assign z06 = (x16 & (~x04 | (~new_n41_ & x04))) | ~new_n46_ | (x07 & (new_n45_ | ~x04));
  assign new_n45_ = x06 & x08 & ~x09 & ~x10;
  assign new_n46_ = (x07 | (~x10 & x16)) & (~x10 | (x06 & x08 & ~x09));
  assign z07 = (~new_n48_ & x07) | (x16 & (~x04 | (~x07 & x11) | (~new_n41_ & x04)));
  assign new_n48_ = (new_n45_ | ~x11) & ~new_n49_ & x04;
  assign new_n49_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n51_ | (x16 & (~x04 | (~new_n41_ & x04)));
  assign new_n51_ = (~x07 | (~new_n52_ & x04)) & (x07 | (~x12 & x16)) & (new_n49_ | ~x12);
  ...
  assign new_n56_ = x16 & ((~new_n41_ & x04) | (~x07 & x13));
  assign z13 = x04 | (~x07 & ~x16);
  assign z10 = (~x07 & ~x16) | (x04 & (new_n61_ | (new_n59_ & x06)));
  assign new_n59_ = x08 & ~x09 & (new_n60_ | (x07 & new_n55_ & ~x10));
  assign new_n60_ = x00 & (~x16 | (x02 & ~x03 & x07));
  assign new_n61_ = x14 & ~new_n41_ & x16;
