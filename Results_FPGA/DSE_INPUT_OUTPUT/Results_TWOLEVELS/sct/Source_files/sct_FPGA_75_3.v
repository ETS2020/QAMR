...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & (~x07 | (~x11 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & ~x11);
  ...
  assign z07 = (x04 & ((~x07 & x11) | (~x02 & ~x11 & x16))) | (~x04 & (~x07 | ~x11)) | (~new_n48_ & ~x11);
  assign new_n48_ = ~new_n49_ & (~x03 | ~x16);
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = new_n44_ | (~x11 & (new_n52_ | (~new_n51_ & x12))) | (~x07 & x12);
  assign new_n51_ = x06 & x08 & ~x09 & ~x10;
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x12;
  assign z09 = new_n44_ | (~new_n54_ & x07) | (~new_n52_ & x13);
  assign new_n54_ = ~x11 & (~x04 | ~x06 | ~x08 | ~new_n55_ | x09);
