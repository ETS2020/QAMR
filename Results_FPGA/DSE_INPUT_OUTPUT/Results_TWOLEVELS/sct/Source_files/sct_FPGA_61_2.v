...
module FAU ( 
  ...
  assign z07 = new_n44_ | new_n46_ | new_n50_ | new_n52_;
  assign new_n50_ = ~new_n51_ & x07;
  assign new_n51_ = x17 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n52_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | new_n46_ | new_n54_ | (~new_n50_ & x12);
  ...
  assign new_n57_ = x17 & (~x04 | ~x06 | ~x08 | ~new_n58_ | x09);
  assign new_n58_ = ~x10 & ~x11 & ~x12 & ~x13 & ~new_n40_ & x17;
  assign new_n59_ = x13 & (~new_n60_ | ~x06 | ~x07 | ~x08);
  assign new_n60_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x17 & (new_n62_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
  assign new_n62_ = x06 & x07 & x08 & new_n63_ & ~x09;
  assign new_n63_ = ~new_n40_ & (x00 | (~x10 & ~x11 & ~x12 & ~x13));
  assign z11 = ~new_n37_ & x02;
  assign z12 = x04 & ~new_n37_ & (x03 | (~x02 & x16));
  assign z13 = new_n37_ | (~new_n37_ & x04);
  assign z14 = x04 & x17;
endmodule
