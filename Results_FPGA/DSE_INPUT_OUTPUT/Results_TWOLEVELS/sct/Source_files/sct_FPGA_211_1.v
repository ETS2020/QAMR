...
module FAU ( 
  ...
  assign new_n45_ = x07 ? ((~x09 | (x06 & x08)) & (~x04 | ~x06 | ~x08 | x09)) : (~x09 | x11);
  assign z06 = new_n44_ | ~new_n47_;
  assign new_n47_ = (x07 | (~x10 & ~x11)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | (~new_n49_ & x07);
  assign new_n49_ = (~x11 | (~x10 & (~x04 | (x06 & x08 & ~x09)))) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | ~new_n51_ | (~x07 & (x11 | x12));
  assign new_n51_ = (~x12 | (new_n52_ & ~x09 & ~x10 & ~x11)) & (~new_n53_ | x11 | x12 | x09 | x10);
  assign new_n52_ = x06 & x08;
  assign new_n53_ = x06 & x07 & x08;
  assign z09 = new_n44_ | (~x11 & (new_n55_ | (~new_n57_ & x13))) | (x07 & x11 & x13);
  assign new_n55_ = x04 & x06 & x07 & x08 & new_n56_ & ~x09;
  assign new_n56_ = ~x10 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = new_n53_ & ~x09 & ~x10 & ~x12;
  ...
  assign z13 = x04 & (~x11 | (x07 & ((x06 & x08 & ~x09) | (x11 & (~x06 | ~x08 | x09)))));
