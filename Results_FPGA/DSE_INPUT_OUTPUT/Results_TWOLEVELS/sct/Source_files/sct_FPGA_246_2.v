...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n40_ & ((x08 & (~x07 | (~x06 & x14))) | (x06 & x07 & ~x08 & x14));
  assign z05 = new_n44_ | ~new_n45_;
  assign new_n44_ = ~new_n38_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = ~new_n46_ & (~x07 | (x14 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign new_n46_ = x03 & x16 & (~x07 | (x04 & x14));
  assign z06 = new_n44_ | new_n46_ | ~new_n48_;
  assign new_n48_ = (~x10 | (x07 & (~x14 | (x06 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | ~x14);
