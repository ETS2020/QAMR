...
module FAU ( 
  ...
  assign new_n46_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10)) : (~x10 | x12);
  assign z07 = new_n44_ | (~new_n48_ & x07) | (~x07 & x11 & ~x12);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (x12 & (~new_n50_ | x09 | x10 | x11)) | (new_n50_ & ~x09 & ~x10 & ~x11 & ~x12);
  assign new_n50_ = x06 & x07 & x08;
  assign z09 = new_n44_ | (~x12 & (new_n53_ | (~new_n52_ & x13))) | (x07 & x12 & x13);
  assign new_n52_ = new_n50_ & ~x09 & ~x10 & ~x11;
