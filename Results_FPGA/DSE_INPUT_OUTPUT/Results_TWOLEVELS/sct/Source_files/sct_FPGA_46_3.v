...
module FAU ( 
  ...
  assign z06 = (x03 & (x07 | (~x07 & x16))) | ~new_n47_ | (~new_n46_ & ~x03);
  assign new_n46_ = ~new_n44_ & x04;
  assign new_n47_ = (x07 | (x04 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x08 | x09 | x10 | ~x06 | ~x07);
  assign z07 = (x03 & (x07 | (~x07 & x16))) | (~new_n46_ & ~x03) | ~new_n50_ | (~new_n49_ & ~x07);
  ...
  assign z09 = (x03 & (x07 | (~x07 & x16))) | new_n56_ | ~new_n58_ | (~new_n46_ & ~x03);
  assign new_n56_ = x04 & x06 & x07 & x08 & new_n57_ & ~x09;
  assign new_n57_ = ~x10 & ~x11 & ~x12 & ~x13 & (x02 | ~x16);
  assign new_n58_ = (x07 | (x04 & ~x13)) & (new_n59_ | ~x13);
  assign new_n59_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z10 = (x03 & x07) | (x04 & (new_n63_ | (x06 & new_n61_ & x07)));
  assign new_n61_ = x08 & ~x09 & ~new_n62_ & (x02 | ~x16);
