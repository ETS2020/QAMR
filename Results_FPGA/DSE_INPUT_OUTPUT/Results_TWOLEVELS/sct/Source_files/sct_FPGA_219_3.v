...
module FAU ( 
  ...
  assign new_n47_ = (~x07 | (~x05 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = new_n44_ | (~x04 & (~x05 | (x05 & ~x07))) | (~new_n49_ & ~x05) | (~x07 & x11);
  assign new_n49_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~x04 & (~x05 | (x05 & ~x07))) | new_n51_ | (x07 & (new_n53_ | x05));
  assign new_n51_ = ~new_n52_ & x12;
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n53_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n44_ | (~x05 & (~x04 | (new_n55_ & x04))) | new_n57_ | (x05 & (x07 | (~x04 & ~x07)));
