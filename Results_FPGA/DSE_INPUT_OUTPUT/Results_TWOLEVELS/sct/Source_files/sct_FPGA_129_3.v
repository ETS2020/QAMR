...
module FAU ( 
  ...
  assign new_n44_ = ~new_n37_ & (new_n45_ | ~x04);
  assign new_n45_ = x16 & (x03 | (~x02 & x04));
  assign z06 = x10 ? ~x07 : (new_n45_ | ~x04 | (new_n47_ & x06 & x07));
  assign new_n47_ = x08 & ~x09;
  assign z07 = new_n44_ | ~new_n49_;
  assign new_n49_ = (x10 | ((~x11 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x11))) & (x07 | ~x11);
  assign z08 = new_n44_ | new_n52_ | (x07 & (new_n51_ | x10));
  assign new_n51_ = x06 & x08 & ~x09 & ~x11 & ~x12;
  assign new_n52_ = x12 & (~x06 | ~x07 | ~x08 | x09 | x11);
  assign z09 = new_n44_ | (~x10 & (new_n54_ | (~new_n51_ & x13))) | (~x07 & x13);
  assign new_n54_ = x04 & x06 & x07 & x08 & new_n55_ & ~x09;
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign z10 = x04 & ((~x10 & (new_n57_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
  assign new_n57_ = x06 & x07 & x08 & ~x09 & ~new_n40_ & ~new_n58_;
  assign new_n58_ = ~x00 & (x11 | x12 | x13);
