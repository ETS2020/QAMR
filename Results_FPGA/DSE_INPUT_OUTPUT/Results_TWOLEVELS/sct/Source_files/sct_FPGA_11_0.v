...
module FAU ( 
  ...
  assign z05 = new_n43_ | (x06 & (x07 ? (x08 & ~x09) : x09)) | (x07 & x09 & (~x06 | ~x08));
  assign new_n43_ = (x06 | x07) & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n43_ | (x06 & ((~x07 & x10) | (x07 & x08 & ~x09 & ~x10))) | (x07 & x10 & (~x06 | ~x08 | x09));
  assign z07 = new_n43_ | ~new_n46_;
  assign new_n46_ = (x06 | (x07 & ~x11)) & (~x11 | (~x09 & ~x10 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  ...
  assign z13 = x04 & (x06 | (x07 & (x03 | (~x02 & x16) | (~x06 & ((x02 & ~x03) | ~x16)))));
