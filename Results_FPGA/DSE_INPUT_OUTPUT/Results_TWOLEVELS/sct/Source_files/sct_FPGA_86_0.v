...
module FAU ( 
  ...
  assign new_n43_ = ~new_n44_ & (x07 | (x01 & ~x09)) & (~x09 | (x06 & x08)) & (~x06 | ~x07 | ~x08 | x09);
  assign new_n44_ = x03 & x16 & (x07 | (x01 & x04));
  assign new_n45_ = (x01 | x07) & (~x04 | (~x02 & x04 & x16));
  assign z06 = new_n45_ | (x01 & (new_n47_ | (~x07 & x10))) | (~new_n48_ & x07);
  assign new_n47_ = x03 & x04 & x16;
  assign new_n48_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10) & (~x03 | ~x16);
  assign z07 = new_n45_ | new_n44_ | ~new_n50_ | (~x07 & (~x01 | x11));
  assign new_n50_ = (~x11 | (new_n51_ & ~x09 & ~x10)) & (~new_n52_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x08;
  assign new_n52_ = x06 & x07 & x08;
  assign z08 = new_n45_ | new_n44_ | ~new_n54_ | (~x07 & (~x01 | x12));
  assign new_n54_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n52_ | x09 | x10 | x11 | x12);
  assign z09 = new_n45_ | new_n44_ | ~new_n58_ | (new_n56_ & x04);
  assign new_n56_ = x06 & x07 & x08 & ~x09 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = (x07 | (x01 & ~x13)) & (new_n59_ | ~x13);
