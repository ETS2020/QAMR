// Benchmark "FAU" written by ABC on Mon Aug 24 17:21:18 2020
...
module FAU ( 
  ...
  assign z08 = x12 | (~x12 & ((x16 & (x03 | (~x02 & x04))) | new_n51_ | ~x04));
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = new_n44_ | (~x12 & (new_n53_ | (~new_n55_ & x13))) | (~x07 & x13);
  assign new_n53_ = x04 & x06 & x07 & x08 & new_n54_ & ~x09;
  assign new_n54_ = ~x10 & ~x11 & ~x13 & ((x02 & ~x03) | ~x16);
