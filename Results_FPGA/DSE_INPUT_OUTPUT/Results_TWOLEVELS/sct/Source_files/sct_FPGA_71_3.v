...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n40_, new_n44_, new_n45_, new_n46_, new_n49_, new_n51_,
  ...
  assign z05 = new_n44_ | (x09 & (~x08 | (~new_n46_ & ~x10))) | (new_n46_ & x08 & ~x09 & ~x10);
  assign new_n44_ = ~new_n37_ & (new_n45_ | ~x04);
  assign new_n45_ = x16 & (x03 | (~x02 & x04));
  assign new_n46_ = x06 & x07;
  assign z06 = x10 ? ~x08 : (new_n45_ | ~x04 | (new_n46_ & x08 & ~x09));
  assign z07 = new_n44_ | ~new_n49_;
  assign new_n49_ = (x10 | ((~x11 | (x06 & x07 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x11))) & (x08 | ~x11);
  assign z08 = new_n44_ | ~new_n51_;
  assign new_n51_ = (~x08 | (~x10 & (~new_n46_ | x09 | x11 | x12))) & (~x12 | (new_n46_ & x08 & ~x09 & ~x11));
  assign z09 = new_n44_ | (~new_n53_ & x08) | (~new_n55_ & x13);
  assign new_n53_ = ~x10 & (~x04 | ~x06 | ~x07 | ~new_n54_ | x09);
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = ~x09 & ~x11 & ~x12 & x06 & x07 & x08;
