...
module FAU ( 
  ...
  assign z05 = (x02 & (~x04 | (x03 & x16))) | ~new_n44_ | (~x02 & (~x07 | (x04 & x07 & x16)));
  assign new_n44_ = (~x07 | (x04 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign z06 = (x02 & (~x04 | (x03 & x16))) | ~new_n46_ | (~x02 & (~x07 | (x04 & x07 & x16)));
  assign new_n46_ = (~x07 | (x04 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = (~x04 & (x02 | x07)) | (x02 & (new_n50_ | (~x07 & x11))) | (~new_n48_ & x07);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & ~new_n49_ & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n49_ = ~x02 & x04 & x16;
  assign new_n50_ = x03 & x16;
  assign z08 = (~x04 & (x02 | x07)) | (x02 & (new_n50_ | (~x07 & x12))) | (~new_n52_ & x07);
  assign new_n52_ = ~new_n53_ & ~new_n49_ & ~new_n54_;
  ...
  assign new_n60_ = ~new_n50_ & (x07 | ~x13);
