...
module FAU ( 
  ...
  assign new_n50_ = x07 & (~x15 | (x06 & x08 & new_n51_ & ~x09));
  assign new_n51_ = ~x10 & ~x11;
  assign new_n52_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | ~new_n54_ | new_n46_;
  assign new_n54_ = (new_n50_ | ~x12) & (~new_n55_ | ~new_n51_ | x12 | ~x15);
  assign new_n55_ = x08 & ~x09 & x06 & x07;
  assign z09 = new_n44_ | new_n46_ | (~x07 & x13) | (~new_n57_ & x15);
  ...
  assign new_n62_ = x06 & x07 & x08 & ~x09 & ~new_n63_ & ~new_n40_;
  assign new_n63_ = ~x00 & (~new_n51_ | x12 | x13 | ~x15);
