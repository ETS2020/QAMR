...
module FAU ( 
  ...
  assign z02 = (x06 & ~x14) | (x04 & ~new_n40_ & ~x06);
  assign new_n40_ = x16 & (~x02 | x03);
  assign z03 = (x06 & ~x14) | (x04 & ~new_n40_ & (~x06 ^ ~x07));
  assign z04 = (x06 & ~x14) | (x04 & ~new_n40_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n44_ | ~new_n45_;
  assign new_n44_ = ~new_n38_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = ~new_n46_ & (~x09 | (x06 & (~x14 | (x07 & x08)))) & (~x06 | ~x07 | ~x08 | x09 | ~x14);
  assign new_n46_ = x03 & x16 & (~x06 | (x04 & x14));
  assign z06 = new_n44_ | new_n46_ | ~new_n48_;
  assign new_n48_ = (~x10 | (x06 & (~x14 | (x07 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | ~x14);
  assign z07 = new_n44_ | new_n46_ | new_n51_ | (~new_n50_ & x06);
  assign new_n50_ = x14 & (~x07 | ~x08 | x09 | x10 | x11);
  assign new_n51_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | ~new_n53_ | new_n46_;
  assign new_n53_ = (~x06 | (~new_n54_ & x14)) & (new_n55_ | ~x12);
  assign new_n54_ = x07 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n55_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = new_n44_ | new_n46_ | new_n59_ | (~new_n57_ & x06);
  assign new_n57_ = x14 & (~new_n58_ | x12 | x13 | ~x14 | x10 | x11);
  assign new_n58_ = x08 & ~x09 & x04 & x07;
  ...
  assign z13 = x04 & (x14 | (~x06 & (x03 | (x02 & ~x03) | ~x16 | (~x02 & x16))));
