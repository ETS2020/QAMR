...
module FAU ( 
  ...
  assign z05 = (x04 & ((~new_n44_ & x07) | (~new_n45_ & x09))) | (~x04 & (x07 | x09)) | (~new_n46_ & x09);
  ...
  assign new_n52_ = (~x07 | ((~x11 | (x06 & x08 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11))) & (~x09 | ~x11);
  assign z08 = new_n48_ | ~new_n54_ | new_n50_;
  assign new_n54_ = (x09 | (x07 & (~new_n55_ | x10 | x11 | x12))) & (~x12 | (new_n55_ & ~x09 & ~x10 & ~x11));
  assign new_n55_ = x06 & x08;
  assign z09 = new_n48_ | new_n50_ | new_n60_ | (x07 & (new_n57_ | new_n59_));
  assign new_n57_ = x04 & x06 & x08 & ~x09 & new_n58_ & ~x10;
  assign new_n58_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n59_ = x13 & (~new_n55_ | x10 | x11 | x12);
  assign new_n60_ = x09 & x13;
  assign z10 = new_n37_ | (~new_n62_ & x04);
  assign new_n62_ = (~x06 | ~x08 | new_n40_ | new_n63_ | x09) & (~new_n40_ | ~x14);
  assign new_n63_ = ~x00 & (~x07 | x10 | x11 | x12 | x13);
