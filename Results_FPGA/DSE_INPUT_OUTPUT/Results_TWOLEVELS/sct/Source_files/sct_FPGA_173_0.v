...
module FAU ( 
  ...
  assign z06 = (~x04 & (x02 | x07)) | (~new_n47_ & x07) | (x02 & (new_n42_ | (~x07 & x10)));
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n48_ & (~x06 | ~x08 | x09 | x10);
  assign new_n48_ = ~x02 & x04 & x16;
  assign z07 = (x02 & (~x04 | (x03 & x16))) | ~new_n50_ | (~x02 & (~x07 | (x04 & x07 & x16)));
  assign new_n50_ = ((~new_n51_ & x04) | ~x07) & (~x11 | (new_n52_ & x06 & x07));
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n52_ = x08 & ~x09 & ~x10;
  assign z08 = (~x04 & (x02 | x07)) | (~new_n54_ & x07) | (x02 & (new_n42_ | (~x07 & x12)));
  assign new_n54_ = (new_n51_ | ~x12) & ~new_n48_ & ~new_n55_;
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x02 | x07)) | (x07 & (new_n60_ | (~new_n57_ & x04))) | (~new_n61_ & x02);
  assign new_n57_ = ~new_n59_ & (~x06 | ~x08 | x09 | ~new_n58_ | x10);
  assign new_n58_ = ~x11 & ~x12 & ~x13 & (~x16 | (x02 & ~x03));
  assign new_n59_ = ~x02 & x16;
  assign new_n60_ = ~new_n55_ & x13;
  assign new_n61_ = ~new_n42_ & (x07 | ~x13);
  assign z10 = (~x02 & ~x07) | (x04 & (new_n63_ | (new_n43_ & x14)));
  assign new_n63_ = x06 & x07 & x08 & ~x09 & ~new_n43_ & ~new_n64_;
