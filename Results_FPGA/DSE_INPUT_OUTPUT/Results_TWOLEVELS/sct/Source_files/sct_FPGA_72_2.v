...
module FAU ( 
  ...
  assign new_n42_ = (~x08 | ((~x02 | x03 | (x07 & (x06 | ~x16))) & (x07 | x16))) & (~x02 | x03 | ~x06 | ~x07 | x08 | ~x16);
  assign z05 = ~new_n44_ | (x16 & (~x04 | (~new_n39_ & x04)));
  assign new_n44_ = (~x07 | (x16 & (~x06 | ~x08 | x09))) & (x07 | (x04 & ~x09)) & (~x09 | (x06 & x08));
  assign z06 = (x16 & (~new_n46_ | (~new_n39_ & x04))) | (~x07 & (~x04 | x10));
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~x07 & (~x04 | x11)) | (x16 & (~new_n48_ | (~new_n39_ & x04)));
  assign new_n48_ = (~x11 | (new_n49_ & ~x09 & ~x10)) & x04 & (~new_n50_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x08;
  assign new_n50_ = x06 & x07 & x08;
  assign z08 = (~x07 & (~x04 | x12)) | (x16 & (~new_n52_ | (~new_n39_ & x04)));
  assign new_n52_ = ~new_n53_ & x04 & (~new_n50_ | ~new_n54_);
  assign new_n53_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n54_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (~x07 | x16)) | (~x07 & x13) | (x16 & ((~new_n56_ & x04) | (~new_n58_ & x13)));
  assign new_n56_ = x02 & ~x03 & (~new_n57_ | ~new_n50_ | ~x02 | x03);
