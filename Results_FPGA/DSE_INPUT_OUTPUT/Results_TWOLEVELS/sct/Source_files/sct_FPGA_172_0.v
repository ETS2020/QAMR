...
module FAU ( 
  ...
  assign z05 = ~new_n37_ & (~new_n44_ | (x16 & (x03 | (~x02 & x04))));
  assign new_n44_ = (~x09 | (x06 & x07 & x08)) & x04 & (~x08 | x09 | ~x06 | ~x07);
  assign z06 = ~new_n46_ | (~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04)))));
  assign new_n46_ = (~x10 | (x08 & ~x09 & x06 & x07)) & ~new_n37_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n37_ & (~new_n48_ | (x16 & (x03 | (~x02 & x04))));
  assign new_n48_ = (new_n50_ | ~x11) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x07 & x08;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = ~new_n52_ | (~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04)))));
  assign new_n52_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & ~new_n37_ & (~new_n49_ | x11 | x12 | x09 | x10);
  assign z09 = new_n56_ | new_n37_ | (~new_n37_ & ((x04 & (new_n54_ | new_n57_)) | new_n58_ | ~x04));
  ...
  assign z10 = x04 & ~new_n37_ & (new_n60_ | (new_n40_ & x14));
