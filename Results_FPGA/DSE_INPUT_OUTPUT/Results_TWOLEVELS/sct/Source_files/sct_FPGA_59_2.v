...
module FAU ( 
  ...
  assign new_n44_ = (~x04 | ((~x09 | new_n45_ | (x16 & (~x02 | x03))) & (x02 | ~x16))) & x04 & (~x03 | ~x16);
  assign new_n45_ = x06 & (~x06 | ~x07 | x08);
  assign new_n46_ = (~x16 | (~x03 & (x02 | ~x04))) & ~new_n47_ & (x04 | x18);
  assign new_n47_ = x06 & x07 & x08;
  assign z06 = new_n49_ | (~x04 & (x18 | (~x09 & ~x18))) | (~new_n50_ & ~x09) | (x09 & x10 & x18);
  assign new_n49_ = x16 & (~x09 | x18) & (x03 | (~x02 & x04));
  assign new_n50_ = (~x10 | (x06 & x07 & x08)) & (~x08 | x10 | ~x06 | ~x07);
  assign z07 = new_n49_ | (~x04 & (x18 | (~x09 & ~x18))) | (~new_n52_ & ~x09) | (x09 & x11 & x18);
  assign new_n52_ = (~x11 | (x08 & ~x10 & x06 & x07)) & (~x06 | ~x07 | ~x08 | x10 | x11);
  assign z08 = new_n49_ | (~x04 & (x18 | (~x09 & ~x18))) | (~new_n54_ & ~x09) | (x09 & x12 & x18);
  assign new_n54_ = (~x12 | (x06 & x07 & x08 & ~x10 & ~x11)) & (~x06 | ~x07 | ~x08 | x10 | x11 | x12);
  assign z09 = new_n49_ | new_n60_ | (~x09 & (new_n56_ | ~new_n58_));
  assign new_n56_ = x04 & x06 & x07 & x08 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = (x04 | x18) & (~x13 | (new_n47_ & new_n59_));
  assign new_n59_ = ~x10 & ~x11 & ~x12;
  assign new_n60_ = x18 & (~x04 | (x09 & x13));
  assign z10 = x04 & (new_n64_ | (~new_n62_ & ~x09));
  assign new_n62_ = (~x06 | ~x07 | ~x08 | new_n39_ | new_n63_) & (~new_n39_ | ~x14);
