...
module FAU ( 
  ...
  wire new_n37_, new_n40_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_,
    new_n53_, new_n54_, new_n55_, new_n57_, new_n61_;
  ...
  assign z03 = (~x07 & ~x13) | (x04 & ~new_n40_ & (x06 ? (~x07 & x13) : x07));
  assign z04 = (~x07 & ~x13) | (x04 & ~new_n40_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n44_ | (~x07 & (x09 | ~x13)) | (x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07);
  ...
  assign z08 = new_n44_ | (~new_n50_ & x07) | (~x07 & x12 & x13);
  assign new_n50_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = new_n44_ | new_n55_ | (new_n52_ & x04);
  assign new_n52_ = ~new_n40_ & (x06 ? ((~x07 & x13) | (new_n54_ & new_n53_ & x07)) : x13);
  assign new_n53_ = x08 & ~x09;
  assign new_n54_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign new_n55_ = x13 & (~new_n53_ | x10 | x11 | x12);
  ...
  assign z13 = ~new_n61_ & x04;
  assign new_n61_ = ~x07 & (~x13 | (~x03 & (x02 | ~x16) & (((~x02 | x03) & x16) | (x06 & (~x06 | x07)))));
