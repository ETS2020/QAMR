...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n40_ & ((x07 & (x06 ^ x08)) | (~x01 & ~x07 & x08));
  assign z05 = new_n44_ | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (~x01 & ~x07 & x09);
  assign new_n44_ = ~new_n38_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (x07 | (~x01 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | (~new_n48_ & x07) | (~x01 & ~x07 & x11);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~new_n50_ & x07) | (~x01 & ~x07 & x12);
  ...
  assign new_n54_ = (x07 | (~x01 & ~x13)) & (new_n55_ | ~x13);
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x07 & (new_n57_ | (new_n40_ & x14))) | (~x01 & new_n40_ & x14));
