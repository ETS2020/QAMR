...
module FAU ( 
  ...
  assign z08 = new_n43_ | (~x06 & x12) | (~new_n48_ & x07);
  assign new_n48_ = (~x12 | (~x10 & ~x11 & x08 & ~x09)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = new_n43_ | (x07 & (new_n50_ | (~new_n52_ & x13))) | (~x06 & x13);
  assign new_n50_ = x04 & x06 & x08 & ~x09 & new_n51_ & ~x10;
