...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ((~x03 & (x02 | (x07 & ~x16))) | (~x07 & ~x16));
  assign z03 = x04 & ((~x03 & ((x02 & (x06 ^ x07)) | (~x06 & x07 & ~x16))) | (x06 & ~x07 & ~x16));
  assign z04 = (x03 & x07) | (~new_n41_ & x04);
  assign new_n41_ = (~x08 | (x06 & x07) | ((~x02 | x03) & x16)) & (~x06 | ~x07 | x08 | (~x02 & x16));
  assign z05 = new_n43_ | new_n44_ | ~new_n45_;
  assign new_n43_ = x03 & (x07 | (~x07 & x16));
  assign new_n44_ = ~x03 & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = (x07 | (x04 & ~x09)) & (~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign z06 = new_n43_ | new_n44_ | ~new_n47_;
  assign new_n47_ = (x07 | (x04 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x08 | x09 | x10 | ~x06 | ~x07);
  assign z07 = new_n43_ | new_n44_ | ~new_n49_ | (~x07 & (~x04 | x11));
  assign new_n49_ = (~x11 | (new_n50_ & ~x09 & ~x10)) & (~new_n51_ | x09 | x10 | x11);
  assign new_n50_ = x06 & x08;
  assign new_n51_ = x06 & x07 & x08;
  assign z08 = new_n43_ | new_n44_ | ~new_n53_ | (~x07 & (~x04 | x12));
  assign new_n53_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & (~new_n51_ | x11 | x12 | x09 | x10);
  assign z09 = (~x04 & (~x03 | ~x07)) | (~x03 & (new_n58_ | (~new_n55_ & x04))) | (~new_n60_ & ~x07);
  assign new_n55_ = ~new_n56_ & (~x06 | ~x07 | ~x08 | ~new_n57_ | x09);
  assign new_n56_ = ~x02 & x16;
  assign new_n57_ = ~x10 & ~x11 & ~x12 & ~x13 & (x02 | ~x16);
  assign new_n58_ = ~new_n59_ & x13;
  assign new_n59_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n60_ = ~x13 & (~x03 | ~x16);
  assign z10 = x04 & ((~x03 & (new_n62_ | (new_n64_ & ~x02))) | (new_n64_ & x03 & ~x07));
  assign new_n62_ = x06 & x07 & x08 & ~x09 & ~new_n56_ & ~new_n63_;
