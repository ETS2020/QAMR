...
module FAU ( 
  ...
  assign z06 = new_n44_ | (x07 & ((x09 & x10) | (x06 & x08 & ~x09 & ~x10))) | (~x09 & x10 & (~x06 | ~x07 | ~x08));
  assign z07 = new_n44_ | ~new_n47_;
  assign new_n47_ = (x07 | (~x09 & ~x11)) & (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (x07 & (new_n49_ | (x09 & x12))) | (~x09 & ~new_n50_ & x12);
  assign new_n49_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n50_ = x08 & ~x10 & ~x11 & x06 & x07;
  ...
  assign new_n54_ = (x07 | (~x09 & ~x13)) & (new_n49_ | ~x13);
