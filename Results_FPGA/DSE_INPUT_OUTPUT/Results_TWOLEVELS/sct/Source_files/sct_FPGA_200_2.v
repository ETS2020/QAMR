...
module FAU ( 
  ...
  assign z02 = (x02 & (~x07 | (~x03 & x04 & ~x06))) | (x04 & ~x06 & ~x16 & (~x02 | x07));
  assign z03 = (x02 & (~x07 | (~x03 & x04 & ~x06))) | (x04 & ~x16 & ((~x06 & x07) | (~x02 & x06 & ~x07)));
  assign z04 = ~new_n41_ & x04;
  assign new_n41_ = (~x07 | (~x06 ^ x08) | ((~x02 | x03) & x16)) & (x02 | x07 | ~x08 | x16);
  assign z05 = (~x04 & (~x02 | x07)) | (~x02 & ((~x07 & x09) | (x04 & x16))) | (~new_n43_ & x07);
  assign new_n43_ = (~x09 | (x06 & x08)) & (~x06 | ~x08 | x09) & (~x03 | ~x16);
  assign z06 = (~x04 & (~x02 | x07)) | (~x02 & ((~x07 & x10) | (x04 & x16))) | (~new_n45_ & x07);
  ...
  assign z08 = (~x04 & (~x02 | x07)) | (~x02 & ((~x07 & x12) | (x04 & x16))) | (~new_n51_ & x07);
  assign new_n51_ = (new_n48_ | ~x12) & ~new_n52_ & (~x03 | ~x16);
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~new_n54_ & x02) | (~x02 & (~x04 | (x04 & x16))) | new_n56_ | new_n59_;
  assign new_n54_ = x07 & (~new_n55_ | x03 | ~x04 | ~x06 | ~x07 | ~x08);
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ~x09 & ~x10;
  assign new_n56_ = x07 & (~x04 | (x03 & x16) | (new_n57_ & new_n58_));
  assign new_n57_ = x08 & ~x09 & x04 & x06;
  assign new_n58_ = ~x12 & ~x13 & ~x16 & ~x10 & ~x11;
  ...
  assign z13 = x04 & (x07 | (~x02 & (x16 | (~x16 & (~x06 | (x06 & ~x07))))));
