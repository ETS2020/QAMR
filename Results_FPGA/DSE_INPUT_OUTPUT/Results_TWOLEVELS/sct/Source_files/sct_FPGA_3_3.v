// Benchmark "FAU" written by ABC on Mon Aug 24 17:20:29 2020
...
module FAU ( 
  ...
  assign new_n43_ = ~new_n44_ & (~x07 | (~x18 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  ...
  assign z07 = new_n45_ | new_n44_ | new_n50_ | (~new_n49_ & x07);
  assign new_n49_ = ~x18 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n50_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n45_ | new_n44_ | new_n52_ | (x07 & (new_n54_ | x18));
  ...
  assign new_n58_ = x13 & (~new_n53_ | x11 | x12 | x09 | x10);
  assign z10 = (x07 & x18) | (x04 & (new_n60_ | (new_n39_ & x14)));
  assign new_n60_ = x06 & x07 & x08 & ~x09 & ~new_n39_ & ~new_n61_;
  assign new_n61_ = ~x00 & (x12 | x13 | x10 | x11);
  assign z11 = x02 | (x07 & x18);
  assign z12 = (x07 & x18) | (x04 & (x03 | (~x02 & x16 & (~x07 | ~x18))));
