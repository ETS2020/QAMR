...
module FAU ( 
  ...
  assign z07 = ~new_n50_ | (x07 & (new_n49_ | ~x04 | (new_n40_ & x04)));
  assign new_n49_ = new_n45_ & ~x09 & ~x10 & ~x11;
  assign new_n50_ = (x07 | (~x11 & ~x16)) & (new_n51_ | ~x11) & (x04 | x16);
  assign new_n51_ = x06 & x08 & ~x09 & ~x10;
  assign z08 = (~new_n53_ & x07) | (~x07 & (x12 | x16)) | (~x04 & ~x16) | (~new_n49_ & x12);
  assign new_n53_ = (~new_n40_ | ~x04) & ~new_n54_ & x04;
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x07 | ~x16)) | (x07 & ((~new_n54_ & x13) | (~new_n56_ & x04))) | (~x07 & x13 & ~x16);
