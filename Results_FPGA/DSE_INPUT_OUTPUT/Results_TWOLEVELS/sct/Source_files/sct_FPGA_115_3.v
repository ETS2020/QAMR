...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & (~x06 | ~x07 | ~x08)) | new_n37_ | (x08 & ~x09 & x06 & x07);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = ~new_n37_ & (~new_n46_ | (x16 & (x03 | (~x02 & x04))));
  assign new_n46_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | (x11 & (~new_n48_ | x09 | x10 | x17)) | (new_n48_ & ~x09 & ~x10 & ~x11);
  assign new_n48_ = x06 & x07 & x08;
  assign z08 = new_n44_ | ~new_n50_ | (x11 & (x12 | x17));
  assign new_n50_ = (~x12 | (x06 & x07 & new_n51_ & x08)) & (~x06 | ~x07 | ~x08 | ~new_n51_ | x11 | x12);
  assign new_n51_ = ~x09 & ~x10;
  assign z09 = new_n44_ | ~new_n55_ | (new_n53_ & x04);
  assign new_n53_ = x06 & x07 & x08 & ~x09 & new_n54_ & ~x10;
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = (~x11 | (~x13 & ~x17)) & (~x13 | (new_n48_ & new_n56_));
  assign new_n56_ = ~x09 & ~x10 & ~x12;
  assign z10 = x04 & (new_n53_ | (~new_n37_ & (new_n58_ | (new_n40_ & x14))));
