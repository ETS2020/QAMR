...
module FAU ( 
  ...
  assign new_n45_ = ~new_n46_ & (x00 | ((~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07))) & (x07 | ~x09);
  ...
  assign z08 = new_n44_ | new_n46_ | new_n53_ | (x07 & (new_n55_ | x00));
  assign new_n53_ = x12 & (~new_n54_ | x09 | x10 | x11);
  assign new_n54_ = x06 & x07 & x08;
  assign new_n55_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n44_ | new_n46_ | new_n59_ | (x07 & (new_n57_ | x00));
  ...
  assign new_n61_ = x06 & x07 & x08 & ~x09 & new_n58_ & ~x10;
