...
module FAU ( 
  ...
  assign z03 = (x07 & ~x12) | (x04 & ~new_n39_ & (x06 ? ~x07 : (x07 & x12)));
  assign z04 = x04 & ~new_n39_ & ((x08 & (~x07 | (~x06 & x12))) | (~x08 & x12 & x06 & x07));
  assign z05 = ~new_n43_ | ((~x07 | x12) & (~x04 | (new_n39_ & x04)));
  assign new_n43_ = (~x12 | ((~x09 | (x06 & x08)) & (~x04 | ~x06 | ~x07 | ~x08 | x09))) & (x07 | ~x09);
  assign z06 = ((~x04 | (new_n39_ & x04)) & (~x07 | x12)) | (~new_n45_ & x12) | (~x07 & x10);
  assign new_n45_ = (~x04 | ~x06 | ~x07 | ~x08 | x09 | x10) & (~x10 | (x06 & x08 & ~x09));
  assign z07 = ((~x07 | x12) & (~x04 | (new_n39_ & x04))) | new_n49_ | (x07 & (new_n47_ | ~x12));
  assign new_n47_ = new_n48_ & x04 & x06 & x08;
