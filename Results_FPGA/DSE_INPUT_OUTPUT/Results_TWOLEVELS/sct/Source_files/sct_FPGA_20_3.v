...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n40_ & ((~x01 & ~x06 & x07) | (x06 & ~x07));
  assign z04 = x04 & ~new_n40_ & ((~x01 & (x06 ? (x07 & ~x08) : x08)) | (~x07 & x08));
  assign z05 = new_n44_ | (x07 & (x01 | (x06 & x08 & ~x09))) | (x09 & (~x06 | ~x07 | ~x08));
  assign new_n44_ = ~new_n38_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (x01 | ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (x07 | ~x10);
  assign z07 = new_n44_ | (~x07 & x11) | (~x01 & (new_n49_ | (~new_n48_ & x11)));
  assign new_n48_ = x06 & x08 & ~x09 & ~x10;
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n44_ | (~new_n49_ & x12) | (x07 & (new_n51_ | x01));
  assign new_n51_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n44_ | new_n56_ | (~x01 & (new_n55_ | (new_n53_ & x04)));
  assign new_n53_ = x06 & x07 & x08 & ~x09 & new_n54_ & ~x10;
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = ~new_n51_ & x13;
  assign new_n56_ = ~x07 & x13;
  assign z10 = new_n38_ | (x04 & (new_n58_ | (new_n40_ & x14)));
  assign new_n58_ = x06 & x07 & x08 & ~x09 & ~new_n40_ & ~new_n59_;
  assign new_n59_ = ~x00 & (x01 | x10 | x11 | x12 | x13);
