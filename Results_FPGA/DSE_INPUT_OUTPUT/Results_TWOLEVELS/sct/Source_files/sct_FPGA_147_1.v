...
module FAU ( 
  ...
  assign z05 = new_n44_ | new_n45_ | (x09 & (~x06 | ~x07 | ~x08)) | (x06 & x07 & x08 & ~x09);
  ...
  assign new_n49_ = (x07 | (~x09 & ~x11)) & (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | new_n45_ | (~new_n51_ & x07) | (new_n53_ & ~x09);
  assign new_n51_ = ~new_n52_ & (~x09 | ~x12);
  assign new_n52_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n53_ = x12 & (~x08 | x10 | x11 | ~x06 | ~x07);
  ...
  assign new_n57_ = (x07 | (~x09 & ~x13)) & (new_n52_ | ~x13);
