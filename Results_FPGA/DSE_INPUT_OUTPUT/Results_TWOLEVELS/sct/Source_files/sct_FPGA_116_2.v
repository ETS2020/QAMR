...
module FAU ( 
  ...
  assign z06 = (~x04 & (~x02 | x07)) | (~new_n46_ & x07) | (~x02 & ((~x07 & x10) | (x04 & x16)));
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n44_ & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (~x02 | x07)) | (~new_n48_ & x07) | (~x02 & ((~x07 & x11) | (x04 & x16)));
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & ~new_n44_ & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~x02 & (~x04 | (x04 & x16))) | ~new_n50_ | (~x07 & (x02 | x12));
  assign new_n50_ = ~new_n52_ & (~x07 | (x04 & ~new_n44_ & ~new_n51_));
  ...
  assign new_n56_ = ~new_n44_ & (new_n51_ | ~x13);
