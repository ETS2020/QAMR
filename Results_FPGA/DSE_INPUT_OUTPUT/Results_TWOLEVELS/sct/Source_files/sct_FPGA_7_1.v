// Benchmark "FAU" written by ABC on Mon Aug 24 17:20:30 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n38_, new_n40_, new_n44_, new_n45_, new_n48_, new_n50_, new_n52_,
  ...
  assign new_n48_ = (x07 | (~x10 & ~x14)) & (~x10 | (x06 & x08 & ~x09)) & (~x08 | x09 | x10 | ~x06 | ~x07);
  assign z07 = new_n44_ | (~x04 & (x07 | ~x14)) | (~new_n50_ & x07) | (~x07 & x11 & ~x14);
  assign new_n50_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~x04 & (x07 | ~x14)) | (~new_n52_ & x07) | (~x07 & x12 & ~x14);
  assign new_n52_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = ((new_n54_ | new_n58_) & x04) | ~new_n56_ | (~new_n38_ & ~x04);
  assign new_n54_ = x06 & x07 & x08 & ~x09 & new_n55_ & ~x10;
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = (x14 | ((x07 | ~x13) & (~x03 | ~x16))) & (~x07 | new_n57_ | ~x13);
  assign new_n57_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n58_ = x16 & ((~x02 & (~x14 | (x07 & x14))) | (x03 & x07 & x14));
  assign z10 = (~x07 & x14) | (x04 & ~new_n60_ & x07);
  assign new_n60_ = (~x06 | ~x08 | x09 | new_n40_ | new_n61_) & (~new_n40_ | ~x14);
