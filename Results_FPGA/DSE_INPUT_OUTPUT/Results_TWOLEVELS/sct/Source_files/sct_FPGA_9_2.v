...
module FAU ( 
  ...
  assign z06 = ~new_n44_ | (x04 & (~x07 | (~x02 & x07 & x16)));
  assign new_n44_ = (~x10 | (x06 & x08 & ~x09)) & x04 & ~new_n45_ & (~x06 | ~x08 | x09 | x10);
  assign new_n45_ = x03 & x07 & x16;
  assign z07 = ~new_n47_ | (x04 & (~x07 | (~x02 & x07 & x16)));
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & x04 & ~new_n45_ & (~new_n48_ | x09 | x10 | x11);
  assign new_n48_ = x06 & x08;
  assign z08 = ~x04 | (x07 & (new_n42_ | ~new_n50_));
  assign new_n50_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = ~x04 | (x07 & (~new_n54_ | (x04 & (new_n52_ | (~x02 & x16)))));
  assign new_n52_ = x06 & x08 & ~x09 & new_n53_ & ~x10;
  assign new_n53_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n54_ = (new_n55_ | ~x13) & (~x03 | ~x16);
  assign new_n55_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z10 = x04 & ~new_n57_ & x07;
