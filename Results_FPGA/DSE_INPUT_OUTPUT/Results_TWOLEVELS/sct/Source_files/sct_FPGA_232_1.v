...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~x07 & (x09 | x11)) | (x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x06 | ~x08 | x09 | x10 | (~x11 & (~x07 | x11))) & (x07 | (~x10 & ~x11)) & (~x10 | (x06 & x08 & ~x09));
  assign z07 = new_n44_ | new_n48_;
  assign new_n48_ = x07 & ((x11 & (x09 | x10 | ~x06 | ~x08)) | (x06 & x08 & ~x09 & ~x10 & ~x11));
  assign z08 = new_n44_ | ~new_n50_;
  assign new_n50_ = (~x12 | ((~x07 | (x08 & ~x11)) & (x11 | (new_n51_ & x06 & x07)))) & (~x06 | ~x07 | ~x08 | ~new_n51_ | x11 | x12);
  assign new_n51_ = ~x09 & ~x10;
  assign z09 = new_n44_ | new_n56_ | (~x11 & (new_n53_ | new_n55_));
  assign new_n53_ = x04 & x06 & x07 & x08 & new_n54_ & ~x09;
  assign new_n54_ = ~x10 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = x13 & (~x06 | ~x07 | x09 | x10 | x12);
  assign new_n56_ = x07 & x13 & (~x08 | x11);
