...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n40_ & ((x00 & ~x06 & x07) | (x06 & ~x07));
  assign z04 = (~x00 & x07) | (x04 & ~new_n40_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n44_ | (~x07 & x09) | (~new_n45_ & x00);
  ...
  assign new_n47_ = (~x00 | ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (x07 | ~x10);
  assign z07 = new_n44_ | (x00 & (new_n50_ | (~new_n49_ & x11))) | (~x07 & x11);
  assign new_n49_ = x06 & x08 & ~x09 & ~x10;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n44_ | (~new_n50_ & x12) | (x07 & (new_n52_ | ~x00));
  assign new_n52_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n44_ | (~x07 & x13) | (~new_n54_ & x00);
  assign new_n54_ = (new_n52_ | ~x13) & (~new_n55_ | x12 | x13 | x10 | x11);
  assign new_n55_ = x06 & x07 & x08 & ~x09;
  assign z10 = x04 & (new_n58_ | (x00 & new_n57_ & x06));
  assign new_n57_ = x07 & x08 & ~new_n40_ & ~x09;
