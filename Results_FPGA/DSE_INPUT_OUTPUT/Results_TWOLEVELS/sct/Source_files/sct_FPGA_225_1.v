...
module FAU ( 
  ...
  assign z07 = new_n43_ | (~new_n47_ & x07) | (~x07 & x11 & ~x17);
  assign new_n47_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n43_ | ~new_n49_ | (~x07 & (x12 | x17));
  assign new_n49_ = (new_n50_ | ~x12) & (~new_n51_ | x09 | x10 | x11 | x12);
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n51_ = x06 & x07 & x08;
  assign z09 = new_n43_ | (x07 & (new_n53_ | (~new_n55_ & x13))) | (~x07 & x13 & ~x17);
