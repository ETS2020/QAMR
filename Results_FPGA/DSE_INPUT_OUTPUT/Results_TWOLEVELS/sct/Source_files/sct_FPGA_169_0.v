...
module FAU ( 
  ...
  assign z03 = (~x07 & ~x09) | (x04 & ~new_n40_ & (x06 ? (~x07 & x09) : x07));
  ...
  assign new_n46_ = x07 & ((x16 & (x03 | (~x02 & x04))) | new_n47_ | ~x04);
  ...
  assign z08 = new_n49_ | (~new_n53_ & x07) | (x09 & x12);
  assign new_n53_ = (~x12 | (~x10 & ~x11 & x06 & x08)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = new_n49_ | (x07 & (new_n55_ | (~new_n57_ & x13))) | (x09 & x13);
  assign new_n55_ = x04 & x06 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = x06 & x08 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x07 & (new_n59_ | (new_n40_ & x14))) | (x09 & new_n40_ & x14));
