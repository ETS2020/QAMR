...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n41_, new_n43_, new_n44_, new_n47_, new_n48_, new_n50_, new_n51_,
  ...
  assign new_n43_ = (x07 | (~x09 & x16)) & (~x09 | (x06 & x08)) & ~new_n44_ & (~x08 | x09 | ~x06 | ~x07);
  assign new_n44_ = x16 & (x03 | (~x02 & x04));
  assign z13 = x04 | (~x07 & ~x16);
  assign z06 = (~x04 & (x07 | x16)) | (~new_n47_ & x16) | (~new_n48_ & x07);
  assign new_n47_ = ~x03 & (x07 | ~x10) & (x02 | ~x04);
  assign new_n48_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x07 | x16)) | ~new_n50_ | new_n44_ | (~x07 & (x11 | ~x16));
  assign new_n50_ = (~x11 | (new_n51_ & ~x09 & ~x10)) & (~new_n52_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x08;
  assign new_n52_ = x06 & x07 & x08;
  assign z08 = (~x04 & (x07 | x16)) | ~new_n54_ | new_n44_ | (~x07 & (x12 | ~x16));
  assign new_n54_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n52_ | x11 | x12 | x09 | x10);
  assign z09 = (~x04 & (x07 | x16)) | ~new_n58_ | (x04 & (new_n56_ | (~x02 & x16)));
  assign new_n56_ = x06 & x07 & x08 & ~x09 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = (x07 | (~x13 & x16)) & (new_n59_ | ~x13) & (~x03 | ~x16);
  assign new_n59_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & (new_n63_ | (x06 & new_n61_ & x07));
  assign new_n61_ = x08 & ~x09 & ~new_n62_ & (~x16 | (x02 & ~x03));
