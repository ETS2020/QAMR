...
module FAU ( 
  ...
  assign z08 = new_n43_ | new_n44_ | (~new_n50_ & x07) | (new_n52_ & ~x09);
  assign new_n50_ = ~new_n51_ & (~x09 | ~x12);
  assign new_n51_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n52_ = x12 & (~x08 | x10 | x11 | ~x06 | ~x07);
  ...
  assign new_n56_ = (x07 | (~x09 & ~x13)) & (new_n51_ | ~x13);
  assign z10 = (~x07 & x09) | (x04 & (new_n58_ | (new_n39_ & x14)));
