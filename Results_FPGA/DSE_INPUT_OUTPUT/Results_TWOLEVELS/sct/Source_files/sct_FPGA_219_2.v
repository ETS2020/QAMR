...
module FAU ( 
  ...
  assign new_n45_ = (x04 | (x05 & (~x05 | ~x07))) & (~x07 | ((~x09 | (x06 & x08)) & (~x06 | ~x08 | x09))) & (x05 | x07 | ~x09);
  assign z06 = new_n44_ | ~new_n47_ | (~x04 & (~x05 | (x05 & x07)));
  assign new_n47_ = (x07 | (~x05 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | (~x04 & (~x05 | (x05 & x07))) | (~new_n49_ & x07) | (~x05 & ~x07 & x11);
  assign new_n49_ = (~x11 | (new_n50_ & ~x09 & ~x10)) & (~new_n50_ | x09 | x10 | x11);
  assign new_n50_ = x06 & x08;
  assign z08 = new_n44_ | (~x04 & (~x05 | (x05 & x07))) | ~new_n52_ | (~x07 & (x05 | x12));
  assign new_n52_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & (~new_n53_ | x11 | x12 | x09 | x10);
  assign new_n53_ = x06 & x07 & x08;
  assign z09 = new_n44_ | ~new_n57_ | (x07 & (x04 ? new_n55_ : x05));
  assign new_n55_ = x06 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = (x07 | (~x05 & ~x13)) & (x04 | x05) & (new_n58_ | ~x13);
  assign new_n58_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x07 & (new_n60_ | (new_n40_ & x14))) | (~x05 & new_n40_ & x14));
  assign new_n60_ = x06 & x08 & ~x09 & ~new_n40_ & ~new_n61_;
