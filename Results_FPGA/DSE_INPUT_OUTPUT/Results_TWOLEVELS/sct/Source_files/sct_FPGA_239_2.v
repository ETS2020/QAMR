...
module FAU ( 
  ...
  assign z06 = new_n44_ | (x08 & ((x10 & (~x06 | x09)) | (x06 & x07 & ~x09 & ~x10))) | (~x07 & x10);
  assign z07 = new_n44_ | ~new_n47_;
  assign new_n47_ = (~x08 | ((~x11 | (x06 & ~x09 & ~x10)) & (~x06 | ~x07 | x09 | x10 | x11))) & (x07 | ~x11);
  assign z08 = new_n44_ | (~new_n50_ & x07) | (x12 & (~new_n49_ | ~x06 | ~x07));
  assign new_n49_ = ~x09 & ~x10 & ~x11;
  assign new_n50_ = x08 & (x10 | x11 | x12 | ~x06 | x09);
  assign z09 = new_n44_ | (~new_n54_ & x13) | (~new_n52_ & x07);
  ...
  assign z10 = x04 & ((new_n58_ & ~x07) | (x08 & (new_n58_ | (x06 & new_n56_ & x07))));
