...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ((~x07 & (~x16 | (x02 & ~x03))) | (~x02 & x07 & ~x16));
  assign z03 = x04 & ((x06 & ~x07 & (~x16 | (x02 & ~x03))) | (x07 & ~x16 & ~x02 & ~x06));
  ...
  assign z09 = new_n60_ | (~x02 & ((~new_n57_ & x04) | ~x04 | (~new_n53_ & x13)));
  assign new_n57_ = ~x16 & (~new_n59_ | ~new_n58_ | x12 | x13 | x16);
  assign new_n58_ = ~x10 & ~x11;
  assign new_n59_ = x06 & x07 & x08 & ~x09;
  assign new_n60_ = ~x07 & (~x04 | new_n44_ | x13);
  assign z10 = (x02 & x07) | (x04 & (~new_n63_ | (~new_n62_ & ~x02)));
  assign new_n62_ = (~new_n59_ | ~new_n58_ | x12 | x13 | x16) & (~x14 | ~x16);
  assign new_n63_ = (~new_n64_ | ~x08 | x09 | x16) & (~x03 | ~x14 | ~x16);
  assign new_n64_ = x00 & x06 & x07;
  assign z11 = x02 & ~x07;
