...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & (~x06 | ~x07 | ~x08)) | (x08 & ~x09 & x06 & x07);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | (~x07 & (x09 | x10)) | (x10 & (~x06 | ~x08 | x09)) | (x06 & x07 & x08 & ~x09 & ~x10);
  assign z07 = new_n44_ | ~new_n47_;
  assign new_n47_ = (x07 | (~x09 & ~x11)) & (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | ~new_n49_ | (~x07 & (x09 | x12));
  assign new_n49_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n50_ | x11 | x12 | x09 | x10);
  assign new_n50_ = x06 & x07 & x08;
  assign new_n51_ = x06 & x08;
  assign z09 = new_n44_ | (~x09 & (new_n53_ | (~new_n55_ & x13))) | (x07 & x09 & x13);
  assign new_n53_ = x04 & x06 & x07 & x08 & new_n54_ & ~x10;
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = new_n50_ & ~x10 & ~x11 & ~x12;
