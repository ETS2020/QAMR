...
module FAU ( 
  ...
  assign z06 = x10 | (~x10 & ((x16 & (x03 | (~x02 & x04))) | new_n46_ | ~x04));
  assign new_n46_ = x06 & x07 & x08 & ~x09;
  assign z07 = new_n44_ | ~new_n48_;
  assign new_n48_ = (~x07 | (~x10 & (~x06 | ~x08 | x09 | x11))) & (~x11 | (x06 & x07 & x08 & ~x09));
  assign z08 = new_n44_ | new_n51_ | (x07 & (new_n50_ | x10));
  assign new_n50_ = x06 & x08 & ~x09 & ~x11 & ~x12;
  assign new_n51_ = x12 & (~x06 | ~x07 | ~x08 | x09 | x11);
  assign z09 = new_n44_ | (~x10 & (new_n53_ | (~new_n50_ & x13))) | (~x07 & x13);
