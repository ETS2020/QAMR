...
module FAU ( 
  ...
  assign z07 = new_n44_ | new_n49_ | (x07 & (new_n48_ | x12));
  assign new_n48_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = ~new_n51_ | (x04 & ((~x07 & x12) | (~x02 & ~x12 & x16)));
  assign new_n51_ = (x04 | (x07 & x12)) & (~x07 | (~new_n48_ & ~x12)) & (~x03 | x12 | ~x16);
  assign z09 = new_n44_ | (x07 & (new_n53_ | x12)) | (~new_n55_ & x13);
  ...
  assign z10 = x04 & ((~x12 & (new_n57_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
