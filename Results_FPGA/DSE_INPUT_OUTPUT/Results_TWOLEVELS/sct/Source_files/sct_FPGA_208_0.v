...
module FAU ( 
  ...
  assign z03 = x04 & ~new_n40_ & (x06 ? (~x07 & x15) : x07);
  assign z04 = x04 & ~new_n40_ & (x07 ? (x06 ^ x08) : (x08 & x15));
  assign z05 = new_n44_ | ~new_n45_;
  assign new_n44_ = ~new_n37_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = ~new_n46_ & (~x07 | ((~x09 | (x06 & x08)) & (~x06 | ~x08 | x09))) & (x07 | ~x09 | ~x15);
  assign new_n46_ = x03 & x16 & (x07 | (x04 & x15));
  assign z06 = new_n44_ | new_n46_ | ~new_n48_;
  assign new_n48_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10)) : (~x10 | ~x15);
  assign z07 = new_n44_ | new_n46_ | ~new_n50_ | (~x07 & (x11 | ~x15));
  assign new_n50_ = (~x11 | (new_n51_ & ~x09 & ~x10)) & (~new_n52_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x08;
  assign new_n52_ = x06 & x07 & x08;
  assign z08 = new_n44_ | new_n46_ | ~new_n54_ | (~x07 & (x12 | ~x15));
  ...
  assign z13 = x04 & (x07 | (x15 & (new_n40_ | (~new_n40_ & (~x06 | (x06 & ~x07))))));
