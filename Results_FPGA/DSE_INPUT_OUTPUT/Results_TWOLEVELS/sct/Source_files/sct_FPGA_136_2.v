...
module FAU ( 
  ...
  assign z05 = new_n43_ | new_n44_ | (x07 & ((~x08 & x09) | (x06 & x08 & ~x09))) | (~x06 & x09);
  ...
  assign new_n48_ = (~x07 | ((~x11 | (x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11))) & (x06 | ~x11);
  assign z08 = new_n43_ | new_n44_ | (~new_n50_ & x07) | (~x06 & x12);
  assign new_n50_ = (~x12 | (x08 & ~x09 & ~x10 & ~x11)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = new_n43_ | new_n44_ | (~new_n54_ & x13) | (~new_n52_ & x06);
  assign new_n52_ = x07 & (~x04 | ~x07 | ~x08 | x09 | ~new_n53_ | x10);
  assign new_n53_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n54_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z10 = x04 & ((x07 & (new_n58_ | (x06 & new_n56_ & x08))) | (new_n58_ & ~x06));
