...
module FAU ( 
  ...
  assign z05 = ~new_n44_ | (~x00 & (~x07 | (x06 & x08 & ~x09)));
  assign new_n44_ = ~new_n45_ & ~new_n47_ & (~x00 | ~x04 | ~new_n46_ | ~x06);
  assign new_n45_ = (x00 | x07) & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign new_n46_ = x07 & x08 & ~x09 & ((x02 & ~x03) | ~x16);
  assign new_n47_ = x09 & (~x06 | ~x07 | ~x08);
  assign z06 = new_n45_ | ~new_n49_;
  assign new_n49_ = (x07 | (x00 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n45_ | (~new_n51_ & x07) | (x00 & ~x07 & x11);
  assign new_n51_ = (~x11 | (~x09 & ~x10 & x06 & x08)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n45_ | (~new_n53_ & x07) | (x00 & ~x07 & x12);
  assign new_n53_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = new_n45_ | (x07 & (new_n55_ | (~new_n57_ & x13))) | (x00 & ~x07 & x13);
