...
module FAU ( 
  ...
  assign z08 = new_n44_ | (~new_n53_ & x07) | (x11 & x12);
  assign new_n53_ = (~x12 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = new_n44_ | (x07 & (new_n55_ | (~new_n57_ & x13))) | (x11 & x13);
  assign new_n55_ = x04 & x06 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = x06 & x08 & ~x09 & ~x10 & ~x12;
