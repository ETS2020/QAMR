...
module FAU ( 
  ...
  assign z05 = ~new_n37_ & (new_n44_ | ~new_n45_);
  assign new_n44_ = x16 & (x03 | (~x02 & x04));
  assign new_n45_ = (~x09 | (x06 & x07 & x08)) & x04 & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = new_n47_ | ~new_n48_;
  assign new_n47_ = ~new_n37_ & (new_n44_ | ~x04);
  assign new_n48_ = (~x10 | (x06 & x07 & x08 & ~x09)) & ~new_n37_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~new_n37_ & (new_n44_ | new_n51_ | ~x04)) | (new_n50_ & x06);
  assign new_n50_ = x07 & x08 & ~x09 & ~x10 & ~new_n37_ & ~x11;
  assign new_n51_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n53_ | (x06 & x07 & x08 & new_n55_ & ~x09);
  assign new_n53_ = ~new_n37_ & (new_n44_ | ~x04 | (~new_n54_ & x12));
  assign new_n54_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n55_ = ~x10 & ~x11 & ~new_n56_ & ~x12;
  assign new_n56_ = ~x13 & (~x04 | x13 | x18 | (x16 & (~x02 | x03)));
  assign z09 = new_n47_ | new_n61_ | (x06 & x07 & new_n58_ & x08);
  assign new_n58_ = ~x09 & ~x10 & ~x11 & (new_n60_ | (new_n59_ & x04));
  assign new_n59_ = ~x12 & ~x13 & ~x18 & (~x16 | (x02 & ~x03));
  assign new_n60_ = x12 & x13;
  assign new_n61_ = ~new_n54_ & x13;
  assign z10 = new_n37_ | (x04 & (new_n63_ | (new_n40_ & x14)));
  assign new_n63_ = x06 & x07 & x08 & ~x09 & ~new_n40_ & ~new_n64_;
  assign new_n64_ = ~x00 & (x12 | x13 | x18 | x10 | x11);
