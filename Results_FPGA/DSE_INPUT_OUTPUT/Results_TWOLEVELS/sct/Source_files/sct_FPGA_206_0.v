...
module FAU ( 
  ...
  assign z06 = (~new_n47_ & (x03 | x14)) | (x16 & (x03 | (~x02 & x04 & x14)));
  assign new_n47_ = (~x10 | (x08 & ~x09 & x06 & x07)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~new_n49_ & (x03 | x14)) | (x16 & (x03 | (~x02 & x04 & x14)));
  assign new_n49_ = (new_n51_ | ~x11) & x04 & (~new_n50_ | x09 | x10 | x11);
  assign new_n50_ = x06 & x07 & x08;
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = (x03 & (~x04 | x16)) | ~new_n53_ | (x14 & (~x04 | (~x02 & x04 & x16)));
  assign new_n53_ = (~x12 | (new_n50_ & ~x09 & ~x10 & ~x11)) & ~new_n38_ & (~new_n50_ | x11 | x12 | x09 | x10);
  assign z09 = (x03 & (~x04 | x16)) | (~new_n55_ & x04) | new_n58_ | (~x04 & x14) | (~x03 & ~x14);
  assign new_n55_ = ~new_n57_ & (~x06 | ~x07 | ~x08 | ~new_n56_ | x09);
  assign new_n56_ = ~x10 & ~x11 & ~x12 & ~x13 & (x14 | ~x16);
  assign new_n57_ = ~x02 & x14 & x16;
  assign new_n58_ = x13 & (~new_n50_ | x11 | x12 | x09 | x10);
  assign z10 = (~x03 & ~x14) | (x04 & ((new_n60_ & x06) | (new_n42_ & x14)));
  assign new_n60_ = x07 & x08 & ~x09 & ~new_n61_ & (x14 | ~x16);
  assign new_n61_ = ~x00 & (x12 | x13 | x10 | x11);
  assign z11 = ~new_n38_ & x02;
  assign z12 = (~x03 & ~x14) | (x04 & (new_n57_ | x03));
