...
module FAU ( 
  ...
  assign z03 = (~x05 & ~x07) | (x04 & ~new_n40_ & ((~x06 & x07) | (x05 & x06 & ~x07)));
  ...
  assign new_n45_ = ~new_n46_ & (x07 | (x05 & ~x09)) & (~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign new_n46_ = x03 & x16 & (x07 | (x04 & x05));
  assign z06 = new_n44_ | new_n46_ | ~new_n48_;
  assign new_n48_ = (x07 | (x05 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | new_n46_ | ~new_n50_ | (~x07 & (~x05 | x11));
  assign new_n50_ = (~x11 | (new_n51_ & ~x09 & ~x10)) & (~new_n52_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x08;
  assign new_n52_ = x06 & x07 & x08;
  assign z08 = new_n44_ | new_n46_ | ~new_n54_ | (~x07 & (~x05 | x12));
  assign new_n54_ = (~x12 | (new_n51_ & ~x09 & ~x10 & ~x11)) & (~new_n52_ | x11 | x12 | x09 | x10);
  assign z09 = new_n44_ | new_n46_ | new_n60_ | (x07 & (new_n56_ | new_n58_));
  ...
  assign z13 = x04 & (x07 | (x05 & (new_n40_ | (~new_n40_ & (~x06 | (x06 & ~x07))))));
