...
module FAU ( 
  ...
  assign z06 = new_n45_ | (~x07 & (~x03 | x10)) | (~new_n47_ & x07) | (~new_n49_ & x10);
  assign new_n47_ = x04 & ~new_n44_ & ~new_n48_;
  assign new_n48_ = ~x09 & ~x10 & x06 & x08;
  assign new_n49_ = x06 & x08 & ~x09;
  assign z07 = new_n45_ | ~new_n51_ | (~x07 & (~x03 | x11));
  assign new_n51_ = (~x07 | (x04 & ~new_n44_ & ~new_n52_)) & (new_n48_ | ~x11);
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n45_ | (~x07 & (~x03 | x12)) | (~new_n54_ & x07) | (~new_n52_ & x12);
  assign new_n54_ = x04 & ~new_n44_ & ~new_n55_;
  assign new_n55_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x03 | x07)) | (~new_n61_ & x03) | (x07 & (new_n60_ | (~new_n57_ & x04)));
