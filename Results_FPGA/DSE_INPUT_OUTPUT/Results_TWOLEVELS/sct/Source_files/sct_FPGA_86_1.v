...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n39_ & ((~x07 & x08) | (x01 & (x06 ? (x07 & ~x08) : x08)));
  assign z05 = ~new_n43_ | new_n45_;
  assign new_n43_ = ~new_n44_ & (~x07 | (x01 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign new_n44_ = x03 & x16 & (x01 | (x04 & ~x07));
  assign new_n45_ = (x01 | ~x07) & (~x04 | (~x02 & x04 & x16));
  assign z06 = new_n45_ | new_n44_ | ~new_n47_;
  assign new_n47_ = (~x01 | ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (x07 | ~x10);
  assign z07 = new_n45_ | new_n44_ | new_n50_ | (~new_n49_ & x07);
  assign new_n49_ = x01 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n50_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n45_ | new_n44_ | new_n52_ | (x07 & (new_n54_ | ~x01));
  assign new_n52_ = x12 & (~new_n53_ | x09 | x10 | x11);
  assign new_n53_ = x06 & x07 & x08;
  assign new_n54_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign z09 = new_n45_ | new_n44_ | new_n58_ | (x07 & (new_n56_ | ~x01));
  ...
  assign z10 = (~x01 & x07) | (x04 & (new_n60_ | (new_n39_ & x14)));
