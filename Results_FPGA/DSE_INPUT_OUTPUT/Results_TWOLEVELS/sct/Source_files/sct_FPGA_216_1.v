...
module FAU ( 
  ...
  assign z06 = new_n43_ | (x06 & ((x10 & (~x08 | x09)) | (x07 & x08 & ~x09 & ~x10))) | (~x07 & x10);
  assign z07 = new_n43_ | ~new_n46_;
  assign new_n46_ = (~x06 | ((~x11 | (x08 & ~x09 & ~x10)) & (~x07 | ~x08 | x09 | x10 | x11))) & (x07 | ~x11);
  assign z08 = new_n43_ | (~x07 & x12) | (~new_n48_ & x06);
  assign new_n48_ = (~x12 | (~x10 & ~x11 & x08 & ~x09)) & (x10 | x11 | x12 | ~x07 | ~x08 | x09);
  assign z09 = new_n43_ | (~x07 & x13) | (x06 & (new_n50_ | (~new_n52_ & x13)));
  assign new_n50_ = x04 & x07 & x08 & ~x09 & new_n51_ & ~x10;
  assign new_n51_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n52_ = x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = (~x06 & x07) | (~new_n54_ & x04);
  assign new_n54_ = (~x07 | ~x08 | x09 | new_n39_ | new_n55_) & (~new_n39_ | ~x14);
  assign new_n55_ = ~x00 & (x11 | x12 | x13 | ~x06 | x10);
