...
module FAU ( 
  ...
  assign z03 = (~x07 & x16) | (x04 & (x06 ? (~x07 & ~x16) : (~new_n40_ & x07)));
  assign new_n40_ = x16 & (~x02 | x03);
  assign z04 = ~new_n42_ & x04;
  assign new_n42_ = (~x07 | ((~x02 | x03 | (~x06 ^ x08)) & (~x06 | x08 | x16))) & (~x08 | x16 | (x06 & x07));
  assign z05 = (~new_n44_ & x07) | (~x07 & (x09 | x16)) | (~new_n45_ & x09) | (~x04 & ~x16);
  assign new_n44_ = (~new_n40_ | ~x04) & x04 & (~x06 | ~x08 | x09);
  assign new_n45_ = x06 & x08;
  assign z06 = (~new_n47_ & x07) | (~x16 & (~x04 | (~x07 & x10)));
  assign new_n47_ = (~new_n40_ | ~x04) & (~x10 | (x06 & x08 & ~x09)) & x04 & (x09 | x10 | ~x06 | ~x08);
  assign z07 = (~new_n50_ & x07) | (~x07 & (x11 | x16)) | (~x04 & ~x16) | (~new_n49_ & x11);
  assign new_n49_ = new_n45_ & ~x09 & ~x10;
  assign new_n50_ = (~new_n40_ | ~x04) & ~new_n51_ & x04;
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~new_n53_ & x07) | (~x16 & (~x04 | (~x07 & x12)));
  assign new_n53_ = (~new_n40_ | ~x04) & (new_n51_ | ~x12) & ~new_n54_ & x04;
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x07 | ~x16)) | (x04 & ~new_n56_ & x07) | (~new_n54_ & x13) | (~x07 & (x13 | x16));
  assign new_n56_ = ~new_n40_ & (~x06 | ~x08 | x09 | ~new_n57_ | x10);
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign z10 = (~x07 & x16) | (x04 & (new_n59_ | (new_n40_ & x14)));
  ...
  assign z13 = x04 & (x07 | (~x16 & (~x06 | (x06 & ~x07))));
