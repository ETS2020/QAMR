...
module FAU ( 
  ...
  assign z09 = new_n44_ | new_n46_ | new_n59_ | (~new_n57_ & x13);
  assign new_n57_ = x07 & (~x14 | (new_n58_ & ~x10 & ~x11 & ~x12));
  assign new_n58_ = x06 & x08 & ~x09;
  assign new_n59_ = new_n60_ & x04 & x06 & x07 & x08 & ~x09;
  assign new_n60_ = ~x10 & ~x11 & ~x12 & ~x13 & x14;
  assign z10 = (x07 & ~x14) | (x04 & ((x06 & new_n62_ & x07) | (new_n40_ & x14)));
  assign new_n62_ = x08 & ~x09 & (new_n60_ | x00);
