...
module FAU ( 
  ...
  assign z06 = (~new_n37_ & (~x04 | (~new_n50_ & x10))) | new_n48_ | new_n51_;
  ...
  assign z07 = ~z13 | new_n53_ | new_n46_ | (~new_n54_ & x11);
  assign new_n53_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n54_ = x08 & ~x09 & ~x10 & x06 & x07;
  assign z08 = (~x04 & (x12 | ~x16)) | (new_n57_ & x06) | (~x12 & x16) | (~new_n56_ & x12);
  assign new_n56_ = new_n54_ & (~x16 | (~x03 & (x02 | ~x04)));
  assign new_n57_ = x07 & x08 & ~x09 & ~x10 & (x11 ^ ~x12);
  assign z09 = (x04 & (new_n59_ | (~x02 & x12 & x16))) | ~new_n61_ | (~x04 & (x12 | ~x16));
  assign new_n59_ = new_n50_ & new_n60_;
  assign new_n60_ = ~x10 & ~x11 & ~x12 & ~x13 & ~x16;
  assign new_n61_ = (~x12 | (~x13 & (~x03 | ~x16))) & (~x13 | new_n62_ | x16);
  assign new_n62_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z10 = x04 & ((new_n64_ & x06) | (x12 & new_n42_ & x14));
  assign new_n64_ = x07 & x08 & ~x09 & (new_n60_ | (~new_n40_ & x00));
