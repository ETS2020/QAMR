...
module FAU ( 
  ...
  assign z04 = (~x06 & ~x07) | (x04 & ~new_n40_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n44_ | new_n45_ | (x06 & (x07 ? (x08 & ~x09) : x09)) | (x07 & x09 & (~x06 | ~x08));
  assign new_n44_ = ~new_n37_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = x03 & x16 & (x06 | (x04 & x07));
  assign z06 = new_n44_ | ~new_n47_;
  assign new_n47_ = ~new_n45_ & (~x06 | ((x07 | ~x10) & (~x07 | ~x08 | x09 | x10))) & (~x07 | ~x10 | (x06 & x08 & ~x09));
  assign z07 = new_n44_ | new_n45_ | ~new_n49_;
  assign new_n49_ = (x06 | (x07 & ~x11)) & (~x11 | (x07 & x08 & ~x09 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | new_n45_ | (~new_n51_ & x06) | (new_n52_ & x07);
  assign new_n51_ = (x07 | ~x12) & (x10 | x11 | x12 | ~x07 | ~x08 | x09);
  assign new_n52_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | new_n45_ | new_n58_ | (x07 & (new_n54_ | new_n56_));
  ...
  assign new_n58_ = x06 & ~x07 & x13;
  assign z10 = x04 & ((x06 & (new_n62_ | (x07 & new_n60_ & x08))) | (new_n62_ & x07));
