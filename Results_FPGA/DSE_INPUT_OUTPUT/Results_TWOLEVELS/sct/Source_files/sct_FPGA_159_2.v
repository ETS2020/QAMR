...
module FAU ( 
  ...
  assign z09 = (~x04 & (~x02 | x07)) | (~new_n59_ & ~x02) | (x07 & (~new_n58_ | (new_n56_ & x04)));
  assign new_n56_ = x06 & x08 & ~x09 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & (~x16 | (x02 & ~x03));
  assign new_n58_ = ~new_n44_ & (new_n53_ | ~x13);
  assign new_n59_ = (x07 | ~x13) & (~x04 | ~x16);
  assign z10 = (x02 & ~x07) | (x04 & (new_n63_ | (new_n61_ & x06)));
  assign new_n61_ = x08 & ~x09 & (new_n62_ | (x07 & new_n57_ & ~x10));
  assign new_n62_ = x00 & ((x02 & ~x03) | (x07 & ~x16));
