...
module FAU ( 
  ...
  assign z06 = new_n48_ | new_n50_ | (x10 & (~x05 | (x04 & ~new_n49_ & x05)));
  assign new_n48_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign new_n49_ = x06 & x07 & x08 & ~x09;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z07 = new_n48_ | (~x10 & (new_n52_ | (~new_n49_ & x11))) | (x05 & x10 & x11);
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x11;
  assign z08 = new_n48_ | ~new_n54_ | (x10 & (~x05 | x12));
  assign new_n54_ = (new_n52_ | ~x12) & (~new_n45_ | x09 | x10 | x11 | x12);
  assign z09 = new_n48_ | (x05 & x10 & x13) | (~x10 & (new_n56_ | (~new_n58_ & x13)));
  assign new_n56_ = x04 & x06 & x07 & x08 & new_n57_ & ~x09;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = new_n45_ & ~x09 & ~x11 & ~x12;
  assign z10 = x04 & (new_n61_ | (~new_n37_ & (new_n60_ | (new_n40_ & x14))));
  assign new_n60_ = x00 & x06 & x07 & x08 & ~new_n40_ & ~x09;
  assign new_n61_ = x06 & x07 & x08 & ~x09 & new_n57_ & ~x10;
