// Benchmark "FAU" written by ABC on Mon Aug 24 17:21:08 2020
...
module FAU ( 
  ...
  assign z05 = new_n43_ | new_n44_ | (x07 & (~x06 | (x08 & ~x09))) | (x09 & (~x07 | ~x08));
  assign new_n43_ = (x06 | ~x07) & (~x04 | (~x02 & x04 & x16));
  assign new_n44_ = x03 & x16 & (x06 | (x04 & ~x07));
  assign z06 = ~new_n46_ | new_n43_;
  assign new_n46_ = ~new_n44_ & (~x07 | (x06 & (~x08 | x09 | x10))) & (~x10 | (x07 & x08 & ~x09));
  ...
  assign z09 = new_n43_ | new_n44_ | new_n56_ | (x06 & (new_n53_ | new_n55_));
  assign new_n53_ = x04 & x07 & x08 & ~x09 & new_n54_ & ~x10;
  ...
  assign new_n59_ = ~x00 & (x11 | x12 | x13 | ~x06 | x10);
