...
module FAU ( 
  ...
  assign z03 = (~x03 & (~x07 | (x02 & x04 & ~x06))) | (x04 & ~x16 & (x06 ^ x07));
  ...
  assign z06 = (x03 & (~x04 | x16)) | ~new_n46_ | (~x07 & (~x03 | x10));
  assign new_n46_ = (~x07 | (x04 & ~new_n44_ & ~new_n48_)) & (new_n47_ | ~x10);
  assign new_n47_ = x06 & x08 & ~x09;
  assign new_n48_ = ~x09 & ~x10 & x06 & x08;
  assign z07 = (x03 & (~x04 | x16)) | ~new_n50_ | (~x07 & (~x03 | x11));
  assign new_n50_ = (~x07 | (x04 & ~new_n44_ & ~new_n51_)) & (new_n48_ | ~x11);
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x03 | x07)) | (x03 & (x16 | (~x07 & x12))) | (~new_n53_ & x07);
  assign new_n53_ = ~new_n44_ & ~new_n54_ & (new_n51_ | ~x12);
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x03 | x07)) | (~new_n60_ & x03) | (x07 & (new_n59_ | (~new_n56_ & x04)));
  ...
  assign new_n60_ = ~x16 & (x07 | ~x13);
  assign z10 = (~x03 & ~x07) | (x04 & (new_n64_ | (new_n62_ & x06)));
