...
module FAU ( 
  ...
  assign z05 = (~x06 & (~x07 | x09)) | (x09 & (~x07 | ~x08)) | new_n43_ | ~x04 | (x06 & x07 & x08 & ~x09);
  assign new_n43_ = x16 & (x03 | (~x02 & x04));
  assign z06 = new_n43_ | ~new_n45_ | (~x06 & (~x07 | x10));
  assign new_n45_ = (~x10 | (x07 & x08 & ~x09)) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n47_ | new_n43_ | (~x06 & (~x07 | x11));
  assign new_n47_ = (~x11 | (new_n48_ & ~x09 & ~x10)) & x04 & (~new_n48_ | ~x06 | x09 | x10 | x11);
  assign new_n48_ = x07 & x08;
  assign z08 = ~new_n50_ | new_n43_ | (~x06 & (~x07 | x12));
  ...
  assign new_n56_ = (x06 | (x07 & ~x13)) & new_n58_ & (new_n57_ | ~x13);
  assign new_n57_ = ~x10 & ~x11 & ~x12 & x07 & x08 & ~x09;
  assign new_n58_ = x04 & (~x03 | ~x16);
  assign z10 = (~x06 & ~x07) | (x04 & ((x06 & new_n60_ & x07) | (new_n39_ & x14)));
  assign new_n60_ = x08 & ~x09 & ~new_n39_ & ~new_n61_;
