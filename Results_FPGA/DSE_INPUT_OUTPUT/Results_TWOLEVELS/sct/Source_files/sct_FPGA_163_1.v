...
module FAU ( 
  ...
  assign z05 = new_n43_ | (~x07 & (x09 | x17)) | (x09 & (~x06 | ~x08)) | (x06 & x07 & x08 & ~x09);
  ...
  assign z09 = new_n43_ | (~x07 & x13 & ~x17) | (x07 & (new_n53_ | (~new_n55_ & x13)));
  ...
  assign z10 = (~x07 & x17) | (x04 & (new_n57_ | (new_n39_ & x14)));
