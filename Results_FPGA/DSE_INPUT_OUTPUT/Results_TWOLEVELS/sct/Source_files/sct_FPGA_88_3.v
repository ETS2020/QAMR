...
module FAU ( 
  ...
  assign new_n48_ = (~x10 | (x08 & ~x09 & x06 & x07)) & ~new_n37_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = new_n50_ | (~new_n37_ & (new_n44_ | new_n52_ | ~x04));
  assign new_n50_ = x06 & x07 & new_n51_ & x08;
  assign new_n51_ = ~x09 & ~x10 & ~x11 & (~x13 | (~x18 & (~x12 | (x12 & x13))));
  assign new_n52_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n54_ | (x06 & x07 & new_n56_ & x08);
  assign new_n54_ = ~new_n37_ & (new_n44_ | ~x04 | (~new_n55_ & x12));
  assign new_n55_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n56_ = ~x09 & ~x10 & ~x11 & ~x12 & (new_n57_ | ~x18);
  assign new_n57_ = x04 & ~x13 & (~x16 | (x02 & ~x03));
  assign z09 = new_n47_ | new_n62_ | (x06 & new_n59_ & x07);
  assign new_n59_ = x08 & ~x09 & ~x10 & ~x11 & (new_n60_ | new_n61_);
  assign new_n60_ = x04 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n61_ = x12 & x13 & ~x18;
  assign new_n62_ = x13 & ~new_n55_ & ~x18;
