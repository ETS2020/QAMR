...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x06 & (~x07 | (x08 & ~x09))) | ~x04 | (x09 & (~x06 | ~x08));
  assign new_n44_ = x16 & (x03 | (~x02 & ~new_n37_ & x04));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x06 | (x07 & (~x08 | x09 | x10))) & x04 & (~x10 | (x06 & x08 & ~x09));
  assign z07 = new_n44_ | new_n48_ | ~new_n49_;
  assign new_n48_ = x06 & (~x07 | (~x10 & ~x11 & x08 & ~x09));
  assign new_n49_ = x04 & (~x11 | (x06 & x08 & ~x09 & ~x10));
  assign z08 = new_n44_ | (~new_n51_ & x06) | new_n52_ | ~x04;
  ...
  assign z10 = x04 & ((x07 & (new_n61_ | (x06 & new_n59_ & x08))) | (new_n61_ & ~x06));
