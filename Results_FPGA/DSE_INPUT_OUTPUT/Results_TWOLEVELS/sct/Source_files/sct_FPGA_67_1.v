...
module FAU ( 
  ...
  assign z07 = (x03 & (~x04 | x16)) | ~new_n48_ | (x07 & (new_n50_ | ~x03));
  assign new_n48_ = (x07 | (x04 & ~new_n43_ & ~x11)) & (new_n49_ | ~x11);
  assign new_n49_ = x06 & x08 & ~x09 & ~x10;
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x03 | ~x07)) | (~x07 & (new_n43_ | x12)) | (~new_n52_ & x03);
  ...
  assign new_n58_ = (~x03 | (x04 & ~x16)) & (x07 | (x04 & ~x13)) & (x03 | ~x07) & (new_n59_ | ~x13);
  ...
  assign z13 = (~x03 & x07) | (x04 & (x03 | (~x02 & ~x07 & x16) | (((x02 & ~x03) | ~x16) & (~x06 | (x06 & ~x07)))));
