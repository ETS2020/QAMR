...
module FAU ( 
  ...
  assign z01 = ~x18 | (~x05 & x15) | (~x04 & x05 & x18);
  ...
  assign z05 = (~new_n44_ & (~x05 | x18)) | (~x04 & (~x05 | (x05 & x18)));
  assign new_n44_ = ~new_n45_ & (~x09 | (x06 & x07 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign new_n45_ = x16 & (x03 | (~x02 & x04));
  assign z06 = (x16 & ~new_n48_ & (~x05 | x18)) | ~new_n47_ | (~x04 & (~x05 | (x05 & x18)));
  assign new_n47_ = (~x10 | (x08 & ~x09 & x06 & x07)) & ~new_n37_ & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign new_n48_ = ~x03 & (x02 | ~x04);
  assign z07 = (~x04 & (~x05 | (x05 & x18))) | ((~x05 | x18) & (new_n45_ | ~new_n50_));
  assign new_n50_ = (~x11 | (x06 & x07 & x08 & ~x09 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = (x16 & ~new_n48_ & (~x05 | x18)) | ~new_n52_ | (~x04 & (~x05 | (x05 & x18)));
  assign new_n52_ = (~x12 | (new_n53_ & ~x09 & ~x10 & ~x11)) & ~new_n37_ & (~new_n53_ | x11 | x12 | x09 | x10);
  assign new_n53_ = x06 & x07 & x08;
  assign z09 = ~new_n57_ | (~new_n37_ & (new_n60_ | (x04 & (new_n55_ | new_n59_))));
  assign new_n55_ = x06 & x07 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = (x04 | (x05 & (~x05 | ~x18))) & (~x05 | x18) & (~x13 | (new_n53_ & new_n58_));
  assign new_n58_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign new_n59_ = ~x02 & x16;
  assign new_n60_ = x03 & x16;
  assign z10 = x04 & ~new_n37_ & (new_n62_ | (new_n40_ & x14));
