...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n40_ & (x07 ? (x06 ^ x08) : (x08 & x14));
  assign z05 = new_n44_ | ~new_n45_;
  assign new_n44_ = ~new_n38_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = ~new_n46_ & (x07 | (~x09 & x14)) & (~x09 | (x06 & x08)) & (~x06 | ~x07 | ~x08 | x09);
  assign new_n46_ = x03 & x16 & (x07 | (x04 & x14));
  assign z06 = new_n44_ | new_n46_ | ~new_n48_;
  assign new_n48_ = x07 ? ((~x10 | (x06 & x08 & ~x09)) & (x09 | x10 | ~x06 | ~x08)) : (~x10 | ~x14);
  ...
  assign z09 = new_n44_ | new_n46_ | ~new_n56_ | (new_n54_ & x04);
  assign new_n54_ = x06 & x07 & x08 & ~x09 & new_n55_ & ~x10;
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = (x07 | (~x13 & x14)) & (new_n57_ | ~x13);
  assign new_n57_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x06 & new_n59_ & x07) | (new_n40_ & x14));
  assign new_n59_ = x08 & ~x09 & ~new_n40_ & ~new_n60_;
