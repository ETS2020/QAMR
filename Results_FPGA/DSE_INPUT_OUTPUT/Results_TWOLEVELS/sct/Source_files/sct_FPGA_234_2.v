...
module FAU ( 
  ...
  assign z03 = (x03 & ~x07) | (x04 & ((x02 & ((~x03 & ~x06 & x07) | (x06 & ~x07))) | (~x16 & (x06 ^ x07))));
  assign z04 = (x03 & ~x07) | (~new_n42_ & x04);
  assign new_n42_ = (((~x02 | x03) & x16) | (x06 ? (~x07 | x08) : ~x08)) & (x07 | ~x08 | (~x02 & x16));
  ...
  assign z06 = (x03 & (~x07 | (x07 & x16))) | ~new_n47_ | (~x03 & (~x04 | (~x02 & x04 & x16)));
  assign new_n47_ = (~x07 | (x04 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = (x03 & (~x07 | (x07 & x16))) | ~new_n49_ | (~x03 & (~x04 | (~x02 & x04 & x16)));
  assign new_n49_ = (~x07 | (~new_n50_ & x04)) & (~x11 | (new_n51_ & x06 & x07));
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n51_ = x08 & ~x09 & ~x10;
  assign z08 = (~x04 & (~x03 | x07)) | (~x03 & (new_n44_ | (~x07 & x12))) | (~new_n53_ & x07);
  assign new_n53_ = (new_n50_ | ~x12) & ~new_n54_ & (~x03 | ~x16);
  assign new_n54_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (~x03 | x07)) | (x07 & (~new_n58_ | (new_n56_ & x04))) | (~new_n59_ & ~x03);
  assign new_n56_ = x06 & x08 & ~x09 & new_n57_ & ~x10;
  assign new_n57_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n58_ = (new_n54_ | ~x13) & (~x03 | ~x16);
  assign new_n59_ = ~new_n44_ & (x07 | ~x13);
  assign z10 = (x03 & ~x07) | (x04 & (new_n61_ | (new_n39_ & x14)));
  assign new_n61_ = x06 & x07 & x08 & ~x09 & ~new_n39_ & ~new_n62_;
  assign new_n62_ = ~x00 & (x12 | x13 | x10 | x11);
  assign z11 = x02 & (~x03 | x07);
  assign z12 = (x03 & (x04 | ~x07)) | (x04 & x16 & ~x02 & ~x03);
