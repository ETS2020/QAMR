...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n41_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n51_,
  ...
  assign new_n41_ = (x07 | ~x08 | x16) & (~x02 | (((x03 & x16) | (x06 ? (~x07 | x08) : ~x08)) & (x03 | x07 | ~x08)));
  ...
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n44_ & (~x08 | x09 | x10 | ~x06 | ~x07);
  ...
  assign z08 = (~x04 & (x02 | ~x07)) | (~new_n51_ & x02) | (~x07 & (x12 | (~x02 & x04 & x16)));
  assign new_n51_ = ~new_n52_ & ~new_n44_ & (~new_n53_ | ~x06 | ~x07 | ~x08);
  assign new_n52_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n53_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (x02 | ~x07)) | (x02 & (~new_n57_ | (new_n55_ & x04))) | (~new_n59_ & ~x07);
  assign new_n55_ = x06 & x07 & x08 & new_n56_ & ~x09;
  assign new_n56_ = ~x10 & ~x11 & ~x12 & ~x13 & (~x03 | ~x16);
  assign new_n57_ = ~new_n44_ & (new_n58_ | ~x13);
