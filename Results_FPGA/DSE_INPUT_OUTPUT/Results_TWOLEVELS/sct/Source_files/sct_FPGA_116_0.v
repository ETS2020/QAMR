...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n41_, new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n50_,
  ...
  assign z05 = (~x04 & (x02 | x07)) | (~new_n45_ & x07) | (x02 & (new_n42_ | (~x07 & x09)));
  assign new_n45_ = (~x09 | (x06 & x08)) & ~new_n46_ & (~x06 | ~x08 | x09);
  assign new_n46_ = ~x02 & x04 & x16;
  assign z06 = (~x04 & (x02 | x07)) | (~new_n48_ & x07) | (x02 & (new_n42_ | (~x07 & x10)));
  assign new_n48_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n46_ & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x02 | x07)) | (~new_n50_ & x07) | (x02 & (new_n42_ | (~x07 & x11)));
  assign new_n50_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & ~new_n46_ & (~x06 | ~x08 | x09 | x10 | x11);
  ...
  assign z10 = x04 & ((~new_n62_ & x07) | (new_n65_ & x02 & x03));
