...
module FAU ( 
  ...
  assign z05 = new_n44_ | (~new_n45_ & x09) | ~x04 | new_n38_ | new_n46_;
  assign new_n44_ = x16 & (x03 | (~x02 & x04 & (~x14 | (x14 & x17))));
  assign new_n45_ = x06 & x07 & x08;
  assign new_n46_ = x08 & ~x09 & x06 & x07;
  assign z06 = new_n44_ | (~new_n46_ & x10) | ~x04 | new_n38_ | new_n48_;
  ...
  assign z08 = new_n44_ | (~new_n50_ & x12) | ~new_n52_ | ~x04;
  assign new_n52_ = ~new_n38_ & (~new_n45_ | ~new_n53_);
  assign new_n53_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = ~new_n57_ | (x04 & (new_n55_ | new_n59_));
  assign new_n55_ = x06 & x07 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = new_n58_ & (~x13 | (new_n45_ & new_n53_));
  assign new_n58_ = x04 & (~x14 | x17) & (~x03 | ~x16);
  assign new_n59_ = ~x02 & x16 & (~x14 | (x14 & x17));
  assign z10 = new_n38_ | (x04 & (new_n63_ | (x06 & new_n61_ & x07)));
  assign new_n61_ = x08 & ~x09 & ~new_n40_ & ~new_n62_;
  assign new_n62_ = ~x00 & (x12 | x13 | x10 | x11);
  assign new_n63_ = x14 & x16 & (x03 | (~x02 & x17));
  assign z11 = ~new_n38_ & x02;
  assign z12 = x04 & (new_n59_ | (~new_n38_ & x03));
