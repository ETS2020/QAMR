...
module FAU ( 
  ...
  assign z03 = (x07 & ~x17) | (x04 & ~new_n39_ & (x06 ? ~x07 : (x07 & x17)));
  ...
  assign z07 = new_n43_ | new_n47_ | new_n49_;
  assign new_n47_ = x07 & (~x17 | (x06 & x08 & new_n48_ & ~x09));
  assign new_n48_ = ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n43_ | (~new_n47_ & x12) | (new_n51_ & new_n48_ & ~x12 & x17);
  assign new_n51_ = x08 & ~x09 & x06 & x07;
  assign z09 = new_n43_ | new_n55_ | (x07 & (new_n53_ | ~x17));
  assign new_n53_ = x04 & x06 & x08 & ~x09 & new_n54_ & ~x10;
  assign new_n54_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n55_ = x13 & (~new_n56_ | ~x06 | ~x07 | ~x08);
  ...
  assign z13 = (x07 & ~x17) | (x04 & ((~x07 & ((~x02 & x16) | ~x16 | (x02 & ~x03))) | x03 | x17));
  assign z14 = x04 & x17;
endmodule
