...
module FAU ( 
  ...
  assign z04 = (~x03 & (x07 | (x02 & x04 & x08))) | (new_n41_ & x04);
  assign new_n41_ = ~x16 & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08));
  assign z05 = ~new_n43_ | (x03 & (~x04 | x16));
  assign new_n43_ = (~x07 | (x03 & (~x06 | ~x08 | x09))) & (new_n44_ | x07) & (~x09 | (x06 & x08));
  assign new_n44_ = x04 & ~x09 & (x02 | ~x04 | ~x16);
  assign z06 = (~x04 & (x03 | ~x07)) | (~new_n47_ & x03) | (~x07 & (new_n46_ | x10));
  assign new_n46_ = ~x02 & x04 & x16;
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & ~x16 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (x03 & (~x04 | x16)) | ~new_n49_ | (x07 & (new_n51_ | ~x03));
  assign new_n49_ = (x07 | (x04 & ~new_n46_ & ~x11)) & (new_n50_ | ~x11);
  assign new_n50_ = x06 & x08 & ~x09 & ~x10;
  assign new_n51_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x03 | ~x07)) | (~x07 & (new_n46_ | x12)) | (~new_n53_ & x03);
  assign new_n53_ = ~new_n54_ & ~x16 & (~new_n55_ | ~x06 | ~x07 | ~x08);
  assign new_n54_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = ~new_n59_ | (x04 & (new_n57_ | (~x02 & ~x07 & x16)));
  assign new_n57_ = new_n58_ & x03 & x06 & x07 & x08 & ~x09;
  assign new_n58_ = ~x12 & ~x13 & ~x16 & ~x10 & ~x11;
  assign new_n59_ = (~x03 | (x04 & ~x16)) & (x07 | (x04 & ~x13)) & (x03 | ~x07) & (new_n60_ | ~x13);
  assign new_n60_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ((x03 & (new_n62_ | new_n64_)) | (new_n64_ & ~x02 & ~x07));
