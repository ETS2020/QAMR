...
module FAU ( 
  ...
  assign z03 = (~x07 & x15) | (x04 & ~new_n39_ & (x06 ? (~x07 & ~x15) : x07));
  ...
  assign new_n44_ = (x04 | (x15 & (~x07 | ~x15))) & (~x07 | ((~x09 | (x06 & x08)) & (~x06 | ~x08 | x09))) & (x07 | ~x09 | x15);
  assign z06 = new_n43_ | (~x04 & (~x15 | (x07 & x15))) | (~x07 & x10 & ~x15) | (~new_n46_ & x07);
