...
module FAU ( 
  ...
  assign z07 = new_n43_ | ~new_n49_ | ~z13;
  assign new_n49_ = (~x11 | (x07 & (x14 | (new_n50_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n50_ | x11 | x14);
  assign new_n50_ = ~x09 & ~x10;
  assign z08 = new_n43_ | ~z13 | new_n52_ | (x12 & (new_n54_ | ~x07));
  assign new_n52_ = new_n53_ & ~x12 & ~x14 & ~x10 & ~x11;
  assign new_n53_ = x08 & ~x09 & x06 & x07;
  assign new_n54_ = ~x14 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = ~new_n58_ | ~z13 | (x04 & (new_n60_ | (new_n56_ & x06)));
  ...
  assign z10 = (x07 & x14) | (x04 & ((x06 & new_n62_ & x07) | (~x07 & new_n39_ & x14)));
  assign new_n62_ = x08 & ~x09 & ~new_n39_ & ~new_n63_;
