...
module FAU ( 
  ...
  assign new_n45_ = (x04 | (x15 & (~x07 | ~x15))) & (~x07 | ((~x09 | (x06 & x08)) & (~x06 | ~x08 | x09))) & (x07 | ~x09 | x15);
  assign z06 = new_n44_ | ~new_n47_ | (~x04 & (~x15 | (x07 & x15)));
  assign new_n47_ = (x07 | (~x10 & ~x15)) & (~x10 | (x06 & x08 & ~x09)) & (~x08 | x09 | x10 | ~x06 | ~x07);
  assign z07 = new_n44_ | (~x04 & (~x15 | (x07 & x15))) | (~new_n49_ & x07) | (~x07 & x11 & ~x15);
  assign new_n49_ = (~x11 | (new_n50_ & ~x09 & ~x10)) & (~new_n50_ | x09 | x10 | x11);
  assign new_n50_ = x06 & x08;
  assign z08 = new_n44_ | (~x04 & (~x15 | (x07 & x15))) | ~new_n52_ | (~x07 & (x12 | x15));
  ...
  assign z10 = x04 & ((~new_n60_ & x07) | (x14 & new_n40_ & ~x15));
