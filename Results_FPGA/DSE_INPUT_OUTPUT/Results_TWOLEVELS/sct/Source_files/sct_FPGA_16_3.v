...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x07 & (x18 | (x06 & x08 & ~x09))) | (x09 & (~x06 | ~x07 | ~x08));
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x07 | (~x18 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x06 & x07 & x08 & ~x09));
  assign z07 = new_n44_ | new_n48_ | new_n50_;
  assign new_n48_ = x07 & (x18 | (x06 & x08 & new_n49_ & ~x09));
  assign new_n49_ = ~x10 & ~x11;
  assign new_n50_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | (~new_n48_ & x12) | (new_n52_ & new_n49_ & ~x12 & ~x18);
  assign new_n52_ = x06 & x07 & x08 & ~x09;
  assign z09 = new_n44_ | new_n58_ | (~x18 & (new_n56_ | (new_n54_ & x04)));
  ...
  assign new_n61_ = ~x00 & (x10 | x11 | x12 | x13 | x18);
