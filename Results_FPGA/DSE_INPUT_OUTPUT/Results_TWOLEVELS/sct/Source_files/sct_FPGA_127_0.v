...
module FAU ( 
  ...
  assign z07 = new_n44_ | (~new_n48_ & x11) | (new_n50_ & ~x09 & ~x10 & ~x11);
  assign new_n48_ = ~new_n49_ & ~x09 & ~x10 & x06 & x08;
  assign new_n49_ = x04 & ~x07 & x08 & ((x02 & ~x03) | ~x16);
  assign new_n50_ = x06 & x07 & x08;
  assign z08 = new_n44_ | (~new_n52_ & x07) | (x11 & x12);
  assign new_n52_ = (~x12 | (x06 & x08 & ~x09 & ~x10)) & (x10 | x11 | x12 | ~x06 | ~x08 | x09);
  assign z09 = new_n44_ | (x11 & x13) | (x07 & (new_n54_ | (~new_n56_ & x13)));
  assign new_n54_ = x04 & x06 & x08 & ~x09 & new_n55_ & ~x10;
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n56_ = x06 & x08 & ~x09 & ~x10 & ~x12;
  assign z10 = x04 & ((x07 & (new_n58_ | (new_n40_ & x14))) | (x11 & new_n40_ & x14));
  assign new_n58_ = x06 & x08 & ~new_n40_ & ~new_n59_ & ~x09;
