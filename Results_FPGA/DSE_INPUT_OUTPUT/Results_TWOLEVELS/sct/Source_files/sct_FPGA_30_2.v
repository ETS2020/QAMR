...
module FAU ( 
  ...
  assign new_n43_ = ~new_n44_ & (~x07 | (x17 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign new_n44_ = x03 & x16 & (x17 | (x04 & ~x07));
  assign new_n45_ = (~x07 | x17) & (~x04 | (~x02 & x04 & x16));
  assign z06 = new_n45_ | new_n44_ | ~new_n47_;
  assign new_n47_ = (~x10 | (x07 & (~x17 | (x06 & x08 & ~x09)))) & (~x06 | ~x07 | ~x08 | x09 | x10 | ~x17);
  assign z07 = new_n45_ | new_n44_ | new_n49_ | new_n51_;
  assign new_n49_ = x07 & (~x17 | (x06 & x08 & new_n50_ & ~x09));
  ...
  assign z09 = new_n45_ | new_n44_ | new_n58_ | (x07 & (new_n56_ | ~x17));
  ...
  assign z10 = (x07 & ~x17) | (x04 & (new_n61_ | (new_n39_ & x14)));
