...
module FAU ( 
  ...
  assign new_n50_ = x14 & (~x06 | ~x08 | ~new_n51_ | x09);
  assign new_n51_ = ~x10 & ~x11;
  assign new_n52_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | new_n46_ | new_n54_ | (x07 & (new_n56_ | ~x14));
  assign new_n54_ = x12 & (~new_n55_ | ~new_n51_ | x09);
  assign new_n55_ = x06 & x07 & x08;
  assign new_n56_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = new_n44_ | new_n46_ | new_n60_ | (~new_n58_ & x07);
  assign new_n58_ = x14 & (~new_n59_ | ~new_n51_ | x12 | x13 | ~x14);
  assign new_n59_ = x08 & ~x09 & x04 & x06;
  assign new_n60_ = x13 & (~new_n55_ | x11 | x12 | x09 | x10);
  assign z10 = x04 & x14 & (new_n40_ | (x06 & new_n62_ & x07));
  assign new_n62_ = x08 & ~x09 & (x00 | (new_n51_ & ~x12 & ~x13));
