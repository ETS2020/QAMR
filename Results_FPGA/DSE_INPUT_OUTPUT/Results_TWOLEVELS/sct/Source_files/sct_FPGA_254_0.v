...
module FAU ( 
  ...
  assign z05 = ~new_n44_ | (x16 & (~x04 | (~new_n43_ & x04)));
  assign new_n43_ = x02 & ~x03;
  assign new_n44_ = (~x07 | (x04 & (~x06 | ~x08 | x09))) & (x07 | (~x09 & x16)) & (~x09 | (x06 & x08));
  assign z06 = (x16 & ((~new_n43_ & x04) | ~x04 | (~x07 & x10))) | (~new_n46_ & x07);
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & x04 & (~x06 | ~x08 | x09 | x10);
  assign z07 = ~new_n48_ | (x16 & (~x04 | (~new_n43_ & x04)));
  assign new_n48_ = (~x07 | (~new_n50_ & x04)) & (x07 | (~x11 & x16)) & (new_n49_ | ~x11);
  assign new_n49_ = x06 & x08 & ~x09 & ~x10;
  assign new_n50_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = ~new_n52_ | (x16 & (~x04 | (~new_n43_ & x04)));
  assign new_n52_ = (~x07 | (~new_n53_ & x04)) & (x07 | (~x12 & x16)) & (new_n50_ | ~x12);
  assign new_n53_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = ~z13 | new_n57_ | (x07 & (new_n55_ | (~new_n53_ & x13)));
  assign new_n55_ = x04 & x06 & x08 & ~x09 & new_n56_ & ~x10;
  assign new_n56_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = x16 & ((~new_n43_ & x04) | (~x07 & x13));
  assign z13 = x04 | (~x07 & ~x16);
  assign z10 = x04 & ((x06 & new_n61_ & x07) | (new_n60_ & x14));
  assign new_n60_ = ~new_n43_ & x16;
  assign new_n61_ = x08 & ~x09 & ~new_n62_ & (new_n43_ | ~x16);
