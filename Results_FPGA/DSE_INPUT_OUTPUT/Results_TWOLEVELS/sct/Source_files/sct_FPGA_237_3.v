...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & (~x07 | (~x13 & (~x06 | ~x08)))) | (x06 & x07 & x08 & ~x09 & ~x13);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x07 | (~x13 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x06 & x07 & x08 & ~x09));
  ...
  assign z08 = new_n44_ | (x07 & (new_n51_ | x13)) | (~new_n53_ & x12);
  ...
  assign z09 = (~x04 & (~x07 | ~x13)) | (x04 & (x13 ? ~x07 : ~new_n55_)) | (x03 & ~x13 & x16);
  assign new_n55_ = ~new_n57_ & (~x06 | ~x07 | ~x08 | ~new_n56_ | x09);
  assign new_n56_ = ~x10 & ~x11 & ~x12 & ((x02 & ~x03) | ~x16);
  ...
  assign z12 = x04 & ~new_n37_ & (new_n57_ | x03);
  assign z13 = x04 & (~x13 | (~x07 & x13));
