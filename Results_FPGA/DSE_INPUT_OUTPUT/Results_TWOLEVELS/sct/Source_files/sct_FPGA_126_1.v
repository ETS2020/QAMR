...
module FAU ( 
  ...
  assign z05 = (new_n39_ & x04) | ~x04 | (x09 & (~x06 | ~x07 | ~x08)) | (x06 & x07 & x08 & ~x09);
  ...
  assign z08 = (new_n39_ & x04) | ~new_n48_ | ~x04;
  assign new_n48_ = (~x12 | (new_n49_ & ~x09 & ~x10 & ~x11)) & (~new_n49_ | x09 | x10 | x11 | x12);
  assign new_n49_ = x06 & x07 & x08;
  assign z09 = (x04 & (new_n51_ | new_n39_ | (~new_n53_ & x13))) | (~x07 & (~x04 | x13));
  ...
  assign z10 = (x07 & (~x04 | (new_n55_ & x06))) | (x04 & new_n39_ & x14);
  assign new_n55_ = x08 & ~x09 & ~new_n39_ & ~new_n56_;
  assign new_n56_ = ~x00 & (x11 | x12 | x13 | ~x04 | x10);
