...
module FAU ( 
  ...
  assign new_n45_ = (x07 | (~x09 & ~x11)) & (~x09 | (x06 & x08)) & (~x04 | ~x06 | ~x07 | ~x08 | x09);
  assign z06 = new_n44_ | (~x07 & (x10 | x11)) | new_n48_ | (~new_n47_ & x10);
  assign new_n47_ = x06 & x08 & ~x09;
  assign new_n48_ = x08 & ~x09 & ~x10 & x06 & x07;
  assign z07 = new_n44_ | (~new_n50_ & x11) | (new_n51_ & ~x09 & ~x10 & ~x11);
  assign new_n50_ = (~x04 | new_n47_ | ~x07) & x07 & ~x10;
  assign new_n51_ = x06 & x07 & x08;
  assign z08 = new_n44_ | (x07 & (new_n53_ | (x11 & x12))) | (~x11 & ~new_n48_ & x12);
  assign new_n53_ = new_n47_ & ~x10 & ~x11 & ~x12;
  ...
  assign new_n57_ = (x07 | (~x11 & ~x13)) & (~x13 | (new_n47_ & ~x10 & ~x11 & ~x12));
  ...
  assign z13 = x04 & (~x11 | (x07 & (new_n47_ | (~new_n47_ & x11))));
