...
module FAU ( 
  ...
  assign z02 = (x00 & x07) | (x04 & ~x06 & ~new_n40_ & (~x07 | (~x00 & x07)));
  assign new_n40_ = x16 & (~x02 | x03);
  assign z03 = x04 & ~new_n40_ & ((~x00 & ~x06 & x07) | (x06 & ~x07));
  assign z04 = x04 & ~new_n40_ & ((~x00 & (x06 ? (x07 & ~x08) : x08)) | (~x07 & x08));
  assign z05 = new_n44_ | ~new_n45_;
  assign new_n44_ = ~new_n37_ & (~x04 | (~x02 & x04 & x16));
  assign new_n45_ = ~new_n46_ & (x07 | ~x09) & (x00 | ((~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07)));
  ...
  assign new_n50_ = ~x00 & (~new_n51_ | x09 | x10 | x11);
  assign new_n51_ = x06 & x08;
  assign new_n52_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | new_n46_ | (~new_n54_ & ~x00) | (~x07 & x12);
  ...
  assign new_n57_ = (x07 | ~x13) & (x00 | ((~new_n58_ | ~x04) & (new_n60_ | ~x13)));
  ...
  assign z10 = (x00 & x07) | (x04 & ((new_n58_ & ~x00) | (new_n40_ & x14)));
