...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n41_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_,
  ...
  assign new_n45_ = (x07 | (x04 & ~x10)) & (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x02 | ~x07)) | (~new_n47_ & x02) | (~x07 & (x11 | (~x02 & x04 & x16)));
  assign new_n47_ = (~x11 | (new_n49_ & x06 & x08)) & ~new_n48_ & ~new_n50_;
  assign new_n48_ = x03 & x16;
  assign new_n49_ = ~x09 & ~x10;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (x02 | ~x07)) | (~new_n52_ & x02) | (~x07 & (x12 | (~x02 & x04 & x16)));
  assign new_n52_ = ~new_n53_ & ~new_n48_ & (~new_n54_ | ~x06 | ~x07 | ~x08);
  ...
  assign new_n58_ = ~new_n48_ & (new_n59_ | ~x13);
  assign new_n59_ = ~x10 & ~x11 & ~x12 & x06 & x08 & ~x09;
  assign new_n60_ = ~x13 & (x02 | ~x04 | ~x16);
  assign z10 = (~x02 & x07) | (x04 & (new_n62_ | new_n64_));
  assign new_n62_ = x06 & x07 & x08 & ~x09 & ~new_n48_ & ~new_n63_;
  assign new_n63_ = ~x00 & (x11 | x12 | x13 | ~x02 | x10);
  assign new_n64_ = x14 & x16 & (~x02 | x03);
  assign z12 = x04 & ((x03 & (x02 | ~x07)) | (~x02 & ~x07 & x16));
  assign z13 = (~x02 & (x07 | (x04 & ~x07 & x16))) | (x04 & (x02 | (~x16 & (~x06 | (x06 & ~x07)))));
