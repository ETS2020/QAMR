...
module FAU ( 
  ...
  assign z03 = (~x05 & x07) | (x04 & ~new_n40_ & (x06 ^ x07));
  assign z04 = (~x05 & x07) | (x04 & ~new_n40_ & ((x08 & (~x06 | ~x07)) | (x06 & x07 & ~x08)));
  assign z05 = new_n44_ | (x05 & ((x09 & (~x06 | ~x08)) | (x08 & ~x09 & x06 & x07))) | (~x07 & x09);
  assign new_n44_ = ~new_n37_ & (~x04 | (x16 & (x03 | (~x02 & x04))));
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x05 | ((~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (x07 | ~x10);
  assign z07 = new_n44_ | new_n49_ | (x07 & (new_n48_ | ~x05));
  assign new_n48_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | (~x07 & x12) | (~new_n51_ & x05);
  assign new_n51_ = (new_n48_ | ~x12) & (~new_n52_ | x11 | x12 | x09 | x10);
  assign new_n52_ = x06 & x07 & x08;
  assign z09 = new_n44_ | new_n58_ | (x05 & (new_n56_ | (new_n54_ & x04)));
  ...
  assign z10 = x04 & ((x05 & (new_n60_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
