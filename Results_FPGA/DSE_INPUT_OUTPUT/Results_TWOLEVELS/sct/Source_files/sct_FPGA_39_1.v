...
module FAU ( 
  ...
  assign z00 = (~x01 & ~x14) | (~x07 & x14) | (x01 & ~x02);
  ...
  assign new_n45_ = (x04 | (~x07 & x14)) & (x07 | (~x09 & ~x14)) & (~x09 | (x06 & x08)) & (~x08 | x09 | ~x06 | ~x07);
  assign z06 = new_n44_ | (~x04 & (x07 | ~x14)) | (~new_n47_ & x07) | (~x07 & x10 & ~x14);
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = new_n44_ | (~x04 & (x07 | ~x14)) | (~new_n49_ & x07) | (~x07 & x11 & ~x14);
  assign new_n49_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~x04 & (x07 | ~x14)) | (~new_n51_ & x07) | (~x07 & x12 & ~x14);
  ...
  assign new_n55_ = (x14 | ((x07 | ~x13) & (~x03 | ~x16))) & (~x07 | new_n56_ | ~x13);
  assign new_n56_ = x06 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n57_ = x16 & ((~x02 & (~x14 | (x07 & x14))) | (x03 & x07 & x14));
  assign z10 = (~x07 & x14) | (x04 & ~new_n59_ & x07);
