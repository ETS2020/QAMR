...
module FAU ( 
  ...
  assign new_n45_ = (x04 | (~x18 & (x07 | x18))) & (~x07 | (x18 & (~x06 | ~x08 | x09))) & (~x09 | (x06 & x07 & x08));
  assign z06 = new_n44_ | new_n47_ | ~new_n48_;
  assign new_n47_ = ~x04 & (x18 | (~x07 & ~x18));
  assign new_n48_ = (~x07 | (x18 & (~x06 | ~x08 | x09 | x10))) & (~x10 | (x08 & ~x09 & x06 & x07));
  assign z07 = new_n44_ | new_n47_ | new_n51_ | (~new_n50_ & x07);
  assign new_n50_ = x18 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n51_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z08 = new_n44_ | new_n47_ | new_n53_ | (x12 & (new_n50_ | ~x07));
  assign new_n53_ = new_n54_ & ~x10 & ~x11 & ~x12 & x18;
  assign new_n54_ = x08 & ~x09 & x06 & x07;
  assign z09 = new_n44_ | new_n60_ | (x18 & ((new_n56_ & x04) | new_n58_ | ~x04));
  ...
  assign new_n60_ = ~x07 & (x13 | (~x04 & ~x18));
