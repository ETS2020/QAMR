...
module FAU ( 
  ...
  assign z06 = new_n47_ | (~new_n37_ & (new_n45_ | ~x04 | (~new_n48_ & x10)));
  assign new_n47_ = x06 & x07 & x08 & ~x09 & ~new_n37_ & ~x10;
  assign new_n48_ = x06 & x07 & x08 & ~x09;
  assign z07 = (~new_n50_ & ~new_n37_) | (x06 & new_n52_ & x07);
  assign new_n50_ = ~new_n45_ & x04 & (new_n51_ | ~x11);
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign new_n52_ = x08 & ~x09 & ~x10 & ~x11 & (x12 | (~x12 & ~x17));
  assign z08 = new_n54_ | (~new_n55_ & x12) | (new_n48_ & new_n57_ & ~x12 & ~x17);
  assign new_n54_ = ~new_n37_ & (new_n45_ | ~x04);
  assign new_n55_ = new_n56_ & (~x04 | new_n40_ | x06);
  assign new_n56_ = (~x06 | ~x07 | ~x08 | x09 | (~x10 & (x10 | ~x11))) & x07 & x08 & ~x09;
  assign new_n57_ = ~x10 & ~x11;
  assign z09 = new_n54_ | new_n62_ | (~x17 & (new_n61_ | (new_n59_ & x04)));
  assign new_n59_ = x06 & x07 & x08 & ~x09 & new_n60_ & ~x10;
  assign new_n60_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n61_ = x13 & (~x06 | ~x07 | ~x08 | ~new_n57_ | x09);
  assign new_n62_ = x12 & x13;
  assign z10 = new_n37_ | (x04 & (new_n64_ | (new_n40_ & x14)));
  assign new_n64_ = x06 & x07 & x08 & ~new_n40_ & ~new_n65_ & ~x09;
  assign new_n65_ = ~x00 & (x10 | x11 | x12 | x13 | x17);
  assign z11 = ~new_n37_ & x02;
  assign z12 = new_n37_ | (x04 & (x03 | (~x02 & ~new_n37_ & x16)));
  assign z13 = x04 & (~x17 | (x12 & x17));
