...
module FAU ( 
  ...
  assign z07 = ~x13 & (x11 | (~x02 & ~x03 & ~x04 & x05 & ~x11));
  assign z08 = new_n41_ & ~x03;
  assign new_n41_ = x04 & ((~x11 & ~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13));
