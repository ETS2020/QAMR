...
module FAU ( 
  ...
  assign z02 = (x01 & ~x05) | (~x00 & ~x01 & ~x02 & new_n30_ & x05 & ~x13);
  ...
  assign z05 = ~new_n36_ & x01;
  assign new_n36_ = x05 & (~x00 | x02 | x03 | x04 | x13);
  assign z06 = (x01 & ~x05) | (~x03 & x04 & (new_n38_ | new_n41_));
  assign new_n38_ = ~x02 & ~x07 & ~x12 & x13 & (new_n39_ | new_n40_);
  assign new_n39_ = x00 & (x01 ? ~x11 : (x05 & ~x09));
  assign new_n40_ = ~x00 & (x01 ? ~x10 : (x05 & ~x08));
  assign new_n41_ = ~x01 & x02 & ~x05 & ~x13;
  assign z07 = (x01 & ~x05) | (new_n43_ & ~x02);
  assign new_n43_ = ~x03 & ~x04 & ~x13 & (x00 ? (x01 | (~x01 & x05)) : x05);
  assign z08 = new_n45_ & ~x03;
  assign new_n45_ = x04 & ((~x01 & x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13));
