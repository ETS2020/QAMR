...
module FAU ( 
  ...
  assign z00 = x03 | (x01 & x13) | (~x04 & ~x05) | (x02 & x05) | (~x02 & x04);
  assign z01 = ~x03 & (x02 ? (x04 & ~x05 & (~x01 | ~x13)) : (~x04 & x05 & (~x01 | (x01 & ~x13))));
