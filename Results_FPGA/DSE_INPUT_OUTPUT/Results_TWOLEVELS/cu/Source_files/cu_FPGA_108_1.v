...
module FAU ( 
  ...
  assign z01 = ~x03 & ((x01 & (x02 ? (x04 & ~x05) : (~x04 & x05))) | (~x13 & ((x02 & x04 & ~x05) | (~x01 & ~x02 & ~x04 & x05))));
  assign z02 = ~x01 & (x13 | (new_n30_ & ~x00 & ~x02 & ~x03));
  assign new_n30_ = ~x04 & x05 & ~x13;
  assign z03 = ~x01 & (x13 | (new_n30_ & x00 & ~x02 & ~x03));
  ...
  assign z06 = (~x01 & x13) | (~x03 & ~new_n37_ & x04);
  assign new_n37_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n38_ | ~x13);
  assign new_n38_ = x00 ? x11 : x10;
  ...
  assign z10 = ~x03 & x06 & (x01 | ~x13) & (~x02 | ~x05);
endmodule
