...
module FAU ( 
  ...
  assign z07 = ~x13 & (~x11 | (new_n44_ & ~x02));
  assign new_n44_ = ~x03 & ~x04 & x05 & ((~x00 & ~x01) | (x11 & (x00 | (~x00 & x01))));
  assign z08 = new_n28_ | new_n46_;
  assign new_n46_ = ~x03 & x04 & ((x02 & ~x05 & ~x13) | (~x12 & x13 & ~x02 & x05));
