...
module FAU ( 
  ...
  wire new_n28_, new_n31_, new_n37_, new_n38_, new_n39_, new_n41_;
  ...
  assign z06 = new_n28_ | (~x03 & x04 & (new_n37_ | new_n39_));
  assign new_n37_ = ~x02 & x05 & ~x07 & ~x12 & ~new_n38_ & x13;
  assign new_n38_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign new_n39_ = x02 & ~x05 & ~new_n28_ & ~x13;
  assign z08 = ~x03 & new_n41_ & x04;
  assign new_n41_ = ~new_n28_ & ((~x12 & x13 & ~x02 & x05) | (x02 & ~x05 & ~x13));
