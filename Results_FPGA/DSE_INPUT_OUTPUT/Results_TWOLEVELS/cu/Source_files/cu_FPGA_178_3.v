...
module FAU ( 
  ...
  assign z00 = (x04 & (~x02 | x08)) | x03 | (x02 & x05) | (~x04 & ~x05);
  ...
  assign z06 = ~x03 & x04 & ~new_n36_ & ~x08;
  assign new_n36_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n37_ | ~x13);
  assign new_n37_ = (x00 | (x01 & x10)) & (x01 | x09) & (~x00 | ~x01 | x11);
  assign z07 = (x04 & x08) | (~x02 & ~x03 & ~x04 & x05 & ~x13);
  assign z08 = ~new_n40_ & x04;
  assign new_n40_ = ~x08 & (x03 | ((x02 | ~x05 | x12 | ~x13) & (~x02 | x05 | x08 | x13)));
  assign z09 = x06 & x13 & (~x04 | ~x08);
  assign z10 = ~x03 & x06 & (~x02 | ~x05) & (~x04 | ~x08);
endmodule
