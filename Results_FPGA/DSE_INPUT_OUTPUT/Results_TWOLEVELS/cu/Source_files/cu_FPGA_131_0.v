...
module FAU ( 
  ...
  wire new_n28_, new_n31_, new_n33_, new_n37_, new_n38_, new_n39_, new_n40_,
    new_n42_, new_n44_;
  assign z00 = ~new_n28_ & (x03 | (~x02 & x04) | (x02 & x05) | (~x04 & ~x05));
  ...
  assign z04 = ~x13 & (~x09 | (new_n31_ & ~x00 & x01 & ~x02));
  ...
  assign new_n38_ = x01 ? (x11 | ~x13) : x09;
  assign new_n39_ = x13 & (x01 ? ~x10 : ~x08);
  assign new_n40_ = ~x05 & ~x13;
  assign z07 = ~x13 & (~x09 | (new_n42_ & ~x02));
  assign new_n42_ = ~x03 & ~x04 & x05 & (~x00 | (x00 & (x01 | (~x01 & x09))));
