...
module FAU ( 
  ...
  assign z06 = (~x05 & ~x10) | (~x03 & x04 & (new_n36_ | new_n39_));
  assign new_n36_ = ~x02 & ~x07 & ~x12 & x13 & (new_n37_ | new_n38_);
  assign new_n37_ = x05 & (x00 ? (x01 ? ~x11 : ~x09) : (~x01 & ~x08));
  assign new_n38_ = ~x00 & x01 & ~x10;
  assign new_n39_ = x02 & ~x05 & ~x13;
  assign z07 = (~x05 & ~x10) | (~x02 & ~x03 & ~x04 & x05 & ~x13);
  assign z08 = new_n42_ | (~x05 & ~x10);
