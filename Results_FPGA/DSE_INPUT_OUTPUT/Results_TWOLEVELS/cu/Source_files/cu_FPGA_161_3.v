...
module FAU ( 
  ...
  assign z06 = ~x03 & x04 & ~new_n38_ & ~x10;
  ...
  assign z08 = ~new_n42_ & x04;
  assign new_n42_ = ~x10 & (x03 | ((x02 | ~x05 | x12 | ~x13) & (~x02 | x05 | x10 | x13)));
  assign z09 = (x04 & x10) | (x06 & x13);
  assign z10 = (x04 & x10) | (~x03 & x06 & (~x02 | ~x05));
endmodule
