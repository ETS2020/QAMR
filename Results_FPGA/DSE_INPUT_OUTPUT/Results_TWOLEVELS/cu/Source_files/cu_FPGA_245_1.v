...
module FAU ( 
  ...
  wire new_n30_, new_n33_, new_n35_, new_n37_, new_n38_, new_n39_, new_n42_;
  assign z00 = (~x05 & (~x02 | x06)) | x03 | (x02 & ~x04) | (x04 & x05);
  assign z01 = ~x03 & ((~x02 & ~x04 & x05) | (x02 & x04 & ~x05 & ~x06));
  assign z02 = (~x05 & x06) | (new_n30_ & ~x00 & ~x01 & ~x02);
  assign new_n30_ = ~x03 & ~x04 & x05 & ~x13;
  assign z03 = (~x05 & x06) | (new_n30_ & x00 & ~x01 & ~x02);
