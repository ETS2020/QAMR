...
module FAU ( 
  ...
  assign z00 = x03 | (~x01 & x13) | (~x02 & ~x05) | (x04 & x05) | (x02 & ~x04);
  ...
  assign z06 = (~x01 & x13) | (~x03 & ~new_n38_ & x04);
  assign new_n38_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n39_ | ~x13);
  assign new_n39_ = x00 ? x11 : x10;
  assign z07 = (~x01 & x13) | (~x02 & ~x03 & ~x04 & x05 & ~x13);
  assign z08 = new_n42_ & ~x03;
  assign new_n42_ = x04 & ((x02 & ~x05 & ~x13) | (x01 & ~x02 & x05 & ~x12 & x13));
