// Benchmark "FAU" written by ABC on Fri Aug 21 16:50:03 2020
...
module FAU ( 
  ...
  assign z00 = (x03 & (~x02 | ~x13)) | (~x02 & (x04 | ~x05)) | (~x13 & (x05 ? x02 : ~x04));
  assign z01 = ~x03 & ((~x02 & ~x04 & x05) | (x02 & x04 & ~x05 & ~x13));
  assign z02 = new_n30_ & ~x13;
  assign new_n30_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z03 = (x02 & x13) | (new_n32_ & x00 & ~x01 & ~x02);
  assign new_n32_ = ~x03 & ~x04 & x05 & ~x13;
  assign z04 = (x02 & x13) | (new_n32_ & ~x00 & x01 & ~x02);
  assign z05 = (x02 & x13) | (new_n32_ & x00 & x01 & ~x02);
