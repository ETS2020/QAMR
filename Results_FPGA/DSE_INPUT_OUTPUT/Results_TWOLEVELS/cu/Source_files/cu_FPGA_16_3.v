// Benchmark "FAU" written by ABC on Fri Aug 21 16:49:35 2020
...
module FAU ( 
  ...
  assign z05 = ~new_n36_ & x05;
  assign new_n36_ = ~x13 & (~x00 | ~x01 | x02 | x03 | x04 | x13);
  assign z06 = ~x13 & ~x05 & x04 & x02 & ~x03;
  assign z07 = x05 & (x13 | (~x02 & ~x03 & ~x04 & ~x13));
  assign z09 = x13 & ~x05 & x06;
  assign z10 = (~x03 & x06 & (~x02 | ~x05)) | (x05 & x13);
  assign z08 = z06;
endmodule
