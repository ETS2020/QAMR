...
module FAU ( 
  ...
  assign z00 = (~x06 | ~x13) & (x03 | (x02 & ~x04) | (x04 & x05) | (~x02 & ~x05));
  assign z01 = (x06 & x13) | (~x03 & (x02 ? (x04 & ~x05) : (~x04 & x05)));
  assign z02 = (x06 & x13) | (new_n30_ & ~x00 & ~x01 & ~x02);
  assign new_n30_ = x05 & ~x13 & ~x03 & ~x04;
  assign z03 = (x06 & x13) | (new_n30_ & x00 & ~x01 & ~x02);
  assign z04 = new_n33_ & ~x13;
  assign new_n33_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z05 = (x06 & x13) | (new_n30_ & x00 & x01 & ~x02);
  assign z06 = (x06 & x13) | (~x03 & ~new_n36_ & x04);
