...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n34_, new_n36_, new_n38_, new_n39_, new_n40_,
    new_n43_;
  assign z00 = x03 | (x10 & ~x13) | (~x02 & ~x05) | (x04 & x05) | (x02 & ~x04);
  ...
  assign z04 = ~x13 & (x10 | (new_n34_ & ~x03 & ~x04 & x05 & ~x10));
  assign new_n34_ = ~x00 & x01 & ~x02;
  assign z05 = ~x13 & new_n36_ & ~x10;
  ...
  assign z07 = ~x13 & (x10 | (~x02 & ~x03 & ~x04 & x05 & ~x10));
  assign z08 = (new_n43_ & ~x03) | (x10 & ~x13);
