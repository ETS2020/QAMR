...
module FAU ( 
  ...
  assign new_n30_ = ~x03 & ~x04 & x05 & x09;
  ...
  assign z05 = ~x13 & (~x09 | (new_n30_ & x00 & x01 & ~x02));
  ...
  assign z07 = ~x02 & ~x03 & ~x04 & new_n39_ & x05;
  assign z08 = (~x09 & ~x13) | (new_n42_ & ~x03);
  assign new_n42_ = x04 & ((x09 & ~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13));
