...
module FAU ( 
  ...
  assign z00 = (x03 & (~x04 | x08)) | (~x04 & (x02 | ~x05)) | (x08 & (x05 ? x04 : ~x02));
  ...
  assign z06 = ~x03 & x04 & ~new_n35_ & x08;
  ...
  assign z08 = ~new_n39_ & x04;
  assign new_n39_ = x08 & (x03 | ((x02 | ~x05 | x12 | ~x13) & (~x08 | x13 | ~x02 | x05)));
