...
module FAU ( 
  ...
  assign z03 = (x10 & x13) | (new_n32_ & x00 & ~x01 & ~x02);
  assign new_n32_ = x05 & ~x13 & ~x03 & ~x04;
  assign z04 = (x10 & x13) | (new_n32_ & ~x00 & x01 & ~x02);
  assign z05 = new_n35_ & ~x13;
  assign new_n35_ = x05 & ~x04 & ~x03 & ~x02 & x00 & x01;
  assign z06 = (x10 & x13) | (~x03 & ~new_n37_ & x04);
  assign new_n37_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n38_ | ~x13);
  assign new_n38_ = (x00 | (~x01 & x08)) & (~x00 | x01 | x09) & (~x01 | x11);
  assign z07 = ~x02 & ~x03 & ~x04 & x05 & ~x13;
  assign z08 = new_n41_ & ~x03;
  assign new_n41_ = x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x10 & ~x12 & x13));
