...
module FAU ( 
  ...
  assign new_n37_ = (~new_n38_ | ~x00 | x01 | x02 | ~x05) & (~x02 | x05 | x13);
  assign new_n38_ = ~x12 & x13 & ~x07 & ~x09;
  assign new_n39_ = ~x02 & x05 & ~x07 & ~x12 & ~new_n40_ & x13;
  assign new_n40_ = (x06 | (x00 ? (~x01 | x11) : (x01 | x08))) & (x10 | ((~x01 | x11) & (x00 | (~x01 & x08))));
