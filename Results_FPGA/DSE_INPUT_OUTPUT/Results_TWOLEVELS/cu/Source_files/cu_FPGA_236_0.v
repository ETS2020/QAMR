...
module FAU ( 
  ...
  assign z06 = new_n28_ | (~x03 & x04 & (new_n41_ | (new_n38_ & ~x02)));
  assign new_n38_ = x05 & ~x07 & ~x12 & (x00 ? ~new_n39_ : new_n40_);
  assign new_n39_ = x01 ? (x11 | ~x13) : x09;
  assign new_n40_ = x13 & (x01 ? ~x10 : ~x08);
  assign new_n41_ = x02 & ~x05 & x09 & ~x13;
  assign z07 = ~new_n43_ & ~x13;
  assign new_n43_ = x09 & (x02 | x03 | x04 | ~x05 | (x00 & (~x00 | ~x09)));
  assign z08 = new_n45_ & ~x03;
  assign new_n45_ = x04 & ((x02 & ~x05 & x09 & ~x13) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x06 & x13;
