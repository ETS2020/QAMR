...
module FAU ( 
  ...
  assign z00 = (~x04 & (~x05 | ~x10)) | x03 | (~x02 & x04) | (x02 & x05);
  assign z01 = ~x03 & ((x02 & x04 & ~x05) | (x05 & x10 & ~x02 & ~x04));
  assign z02 = ~x04 & (~x10 | (new_n30_ & ~x03 & x05 & x10 & ~x13));
  ...
  assign z08 = (~x03 & ~new_n42_ & x04) | (~x04 & ~x10);
