// Benchmark "FAU" written by ABC on Fri Aug 21 16:50:34 2020
...
module FAU ( 
  ...
  assign z06 = (~x10 & ~x13) | (~x03 & x04 & (new_n37_ | new_n40_));
  assign new_n37_ = ~x02 & x05 & ~x07 & ~x12 & (new_n38_ | new_n39_);
  assign new_n38_ = x13 & (x00 ? (x01 ? ~x11 : ~x09) : (~x01 & ~x08));
  assign new_n39_ = ~x00 & x01 & ~x10;
  assign new_n40_ = x02 & ~x05 & ~x13;
  assign z07 = ~x13 & (~x10 | (new_n42_ & ~x02));
  assign new_n42_ = ~x03 & ~x04 & x05 & (x00 ? (x01 | (~x01 & x10)) : (~x01 | (x01 & x10)));
  assign z08 = new_n44_ | (~x10 & ~x13);
