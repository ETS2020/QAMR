...
module FAU ( 
  ...
  assign z06 = (~x05 & ~x09) | (~x03 & x04 & (new_n35_ | new_n38_));
  assign new_n35_ = ~x02 & ~x07 & ~x12 & x13 & (new_n36_ | new_n37_);
  assign new_n36_ = x00 & (x01 ? (x05 & ~x11) : ~x09);
  assign new_n37_ = ~x00 & x05 & (x01 ? ~x10 : ~x08);
