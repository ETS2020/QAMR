...
module FAU ( 
  ...
  assign z01 = (x04 & (x03 | (x02 & ~x05))) | (~x02 & ~x03 & ~x04 & x05);
  assign z02 = (x03 & x04) | (~x00 & ~x01 & ~x02 & new_n30_ & ~x03 & ~x04);
  ...
  assign z05 = (x03 & x04) | (new_n30_ & ~x03 & ~x04 & x00 & x01 & ~x02);
  ...
  assign z07 = ~x02 & ~x03 & new_n30_ & ~x04;
