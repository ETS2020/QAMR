// Benchmark "FAU" written by ABC on Fri Aug 21 16:50:37 2020
...
module FAU ( 
  ...
  assign z02 = (x04 & ~x10) | (new_n30_ & ~x03 & ~x04 & x05 & ~x13);
  ...
  assign new_n42_ = x10 & (x03 | ((x02 | ~x05 | x12 | ~x13) & (~x10 | x13 | ~x02 | x05)));
  assign z09 = (x04 & ~x10) | (x06 & x13);
  assign z10 = ~x03 & x06 & (~x02 | ~x05) & (~x04 | x10);
endmodule
