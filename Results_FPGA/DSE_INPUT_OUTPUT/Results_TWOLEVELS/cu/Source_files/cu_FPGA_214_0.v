...
module FAU ( 
  ...
  assign z00 = ((x12 | x13) & (x03 | (x02 & x05) | (~x04 & ~x05))) | (~x02 & ((x04 & (x12 | (~x03 & x05 & ~x12 & x13))) | (~x05 & x13)));
  ...
  assign z05 = ~x13 & (~x12 | (new_n32_ & x00 & x01 & ~x02));
  ...
  assign z08 = ~x03 & x04 & ((x12 & ~x13 & x02 & ~x05) | (~x12 & x13 & ~x02 & x05));
