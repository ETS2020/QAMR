...
module FAU ( 
  ...
  assign z00 = (x04 & (~x02 | ~x11)) | x03 | (x02 & x05) | (~x04 & ~x05);
  assign z01 = ~x03 & ((~x02 & ~x04 & x05) | (x02 & x04 & ~x05 & x11));
  assign z02 = (x04 & ~x11) | (new_n30_ & ~x03 & ~x04 & x05 & ~x13);
  ...
  assign z06 = x04 & (~x11 | (~new_n38_ & ~x03));
  ...
  assign new_n42_ = x11 & (x03 | ((~x02 | x05 | x13) & (x02 | ~x05 | x12 | ~x13)));
  assign z09 = (x04 & ~x11) | (x06 & x13);
  assign z10 = ~x03 & x06 & (~x02 | ~x05) & (~x04 | x11);
endmodule
