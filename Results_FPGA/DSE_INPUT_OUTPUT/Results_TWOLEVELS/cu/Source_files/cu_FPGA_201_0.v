...
module FAU ( 
  ...
  assign z06 = (~x08 & ~x13) | (~x03 & x04 & (new_n35_ | (new_n38_ & x08 & ~x13)));
  assign new_n35_ = ~x02 & x05 & ~x07 & ~x12 & (new_n36_ | new_n37_);
  assign new_n36_ = x13 & (x00 ? (x01 ? ~x11 : ~x09) : (x01 & ~x10));
  assign new_n37_ = ~x00 & ~x01 & ~x08;
