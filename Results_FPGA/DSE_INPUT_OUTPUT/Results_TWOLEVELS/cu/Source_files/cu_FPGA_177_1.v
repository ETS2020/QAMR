...
module FAU ( 
  ...
  assign z00 = (x03 & (x05 | ~x08)) | (x05 & (x02 | x04)) | (~x05 & ~x08 & (~x02 | ~x04));
  assign z01 = ~x03 & ((~x02 & ~x04 & x05) | (x02 & x04 & ~x05 & ~x08));
  assign z02 = (~x05 & x08) | (new_n30_ & ~x00 & ~x01 & ~x02);
  assign new_n30_ = ~x03 & ~x04 & x05 & ~x13;
  assign z03 = new_n32_ & ~x13;
  assign new_n32_ = x05 & ~x04 & ~x03 & ~x02 & x00 & ~x01;
  assign z04 = (~x05 & x08) | (new_n30_ & ~x00 & x01 & ~x02);
  ...
  assign new_n42_ = x04 & ((x02 & ~x05 & ~x08 & ~x13) | (~x12 & x13 & ~x02 & x05));
  assign z09 = x06 & x13 & (x05 | ~x08);
  assign z10 = (~x05 & x08) | (~x03 & x06 & (~x02 | ~x05));
endmodule
