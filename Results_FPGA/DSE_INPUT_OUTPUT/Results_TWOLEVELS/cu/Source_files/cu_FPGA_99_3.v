// Benchmark "FAU" written by ABC on Fri Aug 21 16:50:00 2020
...
module FAU ( 
  ...
  assign z00 = (~x07 | ~x13) & (x03 | (~x02 & x04) | (x02 & x05) | (~x04 & ~x05));
  assign z01 = ~x03 & (x02 ? (x04 & ~x05 & (~x07 | ~x13)) : (~x04 & x05 & (~x07 | ~x13)));
  assign z02 = new_n30_ & ~x13;
  assign new_n30_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z03 = (x07 & x13) | (new_n32_ & ~x03 & ~x04 & x05 & ~x13);
  ...
  assign z07 = (x07 & x13) | (~x02 & ~x03 & ~x04 & x05 & ~x13);
  assign z08 = new_n42_ & ~x03;
  assign new_n42_ = x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x07 & ~x12 & x13));
