// Benchmark "FAU" written by ABC on Fri Aug 21 16:50:20 2020
...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n34_, new_n36_, new_n38_, new_n39_, new_n40_,
    new_n43_;
  assign z00 = x03 | (x11 & ~x13) | (~x04 & ~x05) | (x02 & x05) | (~x02 & x04);
  assign z01 = ~x03 & (x02 ? (x04 & ~x05 & (x13 | (~x11 & ~x13))) : (~x04 & x05 & (x13 | (~x11 & ~x13))));
  ...
  assign z06 = ~x03 & x04 & ((~x02 & new_n38_ & x05) | (new_n40_ & x02 & ~x05));
  assign new_n38_ = ~x07 & ~x12 & ~new_n39_ & x13;
  assign new_n39_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign new_n40_ = ~x11 & ~x13;
  assign z07 = ~x02 & ~x03 & ~x04 & new_n40_ & x05;
  assign z08 = new_n43_ & ~x03;
  assign new_n43_ = x04 & ((~x11 & ~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x13 ? x06 : x11;
  assign z10 = (x11 & ~x13) | (~x03 & x06 & (~x02 | ~x05));
endmodule
