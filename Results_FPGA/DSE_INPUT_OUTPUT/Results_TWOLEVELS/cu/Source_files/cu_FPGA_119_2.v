// Benchmark "FAU" written by ABC on Fri Aug 21 16:50:05 2020
...
module FAU ( 
  ...
  assign z00 = (~x08 | x13) & (x03 | (~x02 & x04) | (x02 & x05) | (~x04 & ~x05));
  ...
  assign z03 = ~x13 & (x08 | (new_n32_ & x00 & ~x01 & ~x02));
  assign new_n32_ = ~x03 & ~x04 & x05 & ~x08;
  assign z04 = ~x13 & new_n34_ & ~x08;
  assign new_n34_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z05 = ~x13 & (x08 | (new_n32_ & x00 & x01 & ~x02));
  ...
  assign new_n42_ = x04 & ((~x08 & ~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x06 & x13;
