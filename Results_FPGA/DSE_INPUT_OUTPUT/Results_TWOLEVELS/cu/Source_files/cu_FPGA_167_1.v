// Benchmark "FAU" written by ABC on Fri Aug 21 16:50:19 2020
...
module FAU ( 
  ...
  assign z01 = ~x03 & (x02 ? (x04 & ~x05 & (x11 | ~x13)) : (~x04 & x05 & (x11 | ~x13)));
  ...
  assign new_n38_ = ~x07 & x11 & new_n39_ & ~x12;
  assign new_n39_ = x13 & (x00 ? (~x01 & ~x09) : (x01 ? ~x10 : ~x08));
  assign z07 = ~x02 & ~x03 & ~x04 & x05 & ~x13;
  assign z08 = new_n42_ & ~x03;
  assign new_n42_ = x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & x11 & ~x12 & x13));
