...
module FAU ( 
  ...
  assign z04 = x05 & (x02 | (new_n34_ & ~x00 & x01 & ~x02));
  assign new_n34_ = ~x03 & ~x04 & ~x13;
  assign z05 = x05 & (x02 | (new_n34_ & x00 & x01 & ~x02));
  assign z06 = (x02 & x05) | (~x03 & x04 & ((x02 & ~x13) | (new_n37_ & x05)));
  assign new_n37_ = ~x07 & ~x12 & ~new_n38_ & x13;
  assign new_n38_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign z07 = ~x02 & ~x03 & ~x04 & x05 & ~x13;
  assign z08 = (x02 & (x05 | (~x03 & x04 & ~x13))) | (~x03 & x04 & x05 & ~x12 & x13);
