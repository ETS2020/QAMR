...
module FAU ( 
  ...
  assign z00 = (x03 & (~x04 | x10)) | (~x04 & (x02 | ~x05)) | (x10 & (x05 ? x04 : ~x02));
  ...
  assign z05 = (x04 & ~x10) | (new_n36_ & ~x03 & ~x04 & x05 & ~x13);
  ...
  assign z07 = (x04 & ~x10) | (~x02 & ~x03 & ~x04 & x05 & ~x13);
  assign z08 = new_n42_ & ~x03;
  assign new_n42_ = x04 & x10 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13));
