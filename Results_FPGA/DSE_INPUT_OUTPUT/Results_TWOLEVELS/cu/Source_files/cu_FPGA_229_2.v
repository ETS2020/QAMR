...
module FAU ( 
  ...
  assign new_n32_ = x00 & ~x01 & ~x02 & ~x03 & ~x04 & x05;
  ...
  assign new_n40_ = ~x11 & ~x13 & x02 & ~x05;
  assign z07 = ~x13 & (x11 | (new_n42_ & ~x02));
  assign new_n42_ = ~x03 & ~x04 & x05 & (x00 ? (~x01 | (x01 & ~x11)) : ~x11);
  assign z08 = (x11 & ~x13) | (new_n44_ & ~x03);
  assign new_n44_ = x04 & ((x02 & ~x05 & ~x11 & ~x13) | (~x02 & x05 & ~x12 & x13));
