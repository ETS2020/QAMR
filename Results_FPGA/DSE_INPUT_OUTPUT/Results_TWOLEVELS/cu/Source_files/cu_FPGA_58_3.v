...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n36_, new_n37_, new_n39_, new_n41_;
  assign z00 = (x03 & (~x05 | ~x10)) | (x05 & ~x10 & (x02 | x04)) | (~x05 & (~x02 | ~x04));
  ...
  assign z07 = x05 & (x10 | (new_n39_ & ~x02));
  assign new_n39_ = ~x03 & ~x04 & ~x13 & (~x00 | (x00 & (x01 | (~x01 & ~x10))));
  assign z08 = new_n41_ | (x05 & x10);
