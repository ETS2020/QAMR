...
module FAU ( 
  ...
  assign z02 = ~new_n30_ & ~x01;
  assign new_n30_ = x05 & (x00 | x02 | x03 | x04 | x13);
  ...
  assign new_n38_ = ~x02 & ~x07 & ~x12 & (new_n39_ | new_n40_) & x13;
  assign new_n39_ = x00 & (x01 ? (x05 & ~x11) : ~x09);
  assign new_n40_ = ~x00 & (x01 ? (x05 & ~x10) : ~x08);
  assign new_n41_ = x01 & x02 & ~x05 & ~x13;
  assign z07 = (~x01 & ~x05) | (new_n43_ & ~x02);
  assign new_n43_ = ~x03 & ~x04 & ~x13 & ((~x00 & ~x01) | (x05 & (x00 | (~x00 & x01))));
