...
module FAU ( 
  ...
  assign z01 = (~x05 & x13) | (~x03 & ((~x02 & ~x04 & (x13 | (x05 & ~x13))) | (x02 & x04 & ~x05 & ~x13)));
  ...
  assign z04 = (~x05 & x13) | (new_n34_ & ~x00 & x05 & ~x13 & ~x03 & ~x04);
  assign new_n34_ = x01 & ~x02;
  assign z05 = (~x05 & x13) | (x05 & ~x13 & ~x03 & ~x04 & new_n34_ & x00);
  assign z06 = (~x05 & x13) | (~x03 & x04 & (x02 ? (~x05 & ~x13) : new_n37_));
