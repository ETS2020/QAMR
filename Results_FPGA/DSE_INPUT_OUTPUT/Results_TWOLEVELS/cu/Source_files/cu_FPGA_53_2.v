// Benchmark "FAU" written by ABC on Fri Aug 21 16:49:46 2020
...
module FAU ( 
  ...
  assign z01 = ~x03 & (x13 | (~x08 & ~x13)) & (x02 ? (x04 & ~x05) : (~x04 & x05));
  ...
  assign new_n38_ = ~x08 & ~x13;
  assign z07 = ~x13 & (x08 | (~x02 & ~x03 & ~x04 & x05 & ~x08));
  assign z08 = new_n41_ & ~x03;
  assign new_n41_ = x04 & ((~x08 & ~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x06 & x13;
