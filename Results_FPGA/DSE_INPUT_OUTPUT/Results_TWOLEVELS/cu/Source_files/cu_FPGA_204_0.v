...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_,
    new_n43_;
  ...
  assign z06 = (~x08 & ~x13) | (~x03 & x04 & (new_n36_ | new_n39_));
  ...
  assign z07 = ~x13 & (~x08 | (new_n41_ & ~x02));
  assign new_n41_ = ~x03 & ~x04 & x05 & (~x00 | (x00 & (x01 | (~x01 & x08))));
  assign z08 = new_n43_ | (~x08 & ~x13);
