...
module FAU ( 
  ...
  assign z00 = (x03 & (x04 | x10)) | (x04 & (~x02 | x05)) | (~x04 & x10 & (x02 | ~x05));
  ...
  assign z05 = ~x04 & (new_n36_ | ~x10);
  assign new_n36_ = x00 & x01 & ~x02 & ~x03 & x05 & ~x13;
  ...
  assign z07 = ~x04 & (~x10 | (new_n41_ & ~x02));
  assign new_n41_ = ~x03 & x05 & ~x13 & (x00 ? (x01 | (~x01 & x10)) : x10);
  assign z08 = ~x03 & x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x06 & x13 & (x04 | x10);
  assign z10 = ~x03 & x06 & (x04 | x10) & (~x02 | ~x05);
endmodule
