...
module FAU ( 
  ...
  assign z00 = (~x04 & (x02 | ~x08)) | x03 | (x04 & x05) | (~x02 & ~x05);
  ...
  assign z07 = ~x04 & (~x08 | (new_n39_ & ~x02));
  assign new_n39_ = ~x03 & x05 & ~x13 & (~x00 | (x00 & (x01 | (~x01 & x08))));
  assign z08 = (~x04 & ~x08) | (~x03 & ~new_n41_ & x04);
  assign new_n41_ = (~x02 | x05 | x13) & (x02 | ~x05 | x12 | ~x13);
