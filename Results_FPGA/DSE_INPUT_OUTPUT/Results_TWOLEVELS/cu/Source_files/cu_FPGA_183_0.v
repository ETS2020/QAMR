...
module FAU ( 
  ...
  assign z00 = x03 | x04 | x02 | (~x03 & ~x05);
  assign z01 = x05 & ~x04 & ~x02 & ~x03;
  assign z02 = new_n30_ & ~x13;
  assign new_n30_ = x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z03 = ~new_n32_ & ~x03;
  assign new_n32_ = x05 & (~x00 | x01 | x02 | x04 | ~x05 | x13);
  ...
  assign z06 = ~x03 & (new_n38_ | ~x05);
  assign new_n38_ = ~x02 & x04 & ~x07 & ~x12 & ~new_n39_ & x13;
