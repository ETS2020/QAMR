...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n34_, new_n36_, new_n37_, new_n39_, new_n40_,
    new_n41_, new_n42_, new_n45_;
  assign z00 = (~x05 & (~x04 | ~x09)) | x03 | (~x02 & x04) | (x02 & x05);
  ...
  assign z05 = new_n36_ | (new_n37_ & x00 & x01 & ~x02);
  assign new_n36_ = ~x05 & ~x09;
  assign new_n37_ = ~x03 & ~x04 & x05 & ~x13;
  assign z06 = new_n36_ | (~x03 & x04 & (x02 ? new_n42_ : new_n39_));
  assign new_n39_ = ~x07 & ~x12 & x13 & (x00 ? ~new_n40_ : new_n41_);
  assign new_n40_ = x01 ? (~x05 | x11) : x09;
  assign new_n41_ = x05 & (x01 ? ~x10 : ~x08);
  assign new_n42_ = ~x05 & ~x13;
  assign z07 = ~x02 & ~x03 & ~x04 & x05 & ~x13;
  assign z08 = new_n36_ | new_n45_;
  assign new_n45_ = ~x03 & x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13));
