...
module FAU ( 
  ...
  assign z04 = x05 & (x02 | (new_n34_ & ~x00 & x01));
  assign new_n34_ = ~x03 & ~x04 & ~x13;
  assign z05 = x05 & (x02 | (new_n34_ & x00 & x01));
  ...
  assign z07 = x05 & (x02 | (~x03 & ~x04 & ~x13 & (x01 | (~x01 & ~x02))));
  assign z08 = (x02 & (x05 | (~x03 & x04 & ~x05 & ~x13))) | (~x03 & x04 & x05 & ~x12 & x13);
