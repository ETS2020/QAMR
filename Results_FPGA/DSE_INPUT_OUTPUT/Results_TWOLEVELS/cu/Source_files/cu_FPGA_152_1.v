// Benchmark "FAU" written by ABC on Fri Aug 21 16:50:15 2020
...
module FAU ( 
  ...
  assign z00 = x03 | (~x08 & x13) | (~x04 & ~x05) | (x02 & x05) | (~x02 & x04);
  ...
  assign z05 = (~x08 & x13) | (new_n36_ & ~x03 & ~x04 & x05 & ~x13);
  assign new_n36_ = x00 & x01 & ~x02;
  assign z06 = ~x03 & x04 & (x02 ? (~x05 & ~x13) : (new_n38_ & x05));
  assign new_n38_ = ~x07 & x08 & new_n39_ & ~x12;
  assign new_n39_ = x13 & (x00 ? (x01 ? ~x11 : ~x09) : (x01 & ~x10));
  assign z07 = (~x08 & x13) | (~x02 & ~x03 & ~x04 & x05 & ~x13);
  assign z08 = new_n42_ & ~x03;
  assign new_n42_ = x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & x08 & ~x12 & x13));
