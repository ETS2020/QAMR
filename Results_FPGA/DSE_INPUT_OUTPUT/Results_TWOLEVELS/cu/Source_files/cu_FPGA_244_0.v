...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n35_, new_n37_, new_n38_, new_n40_;
  ...
  assign z06 = (~x02 & (~x05 | (~x03 & new_n37_ & x04))) | (x02 & ~x03 & x04 & ~x05 & ~x13);
  assign new_n37_ = ~x07 & ~x12 & ~new_n38_ & x13;
  assign new_n38_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign z07 = ~new_n40_ & ~x02;
  assign new_n40_ = x05 & (x03 | x04 | x13 | (x00 ? (x01 & (~x01 | ~x05)) : (~x01 & (x01 | ~x05))));
