...
module FAU ( 
  ...
  assign z01 = (x05 & x13) | (~x03 & (x02 ? (x04 & (x13 | (~x05 & ~x13))) : (~x04 & x05 & (x01 | (~x01 & ~x13)))));
  ...
  assign z04 = x05 & (x13 | (new_n34_ & ~x00 & x01));
  assign new_n34_ = ~x02 & ~x03 & ~x04;
  assign z05 = x05 & (x13 | (new_n34_ & x00 & x01));
  assign z06 = (x05 & x13) | (x02 & ~x03 & x04 & ~x05 & ~x13);
  assign z07 = x05 & (x13 | (~x02 & ~x03 & ~x04 & (x01 | (~x01 & ~x13))));
