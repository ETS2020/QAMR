...
module FAU ( 
  ...
  assign z06 = (~x03 & ~new_n35_ & x04) | (x05 & ~x09);
  assign new_n35_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n36_ | ~x13);
  assign new_n36_ = x00 ? (~x01 | x11) : (x01 ? x10 : x08);
  assign z07 = x05 & (~x09 | (new_n30_ & ~x02));
  assign z08 = new_n39_ & ~x03;
  assign new_n39_ = x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & x09 & ~x12 & x13));
