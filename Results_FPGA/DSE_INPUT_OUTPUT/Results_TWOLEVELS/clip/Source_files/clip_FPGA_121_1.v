...
module FAU ( 
  ...
  assign z3 = x0 ? ((~new_n37_ & ~x6) | new_n40_ | ~new_n42_) : (~new_n44_ & ~x6);
  assign new_n37_ = new_n39_ & (new_n38_ | (x2 & (x1 | ~x5)));
  assign new_n38_ = (x7 | (x3 & x8)) & (x4 | x8);
  assign new_n39_ = (x8 | (x3 & (x4 | x7))) & (x5 | ((((~x4 | ~x7) & (~x2 | (~x4 & ~x7))) | (~x3 & ~x8)) & (~x3 | ~x8)));
  assign new_n40_ = ~new_n41_ & (~x4 | x7);
  assign new_n41_ = (~x2 | (x8 ? ~x6 : x3)) & (x1 | ~x6 | ~x8);
  assign new_n42_ = (new_n43_ | x3) & (x4 | ~x6 | ~x7 | ~x8);
  assign new_n43_ = (x1 | (x4 & (~x7 | x8))) & (~x6 | ~x8) & (x4 | (x2 ? (x7 | ~x8) : ~x7));
  ...
  assign new_n48_ = ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x2 | (x0 & ~x1))));
endmodule
