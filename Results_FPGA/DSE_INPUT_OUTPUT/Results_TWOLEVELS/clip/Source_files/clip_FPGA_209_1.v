...
module FAU ( 
  ...
  assign z3 = new_n24_ | (x0 & (new_n27_ | new_n31_ | (~new_n29_ & ~x3)));
  assign new_n24_ = ~x6 & (x0 ? (~x5 | (~new_n25_ & x5)) : ~new_n26_);
  ...
  assign new_n29_ = (x1 | (x4 & (~x7 | x8))) & (~x6 | ~x8) & (x4 | ~x7 | (~new_n30_ & ~x6));
  assign new_n30_ = ~x2 & x5;
  assign new_n31_ = x7 & x8 & ~x4 & x6;
  assign z4 = (~x0 & (x5 | x6)) | (x5 & ((~new_n33_ & ~x3) | x6 | (x0 & new_n35_ & ~x6)));
  assign new_n33_ = (new_n34_ | ~x0) & (x1 | (x4 & (~x0 | x6 | x7)));
  assign new_n34_ = (x2 | (x7 ? x4 : x6)) & (x6 | (x8 & (x4 | x7)));
