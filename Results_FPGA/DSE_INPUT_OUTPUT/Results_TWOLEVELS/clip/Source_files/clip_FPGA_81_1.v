...
module FAU ( 
  ...
  assign z3 = ~new_n36_ | (x0 & (new_n33_ | (~new_n39_ & ~x4)));
  assign new_n33_ = ~x6 & (~new_n35_ | (~new_n34_ & (~x2 | (~x1 & x5))));
  assign new_n34_ = (x7 | (x3 & x8)) & (x4 | x8);
  assign new_n35_ = (x8 | (x3 & (x4 | x7))) & (x5 | ((((~x4 | ~x7) & (~x2 | (~x4 & ~x7))) | (~x3 & ~x8)) & (~x3 | ~x8)));
  assign new_n36_ = (x0 | (~new_n37_ & ~x6 & (~x3 | ~x8))) & (new_n38_ | ~x6);
  assign new_n37_ = (x3 | x8) & ((x4 & x7) | (x1 & x2 & (x4 | x7)));
  assign new_n38_ = (x3 | ~x8) & ((x4 & ~x7) | (x1 & ~x2) | (x3 & ~x8));
  assign new_n39_ = (~x7 | ((~x6 | ~x8) & (x2 | x3))) & (x3 | ~x8 | (x1 & (~x2 | x7)));
  assign z4 = x5 & ((~new_n41_ & ~x3) | (~x6 & (new_n43_ | ~x0)) | (x0 & x6));
  assign new_n41_ = (~x0 | x1 | (x4 & (x6 | x7))) & (new_n42_ | x6);
  assign new_n42_ = (x2 | (x4 & x7)) & x8 & (x4 | x7);
  assign new_n43_ = ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x2 | (x0 & ~x1))));
endmodule
