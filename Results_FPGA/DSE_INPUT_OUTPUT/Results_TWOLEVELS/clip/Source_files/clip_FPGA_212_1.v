...
module FAU ( 
  ...
  assign z3 = new_n24_ | new_n29_ | (~x6 & (x5 ? ~new_n31_ : ~new_n32_));
  assign new_n24_ = x0 & ((~new_n25_ & ~new_n26_) | ~new_n28_ | (~new_n27_ & ~x3));
  assign new_n25_ = x4 & ~x7;
  assign new_n26_ = (~x2 | (x8 ? ~x6 : x3)) & (x1 | ~x6 | ~x8);
  assign new_n27_ = (x1 | (x4 & (~x7 | x8))) & (~x6 | ~x8) & (x2 | x4 | ~x7);
  assign new_n28_ = (x5 | x6) & (~x7 | ~x8 | x4 | ~x6);
  assign new_n29_ = ~x0 & (x5 | (~new_n30_ & x6));
  assign new_n30_ = (~x3 | x8) & ((~x3 & x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign new_n31_ = (x7 | (x3 & x8) | (x1 & x2 & x4)) & (x8 | (x3 & (x4 | (x1 & x2))));
  assign new_n32_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign z4 = new_n29_ | (~new_n34_ & x5);
  assign new_n34_ = (new_n35_ | ((x3 | (x4 & (x6 | x7))) & (x6 | x8 | (x4 & x7)))) & ~x6 & (x6 | ((x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8)));
