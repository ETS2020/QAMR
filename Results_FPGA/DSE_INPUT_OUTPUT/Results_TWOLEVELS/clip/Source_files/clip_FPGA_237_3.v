...
module FAU ( 
  ...
  assign new_n19_ = ((x1 ^ ~x2) | (~new_n20_ & x6)) & ~new_n21_ & (~x0 | ~x6);
  assign new_n20_ = ~x3 & x8;
  assign new_n21_ = (~x3 | x8) & ((~x1 & x2 & (~x4 | x7)) | (~x4 & x7 & x1 & ~x2));
