...
module FAU ( 
  ...
  assign z1 = (~new_n23_ & x0) | new_n26_ | new_n24_ | (new_n27_ & ~x4);
  assign new_n23_ = (x2 | (~new_n21_ & (~x1 | ~x6 | (x4 ^ x7)))) & ((x4 ^ ~x7) | (~x2 & (x1 | ~x6)));
  assign new_n24_ = ~new_n25_ & (~x5 | (~x3 & x8));
  assign new_n25_ = (~x1 | x2 | ~x6 | (~x4 ^ ~x7)) & (~x4 | x7 | (x1 & ~x2));
  assign new_n26_ = ~x6 & (x2 | (~x4 & x7) | (x4 & ~x7));
  assign new_n27_ = x7 & ((~x3 & (x2 | (~x1 & x5))) | ((~x5 | x8) & (~x1 | x2)));
  assign z2 = (~new_n29_ & x6) | new_n35_ | (~new_n32_ & ~x6);
  assign new_n29_ = x3 ? ((~new_n31_ | ~x8) & (x1 | ~x7 | new_n30_ | x8)) : ((x1 | ~x7 | ~x8) & (~new_n31_ | x8));
  assign new_n30_ = ~x0 & x5;
  assign new_n31_ = ((x4 & ~x7) | (x1 & ~x2 & (x4 | ~x7))) & (x0 | (~x0 & ~x5));
  assign new_n32_ = (x3 | ((x7 | ~x8) & (~x4 | ~x7 | x8))) & new_n34_ & (new_n33_ | ~x3);
  assign new_n33_ = (~x0 | x2 | x5 | (~x8 & (~x4 | ~x7))) & (x8 | (x4 & x7)) & (~x4 | ~x7 | ~x8);
  assign new_n34_ = ~x2 & (~x0 | x2 | ~x4 | x5 | ~x7 | ~x8);
