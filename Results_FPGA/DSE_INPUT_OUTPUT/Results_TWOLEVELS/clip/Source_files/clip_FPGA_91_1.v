...
module FAU ( 
  ...
  assign z3 = x0 ? ((~new_n33_ & ~x6) | new_n36_ | ~new_n38_) : (~new_n40_ & ~x6);
  assign new_n33_ = new_n35_ & (new_n34_ | (x2 & (x1 | ~x5)));
  ...
  assign new_n38_ = (new_n39_ | x3) & (x4 | ~x6 | ~x7 | ~x8);
  assign new_n39_ = (x1 | (x4 & (~x7 | x8))) & (~x6 | ~x8) & (x4 | (x2 ? (x7 | ~x8) : ~x7));
  ...
  assign new_n44_ = ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x2 | (x0 & ~x1))));
endmodule
