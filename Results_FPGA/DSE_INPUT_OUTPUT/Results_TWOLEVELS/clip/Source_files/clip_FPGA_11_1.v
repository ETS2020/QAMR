...
module FAU ( 
  ...
  assign z3 = (~x6 & (x0 ? (~x5 | (~new_n31_ & x5)) : ~new_n32_)) | (~new_n27_ & x0);
  assign new_n27_ = (new_n28_ | (x4 & ~x7)) & ~new_n30_ & (new_n29_ | x3);
  assign new_n28_ = (~x2 | (x8 ? ~x6 : x3)) & (x1 | ~x6 | ~x8);
  assign new_n29_ = (x1 | (x4 & (~x7 | x8))) & (~x6 | ~x8) & (x2 | x4 | ~x7);
  assign new_n30_ = ~x4 & x6 & x7 & x8;
  assign new_n31_ = (x7 | (x3 & x8) | (x1 & x2 & x4)) & (x8 | (x3 & (x4 | (x1 & x2))));
  assign new_n32_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign z4 = (~x0 & (x5 | x6)) | (x5 & ((~new_n34_ & ~new_n35_) | x6 | (x0 & ~new_n36_ & ~x6)));
  assign new_n34_ = x1 & x2;
  assign new_n35_ = (x3 | (x4 & (~x0 | x6 | x7))) & (~x0 | x6 | x8 | (x4 & x7));
