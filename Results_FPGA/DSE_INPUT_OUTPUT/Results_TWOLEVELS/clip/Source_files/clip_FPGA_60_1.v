...
module FAU ( 
  ...
  assign new_n25_ = (~x0 | x5 | (~x8 & (~x4 | ~x7))) & (x8 | ((x4 | x7) & (new_n26_ | (x4 & x7)))) & (~x4 | ~x7 | ~x8);
  ...
  assign z3 = new_n33_ | (x0 & (~new_n36_ | (~new_n38_ & (~x4 | x7))));
  assign new_n33_ = ~x6 & (x0 ? (~x5 | (~new_n34_ & x5)) : ~new_n35_);
  assign new_n34_ = ((x1 & x2) | ((x7 | (x3 & x8)) & (x4 | x8))) & (x8 | (x3 & (x4 | x7)));
  assign new_n35_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign new_n36_ = (new_n37_ | x3) & (x4 | ~x6 | ~x7 | ~x8);
  assign new_n37_ = (x1 | (x4 & (~x7 | x8))) & (~x6 | ~x8) & (x4 | (x2 ? (x7 | ~x8) : ~x7));
  assign new_n38_ = (~x2 | (x8 ? ~x6 : x3)) & (x1 | ~x6 | ~x8);
  assign z4 = (~x0 & (x5 | x6)) | (x5 & (~new_n41_ | (~new_n26_ & ~new_n40_)));
  assign new_n40_ = (x3 | (x4 & (~x0 | x6 | x7))) & (~x0 | x6 | x8 | (x4 & x7));
  assign new_n41_ = (~x0 | x6 | x8 | (x3 & (x4 | x7))) & ~x6 & (x3 | x4 | x7);
endmodule
