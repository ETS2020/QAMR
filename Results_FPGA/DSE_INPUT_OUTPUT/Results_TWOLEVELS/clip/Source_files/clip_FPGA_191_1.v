...
module FAU ( 
  ...
  assign z3 = x0 ? ((~new_n33_ & ~x6) | new_n37_ | ~new_n39_) : (~new_n41_ & ~x6);
  assign new_n33_ = (new_n34_ | ~x5) & ~new_n35_ & ~new_n36_ & (new_n17_ | x5);
  assign new_n34_ = (x1 | x3 | x7) & (x2 | x4 | x8);
  assign new_n35_ = ~x8 & ((~x1 & (~x4 | ~x7)) | ~x3 | (~x7 & (~x2 | ~x4)));
  assign new_n36_ = ~x2 & ~x3 & ~x7;
  assign new_n37_ = ~new_n38_ & (~x4 | x7);
  assign new_n38_ = (~x2 | (x8 ? ~x6 : x3)) & (x1 | ~x6 | ~x8);
  assign new_n39_ = (new_n40_ | x3) & (x4 | ~x6 | ~x7 | ~x8);
  assign new_n40_ = (x1 | (x4 & (~x7 | x8))) & (~x6 | ~x8) & (x4 | (x2 ? (x7 | ~x8) : ~x7));
  assign new_n41_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign z4 = x5 & (~new_n45_ | (~new_n43_ & ~x3));
  assign new_n43_ = (new_n44_ | x6) & (~x0 | x1 | (x4 & (x6 | x7)));
  assign new_n44_ = (x2 | (x4 & x7)) & x8 & (x4 | x7);
  assign new_n45_ = (~x0 | (~x6 & (x6 | x8 | x2 | x4))) & (x6 | (x0 & (new_n46_ | x8)));
  assign new_n46_ = (x1 | (x4 & x7)) & (x7 | (x2 & x4));
endmodule
