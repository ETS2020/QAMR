...
module FAU ( 
  ...
  assign z3 = (~x6 & (x0 ? ~new_n32_ : ~new_n39_)) | (x0 & (new_n35_ | ~new_n37_));
  assign new_n32_ = (new_n33_ | x7) & ~new_n34_ & (new_n17_ | x5);
  assign new_n33_ = (x1 | (x8 & (x3 | ~x5))) & (x4 | x8) & (x2 | (x3 & x8));
  assign new_n34_ = ~x8 & (~x3 | (~x4 & (~x1 | ~x2)));
  assign new_n35_ = ~new_n36_ & (~x4 | x7);
  assign new_n36_ = (~x2 | (x8 ? ~x6 : x3)) & (x1 | ~x6 | ~x8);
  assign new_n37_ = (new_n38_ | x3) & (x4 | ~x6 | ~x7 | ~x8);
  assign new_n38_ = (x1 | (x4 & (~x7 | x8))) & (~x6 | ~x8) & (x4 | (x2 ? (x7 | ~x8) : ~x7));
  assign new_n39_ = (~x3 | ~x8) & ((~x3 & ~x8) | ((~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7))));
  assign z4 = x5 & ((~new_n41_ & ~x3) | (x0 & x6) | (~x6 & (new_n43_ | ~x0)));
