...
module FAU ( 
  ...
  assign new_n39_ = (x4 | (x1 & (~x5 | x6 | x7))) & (x1 | ((~x5 | x6 | x7) & (~x7 | x8))) & (~x5 | x6 | x8);
  assign new_n40_ = x5 & (~x5 | x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign new_n41_ = x5 ? x0 : ((new_n42_ | x6) & (x0 | new_n43_ | ~x6));
  ...
  assign z4 = (x6 & (x0 ? x5 : (~new_n43_ & ~x5))) | (x0 & ~new_n46_ & x5);
  assign new_n46_ = (new_n47_ | ((x3 | (x4 & (x6 | x7))) & (x6 | x8 | (x4 & x7)))) & (x6 | ((x3 | (x8 & (x4 | x7))) & (x4 | x7 | x8)));
