...
module FAU ( 
  ...
  assign new_n41_ = x2 ? (x6 | (~x4 & ~x7)) : (~x6 | (~x4 & x7) | (~x0 & (x0 | x5)));
  assign new_n42_ = x4 & (x6 ? (~x7 & (x0 | (~x0 & ~x5))) : x7);
  assign new_n43_ = (~x2 | (x7 ? ~x6 : x4)) & (x2 | (x7 ? x4 : x6)) & (x1 | (x4 & (~x6 | ~x7) & (~x0 | x6 | x7)));
  assign new_n44_ = ~new_n45_ & ~x6;
  assign new_n45_ = x0 & (x5 | ~x8 | ((~x4 | ~x7) & (~x2 | (~x4 & ~x7))));
  assign z3 = (~new_n47_ & x6) | (x0 & (new_n49_ | (~x6 & (~x5 | (new_n53_ & x5)))));
  assign new_n47_ = (~x8 | (x0 ? new_n48_ : (~x3 | new_n33_ | x5))) & (x0 | x5 | x8 | (~x3 & (new_n33_ | x3)));
  assign new_n48_ = ((x4 & ~x7) | (x1 & ~x2)) & x3 & (x4 | ~x7);
  assign new_n49_ = ~x3 & (new_n51_ | ~new_n52_ | (~new_n50_ & ~x8));
  assign new_n50_ = (~x2 | (x4 & ~x7)) & (~x5 | x6) & (x1 | ~x7);
  assign new_n51_ = ~x1 & (~x4 | (~x6 & ~x7 & x8));
  assign new_n52_ = (x2 | ((~x5 | x6 | x7) & (x4 | ~x7))) & (x4 | ~x5 | x6 | x7);
  assign new_n53_ = ~x8 & ((~x1 & (~x4 | (x3 & ~x7))) | (~x4 & ~x7) | (~x2 & x3 & (~x4 | ~x7)));
  assign z4 = (x6 & (x5 | (~x0 & ~new_n55_ & ~x5))) | (x0 & x5 & (new_n56_ | ~new_n58_));
  assign new_n55_ = (~x3 | x8) & (new_n33_ | (~x3 ^ ~x8));
  assign new_n56_ = ~new_n57_ & (~x4 | ~x7);
  assign new_n57_ = (x1 | x3) & (x2 | ~x3 | x6 | x8);
  assign new_n58_ = (new_n59_ | x6) & (x2 | x3 | x4);
  assign new_n59_ = (x8 | ((x1 | (x4 & (~x3 | x7))) & x3 & (x4 | x7))) & (x3 | x7 | (x2 & x4));
endmodule
