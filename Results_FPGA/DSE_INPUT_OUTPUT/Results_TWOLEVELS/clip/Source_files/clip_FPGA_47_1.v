...
module FAU ( 
  ...
  assign z3 = new_n32_ | ~new_n36_ | (~new_n40_ & (~x0 | (x0 & ~x5 & ~x6)));
  assign new_n32_ = x2 & ((~new_n33_ & ~x3) | (new_n34_ & x3) | (x8 & (new_n34_ | new_n35_)));
  assign new_n33_ = (~x6 | ~x7) & (x4 | (~x6 & (~x0 | x7 | ~x8)));
  assign new_n34_ = (x4 | x7) & (x0 ? (~x5 & ~x6) : x1);
  assign new_n35_ = x6 & (~x4 | x7);
  assign new_n36_ = (new_n39_ | ~x6) & (~x0 | ((new_n38_ | x3) & (~new_n37_ | x6)));
  assign new_n37_ = ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign new_n38_ = (x1 | ((x6 | x7) & (x4 | ~x8))) & (x6 | x8) & (x2 | (x7 ? x4 : x6));
  assign new_n39_ = (x1 | (x3 & ~x8) | (x4 & ~x7)) & x0 & (~x8 | (x3 & (x4 | ~x7)));
  assign new_n40_ = (~x4 | ~x7 | ~x8) & (~x3 | (~x8 & (~x4 | ~x7)));
  assign z4 = x5 & ((~new_n42_ & ~x6) | (x0 & (new_n44_ | x6)));
  assign new_n42_ = (new_n43_ | (x3 & x8)) & x0 & (x8 | (x3 & (x1 | x4)));
