...
module FAU ( 
  ...
  assign z3 = (~new_n27_ & ~x0) | (~new_n29_ & x6) | (x0 & (x5 ? ~new_n31_ : ~x6));
  assign new_n27_ = (new_n28_ | (~x3 & ~x8)) & ~x6 & (~x3 | ~x8);
  assign new_n28_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n29_ = (x3 | ~x8) & (new_n30_ | (x3 & ~x8));
  assign new_n30_ = ((x1 & ~x2) | (x4 & ~x7)) & (~x0 | x4 | ~x7);
  assign new_n31_ = ~new_n33_ & (new_n32_ | x3);
  assign new_n32_ = (x1 | (x4 & (x6 | x7))) & (x2 | (x7 ? x4 : x6)) & (x6 | (x8 & (x4 | x7)));
  assign new_n33_ = ~x6 & ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign z4 = (~x0 & (x5 | x6)) | (x5 & (x6 | (~new_n31_ & x0)));
endmodule
