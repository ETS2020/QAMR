// Benchmark "FAU" written by ABC on Fri Aug 21 20:42:51 2020
...
module FAU ( 
  ...
  assign z0 = new_n17_ | (~x1 & x2) | new_n19_ | (x1 & ~x2);
  ...
  assign new_n25_ = (~x1 | (x2 ? (x7 ? x6 : ~x4) : (x7 ? ~x4 : ~x6))) & (~x4 | (~x6 ^ x7));
  assign z3 = (~new_n27_ & ~x0) | (~new_n32_ & x6) | (x0 & (x5 ? ~new_n29_ : ~x6));
  assign new_n27_ = (new_n28_ | (~x3 & ~x8)) & ~x6 & (~x3 | ~x8);
  assign new_n28_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n29_ = ~new_n31_ & (new_n30_ | x3);
  assign new_n30_ = (x1 | (x4 & (x6 | x7))) & (x2 | (x7 ? x4 : x6)) & (x6 | (x8 & (x4 | x7)));
  assign new_n31_ = ~x6 & ~x8 & ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign new_n32_ = ((x4 & ~x7) | (x1 & ~x2) | (x3 & ~x8)) & (x3 | (~x8 & (x4 | ~x7))) & (x4 | ~x7 | ~x8);
  assign z4 = (~x0 & (x5 | x6)) | (x5 & (x6 | (~new_n29_ & x0)));
endmodule
