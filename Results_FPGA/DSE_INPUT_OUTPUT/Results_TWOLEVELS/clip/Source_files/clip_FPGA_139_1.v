...
module FAU ( 
  ...
  assign new_n29_ = (~x7 | (((x1 & ~x2) | (~x3 ^ x8)) & (~x3 | x4 | x8))) & ((~x3 ^ ~x8) | ((~x4 | x7) & (~x1 | x2 | (~x4 & x7))));
  assign new_n30_ = ~x4 & (((x3 ^ x8) & (~x1 | (x2 & ~x7))) | (~x2 & ~x3 & x7 & x8));
  ...
  assign new_n38_ = (x1 | ((x6 | x7) & (x4 | ~x8))) & (x6 | x8) & (x2 | ((x6 | x7) & (x4 | ~x7 | ~x8)));
  assign new_n39_ = ((x3 & ~x8) | ((x4 | ~x7) & (x1 | (x4 & ~x7)))) & x0 & (x3 | ~x8);
