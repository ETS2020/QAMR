// Benchmark "FAU" written by ABC on Fri Aug 21 20:42:47 2020
...
module FAU ( 
  ...
  assign z2 = new_n29_ | (~new_n32_ & ~x6) | new_n35_ | new_n37_ | (x0 & x6);
  ...
  assign new_n32_ = ~new_n33_ & ~new_n34_ & (~x0 | new_n18_ | x5);
  assign new_n33_ = (~x1 | ~x2) & (x3 ? (~x8 & (~x4 | ~x7)) : (~x7 & x8));
  assign new_n34_ = ~x7 & ~x8 & x3 & ~x4;
  assign new_n35_ = ~new_n36_ & (x3 ? (~x5 & ~x8) : x8);
  assign new_n36_ = (x1 | (x4 & (~x6 | ~x7))) & (~x2 | ~x6 | ~x7);
  assign new_n37_ = ~new_n38_ & ~x4;
  assign new_n38_ = (~x2 | ((x3 | x7 | ~x8) & (~x3 | x5 | ~x6 | x8))) & (~x7 | ((~x3 | x5 | ~x6 | x8) & (x2 | x3 | ~x8)));
  assign z3 = (~x6 & (x0 ? (~x5 | (~new_n41_ & x5)) : ~new_n40_)) | (~x0 & ~x5 & ~new_n42_ & x6);
  ...
  assign z4 = x0 ? (x6 | (x5 & ~new_n41_ & ~x6)) : (x5 | (~x5 & ~new_n42_ & x6));
endmodule
