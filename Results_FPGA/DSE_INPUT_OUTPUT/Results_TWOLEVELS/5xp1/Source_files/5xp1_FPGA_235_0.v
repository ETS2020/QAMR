// Benchmark "FAU" written by ABC on Thu Aug 20 23:12:35 2020
...
module FAU ( 
  ...
  assign z3 = (x5 & (x0 ? ((x2 & (x1 | x6)) | (x1 & (x3 | x6))) : ((~x6 & (~x1 | (x1 & (~x2 | ~x3)))) | (~x1 & (x3 ? ~x2 : x6))))) | (x0 & ~x5 & ((~x2 & ~x3 & ~x6) | (~x1 & (~x6 | (~x2 & x6)))));
  assign z4 = (x5 & ((x2 & x3 & (x1 ^ ~x6)) | (~x0 & (x1 ? (~x6 & (~x2 | ~x3)) : (~x3 & x6))) | (~x1 & ~x2 & x6))) | (x0 & ((x1 & (x2 ? x6 : (~x3 & ~x6))) | (~x1 & (x2 ? ~x6 : (~x5 & x6))) | (~x2 & x3 & x6)));
