// Benchmark "FAU" written by ABC on Thu Aug 20 23:11:48 2020
...
module FAU ( 
  ...
  assign new_n31_ = (x5 | ((x1 | (~x4 ^ x6)) & (x3 | ~x4 | x6))) & (~x1 | ~x4 | ~x5 | ~x6);
  assign z3 = (x5 & (x0 ? (x1 & (x3 | x6)) : ((~x2 & (~x1 | ~x6)) | (~x1 & (~x6 | (~x3 & x6)))))) | (x1 & ((~x0 & ~x5 & x6) | (x2 & ~x3 & ~x6))) | (x2 & (~x5 | (x0 & x6))) | (x0 & ~x5 & (~x1 | (~x3 & ~x6)));
