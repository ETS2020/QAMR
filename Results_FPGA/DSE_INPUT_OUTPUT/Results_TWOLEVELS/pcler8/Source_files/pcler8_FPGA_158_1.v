// Benchmark "FAU" written by ABC on Mon Aug 24 16:59:06 2020
...
module FAU ( 
  ...
  assign new_n62_ = (x19 | ~x20) & (~new_n63_ | ~x12 | ~x21 | ~x22);
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign new_n64_ = ~x20 & (x22 | (~x08 & x09 & ~x10 & x19));
  assign z11 = new_n68_ | (x02 & x08) | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x21 | (~new_n67_ & x19)) & (~x19 | ~x20 | x21);
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n68_ = ~x20 & (x22 | (~x08 & x09 & ~x10 & x21));
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & x20 & ((x22 & (~x19 | new_n71_ | ~x21)) | (x19 & x21 & ~x22));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x22 & (new_n75_ | ~x20)) | (x04 & x08) | (new_n73_ & ~x08);
  assign new_n73_ = x09 & ~x10 & x23 & (~new_n74_ | ~x19 | ~x21);
  assign new_n74_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n75_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x23;
  assign z14 = (~x08 & x09 & ~new_n77_ & ~x10) | (x05 & ~new_n49_ & x08);
  assign new_n77_ = (~x20 | ((~x22 | (~new_n78_ & ~new_n79_)) & (new_n80_ | ~x24))) & (x22 | ~x24);
  assign new_n78_ = x19 & x21 & x23 & ~x24;
  assign new_n79_ = x16 & x24 & x25 & x26;
  assign new_n80_ = x19 & x21 & x23;
  assign z15 = (~x08 & x09 & ~new_n82_ & ~x10) | (x06 & ~new_n49_ & x08);
  assign new_n82_ = (~x20 | ((~x22 | (~new_n83_ & ~new_n84_)) & (new_n85_ | ~x25))) & (x22 | ~x25);
  assign new_n83_ = x19 & x21 & x23 & x24 & ~x25;
  assign new_n84_ = x17 & x25 & x26;
  assign new_n85_ = x19 & x21 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~new_n87_ & ~x10);
  assign new_n87_ = (x22 | ~x26) & (~x20 | ((~new_n89_ | ~new_n90_) & (new_n88_ | ~x26)));
  assign new_n88_ = x23 & x24 & x25 & ~x18 & x19 & x21;
  assign new_n89_ = x19 & x21 & x22;
