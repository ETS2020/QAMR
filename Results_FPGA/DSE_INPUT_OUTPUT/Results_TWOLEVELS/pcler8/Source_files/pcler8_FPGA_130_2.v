...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x09 | x19)) | (x09 & (~x19 | (~x08 & ~new_n64_ & ~x10)));
  ...
  assign z13 = (x09 & (~x19 | (~x08 & ~new_n69_ & ~x10))) | (x04 & x08);
  ...
  assign z15 = (x09 & (~x19 | (~x08 & ~new_n74_ & ~x10))) | (x06 & x08);
  assign new_n74_ = ~new_n76_ & (~x25 | (~new_n75_ & new_n58_ & x22 & x24));
  assign new_n75_ = x19 & (~x23 | (x17 & x26));
  assign new_n76_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (x07 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n78_ & x19);
  assign new_n78_ = (~x26 | (new_n80_ & new_n58_ & ~x18)) & (~new_n79_ | ~new_n81_);
