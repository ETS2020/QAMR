...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((x19 & (x21 ? (new_n65_ | ~x20) : x20)) | (x16 & ~x19 & x21));
  ...
  assign new_n69_ = ~x19 & (~x16 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x16 | x19 | ~x23) & (~x19 | ((~x23 | (new_n72_ & ~new_n73_ & x22)) & (~new_n72_ | ~x22 | x23)));
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x24 | (~new_n76_ & (~x19 | (new_n72_ & x22 & x23)))) & (~new_n72_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n76_ = x16 & (~x19 | (x25 & x26));
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x19 | ((~new_n79_ | ~new_n81_) & (~x25 | (new_n79_ & new_n80_)))) & (~x16 | x19 | ~x25);
