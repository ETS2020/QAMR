...
module FAU ( 
  ...
  assign new_n62_ = ~x19 & (x21 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & x09 & new_n64_ & ~x10);
  assign new_n64_ = x19 & (x21 ? (new_n65_ | ~x20) : x20);
  ...
  assign new_n70_ = ~x10 & ((x23 & (~x20 | ~x21 | (~new_n71_ & x21))) | (x20 & x21 & x22 & ~x23));
  assign new_n71_ = (~x19 | x22) & (~x25 | ~x26 | ~x15 | ~x24);
  assign z14 = (x05 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x21 | (~new_n74_ & (~x20 | ~x22 | ~x23 | x24))) & (~x24 | (x20 & x21 & x22 & x23));
  assign new_n74_ = x16 & x24 & x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x21 | (~new_n77_ & (~x17 | ~x25 | ~x26))) & (new_n78_ | ~x25);
  assign new_n77_ = x20 & x22 & x23 & x24 & ~x25;
  assign new_n78_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = (~x08 & x09 & ~new_n80_ & ~x10) | (x07 & ~new_n49_ & x08);
  assign new_n80_ = (x21 | ~x26) & (~x19 | ((~new_n82_ | ~new_n83_) & (new_n81_ | ~x26)));
  assign new_n81_ = x23 & x24 & x25 & ~x18 & x20 & x22;
