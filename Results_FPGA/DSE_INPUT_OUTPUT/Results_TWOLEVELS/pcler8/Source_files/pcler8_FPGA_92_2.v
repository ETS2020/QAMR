...
module FAU ( 
  ...
  assign new_n69_ = (~x23 | (new_n58_ & x22 & (~new_n70_ | ~x15 | ~x24))) & (~new_n58_ | ~x22 | x23);
  assign new_n70_ = x25 & x26;
  assign z14 = (x05 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n72_ & x19);
  assign new_n72_ = (~x24 | (new_n58_ & x22 & x23 & (~new_n70_ | ~x16))) & (~new_n58_ | ~x22 | ~x23 | x24);
  ...
  assign new_n77_ = (~x26 | (new_n78_ & new_n58_ & ~x18)) & (~new_n75_ | ~new_n79_);
