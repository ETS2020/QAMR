...
module FAU ( 
  ...
  assign new_n62_ = x19 ? (x20 & (~new_n63_ | ~x12 | ~x21 | ~x22)) : (~x20 | x21);
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = (new_n50_ & x02) | (~x08 & x09 & new_n65_ & ~x10);
  assign new_n65_ = x19 & (x21 ? (~x20 | (new_n60_ & new_n59_ & x13)) : x20);
  assign z12 = (new_n50_ & x03) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x19 & ((x21 & (new_n68_ | (x20 & ~x22))) | (~x20 & x22))) | (~x21 & x22));
  assign new_n68_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = (new_n50_ & x04) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x21 | ~x23) & (~x19 | ((~x21 | (~new_n71_ & (~x20 | ~x22 | x23))) & (~x23 | (x20 & x22))));
  assign new_n71_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (x21 | ~x24) & (~x19 | ((~x21 | (~new_n74_ & ~new_n75_)) & (new_n76_ | ~x24)));
  assign new_n74_ = x20 & x22 & x23 & ~x24;
  assign new_n75_ = x16 & x24 & x25 & x26;
  assign new_n76_ = x20 & x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (x21 | ~x25) & (~x19 | ((~x21 | (~new_n79_ & ~new_n80_)) & (new_n81_ | ~x25)));
  assign new_n79_ = x20 & x22 & x23 & x24 & ~x25;
  assign new_n80_ = x17 & x25 & x26;
  assign new_n81_ = x20 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x21 | ~x26) & (~x19 | ((~new_n85_ | ~new_n86_) & (new_n84_ | ~x26)));
  assign new_n84_ = x23 & x24 & x25 & ~x18 & x20 & x22;
