...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (x09 & (~x21 | (~x08 & ~new_n60_ & ~x10)));
  ...
  assign z12 = (x03 & x08 & (~x09 | x21)) | (~x08 & x09 & ~x10 & ~new_n66_ & x21);
  assign new_n66_ = (~x22 | (x19 & x20 & (~new_n64_ | ~x14 | ~x23))) & (~x19 | ~x20 | x22);
  assign z13 = (x04 & x08) | (x09 & (~x21 | (~x08 & ~new_n68_ & ~x10)));
  assign new_n68_ = (~x23 | (new_n69_ & x22 & (~new_n64_ | ~x15 | ~x21))) & (~new_n69_ | ~x22 | x23);
  assign new_n69_ = x19 & x20;
  assign z14 = (x05 & x08 & (~x09 | x21)) | (x09 & (~x21 | (~x08 & ~new_n71_ & ~x10)));
  assign new_n71_ = (~x24 | (new_n69_ & x22 & ~new_n72_ & x23)) & (~new_n69_ | ~x22 | ~x23 | x24);
  assign new_n72_ = x16 & x21 & x25 & x26;
  assign z15 = (x06 & x08 & (~x09 | x21)) | (~x08 & x09 & ~x10 & ~new_n74_ & x21);
  assign new_n74_ = (~new_n75_ | ~x23 | ~x24 | x25) & (~x25 | (new_n75_ & x23 & x24 & (~x17 | ~x26)));
  assign new_n75_ = x19 & x20 & x22;
  assign z16 = (x07 & x08) | (x09 & (~x21 | (~x08 & ~new_n77_ & ~x10)));
  assign new_n77_ = (~x26 | (new_n78_ & new_n69_ & ~x18)) & (~new_n75_ | ~new_n79_);
  assign new_n78_ = x22 & x23 & x25 & (~x21 | x24);
