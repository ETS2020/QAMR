...
module FAU ( 
  ...
  assign new_n65_ = ~x19 & (x17 | (~x08 & x09 & ~x10 & x20));
  ...
  assign new_n72_ = ~x19 & (x17 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n76_ = ~x19 & (x17 | (~x08 & x09 & ~x10 & x23));
  ...
  assign z15 = (x06 & x08) | (~x08 & new_n82_ & x09) | (~new_n84_ & x17);
  assign new_n82_ = ~x10 & ((x25 & (~new_n83_ | ~x22 | ~x23 | ~x24)) | (new_n83_ & x22 & x23 & x24 & ~x25));
  assign new_n83_ = x19 & x20 & x21;
  assign new_n84_ = x19 & (x08 | ~x09 | x10 | ~x25 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n91_));
  assign new_n86_ = x19 & ((new_n89_ & new_n90_) | ((~new_n87_ | ~new_n88_) & x26));
