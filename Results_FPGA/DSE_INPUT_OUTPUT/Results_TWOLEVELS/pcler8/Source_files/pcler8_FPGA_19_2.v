...
module FAU ( 
  ...
  assign z00 = (x10 & ~x19) | (new_n47_ & ~x08 & x09 & ~x10 & x19 & x20);
  assign new_n47_ = x21 & x22 & x23 & x24 & x25 & x26;
  assign z01 = x00 & ~new_n49_ & x08;
  assign new_n49_ = x10 & ~x19;
  assign z02 = new_n49_ | (x01 & ~new_n49_ & x08);
  ...
  assign z09 = (x00 & x08 & (~x10 | x19)) | (~x08 & x09 & ~x10 & (new_n58_ | ~x19));
  assign new_n58_ = new_n59_ & x11 & x20 & x21 & x22;
  assign new_n59_ = x25 & x26 & x23 & x24;
  ...
  assign z12 = (x03 & x08 & (~x10 | x19)) | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x22 | (x19 & x20 & ~new_n67_ & x21)) & (~x21 | x22 | ~x19 | ~x20);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n71_ | (x04 & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x23 | (x20 & x21 & ~new_n70_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n70_ = x25 & x26 & x15 & x24;
  assign new_n71_ = ~x19 & (x10 | (~x08 & x09 & x23));
  assign z14 = new_n76_ | (x05 & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (new_n74_ & x22 & ~new_n75_ & x23)) & (~x22 | ~x23 | x24 | ~new_n74_ | ~x19);
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign new_n76_ = ~x19 & (x10 | (~x08 & x09 & x24));
  assign z15 = z07 | new_n83_ | (~x08 & new_n78_ & x09);
