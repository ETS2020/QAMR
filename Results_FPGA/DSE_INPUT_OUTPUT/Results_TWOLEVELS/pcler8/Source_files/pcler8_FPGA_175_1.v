...
module FAU ( 
  ...
  assign z00 = x19 & (~x09 | (new_n47_ & new_n49_ & new_n50_));
  ...
  assign z09 = (x00 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~x10 & (new_n60_ | (x09 & ~x19)));
  assign new_n60_ = new_n49_ & new_n50_ & new_n48_ & x11 & x19;
  assign z10 = z02 | (new_n62_ & ~x08);
  assign new_n62_ = ~x10 & ((x19 & ((new_n63_ & new_n64_) | ~x20)) | (x09 & ~x19 & x20));
  ...
  assign new_n71_ = ~new_n73_ & (~x19 | (~new_n72_ & (~new_n48_ | ~x22 | x23)));
  assign new_n72_ = x15 & x23 & x24 & x25 & x26;
  assign new_n73_ = x09 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (new_n75_ & ~x08) | (~x09 & x19);
  assign new_n75_ = ~x10 & ((new_n78_ & x09) | (x19 & (new_n76_ | new_n77_)));
  ...
  assign new_n80_ = (~x25 | (new_n81_ & new_n49_ & x24 & (~x17 | ~x26))) & (~new_n81_ | ~new_n49_ | ~x24 | x25);
  assign new_n81_ = x19 & x20 & x21;
  assign z16 = z08 | (~x08 & new_n83_ & x09);
  assign new_n83_ = ~x10 & ((new_n84_ & new_n87_) | ((~new_n85_ | ~new_n86_) & x26));
