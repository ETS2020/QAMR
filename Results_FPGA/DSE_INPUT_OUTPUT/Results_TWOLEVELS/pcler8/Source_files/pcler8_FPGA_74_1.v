...
module FAU ( 
  ...
  assign z13 = (x04 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n70_ & ~x10);
  assign new_n70_ = ~new_n72_ & (~x19 | (~new_n71_ & (~new_n58_ | ~x22 | x23)));
  assign new_n71_ = x09 & x15 & x23 & x24 & x25 & x26;
  ...
  assign z15 = z07 | (~x08 & ~x10 & (new_n79_ | (new_n81_ & x09)));
  assign new_n79_ = x19 & (new_n80_ | (new_n75_ & x09 & x17));
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x25 & (~new_n58_ | ~x19 | ~x22 | ~x23 | ~x24);
  assign z16 = (x19 & (new_n83_ | ~x09)) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n83_ = new_n84_ & new_n58_ & ~x08 & ~x10;
  assign new_n84_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n85_ = ~x10 & x26 & (~new_n86_ | ~new_n58_ | x18 | ~x19);
