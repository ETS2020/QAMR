...
module FAU ( 
  ...
  assign z12 = (new_n51_ & x03) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & x22 & ((x19 & (~x20 | (x20 & ~x21))) | new_n69_ | ~x19);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (~x19 | x22)) | (x19 & (new_n73_ | ~x22)) | (new_n71_ & ~x08);
  ...
  assign z15 = z07 | new_n79_ | (~x08 & x09 & new_n80_ & ~x10);
  assign new_n79_ = x19 & (~x22 | (new_n47_ & new_n48_ & x24 & ~x25));
  assign new_n80_ = x25 & (~new_n82_ | ~new_n81_ | ~x19);
  assign new_n81_ = x20 & x21;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (x19 | ~x26) & (~x22 | ((new_n85_ | ~x26) & (~new_n86_ | ~new_n81_ | ~x19)));
  assign new_n85_ = ~x18 & x20 & x21 & x23 & x24 & x25;
