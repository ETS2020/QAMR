...
module FAU ( 
  ...
  assign new_n76_ = (~x19 | ((~x23 | (~new_n77_ & ~new_n78_)) & (new_n79_ | ~x24))) & (x23 | ~x24);
  assign new_n77_ = x20 & x21 & x22 & ~x24;
  assign new_n78_ = x16 & x24 & x25 & x26;
  assign new_n79_ = x20 & x21 & x22;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x23 | (~new_n82_ & (~new_n59_ | ~x22 | ~x24 | x25))) & (~x25 | (new_n59_ & x22 & x23 & x24));
  assign new_n82_ = x17 & x25 & x26;
  assign z16 = z08 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (x23 | ~x26) & (~x19 | ((new_n85_ | ~x26) & (~new_n79_ | ~new_n86_)));
