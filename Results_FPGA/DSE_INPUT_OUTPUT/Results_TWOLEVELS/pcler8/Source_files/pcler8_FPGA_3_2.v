...
module FAU ( 
  ...
  assign z11 = (x09 & (~x19 | (~x08 & ~new_n64_ & ~x10))) | (x02 & x08 & (~x09 | x19));
  ...
  assign new_n72_ = (~x24 | (new_n47_ & x22 & x23 & (~new_n61_ | ~x16))) & (~new_n47_ | ~x22 | ~x23 | x24);
  ...
  assign new_n77_ = (~x26 | (new_n78_ & (new_n62_ | ~x19))) & (~new_n75_ | ~new_n62_ | ~x25 | x26);
  assign new_n78_ = x21 & x22 & x25 & ~x18 & x20;
endmodule
