...
module FAU ( 
  ...
  assign z00 = (x18 & ~x19) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  assign new_n47_ = ~x08 & x09;
  assign new_n48_ = x21 & x22 & x23 & x24 & x25 & x26;
  assign z01 = (x18 & ~x19) | (x00 & x08);
  assign z02 = (x18 & ~x19) | (x01 & x08 & (~x18 | x19));
  assign z03 = new_n52_ & x02;
  assign new_n52_ = x08 & (~x18 | x19);
  ...
  assign z10 = (new_n52_ & x01) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x19 | (x20 & (~new_n61_ | ~new_n60_ | ~x12))) & (x18 | x19 | ~x20);
  ...
  assign z13 = z05 | new_n71_ | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n71_ = ~x19 & (x18 | (new_n47_ & ~x10 & x23));
  ...
  assign new_n75_ = (x18 | x19 | ~x24) & (~x19 | ((~new_n76_ | ~new_n78_) & (~x24 | (new_n76_ & new_n77_))));
  assign new_n76_ = x20 & x21;
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (x18 | x19 | ~x25) & (~x19 | ((~new_n81_ | ~new_n83_) & (~x25 | (new_n81_ & new_n82_))));
  assign new_n81_ = x20 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x23 & x24 & ~x25;
  assign z16 = z08 | new_n85_ | (~x08 & new_n86_ & x09);
  assign new_n85_ = x18 & (~x19 | (new_n47_ & ~x10 & x26));
  assign new_n86_ = ~x10 & ((new_n89_ & new_n90_) | (x26 & (new_n87_ | ~new_n88_)));
  assign new_n87_ = ~x18 & (~x23 | ~x24);
  assign new_n88_ = x19 & x20 & x21 & x22 & x25;
  assign new_n89_ = x19 & x20 & x21 & x22;
  assign new_n90_ = x25 & ~x26 & x23 & x24;
endmodule
