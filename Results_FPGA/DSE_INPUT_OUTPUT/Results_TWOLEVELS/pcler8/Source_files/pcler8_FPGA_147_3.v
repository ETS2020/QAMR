...
module FAU ( 
  ...
  assign new_n80_ = ~x17 & (~new_n81_ | x10 | ~x20 | x08 | ~x09);
  assign new_n81_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x10 & ~new_n83_ & x25;
  assign new_n83_ = x22 & x23 & x24 & x19 & x20 & x21;
  assign z16 = new_n59_ | (~x08 & x09 & ~x10 & (new_n85_ | new_n90_));
  assign new_n85_ = ~x17 & ((new_n88_ & new_n89_) | ((~new_n86_ | ~new_n87_) & x26));
