...
module FAU ( 
  ...
  assign z05 = (x04 & x08) | (x18 & ~x19);
  assign z06 = (x05 & x08) | (x18 & ~x19);
  ...
  assign new_n63_ = ~x19 & (x18 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (~x18 | x19)) | (~x19 & (new_n67_ | x18)) | (new_n65_ & ~x08);
  ...
  assign new_n69_ = (~x19 | ((~x20 | ~x21 | x22) & (~x22 | (x20 & ~new_n70_ & x21)))) & (x18 | x19 | ~x22);
  ...
  assign new_n74_ = ~x19 & (x18 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n79_ = ~x19 & (x18 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x19 | ((~new_n82_ | ~new_n84_) & (~x25 | (new_n82_ & new_n83_)))) & (x18 | x19 | ~x25);
  ...
  assign new_n88_ = x22 & x23 & x25 & (x18 | x24);
  assign new_n89_ = x19 & x20 & x21 & x22;
  assign new_n90_ = x23 & x24 & x25 & ~x26;
  assign new_n91_ = x18 & (~x19 | (~x08 & x09 & ~x10 & x26));
endmodule
