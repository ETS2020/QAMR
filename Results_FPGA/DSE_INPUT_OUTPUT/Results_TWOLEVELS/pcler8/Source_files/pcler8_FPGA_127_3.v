...
module FAU ( 
  ...
  assign new_n59_ = ~x26 & (x08 | ~x09 | x10 | ~x20 | x21);
  assign new_n60_ = x09 & ~x10 & x21 & (~x19 | ~x20);
  assign z12 = z04 | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x22 & (~x19 | ((~x20 | ~x21) & ~x26))) | (x19 & x20 & x21 & ~x22 & ~x26));
  assign z13 = z05 | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = (~x23 | (x19 & (x26 | (x20 & x21 & x22)))) & (~x22 | x23 | x26 | ~x19 | ~x20 | ~x21);
  ...
  assign z15 = z07 | (~new_n69_ & x19) | (~x08 & new_n71_ & x09);
  assign new_n69_ = ~x26 & (~new_n70_ | x08 | ~x09 | x10 | ~x20);
  assign new_n70_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n71_ = ~x10 & x25 & (~new_n72_ | ~x22 | ~x23 | ~x24);
  assign new_n72_ = x19 & x20 & x21;
  assign z16 = z08 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = ~x26 & (~new_n72_ | ~new_n67_ | ~x24 | ~x25);
endmodule
