...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (~x10 | x19)) | (x10 & ~x19) | (~x08 & x09 & (new_n57_ | ~x19));
  assign new_n57_ = new_n58_ & ~x10 & x11 & new_n59_ & x22 & x23;
  assign new_n58_ = x20 & x21;
  assign new_n59_ = x24 & x25 & x26;
  assign z10 = (x01 & x08 & (~x10 | x19)) | (x10 & ~x19) | (new_n61_ & ~x08);
  assign new_n61_ = x09 & ((~x10 & ((new_n62_ & new_n63_) | (x19 & ~x20))) | (~x19 & x20));
  ...
  assign new_n67_ = ~x19 & (x10 | (~x08 & x09 & x21));
  ...
  assign new_n71_ = ~x19 & (x10 | (~x08 & x09 & x22));
  ...
  assign new_n75_ = ~x19 & (x10 | (~x08 & x09 & x23));
  assign z14 = z06 | new_n79_ | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x24 | (new_n58_ & x22 & ~new_n78_ & x23)) & (~x22 | ~x23 | x24 | ~new_n58_ | ~x19);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = ~x19 & (x10 | (~x08 & x09 & x24));
  ...
  assign new_n86_ = ~x19 & (x10 | (~x08 & x09 & x25));
  ...
  assign new_n93_ = ~x19 & (x10 | (~x08 & x09 & x26));
endmodule
