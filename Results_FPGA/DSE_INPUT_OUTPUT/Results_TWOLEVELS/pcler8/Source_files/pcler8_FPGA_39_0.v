...
module FAU ( 
  ...
  assign z13 = (x04 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x23 | (x19 & x20 & x21 & ~new_n71_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (new_n74_ & x22 & ~new_n75_ & x23)) & (~new_n74_ | ~x22 | ~x23 | x24);
  assign new_n74_ = x19 & x20 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign z15 = (x06 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n81_ & ~x08))) | (~x08 & new_n77_ & x09);
  assign new_n77_ = ~x10 & ((new_n74_ & new_n80_) | (x25 & (~new_n78_ | ~new_n79_)));
  assign new_n78_ = x20 & x21 & x22;
  assign new_n79_ = x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x22 & x23 & x24 & ~x25;
  assign new_n81_ = ~x10 & x25;
  assign z16 = (x07 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n88_ & ~x08))) | (~x08 & new_n83_ & x09);
