...
module FAU ( 
  ...
  assign new_n69_ = ~new_n72_ & (~x19 | (~new_n71_ & (~new_n70_ | ~x22 | x23)));
  ...
  assign new_n74_ = x19 & (new_n75_ | (new_n70_ & x22 & x23 & ~x24));
  ...
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (x19 & (new_n83_ | ~x09)) | (~x08 & new_n85_ & x09);
  assign new_n83_ = new_n84_ & new_n70_ & ~x08 & ~x10;
