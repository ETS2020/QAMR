...
module FAU ( 
  ...
  assign new_n60_ = (x17 | x19) & (~new_n49_ | ~new_n50_ | ~new_n61_ | ~x11 | ~x19);
  assign new_n61_ = x20 & x21;
  assign z10 = (x01 & ~new_n47_ & x08) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x19 & ((new_n64_ & new_n65_) | ~x20)) | (~x17 & ~x19 & x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (~x17 | x19)) | ((new_n69_ | x17) & ~x19) | (new_n67_ & ~x08);
  ...
  assign new_n77_ = ~x19 & (x17 | (~x08 & x09 & ~x10 & x23));
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x17 | x19 | ~x24) & (~x19 | (((new_n61_ & new_n80_) | ~x24) & (~new_n61_ | ~new_n81_)));
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n81_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x17 | x19 | ~x25) & (~x19 | (((new_n84_ & new_n85_) | ~x25) & (~new_n84_ | ~new_n86_)));
  assign new_n84_ = x20 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x23 & x24 & ~x25;
  assign z16 = new_n93_ | (~x08 & new_n88_ & x09) | (x07 & x08);
  ...
  assign new_n93_ = ~x19 & (x17 | (~x08 & x09 & ~x10 & x26));
endmodule
