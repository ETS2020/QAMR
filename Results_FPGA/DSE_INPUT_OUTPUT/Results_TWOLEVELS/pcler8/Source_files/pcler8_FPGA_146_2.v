...
module FAU ( 
  ...
  assign z09 = z01 | (x09 & (new_n57_ | ~x19));
  assign new_n57_ = new_n58_ & ~x08 & ~x10 & x11 & x20 & x21;
  assign new_n58_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08) | (x09 & (~x19 | (~x08 & ~new_n60_ & ~x10)));
  assign new_n60_ = x20 & (~new_n61_ | ~x12 | ~x21 | ~x22);
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n63_ & x19);
  assign new_n63_ = x21 ? (x20 & (~new_n64_ | ~x13 | ~x22 | ~x23)) : ~x20;
  assign new_n64_ = x24 & x25 & x26;
  assign z12 = (x09 & (~x19 | (~x08 & ~new_n66_ & ~x10))) | (x03 & x08 & (~x09 | x19));
  assign new_n66_ = (~x22 | (x20 & x21 & (~new_n64_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n68_ & x19);
  assign new_n68_ = (~x23 | (~new_n69_ & x22 & x20 & x21)) & (~x20 | ~x21 | ~x22 | x23);
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = (x09 & (~x19 | (~x08 & ~new_n71_ & ~x10))) | (x05 & x08 & (~x09 | x19));
  assign new_n71_ = (~x24 | (new_n72_ & x20 & x21)) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n72_ = (~x19 | x22) & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x09 & (~x19 | (~x08 & ~new_n74_ & ~x10))) | (x06 & x08 & (~x09 | x19));
  assign new_n74_ = (~x25 | (new_n75_ & x23 & ~new_n76_ & x24)) & (~new_n77_ | ~x23 | ~x24 | x25);
  assign new_n75_ = x20 & x21 & (~x19 | x22);
  assign new_n76_ = x17 & x26;
  assign new_n77_ = x20 & x21 & x22;
  assign z16 = (x07 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n79_ & x19);
  assign new_n79_ = (~x26 | (new_n80_ & new_n81_)) & (~new_n77_ | ~new_n82_);
  assign new_n80_ = ~x18 & x20 & x21;
