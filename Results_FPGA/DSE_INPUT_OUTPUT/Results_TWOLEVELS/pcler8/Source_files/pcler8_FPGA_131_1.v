...
module FAU ( 
  ...
  assign new_n77_ = (~x25 | (~new_n79_ & ~new_n80_)) & (~new_n74_ | ~new_n78_ | ~x24 | x25);
  assign new_n78_ = x22 & x23;
  assign new_n79_ = x19 & (~x20 | ~x24 | (x17 & x26));
  assign new_n80_ = x09 & (~x22 | ~x23 | ~x19 | ~x21);
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (~x09 & x19) | (new_n82_ & ~x08);
  assign new_n82_ = ~x10 & ((new_n84_ & new_n85_) | (x26 & (new_n80_ | new_n83_)));
  assign new_n83_ = x19 & (~x24 | ~x25 | x18 | ~x20);
