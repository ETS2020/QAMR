...
module FAU ( 
  ...
  assign z09 = new_n61_ | (new_n62_ & new_n51_ & new_n50_ & x21);
  assign new_n61_ = ~new_n49_ & ((x00 & x08) | (~x08 & x09 & ~x10 & ~x19));
  assign new_n62_ = ~x08 & x09 & ~x10 & x11 & x20;
  assign z10 = (~x08 & x09 & ~new_n64_ & ~x10) | (x01 & x08) | (~x01 & ~x11);
  ...
  assign z12 = ~new_n49_ & (x08 ? x03 : (x09 & ~new_n69_ & ~x10));
  ...
  assign z14 = ~new_n49_ & (x08 ? x05 : (new_n74_ & x09));
  ...
  assign z15 = ~new_n49_ & (x08 ? x06 : (x09 & ~new_n78_ & ~x10));
  assign new_n78_ = (~x25 | (new_n75_ & new_n50_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n50_ | ~x24 | x25);
  assign z16 = ~new_n49_ & (x08 ? x07 : (new_n80_ & x09));
