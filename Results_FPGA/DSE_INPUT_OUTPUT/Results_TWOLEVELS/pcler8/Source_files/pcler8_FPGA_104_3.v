...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x10 | ~x20)) | (x10 & x20) | (new_n62_ & ~x08);
  assign new_n62_ = x09 & ((x20 & (x21 ? (new_n63_ | ~x19) : x19)) | (~x10 & ~x20 & x21));
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x22 | (~new_n66_ & x21 & x19 & x20)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n66_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & (new_n68_ | new_n70_));
  assign new_n68_ = x23 & ((~new_n69_ & x20) | (~x10 & (~x20 | ~x21 | ~x22)));
  assign new_n69_ = x19 & (~x25 | ~x26 | ~x15 | ~x24);
  ...
  assign z15 = (x06 & x08 & (~x10 | ~x20)) | (x10 & x20) | (new_n76_ & ~x08);
  assign new_n76_ = x09 & ((x25 & (new_n77_ | new_n78_)) | (new_n73_ & new_n79_));
  assign new_n77_ = x20 & (~x19 | (~x10 & x17 & x26));
  assign new_n78_ = ~x10 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n79_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & (new_n81_ | (new_n83_ & ~x10)));
  assign new_n81_ = x20 & ((~x19 & x26) | (new_n82_ & x19 & x21 & x22));
  assign new_n82_ = x23 & x24 & x25 & ~x26;
  assign new_n83_ = x26 & (~new_n84_ | x18 | ~x20 | ~x21);
