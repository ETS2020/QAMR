...
module FAU ( 
  ...
  assign z00 = x19 & (x15 | (new_n47_ & new_n48_));
  ...
  assign z04 = (x15 & x19) | (x03 & x08 & (~x15 | ~x19));
  assign z05 = (x04 & x08) | (x15 & x19);
  assign z06 = (x15 & x19) | (x05 & x08 & (~x15 | ~x19));
  assign z07 = (x06 & x08) | (x15 & x19);
  assign z08 = new_n50_ & x07;
  assign z09 = z01 | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & (~x19 | (new_n48_ & new_n60_ & x11 & ~x15));
  assign new_n60_ = x20 & x21;
  assign z10 = z02 | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (x15 | ~x19 | (x20 & (~new_n64_ | ~new_n63_ | ~x12))) & (x19 | ~x20);
  assign new_n63_ = x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((~x15 & ((x21 & (new_n67_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (new_n50_ & x03) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x15 | ((~x22 | (x20 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x19 & (new_n72_ | x15)) | (x04 & x08) | (new_n73_ & ~x08);
  assign new_n72_ = ~x08 & x09 & ~x10 & new_n60_ & x22 & ~x23;
  assign new_n73_ = x09 & ~x10 & x23 & (~new_n63_ | ~x19 | ~x20);
  assign z14 = (new_n50_ & x05) | (~x08 & x09 & ~new_n75_ & ~x10);
  ...
  assign new_n79_ = ~x15 & (~new_n80_ | x10 | ~x20 | x08 | ~x09);
  assign new_n80_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = ~x10 & x25 & (~new_n82_ | ~new_n60_ | ~x19);
  assign new_n82_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~new_n84_ & x19) | (~x08 & new_n86_ & x09);
  assign new_n84_ = ~x15 & (~new_n47_ | ~new_n85_);
  assign new_n85_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | ~new_n60_ | x18 | ~x19);
