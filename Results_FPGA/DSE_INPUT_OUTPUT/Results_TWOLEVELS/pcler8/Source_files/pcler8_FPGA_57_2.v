...
module FAU ( 
  ...
  assign new_n61_ = (~x19 | (x20 & (~new_n59_ | ~new_n62_))) & (x02 | x19 | ~x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (~x08 & new_n64_ & x09) | (x02 & x08 & x19);
  assign new_n64_ = ~x10 & ((x19 & (x21 ? (new_n65_ | ~x20) : x20)) | (~x02 & ~x19 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x02 & (new_n69_ | (x03 & x08))) | (x19 & (x08 ? x03 : new_n67_));
  assign new_n67_ = x09 & ~x10 & ((x22 & (~x20 | new_n68_ | ~x21)) | (x20 & x21 & ~x22));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x08 & x09 & ~x10 & ~x19 & x22;
  assign z13 = (~x02 & (new_n74_ | (x04 & x08))) | (x19 & (x08 ? x04 : new_n71_));
  assign new_n71_ = x09 & ~x10 & ((x23 & (~new_n72_ | new_n73_ | ~x22)) | (new_n72_ & x22 & ~x23));
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign new_n74_ = ~x08 & x09 & ~x10 & ~x19 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | (~new_n78_ & (~new_n77_ | ~x16 | ~x24))) & (new_n79_ | ~x24);
  assign new_n77_ = x25 & x26;
  assign new_n78_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n79_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = (~x02 & (new_n85_ | (x06 & x08))) | (x19 & (x08 ? x06 : new_n81_));
  ...
  assign new_n92_ = ~x19 & (x02 | (~x10 & x26 & ~x08 & x09));
endmodule
