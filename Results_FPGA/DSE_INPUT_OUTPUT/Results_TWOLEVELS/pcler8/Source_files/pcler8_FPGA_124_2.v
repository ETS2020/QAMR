...
module FAU ( 
  ...
  assign new_n59_ = (x13 | x19) & (~new_n61_ | ~new_n60_ | ~x11 | ~x19);
  ...
  assign new_n65_ = ~x19 & (x13 | (~x08 & x09 & ~x10 & x20));
  ...
  assign z13 = new_n76_ | (x04 & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x23 | (x20 & x21 & ~new_n75_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign new_n76_ = ~x19 & (x13 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x19 | ((~x24 | (new_n60_ & new_n79_)) & (~new_n60_ | ~new_n80_))) & (x13 | x19 | ~x24);
  ...
  assign new_n87_ = ~x19 & (x13 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n94_ = ~x19 & (x13 | (~x08 & x09 & ~x10 & x26));
endmodule
