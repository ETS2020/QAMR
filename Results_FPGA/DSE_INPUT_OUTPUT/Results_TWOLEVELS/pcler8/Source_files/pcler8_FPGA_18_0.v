...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n50_, new_n58_, new_n59_, new_n60_, new_n61_, new_n63_,
  ...
  assign z12 = (new_n50_ & x03) | (~x08 & x09 & ~new_n68_ & ~x10);
  ...
  assign new_n71_ = (~x12 | x19 | ~x23) & (~x19 | ((~x23 | (new_n59_ & ~new_n72_ & x22)) & (~new_n59_ | ~x22 | x23)));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x19 | ((~x24 | (new_n59_ & new_n75_)) & (~new_n59_ | ~new_n76_))) & (~x12 | x19 | ~x24);
  ...
  assign new_n83_ = ~x19 & (~x12 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n89_ | (~x08 & x09 & ~new_n85_ & ~x10) | (x07 & x08);
  assign new_n85_ = (~new_n87_ | ~new_n88_) & (~x26 | (new_n86_ & new_n59_ & ~x18));
  assign new_n86_ = x22 & x23 & x24 & x25;
  assign new_n87_ = x19 & x20 & x21 & x22;
  assign new_n88_ = x23 & x24 & x25 & ~x26;
  assign new_n89_ = ~x19 & (~x12 | (~x08 & x09 & ~x10 & x26));
endmodule
