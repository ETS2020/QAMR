...
module FAU ( 
  ...
  assign new_n58_ = (x03 | x19) & (~new_n60_ | ~new_n59_ | ~x11 | ~x19);
  ...
  assign new_n64_ = ~x19 & (x03 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (x21 ? (new_n67_ | ~x20) : x20)) | (~x03 & ~x19 & x21));
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (~x08 & x09 & ~new_n69_ & ~x10) | (x03 & x08 & x19);
  assign new_n69_ = (~x19 | ((~x22 | (x20 & ~new_n70_ & x21)) & (~x20 | ~x21 | x22))) & (x03 | x19 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x19 | ((x21 | ~x23) & (~x20 | ~x21 | ~x22 | x23))) & (~x23 | (x19 & x20 & ~new_n73_ & x22));
  ...
  assign new_n77_ = ~x10 & ((x24 & (~new_n59_ | ~x22 | new_n78_ | ~x23)) | (new_n59_ & x22 & x23 & ~x24));
  assign new_n78_ = x16 & x25 & x26;
  assign z15 = new_n84_ | (x06 & x08) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x25 | ((new_n81_ | ~x19) & new_n59_ & new_n82_)) & (~new_n83_ | ~new_n59_ | ~x19);
  assign new_n81_ = x23 & (~x17 | ~x26);
  assign new_n82_ = x22 & x24;
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign new_n84_ = ~x19 & (x03 | (~x08 & x09 & ~x10 & x25));
