...
module FAU ( 
  ...
  assign z08 = new_n59_ | (~x06 & x19);
  assign new_n59_ = new_n51_ & x07;
  assign z09 = z01 | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = x19 & (~new_n49_ | ~new_n48_ | ~x06 | ~x11);
  assign z10 = z02 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x06 & x19 & ((new_n64_ & new_n65_) | ~x20)) | (~x19 & x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (new_n51_ & x02) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x06 & ((x21 & (new_n68_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n68_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08 & (x06 | ~x19)) | (new_n70_ & ~x08) | ((new_n73_ | ~x06) & x19);
  assign new_n70_ = x09 & ~x10 & x22 & (~new_n71_ | ~new_n72_);
  assign new_n71_ = x19 & (~x06 | x20);
  assign new_n72_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n73_ = x20 & x21 & ~x22 & ~x08 & x09 & ~x10;
  assign z13 = z05 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (x19 | ~x23) & (~x06 | (~new_n77_ & ((new_n48_ & new_n76_) | ~x23)));
  assign new_n76_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n77_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x19 | ~x24) & (~x06 | (((new_n48_ & new_n80_) | ~x24) & (~new_n81_ | ~new_n48_ | ~x19)));
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n81_ = x22 & x23 & ~x24;
  assign z15 = (~new_n87_ & x06) | (~x06 & x19) | (x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x19 | (~new_n84_ & ~new_n85_)) & (~new_n86_ | x08);
  assign new_n84_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n85_ = x17 & x25 & x26;
  assign new_n86_ = (~x19 | ~x21 | ~x22 | ~x23 | ~x24) & x25;
  assign new_n87_ = ~x08 & (~x09 | x10 | x20 | ~x25);
  assign z16 = new_n59_ | (~x08 & x09 & ~x10 & (new_n89_ | new_n94_));
  assign new_n89_ = x06 & ((new_n92_ & new_n93_) | ((~new_n90_ | ~new_n91_) & x26));
