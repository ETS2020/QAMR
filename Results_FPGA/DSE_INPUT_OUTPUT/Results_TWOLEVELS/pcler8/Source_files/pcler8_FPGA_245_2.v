...
module FAU ( 
  ...
  assign new_n62_ = (~x19 | (x20 & (~new_n60_ | ~x12 | ~x21 | ~x22))) & (x12 | x19 | ~x20);
  assign z11 = new_n66_ | (~x08 & x09 & ~new_n64_ & ~x10) | (x02 & x08);
  assign new_n64_ = (~x21 | (~new_n65_ & x20)) & (~x19 | ~x20 | x21);
  assign new_n65_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n66_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x21));
  ...
  assign new_n88_ = x19 & ((new_n82_ & new_n91_) | (x26 & (~new_n89_ | ~new_n90_)));
