...
module FAU ( 
  ...
  assign z12 = (x03 & ~new_n49_ & x08) | new_n49_ | (~x08 & new_n68_ & x09);
  ...
  assign new_n71_ = (~x19 | ((~x22 | (~new_n72_ & (~x20 | ~x21 | x23))) & (~x23 | (x20 & x21)))) & (x22 | ~x23);
  assign new_n72_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x22 | ((~new_n59_ | ~x23 | x24) & (~new_n75_ | ~x16 | ~x24))) & (~x24 | (new_n59_ & x22 & x23));
  assign new_n75_ = x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x22 | (~new_n78_ & (~new_n59_ | ~x23 | ~x24 | x25))) & (~x25 | (new_n59_ & x22 & x23 & x24));
  assign new_n78_ = x17 & x25 & x26;
  assign z16 = z08 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (x22 | ~x26) & (~x19 | ((~new_n82_ | ~new_n83_) & (new_n81_ | ~x26)));
  assign new_n81_ = x23 & x24 & x25 & ~x18 & x20 & x21;
