...
module FAU ( 
  ...
  assign z09 = new_n59_ | (new_n49_ & new_n60_);
  assign new_n59_ = x00 & (x08 | (x09 & ~x10 & ~x19));
  ...
  assign z11 = (x00 & (new_n69_ | (x02 & x08))) | (x19 & (x08 ? x02 : new_n67_));
  assign new_n67_ = x09 & ~x10 & (x21 ? (new_n68_ | ~x20) : x20);
  assign new_n68_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x08 & x09 & ~x10 & ~x19 & x21;
  assign z12 = (x00 & (new_n73_ | (x03 & x08))) | (x19 & (x08 ? x03 : new_n71_));
  assign new_n71_ = x09 & ~x10 & ((x22 & (~x20 | new_n72_ | ~x21)) | (x20 & x21 & ~x22));
  assign new_n72_ = x14 & x23 & x24 & x25 & x26;
  assign new_n73_ = ~x08 & x09 & ~x10 & ~x19 & x22;
  assign z13 = (x00 & (new_n78_ | (x04 & x08))) | (x19 & (x08 ? x04 : new_n75_));
  assign new_n75_ = x09 & ~x10 & ((x23 & (~new_n76_ | new_n77_ | ~x22)) | (new_n76_ & x22 & ~x23));
  ...
  assign new_n82_ = ~x10 & ((x24 & (~new_n76_ | ~x22 | new_n83_ | ~x23)) | (new_n76_ & x22 & x23 & ~x24));
