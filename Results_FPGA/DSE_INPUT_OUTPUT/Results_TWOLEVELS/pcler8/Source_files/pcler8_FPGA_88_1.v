...
module FAU ( 
  ...
  assign new_n48_ = x21 & x22 & x23 & x25 & x26;
  ...
  assign z09 = (x00 & ~new_n50_ & x08) | new_n50_ | (~x08 & new_n59_ & x09);
  ...
  assign new_n65_ = ~x10 & (x20 ? (x21 ? (new_n66_ | ~x19) : x19) : (x21 & ~x24));
  ...
  assign new_n70_ = ~x20 & (x24 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z14 = (x05 & ~new_n50_ & x08) | new_n50_ | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & (new_n78_ | (x24 & (~new_n77_ | ~x19 | ~x21)));
  ...
  assign new_n80_ = (~x20 | ((new_n81_ | ~x25) & (~new_n82_ | ~x23 | ~x24 | x25))) & (x24 | ~x25);
