...
module FAU ( 
  ...
  assign new_n73_ = x26 & (~x19 | (x15 & x24 & x25));
  ...
  assign z15 = z07 | new_n84_ | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | (new_n81_ & new_n83_)) & (~new_n82_ | ~new_n80_ | ~x24 | x25);
  ...
  assign new_n86_ = (~new_n81_ | ~new_n87_) & (~x26 | (new_n60_ & new_n59_ & ~x18));
