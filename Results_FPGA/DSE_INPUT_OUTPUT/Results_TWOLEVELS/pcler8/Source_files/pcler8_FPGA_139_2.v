...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x12 | x19)) | (x12 & (new_n62_ | ~x19)) | (new_n64_ & ~x08);
  assign new_n62_ = new_n63_ & ~x08 & x09 & ~x10 & x21;
  assign new_n63_ = x22 & x23 & x24 & x25 & x26;
  assign new_n64_ = x09 & ~x10 & (x19 ^ x20);
  ...
  assign new_n80_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n87_ | (x06 & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x25 | (new_n85_ & new_n86_)) & (~new_n84_ | ~new_n83_ | ~x24 | x25);
  assign new_n83_ = x22 & x23;
  assign new_n84_ = x19 & x20 & x21;
  assign new_n85_ = x20 & x21 & x22;
  assign new_n86_ = x23 & x24 & (~x17 | ~x26);
  assign new_n87_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n57_ | (~x08 & x09 & ~x10 & (new_n89_ | new_n93_));
  assign new_n89_ = x19 & ((new_n85_ & new_n92_) | (x26 & (~new_n90_ | ~new_n91_)));
  assign new_n90_ = ~x18 & x20 & x21;
  assign new_n91_ = x22 & x23 & x24 & x25;
  assign new_n92_ = x23 & x24 & x25 & ~x26;
  assign new_n93_ = ~x12 & ~x19 & x26;
endmodule
