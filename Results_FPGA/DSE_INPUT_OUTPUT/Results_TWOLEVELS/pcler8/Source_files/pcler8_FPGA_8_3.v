...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (~x19 | ~x25)) | (~x08 & x09 & ~x10 & ~x19);
  assign z10 = z02 | (new_n57_ & ~x08);
  assign new_n57_ = x09 & ~x10 & (x19 ? (~x20 & ~x25) : x20);
  assign z11 = (x02 & x08 & (~x19 | ~x25)) | (x19 & (new_n59_ | x25)) | (new_n60_ & ~x08);
  assign new_n59_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign new_n60_ = x09 & ~x10 & x21 & (~x19 | ~x20);
  assign z12 = (x03 & ~z00 & x08) | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x22 & (~x19 | (~x25 & (~x20 | ~x21)))) | (x19 & x20 & x21 & ~x22 & ~x25));
  assign z13 = z05 | new_n64_ | (~x08 & new_n66_ & x09);
  assign new_n64_ = x19 & (x25 | (new_n65_ & ~x08 & x09 & ~x10));
  assign new_n65_ = x20 & x21 & x22 & ~x23;
  assign new_n66_ = ~x10 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = z06 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x24 | (x19 & (x25 | (new_n69_ & x22 & x23)))) & (~new_n69_ | ~x19 | ~x22 | ~x23 | x24 | x25);
  assign new_n69_ = x20 & x21;
  assign z15 = z07 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = ~x25 & (~new_n69_ | ~x19 | ~x22 | ~x23 | ~x24);
