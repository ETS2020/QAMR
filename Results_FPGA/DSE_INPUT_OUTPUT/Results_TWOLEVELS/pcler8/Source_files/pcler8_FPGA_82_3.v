...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x05 | ~x19)) | (x19 & (new_n68_ | x05)) | (new_n66_ & ~x08);
  ...
  assign z14 = new_n79_ | (~x05 & ~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x24 | (new_n60_ & x22 & ~new_n78_ & x23)) & (~new_n60_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = ~x19 & ((x05 & x08) | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & x08 & (~x05 | ~x19)) | (x19 & (new_n81_ | x05)) | (new_n83_ & ~x08);
