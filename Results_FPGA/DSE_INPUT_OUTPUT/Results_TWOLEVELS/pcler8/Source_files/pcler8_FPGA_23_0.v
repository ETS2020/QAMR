...
module FAU ( 
  ...
  assign z15 = (x06 & ~new_n47_ & x08) | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((x25 & (new_n83_ | new_n84_)) | (new_n82_ & new_n85_));
  assign new_n82_ = x19 & x20 & x21;
  assign new_n83_ = x17 & (~x19 | x26);
  assign new_n84_ = x19 & (~x22 | ~x23 | ~x24 | ~x20 | ~x21);
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign z16 = new_n58_ | (~x08 & x09 & ~x10 & (new_n87_ | new_n92_));
  assign new_n87_ = x19 & ((new_n90_ & new_n91_) | (x26 & (~new_n88_ | ~new_n89_)));
