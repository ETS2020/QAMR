...
module FAU ( 
  ...
  assign z00 = x19 & (new_n47_ | ~x25);
  assign new_n47_ = new_n48_ & ~x08 & x09 & ~x10 & x20;
  assign new_n48_ = x21 & x22 & x23 & x24 & x26;
  assign z01 = new_n50_ | (x00 & ~new_n50_ & x08);
  assign new_n50_ = x19 & ~x25;
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n63_))) & (~x19 | x20 | ~x25);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (~x19 | x25)) | (x19 & (new_n67_ | ~x25)) | (new_n65_ & ~x08);
  assign new_n65_ = x09 & ~x10 & x21 & (~new_n66_ | ~x19);
  assign new_n66_ = x20 & (~x23 | ~x24 | ~x26 | ~x13 | ~x22);
  assign new_n67_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign z12 = (x03 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (x19 & (~x25 | (x20 & ~new_n70_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x25);
  assign new_n70_ = x14 & x23 & x24 & x26;
  assign z13 = (x04 & x08 & (~x19 | x25)) | (x19 & (new_n72_ | ~x25)) | (new_n74_ & ~x08);
  assign new_n72_ = ~x08 & x09 & ~x10 & new_n73_ & x22 & ~x23;
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x09 & ~x10 & x23 & (~new_n75_ | ~x19 | ~x20);
  assign new_n75_ = x21 & x22 & (~x15 | ~x24 | ~x26);
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x24 | (x19 & ((new_n73_ & new_n78_) | ~x25))) & (~new_n73_ | ~x19 | ~new_n79_ | x24 | ~x25);
  assign new_n78_ = x22 & x23 & (~x16 | ~x26);
  assign new_n79_ = x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = x19 ? ((new_n82_ | ~x20) & (x20 | ~x25) & (~x17 | ~x26)) : ~x25;
  assign new_n82_ = x21 & (~x21 | (x22 ? (x23 & (~x23 | x24 | ~x25)) : ~x25));
  assign z16 = z08 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (~x25 | ((new_n85_ | ~x26) & (~new_n86_ | ~new_n73_ | ~x19))) & (x19 | ~x26);
  assign new_n85_ = x22 & x23 & x24 & ~x18 & x20 & x21;
