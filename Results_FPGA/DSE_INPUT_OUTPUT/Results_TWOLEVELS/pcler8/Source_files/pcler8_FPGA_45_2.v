...
module FAU ( 
  ...
  assign new_n60_ = (x06 | x19) & (~new_n62_ | ~new_n61_ | ~x11 | ~x19);
  assign new_n61_ = x20 & x21;
  assign new_n62_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x19 & (~x20 | (new_n65_ & new_n66_))) | (~x06 & ~x19 & x20));
  assign new_n65_ = x12 & x21 & x22;
  assign new_n66_ = x23 & x24 & x25 & x26;
  assign z11 = (new_n51_ & x02) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x19 & (x21 ? (new_n69_ | ~x20) : x20)) | (~x06 & ~x19 & x21));
  assign new_n69_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | new_n71_ | (~x08 & new_n72_ & x09);
  assign new_n71_ = ~x19 & (x06 | (new_n49_ & ~x10 & x22));
  assign new_n72_ = ~x10 & ((x22 & (~x20 | new_n73_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n73_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | ((~x23 | (new_n61_ & ~new_n76_ & x22)) & (~new_n61_ | ~x22 | x23))) & (x06 | x19 | ~x23);
  assign new_n76_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x19 | ((~x24 | (new_n61_ & new_n79_)) & (~new_n61_ | ~new_n80_))) & (x06 | x19 | ~x24);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x25 | (new_n83_ & (new_n48_ | ~x19))) & (~new_n61_ | ~x19 | ~new_n48_ | ~x24 | x25);
  assign new_n83_ = x19 & x20 & x21 & x24 & (~x17 | ~x26);
  assign z16 = new_n85_ | (x19 & (x08 ? x07 : (new_n87_ & x09)));
  assign new_n85_ = ~new_n86_ & ~x06;
  assign new_n86_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x19 | ~x26);
  assign new_n87_ = ~x10 & ((x26 & (~new_n88_ | ~new_n89_)) | (new_n90_ & new_n91_));
