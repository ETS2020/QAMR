...
module FAU ( 
  ...
  assign new_n63_ = (~x19 | (x20 & (~new_n61_ | ~new_n64_))) & (x17 | x19 | ~x20);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = new_n68_ | (~x08 & x09 & ~new_n66_ & ~x10) | (x02 & x08);
  assign new_n66_ = (~x21 | (~new_n67_ & x20)) & (~x19 | ~x20 | x21);
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n68_ = ~x19 & (x17 | (~x08 & x09 & ~x10 & x21));
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x19 | ((~x22 | (x20 & ~new_n71_ & x21)) & (~x20 | ~x21 | x22))) & (x17 | x19 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x19 | ((~x23 | (new_n74_ & ~new_n75_ & x22)) & (~new_n74_ | ~x22 | x23))) & (x17 | x19 | ~x23);
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x25 & x26 & x15 & x24;
  assign z14 = new_n79_ | (~x08 & x09 & ~new_n77_ & ~x10) | (x05 & x08);
  assign new_n77_ = (~x24 | (new_n74_ & x22 & ~new_n78_ & x23)) & (~x22 | ~x23 | x24 | ~new_n74_ | ~x19);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = ~x19 & (x17 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x19 | ((~new_n82_ | ~new_n84_) & (~x25 | (new_n82_ & new_n83_)))) & (x17 | x19 | ~x25);
  assign new_n82_ = x20 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x23 & x24 & ~x25;
  assign z16 = new_n58_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n90_));
