...
module FAU ( 
  ...
  assign new_n62_ = (~x19 | (x20 & (~new_n60_ | ~new_n63_))) & (x15 | x19 | ~x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (~x15 | x19)) | (~x19 & (new_n67_ | x15)) | (new_n65_ & ~x08);
  ...
  assign new_n69_ = (~x19 | ((~x20 | ~x21 | x22) & (~x22 | (x20 & ~new_n70_ & x21)))) & (x15 | x19 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x19 | ((~x23 | (new_n73_ & ~new_n74_ & x22)) & (~new_n73_ | ~x22 | x23))) & (x15 | x19 | ~x23);
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x25 & x26 & x15 & x24;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | ((~x24 | (new_n73_ & new_n77_)) & (~new_n73_ | ~new_n78_))) & (x15 | x19 | ~x24);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x19 | ((~x25 | (new_n81_ & new_n82_)) & (~new_n81_ | ~new_n83_))) & (x15 | x19 | ~x25);
