...
module FAU ( 
  ...
  assign z00 = x19 & (~x22 | (new_n47_ & new_n48_ & x21 & x23));
  ...
  assign new_n62_ = x20 & (~x19 | (new_n48_ & x12 & x21 & x23));
  assign new_n63_ = x19 & (~x22 | (~x08 & x09 & ~x10 & ~x20 & x22));
  assign z11 = (x02 & x08 & (~x19 | x22)) | (x19 & (new_n67_ | ~x22)) | (new_n65_ & ~x08);
  assign new_n65_ = x09 & ~x10 & x21 & (~new_n66_ | ~x19);
  assign new_n66_ = x20 & (~x24 | ~x25 | ~x26 | ~x13 | ~x23);
  assign new_n67_ = ~x08 & x09 & ~x10 & x20 & ~x21 & x22;
  assign z12 = (new_n51_ & x03) | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & x22 & ((x19 & (~x20 | (x20 & ~x21))) | new_n70_ | ~x19);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (~x19 | x22)) | (x19 & (new_n74_ | ~x22)) | (new_n72_ & ~x08);
  assign new_n72_ = x09 & ~x10 & x23 & (~new_n73_ | ~x19 | ~x20);
  assign new_n73_ = x21 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n74_ = ~x08 & x09 & ~x10 & x20 & x21 & ~x23;
  assign z14 = (x19 & (new_n76_ | ~x22)) | (x05 & x08) | (new_n78_ & ~x08);
  assign new_n76_ = ~x08 & x09 & ~x10 & new_n77_ & x23 & ~x24;
  assign new_n77_ = x20 & x21;
  assign new_n78_ = x09 & ~x10 & x24 & (~new_n79_ | ~x19 | ~x20);
  assign new_n79_ = x21 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((x22 & (new_n83_ | (~new_n82_ & x25))) | (~x19 & x25));
  assign new_n82_ = x20 & x21 & x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x19 & x20 & x21 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n85_ & ~x10);
  assign new_n85_ = (x19 | ~x26) & (~x22 | ((new_n86_ | ~x26) & (~new_n87_ | ~new_n77_ | ~x19)));
  assign new_n86_ = x23 & x24 & x25 & ~x18 & x20 & x21;
  assign new_n87_ = x25 & ~x26 & x23 & x24;
endmodule
