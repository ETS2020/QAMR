...
module FAU ( 
  ...
  assign new_n60_ = (~x19 | (x20 & (~new_n58_ | ~new_n61_))) & (x10 | x19 | ~x20);
  assign new_n61_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (~x10 | ~x19)) | (x10 & x19) | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ((x19 & (x21 ? (new_n64_ | ~x20) : x20)) | (~x10 & ~x19 & x21));
  ...
  assign z13 = z05 | (~x08 & x09 & (new_n72_ | (~new_n69_ & x19)));
  assign new_n69_ = ~new_n71_ & (~new_n70_ | ~x22 | x23);
  assign new_n70_ = x20 & x21;
  assign new_n71_ = x24 & x25 & x26 & ~x10 & x15 & x23;
  assign new_n72_ = ~x10 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x19 | (~new_n76_ & (~new_n75_ | ~x16 | ~x24))) & (new_n77_ | ~x24);
  assign new_n75_ = x25 & x26;
  assign new_n76_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n77_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = z07 | (~x08 & x09 & (new_n79_ | (new_n81_ & ~x10)));
  assign new_n79_ = x19 & (new_n80_ | (new_n75_ & ~x10 & x17));
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x25 & (~new_n70_ | ~x19 | ~x22 | ~x23 | ~x24);
  assign z16 = (~new_n83_ & x19) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n83_ = ~x10 & (~new_n84_ | ~new_n70_ | x08 | ~x09);
  assign new_n84_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n85_ = ~x10 & x26 & (~new_n86_ | ~new_n70_ | x18 | ~x19);
