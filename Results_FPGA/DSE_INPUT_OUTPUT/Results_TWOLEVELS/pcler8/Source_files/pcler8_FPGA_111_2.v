...
module FAU ( 
  ...
  assign z00 = (x00 & ~x19) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign z09 = (x00 & (~x19 | (x08 & x19))) | (~x08 & x09 & ~x10 & (new_n58_ | ~x19));
  assign new_n58_ = new_n59_ & x11 & x20 & x21 & x22;
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = (~x00 & (new_n61_ | (x01 & x08))) | (x19 & (x08 ? x01 : new_n62_));
  assign new_n61_ = new_n47_ & ~x10 & ~x19 & x20;
  assign new_n62_ = x09 & ~x10 & (~x20 | (new_n59_ & new_n63_));
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (~x00 | x19)) | (new_n66_ & ~x08) | (~x19 & (new_n65_ | x00));
  ...
  assign z12 = (~x00 & (new_n69_ | (x03 & x08))) | (x19 & (x08 ? x03 : new_n70_));
  assign new_n69_ = new_n47_ & ~x10 & ~x19 & x22;
  assign new_n70_ = x09 & ~x10 & ((x20 & x21 & ~x22) | (x22 & (~x20 | new_n71_ | ~x21)));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | new_n73_ | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n73_ = ~x19 & (x00 | (new_n47_ & ~x10 & x23));
