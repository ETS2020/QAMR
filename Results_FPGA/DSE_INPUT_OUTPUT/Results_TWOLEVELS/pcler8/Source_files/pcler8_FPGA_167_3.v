...
module FAU ( 
  ...
  assign z00 = x19 & (x10 | (new_n47_ & new_n49_ & new_n50_));
  ...
  assign z09 = (x00 & x08) | (x10 & x19) | (~x08 & x09 & (new_n60_ | (~x10 & ~x19)));
  ...
  assign z13 = (x04 & x08 & (~x10 | ~x19)) | (x10 & x19) | (~x08 & ~new_n70_ & x09);
  ...
  assign z14 = (x05 & x08 & (~x10 | ~x19)) | (x10 & x19) | (new_n74_ & ~x08);
  assign new_n74_ = x09 & ((x19 & (new_n75_ | new_n76_)) | (new_n77_ & ~x10));
  ...
  assign new_n79_ = (~x25 | (new_n80_ & new_n49_ & x24 & (~x17 | ~x26))) & (~new_n80_ | ~new_n49_ | ~x24 | x25);
  assign new_n80_ = x19 & x20 & x21;
  assign z16 = z08 | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((new_n83_ & new_n86_) | ((~new_n84_ | ~new_n85_) & x26));
