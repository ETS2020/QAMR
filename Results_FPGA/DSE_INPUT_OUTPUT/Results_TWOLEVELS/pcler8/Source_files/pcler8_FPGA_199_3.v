...
module FAU ( 
  ...
  assign z00 = (x10 & x14) | (new_n47_ & new_n49_ & new_n48_ & x21);
  ...
  assign z09 = (x00 & x08 & (~x10 | ~x14)) | (x10 & x14) | (~x08 & x09 & ~new_n59_ & ~x10);
  ...
  assign z12 = (x14 & (new_n66_ | x10)) | (x03 & x08) | (new_n67_ & ~x08);
  assign new_n66_ = new_n60_ & ~x08 & x09 & x22;
  assign new_n67_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign z13 = (x04 & x08 & (~x10 | ~x14)) | (x10 & x14) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x23 | (x19 & x20 & x21 & ~new_n70_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (~x10 | ~x14)) | (~x08 & x09 & ~new_n72_ & ~x10);
  ...
  assign new_n76_ = (~x25 | (new_n74_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n48_ | ~x24 | x25);
