...
module FAU ( 
  ...
  assign new_n60_ = (~x05 | x19) & (~new_n49_ | ~new_n50_ | ~new_n61_ | ~x11 | ~x19);
  assign new_n61_ = x20 & x21;
  assign z10 = (x01 & ~new_n47_ & x08) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x19 & ((new_n64_ & new_n65_) | ~x20)) | (x05 & ~x19 & x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (x05 | x19)) | (~x19 & (new_n69_ | ~x05)) | (new_n67_ & ~x08);
  ...
  assign new_n71_ = (~x19 | ((~x20 | ~x21 | x22) & (~x22 | (x20 & ~new_n72_ & x21)))) & (~x05 | x19 | ~x22);
  assign new_n72_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x19 | ((~x23 | (new_n61_ & ~new_n75_ & x22)) & (~new_n61_ | ~x22 | x23))) & (~x05 | x19 | ~x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = new_n79_ | (~x08 & x09 & ~x10 & ~new_n77_ & x19);
  assign new_n77_ = (~x24 | (new_n61_ & x22 & ~new_n78_ & x23)) & (~new_n61_ | ~x22 | ~x23 | x24);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = x05 & (x08 | (~x19 & x24 & x09 & ~x10));
  assign z15 = z07 | new_n86_ | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & (((~new_n82_ | ~new_n83_) & x25) | (new_n84_ & new_n85_));
  assign new_n82_ = x20 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x19 & x20 & x21;
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign new_n86_ = ~x19 & (~x05 | (~x10 & x25 & ~x08 & x09));
  ...
  assign new_n93_ = ~x19 & (~x05 | (~x10 & x26 & ~x08 & x09));
endmodule
