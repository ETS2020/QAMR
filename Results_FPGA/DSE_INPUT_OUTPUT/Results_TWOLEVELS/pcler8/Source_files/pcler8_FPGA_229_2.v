...
module FAU ( 
  ...
  assign new_n77_ = x20 & x21 & x23 & x24 & ~x25;
  assign new_n78_ = x19 & x20 & x21 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x22 | ((new_n82_ | ~x26) & (~new_n83_ | ~new_n81_ | ~x19))) & (x19 | ~x26);
