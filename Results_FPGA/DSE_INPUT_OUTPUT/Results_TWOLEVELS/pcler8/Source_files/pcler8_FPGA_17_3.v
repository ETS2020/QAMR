...
module FAU ( 
  ...
  assign z09 = (x19 & x21) | (x00 & x08) | (~x08 & x09 & ~x10 & ~x19);
  ...
  assign z13 = (x04 & ~new_n47_ & x08) | new_n47_ | (~x10 & x23 & ~x08 & x09);
  assign z14 = (x05 & ~new_n47_ & x08) | new_n47_ | (~x10 & x24 & ~x08 & x09);
  assign z15 = (x06 & ~new_n47_ & x08) | new_n47_ | (~x10 & x25 & ~x08 & x09);
