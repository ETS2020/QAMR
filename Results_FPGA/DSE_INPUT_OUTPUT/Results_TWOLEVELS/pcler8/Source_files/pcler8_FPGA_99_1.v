...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (x09 | ~x20)) | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x22 | (~new_n67_ & x21 & x19 & x20)) & (~x21 | x22 | ~x19 | ~x20);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (x09 | ~x20)) | (~x09 & x20) | (~x08 & ~new_n69_ & ~x10);
  assign new_n69_ = ~new_n71_ & (~x23 | ((new_n70_ | ~x20) & (~x09 | (new_n58_ & x20))));
  assign new_n70_ = x19 & (~x09 | ~x15 | ~x24 | ~x25 | ~x26);
  assign new_n71_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (x05 & x08 & (x09 | ~x20)) | (~x09 & x20) | (~x08 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (~new_n74_ & ~new_n75_)) & (~new_n76_ | ~x22 | ~x23 | x24);
  assign new_n74_ = x20 & (~x19 | (x09 & x16 & x25 & x26));
  assign new_n75_ = x09 & (~x20 | ~x21 | ~x22 | ~x23);
  assign new_n76_ = x19 & x20 & x21;
  assign z15 = (x06 & x08 & (x09 | ~x20)) | (new_n78_ & ~x08) | (~x09 & x20);
  assign new_n78_ = ~x10 & ((x25 & (new_n79_ | new_n80_)) | (new_n76_ & new_n81_));
  assign new_n79_ = x20 & (~x19 | (x09 & x17 & x26));
