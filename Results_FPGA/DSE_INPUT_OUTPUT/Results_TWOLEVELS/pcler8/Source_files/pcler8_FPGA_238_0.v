...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (x19 | x26)) | (~x19 & ~x26) | (~x08 & new_n58_ & x09);
  ...
  assign new_n63_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (x19 | x26)) | (~x19 & (new_n67_ | ~x26)) | (new_n65_ & ~x08);
  ...
  assign new_n72_ = (~x23 | (x20 & x21 & ~new_n73_ & x22)) & (~x21 | ~x22 | x23 | ~x19 | ~x20);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign new_n74_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (~new_n78_ & (~x19 | (new_n77_ & x22 & x23)))) & (~x22 | ~x23 | x24 | ~new_n77_ | ~x19);
  ...
  assign new_n85_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | new_n91_ | (~x08 & new_n87_ & x09);
  assign new_n87_ = ~x10 & ((new_n82_ & new_n90_) | (x26 & (~new_n88_ | ~new_n89_)));
  assign new_n88_ = ~x18 & x20 & x21;
  assign new_n89_ = x22 & x23 & x24 & x25;
  assign new_n90_ = x23 & x24 & x25 & ~x26;
  assign new_n91_ = ~x19 & (~x26 | (~x08 & x09 & ~x10));
endmodule
