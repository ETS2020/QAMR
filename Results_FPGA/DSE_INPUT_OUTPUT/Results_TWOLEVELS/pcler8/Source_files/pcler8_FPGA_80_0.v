...
module FAU ( 
  ...
  assign new_n65_ = x21 ? (~new_n66_ & x20) : ~x20;
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n67_ = x02 & (x08 | (x09 & ~x10 & ~x19 & x21));
  ...
  assign new_n71_ = ~x19 & (~x02 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z15 = (x02 & (new_n87_ | (x06 & x08))) | (x19 & (x08 ? x06 : new_n83_));
  assign new_n83_ = x09 & ~x10 & ((new_n84_ & new_n86_) | (x25 & (~new_n84_ | ~new_n85_)));
  ...
  assign new_n94_ = ~x19 & (~x02 | (~x08 & x09 & ~x10 & x26));
endmodule
