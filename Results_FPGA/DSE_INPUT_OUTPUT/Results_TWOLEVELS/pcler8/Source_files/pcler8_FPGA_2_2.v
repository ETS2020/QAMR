...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x10 | x20)) | (~x20 & (x10 | (new_n65_ & ~x08))) | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & ((x21 & (new_n64_ | ~x19)) | (x19 & x20 & ~x21));
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = x09 & x21;
  assign z12 = (x03 & x08 & (~x10 | x20)) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (~new_n68_ & x21 & x19 & x20)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n72_ | (x04 & x08) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x23 | (x19 & x21 & ~new_n71_ & x22)) & (~x21 | ~x22 | x23 | ~x19 | ~x20);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x20 & (x10 | (~x08 & x09 & x23));
  ...
  assign z16 = (x07 & x08 & (~x10 | x20)) | (~x08 & x09 & ~new_n83_ & ~x10);
