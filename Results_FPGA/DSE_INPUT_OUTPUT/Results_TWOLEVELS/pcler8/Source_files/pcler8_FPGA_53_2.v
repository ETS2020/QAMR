...
module FAU ( 
  ...
  assign new_n67_ = (~x23 | (x20 & x21 & ~new_n68_ & x22)) & (~x20 | ~x21 | ~x22 | x23);
  assign new_n68_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (x09 & (~x19 | (~x08 & ~new_n70_ & ~x10)));
  assign new_n70_ = ~new_n72_ & (~x24 | (new_n71_ & (~x19 | (x21 & x22))));
  assign new_n71_ = x20 & x23 & (~x16 | ~x25 | ~x26);
  ...
  assign z16 = (x09 & (~x19 | (~x08 & ~new_n77_ & ~x10))) | (x07 & x08 & (~x09 | x19));
