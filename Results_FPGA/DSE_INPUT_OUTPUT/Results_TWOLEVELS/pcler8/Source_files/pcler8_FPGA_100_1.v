...
module FAU ( 
  ...
  assign z13 = (x04 & x08 & (x16 | ~x19)) | (x19 & (new_n73_ | ~x16)) | (new_n75_ & ~x08);
  assign new_n73_ = new_n74_ & ~x08 & x09 & ~x10;
  ...
  assign new_n78_ = (x19 | ~x24) & (~x16 | ((~x19 | ~new_n79_ | ~x20) & (new_n80_ | ~x24)));
  assign new_n79_ = x21 & x22 & x23 & (~x24 | (x24 & x25 & x26));
  assign new_n80_ = x20 & x21 & x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n82_ | new_n87_));
  assign new_n82_ = x16 & ((new_n85_ & new_n86_) | ((~new_n83_ | ~new_n84_) & x25));
  ...
  assign new_n89_ = x16 & ((new_n92_ & new_n93_) | ((~new_n90_ | ~new_n91_) & x26));
