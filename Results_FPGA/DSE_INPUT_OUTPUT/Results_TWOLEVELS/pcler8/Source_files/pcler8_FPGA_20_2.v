...
module FAU ( 
  ...
  assign new_n69_ = (~x23 | (new_n49_ & ~new_n70_ & x22)) & (~new_n49_ | ~x22 | x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x09 & (~x19 | (~x08 & ~new_n72_ & ~x10))) | (x05 & x08 & (~x09 | x19));
  assign new_n72_ = ~new_n74_ & (~x24 | (new_n73_ & (~x19 | (x21 & x22))));
  assign new_n73_ = x20 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n74_ = x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n76_ & x19);
  assign new_n76_ = (~x25 | (new_n77_ & x23 & x24 & (~x17 | ~x26))) & (~new_n77_ | ~x23 | ~x24 | x25);
  assign new_n77_ = x20 & x21 & x22;
  assign z16 = (x07 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n79_ & x19);
  assign new_n79_ = (~x26 | (new_n80_ & new_n49_ & ~x18)) & (~new_n77_ | ~new_n81_);
