...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x13 | x19)) | (x13 & (new_n65_ | ~x19)) | (new_n67_ & ~x08);
  assign new_n65_ = new_n66_ & ~x10 & x21 & ~x08 & x09;
  assign new_n66_ = x22 & x23 & x24 & x25 & x26;
  assign new_n67_ = x09 & ~x10 & ((x21 & (~x19 | ~x20)) | (x19 & x20 & ~x21));
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x19 | ((~x22 | (x20 & ~new_n70_ & x21)) & (~x20 | ~x21 | x22))) & (x13 | x19 | ~x22);
