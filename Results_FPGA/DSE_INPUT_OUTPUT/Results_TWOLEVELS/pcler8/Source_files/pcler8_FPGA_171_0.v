...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x19 & (x21 ? (new_n66_ | ~x20) : x20)) | (x06 & ~x19 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x19 | ((~x22 | (x20 & ~new_n69_ & x21)) & (~x20 | ~x21 | x22))) & (~x06 | x19 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x19 | ((~x23 | (new_n72_ & ~new_n73_ & x22)) & (~new_n72_ | ~x22 | x23))) & (~x06 | x19 | ~x23);
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | ((~x24 | (new_n72_ & new_n76_)) & (~new_n72_ | ~new_n77_))) & (~x06 | x19 | ~x24);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = (~x19 & (~x06 | (new_n84_ & x09))) | (x06 & x08) | (~x08 & new_n79_ & x09);
  ...
  assign new_n91_ = ~x19 & (~x06 | (~x08 & x09 & ~x10 & x26));
endmodule
