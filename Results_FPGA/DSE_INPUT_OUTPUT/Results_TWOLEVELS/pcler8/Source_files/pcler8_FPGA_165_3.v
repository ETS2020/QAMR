...
module FAU ( 
  ...
  assign z00 = x19 & (x14 | (new_n47_ & new_n48_));
  ...
  assign new_n59_ = ~x10 & (~x19 | (new_n48_ & new_n60_ & x11 & ~x14));
  assign new_n60_ = x20 & x21;
  assign z10 = (x01 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (x14 | ((~x19 | x20) & (~new_n64_ | ~new_n63_ | ~x12 | ~x20))) & (x19 | ~x20);
  assign new_n63_ = x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (~x14 | ~x19)) | (x19 & (new_n68_ | x14)) | (new_n66_ & ~x08);
  assign new_n66_ = x09 & ~x10 & x21 & (~x19 | new_n67_ | ~x20);
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n68_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign z12 = (x03 & ~new_n50_ & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((~x14 & (((~x20 | ~x21) & x22) | (x21 & ~x22 & x19 & x20))) | (~x19 & x22));
  assign z13 = (x19 & (new_n72_ | x14)) | (x04 & x08) | (new_n73_ & ~x08);
  ...
  assign new_n76_ = (x19 | ~x24) & (x14 | (((new_n60_ & new_n77_) | ~x24) & (~new_n78_ | ~new_n60_ | ~x19)));
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = (~new_n80_ & x19) | (x06 & x08) | (~x08 & new_n82_ & x09);
  assign new_n80_ = ~x14 & (~new_n81_ | x08 | ~x09 | x10 | ~x20);
  ...
  assign new_n85_ = x19 & (x14 | (new_n47_ & new_n86_ & x22 & x23));
