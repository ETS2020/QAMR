...
module FAU ( 
  ...
  assign z05 = (~x19 & x22) | (x04 & x08);
  assign z06 = new_n50_ & x05;
  assign z07 = new_n50_ & x06;
  assign z08 = (~x19 & x22) | (x07 & x08);
  ...
  assign z13 = (x22 & (new_n73_ | ~x19)) | (x04 & x08) | (new_n71_ & ~x08);
  assign new_n71_ = x09 & ~x10 & x23 & (~new_n60_ | ~new_n72_);
  assign new_n72_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n73_ = ~x08 & x09 & ~x10 & x20 & x21 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | ((~x24 | (new_n60_ & ~new_n76_ & x23)) & (~new_n60_ | ~x22 | ~x23 | x24))) & (x22 | ~x24);
  assign new_n76_ = x16 & x25 & x26;
  assign z15 = (x06 & x08 & (x19 | ~x22)) | (x22 & (new_n78_ | ~x19)) | (new_n79_ & ~x08);
  assign new_n78_ = new_n47_ & x21 & x23 & x24 & ~x25;
  assign new_n79_ = x09 & ~x10 & x25 & (~new_n80_ | ~new_n81_);
  assign new_n80_ = x20 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x22 & (new_n83_ | ~x19)) | (x07 & x08) | (new_n84_ & ~x08);
  assign new_n83_ = new_n47_ & x21 & x23 & x24 & x25 & ~x26;
  assign new_n84_ = x09 & ~x10 & x26 & (~new_n85_ | ~new_n60_ | x18);
