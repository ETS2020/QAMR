...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (x09 | x19)) | (~x09 & ~x19) | (~x08 & ~x10 & (new_n59_ | ~x19));
  assign new_n59_ = new_n48_ & new_n49_ & x20 & x21 & x09 & x11;
  assign z10 = z02 | (new_n61_ & ~x08);
  assign new_n61_ = ~x10 & ((x09 & ((new_n62_ & new_n63_) | (x19 & ~x20))) | (~x19 & x20));
  assign new_n62_ = x12 & x20 & x21 & x22;
  ...
  assign z12 = (~x19 & (~x09 | (new_n69_ & ~x08))) | (x03 & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x22 & (~x20 | new_n68_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x10 & x22;
  assign z13 = (x04 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x23 | (x19 & x20 & x21 & ~new_n72_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n74_ & ~x10);
  ...
  assign z16 = (~x19 & (~x09 | (new_n85_ & ~x08))) | (x07 & x08) | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((new_n83_ & new_n84_) | (x26 & (~new_n81_ | ~new_n82_)));
  assign new_n81_ = ~x18 & x20 & x21;
  assign new_n82_ = x22 & x23 & x24 & x25;
  assign new_n83_ = x19 & x20 & x21 & x22;
  assign new_n84_ = x23 & x24 & x25 & ~x26;
  assign new_n85_ = ~x10 & x26;
endmodule
