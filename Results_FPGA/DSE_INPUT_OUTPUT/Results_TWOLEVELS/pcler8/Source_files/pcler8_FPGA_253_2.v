...
module FAU ( 
  ...
  assign z10 = (x01 & ~new_n49_ & x08) | new_n49_ | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & (x19 ? (new_n62_ | ~x20) : x20);
  assign new_n62_ = x12 & x21 & x22 & x23 & x24 & x25;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x26 & ((x19 & (new_n65_ | (x20 & ~x21))) | (~x20 & x21))) | (~x19 & x21));
  assign new_n65_ = x13 & x21 & x22 & x23 & x24 & x25;
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x26 | ((~x19 | (~new_n68_ & (~x20 | ~x21 | x22))) & (~x22 | (x20 & x21)))) & (x19 | ~x22);
  assign new_n68_ = x14 & x22 & x23 & x24 & x25;
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x19 | ~x23) & (~x26 | ((new_n73_ | ~x23) & (~x19 | (~new_n71_ & ~new_n72_))));
  ...
  assign new_n75_ = (new_n77_ | ~x24) & (~x19 | (~new_n76_ & (~x16 | ~x24 | ~x25)));
  assign new_n76_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n77_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = z07 | (~new_n79_ & x19) | (~x08 & new_n81_ & x09);
  assign new_n79_ = x26 & (~new_n80_ | x10 | ~x20 | x08 | ~x09);
  ...
  assign new_n84_ = ~x10 & ((x19 & (~x20 | (~new_n85_ & x20))) | (x26 & (x18 | ~x19)));
  assign new_n85_ = x21 ? (x22 ? (x23 ? (x24 & (~x24 | x25)) : ~x26) : ~x26) : ~x26;
endmodule
