...
module FAU ( 
  ...
  assign new_n61_ = x19 ? (x20 & (~new_n59_ | ~new_n62_)) : (~x20 | x23);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & (x19 ? (x21 ? (new_n65_ | ~x20) : x20) : (x21 & ~x23));
  ...
  assign new_n69_ = ~x19 & (x23 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & x19 & ((x23 & (~new_n72_ | new_n73_ | ~x22)) | (new_n72_ & x22 & ~x23));
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & new_n75_ & x09);
  assign new_n75_ = ~x10 & ((x23 & (new_n76_ | (new_n72_ & x22 & ~x24))) | (x24 & (~new_n72_ | ~x22 | ~x23)));
  assign new_n76_ = x16 & x19 & x24 & x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x23 | (~new_n79_ & (~new_n72_ | ~x22 | ~x24 | x25))) & (~x25 | (new_n72_ & x22 & x23 & x24));
  assign new_n79_ = x17 & x19 & x25 & x26;
  assign z16 = (x07 & x08 & (x19 | ~x23)) | (x23 & (new_n81_ | ~x19)) | (new_n83_ & ~x08);
  assign new_n81_ = new_n82_ & ~x08 & x09 & ~x10 & x20;
  assign new_n82_ = x21 & x22 & x24 & x25 & ~x26;
  assign new_n83_ = x09 & ~x10 & x26 & (~new_n84_ | ~new_n72_ | x18);
