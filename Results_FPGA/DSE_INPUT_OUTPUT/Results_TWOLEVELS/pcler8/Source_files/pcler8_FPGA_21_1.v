...
module FAU ( 
  ...
  assign z14 = z06 | (~x08 & ~new_n72_ & ~x10);
  assign new_n72_ = (~new_n74_ | ~x09) & (~x19 | (~new_n73_ & (~new_n64_ | ~x09 | ~x16)));
  assign new_n73_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n74_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & ~x10 & (new_n76_ | (new_n78_ & x09)));
  assign new_n76_ = x19 & (new_n77_ | (x09 & x17 & x25 & x26));
  assign new_n77_ = x23 & x24 & ~x25 & x20 & x21 & x22;
  assign new_n78_ = x25 & (~new_n79_ | ~x19 | ~x22 | ~x23 | ~x24);
  assign new_n79_ = x20 & x21;
  assign z16 = (x19 & (new_n81_ | ~x09)) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n81_ = new_n82_ & new_n79_ & ~x08 & ~x10;
  assign new_n82_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | ~new_n79_ | x18 | ~x19);
