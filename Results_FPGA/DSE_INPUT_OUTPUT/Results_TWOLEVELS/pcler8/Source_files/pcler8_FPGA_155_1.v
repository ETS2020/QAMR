...
module FAU ( 
  ...
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n73_ & ~x10);
  assign new_n73_ = (~new_n75_ | ~x09) & (~x19 | (~new_n74_ & (~new_n59_ | ~x09 | ~x16)));
  assign new_n74_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n75_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & ~x10 & (new_n77_ | (new_n79_ & x09)));
  assign new_n77_ = x19 & (new_n78_ | (x25 & x26 & x09 & x17));
  assign new_n78_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n79_ = x25 & (~new_n58_ | ~x19 | ~x22 | ~x23 | ~x24);
