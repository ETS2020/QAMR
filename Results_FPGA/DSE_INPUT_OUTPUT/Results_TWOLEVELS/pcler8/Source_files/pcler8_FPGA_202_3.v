...
module FAU ( 
  ...
  assign new_n47_ = x21 & x20 & x19 & ~x13 & new_n48_ & ~x10;
  ...
  assign new_n62_ = x19 & (x13 | (new_n48_ & ~x10 & ~x20));
  assign new_n63_ = x20 & (~x19 | (new_n60_ & x12 & x21 & x22));
  assign z11 = z03 | (new_n65_ & ~x08);
  assign new_n65_ = x09 & ~x10 & ((~x13 & ((~x20 & x21) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (x13 | ((~x22 | (x20 & ~new_n68_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x19 | ~x23) & (x13 | ((new_n73_ | ~x23) & (~x19 | (~new_n71_ & ~new_n72_))));
  assign new_n71_ = x20 & x21 & x22 & ~x23;
  assign new_n72_ = x15 & x23 & x24 & x25 & x26;
  assign new_n73_ = x20 & x21 & x22;
  assign z14 = (x05 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = ~new_n78_ & (~x19 | (~new_n76_ & ~new_n77_));
  assign new_n76_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n77_ = ~x13 & x16 & x24 & x25 & x26;
  assign new_n78_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = (x06 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (x19 | ~x25) & (x13 | ((new_n83_ | ~x25) & (~x19 | (~new_n81_ & ~new_n82_))));
  assign new_n81_ = x23 & x24 & ~x25 & x20 & x21 & x22;
  assign new_n82_ = x17 & x25 & x26;
  assign new_n83_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | new_n85_ | (~x08 & new_n88_ & x09);
  assign new_n85_ = x19 & (x13 | (new_n87_ & new_n48_ & new_n86_ & ~x10));
  assign new_n86_ = x20 & x21;
  assign new_n87_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n88_ = ~x10 & x26 & (~new_n89_ | ~new_n86_ | x18 | ~x19);
