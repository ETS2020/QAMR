...
module FAU ( 
  ...
  assign z00 = x19 & (~x09 | (new_n47_ & new_n49_ & ~x08 & ~x10));
  ...
  assign new_n68_ = (~x22 | (new_n69_ & x21 & (~new_n48_ | ~x14 | ~x23))) & (~new_n69_ | ~x21 | x22);
  assign new_n69_ = x19 & x20;
  assign z13 = (x04 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n71_ & ~x10);
  assign new_n71_ = ~new_n73_ & (~x19 | (~new_n72_ & (~new_n49_ | ~x22 | x23)));
  assign new_n72_ = x15 & x23 & x24 & x25 & x26;
  assign new_n73_ = x09 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = z06 | (~x08 & ~x10 & (new_n75_ | (new_n77_ & x09)));
  assign new_n75_ = x19 & (new_n76_ | (new_n49_ & x22 & x23 & ~x24));
  assign new_n76_ = x16 & x24 & x25 & x26;
  assign new_n77_ = x24 & (~new_n69_ | ~x21 | ~x22 | ~x23);
