...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~new_n65_ & ~x10);
  ...
  assign z15 = z07 | (~x08 & ~x10 & (new_n76_ | new_n78_));
  assign new_n76_ = x19 & (new_n77_ | (new_n72_ & x09 & x17));
  assign new_n77_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n78_ = x09 & x25 & (~new_n79_ | ~x19 | ~x20 | ~x21);
