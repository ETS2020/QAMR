...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x12 | ~x19)) | (x19 & (new_n64_ | ~x12)) | (new_n65_ & ~x08);
  assign new_n64_ = new_n48_ & ~x10 & x20 & ~x21;
  ...
  assign z14 = (x05 & x08 & (x12 | ~x19)) | (x19 & (new_n76_ | ~x12)) | (new_n78_ & ~x08);
  assign new_n76_ = new_n77_ & x21 & x22 & x23 & ~x24;
  assign new_n77_ = ~x08 & x09 & ~x10 & x20;
  assign new_n78_ = x09 & ~x10 & x24 & (~new_n79_ | ~new_n72_ | ~x19);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x19 & (new_n81_ | ~x12)) | (x06 & x08) | (new_n82_ & ~x08);
  assign new_n81_ = new_n77_ & x21 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = x09 & ~x10 & x25 & (~new_n83_ | ~new_n72_ | ~x19);
  assign new_n83_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | new_n85_ | (~x08 & new_n87_ & x09);
  assign new_n85_ = x19 & (~x12 | (new_n86_ & new_n48_ & new_n72_ & ~x10));
