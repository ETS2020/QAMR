...
module FAU ( 
  ...
  assign z12 = (x19 & (new_n61_ | x26)) | (new_n62_ & ~x08) | (x03 & x08);
  ...
  assign new_n64_ = (~x23 | (x19 & (x26 | (x20 & x21 & x22)))) & (~x19 | ~x20 | ~x21 | ~x22 | x23 | x26);
  assign z14 = z06 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x24 | (x19 & (x26 | (new_n67_ & x20 & x21)))) & (~x19 | ~x20 | ~x21 | ~new_n67_ | x24 | x26);
  assign new_n67_ = x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x25 | (~new_n71_ & x19)) & (~new_n72_ | ~new_n70_ | ~x19 | ~x20);
  assign new_n70_ = x21 & x22;
  assign new_n71_ = ~x26 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
