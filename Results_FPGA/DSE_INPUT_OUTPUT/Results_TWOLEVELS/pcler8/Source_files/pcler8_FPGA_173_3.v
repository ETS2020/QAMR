...
module FAU ( 
  ...
  assign new_n60_ = new_n61_ & x22 & x23;
  ...
  assign new_n72_ = (~x20 | ~x21 | ~x22 | x23) & (~new_n61_ | ~x15 | ~x23);
  assign new_n73_ = x20 & x21 & x22;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (new_n76_ | ~x19) & (~x24 | (new_n78_ & x19 & x20));
  ...
  assign new_n80_ = ~x10 & ((~x05 & ((~new_n81_ & x19) | (~new_n82_ & x25))) | (~x19 & x25));
  assign new_n81_ = (~x17 | ~x25 | ~x26) & (~new_n73_ | ~x23 | ~x24 | x25);
  assign new_n82_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = (x07 & ~new_n50_ & x08) | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((~x05 & ((~new_n85_ & x19) | (~new_n86_ & x26))) | (~x19 & x26));
  assign new_n85_ = (~x18 | ~x26) & (~new_n73_ | ~x23 | ~x24 | ~x25 | x26);
  assign new_n86_ = new_n73_ & x23 & x24 & x25;
endmodule
