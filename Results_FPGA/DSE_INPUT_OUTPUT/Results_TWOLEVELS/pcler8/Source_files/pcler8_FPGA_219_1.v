...
module FAU ( 
  ...
  assign new_n47_ = x14 & (~new_n48_ | x08 | ~x09 | x10 | ~x14 | ~x20);
  ...
  assign z10 = z02 | new_n64_ | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & x20 & (~x19 | (new_n60_ & new_n63_));
  ...
  assign new_n73_ = (~x14 | ((~x19 | ((x22 | ~x23) & (~new_n74_ | ~x22 | x23))) & (new_n75_ | ~x23))) & (x19 | ~x23);
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x20 & x21 & (~x25 | ~x26 | ~x15 | ~x24);
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x19 | ~x24) & (~x14 | ((~x24 | (new_n74_ & new_n78_)) & (~new_n79_ | ~new_n74_ | ~x19)));
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (x14 | ~x19)) | (x19 & (new_n81_ | ~x14)) | (new_n83_ & ~x08);
  ...
  assign new_n86_ = x14 & (~new_n87_ | x08 | ~x09 | ~new_n74_ | x10);
  assign new_n87_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n88_ = ~x10 & x26 & (~new_n89_ | ~new_n74_ | x18 | ~x19);
