...
module FAU ( 
  ...
  assign z13 = (x04 & x08 & (x17 | ~x19)) | (x19 & (new_n72_ | ~x17)) | (new_n74_ & ~x08);
  assign new_n72_ = new_n73_ & ~x08 & x09 & ~x10;
  ...
  assign new_n77_ = x17 & (~new_n78_ | x10 | ~x20 | x08 | ~x09);
  ...
  assign new_n82_ = (~x19 | ~x20 | ~new_n83_ | ~x21) & (~x25 | (new_n84_ & x19 & x20 & x21));
  assign new_n83_ = x22 & x23 & x24 & (~x25 | (x17 & x25 & x26));
  assign new_n84_ = x22 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n91_));
  assign new_n86_ = x17 & (((~new_n87_ | ~new_n88_) & x26) | (new_n89_ & new_n90_));
