...
module FAU ( 
  ...
  assign new_n63_ = (~x14 | ((~x19 | x20) & (~new_n61_ | ~new_n60_ | ~x12 | ~x20))) & (x19 | ~x20);
  assign z11 = (x02 & x08 & (x14 | ~x19)) | (x19 & (new_n67_ | ~x14)) | (new_n65_ & ~x08);
  ...
  assign new_n69_ = ~x10 & ((x19 & x20 & x21 & (new_n70_ | ~x22)) | (x22 & (~x19 | ~x20 | ~x21)));
  assign new_n70_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (x19 | ~x23) & (~x14 | (~new_n75_ & ((new_n73_ & new_n74_) | ~x23)));
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n75_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | new_n77_ | (~x08 & x09 & new_n79_ & ~x10);
  assign new_n77_ = x19 & (~x14 | (new_n78_ & new_n60_ & x23 & ~x24));
  ...
  assign new_n82_ = x14 & (~new_n78_ | ~new_n60_ | ~x23 | ~x24 | x25);
  assign new_n83_ = ~x10 & x25 & (~new_n84_ | ~new_n73_ | ~x19);
