...
module FAU ( 
  ...
  assign new_n58_ = (~x15 | x19) & (~new_n60_ | ~new_n61_ | ~new_n59_ | ~x11 | ~x19);
  ...
  assign new_n67_ = (~x21 | (x20 & (~new_n61_ | ~new_n60_ | ~x13))) & (~x19 | ~x20 | x21);
  ...
  assign new_n77_ = (~x24 | (new_n59_ & x22 & ~new_n78_ & x23)) & (~new_n59_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = ~x19 & (~x15 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | new_n86_ | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((new_n83_ & new_n85_) | (x25 & (~new_n82_ | ~new_n84_)));
  ...
  assign new_n93_ = ~x19 & (~x15 | (~x08 & x09 & ~x10 & x26));
endmodule
