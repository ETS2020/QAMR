...
module FAU ( 
  ...
  assign z15 = z07 | new_n80_ | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n80_ = ~new_n81_ & x17;
  assign new_n81_ = x19 & (x08 | ~x09 | x10 | ~x25 | ~x26);
  assign new_n82_ = (~x25 | (new_n59_ & x19 & x22 & x23 & x24)) & (~new_n59_ | ~x19 | ~x22 | ~x23 | ~x24 | x25);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n89_));
  assign new_n84_ = x19 & ((x26 & (~new_n85_ | ~new_n86_)) | (new_n87_ & new_n88_));
