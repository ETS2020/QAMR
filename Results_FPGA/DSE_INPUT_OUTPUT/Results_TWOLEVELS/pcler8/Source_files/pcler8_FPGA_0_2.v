...
module FAU ( 
  ...
  assign z10 = z02 | new_n64_ | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x19 & ~x20) | (new_n61_ & new_n60_ & x12 & x20));
  assign new_n64_ = ~x19 & (x07 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (~x07 | x19)) | (~x19 & (new_n68_ | x07)) | (new_n66_ & ~x08);
  ...
  assign new_n74_ = (~x19 | ((~x23 | (new_n75_ & ~new_n76_ & x22)) & (~new_n75_ | ~x22 | x23))) & (x07 | x19 | ~x23);
  assign new_n75_ = x20 & x21;
  assign new_n76_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n47_ & x08) | new_n47_ | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((~new_n79_ & x19) | (x24 & (~new_n80_ | ~x19 | ~x20)));
  assign new_n79_ = (x22 | ~x24) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n80_ = x21 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x06 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x19 | ((~x25 | (new_n83_ & new_n84_)) & (~new_n83_ | ~new_n85_))) & (x07 | x19 | ~x25);
  assign new_n83_ = x20 & x21 & x22;
  assign new_n84_ = x23 & x24 & (~x17 | ~x26);
  assign new_n85_ = x23 & x24 & ~x25;
  assign z16 = new_n89_ | (~x08 & x09 & ~x10 & (new_n87_ | new_n88_));
  assign new_n87_ = x19 & ((~x24 & x26) | (new_n83_ & x23 & x24 & x25 & ~x26));
  assign new_n88_ = x26 & (~new_n60_ | ~x23 | ~x25 | ~new_n48_ | x18);
  assign new_n89_ = x07 & (~x19 | (x08 & x19));
endmodule
