...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x13 & ((x19 & x20 & (new_n66_ | ~x21)) | (~x20 & x21))) | (~x19 & x21));
  assign new_n66_ = x21 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x13 | ((~x22 | (x20 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x19 | ~x23) & (~x13 | (~new_n74_ & (~x23 | (new_n72_ & new_n73_))));
  ...
  assign new_n78_ = x13 & x16 & x24 & x25 & x26;
  assign new_n79_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = (x06 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x19 | ~x25) & (~x13 | ((new_n84_ | ~x25) & (~x19 | (~new_n82_ & ~new_n83_))));
  assign new_n82_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n83_ = x17 & x25 & x26;
  assign new_n84_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | new_n86_ | (~x08 & new_n88_ & x09);
  assign new_n86_ = x19 & (~x13 | (new_n87_ & new_n48_ & new_n72_ & ~x10));
  assign new_n87_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n88_ = ~x10 & x26 & (~new_n89_ | ~new_n72_ | x18 | ~x19);
