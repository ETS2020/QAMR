...
module FAU ( 
  ...
  assign z09 = (~x09 & x19) | (x00 & x08) | (~x08 & ~x10 & (new_n57_ | (x09 & ~x19)));
  assign new_n57_ = new_n59_ & new_n58_ & x11 & x19;
  assign new_n58_ = x20 & x21;
  assign new_n59_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x19 | (x20 & (~new_n62_ | ~new_n63_))) & (~x09 | x19 | ~x20);
  assign new_n62_ = x12 & x21 & x22;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x19 | ((~x20 | x21) & (~new_n63_ | ~x13 | ~x21 | ~x22))) & (~x21 | (x19 & x20));
  assign z12 = (x03 & x08 & (x09 | ~x19)) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x19 & (new_n68_ | (x20 & x21 & ~x22))) | (x22 & (~x19 | ~x20 | ~x21)));
  assign new_n68_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & ~new_n70_ & ~x10);
  assign new_n70_ = ~new_n72_ & (~x19 | (~new_n71_ & (~new_n58_ | ~x22 | x23)));
  assign new_n71_ = x15 & x23 & x24 & x25 & x26;
  assign new_n72_ = x09 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = z06 | (~x08 & ~x10 & (new_n74_ | (new_n76_ & x09)));
  assign new_n74_ = x19 & (new_n75_ | (new_n58_ & x22 & x23 & ~x24));
  assign new_n75_ = x16 & x24 & x25 & x26;
  assign new_n76_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x19 | (~new_n79_ & ~new_n80_)) & (~x09 | new_n81_ | ~x25);
  assign new_n79_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n80_ = x17 & x25 & x26;
  assign new_n81_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (~x08 & new_n83_ & x09);
  assign new_n83_ = ~x10 & ((new_n84_ & new_n87_) | (x26 & (~new_n85_ | ~new_n86_)));
