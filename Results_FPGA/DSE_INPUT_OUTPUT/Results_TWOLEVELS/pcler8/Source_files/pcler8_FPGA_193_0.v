// Benchmark "FAU" written by ABC on Mon Aug 24 16:59:16 2020
...
module FAU ( 
  ...
  assign z02 = (x01 & x08) | (~x19 & ~x26);
  assign z03 = (~x19 & ~x26) | (x02 & x08 & (x19 | x26));
  assign z04 = (~x19 & ~x26) | (x03 & x08 & (x19 | x26));
  assign z05 = (x04 & x08) | (~x19 & ~x26);
  assign z06 = new_n49_ & x05;
  assign z07 = new_n49_ & x06;
  assign z08 = new_n49_ & x07;
  assign z09 = z01 | (~x08 & new_n58_ & x09);
  assign new_n58_ = ~x10 & x26 & (~x19 | (new_n60_ & new_n59_ & x11));
  assign new_n59_ = x20 & x21;
  assign new_n60_ = x22 & x23 & x24 & x25;
  ...
  assign new_n64_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (new_n49_ & x02) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (x20 ^ x21)) | (x21 & x26 & (new_n67_ | ~x19)));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25;
  assign z12 = (new_n49_ & x03) | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & ((x22 & (new_n70_ | (x19 & (~x20 | ~x21)))) | (x19 & x20 & x21 & ~x22));
  assign new_n70_ = x26 & (~x19 | (x24 & x25 & x14 & x23));
  ...
  assign new_n74_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (~new_n77_ & (~x19 | (new_n59_ & x22 & x23)))) & (~new_n59_ | ~x19 | ~x22 | ~x23 | x24);
  ...
  assign new_n81_ = x26 & (x17 | ~x19);
  assign new_n82_ = x19 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | new_n89_ | (~x08 & new_n85_ & x09);
  assign new_n85_ = ~x10 & ((new_n87_ & new_n88_) | (x26 & (~new_n60_ | ~new_n86_)));
  assign new_n86_ = ~x18 & x20 & x21;
  assign new_n87_ = x20 & x21 & x22;
  assign new_n88_ = x23 & x24 & x25 & ~x26;
  assign new_n89_ = ~x19 & (~x26 | (~x08 & x09 & ~x10 & x26));
endmodule
