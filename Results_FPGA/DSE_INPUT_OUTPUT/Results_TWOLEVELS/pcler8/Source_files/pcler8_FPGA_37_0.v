...
module FAU ( 
  ...
  assign z11 = new_n63_ | (~new_n49_ & (x08 ? x02 : new_n65_));
  assign new_n63_ = new_n64_ & ~x08 & x09 & ~x10 & x13 & x21;
  assign new_n64_ = x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = x09 & ~x10 & ((x21 & (~x19 | ~x20)) | (x19 & x20 & ~x21));
  ...
  assign z13 = new_n70_ | (new_n59_ & ~x08 & x09 & ~x10 & x15);
  assign new_n70_ = ~new_n49_ & (x08 ? x04 : (new_n71_ & x09));
  assign new_n71_ = ~x10 & ((x23 & (~x19 | ~x20 | ~x21 | ~x22)) | (x19 & x20 & x21 & x22 & ~x23));
  assign z14 = (x05 & ~new_n49_ & x08) | new_n49_ | (~x08 & new_n73_ & x09);
