...
module FAU ( 
  ...
  assign new_n61_ = ~x10 & ((x19 & (~x20 | (new_n62_ & new_n63_))) | (x09 & ~x19 & x20));
  ...
  assign new_n67_ = (~x22 | (new_n68_ & x21 & (~new_n59_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  ...
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x08 & new_n73_ & x09);
  ...
  assign new_n77_ = (new_n79_ | ~x25) & (~x19 | (~new_n78_ & (~x17 | ~x25 | ~x26)));
