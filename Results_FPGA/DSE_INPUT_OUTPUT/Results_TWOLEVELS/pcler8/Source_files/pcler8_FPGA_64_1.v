...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x06 | ~x19)) | ((new_n68_ | ~x06) & x19) | (new_n66_ & ~x08);
  ...
  assign z14 = (x05 & x08 & (x06 | ~x19)) | ((new_n77_ | ~x06) & x19) | (new_n79_ & ~x08);
  ...
  assign z15 = (x06 & (x08 | (x09 & ~new_n83_ & ~x10))) | (~x08 & x09 & new_n87_ & ~x10);
  assign new_n83_ = (~new_n80_ | ~new_n86_) & (~x25 | (new_n84_ & new_n85_));
