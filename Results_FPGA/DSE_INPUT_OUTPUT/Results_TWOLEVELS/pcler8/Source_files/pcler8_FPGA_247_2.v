...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (x09 & (~x19 | (~x08 & ~new_n61_ & ~x10)));
  ...
  assign z12 = (x09 & (~x19 | (~x08 & ~new_n67_ & ~x10))) | (x03 & x08 & (~x09 | x19));
  ...
  assign z15 = (x06 & x08 & (~x09 | x19)) | (x09 & (~x19 | (new_n74_ & ~x08)));
  assign new_n74_ = ~x10 & ((x25 & (~new_n75_ | ~x23 | new_n76_ | ~x24)) | (new_n75_ & x23 & x24 & ~x25));
