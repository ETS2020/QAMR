...
module FAU ( 
  ...
  assign new_n63_ = (x16 | ((~x19 | x20) & (~new_n61_ | ~new_n60_ | ~x12 | ~x20))) & (x19 | ~x20);
  assign z11 = (x02 & x08 & (~x16 | ~x19)) | (x19 & (new_n65_ | x16)) | (new_n66_ & ~x08);
  assign new_n65_ = new_n48_ & ~x10 & x20 & ~x21;
  ...
  assign z14 = (x05 & x08 & (~x16 | ~x19)) | (x19 & (new_n76_ | x16)) | (new_n77_ & ~x08);
  assign new_n76_ = new_n48_ & ~x10 & x20 & new_n60_ & x23 & ~x24;
  assign new_n77_ = x09 & new_n78_ & ~x10;
  assign new_n78_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = (x06 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (x19 | ~x25) & (x16 | ((~x19 | (~new_n81_ & ~new_n82_)) & (new_n83_ | ~x25)));
  assign new_n81_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = x17 & x25 & x26;
  assign new_n83_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = (~new_n85_ & x19) | (x07 & x08) | (~x08 & new_n88_ & x09);
  assign new_n85_ = ~x16 & (~new_n87_ | ~new_n48_ | ~new_n86_ | x10);
