...
module FAU ( 
  ...
  assign z09 = (x00 & ~new_n47_ & x08) | (~x08 & x09 & new_n59_ & ~x10);
  assign new_n59_ = x25 & (~x19 | (new_n61_ & new_n60_ & x11));
  assign new_n60_ = x20 & x21;
  assign new_n61_ = x22 & x23 & x24 & x26;
  assign z10 = z02 | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & (x20 ? (x25 & (new_n64_ | ~x19)) : x19);
  ...
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x22 & (new_n71_ | (x19 & (~x20 | ~x21)))) | (x19 & x20 & x21 & ~x22));
  assign new_n71_ = x25 & (~x19 | (x14 & x23 & x24 & x26));
  assign z13 = (x04 & ~new_n47_ & x08) | new_n47_ | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x19 | ((~x20 | ~x21 | ~x22 | x23) & (x21 | ~x23))) & (~x23 | (x19 & x20 & ~new_n74_ & x22));
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (~new_n77_ & (~x19 | (new_n60_ & x22 & x23)))) & (~new_n60_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n77_ = x25 & (~x19 | (x16 & x26));
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | (new_n80_ & x23 & x24 & (~x17 | ~x26))) & (~new_n80_ | ~x23 | ~x24 | x25);
  assign new_n80_ = x20 & x21 & x22;
  assign new_n81_ = ~x19 & (~x25 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n83_ | new_n84_));
  assign new_n83_ = x19 & ((~x25 & x26) | (new_n80_ & x23 & x24 & x25 & ~x26));
  assign new_n84_ = x25 & x26 & (~new_n85_ | x18 | ~x19 | ~x20);
