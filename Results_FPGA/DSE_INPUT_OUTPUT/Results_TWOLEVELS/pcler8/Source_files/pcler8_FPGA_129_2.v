...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (~x14 | x19)) | (x14 & (new_n71_ | ~x19)) | (new_n72_ & ~x08);
  assign new_n71_ = new_n65_ & ~x08 & x09 & ~x10 & x22;
  assign new_n72_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (x14 | x19 | ~x23) & (~x19 | ((~x23 | (new_n61_ & ~new_n75_ & x22)) & (~new_n61_ | ~x22 | x23)));
  ...
  assign new_n81_ = (~x19 | ((~new_n82_ | ~new_n84_) & (~x25 | (new_n82_ & new_n83_)))) & (x14 | x19 | ~x25);
