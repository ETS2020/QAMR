...
module FAU ( 
  ...
  assign z13 = z05 | (~x08 & ~x10 & (new_n69_ | new_n72_));
  assign new_n69_ = x19 & ((new_n71_ & x22 & ~x23) | (new_n70_ & x15 & x23));
  assign new_n70_ = x24 & x25 & x26;
  assign new_n71_ = x20 & x21;
  assign new_n72_ = x09 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x09 & x19) | (new_n74_ & ~x08);
  assign new_n74_ = ~x10 & ((new_n77_ & x09) | (x19 & (new_n75_ | new_n76_)));
  assign new_n75_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n76_ = x16 & x24 & x25 & x26;
  assign new_n77_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = (x06 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x19 | (~new_n80_ & ~new_n81_)) & (~x09 | new_n82_ | ~x25);
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x17 & x25 & x26;
  assign new_n82_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = (x19 & (new_n84_ | ~x09)) | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n84_ = new_n85_ & new_n71_ & ~x08 & ~x10;
