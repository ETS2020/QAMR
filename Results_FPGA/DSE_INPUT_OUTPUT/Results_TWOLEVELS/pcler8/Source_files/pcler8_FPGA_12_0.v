...
module FAU ( 
  ...
  assign new_n70_ = ~x19 & (~x14 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (~x08 & x09 & ~new_n72_ & ~x10) | (x04 & ~new_n47_ & x08);
  assign new_n72_ = (~x14 | x19 | ~x23) & (~x19 | ((~x23 | (new_n73_ & ~new_n74_ & x22)) & (~new_n73_ | ~x22 | x23)));
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x25 & x26 & x15 & x24;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | ((~x24 | (new_n73_ & new_n77_)) & (~new_n73_ | ~new_n78_))) & (~x14 | x19 | ~x24);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x19 | ((~x25 | (new_n81_ & new_n82_)) & (~new_n81_ | ~new_n83_))) & (~x14 | x19 | ~x25);
