...
module FAU ( 
  ...
  assign z13 = z05 | new_n71_ | (~x08 & x09 & ~new_n69_ & ~x10);
  ...
  assign z15 = z07 | new_n80_ | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n78_ & new_n58_ & x20)) & (~new_n74_ | ~new_n79_);
  assign new_n78_ = x23 & x24 & (~x17 | ~x26);
  assign new_n79_ = x22 & x23 & x24 & ~x25;
  assign new_n80_ = ~x19 & (~x09 | (~x08 & ~x10 & x25));
