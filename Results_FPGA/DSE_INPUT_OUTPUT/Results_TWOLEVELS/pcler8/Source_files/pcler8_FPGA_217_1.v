...
module FAU ( 
  ...
  assign new_n50_ = x08 & (x20 | ~x26);
  assign z03 = new_n50_ & x02;
  assign z04 = new_n50_ & x03;
  assign z05 = (~x20 & x26) | (x04 & x08 & (x20 | ~x26));
  assign z06 = new_n50_ & x05;
  assign z07 = (~x20 & x26) | (x06 & x08 & (x20 | ~x26));
  ...
  assign new_n70_ = x20 ? ((~x23 | (new_n71_ & ~new_n72_ & x22)) & (~new_n71_ | ~x22 | x23)) : (~x23 | x26);
  assign new_n71_ = x19 & x21;
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = x20 ? ((~x24 | (new_n71_ & new_n75_)) & (~new_n71_ | ~new_n76_)) : (~x24 | x26);
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x22 & x23 & ~x24;
  assign z15 = (new_n50_ & x06) | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = x20 ? ((~x25 | (new_n79_ & new_n80_)) & (~new_n79_ | ~new_n81_)) : (~x25 | x26);
  assign new_n79_ = x19 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & new_n83_ & ~x10);
  assign new_n83_ = x20 & ((new_n79_ & new_n86_) | (x26 & (~new_n84_ | ~new_n85_)));
