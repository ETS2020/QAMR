...
module FAU ( 
  ...
  assign new_n63_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | new_n67_ | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x21 & (~x20 | (new_n49_ & new_n66_))) | (x19 & x20 & ~x21));
  assign new_n66_ = x13 & x22 & x23;
  assign new_n67_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x21));
  ...
  assign new_n71_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x19 | ((~x23 | (new_n74_ & ~new_n75_ & x22)) & (~new_n74_ | ~x22 | x23))) & (x16 | x19 | ~x23);
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x25 & x26 & x15 & x24;
  assign z14 = new_n77_ | (x05 & x08) | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n77_ = x16 & (~x19 | (new_n49_ & ~x08 & x09 & ~x10));
  assign new_n78_ = (~x24 | (x19 & x20 & x21 & x22 & x23)) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x24);
  ...
  assign new_n90_ = x21 & x22 & x19 & x20;
  assign new_n91_ = x23 & x24 & x25 & ~x26;
  assign new_n92_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x26));
endmodule
