...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x10 | x20)) | (~x20 & (x10 | (new_n64_ & ~x08))) | (new_n62_ & ~x08);
  assign new_n62_ = x09 & ~x10 & ((x21 & (new_n63_ | ~x19)) | (x19 & x20 & ~x21));
  ...
  assign new_n69_ = (~x23 | (x19 & x21 & ~new_n70_ & x22)) & (~x21 | ~x22 | x23 | ~x19 | ~x20);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign new_n71_ = ~x20 & (x10 | (~x08 & x09 & x23));
  ...
  assign z15 = z07 | new_n81_ | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~new_n74_ | ~new_n80_) & (~x25 | (new_n78_ & new_n79_));
  assign new_n78_ = x19 & x21 & x22;
  assign new_n79_ = x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x22 & x23 & x24 & ~x25;
  assign new_n81_ = ~x20 & (x10 | (~x08 & x09 & x25));
