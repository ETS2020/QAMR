...
module FAU ( 
  ...
  assign z00 = (x10 & ~x21) | (new_n47_ & new_n48_ & ~x10 & new_n50_ & new_n49_ & x21);
  assign new_n47_ = ~x08 & x09;
  assign new_n48_ = x19 & x20;
  assign new_n49_ = x22 & x23;
  assign new_n50_ = x24 & x25 & x26;
  assign z01 = new_n52_ | (x00 & ~new_n52_ & x08);
  ...
  assign z09 = (x00 & x08 & (~x10 | x21)) | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = x19 & (~new_n62_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n62_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08 & (~x10 | x21)) | (x10 & ~x21) | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = x20 ? (x19 & (~new_n62_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = new_n66_ | (x02 & x08) | (~x08 & x09 & new_n67_ & ~x10);
  assign new_n66_ = ~x21 & (x10 | (new_n47_ & new_n48_));
  assign new_n67_ = x21 & (~x19 | ~x20 | (new_n50_ & new_n49_ & x13));
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (new_n48_ & x21 & (~new_n50_ | ~x14 | ~x23))) & (~new_n48_ | ~x21 | x22);
  ...
  assign new_n74_ = ~x21 & (x10 | (new_n47_ & ~x10 & x24));
  assign new_n75_ = (~x24 | (new_n48_ & x22 & ~new_n76_ & x23)) & (~new_n77_ | ~x22 | ~x23 | x24);
  assign new_n76_ = x16 & x25 & x26;
  assign new_n77_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | (new_n77_ & new_n49_ & x24 & (~x17 | ~x26))) & (~new_n77_ | ~new_n49_ | ~x24 | x25);
  assign z16 = z08 | new_n86_ | (~x08 & new_n81_ & x09);
  ...
  assign new_n86_ = ~x21 & (x10 | (~x08 & x09 & x26));
endmodule
