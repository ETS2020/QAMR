...
module FAU ( 
  ...
  assign new_n61_ = x19 ? (x20 & (~new_n59_ | ~new_n62_)) : (~x20 | x26);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & (x19 ? (x21 ? (new_n65_ | ~x20) : x20) : (x21 & ~x26));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = x19 ? ((~x22 | (x20 & ~new_n68_ & x21)) & (~x20 | ~x21 | x22)) : (~x22 | x26);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x19 | ((x21 | ~x23) & (~x20 | ~x21 | ~x22 | x23))) & (~x23 | (x19 & x20 & ~new_n71_ & x22));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = x19 ? ((~x24 | (new_n74_ & new_n75_)) & (~new_n74_ | ~new_n76_)) : (~x24 | x26);
  ...
  assign z16 = (x07 & ~new_n49_ & x08) | (~x08 & x09 & new_n85_ & ~x10);
  assign new_n85_ = x19 & ((new_n79_ & new_n88_) | (x26 & (~new_n86_ | ~new_n87_)));
