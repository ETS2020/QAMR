...
module FAU ( 
  ...
  assign z00 = x19 & (~x09 | (new_n47_ & new_n48_ & new_n49_ & x24));
  assign new_n47_ = ~x08 & ~x10 & x20 & x21;
  ...
  assign z09 = (x00 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~x10 & (new_n59_ | ~x19));
  ...
  assign z11 = z03 | (~x08 & ~x10 & (new_n65_ | (~new_n64_ & x21)));
  assign new_n64_ = (~x09 | (x19 & x20)) & (~new_n60_ | ~x13 | ~x19 | ~x22);
  assign new_n65_ = x19 & x20 & ~x21;
  assign z12 = z04 | (~x08 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x19 | (~new_n68_ & (~x20 | ~x21 | x22))) & (~x09 | ~x22 | (x19 & x20 & x21));
  ...
  assign z14 = z06 | (~x08 & ~x10 & (new_n75_ | (~new_n73_ & x19)));
  assign new_n73_ = ~new_n74_ & (~new_n49_ | ~x16 | ~x24);
  assign new_n74_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n75_ = x09 & x24 & (~x19 | ~x20 | ~new_n48_ | ~x21);
  assign z15 = z07 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n78_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n78_ | ~new_n48_ | ~x24 | x25);
  assign new_n78_ = x19 & x20 & x21;
  assign z16 = (x19 & (new_n80_ | ~x09)) | (x07 & x08) | (~x08 & new_n81_ & x09);
