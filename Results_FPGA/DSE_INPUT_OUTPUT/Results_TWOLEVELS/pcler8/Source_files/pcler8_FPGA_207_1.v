...
module FAU ( 
  ...
  assign z00 = x25 & (new_n47_ | ~x19);
  assign new_n47_ = new_n48_ & new_n49_ & x23 & x24 & x26;
  assign new_n48_ = ~x08 & x09 & ~x10 & x20;
  ...
  assign new_n60_ = x19 & (~new_n61_ | ~new_n49_ | ~x11 | ~x20);
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = x19 ? (x20 & (~new_n61_ | ~new_n49_ | ~x12)) : (~x20 | x25);
  assign z11 = (x02 & ~new_n51_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x19 ? (x21 ? (new_n66_ | ~x20) : x20) : (x21 & ~x25));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = x19 ? ((~x22 | (x20 & ~new_n69_ & x21)) & (~x20 | ~x21 | x22)) : (~x22 | x25);
  assign new_n69_ = x24 & x25 & x26 & x14 & x23;
  assign z13 = new_n73_ | (x04 & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x23 | (x20 & x21 & ~new_n72_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = ~x19 & (x25 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | new_n78_ | (~x08 & new_n75_ & x09);
  assign new_n75_ = ~x10 & (new_n77_ | (x24 & (~new_n76_ | ~x20 | ~x21)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign new_n78_ = ~x19 & (x25 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n51_ & x08) | (~x08 & x09 & new_n80_ & ~x10);
  assign new_n80_ = x19 & ((x25 & (~new_n81_ | ~x23 | new_n82_ | ~x24)) | (new_n81_ & x23 & x24 & ~x25));
  assign new_n81_ = x20 & x21 & x22;
  assign new_n82_ = x17 & x26;
  assign z16 = (~new_n84_ & x25) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n84_ = x19 & (~new_n48_ | ~new_n49_ | ~x23 | ~x24 | x26);
