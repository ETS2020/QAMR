...
module FAU ( 
  ...
  assign new_n63_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x20));
  ...
  assign z12 = new_n69_ | (x03 & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x22 | (x20 & x21 & (~new_n48_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  ...
  assign new_n73_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x23));
  assign z14 = (~x08 & x09 & ~new_n75_ & ~x10) | (x05 & ~new_n50_ & x08);
  assign new_n75_ = (new_n76_ | ~x19) & (~x22 | ~x24 | (new_n77_ & x19 & x20));
  assign new_n76_ = (x22 | ~x24) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  ...
  assign new_n91_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x26));
endmodule
