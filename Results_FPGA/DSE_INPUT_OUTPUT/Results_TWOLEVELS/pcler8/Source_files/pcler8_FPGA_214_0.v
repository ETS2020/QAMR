...
module FAU ( 
  ...
  assign new_n62_ = ~x19 & (~x02 | (~x08 & x09 & ~x10 & x20));
  ...
  assign new_n77_ = (~x24 | (new_n73_ & x22 & ~new_n78_ & x23)) & (~new_n73_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = ~x19 & (~x02 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x02 & (new_n85_ | (x06 & x08))) | (x19 & (x08 ? x06 : new_n81_));
  assign new_n81_ = x09 & ~x10 & ((new_n82_ & new_n84_) | (x25 & (~new_n82_ | ~new_n83_)));
  ...
  assign new_n92_ = ~x19 & (~x02 | (~x08 & x09 & ~x10 & x26));
endmodule
