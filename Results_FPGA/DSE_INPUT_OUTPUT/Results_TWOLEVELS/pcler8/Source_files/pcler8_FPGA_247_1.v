...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n68_ & ~x10);
  ...
  assign new_n71_ = (~new_n58_ | ~x22 | x23) & (~new_n60_ | ~x09 | ~x15 | ~x23);
  assign new_n72_ = x09 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n74_ & ~x10);
  assign new_n74_ = (~new_n76_ | ~x09) & (~x19 | (~new_n75_ & (~new_n60_ | ~x09 | ~x16)));
