...
module FAU ( 
  ...
  assign new_n62_ = ~x19 & (new_n48_ | x22);
  ...
  assign new_n74_ = ~x08 & x09 & ~x10 & x20 & x21 & ~x23;
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | ((~x24 | (new_n72_ & ~new_n77_ & x23)) & (~new_n72_ | ~x22 | ~x23 | x24))) & (x22 | ~x24);
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = (x06 & x08 & (x19 | ~x22)) | (x22 & (new_n79_ | ~x19)) | (new_n80_ & ~x08);
  assign new_n79_ = new_n48_ & x21 & x23 & x24 & ~x25;
  assign new_n80_ = x09 & ~x10 & x25 & (~new_n81_ | ~new_n82_);
  assign new_n81_ = x20 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x22 & (new_n84_ | ~x19)) | (x07 & x08) | (new_n85_ & ~x08);
  assign new_n84_ = new_n48_ & x21 & x23 & x24 & x25 & ~x26;
  assign new_n85_ = x09 & ~x10 & x26 & (~new_n86_ | ~new_n72_ | x18);
