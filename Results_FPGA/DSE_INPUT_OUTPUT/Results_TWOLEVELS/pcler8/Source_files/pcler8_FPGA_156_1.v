...
module FAU ( 
  ...
  assign z00 = x19 & (~x09 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign z09 = (x00 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~x10 & (new_n59_ | (x09 & ~x19)));
  assign new_n59_ = new_n48_ & new_n49_ & x11 & x19 & x20 & x21;
  assign z10 = z02 | (new_n61_ & ~x08);
  assign new_n61_ = ~x10 & ((x19 & ((new_n62_ & new_n63_) | ~x20)) | (x09 & ~x19 & x20));
  ...
  assign z15 = (x06 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n74_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n48_ | ~x24 | x25);
  assign z16 = (x19 & (new_n79_ | ~x09)) | (x07 & x08) | (~x08 & new_n80_ & x09);
  assign new_n79_ = new_n47_ & new_n48_ & x24 & x25 & ~x26;
