...
module FAU ( 
  ...
  assign new_n60_ = x19 & (~new_n62_ | ~new_n63_ | ~new_n61_ | ~x06 | ~x11);
  assign new_n61_ = x20 & x21;
  assign new_n62_ = x22 & x23;
  assign new_n63_ = x24 & x25 & x26;
  assign z10 = (x01 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = x19 ? ((~new_n66_ | ~new_n67_) & x20) : ~x20;
  assign new_n66_ = x06 & x12 & x21 & x22;
  assign new_n67_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n50_ & x08) | new_n50_ | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & ((x19 & ((new_n67_ & new_n70_) | (x20 & ~x21))) | (x21 & (~x19 | ~x20)));
  assign new_n70_ = x06 & x13 & x21 & x22;
  assign z12 = z04 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x06 | ((~x22 | (x20 & x21)) & (~x19 | (~new_n73_ & (~x20 | ~x21 | x22))))) & (x19 | ~x22);
  assign new_n73_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x06 | (~new_n77_ & (~x23 | (new_n61_ & (new_n76_ | ~x19))))) & (x19 | ~x23);
  ...
  assign new_n79_ = ~new_n81_ & (~x19 | (~new_n80_ & (~new_n63_ | ~x06 | ~x16)));
  assign new_n80_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n81_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = (x06 & (new_n86_ | x08)) | (x19 & (new_n83_ | ~x06)) | (new_n84_ & ~x08);
  assign new_n83_ = new_n61_ & x09 & ~x10 & new_n62_ & x24 & ~x25;
  assign new_n84_ = x09 & ~x10 & ~new_n85_ & x25;
  assign new_n85_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign new_n86_ = x19 & x25 & x26 & x09 & ~x10 & x17;
  assign z16 = new_n58_ | (~x08 & x09 & ~x10 & (new_n88_ | new_n93_));
  assign new_n88_ = x06 & ((new_n91_ & new_n92_) | ((~new_n89_ | ~new_n90_) & x26));
