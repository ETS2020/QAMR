// Benchmark "FAU" written by ABC on Mon Aug 24 16:58:21 2020
...
module FAU ( 
  ...
  assign z11 = (x02 & ~new_n49_ & x08) | new_n49_ | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ((x20 & (x21 ? (new_n65_ | ~x19) : x19)) | (~x10 & ~x20 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08 & (~x10 | ~x20)) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x20 | (~new_n68_ & (~x19 | ~x21 | x22))) & (~x22 | (x19 & x20 & x21));
  assign new_n68_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & (new_n70_ | new_n72_));
  assign new_n70_ = x23 & ((~new_n71_ & x20) | (~x10 & (~new_n59_ | ~x20)));
  assign new_n71_ = x19 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n72_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & (new_n76_ | (~new_n74_ & x24)));
  assign new_n74_ = (new_n75_ | ~x20) & (x10 | (x20 & x21 & x22 & x23));
  assign new_n75_ = x19 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x20 | (~new_n79_ & (~x17 | ~x25 | ~x26))) & (new_n80_ | ~x25);
  assign new_n79_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n80_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = (x07 & ~new_n49_ & x08) | (~x08 & new_n82_ & x09);
