...
module FAU ( 
  ...
  assign new_n71_ = x19 ? ((~x22 | (x20 & ~new_n72_ & x21)) & (~x20 | ~x21 | x22)) : (~x22 | x26);
  assign new_n72_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n74_ & ~x10);
  ...
  assign z16 = (x07 & ~new_n50_ & x08) | new_n50_ | (~x08 & new_n88_ & x09);
