...
module FAU ( 
  ...
  assign new_n71_ = (new_n72_ | (x23 & (~x23 | ~x25))) & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n72_ = x19 & x20 & x21;
  assign z13 = z05 | (~x08 & new_n74_ & x09);
  assign new_n74_ = ~x10 & (new_n77_ | (x23 & x25 & (new_n75_ | ~new_n76_)));
  assign new_n75_ = x22 & (~x19 | ~x20 | ~x21);
  assign new_n76_ = x22 & (~x15 | ~x24 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | ((~x23 | (~new_n80_ & ~new_n81_)) & (new_n82_ | ~x24))) & (x23 | ~x24);
  assign new_n80_ = x19 & x20 & x21 & x22 & ~x24;
  assign new_n81_ = x16 & x24 & x26;
  assign new_n82_ = x19 & x20 & x21 & x22;
  assign z15 = z07 | (~x08 & x09 & new_n84_ & ~x10);
  assign new_n84_ = x25 & (~x23 | (x23 & ((~new_n85_ & x22) | ~x22 | (x17 & x26))));
  assign new_n85_ = x19 & x20 & x21 & (~x19 | ~x20 | ~x21 | x24);
  assign z16 = new_n87_ | (x07 & x08) | (~x08 & x09 & new_n89_ & ~x10);
  assign new_n87_ = x23 & (~x25 | (new_n88_ & new_n48_ & ~x10 & x19));
  assign new_n88_ = x20 & x21 & x22 & x24 & ~x26;
  assign new_n89_ = x26 & (~new_n90_ | x18 | ~x19 | ~x20);
