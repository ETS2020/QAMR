...
module FAU ( 
  ...
  assign new_n47_ = x21 & x20 & x19 & ~x15 & new_n48_ & ~x10;
  assign new_n48_ = ~x08 & x09;
  assign z01 = x00 & x08 & (~x15 | ~x19);
  assign z02 = x01 & x08 & (~x15 | ~x19);
  assign z03 = x02 & x08 & (~x15 | ~x19);
  assign z04 = (x03 & x08) | (x15 & x19);
  assign z05 = (x04 & x08) | (x15 & x19);
  assign z06 = (x05 & x08) | (x15 & x19);
  assign z07 = (x06 & x08) | (x15 & x19);
  assign z08 = (x07 & x08) | (x15 & x19);
  assign z09 = z01 | (~x08 & x09 & ~x10 & (new_n58_ | ~x19));
  assign new_n58_ = new_n59_ & x11 & ~x15 & new_n60_ & x22 & x23;
  assign new_n59_ = x20 & x21;
  assign new_n60_ = x24 & x25 & x26;
  assign z10 = z02 | new_n62_ | (~x08 & x09 & new_n63_ & ~x10);
  assign new_n62_ = x19 & (x15 | (new_n48_ & ~x10 & ~x20));
  assign new_n63_ = x20 & (~x19 | (new_n65_ & new_n64_ & x12));
  assign new_n64_ = x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((~x15 & ((x21 & (new_n68_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n68_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x19 & (new_n72_ | x15)) | (x03 & x08) | (new_n70_ & ~x08);
  ...
  assign z13 = (x19 & (new_n74_ | x15)) | (x04 & x08) | (new_n75_ & ~x08);
  assign new_n74_ = ~x08 & x09 & ~x10 & new_n59_ & x22 & ~x23;
  assign new_n75_ = x09 & ~x10 & x23 & (~new_n64_ | ~x19 | ~x20);
  assign z14 = (x19 & (new_n77_ | x15)) | (x05 & x08) | (new_n78_ & ~x08);
  assign new_n77_ = new_n48_ & ~x10 & x20 & new_n64_ & x23 & ~x24;
  assign new_n78_ = x09 & ~x10 & x24 & (~new_n79_ | ~new_n59_ | ~x19);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((x19 & (new_n82_ | new_n83_)) | (~new_n84_ & x25));
  assign new_n82_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n83_ = ~x15 & x17 & x25 & x26;
  assign new_n84_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = (~new_n86_ & x19) | (x07 & x08) | (~x08 & new_n88_ & x09);
  assign new_n86_ = ~x15 & (~new_n87_ | ~new_n48_ | ~new_n59_ | x10);
  assign new_n87_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n88_ = ~x10 & x26 & (~new_n89_ | ~new_n59_ | x18 | ~x19);
