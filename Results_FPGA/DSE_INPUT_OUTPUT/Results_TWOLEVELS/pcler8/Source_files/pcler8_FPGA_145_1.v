...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (x10 | ~x21)) | (~x08 & x09 & ~x10 & ~x19 & ~x21);
  assign z10 = (x01 & x08 & (x10 | ~x21)) | (~x10 & (x21 | (new_n57_ & ~x08)));
  assign new_n57_ = x09 & (x19 ^ x20);
  assign z11 = (x02 & x08) | (~x10 & (x21 | (new_n59_ & ~x08 & x09)));
  assign new_n59_ = x19 & x20;
  assign z12 = (x03 & x08 & (x10 | ~x21)) | (~x08 & x09 & ~x10 & ~x21 & x22);
  assign z13 = (x04 & x08 & (x10 | ~x21)) | (~x08 & x09 & ~x10 & ~x21 & x23);
  assign z14 = (x05 & x08) | (~x10 & (x21 | (~x08 & x09 & x24)));
  assign z15 = (x06 & x08 & (x10 | ~x21)) | (~x08 & x09 & ~x10 & ~x21 & x25);
  assign z16 = (x07 & x08 & (x10 | ~x21)) | (~x10 & (x21 | (~x08 & x09 & x26)));
endmodule
