...
module FAU ( 
  ...
  assign new_n60_ = x21 & (~x19 | (new_n61_ & x11 & x20 & x22));
  ...
  assign new_n65_ = x21 ? (x20 & (~new_n49_ | ~new_n48_ | ~x13)) : ~x20;
  assign new_n66_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x21));
  ...
  assign new_n91_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x26));
endmodule
