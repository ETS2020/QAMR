...
module FAU ( 
  ...
  assign new_n61_ = (~x09 | ((~x19 | x20) & (~new_n59_ | ~new_n58_ | ~x12 | ~x20))) & (x19 | ~x20);
  assign z11 = new_n65_ | (x02 & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x21 | (~new_n64_ & x20)) & (~x19 | ~x20 | x21);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = ~x19 & (~x09 | (~x08 & ~x10 & x21));
  assign z12 = (x03 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n67_ & ~x10);
  ...
  assign new_n70_ = (~x23 | (x20 & x21 & ~new_n71_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x19 & (~x09 | (~x08 & ~x10 & x23));
  assign z14 = new_n77_ | (x05 & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x24 | (new_n75_ & x22 & ~new_n76_ & x23)) & (~x22 | ~x23 | x24 | ~new_n75_ | ~x19);
  assign new_n75_ = x20 & x21;
  assign new_n76_ = x16 & x25 & x26;
  assign new_n77_ = ~x19 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (x06 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n84_ & ~x08))) | (~x08 & new_n79_ & x09);
  ...
  assign z16 = (x07 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n91_ & ~x08))) | (~x08 & new_n86_ & x09);
