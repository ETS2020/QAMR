...
module FAU ( 
  ...
  assign z14 = z06 | new_n75_ | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n75_ = x16 & (~x19 | (new_n76_ & x25 & x26 & x19 & x24));
  ...
  assign new_n79_ = (~x19 | ((~x25 | (new_n80_ & new_n81_)) & (~new_n80_ | ~new_n82_))) & (x16 | x19 | ~x25);
  ...
  assign new_n89_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x26));
endmodule
