...
module FAU ( 
  ...
  assign new_n69_ = ~new_n70_ & (~x20 | ~x21 | ~x22 | x23);
  assign new_n70_ = x09 & x15 & x23 & x24 & x25 & x26;
  ...
  assign z15 = z07 | (~x08 & ~x10 & (new_n79_ | new_n81_));
  assign new_n79_ = x19 & (new_n80_ | (new_n75_ & x09 & x17));
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x09 & x25 & (~new_n82_ | ~x22 | ~x23 | ~x24);
  assign new_n82_ = x19 & x20 & x21;
  assign z16 = z08 | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((new_n72_ & new_n87_) | (x26 & (~new_n85_ | ~new_n86_)));
