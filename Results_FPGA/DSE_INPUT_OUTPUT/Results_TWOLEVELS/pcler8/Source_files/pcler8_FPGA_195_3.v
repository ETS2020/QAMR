...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n64_ & ~x10) | (x01 & x08 & ~x19);
  assign new_n64_ = (x01 | ((~new_n62_ | ~new_n61_ | ~x12 | ~x20) & (~x19 | x20))) & (x19 | ~x20);
  ...
  assign z12 = (x03 & x08 & (~x01 | ~x19)) | (new_n70_ & ~x08) | (x19 & (new_n72_ | x01));
  ...
  assign z13 = (x19 & (new_n74_ | x01)) | (x04 & x08) | (new_n75_ & ~x08);
  assign new_n74_ = ~x08 & x09 & ~x10 & new_n48_ & x22 & ~x23;
  assign new_n75_ = x09 & ~x10 & x23 & (~new_n76_ | ~x19 | ~x20);
  assign new_n76_ = x21 & x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign z14 = new_n78_ | (x05 & x08) | (~x08 & x09 & new_n80_ & ~x10);
  assign new_n78_ = x19 & (x01 | (new_n79_ & new_n61_ & x23 & ~x24));
  assign new_n79_ = ~x10 & x20 & ~x08 & x09;
  assign new_n80_ = x24 & (~new_n81_ | ~new_n48_ | ~x19);
  assign new_n81_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x06 & x08 & (~x01 | ~x19)) | (x19 & (new_n83_ | x01)) | (new_n84_ & ~x08);
  assign new_n83_ = new_n79_ & new_n61_ & x23 & x24 & ~x25;
