...
module FAU ( 
  ...
  assign new_n65_ = (~x21 | (x20 & (~new_n60_ | ~new_n66_ | ~x13))) & (~x19 | ~x20 | x21);
  assign new_n66_ = x22 & x23;
  assign new_n67_ = ~x19 & (x22 | (~x08 & x09 & ~x10 & x21));
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & x19 & ((x20 & x21 & ~x22) | (x22 & (~x20 | new_n70_ | ~x21)));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x22 | ((~x20 | ~x21 | x23) & (~new_n60_ | ~x15 | ~x23))) & (~x23 | (x20 & x21 & x22));
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x19 | ((~x22 | (~new_n75_ & ~new_n76_)) & (new_n77_ | ~x24))) & (x22 | ~x24);
  assign new_n75_ = x20 & x21 & x23 & ~x24;
  assign new_n76_ = x16 & x24 & x25 & x26;
  assign new_n77_ = x20 & x21 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x19 | ((~x22 | (~new_n80_ & ~new_n81_)) & (new_n82_ | ~x25))) & (x22 | ~x25);
  assign new_n80_ = x20 & x21 & x23 & x24 & ~x25;
  assign new_n81_ = x17 & x25 & x26;
  assign new_n82_ = x20 & x21 & x23 & x24;
  assign z16 = new_n84_ | (x07 & x08) | (~x08 & x09 & new_n87_ & ~x10);
  assign new_n84_ = x22 & (~x19 | (new_n85_ & new_n86_));
  assign new_n85_ = ~x08 & x09 & ~x10 & x20;
  assign new_n86_ = x21 & x23 & x24 & x25 & ~x26;
  assign new_n87_ = x26 & (~new_n59_ | x18 | ~new_n66_ | ~x24 | ~x25);
endmodule
