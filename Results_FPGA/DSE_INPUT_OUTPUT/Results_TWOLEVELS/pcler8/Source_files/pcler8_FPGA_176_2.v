...
module FAU ( 
  ...
  assign new_n82_ = ~x10 & ((x25 & (~new_n83_ | ~x22 | ~x23 | ~x24)) | (new_n83_ & x24 & ~x25 & x22 & x23));
  assign new_n83_ = x19 & x20 & x21;
  assign new_n84_ = x19 & (x08 | ~x09 | x10 | ~x25 | ~x26);
  assign z16 = new_n56_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n91_));
  assign new_n86_ = x19 & ((x26 & (~new_n87_ | ~new_n88_)) | (new_n89_ & new_n90_));
