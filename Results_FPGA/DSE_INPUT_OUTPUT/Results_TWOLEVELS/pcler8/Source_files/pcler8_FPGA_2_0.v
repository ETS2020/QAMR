...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x10 | x20)) | (~x10 & (~x20 | (~x08 & ~new_n62_ & x09)));
  ...
  assign new_n67_ = (~x23 | (x19 & (~x20 | x21) & ~new_n68_ & x22)) & (~x19 | ~x21 | ~x22 | x23);
  assign new_n68_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~x10 & (~x20 | (~x08 & ~new_n70_ & x09)));
  assign new_n70_ = (~x24 | (new_n71_ & x19 & (~x20 | x21))) & (~new_n72_ | ~x19 | ~x21);
