...
module FAU ( 
  ...
  assign z00 = (~x02 & x10) | (new_n47_ & ~x08 & x09 & new_n50_ & ~x10);
  ...
  assign z11 = (~x08 & x09 & ~new_n65_ & ~x10) | (x02 & x08) | (~x02 & x10);
  assign new_n65_ = (~x21 | (x19 & x20 & (~new_n49_ | ~new_n48_ | ~x13))) & (~x19 | ~x20 | x21);
  assign z12 = (x03 & x08 & (x02 | ~x10)) | (~x02 & x10) | (~x08 & x09 & ~new_n67_ & ~x10);
  ...
  assign z14 = (x05 & x08 & (x02 | ~x10)) | (~x08 & x09 & ~new_n72_ & ~x10);
  ...
  assign z16 = (x07 & x08 & (x02 | ~x10)) | (~x02 & x10) | (~x08 & x09 & ~new_n78_ & ~x10);
