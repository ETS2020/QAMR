...
module FAU ( 
  ...
  assign new_n59_ = ~x10 & ((new_n60_ & new_n61_) | ~x19);
  ...
  assign z11 = (x02 & x08 & (x01 | ~x20)) | (x20 & (new_n68_ | ~x01)) | (new_n66_ & ~x08);
  ...
  assign new_n70_ = (~x01 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x20 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (new_n50_ & x04) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x01 | (~new_n76_ & ((new_n74_ & new_n75_) | ~x23))) & (x20 | ~x23);
