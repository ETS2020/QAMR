// Benchmark "FAU" written by ABC on Mon Aug 24 16:58:34 2020
...
module FAU ( 
  ...
  assign z08 = x07 & x08;
  assign z09 = (x00 & ~new_n51_ & x08) | (~x08 & new_n60_ & x09);
  assign new_n60_ = ~x10 & (~x19 | (new_n49_ & new_n48_ & x07 & x11));
  ...
  assign z16 = (x19 & (new_n87_ | ~x07)) | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n87_ = new_n88_ & new_n48_ & x09 & ~x10;
  assign new_n88_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n48_ | x18 | ~x19);
