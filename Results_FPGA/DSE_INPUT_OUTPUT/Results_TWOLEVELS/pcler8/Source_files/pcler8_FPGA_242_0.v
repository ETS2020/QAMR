...
module FAU ( 
  ...
  assign new_n62_ = ~x19 & (~x18 | (~x08 & x09 & ~x10 & x20));
  ...
  assign new_n68_ = (~x19 | ((~x20 | ~x21 | x22) & (~x22 | (x20 & ~new_n69_ & x21)))) & (~x18 | x19 | ~x22);
  ...
  assign new_n73_ = ~x19 & (~x18 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n78_ = ~x19 & (~x18 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x19 | ((~new_n81_ | ~new_n83_) & (~x25 | (new_n81_ & new_n82_)))) & (~x18 | x19 | ~x25);
