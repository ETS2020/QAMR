...
module FAU ( 
  ...
  assign z09 = new_n60_ | new_n47_ | (~new_n47_ & ~new_n61_);
  assign new_n60_ = new_n49_ & ~x08 & x09 & ~x10 & x11 & x20;
  assign new_n61_ = (~x00 | ~x08) & (x08 | ~x09 | x10 | x19);
  assign z10 = z02 | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & (x19 ? (x26 & (new_n64_ | ~x20)) : x20);
  assign new_n64_ = x12 & x21 & x22 & x23 & x24 & x25;
  assign z11 = (x02 & x08 & (x20 | x26)) | (~x20 & (new_n68_ | ~x26)) | (new_n66_ & ~x08);
  ...
  assign new_n72_ = ~x20 & (~x26 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | new_n76_ | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x23 | (~new_n75_ & x22 & x19 & x21)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign new_n76_ = ~x20 & (~x26 | (~x08 & x09 & ~x10 & x23));
  assign z14 = new_n82_ | (x05 & x08) | (~x08 & x09 & ~new_n78_ & ~x10);
  ...
  assign new_n82_ = ~x20 & (~x26 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | new_n88_ | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((new_n81_ & new_n87_) | ((~new_n85_ | ~new_n86_) & x25));
  assign new_n85_ = x19 & x21 & x22;
  assign new_n86_ = x23 & x24 & (~x17 | ~x26);
  assign new_n87_ = x22 & x23 & x24 & ~x25;
  assign new_n88_ = ~x20 & (~x26 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n58_ | (~x08 & x09 & ~x10 & (new_n90_ | new_n92_));
  assign new_n90_ = x19 & ((~x20 & x26) | (new_n91_ & x20 & x21 & x22));
  assign new_n91_ = x23 & x24 & x25 & ~x26;
  assign new_n92_ = x26 & (~new_n93_ | ~new_n79_ | x18);
