...
module FAU ( 
  ...
  assign z15 = z07 | (~x08 & ~x10 & (new_n78_ | (~new_n76_ & x19)));
  assign new_n76_ = (~x17 | ~x25 | ~x26) & (~new_n77_ | ~x23 | ~x24 | x25);
  assign new_n77_ = x20 & x21 & x22;
  assign new_n78_ = x09 & x25 & (~new_n73_ | ~x22 | ~x23 | ~x24);
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (x19 & (new_n80_ | ~x09)) | (~x08 & new_n81_ & x09);
