...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = (~x21 | (x19 & x20 & (~new_n59_ | ~new_n58_ | ~x13))) & (~x19 | ~x20 | x21);
  assign z12 = z04 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x22 | (new_n67_ & x21 & (~new_n59_ | ~x14 | ~x23))) & (~new_n67_ | ~x21 | x22);
  ...
  assign z15 = (x06 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n80_ & ~x08))) | (~x08 & new_n76_ & x09);
