...
module FAU ( 
  ...
  assign z05 = (x10 & x19) | (x04 & x08 & (~x10 | ~x19));
  assign z06 = (x05 & x08) | (x10 & x19);
  assign z07 = x06 & x08 & (~x10 | ~x19);
  assign z08 = (x07 & x08) | (x10 & x19);
  assign z09 = (x00 & x08 & (~x10 | ~x19)) | (x10 & x19) | (~x08 & x09 & (new_n58_ | (~x10 & ~x19)));
  ...
  assign z11 = z03 | (~x08 & x09 & (new_n64_ | (~new_n63_ & x21)));
  assign new_n63_ = (x10 | (x19 & x20)) & (~new_n61_ | ~x13 | ~x19 | ~x22);
  ...
  assign z13 = (x04 & x08 & (~x10 | ~x19)) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x23 | (x19 & x20 & x21 & ~new_n70_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & (new_n74_ | (~new_n72_ & x19)));
  assign new_n72_ = ~new_n73_ & (~x25 | ~x26 | ~x16 | ~x24);
  assign new_n73_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n74_ = ~x10 & x24 & (~x19 | ~x20 | ~new_n75_ | ~x21);
  assign new_n75_ = x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n78_ & new_n75_ & x24 & (~x17 | ~x26))) & (~new_n78_ | ~new_n75_ | ~x24 | x25);
  assign new_n78_ = x19 & x20 & x21;
  assign z16 = (~new_n80_ & x19) | (x07 & x08) | (~x08 & new_n82_ & x09);
  assign new_n80_ = ~x10 & (~new_n81_ | ~new_n47_ | x08 | ~x09);
  assign new_n81_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n82_ = ~x10 & x26 & (~new_n83_ | ~new_n75_ | ~x24 | ~x25);
  assign new_n83_ = x20 & x21 & ~x18 & x19;
endmodule
