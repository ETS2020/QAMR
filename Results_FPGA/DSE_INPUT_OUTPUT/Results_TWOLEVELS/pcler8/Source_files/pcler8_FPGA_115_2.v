...
module FAU ( 
  ...
  assign new_n61_ = x19 ? (~x21 | (x20 & (~new_n63_ | ~new_n62_ | ~x12))) : ~x20;
  assign new_n62_ = x22 & x23;
  assign new_n63_ = x24 & x25 & x26;
  assign z11 = (new_n50_ & x02) | (~x08 & x09 & new_n65_ & ~x10);
  assign new_n65_ = x21 & (~x19 | (x19 & (~x20 | (new_n63_ & new_n62_ & x13))));
  ...
  assign new_n70_ = (~x21 | ((~x19 | (~new_n71_ & (~x20 | ~x22 | x23))) & (~x23 | (x20 & x22)))) & (x19 | ~x23);
  assign new_n71_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (x19 | ~x24) & (~x21 | ((new_n76_ | ~x24) & (~x19 | (~new_n74_ & ~new_n75_))));
  ...
  assign new_n78_ = (x19 | ~x25) & (~x21 | ((new_n81_ | ~x25) & (~x19 | (~new_n79_ & ~new_n80_))));
  ...
  assign new_n83_ = (x19 | ~x26) & (~x21 | ((new_n85_ | ~x26) & (~new_n86_ | ~new_n84_ | ~x19)));
  assign new_n84_ = x20 & x22;
