...
module FAU ( 
  ...
  assign new_n60_ = ~x10 & (~x19 | (new_n48_ & new_n61_ & ~x01 & x11));
  assign new_n61_ = x20 & x21;
  assign z10 = (~x08 & new_n63_ & x09) | (x01 & x08 & ~x19);
  assign new_n63_ = ~x10 & ((~x01 & x19 & ((new_n64_ & new_n65_) | ~x20)) | (~x19 & x20));
  ...
  assign new_n74_ = (x19 | ~x23) & (x01 | (~new_n76_ & ((new_n61_ & new_n75_) | ~x23)));
