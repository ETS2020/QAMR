...
module FAU ( 
  ...
  assign new_n64_ = ~x19 & (~x15 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (x21 ? (new_n67_ | ~x20) : x20)) | (x15 & ~x19 & x21));
  ...
  assign new_n71_ = ~x19 & (~x15 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n75_ = ~x19 & (~x15 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n79_ = ~x19 & (~x15 | (~x08 & x09 & ~x10 & x24));
