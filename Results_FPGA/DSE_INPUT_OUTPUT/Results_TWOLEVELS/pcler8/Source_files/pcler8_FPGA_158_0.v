...
module FAU ( 
  ...
  assign new_n65_ = (~x21 | (~new_n66_ & x19)) & (~x19 | ~x20 | x21);
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n67_ = ~x20 & (~x22 | (~x08 & x09 & ~x10 & x21 & x22));
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & ((x21 & ((~x20 & x22) | (x19 & x20 & ~x22))) | (x22 & (~x19 | new_n70_ | ~x21)));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n74_ | (x04 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x22 | (~new_n73_ & (~x19 | ~x20 | ~x21 | x23))) & (~x23 | (x19 & x21 & x22));
  assign new_n73_ = x15 & x23 & x24 & x25 & x26;
  assign new_n74_ = ~x20 & (~x22 | (~x08 & x09 & ~x10 & x23));
  assign z14 = (~x08 & x09 & ~new_n76_ & ~x10) | (x05 & ~new_n49_ & x08);
  assign new_n76_ = (~x24 | ((~x20 | (x22 & x23)) & (new_n77_ | ~x22))) & (~new_n78_ | ~x22 | ~x23 | x24);
  assign new_n77_ = x19 & x20 & x21 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x19 & x20 & x21;
  assign z15 = (x06 & ~new_n49_ & x08) | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((x25 & (new_n81_ | new_n82_)) | (new_n78_ & new_n83_));
  assign new_n81_ = x20 & (~x22 | ~x23 | ~x24);
  assign new_n82_ = x22 & (~x19 | ~x20 | ~x21 | (x17 & x26));
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & new_n85_ & x09);
  assign new_n85_ = ~x10 & ((new_n87_ & new_n88_) | (x26 & (new_n81_ | new_n86_)));
  assign new_n86_ = x22 & (x18 | ~x19 | ~x20 | ~x21 | ~x25);
