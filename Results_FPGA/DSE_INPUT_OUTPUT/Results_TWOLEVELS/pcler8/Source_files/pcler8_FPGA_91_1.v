...
module FAU ( 
  ...
  assign new_n62_ = (~x19 | (x20 & (~new_n60_ | ~new_n63_))) & (~x09 | x19 | ~x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (x09 | ~x19)) | (~x09 & x19) | (new_n65_ & ~x08);
  assign new_n65_ = ~x10 & ((x19 & (x21 ? (new_n66_ | ~x20) : x20)) | (x09 & ~x19 & x21));
