...
module FAU ( 
  ...
  assign new_n47_ = x09 & (~new_n48_ | x08 | x10 | ~x20 | ~x21);
  ...
  assign new_n58_ = new_n48_ & x20 & x21 & x11 & x19;
  ...
  assign z11 = z03 | (~x08 & ~x10 & (new_n64_ | (~new_n63_ & x21)));
  assign new_n63_ = (~x09 | (x19 & x20)) & (~new_n61_ | ~x13 | ~x19 | ~x22);
  assign new_n64_ = x19 & x20 & ~x21;
  assign z12 = z04 | (~x08 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x19 | (~new_n67_ & (~x20 | ~x21 | x22))) & (~x09 | ~x22 | (x19 & x20 & x21));
  assign new_n67_ = x24 & x25 & x26 & x14 & x22 & x23;
  assign z13 = (x04 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x23 | (x19 & x20 & x21 & ~new_n70_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x08 & new_n72_ & x09);
  assign new_n72_ = ~x10 & ((x24 & (~new_n73_ | ~x22 | new_n74_ | ~x23)) | (new_n73_ & x22 & x23 & ~x24));
  assign new_n73_ = x19 & x20 & x21;
  assign new_n74_ = x16 & x25 & x26;
  assign z15 = (x06 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n76_ & ~x10);
  ...
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (~x08 & new_n81_ & x09);
