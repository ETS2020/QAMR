...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x09 & x19) | (~x08 & ~x10 & (new_n60_ | (x09 & ~x19)));
  ...
  assign new_n70_ = ~new_n72_ & (~x19 | (~new_n71_ & (~new_n48_ | ~x22 | x23)));
  assign new_n71_ = x15 & x23 & x24 & x25 & x26;
  assign new_n72_ = x09 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = z06 | (~x08 & ~x10 & (new_n74_ | (new_n76_ & x09)));
  assign new_n74_ = x19 & (new_n75_ | (new_n48_ & x22 & x23 & ~x24));
  assign new_n75_ = x16 & x24 & x25 & x26;
  assign new_n76_ = x24 & (~new_n68_ | ~new_n49_ | ~x21);
  assign z15 = (x06 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n78_ & ~x10);
