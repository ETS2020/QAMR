...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n48_ | ~new_n60_ | ~x11 | x12);
  assign new_n60_ = x20 & x21;
  assign z10 = z02 | (~x08 & x09 & ~x10 & (x19 ^ x20));
  assign z11 = (x02 & ~new_n50_ & x08) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((~x12 & ((x21 & (new_n64_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n64_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x19 & (new_n68_ | x12)) | (x03 & x08) | (new_n66_ & ~x08);
  assign new_n66_ = x09 & ~x10 & x22 & (~new_n67_ | ~x19 | ~x20);
  assign new_n67_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n68_ = x20 & x21 & ~x22 & ~x08 & x09 & ~x10;
  assign z13 = (x19 & (new_n70_ | x12)) | (x04 & x08) | (new_n71_ & ~x08);
  assign new_n70_ = ~x08 & x09 & ~x10 & new_n60_ & x22 & ~x23;
