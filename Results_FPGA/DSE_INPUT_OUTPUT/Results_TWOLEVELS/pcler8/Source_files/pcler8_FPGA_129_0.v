...
module FAU ( 
  ...
  assign new_n60_ = (~x14 | x19) & (~new_n62_ | ~new_n61_ | ~x11 | ~x19);
  ...
  assign new_n66_ = ~x19 & (~x14 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x19 & (x21 ? (new_n69_ | ~x20) : x20)) | (x14 & ~x19 & x21));
  ...
  assign new_n73_ = ~x19 & (~x14 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x14 | x19 | ~x23) & (~x19 | ((~x23 | (new_n61_ & ~new_n76_ & x22)) & (~new_n61_ | ~x22 | x23)));
  ...
  assign new_n80_ = ~x19 & (~x14 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x19 | ((~new_n83_ | ~new_n85_) & (~x25 | (new_n83_ & new_n84_)))) & (~x14 | x19 | ~x25);
