...
module FAU ( 
  ...
  assign new_n58_ = x23 & (~x19 | (new_n59_ & x11 & x20 & x21));
  assign new_n59_ = x22 & x24 & x25 & x26;
  assign z10 = new_n63_ | (x01 & x08) | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x19 | x20) & (~new_n62_ | ~x12 | ~x20 | ~x21 | ~x22);
  ...
  assign z13 = z05 | new_n74_ | (~x08 & new_n72_ & x09);
  assign new_n72_ = ~x10 & ((x20 & x21 & x22 & ~x23) | (x23 & (~x20 | ~x21 | new_n73_ | ~x22)));
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign new_n74_ = ~x19 & (~x23 | (~x08 & x09 & ~x10 & x23));
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = ~new_n78_ & (~x24 | ((new_n77_ | ~x23) & (~x19 | (x20 & x23))));
  assign new_n77_ = x19 & x21 & x22 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (new_n81_ | ~x19) & (~x25 | (new_n82_ & x19 & x20 & x21));
  assign new_n81_ = (~x20 | ~x21 | ~x22 | ~x23 | ~x24 | x25) & (x23 | ~x25);
  assign new_n82_ = x22 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((new_n87_ & new_n88_) | (x26 & (new_n85_ | new_n86_)));
  assign new_n85_ = x23 & (~x19 | ~x21 | ~x22);
  assign new_n86_ = x19 & (x18 | ~x20 | ~x23 | ~x24 | ~x25);
