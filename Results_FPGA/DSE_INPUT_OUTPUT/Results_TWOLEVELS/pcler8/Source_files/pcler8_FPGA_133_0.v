...
module FAU ( 
  ...
  assign z01 = new_n49_ | (~x10 & ~x19);
  assign new_n49_ = x00 & x08 & (x10 | x19);
  ...
  assign z08 = (~x10 & ~x19) | (x07 & x08 & (x10 | x19));
  ...
  assign z12 = (x03 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n66_ & x19);
  assign new_n66_ = (~x22 | (x20 & x21 & (~new_n59_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n68_ & x19);
  ...
  assign z15 = (x06 & x08 & (x10 | x19)) | (~x10 & (~x19 | (~x08 & ~new_n74_ & x09)));
  assign new_n74_ = ~new_n77_ & (~x25 | (~new_n75_ & new_n76_));
  assign new_n75_ = x19 & (~x21 | ~x22 | ~x23);
  assign new_n76_ = x20 & x24 & (~x17 | ~x26);
  assign new_n77_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (x07 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n79_ & x19);
  assign new_n79_ = (~x26 | (new_n81_ & new_n70_ & ~x18)) & (~new_n80_ | ~new_n82_);
