...
module FAU ( 
  ...
  assign z10 = (x01 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n64_ & ~x10);
  ...
  assign z13 = (x04 & x08 & (x16 | ~x19)) | (x19 & (new_n74_ | ~x16)) | (new_n76_ & ~x08);
  ...
  assign z14 = (x05 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x19 | ~x20 | ~new_n81_ | ~x21) & (~x24 | (x19 & x20 & new_n80_ & x21));
  assign new_n80_ = x22 & x23;
  assign new_n81_ = x22 & x23 & (~x24 | (x25 & x26 & x16 & x24));
  assign z15 = new_n57_ | (~x08 & x09 & ~x10 & (new_n83_ | new_n88_));
  assign new_n83_ = x16 & ((new_n86_ & new_n87_) | ((~new_n84_ | ~new_n85_) & x25));
  ...
  assign z16 = (~new_n90_ & x19) | (x07 & x08) | (~x08 & new_n92_ & x09);
  assign new_n90_ = x16 & (~new_n91_ | ~new_n80_ | ~x24 | ~x25 | x26);
  assign new_n91_ = ~x08 & x09 & ~x10 & x20 & x21;
  assign new_n92_ = ~x10 & x26 & (~new_n93_ | ~new_n80_ | ~x24 | ~x25);
