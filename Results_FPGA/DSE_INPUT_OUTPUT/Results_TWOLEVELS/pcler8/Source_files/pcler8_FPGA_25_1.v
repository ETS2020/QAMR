// Benchmark "FAU" written by ABC on Mon Aug 24 16:58:27 2020
...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x09 | ~x19)) | (~x09 & x19) | (new_n62_ & ~x08);
  assign new_n62_ = ~x10 & ((x19 & (x21 ? (new_n63_ | ~x20) : x20)) | (x09 & ~x19 & x21));
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x19 | (~new_n66_ & (~x20 | ~x21 | x22))) & (~x09 | ~x22 | (x19 & x20 & x21));
  assign new_n66_ = x14 & x22 & x23 & x24 & x25 & x26;
  ...
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~new_n71_ & ~x10);
  ...
  assign z15 = z07 | (~x08 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | (~new_n77_ & ~new_n78_)) & (~x09 | new_n79_ | ~x25);
  assign new_n77_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n78_ = x17 & x25 & x26;
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (x19 & (new_n81_ | ~x09)) | (~x08 & new_n83_ & x09);
  assign new_n81_ = new_n82_ & x20 & x21 & ~x08 & ~x10;
  assign new_n82_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | ~new_n85_);
