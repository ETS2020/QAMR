...
module FAU ( 
  ...
  assign z09 = (x00 & ~new_n49_ & x08) | new_n49_ | (~x08 & new_n58_ & x09);
  assign new_n58_ = ~x10 & (~x19 | (new_n59_ & x11 & x21 & x22));
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | new_n62_ | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (x19 | ~x20) & (~new_n59_ | ~x12 | ~x21 | ~x22);
  assign new_n62_ = ~x20 & (x26 | (~x08 & x09 & ~x10 & x19));
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & (x20 ? (x21 ? (new_n65_ | ~x19) : x19) : (x21 & ~x26));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = x20 ? ((~x22 | (x19 & ~new_n68_ & x21)) & (~x19 | ~x21 | x22)) : (~x22 | x26);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x20 | ((x21 | ~x23) & (~x19 | ~x21 | ~x22 | x23))) & (~x23 | (new_n71_ & x19 & x22));
  assign new_n71_ = (x20 | x26) & (~x25 | ~x26 | ~x15 | ~x24);
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = x20 ? ((~new_n74_ | ~new_n76_) & (~x24 | (new_n74_ & new_n75_))) : (~x24 | x26);
  ...
  assign z16 = (x07 & ~new_n49_ & x08) | (~x08 & x09 & new_n82_ & ~x10);
  assign new_n82_ = x20 & ((x26 & (~new_n84_ | ~new_n85_)) | (new_n83_ & new_n86_));
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = ~x18 & x19 & x21;
