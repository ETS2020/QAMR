...
module FAU ( 
  ...
  assign z02 = (x10 & x20) | (x01 & x08 & (~x10 | ~x20));
  assign z03 = (x10 & x20) | (x02 & x08 & (~x10 | ~x20));
  assign z04 = (x10 & x20) | (x03 & x08 & (~x10 | ~x20));
  assign z05 = x04 & x08 & (~x10 | ~x20);
  assign z06 = x05 & x08 & (~x10 | ~x20);
  assign z07 = (x10 & x20) | (x06 & x08);
  assign z08 = (x10 & x20) | (x07 & x08 & (~x10 | ~x20));
  ...
  assign z12 = (~x08 & x09 & ~new_n66_ & ~x10) | (x03 & x08 & (~x10 | ~x20));
  ...
  assign z14 = (x05 & x08 & (~x10 | ~x20)) | (x10 & x20) | (new_n72_ & ~x08);
  assign new_n72_ = x09 & ((x20 & (new_n73_ | new_n74_)) | (new_n75_ & ~x10));
  assign new_n73_ = x19 & x21 & x22 & x23 & ~x24;
  assign new_n74_ = x25 & x26 & x16 & x24;
  assign new_n75_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & x09 & (new_n77_ | new_n79_));
  assign new_n77_ = x20 & (new_n78_ | (x17 & x25 & x26));
  assign new_n78_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n79_ = ~x10 & x25 & (~new_n80_ | ~x19 | ~x20 | ~x21);
  assign new_n80_ = x22 & x23 & x24;
  assign z16 = (~x08 & x09 & ~new_n82_ & ~x10) | (x07 & x08 & (~x10 | ~x20));
  assign new_n82_ = (~new_n85_ | ~new_n86_) & (~x26 | (new_n83_ & new_n84_));
