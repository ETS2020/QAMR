...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n64_ & ~x08))) | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x21 & (new_n63_ | ~x20)) | (x19 & x20 & ~x21));
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n64_ = ~x10 & x21;
  ...
  assign z16 = (~x19 & (~x09 | (new_n90_ & ~x08))) | (x07 & x08) | (~x08 & new_n85_ & x09);
