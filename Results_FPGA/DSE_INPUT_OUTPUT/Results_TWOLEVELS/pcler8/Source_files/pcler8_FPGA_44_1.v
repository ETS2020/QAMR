...
module FAU ( 
  ...
  assign new_n62_ = x19 ? (x20 & (~new_n60_ | ~new_n63_)) : (~x20 | x25);
  ...
  assign new_n79_ = ~x19 & (x25 | (~x08 & x09 & ~x10 & x24));
  ...
  assign new_n84_ = (~x19 | ((new_n86_ | ~x26) & (~new_n82_ | ~new_n85_ | ~x25 | x26))) & (x25 | ~x26);
