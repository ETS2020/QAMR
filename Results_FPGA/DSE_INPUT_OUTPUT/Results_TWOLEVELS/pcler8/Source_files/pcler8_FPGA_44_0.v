...
module FAU ( 
  ...
  assign new_n47_ = x21 & x22 & x23 & new_n48_ & x24;
  ...
  assign z08 = new_n59_ | new_n49_;
  assign new_n59_ = x07 & ~new_n49_ & x08;
  ...
  assign new_n64_ = x20 ? (~x25 | (x19 & (~new_n65_ | ~new_n62_ | ~x12))) : ~x19;
  assign new_n65_ = x23 & x24 & x26;
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x19 & (x20 ^ x21)) | (x21 & x25 & (new_n68_ | ~x19)));
  ...
  assign new_n72_ = ~x19 & (~x25 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n78_ = (~x24 | (new_n79_ & x22 & ~new_n80_ & x23)) & (~new_n79_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n79_ = x20 & x21;
  assign new_n80_ = x16 & x25 & x26;
  assign new_n81_ = ~x19 & (~x25 | (~x08 & x09 & ~x10 & x24 & x25));
  assign z15 = z07 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (new_n84_ | ~x24) & (~x25 | (new_n85_ & new_n86_));
  assign new_n84_ = (x19 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x25);
  assign new_n85_ = x20 & x21 & x22;
  assign new_n86_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n59_ | (~x08 & x09 & ~x10 & (new_n88_ | new_n89_));
  assign new_n88_ = x19 & ((~x25 & x26) | (new_n85_ & x23 & x24 & x25 & ~x26));
  assign new_n89_ = x25 & x26 & (~new_n90_ | ~new_n50_ | x18);
  assign new_n90_ = x23 & x24 & x21 & x22;
endmodule
