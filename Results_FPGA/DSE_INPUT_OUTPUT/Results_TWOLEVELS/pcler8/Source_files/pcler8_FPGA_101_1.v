...
module FAU ( 
  ...
  assign new_n67_ = ~x10 & ((x22 & (~new_n68_ | new_n69_ | ~x21)) | (new_n68_ & x21 & ~x22));
  assign new_n68_ = x19 & x20;
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x23 | (new_n68_ & x21 & ~new_n72_ & x22)) & (~new_n68_ | ~x21 | ~x22 | x23);
  ...
  assign z15 = new_n79_ | (~new_n50_ & (x08 ? x06 : (new_n78_ & x09)));
  assign new_n78_ = ~x10 & ((x25 & (~new_n75_ | ~x22 | ~x23 | ~x24)) | (new_n75_ & x22 & x23 & x24 & ~x25));
  assign new_n79_ = new_n80_ & new_n68_ & x17 & ~x08 & x09 & ~x10;
  assign new_n80_ = x21 & x22 & x23 & x24 & x25 & x26;
  assign z16 = (~new_n82_ & ~new_n50_) | (~x08 & new_n84_ & x09);
  assign new_n82_ = (~x07 | ~x08) & (~new_n83_ | x08 | ~x09 | ~new_n68_ | x10);
  assign new_n83_ = x21 & x22 & x23 & x24 & x25 & ~x26;
  assign new_n84_ = ~x10 & x26 & (x18 ? x17 : (~new_n75_ | ~new_n85_));
