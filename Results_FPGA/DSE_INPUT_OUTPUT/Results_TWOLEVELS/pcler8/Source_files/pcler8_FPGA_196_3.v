...
module FAU ( 
  ...
  assign new_n65_ = (x15 | ((~x19 | x20) & (~new_n63_ | ~new_n62_ | ~x12 | ~x20))) & (x19 | ~x20);
  ...
  assign new_n74_ = (x15 | (((x20 & x21 & x22) | ~x23) & (~x19 | ~x20 | ~x21 | ~x22 | x23))) & (x19 | ~x23);
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (x19 | ~x24) & (x15 | (((new_n77_ & new_n78_) | ~x24) & (~new_n79_ | ~new_n77_ | ~x19)));
  assign new_n77_ = x20 & x21;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = new_n58_ | (~x08 & x09 & ~x10 & (new_n81_ | new_n86_));
  ...
  assign z16 = (~new_n88_ & x19) | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n88_ = ~x15 & (~new_n48_ | ~new_n49_ | ~x24 | ~x25 | x26);
