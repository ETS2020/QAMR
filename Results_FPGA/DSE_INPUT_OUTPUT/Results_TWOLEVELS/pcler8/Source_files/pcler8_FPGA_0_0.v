...
module FAU ( 
  ...
  assign new_n63_ = ~x19 & (~x07 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (x07 | x19)) | (~x19 & (new_n67_ | ~x07)) | (new_n65_ & ~x08);
  ...
  assign new_n71_ = ~x19 & (~x07 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x19 | ((~x23 | (new_n74_ & ~new_n75_ & x22)) & (~new_n74_ | ~x22 | x23))) & (~x07 | x19 | ~x23);
  ...
  assign new_n79_ = ~x19 & (~x07 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x19 | ((~new_n82_ | ~new_n84_) & (~x25 | (new_n82_ & new_n83_)))) & (~x07 | x19 | ~x25);
  assign new_n82_ = x20 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x23 & x24 & ~x25;
  assign z16 = (x07 & x08) | (~x08 & new_n86_ & x09) | (~x19 & (~x07 | (new_n91_ & x09)));
