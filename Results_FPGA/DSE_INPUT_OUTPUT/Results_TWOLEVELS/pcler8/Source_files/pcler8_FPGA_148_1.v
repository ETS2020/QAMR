...
module FAU ( 
  ...
  assign new_n63_ = (~x13 | ~x19 | ((~new_n61_ | ~new_n64_) & x20)) & (x19 | ~x20);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = (x02 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x19 | ~x20 | (x21 & (~new_n61_ | ~x13 | ~x21 | ~x22))) & (~x21 | (x19 & x20));
  ...
  assign new_n71_ = (~x13 | (~new_n74_ & ((new_n72_ & new_n73_) | ~x23))) & (x19 | ~x23);
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n74_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~x10 & (new_n76_ | new_n79_));
  assign new_n76_ = x13 & (new_n78_ | (x19 & x22 & ~new_n77_ & x23));
  assign new_n77_ = (~x20 | ~x21 | x24) & (~x25 | ~x26 | ~x16 | ~x24);
  assign new_n78_ = x24 & (~x20 | ~x21 | ~x22 | ~x23);
  assign new_n79_ = ~x19 & x24;
  assign z15 = (x06 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x19 | ~x22 | ~new_n82_ | ~x23) & (new_n83_ | ~x25);
  assign new_n82_ = x24 & ((x20 & x21 & ~x25) | (x17 & x25 & x26));
  assign new_n83_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = new_n58_ | (~x08 & x09 & ~x10 & (new_n85_ | new_n90_));
  assign new_n85_ = x13 & ((new_n88_ & new_n89_) | ((~new_n86_ | ~new_n87_) & x26));
