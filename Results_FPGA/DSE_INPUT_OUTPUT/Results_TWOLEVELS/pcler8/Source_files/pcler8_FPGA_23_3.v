...
module FAU ( 
  ...
  assign new_n65_ = (x17 | ~x19 | (x20 & (~new_n63_ | ~new_n62_ | ~x12))) & (x19 | ~x20);
  assign z11 = (~new_n67_ & x19) | (x02 & x08) | (~x08 & new_n68_ & x09);
  assign new_n67_ = ~x17 & (~new_n47_ | x10 | ~x20 | x21);
  assign new_n68_ = ~x10 & x21 & (~x19 | new_n69_ | (~x17 & ~x20));
  ...
  assign z14 = (x19 & (new_n78_ | x17)) | (new_n79_ & ~x08) | (x05 & x08);
  assign new_n78_ = new_n47_ & ~x10 & x20 & new_n62_ & x23 & ~x24;
  assign new_n79_ = x09 & ~x10 & x24 & (~new_n80_ | ~new_n81_);
  assign new_n80_ = x19 & x20 & x21;
  assign new_n81_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x06 & ~new_n51_ & x08) | (~x08 & new_n83_ & x09);
  assign new_n83_ = ~x10 & (new_n86_ | (~x17 & (new_n84_ | (new_n80_ & new_n85_))));
