...
module FAU ( 
  ...
  assign new_n66_ = ~x10 & (x19 ? (x21 ? (new_n67_ | ~x20) : x20) : (x21 & ~x25));
  ...
  assign new_n71_ = ~x19 & (x25 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n75_ | (~x08 & x09 & ~new_n73_ & ~x10) | (x04 & x08);
  assign new_n73_ = (~x23 | (x20 & x21 & ~new_n74_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign new_n75_ = ~x19 & (x25 | (~x08 & x09 & ~x10 & x23));
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  ...
  assign z16 = (x07 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n87_ & ~x10);
  assign new_n87_ = (~x25 | ((~x18 | ~x26) & (~new_n82_ | ~x23 | ~x24 | x26))) & (~x26 | (new_n82_ & x23 & x24 & x25));
endmodule
