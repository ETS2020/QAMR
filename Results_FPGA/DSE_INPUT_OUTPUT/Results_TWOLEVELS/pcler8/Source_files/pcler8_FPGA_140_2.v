...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x05 | x20)) | (~x20 & (new_n66_ | x05)) | (new_n64_ & ~x08);
  ...
  assign new_n70_ = ~x20 & (x05 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x20 | ((~x23 | (new_n73_ & ~new_n74_ & x22)) & (~new_n73_ | ~x22 | x23))) & (x05 | x20 | ~x23);
  assign new_n73_ = x19 & x21;
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & (~x20 | (x08 & x20))) | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & ((~new_n77_ & x20) | (x24 & (~new_n78_ | ~x19 | ~x20)));
  assign new_n77_ = (x22 | ~x24) & (~x19 | ~x21 | ~x22 | ~x23 | x24);
  ...
  assign new_n81_ = x20 & (~x22 | (x17 & x26));
  assign new_n82_ = x19 & x21 & x23 & x24;
  assign new_n83_ = x19 & x20 & x21;
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign new_n85_ = ~x20 & (x05 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n92_ = ~x20 & (x05 | (~x08 & x09 & ~x10 & x26));
endmodule
