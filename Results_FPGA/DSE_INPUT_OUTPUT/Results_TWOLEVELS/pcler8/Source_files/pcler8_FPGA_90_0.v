...
module FAU ( 
  ...
  assign new_n69_ = x26 & (~x19 | (x24 & x25 & x14 & x23));
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x23 | (~new_n72_ & (~x19 | (x20 & x21 & x22)))) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n72_ = x26 & (~x19 | (x15 & x24 & x25));
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x24 | (~new_n76_ & (~x19 | (new_n75_ & x22 & x23)))) & (~new_n75_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n75_ = x20 & x21;
  assign new_n76_ = x26 & (~x19 | (x16 & x25));
  assign z15 = z07 | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((x25 & (new_n80_ | new_n81_)) | (new_n79_ & new_n82_));
  assign new_n79_ = x19 & x20 & x21;
  assign new_n80_ = x26 & (x17 | ~x19);
  assign new_n81_ = x19 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n82_ = x22 & x23 & x24 & ~x25;
  assign z16 = new_n89_ | (x07 & x08) | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((new_n85_ & new_n88_) | ((~new_n86_ | ~new_n87_) & x26));
  assign new_n85_ = x20 & x21 & x22;
  assign new_n86_ = ~x18 & x20 & x21;
  assign new_n87_ = x24 & x25 & x22 & x23;
  assign new_n88_ = x23 & x24 & x25 & ~x26;
  assign new_n89_ = ~x19 & (~x26 | (~x08 & x09 & ~x10));
endmodule
