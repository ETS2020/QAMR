...
module FAU ( 
  ...
  assign new_n69_ = x19 & ((x22 & (~x20 | new_n70_ | ~x21)) | (x20 & x21 & ~x22));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign new_n71_ = ~x19 & x22;
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x19 | ((x21 | ~x23) & (~x20 | ~x21 | ~x22 | x23))) & (~x23 | (x19 & x20 & ~new_n74_ & x22));
  ...
  assign new_n87_ = ~x10 & ((x26 & (~new_n89_ | ~new_n90_)) | (new_n88_ & new_n91_));
