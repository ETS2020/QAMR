...
module FAU ( 
  ...
  assign new_n59_ = new_n48_ & new_n49_ & new_n60_ & x11 & x19;
  ...
  assign new_n64_ = x25 & x26 & x23 & x24;
  ...
  assign z13 = (x04 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n71_ & ~x10);
  assign new_n71_ = ~new_n73_ & (~x19 | (~new_n72_ & (~new_n60_ | ~x22 | x23)));
  ...
  assign z16 = (x19 & (new_n84_ | ~x09)) | (x07 & x08) | (~x08 & new_n85_ & x09);
  assign new_n84_ = new_n47_ & new_n48_ & x24 & x25 & ~x26;
  assign new_n85_ = ~x10 & x26 & (~new_n86_ | ~new_n60_ | x18 | ~x19);
