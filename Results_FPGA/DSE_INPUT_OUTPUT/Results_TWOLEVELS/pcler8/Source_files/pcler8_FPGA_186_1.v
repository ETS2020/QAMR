...
module FAU ( 
  ...
  assign new_n64_ = (~x21 | (x20 & (~new_n66_ | ~new_n65_ | ~x13))) & (~x19 | ~x20 | x21);
  assign new_n65_ = x22 & x23;
  assign new_n66_ = x24 & x25 & x26;
  assign z12 = (~new_n70_ & x21) | (x03 & x08) | (new_n68_ & ~x08);
  assign new_n68_ = x09 & ~x10 & x22 & (~new_n69_ | ~x20);
  assign new_n69_ = x21 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n70_ = x19 & (x08 | ~x09 | x10 | ~x20 | x22);
  assign z13 = z05 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x19 | ((~x23 | (x20 & ~new_n73_ & x22)) & (~x20 | ~x21 | ~x22 | x23))) & (x21 | ~x23);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & new_n75_ & x09);
  assign new_n75_ = ~x10 & ((x19 & (new_n77_ | (~new_n76_ & x24))) | (~x21 & x24));
  assign new_n76_ = x20 & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | new_n79_ | (~x08 & new_n80_ & x09);
  assign new_n79_ = x21 & (~x19 | (new_n47_ & new_n65_ & x24 & ~x25));
  assign new_n80_ = ~x10 & x25 & (~new_n81_ | ~x20 | ~x21 | ~x22);
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n83_ & x21) | (x07 & x08) | (~x08 & new_n84_ & x09);
  assign new_n83_ = x19 & (~new_n47_ | ~new_n65_ | ~x24 | ~x25 | x26);
  assign new_n84_ = ~x10 & x26 & (~new_n85_ | x18 | ~x20 | ~x21);
