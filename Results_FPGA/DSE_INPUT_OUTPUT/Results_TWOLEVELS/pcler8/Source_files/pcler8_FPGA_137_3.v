...
module FAU ( 
  ...
  assign z00 = x19 & (new_n47_ | x06);
  assign new_n47_ = new_n49_ & ~x08 & x09 & new_n48_ & ~x10;
  assign new_n48_ = x20 & x21;
  assign new_n49_ = x22 & x23 & x24 & x25 & x26;
  assign z01 = (x06 & x19) | (x00 & x08);
  assign z02 = (x06 & x19) | (x01 & x08);
  assign z03 = x02 & x08 & (~x06 | ~x19);
  assign z04 = (x06 & x19) | (x03 & x08);
  assign z05 = x04 & x08 & (~x06 | ~x19);
  assign z06 = x05 & x08 & (~x06 | ~x19);
  ...
  assign z10 = new_n63_ | (x01 & x08) | (~x08 & x09 & new_n62_ & ~x10);
  assign new_n62_ = x20 & (~x19 | (new_n60_ & x12 & x21 & x22));
  assign new_n63_ = x19 & (x06 | (~x08 & x09 & ~x10 & ~x20));
  assign z11 = (x02 & x08 & (~x06 | ~x19)) | (new_n65_ & ~x08) | (x19 & (new_n67_ | x06));
  assign new_n65_ = x09 & ~x10 & x21 & (~x19 | new_n66_ | ~x20);
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n67_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign z12 = (x19 & (new_n71_ | x06)) | (new_n69_ & ~x08) | (x03 & x08);
  ...
  assign new_n73_ = x09 & ~x10 & ((~new_n74_ & ~x06) | (~x19 & x23));
  assign new_n74_ = (~x23 | (x20 & x21 & ~new_n75_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (new_n77_ & ~x08);
  assign new_n77_ = x09 & ~x10 & ((~new_n78_ & ~x06) | (~x19 & x24));
  assign new_n78_ = (~x24 | (new_n48_ & x22 & ~new_n79_ & x23)) & (~new_n48_ | ~x19 | ~x22 | ~x23 | x24);
  ...
  assign new_n84_ = new_n48_ & x19 & x22 & x23 & x24;
  assign z16 = (x07 & x08 & (~x06 | ~x19)) | (~x08 & new_n86_ & x09);
  assign new_n86_ = ~x10 & ((~x19 & x26) | (~x06 & ((~new_n87_ & x19) | (~new_n88_ & x26))));
  assign new_n87_ = (~x18 | ~x26) & (~new_n83_ | ~x23 | ~x24 | ~x25 | x26);
