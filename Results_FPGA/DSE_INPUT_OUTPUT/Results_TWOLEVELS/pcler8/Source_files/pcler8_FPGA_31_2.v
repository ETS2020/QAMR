...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((x23 & ((x19 & (new_n65_ | (x20 & ~x21))) | (~x20 & x21))) | (~x19 & x21));
  assign new_n65_ = x13 & x21 & x22 & x24 & x25 & x26;
  assign z12 = (x03 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x19 | ((~x20 | ~x21 | x22) & (~new_n62_ | ~x14 | ~x22))) & (~x22 | (x19 & x20 & x21));
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = x19 ? (~new_n70_ & x20 & (~x20 | (x21 ? x22 : ~x23))) : ~x23;
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (x19 | ~x24) & (~x23 | ((~x19 | (~new_n73_ & ~new_n74_)) & (new_n75_ | ~x24)));
  assign new_n73_ = x20 & x21 & x22 & ~x24;
  ...
  assign new_n79_ = x19 & x20 & x21 & x22 & x24;
  assign z16 = z08 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x19 | ~x26) & (~x23 | ((new_n83_ | ~x26) & (~new_n84_ | ~new_n82_ | ~x19)));
