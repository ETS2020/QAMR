...
module FAU ( 
  ...
  assign new_n67_ = ~x19 & (~x11 | (~x08 & x09 & ~x10 & x21));
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x19 | ((~x22 | (x20 & ~new_n70_ & x21)) & (~x20 | ~x21 | x22))) & (~x11 | x19 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x19 | ((~x23 | (new_n73_ & ~new_n74_ & x22)) & (~new_n73_ | ~x22 | x23))) & (~x11 | x19 | ~x23);
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | ((~x24 | (new_n73_ & new_n77_)) & (~new_n73_ | ~new_n78_))) & (~x11 | x19 | ~x24);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = new_n83_ | (x06 & x08) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x25 | (new_n59_ & new_n81_)) & (~new_n82_ | ~new_n73_ | ~x19);
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x22 & x23 & x24 & ~x25;
  assign new_n83_ = ~x19 & (~x11 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n85_ | new_n89_));
  assign new_n85_ = x19 & ((new_n59_ & new_n88_) | (x26 & (~new_n86_ | ~new_n87_)));
