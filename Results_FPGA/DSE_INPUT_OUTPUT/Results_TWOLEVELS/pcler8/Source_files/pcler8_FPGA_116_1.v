...
module FAU ( 
  ...
  assign z07 = (~x19 & x22) | (x06 & x08 & (x19 | ~x22));
  ...
  assign new_n71_ = (x22 | ~x23) & (~x19 | ((~x20 | ~x21 | ~x22 | x23) & (~x23 | (x20 & ~new_n72_ & x21))));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x22 & (new_n74_ | ~x19)) | (x05 & x08) | (new_n75_ & ~x08);
  assign new_n74_ = ~x08 & x09 & ~x10 & new_n60_ & x23 & ~x24;
  assign new_n75_ = x09 & ~x10 & x24 & (~new_n60_ | ~new_n76_);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (new_n50_ & x06) | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((~x22 & x25) | (x19 & (new_n80_ | (~new_n79_ & x25))));
  assign new_n79_ = x20 & x21 & x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x22 | ~x26) & (~x19 | ((new_n84_ | ~x26) & (~new_n83_ | ~new_n85_)));
  assign new_n83_ = x20 & x21 & x22;
  assign new_n84_ = x23 & x24 & x25 & ~x18 & x20 & x21;
