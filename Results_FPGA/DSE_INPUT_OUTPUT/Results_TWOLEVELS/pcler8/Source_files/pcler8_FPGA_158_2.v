...
module FAU ( 
  ...
  assign new_n58_ = (x19 | (x20 & (~x20 | ~x22))) & (~new_n59_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = x20 ? (~new_n62_ & (x19 | ~x22)) : ~x19;
  assign new_n62_ = x12 & x21 & x23 & x24 & x25 & x26;
  assign z11 = (~new_n66_ & x20) | (x02 & x08) | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & x21 & (~new_n65_ | ~x19);
  assign new_n65_ = x20 & (~x24 | ~x25 | ~x26 | ~x13 | ~x23);
  assign new_n66_ = x22 & (x08 | ~x09 | x10 | ~x19 | x21 | ~x22);
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & x22 & (~x20 | (x20 & (~x19 | new_n69_ | (x19 & ~x21))));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (new_n71_ & ~x08) | (x20 & (new_n73_ | ~x22));
  assign new_n71_ = x09 & ~x10 & x23 & (~new_n72_ | ~x19 | ~x20);
  assign new_n72_ = x21 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n73_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x23;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x22 | ((~x20 | (~new_n76_ & ~new_n77_)) & (new_n78_ | ~x24))) & (x20 | ~x24);
  assign new_n76_ = x19 & x21 & x23 & ~x24;
  assign new_n77_ = x16 & x24 & x25 & x26;
  assign new_n78_ = x19 & x21 & x23;
  assign z15 = (x06 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x22 | ((~x20 | (~new_n81_ & ~new_n82_)) & (new_n83_ | ~x25))) & (x20 | ~x25);
  assign new_n81_ = x19 & x21 & x23 & x24 & ~x25;
  assign new_n82_ = x17 & x25 & x26;
  assign new_n83_ = x19 & x21 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~new_n85_ & ~x10);
  assign new_n85_ = (x20 | ~x26) & (~x22 | ((~new_n87_ | ~new_n88_) & (new_n86_ | ~x26)));
  assign new_n86_ = x23 & x24 & x25 & ~x18 & x19 & x21;
