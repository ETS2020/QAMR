...
module FAU ( 
  ...
  assign z10 = z02 | new_n62_ | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & (~x20 | (new_n59_ & x12 & x21 & x22));
  assign new_n62_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (x19 | x20)) | (~x19 & (new_n66_ | ~x20)) | (new_n64_ & ~x08);
  ...
  assign new_n70_ = ~x19 & (~x20 | (~x08 & x09 & ~x10 & x22));
