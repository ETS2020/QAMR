...
module FAU ( 
  ...
  assign z13 = z05 | (~x08 & ~x10 & (new_n70_ | (~new_n69_ & x19)));
  assign new_n69_ = (~x20 | ~x21 | ~x22 | x23) & (~new_n49_ | ~x15 | ~x23);
  assign new_n70_ = x09 & x23 & (~new_n67_ | ~x21 | ~x22);
  ...
  assign z16 = (x19 & (new_n78_ | ~x09)) | (x07 & x08) | (~x08 & new_n79_ & x09);
  assign new_n78_ = new_n47_ & new_n48_ & x24 & x25 & ~x26;
  assign new_n79_ = ~x10 & x26 & (~new_n80_ | ~new_n48_ | ~x24 | ~x25);
