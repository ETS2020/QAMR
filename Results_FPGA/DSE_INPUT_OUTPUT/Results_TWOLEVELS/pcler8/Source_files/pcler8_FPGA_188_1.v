...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~new_n62_ & ~x10);
  ...
  assign z13 = z05 | (~x08 & ~x10 & (new_n71_ | (~new_n69_ & x19)));
  assign new_n69_ = (~new_n70_ | ~x22 | x23) & (~new_n64_ | ~x09 | ~x15 | ~x23);
  assign new_n70_ = x20 & x21;
  assign new_n71_ = x09 & ~new_n72_ & x23;
  assign new_n72_ = x19 & x20 & x21 & x22;
  assign z14 = z06 | (~x08 & ~new_n74_ & ~x10);
  assign new_n74_ = (~new_n76_ | ~x09) & (~x19 | (~new_n75_ & (~new_n64_ | ~x09 | ~x16)));
  assign new_n75_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n76_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & ~x10 & (new_n78_ | (new_n80_ & x09)));
  assign new_n78_ = x19 & (new_n79_ | (x09 & x17 & x25 & x26));
  assign new_n79_ = x23 & x24 & ~x25 & x20 & x21 & x22;
  assign new_n80_ = x25 & (~new_n70_ | ~x19 | ~x22 | ~x23 | ~x24);
  assign z16 = z08 | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((new_n72_ & new_n85_) | (x26 & (~new_n83_ | ~new_n84_)));
