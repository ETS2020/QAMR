...
module FAU ( 
  ...
  assign new_n61_ = x20 & (~new_n63_ | ~x12 | ~new_n62_ | ~x23 | ~x24);
  ...
  assign z14 = (x05 & x08 & (~x09 | x19)) | (x09 & (~x19 | (~x08 & ~new_n72_ & ~x10)));
  assign new_n72_ = (~x24 | (~new_n73_ & x20 & x23)) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n73_ = x19 & (~x21 | ~x22 | (x16 & x25 & x26));
  assign z15 = (x06 & x08) | (x09 & (~x19 | (~x08 & ~new_n75_ & ~x10)));
  assign new_n75_ = (~x25 | (~new_n76_ & x20 & x23 & x24)) & (~x23 | ~x24 | x25 | ~new_n63_ | ~x20);
  assign new_n76_ = x19 & (~x21 | ~x22 | (x17 & x26));
  assign z16 = z08 | (~x08 & x09 & new_n78_ & ~x10);
  assign new_n78_ = x19 & ((x26 & (~new_n80_ | ~new_n81_)) | (new_n79_ & new_n82_));
