...
module FAU ( 
  ...
  assign z11 = (x02 & (x08 | (x09 & new_n66_ & ~x10))) | (~x08 & x09 & new_n68_ & ~x10);
  assign new_n66_ = x19 & (x21 ? (new_n67_ | ~x20) : x20);
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n68_ = ~x19 & x21;
  assign z12 = (x03 & ~new_n50_ & x08) | new_n50_ | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x19 & (new_n71_ | (x20 & x21 & ~x22))) | (x22 & (~x19 | ~x20 | ~x21)));
  assign new_n71_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x02 | ((~x19 | (~new_n74_ & ~new_n75_)) & (new_n76_ | ~x23))) & (x19 | ~x23);
  ...
  assign new_n78_ = (new_n81_ | ~x24) & (~x19 | (~new_n80_ & (~new_n79_ | ~x16 | ~x24)));
  ...
  assign new_n83_ = (~x02 | ((~x19 | (~new_n84_ & ~new_n85_)) & (new_n86_ | ~x25))) & (x19 | ~x25);
  assign new_n84_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n85_ = x17 & x25 & x26;
  assign new_n86_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~new_n88_ & x19) | (~x08 & new_n90_ & x09);
  assign new_n88_ = x02 & (~new_n89_ | ~new_n60_ | x10 | x08 | ~x09);
