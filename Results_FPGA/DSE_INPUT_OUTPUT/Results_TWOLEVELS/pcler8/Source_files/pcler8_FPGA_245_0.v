...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n60_, new_n61_, new_n63_,
    ...
    new_n91_, new_n92_;
  assign z00 = (~x12 & ~x19) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign z09 = (x00 & x08 & (x12 | x19)) | (~x12 & ~x19) | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & (~x19 | (new_n60_ & new_n61_));
  assign new_n60_ = x11 & x20 & x21 & x22;
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & ((x12 & x20 & (new_n48_ | ~x19)) | (x19 & ~x20));
  assign z11 = new_n65_ | (x02 & x08) | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n65_ = ~x19 & (~x12 | (new_n47_ & ~x10 & x21));
  assign new_n66_ = (~x21 | (~new_n67_ & x20)) & (~x19 | ~x20 | x21);
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | new_n69_ | (~x08 & new_n70_ & x09);
  assign new_n69_ = ~x19 & (~x12 | (new_n47_ & ~x10 & x22));
  ...
  assign new_n73_ = ~x19 & (~x12 | (new_n47_ & ~x10 & x23));
  ...
  assign new_n77_ = (~x19 | ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_))) & (~x12 | x19 | ~x24);
  assign new_n78_ = x20 & x21;
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = z07 | new_n82_ | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n82_ = ~x19 & (~x12 | (new_n47_ & ~x10 & x25));
  assign new_n83_ = (~x25 | (new_n84_ & new_n85_)) & (~new_n86_ | ~new_n78_ | ~x19);
  ...
  assign new_n88_ = x19 & ((new_n84_ & new_n91_) | (x26 & (~new_n89_ | ~new_n90_)));
