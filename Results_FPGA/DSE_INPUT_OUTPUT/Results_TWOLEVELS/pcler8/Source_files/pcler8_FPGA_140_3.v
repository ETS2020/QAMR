...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x05 | ~x20)) | (x20 & (new_n67_ | x05)) | (new_n65_ & ~x08);
  ...
  assign new_n73_ = (x05 | (~new_n76_ & ((new_n74_ & new_n75_) | ~x23))) & (x20 | ~x23);
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n76_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (x05 & (x20 | (x08 & ~x20))) | (~x08 & new_n78_ & x09);
  ...
  assign z15 = (~new_n82_ & ~x05) | ~new_n84_ | (x20 & (x05 | (new_n87_ & new_n88_)));
  assign new_n82_ = (~x06 | ~x08) & (~new_n83_ | x08 | ~x09 | x10);
  assign new_n83_ = x17 & x20 & x25 & x26;
  assign new_n84_ = ~new_n85_ & (x08 | ~x09 | ~new_n86_ | x10);
  assign new_n85_ = ~x20 & ((x06 & x08) | (~x08 & x09 & ~x10 & x25));
  assign new_n86_ = x25 & (~x19 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n87_ = ~x08 & x09 & ~x10 & x19;
  assign new_n88_ = x21 & x22 & x23 & x24 & ~x25;
  assign z16 = z08 | new_n92_ | (x20 & (new_n90_ | x05));
  assign new_n90_ = new_n91_ & new_n74_ & ~x10 & ~x08 & x09;
  assign new_n91_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n92_ = ~x08 & x09 & ~x10 & (~new_n93_ | ~new_n94_) & x26;
  assign new_n93_ = x20 & x21 & ~x18 & x19;
