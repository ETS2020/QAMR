...
module FAU ( 
  ...
  assign z09 = (x00 & ~new_n47_ & x08) | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & ((~x13 & ~x19) | (new_n61_ & new_n60_ & x11 & x19));
  assign new_n60_ = x20 & x21;
  assign new_n61_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x19 & (~x20 | (new_n64_ & new_n65_))) | (~x13 & ~x19 & x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (~new_n67_ & x13) | (x02 & x08) | (new_n68_ & ~x08);
  assign new_n67_ = x19 & (~new_n61_ | x08 | ~x09 | x10 | ~x21);
  assign new_n68_ = x09 & ~x10 & ((x21 & (~x19 | ~x20)) | (x19 & x20 & ~x21));
  assign z12 = new_n72_ | (~x08 & new_n70_ & x09) | (x03 & x08);
  ...
  assign new_n74_ = (~x19 | ((~x23 | (new_n60_ & ~new_n75_ & x22)) & (~new_n60_ | ~x22 | x23))) & (x13 | x19 | ~x23);
  ...
  assign new_n88_ = ~x10 & ((x26 & (~new_n89_ | ~new_n90_)) | (new_n91_ & new_n92_));
