...
module FAU ( 
  ...
  assign z09 = (x10 & x19) | (x00 & x08) | (~x08 & x09 & (new_n57_ | (~x10 & ~x19)));
  ...
  assign z15 = (x06 & x08 & (~x10 | ~x19)) | (~x08 & x09 & ~new_n79_ & ~x10);
  ...
  assign new_n83_ = ~x10 & (~new_n84_ | ~new_n58_ | x08 | ~x09);
