...
module FAU ( 
  ...
  assign new_n70_ = ~x19 & (~x25 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n74_ = ~x19 & (~x25 | (~x08 & x09 & ~x10 & x23));
  ...
  assign z16 = z08 | new_n88_ | (~x08 & new_n83_ & x09);
