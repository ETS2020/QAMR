...
module FAU ( 
  ...
  assign z09 = (x00 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n60_ & ~x10);
  ...
  assign new_n65_ = ~x10 & ((x21 & (~x19 | new_n66_ | ~x20)) | (x11 & x19 & x20 & ~x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x21 | ((~x22 | (x19 & ~new_n69_ & x20)) & (~x19 | ~x20 | x22))) & (~x11 | x21 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n73_ | (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & x08);
  assign new_n71_ = (~x23 | (new_n50_ & ~new_n72_ & x22)) & (~new_n50_ | ~x21 | ~x22 | x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = ~x21 & (~x11 | (~x08 & x09 & ~x10 & x11 & x23));
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x21 | ((~x24 | (new_n50_ & new_n76_)) & (~new_n50_ | ~new_n77_))) & (~x11 | x21 | ~x24);
