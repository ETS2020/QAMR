...
module FAU ( 
  ...
  assign z00 = x21 & (~x19 | (new_n47_ & new_n48_ & x22 & x23));
  ...
  assign z10 = (x01 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = x19 ? (x20 & (~new_n60_ | ~x12 | ~x21 | ~x22)) : (~x20 | x21);
  assign z11 = z03 | (~x08 & x09 & ~x10 & ~new_n64_ & x19);
  assign new_n64_ = x21 ? (x20 & (~new_n48_ | ~x13 | ~x22 | ~x23)) : ~x20;
  assign z12 = (~new_n68_ & x21) | (x03 & x08) | (new_n66_ & ~x08);
  assign new_n66_ = x09 & ~x10 & x22 & (~new_n67_ | ~x20);
  assign new_n67_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n68_ = x19 & (x08 | ~x09 | x10 | ~x20 | x22);
  assign z13 = (x04 & x08) | (new_n70_ & ~x08) | (x21 & (new_n72_ | ~x19));
  assign new_n70_ = x09 & ~x10 & x23 & (~new_n71_ | ~x20 | ~x21);
  assign new_n71_ = x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n72_ = ~x08 & x09 & ~x10 & x20 & x22 & ~x23;
  assign z14 = (x05 & x08 & (x19 | ~x21)) | (x21 & (new_n74_ | ~x19)) | (new_n76_ & ~x08);
  assign new_n74_ = new_n75_ & ~x08 & x09 & ~x10;
  ...
  assign new_n83_ = (x21 | ~x26) & (~x19 | ((new_n85_ | ~x26) & (~new_n84_ | ~new_n86_)));
  assign new_n84_ = x20 & x21 & x22;
  assign new_n85_ = x23 & x24 & x25 & ~x18 & x20 & x22;
