// Benchmark "FAU" written by ABC on Mon Aug 24 16:58:55 2020
...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (x09 & (new_n58_ | ~x19));
  assign new_n58_ = new_n48_ & ~x08 & ~x10 & new_n47_ & x11;
  assign z10 = (x01 & x08 & (~x09 | x19)) | (x09 & (~x19 | (~x08 & ~new_n60_ & ~x10)));
  ...
  assign new_n68_ = (~x23 | (new_n47_ & x22 & (~new_n69_ | ~x15 | ~x24))) & (~new_n47_ | ~x22 | x23);
  assign new_n69_ = x25 & x26;
  assign z14 = (x05 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n71_ & x19);
  assign new_n71_ = (~x24 | (new_n47_ & x22 & x23 & (~new_n69_ | ~x16))) & (~new_n47_ | ~x22 | ~x23 | x24);
  assign z15 = (x06 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n73_ & x19);
  assign new_n73_ = (~x25 | (new_n74_ & x23 & x24 & (~x17 | ~x26))) & (~new_n74_ | ~x23 | ~x24 | x25);
  assign new_n74_ = x20 & x21 & x22;
  assign z16 = (x07 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n76_ & x19);
  assign new_n76_ = (~x26 | (new_n77_ & new_n47_ & ~x18)) & (~new_n74_ | ~new_n78_);
