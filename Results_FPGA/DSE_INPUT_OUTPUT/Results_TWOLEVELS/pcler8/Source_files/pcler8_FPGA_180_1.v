...
module FAU ( 
  ...
  assign z13 = (x19 & (new_n72_ | ~x18)) | (x04 & x08) | (new_n73_ & ~x08);
  ...
  assign new_n76_ = (~x18 | (((new_n48_ & new_n77_) | ~x24) & (~new_n78_ | ~new_n48_ | ~x19))) & (x19 | ~x24);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (x18 | ~x19)) | (x19 & (new_n80_ | ~x18)) | (new_n82_ & ~x08);
  assign new_n80_ = new_n81_ & ~x10 & x20 & ~x08 & x09;
  assign new_n81_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = x09 & ~x10 & x25 & (~new_n83_ | ~new_n48_ | ~x19);
  assign new_n83_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n85_ | x26));
  assign new_n85_ = new_n48_ & x19 & x24 & x25 & x22 & x23;
endmodule
