...
module FAU ( 
  ...
  assign new_n58_ = (x19 | x20) & (~new_n59_ | ~x11 | ~x19 | ~x20 | ~x21);
  assign new_n59_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x19 | x20) & (~new_n63_ | ~new_n62_ | ~x12 | ~x20);
  assign new_n62_ = x21 & x22;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x19 | ((~x20 | x21) & (~new_n63_ | ~x13 | ~x21 | ~x22))) & (x20 | ~x21);
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x19 & ((x22 & (new_n68_ | ~x21)) | (x20 & x21 & ~x22))) | (~x20 & x22));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x20 | ((~x21 | ~x22 | x23) & (~x19 | x22 | ~x23))) & (~x23 | (x20 & ~new_n71_ & x21));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x20 | (~new_n74_ & (~x21 | ~x22 | ~x23 | x24))) & (~x24 | (x20 & x21 & x22 & x23));
  assign new_n74_ = x16 & x19 & x24 & x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = ~new_n79_ & (~x20 | (~new_n77_ & ~new_n78_));
  assign new_n77_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n78_ = x17 & x19 & x25 & x26;
  assign new_n79_ = x25 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign z16 = (x07 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x20 | ~x26) & (~x19 | ((new_n82_ | ~x26) & (~new_n83_ | ~new_n62_ | ~x20)));
