...
module FAU ( 
  ...
  assign new_n66_ = ~x10 & (x19 ? (x21 ? (new_n67_ | ~x20) : x20) : (x21 & ~x26));
  ...
  assign new_n72_ = x19 ? ((~x23 | (new_n59_ & ~new_n73_ & x22)) & (~new_n59_ | ~x22 | x23)) : (~x23 | x26);
  ...
  assign new_n77_ = ~x19 & (x26 | (~x08 & x09 & ~x10 & x24));
  ...
  assign new_n84_ = ~x19 & (x26 | (~x08 & x09 & ~x10 & x25));
