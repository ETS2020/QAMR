...
module FAU ( 
  ...
  assign z12 = (~x08 & x09 & ~new_n70_ & ~x10) | (x03 & x08 & x19);
  assign new_n70_ = (~x19 | ((~x22 | (x20 & ~new_n71_ & x21)) & (~x20 | ~x21 | x22))) & (x03 | x19 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | new_n73_ | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n73_ = ~x19 & (x03 | (new_n47_ & ~x10 & x23));
  assign new_n74_ = (~x23 | (x20 & x21 & ~new_n75_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | new_n77_ | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n77_ = ~x19 & (x03 | (new_n47_ & ~x10 & x24));
