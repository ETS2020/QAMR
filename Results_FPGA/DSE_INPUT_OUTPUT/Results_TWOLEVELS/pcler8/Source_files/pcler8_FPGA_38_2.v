...
module FAU ( 
  ...
  assign z10 = (~x08 & new_n63_ & x09) | (x01 & x08 & x19);
  assign new_n63_ = ~x10 & ((x19 & (~x20 | (new_n64_ & new_n65_))) | (~x01 & ~x19 & x20));
  ...
  assign new_n90_ = ~x10 & ((x26 & (~new_n91_ | ~new_n92_)) | (new_n93_ & new_n94_));
