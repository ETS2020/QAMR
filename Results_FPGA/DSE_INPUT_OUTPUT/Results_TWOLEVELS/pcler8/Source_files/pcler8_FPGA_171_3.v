...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((~x06 & ((x21 & (new_n66_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x03 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (x06 | ((~x22 | (x20 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n69_ = x24 & x25 & x26 & x14 & x23;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x06 | (~new_n74_ & ((new_n72_ & new_n73_) | ~x23))) & (x19 | ~x23);
  ...
  assign new_n76_ = (x19 | ~x24) & (x06 | (((new_n72_ & new_n77_) | ~x24) & (~new_n78_ | ~new_n72_ | ~x19)));
  ...
  assign new_n83_ = ~x06 & (~new_n48_ | ~new_n49_ | ~x24 | ~x25 | x26);
