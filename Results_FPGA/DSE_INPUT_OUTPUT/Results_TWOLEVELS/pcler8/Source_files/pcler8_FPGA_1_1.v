...
module FAU ( 
  ...
  assign z00 = x19 & (~x18 | (new_n49_ & new_n47_ & new_n48_ & ~x10));
  ...
  assign new_n63_ = x19 & (~x18 | (new_n47_ & ~x10 & ~x20));
  assign new_n64_ = ~x10 & x20 & (~x19 | (new_n61_ & new_n65_));
  ...
  assign z12 = (x19 & (new_n72_ | ~x18)) | (x03 & x08) | (new_n70_ & ~x08);
  ...
  assign z13 = (x19 & (new_n74_ | ~x18)) | (new_n75_ & ~x08) | (x04 & x08);
