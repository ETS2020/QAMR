...
module FAU ( 
  ...
  assign z11 = (~new_n65_ & x19) | (x02 & x08) | (new_n66_ & ~x08);
  assign new_n65_ = ~x13 & (x08 | ~x09 | x10 | ~x20 | x21);
  assign new_n66_ = x09 & ~x10 & x21 & (~x19 | ~x20);
  assign z12 = (x19 & (new_n70_ | x13)) | (x03 & x08) | (new_n68_ & ~x08);
  ...
  assign z13 = (x04 & x08) | (new_n73_ & ~x08) | (x19 & (new_n72_ | x13));
  ...
  assign new_n76_ = (x13 | (((new_n60_ & new_n77_) | ~x24) & (~new_n78_ | ~new_n60_ | ~x19))) & (x19 | ~x24);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (~x13 | ~x19)) | (new_n82_ & ~x08) | (x19 & (new_n80_ | x13));
  assign new_n80_ = new_n81_ & ~x08 & x09 & ~x10 & x20;
  assign new_n81_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = x09 & ~x10 & x25 & (~new_n83_ | ~new_n60_ | ~x19);
  assign new_n83_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n85_ & x19) | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n85_ = ~x13 & (~new_n47_ | ~new_n86_);
