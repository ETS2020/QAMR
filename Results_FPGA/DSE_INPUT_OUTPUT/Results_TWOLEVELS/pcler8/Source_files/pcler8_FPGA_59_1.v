...
module FAU ( 
  ...
  assign new_n63_ = ~x20 & (x26 | (~x08 & x09 & ~x10 & x19));
  ...
  assign new_n73_ = (~x23 | (~new_n74_ & x22 & x19 & x21)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  ...
  assign new_n81_ = ~x20 & (x26 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | new_n87_ | (~x08 & new_n83_ & x09);
  ...
  assign new_n87_ = ~x20 & (x26 | (~x08 & x09 & ~x10 & x25));
