...
module FAU ( 
  ...
  assign z11 = z03 | new_n68_ | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x21 | (x20 & (~new_n50_ | ~new_n49_ | ~x13))) & (~x19 | ~x20 | x21);
  assign new_n68_ = ~x19 & (~x15 | (~x08 & x09 & ~x10 & x21));
  ...
  assign new_n75_ = x15 & (~x19 | (x24 & x25 & x26));
  assign z14 = (~x08 & x09 & ~new_n77_ & ~x10) | (x05 & ~new_n47_ & x08);
  assign new_n77_ = (~x19 | ((~new_n61_ | ~new_n79_) & ((new_n61_ & new_n78_) | ~x24))) & (~x15 | x19 | ~x24);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = new_n85_ | (x06 & x08) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = ((new_n82_ & new_n83_) | ~x25) & (~new_n84_ | ~new_n49_ | ~x24 | x25);
