// Benchmark "FAU" written by ABC on Mon Aug 24 16:59:32 2020
...
module FAU ( 
  ...
  assign z10 = new_n63_ | (x01 & x08) | (~x08 & x09 & new_n61_ & ~x10);
  assign new_n61_ = x20 & (new_n62_ | ~x19);
  assign new_n62_ = x12 & x21 & x22 & x24 & x25 & x26;
  assign new_n63_ = x19 & (~x23 | (~x08 & x09 & ~x10 & ~x20));
  ...
  assign new_n72_ = x19 ? (~new_n73_ & x20 & (~x20 | (x21 ? x22 : ~x23))) : ~x23;
  assign new_n73_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | (~new_n76_ & (~x20 | ~x21 | ~x22 | x24))) & (~x24 | (x19 & x20 & x21 & x22));
  assign new_n76_ = x16 & x23 & x24 & x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = ~new_n81_ & (~x19 | (~new_n79_ & ~new_n80_));
  assign new_n79_ = x20 & x21 & x22 & x24 & ~x25;
  assign new_n80_ = x17 & x23 & x25 & x26;
  assign new_n81_ = x25 & (~x19 | ~x20 | ~x21 | ~x22 | ~x24);
  assign z16 = z08 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x19 | ~x26) & (~x23 | ((new_n85_ | ~x26) & (~new_n86_ | ~new_n84_ | ~x19)));
  assign new_n84_ = x20 & x21;
  assign new_n85_ = x22 & x24 & x25 & ~x18 & x20 & x21;
  assign new_n86_ = x22 & x24 & x25 & ~x26;
endmodule
