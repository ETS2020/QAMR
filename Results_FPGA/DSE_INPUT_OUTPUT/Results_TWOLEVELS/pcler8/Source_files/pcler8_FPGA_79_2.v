...
module FAU ( 
  ...
  assign new_n61_ = new_n62_ & x22 & x23 & x24 & x25 & x26;
  assign new_n62_ = ~x08 & x09 & ~x10 & x21;
  assign new_n63_ = x09 & ~x10 & (x19 ^ x20);
  assign z11 = (x02 & x08 & (~x12 | x19)) | (~x19 & (new_n62_ | x12)) | (new_n65_ & ~x08);
  ...
  assign new_n68_ = (~x19 | ((~x20 | ~x21 | x22) & (~x22 | (x20 & ~new_n69_ & x21)))) & (x12 | x19 | ~x22);
