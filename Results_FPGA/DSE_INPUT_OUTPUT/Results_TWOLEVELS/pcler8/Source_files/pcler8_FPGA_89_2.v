...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & x08 & x19);
  assign new_n71_ = (~x19 | ((~x23 | (new_n59_ & ~new_n72_ & x22)) & (~new_n59_ | ~x22 | x23))) & (x04 | x19 | ~x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = new_n74_ | (x19 & (x08 ? x05 : (new_n76_ & x09)));
  assign new_n74_ = ~new_n75_ & ~x04;
  assign new_n75_ = (~x05 | ~x08) & (x08 | ~x09 | x10 | x19 | ~x24);
  assign new_n76_ = ~x10 & ((x24 & (~new_n59_ | ~x22 | new_n77_ | ~x23)) | (new_n59_ & x22 & x23 & ~x24));
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (new_n81_ | ~x25) & (~x19 | (~new_n80_ & (~x17 | ~x25 | ~x26)));
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x22 & x23 & x24 & x19 & x20 & x21;
  assign z16 = new_n83_ | (x19 & (x08 ? x07 : (new_n85_ & x09)));
  assign new_n83_ = ~new_n84_ & ~x04;
  assign new_n84_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x19 | ~x26);
  assign new_n85_ = ~x10 & ((x26 & (~new_n87_ | ~new_n88_)) | (new_n86_ & new_n89_));
