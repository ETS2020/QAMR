...
module FAU ( 
  ...
  assign z09 = z01 | (~x08 & x09 & (new_n59_ | ~x19));
  assign new_n59_ = new_n48_ & new_n49_ & new_n60_ & ~x10 & x11;
  ...
  assign new_n70_ = (~x23 | (~new_n71_ & x22 & x20 & x21)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x19 & (x10 | (~x08 & x09 & x23));
  assign z14 = z06 | new_n76_ | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x24 | (new_n60_ & x22 & ~new_n75_ & x23)) & (~new_n60_ | ~x19 | ~x22 | ~x23 | x24);
