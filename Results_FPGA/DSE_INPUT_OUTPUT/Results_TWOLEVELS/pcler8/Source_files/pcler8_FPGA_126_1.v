...
module FAU ( 
  ...
  assign new_n62_ = x19 ? (x20 & (~new_n63_ | ~new_n64_)) : ~x20;
  assign new_n63_ = x20 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n50_ & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x12 & ((x21 & (new_n67_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x19 & (new_n71_ | ~x12)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign z13 = (x19 & (new_n73_ | ~x12)) | (x04 & x08) | (new_n74_ & ~x08);
  ...
  assign new_n77_ = (~x12 | (((new_n60_ & new_n78_) | ~x24) & (~new_n79_ | ~new_n60_ | ~x19))) & (x19 | ~x24);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n81_ | new_n85_));
  assign new_n81_ = x12 & ((x25 & (~new_n63_ | ~new_n83_)) | (new_n82_ & new_n84_));
  ...
  assign new_n87_ = x12 & (~new_n47_ | ~new_n88_);
