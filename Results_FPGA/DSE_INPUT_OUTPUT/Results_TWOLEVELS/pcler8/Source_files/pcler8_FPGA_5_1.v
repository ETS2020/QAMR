...
module FAU ( 
  ...
  assign new_n68_ = (~x22 | (new_n69_ & x21 & (~new_n59_ | ~x14 | ~x23))) & (~new_n69_ | ~x21 | x22);
  assign new_n69_ = x19 & x20;
  assign z13 = z05 | (~x08 & ~x10 & (new_n72_ | (~new_n71_ & x19)));
  assign new_n71_ = (~new_n58_ | ~x22 | x23) & (~new_n59_ | ~x09 | ~x15 | ~x23);
  assign new_n72_ = x09 & ~new_n73_ & x23;
  assign new_n73_ = x19 & x20 & x21 & x22;
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n75_ & ~x10);
  assign new_n75_ = (~new_n77_ | ~x09) & (~x19 | (~new_n76_ & (~new_n59_ | ~x09 | ~x16)));
  assign new_n76_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n77_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x19 | (~new_n80_ & (~x17 | ~x25 | ~x26))) & (new_n81_ | ~x25);
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & new_n83_ & x09);
  assign new_n83_ = ~x10 & ((new_n73_ & new_n86_) | (x26 & (~new_n84_ | ~new_n85_)));
