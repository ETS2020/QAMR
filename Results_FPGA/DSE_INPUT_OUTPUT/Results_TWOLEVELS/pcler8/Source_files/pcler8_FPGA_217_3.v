...
module FAU ( 
  ...
  assign new_n63_ = (~x23 | (x20 & (x26 | (x19 & x21 & x22)))) & (~x22 | x23 | x26 | ~x19 | ~x20 | ~x21);
  ...
  assign z15 = (x06 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x25 | (x20 & (new_n70_ | x26))) & (~new_n71_ | ~new_n69_ | x25 | x26);
  assign new_n69_ = x23 & x24;
  assign new_n70_ = x19 & x21 & x22 & x23 & x24;
  assign new_n71_ = x19 & x20 & x21 & x22;
  assign z16 = z08 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (x20 | ~x26) & (~new_n71_ | ~new_n69_ | ~x25 | x26);
  assign z00 = 1'b0;
endmodule
