// Benchmark "FAU" written by ABC on Mon Aug 24 16:59:21 2020
...
module FAU ( 
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n60_ | ~new_n59_ | ~x12))) & (x10 | ~x19 | x20);
  assign z11 = z03 | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = (~x20 | ((~x19 | x21) & (~new_n60_ | ~x13 | ~x21 | ~x22))) & (~x21 | (x19 & x20));
  assign z12 = (x03 & ~new_n49_ & x08) | new_n49_ | (~x08 & ~new_n66_ & x09);
  assign new_n66_ = (~x22 | ((x10 | (x20 & x21)) & (~x20 | (~new_n67_ & x19)))) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & (new_n69_ | new_n71_));
  assign new_n69_ = x23 & ((~new_n70_ & x20) | (~x10 & (~new_n59_ | ~x20)));
  assign new_n70_ = x19 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n71_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x20 | (~new_n75_ & (~new_n74_ | ~x16 | ~x24))) & (new_n76_ | ~x24);
  assign new_n74_ = x25 & x26;
  assign new_n75_ = x19 & x21 & x22 & x23 & ~x24;
  assign new_n76_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & (new_n78_ | new_n80_));
  assign new_n78_ = x25 & (new_n79_ | (x20 & (~x19 | (x17 & x26))));
  assign new_n79_ = ~x10 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n80_ = new_n81_ & x19 & x20 & x21;
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign z16 = (x07 & ~new_n49_ & x08) | new_n49_ | (~x08 & ~new_n83_ & x09);
  assign new_n83_ = (~new_n86_ | ~new_n87_) & (~x26 | (~new_n84_ & (new_n85_ | x10)));
  assign new_n84_ = x20 & (x18 | ~x19);
