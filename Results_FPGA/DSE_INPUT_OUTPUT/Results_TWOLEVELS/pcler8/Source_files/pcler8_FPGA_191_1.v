...
module FAU ( 
  ...
  assign z14 = z06 | (~x08 & ~x10 & (new_n76_ | (~new_n74_ & x19)));
  assign new_n74_ = ~new_n75_ & (~x16 | ~x24 | ~x25 | ~x26);
  assign new_n75_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n76_ = x09 & x24 & (~new_n69_ | ~new_n48_ | ~x21);
  ...
  assign z16 = (x19 & (new_n81_ | ~x09)) | (x07 & x08) | (~x08 & new_n82_ & x09);
