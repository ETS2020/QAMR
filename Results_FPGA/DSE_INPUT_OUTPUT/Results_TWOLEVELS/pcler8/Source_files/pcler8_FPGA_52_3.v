...
module FAU ( 
  ...
  assign new_n59_ = new_n60_ & x11 & ~x14 & new_n61_ & x22 & x23;
  ...
  assign new_n70_ = ~x10 & ((~x14 & ((x22 & (~x20 | ~x21)) | (x21 & ~x22 & x19 & x20))) | (~x19 & x22));
  assign z13 = (x04 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x19 | (~new_n73_ & (~x22 | x23 | ~x20 | ~x21))) & (~x23 | (x19 & x20 & x21 & x22));
  assign new_n73_ = x24 & x25 & x26 & ~x14 & x15 & x23;
  assign z14 = (x05 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = ~new_n77_ & (~x19 | (~new_n76_ & (~new_n61_ | x14 | ~x16)));
  assign new_n76_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n77_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x19 | ~x25) & (x14 | ((new_n82_ | ~x25) & (~x19 | (~new_n80_ & ~new_n81_))));
  ...
  assign new_n84_ = ~x14 & (~new_n85_ | x08 | ~x09 | ~new_n60_ | x10);
