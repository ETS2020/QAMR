...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((x19 & (x21 ? (new_n65_ | ~x20) : x20)) | (x03 & ~x19 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & (x08 | (new_n69_ & x09 & ~x10))) | (~x08 & x09 & new_n67_ & ~x10);
  assign new_n67_ = x19 & ((x22 & (~x20 | new_n68_ | ~x21)) | (x20 & x21 & ~x22));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x19 & x22;
  assign z13 = (x03 & (new_n74_ | (x04 & x08))) | (x19 & (x08 ? x04 : new_n71_));
  ...
  assign new_n78_ = ~x10 & ((x24 & (~new_n72_ | ~x22 | new_n79_ | ~x23)) | (new_n72_ & x22 & x23 & ~x24));
  ...
  assign new_n90_ = ~x19 & (~x03 | (~x10 & x26 & ~x08 & x09));
endmodule
