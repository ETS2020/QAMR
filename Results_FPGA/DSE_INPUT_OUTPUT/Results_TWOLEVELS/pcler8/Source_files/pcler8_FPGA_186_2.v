...
module FAU ( 
  ...
  assign new_n63_ = (~x20 | (x19 & (~new_n61_ | ~x12 | ~x21 | ~x22))) & (~x19 | x20 | ~x21);
  assign z11 = z03 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = x19 ? ((x20 | ~x21) & (~new_n49_ | ~new_n48_ | ~x13)) : ~x21;
  assign z12 = (~new_n69_ & x19) | (x03 & x08) | (new_n67_ & ~x08);
  assign new_n67_ = x09 & ~x10 & x22 & (~new_n68_ | ~x19);
  assign new_n68_ = x20 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n69_ = x21 & (x08 | ~x09 | x10 | ~x20 | x22);
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x21 | ((~x23 | (x20 & ~new_n72_ & x22)) & (~x19 | ~x20 | ~x22 | x23))) & (x19 | ~x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & new_n74_ & x09);
  assign new_n74_ = ~x10 & ((~x19 & x24) | (x21 & (new_n76_ | (~new_n75_ & x24))));
  assign new_n75_ = x20 & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x22 & x23 & ~x24;
  assign z15 = z07 | new_n78_ | (~x08 & new_n79_ & x09);
  assign new_n78_ = x19 & (~x21 | (new_n47_ & new_n48_ & x24 & ~x25));
