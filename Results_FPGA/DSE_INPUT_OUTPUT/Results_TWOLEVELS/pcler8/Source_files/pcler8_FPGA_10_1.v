...
module FAU ( 
  ...
  assign z00 = x19 & (~x13 | (new_n47_ & new_n48_));
  ...
  assign new_n59_ = ~x10 & (~x19 | (new_n48_ & new_n60_ & x11 & x13));
  assign new_n60_ = x20 & x21;
  assign z10 = z02 | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (~x13 | ((~x19 | x20) & (~new_n64_ | ~new_n63_ | ~x12 | ~x20))) & (x19 | ~x20);
  assign new_n63_ = x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x19 | ~x20 | (x21 & (~new_n67_ | ~x21 | ~x22 | ~x23))) & (~x21 | (x19 & x20));
  assign new_n67_ = x24 & x25 & x26;
  assign z12 = (x19 & (new_n71_ | ~x13)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign new_n73_ = (x19 | ~x23) & (~x13 | (~new_n75_ & ((new_n60_ & new_n74_) | ~x23)));
  assign new_n74_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n75_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (~new_n77_ & x19) | (x05 & x08) | (~x08 & new_n79_ & x09);
  assign new_n77_ = x13 & (~new_n78_ | ~new_n63_ | ~x23 | x24);
  assign new_n78_ = ~x08 & x09 & ~x10 & x20;
  assign new_n79_ = ~x10 & x24 & (~new_n80_ | ~new_n60_ | ~x19);
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x06 & x08 & (x13 | ~x19)) | (x19 & (new_n82_ | ~x13)) | (new_n83_ & ~x08);
  assign new_n82_ = new_n78_ & new_n63_ & x23 & x24 & ~x25;
  ...
  assign new_n86_ = x13 & (~new_n47_ | ~new_n87_);
