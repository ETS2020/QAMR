...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n61_, new_n63_,
    ...
    new_n91_;
  assign z00 = (x06 & ~x19) | (new_n47_ & new_n49_ & new_n48_ & x21);
  ...
  assign z08 = (x07 & x08) | (x06 & ~x19);
  assign z09 = z01 | (~x08 & x09 & ~new_n60_ & ~x10);
  assign new_n60_ = (x06 | x19) & (~new_n48_ | ~new_n49_ | ~new_n61_ | ~x11 | ~x19);
  ...
  assign z11 = (x02 & x08 & (~x06 | x19)) | (~x19 & (new_n69_ | x06)) | (new_n67_ & ~x08);
  ...
  assign z12 = (new_n51_ & x03) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x19 | ((~x20 | ~x21 | x22) & (~x22 | (x20 & ~new_n72_ & x21)))) & (x06 | x19 | ~x22);
  assign new_n72_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x19 | ((~x23 | (new_n61_ & ~new_n75_ & x22)) & (~new_n61_ | ~x22 | x23))) & (x06 | x19 | ~x23);
  ...
  assign new_n79_ = ~x19 & (x06 | (~x10 & x24 & ~x08 & x09));
  assign z15 = (~x08 & x09 & ~new_n81_ & ~x10) | (x06 & x08 & x19);
  assign new_n81_ = (~x19 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_))) & (x06 | x19 | ~x25);
  ...
  assign new_n91_ = ~x19 & (x06 | (~x10 & x26 & ~x08 & x09));
endmodule
