...
module FAU ( 
  ...
  assign new_n76_ = x19 ? ((~x24 | (new_n59_ & new_n77_)) & (~new_n59_ | ~new_n78_)) : (~x24 | x26);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = x19 ? ((~x25 | (new_n81_ & new_n82_)) & (~new_n81_ | ~new_n83_)) : (~x25 | x26);
  ...
  assign new_n86_ = x19 & (~x23 | ~x24);
  assign new_n87_ = ~x18 & x20 & x21 & x22 & x25;
