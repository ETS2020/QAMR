...
module FAU ( 
  ...
  assign new_n60_ = ~x10 & (~x19 | (new_n61_ & new_n49_ & x11 & x20));
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | new_n63_ | (~x08 & new_n64_ & x09);
  assign new_n63_ = ~x19 & (new_n48_ | x23);
  assign new_n64_ = ~x10 & ((x19 & ~x20) | (new_n61_ & new_n49_ & x12));
  assign z11 = (x02 & x08 & (x19 | ~x23)) | (~x19 & (new_n68_ | x23)) | (new_n66_ & ~x08);
  ...
  assign new_n71_ = x24 & x25 & x26 & x14 & x23;
  assign new_n72_ = ~x19 & (x23 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z14 = (x05 & x08 & (x19 | ~x23)) | (x23 & (new_n77_ | ~x19)) | (new_n79_ & ~x08);
  assign new_n77_ = ~x08 & x09 & ~x10 & new_n78_ & x22 & ~x24;
  assign new_n78_ = x20 & x21;
  assign new_n79_ = x09 & ~x10 & x24 & (~new_n78_ | ~new_n80_);
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x06 & ~new_n51_ & x08) | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((~x23 & x25) | (x19 & (new_n84_ | (~new_n83_ & x25))));
  assign new_n83_ = x20 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n84_ = x23 & x24 & ~x25 & x20 & x21 & x22;
  assign z16 = (x23 & (new_n86_ | ~x19)) | (x07 & x08) | (new_n87_ & ~x08);
  assign new_n86_ = new_n48_ & new_n49_ & x24 & x25 & ~x26;
  assign new_n87_ = x09 & ~x10 & x26 & (~new_n88_ | ~new_n78_ | x18);
  assign new_n88_ = x22 & x23 & x25 & (~x19 | x24);
endmodule
