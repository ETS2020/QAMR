...
module FAU ( 
  ...
  assign z13 = (x04 & (~x19 | (x08 & x19))) | (~x08 & x09 & ~new_n72_ & ~x10);
  ...
  assign z15 = (x06 & ~new_n47_ & x08) | new_n47_ | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (new_n82_ | ~x19) & (~x25 | (new_n83_ & new_n78_ & x19));
  assign new_n82_ = (x23 | ~x25) & (~x20 | ~x21 | ~x22 | ~x23 | ~x24 | x25);
  ...
  assign new_n90_ = ~x19 & (x04 | (~x10 & x26 & ~x08 & x09));
endmodule
