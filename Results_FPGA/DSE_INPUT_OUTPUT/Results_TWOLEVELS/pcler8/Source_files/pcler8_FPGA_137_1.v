...
module FAU ( 
  ...
  assign z10 = new_n65_ | (x01 & x08) | (~x08 & x09 & new_n64_ & ~x10);
  assign new_n64_ = x20 & (~x19 | (new_n62_ & x12 & x21 & x22));
  assign new_n65_ = x19 & (~x06 | (~x08 & x09 & ~x10 & ~x20));
  assign z11 = (x02 & x08 & (x06 | ~x19)) | (new_n67_ & ~x08) | (x19 & (new_n69_ | ~x06));
  assign new_n67_ = x09 & ~x10 & x21 & (~x19 | new_n68_ | ~x20);
  assign new_n68_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n69_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign z12 = (x19 & (new_n73_ | ~x06)) | (new_n71_ & ~x08) | (x03 & x08);
  ...
  assign new_n75_ = (~x06 | (~new_n77_ & ((new_n48_ & new_n76_) | ~x23))) & (x19 | ~x23);
  ...
  assign z15 = z07 | (x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x19 | (~new_n84_ & ~new_n85_)) & (x08 | new_n86_ | ~x25);
