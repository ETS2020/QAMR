// Benchmark "FAU" written by ABC on Mon Aug 24 16:59:18 2020
...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (~x09 | x19)) | (x09 & (~x19 | (~x08 & ~new_n66_ & ~x10)));
  ...
  assign new_n74_ = (~x25 | (new_n75_ & (~x19 | x23) & ~new_n76_ & x24)) & (~new_n75_ | ~x23 | ~x24 | x25);
  ...
  assign new_n79_ = x24 & x25 & x22 & (~x19 | x23);
