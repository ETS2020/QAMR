...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (x09 & ~x10 & ((~new_n64_ & x01) | (new_n65_ & ~x08)));
  assign new_n64_ = (~new_n62_ | ~x12 | ~x20 | ~x21 | ~x22) & (~x19 | x20);
  assign new_n65_ = ~x19 & x20;
  assign z11 = (x02 & x08 & (x01 | ~x19)) | (x19 & (new_n69_ | ~x01)) | (new_n67_ & ~x08);
  assign new_n67_ = x09 & ~x10 & x21 & (~x19 | new_n68_ | ~x20);
  assign new_n68_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n69_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign z12 = (x03 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x19 | ~x22) & (~x01 | ((~x22 | (x20 & ~new_n72_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n72_ = x24 & x25 & x26 & x14 & x23;
  assign z13 = (x04 & x08 & (x01 | ~x19)) | ((new_n74_ | ~x01) & x19) | (new_n76_ & ~x08);
  assign new_n74_ = new_n75_ & x20 & x21 & x22 & ~x23;
  assign new_n75_ = ~x08 & x09 & ~x10;
  assign new_n76_ = x09 & ~x10 & x23 & (~new_n77_ | ~x19 | ~x20);
  assign new_n77_ = x21 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign z14 = (~new_n79_ & x19) | (x05 & x08) | (new_n81_ & ~x08);
  assign new_n79_ = x01 & (~new_n80_ | ~x21 | ~x22 | ~x23 | x24);
  ...
  assign new_n85_ = x01 & ((new_n82_ & new_n88_) | ((~new_n86_ | ~new_n87_) & x25));
  assign new_n86_ = x20 & x21 & x22;
  assign new_n87_ = x23 & x24 & (~x17 | ~x26);
  assign new_n88_ = x22 & x23 & x24 & ~x25;
  assign new_n89_ = ~x19 & x25;
  assign z16 = (~new_n91_ & x19) | (x07 & x08) | (~x08 & new_n92_ & x09);
  assign new_n91_ = x01 & (~new_n48_ | ~new_n49_ | ~x24 | ~x25 | x26);
  assign new_n92_ = ~x10 & x26 & (~new_n93_ | ~new_n49_ | ~x24 | ~x25);
