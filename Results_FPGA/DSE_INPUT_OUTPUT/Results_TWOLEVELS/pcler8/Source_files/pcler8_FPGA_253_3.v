...
module FAU ( 
  ...
  assign new_n63_ = (~x23 | (x19 & (x26 | (x20 & x21 & x22)))) & (~x22 | x23 | x26 | ~x19 | ~x20 | ~x21);
  assign z14 = ~new_n67_ | (~new_n65_ & x19);
  assign new_n65_ = ~x26 & (~new_n66_ | ~x21 | ~x22 | ~x23 | x24);
  assign new_n66_ = ~x10 & x20 & ~x08 & x09;
  assign new_n67_ = x08 ? ~x05 : (~x09 | x10 | new_n68_ | ~x24);
  assign new_n68_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = (x06 & x08 & (~x19 | ~x26)) | (new_n71_ & ~x08) | (x19 & (new_n70_ | x26));
  assign new_n70_ = new_n66_ & x21 & x22 & x23 & x24 & ~x25;
  assign new_n71_ = x09 & ~x10 & ~new_n72_ & x25;
  assign new_n72_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = ~x26 & (~new_n75_ | ~x19 | ~x20 | ~x21);
