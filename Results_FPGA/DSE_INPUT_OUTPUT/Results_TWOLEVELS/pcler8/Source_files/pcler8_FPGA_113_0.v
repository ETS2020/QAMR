...
module FAU ( 
  ...
  assign new_n62_ = (~x19 | (x20 & (~new_n60_ | ~new_n63_))) & (~x18 | x19 | ~x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x19 & (x21 ? (new_n66_ | ~x20) : x20)) | (x18 & ~x19 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x19 | ((~x22 | (x20 & ~new_n69_ & x21)) & (~x20 | ~x21 | x22))) & (~x18 | x19 | ~x22);
