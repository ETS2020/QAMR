...
module FAU ( 
  ...
  assign new_n60_ = x19 & (~new_n48_ | ~new_n49_ | ~new_n61_ | ~x11 | ~x17);
  assign new_n61_ = x20 & x21;
  assign z10 = (new_n51_ & x01) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x17 & x19 & (~x20 | (new_n64_ & new_n65_))) | (~x19 & x20));
  ...
  assign z12 = (x03 & x08 & (x17 | ~x19)) | (x19 & (new_n73_ | ~x17)) | (new_n71_ & ~x08);
  ...
  assign z13 = (x19 & (new_n75_ | ~x17)) | (x04 & x08) | (new_n76_ & ~x08);
  ...
  assign z14 = (new_n51_ & x05) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x19 | ~x24) & (~x17 | ((~x24 | (new_n61_ & new_n80_)) & (~new_n81_ | ~new_n61_ | ~x19)));
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n81_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x17 | ((~x19 | ~new_n84_ | ~x20) & (new_n85_ | ~x25))) & (x19 | ~x25);
  assign new_n84_ = x21 & x22 & x23 & x24 & (~x25 | (x25 & x26));
  assign new_n85_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = (~new_n87_ & x19) | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n87_ = x17 & (~new_n88_ | x08 | ~x09 | ~new_n61_ | x10);
  assign new_n88_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n61_ | x18 | ~x19);
