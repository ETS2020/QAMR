...
module FAU ( 
  ...
  assign new_n73_ = (x19 | ~x23) & (~x16 | (~new_n76_ & ((new_n74_ & new_n75_) | ~x23)));
  ...
  assign new_n78_ = (~x19 | ~x20 | ~new_n79_ | ~x21) & (~x24 | (x19 & x20 & new_n49_ & x21));
  assign new_n79_ = x22 & x23 & (~x24 | (x24 & x25 & x26));
  assign z15 = (~new_n81_ & x19) | (x06 & x08) | (~x08 & new_n83_ & x09);
  assign new_n81_ = x16 & (~new_n82_ | x08 | ~x09 | x10 | ~x20);
  assign new_n82_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n83_ = ~x10 & x25 & (~new_n84_ | ~new_n74_ | ~x19);
