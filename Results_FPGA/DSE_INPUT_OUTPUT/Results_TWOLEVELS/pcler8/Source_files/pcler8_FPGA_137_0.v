...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x06 | x19)) | (~x19 & (new_n67_ | ~x06)) | (new_n65_ & ~x08);
  ...
  assign new_n73_ = (~x19 | ((~x23 | (new_n74_ & ~new_n75_ & x22)) & (~new_n74_ | ~x22 | x23))) & (~x06 | x19 | ~x23);
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x19 | ((~x24 | (new_n74_ & new_n78_)) & (~new_n74_ | ~new_n79_))) & (~x06 | x19 | ~x24);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08) | (~x08 & new_n81_ & x09) | (~x19 & (~x06 | (new_n86_ & x09)));
  ...
  assign new_n90_ = ~x10 & ((new_n82_ & new_n93_) | ((~new_n91_ | ~new_n92_) & x26));
