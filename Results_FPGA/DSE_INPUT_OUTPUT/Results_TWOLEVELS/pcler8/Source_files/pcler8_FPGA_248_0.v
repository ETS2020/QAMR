...
module FAU ( 
  ...
  assign new_n62_ = (~x19 | (x20 & (~new_n60_ | ~new_n63_))) & (~x04 | x19 | ~x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x19 & (x21 ? (new_n66_ | ~x20) : x20)) | (x04 & ~x19 & x21));
  ...
  assign new_n70_ = ~x19 & (~x04 | (~x10 & x22 & ~x08 & x09));
  ...
  assign new_n74_ = ~x19 & (~x04 | (x09 & ~x10 & x23));
  ...
  assign z15 = z07 | new_n87_ | (~x08 & new_n82_ & x09);
  ...
  assign new_n87_ = ~x19 & (~x04 | (~x10 & x25 & ~x08 & x09));
  assign z16 = z08 | new_n94_ | (~x08 & new_n89_ & x09);
  ...
  assign new_n94_ = ~x19 & (~x04 | (~x10 & x26 & ~x08 & x09));
endmodule
