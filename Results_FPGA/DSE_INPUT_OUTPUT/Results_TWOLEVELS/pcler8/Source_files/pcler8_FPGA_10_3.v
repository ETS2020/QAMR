...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n48_ | ~new_n60_ | ~x11 | x13);
  ...
  assign z11 = (~new_n66_ & x19) | (x02 & x08) | (new_n67_ & ~x08);
  assign new_n66_ = ~x13 & (x08 | ~x09 | x10 | ~x20 | x21);
  ...
  assign z15 = (x06 & x08 & (~x13 | ~x19)) | (new_n83_ & ~x08) | (x19 & (new_n82_ | x13));
