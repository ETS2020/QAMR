...
module FAU ( 
  ...
  assign new_n60_ = ~x10 & (~x19 | (new_n49_ & new_n48_ & x11 & ~x15));
  ...
  assign z12 = (x19 & (new_n71_ | x15)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign new_n73_ = (x15 | (((x20 & x21 & x22) | ~x23) & (~x19 | ~x20 | ~x21 | ~x22 | x23))) & (x19 | ~x23);
  assign z14 = (x05 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (x15 | (((new_n48_ & new_n76_) | ~x24) & (~new_n77_ | ~new_n48_ | ~x19))) & (x19 | ~x24);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = (~new_n79_ & x19) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n79_ = ~x15 & (~new_n80_ | x08 | ~x09 | x10 | ~x20);
  ...
  assign new_n84_ = ~x15 & ((new_n87_ & new_n88_) | ((~new_n85_ | ~new_n86_) & x26));
