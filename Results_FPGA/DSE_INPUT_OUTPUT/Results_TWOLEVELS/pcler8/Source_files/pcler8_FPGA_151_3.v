...
module FAU ( 
  ...
  assign new_n62_ = x09 & ((x19 & (x21 ? (new_n63_ | ~x20) : x20)) | (~x10 & ~x19 & x21));
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08 & (~x10 | ~x19)) | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x22 | (new_n67_ & x21 & (~new_n66_ | ~x14 | ~x23))) & (~new_n67_ | ~x21 | x22);
  ...
  assign z14 = (x05 & x08 & (~x10 | ~x19)) | (x10 & x19) | (~x08 & ~new_n74_ & x09);
  assign new_n74_ = (~new_n76_ | x10) & (~x19 | (~new_n75_ & (~new_n66_ | x10 | ~x16)));
  assign new_n75_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n76_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = (x06 & x08 & (~x10 | ~x19)) | (x10 & x19) | (~x08 & ~new_n78_ & x09);
  assign new_n78_ = (~x19 | (~new_n79_ & ~new_n80_)) & (x10 | new_n81_ | ~x25);
  assign new_n79_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n80_ = ~x10 & x17 & x25 & x26;
  assign new_n81_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = (x07 & x08 & (~x10 | ~x19)) | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (~x26 | (new_n84_ & new_n85_)) & (~new_n72_ | ~new_n86_);
