...
module FAU ( 
  ...
  assign z10 = z02 | (~x08 & ~x10 & (new_n61_ | new_n63_));
  assign new_n61_ = x19 & (~x20 | (new_n62_ & x12 & x21 & x22));
  assign new_n62_ = x23 & x24 & x25 & x26;
  assign new_n63_ = x09 & ~x19 & x20;
  assign z11 = z03 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x21 | (x19 & x20 & (~new_n59_ | ~new_n58_ | ~x13))) & (~x19 | ~x20 | x21);
  ...
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x09 & x19) | (new_n73_ & ~x08);
  assign new_n73_ = ~x10 & ((new_n76_ & x09) | (x19 & (new_n74_ | new_n75_)));
