...
module FAU ( 
  ...
  assign new_n69_ = (~x19 | (x20 ? ((x21 | ~x22) & (x15 | ~x21 | x22)) : ~x22)) & (~x22 | (~new_n70_ & x19));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x22 | ((~x23 | (new_n48_ & ~new_n73_ & x21)) & (~new_n48_ | ~x21 | x23))) & (x15 | x22 | ~x23);
  ...
  assign z15 = (x06 & ~new_n47_ & x08) | new_n47_ | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x22 | ((x23 | ~x25) & (~new_n80_ | ~x23 | ~x24 | x25))) & (~x25 | (new_n80_ & x22 & ~new_n81_ & x24));
  assign new_n80_ = x19 & x20 & x21;
  assign new_n81_ = x17 & x26;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n83_ | new_n87_));
  assign new_n83_ = x22 & ((x26 & (~new_n84_ | ~new_n85_)) | (new_n80_ & new_n86_));
  assign new_n84_ = ~x18 & x19 & x20;
  assign new_n85_ = x21 & x23 & x24 & x25;
  assign new_n86_ = x23 & x24 & x25 & ~x26;
  assign new_n87_ = ~x15 & ~x22 & x26;
endmodule
