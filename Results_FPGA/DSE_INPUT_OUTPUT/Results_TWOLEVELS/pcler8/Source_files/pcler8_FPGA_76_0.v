// Benchmark "FAU" written by ABC on Mon Aug 24 16:58:42 2020
...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n66_ & ~x10);
  ...
  assign new_n71_ = ~x19 & (~x09 | (~x08 & ~x10 & x23));
  ...
  assign z16 = (~x19 & (~x09 | (new_n84_ & ~x08))) | (x07 & x08) | (~x08 & new_n79_ & x09);
