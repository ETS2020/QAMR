...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x12 | x19)) | (x12 & (new_n61_ | ~x19)) | (new_n63_ & ~x08);
  assign new_n61_ = new_n62_ & ~x08 & x09 & ~x10 & x21;
  assign new_n62_ = x22 & x23 & x24 & x25 & x26;
  assign new_n63_ = x09 & ~x10 & (x19 ^ x20);
  ...
  assign new_n73_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | new_n78_ | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x24 | (new_n76_ & x22 & ~new_n77_ & x23)) & (~x22 | ~x23 | x24 | ~new_n76_ | ~x19);
  assign new_n76_ = x20 & x21;
  assign new_n77_ = x16 & x25 & x26;
  assign new_n78_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n85_ | (x06 & x08) | (~x08 & x09 & ~new_n80_ & ~x10);
  ...
  assign new_n85_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x25));
