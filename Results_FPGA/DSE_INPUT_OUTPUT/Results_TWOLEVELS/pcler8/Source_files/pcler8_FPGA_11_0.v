...
module FAU ( 
  ...
  assign z07 = x06 & x08;
  assign z08 = x07 & x08;
  assign z09 = x08 ? x00 : (new_n57_ | ~x19);
  assign new_n57_ = new_n58_ & x09 & ~x10 & x11 & x20 & x21;
  ...
  assign z12 = x08 ? x03 : (x09 & ~x10 & ~new_n66_ & x19);
  assign new_n66_ = (~x22 | (x20 & x21 & (~new_n64_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = x08 ? x04 : (~x19 | (x09 & ~new_n68_ & ~x10));
  assign new_n68_ = (~x20 | ~x21 | ~x22 | (~new_n69_ & x23)) & (~x23 | (x20 & x22 & (~x19 | x21)));
  assign new_n69_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = x08 ? x05 : (~x19 | (x09 & ~new_n71_ & ~x10));
  assign new_n71_ = (~x20 | ~x21 | ~x22 | ~x23 | (~new_n72_ & x24)) & (~x24 | (x20 & x21 & x22 & x23));
  assign new_n72_ = x16 & x24 & x25 & x26;
  assign z15 = x08 ? x06 : (~x19 | (x09 & ~new_n74_ & ~x10));
  assign new_n74_ = (~x20 | ~x21 | ~new_n76_ | ~x22) & (~x25 | (x20 & x21 & new_n75_ & x22));
  assign new_n75_ = x23 & x24;
  assign new_n76_ = x23 & x24 & (~x25 | (x17 & x25 & x26));
  assign z16 = x08 ? x07 : (x09 & new_n78_ & ~x10);
  assign new_n78_ = x19 & ((new_n81_ & new_n82_) | (x26 & (~new_n79_ | ~new_n80_)));
