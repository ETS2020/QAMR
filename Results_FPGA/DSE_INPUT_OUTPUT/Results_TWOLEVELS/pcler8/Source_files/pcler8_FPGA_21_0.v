...
module FAU ( 
  ...
  assign z14 = new_n74_ | (x05 & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x24 | (new_n72_ & x22 & ~new_n73_ & x23)) & (~x22 | ~x23 | x24 | ~new_n72_ | ~x19);
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x16 & x25 & x26;
  assign new_n74_ = ~x19 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (~x19 & (~x09 | (new_n81_ & ~x08))) | (x06 & x08) | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & ((new_n77_ & new_n80_) | (x25 & (~new_n78_ | ~new_n79_)));
