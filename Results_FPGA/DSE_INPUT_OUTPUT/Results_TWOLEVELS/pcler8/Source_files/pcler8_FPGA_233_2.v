...
module FAU ( 
  ...
  assign new_n61_ = (x10 | ((~x19 | x20) & (~new_n59_ | ~new_n58_ | ~x12 | ~x20))) & (x19 | ~x20);
  assign z11 = (x02 & x08 & (~x10 | x19)) | (~x19 & (x10 | (new_n65_ & ~x08))) | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & ((x21 & (new_n64_ | ~x20)) | (x19 & x20 & ~x21));
  ...
  assign new_n71_ = (~x23 | (x20 & x21 & ~new_n72_ & x22)) & (~x21 | ~x22 | x23 | ~x19 | ~x20);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = ~x19 & (x10 | (~x08 & x09 & x23));
  ...
  assign z15 = new_n82_ | (x06 & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | (new_n80_ & new_n58_ & x20)) & (~new_n76_ | ~new_n81_);
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x19 & (x10 | (~x08 & x09 & x25));
  ...
  assign new_n89_ = ~x19 & (x10 | (~x08 & x09 & x26));
endmodule
