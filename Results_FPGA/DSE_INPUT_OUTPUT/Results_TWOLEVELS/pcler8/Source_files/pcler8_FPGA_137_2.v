...
module FAU ( 
  ...
  assign new_n63_ = (~new_n61_ | ~x12 | ~x20 | ~x21 | ~x22) & (~x19 | x20);
  ...
  assign new_n72_ = ~x19 & (x06 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x19 | ((~x23 | (new_n75_ & ~new_n76_ & x22)) & (~new_n75_ | ~x22 | x23))) & (x06 | x19 | ~x23);
  assign new_n75_ = x20 & x21;
  assign new_n76_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x19 | (((new_n75_ & new_n79_) | ~x24) & (~new_n75_ | ~new_n80_))) & (x06 | x19 | ~x24);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((x25 & (~new_n83_ | ~new_n48_ | new_n84_ | ~x24)) | (new_n83_ & new_n48_ & x24 & ~x25));
