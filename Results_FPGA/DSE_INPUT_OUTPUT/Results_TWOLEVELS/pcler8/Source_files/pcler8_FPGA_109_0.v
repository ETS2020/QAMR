...
module FAU ( 
  ...
  assign new_n57_ = new_n58_ & new_n59_ & x09 & x11 & x20 & x21;
  assign new_n58_ = x22 & x23;
  assign new_n59_ = x24 & x25 & x26;
  assign z10 = (x01 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = x20 ? (x19 & (~new_n62_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign new_n62_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = (~x21 | (x19 & x20 & (~new_n59_ | ~new_n58_ | ~x13))) & (~x19 | ~x20 | x21);
  assign z12 = (x03 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n68_ & ~x08))) | (~x08 & new_n66_ & x09);
  ...
  assign z15 = (~x19 & (~x09 | (new_n81_ & ~x08))) | (x06 & x08) | (~x08 & new_n77_ & x09);
