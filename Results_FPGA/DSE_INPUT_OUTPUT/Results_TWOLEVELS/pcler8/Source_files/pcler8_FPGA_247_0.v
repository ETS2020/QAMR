...
module FAU ( 
  ...
  assign new_n68_ = ~x10 & ((x22 & (~x20 | new_n69_ | ~x21)) | (x21 & ~x22 & x19 & x20));
  ...
  assign z15 = (x06 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n85_ & ~x08))) | (~x08 & new_n80_ & x09);
  ...
  assign new_n85_ = ~x10 & x25;
  assign z16 = (~x19 & (~x09 | (new_n92_ & ~x08))) | (x07 & x08) | (~x08 & new_n87_ & x09);
