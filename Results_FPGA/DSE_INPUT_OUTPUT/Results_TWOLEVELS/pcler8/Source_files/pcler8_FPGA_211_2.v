...
module FAU ( 
  ...
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (x21 ? (new_n67_ | ~x20) : x20)) | (~x06 & ~x19 & x21));
  ...
  assign new_n71_ = ~x19 & (x06 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n76_ = (~x19 | ((~x24 | (new_n59_ & new_n77_)) & (~new_n59_ | ~new_n78_))) & (x06 | x19 | ~x24);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = (~x08 & x09 & ~new_n80_ & ~x10) | (x06 & x08 & x19);
  assign new_n80_ = (~x19 | ((~x25 | (new_n81_ & new_n82_)) & (~new_n81_ | ~new_n83_))) & (x06 | x19 | ~x25);
