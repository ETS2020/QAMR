...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (x01 | x09)) | (~x01 & ~x09) | (~x08 & x09 & ~new_n57_ & ~x10);
  assign new_n57_ = x19 & (~new_n58_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign z10 = (~x08 & x09 & ~new_n60_ & ~x10) | (~x01 & ~x09) | (x01 & x08);
  assign new_n60_ = x20 ? (x19 & (~new_n58_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = (x02 & x08 & (x01 | x09)) | (~x08 & x09 & ~new_n62_ & ~x10) | (~x01 & ~x09);
  ...
  assign z15 = (x06 & x08 & (x01 | x09)) | (~x08 & x09 & ~new_n76_ & ~x10) | (~x01 & ~x09);
