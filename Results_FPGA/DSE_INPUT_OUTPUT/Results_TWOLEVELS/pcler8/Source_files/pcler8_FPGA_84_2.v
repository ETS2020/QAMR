...
module FAU ( 
  ...
  assign z00 = (x01 & ~x19) | (new_n47_ & new_n49_ & ~x10 & x19 & x20);
  assign new_n47_ = new_n48_ & x21 & x24 & x25 & x26;
  assign new_n48_ = x22 & x23;
  assign new_n49_ = ~x08 & x09;
  assign z01 = x00 & x08 & (~x01 | x19);
  assign z02 = x19 & x01 & x08;
  assign z03 = x02 & x08 & (~x01 | x19);
  assign z04 = (x01 & ~x19) | (x03 & x08);
  assign z05 = (x01 & ~x19) | (x04 & x08 & (~x01 | x19));
  assign z06 = x05 & x08 & (~x01 | x19);
  assign z07 = x06 & x08 & (~x01 | x19);
  assign z08 = (x01 & ~x19) | (x07 & x08 & (~x01 | x19));
  assign z09 = z01 | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & ((~x01 & ~x19) | (new_n61_ & new_n60_ & x11 & x19));
  ...
  assign new_n66_ = ~x19 & (x01 | (new_n49_ & ~x10 & x21));
  assign new_n67_ = (~x21 | (~new_n68_ & x20)) & (~x19 | ~x20 | x21);
  assign new_n68_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = new_n70_ | (x03 & x08) | (~x08 & new_n71_ & x09);
  assign new_n70_ = ~x19 & (x01 | (new_n49_ & ~x10 & x22));
  assign new_n71_ = ~x10 & ((x22 & (~x20 | new_n72_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n72_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x01 & (new_n74_ | (x04 & x08))) | (x19 & (x08 ? x04 : new_n75_));
  assign new_n74_ = new_n49_ & ~x10 & ~x19 & x23;
  ...
  assign new_n80_ = ~x10 & ((x24 & (~new_n60_ | ~x22 | new_n81_ | ~x23)) | (new_n60_ & x22 & x23 & ~x24));
  assign new_n81_ = x16 & x25 & x26;
  assign z15 = z07 | new_n83_ | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n83_ = ~x19 & (x01 | (new_n49_ & ~x10 & x25));
  assign new_n84_ = (~x25 | ((new_n48_ | ~x19) & new_n60_ & ~new_n85_ & x24)) & (~new_n48_ | ~x24 | x25 | ~new_n60_ | ~x19);
