...
module FAU ( 
  ...
  assign new_n66_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x21));
  ...
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n79_ | new_n81_));
  assign new_n79_ = x25 & ((x19 & (~x22 | ~x24)) | (x22 & (~new_n80_ | ~x19 | ~x20)));
  assign new_n80_ = x21 & x23 & (~x17 | ~x26);
  assign new_n81_ = new_n82_ & x19 & x20 & x21;
  assign new_n82_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n86_));
  assign new_n84_ = x19 & ((~x22 & x26) | (new_n85_ & x20 & x21 & x22));
  assign new_n85_ = x23 & x24 & x25 & ~x26;
  assign new_n86_ = x26 & (~new_n87_ | x18 | ~x19 | ~x20);
  assign new_n87_ = x24 & x25 & x21 & (~x22 | x23);
endmodule
