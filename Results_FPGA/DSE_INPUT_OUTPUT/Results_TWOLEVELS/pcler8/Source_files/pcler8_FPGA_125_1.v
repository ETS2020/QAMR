...
module FAU ( 
  ...
  assign new_n63_ = (~x15 | ((~x19 | x20) & (~new_n65_ | ~new_n64_ | ~x12 | ~x20))) & (x19 | ~x20);
  ...
  assign new_n74_ = (x19 | ~x23) & (~x15 | ((~x19 | ~new_n75_ | ~x20) & (~x23 | (new_n64_ & x20))));
  assign new_n75_ = x21 & x22 & (~x23 | (x23 & x24 & x25 & x26));
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x19 | ~x24) & (~x15 | ((~x24 | (new_n60_ & new_n78_)) & (~new_n79_ | ~new_n60_ | ~x19)));
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (x15 | ~x19)) | (x19 & (new_n81_ | ~x15)) | (new_n83_ & ~x08);
  assign new_n81_ = new_n82_ & new_n48_ & ~x10 & x20;
  ...
  assign new_n86_ = x19 & (~x15 | (new_n87_ & new_n48_ & new_n60_ & ~x10));
