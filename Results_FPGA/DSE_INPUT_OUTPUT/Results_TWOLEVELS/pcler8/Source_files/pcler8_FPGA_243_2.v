...
module FAU ( 
  ...
  assign z12 = (~x08 & x09 & ~new_n67_ & ~x10) | (x03 & x08 & x19);
  assign new_n67_ = (~x19 | ((~x22 | (x20 & ~new_n68_ & x21)) & (~x20 | ~x21 | x22))) & (x03 | x19 | ~x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~x03 & (new_n73_ | (x04 & x08))) | (x19 & (x08 ? x04 : new_n70_));
  assign new_n70_ = x09 & ~x10 & ((x23 & (~new_n71_ | new_n72_ | ~x22)) | (new_n71_ & x22 & ~x23));
  assign new_n71_ = x20 & x21;
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = ~x08 & x09 & ~x10 & ~x19 & x23;
  assign z14 = new_n75_ | (x19 & (x08 ? x05 : (new_n77_ & x09)));
  assign new_n75_ = ~new_n76_ & ~x03;
  assign new_n76_ = (~x05 | ~x08) & (x08 | ~x09 | x10 | x19 | ~x24);
  assign new_n77_ = ~x10 & ((x24 & (~new_n71_ | ~x22 | new_n78_ | ~x23)) | (new_n71_ & x22 & x23 & ~x24));
  ...
  assign new_n89_ = ~x19 & (x03 | (~x10 & x26 & ~x08 & x09));
endmodule
