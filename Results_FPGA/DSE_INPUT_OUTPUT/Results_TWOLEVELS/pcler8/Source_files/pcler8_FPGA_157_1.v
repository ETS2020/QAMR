...
module FAU ( 
  ...
  assign z00 = x19 & (~x14 | (new_n47_ & new_n49_ & ~x10 & x14 & x20));
  ...
  assign new_n78_ = x14 & (~new_n79_ | ~x21 | ~x22 | ~x23 | x24);
  assign new_n79_ = ~x08 & x09 & ~x10 & x20;
  assign new_n80_ = ~x10 & x24 & (~new_n81_ | ~new_n74_ | ~x19);
  assign new_n81_ = x22 & x23 & (~x14 | ~x16 | ~x25 | ~x26);
  assign z15 = (x19 & (new_n83_ | ~x14)) | (x06 & x08) | (new_n84_ & ~x08);
  assign new_n83_ = new_n79_ & x21 & x22 & x23 & x24 & ~x25;
  assign new_n84_ = x09 & ~x10 & x25 & (~new_n85_ | ~new_n74_ | ~x19);
  assign new_n85_ = x22 & x23 & x24 & (~x14 | ~x17 | ~x24 | ~x26);
  assign z16 = (~new_n87_ & x19) | (x07 & x08) | (~x08 & new_n89_ & x09);
  assign new_n87_ = x14 & (~new_n88_ | ~new_n48_ | ~x24 | ~x25 | x26);
