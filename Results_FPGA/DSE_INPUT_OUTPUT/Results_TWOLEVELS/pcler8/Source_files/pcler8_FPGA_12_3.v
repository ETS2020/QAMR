...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (~x14 | ~x19)) | (x19 & (new_n70_ | x14)) | (new_n68_ & ~x08);
  ...
  assign new_n72_ = (x14 | (~new_n75_ & (~x23 | (new_n73_ & new_n74_)))) & (x19 | ~x23);
  ...
  assign new_n77_ = (x19 | ~x24) & (x14 | ((~x24 | (new_n73_ & new_n78_)) & (~new_n79_ | ~new_n73_ | ~x19)));
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n81_ | new_n85_));
  assign new_n81_ = ~x14 & ((new_n69_ & new_n84_) | (x25 & (~new_n82_ | ~new_n83_)));
  ...
  assign new_n87_ = ~x14 & (~new_n48_ | ~new_n88_);
  assign new_n88_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n73_ | x18 | ~x19);
