...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (x09 | ~x19)) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x19 & (new_n66_ | (x20 & x21 & ~x22))) | (x22 & (~x19 | ~x20 | ~x21)));
  assign new_n66_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & ~x10 & (new_n68_ | new_n71_));
  assign new_n68_ = x19 & ((new_n70_ & x22 & ~x23) | (new_n69_ & x15 & x23));
  assign new_n69_ = x24 & x25 & x26;
  assign new_n70_ = x20 & x21;
  assign new_n71_ = x09 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = z06 | (~x08 & ~x10 & (new_n73_ | (new_n75_ & x09)));
  assign new_n73_ = x19 & (new_n74_ | (new_n70_ & x22 & x23 & ~x24));
