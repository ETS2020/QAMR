...
module FAU ( 
  ...
  assign z10 = (new_n63_ & x09) | (x01 & x08) | (~x01 & x19);
  assign new_n63_ = ~x10 & ((x19 & ((new_n64_ & new_n65_) | ~x20)) | (~x08 & ~x19 & x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (x01 | ~x19)) | (new_n67_ & ~x08) | ((new_n69_ | ~x01) & x19);
  assign new_n67_ = x09 & ~x10 & x21 & (~x19 | new_n68_ | ~x20);
  assign new_n68_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign z12 = ((new_n73_ | ~x01) & x19) | (new_n71_ & ~x08) | (x03 & x08);
  ...
  assign z13 = (new_n51_ & x04) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (x19 | ~x23) & (~x01 | (~new_n77_ & ((new_n48_ & new_n76_) | ~x23)));
  assign new_n76_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n77_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x19 | ~x24) & (~x01 | (((new_n48_ & new_n80_) | ~x24) & (~new_n81_ | ~new_n48_ | ~x19)));
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n81_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (x01 | ~x19)) | ((new_n83_ | ~x01) & x19) | (new_n85_ & ~x08);
  assign new_n83_ = new_n84_ & ~x08 & x09 & ~x10 & x20;
  assign new_n84_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n85_ = x09 & ~x10 & x25 & (~new_n86_ | ~new_n48_ | ~x19);
  assign new_n86_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n59_ | (~x08 & x09 & ~x10 & (new_n88_ | new_n93_));
  assign new_n88_ = x01 & (((~new_n89_ | ~new_n90_) & x26) | (new_n91_ & new_n92_));
