...
module FAU ( 
  ...
  assign new_n82_ = (~x25 | (new_n84_ & new_n85_)) & (~new_n83_ | ~new_n49_ | ~x24 | x25);
  assign new_n83_ = x19 & x20 & x21;
  assign new_n84_ = x20 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = ~x19 & (~x18 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n59_ | (~x08 & x09 & ~x10 & (new_n88_ | new_n89_));
  assign new_n88_ = x19 & ((x26 & (~new_n84_ | ~x23 | ~x24 | ~x25)) | (new_n84_ & x23 & x24 & x25 & ~x26));
