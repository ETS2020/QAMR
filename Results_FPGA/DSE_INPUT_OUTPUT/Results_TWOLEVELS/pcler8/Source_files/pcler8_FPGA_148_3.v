...
module FAU ( 
  ...
  assign new_n78_ = (x19 | ~x24) & (x13 | ((new_n81_ | ~x24) & (~x19 | (~new_n79_ & ~new_n80_))));
  assign new_n79_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n80_ = x16 & x24 & x25 & x26;
  assign new_n81_ = x20 & x21 & x22 & x23;
  assign z15 = (x06 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n83_ & ~x10);
  ...
  assign new_n87_ = ~x13 & (((~new_n88_ | ~new_n89_) & x26) | (new_n90_ & new_n91_));
