...
module FAU ( 
  ...
  assign z09 = z01 | (new_n57_ & new_n58_ & x21 & x22 & x23);
  assign new_n57_ = x11 & x19 & x20 & ~x08 & x09 & ~x10;
  assign new_n58_ = x24 & x25 & x26;
  assign z10 = (x01 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n60_ & x19);
  assign new_n60_ = x20 & (~new_n62_ | ~x12 | ~new_n61_ | ~x23 | ~x24);
  assign new_n61_ = x25 & x26;
  assign new_n62_ = x21 & x22;
  assign z11 = (x02 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n64_ & x19);
  assign new_n64_ = x21 ? (x20 & (~new_n58_ | ~x13 | ~x22 | ~x23)) : ~x20;
  assign z12 = (x03 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n66_ & x19);
  assign new_n66_ = (~x22 | (x20 & x21 & (~new_n58_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n68_ & x19);
  assign new_n68_ = (~x23 | (new_n69_ & x22 & (~new_n61_ | ~x15 | ~x24))) & (~new_n69_ | ~x22 | x23);
  assign new_n69_ = x20 & x21;
  assign z14 = (x05 & x08) | (x09 & (~x19 | (~x08 & ~new_n71_ & ~x10)));
  assign new_n71_ = (~x24 | (~new_n72_ & x20 & x23)) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n72_ = x19 & (~x21 | ~x22 | (x16 & x25 & x26));
  assign z15 = (x06 & x08) | (x09 & (~x19 | (~x08 & ~new_n74_ & ~x10)));
  assign new_n74_ = (~x25 | (~new_n75_ & x20 & x23 & x24)) & (~x23 | ~x24 | x25 | ~new_n62_ | ~x20);
  assign new_n75_ = x19 & (~x21 | ~x22 | (x17 & x26));
  assign z16 = (x07 & x08) | (x09 & (~x19 | (new_n77_ & ~x08)));
  assign new_n77_ = ~x10 & ((x26 & (~new_n79_ | ~new_n80_)) | (new_n78_ & new_n81_));
