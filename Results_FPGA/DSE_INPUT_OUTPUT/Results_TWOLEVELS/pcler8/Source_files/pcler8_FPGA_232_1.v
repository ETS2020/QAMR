...
module FAU ( 
  ...
  assign new_n63_ = (~x19 | ((~x20 | x21) & (~new_n58_ | ~x13 | ~x21 | ~x22))) & (~x21 | (x19 & x20));
  ...
  assign z13 = z05 | (~x08 & ~x10 & (new_n71_ | (~new_n68_ & x19)));
  assign new_n68_ = (~new_n70_ | ~x22 | x23) & (~new_n69_ | ~x24 | ~x15 | ~x23);
  assign new_n69_ = x25 & x26;
  assign new_n70_ = x20 & x21;
  assign new_n71_ = x09 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x19 | (~new_n74_ & (~new_n69_ | ~x16 | ~x24))) & (new_n75_ | ~x24);
  assign new_n74_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n75_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = z07 | (~x08 & ~new_n77_ & ~x10);
  ...
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (x19 & (new_n82_ | ~x09)) | (~x08 & new_n84_ & x09);
  assign new_n82_ = new_n83_ & new_n70_ & ~x08 & ~x10;
  assign new_n83_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n84_ = ~x10 & x26 & (~new_n85_ | ~new_n70_ | x18 | ~x19);
