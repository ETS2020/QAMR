...
module FAU ( 
  ...
  assign z12 = (~x19 & (~x09 | (new_n68_ & ~x08))) | (x03 & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x22 & (~x20 | new_n67_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  ...
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x25 | (new_n79_ & new_n58_ & x20)) & (~new_n75_ | ~new_n80_);
  assign new_n79_ = x23 & x24 & (~x17 | ~x26);
  assign new_n80_ = x22 & x23 & x24 & ~x25;
  assign new_n81_ = ~x19 & (~x09 | (~x08 & ~x10 & x25));
