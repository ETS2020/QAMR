...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n60_ | ~x11 | x18 | ~x20 | ~x21);
  assign new_n60_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = (x01 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (x18 | ~x19 | ((~new_n63_ | ~new_n64_) & x20)) & (x19 | ~x20);
  ...
  assign new_n79_ = (x18 | ((new_n82_ | ~x25) & (~x19 | (~new_n80_ & ~new_n81_)))) & (x19 | ~x25);
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x17 & x25 & x26;
  assign new_n82_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = new_n84_ | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n84_ = x19 & (x18 | (new_n86_ & new_n85_ & ~x08 & x09));
  assign new_n85_ = ~x10 & x20 & x21;
  assign new_n86_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | ~x19 | ~x20 | ~x21);
