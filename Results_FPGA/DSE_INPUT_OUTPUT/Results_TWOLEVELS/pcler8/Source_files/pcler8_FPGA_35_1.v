...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n61_ | ~new_n60_ | ~x11 | ~x17);
  ...
  assign new_n74_ = (~x17 | ((~x19 | ((x22 | ~x23) & (~new_n60_ | ~x22 | x23))) & (new_n75_ | ~x23))) & (x19 | ~x23);
  assign new_n75_ = x20 & x21 & (~x25 | ~x26 | ~x15 | ~x24);
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x19 | ~x24) & (~x17 | (((new_n60_ & new_n78_) | ~x24) & (~new_n79_ | ~new_n60_ | ~x19)));
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x19 | ~x20 | ~new_n82_ | ~x21) & (~x25 | (new_n83_ & x19 & x20 & x21));
  assign new_n82_ = x22 & x23 & x24 & (~x25 | (x17 & x25 & x26));
