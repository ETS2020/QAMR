...
module FAU ( 
  ...
  assign z10 = (new_n49_ & x01) | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x19 | (x20 & (~new_n62_ | ~new_n63_))) & (~x14 | x19 | ~x20);
  ...
  assign new_n68_ = (~x22 | ((~x14 | (~new_n63_ & x19)) & (~x19 | (x20 & x21)))) & (~x19 | ~x20 | ~x21 | x22);
  assign z13 = z05 | new_n72_ | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x23 | ((~x19 | (~new_n71_ & x21)) & x20 & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x19 & (~x14 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | new_n77_ | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = ~new_n76_ & (~x24 | (~new_n75_ & x20 & x22 & x23));
  assign new_n75_ = x19 & (~x21 | (x16 & x25 & x26));
  ...
  assign new_n85_ = x19 & (x18 | ~x24);
  assign new_n86_ = x20 & x21 & x22 & x23 & x25;
