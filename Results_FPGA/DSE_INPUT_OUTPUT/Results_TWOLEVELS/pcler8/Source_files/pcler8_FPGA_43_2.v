...
module FAU ( 
  ...
  assign z10 = (x01 & ~new_n51_ & x08) | new_n51_ | (~x08 & ~new_n63_ & x09);
  assign new_n63_ = (x10 | ~x20 | (x19 & (~new_n61_ | ~new_n64_))) & (~x19 | x20);
  ...
  assign new_n70_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n74_ | (x04 & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x23 | (x19 & x21 & ~new_n73_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign new_n74_ = ~x20 & (x10 | (~x08 & x09 & x23));
  assign z14 = (x05 & x08 & (~x10 | x20)) | (~x08 & x09 & ~new_n76_ & ~x10);
  ...
  assign z16 = z08 | new_n87_ | (~x08 & new_n82_ & x09);
  ...
  assign new_n87_ = ~x20 & (x10 | (~x08 & x09 & x26));
endmodule
