...
module FAU ( 
  ...
  assign new_n80_ = (~x19 | (~new_n81_ & (~x17 | ~x25 | ~x26))) & (new_n82_ | ~x25);
  assign new_n81_ = x23 & x24 & ~x25 & x20 & x21 & x22;
  assign new_n82_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (~x25 | (~new_n86_ & (~new_n85_ | ~x23 | ~x24 | x26))) & (~x26 | (new_n85_ & x23 & x24 & x25));
  assign new_n85_ = x20 & x21 & x22;
  assign new_n86_ = x18 & x19 & x26;
endmodule
