...
module FAU ( 
  ...
  assign z00 = ~x10 & (~x16 | (new_n47_ & ~x08 & x09 & new_n50_ & x16));
  ...
  assign z13 = (x04 & x08 & (x10 | x16)) | (~x10 & (~x16 | (~x08 & ~new_n69_ & x09)));
  assign new_n69_ = (~x23 | (new_n50_ & (~x16 | x21) & ~new_n70_ & x22)) & (~new_n50_ | ~x21 | ~x22 | x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (x10 | x16)) | (~x08 & x09 & ~x10 & ~new_n72_ & x16);
  assign new_n72_ = (~x19 | ~x20 | ~new_n73_ | ~x21) & (~x24 | (x19 & x20 & new_n48_ & x21));
  assign new_n73_ = x22 & x23 & (~x24 | (x24 & x25 & x26));
  assign z15 = (x06 & x08 & (x10 | x16)) | (~x08 & x09 & ~x10 & ~new_n75_ & x16);
  assign new_n75_ = (~x25 | (new_n76_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n76_ | ~new_n48_ | ~x24 | x25);
  assign new_n76_ = x19 & x20 & x21;
  assign z16 = z08 | (~x08 & x09 & new_n78_ & ~x10);
  assign new_n78_ = x16 & ((new_n81_ & new_n82_) | (x26 & (~new_n79_ | ~new_n80_)));
