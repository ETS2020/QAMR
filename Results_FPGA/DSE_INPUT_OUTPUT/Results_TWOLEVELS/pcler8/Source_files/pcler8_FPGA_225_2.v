...
module FAU ( 
  ...
  assign new_n72_ = ~x19 & (x11 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (x11 | x19 | ~x23) & (~x19 | ((~x23 | (new_n60_ & ~new_n75_ & x22)) & (~new_n60_ | ~x22 | x23)));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x11 | x19 | ~x24) & (~x19 | ((~x24 | (new_n60_ & new_n78_)) & (~new_n60_ | ~new_n79_)));
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (new_n50_ & x06) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x11 | x19 | ~x25) & (~x19 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_)));
  assign new_n82_ = x20 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x23 & x24 & ~x25;
  assign z16 = new_n57_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n90_));
