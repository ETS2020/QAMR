...
module FAU ( 
  ...
  assign new_n71_ = (~x22 | ((~x23 | (x20 & ~new_n72_ & x21)) & (~x19 | ~x20 | ~x21 | x23))) & (x19 | ~x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x19 & (new_n74_ | ~x22)) | (x05 & x08) | (new_n76_ & ~x08);
  assign new_n74_ = ~x08 & x09 & ~x10 & new_n75_ & x23 & ~x24;
  assign new_n75_ = x20 & x21;
  assign new_n76_ = x09 & ~x10 & x24 & (~new_n77_ | ~x19 | ~x20);
  assign new_n77_ = x21 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (new_n51_ & x06) | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((x22 & (new_n81_ | (~new_n80_ & x25))) | (~x19 & x25));
  assign new_n80_ = x20 & x21 & x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x19 & x20 & x21 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x19 | ~x26) & (~x22 | ((new_n84_ | ~x26) & (~new_n85_ | ~new_n75_ | ~x19)));
  assign new_n84_ = ~x18 & x20 & x21 & x23 & x24 & x25;
