...
module FAU ( 
  ...
  assign new_n75_ = (x19 | ~x24) & (x02 | ((~x19 | (~new_n76_ & ~new_n77_)) & (new_n78_ | ~x24)));
  ...
  assign new_n80_ = (x19 | ~x25) & (x02 | ((~x19 | (~new_n81_ & ~new_n82_)) & (new_n83_ | ~x25)));
  ...
  assign new_n85_ = ~x02 & (~new_n86_ | x08 | ~x09 | ~new_n60_ | x10);
