...
module FAU ( 
  ...
  assign new_n63_ = ~x10 & ((x19 & (~x20 | (new_n64_ & new_n65_))) | (x15 & ~x19 & x20));
  ...
  assign new_n76_ = (~x15 | x19 | ~x24) & (~x19 | ((~x24 | (new_n60_ & new_n77_)) & (~new_n60_ | ~new_n78_)));
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24;
  assign z15 = new_n85_ | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((x25 & (~new_n81_ | ~new_n82_)) | (new_n83_ & new_n84_));
