...
module FAU ( 
  ...
  assign z12 = z04 | (~x08 & ~new_n64_ & ~x10);
  assign new_n64_ = (~x19 | (~new_n65_ & (~x20 | ~x21 | x22))) & (~x09 | ~x22 | (x19 & x20 & x21));
  assign new_n65_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x19 | (~new_n68_ & (~x20 | ~x21 | ~x22 | x23))) & (~x23 | (x19 & x20 & x21 & x22));
  assign new_n68_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & ~x10 & (new_n72_ | (~new_n70_ & x19)));
  assign new_n70_ = ~new_n71_ & (~x16 | ~x24 | ~x25 | ~x26);
  ...
  assign new_n75_ = (~x19 | (~new_n76_ & ~new_n77_)) & (~x09 | new_n78_ | ~x25);
