...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n48_, new_n56_, new_n59_, new_n60_, new_n62_, new_n63_,
  ...
  assign z00 = x19 & (x16 | (new_n47_ & new_n48_ & x22 & x23));
  assign new_n47_ = ~x08 & x09 & ~x10 & x20 & x21;
  assign new_n48_ = x24 & x25 & x26;
  assign z01 = x00 & x08 & (~x16 | ~x19);
  assign z02 = x01 & x08 & (~x16 | ~x19);
  assign z03 = (x16 & x19) | (x02 & x08);
  assign z04 = (x16 & x19) | (x03 & x08);
  assign z05 = x04 & x08 & (~x16 | ~x19);
  assign z06 = x05 & x08 & (~x16 | ~x19);
  assign z07 = new_n56_ | (x16 & x19);
  assign new_n56_ = x06 & x08 & (~x16 | ~x19);
  assign z08 = x07 & x08 & (~x16 | ~x19);
  assign z09 = z01 | (~x08 & x09 & ~x10 & (new_n59_ | ~x19));
  assign new_n59_ = new_n48_ & x22 & x23 & new_n60_ & x11 & ~x16;
  assign new_n60_ = x20 & x21;
  assign z10 = z02 | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((~x16 & x19 & (~x20 | (new_n63_ & new_n64_))) | (~x19 & x20));
  ...
  assign new_n68_ = ~x16 & (x08 | ~x09 | x10 | ~x20 | x21);
  assign z12 = (x03 & x08) | (new_n70_ & ~x08) | (x19 & (new_n72_ | x16));
  ...
  assign z13 = (x04 & x08 & (~x16 | ~x19)) | (x19 & (new_n74_ | x16)) | (new_n75_ & ~x08);
  ...
  assign new_n78_ = (x16 | ((~x24 | (new_n60_ & x22 & x23)) & (~new_n60_ | ~x19 | ~x22 | ~x23 | x24))) & (x19 | ~x24);
  assign z15 = new_n56_ | (~x08 & x09 & ~x10 & (new_n80_ | new_n85_));
  assign new_n80_ = ~x16 & ((new_n81_ & new_n84_) | (x25 & (~new_n82_ | ~new_n83_)));
  ...
  assign new_n87_ = ~x16 & (~new_n47_ | ~new_n88_);
