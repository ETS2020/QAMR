...
module FAU ( 
  ...
  assign new_n64_ = (x04 | ((~x19 | x20) & (~new_n62_ | ~new_n61_ | ~x12 | ~x20))) & (x19 | ~x20);
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((~x04 & ((x21 & (new_n67_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x19 & (new_n71_ | x04)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign z13 = (x04 & (x19 | (x08 & ~x19))) | (~x08 & x09 & ~new_n73_ & ~x10);
  ...
  assign new_n76_ = (x19 | ~x24) & (x04 | (((new_n77_ & new_n78_) | ~x24) & (~new_n79_ | ~new_n77_ | ~x19)));
  assign new_n77_ = x20 & x21;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (~x04 | ~x19)) | (x19 & (new_n81_ | x04)) | (new_n83_ & ~x08);
  assign new_n81_ = new_n82_ & ~x08 & x09 & ~x10 & x20;
  assign new_n82_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n83_ = x09 & ~x10 & x25 & (~new_n84_ | ~new_n77_ | ~x19);
  assign new_n84_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~new_n86_ & x19) | (~x08 & new_n87_ & x09);
  assign new_n86_ = ~x04 & (~new_n48_ | ~new_n49_ | ~x24 | ~x25 | x26);
