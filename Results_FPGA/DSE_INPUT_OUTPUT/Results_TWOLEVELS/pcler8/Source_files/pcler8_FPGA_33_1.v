...
module FAU ( 
  ...
  assign z14 = z06 | (~x08 & ~x10 & (new_n74_ | (~new_n72_ & x19)));
  assign new_n72_ = ~new_n73_ & (~x16 | ~x24 | ~x25 | ~x26);
  assign new_n73_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n74_ = x09 & x24 & (~x19 | ~x20 | ~new_n48_ | ~x21);
  assign z15 = (x06 & x08 & (x09 | ~x19)) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x25 | (new_n77_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n77_ | ~new_n48_ | ~x24 | x25);
