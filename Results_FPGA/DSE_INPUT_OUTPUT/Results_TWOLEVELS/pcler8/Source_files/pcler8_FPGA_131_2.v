...
module FAU ( 
  ...
  assign new_n74_ = x19 & (~x22 | ~x23);
  assign new_n75_ = x20 & x21 & x24 & (~x17 | ~x26);
  assign new_n76_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = (x07 & x08 & (~x09 | x19)) | (x09 & (~x19 | (~x08 & ~new_n78_ & ~x10)));
  assign new_n78_ = (~x26 | (~new_n74_ & new_n80_)) & (~new_n79_ | ~new_n63_ | ~x25 | x26);
  assign new_n79_ = x20 & x21 & x22;
  assign new_n80_ = ~x18 & x20 & x21 & x24 & x25;
endmodule
