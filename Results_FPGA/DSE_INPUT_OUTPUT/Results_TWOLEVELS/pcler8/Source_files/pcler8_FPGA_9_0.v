...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (x09 | x19)) | (~x08 & x09 & ~x10 & (new_n58_ | ~x19));
  assign new_n58_ = new_n59_ & x21 & x22 & x11 & x20;
  ...
  assign new_n79_ = ~x10 & ((x25 & (~new_n80_ | ~new_n48_ | new_n81_ | ~x24)) | (new_n80_ & new_n48_ & x24 & ~x25));
  assign new_n80_ = x19 & x20 & x21;
  assign new_n81_ = x17 & x26;
  assign z16 = (~x19 & (~x09 | (new_n88_ & ~x08))) | (x07 & x08) | (~x08 & new_n83_ & x09);
