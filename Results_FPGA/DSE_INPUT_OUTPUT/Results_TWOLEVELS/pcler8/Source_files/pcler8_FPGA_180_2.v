...
module FAU ( 
  ...
  assign z12 = (x03 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  ...
  assign new_n85_ = ~x19 & (x18 | (~x10 & x25 & ~x08 & x09));
  assign z16 = new_n91_ | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n87_ = ~x10 & ((new_n89_ & new_n90_) | (x26 & (~new_n83_ | ~new_n88_)));
  assign new_n88_ = x24 & x25 & x22 & (x18 | x23);
  assign new_n89_ = x21 & x22 & x19 & x20;
  assign new_n90_ = x23 & x24 & x25 & ~x26;
  assign new_n91_ = x18 & (~x19 | (~x10 & x26 & ~x08 & x09));
endmodule
