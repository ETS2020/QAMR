...
module FAU ( 
  ...
  assign z14 = (x05 & x08 & (~x10 | x19)) | (~x08 & x09 & ~new_n75_ & ~x10);
  ...
  assign new_n79_ = (~x25 | (new_n76_ & new_n80_ & x24 & (~x17 | ~x26))) & (~new_n76_ | ~new_n80_ | ~x24 | x25);
  ...
  assign new_n87_ = ~x19 & (x10 | (~x08 & x09 & x26));
endmodule
