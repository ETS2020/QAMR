...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n60_, new_n62_, new_n63_,
    ...
    new_n91_, new_n92_;
  assign z00 = x19 & (x06 | (new_n47_ & new_n48_));
  ...
  assign z04 = (x06 & x19) | (x03 & x08 & (~x06 | ~x19));
  assign z05 = new_n50_ & x04;
  assign z06 = new_n50_ & x05;
  assign z07 = x06 & (x19 | (x08 & ~x19));
  assign z08 = (x06 & x19) | (x07 & x08);
  assign z09 = z01 | (~x08 & x09 & ~new_n59_ & ~x10);
  assign new_n59_ = x19 & (~new_n48_ | ~new_n60_ | x06 | ~x11);
  assign new_n60_ = x20 & x21;
  assign z10 = z02 | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((~x06 & x19 & ((new_n63_ & new_n64_) | ~x20)) | (~x19 & x20));
  ...
  assign new_n70_ = (x06 | ((~x22 | (x20 & ~new_n71_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (x19 | ~x23) & (x06 | (~new_n75_ & ((new_n60_ & new_n74_) | ~x23)));
  assign new_n74_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n75_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (x05 & x08 & (~x06 | ~x19)) | (x19 & (new_n77_ | x06)) | (new_n79_ & ~x08);
  assign new_n77_ = new_n78_ & ~x08 & x09 & ~x10 & x20;
  assign new_n78_ = x21 & x22 & x23 & ~x24;
  assign new_n79_ = x09 & ~x10 & (~new_n80_ | ~new_n81_) & x24;
  assign new_n80_ = x19 & x20 & x21;
  assign new_n81_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (~x19 & ((x06 & x08) | (new_n87_ & ~x08 & x09))) | (~x06 & ~x08 & new_n83_ & x09);
  assign new_n83_ = ~x10 & ((new_n80_ & new_n86_) | ((~new_n84_ | ~new_n85_) & x25));
  assign new_n84_ = x20 & x21 & x22;
  assign new_n85_ = x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x22 & x23 & x24 & ~x25;
  assign new_n87_ = ~x10 & x25;
  assign z16 = new_n89_ | (x07 & x08) | (~x08 & new_n91_ & x09);
  assign new_n89_ = x19 & (x06 | (new_n47_ & new_n90_ & x22 & x23));
