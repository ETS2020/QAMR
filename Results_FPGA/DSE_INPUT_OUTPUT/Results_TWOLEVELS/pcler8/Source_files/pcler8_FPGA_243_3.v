// Benchmark "FAU" written by ABC on Mon Aug 24 16:59:31 2020
...
module FAU ( 
  ...
  assign new_n50_ = x08 & (~x03 | ~x19);
  assign z02 = (x03 & x19) | (x01 & x08 & (~x03 | ~x19));
  assign z03 = new_n50_ & x02;
  assign z04 = x03 & x08 & ~x19;
  assign z05 = (x03 & x19) | (x04 & x08 & (~x03 | ~x19));
  assign z06 = new_n50_ & x05;
  assign z07 = new_n50_ & x06;
  assign z08 = new_n50_ & x07;
  assign z09 = (x00 & x08 & (~x03 | ~x19)) | (x03 & x19) | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & (~x19 | (new_n61_ & new_n60_ & x11 & x20));
  assign new_n60_ = x21 & x22;
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = (new_n50_ & x01) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (x03 | ((~new_n61_ | ~new_n60_ | ~x12 | ~x20) & (~x19 | x20))) & (x19 | ~x20);
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((~x03 & ((x21 & (new_n66_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (~x19 & ((x03 & x08) | (new_n70_ & ~x08 & x09))) | (~x03 & ~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x22 & (~x20 | new_n69_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign new_n70_ = ~x10 & x22;
  assign z13 = (new_n50_ & x04) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (x19 | ~x23) & (x03 | ((~x19 | (~new_n73_ & ~new_n74_)) & (new_n75_ | ~x23)));
  ...
  assign new_n77_ = (x19 | ~x24) & (x03 | ((~x19 | (~new_n78_ & ~new_n79_)) & (new_n80_ | ~x24)));
  assign new_n78_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n79_ = x16 & x24 & x25 & x26;
  assign new_n80_ = x20 & x21 & x22 & x23;
  assign z15 = new_n82_ | new_n84_ | new_n89_ | (~x08 & new_n87_ & x09);
  assign new_n82_ = ~x03 & ((x06 & x08) | (new_n83_ & ~x08 & x09 & ~x10));
  assign new_n83_ = x17 & x19 & x25 & x26;
  assign new_n84_ = x19 & (x03 | (new_n86_ & new_n85_ & ~x10 & x20));
  assign new_n85_ = ~x08 & x09;
  assign new_n86_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n87_ = ~x10 & x25 & (~new_n88_ | ~x22 | ~x23 | ~x24);
  assign new_n88_ = x20 & x21;
  assign new_n89_ = ~x19 & ((x06 & x08) | (~x10 & x25 & ~x08 & x09));
  assign z16 = z08 | new_n91_ | (~x08 & new_n93_ & x09);
  assign new_n91_ = x19 & (x03 | (new_n92_ & new_n85_ & new_n88_ & ~x10));
  assign new_n92_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n93_ = ~x10 & x26 & (~new_n94_ | ~new_n88_ | x18 | ~x19);
