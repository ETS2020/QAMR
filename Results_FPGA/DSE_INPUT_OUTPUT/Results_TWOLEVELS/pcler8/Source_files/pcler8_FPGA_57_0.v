...
module FAU ( 
  ...
  assign z11 = new_n66_ | (~x08 & x09 & ~x10 & ~new_n64_ & x19);
  assign new_n64_ = x21 ? (~new_n65_ & x20) : ~x20;
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n66_ = x02 & (x08 | (x09 & ~x10 & ~x19 & x21));
  ...
  assign new_n70_ = ~x08 & x09 & ~x10 & ~x19 & x22;
  assign z13 = (x02 & (new_n75_ | (x04 & x08))) | (x19 & (x08 ? x04 : new_n72_));
  assign new_n72_ = x09 & ~x10 & ((x23 & (~new_n73_ | new_n74_ | ~x22)) | (new_n73_ & x22 & ~x23));
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign new_n75_ = ~x08 & x09 & ~x10 & ~x19 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x19 | (~new_n79_ & (~new_n78_ | ~x16 | ~x24))) & (new_n80_ | ~x24);
  ...
  assign new_n82_ = x09 & ~x10 & ((x25 & (~new_n83_ | ~new_n84_)) | (new_n83_ & new_n85_));
