...
module FAU ( 
  ...
  assign new_n58_ = (x19 | x20) & (~new_n59_ | ~new_n60_ | ~x11 | ~x19 | ~x20 | ~x21);
  ...
  assign new_n65_ = x20 ? (x21 & (~new_n60_ | ~new_n59_ | ~x13)) : ~x21;
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x20 | ((~x21 | x22) & (~new_n60_ | ~x14 | ~x22 | ~x23))) & (~x22 | (x20 & x21));
  assign z13 = z05 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x20 | ((~x21 | ~x22 | x23) & (~new_n60_ | ~x15 | ~x23))) & (~x23 | (x20 & x21 & x22));
  assign z14 = z06 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x19 | ((~x20 | (~new_n72_ & ~new_n73_)) & (new_n74_ | ~x24))) & (x20 | ~x24);
  ...
  assign new_n76_ = (~x19 | ((~x20 | (~new_n77_ & ~new_n78_)) & (new_n79_ | ~x25))) & (x20 | ~x25);
  ...
  assign new_n81_ = (x20 | ~x26) & (~x19 | ((~x20 | (~new_n82_ & (~x18 | ~x26))) & (new_n83_ | ~x26)));
