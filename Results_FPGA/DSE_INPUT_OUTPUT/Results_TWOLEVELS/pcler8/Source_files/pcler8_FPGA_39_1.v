...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n58_, new_n59_, new_n61_, new_n62_, new_n64_,
    ...
    new_n84_, new_n85_;
  assign z00 = x19 & (~x09 | (new_n47_ & new_n48_ & x22 & x23));
  ...
  assign new_n67_ = (~x22 | (new_n68_ & x21 & (~new_n48_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  ...
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (x19 & (new_n82_ | ~x09)) | (~x08 & new_n83_ & x09);
  assign new_n82_ = new_n47_ & x22 & x23 & x24 & x25 & ~x26;
