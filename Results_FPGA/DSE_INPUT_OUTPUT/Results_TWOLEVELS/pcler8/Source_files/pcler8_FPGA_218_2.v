...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n60_, new_n61_, new_n63_,
    ...
    new_n84_, new_n85_;
  assign z00 = x19 & (~x21 | (new_n47_ & new_n48_ & x22 & x23));
  ...
  assign new_n59_ = ~x10 & (~x19 | (new_n61_ & new_n60_ & x11));
  ...
  assign z11 = z03 | (~x08 & x09 & ~x10 & ~new_n65_ & x21);
  assign new_n65_ = x19 & (~new_n48_ | ~x13 | ~x22 | ~x23) & (~x19 | x20);
  assign z12 = (~new_n69_ & x19) | (x03 & x08) | (new_n67_ & ~x08);
  assign new_n67_ = x09 & ~x10 & x22 & (~new_n68_ | ~x19);
  assign new_n68_ = x20 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n69_ = x21 & (x08 | ~x09 | x10 | ~x20 | x22);
  assign z13 = (x04 & x08) | (new_n71_ & ~x08) | (x19 & (new_n73_ | ~x21));
  assign new_n71_ = x09 & ~x10 & x23 & (~new_n72_ | ~x19 | ~x20);
  assign new_n72_ = x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n73_ = ~x08 & x09 & ~x10 & x20 & x22 & ~x23;
  assign z14 = (x05 & x08 & (~x19 | x21)) | (x19 & (new_n75_ | ~x21)) | (new_n76_ & ~x08);
  assign new_n75_ = ~x08 & x09 & ~x10 & new_n60_ & x23 & ~x24;
  assign new_n76_ = x09 & ~x10 & x24 & (~new_n77_ | ~x19 | ~x20);
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((x21 & (new_n81_ | (~new_n80_ & x25))) | (~x19 & x25));
  ...
  assign new_n83_ = (x19 | ~x26) & (~x21 | ((new_n84_ | ~x26) & (~new_n85_ | ~new_n60_ | ~x19)));
