...
module FAU ( 
  ...
  assign new_n70_ = x20 & x21 & ~x22 & ~x08 & x09 & ~x10;
  assign z13 = z05 | (~x08 & new_n72_ & x09);
  assign new_n72_ = ~x10 & ((~new_n73_ & ~x16) | (~x19 & x23));
  ...
  assign new_n79_ = ~x10 & ((~x19 & x25) | (~x16 & ((~new_n80_ & x19) | (~new_n82_ & x25))));
  assign new_n80_ = (~new_n81_ | ~x23 | ~x24 | x25) & (~x17 | ~x25 | ~x26);
  assign new_n81_ = x20 & x21 & x22;
  assign new_n82_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((~x19 & x26) | (~x16 & ((~new_n85_ & x19) | (~new_n86_ & x26))));
  assign new_n85_ = (~x18 | ~x26) & (~new_n81_ | ~x23 | ~x24 | ~x25 | x26);
  assign new_n86_ = new_n81_ & x23 & x24 & x25;
endmodule
