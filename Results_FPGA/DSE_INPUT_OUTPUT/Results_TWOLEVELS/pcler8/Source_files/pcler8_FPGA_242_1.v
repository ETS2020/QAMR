...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x18 | ~x19)) | (x19 & (new_n66_ | ~x18)) | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & x21 & (~x19 | new_n65_ | ~x20);
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n66_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x18 | ((~x22 | (x20 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~new_n71_ & x19) | (x04 & x08) | (new_n73_ & ~x08);
  assign new_n71_ = x18 & (~new_n72_ | x08 | ~x09 | x10);
  ...
  assign new_n76_ = x19 & (~x18 | (new_n77_ & new_n78_));
  ...
  assign z16 = (x07 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n89_ & ~x10);
  assign new_n89_ = ~x26 & (~new_n80_ | ~x22 | ~x23 | ~x24 | ~x25);
endmodule
