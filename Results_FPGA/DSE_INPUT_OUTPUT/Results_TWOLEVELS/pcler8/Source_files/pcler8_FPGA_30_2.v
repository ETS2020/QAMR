...
module FAU ( 
  ...
  assign new_n70_ = (~x19 | ((~x20 | ~x21 | x22) & (~x22 | (x20 & ~new_n71_ & x21)))) & (x16 | x19 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x19 | ((~x23 | (new_n61_ & ~new_n74_ & x22)) & (~new_n61_ | ~x22 | x23))) & (x16 | x19 | ~x23);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | new_n76_ | (~x08 & x09 & ~new_n77_ & ~x10);
  ...
  assign new_n79_ = (~x25 | (new_n81_ & new_n82_)) & (~new_n80_ | ~new_n48_ | ~x24 | x25);
  assign new_n80_ = x19 & x20 & x21;
  assign new_n81_ = x20 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x25));
