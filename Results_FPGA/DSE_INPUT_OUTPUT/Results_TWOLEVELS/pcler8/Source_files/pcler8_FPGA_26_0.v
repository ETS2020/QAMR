...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (x09 | x19)) | (~x09 & ~x19) | (~x08 & ~x10 & (new_n57_ | ~x19));
  ...
  assign z11 = (x02 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n68_ & ~x08))) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x21 & (new_n67_ | ~x20)) | (x19 & x20 & ~x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n68_ = ~x10 & x21;
  assign z12 = z04 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x22 | (new_n71_ & x21 & (~new_n60_ | ~x14 | ~x23))) & (~new_n71_ | ~x21 | x22);
  assign new_n71_ = x19 & x20;
  assign z13 = (x04 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x23 | (new_n71_ & x21 & ~new_n74_ & x22)) & (~new_n71_ | ~x21 | ~x22 | x23);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | new_n78_ | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (new_n58_ & x22 & ~new_n77_ & x23)) & (~new_n58_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n77_ = x16 & x25 & x26;
  assign new_n78_ = ~x19 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (x06 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x25 | (new_n81_ & new_n59_ & x24 & (~x17 | ~x26))) & (~new_n81_ | ~new_n59_ | ~x24 | x25);
