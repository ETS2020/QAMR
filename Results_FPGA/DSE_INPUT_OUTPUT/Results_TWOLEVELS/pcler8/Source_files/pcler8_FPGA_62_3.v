...
module FAU ( 
  ...
  assign new_n61_ = x09 & ~x10 & x22 & ~new_n62_ & (~x23 | (x23 & ~x25));
  assign new_n62_ = x19 & x20 & x21;
  assign new_n63_ = x09 & ~x10;
  assign new_n64_ = x19 & x20 & x21 & ~x22;
  assign z13 = z05 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = x22 ? ((~x23 | x25 | (x19 & x20 & x21)) & (~x19 | ~x20 | ~x21 | x23)) : (~x23 | x25);
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x24 | (x23 & (new_n69_ | x25))) & (~new_n62_ | x24 | x25 | ~x22 | ~x23);
  assign new_n69_ = x19 & x20 & x21 & x22;
  assign z15 = z07 | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((~x23 & x25) | (new_n62_ & x22 & x23 & x24 & ~x25));
