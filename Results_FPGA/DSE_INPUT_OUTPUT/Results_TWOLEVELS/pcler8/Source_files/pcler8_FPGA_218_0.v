...
module FAU ( 
  ...
  assign z00 = (~x19 & ~x21) | (new_n47_ & new_n49_ & new_n48_ & x21);
  ...
  assign new_n65_ = (~x20 | (~x19 ^ x21)) & (~x21 | (x20 & (~new_n49_ | ~new_n48_ | ~x13)));
  ...
  assign new_n73_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n78_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (new_n81_ | ~x19) & (~x21 | ~x25 | (new_n83_ & new_n82_ & x19));
  assign new_n81_ = (~x20 | ~x21 | ~x22 | ~x23 | ~x24 | x25) & (x21 | ~x25);
  assign new_n82_ = x20 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x07 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n85_ & ~x10);
  assign new_n85_ = (~new_n88_ | ~new_n89_) & (~x26 | (~new_n86_ & (new_n87_ | ~x21)));
  assign new_n86_ = x19 & (~x21 | ~x25);
  assign new_n87_ = ~x18 & x19 & x20 & x22 & x23 & x24;
