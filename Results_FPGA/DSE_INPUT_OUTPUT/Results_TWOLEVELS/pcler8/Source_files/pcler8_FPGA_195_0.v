...
module FAU ( 
  ...
  assign new_n62_ = x19 & (~x20 | (new_n60_ & x12 & x21 & x22));
  assign new_n63_ = ~x19 & x20;
  assign z11 = (x02 & x08 & (x01 | x19)) | (~x19 & (new_n67_ | ~x01)) | (new_n65_ & ~x08);
  ...
  assign new_n71_ = ~x19 & (~x01 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n75_ = ~x19 & (~x01 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n80_ = ~x19 & (~x01 | (~x08 & x09 & ~x10 & x24));
