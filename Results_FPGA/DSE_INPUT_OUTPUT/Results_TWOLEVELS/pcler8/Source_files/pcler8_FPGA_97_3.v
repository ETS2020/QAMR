...
module FAU ( 
  ...
  assign new_n61_ = x19 & (~new_n49_ | ~new_n48_ | ~x11 | x17);
  assign z10 = z02 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((~x17 & ((new_n64_ & new_n65_) | (x19 & ~x20))) | (~x19 & x20));
  assign new_n64_ = x12 & x20 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n51_ & x08) | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((~x17 & ((x21 & (new_n68_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n68_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x19 & (new_n72_ | x17)) | (x03 & x08) | (new_n70_ & ~x08);
  ...
  assign new_n74_ = (x19 | ~x23) & (x17 | (~new_n76_ & (~x23 | (new_n48_ & new_n75_))));
  assign new_n75_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n76_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (~new_n78_ & x19) | (new_n80_ & ~x08) | (x05 & x08);
  assign new_n78_ = ~x17 & (~new_n79_ | ~x23 | x24 | ~x21 | ~x22);
  assign new_n79_ = ~x08 & x09 & ~x10 & x20;
  assign new_n80_ = x09 & ~x10 & x24 & (~new_n81_ | ~new_n82_);
  assign new_n81_ = x19 & x20 & x21;
  assign new_n82_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x06 & ~new_n51_ & x08) | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & (new_n87_ | (~x17 & (new_n85_ | (new_n81_ & new_n86_))));
  assign new_n85_ = x25 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n86_ = x22 & x23 & x24 & ~x25;
  assign new_n87_ = ~x19 & x25;
  assign z16 = new_n59_ | (~x08 & x09 & ~x10 & (new_n89_ | new_n94_));
