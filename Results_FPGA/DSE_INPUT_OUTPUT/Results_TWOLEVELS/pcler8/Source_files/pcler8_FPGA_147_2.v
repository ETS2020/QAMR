...
module FAU ( 
  ...
  assign z15 = (~new_n83_ & x17) | (x06 & x08) | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((x25 & (~new_n82_ | ~x22 | ~x23 | ~x24)) | (new_n82_ & x22 & x23 & x24 & ~x25));
  assign new_n82_ = x19 & x20 & x21;
  assign new_n83_ = x19 & (x08 | ~x09 | x10 | ~x25 | ~x26);
