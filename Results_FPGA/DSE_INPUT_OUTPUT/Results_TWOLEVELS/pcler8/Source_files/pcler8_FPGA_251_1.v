...
module FAU ( 
  ...
  assign z01 = x00 & x08 & (x01 | ~x09);
  assign z02 = x01 & x08;
  assign z03 = x02 & x08 & (x01 | ~x09);
  assign z04 = (~x01 & x09) | (x03 & x08);
  assign z05 = x04 & x08 & (x01 | ~x09);
  assign z06 = (~x01 & x09) | (x05 & x08);
  assign z07 = x06 & x08 & (x01 | ~x09);
  assign z08 = x07 & x08 & (x01 | ~x09);
  assign z09 = (x00 & x08 & (x01 | ~x09)) | (x09 & (~x01 | (~x08 & ~new_n58_ & ~x10)));
  assign new_n58_ = x19 & (~new_n59_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08) | (x09 & (~x01 | (~new_n61_ & ~x10)));
  assign new_n61_ = x20 ? (x19 & (~new_n59_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = (x02 & x08 & (x01 | ~x09)) | (x09 & (~x01 | (~x08 & ~new_n63_ & ~x10)));
  assign new_n63_ = (~x21 | (x19 & ~new_n64_ & x20)) & (~x19 | ~x20 | x21);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08) | (x09 & (~x01 | (~x08 & ~new_n66_ & ~x10)));
  assign new_n66_ = (~x22 | (~new_n67_ & x21 & x19 & x20)) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (x01 | ~x09)) | (x01 & ~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x23 | (x19 & x20 & x21 & ~new_n70_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (x09 & (~x01 | (~x08 & ~new_n72_ & ~x10)));
  assign new_n72_ = ~new_n75_ & (~x24 | (~new_n73_ & new_n74_));
  assign new_n73_ = x01 & (~x22 | (x16 & x25 & x26));
  assign new_n74_ = x19 & x20 & x21 & x23;
  assign new_n75_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (x01 | ~x09)) | (x09 & (~x01 | (new_n77_ & ~x08)));
  assign new_n77_ = ~x10 & ((x25 & (new_n79_ | ~new_n80_)) | (new_n78_ & new_n81_));
  assign new_n78_ = x19 & x20 & x21;
  assign new_n79_ = x01 & (~x22 | (x17 & x26));
  assign new_n80_ = x19 & x20 & x21 & x23 & x24;
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign z16 = (x07 & x08 & (x01 | ~x09)) | (x01 & ~x08 & new_n83_ & x09);
