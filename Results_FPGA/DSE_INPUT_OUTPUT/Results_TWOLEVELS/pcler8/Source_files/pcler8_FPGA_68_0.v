...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n61_ & x19);
  ...
  assign z12 = (x03 & x08 & (x10 | x19)) | (~x10 & (~x19 | (~x08 & ~new_n68_ & x09)));
  assign new_n68_ = (~x22 | (x20 & x21 & (~new_n66_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n70_ & x19);
  ...
  assign new_n77_ = (~x26 | (~new_n78_ & new_n79_)) & (~new_n75_ | ~new_n63_ | ~x25 | x26);
  assign new_n78_ = x19 & (~x22 | ~x24);
  assign new_n79_ = ~x18 & x20 & x21 & x23 & x25;
endmodule
