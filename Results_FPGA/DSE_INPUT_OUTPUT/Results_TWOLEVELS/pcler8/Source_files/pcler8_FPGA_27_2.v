...
module FAU ( 
  ...
  assign new_n60_ = (x15 | x19) & (~new_n49_ | ~new_n50_ | ~new_n61_ | ~x11 | ~x19);
  assign new_n61_ = x20 & x21;
  assign z10 = new_n65_ | (x01 & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x19 | x20) & (~new_n64_ | ~x12 | ~x20 | ~x21 | ~x22);
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign new_n65_ = ~x19 & (x15 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (~x15 | x19)) | ((new_n69_ | x15) & ~x19) | (new_n67_ & ~x08);
  assign new_n67_ = x09 & ~x10 & ((x21 & (new_n68_ | ~x20)) | (x19 & x20 & ~x21));
  assign new_n68_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n69_ = ~x08 & x09 & ~x10 & x21;
  ...
  assign new_n73_ = ~x19 & (x15 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | ((~x23 | (new_n61_ & ~new_n76_ & x22)) & (~new_n61_ | ~x22 | x23))) & (x15 | x19 | ~x23);
  assign new_n76_ = x15 & x24 & x25 & x26;
  assign z14 = (~x08 & x09 & ~new_n78_ & ~x10) | (x05 & ~new_n47_ & x08);
  assign new_n78_ = (~x19 | (((new_n61_ & new_n79_) | ~x24) & (~new_n61_ | ~new_n80_))) & (x15 | x19 | ~x24);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = new_n86_ | (x06 & x08) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = ((new_n83_ & new_n84_) | ~x25) & (~new_n85_ | ~new_n61_ | ~x19);
  assign new_n83_ = x20 & x21 & x22;
  assign new_n84_ = x23 & x24 & (~x17 | ~x26);
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign new_n86_ = ~x19 & (x15 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n88_ | new_n92_));
  assign new_n88_ = x19 & (((~new_n89_ | ~new_n90_) & x26) | (new_n83_ & new_n91_));
  assign new_n89_ = ~x18 & x20 & x21;
  assign new_n90_ = x22 & x23 & x24 & x25;
  assign new_n91_ = x23 & x24 & x25 & ~x26;
  assign new_n92_ = ~x15 & ~x19 & x26;
endmodule
