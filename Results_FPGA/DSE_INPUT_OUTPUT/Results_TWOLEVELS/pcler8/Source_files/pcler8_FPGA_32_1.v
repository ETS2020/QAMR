...
module FAU ( 
  ...
  assign z07 = (~x17 & x19) | (x06 & x08 & (x17 | ~x19));
  assign z08 = new_n50_ & x07;
  assign z09 = (x00 & x08 & (x17 | ~x19)) | (~x17 & x19) | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & (~x19 | (new_n61_ & new_n60_ & x11 & x20));
  assign new_n60_ = x21 & x22;
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | new_n63_ | (~x08 & new_n64_ & x09);
  assign new_n63_ = x19 & (~x17 | (new_n48_ & ~x10 & ~x20));
  assign new_n64_ = ~x10 & x20 & (~x19 | (new_n61_ & new_n60_ & x12));
  ...
  assign new_n73_ = (x19 | ~x23) & (~x17 | (~new_n76_ & (~x23 | (new_n74_ & new_n75_))));
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n76_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (x05 & x08 & (x17 | ~x19)) | (x19 & (new_n78_ | ~x17)) | (new_n79_ & ~x08);
  assign new_n78_ = new_n48_ & ~x10 & x20 & new_n60_ & x23 & ~x24;
  assign new_n79_ = x09 & ~x10 & x24 & (~new_n80_ | ~new_n74_ | ~x19);
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (new_n50_ & x06) | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x19 | ~x25) & (~x17 | ((~x19 | ~new_n83_ | ~x20) & (new_n84_ | ~x25)));
