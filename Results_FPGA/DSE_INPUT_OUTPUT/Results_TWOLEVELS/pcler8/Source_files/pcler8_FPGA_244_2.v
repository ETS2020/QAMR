...
module FAU ( 
  ...
  assign new_n61_ = (~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (~x19 | x20 | ~x23);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (x02 & ~new_n49_ & x08) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x21 & (~x19 | (x23 & (new_n65_ | ~x20)))) | (x19 & x20 & ~x21 & x23));
  assign new_n65_ = x13 & x22 & x24 & x25 & x26;
  assign z12 = (x03 & x08 & (~x19 | x23)) | (x19 & (new_n69_ | ~x23)) | (new_n67_ & ~x08);
  assign new_n67_ = x09 & ~x10 & x22 & (~new_n68_ | ~x19 | ~x20);
  assign new_n68_ = x21 & (~x25 | ~x26 | ~x14 | ~x24);
  assign new_n69_ = ~x08 & x09 & ~x10 & x20 & x21 & ~x22;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = x19 ? ((~x20 | (x21 ? x22 : ~x23)) & (~x23 | (~new_n72_ & x20))) : ~x23;
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (x19 | ~x24) & (~x23 | ((~x19 | (~new_n75_ & ~new_n76_)) & (new_n77_ | ~x24)));
  assign new_n75_ = x20 & x21 & x22 & ~x24;
  assign new_n76_ = x16 & x24 & x25 & x26;
  assign new_n77_ = x20 & x21 & x22;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x19 | ~x25) & (~x23 | ((~x19 | (~new_n80_ & ~new_n81_)) & (new_n82_ | ~x25)));
  assign new_n80_ = x20 & x21 & x22 & x24 & ~x25;
  assign new_n81_ = x17 & x25 & x26;
  assign new_n82_ = x20 & x21 & x22 & x24;
  assign z16 = z08 | (~new_n84_ & x19) | (~x08 & new_n86_ & x09);
  assign new_n84_ = x23 & (~new_n85_ | x10 | ~x20 | x08 | ~x09);
