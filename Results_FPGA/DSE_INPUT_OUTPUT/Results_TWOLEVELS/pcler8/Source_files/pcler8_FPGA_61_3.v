...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (~x18 | ~x20)) | (x20 & (new_n69_ | x18)) | (new_n67_ & ~x08);
  ...
  assign z13 = (x04 & x08 & (~x18 | ~x20)) | (x20 & (new_n74_ | x18)) | (new_n76_ & ~x08);
  ...
  assign z14 = (x05 & x08 & (~x18 | ~x20)) | (x20 & (new_n79_ | x18)) | (new_n81_ & ~x08);
  assign new_n79_ = new_n80_ & ~x08 & x09 & ~x10 & x19;
  ...
  assign new_n85_ = ~x18 & ((new_n82_ & new_n88_) | ((~new_n86_ | ~new_n87_) & x25));
  assign new_n86_ = x19 & x21 & x22;
  assign new_n87_ = x23 & x24 & (~x17 | ~x26);
  assign new_n88_ = x22 & x23 & x24 & ~x25;
  assign new_n89_ = ~x20 & x25;
  assign z16 = (~new_n91_ & x20) | (x07 & x08) | (~x08 & new_n92_ & x09);
  assign new_n91_ = ~x18 & (~new_n48_ | ~new_n49_ | ~x24 | ~x25 | x26);
  assign new_n92_ = ~x10 & x26 & (~new_n82_ | ~new_n49_ | ~x24 | ~x25);
endmodule
