...
module FAU ( 
  ...
  assign new_n65_ = (~x02 | ((~new_n63_ | ~new_n62_ | ~x12 | ~x20) & (~x19 | x20))) & (x19 | ~x20);
  assign z11 = (x02 & (x08 | (x09 & ~new_n67_ & ~x10))) | (~x08 & x09 & new_n68_ & ~x10);
  assign new_n67_ = (~x19 | (~x20 ^ x21)) & (~new_n63_ | ~x13 | ~x21 | ~x22);
  assign new_n68_ = ~x19 & x21;
  assign z12 = z04 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x02 | ((~x22 | (x20 & ~new_n71_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (x02 | ~x19)) | ((new_n73_ | ~x02) & x19) | (new_n74_ & ~x08);
  ...
  assign z14 = (x05 & x08 & (x02 | ~x19)) | ((new_n77_ | ~x02) & x19) | (new_n79_ & ~x08);
  assign new_n77_ = new_n78_ & new_n62_ & x23 & ~x24;
  ...
  assign new_n82_ = x02 & (~new_n78_ | ~new_n62_ | ~x23 | ~x24 | x25);
  assign new_n83_ = ~x10 & x25 & (~new_n84_ | ~new_n48_ | ~x19);
  assign new_n84_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n59_ | (~x08 & x09 & ~x10 & (new_n86_ | new_n91_));
  assign new_n86_ = x02 & ((new_n89_ & new_n90_) | ((~new_n87_ | ~new_n88_) & x26));
