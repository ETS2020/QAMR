...
module FAU ( 
  ...
  assign new_n62_ = ~x19 & (~x17 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x19 & (x21 ? (new_n65_ | ~x20) : x20)) | (x17 & ~x19 & x21));
  ...
  assign new_n69_ = ~x19 & (~x17 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x17 | x19 | ~x23) & (~x19 | ((~x23 | (new_n72_ & ~new_n73_ & x22)) & (~new_n72_ | ~x22 | x23)));
