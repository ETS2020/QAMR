...
module FAU ( 
  ...
  assign new_n69_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x23 | (x19 & x20 & x21 & ~new_n72_ & x22)) & (~x21 | ~x22 | x23 | ~x19 | ~x20);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (~x10 | x20)) | (~x08 & x09 & ~new_n74_ & ~x10);
  ...
  assign new_n85_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x26));
endmodule
