...
module FAU ( 
  ...
  assign new_n61_ = (~x19 | (x20 & (~new_n59_ | ~new_n62_))) & (~x16 | x19 | ~x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (x16 | x19)) | (~x19 & (new_n66_ | ~x16)) | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & ((x21 & (new_n65_ | ~x20)) | (x19 & x20 & ~x21));
  ...
  assign new_n78_ = ~x19 & (~x16 | (~x08 & x09 & ~x10 & x24));
  assign z15 = (x06 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (~x19 | ((~x25 | (new_n81_ & new_n82_)) & (~new_n81_ | ~new_n83_))) & (~x16 | x19 | ~x25);
  ...
  assign new_n90_ = ~x19 & (~x16 | (~x08 & x09 & ~x10 & x26));
endmodule
