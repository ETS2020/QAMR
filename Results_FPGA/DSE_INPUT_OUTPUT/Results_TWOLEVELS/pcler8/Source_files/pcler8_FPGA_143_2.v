...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n61_, new_n63_,
    ...
    new_n84_, new_n85_;
  assign z00 = x19 & (~x21 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign new_n63_ = x20 & (~x19 | (new_n49_ & new_n48_ & x12));
  assign new_n64_ = x19 & (~x21 | (~x08 & x09 & ~x10 & ~x20 & x21));
  assign z11 = z03 | (~x08 & x09 & new_n66_ & ~x10);
  assign new_n66_ = x21 & (~x19 | (new_n49_ & new_n48_ & x13) | (x19 & ~x20));
  assign z12 = (~new_n70_ & x19) | (x03 & x08) | (new_n68_ & ~x08);
  assign new_n68_ = x09 & ~x10 & x22 & (~new_n69_ | ~x19);
  assign new_n69_ = x20 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n70_ = x21 & (x08 | ~x09 | x10 | ~x20 | x22);
  assign z13 = (x04 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x21 | ((~x23 | (x20 & ~new_n73_ & x22)) & (~x19 | ~x20 | ~x22 | x23))) & (x19 | ~x23);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n51_ & x08) | (~x08 & new_n75_ & x09);
  assign new_n75_ = ~x10 & ((x21 & (new_n77_ | (~new_n76_ & x24))) | (~x19 & x24));
  assign new_n76_ = x20 & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x22 & x23 & ~x24;
  assign z15 = (~new_n79_ & x19) | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n79_ = x21 & (~new_n47_ | ~new_n48_ | ~x24 | x25);
  assign new_n80_ = ~x10 & x25 & (~new_n81_ | ~x19 | ~x20 | ~x22);
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~new_n83_ & x19) | (~x08 & new_n84_ & x09);
  assign new_n83_ = x21 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
