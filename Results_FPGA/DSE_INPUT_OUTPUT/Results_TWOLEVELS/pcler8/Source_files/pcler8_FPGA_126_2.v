...
module FAU ( 
  ...
  assign new_n59_ = ~x10 & ((~x12 & ~x19) | (new_n61_ & new_n60_ & x11 & x19));
  assign new_n60_ = x20 & x21;
  assign new_n61_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = ~new_n64_ | (~new_n63_ & x12);
  assign new_n63_ = x19 & (~new_n61_ | x08 | ~x09 | x10 | ~x21);
  assign new_n64_ = x08 ? ~x01 : (~x09 | x10 | (~x19 ^ x20));
  assign z11 = (x02 & ~new_n47_ & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (x21 ? (new_n67_ | ~x20) : x20)) | (~x12 & ~x19 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = new_n71_ | (~x08 & new_n69_ & x09) | (x03 & x08);
  assign new_n69_ = ~x10 & ((x22 & (~x20 | new_n70_ | ~x21)) | (x21 & ~x22 & x19 & x20));
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign new_n71_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x22));
  assign z13 = new_n75_ | (x04 & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x23 | (~new_n74_ & x22 & x20 & x21)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign new_n75_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x23));
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x19 | ((~x24 | (new_n60_ & new_n78_)) & (~new_n60_ | ~new_n79_))) & (x12 | x19 | ~x24);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x19 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_))) & (x12 | x19 | ~x25);
  ...
  assign new_n91_ = ~x19 & (x12 | (~x08 & x09 & ~x10 & x26));
endmodule
