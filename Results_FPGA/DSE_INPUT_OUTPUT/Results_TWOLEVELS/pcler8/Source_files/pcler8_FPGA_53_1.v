...
module FAU ( 
  ...
  assign z10 = z02 | (~x08 & ~new_n60_ & ~x10);
  assign new_n60_ = (~x19 | (x20 & (~new_n58_ | ~new_n61_))) & (~x09 | x19 | ~x20);
  assign new_n61_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (x09 | ~x19)) | (~x09 & x19) | (new_n63_ & ~x08);
  ...
  assign new_n66_ = (~x22 | (new_n68_ & x21 & (~new_n67_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  ...
  assign z14 = z06 | (~x08 & ~new_n73_ & ~x10);
  assign new_n73_ = (~new_n75_ | ~x09) & (~x19 | (~new_n74_ & (~new_n67_ | ~x09 | ~x16)));
  assign new_n74_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n75_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x19 | (~new_n78_ & (~x17 | ~x25 | ~x26))) & (new_n79_ | ~x25);
