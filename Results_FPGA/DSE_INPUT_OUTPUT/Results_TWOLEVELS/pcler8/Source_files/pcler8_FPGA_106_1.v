...
module FAU ( 
  ...
  assign z11 = x08 ? x02 : (x10 | (~new_n62_ & x09));
  assign new_n62_ = (~x19 | ~x20 | (x21 & (~new_n58_ | ~new_n63_))) & (~x21 | (x19 & (x10 | x20)));
  assign new_n63_ = x13 & x21 & x22;
  assign z12 = x08 ? x03 : (new_n65_ | x10);
  assign new_n65_ = x09 & ((x19 & x20 & x21 & (new_n66_ | ~x22)) | (x22 & (~x19 | ~x20 | ~x21)));
  assign new_n66_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = x08 ? x04 : (x10 | (~new_n68_ & x09));
  assign new_n68_ = (~x19 | ~x20 | ~x21 | ~x22 | (~new_n69_ & x23)) & (~x23 | (x19 & x20 & x21 & x22));
  ...
  assign z16 = x08 ? x07 : (x10 | (~new_n78_ & x09));
  assign new_n78_ = (~x26 | (new_n81_ & (new_n79_ | x10))) & (~new_n80_ | ~new_n79_ | ~x25 | x26);
  assign new_n79_ = x23 & x24;
  assign new_n80_ = x19 & x20 & x21 & x22;
  assign new_n81_ = x21 & x22 & x25 & ~x18 & x19 & x20;
endmodule
