// Benchmark "FAU" written by ABC on Mon Aug 24 16:58:59 2020
...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x10 & (new_n57_ | ~x19));
  ...
  assign z11 = (x02 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n65_ & x19);
  assign new_n65_ = x21 ? (x20 & (~new_n66_ | ~x13 | ~x22 | ~x23)) : ~x20;
  assign new_n66_ = x24 & x25 & x26;
  assign z12 = (x03 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n68_ & x19);
  assign new_n68_ = (~x22 | (x20 & x21 & (~new_n66_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign z13 = (x04 & x08) | (~x10 & (~x19 | (~x08 & ~new_n70_ & x09)));
  assign new_n70_ = (~x23 | (new_n58_ & x22 & (~new_n62_ | ~x15 | ~x24))) & (~new_n58_ | ~x22 | x23);
  assign z14 = (x05 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n72_ & x19);
  assign new_n72_ = (~x24 | (new_n58_ & x22 & x23 & (~new_n62_ | ~x16))) & (~new_n58_ | ~x22 | ~x23 | x24);
  assign z15 = (x06 & x08 & (x10 | x19)) | (~x08 & x09 & ~x10 & ~new_n74_ & x19);
  assign new_n74_ = (~x25 | (new_n75_ & x23 & x24 & (~x17 | ~x26))) & (~new_n75_ | ~x23 | ~x24 | x25);
  assign new_n75_ = x20 & x21 & x22;
  assign z16 = (x07 & x08) | (~x10 & (~x19 | (~x08 & ~new_n77_ & x09)));
  assign new_n77_ = (~x26 | (new_n78_ & (new_n63_ | ~x19))) & (~new_n75_ | ~new_n63_ | ~x25 | x26);
  assign new_n78_ = ~x18 & x20 & x21 & x22 & x25;
endmodule
