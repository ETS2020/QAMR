...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n49_, new_n51_, new_n59_, new_n60_, new_n61_, new_n63_,
  ...
  assign z02 = new_n51_ | new_n49_;
  assign new_n51_ = x01 & ~new_n49_ & x08;
  ...
  assign new_n59_ = (x15 | x19) & (~new_n61_ | ~new_n60_ | ~x11 | ~x19);
  assign new_n60_ = x20 & x21;
  assign new_n61_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = new_n51_ | (~x08 & x09 & ~x10 & (new_n63_ | new_n65_));
  assign new_n63_ = x19 & (~x20 | (new_n64_ & x12 & x21 & x22));
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign new_n65_ = ~x15 & ~x19 & x20;
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x19 & (x21 ? (new_n68_ | ~x20) : x20)) | (~x15 & ~x19 & x21));
  assign new_n68_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | new_n72_ | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x22 & (~x20 | new_n71_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign new_n72_ = ~x19 & (x15 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (x15 | x19 | ~x23) & (~x19 | ((~x23 | (new_n60_ & ~new_n75_ & x22)) & (~new_n60_ | ~x22 | x23)));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x19 | ((~x24 | (new_n60_ & new_n78_)) & (~new_n60_ | ~new_n79_))) & (x15 | x19 | ~x24);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (new_n83_ | ~x25) & (~x19 | (~new_n82_ & (~x17 | ~x25 | ~x26)));
  ...
  assign new_n90_ = ~x19 & (x15 | (~x08 & x09 & ~x10 & x26));
endmodule
