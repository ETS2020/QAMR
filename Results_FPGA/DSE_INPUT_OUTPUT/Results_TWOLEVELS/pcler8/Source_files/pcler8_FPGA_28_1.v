...
module FAU ( 
  ...
  assign z00 = x20 & (~x19 | (new_n47_ & new_n48_ & x22 & x23));
  ...
  assign new_n64_ = x21 & (~x20 | (new_n48_ & x13 & x22 & x23));
  assign new_n65_ = x20 & (~x19 | (~x08 & x09 & ~x10 & ~x21));
  assign z12 = (~new_n69_ & x20) | (x03 & x08) | (new_n67_ & ~x08);
  assign new_n67_ = x09 & ~x10 & x22 & (~new_n68_ | ~x20);
  assign new_n68_ = x21 & (~x24 | ~x25 | ~x26 | ~x14 | ~x23);
  assign new_n69_ = x19 & (x08 | ~x09 | x10 | ~x21 | x22);
  assign z13 = (x04 & x08) | (new_n71_ & ~x08) | (x20 & (new_n73_ | ~x19));
  assign new_n71_ = x09 & ~x10 & x23 & (~new_n72_ | ~x20 | ~x21);
  assign new_n72_ = x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n73_ = ~x08 & x09 & ~x10 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & new_n75_ & x09);
  assign new_n75_ = ~x10 & ((x19 & (new_n77_ | (~new_n76_ & x24))) | (~x20 & x24));
  assign new_n76_ = x21 & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n50_ & x08) | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((x19 & (new_n81_ | (~new_n80_ & x25))) | (~x20 & x25));
  assign new_n80_ = x21 & x22 & x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~new_n83_ & x20) | (~x08 & new_n85_ & x09);
  assign new_n83_ = x19 & (~new_n47_ | ~new_n84_);
