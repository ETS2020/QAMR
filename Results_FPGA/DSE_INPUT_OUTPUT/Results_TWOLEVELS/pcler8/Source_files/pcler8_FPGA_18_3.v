...
module FAU ( 
  ...
  assign new_n65_ = (x12 | ((~x19 | ((~new_n66_ | ~new_n67_) & (~x20 | x21))) & (x20 | ~x21))) & (x19 | ~x21);
  assign new_n66_ = x13 & x21 & x22;
  assign new_n67_ = x23 & x24 & x25 & x26;
  assign z12 = (x03 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x12 | ((~x19 | (~new_n70_ & (~x20 | ~x21 | x22))) & (~x22 | (x20 & x21)))) & (x19 | ~x22);
  assign new_n70_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (x19 | ~x23) & (x12 | ((new_n75_ | ~x23) & (~x19 | (~new_n73_ & ~new_n74_))));
  ...
  assign new_n77_ = (x19 | ~x24) & (x12 | ((new_n80_ | ~x24) & (~x19 | (~new_n78_ & ~new_n79_))));
  assign new_n78_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n79_ = x16 & x24 & x25 & x26;
  assign new_n80_ = x20 & x21 & x22 & x23;
  assign z15 = (x06 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n82_ & ~x10);
  ...
  assign new_n86_ = ~x12 & (~new_n87_ | x08 | ~x09 | ~new_n60_ | x10);
