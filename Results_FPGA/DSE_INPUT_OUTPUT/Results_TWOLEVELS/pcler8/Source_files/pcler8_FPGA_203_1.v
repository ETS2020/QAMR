...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n58_, new_n60_, new_n61_, new_n63_, new_n64_,
    ...
    new_n84_, new_n85_;
  assign z00 = x19 & (~x09 | (new_n48_ & new_n47_ & ~x08 & ~x10));
  ...
  assign z09 = (~x09 & x19) | (x00 & x08) | (~x08 & ~x10 & (new_n58_ | (x09 & ~x19)));
  ...
  assign z13 = z05 | (~x08 & ~new_n69_ & ~x10);
  assign new_n69_ = ~new_n71_ & (~x19 | (~new_n70_ & (~new_n47_ | ~x22 | x23)));
  assign new_n70_ = x15 & x23 & x24 & x25 & x26;
  assign new_n71_ = x09 & x23 & (~x21 | ~x22 | ~x19 | ~x20);
  assign z14 = z06 | (~x08 & ~x10 & (new_n75_ | (~new_n73_ & x19)));
  assign new_n73_ = ~new_n74_ & (~x25 | ~x26 | ~x16 | ~x24);
  assign new_n74_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n75_ = x09 & x24 & (~x19 | ~x20 | ~new_n76_ | ~x21);
  assign new_n76_ = x22 & x23;
  assign z15 = (~x08 & x09 & ~new_n78_ & ~x10) | (x06 & x08 & (x09 | ~x19));
  assign new_n78_ = (~x25 | (new_n79_ & new_n76_ & x24 & (~x17 | ~x26))) & (~new_n79_ | ~new_n76_ | ~x24 | x25);
