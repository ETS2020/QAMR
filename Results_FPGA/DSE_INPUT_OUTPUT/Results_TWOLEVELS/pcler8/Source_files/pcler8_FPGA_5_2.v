...
module FAU ( 
  ...
  assign z11 = (x09 & (~x19 | (~x08 & ~new_n63_ & ~x10))) | (x02 & x08);
  ...
  assign z13 = (x09 & (~x19 | (~x08 & ~new_n68_ & ~x10))) | (x04 & x08);
  assign new_n68_ = (~x23 | ((~x19 | (~new_n69_ & x21)) & x20 & x22)) & (~x20 | ~x21 | ~x22 | x23);
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08 & (~x09 | x19)) | (x09 & (~x19 | (~x08 & ~new_n71_ & ~x10)));
  assign new_n71_ = (~x24 | (~new_n72_ & x20 & x22 & x23)) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n72_ = x19 & (~x21 | (x16 & x25 & x26));
