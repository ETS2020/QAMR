...
module FAU ( 
  ...
  assign z13 = (x19 & (new_n74_ | x17)) | (new_n75_ & ~x08) | (x04 & x08);
  ...
  assign new_n78_ = x19 & (x17 | (new_n79_ & new_n63_ & x23 & ~x24));
  ...
  assign new_n83_ = ~x17 & (~new_n79_ | ~new_n63_ | ~x23 | ~x24 | x25);
  assign new_n84_ = ~x10 & ~new_n85_ & x25;
  assign new_n85_ = x22 & x23 & x24 & x19 & x20 & x21;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n87_ | new_n92_));
  assign new_n87_ = ~x17 & ((new_n90_ & new_n91_) | (x26 & (~new_n88_ | ~new_n89_)));
