...
module FAU ( 
  ...
  assign new_n73_ = (~x19 | (~new_n74_ & (~x20 | ~x21 | ~x22 | x23))) & (~x23 | (x20 & x21 & x22));
  assign new_n74_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | new_n49_ | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & ((x23 & (new_n77_ | (new_n59_ & x22 & ~x24))) | (x24 & (~new_n59_ | ~x22 | ~x23)));
  assign new_n77_ = x16 & x19 & x24 & x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x23 | (~new_n80_ & (~new_n59_ | ~x22 | ~x24 | x25))) & (~x25 | (new_n59_ & x22 & x23 & x24));
  assign new_n80_ = x17 & x19 & x25 & x26;
  assign z16 = z08 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x19 | ((new_n84_ | ~x26) & (~new_n83_ | ~new_n85_))) & (x23 | ~x26);
  assign new_n83_ = x20 & x21 & x22;
  assign new_n84_ = x22 & x24 & x25 & ~x18 & x20 & x21;
