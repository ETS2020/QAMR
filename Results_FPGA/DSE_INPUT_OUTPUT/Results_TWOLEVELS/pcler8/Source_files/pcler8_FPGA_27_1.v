...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n61_, new_n63_,
    ...
    new_n91_, new_n92_;
  assign z00 = x19 & (~x15 | (new_n47_ & new_n49_ & new_n48_ & x21));
  assign new_n47_ = ~x08 & x09 & ~x10 & x15 & x20;
  ...
  assign new_n60_ = x19 & (~new_n48_ | ~new_n49_ | ~new_n61_ | ~x11 | ~x15);
  assign new_n61_ = x20 & x21;
  assign z10 = z02 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & (x19 ? (~x20 | (new_n65_ & new_n64_ & x12)) : x20);
  assign new_n64_ = x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (x15 | ~x19)) | (x19 & (new_n69_ | ~x15)) | (new_n67_ & ~x08);
  ...
  assign new_n75_ = (~x15 | ((~x19 | ~new_n76_ | ~x20) & (~x23 | (new_n64_ & x20)))) & (x19 | ~x23);
  assign new_n76_ = x21 & x22 & (~x23 | (x23 & x24 & x25 & x26));
  assign z14 = (x05 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (x19 | ~x24) & (~x15 | ((~x24 | (new_n61_ & new_n79_)) & (~new_n80_ | ~new_n61_ | ~x19)));
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = (~new_n82_ & x19) | (x06 & x08) | (~x08 & new_n84_ & x09);
  assign new_n82_ = x15 & (~new_n83_ | x10 | ~x20 | x08 | ~x09);
  assign new_n83_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n84_ = ~x10 & x25 & (~new_n85_ | ~new_n61_ | ~x19);
  assign new_n85_ = x22 & x23 & x24 & (~x15 | ~x17 | ~x26);
