...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n73_ & ~x10) | (x04 & ~new_n49_ & x08);
  assign new_n73_ = (~x16 | x19 | ~x23) & (~x19 | ((~x23 | (new_n59_ & ~new_n74_ & x22)) & (~new_n59_ | ~x22 | x23)));
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | new_n78_ | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (new_n59_ & x22 & ~new_n77_ & x23)) & (~new_n59_ | ~x19 | ~x22 | ~x23 | x24);
  ...
  assign new_n80_ = (new_n83_ | ~x25) & (~x19 | (~new_n81_ & (~x17 | ~x25 | ~x26)));
  assign new_n81_ = new_n82_ & x23 & x24 & ~x25;
  assign new_n82_ = x20 & x21 & x22;
  assign new_n83_ = new_n59_ & x19 & x22 & x23 & x24;
  assign z16 = (x07 & ~new_n49_ & x08) | new_n49_ | (~x08 & new_n85_ & x09);
  assign new_n85_ = ~x10 & ((~new_n86_ & x19) | (x26 & (~new_n87_ | ~new_n59_ | ~x19)));
