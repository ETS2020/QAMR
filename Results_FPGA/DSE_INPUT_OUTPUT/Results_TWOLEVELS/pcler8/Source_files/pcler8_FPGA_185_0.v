...
module FAU ( 
  ...
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  ...
  assign new_n74_ = ~x20 & (~x18 | (~x08 & x09 & ~x10 & x18 & x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x20 | ((~x24 | (new_n77_ & new_n78_)) & (~new_n77_ | ~new_n79_))) & (~x18 | x20 | ~x24);
