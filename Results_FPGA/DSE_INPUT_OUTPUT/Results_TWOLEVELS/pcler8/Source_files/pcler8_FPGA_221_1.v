...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n48_ | ~new_n60_ | ~x11 | ~x15);
  assign new_n60_ = x20 & x21;
  assign z10 = z02 | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (~x15 | ~x19 | ((~new_n63_ | ~new_n64_) & x20)) & (x19 | ~x20);
  ...
  assign new_n72_ = (~x19 | ~x20 | ~x21 | ~x22 | (~new_n64_ & x23)) & (~x23 | (x21 & x22 & x19 & x20));
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x15 | (((new_n60_ & new_n75_) | ~x24) & (~new_n76_ | ~new_n60_ | ~x19))) & (x19 | ~x24);
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x22 & x23 & ~x24;
  assign z15 = (~new_n78_ & x19) | (x06 & x08) | (~x08 & new_n80_ & x09);
  assign new_n78_ = x15 & (~new_n79_ | x10 | ~x20 | x08 | ~x09);
  assign new_n79_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n80_ = ~x10 & x25 & (~new_n81_ | ~new_n60_ | ~x19);
  assign new_n81_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~new_n83_ & x19) | (~x08 & new_n85_ & x09);
  assign new_n83_ = x15 & (~new_n47_ | ~new_n84_);
