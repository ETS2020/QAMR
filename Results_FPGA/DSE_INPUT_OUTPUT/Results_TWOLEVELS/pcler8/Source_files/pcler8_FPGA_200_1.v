...
module FAU ( 
  ...
  assign new_n64_ = x20 & (~x19 | (new_n61_ & x12 & x21 & x22));
  assign z11 = (x02 & x08 & (x17 | ~x19)) | (x19 & (new_n66_ | ~x17)) | (new_n67_ & ~x08);
  assign new_n66_ = new_n48_ & ~x10 & x20 & ~x21;
  ...
  assign z13 = (x19 & (new_n73_ | ~x17)) | (x04 & x08) | (new_n75_ & ~x08);
  ...
  assign z14 = (x05 & x08 & (x17 | ~x19)) | (x19 & (new_n78_ | ~x17)) | (new_n80_ & ~x08);
  assign new_n78_ = new_n79_ & new_n48_ & ~x10 & x20;
  assign new_n79_ = x21 & x22 & x23 & ~x24;
  assign new_n80_ = x09 & ~x10 & x24 & (~new_n81_ | ~new_n74_ | ~x19);
