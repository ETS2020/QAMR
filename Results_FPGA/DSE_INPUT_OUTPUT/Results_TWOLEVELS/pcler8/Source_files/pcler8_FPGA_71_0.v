...
module FAU ( 
  ...
  assign new_n58_ = (~x18 | x19) & (~new_n60_ | ~new_n61_ | ~new_n59_ | ~x11 | ~x19);
  assign new_n59_ = x20 & x21;
  assign new_n60_ = x22 & x23;
  assign new_n61_ = x24 & x25 & x26;
  assign z10 = (x01 & ~new_n49_ & x08) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x19 & (~x20 | (new_n64_ & new_n65_))) | (x18 & ~x19 & x20));
