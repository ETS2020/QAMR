...
module FAU ( 
  ...
  assign new_n58_ = x09 & ~x10 & ((x21 & (~x19 | (~x20 & ~x23))) | (x19 & x20 & ~x21 & ~x23));
  assign z12 = (x03 & x08 & (~x19 | ~x23)) | (new_n61_ & ~x08) | (x19 & (new_n60_ | x23));
  assign new_n60_ = ~x08 & x09 & ~x10 & x20 & x21 & ~x22;
  assign new_n61_ = x09 & ~x10 & x22 & (~x19 | ~x20 | ~x21);
  assign z13 = (x04 & ~new_n47_ & x08) | new_n47_ | (~x08 & new_n63_ & x09);
