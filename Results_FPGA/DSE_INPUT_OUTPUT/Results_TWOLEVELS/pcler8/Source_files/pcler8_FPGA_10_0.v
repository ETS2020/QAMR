...
module FAU ( 
  ...
  assign new_n60_ = (~x13 | x19) & (~new_n49_ | ~new_n50_ | ~new_n61_ | ~x11 | ~x19);
  assign new_n61_ = x20 & x21;
  assign z10 = z02 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x19 & ((new_n64_ & new_n65_) | ~x20)) | (x13 & ~x19 & x20));
  ...
  assign new_n68_ = ~x19 & (~x13 | (~x08 & x09 & ~x10 & x21));
  ...
  assign new_n72_ = ~x19 & (~x13 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x19 | ((~x23 | (new_n61_ & ~new_n75_ & x22)) & (~new_n61_ | ~x22 | x23))) & (~x13 | x19 | ~x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = new_n79_ | (~x08 & x09 & ~new_n77_ & ~x10) | (x05 & x08);
  assign new_n77_ = (~x24 | (new_n61_ & x22 & ~new_n78_ & x23)) & (~new_n61_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = ~x19 & (~x13 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | new_n86_ | (~x08 & new_n81_ & x09);
