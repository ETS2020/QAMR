...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (~x12 | ~x19)) | (x12 & x19) | (~x08 & new_n60_ & x09);
  ...
  assign new_n64_ = x09 & ~x10 & ((~x19 & x20) | (~x12 & x19 & ~x20));
  ...
  assign new_n68_ = ~x12 & (x08 | ~x09 | x10 | ~x20 | x21);
  assign z12 = (x03 & x08 & (~x12 | ~x19)) | (new_n70_ & ~x08) | (x19 & (new_n72_ | x12));
  ...
  assign z13 = (x04 & x08 & (~x12 | ~x19)) | (x19 & (new_n74_ | x12)) | (new_n75_ & ~x08);
  ...
  assign new_n78_ = (x12 | ((~x24 | (new_n48_ & new_n79_)) & (~new_n80_ | ~new_n48_ | ~x19))) & (x19 | ~x24);
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (~x12 | ~x19)) | (x19 & (new_n82_ | x12)) | (new_n84_ & ~x08);
  ...
  assign new_n87_ = ~x12 & ((new_n90_ & new_n91_) | (x26 & (~new_n88_ | ~new_n89_)));
