...
module FAU ( 
  ...
  assign new_n69_ = new_n61_ & x14 & x22 & x23;
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((x05 & ((~new_n72_ & x19) | (~new_n73_ & x23))) | (~x19 & x23));
  assign new_n72_ = (~new_n60_ | ~x22 | x23) & (~new_n61_ | ~x15 | ~x23);
  assign new_n73_ = x20 & x21 & x22;
  assign z14 = z06 | (x09 & ~x10 & (new_n75_ | (new_n77_ & ~x08)));
  assign new_n75_ = x19 & (new_n76_ | (new_n60_ & x22 & x23 & ~x24));
  assign new_n76_ = x16 & x24 & x25 & x26;
  assign new_n77_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = z07 | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((x05 & ((~new_n80_ & x19) | (~new_n81_ & x25))) | (~x19 & x25));
  assign new_n80_ = (~x17 | ~x25 | ~x26) & (~new_n73_ | ~x23 | ~x24 | x25);
  assign new_n81_ = new_n60_ & x22 & x23 & x24;
  assign z16 = (x07 & ~new_n50_ & x08) | (~x08 & new_n83_ & x09);
  assign new_n83_ = ~x10 & ((x05 & ((~new_n84_ & x19) | (~new_n85_ & x26))) | (~x19 & x26));
  assign new_n84_ = (~x18 | ~x26) & (~new_n73_ | ~x23 | ~x24 | ~x25 | x26);
  assign new_n85_ = new_n73_ & x23 & x24 & x25;
endmodule
