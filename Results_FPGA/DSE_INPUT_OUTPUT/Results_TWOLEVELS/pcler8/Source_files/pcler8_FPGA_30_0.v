...
module FAU ( 
  ...
  assign new_n65_ = ~x19 & (~x16 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (x16 | x19)) | (~x19 & (new_n69_ | ~x16)) | (new_n67_ & ~x08);
  ...
  assign new_n71_ = (~x19 | ((~x20 | ~x21 | x22) & (~x22 | (x20 & ~new_n72_ & x21)))) & (~x16 | x19 | ~x22);
  assign new_n72_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x19 | ((~x23 | (new_n61_ & ~new_n75_ & x22)) & (~new_n61_ | ~x22 | x23))) & (~x16 | x19 | ~x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | new_n79_ | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x24 | (new_n61_ & x22 & ~new_n78_ & x23)) & (~x22 | ~x23 | x24 | ~new_n61_ | ~x19);
  assign new_n78_ = x16 & x25 & x26;
  assign new_n79_ = ~x19 & (~x16 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n85_ | (~x08 & x09 & ~new_n81_ & ~x10) | (x06 & x08);
  assign new_n81_ = (~x25 | (new_n83_ & new_n84_)) & (~new_n82_ | ~new_n48_ | ~x24 | x25);
  assign new_n82_ = x19 & x20 & x21;
  assign new_n83_ = x20 & x21 & x22;
  assign new_n84_ = x23 & x24 & (~x17 | ~x26);
  assign new_n85_ = ~x19 & (~x16 | (~x08 & x09 & ~x10 & x25));
