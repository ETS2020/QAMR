...
module FAU ( 
  ...
  assign new_n58_ = x19 & (~new_n59_ | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n59_ = x11 & x20 & x21 & x22;
  assign z10 = z02 | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = x19 ? (~x25 | (~new_n62_ & x20)) : ~x20;
  assign new_n62_ = x12 & x21 & x22 & x23 & x24 & x26;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x25 & ((x19 & (new_n65_ | (x20 & ~x21))) | (~x20 & x21))) | (~x19 & x21));
  assign new_n65_ = x13 & x21 & x22 & x23 & x24 & x26;
  assign z12 = (x03 & ~new_n49_ & x08) | new_n49_ | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x19 & (new_n68_ | (x20 & x21 & ~x22))) | (x22 & (~x19 | ~x20 | ~x21)));
  assign new_n68_ = x14 & x22 & x23 & x24 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x19 | (~new_n71_ & (~x20 | ~x21 | ~x22 | x23))) & (~x23 | (x19 & x20 & x21 & x22));
  assign new_n71_ = x15 & x23 & x24 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (x19 | ~x24) & (~x25 | ((new_n76_ | ~x24) & (~x19 | (~new_n74_ & ~new_n75_))));
  assign new_n74_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n75_ = x16 & x24 & x26;
  assign new_n76_ = x20 & x21 & x22 & x23;
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = x19 ? ((new_n79_ | ~x20) & (x20 | ~x25) & (~x17 | ~x26)) : ~x25;
  assign new_n79_ = x21 ? (x22 & (~x22 | (x23 & (~x23 | x24 | ~x25)))) : ~x25;
  assign z16 = z08 | (~new_n81_ & x19) | (~x08 & new_n83_ & x09);
  assign new_n81_ = x25 & (~new_n82_ | x08 | ~x09 | x10 | ~x20);
  assign new_n82_ = x21 & x22 & x23 & x24 & ~x26;
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | x18 | ~x19 | ~x20);
  assign new_n84_ = x21 & x22 & x23 & x24;
endmodule
