...
module FAU ( 
  ...
  assign z04 = x08 & (~x20 | (x03 & x20));
  assign z05 = x08 & (~x20 | (x04 & x20));
  assign z06 = x20 & x05 & x08;
  assign z07 = x08 & (x06 | ~x20);
  ...
  assign z11 = (~new_n64_ & x20) | (~x08 & x09 & new_n62_ & ~x10);
  assign new_n62_ = x21 & (~x19 | new_n63_ | ~x20);
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n64_ = (~x02 | ~x08) & (x08 | ~x09 | x10 | ~x19 | x21);
  assign z12 = (x20 & (new_n68_ | (x03 & x08))) | (new_n66_ & ~x08);
  assign new_n66_ = x09 & ~x10 & x22 & (~new_n67_ | ~x19 | ~x20);
  assign new_n67_ = x21 & (~x14 | ~x23 | ~x24 | ~x25 | ~x26);
  assign new_n68_ = ~x08 & x09 & ~x10 & x19 & x21 & ~x22;
  assign z13 = (x20 & (new_n70_ | (x04 & x08))) | (new_n72_ & ~x08);
  ...
  assign z14 = (x09 & ~new_n75_ & ~x10) | (x08 & (~x20 | (x05 & x20)));
  assign new_n75_ = (x08 | (~new_n77_ & (~x24 | (new_n71_ & new_n76_)))) & (x20 | ~x24);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (x09 & ~x10 & (new_n79_ | (~x20 & x25)));
  assign new_n79_ = ~x08 & ((new_n80_ & new_n83_) | (x25 & (~new_n81_ | ~new_n82_)));
  assign new_n80_ = x19 & x20 & x21;
  assign new_n81_ = x19 & x21 & x22;
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign z16 = (x20 & (new_n85_ | (x07 & x08))) | (~x08 & new_n87_ & x09);
  assign new_n85_ = new_n86_ & new_n71_ & ~x10 & ~x08 & x09;
  assign new_n86_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | ~new_n89_);
