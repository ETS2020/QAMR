...
module FAU ( 
  ...
  assign new_n61_ = (~x20 | (x19 & (~new_n59_ | ~new_n62_))) & (x01 | ~x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (~x01 | x20)) | (~x20 & (new_n66_ | x01)) | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & ((x21 & (new_n65_ | ~x19)) | (x19 & x20 & ~x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n66_ = ~x08 & x09 & ~x10 & x21;
  assign z12 = (~x01 & (new_n70_ | (x03 & x08))) | (x20 & (x08 ? x03 : new_n68_));
  assign new_n68_ = x09 & ~x10 & ((x19 & x21 & ~x22) | (x22 & (~x19 | new_n69_ | ~x21)));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign new_n70_ = ~x08 & x09 & ~x10 & ~x20 & x22;
  assign z13 = (~x01 & (new_n75_ | (x04 & x08))) | (x20 & (x08 ? x04 : new_n72_));
  assign new_n72_ = x09 & ~x10 & ((x23 & (~new_n73_ | new_n74_ | ~x22)) | (new_n73_ & x22 & ~x23));
  assign new_n73_ = x19 & x21;
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign new_n75_ = ~x08 & x09 & ~x10 & ~x20 & x23;
  assign z14 = new_n77_ | (x20 & (x08 ? x05 : (new_n79_ & x09)));
  assign new_n77_ = ~new_n78_ & ~x01;
  assign new_n78_ = (~x05 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x24);
  assign new_n79_ = ~x10 & ((x24 & (~new_n73_ | ~x22 | new_n80_ | ~x23)) | (new_n73_ & x22 & x23 & ~x24));
  assign new_n80_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (new_n84_ | ~x25) & (~x20 | (~new_n83_ & (~x17 | ~x25 | ~x26)));
  assign new_n83_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  ...
  assign new_n88_ = ~x10 & ((x26 & (~new_n90_ | ~new_n91_)) | (new_n89_ & new_n92_));
