...
module FAU ( 
  ...
  assign z14 = new_n75_ | (x05 & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (new_n58_ & x22 & ~new_n74_ & x23)) & (~new_n58_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n74_ = x16 & x25 & x26;
  assign new_n75_ = ~x19 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (x06 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n78_ & new_n59_ & x24 & (~x17 | ~x26))) & (~new_n78_ | ~new_n59_ | ~x24 | x25);
