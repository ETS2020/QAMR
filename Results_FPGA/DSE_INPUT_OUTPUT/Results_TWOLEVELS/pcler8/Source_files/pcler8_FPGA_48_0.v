...
module FAU ( 
  ...
  assign z13 = new_n70_ | (x04 & x08) | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x23 | (x20 & x21 & ~new_n69_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign new_n70_ = ~x19 & (~x09 | (~x08 & ~x10 & x23));
  assign z14 = z06 | new_n75_ | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x24 | (new_n73_ & x22 & ~new_n74_ & x23)) & (~x22 | ~x23 | x24 | ~new_n73_ | ~x19);
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x16 & x25 & x26;
  assign new_n75_ = ~x19 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (x06 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n82_ & ~x08))) | (~x08 & new_n77_ & x09);
  ...
  assign z16 = (x07 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n89_ & ~x08))) | (~x08 & new_n84_ & x09);
