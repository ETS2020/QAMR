...
module FAU ( 
  ...
  assign new_n58_ = x19 & (~new_n60_ | ~new_n59_ | ~x11 | ~x20);
  assign new_n59_ = x21 & x22;
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & ~new_n62_ & ~x10);
  assign new_n62_ = (~x09 | (~x19 ^ x20)) & (~new_n60_ | ~new_n59_ | ~x12 | ~x20);
  ...
  assign new_n67_ = (~x22 | (new_n68_ & ~new_n69_ & x21)) & (~new_n68_ | ~x21 | x22);
  assign new_n68_ = x19 & x20;
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x23 | (~new_n72_ & (~x21 | (x19 & x20 & x22)))) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n72_ = x09 & (~x21 | (x15 & x21 & x24 & x25 & x26));
  assign z14 = (x05 & ~new_n49_ & x08) | new_n49_ | (~x08 & ~x10 & (new_n74_ | new_n76_));
  assign new_n74_ = x24 & (new_n75_ | (x21 & (~new_n68_ | ~x22 | ~x23)));
  assign new_n75_ = x09 & (~x21 | (x16 & x21 & x25 & x26));
  assign new_n76_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (new_n80_ | ~x25) & (~x21 | (~new_n79_ & (~x17 | ~x25 | ~x26)));
  assign new_n79_ = x19 & x20 & x22 & x23 & x24 & ~x25;
  assign new_n80_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & ~x10 & (new_n84_ | (~new_n82_ & x26)));
  assign new_n82_ = (new_n83_ | ~x21) & (~x09 | (x21 & x22 & x23 & x24));
  assign new_n83_ = ~x18 & x19 & x20 & x25;
  assign new_n84_ = new_n59_ & new_n68_ & x23 & x24 & x25 & ~x26;
endmodule
