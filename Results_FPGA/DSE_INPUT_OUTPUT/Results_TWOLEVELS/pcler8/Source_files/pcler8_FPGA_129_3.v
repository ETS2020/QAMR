...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (~x14 | ~x19)) | (x19 & (new_n73_ | x14)) | (new_n71_ & ~x08);
  ...
  assign new_n75_ = (x14 | (~new_n77_ & (~x23 | (new_n48_ & new_n76_)))) & (x19 | ~x23);
  assign new_n76_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n77_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (~new_n79_ & x19) | (new_n81_ & ~x08) | (x05 & x08);
  assign new_n79_ = ~x14 & (~new_n80_ | ~x21 | ~x22 | ~x23 | x24);
  assign new_n80_ = ~x08 & x09 & ~x10 & x20;
  assign new_n81_ = x09 & ~x10 & x24 & (~new_n72_ | ~new_n82_);
  assign new_n82_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = new_n58_ | (~x08 & x09 & ~x10 & (new_n84_ | new_n88_));
  assign new_n84_ = ~x14 & ((new_n72_ & new_n87_) | (x25 & (~new_n85_ | ~new_n86_)));
  assign new_n85_ = x20 & x21 & x22;
  assign new_n86_ = x23 & x24 & (~x17 | ~x26);
  assign new_n87_ = x22 & x23 & x24 & ~x25;
  assign new_n88_ = ~x19 & x25;
  assign z16 = new_n60_ | (~x08 & x09 & ~x10 & (new_n90_ | new_n95_));
  assign new_n90_ = ~x14 & ((new_n93_ & new_n94_) | (x26 & (~new_n91_ | ~new_n92_)));
