...
module FAU ( 
  ...
  assign new_n57_ = new_n58_ & x20 & x21 & x09 & x11;
  assign new_n58_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08 & (x09 | x19)) | (~x09 & ~x19) | (new_n60_ & ~x08);
  assign new_n60_ = ~x10 & ((x09 & ((new_n61_ & new_n62_) | (x19 & ~x20))) | (~x19 & x20));
  assign new_n61_ = x12 & x20 & x21 & x22;
  assign new_n62_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n66_ & ~x08))) | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x21 & (new_n65_ | ~x20)) | (x19 & x20 & ~x21));
  ...
  assign z15 = (~x19 & (~x09 | (new_n84_ & ~x08))) | (x06 & x08) | (~x08 & new_n80_ & x09);
  ...
  assign z16 = (x07 & x08 & (x09 | x19)) | (~x08 & new_n86_ & x09);
