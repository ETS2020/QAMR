...
module FAU ( 
  ...
  assign new_n72_ = (~x19 | (~new_n73_ & (~x22 | x23 | ~x20 | ~x21))) & (~x23 | (x21 & x22 & (x20 | ~x22)));
  assign new_n73_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | ((~x23 | (~new_n76_ & ~new_n77_)) & (new_n78_ | ~x24))) & (x23 | ~x24);
  ...
  assign new_n80_ = (~x19 | ((~x23 | (~new_n81_ & ~new_n82_)) & (new_n83_ | ~x25))) & (x23 | ~x25);
  assign new_n81_ = x20 & x21 & x22 & x24 & ~x25;
  assign new_n82_ = x17 & x25 & x26;
  assign new_n83_ = x20 & x21 & x22 & x24;
  assign z16 = (x07 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n85_ & ~x10);
  assign new_n85_ = (~x23 | (~new_n86_ & (~new_n78_ | ~x24 | ~x25 | x26))) & (~x26 | (new_n78_ & x23 & x24 & x25));
