...
module FAU ( 
  ...
  assign new_n61_ = x20 & (~x19 | (new_n59_ & x12 & x21 & x22));
  assign z11 = z03 | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x20 | ((~new_n59_ | ~x13 | ~x21 | ~x22) & (~x19 | x21))) & (x19 | ~x21);
  assign z12 = (x03 & ~new_n49_ & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x20 & ((x22 & (new_n66_ | ~x21)) | (x19 & x21 & ~x22))) | (~x19 & x22));
  assign new_n66_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x19 | ((~x20 | x22 | ~x23) & (~x21 | ~x22 | x23))) & (~x23 | (x19 & ~new_n69_ & x21));
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x19 | (~new_n72_ & (~x21 | ~x22 | ~x23 | x24))) & (~x24 | (x19 & x21 & x22 & x23));
  assign new_n72_ = x16 & x20 & x24 & x25 & x26;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = ~new_n77_ & (~x19 | (~new_n75_ & ~new_n76_));
  assign new_n75_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n76_ = x17 & x20 & x25 & x26;
  assign new_n77_ = x25 & (~x19 | ~x21 | ~x22 | ~x23 | ~x24);
  assign z16 = (x07 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x20 | ((~x19 | (~new_n80_ & (~x18 | ~x26))) & (new_n81_ | ~x26))) & (x19 | ~x26);
