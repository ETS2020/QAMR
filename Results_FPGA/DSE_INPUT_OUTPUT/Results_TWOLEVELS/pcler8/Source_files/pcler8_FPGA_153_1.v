...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n61_ | ~new_n60_ | ~x11 | ~x16);
  ...
  assign new_n67_ = ~x10 & ((x16 & ((x21 & (new_n68_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n68_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x19 & (new_n72_ | ~x16)) | (x03 & x08) | (new_n70_ & ~x08);
  ...
  assign new_n74_ = (~x16 | (~new_n76_ & ((new_n60_ & new_n75_) | ~x23))) & (x19 | ~x23);
  assign new_n75_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n76_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (x05 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x19 | ~x20 | ~new_n80_ | ~x21) & (~x24 | (x19 & x20 & new_n79_ & x21));
  assign new_n79_ = x22 & x23;
  assign new_n80_ = x22 & x23 & (~x24 | (x25 & x26 & x16 & x24));
  assign z15 = (x06 & x08 & (x16 | ~x19)) | (x19 & (new_n82_ | ~x16)) | (new_n84_ & ~x08);
  assign new_n82_ = new_n83_ & ~x08 & x09 & ~x10 & x20;
  assign new_n83_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n84_ = x09 & ~x10 & x25 & (~new_n85_ | ~new_n60_ | ~x19);
  assign new_n85_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~new_n87_ & x19) | (~x08 & new_n89_ & x09);
  assign new_n87_ = x16 & (~new_n88_ | ~new_n79_ | ~x24 | ~x25 | x26);
  assign new_n88_ = ~x08 & x09 & ~x10 & x20 & x21;
  assign new_n89_ = ~x10 & x26 & (~new_n90_ | ~new_n79_ | ~x24 | ~x25);
