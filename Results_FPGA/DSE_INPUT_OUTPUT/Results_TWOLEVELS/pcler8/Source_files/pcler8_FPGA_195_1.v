...
module FAU ( 
  ...
  assign z01 = (~x01 & x19) | (x00 & x08);
  assign z02 = x01 & x08;
  assign z03 = x02 & x08 & (x01 | ~x19);
  assign z04 = x03 & x08 & (x01 | ~x19);
  assign z05 = (~x01 & x19) | (x04 & x08);
  assign z06 = (~x01 & x19) | (x05 & x08);
  assign z07 = x06 & x08 & (x01 | ~x19);
  assign z08 = new_n58_ | (~x01 & x19);
  assign new_n58_ = x07 & x08 & (x01 | ~x19);
  assign z09 = z01 | (~x08 & new_n60_ & x09);
  assign new_n60_ = ~x10 & (~x19 | (new_n62_ & new_n61_ & x11 & x20));
  assign new_n61_ = x21 & x22;
  assign new_n62_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08) | (x09 & ~x10 & ((~new_n64_ & x01) | (new_n65_ & ~x08)));
  assign new_n64_ = (~x19 | x20) & (~new_n62_ | ~new_n61_ | ~x12 | ~x20);
  ...
  assign z12 = (x03 & x08 & (x01 | ~x19)) | (new_n71_ & ~x08) | ((new_n73_ | ~x01) & x19);
  ...
  assign z13 = (x19 & (new_n75_ | ~x01)) | (x04 & x08) | (new_n76_ & ~x08);
  ...
  assign new_n79_ = x19 & (~x01 | (new_n80_ & new_n61_ & x23 & ~x24));
  assign new_n80_ = ~x08 & x09 & ~x10 & x20;
  assign new_n81_ = x24 & (~new_n82_ | ~new_n48_ | ~x19);
  assign new_n82_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x06 & x08 & (x01 | ~x19)) | (x19 & (new_n84_ | ~x01)) | (new_n85_ & ~x08);
  assign new_n84_ = new_n80_ & new_n61_ & x23 & x24 & ~x25;
