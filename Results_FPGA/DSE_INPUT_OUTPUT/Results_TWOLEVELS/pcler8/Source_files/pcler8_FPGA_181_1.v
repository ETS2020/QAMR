...
module FAU ( 
  ...
  assign z11 = (x02 & ~new_n50_ & x08) | new_n50_ | (~x08 & ~x10 & (new_n64_ | new_n66_));
  assign new_n64_ = x21 & (new_n65_ | (new_n60_ & x13 & x19 & x22));
  assign new_n65_ = x09 & (~x19 | ~x20);
  ...
  assign z13 = (x04 & ~new_n50_ & x08) | new_n50_ | (~x08 & ~new_n71_ & ~x10);
  assign new_n71_ = ~new_n73_ & (~x19 | (~new_n72_ & (~new_n47_ | ~x22 | x23)));
  assign new_n72_ = x15 & x23 & x24 & x25 & x26;
  assign new_n73_ = x09 & x23 & (~x21 | ~x22 | ~x19 | ~x20);
  assign z14 = (x05 & ~new_n50_ & x08) | new_n50_ | (new_n75_ & ~x08);
  ...
  assign new_n82_ = x25 & (~new_n47_ | ~x19 | ~x22 | ~x23 | ~x24);
  assign z16 = z08 | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((x26 & (~new_n86_ | ~new_n87_)) | (new_n85_ & new_n88_));
