...
module FAU ( 
  ...
  assign new_n67_ = (~x22 | (new_n68_ & x21 & (~new_n60_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  ...
  assign new_n73_ = (~new_n75_ | ~x09) & (~x19 | (~new_n74_ & (~new_n60_ | ~x09 | ~x16)));
  ...
  assign z16 = (x19 & (new_n81_ | ~x09)) | (x07 & x08) | (~x08 & new_n83_ & x09);
  assign new_n81_ = new_n82_ & new_n58_ & ~x08 & ~x10;
  assign new_n82_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n83_ = ~x10 & x26 & (~new_n84_ | ~new_n58_ | x18 | ~x19);
