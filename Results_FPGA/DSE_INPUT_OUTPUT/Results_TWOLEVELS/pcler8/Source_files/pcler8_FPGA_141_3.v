...
module FAU ( 
  ...
  assign new_n77_ = (~x25 | (new_n74_ & new_n49_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n49_ | ~x24 | x25);
  assign z16 = new_n79_ | (~x08 & x09 & ~x10 & ~new_n81_ & x26);
  assign new_n79_ = ~new_n47_ & ((x07 & x08) | (new_n48_ & new_n80_));
  assign new_n80_ = x21 & x22 & x23 & x24 & x25 & ~x26;
  assign new_n81_ = x18 ? x06 : (new_n74_ & new_n49_ & x24 & x25);
endmodule
