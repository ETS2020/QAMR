...
module FAU ( 
  ...
  assign z13 = (~x08 & x09 & ~new_n74_ & ~x10) | (x04 & ~new_n47_ & x08);
  assign new_n74_ = (~x23 | (~new_n75_ & (~x19 | (x20 & x21 & x22)))) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n75_ = x26 & (~x19 | (x15 & x24 & x25));
  assign z14 = (new_n77_ & ~x08) | (x05 & ~new_n47_ & x08);
  assign new_n77_ = x09 & ~x10 & (new_n80_ | ((new_n78_ | new_n79_) & x24));
  assign new_n78_ = x26 & (~x19 | (x16 & x25));
  assign new_n79_ = x19 & (~x22 | ~x23 | ~x20 | ~x21);
  ...
  assign new_n84_ = x26 & (x17 | ~x19);
  assign new_n85_ = x19 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n86_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n88_ | new_n90_));
  assign new_n88_ = x25 & ((~x19 & x26) | (new_n89_ & x19 & new_n49_ & x24 & ~x26));
  assign new_n89_ = x20 & x21;
  assign new_n90_ = x26 & (~new_n89_ | x18 | ~new_n49_ | ~x24 | ~x25);
endmodule
