...
module FAU ( 
  ...
  assign new_n63_ = (~x04 | ((~x19 | x20) & (~new_n61_ | ~new_n60_ | ~x12 | ~x20))) & (x19 | ~x20);
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x04 & ((x21 & (new_n66_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x19 & (new_n70_ | ~x04)) | (x03 & x08) | (new_n68_ & ~x08);
  ...
  assign z13 = (x09 & ~new_n72_ & ~x10) | new_n50_ | z05;
  assign new_n72_ = ~new_n75_ & (~x19 | (~new_n74_ & (~new_n73_ | ~x22 | x23)));
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x15 & x23 & x24 & x25 & x26;
  assign new_n75_ = ~x08 & x23 & (~x19 | ~x20 | ~x21 | ~x22);
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x19 | ~x24) & (~x04 | ((~x24 | (new_n73_ & new_n78_)) & (~new_n79_ | ~new_n73_ | ~x19)));
  ...
  assign new_n86_ = x04 & (~new_n48_ | ~new_n87_);
