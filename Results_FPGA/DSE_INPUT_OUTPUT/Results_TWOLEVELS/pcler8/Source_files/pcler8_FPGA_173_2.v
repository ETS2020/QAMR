...
module FAU ( 
  ...
  assign z10 = new_n62_ | (x01 & x08) | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (~new_n59_ | ~x12 | ~x20 | ~x21 | ~x22) & (~x19 | x20);
  assign new_n62_ = ~x19 & (x05 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (~x05 | x19)) | (~x19 & (new_n66_ | x05)) | (new_n64_ & ~x08);
  ...
  assign new_n70_ = ~x19 & (x05 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (~x08 & x09 & ~new_n72_ & ~x10) | (x04 & ~new_n49_ & x08);
  assign new_n72_ = (~x19 | ((~x23 | (new_n73_ & ~new_n74_ & x22)) & (~new_n73_ | ~x22 | x23))) & (x05 | x19 | ~x23);
  assign new_n73_ = x20 & x21;
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & new_n76_ & x09);
