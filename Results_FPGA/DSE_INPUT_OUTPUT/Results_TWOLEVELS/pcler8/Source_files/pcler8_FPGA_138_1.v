...
module FAU ( 
  ...
  assign new_n71_ = ~x19 & (x26 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (~x08 & x09 & ~new_n73_ & ~x10) | (x04 & ~new_n50_ & x08);
  assign new_n73_ = x19 ? ((~x23 | (new_n74_ & ~new_n75_ & x22)) & (~new_n74_ | ~x22 | x23)) : (~x23 | x26);
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = (~x08 & x09 & ~new_n77_ & ~x10) | (x05 & ~new_n50_ & x08);
  assign new_n77_ = x19 ? ((~x24 | (new_n74_ & new_n78_)) & (~new_n74_ | ~new_n79_)) : (~x24 | x26);
