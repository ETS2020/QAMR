...
module FAU ( 
  ...
  assign new_n60_ = (~x18 | ~x20 | (x19 & (~new_n62_ | ~new_n61_ | ~x11))) & (x19 | x20);
  assign new_n61_ = x21 & x22;
  assign new_n62_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n64_ & ~x10);
  assign new_n64_ = x20 ? ((~new_n62_ | ~new_n61_ | ~x12) & (~x18 | x19)) : ~x19;
  assign z11 = (x02 & x08 & (x18 | ~x20)) | (x20 & (new_n68_ | ~x18)) | (new_n66_ & ~x08);
  ...
  assign new_n70_ = (~x18 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x20 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (x18 | ~x20)) | (x20 & (new_n73_ | ~x18)) | (new_n75_ & ~x08);
  ...
  assign new_n78_ = (x20 | ~x24) & (~x18 | (~new_n80_ & ((new_n74_ & new_n79_) | ~x24)));
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = new_n57_ | (~x08 & x09 & ~x10 & (new_n82_ | new_n87_));
  assign new_n82_ = x18 & ((new_n83_ & new_n86_) | (x25 & (~new_n84_ | ~new_n85_)));
  ...
  assign new_n89_ = ~x26 & (~new_n83_ | ~x22 | ~x23 | ~x24 | ~x25);
endmodule
