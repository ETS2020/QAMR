...
module FAU ( 
  ...
  assign new_n63_ = ~x19 & (x14 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x19 & (x21 ? (new_n66_ | ~x20) : x20)) | (~x14 & ~x19 & x21));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08 & (~x14 | x19)) | (x14 & (new_n68_ | ~x19)) | (new_n69_ & ~x08);
  assign new_n68_ = new_n60_ & ~x10 & x22 & ~x08 & x09;
  assign new_n69_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & ~new_n47_ & x08);
  assign new_n71_ = (x14 | x19 | ~x23) & (~x19 | ((~x23 | (new_n72_ & ~new_n73_ & x22)) & (~new_n72_ | ~x22 | x23)));
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x25 & x26 & x15 & x24;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | ((~x24 | (new_n72_ & new_n76_)) & (~new_n72_ | ~new_n77_))) & (x14 | x19 | ~x24);
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x19 | ((~x25 | (new_n80_ & new_n81_)) & (~new_n80_ | ~new_n82_))) & (x14 | x19 | ~x25);
  ...
  assign new_n89_ = ~x19 & (x14 | (~x08 & x09 & ~x10 & x26));
endmodule
