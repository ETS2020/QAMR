...
module FAU ( 
  ...
  assign new_n50_ = x08 & (~x01 | ~x20);
  assign z02 = x01 & x08 & ~x20;
  assign z03 = new_n50_ & x02;
  assign z04 = new_n50_ & x03;
  assign z05 = (x01 & x20) | (x04 & x08 & (~x01 | ~x20));
  assign z06 = new_n50_ & x05;
  assign z07 = (x01 & x20) | (x06 & x08);
  assign z08 = new_n50_ & x07;
  assign z09 = (x00 & x08 & (~x01 | ~x20)) | (x01 & x20) | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & (~x19 | (new_n61_ & new_n60_ & x11 & x20));
  assign new_n60_ = x21 & x22;
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z10 = (~x08 & x09 & ~new_n63_ & ~x10) | (x01 & x08 & ~x20);
  assign new_n63_ = (x01 | ~x20 | (x19 & (~new_n61_ | ~new_n60_ | ~x12))) & (~x19 | x20);
  assign z11 = (x02 & x08 & (~x01 | ~x20)) | (x20 & (new_n67_ | x01)) | (new_n65_ & ~x08);
  ...
  assign new_n69_ = (x01 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x20 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (new_n50_ & x04) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (x01 | (~new_n75_ & ((new_n73_ & new_n74_) | ~x23))) & (x20 | ~x23);
  assign new_n73_ = x19 & x21;
  assign new_n74_ = x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n75_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x01 | (~new_n79_ & ((new_n73_ & new_n78_) | ~x24))) & (x20 | ~x24);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((x20 & (new_n82_ | new_n83_)) | (~new_n84_ & x25));
  assign new_n82_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n83_ = x25 & x26 & ~x01 & x17;
  assign new_n84_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n91_));
  assign new_n86_ = ~x01 & ((new_n89_ & new_n90_) | ((~new_n87_ | ~new_n88_) & x26));
