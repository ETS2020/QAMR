...
module FAU ( 
  ...
  assign new_n63_ = (~x19 | (x20 & (~new_n64_ | ~new_n65_))) & (x15 | x19 | ~x20);
  ...
  assign new_n70_ = (~x19 | ((~x22 | (x20 & ~new_n71_ & x21)) & (~x20 | ~x21 | x22))) & (x15 | x19 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n73_ | (x04 & x08) | (~x08 & new_n74_ & x09);
  assign new_n73_ = x15 & (~x19 | (new_n65_ & ~x08 & x09 & ~x10));
  assign new_n74_ = ~x10 & ((x19 & ((~x21 & x23) | (x20 & x21 & x22 & ~x23))) | (x23 & (~x19 | ~x20 | ~x22)));
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | ((~x24 | (new_n60_ & new_n77_)) & (~new_n60_ | ~new_n78_))) & (x15 | x19 | ~x24);
  ...
  assign new_n85_ = ~x19 & (x15 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n92_ = ~x19 & (x15 | (~x08 & x09 & ~x10 & x26));
endmodule
