...
module FAU ( 
  ...
  assign new_n75_ = (~x24 | (~new_n77_ & (~x19 | (new_n76_ & x22 & x23)))) & (~new_n76_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n76_ = x20 & x21;
  assign new_n77_ = x16 & (~x19 | (x25 & x26));
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x19 | ((~new_n80_ | ~new_n82_) & (~x25 | (new_n80_ & new_n81_)))) & (~x16 | x19 | ~x25);
  assign new_n80_ = x20 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x23 & x24 & ~x25;
  assign z16 = new_n57_ | (~x08 & x09 & ~x10 & (new_n84_ | new_n88_));
  assign new_n84_ = x19 & ((new_n80_ & new_n87_) | (x26 & (~new_n85_ | ~new_n86_)));
  assign new_n85_ = ~x18 & x20 & x21;
  assign new_n86_ = x22 & x23 & x24 & x25;
  assign new_n87_ = x23 & x24 & x25 & ~x26;
  assign new_n88_ = x16 & ~x19 & x26;
endmodule
