...
module FAU ( 
  ...
  assign new_n63_ = x21 ? (x20 & (~new_n58_ | ~x13 | ~x22 | ~x23)) : ~x20;
  ...
  assign z15 = (x06 & x08) | (x09 & (~x19 | (new_n73_ & ~x08)));
  assign new_n73_ = ~x10 & ((x25 & (~new_n74_ | ~x23 | new_n75_ | ~x24)) | (new_n74_ & x23 & x24 & ~x25));
  assign new_n74_ = x20 & x21 & x22;
  assign new_n75_ = x17 & x19 & x26;
  assign z16 = (x07 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n77_ & x19);
  assign new_n77_ = (~x26 | (new_n78_ & new_n69_ & ~x18)) & (~new_n74_ | ~new_n79_);
