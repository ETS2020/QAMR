...
module FAU ( 
  ...
  assign new_n71_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (x04 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x23 | ((~x19 | (x21 & x22)) & (~x21 | (x19 & ~new_n74_ & x20)))) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n47_ & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x19 | ((~new_n77_ | ~x20 | ~x21) & (x21 | ~x24))) & (~x21 | ~x24 | (new_n78_ & x19 & x20));
  assign new_n77_ = x22 & x23 & ~x24;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (new_n80_ & ~x08);
  assign new_n80_ = x09 & ~x10 & (new_n81_ | (~new_n83_ & x19));
  assign new_n81_ = x25 & (~new_n82_ | ~x19 | ~x20 | (x21 & ~x22));
  assign new_n82_ = x23 & x24 & (~x17 | ~x26);
  assign new_n83_ = (x21 | ~x25) & (~x20 | ~x21 | ~x22 | ~x23 | ~x24 | x25);
  assign z16 = (x07 & ~new_n47_ & x08) | new_n47_ | (~x08 & new_n85_ & x09);
  assign new_n85_ = ~x10 & ((~new_n87_ & x26) | (~new_n86_ & x19));
  assign new_n86_ = (x21 | ~x26) & (~x20 | ~x21 | ~x22 | ~new_n61_ | ~x25 | x26);
  assign new_n87_ = new_n48_ & ~x18 & x24 & x25 & x22 & x23;
endmodule
