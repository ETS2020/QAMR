...
module FAU ( 
  ...
  assign z03 = (~x04 & ~x19) | (x02 & x08 & (x04 | x19));
  assign z04 = (~x04 & ~x19) | (x03 & x08);
  assign z05 = x04 & x08;
  assign z06 = (~x04 & ~x19) | (x05 & x08 & (x04 | x19));
  assign z07 = x06 & x08 & (x04 | x19);
  assign z08 = x07 & x08 & (x04 | x19);
  assign z09 = (x00 & x08 & (x04 | x19)) | (~x08 & new_n57_ & x09);
  assign new_n57_ = ~x10 & ((x04 & ~x19) | (new_n59_ & new_n58_ & x11 & x19));
  assign new_n58_ = x20 & x21;
  assign new_n59_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | new_n63_ | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x19 | x20) & (~new_n62_ | ~x21 | ~x22 | ~x12 | ~x20);
  assign new_n62_ = x23 & x24 & x25 & x26;
  assign new_n63_ = ~x19 & (~x04 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (x04 | x19)) | (~x08 & new_n65_ & x09);
  ...
  assign new_n70_ = ~x19 & (~x04 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (x04 & (x08 | (new_n74_ & x09 & ~x10))) | (~x08 & x09 & new_n72_ & ~x10);
  assign new_n72_ = x19 & ((x23 & (~new_n58_ | new_n73_ | ~x22)) | (new_n58_ & x22 & ~x23));
  ...
  assign z15 = z07 | new_n85_ | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x25 | (new_n82_ & new_n83_)) & (~new_n84_ | ~new_n58_ | ~x19);
  assign new_n82_ = x20 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign new_n85_ = ~x19 & (~x04 | (~x08 & x09 & ~x10 & x25));
