...
module FAU ( 
  ...
  assign z10 = (~x08 & x09 & ~new_n65_ & ~x10) | (x01 & x08 & ~x19);
  assign new_n65_ = (x01 | ~x19 | (x20 & (~new_n63_ | ~new_n62_ | ~x12))) & (x19 | ~x20);
  ...
  assign z13 = (x04 & x08 & (~x01 | ~x19)) | (x19 & (new_n74_ | x01)) | (new_n76_ & ~x08);
  ...
  assign new_n79_ = ~x01 & (~new_n80_ | ~new_n62_ | ~x23 | x24);
