...
module FAU ( 
  ...
  assign z13 = (x04 & (~x19 | (x08 & x19))) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x23 | (x19 & x20 & x21 & ~new_n75_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
