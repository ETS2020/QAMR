...
module FAU ( 
  ...
  assign new_n69_ = (~x23 | (new_n67_ & ~new_n70_ & x22)) & (~new_n67_ | ~x21 | ~x22 | x23);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign new_n71_ = ~x21 & (~x09 | (~x08 & ~x10 & x23));
  assign z14 = z06 | new_n76_ | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (new_n67_ & x22 & ~new_n74_ & x23)) & (~new_n75_ | ~x22 | ~x23 | x24);
  assign new_n74_ = x16 & x25 & x26;
  assign new_n75_ = x19 & x20 & x21;
  assign new_n76_ = ~x21 & (~x09 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x25 | (new_n75_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n63_ | ~x24 | x25);
  assign z16 = (~x21 & (~x09 | (new_n85_ & ~x08))) | (x07 & x08) | (~x08 & new_n80_ & x09);
