...
module FAU ( 
  ...
  assign new_n70_ = ~new_n72_ & (~x23 | ((new_n71_ | ~x19) & (~x09 | (x19 & x21))));
  assign new_n71_ = x20 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n72_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = (x05 & x08 & (x09 | ~x19)) | (~x09 & x19) | (~x08 & ~new_n74_ & ~x10);
  assign new_n74_ = ~new_n76_ & (~x24 | ((new_n75_ | ~x19) & (~x09 | (x19 & x21))));
  assign new_n75_ = x20 & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (x09 | ~x19)) | (~x08 & new_n78_ & x09);
  ...
  assign z16 = z08 | (~x08 & ~x10 & (new_n83_ | new_n85_));
  assign new_n83_ = x26 & (new_n84_ | (x19 & (x18 | ~x20 | ~x25)));
  assign new_n84_ = x09 & (~x19 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n85_ = new_n86_ & x21 & x22 & x19 & x20;
