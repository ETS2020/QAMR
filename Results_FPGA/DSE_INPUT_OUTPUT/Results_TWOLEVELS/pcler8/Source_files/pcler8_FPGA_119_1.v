...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x09 & x19) | (~x08 & ~x10 & (new_n58_ | (x09 & ~x19)));
  assign new_n58_ = new_n48_ & x20 & x21 & x11 & x19;
  assign z10 = (x01 & x08 & (x09 | ~x19)) | (~x09 & x19) | (new_n60_ & ~x08);
  ...
  assign new_n64_ = (~x21 | (x19 & x20 & (~new_n66_ | ~new_n65_ | ~x13))) & (~x19 | ~x20 | x21);
  assign new_n65_ = x22 & x23;
  assign new_n66_ = x24 & x25 & x26;
  assign z12 = (~x08 & x09 & ~new_n68_ & ~x10) | (x03 & x08 & (x09 | ~x19));
  assign new_n68_ = (~x22 | (new_n69_ & x21 & (~new_n66_ | ~x14 | ~x23))) & (~new_n69_ | ~x21 | x22);
  assign new_n69_ = x19 & x20;
  assign z13 = (~x08 & x09 & ~new_n71_ & ~x10) | (x04 & x08 & (x09 | ~x19));
  ...
  assign z15 = (~x08 & x09 & ~new_n78_ & ~x10) | (x06 & x08 & (x09 | ~x19));
  assign new_n78_ = (~x25 | (new_n75_ & new_n65_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n65_ | ~x24 | x25);
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & ((x26 & (~new_n81_ | ~new_n82_)) | (new_n83_ & new_n84_));
