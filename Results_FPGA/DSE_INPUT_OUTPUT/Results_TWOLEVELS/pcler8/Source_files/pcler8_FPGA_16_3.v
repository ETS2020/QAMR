...
module FAU ( 
  ...
  assign new_n75_ = (x04 | ((~x19 | (~new_n76_ & ~new_n77_)) & (new_n78_ | ~x24))) & (x19 | ~x24);
  assign new_n76_ = x20 & x21 & x22 & x23 & ~x24;
  assign new_n77_ = x16 & x24 & x25 & x26;
  assign new_n78_ = x20 & x21 & x22 & x23;
  assign z15 = (x06 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n80_ & ~x10);
  ...
  assign new_n84_ = ~x04 & (~new_n85_ | x08 | ~x09 | ~new_n60_ | x10);
