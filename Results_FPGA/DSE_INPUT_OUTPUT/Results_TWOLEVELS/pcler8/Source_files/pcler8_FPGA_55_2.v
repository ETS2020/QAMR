...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n59_, new_n60_, new_n61_, new_n63_,
    ...
    new_n91_;
  assign z00 = (x05 & ~x19) | (new_n48_ & new_n47_ & ~x10 & x19 & x20);
  ...
  assign z07 = (x05 & ~x19) | (x06 & x08 & (~x05 | x19));
  ...
  assign z14 = (~x08 & x09 & ~new_n76_ & ~x10) | (x05 & x08 & x19);
  assign new_n76_ = (~x19 | ((~x24 | (new_n60_ & new_n77_)) & (~new_n60_ | ~new_n78_))) & (x05 | x19 | ~x24);
  ...
  assign new_n81_ = (~x06 | ~x08) & (x10 | x19 | ~x25 | x08 | ~x09);
  ...
  assign new_n87_ = (~x07 | ~x08) & (x10 | x19 | ~x26 | x08 | ~x09);
