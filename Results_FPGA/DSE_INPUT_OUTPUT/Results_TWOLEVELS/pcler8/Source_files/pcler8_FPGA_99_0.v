...
module FAU ( 
  ...
  assign z04 = (~x09 & ~x20) | (x03 & x08 & (x09 | x20));
  assign z05 = x04 & x08 & (x09 | x20);
  assign z06 = x05 & x08 & (x09 | x20);
  assign z07 = x06 & x08 & (x09 | x20);
  assign z08 = (~x09 & ~x20) | (x07 & x08 & (x09 | x20));
  assign z09 = (x00 & x08 & (x09 | x20)) | (~x09 & ~x20) | (~x08 & ~new_n57_ & ~x10);
  assign new_n57_ = (~x09 | ~x20 | (x19 & (~new_n58_ | ~new_n59_))) & (x19 | x20);
  assign new_n58_ = x11 & x21 & x22;
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & x09 & ~new_n61_ & ~x10);
  assign new_n61_ = x20 ? (x19 & (~new_n59_ | ~x12 | ~x21 | ~x22)) : ~x19;
  assign z11 = new_n65_ | (x02 & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x21 | (~new_n64_ & x19)) & (~x19 | ~x20 | x21);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = ~x20 & (~x09 | (~x08 & ~x10 & x21));
  assign z12 = (x03 & x08 & (x09 | x20)) | (~x08 & x09 & ~new_n67_ & ~x10);
  ...
  assign new_n70_ = (~x23 | (x19 & x21 & ~new_n71_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = ~x20 & (~x09 | (~x08 & ~x10 & x23));
  assign z14 = (x05 & x08 & (x09 | x20)) | (~x20 & (~x09 | (new_n77_ & ~x08))) | (~x08 & new_n74_ & x09);
  assign new_n74_ = ~x10 & (new_n76_ | (x24 & (~new_n75_ | ~x19 | ~x21)));
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign new_n77_ = ~x10 & x24;
  assign z15 = (x06 & x08 & (x09 | x20)) | (~x20 & (~x09 | (new_n84_ & ~x08))) | (~x08 & new_n79_ & x09);
  ...
  assign new_n84_ = ~x10 & x25;
  assign z16 = (x07 & x08 & (x09 | x20)) | (~x08 & new_n86_ & x09);
  assign new_n86_ = ~x10 & ((new_n89_ & new_n90_) | (x26 & (~new_n87_ | ~new_n88_)));
