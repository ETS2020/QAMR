// Benchmark "FAU" written by ABC on Mon Aug 24 16:59:10 2020
...
module FAU ( 
  ...
  assign new_n47_ = new_n48_ & x22 & x23 & x24 & x25 & x26;
  ...
  assign new_n64_ = ~x10 & ((x06 & ((x21 & (new_n65_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n65_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x03 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x06 | ((~x22 | (x20 & ~new_n68_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x06 | (~new_n73_ & (~x23 | (new_n71_ & new_n72_)))) & (x19 | ~x23);
  assign new_n71_ = x20 & x21;
  assign new_n72_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n73_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (x19 | ~x24) & (~x06 | ((~x24 | (new_n71_ & new_n76_)) & (~new_n77_ | ~new_n71_ | ~x19)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = z07 | (x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x19 | (~new_n80_ & ~new_n81_)) & (x08 | new_n82_ | ~x25);
  ...
  assign new_n84_ = x06 & (~new_n48_ | ~new_n85_);
  assign new_n85_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | ~new_n71_ | x18 | ~x19);
