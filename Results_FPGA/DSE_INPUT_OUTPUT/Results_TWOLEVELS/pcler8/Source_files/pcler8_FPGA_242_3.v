...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n60_ | ~x11 | ~x19 | ~x20 | ~x21);
  ...
  assign new_n65_ = (~x19 | ((~new_n63_ | ~x13 | ~x21 | ~x22) & (~x20 | x21))) & (~x21 | (x19 & x20));
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (x18 | ((~x19 | (~new_n68_ & (~x20 | ~x21 | x22))) & (~x22 | (x20 & x21)))) & (x19 | ~x22);
  assign new_n68_ = x24 & x25 & x26 & x14 & x22 & x23;
  ...
  assign new_n73_ = (new_n76_ | ~x24) & (~x19 | (~new_n75_ & (~new_n74_ | ~x16 | ~x24)));
  ...
  assign new_n78_ = (x18 | ((new_n81_ | ~x25) & (~x19 | (~new_n79_ & ~new_n80_)))) & (x19 | ~x25);
  assign new_n79_ = x23 & x24 & ~x25 & x20 & x21 & x22;
  assign new_n80_ = x17 & x25 & x26;
  assign new_n81_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = (x07 & x08 & (~x18 | ~x19)) | (x19 & (new_n83_ | x18)) | (new_n85_ & ~x08);
  assign new_n83_ = new_n84_ & ~x08 & x09 & ~x10 & x20 & x21;
  assign new_n84_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n85_ = x09 & ~x10 & (~new_n86_ | ~new_n87_) & x26;
