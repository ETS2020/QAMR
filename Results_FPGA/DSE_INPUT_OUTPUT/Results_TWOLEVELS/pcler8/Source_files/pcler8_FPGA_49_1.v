...
module FAU ( 
  ...
  assign z10 = (x01 & ~new_n49_ & x08) | new_n49_ | (~x08 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x19 | (x20 & (~new_n59_ | ~new_n62_))) & (~x09 | x19 | ~x20);
  ...
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & ~new_n70_ & ~x10);
  ...
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (~x08 & ~x10 & (new_n79_ | new_n81_));
  assign new_n79_ = x19 & (new_n80_ | (x09 & x17 & x25 & x26));
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x09 & x25 & (~new_n76_ | ~x22 | ~x23 | ~x24);
