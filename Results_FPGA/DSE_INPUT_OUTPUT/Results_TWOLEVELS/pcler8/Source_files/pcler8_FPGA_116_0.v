...
module FAU ( 
  ...
  assign new_n63_ = x20 ? (~x22 | (x19 & (~new_n48_ | ~new_n64_ | ~x12))) : ~x19;
  assign new_n64_ = x21 & x23;
  assign z11 = (new_n50_ & x02) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (~x20 ^ ~x21)) | (x21 & x22 & (new_n67_ | ~x19)));
  assign new_n67_ = x13 & x23 & x24 & x25 & x26;
  assign z12 = z04 | new_n70_ | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (x20 & x21 & (~new_n48_ | ~x14 | ~x23))) & (~x20 | ~x21 | x22);
  assign new_n70_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x22));
  ...
  assign z15 = (new_n50_ & x06) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (new_n80_ | ~x19) & (~x22 | ~x25 | (new_n81_ & new_n60_ & x19));
  assign new_n80_ = (x22 | ~x25) & (~x20 | ~x21 | ~x22 | ~x23 | ~x24 | x25);
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n83_ | new_n85_));
  assign new_n83_ = x19 & ((~x22 & x26) | (new_n84_ & x20 & x21 & x22));
  assign new_n84_ = x23 & x24 & x25 & ~x26;
  assign new_n85_ = x22 & x26 & (~new_n86_ | x18 | ~x19 | ~x20);
