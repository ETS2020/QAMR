...
module FAU ( 
  ...
  assign z10 = z02 | (x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (~x19 | (x20 & (~new_n60_ | ~new_n63_))) & (x08 | x19 | ~x20);
  ...
  assign z12 = z04 | (x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x19 | (~new_n70_ & (~x20 | ~x21 | x22))) & (x08 | ~x22 | (x19 & x20 & x21));
  assign new_n70_ = x14 & x22 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (x09 & ~x10 & (new_n72_ | new_n73_));
  assign new_n72_ = x19 & ((new_n49_ & x22 & ~x23) | (new_n48_ & x15 & x23));
  ...
  assign z15 = (~x19 & ((x06 & x08) | (new_n85_ & ~x08 & x09))) | (~x08 & new_n80_ & x09);
  ...
  assign z16 = (x09 & ~new_n87_ & ~x10) | (x08 & (x19 | (x07 & ~x19)));
  assign new_n87_ = (~new_n74_ | ~new_n90_) & (x08 | ~x26 | (new_n88_ & new_n89_));
