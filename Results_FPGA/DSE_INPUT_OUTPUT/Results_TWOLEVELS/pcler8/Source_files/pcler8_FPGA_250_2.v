...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (~x10 | x20)) | (x10 & ~x20) | (~x08 & ~new_n58_ & x09);
  ...
  assign new_n62_ = (~x19 | x20) & (x10 | ~x20 | (x19 & (~new_n60_ | ~new_n59_ | ~x12)));
  ...
  assign new_n73_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | new_n79_ | (~x08 & x09 & ~new_n75_ & ~x10);
  ...
  assign new_n79_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | new_n85_ | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((new_n78_ & new_n84_) | (x25 & (~new_n82_ | ~new_n83_)));
  assign new_n82_ = x19 & x21 & x22;
  assign new_n83_ = x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x22 & x23 & x24 & ~x25;
  assign new_n85_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n92_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x26));
endmodule
