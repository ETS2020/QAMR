...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (x09 | ~x21)) | (~x09 & x21) | (~x08 & ~new_n61_ & ~x10);
  assign new_n61_ = (~x09 | (~x19 ^ x20)) & (~new_n59_ | ~new_n58_ | ~x12 | ~x20);
  ...
  assign new_n66_ = (~x21 | ((~x22 | (x19 & ~new_n67_ & x20)) & (~x19 | ~x20 | x22))) & (~x09 | x21 | ~x22);
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08 & (x09 | ~x21)) | (~x09 & x21) | (~x08 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x23 | ((new_n70_ | ~x21) & (~x09 | (x21 & x22)))) & (~new_n71_ | ~x21 | ~x22 | x23);
  assign new_n70_ = x19 & x20 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n71_ = x19 & x20;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x21 | (~new_n74_ & (~new_n71_ | ~x22 | ~x23 | x24))) & (~x24 | (new_n71_ & x21 & x22 & x23));
  assign new_n74_ = x16 & x24 & x25 & x26;
  assign z15 = (x06 & x08 & (x09 | ~x21)) | (~x09 & x21) | (new_n76_ & ~x08);
  assign new_n76_ = ~x10 & ((new_n79_ & new_n80_) | (x25 & (new_n77_ | new_n78_)));
  assign new_n77_ = x21 & (~x19 | ~x20 | (x17 & x26));
  assign new_n78_ = x09 & (~x21 | ~x22 | ~x23 | ~x24);
