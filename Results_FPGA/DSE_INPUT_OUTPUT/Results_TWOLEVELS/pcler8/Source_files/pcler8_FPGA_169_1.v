...
module FAU ( 
  ...
  assign new_n67_ = (~x22 | ((~x09 | (x19 & x21)) & (~x19 | (~new_n68_ & x20)))) & (~x19 | ~x20 | ~x21 | x22);
  ...
  assign z15 = (x06 & x08 & (x09 | ~x19)) | (new_n77_ & ~x08) | (~x09 & x19);
  assign new_n77_ = ~x10 & ((x25 & (new_n78_ | new_n79_)) | (new_n74_ & new_n80_));
  assign new_n78_ = x19 & (~x20 | ~x24 | (x17 & x26));
  assign new_n79_ = x09 & (~x22 | ~x23 | ~x19 | ~x21);
  assign new_n80_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((x26 & (~new_n83_ | ~new_n84_)) | (new_n85_ & new_n86_));
