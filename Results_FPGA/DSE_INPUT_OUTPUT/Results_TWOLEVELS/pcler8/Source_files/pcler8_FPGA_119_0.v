...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (x09 | x19)) | (~x09 & ~x19) | (new_n61_ & ~x08);
  ...
  assign z12 = (~x08 & x09 & ~new_n67_ & ~x10) | (x03 & x08 & (x09 | x19));
  assign new_n67_ = (~x22 | (new_n68_ & x21 & (~new_n49_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  assign new_n68_ = x19 & x20;
  assign z13 = (~x08 & x09 & ~new_n70_ & ~x10) | (x04 & x08 & (x09 | x19));
  ...
  assign z15 = (~x08 & x09 & ~new_n77_ & ~x10) | (x06 & x08 & (x09 | x19));
  assign new_n77_ = (~x25 | (new_n74_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n48_ | ~x24 | x25);
  assign z16 = (x07 & x08 & (x09 | x19)) | (~x08 & new_n79_ & x09);
