...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x21 & (~x20 | ((new_n66_ | ~x19) & x24))) | (x19 & x20 & ~x21 & x24));
  assign new_n66_ = x13 & x22 & x23 & x25 & x26;
  assign z12 = (x20 & (new_n68_ | ~x24)) | (x03 & x08) | (new_n70_ & ~x08);
  assign new_n68_ = new_n69_ & x19 & x21 & ~x22;
  assign new_n69_ = ~x08 & x09 & ~x10;
  assign new_n70_ = x09 & ~x10 & x22 & (~new_n71_ | ~x19 | ~x20);
  assign new_n71_ = x21 & (~x25 | ~x26 | ~x14 | ~x23);
  assign z13 = (x04 & x08) | (new_n74_ & ~x08) | (~new_n73_ & x20);
  assign new_n73_ = x24 & (~new_n69_ | ~x19 | ~x21 | ~x22 | x23);
  assign new_n74_ = x09 & ~x10 & x23 & (~new_n75_ | ~x19 | ~x20);
  assign new_n75_ = x21 & x22 & (~x15 | ~x25 | ~x26);
  assign z14 = (x05 & ~new_n51_ & x08) | new_n51_ | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = x20 ? ((new_n78_ | ~x19) & ~new_n79_ & (x19 | ~x24)) : ~x24;
  assign new_n78_ = x21 ? (x22 & (~x22 | x23)) : ~x24;
  assign new_n79_ = x16 & x25 & x26;
  assign z15 = (x06 & ~new_n51_ & x08) | (~x08 & new_n81_ & x09);
  assign new_n81_ = ~x10 & ((x24 & (new_n83_ | (~new_n82_ & x25))) | (~x20 & x25));
  assign new_n82_ = x19 & x21 & x22 & x23 & (~x17 | ~x26);
  assign new_n83_ = x19 & x20 & x21 & x22 & x23 & ~x25;
  assign z16 = (x07 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n85_ & ~x10);
  assign new_n85_ = (x20 | ~x26) & (~x24 | ((~new_n86_ | ~new_n88_) & (new_n87_ | ~x26)));
  assign new_n86_ = x19 & x20 & x21;
  assign new_n87_ = ~x18 & x19 & x21 & x22 & x23 & x25;
  assign new_n88_ = x22 & x23 & x25 & ~x26;
endmodule
