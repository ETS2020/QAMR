...
module FAU ( 
  ...
  assign z09 = z01 | (~x08 & ~x10 & (new_n59_ | ~x19));
  assign new_n59_ = new_n48_ & new_n49_ & new_n60_ & x09 & x11;
  ...
  assign z11 = new_n66_ | (x02 & x08) | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x21 | (x20 & (~new_n49_ | ~new_n48_ | ~x13))) & (~x19 | ~x20 | x21);
  assign new_n66_ = ~x19 & (~x09 | (~x08 & ~x10 & x21));
  assign z12 = (x03 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n70_ & ~x08))) | (~x08 & new_n68_ & x09);
  ...
  assign new_n72_ = (~x23 | (~new_n73_ & x22 & x20 & x21)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign new_n74_ = ~x19 & (~x09 | (~x08 & ~x10 & x23));
  assign z14 = new_n78_ | (x05 & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~x24 | (new_n60_ & x22 & ~new_n77_ & x23)) & (~new_n60_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n77_ = x16 & x25 & x26;
  assign new_n78_ = ~x19 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (~x08 & x09 & ~new_n80_ & ~x10) | (x06 & x08 & (x09 | x19));
  assign new_n80_ = (~x25 | (new_n81_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n81_ | ~new_n48_ | ~x24 | x25);
