...
module FAU ( 
  ...
  assign z06 = (~x10 & ~x20) | (x05 & x08 & (x10 | x20));
  assign z07 = x06 & x08 & (x10 | x20);
  assign z08 = (x07 & x08) | (~x10 & ~x20);
  assign z09 = (x00 & x08 & (x10 | x20)) | (~x10 & (~x20 | (new_n57_ & ~x08)));
  assign new_n57_ = x09 & (~x19 | (new_n58_ & x11 & x21 & x22));
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08 & (x10 | x20)) | (~x10 & (~x20 | (new_n60_ & ~x08)));
  assign new_n60_ = x09 & (~x19 | (new_n58_ & x12 & x21 & x22));
  ...
  assign z12 = (x03 & x08 & (x10 | x20)) | (~x10 & (~x20 | (~x08 & ~new_n65_ & x09)));
  ...
  assign z16 = (x07 & x08) | (~x10 & (~x20 | (~x08 & ~new_n76_ & x09)));
  assign new_n76_ = (~x26 | (new_n78_ & (new_n77_ | ~x20))) & (~new_n74_ | ~new_n77_ | ~x25 | x26);
  assign new_n77_ = x23 & x24;
  assign new_n78_ = ~x18 & x19 & x21 & x22 & x25;
endmodule
