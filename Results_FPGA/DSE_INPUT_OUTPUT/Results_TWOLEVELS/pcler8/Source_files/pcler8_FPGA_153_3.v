...
module FAU ( 
  ...
  assign new_n74_ = (x16 | ((~x19 | (~new_n75_ & ~new_n76_)) & (new_n77_ | ~x23))) & (x19 | ~x23);
  assign new_n75_ = x20 & x21 & x22 & ~x23;
  assign new_n76_ = x15 & x23 & x24 & x25 & x26;
  assign new_n77_ = x20 & x21 & x22;
  assign z14 = (x05 & x08 & (~x16 | ~x19)) | (x19 & (new_n79_ | x16)) | (new_n81_ & ~x08);
  assign new_n79_ = new_n80_ & new_n48_ & ~x10 & x20;
  assign new_n80_ = x21 & x22 & x23 & ~x24;
  assign new_n81_ = x09 & new_n82_ & ~x10;
  assign new_n82_ = x24 & (~x19 | ~x20 | ~x21 | ~x22 | ~x23);
  assign z15 = (x06 & ~new_n50_ & x08) | new_n50_ | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((x19 & (new_n85_ | new_n86_)) | (~new_n87_ & x25));
  assign new_n85_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n86_ = ~x16 & x17 & x25 & x26;
  assign new_n87_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | new_n89_ | (~x08 & new_n91_ & x09);
  assign new_n89_ = x19 & (x16 | (new_n90_ & new_n48_ & new_n60_ & ~x10));
