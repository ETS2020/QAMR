...
module FAU ( 
  ...
  assign new_n62_ = (~x19 | x20) & (~new_n60_ | ~x21 | ~x22 | ~x12 | ~x20);
  assign new_n63_ = ~x19 & (~x11 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((x19 & (x21 ? (new_n66_ | ~x20) : x20)) | (x11 & ~x19 & x21));
  ...
  assign new_n70_ = ~x19 & (~x11 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (new_n49_ & x04) | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (~x11 | x19 | ~x23) & (~x19 | ((~x23 | (new_n73_ & ~new_n74_ & x22)) & (~new_n73_ | ~x22 | x23)));
  ...
  assign new_n80_ = (~x19 | ((~x25 | (new_n59_ & new_n81_)) & (~new_n59_ | ~new_n82_))) & (~x11 | x19 | ~x25);
