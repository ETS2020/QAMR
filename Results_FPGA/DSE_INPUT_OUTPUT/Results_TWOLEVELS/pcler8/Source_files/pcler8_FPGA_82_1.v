...
module FAU ( 
  ...
  assign z00 = x19 & (~x05 | (new_n47_ & new_n48_));
  assign new_n47_ = ~x08 & x09 & ~x10 & x20 & x21;
  assign new_n48_ = x22 & x23 & x24 & x25 & x26;
  assign z01 = new_n50_ & x00;
  assign new_n50_ = x08 & (x05 | ~x19);
  assign z02 = (~x05 & x19) | (x01 & x08 & (x05 | ~x19));
  assign z03 = new_n50_ & x02;
  assign z04 = (~x05 & x19) | (x03 & x08 & (x05 | ~x19));
  assign z05 = (~x05 & x19) | (x04 & x08 & (x05 | ~x19));
  assign z06 = x05 & x08;
  assign z07 = new_n50_ & x06;
  assign z08 = (~x05 & x19) | (x07 & x08);
  assign z09 = z01 | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & (~x19 | (new_n48_ & new_n60_ & x05 & x11));
  assign new_n60_ = x20 & x21;
  assign z10 = (new_n50_ & x01) | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x05 & x19 & ((new_n63_ & new_n64_) | ~x20)) | (~x19 & x20));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & x08 & (x05 | ~x19)) | ((new_n68_ | ~x05) & x19) | (new_n66_ & ~x08);
  ...
  assign new_n70_ = (~x05 | ((~x22 | (x20 & ~new_n71_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (new_n50_ & x04) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (x19 | ~x23) & (~x05 | (~new_n75_ & ((new_n60_ & new_n74_) | ~x23)));
  ...
  assign z15 = (x06 & x08 & (x05 | ~x19)) | ((new_n81_ | ~x05) & x19) | (new_n83_ & ~x08);
  assign new_n81_ = new_n82_ & ~x10 & x20 & ~x08 & x09;
  assign new_n82_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n83_ = x09 & ~x10 & x25 & (~new_n84_ | ~new_n60_ | ~x19);
  assign new_n84_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n86_ | (x07 & x08) | (~x08 & new_n88_ & x09);
  assign new_n86_ = x19 & (~x05 | (new_n47_ & new_n87_ & x22 & x23));
