...
module FAU ( 
  ...
  assign z14 = z06 | new_n75_ | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x24 | (new_n72_ & x22 & ~new_n73_ & x23)) & (~new_n74_ | ~x22 | ~x23 | x24);
  assign new_n72_ = x19 & x21;
  assign new_n73_ = x16 & x25 & x26;
  assign new_n74_ = x19 & x20 & x21;
  assign new_n75_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n81_ | (x06 & x08) | (~x08 & new_n77_ & x09);
  ...
  assign new_n81_ = ~x20 & (x10 | (~x08 & x09 & ~x10 & x25));
