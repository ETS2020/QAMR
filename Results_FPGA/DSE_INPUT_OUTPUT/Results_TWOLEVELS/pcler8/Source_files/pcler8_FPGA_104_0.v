...
module FAU ( 
  ...
  assign z13 = (~x10 & (~x20 | (~x08 & ~new_n67_ & x09))) | (x04 & x08);
  ...
  assign z15 = (x06 & x08 & (x10 | x20)) | (~x10 & (~x20 | (new_n73_ & ~x08)));
  ...
  assign z16 = (~x10 & (~x20 | (~x08 & ~new_n77_ & x09))) | (x07 & x08);
  assign new_n77_ = (~x26 | (new_n79_ & new_n80_)) & (~new_n74_ | ~new_n78_ | ~x25 | x26);
  assign new_n78_ = x23 & x24;
  assign new_n79_ = x19 & x21 & (~x18 | ~x20);
