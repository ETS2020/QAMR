...
module FAU ( 
  ...
  assign z00 = x19 & (x14 | (new_n47_ & new_n48_ & new_n49_ & x24));
  ...
  assign new_n64_ = (x14 | ~x19 | (x20 & (~new_n62_ | ~new_n61_ | ~x12))) & (x19 | ~x20);
  assign z11 = (~new_n68_ & x19) | (x02 & x08) | (new_n66_ & ~x08);
  assign new_n66_ = x09 & ~x10 & x21 & (~x19 | new_n67_ | ~x20);
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign new_n68_ = ~x14 & (x08 | ~x09 | x10 | ~x20 | x21);
  assign z12 = z04 | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((~x14 & ((x22 & (~x20 | ~x21)) | (x19 & x20 & x21 & ~x22))) | (~x19 & x22));
  assign z13 = z05 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (x19 | ~x23) & (x14 | (~new_n75_ & (~x23 | (new_n73_ & new_n74_))));
  ...
  assign new_n77_ = x19 & (x14 | (new_n78_ & new_n61_ & x23 & ~x24));
  assign new_n78_ = ~x08 & x09 & ~x10 & x20;
  assign new_n79_ = x24 & (~new_n80_ | ~new_n73_ | ~x19);
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = (x19 & (new_n82_ | x14)) | (x06 & x08) | (new_n83_ & ~x08);
  assign new_n82_ = new_n78_ & new_n61_ & x23 & x24 & ~x25;
  ...
  assign new_n86_ = ~x14 & (~new_n47_ | ~new_n48_ | ~x24 | ~x25 | x26);
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | ~new_n73_ | x18 | ~x19);
