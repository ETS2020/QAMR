...
module FAU ( 
  ...
  assign z14 = (x05 & ~new_n51_ & x08) | new_n51_ | (~x08 & new_n76_ & x09);
  assign new_n76_ = ~x10 & ((x19 & new_n77_ & x20) | (x24 & (~new_n78_ | ~x19 | ~x20)));
  assign new_n77_ = x21 & x22 & x23 & (~x24 | (x24 & x25 & x26));
  assign new_n78_ = x21 & x22 & x23;
  assign z15 = (~new_n80_ & x19) | (x06 & x08) | (~x08 & new_n82_ & x09);
  assign new_n80_ = x16 & (~new_n81_ | x10 | ~x20 | x08 | ~x09);
  assign new_n81_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x10 & x25 & (~new_n83_ | ~new_n48_ | ~x19);
