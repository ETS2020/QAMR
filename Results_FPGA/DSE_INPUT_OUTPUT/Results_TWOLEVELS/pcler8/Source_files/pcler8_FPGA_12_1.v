...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x14 & ((x21 & (new_n66_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x03 & ~new_n50_ & x08) | new_n50_ | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x19 & x20 & x21 & (new_n48_ | ~x22)) | ((~x19 | ~x20 | ~x21) & x22));
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x14 | (~new_n73_ & ((new_n71_ & new_n72_) | ~x23))) & (x19 | ~x23);
  ...
  assign new_n75_ = (x19 | ~x24) & (~x14 | (((new_n71_ & new_n76_) | ~x24) & (~new_n77_ | ~new_n71_ | ~x19)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n79_ | new_n84_));
  assign new_n79_ = x14 & ((new_n80_ & new_n83_) | ((~new_n81_ | ~new_n82_) & x25));
  ...
  assign new_n86_ = x14 & (~new_n47_ | ~new_n87_);
  assign new_n87_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n88_ = ~x10 & x26 & (~new_n89_ | ~new_n71_ | x18 | ~x19);
