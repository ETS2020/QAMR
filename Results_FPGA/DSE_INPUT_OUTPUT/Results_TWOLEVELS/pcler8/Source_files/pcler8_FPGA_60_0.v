...
module FAU ( 
  ...
  assign z11 = (x02 & x08 & (x09 | x19)) | (~x19 & (~x09 | (new_n65_ & ~x08))) | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x21 & (new_n64_ | ~x20)) | (x19 & x20 & ~x21));
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = ~x10 & x21;
  assign z12 = (x03 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (~new_n68_ & x21 & x19 & x20)) & (~x21 | x22 | ~x19 | ~x20);
  ...
  assign z16 = (x07 & x08 & (x09 | x19)) | (~x08 & new_n80_ & x09);
