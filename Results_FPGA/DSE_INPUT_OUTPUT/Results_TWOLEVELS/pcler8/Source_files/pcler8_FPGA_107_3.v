...
module FAU ( 
  ...
  assign new_n60_ = x19 & (~new_n61_ | x06 | ~x11 | ~x20 | ~x21);
  ...
  assign new_n68_ = (x06 | ((~x19 | (~new_n69_ & (~x20 | ~x21 | x22))) & (~x22 | (x20 & x21)))) & (x19 | ~x22);
  assign new_n69_ = x24 & x25 & x26 & x14 & x22 & x23;
  assign z13 = z05 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x06 | ((new_n74_ | ~x23) & (~x19 | (~new_n72_ & ~new_n73_)))) & (x19 | ~x23);
  ...
  assign z15 = (x06 & (x19 | (x08 & ~x19))) | (~x08 & x09 & ~new_n81_ & ~x10);
