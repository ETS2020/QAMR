...
module FAU ( 
  ...
  assign new_n66_ = (x16 | ((~x19 | ((~new_n64_ | ~new_n67_) & (~x20 | x21))) & (x20 | ~x21))) & (x19 | ~x21);
  ...
  assign new_n72_ = (~x19 | (~new_n73_ & (~x20 | ~x21 | ~x22 | x23))) & (~x23 | (x21 & x22 & x19 & x20));
  assign new_n73_ = x15 & x23 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (x16 | ((~x24 | (new_n60_ & x22 & x23)) & (~x22 | ~x23 | x24 | ~new_n60_ | ~x19))) & (x19 | ~x24);
  assign z15 = (x06 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x19 | ~x25) & (x16 | ((new_n80_ | ~x25) & (~x19 | (~new_n78_ & ~new_n79_))));
  ...
  assign new_n82_ = ~x16 & (~new_n83_ | x08 | ~x09 | ~new_n60_ | x10);
