...
module FAU ( 
  ...
  assign new_n64_ = ~x19 & (x18 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & ~new_n47_ & x08) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (x21 ? (new_n67_ | ~x20) : x20)) | (~x18 & ~x19 & x21));
  ...
  assign new_n71_ = ~x19 & (x18 | (~x08 & x09 & ~x10 & x22));
  ...
  assign new_n75_ = ~x19 & (x18 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x19 | ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_))) & (x18 | x19 | ~x24);
  ...
  assign new_n82_ = ~x10 & ((new_n85_ & new_n86_) | (x25 & (~new_n83_ | ~new_n84_)));
  ...
  assign z16 = new_n58_ | (~x08 & x09 & ~x10 & (new_n89_ | new_n93_));
  assign new_n89_ = x19 & ((new_n83_ & new_n92_) | ((~new_n90_ | ~new_n91_) & x26));
  assign new_n90_ = ~x18 & x20 & x21;
  assign new_n91_ = x24 & x25 & x22 & x23;
  assign new_n92_ = x23 & x24 & x25 & ~x26;
  assign new_n93_ = ~x18 & ~x19 & x26;
endmodule
