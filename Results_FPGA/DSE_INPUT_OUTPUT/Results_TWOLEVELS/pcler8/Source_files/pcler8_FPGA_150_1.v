...
module FAU ( 
  ...
  assign z09 = (x00 & ~new_n51_ & x08) | new_n51_ | (~x08 & new_n60_ & x09);
  assign new_n60_ = ~x10 & (~x19 | (new_n61_ & x19 & x20 & x21 & x22));
  ...
  assign new_n65_ = ~x10 & ((x11 & x21 & (~x19 | new_n66_ | ~x20)) | (x19 & x20 & ~x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x11 | ((~x22 | (x19 & ~new_n69_ & x20)) & (~x19 | ~x20 | ~x21 | x22))) & (x21 | ~x22);
  assign new_n69_ = x24 & x25 & x26 & x14 & x23;
  assign z13 = (x21 & (new_n71_ | ~x11)) | (x04 & x08) | (new_n73_ & ~x08);
  assign new_n71_ = ~x08 & x09 & ~x10 & new_n72_ & x22 & ~x23;
  assign new_n72_ = x19 & x20;
  assign new_n73_ = x09 & ~x10 & x23 & (~new_n72_ | ~new_n74_);
  assign new_n74_ = x21 & x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign z14 = (x05 & ~new_n51_ & x08) | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (x21 | ~x24) & (~x11 | (~new_n78_ & ((new_n72_ & new_n77_) | ~x24)));
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n78_ = x22 & x23 & ~x24 & x19 & x20 & x21;
  assign z15 = (~new_n80_ & x21) | (x06 & x08) | (~x08 & new_n82_ & x09);
  assign new_n80_ = x11 & (~new_n81_ | x08 | ~x09 | x10 | ~x19);
  assign new_n81_ = x20 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x10 & x25 & (~new_n83_ | ~x19 | ~x20 | ~x21);
  assign new_n83_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~new_n85_ & x21) | (~x08 & new_n86_ & x09);
  assign new_n85_ = x11 & (~new_n48_ | ~new_n49_ | ~x24 | ~x25 | x26);
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | ~new_n49_ | ~x24 | ~x25);
