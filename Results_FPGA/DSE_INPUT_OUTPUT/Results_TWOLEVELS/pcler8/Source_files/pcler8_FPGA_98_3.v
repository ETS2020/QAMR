...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n57_, new_n59_, new_n60_, new_n62_, new_n63_, new_n65_;
  assign z00 = x19 & x23;
  ...
  assign z10 = (x01 & ~z00 & x08) | z00 | (new_n57_ & ~x08);
  assign new_n57_ = x09 & ~x10 & (x19 ^ x20);
  assign z11 = (x02 & x08 & (~x19 | ~x23)) | (new_n60_ & ~x08) | (x19 & (new_n59_ | x23));
  assign new_n59_ = ~x08 & x09 & ~x10 & x20 & ~x21;
  assign new_n60_ = x09 & ~x10 & x21 & (~x19 | ~x20);
  assign z12 = (x03 & x08 & (~x19 | ~x23)) | (new_n63_ & ~x08) | (x19 & (new_n62_ | x23));
  assign new_n62_ = ~x08 & x09 & ~x10 & x20 & x21 & ~x22;
  assign new_n63_ = x09 & ~x10 & x22 & (~x19 | ~x20 | ~x21);
  assign z13 = z00 | (x04 & x08) | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x23 | (x19 & x20 & x21 & x22));
  assign z14 = (x05 & ~z00 & x08) | z00 | (~x08 & x09 & ~x10 & x24);
