...
module FAU ( 
  ...
  assign new_n64_ = ~x10 & ((x19 & (x21 ? (new_n65_ | ~x20) : x20)) | (x12 & ~x19 & x21));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x19 | ((~x22 | (x20 & ~new_n68_ & x21)) & (~x20 | ~x21 | x22))) & (~x12 | x19 | ~x22);
  ...
  assign new_n72_ = ~x19 & (~x12 | (~x08 & x09 & ~x10 & x23));
  ...
  assign new_n77_ = ~x19 & (~x12 | (~x08 & x09 & ~x10 & x24));
