...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n57_, new_n60_, new_n61_, new_n63_,
    ...
    new_n91_, new_n92_;
  assign z00 = x19 & (~x01 | (new_n47_ & new_n48_));
  ...
  assign new_n60_ = x19 & (~new_n48_ | ~new_n61_ | ~x01 | ~x11);
  assign new_n61_ = x20 & x21;
  assign z10 = (x01 & x08) | (x09 & ~x10 & ((~new_n63_ & x01) | (new_n65_ & ~x08)));
  ...
  assign new_n67_ = ~x10 & ((x01 & ((x21 & (new_n68_ | ~x20)) | (x19 & x20 & ~x21))) | (~x19 & x21));
  assign new_n68_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x03 & x08 & (x01 | ~x19)) | (x19 & (new_n72_ | ~x01)) | (new_n70_ & ~x08);
  ...
  assign new_n89_ = x01 & (~new_n47_ | ~new_n90_);
