...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x09 & x19) | (~x08 & ~x10 & (new_n59_ | (x09 & ~x19)));
  ...
  assign z12 = (~x08 & x09 & ~new_n66_ & ~x10) | (x03 & x08 & (x09 | ~x19));
  ...
  assign z16 = (x07 & x08 & (x09 | ~x19)) | (x19 & (new_n78_ | ~x09)) | (~x08 & new_n79_ & x09);
