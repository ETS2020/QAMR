...
module FAU ( 
  ...
  assign new_n59_ = new_n48_ & x20 & x21 & x11 & x19;
  ...
  assign new_n64_ = x21 & (new_n65_ | (new_n62_ & x13 & x19 & x22));
  assign new_n65_ = x09 & (~x19 | ~x20);
  assign new_n66_ = x19 & x20 & ~x21;
  assign z12 = z04 | (~x08 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x19 | (~new_n69_ & (~x20 | ~x21 | x22))) & (~x09 | ~x22 | (x19 & x20 & x21));
