...
module FAU ( 
  ...
  assign new_n59_ = x21 & (~x19 | (new_n60_ & x11 & x20 & x22));
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = new_n63_ | (x01 & x08) | (~x08 & x09 & ~new_n62_ & ~x10);
  assign new_n62_ = (x20 | (x21 & (~x19 | ~x21))) & (~new_n60_ | ~x12 | ~x20 | ~x21 | ~x22);
  assign new_n63_ = ~x19 & (~x21 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x19 | (~x20 ^ x21)) & (~x21 | (~new_n66_ & x19));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x19 & ((~x21 & x22) | (x20 & x21 & ~x22))) | (x21 & x22 & (~x19 | new_n69_ | ~x20)));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x19 | ((x21 | ~x23) & (~x20 | ~x21 | ~x22 | x23))) & (~x23 | (x19 & x20 & ~new_n72_ & x22));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | new_n49_ | (~x08 & new_n74_ & x09);
  assign new_n74_ = ~x10 & ((~new_n75_ & x19) | (x24 & (~new_n76_ | ~x19 | ~x20)));
  assign new_n75_ = (x21 | ~x24) & (~x20 | ~x21 | ~x22 | ~x23 | x24);
  ...
  assign z16 = new_n57_ | (~x08 & x09 & ~x10 & (new_n85_ | new_n87_));
  assign new_n85_ = x21 & ((~x19 & x26) | (new_n86_ & x19 & x20 & x22));
  assign new_n86_ = x23 & x24 & x25 & ~x26;
  assign new_n87_ = x19 & x26 & (~new_n88_ | x18 | ~x20 | ~x21);
