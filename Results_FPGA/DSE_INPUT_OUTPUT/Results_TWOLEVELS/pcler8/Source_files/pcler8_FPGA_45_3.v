...
module FAU ( 
  ...
  assign z12 = (x03 & x08 & (~x06 | ~x19)) | (new_n70_ & ~x08) | (x19 & (new_n72_ | x06));
  ...
  assign new_n74_ = (x19 | ~x23) & (x06 | (~new_n76_ & ((new_n48_ & new_n75_) | ~x23)));
  assign new_n75_ = x22 & (~x25 | ~x26 | ~x15 | ~x24);
  assign new_n76_ = x19 & x20 & x21 & x22 & ~x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (x19 | ~x24) & (x06 | (((new_n48_ & new_n79_) | ~x24) & (~new_n80_ | ~new_n48_ | ~x19)));
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((x25 & (~new_n84_ | ~new_n83_ | new_n85_ | ~x24)) | (new_n84_ & new_n83_ & x24 & ~x25));
  assign new_n83_ = x22 & x23;
  assign new_n84_ = x19 & x20 & x21;
  assign new_n85_ = x17 & x26;
  assign z16 = new_n59_ | (~x08 & x09 & (new_n87_ | new_n92_) & ~x10);
  assign new_n87_ = ~x06 & (((~new_n88_ | ~new_n89_) & x26) | (new_n90_ & new_n91_));
