...
module FAU ( 
  ...
  assign z11 = z03 | new_n67_ | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x21 | (x20 & (~new_n49_ | ~new_n48_ | ~x13))) & (~x19 | ~x20 | x21);
  assign new_n67_ = ~x19 & (~x09 | (~x08 & ~x10 & x21));
  assign z12 = (x03 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (new_n70_ & x21 & (~new_n49_ | ~x14 | ~x23))) & (~new_n70_ | ~x21 | x22);
  assign new_n70_ = x19 & x20;
  assign z13 = (x04 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n72_ & ~x10);
  ...
  assign new_n75_ = (~x24 | (new_n60_ & x22 & ~new_n76_ & x23)) & (~new_n60_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n76_ = x16 & x25 & x26;
  assign new_n77_ = ~x19 & (~x09 | (~x08 & ~x10 & x24));
  assign z15 = (x06 & x08 & (x09 | x19)) | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x25 | (new_n80_ & new_n48_ & x24 & (~x17 | ~x26))) & (~new_n80_ | ~new_n48_ | ~x24 | x25);
  assign new_n80_ = x19 & x20 & x21;
  assign z16 = (~x19 & (~x09 | (new_n87_ & ~x08))) | (x07 & x08) | (~x08 & new_n82_ & x09);
