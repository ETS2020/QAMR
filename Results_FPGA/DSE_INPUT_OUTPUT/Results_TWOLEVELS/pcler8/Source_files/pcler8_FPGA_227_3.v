...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n48_, new_n50_, new_n60_, new_n61_, new_n63_, new_n64_,
  ...
  assign z09 = (x11 & x19) | (x00 & x08) | (~x08 & x09 & ~x10 & ~x19);
  assign z10 = (x01 & ~new_n50_ & x08) | new_n50_ | (~x08 & x09 & ~new_n60_ & ~x10);
  assign new_n60_ = x19 ? (x20 & (~new_n61_ | ~x12 | ~x21 | ~x22)) : ~x20;
  assign new_n61_ = x23 & x24 & x25 & x26;
  assign z11 = (x02 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (x11 | ((~x19 | ((~new_n61_ | ~new_n64_) & (~x20 | x21))) & (x20 | ~x21))) & (x19 | ~x21);
  assign new_n64_ = x13 & x21 & x22;
  ...
  assign z13 = (x04 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (x19 | ~x23) & (x11 | ((~x19 | (~new_n70_ & ~new_n71_)) & (new_n72_ | ~x23)));
  assign new_n70_ = x20 & x21 & x22 & ~x23;
  assign new_n71_ = x15 & x23 & x24 & x25 & x26;
  assign new_n72_ = x20 & x21 & x22;
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (x19 | ~x24) & (x11 | ((~x19 | (~new_n75_ & ~new_n76_)) & (new_n77_ | ~x24)));
  ...
  assign new_n79_ = (x19 | ~x25) & (x11 | ((~x19 | (~new_n80_ & ~new_n81_)) & (new_n82_ | ~x25)));
  assign new_n80_ = x20 & x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x17 & x25 & x26;
  assign new_n82_ = x20 & x21 & x22 & x23 & x24;
  assign z16 = (~new_n84_ & x19) | (x07 & x08) | (~x08 & new_n87_ & x09);
  assign new_n84_ = ~x11 & (~new_n86_ | x08 | ~x09 | ~new_n85_ | x10);
  assign new_n85_ = x20 & x21;
  assign new_n86_ = x22 & x23 & x24 & x25 & ~x26;
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | ~new_n85_ | x18 | ~x19);
