...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n61_, new_n62_, new_n63_,
    ...
    new_n91_;
  assign z00 = x19 & (~x17 | (new_n49_ & new_n47_ & new_n48_ & ~x10));
  ...
  assign z03 = (x02 & x08) | (~x17 & x19);
  assign z04 = (x03 & x08) | (~x17 & x19);
  assign z05 = (x04 & x08) | (~x17 & x19);
  assign z06 = (x05 & x08) | (~x17 & x19);
  assign z07 = (x06 & x08) | (~x17 & x19);
  assign z08 = x07 & x08 & (x17 | ~x19);
  assign z09 = (x00 & x08 & (x17 | ~x19)) | (~x08 & new_n59_ & x09);
  assign new_n59_ = ~x10 & (~x19 | (new_n49_ & new_n48_ & x11 & x17));
  assign z10 = new_n61_ | (x01 & x08) | (~x08 & x09 & new_n62_ & ~x10);
  assign new_n61_ = x19 & (~x17 | (new_n47_ & ~x10 & ~x20));
  assign new_n62_ = x20 & (~x19 | (new_n63_ & x12 & x21 & x22));
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = new_n65_ | (x02 & x08) | (~x08 & x09 & new_n66_ & ~x10);
  assign new_n65_ = x19 & (~x17 | (new_n47_ & ~x10 & x20 & ~x21));
  assign new_n66_ = x21 & (~x19 | new_n67_ | ~x20);
  assign new_n67_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = (x19 & (new_n71_ | ~x17)) | (x03 & x08) | (new_n69_ & ~x08);
  ...
  assign z13 = (x19 & (new_n73_ | ~x17)) | (new_n74_ & ~x08) | (x04 & x08);
  assign new_n73_ = ~x08 & x09 & ~x10 & new_n48_ & x22 & ~x23;
  assign new_n74_ = x09 & ~x10 & x23 & (~new_n75_ | ~x19 | ~x20);
  assign new_n75_ = x21 & x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign z14 = (~new_n77_ & x19) | (new_n79_ & ~x08) | (x05 & x08);
  assign new_n77_ = x17 & (~new_n78_ | ~x21 | ~x22 | ~x23 | x24);
  assign new_n78_ = ~x08 & x09 & ~x10 & x20;
  assign new_n79_ = x09 & ~x10 & x24 & (~new_n80_ | ~new_n48_ | ~x19);
  assign new_n80_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n82_ & x09);
  assign new_n82_ = ~x10 & ((x19 & new_n83_ & x20) | (~new_n84_ & x25));
  assign new_n83_ = x21 & x22 & x23 & x24 & (~x25 | (x25 & x26));
  assign new_n84_ = x22 & x23 & x24 & x19 & x20 & x21;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n91_));
  assign new_n86_ = x17 & ((new_n89_ & new_n90_) | (x26 & (~new_n87_ | ~new_n88_)));
