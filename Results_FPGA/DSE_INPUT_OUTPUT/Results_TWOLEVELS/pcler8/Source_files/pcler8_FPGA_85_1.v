...
module FAU ( 
  ...
  assign new_n65_ = ~x19 & (x26 | (~x08 & x09 & ~x10 & x20));
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & (x19 ? (x21 ? (new_n68_ | ~x20) : x20) : (x21 & ~x26));
  ...
  assign new_n72_ = ~x19 & (x26 | (~x08 & x09 & ~x10 & x22));
  assign z13 = (new_n50_ & x04) | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = x19 ? ((~x23 | (new_n60_ & ~new_n75_ & x22)) & (~new_n60_ | ~x22 | x23)) : (~x23 | x26);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = x19 ? ((~x24 | (new_n60_ & new_n78_)) & (~new_n60_ | ~new_n79_)) : (~x24 | x26);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = x19 ? ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_)) : (~x25 | x26);
  ...
  assign new_n86_ = x26 & (~new_n87_ | (x19 & (~x22 | ~x23 | ~x24)));
  assign new_n87_ = ~x18 & x20 & x21 & x25;
  assign new_n88_ = new_n89_ & x21 & x22 & x19 & x20;
