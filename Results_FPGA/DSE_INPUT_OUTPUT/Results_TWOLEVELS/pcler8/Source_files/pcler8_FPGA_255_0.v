...
module FAU ( 
  ...
  assign new_n61_ = x20 ? (~x23 | (~new_n62_ & x19)) : ~x19;
  assign new_n62_ = x12 & x21 & x22 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x19 & (x20 ^ x21)) | (x21 & x23 & (new_n65_ | ~x19)));
  ...
  assign new_n71_ = (~x20 | ((x19 | ~x23) & (~x19 | ~x21 | ~x22 | x23))) & (~x23 | (x20 & x21 & ~new_n72_ & x22));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = new_n78_ | (~x08 & x09 & ~new_n74_ & ~x10) | (x05 & x08);
  assign new_n74_ = (~x23 | (~new_n76_ & (~new_n75_ | ~x16 | ~x24))) & (new_n77_ | ~x24);
  assign new_n75_ = x25 & x26;
  assign new_n76_ = x19 & x20 & x21 & x22 & ~x24;
  assign new_n77_ = x20 & x21 & x22 & x23;
  assign new_n78_ = ~x19 & (~x23 | (~x08 & x09 & ~x10 & x24));
  assign z15 = z07 | new_n83_ | (~x08 & new_n80_ & x09);
  assign new_n80_ = ~x10 & (new_n82_ | (x23 & (new_n81_ | (new_n75_ & x17))));
  assign new_n81_ = x19 & x20 & x21 & x22 & x24 & ~x25;
  assign new_n82_ = x25 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n83_ = ~x19 & (~x23 | (~x08 & x09 & ~x10 & x25));
  ...
  assign new_n90_ = ~x19 & (~x23 | (~x08 & x09 & ~x10 & x26));
endmodule
