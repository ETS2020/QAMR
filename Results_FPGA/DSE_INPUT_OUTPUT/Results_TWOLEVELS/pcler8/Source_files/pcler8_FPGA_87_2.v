...
module FAU ( 
  ...
  assign new_n66_ = ~x10 & ((x19 & (x21 ? (new_n67_ | ~x20) : x20)) | (~x16 & ~x19 & x21));
  ...
  assign new_n75_ = ~x19 & (x16 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x19 | ((~x24 | (new_n59_ & new_n78_)) & (~new_n59_ | ~new_n79_))) & (x16 | x19 | ~x24);
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (new_n50_ & x06) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (~x19 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_))) & (x16 | x19 | ~x25);
