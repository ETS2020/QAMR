...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n56_, new_n58_, new_n59_, new_n60_, new_n62_, new_n63_,
  ...
  assign z02 = (~x17 & ~x19) | (x01 & x08 & (x17 | x19));
  ...
  assign z08 = new_n56_ | (~x17 & ~x19);
  assign new_n56_ = x07 & x08 & (x17 | x19);
  assign z09 = (x00 & x08 & (x17 | x19)) | (~x08 & new_n58_ & x09);
  assign new_n58_ = ~x10 & ((x17 & ~x19) | (new_n60_ & new_n59_ & x11 & x19));
  assign new_n59_ = x20 & x21;
  assign new_n60_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08 & (x17 | x19)) | (~x08 & new_n62_ & x09);
  ...
  assign new_n87_ = ~x19 & (~x17 | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n56_ | (~x08 & x09 & ~x10 & (new_n89_ | new_n93_));
