...
module FAU ( 
  ...
  assign new_n61_ = (~x19 | (x20 & (~new_n59_ | ~new_n62_))) & (x14 | x19 | ~x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (x02 & x08 & (~x14 | x19)) | (~x19 & (new_n66_ | x14)) | (new_n64_ & ~x08);
  ...
  assign z12 = (~new_n68_ & x14) | (x03 & x08) | (new_n69_ & ~x08);
  assign new_n68_ = x19 & (~new_n59_ | x08 | ~x09 | x10 | ~x22);
  assign new_n69_ = x09 & ~x10 & ((x22 & (~x19 | ~x20 | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign z13 = (x04 & ~new_n49_ & x08) | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x19 | ((~x23 | (new_n72_ & ~new_n73_ & x22)) & (~new_n72_ | ~x22 | x23))) & (x14 | x19 | ~x23);
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | (~new_n77_ & (~new_n76_ | ~x16 | ~x24))) & (new_n78_ | ~x24);
  ...
  assign new_n80_ = (new_n82_ | ~x25) & (~x19 | (~new_n81_ & (~x17 | ~x25 | ~x26)));
