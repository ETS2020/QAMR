...
module FAU ( 
  ...
  assign new_n71_ = (x14 | ((~x19 | ((x22 | ~x23) & (~new_n72_ | ~x22 | x23))) & (new_n73_ | ~x23))) & (x19 | ~x23);
  assign new_n72_ = x20 & x21;
  assign new_n73_ = x20 & x21 & (~x25 | ~x26 | ~x15 | ~x24);
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (x19 | ~x24) & (x14 | ((~x24 | (new_n72_ & new_n76_)) & (~new_n77_ | ~new_n72_ | ~x19)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = (x06 & x08 & (~x14 | ~x19)) | (x19 & (new_n79_ | x14)) | (new_n81_ & ~x08);
  assign new_n79_ = new_n80_ & ~x08 & x09 & ~x10 & x20;
  assign new_n80_ = x21 & x22 & x23 & x24 & ~x25;
  assign new_n81_ = x09 & ~x10 & x25 & (~new_n82_ | ~new_n72_ | ~x19);
  assign new_n82_ = x22 & x23 & x24 & (~x17 | ~x26);
  assign z16 = new_n84_ | (x07 & x08) | (~x08 & new_n86_ & x09);
  assign new_n84_ = x19 & (x14 | (new_n48_ & new_n85_ & x22 & x23));
  assign new_n85_ = x24 & x25 & ~x26;
  assign new_n86_ = ~x10 & x26 & (~new_n87_ | ~new_n72_ | x18 | ~x19);
