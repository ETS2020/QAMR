...
module FAU ( 
  ...
  assign z01 = x00 & x08 & (x19 | x22);
  assign z02 = (~x19 & ~x22) | (x01 & x08 & (x19 | x22));
  assign z03 = x02 & x08 & (x19 | x22);
  assign z04 = (~x19 & ~x22) | (x03 & x08 & (x19 | x22));
  assign z05 = x04 & x08 & (x19 | x22);
  assign z06 = x05 & x08 & (x19 | x22);
  assign z07 = x06 & x08 & (x19 | x22);
  assign z08 = x07 & x08 & (x19 | x22);
  assign z09 = z01 | (~x08 & x09 & ~x10 & ~new_n58_ & x22);
  assign new_n58_ = x19 & (~new_n59_ | ~x11 | ~x20 | ~x21);
  assign new_n59_ = x25 & x26 & x23 & x24;
  assign z10 = (x01 & x08 & (x19 | x22)) | (new_n61_ & ~x08);
  assign new_n61_ = x09 & ~x10 & (x20 ? (x22 & (new_n62_ | ~x19)) : x19);
  assign new_n62_ = x24 & x25 & x26 & x12 & x21 & x23;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((x19 & (~x20 ^ ~x21)) | (x21 & x22 & (new_n65_ | ~x19)));
  assign new_n65_ = x13 & x23 & x24 & x25 & x26;
  assign z12 = (~x08 & new_n67_ & x09) | (x03 & x08 & (x19 | x22));
  ...
  assign new_n72_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x23));
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x24 | ((new_n75_ | ~x22) & (~x19 | (x22 & x23)))) & (~new_n76_ | ~x22 | ~x23 | x24);
  assign new_n75_ = x19 & x20 & x21 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21;
  assign z15 = z07 | new_n82_ | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~new_n76_ | ~new_n81_) & (~x25 | (new_n79_ & new_n80_));
  assign new_n79_ = x20 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x19 & (~x22 | (~x08 & x09 & ~x10 & x25));
  assign z16 = z08 | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((new_n87_ & new_n88_) | (x26 & (new_n85_ | new_n86_)));
  assign new_n85_ = x22 & (~x19 | ~x20 | ~x21);
  assign new_n86_ = x19 & (~x23 | ~x24 | ~x25 | x18 | ~x22);
