...
module FAU ( 
  ...
  assign z10 = new_n62_ | (~x08 & x09 & ~new_n61_ & ~x10) | (x01 & x08);
  assign new_n61_ = (~new_n59_ | ~x12 | ~x20 | ~x21 | ~x22) & (~x19 | x20);
  assign new_n62_ = ~x19 & (~x25 | (~x08 & x09 & ~x10 & x20));
  assign z11 = (x02 & x08 & (x19 | x25)) | (~x19 & (new_n66_ | ~x25)) | (new_n64_ & ~x08);
  ...
  assign z13 = z05 | new_n73_ | (~x08 & x09 & ~new_n71_ & ~x10);
  ...
  assign z14 = new_n78_ | (~x08 & x09 & ~new_n75_ & ~x10) | (x05 & x08);
  ...
  assign new_n89_ = ~x19 & (~x25 | (~x08 & x09 & ~x10 & x26));
endmodule
