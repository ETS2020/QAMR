...
module FAU ( 
  ...
  assign z09 = z01 | (~x08 & x09 & (new_n57_ | ~x19));
  assign new_n57_ = new_n58_ & new_n59_ & ~x10 & x11 & x20 & x21;
  ...
  assign z14 = (x05 & x08 & (~x10 | x19)) | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (new_n74_ & x22 & ~new_n75_ & x23)) & (~new_n74_ | ~x22 | ~x23 | x24);
  assign new_n74_ = x19 & x20 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign z15 = (x06 & x08 & (~x10 | x19)) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n74_ & new_n58_ & x24 & (~x17 | ~x26))) & (~new_n74_ | ~new_n58_ | ~x24 | x25);
  ...
  assign new_n84_ = ~x19 & (x10 | (~x08 & x09 & x26));
endmodule
