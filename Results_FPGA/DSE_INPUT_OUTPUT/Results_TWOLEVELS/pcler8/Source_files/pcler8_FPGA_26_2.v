...
module FAU ( 
  ...
  assign z11 = (x09 & (~x19 | (~x08 & ~new_n63_ & ~x10))) | (x02 & x08 & (~x09 | x19));
  ...
  assign z16 = (x07 & x08 & (~x09 | x19)) | (~x08 & x09 & ~x10 & ~new_n77_ & x19);
  assign new_n77_ = (~x26 | (new_n78_ & new_n79_)) & (~new_n75_ | ~new_n80_);
  assign new_n78_ = ~x18 & x20 & x21;
