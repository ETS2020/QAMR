...
module FAU ( 
  ...
  assign new_n67_ = (~x22 | ((x10 | (x20 & x21)) & (~x20 | (~new_n68_ & x19)))) & (~x19 | ~x20 | ~x21 | x22);
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & (new_n70_ | new_n72_));
  ...
  assign new_n74_ = ~x08 & x09 & (new_n77_ | (x24 & (new_n75_ | new_n76_)));
  assign new_n75_ = x20 & (~x19 | (x16 & x25 & x26));
  assign new_n76_ = ~x10 & (~x20 | ~x21 | ~x22 | ~x23);
  assign new_n77_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = (x06 & ~new_n49_ & x08) | new_n49_ | (new_n79_ & ~x08);
  assign new_n79_ = x09 & ((new_n80_ & new_n83_) | (x25 & (new_n81_ | new_n82_)));
  assign new_n80_ = x19 & x20 & x21;
  assign new_n81_ = x20 & (~x19 | (x17 & x26));
  assign new_n82_ = ~x10 & (~x20 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n83_ = x22 & x23 & x24 & ~x25;
  assign z16 = (x07 & ~new_n49_ & x08) | new_n49_ | (~x08 & x09 & (new_n85_ | new_n87_));
  assign new_n85_ = x20 & ((~x19 & x26) | (new_n86_ & new_n59_ & x19));
  assign new_n86_ = x23 & x24 & x25 & ~x26;
  assign new_n87_ = ~x10 & x26 & (~new_n88_ | x18 | ~x20 | ~x21);
