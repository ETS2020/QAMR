...
module FAU ( 
  ...
  assign z00 = ~x08 & (x10 | (new_n47_ & new_n48_ & new_n49_));
  assign new_n47_ = x09 & x19 & x20 & x21;
  ...
  assign z13 = x08 ? x04 : (x10 | (~new_n69_ & x09));
  ...
  assign z15 = x08 ? x06 : (x10 | (~new_n76_ & x09));
  assign new_n76_ = (~x25 | (new_n73_ & new_n77_)) & (~new_n73_ | ~new_n48_ | ~x24 | x25);
  assign new_n77_ = x22 & (x10 | x23) & x24 & (~x17 | ~x26);
  assign z16 = x08 ? x07 : (new_n79_ | x10);
  assign new_n79_ = x09 & ((new_n82_ & new_n83_) | ((~new_n80_ | ~new_n81_) & x26));
