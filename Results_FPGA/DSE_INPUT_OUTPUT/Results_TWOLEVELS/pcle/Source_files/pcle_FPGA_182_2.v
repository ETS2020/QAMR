...
module FAU ( 
  ...
  assign z8 = new_n54_ | (x07 & x08) | (~x08 & new_n55_ & x09);
  assign new_n54_ = ~x12 & (x00 | (new_n31_ & ~x10 & x18));
  assign new_n55_ = ~x10 & ((new_n58_ & new_n59_) | (x18 & (new_n56_ | ~new_n57_)));
  assign new_n56_ = x12 & (~x15 | ~x16);
  assign new_n57_ = x14 & x17 & x11 & x13;
  assign new_n58_ = x13 & x14 & x11 & x12;
  assign new_n59_ = x17 & ~x18 & x15 & x16;
endmodule
