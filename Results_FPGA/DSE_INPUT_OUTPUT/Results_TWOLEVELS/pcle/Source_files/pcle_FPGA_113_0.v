...
module FAU ( 
  ...
  assign new_n38_ = ~x12 & (~x16 | (~x08 & x09 & ~x10 & x13 & x16));
  ...
  assign new_n47_ = (~x13 | ((x12 | ~x16) & (~x14 | ~x15 | x16 | ~x11 | ~x12))) & (~x16 | (x14 & x15 & x11 & x13));
  ...
  assign new_n53_ = (~x12 | ((~new_n50_ | ~new_n54_) & (x16 | ~x18))) & (new_n55_ | ~x18);
