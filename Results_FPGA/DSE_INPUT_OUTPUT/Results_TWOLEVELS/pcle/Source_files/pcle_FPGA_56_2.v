...
module FAU ( 
  ...
  assign new_n37_ = x14 & (x08 | ~x09 | x10 | ~x11 | x13);
  assign new_n38_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (new_n40_ & ~x08) | new_n33_ | (x03 & x08);
  assign new_n40_ = x09 & ~x10 & (x12 ? (~x11 | (x11 & ~x13)) : x14);
  ...
  assign z7 = ~new_n48_ | (~new_n46_ & x12);
  assign new_n46_ = x14 & (~new_n47_ | ~x13 | ~x15 | ~x16 | x17);
  assign new_n47_ = ~x08 & x09 & ~x10 & x11;
  assign new_n48_ = x08 ? ~x06 : (~x09 | x10 | new_n49_ | ~x17);
  assign new_n49_ = x11 & x12 & x13 & x15 & x16;
  assign z8 = ~new_n52_ | (x12 & (new_n51_ | ~x14));
  assign new_n51_ = new_n47_ & x13 & x15 & x16 & x17 & ~x18;
