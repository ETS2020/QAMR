...
module FAU ( 
  ...
  assign z1 = (x00 & x08) | (x09 & (~x12 | (~x08 & ~x10 & ~x11 & x12)));
  ...
  assign z7 = (x09 & (~x12 | (new_n43_ & ~x08))) | (x06 & x08);
  assign new_n43_ = ~x10 & ((~new_n44_ & x17) | (new_n45_ & x15 & x16 & ~x17));
  assign new_n44_ = x11 & x13 & x14 & x16 & (~x12 | x15);
  assign new_n45_ = x11 & x13 & x14;
  assign z8 = (x07 & x08 & (~x09 | x12)) | (~x08 & x09 & ~x10 & ~new_n47_ & x12);
