...
module FAU ( 
  ...
  assign new_n42_ = x12 ? ((~x15 | (x11 & x13 & x14)) & (~x11 | ~x13 | ~x14 | x15)) : (~x15 | ~x18);
  ...
  assign z8 = (~x08 & new_n50_ & x09) | new_n33_ | (x07 & x08);
  assign new_n50_ = ~x10 & ((x11 & (new_n51_ | ~x12)) | (~new_n52_ & x18));
  assign new_n51_ = x13 & x14 & x15 & x16 & x17 & ~x18;
