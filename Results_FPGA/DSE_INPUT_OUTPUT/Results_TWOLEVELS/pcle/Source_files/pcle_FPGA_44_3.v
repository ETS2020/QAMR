// Benchmark "FAU" written by ABC on Mon Aug 24 16:34:34 2020
...
module FAU ( 
  ...
  assign z4 = (~x12 & ((x03 & x08) | (new_n40_ & ~x08 & x09))) | (~x03 & ~x08 & new_n41_ & x09);
  assign new_n40_ = ~x10 & x14;
  assign new_n41_ = ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  ...
  assign z6 = (x05 & ~new_n34_ & x08) | (new_n48_ & ~x08);
  assign new_n48_ = x09 & ~x10 & ((~new_n49_ & ~x03) | (~x12 & x16));
  assign new_n49_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = (~new_n51_ & x12) | (x06 & x08) | (~x08 & new_n53_ & x09);
  assign new_n51_ = ~x03 & (~new_n52_ | x08 | ~x09 | x10 | ~x11);
  ...
  assign new_n56_ = (x12 | ~x18) & (x03 | ((~new_n46_ | ~new_n58_) & (new_n57_ | ~x18)));
