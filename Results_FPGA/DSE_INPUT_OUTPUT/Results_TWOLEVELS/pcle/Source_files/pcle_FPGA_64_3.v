...
module FAU ( 
  ...
  assign z1 = (x02 & x11) | (x00 & x08) | (~x08 & x09 & ~x10 & ~x11);
  assign z2 = (x01 & x08 & (~x02 | ~x11)) | (new_n36_ & ~x08);
  assign new_n36_ = x09 & ~x10 & ((~x11 & x12) | (~x02 & x11 & ~x12));
  assign z3 = (x02 & (x08 | x11)) | (new_n38_ & ~x08);
  assign new_n38_ = x09 & ~x10 & ((x13 & (~x11 | ~x12)) | (x11 & x12 & ~x13));
  assign z4 = (x11 & (new_n42_ | x02)) | (x03 & x08) | (new_n40_ & ~x08);
  assign new_n40_ = x09 & ~x10 & ~new_n41_ & x14;
  assign new_n41_ = x11 & x12 & x13;
  assign new_n42_ = ~x08 & x09 & ~x10 & x12 & x13 & ~x14;
  assign z5 = (new_n44_ & ~x08) | (x04 & x08 & (~x02 | ~x11));
  assign new_n44_ = x09 & ~new_n45_ & ~x10;
  assign new_n45_ = (x02 | (((x12 & x13 & x14) | ~x15) & (~x11 | ~x12 | ~x13 | ~x14 | x15))) & (x11 | ~x15);
  ...
  assign z7 = (~new_n51_ & x11) | (x06 & x08) | (~x08 & new_n53_ & x09);
  assign new_n51_ = ~x02 & (~new_n48_ | ~new_n52_);
  assign new_n52_ = x13 & x14 & x15 & x16 & ~x17;
  assign new_n53_ = ~x10 & x17 & (~new_n41_ | ~x14 | ~x15 | ~x16);
  assign z8 = (~new_n55_ & x11) | (x07 & x08) | (~x08 & new_n56_ & x09);
