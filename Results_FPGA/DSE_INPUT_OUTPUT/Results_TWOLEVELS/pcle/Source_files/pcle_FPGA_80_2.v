...
module FAU ( 
  ...
  assign z5 = (~x03 & (new_n41_ | (x04 & x08))) | (x11 & (x08 ? x04 : new_n42_));
  assign new_n41_ = new_n31_ & ~x10 & ~x11 & x15;
  assign new_n42_ = x09 & ~x10 & ((x15 & (~x12 | ~x13 | ~x14)) | (x14 & ~x15 & x12 & x13));
  assign z6 = new_n44_ | (x05 & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n44_ = ~x11 & (x03 | (new_n31_ & ~x10 & x16));
  assign new_n45_ = (~x16 | (new_n46_ & x14 & x15)) & (~new_n46_ | ~x11 | ~x14 | ~x15 | x16);
  assign new_n46_ = x12 & x13;
  assign z7 = new_n48_ | (x06 & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n48_ = ~x11 & (x03 | (new_n31_ & ~x10 & x17));
  assign new_n49_ = (~x17 | (new_n46_ & x14 & x15 & x16)) & (~x16 | x17 | ~x14 | ~x15 | ~new_n46_ | ~x11);
