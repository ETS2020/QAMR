...
module FAU ( 
  ...
  assign z4 = (x12 & (new_n41_ | x07)) | (new_n42_ & ~x08) | (x03 & x08);
  ...
  assign new_n44_ = (x07 | ((~x15 | (x11 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x15))) & (x12 | ~x15);
  assign z6 = (x05 & ~new_n34_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & ~x07) | (~x12 & x16));
  assign new_n47_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = (~new_n49_ & x12) | (x06 & x08) | (~x08 & new_n51_ & x09);
  assign new_n49_ = ~x07 & (~new_n50_ | x08 | ~x09 | x10 | ~x11);
  ...
  assign new_n57_ = ~x12 & ((x07 & x08) | (~x08 & x09 & ~x10 & x18));
endmodule
