...
module FAU ( 
  ...
  assign z6 = (x11 & (new_n41_ | ~x09)) | (x05 & x08) | (~x08 & new_n43_ & x09);
  assign new_n41_ = new_n42_ & ~x08 & ~x10 & x12;
  assign new_n42_ = x13 & x14 & x15 & ~x16;
  assign new_n43_ = ~x10 & x16 & (~x11 | ~x12 | ~new_n44_ | ~x13);
  ...
  assign new_n52_ = (~x18 | (new_n49_ & new_n54_)) & (~new_n53_ | ~new_n50_ | ~x17 | x18);
