...
module FAU ( 
  ...
  assign new_n38_ = x09 & ~x10 & ((~x08 & (x11 ? (x12 & ~x13) : x13)) | (~x12 & x13));
  ...
  assign z5 = new_n31_ | (x04 & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x12 | ((x13 | ~x15) & (~x14 | x15 | ~x11 | ~x13))) & (~x15 | (x11 & x14 & (~x02 | x12)));
  ...
  assign new_n51_ = ~x12 & (~x02 | (x02 & ~x08 & x09 & ~x10 & x17));
  ...
  assign new_n56_ = ~x12 & (~x02 | (x02 & ~x08 & x09 & ~x10 & x18));
endmodule
