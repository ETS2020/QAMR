...
module FAU ( 
  ...
  assign z6 = (x05 & ~new_n35_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & ~x04) | (~x11 & x16));
  assign new_n47_ = (~x16 | (x14 & x15 & x12 & x13)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = (x06 & ~new_n35_ & x08) | (~x08 & new_n49_ & x09);
  assign new_n49_ = ~x10 & (new_n53_ | (~x04 & (new_n51_ | (new_n50_ & new_n52_))));
  ...
  assign new_n55_ = (x11 | ~x18) & (x04 | ((~new_n57_ | ~new_n58_) & (new_n56_ | ~x18)));
