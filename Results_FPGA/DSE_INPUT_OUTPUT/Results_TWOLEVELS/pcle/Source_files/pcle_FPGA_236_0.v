...
module FAU ( 
  ...
  assign new_n43_ = (new_n45_ | ~x16) & (~new_n44_ | x16 | ~x17 | ~x14 | ~x15);
  assign new_n44_ = x11 & x12 & x13;
  assign new_n45_ = (~x13 | (x11 & x12)) & x15 & (~x15 | (x13 & x14));
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & new_n47_ & x09);
  assign new_n47_ = ~x10 & ((~new_n48_ & x15) | (x17 & (~x15 | (~x11 & x13))));
  assign new_n48_ = (~x11 | ~x12 | ~x13 | ~x14 | (~x16 ^ x17)) & (~x17 | (x12 & x13 & x14));
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n50_ & ~x10);
  assign new_n50_ = (~x16 | ((x17 | ~x18) & (~new_n44_ | ~x14 | ~x15 | ~x17 | x18))) & (~x17 | ~x18 | (new_n44_ & x14 & x15 & x16));
endmodule
