...
module FAU ( 
  ...
  assign z6 = (new_n48_ & ~x08) | (x05 & x08 & (~x04 | ~x12));
  assign new_n48_ = x09 & ~x10 & ((~new_n49_ & ~x04) | (~x12 & x16));
  assign new_n49_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~new_n51_ & x12) | (x06 & x08) | (~x08 & new_n53_ & x09);
  assign new_n51_ = ~x04 & (~new_n52_ | x10 | ~x11 | x08 | ~x09);
  assign new_n52_ = x13 & x14 & x15 & x16 & ~x17;
  assign new_n53_ = ~x10 & x17 & (~new_n43_ | ~x14 | ~x15 | ~x16);
  assign z8 = (~new_n55_ & x12) | (x07 & x08) | (~x08 & new_n56_ & x09);
  assign new_n55_ = ~x04 & (~new_n32_ | ~new_n33_ | ~x16 | ~x17 | x18);
  assign new_n56_ = ~x10 & x18 & (~new_n43_ | ~new_n33_ | ~x16 | ~x17);
endmodule
