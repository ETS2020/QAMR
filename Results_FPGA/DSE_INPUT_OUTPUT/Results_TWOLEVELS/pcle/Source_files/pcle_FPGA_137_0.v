...
module FAU ( 
  ...
  assign z4 = (~x12 & (~x02 | (new_n41_ & x02 & ~x08))) | (new_n42_ & ~x08) | (x03 & x08);
  assign new_n41_ = x09 & ~x10 & x14;
  assign new_n42_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x13 & ~x14 & x11 & x12));
  assign z5 = new_n44_ | (x04 & x08) | (~x08 & new_n45_ & x09);
  assign new_n44_ = ~x12 & (~x02 | (x02 & ~x08 & x09 & ~x10 & x15));
  ...
  assign new_n48_ = (~x16 | (new_n49_ & x14 & x15)) & (~new_n50_ | ~x14 | ~x15 | x16);
  assign new_n49_ = x11 & x13;
  assign new_n50_ = x11 & x12 & x13;
  assign z7 = new_n52_ | (x06 & x08) | (~x08 & x09 & ~new_n53_ & ~x10);
  assign new_n52_ = ~x12 & (~x02 | (new_n31_ & ~x10 & x17));
  assign new_n53_ = (~x17 | (new_n49_ & x14 & x15 & x16)) & (~new_n50_ | ~x16 | x17 | ~x14 | ~x15);
  assign z8 = new_n55_ | (x12 & (x08 ? x07 : (new_n57_ & x09)));
  assign new_n55_ = ~new_n56_ & x02;
  assign new_n56_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x12 | ~x18);
  assign new_n57_ = ~x10 & ((x18 & (~new_n58_ | ~x15 | ~x16 | ~x17)) | (new_n58_ & x17 & ~x18 & x15 & x16));
