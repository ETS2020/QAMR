// Benchmark "FAU" written by ABC on Mon Aug 24 16:35:20 2020
...
module FAU ( 
  ...
  assign new_n39_ = ~x05 & (x08 | ~x09 | x10 | ~x11 | x13);
  assign new_n40_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (x12 & (new_n42_ | x05)) | (new_n43_ & ~x08) | (x03 & x08);
  assign new_n42_ = ~x08 & x09 & ~x10 & x11 & x13 & ~x14;
  assign new_n43_ = x09 & ~x10 & x14 & (~x11 | ~x12 | ~x13);
  assign z5 = (new_n34_ & x04) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (x05 | ((~x15 | (x11 & x13 & x14)) & (~x13 | ~x14 | x15 | ~x11 | ~x12))) & (x12 | ~x15);
  assign z6 = (x05 & (x08 | x12)) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = (~new_n49_ & x12) | (x06 & x08) | (~x08 & new_n51_ & x09);
  assign new_n49_ = ~x05 & (~new_n50_ | x08 | ~x09 | x10 | ~x11);
  assign new_n50_ = x13 & x14 & x15 & x16 & ~x17;
  assign new_n51_ = ~x10 & ~new_n52_ & x17;
  assign new_n52_ = x11 & x12 & x13 & x14 & x15 & x16;
  assign z8 = (new_n34_ & x07) | (~x08 & x09 & ~new_n54_ & ~x10);
  assign new_n54_ = (x12 | ~x18) & (x05 | ((~new_n56_ | ~new_n57_) & (new_n55_ | ~x18)));
  assign new_n55_ = x11 & x13 & x14 & x15 & x16 & x17;
