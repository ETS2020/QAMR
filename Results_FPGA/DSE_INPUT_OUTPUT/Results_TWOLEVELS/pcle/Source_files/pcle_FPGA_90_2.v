...
module FAU ( 
  ...
  assign new_n37_ = x16 & (x08 | ~x09 | x10 | ~x11 | x13 | ~x16);
  ...
  assign new_n42_ = x16 & (~new_n43_ | ~x13 | ~x14 | x15 | ~x16);
  assign new_n43_ = ~x08 & x09 & ~x10 & x11;
  assign new_n44_ = ~x10 & x15 & (~x11 | ~x12 | ~x13 | ~x14);
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & new_n46_ & ~x10);
  assign new_n46_ = x16 & (~x12 | (x12 & (~x11 | (x11 & (~x13 | (x13 & (~x14 | (x14 & ~x15))))))));
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n48_ & ~x08);
  assign new_n48_ = x09 & ~x10 & ((~new_n49_ & x16) | (~x12 & x17));
  assign new_n49_ = (~x17 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x17);
