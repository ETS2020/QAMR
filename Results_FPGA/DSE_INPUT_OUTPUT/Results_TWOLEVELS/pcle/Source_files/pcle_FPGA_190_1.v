...
module FAU ( 
  ...
  assign z7 = ~new_n46_ | (x14 & (~x12 | (new_n32_ & new_n48_)));
  assign new_n46_ = x08 ? ~x06 : (~x09 | x10 | new_n47_ | ~x17);
  assign new_n47_ = x14 & x15 & x16 & x11 & (~x12 | x13);
  assign new_n48_ = x13 & x15 & x16 & ~x17;
