...
module FAU ( 
  ...
  assign z4 = (x11 & (new_n41_ | x04)) | (new_n42_ & ~x08) | (x03 & x08);
  ...
  assign new_n45_ = ~x10 & ((x15 & (~x12 | ~x13 | ~x14)) | (x13 & x14 & ~x15 & x11 & x12));
  assign z6 = new_n47_ | (x05 & x08) | (~x08 & x09 & new_n50_ & ~x10);
  assign new_n47_ = x11 & (x04 | (new_n49_ & new_n48_ & x15 & ~x16));
  assign new_n48_ = x13 & x14;
  assign new_n49_ = ~x10 & x12 & ~x08 & x09;
  assign new_n50_ = x16 & (~x11 | ~x12 | ~x13 | ~x14 | ~x15);
  assign z7 = (~new_n52_ & x11) | (x06 & x08) | (~x08 & new_n53_ & x09);
  assign new_n52_ = ~x04 & (~new_n49_ | ~new_n48_ | ~x15 | ~x16 | x17);
  assign new_n53_ = ~x10 & ~new_n54_ & x17;
  assign new_n54_ = x11 & x12 & x13 & x14 & x15 & x16;
  assign z8 = (x07 & ~new_n35_ & x08) | (~x08 & x09 & ~new_n56_ & ~x10);
  assign new_n56_ = (x04 | ((~new_n58_ | ~new_n59_) & (new_n57_ | ~x18))) & (x11 | ~x18);
