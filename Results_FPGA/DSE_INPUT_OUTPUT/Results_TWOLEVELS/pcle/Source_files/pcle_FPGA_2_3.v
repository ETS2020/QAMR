...
module FAU ( 
  ...
  assign z0 = (x00 & x08) | (new_n32_ & new_n31_ & ~x08 & x09);
  assign new_n31_ = ~x10 & x11 & x12;
  assign new_n32_ = x13 & x14 & x15 & x16 & x17 & x18;
  assign z1 = ~x11 & ~x10 & ~x08 & x09;
  assign z2 = x08 ? (x00 | x01) : new_n35_;
  assign new_n35_ = x09 & ~x10 & (x11 ^ x12);
  assign z3 = (new_n37_ & ~x08) | (~x00 & x02 & x08);
  assign new_n37_ = x09 & ~x10 & ((x13 & (~x11 | ~x12)) | (x11 & x12 & ~x13));
  assign z4 = x08 ? (x00 | x03) : new_n39_;
  assign new_n39_ = x09 & ~x10 & ((x14 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (~x00 & x04 & x08) | (~x08 & new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x15 & (~x11 | ~x12 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = x08 ? (x00 | x05) : (x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x16 | (x13 & x14 & x15 & x11 & x12)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~x00 & x06 & x08) | (~x08 & new_n45_ & x09);
  assign new_n45_ = ~x10 & ((x17 & (~new_n46_ | ~x14 | ~x15 | ~x16)) | (new_n46_ & x14 & x15 & x16 & ~x17));
  assign new_n46_ = x11 & x12 & x13;
  assign z8 = (~x00 & x07 & x08) | (~x08 & x09 & ~new_n48_ & ~x10);
