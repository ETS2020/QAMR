...
module FAU ( 
  ...
  assign new_n41_ = ~x10 & ((~x14 & x15) | (x11 & ((x12 & x13) ? (x14 & ~x15) : x15)));
  assign z6 = (~new_n43_ & x14) | (x05 & x08) | (new_n45_ & ~x08);
  assign new_n43_ = x11 & (~new_n44_ | x08 | ~x09 | x10);
  assign new_n44_ = x15 & ~x16 & x12 & x13;
  assign new_n45_ = x09 & ~x10 & x16 & (~new_n46_ | ~x14 | ~x15);
  assign new_n46_ = x12 & (~x11 | x13);
  assign z7 = (~new_n48_ & x14) | (x06 & x08) | (~x08 & new_n49_ & x09);
  assign new_n48_ = x11 & (~new_n32_ | ~x16 | x17 | ~x13 | ~x15);
  assign new_n49_ = ~x10 & x17 & (~new_n46_ | ~x14 | ~x15 | ~x16);
  assign z8 = ~new_n52_ | (x14 & (new_n51_ | ~x11));
  assign new_n51_ = new_n32_ & x13 & x15 & x16 & x17 & ~x18;
  assign new_n52_ = x08 ? ~x07 : (~x09 | x10 | new_n53_ | ~x18);
  assign new_n53_ = x15 & x16 & x17 & x12 & x13 & x14;
endmodule
