// Benchmark "FAU" written by ABC on Mon Aug 24 16:35:02 2020
...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & x12 & (x11 ^ x13);
  assign z4 = (~new_n39_ & x13) | (new_n40_ & ~x08) | (x03 & x08);
  assign new_n39_ = x12 & (x08 | ~x09 | x10 | ~x11 | x14);
  assign new_n40_ = x09 & ~x10 & x14 & (~x11 | ~x13);
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & new_n42_ & x09);
  assign new_n42_ = ~x10 & ((x12 & ((x15 & (~x11 | ~x14)) | (x11 & x13 & x14 & ~x15))) | (~x13 & x15));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x12 | ((~x16 | (x11 & x14 & x15)) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (x13 | ~x16);
  assign z7 = ~new_n48_ | (~new_n46_ & x13);
  assign new_n46_ = x12 & (~new_n47_ | ~x14 | ~x15 | ~x16 | x17);
  ...
  assign new_n51_ = new_n47_ & x14 & x15 & x16 & x17 & ~x18;
