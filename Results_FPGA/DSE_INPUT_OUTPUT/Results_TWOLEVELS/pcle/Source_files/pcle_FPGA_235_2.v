...
module FAU ( 
  ...
  assign z5 = (~x08 & new_n42_ & x09) | new_n31_ | (x04 & x08);
  assign new_n42_ = ~x10 & ((x12 & ((~x13 & x15) | (x14 & ~x15 & x11 & x13))) | (x15 & (~x11 | ~x12 | ~x14)));
  assign z6 = new_n31_ | (x05 & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x12 | ((x13 | ~x16) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (~x16 | (x11 & x12 & x14 & x15));
  ...
  assign new_n49_ = ~x12 & (x07 | (~x10 & x17 & ~x08 & x09));
  assign z8 = (x07 & (x08 | ~x12)) | (~x08 & new_n51_ & x09);
