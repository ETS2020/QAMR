...
module FAU ( 
  ...
  assign new_n40_ = (~x12 | ((x11 | ~x15) & (~x14 | x15 | ~x11 | ~x13))) & (x10 | ~x15 | (x12 & x13 & x14));
  assign z6 = (x05 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n42_ & ~x10);
  assign new_n42_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~x08 & ~new_n44_ & x09) | (x10 & x12) | (x06 & x08);
  assign new_n44_ = (new_n45_ | ~x12) & (x10 | ~x17 | (new_n46_ & x12 & x13));
  assign new_n45_ = (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17) & (x11 | ~x17);
  assign new_n46_ = x14 & x15 & x16;
  assign z8 = (x07 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~new_n51_ | ~new_n52_) & (~x18 | (new_n49_ & new_n50_));
