...
module FAU ( 
  ...
  assign z6 = (x05 & x08) | (~x08 & new_n51_ & x09) | (~new_n49_ & x12);
  assign new_n49_ = x04 & (~new_n50_ | x08 | ~x09 | x10 | ~x11);
  assign new_n50_ = x13 & x14 & x15 & ~x16;
  assign new_n51_ = ~x10 & x16 & (~new_n33_ | ~x13 | ~x11 | ~x12);
  assign z7 = (x06 & x08 & (x04 | ~x12)) | (~x08 & new_n53_ & x09);
  assign new_n53_ = ~x10 & (new_n56_ | (x04 & (new_n54_ | (new_n43_ & new_n55_))));
  assign new_n54_ = x17 & (~x14 | ~x15 | ~x16 | ~x11 | ~x13);
  assign new_n55_ = x14 & x15 & x16 & ~x17;
  assign new_n56_ = ~x12 & x17;
  assign z8 = (x07 & x08) | (~x08 & new_n59_ & x09) | (~new_n58_ & x12);
  assign new_n58_ = x04 & (~new_n32_ | ~new_n33_ | ~x16 | ~x17 | x18);
  assign new_n59_ = ~x10 & x18 & (~new_n43_ | ~new_n33_ | ~x16 | ~x17);
endmodule
