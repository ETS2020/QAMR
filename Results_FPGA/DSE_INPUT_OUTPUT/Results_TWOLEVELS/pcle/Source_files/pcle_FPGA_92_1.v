...
module FAU ( 
  ...
  assign z7 = (~x08 & x09 & ~new_n49_ & ~x10) | new_n33_ | (x06 & x08);
  assign new_n49_ = (~x12 | ((x15 | ~x17) & (~new_n50_ | ~x15 | ~x16 | x17))) & (new_n51_ | ~x17);
  assign new_n50_ = x11 & x13 & x14;
  assign new_n51_ = x11 & x13 & x14 & x16 & (x12 | x18);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & new_n53_ & ~x10);
  assign new_n53_ = x12 & ((x18 & (~new_n50_ | ~x15 | ~x16 | ~x17)) | (new_n50_ & x15 & x16 & x17 & ~x18));
endmodule
