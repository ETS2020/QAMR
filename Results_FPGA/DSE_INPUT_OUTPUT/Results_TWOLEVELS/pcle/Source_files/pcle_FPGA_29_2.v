...
module FAU ( 
  ...
  assign z2 = (~x00 & (new_n35_ | (new_n32_ & ~x10 & x11 & ~x12))) | (x12 & (new_n35_ | (new_n32_ & ~x10 & ~x11)));
  assign new_n35_ = x01 & x08;
  assign z3 = new_n37_ | (new_n38_ & ~x08) | (x02 & x08);
  assign new_n37_ = ~x12 & (x00 | (new_n32_ & ~x10 & x13));
  assign new_n38_ = x09 & ~x10 & (x11 ? (x12 & ~x13) : x13);
  assign z4 = new_n40_ | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n40_ = ~x12 & (x00 | (new_n32_ & ~x10 & x14));
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x13 & ~x14 & x11 & x12));
  assign z5 = new_n43_ | (x04 & x08) | (~x08 & new_n44_ & x09);
  assign new_n43_ = ~x12 & (x00 | (new_n32_ & ~x10 & x15));
  assign new_n44_ = ~x10 & ((x15 & (~x11 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (~x00 & (new_n46_ | (x05 & x08))) | (x12 & (x08 ? x05 : new_n47_));
  assign new_n46_ = new_n32_ & ~x10 & ~x12 & x16;
  assign new_n47_ = new_n48_ & x09;
  assign new_n48_ = ~x10 & ((x11 & x13 & x14 & x15 & ~x16) | (x16 & (~x14 | ~x15 | ~x11 | ~x13)));
  assign z7 = (~x00 & (new_n50_ | (x06 & x08))) | (x12 & (x08 ? x06 : new_n51_));
  assign new_n50_ = new_n32_ & ~x10 & ~x12 & x17;
  assign new_n51_ = x09 & ~new_n52_ & ~x10;
  assign new_n52_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14);
  assign z8 = new_n54_ | (x12 & (x08 ? x07 : (new_n56_ & x09)));
  assign new_n54_ = ~new_n55_ & ~x00;
  assign new_n55_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x12 | ~x18);
  assign new_n56_ = ~x10 & ((x18 & (~new_n57_ | ~x15 | ~x16 | ~x17)) | (new_n57_ & x17 & ~x18 & x15 & x16));
