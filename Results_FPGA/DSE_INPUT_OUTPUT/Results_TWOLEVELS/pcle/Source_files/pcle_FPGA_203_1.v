...
module FAU ( 
  ...
  assign new_n38_ = x04 & (x08 | ~x09 | x10 | ~x11 | x13);
  assign new_n39_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (x03 & ~new_n34_ & x08) | (~x08 & new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x04 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14))) | (~x12 & x14));
  assign z5 = (x04 & (x08 | (x09 & ~new_n43_ & ~x10))) | (~x08 & x09 & new_n44_ & ~x10);
  assign new_n43_ = (~x15 | (x11 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x15);
  assign new_n44_ = ~x12 & x15;
  assign z6 = (x05 & ~new_n34_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x04) | (~x12 & x16));
  assign new_n47_ = (~x16 | (x11 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~new_n49_ & x12) | (x06 & x08) | (~x08 & new_n51_ & x09);
  assign new_n49_ = x04 & (~new_n50_ | x08 | ~x09 | x10 | ~x11);
  ...
  assign new_n54_ = (x12 | ~x18) & (~x04 | ((~new_n56_ | ~new_n57_) & (new_n55_ | ~x18)));
