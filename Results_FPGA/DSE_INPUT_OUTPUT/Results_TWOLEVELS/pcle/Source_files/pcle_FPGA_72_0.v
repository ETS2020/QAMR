...
module FAU ( 
  ...
  assign new_n47_ = ~x12 & (~x04 | (new_n31_ & ~x10 & x16));
  ...
  assign z8 = ~new_n58_ | (~x08 & x09 & ~x10 & (new_n54_ | new_n56_));
  assign new_n54_ = x12 & ((~x16 & x18) | (new_n55_ & x15 & x16 & x17 & ~x18));
  assign new_n55_ = x11 & x13 & x14;
  assign new_n56_ = x18 & (~new_n57_ | ~x14 | ~x15 | ~x17);
  assign new_n57_ = x11 & x13 & (~x04 | x12);
  assign new_n58_ = (~x07 | ~x08) & (x04 | x12);
endmodule
