...
module FAU ( 
  ...
  assign new_n45_ = (~x14 | ((x12 | ~x16) & (~x11 | ~x12 | ~x13 | ~x15 | x16))) & (~x16 | (x14 & x15 & x11 & x13));
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~x12 | ((x16 | ~x17) & (~new_n48_ | ~x15 | ~x16 | x17))) & (~x16 | new_n49_ | ~x17);
  assign new_n48_ = x11 & x13 & x14;
  assign new_n49_ = x11 & x12 & x13 & x14 & x15;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x12 | ((~new_n48_ | ~new_n52_) & (x16 | ~x18))) & (~x16 | new_n53_ | ~x18);
