...
module FAU ( 
  ...
  assign new_n46_ = (~x17 | ((~x12 | (new_n47_ & x13)) & (~x13 | (x11 & x12 & x16)))) & (~x11 | ~x12 | ~x13 | ~new_n47_ | ~x16 | x17);
  assign new_n47_ = x14 & x15;
  assign z8 = new_n53_ | (x07 & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (new_n52_ | ~x18) & (~x13 | ((~new_n50_ | ~new_n51_) & (x16 | ~x18)));
  assign new_n50_ = x11 & x12 & x14;
  assign new_n51_ = x15 & x16 & x17 & ~x18;
  assign new_n52_ = x11 & x13 & x14 & x15 & x17;
