// Benchmark "FAU" written by ABC on Mon Aug 24 16:34:56 2020
...
module FAU ( 
  ...
  assign new_n47_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n49_ & ~x08);
  assign new_n49_ = x09 & ~x10 & (x12 ? ~new_n50_ : (x17 & x18));
  assign new_n50_ = (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14) & (~x17 | (x11 & x13 & x14 & x15 & x16));
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n52_ & ~x10);
  assign new_n52_ = (~x17 | ((~new_n53_ | ~new_n54_) & (x12 | ~x18))) & (new_n55_ | ~x18);
  assign new_n53_ = x11 & x12 & x13;
  assign new_n54_ = x14 & x15 & x16 & ~x18;
