...
module FAU ( 
  ...
  assign z4 = (x03 & x08 & (x09 | ~x11)) | (~x08 & new_n39_ & x09);
  ...
  assign new_n42_ = ~x10 & x15 & (~x13 | ~x14 | ~x11 | ~x12);
  ...
  assign new_n48_ = new_n32_ & new_n33_ & x16 & ~x17;
  ...
  assign new_n52_ = new_n32_ & new_n33_ & x16 & x17 & ~x18;
  assign new_n53_ = ~x10 & x18 & (~new_n50_ | ~new_n33_ | ~x16 | ~x17);
endmodule
