...
module FAU ( 
  ...
  assign new_n41_ = ~x10 & ((x12 & ((x15 & (~x13 | ~x14)) | (x14 & ~x15 & x11 & x13))) | (~x11 & x15));
  assign z6 = (x05 & ~new_n35_ & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x12 | ((~x16 | (x13 & x14 & x15)) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (x11 | ~x16);
  assign z7 = (x06 & ~new_n35_ & x08) | (new_n45_ & ~x08);
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x12) | (~x11 & x17));
  assign new_n46_ = (~x17 | (x15 & x16 & x13 & x14)) & (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14);
  assign z8 = (~new_n48_ & x11) | (x07 & x08) | (~x08 & new_n50_ & x09);
  assign new_n48_ = x12 & (~new_n49_ | x08 | ~x09 | x10 | ~x13);
  assign new_n49_ = x14 & x15 & x16 & x17 & ~x18;
  assign new_n50_ = ~x10 & ~new_n51_ & x18;
  assign new_n51_ = x11 & x13 & x14 & x15 & x16 & x17;
endmodule
