...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & ((x11 & ((~x13 & x14) | (x12 & x13 & ~x14))) | (~x12 & x14));
  assign z5 = ~new_n39_ | (x12 & (new_n41_ | ~x11));
  assign new_n39_ = x08 ? ~x04 : (~new_n40_ | ~x09);
  assign new_n40_ = ~x10 & x15 & (~x12 | ~x13 | (x11 & ~x14));
  assign new_n41_ = x13 & x14 & ~x15 & ~x08 & x09 & ~x10;
  assign z6 = (x05 & x08 & (x11 | ~x12)) | (new_n43_ & ~x08);
  assign new_n43_ = x09 & ~new_n44_ & ~x10;
  assign new_n44_ = (~x11 | ((~x16 | (x13 & x14 & x15)) & (~x14 | ~x15 | x16 | ~x12 | ~x13))) & (x12 | ~x16);
  assign z7 = ~new_n46_ | (x12 & (~x11 | (new_n48_ & new_n49_)));
  ...
  assign z8 = (~x08 & new_n51_ & x09) | (x07 & x08 & (x11 | ~x12));
  assign new_n51_ = ~x10 & (new_n55_ | (x11 & (new_n52_ | (new_n53_ & new_n54_))));
