...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & (x11 ? (~x13 | (~x12 & x13)) : x13);
  assign z4 = new_n39_ | (new_n40_ & ~x08) | (x03 & x08);
  assign new_n39_ = ~x12 & (~x13 | (~x08 & x09 & ~x10 & x14));
  assign new_n40_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & new_n42_ & x09);
  assign new_n42_ = ~x10 & ((x15 & ((x12 & (~x13 | ~x14)) | (x13 & (~x11 | ~x12)))) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x16 | ((~x13 | (x11 & x12)) & (~x12 | (x13 & x14 & x15)))) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (new_n48_ | ~x17) & (~new_n47_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n47_ = x11 & x12 & x13;
  assign new_n48_ = (~x13 | (x11 & x12)) & (~x12 | (x13 & x14 & x15 & x16));
  ...
  assign new_n53_ = ~x12 & (~x13 | (~x08 & x09 & ~x10 & x18));
endmodule
