// Benchmark "FAU" written by ABC on Mon Aug 24 16:35:52 2020
...
module FAU ( 
  ...
  assign z6 = (~x08 & ~new_n41_ & ~x10) | (x05 & x08) | (~x09 & x12);
  assign new_n41_ = (new_n42_ | ~x12) & (~x09 | ~x16 | (new_n43_ & x12 & x13));
  assign new_n42_ = (x11 | ~x16) & (~x11 | ~x13 | ~x14 | ~x15 | x16);
  ...
  assign z8 = (x07 & x08 & (x09 | ~x12)) | (~x08 & new_n48_ & x09);
  assign new_n48_ = ~x10 & ((new_n50_ & new_n51_) | (x18 & (~new_n46_ | ~new_n49_)));
