...
module FAU ( 
  ...
  assign z5 = (~x08 & x09 & ~new_n42_ & ~x10) | new_n33_ | (x04 & x08);
  assign new_n42_ = (~x12 | ((x13 | ~x15) & (~x14 | x15 | ~x11 | ~x13))) & (~x15 | (x11 & x14 & (~x01 | x12)));
  assign z6 = (new_n44_ & ~x08) | new_n33_ | (x05 & x08);
  assign new_n44_ = x09 & ~x10 & (new_n45_ | new_n46_);
  assign new_n45_ = x12 & ((~x13 & x16) | (x11 & x13 & x14 & x15 & ~x16));
  assign new_n46_ = x16 & (~x14 | ~x15 | ~x11 | (x01 & ~x12));
  ...
  assign new_n51_ = ~x12 & (~x01 | (x01 & ~x08 & x09 & ~x10 & x17));
