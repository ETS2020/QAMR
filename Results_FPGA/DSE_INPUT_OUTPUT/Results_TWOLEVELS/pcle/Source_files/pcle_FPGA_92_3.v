...
module FAU ( 
  ...
  assign new_n35_ = ~x18 & (x10 | ~x11 | x13 | x08 | ~x09);
  assign new_n36_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (new_n39_ & ~x08) | (x03 & x08) | (x12 & (new_n38_ | x18));
  ...
  assign z8 = (x07 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n54_ & ~x10);
  assign new_n54_ = (x12 | ~x18) & (~new_n44_ | ~x15 | ~x16 | ~x17 | x18);
  assign z0 = 1'b0;
endmodule
