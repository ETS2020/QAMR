...
module FAU ( 
  ...
  assign z6 = new_n49_ | (x05 & x08) | (~x08 & x09 & new_n51_ & ~x10);
  assign new_n49_ = x12 & (~x05 | (new_n50_ & x09 & ~x10 & x11));
  assign new_n50_ = x13 & x14 & x15 & ~x16;
  assign new_n51_ = x16 & (~x11 | ~x12 | ~x13 | ~x14 | ~x15);
  assign z7 = (~new_n53_ & x12) | (x06 & x08) | (~x08 & new_n55_ & x09);
  ...
  assign new_n58_ = (x12 | ~x18) & (~x05 | ((new_n59_ | ~x18) & (~new_n47_ | ~new_n60_)));
