...
module FAU ( 
  ...
  assign new_n43_ = ~x10 & ((x13 & ((x15 & (~x11 | ~x14)) | (x11 & x12 & x14 & ~x15))) | (~x12 & x15));
  assign z6 = (x05 & x08 & (~x12 | x13)) | (new_n45_ & ~x08);
  assign new_n45_ = x09 & ~new_n46_ & ~x10;
  assign new_n46_ = (~x13 | ((~x16 | (x11 & x14 & x15)) & (~x11 | ~x12 | ~x14 | ~x15 | x16))) & (x12 | ~x16);
  assign z7 = ~new_n49_ | (~new_n48_ & x12);
  assign new_n48_ = x13 & (~new_n32_ | ~x14 | ~x15 | ~x16 | x17);
