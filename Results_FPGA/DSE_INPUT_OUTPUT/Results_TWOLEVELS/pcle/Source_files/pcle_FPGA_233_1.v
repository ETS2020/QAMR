...
module FAU ( 
  ...
  assign z1 = (~x06 & x11) | (x00 & x08) | (~x08 & x09 & ~x10 & ~x11);
  ...
  assign new_n38_ = x06 & (x08 | ~x09 | x10 | ~x12 | x13);
  assign new_n39_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (x11 & (new_n43_ | ~x06)) | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n41_ = x09 & ~x10 & x14 & (~new_n42_ | ~x11);
  assign new_n42_ = x12 & x13;
  assign new_n43_ = ~x08 & x09 & ~x10 & x12 & x13 & ~x14;
  assign z5 = (new_n35_ & x04) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (x11 | ~x15) & (~x06 | ((~x15 | (x12 & x13 & x14)) & (~x13 | ~x14 | x15 | ~x11 | ~x12)));
  assign z6 = (new_n35_ & x05) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n47_ = (~x06 | ((~x16 | (new_n42_ & x14 & x15)) & (~new_n42_ | ~x11 | ~x14 | ~x15 | x16))) & (x11 | ~x16);
  assign z7 = (x11 & (new_n49_ | ~x06)) | (x06 & x08) | (~x08 & new_n51_ & x09);
  assign new_n49_ = new_n50_ & new_n42_ & x09 & ~x10;
