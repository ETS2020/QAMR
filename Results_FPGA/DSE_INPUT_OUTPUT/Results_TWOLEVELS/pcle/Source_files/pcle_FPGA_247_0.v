...
module FAU ( 
  ...
  assign z7 = new_n49_ | (~x08 & x09 & ~x10 & ~new_n50_ & x12);
  assign new_n49_ = x06 & (x08 | (x09 & ~x10 & ~x12 & x17));
  assign new_n50_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = ~new_n56_ | (~x08 & x09 & (new_n52_ | new_n54_) & ~x10);
  assign new_n52_ = x12 & ((~x15 & x18) | (new_n53_ & x15 & x16 & x17 & ~x18));
  assign new_n53_ = x11 & x13 & x14;
  assign new_n54_ = x18 & (~new_n55_ | ~x14 | ~x16 | ~x17);
  assign new_n55_ = x11 & x13 & (~x06 | x12);
  assign new_n56_ = ~new_n31_ & (~x07 | ~x08);
endmodule
