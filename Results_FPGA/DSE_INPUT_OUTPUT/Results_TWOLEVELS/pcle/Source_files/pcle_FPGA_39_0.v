...
module FAU ( 
  ...
  assign z3 = new_n37_ | (~x02 & ~x12) | (x02 & x08);
  assign new_n37_ = x09 & ~x10 & ((~x08 & (x11 ? (x12 & ~x13) : x13)) | (~x12 & x13));
  ...
  assign new_n46_ = ~x10 & ((x11 & x13 & x14 & x15 & ~x16) | (x16 & (~x11 | ~x13 | ~x14 | ~x15)));
  assign new_n47_ = ~x08 & x09 & ~x10 & ~x12 & x16;
  assign z7 = (x02 & (new_n51_ | (x06 & x08))) | (x12 & (x08 ? x06 : new_n49_));
  assign new_n49_ = x09 & ~new_n50_ & ~x10;
  assign new_n50_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14);
