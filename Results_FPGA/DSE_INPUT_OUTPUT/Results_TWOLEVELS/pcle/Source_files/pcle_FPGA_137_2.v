...
module FAU ( 
  ...
  assign new_n38_ = x09 & ~x10 & ((x12 & (x11 ^ x13)) | (~x02 & ~x12 & x13));
  assign z4 = (~x12 & (x02 | (new_n40_ & ~x02 & ~x08))) | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n40_ = x09 & ~x10 & x14;
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = new_n43_ | (x04 & x08) | (~x08 & new_n44_ & x09);
  assign new_n43_ = ~x12 & (x02 | (~x02 & ~x08 & x09 & ~x10 & x15));
  assign new_n44_ = ~x10 & ((x15 & (~x11 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = new_n46_ | (x05 & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n46_ = ~x12 & (x02 | (new_n31_ & ~x10 & x16));
