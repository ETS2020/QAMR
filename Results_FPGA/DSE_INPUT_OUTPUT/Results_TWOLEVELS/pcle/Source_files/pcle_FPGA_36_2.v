...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & ((x12 & ((~x13 & x14) | (x11 & x13 & ~x14))) | (~x11 & x14));
  assign z5 = (x11 & (new_n41_ | ~x12)) | (new_n39_ & ~x08) | (x04 & x08);
  assign new_n39_ = x09 & ~x10 & x15 & (~x11 | (~new_n40_ & x12));
  assign new_n40_ = x13 & x14;
  assign new_n41_ = ~x08 & x09 & ~x10 & x13 & x14 & ~x15;
  assign z6 = new_n43_ | (x05 & x08) | (~x08 & x09 & new_n45_ & ~x10);
  assign new_n43_ = x11 & (~x12 | (new_n44_ & ~x08 & x09 & ~x10));
  ...
  assign z8 = new_n50_ | (x07 & x08) | (~x08 & x09 & new_n53_ & ~x10);
  assign new_n50_ = x11 & (~x12 | (new_n51_ & new_n52_));
  assign new_n51_ = ~x08 & x09 & ~x10 & x13;
  assign new_n52_ = x14 & x15 & x16 & x17 & ~x18;
  assign new_n53_ = x18 & (~new_n54_ | ~new_n40_ | ~x11);
  assign new_n54_ = x15 & x17 & (~x12 | x16);
endmodule
