...
module FAU ( 
  ...
  assign new_n46_ = x09 & ~x10 & (x12 ? ~new_n47_ : (x16 & x17));
  assign new_n47_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x14 | ~x15 | x16 | ~x11 | ~x13);
  assign z7 = (new_n49_ & ~x08) | new_n31_ | (x06 & x08);
  assign new_n49_ = x09 & ~x10 & (new_n51_ | (~new_n50_ & x11));
  assign new_n50_ = (~x13 | ~x14 | ~x15 | ~x16 | x17) & (x12 | ~x17);
  ...
  assign new_n56_ = ~x12 & (~x17 | (~x08 & x09 & ~x10 & x18));
endmodule
