...
module FAU ( 
  ...
  assign z6 = (x05 & (x08 | (new_n46_ & x09 & ~x10))) | (~x08 & x09 & new_n47_ & ~x10);
  assign new_n46_ = ~x12 & x16;
  ...
  assign new_n51_ = x13 & x14 & x16 & x11 & (~x05 | x12);
  assign z8 = ~new_n56_ | (~x08 & x09 & (new_n53_ | new_n54_) & ~x10);
  assign new_n53_ = x12 & ((~x15 & x18) | (new_n50_ & x15 & x16 & x17 & ~x18));
  assign new_n54_ = x18 & (~new_n55_ | ~x14 | ~x16 | ~x17);
  assign new_n55_ = x11 & x13 & (~x05 | x12);
