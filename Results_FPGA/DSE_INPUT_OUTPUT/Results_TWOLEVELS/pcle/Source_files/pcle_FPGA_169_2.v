...
module FAU ( 
  ...
  assign new_n37_ = x17 & (x08 | ~x09 | x10 | ~x11 | x13);
  ...
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x15 | (x12 & (~x17 | (x11 & x13 & x14)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15 | ~x17);
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x16 | (x12 & (~x17 | (new_n47_ & x11 & x13)))) & (~x11 | ~x12 | ~x13 | ~new_n47_ | x16 | ~x17);
  assign new_n47_ = x14 & x15;
  assign z7 = (new_n49_ & ~x08) | new_n33_ | (x06 & x08);
  assign new_n49_ = x09 & ~x10 & (x12 ? ~new_n50_ : x17);
  assign new_n50_ = x11 & (~x11 | (x13 & (~x13 | (x14 & (~x14 | ~x17 | (x15 & (~x15 | x16)))))));
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & new_n52_ & x09);
  assign new_n52_ = ~x10 & (new_n55_ | (x17 & (new_n53_ | (new_n41_ & new_n54_))));
