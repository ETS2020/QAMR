...
module FAU ( 
  ...
  assign z5 = (x04 & x08 & (x09 | ~x11)) | (~x08 & new_n41_ & x09);
  ...
  assign new_n45_ = ~x10 & x16 & (~new_n46_ | ~x13 | ~x11 | ~x12);
  assign new_n46_ = x14 & x15;
  assign z7 = (x06 & x08 & (x09 | ~x11)) | (~x08 & new_n48_ & x09);
  assign new_n48_ = ~x10 & ((x17 & (~new_n38_ | ~x14 | ~x15 | ~x16)) | (new_n38_ & x16 & ~x17 & x14 & x15));
  assign z8 = (x11 & (new_n50_ | ~x09)) | (x07 & x08) | (~x08 & new_n52_ & x09);
  assign new_n50_ = new_n51_ & x12 & x13 & ~x08 & ~x10;
  assign new_n51_ = x14 & x15 & x16 & x17 & ~x18;
  assign new_n52_ = ~x10 & x18 & (~new_n38_ | ~new_n46_ | ~x16 | ~x17);
endmodule
