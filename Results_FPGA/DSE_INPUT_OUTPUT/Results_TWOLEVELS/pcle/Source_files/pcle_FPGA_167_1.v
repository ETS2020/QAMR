...
module FAU ( 
  ...
  assign new_n42_ = ~x12 & (x16 | (~x08 & x09 & ~x10 & x15));
  assign new_n43_ = ~x10 & ((x15 & (~x11 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & new_n45_ & x09);
  assign new_n45_ = ~x10 & x12 & ((x16 & (~new_n46_ | ~x14 | ~x15)) | (new_n46_ & x14 & x15 & ~x16));
  assign new_n46_ = x11 & x13;
  assign z7 = ~new_n48_ | (x16 & (~x12 | (new_n50_ & new_n51_)));
  assign new_n48_ = x08 ? ~x06 : (~x09 | x10 | new_n49_ | ~x17);
  assign new_n49_ = x11 & x13 & x14 & x16 & (~x12 | x15);
  assign new_n50_ = ~x08 & x09 & ~x10 & x11;
  assign new_n51_ = x13 & x14 & x15 & ~x17;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n53_ & ~x10);
  assign new_n53_ = (~x12 | ((~new_n54_ | ~new_n56_) & (new_n55_ | ~x18))) & (x16 | ~x18);
  assign new_n54_ = x11 & x13 & x14;
  assign new_n55_ = x11 & x13 & x14 & x15 & x17;
