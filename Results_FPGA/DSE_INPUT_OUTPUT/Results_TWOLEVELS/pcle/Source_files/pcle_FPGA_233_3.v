...
module FAU ( 
  ...
  assign z6 = (new_n35_ & x05) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & ((~new_n48_ & ~x06) | (~x11 & x16));
  assign new_n48_ = (~x16 | (x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & (x08 | x11)) | (~x08 & new_n50_ & x09);
  assign new_n50_ = ~x10 & ((x17 & (~new_n42_ | ~x14 | ~x15 | ~x16)) | (new_n42_ & x14 & x15 & x16 & ~x17));
  assign z8 = (new_n35_ & x07) | (~x08 & x09 & ~new_n52_ & ~x10);
  assign new_n52_ = (x11 | ~x18) & (x06 | ((~new_n54_ | ~new_n55_) & (new_n53_ | ~x18)));
