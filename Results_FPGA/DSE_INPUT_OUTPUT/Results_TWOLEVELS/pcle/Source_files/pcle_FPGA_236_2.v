...
module FAU ( 
  ...
  assign z5 = (~new_n33_ & (new_n41_ | (x04 & x08))) | (new_n43_ & ~x08);
  assign new_n41_ = new_n42_ & ~x08 & x09 & ~x10 & x11;
  assign new_n42_ = x12 & x13 & x14 & ~x15;
  assign new_n43_ = x09 & ~x10 & x15 & ~new_n44_ & (~x16 | (x16 & x17));
  assign new_n44_ = x11 & x12 & x13 & x14;
  assign z6 = (x05 & ~new_n33_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & (x15 ? ~new_n47_ : (x16 & x17));
  assign new_n47_ = (~x16 | ~x17 | (x11 & x12 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x16);
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n49_ & ~x08);
  assign new_n49_ = x09 & ~x10 & x17 & (~x16 | (x16 & (~x15 | (~new_n44_ & x15))));
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n51_ = (~x17 | ((new_n54_ | ~x18) & (~new_n52_ | ~new_n53_ | ~x16 | x18))) & (x16 | ~x18);
