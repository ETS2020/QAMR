...
module FAU ( 
  ...
  assign new_n41_ = ~x10 & ((x01 & ((x12 & ((~x13 & x14) | (x11 & x13 & ~x14))) | (~x11 & x14))) | (~x12 & x14));
  ...
  assign z6 = ~new_n48_ | (x12 & (~x01 | (new_n50_ & new_n51_)));
  assign new_n48_ = x08 ? ~x05 : (~x09 | ~new_n49_ | x10);
  ...
  assign new_n53_ = new_n50_ & x13 & x14 & x15 & x16 & ~x17;
