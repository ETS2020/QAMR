...
module FAU ( 
  ...
  assign z7 = (~x08 & new_n48_ & x09) | new_n33_ | (x06 & x08);
  assign new_n48_ = ~x10 & ((~new_n49_ & x11) | (x17 & (~new_n50_ | ~x11 | ~x13)));
  assign new_n49_ = x12 & (~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign new_n50_ = x14 & x15 & x16;
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n52_ & ~x10);
  assign new_n52_ = (~x12 | ((x17 | ~x18) & (~new_n53_ | ~new_n54_ | ~x17 | x18))) & (~x17 | new_n55_ | ~x18);
