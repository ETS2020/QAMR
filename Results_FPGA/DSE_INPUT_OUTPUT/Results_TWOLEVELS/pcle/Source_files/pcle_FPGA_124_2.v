...
module FAU ( 
  ...
  assign z1 = (x00 & x08 & (~x12 | x17)) | (new_n33_ & ~x08);
  ...
  assign new_n45_ = x17 & (~new_n46_ | ~x15 | x16 | ~x13 | ~x14);
  assign new_n46_ = ~x08 & x09 & ~x10 & x11;
  assign new_n47_ = x08 ? ~x05 : (~x09 | x10 | new_n48_ | ~x16);
  assign new_n48_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = (new_n50_ & ~x08) | (x12 & ~x17) | (x06 & x08);
  assign new_n50_ = x09 & ~x10 & (x12 ? ~new_n51_ : x17);
  assign new_n51_ = x11 ? (x13 ? (x14 ? (x15 & (~x15 | x16)) : ~x17) : ~x17) : ~x17;
  assign z8 = ~new_n54_ | (x12 & (new_n53_ | ~x17));
  assign new_n53_ = new_n46_ & x13 & x14 & x15 & x16 & ~x18;
