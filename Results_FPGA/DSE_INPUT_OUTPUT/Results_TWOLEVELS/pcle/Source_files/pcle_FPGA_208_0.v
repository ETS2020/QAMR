...
module FAU ( 
  ...
  assign new_n44_ = x11 & ((x15 & (~x12 | ~x13 | ~x14)) | (x12 & x13 & x14 & ~x15));
  assign z6 = new_n46_ | (x05 & x08) | (~x08 & x09 & ~new_n47_ & ~x10);
  assign new_n46_ = ~x11 & (~x04 | (~x10 & x16 & ~x08 & x09));
  assign new_n47_ = (~x16 | (x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x04 & (new_n51_ | (x06 & x08))) | (x11 & (x08 ? x06 : new_n49_));
  assign new_n49_ = x09 & ~new_n50_ & ~x10;
  assign new_n50_ = (~x12 | ~x13 | ~x14 | ~x15 | ~x16 | x17) & (~x17 | (x12 & x13 & x14 & x15 & x16));
  assign new_n51_ = ~x08 & x09 & ~x10 & ~x11 & x17;
  assign z8 = (~x08 & x09 & ~new_n53_ & ~x10) | new_n31_ | (x07 & x08);
  assign new_n53_ = (~x11 | ((x16 | ~x18) & (~new_n54_ | ~new_n55_))) & (new_n56_ | ~x18);
