...
module FAU ( 
  ...
  assign z5 = (x04 & x08 & (~x09 | x11)) | (~x08 & x09 & ~x10 & ~new_n39_ & x11);
  ...
  assign new_n43_ = (~x17 | (~new_n45_ & x12 & x16)) & (~new_n44_ | ~x15 | ~x16 | x17);
  assign new_n44_ = x12 & x13 & x14;
  assign new_n45_ = x11 & (~x13 | ~x14 | ~x15);
  assign z8 = (x07 & x08) | (x09 & (~x11 | (~x08 & ~new_n47_ & ~x10)));
  assign new_n47_ = (~new_n44_ | ~new_n49_ | ~x17 | x18) & (~x18 | (~new_n45_ & new_n48_));
  assign new_n48_ = x12 & x16 & x17;
