...
module FAU ( 
  ...
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = x12 ? ((~x16 | (new_n47_ & x14 & x15)) & (~new_n47_ | ~x14 | ~x15 | x16)) : (~x16 | ~x18);
  assign new_n47_ = x11 & x13;
  assign z7 = new_n51_ | (x06 & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (~x17 | (new_n47_ & x14 & x15 & x16)) & (~new_n50_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n50_ = x11 & x12 & x13;
  assign new_n51_ = ~x12 & (~x18 | (~x08 & x09 & ~x10 & x17));
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n53_ & ~x10);
  assign new_n53_ = (~x11 | ((x12 | ~x18) & (~new_n55_ | ~new_n54_ | ~x12))) & (~x18 | (new_n56_ & new_n54_ & x11));
  assign new_n54_ = x13 & x14;
  assign new_n55_ = x15 & x16 & x17 & ~x18;
  assign new_n56_ = x15 & x16 & x17;
endmodule
