...
module FAU ( 
  ...
  assign new_n43_ = (~x12 | ((x13 | ~x16) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (~x16 | (x11 & x12 & x14 & x15));
  assign z7 = (new_n45_ & ~x08) | new_n33_ | (x06 & x08);
  assign new_n45_ = x09 & ~x10 & (new_n47_ | (~new_n46_ & x11));
  assign new_n46_ = x12 & (~x13 | ~x14 | ~x15 | ~x16 | x17);
  ...
  assign new_n52_ = ~x12 & (~x17 | (~x08 & x09 & ~x10 & x18));
endmodule
