...
module FAU ( 
  ...
  assign new_n44_ = (~x12 | ((~x15 | (x11 & x13 & x14)) & (~x14 | x15 | ~x11 | ~x13))) & (x07 | x12 | ~x15);
  assign z6 = (x05 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x12 | ((~x16 | (new_n47_ & x14 & x15)) & (~new_n47_ | ~x14 | ~x15 | x16))) & (x07 | x12 | ~x16);
  ...
  assign new_n51_ = ~x12 & (x07 | (~x08 & x09 & ~x10 & x17));
