...
module FAU ( 
  ...
  assign new_n35_ = x09 & ~x10 & ((x13 & (~x11 | (~x12 & ~x16))) | (x11 & x12 & ~x13 & ~x16));
  ...
  assign new_n39_ = (~x15 | (x11 & (x16 | (x12 & x13 & x14)))) & (~x14 | x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z6 = new_n32_ | (x05 & x08) | (~x08 & x09 & ~new_n41_ & ~x10);
