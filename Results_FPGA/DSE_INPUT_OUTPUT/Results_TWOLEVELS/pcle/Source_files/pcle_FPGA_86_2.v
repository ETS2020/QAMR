...
module FAU ( 
  ...
  assign new_n42_ = (~x12 | ((~x15 | (x11 & x13 & x14)) & (~x11 | ~x13 | ~x14 | x15))) & (x04 | x12 | ~x15);
  assign z6 = (~x04 & (new_n46_ | (x05 & x08))) | (x12 & (x08 ? x05 : new_n44_));
  ...
  assign new_n48_ = (~x17 | ((~x12 | (new_n49_ & x13)) & x11 & x16)) & (~x11 | ~x12 | ~x13 | ~new_n49_ | ~x16 | x17);
