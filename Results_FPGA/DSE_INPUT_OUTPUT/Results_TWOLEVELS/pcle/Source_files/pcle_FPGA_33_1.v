...
module FAU ( 
  ...
  assign z7 = (x11 & (new_n46_ | ~x09)) | (x06 & x08) | (~x08 & new_n48_ & x09);
  assign new_n46_ = new_n47_ & x14 & x15 & x16 & ~x17;
  assign new_n47_ = x12 & x13 & ~x08 & ~x10;
  assign new_n48_ = ~x10 & x17 & (~new_n38_ | ~x14 | ~x15 | ~x16);
  assign z8 = (x11 & (new_n50_ | ~x09)) | (x07 & x08) | (~x08 & new_n51_ & x09);
  assign new_n50_ = new_n47_ & x14 & x15 & x16 & x17 & ~x18;
  assign new_n51_ = ~x10 & x18 & (~new_n38_ | ~new_n52_);
