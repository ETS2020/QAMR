...
module FAU ( 
  ...
  assign z0 = (~x12 & ~x14) | (new_n32_ & new_n31_ & ~x10 & x11 & x12);
  ...
  assign new_n40_ = x09 & ~x10 & ((x11 & (x14 ? ~x12 : x13)) | (x14 & (~x11 | ~x13)));
  assign z5 = new_n42_ | (~x08 & new_n43_ & x09) | (x04 & x08);
  assign new_n42_ = ~x12 & (~x14 | (new_n31_ & ~x10 & x15));
  assign new_n43_ = ~x10 & ((x15 & (~x11 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = new_n45_ | (x05 & x08) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n45_ = ~x12 & (~x14 | (new_n31_ & ~x10 & x16));
  assign new_n46_ = (~x16 | (new_n47_ & x14 & x15)) & (~new_n48_ | ~x14 | ~x15 | x16);
  assign new_n47_ = x11 & x13;
  assign new_n48_ = x11 & x12 & x13;
  assign z7 = new_n50_ | (x06 & x08) | (~x08 & x09 & ~new_n51_ & ~x10);
  assign new_n50_ = ~x12 & (~x14 | (new_n31_ & ~x10 & x17));
  assign new_n51_ = (~x17 | (new_n47_ & x14 & x15 & x16)) & (~new_n48_ | ~x16 | x17 | ~x14 | ~x15);
  assign z8 = new_n53_ | (x07 & x08) | (~x08 & x09 & ~new_n54_ & ~x10);
  assign new_n53_ = ~x12 & (~x14 | (new_n31_ & ~x10 & x18));
