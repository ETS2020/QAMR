...
module FAU ( 
  ...
  assign z4 = (x03 & x08 & (x12 | ~x17)) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & (x12 ? ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14)) : (x14 & ~x17));
  assign z5 = new_n41_ | (~x08 & new_n42_ & x09) | (x04 & x08);
  assign new_n41_ = ~x12 & (x17 | (~x08 & x09 & ~x10 & x15 & ~x17));
  assign new_n42_ = ~x10 & ((x15 & (~x11 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (new_n44_ & ~x08) | (~x12 & x17) | (x05 & x08);
  assign new_n44_ = x09 & ~x10 & (new_n45_ | new_n46_);
  assign new_n45_ = x12 & ((~x13 & x16) | (x14 & x15 & ~x16 & x11 & x13));
  assign new_n46_ = x16 & (~x11 | ~x14 | ~x15 | (~x12 & ~x17));
  assign z7 = (~x08 & new_n48_ & x09) | (x06 & x08) | (~x12 & x17);
  assign new_n48_ = ~x10 & (new_n49_ | (new_n50_ & x11 & x12 & x13));
  assign new_n49_ = x17 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign new_n50_ = x14 & x15 & x16 & ~x17;
  assign z8 = (~x08 & new_n54_ & x09) | (x07 & x08) | (~new_n52_ & x17);
  assign new_n52_ = x12 & (~new_n53_ | x08 | ~x09 | x10 | ~x11);
  assign new_n53_ = x13 & x14 & x15 & x16 & ~x18;
  assign new_n54_ = ~x10 & ~new_n55_ & x18;
  assign new_n55_ = x15 & x16 & x17 & x11 & x13 & x14;
endmodule
