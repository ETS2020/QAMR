...
module FAU ( 
  ...
  assign new_n37_ = ~x12 & (~x07 | (~x08 & x09 & ~x10 & x13));
  assign new_n38_ = x09 & ~x10 & (x11 ? (x12 & ~x13) : x13);
  assign z4 = new_n40_ | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n40_ = ~x12 & (~x07 | (~x08 & x09 & ~x10 & x14));
  ...
  assign z6 = (x05 & ~new_n33_ & x08) | (new_n45_ & ~x08);
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x12) | (x07 & ~x12 & x16));
  assign new_n46_ = (~x16 | (x11 & x13 & x14 & x15)) & (~x11 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n48_ & ~x08);
  assign new_n48_ = x09 & ~x10 & ((~new_n49_ & x12) | (x07 & ~x12 & x17));
  assign new_n49_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & (x08 | (new_n53_ & x09 & ~x10))) | (~x08 & x09 & new_n51_ & ~x10);
  assign new_n51_ = x12 & ((x18 & (~new_n52_ | ~x15 | ~x16 | ~x17)) | (new_n52_ & x15 & x16 & x17 & ~x18));
