...
module FAU ( 
  ...
  assign z7 = (~x08 & ~new_n43_ & x09) | (x06 & x08) | (x10 & x12);
  assign new_n43_ = (new_n44_ | ~x12) & (x10 | ~x17 | (new_n45_ & x12 & x13));
  assign new_n44_ = (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17) & (x11 | ~x17);
  assign new_n45_ = x14 & x15 & x16;
  assign z8 = (x07 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n47_ & ~x10);
