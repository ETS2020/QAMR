...
module FAU ( 
  ...
  assign z6 = (new_n47_ & x05) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = x11 ? ((~x16 | (new_n46_ & x14 & x15)) & (~new_n46_ | ~x14 | ~x15 | x16)) : (~x16 | x18);
  assign new_n46_ = x12 & x13;
  assign new_n47_ = x08 & (x11 | ~x18);
  assign z7 = (new_n47_ & x06) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (~x17 | ((x16 | (x18 & (~x11 | ~x18))) & (x11 | x18) & (~x11 | (new_n46_ & new_n50_)))) & (~new_n46_ | ~x11 | ~new_n50_ | ~x16 | x17);
  assign new_n50_ = x14 & x15;
  assign z8 = (new_n47_ & x07) | (new_n52_ & ~x08);
  assign new_n52_ = x09 & ~x10 & x11 & (new_n54_ | (~new_n53_ & x17));
  assign new_n53_ = (x16 | ~x18) & (~x15 | ~x16 | x18 | ~x12 | ~x13 | ~x14);
