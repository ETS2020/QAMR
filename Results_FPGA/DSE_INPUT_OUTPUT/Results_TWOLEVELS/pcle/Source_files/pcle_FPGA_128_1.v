...
module FAU ( 
  ...
  assign z1 = (x00 & x08 & (x07 | ~x12)) | (new_n34_ & ~x08);
  assign new_n34_ = x09 & ~x10 & ~x11 & (~x12 | (x07 & x12));
  assign z2 = (new_n36_ & ~x08) | (~x07 & x12) | (x01 & x08);
  assign new_n36_ = x09 & ~x10 & ((x07 & ~x11 & x12) | (x11 & ~x12));
  assign z3 = (x02 & x08 & (x07 | ~x12)) | (new_n38_ & ~x08);
  assign new_n38_ = x09 & ~x10 & ((x07 & (x11 ? (x12 & ~x13) : x13)) | (~x12 & x13));
  assign z4 = (x12 & (new_n40_ | ~x07)) | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n40_ = x11 & x13 & ~x14 & ~x08 & x09 & ~x10;
  assign new_n41_ = x09 & ~x10 & x14 & (~x11 | ~x12 | ~x13);
  assign z5 = (x04 & x08 & (x07 | ~x12)) | (new_n43_ & ~x08);
  assign new_n43_ = x09 & ~new_n44_ & ~x10;
  assign new_n44_ = (~x07 | ((~x15 | (x11 & x13 & x14)) & (~x13 | ~x14 | x15 | ~x11 | ~x12))) & (x12 | ~x15);
  assign z6 = new_n46_ | (~x08 & x09 & new_n49_ & ~x10) | (x05 & x08);
  assign new_n46_ = x12 & (~x07 | (new_n48_ & new_n47_ & x15 & ~x16));
  ...
  assign z8 = (x07 & (x08 | (x09 & ~new_n55_ & ~x10))) | (~x08 & x09 & new_n58_ & ~x10);
