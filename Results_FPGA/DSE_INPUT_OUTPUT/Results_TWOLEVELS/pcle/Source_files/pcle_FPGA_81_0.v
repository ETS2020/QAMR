...
module FAU ( 
  ...
  assign z2 = (x01 & x08) | (~x10 & (~x12 | (~x08 & x09 & ~x11 & x12)));
  ...
  assign z6 = (x05 & x08) | (~x10 & (~x12 | (~x08 & ~new_n42_ & x09)));
  assign new_n42_ = (~x16 | (x14 & x15 & x11 & (~x12 | x13))) & (~x11 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & x08) | (~x10 & (~x12 | (~x08 & ~new_n44_ & x09)));
  assign new_n44_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x15 | ~x16 | x17 | ~x11 | ~x13 | ~x14);
  assign z8 = (~x10 & (~x12 | (new_n46_ & ~x08))) | (x07 & x08);
