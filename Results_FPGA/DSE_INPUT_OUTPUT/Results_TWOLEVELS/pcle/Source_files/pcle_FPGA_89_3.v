...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n35_, new_n37_, new_n38_, new_n40_, new_n41_,
    new_n42_, new_n44_, new_n45_, new_n47_;
  ...
  assign new_n35_ = x09 & ~x10 & ((x13 & (~x12 | (~x11 & ~x17))) | (~x13 & ~x17 & x11 & x12));
  ...
  assign new_n40_ = ~x17 & (~new_n41_ | x08 | ~x09 | x10);
  ...
  assign new_n47_ = (x12 | ~x17) & (~x11 | ~x12 | ~x13 | ~new_n45_ | ~x16 | x17);
