...
module FAU ( 
  ...
  assign new_n41_ = ~x11 & (~x14 | (new_n31_ & ~x10 & x15));
  assign new_n42_ = ~x10 & ((x15 & (~x12 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (x05 & x08 & (x11 | x14)) | (new_n44_ & ~x08);
  assign new_n44_ = x09 & ~new_n45_ & ~x10;
  assign new_n45_ = (~x11 | ((~x12 | ~x13 | ~x14 | ~x15 | x16) & (x14 | ~x16))) & (~x14 | ~x16 | (x11 & x12 & x13 & x15));
  assign z7 = new_n47_ | (x06 & x08) | (~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n47_ = ~x11 & (~x14 | (new_n31_ & ~x10 & x17));
  assign new_n48_ = (~x14 | ((x15 | ~x17) & (~x15 | ~x16 | x17 | ~new_n49_ | ~x11))) & (~x17 | (new_n49_ & x14 & x16));
  assign new_n49_ = x12 & x13;
  assign z8 = new_n51_ | (x07 & x08) | (~x08 & x09 & ~new_n52_ & ~x10);
  assign new_n51_ = ~x11 & (~x14 | (new_n31_ & ~x10 & x18));
  assign new_n52_ = (~x14 | ((x15 | ~x18) & (~new_n53_ | ~new_n54_))) & (new_n55_ | ~x18);
  assign new_n53_ = x11 & x12 & x13;
  assign new_n54_ = x17 & ~x18 & x15 & x16;
  assign new_n55_ = x14 & x16 & x17 & x12 & x13;
endmodule
