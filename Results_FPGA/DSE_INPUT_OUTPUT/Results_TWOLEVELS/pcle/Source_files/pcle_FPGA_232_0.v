...
module FAU ( 
  ...
  assign z0 = (~x06 & ~x11) | (new_n32_ & new_n31_ & ~x10 & x11 & x12);
  ...
  assign new_n46_ = ~x11 & (~x06 | (new_n31_ & ~x10 & x16));
  assign new_n47_ = (~x16 | (x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = new_n49_ | (~x08 & x09 & ~x10 & ~new_n50_ & x11);
  assign new_n49_ = x06 & (x08 | (x09 & ~x10 & ~x11 & x17));
