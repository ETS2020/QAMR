...
module FAU ( 
  ...
  assign new_n41_ = ~x10 & (new_n43_ | (x09 & ~new_n42_ & x16));
  assign new_n42_ = x11 & x12 & x13 & x14;
  assign new_n43_ = x12 & ((~x15 & x16) | (x14 & x15 & ~x16 & x11 & x13));
  assign z7 = (~x08 & ~new_n45_ & ~x10) | (x06 & x08) | (~x09 & x12);
  assign new_n45_ = (~new_n46_ | ~new_n48_) & (~x17 | (~new_n47_ & (new_n42_ | ~x09)));
  ...
  assign new_n50_ = (~x18 | (new_n46_ & new_n52_)) & (~new_n42_ | ~new_n51_ | ~x17 | x18);
