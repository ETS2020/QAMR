...
module FAU ( 
  ...
  assign new_n42_ = ~x10 & ((x12 & ((~x13 & x15) | (x14 & ~x15 & x11 & x13))) | (x13 & x15 & (~x11 | ~x12 | ~x14)));
  assign z6 = new_n31_ | (x05 & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x12 | ((x13 | ~x16) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (~x16 | (x11 & x12 & x15 & (~x13 | x14)));
  assign z7 = (new_n46_ & ~x08) | new_n31_ | (x06 & x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n48_ & x17) | (~new_n47_ & x12));
  assign new_n47_ = (x13 | ~x17) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign new_n48_ = x11 & x12 & x15 & x16 & (~x13 | x14);
  ...
  assign new_n53_ = ~x12 & (~x13 | (~x10 & x18 & ~x08 & x09));
endmodule
