...
module FAU ( 
  ...
  assign new_n45_ = (~x11 | ((x12 | ~x16) & (~x12 | ~x13 | ~x14 | ~x15 | x16))) & (~x16 | (x11 & x13 & x14 & x15));
  ...
  assign new_n52_ = ~x10 & ((new_n55_ & new_n56_) | ((new_n53_ | new_n54_) & x18));
  assign new_n53_ = x16 & (~x11 | ~x12 | ~x13);
  assign new_n54_ = x12 & (~x14 | ~x15 | ~x16 | ~x17);
