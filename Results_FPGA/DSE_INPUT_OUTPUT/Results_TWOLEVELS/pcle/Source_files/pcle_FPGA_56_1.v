...
module FAU ( 
  ...
  assign new_n42_ = ~x10 & ((x12 & ((x11 & x13) ? (x14 & ~x15) : x15)) | (~x14 & x15));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x12 | ((~x16 | (x11 & x13 & x15)) & (~x11 | ~x13 | ~x14 | ~x15 | x16))) & (x14 | ~x16);
  assign z7 = new_n46_ | (new_n49_ & ~x08) | (x06 & x08);
  assign new_n46_ = x14 & (~x12 | (new_n48_ & new_n47_ & x16 & ~x17));
  assign new_n47_ = x13 & x15;
  assign new_n48_ = ~x08 & x09 & ~x10 & x11;
  assign new_n49_ = x09 & ~x10 & x17 & (~new_n50_ | ~x11 | ~x13);
  assign new_n50_ = x14 & x16 & (~x12 | x15);
  assign z8 = (~new_n52_ & x14) | (x07 & x08) | (~x08 & new_n53_ & x09);
  assign new_n52_ = x12 & (~new_n48_ | ~new_n47_ | ~x16 | ~x17 | x18);
  assign new_n53_ = ~x10 & x18 & (~new_n54_ | ~x11 | ~x13 | ~x14);
  assign new_n54_ = x16 & x17 & (~x12 | x15);
endmodule
