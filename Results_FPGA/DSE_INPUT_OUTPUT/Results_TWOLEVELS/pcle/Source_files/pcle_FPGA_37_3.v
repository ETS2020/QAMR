...
module FAU ( 
  ...
  assign new_n45_ = ~x18 & (~new_n46_ | x08 | ~x09 | x10 | ~x12);
  assign new_n46_ = x13 & x14 & x15 & ~x16;
  assign new_n47_ = x08 ? ~x05 : (~x09 | x10 | new_n48_ | ~x16);
  assign new_n48_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = (x06 & ~z0 & x08) | (~x08 & new_n50_ & x09);
  assign new_n50_ = ~x10 & ((x17 & (new_n51_ | ~x11)) | (new_n43_ & new_n52_));
  assign new_n51_ = ~x18 & (~x12 | ~x13 | ~x14 | ~x15 | ~x16);
  assign new_n52_ = x15 & x16 & ~x17 & ~x18;
  assign z8 = (~x08 & new_n54_ & x09) | z0 | (x07 & x08);
  assign new_n54_ = ~x10 & (x18 | (new_n55_ & x11 & x12 & x13));
