...
module FAU ( 
  ...
  assign z2 = (new_n35_ & ~x08) | (~x05 & ~x12) | (x01 & x08);
  assign new_n35_ = x09 & ~x10 & (x11 ^ x12);
  assign z3 = (new_n37_ & ~x08) | (x02 & x08 & (x05 | x12));
  ...
  assign z6 = (x05 & (x08 | (new_n47_ & x09 & ~x10))) | (~x08 & x09 & new_n45_ & ~x10);
  assign new_n45_ = x12 & ((x16 & (~new_n46_ | ~x14 | ~x15)) | (new_n46_ & x14 & x15 & ~x16));
  ...
  assign new_n51_ = ~x12 & (~x05 | (~x08 & x09 & ~x10 & x17));
  ...
  assign new_n56_ = ~x12 & (~x05 | (~x08 & x09 & ~x10 & x18));
endmodule
