...
module FAU ( 
  ...
  assign z4 = (new_n38_ & ~x08) | (x10 & x12) | (x03 & x08);
  assign new_n38_ = x09 & ((x14 & ((~x11 & x12) | (~x10 & (~x12 | ~x13)))) | (x13 & ~x14 & x11 & x12));
  assign z5 = (~x08 & ~new_n40_ & x09) | (x10 & x12) | (x04 & x08);
  assign new_n40_ = (~x15 | ((x10 | (x12 & x13)) & (~x12 | (x11 & x14)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15);
  assign z6 = (new_n42_ & ~x08) | (x10 & x12) | (x05 & x08);
  assign new_n42_ = x09 & ((~new_n43_ & x16) | (new_n44_ & x14 & x15 & ~x16));
  assign new_n43_ = (x10 | (x12 & x13)) & (~x12 | (x11 & x14 & x15));
  assign new_n44_ = x11 & x12 & x13;
  assign z7 = (x06 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x17 | (new_n44_ & x14 & x15 & x16)) & (~new_n44_ | ~x14 | ~x15 | ~x16 | x17);
  ...
  assign new_n50_ = new_n51_ & x13 & x14 & x11 & x12;
