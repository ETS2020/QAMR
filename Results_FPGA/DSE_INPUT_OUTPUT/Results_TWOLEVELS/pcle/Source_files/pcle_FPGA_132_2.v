...
module FAU ( 
  ...
  assign new_n43_ = (new_n45_ | ~x17) & (~new_n44_ | ~x15 | ~x16 | x17);
  assign new_n44_ = x11 & x13 & x14;
  assign new_n45_ = x11 & x13 & (~x12 | x14) & x15 & x16;
  assign z8 = (x07 & x08) | (x09 & (~x12 | (~x08 & ~new_n47_ & ~x10)));
  assign new_n47_ = (~x18 | (new_n48_ & x15 & x16 & x17)) & (~new_n44_ | ~x15 | ~x16 | ~x17 | x18);
  assign new_n48_ = x11 & x13 & (~x12 | x14);
endmodule
