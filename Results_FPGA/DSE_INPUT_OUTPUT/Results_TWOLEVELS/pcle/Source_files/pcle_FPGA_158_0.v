// Benchmark "FAU" written by ABC on Mon Aug 24 16:35:11 2020
...
module FAU ( 
  ...
  assign z1 = (~x08 & ~x10 & ~x11 & (~x12 | (x09 & x12))) | (x00 & x08) | (~x09 & ~x12);
  ...
  assign z6 = (x05 & x08 & (x09 | x12)) | (~x08 & x09 & ~new_n41_ & ~x10);
  assign new_n41_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = new_n46_ | (x06 & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x17 | (new_n45_ & x14 & x15 & x16)) & (~new_n44_ | ~x16 | x17 | ~x14 | ~x15);
  assign new_n44_ = x11 & x12 & x13;
  assign new_n45_ = x11 & x13;
  assign new_n46_ = ~x12 & (~x09 | (~x08 & ~x10 & x17));
  ...
  assign new_n51_ = ~x12 & (~x09 | (~x08 & ~x10 & x18));
endmodule
