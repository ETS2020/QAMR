...
module FAU ( 
  ...
  assign z5 = new_n33_ | (x04 & x08) | (~x08 & new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x12 & ((~x13 & x15) | (x11 & x13 & x14 & ~x15))) | (x15 & (~x11 | ~x12 | ~x14)));
  assign z6 = (x05 & ~new_n33_ & x08) | (new_n43_ & ~x08);
  assign new_n43_ = x09 & ~x10 & (x12 ? ~new_n44_ : (x16 & x18));
  assign new_n44_ = (~x16 | (x11 & x13 & x14 & x15)) & (~x11 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & (x12 ? ~new_n47_ : (x17 & x18));
  assign new_n47_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (~x17 | ((~new_n50_ | ~new_n51_) & (x12 | ~x18))) & (new_n52_ | ~x18);
