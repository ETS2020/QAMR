...
module FAU ( 
  ...
  assign new_n38_ = ~x12 & (~x06 | (~x08 & x09 & ~x10 & x13));
  assign new_n39_ = x09 & ~x10 & (x11 ? (x12 & ~x13) : x13);
  assign z4 = (x03 & ~new_n31_ & x08) | (~x08 & new_n41_ & x09);
  assign new_n41_ = ~x10 & ((x12 & ((x14 & (~x11 | ~x13)) | (x11 & x13 & ~x14))) | (x06 & ~x12 & x14));
  assign z5 = (~x08 & x09 & ~new_n43_ & ~x10) | new_n31_ | (x04 & x08);
  assign new_n43_ = (~x12 | ((x13 | ~x15) & (~x14 | x15 | ~x11 | ~x13))) & (~x15 | (x11 & x14 & (~x06 | x12)));
  assign z6 = (new_n45_ & ~x08) | new_n31_ | (x05 & x08);
  assign new_n45_ = x09 & ~x10 & (new_n46_ | new_n47_);
  assign new_n46_ = x12 & ((~x13 & x16) | (x11 & x13 & x14 & x15 & ~x16));
  assign new_n47_ = x16 & (~x14 | ~x15 | ~x11 | (x06 & ~x12));
  assign z7 = (x06 & (new_n52_ | x08)) | (~x06 & ~x12) | (~x08 & new_n49_ & x09);
  assign new_n49_ = ~x10 & (new_n50_ | (new_n51_ & x11 & x12 & x13));
  assign new_n50_ = x17 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
  assign new_n51_ = x14 & x15 & x16 & ~x17;
  assign new_n52_ = ~x12 & x17 & x09 & ~x10;
