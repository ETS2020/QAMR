...
module FAU ( 
  ...
  assign z5 = (~x12 & (~x04 | (new_n44_ & x09))) | (x04 & x08) | (~x08 & new_n45_ & x09);
  assign new_n44_ = ~x10 & x15;
  assign new_n45_ = ~x10 & ((x15 & (~x11 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (x04 & (new_n49_ | (x05 & x08))) | (x12 & (x08 ? x05 : new_n47_));
  assign new_n47_ = new_n48_ & x09;
  assign new_n48_ = ~x10 & ((x11 & x13 & x14 & x15 & ~x16) | (x16 & (~x11 | ~x13 | ~x14 | ~x15)));
  assign new_n49_ = ~x08 & x09 & ~x10 & ~x12 & x16;
  assign z7 = (~x08 & x09 & ~new_n51_ & ~x10) | new_n31_ | (x06 & x08);
  assign new_n51_ = (~x12 | ((x15 | ~x17) & (~new_n52_ | ~x15 | ~x16 | x17))) & (new_n53_ | ~x17);
  assign new_n52_ = x11 & x13 & x14;
  assign new_n53_ = x13 & x14 & x16 & x11 & (~x04 | x12);
  assign z8 = ~new_n58_ | (~x08 & x09 & (new_n55_ | new_n56_) & ~x10);
  assign new_n55_ = x12 & ((~x15 & x18) | (new_n52_ & x15 & x16 & x17 & ~x18));
  assign new_n56_ = x18 & (~new_n57_ | ~x14 | ~x16 | ~x17);
  assign new_n57_ = x11 & x13 & (~x04 | x12);
  assign new_n58_ = ~new_n31_ & (~x07 | ~x08);
endmodule
