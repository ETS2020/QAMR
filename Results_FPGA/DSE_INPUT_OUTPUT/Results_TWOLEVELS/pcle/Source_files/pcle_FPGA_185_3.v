...
module FAU ( 
  ...
  assign z4 = (~new_n40_ & x12) | (new_n38_ & ~x08) | (x03 & x08);
  assign new_n38_ = x09 & ~x10 & ~new_n39_ & x14;
  assign new_n39_ = x11 & x12 & x13;
  assign new_n40_ = ~x10 & (x08 | ~x09 | ~x11 | ~x13 | x14);
  assign z5 = (~x08 & ~new_n42_ & x09) | (x10 & x12) | (x04 & x08);
  assign new_n42_ = (~x12 | ((x14 | ~x15) & (~x14 | x15 | ~x11 | ~x13))) & (x10 | ~x15 | (x11 & x12 & x13));
  assign z6 = (x05 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x17 | (new_n39_ & x14 & x15 & x16)) & (~new_n39_ | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & x08 & (~x10 | ~x12)) | (~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~x18 | (new_n39_ & new_n50_)) & (~new_n51_ | ~new_n49_ | ~x17 | x18);
