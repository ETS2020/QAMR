...
module FAU ( 
  ...
  assign new_n35_ = ~x15 & (x08 | ~x09 | x10 | ~x12 | x13);
  assign new_n36_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (x03 & ~z0 & x08) | (~x08 & new_n38_ & x09);
  assign new_n38_ = ~x10 & ((x14 & (~x11 | (~x15 & (~x12 | ~x13)))) | (x11 & x12 & x13 & ~x14 & ~x15));
  assign z5 = (x04 & ~z0 & x08) | (~x08 & new_n40_ & x09);
  assign new_n40_ = ~x10 & ((~x11 & x15) | (x11 & x12 & x13 & x14 & ~x15));
