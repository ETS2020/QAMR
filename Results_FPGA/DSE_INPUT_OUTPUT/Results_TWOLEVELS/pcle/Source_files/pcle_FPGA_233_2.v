...
module FAU ( 
  ...
  wire new_n31_, new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n41_,
  ...
  assign z1 = (~x11 & (x06 | (~x08 & x09 & ~x10))) | (x00 & x08);
  ...
  assign new_n37_ = ~x11 & (x06 | (~x08 & x09 & ~x10 & x13));
  assign new_n38_ = x09 & ~x10 & ((~x12 & x13) | (x11 & x12 & ~x13));
  assign z4 = new_n40_ | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n40_ = ~x11 & (x06 | (~x08 & x09 & ~x10 & x14));
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x12 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x11 | ((~x12 | ~x13 | ~x14 | x15) & (~x15 | (x12 & x13 & x14)))) & (x06 | x11 | ~x15);
  assign z6 = (x05 & ~new_n34_ & x08) | (new_n45_ & ~x08);
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x11) | (~x06 & ~x11 & x16));
  assign new_n46_ = (~x16 | (x12 & x13 & x14 & x15)) & (~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & (x08 | ~x11)) | (~x08 & x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~x17 | ((new_n49_ | ~x11) & x13 & x16 & x11 & x12)) & (~x11 | ~x12 | ~x13 | ~new_n49_ | ~x16 | x17);
