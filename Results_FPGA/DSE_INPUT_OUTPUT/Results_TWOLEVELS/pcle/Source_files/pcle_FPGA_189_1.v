...
module FAU ( 
  ...
  assign z3 = (new_n36_ & ~x08) | (~x09 & x11) | (x02 & x08);
  ...
  assign z5 = (~x08 & ~new_n40_ & ~x10) | (x04 & x08) | (~x09 & x11);
  assign new_n40_ = (~x15 | ((~x09 | (x11 & x13)) & (~x11 | (x12 & x14)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15);
  assign z6 = (x05 & x08 & (x09 | ~x11)) | (~x08 & x09 & ~new_n42_ & ~x10);
  assign new_n42_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x14 | ~x15 | x16 | ~x11 | ~x12 | ~x13);
  assign z7 = (x06 & x08 & (x09 | ~x11)) | (~x08 & new_n44_ & x09);
  assign new_n44_ = ~x10 & ((x17 & (~new_n45_ | ~x14 | ~x15 | ~x16)) | (new_n45_ & x16 & ~x17 & x14 & x15));
  assign new_n45_ = x11 & x12 & x13;
  assign z8 = (x07 & x08 & (x09 | ~x11)) | (~x08 & x09 & ~new_n47_ & ~x10);
