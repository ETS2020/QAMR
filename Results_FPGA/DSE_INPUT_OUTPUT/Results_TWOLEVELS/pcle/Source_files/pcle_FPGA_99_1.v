...
module FAU ( 
  ...
  assign new_n40_ = ~x12 & (x16 | (~x08 & x09 & ~x10 & x14));
  assign new_n41_ = x09 & ~x10 & ((x14 & (~x11 | ~x13)) | (x13 & ~x14 & x11 & x12));
  assign z5 = (x04 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = x12 ? ((~x15 | (x11 & x13 & x14)) & (~x11 | ~x13 | ~x14 | x15)) : (~x15 | x16);
  assign z6 = (x05 & ~new_n34_ & x08) | (~x08 & new_n45_ & x09);
  assign new_n45_ = ~x10 & x12 & ((x16 & (~new_n46_ | ~x14 | ~x15)) | (new_n46_ & x14 & x15 & ~x16));
  assign new_n46_ = x11 & x13;
  assign z7 = ~new_n48_ | (x16 & (~x12 | (new_n32_ & new_n50_)));
  assign new_n48_ = x08 ? ~x06 : (~x09 | x10 | new_n49_ | ~x17);
  assign new_n49_ = x11 & x13 & x15 & x16 & (~x12 | x14);
  assign new_n50_ = x13 & x14 & x15 & ~x17;
  assign z8 = (x07 & ~new_n34_ & x08) | (~x08 & new_n52_ & x09);
  assign new_n52_ = ~x10 & (new_n56_ | (x12 & (new_n54_ | (new_n53_ & new_n55_))));
  assign new_n53_ = x11 & x13 & x14;
  assign new_n54_ = x18 & (~x11 | ~x13 | ~x14 | ~x15 | ~x17);
