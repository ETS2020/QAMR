...
module FAU ( 
  ...
  assign new_n44_ = ~x12 & (~x07 | (~x08 & x09 & ~x10 & x15));
  assign new_n45_ = ~x10 & ((x15 & (~x11 | ~x13 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (x05 & ~new_n31_ & x08) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & ((~new_n48_ & x12) | (x07 & ~x12 & x16));
  assign new_n48_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x14 | ~x15 | x16 | ~x11 | ~x13);
  assign z7 = (x06 & ~new_n31_ & x08) | (new_n50_ & ~x08);
  assign new_n50_ = x09 & ~x10 & ((~new_n51_ & x12) | (x07 & ~x12 & x17));
  ...
  assign new_n56_ = x07 & (x08 | (x09 & ~x10 & ~x12 & x18));
endmodule
