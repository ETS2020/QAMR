...
module FAU ( 
  ...
  assign z0 = (~x05 & ~x12) | (new_n32_ & new_n31_ & ~x10 & x11 & x12);
  ...
  assign new_n49_ = ~x12 & (~x05 | (x09 & ~x10 & x16));
  assign z7 = new_n51_ | (x06 & x08) | (~x08 & x09 & ~new_n52_ & ~x10);
  assign new_n51_ = ~x12 & (~x05 | (new_n31_ & ~x10 & x17));
  assign new_n52_ = (~x17 | (new_n47_ & x14 & x15 & x16)) & (~new_n48_ | ~x14 | ~x15 | ~x16 | x17);
