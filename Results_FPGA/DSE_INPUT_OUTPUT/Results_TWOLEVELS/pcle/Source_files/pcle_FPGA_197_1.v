...
module FAU ( 
  ...
  assign z5 = (~x08 & x09 & ~new_n43_ & ~x10) | new_n34_ | (x04 & x08);
  assign new_n43_ = (~x12 | ((x13 | ~x15) & (~x14 | x15 | ~x11 | ~x13))) & (~x15 | (x11 & x14 & (x12 | x17)));
  ...
  assign z8 = ~new_n52_ | (x17 & (new_n51_ | ~x12));
  assign new_n51_ = new_n32_ & x13 & x14 & x15 & x16 & ~x18;
