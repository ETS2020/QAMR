...
module FAU ( 
  ...
  assign new_n38_ = x07 & (x08 | ~x09 | x10 | ~x11 | x13);
  assign new_n39_ = x09 & ~x10 & x13 & (~x11 | ~x12);
  assign z4 = (x12 & (new_n43_ | ~x07)) | (new_n41_ & ~x08) | (x03 & x08);
  assign new_n41_ = x09 & ~x10 & ~new_n42_ & x14;
  assign new_n42_ = x11 & x12 & x13;
  assign new_n43_ = ~x08 & x09 & ~x10 & x11 & x13 & ~x14;
  assign z5 = (x04 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (~x07 | ((~x15 | (x11 & x13 & x14)) & (~x11 | ~x12 | ~x13 | ~x14 | x15))) & (x12 | ~x15);
  assign z6 = (x05 & ~new_n34_ & x08) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & ((~new_n48_ & x07) | (~x12 & x16));
  assign new_n48_ = (~x16 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~x08 & x09 & ~new_n50_ & ~x10) | new_n34_ | (x06 & x08);
  assign new_n50_ = (~x17 | (new_n52_ & (new_n51_ | ~x07))) & (~new_n42_ | ~new_n51_ | ~x16 | x17);
  assign new_n51_ = x14 & x15;
  assign new_n52_ = x11 & x12 & x13 & x16;
  assign z8 = (x07 & (x08 | (x09 & ~new_n54_ & ~x10))) | (~x08 & x09 & new_n57_ & ~x10);
