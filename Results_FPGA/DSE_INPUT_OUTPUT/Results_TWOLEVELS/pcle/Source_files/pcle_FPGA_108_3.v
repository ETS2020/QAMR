...
module FAU ( 
  ...
  assign z7 = (x06 & (x08 | x12)) | (~x08 & new_n51_ & x09);
  assign new_n51_ = ~x10 & ((x17 & (~new_n52_ | ~x14 | ~x15 | ~x16)) | (new_n52_ & x16 & ~x17 & x14 & x15));
  assign new_n52_ = x11 & x12 & x13;
  assign z8 = (x07 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n54_ & ~x10);
  assign new_n54_ = (x12 | ~x18) & (x06 | ((~new_n46_ | ~new_n56_) & (new_n55_ | ~x18)));
