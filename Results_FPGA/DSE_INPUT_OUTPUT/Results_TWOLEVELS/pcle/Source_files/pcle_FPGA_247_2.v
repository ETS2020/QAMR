...
module FAU ( 
  ...
  assign z7 = (new_n49_ & ~x08) | (x06 & x08 & x12);
  assign new_n49_ = x09 & ~x10 & ((~new_n50_ & x12) | (~x06 & ~x12 & x17));
  assign new_n50_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
  assign z8 = new_n57_ | (x07 & x08) | (~x08 & new_n52_ & x09);
  assign new_n52_ = ~x10 & ((new_n55_ & new_n56_) | (x18 & (new_n53_ | ~new_n54_)));
  assign new_n53_ = x12 & (~x15 | ~x16);
  assign new_n54_ = x14 & x17 & x11 & x13;
  assign new_n55_ = x13 & x14 & x11 & x12;
  assign new_n56_ = x17 & ~x18 & x15 & x16;
  assign new_n57_ = ~x12 & (x06 | (~x10 & x18 & ~x08 & x09));
endmodule
