...
module FAU ( 
  ...
  assign new_n38_ = x09 & ~x10 & (x11 ? (~x13 | (~x12 & x13)) : x13);
  ...
  assign new_n43_ = ~x10 & ((x15 & ((x12 & (~x13 | ~x14)) | (x13 & (~x11 | ~x12)))) | (x11 & x12 & x13 & x14 & ~x15));
  assign z6 = (x05 & ~new_n31_ & x08) | (~x08 & x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (~x12 | ((x13 | ~x16) & (~x14 | ~x15 | x16 | ~x11 | ~x13))) & (~x13 | ~x16 | (x14 & x15 & x11 & x12));
