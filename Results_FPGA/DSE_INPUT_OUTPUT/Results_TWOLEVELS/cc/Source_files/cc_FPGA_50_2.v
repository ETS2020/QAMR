...
module FAU ( 
  ...
  assign z12 = (x15 & (~x19 | (x12 & x13))) | (~new_n54_ & x12);
  assign new_n54_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = new_n56_ | (x15 & ~x19);
  ...
  assign new_n61_ = (~x04 | ~x08 | ~x10 | x15) & (~x17 | (x08 & x10));
  assign z17 = ~new_n63_ & x12;
  assign new_n63_ = x15 ? (~x18 | ~x19) : ((x08 & x10) ? ~x05 : ~x18);
  assign z18 = (x15 & ~x19) | (~new_n65_ & x12);
  assign new_n65_ = (~x08 | ~x10 | (~x06 & (x14 | ~x15))) & (~x19 | (x08 & x10)) & (~x14 | ~x15);
