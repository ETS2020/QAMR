...
module FAU ( 
  ...
  assign z03 = x15 & (x01 | (x08 & x10 & x12 & ~x14));
  ...
  assign z12 = (x15 & (x01 | (x12 & x13))) | (~new_n56_ & x12);
  assign new_n56_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (x15 & (x01 | (x08 & x10 & x12 & ~x14))) | (x12 & x14 & (~x01 | ~x08 | ~x10));
  ...
  assign z16 = (~new_n62_ & x12) | (x15 & (x01 | (x12 & x17)));
  assign new_n62_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (~new_n64_ & x12) | (x15 & (x01 | (x12 & x18)));
  assign new_n64_ = (~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = (~new_n66_ & x12) | (x15 & (x01 | (x12 & x19)));
