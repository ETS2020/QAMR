...
module FAU ( 
  ...
  assign new_n57_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | ~x16 | (x01 & x08 & x10));
  assign z14 = (~x15 & ~x16) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = (~x15 & (new_n60_ | ~x16)) | (x12 & ~x14 & ~new_n61_ & x16);
  assign new_n60_ = x03 & x08 & x10 & x12;
  assign new_n61_ = x08 & x10 & ~x15;
  assign z16 = (~new_n63_ & ~x15) | (x12 & ~new_n61_ & x17);
  assign new_n63_ = x16 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = (~new_n65_ & ~x15) | (x12 & ~new_n61_ & x18);
  assign new_n65_ = x16 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = (~new_n67_ & ~x15) | (x12 & ~new_n61_ & x19);
