...
module FAU ( 
  ...
  assign new_n46_ = x12 & ((~x03 & (x14 | (x08 & x10 & ~x15))) | (x14 & x15));
  ...
  assign new_n56_ = ~x03 & (~x00 | ~x08 | ~x10 | ~x12);
  ...
  assign new_n61_ = ~x14 & x16 & (x15 | (~x03 & (~x08 | ~x10)));
  assign z16 = ~new_n63_ & x12;
  assign new_n63_ = (~x15 | ~x17) & (x03 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15)));
  assign z17 = (~new_n65_ & ~x15) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n65_ = ~x03 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = ~new_n67_ & x12;
  assign new_n67_ = (~x15 | ~x19) & (x03 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15)));
