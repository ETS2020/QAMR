...
module FAU ( 
  ...
  assign z03 = (~x15 & ~x18) | (x08 & x10 & x12 & ~x14 & x15);
  assign z04 = x15 & ~x18;
  assign z05 = x19 | (~x15 & ~x18);
  assign z06 = x15 ? (~x08 | ~x09 | (x08 & x09)) : ~x18;
  ...
  assign z13 = new_n60_ | (~x15 & ~x18);
  assign new_n60_ = x12 & ((x15 & (x14 | (x08 & x10 & ~x14))) | (x14 & (~x01 | ~x08 | ~x10)));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15 & x18));
  assign z15 = x12 & (new_n63_ | (new_n58_ & x03 & x08));
  assign new_n63_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & x18));
