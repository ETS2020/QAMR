...
module FAU ( 
  ...
  assign new_n46_ = x12 & ((x09 & (x14 | (x08 & x10 & ~x15))) | (x14 & x15));
  assign z03 = (~x09 & ~x15) | (x08 & x10 & x12 & ~x14 & x15);
  ...
  assign new_n58_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x09 | ~x14 | (x01 & x08 & x10));
  ...
  assign new_n65_ = (~x15 | ~x18) & (~x09 | (((x08 & x10) | ~x18) & (~x05 | ~x08 | ~x10 | x15)));
