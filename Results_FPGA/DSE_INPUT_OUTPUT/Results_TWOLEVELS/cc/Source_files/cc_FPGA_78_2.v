...
module FAU ( 
  ...
  assign z12 = x12 & x13 & (new_n57_ | x00 | ~x08 | ~x10);
  assign new_n57_ = x15 & (x14 | (x08 & x10 & ~x14));
  assign z13 = ~new_n59_ & x12;
  assign new_n59_ = (~x13 | ~x15 | (~x14 & (~x08 | ~x10 | x14))) & x13 & (~x14 | (x01 & x08 & x10));
  assign z14 = x12 & x13 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15));
  assign z15 = x12 & (~new_n62_ | (~x14 & x16 & (~new_n46_ | ~x08)));
  assign new_n62_ = x13 & (~x03 | ~x08 | ~x10 | x15);
