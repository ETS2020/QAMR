// Benchmark "FAU" written by ABC on Fri Aug 21 19:50:08 2020
...
module FAU ( 
  ...
  assign z12 = (~new_n56_ & x12) | (x15 & (~x07 | (x12 & x13)));
  ...
  assign new_n63_ = (x15 | ((x08 & x10) ? ~x04 : ~x17)) & (~x07 | ~x15 | ~x17);
  assign z17 = (~new_n65_ & x12) | (x15 & (~x07 | (x12 & x18)));
  assign new_n65_ = (~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = (~new_n67_ & x12) | (x15 & (~x07 | (x12 & x19)));
  assign new_n67_ = (~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = (x15 & (~x07 | (x12 & x20))) | (x12 & ((x07 & x08 & x10 & ~x15) | (x20 & (~x08 | ~x10))));
  assign z06 = x15;
endmodule
