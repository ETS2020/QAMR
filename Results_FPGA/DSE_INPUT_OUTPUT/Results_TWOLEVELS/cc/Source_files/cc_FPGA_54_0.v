...
module FAU ( 
  ...
  assign new_n57_ = (~x13 | (~x15 & (~x17 | (x08 & x10)))) & (~x00 | ~x08 | ~x10 | x15 | ~x17);
  assign z13 = ~new_n59_ & x12;
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | ~x17 | (x01 & x08 & x10));
  assign z14 = (~x15 & ~x17) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = new_n62_ | (x12 & ~x14 & ~new_n46_ & x16);
  assign new_n62_ = ~x15 & (~x17 | (x03 & x08 & x10 & x12));
  ...
  assign new_n69_ = x17 & (~x07 | ~x08 | ~x10 | ~x12);
endmodule
