...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n56_, new_n58_, new_n61_, new_n62_, new_n64_, new_n67_,
    new_n69_;
  ...
  assign new_n56_ = (~x13 | (~x15 & (x18 | (x08 & x10)))) & (~x00 | ~x08 | ~x10 | x15 | x18);
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x18 | (x01 & x08 & x10));
  ...
  assign new_n62_ = x03 & x08 & x10 & ~x15 & ~x18;
