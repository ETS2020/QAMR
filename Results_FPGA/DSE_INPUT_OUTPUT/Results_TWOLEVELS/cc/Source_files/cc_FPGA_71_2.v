// Benchmark "FAU" written by ABC on Fri Aug 21 19:49:37 2020
...
module FAU ( 
  ...
  assign z12 = (x13 & ~x15) | (x12 & (x13 | (x00 & x08 & x10 & ~x15)));
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (x13 | ~x14 | (x01 & x08 & x10));
  assign z14 = (x13 & ~x15) | (x12 & ((x02 & x08 & x10 & ~x15) | (x15 & (~x08 | ~x10))));
  assign z15 = x12 & ((~new_n61_ & ~x13) | (~x14 & x15 & x16));
  assign new_n61_ = (x14 | ~x16 | (x08 & x10)) & (~x10 | x15 | ~x03 | ~x08);
  ...
  assign new_n67_ = ~x13 & (~x06 | ~x08 | ~x10 | ~x12);
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = (~x15 | ~x20) & (x13 | ((~x20 | (x08 & x10)) & (~x10 | x15 | ~x07 | ~x08)));
endmodule
