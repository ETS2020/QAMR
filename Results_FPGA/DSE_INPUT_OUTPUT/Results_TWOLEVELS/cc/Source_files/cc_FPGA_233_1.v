...
module FAU ( 
  ...
  assign z15 = (~new_n57_ & x12) | (x15 & (~x12 | (~x14 & x16)));
  assign new_n57_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | ~x16 | (x08 & x10));
  assign z16 = x12 & ((x04 & x08 & x10 & ~x15) | (x17 & (~x08 | ~x10 | x15)));
  assign z17 = (x15 & (~x12 | (x12 & x18))) | (x12 & ((x05 & x08 & x10 & ~x15) | (x18 & (~x08 | ~x10))));
  assign z18 = (x12 & ((x06 & x08 & x10 & ~x15) | (x19 & (~x08 | ~x10)))) | (x15 & (~x12 | x19));
