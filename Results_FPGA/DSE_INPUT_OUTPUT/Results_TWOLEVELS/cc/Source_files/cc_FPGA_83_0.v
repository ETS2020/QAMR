...
module FAU ( 
  ...
  assign z13 = x12 & ((x08 & x10 & ~x14 & x15) | (x14 & (x15 | (x01 & (~x08 | ~x10)))));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x08 & x10 & ~x15 & x01 & x02));
