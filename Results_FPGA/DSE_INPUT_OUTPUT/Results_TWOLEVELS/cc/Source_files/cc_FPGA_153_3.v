...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n58_, new_n60_, new_n61_, new_n64_, new_n68_,
    new_n70_;
  ...
  assign z10 = (~x08 & (~x19 | (x19 & ~x20))) | (~x09 & (~x19 | ~x20));
  assign z11 = ~new_n45_ & x14;
  assign z12 = new_n45_ | (x12 & ((x13 & (~new_n58_ | ~x08)) | (new_n58_ & x00 & x08)));
  assign new_n58_ = x10 & ~x15;
  assign z13 = x12 & (new_n60_ | new_n61_);
  assign new_n60_ = x14 & (~x19 | ~x20) & (~x01 | ~x08 | ~x10);
  assign new_n61_ = x08 & x10 & x15 & (~x20 | (~x19 & x20));
  assign z14 = new_n45_ | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = x12 & ~new_n45_ & ~new_n64_;
  ...
  assign new_n68_ = (~x06 | ((~x19 | x20) & (~x08 | ~x10 | x15 | x19))) & (~x19 | x20 | (x08 & x10 & ~x15));
  assign z19 = new_n45_ | (~new_n70_ & x12);
  assign new_n70_ = (~x08 | ~x10 | (x15 ? (x19 | ~x20) : ~x07)) & (~x20 | (x08 & x10));
endmodule
