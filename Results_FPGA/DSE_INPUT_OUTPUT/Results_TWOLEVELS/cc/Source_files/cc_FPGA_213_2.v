...
module FAU ( 
  ...
  assign z02 = (x02 & ~x15) | (~x11 & x12 & (new_n46_ | x14));
  ...
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (x02 | ~x14 | (x01 & x08 & x10));
  ...
  assign new_n68_ = (x02 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15))) & (~x15 | ~x19);
  assign z19 = (~new_n70_ & ~x15) | (x12 & ~new_n46_ & x20);
