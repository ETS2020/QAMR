...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n57_, new_n60_, new_n62_, new_n64_, new_n66_;
  assign z00 = x11 & x20 & (x00 | ~x15);
  assign z01 = x15 & (~x00 | (x08 & x10 & ~x14));
  assign z02 = new_n46_ | (~x00 & x15);
  assign new_n46_ = ~x11 & x12 & (x14 | (x08 & x10 & ~x15));
  assign z03 = x15 & (~x00 | (x00 & x08 & x10 & x12 & ~x14));
  ...
  assign new_n57_ = (~x00 | ~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
