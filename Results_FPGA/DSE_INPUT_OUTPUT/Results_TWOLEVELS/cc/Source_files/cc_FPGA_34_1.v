...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n55_, new_n57_, new_n60_, new_n61_, new_n63_, new_n66_,
    new_n68_;
  assign z00 = (x11 & x20) | (~x15 & x18);
  assign z01 = (~x15 & x18) | (x08 & x10 & ~x14 & x15);
  assign z02 = new_n46_ & ~x11;
  assign new_n46_ = x12 & ((x14 & (x15 | ~x18)) | (x08 & x10 & ~x15 & ~x18));
  ...
  assign new_n55_ = ~x18 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = new_n57_ | (~x15 & x18);
  assign new_n57_ = x12 & ((x15 & (x14 | (x08 & x10 & ~x14))) | (x14 & (~x01 | ~x08 | ~x10)));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15 & ~x18));
  assign z15 = x12 & (new_n61_ | (new_n60_ & x03 & x08));
  assign new_n60_ = x10 & ~x15 & ~x18;
  assign new_n61_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & ~x18));
  assign z16 = ~new_n63_ & x12;
  assign new_n63_ = (~x17 | (~x15 & (x18 | (x08 & x10)))) & (~x04 | ~x08 | ~x10 | x15 | x18);
  assign z17 = x12 & ((x05 & x08 & x10 & ~x15 & ~x18) | (x15 & x18));
  assign z18 = (~new_n66_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n66_ = ~x18 & (~x06 | ~x08 | ~x10 | ~x12);
  assign z19 = ~new_n68_ & x12;
  assign new_n68_ = (x18 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15))) & (~x15 | ~x20);
  assign z09 = ~z10;
  assign z06 = x15;
endmodule
