...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n57_, new_n59_, new_n62_, new_n66_, new_n68_;
  assign z00 = x11 & x20;
  ...
  assign z12 = new_n45_ | (x12 & ((x13 & (~new_n57_ | ~x08)) | (new_n57_ & x00 & x08)));
  ...
  assign z16 = new_n45_ | (x12 & ((x17 & (~new_n57_ | ~x08)) | (new_n57_ & x04 & x08)));
  assign z17 = x12 & ~new_n45_ & ((x18 & (~new_n57_ | ~x08)) | (new_n57_ & x05 & x08));
  assign z18 = ~new_n66_ & x12;
  assign new_n66_ = (~x06 | ((~x19 | ~x20) & (~x08 | ~x10 | x15 | x19))) & (~x19 | ~x20 | (x08 & x10 & ~x15));
  assign z19 = new_n45_ | new_n68_;
  assign new_n68_ = x12 & ((x08 & x10 & (x15 ? x20 : x07)) | (x20 & (~x08 | ~x10)));
