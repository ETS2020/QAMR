...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n54_, new_n56_, new_n59_, new_n61_, new_n63_, new_n65_;
  ...
  assign z12 = (x15 & (x20 | (x12 & x13))) | (~new_n54_ & x12);
  assign new_n54_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = ~new_n56_ & x12;
  assign new_n56_ = (~x15 | x20 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (x15 & ~x20 & (~x08 | ~x10)));
  assign z15 = (~new_n59_ & x12) | (x15 & (x20 | (x12 & ~x14 & x16)));
  assign new_n59_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | ~x16 | (x08 & x10));
  assign z16 = (~new_n61_ & x12) | (x15 & (x20 | (x12 & x17)));
