...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n55_, new_n59_, new_n61_, new_n63_, new_n65_;
  ...
  assign new_n55_ = (~x13 | (x15 ? ~x01 : (x08 & x10))) & (~x10 | x15 | ~x00 | ~x08);
  assign z13 = (~x01 & (x15 | (x12 & x14))) | (x12 & ((x15 & (x14 | (x01 & x08 & x10 & ~x14))) | (x14 & (~x08 | ~x10))));
  assign z14 = x12 & ((x01 & x15 & (~x08 | ~x10)) | (x10 & ~x15 & x02 & x08));
  assign z15 = x12 & (new_n59_ | (x10 & ~x15 & x03 & x08));
  ...
  assign new_n63_ = (~x18 | (x08 & x10)) & (~x10 | x15 | ~x05 | ~x08);
