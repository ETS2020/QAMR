...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n56_, new_n57_, new_n59_, new_n62_, new_n65_, new_n68_;
  assign z00 = x11 & x20 & (x15 | ~x19);
  assign z01 = x15 & ~x14 & x08 & x10;
  assign z02 = new_n46_ & ~x11;
  assign new_n46_ = x12 & ((x14 & (x15 | ~x19)) | (x08 & x10 & ~x15 & ~x19));
  ...
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x19 | (x01 & x08 & x10));
  assign z14 = (~x15 & x19) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = x12 & (new_n62_ | (~x14 & ~new_n56_ & x16));
  assign new_n62_ = x03 & x08 & x10 & ~x15 & ~x19;
  assign z16 = x12 & ((~new_n56_ & x17) | (new_n57_ & x04 & x08));
  assign z17 = (~new_n65_ & ~x15) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n65_ = ~x19 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = (~x15 & x19) | (x12 & (x19 | (x06 & x08 & x10 & ~x15)));
  assign z19 = ~new_n68_ & x12;
  assign new_n68_ = (x19 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15))) & (~x15 | ~x20);
  assign z09 = ~z10;
endmodule
