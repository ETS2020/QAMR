...
module FAU ( 
  ...
  assign new_n64_ = (~x15 | ~x17) & (x11 | ((~x17 | (x08 & x10)) & (~x10 | x15 | ~x04 | ~x08)));
  assign z17 = ~new_n66_ & x12;
  assign new_n66_ = (~x15 | ~x18) & (x11 | ((~x18 | (x08 & x10)) & (~x10 | x15 | ~x05 | ~x08)));
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (~x15 | ~x19) & (x11 | ((~x19 | (x08 & x10)) & (~x10 | x15 | ~x06 | ~x08)));
  assign z19 = ~new_n70_ & x12;
  assign new_n70_ = (~x15 | ~x20) & (x11 | ((~x20 | (x08 & x10)) & (~x10 | x15 | ~x07 | ~x08)));
endmodule
