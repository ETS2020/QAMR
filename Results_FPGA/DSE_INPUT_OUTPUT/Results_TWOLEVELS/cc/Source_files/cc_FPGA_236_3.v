// Benchmark "FAU" written by ABC on Fri Aug 21 19:50:24 2020
...
module FAU ( 
  ...
  assign new_n47_ = x12 & ((x14 & (~x15 | ~x19)) | (x08 & x10 & ~x15));
  ...
  assign new_n56_ = (~x13 | (x15 ? x19 : (x08 & x10))) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (~x15 | x19 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  assign z14 = (x15 & x19) | (x12 & ((x02 & x08 & x10 & ~x15) | ((~x08 | ~x10) & x15)));
  assign z15 = x12 & (new_n61_ | (x03 & x08 & x10 & ~x15));
  assign new_n61_ = ~x14 & x16 & (x15 ? ~x19 : (~x08 | ~x10));
  assign z16 = x12 & (x15 ? (x17 & ~x19) : (new_n45_ ? x04 : x17));
  assign z17 = (~new_n64_ & x12) | (x15 & (x19 | (x12 & x18)));
  assign new_n64_ = ((x08 & x10) | ~x18) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = (x15 & x19) | (x12 & ((x06 & x08 & x10 & ~x15) | ((~x08 | ~x10) & x19)));
  assign z19 = x12 & (x15 ? (~x19 & x20) : (new_n45_ ? x07 : x20));
  assign z09 = ~z10;
  assign z06 = x15;
endmodule
