...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n54_, new_n56_, new_n59_, new_n60_, new_n62_, new_n65_,
    new_n67_;
  ...
  assign new_n54_ = x18 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = new_n56_ | (~x15 & ~x18);
  assign new_n56_ = x12 & ((x15 & (x14 | (x08 & x10 & ~x14))) | (x14 & (~x01 | ~x08 | ~x10)));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15 & x18));
  assign z15 = x12 & (new_n60_ | (new_n59_ & x03 & x08));
  assign new_n59_ = x10 & ~x15 & x18;
  assign new_n60_ = ~x14 & x16 & (x15 | ((~x08 | ~x10) & x18));
  assign z16 = ~new_n62_ & x12;
  assign new_n62_ = (~x17 | (~x15 & (~x18 | (x08 & x10)))) & (~x04 | ~x08 | ~x10 | x15 | ~x18);
