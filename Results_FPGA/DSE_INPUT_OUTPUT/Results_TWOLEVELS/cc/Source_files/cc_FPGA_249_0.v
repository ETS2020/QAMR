...
module FAU ( 
  ...
  assign z06 = x15 ? (~x08 | ~x09 | (x08 & x09)) : ~x02;
  assign z07 = x17 & (x02 | x15);
  assign z08 = x16 | (~x02 & ~x15);
  assign z09 = x08 & x09 & (x02 | x15);
  assign z10 = (~x08 | ~x09) & (x02 | x15);
  assign z11 = x14 | (~x02 & ~x15);
  assign z12 = ~new_n57_ & x12;
  assign new_n57_ = (~x02 | ((~x13 | (x08 & x10)) & (~x10 | x15 | ~x00 | ~x08))) & (~x13 | ~x15);
  assign z13 = new_n59_ | (~x02 & ~x15);
  assign new_n59_ = x12 & ((x15 & (x14 | (x08 & x10 & ~x14))) | (x14 & (~x01 | ~x08 | ~x10)));
  assign z14 = (~x02 & ~x15) | (x12 & ((x08 & x10 & ~x15) | (x15 & (~x08 | ~x10))));
  ...
  assign new_n64_ = x02 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = ~new_n66_ & x12;
  assign new_n66_ = (~x15 | ~x18) & (~x02 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15)));
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (~x15 | ~x19) & (~x02 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15)));
  assign z19 = ~new_n70_ & x12;
  assign new_n70_ = (~x15 | ~x20) & (~x02 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15)));
endmodule
