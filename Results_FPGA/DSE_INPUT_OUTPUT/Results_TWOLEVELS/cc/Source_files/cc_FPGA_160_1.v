...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n48_, new_n58_, new_n62_, new_n64_;
  ...
  assign new_n58_ = (~x13 | (x15 ? ~x01 : (x08 & x10))) & (~x10 | x15 | ~x00 | ~x08);
  assign z13 = (~x01 & (x15 | (x12 & x14))) | (x12 & ((x15 & (x14 | (x08 & x10 & ~x14))) | (x14 & (~x08 | ~x10))));
  assign z14 = x12 & ((x01 & x15 & (~x08 | ~x10)) | (x10 & ~x15 & x02 & x08));
  assign z15 = (~new_n62_ & x12) | (x15 & (~x01 | (x12 & ~x14 & x16)));
  assign new_n62_ = (x14 | ~x16 | (x08 & x10)) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = (~new_n64_ & x12) | (x15 & (~x01 | (x12 & x17)));
