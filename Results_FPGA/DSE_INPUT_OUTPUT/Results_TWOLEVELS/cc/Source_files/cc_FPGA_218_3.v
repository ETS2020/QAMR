...
module FAU ( 
  ...
  assign z13 = (x01 & x15) | (x12 & ((~x01 & (x14 | (x08 & x10 & ~x14 & x15))) | (x14 & (~x08 | ~x10))));
  ...
  assign z16 = (~new_n63_ & x12) | (x15 & (x01 | (x12 & x17)));
  assign new_n63_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = ~new_n65_ & x12;
  assign new_n65_ = (x15 | ((x08 & x10) ? ~x05 : ~x18)) & (x01 | ~x15 | ~x18);
  assign z18 = (~new_n67_ & x12) | (x15 & (x01 | (x12 & x19)));
  assign new_n67_ = (~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = (~new_n69_ & x12) | (x15 & (x01 | (x12 & x20)));
