...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n54_, new_n55_, new_n57_, new_n60_, new_n65_;
  ...
  assign z12 = x12 & ((~new_n54_ & x13) | (new_n55_ & x00 & x08));
  assign new_n54_ = ~x15 & (x19 | (x08 & x10));
  assign new_n55_ = x10 & ~x15 & ~x19;
  assign z13 = new_n57_ | (~x15 & x19);
  ...
  assign z16 = x12 & ((~new_n54_ & x17) | (new_n55_ & x04 & x08));
  assign z17 = x12 & ((~new_n54_ & x18) | (new_n55_ & x05 & x08));
  assign z18 = (~x15 & x19) | (x12 & (x19 | (x06 & x08 & x10 & ~x15)));
  assign z19 = (~new_n65_ & ~x15) | (x12 & ~new_n46_ & x20);
  assign new_n65_ = ~x19 & (~x07 | ~x08 | ~x10 | ~x12);
  assign z09 = ~z10;
  assign z05 = x19;
  assign z06 = x15;
endmodule
