// Benchmark "FAU" written by ABC on Fri Aug 21 19:50:26 2020
...
module FAU ( 
  ...
  assign z03 = x15 & (~x20 | (x08 & x10 & x12 & ~x14 & x20));
  ...
  assign z12 = (x15 & (~x20 | (x12 & x13))) | (~new_n55_ & x12);
  assign new_n55_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = ~new_n57_ & x12;
  assign new_n57_ = (~x15 | ~x20 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  ...
  assign new_n62_ = x15 ? (~x17 | ~x20) : ((x08 & x10) ? ~x04 : ~x17);
  ...
  assign z19 = (x15 & ~x20) | (~new_n68_ & x12);
  assign new_n68_ = (~x08 | ~x10 | (~x07 & (x14 | ~x15 | ~x20))) & (~x20 | (x08 & x10 & (~x14 | ~x15)));
  assign z06 = x15;
endmodule
