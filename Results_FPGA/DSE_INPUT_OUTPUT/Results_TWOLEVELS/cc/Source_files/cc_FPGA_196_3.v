...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n56_, new_n60_, new_n65_;
  ...
  assign z11 = x14 & ~x15;
  assign z12 = (x15 & (x14 | (x12 & x13))) | (~new_n56_ & x12);
  assign new_n56_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = z03 | (x12 & x14 & (~new_n45_ | ~x01));
  ...
  assign z19 = (~new_n65_ & x12) | (x15 & (x14 | (x12 & x20)));
  assign new_n65_ = ((x08 & x10) | ~x20) & (~x07 | ~x08 | ~x10 | x15);
  assign z06 = x15;
endmodule
