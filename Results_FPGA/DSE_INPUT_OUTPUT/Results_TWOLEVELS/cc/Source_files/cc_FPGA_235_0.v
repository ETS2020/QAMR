...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n57_, new_n59_, new_n62_, new_n63_, new_n65_, new_n68_,
    new_n70_;
  ...
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | ~x18 | (x01 & x08 & x10));
  assign z14 = (~x15 & ~x18) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = new_n62_ | new_n63_;
  assign new_n62_ = ~x15 & (~x18 | (x03 & x08 & x10 & x12));
  ...
  assign new_n68_ = x18 & (~x06 | ~x08 | ~x10 | ~x12);
