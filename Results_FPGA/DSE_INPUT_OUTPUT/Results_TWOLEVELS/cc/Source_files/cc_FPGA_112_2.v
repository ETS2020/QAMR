...
module FAU ( 
  ...
  assign z01 = x19 & x15 & ~x14 & x08 & x10;
  assign z02 = new_n46_ | (x15 & ~x19);
  assign new_n46_ = ~x11 & x12 & (x14 | (x08 & x10 & ~x15));
  assign z03 = x15 & (~x19 | (x08 & x10 & x12 & ~x14 & x19));
  assign z04 = ~x18 & (~x15 | x19);
  assign z05 = x19 ? (~x08 | ~x09 | (x08 & x09)) : x15;
  assign z06 = x15 & x19;
  ...
  assign z12 = (x15 & (~x19 | (x12 & x13))) | (~new_n57_ & x12);
  assign new_n57_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = ~new_n59_ & x12;
  assign new_n59_ = (~x15 | ~x19 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  ...
  assign z18 = (x15 & ~x19) | (~new_n68_ & x12);
  assign new_n68_ = (~x08 | ~x10 | (~x06 & (x14 | ~x15 | ~x19))) & (~x19 | (x08 & x10 & (~x14 | ~x15)));
  assign z19 = (~new_n70_ & x12) | (x15 & (~x19 | (x12 & x20)));
