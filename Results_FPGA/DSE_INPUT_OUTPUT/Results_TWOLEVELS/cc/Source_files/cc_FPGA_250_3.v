...
module FAU ( 
  ...
  assign new_n56_ = (~x13 | (x15 ? x09 : (x08 & x10))) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (x09 & x15) | (~new_n58_ & x12);
  assign new_n58_ = (~x15 | (~x14 & (~x08 | x09 | ~x10 | x14))) & (~x14 | (x01 & x08 & x10));
  ...
  assign z17 = x12 & ((~x15 & (new_n65_ ? x05 : x18)) | (~x09 & x15 & x18));
  assign new_n65_ = x08 & x10;
  assign z18 = x12 & ((~x15 & (new_n65_ ? x06 : x19)) | (~x09 & x15 & x19));
  assign z19 = (~new_n68_ & x12) | (x15 & (x09 | (x12 & x20)));
