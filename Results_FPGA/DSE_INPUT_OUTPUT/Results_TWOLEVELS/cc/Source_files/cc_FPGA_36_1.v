...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n54_, new_n56_, new_n59_, new_n61_, new_n63_, new_n65_,
    new_n67_;
  ...
  assign new_n56_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x16 | (x01 & x08 & x10));
  assign z14 = (~x15 & x16) | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = (~x15 & x16) | (x12 & ((new_n59_ & x10 & ~x15) | (~x14 & x16)));
  assign new_n59_ = x03 & x08;
  assign z16 = (~new_n61_ & ~x15) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n61_ = ~x16 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = (~new_n63_ & ~x15) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n63_ = ~x16 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = (~new_n65_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n65_ = ~x16 & (~x06 | ~x08 | ~x10 | ~x12);
