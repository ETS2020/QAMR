...
module FAU ( 
  ...
  assign new_n46_ = x12 & ((~x05 & (x14 | (x08 & x10 & ~x15))) | (x14 & x15));
  ...
  assign new_n57_ = (~x13 | ~x15) & (x05 | ((~x13 | (x08 & x10)) & (~x10 | x15 | ~x00 | ~x08)));
  assign z13 = new_n59_ | (x05 & ~x15);
  assign new_n59_ = x12 & ((x15 & (x14 | (x08 & x10 & ~x14))) | (x14 & (~x01 | ~x08 | ~x10)));
  assign z14 = (x05 & ~x15) | (x12 & ((x10 & ~x15 & x02 & x08) | (x15 & (~x08 | ~x10))));
