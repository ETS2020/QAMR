...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n56_, new_n59_;
  ...
  assign new_n56_ = x08 ? ((~x15 | (~x14 & (~x10 | x14))) & (~x14 | (x01 & x10))) : (~x14 | ~x17);
  assign z14 = x12 & (x08 ? ((~x10 & x15) | (x02 & x10 & ~x15)) : (x15 & x17));
  assign z15 = x12 & ((~new_n59_ & x08) | (x16 & x17 & ~x08 & ~x14));
  assign new_n59_ = (x14 | ~x16 | (x10 & ~x15)) & (~x03 | ~x10 | x15);
  assign z16 = (~x08 & (x12 | ~x17)) | (x12 & (new_n46_ ? x04 : x17));
