...
module FAU ( 
  ...
  assign z02 = ~x11 & x12 & ((~x04 & (new_n46_ | x14)) | (x14 & x15));
  ...
  assign new_n57_ = (~x13 | ~x15) & (x04 | ((~x13 | (x08 & x10)) & (~x10 | x15 | ~x00 | ~x08)));
  assign z13 = ~new_n59_ & x12;
  assign new_n59_ = (~x15 | (~x14 & (~x08 | ~x10 | x14))) & (x04 | ~x14 | (x01 & x08 & x10));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & ~x04 & x08 & x10 & ~x15));
  assign z15 = new_n62_ | (x12 & ~x14 & ~new_n46_ & x16);
  assign new_n62_ = ~x15 & (x04 | (x03 & x08 & x10 & x12));
  assign z16 = x12 & x17 & (x15 | (~x04 & (~x08 | ~x10)));
