...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n61_, new_n64_;
  assign z00 = x11 & x20 & (~x13 | ~x15);
  assign z01 = x15 & ~x14 & new_n45_ & ~x13;
  assign new_n45_ = x08 & x10;
  assign z02 = new_n47_ & ~x11;
  assign new_n47_ = x12 & ((x14 & (~x13 | ~x15)) | (x08 & x10 & ~x15));
  assign z03 = x15 & ~x14 & ~x13 & new_n45_ & x12;
  ...
  assign z13 = (x13 & x15) | (x12 & ((x15 & (x14 | (new_n45_ & ~x13 & ~x14))) | ((~new_n45_ | ~x01) & x14)));
  assign z14 = (x13 & x15) | (x12 & ((x02 & x08 & x10 & ~x15) | ((~x08 | ~x10) & x15)));
  assign z15 = (~new_n61_ & x12) | (x15 & (x13 | (x12 & ~x14 & x16)));
  assign new_n61_ = (x14 | (x08 & x10) | ~x16) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = x12 & ((~x15 & (new_n45_ ? x04 : x17)) | (~x13 & x15 & x17));
  assign z17 = (~new_n64_ & x12) | (x15 & (x13 | (x12 & x18)));
