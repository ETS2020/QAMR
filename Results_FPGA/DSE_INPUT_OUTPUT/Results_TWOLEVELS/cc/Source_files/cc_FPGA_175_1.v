...
module FAU ( 
  ...
  assign z02 = ~x11 & x12 & ~x15 & (new_n46_ | x14);
  assign new_n46_ = x08 & x10;
  assign z03 = x15 & ~x14 & x12 & new_n46_ & x11;
  ...
  assign new_n57_ = (~x13 | (x15 ? ~x11 : (x08 & x10))) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (~x11 & x15) | (x12 & ((x15 & (x14 | (new_n46_ & x11 & ~x14))) | (x14 & (~new_n46_ | ~x01))));
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (x11 & x15 & (~x08 | ~x10)));
  ...
  assign z18 = (~new_n67_ & x12) | (x15 & (~x11 | (x12 & x19)));
  assign new_n67_ = (~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = (~new_n69_ & x12) | (x15 & (~x11 | (x12 & x20)));
