...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n55_, new_n56_, new_n58_, new_n61_, new_n62_, new_n65_;
  assign z00 = x11 & x20;
  assign z01 = x15 & x08 & x10 & ~x14;
  assign z02 = new_n46_ & ~x11;
  assign new_n46_ = x12 & ((x14 & (x15 | x20)) | (x08 & x10 & ~x15 & x20));
  ...
  assign new_n55_ = ~x15 & ((x08 & x10) | ~x20);
  assign new_n56_ = x10 & ~x15 & x20;
  ...
  assign new_n65_ = x20 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = x12 & ((~new_n55_ & x19) | (new_n56_ & x06 & x08));
  assign z19 = (~x15 & ~x20) | (x12 & x20 & (~x10 | x15 | x07 | ~x08));
  assign z09 = ~z10;
  assign z06 = x15;
endmodule
