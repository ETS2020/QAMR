...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n57_, new_n59_, new_n62_, new_n64_;
  ...
  assign z12 = (x15 & (~x16 | (x12 & x13))) | (~new_n57_ & x12);
  assign new_n57_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (x15 & (~x16 | (x08 & x10 & x12))) | (new_n59_ & x12);
  assign new_n59_ = x14 & (~x01 | ~x08 | ~x10);
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (x15 & x16 & (~x08 | ~x10)));
  assign z15 = (x15 & ~x16) | (~new_n62_ & x12);
  assign new_n62_ = (~x08 | ~x10 | ((~x03 | x15) & (x14 | ~x15 | ~x16))) & (x14 | ~x16 | (x08 & x10));
