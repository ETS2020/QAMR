...
module FAU ( 
  ...
  assign new_n61_ = (~x08 | ~x10 | ((~x03 | x15) & (x14 | ~x15 | ~x16))) & (x14 | (x08 & x10) | ~x16);
  assign z16 = ~new_n63_ & x12;
  assign new_n63_ = (~x04 | ((~x16 | ~x17) & (~x08 | ~x10 | x15 | x17))) & (~x16 | ~x17 | (x08 & x10 & ~x15));
  assign z17 = new_n44_ | (x12 & ((x18 & (~new_n56_ | ~x08)) | (new_n56_ & x05 & x08)));
  assign z18 = x12 & ~new_n44_ & ((x19 & (~new_n56_ | ~x08)) | (new_n56_ & x06 & x08));
  assign z19 = new_n44_ | (x12 & ((x20 & (~new_n56_ | ~x08)) | (new_n56_ & x07 & x08)));
