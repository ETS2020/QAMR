...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n47_, new_n57_, new_n61_, new_n63_, new_n65_, new_n68_;
  assign z00 = x20 & x11 & ~x15;
  assign z01 = x15 & (x11 | (x08 & x10 & ~x14));
  assign z02 = ~x11 & x12 & (x14 | (x08 & x10 & ~x15));
  assign z03 = x15 & x12 & new_n47_ & ~x11 & ~x14;
  ...
  assign z12 = (x15 & (x11 | (x12 & x13))) | (~new_n57_ & x12);
  assign new_n57_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (x11 & x15) | (x12 & ((x15 & (x14 | (new_n47_ & ~x11 & ~x14))) | (x14 & (~new_n47_ | ~x01))));
