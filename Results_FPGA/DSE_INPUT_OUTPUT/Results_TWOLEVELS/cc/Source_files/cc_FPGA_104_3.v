...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n56_, new_n60_, new_n62_;
  ...
  assign z13 = (x15 & x16) | (x12 & ((x15 & (x14 | (new_n45_ & ~x14 & ~x16))) | (x14 & (~new_n45_ | ~x01))));
  assign z14 = x12 & ((x02 & x08 & x10 & ~x15) | (x15 & (~x08 | ~x10) & ~x16));
  assign z15 = (x15 & x16) | (~new_n60_ & x12);
  assign new_n60_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | (x08 & x10) | ~x16);
