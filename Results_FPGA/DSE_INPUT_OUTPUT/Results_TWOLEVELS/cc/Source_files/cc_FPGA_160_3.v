...
module FAU ( 
  ...
  assign new_n58_ = (~x13 | (x15 ? x01 : (x08 & x10))) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (x15 & (x01 | (new_n48_ & x12 & ~x14))) | (x12 & x14 & (~new_n48_ | ~x01));
  assign z14 = x12 & ((~x01 & x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15));
  assign z15 = (x15 & (x01 | (x12 & ~x14 & x16))) | (~new_n62_ & x12);
