...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n57_, new_n59_, new_n62_, new_n67_;
  assign z00 = x11 & x20;
  ...
  assign z17 = (x18 & ~x20) | (x12 & ((new_n57_ & x05 & x08) | (x18 & (~new_n57_ | ~x08))));
  assign z18 = new_n45_ | (x12 & ((x19 & (~new_n57_ | ~x08)) | (new_n57_ & x06 & x08)));
  assign z19 = ~new_n67_ & x12;
  assign new_n67_ = (~x07 | (~x20 & (~x08 | ~x10 | x15 | x18))) & (~x20 | (x08 & x10 & (~x08 | ~x10 | ~x15)));
  assign z04 = ~x18;
endmodule
