...
module FAU ( 
  ...
  assign z03 = x15 & (x09 | (x08 & ~x09 & x10 & x12 & ~x14));
  ...
  assign z12 = (x15 & (x09 | (x12 & x13))) | (~new_n56_ & x12);
  assign new_n56_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (x09 | ~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  assign z14 = (x09 & x15) | (x12 & (((~x08 | ~x10) & x15) | (x02 & x08 & x10 & ~x15)));
  assign z15 = x12 & (new_n61_ | (x03 & x08 & x10 & ~x15));
  assign new_n61_ = ~x14 & x16 & (x15 ? ~x09 : (~x08 | ~x10));
  assign z16 = (~new_n63_ & x12) | (x15 & (x09 | (x12 & x17)));
  assign new_n63_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = ~new_n65_ & x12;
  assign new_n65_ = (x15 | ((x08 & x10) ? ~x05 : ~x18)) & (x09 | ~x15 | ~x18);
  assign z18 = (~new_n67_ & x12) | (x15 & (x09 | (x12 & x19)));
