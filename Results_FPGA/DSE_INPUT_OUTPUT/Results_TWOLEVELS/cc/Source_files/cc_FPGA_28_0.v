...
module FAU ( 
  ...
  assign new_n62_ = ~x15 & (~x16 | (x03 & x08 & x10 & x12));
  assign new_n63_ = x12 & ~x14 & x16 & (~x08 | ~x10 | x15);
  assign z16 = ~new_n65_ & x12;
  assign new_n65_ = (~x16 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15))) & (~x15 | ~x17);
  assign z17 = ~new_n67_ & x12;
  assign new_n67_ = (~x16 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15))) & (~x15 | ~x18);
  assign z18 = ~new_n69_ & x12;
  assign new_n69_ = (~x16 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15))) & (~x15 | ~x19);
  assign z19 = ~new_n71_ & x12;
  assign new_n71_ = (~x16 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15))) & (~x15 | ~x20);
endmodule
