...
module FAU ( 
  ...
  assign z16 = x12 & ((x15 & x17) | (x04 & (new_n46_ | x17)));
  assign z17 = ~new_n65_ & x12;
  assign new_n65_ = (~x04 | ((~x18 | (x08 & x10)) & (~x10 | x15 | ~x05 | ~x08))) & (~x15 | ~x18);
  assign z18 = ~new_n67_ & x12;
  assign new_n67_ = (~x04 | ((~x19 | (x08 & x10)) & (~x10 | x15 | ~x06 | ~x08))) & (~x15 | ~x19);
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = (~x04 | ((~x20 | (x08 & x10)) & (~x10 | x15 | ~x07 | ~x08))) & (~x15 | ~x20);
endmodule
