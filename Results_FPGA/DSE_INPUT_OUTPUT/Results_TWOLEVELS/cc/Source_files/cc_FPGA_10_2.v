...
module FAU ( 
  ...
  assign z01 = (x07 & ~x15) | (x08 & x10 & ~x14 & x15);
  assign z02 = new_n46_ | (x07 & ~x15);
  assign new_n46_ = ~x11 & x12 & (x14 | (x08 & x10 & ~x15));
  assign z03 = (x07 & ~x15) | (x08 & x10 & x12 & ~x14 & x15);
  ...
  assign new_n62_ = (x14 | (x08 & x10) | ~x16) & (~x10 | x15 | ~x03 | ~x08);
  assign z16 = ~new_n64_ & x12;
  assign new_n64_ = (~x15 | ~x17) & (x07 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15)));
