...
module FAU ( 
  ...
  assign z01 = (x05 & x14) | (x08 & x10 & ~x14 & x15);
  assign z02 = new_n47_ & ~x11;
  assign new_n47_ = x12 & ((~x05 & x14) | (x08 & x10 & ~x14 & ~x15));
  ...
  assign new_n59_ = (~x15 | ((x05 | ~x14) & (~x08 | ~x10 | x14))) & (x05 | ~x14 | (x01 & x08 & x10));
  ...
  assign z17 = x12 & (x05 ? (~x14 & (x18 | (new_n57_ & x08))) : (x18 & (~new_n57_ | ~x08)));
