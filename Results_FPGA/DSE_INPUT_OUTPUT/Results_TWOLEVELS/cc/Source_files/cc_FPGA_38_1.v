// Benchmark "FAU" written by ABC on Fri Aug 21 19:49:23 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n47_, new_n57_, new_n59_, new_n62_, new_n64_, new_n66_, new_n68_,
    new_n70_;
  assign z00 = x11 & x20 & (x09 | ~x15);
  assign z01 = x15 & ~x14 & z09 & x10;
  assign z09 = x08 & x09;
  assign z02 = new_n47_ | (~x09 & x15);
  assign new_n47_ = ~x11 & x12 & (x14 | (x08 & x10 & ~x15));
  assign z03 = x15 & (~x09 | (x08 & x10 & x12 & ~x14));
  ...
  assign z13 = (x15 & (~x09 | (x08 & x10 & x12))) | (new_n59_ & x12);
  assign new_n59_ = x14 & (~x01 | ~x08 | ~x10);
  assign z14 = (~x09 & x15) | (x12 & ((x02 & x08 & x10 & ~x15) | (x15 & (~x08 | ~x10))));
  ...
  assign z18 = (~new_n68_ & x12) | (x15 & (~x09 | (x12 & x19)));
  assign new_n68_ = (~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = ~new_n70_ & x12;
  assign new_n70_ = (x15 | ((x08 & x10) ? ~x07 : ~x20)) & (~x09 | ~x15 | ~x20);
endmodule
