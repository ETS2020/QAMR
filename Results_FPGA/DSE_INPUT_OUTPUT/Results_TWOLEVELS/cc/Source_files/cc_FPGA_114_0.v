...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n47_, new_n58_, new_n60_, new_n63_, new_n66_;
  assign z00 = x11 & x20;
  ...
  assign new_n66_ = (~x05 | (~x18 & (~x08 | ~x10 | x15 | ~x20))) & (~x18 | (x08 & x10 & ~x15));
  assign z18 = x12 & ~new_n45_ & ((x19 & (~new_n58_ | ~x08)) | (new_n58_ & x06 & x08));
  assign z19 = (~x18 & ~x20) | (x12 & ((new_n58_ & x07 & x08) | ((~new_n58_ | ~x08) & x20)));
endmodule
