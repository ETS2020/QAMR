...
module FAU ( 
  ...
  assign new_n64_ = (~x15 | ~x17) & (x09 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15)));
  assign z17 = ~new_n66_ & x12;
  assign new_n66_ = (~x15 | ~x18) & (x09 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15)));
  assign z18 = (~new_n68_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n68_ = ~x09 & (~x06 | ~x08 | ~x10 | ~x12);
  assign z19 = ~new_n70_ & x12;
  assign new_n70_ = (~x15 | ~x20) & (x09 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15)));
  assign z10 = ~z09;
endmodule
