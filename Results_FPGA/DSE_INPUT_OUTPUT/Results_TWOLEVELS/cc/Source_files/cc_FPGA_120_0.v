// Benchmark "FAU" written by ABC on Fri Aug 21 19:49:52 2020
...
module FAU ( 
  ...
  assign z02 = (~x01 & ~x15) | (~x11 & x12 & (new_n46_ | x14));
  assign new_n46_ = x08 & x10 & ~x15;
  assign z03 = (~x01 & ~x15) | (x08 & x10 & x12 & ~x14 & x15);
  assign z04 = ~x18 | (~x01 & ~x15);
  assign z05 = x19 | (~x01 & ~x15);
  assign z06 = x15 ? (~x08 | ~x09 | (x08 & x09)) : ~x01;
  ...
  assign new_n57_ = x01 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = x12 & ((x14 & (x15 | (x01 & (~x08 | ~x10)))) | (x08 & x10 & ~x14 & x15));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x01 & x02 & x08 & x10 & ~x15));
  assign z15 = new_n61_ | (x12 & ~x14 & ~new_n46_ & x16);
  assign new_n61_ = ~x15 & (~x01 | (x03 & x08 & x10 & x12));
  assign z16 = ~new_n63_ & x12;
  assign new_n63_ = (~x01 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15))) & (~x15 | ~x17);
  assign z17 = ~new_n65_ & x12;
  assign new_n65_ = (~x01 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15))) & (~x15 | ~x18);
  assign z18 = (~new_n67_ & ~x15) | (x12 & ~new_n46_ & x19);
  assign new_n67_ = x01 & (~x06 | ~x08 | ~x10 | ~x12);
