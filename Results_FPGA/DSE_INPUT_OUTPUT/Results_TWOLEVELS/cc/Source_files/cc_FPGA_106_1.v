...
module FAU ( 
  ...
  assign new_n55_ = (~x13 | (x15 ? ~x05 : (x08 & x10))) & (~x10 | x15 | ~x00 | ~x08);
  assign z13 = ~new_n57_ & x12;
  assign new_n57_ = (~x05 | ~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  ...
  assign z16 = (~new_n62_ & x12) | (x15 & (~x05 | (x12 & x17)));
  assign new_n62_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (x15 & (~x05 | (x12 & x18))) | (x12 & ((x18 & (~x08 | ~x10)) | (x05 & x08 & x10 & ~x15)));
  assign z18 = ~new_n65_ & x12;
  assign new_n65_ = (x15 | ((x08 & x10) ? ~x06 : ~x19)) & (~x05 | ~x15 | ~x19);
  assign z19 = (~new_n67_ & x12) | (x15 & (~x05 | (x12 & x20)));
