...
module FAU ( 
  ...
  assign new_n64_ = (~x15 | ~x17) & (x03 | ((~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15)));
  assign z17 = (~new_n66_ & ~x15) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n66_ = ~x03 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (~x15 | ~x19) & (x03 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15)));
  assign z19 = (~new_n70_ & ~x15) | (x12 & x20 & (~x08 | ~x10 | x15));
  assign new_n70_ = ~x03 & (~x07 | ~x08 | ~x10 | ~x12);
endmodule
