...
module FAU ( 
  ...
  assign new_n56_ = ~x02 & (~x00 | ~x08 | ~x10 | ~x12);
  assign z13 = new_n58_ | (x02 & ~x15);
  assign new_n58_ = x12 & ((x15 & (x14 | (x08 & x10 & ~x14))) | (x14 & (~x01 | ~x08 | ~x10)));
  assign z14 = (x02 & ~x15) | (x12 & x15 & (~x08 | ~x10));
  assign z15 = x12 & ((~new_n61_ & ~x02) | (~x14 & x15 & x16));
  assign new_n61_ = (x14 | (x08 & x10) | ~x16) & (~x10 | x15 | ~x03 | ~x08);
  assign z16 = (~new_n63_ & ~x15) | (x12 & x17 & (~x08 | ~x10 | x15));
  assign new_n63_ = ~x02 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = ~new_n65_ & x12;
  assign new_n65_ = (~x15 | ~x18) & (x02 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15)));
  assign z18 = (~new_n67_ & ~x15) | (x12 & x19 & (~x08 | ~x10 | x15));
  assign new_n67_ = ~x02 & (~x06 | ~x08 | ~x10 | ~x12);
  assign z19 = (~new_n69_ & ~x15) | (x12 & x20 & (~x08 | ~x10 | x15));
  assign new_n69_ = ~x02 & (~x07 | ~x08 | ~x10 | ~x12);
  assign z06 = x15;
endmodule
