...
module FAU ( 
  ...
  assign new_n56_ = ~x11 & (~x00 | ~x08 | ~x10 | ~x12);
  ...
  assign new_n64_ = ~x11 & (~x04 | ~x08 | ~x10 | ~x12);
  assign z17 = (~new_n66_ & ~x15) | (x12 & x18 & (~x08 | ~x10 | x15));
  assign new_n66_ = ~x11 & (~x05 | ~x08 | ~x10 | ~x12);
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (x11 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15))) & (~x15 | ~x19);
