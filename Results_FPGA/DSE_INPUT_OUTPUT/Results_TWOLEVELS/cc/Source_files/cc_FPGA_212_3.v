...
module FAU ( 
  ...
  assign z12 = (x15 & (x02 | (x12 & x13))) | (~new_n57_ & x12);
  assign new_n57_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = (x15 & (x02 | (x08 & x10 & x12))) | (new_n59_ & x12);
  assign new_n59_ = x14 & (~x01 | ~x08 | ~x10);
  assign z14 = (x02 & (x15 | (x08 & x10 & x12))) | (x12 & x15 & (~x08 | ~x10));
  assign z15 = x12 & (new_n62_ | (x03 & x08 & x10 & ~x15));
  assign new_n62_ = ~x14 & x16 & (x15 ? ~x02 : (~x08 | ~x10));
  assign z16 = (~new_n64_ & x12) | (x15 & (x02 | (x12 & x17)));
  assign new_n64_ = (~x17 | (x08 & x10)) & (~x10 | x15 | ~x04 | ~x08);
  assign z17 = ~new_n66_ & x12;
  assign new_n66_ = (x15 | ((x08 & x10) ? ~x05 : ~x18)) & (x02 | ~x15 | ~x18);
  assign z18 = (~new_n68_ & x12) | (x15 & (x02 | (x12 & x19)));
  assign new_n68_ = (~x19 | (x08 & x10)) & (~x10 | x15 | ~x06 | ~x08);
  assign z19 = (~new_n70_ & x12) | (x15 & (x02 | (x12 & x20)));
  assign new_n70_ = (~x20 | (x08 & x10)) & (~x10 | x15 | ~x07 | ~x08);
endmodule
