...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n45_, new_n56_, new_n58_, new_n61_, new_n63_, new_n65_;
  assign z00 = x11 & (x15 | x20);
  assign z01 = x15 & ~x14 & new_n45_ & ~x11;
  assign new_n45_ = x08 & x10;
  assign z02 = ~x11 & x12 & (x14 | (x08 & x10 & ~x15));
  assign z03 = x15 & (x11 | (new_n45_ & ~x11 & x12 & ~x14));
  ...
  assign z16 = (x15 & (x11 | (x12 & x17))) | (~new_n63_ & x12);
  assign new_n63_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (x15 & (x11 | (x12 & x18))) | (~new_n65_ & x12);
