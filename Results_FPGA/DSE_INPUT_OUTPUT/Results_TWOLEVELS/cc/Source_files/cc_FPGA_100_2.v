...
module FAU ( 
  ...
  assign new_n46_ = x12 & ((x14 & (~x15 | x18)) | (x08 & x10 & ~x15));
  ...
  assign new_n58_ = (~x15 | ~x18 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  assign z14 = (x15 & ~x18) | (x12 & ((x02 & x08 & x10 & ~x15) | (x15 & (~x08 | ~x10))));
  ...
  assign new_n65_ = (~x08 | ~x10 | ((~x05 | x15) & (x14 | ~x15 | ~x18))) & (~x18 | (x08 & x10 & (~x14 | ~x15)));
  assign z18 = (~new_n67_ & x12) | (x15 & (~x18 | (x12 & x19)));
  assign new_n67_ = (~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = x15 ? (~x18 | ~x20) : ((x08 & x10) ? ~x07 : ~x20);
  assign z06 = x15;
endmodule
