...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n57_, new_n59_, new_n62_, new_n65_, new_n68_;
  ...
  assign z06 = x11 & x15 & (~x08 | ~x09 | (x08 & x09));
  ...
  assign new_n59_ = (~x11 | ~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  assign z14 = (~x11 & x15) | (x12 & (((~x08 | ~x10) & x15) | (x02 & x08 & x10 & ~x15)));
  assign z15 = (~new_n62_ & x12) | (x15 & (~x11 | (x12 & ~x14 & x16)));
  assign new_n62_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | (x08 & x10) | ~x16);
  assign z16 = x12 & ((~x15 & (new_n46_ ? x04 : x17)) | (x11 & x15 & x17));
  assign z17 = (~new_n65_ & x12) | (x15 & (~x11 | (x12 & x18)));
  assign new_n65_ = (~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = x12 & ((~x15 & (new_n46_ ? x06 : x19)) | (x11 & x15 & x19));
