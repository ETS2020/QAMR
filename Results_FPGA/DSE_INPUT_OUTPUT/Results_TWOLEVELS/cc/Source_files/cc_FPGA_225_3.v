...
module FAU ( 
  ...
  assign z13 = x12 & (new_n59_ | new_n60_);
  assign new_n59_ = x14 & (~x18 | ~x19) & (~x01 | ~x08 | ~x10);
  assign new_n60_ = x08 & x10 & x15 & (~x19 | (~x18 & x19));
  assign z14 = new_n44_ | (x12 & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15)));
  assign z15 = new_n44_ | (~new_n63_ & x12);
  ...
  assign new_n66_ = (~x05 | ((~x08 | ~x10 | x15 | x18) & (~x18 | x19))) & (~x18 | x19 | (x08 & x10 & ~x15));
  assign z18 = ~new_n68_ & x12;
  assign new_n68_ = (~x06 | ((x18 | ~x19) & (~x08 | ~x10 | x15 | x19))) & (x18 | ~x19 | (x08 & x10 & (~x08 | ~x10 | ~x15)));
  assign z19 = new_n44_ | (x12 & ((x20 & (~new_n57_ | ~x08)) | (new_n57_ & x07 & x08)));
  assign z05 = x19;
endmodule
