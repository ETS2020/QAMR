...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n57_, new_n59_, new_n62_, new_n63_, new_n65_;
  ...
  assign z15 = x12 & (new_n63_ | (~x14 & ~new_n62_ & x16));
  assign new_n62_ = ~x15 & (~x20 | (x08 & x10));
  assign new_n63_ = x03 & x08 & x10 & ~x15 & x20;
  assign z16 = x12 & ((~new_n62_ & x17) | (new_n65_ & x04 & x08));
  assign new_n65_ = x10 & ~x15 & x20;
  assign z17 = x12 & ((~new_n62_ & x18) | (new_n65_ & x05 & x08));
  assign z18 = x12 & ((~new_n62_ & x19) | (new_n65_ & x06 & x08));
