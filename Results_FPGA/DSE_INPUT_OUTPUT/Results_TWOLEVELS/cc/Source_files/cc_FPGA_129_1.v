...
module FAU ( 
  ...
  assign new_n55_ = (~x13 | (x15 ? ~x03 : (x08 & x10))) & (~x10 | x15 | ~x00 | ~x08);
  ...
  assign new_n60_ = (~x03 | ((~x08 | ~x10 | x15) & (x14 | ~x16))) & (x14 | x15 | ~x16 | (x08 & x10));
  assign z16 = (~new_n62_ & x12) | (x15 & (~x03 | (x12 & x17)));
  assign new_n62_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = ~new_n64_ & x12;
  assign new_n64_ = (x15 | ((x08 & x10) ? ~x05 : ~x18)) & (~x03 | ~x15 | ~x18);
  assign z18 = (~new_n66_ & x12) | (x15 & (~x03 | (x12 & x19)));
