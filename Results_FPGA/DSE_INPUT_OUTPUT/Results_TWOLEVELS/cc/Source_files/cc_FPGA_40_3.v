...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n44_, new_n47_, new_n57_, new_n59_, new_n60_, new_n63_;
  ...
  assign z13 = new_n44_ | (x12 & (new_n59_ | new_n60_));
  assign new_n59_ = x15 & (x14 | (x08 & x10 & ~x14 & (~x17 | ~x19)));
  ...
  assign z16 = (x17 & x19) | (x12 & ((new_n57_ & x04 & x08) | (x17 & (~new_n57_ | ~x08))));
  assign z17 = x12 & ~new_n44_ & ((x18 & (~new_n57_ | ~x08)) | (new_n57_ & x05 & x08));
  assign z18 = (x17 & x19) | (x12 & ((new_n57_ & x06 & x08) | (x19 & (~new_n57_ | ~x08))));
