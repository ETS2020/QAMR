...
module FAU ( 
  ...
  assign z12 = (x15 & (x11 | (x12 & x13))) | (~new_n55_ & x12);
  assign new_n55_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = new_n57_ | (x11 & x15);
  ...
  assign new_n60_ = ~x14 & x16 & (x15 ? ~x11 : (~x08 | ~x10));
  assign z16 = (~new_n62_ & x12) | (x15 & (x11 | (x12 & x17)));
  assign new_n62_ = (~x17 | (x08 & x10)) & (~x04 | ~x08 | ~x10 | x15);
  assign z17 = (~new_n64_ & x12) | (x15 & (x11 | (x12 & x18)));
  ...
  assign new_n68_ = (x15 | ((x08 & x10) ? ~x07 : ~x20)) & (x11 | ~x15 | ~x20);
  assign z09 = ~z10;
endmodule
