...
module FAU ( 
  ...
  assign z03 = x15 & (~x02 | (x02 & x08 & x10 & x12 & ~x14));
  ...
  assign z12 = (~new_n56_ & x12) | (x15 & (~x02 | (x12 & x13)));
  assign new_n56_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (~x02 | ~x15 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | x15 | (x01 & x08 & x10));
  assign z14 = (~x02 & x15) | (x12 & ((x02 & x08 & x10 & ~x15) | (x15 & (~x08 | ~x10))));
  assign z15 = (~new_n61_ & x12) | (x15 & (~x02 | (x12 & ~x14 & x16)));
  assign new_n61_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | ~x16 | (x08 & x10));
  assign z16 = (~new_n63_ & x12) | (x15 & (~x02 | (x12 & x17)));
  assign new_n63_ = (~x17 | (x08 & x10)) & (~x10 | x15 | ~x04 | ~x08);
  assign z17 = (~new_n65_ & x12) | (x15 & (~x02 | (x12 & x18)));
  assign new_n65_ = (~x18 | (x08 & x10)) & (~x10 | x15 | ~x05 | ~x08);
  assign z18 = ~new_n67_ & x12;
  assign new_n67_ = (x15 | ((x08 & x10) ? ~x06 : ~x19)) & (~x02 | ~x15 | ~x19);
  assign z19 = (~new_n69_ & x12) | (x15 & (~x02 | (x12 & x20)));
