...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n48_, new_n58_, new_n60_, new_n63_, new_n66_;
  ...
  assign z12 = (x15 & (x07 | (x12 & x13))) | (~new_n58_ & x12);
  assign new_n58_ = (~x13 | (x08 & x10)) & (~x00 | ~x08 | ~x10 | x15);
  assign z13 = new_n60_ | (x07 & x15);
  assign new_n60_ = x12 & ((x15 & (x14 | (x08 & x10 & ~x14))) | (x14 & (~x01 | ~x08 | ~x10)));
  assign z14 = x12 & ((~x07 & x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15));
  assign z15 = x12 & (new_n63_ | (x03 & x08 & x10 & ~x15));
  assign new_n63_ = ~x14 & x16 & (x15 ? ~x07 : (~x08 | ~x10));
  assign z16 = x12 & ((~x15 & (new_n48_ ? x04 : x17)) | (~x07 & x15 & x17));
  assign z17 = (~new_n66_ & x12) | (x15 & (x07 | (x12 & x18)));
  assign new_n66_ = (~x18 | (x08 & x10)) & (~x10 | x15 | ~x05 | ~x08);
  assign z18 = x12 & ((~x15 & (new_n48_ ? x06 : x19)) | (~x07 & x15 & x19));
  assign z19 = x12 & ((~x15 & (new_n48_ ? x07 : x20)) | (~x07 & x15 & x20));
endmodule
