...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n46_, new_n48_, new_n61_;
  ...
  assign z03 = x15 & ~x14 & ~x13 & new_n48_ & x12;
  assign new_n48_ = x08 & x10;
  assign z04 = ~x18 & (~x13 | ~x15);
  assign z05 = x19 & (~x13 | ~x15);
  assign z06 = ~x13 & x15 & (~x08 | ~x09 | (x08 & x09));
  assign z07 = x17 | (x13 & x15);
  assign z08 = x16 & (~x13 | ~x15);
  assign z09 = x08 & x09 & (~x15 | (~x13 & x15));
  assign z10 = (~x08 | ~x09) & (~x15 | (~x13 & x15));
  assign z11 = x14 | (x13 & x15);
  assign z12 = (x13 & x15) | (x12 & (((~x08 | ~x10) & x13) | (x00 & x08 & x10 & ~x15)));
  assign z13 = (x13 & x15) | (x12 & ((x15 & (x14 | (new_n48_ & ~x13 & ~x14))) | (x14 & (~new_n48_ | ~x01))));
  ...
  assign z16 = x12 & ((~x15 & (new_n48_ ? x04 : x17)) | (~x13 & x15 & x17));
