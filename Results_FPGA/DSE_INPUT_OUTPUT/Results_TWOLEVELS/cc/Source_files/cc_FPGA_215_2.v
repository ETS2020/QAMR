...
module FAU ( 
  ...
  assign z03 = x20 & x15 & ~x14 & x12 & x08 & x10;
  ...
  assign z13 = (x15 & ~x20) | (~new_n58_ & x12);
  assign new_n58_ = (~x15 | ~x20 | (~x14 & (~x08 | ~x10 | x14))) & (~x14 | (x01 & x08 & x10));
  ...
  assign new_n63_ = x15 ? (~x17 | ~x20) : ((x08 & x10) ? ~x04 : ~x17);
  assign z17 = (~new_n65_ & x12) | (x15 & (~x20 | (x12 & x18)));
  assign new_n65_ = (~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15);
  assign z18 = (~new_n67_ & x12) | (x15 & (~x20 | (x12 & x19)));
  assign new_n67_ = (~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15);
  assign z19 = ~new_n69_ & x12;
  assign new_n69_ = (~x08 | ~x10 | ((~x07 | x15) & (x14 | ~x15 | ~x20))) & (~x20 | (x08 & x10 & (~x14 | ~x15)));
  assign z06 = x15;
endmodule
