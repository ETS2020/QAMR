...
module FAU ( 
  ...
  assign z0 = (~x8 & ((x6 & (~x9 | (x7 & x9))) | (x2 & x7 & ~x9))) | ((~x7 | x9) & (x2 | (x6 & x8))) | (x6 & ~x7 & x9);
  assign z1 = (x7 & ~x9 & (x6 | (x2 & ~x8))) | (x2 & (x8 | (~x7 & x9))) | (x6 & ((~x7 & (x8 | x9)) | (x8 & x9)));
  assign z2 = (~x2 & ~x6) | (~x7 & ~x8 & ~x9);
  assign z3 = (x2 & (~x6 | x8)) | (~new_n23_ & x6) | x0 | x1 | (~x2 & ~x6);
  assign new_n23_ = (~x7 | (x9 & (x8 | ~x9))) & (~x8 | ~x9) & (x7 | (~x9 & (x8 | x9)));
  assign z4 = x6 ? ((~x7 & (x9 | (~x8 & ~x9))) | (x8 & (~x7 | x9))) : x2;
