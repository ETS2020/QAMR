...
module FAU ( 
  ...
  assign z2 = ~x9 & ~x7 & ~x8;
  assign z3 = ~x8 | (x5 & (~new_n23_ | (x8 & (x7 | (~x7 & x9)))));
  assign new_n23_ = ~x0 & ~x1 & ~x2;
  assign z4 = (~x6 & (x5 | ~x8)) | (~x7 & ~x8) | (x8 & (~x5 | (x5 & (~x7 | x9))));
  assign z5 = (~new_n26_ & x9) | (~x6 & (x5 | ~x8)) | (~x5 & x8) | (~new_n27_ & ~x9);
  assign new_n26_ = (x0 | x1 | ~x2 | (x7 & ~x8)) & (~x5 | x7 | ~x8);
  assign new_n27_ = x7 ? (x8 & (~x3 | x4)) : x8;
