...
module FAU ( 
  ...
  assign z4 = (~x6 & (x4 | x9)) | (~x7 & (x9 | (x4 & (x8 | (~x8 & ~x9))))) | (x8 & x9) | (~x4 & ~x9);
  assign z5 = new_n26_ | ~new_n27_;
  assign new_n26_ = ~x0 & ~x1 & x2 & (x7 ? (x8 & x9) : ~x8);
  assign new_n27_ = (~x4 | (x6 & (x8 | x9))) & (x4 | x9) & (~x9 | (x6 & (~x5 | x7 | ~x8)));
  assign z6 = (~x6 & (x4 | x9)) | (x4 & ~new_n29_ & ~x9) | (~new_n30_ & x9);
  assign new_n29_ = (x7 | x8) & (~x3 | ~x7 | ~x8);
  assign new_n30_ = (~x5 | x7 | ~x8) & (~x7 | ((x0 | x1 | x2) & x8));
endmodule
