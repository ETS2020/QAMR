...
module FAU ( 
  ...
  assign z0 = ~x7 | x9 | (x6 & ~x9) | (x7 & ~x8);
  assign z1 = (~x9 & (x6 | (~x6 & x7))) | x8 | (~x7 & x9);
  assign z2 = ~x9 & ~x8 & ~x6 & ~x7;
  assign z3 = x9 | (~x6 & (~new_n23_ | (~x9 & (x7 | (~x7 & ~x8)))));
  assign new_n23_ = ~x0 & ~x1 & ~x2;
  assign z4 = ~x6 | x8 | (x6 & ~x9) | (~x7 & x9);
  assign z5 = ~x6 | (~new_n26_ & x9);
  assign new_n26_ = (x0 | x1 | ~x2 | (~x7 ^ ~x8)) & (~x5 | x7 | ~x8);
  assign z6 = (x7 & (new_n23_ | ~x8)) | ~x6 | (x6 & ~x9) | (x5 & ~x7 & x8 & x9);
endmodule
