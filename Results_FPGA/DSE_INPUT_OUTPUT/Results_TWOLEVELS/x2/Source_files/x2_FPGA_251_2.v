...
module FAU ( 
  ...
  assign z3 = (x7 & (~x9 | (~x8 & x9))) | (x9 & (~x7 | x8)) | ~new_n23_ | (~x9 & (x5 | (~x5 & ~x8)));
  ...
  assign z6 = new_n30_ | new_n31_ | new_n34_ | ((new_n32_ | new_n33_) & x7);
  assign new_n30_ = x5 & (~x9 | (~x7 & x8 & x9));
  assign new_n31_ = ~x5 & (~x6 | (~x7 & ~x8 & ~x9));
  assign new_n32_ = x9 & (~x8 | (~x0 & ~x1 & ~x2));
