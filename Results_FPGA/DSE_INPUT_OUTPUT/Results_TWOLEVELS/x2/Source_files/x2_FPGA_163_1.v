...
module FAU ( 
  ...
  assign z0 = x9 ? ((x1 & (~x7 | (x7 & ~x8))) | ~x1 | x8) : (~x8 | (~x7 & x8));
  assign z1 = (x1 & (x8 | (~x7 & x9))) | (~x9 & (x7 | (~x7 & x8)));
  assign z2 = ~x9 & ~x7 & ~x8;
  assign z3 = (x7 & (~x9 | (x1 & ~x8 & x9))) | (x1 & (x8 | (~x7 & x9))) | (~x9 & (x0 | x2 | (~x7 & ~x8)));
  assign z4 = (x1 & (~x6 | (~x7 & x9))) | (~x9 & (~x6 | ~x7)) | (x9 & (~x1 | x8));
  assign z5 = (x1 & (~x6 | (new_n25_ & x8 & x9))) | (~x9 & (~x6 | new_n26_ | ~x8)) | (~x1 & x9);
