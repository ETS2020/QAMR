// Benchmark "FAU" written by ABC on Mon Aug 24 16:53:07 2020
...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n68_,
    ...
    new_n84_;
  assign z00 = (~x17 & ~new_n55_ & x19) | (~x19 & (x05 | ~x20));
  ...
  assign z03 = (~x17 & ~new_n61_ & x19) | (~x05 & ~x19 & ~x23);
  ...
  assign z06 = (~x17 & x19 & (x18 ? ~x27 : x05)) | (~x05 & ~x19 & ~x26);
  assign z07 = (~x17 & ~new_n68_ & x19) | (~x19 & (x05 | ~x27));
  ...
  assign z10 = (~x17 & ~new_n74_ & x19) | (~x19 & (x05 | ~x30));
  assign new_n74_ = x18 ? x31 : ~x09;
  assign z11 = (~x17 & ~new_n76_ & x19) | (~x19 & (x05 | ~x31));
  ...
  assign z15 = (~x17 & ~new_n84_ & x19) | (~x19 & (x05 | ~x35));
