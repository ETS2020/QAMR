...
module FAU ( 
  ...
  assign new_n55_ = ~x28 & (x18 ? ~x21 : x03);
  assign z01 = (~x17 & new_n57_ & x19) | (~x19 & ~x21);
  assign new_n57_ = ~x28 & (x18 ? ~x22 : x02);
  assign z02 = x19 ? ~new_n59_ : ~x22;
  assign new_n59_ = ~x28 & (x17 | (x18 ? x23 : ~x01));
  ...
  assign z12 = (~x17 & new_n78_ & x19) | (~x19 & ~x32);
  assign new_n78_ = ~x28 & (x18 ? ~x33 : x15);
  ...
  assign z15 = (~x17 & x19 & ~x28 & (x12 | x18)) | (~x19 & ~x35);
endmodule
