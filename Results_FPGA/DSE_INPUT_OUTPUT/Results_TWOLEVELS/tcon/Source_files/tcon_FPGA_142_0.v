...
module FAU ( 
  ...
  assign z05 = x14 | (~x09 & ~x14);
  assign z06 = x15 | (~x09 & ~x14);
  assign z07 = x16 | (~x09 & ~x14);
  assign z08 = (~x09 & ~x14) | (~x08 & x09) | (x00 & x08);
  assign z09 = (~x09 & ~x14) | (x01 & x08) | (~x08 & x10);
  assign z10 = (x09 | x14) & (x08 ? x02 : x11);
  assign z11 = (~x09 & ~x14) | (x03 & x08) | (~x08 & x12);
  assign z12 = (x09 | x14) & (x08 ? x04 : x13);
  assign z13 = (~x09 & ~x14) | (x05 & x08) | (~x08 & x14);
