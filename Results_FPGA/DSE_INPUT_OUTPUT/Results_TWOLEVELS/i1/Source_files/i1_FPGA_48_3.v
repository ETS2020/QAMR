...
module FAU ( 
  ...
  assign z02 = ~x15 & x19 & (new_n50_ | (~new_n48_ & x00));
  ...
  assign z04 = (x20 & (~x15 | ~x19)) | x21 | (x15 & x19);
  assign z05 = x10 | (~new_n55_ & x19);
  assign new_n55_ = ~x15 & (~new_n51_ | x05 | x06 | x07 | x08);
  assign z06 = x19 & (new_n57_ | ~x00 | x15 | (x00 & ~new_n48_ & ~x15));
  assign new_n57_ = ~x01 & ~x02 & ~x03 & new_n58_ & ~x04;
  assign new_n58_ = ~x05 & ~x06 & ~x07 & (~x08 | (x08 & (x09 | (~x09 & ~x15))));
  assign z07 = x18 & x24 & (~x15 | ~x19);
  assign z08 = x11 | (x15 & x19);
  assign z09 = (x15 & x19) | (x11 & x24);
  assign z10 = (x15 & x19) | (x14 & x22 & ~x24);
  assign z11 = x17 & x22 & ~x24 & (~x15 | ~x19);
  assign z12 = (x15 & x19) | (x14 & x23 & ~x24);
  assign z13 = (x15 & x19) | (x17 & x23 & ~x24);
  assign z14 = (x15 & x19) | (x16 & ~x24);
