// Benchmark "FAU" written by ABC on Fri Aug 21 20:35:28 2020
...
module FAU ( 
  ...
  assign new_n47_ = x00 & (~new_n48_ | x04 | x05 | x06);
  assign new_n48_ = ~x01 & ~x02 & ~x03;
  assign new_n49_ = ~x07 & (~new_n50_ | x05 | x06 | ~x08 | x09);
  assign new_n50_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign z03 = x20 & (~x07 | ~x19);
  assign z04 = (x20 & (~x07 | ~x19)) | x21 | (x07 & x19);
  assign z05 = x10 | (~new_n54_ & x19);
  assign new_n54_ = ~x07 & (~new_n48_ | x04 | x05 | x06 | x08);
  assign z06 = x19 & ((~new_n56_ & ~x07) | new_n57_ | new_n47_ | x07);
  assign new_n56_ = x00 & (~new_n50_ | ~x08 | ~x09 | x05 | x06);
  assign new_n57_ = ~x01 & new_n58_ & ~x02;
  assign new_n58_ = ~x03 & ~x04 & ~x05 & ~x06 & (~x08 | (x08 & ~x09));
