...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n53_, new_n55_;
  assign z01 = ~x00 | (~x01 & ~x02 & ~x03 & new_n44_ & ~x04);
  ...
  assign z03 = (~x00 & ~x19) | (x20 & (x00 | x19));
  assign z04 = (x00 | x19) & (x20 | x21);
  assign z05 = x10 | (new_n48_ & new_n53_) | (~x00 & ~x19);
  assign new_n53_ = ~x05 & ~x06 & ~x07 & ~x08 & x19;
  assign z06 = ~x00 | (x19 & ((x00 & (~new_n46_ | ~new_n47_)) | (new_n55_ & ~x01)));
  ...
  assign z13 = (~x00 & ~x19) | (x17 & x23 & ~x24);
