...
module FAU ( 
  ...
  assign z04 = (x20 | x21) & (~x11 | x19);
  assign z05 = new_n55_ | (x10 & (~x11 | x19));
  assign new_n55_ = new_n51_ & ~x05 & ~x06 & ~x07 & ~x08 & x19;
  assign z06 = x19 ? (new_n48_ | ~x00 | (new_n57_ & ~x01)) : x11;
  ...
  assign z13 = (x11 & ~x19) | (x17 & x23 & ~x24);
  assign z14 = x16 & ~x24 & (~x11 | x19);
  assign z15 = x14 | x15 | x13 | x12 | (x11 & ~x19);
endmodule
