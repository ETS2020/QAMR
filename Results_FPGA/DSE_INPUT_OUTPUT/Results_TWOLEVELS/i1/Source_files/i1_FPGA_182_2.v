// Benchmark "FAU" written by ABC on Fri Aug 21 20:35:24 2020
...
module FAU ( 
  ...
  assign z05 = (x10 & x19) | (~x06 & (x10 | (new_n51_ & new_n55_ & ~x08 & x19)));
  assign new_n55_ = ~x05 & ~x07;
  assign z06 = (x06 & (~x19 | (x00 & x19))) | (x19 & ((new_n58_ & ~x01) | ~x00 | (~new_n57_ & x00)));
  assign new_n57_ = new_n55_ & ~x04 & ~x01 & ~x02 & ~x03;
  ...
  assign z15 = (~x06 | x19) & (x14 | x15 | x12 | x13);
endmodule
