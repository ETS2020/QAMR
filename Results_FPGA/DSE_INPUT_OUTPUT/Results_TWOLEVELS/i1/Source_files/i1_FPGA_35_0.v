...
module FAU ( 
  ...
  assign z01 = (~x05 & (new_n45_ | ~x19)) | (~x00 & x19);
  assign new_n45_ = ~x01 & ~x02 & new_n46_ & ~x03;
  assign new_n46_ = ~x04 & ~x06 & ~x07 & (x08 ? (x09 & x19) : ~x09);
  assign z02 = (~x05 & (new_n48_ | ~x19)) | (x00 & ~new_n50_ & x19);
  ...
  assign z05 = (x10 & (x05 | x19)) | (new_n49_ & new_n55_ & ~x05 & ~x06);
  assign new_n55_ = ~x07 & ~x08 & x19;
  assign z06 = x19 & ((new_n57_ & ~x01) | ~x00 | (~new_n50_ & x00));
