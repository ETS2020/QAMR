...
module FAU ( 
  ...
  assign z01 = x19 & (new_n45_ | ~x15 | (~x00 & x15));
  assign new_n45_ = ~x01 & ~x02 & ~x03 & new_n46_ & ~x04;
  assign new_n46_ = ~x05 & ~x06 & ~x07 & (x08 ? (x09 & x15) : ~x09);
  assign z02 = x15 & x19 & (new_n48_ | new_n50_);
  ...
  assign new_n55_ = x15 & (~new_n51_ | x05 | x06 | x07 | x08 | ~x15);
  assign z06 = x15 & x19 & (new_n48_ | ~x00 | (new_n57_ & ~x01));
