...
module FAU ( 
  ...
  assign z01 = (~x04 & ~x07) | (~x00 & x19);
  assign z02 = x00 & (x04 | x07) & x19;
  assign z03 = (~x04 & ~x07) | (x20 & (x04 | x07));
  assign z04 = (x04 | x07) & (x20 | x21);
  assign z05 = x10 & (x04 | x07);
  assign z06 = (~x04 & ~x07) | (x19 & (~x00 | (x00 & (x04 | x07))));
  assign z07 = (~x04 & ~x07) | (x18 & x24);
  assign z08 = x11 & (x04 | x07);
  assign z09 = x11 & x24 & (x04 | x07);
  assign z10 = x14 & x22 & (x04 | x07) & ~x24;
  assign z11 = x17 & x22 & (x04 | x07) & ~x24;
