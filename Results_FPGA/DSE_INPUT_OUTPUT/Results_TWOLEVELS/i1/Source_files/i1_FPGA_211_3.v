...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n44_, new_n45_, new_n49_;
  assign z02 = x19 & (x00 | (new_n44_ & new_n45_));
  assign new_n44_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n45_ = ~x05 & ~x06 & ~x07 & x08 & ~x09;
  assign z03 = x20 & (~x00 | ~x19);
  assign z04 = (x20 & (~x00 | ~x19)) | x21 | (x00 & x19);
  assign z05 = x10 | ((x00 | (new_n44_ & new_n49_)) & x19);
  assign new_n49_ = ~x05 & ~x06 & ~x07 & ~x08;
  assign z06 = ~x00 & x19;
