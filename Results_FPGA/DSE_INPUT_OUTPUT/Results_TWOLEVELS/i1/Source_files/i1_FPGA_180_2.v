...
module FAU ( 
  ...
  assign z00 = x00 & (~x19 | (x19 & x22));
  assign z01 = ~new_n45_ & x19;
  assign new_n45_ = (x01 | x02 | ~new_n46_ | x03) & x00 & x22;
  ...
  assign new_n50_ = x22 & (~new_n51_ | x01 | x02 | x03 | x04);
  assign new_n51_ = ~x05 & ~x06 & ~x07 & x08 & ~x09;
  assign z03 = x20 | (x19 & ~x22);
  assign z04 = z03 | x21;
  assign z05 = (x10 & (~x19 | x22)) | (new_n55_ & new_n49_ & ~x08 & x19 & x22);
  assign new_n55_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x05;
  assign z06 = x19 & (~x00 | ~x22 | (x00 & x22));
  assign z07 = x18 & x24 & (~x19 | x22);
  assign z08 = x11 | (x19 & ~x22);
  assign z09 = x11 & x24 & (~x19 | x22);
