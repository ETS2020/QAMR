...
module FAU ( 
  ...
  assign new_n50_ = new_n51_ & new_n52_ & ~x07 & x08 & ~x09;
  assign new_n51_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n52_ = ~x05 & ~x06;
  assign z03 = x20 & (~x07 | x19);
  assign z04 = (x20 & (~x07 | x19)) | x21 | (x07 & ~x19);
  assign z05 = (x10 & x19) | (~x07 & (x10 | (new_n51_ & new_n52_ & ~x08 & x19)));
  assign z06 = (x07 & (~x19 | (x00 & x19))) | (x19 & ((new_n58_ & ~x01) | ~x00 | (~new_n57_ & x00)));
  assign new_n57_ = new_n52_ & ~x04 & ~x01 & ~x02 & ~x03;
