...
module FAU ( 
  ...
  assign z04 = z03 | x21;
  assign z05 = x10 | (x07 & ~x19) | (new_n49_ & new_n54_ & ~x07 & ~x08 & x19);
  assign new_n54_ = ~x05 & ~x06;
  assign z06 = (x07 & (~x19 | (x00 & x19))) | (x19 & ((new_n56_ & ~x01) | ~x00 | (~new_n57_ & x00)));
  assign new_n56_ = ~x02 & ~x03 & ~x04 & ~x05 & ~x06 & ~x07;
  assign new_n57_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x05 & ~x06;
