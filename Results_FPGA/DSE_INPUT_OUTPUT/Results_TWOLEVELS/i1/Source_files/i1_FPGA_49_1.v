// Benchmark "FAU" written by ABC on Fri Aug 21 20:35:02 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n44_, new_n46_, new_n47_, new_n51_, new_n53_, new_n54_;
  assign z01 = x19 & (~x00 | (~x01 & ~x02 & new_n44_ & ~x03));
  assign new_n44_ = ~x04 & ~x05 & ~x06 & ~x07 & (~x08 ^ x09);
  assign z02 = x00 & ~new_n46_ & x19;
  assign new_n46_ = new_n47_ & ~x05 & ~x06 & ~x07 & (~x08 | x09);
  assign new_n47_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign z03 = x20 | (~x00 & x19);
  assign z04 = z03 | x21;
  assign z05 = (x00 & (new_n51_ | x10)) | (x10 & ~x19);
  assign new_n51_ = new_n47_ & ~x05 & ~x06 & ~x07 & ~x08 & x19;
  assign z06 = x19 & (new_n53_ | ~x00 | (~new_n46_ & x00));
  assign new_n53_ = ~x01 & ~x02 & ~x03 & new_n54_ & ~x04;
  assign new_n54_ = ~x05 & ~x06 & ~x07 & (x08 ? x09 : x00);
