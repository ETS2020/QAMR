...
module FAU ( 
  ...
  assign new_n45_ = ~x07 & (x04 | (~x01 & ~x02 & new_n46_ & ~x03));
  assign new_n46_ = ~x05 & ~x06 & x19 & ((~x04 & x08 & x09) | (~x08 & ~x09));
  assign z02 = x19 & (new_n48_ | (x00 & (x07 | (~new_n50_ & ~x04))));
  assign new_n48_ = new_n49_ & ~x03 & ~x04 & ~x01 & ~x02;
  assign new_n49_ = ~x05 & ~x06 & ~x07 & x08 & ~x09;
  assign new_n50_ = ~x01 & ~x02 & ~x03 & ~x05 & ~x06;
  assign z03 = (x04 & ~x07) | (x20 & (~x04 | x07));
  assign z04 = (~x04 | x07) & (x20 | x21);
  assign z05 = (~x04 & (x10 | (new_n54_ & new_n55_ & ~x06 & ~x07))) | (x07 & x10);
  assign new_n54_ = ~x01 & ~x02 & ~x03 & ~x05;
  assign new_n55_ = ~x08 & x19;
  assign z06 = (x04 & ~x07) | (x19 & ((~x04 & (new_n57_ | (~new_n50_ & x00))) | ~x00 | (x00 & x07)));
