...
module FAU ( 
  ...
  assign z02 = x19 & (~x22 | (x22 & (new_n48_ | new_n50_)));
  ...
  assign z04 = (x20 & (~x19 | x22)) | x21 | (x19 & ~x22);
  assign z05 = x10 | (~new_n55_ & x19);
  assign new_n55_ = x22 & (~new_n51_ | x05 | x06 | x07 | x08 | ~x22);
  assign z06 = x19 & x22 & (new_n48_ | ~x00 | (new_n57_ & ~x01));
  ...
  assign z15 = (x12 | x13 | x14 | x15) & (~x19 | x22);
endmodule
