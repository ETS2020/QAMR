...
module FAU ( 
  ...
  assign z04 = z03 | x21;
  assign z05 = (x10 & x19) | (~x03 & (x10 | (new_n55_ & new_n54_ & ~x08 & x19)));
  assign new_n54_ = ~x06 & ~x07;
  assign new_n55_ = ~x01 & ~x02 & ~x04 & ~x05;
  assign z06 = (x03 & (~x19 | (x00 & x19))) | (x19 & ((new_n57_ & ~x01) | ~x00 | (~new_n58_ & x00)));
  assign new_n57_ = ~x02 & ~x03 & ~x04 & ~x05 & ~x06 & ~x07;
  assign new_n58_ = ~x01 & ~x02 & ~x04 & ~x05 & ~x06 & ~x07;
