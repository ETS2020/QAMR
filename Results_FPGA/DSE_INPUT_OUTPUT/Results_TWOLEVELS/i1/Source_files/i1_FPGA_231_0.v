...
module FAU ( 
  ...
  assign z01 = (~x07 & (new_n45_ | ~x19)) | (~x00 & x19);
  assign new_n45_ = ~x01 & ~x02 & new_n46_ & ~x03;
  assign new_n46_ = ~x04 & ~x05 & ~x06 & (x08 ? (x09 & x19) : ~x09);
  assign z02 = (~x07 & (new_n48_ | ~x19)) | (x00 & ~new_n51_ & x19);
  assign new_n48_ = new_n49_ & new_n50_ & x08 & ~x09 & x19;
  ...
  assign z04 = z03 | x21;
  assign z05 = (x10 & (x07 | x19)) | (new_n49_ & new_n50_ & ~x07 & ~x08 & x19);
  assign z06 = x19 & ((new_n57_ & ~x01) | ~x00 | (~new_n51_ & x00));
