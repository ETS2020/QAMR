...
module FAU ( 
  ...
  assign z02 = (x07 & (~x19 | (x00 & x19))) | (x19 & (new_n50_ | (~new_n48_ & x00)));
  assign new_n48_ = new_n49_ & ~x01 & ~x04 & ~x05 & ~x06;
  ...
  assign new_n55_ = (~x07 | x19) & (~new_n51_ | x05 | x06 | x07 | x08 | ~x19);
  assign z06 = x19 & ((new_n57_ & ~x01) | ~x00 | (x00 & (~new_n58_ | ~new_n49_ | x01)));
  ...
  assign z15 = (~x07 | x19) & (x14 | x15 | x12 | x13);
endmodule
