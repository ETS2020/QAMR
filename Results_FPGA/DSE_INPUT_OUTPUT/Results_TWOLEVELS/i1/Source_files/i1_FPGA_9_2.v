...
module FAU ( 
  ...
  assign z02 = (x07 & (~x19 | (x00 & x19))) | (x19 & (new_n51_ | (~new_n48_ & x00)));
  assign new_n48_ = new_n49_ & ~x01 & new_n50_ & ~x04;
  assign new_n49_ = ~x02 & ~x03;
  assign new_n50_ = ~x05 & ~x06;
  assign new_n51_ = new_n52_ & new_n50_ & ~x07 & x08 & ~x09;
  assign new_n52_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign z03 = x20 & (~x07 | x19);
  assign z04 = (x20 & (~x07 | x19)) | x21 | (x07 & ~x19);
  assign z05 = (x10 & x19) | (~x07 & (x10 | (new_n52_ & new_n50_ & ~x08 & x19)));
