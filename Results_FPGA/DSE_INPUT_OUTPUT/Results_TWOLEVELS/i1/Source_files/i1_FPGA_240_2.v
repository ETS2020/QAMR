...
module FAU ( 
  ...
  assign z02 = x19 & x22 & (new_n50_ | (~new_n48_ & x00));
  ...
  assign new_n55_ = x22 & (~new_n51_ | x05 | x06 | x07 | x08);
  assign z06 = x19 & (new_n57_ | ~x00 | ~x22 | (x00 & ~new_n48_ & x22));
  assign new_n57_ = ~x01 & ~x02 & ~x03 & new_n58_ & ~x04;
  assign new_n58_ = ~x05 & ~x06 & ~x07 & (~x08 | (x08 & (x09 | (~x09 & x22))));
