...
module FAU ( 
  ...
  assign z01 = x19 & (new_n45_ | x18 | (~x00 & ~x18));
  assign new_n45_ = ~x01 & ~x02 & ~x03 & new_n46_ & ~x04;
  assign new_n46_ = ~x05 & ~x06 & ~x07 & (x08 ? (x09 & ~x18) : ~x09);
  assign z02 = ~x18 & x19 & (new_n48_ | new_n50_);
  ...
  assign z04 = (x20 & (~x18 | ~x19)) | x21 | (x18 & x19);
  assign z05 = (x10 & (~x18 | ~x19)) | (new_n56_ & new_n55_ & ~x08 & ~x18 & x19);
  assign new_n55_ = ~x06 & ~x07;
  assign new_n56_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x05;
  assign z06 = ~x18 & x19 & ((new_n58_ & ~x01) | new_n48_ | ~x00);
  ...
  assign z15 = x14 | x15 | x13 | x12 | (x18 & x19);
endmodule
