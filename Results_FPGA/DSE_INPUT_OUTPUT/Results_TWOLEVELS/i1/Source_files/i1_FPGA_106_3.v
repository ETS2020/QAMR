...
module FAU ( 
  ...
  assign new_n45_ = (x01 | x02 | ~new_n46_ | x03) & x00 & ~x23;
  ...
  assign z06 = x19 & (new_n58_ | new_n48_ | ~x00 | x23);
  assign new_n58_ = ~x01 & ~x02 & new_n59_ & ~x03;
  assign new_n59_ = ~x04 & ~x05 & ~x06 & ~x07 & (x08 | (~x08 & ~x23));
  assign z07 = x18 & (~x19 | ~x23) & x24;
  assign z08 = x11 & (~x19 | ~x23);
  assign z09 = x11 & (~x19 | ~x23) & x24;
  ...
  assign z15 = (~x19 | ~x23) & (x12 | x13 | x14 | x15);
endmodule
