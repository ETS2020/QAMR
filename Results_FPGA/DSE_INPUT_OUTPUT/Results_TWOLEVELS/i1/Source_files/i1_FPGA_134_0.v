...
module FAU ( 
  ...
  assign new_n47_ = x00 & (~new_n48_ | x06 | x07 | x04 | x05);
  ...
  assign new_n54_ = ~x07 & (~x19 | (new_n48_ & new_n55_));
  assign new_n55_ = ~x04 & ~x05 & ~x06 & ~x08;
  assign z06 = new_n54_ | (x19 & (~new_n57_ | (~x01 & new_n58_ & ~x02)));
  assign new_n57_ = x00 & (~x00 | (new_n48_ & ~x06 & ~x07 & ~x04 & ~x05));
