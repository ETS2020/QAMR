...
module FAU ( 
  ...
  assign new_n45_ = ~x23 & (~x00 | (~x01 & ~x02 & new_n46_ & ~x03));
  ...
  assign new_n50_ = ~x23 & (~new_n51_ | x03 | x04 | x01 | x02);
  assign new_n51_ = ~x05 & ~x06 & ~x07 & x08 & ~x09;
  assign z03 = x20 & (~x19 | ~x23);
  assign z04 = (x20 & (~x19 | ~x23)) | x21 | (x19 & x23);
  assign z05 = (x10 & (~x19 | ~x23)) | (new_n56_ & new_n55_ & ~x08 & x19 & ~x23);
  assign new_n55_ = ~x06 & ~x07;
  assign new_n56_ = ~x03 & ~x04 & ~x05 & ~x01 & ~x02;
  assign z06 = x19 & (new_n58_ | new_n48_ | x23 | (~x00 & ~x23));
  assign new_n58_ = ~x01 & ~x02 & ~x03 & new_n59_ & ~x04;
  assign new_n59_ = ~x05 & ~x06 & ~x07 & (x08 ? (~x09 | (x09 & ~x23)) : ~x23);
  assign z07 = (x19 & x23) | (x18 & x24);
  assign z08 = x11 & (~x19 | ~x23);
  assign z09 = (x19 & x23) | (x11 & x24);
  assign z10 = x14 & x22 & ~x24 & (~x19 | ~x23);
  assign z11 = (x19 & x23) | (x17 & x22 & ~x24);
  assign z12 = ~x24 & x23 & x14 & ~x19;
  assign z13 = x23 & (x19 | (x17 & ~x24));
  assign z14 = x16 & (~x19 | ~x23) & ~x24;
  assign z15 = x14 | x15 | x13 | x12 | (x19 & x23);
endmodule
