...
module FAU ( 
  ...
  assign new_n50_ = x24 & (~new_n51_ | x03 | x04 | x01 | x02);
  assign new_n51_ = ~x05 & ~x06 & ~x07 & x08 & ~x09;
  assign z03 = x20 | (x19 & ~x24);
  assign z04 = z03 | x21;
  assign z05 = (x10 & (~x19 | x24)) | (new_n56_ & new_n55_ & ~x08 & x19 & x24);
  assign new_n55_ = ~x06 & ~x07;
  assign new_n56_ = ~x03 & ~x04 & ~x05 & ~x01 & ~x02;
  assign z06 = x19 & (new_n58_ | new_n48_ | ~x00 | ~x24);
  assign new_n58_ = ~x01 & ~x02 & new_n59_ & ~x03;
  assign new_n59_ = ~x04 & ~x05 & ~x06 & ~x07 & (x08 | (~x08 & x24));
