...
module FAU ( 
  ...
  assign z6 = ~new_n80_ | (~new_n78_ & (x03 | (x06 & ~x11)));
  assign new_n78_ = ~new_n79_ & (~x00 | x02 | x10 | ~x14 | x24);
  assign new_n79_ = ~new_n60_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n80_ = (~x24 | new_n81_ | (~x05 & ~x13)) & ~new_n85_ & (new_n84_ | (x05 ? (~x13 | x24) : x13));
  assign new_n81_ = (new_n82_ | ~x18) & (~x07 | x11 | ~new_n83_ | x14);
  assign new_n82_ = ((~x14 & ~x21) | (x03 & (x06 | ~x11))) & (~x11 | ~x14 | x20);
  assign new_n83_ = x20 & x21;
  assign new_n84_ = (new_n82_ | ~x15) & (x11 | x14 | ~new_n83_ | ~x19);
  assign new_n85_ = ~x02 & ~x10 & x21 & ~new_n86_ & ~x24;
  assign new_n86_ = (~x11 | (x06 & (~x14 | x20))) & ~x00 & x03;
  assign z7 = new_n59_ | (~new_n55_ & ~new_n60_);
endmodule
