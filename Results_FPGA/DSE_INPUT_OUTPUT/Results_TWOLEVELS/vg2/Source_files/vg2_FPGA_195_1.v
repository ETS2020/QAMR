...
module FAU ( 
  ...
  assign new_n42_ = x08 & x09 & x11 & x12 & new_n43_ & x16;
  assign new_n43_ = x17 & x20 & x22 & x23 & (new_n44_ | new_n45_);
  assign new_n44_ = x05 & x13 & x14 & x15;
  ...
  assign new_n58_ = (x05 | x13 | (~new_n59_ & ~new_n61_)) & (x14 | ~x21);
  ...
  assign z3 = (~new_n69_ & ~x24) | ~new_n76_ | (x24 & ~new_n72_ & (x05 | x13));
  assign new_n69_ = x01 ? (~x03 | ~x06 | ~new_n70_ | ~x08) : (x03 | x06 | ~new_n71_ | x08);
  assign new_n70_ = x11 & x20 & (new_n44_ | new_n45_);
  assign new_n71_ = ~x11 & ~x14 & ~new_n48_ & ~x20;
  ...
  assign new_n76_ = (x14 | ~x21) & (x05 | new_n77_ | x13);
  ...
  assign new_n81_ = (new_n82_ | (~x14 & x21)) & (~new_n39_ | x10 | x21 | x24);
  assign new_n82_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n84_ & (x14 | ~x21)) | (x14 & x21 & ~x24 & ~x02 & ~x10);
  ...
  assign new_n87_ = x14 & x21 & ~x24 & x00 & ~x02 & ~x10;
  assign z5 = new_n89_ | ~new_n90_ | new_n38_ | (x07 & x13 & x24);
  assign new_n89_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n90_ = (x05 | x13 | ~x19) & (x14 | ~x21);
  assign z6 = (~new_n94_ & x14) | (~new_n92_ & ~x21);
  assign new_n92_ = (new_n37_ | (~x03 & (x11 | (~new_n93_ & ~x06)))) & (new_n84_ | (x03 & (x06 | ~x11)));
  assign new_n93_ = ~x14 & x20;
  assign new_n94_ = new_n95_ & (new_n66_ | (x03 & (~x11 | (x06 & x20))));
  assign new_n95_ = ~new_n96_ & (new_n82_ | (~x03 & (~x06 | x11)));
  assign new_n96_ = new_n39_ & ~x10 & x21 & ~x24;
endmodule
