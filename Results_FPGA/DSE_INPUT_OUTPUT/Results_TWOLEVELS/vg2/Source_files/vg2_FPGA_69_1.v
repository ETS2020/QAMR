...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n83_, new_n85_, new_n86_, new_n88_;
  assign z0 = ~x01 & new_n36_ & ~x03;
  assign new_n36_ = ~x06 & ~x11 & ~x14 & ~x20 & ~new_n37_ & ~x22;
  ...
  assign new_n40_ = x01 ? (~x03 | ~new_n41_ | ~x04) : (x03 | ~new_n44_ | x04);
  ...
  assign new_n45_ = ~x14 & ~x16 & ~x17 & ~x20 & ~new_n46_ & ~x23;
  ...
  assign new_n55_ = ~new_n60_ & (x05 | x13 | (~new_n56_ & ~new_n58_));
  ...
  assign z2 = (~x06 & x22) | (x01 & x03 & new_n62_ & x06);
  assign new_n62_ = x11 & x14 & ~new_n63_ & x20;
  assign new_n63_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n64_ & (x05 | x13 | ~x15);
  assign new_n64_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = ~new_n66_ | (~x24 & (x01 ? (new_n74_ & x03) : (new_n75_ & ~x03)));
  assign new_n66_ = (~x24 | new_n67_ | (~x05 & ~x13)) & ~new_n60_ & (x05 | new_n71_ | x13);
  ...
  assign new_n75_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign z4 = (~new_n63_ & ~new_n79_) | (~new_n37_ & ~new_n77_);
  assign new_n77_ = (x16 | new_n78_ | x22) & ((~x06 & x22) | (~x08 & (~x09 | x16)));
  assign new_n78_ = ~x17 & (~x04 | x23);
  assign new_n79_ = ((~x06 & x22) | (x08 & (x09 | ~x16))) & (~x06 | ~x16 | new_n80_ | ~x22);
  assign new_n80_ = x17 & (x04 | ~x23);
  assign z5 = (~new_n83_ & x05) | ~new_n82_ | new_n60_ | (~x05 & ~x13 & x19);
  assign new_n82_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n83_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n85_ | x03)) | new_n60_ | (~new_n63_ & (new_n86_ | ~x03));
  assign new_n85_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n86_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n88_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
