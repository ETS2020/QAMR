...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n37_ | (x24 & ~new_n49_ & (x05 | x13));
  ...
  assign z7 = ~new_n37_ & ~new_n58_;
  assign new_n58_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n64_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n37_ | (x24 & ~new_n60_ & (x05 | x13));
  ...
  assign z4 = ~new_n37_ & ((~new_n38_ & (new_n68_ | x08)) | (~new_n58_ & (new_n69_ | ~x08)));
  ...
  assign z6 = (~new_n38_ & (new_n72_ | x03)) | new_n37_ | (~new_n58_ & (new_n73_ | ~x03));
