...
module FAU ( 
  ...
  assign z2 = x01 & (x02 | (x03 & new_n63_ & x06));
  assign new_n63_ = x11 & x14 & x20 & (new_n64_ | new_n65_ | ~new_n66_);
  assign new_n64_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n65_ = x13 & x18 & x24;
  ...
  assign z4 = (~new_n83_ & (~x08 | (~new_n87_ & x16))) | (z5 & (x08 | (~new_n86_ & ~x16)));
  assign z5 = new_n38_ | (~new_n82_ & (~x01 | ~x02));
  assign new_n82_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  ...
  assign z7 = new_n64_ | ~new_n93_ | new_n65_ | (x01 & x02);
  assign new_n93_ = ~new_n85_ & (x05 | x13 | ~x15);
endmodule
