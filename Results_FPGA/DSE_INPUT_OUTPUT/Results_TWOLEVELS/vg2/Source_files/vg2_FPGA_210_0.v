...
module FAU ( 
  ...
  assign z2 = (new_n61_ & x01) | ((new_n59_ | ~x01) & ~x02);
  ...
  assign z4 = (~new_n73_ & (new_n77_ | x08)) | new_n79_ | (~new_n75_ & (new_n78_ | ~x08));
  assign new_n73_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n74_ & (x05 | x13 | ~x19);
  ...
  assign z7 = (~new_n62_ & (x01 | x02)) | (~x10 & x21 & ~x24 & x01 & ~x02);
