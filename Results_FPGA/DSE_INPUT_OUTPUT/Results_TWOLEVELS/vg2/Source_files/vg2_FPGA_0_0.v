...
module FAU ( 
  ...
  assign new_n78_ = (new_n80_ | ~x05) & (new_n79_ | ~x13) & (x05 | x13 | ~x19 | ~x21);
  assign new_n79_ = ~new_n38_ & (~x07 | ~x24);
  assign new_n80_ = (~x13 | ~x19 | x24) & (~x07 | ~x21 | ~x24);
  assign z7 = new_n82_ | (x13 & x18 & x24) | (~new_n83_ & x21);
  assign new_n82_ = x05 & ((x13 & x15 & ~x24) | (x18 & x21 & x24));
  assign new_n83_ = (x05 | x13 | ~x15) & (x02 | x10 | x24);
  ...
  assign new_n88_ = x00 & ~x02 & ~x10 & (x13 | x21);
  assign new_n89_ = (~x19 | ~x21 | x05 | x13) & (~x07 | ~x24 | (~x13 & (~x05 | ~x21)));
