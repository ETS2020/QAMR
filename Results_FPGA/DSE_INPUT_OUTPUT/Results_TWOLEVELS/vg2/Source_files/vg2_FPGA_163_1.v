...
module FAU ( 
  ...
  assign new_n63_ = (new_n64_ | (~x21 & x23)) & (x02 | x10 | ~x21 | x24);
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n66_ & ~x24) | ~new_n70_ | (x24 & ~new_n74_ & (x05 | x13));
  ...
  assign new_n70_ = (x21 | ~x23) & (x05 | new_n71_ | x13);
  ...
  assign new_n74_ = (~new_n76_ | ~new_n75_ | ~x01 | ~x03) & (~new_n77_ | ~new_n55_ | x01 | x03);
  assign new_n75_ = x06 & x08;
  assign new_n76_ = x18 & x20 & x11 & x14;
  assign new_n77_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign z4 = (~x23 & (new_n85_ | (~new_n37_ & ~new_n86_))) | (~new_n79_ & x21);
  assign new_n79_ = (new_n82_ | (~new_n83_ & ~x08)) & ~new_n38_ & (new_n80_ | (~new_n84_ & x08));
  ...
  assign new_n85_ = ~new_n64_ & (~x08 | (x16 & (~x09 | (~x17 & x22))));
  assign new_n86_ = ~x08 & (x16 | (~x09 & (x22 | (~x04 & ~x17))));
  assign z5 = ~new_n37_ & (x21 | ~x23);
  assign z6 = ~new_n89_ | (~new_n91_ & (new_n92_ | (~new_n82_ & (x21 | ~x23))));
  assign new_n89_ = ~new_n90_ & (~x00 | x02 | x10 | ~x21 | x24);
  assign new_n90_ = ~new_n63_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n91_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n92_ = x00 & ~x02 & ~x10 & ~x23 & ~x24;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n94_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n94_ = (x21 | ~x23) & (x02 | x10 | ~x21 | x24);
endmodule
