...
module FAU ( 
  ...
  assign z4 = (~new_n79_ & (new_n83_ | x08)) | new_n82_ | (~new_n64_ & (new_n84_ | ~x08));
  ...
  assign z5 = new_n37_ | ~new_n80_ | new_n38_ | new_n82_;
  assign z6 = (~new_n79_ & (new_n87_ | x03)) | new_n82_ | (~new_n64_ & (new_n88_ | ~x03));
  assign new_n87_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n88_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n90_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n90_ = ~new_n65_ & (x05 | x13 | ~x15) & ~new_n82_ & (~new_n91_ | ~x13);
