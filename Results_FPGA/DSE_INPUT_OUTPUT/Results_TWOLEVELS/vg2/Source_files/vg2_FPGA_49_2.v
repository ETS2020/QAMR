...
module FAU ( 
  ...
  assign new_n53_ = x05 ? ~new_n56_ : new_n54_;
  assign new_n54_ = (x13 | ~x19) & ~new_n55_ & (~x07 | ~x13 | ~x24);
  assign new_n55_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n56_ = x21 & ((x13 & x19 & ~x24) | (x07 & x24));
  assign new_n57_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n58_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n59_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z6 = new_n61_ | new_n63_ | (x05 & ~x21);
  assign new_n61_ = ~new_n62_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n62_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n55_ & (x05 | x13 | ~x19);
