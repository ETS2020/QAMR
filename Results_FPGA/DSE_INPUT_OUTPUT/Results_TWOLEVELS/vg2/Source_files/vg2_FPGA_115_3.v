...
module FAU ( 
  ...
  assign z2 = x01 & ~x02 & x03 & new_n64_ & x06;
  assign new_n64_ = x11 & x14 & x20 & (new_n65_ | new_n66_ | ~new_n67_);
  assign new_n65_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n66_ = x13 & x18 & x24;
  assign new_n67_ = (x05 | x13 | ~x15) & (x10 | ~x21 | x24);
  ...
  assign z4 = (~new_n37_ & (new_n85_ | x08)) | new_n87_ | (~new_n82_ & (new_n86_ | ~x08));
  assign new_n82_ = ~new_n65_ & new_n83_ & ~new_n66_;
  ...
  assign z5 = new_n38_ | (~new_n87_ & ~new_n89_);
  assign new_n89_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign z6 = new_n91_ | (~new_n92_ & (new_n84_ | (~new_n87_ & ~new_n93_)));
  ...
  assign z7 = new_n65_ | ~new_n83_ | new_n66_ | new_n87_;
endmodule
