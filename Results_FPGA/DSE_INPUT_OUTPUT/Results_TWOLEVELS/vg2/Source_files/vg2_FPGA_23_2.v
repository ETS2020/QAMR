...
module FAU ( 
  ...
  assign new_n43_ = x14 & x17 & x20 & x22 & ~new_n44_ & x23;
  ...
  assign new_n48_ = ~new_n49_ & (~new_n53_ | ~new_n55_ | ~x12 | ~x14 | ~x17);
  assign new_n49_ = new_n50_ & new_n52_ & ~x11 & ~x14 & ~x16;
  ...
  assign new_n56_ = (~x12 | x16) & (x05 | x13 | (~new_n57_ & ~new_n59_));
  assign new_n57_ = new_n53_ & new_n58_ & x12 & x14 & x15;
  assign new_n58_ = x22 & x23 & x17 & x20;
  assign new_n59_ = new_n60_ & new_n61_ & ~x14 & ~x16 & ~x17;
  assign new_n60_ = new_n51_ & ~x09 & ~x11 & ~x06 & ~x08;
  assign new_n61_ = x19 & ~x20 & ~x22 & ~x23;
  assign z2 = (new_n63_ & x01) | (x12 & ~x16);
  ...
  assign z3 = (~new_n67_ & ~x24) | ~new_n74_ | (x24 & ~new_n70_ & (x05 | x13));
  ...
  assign new_n74_ = (~x12 | x16) & (x05 | new_n75_ | x13);
  ...
  assign z4 = (~new_n81_ & (~x12 | x16)) | (~x12 & new_n79_ & ~x16) | (new_n80_ & x16);
  assign new_n79_ = ~new_n38_ & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n80_ = ~new_n64_ & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n81_ = (x24 | (~new_n82_ & (~x05 | new_n83_ | ~x13))) & (~x24 | new_n84_ | (~x05 & ~x13)) & (x05 | new_n83_ | x13);
  assign new_n82_ = ~x02 & ~x10 & (x08 ? x00 : x21);
  assign new_n83_ = x08 ? ~x19 : ~x15;
  assign new_n84_ = x08 ? ~x07 : ~x18;
  assign z6 = (new_n86_ | new_n87_) & (~x12 | x16);
  assign new_n86_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n87_ = ~new_n64_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n89_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n89_ = ~new_n65_ & (~x12 | x16);
endmodule
