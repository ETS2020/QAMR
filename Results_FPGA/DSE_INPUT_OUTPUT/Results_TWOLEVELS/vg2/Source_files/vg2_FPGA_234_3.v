...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n84_ | x08)) | new_n86_ | (~new_n81_ & (new_n85_ | ~x08));
  assign new_n81_ = ~new_n64_ & new_n82_ & ~new_n65_;
  assign new_n82_ = ~new_n83_ & (x05 | x13 | ~x15);
  ...
  assign new_n88_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign z6 = new_n90_ | (~new_n91_ & (new_n83_ | (~new_n86_ & ~new_n92_)));
  ...
  assign z7 = new_n64_ | ~new_n82_ | new_n65_ | new_n86_;
endmodule
