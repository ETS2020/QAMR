...
module FAU ( 
  ...
  assign z2 = new_n53_ | (new_n50_ & x01);
  assign new_n50_ = x03 & x06 & x11 & x14 & ~new_n51_ & x20;
  assign new_n51_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n52_ & (x05 | x13 | ~x15);
  ...
  assign z4 = (~new_n57_ & (new_n59_ | x08)) | new_n53_ | (~new_n51_ & (new_n60_ | ~x08));
  assign new_n57_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n58_ & (x05 | x13 | ~x19);
  assign new_n58_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n59_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n60_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n62_ | (x07 & x24 & (x05 | x13));
  assign new_n62_ = ~new_n58_ & (x05 | x13 | ~x19) & (~x05 | (~x21 & (~x13 | ~x19 | x24)));
  assign z6 = (~new_n67_ & (new_n66_ | (~new_n65_ & ~x21))) | new_n64_ | new_n68_;
  assign new_n64_ = ~new_n46_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n65_ = ~new_n58_ & (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24)));
  assign new_n66_ = ~x05 & ((~x13 & x19) | (x07 & x13 & x24));
  assign new_n67_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n68_ = x00 & ~x02 & ~x05 & ~x10 & x21 & ~x24;
  assign z7 = ~new_n70_ | (x13 & ((x18 & x24) | (x05 & x15 & ~x24)));
  assign new_n70_ = ~new_n52_ & (x05 | x13 | ~x15) & (~x05 | (~new_n71_ & ~x21));
