...
module FAU ( 
  ...
  assign new_n49_ = (~new_n41_ | ~new_n50_) & (~new_n53_ | ~new_n54_ | ~new_n45_ | ~new_n52_);
  ...
  assign z3 = ~new_n73_ | (x24 & ~new_n69_ & (x05 | x13)) | (~new_n64_ & ~x24);
  ...
  assign z5 = (~new_n83_ & ~x24) | (~new_n85_ & (~x21 | ~x23));
  assign new_n83_ = ~new_n84_ & (~x00 | x02 | x10 | (x21 & (~x21 | x23)));
  assign new_n84_ = x05 & x13 & x19 & (~x21 | ~x23);
  assign new_n85_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign z6 = (~new_n87_ & (new_n91_ | x03)) | new_n93_ | (z7 & (new_n92_ | ~x03));
  assign new_n87_ = (new_n89_ | (x21 & x23)) & (~new_n88_ | x10 | x21 | x24);
  assign new_n88_ = x00 & ~x02;
  assign new_n89_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign z7 = (~new_n79_ & (~x21 | ~x23)) | (~x02 & ~x10 & x21 & ~x23 & ~x24);
  assign new_n91_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n92_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n93_ = x21 & ~x23 & ~x24 & x00 & ~x02 & ~x10;
endmodule
