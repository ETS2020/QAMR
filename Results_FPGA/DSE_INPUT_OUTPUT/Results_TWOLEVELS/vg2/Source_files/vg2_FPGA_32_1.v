...
module FAU ( 
  ...
  assign new_n77_ = x06 & x08 & x11 & x14 & (new_n43_ | new_n44_);
  assign new_n78_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n47_ & ~x20;
  assign z4 = (~new_n80_ & (new_n84_ | x08)) | new_n86_ | (z7 & (new_n85_ | ~x08));
  assign new_n80_ = ~new_n81_ & (~x00 | x02 | x10 | x21 | x24);
  assign new_n81_ = ~new_n63_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign z7 = (~new_n83_ & (x20 | ~x21)) | (x20 & x21 & ~x24 & ~x02 & ~x10);
  ...
  assign new_n86_ = x20 & x21 & ~x24 & x00 & ~x02 & ~x10;
  assign z5 = (~new_n89_ & x05) | ~new_n88_ | new_n63_ | (~x05 & ~x13 & x19);
  assign new_n88_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n89_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n91_ & ~x21) | (x20 & (~new_n96_ | (~new_n93_ & ~x24)));
  assign new_n91_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n83_ | (x03 & (~x11 | (~new_n92_ & x06))));
  assign new_n92_ = x14 & ~x20;
  assign new_n93_ = (x02 | new_n94_ | x10) & (~x05 | new_n95_ | ~x13);
  assign new_n94_ = (~x00 | (~x21 & (x11 | x14))) & (~x21 | (x03 & (x06 | ~x11)));
  assign new_n95_ = (~x19 | (~x03 & (x11 | (~x06 & x14)))) & (~x15 | (x03 & (x06 | ~x11)));
  assign new_n96_ = (new_n97_ | (x03 & (x06 | ~x11))) & (new_n98_ | (~x03 & (x11 | (~x06 & x14))));
  assign new_n97_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n98_ = (x05 | x13 | ~x19) & (~x07 | (~x05 & ~x13) | ~x24);
endmodule
