...
module FAU ( 
  ...
  assign z1 = new_n55_ | (x21 & (new_n51_ | (~new_n42_ & ~x24)));
  ...
  assign new_n46_ = new_n47_ & new_n50_ & x14 & x16 & x11 & x12;
  assign new_n47_ = new_n48_ & x03 & x04 & new_n49_ & x09 & ~x10;
  assign new_n48_ = x01 & ~x02;
  assign new_n49_ = x06 & x08;
  assign new_n50_ = x22 & x23 & x17 & x20;
  assign new_n51_ = ~x01 & ~x03 & new_n52_ & ~x04;
  assign new_n52_ = ~x06 & ~x08 & ~x09 & ~x11 & new_n53_ & ~x12;
  assign new_n53_ = ~x14 & ~x16 & ~x17 & ~x20 & new_n54_ & ~x22;
  assign new_n54_ = ~x23 & ((~x05 & ~x13 & x19) | (x07 & x24 & (x05 | x13)));
  ...
  assign z2 = new_n40_ | (new_n60_ & x01);
  ...
  assign z3 = (~new_n64_ & ~new_n40_) | (new_n74_ & new_n48_ & new_n49_ & x03);
  assign new_n64_ = (new_n69_ | (x05 ? (~x13 | x24) : x13)) & ~new_n72_ & (~x24 | new_n65_ | (~x05 & ~x13));
  ...
  assign z4 = (~new_n38_ & (new_n76_ | x08)) | new_n40_ | (~new_n61_ & (new_n77_ | ~x08));
  assign new_n76_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n77_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = new_n79_ | new_n83_ | (~new_n82_ & (new_n62_ | (~new_n40_ & ~new_n58_)));
  assign new_n79_ = ~new_n80_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n80_ = ~new_n81_ & (~x00 | x02 | x10 | ~x12 | x24);
  assign new_n81_ = ~new_n40_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  ...
  assign new_n85_ = ~new_n40_ & ~new_n62_;
endmodule
