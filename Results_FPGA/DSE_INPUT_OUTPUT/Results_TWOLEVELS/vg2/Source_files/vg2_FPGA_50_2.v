...
module FAU ( 
  ...
  assign new_n44_ = ~x08 & ~x09 & ~x12 & new_n45_ & ~x14;
  ...
  assign new_n59_ = new_n50_ & ~x09 & ~x12 & ~x06 & ~x08;
  assign new_n60_ = x19 & ~x20 & ~x22 & ~x23;
  assign new_n61_ = x11 & ~x12;
  assign z2 = x11 & (new_n63_ | ~x12);
  ...
  assign z6 = (~new_n84_ & (~x11 | x12)) | (new_n82_ & ~x11) | (x11 & new_n83_ & x12);
  assign new_n82_ = ~new_n37_ & (x06 | (~x14 & x20));
  assign new_n83_ = ~new_n64_ & (~x06 | (x14 & ~x20));
  assign new_n84_ = (x24 | (~new_n85_ & (~x05 | new_n86_ | ~x13))) & (~x24 | new_n87_ | (~x05 & ~x13)) & (x05 | new_n86_ | x13);
  ...
  assign new_n89_ = ~new_n65_ & (x05 | x13 | ~x15) & ~new_n61_ & (~new_n90_ | ~x13);
