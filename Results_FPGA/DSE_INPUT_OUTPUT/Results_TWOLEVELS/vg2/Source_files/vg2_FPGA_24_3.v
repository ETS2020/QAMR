...
module FAU ( 
  ...
  assign new_n37_ = (new_n38_ | ~x05) & ~new_n40_ & (x05 | x13 | new_n39_ | ~x19);
  assign new_n38_ = (x02 | ~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n39_ = x02 & x24;
  assign new_n40_ = ~x02 & ((x07 & x13 & x24) | (x00 & ~x10 & ~x24));
  assign z1 = (~new_n42_ & ~x24) | (~new_n49_ & x24) | (~x05 & ~new_n58_ & ~x13);
  ...
  assign new_n49_ = ~x02 & ((~new_n50_ & ~new_n54_) | (~x05 & ~x13));
  assign new_n50_ = new_n51_ & new_n53_ & x22 & x23 & x18 & x20;
  ...
  assign new_n58_ = ~new_n59_ & (~new_n61_ | ~new_n63_ | x01 | x03 | x04);
  ...
  assign z7 = (~new_n67_ & x05) | new_n68_ | (~x05 & ~x13 & ~new_n39_ & x15);
  assign new_n67_ = (x02 | ~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n68_ = ~x02 & ((x13 & x18 & x24) | (~x10 & x21 & ~x24));
  assign z3 = new_n70_ | (~x24 & ~new_n80_ & (~x05 ^ x13));
  assign new_n70_ = ~x02 & (~new_n75_ | (x24 & ~new_n71_ & (x05 | x13)));
  ...
  assign new_n77_ = (x10 | ~x21 | x24) & (x05 | x13 | ~x15);
  assign new_n78_ = ~x11 & ~x14 & ~new_n79_ & ~x20;
  assign new_n79_ = (~x00 | x10 | x24) & (x05 | x13 | ~x19);
  ...
  assign z5 = new_n89_ | ~new_n87_ | (x24 & (x02 | (x07 & x13)));
  assign new_n87_ = ~new_n88_ & (x05 | x13 | ~x19);
  assign new_n88_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n89_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign z6 = (~new_n91_ & (new_n94_ | x03)) | new_n39_ | (~new_n92_ & (new_n95_ | ~x03));
  assign new_n91_ = ~new_n89_ & new_n87_ & (~x07 | ~x13 | ~x24);
