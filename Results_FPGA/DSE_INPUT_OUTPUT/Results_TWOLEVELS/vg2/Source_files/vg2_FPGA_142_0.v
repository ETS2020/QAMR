// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:53 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n75_, new_n76_, new_n79_, new_n80_, new_n82_;
  ...
  assign z6 = (~new_n72_ & (new_n79_ | x03)) | new_n76_ | (~new_n60_ & (new_n80_ | ~x03));
  assign new_n79_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n80_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n82_ & (x01 | x02)) | (~x10 & x21 & ~x24 & x01 & ~x02);
