...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | new_n47_ | new_n56_ | new_n60_;
  ...
  assign new_n57_ = x07 & ~x08 & ~x09 & ~x11 & new_n58_ & ~x12;
  assign new_n58_ = ~x14 & ~x16 & ~x17 & new_n59_ & ~x20;
  assign new_n59_ = ~x22 & ~x23 & x24 & (x05 | x13);
  assign new_n60_ = x11 & x18;
  assign z2 = x01 & new_n62_ & x03;
  assign new_n62_ = x06 & x11 & x14 & ~x18 & ~new_n63_ & x20;
  assign new_n63_ = ~new_n64_ & (~x15 | (x05 ? (~x13 | x24) : x13));
  assign new_n64_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~new_n66_ & ~x24) | new_n72_ | (~x05 & ~new_n69_ & ~x13);
  assign new_n66_ = x01 ? (~x03 | ~x06 | ~new_n67_ | ~x08) : (x03 | x06 | ~new_n68_ | x08);
  assign new_n67_ = x11 & x14 & ~x18 & ~new_n43_ & x20;
  assign new_n68_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign new_n69_ = (~new_n70_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n71_ | x01 | x03 | x06 | x08);
  assign new_n70_ = x11 & x14 & x15 & ~x18 & x20;
  assign new_n71_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n72_ = ~x01 & ~x03 & ~x06 & x07 & new_n73_ & ~x08;
  assign new_n73_ = ~x11 & ~x14 & ~x20 & x24 & (x05 | x13);
  assign z4 = (~new_n37_ & (new_n76_ | x08)) | new_n60_ | (~new_n75_ & (new_n77_ | ~x08));
  assign new_n75_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n64_ & (x05 | x13 | ~x15);
  assign new_n76_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n77_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n60_;
  assign z6 = (~new_n37_ & (x03 | (~new_n81_ & ~x11))) | (~new_n80_ & x11) | (~new_n75_ & ~x03);
  assign new_n80_ = ~x18 & (new_n63_ | (x06 & (~x14 | x20)));
  assign new_n81_ = ~x06 & (x14 | ~x20);
  assign z7 = (~new_n63_ & (~x11 | ~x18)) | (~x11 & x18 & x24 & (x05 | x13));
endmodule
