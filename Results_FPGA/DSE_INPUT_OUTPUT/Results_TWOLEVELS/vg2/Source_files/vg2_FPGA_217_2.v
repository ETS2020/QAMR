...
module FAU ( 
  ...
  assign new_n56_ = ~new_n62_ & (x10 | x24 | (~new_n57_ & (~new_n53_ | ~new_n60_)));
  ...
  assign new_n78_ = ~new_n62_ & (x05 | new_n79_ | x13);
  ...
  assign z4 = (~new_n65_ & (~x08 | (~new_n84_ & x16))) | (z5 & (x08 | (~new_n83_ & ~x16)));
  assign new_n83_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n84_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n65_ & (~x03 | (~new_n87_ & x11))) | (z5 & (x03 | (~new_n86_ & ~x11)));
  assign new_n86_ = ~x06 & (x14 | ~x20);
  assign new_n87_ = x06 & (~x14 | x20);
  assign z7 = ~new_n89_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n89_ = ~new_n62_ & (~new_n90_ | ~x13) & ~new_n67_ & (x05 | x13 | ~x15);
