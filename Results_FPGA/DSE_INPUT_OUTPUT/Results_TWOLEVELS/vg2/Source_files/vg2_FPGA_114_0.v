...
module FAU ( 
  ...
  assign new_n58_ = x14 & x20 & (new_n59_ | new_n60_ | new_n61_ | new_n62_);
  assign new_n59_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n60_ = x13 & x18 & x24;
  assign new_n61_ = ~x05 & ~x13 & x15;
  assign new_n62_ = x21 & ~x24 & ~x02 & ~x10;
  assign z3 = (x21 & (new_n64_ | (~x01 & new_n68_ & ~x03))) | (x01 & new_n69_ & x03);
  assign new_n64_ = ~new_n65_ & ~x24;
  assign new_n65_ = (~new_n67_ | ~x03 | ~x06 | ~x01 | x02) & (x01 | x03 | ~new_n66_ | x06);
  assign new_n66_ = ~x08 & ~x11 & ~x14 & ~new_n44_ & ~x20;
  assign new_n67_ = x08 & ~x10 & x11 & x14 & x20;
  assign new_n68_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n52_ & ~x20;
  assign new_n69_ = x06 & x08 & x11 & x14 & ~new_n56_ & x20;
  assign z4 = (~new_n71_ & (new_n75_ | x08)) | new_n74_ | (~new_n73_ & (new_n76_ | ~x08));
  assign new_n71_ = (new_n72_ | (~x20 & ~x21)) & (~new_n39_ | x10 | ~x20 | x24);
  assign new_n72_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n73_ = ~new_n62_ & (new_n56_ | (~x20 & ~x21));
  assign new_n74_ = new_n39_ & ~x10 & x21 & ~x24;
  ...
  assign new_n79_ = (x05 | x13 | ~x19) & (x20 | x21);
  assign z6 = (~new_n81_ & x20) | (~new_n82_ & x21);
  assign new_n81_ = (new_n37_ | (~x03 & (x11 | (~x06 & x14)))) & (new_n56_ | (x03 & (x06 | ~x11)));
  assign new_n82_ = ~new_n83_ & ~new_n38_ & (new_n72_ | (~x03 & (~x06 | x11)));
  assign new_n83_ = ~new_n84_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n84_ = ~new_n59_ & ~new_n60_ & ~new_n61_ & (x02 | x10 | x24);
  assign z7 = new_n59_ | new_n60_ | new_n61_ | new_n62_ | (~x20 & ~x21);
endmodule
