...
module FAU ( 
  ...
  assign z4 = (~new_n85_ & (~x08 | (~new_n89_ & x16))) | (z5 & (x08 | (~new_n88_ & ~x16)));
  assign z5 = new_n38_ | (~new_n84_ & (~x01 | ~x02));
  assign new_n84_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n85_ = ~new_n87_ & (new_n86_ | (x01 & x02));
  assign new_n86_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
  assign new_n87_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n88_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n89_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n91_ | new_n92_ | (x01 & x02);
  assign new_n91_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n92_ = ~new_n93_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n93_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n87_ & (x05 | x13 | ~x15);
  assign z7 = new_n66_ | ~new_n95_ | new_n67_ | (x01 & x02);
  assign new_n95_ = ~new_n87_ & (x05 | x13 | ~x15);
endmodule
