...
module FAU ( 
  ...
  assign new_n46_ = ~x14 & ~x16 & ~x17 & ~x22 & ~new_n47_ & ~x23;
  ...
  assign new_n62_ = x06 & x11 & x14 & x20 & ~new_n63_ & x22;
  ...
  assign new_n67_ = x11 & x14 & x20 & ~new_n44_ & x22;
  assign new_n68_ = ~x11 & ~x14 & ~new_n47_ & ~x20;
  assign new_n69_ = ~new_n70_ & (~new_n72_ | x01 | x03 | x06 | ~x07);
  assign new_n70_ = new_n71_ & x06 & x08 & x01 & x03;
  assign new_n71_ = x11 & x14 & x18 & x20 & x22;
  ...
  assign new_n75_ = x11 & x14 & x15 & x20 & x22;
  assign z4 = (~new_n37_ & (new_n77_ | x08)) | new_n39_ | (~new_n63_ & (new_n78_ | ~x08));
  ...
  assign z6 = ~new_n84_ | (~new_n83_ & ~new_n39_);
