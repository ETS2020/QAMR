...
module FAU ( 
  ...
  assign new_n56_ = (x21 | x22) & (x05 | x13 | (~new_n57_ & ~new_n59_));
  ...
  assign z2 = (~x21 & ~x22) | (new_n63_ & x01);
  ...
  assign z4 = ~new_n80_ | (~new_n37_ & (x08 | (x09 & ~x16)));
  assign new_n80_ = (new_n64_ | (~new_n83_ & x08)) & (new_n81_ | x22);
  ...
  assign z6 = ~new_n86_ | (~new_n90_ & (new_n91_ | (~new_n82_ & (x21 | x22))));
  assign new_n86_ = ~new_n89_ & (new_n87_ | (~new_n65_ & (new_n88_ | (~x21 & ~x22))));
  ...
  assign new_n91_ = x00 & ~x02 & ~x10 & x22 & ~x24;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n93_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n93_ = ~new_n65_ & (x21 | x22);
endmodule
