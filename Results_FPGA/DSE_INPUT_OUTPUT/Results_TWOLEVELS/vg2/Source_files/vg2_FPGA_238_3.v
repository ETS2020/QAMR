...
module FAU ( 
  ...
  assign z4 = ((new_n85_ | x08) & (new_n80_ | new_n38_)) | (z7 & (new_n86_ | ~x08));
  assign new_n80_ = ~new_n81_ & (~x01 | ~x02);
  ...
  assign new_n93_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n84_ & (x05 | x13 | ~x15);
endmodule
