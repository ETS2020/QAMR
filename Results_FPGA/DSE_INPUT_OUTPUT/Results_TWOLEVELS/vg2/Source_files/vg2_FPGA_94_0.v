...
module FAU ( 
  ...
  assign new_n58_ = ~new_n40_ & (x05 | (~new_n59_ & ~new_n61_) | x13);
  ...
  assign new_n62_ = new_n56_ & ~x09 & ~x11 & ~x06 & ~x08;
  assign new_n63_ = x19 & ~x20 & ~x22 & ~x23;
  assign z2 = x01 & x03 & x06 & new_n65_ & x11;
  assign new_n65_ = x14 & x20 & (~new_n68_ | (~new_n66_ & ~new_n40_));
  assign new_n66_ = ~new_n67_ & (x05 | x13 | ~x15);
  assign new_n67_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n68_ = (~x13 | ~x18 | ~x24) & (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | (~x18 & (~x12 | x24)))));
  assign z3 = (~new_n40_ & (x01 ? (new_n70_ & x03) : (new_n71_ & ~x03))) | (x01 & new_n72_ & x03);
  assign new_n70_ = x06 & x08 & x11 & x14 & ~new_n66_ & x20;
  assign new_n71_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n38_ & ~x20;
  assign new_n72_ = x06 & x08 & x11 & x14 & ~new_n68_ & x20;
  assign z4 = (~new_n38_ & (new_n75_ | x08)) | new_n40_ | (~new_n74_ & (new_n76_ | ~x08));
  assign new_n74_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign new_n75_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n76_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n38_ & (new_n78_ | x03)) | new_n40_ | (~new_n74_ & (new_n79_ | ~x03));
  ...
  assign new_n81_ = ~new_n40_ & ~new_n67_;
endmodule
