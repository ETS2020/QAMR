...
module FAU ( 
  ...
  assign z4 = (~new_n80_ & x24) | new_n86_ | (~x02 & ~x10 & ~new_n91_ & ~x24);
  assign new_n80_ = (~new_n85_ | ~x15) & (new_n81_ | (~x05 & ~x13));
  assign new_n81_ = ~new_n82_ & (~x18 | ((x08 | x15) & (new_n84_ | ~x16)));
  assign new_n82_ = x07 & ((~new_n83_ & ~x16) | (~new_n39_ & x08));
  assign new_n83_ = (x15 | (~x09 & (~x04 | x22 | x23))) & (~x17 | x22);
  assign new_n84_ = (x15 | (x09 & (x17 | ~x22))) & (~x22 | ~x23 | x04 | ~x17);
  assign new_n85_ = x17 & ((~x08 & (x18 | (x07 & x09 & ~x16))) | (~x09 & x16 & x18));
  assign new_n86_ = ~new_n87_ & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n87_ = (new_n88_ | ~x17) & (x15 | ~x19 | (~new_n90_ & ~x08));
  assign new_n88_ = (~x15 | (x08 & ~x19 & (new_n89_ | ~x16))) & (x16 | ~x19 | x22);
  assign new_n89_ = x09 & (x04 | ~x22 | ~x23);
  assign new_n90_ = ~x16 & (x09 | (x04 & ~x22 & ~x23));
  assign new_n91_ = ~new_n92_ & (~x00 | ~new_n93_ | x16) & (~new_n94_ | ~x16);
  assign new_n92_ = ~new_n39_ & ((x00 & (x08 | (x09 & ~x16))) | (x21 & (~x08 | (~x09 & x16))));
  assign new_n93_ = ~x22 & (x17 | (x04 & ~x15 & ~x23));
  assign new_n94_ = x21 & x22 & ((~x15 & ~x17) | (~x04 & x17 & x23));
  ...
  assign z7 = (~new_n103_ & x05) | ~new_n102_ | (x15 & (~x17 | (~x05 & ~x13)));
  assign new_n102_ = ~new_n67_ & (~x13 | ~x18 | ~x24);
  assign new_n103_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
endmodule
