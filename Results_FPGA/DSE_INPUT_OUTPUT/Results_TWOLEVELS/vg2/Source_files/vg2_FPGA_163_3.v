...
module FAU ( 
  ...
  assign z3 = ~new_n64_ | (~x24 & (x01 ? (new_n73_ & x03) : (new_n75_ & ~x03)));
  assign new_n64_ = (~x24 | new_n65_ | (~x05 & ~x13)) & ~new_n39_ & (x05 | new_n70_ | x13);
  assign new_n65_ = (~new_n66_ | ~new_n67_) & (~new_n68_ | ~new_n69_);
  assign new_n66_ = x01 & x03 & x06 & x08;
  assign new_n67_ = x11 & x14 & x18 & x20;
  assign new_n68_ = ~x01 & ~x03 & ~x06 & x07;
  ...
  assign z4 = (~new_n86_ & ~new_n62_) | (~new_n78_ & ~x23) | (new_n85_ & ~x21);
  assign new_n78_ = ~new_n83_ & (x24 | (~new_n81_ & (x02 | new_n79_ | x10)));
  assign new_n79_ = (~x00 | (~x21 & (~x04 | x16 | x22))) & (new_n80_ | ~x21);
  assign new_n80_ = x08 & (~x16 | (x09 & (x17 | ~x22)));
  assign new_n81_ = x05 & x13 & ~new_n82_ & x19;
  assign new_n82_ = ~x08 & (x16 | (~x09 & (x22 | (~x04 & ~x17))));
  assign new_n83_ = ~new_n82_ & ~new_n84_;
  assign new_n84_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign new_n85_ = ~new_n37_ & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  assign new_n86_ = (new_n80_ | (x21 & x23)) & (x04 | ~x16 | x21 | ~x22 | ~x23);
  assign z5 = (~new_n39_ & ~new_n84_) | (~new_n88_ & ~x24);
  assign new_n88_ = ~new_n89_ & (~x05 | ~x13 | new_n39_ | ~x19);
  assign new_n89_ = x00 & ~x02 & ~x10 & (~x21 | (x21 & ~x23));
  assign z6 = (~new_n91_ & (new_n93_ | x03)) | new_n95_ | (~new_n61_ & (new_n94_ | ~x03));
  assign new_n91_ = ~new_n92_ & (x10 | x21 | x24 | ~x00 | x02);
  assign new_n92_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n93_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n94_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n95_ = x21 & ~x23 & ~x24 & x00 & ~x02 & ~x10;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n97_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n97_ = x21 & (x23 | (~x02 & ~x10 & ~x24));
endmodule
