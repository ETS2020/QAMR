...
module FAU ( 
  ...
  assign new_n65_ = x06 & x11 & x14 & ~new_n66_ & x20;
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign new_n67_ = ~x10 & x21 & ~x24;
  assign z3 = (~new_n69_ & ~new_n49_) | (new_n73_ & x24) | (new_n77_ & ~x02);
  assign new_n69_ = ~new_n70_ & (~new_n72_ | x01 | x03 | x06 | x08);
  assign new_n70_ = new_n71_ & x08 & x11 & x14 & x15 & x20;
  assign new_n71_ = x01 & ~x02 & x03 & x06;
  assign new_n72_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n73_ = (x05 | x13) & (new_n74_ | new_n75_);
  assign new_n74_ = new_n71_ & x08 & x11 & x14 & x18 & x20;
  assign new_n75_ = new_n76_ & ~x06 & x07 & ~x01 & ~x03;
  assign new_n76_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n77_ = ~x10 & ~x24 & (new_n78_ | new_n79_);
  assign new_n78_ = new_n76_ & x00 & ~x01 & ~x03 & ~x06;
  assign new_n79_ = new_n80_ & x01 & x03 & x06 & x08;
  assign new_n80_ = x11 & x14 & x20 & x21;
  assign z4 = (~new_n37_ & (new_n84_ | x08)) | new_n86_ | (~new_n82_ & (new_n85_ | ~x08));
  ...
  assign z5 = (~new_n89_ & x05) | ~new_n88_ | new_n38_ | (~x05 & ~x13 & x19);
  assign new_n88_ = ~new_n86_ & (~x07 | ~x13 | ~x24);
  assign new_n89_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n91_ | x03)) | new_n86_ | (~new_n82_ & (new_n92_ | ~x03));
  assign new_n91_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n92_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n83_ | (~new_n86_ & ~new_n94_);
