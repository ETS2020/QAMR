...
module FAU ( 
  ...
  assign z0 = new_n42_ | (new_n36_ & ~x01);
  ...
  assign new_n42_ = x15 & x21;
  assign z1 = x01 ? (x03 & x04 & new_n47_ & x06) : (~x03 & ~x04 & new_n44_ & ~x06);
  assign new_n44_ = ~x08 & ~x09 & ~x11 & ~x12 & new_n45_ & ~x14;
  assign new_n45_ = ~x16 & ~x17 & ~x20 & ~x22 & z5 & ~x23;
  assign z5 = ~new_n42_ & (new_n38_ | new_n39_ | new_n40_ | new_n41_);
  assign new_n47_ = x08 & x09 & x11 & x12 & new_n48_ & x14;
  assign new_n48_ = x16 & x17 & x20 & x22 & ~new_n49_ & x23;
  assign new_n49_ = ~new_n50_ & (new_n52_ | x15) & (~new_n51_ | ~x15);
  assign new_n50_ = x05 & ((~x15 & x18 & x24) | (x13 & x15 & ~x21 & ~x24));
  assign new_n51_ = ~x21 & ((x18 & x24) | (~x05 & ~x13));
  assign new_n52_ = (~x13 | ~x18 | ~x24) & (x02 | x10 | ~x21 | x24);
  assign z2 = x01 & x03 & new_n54_ & x06;
  assign new_n54_ = x11 & x14 & ~new_n49_ & x20;
  assign z3 = x01 ? (x03 & x06 & new_n54_ & x08) : (~x03 & ~x06 & new_n56_ & ~x08);
  assign new_n56_ = ~x11 & ~x14 & z5 & ~x20;
  assign z4 = (~new_n37_ & (new_n60_ | x08)) | new_n42_ | (~new_n58_ & (new_n61_ | ~x08));
  ...
  assign z6 = (~new_n37_ & (new_n63_ | x03)) | new_n42_ | (~new_n58_ & (new_n64_ | ~x03));
  assign new_n63_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n64_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n66_ & x05) | ~new_n52_ | (x15 & (x21 | (~x05 & ~x13)));
  assign new_n66_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
endmodule
