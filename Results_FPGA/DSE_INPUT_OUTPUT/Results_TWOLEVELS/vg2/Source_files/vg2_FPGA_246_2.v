...
module FAU ( 
  ...
  assign new_n56_ = (x05 | new_n61_ | x13) & (~x05 | x21) & (~x24 | new_n57_ | (~x05 & ~x13));
  ...
  assign z4 = (~new_n69_ & (new_n71_ | x08)) | new_n54_ | (~new_n51_ & (new_n72_ | ~x08));
  assign new_n69_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n70_ & (x05 | x13 | ~x19);
  assign new_n70_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n71_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n72_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n74_ | (x07 & x24 & (x05 | x13));
  assign new_n74_ = (new_n75_ | ~x05) & ~new_n70_ & (x05 | x13 | ~x19);
  assign new_n75_ = x21 & (~x13 | ~x19 | x24);
  assign z6 = (~new_n69_ & (new_n77_ | x03)) | new_n54_ | (~new_n51_ & (new_n78_ | ~x03));
  assign new_n77_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n78_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n80_ | ~new_n52_ | (x05 & (~x21 | (x18 & x24)));
  assign new_n80_ = x13 & ((x18 & x24) | (x05 & x15 & ~x24));
endmodule
