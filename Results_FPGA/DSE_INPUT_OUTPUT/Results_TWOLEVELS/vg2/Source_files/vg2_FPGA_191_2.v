...
module FAU ( 
  ...
  assign z5 = new_n38_ | (~new_n82_ & (~x02 | x12));
  ...
  assign z6 = new_n86_ | new_n87_ | (x02 & ~x12);
  assign new_n86_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n87_ = ~new_n88_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n88_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n65_ & (x05 | x13 | ~x15);
endmodule
