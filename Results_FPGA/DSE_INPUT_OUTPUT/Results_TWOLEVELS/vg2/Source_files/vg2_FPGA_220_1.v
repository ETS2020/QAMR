// Benchmark "FAU" written by ABC on Mon Aug 24 18:14:19 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n74_, new_n75_, new_n77_, new_n78_, new_n79_, new_n82_, new_n84_;
  ...
  assign new_n62_ = x14 & (~x01 | ~x03 | ~x06 | new_n63_ | ~x11);
  ...
  assign z6 = ~new_n82_ | (~new_n37_ & (x03 | (x06 & ~x11)));
  assign new_n82_ = (x14 | ~x20) & (new_n63_ | (x03 & (~x11 | (x06 & (~x14 | x20)))));
