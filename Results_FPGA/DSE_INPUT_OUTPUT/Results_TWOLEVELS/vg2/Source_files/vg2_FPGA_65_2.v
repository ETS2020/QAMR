...
module FAU ( 
  ...
  assign z2 = x03 & (new_n62_ | ~x23);
  assign new_n62_ = x01 & x06 & x11 & x14 & ~new_n63_ & x20;
  ...
  assign new_n67_ = x11 & x14 & x20 & ~new_n43_ & x23;
  ...
  assign new_n71_ = x11 & x14 & x18 & x20 & x23;
  ...
  assign new_n75_ = x11 & x14 & x15 & x20 & x23;
  assign z4 = (~new_n37_ & (new_n77_ | x08)) | new_n79_ | (~new_n63_ & (new_n78_ | ~x08));
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = x03 & ~x23;
  assign z5 = (~new_n82_ & x05) | ~new_n81_ | new_n79_ | (~x05 & ~x13 & x19);
  assign new_n81_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n82_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (x03 ? x23 : new_n84_)) | (~new_n63_ & (new_n85_ | ~x03));
  assign new_n84_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n85_ = x11 & x23 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n87_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n87_ = ~new_n64_ & ~new_n79_;
endmodule
