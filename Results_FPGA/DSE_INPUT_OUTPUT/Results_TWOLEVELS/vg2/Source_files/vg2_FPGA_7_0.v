...
module FAU ( 
  ...
  assign new_n64_ = x20 & (new_n65_ | new_n67_ | (~new_n66_ & x21));
  assign new_n65_ = x05 & ((x18 & x21 & x24) | (x13 & x15 & ~x24));
  assign new_n66_ = (x05 | x13 | ~x15) & (x02 | x10 | x24);
  assign new_n67_ = x13 & x18 & x24;
  ...
  assign new_n86_ = (~x07 | ~x24 | (~x13 & (~x05 | ~x21))) & (~x19 | ~x21 | x05 | x13);
  assign z6 = (~new_n37_ & (new_n88_ | x03)) | new_n39_ | (~new_n80_ & (new_n89_ | ~x03));
  assign new_n88_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n89_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n92_ & x05) | ~new_n91_ | (~x13 & (~x21 | (~x05 & x15)));
  assign new_n91_ = ~new_n67_ & ~new_n81_;
