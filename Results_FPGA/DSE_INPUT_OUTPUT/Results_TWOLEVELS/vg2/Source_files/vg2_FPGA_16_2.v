// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:10 2020
...
module FAU ( 
  ...
  assign z1 = (~new_n41_ & ~x24) | new_n49_ | new_n64_ | (new_n58_ & x24);
  ...
  assign new_n58_ = (x05 | x13) & (new_n59_ | (new_n62_ & new_n47_ & new_n53_));
  ...
  assign new_n64_ = new_n65_ & new_n67_ & x04 & x05 & x01 & x03;
  assign new_n65_ = new_n66_ & x13 & x14 & x15 & x16;
  assign new_n66_ = x17 & x18 & x20 & x22 & x23;
  assign new_n67_ = x06 & x08 & x09 & x11 & x12;
  assign z2 = x01 & x03 & x06 & new_n69_ & x11;
  assign new_n69_ = x14 & x20 & (~new_n72_ | (~new_n70_ & ~new_n39_));
  assign new_n70_ = ~new_n71_ & (x05 | x13 | ~x15);
  assign new_n71_ = x21 & ~x24 & ~x02 & ~x10;
  assign new_n72_ = (~x13 | ~x18 | ~x24) & (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | (~x18 & (x12 | x24)))));
  assign z3 = ~new_n74_ | (~x24 & (x01 ? (new_n82_ & x03) : (new_n84_ & ~x03)));
  assign new_n74_ = (~x24 | new_n75_ | (~x05 & ~x13)) & ~new_n39_ & (x05 | new_n79_ | x13);
  assign new_n75_ = ~new_n76_ & (~new_n78_ | x01 | x03 | x06 | ~x07);
  assign new_n76_ = new_n77_ & x11 & x14 & x18 & x20;
  ...
  assign new_n82_ = x06 & x08 & x11 & x14 & ~new_n83_ & x20;
  assign new_n83_ = (~x05 | ~x13 | ~x15) & (x02 | x10 | ~x21);
  assign new_n84_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n44_ & ~x20;
  assign z4 = new_n86_ | (x24 & ~new_n90_ & (x05 | x13)) | (x05 & new_n91_ & x13);
  assign new_n86_ = ~new_n39_ & ((~new_n70_ & (new_n88_ | ~x08)) | (~new_n87_ & (new_n89_ | x08)));
  assign new_n87_ = ~new_n38_ & (~x19 | (x05 ? (~x13 | x24) : x13));
  assign new_n88_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n89_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n90_ = (~x18 | (~new_n88_ & ~x07 & x08)) & (~x07 | x12 | (~new_n89_ & ~x08));
  assign new_n91_ = x15 & (x18 | (~x12 & ~x24)) & (new_n88_ | ~x08);
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = new_n94_ | (x05 & new_n98_ & x13) | (x24 & ~new_n99_ & (x05 | x13));
  assign new_n94_ = ~new_n39_ & ((~new_n87_ & ~new_n97_) | (~new_n70_ & ~new_n95_));
  assign new_n95_ = ~new_n96_ & x03;
  assign new_n96_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n97_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n98_ = x15 & ~new_n95_ & (x18 | (~x12 & ~x24));
  assign new_n99_ = (~x18 | (~new_n96_ & x03 & ~x07)) & (~x07 | new_n97_ | x12);
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n101_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n101_ = ~new_n39_ & ~new_n71_;
endmodule
