...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n68_, new_n71_, new_n72_, new_n74_;
  ...
  assign new_n49_ = x22 & x23 & (new_n50_ | new_n51_);
  assign new_n50_ = x05 & ((x13 & x15 & (x18 | (~x21 & ~x24))) | (x18 & x24));
  assign new_n51_ = x18 & ((x13 & x24) | (~x02 & ~x10 & x21 & ~x24));
  ...
  assign z2 = new_n42_ | (new_n57_ & x01);
  ...
  assign new_n64_ = x11 & ~x13 & x14 & x15 & x20;
  assign new_n65_ = x08 & x11 & x14 & (new_n50_ | new_n51_) & x20;
  assign z4 = (~new_n37_ & (new_n67_ | x08)) | new_n42_ | (~new_n58_ & (new_n68_ | ~x08));
  ...
  assign z6 = (~new_n37_ & (new_n71_ | x03)) | new_n42_ | (~new_n58_ & (new_n72_ | ~x03));
  assign new_n71_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n72_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n74_ | (x18 & (new_n59_ | ((x05 | x13) & x24)));
  assign new_n74_ = x15 & (x05 ? (x13 & (x18 | (~x21 & ~x24))) : (~x13 & (x18 | ~x21)));
endmodule
