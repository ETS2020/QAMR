...
module FAU ( 
  ...
  assign new_n55_ = (x09 | ~x12) & (x05 | x13 | (~new_n56_ & ~new_n58_));
  ...
  assign z4 = ~new_n79_ | (~new_n37_ & (new_n81_ | x08));
  assign new_n79_ = (x09 | ~x12) & (new_n64_ | (x08 & (~x16 | (~new_n80_ & x09))));
  assign new_n80_ = x22 & (~x17 | (~x04 & x23));
  assign new_n81_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & (x09 | ~x12);
  assign z6 = new_n84_ | new_n85_ | (~x09 & x12);
