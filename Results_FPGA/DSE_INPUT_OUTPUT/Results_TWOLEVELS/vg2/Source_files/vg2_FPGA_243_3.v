...
module FAU ( 
  ...
  assign new_n64_ = ~x15 & x20 & (new_n65_ | (x18 & ~new_n62_ & x24));
  ...
  assign z4 = (~new_n37_ & (new_n77_ | x08)) | new_n79_ | (~new_n76_ & (new_n78_ | ~x08));
  assign new_n76_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n65_ & (x05 | x13 | ~x15);
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = x06 & x15;
  ...
  assign z6 = (~new_n84_ & x24) | new_n89_ | (~new_n93_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n84_ = ~new_n85_ & (~x15 | ~x18 | x03 | x06);
  assign new_n85_ = ~new_n62_ & ((~new_n86_ & x07) | (~new_n88_ & x18));
  assign new_n86_ = (~x03 | (x06 & x15)) & (x11 | (x06 ? x15 : ~new_n87_));
  assign new_n87_ = ~x14 & x20;
  assign new_n88_ = (x03 | x15) & (~x11 | (x06 & (~x14 | x15 | x20)));
  assign new_n89_ = ~x02 & ~x10 & ~new_n90_ & ~x24;
  assign new_n90_ = (new_n79_ | (x03 ? ~x00 : ~x21)) & ~new_n92_ & (~new_n91_ | ~x00);
  assign new_n91_ = ~x11 & (x06 ? ~x15 : new_n87_);
  assign new_n92_ = x11 & x21 & (~x06 | (x14 & ~x15 & ~x20));
  assign new_n93_ = (~x19 | (x15 ? x06 : (~x03 & (x11 | (~new_n87_ & ~x06))))) & (x06 | ~x15 | (x03 & ~x11));
  assign z7 = (~new_n95_ & ~x24) | (~x06 & x15 & (new_n62_ | (x18 & x24))) | (~x15 & x18 & ~new_n62_ & x24);
  assign new_n95_ = ~new_n96_ & (x02 | x10 | new_n79_ | ~x21);
  assign new_n96_ = x05 & ~x06 & x13 & x15;
endmodule
