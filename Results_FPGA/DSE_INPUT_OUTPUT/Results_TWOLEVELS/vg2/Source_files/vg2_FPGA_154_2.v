...
module FAU ( 
  ...
  assign new_n46_ = ~x14 & ~x16 & ~x20 & ~x22 & ~new_n47_ & ~x23;
  ...
  assign new_n50_ = ~x11 & ~x12 & ~x14 & new_n51_ & ~x16 & ~x20;
  ...
  assign new_n60_ = ~x12 & ~x14 & ~x16 & new_n51_ & x19 & ~x20;
  ...
  assign z4 = (~new_n85_ & (~x17 | x22)) | ~new_n78_ | (new_n86_ & x24);
  assign new_n78_ = ~new_n79_ & ((~new_n83_ & ~new_n84_) | (x05 ? (~x13 | x24) : x13));
  assign new_n79_ = ~x02 & ~x10 & ~x24 & (new_n82_ | (new_n80_ & x16));
  assign new_n80_ = new_n81_ & x21;
  assign new_n81_ = x22 & (~x17 | (~x04 & x23));
  assign new_n82_ = new_n51_ & ~x17 & x00 & x04 & ~x16;
  assign new_n83_ = x15 & new_n81_ & x16;
  assign new_n84_ = new_n51_ & x19 & x04 & ~x16 & ~x17;
  assign new_n85_ = (new_n38_ | (~x08 & (~x09 | x16))) & (new_n63_ | (x08 & (x09 | ~x16)));
  assign new_n86_ = (x05 | x13) & (new_n87_ | (x16 & new_n81_ & x18));
  assign new_n87_ = new_n51_ & ~x17 & x04 & x07 & ~x16;
  assign z6 = new_n89_ | new_n90_ | (x17 & ~x22);
  ...
  assign new_n92_ = ~new_n64_ & (~x17 | x22);
endmodule
