// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:21 2020
...
module FAU ( 
  ...
  assign z4 = (~new_n53_ & (new_n57_ | x08)) | new_n59_ | (z7 & (new_n58_ | ~x08));
  assign new_n53_ = (new_n54_ | x05) & (x21 | (~new_n56_ & (new_n55_ | ~x05)));
  assign new_n54_ = (x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n55_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n56_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n57_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n58_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n59_ = x00 & ~x02 & ~x05 & ~x10 & x21 & ~x24;
  assign z5 = ~new_n40_ | (~new_n61_ & ~x24);
  assign new_n61_ = ~new_n39_ & (~x00 | x02 | x10 | (x21 & (x05 | ~x21)));
  assign z6 = new_n63_ | new_n65_ | (x05 & x21);
  assign new_n63_ = ~new_n64_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n64_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n56_ & (x05 | x13 | ~x19);
  assign new_n65_ = ~new_n66_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
