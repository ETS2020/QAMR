...
module FAU ( 
  ...
  assign new_n66_ = (new_n67_ | (x21 & ~x23)) & (~x21 | ~x23 | x24 | x02 | x10);
  ...
  assign z4 = ~new_n81_ | (~new_n37_ & (new_n89_ | x08));
  ...
  assign z5 = (~new_n92_ & x05) | ~new_n91_ | new_n39_ | (~x05 & ~x13 & x19);
  assign new_n91_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n92_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n94_ & (new_n96_ | x03)) | new_n98_ | (~new_n66_ & (new_n97_ | ~x03));
  assign new_n94_ = ~new_n95_ & (~x00 | x02 | x10 | x21 | x24);
  assign new_n95_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n96_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n97_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n98_ = x21 & x23 & ~x24 & x00 & ~x02 & ~x10;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n100_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n100_ = x21 & (~x23 | (~x02 & ~x10 & ~x24));
endmodule
