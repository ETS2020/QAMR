...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    new_n44_, new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n54_,
  ...
  assign z4 = (~new_n52_ & (new_n56_ | x08)) | new_n58_ | (z7 & (new_n57_ | ~x08));
  assign new_n52_ = (new_n55_ | ~x05) & (x21 | (new_n53_ & (x05 | x13 | ~x19)));
  assign new_n53_ = ~new_n54_ & (~x07 | ~x13 | ~x24);
  assign new_n54_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n55_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n56_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n57_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n58_ = x00 & ~x02 & x05 & ~x10 & x21 & ~x24;
  assign z5 = ~new_n39_ | (~x24 & (new_n60_ | (x05 & x13 & x19)));
  assign new_n60_ = x00 & ~x02 & ~x10 & (~x21 | (x05 & x21));
  assign z6 = new_n62_ | new_n64_ | (~x05 & x21);
  assign new_n62_ = ~new_n63_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n63_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n54_ & (x05 | x13 | ~x19);
  assign new_n64_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
