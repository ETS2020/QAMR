...
module FAU ( 
  ...
  assign z2 = (~x16 & x22) | (new_n63_ & x01);
  ...
  assign new_n74_ = (x16 | ~x22) & (x05 | new_n75_ | x13);
  ...
  assign z4 = ~new_n79_ | (~new_n38_ & ~new_n81_);
  assign new_n79_ = (x16 | ~x22) & (new_n64_ | ((new_n80_ | ~x22) & x08 & (x09 | ~x16)));
  assign new_n80_ = x17 & (x04 | ~x23);
  assign new_n81_ = ~x08 & (x16 | (~x09 & ~x17 & (~x04 | x23)));
  assign z6 = new_n83_ | new_n84_ | (~x16 & x22);
  assign new_n83_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n84_ = ~new_n64_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n64_ & (x16 | ~x22);
endmodule
