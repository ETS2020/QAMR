...
module FAU ( 
  ...
  assign z4 = ~new_n82_ | (z7 & (new_n87_ | ~x08));
  ...
  assign z7 = (~new_n86_ & (x10 | x21)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n86_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n87_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n67_ & (new_n89_ | ~x03)) | new_n90_ | (~new_n38_ & (new_n91_ | x03));
  assign new_n89_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n90_ = ~x10 & (~x21 | (x00 & ~x02 & x21 & ~x24));
