...
module FAU ( 
  ...
  assign new_n55_ = (~x03 | ~x21) & (~new_n56_ | ~new_n58_ | ~new_n57_ | x02 | x03);
  ...
  assign new_n70_ = new_n71_ & new_n57_ & ~x02 & ~x03 & ~x06;
  assign new_n71_ = ~x08 & ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  assign z4 = new_n73_ | (new_n79_ & x00) | (z7 & (new_n81_ | ~x08));
  assign new_n73_ = ~new_n74_ & (~x03 | ~x21);
  assign new_n74_ = (new_n76_ | (~new_n77_ & ~x08)) & (~new_n75_ | ~x08 | x10 | x24);
  ...
  assign z7 = (~new_n61_ & (~x03 | ~x21)) | (~x02 & ~x03 & ~x10 & x21 & ~x24);
  assign new_n79_ = ~x02 & ~x10 & ~x16 & new_n80_ & ~x21;
  assign new_n80_ = ~x24 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (~x03 | (x03 & ~x21));
  assign z6 = ~new_n84_ | (~x11 & ~new_n89_ & (x06 | (~x14 & x20)));
  assign new_n84_ = (x24 | (~new_n88_ & (~x05 | new_n85_ | ~x13))) & (~x24 | new_n87_ | (~x05 & ~x13)) & (x05 | new_n85_ | x13);
  assign new_n85_ = (new_n86_ | ~x15) & (~x03 | ~x19 | x21);
  assign new_n86_ = x03 & (~x11 | x21 | (x06 & (~x14 | x20)));
  assign new_n87_ = (~x03 | ~x07 | x21) & (new_n86_ | ~x18);
  assign new_n88_ = ~x02 & ~x10 & ((~x03 & x21) | (x00 & x03 & ~x21));
  assign new_n89_ = (new_n76_ | x03) & (~new_n75_ | x10 | x21 | x24);
endmodule
