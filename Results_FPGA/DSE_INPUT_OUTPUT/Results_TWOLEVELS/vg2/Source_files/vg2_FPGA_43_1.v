...
module FAU ( 
  ...
  assign z3 = ~new_n56_ | (~x24 & (x01 ? (new_n64_ & x03) : (new_n65_ & ~x03)));
  ...
  assign new_n69_ = ~new_n70_ & (~x22 | (~new_n72_ & ~new_n73_ & (~new_n71_ | x02)));
  assign new_n70_ = ~x09 & (new_n54_ | (x18 & x24 & (x05 | x13)));
  assign new_n71_ = ~x10 & x21 & (~x17 | (~x04 & x23 & ~x24));
  assign new_n72_ = ~x04 & x18 & x23 & x24 & (x05 | x13);
  assign new_n73_ = x15 & ~x17 & (x05 ^ ~x13);
  assign new_n74_ = x24 & (~x17 | (~new_n75_ & (x05 | x13)));
  assign new_n75_ = (~x07 | (~x08 & (x16 | (~x09 & x22)))) & (x08 | ~x18);
  assign new_n76_ = ~x10 & ~x24 & ((x00 & (new_n77_ | x08)) | (~x08 & x21));
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = (~x15 | (~new_n79_ & x08)) & (~x19 | (~new_n77_ & ~x08));
