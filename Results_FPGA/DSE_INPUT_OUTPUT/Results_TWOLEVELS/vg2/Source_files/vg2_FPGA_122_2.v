// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:46 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n81_, new_n82_, new_n85_, new_n86_, new_n87_, new_n88_, new_n91_,
    new_n92_;
  assign z0 = ~x01 & ~x03 & ~x06 & new_n36_ & ~x11;
  assign new_n36_ = ~x14 & ~x20 & (new_n38_ | (~new_n37_ & (~x00 | x21)));
  assign new_n37_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n38_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  ...
  assign new_n43_ = (x02 | x10) & (~x05 | ~x13 | ~x15);
  ...
  assign new_n58_ = (~new_n49_ | ~new_n59_) & (~new_n62_ | ~new_n63_ | ~new_n54_ | ~new_n61_);
  ...
  assign new_n64_ = ~x00 & (new_n48_ | (~new_n58_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign z2 = (x00 & ~x21) | (new_n66_ & x01);
  ...
  assign z3 = (x21 & (new_n75_ | new_n70_ | new_n78_)) | (~x00 & (new_n70_ | new_n82_));
  ...
  assign new_n79_ = (~new_n80_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n81_ | x06 | x08 | x01 | x03);
  assign new_n80_ = x11 & x14 & x15 & x20;
  assign new_n81_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n82_ = ~new_n79_ & (x05 ? (x13 & ~x24) : ~x13);
  assign z4 = ~new_n86_ | (z7 & (new_n88_ | ~x08));
  assign z7 = new_n68_ | (~new_n85_ & (~x00 | x21));
  assign new_n85_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n86_ = ~new_n38_ & ((x00 & ~x21) | new_n37_ | (~new_n87_ & ~x08));
  assign new_n87_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n88_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ | (x00 & (new_n68_ | ~x21));
  assign z6 = new_n91_ | new_n38_ | (new_n92_ & (~x00 | x21));
  assign new_n91_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
