...
module FAU ( 
  ...
  assign new_n76_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n77_ & (x05 | x13 | ~x19);
  assign new_n77_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n78_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n79_ & (x05 | x13 | ~x15);
  assign new_n79_ = x21 & ~x24 & ~x02 & ~x10;
  ...
  assign z6 = (~new_n85_ & (~x03 | (~new_n87_ & x11))) | (z5 & (x03 | (~new_n86_ & ~x11)));
  assign new_n85_ = (new_n63_ | (~x01 & ~x02)) & (~x01 | x02 | x10 | ~x21 | x24);
