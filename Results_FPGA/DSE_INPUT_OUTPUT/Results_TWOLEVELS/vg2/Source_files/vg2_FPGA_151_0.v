...
module FAU ( 
  ...
  assign new_n46_ = x11 & x14 & x20 & ~new_n43_ & ~new_n39_;
  assign z3 = ~new_n48_ & ~new_n39_;
  ...
  assign new_n55_ = new_n56_ & x18 & x20 & x11 & x14;
  assign new_n56_ = x01 & x03 & x06 & x08;
  ...
  assign z4 = (~new_n37_ & (new_n62_ | x08)) | new_n39_ | (~new_n43_ & (new_n63_ | ~x08));
  ...
  assign z6 = ~new_n39_ & (new_n68_ | new_n69_);
  assign new_n68_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n69_ = ~new_n43_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n71_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n71_ = ~new_n39_ & ~new_n44_;
endmodule
