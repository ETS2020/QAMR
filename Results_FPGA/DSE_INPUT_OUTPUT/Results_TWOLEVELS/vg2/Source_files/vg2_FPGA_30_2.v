...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (x08 ? x20 : new_n79_)) | (~new_n63_ & (new_n77_ | ~x08));
  ...
  assign new_n85_ = (~x00 | x11 | x14 | ~x20) & (x08 | ~x11 | ~x14 | x20 | ~x21);
  assign new_n86_ = (~x19 | ~x20 | x11 | x14) & (~x14 | ~x15 | x20 | x08 | ~x11);
  assign new_n87_ = (~x07 | x11 | x14 | ~x20) & (~x14 | ~x18 | x20 | x08 | ~x11);
  assign z7 = ~new_n63_ & (~x08 | x20);
endmodule
