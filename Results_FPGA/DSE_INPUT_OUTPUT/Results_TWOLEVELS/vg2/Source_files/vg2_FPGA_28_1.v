...
module FAU ( 
  ...
  assign new_n40_ = (~x19 | ((x05 | x13) & (~x07 | ~x24))) & (~x07 | x21 | ~x24 | (~x05 & ~x13));
  ...
  assign z7 = (~new_n67_ & (x19 | ~x21)) | (~x02 & ~x10 & x19 & x21 & ~x24);
  ...
  assign z4 = (~new_n80_ & (new_n84_ | x08)) | new_n38_ | (~new_n82_ & (new_n85_ | ~x08));
  ...
  assign z5 = ~new_n40_ | (~x24 & (new_n39_ | new_n87_));
  assign new_n87_ = x00 & ~x02 & ~x10 & (~x21 | (x19 & x21));
  assign z6 = (~new_n99_ & (~new_n96_ | new_n100_)) | ~new_n92_ | (new_n89_ & x11);
  assign new_n89_ = (~x06 | (x14 & ~x20)) & (new_n90_ | (~new_n91_ & x19));
  assign new_n90_ = ~new_n67_ & ~x21;
  assign new_n91_ = ~new_n83_ & (~x03 | ~x18 | ~x24);
  assign new_n92_ = (~new_n90_ | x03) & (~x19 | (~new_n93_ & new_n95_));
  assign new_n93_ = ~x24 & ((new_n94_ & ~x02) | (x05 & x13 & x15));
  assign new_n94_ = ~x10 & x21 & (x00 | ~x03);
  assign new_n95_ = (x05 | x13 | ~x15) & (x03 | ~x18 | ~x24 | (~x05 & ~x13));
  assign new_n96_ = ~new_n97_ & ~new_n98_ & (x05 | x13 | ~x19);
  assign new_n97_ = x07 & x24 & (x19 | (x13 & ~x21));
  assign new_n98_ = x00 & ~x02 & ~x10 & ~x21 & ~x24;
  assign new_n99_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n100_ = x05 & ((x13 & x19 & ~x24) | (x07 & ~x21 & x24));
endmodule
