...
module FAU ( 
  ...
  assign new_n73_ = (~x16 | ~x21) & (x05 | new_n74_ | x13);
  ...
  assign z4 = new_n78_ | (~new_n37_ & (new_n79_ | x08)) | (~new_n80_ & (new_n81_ | ~x08));
  assign new_n78_ = x21 & (x16 | (~x02 & ~x08 & ~x10 & ~x24));
  ...
  assign new_n84_ = (x05 | x13 | ~x19) & (~x16 | ~x21);
  assign z6 = (~new_n86_ & (new_n90_ | x03)) | new_n92_ | (z7 & (new_n91_ | ~x03));
  assign new_n86_ = (new_n88_ | (x16 & x21)) & (~new_n87_ | x10 | x21 | x24);
  assign new_n87_ = x00 & ~x02;
  assign new_n88_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n80_ & (~x16 | ~x21)) | (~x02 & ~x10 & ~x16 & x21 & ~x24);
  assign new_n90_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n91_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n92_ = ~x16 & x21 & ~x24 & x00 & ~x02 & ~x10;
endmodule
