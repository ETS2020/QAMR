...
module FAU ( 
  ...
  assign new_n71_ = ~x10 & x11 & x14 & x20 & x21;
  ...
  assign new_n75_ = (~x05 | ((~x13 | ~x15 | x24) & (~x12 | ~x18 | ~x24))) & (~x15 | ((~x18 | ~x24) & (x05 | x13))) & (~x18 | ~x24 | ~x12 | ~x13);
  assign z4 = ~new_n77_ | (~new_n39_ & (new_n84_ | (~x02 & new_n85_ & ~x10)));
  assign new_n77_ = (new_n83_ | (x05 ? (~x13 | x24) : x13)) & (~x24 | (~new_n78_ & ~new_n82_));
  assign new_n78_ = x12 & ~new_n62_ & (new_n79_ | (new_n81_ & x07));
  assign new_n79_ = x18 & (new_n80_ | ~x08);
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n81_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n82_ = x15 & (new_n79_ | (x07 & new_n81_ & ~x08));
  assign new_n83_ = (~x15 | (~new_n80_ & x08 & ~x19)) & (~x12 | ~x19 | (~new_n81_ & ~x08));
  assign new_n84_ = x08 & (new_n38_ | (x07 & ~new_n62_ & x24));
  assign new_n85_ = ~x24 & ((new_n81_ & x00) | (x21 & (new_n80_ | ~x08)));
