...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n95_ & ~x16))) | ~new_n89_ | (new_n91_ & x16);
  ...
  assign z5 = (~new_n99_ & x05) | ~new_n97_ | (x19 & (x02 | (~x05 & ~x13)));
  assign new_n97_ = ~new_n98_ & (~x07 | ~x13 | ~x24);
  assign new_n98_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n99_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = new_n101_ | new_n103_ | (x02 & x19);
  assign new_n101_ = ~new_n102_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n102_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n98_ & (x05 | x13 | ~x19);
  assign new_n103_ = ~new_n72_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n105_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n105_ = ~new_n73_ & (~x02 | ~x19);
endmodule
