...
module FAU ( 
  ...
  assign new_n41_ = ~new_n44_ & (~new_n42_ | ~new_n48_ | ~new_n49_ | ~x17 | ~x20);
  assign new_n42_ = new_n43_ & x01 & ~x02 & x03 & x04;
  assign new_n43_ = x06 & x08 & x09 & x11;
  assign new_n44_ = new_n45_ & ~x01 & ~x03 & ~x04 & new_n46_ & new_n47_;
  ...
  assign new_n50_ = ~new_n51_ & (~new_n42_ | ~new_n55_ | ~new_n49_ | ~x18 | ~x20);
  ...
  assign new_n56_ = ~x02 & ~x10 & ~x24 & (new_n58_ | (new_n57_ & new_n60_));
  assign new_n57_ = new_n53_ & new_n54_;
  assign new_n58_ = new_n55_ & new_n59_ & new_n43_ & x01 & x03 & x04;
  ...
  assign z3 = ~new_n72_ | (~new_n68_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n68_ = ~new_n69_ & (~new_n71_ | ~new_n61_ | x06 | x08);
  assign new_n69_ = new_n70_ & x14 & x15 & x20 & x08 & x11;
  assign new_n70_ = x01 & ~x02 & x03 & x06;
  assign new_n71_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n72_ = (~new_n76_ | x02) & (~x24 | new_n73_ | (~x05 & ~x13));
  assign new_n73_ = (~new_n70_ | ~new_n74_) & (~new_n75_ | ~new_n61_ | x06 | ~x07);
  assign new_n74_ = x08 & x11 & x14 & x18 & x20;
  assign new_n75_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n76_ = ~x10 & ~x24 & ((new_n75_ & new_n77_) | (new_n78_ & new_n79_));
  assign new_n77_ = x00 & ~x01 & ~x03 & ~x06;
  assign new_n78_ = x01 & x03 & x06 & x08;
  assign new_n79_ = x11 & x14 & x20 & x21;
  ...
  assign z5 = new_n39_ | ~new_n37_ | ~new_n89_;
  assign new_n89_ = (~x01 | ~x02) & (~x07 | ~x13 | ~x24);
  assign z6 = (~new_n81_ & (x03 | (~new_n91_ & ~x11))) | (~new_n83_ & (~x03 | (~new_n92_ & x11)));
  assign new_n91_ = ~x06 & (x14 | ~x20);
  assign new_n92_ = x06 & (~x14 | x20);
  assign z7 = new_n66_ | ~new_n94_ | new_n65_ | new_n85_;
  assign new_n94_ = (~x01 | ~x02) & (~x13 | ~x18 | ~x24);
endmodule
