...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n84_;
  assign z0 = (new_n36_ & ~x01) | (~x08 & x12);
  ...
  assign z2 = (~x08 & x12) | (new_n62_ & x01);
  ...
  assign z4 = (~new_n37_ & (new_n77_ | x08)) | (~x08 & x12) | (~new_n63_ & (new_n78_ | (~x08 & ~x12)));
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = new_n80_ | ~new_n81_ | new_n38_ | (x07 & x13 & x24);
  assign new_n80_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n81_ = (x05 | x13 | ~x19) & (x08 | ~x12);
  assign z6 = new_n83_ | new_n84_ | (~x08 & x12);
  assign new_n83_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n84_ = ~new_n63_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n63_ & (x08 | (~x08 & ~x12));
endmodule
