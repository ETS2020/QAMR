...
module FAU ( 
  ...
  assign new_n67_ = ~new_n69_ & (new_n68_ | (x00 & x02));
  ...
  assign z4 = (~new_n67_ & (~x08 | (~new_n85_ & x16))) | (z5 & (x08 | (~new_n84_ & ~x16)));
  assign new_n84_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n85_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n67_ & (~x03 | (~new_n88_ & x11))) | (z5 & (x03 | (~new_n87_ & ~x11)));
  assign new_n87_ = ~x06 & (x14 | ~x20);
  assign new_n88_ = x06 & (~x14 | x20);
  assign z7 = (~new_n90_ & x05) | ~new_n91_ | new_n69_ | (~x05 & ~x13 & x15);
  assign new_n90_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n91_ = (~x00 | ~x02) & (~x13 | ~x18 | ~x24);
endmodule
