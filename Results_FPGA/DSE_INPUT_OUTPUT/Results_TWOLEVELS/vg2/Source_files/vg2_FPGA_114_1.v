...
module FAU ( 
  ...
  assign new_n79_ = (new_n80_ | (~x20 & x21)) & (~new_n39_ | x10 | x21 | x24);
  assign new_n80_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n81_ = (new_n82_ | (~x20 & x21)) & (~x20 | ~x21 | x24 | x02 | x10);
  ...
  assign new_n85_ = x20 & x21 & ~x24 & x00 & ~x02 & ~x10;
  ...
  assign z6 = (~new_n90_ & ~x21) | (x20 & (~new_n95_ | (~new_n92_ & ~x24)));
  assign new_n90_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n82_ | (x03 & (~x11 | (~new_n91_ & x06))));
  assign new_n91_ = x14 & ~x20;
  assign new_n92_ = (x02 | new_n93_ | x10) & (~x05 | new_n94_ | ~x13);
  assign new_n93_ = (~x00 | (~x21 & (x11 | x14))) & (~x21 | (x03 & (x06 | ~x11)));
  assign new_n94_ = (~x19 | (~x03 & (x11 | (~x06 & x14)))) & (~x15 | (x03 & (x06 | ~x11)));
  assign new_n95_ = (new_n96_ | (x03 & (x06 | ~x11))) & (new_n97_ | (~x03 & (x11 | (~x06 & x14))));
  assign new_n96_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n97_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n99_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n99_ = x21 & (~x20 | (~x02 & ~x10 & ~x24));
endmodule
