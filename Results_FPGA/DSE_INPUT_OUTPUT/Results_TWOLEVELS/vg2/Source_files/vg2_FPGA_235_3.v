...
module FAU ( 
  ...
  assign z1 = new_n40_ | (new_n49_ & x24) | new_n56_ | (x08 & x21);
  ...
  assign z2 = (new_n60_ & x01) | (x08 & x21);
  ...
  assign new_n71_ = (~x08 | ~x21) & (~new_n72_ | ~new_n73_ | x08 | x10 | x11);
  assign new_n72_ = x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n73_ = ~x14 & ~x20 & ~x24;
  assign z4 = ~new_n78_ | (new_n75_ & ~x16);
  assign new_n75_ = ~new_n76_ & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n76_ = ~new_n77_ & (x10 | x21 | x24 | ~x00 | x02);
  assign new_n77_ = ~x08 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n78_ = (x24 | (~new_n82_ & (~x05 | new_n79_ | ~x13))) & (~x24 | new_n81_ | (~x05 & ~x13)) & (x05 | new_n79_ | x13);
  assign new_n79_ = (~x15 | (x08 & (~x16 | new_n80_ | x21))) & (~x08 | ~x19 | x21);
  assign new_n80_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n81_ = (~x18 | (x08 & (~x16 | new_n80_ | x21))) & (~x07 | ~x08 | x21);
  assign new_n82_ = ~x02 & ~x10 & ((~x08 & x21) | (x00 & x08 & ~x21));
  assign z5 = new_n84_ | ~new_n85_ | new_n38_ | (x07 & x13 & x24);
  assign new_n84_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n85_ = (~x08 | ~x21) & (x05 | x13 | ~x19);
  assign z6 = new_n87_ | new_n88_ | (x08 & x21);
  assign new_n87_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n88_ = ~new_n61_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n90_ & (~x08 | ~x21)) | (~x02 & ~x08 & ~x10 & x21 & ~x24);
