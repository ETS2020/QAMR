...
module FAU ( 
  ...
  assign z3 = new_n68_ | (~x15 & (new_n81_ | (x24 & ~new_n77_ & ~new_n62_)));
  assign new_n68_ = ~x02 & (~new_n69_ | (~new_n74_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n69_ = x01 ? (~x03 | ~x06 | ~new_n70_ | ~x08) : (x03 | x06 | ~new_n72_ | x08);
  assign new_n70_ = x11 & new_n71_ & x14;
  assign new_n71_ = x20 & ((x15 & x18 & x24) | (~x10 & x21 & ~x24));
  assign new_n72_ = ~x11 & ~x14 & ~new_n73_ & ~x20;
  assign new_n73_ = (~x07 | ~x24 | (~x05 & ~x13)) & (~x00 | x10 | x24);
  ...
  assign new_n77_ = ~new_n78_ & (~new_n80_ | x01 | x03 | x06 | ~x07);
  assign new_n78_ = new_n79_ & x18 & x20 & x11 & x14;
  assign new_n79_ = x01 & x03 & x06 & x08;
  assign new_n80_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n81_ = ~x01 & ~x03 & ~x06 & ~x08 & new_n82_ & ~x11;
  assign new_n82_ = ~x14 & x19 & ~x20 & (x05 ? (x13 & ~x24) : ~x13);
  assign z4 = (~new_n37_ & (new_n84_ | x08)) | new_n39_ | (~new_n65_ & (new_n85_ | ~x08));
  ...
  assign z6 = (new_n95_ & ~x11) | new_n90_ | new_n98_ | (new_n99_ & x19);
  assign new_n90_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = new_n94_ | new_n92_ | (x18 & x24 & x13 & ~x15);
  assign new_n92_ = ~x02 & (new_n93_ | (~x10 & x21 & ~x24));
  assign new_n93_ = x15 & ((x18 & x24) | (~x05 & ~x13));
  assign new_n94_ = x05 & ((~x15 & x18 & x24) | (x15 & ~x24 & ~x02 & x13));
  assign new_n95_ = (x06 | (~x14 & x20)) & (new_n97_ | (~new_n96_ & ~x02));
  assign new_n96_ = (~x00 | x10 | x24) & (~x15 | ~x24 | x03 | ~x07);
  assign new_n97_ = ~x15 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n98_ = x03 & (new_n38_ | (x07 & x24 & ~new_n39_ & ~new_n62_));
  assign new_n99_ = (x05 ? (x13 & ~x24) : ~x13) & (x15 ? ~x02 : x03);
endmodule
