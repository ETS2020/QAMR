...
module FAU ( 
  ...
  assign z4 = ((new_n86_ | x08) & (new_n81_ | new_n38_)) | (z7 & (new_n87_ | ~x08));
  assign new_n81_ = ~new_n82_ & (~x01 | ~x02);
  ...
  assign z6 = new_n92_ | new_n93_ | (x01 & x02);
  assign new_n92_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n93_ = ~new_n94_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n94_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n85_ & (x05 | x13 | ~x15);
endmodule
