...
module FAU ( 
  ...
  assign new_n37_ = (new_n38_ | (~x02 & ~x16)) & (~x00 | x02 | x10 | ~x16 | x24);
  ...
  assign z7 = (~new_n62_ & (x02 | x16)) | (x16 & x21 & ~x24 & ~x02 & ~x10);
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (x16 & (new_n64_ | new_n69_ | new_n74_)) | (x02 & (new_n69_ | new_n78_));
  ...
  assign z4 = new_n80_ | new_n82_ | (~x02 & ~x10 & new_n84_ & x16);
  assign new_n80_ = ~new_n38_ & ((x08 & (x02 | x16)) | (x02 & ~new_n81_ & ~x16));
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = ~new_n62_ & ((~x08 & (x02 | x16)) | (x16 & (new_n83_ | ~x09)));
  assign new_n83_ = x22 & (~x17 | (~x04 & x23));
  assign new_n84_ = ~x24 & ((x00 & x08) | (x21 & (new_n83_ | ~x08 | ~x09)));
  assign z5 = ~new_n38_ | (~x02 & (~x16 | (x00 & ~x10 & ~x24)));
