...
module FAU ( 
  ...
  assign z7 = new_n66_ | (~new_n67_ & x21) | (x13 & x18 & x24);
  ...
  assign new_n80_ = (new_n83_ | ~x05) & (~x19 | ~x21 | x05 | x13) & (new_n81_ | ~x13);
  ...
  assign z6 = new_n88_ | new_n90_ | (~x13 & ~x21);
  assign new_n88_ = ~new_n89_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n89_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n82_ & (x05 | x13 | ~x19);
