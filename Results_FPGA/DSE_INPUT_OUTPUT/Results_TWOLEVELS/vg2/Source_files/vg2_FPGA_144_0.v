...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n82_, new_n85_, new_n87_, new_n88_, new_n89_;
  ...
  assign new_n74_ = (x10 | x21) & (x05 | new_n75_ | x13);
  ...
  assign z4 = (~new_n79_ & (new_n80_ | x08)) | new_n82_ | (~new_n64_ & (new_n81_ | ~x08));
  ...
  assign new_n82_ = ~x10 & (~x21 | (x00 & ~x02 & x21 & ~x24));
  assign z5 = (~new_n79_ & (x10 | x21)) | (x00 & ~x02 & ~x10 & x21 & ~x24);
  assign z6 = new_n85_ | ~new_n88_;
  assign new_n85_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n87_ & (x10 | x21)) | (~x02 & ~x10 & x21 & ~x24);
  assign new_n87_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n88_ = (~x00 | x02 | x10 | ~x21 | x24) & (~new_n89_ | (~x10 & ~x21));
