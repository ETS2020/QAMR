...
module FAU ( 
  ...
  assign new_n57_ = (~x14 | x21) & (x05 | x13 | (~new_n58_ & ~new_n60_));
  ...
  assign new_n75_ = (~x14 | x21) & (x05 | new_n76_ | x13);
  ...
  assign new_n80_ = (new_n81_ | (x14 & ~x21)) & (~new_n39_ | x10 | x14 | x24);
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n83_ & (~x14 | x21)) | (x21 & ~x24 & ~x02 & ~x10);
  ...
  assign new_n89_ = (~x14 | x21) & (x05 | x13 | ~x19);
  assign z6 = (~new_n91_ & ~x14) | (~new_n92_ & x21);
  assign new_n91_ = (new_n37_ | (~x03 & (x11 | (~x06 & ~x20)))) & (new_n83_ | (x03 & (x06 | ~x11)));
  assign new_n92_ = ~new_n93_ & ~new_n38_ & (new_n81_ | (~x03 & (~x06 | x11)));
  assign new_n93_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
