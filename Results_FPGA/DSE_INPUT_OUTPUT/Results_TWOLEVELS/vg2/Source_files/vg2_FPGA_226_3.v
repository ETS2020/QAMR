...
module FAU ( 
  ...
  assign new_n45_ = x11 & x14 & ~new_n46_ & ~new_n40_ & x20;
  ...
  assign z4 = (~new_n38_ & (new_n62_ | x08)) | new_n40_ | (~new_n46_ & (new_n63_ | ~x08));
  assign new_n62_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n63_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n38_ & (new_n65_ | x03)) | new_n40_ | (~new_n46_ & (new_n66_ | ~x03));
  assign new_n65_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n66_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n68_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n68_ = ~new_n47_ & (x05 | x13 | ~x15) & ~new_n40_ & (~new_n69_ | ~x13);
