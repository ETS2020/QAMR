...
module FAU ( 
  ...
  assign z2 = new_n66_ | (new_n63_ & x01);
  ...
  assign z4 = (~new_n37_ & (new_n82_ | x08)) | ((new_n81_ | new_n65_) & (new_n83_ | ~x08));
  assign new_n81_ = ~new_n66_ & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n38_ | (x00 & (x02 | (~x10 & ~x24)));
  assign z6 = (~new_n64_ & (new_n88_ | ~x03)) | new_n66_ | (~new_n86_ & (new_n89_ | x03));
  ...
  assign new_n91_ = ~new_n65_ & (x05 | x13 | ~x15) & ~new_n66_ & (~new_n92_ | ~x13);
