...
module FAU ( 
  ...
  assign z7 = new_n60_ | (~new_n39_ & ~new_n48_);
  ...
  assign new_n75_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n60_ & (x05 | x13 | ~x15);
  ...
  assign z6 = (~new_n37_ & (new_n80_ | x03)) | new_n39_ | (~new_n75_ & (new_n81_ | ~x03));
