...
module FAU ( 
  ...
  assign new_n46_ = x11 & x14 & x20 & ~new_n43_ & (x09 | x23);
  ...
  assign new_n62_ = ~new_n38_ & (x09 | (x17 & ~x22 & x23));
  assign new_n63_ = ~new_n43_ & ((~x09 & x23) | (x22 & ((x09 & ~x17) | (~x04 & x23))));
  ...
  assign z6 = (x09 | x23) & (new_n69_ | new_n70_);
  assign new_n69_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n70_ = ~new_n43_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n72_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n72_ = ~new_n44_ & (x09 | x23);
endmodule
