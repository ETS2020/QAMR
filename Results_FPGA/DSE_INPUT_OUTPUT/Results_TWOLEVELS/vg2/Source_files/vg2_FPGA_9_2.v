...
module FAU ( 
  ...
  assign new_n41_ = ~x02 & (x00 | (new_n42_ & new_n44_));
  assign new_n42_ = new_n43_ & x01 & x03 & x04 & x06;
  assign new_n43_ = ~x10 & x11 & x08 & x09;
  assign new_n44_ = new_n45_ & x22 & x23 & ~x24 & x20 & x21;
  ...
  assign new_n61_ = ~x00 & (~new_n62_ | ~x06 | x10 | ~x01 | ~x03);
  ...
  assign z3 = ~new_n66_ | (~x02 & (new_n74_ | x00));
  assign new_n66_ = (new_n67_ | (x05 ? (~x13 | x24) : x13)) & (~x24 | (~x05 & ~x13) | (~new_n70_ & ~new_n72_));
  ...
  assign new_n74_ = new_n62_ & x06 & x08 & ~x10 & x01 & x03;
  assign z4 = (~new_n39_ & (new_n78_ | x08)) | new_n38_ | (~new_n76_ & (new_n79_ | ~x08));
  ...
  assign z6 = (~new_n76_ & (new_n81_ | ~x03)) | new_n38_ | (~new_n39_ & (new_n82_ | x03));
