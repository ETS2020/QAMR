...
module FAU ( 
  ...
  assign z1 = new_n40_ | (new_n49_ & x24) | new_n56_ | (x14 & x21);
  ...
  assign new_n70_ = (~x14 | ~x21) & (~new_n71_ | ~new_n72_ | x14 | x20 | x24);
  assign new_n71_ = x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n72_ = ~x08 & ~x10 & ~x11;
  assign z4 = (~new_n74_ & (new_n78_ | x08)) | new_n80_ | (z7 & (new_n79_ | ~x08));
  assign new_n74_ = (new_n76_ | (x14 & x21)) & (~new_n75_ | x10 | x21 | x24);
  assign new_n75_ = x00 & ~x02;
  assign new_n76_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n61_ & (~x14 | ~x21)) | (~x02 & ~x10 & ~x14 & x21 & ~x24);
  ...
  assign new_n83_ = (~x14 | ~x21) & (x05 | x13 | ~x19);
  assign z6 = (~new_n85_ & ~x21) | (~x14 & (~new_n90_ | (~new_n87_ & ~x24)));
  assign new_n85_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n61_ | (x03 & (~x11 | (~new_n86_ & x06))));
  assign new_n86_ = x14 & ~x20;
  assign new_n87_ = (x02 | new_n88_ | x10) & (~x05 | new_n89_ | ~x13);
  assign new_n88_ = (~x00 | (~x21 & (x11 | ~x20))) & (~x21 | (x03 & (x06 | ~x11)));
  assign new_n89_ = (~x19 | (~x03 & (x11 | (~x06 & ~x20)))) & (~x15 | (x03 & (x06 | ~x11)));
  assign new_n90_ = (new_n91_ | (x03 & (x06 | ~x11))) & (new_n92_ | (~x03 & (x11 | (~x06 & ~x20))));
