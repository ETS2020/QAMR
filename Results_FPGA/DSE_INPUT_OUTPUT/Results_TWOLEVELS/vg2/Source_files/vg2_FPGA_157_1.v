// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:58 2020
...
module FAU ( 
  ...
  assign z0 = (new_n36_ & ~x01) | (~x12 & x16);
  ...
  assign new_n41_ = x08 & x09 & x11 & new_n42_ & x14;
  ...
  assign new_n45_ = ~x14 & ~x17 & ~x20 & ~x22 & ~new_n46_ & ~x23;
  assign new_n46_ = (~x00 | x02 | x10) & (~x05 | ~x13 | ~x19);
  assign new_n47_ = ~new_n48_ & (~new_n52_ | ~new_n54_ | ~x14 | ~x16 | ~x17);
  assign new_n48_ = new_n49_ & new_n51_ & ~x11 & ~x12 & ~x14;
  ...
  assign new_n70_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
  ...
  assign z4 = (~new_n81_ & (x12 | ~x16)) | (new_n79_ & ~x16) | (x12 & new_n80_ & x16);
  assign new_n79_ = ~new_n37_ & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  ...
  assign new_n87_ = (x05 | x13 | ~x19) & (x12 | ~x16);
  assign z6 = new_n89_ | new_n90_ | (~x12 & x16);
  assign new_n89_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = ~new_n64_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
