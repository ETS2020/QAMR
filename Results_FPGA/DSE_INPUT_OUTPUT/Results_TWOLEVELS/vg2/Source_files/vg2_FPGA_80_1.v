...
module FAU ( 
  ...
  assign z7 = (~new_n68_ & x05) | (~new_n66_ & x13) | (~x05 & ~x13 & x15 & ~x21);
  ...
  assign z5 = ~new_n39_ | (~x24 & (new_n89_ | (x05 & x13 & x19)));
  assign new_n89_ = x00 & ~x02 & ~x10 & (~x21 | (x13 & x21));
  assign z6 = new_n91_ | new_n93_ | (~x13 & x21);
  assign new_n91_ = ~new_n92_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n92_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & ~new_n83_ & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
