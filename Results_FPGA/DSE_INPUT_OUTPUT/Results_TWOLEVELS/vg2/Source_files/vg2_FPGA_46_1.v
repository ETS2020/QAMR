...
module FAU ( 
  ...
  assign z2 = x01 & x03 & x06 & new_n60_ & x11;
  assign new_n60_ = x14 & x20 & ((~new_n61_ & (~x08 | (x02 & x08))) | (new_n62_ & ~x02 & ~x08));
  ...
  assign new_n64_ = ~new_n65_ & (~new_n67_ | x06 | x08 | x01 | x03);
  ...
  assign z4 = (new_n74_ & ~x16) | new_n80_ | new_n77_ | (new_n81_ & x24);
  ...
  assign new_n78_ = (~x15 | (~new_n79_ & x08)) & (~x08 | ~x19);
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n80_ = ~x02 & (new_n62_ | x08);
  assign new_n81_ = (x05 | x13) & ((x07 & x08) | (x18 & (new_n79_ | ~x08)));
  assign z5 = ~new_n38_ | (~x02 & (x08 | (x00 & ~x10 & ~x24)));
  assign z6 = new_n84_ | (~new_n85_ & ((new_n62_ & ~x02 & ~x08) | (~new_n61_ & (x02 | ~x08))));
  assign new_n84_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n85_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign z7 = new_n80_ | ~new_n61_;
endmodule
