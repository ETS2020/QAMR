...
module FAU ( 
  ...
  assign new_n56_ = ~new_n58_ & (~new_n57_ | ~new_n60_ | ~new_n59_ | ~x00 | x01);
  ...
  assign new_n72_ = (~x11 | ~x21) & (~new_n73_ | ~new_n74_ | x08 | x10 | x11);
  assign new_n73_ = x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n74_ = ~x14 & ~x20 & ~x24;
  assign z4 = (~new_n37_ & (new_n78_ | x08)) | new_n58_ | (~new_n76_ & (new_n79_ | ~x08));
  ...
  assign z5 = (~new_n82_ & x05) | ~new_n81_ | new_n58_ | (~x05 & ~x13 & x19);
  assign new_n81_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n82_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = new_n84_ | (~new_n37_ & (new_n85_ | x03)) | (~new_n63_ & (new_n86_ | ~x03));
  assign new_n84_ = x21 & (x11 | (new_n59_ & ~x10 & ~x24));
  ...
  assign new_n88_ = x21 & (x11 | (~x02 & ~x10 & ~x24));
endmodule
