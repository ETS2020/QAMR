...
module FAU ( 
  ...
  assign z5 = new_n86_ | ~new_n87_ | new_n39_ | (x07 & x13 & x24);
  assign new_n86_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n87_ = (~x02 | x12) & (x05 | x13 | ~x19);
  assign z6 = new_n89_ | new_n91_ | (x02 & ~x12);
  assign new_n89_ = ~new_n90_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n39_ & (x05 | x13 | ~x19);
