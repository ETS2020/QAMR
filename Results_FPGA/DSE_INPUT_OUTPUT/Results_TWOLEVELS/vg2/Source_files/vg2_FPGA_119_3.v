...
module FAU ( 
  ...
  assign new_n64_ = x06 & x11 & x14 & (~new_n65_ | new_n67_) & x20;
  ...
  assign new_n74_ = new_n75_ & x03 & x06 & x08 & ~x10;
  ...
  assign z4 = (~new_n37_ & (new_n85_ | x08)) | new_n84_ | (~new_n82_ & (new_n86_ | ~x08));
  ...
  assign z5 = new_n38_ | (~new_n84_ & ~new_n88_);
  assign new_n88_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = new_n90_ | (~new_n91_ & (new_n83_ | (~new_n84_ & ~new_n92_)));
  assign new_n90_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n91_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n92_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
  assign z7 = new_n67_ | ~new_n94_ | new_n66_ | new_n83_;
