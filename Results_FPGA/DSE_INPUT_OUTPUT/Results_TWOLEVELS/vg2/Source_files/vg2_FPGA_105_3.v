...
module FAU ( 
  ...
  assign new_n37_ = ~x02 & (new_n38_ | (x00 & ~x10 & ~x24));
  assign new_n38_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n39_ = ~x05 & ((~x13 & x19) | (x07 & x13 & x24));
  assign z1 = (~new_n41_ & ~x24) | ~new_n57_ | (~x05 & ~new_n48_ & ~x13);
  ...
  assign new_n57_ = (~x02 | ~x05) & (~x24 | (~new_n58_ & ~new_n60_) | (~x05 & ~x13));
  assign new_n58_ = new_n50_ & new_n59_ & x16 & x17 & x12 & x14;
  assign new_n59_ = x22 & x23 & x18 & x20;
  assign new_n60_ = new_n61_ & new_n62_ & ~x11 & ~x12 & ~x14 & ~x16;
  assign new_n61_ = new_n55_ & ~x08 & ~x09 & ~x06 & x07;
  assign new_n62_ = ~x17 & ~x20 & ~x22 & ~x23;
  assign z2 = new_n67_ | (new_n64_ & x01);
  ...
  assign new_n69_ = (x05 | new_n74_ | x13) & (~x02 | ~x05) & (~x24 | new_n70_ | (~x05 & ~x13));
  ...
  assign z4 = (~new_n80_ & (new_n83_ | x08)) | new_n67_ | (~new_n65_ & (new_n84_ | ~x08));
  assign new_n80_ = ~new_n38_ & new_n81_ & (~x07 | ~x13 | ~x24);
  assign new_n81_ = ~new_n82_ & (x05 | x13 | ~x19);
  assign new_n82_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (x07 & x24 & (x05 | x13)) | ~new_n81_ | (~new_n86_ & x05);
  assign new_n86_ = ~x02 & (~x13 | ~x19 | x24);
  assign z6 = (~new_n80_ & (new_n88_ | x03)) | new_n67_ | (~new_n65_ & (new_n89_ | ~x03));
  assign new_n88_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n89_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n92_ | (~x02 & (new_n91_ | (~x10 & x21 & ~x24)));
  assign new_n91_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n92_ = ~x05 & (x13 ? (x18 & x24) : x15);
endmodule
