...
module FAU ( 
  ...
  assign new_n58_ = ~new_n59_ & (~new_n54_ | ~new_n62_ | ~new_n56_ | ~x15 | ~x16);
  assign new_n59_ = new_n60_ & new_n53_ & ~x06 & ~x08 & ~x09 & ~x11;
  ...
  assign new_n64_ = x11 & x14 & ~new_n65_ & ~new_n40_ & x20;
  ...
  assign new_n68_ = (~x24 | new_n69_ | (~x05 & ~x13)) & ~new_n40_ & (x05 | new_n73_ | x13);
  ...
  assign new_n76_ = x06 & x08 & x11 & x14 & ~new_n45_ & x20;
  assign new_n77_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n48_ & ~x20;
  assign z4 = (~new_n38_ & (new_n79_ | x08)) | new_n40_ | (~new_n65_ & (new_n80_ | ~x08));
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n38_ & (new_n82_ | x03)) | new_n40_ | (~new_n65_ & (new_n83_ | ~x03));
  assign new_n82_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n83_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n85_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n85_ = ~new_n66_ & (x05 | x13 | ~x15) & ~new_n40_ & (~new_n86_ | ~x13);
