...
module FAU ( 
  ...
  assign z1 = (~x02 & (new_n41_ | x03)) | new_n45_ | new_n53_;
  assign new_n41_ = new_n42_ & new_n44_ & ~x20 & ~x22 & ~x23 & ~x24;
  assign new_n42_ = new_n43_ & x00 & ~x01 & ~x04 & ~x06;
  ...
  assign z2 = x03 & (new_n61_ | ~x02);
  assign new_n61_ = x01 & x06 & x11 & x14 & ~new_n62_ & x20;
  ...
  assign new_n74_ = (~x00 | x02 | x03 | x10 | x24) & (new_n39_ | (~x02 & x03));
  assign new_n75_ = (new_n62_ | (~x02 & x03)) & (x02 | x03 | x10 | ~x21 | x24);
  assign new_n76_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n77_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = (x00 & ~x02 & ~x03 & ~x10 & ~x24) | (~new_n39_ & (~x03 | (x02 & x03)));
  assign z6 = ~new_n80_ | (~x11 & ~new_n85_ & (x06 | (~x14 & x20)));
  assign new_n80_ = ~new_n84_ & (~x24 | new_n81_ | (~x05 & ~x13)) & (new_n83_ | (x05 ? (~x13 | x24) : x13));
  assign new_n81_ = (~x02 | ~x03 | ~x07) & (new_n82_ | ~x18);
  assign new_n82_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n83_ = (~x02 | ~x03 | ~x19) & (new_n82_ | ~x15);
  assign new_n84_ = ~x02 & (x03 | (~x10 & x21 & ~x24));
  assign new_n85_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n86_ & (x05 | x13 | ~x19);
  assign new_n86_ = ~x10 & ~x24 & x00 & ~x02;
  assign z7 = ~new_n62_ | new_n84_;
endmodule
