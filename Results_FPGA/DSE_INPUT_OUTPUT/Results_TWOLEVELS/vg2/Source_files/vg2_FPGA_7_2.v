...
module FAU ( 
  ...
  assign new_n65_ = (x13 | ~x18 | ~x24) & (~x13 | ~x15 | ~x21 | x24);
  ...
  assign z4 = (~new_n37_ & (new_n83_ | x08)) | new_n39_ | (~new_n79_ & (new_n84_ | ~x08));
  assign new_n79_ = ~new_n82_ & new_n80_ & (~x13 | ~x18 | ~x24);
  assign new_n80_ = ~new_n81_ & (x05 | x13 | ~x15);
  assign new_n81_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n82_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  ...
  assign new_n87_ = x19 & x21 & x05 & x13;
  assign new_n88_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (x13 ? ~x21 : ~x05));
  assign z6 = (~new_n37_ & (new_n90_ | x03)) | new_n39_ | (~new_n79_ & (new_n91_ | ~x03));
  assign new_n90_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n91_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n82_ | ~new_n80_ | (x13 & (~x21 | (x18 & x24)));
endmodule
