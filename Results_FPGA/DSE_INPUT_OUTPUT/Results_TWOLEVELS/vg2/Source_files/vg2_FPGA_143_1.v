...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n78_ | x08)) | new_n80_ | (~new_n64_ & (new_n79_ | ~x08));
  ...
  assign z6 = new_n83_ | new_n84_ | (~new_n64_ & (~x03 | (~x06 & x11)));
  assign new_n83_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n84_ = ~x20 & (x21 | (new_n85_ & x11));
  assign new_n85_ = x14 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
