...
module FAU ( 
  ...
  assign z0 = (~x05 & x21) | (~x01 & new_n36_ & ~x03);
  ...
  assign z7 = (~new_n66_ & x13) | (~new_n67_ & x05) | (~x05 & ~x13 & x15 & ~x21);
  ...
  assign new_n69_ = ~x11 & ~x14 & ~x20 & (~new_n72_ | (~new_n70_ & ~x24));
  assign new_n70_ = (~new_n71_ | ~x05) & (~x00 | x02 | x10 | (~x05 & x21));
  assign new_n71_ = x13 & x19;
  assign new_n72_ = (~x07 | ~x24 | (~x05 & (~x13 | x21))) & (~x19 | x21 | x05 | x13);
  assign z4 = (~new_n74_ & (new_n76_ | x08)) | new_n78_ | (z7 & (new_n77_ | ~x08));
  assign new_n74_ = ~new_n39_ & (x21 | (new_n75_ & (x05 | x13 | ~x19)));
  assign new_n75_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n76_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n77_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n78_ = x00 & ~x02 & x05 & ~x10 & x21 & ~x24;
  assign z5 = new_n39_ | ~new_n75_ | (~x05 & ((~x13 & x19) | x21));
  assign z6 = (~new_n74_ & (new_n81_ | x03)) | new_n78_ | (z7 & (new_n82_ | ~x03));
