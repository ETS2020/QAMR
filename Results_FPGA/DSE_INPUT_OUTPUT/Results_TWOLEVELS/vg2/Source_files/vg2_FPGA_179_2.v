...
module FAU ( 
  ...
  assign new_n67_ = (~x24 | new_n68_ | (~x05 & ~x13)) & ~new_n65_ & (x05 | new_n72_ | x13);
  ...
  assign z5 = ~new_n37_ & ~new_n65_;
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | new_n65_ | (~new_n63_ & (new_n83_ | ~x03));
  ...
  assign new_n85_ = ~new_n64_ & ~new_n65_;
endmodule
