...
module FAU ( 
  ...
  assign z1 = (~new_n41_ & ~new_n62_) | new_n50_ | (~x02 & (new_n57_ | x15));
  ...
  assign new_n65_ = ~new_n66_ & (~x02 | new_n67_ | ~x15) & (new_n68_ | x15);
  assign new_n66_ = x05 & ((~x15 & x18 & x24) | (x02 & x13 & x15 & ~x24));
  assign new_n67_ = (~x18 | ~x24) & (x05 | x13);
  assign new_n68_ = (~x13 | ~x18 | ~x24) & (x02 | x10 | ~x21 | x24);
  ...
  assign new_n74_ = ~x02 & (x15 | (~x10 & ~new_n75_ & ~x24));
  assign new_n75_ = (~new_n37_ | ~new_n72_) & (~new_n73_ | ~new_n76_);
  ...
  assign new_n87_ = ~x02 & x15;
  assign z5 = ~new_n39_ | (~x02 & (x15 | (x00 & ~x10 & ~x24)));
  assign z6 = ~new_n91_ | (~x11 & ~new_n90_ & (x06 | (~x14 & x20)));
  assign new_n90_ = (new_n81_ | x15) & (~x02 | x03 | ~x07 | ~x15 | ~x24);
  assign new_n91_ = (new_n65_ | (~new_n95_ & x03)) & (~new_n92_ | ~x19) & (new_n93_ | ~x03);
  assign new_n92_ = ~new_n62_ & (x15 ? x02 : x03);
  assign new_n93_ = ~new_n94_ & (~x00 | x02 | x10 | x15 | x24);
  assign new_n94_ = x07 & x24 & (x05 | x13) & (x02 | ~x15);
  assign new_n95_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n97_ | (~x02 & (x15 | (~x10 & x21 & ~x24)));
