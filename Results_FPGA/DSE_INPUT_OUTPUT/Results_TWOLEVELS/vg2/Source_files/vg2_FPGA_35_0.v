...
module FAU ( 
  ...
  assign z2 = (~x08 & ~x12) | (new_n45_ & x01);
  ...
  assign z4 = (~new_n37_ & (new_n60_ | x08)) | (~x08 & ~x12) | (~new_n42_ & (new_n61_ | (~x08 & x12)));
  assign new_n60_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n61_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = new_n63_ | ~new_n64_ | new_n38_ | (x07 & x13 & x24);
  assign new_n63_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n64_ = (x05 | x13 | ~x19) & (x08 | x12);
  assign z6 = new_n66_ | new_n67_ | (~x08 & ~x12);
  assign new_n66_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n67_ = ~new_n42_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n42_ & (x08 | (~x08 & x12));
endmodule
