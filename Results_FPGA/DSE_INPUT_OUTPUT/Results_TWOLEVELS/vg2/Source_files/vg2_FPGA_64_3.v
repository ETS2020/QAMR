...
module FAU ( 
  ...
  assign z5 = (~new_n39_ & ~new_n83_) | (~new_n81_ & ~x24);
  assign new_n81_ = ~new_n82_ & (~x05 | ~x13 | new_n39_ | ~x19);
  assign new_n82_ = x00 & ~x02 & ~x10 & (~x21 | (~x12 & x21));
  assign new_n83_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign z6 = (~new_n85_ & (new_n89_ | x03)) | new_n91_ | (~new_n87_ & (new_n90_ | ~x03));
  assign new_n85_ = ~new_n86_ & (x10 | x21 | x24 | ~x00 | x02);
  assign new_n86_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n87_ = (new_n88_ | (x12 & x21)) & (x02 | x10 | x12 | ~x21 | x24);
  ...
  assign new_n91_ = ~x12 & x21 & ~x24 & x00 & ~x02 & ~x10;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n93_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n93_ = x21 & (x12 | (~x02 & ~x10 & ~x24));
endmodule
