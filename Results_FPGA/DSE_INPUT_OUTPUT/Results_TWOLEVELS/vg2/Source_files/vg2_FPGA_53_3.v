...
module FAU ( 
  ...
  assign z2 = (x16 & x22) | (new_n44_ & x01);
  ...
  assign new_n57_ = (~x16 | ~x22) & (x05 | new_n58_ | x13);
  ...
  assign z4 = ~new_n62_ | (~new_n45_ & (~x08 | (~x09 & x16)));
  assign new_n62_ = (~x16 | ~x22) & (new_n38_ | (~x08 & (x16 | (~x09 & (new_n63_ | x22)))));
  assign new_n63_ = ~x17 & (~x04 | x23);
  assign z6 = new_n65_ | new_n66_ | (x16 & x22);
  assign new_n65_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n66_ = ~new_n45_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n45_ & (~x16 | ~x22);
endmodule
