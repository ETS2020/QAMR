...
module FAU ( 
  ...
  assign z6 = (~new_n82_ & (x03 | (~new_n84_ & ~x11))) | (~new_n83_ & (~x03 | (~new_n85_ & x11)));
  assign new_n82_ = (new_n37_ | (~x01 & ~x02)) & (~x00 | ~x01 | x02 | x10 | x24);
  assign new_n83_ = (new_n62_ | (~x01 & ~x02)) & (x10 | ~x21 | x24 | ~x01 | x02);
