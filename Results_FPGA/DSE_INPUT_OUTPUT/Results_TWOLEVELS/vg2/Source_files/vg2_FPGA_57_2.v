...
module FAU ( 
  ...
  assign new_n53_ = new_n54_ & new_n55_ & new_n44_ & x01 & x03 & x04;
  ...
  assign new_n59_ = ~new_n38_ & (x10 | x24 | (~new_n60_ & (~new_n56_ | ~new_n63_)));
  assign new_n60_ = new_n44_ & new_n61_ & new_n54_ & new_n62_;
  ...
  assign z7 = new_n69_ | (~new_n38_ & ~new_n68_);
  assign new_n68_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n69_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~x02 & (new_n71_ | new_n76_ | (new_n80_ & ~x10))) | (x12 & (new_n71_ | new_n76_));
  assign new_n71_ = ~new_n51_ & (new_n72_ | (new_n74_ & new_n75_ & x15 & x20));
  ...
  assign new_n76_ = x24 & ~new_n77_ & (x05 | x13);
  assign new_n77_ = (~new_n78_ | ~new_n79_) & (~new_n74_ | ~new_n75_ | ~x18 | ~x20);
  assign new_n78_ = ~x01 & ~x03 & ~x06 & x07;
  assign new_n79_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n80_ = ~x24 & (new_n81_ | (new_n74_ & new_n75_ & x20 & x21));
  assign new_n81_ = new_n79_ & ~x03 & ~x06 & x00 & ~x01;
  ...
  assign new_n87_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n69_ & (x05 | x13 | ~x15);
