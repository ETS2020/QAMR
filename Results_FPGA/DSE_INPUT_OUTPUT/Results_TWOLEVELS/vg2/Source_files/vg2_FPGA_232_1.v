// Benchmark "FAU" written by ABC on Mon Aug 24 18:14:23 2020
...
module FAU ( 
  ...
  assign z4 = (~new_n79_ & (x08 | (~new_n85_ & ~x16))) | (z7 & (~x08 | (~new_n86_ & x16)));
  assign new_n79_ = ~new_n82_ & (new_n80_ | new_n81_);
  assign new_n80_ = ~x01 & x02;
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n82_ = ~x10 & ~x24 & x00 & ~x02;
  assign z7 = new_n65_ | (~new_n80_ & ~new_n84_);
  ...
  assign z5 = new_n37_ | ~new_n88_ | new_n38_ | new_n80_;
  assign new_n88_ = ~new_n82_ & (x05 | x13 | ~x19);
  assign z6 = (~new_n90_ & (new_n91_ | x03)) | new_n80_ | (~new_n64_ & (new_n92_ | ~x03));
  assign new_n90_ = ~new_n37_ & new_n88_ & ~new_n38_;
