...
module FAU ( 
  ...
  assign z4 = (~new_n73_ & (x08 | (~new_n75_ & ~x16))) | (~new_n74_ & (~x08 | (~new_n76_ & x16)));
  assign new_n73_ = (new_n37_ | (~x01 & ~x02)) & (~x00 | ~x01 | x02 | x10 | x24);
  assign new_n74_ = (new_n62_ | (~x01 & ~x02)) & (x10 | ~x21 | x24 | ~x01 | x02);
