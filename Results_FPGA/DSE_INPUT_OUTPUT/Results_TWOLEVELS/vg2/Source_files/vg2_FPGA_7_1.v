...
module FAU ( 
  ...
  assign new_n48_ = ~x13 & (x21 | (~x05 & (new_n49_ | new_n53_)));
  ...
  assign new_n65_ = x13 & (new_n66_ | (x18 & x24));
  ...
  assign new_n85_ = (~x07 | ~x24 | (~x13 & (~x05 | x21))) & (x05 | x13 | ~x19 | x21);
  ...
  assign z7 = (~new_n91_ & x05) | ~new_n90_ | (~x13 & (x21 | (~x05 & x15)));
