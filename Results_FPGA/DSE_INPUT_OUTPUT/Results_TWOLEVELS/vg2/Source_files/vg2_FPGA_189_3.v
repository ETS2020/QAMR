...
module FAU ( 
  ...
  assign new_n55_ = (~x09 | ~x21) & (~new_n56_ | ~new_n58_);
  ...
  assign new_n61_ = (new_n62_ | (x09 & x21)) & (x02 | x09 | x10 | ~x21 | x24);
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n64_ & ~x24) | ~new_n73_ | (x24 & ~new_n69_ & ~new_n77_);
  ...
  assign new_n73_ = (~x09 | ~x21) & (x05 | new_n74_ | x13);
  ...
  assign z4 = (~new_n79_ & ~x24) | (new_n85_ & x24) | new_n87_ | (new_n86_ & ~x05);
  assign new_n79_ = (new_n80_ | new_n68_) & ~new_n84_ & (~x05 | ~new_n82_ | ~x13);
  assign new_n80_ = ~x08 & (x16 | (~new_n81_ & ~x09));
  assign new_n81_ = ~x22 & (x17 | (x04 & ~x23));
  assign new_n82_ = x15 & (new_n83_ | ~x08);
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n84_ = ~x02 & ~x10 & x21 & (~x08 | x16);
  assign new_n85_ = ~new_n77_ & ((~new_n80_ & x07) | (x18 & (new_n83_ | ~x08)));
  assign new_n86_ = ~x13 & (new_n82_ | (x19 & (x08 | (new_n81_ & ~x16))));
  assign new_n87_ = x09 & (x21 | (new_n77_ & ~x16 & x19));
  ...
  assign z6 = (~new_n92_ & (new_n95_ | x03)) | new_n97_ | (~new_n61_ & (new_n96_ | ~x03));
  assign new_n92_ = (new_n94_ | (x09 & x21)) & (~new_n93_ | x10 | x21 | x24);
  ...
  assign new_n97_ = ~x10 & x21 & ~x24 & x00 & ~x02 & ~x09;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n99_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n99_ = x21 & (x09 | (~x02 & ~x10 & ~x24));
endmodule
