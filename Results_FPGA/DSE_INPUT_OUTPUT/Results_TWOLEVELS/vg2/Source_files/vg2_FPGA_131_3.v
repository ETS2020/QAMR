...
module FAU ( 
  ...
  assign z4 = ((new_n87_ | x08) & (new_n82_ | new_n38_)) | (z7 & (new_n88_ | ~x08));
  ...
  assign new_n91_ = (~x01 | ~x02) & (~x07 | ~x13 | ~x24);
  assign z6 = new_n93_ | new_n94_ | (x01 & x02);
  assign new_n93_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n94_ = ~new_n95_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n95_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n86_ & (x05 | x13 | ~x15);
endmodule
