...
module FAU ( 
  ...
  assign z4 = (~new_n77_ & (new_n81_ | x08)) | new_n80_ | (~new_n79_ & (new_n82_ | ~x08));
  assign new_n77_ = (new_n78_ | (~x20 & ~x21)) & (~new_n39_ | x10 | ~x20 | x24);
  assign new_n78_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n79_ = ~new_n66_ & (new_n73_ | (~x20 & ~x21));
  assign new_n80_ = new_n39_ & ~x10 & x21 & ~x24;
  ...
  assign new_n85_ = (x20 | x21) & (x05 | x13 | ~x19);
  assign z6 = (~new_n87_ & x20) | (~new_n88_ & x21);
  assign new_n87_ = (new_n37_ | (~x03 & (x11 | (~x06 & x14)))) & (new_n73_ | (x03 & (x06 | ~x11)));
  assign new_n88_ = ~new_n89_ & ~new_n38_ & (new_n78_ | (~x03 & (~x06 | x11)));
  assign new_n89_ = ~new_n90_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n91_ & (x05 | x13 | ~x15);
  assign new_n91_ = ~x02 & ~x10 & ~x24;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n93_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n93_ = ~new_n66_ & (x20 | x21);
endmodule
