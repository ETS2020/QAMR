...
module FAU ( 
  ...
  assign z2 = (~x03 & ~x23) | (x01 & new_n45_ & x03);
  assign new_n45_ = x06 & x11 & x14 & ~new_n42_ & x20;
  ...
  assign z6 = (~new_n37_ & (new_n67_ | x03)) | (~new_n42_ & (x03 ? new_n68_ : x23));
  assign new_n67_ = ~x11 & x23 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n70_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n70_ = ~new_n43_ & ~new_n60_;
endmodule
