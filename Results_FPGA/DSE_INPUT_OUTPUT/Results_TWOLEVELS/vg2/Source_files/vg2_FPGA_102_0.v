...
module FAU ( 
  ...
  assign new_n64_ = x11 & x14 & x20 & (new_n67_ | (~new_n65_ & x21));
  ...
  assign new_n86_ = (~x07 | ~x24 | (~x05 & (~x13 | ~x21))) & (~x19 | ~x21 | x05 | x13);
  ...
  assign z7 = new_n67_ | new_n91_ | new_n81_ | (x13 & x18 & x24);
  assign new_n91_ = ~x05 & (~x21 | (~x13 & x15));
endmodule
