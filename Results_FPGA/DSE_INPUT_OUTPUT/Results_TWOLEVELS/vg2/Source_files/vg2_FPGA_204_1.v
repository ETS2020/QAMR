...
module FAU ( 
  ...
  assign z7 = (~new_n65_ & (x09 | ~x21)) | (~x02 & x09 & ~x10 & x21 & ~x24);
  ...
  assign new_n82_ = ~x09 & (x21 | (~new_n65_ & x16));
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = x16 & x22 & (~x17 | (~x04 & x23));
  assign z5 = new_n86_ | ~new_n87_ | new_n38_ | (x07 & x13 & x24);
  assign new_n86_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n87_ = (x05 | x13 | ~x19) & (x09 | ~x21);
  assign z6 = new_n89_ | new_n90_ | (~x09 & x21);
