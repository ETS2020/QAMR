// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:39 2020
...
module FAU ( 
  ...
  assign new_n48_ = (x05 | new_n49_ | x13) & (~x05 | x21) & (~x24 | new_n58_ | (~x05 & ~x13));
  ...
  assign new_n52_ = new_n53_ & x15 & x16 & x12 & x14;
  ...
  assign new_n58_ = (~new_n50_ | ~new_n59_) & (~new_n62_ | ~new_n63_ | ~new_n54_ | ~new_n61_);
  ...
  assign new_n65_ = x20 & (new_n66_ | (~x05 & (x13 ? new_n68_ : x15)));
  assign new_n66_ = x21 & (new_n67_ | (~x02 & ~x10 & ~x24));
  assign new_n67_ = x05 & (new_n68_ | (new_n69_ & x13));
  assign new_n68_ = x18 & x24;
  assign new_n69_ = x15 & ~x24;
  assign z3 = ~new_n71_ | (~x24 & (x01 ? (new_n79_ & x03) : (new_n80_ & ~x03)));
  assign new_n71_ = (x05 | new_n76_ | x13) & (~x05 | x21) & (~x24 | new_n72_ | (~x05 & ~x13));
  ...
  assign new_n80_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n47_ & ~x20;
  assign z4 = (~new_n37_ & (new_n85_ | x08)) | new_n39_ | (~new_n82_ & (new_n86_ | ~x08));
  assign new_n82_ = ~new_n67_ & new_n83_ & (~new_n68_ | ~x13);
  assign new_n83_ = ~new_n84_ & (x05 | x13 | ~x15);
  ...
  assign new_n88_ = ~x24 & (new_n89_ | (x00 & ~x02 & ~new_n39_ & ~x10));
  assign new_n89_ = x05 & x13 & x19 & x21;
  assign new_n90_ = (x05 | ((x13 | ~x19) & (~x07 | ~x13 | ~x24))) & (~x21 | ~x24 | ~x05 | ~x07);
  assign z6 = (~new_n37_ & (new_n92_ | x03)) | new_n39_ | (~new_n82_ & (new_n93_ | ~x03));
  assign new_n92_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n93_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x13 & (new_n68_ | (new_n69_ & x05))) | ~new_n83_ | (x05 & (new_n68_ | ~x21));
endmodule
