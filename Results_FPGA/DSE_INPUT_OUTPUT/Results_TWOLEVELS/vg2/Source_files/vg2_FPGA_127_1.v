...
module FAU ( 
  ...
  assign new_n47_ = (new_n48_ | ~x13) & (new_n49_ | ~x05) & (~x15 | x21 | x05 | x13);
  assign new_n48_ = (~x18 | x21 | ~x24) & (~x05 | ~x15 | x24);
  assign new_n49_ = (~x18 | ~x24) & (~x21 | x24 | x02 | x10);
  assign z2 = x01 & x03 & new_n51_ & x06;
  assign new_n51_ = x11 & x14 & ~new_n47_ & x20;
  assign z3 = x01 ? (x03 & x06 & new_n51_ & x08) : (~x03 & ~x06 & new_n53_ & ~x08);
  assign new_n53_ = ~x11 & ~x14 & ~new_n42_ & ~x20;
  assign z4 = (~new_n55_ & (new_n58_ | x08)) | new_n60_ | (~new_n47_ & (new_n59_ | ~x08));
  assign new_n55_ = (new_n57_ | ~x05) & (x21 | (new_n56_ & (x05 | x13 | ~x19)));
  assign new_n56_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  ...
  assign z5 = ~new_n44_ | (~x24 & (new_n62_ | (x05 & x13 & x19)));
  assign new_n62_ = x00 & ~x02 & ~x10 & (~x21 | (x05 & x21));
  assign z6 = (~new_n55_ & (new_n64_ | x03)) | new_n60_ | (~new_n47_ & (new_n65_ | ~x03));
  assign new_n64_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n65_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n67_ & x05) | ~new_n68_ | (~x05 & (x21 | (~x13 & x15)));
  assign new_n67_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n68_ = (~x13 | ~x18 | ~x24) & (~x21 | x24 | x02 | x10);
endmodule
