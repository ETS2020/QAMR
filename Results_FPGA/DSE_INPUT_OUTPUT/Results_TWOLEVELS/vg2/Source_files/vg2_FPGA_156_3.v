...
module FAU ( 
  ...
  assign new_n44_ = x11 & x14 & x20 & ~new_n45_ & (~x08 | (x08 & ~x12));
  ...
  assign z4 = (~new_n37_ & (new_n61_ | (x08 & ~x12))) | (x08 & x12) | (~new_n45_ & (new_n62_ | ~x08));
  ...
  assign new_n68_ = ~new_n46_ & (x05 | x13 | ~x15) & ~new_n39_ & (~new_n69_ | ~x13);
