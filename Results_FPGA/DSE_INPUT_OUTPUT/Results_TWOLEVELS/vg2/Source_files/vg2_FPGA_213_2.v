...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n76_ | x08)) | new_n78_ | (~new_n74_ & (new_n77_ | ~x08));
  ...
  assign z5 = (~new_n80_ & (~x01 | x02)) | (~x02 & ~x10 & ~x24 & x00 & ~x01);
  assign new_n80_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | new_n78_ | (~new_n74_ & (new_n83_ | ~x03));
