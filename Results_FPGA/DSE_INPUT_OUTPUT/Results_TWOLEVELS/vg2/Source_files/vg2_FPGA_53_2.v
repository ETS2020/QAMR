...
module FAU ( 
  ...
  assign z2 = (new_n63_ & x01) | (x16 & ~x22);
  ...
  assign z4 = ~new_n79_ | (~new_n38_ & (new_n81_ | x08 | (x09 & ~x16)));
  assign new_n79_ = (~x16 | x22) & (new_n64_ | (x08 & (new_n80_ | ~x16)));
  assign new_n80_ = x09 & x17 & (x04 | ~x23);
