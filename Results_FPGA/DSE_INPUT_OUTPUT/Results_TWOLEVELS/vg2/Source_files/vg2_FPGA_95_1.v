...
module FAU ( 
  ...
  assign new_n56_ = ~x10 & (x21 | (new_n57_ & new_n58_ & new_n54_ & new_n59_));
  assign new_n57_ = x00 & ~x01 & ~x02 & ~x03;
  ...
  assign z3 = (new_n74_ & new_n75_) | (~new_n39_ & (new_n65_ | new_n69_));
  ...
  assign new_n69_ = x24 & ~new_n60_ & (new_n70_ | new_n72_);
  ...
  assign z4 = (~new_n39_ & ~new_n63_ & (new_n80_ | ~x08)) | (z5 & (new_n79_ | x08));
  assign z5 = (~new_n78_ & (x10 | ~x21)) | (~x10 & ~x21 & ~x24 & x00 & ~x02);
  ...
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | new_n39_ | (~new_n63_ & (new_n83_ | ~x03));
