...
module FAU ( 
  ...
  assign z4 = ~new_n55_ | ((new_n59_ | x08) & (~new_n57_ | new_n60_));
  assign new_n55_ = (x05 | ~x21) & (new_n50_ | (~new_n56_ & x08));
  assign new_n56_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n57_ = (~x07 | ~x13 | ~x24) & ~new_n58_ & (x05 | x13 | ~x19);
  assign new_n58_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n59_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n60_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign z5 = new_n60_ | ~new_n62_ | (~x05 & (x21 | (~x13 & x19)));
  assign new_n62_ = ~new_n58_ & (~x07 | ~x13 | ~x24);
  assign z6 = (~new_n64_ & (new_n65_ | x03)) | new_n67_ | (~new_n45_ & (new_n66_ | ~x03));
  assign new_n64_ = ~new_n60_ & (x21 | (new_n62_ & (x05 | x13 | ~x19)));
  assign new_n65_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n66_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n67_ = x00 & ~x02 & x05 & ~x10 & x21 & ~x24;
  assign z7 = (~new_n70_ & x05) | ~new_n69_ | (~x05 & (x21 | (~x13 & x15)));
  assign new_n69_ = ~new_n51_ & (~x13 | ~x18 | ~x24);
