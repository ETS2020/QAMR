...
module FAU ( 
  ...
  assign new_n46_ = ~x23 & ((x05 & x13 & x19) | (~x02 & ~x10));
  ...
  assign new_n57_ = ~new_n60_ & (~new_n49_ | ~new_n58_);
  ...
  assign new_n64_ = x02 & (new_n48_ | (~new_n57_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign z2 = x01 & x03 & x06 & new_n66_ & x11;
  assign new_n66_ = x14 & x20 & (new_n68_ | (~new_n67_ & (x00 | x02)));
  assign new_n67_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n68_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~new_n77_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n74_ | (x24 & ~new_n70_ & (x05 | x13));
  ...
  assign new_n74_ = ~x02 & (~x00 | (~x10 & ~new_n75_ & ~x24));
  assign new_n75_ = (~new_n73_ | x01 | x03 | x06) & (~new_n76_ | ~x01 | ~x03 | ~x06 | ~x08);
  assign new_n76_ = x11 & x14 & x20 & x21;
  ...
  assign z4 = ~new_n81_ | (~new_n37_ & (new_n83_ | x08));
  assign new_n81_ = ~new_n68_ & ((~x00 & ~x02) | new_n67_ | (~new_n82_ & x08));
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n38_ | (~x02 & (~x00 | (~x10 & ~x24)));
  assign z6 = (~new_n67_ & (new_n88_ | ~x03)) | new_n90_ | (~new_n86_ & (new_n89_ | x03));
  assign new_n86_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n87_ & (x05 | x13 | ~x19);
  assign new_n87_ = ~x02 & ~x10 & ~x24;
  assign new_n88_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n89_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n90_ = ~x02 & (~x00 | (x21 & ~x24 & x00 & ~x10));
  assign z7 = ~new_n67_ | new_n90_;
endmodule
