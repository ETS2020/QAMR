// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:34 2020
...
module FAU ( 
  ...
  assign new_n47_ = ~new_n48_ & (~x13 | ~x18 | ~x24) & (new_n49_ | ~x21);
  assign new_n48_ = x05 & ((x18 & x21 & x24) | (x13 & x15 & ~x24));
  assign new_n49_ = (x05 | x13 | ~x15) & (x02 | x10 | x24);
  assign z2 = new_n51_ & x01;
  assign new_n51_ = x03 & x06 & x11 & x14 & ~new_n47_ & x20;
  assign z3 = ~new_n53_ | (~x24 & (x01 ? (new_n61_ & x03) : (new_n63_ & ~x03)));
  assign new_n53_ = (~x24 | new_n54_ | (~x05 & ~x13)) & (x13 | (x21 & (new_n58_ | x05)));
  ...
  assign z4 = (~new_n66_ & (new_n69_ | x08)) | new_n71_ | (~new_n47_ & (new_n70_ | ~x08));
  assign new_n66_ = (new_n68_ | ~x05) & (x05 | x13 | ~x19 | ~x21) & (new_n67_ | ~x13);
  assign new_n67_ = ~new_n38_ & (~x07 | ~x24);
  assign new_n68_ = (~x13 | ~x19 | x24) & (~x07 | ~x21 | ~x24);
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n70_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n71_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z6 = new_n73_ | new_n74_ | (~x13 & ~x21);
  ...
  assign z7 = (~new_n79_ & x05) | ~new_n78_ | (~x13 & (~x21 | (~x05 & x15)));
  assign new_n78_ = ~new_n76_ & (~x13 | ~x18 | ~x24);
  assign new_n79_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
endmodule
