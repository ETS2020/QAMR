...
module FAU ( 
  ...
  assign new_n44_ = x21 & (x01 | x03 | x04 | ~new_n45_ | x06);
  ...
  assign z2 = (~x21 & ~x24) | (new_n64_ & x01);
  ...
  assign z3 = (x21 & (new_n76_ | (~new_n73_ & ~x24))) | (x24 & (new_n68_ | new_n76_));
  ...
  assign new_n74_ = x11 & x14 & ~new_n43_ & x20;
  assign new_n75_ = ~x11 & ~x14 & ~new_n47_ & ~x20;
  ...
  assign z4 = (~new_n81_ & (new_n82_ | x08)) | new_n84_ | (~new_n65_ & (new_n83_ | ~x08));
  ...
  assign new_n84_ = ~x24 & (~x21 | (x00 & ~x02 & ~x10 & x21));
  assign z5 = (x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | new_n84_ | (x07 & x13 & x24) | (~x05 & ~x13 & x19);
  assign z6 = ~new_n87_ | (~new_n90_ & ((~new_n91_ & x05) | ~new_n93_ | (new_n92_ & ~x05)));
  assign new_n87_ = ~new_n88_ & (~x00 | x02 | x10 | ~x21 | x24);
  assign new_n88_ = ~new_n89_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n89_ = (~x05 | ((~x07 | ~x24) & (~x21 | x24 | ~x13 | ~x19))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19 | (~x21 & ~x24));
  assign new_n90_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n91_ = (~x18 | ~x24) & (~x13 | ~x15 | ~x21 | x24);
  assign new_n92_ = ~x13 & x15 & (x21 | x24);
  assign new_n93_ = (~x13 | ~x18 | ~x24) & (~x21 | x24 | x02 | x10);
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (~new_n95_ & ~x24) | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n95_ = x21 & (x02 | x10);
endmodule
