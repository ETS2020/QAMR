...
module FAU ( 
  ...
  assign z2 = (x01 & new_n58_ & x03) | (~x03 & ~x21);
  assign new_n58_ = x06 & x11 & x14 & ~new_n59_ & x20;
  ...
  assign z4 = (~new_n69_ & (new_n72_ | x08)) | new_n74_ | (~new_n71_ & (new_n73_ | ~x08));
  assign new_n69_ = (new_n70_ | (~x03 & ~x21)) & (~x00 | x02 | ~new_n39_ | ~x03);
  ...
  assign z6 = ~new_n77_ | (x11 & ~new_n59_ & (~x06 | (x14 & ~x20)));
  assign new_n77_ = (new_n78_ | x24) & new_n83_ & (~x24 | new_n81_ | (~x05 & ~x13));
  assign new_n78_ = ~new_n79_ & (x02 | x10 | (x03 & (~x00 | ~x03)));
  assign new_n79_ = x05 & x13 & (new_n80_ | (~x03 & x15 & x21));
  assign new_n80_ = x19 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n81_ = (~x07 | (~new_n82_ & ~x03)) & (x03 | ~x18 | ~x21);
  assign new_n82_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n83_ = (x05 | ~new_n80_ | x13) & (x03 | (x21 & (~x15 | ~x21 | x05 | x13)));
