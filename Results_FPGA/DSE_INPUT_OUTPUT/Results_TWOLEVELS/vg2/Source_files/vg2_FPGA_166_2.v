...
module FAU ( 
  ...
  assign z1 = (~x02 & (new_n40_ | x01)) | new_n44_ | (new_n52_ & x24);
  assign new_n40_ = new_n41_ & new_n43_ & ~x20 & ~x22 & ~x23 & ~x24;
  assign new_n41_ = new_n42_ & x00 & ~x03 & ~x04 & ~x06;
  ...
  assign z7 = ~new_n61_ | (~x02 & (x01 | (~x10 & x21 & ~x24)));
endmodule
