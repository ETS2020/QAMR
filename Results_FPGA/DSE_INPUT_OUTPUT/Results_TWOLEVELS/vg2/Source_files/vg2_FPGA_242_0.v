...
module FAU ( 
  ...
  assign z2 = new_n60_ | (new_n57_ & x01);
  ...
  assign new_n64_ = ~x08 & ~x11 & ~x14 & ~new_n43_ & ~x20;
  assign new_n65_ = x08 & ~x10 & x11 & x14 & x20;
  assign new_n66_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n51_ & ~x20;
  assign new_n67_ = x06 & x08 & x11 & x14 & ~new_n55_ & x20;
  assign z4 = (~new_n37_ & (new_n69_ | x08)) | new_n60_ | (~new_n58_ & (new_n70_ | ~x08));
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n70_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n73_ & x05) | ~new_n72_ | new_n60_ | (~x05 & ~x13 & x19);
  assign new_n72_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n73_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = ~new_n75_ | (~new_n37_ & (x03 | (x06 & ~x11)));
  assign new_n75_ = (~x24 | new_n76_ | (~x05 & ~x13)) & new_n79_ & (new_n78_ | (x05 ? (~x13 | x24) : x13));
  assign new_n76_ = (new_n77_ | ~x18) & (~x07 | x11 | x14 | ~x20);
  assign new_n77_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n78_ = (new_n77_ | ~x15) & (~x19 | ~x20 | x11 | x14);
  assign new_n79_ = (x14 | x21) & (x02 | x10 | ~x21 | new_n77_ | x24);
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n81_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n81_ = ~new_n59_ & ~new_n60_;
endmodule
