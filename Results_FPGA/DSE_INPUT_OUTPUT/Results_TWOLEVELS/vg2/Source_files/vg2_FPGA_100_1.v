...
module FAU ( 
  ...
  assign new_n36_ = ~x21 & (~new_n37_ | ~x00 | x01 | x03 | x06);
  ...
  assign new_n41_ = ~x02 & (x21 | (new_n42_ & new_n44_));
  assign new_n42_ = new_n43_ & x00 & ~x01 & ~x03 & ~x04;
  assign new_n43_ = ~x06 & ~x08 & ~x09 & ~x10;
  assign new_n44_ = new_n45_ & ~x17 & ~x20 & ~x22 & ~x23 & ~x24;
  ...
  assign new_n55_ = (~new_n47_ | ~new_n56_) & (~new_n51_ | ~new_n58_ | ~new_n45_ | ~new_n59_);
  ...
  assign z2 = new_n63_ | (new_n61_ & x01);
  ...
  assign z3 = (new_n74_ & new_n75_) | (~new_n63_ & (new_n65_ | new_n69_));
  assign new_n65_ = ~new_n66_ & (x05 ? (x13 & ~x24) : ~x13);
  ...
  assign new_n74_ = ~x03 & ~x06 & ~x08 & x00 & ~x01 & ~x02;
  assign new_n75_ = ~x20 & ~x21 & ~x24 & ~x10 & ~x11 & ~x14;
  assign z4 = (~new_n77_ & (new_n79_ | x08)) | new_n63_ | (~new_n62_ & (new_n80_ | ~x08));
  ...
  assign z5 = ~new_n39_ | (~x02 & (x21 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n83_ & (new_n84_ | x03)) | (~new_n63_ & ~new_n62_ & (new_n85_ | ~x03));
  assign new_n83_ = (new_n39_ | (~x02 & x21)) & (~x00 | x02 | x10 | x21 | x24);
