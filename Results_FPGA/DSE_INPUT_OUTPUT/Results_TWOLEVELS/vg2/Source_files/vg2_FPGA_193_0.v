...
module FAU ( 
  ...
  assign z7 = new_n46_ | (~new_n47_ & x21) | (x13 & x18 & x24);
  assign new_n46_ = x05 & ((x18 & x21 & x24) | (x13 & x15 & ~x24));
  assign new_n47_ = (x05 | x13 | ~x15) & (x02 | x10 | x24);
  ...
  assign new_n52_ = (new_n53_ | ~x05) & (~x19 | ~x21 | x05 | x13) & (new_n54_ | ~x13);
  assign new_n53_ = (~x07 | ~x21 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n54_ = (~x07 | ~x24) & (x10 | x24 | ~x00 | x02);
