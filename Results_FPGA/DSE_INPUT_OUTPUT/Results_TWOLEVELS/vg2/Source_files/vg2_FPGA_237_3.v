...
module FAU ( 
  ...
  assign new_n76_ = new_n77_ & new_n78_ & x11 & x14 & x20;
  assign new_n77_ = x06 & x08 & ~x10 & x01 & ~x02 & x03;
  assign new_n78_ = x21 & ~x22 & ~x24;
  assign z4 = ~new_n80_ | (~new_n63_ & (~x08 | (~x09 & x16)));
  assign new_n80_ = (new_n37_ | (~new_n83_ & ~x08)) & (new_n81_ | ~x22);
  assign new_n81_ = ~x21 & (~x16 | new_n82_ | (x17 & (x04 | ~x23)));
  ...
  assign new_n86_ = x00 & ~x02 & ~x10 & (~x21 | (x21 & ~x22));
  assign new_n87_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign z6 = (~new_n89_ & (new_n93_ | x03)) | new_n92_ | (~new_n91_ & (new_n94_ | ~x03));
  assign new_n89_ = ~new_n90_ & (x10 | x21 | x24 | ~x00 | x02);
  assign new_n90_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n91_ = (new_n39_ | new_n82_) & (~new_n78_ | x02 | x10);
  assign new_n92_ = new_n78_ & x00 & ~x02 & ~x10;
  ...
  assign new_n96_ = x21 & (x22 | (~x02 & ~x10 & ~x24));
endmodule
