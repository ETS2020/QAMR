...
module FAU ( 
  ...
  assign z3 = (~x02 & (~new_n68_ | (~new_n78_ & ~new_n81_))) | (~x18 & (new_n75_ | (~new_n78_ & ~new_n81_)));
  assign new_n68_ = (~x24 | new_n69_ | new_n62_) & (x10 | new_n73_ | x24);
  ...
  assign new_n73_ = ~new_n74_ & (~new_n71_ | x03 | x06 | ~x00 | x01);
  assign new_n74_ = new_n72_ & x20 & x21 & x11 & x14;
  assign new_n75_ = ~x01 & ~x03 & ~x06 & x07 & new_n76_ & ~x08;
  assign new_n76_ = ~x11 & ~x14 & new_n77_ & ~x20;
  assign new_n77_ = ~new_n62_ & x24;
  ...
  assign z4 = (~new_n37_ & (new_n83_ | x08)) | new_n39_ | (~new_n65_ & (new_n84_ | ~x08));
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = new_n86_ | new_n87_ | new_n38_;
  assign new_n86_ = x19 & ~new_n39_ & ~new_n81_;
  assign new_n87_ = x07 & x24 & ~new_n62_ & (~x18 | (~x02 & x18));
  assign z6 = new_n89_ | (~new_n91_ & ~x02) | (x15 & new_n96_ & ~x18);
  assign new_n89_ = ~new_n90_ & (new_n86_ | new_n38_ | (x07 & new_n77_ & ~x18));
  assign new_n90_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n91_ = (~new_n92_ | ~x18) & (new_n94_ | (~new_n93_ & x03));
  assign new_n92_ = x24 & ~new_n62_ & (new_n93_ | ~x03 | x07);
  assign new_n93_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n94_ = ~new_n95_ & (new_n81_ | ~x15);
  assign new_n95_ = ~x10 & x21 & ~x24;
  assign new_n96_ = ~new_n81_ & (new_n93_ | ~x03);
  assign z7 = (x15 & ~new_n81_ & (~x02 | ~x18)) | (~x02 & (new_n95_ | (new_n77_ & x18)));
endmodule
