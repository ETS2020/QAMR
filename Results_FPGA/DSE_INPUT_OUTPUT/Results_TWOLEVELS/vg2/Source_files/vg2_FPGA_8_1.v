...
module FAU ( 
  ...
  assign new_n70_ = (x01 | (~new_n71_ & ~x02)) & (~new_n73_ | ~x01 | x02 | ~new_n42_ | ~x03);
  assign new_n71_ = new_n72_ & ~x06 & ~x08 & x00 & ~x03;
  assign new_n72_ = ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  assign new_n73_ = x20 & x21 & ~x24 & ~x10 & x11 & x14;
  ...
  assign z4 = ((new_n82_ | new_n64_) & (new_n84_ | ~x08)) | (z5 & (new_n83_ | x08));
  assign z5 = new_n81_ | (~new_n79_ & ~new_n80_);
  assign new_n79_ = ~x01 & x02;
  assign new_n80_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n81_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n82_ = ~new_n79_ & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n86_ & (new_n87_ | x03)) | new_n79_ | (~new_n63_ & (new_n88_ | ~x03));
  assign new_n86_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n81_ & (x05 | x13 | ~x19);
  assign new_n87_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n88_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n90_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n90_ = ~new_n64_ & (x05 | x13 | ~x15) & ~new_n79_ & (~new_n91_ | ~x13);
  assign new_n91_ = x18 & x24;
endmodule
