...
module FAU ( 
  ...
  assign z7 = new_n67_ | (x21 & (new_n66_ | (~x02 & ~x10 & ~x24)));
  assign new_n66_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n67_ = ~x05 & (x13 ? (x18 & x24) : x15);
  ...
  assign z6 = ~new_n80_ | (~new_n83_ & (x05 ? new_n84_ : ~new_n82_));
  assign new_n80_ = ~new_n81_ & (~x00 | x02 | x10 | ~x21 | x24);
  assign new_n81_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n82_ = (x13 | ~x19) & ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n83_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n84_ = x21 & ((x13 & x19 & ~x24) | (x07 & x24));
endmodule
