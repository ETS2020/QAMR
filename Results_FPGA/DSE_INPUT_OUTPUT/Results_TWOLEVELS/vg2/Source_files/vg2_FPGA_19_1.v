// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:11 2020
...
module FAU ( 
  ...
  assign z4 = (~new_n79_ & (x08 | (~new_n84_ & ~x16))) | (z7 & (~x08 | (~new_n85_ & x16)));
  assign new_n79_ = ~new_n81_ & (new_n80_ | (~x01 & x02));
  assign new_n80_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n81_ = x00 & ~x02 & ~x10 & ~x24;
  assign z7 = new_n65_ | (~new_n83_ & (x01 | ~x02));
  ...
  assign z5 = new_n39_ | ~new_n87_ | new_n38_ | new_n81_;
  assign new_n87_ = (~x07 | ~x13 | ~x24) & (x01 | ~x02);
  assign z6 = (~new_n79_ & (x03 | (~new_n89_ & ~x11))) | (z7 & (~x03 | (~new_n90_ & x11)));
