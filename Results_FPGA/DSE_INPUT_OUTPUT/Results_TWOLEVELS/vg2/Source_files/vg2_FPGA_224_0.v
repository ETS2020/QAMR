...
module FAU ( 
  ...
  assign z1 = (~new_n41_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n38_ | (x24 & ~new_n50_ & (x05 | x13));
  ...
  assign z3 = (~new_n65_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n38_ | (x24 & ~new_n61_ & (x05 | x13));
  ...
  assign z4 = (~new_n39_ & (new_n69_ | x08)) | new_n38_ | (~new_n59_ & (new_n70_ | ~x08));
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n70_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n39_ & (new_n72_ | x03)) | new_n38_ | (~new_n59_ & (new_n73_ | ~x03));
