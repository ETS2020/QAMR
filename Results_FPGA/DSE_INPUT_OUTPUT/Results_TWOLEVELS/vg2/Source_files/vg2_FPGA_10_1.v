...
module FAU ( 
  ...
  assign new_n42_ = ~x06 & ~x09 & ~x10 & ~x11;
  ...
  assign z5 = ~new_n38_ | (~x02 & (x08 | (x00 & ~x10 & ~x24)));
  assign z6 = new_n86_ | new_n89_ | (~x02 & x08);
  ...
  assign z7 = (~new_n63_ & (x02 | ~x08)) | (~x02 & ~x08 & ~x10 & x21 & ~x24);
endmodule
