...
module FAU ( 
  ...
  assign z1 = new_n40_ | (x24 & ~new_n49_ & ~new_n61_) | (~new_n56_ & ~x02);
  ...
  assign new_n56_ = ~x10 & (x24 | ((~new_n41_ | ~new_n58_) & (~new_n57_ | ~new_n59_)));
  assign new_n57_ = new_n54_ & new_n55_;
  assign new_n58_ = new_n51_ & x20 & x21 & x22 & x23;
  ...
  assign new_n71_ = ~x02 & (x10 | (~new_n72_ & ~x24));
  assign new_n72_ = (~new_n69_ | ~new_n73_) & (~new_n70_ | ~new_n74_);
  assign new_n73_ = ~x03 & ~x06 & x00 & ~x01;
