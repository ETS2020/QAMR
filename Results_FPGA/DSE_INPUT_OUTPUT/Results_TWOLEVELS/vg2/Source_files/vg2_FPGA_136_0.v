...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n61_ | x08)) | new_n55_ | (~new_n42_ & (new_n62_ | ~x08));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n65_ & x05) | ~new_n64_ | new_n55_ | (~x05 & ~x13 & x19);
  assign new_n64_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n65_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n67_ | x03)) | new_n55_ | (~new_n42_ & (new_n68_ | ~x03));
