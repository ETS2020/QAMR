...
module FAU ( 
  ...
  assign z4 = ((~new_n81_ | new_n90_) & x15) | (~new_n87_ & x17);
  assign new_n81_ = ~new_n82_ & (new_n84_ | ~x24) & (x02 | x10 | new_n86_ | x24);
  assign new_n82_ = (x05 ? (x13 & ~x24) : ~x13) & (new_n83_ | ~x08 | x19);
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n84_ = (new_n85_ | ~x18) & (~x07 | ~x08 | (~x05 & ~x13));
  assign new_n85_ = x08 & (~x16 | (x09 & (x17 | ~x22)));
  assign new_n86_ = (~x00 | ~x08) & (new_n85_ | ~x21);
  assign new_n87_ = ~new_n88_ & (new_n37_ | (~x08 & (x16 | (~x09 & x22))));
  assign new_n88_ = ~new_n89_ & (new_n68_ | (x18 & x24 & (x05 | x13)));
  assign new_n89_ = x08 & (~x16 | (x09 & (x04 | ~x22 | ~x23)));
  assign new_n90_ = ~x16 & ~new_n91_ & (new_n38_ | (x07 & ~x08 & x24));
  assign new_n91_ = ~x09 & (~x04 | x22 | x23);
  ...
  assign z6 = (~new_n37_ & (new_n96_ | x03)) | new_n39_ | (~new_n67_ & (new_n97_ | ~x03));
  ...
  assign new_n99_ = ~new_n39_ & ~new_n68_;
endmodule
