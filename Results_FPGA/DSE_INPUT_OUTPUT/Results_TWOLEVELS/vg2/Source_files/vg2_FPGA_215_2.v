...
module FAU ( 
  ...
  assign z1 = (~x02 & (new_n41_ | x01)) | new_n45_ | (new_n53_ & x24);
  assign new_n41_ = new_n42_ & new_n44_ & ~x20 & ~x22 & ~x23 & ~x24;
  ...
  assign new_n50_ = new_n51_ & ~x01 & ~x03 & ~x04 & new_n44_ & new_n52_;
  assign new_n51_ = ~x06 & ~x08 & ~x09 & ~x11;
  assign new_n52_ = ~x22 & ~x23 & x19 & ~x20;
  assign new_n53_ = (x05 | x13) & (new_n54_ | (new_n46_ & new_n58_ & new_n59_));
  ...
  assign new_n77_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n80_ = x01 & ~x02;
  assign z5 = (x00 & ~x01 & ~x02 & ~x10 & ~x24) | (~new_n39_ & (~x01 | x02));
  assign z6 = (~new_n83_ & (~x03 | (~new_n85_ & x11))) | (z5 & (x03 | (~new_n84_ & ~x11)));
  assign new_n83_ = (new_n62_ | (x01 & ~x02)) & (x01 | x02 | x10 | ~x21 | x24);
