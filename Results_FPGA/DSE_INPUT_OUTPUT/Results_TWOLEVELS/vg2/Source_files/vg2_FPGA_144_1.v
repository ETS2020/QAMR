...
module FAU ( 
  ...
  assign z1 = new_n41_ | (new_n50_ & x24) | (~x10 & (new_n57_ | x21));
  ...
  assign z3 = (~new_n71_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n68_ | (x24 & ~new_n64_ & (x05 | x13));
  ...
  assign new_n68_ = ~x10 & (new_n69_ | x21);
  assign new_n69_ = new_n70_ & ~x02 & ~x03 & ~x06 & x00 & ~x01;
  assign new_n70_ = ~x08 & ~x11 & ~x14 & ~x20 & ~x24;
