...
module FAU ( 
  ...
  assign new_n46_ = x11 & x14 & x20 & ~new_n42_ & ~new_n44_;
  ...
  assign z4 = (~new_n37_ & (new_n61_ | x08)) | (~x08 & ~x12) | (~new_n42_ & (new_n62_ | ~x08));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n44_;
  assign z6 = ~new_n44_ & (new_n65_ | new_n66_);
  assign new_n65_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n66_ = ~new_n42_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n68_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n68_ = ~new_n43_ & (x05 | x13 | ~x15) & ~new_n44_ & (~new_n69_ | ~x13);
