...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n78_ | x08)) | new_n74_ | (~new_n63_ & (new_n79_ | ~x08));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n82_ & x05) | ~new_n81_ | new_n74_ | (~x05 & ~x13 & x19);
  assign new_n81_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n82_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n84_ | x03)) | new_n74_ | (~new_n63_ & (new_n85_ | ~x03));
