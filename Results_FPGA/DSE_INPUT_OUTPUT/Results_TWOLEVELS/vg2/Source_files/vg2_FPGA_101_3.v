...
module FAU ( 
  ...
  assign z3 = (~x02 & (new_n68_ | new_n72_ | (new_n78_ & ~x10))) | (~x22 & (new_n68_ | new_n72_));
  ...
  assign z4 = new_n81_ | new_n83_ | (x22 & (x02 | (new_n84_ & x16)));
  assign new_n81_ = ~new_n37_ & (new_n82_ | x08);
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n83_ = ~new_n65_ & (~x08 | (~x09 & x16));
  assign new_n84_ = ~new_n85_ & (~x17 | (~x04 & x23));
  ...
  assign z6 = new_n91_ | (~new_n94_ & (new_n38_ | (~new_n39_ & ~new_n95_)));
  assign new_n91_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = new_n66_ | (~new_n39_ & ~new_n93_);
