...
module FAU ( 
  ...
  assign new_n78_ = (new_n39_ | (~x08 & (~x09 | x16))) & (~new_n79_ | x16);
  assign new_n79_ = ~x22 & (x17 | (x04 & ~x20 & ~x23));
  assign new_n80_ = (~new_n81_ | ~x16) & (new_n39_ | (x08 & (x09 | ~x16)));
  assign new_n81_ = x22 & ((~x17 & ~x20) | (~x04 & x17 & x23));
  ...
  assign z6 = ~new_n87_ | (~new_n86_ & ~new_n39_);
  assign new_n86_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n64_ | (x03 & (x06 | ~x11)));
  assign new_n87_ = (x24 | (~new_n88_ & (~x05 | new_n90_ | ~x13))) & (x05 | new_n90_ | x13) & (~x24 | new_n91_ | (~x05 & ~x13));
  assign new_n88_ = ~x02 & ~new_n89_ & ~x10;
  assign new_n89_ = (~x00 | x11 | x14 | ~x17 | ~x20) & (x20 | ~x21 | ~x11 | ~x14);
  assign new_n90_ = (x11 | x14 | ~x17 | ~x19 | ~x20) & (~x11 | ~x14 | ~x15 | x20);
  assign new_n91_ = (~x07 | x11 | x14 | ~x17 | ~x20) & (~x18 | x20 | ~x11 | ~x14);
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n93_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n93_ = ~new_n39_ & ~new_n65_;
endmodule
