...
module FAU ( 
  ...
  assign z3 = ~new_n67_ | (~x24 & (x01 ? (new_n74_ & x03) : (new_n75_ & ~x03)));
  assign new_n67_ = (~x24 | new_n68_ | (~x05 & ~x13)) & ~new_n61_ & (x05 | new_n71_ | x13);
  assign new_n68_ = (~new_n69_ | ~x01 | ~x03 | ~x06) & (~new_n70_ | x01 | x03 | x06 | ~x07);
  ...
  assign z4 = new_n77_ | (x24 & ~new_n83_ & (x05 | x13));
  assign new_n77_ = ~new_n61_ & (new_n78_ | (~x02 & new_n82_ & ~x10));
  assign new_n78_ = ~new_n79_ & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n79_ = (~x15 | (~new_n80_ & x08)) & (~x19 | (~new_n81_ & ~x08));
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n81_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n82_ = ~x24 & ((x21 & (new_n80_ | ~x08)) | (x00 & (new_n81_ | x08)));
  assign new_n83_ = (~x18 | ~x20 | (~new_n80_ & ~x07 & x08)) & (~x07 | x18 | (~new_n81_ & ~x08));
  assign z5 = (~new_n86_ & x05) | ~new_n85_ | new_n61_ | (~x05 & ~x13 & x19);
  assign new_n85_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n86_ = (~x13 | ~x19 | x24) & (~x07 | ~x24);
  assign z6 = new_n88_ | new_n89_ | (x18 & (new_n91_ | ~x20));
  assign new_n88_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n89_ = ~new_n90_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = ~new_n65_ & (~x15 | (x05 ? (~x13 | x24) : x13));
  assign new_n91_ = x24 & (x05 | x13) & (~x03 | (~x06 & x11));
  assign z7 = (~new_n90_ & (~x18 | x20)) | (x18 & x20 & x24 & (x05 | x13));
endmodule
