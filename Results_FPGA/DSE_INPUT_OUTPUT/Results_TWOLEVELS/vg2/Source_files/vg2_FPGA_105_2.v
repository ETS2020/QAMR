...
module FAU ( 
  ...
  assign new_n36_ = ~x11 & ~x14 & ~x20 & (new_n39_ | (~new_n37_ & ~x02));
  assign new_n37_ = new_n38_ & (x05 | x13 | ~x19);
  assign new_n38_ = (~x07 | ~x13 | ~x24) & (~x00 | x10 | x24);
  ...
  assign new_n57_ = ~x02 & (x13 | (~new_n58_ & ~new_n60_));
  ...
  assign new_n69_ = (~x24 | new_n70_ | (~x05 & ~x13)) & (x05 | (~x02 & (new_n74_ | x13)));
  ...
  assign z4 = (~new_n80_ & (new_n82_ | x08)) | new_n67_ | (~new_n65_ & (new_n83_ | ~x08));
  ...
  assign z5 = new_n39_ | new_n85_ | new_n81_ | (x07 & x13 & x24);
  assign new_n85_ = ~x05 & (x02 | (~x13 & x19));
  assign z6 = (~new_n80_ & (new_n87_ | x03)) | new_n67_ | (~new_n65_ & (new_n88_ | ~x03));
  assign new_n87_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n88_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n90_ & x05) | (~x02 & (~new_n91_ | (~x05 & ~x13 & x15)));
  assign new_n90_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n91_ = (~x13 | ~x18 | ~x24) & (x10 | ~x21 | x24);
endmodule
