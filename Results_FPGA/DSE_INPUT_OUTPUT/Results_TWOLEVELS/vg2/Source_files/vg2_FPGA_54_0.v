...
module FAU ( 
  ...
  assign z7 = (~x24 & (new_n66_ | (x05 & x13 & x15))) | new_n67_ | (~x05 & ~x13 & x15);
  assign new_n66_ = ~x02 & ~x10 & ~new_n39_ & x21;
  assign new_n67_ = x18 & x24 & (x15 | (x12 & (x05 | x13)));
  ...
  assign new_n72_ = x14 & x20 & x21 & ~x10 & x11;
  ...
  assign new_n76_ = (~x05 | ((~x12 | ~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x15 | ((~x18 | ~x24) & (x05 | x13))) & (~x18 | ~x24 | ~x12 | ~x13);
  ...
  assign z6 = (~new_n37_ & (new_n84_ | x03)) | new_n39_ | (~new_n78_ & (new_n85_ | ~x03));
