...
module FAU ( 
  ...
  assign new_n61_ = new_n62_ & new_n55_ & ~x06 & ~x08 & ~x09 & ~x11;
  ...
  assign z4 = ~new_n80_ | new_n86_;
  assign new_n80_ = (~x24 | new_n81_ | (~x05 & ~x13)) & new_n85_ & (new_n84_ | (x05 ? (~x13 | x24) : x13));
  assign new_n81_ = (new_n82_ | ~x18) & (~x04 | ~x07 | ~new_n57_ | x16);
  assign new_n82_ = ~new_n83_ & x08;
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n84_ = (new_n82_ | ~x15) & (~x04 | x16 | ~new_n57_ | ~x19);
  assign new_n85_ = (x21 | x23) & (x02 | x10 | ~x21 | new_n82_ | x24);
  assign new_n86_ = ~new_n38_ & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  assign z6 = ~new_n88_ | (~new_n92_ & (new_n94_ | (~new_n40_ & ~new_n93_)));
  assign new_n88_ = ~new_n89_ & (~x00 | x02 | x10 | ~x21 | x24);
  assign new_n89_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = new_n67_ | (~new_n40_ & ~new_n91_);
