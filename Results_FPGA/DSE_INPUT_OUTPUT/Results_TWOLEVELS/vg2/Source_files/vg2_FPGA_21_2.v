// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:12 2020
...
module FAU ( 
  ...
  assign new_n65_ = ~new_n67_ & (new_n38_ | new_n66_);
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n67_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~x02 & (new_n69_ | new_n73_ | (new_n79_ & ~x10))) | (x12 & (new_n69_ | new_n73_));
  ...
  assign new_n73_ = x24 & ~new_n74_ & ~new_n62_;
  assign new_n74_ = (~new_n77_ | ~new_n78_) & (~new_n75_ | ~new_n76_ | ~x18 | ~x20);
  assign new_n75_ = x01 & x03 & x06 & x08;
  assign new_n76_ = x11 & x14;
  assign new_n77_ = ~x01 & ~x03 & ~x06 & x07;
  assign new_n78_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n79_ = ~x24 & (new_n80_ | (new_n75_ & new_n76_ & x20 & x21));
  assign new_n80_ = new_n78_ & ~x03 & ~x06 & x00 & ~x01;
  assign z4 = (~new_n82_ & (new_n84_ | x08)) | new_n38_ | (~new_n83_ & (new_n85_ | ~x08));
  ...
  assign z5 = (~new_n88_ & x05) | ~new_n87_ | new_n38_ | (~x05 & ~x13 & x19);
  assign new_n87_ = ~new_n40_ & (~x07 | ~x13 | ~x24);
  assign new_n88_ = (~x13 | ~x19 | x24) & (~x07 | ~x24);
  assign z6 = (~new_n37_ & (x03 | (~new_n90_ & ~x11))) | (~new_n65_ & (~x03 | (~new_n91_ & x11)));
  assign new_n90_ = ~x06 & (x14 | ~x20);
  assign new_n91_ = x06 & (~x14 | x20);
  assign z7 = ~new_n93_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n93_ = ~new_n67_ & (x05 | x13 | ~x15) & ~new_n38_ & (~new_n94_ | ~x13);
