...
module FAU ( 
  ...
  assign new_n40_ = (~new_n43_ | ~new_n45_) & (~new_n41_ | ~new_n47_ | ~new_n48_ | ~new_n49_);
  assign new_n41_ = new_n42_ & x04 & x06;
  ...
  assign new_n49_ = x20 & ~x21 & x22 & x23;
  assign new_n50_ = ~new_n51_ & (~new_n53_ | ~new_n55_ | x01 | x03 | x04);
  assign new_n51_ = new_n49_ & new_n52_ & new_n47_ & new_n42_ & x04 & x06;
  assign new_n52_ = x17 & x18 & x14 & x16;
  assign new_n53_ = new_n54_ & ~x22 & ~x23 & ~x17 & ~x20;
  ...
  assign z7 = (~new_n62_ & (~x16 | ~x21)) | (~x02 & ~x10 & ~x16 & x21 & ~x24);
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (new_n75_ & new_n76_) | (~new_n64_ & (~x16 | ~x21));
  ...
  assign new_n68_ = (~new_n71_ | ~new_n72_) & (~new_n69_ | ~new_n70_);
  ...
  assign z4 = (~new_n78_ & ~x16) | (~x21 & (~new_n87_ | (new_n85_ & x24)));
  assign new_n78_ = ~new_n79_ & (~new_n82_ | ~x24) & (x02 | x10 | new_n83_ | x24);
  assign new_n79_ = ~new_n80_ & ((~x08 & x15) | (~new_n81_ & x19));
  assign new_n80_ = x05 ? (~x13 | x24) : x13;
  assign new_n81_ = ~x08 & ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = (x05 | x13) & ((~new_n81_ & x07) | (~x08 & x18));
  assign new_n83_ = (new_n84_ | ~x00) & (~x21 | (~x00 & x08));
  assign new_n84_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n85_ = (x05 | x13) & ((x07 & x08) | (x18 & (new_n86_ | ~x08)));
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n87_ = ~new_n88_ & (new_n80_ | ((~x08 | ~x19) & (~x15 | (~new_n86_ & x08))));
  ...
  assign new_n91_ = (x05 | x13 | ~x19) & (~x16 | ~x21);
