...
module FAU ( 
  ...
  assign new_n48_ = ~x05 & (x21 | (~x13 & (new_n49_ | new_n53_)));
  ...
  assign new_n64_ = x20 & (new_n67_ | new_n65_ | (new_n62_ & x15 & ~x21));
  assign new_n65_ = x05 & (new_n66_ | (x18 & x24));
  assign new_n66_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n67_ = x13 & ((x18 & ~x21 & x24) | (x05 & x15 & ~x24));
  assign z3 = ~new_n69_ | (~x24 & (x01 ? (new_n77_ & x03) : (new_n78_ & ~x03)));
  assign new_n69_ = (~x24 | new_n70_ | (~x05 & ~x13)) & (x05 | (~x21 & (new_n74_ | x13)));
  ...
  assign z4 = (~new_n37_ & (new_n81_ | x08)) | new_n39_ | (~new_n80_ & (new_n82_ | ~x08));
  ...
  assign z5 = ~new_n85_ | (~x24 & (new_n84_ | (x05 & x13 & x19)));
  assign new_n84_ = x00 & ~x02 & ~new_n39_ & ~x10;
  assign new_n85_ = (~x07 | ~x24 | (~x05 & (~x13 | x21))) & (x05 | x13 | ~x19 | x21);
  ...
  assign z7 = (~new_n91_ & x05) | ~new_n90_ | (~x05 & (x21 | (~x13 & x15)));
  assign new_n90_ = ~new_n66_ & (~x13 | ~x18 | ~x24);
