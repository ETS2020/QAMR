...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n82_, new_n83_, new_n84_, new_n87_, new_n88_, new_n89_;
  ...
  assign new_n56_ = ~x20 & ~x21 & ~x22 & ~x23;
  ...
  assign new_n61_ = new_n57_ & ~x08 & ~x09 & ~x11 & ~x12;
  assign new_n62_ = new_n56_ & ~x17 & x19 & ~x14 & ~x16;
  assign z2 = (x01 & new_n64_ & x06) | (~x03 & x21);
  assign new_n64_ = x11 & x14 & x20 & (new_n66_ | (~new_n65_ & x03));
  ...
  assign z4 = (~new_n79_ & (new_n82_ | x08)) | new_n84_ | (~new_n81_ & (new_n83_ | ~x08));
  assign new_n79_ = (new_n80_ | (~x03 & x21)) & (~new_n39_ | x10 | x21 | x24);
  assign new_n80_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n81_ = (new_n65_ | (~x03 & x21)) & (x02 | ~x03 | x10 | ~x21 | x24);
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n84_ = ~x10 & x21 & ~x24 & x00 & ~x02 & x03;
  assign z5 = ~new_n37_ & (x03 | ~x21);
  assign z6 = (~new_n37_ & (new_n89_ | x03)) | new_n87_ | (~x03 & (x21 | (~new_n65_ & ~x21)));
  assign new_n87_ = x11 & ~new_n88_ & (~x06 | (x14 & ~x20));
  assign new_n88_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n66_ & (x05 | x13 | ~x15);
  assign new_n89_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = (~x02 & x03 & ~x10 & x21 & ~x24) | (~new_n65_ & (x03 | (~x03 & ~x21)));
endmodule
