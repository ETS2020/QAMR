...
module FAU ( 
  ...
  assign new_n37_ = (new_n38_ | (~x00 & x21)) & (~x00 | x02 | x10 | x24);
  ...
  assign z3 = (x00 & (new_n75_ | new_n70_ | new_n78_)) | (~x21 & (new_n70_ | new_n82_));
  ...
  assign z4 = ~new_n84_ | (~new_n37_ & (new_n88_ | x08));
  assign new_n84_ = ~new_n87_ & (new_n85_ | (~new_n86_ & x08) | (~x00 & x21));
  assign new_n85_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n87_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign new_n88_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n90_ | (x05 & ((x07 & x24) | (x13 & x19 & ~x24)));
  assign new_n90_ = new_n91_ & (x00 | ~x21) & (x05 | x13 | ~x19);
  assign new_n91_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign z6 = new_n93_ | new_n87_ | (new_n94_ & (x00 | ~x21));
  assign new_n93_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n94_ = ~new_n85_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = new_n87_ | (~new_n85_ & (x00 | ~x21));
endmodule
