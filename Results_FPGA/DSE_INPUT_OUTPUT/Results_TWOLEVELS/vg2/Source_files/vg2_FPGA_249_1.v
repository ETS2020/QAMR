...
module FAU ( 
  ...
  assign new_n37_ = ~new_n39_ & (new_n38_ | (~x00 & x02));
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n39_ = x00 & ~x02 & ~x10 & ~x24;
  assign z1 = (~x02 & (new_n41_ | new_n50_ | new_n57_)) | (x00 & (new_n41_ | new_n50_));
  ...
  assign new_n77_ = (x00 | ~x02) & (x05 | new_n78_ | x13);
  ...
  assign z4 = (~new_n64_ & (~x08 | (~new_n82_ & x16))) | (~new_n37_ & (x08 | (~new_n83_ & ~x16)));
  assign new_n82_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n83_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z5 = (~new_n85_ & x05) | ~new_n86_ | new_n39_ | (~x05 & ~x13 & x19);
  assign new_n85_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n86_ = (x00 | ~x02) & (~x07 | ~x13 | ~x24);
  assign z6 = new_n88_ | new_n90_ | (~x00 & x02);
  assign new_n88_ = ~new_n89_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n89_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n39_ & (x05 | x13 | ~x19);
  ...
  assign new_n94_ = (x00 | ~x02) & (~x13 | ~x18 | ~x24);
endmodule
