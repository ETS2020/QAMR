...
module FAU ( 
  ...
  assign new_n37_ = (new_n38_ | (x00 & x02)) & (~x00 | x02 | x10 | x24);
  ...
  assign new_n64_ = ~new_n66_ & (new_n65_ | (x00 & x02));
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n66_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~new_n73_ & x00) | (~new_n75_ & ~new_n49_) | new_n68_ | new_n78_;
  assign new_n68_ = x24 & (new_n69_ | new_n71_) & (x05 | x13);
  ...
  assign new_n73_ = ~x02 & (~new_n74_ | x06 | x08 | x01 | x03);
  ...
  assign new_n79_ = ~x10 & x11 & x14 & x20 & x21 & ~x24;
  assign z4 = (~new_n37_ & (x08 | (~new_n81_ & ~x16))) | (~new_n64_ & (~x08 | (~new_n82_ & x16)));
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n38_ | (x00 & (x02 | (~x10 & ~x24)));
  assign z6 = new_n85_ | new_n87_ | (x00 & x02);
  assign new_n85_ = ~new_n86_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n86_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n66_ & (x05 | x13 | ~x15);
  assign new_n87_ = ~new_n88_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n88_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n89_ & (x05 | x13 | ~x19);
  assign new_n89_ = x00 & ~x10 & ~x24;
  assign z7 = (~new_n91_ & x05) | ~new_n92_ | new_n66_ | (~x05 & ~x13 & x15);
  assign new_n91_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n92_ = (~x00 | ~x02) & (~x13 | ~x18 | ~x24);
endmodule
