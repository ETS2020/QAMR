...
module FAU ( 
  ...
  assign z5 = (~x06 & ~x10 & ~x24 & x00 & ~x02) | (~new_n79_ & (x02 | ~x06));
  assign new_n79_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = ~new_n81_ | (~new_n37_ & (x03 | (~x11 & ~x14 & x20)));
  assign new_n81_ = (~new_n82_ | ~x24) & ~new_n84_ & (new_n87_ | x02);
  assign new_n82_ = (x05 | x13) & (new_n83_ | (x06 & x07 & ~x11));
  assign new_n83_ = x18 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n84_ = (new_n85_ | new_n86_) & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n85_ = x15 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n86_ = x06 & ~x11 & x19;
  assign new_n87_ = ~x06 & (x10 | ~x21 | x24 | (x03 & ~x11));
