...
module FAU ( 
  ...
  assign new_n37_ = (new_n38_ | ~x05) & ~new_n39_ & (x05 | x13 | ~x19);
  assign new_n38_ = (~x07 | x13 | ~x24) & (x02 | ~x13 | ~x19 | x24);
  assign new_n39_ = ~x02 & ((x07 & x13 & x24) | (x00 & ~x10 & ~x24));
  assign z1 = (~new_n41_ & ~new_n62_) | (new_n50_ & x24) | (new_n57_ & ~x02);
  ...
  assign new_n50_ = (x13 ? ~x02 : x05) & (new_n53_ | (new_n42_ & new_n51_));
  ...
  assign new_n62_ = (x05 | x13) & (x02 | ~x05 | ~x13 | x24);
  assign z2 = new_n64_ & x01;
  assign new_n64_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n66_ & x05) | new_n67_ | (~x05 & ~x13 & x15);
  assign new_n66_ = (x13 | ~x18 | ~x24) & (~x15 | x24 | x02 | ~x13);
  assign new_n67_ = ~x02 & ((x13 & x18 & x24) | (~x10 & x21 & ~x24));
  assign z3 = new_n69_ | new_n74_ | (x02 & x13) | (~x05 & ~new_n79_ & ~x13);
  ...
  assign z5 = new_n88_ | ~new_n86_ | (x13 & (x02 | (x07 & x24)));
  assign new_n86_ = ~new_n87_ & (x05 | x13 | ~x19);
  assign new_n87_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n88_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign z6 = (~new_n90_ & ~new_n94_) | new_n91_ | (x02 & x13);
  assign new_n90_ = ~new_n88_ & new_n86_ & (~x07 | ~x13 | ~x24);
