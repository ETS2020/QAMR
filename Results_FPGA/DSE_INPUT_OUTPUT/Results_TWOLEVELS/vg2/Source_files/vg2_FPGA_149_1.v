...
module FAU ( 
  ...
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
  ...
  assign new_n77_ = x14 & (new_n43_ | (x15 & x20 & x05 & x13));
  assign new_n78_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n47_ & ~x20;
  assign z4 = (~new_n37_ & (new_n81_ | x08)) | new_n66_ | (~new_n80_ & (new_n82_ | ~x08));
