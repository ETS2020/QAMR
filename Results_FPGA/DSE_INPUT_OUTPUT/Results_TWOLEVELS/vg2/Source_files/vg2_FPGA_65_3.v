...
module FAU ( 
  ...
  assign new_n48_ = x11 & x14 & x20 & ~new_n49_ & ~x23;
  ...
  assign new_n54_ = x11 & x14 & x18 & x20 & ~x23;
  ...
  assign new_n58_ = x11 & x14 & x15 & x20 & ~x23;
  ...
  assign z6 = (~new_n37_ & (x03 ? ~x23 : new_n67_)) | (~new_n44_ & (new_n68_ | ~x03));
  assign new_n67_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & ~x23 & (~x06 | (x14 & ~x20));
