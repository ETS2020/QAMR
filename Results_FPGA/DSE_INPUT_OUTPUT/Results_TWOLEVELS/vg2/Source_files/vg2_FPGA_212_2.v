...
module FAU ( 
  ...
  assign z1 = new_n56_ | (~new_n40_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n50_ & (x05 | x13));
  assign new_n40_ = ~new_n43_ & (~new_n41_ | ~new_n49_ | ~new_n48_ | ~x15 | ~x16);
  assign new_n41_ = new_n42_ & x01 & x03 & x04;
  assign new_n42_ = x09 & x11 & x06 & x08;
  assign new_n43_ = new_n45_ & new_n46_ & ~x09 & ~x11 & new_n44_ & new_n47_;
  ...
  assign new_n50_ = ~new_n51_ & (~new_n41_ | ~new_n55_ | ~new_n48_ | ~x16 | ~x17);
  assign new_n51_ = new_n53_ & new_n54_ & new_n45_ & new_n52_ & ~x08 & ~x09;
  assign new_n52_ = ~x06 & x07;
  assign new_n53_ = ~x14 & ~x16 & ~x11 & ~x12;
  assign new_n54_ = ~x22 & ~x23 & ~x17 & ~x20;
  assign new_n55_ = x22 & x23 & x18 & x20;
  assign new_n56_ = ~x02 & (x01 | (new_n44_ & new_n59_ & new_n57_ & new_n58_));
  assign new_n57_ = x00 & ~x03 & ~x04 & ~x06;
  assign new_n58_ = ~x10 & ~x11 & ~x08 & ~x09;
  ...
  assign new_n64_ = ~new_n65_ & (~new_n67_ | ~new_n52_ | x01 | x03);
  ...
  assign z5 = (~new_n80_ & (~x01 | x02)) | (x00 & ~x01 & ~x02 & ~x10 & ~x24);
