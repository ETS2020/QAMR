...
module FAU ( 
  ...
  assign new_n69_ = (~x24 | new_n70_ | (~x05 & ~x13)) & ~new_n40_ & (x05 | new_n74_ | x13);
  ...
  assign z4 = (~new_n38_ & (new_n80_ | x08)) | new_n40_ | (~new_n66_ & (new_n81_ | ~x08));
  assign new_n80_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = ~new_n40_ & (new_n83_ | new_n84_);
  assign new_n83_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n84_ = ~new_n66_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
