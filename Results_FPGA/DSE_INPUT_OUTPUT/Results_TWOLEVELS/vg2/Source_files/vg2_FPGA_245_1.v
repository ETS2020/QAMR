...
module FAU ( 
  ...
  assign new_n63_ = x20 & (new_n66_ | ~new_n64_ | (x13 & x18 & x24));
  ...
  assign new_n72_ = (x01 | (~new_n73_ & ~x02)) & (~new_n75_ | ~x01 | x02 | ~new_n43_ | ~x03);
  assign new_n73_ = new_n74_ & ~x06 & ~x08 & x00 & ~x03;
  assign new_n74_ = ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  ...
  assign z4 = (~new_n80_ & (x08 | (~new_n85_ & ~x16))) | (~new_n82_ & (~x08 | (~new_n86_ & x16)));
  assign new_n80_ = (new_n81_ | (~x01 & x02)) & (x10 | x24 | ~x00 | x02);
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n82_ = ~new_n65_ & (new_n83_ | new_n84_);
  ...
  assign z5 = new_n39_ | ~new_n88_ | new_n83_ | (x07 & x13 & x24);
  assign new_n88_ = ~new_n38_ & (x10 | x24 | ~x00 | x02);
  assign z6 = (~new_n80_ & (x03 | (~new_n90_ & ~x11))) | (~new_n82_ & (~x03 | (~new_n91_ & x11)));
  assign new_n90_ = ~x06 & (x14 | ~x20);
  assign new_n91_ = x06 & (~x14 | x20);
  assign z7 = new_n66_ | ~new_n64_ | new_n83_ | (x13 & x18 & x24);
endmodule
