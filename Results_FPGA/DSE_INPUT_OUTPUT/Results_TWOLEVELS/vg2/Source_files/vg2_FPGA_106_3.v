...
module FAU ( 
  ...
  assign z1 = new_n41_ | (new_n51_ & x24) | new_n39_ | (~x10 & ~new_n58_ & ~x24);
  ...
  assign new_n58_ = (~new_n42_ | ~new_n59_) & (~new_n56_ | ~new_n57_ | ~new_n60_ | ~new_n61_);
  ...
  assign z3 = new_n67_ | (new_n71_ & x24) | new_n39_ | (~x10 & ~new_n76_ & ~x24);
  assign new_n67_ = ~new_n68_ & ~new_n50_;
  ...
  assign new_n77_ = new_n60_ & ~x06 & ~x08 & ~x11 & ~x14 & ~x20;
  ...
  assign z6 = new_n85_ | (~new_n88_ & (new_n38_ | (~new_n39_ & ~new_n89_)));
  assign new_n85_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n87_ & (~x02 | ~x21)) | (~x02 & ~x10 & x21 & ~x24);
