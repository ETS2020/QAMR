...
module FAU ( 
  ...
  assign z3 = (~new_n69_ & ~new_n39_) | (new_n79_ & new_n80_ & new_n81_);
  ...
  assign z4 = (~new_n37_ & (new_n89_ | x08)) | new_n83_ | new_n39_ | (~new_n66_ & ~x08);
  assign new_n83_ = x16 & (new_n87_ | (~new_n84_ & ~x24));
  assign new_n84_ = (new_n85_ | (~new_n44_ & ~new_n45_)) & (x09 | (~new_n44_ & ~new_n86_));
  assign new_n85_ = x17 & (x04 | ~x23);
  assign new_n86_ = x05 & x13 & x15;
  assign new_n87_ = ~new_n88_ & (~x09 | (~new_n85_ & x22));
  assign new_n88_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n89_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = (~new_n39_ & ~new_n93_) | (~new_n91_ & ~x24);
  assign new_n91_ = ~new_n92_ & (~x05 | ~x13 | new_n39_ | ~x19);
  assign new_n92_ = x00 & ~x02 & ~x10 & (~x21 | (x21 & x22));
  assign new_n93_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign z6 = ~new_n95_ | (~new_n98_ & (new_n100_ | (~new_n39_ & ~new_n99_)));
  assign new_n95_ = (new_n97_ | (~new_n96_ & (~new_n81_ | x02 | x10))) & (~new_n81_ | ~x00 | x02 | x10);
  assign new_n96_ = ~new_n39_ & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  ...
  assign new_n102_ = x21 & (~x22 | (~x02 & ~x10 & ~x24));
endmodule
