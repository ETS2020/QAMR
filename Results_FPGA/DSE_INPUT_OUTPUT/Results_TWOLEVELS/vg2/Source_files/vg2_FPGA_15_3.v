...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (~x21 | ~x23)) | (~x02 & ~x10 & x21 & ~x23 & ~x24);
  ...
  assign z5 = (~new_n39_ & ~new_n86_) | (~new_n84_ & ~x24);
  assign new_n84_ = ~new_n85_ & (~x05 | ~x13 | new_n39_ | ~x19);
  assign new_n85_ = x00 & ~x02 & ~x10 & (~x21 | (x21 & ~x23));
  assign new_n86_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign z6 = (~new_n88_ & (new_n90_ | x03)) | new_n92_ | (z7 & (new_n91_ | ~x03));
  assign new_n88_ = ~new_n89_ & (x10 | x21 | x24 | ~x00 | x02);
  assign new_n89_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
