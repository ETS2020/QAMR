...
module FAU ( 
  ...
  assign z4 = new_n82_ | new_n84_ | (x22 & ~new_n86_ & ~new_n88_);
  assign new_n82_ = ~new_n83_ & (x08 | (x09 & ~x16));
  assign new_n83_ = (new_n39_ | (~x02 & ~x22)) & (~x00 | x02 | x10 | ~x22 | x24);
  assign new_n84_ = x02 & ((new_n85_ & ~x16) | (~new_n64_ & (~x08 | (~x09 & x16))));
  assign new_n85_ = ~x22 & ~new_n39_ & (x17 | (x04 & ~x23));
  ...
  assign z6 = new_n91_ | new_n94_ | (~x02 & ~x22);
