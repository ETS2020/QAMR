...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n53_ | (~new_n60_ & (new_n45_ | new_n49_));
  assign new_n40_ = ~x02 & (~x12 | (new_n41_ & new_n43_));
  assign new_n41_ = new_n42_ & x01 & x03 & x04 & x06;
  assign new_n42_ = ~x10 & x11 & x08 & x09;
  assign new_n43_ = new_n44_ & x14 & x16 & x17 & x20;
  assign new_n44_ = x21 & x22 & x23 & ~x24;
  assign new_n45_ = new_n46_ & new_n48_ & x17 & x20 & x22 & x23;
  ...
  assign new_n53_ = x24 & (x05 | x13) & (new_n56_ | (new_n46_ & new_n54_));
  ...
  assign new_n60_ = x05 ? (~x13 | x24) : x13;
  assign z2 = new_n62_ & x01;
  assign new_n62_ = x03 & x06 & x11 & x14 & ~new_n63_ & x20;
  assign new_n63_ = (new_n64_ | (~x02 & ~x12)) & (x02 | x10 | ~x12 | ~x21 | x24);
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n73_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n70_ | (x24 & ~new_n66_ & (x05 | x13));
  ...
  assign new_n70_ = ~x02 & (~x12 | (~x10 & ~x24 & (new_n71_ | new_n72_)));
  assign new_n71_ = new_n68_ & x00 & ~x01 & ~x03 & ~x06;
  assign new_n72_ = new_n69_ & x11 & x14 & x20 & x21;
  ...
  assign z4 = (~new_n63_ & (~x08 | (~new_n78_ & x16))) | (z5 & (x08 | (~new_n77_ & ~x16)));
  assign new_n77_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n78_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n63_ & (~x03 | (~new_n81_ & x11))) | (z5 & (x03 | (~new_n80_ & ~x11)));
