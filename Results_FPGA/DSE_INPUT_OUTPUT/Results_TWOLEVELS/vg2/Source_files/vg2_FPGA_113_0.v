...
module FAU ( 
  ...
  assign z4 = (~new_n80_ & (new_n83_ | x08)) | new_n85_ | (z7 & (new_n84_ | ~x08));
  assign new_n80_ = (new_n81_ | ~x05) & (x05 | x13 | ~x19 | ~x21) & (new_n82_ | ~x13);
  assign new_n81_ = (~x07 | ~x21 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n82_ = (~x07 | ~x24) & (x10 | x24 | ~x00 | x02);
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n85_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z5 = (~new_n87_ & x05) | ~new_n88_ | (~x13 & (~x21 | (~x05 & x19)));
  assign new_n87_ = (~x13 | ~x19 | x24) & (~x07 | ~x24);
  assign new_n88_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign z6 = (~new_n80_ & (new_n90_ | x03)) | new_n85_ | (z7 & (new_n91_ | ~x03));
