// Benchmark "FAU" written by ABC on Mon Aug 24 18:14:22 2020
...
module FAU ( 
  ...
  assign z1 = new_n41_ | new_n50_ | new_n57_;
  ...
  assign new_n50_ = x24 & (new_n53_ | (new_n42_ & new_n51_)) & (x05 | x13);
  ...
  assign z4 = (~new_n37_ & (new_n83_ | x08)) | new_n39_ | (~new_n81_ & (new_n84_ | ~x08));
  ...
  assign z5 = (x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | new_n86_ | (x07 & x13 & x24) | (~x05 & ~x13 & x19);
  assign new_n86_ = ~x10 & (x12 | (x00 & ~x02 & ~x24));
  assign z6 = (~new_n88_ & (x03 | (~new_n90_ & ~x11))) | (z7 & (~x03 | (~new_n91_ & x11)));
  assign new_n88_ = (new_n89_ | (~x10 & x12)) & (x10 | x12 | x24 | ~x00 | x02);
