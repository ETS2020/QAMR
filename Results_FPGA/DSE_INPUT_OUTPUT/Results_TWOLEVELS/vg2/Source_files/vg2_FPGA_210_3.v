...
module FAU ( 
  ...
  assign z2 = x01 & (x02 | (new_n62_ & x03));
  ...
  assign z4 = (~new_n37_ & (new_n82_ | x08)) | new_n81_ | (~new_n79_ & (new_n83_ | ~x08));
  ...
  assign z5 = new_n38_ | (~new_n81_ & ~new_n85_);
  assign new_n85_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = (z5 & (x03 | (~new_n89_ & ~x11))) | (z7 & (~x03 | (~new_n90_ & x11)));
  assign z7 = new_n80_ | (~new_n81_ & ~new_n88_);
