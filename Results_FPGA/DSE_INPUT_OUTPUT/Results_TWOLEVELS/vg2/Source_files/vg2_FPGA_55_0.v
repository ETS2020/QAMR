...
module FAU ( 
  ...
  assign z5 = (~new_n59_ & x05) | ~new_n60_ | (~x05 & (~x21 | (~x13 & x19)));
  assign new_n59_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n60_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign z6 = (~new_n52_ & (new_n62_ | x03)) | new_n57_ | (~new_n45_ & (new_n63_ | ~x03));
  assign new_n62_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n63_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n46_ | ~new_n65_ | (~x05 & (~x21 | (~x13 & x15)));
  assign new_n65_ = (~x13 | ~x18 | ~x24) & (x02 | x10 | ~x21 | x24);
endmodule
