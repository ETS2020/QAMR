...
module FAU ( 
  ...
  assign z2 = new_n66_ | (x01 & new_n63_ & x03);
  assign new_n63_ = x06 & x11 & x20 & (new_n65_ | (~new_n64_ & x14));
  ...
  assign new_n76_ = x06 & x08 & x11 & ~new_n77_ & x20;
  assign new_n77_ = ~new_n78_ & (x02 | x10 | ~x21);
  assign new_n78_ = x14 & x15 & x05 & x13;
  assign new_n79_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n47_ & ~x20;
  assign z4 = (~new_n37_ & (new_n82_ | x08)) | new_n66_ | (~new_n81_ & (new_n83_ | ~x08));
  ...
  assign z5 = (~new_n66_ & ~new_n87_) | (~new_n85_ & ~x24);
  assign new_n85_ = ~new_n86_ & (~x05 | ~x13 | new_n66_ | ~x19);
  assign new_n86_ = x00 & ~x02 & ~x10 & (~x21 | (x14 & x21));
  assign new_n87_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign z6 = (~new_n91_ & x14) | (~new_n89_ & ~x21);
  assign new_n89_ = (new_n37_ | (~x03 & (x11 | (~new_n90_ & ~x06)))) & (new_n64_ | (x03 & (x06 | ~x11)));
  assign new_n90_ = ~x14 & x20;
  assign new_n91_ = new_n92_ & (new_n81_ | (x03 & (~x11 | (x06 & x20))));
  assign new_n92_ = ~new_n94_ & (new_n93_ | (~x03 & (~x06 | x11)));
  assign new_n93_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n94_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z7 = (~new_n64_ & (x14 | ~x21)) | (x14 & x21 & ~x24 & ~x02 & ~x10);
endmodule
