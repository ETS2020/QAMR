...
module FAU ( 
  ...
  assign z2 = x03 & (new_n43_ | x12);
  assign new_n43_ = x01 & x06 & x11 & x14 & ~new_n44_ & x20;
  ...
  assign new_n52_ = ~new_n53_ & (~new_n55_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n53_ = new_n54_ & ~x06 & x07 & ~x01 & ~x03;
  assign new_n54_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n55_ = x18 & x20 & x11 & x14;
  assign new_n56_ = (new_n57_ | ~x03) & (~new_n60_ | ~new_n59_ | x01 | x03);
  assign new_n57_ = ~x12 & (~new_n58_ | ~x06 | ~x08 | ~x01 | x05);
  assign new_n58_ = x11 & ~x13 & x14 & x15 & x20;
  assign new_n59_ = ~x05 & ~x06 & ~x08;
  assign new_n60_ = ~x11 & ~x13 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n37_ & (new_n62_ | x08)) | new_n64_ | (~new_n44_ & (new_n63_ | ~x08));
  assign new_n62_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n63_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n64_ = x03 & x12;
  assign z5 = (~new_n67_ & x05) | ~new_n66_ | new_n64_ | (~x05 & ~x13 & x19);
  assign new_n66_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n67_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (x03 ? ~x12 : new_n69_)) | (~new_n44_ & (new_n70_ | ~x03));
  assign new_n69_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n70_ = x11 & ~x12 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n72_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n72_ = ~new_n45_ & (x05 | x13 | ~x15) & ~new_n64_ & (~new_n73_ | ~x13);
