...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n81_, new_n82_, new_n83_, new_n86_, new_n87_, new_n90_, new_n91_;
  ...
  assign z2 = (new_n68_ & x01) | (~new_n66_ & ~x02);
  ...
  assign z3 = (~x10 & (new_n76_ | new_n71_ | new_n79_)) | (x02 & (new_n71_ | new_n83_));
  ...
  assign z6 = (~new_n37_ & (x03 | (~new_n90_ & ~x11))) | (z7 & (~x03 | (~new_n91_ & x11)));
