...
module FAU ( 
  ...
  assign new_n45_ = ~new_n46_ & (~x21 | (new_n47_ & (x05 | x13 | ~x15)));
  assign new_n46_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  ...
  assign new_n54_ = x11 & x14 & ~new_n45_ & x20;
  ...
  assign z5 = (~new_n62_ & x05) | ~new_n61_ | (~x05 & (~x21 | (~x13 & x19)));
  assign new_n61_ = ~new_n57_ & (~x07 | ~x13 | ~x24);
  assign new_n62_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n64_ & (new_n67_ | x03)) | new_n69_ | (~new_n45_ & (new_n68_ | ~x03));
  assign new_n64_ = new_n65_ & (~x07 | ~x24 | (~x05 & (~x13 | ~x21)));
  assign new_n65_ = (~x19 | ~x21 | x05 | x13) & (~x05 | x24 | (~new_n66_ & (~x13 | ~x19)));
  assign new_n66_ = x00 & ~x02 & ~x10;
  assign new_n67_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n69_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z7 = new_n46_ | new_n71_ | new_n51_ | (x13 & x18 & x24);
  assign new_n71_ = ~x05 & (~x21 | (~x13 & x15));
endmodule
