...
module FAU ( 
  ...
  assign new_n65_ = (new_n68_ | ~x05) & (new_n66_ | ~x13) & (x05 | x13 | ~x15 | x21);
  ...
  assign new_n70_ = (~x24 | new_n71_ | (~x05 & ~x13)) & (x13 | (~x21 & (new_n75_ | x05)));
  ...
  assign z4 = (~new_n81_ & (new_n85_ | x08)) | new_n87_ | (~new_n65_ & (new_n86_ | ~x08));
  assign new_n81_ = ~new_n84_ & ~new_n82_ & (~x07 | ~x13 | ~x24);
  assign new_n82_ = ~x21 & (new_n83_ | (~x05 & ~x13 & x19));
  assign new_n83_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n84_ = x05 & ((x07 & ~x21 & x24) | (x13 & x19 & ~x24));
  assign new_n85_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n87_ = x00 & ~x02 & ~x10 & x13 & x21 & ~x24;
  assign z5 = (~new_n90_ & x05) | ~new_n89_ | (~x13 & (x21 | (~x05 & x19)));
  assign new_n89_ = ~new_n83_ & (~x07 | ~x13 | ~x24);
  assign new_n90_ = (~x13 | ~x19 | x24) & (~x07 | ~x24);
  assign z6 = new_n92_ | new_n94_ | (~x13 & x21);
  assign new_n92_ = ~new_n93_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n93_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & ~new_n83_ & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n94_ = ~new_n95_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n95_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign z7 = (~new_n98_ & x05) | ~new_n97_ | (~x13 & (x21 | (~x05 & x15)));
  assign new_n97_ = ~new_n67_ & (~x13 | ~x18 | ~x24);
