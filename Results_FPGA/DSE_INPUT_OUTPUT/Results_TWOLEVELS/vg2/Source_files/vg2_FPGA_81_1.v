...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n74_, new_n75_, new_n76_, new_n79_, new_n80_, new_n82_, new_n83_,
  ...
  assign z6 = new_n86_ | new_n88_ | (~x01 & x02);
  assign new_n86_ = ~new_n87_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n87_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n80_ & (x05 | x13 | ~x19);
  assign new_n88_ = ~new_n63_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
