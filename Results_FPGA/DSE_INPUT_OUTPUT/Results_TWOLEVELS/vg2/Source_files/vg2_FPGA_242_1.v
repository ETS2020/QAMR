...
module FAU ( 
  ...
  assign z2 = new_n66_ | (x01 & x03 & x06 & new_n63_ & x11);
  assign new_n63_ = x20 & (new_n64_ | new_n65_);
  assign new_n64_ = x14 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  ...
  assign new_n70_ = ~x11 & ~x14 & ~x20 & ~new_n47_ & ~x21;
  ...
  assign z4 = (~new_n37_ & (new_n80_ | x08)) | new_n66_ | (~new_n79_ & (new_n81_ | ~x08));
  ...
  assign z5 = (~new_n84_ & x05) | ~new_n83_ | new_n66_ | (~x05 & ~x13 & x19);
  assign new_n83_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n84_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = new_n86_ | (~new_n87_ & x11) | new_n66_ | (~new_n79_ & ~x03);
