...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n82_, new_n83_, new_n84_, new_n87_, new_n88_, new_n90_;
  assign z0 = ~x01 & (x02 | (~x03 & ~x06 & new_n36_ & ~x11));
  assign new_n36_ = ~x14 & ~x20 & (new_n37_ | new_n38_ | ~new_n39_);
  ...
  assign new_n68_ = new_n69_ & x11 & x14 & x18 & x20;
  assign new_n69_ = x01 & x03 & x06 & x08;
  assign new_n70_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n71_ = (x01 | (~new_n72_ & ~x02)) & (~new_n74_ | ~x01 | x02 | ~new_n43_ | ~x03);
  assign new_n72_ = new_n73_ & ~x06 & ~x08 & x00 & ~x03;
  assign new_n73_ = ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  assign new_n74_ = x20 & x21 & ~x24 & ~x10 & x11 & x14;
  ...
  assign z4 = (~new_n79_ & (new_n82_ | x08)) | new_n84_ | (~new_n64_ & (new_n83_ | ~x08));
  assign new_n79_ = ~new_n37_ & new_n80_ & ~new_n38_;
  assign new_n80_ = ~new_n81_ & (x05 | x13 | ~x19);
  ...
  assign z5 = new_n37_ | ~new_n80_ | new_n38_ | new_n84_;
  assign z6 = (~new_n79_ & (new_n87_ | x03)) | new_n84_ | (~new_n64_ & (new_n88_ | ~x03));
  assign new_n87_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n88_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n65_ | (~new_n84_ & ~new_n90_);
  assign new_n90_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
endmodule
