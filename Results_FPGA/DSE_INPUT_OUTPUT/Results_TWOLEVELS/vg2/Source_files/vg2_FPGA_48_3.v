// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:20 2020
...
module FAU ( 
  ...
  assign new_n76_ = (~x05 | ~x13 | ~x19) & (~x00 | x02 | x10);
  assign z4 = (~new_n37_ & (new_n78_ | x08)) | new_n39_ | (~new_n61_ & (new_n79_ | ~x08));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | new_n39_ | (~new_n61_ & (new_n83_ | ~x03));
  ...
  assign new_n85_ = x21 & (x12 | (~x02 & ~x10 & ~x24));
endmodule
