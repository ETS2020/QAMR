...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n50_ | new_n57_ | new_n60_;
  ...
  assign new_n71_ = x12 & (~new_n72_ | x01 | x02 | ~new_n46_ | x03);
  ...
  assign z4 = (~new_n63_ & (new_n81_ | ~x08)) | new_n60_ | (~new_n79_ & (new_n82_ | x08));
  ...
  assign z6 = new_n85_ | new_n89_ | (~new_n87_ & (new_n86_ | new_n88_));
  assign new_n85_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n86_ = ~new_n60_ & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  assign new_n87_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n88_ = ~x00 & ~x02 & ~x10 & x21 & ~x24;
  assign new_n89_ = x12 & x21 & ~x24 & x00 & ~x02 & ~x10;
  assign z7 = ~new_n91_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n91_ = ~new_n64_ & (x05 | x13 | ~x15) & ~new_n60_ & (~new_n92_ | ~x13);
