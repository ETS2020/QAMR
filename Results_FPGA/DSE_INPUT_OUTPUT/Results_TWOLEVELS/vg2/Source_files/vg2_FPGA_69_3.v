...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & ~new_n61_) | (~new_n44_ & ~new_n63_);
  assign new_n61_ = (x16 | new_n62_ | x22) & ((x06 & x22) | (~x08 & (~x09 | x16)));
  assign new_n62_ = ~x17 & (~x04 | x23);
  assign new_n63_ = ((x06 & x22) | (x08 & (x09 | ~x16))) & (x06 | ~x16 | new_n64_ | ~x22);
  assign new_n64_ = x17 & (x04 | ~x23);
  assign z5 = (~new_n67_ & x05) | ~new_n66_ | new_n55_ | (~x05 & ~x13 & x19);
  assign new_n66_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n67_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n69_ | x03)) | new_n55_ | (~new_n44_ & (new_n70_ | ~x03));
  ...
  assign new_n72_ = ~new_n55_ & ~new_n45_;
endmodule
