...
module FAU ( 
  ...
  assign new_n43_ = x16 & x17 & x20 & (new_n44_ | new_n45_) & x22;
  ...
  assign z6 = (~new_n93_ & (new_n97_ | x03)) | new_n99_ | (z7 & (new_n98_ | ~x03));
  assign new_n93_ = ~new_n94_ & (~x00 | x02 | x10 | x21 | x24);
  assign new_n94_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign z7 = (~new_n96_ & (~x21 | x23)) | (x21 & x23 & ~x24 & ~x02 & ~x10);
  assign new_n96_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
  assign new_n97_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n98_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n99_ = x21 & x23 & ~x24 & x00 & ~x02 & ~x10;
endmodule
