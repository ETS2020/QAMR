...
module FAU ( 
  ...
  assign z2 = (new_n69_ & x01) | (~new_n66_ & ~x02);
  assign new_n66_ = x00 & (~new_n67_ | ~x11 | ~x14 | ~new_n68_ | ~x20);
  assign new_n67_ = x01 & x03 & x06 & ~x10;
  ...
  assign z3 = (~new_n79_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n76_ | (x24 & ~new_n72_ & (x05 | x13));
  ...
  assign new_n76_ = ~x02 & (~x00 | (~x10 & ~new_n77_ & ~x24));
  assign new_n77_ = (~new_n75_ | x01 | x03 | x06) & (~new_n78_ | ~x01 | ~x03 | ~x06 | ~x08);
  ...
  assign z4 = ~new_n83_ | (~new_n37_ & (new_n86_ | x08));
  assign new_n83_ = (~new_n84_ | (~x00 & ~x02)) & (~x00 | x02 | ~new_n68_ | x10);
  assign new_n84_ = ~new_n70_ & (new_n85_ | ~x08);
  assign new_n85_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n86_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n38_ | (~x02 & (~x00 | (~x10 & ~x24)));
  assign z6 = new_n92_ | new_n89_ | (~x02 & (~x00 | (new_n68_ & x00 & ~x10)));
  ...
  assign new_n92_ = ~new_n70_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n70_ | (~x02 & (~x00 | (new_n68_ & x00 & ~x10)));
endmodule
