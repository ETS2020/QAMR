...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | (~x05 & ~x13) | (~new_n47_ & x24);
  ...
  assign z7 = (~new_n58_ & (x05 | x13)) | (x05 & x13 & x15 & ~x24);
  assign new_n58_ = (~x18 | ~x24) & (~x21 | x24 | x02 | x10);
  assign z3 = (~new_n60_ & (x05 | x13)) | (x05 & x13 & ~new_n63_ & ~x24);
  assign new_n60_ = x01 ? (~x03 | ~x06 | ~new_n61_ | ~x08) : (x03 | x06 | ~new_n62_ | x08);
  assign new_n61_ = x11 & x14 & ~new_n58_ & x20;
  assign new_n62_ = ~x11 & ~x14 & ~new_n38_ & ~x20;
  ...
  assign z6 = ~new_n70_ | (~new_n72_ & (x24 ? x07 : ~new_n46_));
  assign new_n70_ = (x05 | x13) & (new_n71_ | (x24 ? ~x18 : new_n43_));
