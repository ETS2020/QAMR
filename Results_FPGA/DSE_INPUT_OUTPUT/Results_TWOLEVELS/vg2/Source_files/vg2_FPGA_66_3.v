...
module FAU ( 
  ...
  assign z7 = x05 ? new_n47_ : (~new_n48_ | (~x13 & x15));
  assign new_n47_ = ~x21 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n48_ = (~x13 | ~x18 | ~x24) & (x02 | x10 | ~x21 | x24);
  assign z2 = new_n50_ & x01;
  assign new_n50_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z3 = ~new_n52_ | (~x24 & (x01 ? (new_n60_ & x03) : (new_n62_ & ~x03)));
  assign new_n52_ = (x05 | new_n57_ | x13) & (~x05 | ~x21) & (~x24 | new_n53_ | (~x05 & ~x13));
  assign new_n53_ = ~new_n54_ & (~new_n56_ | x06 | ~x07 | x01 | x03);
  assign new_n54_ = new_n55_ & x11 & x14 & x18 & x20;
  assign new_n55_ = x01 & x03 & x06 & x08;
  assign new_n56_ = ~x08 & ~x11 & ~x14 & ~x20;
  ...
  assign new_n63_ = (~x00 | x02 | x10) & (~x05 | ~x13 | ~x19);
  assign z4 = (~new_n65_ & (new_n69_ | x08)) | new_n71_ | (z7 & (new_n70_ | ~x08));
  assign new_n65_ = (new_n66_ | x05) & (x21 | (~new_n68_ & (new_n67_ | ~x05)));
  assign new_n66_ = (x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n67_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n68_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n70_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n71_ = x00 & ~x02 & ~x05 & ~x10 & x21 & ~x24;
  assign z5 = ~new_n40_ | (~new_n73_ & ~x24);
  assign new_n73_ = ~new_n39_ & (~x00 | x02 | x10 | (x21 & (x05 | ~x21)));
  assign z6 = new_n75_ | new_n77_ | (x05 & x21);
  assign new_n75_ = ~new_n76_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n76_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n68_ & (x05 | x13 | ~x19);
