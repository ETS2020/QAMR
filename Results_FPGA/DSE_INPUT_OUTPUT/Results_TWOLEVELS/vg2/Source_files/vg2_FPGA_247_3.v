...
module FAU ( 
  ...
  assign new_n76_ = x20 & x21 & ~x24 & x11 & x14 & ~x17;
  assign z4 = new_n84_ | (~new_n78_ & ~x17) | (~x21 & (new_n83_ | new_n87_));
  assign new_n78_ = ~new_n81_ & (x24 | (~new_n79_ & (x02 | ~new_n82_ | x10)));
  assign new_n79_ = x05 & x13 & ~new_n80_ & x19;
  assign new_n80_ = ~x08 & (x16 | (~x09 & (~x04 | x22 | x23)));
  assign new_n81_ = ~new_n80_ & ((~x05 & ~x13 & x19) | (x07 & x24 & (x05 | x13)));
  assign new_n82_ = x21 & ((x16 & (~x09 | x22)) | x00 | ~x08);
  assign new_n83_ = ~new_n37_ & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  assign new_n84_ = ~new_n85_ & ((new_n86_ & x16) | (~new_n39_ & (~x08 | (~x09 & x16))));
  assign new_n85_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n86_ = x22 & (~x17 | (~x04 & ~x21 & x23));
  assign new_n87_ = new_n88_ & x00 & ~x02 & x04 & ~x10;
  assign new_n88_ = ~x23 & ~x24 & ~x16 & ~x22;
  ...
  assign z6 = (~new_n93_ & (new_n96_ | x03)) | new_n98_ | (~new_n95_ & (new_n97_ | ~x03));
  assign new_n93_ = ~new_n94_ & (x10 | x21 | x24 | ~x00 | x02);
  assign new_n94_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n95_ = (new_n85_ | (x17 & x21)) & (x02 | x10 | x17 | ~x21 | x24);
  assign new_n96_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n97_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n98_ = ~x17 & x21 & ~x24 & x00 & ~x02 & ~x10;
