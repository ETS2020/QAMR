...
module FAU ( 
  ...
  assign new_n44_ = x05 & x13 & x15 & x16;
  ...
  assign z4 = (~new_n37_ & (new_n84_ | x08)) | new_n81_ | new_n39_ | (~new_n66_ & ~x08);
  assign new_n81_ = ~new_n82_ & (new_n67_ | (~new_n83_ & x16));
  ...
  assign z6 = (~new_n89_ & (new_n92_ | x03)) | new_n94_ | (z7 & (new_n93_ | ~x03));
  assign new_n89_ = ~new_n90_ & (~x00 | x02 | x10 | x21 | x24);
  assign new_n90_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign z7 = (~new_n83_ & (x16 | ~x21)) | (x16 & x21 & ~x24 & ~x02 & ~x10);
  assign new_n92_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n93_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n94_ = x16 & x21 & ~x24 & x00 & ~x02 & ~x10;
endmodule
