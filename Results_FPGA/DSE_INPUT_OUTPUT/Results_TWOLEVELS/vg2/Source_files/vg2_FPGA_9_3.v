// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:08 2020
...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (~x00 | ~x02)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z1 = (x00 & (new_n40_ | x02)) | new_n44_ | ~new_n53_;
  assign new_n40_ = new_n41_ & new_n43_ & ~x20 & ~x22 & ~x23 & ~x24;
  assign new_n41_ = new_n42_ & ~x04 & ~x06 & ~x01 & ~x03;
  assign new_n42_ = ~x10 & ~x11 & ~x08 & ~x09;
  assign new_n43_ = ~x16 & ~x17 & ~x12 & ~x14;
  assign new_n44_ = ~new_n52_ & (new_n49_ | (new_n45_ & new_n47_));
  ...
  assign new_n53_ = ~new_n60_ & (~x24 | new_n64_ | (~new_n56_ & (~new_n45_ | ~new_n54_)));
  assign new_n54_ = new_n55_ & x18 & x20 & x22 & x23;
  assign new_n55_ = x12 & x14 & x16 & x17;
  assign new_n56_ = new_n58_ & new_n59_ & new_n57_ & ~x01 & ~x03 & ~x04;
  assign new_n57_ = ~x08 & ~x09 & ~x06 & x07;
  assign new_n58_ = ~x14 & ~x16 & ~x11 & ~x12;
  assign new_n59_ = ~x22 & ~x23 & ~x17 & ~x20;
  assign new_n60_ = new_n61_ & new_n62_ & new_n55_ & new_n63_;
  assign new_n61_ = x01 & ~x02 & x03 & x04;
  assign new_n62_ = x06 & x08 & x09 & ~x10 & x11;
  assign new_n63_ = x22 & x23 & ~x24 & x20 & x21;
  assign new_n64_ = ~x05 & ~x13;
  assign z2 = new_n69_ | (new_n66_ & x01);
  ...
  assign new_n69_ = x00 & x02;
  assign z3 = (~new_n76_ & x00) | (~new_n78_ & ~new_n52_) | new_n71_ | new_n81_;
  assign new_n71_ = x24 & ~new_n64_ & (new_n72_ | new_n74_);
  ...
  assign new_n76_ = ~x02 & (~new_n77_ | x06 | x08 | x01 | x03);
  assign new_n77_ = ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  ...
  assign new_n81_ = new_n82_ & x01 & ~x02 & x03 & x06 & x08;
  assign new_n82_ = ~x10 & x11 & x14 & x20 & x21 & ~x24;
  assign z4 = (~new_n67_ & (new_n86_ | ~x08)) | new_n69_ | (~new_n84_ & (new_n87_ | x08));
  assign new_n84_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n85_ & (x05 | x13 | ~x19);
  assign new_n85_ = x00 & ~x10 & ~x24;
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n87_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = (~new_n67_ & (new_n89_ | ~x03)) | new_n69_ | (~new_n84_ & (new_n90_ | x03));
  assign new_n89_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n90_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n92_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n92_ = ~new_n68_ & (x05 | x13 | ~x15) & ~new_n69_ & (~new_n93_ | ~x13);
