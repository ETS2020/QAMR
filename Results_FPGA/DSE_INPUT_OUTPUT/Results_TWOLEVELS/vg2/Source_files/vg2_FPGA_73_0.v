...
module FAU ( 
  ...
  assign z4 = ~new_n79_ | new_n85_;
  assign new_n79_ = (~x24 | new_n80_ | (~x05 & ~x13)) & new_n84_ & (new_n83_ | (x05 ? (~x13 | x24) : x13));
  assign new_n80_ = (new_n81_ | ~x18) & (~x04 | ~x07 | ~new_n56_ | x16);
  assign new_n81_ = ~new_n82_ & x08;
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n83_ = (new_n81_ | ~x15) & (~x04 | x16 | ~new_n56_ | ~x19);
  assign new_n84_ = (x21 | x23) & (x02 | x10 | ~x21 | new_n81_ | x24);
  assign new_n85_ = ~new_n37_ & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  ...
  assign z6 = ~new_n90_ | (~new_n92_ & (new_n94_ | (~new_n39_ & ~new_n93_)));
  assign new_n90_ = ~new_n91_ & (~x00 | x02 | x10 | ~x21 | x24);
  assign new_n91_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n92_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n93_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n94_ = x00 & ~x02 & ~x10 & x23 & ~x24;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n96_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n96_ = (x21 | x23) & (x02 | x10 | ~x21 | x24);
endmodule
