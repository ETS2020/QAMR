...
module FAU ( 
  ...
  assign z3 = (~x02 & (new_n68_ | new_n72_ | (new_n78_ & ~x10))) | (~x21 & (new_n68_ | new_n72_));
  ...
  assign z4 = (~new_n37_ & (new_n81_ | x08)) | new_n39_ | (~new_n65_ & (new_n82_ | ~x08));
  ...
  assign z6 = new_n87_ | (~new_n91_ & (new_n38_ | (~new_n39_ & ~new_n92_)));
  assign new_n87_ = ~new_n88_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n88_ = ((~new_n89_ & new_n90_) | (x02 & x21)) & (~x21 | x24 | x02 | x10);
  assign new_n89_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n90_ = (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n91_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n92_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n89_ | ~new_n90_ | (x21 & (x02 | (~x10 & ~x24)));
endmodule
