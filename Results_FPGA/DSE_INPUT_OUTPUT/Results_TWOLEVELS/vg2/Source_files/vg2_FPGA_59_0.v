...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n89_;
  ...
  assign z4 = (~new_n72_ & (new_n74_ | x08)) | new_n76_ | (~new_n60_ & (new_n75_ | ~x08));
  assign new_n72_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n73_ & (x05 | x13 | ~x19);
  assign new_n73_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n74_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n75_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n76_ = ~x02 & ~x06;
  assign z5 = (~new_n37_ & (x02 | x06)) | (x00 & ~x02 & x06 & ~x10 & ~x24);
  assign z6 = ~new_n79_ | (~x24 & (new_n86_ | (~x02 & ~new_n87_ & ~x10)));
  assign new_n79_ = (~x24 | new_n80_ | (~x05 & ~x13)) & ~new_n85_ & (x05 | new_n83_ | x13);
  assign new_n80_ = (new_n81_ | ~x18) & (new_n82_ | ~x07);
  assign new_n81_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n82_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n83_ = ~new_n84_ & (~x15 | (x03 & (~x11 | ~x14 | x20)));
  assign new_n84_ = x19 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n85_ = ~x06 & (~x02 | (~x13 & x15 & ~x05 & x11));
  assign new_n86_ = x05 & x13 & (new_n84_ | (~new_n81_ & x15));
  assign new_n87_ = (~x00 | (~x03 & x11)) & (~x21 | (x03 & (~x11 | ~x14 | x20)));
  assign z7 = (~new_n89_ & (x02 | x06)) | (~x10 & x21 & ~x24 & ~x02 & x06);
