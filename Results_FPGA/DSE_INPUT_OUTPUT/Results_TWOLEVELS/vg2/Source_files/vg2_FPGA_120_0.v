// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:45 2020
...
module FAU ( 
  ...
  assign z2 = (new_n61_ & x01) | (~x02 & (new_n59_ | ~x01));
  assign new_n59_ = new_n60_ & x03 & x06 & ~x10 & x11;
  assign new_n60_ = x14 & x20 & x21 & ~x24;
  assign new_n61_ = x03 & x06 & x11 & x14 & ~new_n62_ & x20;
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = new_n64_ | (x24 & ~new_n67_ & (x05 | x13)) | (~new_n71_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n64_ = ~new_n65_ & ~x02;
  assign new_n65_ = x01 & (~new_n66_ | ~x08 | x10 | ~x03 | ~x06);
  assign new_n66_ = x20 & x21 & ~x24 & x11 & x14;
  ...
  assign z6 = (~new_n75_ & (new_n84_ | x03)) | new_n81_ | (~new_n77_ & (new_n85_ | ~x03));
