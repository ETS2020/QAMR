...
module FAU ( 
  ...
  assign z1 = new_n41_ | new_n57_ | new_n39_ | (new_n50_ & x24);
  ...
  assign new_n71_ = (~x14 | ~x21) & (~new_n72_ | ~new_n73_ | x14 | x20 | x24);
  assign new_n72_ = x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n73_ = ~x08 & ~x10 & ~x11;
  assign z4 = (~new_n75_ & (new_n78_ | x08)) | new_n80_ | (~new_n77_ & (new_n79_ | ~x08));
  assign new_n75_ = ~new_n76_ & (x10 | x21 | x24 | ~x00 | x02);
  assign new_n76_ = ~new_n39_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n77_ = (new_n62_ | (x14 & x21)) & (x02 | x10 | x14 | ~x21 | x24);
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n80_ = ~x14 & x21 & ~x24 & x00 & ~x02 & ~x10;
  assign z5 = (~new_n39_ & ~new_n84_) | (~new_n82_ & ~x24);
  assign new_n82_ = ~new_n83_ & (~x05 | ~x13 | new_n39_ | ~x19);
  assign new_n83_ = x00 & ~x02 & ~x10 & (~x21 | (~x14 & x21));
  assign new_n84_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (~x05 & ~x13));
  assign z6 = new_n86_ | new_n89_ | (~new_n87_ & (~x03 | (~x06 & x11)));
  ...
  assign new_n89_ = x14 & (x21 | (x11 & ~new_n62_ & ~x20));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n91_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n91_ = x21 & (x14 | (~x02 & ~x10 & ~x24));
endmodule
