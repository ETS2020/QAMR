...
module FAU ( 
  ...
  assign z1 = new_n52_ | (x21 & (new_n48_ | (~new_n40_ & ~x24)));
  ...
  assign z3 = ~new_n62_ | (~x24 & (x01 ? (new_n70_ & x03) : (new_n72_ & ~x03)));
  assign new_n62_ = (~x24 | new_n63_ | (~x05 & ~x13)) & ~new_n60_ & (x05 | new_n67_ | x13);
