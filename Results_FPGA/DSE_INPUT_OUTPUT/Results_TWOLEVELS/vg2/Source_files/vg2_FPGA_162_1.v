...
module FAU ( 
  ...
  assign new_n65_ = x11 & x14 & x20 & ~new_n66_ & ~new_n38_;
  ...
  assign z4 = (~new_n82_ & (new_n83_ | x08)) | new_n38_ | (~new_n66_ & (new_n84_ | ~x08));
  ...
  assign z6 = new_n89_ | new_n92_ | (x00 & ~x02 & new_n68_ & ~x10);
  assign new_n89_ = ~new_n91_ & (new_n90_ | (~x02 & ~x10 & new_n68_ & ~x12));
  assign new_n90_ = ~new_n38_ & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  assign new_n91_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n92_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign z7 = new_n69_ | ~new_n67_ | new_n38_ | (x13 & x18 & x24);
endmodule
