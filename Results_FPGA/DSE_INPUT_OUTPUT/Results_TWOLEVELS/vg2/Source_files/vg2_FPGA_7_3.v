...
module FAU ( 
  ...
  assign new_n81_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign new_n82_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = new_n85_ | ~new_n87_;
  assign new_n85_ = ~x24 & (new_n86_ | (x00 & ~x02 & ~new_n39_ & ~x10));
  assign new_n86_ = x05 & x13 & x19 & ~x21;
  assign new_n87_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (x13 ? x21 : ~x05));
  assign z6 = (~new_n37_ & (new_n89_ | x03)) | new_n39_ | (~new_n81_ & (new_n90_ | ~x03));
  assign new_n89_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n90_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n92_ & x05) | new_n67_ | (~x05 & ~x13 & x15) | (~new_n93_ & x13);
  assign new_n92_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n93_ = ~x21 & (~x18 | ~x24);
endmodule
