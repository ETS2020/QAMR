...
module FAU ( 
  ...
  assign z7 = (~new_n63_ & (x02 | ~x22)) | (~x02 & ~x10 & x21 & ~x22 & ~x24);
  ...
  assign z4 = new_n81_ | new_n82_ | (~x22 & ~new_n84_ & ~new_n86_);
  assign new_n81_ = z7 & (~x08 | (~x09 & x16));
  assign new_n82_ = x02 & ((new_n83_ & x16) | (~new_n39_ & (x08 | (x09 & ~x16))));
  assign new_n83_ = x22 & ~new_n63_ & (~x17 | (~x04 & x23));
  assign new_n84_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n85_ & (x05 | x13 | ~x19);
  assign new_n85_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n86_ = ~x08 & (x16 | (~x09 & ~x17 & (~x04 | x23)));
  assign z5 = ~new_n39_ | (~x02 & (x22 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n89_ & (x03 | (~new_n90_ & ~x11))) | (z7 & (~x03 | (~new_n91_ & x11)));
  assign new_n89_ = (new_n39_ | (~x02 & x22)) & (~x00 | x02 | x10 | x22 | x24);
