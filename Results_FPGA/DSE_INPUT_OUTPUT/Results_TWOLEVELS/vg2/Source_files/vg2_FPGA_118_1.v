...
module FAU ( 
  ...
  assign z1 = (~new_n42_ & ~x24) | (~new_n58_ & ~x05) | (x24 & ~new_n49_ & (x05 | x13));
  ...
  assign new_n58_ = ~x21 & (x13 | (~new_n59_ & ~new_n61_));
  ...
  assign z4 = (~new_n80_ & (new_n82_ | x08)) | new_n39_ | (~new_n66_ & (new_n83_ | ~x08));
  ...
  assign z5 = ~new_n40_ | (~x24 & (new_n85_ | (x05 & x13 & x19)));
  assign new_n85_ = x00 & ~x02 & ~x10 & (~x21 | (x05 & x21));
  assign z6 = (~new_n93_ & (new_n92_ | (~new_n91_ & ~x21))) | new_n87_ | new_n94_;
  assign new_n87_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n90_ & x13) | (~new_n89_ & x05) | (~x05 & ~x13 & x15 & ~x21);
  assign new_n89_ = ~new_n67_ & (~x18 | ~x24);
  assign new_n90_ = (~x18 | x21 | ~x24) & (~x05 | ~x15 | x24);
  assign new_n91_ = (x05 | x13 | ~x19) & ~new_n81_ & (~x07 | ~x13 | ~x24);
  assign new_n92_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n93_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n94_ = x00 & ~x02 & x05 & ~x10 & x21 & ~x24;
endmodule
