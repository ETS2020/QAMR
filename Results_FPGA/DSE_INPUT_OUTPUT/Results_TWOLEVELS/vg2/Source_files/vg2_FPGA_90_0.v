...
module FAU ( 
  ...
  assign z2 = x01 & x03 & x06 & new_n61_ & x11;
  assign new_n61_ = x14 & x20 & (new_n63_ | (~new_n62_ & (x00 | x02)));
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n63_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  ...
  assign new_n69_ = ~x02 & (~x00 | (~x10 & ~new_n70_ & ~x24));
  assign new_n70_ = (~new_n68_ | x01 | x03 | x06) & (~new_n71_ | ~x01 | ~x03 | ~x06 | ~x08);
  ...
  assign z4 = ~new_n76_ | (z5 & (new_n78_ | x08));
  assign new_n76_ = ~new_n63_ & ((~x00 & ~x02) | new_n62_ | (~new_n77_ & x08));
  assign new_n77_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = new_n80_ | new_n63_ | (new_n81_ & (x00 | x02));
  assign new_n80_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n81_ = ~new_n62_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n62_ | (~x02 & (~x00 | (x21 & ~x24 & x00 & ~x10)));
endmodule
