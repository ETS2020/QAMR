...
module FAU ( 
  ...
  assign z4 = (~new_n81_ & (x09 | ~x23)) | (new_n79_ & ~x16) | (new_n80_ & x16);
  assign new_n79_ = ~new_n38_ & (x09 | (~x22 & ~x23 & (x04 | x17)));
  assign new_n80_ = ~new_n64_ & (x09 ? (x22 & (~x17 | (~x04 & x23))) : ~x23);
  ...
  assign z6 = (x09 | ~x23) & (new_n86_ | new_n87_);
  ...
  assign new_n89_ = ~new_n65_ & (x09 | ~x23);
endmodule
