// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:26 2020
...
module FAU ( 
  ...
  assign z2 = new_n49_ & x01;
  assign new_n49_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z3 = ~new_n51_ | (~x24 & (x01 ? (new_n59_ & x03) : (new_n61_ & ~x03)));
  assign new_n51_ = (~x24 | new_n52_ | (~x05 & ~x13)) & (x05 | (~x21 & (new_n56_ | x13)));
  ...
  assign new_n56_ = (~new_n57_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n58_ | x01 | x03 | x06 | x08);
  ...
  assign new_n62_ = (~x05 | ~x13 | ~x19) & (~x00 | x02 | x10);
  assign z4 = (~new_n64_ & (new_n68_ | x08)) | new_n70_ | (z7 & (new_n69_ | ~x08));
  assign new_n64_ = (new_n67_ | ~x05) & (x21 | (new_n65_ & (x05 | x13 | ~x19)));
  assign new_n65_ = ~new_n66_ & (~x07 | ~x13 | ~x24);
  assign new_n66_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n67_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n68_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n69_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n70_ = x00 & ~x02 & x05 & ~x10 & x21 & ~x24;
  assign z5 = ~new_n39_ | (~x24 & (new_n72_ | (x05 & x13 & x19)));
  assign new_n72_ = x00 & ~x02 & ~x10 & (~x21 | (x05 & x21));
  assign z6 = new_n74_ | new_n76_ | (~x05 & x21);
  assign new_n74_ = ~new_n75_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n75_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n66_ & (x05 | x13 | ~x19);
