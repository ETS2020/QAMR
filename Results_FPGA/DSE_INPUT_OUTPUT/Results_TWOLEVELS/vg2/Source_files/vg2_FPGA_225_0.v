// Benchmark "FAU" written by ABC on Mon Aug 24 18:14:21 2020
...
module FAU ( 
  ...
  assign z3 = new_n63_ | (x24 & ~new_n66_ & (x05 | x13)) | (~new_n70_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n63_ = ~new_n64_ & ~x02;
  assign new_n64_ = x01 & (~new_n65_ | ~x08 | x10 | ~x03 | ~x06);
  ...
  assign z4 = (~new_n74_ & (new_n76_ | x08)) | new_n78_ | (~new_n60_ & (new_n77_ | ~x08));
  assign new_n74_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n75_ & (x05 | x13 | ~x19);
  assign new_n75_ = ~x10 & ~x24 & x00 & ~x02;
  ...
  assign z6 = (~new_n74_ & (new_n81_ | x03)) | new_n78_ | (~new_n60_ & (new_n82_ | ~x03));
  assign new_n81_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n82_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n84_ | (~x02 & (~x01 | (~x10 & x21 & ~x24)));
