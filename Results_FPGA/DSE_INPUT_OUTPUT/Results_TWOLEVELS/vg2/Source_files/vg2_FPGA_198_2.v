...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n74_, new_n75_, new_n76_, new_n77_, new_n78_, new_n81_, new_n83_,
  ...
  assign z2 = (new_n62_ & x01) | (x02 & ~x14);
  ...
  assign z3 = new_n66_ | (new_n70_ & x24) | new_n75_ | (x02 & ~x14);
  ...
  assign new_n70_ = ~new_n60_ & (new_n71_ | new_n73_);
  ...
  assign new_n75_ = ~x10 & (new_n76_ | new_n77_) & ~x24;
  assign new_n76_ = new_n74_ & ~x03 & ~x06 & x00 & ~x01;
  assign new_n77_ = new_n78_ & x03 & x06 & x01 & ~x02;
  assign new_n78_ = x08 & x11 & x14 & x20 & x21;
  assign z4 = (z5 & (x08 | (~new_n84_ & ~x16))) | (z7 & (~x08 | (~new_n85_ & x16)));
  assign z5 = (~new_n81_ & (~x02 | x14)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n64_ | (~new_n83_ & (~x02 | x14));
  ...
  assign z6 = (~x02 & (new_n87_ | ~new_n88_)) | (~new_n92_ & x14);
  assign new_n87_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n88_ = ~new_n91_ & (new_n89_ | (x03 & (x06 | ~x11)));
  assign new_n89_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n90_ & (x05 | x13 | ~x15);
  assign new_n90_ = ~x10 & x21 & ~x24;
  assign new_n91_ = ~x10 & x11 & x14 & ~x20 & x21 & ~x24;
  assign new_n92_ = (new_n81_ | (~x03 & (~x06 | x11))) & (new_n83_ | (x03 & (~x11 | (x06 & x20))));
endmodule
