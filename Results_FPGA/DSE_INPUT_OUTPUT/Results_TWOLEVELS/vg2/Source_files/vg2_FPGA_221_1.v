...
module FAU ( 
  ...
  assign new_n57_ = ~x13 & (x21 | (~x05 & (new_n58_ | new_n60_)));
  ...
  assign z7 = (~new_n68_ & x05) | (~new_n66_ & x13) | (x15 & ~x21 & ~x05 & ~x13);
  ...
  assign new_n70_ = ~x11 & ~x14 & ~x20 & (new_n71_ | ~new_n73_);
  assign new_n71_ = ~x24 & (new_n72_ | (x05 & x13 & x19));
  assign new_n72_ = x00 & ~x02 & ~new_n39_ & ~x10;
  assign new_n73_ = (~x07 | ~x24 | (~x13 & (~x05 | x21))) & (x05 | x13 | ~x19 | x21);
  ...
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | new_n39_ | (~new_n75_ & (new_n83_ | ~x03));
