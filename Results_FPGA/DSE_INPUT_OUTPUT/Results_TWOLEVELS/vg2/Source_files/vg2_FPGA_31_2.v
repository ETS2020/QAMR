...
module FAU ( 
  ...
  assign new_n56_ = x05 ? ~new_n58_ : new_n57_;
  assign new_n57_ = (x13 | ~x19) & ~new_n38_ & (~x07 | ~x13 | ~x24);
  ...
  assign z6 = new_n63_ | new_n64_ | (x05 & ~x21);
  assign new_n63_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
