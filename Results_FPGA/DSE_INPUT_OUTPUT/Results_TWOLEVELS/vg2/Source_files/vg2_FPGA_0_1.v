// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:05 2020
...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | (x24 & ~new_n47_ & (x05 | x13)) | (~new_n56_ & ~x13);
  ...
  assign new_n56_ = ~x21 & (x05 | (~new_n57_ & ~new_n59_));
  ...
  assign new_n67_ = (~x24 | new_n68_ | (~x05 & ~x13)) & (x13 | (~x21 & (new_n72_ | x05)));
  ...
  assign z4 = (~new_n78_ & (new_n84_ | x08)) | new_n86_ | (z7 & (new_n85_ | ~x08));
  assign new_n78_ = ~new_n80_ & ~new_n79_ & (~x07 | ~x13 | ~x24);
  assign new_n79_ = ~x21 & (new_n38_ | (~x05 & ~x13 & x19));
  assign new_n80_ = x05 & ((x13 & x19 & ~x24) | (x07 & ~x21 & x24));
  assign z7 = (~new_n83_ & x05) | (~new_n82_ & x13) | (x15 & ~x21 & ~x05 & ~x13);
  assign new_n82_ = ~new_n65_ & (~x18 | ~x24);
  assign new_n83_ = (~x13 | ~x15 | x24) & (~x18 | x21 | ~x24);
  assign new_n84_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n85_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n86_ = x13 & x21 & ~x24 & x00 & ~x02 & ~x10;
  assign z5 = ~new_n89_ | (~x24 & (new_n88_ | (x05 & x13 & x19)));
  assign new_n88_ = x00 & ~x02 & ~x10 & (~x21 | (x13 & x21));
  assign new_n89_ = (~x07 | ~x24 | (~x13 & (~x05 | x21))) & (x05 | x13 | ~x19 | x21);
  assign z6 = (~new_n78_ & (new_n91_ | x03)) | new_n86_ | (z7 & (new_n92_ | ~x03));
