...
module FAU ( 
  ...
  assign new_n50_ = (~new_n40_ | ~new_n51_) & (~new_n45_ | ~new_n53_ | ~new_n54_ | ~new_n55_);
  ...
  assign z3 = new_n65_ | (x24 & ~new_n68_ & (x05 | x13)) | (~new_n72_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n65_ = ~new_n66_ & ~x02;
  assign new_n66_ = x03 & (~new_n67_ | ~x08 | x10 | ~x01 | ~x06);
  ...
  assign z5 = ~new_n37_ | (~x02 & (~x03 | (x00 & x03 & ~x10 & ~x24)));
  assign z6 = (~new_n85_ & x03) | (x02 & (new_n93_ | (new_n90_ & x24)));
  assign new_n85_ = (~new_n86_ | ~x24) & ~new_n88_ & (x02 | x10 | new_n89_ | x24);
  assign new_n86_ = (x05 | x13) & (x07 | (x11 & ~new_n87_ & x18));
  assign new_n87_ = x06 & (~x14 | x20);
  assign new_n88_ = ~new_n49_ & (x19 | (x11 & ~new_n87_ & x15));
  assign new_n89_ = ~x00 & (~x11 | new_n87_ | ~x21);
  assign new_n90_ = (x05 | x13) & (new_n91_ | (~x03 & x18));
  assign new_n91_ = x07 & ~new_n92_ & ~x11;
  assign new_n92_ = ~x06 & (x14 | ~x20);
  assign new_n93_ = ~new_n49_ & ((~x11 & ~new_n92_ & x19) | (~x03 & x15));
  assign z7 = (~new_n63_ & (x03 | (x02 & ~x03))) | (~x02 & x03 & ~x10 & x21 & ~x24);
endmodule
