...
module FAU ( 
  ...
  assign new_n64_ = x10 & (new_n48_ | (~new_n58_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign z2 = (new_n66_ & x01) | (~x10 & ~x21);
  assign new_n66_ = x03 & x06 & x11 & x14 & ~new_n67_ & x20;
  assign new_n67_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n68_ & (x05 | x13 | ~x15);
  assign new_n68_ = ~x02 & ~x10 & ~x24;
  assign z3 = (~new_n70_ & ~x24) | ~new_n73_ | (x24 & ~new_n77_ & (x05 | x13));
  assign new_n70_ = x01 ? (~x03 | ~x06 | ~new_n71_ | ~x08) : (x03 | x06 | ~new_n72_ | x08);
  assign new_n71_ = x11 & x14 & ~new_n43_ & x20;
  assign new_n72_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign new_n73_ = (x10 | x21) & (x05 | new_n74_ | x13);
  ...
  assign new_n77_ = (~new_n79_ | ~new_n78_ | ~x01 | ~x03) & (~new_n80_ | ~new_n55_ | x01 | x03);
  assign new_n78_ = x06 & x08;
  assign new_n79_ = x11 & x14 & x18 & x20;
  assign new_n80_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign z4 = ~new_n82_ | (~new_n85_ & (new_n88_ | ~x08));
  assign new_n82_ = (~x00 | x02 | x10 | ~x21 | x24) & (~new_n83_ | (~x10 & ~x21));
  assign new_n83_ = ~new_n38_ & (new_n84_ | x08);
  assign new_n84_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n85_ = ((~x10 & ~x21) | (~new_n86_ & new_n87_)) & (~x21 | x24 | x02 | x10);
  assign new_n86_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n87_ = (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n88_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n67_ & (new_n90_ | ~x03)) | new_n91_ | (~new_n38_ & (new_n92_ | x03));
  assign new_n90_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n91_ = ~x10 & (~x21 | (x00 & ~x02 & x21 & ~x24));
