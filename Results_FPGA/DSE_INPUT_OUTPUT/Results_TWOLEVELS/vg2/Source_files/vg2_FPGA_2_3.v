...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n86_ | x08)) | new_n88_ | (~new_n83_ & (new_n87_ | ~x08));
  assign new_n83_ = ~new_n66_ & new_n84_ & ~new_n67_;
  assign new_n84_ = ~new_n85_ & (x05 | x13 | ~x15);
  ...
  assign z5 = new_n38_ | (~new_n88_ & ~new_n90_);
  assign new_n90_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign z6 = new_n92_ | (~new_n93_ & (new_n85_ | (~new_n88_ & ~new_n94_)));
  ...
  assign z7 = new_n66_ | ~new_n84_ | new_n67_ | new_n88_;
endmodule
