...
module FAU ( 
  ...
  assign new_n47_ = ~new_n48_ & (~new_n53_ | ~new_n56_ | ~new_n55_ | ~x16 | ~x17);
  assign new_n48_ = new_n49_ & new_n51_ & new_n52_ & ~x08 & ~x09;
  ...
  assign z2 = (~x03 & x12) | (x01 & new_n63_ & x03);
  ...
  assign z3 = (~new_n67_ & ~x24) | ~new_n70_ | (x24 & ~new_n74_ & (x05 | x13));
  ...
  assign new_n70_ = (new_n71_ | x03) & (~new_n73_ | ~new_n54_ | x05 | ~x01 | ~x03);
  assign new_n71_ = ~x12 & (~new_n72_ | x06 | x08 | x01 | x05);
  assign new_n72_ = ~x11 & ~x13 & ~x14 & x19 & ~x20;
  assign new_n73_ = x11 & ~x13 & x14 & x15 & x20;
  assign new_n74_ = (~new_n75_ | ~new_n54_ | ~x01 | ~x03) & (~new_n76_ | ~new_n52_ | x01 | x03);
  assign new_n75_ = x18 & x20 & x11 & x14;
  assign new_n76_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign z4 = (~new_n37_ & (new_n79_ | x08)) | new_n78_ | (~new_n64_ & (new_n80_ | ~x08));
  assign new_n78_ = ~x03 & x12;
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n83_ & x05) | ~new_n82_ | new_n78_ | (~x05 & ~x13 & x19);
  assign new_n82_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n83_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n85_ | x03)) | (~new_n64_ & (x03 ? new_n86_ : ~x12));
  assign new_n85_ = ~x11 & ~x12 & (x06 | (~x14 & x20));
  assign new_n86_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n88_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n88_ = ~new_n65_ & (x05 | x13 | ~x15) & ~new_n78_ & (~new_n89_ | ~x13);
