...
module FAU ( 
  ...
  assign z1 = new_n42_ | new_n58_ | new_n38_ | (x24 & ~new_n51_ & ~new_n63_);
  ...
  assign z3 = (~x02 & (new_n70_ | new_n74_ | (new_n80_ & ~x10))) | (~x12 & (new_n70_ | new_n74_));
  ...
  assign new_n74_ = x24 & ~new_n75_ & ~new_n63_;
  assign new_n75_ = (~new_n78_ | ~new_n79_) & (~new_n76_ | ~new_n77_ | ~x18 | ~x20);
  assign new_n76_ = x01 & x03 & x06 & x08;
  assign new_n77_ = x11 & x14;
  assign new_n78_ = ~x01 & ~x03 & ~x06 & x07;
  assign new_n79_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n80_ = ~x24 & (new_n81_ | (new_n76_ & new_n77_ & x20 & x21));
