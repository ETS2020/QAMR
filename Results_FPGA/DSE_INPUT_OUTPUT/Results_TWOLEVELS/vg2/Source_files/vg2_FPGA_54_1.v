...
module FAU ( 
  ...
  assign z7 = (~new_n67_ & ~x24) | (x12 & x15 & (new_n63_ | (x18 & x24))) | (~x15 & x18 & ~new_n63_ & x24);
  assign new_n67_ = ~new_n68_ & (~x05 | ~x12 | ~x13 | ~x15);
  assign new_n68_ = ~x02 & ~x10 & x21 & (x12 | ~x15);
  ...
  assign new_n77_ = (~x05 | ((x15 | ~x18 | ~x24) & (~x12 | ~x13 | ~x15 | x24))) & (~x12 | ~x15 | ((~x18 | ~x24) & (x05 | x13))) & (~x18 | ~x24 | ~x13 | x15);
  ...
  assign z6 = (~new_n37_ & (new_n85_ | x03)) | new_n39_ | (~new_n79_ & (new_n86_ | ~x03));
