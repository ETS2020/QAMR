...
module FAU ( 
  ...
  assign new_n51_ = ~x11 & ~x14 & ~x20 & ~new_n52_ & x22;
  ...
  assign new_n70_ = (~x00 | x11 | x14 | ~x20) & (~x11 | ~x14 | x20 | ~x21 | ~x22);
  assign new_n71_ = (x11 | x14 | ~x19 | ~x20) & (~x11 | ~x14 | ~x15 | x20 | ~x22);
  assign new_n72_ = (~x07 | x11 | x14 | ~x20) & (~x11 | ~x14 | ~x18 | x20 | ~x22);
