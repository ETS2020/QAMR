// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:43 2020
...
module FAU ( 
  ...
  assign z7 = new_n66_ | (~new_n67_ & ~x13) | (x13 & x18 & ~x21 & x24);
  assign new_n66_ = x05 & ((~x13 & x18 & x24) | (x13 & x15 & ~x21 & ~x24));
  assign new_n67_ = (x05 | ~x15) & (x02 | x10 | ~x21 | x24);
  assign z3 = ~new_n69_ | (~x24 & (x01 ? (new_n77_ & x03) : (new_n78_ & ~x03)));
  assign new_n69_ = (~x24 | new_n70_ | (~x05 & ~x13)) & (~x13 | ~x21) & (x05 | new_n74_ | x13);
  ...
  assign new_n80_ = (new_n82_ | ~x05) & ~new_n81_ & (new_n83_ | x21);
  assign new_n81_ = ~x05 & ~x13 & x19;
  assign new_n82_ = (~x07 | x13 | ~x24) & (~x13 | ~x19 | x21 | x24);
  assign new_n83_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign new_n84_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n85_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n86_ = x00 & ~x02 & ~x10 & ~x13 & x21 & ~x24;
  assign z5 = new_n89_ | ~new_n88_ | (x13 & (x21 | (x07 & x24)));
  assign new_n88_ = ~new_n81_ & (x10 | x24 | ~x00 | x02);
  assign new_n89_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign z6 = (~new_n80_ & (new_n91_ | x03)) | new_n86_ | (z7 & (new_n92_ | ~x03));
