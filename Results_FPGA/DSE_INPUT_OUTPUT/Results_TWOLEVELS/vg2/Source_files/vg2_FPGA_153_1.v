...
module FAU ( 
  ...
  assign z7 = (~new_n68_ & x13) | (~new_n66_ & x05) | (x15 & ~x21 & ~x05 & ~x13);
  assign new_n66_ = ~new_n67_ & (~x18 | ~x24);
  assign new_n67_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n68_ = (~x18 | x21 | ~x24) & (~x05 | ~x15 | x24);
  assign z3 = x01 ? (x03 & x06 & new_n64_ & x08) : (~x03 & ~x06 & new_n70_ & ~x08);
  assign new_n70_ = ~x11 & ~x14 & ~x20 & (~new_n73_ | (~new_n71_ & ~x24));
  assign new_n71_ = ~new_n72_ & (~x05 | ~x13 | ~x19);
  assign new_n72_ = x00 & ~x02 & ~new_n39_ & ~x10;
  assign new_n73_ = (~x07 | ~x24 | (~x05 & (~x13 | x21))) & (x05 | x13 | ~x19 | x21);
  assign z4 = (~new_n37_ & (new_n76_ | x08)) | new_n39_ | (~new_n75_ & (new_n77_ | ~x08));
  assign new_n75_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign new_n76_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n77_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n73_ | (~x24 & (new_n79_ | (x05 & x13 & x19)));
  assign new_n79_ = x00 & ~x02 & ~x10 & (~x21 | (x05 & x21));
  assign z6 = (~new_n84_ & (new_n83_ | (~new_n82_ & ~x21))) | new_n81_ | new_n85_;
  assign new_n81_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n82_ = (x05 | x13 | ~x19) & ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n83_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n84_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n85_ = x00 & ~x02 & x05 & ~x10 & x21 & ~x24;
endmodule
