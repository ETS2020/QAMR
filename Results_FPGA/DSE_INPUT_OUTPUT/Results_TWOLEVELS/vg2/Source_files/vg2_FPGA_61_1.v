...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x10 | ~x21)) | (x00 & ~x02 & ~x10 & ~x21 & ~x24);
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z1 = new_n56_ | (~new_n60_ & (new_n40_ | (new_n49_ & x24)));
  ...
  assign z2 = new_n60_ | (new_n62_ & x01);
  ...
  assign new_n69_ = ~x10 & (new_n70_ | x21);
  assign new_n70_ = new_n71_ & x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n71_ = ~x08 & ~x11 & ~x14 & ~x20 & ~x24;
  ...
  assign z4 = (~new_n60_ & ~new_n63_ & (new_n77_ | ~x08)) | (z5 & (new_n76_ | x08));
  assign new_n76_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n77_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n79_ & (new_n81_ | x03)) | new_n60_ | (~new_n63_ & (new_n82_ | ~x03));
