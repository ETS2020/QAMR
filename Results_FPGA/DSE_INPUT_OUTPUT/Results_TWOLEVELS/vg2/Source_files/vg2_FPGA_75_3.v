// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:30 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n74_, new_n75_, new_n76_, new_n79_, new_n80_, new_n81_, new_n83_,
    new_n84_, new_n85_, new_n87_, new_n88_;
  assign z0 = new_n36_ & ~x01;
  assign new_n36_ = ~x03 & ~x06 & ~x11 & ~x14 & ~new_n37_ & ~x20;
  assign new_n37_ = (new_n38_ | (x02 & x10)) & (~x00 | x02 | x10 | x24);
  ...
  assign new_n47_ = (new_n48_ | new_n52_) & (x05 | x13);
  ...
  assign new_n56_ = (~x02 | ~x10) & (x05 | x13 | (~new_n57_ & ~new_n59_));
  assign new_n57_ = new_n49_ & new_n58_ & x12 & x14 & x15 & x16;
  ...
  assign z2 = (x02 & x10) | (new_n63_ & x01);
  ...
  assign z3 = (~new_n67_ & (~x02 | ~x10)) | (~x02 & ~x10 & ~new_n75_ & ~x24);
  assign new_n67_ = (new_n72_ | (x05 ? (~x13 | x24) : x13)) & (~x24 | new_n68_ | (~x05 & ~x13));
  ...
  assign new_n75_ = ~new_n76_ & (~new_n70_ | x03 | x06 | ~x00 | x01);
  assign new_n76_ = new_n71_ & x20 & x21 & x11 & x14;
  assign z4 = (~new_n37_ & (x08 | (~new_n80_ & ~x16))) | (z7 & (~x08 | (~new_n81_ & x16)));
  assign z7 = new_n65_ | (~new_n79_ & (~x02 | ~x10));
  ...
  assign z5 = ~new_n83_ | (x05 & ((x07 & x24) | (x13 & x19 & ~x24)));
  assign new_n83_ = ~new_n84_ & (~x02 | ~x10) & ~new_n85_ & (x10 | x24 | ~x00 | x02);
  assign new_n84_ = x07 & x13 & x24;
  assign new_n85_ = ~x05 & ~x13 & x19;
  assign z6 = (~new_n37_ & (x03 | (~new_n87_ & ~x11))) | (z7 & (~x03 | (~new_n88_ & x11)));
