...
module FAU ( 
  ...
  assign z0 = new_n38_ | (new_n36_ & ~x01);
  ...
  assign z1 = ~new_n38_ & ((~new_n40_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n49_ & (x05 | x13)));
  ...
  assign z2 = new_n38_ | (new_n56_ & x01);
  assign new_n56_ = x03 & x06 & x11 & x14 & ~new_n57_ & x20;
  assign new_n57_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n63_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n38_ | (x24 & ~new_n59_ & (x05 | x13));
  assign new_n59_ = ~new_n60_ & (~new_n62_ | x01 | x03 | x06 | ~x07);
  assign new_n60_ = new_n61_ & x11 & x14 & x18 & x20;
  ...
  assign new_n64_ = x11 & x14 & x15 & x20;
  assign new_n65_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n37_ & (new_n67_ | x08)) | new_n38_ | (~new_n57_ & (new_n68_ | ~x08));
  ...
  assign z6 = (~new_n37_ & (new_n71_ | x03)) | new_n38_ | (~new_n57_ & (new_n72_ | ~x03));
  assign new_n71_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n72_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n38_ & ~new_n57_;
endmodule
