...
module FAU ( 
  ...
  assign new_n47_ = ~new_n48_ & (~x21 | (new_n49_ & (x05 | x13 | ~x15)));
  ...
  assign z4 = ~new_n66_ | (~new_n37_ & (new_n70_ | x08));
  assign new_n66_ = (x05 | x21) & ((new_n67_ & ~new_n48_) | (~new_n69_ & x08));
  ...
  assign z6 = (~new_n72_ & (new_n75_ | x03)) | new_n77_ | (~new_n47_ & (new_n76_ | ~x03));
  assign new_n72_ = ~new_n73_ & (~new_n74_ | ~x05) & (x05 | x13 | ~x19 | ~x21);
  assign new_n73_ = x07 & x24 & (x05 | (x13 & x21));
  assign new_n74_ = ~x24 & ((x13 & x19) | (x00 & ~x02 & ~x10));
  assign new_n75_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n76_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n77_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z7 = new_n48_ | new_n79_ | new_n68_ | (x13 & x18 & x24);
  assign new_n79_ = ~x05 & (~x21 | (~x13 & x15));
endmodule
