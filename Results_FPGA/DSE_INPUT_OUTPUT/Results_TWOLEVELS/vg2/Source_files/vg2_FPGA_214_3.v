...
module FAU ( 
  ...
  assign z7 = new_n67_ | (~new_n40_ & ~new_n66_);
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n67_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = ~new_n69_ | (x24 & ~new_n78_ & ~new_n39_);
  assign new_n69_ = (x02 | (~new_n70_ & (x10 | new_n74_ | x24))) & (~new_n70_ | x07);
  ...
  assign new_n74_ = ~new_n75_ & (~new_n77_ | x03 | x06 | ~x00 | x01);
  assign new_n75_ = new_n76_ & x20 & x21 & x11 & x14;
  assign new_n76_ = x01 & x03 & x06 & x08;
  assign new_n77_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n78_ = (~new_n80_ | x01 | x02 | x03 | x06) & (~x01 | ~x03 | ~new_n79_ | ~x06);
  assign new_n79_ = x08 & x11 & x14 & x18 & ~new_n40_ & x20;
  assign new_n80_ = x07 & ~x08 & ~x11 & ~x14 & ~x20;
  assign z4 = (~new_n82_ & (new_n85_ | x08)) | new_n40_ | (~new_n84_ & (new_n86_ | ~x08));
  assign new_n82_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n83_ & (x05 | x13 | ~x19);
  assign new_n83_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n84_ = (~x05 | ((~x13 | ~x15 | x24) & (~x18 | ~x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign new_n85_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n82_ & (new_n88_ | x03)) | new_n40_ | (~new_n84_ & (new_n89_ | ~x03));
