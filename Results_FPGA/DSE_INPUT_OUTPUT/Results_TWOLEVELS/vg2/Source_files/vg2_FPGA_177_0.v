...
module FAU ( 
  ...
  assign new_n49_ = (new_n50_ | ~x05) & ~new_n52_ & (~x15 | (~new_n51_ & (x05 | x13)));
  assign new_n50_ = (~x18 | ~x21 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n51_ = x18 & x24;
  assign new_n52_ = x21 & ((x13 & x18 & x24) | (~x02 & ~x10 & ~x24));
  ...
  assign z4 = (~new_n37_ & (new_n61_ | x08)) | new_n42_ | (~new_n59_ & (new_n62_ | ~x08));
  assign new_n59_ = (~x05 | ((~x13 | ~x15 | x24) & (~x18 | ~x24))) & (~x13 | ~x18 | ~x24) & ~new_n60_ & (x05 | x13 | ~x15);
  assign new_n60_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n37_ & (new_n64_ | x03)) | new_n42_ | (~new_n59_ & (new_n65_ | ~x03));
  assign new_n64_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n65_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x13 & x15 & ~x24) | (x18 & x24))) | ~new_n67_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n67_ = ~new_n42_ & ~new_n60_;
endmodule
