...
module FAU ( 
  ...
  assign new_n61_ = ~x11 & ~x12 & ~x08 & ~x09;
  assign new_n62_ = ~x17 & ~x18 & ~x14 & ~x16;
  assign new_n63_ = x19 & ~x20 & ~x22 & ~x23;
  assign z2 = x01 & x03 & x06 & x11 & new_n65_ & x14;
  assign new_n65_ = x20 & ((~new_n66_ & (x12 | ~x18)) | (x12 & x18 & ~new_n69_ & x24));
  assign new_n66_ = ~new_n68_ & (new_n67_ | ~x15);
  assign new_n67_ = x05 ? (~x13 | x24) : x13;
  assign new_n68_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n69_ = ~x05 & ~x13;
  assign z3 = ~new_n71_ | (~x24 & (x01 ? (new_n79_ & x03) : (new_n80_ & ~x03)));
  assign new_n71_ = (~x24 | new_n72_ | (~x05 & ~x13)) & ~new_n39_ & (x05 | new_n76_ | x13);
  ...
  assign new_n79_ = x06 & x08 & x11 & x14 & ~new_n44_ & x20;
  assign new_n80_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n48_ & ~x20;
  assign z4 = new_n82_ | (x24 & ~new_n87_ & ~new_n69_);
  assign new_n82_ = ~new_n39_ & (new_n83_ | (~x02 & new_n86_ & ~x10));
  assign new_n83_ = ~new_n67_ & ((x15 & (new_n84_ | ~x08)) | (x19 & (new_n85_ | x08)));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n85_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n86_ = ~x24 & ((x21 & (new_n84_ | ~x08)) | (x00 & (new_n85_ | x08)));
  assign new_n87_ = (~x12 | ~x18 | (~new_n84_ & ~x07 & x08)) & (~x07 | x18 | (~new_n85_ & ~x08));
  assign z5 = (~new_n89_ & (x12 | ~x18)) | (x07 & x24 & ~new_n69_ & (~x18 | (x12 & x18)));
  assign new_n89_ = ~new_n38_ & (new_n67_ | ~x19);
  assign z6 = new_n91_ | (x24 & ~new_n94_ & ~new_n69_);
  assign new_n91_ = ~new_n39_ & ((~new_n89_ & ~new_n92_) | (~new_n66_ & (new_n93_ | ~x03)));
  assign new_n92_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n93_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n94_ = (~x12 | ~x18 | (~new_n93_ & x03 & ~x07)) & (~x07 | new_n92_ | x18);
  assign z7 = (~new_n96_ & x05) | new_n97_ | new_n68_ | (~x05 & ~x13 & x15);
  assign new_n96_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n97_ = x18 & (~x12 | (x13 & x24));
endmodule
