...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n61_ | x08)) | new_n60_ | (~new_n44_ & (new_n62_ | ~x08));
  ...
  assign z6 = new_n67_ | (x11 & x12) | (~new_n44_ & (~x03 | (~new_n68_ & x11)));
  assign new_n67_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n68_ = x06 & (~x14 | x20);
  assign z7 = ~new_n70_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n70_ = ~new_n45_ & (x05 | x13 | ~x15) & ~new_n60_ & (~new_n71_ | ~x13);
