...
module FAU ( 
  ...
  assign z5 = ~new_n37_ & ~z2;
  assign z6 = ~new_n51_ | (~new_n37_ & (x03 | (~x11 & (x06 | x20))));
  assign new_n51_ = (~x14 | ~x20) & (new_n45_ | (x03 & (~x11 | (x06 & ~x14))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n53_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n53_ = ~z2 & ~new_n46_;
endmodule
