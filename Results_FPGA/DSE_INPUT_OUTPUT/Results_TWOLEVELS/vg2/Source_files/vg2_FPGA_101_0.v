...
module FAU ( 
  ...
  assign new_n41_ = ~x02 & (~x22 | (new_n42_ & new_n44_));
  assign new_n42_ = new_n43_ & x01 & x03 & x04 & x06;
  assign new_n43_ = ~x10 & x11 & x08 & x09;
  assign new_n44_ = new_n45_ & x23 & ~x24 & x20 & x21;
  ...
  assign new_n55_ = (~new_n47_ | ~new_n56_) & (~new_n51_ | ~new_n57_ | ~new_n58_ | ~new_n59_);
  assign new_n56_ = new_n45_ & x18 & x20 & x22 & x23;
  ...
  assign z4 = new_n82_ | (~new_n91_ & ~x22) | new_n85_ | (~new_n92_ & ~x08);
  assign new_n82_ = ~new_n83_ & (x08 | (x09 & ~x16));
  assign new_n83_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n84_ & (x05 | x13 | ~x19);
  assign new_n84_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n85_ = x16 & (new_n89_ | (~x24 & (new_n86_ | (~new_n68_ & ~x09))));
  assign new_n86_ = ~new_n88_ & (new_n87_ | (~x02 & ~x10 & x21));
  assign new_n87_ = x05 & x13 & x15 & x22;
  assign new_n88_ = x17 & (x04 | ~x23);
  assign new_n89_ = ~new_n90_ & ((~x05 & ~x13 & x15) | (x18 & x24 & (x05 | x13)));
  assign new_n90_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n91_ = x02 & (x16 | new_n39_ | (~x17 & (~x04 | x23)));
  ...
  assign z6 = (~new_n96_ & (x03 | (~new_n98_ & ~x11))) | (z7 & (~x03 | (~new_n99_ & x11)));
  assign new_n96_ = (new_n39_ | (~x02 & ~x22)) & (~x00 | x02 | x10 | ~x22 | x24);
  assign z7 = (~new_n64_ & (x02 | x22)) | (x21 & x22 & ~x24 & ~x02 & ~x10);
