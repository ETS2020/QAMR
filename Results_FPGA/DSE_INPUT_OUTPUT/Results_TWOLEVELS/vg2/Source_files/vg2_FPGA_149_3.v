...
module FAU ( 
  ...
  assign z2 = x20 & (new_n60_ | x21);
  assign new_n60_ = x01 & x03 & x06 & x11 & ~new_n61_ & x14;
  ...
  assign new_n64_ = new_n65_ & x18 & x20 & x11 & x14;
  ...
  assign new_n70_ = (~x20 | ~x21) & (~new_n71_ | ~new_n72_ | x14 | x20 | x24);
  assign new_n71_ = x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n72_ = ~x08 & ~x10 & ~x11;
  assign z4 = (~new_n37_ & (new_n76_ | x08)) | new_n39_ | (~new_n74_ & (new_n77_ | ~x08));
  ...
  assign z5 = (~new_n80_ & x05) | ~new_n79_ | new_n39_ | (~x05 & ~x13 & x19);
  assign new_n79_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n80_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = new_n82_ | (~new_n83_ & x11) | new_n39_ | (~new_n74_ & ~x03);
  assign new_n82_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n83_ = (new_n84_ | x24) & (new_n86_ | (x06 & (~x14 | x20)));
  assign new_n84_ = ~new_n85_ & (x02 | x10 | ~x21 | (x06 & ~x14));
  assign new_n85_ = x05 & x13 & x15 & (~x06 | (x14 & ~x20));
  assign new_n86_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | new_n88_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n88_ = x21 & (x20 | (~x02 & ~x10 & ~x24));
endmodule
