...
module FAU ( 
  ...
  assign new_n54_ = ~new_n50_ & new_n55_ & (~x13 | ~x18 | ~x24);
  assign new_n55_ = ~new_n56_ & (x05 | x13 | ~x15);
  assign new_n56_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = x01 ? (x03 & x06 & new_n59_ & x08) : (~x03 & ~x06 & new_n58_ & ~x08);
  assign new_n58_ = ~x11 & ~x14 & ~new_n43_ & ~x20;
  assign new_n59_ = x11 & x14 & ~new_n49_ & x20;
  assign z4 = (~new_n37_ & (new_n61_ | x08)) | new_n39_ | (~new_n54_ & (new_n62_ | ~x08));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n64_ | (x07 & x24 & (x05 | x13));
  assign new_n64_ = (new_n65_ | ~x05) & ~new_n38_ & (x05 | x13 | ~x19);
  assign new_n65_ = x21 & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n67_ | x03)) | new_n39_ | (~new_n54_ & (new_n68_ | ~x03));
  assign new_n67_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n70_ | ~new_n55_ | (x05 & (~x21 | (x18 & x24)));
