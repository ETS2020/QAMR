...
module FAU ( 
  ...
  assign z3 = new_n64_ | (~new_n71_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n67_ & (x05 | x13));
  assign new_n64_ = ~new_n65_ & ~x02;
  assign new_n65_ = x01 & (~new_n66_ | ~x03 | ~x06 | ~x08 | x10);
  ...
  assign new_n71_ = (~new_n72_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n73_ | x06 | x08 | x01 | x03);
  assign new_n72_ = x11 & x14 & x15 & x20;
  assign new_n73_ = x19 & ~x20 & ~x11 & ~x14;
  assign z4 = (~new_n75_ & (new_n77_ | x08)) | new_n79_ | (~new_n61_ & (new_n78_ | ~x08));
  assign new_n75_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n76_ & (x05 | x13 | ~x19);
  assign new_n76_ = x00 & ~x02 & ~x10 & ~x24;
  ...
  assign z7 = (~new_n83_ & (x01 | x02)) | (x01 & ~x02 & ~x10 & x21 & ~x24);
