...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n51_, new_n52_, new_n54_, new_n56_, new_n59_, new_n60_, new_n61_,
  ...
  assign new_n46_ = ~x23 & ~new_n42_ & (new_n38_ | new_n39_ | new_n40_ | new_n41_);
  assign new_n47_ = x08 & x09 & x11 & x12 & new_n48_ & x14;
  assign new_n48_ = x16 & x17 & x20 & x22 & ~new_n49_ & x23;
  assign new_n49_ = (new_n50_ | ~x05) & ~new_n51_ & (~x15 | (~new_n52_ & (x05 | x13)));
  assign new_n50_ = (~x18 | x21 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n51_ = x18 & x24 & (x15 | (x13 & ~x21));
  ...
  assign z4 = (~new_n37_ & (new_n60_ | x08)) | new_n42_ | (~new_n59_ & (new_n61_ | ~x08));
  assign new_n59_ = (~x05 | ((~x13 | ~x15 | x24) & (~x18 | ~x24))) & (~x13 | ~x18 | ~x24) & ~new_n52_ & (x05 | x13 | ~x15);
  assign new_n60_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n61_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n37_ & (new_n63_ | x03)) | new_n42_ | (~new_n59_ & (new_n64_ | ~x03));
  assign new_n63_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n64_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x05 & ((x13 & x15 & ~x24) | (x18 & x24))) | new_n66_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n66_ = x21 & (~x15 | (~x02 & ~x10 & ~x24));
endmodule
