...
module FAU ( 
  ...
  assign z1 = new_n40_ | (x24 & ~new_n50_ & ~new_n62_) | (~new_n57_ & ~x10);
  ...
  assign new_n50_ = ~new_n53_ & (~new_n41_ | ~new_n51_);
  ...
  assign new_n57_ = ~x02 & (x24 | ((~new_n41_ | ~new_n59_) & (~new_n58_ | ~new_n60_)));
  ...
  assign z2 = (x02 & ~x10) | (new_n64_ & x01);
  ...
  assign z3 = (~x02 & (new_n68_ | (new_n73_ & x24) | (~x10 & ~new_n76_ & ~x24))) | (x10 & (new_n68_ | (new_n73_ & x24)));
  assign new_n68_ = ~new_n49_ & (new_n69_ | (new_n71_ & new_n72_ & x15 & x20));
  assign new_n69_ = new_n70_ & ~x06 & ~x08 & ~x01 & ~x03;
  assign new_n70_ = x19 & ~x20 & ~x11 & ~x14;
  assign new_n71_ = x01 & x03 & x06 & x08;
  assign new_n72_ = x11 & x14;
  assign new_n73_ = ~new_n62_ & (new_n74_ | (new_n71_ & new_n72_ & x18 & x20));
  ...
  assign z7 = (~new_n80_ & (~x02 | x10)) | (x21 & ~x24 & ~x02 & ~x10);
  ...
  assign new_n84_ = ~x10 & (x02 | (x00 & ~x24));
  assign z6 = (~new_n37_ & (x03 | (~new_n86_ & ~x11))) | (z7 & (~x03 | (~new_n87_ & x11)));
