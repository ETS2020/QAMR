...
module FAU ( 
  ...
  assign z7 = (~new_n65_ & (x16 | ~x21)) | (x16 & x21 & ~x24 & ~x02 & ~x10);
  ...
  assign z4 = (~new_n86_ & ~x21) | (x16 & (~new_n80_ | (new_n91_ & x24)));
  assign new_n80_ = ~new_n81_ & (x02 | x10 | ~new_n85_ | ~x21);
  assign new_n81_ = ~new_n84_ & ((~new_n82_ & x15) | (x08 & x19));
  assign new_n82_ = ~new_n83_ & x08 & x09;
  assign new_n83_ = x22 & (~x17 | (~x04 & x23));
  assign new_n84_ = x05 ? (~x13 | x24) : x13;
  assign new_n85_ = ~x24 & (new_n83_ | x00 | ~x08 | ~x09);
  assign new_n86_ = (new_n87_ | (x05 ? (~x13 | x24) : x13)) & ~new_n90_ & (~x24 | new_n89_ | (~x05 & ~x13));
  assign new_n87_ = (x08 | ~x15) & (~x19 | (~new_n88_ & ~x08));
  assign new_n88_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n89_ = (x08 | ~x18) & (~x07 | (~new_n88_ & ~x08));
  assign new_n90_ = x00 & ~x02 & ~x10 & ~x24 & (new_n88_ | x08);
  assign new_n91_ = (x05 | x13) & ((~new_n82_ & x18) | (x07 & x08));
  assign z5 = new_n93_ | ~new_n94_ | new_n38_ | (x07 & x13 & x24);
  assign new_n93_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n94_ = (x05 | x13 | ~x19) & (x16 | ~x21);
  assign z6 = new_n96_ | new_n97_ | (~x16 & x21);
  assign new_n96_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n97_ = ~new_n98_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n98_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n99_ & (x05 | x13 | ~x15);
