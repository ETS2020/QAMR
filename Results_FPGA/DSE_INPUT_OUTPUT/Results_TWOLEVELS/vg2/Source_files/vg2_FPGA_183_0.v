...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n74_, new_n78_, new_n79_, new_n81_, new_n82_, new_n83_, new_n84_,
    new_n85_, new_n86_;
  ...
  assign z1 = (~x02 & (new_n39_ | ~x01)) | new_n44_ | (new_n52_ & x24);
  ...
  assign new_n48_ = new_n50_ & new_n51_ & new_n49_ & ~x01 & ~x03 & ~x04;
  ...
  assign z3 = new_n65_ | (~new_n72_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n68_ & (x05 | x13));
  assign new_n65_ = ~new_n66_ & ~x02;
  assign new_n66_ = x01 & (~new_n67_ | ~x03 | ~x06 | ~x08 | x10);
  assign new_n67_ = x20 & x21 & ~x24 & x11 & x14;
  ...
  assign new_n72_ = (~new_n73_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n74_ | x06 | x08 | x01 | x03);
  assign new_n73_ = x11 & x14 & x15 & x20;
  assign new_n74_ = x19 & ~x20 & ~x11 & ~x14;
  assign z4 = (z5 & (x08 | (~new_n78_ & ~x16))) | (z7 & (~x08 | (~new_n79_ & x16)));
  assign z5 = (~new_n37_ & (x01 | x02)) | (x00 & x01 & ~x02 & ~x10 & ~x24);
  assign z7 = (~new_n63_ & (x01 | x02)) | (x01 & ~x02 & ~x10 & x21 & ~x24);
  assign new_n78_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n79_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n81_ | new_n84_ | (~x01 & ~x02);
  assign new_n81_ = ~new_n82_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n82_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n83_ & (x05 | x13 | ~x19);
  ...
  assign new_n86_ = x21 & ~x24 & ~x02 & ~x10;
endmodule
