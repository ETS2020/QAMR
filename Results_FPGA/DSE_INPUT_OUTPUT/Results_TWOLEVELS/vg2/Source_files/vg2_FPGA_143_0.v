...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n68_ | x08)) | new_n70_ | (~new_n58_ & (new_n69_ | ~x08));
  assign new_n68_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n69_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n70_ = ~x20 & ~x21;
  assign z5 = ~new_n37_ & ~new_n70_;
  assign z6 = ~new_n73_ | (~new_n58_ & (~x03 | (~x06 & x11)));
  assign new_n73_ = (new_n74_ | (x05 ? (~x13 | x24) : x13)) & new_n77_ & (~x24 | new_n76_ | (~x05 & ~x13));
  assign new_n74_ = (new_n75_ | ~x19) & (~x11 | ~x14 | ~x15 | x20);
  assign new_n75_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n76_ = (new_n75_ | ~x07) & (~x18 | x20 | ~x11 | ~x14);
  assign new_n77_ = ~new_n70_ & (x02 | x10 | new_n78_ | x24);
  assign new_n78_ = (~x11 | ~x14 | x20) & (~x00 | (~x03 & (x11 | (~x06 & x14))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n80_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
