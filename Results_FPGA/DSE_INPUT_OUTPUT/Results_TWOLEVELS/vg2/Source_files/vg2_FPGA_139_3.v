...
module FAU ( 
  ...
  assign z1 = ((~x02 | ~x10) & (new_n41_ | (new_n50_ & x24))) | (~x02 & ~x10 & ~new_n57_ & ~x24);
  ...
  assign new_n50_ = (new_n53_ | (new_n42_ & new_n51_)) & (x05 | x13);
  assign new_n51_ = new_n52_ & x22 & x23 & x18 & x20;
  ...
  assign new_n57_ = (~new_n42_ | ~new_n58_) & (~new_n59_ | ~new_n55_ | ~new_n56_);
  assign new_n58_ = new_n52_ & x22 & x23 & x20 & x21;
  ...
  assign z3 = (~new_n66_ & ~x24) | ~new_n75_ | (x24 & ~new_n71_ & (x05 | x13));
  ...
  assign new_n75_ = ~new_n39_ & (x05 | new_n76_ | x13);
  ...
  assign z4 = (~new_n37_ & (new_n80_ | x08)) | new_n39_ | (~new_n63_ & (new_n81_ | ~x08));
  assign new_n80_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n84_ & x05) | ~new_n83_ | new_n38_ | (~x05 & ~x13 & x19);
  assign new_n83_ = ~new_n39_ & (~x07 | ~x13 | ~x24);
  assign new_n84_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n86_ | x03)) | new_n39_ | (~new_n63_ & (new_n87_ | ~x03));
  assign new_n86_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n87_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = new_n64_ | (~new_n39_ & ~new_n89_);
  assign new_n89_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
endmodule
