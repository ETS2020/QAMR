...
module FAU ( 
  ...
  assign new_n56_ = (~x24 | new_n57_ | new_n65_) & (~x20 | (~new_n62_ & x18));
  ...
  assign new_n62_ = new_n63_ & new_n64_ & x14 & x15 & x12 & x13;
  assign new_n63_ = new_n51_ & x04 & x05 & x01 & x03;
  assign new_n64_ = x22 & x23 & x16 & x17;
  ...
  assign z3 = (~new_n71_ & ~x24) | ~new_n75_ | (~x05 & ~new_n81_ & ~x13);
  assign new_n71_ = (x01 | ~new_n72_ | x03) & (~new_n74_ | ~x01 | x02 | ~new_n73_ | ~x03);
  assign new_n72_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n43_ & ~x20;
  assign new_n73_ = x06 & x08;
  assign new_n74_ = x14 & x20 & x21 & ~x10 & x11;
  assign new_n75_ = (new_n79_ | ~x20) & (~x24 | new_n76_ | new_n65_);
  assign new_n76_ = (~new_n77_ | ~x14 | ~x20 | ~x08 | ~x11) & (~new_n78_ | x08 | x11 | x14 | x20);
  assign new_n77_ = x01 & x03 & x06;
  assign new_n78_ = ~x01 & ~x03 & ~x06 & x07;
  assign new_n79_ = x18 & (~new_n80_ | ~x05 | ~x06 | ~x01 | ~x03);
  assign new_n80_ = x08 & x11 & x13 & x14 & x15;
  assign new_n81_ = (~new_n82_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n83_ | x01 | x03 | x06 | x08);
  assign new_n82_ = x15 & x20 & x11 & x14;
  assign new_n83_ = x19 & ~x20 & ~x11 & ~x14;
  assign z4 = new_n85_ | (x24 & ~new_n91_ & (x05 | x13)) | (x05 & new_n92_ & x13);
  assign new_n85_ = ~new_n88_ & ((~new_n86_ & (new_n89_ | ~x08)) | (~new_n87_ & (new_n90_ | x08)));
  assign new_n86_ = ~new_n69_ & (x05 | x13 | ~x15);
  ...
  assign new_n91_ = (~x18 | (~new_n89_ & ~x07 & x08)) & (~x07 | x20 | (~new_n90_ & ~x08));
  assign new_n92_ = x15 & (new_n89_ | ~x08) & (x18 | (~x20 & ~x24));
  assign z5 = (~new_n95_ & x05) | ~new_n94_ | new_n88_ | (~x05 & ~x13 & x19);
  assign new_n94_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n95_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = new_n97_ | new_n100_ | new_n88_ | (x24 & ~new_n98_ & ~new_n65_);
  assign new_n97_ = ~new_n87_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n98_ = (new_n99_ | ~x18) & (~x07 | (~x03 & (~x06 | x11)));
  assign new_n99_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n100_ = ~new_n99_ & (new_n69_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
  assign z7 = ~new_n102_ | (~new_n86_ & ~new_n88_);
  assign new_n102_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | (~x18 & (x20 | x24))))) & (~x13 | ~x18 | ~x24);
endmodule
