...
module FAU ( 
  ...
  assign new_n65_ = ~new_n68_ & ~new_n66_ & (~x18 | ~x24 | ~x13 | x15);
  assign new_n66_ = ~x02 & (new_n67_ | (~x10 & x21 & ~x24));
  assign new_n67_ = x15 & ((x18 & x24) | (~x05 & ~x13));
  assign new_n68_ = x05 & ((~x15 & x18 & x24) | (~x02 & x13 & x15 & ~x24));
  ...
  assign z6 = (new_n90_ & ~x11) | new_n89_ | new_n93_ | (new_n94_ & x19);
  assign new_n89_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = (x06 | (~x14 & x20)) & (new_n92_ | (~new_n91_ & ~x02));
  assign new_n91_ = (~x15 | ~x24 | x03 | ~x07) & (~x00 | x10 | x24);
  assign new_n92_ = ~x15 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n93_ = x03 & (new_n38_ | (x07 & x24 & ~new_n39_ & ~new_n62_));
  assign new_n94_ = (x05 ? (x13 & ~x24) : ~x13) & (x15 ? ~x02 : x03);
  assign z7 = (~new_n97_ & x05) | ~new_n96_ | (x15 & (x02 | (~x05 & ~x13)));
  assign new_n96_ = ~new_n82_ & (~x13 | ~x18 | ~x24);
