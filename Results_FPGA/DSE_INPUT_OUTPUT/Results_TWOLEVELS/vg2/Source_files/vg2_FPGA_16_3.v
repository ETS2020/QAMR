...
module FAU ( 
  ...
  assign new_n41_ = x04 & x06 & new_n42_ & x08;
  assign new_n42_ = x09 & x11 & x12 & x14 & new_n43_ & x16;
  assign new_n43_ = x17 & ~x18 & x20 & x22 & ~new_n44_ & x23;
  ...
  assign new_n50_ = (~new_n51_ | ~new_n53_) & (~new_n57_ | ~new_n58_ | ~new_n55_ | ~new_n56_);
  ...
  assign new_n55_ = x01 & x03 & x04 & x06;
  ...
  assign new_n63_ = x20 & ((~new_n64_ & (~x12 | ~x18)) | (~x12 & x18 & ~new_n67_ & x24));
  assign new_n64_ = ~new_n66_ & (new_n65_ | ~x15);
  ...
  assign z4 = new_n80_ | (x24 & ~new_n85_ & ~new_n67_);
  assign new_n80_ = ~new_n39_ & (new_n81_ | (~x02 & new_n84_ & ~x10));
  assign new_n81_ = ~new_n65_ & ((x15 & (new_n82_ | ~x08)) | (x19 & (new_n83_ | x08)));
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = ~x24 & ((x21 & (new_n82_ | ~x08)) | (x00 & (new_n83_ | x08)));
  assign new_n85_ = (x12 | ~x18 | (~new_n82_ & ~x07 & x08)) & (~x07 | x18 | (~new_n83_ & ~x08));
  assign z5 = (~new_n87_ & (~x12 | ~x18)) | (x07 & x24 & ~new_n67_ & (~x18 | (~x12 & x18)));
  assign new_n87_ = ~new_n38_ & (new_n65_ | ~x19);
  assign z6 = new_n89_ | (x24 & ~new_n92_ & ~new_n67_);
  assign new_n89_ = ~new_n39_ & ((~new_n87_ & ~new_n90_) | (~new_n64_ & (new_n91_ | ~x03)));
  assign new_n90_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n91_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n92_ = (x12 | ~x18 | (~new_n91_ & x03 & ~x07)) & (~x07 | new_n90_ | x18);
  assign z7 = (~new_n94_ & x05) | new_n95_ | new_n66_ | (~x05 & ~x13 & x15);
  assign new_n94_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n95_ = x18 & (x12 | (x13 & x24));
endmodule
