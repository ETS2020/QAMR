...
module FAU ( 
  ...
  assign new_n36_ = ~x11 & ~x14 & ~x20 & ~new_n37_ & ~new_n38_;
  assign new_n37_ = x00 & ~x02;
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z1 = new_n40_ | new_n50_ | (new_n60_ & (new_n56_ | (new_n41_ & new_n54_)));
  assign new_n40_ = x24 & ~new_n49_ & ~new_n37_ & (new_n45_ | (new_n41_ & new_n43_));
  ...
  assign new_n50_ = new_n51_ & new_n53_ & ~x00 & x01 & ~x02 & x03;
  assign new_n51_ = new_n52_ & x11 & x12 & x14 & x16 & x17;
  assign new_n52_ = x22 & x23 & ~x24 & x20 & x21;
  assign new_n53_ = x08 & x09 & ~x10 & x04 & x06;
  assign new_n54_ = new_n55_ & x12 & x14 & x15 & x16;
  ...
  assign new_n60_ = ~new_n37_ & (x05 ? (x13 & ~x24) : ~x13);
  assign z2 = new_n62_ & x01;
  assign new_n62_ = x03 & x06 & x11 & x14 & ~new_n63_ & x20;
  assign new_n63_ = (new_n64_ | (x00 & ~x02)) & (x00 | x02 | x10 | ~x21 | x24);
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = new_n66_ | (~new_n73_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n69_ & (x05 | x13));
  assign new_n66_ = ~x02 & (new_n67_ | x00);
  assign new_n67_ = new_n68_ & x01 & x03 & x06 & x08 & ~x10;
  assign new_n68_ = x20 & x21 & ~x24 & x11 & x14;
  ...
  assign z4 = (~new_n63_ & (new_n77_ | ~x08)) | (~new_n37_ & ~new_n38_ & (new_n78_ | x08));
  assign new_n77_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = (x05 & ((x13 & x19 & ~x24) | (x07 & x24))) | (x07 & x13 & x24) | new_n37_ | (~x05 & ~x13 & x19);
  assign z6 = (~new_n81_ & (new_n83_ | ~x03)) | new_n37_ | (~new_n38_ & (new_n84_ | x03));
  ...
  assign z7 = ~new_n64_ | (~x02 & (x00 | (~x10 & x21 & ~x24)));
endmodule
