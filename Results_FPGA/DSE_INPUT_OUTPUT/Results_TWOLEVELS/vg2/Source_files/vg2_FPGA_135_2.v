...
module FAU ( 
  ...
  assign new_n73_ = (new_n74_ | ~x03) & (~new_n77_ | ~new_n76_ | x01 | x03);
  assign new_n74_ = x12 & (~new_n75_ | ~x06 | ~x08 | ~x01 | x05);
  assign new_n75_ = x11 & ~x13 & x14 & x15 & x20;
  assign new_n76_ = ~x05 & ~x06 & ~x08;
  ...
  assign z6 = (~new_n37_ & (x03 ? x12 : new_n86_)) | (~new_n63_ & (new_n87_ | ~x03));
  assign new_n86_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n87_ = x11 & x12 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n89_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n89_ = ~new_n64_ & (x05 | x13 | ~x15) & ~new_n81_ & (~new_n90_ | ~x13);
