...
module FAU ( 
  ...
  assign new_n70_ = ~x10 & (x02 | (~new_n71_ & ~x24));
  ...
  assign z5 = (x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | new_n81_ | (x07 & x13 & x24) | (~x05 & ~x13 & x19);
  assign new_n81_ = ~x10 & (x02 | (x00 & ~x24));
  assign z6 = (~new_n37_ & (new_n83_ | x03)) | new_n39_ | (~new_n63_ & (new_n84_ | ~x03));
  assign new_n83_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n84_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n86_ & (~x02 | x10)) | (~x02 & ~x10 & x21 & ~x24);
