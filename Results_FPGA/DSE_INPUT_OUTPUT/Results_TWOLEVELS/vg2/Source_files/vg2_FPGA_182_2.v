...
module FAU ( 
  ...
  assign z6 = (~new_n81_ & (x03 | (~new_n83_ & ~x11))) | (~new_n82_ & (~x03 | (~new_n84_ & x11)));
  assign new_n81_ = (~x00 | x01 | x02 | x10 | x24) & (new_n79_ | (x01 & ~x02));
  assign new_n82_ = (new_n61_ | (x01 & ~x02)) & (x01 | x02 | x10 | ~x21 | x24);
