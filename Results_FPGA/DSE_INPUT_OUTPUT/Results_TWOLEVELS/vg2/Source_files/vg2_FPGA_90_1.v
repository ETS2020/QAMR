...
module FAU ( 
  ...
  assign new_n56_ = (x00 | ~x02) & (x05 | x13 | (~new_n57_ & ~new_n59_));
  ...
  assign new_n75_ = (x00 | ~x02) & (x05 | new_n76_ | x13);
  ...
  assign z4 = (~new_n64_ & (~x08 | (~new_n80_ & x16))) | (z5 & (x08 | (~new_n81_ & ~x16)));
  assign new_n80_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z6 = (~new_n64_ & (~x03 | (~new_n83_ & x11))) | (z5 & (x03 | (~new_n84_ & ~x11)));
  assign new_n83_ = x06 & (~x14 | x20);
  assign new_n84_ = ~x06 & (x14 | ~x20);
  assign z7 = (~new_n86_ & x05) | ~new_n87_ | new_n66_ | (~x05 & ~x13 & x15);
  assign new_n86_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n87_ = (x00 | ~x02) & (~x13 | ~x18 | ~x24);
endmodule
