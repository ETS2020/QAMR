...
module FAU ( 
  ...
  assign z4 = ((new_n81_ | new_n38_) & (new_n83_ | x08)) | (z7 & (new_n84_ | ~x08));
  ...
  assign z6 = new_n89_ | new_n90_ | (x02 & ~x12);
  assign new_n89_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = ~new_n91_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n91_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n65_ & (x05 | x13 | ~x15);
endmodule
