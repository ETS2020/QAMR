...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n83_ | x08)) | new_n82_ | (~new_n80_ & (new_n84_ | ~x08));
  ...
  assign z5 = new_n38_ | (~new_n82_ & ~new_n86_);
  assign new_n86_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = (z5 & (x03 | (~new_n90_ & ~x11))) | (z7 & (~x03 | (~new_n91_ & x11)));
  assign z7 = new_n81_ | (~new_n82_ & ~new_n89_);
