...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n76_, new_n77_, new_n80_, new_n81_, new_n82_, new_n83_;
  ...
  assign z4 = (~new_n73_ & (x08 | (~new_n76_ & ~x16))) | (z7 & (~x08 | (~new_n77_ & x16)));
  ...
  assign new_n83_ = ~new_n61_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
