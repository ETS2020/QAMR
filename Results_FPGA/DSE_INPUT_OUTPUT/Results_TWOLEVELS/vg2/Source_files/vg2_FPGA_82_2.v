...
module FAU ( 
  ...
  assign z1 = ~new_n49_ | ((new_n41_ | new_n45_) & (x05 ? (x13 & ~x24) : ~x13));
  ...
  assign z3 = new_n69_ | (~new_n71_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n65_ & (x05 | x13));
  ...
  assign new_n69_ = ~x02 & (x01 | (new_n70_ & new_n47_ & x00 & ~x03));
  assign new_n70_ = ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  assign new_n71_ = (~new_n72_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n73_ | x01 | x03 | x06 | x08);
  assign new_n72_ = x15 & x20 & x11 & x14;
  assign new_n73_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n75_ & (new_n79_ | x08)) | new_n81_ | (~new_n77_ & (new_n80_ | ~x08));
  assign new_n75_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n76_ & (x05 | x13 | ~x19);
  assign new_n76_ = ~x10 & ~x24 & x00 & ~x02;
  ...
  assign z5 = (~new_n39_ & (~x01 | x02)) | (x00 & ~x01 & ~x02 & ~x10 & ~x24);
