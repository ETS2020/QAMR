...
module FAU ( 
  ...
  assign new_n36_ = ~x20 & (new_n37_ | (x05 & (x24 ? x07 : ~new_n38_)));
  assign new_n37_ = x02 & ((~x05 & ~x13 & x19) | (x07 & x13 & x24));
  assign new_n38_ = (~x00 | x02 | x10) & (~x13 | ~x19);
  assign z1 = new_n40_ | (~new_n49_ & ~new_n61_) | (~x02 & (new_n56_ | ~x05));
  ...
  assign new_n43_ = new_n44_ & x22 & x23 & x18 & x20;
  ...
  assign new_n58_ = new_n44_ & x22 & x23 & x20 & x21;
  assign new_n59_ = new_n60_ & x00 & ~x01 & ~x03;
  assign new_n60_ = ~x08 & ~x09 & ~x04 & ~x06;
  assign new_n61_ = x05 ? (~x13 | x24) : x13;
  assign z2 = new_n65_ | (~new_n63_ & ~x02);
  assign new_n63_ = x05 & (~new_n64_ | ~x01 | ~x03 | ~x06 | x10);
  assign new_n64_ = x11 & x14 & x20 & x21 & ~x24;
  assign new_n65_ = x01 & x03 & x06 & x11 & new_n66_ & x14;
  assign new_n66_ = x20 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  assign z3 = (x24 & ~new_n68_ & (x05 | x13)) | new_n72_ | (~new_n75_ & (x05 ? (x13 & ~x24) : ~x13));
  ...
  assign new_n72_ = ~x02 & (~x05 | (~x10 & ~x24 & (new_n73_ | new_n74_)));
  assign new_n73_ = new_n70_ & ~x03 & ~x06 & x00 & ~x01;
  ...
  assign z5 = ~new_n87_ | (~x02 & (~x05 | (x00 & ~x10 & ~x24)));
  assign new_n87_ = (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24) & (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24)));
  assign z6 = (~new_n79_ & (new_n89_ | x03)) | new_n85_ | (~new_n81_ & (new_n90_ | ~x03));
  assign new_n89_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n90_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (x02 & ((new_n92_ & x13) | (~x05 & ~x13 & x15))) | (x05 & (new_n92_ | new_n93_));
  assign new_n92_ = x18 & x24;
  assign new_n93_ = ~x24 & ((x13 & x15) | (~x02 & ~x10 & x21));
endmodule
