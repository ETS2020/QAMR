...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n75_ | x08)) | new_n77_ | (~new_n73_ & (new_n76_ | ~x08));
  ...
  assign z5 = (x00 & ~x01 & ~x02 & ~x10 & ~x24) | (~new_n79_ & (~x01 | x02));
  assign new_n79_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = (~new_n37_ & (new_n81_ | x03)) | new_n77_ | (~new_n73_ & (new_n82_ | ~x03));
