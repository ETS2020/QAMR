...
module FAU ( 
  ...
  assign z4 = new_n78_ | new_n79_ | ~new_n81_ | (new_n73_ & x24);
  assign new_n73_ = ~new_n74_ & (x05 | x13);
  assign new_n74_ = (new_n75_ | ~x18) & (~new_n77_ | ~x04 | ~x07);
  assign new_n75_ = ~new_n76_ & x08;
  assign new_n76_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n77_ = ~x16 & ~x22 & ~x23;
  assign new_n78_ = ~new_n37_ & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  assign new_n79_ = (x05 ? (x13 & ~x24) : ~x13) & (new_n80_ | (~new_n75_ & x15));
  assign new_n80_ = x04 & ~x16 & x19 & ~x22 & ~x23;
  assign new_n81_ = (x21 | x23) & (x02 | x10 | ~x21 | new_n75_ | x24);
  assign z5 = ~new_n37_ & ~new_n39_;
  assign z6 = ~new_n84_ | (~new_n86_ & (new_n88_ | (~new_n39_ & ~new_n87_)));
  ...
  assign new_n88_ = x00 & ~x02 & ~x10 & x23 & ~x24;
endmodule
