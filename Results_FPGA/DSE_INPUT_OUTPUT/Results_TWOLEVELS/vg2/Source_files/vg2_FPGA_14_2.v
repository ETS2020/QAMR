...
module FAU ( 
  ...
  assign new_n41_ = ~new_n50_ & (new_n42_ | new_n46_);
  ...
  assign new_n53_ = ~x20 & ~x22 & ~x23 & (new_n38_ | new_n54_);
  ...
  assign new_n58_ = (~x18 | ~x24 | (~x05 & ~x13)) & (x02 | x10 | x24);
  ...
  assign z3 = (~new_n64_ & ~new_n39_) | (x01 & x03 & new_n69_ & x06);
  assign new_n64_ = (new_n65_ | new_n50_) & (x01 | x03 | ~new_n68_ | x06);
  ...
  assign new_n68_ = ~x08 & ~x11 & ~x14 & (new_n38_ | new_n54_) & ~x20;
  assign new_n69_ = x08 & x11 & x14 & x20 & ~new_n58_ & x21;
  assign z4 = (~new_n37_ & (new_n71_ | x08)) | new_n39_ | (~new_n61_ & (new_n72_ | ~x08));
  assign new_n71_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n72_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = (~new_n75_ & x05) | ~new_n74_ | new_n39_ | (~x05 & ~x13 & x19);
  assign new_n74_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n75_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n77_ | x03)) | new_n39_ | (~new_n61_ & (new_n78_ | ~x03));
  assign new_n77_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n78_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = (~new_n58_ & x21) | (x15 & ~new_n50_ & (~x18 | x21));
endmodule
