...
module FAU ( 
  ...
  assign z4 = (~new_n53_ & (new_n57_ | x08)) | new_n59_ | (~new_n46_ & (new_n58_ | ~x08));
  assign new_n53_ = x05 ? ~new_n56_ : (new_n54_ & (x13 | ~x19));
  assign new_n54_ = ~new_n55_ & (~x07 | ~x13 | ~x24);
  ...
  assign z5 = ~new_n61_ | (x07 & x24 & (x05 | x13));
  assign new_n61_ = (~x05 | (x21 & (~x13 | ~x19 | x24))) & ~new_n55_ & (x05 | x13 | ~x19);
  assign z6 = (~new_n53_ & (new_n63_ | x03)) | new_n59_ | (~new_n46_ & (new_n64_ | ~x03));
