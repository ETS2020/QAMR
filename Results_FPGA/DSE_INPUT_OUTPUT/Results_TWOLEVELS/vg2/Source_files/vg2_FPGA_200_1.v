...
module FAU ( 
  ...
  assign new_n82_ = z7 & (~x08 | (~x09 & x16));
  assign z7 = (~new_n64_ & (x02 | ~x22)) | (~x02 & ~x10 & x21 & ~x22 & ~x24);
  assign new_n84_ = x02 & ((new_n85_ & x16) | (~new_n39_ & (x08 | (x09 & ~x16))));
  assign new_n85_ = x22 & ~new_n64_ & (~x17 | (~x04 & x23));
  ...
  assign z6 = new_n91_ | new_n92_ | (~x02 & x22);
  assign new_n91_ = ~new_n86_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
