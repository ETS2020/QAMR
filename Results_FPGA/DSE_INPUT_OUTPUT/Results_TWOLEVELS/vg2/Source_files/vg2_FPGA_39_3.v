...
module FAU ( 
  ...
  assign z2 = x03 & (x02 | (new_n63_ & x01));
  ...
  assign new_n71_ = (~x03 | (~new_n72_ & ~x02)) & (~new_n75_ | ~new_n74_ | x02 | x03 | x06);
  assign new_n72_ = new_n73_ & x01 & x06 & x08 & ~x10;
  ...
  assign z6 = ~new_n89_ | (~x11 & ~new_n95_ & (new_n38_ | new_n96_));
  assign new_n89_ = (~x24 | new_n90_ | (~x05 & ~x13)) & ~new_n93_ & (new_n92_ | (x05 ? (~x13 | x24) : x13));
  assign new_n90_ = (x02 | ((~x03 | ~x07) & (~x11 | new_n91_ | ~x18))) & (x03 | ~x18);
  assign new_n91_ = x06 & (~x14 | x20);
  assign new_n92_ = (x02 | ((~x03 | ~x19) & (~x11 | new_n91_ | ~x15))) & (x03 | ~x15);
  assign new_n93_ = ~x02 & ~x10 & ~x24 & (new_n94_ | (x00 & x03));
  assign new_n94_ = x21 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n95_ = ~x06 & (x14 | ~x20);
  assign new_n96_ = ~x03 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign z7 = new_n81_ | (~new_n82_ & ~new_n98_);
