...
module FAU ( 
  ...
  assign z2 = ~new_n62_ & x14;
  assign new_n62_ = x20 & (~x01 | ~x03 | ~x06 | new_n63_ | ~x11);
  ...
  assign z6 = ~new_n82_ | (~new_n63_ & (~x03 | (~x06 & x11)));
  assign new_n82_ = (~x14 | x20) & (new_n37_ | (~x03 & (x11 | (~x06 & (x14 | ~x20)))));
