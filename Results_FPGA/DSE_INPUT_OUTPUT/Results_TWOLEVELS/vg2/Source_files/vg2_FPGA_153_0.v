...
module FAU ( 
  ...
  assign z1 = (~new_n41_ & ~x24) | (~new_n57_ & ~x05) | (x24 & ~new_n48_ & (x05 | x13));
  ...
  assign new_n57_ = x21 & (x13 | (~new_n58_ & ~new_n60_));
  ...
  assign z7 = (~new_n66_ & x05) | (x21 & (~new_n67_ | (~x05 & ~x13 & x15)));
  assign new_n66_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n67_ = (~x13 | ~x18 | ~x24) & (x02 | x10 | x24);
  assign z3 = x01 ? (x03 & x06 & new_n64_ & x08) : (~x03 & ~x06 & new_n69_ & ~x08);
  assign new_n69_ = ~x11 & ~x14 & z5 & ~x20;
  assign z5 = ~new_n72_ | (~x24 & (new_n71_ | (x05 & x13 & x19)));
  assign new_n71_ = x00 & ~x02 & ~new_n39_ & ~x10;
  assign new_n72_ = ~new_n73_ & (~x19 | ~x21 | x05 | x13);
  assign new_n73_ = x07 & x24 & (x05 | (x13 & x21));
  assign z4 = (~new_n37_ & (new_n77_ | x08)) | new_n39_ | (~new_n75_ & (new_n78_ | ~x08));
  ...
  assign z6 = (~new_n80_ & (new_n82_ | x03)) | new_n84_ | (z7 & (new_n83_ | ~x03));
  assign new_n80_ = ~new_n73_ & (x05 | x13 | ~x19 | ~x21) & (~new_n81_ | ~x05);
  assign new_n81_ = ~x24 & ((x13 & x19) | (x00 & ~x02 & ~x10));
