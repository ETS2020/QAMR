...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n83_ & ~x16))) | (~new_n65_ & (~x08 | (~new_n84_ & x16)));
  assign new_n83_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n84_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = (~new_n86_ & x05) | ~new_n87_ | new_n62_ | (~x05 & ~x13 & x19);
  assign new_n86_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign new_n87_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign z6 = (~new_n37_ & (x03 | (~new_n89_ & ~x11))) | (~new_n65_ & (~x03 | (~new_n90_ & x11)));
  assign new_n89_ = ~x06 & (x14 | ~x20);
  assign new_n90_ = x06 & (~x14 | x20);
  assign z7 = ~new_n92_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n92_ = ~new_n62_ & (~new_n93_ | ~x13) & ~new_n67_ & (x05 | x13 | ~x15);
