...
module FAU ( 
  ...
  assign new_n65_ = ~new_n66_ & ~new_n67_ & (~x15 | (~new_n62_ & (~x18 | ~x24)));
  ...
  assign z6 = ~new_n88_ | (~x11 & ~new_n92_ & (x06 | (~x14 & x20)));
  assign new_n88_ = ~new_n89_ & (~new_n91_ | ~x19) & (~x03 | (~new_n90_ & ~new_n38_));
  assign new_n89_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = x07 & x24 & ~new_n39_ & ~new_n62_;
  assign new_n91_ = (x05 ? (x13 & ~x24) : ~x13) & (x15 | (~x02 & x03));
  assign new_n92_ = (new_n93_ | x02) & (~x15 | ~x24 | x03 | ~x07);
