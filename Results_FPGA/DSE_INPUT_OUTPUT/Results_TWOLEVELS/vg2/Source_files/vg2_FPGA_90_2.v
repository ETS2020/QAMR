...
module FAU ( 
  ...
  assign new_n62_ = (new_n63_ | (x00 & ~x02)) & (x00 | x02 | x10 | ~x21 | x24);
  ...
  assign new_n65_ = ~x02 & (new_n66_ | x00);
  assign new_n66_ = new_n67_ & x06 & x08 & ~x10 & x01 & x03;
  ...
  assign z4 = (~new_n62_ & (new_n76_ | ~x08)) | (~new_n38_ & ~new_n39_ & (new_n77_ | x08));
  assign new_n76_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = (~new_n62_ & (new_n79_ | ~x03)) | (~new_n38_ & ~new_n39_ & (new_n80_ | x03));
  assign new_n79_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n80_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n63_ | (~x02 & (x00 | (~x10 & x21 & ~x24)));
endmodule
