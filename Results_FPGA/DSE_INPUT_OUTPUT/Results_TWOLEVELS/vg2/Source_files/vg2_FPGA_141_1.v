...
module FAU ( 
  ...
  assign new_n36_ = ~x06 & ~x11 & ~x14 & ~x15 & ~new_n37_ & ~x20;
  ...
  assign new_n45_ = ~x09 & ~x11 & ~x12 & ~x14 & new_n46_ & ~x15;
  ...
  assign new_n54_ = new_n55_ & ~x15 & ~x16 & ~x12 & ~x14;
  ...
  assign new_n61_ = ~x16 & ~x17 & ~x14 & ~x15;
  ...
  assign new_n70_ = ~x11 & ~x14 & ~x15 & ~new_n47_ & ~x20;
  assign new_n71_ = ~new_n72_ & (~new_n74_ | x01 | x03 | x06 | ~x07);
  assign new_n72_ = new_n73_ & x18 & x20 & x11 & x14;
  assign new_n73_ = x06 & x08 & x01 & x03;
  assign new_n74_ = ~x08 & ~x11 & ~x14 & ~x15 & ~x20;
  assign new_n75_ = (~new_n76_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n77_ | x01 | x03 | x06 | x08);
  assign new_n76_ = x15 & x20 & x11 & x14;
  assign new_n77_ = ~x11 & ~x14 & ~x15 & x19 & ~x20;
  assign z4 = ~new_n79_ | (~new_n87_ & (x11 | ~x15));
  assign new_n79_ = (new_n86_ | (x05 ? (~x13 | x24) : x13)) & (new_n80_ | ~x24);
  assign new_n80_ = (x15 | new_n81_ | new_n85_) & (~x11 | new_n84_ | ~x15);
  assign new_n81_ = (~new_n83_ | ~x07) & (~x18 | (~new_n82_ & x08));
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = (~x18 | (~new_n82_ & x08)) & (~x07 | ~new_n83_ | x08);
  assign new_n85_ = ~x05 & ~x13;
  assign new_n86_ = (~x11 | ~x15 | (~new_n82_ & x08 & ~x19)) & (x15 | ~x19 | (~new_n83_ & ~x08));
  assign new_n87_ = (new_n88_ | ~x08) & (x02 | ~new_n89_ | x10);
  assign new_n88_ = ~new_n38_ & (~x07 | new_n85_ | ~x24);
  assign new_n89_ = ~x24 & ((new_n83_ & x00) | (x21 & (new_n82_ | ~x08)));
  assign z5 = new_n91_ | ~new_n92_ | new_n38_ | (x07 & x13 & x24);
  assign new_n91_ = x05 & ((x13 & x19 & ~x24) | (x07 & x24));
  assign new_n92_ = (x11 | ~x15) & (x05 | x13 | ~x19);
  assign z6 = (~new_n97_ & (x11 | ~x15)) | (~new_n94_ & ~x15) | (x11 & (new_n96_ | (~new_n99_ & x15)));
  assign new_n94_ = new_n95_ & (x11 | new_n37_ | (~x06 & (x14 | ~x20)));
  assign new_n95_ = x03 ? (~x19 | (x05 ? (~x13 | x24) : x13)) : (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n96_ = ~new_n65_ & (~x06 | (x14 & ~x20));
  assign new_n97_ = ~new_n98_ & (~x03 | ~x07 | new_n85_ | ~x24);
  assign new_n98_ = ~x02 & ~x10 & ~x24 & (x03 ? x00 : x21);
  assign new_n99_ = ((x05 ? (~x13 | x24) : x13) | (x03 & ~x19)) & (x03 | ~x18 | ~x24);
  assign z7 = (~new_n101_ & ~x24) | (x11 & x15 & (new_n85_ | (x18 & x24))) | (~x15 & x18 & ~new_n85_ & x24);
