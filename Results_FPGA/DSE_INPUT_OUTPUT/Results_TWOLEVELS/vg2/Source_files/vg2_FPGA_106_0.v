...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n82_, new_n83_, new_n86_, new_n88_, new_n89_;
  assign z0 = (~x02 & (new_n36_ | ~x21)) | (new_n38_ & ~x01);
  ...
  assign z1 = new_n41_ | new_n50_ | (~x02 & (new_n57_ | ~x21));
  ...
  assign new_n59_ = new_n45_ & x12 & x14 & x16;
  assign new_n60_ = new_n61_ & x00 & ~x01 & ~x03;
  assign new_n61_ = ~x08 & ~x09 & ~x04 & ~x06;
  assign z2 = (new_n65_ & x01) | (~new_n63_ & ~x02);
  assign new_n63_ = x21 & (~new_n64_ | ~x11 | ~x14 | ~x20 | x24);
  assign new_n64_ = x01 & x03 & x06 & ~x10;
  assign new_n65_ = x03 & x06 & x11 & x14 & ~new_n66_ & x20;
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n75_ & (x05 ? (x13 & ~x24) : ~x13)) | new_n72_ | (x24 & ~new_n68_ & (x05 | x13));
  ...
  assign new_n72_ = ~x02 & (~x21 | (~x10 & ~new_n73_ & ~x24));
  assign new_n73_ = (~new_n74_ | ~x08 | ~x11 | ~x14 | ~x20) & (~new_n37_ | x14 | x20 | x08 | x11);
  ...
  assign z4 = (~new_n39_ & (new_n81_ | x08)) | new_n83_ | (~new_n79_ & (new_n82_ | ~x08));
  ...
  assign new_n83_ = ~x02 & (~x21 | (x21 & ~x24 & x00 & ~x10));
  assign z5 = ~new_n39_ | new_n83_;
  assign z6 = new_n86_ | ~new_n88_;
  assign new_n86_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n66_ & (x02 | x21)) | (~x02 & ~x10 & x21 & ~x24);
  assign new_n88_ = (~new_n89_ | (~x02 & ~x21)) & (~x00 | x02 | x10 | ~x21 | x24);
  assign new_n89_ = ~new_n39_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
endmodule
