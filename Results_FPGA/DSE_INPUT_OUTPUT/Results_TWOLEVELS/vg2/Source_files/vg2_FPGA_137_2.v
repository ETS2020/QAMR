...
module FAU ( 
  ...
  assign z1 = new_n41_ | (x21 & (new_n61_ | (~x01 & new_n58_ & ~x03)));
  ...
  assign new_n61_ = new_n62_ & new_n64_ & x14 & x16 & x11 & x12;
  assign new_n62_ = new_n63_ & x03 & x04 & x01 & ~x02;
  assign new_n63_ = x06 & x08 & x09 & ~x10;
  assign new_n64_ = x17 & x20 & x22 & x23 & ~x24;
  assign z2 = new_n66_ & x01;
  assign new_n66_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = new_n69_ | (~new_n39_ & ~new_n68_);
  ...
  assign z6 = (~new_n37_ & (new_n90_ | x03)) | new_n39_ | (~new_n84_ & (new_n91_ | ~x03));
