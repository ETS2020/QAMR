...
module FAU ( 
  ...
  assign new_n58_ = ~new_n38_ & (x05 | x13 | (~new_n59_ & ~new_n61_));
  assign new_n59_ = new_n51_ & new_n60_ & x15 & x16 & x12 & x14;
  ...
  assign z2 = new_n38_ | (new_n65_ & x01);
  ...
  assign new_n69_ = (~x24 | new_n70_ | (~x05 & ~x13)) & ~new_n38_ & (x05 | new_n74_ | x13);
  ...
  assign new_n77_ = x06 & x08 & x11 & x14 & ~new_n45_ & x20;
  assign new_n78_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n48_ & ~x20;
  assign z4 = (~new_n80_ & (new_n81_ | x08)) | new_n38_ | (~new_n66_ & (new_n82_ | ~x08));
  assign new_n80_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n40_ & (x05 | x13 | ~x19);
  assign new_n81_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n80_ & (new_n84_ | x03)) | new_n38_ | (~new_n66_ & (new_n85_ | ~x03));
  assign new_n84_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n85_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n87_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n87_ = ~new_n67_ & (x05 | x13 | ~x15) & ~new_n38_ & (~new_n88_ | ~x13);
