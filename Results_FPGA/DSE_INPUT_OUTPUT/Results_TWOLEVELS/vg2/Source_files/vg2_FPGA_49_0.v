...
module FAU ( 
  ...
  assign z6 = new_n59_ | new_n62_ | (~x05 & ~x21);
  assign new_n59_ = ~new_n60_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n60_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n61_ & (x05 | x13 | ~x19);
  assign new_n61_ = x00 & ~x02 & ~x10 & ~x24;
