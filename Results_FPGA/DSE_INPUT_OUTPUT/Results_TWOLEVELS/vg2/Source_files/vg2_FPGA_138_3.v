...
module FAU ( 
  ...
  assign new_n55_ = (~x20 | ~x21) & (~new_n56_ | ~new_n53_ | ~new_n58_ | x17 | x20);
  assign new_n56_ = new_n57_ & ~x02 & ~x03 & x00 & ~x01;
  assign new_n57_ = ~x04 & ~x06 & ~x08 & ~x09 & ~x10;
  assign new_n58_ = ~x22 & ~x23 & ~x24;
  ...
  assign new_n65_ = x11 & x14 & x18 & x20 & ~x21;
  ...
  assign new_n73_ = (new_n75_ | (x20 & x21)) & (~new_n74_ | x10 | x21 | x24);
  assign new_n74_ = x00 & ~x02;
  assign new_n75_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n76_ = (new_n61_ | (x20 & x21)) & (x02 | x10 | x20 | ~x21 | x24);
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = ~x20 & x21 & ~x24 & x00 & ~x02 & ~x10;
  assign z5 = new_n81_ | ~new_n82_ | new_n38_ | (x07 & x13 & x24);
  assign new_n81_ = x05 & ((x13 & x19 & ~x24) | (x07 & x24));
  assign new_n82_ = (~x20 | ~x21) & (x05 | x13 | ~x19);
  assign z6 = (~new_n86_ & ~x20) | (~new_n84_ & ~x21);
  assign new_n84_ = (new_n37_ | (~x03 & (x11 | (~new_n85_ & ~x06)))) & (new_n61_ | (x03 & (x06 | ~x11)));
