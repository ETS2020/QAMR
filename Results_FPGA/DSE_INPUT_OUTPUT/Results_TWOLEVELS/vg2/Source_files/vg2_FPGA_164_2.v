...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n75_, new_n77_, new_n78_, new_n81_, new_n82_, new_n83_, new_n84_,
    new_n85_, new_n86_;
  ...
  assign z4 = (~new_n75_ & (x08 | (~new_n77_ & ~x16))) | (z7 & (~x08 | (~new_n78_ & x16)));
  assign new_n75_ = (new_n39_ | (x01 & ~x02)) & (~x00 | x01 | x02 | x10 | x24);
