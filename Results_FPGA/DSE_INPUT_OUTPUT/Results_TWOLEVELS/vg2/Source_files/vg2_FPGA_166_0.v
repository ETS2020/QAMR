...
module FAU ( 
  ...
  assign z2 = (new_n62_ & x01) | (~x02 & (new_n60_ | ~x01));
  ...
  assign new_n75_ = (new_n63_ | (~x01 & ~x02)) & (x10 | ~x21 | x24 | ~x01 | x02);
  assign new_n76_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n77_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n75_ & (~x03 | (~new_n80_ & x11))) | (z5 & (x03 | (~new_n79_ & ~x11)));
  assign new_n79_ = ~x06 & (x14 | ~x20);
  assign new_n80_ = x06 & (~x14 | x20);
  assign z7 = ~new_n63_ | (~x02 & (~x01 | (~x10 & x21 & ~x24)));
endmodule
