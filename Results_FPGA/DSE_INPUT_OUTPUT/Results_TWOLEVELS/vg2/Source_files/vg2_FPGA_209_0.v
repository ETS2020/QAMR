...
module FAU ( 
  ...
  assign new_n55_ = ~new_n60_ & (x03 | (~new_n56_ & x21));
  assign new_n56_ = new_n57_ & new_n59_ & ~x13 & ~x14 & ~x16 & ~x17;
  assign new_n57_ = new_n58_ & ~x05 & ~x06 & ~x01 & ~x04;
  ...
  assign z4 = (~new_n37_ & (new_n77_ | x08)) | new_n79_ | (~new_n65_ & (new_n78_ | ~x08));
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = ~x03 & ~x21;
  assign z5 = ~new_n37_ & ~new_n79_;
  assign z6 = ~new_n82_ | (x11 & ~new_n87_ & (~x06 | (x14 & ~x20)));
  assign new_n82_ = (x24 | (~new_n86_ & (~x05 | new_n83_ | ~x13))) & (~x24 | new_n85_ | (~x05 & ~x13)) & (x05 | new_n83_ | x13);
  assign new_n83_ = (new_n84_ | ~x19) & (x03 | ~x15 | ~x21);
  assign new_n84_ = ~x03 & (x11 | ~x21 | (~x06 & (x14 | ~x20)));
  assign new_n85_ = (new_n84_ | ~x07) & (x03 | ~x18 | ~x21);
  assign new_n86_ = ~x02 & ~x10 & (x03 ? x00 : x21);
  assign new_n87_ = ~new_n66_ & (new_n73_ | ~x03);
  assign z7 = new_n66_ | (~new_n73_ & (x03 | (~x03 & x21)));
endmodule
