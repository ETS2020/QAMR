...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n92_;
  assign z0 = (~x01 & ~x03 & ~x06 & new_n36_ & ~x11) | (~x07 & x11);
  ...
  assign new_n64_ = x06 & x07 & x11 & x14 & ~new_n65_ & x20;
  ...
  assign z6 = (new_n85_ & x24) | new_n87_ | new_n88_ | new_n62_;
  assign new_n85_ = (x05 | x13) & ((~new_n86_ & x07) | (~x03 & x18));
  assign new_n86_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n87_ = ~new_n86_ & (new_n38_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n88_ = ~new_n89_ & (new_n66_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n89_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign z7 = ~new_n91_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n91_ = ~new_n66_ & (x05 | x13 | ~x15) & ~new_n62_ & (~new_n92_ | ~x13);
