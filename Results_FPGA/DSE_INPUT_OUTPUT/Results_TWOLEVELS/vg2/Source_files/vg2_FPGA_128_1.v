...
module FAU ( 
  ...
  assign z4 = (~new_n83_ & (x08 | (~new_n85_ & ~x16))) | (z7 & (~x08 | (~new_n86_ & x16)));
  ...
  assign z6 = new_n89_ | new_n92_ | (~x02 & x12);
  assign new_n89_ = ~new_n90_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n91_ & (x05 | x13 | ~x19);
  assign new_n91_ = ~x10 & ~x24 & x00 & ~x02;
