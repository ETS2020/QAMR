...
module FAU ( 
  ...
  assign new_n58_ = ~x11 & ~x13 & ~x14 & x19 & ~x20;
  assign new_n59_ = ~x05 & x06 & x08;
  assign new_n60_ = x11 & ~x13 & x14 & x15 & x20;
  assign z4 = (~new_n37_ & (new_n63_ | x08)) | new_n62_ | (~new_n42_ & (new_n64_ | ~x08));
  ...
  assign z6 = (~new_n37_ & (new_n69_ | x03)) | (~new_n42_ & (x03 ? new_n70_ : x12));
  assign new_n69_ = ~x11 & x12 & (x06 | (~x14 & x20));
  assign new_n70_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n72_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n72_ = ~new_n43_ & (x05 | x13 | ~x15) & ~new_n62_ & (~new_n73_ | ~x13);
