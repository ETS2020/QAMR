...
module FAU ( 
  ...
  assign z7 = (~new_n66_ & x05) | (~new_n67_ & x13) | (~x05 & ~x13 & x15 & ~x21);
  ...
  assign new_n80_ = ~new_n83_ & ~new_n81_ & (~x07 | ~x13 | ~x24);
  assign new_n81_ = ~x21 & (new_n82_ | (~x05 & ~x13 & x19));
  assign new_n82_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n83_ = x05 & ((x07 & ~x21 & x24) | (x13 & x19 & ~x24));
