...
module FAU ( 
  ...
  assign new_n47_ = (~x02 | x18) & (x05 | x13 | (~new_n48_ & ~new_n52_));
  ...
  assign new_n63_ = (~new_n64_ | new_n65_) & x20;
  assign new_n64_ = (~x18 | new_n61_ | ~x24) & (x02 | x10 | ~x21 | x24);
  assign new_n65_ = x15 & ((~x02 & (x05 ? (x13 & ~x24) : ~x13)) | (x18 & (x05 ^ ~x13)));
  assign z3 = (~new_n67_ & ~x24) | ~new_n74_ | (x24 & ~new_n70_ & ~new_n61_);
  ...
  assign new_n74_ = (x05 | new_n75_ | x13) & (~x02 | x18);
  ...
  assign z4 = (~new_n79_ & (new_n87_ | x08)) | new_n85_ | (~new_n82_ & x18);
  assign new_n79_ = (~x19 | new_n81_ | (x02 & ~x18)) & (new_n80_ | x02);
  assign new_n80_ = (~x07 | new_n61_ | ~x24) & (~x00 | x10 | x24);
  assign new_n81_ = x05 ? (~x13 | x24) : x13;
  assign new_n82_ = ~new_n83_ & (~x15 | (x05 ^ x13) | (~new_n84_ & x08));
  assign new_n83_ = x24 & ~new_n61_ & (new_n84_ | x07 | ~x08);
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n85_ = ~x02 & ~new_n86_ & (new_n84_ | ~x08);
  assign new_n86_ = (new_n81_ | ~x15) & (x10 | ~x21 | x24);
  assign new_n87_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = new_n89_ | (~new_n90_ & x18) | (~x02 & ~new_n86_ & ~new_n92_);
  assign new_n89_ = ~new_n79_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = (~x24 | new_n91_ | (~x05 & ~x13)) & (~x15 | new_n92_ | (~x05 ^ ~x13));
  ...
  assign new_n94_ = (~x02 | x18) & (~x21 | x24 | x02 | x10);
endmodule
