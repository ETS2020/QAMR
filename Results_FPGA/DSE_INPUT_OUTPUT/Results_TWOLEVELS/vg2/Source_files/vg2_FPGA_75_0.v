...
module FAU ( 
  ...
  assign z4 = ~new_n37_ & ((~new_n38_ & (new_n67_ | x08)) | (~new_n57_ & (new_n68_ | ~x08)));
  ...
  assign z6 = ~new_n37_ & (new_n71_ | new_n72_);
  assign new_n71_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n72_ = ~new_n57_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n37_ & ~new_n57_;
endmodule
