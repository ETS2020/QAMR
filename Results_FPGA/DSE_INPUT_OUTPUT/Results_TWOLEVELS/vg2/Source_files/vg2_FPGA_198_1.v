...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n85_;
  assign z0 = (~new_n36_ & ~x02) | (new_n38_ & ~x01);
  assign new_n36_ = ~x14 & (~new_n37_ | x10 | x11 | x20 | x24);
  ...
  assign z2 = x14 & (new_n61_ | ~x02);
  assign new_n61_ = x01 & x03 & x06 & x11 & ~new_n62_ & x20;
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = new_n64_ | (~new_n70_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n66_ & (x05 | x13));
  assign new_n64_ = ~x02 & (new_n65_ | x14);
  assign new_n65_ = new_n37_ & ~x08 & ~x10 & ~x11 & ~x20 & ~x24;
  ...
  assign new_n70_ = (~new_n71_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n72_ | x06 | x08 | x01 | x03);
  assign new_n71_ = x11 & x14 & x15 & x20;
  assign new_n72_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (z5 & (x08 | (~new_n76_ & ~x16))) | (z7 & (~x08 | (~new_n77_ & x16)));
  assign z5 = (~new_n39_ & (x02 | ~x14)) | (x00 & ~x02 & ~x10 & ~x14 & ~x24);
  assign z7 = (~new_n62_ & (x02 | ~x14)) | (~x02 & ~x10 & ~x14 & x21 & ~x24);
  assign new_n76_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n77_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = ~new_n79_ | (z7 & (~x03 | (~x06 & x11)));
  assign new_n79_ = (new_n80_ | (x05 ? (~x13 | x24) : x13)) & ~new_n84_ & (~x24 | new_n83_ | (~x05 & ~x13));
  assign new_n80_ = (new_n81_ | ~x19) & (~new_n82_ | ~x14 | ~x15 | x20);
  assign new_n81_ = ((~x02 & x14) | (~x03 & (~x06 | x11))) & (x11 | x14 | ~x20);
  assign new_n82_ = x02 & x11;
  assign new_n83_ = (new_n81_ | ~x07) & (~new_n82_ | ~x14 | ~x18 | x20);
  assign new_n84_ = x00 & ~x02 & new_n85_ & ~x10;
  assign new_n85_ = ~x14 & ~x24 & (x03 | (~x11 & (x06 | x20)));
endmodule
