...
module FAU ( 
  ...
  assign z7 = (~new_n63_ & (x02 | x22)) | (x21 & x22 & ~x24 & ~x02 & ~x10);
  assign new_n63_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (x22 & (new_n65_ | new_n70_ | new_n75_)) | (x02 & (new_n70_ | new_n79_));
  ...
  assign z4 = new_n81_ | new_n83_ | (x22 & ~new_n85_ & ~new_n87_);
  assign new_n81_ = ~new_n82_ & (x08 | (x09 & ~x16));
  assign new_n82_ = (new_n39_ | (~x02 & ~x22)) & (~x00 | x02 | x10 | ~x22 | x24);
  assign new_n83_ = x02 & ((new_n84_ & ~x16) | (~new_n63_ & (~x08 | (~x09 & x16))));
  assign new_n84_ = ~x22 & ~new_n39_ & (x17 | (x04 & ~x23));
  ...
  assign z6 = (~new_n82_ & (x03 | (~new_n90_ & ~x11))) | (z7 & (~x03 | (~new_n91_ & x11)));
