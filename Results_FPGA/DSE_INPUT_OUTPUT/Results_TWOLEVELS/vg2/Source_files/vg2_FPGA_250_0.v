...
module FAU ( 
  ...
  assign z3 = ~new_n61_ | (~x24 & (x01 ? (new_n70_ & x03) : (new_n72_ & ~x03)));
  assign new_n61_ = (~x24 | new_n62_ | (~x05 & ~x13)) & ~new_n69_ & (x05 | new_n66_ | x13);
  ...
  assign z4 = (~new_n74_ & (new_n77_ | x08)) | new_n79_ | (~new_n76_ & (new_n78_ | ~x08));
  assign new_n74_ = ~new_n75_ & (~x00 | x02 | ~x06 | x10 | x24);
  assign new_n75_ = ~new_n69_ & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign new_n76_ = ~new_n59_ & (new_n55_ | new_n69_);
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z5 = (~new_n82_ & x05) | ~new_n81_ | new_n69_ | (~x05 & ~x13 & x19);
  assign new_n81_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n82_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n84_ & x06) | (x21 & (~new_n90_ | (~new_n85_ & ~x24)));
  assign new_n84_ = (new_n37_ | (~x03 & x11)) & (new_n55_ | (x03 & (~x11 | ~x14 | x20)));
  assign new_n85_ = new_n86_ & (new_n89_ | (x03 & (x06 | ~x11)));
  assign new_n86_ = ~new_n87_ & (~x05 | ~x13 | new_n88_ | ~x19);
  assign new_n87_ = ~x02 & ~x10 & (x00 | (x11 & x14 & ~x20));
  assign new_n88_ = ~x03 & (x11 | x14 | ~x20);
  assign new_n89_ = (x02 | x10) & (~x05 | ~x13 | ~x15);
  assign new_n90_ = (new_n51_ | new_n88_) & (new_n91_ | (x03 & (x06 | ~x11)));
  assign new_n91_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n93_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n93_ = ~new_n59_ & ~new_n69_;
endmodule
