...
module FAU ( 
  ...
  assign z4 = ~new_n60_ & (x06 | x12);
  assign new_n60_ = (new_n37_ | (~x08 & (new_n61_ | x16))) & (new_n42_ | (x08 & (new_n62_ | ~x16)));
  ...
  assign new_n65_ = (x06 | x12) & (x05 | x13 | ~x19);
  assign z6 = (~new_n69_ & (x06 | x12)) | (new_n67_ & ~x11) | (new_n68_ & x11);
  assign new_n67_ = ~new_n37_ & (x06 | (x12 & ~x14 & x20));
  assign new_n68_ = ~new_n42_ & (x06 ? (x14 & ~x20) : x12);
  assign new_n69_ = (x24 | (~new_n70_ & (~x05 | new_n71_ | ~x13))) & (~x24 | new_n72_ | (~x05 & ~x13)) & (x05 | new_n71_ | x13);
  assign new_n70_ = ~x02 & ~x10 & (x03 ? x00 : x21);
  assign new_n71_ = x03 ? ~x19 : ~x15;
  assign new_n72_ = x03 ? ~x07 : ~x18;
  assign z7 = (~new_n74_ & x05) | ~new_n75_ | new_n43_ | (~x05 & ~x13 & x15);
  assign new_n74_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n75_ = (x06 | x12) & (~x13 | ~x18 | ~x24);
endmodule
