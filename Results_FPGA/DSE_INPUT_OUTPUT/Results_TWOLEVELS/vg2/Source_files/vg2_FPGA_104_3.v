...
module FAU ( 
  ...
  assign z5 = (~new_n85_ & x05) | ~new_n84_ | new_n40_ | (~x05 & ~x13 & x19);
  assign new_n84_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n85_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n87_ & (new_n89_ | x03)) | new_n38_ | (~new_n88_ & (new_n90_ | ~x03));
  assign new_n87_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n40_ & (x05 | x13 | ~x19);
