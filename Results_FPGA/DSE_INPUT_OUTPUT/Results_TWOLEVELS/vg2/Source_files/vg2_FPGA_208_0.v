...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n76_ | x08)) | new_n39_ | (~new_n61_ & (new_n77_ | ~x08));
  ...
  assign z6 = ~new_n86_ | (~x24 & (new_n82_ | (~x02 & new_n88_ & ~x10)));
  assign new_n82_ = x05 & ~new_n83_ & x13;
  assign new_n83_ = (new_n84_ | ~x15) & (new_n85_ | ~x19);
  assign new_n84_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n85_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n86_ = (~x24 | new_n87_ | (~x13 & (~x05 | ~x12))) & (x05 | ~x12 | new_n83_ | x13);
  assign new_n87_ = (new_n85_ | ~x07) & (new_n84_ | ~x18);
  assign new_n88_ = ~new_n39_ & ((~new_n85_ & x00) | (~new_n84_ & x21));
  assign z7 = ~new_n91_ | (~x24 & (new_n90_ | (x05 & x13 & x15)));
  assign new_n90_ = ~x02 & ~x10 & ~new_n39_ & x21;
  assign new_n91_ = (~x13 | ~x18 | ~x24) & (~x12 | (x05 ? (~x18 | ~x24) : (x13 | ~x15)));
endmodule
