...
module FAU ( 
  ...
  assign z2 = (~x06 & ~x22) | (x01 & x03 & new_n45_ & x06);
  ...
  assign new_n61_ = ((~x06 & ~x22) | (~x08 & (~x09 | x16))) & (~x06 | x16 | new_n62_ | x22);
  assign new_n62_ = ~x17 & (~x04 | x23);
  assign new_n63_ = (~x16 | new_n64_ | ~x22) & ((~x06 & ~x22) | (x08 & (x09 | ~x16)));
  ...
  assign z6 = (~new_n37_ & (new_n69_ | x03)) | new_n55_ | (~new_n42_ & (new_n70_ | ~x03));
