...
module FAU ( 
  ...
  assign new_n63_ = x06 & x11 & x14 & ~new_n64_ & x20;
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n65_ & (x05 | x13 | ~x15);
  assign new_n65_ = ~x10 & x21 & ~x24;
  assign z3 = (~new_n76_ & (x05 ? (x13 & ~x24) : ~x13)) | ~new_n71_ | (x24 & ~new_n67_ & (x05 | x13));
  ...
  assign new_n71_ = (~x01 | (~new_n72_ & ~x02)) & (~new_n75_ | ~x00 | x01 | ~new_n74_ | x02);
  assign new_n72_ = new_n73_ & x03 & x06 & x08 & ~x10;
  assign new_n73_ = x11 & x14 & x20 & x21 & ~x24;
  assign new_n74_ = ~x03 & ~x06;
  ...
  assign z5 = new_n38_ | (~new_n81_ & (~x01 | ~x02));
  assign new_n81_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n84_ | (~new_n83_ & (~x01 | ~x02));
  ...
  assign z6 = new_n88_ | new_n89_ | (x01 & x02);
  assign new_n88_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n89_ = ~new_n90_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n90_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n84_ & (x05 | x13 | ~x15);
endmodule
