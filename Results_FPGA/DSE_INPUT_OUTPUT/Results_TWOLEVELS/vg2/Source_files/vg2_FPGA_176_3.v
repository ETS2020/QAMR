...
module FAU ( 
  ...
  assign new_n39_ = x02 & x16;
  assign z1 = new_n41_ | new_n57_ | new_n39_ | (x24 & ~new_n50_ & ~new_n62_);
  ...
  assign new_n60_ = new_n61_ & ~x02 & ~x03 & x00 & ~x01;
  ...
  assign z3 = (~x02 & (new_n68_ | new_n72_ | (new_n78_ & ~x10))) | (~x16 & (new_n68_ | new_n72_));
  assign new_n68_ = ~new_n69_ & (x05 ? (x13 & ~x24) : ~x13);
  ...
  assign new_n72_ = x24 & ~new_n73_ & ~new_n62_;
  assign new_n73_ = (~new_n76_ | ~new_n77_) & (~new_n74_ | ~new_n75_ | ~x18 | ~x20);
  assign new_n74_ = x01 & x03 & x06 & x08;
  assign new_n75_ = x11 & x14;
  assign new_n76_ = ~x01 & ~x03 & ~x06 & x07;
  assign new_n77_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n78_ = ~x24 & (new_n79_ | (new_n74_ & new_n75_ & x20 & x21));
  assign new_n79_ = new_n77_ & ~x03 & ~x06 & x00 & ~x01;
  assign z4 = (~new_n37_ & (x08 | (~new_n85_ & ~x16))) | (~new_n81_ & x16) | (~new_n65_ & ~x08);
  assign new_n81_ = ~x02 & (new_n82_ | new_n84_);
  assign new_n82_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n83_ & (x05 | x13 | ~x15);
  assign new_n83_ = ~x10 & x21 & ~x24;
  ...
  assign z6 = (~new_n37_ & (new_n90_ | x03)) | new_n39_ | (~new_n65_ & (new_n91_ | ~x03));
  ...
  assign new_n93_ = ~new_n39_ & ~new_n66_;
endmodule
