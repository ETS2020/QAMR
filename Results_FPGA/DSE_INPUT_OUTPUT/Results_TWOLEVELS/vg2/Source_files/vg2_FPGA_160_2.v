...
module FAU ( 
  ...
  assign z4 = (~new_n73_ & (x08 | (~new_n76_ & ~x16))) | (~new_n75_ & (~x08 | (~new_n77_ & x16)));
  assign new_n73_ = (~x00 | x01 | x02 | x10 | x24) & (new_n74_ | (x01 & ~x02));
  ...
  assign z5 = ~new_n74_ | (~x02 & (x01 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n73_ & (x03 | (~new_n80_ & ~x11))) | (~new_n75_ & (~x03 | (~new_n81_ & x11)));
