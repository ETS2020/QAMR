...
module FAU ( 
  ...
  assign z7 = new_n66_ | (x13 & x18 & x24) | (~new_n67_ & x21);
  ...
  assign new_n69_ = ~x11 & ~x14 & ~x20 & (new_n70_ | ~new_n72_);
  assign new_n70_ = ~x24 & (new_n71_ | (x05 & x13 & x19));
  assign new_n71_ = x00 & ~x02 & ~new_n39_ & ~x10;
  assign new_n72_ = (~x07 | ~x24 | (~x13 & (~x05 | ~x21))) & (~x19 | ~x21 | x05 | x13);
  ...
  assign z5 = (~new_n80_ & x05) | ~new_n79_ | (~x13 & (~x21 | (~x05 & x19)));
  assign new_n79_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n80_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (new_n82_ | x03)) | new_n39_ | (~new_n74_ & (new_n83_ | ~x03));
