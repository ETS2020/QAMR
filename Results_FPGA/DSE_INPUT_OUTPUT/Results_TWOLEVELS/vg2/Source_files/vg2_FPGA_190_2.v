...
module FAU ( 
  ...
  assign z3 = (~new_n68_ & ~x02) | (~new_n77_ & x18);
  assign new_n68_ = (new_n69_ | new_n76_) & ~new_n74_ & (x01 | ~new_n72_ | x03);
  ...
  assign new_n74_ = new_n75_ & x06 & x08 & ~x10 & x01 & x03;
  assign new_n75_ = x11 & x14 & x20 & x21 & ~x24;
  assign new_n76_ = x05 ? (~x13 | x24) : x13;
  assign new_n77_ = (x05 | new_n69_ | x13) & (~x24 | new_n78_ | (~x05 & ~x13)) & (~x05 | new_n81_ | ~x13);
  assign new_n78_ = (~new_n80_ | x08 | x11 | x14 | x20) & (~new_n79_ | ~x14 | ~x20 | ~x08 | ~x11);
  assign new_n79_ = x01 & x03 & x06;
  assign new_n80_ = ~x01 & ~x03 & ~x06 & x07;
  assign new_n81_ = (~new_n82_ | x01 | x03 | x06 | x08) & (~new_n70_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n82_ = ~x11 & ~x14 & x19 & ~x20 & ~x24;
  ...
  assign z5 = new_n38_ | (~new_n39_ & ~new_n87_);
  assign new_n87_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = new_n89_ | (new_n94_ & ~x02) | (~new_n91_ & x18);
  assign new_n89_ = ~new_n90_ & ((~new_n73_ & ~x02) | (x19 & ~new_n76_ & (~x02 | x18)));
  assign new_n90_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n91_ = (~x24 | new_n92_ | (~x05 & ~x13)) & (~x15 | new_n93_ | (~x05 ^ ~x13));
  assign new_n92_ = x03 & ~x07 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n93_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n94_ = ~new_n93_ & ((~new_n76_ & x15) | (~x10 & x21 & ~x24));
  assign z7 = new_n96_ | new_n66_ | (x18 & x24 & (x05 | x13));
  assign new_n96_ = x15 & ((~x02 & (x05 ? (x13 & ~x24) : ~x13)) | (x18 & (x05 ^ ~x13)));
endmodule
