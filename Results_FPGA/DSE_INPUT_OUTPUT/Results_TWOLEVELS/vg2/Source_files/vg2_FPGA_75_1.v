...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n81_, new_n82_, new_n85_, new_n86_, new_n89_, new_n90_;
  ...
  assign new_n63_ = ~x10 & (~new_n64_ | ~x21 | x24 | ~x14 | ~x20);
  assign new_n64_ = x01 & x03 & x06 & x11;
  assign new_n65_ = x03 & x06 & x11 & x14 & ~new_n66_ & x20;
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = new_n82_ | (~x10 & (~new_n73_ | (~new_n68_ & ~x24)));
  assign new_n68_ = x01 ? (~x03 | ~x06 | ~new_n69_ | ~x08) : (x03 | x06 | ~new_n71_ | x08);
  assign new_n69_ = x11 & new_n70_ & x14;
  assign new_n70_ = x20 & ((x05 & x13 & x15) | (~x02 & x21));
  assign new_n71_ = ~x11 & new_n72_ & ~x14;
  assign new_n72_ = ~x20 & ((x00 & ~x02) | (x05 & x13 & x19));
  assign new_n73_ = ~new_n74_ & (x05 | new_n79_ | x13);
  assign new_n74_ = x24 & ~new_n61_ & ((new_n75_ & new_n76_) | (new_n77_ & new_n78_));
  ...
  assign z4 = (~new_n37_ & (x08 | (~new_n85_ & ~x16))) | (z7 & (~x08 | (~new_n86_ & x16)));
  ...
  assign z6 = (~new_n37_ & (x03 | (~new_n89_ & ~x11))) | (z7 & (~x03 | (~new_n90_ & x11)));
