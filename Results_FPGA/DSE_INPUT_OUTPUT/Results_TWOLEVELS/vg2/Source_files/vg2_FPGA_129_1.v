...
module FAU ( 
  ...
  assign z4 = ~new_n74_ & ((~new_n37_ & (new_n78_ | x08)) | (~new_n63_ & (new_n79_ | ~x08)));
  ...
  assign new_n83_ = ~new_n63_ & (x06 ? (x14 & ~x20) : ~x12);
