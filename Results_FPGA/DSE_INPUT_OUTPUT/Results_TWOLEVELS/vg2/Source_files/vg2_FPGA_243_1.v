...
module FAU ( 
  ...
  assign z6 = (~new_n86_ & x24) | new_n91_ | (~x02 & ~x10 & ~new_n94_ & ~x24);
  assign new_n86_ = (new_n87_ | new_n90_) & (~x15 | ~x18 | x03 | ~x06);
  assign new_n87_ = (new_n89_ | ~x18) & (~x07 | (~new_n88_ & (new_n81_ | ~x03)));
  assign new_n88_ = ~x11 & (x06 | (~x14 & ~x15 & x20));
  assign new_n89_ = (x03 | x15) & (~x11 | (x06 ? (~x14 | x20) : x15));
  assign new_n90_ = ~x05 & ~x13;
  assign new_n91_ = (x05 ? (x13 & ~x24) : ~x13) & (new_n93_ | (~new_n92_ & x19));
  assign new_n92_ = (~x06 | (x11 & ~x15)) & (x15 | (~x03 & (x11 | x14 | ~x20)));
  assign new_n93_ = x06 & x15 & (~x03 | (x11 & x14 & ~x20));
  assign new_n94_ = (new_n81_ | (x03 ? ~x00 : ~x21)) & ~new_n95_ & (~new_n88_ | ~x00);
  assign new_n95_ = x11 & x21 & (x06 ? (x14 & ~x20) : ~x15);
  assign z7 = (~new_n97_ & ~x24) | (x06 & x15 & (new_n90_ | (x18 & x24))) | (~x15 & x18 & ~new_n90_ & x24);
  assign new_n97_ = ~new_n98_ & (x02 | x10 | new_n81_ | ~x21);
  assign new_n98_ = x13 & x15 & x05 & x06;
endmodule
