...
module FAU ( 
  ...
  assign z1 = (~x02 & (new_n39_ | ~x06)) | new_n43_ | new_n52_;
  assign new_n39_ = new_n40_ & new_n42_ & x01 & x03 & x04 & x08;
  ...
  assign new_n52_ = x24 & (new_n55_ | (new_n44_ & new_n53_)) & (x05 | x13);
  ...
  assign new_n65_ = x06 & (~new_n66_ | ~x01 | ~x03 | ~x08 | x10);
  ...
  assign z4 = (~new_n75_ & (x08 | (~new_n78_ & ~x16))) | (~new_n76_ & (~x08 | (~new_n79_ & x16)));
  assign new_n75_ = (new_n37_ | (~x02 & ~x06)) & (~x00 | x02 | ~x06 | x10 | x24);
  assign new_n76_ = (new_n77_ | (~x02 & ~x06)) & (x02 | ~x06 | x10 | ~x21 | x24);
  ...
  assign z5 = ~new_n37_ | (~x02 & (~x06 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n85_ & x02) | (~new_n82_ & x06);
  assign new_n82_ = (new_n83_ | (~x03 & x11)) & (new_n61_ | (x03 & (~x11 | ~x14 | x20)));
  assign new_n83_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n84_ & (x05 | x13 | ~x19);
  assign new_n84_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n85_ = (new_n37_ | (~x03 & (~new_n86_ | x11))) & (new_n77_ | (x03 & (x06 | ~x11)));
  assign new_n86_ = ~x14 & x20;
  assign z7 = ~new_n77_ | (~x02 & (~x06 | (~x10 & x21 & ~x24)));
endmodule
