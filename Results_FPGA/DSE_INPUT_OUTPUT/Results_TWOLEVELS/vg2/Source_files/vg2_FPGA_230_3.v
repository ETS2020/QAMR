...
module FAU ( 
  ...
  assign z7 = new_n66_ | (~new_n65_ & (~x02 | ~x12));
  ...
  assign z4 = ((new_n82_ | new_n38_) & (new_n84_ | x08)) | (z7 & (new_n85_ | ~x08));
  assign new_n82_ = ~new_n83_ & (~x02 | ~x12);
  ...
  assign z6 = new_n90_ | new_n91_ | (x02 & x12);
  assign new_n90_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n91_ = ~new_n92_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n92_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n66_ & (x05 | x13 | ~x15);
endmodule
