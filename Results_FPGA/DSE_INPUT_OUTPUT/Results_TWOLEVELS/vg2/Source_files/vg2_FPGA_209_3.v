...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n56_ | new_n59_ | (new_n49_ & x24);
  ...
  assign new_n65_ = new_n66_ & x01 & x03 & x06 & x08;
  assign new_n66_ = x11 & x14 & x18 & x20 & ~x21;
  ...
  assign new_n70_ = x11 & x14 & x15 & x20 & ~x21;
  assign new_n71_ = new_n72_ & ~x02 & ~x03 & ~x06 & x00 & ~x01;
  assign new_n72_ = ~x14 & ~x20 & ~x24 & ~x08 & ~x10 & ~x11;
  assign z4 = (~new_n37_ & (new_n76_ | x08)) | new_n59_ | (~new_n74_ & (new_n77_ | ~x08));
  ...
  assign z5 = ~new_n37_ & (~x03 | (x03 & ~x21));
  assign z6 = ~new_n80_ | (~x11 & ~new_n85_ & (x06 | (~x14 & x20)));
  assign new_n80_ = (x24 | (~new_n84_ & (~x05 | new_n81_ | ~x13))) & (x05 | new_n81_ | x13) & (~x24 | new_n83_ | (~x05 & ~x13));
  assign new_n81_ = (new_n82_ | ~x15) & (~x03 | ~x19 | x21);
  assign new_n82_ = x03 & (~x11 | x21 | (x06 & (~x14 | x20)));
  assign new_n83_ = (~x03 | ~x07 | x21) & (new_n82_ | ~x18);
  assign new_n84_ = ~x02 & ~x10 & ((~x03 & x21) | (x00 & x03 & ~x21));
  assign new_n85_ = ~new_n86_ & (x10 | x21 | x24 | ~x00 | x02);
  assign new_n86_ = ~x03 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
  assign z7 = (~new_n62_ & (~x03 | ~x21)) | (~x02 & ~x03 & ~x10 & x21 & ~x24);
endmodule
