...
module FAU ( 
  ...
  assign z4 = (~new_n79_ & (new_n81_ | x08)) | new_n83_ | (~new_n64_ & (new_n82_ | ~x08));
  ...
  assign z5 = new_n80_ | (~new_n83_ & ~new_n85_);
  assign new_n85_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = new_n87_ | new_n88_ | (~x06 & (x02 | (~new_n89_ & x11)));
  assign new_n87_ = ~new_n79_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n88_ = ~new_n64_ & (~x03 | (x11 & x14 & ~x20));
  assign new_n89_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n90_ & (x05 | x13 | ~x15);
  assign new_n90_ = ~x10 & x21 & ~x24;
  assign z7 = new_n65_ | (~new_n83_ & ~new_n92_);
