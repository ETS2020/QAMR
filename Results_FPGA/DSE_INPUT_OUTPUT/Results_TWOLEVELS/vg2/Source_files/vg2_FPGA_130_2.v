...
module FAU ( 
  ...
  assign z3 = (~x02 & (new_n68_ | new_n72_ | (new_n78_ & ~x10))) | (x12 & (new_n68_ | new_n72_));
  ...
  assign new_n72_ = x24 & ~new_n73_ & ~new_n61_;
  ...
  assign z6 = new_n88_ | (~new_n89_ & (new_n38_ | (~new_n39_ & ~new_n90_)));
  assign new_n88_ = ~new_n64_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  ...
  assign new_n92_ = ~new_n66_ & (x05 | x13 | ~x15) & ~new_n39_ & (~new_n93_ | ~x13);
