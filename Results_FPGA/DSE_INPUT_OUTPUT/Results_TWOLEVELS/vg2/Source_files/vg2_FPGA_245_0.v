...
module FAU ( 
  ...
  assign z4 = (~new_n74_ & (x08 | (~new_n77_ & ~x16))) | (~new_n75_ & (~x08 | (~new_n78_ & x16)));
  assign new_n74_ = (new_n37_ | (~x01 & ~x02)) & (~x00 | ~x01 | x02 | x10 | x24);
  assign new_n75_ = (new_n76_ | (~x01 & ~x02)) & (~x01 | x02 | x10 | ~x21 | x24);
  ...
  assign z6 = (~new_n74_ & (x03 | (~new_n81_ & ~x11))) | (~new_n75_ & (~x03 | (~new_n82_ & x11)));
  assign new_n81_ = ~x06 & (x14 | ~x20);
  assign new_n82_ = x06 & (~x14 | x20);
  assign z7 = ~new_n76_ | (~x02 & (~x01 | (~x10 & x21 & ~x24)));
endmodule
