...
module FAU ( 
  ...
  assign z5 = (~x24 & (new_n38_ | (x05 & x13 & x19))) | (~x05 & ~x13 & x19) | (x07 & x13 & x24);
  ...
  assign new_n50_ = x22 & x23 & (x13 ? (x18 & x24) : x15);
  ...
  assign z7 = (~x24 & (new_n57_ | (x05 & x13 & x15))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  ...
  assign new_n64_ = x11 & x14 & x20 & x21;
  ...
  assign new_n69_ = (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n70_ = ~x08 & ~x11 & ~x14 & ~new_n71_ & ~x20;
  assign new_n71_ = (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  ...
  assign new_n77_ = (~x19 | (x13 & (~x05 | x24))) & ~new_n78_ & (~x07 | ~x13 | ~x24);
  assign new_n78_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n79_ = (~x05 | x13) & (new_n80_ | (new_n81_ & (~x15 | (x13 & (~x05 | x24)))));
  assign new_n80_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n81_ = (~x13 | ~x18 | ~x24) & (~x21 | x24 | x02 | x10);
endmodule
