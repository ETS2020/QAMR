...
module FAU ( 
  ...
  assign new_n73_ = new_n74_ & x08 & ~x10 & x03 & x06;
  assign new_n74_ = x20 & x21 & ~x24 & x11 & x14;
  ...
  assign z5 = new_n39_ | ~new_n37_ | ~new_n88_;
  assign new_n88_ = (~x01 | ~x02) & (~x07 | ~x13 | ~x24);
  assign z6 = (~new_n81_ & (x03 | (~new_n90_ & ~x11))) | (z7 & (~x03 | (~new_n91_ & x11)));
