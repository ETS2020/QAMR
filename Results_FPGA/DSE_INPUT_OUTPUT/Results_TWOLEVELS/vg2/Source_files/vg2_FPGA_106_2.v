...
module FAU ( 
  ...
  assign z0 = new_n41_ | (~x01 & ~x03 & ~x06 & new_n36_ & ~x11);
  ...
  assign new_n41_ = x02 & ~x21;
  assign z1 = (~new_n43_ & ~x24) | ~new_n59_ | (x24 & ~new_n50_ & (x05 | x13));
  ...
  assign new_n70_ = (~x24 | new_n71_ | (~x05 & ~x13)) & ~new_n41_ & (x05 | new_n75_ | x13);
  ...
  assign z4 = ~new_n81_ | (~x16 & ~new_n88_ & (~new_n87_ | new_n37_));
  assign new_n81_ = (~x24 | new_n85_ | (~x05 & ~x13)) & new_n82_ & (new_n86_ | (x05 ? (~x13 | x24) : x13));
  assign new_n82_ = x02 ? x21 : ~new_n83_;
  assign new_n83_ = ~x10 & ~x24 & ((x00 & x08) | (x21 & (new_n84_ | ~x08)));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n85_ = (~x07 | ~x08) & (~x18 | (~new_n84_ & x08));
  assign new_n86_ = (~x15 | (~new_n84_ & x08)) & (~x08 | ~x19);
  assign new_n87_ = ~new_n38_ & ~new_n40_ & (x21 | x24 | ~x00 | x10);
  assign new_n88_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign z5 = new_n37_ | new_n40_ | new_n41_ | new_n38_ | new_n39_;
  assign z6 = new_n91_ | (~new_n95_ & (new_n39_ | (~new_n94_ & ~new_n41_)));
  assign new_n91_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = new_n68_ | (~new_n41_ & ~new_n93_);
  assign new_n93_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
  assign new_n94_ = ~new_n37_ & ~new_n38_ & ~new_n40_;
