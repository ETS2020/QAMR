...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (new_n86_ | x08)) | new_n85_ | (~new_n83_ & (new_n87_ | ~x08));
  ...
  assign z5 = new_n38_ | (~new_n85_ & ~new_n89_);
  assign new_n89_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z6 = new_n91_ | (~new_n92_ & (new_n84_ | (~new_n85_ & ~new_n93_)));
  assign new_n91_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n92_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n93_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (x05 | x13 | ~x15) & (~x13 | ~x18 | ~x24);
  assign z7 = new_n68_ | ~new_n95_ | new_n67_ | new_n84_;
  assign new_n95_ = ~new_n85_ & (~x13 | ~x18 | ~x24);
endmodule
