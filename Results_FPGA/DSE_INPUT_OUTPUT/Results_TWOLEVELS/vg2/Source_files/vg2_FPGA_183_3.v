...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n49_ | new_n60_ | (x01 & (new_n56_ | x02));
  ...
  assign new_n56_ = new_n57_ & new_n59_ & x14 & x16 & x17 & x20;
  assign new_n57_ = new_n58_ & x03 & x04 & x06 & x08;
  assign new_n58_ = x09 & ~x10 & x11 & x12;
  assign new_n59_ = x21 & x22 & x23 & ~x24;
  assign new_n60_ = new_n61_ & new_n62_ & ~x02 & ~x03 & x00 & ~x01;
  assign new_n61_ = new_n54_ & ~x22 & ~x23 & ~x24 & ~x17 & ~x20;
  ...
  assign new_n76_ = ~x14 & ~x20 & ~x24 & ~x08 & ~x10 & ~x11;
  ...
  assign z5 = new_n38_ | (~new_n82_ & (~x01 | ~x02));
  assign new_n82_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n85_ | (~new_n84_ & (~x01 | ~x02));
  ...
  assign z6 = new_n89_ | new_n90_ | (x01 & x02);
  assign new_n89_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n90_ = ~new_n91_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n91_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n85_ & (x05 | x13 | ~x15);
endmodule
