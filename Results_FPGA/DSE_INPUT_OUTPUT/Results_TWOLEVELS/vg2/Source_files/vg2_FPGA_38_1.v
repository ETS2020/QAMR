...
module FAU ( 
  ...
  assign new_n69_ = (new_n71_ | ~x05) & (new_n70_ | ~x13) & (x05 | x13 | ~x15 | x21);
  assign new_n70_ = ~new_n66_ & (~x18 | ~x24);
  assign new_n71_ = (~x13 | ~x15 | x24) & (~x18 | x21 | ~x24);
  assign z4 = (~new_n73_ & (new_n77_ | x08)) | new_n79_ | (~new_n69_ & (new_n78_ | ~x08));
  assign new_n73_ = ~new_n76_ & ~new_n74_ & (~x07 | ~x13 | ~x24);
  assign new_n74_ = ~x21 & (new_n75_ | (~x05 & ~x13 & x19));
  assign new_n75_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n76_ = x05 & ((x13 & x19 & ~x24) | (x07 & ~x21 & x24));
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = x00 & ~x02 & ~x10 & x13 & x21 & ~x24;
  assign z5 = ~new_n39_ | (~x24 & (new_n81_ | (x05 & x13 & x19)));
  assign new_n81_ = x00 & ~x02 & ~x10 & (~x21 | (x13 & x21));
  assign z6 = new_n83_ | new_n85_ | (~x13 & x21);
  assign new_n83_ = ~new_n84_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n84_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & ~new_n75_ & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n85_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = (~new_n88_ & x05) | ~new_n87_ | (~x13 & (x21 | (~x05 & x15)));
  assign new_n87_ = ~new_n66_ & (~x13 | ~x18 | ~x24);
