...
module FAU ( 
  ...
  assign new_n65_ = ~new_n67_ & (new_n39_ | new_n66_);
  ...
  assign new_n78_ = (~x05 | ~x13 | ~x15) & (x02 | x10 | ~x21);
  assign new_n79_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n47_ & ~x20;
  assign z4 = new_n88_ | ~new_n81_ | (~new_n90_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n81_ = (~new_n82_ | ~x24) & ~new_n39_ & (x02 | x10 | new_n86_ | x24);
  assign new_n82_ = (x05 | x13) & (new_n85_ | (~new_n83_ & x07));
  assign new_n83_ = ~new_n84_ & ~x08;
  assign new_n84_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n85_ = ~x04 & x16 & new_n56_ & x18;
  assign new_n86_ = (~x00 | (~x08 & (new_n87_ | x16))) & (~new_n56_ | x04 | ~x16);
  assign new_n87_ = ~x09 & (x22 | (~x04 & ~x17));
  assign new_n88_ = ~new_n89_ & (~x08 | (x16 & (~x09 | (~x17 & x22))));
  assign new_n89_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n67_ & (x05 | x13 | ~x15);
  assign new_n90_ = (new_n83_ | ~x19) & (x04 | ~x15 | ~new_n56_ | ~x16);
  ...
  assign z6 = ~new_n95_ | (~new_n97_ & (new_n99_ | (~new_n39_ & ~new_n98_)));
  assign new_n95_ = ~new_n96_ & (~x00 | x02 | x10 | ~x21 | x24);
  assign new_n96_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n97_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n98_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n99_ = x00 & ~x02 & ~x10 & ~x23 & ~x24;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | ~new_n101_ | (x13 & x18 & x24) | (~x05 & ~x13 & x15);
  assign new_n101_ = ~new_n39_ & ~new_n67_;
endmodule
