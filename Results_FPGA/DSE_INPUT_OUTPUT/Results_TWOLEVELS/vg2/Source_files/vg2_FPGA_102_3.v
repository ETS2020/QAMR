...
module FAU ( 
  ...
  assign new_n65_ = x20 & (x05 ? new_n69_ : (~new_n66_ | (~x13 & x15)));
  assign new_n66_ = ~new_n68_ & (~new_n67_ | ~x13);
  assign new_n67_ = x18 & x24;
  assign new_n68_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n69_ = ~x21 & ((x18 & x24) | (x13 & x15 & ~x24));
  ...
  assign z4 = (~new_n37_ & (new_n83_ | x08)) | new_n39_ | (~new_n82_ & (new_n84_ | ~x08));
  ...
  assign new_n86_ = ~x24 & (new_n87_ | (x00 & ~x02 & ~new_n39_ & ~x10));
  assign new_n87_ = x05 & x13 & x19 & ~x21;
  assign new_n88_ = (x05 | ((x13 | ~x19) & (~x07 | ~x13 | ~x24))) & (~x05 | ~x07 | x21 | ~x24);
  ...
  assign z7 = ~new_n93_ | (x13 & ((x18 & x24) | (x05 & x15 & ~x24)));
  assign new_n93_ = ~new_n68_ & (x05 | x13 | ~x15) & (~x05 | (~new_n67_ & ~x21));
endmodule
