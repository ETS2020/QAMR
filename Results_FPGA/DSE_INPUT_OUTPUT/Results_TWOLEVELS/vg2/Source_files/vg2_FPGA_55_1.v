...
module FAU ( 
  ...
  assign z4 = (~new_n52_ & (new_n55_ | x08)) | new_n57_ | (~new_n45_ & (new_n56_ | ~x08));
  assign new_n52_ = ~new_n53_ & (x21 | (new_n54_ & (x05 | x13 | ~x19)));
  assign new_n53_ = x05 & ((x07 & x24) | (x13 & x19 & ~x24));
  assign new_n54_ = (~x07 | ~x13 | ~x24) & (~x00 | x02 | x10 | x24);
  assign new_n55_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n56_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n57_ = x00 & ~x02 & x05 & ~x10 & x21 & ~x24;
  assign z5 = new_n53_ | ~new_n54_ | (~x05 & (x21 | (~x13 & x19)));
  assign z6 = (~new_n52_ & (new_n60_ | x03)) | new_n57_ | (~new_n45_ & (new_n61_ | ~x03));
  assign new_n60_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n61_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n64_ | (~x05 & (x21 | (~x13 & x15))) | (~new_n63_ & x05);
  assign new_n63_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n64_ = (~x21 | x24 | x02 | x10) & (~x13 | ~x18 | ~x24);
endmodule
