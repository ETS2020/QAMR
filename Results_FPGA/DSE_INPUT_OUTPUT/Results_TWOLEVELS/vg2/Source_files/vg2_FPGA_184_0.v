...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n82_, new_n83_, new_n84_, new_n87_, new_n88_;
  ...
  assign z1 = (~x02 & (new_n41_ | ~x12)) | new_n45_ | new_n54_;
  assign new_n41_ = new_n42_ & new_n44_ & x01 & x03 & x04 & x06;
  assign new_n42_ = new_n43_ & x14 & x16 & x17 & x20;
  assign new_n43_ = x21 & x22 & x23 & ~x24;
  assign new_n44_ = ~x10 & x11 & x08 & x09;
  assign new_n45_ = (new_n50_ | (new_n46_ & new_n48_)) & (x05 ? (x13 & ~x24) : ~x13);
  ...
  assign new_n54_ = x24 & (new_n57_ | (new_n46_ & new_n55_)) & (x05 | x13);
  ...
  assign z2 = (~x02 & (new_n62_ | ~x12)) | (new_n64_ & x01);
  assign new_n62_ = new_n63_ & x06 & ~x10 & x01 & x03;
  ...
  assign new_n73_ = x20 & x21 & x11 & x14;
  ...
  assign z4 = (~new_n78_ & (new_n82_ | x08)) | new_n84_ | (~new_n80_ & (new_n83_ | ~x08));
