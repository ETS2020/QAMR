// Benchmark "FAU" written by ABC on Mon Aug 24 18:14:30 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n75_, new_n76_, new_n77_, new_n78_, new_n81_, new_n82_;
  ...
  assign new_n44_ = new_n45_ & new_n47_ & ~x22 & ~x23 & x19 & ~x20;
  assign new_n45_ = ~x01 & ~x03 & ~x04 & new_n46_ & ~x09 & ~x11;
  assign new_n46_ = ~x06 & ~x08;
  assign new_n47_ = ~x12 & ~x14 & ~x16 & ~x17;
  assign new_n48_ = ~new_n55_ & (~x24 | new_n59_ | (~new_n51_ & (~new_n41_ | ~new_n49_)));
  ...
  assign new_n55_ = new_n56_ & new_n57_ & new_n53_ & new_n58_;
  assign new_n56_ = x00 & ~x01 & ~x02 & ~x03;
  assign new_n57_ = ~x04 & ~x06 & ~x08 & ~x09 & ~x10;
  assign new_n58_ = ~x17 & ~x20 & ~x22 & ~x23 & ~x24;
  ...
  assign z3 = new_n68_ | (~new_n70_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n64_ & (x05 | x13));
  ...
  assign new_n68_ = ~x02 & (x01 | (new_n69_ & new_n46_ & x00 & ~x03));
  assign new_n69_ = ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  ...
  assign z4 = (~new_n74_ & (x08 | (~new_n77_ & ~x16))) | (~new_n76_ & (~x08 | (~new_n78_ & x16)));
  assign new_n74_ = (new_n75_ | (x01 & ~x02)) & (x02 | x10 | x24 | ~x00 | x01);
  assign new_n75_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n76_ = (new_n62_ | (x01 & ~x02)) & (x01 | x02 | x10 | ~x21 | x24);
  assign new_n77_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n78_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n75_ | (~x02 & (x01 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n74_ & (x03 | (~new_n81_ & ~x11))) | (~new_n76_ & (~x03 | (~new_n82_ & x11)));
