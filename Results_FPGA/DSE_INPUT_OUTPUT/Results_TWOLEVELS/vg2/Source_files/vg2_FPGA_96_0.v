// Benchmark "FAU" written by ABC on Mon Aug 24 18:13:37 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n75_, new_n76_, new_n79_, new_n80_, new_n81_, new_n82_;
  ...
  assign z4 = (~new_n72_ & (x08 | (~new_n75_ & ~x16))) | (~new_n73_ & (~x08 | (~new_n76_ & x16)));
  assign new_n72_ = (new_n37_ | (~x01 & ~x02)) & (~x00 | ~x01 | x02 | x10 | x24);
  assign new_n73_ = (new_n74_ | (~x01 & ~x02)) & (x10 | ~x21 | x24 | ~x01 | x02);
  ...
  assign z6 = new_n79_ | new_n82_ | (~x01 & ~x02);
  assign new_n79_ = ~new_n80_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n80_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n81_ & (x05 | x13 | ~x19);
  assign new_n81_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n82_ = ~new_n60_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n74_ | (~x02 & (~x01 | (~x10 & x21 & ~x24)));
endmodule
