...
module FAU ( 
  ...
  assign new_n36_ = ~x20 & ((~new_n38_ & x19) | (x07 & ~new_n37_ & x24));
  assign new_n37_ = ~x05 & ~x13;
  assign new_n38_ = (~x02 | (x05 ? (~x13 | x24) : x13)) & (x05 | x13 | ~x24);
  assign z1 = (~new_n40_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n49_ & (x05 | x13)) | (~x02 & ~x24);
  ...
  assign z7 = (~new_n38_ & x15) | (x18 & ~new_n37_ & x24);
  assign z3 = (x24 & ((~new_n59_ & (x05 | x13)) | (~x05 & ~new_n63_ & ~x13))) | (x02 & ~new_n63_ & (x05 ? (x13 & ~x24) : ~x13));
  ...
  assign z4 = (~new_n67_ & ~new_n38_) | (x24 & ~new_n72_ & ~new_n37_);
  assign new_n67_ = (new_n70_ | ~x19) & (new_n68_ | ~x15);
  ...
  assign new_n72_ = (new_n70_ | ~x07) & (new_n68_ | ~x18);
  assign z5 = (x05 & ((x13 & x19 & ~x24) | (x07 & x24))) | (x07 & x13 & x24) | (~x02 & ~x24) | (~x05 & ~x13 & x19);
  assign z6 = new_n75_ | new_n77_ | (~x02 & ~x24);
  assign new_n75_ = ~new_n76_ & ((x05 & ((x13 & x19 & ~x24) | (x07 & x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
