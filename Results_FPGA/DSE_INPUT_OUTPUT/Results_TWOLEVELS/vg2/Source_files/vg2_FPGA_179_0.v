...
module FAU ( 
  ...
  assign z4 = ~new_n46_ & ((~new_n37_ & (new_n61_ | x08)) | (~new_n42_ & (new_n62_ | ~x08)));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n62_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n46_;
  assign z6 = (~new_n37_ & (new_n65_ | x03)) | new_n46_ | (~new_n42_ & (new_n66_ | ~x03));
  ...
  assign new_n68_ = ~new_n43_ & ~new_n46_;
endmodule
