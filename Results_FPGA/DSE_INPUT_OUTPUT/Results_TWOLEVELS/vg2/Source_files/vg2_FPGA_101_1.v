...
module FAU ( 
  ...
  assign new_n36_ = ~x22 & (~new_n37_ | ~x00 | x01 | x03 | x06);
  ...
  assign z1 = new_n56_ | (~new_n41_ & (x05 ? (x13 & ~x24) : ~x13)) | (x24 & ~new_n50_ & (x05 | x13));
  ...
  assign new_n50_ = (~new_n42_ | ~new_n51_) & (~new_n46_ | ~new_n54_ | ~new_n53_ | ~new_n55_);
  ...
  assign new_n56_ = ~x02 & (x22 | (new_n57_ & new_n58_ & new_n53_ & new_n59_));
  assign new_n57_ = ~x03 & ~x04 & x00 & ~x01;
  assign new_n58_ = ~x06 & ~x08 & ~x09 & ~x10;
  assign new_n59_ = ~x17 & ~x20 & ~x23 & ~x24;
  assign z2 = (~new_n61_ & ~x02) | (new_n63_ & x01);
  assign new_n61_ = ~x22 & (~new_n62_ | ~x06 | x10 | ~x01 | ~x03);
  ...
  assign z3 = (~x22 & (new_n66_ | new_n71_ | new_n76_)) | (x02 & (new_n71_ | new_n80_));
  ...
  assign z4 = (~new_n93_ & (~x08 | (~x09 & x16))) | ~new_n88_ | (~new_n82_ & ~x16);
  assign new_n82_ = ~new_n86_ & (x24 | (~new_n83_ & (new_n70_ | ~x09)));
  assign new_n83_ = (new_n84_ | new_n85_) & (x17 | (x04 & ~x23));
  assign new_n84_ = x00 & ~x02 & ~x10;
  assign new_n85_ = x05 & x13 & x19 & ~x22;
  assign new_n86_ = ~new_n87_ & ((~x05 & ~x13 & x19) | (x07 & x24 & (x05 | x13)));
  assign new_n87_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n88_ = ~new_n92_ & (~x24 | new_n89_ | (~x05 & ~x13)) & (new_n91_ | (x05 ? (~x13 | x24) : x13));
  assign new_n89_ = (~x07 | ~x08) & (~x16 | ~new_n90_ | ~x18);
  assign new_n90_ = x22 & (~x17 | (~x04 & x23));
  assign new_n91_ = (~x08 | ~x19) & (~x15 | ~new_n90_ | ~x16);
  assign new_n92_ = ~x02 & (x22 | (x00 & x08 & ~x10 & ~x24));
  assign new_n93_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n94_ & (x05 | x13 | ~x15);
  assign new_n94_ = ~x02 & ~x10 & x21 & ~x24;
  assign z5 = ~new_n39_ | (~x02 & (x22 | (x00 & ~x10 & ~x24)));
  assign z6 = (~new_n97_ & (x03 | (~new_n99_ & ~x11))) | (z7 & (~x03 | (~new_n100_ & x11)));
  assign new_n97_ = (new_n39_ | (~x02 & x22)) & (~x00 | x02 | x10 | x22 | x24);
  assign z7 = (~new_n64_ & (x02 | ~x22)) | (~x02 & ~x10 & x21 & ~x22 & ~x24);
