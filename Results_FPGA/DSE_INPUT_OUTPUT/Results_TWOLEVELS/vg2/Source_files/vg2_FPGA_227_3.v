...
module FAU ( 
  ...
  assign z1 = new_n40_ | (new_n50_ & x24) | new_n61_ | (~x10 & ~new_n57_ & ~x24);
  ...
  assign new_n50_ = (x05 | x13) & (new_n53_ | (new_n41_ & new_n51_));
  ...
  assign new_n57_ = (~new_n41_ | ~new_n58_) & (~new_n55_ | ~new_n56_ | ~new_n59_ | ~new_n60_);
  ...
  assign z2 = x11 & (new_n63_ | x02);
  assign new_n63_ = x01 & x03 & x06 & x14 & ~new_n64_ & x20;
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n65_ & (x05 | x13 | ~x15);
  assign new_n65_ = ~x10 & x21 & ~x24;
  assign z3 = new_n67_ | (new_n71_ & x24) | new_n61_ | (~x10 & ~new_n76_ & ~x24);
  assign new_n67_ = ~new_n68_ & ~new_n49_;
  ...
  assign new_n71_ = (x05 | x13) & (new_n72_ | new_n74_);
  ...
  assign new_n76_ = ~new_n77_ & (~new_n73_ | ~x11 | ~x14 | ~x20 | ~x21);
  assign new_n77_ = new_n59_ & ~x06 & ~x08 & ~x11 & ~x14 & ~x20;
  assign z4 = (~new_n37_ & (new_n81_ | x08)) | new_n61_ | (~new_n79_ & (new_n82_ | ~x08));
  ...
  assign z5 = (~new_n85_ & x05) | ~new_n84_ | new_n61_ | (~x05 & ~x13 & x19);
  assign new_n84_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n85_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  assign z6 = (~new_n37_ & (x03 | (~new_n88_ & ~x11))) | (~new_n87_ & x11) | (~new_n79_ & ~x03);
  assign new_n87_ = ~x02 & (new_n64_ | (x06 & (~x14 | x20)));
  assign new_n88_ = ~x06 & (x14 | ~x20);
  assign z7 = ~new_n90_ | (x05 & ((x18 & x24) | (x13 & x15 & ~x24)));
  assign new_n90_ = ~new_n80_ & (x05 | x13 | ~x15) & ~new_n61_ & (~new_n91_ | ~x13);
