...
module FAU ( 
  ...
  assign z7 = new_n68_ | (~new_n38_ & ~new_n67_);
  ...
  assign new_n70_ = (~x24 | new_n71_ | (~x05 & ~x13)) & ~new_n38_ & (x05 | new_n75_ | x13);
  ...
  assign new_n78_ = x06 & x08 & x11 & x14 & ~new_n45_ & x20;
  assign new_n79_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n48_ & ~x20;
  assign z4 = (~new_n81_ & (new_n83_ | x08)) | new_n38_ | (~new_n82_ & (new_n84_ | ~x08));
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n40_ & (x05 | x13 | ~x19);
  assign new_n82_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n68_ & (x05 | x13 | ~x15);
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n81_ & (new_n86_ | x03)) | new_n38_ | (~new_n82_ & (new_n87_ | ~x03));
