...
module FAU ( 
  ...
  assign new_n81_ = (x05 | ((~x01 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n82_ = (~x05 | ((~x01 | ~x17 | x18) & (x08 | x15 | x17 | ~x18))) & (~x01 | x05 | ~x17 | x18);
  ...
  assign z06 = new_n84_ | (~x09 & (new_n102_ | ((new_n94_ | new_n104_) & ~x05)));
  ...
  assign new_n138_ = x08 & new_n139_ & ~x17;
  assign new_n139_ = x18 & ~x21 & (x04 ? (~x12 & ~x15) : (~x11 & x15));
  assign z13 = x01 & ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n148_ & ~x18) | (~x17 & (new_n142_ | (x08 & ~new_n145_ & x18)));
  assign new_n142_ = x01 & ~x05 & new_n143_ & ~x09;
  ...
  assign new_n148_ = x01 & (~x01 | x05 | x09 | ~x17 | (~x07 & (x07 | ~x15)));
  assign z15 = ~new_n150_ & ~x18;
  assign new_n150_ = x01 & (~x01 | ~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign new_n159_ = (new_n160_ | x05) & (~new_n163_ | ~new_n65_ | x04 | ~x05);
  assign new_n160_ = ~new_n104_ & (x07 | ~new_n161_ | x08);
  ...
  assign new_n170_ = x17 & ~x15 & ~x09 & ~x07 & x01 & ~x05;
  ...
  assign new_n177_ = new_n178_ & ~x05 & x12 & x01 & x04;
  ...
  assign new_n199_ = (~x07 | ~x08 | x15 | ~x19) & (x07 | ((x08 | x15 | ~x19) & (~new_n72_ | x04 | ~x08)));
  assign new_n200_ = new_n201_ & new_n65_ & x03 & ~x05;
  assign new_n201_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n203_ & ~x17) | (x01 & ~x09 & new_n213_ & x17);
  ...
  assign new_n209_ = (~x01 | x18 | (x02 & x11)) & (~x08 | ~x18 | ~x19);
