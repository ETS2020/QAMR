...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n61_, new_n62_, new_n63_,
    ...
    new_n98_, new_n99_, new_n102_, new_n103_, new_n105_, new_n107_,
  ...
  assign new_n64_ = ~x15 & x18 & ((x07 & x09) | ~x12 | (~x04 & ~x07 & x12));
  ...
  assign new_n75_ = (x04 | ~x08 | ~x12 | x17 | ~x18) & (x09 | ~x17 | x18);
  assign new_n76_ = ~x18 & (x17 | (x04 & x12 & ~x14 & ~x17 & ~x21));
  assign new_n77_ = x08 & ~x17 & x18 & (~x12 | (x07 & x09));
  assign new_n78_ = new_n79_ & x02 & x08 & ~x11 & x15 & ~x17;
  assign new_n79_ = ~x05 & ~x07;
  assign z10 = x05 ? ((new_n82_ & x07 & x08 & x09) | (new_n81_ & ~x07 & ~x09)) : ((new_n81_ & ~x09) | (new_n82_ & ~x07 & x08 & x09));
  assign new_n81_ = x17 & ~x18;
  assign new_n82_ = ~x15 & ~x17 & x18;
  assign z11 = new_n84_ & ~x18;
  assign new_n84_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (x18 | (new_n70_ & ~x05));
  ...
  assign new_n94_ = x18 & (~x09 | (x05 & x08 & new_n95_ & ~x15));
  assign new_n95_ = ~x17 & ((x07 & ~x19) | (x04 & ~x07 & x09 & ~x12));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x18 & (~x09 | (x08 & ~new_n98_ & ~x17));
  assign new_n98_ = (new_n99_ | x15) & (x05 | ~x15 | (x02 & (~x07 | ~x09)));
  assign new_n99_ = x05 ? (x12 & (~x07 | ~x09)) : (x07 | x19);
  assign z19 = ~x09 & (x18 | (new_n79_ & ~x15 & x17 & ~x18));
  assign z20 = x04 & ~x07 & ~x15 & ~new_n102_ & ~x17;
  assign new_n102_ = (~x05 | ~x08 | ~x09 | x12 | ~x18) & (~new_n103_ | x05 | x09 | ~x12);
  assign new_n103_ = ~x14 & ~x18 & ~x21;
  assign z21 = x18 & new_n105_ & ~x17;
  assign new_n105_ = ~x15 & x09 & x08 & ~x07 & ~x05 & x06;
  assign z22 = new_n107_ & ~x05;
  assign new_n107_ = x08 & x09 & ~x17 & x18 & (x07 ^ ~x15);
  assign z23 = x18 & (~x09 | (new_n67_ & x09 & ~x15 & ~x17));
  assign z24 = ~x09 & (x18 | (~x05 & ~x15 & ~new_n110_ & ~x17));
  assign new_n110_ = (~x01 | ~x07 | ~x08) & (~new_n103_ | ~x04 | x07 | ~x12);
  assign z25 = x18 & ~x17 & ~x15 & x09 & new_n79_ & x08;
  assign z26 = z05 | (~x20 & (x14 | x21));
  assign z27 = z05 | (~new_n114_ & ~x05);
  assign new_n114_ = (x07 | (~new_n115_ & (~x00 | x09 | ~new_n81_ | ~x15))) & (~x07 | x09 | ~new_n81_ | x15);
  assign new_n115_ = ~x17 & x18 & x19 & x03 & x08 & ~x15;
  assign z28 = (~x05 & ~new_n117_ & x15) | z05 | (new_n119_ & x05);
  assign new_n117_ = (new_n118_ | x17) & (x09 | ~x17 | (x19 & (x07 | x18)));
  assign new_n118_ = (x02 | ((~x07 | x09) & (~x08 | ~x18))) & (~x07 | ((x09 | x11) & (~x08 | ~x09 | ~x18))) & (~x02 | x07 | ~x08 | x11 | ~x18);
  assign new_n119_ = ~x07 & ((new_n82_ & new_n120_) | (new_n81_ & ~x09));
