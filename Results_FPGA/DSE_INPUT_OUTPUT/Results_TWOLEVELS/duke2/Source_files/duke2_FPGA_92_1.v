...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n66_, new_n69_,
    new_n71_, new_n73_, new_n74_, new_n78_, new_n79_, new_n81_, new_n82_,
    new_n85_;
  ...
  assign z20 = ~new_n78_ & ~x17;
  assign new_n78_ = ~x18 & (~new_n79_ | x15 | x18 | x21 | ~x12 | x14);
  assign new_n79_ = ~x07 & ~x09 & x04 & ~x05;
