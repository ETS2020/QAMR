...
module FAU ( 
  ...
  assign z09 = (new_n117_ & ~x07) | (x18 & (~new_n119_ | (~new_n105_ & ~x07)));
  assign new_n105_ = ~new_n114_ & (x15 | ((new_n106_ | x09) & (~new_n116_ | x04)));
  assign new_n106_ = ~new_n113_ & (x21 | ((~new_n107_ | ~x04) & (new_n109_ | x05)));
  assign new_n107_ = ~x12 & (new_n108_ | (x13 & ~x14 & x02 & x08));
  assign new_n108_ = ~x08 & ~x17 & ~x05 & ~x06;
  ...
  assign new_n112_ = x13 & ~x14 & ~x17 & (x10 ? x12 : ~x06);
  assign new_n113_ = ~x17 & ~x19 & x05 & ~x08;
  assign new_n114_ = x08 & (new_n115_ | (~x17 & x21 & x05 & ~x09));
  assign new_n115_ = x02 & ~x05 & ~x11 & x15 & (x09 | ~x21);
  assign new_n116_ = x05 & x08 & x12 & ~x17 & (x09 | ~x21);
  assign new_n117_ = ~x09 & ~x15 & ~new_n118_ & ~x18;
  assign new_n118_ = x05 ? ~x17 : (~x17 & (~x04 | ~x12 | x14 | x17 | x21));
  assign new_n119_ = ~x17 & (~x05 | ~x08 | x15 | x17 | (~x07 & x12));
  ...
  assign z18 = x18 & (x17 | (~x05 & ~x07 & ~x09 & ~new_n158_ & ~x17));
  ...
  assign new_n174_ = ~x07 & ((~x05 & ((x09 & ~x15 & x06 & x08) | (~x09 & x15 & ~x06 & ~x08))) | (~x08 & ~x09 & ~x15 & x05 & x06));
  ...
  assign z24 = (x17 & x18) | (~x09 & (new_n181_ | (new_n125_ & new_n185_ & ~x17 & ~x18)));
  assign new_n181_ = ~x07 & (new_n182_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n182_ = ~x17 & ~x21 & ((new_n183_ & x04) | (new_n184_ & x08));
  assign new_n183_ = ~x15 & ((~x12 & x18 & x05 & x08) | (~x05 & x12 & ~x14 & ~x18));
  assign new_n184_ = x15 & x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  ...
  assign new_n191_ = ~x17 & (new_n193_ | (~x21 & (new_n192_ | (~new_n132_ & ~x04))));
  ...
  assign z28 = (~new_n198_ & ~x17) | (~x09 & new_n208_ & x17);
  assign new_n198_ = (~x18 | ((new_n199_ | x07) & (~new_n206_ | x05))) & (x05 | ~new_n207_ | ~x07);
  assign new_n199_ = (~x08 | (new_n205_ & (x05 | (~new_n200_ & ~new_n202_)))) & (x05 | ~new_n204_ | x08);
  assign new_n200_ = x11 & (new_n201_ | (~x02 & x15 & (x09 | (~x09 & ~x21))));
  assign new_n201_ = ~x14 & ~x15 & ~x21 & ~x09 & x10 & x12;
  assign new_n202_ = ~x09 & new_n203_ & x10;
  assign new_n203_ = x12 & ~x14 & ~x15 & ~x21 & (~x13 | (x02 & x13));
  assign new_n204_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n97_ & x21));
