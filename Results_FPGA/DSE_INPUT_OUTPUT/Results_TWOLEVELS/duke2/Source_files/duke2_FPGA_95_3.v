...
module FAU ( 
  ...
  assign z01 = new_n58_ | (x06 & x18);
  assign new_n58_ = ~x17 & (new_n63_ | (~x05 & ~new_n59_ & x11));
  assign new_n59_ = (x02 | x06 | ~new_n60_ | x07) & (~new_n62_ | ~x02 | ~x07);
  assign new_n60_ = x08 & x18 & (x09 ? x15 : (~x21 & (new_n61_ | x15)));
  assign new_n61_ = x13 & ~x14 & ~x15 & (~x10 | (x04 & x10 & ~x12));
  assign new_n62_ = ~x09 & x15 & ~x18;
  assign new_n63_ = new_n64_ & ~x09 & ~x11 & x15 & x18 & ~x21;
  assign new_n64_ = ~x04 & x05 & new_n65_ & ~x06;
  assign new_n65_ = ~x07 & x08;
  assign z02 = (x06 & x18) | (~x17 & (new_n73_ | (~new_n67_ & ~x09)));
  assign new_n67_ = (x05 | ((new_n68_ | x15) & (x06 | ~new_n72_ | ~x15))) & (~new_n70_ | x06);
  assign new_n68_ = ~new_n69_ & (~x01 | ~x07 | x18 | (~x08 & ~x16));
  assign new_n69_ = ~x06 & ~x07 & x18 & (~x04 | ~x12);
  assign new_n70_ = x18 & ((~new_n71_ & x05) | (new_n65_ & x15 & x21));
  assign new_n71_ = x07 ? (~x08 | x15) : (x08 ? (~x21 & (x04 | x11 | ~x15 | x21)) : x15);
  assign new_n72_ = x18 & (x08 ? (x07 | (~x02 & ~x07 & x11 & ~x21)) : ~x07);
  assign new_n73_ = x08 & x18 & (new_n74_ | (~x05 & ~x07 & ~x15));
  assign new_n74_ = ~x06 & (x05 ? (~new_n75_ & ~x15) : (x15 & (new_n76_ | ~x11)));
  assign new_n75_ = (x04 | x07 | ~x12 | (~x09 & x21)) & x12 & (~x07 | ~x09);
  assign new_n76_ = x09 & (~x02 | x07);
  assign z03 = new_n78_ | (~x09 & (new_n81_ | (new_n80_ & ~x06)));
  assign new_n78_ = x18 & (x06 | (new_n79_ & ~x05 & ~x06 & ~x07));
  ...
  assign new_n86_ = (~x02 | x10 | ~x13) & (~x10 | ~x12 | x13 | x16);
  assign z06 = (x06 & x18) | (~x09 & (new_n96_ | (~new_n88_ & ~x05)));
  assign new_n88_ = ~new_n95_ & (x07 | (~new_n94_ & (x06 | ~new_n89_ | x17)));
  assign new_n89_ = x18 & (new_n93_ | (~x15 & (new_n92_ | (~new_n90_ & ~x14))));
  ...
  assign new_n94_ = x00 & x15 & x17 & ~x18;
  assign new_n95_ = x07 & ~x15 & x17 & ~x18;
  assign new_n96_ = new_n97_ & x04 & x05 & new_n65_ & ~x06;
  ...
  assign z10 = z13 | (~x06 & new_n115_ & ~x17);
  assign z13 = new_n81_ & ~x09;
  assign new_n115_ = x18 & ((~x15 & ((x05 & (x07 ? x08 : (~x08 & ~x09))) | (x08 & x09 & ~x05 & ~x07))) | (~x05 & ~x07 & ~x08 & ~x09 & x15));
  assign z11 = new_n117_ & ~x18;
  assign new_n117_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (x06 & x18) | (~x09 & (new_n124_ | (~new_n119_ & ~x07)));
  assign new_n119_ = ~new_n123_ & (x06 | x17 | ~x18 | new_n120_ | x21);
  assign new_n120_ = (new_n122_ | x04) & (x05 | ((new_n121_ | ~x08) & (~new_n98_ | ~x04 | x08))) & (~x04 | ~x05 | ~new_n98_ | ~x08);
  assign new_n121_ = (x14 | ~new_n91_ | x15) & (x02 | ~x11 | ~x15);
  assign new_n122_ = (x11 | ~x15 | ~x05 | ~x08) & (x05 | x08 | ~x12 | x15);
  assign new_n123_ = x00 & ~x05 & x15 & x17 & ~x18;
  assign new_n124_ = ~x05 & x07 & ~x15 & x17 & ~x18;
  assign z14 = (~x17 & (new_n126_ | (~x05 & new_n130_ & ~x09))) | (~x05 & new_n132_ & ~x09);
  assign new_n126_ = ~x06 & x08 & ~new_n127_ & x18;
  assign new_n127_ = x07 ? (new_n128_ | x19) : (new_n129_ | (~x09 & (x09 | x21)));
  ...
  assign new_n137_ = ~x14 & ~x21 & (new_n91_ | new_n138_);
  assign new_n138_ = x12 & x16 & ((x10 & ~x13) | (~x02 & x11));
  assign z17 = ~x09 & (new_n143_ | (~new_n140_ & ~x05));
  assign new_n140_ = ~new_n95_ & (x07 | (~new_n141_ & ~new_n94_));
  assign new_n141_ = ~x04 & ~x06 & new_n142_ & ~x08;
  assign new_n142_ = x12 & ~x15 & ~x17 & x18 & (~x21 | (~x14 & x21));
  assign new_n143_ = new_n64_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x06 & ~x07 & ~x09 & new_n145_ & ~x17;
  assign new_n145_ = x18 & ((~x14 & ~new_n146_ & ~x15) | (~x08 & x15 & x19));
  assign new_n146_ = (~x08 | new_n86_ | x21) & (x04 | x08 | ~x12 | ~x21);
  assign z19 = (x06 & x18) | (new_n148_ & ~x15 & x17 & ~x18);
  ...
  assign new_n151_ = (~new_n154_ | x05) & (x21 | (x04 ? ~new_n152_ : new_n122_));
  ...
  assign z27 = (~new_n177_ & x18) | (~x09 & (new_n179_ | (~x17 & ~new_n174_ & x18)));
  assign new_n174_ = (x06 | new_n175_ | x07) & (~x07 | ~x08 | new_n128_ | ~x19);
  assign new_n175_ = ~new_n176_ & (x04 | new_n122_ | x21);
  assign new_n176_ = x05 & ~x08 & ~x15 & x19;
  assign new_n177_ = ~x06 & (~new_n178_ | ~new_n65_ | ~x03 | x05);
