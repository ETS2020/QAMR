...
module FAU ( 
  ...
  assign new_n145_ = x18 & ~x21 & x11 & x15;
  ...
  assign z20 = ~x07 & ~x17 & ((new_n188_ & x03) | (~new_n182_ & (x03 | ~x10)));
  ...
  assign z23 = new_n57_ | (~x05 & ~x07 & new_n196_ & x08);
  assign new_n196_ = x09 & ~x15 & ~x17 & ~new_n57_ & x18;
  assign z24 = ~x09 & ~x17 & ~new_n57_ & (new_n198_ | new_n202_);
  ...
  assign new_n202_ = new_n70_ & x01 & x08 & ~x15 & ~x18;
  assign z25 = new_n57_ | (~x05 & ~x07 & new_n204_ & ~x17);
  assign new_n204_ = x18 & (x08 ? (x09 & ~new_n57_ & ~x15) : (~x09 & x15));
  assign z26 = new_n57_ | (~x20 & (x21 | (~new_n57_ & x14)));
  assign z27 = new_n211_ | new_n57_ | (~x09 & ((~new_n207_ & ~new_n57_) | (new_n213_ & ~x17)));
  assign new_n207_ = (x07 | (~new_n208_ & (~x00 | x05 | ~new_n137_ | ~x15))) & (x05 | ~x07 | ~new_n137_ | x15);
  ...
  assign z28 = (~new_n215_ & ~new_n57_) | new_n57_ | new_n228_ | (~new_n220_ & ~x17);
  assign new_n215_ = (x05 | (~new_n219_ & (x07 | new_n216_ | x09))) & (~x05 | x07 | ~new_n137_ | x09);
  assign new_n216_ = (~x15 | ~x17 | x18) & (x17 | ~x18 | (~new_n217_ & (~new_n218_ | x02)));
  assign new_n217_ = new_n128_ & x04 & ~x12 & ~x14 & ~x15 & x21;
  assign new_n218_ = x11 & ((x08 & x15 & ~x21) | (x06 & ~x08 & ~x14 & ~x15 & x21));
  assign new_n219_ = x07 & x08 & x15 & ~x17 & x18;
  assign new_n220_ = (~new_n226_ | x07) & (x05 | ((~new_n221_ | x07) & (new_n224_ | ~x15)));
  assign new_n221_ = x08 & ~x09 & new_n222_ & x10;
  assign new_n222_ = x12 & ~x14 & ~x15 & x18 & ~new_n223_ & ~x21;
  assign new_n223_ = (x13 | ((~x03 | (~x06 ^ ~x16)) & (x06 | ~x16) & (~x06 | x16))) & ~x11 & (~x02 | ~x03 | ~x13);
  assign new_n224_ = new_n225_ & (x02 | ((~x08 | ~x09 | ~x18) & (~x07 | x09 | x18)));
  assign new_n225_ = (x09 | ((~x07 | x11 | x18) & (x07 | x08 | ~x18 | x19))) & (~x08 | x11 | ~x18);
