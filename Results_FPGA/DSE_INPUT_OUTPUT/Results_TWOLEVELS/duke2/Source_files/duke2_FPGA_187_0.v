...
module FAU ( 
  ...
  assign new_n56_ = x17 & (x05 ? (~x07 | ~x15) : (x20 & (x15 ? (~x00 | x07) : ~x07)));
  ...
  assign new_n84_ = (~x05 | ((~x17 | x18) & (x08 | x15 | x17 | ~x18))) & (~x17 | x18 | ~x20 | (~x15 & (x05 | x15)));
  ...
  assign new_n110_ = (x09 | (x07 ? (~x08 | (~x05 ^ x15)) : (x08 | (~x05 ^ x15)))) & (~x09 | x15 | ~x16 | x05 | x07 | ~x08);
  ...
  assign new_n129_ = ~x09 & (x07 ? ~new_n130_ : (x15 ? ~new_n133_ : ~new_n132_));
  assign new_n130_ = (~new_n105_ | x05) & (~new_n131_ | ~x05 | ~x08 | x15);
  assign new_n131_ = ~x17 & x18 & x19;
  assign new_n132_ = (~x05 | ((~x17 | x18 | ~x20) & (x17 | ~x18 | x06 | x08))) & (x18 | ~x20 | x05 | ~x17);
  assign new_n133_ = (~x17 | x18 | ~x20) & (x05 | x06 | x08 | x17 | ~x18);
  assign new_n134_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = ~x18 & (~x20 | (new_n136_ & ~x09 & ~x15 & ~x17));
  ...
  assign z13 = ~new_n147_ & ~x18;
  assign new_n147_ = x20 & (x09 | ~x17 | ((~x05 | x07) & (~x20 | ((x07 | ~x15) & (x05 | (~x07 & (x07 | x15)))))));
  assign z14 = (~new_n149_ & ~x17) | (~x05 & ~x09 & new_n155_ & ~x18);
  ...
  assign new_n155_ = x20 & ((~x01 & x07) | (x17 & (x07 | (x15 & (~x00 | (x00 & ~x07))))));
  ...
  assign new_n166_ = (~new_n105_ | ~x07 | x15) & (x07 | ((x08 | ~new_n167_ | x15) & (~new_n105_ | ~x00 | ~x15)));
  assign new_n167_ = ~x17 & x18 & ~new_n61_ & ~new_n168_;
  assign new_n168_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n169_ = ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = new_n79_ | (~x05 & ~x07 & ~x09 & new_n171_ & ~x17);
  assign new_n171_ = x18 & ((~x14 & ~new_n172_ & ~x15) | (~x08 & x15 & x19));
  assign new_n172_ = ~new_n88_ & (~x12 | (~new_n174_ & (new_n173_ | x06)));
  assign new_n173_ = (x04 | x08 | ~x21) & (~new_n93_ | ~x08 | ~x10);
  assign new_n174_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign z19 = new_n176_ & x20;
  ...
  assign new_n193_ = ~new_n194_ & (~new_n136_ | x18 | ~x20 | ~x08 | x15);
  ...
  assign new_n207_ = ~new_n79_ & (~new_n82_ | ~new_n131_ | ~new_n65_ | ~x03 | x05);
  ...
  assign new_n217_ = x17 & ((~x07 & x20 & (x15 | (x05 & ~x15))) | (~x05 & x15 & ~x19));
