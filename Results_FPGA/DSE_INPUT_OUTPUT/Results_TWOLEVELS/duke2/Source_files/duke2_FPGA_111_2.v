...
module FAU ( 
  ...
  assign new_n68_ = (x07 | (~new_n69_ & new_n71_)) & (~x08 | x15 | ~x05 | ~x07);
  ...
  assign new_n97_ = new_n70_ & x04 & ~x12 & ~x15 & ~x21;
  ...
  assign new_n116_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x06 | x08 | x09 | ~x15))) & (x08 | x09 | x15 | ~x05 | x06))) & (~x05 | ~x07 | ~x08 | x15);
  ...
  assign new_n136_ = (~x06 | (~new_n137_ & (~x12 | new_n138_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n138_ | ~x16);
  assign new_n137_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n138_ = x13 & (x02 | ~x11);
  assign new_n139_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = (x17 & ~x18) | (~x07 & ~x09 & ~x17 & ~new_n141_ & x18);
  assign new_n141_ = ~new_n142_ & (~new_n70_ | x04 | x11 | ~x15 | x21);
  assign new_n142_ = ~x05 & ~x08 & ~new_n59_ & ~new_n143_ & ~x15;
  assign new_n143_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = (x17 & ~x18) | (~x05 & ~x07 & ~x09 & ~x17 & ~new_n145_ & x18);
  assign new_n145_ = (x14 | (~new_n146_ & ~new_n83_) | x15) & (x08 | ~x15 | ~x19);
  assign new_n146_ = x12 & ((~new_n147_ & ~x06) | (new_n148_ & x06 & x08 & x10));
  assign new_n147_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n157_ = new_n70_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n161_ = (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n163_ & x08;
  assign new_n163_ = ~x05 & ~x07;
  assign z24 = ~x09 & (new_n165_ | new_n169_) & ~x17;
  ...
  assign z25 = (x17 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n171_ & x18);
  assign new_n171_ = x08 ? (~x09 | x15) : (x09 | ~x15);
