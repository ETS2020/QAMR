...
module FAU ( 
  ...
  assign new_n79_ = ~x18 & x20;
  assign z03 = z23 | (~x09 & (x07 ? ~new_n83_ : ~new_n84_));
  assign z23 = (~x18 & x20) | (new_n82_ & ~x17 & x18 & new_n65_ & ~x05);
  ...
  assign z06 = new_n79_ | (~x09 & (new_n107_ | (~new_n95_ & ~x05)));
  ...
  assign new_n105_ = x17 & ~x18 & ~x20;
  assign new_n106_ = new_n105_ & x07 & ~x15;
  assign new_n107_ = new_n108_ & new_n65_ & x04 & x05;
  assign new_n108_ = ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign z07 = (~x18 & x20) | (~x17 & ~new_n110_ & x18);
  assign new_n110_ = (x09 | (x07 ? (~x08 | (~x05 ^ x15)) : (x08 | (~x05 ^ x15)))) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  ...
  assign new_n126_ = ~x14 & ~x15 & ~x18 & ~x20 & ~x21;
  assign new_n127_ = ~x07 & ~x09 & new_n105_ & ~x15;
  assign z10 = new_n129_ | (x08 & new_n133_ & ~x15);
  assign new_n129_ = ~x09 & (x07 ? (new_n132_ | (new_n105_ & ~x05)) : ~new_n130_);
  assign new_n130_ = x05 ? ((~x17 | x18 | x20) & (~new_n131_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | x20) & (~new_n131_ | x17 | ~x18))) & (x18 | x20 | x15 | ~x17));
  assign new_n131_ = ~x06 & ~x08;
  assign new_n132_ = x05 & x08 & ~x15 & ~x17 & x18 & x19;
  assign new_n133_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = ~x18 & (x20 | (new_n135_ & ~x09 & ~x15 & ~x17));
  ...
  assign new_n138_ = (new_n139_ | x05) & (~x08 | x12 | x15 | ~x04 | ~x05);
  ...
  assign z18 = new_n79_ | (~x05 & ~x07 & ~x09 & new_n169_ & ~x17);
  ...
  assign new_n188_ = (x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  assign new_n189_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z24 = ~x09 & ~new_n191_ & ~x17;
  assign new_n191_ = ~new_n192_ & (~new_n135_ | x18 | x20 | ~x08 | x15);
  assign new_n192_ = ~x07 & (new_n193_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n193_ = ~x21 & ((x04 & ~new_n194_ & ~x15) | (x08 & new_n195_ & x15));
  assign new_n194_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | x20);
  assign new_n195_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign z25 = (~x18 & x20) | (~x05 & ~x07 & ~x17 & ~new_n197_ & x18);
  ...
  assign new_n203_ = ~new_n79_ & (~new_n204_ | ~new_n65_ | ~x03 | x05);
  ...
  assign new_n215_ = ~x18 & (x20 | (new_n216_ & ~x09));
  assign new_n216_ = x17 & (x05 ? (~x07 & ~x20) : (x15 & (~x19 | (~x07 & ~x20))));
  assign new_n217_ = ~x09 & x15 & ~x18 & ~x20 & (~x02 | ~x11);
endmodule
