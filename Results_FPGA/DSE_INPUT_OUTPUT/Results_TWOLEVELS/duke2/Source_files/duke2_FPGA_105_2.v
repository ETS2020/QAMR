...
module FAU ( 
  ...
  assign z03 = (~new_n79_ & ~x09) | new_n83_ | new_n84_;
  assign new_n79_ = x07 ? ((~new_n81_ | x05) & (~new_n80_ | ~x08)) : (x05 ? (~new_n81_ & (~new_n82_ | x08)) : ~new_n81_);
  assign new_n80_ = ~x17 & ~new_n75_ & x18;
  ...
  assign z06 = new_n84_ | (~x09 & (new_n106_ | (~new_n95_ & ~x05)));
  ...
  assign new_n104_ = new_n81_ & x00 & x15;
  assign new_n105_ = new_n81_ & x07 & ~x15;
  ...
  assign new_n126_ = ~x16 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | x16)));
  assign z10 = (~new_n128_ & ~x09) | new_n84_ | (x08 & new_n131_ & x09);
  assign new_n128_ = x07 ? ((~new_n81_ | x05) & (~new_n82_ | ~x05 | ~x08)) : new_n129_;
  ...
  assign z11 = ~x18 & (x16 | (new_n133_ & ~x09 & ~x15 & ~x17));
  assign new_n133_ = x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n135_ & ~x07) | (new_n81_ & ~x05 & x07 & ~x15));
  ...
  assign new_n142_ = new_n81_ & x00 & ~x05 & x15;
  ...
  assign new_n146_ = x18 & (x07 ? (~new_n75_ & ~x19) : new_n147_);
  ...
  assign new_n153_ = ~x16 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = new_n84_ | (x08 & ~x17 & (x05 ? new_n161_ : ~new_n155_));
  assign new_n155_ = (x07 | new_n156_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n156_ = x09 ? (~x18 | x19) : (x14 | new_n157_ | x21);
  assign new_n157_ = (~new_n160_ | x06) & (~x18 | (~new_n99_ & (~x06 | (~new_n158_ & ~new_n159_))));
  ...
  assign new_n163_ = (~new_n81_ | ~x07 | x15) & (x07 | ((x08 | ~new_n164_ | x15) & (~new_n81_ | ~x00 | ~x15)));
  ...
  assign new_n170_ = x12 & ((new_n172_ & x06 & x08 & x10) | (~new_n171_ & ~x06));
  assign new_n171_ = (~new_n93_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n172_ = ~x13 & x16 & ~x21;
  assign z19 = ~new_n174_ & ~x18;
  assign new_n174_ = ~x16 & (x05 | x07 | x09 | x15 | x16 | ~x17);
  ...
  assign z22 = (x16 & ~x18) | (~x17 & ~new_n188_ & x18);
  assign new_n188_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = new_n190_ & x18;
  assign new_n190_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = new_n84_ | (~x09 & ~new_n192_ & ~x17);
  assign new_n192_ = ~new_n193_ & (~new_n133_ | x16 | x18 | ~x08 | x15);
  ...
  assign new_n202_ = ~x21 & (new_n140_ | new_n203_);
  assign new_n203_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n204_ = new_n205_ & ~x05;
  assign new_n205_ = ~x16 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n206_ = new_n207_ & new_n65_ & x03 & ~x05;
  assign new_n207_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n209_ & ~x17) | (~x09 & ~x16 & new_n217_ & x17);
  assign new_n209_ = (new_n210_ | ~x18) & (x05 | ~new_n216_ | ~x07);
  ...
  assign new_n216_ = ~x09 & x15 & ~x16 & ~x18 & (~x02 | ~x11);
