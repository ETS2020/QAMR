...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n70_, new_n72_, new_n73_, new_n74_, new_n75_, new_n79_, new_n81_,
    new_n82_, new_n85_;
  ...
  assign z14 = z05 | (~x05 & ~new_n72_ & ~x09);
  assign new_n72_ = (x18 | (new_n74_ & (new_n73_ | x15))) & (~x07 | ~new_n75_ | ~x15);
  assign new_n73_ = (~x07 | ~x17) & (x14 | x17 | x21 | ~x04 | x07 | ~x12);
  assign new_n74_ = (~x15 | (x07 ? (~x17 & (~x02 | ~x11 | x17)) : ~x17)) & (x01 | ~x07);
  assign new_n75_ = ~x17 & (~x02 | ~x11);
  assign z15 = (~x17 & x18) | (x05 & ~x07 & ~x09 & ~x15 & x17 & ~x18);
  assign z19 = (~x17 & x18) | (~x15 & x17 & ~x18 & ~x05 & ~x07 & ~x09);
  assign z20 = ~x21 & ~x18 & ~x17 & new_n79_ & ~x15;
  assign new_n79_ = ~x14 & x12 & ~x09 & ~x07 & x04 & ~x05;
  assign z24 = ~x17 & (x18 | (~x05 & ~x09 & ~new_n81_ & ~x15));
  assign new_n81_ = (~x01 | ~x07 | ~x08) & (~new_n82_ | ~x04 | x07 | ~x12);
  assign new_n82_ = ~x14 & ~x18 & ~x21;
  assign z26 = z05 | (~x20 & (x14 | x21));
  assign z28 = (~x17 & x18) | (~x09 & ((new_n85_ & ~x05) | (x05 & ~x07 & x17 & ~x18)));
  assign new_n85_ = x15 & ((new_n75_ & x07) | (x17 & ~x18 & (~x07 | ~x19)));
  assign z07 = 1'b0;
  assign z16 = 1'b0;
  assign z22 = 1'b0;
  assign z23 = 1'b0;
