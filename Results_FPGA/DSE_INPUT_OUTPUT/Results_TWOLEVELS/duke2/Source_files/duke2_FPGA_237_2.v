...
module FAU ( 
  ...
  assign new_n54_ = (new_n55_ | ~x17) & (~new_n56_ | ~x12 | x15 | x17 | x21);
  ...
  assign z02 = new_n68_ | (~x17 & (new_n76_ | (~x09 & (new_n70_ | new_n74_))));
  assign new_n70_ = ~x05 & (x07 ? ~new_n71_ : (x18 & (new_n72_ | new_n73_)));
  assign new_n71_ = (~x01 | x15 | x18 | (~x16 & (~x08 | x14))) & (~x08 | ~x15 | ~x18);
  assign new_n72_ = ~x02 & ((x06 & ~x08) | (x08 & x11 & x15 & ~x21));
  assign new_n73_ = ~x08 & ((~x06 & (~x04 | ~x12)) | x15 | (x06 & ~x11));
  assign new_n74_ = x18 & ((~new_n75_ & x05) | (new_n67_ & x15 & x21));
  assign new_n75_ = x07 ? (~x08 | x15) : (x08 ? (~x21 & (x04 | x11 | ~x15 | x21)) : x15);
  ...
  assign z06 = new_n68_ | (~x09 & (new_n105_ | (~new_n93_ & ~x05)));
  ...
  assign new_n104_ = x15 & x17 & ~x18 & x00 & ~x14;
  ...
  assign new_n125_ = ~x14 & (x07 | x09 | x14 | x15 | ~x17);
  ...
  assign new_n129_ = (x05 | x14 | ~x17 | x18) & (x15 | x17 | ~x18 | ~x05 | ~x08);
  ...
  assign new_n141_ = x00 & ~x05 & ~x14 & x15 & x17 & ~x18;
  assign z13 = ~x18 & (x14 | (~x09 & ~x14 & x17 & (~x05 | (x05 & ~x07))));
  assign z14 = (~new_n144_ & ~x17) | (~x05 & new_n150_ & ~x09);
  assign new_n144_ = (~new_n145_ | ~x08) & (x05 | x09 | ~new_n148_ | x14);
  ...
  assign new_n149_ = x04 & ~x07 & x12 & ~x15 & ~x21;
  assign new_n150_ = ~x14 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n152_ & ~x18;
  assign new_n152_ = x17 & ~x15 & ~x14 & ~x09 & x05 & ~x07;
  assign z16 = (x14 & ~x18) | (x08 & ~x17 & x18 & (new_n154_ | new_n159_));
  ...
  assign z17 = new_n68_ | (~x09 & (new_n161_ | new_n164_));
  assign new_n161_ = ~x05 & (new_n102_ | (~x07 & (new_n104_ | (new_n162_ & ~x08))));
  ...
  assign new_n171_ = ~x14 & (x14 | x15 | ~x17 | x05 | x07 | x09);
  ...
  assign z21 = (x14 & ~x18) | (~x17 & ~new_n183_ & x18);
  ...
  assign new_n185_ = (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = new_n80_ | new_n68_;
  ...
  assign new_n192_ = ~x05 & ~x08 & ~x15 & x18;
  assign new_n193_ = x08 & ~x14 & ~x15 & ~x18;
  ...
  assign new_n203_ = ~new_n68_ & (~new_n204_ | ~new_n67_ | ~x03 | x05);
  assign new_n204_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n206_ & ~x17) | (~x18 & (x14 | (~x09 & ~new_n214_ & x17)));
  ...
  assign new_n214_ = x05 ? (x07 | x14) : (~x15 | (x19 & (x07 | x14)));
endmodule
