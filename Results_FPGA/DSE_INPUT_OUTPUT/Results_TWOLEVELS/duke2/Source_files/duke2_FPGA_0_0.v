...
module FAU ( 
  ...
  assign z06 = (~x12 & ~x18) | (~x09 & (new_n105_ | (~new_n93_ & ~x05)));
  assign new_n93_ = ~new_n104_ & (x07 | (x15 ? new_n101_ : (~new_n94_ | x17)));
  ...
  assign z07 = (~x12 & ~x18) | (~x17 & ~new_n108_ & x18);
  ...
  assign new_n125_ = ~x07 & ~x09 & x12 & ~x15 & x17 & ~x18;
  assign z10 = ~new_n131_ | (~x09 & (x07 ? ~new_n129_ : ~new_n127_));
  assign new_n127_ = x05 ? ((~x12 | ~x17 | x18) & (~new_n128_ | x15 | x17 | ~x18)) : ((~x12 | ~x17 | x18) & (~new_n128_ | ~x15 | x17 | ~x18));
  assign new_n128_ = ~x06 & ~x08;
  assign new_n129_ = (x05 | ~x12 | ~x17 | x18) & (~new_n130_ | ~x05 | x17 | ~x18 | ~x19);
  assign new_n130_ = x08 & ~x15;
  assign new_n131_ = (x12 | x18) & (~x08 | x15 | x17 | new_n132_ | ~x18);
  assign new_n132_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign z11 = ~x18 & new_n134_ & ~x17;
  assign new_n134_ = ~x15 & x12 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (~x12 & ~x18) | (~x09 & (new_n144_ | (~new_n136_ & ~x07)));
  assign new_n136_ = ~new_n143_ & (x17 | ~x18 | x21 | (new_n137_ & ~new_n141_));
  assign new_n137_ = (new_n138_ | x05) & (~x04 | ~x05 | ~x08 | x12 | x15);
  assign new_n138_ = ~new_n140_ & (x15 | (x08 ? (~new_n96_ | x14) : new_n139_));
  ...
  assign new_n143_ = x15 & x17 & ~x18 & x00 & ~x05 & x12;
  assign new_n144_ = ~x15 & x17 & ~x18 & ~x05 & x07 & x12;
  assign z13 = ~x18 & (~x12 | (~x09 & x12 & x17 & (~x05 | (x05 & ~x07))));
  assign z14 = (~new_n147_ & ~x17) | (~x18 & (~x12 | (new_n153_ & ~x05)));
  ...
  assign new_n151_ = (~x12 | (~new_n152_ & (~x02 | ~x07 | ~x11 | ~x15))) & (~x07 | ~x15 | (x02 & x11));
  ...
  assign new_n159_ = (~x06 | (~new_n160_ & (~x12 | new_n161_ | x16))) & ~new_n96_ & (x06 | ~x12 | new_n161_ | ~x16);
  ...
  assign new_n169_ = (x14 | x15 | (~new_n170_ & ~new_n86_)) & (x08 | ~x15 | ~x19);
  assign new_n170_ = x12 & ((new_n172_ & x06 & x08 & x10) | (~new_n171_ & ~x06));
  assign new_n171_ = (~new_n91_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  ...
  assign z22 = (~x12 & ~x18) | (~x17 & x18 & (new_n187_ | new_n188_));
  ...
  assign new_n196_ = x08 & x12 & ~x15 & ~x18;
  assign z25 = (~x12 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n198_ & x18);
  ...
  assign new_n205_ = x12 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n206_ = new_n207_ & new_n65_ & x03 & ~x05;
  assign new_n207_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n216_ & ~x18) | (~x17 & ((~new_n209_ & x18) | (new_n218_ & ~x05)));
  assign new_n209_ = (new_n210_ | ~x08) & (x05 | x07 | x08 | new_n215_ | x09);
  ...
  assign new_n215_ = (~x15 | x19) & (x14 | x15 | new_n100_ | ~x21);
  assign new_n216_ = x12 & (~new_n217_ | x09);
  assign new_n217_ = x17 & (x05 ? (~x07 & x12) : (x15 & (~x19 | (~x07 & x12))));
