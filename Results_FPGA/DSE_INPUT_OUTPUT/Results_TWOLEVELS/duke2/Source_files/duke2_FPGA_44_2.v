...
module FAU ( 
  ...
  assign z03 = x17 ? ~x18 : (~new_n81_ & x18);
  assign new_n81_ = (~x08 | ((x05 | (x07 ? (x09 | ~x15) : (~x09 | x15))) & (~x05 | ~x07 | x09 | x15))) & (~x05 | x07 | x08 | x09 | x15);
  ...
  assign z06 = ~x07 & ~x09 & new_n93_ & ~x17;
  assign new_n93_ = x18 & (new_n100_ | (~x05 & (new_n61_ | (~new_n94_ & ~x15))));
  ...
  assign z09 = ~x17 & (new_n116_ | (x18 & (new_n105_ | (new_n114_ & ~x07))));
  ...
  assign z14 = (~x17 & (new_n116_ | (x08 & ~new_n130_ & x18))) | (~x18 & (new_n133_ | x17));
  ...
  assign new_n134_ = x07 & ~x09 & (~x01 | (x15 & (~x02 | ~x11 | (x02 & x11))));
  ...
  assign new_n138_ = (~x06 | (~new_n139_ & (~x12 | new_n140_ | x16))) & ~new_n96_ & (x06 | ~x12 | new_n140_ | ~x16);
  ...
  assign new_n143_ = ~new_n144_ & (~new_n74_ | x04 | x11 | ~x15 | x21);
  ...
  assign new_n147_ = (x14 | (~new_n86_ & ~new_n148_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n153_ = ~x21 & (x04 ? (new_n154_ & ~x12) : ~new_n127_);
  ...
  assign new_n159_ = new_n74_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign z22 = x17 ? ~x18 : (x18 & ((~new_n163_ & ~x07) | (~x05 & new_n164_ & x07)));
  ...
  assign new_n180_ = x03 & ~x05 & ~x07 & new_n76_ & x08 & x09;
  assign z28 = (~x17 & ~new_n182_ & x18) | (~x18 & (new_n189_ | x17));
  assign new_n182_ = (~x08 | ((new_n188_ | x07) & (new_n183_ | x05))) & (x05 | x07 | ~new_n187_ | x08);
  ...
  assign new_n187_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
