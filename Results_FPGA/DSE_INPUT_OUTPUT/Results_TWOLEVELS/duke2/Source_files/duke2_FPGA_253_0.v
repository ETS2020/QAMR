...
module FAU ( 
  ...
  assign z02 = ~x17 & (new_n70_ | (new_n78_ & new_n79_));
  assign new_n70_ = x18 & ((~new_n75_ & x08) | (~x07 & (new_n71_ | (new_n77_ & x08))));
  ...
  assign new_n77_ = ~x15 & (~x05 | (~x04 & x05 & x12 & (x09 | ~x21)));
  assign new_n78_ = x01 & ~x05 & x07;
  assign new_n79_ = ~x09 & ~x15 & x16 & ~x18;
  assign z03 = ~new_n81_ | (~x09 & (x07 ? ~new_n83_ : ~new_n84_));
  assign new_n81_ = (x16 | x18) & (~new_n66_ | x05 | ~new_n82_ | x17 | ~x18);
  ...
  assign z12 = new_n68_ | (~x09 & (new_n135_ | (new_n103_ & new_n143_)));
  ...
  assign z14 = (~new_n146_ & ~x17) | (~x18 & (~x16 | (new_n153_ & ~x05)));
  ...
  assign new_n150_ = (~new_n151_ | ~x07) & (~new_n152_ | ~x04 | x07 | ~x12);
  assign new_n151_ = x15 & (~x02 | ~x11 | (x02 & x11));
  assign new_n152_ = ~x14 & ~x15 & x16 & ~x21;
  assign new_n153_ = ~x09 & ((~x01 & x07) | (x16 & x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n155_ & ~x18;
  assign new_n155_ = x17 & x16 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = new_n68_ | (x08 & ~x17 & (x05 ? new_n163_ : ~new_n157_));
  assign new_n157_ = (x07 | new_n158_ | x15) & (~x09 | ~x15 | (x02 & ~x07) | ~x18);
  assign new_n158_ = x09 ? (~x18 | x19) : (x14 | new_n159_ | x21);
  assign new_n159_ = (~new_n162_ | ~x06) & (~x18 | (~new_n160_ & ~new_n98_ & (~new_n161_ | x06)));
  assign new_n160_ = x02 & x06 & ((x04 & ~x12) | (~x10 & x13));
  ...
  assign new_n196_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | ~x16 | x18 | x05 | ~x12);
  assign new_n197_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n198_ = new_n78_ & x08 & ~x15 & x16 & ~x18;
  ...
  assign new_n203_ = ~x09 & ((new_n207_ & ~x05) | (~x17 & ~new_n204_ & x18));
  ...
  assign z28 = (~new_n217_ & ~x18) | (~x17 & ((new_n219_ & ~x05) | (~new_n210_ & x18)));
  assign new_n210_ = (~x08 | ((new_n211_ | x05) & (new_n216_ | x07))) & (x05 | x07 | ~new_n215_ | x08);
  ...
  assign new_n217_ = x16 & (~new_n218_ | x09);
  assign new_n218_ = x17 & (x05 ? (~x07 & x16) : (x15 & (~x19 | (~x07 & x16))));
