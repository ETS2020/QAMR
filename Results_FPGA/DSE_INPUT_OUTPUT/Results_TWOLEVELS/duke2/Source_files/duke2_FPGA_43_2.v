...
module FAU ( 
  ...
  assign new_n68_ = (new_n73_ | ~x18) & (x15 | ((new_n69_ | x05) & (new_n71_ | ~x18)));
  assign new_n69_ = ~new_n70_ & (~x06 | x07 | ~x18 | (x02 & x11));
  assign new_n70_ = x01 & x07 & ~x18 & (x16 | (x08 & ~x12));
  assign new_n71_ = (x07 | (~new_n72_ & (~x05 | x08))) & (~x08 | ~x19 | ~x05 | ~x07);
  ...
  assign new_n79_ = new_n65_ & ~x05 & new_n80_ & ~x17 & x18;
  ...
  assign z05 = new_n66_ | (~x05 & ~x07 & ~x09 & new_n85_ & ~x14);
  ...
  assign z06 = new_n66_ | (~x09 & (new_n105_ | (~new_n93_ & ~x05)));
  ...
  assign new_n104_ = x15 & x17 & ~x18 & x00 & ~x12;
  ...
  assign new_n122_ = ~x09 & new_n103_ & ~x12;
  assign z10 = new_n124_ | (x08 & new_n129_ & ~x15);
  assign new_n124_ = ~x09 & (x07 ? ~new_n127_ : ~new_n125_);
  assign new_n125_ = x05 ? ((x12 | ~x17 | x18) & (~new_n126_ | x15 | x17 | ~x18)) : ((x12 | ~x17 | x18) & (~new_n126_ | ~x15 | x17 | ~x18));
  assign new_n126_ = ~x06 & ~x08;
  assign new_n127_ = (x05 | x12 | ~x17 | x18) & (~new_n128_ | ~x05 | x17 | ~x18 | ~x19);
  ...
  assign z14 = (~new_n143_ & ~x17) | (~x05 & new_n148_ & ~x09);
  ...
  assign new_n147_ = ~x09 & ~x12 & x15 & ~x18 & (~x02 | ~x11 | (x02 & x11));
  assign new_n148_ = ~x12 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = ~x18 & (x12 | (new_n150_ & x05 & ~x12 & ~x15 & x17));
  ...
  assign new_n159_ = ~new_n102_ & (x07 | (~new_n104_ & (~new_n160_ | x08)));
  assign new_n160_ = ~x15 & ~x17 & x18 & ~new_n59_ & ~new_n161_;
  assign new_n161_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n162_ = new_n64_ & new_n106_ & ~x11 & x15;
  ...
  assign z19 = ~x18 & (x12 | (new_n150_ & ~x05 & ~x12 & ~x15 & x17));
  assign z20 = (x12 & ~x18) | (~x07 & ~x17 & ~new_n170_ & x18);
  assign new_n170_ = ~new_n175_ & (x09 | (~new_n171_ & (x05 | ~new_n174_ | x06)));
  assign new_n171_ = ~x21 & (x04 ? (new_n172_ & ~x12) : ~new_n139_);
  ...
  assign new_n177_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign z24 = ~x09 & ~x17 & (new_n185_ | (new_n183_ & ~x07));
  ...
  assign new_n186_ = x08 & ~x12 & ~x15 & ~x18;
  ...
  assign new_n194_ = ~new_n66_ & (~new_n195_ | ~new_n65_ | ~x03 | x05);
  assign new_n195_ = new_n80_ & ~x17 & x18 & x19;
  assign new_n196_ = new_n197_ & ~x05;
  assign new_n197_ = ~x12 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n199_ | new_n206_)) | (~x09 & ~x12 & new_n208_ & x17);
  assign new_n199_ = x18 & ((~new_n200_ & x08) | (~x05 & ~x07 & new_n205_ & ~x08));
  assign new_n200_ = (new_n204_ | x07) & (x05 | ((new_n203_ | ~x15) & (~new_n201_ | x07)));
  ...
  assign new_n205_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n101_ & x21));
