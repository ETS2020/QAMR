...
module FAU ( 
  ...
  assign new_n56_ = x05 ? (x15 & (x07 | x18)) : (x07 ? ~x15 : (x18 | (x15 & (x00 | ~x15))));
  ...
  assign new_n76_ = x18 & ((~new_n77_ & ~x15) | (~x05 & x15 & (new_n78_ | ~x11)));
  ...
  assign new_n80_ = x07 ? ((~x08 | x17 | ~x18 | (~x05 ^ x15)) & (x05 | ~x17 | (~x15 & (x15 | x18)))) : (x05 ? ((~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (~x17 | x18));
  assign new_n81_ = ~x05 & ~x07 & x08;
  assign z04 = ~x14 & ~x20 & (~x17 | ~x18);
  assign z05 = x18 & (x17 | (~x05 & ~x07 & new_n84_ & ~x09));
  assign new_n84_ = ~x14 & ~x15 & ~x17 & (new_n85_ | new_n87_ | new_n89_);
  ...
  assign z06 = ~x09 & (new_n101_ | (~x05 & (new_n99_ | (~new_n92_ & ~x07))));
  assign new_n92_ = (~x00 | ~x15 | ~x17 | x18) & (x17 | ~x18 | (~new_n63_ & (new_n93_ | x15)));
  assign new_n93_ = (x14 | (~new_n87_ & new_n94_)) & (x08 | new_n98_ | x21);
  assign new_n94_ = (~x08 | (~new_n95_ & ~new_n96_) | x21) & (~new_n97_ | x08 | x12 | ~x21);
  assign new_n95_ = (~x10 | (x04 & x10 & ~x12)) & (~x13 | (~x02 & x11 & x13));
  assign new_n96_ = ~x06 & ((x10 & x12 & ~x13 & ~x16) | (x02 & ~x10 & x13));
  assign new_n97_ = x04 & ~x06;
  assign new_n98_ = (x02 | ~x06 | ~x11) & (~x04 | x06 | x12);
  assign new_n99_ = new_n100_ & x07 & ~x15;
  assign new_n100_ = x17 & ~x18;
  assign new_n101_ = new_n102_ & ~x07 & x08 & x04 & x05;
  ...
  assign z09 = (new_n118_ & ~x07) | (x18 & (~new_n120_ | (~new_n107_ & ~x07)));
  assign new_n107_ = ~new_n115_ & (x15 | ((new_n108_ | x09) & (~new_n117_ | x04)));
  assign new_n108_ = ~new_n114_ & (x21 | (~new_n111_ & (~x04 | new_n109_ | x12)));
  assign new_n109_ = (~x13 | x14 | ~x02 | ~x08) & (~new_n110_ | x08 | x17);
  assign new_n110_ = ~x05 & ~x06;
  assign new_n111_ = ~x05 & ~x17 & ((new_n113_ & x02) | (~new_n112_ & x06));
  assign new_n112_ = (x02 | x08 | ~x11) & (~x02 | ~x08 | x10 | ~x13 | x14);
  assign new_n113_ = x08 & x13 & ~x14 & (x10 ? x12 : ~x06);
  assign new_n114_ = x05 & ~x08 & ~x17 & ~x19;
  ...
  assign new_n120_ = ~x17 & (~x05 | ~x08 | x15 | (~x07 & x12) | x17);
  assign z10 = (~new_n124_ & x18) | (~x09 & (x07 ? ~new_n123_ : ~new_n122_));
  assign new_n122_ = x05 ? ((~x17 | x18) & (x15 | ~x18 | x06 | x08)) : (x15 ? ((~x17 | x18) & (x17 | ~x18 | x06 | x08)) : (~x17 | x18));
  assign new_n123_ = (x05 | ~x17 | (~x15 & (x15 | x18))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n124_ = ~x17 & (~x08 | ~x09 | x15 | x17 | (~x05 ^ ~x07));
  assign z11 = new_n126_ & ~x18;
  assign new_n126_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n128_ & ~x07) | (new_n100_ & ~x15 & ~x05 & x07));
  assign new_n128_ = (x17 | ~new_n129_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  assign new_n129_ = ~x21 & ((~new_n133_ & ~x04) | (~new_n130_ & ~x05) | (new_n134_ & x04 & x05));
  assign new_n130_ = ~new_n132_ & (x15 | (x08 ? (~new_n95_ | x14) : new_n131_));
  ...
  assign z13 = x17 & (x18 | (~x09 & (x05 ? (~x07 & ~x18) : (x07 ? (x15 | (~x15 & ~x18)) : ~x18))));
  assign z14 = (~new_n137_ & ~x07) | (x17 & x18) | (~new_n141_ & x07);
  assign new_n137_ = (~x08 | ~new_n138_ | ~x18) & (x05 | x09 | new_n140_ | x18);
  assign new_n138_ = ~new_n139_ & (x09 | (~x09 & ~x17 & ~x21));
  assign new_n139_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n140_ = (~x15 | ~x17) & (~x04 | ~x12 | x14 | x15 | x17 | x21);
  assign new_n141_ = (~new_n142_ | x05) & (~x08 | ~x18 | x19 | (~x05 ^ x15));
  assign new_n142_ = ~new_n143_ & ~x09;
  assign new_n143_ = (~x17 | (~x15 & (x15 | x18))) & (x18 | (x01 & (~x15 | x17 | (x02 & x11 & (~x02 | ~x11)))));
  ...
  assign new_n148_ = (~x06 | (~new_n149_ & (~x12 | new_n150_ | x16))) & ~new_n95_ & (x06 | ~x12 | new_n150_ | ~x16);
  ...
  assign new_n153_ = (~new_n100_ | ~x07 | x15) & (x07 | ((~new_n100_ | ~x00 | ~x15) & (x08 | ~new_n154_ | x15)));
  assign new_n154_ = ~x17 & x18 & ~new_n155_ & (~x21 | (~x14 & x21));
  assign new_n155_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n156_ = new_n157_ & new_n66_ & ~x17 & x18 & ~x21;
  assign new_n157_ = ~x04 & x05 & ~x07 & x08;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n159_ & x18;
  assign new_n159_ = (x14 | x15 | (~new_n85_ & ~new_n160_)) & (x08 | ~x15 | ~x19);
  ...
  assign z19 = ~x18 & x17 & ~x15 & new_n164_ & ~x09;
  assign new_n164_ = ~x05 & ~x07;
  assign z20 = (x17 & x18) | (~x07 & (new_n173_ | (~x09 & ~new_n166_ & ~x17)));
  assign new_n166_ = ~new_n170_ & (~x18 | (~new_n167_ & (x05 | ~new_n172_ | x06)));
  assign new_n167_ = ~x21 & (x04 ? (new_n168_ & ~x12) : ~new_n133_);
  ...
  assign new_n173_ = new_n72_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n178_ = (~x05 | ~x06 | x08 | x09 | x15 | x17) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15 | x17)));
  ...
  assign z27 = (~x09 & (new_n195_ | (~new_n190_ & x18))) | (x18 & (new_n194_ | x17));
  assign new_n190_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : ~new_n191_;
  assign new_n191_ = ~x17 & (new_n193_ | (~x21 & (new_n192_ | (~new_n133_ & ~x04))));
  assign new_n192_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n193_ = x05 & ~x08 & ~x15 & x19;
  assign new_n194_ = new_n164_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n195_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n203_ | (~new_n197_ & x18))) | (~x09 & x17 & ~new_n205_ & ~x18);
  assign new_n197_ = (~x08 | ((new_n202_ | x07) & (new_n198_ | x05))) & (x05 | x07 | ~new_n201_ | x08);
  ...
  assign new_n201_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n98_ & x21));
