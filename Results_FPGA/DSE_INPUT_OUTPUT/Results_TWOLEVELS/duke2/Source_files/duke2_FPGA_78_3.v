...
module FAU ( 
  ...
  assign z02 = (~x09 & (new_n68_ | (~new_n73_ & x18))) | (x18 & (new_n76_ | x17));
  assign new_n68_ = ~x05 & (x15 ? (~x17 & ~new_n72_ & x18) : ~new_n69_);
  assign new_n69_ = (~x01 | ~x07 | x17 | new_n70_ | x18) & (x07 | new_n71_ | ~x18);
  assign new_n70_ = ~x08 & ~x16;
  assign new_n71_ = x06 ? (x02 & x11) : (x04 & x12);
  assign new_n72_ = x08 ? (~x07 & (~x11 | x21 | x02 | x07)) : x07;
  assign new_n73_ = (new_n74_ | ~x05) & (x07 | ~x08 | ~x15 | ~x21);
  assign new_n74_ = (x07 | (x08 ? (~x21 & (~new_n75_ | ~x15 | x17 | x21)) : (x15 | x17))) & (x15 | x17 | ~x07 | ~x08);
  assign new_n75_ = ~x04 & ~x11;
  assign new_n76_ = x08 & ((~x15 & (x05 ? ~new_n77_ : ~x07)) | (~x05 & ~new_n78_ & x15));
  assign new_n77_ = (x04 | x07 | ~x12 | (~x09 & x21)) & x12 & (~x07 | ~x09 | x17);
  assign new_n78_ = x11 & (~x09 | x17 | (x02 & ~x07));
  ...
  assign new_n118_ = ~x18 & (x17 | (x04 & x12 & ~x14 & ~x17 & ~x21));
  ...
  assign z14 = ~new_n141_ | (~x17 & ((~new_n137_ & ~x07) | (~x05 & new_n145_ & x07)));
  ...
  assign new_n141_ = (new_n144_ | ~x18) & (x05 | (~new_n143_ & (x09 | new_n142_ | x18)));
  assign new_n142_ = (x01 | ~x07) & (~x17 | (~x07 & (x07 | ~x15)));
  assign new_n143_ = x15 & x18 & ~x19 & x07 & x08;
  assign new_n144_ = ~x17 & (~x05 | ~x07 | ~x08 | x15 | x19);
  ...
  assign z18 = x18 & (x17 | (~x05 & ~x07 & ~x09 & ~new_n159_ & ~x17));
  ...
  assign z20 = ~x07 & ~x17 & (new_n165_ | new_n171_);
  assign new_n165_ = ~x09 & (new_n166_ | (new_n139_ & x04 & ~x05 & x12));
  assign new_n166_ = x18 & (new_n169_ | (~x21 & (x04 ? new_n167_ : ~new_n132_)));
  ...
  assign new_n177_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign new_n204_ = (~x15 | x19) & (x14 | x15 | new_n98_ | ~x21);
  assign new_n205_ = (x05 | new_n206_ | ~x15) & (~x05 | x07 | ~x17 | x18);
