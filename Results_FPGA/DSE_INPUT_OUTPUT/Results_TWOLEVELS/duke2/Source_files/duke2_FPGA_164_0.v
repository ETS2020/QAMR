...
module FAU ( 
  ...
  assign z07 = ~x17 & ((~x09 & new_n98_ & x18) | ~x18 | (new_n74_ & new_n99_ & x09));
  assign new_n98_ = ~new_n70_ & (x07 ^ ~x08);
  assign new_n99_ = ~x15 & x16;
  assign z08 = (~x17 & ~x18) | (x14 & ~x20);
  assign z09 = (new_n114_ & ~x07) | (~x17 & (~new_n113_ | (~new_n102_ & ~x07)));
  ...
  assign new_n110_ = x08 & (new_n111_ | (x05 & ~x09 & x18 & x21));
  ...
  assign z12 = (~x17 & ~x18) | (~x09 & (new_n127_ | (~new_n120_ & ~x07)));
  ...
  assign new_n127_ = ~x05 & x07 & new_n128_ & ~x15;
  assign new_n128_ = x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = new_n134_ | (~x17 & (~x18 | (~new_n131_ & x08)));
  assign new_n131_ = x07 ? (new_n70_ | x19) : ~new_n132_;
  ...
  assign z17 = (~new_n144_ & ~x09) | (~x17 & ~x18);
  assign new_n144_ = (new_n145_ | x05) & (~new_n148_ | x07 | ~x08 | x04 | ~x05);
  assign new_n145_ = (~new_n128_ | ~x07 | x15) & (x07 | ((x08 | ~new_n146_ | x15) & (~new_n128_ | ~x00 | ~x15)));
  assign new_n146_ = ~x17 & x18 & ~new_n58_ & ~new_n147_;
  assign new_n147_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n148_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n150_ & x18;
  assign new_n150_ = (x14 | x15 | (~new_n151_ & ~new_n79_)) & (x08 | ~x15 | ~x19);
  assign new_n151_ = x12 & ((~new_n152_ & ~x06) | (new_n153_ & x06 & x08 & x10));
  assign new_n152_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  ...
  assign new_n167_ = x18 & ((x08 & ~new_n168_ & ~x21) | (~x05 & ~x08 & ~x15));
  ...
  assign z27 = (~x09 & ((~new_n173_ & ~x17) | (~x05 & new_n179_ & x17))) | (~new_n177_ & ~x17);
  assign new_n173_ = x07 ? (~x08 | new_n70_ | ~x19) : ~new_n174_;
  assign new_n174_ = x18 & (new_n176_ | (~x21 & (new_n175_ | (~new_n125_ & ~x04))));
  assign new_n175_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n176_ = x05 & ~x08 & ~x15 & x19;
  assign new_n177_ = x18 & (~new_n178_ | ~x03 | x05 | x07);
  assign new_n178_ = x08 & x09 & ~x15 & x19;
  assign new_n179_ = ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & ~new_n181_ & x18) | (~x09 & x17 & ~new_n187_ & ~x18);
