...
module FAU ( 
  ...
  assign new_n66_ = (x05 | (x07 ? new_n71_ : (new_n73_ | ~x18))) & (new_n67_ | ~x18);
  ...
  assign z23 = (new_n79_ & ~x05 & new_n80_ & ~x17 & x18) | (x11 & ~x18);
  assign new_n79_ = ~x07 & x08;
  assign new_n80_ = x09 & ~x15;
  assign new_n81_ = (~x08 | x17 | ~x18 | (~x05 ^ x15)) & (x05 | x11 | ~x17 | x18);
  assign new_n82_ = x05 ? ((x11 | ~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (x11 | ~x17 | x18);
  ...
  assign new_n102_ = new_n103_ & new_n79_ & x04 & x05;
  ...
  assign z10 = (~new_n127_ & ~x09) | new_n84_ | (x08 & new_n131_ & ~x15);
  ...
  assign z11 = ~x18 & (x11 | (new_n133_ & ~x09 & ~x15 & ~x17));
  ...
  assign z17 = ~x09 & ((~new_n162_ & ~x05) | (new_n165_ & new_n79_ & ~x04 & x05));
  assign new_n162_ = (x07 | (~new_n163_ & (~new_n123_ | ~x15 | ~x00 | x11))) & (~x07 | x11 | ~new_n123_ | x15);
  assign new_n163_ = ~x08 & ~x15 & ~x17 & new_n164_ & x18;
  assign new_n164_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  ...
  assign new_n172_ = x17 & ~x15 & ~x11 & ~x09 & ~x05 & ~x07;
  ...
  assign new_n181_ = new_n64_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n188_ = ~new_n189_ & (~new_n133_ | x15 | x18 | ~x08 | x11);
  ...
  assign new_n200_ = new_n201_ & new_n79_ & x03 & ~x05;
  assign new_n201_ = new_n80_ & ~x17 & x18 & x19;
  assign new_n202_ = new_n104_ & ~x05;
  assign z28 = (~x17 & (new_n204_ | new_n211_)) | (~x09 & ~x11 & new_n212_ & x17);
