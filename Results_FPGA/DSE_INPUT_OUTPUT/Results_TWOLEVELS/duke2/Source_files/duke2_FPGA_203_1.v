...
module FAU ( 
  ...
  assign new_n74_ = (~x01 | x15 | x18 | x21 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18);
  ...
  assign new_n80_ = (~new_n81_ | x17 | ~x18 | ~new_n66_ | x05) & (x18 | ~x21);
  ...
  assign new_n94_ = ~new_n101_ & (x17 | ~x18 | (~new_n103_ & (new_n95_ | x15)));
  ...
  assign new_n102_ = new_n65_ & x17;
  assign new_n103_ = new_n63_ & x11 & x15 & ~x21;
  assign new_n104_ = new_n102_ & x07 & ~x15;
  ...
  assign z09 = new_n123_ | (~x17 & (new_n111_ | new_n124_));
  assign new_n111_ = x18 & (new_n122_ | (~x07 & (new_n120_ | (~new_n112_ & ~x15))));
  assign new_n112_ = ~new_n119_ & (x09 | (~new_n118_ & (x21 | (~new_n113_ & ~new_n115_))));
  ...
  assign new_n123_ = ~x07 & ~x09 & new_n102_ & ~x15;
  assign new_n124_ = new_n125_ & x12 & ~x14 & new_n65_ & ~x15;
  assign new_n125_ = x04 & ~x05 & ~x07 & ~x09;
  ...
  assign new_n129_ = (x05 | ~x17 | x18 | x21) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n130_ = ~x15 & ~x17 & x18 & (~x05 ^ x07);
  assign z11 = ~x21 & new_n132_ & ~x18;
  assign new_n132_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ~x21 & ((~new_n134_ & ~x07) | (new_n141_ & ~x05 & x07));
  assign new_n134_ = (x17 | new_n135_ | ~x18) & (~x15 | ~x17 | x18 | ~x00 | x05);
  ...
  assign z14 = (~new_n144_ & ~x17) | (~x18 & (x21 | (new_n150_ & ~x05)));
  ...
  assign new_n148_ = (x21 | (~new_n149_ & (~x11 | ~x15 | ~x02 | ~x07))) & (~x07 | ~x15 | (x02 & x11));
  assign new_n149_ = x04 & ~x07 & x12 & ~x14 & ~x15;
  assign new_n150_ = ~x09 & ((~x01 & x07) | (x17 & ~x21 & (x07 | (~x07 & x15))));
  assign z15 = new_n152_ & ~x21;
  assign new_n152_ = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = (~x18 & x21) | (x08 & ~x17 & x18 & (new_n154_ | new_n159_));
  ...
  assign z17 = (~x18 & x21) | (~x09 & (new_n164_ | (~new_n161_ & ~x05)));
  ...
  assign new_n164_ = new_n165_ & new_n66_ & ~x04 & x05;
  ...
  assign new_n172_ = ~x21 & (x15 | ~x17 | x21 | x05 | x07 | x09);
  ...
  assign new_n178_ = x04 & ~x05 & x12 & new_n65_ & ~x14 & ~x15;
  assign new_n179_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n180_ = new_n72_ & x04 & x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n191_ = x01 & ~x05 & x07 & new_n65_ & x08 & ~x15;
  assign z25 = (~x18 & x21) | (~x05 & ~x07 & ~x17 & ~new_n193_ & x18);
  assign new_n193_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = (~x18 & x21) | (~x20 & (x14 ? (x18 | ~x21) : (x18 & x21)));
  assign z27 = new_n196_ | (new_n201_ & new_n66_ & x03 & ~x05);
  assign new_n196_ = ~x09 & ((~x17 & ~new_n197_ & x18) | (~x05 & x17 & new_n200_ & ~x18));
  ...
  assign new_n200_ = ~x21 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n201_ = new_n81_ & ~x17 & x18 & x19;
  assign z28 = (~new_n209_ & ~x18) | (~x17 & ((new_n211_ & ~x05) | (~new_n203_ & x18)));
  ...
  assign new_n209_ = ~x21 & (x09 | new_n210_ | ~x17);
  assign new_n210_ = x05 ? (x07 | x21) : (~x15 | (x19 & (x07 | x21)));
