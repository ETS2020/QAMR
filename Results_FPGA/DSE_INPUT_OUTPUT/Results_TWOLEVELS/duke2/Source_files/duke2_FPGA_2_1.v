...
module FAU ( 
  ...
  assign z01 = (~x17 & (new_n65_ | (~new_n58_ & ~x05))) | (~x18 & x20);
  ...
  assign z02 = (~x17 & (new_n76_ | (~new_n69_ & ~x09))) | (~x18 & x20);
  ...
  assign new_n127_ = x05 ? ((~x17 | x18 | x20) & (~new_n128_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | x20) & (~new_n128_ | x17 | ~x18))) & (x18 | x20 | x15 | ~x17));
  ...
  assign new_n172_ = ~x20 & (x15 | ~x17 | x20 | x05 | x07 | x09);
