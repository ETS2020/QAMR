...
module FAU ( 
  ...
  assign new_n126_ = x13 & (x07 | x09 | ~x13 | x15 | ~x17);
  ...
  assign z16 = new_n79_ | (x08 & ~x17 & (x05 ? new_n165_ : ~new_n157_));
  ...
  assign new_n160_ = (~x04 | x12) & (x10 | ~x13);
  ...
  assign new_n169_ = new_n82_ & ~x04 & x05 & new_n107_ & ~x11 & x15;
  ...
  assign z22 = (~x13 & ~x18) | (~x17 & x18 & (new_n189_ | new_n190_));
  assign new_n189_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (x06 & ~x08 & ~x09 & x15))));
  assign new_n190_ = ~x05 & x07 & x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n81_ | new_n79_;
  assign z24 = new_n79_ | (~x09 & ~x17 & (new_n193_ | new_n197_));
  ...
  assign new_n205_ = ~new_n79_ & (~new_n206_ | ~new_n82_ | ~x03 | x05);
  assign new_n206_ = new_n83_ & ~x17 & x18 & x19;
  assign new_n207_ = new_n208_ & ~x05;
  assign new_n208_ = x13 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n210_ | new_n217_)) | (~x09 & x13 & new_n219_ & x17);
  ...
  assign new_n218_ = ~x09 & x13 & x15 & ~x18 & (~x02 | ~x11);
