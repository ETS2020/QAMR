...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n66_, new_n69_,
    new_n71_, new_n74_, new_n75_, new_n76_, new_n80_, new_n82_, new_n83_,
    new_n86_, new_n87_;
  ...
  assign z13 = z03 | z16;
  assign z14 = (~x17 & x18) | (~x05 & ~x09 & (new_n76_ | (~new_n74_ & ~x18)));
  assign new_n74_ = (new_n75_ | x15) & (~x07 | (x01 & (~x15 | ~x17))) & (x07 | ~x15 | ~x17);
  assign new_n75_ = (~x07 | ~x17) & (~x04 | x07 | ~x12 | x14 | x17 | x21);
  assign new_n76_ = x07 & x15 & ~x17 & (~x02 | ~x11 | (x02 & x11));
  ...
  assign z28 = (~x17 & x18) | (~x09 & ((new_n86_ & ~x05) | (x17 & ~x18 & x05 & ~x07)));
  assign new_n86_ = ~new_n87_ & x15;
  assign new_n87_ = (~x07 | x17 | (x02 & x11)) & (~x17 | x18 | (x07 & x19));
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z18 = 1'b0;
  assign z22 = 1'b0;
