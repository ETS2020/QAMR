...
module FAU ( 
  ...
  assign new_n54_ = ~new_n55_ & (~new_n56_ | x06 | x07 | ~x04 | x05);
  ...
  assign z02 = new_n81_ | (~x17 & ((~new_n69_ & ~x09) | (new_n78_ & x08)));
  assign new_n69_ = ~new_n70_ & (~x18 | (~new_n77_ & (x07 | (~new_n74_ & new_n76_))));
  assign new_n70_ = ~x05 & (x07 ? ~new_n71_ : (~new_n73_ | (~new_n72_ & ~x02)));
  assign new_n71_ = (~x01 | x15 | x18 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18 | ~x19);
  assign new_n72_ = ~x06 & (~x08 | ~x11 | ~x15 | ~x18 | x21);
  assign new_n73_ = (x08 | ~x15 | ~x18) & (~x06 | x11);
  assign new_n74_ = ~x04 & ((~x06 & ~x15) | (new_n75_ & ~x11 & x15 & ~x21));
  assign new_n75_ = x05 & x08;
  assign new_n76_ = (~x08 | ~x21 | (~x05 & ~x15)) & (x15 | ((x06 | x12) & (~x05 | x08)));
  assign new_n77_ = x08 & ~x15 & x19 & x05 & x07;
  ...
  assign new_n85_ = (x05 | ((x06 | ~x17 | x18) & (x17 | ~x18 | ~x08 | ~x15))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n86_ = x05 ? ((x06 | ~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (x06 | ~x17 | x18);
  assign z04 = ~x14 & ~new_n81_ & ~x20;
  assign z05 = new_n81_ | (~x05 & ~x07 & ~x09 & new_n89_ & ~x14);
  ...
  assign z06 = ~x09 & (new_n108_ | (~x05 & (new_n106_ | (~new_n97_ & ~x07))));
  assign new_n97_ = ~new_n105_ & (x17 | ~x18 | (~new_n104_ & (new_n98_ | x15)));
  ...
  assign new_n105_ = x00 & ~x06 & x15 & x17 & ~x18;
  assign new_n106_ = new_n107_ & ~x06 & x07;
  ...
  assign new_n126_ = new_n127_ & x04 & ~x05 & ~x06 & ~x07 & ~x09;
  assign new_n127_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n128_ = ~x06 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | x06)));
  assign z10 = (~new_n130_ & ~x09) | new_n81_ | (x08 & new_n133_ & ~x15);
  assign new_n130_ = (new_n131_ | x06) & (~new_n132_ | ~x05 | ~x07 | ~x08);
  assign new_n131_ = (x07 | (x05 ? ((~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (x15 ? ((~x17 | x18) & (x08 | x17 | ~x18)) : (~x17 | x18)))) & (x05 | ~x07 | ~x17 | x18);
  assign new_n132_ = ~x15 & ~x17 & x18 & x19;
  assign new_n133_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = ~x18 & (new_n135_ | x06);
  assign new_n135_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = ~x09 & ((~new_n137_ & ~x07) | (new_n107_ & ~x05 & ~x06 & x07));
  ...
  assign new_n144_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x06;
  assign z13 = ~x18 & (x06 | (~x06 & ~x09 & x17 & (~x05 | (x05 & ~x07))));
  assign z14 = (~new_n147_ & ~x17) | (~x05 & new_n153_ & ~x06);
  assign new_n147_ = (~new_n148_ | ~x08) & (x05 | x06 | ~new_n151_ | x09);
  ...
  assign new_n155_ = ~x06 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign new_n159_ = (~x06 | (~new_n160_ & (~x12 | new_n161_ | x16))) & ~new_n100_ & (x06 | ~x12 | new_n161_ | ~x16);
  assign new_n160_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n161_ = x13 & (x02 | ~x11);
  assign new_n162_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = new_n81_ | (~x09 & (new_n167_ | (~new_n164_ & ~x05)));
  assign new_n164_ = ~new_n106_ & (x07 | (~new_n105_ & (~new_n165_ | x08)));
  assign new_n165_ = ~x15 & ~x17 & x18 & ~new_n61_ & ~new_n166_;
  assign new_n166_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n167_ = new_n65_ & new_n109_ & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n169_ & x18;
  assign new_n169_ = (x14 | x15 | (~new_n90_ & ~new_n170_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n174_ = x17 & ~x15 & ~x09 & ~x07 & ~x05 & ~x06;
  ...
  assign new_n180_ = new_n181_ & ~x06 & x12 & x04 & ~x05;
  assign new_n181_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n182_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n183_ = new_n75_ & x04 & x09 & ~x12 & ~x15 & x18;
  ...
  assign z22 = new_n81_ | (~x17 & ((~new_n187_ & ~x07) | (~x05 & new_n188_ & x07)));
  assign new_n187_ = (x05 | ((x15 | ~x18 | ~x08 | ~x09) & (x09 | ~x15 | ~x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign new_n188_ = x08 & x15 & x18 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n190_ & x18;
  assign new_n190_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = new_n81_ | (~x09 & (new_n192_ | new_n196_) & ~x17);
  assign new_n192_ = ~x07 & (new_n193_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n193_ = ~x21 & ((x04 & ~new_n194_ & ~x15) | (x08 & new_n195_ & x15));
  assign new_n194_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | x06 | ~x12 | x14 | x18);
  ...
  assign new_n204_ = new_n205_ & new_n66_ & x03 & ~x05;
  assign new_n205_ = new_n84_ & ~x17 & x18 & x19;
  assign new_n206_ = new_n207_ & ~x05;
  assign new_n207_ = ~x06 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (new_n216_ & ~x06) | (~x17 & (new_n209_ | (~x05 & new_n218_ & ~x06)));
  ...
  assign new_n213_ = (x02 | (~x09 & (~x11 | x21 | x07 | x09))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  ...
  assign new_n217_ = x17 & ~x18 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
