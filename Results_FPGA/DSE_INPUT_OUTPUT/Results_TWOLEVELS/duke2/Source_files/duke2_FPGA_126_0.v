...
module FAU ( 
  ...
  assign new_n80_ = (x11 | ~x21 | ~x06 | x08) & (x06 | ~x08 | x10 | ~x13 | x21);
  ...
  assign z06 = ~x09 & (new_n96_ | (~x05 & (new_n94_ | (~new_n86_ & ~x07))));
  assign new_n86_ = (~x17 | x18 | ~x00 | ~x15) & (x17 | ~x18 | (~new_n93_ & (new_n87_ | x15)));
  assign new_n87_ = (x14 | (~new_n81_ & new_n88_)) & (x08 | new_n92_ | x21);
  assign new_n88_ = (~x08 | (~new_n89_ & ~new_n90_) | x21) & (~new_n91_ | x08 | x12 | ~x21);
  ...
  assign new_n93_ = new_n60_ & x11 & x15 & ~x21;
  ...
  assign z07 = ~x17 & ((~x09 & new_n99_ & x18) | ~x18 | (new_n75_ & new_n100_ & x09));
  assign new_n99_ = (x05 ^ x15) & (x07 ^ ~x08);
  assign new_n100_ = ~x15 & x16;
  assign z08 = (~x17 & ~x18) | (x14 & ~x20);
  assign z09 = (~x17 & ~new_n103_ & x18) | (~x07 & ~x09 & ~x15 & x17 & ~x18);
  assign new_n103_ = (~new_n112_ | x07) & (x15 | (~new_n111_ & (x07 | (~new_n104_ & ~new_n114_))));
  ...
  assign new_n111_ = x05 & x08 & (~x12 | (~new_n72_ & x07));
  ...
  assign z10 = new_n116_ | (~x09 & (x07 ? ~new_n119_ : ~new_n118_));
  assign new_n116_ = ~x17 & (~x18 | (x08 & ~x15 & ~new_n117_ & x18));
  assign new_n117_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign new_n118_ = x05 ? ((~x17 | x18) & (x06 | x08 | x15 | x17)) : (x15 ? ((~x17 | x18) & (x06 | x08 | x17)) : (~x17 | x18));
  assign new_n119_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18 | ~x19);
  assign z12 = ~x09 & ((~new_n121_ & ~x07) | (new_n95_ & ~x15 & ~x05 & x07));
  assign new_n121_ = (x17 | ~new_n122_ | ~x18) & (~x15 | ~x17 | x18 | ~x00 | x05);
  assign new_n122_ = ~x21 & ((~new_n126_ & ~x04) | (~new_n123_ & ~x05) | (new_n127_ & x04 & x05));
  assign new_n123_ = ~new_n125_ & (x15 | (x08 ? (~new_n89_ | x14) : new_n124_));
  assign new_n124_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n125_ = ~x02 & x08 & x11 & x15;
  assign new_n126_ = (~x05 | ~x08 | x11 | ~x15) & (x05 | x06 | x08 | ~x12 | x15);
  assign new_n127_ = x08 & ~x12 & ~x15;
  assign z13 = ~x18 & (~x17 | (~x09 & x17 & (~x05 | (x05 & ~x07))));
  assign z14 = (~new_n130_ & ~x05) | (~x17 & (~x18 | (x05 & new_n134_ & x08)));
  assign new_n130_ = (~x15 | (x07 ? (~new_n133_ & (~new_n95_ | x09)) : (~new_n131_ & (~new_n95_ | x09)))) & (~new_n95_ | x15 | ~x07 | x09);
  assign new_n131_ = ~x02 & x08 & x11 & ~x17 & ~new_n132_ & x18;
  assign new_n132_ = ~x09 & (x09 | x21);
  assign new_n133_ = x18 & ~x19 & x08 & ~x17;
  assign new_n134_ = ~x15 & ((x04 & new_n135_ & ~x07) | (x07 & x18 & ~x19));
  assign new_n135_ = ~x12 & (x09 | (~x09 & x18 & ~x21));
  assign z15 = ~x18 & (~x17 | (x05 & ~x07 & ~x09 & ~x15 & x17));
  assign z16 = ~x17 & (~x18 | (x08 & (x05 ? new_n144_ : ~new_n138_)));
  assign new_n138_ = (x07 | new_n139_ | x15) & (~x09 | ~x15 | (x02 & (~x07 | ~x18)));
  assign new_n139_ = x09 ? x19 : (x14 | new_n140_ | x21);
  assign new_n140_ = (~x06 | (~new_n141_ & ~new_n142_)) & (~new_n143_ | x06) & (~new_n89_ | ~x18);
  ...
  assign z17 = ~new_n146_ & ~x09;
  assign new_n146_ = (new_n147_ | x05) & (~new_n150_ | x07 | ~x08 | x04 | ~x05);
  assign new_n147_ = (~new_n95_ | ~x07 | x15) & (x07 | ((~new_n95_ | ~x00 | ~x15) & (x08 | ~new_n148_ | x15)));
  assign new_n148_ = ~x17 & ~new_n58_ & ~new_n149_ & x18;
  assign new_n149_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n150_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x17 & (~x18 | (~x05 & ~x07 & ~x09 & ~new_n152_ & x18));
  assign new_n152_ = (x08 | ~x15 | ~x19) & (x14 | (~new_n79_ & ~new_n153_) | x15);
  ...
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n163_ | (~x09 & ~new_n158_ & x18))));
  assign new_n158_ = ~new_n159_ & (x05 | ~new_n162_ | x06);
  ...
  assign new_n165_ = (x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x05 | ~x06 | x08 | x09 | x15 | ~x18);
  assign new_n166_ = x18 & (x09 | ~x15 | ~x18 | x05 | ~x07 | ~x08);
  assign z22 = ~x17 & x18 & ((~new_n169_ & ~x07) | (~x05 & new_n168_ & x07));
  assign new_n168_ = x08 & ~new_n72_ & x15;
  ...
  assign new_n172_ = (x05 | x08 | x15) & (~x08 | ~x18 | new_n173_ | x21);
  ...
  assign z27 = (~x09 & (new_n183_ | (~x17 & ~new_n178_ & x18))) | (~x17 & (new_n181_ | ~x18));
  assign new_n178_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n179_ & (~x05 | x08 | x15 | ~x19));
  assign new_n179_ = ~x21 & (new_n180_ | (~new_n126_ & ~x04));
  assign new_n180_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n181_ = new_n182_ & x03 & ~x05 & ~x07;
  assign new_n182_ = x08 & x09 & ~x15 & x19;
  assign new_n183_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & ~new_n185_ & x18) | (~x09 & x17 & ~new_n191_ & ~x18);
  assign new_n185_ = (~x08 | ((new_n186_ | x05) & (new_n190_ | x07))) & (x05 | x07 | ~new_n189_ | x08);
  assign new_n186_ = ~new_n187_ & (x07 | x09 | ~x10 | ~new_n188_ | ~x12);
  assign new_n187_ = x15 & ((~x02 & ~x07 & ~new_n132_ & x11) | ~x11 | (~new_n72_ & x07));
  assign new_n188_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n189_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n92_ & x21));
