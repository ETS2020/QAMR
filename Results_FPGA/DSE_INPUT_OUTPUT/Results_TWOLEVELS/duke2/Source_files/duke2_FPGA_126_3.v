...
module FAU ( 
  ...
  assign new_n123_ = x05 ? ((~x17 | x18) & (x06 | x08 | x15 | ~x18)) : (x15 ? ((~x17 | x18) & (x06 | x08 | ~x18)) : (~x17 | x18));
  ...
  assign z12 = ~x09 & ((~new_n129_ & ~x07) | (~x05 & x07 & new_n99_ & ~x15));
  ...
  assign new_n138_ = (new_n139_ | x05) & (~x04 | ~x05 | ~new_n143_ | ~x08);
  assign new_n139_ = (new_n140_ | ~x15) & (~new_n142_ | x18 | x21 | x15 | x17);
  assign new_n140_ = (~new_n141_ | x02) & (~new_n99_ | x09);
  assign new_n141_ = x08 & x11 & ~x17 & x18 & (x09 | (~x09 & ~x21));
  assign new_n142_ = x04 & ~x09 & x12 & ~x14;
  assign new_n143_ = ~x12 & ~x15 & x18 & (x09 | (~x09 & ~x17 & ~x21));
  ...
  assign new_n149_ = (x07 | new_n150_ | x15) & (~x09 | ~x15 | (x02 & (~x07 | x17)));
  assign new_n150_ = x09 ? x19 : (x14 | new_n151_ | x21);
  assign new_n151_ = (~x06 | (~new_n152_ & ~new_n153_)) & (~new_n154_ | x06) & (~new_n94_ | x17);
  assign new_n152_ = x02 & ((~x10 & x13 & ~x17) | (x04 & ~x12));
  ...
  assign new_n157_ = (~new_n99_ | ~x07 | x15) & (x07 | ((~new_n99_ | ~x00 | ~x15) & (x08 | ~new_n158_ | x15)));
  assign new_n158_ = ~x17 & x18 & ~new_n61_ & ~new_n159_;
  assign new_n159_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n160_ = new_n101_ & ~x11 & x15;
  assign z18 = x18 & (x17 | (~x05 & ~x07 & ~x09 & ~new_n162_ & ~x17));
  assign new_n162_ = (x14 | x15 | (~new_n84_ & ~new_n163_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n178_ = (x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign new_n179_ = ~x17 & (x09 | ~x15 | x17 | x05 | ~x07 | ~x08);
  assign z22 = ~x17 & ~new_n181_ & x18;
  assign new_n181_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = x18 & (x17 | (new_n66_ & ~x05 & x09 & ~x15 & ~x17));
  assign z24 = (~x09 & (new_n188_ | (~new_n184_ & ~x07))) | (x17 & x18);
  assign new_n184_ = (x05 | x08 | x15 | ~x18) & (~new_n185_ | x17);
  ...
  assign new_n188_ = new_n189_ & x01 & ~x05 & x07;
  assign new_n189_ = x08 & ~x15 & ~x17 & ~x18;
  assign z25 = new_n191_ & ~x05;
  assign new_n191_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = (x17 & x18) | (~x20 & (x14 | x21));
  assign z27 = (~new_n198_ & x18) | (~x09 & (new_n200_ | (~new_n194_ & x18)));
  assign new_n194_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : ~new_n195_;
  assign new_n195_ = ~x17 & (new_n197_ | (~x21 & (new_n196_ | (~new_n134_ & ~x04))));
  assign new_n196_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n197_ = ~x15 & x19 & x05 & ~x08;
  assign new_n198_ = ~x17 & (~new_n199_ | ~x03 | x05 | x07);
  assign new_n199_ = ~x15 & x19 & x08 & x09;
  assign new_n200_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n210_ | (~new_n202_ & x18))) | (~x09 & x17 & ~new_n212_ & ~x18);
  assign new_n202_ = (x07 | ((new_n203_ | ~x08) & (x05 | ~new_n208_ | x08))) & (x05 | ~new_n209_ | ~x08);
  assign new_n203_ = new_n207_ & (x05 | (~new_n204_ & (x09 | ~new_n206_ | ~x10)));
  assign new_n204_ = x11 & (new_n205_ | (~x02 & x15 & (x09 | (~x09 & ~x21))));
