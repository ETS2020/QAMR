...
module FAU ( 
  ...
  assign z23 = (new_n65_ & ~x05 & new_n79_ & ~x17 & x18) | (~x16 & ~x18);
  ...
  assign z14 = (~new_n145_ & ~x17) | (~x18 & (~x16 | (new_n151_ & ~x05)));
  ...
  assign new_n149_ = (~x16 | (~new_n150_ & (~x11 | ~x15 | ~x02 | ~x07))) & (~x07 | ~x15 | (x02 & x11));
  assign new_n150_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n151_ = ~x09 & ((~x01 & x07) | (x16 & x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n153_ & ~x18;
  assign new_n153_ = x17 & x16 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = new_n83_ | (x08 & ~x17 & (x05 ? new_n161_ : ~new_n155_));
  assign new_n155_ = (x07 | new_n156_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n156_ = x09 ? (~x18 | x19) : (x14 | new_n157_ | x21);
  assign new_n157_ = (~new_n160_ | ~x06) & (~x18 | (~new_n158_ & ~new_n96_ & (~new_n159_ | x06)));
  ...
  assign new_n163_ = (~new_n102_ | ~x07 | x15) & (x07 | ((x08 | ~new_n164_ | x15) & (~new_n102_ | ~x00 | ~x15)));
  ...
  assign new_n168_ = (x14 | (~new_n86_ & ~new_n169_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign z21 = (~x16 & ~x18) | (~x17 & ~new_n185_ & x18);
  ...
  assign z27 = new_n199_ | new_n83_ | (new_n204_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n204_ = new_n79_ & ~x17 & x18 & x19;
  assign z28 = (~new_n213_ & ~x18) | (~x17 & ((new_n215_ & ~x05) | (~new_n206_ & x18)));
  assign new_n206_ = (~x08 | ((new_n207_ | x05) & (new_n212_ | x07))) & (x05 | x07 | ~new_n211_ | x08);
  ...
  assign new_n213_ = x16 & (~new_n214_ | x09);
