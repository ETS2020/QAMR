...
module FAU ( 
  ...
  assign new_n55_ = x05 ? (x15 & (x07 | x13)) : (x13 | (x07 ? ~x15 : (x15 & (x00 | ~x15))));
  ...
  assign new_n80_ = new_n81_ & ~x17 & x18 & new_n65_ & ~x05;
  ...
  assign new_n102_ = x00 & ~x13 & x15 & x17 & ~x18;
  assign new_n103_ = new_n104_ & x07 & ~x13;
  ...
  assign z09 = (~new_n124_ & ~x18) | (~x17 & (new_n111_ | (new_n122_ & x05)));
  assign new_n111_ = ~x07 & ((x08 & (new_n112_ | new_n120_)) | (new_n116_ & ~x09));
  assign new_n112_ = x18 & ((~new_n113_ & ~x09) | (~new_n115_ & (x09 | ~x21)));
  assign new_n113_ = (~x05 | ~x21) & (~new_n114_ | x15 | x21 | ~x13 | x14);
  assign new_n114_ = ~x06 & ~x10 & x02 & ~x05;
  assign new_n115_ = (~x02 | x05 | x11 | ~x15) & (~x12 | x15 | x04 | ~x05);
  assign new_n116_ = ~x15 & ((new_n119_ & x05 & ~x08) | (~x05 & ~new_n117_ & ~x21));
  assign new_n117_ = ~new_n118_ & (x02 | ~x06 | x08 | ~x11 | ~x18);
  assign new_n118_ = x04 & ((~x06 & ~x08 & ~x12 & x18) | (x12 & ~x14 & ~x18));
  assign new_n119_ = x18 & ~x19;
  assign new_n120_ = x02 & ~x09 & x13 & ~x14 & new_n121_ & ~x15;
  assign new_n121_ = ~x21 & ((x04 & ~x12) | (~x05 & (x10 ? x12 : x06)));
  assign new_n122_ = x08 & ~x15 & x18 & (new_n123_ | ~x12);
  assign new_n123_ = x07 & (x09 | ~x19 | (~x09 & x19));
  assign new_n124_ = ~x13 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | x13)));
  ...
  assign new_n128_ = (x05 | x13 | ~x17 | x18) & (x17 | ~x18 | ~x19 | ~new_n129_ | ~x05);
  assign new_n129_ = x08 & ~x15;
  assign new_n130_ = (~x13 | x18) & (~x08 | x15 | x17 | new_n131_ | ~x18);
  assign new_n131_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign z11 = ~x18 & new_n133_ & ~x17;
  assign new_n133_ = ~x15 & ~x13 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n135_ & ~x07) | (new_n104_ & ~x05 & x07 & ~x13));
  ...
  assign z14 = (~new_n145_ & ~x17) | (~x18 & (x13 | (new_n151_ & ~x05)));
  ...
  assign new_n149_ = ~new_n150_ & (~x07 | ~x15 | (x02 & x11 & (~x02 | ~x11 | x13)));
  assign new_n150_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n151_ = ~x09 & ((~x01 & x07) | (~x13 & x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n153_ & ~x18;
  assign new_n153_ = ~x13 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = new_n78_ | (x08 & ~x17 & (x05 ? new_n161_ : ~new_n155_));
  assign new_n155_ = (x07 | new_n156_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n156_ = x09 ? ~new_n119_ : (x14 | new_n157_ | x21);
  assign new_n157_ = (~x06 | (~new_n158_ & ~new_n159_)) & (~x18 | (~new_n97_ & (~new_n160_ | x06)));
  ...
  assign z17 = ~x09 & ((~new_n163_ & ~x05) | (new_n166_ & new_n65_ & ~x04 & x05));
  assign new_n163_ = ~new_n103_ & (x07 | (~new_n102_ & (~new_n164_ | x08)));
  assign new_n164_ = ~x15 & ~x17 & ~new_n61_ & ~new_n165_ & x18;
  assign new_n165_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n166_ = new_n106_ & ~x11 & x15;
  ...
  assign new_n173_ = x17 & ~x15 & ~x13 & ~x09 & ~x05 & ~x07;
  assign z20 = new_n78_ | (~x07 & ~x17 & (new_n182_ | (~new_n175_ & ~x09)));
  ...
  assign z22 = (x13 & ~x18) | (~x17 & (new_n187_ | new_n188_) & x18);
