...
module FAU ( 
  ...
  assign z02 = ~x17 & (new_n68_ | (new_n78_ & x01 & ~x05 & x07));
  assign new_n68_ = x18 & ((~new_n69_ & ~x07) | (x08 & (~new_n77_ | (~new_n76_ & x07))));
  ...
  assign z03 = (~new_n80_ & ~x09) | (new_n84_ & x09 & ~x15 & ~x17 & x18);
  assign new_n80_ = x07 ? ((~new_n82_ | x05) & (~new_n81_ | ~x08)) : (x05 ? (~new_n82_ & (~new_n83_ | x08)) : ~new_n82_);
  assign new_n81_ = ~x17 & ~new_n76_ & x18;
  ...
  assign new_n103_ = new_n82_ & x00 & x15;
  assign new_n104_ = new_n82_ & x07 & ~x15;
  ...
  assign z09 = (~new_n124_ & ~x18) | (~x17 & (new_n122_ | (~new_n111_ & x18)));
  assign new_n111_ = ~new_n121_ & (x07 | (~new_n120_ & (x15 | (~new_n112_ & ~new_n119_))));
  ...
  assign new_n119_ = ~x04 & x05 & x08 & ~new_n73_ & x12;
  assign new_n120_ = x08 & ((x02 & ~x05 & ~x11 & ~new_n73_ & x15) | (new_n73_ & x05));
  ...
  assign z10 = (~new_n126_ & ~x09) | (~x16 & ~x18) | (x08 & new_n129_ & x09);
  assign new_n126_ = x07 ? ((~new_n82_ | x05) & (~new_n83_ | ~x05 | ~x08)) : new_n127_;
  assign new_n127_ = x05 ? ((~x16 | ~x17 | x18) & (~new_n128_ | x15 | x17 | ~x18)) : ((~x15 | ((~x16 | ~x17 | x18) & (~new_n128_ | x17 | ~x18))) & (x15 | ~x16 | ~x17 | x18));
  assign new_n128_ = ~x06 & ~x08;
  assign new_n129_ = ~x15 & ~x17 & x18 & (~x05 ^ x07);
  assign z11 = ~x18 & new_n131_ & ~x17;
  assign new_n131_ = x16 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (~x16 & ~x18) | (~x09 & (new_n133_ | (new_n141_ & x16 & x17 & ~x18)));
  ...
  assign new_n140_ = new_n82_ & x00 & ~x05 & x15;
  assign new_n141_ = ~x05 & x07 & ~x15;
  assign z13 = ~x09 & x16 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n144_ & ~x17) | (~x18 & (~x16 | (new_n149_ & ~x05)));
  ...
  assign new_n147_ = (~x16 | (~new_n148_ & (~x11 | ~x15 | ~x02 | ~x07))) & (~x07 | ~x15 | (x02 & x11));
  assign new_n148_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n149_ = ~x09 & ((~x01 & x07) | (x16 & x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n151_ & ~x18;
  assign new_n151_ = x16 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign new_n160_ = (~new_n82_ | ~x07 | x15) & (x07 | ((x08 | ~new_n161_ | x15) & (~new_n82_ | ~x00 | ~x15)));
  ...
  assign new_n165_ = (x14 | x15 | (~new_n166_ & ~new_n88_)) & (x08 | ~x15 | ~x19);
  assign new_n166_ = x12 & ((~new_n167_ & ~x06) | (new_n168_ & x06 & x08 & x10));
  assign new_n167_ = (x04 | x08 | ~x21) & (~new_n93_ | ~x08 | ~x10);
  assign new_n168_ = ~x13 & x16 & ~x21;
  assign z19 = ~new_n170_ & ~x18;
  assign new_n170_ = x16 & (x05 | x07 | x09 | x15 | ~x16 | ~x17);
  ...
  assign new_n176_ = new_n177_ & x12 & ~x14 & x04 & ~x05;
  assign new_n177_ = ~x18 & ~x21 & ~x15 & x16;
  assign new_n178_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n179_ = new_n71_ & x04 & x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n183_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign z27 = new_n196_ | (new_n201_ & x03 & ~x05 & ~x07 & x08);
  assign new_n196_ = ~x09 & ((new_n200_ & ~x05) | (~x17 & ~new_n197_ & x18));
  ...
  assign z28 = (~new_n209_ & ~x18) | (~x17 & ((~new_n203_ & x18) | (new_n211_ & ~x05)));
  ...
  assign new_n207_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n101_ & x21));
  assign new_n208_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n209_ = x16 & (x09 | new_n210_ | ~x17);
  assign new_n210_ = x05 ? (x07 | ~x16) : (~x15 | (x19 & (x07 | ~x16)));
