...
module FAU ( 
  ...
  assign z01 = (x18 & (x17 | (~new_n58_ & ~x07))) | (new_n68_ & new_n64_ & ~x17 & ~x18);
  assign new_n58_ = (new_n59_ | x05) & (~new_n67_ | x04 | ~x05 | ~x08 | x09);
  assign new_n59_ = ~new_n63_ & (x09 | (~new_n66_ & ((~new_n60_ & ~new_n65_) | x15)));
  assign new_n60_ = ~x17 & (new_n61_ | (~x02 & x08 & new_n62_ & x11));
  ...
  assign new_n65_ = ~x02 & x06 & ~x08 & x11 & ~x21;
  assign new_n66_ = ~x02 & x08 & x11 & x15 & ~x17 & ~x21;
  assign new_n67_ = ~x17 & ~x21 & ~x11 & x15;
  ...
  assign z06 = new_n85_ | (~x09 & (new_n103_ | (~x05 & (new_n95_ | new_n105_))));
  assign new_n95_ = ~x07 & (new_n102_ | (x18 & (new_n66_ | (~new_n96_ & ~x15))));
  assign new_n96_ = ~new_n65_ & (x17 | (~new_n101_ & (x14 | (~new_n90_ & new_n97_))));
  ...
  assign new_n101_ = new_n100_ & ~x08 & ~x12 & ~x21;
  assign new_n102_ = x00 & x15 & x17 & ~x18;
  assign new_n103_ = new_n104_ & ~x12 & ~x15 & new_n83_ & x04 & x05;
  assign new_n104_ = ~x17 & x18 & ~x21;
  assign new_n105_ = x07 & ~x15 & x17 & ~x18;
  assign z07 = x18 & (new_n107_ | x17 | (~x09 & new_n108_ & ~x17));
  assign new_n107_ = new_n83_ & ~x05 & x09 & ~x15 & x16;
  assign new_n108_ = (x05 ^ x15) & (~x07 ^ x08);
  assign z08 = x14 & ~new_n85_ & ~x20;
  assign z09 = (~new_n111_ & x18) | (~x07 & ~x09 & ~x15 & ~new_n125_ & ~x18);
  assign new_n111_ = new_n124_ & (x07 | (~new_n122_ & (x15 | (~new_n112_ & ~new_n120_))));
  assign new_n112_ = ~x09 & (new_n119_ | (~x21 & (new_n113_ | (~new_n116_ & ~x05))));
  assign new_n113_ = x04 & ~x12 & (new_n114_ | new_n115_);
  assign new_n114_ = x02 & x08 & x13 & ~x14;
  assign new_n115_ = ~x08 & ~x17 & ~x05 & ~x06;
  assign new_n116_ = (~x06 | (~new_n117_ & (x02 | x08 | ~x11))) & (~x02 | ~new_n118_ | ~x08);
  assign new_n117_ = x02 & x08 & ~x10 & x13 & ~x14 & ~x17;
  assign new_n118_ = x13 & ~x14 & ~x17 & (x10 ? x12 : ~x06);
  assign new_n119_ = ~x17 & ~x19 & x05 & ~x08;
  assign new_n120_ = new_n121_ & ~x04;
  assign new_n121_ = x05 & x08 & x12 & ~x17 & (x09 | ~x21);
  assign new_n122_ = x08 & (new_n123_ | (~x17 & x21 & x05 & ~x09));
  assign new_n123_ = x02 & ~x05 & ~x11 & x15 & (x09 | ~x21);
  assign new_n124_ = ~x17 & (~x05 | ~x08 | x15 | x17 | (~x07 & x12));
  assign new_n125_ = x05 ? ~x17 : (~x17 & (~x04 | ~x12 | x14 | x17 | x21));
  assign z10 = (~new_n129_ & x18) | (~x09 & (x07 ? ~new_n128_ : ~new_n127_));
  assign new_n127_ = x05 ? ((~x17 | x18) & (x15 | ~x18 | x06 | x08)) : (x15 ? ((~x17 | x18) & (x17 | ~x18 | x06 | x08)) : (~x17 | x18));
  assign new_n128_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n129_ = ~x17 & (~x08 | ~x09 | x15 | x17 | (x05 ^ x07));
  assign z11 = new_n131_ & ~x18;
  assign new_n131_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n85_ | (~x09 & ((~new_n133_ & ~x07) | (new_n142_ & ~x05 & x07)));
  assign new_n133_ = ~new_n141_ & (~x18 | x21 | (~new_n140_ & (new_n134_ | x17)));
  ...
  assign new_n142_ = ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n145_ & ~x07) | new_n85_ | (~new_n151_ & x07);
  assign new_n145_ = (new_n146_ | x05) & (~x04 | ~x05 | ~new_n150_ | ~x08);
  assign new_n146_ = (~new_n149_ | x15 | x17 | x18 | x21) & (new_n147_ | ~x15);
  assign new_n147_ = (~new_n148_ | x02) & (x09 | ~x17 | x18);
  assign new_n148_ = x08 & x11 & x18 & (x09 | (~x09 & ~x17 & ~x21));
  assign new_n149_ = x04 & ~x09 & x12 & ~x14;
  assign new_n150_ = ~x12 & ~x15 & ~x17 & x18 & (x09 | (~x09 & ~x21));
  assign new_n151_ = (~x08 | ~new_n152_ | ~x18) & (x05 | x09 | new_n153_ | x18);
  assign new_n152_ = ~x19 & (~x05 ^ ~x15);
  assign new_n153_ = ~x17 & x01 & (~x15 | x17 | (x02 & x11 & (~x02 | ~x11)));
  ...
  assign z17 = ~x09 & (new_n166_ | (~x05 & (new_n105_ | (~new_n163_ & ~x07))));
  ...
  assign new_n166_ = new_n83_ & ~x04 & x05 & new_n104_ & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n168_ & x18;
  assign new_n168_ = (x14 | x15 | (~new_n169_ & ~new_n88_)) & (x08 | ~x15 | ~x19);
  assign new_n169_ = x12 & ((~new_n170_ & ~x06) | (new_n171_ & x06 & x08 & x10));
  ...
  assign new_n175_ = ~x21 & (x04 ? (new_n176_ & ~x12) : ~new_n138_);
  ...
  assign new_n181_ = new_n73_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign z22 = ~new_n185_ & x18;
  assign new_n185_ = (new_n186_ | x07) & ~x17 & (x05 | ~x07 | ~x08 | ~x15 | x17);
  assign new_n186_ = (x05 | ((x15 | x17 | ~x08 | ~x09) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  assign z23 = new_n188_ & x18;
  assign new_n188_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = new_n85_ | (~new_n190_ & ~x09);
  assign new_n190_ = (new_n191_ | x07) & (~new_n195_ | ~x01 | x05 | ~x07);
  assign new_n191_ = (x15 | ~x18 | x05 | x08) & (~new_n192_ | x17);
  assign new_n192_ = ~x21 & ((x08 & new_n194_ & x15) | (x04 & ~new_n193_ & ~x15));
  assign new_n193_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n194_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n195_ = ~x17 & ~x18 & x08 & ~x15;
  assign z25 = new_n197_ & ~x05;
  assign new_n197_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = new_n85_ | (~x20 & (x21 | (~new_n85_ & x14)));
  assign z27 = new_n200_ | (new_n205_ & new_n83_ & x03 & ~x05);
  assign new_n200_ = ~x09 & ((~x17 & ~new_n201_ & x18) | (~x05 & x17 & ~new_n204_ & ~x18));
  assign new_n201_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n202_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n202_ = ~x21 & (new_n203_ | (~new_n138_ & ~x04));
  assign new_n203_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n204_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n205_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n214_ | (~new_n207_ & x18))) | (~x09 & x17 & ~new_n216_ & ~x18);
  assign new_n207_ = (~x08 | ((new_n208_ | x05) & (new_n213_ | x07))) & (x05 | x07 | ~new_n211_ | x08);
  ...
  assign new_n211_ = ~x09 & ((x15 & ~x19) | (~x14 & new_n212_ & ~x15));
  assign new_n212_ = x21 & ((x04 & ~x06 & ~x12) | (~x02 & x06 & x11));
