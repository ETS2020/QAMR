...
module FAU ( 
  ...
  assign new_n69_ = (new_n70_ | ~x18) & (~new_n78_ | x15 | x18 | ~x08 | x09);
  ...
  assign z06 = ~x09 & (new_n104_ | (~x05 & (new_n101_ | (~new_n93_ & ~x07))));
  assign new_n93_ = (x17 | ~x18 | (~new_n63_ & (new_n94_ | x15))) & (~new_n100_ | ~x15 | ~x17 | x18);
  ...
  assign z09 = new_n122_ | (~x17 & (new_n123_ | (~new_n110_ & x18)));
  ...
  assign new_n122_ = ~x07 & x08 & new_n102_ & ~x09;
  ...
  assign z11 = ~x18 & (~x08 | (new_n78_ & x08 & ~x09 & ~x15 & ~x17));
  ...
  assign new_n138_ = new_n103_ & x15 & x00 & ~x05 & x08;
  ...
  assign new_n144_ = ~x09 & ~x18 & (new_n145_ | (new_n64_ & x02 & x07));
  ...
  assign new_n149_ = x08 & (~x05 | x07 | ~x08 | x09 | x15 | ~x17);
  ...
  assign new_n158_ = (~x07 | ~x08 | ~new_n103_ | x15) & (x07 | ((x08 | ~new_n159_ | x15) & (~new_n103_ | ~x15 | ~x00 | ~x08)));
  ...
  assign z18 = new_n82_ | (~x05 & ~x07 & ~x09 & new_n163_ & ~x17);
  ...
  assign new_n168_ = x08 & (x09 | x15 | ~x17 | x05 | x07 | ~x08);
  assign z20 = new_n82_ | (~x07 & ~x17 & (new_n177_ | (~new_n170_ & ~x09)));
  ...
  assign new_n174_ = new_n175_ & x08 & x12 & x04 & ~x05;
  assign new_n175_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n176_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n177_ = x04 & x05 & x08 & new_n178_ & x09 & ~x12;
  assign new_n178_ = ~x15 & x18;
  assign z21 = (~x08 & ~x18) | (~x17 & ~new_n180_ & x18);
  ...
  assign z24 = ~x09 & ~x17 & (new_n189_ | (~new_n186_ & ~x07));
  assign new_n186_ = (~x08 | x21 | (~new_n187_ & ~new_n188_)) & (~new_n178_ | x05 | x08);
  ...
  assign new_n199_ = ~new_n82_ & (~new_n200_ | ~new_n66_ | ~x03 | x05);
  assign new_n200_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & ((~new_n202_ & x18) | (new_n210_ & ~x05))) | (~new_n208_ & ~x18);
  ...
  assign new_n208_ = x08 & (~new_n209_ | x09);
  assign new_n209_ = x17 & (x05 ? new_n66_ : (x15 & (new_n66_ | ~x19)));
