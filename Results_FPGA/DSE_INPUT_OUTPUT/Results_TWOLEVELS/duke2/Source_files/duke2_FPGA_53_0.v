...
module FAU ( 
  ...
  assign z02 = new_n68_ | (~x17 & (new_n77_ | (~new_n70_ & ~x09)));
  ...
  assign new_n81_ = ~x17 & x18 & x09 & ~x15 & new_n65_ & ~x05;
  ...
  assign new_n124_ = new_n125_ & x04 & ~x05 & ~x07 & ~x09 & x10;
  assign new_n125_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n126_ = ~x07 & ~x09 & new_n105_ & x10;
  ...
  assign z11 = ~x18 & (new_n133_ | ~x10);
  assign new_n133_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = ~x09 & ((~new_n135_ & ~x07) | (new_n105_ & ~x05 & x07 & x10));
  ...
  assign new_n151_ = x10 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = ~x18 & (~x10 | (new_n153_ & x05 & x10 & ~x15 & x17));
  ...
  assign z17 = ~x09 & (new_n165_ | (~x05 & (new_n104_ | (~new_n162_ & ~x07))));
  ...
  assign z19 = ~x18 & (~x10 | (new_n153_ & ~x05 & x10 & ~x15 & x17));
  ...
  assign new_n180_ = ~x15 & x18 & x09 & ~x12 & new_n73_ & x04;
  ...
  assign new_n189_ = (x12 | ~x18 | ~x05 | ~x08) & (~x12 | x14 | x18 | x05 | ~x10);
  ...
  assign new_n201_ = ~new_n68_ & (~new_n202_ | ~new_n65_ | ~x03 | x05);
