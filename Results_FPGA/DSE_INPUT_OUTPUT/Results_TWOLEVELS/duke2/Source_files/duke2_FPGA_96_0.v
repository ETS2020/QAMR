...
module FAU ( 
  ...
  assign new_n115_ = ~x09 & new_n95_ & ~x15;
  ...
  assign new_n119_ = x05 ? ((~x17 | x18) & (x06 | x08 | x15 | x17)) : (x15 ? ((~x17 | x18) & (x06 | x08 | x17)) : (~x17 | x18));
  assign new_n120_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18 | ~x19);
  assign z12 = ~x09 & ((~new_n122_ & ~x07) | (~x05 & x07 & new_n95_ & ~x15));
  ...
  assign z14 = (~new_n131_ & ~x05) | (~x17 & (~x18 | (x05 & new_n135_ & x08)));
  assign new_n131_ = (~x15 | (x07 ? (~new_n134_ & (~new_n95_ | x09)) : (~new_n132_ & (~new_n95_ | x09)))) & (~x07 | x09 | ~new_n95_ | x15);
  assign new_n132_ = new_n133_ & ~x02;
  assign new_n133_ = x08 & x11 & ~x17 & x18 & (x09 | (~x09 & ~x21));
  assign new_n134_ = x08 & ~x17 & x18 & ~x19;
  assign new_n135_ = ~x15 & ((x04 & new_n136_ & ~x07) | (x07 & x18 & ~x19));
  ...
  assign new_n141_ = (~x06 | (~new_n142_ & (~x12 | new_n143_ | x16))) & ~new_n89_ & (x06 | ~x12 | new_n143_ | ~x16);
  ...
  assign new_n152_ = (x14 | (~new_n79_ & ~new_n153_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n163_ = new_n62_ & x04 & x09 & ~x12 & ~x15;
  ...
  assign z28 = (~x17 & ~new_n185_ & x18) | (~x09 & x17 & ~new_n192_ & ~x18);
  ...
  assign new_n190_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n92_ & x21));
