...
module FAU ( 
  ...
  assign new_n55_ = x05 ? (x15 & (x07 | ~x19)) : (~x19 | (x07 ? ~x15 : (x15 & (x00 | ~x15))));
  ...
  assign z02 = ~x17 & ((new_n77_ & x08) | ((new_n69_ | new_n73_) & ~x09));
  ...
  assign new_n109_ = (x09 | (x07 ? (~x08 | (~x05 ^ x15)) : (x08 | (~x05 ^ x15)))) & (~x09 | x15 | ~x16 | x05 | x07 | ~x08);
  assign z08 = new_n67_ | (x14 & ~new_n67_ & ~x20);
  assign z09 = (~new_n126_ & ~x18) | (~x17 & ((new_n123_ & ~x07) | (~new_n112_ & x18)));
  assign new_n112_ = (x15 | (~new_n121_ & (new_n113_ | x07))) & (x07 | new_n122_ | ~x08);
  assign new_n113_ = ~new_n120_ & (x21 | (~new_n119_ & ((~new_n114_ & ~new_n116_) | x09)));
  ...
  assign new_n119_ = x08 & x12 & ~x04 & x05;
  assign new_n120_ = ~x04 & x05 & x08 & x09 & x12;
  assign new_n121_ = x05 & x08 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  assign new_n122_ = (~x02 | x05 | x11 | ~x15 | (~x09 & x21)) & (~x05 | x09 | ~x21);
  assign new_n123_ = ~x09 & ~x15 & (new_n124_ | (x05 & ~x08 & ~x19));
  assign new_n124_ = new_n125_ & ~x14 & ~x18 & ~x21;
  assign new_n125_ = x04 & ~x05 & x12;
  assign new_n126_ = x19 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | ~x19)));
  ...
  assign z17 = new_n67_ | (~x09 & (new_n166_ | (~new_n163_ & ~x05)));
  ...
  assign new_n168_ = (x14 | (~new_n169_ & ~new_n88_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n173_ = x19 & (x05 | x07 | x09 | x15 | ~x17 | ~x19);
  assign z20 = new_n67_ | (~x07 & ~x17 & (new_n181_ | (~new_n175_ & ~x09)));
  assign new_n175_ = ~new_n179_ & (~x18 | (~new_n176_ & (x05 | ~new_n180_ | x06)));
  assign new_n176_ = ~x21 & (x04 ? new_n177_ : ~new_n142_);
  assign new_n177_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n178_ : ~x06));
  assign new_n178_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n179_ = new_n125_ & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n180_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n181_ = new_n182_ & x04 & x05 & x08;
  assign new_n182_ = x09 & ~x12 & ~x15 & x18;
  assign z21 = (~x18 & ~x19) | (~x17 & ~new_n184_ & x18);
  assign new_n184_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = (~x18 & ~x19) | (~x17 & x18 & (new_n186_ | new_n187_));
  ...
  assign z28 = (~new_n216_ & ~x18) | (~x17 & ((new_n215_ & ~x05) | (~new_n208_ & x18)));
  assign new_n208_ = (~x08 | ((new_n214_ | x07) & (new_n209_ | x05))) & (x05 | x07 | ~new_n213_ | x08);
