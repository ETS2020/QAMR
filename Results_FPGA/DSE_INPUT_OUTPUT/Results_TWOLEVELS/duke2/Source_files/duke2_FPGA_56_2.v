...
module FAU ( 
  ...
  assign new_n138_ = (~x06 | (~new_n139_ & (~x12 | new_n140_ | x16))) & ~new_n91_ & (x06 | ~x12 | new_n140_ | ~x16);
  ...
  assign new_n147_ = (x14 | x15 | (~new_n148_ & ~new_n81_)) & (x08 | ~x15 | ~x19);
  assign new_n148_ = x12 & ((new_n150_ & x06 & x08 & x10) | (~new_n149_ & ~x06));
  assign new_n149_ = (x04 | x08 | ~x21) & (~new_n86_ | ~x08 | ~x10);
