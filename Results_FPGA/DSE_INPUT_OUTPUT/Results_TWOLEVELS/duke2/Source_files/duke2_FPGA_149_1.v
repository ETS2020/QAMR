...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n71_, new_n73_, new_n74_, new_n75_, new_n79_, new_n80_, new_n82_,
    new_n83_, new_n87_;
  ...
  assign z14 = (~x17 & x18) | (~x05 & ~x09 & ~new_n73_ & ~x18);
  assign new_n73_ = (new_n74_ | x15) & (x01 | ~x07) & (~x15 | (~x17 & (~x07 | new_n75_ | x17)));
  assign new_n74_ = (~x07 | ~x17) & (x14 | x17 | x21 | ~x04 | x07 | ~x12);
  assign new_n75_ = x02 & x11 & (~x02 | ~x11);
  assign z15 = (~x17 & x18) | (x05 & ~x07 & ~x09 & ~x15 & x17 & ~x18);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~new_n79_ & ~x17;
  assign new_n79_ = ~x18 & (~new_n80_ | x15 | x18 | x21 | ~x12 | x14);
  assign new_n80_ = ~x07 & ~x09 & x04 & ~x05;
  assign z24 = ~x17 & (x18 | (~x05 & ~x09 & ~x15 & ~new_n82_ & ~x18));
  assign new_n82_ = (~x01 | ~x07 | ~x08) & (~new_n83_ | ~x04 | x07);
  assign new_n83_ = x12 & ~x14 & ~x21;
  assign z26 = z16 | (~x20 & (x21 | (~z16 & x14)));
  assign z27 = z06 | z16;
