...
module FAU ( 
  ...
  assign z06 = ~x09 & ((x00 & ~new_n93_ & ~x07) | (new_n104_ & ~x05 & x07));
  assign new_n93_ = ~new_n102_ & (x05 | ((~x15 | ~x17 | x18) & (x17 | new_n94_ | ~x18)));
  ...
  assign new_n102_ = new_n103_ & x04 & x05 & x08 & ~x12;
  assign new_n103_ = x18 & ~x21 & ~x15 & ~x17;
  ...
  assign z09 = ~new_n122_ | (~new_n109_ & ~x17);
  assign new_n109_ = ~new_n120_ & (~x18 | ((new_n110_ | x15) & (~new_n118_ | x07)));
  assign new_n110_ = ~new_n115_ & (~x00 | (~new_n114_ & (~x08 | (~new_n111_ & ~new_n117_))));
  assign new_n111_ = ~x09 & (x07 ? x05 : (~x21 & (new_n112_ | new_n113_)));
  assign new_n112_ = x02 & ~x05 & ~x10 & x13 & ~x14;
  assign new_n113_ = x04 & x05 & ~x12;
  assign new_n114_ = ~x07 & ~x08 & ~x09 & (x05 ? ~x19 : new_n101_);
  assign new_n115_ = x02 & ~x07 & x08 & ~x09 & new_n116_ & x13;
  assign new_n116_ = ~x14 & ~x21 & ((x04 & ~x12) | (~x05 & x10 & x12));
  assign new_n117_ = x05 & (~x04 | (x09 & (x07 | ~x12)));
  assign new_n118_ = x08 & (new_n119_ | (~x09 & x21 & x00 & x05));
  assign new_n119_ = x02 & ~x05 & ~x11 & x15 & (x09 | ~x21);
  assign new_n120_ = new_n121_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n121_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n122_ = (x00 | ~x18) & (x07 | ~new_n104_ | x09);
  assign z10 = (~new_n128_ & ~x00) | (~x09 & (~new_n124_ | (~new_n129_ & x00))) | (new_n126_ & x00);
  assign new_n124_ = (x07 | (x05 ? ((~x17 | x18) & (~new_n125_ | x15 | x17 | ~x18)) : ((x15 | ~x17 | x18) & (~new_n125_ | ~x15 | x17 | ~x18)))) & (x05 | ~x07 | ~x17 | x18);
  assign new_n125_ = ~x06 & ~x08;
  assign new_n126_ = x08 & new_n127_ & x09;
  assign new_n127_ = ~x15 & ~x17 & x18 & (~x05 ^ x07);
  assign new_n128_ = ~x18 & (~x15 | ~x17 | x18 | x05 | x07 | x09);
  assign new_n129_ = (~x05 | ~x07 | ~x08 | x15 | x17 | ~x18) & (~x15 | ~x17 | x18 | x05 | x07);
  assign z11 = new_n131_ & ~x18;
  assign new_n131_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((x00 & ~new_n133_ & ~x07) | (new_n104_ & ~x05 & x07));
  assign new_n133_ = (x17 | ~x18 | new_n134_ | x21) & (x05 | ~x15 | ~x17 | x18);
  ...
  assign new_n138_ = (~x05 | ~x08 | x11 | ~x15) & (x08 | ~x12 | x15 | x05 | x06);
  assign new_n139_ = x08 & ~x12 & ~x15;
  assign z13 = new_n141_ | (new_n142_ & ~x09);
  assign new_n141_ = ~new_n128_ & ~x00;
  assign new_n142_ = x17 & ~x18 & (x05 ? ~x07 : (x07 | (~x07 & (~x15 | (x00 & x15)))));
  assign z14 = (~x17 & (new_n144_ | (~x05 & new_n148_ & ~x09))) | (~x05 & new_n150_ & ~x09);
  assign new_n144_ = x00 & new_n145_ & x08;
  ...
  assign z15 = (~x00 & x18) | (new_n104_ & x05 & ~x07 & ~x09);
  ...
  assign new_n155_ = ~x21 & ((x06 & (new_n156_ | new_n157_)) | new_n97_ | (new_n158_ & ~x06));
  ...
  assign z17 = ~x09 & ((x00 & ~new_n162_ & ~x07) | (new_n104_ & ~x05 & x07));
  assign new_n162_ = (new_n163_ | x05) & (~new_n165_ | x04 | ~x05 | ~x08 | x11);
  assign new_n163_ = (~x15 | ~x17 | x18) & (x08 | x15 | x17 | ~new_n164_ | ~x18);
  assign new_n164_ = ~new_n61_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n165_ = x15 & ~x17 & x18 & ~x21;
  assign z18 = x00 & ~x05 & ~x07 & ~x09 & new_n167_ & ~x17;
  assign new_n167_ = x18 & ((~x14 & ~new_n168_ & ~x15) | (~x08 & x15 & x19));
  assign new_n168_ = ~new_n86_ & (~x12 | (~new_n170_ & (new_n169_ | x06)));
  assign new_n169_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n170_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = (~x00 & x18) | (~x07 & ~x17 & (new_n179_ | (x00 & ~new_n173_ & x18)));
  assign new_n173_ = ~new_n177_ & (x09 | (~new_n174_ & (x05 | ~new_n178_ | x06)));
  ...
  assign new_n177_ = new_n65_ & x04 & x09 & ~x12 & ~x15;
  assign new_n178_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n179_ = new_n180_ & ~x09 & x12 & x04 & ~x05;
  assign new_n180_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign z21 = x18 & (~x00 | (~x17 & (new_n182_ | new_n183_)));
  assign new_n182_ = ~x07 & ((~x05 & ((~x09 & x15 & ~x06 & ~x08) | (x09 & ~x15 & x06 & x08))) | (x05 & x06 & ~x08 & ~x09 & ~x15));
  assign new_n183_ = x08 & ~x09 & x15 & x00 & ~x05 & x07;
  assign z22 = x18 & (~x00 | (~new_n185_ & ~x17));
  assign new_n185_ = (new_n186_ | x07) & (~x00 | x05 | ~x07 | ~x08 | ~x15);
  assign new_n186_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x00 | ~x08)));
  assign z23 = x18 & new_n188_ & ~x17;
  assign new_n188_ = ~x15 & x09 & x08 & ~x07 & x00 & ~x05;
  assign z24 = ~x09 & ~x17 & (new_n190_ | new_n195_);
  assign new_n190_ = ~x07 & ((new_n194_ & x00 & ~x05) | (~new_n191_ & ~x21));
  assign new_n191_ = (~x04 | new_n192_ | x15) & (~x00 | ~x08 | ~new_n193_ | ~x15);
  assign new_n192_ = (~x00 | ~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x05 | ~x12);
  assign new_n193_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n194_ = ~x08 & ~x15 & x18;
  ...
  assign z27 = new_n206_ | (x00 & (new_n204_ | (~new_n200_ & ~x09)));
  assign new_n200_ = (x17 | new_n201_ | ~x18) & (~x15 | ~x17 | x18 | x05 | x07);
  ...
  assign new_n206_ = new_n104_ & ~x05 & x07 & ~x09;
  assign z28 = new_n141_ | (~new_n208_ & ~x17) | (~x09 & new_n219_ & x17);
  assign new_n208_ = (~new_n218_ | x05) & (~x18 | (~new_n215_ & (new_n209_ | ~x08)));
  assign new_n209_ = (x05 | ((~new_n214_ | ~x00) & (~new_n210_ | x07))) & (new_n212_ | x07);
  assign new_n210_ = ~x09 & x10 & new_n211_ & x12;
  assign new_n211_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n212_ = ~new_n213_ & (~x15 | ~x21 | ~x00 | x09);
  assign new_n213_ = ~x04 & x05 & x12 & ~x15 & (x09 | ~x21);
  assign new_n214_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n215_ = x00 & ~x05 & ~x07 & new_n216_ & ~x08;
