...
module FAU ( 
  ...
  assign z09 = (new_n116_ & ~x07) | (~x17 & (~new_n115_ | (~new_n104_ & ~x07)));
  assign new_n104_ = ~new_n112_ & (x15 | ((~new_n114_ | x04) & (new_n105_ | x09)));
  ...
  assign z14 = (~new_n131_ & ~x05) | (~x17 & (~x18 | (new_n134_ & x05)));
  assign new_n131_ = (~x15 | (x07 ? (~new_n133_ & (~new_n97_ | x09)) : (~new_n132_ & (~new_n97_ | x09)))) & (~x07 | x09 | ~new_n97_ | x15);
  assign new_n132_ = ~x02 & x08 & x11 & ~x17 & (x09 | (new_n64_ & ~x09));
  assign new_n133_ = x08 & ~x17 & ~x19;
  assign new_n134_ = x08 & ~x15 & ((x07 & ~x19) | (x04 & new_n135_ & ~x07));
  assign new_n135_ = ~x12 & x18 & (x09 | (~x09 & ~x21));
  ...
  assign new_n140_ = (~x06 | (~new_n141_ & (~x12 | new_n142_ | x16))) & ~new_n92_ & (x06 | ~x12 | new_n142_ | ~x16);
  ...
  assign new_n145_ = (~new_n97_ | ~x07 | x15) & (x07 | ((x08 | ~new_n146_ | x15) & (~new_n97_ | ~x00 | ~x15)));
