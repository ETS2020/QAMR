...
module FAU ( 
  ...
  assign z02 = ~x17 & ((~new_n68_ & x18) | (new_n77_ & new_n78_ & x16 & ~x18));
  assign new_n68_ = (new_n69_ | x07) & (~x08 | (new_n76_ & (~x07 | (~x05 ^ x15))));
  ...
  assign z03 = new_n80_ | new_n83_ | (~x09 & (x07 ? ~new_n81_ : ~new_n82_));
  ...
  assign z06 = new_n83_ | (~x09 & (new_n106_ | (~new_n94_ & ~x05)));
  ...
  assign new_n120_ = ~x04 & x05 & x08 & ~new_n73_ & x12;
  assign new_n121_ = x08 & ((x02 & ~x05 & ~x11 & ~new_n73_ & x15) | (new_n73_ & x05));
  assign new_n122_ = x05 & x08 & ~x15 & (x07 | ~x12);
  assign new_n123_ = new_n124_ & x04 & ~x05 & ~x07 & ~x09 & x12;
  assign new_n124_ = ~x14 & ~x15 & x16 & ~x18 & ~x21;
  assign new_n125_ = x16 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | ~x16)));
  assign z10 = (~new_n127_ & ~x09) | new_n83_ | (x08 & new_n131_ & x09);
  ...
  assign z11 = ~x18 & (~x16 | (new_n77_ & new_n78_ & x16 & ~x17));
  assign z12 = ~x09 & ((~new_n134_ & ~x07) | (new_n104_ & ~x05 & x07 & ~x15));
  ...
  assign new_n141_ = new_n104_ & x00 & ~x05 & x15;
  ...
  assign z16 = new_n83_ | (x08 & ~x17 & (x05 ? new_n160_ : ~new_n154_));
  ...
  assign z24 = new_n83_ | (~x09 & ~x17 & (new_n190_ | new_n194_));
  ...
  assign new_n194_ = new_n77_ & x08 & ~x15 & ~x18;
  ...
  assign z28 = (~new_n207_ & ~x17) | (~x09 & x16 & new_n215_ & x17);
