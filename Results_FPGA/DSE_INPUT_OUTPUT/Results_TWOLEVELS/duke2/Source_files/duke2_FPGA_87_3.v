...
module FAU ( 
  ...
  assign z14 = (new_n146_ & ~x01) | (~new_n140_ & ~x17);
  ...
  assign new_n146_ = ~x05 & ~x09 & ~x18 & (x07 | (~x07 & x15 & x17));
  ...
  assign new_n167_ = x17 & ~x15 & ~x09 & ~x07 & ~x01 & ~x05;
  assign z20 = (x01 & x17) | (~x07 & ~x17 & (new_n176_ | (~new_n169_ & ~x09)));
  assign new_n169_ = (~new_n117_ | x14 | x15 | x18 | x21) & (new_n170_ | ~x18);
  assign new_n170_ = ~new_n173_ & (x21 | (x04 ? ~new_n171_ : new_n175_));
  ...
  assign new_n176_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n187_ = new_n188_ & ~x05 & x07 & x08;
  assign new_n188_ = ~x17 & ~x18 & ~x09 & ~x15;
  assign z25 = new_n190_ & ~x05;
  assign new_n190_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (~x01 | ~x17) & (x14 | x21);
  assign z27 = (~new_n193_ & ~x09) | new_n196_ | (x01 & x17);
  assign new_n193_ = x05 ? (x17 | new_n195_ | ~x18) : (~new_n103_ & (x17 | new_n194_ | ~x18));
  assign new_n194_ = (x07 | x08 | x15 | new_n159_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n195_ = (x15 | ~x19 | ~x07 | ~x08) & (x07 | ((x08 | x15 | ~x19) & (~new_n72_ | x04 | ~x08)));
  assign new_n196_ = new_n197_ & x03 & ~x05 & ~x07 & x08;
  assign new_n197_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = x17 ? (x01 | (new_n207_ & ~x09)) : ~new_n199_;
  assign new_n199_ = (new_n200_ | ~x18) & (~new_n206_ | x05);
  ...
  assign new_n207_ = ~x18 & ((~x01 & ~x07 & (x05 | (~x05 & x15))) | (~x05 & x15 & ~x19));
endmodule
