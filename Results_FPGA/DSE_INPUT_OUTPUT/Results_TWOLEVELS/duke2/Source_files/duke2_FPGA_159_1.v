...
module FAU ( 
  ...
  assign z10 = x07 ? ~new_n76_ : (new_n77_ | x18);
  assign new_n76_ = (x15 | ((~x05 | ~x08 | x17 | ~x18) & (~x17 | x18 | x05 | x09))) & (x05 | x09 | ~x15 | ~x17 | x18);
  assign new_n77_ = ~x09 & x17 & ~x18;
  ...
  assign new_n92_ = ~x18 & (~new_n93_ | x14 | x15 | x17 | x18 | x21);
  assign new_n93_ = x04 & ~x05 & ~x09 & x12;
  assign z21 = new_n95_ & x18;
  assign new_n95_ = ~x17 & x15 & ~x09 & x08 & ~x05 & x07;
  assign z22 = x18 & (~x07 | (~x05 & x07 & x08 & x15 & ~x17));
  assign z24 = z23 | (~x05 & ~x09 & new_n98_ & ~x15);
  assign new_n98_ = ~x17 & ~x18 & (new_n99_ | (x01 & x07 & x08));
  assign new_n99_ = x04 & ~x07 & x12 & ~x14 & ~x21;
  assign z26 = ~x20 & ~z23 & (x14 | x21);
  assign z27 = ~x09 & ((~new_n103_ & x07) | (new_n102_ & x00 & ~x05 & ~x07));
  assign new_n102_ = x15 & x17 & ~x18;
  assign new_n103_ = (x05 | ((x15 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18 | ~x19))) & (~x05 | ~x08 | x15 | x17 | ~x18 | ~x19);
  assign z28 = (~x05 & ~new_n105_ & x15) | (new_n77_ & x05 & ~x07);
  assign new_n105_ = (~x07 | ~x08 | ~x09 | x17 | ~x18) & (x09 | ((new_n106_ | x18) & (~x07 | ~x08 | x17 | ~x18)));
