...
module FAU ( 
  ...
  assign z23 = (x10 & ~x18) | (new_n65_ & ~x05 & new_n81_ & ~x17 & x18);
  ...
  assign z06 = ~x09 & (new_n104_ | (~x05 & (new_n106_ | (~new_n94_ & ~x07))));
  assign new_n94_ = (x17 | new_n95_ | ~x18) & (~new_n103_ | ~x15 | ~x17 | x18);
  ...
  assign z07 = (x10 & ~x18) | (~x17 & ~new_n108_ & x18);
  ...
  assign new_n111_ = (~new_n117_ | x07) & (x15 | (~new_n120_ & (x07 | (~new_n112_ & ~new_n119_))));
  ...
  assign new_n126_ = x05 ? ((x10 | ~x17 | x18) & (~new_n127_ | x15 | x17 | ~x18)) : ((x10 | ~x17 | x18) & (~new_n127_ | ~x15 | x17 | ~x18));
  assign new_n127_ = ~x06 & ~x08;
  assign new_n128_ = (x05 | x10 | ~x17 | x18) & (~new_n129_ | ~x05 | x17 | ~x18 | ~x19);
  ...
  assign z12 = new_n78_ | (~x09 & (new_n142_ | (~new_n134_ & ~x07)));
  ...
  assign new_n140_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  assign new_n141_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x10;
  assign new_n142_ = ~x15 & x17 & ~x18 & ~x05 & x07 & ~x10;
  assign z13 = ~x09 & ~x10 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n145_ & ~x17) | (~x18 & (x10 | (new_n151_ & ~x05)));
  assign new_n145_ = (~new_n146_ | ~x08) & (x05 | x09 | ~new_n149_ | x10);
  ...
  assign new_n151_ = ~x09 & ((~x01 & x07) | (~x10 & x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n153_ & ~x18;
  assign new_n153_ = ~x10 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = (x10 & ~x18) | (x08 & ~x17 & x18 & (new_n155_ | new_n160_));
  ...
  assign z17 = ~x09 & (new_n165_ | (~x05 & (new_n106_ | (~new_n162_ & ~x07))));
  assign new_n162_ = (~new_n103_ | ~x15 | ~x17 | x18) & (x08 | x15 | x17 | ~new_n163_ | ~x18);
  ...
  assign new_n167_ = (x14 | x15 | (~new_n87_ & ~new_n168_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n172_ = x17 & ~x15 & ~x10 & ~x09 & ~x05 & ~x07;
  ...
  assign new_n178_ = new_n179_ & x04 & ~x05 & ~x10 & x12;
  ...
  assign new_n191_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | x10 | ~x12 | x14 | x18);
  ...
  assign new_n201_ = ~new_n78_ & (~new_n202_ | ~new_n65_ | ~x03 | x05);
  assign new_n202_ = new_n81_ & ~x17 & x18 & x19;
  assign new_n203_ = new_n204_ & ~x05;
  assign new_n204_ = ~x10 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n206_ | new_n213_)) | (~x09 & ~x10 & new_n215_ & x17);
  ...
  assign new_n214_ = ~x09 & ~x10 & x15 & ~x18 & (~x02 | ~x11);
