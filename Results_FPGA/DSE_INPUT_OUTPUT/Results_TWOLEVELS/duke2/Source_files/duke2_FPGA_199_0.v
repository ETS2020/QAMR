...
module FAU ( 
  ...
  assign new_n123_ = ~x14 & ~x15 & ~x18 & x19 & ~x21;
  assign new_n124_ = ~x07 & ~x09 & new_n102_ & ~x15;
  assign z10 = ~new_n128_ | (~x09 & (x07 ? new_n130_ : ~new_n126_));
  assign new_n126_ = x05 ? ((~x17 | x18 | ~x19) & (~new_n127_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | ~x19) & (~new_n127_ | x17 | ~x18))) & (x15 | ~x17 | x18 | ~x19));
  assign new_n127_ = ~x06 & ~x08;
  assign new_n128_ = (x18 | x19) & (~x08 | x15 | x17 | new_n129_ | ~x18);
  ...
  assign z12 = new_n78_ | (~x09 & (new_n134_ | (new_n102_ & new_n142_)));
  ...
  assign new_n149_ = x19 & (new_n150_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n150_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n151_ = ~x18 & x19 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n153_ & x19;
  assign new_n153_ = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = new_n78_ | (x08 & ~new_n155_ & ~x17);
  assign new_n155_ = (~x18 | (x05 ? ~new_n161_ : new_n156_)) & (~new_n162_ | x05 | x07);
  assign new_n156_ = (x07 | x09 | x14 | ~new_n157_ | x15) & (~x09 | (x02 & ~x07) | ~x15);
  assign new_n157_ = ~x21 & ((x06 & (new_n158_ | new_n159_)) | new_n96_ | (new_n160_ & ~x06));
  ...
  assign new_n162_ = x09 & ~x15 & ~x19;
  assign z17 = ~x09 & ((~new_n164_ & ~x05) | (new_n167_ & new_n65_ & ~x04 & x05));
  assign new_n164_ = (~new_n102_ | ~x07 | x15) & (x07 | ((x08 | ~new_n165_ | x15) & (~new_n102_ | ~x00 | ~x15)));
  ...
  assign z19 = x19 & ~x18 & x17 & ~x15 & new_n174_ & ~x09;
  ...
  assign new_n177_ = ~x21 & (x04 ? (new_n178_ & ~x12) : ~new_n139_);
  ...
  assign z25 = (~x18 & ~x19) | (~x05 & ~x07 & ~x17 & ~new_n198_ & x18);
  ...
  assign new_n203_ = ~x21 & (new_n204_ | (~new_n139_ & ~x04));
  assign new_n204_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n205_ = x19 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  ...
  assign new_n214_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
