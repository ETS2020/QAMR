...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n66_, new_n69_,
    new_n71_, new_n73_, new_n74_, new_n75_, new_n76_, new_n80_, new_n81_,
    new_n83_, new_n84_, new_n87_;
  ...
  assign z03 = (~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07))) | (~x17 & x18);
  ...
  assign z14 = z18 | (~x05 & ~new_n73_ & ~x09);
  ...
  assign new_n83_ = ~x18 & ((x01 & x07 & x08) | (new_n84_ & x04 & ~x07));
  assign new_n84_ = x12 & ~x14 & ~x21;
  assign z26 = z18 | (~x20 & (x21 | (~z18 & x14)));
  assign z28 = (~x17 & x18) | (~x09 & ((new_n87_ & ~x05) | (x05 & ~x07 & x17 & ~x18)));
  assign new_n87_ = x15 & ((new_n76_ & x07) | (x17 & ~x18 & (~x07 | ~x19)));
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z16 = 1'b0;
  assign z23 = 1'b0;
