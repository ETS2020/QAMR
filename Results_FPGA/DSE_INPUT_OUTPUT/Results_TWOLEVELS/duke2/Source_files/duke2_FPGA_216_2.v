...
module FAU ( 
  ...
  assign z09 = x17 ? ~x18 : (new_n115_ | (~new_n103_ & x18));
  ...
  assign z24 = ~x09 & (new_n167_ | new_n171_) & ~x17;
  assign new_n167_ = ~x07 & (new_n168_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n168_ = ~x21 & ((x04 & ~new_n169_ & ~x15) | (x08 & new_n170_ & x15));
  assign new_n169_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x05 | ~x12);
  ...
  assign z27 = ~x17 & x18 & (new_n179_ | (~new_n176_ & ~x09));
  ...
  assign new_n179_ = new_n165_ & x03 & x08 & x09 & ~x15 & x19;
