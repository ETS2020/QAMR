...
module FAU ( 
  ...
  assign new_n63_ = (x09 | (~new_n64_ & ~new_n67_)) & (~x05 | ~new_n68_ | ~x08);
  assign new_n64_ = x18 & ((~new_n65_ & ~x07) | (x05 & x08 & x21));
  assign new_n65_ = (new_n66_ | x06) & (x08 | (~x05 & (~x06 | (x02 & x11))));
  assign new_n66_ = x04 & x12;
  assign new_n67_ = x07 & ((x05 & x08 & x18) | (x01 & ~x05 & ~x18 & (x08 | x16)));
  assign new_n68_ = x18 & ((~x04 & ~x07 & x12 & (x09 | ~x21)) | ~x12 | (x07 & x09));
  ...
  assign z06 = (x15 & x18) | (~x09 & (new_n90_ | (~new_n83_ & ~x05)));
  assign new_n83_ = (x07 | ((x15 | x17 | new_n84_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  ...
  assign z07 = ~x15 & new_n93_ & ~x17;
  assign new_n93_ = x18 & ((x08 & ((x05 & x07 & ~x09) | (~x05 & ~x07 & x09 & x16))) | (x05 & ~x07 & ~x08 & ~x09));
  assign z08 = (x15 & x18) | (x14 & ~x20);
  assign z09 = ~x15 & (new_n108_ | (~x17 & (new_n105_ | (~new_n96_ & x18))));
  assign new_n96_ = (x07 | (~new_n97_ & (x04 | ~x05 | ~new_n104_ | ~x08))) & (~x05 | ~x08 | (new_n104_ & ~x07));
  ...
  assign z10 = new_n111_ | new_n72_;
  assign new_n111_ = ~x15 & ((~x17 & ~new_n112_ & x18) | (~x05 & ~x09 & x17 & ~x18));
  ...
  assign z12 = ~x09 & (new_n90_ | (~new_n116_ & ~x05));
  assign new_n116_ = (~x17 | x18 | ~x07 | x15) & (x07 | ((~x17 | x18 | ~x00 | ~x15) & (x15 | x17 | ~new_n117_ | ~x18)));
  assign new_n117_ = ~x21 & (x08 ? (new_n86_ & ~x14) : ~new_n118_);
  assign new_n118_ = x06 ? (~x02 ^ x11) : (~x04 ^ x12);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n121_ & ~x17) | (new_n126_ & ~x05) | (x15 & x18);
  assign new_n121_ = (~x04 | x07 | (~new_n122_ & (~new_n125_ | ~x05))) & (new_n123_ | ~x07);
  assign new_n122_ = ~x05 & ~x09 & x12 & new_n107_ & ~x14 & ~x15;
  assign new_n123_ = (~new_n124_ | x05) & (~x05 | ~x08 | ~x18 | x19);
  assign new_n124_ = ~x09 & x15 & ~x18 & (~x02 | ~x11 | (x02 & x11));
  assign new_n125_ = x08 & ~x12 & x18 & (x09 | (~x09 & ~x15 & ~x21));
  ...
  assign z17 = (~x05 & ~new_n135_ & ~x09) | (x15 & x18);
  assign new_n135_ = (~new_n109_ | ~x07 | x15) & (x07 | ((~new_n109_ | ~x00 | ~x15) & (x08 | ~new_n136_ | x15)));
  assign new_n136_ = ~x17 & x18 & ~new_n60_ & ~new_n137_;
  assign new_n137_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = ~x05 & ~x07 & ~x09 & new_n139_ & ~x14;
  assign new_n139_ = ~x15 & ~x17 & x18 & (new_n76_ | (~new_n140_ & x12));
  assign new_n140_ = (x06 | (~new_n142_ & (~new_n81_ | ~x08 | ~x10))) & (~new_n141_ | ~x06 | ~x08 | ~x10);
  assign new_n141_ = ~x13 & x16 & ~x21;
  assign new_n142_ = ~x04 & ~x08 & x21;
  ...
  assign new_n149_ = new_n66_ & new_n107_ & ~x14;
  ...
  assign new_n159_ = (x07 | (~new_n160_ & (x05 | x08 | ~x18))) & (~x07 | ~x08 | x18 | ~x01 | x05);
  assign new_n160_ = new_n161_ & x04;
  assign new_n161_ = ~x21 & ((x05 & x08 & ~x12 & x18) | (~x14 & ~x18 & ~x05 & x12));
  assign z25 = x18 & ~x17 & ~x15 & x09 & new_n69_ & x08;
  assign z26 = (x15 & x18) | (~x20 & (x14 | x21));
  assign z27 = new_n165_ | (new_n168_ & ~x07 & x08 & x03 & ~x05);
  assign new_n165_ = ~x09 & ((~new_n166_ & ~x15) | (new_n109_ & x15 & new_n69_ & x00));
  assign new_n166_ = (x17 | new_n167_ | ~x18) & (x05 | ~x07 | ~x17 | x18);
  assign new_n167_ = x05 ? (~x19 | (~x07 ^ ~x08)) : (x07 | x08 | new_n137_ | x21);
  assign new_n168_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = new_n177_ | (~x09 & ((~new_n170_ & ~x05) | (new_n109_ & x05 & ~x07)));
  assign new_n170_ = (x17 | (new_n171_ & (new_n174_ | x02))) & (~x15 | ~new_n176_ | ~x17);
  assign new_n171_ = (x07 | x14 | x15 | new_n172_ | ~x18) & (~x15 | x18 | ~x07 | x11);
  assign new_n172_ = ~new_n88_ & (~new_n173_ | ~x08);
  assign new_n173_ = x10 & x12 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n174_ = (~x07 | ~x15 | x18) & (~new_n175_ | x14 | x15 | ~x18 | ~x21);
  assign new_n175_ = x06 & ~x07 & ~x08 & x11;
  assign new_n176_ = ~x18 & (~x07 | ~x19);
  assign new_n177_ = ~x04 & x05 & ~x07 & new_n178_ & x08;
  assign new_n178_ = x12 & ~x15 & ~x17 & x18 & (x09 | ~x21);
endmodule
