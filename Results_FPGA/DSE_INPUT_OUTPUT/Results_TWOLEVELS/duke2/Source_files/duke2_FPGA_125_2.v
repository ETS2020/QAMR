...
module FAU ( 
  ...
  assign new_n70_ = (new_n71_ | ~x18) & (~new_n79_ | x15 | x18 | ~x08 | x09);
  ...
  assign new_n109_ = new_n66_ & ~x05 & x09 & ~x15 & x16;
  ...
  assign z12 = new_n68_ | (~x09 & (new_n136_ | (new_n104_ & new_n144_)));
  ...
  assign new_n153_ = ~x16 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n155_ & ~x18;
  assign new_n155_ = ~x16 & (x15 | x16 | ~x17 | ~x05 | x07 | x09);
  ...
  assign new_n174_ = x17 & ~x16 & ~x15 & ~x09 & ~x05 & ~x07;
  ...
  assign new_n195_ = new_n79_ & x08 & ~x15 & ~x18;
  assign z25 = (x16 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n197_ & x18);
  ...
  assign new_n214_ = ~x18 & (x16 | (new_n215_ & ~x09));
