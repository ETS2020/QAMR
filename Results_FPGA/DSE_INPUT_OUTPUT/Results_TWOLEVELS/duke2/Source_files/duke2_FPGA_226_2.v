...
module FAU ( 
  ...
  assign z02 = ~x17 & ((~x09 & (new_n70_ | new_n75_)) | (new_n78_ & x08));
  assign new_n70_ = ~x05 & (x07 ? ~new_n71_ : (x18 & (new_n73_ | new_n74_)));
  assign new_n71_ = ~new_n72_ & (~x18 | ~x19 | ~x08 | ~x15);
  assign new_n72_ = x01 & ~x14 & ~x15 & ~x18 & (x08 | x16);
  assign new_n73_ = ~x02 & ((x06 & ~x08) | (x15 & ~x21 & x08 & x11));
  assign new_n74_ = ~x08 & ((~x06 & (~x04 | ~x12)) | x15 | (x06 & ~x11));
  assign new_n75_ = x18 & (new_n76_ | (new_n66_ & x15 & x21));
  assign new_n76_ = x05 & ((~x07 & (x08 ? ~new_n77_ : ~x15)) | (~x15 & x19 & x07 & x08));
  ...
  assign z07 = (x14 & ~x18) | (~x17 & ~new_n107_ & x18);
  ...
  assign new_n124_ = ~x14 & (x07 | x09 | x14 | x15 | ~x17);
  ...
  assign z11 = ~x18 & (x14 | (new_n133_ & ~x09 & ~x15 & ~x17));
  assign new_n133_ = x01 & ~x05 & x07;
  assign z12 = new_n68_ | (~new_n135_ & ~x09);
  assign new_n135_ = ~new_n143_ & (x07 | (~new_n142_ & (x17 | ~new_n136_ | ~x18)));
  ...
  assign new_n142_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x14;
  assign new_n143_ = ~x15 & x17 & ~x18 & ~x05 & x07 & ~x14;
  assign z13 = ~x09 & ~x14 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n146_ & ~x17) | (~x18 & (x14 | (new_n152_ & ~x05)));
  ...
  assign new_n152_ = ~x09 & ((~x01 & x07) | (~x14 & x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n154_ & ~x18;
  assign new_n154_ = x17 & ~x15 & ~x14 & ~x09 & x05 & ~x07;
  assign z16 = (x14 & ~x18) | (x08 & ~x17 & x18 & (new_n156_ | new_n161_));
  ...
  assign z17 = ~x09 & (new_n163_ | (new_n65_ & new_n104_ & ~x11 & x15));
  assign new_n163_ = ~x05 & (new_n105_ | (~x07 & (new_n102_ | (new_n164_ & ~x08))));
  assign new_n164_ = ~x15 & ~x17 & x18 & ~new_n165_ & (~x21 | (~x14 & x21));
  assign new_n165_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n167_ & x18;
  assign new_n167_ = (x14 | x15 | (~new_n88_ & ~new_n168_)) & (x08 | ~x15 | ~x19);
  ...
  assign z20 = new_n68_ | (~x07 & ~x17 & (new_n180_ | (~new_n173_ & ~x09)));
  ...
  assign new_n189_ = ~new_n190_ & (~new_n133_ | ~x08 | x14 | x15 | x18);
  ...
  assign z28 = (~new_n212_ & ~x18) | (~x17 & ((new_n214_ & ~x05) | (~new_n205_ & x18)));
  assign new_n205_ = (~x08 | ((new_n206_ | x05) & (new_n211_ | x07))) & (x05 | x07 | ~new_n210_ | x08);
  assign new_n206_ = ~new_n207_ & (new_n209_ | ~x15);
  ...
  assign new_n212_ = ~x14 & (~new_n213_ | x09);
  assign new_n213_ = x17 & (x05 ? (~x07 & ~x14) : (x15 & (~x19 | (~x07 & ~x14))));
