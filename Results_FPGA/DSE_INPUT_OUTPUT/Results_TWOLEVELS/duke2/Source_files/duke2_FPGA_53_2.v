...
module FAU ( 
  ...
  assign z01 = (x10 & (~x18 | (new_n69_ & new_n70_))) | (~new_n58_ & ~x17);
  assign new_n58_ = ~new_n64_ & (x05 | (~new_n67_ & (x09 | (~new_n59_ & ~new_n68_))));
  assign new_n59_ = ~x07 & x18 & (new_n63_ | (~new_n60_ & ~x15));
  ...
  assign new_n67_ = new_n66_ & ~x02 & x09 & x11 & x15 & x18;
  assign new_n68_ = x11 & x15 & ~x18 & x02 & x07 & ~x10;
  assign new_n69_ = ~x02 & x04 & ~x05 & new_n66_ & ~x09 & x11;
  assign new_n70_ = new_n71_ & ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign new_n71_ = x13 & ~x14;
  assign z02 = new_n83_ | (~x17 & ((~new_n73_ & ~x09) | (new_n80_ & x08)));
  assign new_n73_ = (x05 | (x07 ? new_n78_ : (new_n79_ | ~x18))) & (new_n74_ | ~x18);
  ...
  assign new_n79_ = (x02 | (~x06 & (~x15 | x21 | ~x08 | ~x11))) & (~x06 | (x11 & (x08 | ~x15))) & (x06 | x08 | ~x15);
  ...
  assign new_n85_ = new_n66_ & ~x05 & new_n86_ & ~x17 & x18;
  ...
  assign z07 = (x10 & ~x18) | (~x17 & ~new_n112_ & x18);
  ...
  assign new_n117_ = ~x12 & ((~x05 & ~x06 & ~x08) | (new_n71_ & x02 & x08));
  ...
  assign z15 = ~x18 & (x10 | (new_n157_ & x05 & ~x10 & ~x15 & x17));
  ...
  assign z17 = ~x09 & (new_n166_ | (new_n65_ & new_n110_ & ~x11 & x15));
  assign new_n166_ = ~x05 & (new_n107_ | (~x07 & (new_n106_ | (new_n167_ & ~x08))));
  assign new_n167_ = ~x15 & ~x17 & x18 & ~new_n168_ & (~x21 | (~x14 & x21));
  assign new_n168_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign z18 = new_n83_ | (~x05 & ~x07 & ~x09 & new_n170_ & ~x17);
  ...
  assign z22 = (x10 & ~x18) | (~x17 & (new_n188_ | new_n189_) & x18);
  ...
  assign z24 = new_n83_ | (~x09 & ~x17 & (new_n192_ | new_n196_));
  assign new_n192_ = ~x07 & (new_n193_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n193_ = ~x21 & ((x04 & ~new_n194_ & ~x15) | (x08 & new_n195_ & x15));
  assign new_n194_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | x10 | ~x12 | x14 | x18);
  assign new_n195_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  ...
  assign new_n202_ = ~x21 & (new_n144_ | new_n203_);
  assign new_n203_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n204_ = ~new_n83_ & (~new_n205_ | ~new_n66_ | ~x03 | x05);
  assign new_n205_ = new_n86_ & ~x17 & x18 & x19;
