...
module FAU ( 
  ...
  assign z09 = ~x17 & (new_n114_ | (~new_n102_ & x18));
  ...
  assign new_n146_ = (x14 | (~new_n83_ & ~new_n147_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n162_ = (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = (x17 & ~x18) | (new_n164_ & x09 & ~x15 & ~x17 & x18);
  assign new_n164_ = ~x05 & ~x07 & x08;
  assign z24 = (x17 & ~x18) | (~x09 & (new_n166_ | new_n170_) & ~x17);
