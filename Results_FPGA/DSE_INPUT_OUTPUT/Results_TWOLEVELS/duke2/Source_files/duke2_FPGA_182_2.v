...
module FAU ( 
  ...
  assign z11 = x01 & ~x18;
  assign z02 = ~x17 & x18 & ((~new_n70_ & ~x07) | (~new_n76_ & x08));
  ...
  assign new_n73_ = ~x02 & ((x06 & ~x15) | (x08 & x11 & x15 & ~x21));
  assign new_n74_ = x15 ? x08 : (x06 ? x11 : (x04 & x12));
  ...
  assign z03 = new_n79_ | z11 | (~x09 & (x07 ? ~new_n80_ : ~new_n81_));
  assign new_n79_ = new_n66_ & ~x05 & ~x17 & x18 & x09 & ~x15;
  ...
  assign new_n99_ = new_n100_ & ~x12 & ~x15 & new_n66_ & x04 & x05;
  assign new_n100_ = ~x17 & x18 & ~x21;
  assign new_n101_ = ~x01 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z07 = ~x17 & ~new_n103_ & x18;
  assign new_n103_ = (x09 | (~x05 ^ x15) | (~x07 ^ ~x08)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~z11 & ~x20;
  assign z09 = ~new_n117_ | (~x15 & (new_n106_ | (x05 & new_n119_ & x08)));
  ...
  assign new_n116_ = x05 & x08 & x12 & ~x17 & ~new_n72_ & x18;
  assign new_n117_ = (~x01 | x18) & (x07 | ~x08 | x17 | new_n118_ | ~x18);
  assign new_n118_ = (~x02 | x05 | x11 | new_n72_ | ~x15) & (~new_n72_ | ~x05);
  assign new_n119_ = ~x17 & x18 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  ...
  assign new_n128_ = ~new_n101_ & (x07 | x17 | ~new_n129_ | ~x18);
  ...
  assign z14 = x07 ? ~new_n140_ : (new_n143_ | (~new_n136_ & ~x17));
  assign new_n136_ = ~new_n137_ & (~x08 | ~x18 | new_n139_ | (~x09 & (x09 | x21)));
  assign new_n137_ = new_n138_ & ~x01 & x04 & ~x05 & ~x09;
  assign new_n138_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n139_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n140_ = (x05 | (~new_n141_ & (~new_n142_ | ~x08 | ~x15))) & (~new_n142_ | ~x05 | ~x08 | x15);
  assign new_n141_ = ~x01 & ~x09 & ~x18;
  assign new_n142_ = ~x17 & x18 & ~x19;
  assign new_n143_ = ~x01 & ~x05 & ~x09 & x15 & x17 & ~x18;
  assign z15 = ~new_n145_ & ~x18;
  assign new_n145_ = ~x01 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = (x01 & ~x18) | (x08 & ~x17 & x18 & (new_n147_ | new_n152_));
  ...
  assign new_n164_ = x17 & ~x15 & ~x09 & ~x07 & ~x01 & ~x05;
  ...
  assign z27 = (~new_n192_ & ~x09) | (new_n196_ & new_n66_ & x03 & ~x05);
  assign new_n192_ = x05 ? (x17 | new_n194_ | ~x18) : (~new_n101_ & (x17 | new_n193_ | ~x18));
  assign new_n193_ = (x07 | x08 | x15 | new_n157_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n194_ = (~x07 | ~x08 | x15 | ~x19) & (x07 | ((x08 | x15 | ~x19) & (~new_n195_ | x04 | ~x08)));
  assign new_n195_ = ~x11 & x15 & ~x21;
  ...
  assign new_n199_ = (x07 | x14 | ~new_n200_ | x15) & (~x15 | (x07 ? new_n202_ : ~new_n203_));
  assign new_n200_ = x18 & (x08 ? new_n201_ : (~new_n98_ & x21));
  assign new_n201_ = x10 & x12 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n202_ = (~x08 | ~x18 | ~x19) & (x01 | x18 | (x02 & x11));
  assign new_n203_ = x18 & ((~x08 & ~x19) | (~x02 & x08 & x11 & ~x21));
