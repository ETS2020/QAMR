...
module FAU ( 
  ...
  assign new_n66_ = ~x11 & x15 & ~x17 & ~x21;
  assign new_n67_ = x02 & ~x05 & x07 & ~x09;
  assign z02 = (~x17 & (new_n75_ | (~new_n69_ & ~x09))) | ((new_n78_ | x17) & x18);
  ...
  assign new_n72_ = (~x05 | ((x07 | x08 | x15) & (new_n73_ | ~x08))) & (x07 | ~x08 | ~x15 | ~x21);
  assign new_n73_ = (~x07 | x15) & (x04 | x07 | x11 | ~x15 | x21);
  assign new_n74_ = x08 ? ((~x07 | ~x19) & (x02 | x07 | ~x11 | x21)) : x07;
  assign new_n75_ = x08 & x18 & (x05 ? (~new_n76_ & ~x15) : (~new_n77_ & x15));
  assign new_n76_ = (x04 | x07 | ~x12 | (~x09 & x21)) & (~x07 | ~x09);
  assign new_n77_ = (~x07 | (~x09 & x19)) & x11 & (x02 | ~x09);
  assign new_n78_ = x08 & (x05 ? ((~x12 & ~x15) | (new_n79_ & ~x07)) : (~x07 & ~x15));
  assign new_n79_ = ~x09 & x21;
  assign z03 = (~new_n83_ & ~x09) | (x18 & (x17 | (new_n81_ & x09 & ~x15 & ~x17)));
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n102_ | (~new_n94_ & ~x05)));
  assign new_n94_ = (x07 | ((x17 | new_n95_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n95_ = ~new_n65_ & (x15 | (~new_n100_ & (x14 | (~new_n89_ & new_n96_))));
  ...
  assign new_n102_ = new_n103_ & ~x12 & ~x15 & new_n82_ & x04 & x05;
  ...
  assign z09 = (new_n118_ & ~x07) | (x18 & (~new_n120_ | (~new_n108_ & ~x07)));
  assign new_n108_ = ~new_n117_ & (x15 | ((new_n109_ | x09) & (~new_n116_ | x04)));
  assign new_n109_ = ~new_n115_ & (x21 | (~new_n112_ & (~x04 | new_n110_ | x12)));
  assign new_n110_ = (~x13 | x14 | ~x02 | ~x08) & (~new_n111_ | x08 | x17);
  assign new_n111_ = ~x05 & ~x06;
  assign new_n112_ = ~x05 & ~x17 & ((new_n114_ & x02) | (~new_n113_ & x06));
  assign new_n113_ = (x02 | x08 | ~x11) & (~x02 | ~x08 | x10 | ~x13 | x14);
  assign new_n114_ = x08 & x13 & ~x14 & (x10 ? x12 : ~x06);
  assign new_n115_ = x05 & ~x08 & ~x19;
  assign new_n116_ = x05 & x08 & x12 & ~new_n79_ & ~x17;
  assign new_n117_ = x08 & ((x02 & ~x05 & ~x11 & ~new_n79_ & x15) | (new_n79_ & x05));
  assign new_n118_ = ~x09 & ~x15 & ~new_n119_ & ~x18;
  assign new_n119_ = x05 ? ~x17 : (~x17 & (~x04 | ~x12 | x14 | x17 | x21));
  assign new_n120_ = ~x17 & (~x05 | ~x08 | x15 | (x12 & (~x07 | x17)));
  ...
  assign new_n130_ = ~new_n132_ & (x15 | (x08 ? (~new_n97_ | x14) : new_n131_));
  ...
  assign z14 = (~new_n138_ & ~x07) | (x17 & x18) | (~new_n142_ & x07);
  assign new_n138_ = (~x08 | ~new_n139_ | ~x18) & (x05 | x09 | new_n141_ | x18);
  assign new_n139_ = ~new_n140_ & (x09 | (~x09 & ~x17 & ~x21));
  assign new_n140_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n141_ = (~x15 | ~x17) & (~x04 | ~x12 | x14 | x15 | x17 | x21);
  assign new_n142_ = (~x08 | ~new_n143_ | ~x18) & (x05 | x09 | new_n144_ | x18);
  assign new_n143_ = ~x19 & (x05 ? ~x15 : (x15 & ~x17));
  assign new_n144_ = ~x17 & x01 & (~x15 | x17 | (x02 & x11 & (~x02 | ~x11)));
  ...
  assign z22 = x18 & (x17 | (~x17 & ((~new_n177_ & ~x07) | (~x05 & new_n178_ & x07))));
  assign new_n177_ = (x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  assign new_n178_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n180_ & x18;
  assign new_n180_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  ...
  assign z27 = new_n191_ | (new_n196_ & new_n82_ & x03 & ~x05);
  ...
  assign z28 = (~x17 & (new_n198_ | (new_n205_ & ~x05))) | (~x09 & new_n206_ & x17);
  ...
  assign new_n202_ = (x02 | (~x09 & (~x11 | x21 | x07 | x09))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n203_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n204_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n101_ & x21));
