// Benchmark "FAU" written by ABC on Fri Aug 21 18:29:24 2020
...
module FAU ( 
  ...
  assign z13 = z03 | z05;
  assign z14 = z05 | (~x05 & ~new_n74_ & ~x09);
  assign new_n74_ = (x18 | (new_n76_ & (new_n75_ | x15))) & (~x07 | ~new_n77_ | ~x15);
  assign new_n75_ = (~x07 | ~x17) & (x14 | x17 | x21 | ~x04 | x07 | ~x12);
  assign new_n76_ = (~x15 | (x07 ? (~x17 & (~x02 | ~x11 | x17)) : ~x17)) & (x01 | ~x07);
  assign new_n77_ = ~x17 & (~x02 | ~x11);
  ...
  assign new_n88_ = x15 & ((new_n77_ & x07) | (x17 & ~x18 & (~x07 | ~x19)));
  assign z07 = 1'b0;
  assign z18 = 1'b0;
  assign z22 = 1'b0;
  assign z10 = z03;
