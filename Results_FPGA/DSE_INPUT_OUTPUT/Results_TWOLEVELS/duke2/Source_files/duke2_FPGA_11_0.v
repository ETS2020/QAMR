...
module FAU ( 
  ...
  assign z11 = ~x18 & (~x16 | (new_n78_ & x16 & ~x17 & ~x09 & ~x15));
  assign z12 = ~x09 & ((~new_n133_ & ~x07) | (new_n102_ & ~x05 & x07 & ~x15));
  ...
  assign z14 = (~new_n143_ & ~x17) | (~x18 & (~x16 | (new_n149_ & ~x05)));
  assign new_n143_ = (~x08 | new_n144_ | ~x18) & (x05 | x09 | new_n146_ | x18);
  assign new_n144_ = x07 ? (new_n76_ | x19) : (new_n145_ | (~x09 & (x09 | x21)));
  assign new_n145_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n146_ = (~new_n147_ | ~x07) & (~new_n148_ | ~x04 | x07 | ~x12);
  assign new_n147_ = x15 & ((x02 & x11) | (x16 & (~x02 | ~x11)));
  assign new_n148_ = ~x14 & ~x15 & x16 & ~x21;
  assign new_n149_ = ~x09 & ((~x01 & x07) | (x16 & x17 & (x07 | (~x07 & x15))));
  assign z15 = ~x18 & (~x16 | (new_n151_ & x05 & ~x15 & x16 & x17));
  assign new_n151_ = ~x07 & ~x09;
  assign z16 = new_n67_ | (x08 & ~x17 & (x05 ? new_n159_ : ~new_n153_));
  assign new_n153_ = (x07 | new_n154_ | x15) & (~x09 | ~x15 | (x02 & ~x07) | ~x18);
  assign new_n154_ = x09 ? (~x18 | x19) : (x14 | new_n155_ | x21);
  assign new_n155_ = (~new_n158_ | ~x06) & (~x18 | (~new_n156_ & ~new_n97_ & (~new_n157_ | x06)));
  ...
  assign new_n164_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign z19 = ~x18 & (~x16 | (new_n151_ & ~x05 & ~x15 & x16 & x17));
  ...
  assign new_n177_ = ~x15 & x16 & ~x18 & ~x21;
  ...
  assign new_n186_ = ~new_n187_ & (~new_n78_ | ~x16 | x18 | ~x08 | x15);
  ...
  assign new_n196_ = ~x21 & (new_n138_ | new_n197_);
  ...
  assign z28 = (~x09 & x16 & new_n211_ & x17) | (~new_n203_ & ~x17);
