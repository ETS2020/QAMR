...
module FAU ( 
  ...
  assign new_n55_ = x05 ? (x15 & (x07 | x21)) : (x07 ? ~x15 : (x21 | (x15 & (x00 | ~x15))));
  ...
  assign new_n82_ = (x18 | ~x21) & (~new_n65_ | x05 | ~new_n83_ | x17 | ~x18);
  assign new_n83_ = x09 & ~x15;
  assign new_n84_ = (~x08 | x17 | ~x18 | (x05 ^ ~x15)) & (x05 | ~x17 | x18 | (~x15 & (x15 | x21)));
  assign new_n85_ = x05 ? ((x08 | x15 | x17 | ~x18) & (~x17 | x18 | x21)) : (~x17 | x18 | x21);
  ...
  assign new_n130_ = ~new_n131_ & (x05 | ~x17 | x18 | (~x15 & (x15 | x21)));
  assign new_n131_ = x05 & x08 & ~x15 & ~x17 & x18 & x19;
  assign new_n132_ = (x18 | ~x21) & (~x08 | x15 | x17 | new_n133_ | ~x18);
  assign new_n133_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign z11 = ~x18 & (x21 | (new_n135_ & ~x09 & ~x15 & ~x17));
  ...
  assign z13 = ~new_n146_ & ~x18;
  assign new_n146_ = ~x21 & (x09 | ~x17 | (x05 ? (x07 | x21) : (x07 ? (~x15 & (x15 | x21)) : x21)));
  ...
  assign new_n152_ = ~new_n153_ & (~x07 | ~x15 | ((~x02 | ~x11) & (x21 | (x02 & x11))));
  assign new_n153_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n154_ = ~x09 & ((~x01 & x07) | (x17 & (x07 ? (x15 | (~x15 & ~x21)) : (x15 & ~x21))));
  ...
  assign new_n170_ = (x14 | (~new_n89_ & ~new_n171_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n181_ = new_n182_ & x04 & ~x05 & x12;
  ...
  assign z24 = new_n68_ | (~x09 & ~new_n194_ & ~x17);
  assign new_n194_ = ~new_n195_ & (~new_n135_ | x18 | x21 | ~x08 | x15);
  assign new_n195_ = ~x07 & (new_n196_ | (~x15 & x18 & ~x05 & ~x08));
  assign new_n196_ = ~x21 & ((x08 & new_n198_ & x15) | (x04 & ~new_n197_ & ~x15));
  assign new_n197_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  assign new_n198_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign z25 = (~x18 & x21) | (~x05 & ~x07 & ~x17 & ~new_n200_ & x18);
  ...
  assign new_n205_ = ~x21 & (new_n206_ | (~new_n142_ & ~x04));
  assign new_n206_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n207_ = ~x21 & ((x07 & ~x15) | (x00 & ~x07 & x15));
