...
module FAU ( 
  ...
  assign new_n142_ = ~new_n143_ & (~new_n98_ | x04 | x11 | ~x15 | x21);
  assign new_n143_ = ~x05 & ~x08 & ~new_n60_ & ~new_n144_ & ~x15;
  assign new_n144_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n146_ & x18;
  assign new_n146_ = (x14 | (~new_n147_ & ~new_n82_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n158_ = new_n98_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n162_ = (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
