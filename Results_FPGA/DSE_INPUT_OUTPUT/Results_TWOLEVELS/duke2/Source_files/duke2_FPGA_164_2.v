...
module FAU ( 
  ...
  assign z02 = ~x17 & ((new_n73_ & x08) | (~x09 & (new_n66_ | new_n69_)));
  assign new_n66_ = x18 & (new_n67_ | (~x07 & x08 & x15 & x21));
  assign new_n67_ = x05 & ((~x07 & (x08 ? ~new_n68_ : ~x15)) | (x07 & x08 & ~x15 & x19));
  assign new_n68_ = ~x21 & (x04 | x11 | ~x15 | x21);
  assign new_n69_ = ~x05 & (x07 ? ~new_n70_ : (x18 & (new_n71_ | new_n72_)));
  assign new_n70_ = (~x01 | x15 | x18 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18 | ~x19);
  assign new_n71_ = ~x02 & ((x06 & ~x08) | (x15 & ~x21 & x08 & x11));
  ...
  assign new_n77_ = (~x08 | ((x05 | (x07 ? (x09 | ~x15) : (~x09 | x15))) & (x09 | x15 | ~x05 | ~x07))) & (~x05 | x07 | x08 | x09 | x15);
  ...
  assign z09 = x17 ? ~x18 : (new_n113_ | (x18 & (new_n102_ | (new_n111_ & ~x07))));
  assign new_n102_ = ~x15 & (new_n110_ | (~x07 & (new_n109_ | (~new_n103_ & ~x09))));
  ...
  assign z10 = ~x17 & x18 & ((~new_n116_ & ~x07) | (x05 & new_n117_ & x07));
  assign new_n116_ = (~x05 | x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | x06 | x08)));
  ...
  assign new_n143_ = ~new_n144_ & (~new_n97_ | x04 | x11 | ~x15 | x21);
  assign new_n144_ = ~x05 & ~x08 & ~x15 & ~new_n58_ & ~new_n145_;
  assign new_n145_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n147_ & x18;
  assign new_n147_ = (x14 | x15 | (~new_n148_ & ~new_n82_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n159_ = new_n97_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign z27 = x17 ? ~x18 : (~new_n177_ & x18);
  assign new_n177_ = (new_n178_ | x09) & (~new_n181_ | ~x08 | ~x09 | x15 | ~x19);
  assign new_n178_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n179_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n179_ = ~x21 & (new_n180_ | (~new_n125_ & ~x04));
  assign new_n180_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n181_ = x03 & ~x05 & ~x07;
  assign z28 = ~x17 & ((new_n190_ & ~x05) | (~new_n183_ & x18));
  assign new_n183_ = (~x08 | ((new_n189_ | x07) & (new_n184_ | x05))) & (x05 | x07 | ~new_n188_ | x08);
  assign new_n184_ = ~new_n185_ & (new_n187_ | ~x15);
  assign new_n185_ = ~x07 & ~x09 & x10 & new_n186_ & x12;
