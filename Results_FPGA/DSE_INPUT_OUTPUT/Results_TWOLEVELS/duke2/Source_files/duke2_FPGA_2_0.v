...
module FAU ( 
  ...
  assign z01 = (~x18 & ~x20) | (~x17 & (new_n65_ | (~new_n58_ & ~x05)));
  ...
  assign z02 = (~x18 & ~x20) | (~x17 & (new_n76_ | (~new_n69_ & ~x09)));
  ...
  assign new_n80_ = new_n66_ & ~x05 & new_n81_ & ~x17 & x18;
  ...
  assign new_n127_ = x05 ? ((~x17 | x18 | ~x20) & (~new_n128_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | ~x20) & (~new_n128_ | x17 | ~x18))) & (x15 | ~x17 | x18 | ~x20));
  assign new_n128_ = ~x06 & ~x08;
  assign new_n129_ = (x05 | ~x17 | x18 | ~x20) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n130_ = ~x15 & ~x17 & x18 & (~x05 ^ x07);
  assign z11 = ~x18 & (new_n132_ | ~x20);
  assign new_n132_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = (~x18 & ~x20) | (~x09 & (new_n134_ | (new_n142_ & x17 & ~x18 & x20)));
  assign new_n134_ = ~x07 & (new_n141_ | (~x17 & x18 & ~new_n135_ & ~x21));
  ...
  assign z17 = ~x09 & ((~new_n162_ & ~x05) | (new_n165_ & new_n66_ & ~x04 & x05));
  ...
  assign new_n167_ = (x14 | x15 | (~new_n168_ & ~new_n87_)) & (x08 | ~x15 | ~x19);
  assign new_n168_ = x12 & ((~new_n169_ & ~x06) | (new_n170_ & x06 & x08 & x10));
  assign new_n169_ = (~new_n92_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n170_ = ~x13 & x16 & ~x21;
  assign z19 = ~new_n172_ & ~x18;
  assign new_n172_ = x20 & (x05 | x07 | x09 | x15 | ~x17 | ~x20);
  ...
  assign new_n199_ = ~x21 & (new_n200_ | (~new_n139_ & ~x04));
  assign new_n200_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n201_ = x20 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n202_ = new_n81_ & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n210_ | (~new_n204_ & x18))) | (~x09 & x17 & new_n212_ & ~x18);
  assign new_n204_ = (~x08 | ((new_n209_ | x07) & (new_n205_ | x05))) & (x05 | x07 | ~new_n208_ | x08);
  ...
  assign new_n211_ = ~x09 & x15 & ~x18 & x20 & (~x02 | ~x11);
  assign new_n212_ = x20 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
endmodule
