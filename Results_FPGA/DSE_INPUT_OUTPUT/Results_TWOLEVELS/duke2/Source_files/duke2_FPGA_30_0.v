...
module FAU ( 
  ...
  assign new_n82_ = (x05 | ((~x03 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  ...
  assign new_n121_ = new_n122_ & x03 & x04 & ~x05 & ~x07 & ~x09;
  ...
  assign new_n159_ = (x07 | (~new_n160_ & (~x00 | ~x03 | ~new_n124_ | ~x15))) & (~x03 | ~x07 | ~new_n124_ | x15);
  ...
  assign new_n167_ = (~x08 | ~x10 | x13 | x16 | x21) & (x04 | x08 | ~x21);
