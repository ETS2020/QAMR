...
module FAU ( 
  ...
  assign new_n67_ = x01 & x07 & ~x18 & (x16 | (x08 & ~x17));
  ...
  assign new_n87_ = ~new_n95_ & (x05 | (~new_n94_ & (new_n88_ | x15)));
  ...
  assign new_n95_ = new_n96_ & x04 & ~x12 & ~x15 & ~x21;
  ...
  assign new_n121_ = (new_n122_ | x15) & (~new_n61_ | ~x11 | ~x15);
  assign new_n122_ = x08 ? (~new_n90_ | x14) : new_n123_;
  ...
  assign new_n142_ = ~new_n143_ & (~new_n96_ | x04 | x11 | ~x15 | x21);
  ...
  assign new_n158_ = new_n96_ & x04 & ~x15 & x18 & x09 & ~x12;
