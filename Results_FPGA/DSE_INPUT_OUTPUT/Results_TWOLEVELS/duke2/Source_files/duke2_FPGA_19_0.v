...
module FAU ( 
  ...
  assign z23 = (new_n66_ & ~x05 & new_n82_ & ~x17 & x18) | (~x11 & ~x18);
  ...
  assign new_n102_ = x15 & x17 & ~x18 & x00 & x11;
  ...
  assign z07 = (~x11 & ~x18) | (~x17 & ~new_n108_ & x18);
  ...
  assign new_n125_ = ~x07 & ~x09 & new_n104_ & x11;
  ...
  assign new_n129_ = (x05 | ~x11 | ~x17 | x18) & (~new_n130_ | ~x05 | x17 | ~x18 | ~x19);
  assign new_n130_ = x08 & ~x15;
  assign new_n131_ = (x11 | x18) & (~x08 | x15 | x17 | new_n132_ | ~x18);
  assign new_n132_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign z11 = ~x18 & (~x11 | (new_n135_ & new_n134_ & x01));
  assign new_n134_ = ~x05 & x07;
  assign new_n135_ = ~x09 & ~x15 & ~x17;
  ...
  assign new_n143_ = (~x05 | ~x08 | x11 | ~x15) & (x08 | ~x12 | x15 | x05 | x06);
  ...
  assign new_n155_ = x17 & ~x15 & x11 & ~x09 & x05 & ~x07;
  ...
  assign z17 = ~x09 & (new_n164_ | (new_n65_ & new_n106_ & ~x11 & x15));
  assign new_n164_ = ~x05 & (new_n103_ | (~x07 & (new_n102_ | (new_n165_ & ~x08))));
  assign new_n165_ = ~x15 & ~x17 & x18 & ~new_n60_ & ~new_n166_;
  assign new_n166_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = new_n168_ | (~x11 & ~x18);
  assign new_n168_ = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n169_ & x18;
  ...
  assign new_n195_ = ~x15 & ~x18 & x08 & x11 & new_n134_ & x01;
  ...
  assign z28 = (~new_n208_ & ~x17) | (~x09 & x11 & new_n217_ & x17);
  assign new_n208_ = ~new_n216_ & (~x18 | (~new_n214_ & (new_n209_ | ~x08)));
  ...
  assign new_n214_ = ~x05 & ~x07 & new_n215_ & ~x08;
  assign new_n215_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n101_ & x21));
  assign new_n216_ = new_n134_ & ~x02 & ~x09 & x11 & x15 & ~x18;
