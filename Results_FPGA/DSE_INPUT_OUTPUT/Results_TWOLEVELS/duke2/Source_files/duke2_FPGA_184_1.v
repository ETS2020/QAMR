...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n71_, new_n74_, new_n75_, new_n79_, new_n80_, new_n82_, new_n83_,
    new_n86_;
  assign z00 = ~x09 & ~new_n54_ & ~x18;
  assign new_n54_ = (new_n55_ | ~x17) & (~new_n56_ | x14 | x15 | x17 | x21);
  assign new_n55_ = x05 ? (x07 & x15) : (x07 ? ~x15 : (x15 & (x00 | ~x15)));
  assign new_n56_ = x04 & ~x05 & ~x07 & x12;
  assign z01 = ~x17 & (x18 | (new_n58_ & ~x09 & x11 & x15 & ~x18));
  assign new_n58_ = x02 & ~x05 & x07;
  ...
  assign z24 = ~x17 & (x18 | (~x05 & ~x09 & ~new_n82_ & ~x15));
  assign new_n82_ = (~x01 | ~x07 | ~x08) & (~new_n83_ | ~x04 | x07 | ~x12);
  assign new_n83_ = ~x14 & ~x18 & ~x21;
  assign z26 = ~x20 & ~z16 & (x14 | x21);
  assign z28 = ~x09 & ~x18 & (x05 ? (~x07 & x17) : new_n86_);
  assign new_n86_ = x15 & ((x07 & ~x17 & (~x02 | ~x11)) | (x17 & (~x07 | ~x19)));
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z18 = 1'b0;
  assign z21 = 1'b0;
