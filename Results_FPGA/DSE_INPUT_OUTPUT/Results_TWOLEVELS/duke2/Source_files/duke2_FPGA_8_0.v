...
module FAU ( 
  ...
  assign z01 = ~x17 & (new_n65_ | (~x05 & (new_n63_ | (~new_n58_ & ~x09))));
  ...
  assign z23 = new_n78_ | (new_n81_ & ~x05 & ~x07 & x08);
  assign new_n81_ = ~x17 & x18 & x09 & ~x15;
  assign new_n82_ = (~x08 | x17 | ~x18 | (~x05 ^ x15)) & (x05 | ~x10 | ~x17 | x18);
  assign new_n83_ = x05 ? ((~x10 | ~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (~x10 | ~x17 | x18);
  ...
  assign z06 = new_n78_ | (~x09 & (new_n105_ | (~new_n94_ & ~x05)));
  ...
  assign new_n103_ = x00 & x10 & x15 & x17 & ~x18;
  assign new_n104_ = x07 & x10 & ~x15 & x17 & ~x18;
  ...
  assign new_n123_ = new_n124_ & x04 & ~x05 & ~x07 & ~x09 & x10;
  assign new_n124_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n125_ = x10 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | ~x10)));
  assign z10 = new_n127_ | (x08 & new_n132_ & ~x15);
  assign new_n127_ = ~x09 & (x07 ? ~new_n130_ : ~new_n128_);
  ...
  assign new_n134_ = ~x15 & x10 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n78_ | (~x09 & (new_n144_ | (~new_n136_ & ~x07)));
  ...
  assign new_n143_ = x15 & x17 & ~x18 & x00 & ~x05 & x10;
  assign new_n144_ = ~x15 & x17 & ~x18 & ~x05 & x07 & x10;
  assign z13 = ~x09 & x10 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n147_ & ~x17) | (~x18 & (~x10 | (new_n153_ & ~x05)));
  assign new_n147_ = (~new_n148_ | ~x08) & (x05 | x09 | ~new_n151_ | ~x10);
  ...
  assign new_n153_ = ~x09 & ((~x01 & x07) | (x10 & x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n155_ & ~x18;
  assign new_n155_ = x10 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign z17 = new_n164_ | new_n78_;
  assign new_n164_ = ~x09 & (new_n168_ | (~x05 & (new_n104_ | (~new_n165_ & ~x07))));
  assign new_n165_ = ~new_n103_ & (x08 | x15 | x17 | ~new_n166_ | ~x18);
  assign new_n166_ = ~new_n167_ & (~x21 | (~x14 & x21));
  assign new_n167_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n168_ = new_n66_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = new_n78_ | (~x05 & ~x07 & ~x09 & new_n170_ & ~x17);
  assign new_n170_ = x18 & ((~x14 & ~new_n171_ & ~x15) | (~x08 & x15 & x19));
  assign new_n171_ = ~new_n87_ & (~x12 | (~new_n173_ & (new_n172_ | x06)));
  assign new_n172_ = (x04 | x08 | ~x21) & (~new_n92_ | ~x08 | ~x10);
  assign new_n173_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign z19 = new_n175_ & ~x18;
  assign new_n175_ = x17 & ~x15 & x10 & ~x09 & ~x05 & ~x07;
  ...
  assign new_n181_ = new_n182_ & x04 & ~x05 & x10 & x12;
  assign new_n182_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n183_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n184_ = new_n185_ & x04 & x05 & x08;
  assign new_n185_ = ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n202_ = ~x21 & (new_n141_ | new_n203_);
  ...
  assign z28 = ((new_n209_ | new_n216_) & ~x17) | (~x09 & x10 & new_n218_ & x17);
  ...
  assign new_n215_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n101_ & x21));
