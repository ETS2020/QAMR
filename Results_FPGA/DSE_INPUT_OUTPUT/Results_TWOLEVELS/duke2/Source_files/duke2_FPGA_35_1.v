...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28;
  wire new_n54_, new_n55_, new_n56_, new_n59_, new_n61_, new_n65_, new_n68_,
    new_n69_, new_n71_, new_n74_, new_n75_, new_n76_, new_n81_, new_n82_,
  ...
  assign z09 = z16 | (~x07 & ~x09 & ~new_n68_ & ~x15);
  assign new_n68_ = x05 ? (~x17 | x18) : ((~x17 | x18) & (~new_n69_ | ~x04 | ~x12));
  assign new_n69_ = ~x14 & ~x17 & ~x21;
  assign z11 = new_n71_ & ~x18;
  assign new_n71_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z13 = z16 | z03;
  assign z14 = z16 | (~x05 & ~x09 & (~new_n75_ | (~new_n74_ & ~x15)));
  assign new_n74_ = (~x07 | ~x17 | x18) & (~new_n69_ | ~x04 | x07 | ~x12);
  assign new_n75_ = ~new_n76_ & (x01 | ~x07 | x18);
  assign new_n76_ = x15 & ((~x18 & (x07 ? (x17 | (x02 & x11 & ~x17)) : x17)) | (x07 & ~x17 & (~x02 | ~x11)));
