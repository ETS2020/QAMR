...
module FAU ( 
  ...
  assign z23 = (x03 & ~x18) | (new_n65_ & ~x05 & new_n82_ & ~x17 & x18);
  assign new_n82_ = x09 & ~x15;
  assign new_n83_ = (x05 | ((x03 | ~x17 | x18) & (x17 | ~x18 | ~x08 | ~x15))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n84_ = (~x05 | ((x03 | ~x17 | x18) & (x08 | x15 | x17 | ~x18))) & (x03 | x05 | ~x17 | x18);
  assign z04 = ~x14 & ~new_n79_ & ~x20;
  assign z05 = new_n79_ | (~x05 & ~x07 & ~x09 & new_n87_ & ~x14);
  ...
  assign z06 = new_n79_ | (~x09 & (new_n103_ | (~x05 & (new_n95_ | new_n105_))));
  ...
  assign z12 = new_n79_ | (~x09 & (x05 ? new_n139_ : ~new_n135_));
  ...
  assign z17 = new_n79_ | (~x09 & (new_n163_ | (~new_n160_ & ~x05)));
  assign new_n160_ = (x07 | (~new_n161_ & (~new_n125_ | ~x15 | ~x00 | x03))) & (x03 | ~x07 | ~new_n125_ | x15);
  ...
  assign z18 = new_n79_ | (~x05 & ~x07 & ~x09 & new_n166_ & ~x17);
  ...
  assign new_n171_ = ~x03 & (x09 | x15 | ~x17 | x03 | x05 | x07);
  assign z20 = new_n79_ | (~x07 & ~x17 & (new_n181_ | (~new_n173_ & ~x09)));
  ...
  assign new_n178_ = new_n179_ & ~x05 & x12 & ~x03 & x04;
  assign new_n179_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n180_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n181_ = new_n71_ & x04 & x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n185_ = (x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)));
  ...
  assign z27 = (~new_n197_ & ~x09) | (x03 & (new_n200_ | ~x18));
  assign new_n197_ = x05 ? (x17 | new_n199_ | ~x18) : (~new_n105_ & (x17 | new_n198_ | ~x18));
  assign new_n198_ = (x07 | x08 | x15 | new_n162_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n199_ = (x15 | ~x19 | ~x07 | ~x08) & (x07 | ((x08 | x15 | ~x19) & (~new_n72_ | x04 | ~x08)));
  assign new_n200_ = new_n82_ & ~x17 & x19 & new_n65_ & ~x05;
  assign z28 = (~new_n202_ & ~x17) | (~x03 & ~x09 & new_n211_ & x17);
  ...
  assign new_n207_ = ~x15 & x18 & (x08 ? new_n208_ : (~new_n101_ & x21));
