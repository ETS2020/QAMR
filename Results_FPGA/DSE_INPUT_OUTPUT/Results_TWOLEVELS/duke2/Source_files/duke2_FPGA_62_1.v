...
module FAU ( 
  ...
  assign new_n75_ = ~x15 & (new_n76_ | (x07 & x17 & ~x18));
  assign new_n76_ = ~x14 & ~x17 & ~x21 & x04 & ~x07 & x12;
  assign new_n77_ = (~x15 | (~x17 & (~x07 | x17 | (x02 & x11 & (~x02 | ~x11))))) & (x01 | ~x07);
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~new_n81_ & ~x17;
  assign new_n81_ = ~x18 & (~new_n82_ | x07 | x09 | ~x04 | x05);
