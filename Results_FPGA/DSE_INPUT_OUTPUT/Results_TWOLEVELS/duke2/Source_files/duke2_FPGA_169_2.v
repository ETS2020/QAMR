...
module FAU ( 
  ...
  assign new_n55_ = x17 & (x05 ? (~x15 | (~x07 & ~x13)) : (~x13 & (x07 ? x15 : (~x15 | (~x00 & x15)))));
  assign new_n56_ = ~x13 & ~x14 & ~x15 & ~x17 & ~x21;
  ...
  assign new_n64_ = x15 & ~x18 & x11 & ~x13;
  ...
  assign z06 = ~x09 & (new_n104_ | (~x05 & (new_n93_ | new_n102_)));
  assign new_n93_ = ~x07 & (new_n101_ | (~x17 & (new_n94_ | new_n100_) & x18));
  assign new_n94_ = ~x15 & ((new_n99_ & ~x08) | (~x14 & (new_n88_ | ~new_n95_)));
  ...
  assign z09 = (~x17 & ((~new_n110_ & x18) | (new_n116_ & x04))) | (~new_n118_ & ~x18);
  assign new_n110_ = (x07 | (x08 ? new_n111_ : ~new_n114_)) & (~x05 | ~new_n115_ | ~x08);
  assign new_n111_ = (new_n112_ | (~x09 & x21)) & (x09 | ((~x05 | ~x21) & (~x02 | ~new_n113_ | x05)));
  assign new_n112_ = (x11 | ~x15 | ~x02 | x05) & (~x12 | x15 | x04 | ~x05);
  assign new_n113_ = x13 & ~x14 & ~x15 & ~x21 & (~x10 | (x10 & x12));
  assign new_n114_ = ~x09 & ~x15 & (x05 ? ~x19 : new_n99_);
  assign new_n115_ = ~x15 & (x07 | ~x12);
  assign new_n116_ = ~x07 & ~x09 & ~x14 & ~x15 & ~new_n117_ & ~x21;
  assign new_n117_ = (~x02 | ~x08 | x12 | ~x13) & (x05 | ~x12 | x13 | x18);
  assign new_n118_ = ~x13 & (x07 | x09 | x13 | x15 | ~x17);
  assign z10 = (~x09 & (x07 ? ~new_n122_ : ~new_n120_)) | (x08 & new_n123_ & x09);
  assign new_n120_ = x05 ? ((x13 | ~x17 | x18) & (~new_n121_ | x15 | x17 | ~x18)) : ((x13 | ~x17 | x18) & (~new_n121_ | ~x15 | x17 | ~x18));
  assign new_n121_ = ~x06 & ~x08;
  assign new_n122_ = (x05 | x13 | ~x17 | x18) & (x15 | x17 | ~x18 | ~x05 | ~x08);
  assign new_n123_ = ~x15 & ~x17 & x18 & (x05 ^ ~x07);
  assign z11 = ~x18 & (new_n125_ | x13);
  assign new_n125_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = ~x09 & ((~new_n127_ & ~x07) | (new_n103_ & ~x05 & x07 & ~x13));
  assign new_n127_ = ~new_n134_ & (x17 | ~x18 | x21 | (new_n128_ & ~new_n132_));
  ...
  assign new_n134_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x13;
  assign z13 = ~x09 & ~x13 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n137_ & ~x17) | (~x05 & new_n143_ & ~x09);
  assign new_n137_ = (~new_n138_ | ~x08) & (x05 | x09 | ~new_n141_ | x13);
  ...
  assign new_n143_ = ~x13 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n145_ & ~x18;
  assign new_n145_ = x17 & ~x15 & ~x13 & ~x09 & x05 & ~x07;
  ...
  assign new_n152_ = new_n115_ & x09;
  assign z17 = new_n78_ | (~x09 & (new_n154_ | new_n157_));
  assign new_n154_ = ~x05 & (new_n102_ | (~x07 & (new_n101_ | (new_n155_ & ~x08))));
  assign new_n155_ = ~x15 & ~x17 & ~new_n61_ & ~new_n156_ & x18;
  ...
  assign new_n161_ = (~new_n91_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n162_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~new_n164_ & ~x18;
  assign new_n164_ = ~x13 & (x13 | x15 | ~x17 | x05 | x07 | x09);
  assign z20 = ~x07 & ~x17 & (new_n173_ | ((new_n166_ | new_n171_) & ~x09));
  assign new_n166_ = x18 & (new_n167_ | (~x05 & new_n170_ & ~x06));
  ...
  assign new_n171_ = new_n172_ & x12 & ~x13 & x04 & ~x05;
  assign new_n172_ = ~x14 & ~x15 & ~x18 & ~x21;
  ...
  assign new_n183_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x13 | x14 | x18);
  ...
  assign new_n191_ = ~x21 & (new_n132_ | new_n192_);
  assign new_n192_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n193_ = new_n194_ & ~x05;
  assign new_n194_ = ~x13 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n195_ = ~new_n78_ & (~new_n196_ | ~new_n66_ | ~x03 | x05);
  assign new_n196_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n198_ & ~x17) | (~x09 & ~x13 & new_n207_ & x17);
  assign new_n198_ = (new_n199_ | ~x18) & (x05 | ~new_n206_ | ~x07);
  assign new_n199_ = (~x08 | ((new_n200_ | x05) & (new_n205_ | x07))) & (x05 | x07 | ~new_n203_ | x08);
