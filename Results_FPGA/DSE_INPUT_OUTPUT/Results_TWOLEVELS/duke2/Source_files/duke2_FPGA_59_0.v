...
module FAU ( 
  ...
  assign z06 = new_n78_ | (~x09 & (new_n105_ | (~new_n93_ & ~x05)));
  assign new_n93_ = ~new_n104_ & (x07 | (~new_n102_ & (x17 | new_n94_ | ~x18)));
  ...
  assign new_n108_ = (x09 | (x07 ? (~x08 | (~x05 ^ x15)) : (x08 | (~x05 ^ x15)))) & (~x09 | x15 | ~x16 | x05 | x07 | ~x08);
  ...
  assign new_n112_ = ~x09 & ((new_n118_ & x05) | (~x21 & (new_n113_ | (~new_n115_ & ~x05))));
  ...
  assign z10 = ~new_n129_ | (~x09 & (x07 ? new_n131_ : ~new_n127_));
  assign new_n127_ = x05 ? ((~x17 | x18 | ~x19) & (~new_n128_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | ~x19) & (~new_n128_ | x17 | ~x18))) & (x15 | ~x17 | x18 | ~x19));
  assign new_n128_ = ~x06 & ~x08;
  assign new_n129_ = (x18 | x19) & (~x08 | x15 | x17 | new_n130_ | ~x18);
  assign new_n130_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign new_n131_ = x19 & ((~x05 & x17 & ~x18) | (x05 & x08 & ~x15 & ~x17 & x18));
  assign z11 = x19 & new_n133_ & ~x18;
  assign new_n133_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n78_ | (~x09 & (new_n135_ | (new_n103_ & new_n143_)));
  ...
  assign new_n152_ = ~x18 & x19 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  ...
  assign new_n158_ = (~x06 | (~new_n159_ & (~x12 | new_n160_ | x16))) & ~new_n97_ & (x06 | ~x12 | new_n160_ | ~x16);
  ...
  assign new_n166_ = ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n180_ = ~x15 & ~x18 & x19 & ~x21;
  ...
  assign z22 = (~x18 & ~x19) | (~x17 & x18 & (new_n187_ | new_n188_));
  ...
  assign new_n193_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | ~x19);
  ...
  assign z27 = new_n200_ | new_n78_ | (new_n205_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n204_ = x19 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n205_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n216_ & ~x18) | (~x17 & (new_n214_ | (~new_n207_ & x18)));
  ...
  assign new_n212_ = ~x09 & ~x14 & ~x15 & ~new_n101_ & x21;
  assign new_n213_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n214_ = ~x05 & ~x09 & ~new_n215_ & x15;
  assign new_n215_ = x07 ? (x18 | ~x19 | (x02 & x11)) : (x08 | x19);
  assign new_n216_ = x19 & (x07 | x09 | ~x17 | ~x19 | (~x05 & (x05 | ~x15)));
endmodule
