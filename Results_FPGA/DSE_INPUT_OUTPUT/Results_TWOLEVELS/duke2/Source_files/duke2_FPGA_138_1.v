...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n70_, new_n72_, new_n73_, new_n74_, new_n75_, new_n80_, new_n81_,
  ...
  assign z14 = (~x17 & x18) | (~x05 & ~x09 & (new_n75_ | (~new_n72_ & ~x18)));
  assign new_n72_ = (new_n73_ | x15) & (x01 | ~x07) & (~x15 | (~x17 & (~x07 | new_n74_ | x17)));
  assign new_n73_ = (~x07 | ~x17) & (~x04 | x07 | ~x12 | x14 | x17 | x21);
  assign new_n74_ = x02 & x11;
  assign new_n75_ = x02 & x07 & x11 & x15 & ~x17;
  ...
  assign new_n87_ = x15 & ((x07 & ~new_n74_ & ~x17) | (x17 & (~x07 | ~x19)));
  assign z07 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
  assign z21 = 1'b0;
