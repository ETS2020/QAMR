...
module FAU ( 
  ...
  assign new_n71_ = x06 ? (x02 & x11) : (~x18 | (x04 & x12));
  ...
  assign new_n101_ = x00 & ~x06 & x15 & x17 & ~x18;
  ...
  assign new_n125_ = ~new_n127_ & (new_n126_ | x06);
  assign new_n126_ = (x07 | (x05 ? ((~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (x15 ? ((~x17 | x18) & (x08 | x17 | ~x18)) : (~x17 | x18)))) & (x05 | ~x07 | ~x17 | x18);
  assign new_n127_ = ~x15 & ~x17 & x18 & x05 & x07 & x08;
  assign new_n128_ = ~x15 & ~x17 & x18 & (x05 ^ ~x07);
  assign z11 = ~x18 & new_n130_ & ~x17;
  assign new_n130_ = ~x15 & ~x09 & x07 & ~x06 & x01 & ~x05;
  assign z12 = new_n132_ | new_n78_;
  assign new_n132_ = ~x09 & (new_n141_ | (~x07 & (new_n140_ | (new_n133_ & ~x17))));
  assign new_n133_ = x18 & ~x21 & (new_n134_ | new_n139_ | (~new_n136_ & ~x05));
  ...
  assign new_n140_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x06;
  assign new_n141_ = ~x15 & x17 & ~x18 & ~x05 & ~x06 & x07;
  assign z13 = ~x18 & (x06 | (~x06 & ~x09 & x17 & (~x05 | (x05 & ~x07))));
  assign z14 = (~new_n144_ & ~x17) | (~x05 & new_n150_ & ~x06);
  assign new_n144_ = (~new_n145_ | ~x08) & (x05 | x06 | ~new_n148_ | x09);
  ...
  assign z17 = new_n78_ | (~x09 & (new_n161_ | new_n164_));
  assign new_n161_ = ~x05 & (new_n104_ | (~x07 & (new_n101_ | (new_n162_ & ~x08))));
  assign new_n162_ = ~x15 & ~x17 & x18 & ~new_n61_ & ~new_n163_;
  assign new_n163_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n164_ = new_n65_ & new_n103_ & ~x11 & x15;
  ...
  assign new_n171_ = ~x06 & (x09 | x15 | ~x17 | x05 | x06 | x07);
  ...
  assign new_n177_ = new_n178_ & ~x06 & x12 & x04 & ~x05;
  ...
  assign new_n199_ = ~x21 & (new_n134_ | new_n200_);
  assign new_n200_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n201_ = new_n202_ & ~x05;
  assign new_n202_ = ~x06 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n203_ = ~new_n78_ & (~new_n204_ | ~new_n66_ | ~x03 | x05);
  assign new_n204_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n206_ & ~x17) | (~x06 & ~x09 & new_n214_ & x17);
  assign new_n206_ = (new_n207_ | ~x18) & (x05 | ~new_n213_ | x06);
  ...
  assign new_n211_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
