...
module FAU ( 
  ...
  assign z14 = (~x17 & x18) | (~x05 & ~x09 & (new_n75_ | (~new_n73_ & ~x18)));
  assign new_n73_ = (new_n74_ | x15) & (~x07 | (x01 & (~x15 | ~x17))) & (x07 | ~x15 | ~x17);
  assign new_n74_ = (~x07 | ~x17) & (~x04 | x07 | ~x12 | x14 | x17 | x21);
  assign new_n75_ = x07 & x15 & ~x17 & (~x02 | ~x11 | (x02 & x11));
  ...
  assign z27 = z06 | z05;
  assign z28 = (~x17 & x18) | (~x09 & ((new_n87_ & ~x05) | (x17 & ~x18 & x05 & ~x07)));
  assign new_n87_ = ~new_n88_ & x15;
  assign new_n88_ = (~x07 | x17 | (x02 & x11)) & (~x17 | x18 | (x07 & x19));
  assign z16 = 1'b0;
  assign z22 = 1'b0;
  assign z23 = 1'b0;
  assign z25 = 1'b0;
