...
module FAU ( 
  ...
  assign new_n78_ = (~x07 | (~x09 & x19)) & x11 & (x02 | x07 | ~x09 | ~x11);
  ...
  assign new_n92_ = (x17 | ~x18 | (~new_n63_ & (new_n93_ | x15))) & (~x00 | ~x15 | ~x17 | x18);
  ...
  assign new_n104_ = (x09 | (x07 ? (~x08 | (~x05 ^ x15)) : (x08 | (~x05 ^ x15)))) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20 & (~x17 | ~x18);
  assign z09 = (x18 & (new_n107_ | x17 | (new_n120_ & ~x07))) | (new_n122_ & ~x07);
  assign new_n107_ = ~x15 & (new_n118_ | (~x07 & (new_n116_ | (~new_n108_ & ~x09))));
  assign new_n108_ = (x21 | ((new_n111_ | x05) & (~new_n109_ | ~x04))) & (~new_n115_ | ~x05);
  assign new_n109_ = ~x12 & (new_n110_ | (x02 & x08 & x13 & ~x14));
  assign new_n110_ = ~x05 & ~x06 & ~x08 & ~x17;
  assign new_n111_ = (~x06 | ((~new_n112_ | ~x02 | ~x08) & (~new_n113_ | x02 | x08))) & (~x02 | ~new_n114_ | ~x08);
  assign new_n112_ = ~x10 & x13 & ~x14;
  assign new_n113_ = x11 & ~x17;
  assign new_n114_ = x13 & ~x14 & ~x17 & (x10 ? x12 : ~x06);
  ...
  assign new_n119_ = x08 & ~x17 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  assign new_n120_ = x08 & (new_n121_ | (~x17 & x21 & x05 & ~x09));
  ...
  assign z12 = ~x09 & ((~new_n132_ & ~x07) | (new_n100_ & ~x15 & ~x05 & x07));
  ...
  assign z14 = (~new_n141_ & ~x07) | (x17 & x18) | (~new_n147_ & x07);
  assign new_n141_ = (new_n142_ | x05) & (~x04 | ~x05 | ~new_n146_ | ~x08);
  assign new_n142_ = (new_n143_ | ~x15) & (~new_n145_ | x15 | x17 | x18 | x21);
  assign new_n143_ = (~new_n144_ | x02) & (~new_n100_ | x09);
  assign new_n144_ = x08 & x11 & ~x17 & x18 & (x09 | (~x09 & ~x21));
  assign new_n145_ = x04 & ~x09 & x12 & ~x14;
  assign new_n146_ = ~x12 & ~x15 & x18 & (x09 | (~x09 & ~x17 & ~x21));
  assign new_n147_ = (new_n148_ | x17) & (x05 | x09 | x18 | (x01 & ~x17));
  assign new_n148_ = (~new_n149_ | x05) & (~x08 | ~x18 | x19 | (~x05 ^ x15));
  assign new_n149_ = ~x09 & x15 & ~x18 & (~x02 | ~x11 | (x02 & x11));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x18 & (x17 | (x08 & (x05 ? new_n158_ : ~new_n152_)));
  assign new_n152_ = (x07 | new_n153_ | x15) & (~x09 | ~x15 | (x02 & (~x07 | x17)));
  assign new_n153_ = x09 ? x19 : (x14 | new_n154_ | x21);
  assign new_n154_ = (~x06 | (~new_n155_ & ~new_n156_)) & (~new_n157_ | x06) & (~new_n95_ | x17);
  ...
  assign new_n163_ = new_n102_ & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n165_ & x18;
  assign new_n165_ = (x14 | x15 | (~new_n166_ & ~new_n85_)) & (x08 | ~x15 | ~x19);
  assign new_n166_ = x12 & ((~new_n167_ & ~x06) | (new_n168_ & x06 & x08 & x10));
  assign new_n167_ = (~new_n90_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n168_ = ~x13 & x16 & ~x21;
  assign z19 = x17 & (x18 | (~x05 & ~x07 & ~x09 & ~x15 & ~x18));
  assign z20 = (x17 & x18) | (~x07 & (new_n178_ | (~x09 & ~new_n171_ & ~x17)));
  ...
  assign new_n176_ = ~x14 & ~x15 & ~x18 & ~x21;
  ...
  assign new_n183_ = (x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  assign new_n184_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z24 = (x17 & x18) | (~x09 & (new_n190_ | (~new_n186_ & ~x07)));
  assign new_n186_ = (~new_n187_ | x17) & (x05 | x08 | x15 | ~x18);
  ...
  assign new_n190_ = new_n191_ & x01 & ~x05 & x07;
  assign new_n191_ = ~x17 & ~x18 & x08 & ~x15;
  assign z25 = ~new_n193_ & x18;
  assign new_n193_ = ~x17 & (x05 | x07 | x17 | (x08 ? (~x09 | x15) : (x09 | ~x15)));
  assign z26 = (x17 & x18) | (~x20 & (x21 | (x14 & (~x17 | ~x18))));
  assign z27 = (~x09 & (new_n202_ | (~new_n196_ & x18))) | (x18 & (new_n201_ | x17));
  assign new_n196_ = (new_n197_ | x17) & (~new_n200_ | x08 | ~x05 | x07);
  assign new_n197_ = x07 ? ~new_n199_ : (x21 | (~new_n198_ & (new_n137_ | x04)));
  assign new_n198_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n199_ = x08 & x19 & (x05 ^ x15);
  assign new_n200_ = ~x15 & x19;
  assign new_n201_ = x03 & ~x05 & ~x07 & new_n200_ & x08 & x09;
  assign new_n202_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n204_ | (new_n211_ & ~x05))) | (~x09 & new_n212_ & x17);
  ...
  assign new_n208_ = (x02 | x07 | ~x11 | (~x09 & (x09 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n209_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n210_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n98_ & x21));
