...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n70_, new_n72_, new_n73_, new_n77_, new_n79_, new_n80_, new_n83_;
  ...
  assign new_n72_ = (~x07 | ~x17) & (~x04 | x07 | ~x12 | x14 | x17 | x21);
  assign new_n73_ = (~x15 | (~x17 & (~x07 | x17 | (x02 & x11 & (~x02 | ~x11))))) & (x01 | ~x07);
  assign z15 = (~x17 & x18) | (x05 & ~x07 & ~x09 & ~x15 & x17 & ~x18);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x21 & ~x18 & ~x17 & new_n77_ & ~x15;
  assign new_n77_ = ~x14 & x12 & ~x09 & ~x07 & x04 & ~x05;
  assign z24 = ~x05 & ~x09 & ~x15 & ~x17 & ~new_n79_ & ~x18;
  assign new_n79_ = (~x01 | ~x07 | ~x08) & (~new_n80_ | ~x04 | x07);
  assign new_n80_ = x12 & ~x14 & ~x21;
  assign z26 = ~x20 & ~z07 & (x14 | x21);
  assign z28 = ~x09 & ~x18 & (x05 ? (~x07 & x17) : new_n83_);
  assign new_n83_ = x15 & ((x07 & ~x17 & (~x02 | ~x11)) | (x17 & (~x07 | ~x19)));
  assign z05 = 1'b0;
  assign z16 = 1'b0;
  assign z22 = 1'b0;
  assign z23 = 1'b0;
