...
module FAU ( 
  ...
  assign z05 = x18 & (~x16 | (~x05 & ~x07 & new_n86_ & ~x09));
  assign new_n86_ = ~x14 & ~x15 & x16 & ~x17 & (~new_n87_ | new_n90_);
  ...
  assign z06 = new_n84_ | (~x09 & (new_n102_ | (~new_n93_ & ~x05)));
  assign new_n93_ = (~new_n101_ | ~x07 | x15) & (x07 | (x15 ? new_n99_ : ~new_n94_));
  assign new_n94_ = x16 & ~x17 & ~new_n95_ & x18;
  ...
  assign new_n98_ = (~x12 | x13 | ~x06 | ~x10) & (~x02 | x06 | x10 | ~x13);
  ...
  assign new_n105_ = ~x17 & ((~x09 & (x05 ^ x15) & (~x07 ^ x08)) | (~x05 & ~x07 & x08 & x09 & ~x15));
  ...
  assign z11 = new_n84_ | (new_n131_ & x01 & ~x05 & x07);
  ...
  assign z14 = (~new_n143_ & ~x17) | new_n84_ | (new_n151_ & ~x05);
  assign new_n143_ = (~x08 | new_n144_ | ~x18) & (x05 | x09 | new_n149_ | x18);
  assign new_n144_ = x07 ? (x19 | (x05 ^ ~x15)) : new_n145_;
  assign new_n145_ = ~new_n148_ & (~x16 | (~new_n146_ & ~new_n147_));
  assign new_n146_ = ~x02 & ~x05 & x11 & x15 & (x09 | (~x09 & ~x21));
  assign new_n147_ = x04 & x05 & ~x09 & ~x12 & ~x15 & ~x21;
  assign new_n148_ = x04 & x05 & x09 & ~x12 & ~x15;
  ...
  assign z16 = x18 & (~x16 | (new_n154_ & x08));
  assign new_n154_ = ~x17 & (x05 ? new_n161_ : (new_n160_ | (new_n155_ & ~x07)));
  assign new_n155_ = ~x15 & (x09 ? ~x19 : (~x14 & ~new_n156_ & ~x21));
  assign new_n156_ = (~new_n157_ | ~x02) & ~new_n159_ & ((~new_n97_ & ~new_n158_) | ~x16);
  assign new_n157_ = x06 & ((x04 & ~x12) | (~x10 & x13 & x16));
  assign new_n158_ = ~x06 & x10 & x12 & ~x13;
  assign new_n159_ = x11 & x12 & ~x02 & ~x06;
  assign new_n160_ = x09 & x15 & (~x02 | (x07 & x16));
  assign new_n161_ = x09 & ~x15 & (~x12 | (x07 & x16));
  assign z17 = ~x09 & ((~new_n163_ & ~x05) | (new_n167_ & new_n166_ & ~x04 & x05));
  assign new_n163_ = (~new_n101_ | ~x07 | x15) & (x07 | ((x08 | ~new_n164_ | x15) & (~new_n101_ | ~x00 | ~x15)));
  ...
  assign z18 = ~x05 & ~x07 & ~x09 & x16 & new_n169_ & ~x17;
  assign new_n169_ = x18 & ((~x14 & ~new_n170_ & ~x15) | (~x08 & x15 & x19));
  assign new_n170_ = ~new_n90_ & (new_n171_ | ~x12);
  assign new_n171_ = (x04 | x06 | x08 | ~x21) & (~x06 | ~x08 | ~x10 | x13 | x21);
  assign z19 = new_n84_ | (new_n121_ & ~x05 & ~x07 & ~x09);
  assign z20 = new_n84_ | (~x07 & ~x17 & (new_n181_ | (~new_n174_ & ~x09)));
  assign new_n174_ = (~new_n180_ | ~x04 | x05 | ~x12) & (~new_n175_ | ~x16);
  assign new_n175_ = x18 & (new_n178_ | (~x21 & (x04 ? new_n176_ : ~new_n138_)));
  ...
  assign z23 = x18 & (~x16 | (new_n189_ & x09 & ~x15 & x16 & ~x17));
  assign new_n189_ = ~x05 & ~x07 & x08;
  assign z24 = new_n84_ | (~x09 & (new_n191_ | new_n195_) & ~x17);
  assign new_n191_ = ~x07 & (new_n192_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n192_ = ~x21 & ((x04 & ~new_n193_ & ~x15) | (x08 & new_n194_ & x15));
  assign new_n193_ = (~x05 | ~x08 | x12 | ~x16 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n194_ = x16 & x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n195_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = x18 & (~x16 | (~x05 & ~x07 & new_n197_ & x16));
  assign new_n197_ = ~x17 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = new_n84_ | (~x20 & (x14 | x21));
  assign z27 = new_n204_ | (~x09 & (new_n206_ | (x16 & new_n200_ & ~x17)));
  ...
  assign new_n204_ = new_n205_ & x03 & ~x05 & ~x07 & x08 & x09;
  assign new_n205_ = ~x15 & x16 & ~x17 & x18 & x19;
  assign new_n206_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = new_n218_ | (~x17 & (new_n216_ | (x16 & ~new_n208_ & x18)));
