...
module FAU ( 
  ...
  assign new_n104_ = x15 & x17 & ~x18 & x00 & x13;
  ...
  assign new_n127_ = x13 & (x07 | x09 | ~x13 | x15 | ~x17);
  assign z10 = new_n129_ | (x08 & new_n134_ & ~x15);
  assign new_n129_ = ~x09 & (x07 ? ~new_n132_ : ~new_n130_);
  assign new_n130_ = x05 ? ((~x13 | ~x17 | x18) & (~new_n131_ | x15 | x17 | ~x18)) : ((~x13 | ~x17 | x18) & (~new_n131_ | ~x15 | x17 | ~x18));
  ...
  assign z11 = ~x18 & (~x13 | (new_n136_ & ~x09 & ~x15 & ~x17));
  assign new_n136_ = x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n138_ & ~x07) | (new_n106_ & ~x05 & x07 & x13));
  ...
  assign new_n145_ = x15 & x17 & ~x18 & x00 & ~x05 & x13;
  assign z13 = ~x09 & x13 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n148_ & ~x17) | (~x05 & new_n154_ & ~x09);
  assign new_n148_ = (~new_n149_ | ~x08) & (x05 | x09 | ~new_n152_ | ~x13);
  assign new_n149_ = x18 & (x07 ? new_n151_ : (~new_n150_ & (x09 | (~x09 & ~x21))));
  assign new_n150_ = (~x11 | ~x15 | x02 | x05) & (x12 | x15 | ~x04 | ~x05);
  ...
  assign new_n154_ = x13 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n156_ & ~x18;
  assign new_n156_ = x17 & ~x15 & x13 & ~x09 & x05 & ~x07;
  ...
  assign z17 = new_n80_ | (~x09 & (new_n165_ | new_n168_));
  ...
  assign new_n168_ = new_n65_ & new_n108_ & ~x11 & x15;
  ...
  assign new_n175_ = x13 & (x05 | x07 | x09 | ~x13 | x15 | ~x17);
  assign z20 = new_n80_ | (~x07 & ~x17 & (new_n184_ | (~new_n177_ & ~x09)));
  ...
  assign new_n192_ = ~new_n193_ & (~new_n136_ | x15 | x18 | ~x08 | ~x13);
  ...
  assign new_n205_ = x13 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n206_ = new_n207_ & new_n66_ & x03 & ~x05;
  assign new_n207_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n209_ | new_n216_)) | (~x09 & x13 & new_n218_ & x17);
  ...
  assign new_n217_ = ~x09 & x13 & x15 & ~x18 & (~x02 | ~x11);
