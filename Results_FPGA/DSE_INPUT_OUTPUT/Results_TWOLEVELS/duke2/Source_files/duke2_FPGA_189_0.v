...
module FAU ( 
  ...
  assign new_n71_ = (~x07 | ((~x01 | x15 | x18 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18))) & (x07 | x08 | ~x15 | ~x18);
  ...
  assign z06 = (~x18 & ~x19) | (~x09 & (new_n106_ | (~new_n94_ & ~x05)));
  ...
  assign new_n130_ = (x18 | x19) & (~x08 | x15 | x17 | new_n131_ | ~x18);
  assign new_n131_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign new_n132_ = x19 & ((~x05 & x17 & ~x18) | (x05 & x08 & ~x15 & ~x17 & x18));
  assign z11 = ~x18 & (~x19 | (new_n134_ & ~x09 & ~x15 & ~x17));
  assign new_n134_ = x01 & ~x05 & x07;
  assign z12 = (~x18 & ~x19) | (~x09 & (new_n136_ | (new_n144_ & x17 & ~x18 & x19)));
  ...
  assign new_n151_ = x19 & (new_n152_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n152_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n153_ = ~x18 & x19 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n155_ & x19;
  ...
  assign z17 = (~x18 & ~x19) | (~x09 & (new_n167_ | (~new_n164_ & ~x05)));
  ...
  assign new_n192_ = ~new_n193_ & (~new_n134_ | x18 | ~x19 | ~x08 | x15);
  assign new_n193_ = ~x07 & (new_n194_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n194_ = ~x21 & ((x04 & ~new_n195_ & ~x15) | (x08 & new_n196_ & x15));
  assign new_n195_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | ~x19);
