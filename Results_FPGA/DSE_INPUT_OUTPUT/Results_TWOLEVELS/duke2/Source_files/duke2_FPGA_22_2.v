...
module FAU ( 
  ...
  assign z01 = (~x18 & (new_n67_ | x13)) | (~x07 & ~x17 & ~new_n59_ & x18);
  assign new_n59_ = ~new_n63_ & (x05 | (~new_n66_ & (x09 | (~new_n60_ & ~new_n65_))));
  ...
  assign new_n70_ = (new_n71_ | ~x18) & (x05 | (x07 ? new_n75_ : (new_n77_ | ~x18)));
  assign new_n71_ = (x07 | (new_n73_ & (new_n72_ | x04))) & (~new_n74_ | ~x05 | ~x07);
  assign new_n72_ = (x06 | x15) & (~new_n64_ | x11 | ~x15 | x21);
  assign new_n73_ = (~x08 | ~x21 | (~x05 & ~x15)) & (x15 | ((x06 | x12) & (~x05 | x08)));
  assign new_n74_ = x08 & ~x15 & x19;
  assign new_n75_ = ~new_n76_ & (~x18 | ~x19 | ~x08 | ~x15);
  assign new_n76_ = x01 & ~x13 & ~x15 & ~x18 & (x08 | x16);
  ...
  assign new_n82_ = new_n83_ & ~x05 & ~x17 & x18 & x09 & ~x15;
  ...
  assign z06 = new_n87_ | (~x09 & (new_n107_ | (~new_n97_ & ~x05)));
  assign new_n97_ = ~new_n106_ & (x07 | (~new_n105_ & (x17 | new_n98_ | ~x18)));
  assign new_n98_ = ~new_n65_ & (x15 | (~new_n103_ & (x14 | (~new_n92_ & new_n99_))));
  ...
  assign new_n105_ = x00 & ~x13 & x15 & x17 & ~x18;
  assign new_n106_ = x07 & ~x13 & ~x15 & x17 & ~x18;
  assign new_n107_ = new_n108_ & new_n83_ & x04 & x05;
  assign new_n108_ = ~x17 & x18 & ~x21 & ~x12 & ~x15;
  assign z07 = ~x17 & ~new_n110_ & x18;
  assign new_n110_ = (x09 | (~x05 ^ x15) | (x07 ^ x08)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = new_n87_ | (x14 & ~new_n87_ & ~x20);
  ...
  assign new_n126_ = ~x13 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n127_ = ~x07 & ~x09 & ~x13 & ~x15 & x17 & ~x18;
  assign z10 = ~new_n133_ | (~x09 & (x07 ? ~new_n131_ : ~new_n129_));
  assign new_n129_ = x05 ? ((x13 | ~x17 | x18) & (~new_n130_ | x15 | x17 | ~x18)) : ((x13 | ~x17 | x18) & (~new_n130_ | ~x15 | x17 | ~x18));
  assign new_n130_ = ~x06 & ~x08;
  assign new_n131_ = (x05 | x13 | ~x17 | x18) & (~new_n132_ | ~x05 | x17 | ~x18 | ~x19);
  assign new_n132_ = x08 & ~x15;
  assign new_n133_ = (~x13 | x18) & (~x08 | x15 | x17 | new_n134_ | ~x18);
  assign new_n134_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign z11 = ~x18 & new_n136_ & ~x17;
  assign new_n136_ = ~x15 & ~x13 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n87_ | (~new_n138_ & ~x09);
  assign new_n138_ = ~new_n146_ & (x07 | (~new_n145_ & (x17 | ~new_n139_ | ~x18)));
  assign new_n139_ = ~x21 & ((~new_n143_ & ~x04) | (new_n144_ & x04 & x05) | (~new_n140_ & ~x05));
  ...
  assign new_n145_ = x00 & ~x05 & ~x13 & x15 & x17 & ~x18;
  assign new_n146_ = ~x15 & x17 & ~x18 & ~x05 & x07 & ~x13;
  assign z13 = ~x18 & (x13 | (~x09 & ~x13 & x17 & (~x05 | (x05 & ~x07))));
  assign z14 = (~new_n149_ & ~x17) | (~x18 & (x13 | (new_n155_ & ~x05)));
  assign new_n149_ = (~x08 | new_n152_ | ~x18) & (x05 | x09 | new_n150_ | x18);
  assign new_n150_ = ~new_n151_ & (~x07 | ~x15 | (x02 & x11 & (~x02 | ~x11)));
  assign new_n151_ = ~x13 & ~x14 & ~x15 & ~x21 & new_n56_ & x04;
  ...
  assign new_n155_ = ~x09 & ((~x01 & x07) | (~x13 & x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n157_ & ~x18;
  assign new_n157_ = x17 & ~x15 & ~x13 & ~x09 & x05 & ~x07;
  ...
  assign new_n164_ = x09 & ~new_n56_ & ~x15;
  assign z17 = ~x09 & ((~new_n166_ & ~x05) | (new_n169_ & new_n83_ & ~x04 & x05));
  assign new_n166_ = ~new_n106_ & (x07 | (~new_n105_ & (~new_n167_ | x08)));
  assign new_n167_ = ~x15 & ~x17 & x18 & ~new_n168_ & (~x21 | (~x14 & x21));
  assign new_n168_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n169_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = new_n87_ | (~x05 & ~x07 & ~x09 & new_n171_ & ~x17);
  assign new_n171_ = x18 & ((~x14 & ~new_n172_ & ~x15) | (~x08 & x15 & x19));
  assign new_n172_ = ~new_n90_ & (~x12 | (~new_n174_ & (new_n173_ | x06)));
  assign new_n173_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign new_n174_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x13 & new_n176_ & ~x09;
  assign new_n176_ = ~x05 & ~x07;
  assign z20 = new_n87_ | (~x07 & ~x17 & (new_n185_ | (~new_n178_ & ~x09)));
  ...
  assign new_n185_ = new_n64_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n216_ = ~x13 & (~new_n217_ | x09);
  assign new_n217_ = x17 & (x05 ? (~x07 & ~x13) : (x15 & (~x19 | (~x07 & ~x13))));
