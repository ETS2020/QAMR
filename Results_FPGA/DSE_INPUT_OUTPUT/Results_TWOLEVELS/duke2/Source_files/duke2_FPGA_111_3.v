...
module FAU ( 
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n99_ | (~new_n91_ & ~x05)));
  assign new_n91_ = (x07 | ((x17 | new_n92_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n92_ = ~new_n62_ & (x15 | (~new_n97_ & (x14 | (~new_n86_ & new_n93_))));
  ...
  assign z07 = x18 & ((~x09 & new_n102_ & ~x17) | x17 | (new_n80_ & new_n104_ & x09));
  ...
  assign new_n135_ = new_n136_ & ~x15 & ~x05 & x07;
  ...
  assign new_n159_ = (x14 | x15 | (~new_n160_ & ~new_n84_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n173_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n178_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | ~x15);
