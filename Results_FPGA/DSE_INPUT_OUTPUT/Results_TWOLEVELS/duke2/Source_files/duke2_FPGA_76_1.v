...
module FAU ( 
  ...
  assign new_n61_ = (x02 | x07 | ~x08 | ~x18 | (~x09 & (x09 | x21))) & (x09 | x18 | ~x02 | ~x07);
  assign z02 = z23 | (~x17 & (new_n68_ | (~x05 & (new_n63_ | new_n66_))));
  assign new_n63_ = ~x09 & (x07 ? ~new_n64_ : new_n65_);
  assign new_n64_ = (~x01 | x15 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18 | ~x19);
  assign new_n65_ = x15 & x18 & (~x08 | (~x02 & x08 & x11 & ~x21));
  assign new_n66_ = x08 & new_n67_ & x15;
  assign new_n67_ = x18 & ((x07 & (x09 | ~x19)) | ~x11 | (x09 & x11 & ~x02 & ~x07));
  assign new_n68_ = ~x07 & x08 & new_n69_ & ~x09;
  assign new_n69_ = x15 & x18 & (x21 | (~x11 & ~x21 & ~x04 & x05));
  assign z03 = z13 | (~new_n71_ & x18);
  assign new_n71_ = x15 & (x05 | ~x07 | ~x08 | x09 | x17);
  ...
  assign new_n77_ = ~x02 & x08 & x11 & ~x17 & x18 & ~x21;
  assign z07 = ~new_n79_ & x18;
  assign new_n79_ = x15 & (x05 | x09 | x17 | (x07 ? ~x08 : (x08 | ~x15)));
  ...
  assign z10 = z23 | (~x09 & ((~x05 & (new_n76_ | new_n88_)) | (new_n76_ & x05 & ~x07)));
  ...
  assign z14 = ~x05 & (new_n101_ | (~x09 & (new_n96_ | new_n98_)));
  assign new_n96_ = x15 & (x17 ? ~x18 : ~new_n97_);
  assign new_n97_ = (x02 | ((~x07 | x18) & (x07 | ~x08 | ~x11 | ~x18 | x21))) & (~x07 | x18 | (x11 & (~x02 | ~x11)));
  assign new_n98_ = ~x18 & ((~new_n99_ & x07) | (new_n100_ & x04 & ~x07 & x12));
  assign new_n99_ = x01 & (x15 | ~x17);
  assign new_n100_ = ~x14 & ~x15 & ~x17 & ~x21;
  assign new_n101_ = x08 & x15 & ~x17 & ~new_n102_ & x18;
  assign new_n102_ = (~x09 | ~x11 | x02 | x07) & (~x07 | x19);
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x18 & (~x15 | (new_n105_ & ~x05));
  assign new_n105_ = x08 & x09 & ~x17 & (~x02 | (x07 & x15));
  assign z17 = z23 | ((new_n107_ | new_n108_) & ~x09);
  assign new_n107_ = new_n60_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign z20 = ~x07 & ~x09 & ~x17 & ~x21 & (new_n113_ | new_n114_);
  assign new_n113_ = ~x04 & x05 & x08 & ~x11 & x15 & x18;
  assign new_n114_ = x04 & ~x05 & x12 & ~x14 & ~x15 & ~x18;
  assign z21 = x18 & (~x15 | (new_n116_ & ~x05));
  assign new_n116_ = ~x09 & ~x17 & ((x07 & x08) | (~x06 & ~x07 & ~x08 & x15));
  assign z22 = x18 & (~x15 | (~x05 & new_n118_ & x15));
  assign new_n118_ = ~x17 & ((~x09 & ((x06 & ~x07 & ~x08) | (x07 & x08 & x19))) | (x07 & x08 & (x09 | ~x19)));
  assign z24 = z23 | (~x09 & (new_n120_ | new_n123_) & ~x17);
  assign new_n120_ = ~x07 & ~x21 & (new_n113_ | (~x05 & (new_n121_ | new_n122_)));
  assign new_n121_ = ~x02 & x08 & x11 & x15 & x18;
  assign new_n122_ = ~x14 & ~x15 & ~x18 & x04 & x12;
  assign new_n123_ = x01 & ~x05 & x07 & x08 & ~x15;
  assign z25 = new_n125_ & ~x05;
  assign new_n125_ = ~x07 & ~x08 & ~x09 & x15 & ~x17 & x18;
  assign z26 = ~x20 & ~z23 & (x14 | x21);
  assign z27 = z23 | (~x09 & (new_n107_ | (~new_n128_ & ~x05)));
  assign new_n128_ = (new_n129_ | ~x07) & (~x00 | x07 | ~new_n76_ | ~x15);
  assign new_n129_ = (x15 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18 | ~x19);
  assign z28 = new_n135_ | (x15 & (new_n137_ | ((new_n131_ | new_n136_) & ~x05)));
  assign new_n131_ = ~x17 & (new_n134_ | (x18 & (new_n133_ | (~new_n132_ & x08))));
  assign new_n132_ = (x02 | x07 | ~x11 | (~x09 & (x09 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n133_ = ~x07 & ~x08 & ~x09 & ~x19;
  assign new_n134_ = x07 & ~x09 & ~x18 & (~x02 | ~x11);
  assign new_n135_ = x05 & ~x07 & new_n76_ & ~x09;
