...
module FAU ( 
  ...
  assign z09 = (~new_n124_ & ~x18) | (~x17 & (new_n119_ | (x18 & (new_n111_ | new_n122_))));
  assign new_n111_ = ~x15 & (new_n118_ | (~x07 & (new_n117_ | (~new_n112_ & ~x09))));
  ...
  assign new_n115_ = (~x02 | ~new_n116_ | ~x08) & (x02 | ~x06 | x08 | ~x11);
  ...
  assign new_n120_ = ~x21 & (new_n121_ | (x04 & x10 & x12 & ~x18));
  assign new_n121_ = x02 & x06 & x08 & ~x10 & x13;
  assign new_n122_ = ~x07 & ~new_n123_ & x08;
  assign new_n123_ = (~x02 | x05 | x11 | ~x15 | (~x09 & x21)) & (~x05 | x09 | ~x21);
  assign new_n124_ = x10 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | ~x10)));
  ...
  assign new_n129_ = (x05 | ~x10 | ~x17 | x18) & (~new_n130_ | ~x05 | x17 | ~x18 | ~x19);
  ...
  assign new_n154_ = x10 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = new_n78_ | (x08 & ~x17 & (x05 ? new_n162_ : ~new_n156_));
  assign new_n156_ = (x07 | new_n157_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n157_ = x09 ? (~x18 | x19) : (x14 | new_n158_ | x21);
  assign new_n158_ = (~x06 | (~new_n159_ & ~new_n160_)) & (~x18 | (~new_n97_ & (~new_n161_ | x06)));
  ...
  assign z17 = ~x09 & (new_n167_ | (~x05 & (new_n106_ | (~new_n164_ & ~x07))));
  assign new_n164_ = (~new_n103_ | ~x15 | ~x17 | x18) & (x08 | x15 | x17 | ~new_n165_ | ~x18);
  ...
  assign new_n174_ = x17 & ~x15 & x10 & ~x09 & ~x05 & ~x07;
  ...
  assign new_n193_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x10 | ~x12 | x14 | x18);
  ...
  assign z28 = (~x17 & (new_n208_ | new_n215_)) | (~x09 & x10 & new_n217_ & x17);
  ...
  assign new_n216_ = ~x09 & x10 & x15 & ~x18 & (~x02 | ~x11);
