...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n77_, new_n80_, new_n82_, new_n84_, new_n85_, new_n86_, new_n87_,
  ...
  assign z02 = ~x17 & (new_n75_ | (~x09 & (new_n69_ | (~new_n73_ & x18))));
  assign new_n69_ = ~x05 & (x07 ? ~new_n70_ : (x18 & (new_n71_ | new_n72_)));
  assign new_n70_ = (~x01 | x15 | x18 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18);
  ...
  assign z06 = new_n82_ | (~x09 & (new_n100_ | (~new_n92_ & ~x05)));
  assign new_n92_ = (x07 | ((x17 | new_n93_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n93_ = ~new_n62_ & (x15 | (~new_n98_ & (x14 | (~new_n87_ & new_n94_))));
  ...
  assign z07 = x18 & (new_n103_ | x17 | (~x09 & new_n104_ & ~x17));
  assign new_n103_ = new_n66_ & ~x05 & x09 & ~x15 & x16;
  assign new_n104_ = (x05 ^ x15) & (x07 ^ ~x08);
  ...
  assign z12 = new_n82_ | (~x09 & ((~new_n128_ & ~x07) | (new_n135_ & ~x05 & x07)));
  ...
  assign new_n135_ = new_n136_ & ~x15;
  assign new_n136_ = x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = ~new_n143_ | (~x17 & ((~new_n139_ & ~x07) | (~x05 & new_n147_ & x07)));
  ...
  assign new_n143_ = (new_n146_ | ~x18) & (x05 | (~new_n145_ & (x09 | new_n144_ | x18)));
  assign new_n144_ = (x01 | ~x07) & (~x17 | (~x07 & (x07 | ~x15)));
  assign new_n145_ = x15 & x18 & ~x19 & x07 & x08;
  assign new_n146_ = ~x17 & (~x05 | ~x07 | ~x08 | x15 | x19);
  assign new_n147_ = ~x09 & x15 & ~x18 & (~x02 | ~x11 | (x02 & x11));
  ...
  assign new_n152_ = (~x06 | (~new_n153_ & (~x12 | new_n154_ | x16))) & ~new_n95_ & (x06 | ~x12 | new_n154_ | ~x16);
  assign new_n153_ = x02 & ((x04 & ~x12) | (~x10 & x13));
  assign new_n154_ = x13 & (x02 | ~x11);
  assign new_n155_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = new_n82_ | (~x09 & (new_n160_ | (~new_n157_ & ~x05)));
  assign new_n157_ = (~new_n136_ | ~x07 | x15) & (x07 | ((x08 | ~new_n158_ | x15) & (~new_n136_ | ~x00 | ~x15)));
  assign new_n158_ = ~x17 & x18 & ~new_n60_ & ~new_n159_;
  assign new_n159_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n160_ = new_n65_ & new_n101_ & ~x11 & x15;
  ...
  assign z20 = ~x07 & ~x17 & (new_n168_ | new_n174_);
  assign new_n168_ = ~x09 & (new_n169_ | (new_n141_ & x04 & ~x05 & x12));
  assign new_n169_ = x18 & (new_n172_ | (~x21 & (x04 ? new_n170_ : ~new_n133_)));
  ...
  assign new_n179_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign new_n202_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
