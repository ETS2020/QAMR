...
module FAU ( 
  ...
  assign new_n72_ = ~x02 & ((x06 & ~x08) | (x08 & x11 & x15 & ~x21));
  assign new_n73_ = ~x08 & (x06 ? (~x11 | x15) : (~x04 | ~x12 | x15));
  assign new_n74_ = x18 & (new_n75_ | (new_n66_ & x15 & x21));
  assign new_n75_ = x05 & ((~x07 & (x08 ? ~new_n76_ : ~x15)) | (x07 & x08 & ~x15 & x19));
  assign new_n76_ = ~x21 & (~x15 | x21 | x04 | x11);
  ...
  assign new_n81_ = new_n66_ & ~x05 & x09 & ~x15 & ~x17 & x18;
  ...
  assign z06 = new_n85_ | (~x09 & (new_n106_ | (~new_n95_ & ~x05)));
  assign new_n95_ = ~new_n105_ & (x07 | (~new_n104_ & (x17 | new_n96_ | ~x18)));
  ...
  assign new_n104_ = x00 & ~x13 & x15 & x17 & ~x18;
  assign new_n105_ = x07 & ~x13 & ~x15 & x17 & ~x18;
  ...
  assign z09 = new_n125_ | (~new_n112_ & ~x17);
  assign new_n112_ = (x07 | (~new_n119_ & (new_n113_ | ~x08))) & (~x05 | ~new_n124_ | ~x08);
  assign new_n113_ = ~new_n116_ & (~x18 | ((new_n114_ | x09) & (new_n118_ | (~x09 & x21))));
  assign new_n114_ = (~x05 | ~x21) & (~new_n115_ | ~x02 | x05 | x06 | x10);
  assign new_n115_ = ~x15 & ~x21 & x13 & ~x14;
  assign new_n116_ = x02 & ~x09 & x13 & ~x14 & new_n117_ & ~x15;
  assign new_n117_ = ~x21 & ((x04 & ~x12) | (~x05 & (x10 ? x12 : x06)));
  assign new_n118_ = (x11 | ~x15 | ~x02 | x05) & (~x12 | x15 | x04 | ~x05);
  assign new_n119_ = ~x09 & ~x15 & ((new_n123_ & x05 & ~x08) | (new_n120_ & ~x05));
  assign new_n120_ = ~x21 & (new_n122_ | (~new_n121_ & x04));
  assign new_n121_ = (x12 | ~x18 | x06 | x08) & (x14 | x18 | ~x12 | x13);
  assign new_n122_ = ~x02 & x06 & ~x08 & x11 & x18;
  assign new_n123_ = x18 & ~x19;
  assign new_n124_ = ~x15 & x18 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  assign new_n125_ = ~x18 & (x13 | (~x07 & ~x09 & ~x13 & ~x15 & x17));
  assign z10 = ~new_n131_ | (~x09 & (x07 ? ~new_n129_ : ~new_n127_));
  assign new_n127_ = x05 ? ((x13 | ~x17 | x18) & (~new_n128_ | x15 | x17 | ~x18)) : ((x13 | ~x17 | x18) & (~new_n128_ | ~x15 | x17 | ~x18));
  assign new_n128_ = ~x06 & ~x08;
  assign new_n129_ = (x05 | x13 | ~x17 | x18) & (~new_n130_ | ~x05 | x17 | ~x18 | ~x19);
  assign new_n130_ = x08 & ~x15;
  assign new_n131_ = (~x13 | x18) & (~x08 | x15 | x17 | new_n132_ | ~x18);
  assign new_n132_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign z11 = ~x18 & new_n134_ & ~x17;
  assign new_n134_ = ~x15 & ~x13 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n85_ | (~new_n136_ & ~x09);
  assign new_n136_ = ~new_n144_ & (x07 | (~new_n143_ & (x17 | ~new_n137_ | ~x18)));
  assign new_n137_ = ~x21 & ((~new_n141_ & ~x04) | (~new_n138_ & ~x05) | (new_n142_ & x04 & x05));
  ...
  assign new_n143_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x13;
  assign new_n144_ = ~x15 & x17 & ~x18 & ~x05 & x07 & ~x13;
  assign z13 = ~x09 & ~x13 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n147_ & ~x17) | (~x18 & (x13 | (new_n153_ & ~x05)));
  ...
  assign new_n151_ = (x13 | (~new_n152_ & (~x02 | ~x07 | ~x11 | ~x15))) & (~x07 | ~x15 | (x02 & x11));
  assign new_n152_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n153_ = ~x09 & ((~x01 & x07) | (~x13 & x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n155_ & ~x18;
  assign new_n155_ = x17 & ~x15 & ~x13 & ~x09 & x05 & ~x07;
  assign z16 = new_n85_ | (x08 & ~x17 & (x05 ? new_n163_ : ~new_n157_));
  assign new_n157_ = (x07 | new_n158_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n158_ = x09 ? ~new_n123_ : (x14 | new_n159_ | x21);
  assign new_n159_ = (~x06 | (~new_n160_ & ~new_n161_)) & (~x18 | (~new_n99_ & (~new_n162_ | x06)));
  assign new_n160_ = x02 & ((~x10 & x13) | (x04 & ~x12 & x18));
  assign new_n161_ = x12 & ~x16 & x18 & (~x13 | (~x02 & x11));
  assign new_n162_ = x12 & x16 & (~x13 | (~x02 & x11));
  assign new_n163_ = x09 & ~x15 & x18 & (x07 | ~x12);
  assign z17 = new_n85_ | (~x09 & (new_n165_ | new_n168_));
  assign new_n165_ = ~x05 & (new_n105_ | (~x07 & (new_n104_ | (new_n166_ & ~x08))));
  assign new_n166_ = ~x15 & ~x17 & x18 & ~new_n61_ & ~new_n167_;
  assign new_n167_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n168_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n170_ & x18;
  assign new_n170_ = (x14 | x15 | (~new_n88_ & ~new_n171_)) & (x08 | ~x15 | ~x19);
  ...
  assign z27 = new_n207_ | (~x09 & (new_n203_ | (new_n209_ & ~x05)));
  assign new_n203_ = ~x17 & ~new_n204_ & x18;
  assign new_n204_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n205_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n205_ = ~x21 & (new_n206_ | (~new_n141_ & ~x04));
  assign new_n206_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n207_ = new_n208_ & new_n66_ & x03 & ~x05;
  assign new_n208_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign new_n209_ = ~x13 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n211_ & ~x17) | (~x18 & (x13 | (~x09 & ~new_n221_ & x17)));
  ...
  assign new_n215_ = x12 & ~x14 & ~x15 & ~x21 & (x11 | ~x13);
  assign new_n216_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n103_ & x21));
  assign new_n217_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n218_ = (~new_n219_ | ~x07) & (~new_n220_ | ~x02 | x07 | ~x08 | ~x10);
  assign new_n219_ = x15 & ~x18 & (~x02 | ~x11);
  assign new_n220_ = x12 & x13 & ~x14 & ~x15 & ~x21;
