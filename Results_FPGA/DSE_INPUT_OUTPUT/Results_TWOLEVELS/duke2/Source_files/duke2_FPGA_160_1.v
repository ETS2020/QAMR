...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n67_, new_n70_,
    new_n72_, new_n74_, new_n75_, new_n79_, new_n81_, new_n82_, new_n85_;
  ...
  assign z14 = ~x05 & ~x09 & ~x18 & (~new_n75_ | (~new_n74_ & ~x15));
  assign new_n74_ = (~x07 | ~x17) & (x14 | x17 | x21 | ~x04 | x07 | ~x12);
  assign new_n75_ = (~x15 | (~x17 & (~x07 | x17 | (x02 & x11 & (~x02 | ~x11))))) & (x01 | ~x07);
  ...
  assign z28 = (~x17 & x18) | (~x09 & ~x18 & (x05 ? (~x07 & x17) : new_n85_));
