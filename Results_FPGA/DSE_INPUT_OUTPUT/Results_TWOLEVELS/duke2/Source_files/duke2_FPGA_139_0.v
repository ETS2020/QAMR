...
module FAU ( 
  ...
  assign z03 = z23 | (~x09 & (x07 ? ~new_n82_ : ~new_n81_));
  assign z23 = (~x18 & ~x19) | (new_n80_ & ~x17 & x18 & new_n65_ & ~x05);
  assign new_n80_ = x09 & ~x15;
  assign new_n81_ = x05 ? ((x08 | x15 | x17 | ~x18) & (~x17 | x18 | ~x19)) : (~x17 | x18 | ~x19);
  assign new_n82_ = (x05 | ~x17 | x18 | ~x19) & (~x08 | x17 | (x05 ? (x15 | (x19 & (~x18 | ~x19))) : (~x15 | ~x18)));
  assign z04 = (~x14 & ~x20) | (~x18 & ~x19);
  assign z05 = new_n85_ | (~x18 & ~x19);
  ...
  assign z07 = (~x18 & ~x19) | (~x17 & (new_n108_ | (~new_n109_ & ~x09)));
  assign new_n108_ = new_n65_ & ~x05 & new_n80_ & x16 & x18;
  assign new_n109_ = (~x18 | (x07 ? (~x08 | (x05 ? (x15 | ~x19) : ~x15)) : (x08 | (~x05 ^ x15)))) & (~x05 | ~x07 | ~x08 | x15 | x19);
  ...
  assign z11 = ~x18 & (~x19 | (new_n134_ & ~x09 & ~x15 & ~x17));
  ...
  assign new_n146_ = (new_n147_ | ~x08) & (x05 | x09 | ~new_n150_ | x18);
  assign new_n147_ = (~x18 | ((~new_n148_ | x07) & (~x05 | ~x07 | x15 | x19))) & (x05 | ~x07 | ~x15 | x19);
  assign new_n148_ = ~new_n149_ & (x09 | (~x09 & ~x21));
  ...
  assign z17 = (~x18 & ~x19) | (~x09 & (new_n166_ | (~new_n163_ & ~x05)));
  ...
  assign z22 = (~x18 & ~x19) | (~x17 & ~new_n188_ & x18);
  assign new_n188_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z24 = (~x09 & ~new_n190_ & ~x17) | (~x18 & ~x19);
  assign new_n190_ = ~new_n191_ & (~new_n134_ | x18 | ~x19 | ~x08 | x15);
  ...
  assign z25 = (~x18 & ~x19) | (~x05 & ~x07 & ~x17 & ~new_n196_ & x18);
  ...
  assign new_n205_ = x17 & ~x18 & x19 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n207_ & ~x17) | (~x07 & ~x09 & new_n215_ & x17);
  ...
  assign new_n214_ = ~x09 & x15 & ~x18 & x19 & (~x02 | ~x11);
  assign new_n215_ = ~x18 & x19 & (x05 | (~x05 & x15));
endmodule
