...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n71_, new_n73_, new_n74_, new_n79_, new_n81_, new_n82_, new_n85_;
  ...
  assign z24 = ~x05 & ~x09 & ~x15 & ~x17 & ~new_n81_ & ~x18;
  assign new_n81_ = (~x01 | ~x07 | ~x08) & (~new_n82_ | ~x04 | x07);
  assign new_n82_ = x12 & ~x14 & ~x21;
