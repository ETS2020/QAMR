...
module FAU ( 
  ...
  assign new_n122_ = new_n123_ & x01 & x04 & ~x05 & ~x07 & ~x09;
  assign new_n123_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n124_ = x01 & ~x07 & ~x09 & ~x15 & x17 & ~x18;
  ...
  assign z12 = new_n68_ | (~x09 & (x05 ? new_n139_ : ~new_n135_));
  ...
  assign new_n139_ = ~x07 & x08 & new_n140_ & ~x17;
  ...
  assign new_n152_ = x17 & ~x15 & ~x09 & ~x07 & x01 & x05;
  assign z16 = (~x01 & ~x18) | (x08 & ~x17 & x18 & (new_n154_ | new_n159_));
  ...
  assign new_n161_ = ~new_n162_ & (x05 | (~new_n105_ & (x07 | ~new_n163_ | x08)));
  ...
  assign new_n171_ = x17 & ~x15 & ~x09 & ~x07 & x01 & ~x05;
  assign z20 = ~x07 & ~x17 & (new_n181_ | (~new_n173_ & ~x09));
  assign new_n173_ = ~new_n178_ & (~x18 | (~new_n174_ & (x05 | ~new_n180_ | x06)));
  assign new_n174_ = ~x21 & (x04 ? (new_n175_ & ~x12) : ~new_n177_);
  ...
  assign new_n178_ = new_n179_ & x01 & x04 & ~x05 & x12;
  ...
  assign z22 = (~x01 & ~x18) | (~x17 & x18 & (new_n185_ | new_n186_));
  assign new_n185_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  ...
  assign new_n190_ = x05 ? (x07 | ~new_n140_ | ~x08) : (~new_n191_ & ~new_n193_);
  assign new_n191_ = ~x15 & ((x01 & ~x18 & (new_n192_ | (x07 & x08))) | (~x07 & ~x08 & x18));
  assign new_n192_ = x04 & ~x07 & x12 & ~x14 & ~x21;
  assign new_n193_ = new_n66_ & ~x02 & x11 & x15 & x18 & ~x21;
  assign z25 = (~x01 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n195_ & x18);
  assign new_n195_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = ~x20 & ~new_n68_ & (x14 | x21);
  assign z27 = (~new_n198_ & ~x09) | new_n201_ | new_n68_;
  assign new_n198_ = x05 ? (x17 | new_n200_ | ~x18) : (~new_n105_ & (x17 | new_n199_ | ~x18));
  assign new_n199_ = (x07 | x08 | x15 | new_n164_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n200_ = (~x07 | ~x08 | x15 | ~x19) & (x07 | ((x08 | x15 | ~x19) & (~new_n74_ | x04 | ~x08)));
  assign new_n201_ = new_n202_ & new_n66_ & x03 & ~x05;
  assign new_n202_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n211_ & ~x18) | (~x17 & ((~new_n204_ & x18) | (new_n213_ & ~x05)));
  assign new_n204_ = (~x08 | ((new_n205_ | x05) & (new_n210_ | x07))) & (x05 | x07 | ~new_n209_ | x08);
  assign new_n205_ = ~new_n206_ & (new_n208_ | ~x15);
  ...
  assign new_n209_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n101_ & x21));
  assign new_n210_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n211_ = x01 & (~new_n212_ | x09);
  assign new_n212_ = x17 & ((x01 & ~x07 & (x05 | (~x05 & x15))) | (~x05 & x15 & ~x19));
