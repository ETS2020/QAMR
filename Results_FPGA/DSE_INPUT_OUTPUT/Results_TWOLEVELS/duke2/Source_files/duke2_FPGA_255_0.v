...
module FAU ( 
  ...
  assign new_n54_ = x17 & (x05 ? (~x15 | (~x07 & x21)) : (x07 ? x15 : (x21 & (~x15 | (~x00 & x15)))));
  ...
  assign new_n67_ = (x05 | (x07 ? new_n68_ : (new_n74_ | ~x18))) & (new_n70_ | ~x18);
  assign new_n68_ = (~x01 | x15 | ~new_n69_ | x18) & (~x08 | ~x15 | ~x18 | ~x19);
  assign new_n69_ = x21 & (x08 | x16);
  ...
  assign z03 = new_n79_ | new_n65_ | (~x09 & (x07 ? ~new_n81_ : ~new_n82_));
  assign new_n79_ = new_n80_ & ~x05 & ~x07 & x08;
  assign new_n80_ = x09 & ~x15 & ~x17 & x18;
  assign new_n81_ = (~x08 | x17 | ~x18 | (x05 ^ ~x15)) & (x05 | ~x17 | x18 | (~x15 & (x15 | ~x21)));
  assign new_n82_ = x05 ? ((x08 | x15 | x17 | ~x18) & (~x17 | x18 | ~x21)) : (~x17 | x18 | ~x21);
  ...
  assign new_n93_ = ~new_n100_ & (x17 | ~x18 | (~new_n60_ & (new_n94_ | x15)));
  ...
  assign z07 = (~x18 & ~x21) | (~x17 & ~new_n106_ & x18);
  assign new_n106_ = (x09 | (~x05 ^ x15) | (~x07 ^ ~x08)) & (~x09 | x15 | ~x16 | x05 | x07 | ~x08);
  assign z08 = x14 & ~new_n65_ & ~x20;
  assign z09 = (~x17 & x18 & (new_n109_ | (new_n118_ & ~x07))) | (new_n120_ & ~x07);
  ...
  assign new_n120_ = ~x09 & new_n101_ & ~x15;
  assign z10 = ~new_n126_ | (~x09 & (x07 ? ~new_n124_ : ~new_n122_));
  assign new_n122_ = x05 ? ((~x17 | x18 | ~x21) & (~new_n123_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | ~x21) & (~new_n123_ | x17 | ~x18))) & (x18 | ~x21 | x15 | ~x17));
  assign new_n123_ = ~x06 & ~x08;
  assign new_n124_ = ~new_n125_ & (x05 | ~x17 | x18 | (~x15 & (x15 | ~x21)));
  assign new_n125_ = x05 & x08 & ~x15 & ~x17 & x18 & x19;
  assign new_n126_ = (x18 | x21) & (~x08 | x15 | x17 | new_n127_ | ~x18);
  assign new_n127_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign z11 = ~x18 & (new_n129_ | ~x21);
  assign new_n129_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = new_n65_ | (~x09 & (new_n131_ | (new_n101_ & new_n139_)));
  assign new_n131_ = ~x07 & ((~x17 & x18 & ~new_n132_ & ~x21) | (new_n138_ & x17 & ~x18 & x21));
  assign new_n132_ = (new_n136_ | x04) & (~new_n137_ | ~x04 | ~x05) & (new_n133_ | x05);
  ...
  assign z13 = ~new_n141_ & ~x18;
  assign new_n141_ = x21 & (x09 | ~x17 | (x05 ? (x07 | ~x21) : (x07 ? (~x15 & (x15 | ~x21)) : ~x21)));
  assign z14 = (~new_n143_ & ~x17) | (~x18 & (~x21 | (new_n148_ & ~x05)));
  assign new_n143_ = (~new_n144_ | ~x08) & (x05 | ~new_n147_ | ~x07);
  ...
  assign new_n147_ = ~x09 & x15 & ~x18 & ((x02 & x11) | (x21 & (~x02 | ~x11)));
  assign new_n148_ = ~x09 & ((~x01 & x07) | (x17 & (x07 ? (x15 | (~x15 & x21)) : (x15 & x21))));
  assign z15 = new_n150_ & x21;
  assign new_n150_ = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  ...
  assign new_n162_ = new_n63_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n169_ = x21 & (x05 | x07 | x09 | x15 | ~x17 | ~x21);
  ...
  assign z24 = new_n65_ | (~x09 & ~x17 & (new_n187_ | (new_n185_ & ~x07)));
  ...
  assign new_n188_ = x08 & ~x15 & ~x18 & x21;
  ...
  assign new_n207_ = x07 & ~x09 & x15 & new_n208_ & ~x18;
  assign new_n208_ = x21 & (~x02 | ~x11);
