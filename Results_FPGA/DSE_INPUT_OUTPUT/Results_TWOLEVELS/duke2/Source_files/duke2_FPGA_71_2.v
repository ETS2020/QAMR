...
module FAU ( 
  ...
  assign new_n70_ = (x07 | (new_n73_ & (new_n71_ | x04))) & (~new_n74_ | ~x05 | ~x07);
  assign new_n71_ = (x06 | x15) & (~new_n72_ | x11 | ~x15 | x21);
  ...
  assign new_n78_ = (x04 | x07 | ~x12 | (~x09 & x21)) & (~x07 | (~x09 & x19)) & (~x09 | x12);
  assign new_n79_ = (~x07 | (~x09 & x19)) & x11 & (x02 | ~x09);
  assign new_n80_ = ~x21 & (x17 | (new_n72_ & ~x12 & ~x15 & x18));
  ...
  assign z07 = x17 ? ~x21 : (~new_n108_ & x18);
  assign new_n108_ = (x09 | (~x05 ^ x15) | (x07 ^ x08)) & (~x09 | x15 | ~x16 | x05 | x07 | ~x08);
  assign z08 = x14 & ~x20 & (~x17 | x21);
  assign z09 = ~new_n122_ | (~x15 & (new_n125_ | (~new_n111_ & x18)));
  assign new_n111_ = ~new_n119_ & (x07 | ((~new_n121_ | x04) & (new_n112_ | x09)));
  assign new_n112_ = ~new_n118_ & (x21 | (~new_n115_ & (~x04 | new_n113_ | x12)));
  assign new_n113_ = (~x13 | x14 | ~x02 | ~x08) & (~new_n114_ | x08 | x17);
  assign new_n114_ = ~x05 & ~x06;
  assign new_n115_ = ~x05 & ~x17 & ((new_n117_ & x02) | (~new_n116_ & x06));
  ...
  assign new_n120_ = (x12 | x21) & (x17 | ((~x09 | (~x07 & x12)) & (~x07 | (x19 & (x09 | ~x19)))));
  assign new_n121_ = x05 & x08 & x12 & ~x17 & (x09 | ~x21);
  assign new_n122_ = (~x17 | x21) & (x07 | ~x08 | new_n123_ | ~x18);
  assign new_n123_ = (~x05 | x09 | x17 | ~x21) & (~x02 | ~new_n124_ | x05);
  assign new_n124_ = ~x11 & x15 & (~x21 | (x09 & ~x17));
  assign new_n125_ = ~x07 & ~x09 & ~new_n126_ & ~x18;
  assign new_n126_ = x05 ? ~x17 : ((~x17 | ~x21) & (~x04 | ~x12 | x14 | x17 | x21));
  assign z10 = new_n128_ | (x08 & new_n132_ & ~x15);
  assign new_n128_ = ~x09 & (x07 ? (new_n131_ | (new_n103_ & ~x05)) : ~new_n129_);
  assign new_n129_ = x05 ? ((~x17 | x18 | ~x21) & (~new_n130_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | ~x21) & (~new_n130_ | x17 | ~x18))) & (x15 | ~x17 | x18 | ~x21));
  assign new_n130_ = ~x06 & ~x08;
  assign new_n131_ = x05 & x08 & ~x15 & ~x17 & x18 & x19;
  assign new_n132_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = (x17 & ~x21) | (new_n134_ & ~x09 & ~x15 & ~x17 & ~x18);
  assign new_n134_ = x01 & ~x05 & x07;
  assign z12 = (x17 & ~x21) | (~x09 & (new_n136_ | (new_n144_ & x17 & ~x18 & x21)));
  assign new_n136_ = ~x07 & ((new_n143_ & x17 & ~x18 & x21) | (~x17 & x18 & ~new_n137_ & ~x21));
  ...
  assign z14 = (~new_n147_ & ~x17) | (x17 & ~x21) | (~x05 & new_n153_ & ~x09);
  ...
  assign new_n153_ = ~x18 & ((~x01 & x07) | (x17 & x21 & (x07 | (~x07 & x15))));
  assign z15 = x17 & (~x21 | (new_n155_ & ~x09 & x05 & ~x07));
  ...
  assign z19 = ~new_n174_ & x17;
  assign new_n174_ = x21 & (x05 | x07 | x09 | x15 | x18 | ~x21);
  assign z20 = (x17 & ~x21) | (~x07 & ~x17 & (new_n183_ | (~new_n176_ & ~x09)));
  ...
  assign new_n183_ = new_n72_ & x04 & x09 & ~x12 & ~x15 & x18;
  ...
  assign z22 = x17 ? ~x21 : (x18 & (new_n187_ | new_n188_));
  assign new_n187_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x06 & ~x08 & ~x09 & x15) | (x08 & x09 & ~x15))));
  assign new_n188_ = ~x05 & x07 & x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n190_ & x18;
  assign new_n190_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n192_ | (new_n134_ & new_n155_ & x08));
  ...
  assign z27 = new_n200_ | (new_n205_ & new_n66_ & x03 & ~x05);
