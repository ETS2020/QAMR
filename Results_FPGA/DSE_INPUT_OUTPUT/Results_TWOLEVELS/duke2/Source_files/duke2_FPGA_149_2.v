...
module FAU ( 
  ...
  assign z14 = (~new_n127_ & ~x17) | (~x18 & (new_n133_ | x17));
  ...
  assign new_n131_ = ~new_n132_ & (~x07 | ~x15 | (x02 & x11 & (~x02 | ~x11)));
  assign new_n132_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n133_ = ~x01 & ~x05 & x07 & ~x09;
  ...
  assign z17 = ~x07 & ~x09 & ~x17 & ~new_n142_ & x18;
  ...
  assign z24 = (x17 & ~x18) | (~x09 & ~x17 & (new_n166_ | new_n170_));
  ...
  assign z27 = x17 ? ~x18 : (~new_n175_ & x18);
