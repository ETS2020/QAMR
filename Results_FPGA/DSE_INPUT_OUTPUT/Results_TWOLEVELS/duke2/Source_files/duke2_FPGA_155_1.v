...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n86_, new_n87_, new_n90_, new_n91_, new_n92_, new_n93_, new_n95_,
  ...
  assign new_n69_ = ~new_n70_ & (x08 | ~x10 | ~x15) & (~x06 | x11);
  ...
  assign new_n74_ = (~x08 | ~x21 | (~x05 & (~x10 | ~x15))) & (x15 | (~new_n75_ & (~x05 | x08 | ~x10)));
  assign new_n75_ = ~x06 & ~x12;
  assign new_n76_ = x08 & x10 & ~x15;
  assign new_n77_ = (~x01 | x15 | x18 | (~x08 & ~x16)) & (~x15 | ~x18 | ~x08 | ~x10);
  ...
  assign z06 = ~x09 & ((~new_n95_ & ~x05) | (new_n106_ & new_n105_ & x04 & x05));
  assign new_n95_ = (x07 | ((~new_n96_ | ~x10) & (~new_n104_ | ~x00 | ~x15))) & (~new_n104_ | ~x07 | x15);
  ...
  assign z09 = (~new_n111_ & ~x17) | new_n82_ | (~x07 & new_n122_ & ~x09);
  assign new_n111_ = ~new_n119_ & (~x18 | (~new_n121_ & (x07 | (~new_n112_ & ~new_n118_))));
  assign new_n112_ = ~x15 & (new_n115_ | (~x09 & (new_n117_ | (~new_n113_ & ~x21))));
  assign new_n113_ = (x05 | x08 | new_n103_ | ~x10) & (~x02 | ~new_n114_ | ~x08);
  assign new_n114_ = x13 & ~x14 & ((x04 & ~x12) | (~x05 & x10 & x12));
  assign new_n115_ = ~x04 & x05 & x08 & x10 & ~new_n116_ & x12;
  assign new_n116_ = ~x09 & x21;
  assign new_n117_ = x05 & ~x08 & x10 & ~x19;
  assign new_n118_ = x08 & ((new_n116_ & x05) | (x02 & ~x05 & ~x11 & ~new_n116_ & x15));
  assign new_n119_ = new_n120_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n120_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n121_ = x05 & x08 & ~x15 & (~x12 | (x07 & x10));
  assign new_n122_ = new_n104_ & ~x15;
  ...
  assign new_n127_ = (x05 | ~x17 | x18) & (~new_n71_ | ~x05 | x15 | x17 | ~x18);
  assign new_n128_ = x10 & ~x15 & ~x17 & x18 & (~x05 ^ x07);
  assign z11 = new_n130_ & ~x18;
  assign new_n130_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n82_ | (~x09 & ((~new_n132_ & ~x07) | (new_n122_ & ~x05 & x07)));
  ...
  assign new_n141_ = x00 & ~x05 & new_n104_ & x15;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n144_ & ~x17) | new_n82_ | (new_n150_ & ~x05);
  assign new_n144_ = (~x08 | new_n145_ | ~x18) & (x05 | x09 | new_n148_ | x18);
  assign new_n145_ = x07 ? (x19 | (x05 ^ ~x15)) : ~new_n146_;
  assign new_n146_ = x10 & ~new_n147_ & (x09 | (~x09 & ~x21));
  ...
  assign z15 = new_n82_ | (new_n122_ & x05 & ~x07 & ~x09);
  ...
  assign z17 = new_n82_ | (~x09 & (new_n163_ | (~new_n159_ & ~x05)));
  assign new_n159_ = (~new_n104_ | ~x07 | x15) & (x07 | (~new_n160_ & (~new_n104_ | ~x00 | ~x15)));
  ...
  assign new_n163_ = new_n164_ & new_n105_ & ~x04 & x05;
  assign new_n164_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = x18 & (~x10 | (~x05 & ~x07 & ~x09 & new_n166_ & x10));
  ...
  assign z19 = new_n82_ | (new_n122_ & ~x05 & ~x07 & ~x09);
  ...
  assign new_n181_ = x10 & ~x12 & ~x15 & x18;
  assign z21 = x10 & ~x17 & ~new_n183_ & x18;
  ...
  assign new_n186_ = (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | ~x10 | x15))) & (~x05 | ~x06 | x08 | x09 | ~x10 | x15);
  assign z24 = new_n82_ | (~x09 & ~x17 & (new_n192_ | (~new_n188_ & ~x07)));
  ...
  assign z25 = x18 & (~x10 | (~x05 & ~x07 & new_n194_ & x10));
  assign new_n194_ = ~x17 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & ~new_n82_ & (x14 | x21);
  assign z27 = new_n202_ | (~x09 & (new_n204_ | (x10 & new_n197_ & ~x17)));
  assign new_n197_ = x18 & (x07 ? new_n201_ : ~new_n198_);
  assign new_n198_ = ~new_n200_ & (x21 | (~new_n134_ & ~new_n199_));
  ...
  assign new_n203_ = x10 & ~x15 & ~x17 & x18 & x19;
  assign new_n204_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n206_ & ~x17) | (~x09 & new_n214_ & x17);
  assign new_n206_ = (~x10 | new_n207_ | ~x18) & (~new_n213_ | x05);
  assign new_n207_ = (~x08 | ((new_n208_ | x05) & (new_n212_ | x07))) & (x05 | x07 | ~new_n211_ | x08);
  assign new_n208_ = ~new_n209_ & (x07 | x09 | ~new_n210_ | ~x12);
  assign new_n209_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n210_ = ~x14 & ~x15 & ~x21 & (~x13 | x11 | (x02 & x13));
  assign new_n211_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n103_ & x21));
