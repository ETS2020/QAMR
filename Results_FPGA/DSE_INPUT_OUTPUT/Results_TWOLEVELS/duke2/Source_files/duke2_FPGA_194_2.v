...
module FAU ( 
  ...
  assign new_n66_ = (x05 | (x07 ? new_n72_ : (new_n73_ | ~x18))) & (new_n67_ | ~x18);
  ...
  assign new_n90_ = x18 & (new_n97_ | (~x05 & (new_n60_ | (~new_n91_ & ~x15))));
  ...
  assign z09 = ~x17 & (new_n113_ | (x18 & (new_n102_ | (new_n111_ & ~x07))));
  ...
  assign new_n123_ = x08 ? (~new_n93_ | x14) : new_n124_;
  ...
  assign new_n146_ = (x14 | x15 | (~new_n147_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n147_ = x12 & ((~new_n148_ & ~x06) | (new_n149_ & x06 & x08 & x10));
  assign new_n148_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  ...
  assign new_n179_ = x03 & ~x05 & ~x07 & new_n71_ & x08 & x09;
  assign z28 = ~x17 & ((new_n188_ & ~x05) | (~new_n181_ & x18));
  assign new_n181_ = (~x08 | ((new_n182_ | x05) & (new_n187_ | x07))) & (x05 | x07 | ~new_n186_ | x08);
  assign new_n182_ = ~new_n183_ & (new_n185_ | ~x15);
