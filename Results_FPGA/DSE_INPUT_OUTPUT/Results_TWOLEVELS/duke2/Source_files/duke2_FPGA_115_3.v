...
module FAU ( 
  ...
  assign z17 = (~x09 & (new_n157_ | (~new_n154_ & ~x05))) | (x17 & x18);
  assign new_n154_ = (~new_n99_ | ~x07 | x15) & (x07 | ((x08 | ~new_n155_ | x15) & (~new_n99_ | ~x00 | ~x15)));
  ...
  assign new_n172_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n176_ = (new_n177_ | x07) & ~x17 & (x05 | ~x07 | ~x08 | ~x15 | x17);
  assign new_n177_ = (x05 | ((x15 | x17 | ~x08 | ~x09) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15 | x17);
  ...
  assign z28 = (~new_n205_ & ~x09) | (x18 & (~new_n207_ | (~new_n197_ & ~x07)));
  ...
  assign new_n202_ = ~x09 & ~x17 & ((x15 & ~x19) | (~x14 & new_n203_ & ~x15));
  assign new_n203_ = x21 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  assign new_n204_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n205_ = (x05 | new_n206_ | ~x15) & (~new_n99_ | ~x05 | x07);
  assign new_n206_ = (~x17 | x19) & (x18 | (x07 ? (x17 | (x02 & x11)) : ~x17));
  assign new_n207_ = ~x17 & (x05 | ~x08 | ~x15 | x17 | (~x07 & x11));
endmodule
