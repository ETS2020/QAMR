...
module FAU ( 
  ...
  assign new_n58_ = (~new_n64_ | ~x02 | ~x06 | ~x07) & (x07 | new_n59_ | ~x18);
  ...
  assign new_n80_ = new_n66_ & ~x05 & x09 & ~x15 & ~x17 & x18;
  assign new_n81_ = (x05 | ((~x06 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n82_ = x05 ? ((~x06 | ~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (~x06 | ~x17 | x18);
  ...
  assign z06 = ~x09 & (new_n102_ | (~x05 & (new_n104_ | (~new_n93_ & ~x07))));
  ...
  assign new_n101_ = x15 & x17 & ~x18 & x00 & x06;
  assign new_n102_ = new_n66_ & x04 & x05 & new_n103_ & ~x12 & ~x15;
  assign new_n103_ = ~x17 & x18 & ~x21;
  assign new_n104_ = x06 & x07 & ~x15 & x17 & ~x18;
  assign z07 = (~x06 & ~x18) | (~x17 & ~new_n106_ & x18);
  ...
  assign new_n121_ = new_n122_ & x04 & ~x05 & x06 & ~x07 & ~x09;
  assign new_n122_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n123_ = x06 & ~x07 & ~x09 & ~x15 & x17 & ~x18;
  assign z10 = (~new_n125_ & ~x09) | new_n78_ | (x08 & new_n128_ & x09);
  assign new_n125_ = x07 ? new_n127_ : new_n126_;
  assign new_n126_ = x05 ? ((~x06 | ~x17 | x18) & (x15 | x17 | x06 | x08)) : ((~x06 | ~x17 | x18) & (x06 | x08 | ~x15 | x17 | ~x18));
  assign new_n127_ = (~x05 | ~x08 | x15 | x17 | ~x18) & (x05 | ~x06 | ~x17 | x18);
  assign new_n128_ = ~x15 & ~x17 & x18 & (x05 ^ ~x07);
  assign z11 = ~x18 & new_n130_ & ~x17;
  assign new_n130_ = ~x15 & ~x09 & x07 & x06 & x01 & ~x05;
  assign z12 = new_n78_ | (~x09 & (new_n132_ | new_n140_));
  assign new_n132_ = ~x07 & (new_n139_ | (~x17 & x18 & ~new_n133_ & ~x21));
  assign new_n133_ = (new_n137_ | x04) & (~new_n138_ | ~x04 | ~x05) & (new_n134_ | x05);
  ...
  assign new_n139_ = x15 & x17 & ~x18 & x00 & ~x05 & x06;
  assign new_n140_ = ~x15 & x17 & ~x18 & ~x05 & x06 & x07;
  assign z13 = ~x18 & (~x06 | (x06 & ~x09 & x17 & (~x05 | (x05 & ~x07))));
  assign z14 = (~new_n143_ & ~x17) | (~x05 & new_n149_ & x06);
  assign new_n143_ = (~new_n144_ | ~x08) & (x05 | ~x06 | ~new_n147_ | x09);
  ...
  assign new_n151_ = x17 & ~x15 & ~x09 & ~x07 & x05 & x06;
  ...
  assign z17 = new_n78_ | (~x09 & (new_n160_ | new_n163_));
  assign new_n160_ = ~x05 & (new_n104_ | (~x07 & (new_n101_ | (new_n161_ & ~x08))));
  assign new_n161_ = ~x15 & ~x17 & x18 & ~new_n61_ & ~new_n162_;
  assign new_n162_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n163_ = new_n65_ & new_n103_ & ~x11 & x15;
  assign z18 = new_n78_ | (~x05 & ~x07 & ~x09 & new_n165_ & ~x17);
  assign new_n165_ = x18 & ((~x14 & ~new_n166_ & ~x15) | (~x08 & x15 & x19));
  assign new_n166_ = ~new_n86_ & (~x12 | (~new_n168_ & (new_n167_ | x06)));
  assign new_n167_ = (~new_n91_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n168_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~new_n170_ & ~x18;
  assign new_n170_ = x06 & (x09 | x15 | ~x17 | x05 | ~x06 | x07);
  ...
  assign new_n176_ = new_n177_ & x06 & x12 & x04 & ~x05;
  ...
  assign z27 = new_n197_ | new_n78_ | (new_n202_ & new_n66_ & x03 & ~x05);
  assign new_n197_ = ~x09 & ((~x17 & ~new_n198_ & x18) | (new_n201_ & ~x05));
  ...
  assign z28 = (~new_n204_ & ~x17) | (x06 & ~x09 & new_n212_ & x17);
  assign new_n204_ = (new_n205_ | ~x18) & (x05 | ~new_n211_ | ~x06);
  ...
  assign new_n209_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
