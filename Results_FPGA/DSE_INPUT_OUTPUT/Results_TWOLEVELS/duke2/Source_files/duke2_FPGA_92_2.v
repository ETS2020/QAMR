...
module FAU ( 
  ...
  assign new_n67_ = (x07 | (~new_n68_ & new_n70_)) & (~x05 | ~x07 | ~new_n71_ | ~x08);
  ...
  assign new_n90_ = ~new_n98_ & (x05 | (~new_n97_ & (new_n91_ | x15)));
  ...
  assign z10 = x17 ? ~x18 : (x18 & ((~new_n117_ & ~x07) | (x05 & new_n118_ & x07)));
  assign new_n117_ = (~x05 | x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | x06 | x08)));
  ...
  assign new_n122_ = (new_n126_ | x04) & (new_n123_ | x05) & (~new_n127_ | ~x04 | ~x05);
  ...
  assign z14 = ~new_n129_ & ~x17;
  assign new_n129_ = (~x08 | new_n130_ | ~x18) & (x05 | x09 | new_n133_ | x18);
  ...
  assign new_n133_ = ~new_n134_ & (~x07 | (x01 & (~x15 | (x02 & x11 & (~x02 | ~x11)))));
  ...
  assign new_n143_ = ~new_n144_ & (~new_n69_ | x04 | x11 | ~x15 | x21);
  assign new_n144_ = ~x05 & ~x08 & ~x15 & ~new_n59_ & ~new_n145_;
  ...
  assign new_n153_ = ~x21 & (x04 ? (new_n154_ & ~x12) : ~new_n126_);
  ...
  assign new_n159_ = new_n69_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign new_n180_ = x03 & ~x05 & ~x07 & new_n71_ & x08 & x09;
  assign z28 = x17 ? ~x18 : ((new_n189_ & ~x05) | (~new_n182_ & x18));
