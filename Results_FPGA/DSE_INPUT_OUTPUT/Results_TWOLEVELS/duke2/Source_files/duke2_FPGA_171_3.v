...
module FAU ( 
  ...
  assign z06 = (~x09 & (new_n100_ | (~new_n92_ & ~x05))) | (x17 & x18);
  ...
  assign new_n108_ = ~x12 & ((~x05 & ~x06 & ~x08) | (new_n109_ & x02 & x08));
  ...
  assign z12 = ~x09 & ((~new_n129_ & ~x07) | (~x05 & x07 & new_n121_ & ~x15));
  ...
  assign new_n140_ = (~new_n141_ | x02) & (~new_n121_ | x09);
  ...
  assign new_n151_ = (~x06 | (~new_n152_ & ~new_n153_)) & (~new_n154_ | x06) & (~new_n95_ | x17);
  assign new_n152_ = x02 & ((x04 & ~x12) | (~x10 & x13 & ~x17));
  assign new_n153_ = x12 & ~x16 & (~x13 | (~x02 & x11));
  assign new_n154_ = x12 & x16 & (~x13 | (~x02 & x11));
  assign new_n155_ = x09 & ~x15 & (~x12 | (x07 & ~x17));
  assign z17 = (~x09 & (new_n160_ | (~new_n157_ & ~x05))) | (x17 & x18);
  assign new_n157_ = (~new_n121_ | ~x07 | x15) & (x07 | ((x08 | ~new_n158_ | x15) & (~new_n121_ | ~x00 | ~x15)));
  ...
  assign new_n186_ = new_n127_ & x08 & ~x15 & ~x18;
  assign z25 = new_n188_ & ~x05;
  assign new_n188_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21) & (~x17 | ~x18);
  assign z27 = (~new_n195_ & x18) | (~x09 & (new_n197_ | (~new_n191_ & x18)));
  assign new_n191_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : ~new_n192_;
  assign new_n192_ = ~x17 & (new_n194_ | (~x21 & (new_n193_ | (~new_n134_ & ~x04))));
  assign new_n193_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n194_ = x05 & ~x08 & ~x15 & x19;
  assign new_n195_ = ~x17 & (~new_n196_ | ~x03 | x05 | x07);
  assign new_n196_ = ~x15 & x19 & x08 & x09;
  assign new_n197_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n208_ & ~x09) | (x18 & ((~new_n199_ & ~x17) | new_n206_ | x17));
  assign new_n199_ = (new_n200_ | x07) & (x05 | ~x08 | ~x15 | (~x07 & x11));
  assign new_n200_ = (~x08 | (new_n205_ & (new_n201_ | x05))) & (x05 | ~new_n204_ | x08);
  assign new_n201_ = (~new_n202_ | x02) & (~new_n203_ | ~x10 | ~x12 | ~x02 | x09);
  assign new_n202_ = x11 & x15 & (x09 | (~x09 & ~x21));
  assign new_n203_ = ~x15 & ~x21 & x13 & ~x14;
  assign new_n204_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
  assign new_n205_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n206_ = ~x05 & ~x07 & x08 & ~x09 & new_n207_ & x10;
  assign new_n207_ = x12 & ~x14 & ~x15 & ~x21 & (x11 | ~x13);
  assign new_n208_ = (x05 | new_n209_ | ~x15) & (~new_n121_ | ~x05 | x07);
