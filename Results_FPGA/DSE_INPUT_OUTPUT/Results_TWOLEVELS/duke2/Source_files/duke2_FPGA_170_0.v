...
module FAU ( 
  ...
  assign new_n64_ = (new_n69_ | ~x08) & (x07 | (~new_n65_ & (~new_n71_ | ~x08)));
  ...
  assign new_n69_ = (~x07 | (~x05 ^ x15)) & (x05 | new_n70_ | ~x15) & (~x05 | x12 | x15);
  assign new_n70_ = x11 & (x02 | ~x09);
  ...
  assign z10 = (~x09 & (x07 ? ~new_n115_ : ~new_n114_)) | (~new_n116_ & ~x17);
  assign new_n114_ = x05 ? ((~x17 | x18) & (x15 | x17 | x06 | x08)) : (x15 ? ((~x17 | x18) & (x17 | ~x18 | x06 | x08)) : (~x17 | x18));
  assign new_n115_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n116_ = x18 & (~x08 | ~x09 | x15 | ~x18 | (~x05 ^ ~x07));
  ...
  assign z14 = x07 ? (new_n132_ | (~x05 & new_n126_ & ~x09)) : ~new_n129_;
  assign new_n129_ = ~new_n130_ & (x05 | x09 | ~new_n126_ | ~x15);
  ...
  assign new_n137_ = (~x06 | (~new_n138_ & (~x12 | new_n139_ | x16))) & ~new_n89_ & (x06 | ~x12 | new_n139_ | ~x16);
  assign new_n138_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n139_ = x13 & (x02 | ~x11);
  assign new_n140_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = (~new_n142_ & ~x09) | (~x17 & ~x18);
  assign new_n142_ = (new_n143_ | x05) & (~new_n146_ | x07 | ~x08 | x04 | ~x05);
  assign new_n143_ = (~new_n126_ | ~x07 | x15) & (x07 | ((x08 | ~new_n144_ | x15) & (~new_n126_ | ~x00 | ~x15)));
  ...
  assign new_n148_ = (x14 | x15 | (~new_n149_ & ~new_n78_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n163_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign z28 = (~x17 & ((~new_n180_ & x18) | new_n186_ | ~x18)) | (~x09 & ~new_n188_ & ~x18);
  assign new_n180_ = (~x08 | ((new_n181_ | x05) & (new_n185_ | x07))) & (x05 | x07 | ~new_n184_ | x08);
  assign new_n181_ = ~new_n182_ & (~new_n183_ | ~x02 | x07 | x09 | ~x10);
  ...
  assign new_n188_ = x05 ? (x07 | ~x17) : (~x15 | (x19 & (x07 | ~x17)));
  assign z11 = 1'b0;
endmodule
