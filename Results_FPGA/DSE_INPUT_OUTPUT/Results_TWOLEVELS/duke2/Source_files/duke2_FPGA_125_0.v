...
module FAU ( 
  ...
  assign new_n76_ = (~x05 ^ ~x15) & (x09 | ~x19 | (~x09 & x19));
  ...
  assign z23 = (~x16 & ~x18) | (new_n66_ & ~x05 & new_n82_ & ~x17 & x18);
  ...
  assign z12 = new_n68_ | (~x09 & (new_n135_ | (new_n104_ & new_n143_)));
  ...
  assign new_n146_ = (~new_n147_ | ~x08) & (x05 | x09 | ~new_n150_ | ~x16);
  ...
  assign new_n152_ = x16 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n154_ & ~x18;
  assign new_n154_ = x16 & (~x05 | x07 | x09 | x15 | ~x16 | ~x17);
  ...
  assign new_n173_ = x17 & x16 & ~x15 & ~x09 & ~x05 & ~x07;
  ...
  assign new_n203_ = x16 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  ...
  assign new_n213_ = ~x18 & (~x16 | (new_n214_ & ~x09));
  assign new_n214_ = x17 & (x05 ? (~x07 & x16) : (x15 & (~x19 | (~x07 & x16))));
