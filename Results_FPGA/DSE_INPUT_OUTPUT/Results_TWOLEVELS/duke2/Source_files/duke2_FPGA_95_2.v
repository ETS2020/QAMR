...
module FAU ( 
  ...
  assign new_n65_ = new_n66_ & new_n67_ & ~x09 & ~x11;
  assign new_n66_ = ~x07 & x08 & ~x04 & x05;
  assign new_n67_ = x15 & x18 & ~x21;
  assign new_n68_ = x06 & ~x18;
  assign z02 = new_n68_ | (~x17 & (new_n78_ | (~new_n70_ & ~x09)));
  assign new_n70_ = (new_n71_ | ~x18) & (x05 | (x07 ? new_n77_ : new_n75_));
  ...
  assign new_n75_ = (x02 | (~x06 & (~new_n67_ | ~x08 | ~x11))) & (~new_n76_ | x08) & (~x06 | x11);
  assign new_n76_ = x15 & x18;
  assign new_n77_ = (~x01 | x15 | x18 | (~x16 & (x06 | ~x08))) & (~x08 | ~x15 | ~x18);
  ...
  assign z03 = (~x09 & (x07 ? ~new_n84_ : ~new_n85_)) | new_n82_ | new_n68_;
  ...
  assign new_n96_ = ~new_n106_ & (x07 | (~new_n105_ & (x17 | new_n97_ | ~x18)));
  ...
  assign new_n106_ = ~x06 & x07 & ~x15 & x17 & ~x18;
  ...
  assign new_n127_ = ~x06 & ~x07 & ~x09 & ~x15 & x17 & ~x18;
  assign z10 = (~x09 & (new_n130_ | (~new_n129_ & ~x06))) | (x08 & new_n131_ & x09);
  ...
  assign new_n133_ = ~x15 & ~x09 & x07 & ~x06 & x01 & ~x05;
  assign z12 = new_n135_ | new_n68_;
  assign new_n135_ = ~x09 & (new_n144_ | (~x07 & (new_n143_ | (new_n136_ & ~x17))));
  assign new_n136_ = x18 & ~x21 & (new_n137_ | new_n142_ | (~new_n139_ & ~x05));
  ...
  assign new_n144_ = ~x15 & x17 & ~x18 & ~x05 & ~x06 & x07;
  ...
  assign new_n155_ = x17 & ~x15 & ~x09 & ~x07 & x05 & ~x06;
  ...
  assign z17 = ~x09 & (new_n166_ | (~x05 & (new_n106_ | (~new_n164_ & ~x07))));
  assign new_n164_ = ~new_n105_ & (x08 | x15 | x17 | ~new_n165_ | ~x18);
  assign new_n165_ = ~new_n61_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n166_ = new_n66_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n168_ & x18;
  assign new_n168_ = (x14 | x15 | (~new_n169_ & ~new_n89_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n176_ = ~x21 & (x04 ? (new_n177_ & ~x12) : ~new_n138_);
  ...
  assign new_n190_ = (new_n191_ | x07) & (~new_n195_ | x15 | x18 | ~x07 | ~x08);
  assign new_n191_ = ~new_n192_ & (x15 | ~x18 | x05 | x08);
  assign new_n192_ = ~x21 & ((x04 & ~new_n193_ & ~x15) | (x08 & new_n194_ & x15));
  assign new_n193_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | x06 | ~x12 | x14 | x18);
  assign new_n194_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n195_ = x01 & ~x05 & ~x06;
  assign z25 = (x06 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n197_ & x18);
  ...
  assign new_n201_ = ~x21 & (new_n137_ | new_n202_);
  assign new_n202_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n203_ = new_n204_ & ~x05;
  assign new_n204_ = ~x06 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n205_ = ~new_n68_ & (~new_n206_ | ~x03 | x05 | x07 | ~x08);
  assign new_n206_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n208_ & ~x17) | (~x06 & ~x09 & new_n216_ & x17);
  assign new_n208_ = (new_n209_ | ~x18) & (x05 | ~new_n215_ | x06);
  ...
  assign new_n211_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (x11 & ~x21 & ~x07 & ~x09))));
  assign new_n212_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n213_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n104_ & x21));
