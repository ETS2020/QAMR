...
module FAU ( 
  ...
  assign new_n169_ = ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign new_n176_ = x20 & (x05 | x07 | x09 | x15 | ~x17 | ~x20);
  ...
  assign z28 = (~new_n213_ & ~x18) | (~x17 & ((~new_n207_ & x18) | (new_n215_ & ~x05)));
  ...
  assign new_n213_ = x20 & (x09 | new_n214_ | ~x17);
  assign new_n214_ = x05 ? (x07 | ~x20) : (~x15 | (x19 & (x07 | ~x20)));
