...
module FAU ( 
  ...
  assign new_n73_ = x05 ? ((x07 | ~x17) & (~x07 | ~x08 | x17 | ~x18)) : (x07 | x18 | (~new_n74_ & ~x17));
  assign new_n74_ = x04 & x12 & ~x14 & ~x17 & ~x21;
  assign new_n75_ = x09 & ~x17 & x18 & x05 & x07 & x08;
  assign z10 = x07 ? ~new_n77_ : (new_n78_ | x18);
  assign new_n77_ = (x15 | ((~x05 | ~x08 | x17 | ~x18) & (~x17 | x18 | x05 | x09))) & (x05 | x09 | ~x15 | ~x17 | x18);
  ...
  assign new_n103_ = x05 & x08 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x05 & ~new_n105_ & x15) | (new_n78_ & x05 & ~x07);
