...
module FAU ( 
  ...
  assign new_n70_ = x18 & ((~x08 & x15) | (x06 & ~x11));
  ...
  assign z03 = ~new_n79_ | (~x09 & (x07 ? ~new_n82_ : ~new_n83_));
  assign new_n79_ = (~x11 | x18) & (~new_n80_ | x05 | ~new_n81_ | x17 | ~x18);
  ...
  assign new_n102_ = new_n80_ & x04 & x05 & new_n103_ & ~x12 & ~x15;
  ...
  assign z09 = new_n121_ | (~x17 & (new_n124_ | (~new_n109_ & x18)));
  ...
  assign new_n121_ = ~x07 & ~x09 & new_n122_ & ~x11;
  ...
  assign z10 = (~new_n127_ & ~x09) | new_n77_ | (x08 & new_n131_ & ~x15);
  assign new_n127_ = x07 ? (~new_n130_ & (x05 | ~new_n123_ | x11)) : new_n128_;
  ...
  assign z11 = ~x18 & (new_n133_ | x11);
  assign new_n133_ = ~x09 & ~x15 & ~x17 & x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n135_ & ~x07) | (new_n122_ & ~x05 & x07 & ~x11));
  ...
  assign new_n149_ = ~x11 & ~new_n150_ & ~x18;
  assign new_n150_ = (x14 | x15 | x21 | ~x04 | x07 | ~x12) & (~x07 | ~x15);
  assign new_n151_ = ~x11 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n153_ & ~x18;
  assign new_n153_ = x17 & ~x15 & ~x11 & ~x09 & x05 & ~x07;
  assign z16 = new_n77_ | (x08 & ~x17 & (x05 ? new_n161_ : ~new_n155_));
  assign new_n155_ = (x07 | new_n156_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n156_ = x09 ? (~x18 | x19) : (x14 | new_n157_ | x21);
  assign new_n157_ = ~new_n160_ & (~x18 | (~new_n97_ & ~new_n159_ & (new_n158_ | ~x06)));
  assign new_n158_ = (~x12 | x13 | x16) & (~x02 | ((~x04 | x12) & (x10 | ~x13)));
  assign new_n159_ = ~x13 & x16 & ~x06 & x12;
  assign new_n160_ = ~x02 & x11 & x12 & (x06 ^ x16);
  assign new_n161_ = x09 & ~x15 & x18 & (x07 | ~x12);
  assign z17 = new_n77_ | (~x09 & (new_n166_ | (~new_n163_ & ~x05)));
  assign new_n163_ = (x07 | (~new_n164_ & (~new_n123_ | ~x15 | ~x00 | x11))) & (~new_n123_ | x15 | ~x07 | x11);
  assign new_n164_ = ~x08 & ~x15 & ~x17 & new_n165_ & x18;
  assign new_n165_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n166_ = new_n103_ & ~x11 & x15 & new_n80_ & ~x04 & x05;
  ...
  assign new_n173_ = ~x11 & (x11 | x15 | ~x17 | x05 | x07 | x09);
  assign z20 = new_n77_ | (~x07 & ~x17 & (new_n182_ | (~new_n175_ & ~x09)));
  ...
  assign new_n182_ = new_n64_ & x04 & ~x15 & x18 & x09 & ~x12;
  assign z21 = (x11 & ~x18) | (~x17 & ~new_n184_ & x18);
  assign new_n184_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = (x11 & ~x18) | (~x17 & x18 & (new_n186_ | new_n187_));
  assign new_n186_ = ~x07 & ((x05 & x06 & ~x08 & ~x09 & ~x15) | (~x05 & ((x08 & x09 & ~x15) | (x06 & ~x08 & ~x09 & x15))));
  assign new_n187_ = ~x05 & x07 & x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n189_ & x18;
  assign new_n189_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = new_n77_ | (~x09 & ~x17 & (new_n191_ | new_n195_));
  ...
  assign new_n203_ = ~new_n77_ & (~new_n204_ | ~new_n80_ | ~x03 | x05);
  assign new_n204_ = new_n81_ & ~x17 & x18 & x19;
  assign new_n205_ = new_n104_ & ~x05;
  ...
  assign new_n208_ = (new_n209_ | ~x15) & (x07 | x09 | ~new_n210_ | ~x10);
  ...
  assign new_n213_ = ~x09 & (new_n214_ | (new_n215_ & new_n80_ & x10 & x11));
  assign new_n214_ = x07 & ~x11 & x15 & ~x18;
