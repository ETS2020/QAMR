...
module FAU ( 
  ...
  assign new_n79_ = x18 & ((x08 & ((~x05 & (x07 ? (~x09 & x15) : (x09 & ~x15))) | (x05 & x07 & ~x09 & ~x15))) | (x05 & ~x07 & ~x08 & ~x09 & ~x15));
  assign z04 = z13 | (~x14 & ~x20);
  assign z13 = x17 & ~x18;
  assign z05 = z13 | (~x05 & ~x07 & ~x09 & new_n83_ & ~x14);
  ...
  assign new_n91_ = x18 & (new_n98_ | (~x05 & (new_n61_ | (~new_n92_ & ~x15))));
  ...
  assign new_n147_ = (x14 | (~new_n84_ & ~new_n148_) | x15) & (x08 | ~x15 | ~x19);
  assign new_n148_ = x12 & ((~new_n150_ & ~x06) | (new_n149_ & x06 & x08 & x10));
  assign new_n149_ = ~x13 & x16 & ~x21;
  assign new_n150_ = (x04 | x08 | ~x21) & (x13 | x16 | x21 | ~x08 | ~x10);
