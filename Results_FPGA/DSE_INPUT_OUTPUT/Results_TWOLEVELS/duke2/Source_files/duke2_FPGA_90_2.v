...
module FAU ( 
  ...
  assign new_n77_ = ~x09 & ~x15 & ~x16 & ~x18;
  ...
  assign z22 = (x16 & ~x18) | (~x17 & (new_n187_ | new_n188_) & x18);
  ...
  assign new_n191_ = ~new_n192_ & (~new_n133_ | ~x08 | x15 | x16 | x18);
  ...
  assign new_n203_ = ~new_n84_ & (~new_n204_ | ~new_n65_ | ~x03 | x05);
  assign new_n204_ = new_n80_ & ~x17 & x18 & x19;
  assign new_n205_ = new_n206_ & ~x05;
  assign new_n206_ = ~x16 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = ((new_n208_ | new_n214_) & ~x17) | (~x09 & ~x16 & new_n216_ & x17);
  assign new_n208_ = x18 & ((~new_n209_ & x08) | (~x05 & ~x07 & new_n213_ & ~x08));
  assign new_n209_ = (new_n212_ | x07) & (x05 | ((new_n71_ | ~x15) & (~new_n210_ | x07)));
