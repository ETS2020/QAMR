...
module FAU ( 
  ...
  assign new_n68_ = (x05 | (x15 ? (~new_n75_ | ~x18) : new_n73_)) & (new_n69_ | ~x18);
  ...
  assign new_n106_ = (~x04 | x06 | x12) & (~x11 | x19 | x02 | ~x06);
  ...
  assign z09 = ~new_n127_ | (~x17 & (new_n129_ | (~new_n114_ & x18)));
  assign new_n114_ = ~new_n126_ & (x07 | ((new_n115_ | x15) & (new_n125_ | ~x08)));
  assign new_n115_ = ~new_n122_ & (x09 | (~new_n124_ & (x21 | (~new_n116_ & ~new_n118_))));
  ...
  assign new_n123_ = x05 & x08 & x12 & ~x19 & (x09 | ~x21);
  ...
  assign new_n138_ = ~new_n148_ & (x17 | ~x18 | new_n139_ | x21);
  ...
  assign new_n148_ = x00 & ~x05 & new_n83_ & x15;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~x17 & (new_n151_ | (~x05 & new_n154_ & ~x09))) | (~x05 & new_n156_ & ~x09);
  assign new_n151_ = x08 & x18 & ~new_n152_ & ~x19;
  assign new_n152_ = x07 ? (x05 ^ ~x15) : (new_n153_ | (~x09 & (x09 | x21)));
  ...
  assign z16 = x08 & ~x17 & x18 & ~x19 & (new_n159_ | new_n165_);
  assign new_n159_ = ~x05 & ((~x07 & ~x15 & (new_n160_ | x09)) | (x09 & x15 & (~x02 | x07)));
  assign new_n160_ = ~x14 & ~x21 & (new_n161_ | new_n164_ | (new_n102_ & ~x09));
  assign new_n161_ = x06 & (new_n163_ | (x12 & ~x16 & (new_n162_ | ~x13)));
  assign new_n162_ = ~x02 & x11;
  assign new_n163_ = x02 & ((x04 & ~x12) | (~x09 & ~x10 & x13));
  assign new_n164_ = ~x06 & x12 & x16 & (new_n162_ | ~x13);
  assign new_n165_ = x05 & x09 & ~x15 & (x07 | ~x12);
  assign z17 = new_n80_ | (~x09 & (new_n170_ | (~new_n167_ & ~x05)));
  assign new_n167_ = (~new_n83_ | ~x07 | x15) & (x07 | ((~new_n83_ | ~x00 | ~x15) & (x08 | ~new_n168_ | x15)));
  assign new_n168_ = ~x17 & x18 & ~new_n61_ & ~new_n169_;
  assign new_n169_ = (x04 | x06 | ~x12) & (x11 | x19 | ~x02 | ~x06);
  assign new_n170_ = new_n171_ & ~x04 & x05 & ~x07 & x08 & ~x11;
  assign new_n171_ = x15 & ~x17 & x18 & ~x19 & ~x21;
  assign z18 = x18 & (x19 | (~x05 & ~x07 & new_n173_ & ~x09));
  assign new_n173_ = ~x14 & ~x15 & ~x17 & (new_n91_ | (~new_n174_ & x12));
  assign new_n174_ = (x06 | (~new_n176_ & (~new_n97_ | ~x08 | ~x10))) & (~new_n175_ | ~x06 | ~x08 | ~x10);
  assign new_n175_ = ~x13 & x16 & ~x21;
  assign new_n176_ = ~x04 & ~x08 & x21;
  assign z19 = new_n80_ | (new_n128_ & ~x05 & ~x07 & ~x09);
  assign z20 = new_n80_ | (~x07 & ~x17 & (new_n185_ | (~new_n179_ & ~x09)));
  assign new_n179_ = (new_n180_ | ~x18) & (~new_n184_ | x14 | x15 | x18 | x21);
  assign new_n180_ = ~new_n183_ & (x21 | (~new_n140_ & (~x04 | ~new_n181_ | x12)));
  assign new_n181_ = ~x15 & (x05 ? (x08 & ~x19) : (x08 ? new_n182_ : ~x06));
  assign new_n182_ = x10 & ~x14 & ~x19 & (~x13 | (~x02 & x11 & x13));
  assign new_n183_ = ~x05 & ~x06 & ~x08 & ~x14 & new_n96_ & ~x15;
  assign new_n184_ = x04 & ~x05 & x12;
  assign new_n185_ = new_n186_ & x08 & x09 & x04 & x05;
  assign new_n186_ = ~x12 & ~x15 & x18 & ~x19;
  assign z21 = x18 & (x19 | (~x17 & (new_n189_ | (~new_n188_ & ~x07))));
  assign new_n188_ = (x05 | ((~x06 | ~x08 | ~x09 | x15) & (x09 | ~x15 | x19 | x06 | x08))) & (~x05 | ~x06 | x08 | x09 | x15 | x19);
  assign new_n189_ = ~x09 & x15 & ~x19 & ~x05 & x07 & x08;
  assign z22 = x18 & (x19 | (~x17 & ~new_n191_ & ~x19));
  assign new_n191_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = ~x19 & new_n193_ & x18;
  assign new_n193_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n199_ | (~new_n195_ & ~x07));
  assign new_n195_ = ~new_n196_ & (x15 | ~x18 | x19 | x05 | x08);
  ...
  assign z27 = new_n80_ | (~x09 & ((~new_n204_ & ~x07) | (new_n128_ & ~x05 & x07)));
  assign new_n204_ = ~new_n148_ & (x17 | ~x18 | new_n205_ | x21);
  assign new_n205_ = ~new_n140_ & (~new_n206_ | ~x02 | x05 | ~x06);
  assign new_n206_ = ~x15 & ~x19 & ~x08 & ~x11;
  assign z28 = (~new_n208_ & ~x17) | (~x09 & new_n220_ & x17);
  assign new_n208_ = ~new_n217_ & (~x18 | x19 | (~new_n219_ & (new_n209_ | x07)));
  assign new_n209_ = (~x08 | (new_n216_ & (new_n210_ | x05))) & (x05 | x08 | new_n214_ | x09);
  ...
  assign new_n214_ = x06 ? (~x15 & (~new_n162_ | x14 | x15 | ~x21)) : (~x15 & (~new_n215_ | x14 | x15 | ~x21));
  ...
  assign new_n219_ = ~x05 & x08 & x15 & (x07 | ~x11);
