...
module FAU ( 
  ...
  assign new_n125_ = ~x20 & (x07 | x09 | x15 | ~x17 | x20);
  assign z10 = (~new_n127_ & ~x09) | new_n78_ | (x08 & new_n131_ & x09);
  assign new_n127_ = x07 ? new_n130_ : new_n128_;
  assign new_n128_ = x05 ? ((~x17 | x18 | x20) & (~new_n129_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | x20) & (~new_n129_ | x17 | ~x18))) & (x15 | ~x17 | x18 | x20));
  assign new_n129_ = ~x06 & ~x08;
  assign new_n130_ = (x05 | ~x17 | x18 | x20) & (~x05 | ~x08 | x15 | x17 | ~x18);
  ...
  assign z14 = (~new_n146_ & ~x17) | (~x18 & ((new_n152_ & ~x05) | x20));
  ...
  assign z16 = new_n78_ | (new_n156_ & x08);
  assign new_n156_ = ~x17 & x18 & (x05 ? new_n163_ : (new_n157_ | new_n162_));
  ...
  assign z17 = new_n78_ | (~x09 & (new_n168_ | (~new_n165_ & ~x05)));
  ...
  assign new_n168_ = new_n169_ & new_n65_ & ~x04 & x05;
  assign new_n169_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = new_n78_ | (~x05 & ~x07 & ~x09 & new_n171_ & ~x17);
  ...
  assign new_n185_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign z27 = new_n200_ | (new_n205_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n204_ = ~x20 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n205_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n215_ & ~x18) | (~x17 & ((~new_n207_ & x18) | (new_n217_ & ~x05)));
  assign new_n207_ = (x07 | ((new_n208_ | ~x08) & (x05 | ~new_n213_ | x08))) & (x05 | ~new_n214_ | ~x08);
  assign new_n208_ = new_n212_ & (x05 | (~new_n209_ & (x09 | ~new_n211_ | ~x10)));
  assign new_n209_ = x11 & (new_n210_ | (~x02 & x15 & (x09 | (~x09 & ~x21))));
  assign new_n210_ = ~x14 & ~x15 & ~x21 & ~x09 & x10 & x12;
  ...
  assign new_n215_ = ~x20 & (x09 | new_n216_ | ~x17);
  assign new_n216_ = x05 ? (x07 | x20) : (~x15 | (x19 & (x07 | x20)));
