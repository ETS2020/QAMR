...
module FAU ( 
  ...
  assign new_n85_ = new_n65_ & ~x05 & ~x17 & x18 & x09 & ~x15;
  assign new_n86_ = (~x08 | x17 | ~x18 | (x05 ^ ~x15)) & (x05 | ~x17 | x18 | x19);
  assign z04 = new_n78_ | (~x14 & ~x20);
  assign z05 = new_n78_ | (~x05 & ~x07 & ~x09 & new_n89_ & ~x14);
  ...
  assign z10 = new_n129_ | new_n78_ | (x08 & new_n136_ & ~x15);
  assign new_n129_ = ~x09 & (~new_n133_ | (~x07 & (x05 ? ~new_n130_ : ~new_n132_)));
  assign new_n130_ = (~new_n131_ | x15 | x17 | ~x18) & (~x17 | x18 | x19);
  assign new_n131_ = ~x06 & ~x08;
  assign new_n132_ = (~x15 | ((~new_n131_ | x17 | ~x18) & (~x00 | ~x17 | x18 | x19))) & (x15 | ~x17 | x18 | x19);
  assign new_n133_ = (~new_n134_ | x05) & (~new_n135_ | ~x05 | ~x07 | ~x08);
  assign new_n134_ = x17 & ~x18 & ~x19 & (x07 | (~x00 & x15));
  assign new_n135_ = ~x15 & ~x17 & x18 & x19;
  assign new_n136_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = ~x18 & (new_n138_ | x19);
  assign new_n138_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = new_n78_ | (~x09 & (new_n140_ | (new_n84_ & new_n148_)));
  assign new_n140_ = ~x07 & (new_n147_ | (~x17 & x18 & ~new_n141_ & ~x21));
  assign new_n141_ = (new_n145_ | x04) & (new_n142_ | x05) & (~new_n146_ | ~x04 | ~x05);
  assign new_n142_ = ~new_n144_ & (x15 | (x08 ? (~new_n100_ | x14) : new_n143_));
  ...
  assign new_n154_ = (~x11 | ~x15 | x02 | x05) & (~x04 | ~x05 | x12 | x15);
  ...
  assign z15 = new_n162_ & ~x19;
  assign new_n162_ = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  ...
  assign new_n166_ = (~x06 | (~new_n167_ & (~x12 | new_n168_ | x16))) & ~new_n100_ & (x06 | ~x12 | new_n168_ | ~x16);
  assign new_n167_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n168_ = x13 & (x02 | ~x11);
  assign new_n169_ = x05 & x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & ((~new_n171_ & ~x05) | (new_n174_ & new_n65_ & ~x04 & x05));
  assign new_n171_ = (~new_n84_ | ~x07 | x15) & (x07 | ((x08 | ~new_n172_ | x15) & (~new_n84_ | ~x00 | ~x15)));
  assign new_n172_ = ~x17 & x18 & ~new_n61_ & ~new_n173_;
  assign new_n173_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n174_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n176_ & x18;
  assign new_n176_ = (x14 | x15 | (~new_n90_ & ~new_n177_)) & (x08 | ~x15 | ~x19);
  ...
  assign z19 = ~x19 & ~x18 & x17 & ~x15 & new_n181_ & ~x09;
  ...
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n181_ & x08;
  assign z24 = new_n78_ | (~x09 & ~x17 & (new_n199_ | new_n203_));
  ...
  assign z27 = new_n208_ | (new_n213_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n213_ = ~x17 & x18 & x19 & x09 & ~x15;
