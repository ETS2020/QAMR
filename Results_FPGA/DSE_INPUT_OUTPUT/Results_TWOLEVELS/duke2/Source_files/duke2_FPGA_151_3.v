...
module FAU ( 
  ...
  assign z03 = (~new_n81_ & ~x09) | (new_n82_ & ~x05 & new_n80_ & x09 & ~x15);
  ...
  assign z06 = (x17 & x18) | (~x09 & (new_n101_ | (~new_n93_ & ~x05)));
  assign new_n93_ = (x07 | ((x17 | new_n94_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n94_ = ~new_n65_ & (x15 | (~new_n99_ & (x14 | (~new_n88_ & new_n95_))));
  ...
  assign new_n101_ = new_n102_ & ~x12 & ~x15 & new_n82_ & x04 & x05;
  assign new_n102_ = ~x17 & x18 & ~x21;
  assign z07 = x18 & (new_n104_ | x17 | (~x09 & new_n105_ & ~x17));
  assign new_n104_ = new_n82_ & ~x05 & x09 & ~x15 & x16;
  assign new_n105_ = (x05 ^ x15) & (~x07 ^ x08);
  ...
  assign new_n137_ = (~x05 | ~x08 | x11 | ~x15) & (x08 | ~x12 | x15 | x05 | x06);
  assign new_n138_ = x08 & ~x12 & ~x15;
  assign z13 = x17 & (x18 | (~x09 & ~x18 & (~x05 | (x05 & ~x07))));
  assign z14 = (~new_n141_ & ~x07) | (~new_n145_ & x07) | (x17 & x18);
  assign new_n141_ = (~x08 | ~new_n142_ | ~x18) & (x05 | x09 | new_n144_ | x18);
  assign new_n142_ = ~new_n143_ & (x09 | (~x09 & ~x17 & ~x21));
  assign new_n143_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n144_ = (~x15 | ~x17) & (~x04 | ~x12 | x14 | x15 | x17 | x21);
  assign new_n145_ = (new_n146_ | x17) & (x05 | x09 | x18 | (x01 & ~x17));
  assign new_n146_ = (~new_n147_ | x05) & (~x08 | ~x18 | x19 | (x05 ^ ~x15));
  ...
  assign z17 = ~x09 & ((~new_n157_ & ~x05) | (new_n160_ & new_n82_ & ~x04 & x05));
  ...
  assign new_n160_ = new_n102_ & ~x11 & x15;
  ...
  assign new_n164_ = (~new_n91_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n165_ = ~x13 & x16 & ~x21;
  assign z19 = x17 & (x18 | (~x05 & ~x07 & ~x09 & ~x15 & ~x18));
  assign z20 = (x17 & x18) | (~x07 & (new_n175_ | (~x09 & ~new_n168_ & ~x17)));
  ...
  assign z22 = x18 & ((~new_n180_ & ~x07) | x17 | (~x05 & new_n181_ & x07));
  assign new_n180_ = (~x05 | ~x06 | x08 | x09 | x15 | x17) & (x05 | ((x15 | x17 | ~x08 | ~x09) & (~x06 | x08 | x09 | ~x15)));
  assign new_n181_ = x08 & x15 & ~x17 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = x18 & (x17 | (new_n82_ & ~x05 & x09 & ~x15 & ~x17));
  assign z24 = (x17 & x18) | (~new_n184_ & ~x09);
  assign new_n184_ = (new_n185_ | x07) & (~new_n189_ | ~x01 | x05 | ~x07);
  assign new_n185_ = (~new_n186_ | x17) & (x15 | ~x18 | x05 | x08);
  assign new_n186_ = ~x21 & ((x04 & ~new_n187_ & ~x15) | (x08 & new_n188_ & x15));
  assign new_n187_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n188_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n189_ = ~x17 & ~x18 & x08 & ~x15;
  assign z25 = ~new_n191_ & x18;
  assign new_n191_ = ~x17 & (x05 | x07 | x17 | (x08 ? (~x09 | x15) : (x09 | ~x15)));
  assign z26 = ~x20 & (x14 | x21) & (~x17 | ~x18);
  assign z27 = new_n194_ | (new_n199_ & new_n82_ & x03 & ~x05);
