...
module FAU ( 
  ...
  assign z02 = ~x17 & (new_n77_ | (x18 & (new_n74_ | (~new_n69_ & x08))));
  assign new_n69_ = (~x15 | ((new_n72_ | x05) & (~new_n73_ | x07))) & (new_n70_ | ~x05) & (x05 | x07 | x15);
  assign new_n70_ = (new_n71_ | x15) & (x07 | x09 | ~x21);
  assign new_n71_ = (x04 | x07 | ~x12 | (~x09 & x21)) & x12 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n72_ = x11 & (~x07 | (~x09 & x19 & (x09 | ~x19))) & (x02 | (~x09 & (x07 | x09 | ~x11 | x21)));
  assign new_n73_ = ~x09 & (x21 | (~x11 & ~x21 & ~x04 & x05));
  assign new_n74_ = ~x07 & ~x09 & (~new_n75_ | (~x08 & (~x05 ^ ~x15)));
  assign new_n75_ = (x05 | ~x06 | (x02 & x11)) & (~new_n76_ | x06);
  assign new_n76_ = ~x15 & (~x04 | ~x12);
  assign new_n77_ = new_n78_ & new_n65_ & ~x09 & ~x15;
  assign new_n78_ = x07 & x08 & x01 & ~x05;
  assign z03 = z23 | (~x09 & (x07 ? ~new_n82_ : ~new_n83_));
  assign z23 = (x16 & ~x18) | (new_n66_ & ~x05 & new_n81_ & ~x17 & x18);
  ...
  assign z12 = new_n85_ | (~x09 & (new_n136_ | (new_n104_ & new_n144_)));
  ...
  assign new_n170_ = (x14 | (~new_n88_ & ~new_n171_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n175_ = x17 & ~x16 & ~x15 & ~x09 & ~x05 & ~x07;
  ...
  assign new_n209_ = ~new_n210_ & (new_n72_ | ~x15);
  ...
  assign new_n214_ = ~x16 & (~new_n215_ | x09);
  assign new_n215_ = x17 & (x05 ? (~x07 & ~x16) : (x15 & (~x19 | (~x07 & ~x16))));
