...
module FAU ( 
  ...
  assign new_n55_ = x17 & ((x05 & (~x15 | (x00 & ~x07))) | (x00 & ~x05 & (~x07 ^ x15)));
  ...
  assign new_n82_ = new_n67_ & ~x05 & new_n83_ & ~x17 & x18;
  assign new_n83_ = x09 & ~x15;
  assign new_n84_ = (x05 | ((~x00 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n85_ = (~x00 | ~x17 | x18) & (~x05 | x08 | x15 | x17 | ~x18);
  ...
  assign z06 = new_n68_ | (~x09 & (new_n104_ | (~x05 & (new_n96_ | new_n106_))));
  assign new_n96_ = ~x07 & ~x17 & x18 & (new_n103_ | (~new_n97_ & ~x15));
  ...
  assign new_n104_ = new_n67_ & x04 & x05 & new_n105_ & ~x12 & ~x15;
  assign new_n105_ = ~x17 & x18 & ~x21;
  assign new_n106_ = x00 & x17 & ~x18 & (~x07 ^ ~x15);
  ...
  assign z09 = ~new_n123_ | (~x15 & (new_n111_ | (x05 & new_n125_ & x08)));
  assign new_n111_ = ~x07 & ((new_n121_ & ~x04) | (~x09 & (new_n112_ | ~new_n118_)));
  assign new_n112_ = ~x05 & ((x00 & ~x18 & (new_n117_ | x17)) | (~x17 & new_n113_ & x18));
  assign new_n113_ = ~x21 & ((~new_n114_ & x06) | new_n116_ | (new_n115_ & x02));
  assign new_n114_ = (x02 | x08 | ~x11) & (~x02 | ~x08 | x10 | ~x13 | x14);
  assign new_n115_ = x08 & x13 & ~x14 & (x10 ? x12 : ~x06);
  assign new_n116_ = ~x08 & ~x12 & x04 & ~x06;
  assign new_n117_ = ~x14 & ~x17 & ~x21 & x04 & x12;
  assign new_n118_ = ~new_n119_ & (~new_n120_ | ~new_n105_ | ~x13 | x14);
  assign new_n119_ = x05 & ((x17 & ~x18) | (~x08 & ~x17 & x18 & ~x19));
  assign new_n120_ = x08 & ~x12 & x02 & x04;
  assign new_n121_ = new_n122_ & x05;
  assign new_n122_ = x08 & x12 & ~x17 & x18 & (x09 | ~x21);
  assign new_n123_ = (x00 | x18) & (x07 | ~x08 | x17 | new_n124_ | ~x18);
  assign new_n124_ = (~x02 | x05 | x11 | ~x15 | (~x09 & x21)) & (~x05 | x09 | ~x21);
  assign new_n125_ = ~x17 & x18 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  assign z10 = ~new_n131_ | (~x09 & (x07 ? ~new_n129_ : ~new_n127_));
  assign new_n127_ = x05 ? ((~x00 | ~x17 | x18) & (~new_n128_ | x15 | x17 | ~x18)) : ((~x00 | ~x17 | x18) & (~new_n128_ | ~x15 | x17 | ~x18));
  assign new_n128_ = ~x06 & ~x08;
  assign new_n129_ = (~x00 | x05 | ~x17 | x18) & (~new_n130_ | ~x05 | x17 | ~x18 | ~x19);
  ...
  assign new_n134_ = ~x15 & ~x09 & x07 & ~x05 & x00 & x01;
  assign z12 = new_n68_ | (~x09 & (x05 ? new_n140_ : ~new_n136_));
  assign new_n136_ = ~new_n106_ & (x07 | x17 | ~new_n137_ | ~x18);
  assign new_n137_ = ~x21 & ((~new_n138_ & ~x15) | (new_n63_ & x11 & x15));
  assign new_n138_ = x08 ? (~new_n99_ | x14) : new_n139_;
  assign new_n139_ = x06 ? (~x02 ^ x11) : (~x04 ^ x12);
  assign new_n140_ = ~x07 & x08 & new_n141_ & ~x17;
  assign new_n141_ = x18 & ~x21 & (x04 ? (~x12 & ~x15) : (~x11 & x15));
  assign z13 = ~x18 & (~x00 | (x00 & ~x09 & x17 & (~x05 | (x05 & ~x07))));
  ...
  assign new_n152_ = x00 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign new_n161_ = ~new_n162_ & (~new_n66_ | ~new_n105_ | x11 | ~x15);
  assign new_n162_ = ~x05 & (new_n106_ | (~x07 & new_n163_ & ~x08));
  ...
  assign new_n168_ = (~new_n94_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n169_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~new_n171_ & ~x18;
  assign new_n171_ = x00 & (x09 | x15 | ~x17 | ~x00 | x05 | x07);
  assign z20 = new_n68_ | (~x07 & ~x17 & (new_n181_ | (~new_n173_ & ~x09)));
  assign new_n173_ = (new_n174_ | ~x18) & (~new_n180_ | x18 | x21 | x14 | x15);
  ...
  assign new_n180_ = x00 & x04 & ~x05 & x12;
  assign new_n181_ = new_n73_ & x04 & x09 & ~x12 & ~x15 & x18;
  ...
  assign z24 = new_n68_ | (~x09 & (new_n189_ | new_n193_) & ~x17);
  ...
  assign z25 = (~x00 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n195_ & x18);
  assign new_n195_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = ~x20 & ~new_n68_ & (x14 | x21);
  assign z27 = (~new_n198_ & ~x09) | new_n201_ | new_n68_;
  assign new_n198_ = x05 ? (x17 | new_n200_ | ~x18) : (~new_n106_ & (x17 | new_n199_ | ~x18));
  ...
  assign new_n201_ = new_n202_ & new_n67_ & x03 & ~x05;
  assign new_n202_ = new_n83_ & ~x17 & x18 & x19;
  assign z28 = (~new_n204_ & ~x17) | (x00 & ~x09 & new_n214_ & x17);
  assign new_n204_ = ~new_n212_ & (x05 | (~new_n205_ & (~x08 | ~new_n211_ | ~x15)));
  assign new_n205_ = ~x09 & ((new_n206_ & ~x07) | (x15 & (x07 ? ~new_n209_ : new_n210_)));
  ...
  assign new_n210_ = x18 & ((~x08 & ~x19) | (x11 & ~x21 & ~x02 & x08));
  assign new_n211_ = ~new_n80_ & x18;
  assign new_n212_ = ~x07 & x08 & ~new_n213_ & x18;
