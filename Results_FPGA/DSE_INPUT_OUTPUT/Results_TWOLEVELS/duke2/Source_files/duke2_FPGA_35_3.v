...
module FAU ( 
  ...
  assign new_n80_ = (~new_n79_ | ~x07) & x11 & (x02 | ~x09);
  ...
  assign z09 = (x18 & (new_n109_ | x17 | (new_n121_ & ~x07))) | (new_n123_ & ~x07);
  assign new_n109_ = ~x15 & (new_n118_ | (~x07 & (new_n120_ | (~new_n110_ & ~x09))));
  ...
  assign new_n116_ = x13 & ~x14 & ((x10 & x12) | (~x06 & ~x10 & ~x17));
  assign new_n117_ = ~x17 & ~x19 & x05 & ~x08;
  assign new_n118_ = x05 & x08 & (new_n119_ | ~x12);
  assign new_n119_ = x07 & ~x17 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign new_n124_ = x05 ? ~x17 : (~x17 & (~x04 | ~x12 | x14 | x17 | x21));
  ...
  assign z12 = ~x09 & ((~new_n133_ & ~x07) | (new_n102_ & ~x15 & ~x05 & x07));
  ...
  assign z14 = (~new_n142_ & ~x07) | (x17 & x18) | (~new_n149_ & x07);
  ...
  assign new_n147_ = ~x12 & ~x15 & x18 & (x09 | (new_n148_ & ~x09));
  assign new_n148_ = ~x17 & ~x21;
  assign new_n149_ = (new_n150_ | x17) & (x05 | x09 | x18 | (x01 & ~x17));
  ...
  assign new_n156_ = (~x06 | (~new_n157_ & ~new_n158_)) & (~new_n159_ | x06) & (~new_n97_ | x17);
  ...
  assign new_n165_ = new_n65_ & new_n104_ & ~x11 & x15;
  ...
  assign new_n185_ = (x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  assign new_n186_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = x18 & (x17 | (x09 & ~x15 & ~x17 & new_n66_ & ~x05));
  assign z24 = (x17 & x18) | (~x09 & (new_n193_ | (~new_n189_ & ~x07)));
  ...
  assign new_n201_ = ~x21 & (new_n202_ | (~new_n138_ & ~x04));
  assign new_n202_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n203_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n204_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n213_ & ~x09) | (x18 & (~new_n211_ | (~new_n206_ & x08)));
  assign new_n206_ = (new_n210_ | x07) & (x05 | ((~new_n208_ | x07) & (new_n207_ | ~x15)));
  assign new_n207_ = ~new_n119_ & x11 & (x02 | (~x09 & (x07 | x09 | ~new_n148_ | ~x11)));
  ...
  assign new_n211_ = ~x17 & (x05 | x07 | x08 | new_n212_ | x09);
  assign new_n212_ = (~x15 | x19) & (x14 | x15 | x17 | new_n100_ | ~x21);
  assign new_n213_ = (~new_n102_ | ~x05 | x07) & (x05 | new_n214_ | ~x15);
