...
module FAU ( 
  ...
  assign new_n71_ = (~x01 | x15 | x18 | (~x08 & ~x16)) & (~x08 | ~x15 | x17 | ~x18);
  ...
  assign new_n88_ = x18 & (new_n95_ | (~x05 & (new_n60_ | (~new_n89_ & ~x15))));
  ...
  assign new_n95_ = new_n68_ & x04 & ~x12 & ~x15 & ~x21;
  assign z07 = x17 ? ~x18 : (~new_n97_ & x18);
  assign new_n97_ = (x09 | (~x05 ^ x15) | (x07 ^ x08)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = (x17 & ~x18) | (x14 & ~x20);
  assign z09 = x17 ? ~x18 : (new_n112_ | (~new_n100_ & x18));
  assign new_n100_ = ~new_n111_ & (x07 | (~new_n108_ & (x15 | (~new_n101_ & ~new_n110_))));
  ...
  assign new_n105_ = (x02 | x08 | ~x11) & (~x02 | ~x08 | x10 | ~x13 | x14);
  ...
  assign new_n119_ = (new_n123_ | x04) & (new_n120_ | x05) & (~new_n124_ | ~x04 | ~x05);
  assign new_n120_ = (new_n121_ | x15) & (~x11 | ~x15 | x02 | ~x08);
  assign new_n121_ = x08 ? (~new_n91_ | x14) : new_n122_;
  assign new_n122_ = (~x04 | x06 | x12) & (~x06 | (~x02 ^ x11));
  assign new_n123_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  assign new_n124_ = x08 & ~x12 & ~x15;
  assign z14 = (~new_n126_ & ~x17) | (~x18 & (x17 | (new_n132_ & ~x05)));
  assign new_n126_ = (~x08 | new_n127_ | ~x18) & (x05 | x09 | new_n130_ | x18);
  ...
  assign new_n130_ = ~new_n131_ & (~x07 | ~x15 | (x02 & x11));
  assign new_n131_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n132_ = x07 & ~x09 & (~x01 | (x02 & x11 & x15));
  ...
  assign new_n136_ = (~x06 | (~new_n137_ & (~x12 | new_n138_ | x16))) & ~new_n91_ & (x06 | ~x12 | new_n138_ | ~x16);
  assign new_n137_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n138_ = x13 & (x02 | ~x11);
  assign new_n139_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x07 & ~x09 & ~x17 & ~new_n141_ & x18;
  assign new_n141_ = ~new_n142_ & (~new_n68_ | x04 | x11 | ~x15 | x21);
  assign new_n142_ = ~x05 & ~x08 & ~x15 & ~new_n58_ & ~new_n143_;
  assign new_n143_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n145_ & x18;
  assign new_n145_ = (x14 | x15 | (~new_n146_ & ~new_n81_)) & (x08 | ~x15 | ~x19);
  assign new_n146_ = x12 & ((~new_n147_ & ~x06) | (new_n148_ & x06 & x08 & x10));
  assign new_n147_ = (x04 | x08 | ~x21) & (~new_n86_ | ~x08 | ~x10);
  ...
  assign new_n151_ = ~x21 & (x04 ? (new_n152_ & ~x12) : ~new_n123_);
  ...
  assign new_n157_ = new_n68_ & x04 & ~x15 & x18 & x09 & ~x12;
  assign z21 = x17 ? ~x18 : (~new_n159_ & x18);
  assign new_n159_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n161_ & x18;
  assign new_n161_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = (x17 & ~x18) | (new_n163_ & x09 & ~x15 & ~x17 & x18);
  assign new_n163_ = ~x05 & ~x07 & x08;
  assign z24 = (x17 & ~x18) | (~x09 & (new_n169_ | (~x07 & ~new_n165_ & ~x17)));
  assign new_n165_ = ~new_n166_ & (x05 | x08 | x15 | ~x18);
  assign new_n166_ = ~x21 & ((x04 & ~new_n167_ & ~x15) | (x08 & new_n168_ & x15));
  assign new_n167_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x05 | ~x12);
  ...
  assign z27 = x17 ? ~x18 : (~new_n174_ & x18);
  assign new_n174_ = (new_n175_ | x09) & (~new_n178_ | ~x08 | ~x09 | x15 | ~x19);
  assign new_n175_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n176_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n176_ = ~x21 & (new_n177_ | (~new_n123_ & ~x04));
  assign new_n177_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n178_ = x03 & ~x05 & ~x07;
  assign z28 = ~x17 & ((new_n186_ & ~x05) | (~new_n180_ & x18));
  assign new_n180_ = (~x08 | ((new_n185_ | x07) & (new_n181_ | x05))) & (x05 | x07 | ~new_n184_ | x08);
  assign new_n181_ = ~new_n182_ & (x07 | x09 | ~x10 | ~new_n183_ | ~x12);
  assign new_n182_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n183_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n184_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n94_ & x21));
