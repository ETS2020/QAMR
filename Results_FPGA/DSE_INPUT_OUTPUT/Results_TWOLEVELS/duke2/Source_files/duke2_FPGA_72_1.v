...
module FAU ( 
  ...
  assign new_n82_ = (x18 | ~x20) & (~new_n66_ | x05 | ~new_n83_ | x17 | ~x18);
  assign new_n83_ = x09 & ~x15;
  assign new_n84_ = (~x08 | x17 | ~x18 | (x05 ^ ~x15)) & (x05 | ~x17 | x18 | x20);
  assign new_n85_ = x05 ? ((~x17 | x18 | x20) & (x08 | x15 | x17 | ~x18)) : (~x17 | x18 | x20);
  ...
  assign z08 = x14 & ~x20;
  assign z09 = (~new_n127_ & ~x18) | (~x17 & (new_n124_ | (~new_n112_ & x18)));
  ...
  assign new_n127_ = ~x20 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | x20)));
  ...
  assign new_n148_ = ~new_n149_ & (~x07 | ~x15 | ((~x02 | ~x11) & (x20 | (x02 & x11))));
  ...
  assign new_n155_ = ~x20 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign new_n169_ = (x14 | x15 | (~new_n170_ & ~new_n89_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n193_ = ~new_n194_ & (~new_n135_ | x18 | x20 | ~x08 | x15);
  ...
  assign z25 = (~x18 & x20) | (~x05 & ~x07 & ~x17 & ~new_n199_ & x18);
  ...
  assign new_n208_ = x17 & ~x18 & ~x20 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~x17 & (new_n210_ | (new_n217_ & ~x05))) | (~x09 & new_n219_ & x17);
  ...
  assign new_n217_ = x07 & ~x09 & x15 & new_n218_ & ~x18;
  assign new_n218_ = ~x20 & (~x02 | ~x11);
