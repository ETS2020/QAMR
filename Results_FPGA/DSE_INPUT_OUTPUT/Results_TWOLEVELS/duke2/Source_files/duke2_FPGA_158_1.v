...
module FAU ( 
  ...
  assign new_n55_ = x05 ? (x15 & (x07 | x21)) : (x21 | (x07 ? ~x15 : (x15 & (x00 | ~x15))));
  ...
  assign z23 = (new_n82_ & ~x17 & x18 & new_n66_ & ~x05) | (~x18 & x21);
  assign new_n82_ = x09 & ~x15;
  assign new_n83_ = (~x08 | x17 | ~x18 | (x05 ^ ~x15)) & (x05 | ~x17 | x18 | x21);
  assign new_n84_ = x05 ? ((~x17 | x18 | x21) & (x08 | x15 | x17 | ~x18)) : (~x17 | x18 | x21);
  assign z04 = ~x14 & ~x20 & (~x21 | (x18 & x21));
  assign z05 = new_n94_ | (~x05 & ~x07 & ~x09 & new_n87_ & ~x14);
  ...
  assign new_n96_ = ~new_n103_ & (x17 | ~x18 | (~new_n105_ & (new_n97_ | x15)));
  assign new_n97_ = (x14 | (~new_n90_ & new_n98_)) & (x08 | new_n102_ | x21);
  ...
  assign new_n126_ = new_n127_ & new_n65_ & ~x15 & x12 & ~x14;
  assign new_n127_ = ~x07 & ~x09 & x04 & ~x05;
  assign z10 = new_n129_ | new_n94_ | (x08 & new_n133_ & ~x15);
  assign new_n129_ = ~x09 & (x07 ? (new_n132_ | (new_n104_ & ~x05)) : ~new_n130_);
  assign new_n130_ = x05 ? ((~x17 | x18 | x21) & (~new_n131_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | x21) & (~new_n131_ | x17 | ~x18))) & (x18 | x21 | x15 | ~x17));
  assign new_n131_ = ~x06 & ~x08;
  assign new_n132_ = x05 & x08 & ~x15 & ~x17 & x18 & x19;
  assign new_n133_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = ~x21 & new_n135_ & ~x18;
  assign new_n135_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = (~x18 & x21) | (~x09 & ~x21 & (new_n144_ | (~new_n137_ & ~x07)));
  assign new_n137_ = (x17 | new_n138_ | ~x18) & (~x15 | ~x17 | x18 | ~x00 | x05);
  ...
  assign new_n151_ = ~x21 & (new_n152_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n152_ = x04 & ~x07 & x12 & ~x14 & ~x15;
  assign new_n153_ = ~x18 & ~x21 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n155_ & ~x21;
  assign new_n155_ = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = (~x18 & x21) | (x08 & ~x17 & (new_n157_ | new_n162_) & x18);
  ...
  assign z17 = ~x09 & ((~new_n164_ & ~x05) | (new_n167_ & new_n66_ & ~x04 & x05));
  ...
  assign z19 = new_n174_ & ~x21;
  assign new_n174_ = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = new_n94_ | (~x07 & ~x17 & (new_n182_ | (~new_n176_ & ~x09)));
  assign new_n176_ = ~new_n180_ & (~x18 | (~new_n177_ & (x05 | ~new_n181_ | x06)));
  ...
  assign new_n180_ = x04 & ~x05 & x12 & new_n65_ & ~x14 & ~x15;
  ...
  assign z22 = (~x18 & x21) | (~x17 & x18 & (new_n187_ | new_n188_));
  assign new_n187_ = ~x07 & ((~x08 & ~x09 & ~x15 & x05 & x06) | (~x05 & ((x08 & x09 & ~x15) | (~x09 & x15 & x06 & ~x08))));
  assign new_n188_ = ~x05 & x07 & x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z24 = new_n94_ | (~x09 & (new_n190_ | new_n194_) & ~x17);
  ...
  assign z25 = (~x18 & x21) | (~x05 & ~x07 & ~x17 & ~new_n196_ & x18);
  assign new_n196_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = (~x18 & x21) | (~x20 & (x14 ? (x18 | ~x21) : (x18 & x21)));
  assign z27 = new_n199_ | new_n94_ | (new_n204_ & new_n66_ & x03 & ~x05);
  ...
  assign new_n215_ = ~x09 & x15 & ~x18 & ~x21 & (~x02 | ~x11);
endmodule
