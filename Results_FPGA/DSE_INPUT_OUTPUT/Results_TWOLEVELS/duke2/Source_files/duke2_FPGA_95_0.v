...
module FAU ( 
  ...
  assign new_n72_ = x15 & x18 & ~x21 & x05 & x08 & ~x11;
  assign new_n73_ = x18 & ((x08 & x21 & (x05 | x15)) | (x05 & ~x08 & ~x15));
  assign new_n74_ = (~x01 | x15 | x18 | (~x16 & (~x06 | ~x08))) & (~x08 | ~x15 | ~x18);
  ...
  assign z03 = new_n80_ | new_n67_ | (~x09 & (x07 ? ~new_n82_ : ~new_n83_));
  assign new_n80_ = new_n81_ & ~x05 & ~x07 & x08;
  assign new_n81_ = x09 & ~x15 & ~x17 & x18;
  assign new_n82_ = (x05 | ((~x06 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  ...
  assign new_n103_ = x00 & x06 & x15 & x17 & ~x18;
  assign new_n104_ = x06 & x07 & ~x15 & x17 & ~x18;
  assign new_n105_ = x04 & x05 & ~x07 & x08 & new_n106_ & new_n107_;
  ...
  assign new_n112_ = ~new_n123_ & (x07 | (~new_n120_ & (x15 | (~new_n113_ & ~new_n122_))));
  ...
  assign new_n124_ = new_n125_ & x04 & ~x05 & x06 & ~x07 & ~x09;
  assign new_n125_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n126_ = x06 & ~x07 & ~x09 & ~x15 & x17 & ~x18;
  assign z10 = (~x09 & (x07 ? ~new_n129_ : ~new_n128_)) | (x08 & new_n130_ & x09);
  assign new_n128_ = x05 ? ((~x06 | ~x17 | x18) & (x06 | x08 | x15 | x17 | ~x18)) : ((~x06 | ~x17 | x18) & (x06 | x08 | ~x15 | x17 | ~x18));
  ...
  assign z12 = new_n67_ | (~x09 & (new_n134_ | new_n141_));
  assign new_n134_ = ~x07 & (new_n140_ | (~x17 & x18 & ~new_n135_ & ~x21));
  assign new_n135_ = (new_n139_ | x04) & (new_n136_ | x05) & (~x04 | ~x05 | ~new_n106_ | ~x08);
  ...
  assign z17 = ~x09 & (new_n161_ | (new_n66_ & new_n107_ & ~x11 & x15));
  assign new_n161_ = ~x05 & (new_n104_ | (~x07 & (new_n103_ | (new_n162_ & ~x08))));
  ...
  assign new_n167_ = (x04 | x08 | ~x21) & (~new_n92_ | ~x08 | ~x10);
  ...
  assign new_n182_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (~x08 | x09 | ~x15 | x05 | ~x07);
  assign z22 = ~x17 & ~new_n184_ & x18;
  assign new_n184_ = (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = new_n186_ & x18;
  assign new_n186_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~new_n188_ & ~x17;
  assign new_n188_ = (new_n189_ | x07) & (~new_n193_ | x15 | x18 | ~x07 | ~x08);
  assign new_n189_ = ~new_n190_ & (x05 | x08 | x15 | ~x18);
  ...
  assign new_n193_ = x01 & ~x05 & x06;
  assign z25 = (~x06 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n195_ & x18);
  assign new_n195_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = new_n67_ | (~x20 & (x14 | x21));
  assign z27 = (~new_n198_ & ~x09) | new_n203_ | new_n67_;
  assign new_n198_ = (x17 | new_n199_ | ~x18) & (x05 | ~x06 | ~x17 | new_n202_ | x18);
