...
module FAU ( 
  ...
  assign new_n146_ = (x14 | x15 | (~new_n147_ & ~new_n81_)) & (x08 | ~x15 | ~x19);
  assign new_n147_ = x12 & ((new_n149_ & x06 & x08 & x10) | (~new_n148_ & ~x06));
  assign new_n148_ = (x04 | x08 | ~x21) & (~new_n86_ | ~x08 | ~x10);
  ...
  assign z23 = (x17 & ~x18) | (new_n63_ & ~x05 & ~x17 & x18 & x09 & ~x15);
  assign z24 = (x17 & ~x18) | (~x09 & (new_n169_ | (~x07 & ~new_n165_ & ~x17)));
  assign new_n165_ = ~new_n166_ & (x15 | ~x18 | x05 | x08);
