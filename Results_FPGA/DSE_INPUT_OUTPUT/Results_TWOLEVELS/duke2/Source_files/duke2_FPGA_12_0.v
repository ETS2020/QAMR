...
module FAU ( 
  ...
  assign new_n73_ = x18 & (~x08 | ((new_n74_ | ~x18) & (~x05 | x12 | x15)));
  assign new_n74_ = (~x07 | (~x05 ^ x15)) & (x05 | ~x15 | (x11 & (x02 | ~x09)));
  ...
  assign z09 = (new_n116_ & ~x07) | (~x17 & (~new_n115_ | (~new_n105_ & ~x07)));
  assign new_n105_ = ~new_n114_ & (x15 | ((new_n106_ | x09) & (~new_n113_ | x04)));
  assign new_n106_ = ~new_n112_ & (x21 | (~new_n109_ & (~x04 | new_n107_ | x12)));
  assign new_n107_ = (~x13 | x14 | ~x02 | ~x08) & (~new_n108_ | x08 | ~x18);
  assign new_n108_ = ~x05 & ~x06;
  assign new_n109_ = ~x05 & x18 & ((new_n111_ & x02) | (~new_n110_ & x06));
  assign new_n110_ = (x02 | x08 | ~x11) & (~x02 | ~x08 | x10 | ~x13 | x14);
  assign new_n111_ = x08 & x13 & ~x14 & (x10 ? x12 : ~x06);
  assign new_n112_ = x05 & ~x08 & x18 & ~x19;
  assign new_n113_ = x05 & x08 & x12 & ~new_n72_ & x18;
  ...
  assign new_n118_ = x05 ? ((~x17 | x18) & (x15 | x17 | x06 | x08)) : (x15 ? ((~x17 | x18) & (x17 | ~x18 | x06 | x08)) : (~x17 | x18));
  assign new_n119_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n120_ = x18 & (~x08 | ~x09 | x15 | ~x18 | (~x05 ^ ~x07));
  assign z12 = z11 | (~x09 & ((~new_n122_ & ~x07) | (new_n129_ & ~x05 & x07)));
  ...
  assign new_n129_ = new_n98_ & ~x15;
  assign z13 = ~x18 & (~x17 | (~x09 & x17 & (~x05 | (x05 & ~x07))));
  assign z14 = x07 ? (new_n135_ | (~x05 & new_n98_ & ~x09)) : ~new_n132_;
  assign new_n132_ = ~new_n133_ & (x05 | x09 | ~new_n98_ | ~x15);
  ...
  assign new_n146_ = (~new_n98_ | ~x07 | x15) & (x07 | ((~new_n98_ | ~x00 | ~x15) & (x08 | ~new_n147_ | x15)));
