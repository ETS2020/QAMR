...
module FAU ( 
  ...
  assign new_n79_ = x09 & ~x15 & ~x17 & x18 & new_n80_ & ~x05;
  ...
  assign z10 = (~new_n125_ & ~x09) | new_n84_ | (x08 & new_n129_ & x09);
  ...
  assign new_n131_ = ~x15 & ~x13 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n84_ | (~new_n133_ & ~x09);
  ...
  assign new_n144_ = (~new_n145_ | ~x08) & (x05 | x09 | ~new_n148_ | x13);
  ...
  assign new_n150_ = ~x13 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n152_ & ~x18;
  assign new_n152_ = x17 & ~x15 & ~x13 & ~x09 & x05 & ~x07;
  assign z16 = new_n84_ | (new_n154_ & x08);
  ...
  assign new_n165_ = ~x15 & ~x17 & ~new_n60_ & ~new_n166_ & x18;
  ...
  assign new_n174_ = ~x13 & (x13 | x15 | ~x17 | x05 | x07 | x09);
  ...
  assign new_n183_ = x09 & ~x12 & ~x15 & x18 & new_n67_ & x04;
  ...
  assign new_n193_ = (x12 | ~x18 | ~x05 | ~x08) & (x13 | x14 | x18 | x05 | ~x12);
  ...
  assign new_n203_ = ~x21 & (new_n204_ | (~new_n138_ & ~x04));
  ...
  assign z28 = (~new_n208_ & ~x17) | (~x18 & (x13 | (~x09 & ~new_n216_ & x17)));
  ...
  assign new_n215_ = ~x09 & ~x13 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n216_ = x05 ? (x07 | x13) : (~x15 | (x19 & (x07 | x13)));
endmodule
