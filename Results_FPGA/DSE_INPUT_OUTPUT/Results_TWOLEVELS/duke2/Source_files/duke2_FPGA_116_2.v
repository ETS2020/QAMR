...
module FAU ( 
  ...
  assign new_n124_ = ~x14 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | x14)));
  ...
  assign new_n142_ = x00 & ~x05 & ~x14 & x15 & x17 & ~x18;
  ...
  assign new_n154_ = ~x14 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign z17 = new_n68_ | (~x09 & (new_n163_ | new_n166_));
  ...
  assign new_n166_ = new_n65_ & new_n104_ & ~x11 & x15;
  ...
  assign z20 = new_n68_ | (~x07 & ~x17 & (new_n182_ | (~new_n175_ & ~x09)));
  ...
  assign new_n191_ = ~new_n192_ & (~new_n133_ | ~x08 | x14 | x15 | x18);
  ...
  assign z25 = (x14 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n197_ & x18);
  ...
  assign z28 = (~new_n215_ & ~x18) | (~x17 & ((new_n217_ & ~x05) | (~new_n208_ & x18)));
  ...
  assign new_n215_ = ~x14 & (~new_n216_ | x09);
