...
module FAU ( 
  ...
  assign z01 = (~x03 & x18) | (~x17 & (new_n65_ | (x03 & ~x07 & ~new_n58_ & x18)));
  ...
  assign z03 = (~new_n79_ & ~x07) | new_n81_ | (x07 & ~new_n82_ & ~x09);
  assign new_n79_ = (new_n80_ | x15) & (x09 | ~x17 | x18 | (~x05 & (x05 | ~x15)));
  assign new_n80_ = (~x03 | x17 | ~x18 | (x05 ? (x08 | x09) : (~x08 | ~x09))) & (~x17 | x18 | x05 | x09);
  assign new_n81_ = ~x03 & x18;
  assign new_n82_ = (~x03 | ~x08 | x17 | ~x18 | (~x05 ^ x15)) & (x05 | ~x17 | x18);
  ...
  assign z06 = new_n81_ | (~x09 & (new_n105_ | (~x05 & (new_n93_ | new_n103_))));
  assign new_n93_ = ~x07 & ((x03 & ~x17 & ~new_n94_ & x18) | (new_n102_ & x17 & ~x18));
  ...
  assign new_n105_ = new_n106_ & x03 & x04 & x05 & ~x07 & x08;
  assign new_n106_ = ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign z07 = x18 & (~x03 | (~x17 & (new_n110_ | (new_n108_ & x03))));
  assign new_n108_ = ~x09 & ~new_n109_ & (x07 ^ ~x08);
  ...
  assign new_n131_ = (x05 | ~x17 | x18) & (~x03 | ~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n132_ = ~x15 & ~x17 & (x05 ^ ~x07);
  assign z11 = new_n134_ & ~x18;
  assign new_n134_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n136_ & ~x07) | (~x05 & x07 & new_n104_ & ~x15));
  ...
  assign new_n143_ = x00 & ~x05 & new_n104_ & x15;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~x17 & (new_n146_ | (~x05 & new_n149_ & ~x09))) | (~x05 & new_n151_ & ~x09);
  assign new_n146_ = x03 & x08 & ~new_n147_ & x18;
  assign new_n147_ = x07 ? (new_n109_ | x19) : (new_n148_ | (~x09 & (x09 | x21)));
  ...
  assign z15 = new_n81_ | (new_n104_ & ~x15 & x05 & ~x07 & ~x09);
  assign z16 = x18 & (~x03 | (x08 & ~new_n154_ & ~x17));
  assign new_n154_ = x05 ? ~new_n161_ : (~new_n160_ & (x07 | new_n155_ | x15));
  assign new_n155_ = (~x03 | ~x09 | x19) & (x09 | x14 | new_n156_ | x21);
  assign new_n156_ = (~x06 | (~new_n157_ & ~new_n158_)) & (~new_n159_ | x06) & (~new_n97_ | ~x03);
  assign new_n157_ = x02 & ((x04 & ~x12) | (x03 & ~x10 & x13));
  assign new_n158_ = x12 & ~x16 & (~x13 | (~x02 & x11));
  assign new_n159_ = x12 & x16 & (~x13 | (~x02 & x11));
  assign new_n160_ = x09 & x15 & (~x02 | (x03 & x07));
  assign new_n161_ = x09 & ~x15 & (~x12 | (x03 & x07));
  assign z17 = ~x09 & (new_n163_ | new_n166_);
  assign new_n163_ = ~x05 & ((new_n104_ & x07 & ~x15) | (~x07 & (new_n164_ | (new_n104_ & x00 & x15))));
  assign new_n164_ = x03 & ~x08 & ~x15 & ~x17 & new_n165_ & x18;
  assign new_n165_ = ~new_n61_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n166_ = new_n167_ & x03 & ~x04 & x05 & ~x07 & x08;
  assign new_n167_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = x18 & (~x03 | (x03 & ~x05 & ~x07 & new_n169_ & ~x09));
  assign new_n169_ = ~x17 & ((~x14 & ~new_n170_ & ~x15) | (~x08 & x15 & x19));
  assign new_n170_ = ~new_n86_ & (~x12 | (~new_n172_ & (new_n171_ | x06)));
  assign new_n171_ = (x04 | x08 | ~x21) & (x13 | x16 | x21 | ~x08 | ~x10);
  assign new_n172_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n181_ | (x03 & ~new_n175_ & x18));
  assign new_n175_ = ~new_n180_ & (x09 | (~new_n176_ & (x05 | ~new_n179_ | x06)));
  ...
  assign new_n181_ = new_n182_ & x04 & ~x05 & ~x09 & x12;
  assign new_n182_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign z21 = x18 & (~x03 | (~x17 & (new_n185_ | (~new_n184_ & ~x09))));
  assign new_n184_ = (x05 | x06 | x07 | x08 | ~x15) & (~x03 | ((x07 | x08 | x15 | ~x05 | ~x06) & (~x08 | ~x15 | x05 | ~x07)));
  assign new_n185_ = x08 & x09 & ~x15 & ~x05 & x06 & ~x07;
  assign z22 = x03 & ~x17 & ~new_n187_ & x18;
  assign new_n187_ = (x07 | ((~x06 | x08 | x09 | (~x05 ^ x15)) & (x05 | ~x08 | ~x09 | x15))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = x03 & new_n189_ & ~x05;
  assign new_n189_ = ~x07 & x08 & x09 & ~x15 & ~x17 & x18;
  assign z24 = new_n81_ | (~x09 & ~x17 & (new_n195_ | (~new_n191_ & ~x07)));
  assign new_n191_ = (new_n192_ | x21) & (x05 | x08 | x15 | ~x18);
  assign new_n192_ = (~x04 | new_n193_ | x15) & (~x03 | ~x08 | ~new_n194_ | ~x15);
  assign new_n193_ = (~x03 | ~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x05 | ~x12);
  assign new_n194_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n195_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = x03 & new_n197_ & ~x05;
  assign new_n197_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = new_n81_ | (~x20 & (x14 | x21));
  assign z27 = new_n204_ | (~x09 & (new_n206_ | (x03 & new_n200_ & ~x17)));
  assign new_n200_ = ~new_n201_ & x18;
  assign new_n201_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n202_ & (~x05 | x08 | x15 | ~x19));
  assign new_n202_ = ~x21 & (new_n203_ | (~new_n141_ & ~x04));
