...
module FAU ( 
  ...
  assign new_n126_ = x20 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | ~x20)));
  assign z10 = ~new_n132_ | (~x09 & (x07 ? ~new_n128_ : ~new_n130_));
  assign new_n128_ = (~new_n129_ | ~x05 | ~x08 | x15) & (~new_n103_ | x05);
  assign new_n129_ = ~x17 & x18 & x19;
  ...
  assign new_n154_ = ~x18 & x20 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n156_ & ~x18;
  assign new_n156_ = x20 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign new_n171_ = (x14 | x15 | (~new_n88_ & ~new_n172_)) & (x08 | ~x15 | ~x19);
  ...
  assign z20 = new_n80_ | (~x07 & ~x17 & (new_n185_ | (~new_n178_ & ~x09)));
  ...
  assign new_n190_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  ...
  assign z27 = new_n203_ | new_n80_ | (new_n208_ & new_n66_ & x03 & ~x05);
  ...
  assign new_n208_ = new_n129_ & x09 & ~x15;
