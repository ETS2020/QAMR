...
module FAU ( 
  ...
  assign new_n70_ = (new_n71_ | x07) & (~x05 | ~x07 | ~x08 | ~new_n74_ | x15);
  ...
  assign new_n82_ = (x06 | x18) & (~new_n66_ | x05 | ~new_n83_ | x17 | ~x18);
  assign new_n83_ = x09 & ~x15;
  assign new_n84_ = (x05 | ((~x06 | ~x17 | x18) & (~x08 | ~x15 | x17 | ~x18))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n85_ = x05 ? ((~x06 | ~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (~x06 | ~x17 | x18);
  ...
  assign new_n113_ = (~new_n121_ | x07) & (x15 | (~new_n124_ & ((~new_n114_ & ~new_n123_) | x07)));
  ...
  assign new_n125_ = new_n126_ & x04 & ~x05 & x06 & ~x07 & ~x09;
  assign new_n126_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n127_ = x06 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | ~x06)));
  assign z10 = ~new_n131_ | (~x09 & (x07 ? ~new_n129_ : ~new_n133_));
  assign new_n129_ = (x05 | ~x06 | ~x17 | x18) & (~new_n130_ | ~x05 | x17 | ~x18 | ~x19);
  assign new_n130_ = x08 & ~x15;
  assign new_n131_ = (x06 | x18) & (~x08 | x15 | x17 | new_n132_ | ~x18);
  assign new_n132_ = x05 ? (~x07 | (~x09 & x19)) : (x07 | ~x09);
  assign new_n133_ = x05 ? ((~x06 | ~x17 | x18) & (x15 | x17 | x06 | x08)) : ((~x06 | ~x17 | x18) & (x06 | x08 | ~x15 | x17 | ~x18));
  assign z11 = ~x18 & (new_n135_ | ~x06);
  assign new_n135_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = ~x09 & ((~new_n137_ & ~x07) | (new_n106_ & ~x05 & x06 & x07));
  ...
  assign z17 = new_n80_ | (~x09 & (new_n164_ | new_n167_));
  assign new_n164_ = ~x05 & (new_n105_ | (~x07 & (new_n104_ | (new_n165_ & ~x08))));
  assign new_n165_ = ~x15 & ~x17 & x18 & ~new_n61_ & ~new_n166_;
  assign new_n166_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n167_ = new_n65_ & new_n108_ & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n169_ & x18;
  assign new_n169_ = (x14 | x15 | (~new_n89_ & ~new_n170_)) & (x08 | ~x15 | ~x19);
  ...
  assign z22 = (~x06 & ~x18) | (~x17 & x18 & (new_n188_ | new_n189_));
  ...
  assign new_n206_ = x06 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n207_ = new_n66_ & x03 & ~x05 & new_n83_ & new_n74_ & ~x17;
