...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n70_, new_n72_, new_n73_, new_n74_, new_n78_, new_n80_, new_n81_,
    new_n85_, new_n86_;
  ...
  assign z03 = (~x17 & x18) | (~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07)));
  ...
  assign z14 = (~x17 & x18) | (~x05 & ~x09 & (new_n74_ | (~new_n72_ & ~x18)));
  assign new_n72_ = (new_n73_ | x15) & (~x07 | (x01 & (~x15 | ~x17))) & (x07 | ~x15 | ~x17);
  assign new_n73_ = (~x07 | ~x17) & (~x04 | x07 | ~x12 | x14 | x17 | x21);
  assign new_n74_ = x07 & x15 & ~x17 & (~x02 | ~x11 | (x02 & x11));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x21 & ~x18 & ~x17 & new_n78_ & ~x15;
  assign new_n78_ = ~x14 & x12 & ~x09 & ~x07 & x04 & ~x05;
  assign z24 = ~x05 & ~x09 & ~x15 & ~x17 & ~new_n80_ & ~x18;
  ...
  assign new_n86_ = (~x07 | x17 | (x02 & x11)) & (~x17 | x18 | (x07 & x19));
  assign z07 = 1'b0;
  assign z16 = 1'b0;
  assign z21 = 1'b0;
  assign z25 = 1'b0;
