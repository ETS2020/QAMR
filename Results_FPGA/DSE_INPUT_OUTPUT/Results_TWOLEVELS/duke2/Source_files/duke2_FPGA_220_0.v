...
module FAU ( 
  ...
  assign z02 = new_n80_ | (~x17 & ((~new_n69_ & ~x09) | (~new_n76_ & x08)));
  ...
  assign new_n74_ = x06 ? (x11 & (x02 | ~x18)) : (~x18 | (x04 & x12));
  assign new_n75_ = x08 ? ((~x07 | ~x19) & (~x11 | x21 | x02 | x07)) : x07;
  assign new_n76_ = (~x18 | ((new_n77_ | x15) & (x05 | new_n79_ | ~x15))) & (x05 | x11 | ~x15);
  assign new_n77_ = x05 ? new_n78_ : x07;
  assign new_n78_ = (x04 | x07 | ~x12 | (~x09 & x21)) & x12 & (~x07 | (~x09 & x19));
  assign new_n79_ = (~x07 | (~x09 & x19)) & (~x09 | ~x11 | x02 | x07);
  assign new_n80_ = ~x11 & ~x18;
  assign z03 = ~new_n82_ | (~x09 & (x07 ? ~new_n84_ : ~new_n85_));
  assign new_n82_ = (x11 | x18) & (~new_n66_ | x05 | ~new_n83_ | x17 | ~x18);
  ...
  assign new_n103_ = x15 & x17 & ~x18 & x00 & x11;
  ...
  assign new_n126_ = ~x07 & ~x09 & new_n105_ & x11;
  ...
  assign z16 = (~x11 & ~x18) | (x08 & ~x17 & x18 & (new_n157_ | new_n162_));
  ...
  assign z17 = new_n80_ | (~x09 & (new_n167_ | (~new_n164_ & ~x05)));
  assign new_n164_ = ~new_n104_ & (x07 | (~new_n103_ & (~new_n165_ | x08)));
  ...
  assign new_n174_ = x11 & (x05 | x07 | x09 | ~x11 | x15 | ~x17);
  assign z20 = new_n80_ | (~x07 & ~x17 & (new_n183_ | (~new_n176_ & ~x09)));
  ...
  assign z22 = (~x11 & ~x18) | (~x17 & x18 & (new_n188_ | new_n189_));
  ...
  assign z24 = new_n80_ | (~x09 & ~x17 & (new_n193_ | new_n197_));
  ...
  assign new_n205_ = ~new_n80_ & (~new_n206_ | ~new_n66_ | ~x03 | x05);
  assign new_n206_ = new_n83_ & ~x17 & x18 & x19;
  assign new_n207_ = new_n208_ & ~x05;
  assign new_n208_ = x11 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = (~new_n210_ & ~x17) | (~x18 & (~x11 | (~x09 & ~new_n220_ & x17)));
  assign new_n210_ = ~new_n218_ & (~x18 | (~new_n189_ & (new_n211_ | x07)));
  assign new_n211_ = (~x08 | (new_n217_ & (x05 | (~new_n212_ & ~new_n214_)))) & (x05 | ~new_n216_ | x08);
  ...
  assign new_n218_ = ~x05 & ~new_n219_ & x15;
  assign new_n219_ = (~x08 | x11) & (x02 | ~x07 | x09 | ~x11 | x18);
