...
module FAU ( 
  ...
  assign new_n73_ = (~x01 | x15 | x18 | (~x16 & (~x08 | ~x19))) & (~x18 | ~x19 | ~x08 | ~x15);
  ...
  assign new_n125_ = x19 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | ~x19)));
  ...
  assign new_n154_ = x19 & (~x05 | x07 | x09 | x15 | ~x17);
  ...
  assign new_n193_ = ~new_n194_ & (~new_n133_ | x18 | ~x19 | ~x08 | x15);
  assign new_n194_ = ~x07 & (new_n195_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n195_ = ~x21 & ((x04 & ~new_n196_ & ~x15) | (x08 & new_n197_ & x15));
  assign new_n196_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | ~x19);
  ...
  assign z27 = new_n202_ | new_n78_ | (new_n207_ & new_n65_ & x03 & ~x05);
  ...
  assign new_n204_ = ~x21 & (new_n205_ | (~new_n140_ & ~x04));
  assign new_n205_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n206_ = x19 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n207_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (new_n217_ & ~x07) | (~x17 & (new_n209_ | (~x05 & new_n216_ & x07)));
  ...
  assign new_n216_ = ~x09 & x15 & ~x18 & x19 & (~x02 | ~x11);
  assign new_n217_ = ~x09 & x17 & ~x18 & x19 & (x05 | (~x05 & x15));
endmodule
