...
module FAU ( 
  ...
  assign new_n66_ = ~x05 & (x15 ? new_n69_ : (new_n68_ | (~new_n67_ & ~x12)));
  assign new_n67_ = (~x01 | ~x07 | x18 | (~x08 & ~x16)) & (x06 | x07 | ~x18);
  assign new_n68_ = ~x07 & x18 & (x06 ? (~x02 | ~x11) : ~x04);
  ...
  assign new_n77_ = (~x08 | x17 | ~x18 | (~x05 ^ x15)) & (x05 | x12 | ~x17 | x18);
  assign new_n78_ = x05 ? ((x12 | ~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (x12 | ~x17 | x18);
  assign new_n79_ = ~x05 & ~x07 & x08;
  assign z04 = ~x14 & ~x20 & (~x12 | x18);
  assign z05 = new_n82_ | (x12 & ~x18);
  ...
  assign z06 = ~x09 & (new_n102_ | (~x05 & (new_n100_ | (~new_n91_ & ~x07))));
  ...
  assign z09 = (~x17 & x18 & (new_n118_ | (~new_n108_ & ~x07))) | (new_n117_ & ~x07);
  assign new_n108_ = (new_n116_ | ~x08) & (x15 | (~new_n115_ & (new_n109_ | x09)));
  ...
  assign new_n117_ = ~x09 & new_n101_ & ~x12;
  assign new_n118_ = x05 & x08 & ~x15 & (x07 | ~x12);
  assign z10 = (~new_n120_ & ~x09) | (x12 & ~x18) | (x08 & new_n124_ & x09);
  assign new_n120_ = x07 ? new_n123_ : new_n121_;
  ...
  assign z11 = ~x18 & (x12 | (new_n126_ & ~x09 & ~x15 & ~x17));
  assign new_n126_ = x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n128_ & ~x07) | (new_n101_ & ~x05 & x07 & ~x12));
  ...
  assign new_n142_ = ~x09 & ~x12 & x15 & ~x18 & (~x02 | ~x11 | (x02 & x11));
  assign new_n143_ = ~x12 & ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n145_ & ~x18;
  assign new_n145_ = x17 & ~x15 & ~x12 & ~x09 & x05 & ~x07;
  ...
  assign new_n154_ = ~new_n99_ & (x08 | x15 | x17 | ~new_n155_ | ~x18);
  assign new_n155_ = ~new_n59_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n156_ = new_n64_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  ...
  assign new_n165_ = ~new_n170_ & (x09 | (~new_n166_ & (x05 | ~new_n169_ | x06)));
  ...
  assign z24 = ~x09 & ~x17 & (new_n180_ | (new_n178_ & ~x07));
  assign new_n178_ = x18 & ((~x05 & ~x08 & ~x15) | (x08 & ~new_n179_ & ~x21));
  assign new_n179_ = (x02 | x05 | ~x11 | ~x15) & (~x05 | (x04 ? (x12 | x15) : (x11 | ~x15)));
  assign new_n180_ = new_n126_ & x08 & ~x12 & ~x15 & ~x18;
  assign z25 = (x12 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n182_ & x18);
  ...
  assign new_n189_ = ~x12 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n190_ = new_n191_ & x03 & ~x05 & ~x07 & x08;
  assign new_n191_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n193_ & ~x17) | (~x18 & (x12 | (~x09 & ~new_n203_ & x17)));
  assign new_n193_ = (new_n194_ | ~x18) & (x05 | new_n200_ | x09);
  assign new_n194_ = (~x08 | ((new_n195_ | x05) & (new_n199_ | x07))) & (x05 | x07 | ~new_n198_ | x08);
  assign new_n195_ = ~new_n196_ & (~new_n197_ | ~x02 | x07 | x09 | ~x10);
  ...
  assign new_n200_ = x07 ? (~new_n201_ | x12) : (~x08 | ~x10 | ~new_n202_ | ~x12);
  assign new_n201_ = x15 & ~x18 & (~x02 | ~x11);
  assign new_n202_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13);
  assign new_n203_ = x05 ? (x07 | x12) : (~x15 | (x19 & (x07 | x12)));
endmodule
