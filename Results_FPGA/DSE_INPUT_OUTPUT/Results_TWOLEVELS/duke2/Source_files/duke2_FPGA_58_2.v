...
module FAU ( 
  ...
  assign new_n68_ = ~x04 & ((~x06 & ~x15) | (new_n69_ & x05 & x08));
  ...
  assign new_n78_ = (~x08 | ((x05 | (x07 ? (x09 | ~x15) : (~x09 | x15))) & (x09 | x15 | ~x05 | ~x07))) & (~x05 | x07 | x08 | x09 | x15);
  ...
  assign z09 = (~new_n54_ & ~x18) | (~x17 & ~new_n102_ & x18);
  ...
  assign z14 = (~x17 & (new_n132_ | (x08 & ~new_n129_ & x18))) | (~x18 & (new_n126_ | x17));
  assign new_n126_ = ~x05 & ~new_n127_ & ~x09;
  assign new_n127_ = ~new_n128_ & (~x07 | (x01 & (~x02 | ~x11 | ~x15)));
  ...
  assign new_n133_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  ...
  assign new_n142_ = (x05 | x08 | ~new_n143_ | x15) & (~new_n69_ | x04 | ~x05 | ~x08);
  ...
  assign new_n157_ = new_n158_ & new_n124_ & ~x17 & x18;
  ...
  assign z24 = z15 | (~x09 & (new_n170_ | (~new_n166_ & ~x07)));
  ...
  assign new_n169_ = ~x17 & x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  ...
  assign z28 = ~x17 & (new_n132_ | (~new_n181_ & x18));
