...
module FAU ( 
  ...
  assign new_n106_ = ~x20 & (~new_n107_ | x15 | x17 | ~x18 | x20 | x21);
  ...
  assign new_n123_ = ~x19 & ~x20 & x05 & ~x08;
  ...
  assign z12 = ~x09 & (new_n138_ | ~new_n149_);
  assign new_n138_ = ~x07 & (new_n148_ | (~x17 & x18 & ~new_n139_ & ~x21));
  assign new_n139_ = ~new_n140_ & ~new_n147_ & (x05 | (~new_n146_ & (new_n143_ | x15)));
  assign new_n140_ = ~x04 & (new_n142_ | (new_n141_ & ~x11 & x15 & ~x20));
  assign new_n141_ = x05 & x08;
  assign new_n142_ = ~x05 & ~x06 & ~x08 & x12 & ~x15;
  assign new_n143_ = ~new_n145_ & (x20 | (~new_n144_ & (~x08 | ~new_n99_ | x14)));
  assign new_n144_ = x06 & ~x08 & (x02 ^ x11);
  assign new_n145_ = ~x08 & ~x12 & x04 & ~x06;
  assign new_n146_ = new_n64_ & x11 & x15 & ~x20;
  assign new_n147_ = new_n141_ & x04 & ~x12 & ~x15 & ~x20;
  assign new_n148_ = x17 & ~x18 & ~x20 & x00 & ~x05 & x15;
  assign new_n149_ = ~x20 & (~x17 | x18 | x20 | x05 | ~x07 | x15);
  ...
  assign new_n153_ = x07 ? ~new_n155_ : (new_n154_ | (~x09 & (~new_n56_ | x09)));
  assign new_n154_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n155_ = ~x19 & (~x05 ^ ~x15) & (x09 | (~x09 & ~x20));
  assign new_n156_ = ~x20 & (new_n157_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n157_ = ~x14 & ~x15 & ~x21 & x04 & ~x07 & x12;
  assign new_n158_ = ~x18 & ~x20 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n160_ & ~x09;
  assign new_n160_ = ~x20 & (~x05 | x07 | x15 | ~x17 | x18);
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n167_ : ~new_n162_);
  assign new_n162_ = (x07 | x15 | (x09 ? x19 : ~new_n163_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n163_ = ~x14 & ~x20 & ~new_n164_ & ~x21;
  assign new_n164_ = (~x06 | (~new_n165_ & (~x12 | new_n166_ | x16))) & ~new_n99_ & (x06 | ~x12 | new_n166_ | ~x16);
  assign new_n165_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n166_ = x13 & (x02 | ~x11);
  assign new_n167_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (~new_n173_ | (~x05 & (new_n108_ | (~new_n169_ & ~x07))));
  assign new_n169_ = ~new_n105_ & (x08 | x15 | x17 | new_n170_ | ~x18);
  assign new_n170_ = (x20 | (~new_n171_ & (~new_n172_ | ~x12 | x14 | ~x21))) & (~new_n172_ | ~x12 | x21);
  assign new_n171_ = x02 & x06 & ~new_n62_ & ~x11;
  assign new_n172_ = ~x04 & ~x06;
  assign new_n173_ = ~x20 & (~new_n174_ | ~x15 | x17 | ~x18 | x20 | x21);
  assign new_n174_ = ~x04 & x05 & ~x07 & x08 & ~x11;
  assign z18 = ~new_n176_ & ~x09;
  assign new_n176_ = ~x20 & (x05 | x07 | x17 | ~x18 | new_n177_ | x20);
  assign new_n177_ = (x14 | x15 | (~new_n89_ & ~new_n178_)) & (x08 | ~x15 | ~x19);
  assign new_n178_ = x12 & ((~new_n180_ & ~x06) | (new_n179_ & x06 & x08 & x10));
  assign new_n179_ = ~x13 & x16 & ~x21;
  assign new_n180_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x20 & ~x18 & x17 & ~x15 & new_n111_ & ~x09;
  assign z20 = (new_n183_ & ~x07) | (~x09 & x20);
  assign new_n183_ = ~x17 & (new_n195_ | (~x09 & (new_n193_ | (~new_n184_ & x18))));
  assign new_n184_ = ~new_n191_ & (x20 | (x04 ? (~new_n187_ | x12) : new_n185_));
  assign new_n185_ = ~new_n73_ & (~new_n186_ | x05 | x06 | x08);
  assign new_n186_ = x12 & ~x14 & ~x15 & x21;
  assign new_n187_ = ~x15 & (x05 ? new_n190_ : (~x14 & (new_n188_ | new_n189_)));
  assign new_n188_ = x08 & x10 & ~x21 & (~x13 | (~x02 & x11 & x13));
  assign new_n189_ = ~x06 & ~x08 & x21;
  assign new_n190_ = x08 & ~x21;
  assign new_n191_ = new_n192_ & ~x05;
  assign new_n192_ = ~x06 & ~x08 & ~x15 & ~x21 & (x04 ^ x12);
  assign new_n193_ = new_n194_ & new_n56_ & ~x15 & ~x18;
  assign new_n194_ = x04 & ~x05 & x12 & ~x14;
  assign new_n195_ = new_n141_ & x04 & x09 & ~x12 & ~x15 & x18;
  assign z21 = new_n197_ | (~x09 & x20);
  assign new_n197_ = ~x17 & x18 & ((~new_n198_ & ~x07) | (~x05 & new_n199_ & x07));
  assign new_n198_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15 | x20)));
  assign new_n199_ = x08 & ~x09 & x15 & ~x20;
  ...
  assign new_n205_ = ~x07 & (new_n206_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n206_ = ~x21 & ((x04 & ~new_n207_ & ~x15) | (x08 & new_n208_ & x15));
  assign new_n207_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18);
  assign new_n208_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n209_ = x08 & ~x15 & ~x18 & x01 & ~x05 & x07;
  ...
  assign z28 = new_n234_ | (~x05 & ((~new_n224_ & ~x17) | (new_n239_ & ~x09)));
