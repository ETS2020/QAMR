...
module FAU ( 
  ...
  assign new_n93_ = (x07 | ((x17 | new_n94_ | ~x18) & (~x17 | x18 | ~x00 | ~x15))) & (~x07 | x15 | ~x17 | x18);
  ...
  assign new_n97_ = ~x06 & ((~x13 & ~x16 & x10 & x12) | (x02 & ~x10 & x13));
  ...
  assign z09 = (new_n119_ & ~x07) | (x18 & (~new_n121_ | (~new_n107_ & ~x07)));
  assign new_n107_ = ~new_n116_ & (x15 | ((new_n108_ | x09) & (~new_n118_ | x04)));
  assign new_n108_ = ~new_n115_ & (x21 | ((~new_n109_ | ~x04) & (new_n111_ | x05)));
  assign new_n109_ = ~x12 & (new_n110_ | (x02 & x08 & x13 & ~x14));
  assign new_n110_ = ~x08 & ~x17 & ~x05 & ~x06;
  ...
  assign new_n114_ = x13 & ~x14 & ((x10 & x12) | (~x06 & ~x10 & ~x17));
  assign new_n115_ = ~x17 & ~x19 & x05 & ~x08;
  assign new_n116_ = x08 & (new_n117_ | (~x17 & x21 & x05 & ~x09));
  ...
  assign new_n121_ = ~x17 & (~x05 | ~x08 | x15 | x17 | (~x07 & x12));
  ...
  assign new_n141_ = (~new_n142_ | x02) & (x09 | ~x17 | x18);
  ...
  assign new_n150_ = (x07 | new_n151_ | x15) & (~x09 | ~x15 | x17 | (x02 & ~x07));
  assign new_n151_ = x09 ? x19 : (x14 | new_n152_ | x21);
  assign new_n152_ = (~x06 | (~new_n153_ & ~new_n154_)) & (~new_n155_ | x06) & (~new_n96_ | x17);
  ...
  assign z17 = ~x09 & (new_n158_ | new_n162_);
  assign new_n158_ = ~x05 & ((~new_n159_ & ~x07) | (x07 & ~x15 & x17 & ~x18));
  ...
  assign new_n162_ = new_n163_ & new_n66_ & ~x17 & x18 & ~x21;
  ...
  assign new_n167_ = (x04 | x08 | ~x21) & (~new_n91_ | ~x08 | ~x10);
  ...
  assign new_n173_ = ~x21 & (x04 ? (new_n174_ & ~x12) : ~new_n134_);
