...
module FAU ( 
  ...
  assign new_n56_ = x05 ? (x07 & x15) : (x18 | (x07 ? ~x15 : (x15 & (x00 | ~x15))));
  ...
  assign z02 = ~x17 & (new_n74_ | (~x09 & (new_n68_ | (~new_n72_ & x18))));
  assign new_n68_ = ~x05 & (x07 ? ~new_n69_ : (x18 & (new_n70_ | new_n71_)));
  assign new_n69_ = (~x01 | x15 | x18 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18);
  assign new_n70_ = ~x02 & ((x06 & ~x08) | (x08 & x11 & x15 & ~x21));
  assign new_n71_ = ~x08 & ((~x06 & (~x04 | ~x12)) | x15 | (x06 & ~x11));
  ...
  assign new_n76_ = x11 & (~x09 | (~x07 & (x02 | x07 | ~x11)));
  assign z03 = z23 | (~new_n80_ & ~x09);
  assign z23 = x18 & (x17 | (new_n79_ & x08 & x09 & ~x15));
  assign new_n79_ = ~x05 & ~x07;
  assign new_n80_ = x07 ? ((~x08 | x17 | ~x18 | (~x05 ^ x15)) & (x05 | ~x17 | x18)) : (x05 ? (~x17 & (x08 | x15 | x17 | ~x18)) : (~x17 | x18));
  ...
  assign new_n92_ = (~new_n97_ | x08) & (x14 | (~new_n86_ & new_n93_));
  ...
  assign new_n109_ = ~x05 & ~x06 & ~x08 & ~x17;
  ...
  assign new_n113_ = x13 & ~x14 & ((x10 & x12) | (~x06 & ~x10 & ~x17));
  ...
  assign new_n122_ = x05 ? (~x17 & (x06 | x08 | x15 | ~x18)) : (x15 ? ((~x17 | x18) & (x06 | x08 | ~x18)) : (~x17 | x18));
  assign new_n123_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n124_ = ~x17 & (~x08 | ~x09 | x15 | (x05 ? (~x07 | x17) : x07));
  ...
  assign z13 = x17 & (x18 | (~x09 & (x05 ? ~x07 : ~x18)));
  assign z14 = (~x17 & (new_n137_ | (~x05 & new_n141_ & ~x09))) | (~x05 & new_n143_ & ~x09);
  assign new_n137_ = x08 & ~new_n138_ & x18;
  assign new_n138_ = x07 ? ~new_n140_ : (new_n139_ | (~x09 & (x09 | x21)));
  assign new_n139_ = (~x11 | ~x15 | x02 | x05) & (~x04 | ~x05 | x12 | x15);
  ...
  assign new_n154_ = (~new_n99_ | ~x07 | x15) & (x07 | ((~new_n99_ | ~x00 | ~x15) & (x08 | ~new_n155_ | x15)));
  ...
  assign new_n159_ = (x14 | x15 | (~new_n84_ & ~new_n160_)) & (x08 | ~x15 | ~x19);
  ...
  assign z19 = ~x18 & x17 & ~x15 & new_n79_ & ~x09;
  ...
  assign z21 = x18 & (new_n175_ | ~new_n176_);
  assign new_n175_ = ~x07 & ((~x05 & ((~x06 & ~x08 & ~x09 & x15) | (x09 & ~x15 & x06 & x08))) | (~x08 & ~x09 & ~x15 & x05 & x06));
  assign new_n176_ = ~x17 & (x09 | ~x15 | x17 | x05 | ~x07 | ~x08);
  assign z22 = ~new_n178_ & x18;
  assign new_n178_ = (new_n179_ | x07) & ~x17 & (x05 | ~x07 | ~x08 | ~x15 | x17);
  assign new_n179_ = (x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  ...
  assign new_n185_ = new_n126_ & x08 & ~x15 & ~x18;
  assign z25 = ~new_n187_ & x18;
  assign new_n187_ = ~x17 & (x05 | x07 | (x08 ? (~x09 | x15) : (x09 | ~x15 | x17)));
  ...
  assign new_n193_ = ~x15 & x19 & x05 & ~x08;
  assign new_n194_ = new_n79_ & x03 & x08 & x09 & ~x15 & x19;
  assign new_n195_ = ~x05 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign z28 = new_n205_ | (x18 & (~new_n207_ | (~new_n197_ & ~x07)));
  assign new_n197_ = (x05 | ~new_n202_ | x08) & (~x08 | ((new_n198_ | x05) & (new_n204_ | x17)));
  assign new_n198_ = (new_n199_ | ~x11) & (x09 | ~new_n201_ | ~x10);
  assign new_n199_ = ~new_n200_ & (x02 | ~x15 | x17 | (~x09 & (x09 | x21)));
  assign new_n200_ = ~x14 & ~x15 & ~x21 & ~x09 & x10 & x12;
  assign new_n201_ = x12 & ~x14 & ~x15 & ~x21 & (~x13 | (x02 & x13));
  assign new_n202_ = ~x09 & ~x17 & ((~x14 & new_n203_ & ~x15) | (x15 & ~x19));
  assign new_n203_ = x21 & ((~x02 & x06 & x11) | (x04 & ~x06 & ~x12));
  assign new_n204_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n205_ = ~x09 & (x05 ? (~x07 & x17) : (~new_n206_ & x15));
  assign new_n206_ = (~x17 | x19) & (x18 | (x07 ? (x17 | (x02 & x11)) : ~x17));
  assign new_n207_ = ~x17 & (x05 | ~x08 | ~x15 | (~x07 & x11) | x17);
endmodule
