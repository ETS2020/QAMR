...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n60_, new_n61_,
    ...
    new_n214_;
  assign z00 = ~x18 & (x11 | (~x09 & (new_n54_ | new_n58_)));
  assign new_n54_ = new_n55_ & new_n57_ & x04 & ~x05;
  assign new_n55_ = new_n56_ & ~x15 & ~x17 & ~x21;
  assign new_n56_ = x12 & ~x14;
  assign new_n57_ = ~x07 & ~x11;
  assign new_n58_ = x17 & (x05 ? (~x15 | (~x07 & ~x11)) : (~x11 & (x07 ? x15 : (~x15 | (~x00 & x15)))));
  assign z01 = ~x07 & ~x17 & x18 & (new_n65_ | (~new_n60_ & ~x05));
  ...
  assign new_n65_ = new_n66_ & ~x04 & ~x09 & ~x11 & x15 & ~x21;
  assign new_n66_ = x05 & x08;
  assign z02 = ~x17 & ((~new_n68_ & ~x09) | (new_n76_ & x08));
  assign new_n68_ = (x05 | (x07 ? new_n73_ : (new_n75_ | ~x18))) & (new_n69_ | ~x18);
  assign new_n69_ = (x07 | (new_n71_ & (new_n70_ | x04))) & (~new_n72_ | ~x05 | ~x07);
  assign new_n70_ = (x06 | x15) & (~new_n66_ | x11 | ~x15 | x21);
  assign new_n71_ = (~x08 | ~x21 | (~x05 & ~x15)) & (x15 | ((x06 | x12) & (~x05 | x08)));
  assign new_n72_ = x08 & ~x15 & x19;
  assign new_n73_ = ~new_n74_ & (~x18 | ~x19 | ~x08 | ~x15);
  assign new_n74_ = x01 & ~x11 & ~x15 & ~x18 & (x08 | x16);
  ...
  assign z03 = new_n80_ | (~x09 & (x07 ? ~new_n83_ : ~new_n84_));
  assign new_n80_ = new_n81_ & ~x05 & new_n82_ & ~x17 & x18;
  ...
  assign z06 = new_n86_ | (~x09 & (new_n104_ | (~x05 & (new_n96_ | new_n106_))));
  ...
  assign new_n104_ = new_n105_ & new_n81_ & x04 & x05;
  assign new_n105_ = ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign new_n106_ = ~x11 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  ...
  assign z09 = new_n123_ | (~x17 & (new_n126_ | (~new_n111_ & x18)));
  ...
  assign new_n127_ = x04 & ~x05 & ~x07 & ~x09 & ~x11;
  assign z10 = (~new_n129_ & ~x09) | (x08 & new_n133_ & ~x15);
  assign new_n129_ = x07 ? (~new_n132_ & (x05 | ~new_n125_ | x11)) : new_n130_;
  ...
  assign new_n135_ = ~x15 & ~x11 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n137_ & ~x07) | (new_n124_ & ~x05 & x07 & ~x11));
  ...
  assign new_n144_ = x00 & ~x05 & ~x11 & new_n125_ & x15;
  ...
  assign new_n151_ = (~x07 | ~x15) & (~x04 | x07 | x11 | ~new_n56_ | x15 | x21);
  assign new_n152_ = ~x09 & ((~x01 & x07) | (~x11 & x17 & (x07 | (~x07 & x15))));
  assign z15 = ~x18 & (x11 | (new_n154_ & x05 & ~x11 & ~x15 & x17));
  ...
  assign z17 = ~x09 & ((~new_n163_ & ~x05) | (new_n166_ & new_n81_ & ~x04 & x05));
  assign new_n163_ = (x07 | (~new_n164_ & (~new_n125_ | ~x15 | ~x00 | x11))) & (~x07 | x11 | ~new_n125_ | x15);
  ...
  assign z19 = ~x18 & (x11 | (new_n154_ & ~x05 & ~x11 & ~x15 & x17));
  assign z20 = new_n86_ | (~x07 & ~x17 & (new_n181_ | (~new_n174_ & ~x09)));
  assign new_n174_ = ~new_n178_ & (~x18 | (~new_n175_ & (x05 | ~new_n180_ | x06)));
  assign new_n175_ = ~x21 & (x04 ? (new_n176_ & ~x12) : ~new_n143_);
  assign new_n176_ = ~x15 & (x05 ? x08 : (x08 ? (new_n177_ & x10) : ~x06));
  assign new_n177_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n178_ = new_n179_ & x04 & ~x05 & ~x11 & x12;
  assign new_n179_ = ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n180_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n181_ = new_n66_ & x04 & x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n185_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  assign new_n186_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n80_ | new_n86_;
  ...
  assign new_n194_ = ~x15 & ~x18 & x08 & ~x11;
  ...
  assign new_n202_ = ~new_n86_ & (~new_n203_ | ~new_n81_ | ~x03 | x05);
  assign new_n203_ = new_n82_ & ~x17 & x18 & x19;
  assign new_n204_ = new_n106_ & ~x05;
  assign z28 = (~x17 & (new_n212_ | (~new_n206_ & x18))) | ((new_n214_ | x11) & ~x18);
  ...
  assign new_n212_ = ~x05 & ~x09 & (new_n213_ | (x07 & x15 & ~x18));
  assign new_n213_ = new_n56_ & ~x15 & ~x21 & new_n81_ & x10 & x11;
  assign new_n214_ = ~x09 & x17 & (x05 ? new_n57_ : (x15 & (new_n57_ | ~x19)));
endmodule
