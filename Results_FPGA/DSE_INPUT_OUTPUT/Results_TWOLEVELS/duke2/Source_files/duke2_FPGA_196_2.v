...
module FAU ( 
  ...
  assign new_n71_ = (~x01 | x15 | x18 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18);
  assign new_n72_ = (x02 | (~x06 & (~x15 | x21 | ~x08 | ~x11))) & (x08 | ~x15) & (~x06 | x11);
  assign new_n73_ = x18 & ((~new_n74_ & ~x15) | (~x05 & x15 & (new_n75_ | ~x11)));
  ...
  assign new_n89_ = ~new_n96_ & (x05 | (~new_n60_ & (new_n90_ | x15)));
  ...
  assign new_n96_ = new_n69_ & x04 & ~x12 & ~x15 & ~x21;
  assign z07 = ~x17 & ~new_n98_ & x18;
  assign new_n98_ = (x09 | (~x05 ^ x15) | (x07 ^ x08)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~z13 & ~x20;
  assign z09 = x17 ? ~x18 : (new_n110_ | (x18 & (new_n112_ | (~new_n101_ & ~x07))));
  assign new_n101_ = (x15 | (~new_n108_ & (new_n102_ | x09))) & (new_n109_ | ~x08);
  assign new_n102_ = (x21 | (~new_n103_ & (new_n105_ | x05))) & (~x05 | x08 | x19);
  ...
  assign z10 = ~x17 & ~new_n114_ & x18;
  assign new_n114_ = (x07 | ((x05 | ((~x08 | ~x09 | x15) & (x06 | x08 | x09 | ~x15))) & (~x05 | x06 | x08 | x09 | x15))) & (~x05 | ~x07 | ~x08 | x15);
  ...
  assign new_n122_ = (x11 | ~x15 | ~x05 | ~x08) & (x08 | ~x12 | x15 | x05 | x06);
  assign new_n123_ = x08 & ~x12 & ~x15;
  assign z14 = (~x17 & (new_n110_ | (x08 & ~new_n125_ & x18))) | (~x18 & (new_n128_ | x17));
  ...
  assign new_n156_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & ~new_n158_ & x18;
  assign new_n158_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = x18 & ~x17 & ~x15 & x09 & new_n160_ & x08;
  assign new_n160_ = ~x05 & ~x07;
  assign z24 = (x17 & ~x18) | (~x09 & ~x17 & (new_n162_ | new_n166_));
  assign new_n162_ = ~x07 & (new_n163_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n163_ = ~x21 & ((x04 & ~new_n164_ & ~x15) | (x08 & new_n165_ & x15));
  assign new_n164_ = (~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x05 | ~x12);
  ...
  assign z26 = z13 | (~x20 & (x21 | (~z13 & x14)));
  assign z27 = x17 ? ~x18 : (x18 & (new_n174_ | (~new_n171_ & ~x09)));
  assign new_n171_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n172_ & (~x05 | x08 | x15 | ~x19));
  assign new_n172_ = ~x21 & (new_n173_ | (~new_n122_ & ~x04));
  assign new_n173_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n174_ = new_n160_ & x03 & x08 & x09 & ~x15 & x19;
  assign z28 = (~x17 & ~new_n176_ & x18) | (~x18 & (new_n182_ | x17));
  assign new_n176_ = (~x08 | ((new_n177_ | x05) & (new_n181_ | x07))) & (x05 | x07 | ~new_n180_ | x08);
  assign new_n177_ = ~new_n178_ & (x07 | x09 | ~x10 | ~new_n179_ | ~x12);
  assign new_n178_ = x15 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n179_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n180_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n95_ & x21));
  assign new_n181_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n182_ = ~x05 & x07 & ~x09 & x15 & (~x02 | ~x11);
  assign z19 = 1'b0;
  assign z15 = z13;
endmodule
