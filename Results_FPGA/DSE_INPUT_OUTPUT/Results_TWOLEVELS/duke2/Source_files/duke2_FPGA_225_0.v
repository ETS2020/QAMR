...
module FAU ( 
  ...
  assign z03 = new_n80_ | new_n78_ | (~x09 & (x07 ? ~new_n81_ : ~new_n82_));
  ...
  assign new_n125_ = x10 & (x07 | x09 | ~x10 | x15 | ~x17);
  assign z10 = (~x09 & (x07 ? ~new_n129_ : ~new_n127_)) | (x08 & new_n130_ & x09);
  assign new_n127_ = x05 ? ((~x10 | ~x17 | x18) & (~new_n128_ | x15 | x17 | ~x18)) : ((~x10 | ~x17 | x18) & (~new_n128_ | ~x15 | x17 | ~x18));
  assign new_n128_ = ~x06 & ~x08;
  assign new_n129_ = (x05 | ~x10 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n130_ = ~x15 & ~x17 & x18 & (~x05 ^ x07);
  assign z11 = ~x18 & (new_n132_ | ~x10);
  assign new_n132_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = ~x09 & ((~new_n134_ & ~x07) | (new_n104_ & ~x05 & x07 & x10));
  ...
  assign new_n141_ = x15 & x17 & ~x18 & x00 & ~x05 & x10;
  assign z13 = ~x09 & x10 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~new_n144_ & ~x17) | (~x18 & (~x10 | (new_n150_ & ~x05)));
  assign new_n144_ = (~new_n145_ | ~x08) & (x05 | x09 | ~new_n148_ | ~x10);
  ...
  assign new_n150_ = ~x09 & ((~x01 & x07) | (x10 & x17 & (x07 | (~x07 & x15))));
  assign z15 = new_n152_ & ~x18;
  assign new_n152_ = x17 & ~x15 & x10 & ~x09 & x05 & ~x07;
  ...
  assign z17 = ~x09 & (new_n164_ | (~x05 & (new_n103_ | (~new_n161_ & ~x07))));
  assign new_n161_ = (~new_n102_ | ~x15 | ~x17 | x18) & (x08 | x15 | x17 | ~new_n162_ | ~x18);
  assign new_n162_ = ~new_n163_ & (~x21 | (~x14 & x21));
  assign new_n163_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n164_ = new_n64_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n166_ & x18;
  assign new_n166_ = (x14 | x15 | (~new_n86_ & ~new_n167_)) & (x08 | ~x15 | ~x19);
  ...
  assign new_n171_ = x10 & (x05 | x07 | x09 | ~x10 | x15 | ~x17);
  ...
  assign new_n180_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign z22 = (~x10 & ~x18) | (~x17 & ~new_n184_ & x18);
  assign new_n184_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))))) & (x05 | ~x07 | ~x08 | ~x15);
  ...
  assign new_n190_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x10 | ~x12 | x14 | x18);
  assign new_n191_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n192_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = (~x10 & ~x18) | (~x05 & ~x07 & ~x17 & ~new_n194_ & x18);
  ...
  assign new_n201_ = x10 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n202_ = ~new_n78_ & (~new_n203_ | ~new_n65_ | ~x03 | x05);
  assign new_n203_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n205_ & ~x17) | (~x09 & x10 & new_n213_ & x17);
  assign new_n205_ = (new_n206_ | ~x18) & (x05 | ~new_n212_ | ~x07);
