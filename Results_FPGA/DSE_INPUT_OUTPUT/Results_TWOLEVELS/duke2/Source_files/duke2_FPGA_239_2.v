...
module FAU ( 
  ...
  assign new_n126_ = ~x14 & (x07 | x09 | x15 | ~x17 | (~x05 & (x05 | x14)));
  ...
  assign z12 = new_n79_ | (~x09 & (new_n145_ | (~new_n137_ & ~x07)));
  ...
  assign new_n156_ = ~x14 & (~x05 | x07 | x09 | x15 | ~x17);
  assign z16 = (x14 & ~x18) | (x08 & ~x17 & x18 & (new_n158_ | new_n163_));
  ...
  assign z24 = new_n79_ | (~x09 & ~x17 & (new_n190_ | new_n194_));
  ...
  assign new_n202_ = ~new_n79_ & (~new_n203_ | ~new_n66_ | ~x03 | x05);
  ...
  assign new_n214_ = ~x18 & (x14 | (new_n215_ & ~x09));
  assign new_n215_ = x17 & (x05 ? (~x07 & ~x14) : (x15 & (~x19 | (~x07 & ~x14))));
  assign new_n216_ = ~x09 & ~x14 & x15 & ~x18 & (~x02 | ~x11);
endmodule
