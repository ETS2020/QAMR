...
module FAU ( 
  ...
  assign new_n68_ = (new_n71_ | ~x18) & (x05 | (x15 ? (new_n73_ | ~x18) : new_n69_));
  assign new_n69_ = (~x01 | ~x07 | x18 | (~x08 & ~x16)) & (x07 | new_n70_ | ~x18);
  assign new_n70_ = x06 ? (x02 & x11) : (x04 & x12);
  assign new_n71_ = (~x05 | (x07 ? (~x08 | x15) : new_n72_)) & (x07 | ~x08 | ~x15 | ~x21);
  assign new_n72_ = (x15 | (x08 & (~x04 | ~x08 | x12 | x21))) & (~x08 | (~x21 & (x04 | x11 | ~x15 | x21)));
  assign new_n73_ = x08 ? (~x07 & (x02 | x07 | ~x11 | x21)) : x07;
  assign new_n74_ = ~new_n75_ & (x05 | (x15 ? x11 : x07)) & (x04 | ~x05 | x15);
  assign new_n75_ = x09 & (x05 ? (~x15 & (x07 | ~x12)) : (x15 & (~x02 | x07)));
  assign z03 = (~new_n77_ & ~x09) | (x18 & (x17 | (new_n78_ & x09 & ~x15 & ~x17)));
  ...
  assign z06 = new_n80_ | (~x09 & (new_n98_ | (~new_n90_ & ~x05)));
  ...
  assign z07 = x18 & ((~x09 & new_n101_ & ~x17) | x17 | (new_n78_ & new_n102_ & x09));
  ...
  assign new_n105_ = x18 & (new_n114_ | (~x15 & (new_n116_ | (~new_n106_ & ~x09))));
  assign new_n106_ = ~new_n113_ & (x07 | (~new_n112_ & (x21 | (~new_n107_ & ~new_n109_))));
  ...
  assign z12 = new_n80_ | (~x09 & ((~new_n128_ & ~x07) | (new_n119_ & ~x05 & x07)));
  ...
  assign z14 = (~x05 & new_n143_ & ~x09) | (~x17 & (new_n137_ | (~x05 & new_n141_ & ~x09)));
  ...
  assign z17 = new_n80_ | (~x09 & (new_n156_ | (~new_n153_ & ~x05)));
  assign new_n153_ = (~new_n120_ | ~x07 | x15) & (x07 | ((x08 | ~new_n154_ | x15) & (~new_n120_ | ~x00 | ~x15)));
  ...
  assign new_n158_ = (x14 | x15 | (~new_n159_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n159_ = x12 & ((~new_n160_ & ~x06) | (new_n161_ & x06 & x08 & x10));
  assign new_n160_ = (~new_n88_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  ...
  assign z28 = new_n197_ | (~x09 & ((new_n120_ & x05 & ~x07) | (new_n207_ & ~x05)));
  assign new_n197_ = x18 & (~new_n203_ | (x08 & (new_n205_ | (~new_n198_ & ~x05))));
  assign new_n198_ = (new_n199_ | x17) & (x07 | x09 | ~new_n202_ | ~x10);
  ...
  assign new_n204_ = (~x15 | x19) & (x14 | x15 | new_n97_ | ~x21);
  assign new_n205_ = ~x07 & (new_n206_ | (~x09 & x15 & ~x17 & x21));
  assign new_n206_ = ~x04 & x05 & x12 & ~x15 & (x09 | ~x21);
  assign new_n207_ = ~new_n208_ & x15;
