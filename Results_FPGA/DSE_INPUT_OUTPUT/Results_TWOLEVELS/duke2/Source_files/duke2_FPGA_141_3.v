...
module FAU ( 
  ...
  assign z06 = (~x09 & (new_n99_ | (~new_n90_ & ~x05))) | (x17 & x18);
  ...
  assign z07 = x18 & ((~x09 & new_n102_ & ~x17) | x17 | (new_n79_ & new_n104_ & x09));
  ...
  assign new_n109_ = (x05 | x06 | x08 | x17) & (~new_n110_ | ~x02 | ~x08);
  assign new_n110_ = x13 & ~x14;
  assign new_n111_ = ~x05 & (new_n114_ | (~x17 & (new_n112_ | new_n113_)));
  assign new_n112_ = x02 & x08 & ~x10 & x13 & ~x14;
  assign new_n113_ = ~x08 & x11 & ~x02 & x06;
  ...
  assign z14 = (~x17 & (new_n139_ | (~x05 & new_n142_ & ~x09))) | (~x05 & new_n144_ & ~x09);
  assign new_n139_ = x08 & ~new_n140_ & x18;
  assign new_n140_ = x07 ? (new_n103_ | x19) : (new_n141_ | (~x09 & (x09 | x21)));
  ...
  assign z17 = ~x09 & (new_n154_ | new_n157_);
  assign new_n154_ = ~x05 & ((~new_n155_ & ~x07) | (x17 & ~x18 & x07 & ~x15));
  ...
  assign z19 = x17 & (x18 | (new_n164_ & ~x09 & ~x15 & ~x18));
  ...
  assign new_n190_ = x07 ? (~x08 | new_n103_ | ~x19) : ~new_n191_;
  assign new_n191_ = ~x17 & (new_n193_ | (~x21 & (new_n192_ | (~new_n134_ & ~x04))));
  ...
  assign z28 = (~new_n205_ & ~x09) | (x18 & (~new_n203_ | (~new_n197_ & x08)));
  assign new_n197_ = (~new_n200_ | x07) & (x05 | ((~new_n198_ | x07) & (~new_n202_ | ~x15)));
  ...
  assign new_n202_ = ~x17 & (x07 | ~x11 | (~x02 & (x09 | (~x07 & ~x09 & x11 & ~x21))));
  assign new_n203_ = ~x17 & (x05 | x07 | x08 | x09 | new_n204_ | x17);
  assign new_n204_ = (~x15 | x19) & (x14 | x15 | new_n98_ | ~x21);
  assign new_n205_ = (x05 | new_n206_ | ~x15) & (~x17 | x18 | ~x05 | x07);
