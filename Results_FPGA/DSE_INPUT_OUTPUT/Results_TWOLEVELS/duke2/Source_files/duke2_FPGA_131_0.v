...
module FAU ( 
  ...
  assign new_n68_ = new_n69_ & (x05 | (x07 ? new_n73_ : (new_n74_ | ~x18)));
  assign new_n69_ = (new_n70_ | x07) & (~x05 | ~x07 | ~x08 | x15 | ~x18);
  ...
  assign new_n81_ = (x05 | ((~x06 | ~x17 | x18) & (x17 | ~x18 | ~x08 | ~x15))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  ...
  assign new_n104_ = new_n65_ & x04 & x05 & new_n105_ & ~x12 & ~x15;
  ...
  assign new_n110_ = ~new_n121_ & (x07 | (~new_n118_ & ((~new_n111_ & ~new_n120_) | x15)));
  ...
  assign new_n122_ = new_n123_ & x04 & ~x05 & x06 & ~x07 & ~x09;
  assign new_n123_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n124_ = x06 & ~x07 & new_n103_ & ~x09;
  assign z10 = (~new_n126_ & ~x09) | new_n78_ | (x08 & new_n129_ & x09);
  assign new_n126_ = x07 ? new_n128_ : new_n127_;
  assign new_n127_ = x05 ? ((~x06 | ~x17 | x18) & (x15 | x17 | x06 | x08)) : ((~x06 | ~x17 | x18) & (~x15 | x17 | ~x18 | x06 | x08));
  assign new_n128_ = (~x05 | ~x08 | x15 | x17 | ~x18) & (x05 | ~x06 | ~x17 | x18);
  assign new_n129_ = ~x15 & ~x17 & x18 & (x05 ^ ~x07);
  assign z11 = ~x18 & (new_n131_ | ~x06);
  assign new_n131_ = ~x09 & ~x15 & ~x17 & x01 & ~x05 & x07;
  assign z12 = ~x09 & ((~new_n133_ & ~x07) | (new_n103_ & ~x05 & x06 & x07));
  ...
  assign z16 = new_n78_ | (x08 & ~x17 & (x05 ? new_n159_ : ~new_n153_));
  ...
  assign new_n161_ = ~new_n102_ & (x07 | (~new_n101_ & (~new_n162_ | x08)));
  assign new_n162_ = ~x15 & ~x17 & x18 & ~new_n61_ & ~new_n163_;
  assign new_n163_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n164_ = new_n105_ & ~x11 & x15;
  ...
  assign new_n183_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (~x08 | x09 | ~x15 | x05 | ~x07);
  ...
  assign z28 = (~new_n205_ & ~x17) | (~x18 & (~x06 | (~x09 & ~new_n213_ & x17)));
  ...
  assign new_n210_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
  assign new_n211_ = (x09 | ~x15 | ~x21) & (x04 | ~x05 | ~x12 | x15 | (~x09 & x21));
  assign new_n212_ = x07 & ~x09 & x15 & ~x18 & (~x02 | ~x11);
  assign new_n213_ = x05 ? (~x06 | x07) : (~x15 | (x19 & (~x06 | x07)));
endmodule
