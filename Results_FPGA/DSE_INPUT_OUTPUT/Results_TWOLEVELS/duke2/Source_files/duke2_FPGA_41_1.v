...
module FAU ( 
  ...
  assign new_n68_ = (x15 | (new_n69_ & (new_n75_ | x05))) & (new_n72_ | ~x18);
  assign new_n69_ = (new_n70_ | x07) & (~x05 | ~x07 | ~x08 | ~x18 | ~x19);
  assign new_n70_ = ~new_n71_ & (~x21 | (x06 ? x02 : x12));
  assign new_n71_ = x18 & ((~x04 & ~x06) | (x05 & ~x08));
  assign new_n72_ = (new_n73_ | x07) & (~x08 | ~x15 | ~x19 | x05 | ~x07);
  ...
  assign new_n82_ = new_n83_ & ~x17 & x18 & new_n65_ & ~x05;
  ...
  assign new_n96_ = ~x07 & (new_n103_ | (~x17 & x18 & (new_n97_ | new_n102_)));
  assign new_n97_ = ~x15 & ((new_n76_ & ~x08) | (~x14 & (new_n91_ | ~new_n98_)));
  ...
  assign z16 = (~x18 & x21) | (x08 & ~x17 & x18 & (new_n156_ | new_n161_));
  ...
  assign z17 = new_n80_ | (~x09 & (new_n166_ | (~new_n163_ & ~x05)));
  ...
  assign z24 = new_n80_ | (~x09 & ~x17 & (new_n191_ | new_n195_));
  ...
  assign z28 = (~x17 & (new_n207_ | (new_n215_ & ~x05))) | (~x09 & new_n217_ & x17);
  ...
  assign new_n216_ = ~x09 & x15 & ~x18 & ~x21 & (~x02 | ~x11);
  assign new_n217_ = ~x18 & ~x21 & (x05 ? ~x07 : (x15 & (~x07 | ~x19)));
endmodule
