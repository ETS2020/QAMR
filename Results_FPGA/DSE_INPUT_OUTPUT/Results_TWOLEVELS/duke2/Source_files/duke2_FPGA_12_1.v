...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n70_, new_n73_, new_n74_, new_n78_, new_n80_, new_n81_, new_n84_;
  ...
  assign z24 = ~x17 & (x18 | (~x05 & ~x09 & ~new_n80_ & ~x15));
  assign new_n80_ = (~x01 | ~x07 | ~x08) & (~new_n81_ | ~x04 | x07 | ~x12);
  assign new_n81_ = ~x14 & ~x18 & ~x21;
