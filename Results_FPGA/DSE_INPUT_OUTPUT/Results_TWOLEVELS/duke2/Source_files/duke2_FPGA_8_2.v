...
module FAU ( 
  ...
  assign new_n132_ = ~x15 & ~x10 & ~x09 & x07 & x01 & ~x05;
  ...
  assign z17 = new_n162_ | new_n78_;
  assign new_n162_ = ~x09 & (new_n166_ | (~x05 & (new_n104_ | (~new_n163_ & ~x07))));
  assign new_n163_ = ~new_n103_ & (x08 | x15 | x17 | ~new_n164_ | ~x18);
  ...
  assign z18 = new_n78_ | (~x05 & ~x07 & ~x09 & new_n168_ & ~x17);
  assign new_n168_ = x18 & ((~x14 & ~new_n169_ & ~x15) | (~x08 & x15 & x19));
  assign new_n169_ = ~new_n87_ & (~x12 | (~new_n171_ & (new_n170_ | x06)));
  assign new_n170_ = (x04 | x08 | ~x21) & (~new_n92_ | ~x08 | ~x10);
  assign new_n171_ = ~x13 & x16 & ~x21 & x06 & x08 & x10;
  assign z19 = new_n173_ & ~x18;
  assign new_n173_ = x17 & ~x15 & ~x10 & ~x09 & ~x05 & ~x07;
  ...
  assign new_n203_ = ~x10 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n204_ = new_n205_ & x03 & ~x05 & ~x07 & x08;
  assign new_n205_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = ((new_n207_ | new_n214_) & ~x17) | (~x09 & ~x10 & new_n216_ & x17);
