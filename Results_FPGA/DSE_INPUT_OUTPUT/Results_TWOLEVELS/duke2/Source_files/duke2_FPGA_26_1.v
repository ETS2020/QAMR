...
module FAU ( 
  ...
  assign z02 = new_n67_ | (~x17 & ((~new_n69_ & ~x09) | (new_n76_ & x08)));
  ...
  assign z05 = new_n67_ | (~x05 & ~x07 & ~x09 & new_n86_ & ~x14);
  ...
  assign new_n124_ = ~x14 & ~x15 & ~x18 & ~x20 & ~x21;
  ...
  assign new_n128_ = x05 ? ((~x17 | x18 | x20) & (~new_n129_ | x15 | x17 | ~x18)) : ((~x15 | ((~x17 | x18 | x20) & (~new_n129_ | x17 | ~x18))) & (x18 | x20 | x15 | ~x17));
  assign new_n129_ = ~x06 & ~x08;
  assign new_n130_ = x05 & x08 & ~x15 & ~x17 & x18 & x19;
  assign new_n131_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = ~x18 & (new_n133_ | x20);
  assign new_n133_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = ~x09 & ((~new_n135_ & ~x07) | (new_n103_ & ~x05 & x07 & ~x15));
  assign new_n135_ = ~new_n142_ & (x17 | ~x18 | x21 | (new_n136_ & ~new_n140_));
  assign new_n136_ = (new_n137_ | x05) & (~x04 | ~x05 | ~x08 | x12 | x15);
  ...
  assign new_n142_ = new_n103_ & x00 & ~x05 & x15;
  ...
  assign new_n149_ = ~x20 & (new_n150_ | (x07 & x15 & (~x02 | ~x11 | (x02 & x11))));
  assign new_n150_ = x04 & ~x07 & x12 & ~x14 & ~x15 & ~x21;
  assign new_n151_ = ~x18 & ~x20 & ((~x01 & x07) | (x17 & (x07 | (~x07 & x15))));
  assign z15 = ~new_n153_ & ~x18;
  assign new_n153_ = ~x20 & (x15 | ~x17 | x20 | ~x05 | x07 | x09);
  assign z16 = (~x18 & x20) | (x08 & ~x17 & x18 & (new_n155_ | new_n160_));
  assign new_n155_ = ~x05 & ((~x07 & ~new_n156_ & ~x15) | (x09 & x15 & (~x02 | x07)));
  assign new_n156_ = x09 ? x19 : (x14 | new_n157_ | x21);
  ...
  assign new_n160_ = x05 & x09 & ~x15 & (x07 | ~x12);
  ...
  assign new_n163_ = ~x17 & x18 & ~new_n61_ & ~new_n164_;
  assign new_n164_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n165_ = new_n66_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  ...
  assign z19 = new_n172_ & ~x20;
  assign new_n172_ = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n181_ | (~new_n174_ & ~x09));
  assign new_n174_ = ~new_n178_ & (~x18 | (~new_n175_ & (x05 | ~new_n180_ | x06)));
  assign new_n175_ = ~x21 & (x04 ? (new_n176_ & ~x12) : ~new_n141_);
  ...
  assign new_n179_ = ~x20 & ~x21 & ~x15 & ~x18;
  assign new_n180_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n181_ = new_n182_ & x04 & x05 & x08;
  assign new_n182_ = x09 & ~x12 & ~x15 & x18;
  assign z21 = (~x18 & x20) | (~x17 & ~new_n184_ & x18);
  assign new_n184_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x09 | x15 | ~x06 | ~x08))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n186_ & ~x07) | (~x05 & new_n187_ & x07));
  assign new_n186_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n187_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n80_ | new_n67_;
  assign z24 = new_n67_ | (~x09 & ~x17 & (new_n190_ | new_n194_));
  assign new_n190_ = ~x07 & (new_n191_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n191_ = ~x21 & ((x04 & ~new_n192_ & ~x15) | (x08 & new_n193_ & x15));
  assign new_n192_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | x20);
  assign new_n193_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n194_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = (~x18 & x20) | (~x05 & ~x07 & ~x17 & ~new_n196_ & x18);
  assign new_n196_ = x08 ? (~x09 | x15) : (x09 | ~x15);
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n204_ | (~x09 & (new_n202_ | (~x17 & ~new_n199_ & x18)));
  assign new_n199_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n200_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n200_ = ~x21 & (new_n140_ | new_n201_);
  assign new_n201_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n202_ = new_n203_ & ~x05;
  assign new_n203_ = x17 & ~x18 & ~x20 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n204_ = new_n205_ & x03 & ~x05 & ~x07 & x08;
  assign new_n205_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = new_n214_ | (~x17 & (new_n207_ | (~x05 & new_n216_ & x07)));
  assign new_n207_ = x18 & ((~new_n208_ & x08) | (~x05 & ~x07 & new_n213_ & ~x08));
  assign new_n208_ = (new_n212_ | x07) & (x05 | ((~new_n209_ | x07) & (new_n211_ | ~x15)));
  assign new_n209_ = ~x09 & x10 & new_n210_ & x12;
  assign new_n210_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n211_ = (x02 | x07 | ~x11 | (~x09 & (x09 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n212_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n213_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n100_ & x21));
  assign new_n214_ = ~x18 & (x20 | (new_n215_ & ~x09));
  assign new_n215_ = x17 & (x05 ? (~x07 & ~x20) : (x15 & (~x19 | (~x07 & ~x20))));
  assign new_n216_ = ~x09 & x15 & ~x18 & ~x20 & (~x02 | ~x11);
endmodule
