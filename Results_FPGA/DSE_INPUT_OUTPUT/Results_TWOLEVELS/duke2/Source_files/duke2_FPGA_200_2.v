...
module FAU ( 
  ...
  assign z07 = new_n69_ | (~x17 & (new_n108_ | new_n109_));
  assign new_n108_ = new_n66_ & ~x05 & x09 & ~x15 & x16;
  assign new_n109_ = ~x09 & x18 & (x05 ^ x15) & (~x07 ^ x08);
  ...
  assign new_n124_ = new_n125_ & new_n57_ & ~x16 & ~x18 & ~x21;
  assign new_n125_ = x04 & ~x05 & ~x07 & ~x09 & x12;
  assign new_n126_ = ~x07 & ~x09 & new_n103_ & ~x15;
  assign z10 = new_n128_ | new_n69_ | (x08 & new_n132_ & ~x15);
  assign new_n128_ = ~x09 & (x07 ? (new_n131_ | (new_n103_ & ~x05)) : ~new_n129_);
  assign new_n129_ = x05 ? ((x16 | ~x17 | x18) & (~new_n130_ | x15 | x17 | ~x18)) : ((~x15 | ((x16 | ~x17 | x18) & (~new_n130_ | x17 | ~x18))) & (~x17 | x18 | x15 | x16));
  ...
  assign new_n134_ = ~x16 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = new_n69_ | (~x09 & (new_n136_ | (new_n103_ & new_n144_)));
  ...
  assign new_n148_ = ~new_n149_ & (~x07 | ~x15 | ((~x02 | ~x11) & (x16 | (x02 & x11))));
  assign new_n149_ = x04 & ~x07 & x12 & new_n57_ & ~x16 & ~x21;
  ...
  assign z19 = ~x18 & x17 & ~x16 & ~x15 & new_n174_ & ~x09;
  ...
  assign new_n181_ = ~x15 & ~x16 & ~x18 & ~x21;
  ...
  assign z28 = ((new_n209_ | new_n216_) & ~x17) | (~x09 & ~x16 & new_n218_ & x17);
