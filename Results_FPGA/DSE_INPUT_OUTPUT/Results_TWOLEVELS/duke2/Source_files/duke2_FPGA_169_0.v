...
module FAU ( 
  ...
  assign new_n81_ = (~x08 | x17 | ~x18 | (~x05 ^ x15)) & (x05 | ~x13 | ~x17 | x18);
  assign new_n82_ = x05 ? ((~x13 | ~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (~x13 | ~x17 | x18);
  ...
  assign new_n102_ = new_n103_ & x07 & x13;
  ...
  assign new_n110_ = ~new_n121_ & (x07 | ((new_n120_ | ~x08) & (new_n111_ | x15)));
  assign new_n111_ = ~new_n119_ & (x09 | (~new_n118_ & ((~new_n112_ & ~new_n115_) | x21)));
  assign new_n112_ = x04 & ~x12 & (new_n114_ | (new_n113_ & ~x05));
  ...
  assign new_n123_ = x13 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n124_ = x13 & (x07 | x09 | ~x13 | x15 | ~x17);
  assign z10 = (~x09 & (x07 ? ~new_n127_ : ~new_n126_)) | (x08 & new_n128_ & x09);
  assign new_n126_ = x05 ? ((~x13 | ~x17 | x18) & (~new_n113_ | x15 | x17 | ~x18)) : ((~x13 | ~x17 | x18) & (~new_n113_ | ~x15 | x17 | ~x18));
  assign new_n127_ = (x05 | ~x13 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n128_ = ~x15 & ~x17 & x18 & (x05 ^ ~x07);
  assign z11 = ~x18 & (new_n130_ | ~x13);
  assign new_n130_ = x01 & ~x05 & x07 & ~x09 & ~x15 & ~x17;
  assign z12 = ~x09 & ((~new_n132_ & ~x07) | (new_n103_ & ~x05 & x07 & x13));
  assign new_n132_ = ~new_n139_ & (x17 | ~x18 | (new_n133_ & ~new_n137_) | x21);
  ...
  assign new_n136_ = ~x02 & x08 & x11 & x15;
  ...
  assign z17 = new_n78_ | (~x09 & (new_n159_ | new_n162_));
  assign new_n159_ = ~x05 & (new_n102_ | (~x07 & (new_n101_ | (new_n160_ & ~x08))));
  assign new_n160_ = ~x15 & ~x17 & x18 & ~new_n61_ & ~new_n161_;
  assign new_n161_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n162_ = new_n65_ & new_n105_ & ~x11 & x15;
  assign z18 = new_n78_ | (~x05 & ~x07 & ~x09 & new_n164_ & ~x17);
  assign new_n164_ = x18 & ((~x14 & ~new_n165_ & ~x15) | (~x08 & x15 & x19));
  assign new_n165_ = ~new_n86_ & (~x12 | (~new_n167_ & (new_n166_ | x06)));
  assign new_n166_ = (~new_n91_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  assign new_n167_ = x06 & x08 & x10 & ~x13 & x16 & ~x21;
  assign z19 = ~new_n169_ & ~x18;
  assign new_n169_ = x13 & (x05 | x07 | x09 | ~x13 | x15 | ~x17);
  ...
  assign new_n175_ = new_n176_ & x04 & ~x05 & x12 & x13;
  ...
  assign new_n188_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | ~x13 | x14 | x18);
  ...
  assign new_n200_ = ~new_n78_ & (~new_n201_ | ~new_n66_ | ~x03 | x05);
  assign new_n201_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n203_ & ~x17) | (~x09 & x13 & new_n211_ & x17);
  ...
  assign new_n208_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
  assign new_n209_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n210_ = ~x09 & x13 & x15 & ~x18 & (~x02 | ~x11);
