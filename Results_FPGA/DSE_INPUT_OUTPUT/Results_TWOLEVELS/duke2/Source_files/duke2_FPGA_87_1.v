...
module FAU ( 
  ...
  assign new_n55_ = x01 & x17 & (x05 ? (~x07 | ~x15) : (x07 ? x15 : (~x15 | (~x00 & x15))));
  assign new_n56_ = x04 & ~x05 & ~x07 & x12;
  assign z01 = x17 ? ~x01 : (new_n64_ | ((new_n58_ | new_n66_) & ~x05));
  ...
  assign new_n68_ = (x05 | (x07 ? new_n74_ : (new_n75_ | ~x18))) & (new_n69_ | ~x18);
  assign new_n69_ = (x07 | (~new_n70_ & new_n73_)) & (~x08 | x15 | ~x05 | ~x07);
  assign new_n70_ = ~x04 & ((new_n71_ & new_n72_) | (~x06 & ~x15));
  ...
  assign new_n82_ = (x05 | ((~x01 | ~x17 | x18) & (x17 | ~x18 | ~x08 | ~x15))) & (~x05 | ~x08 | x15 | x17 | ~x18);
  ...
  assign z06 = ~x09 & (new_n101_ | ((new_n94_ | new_n103_) & ~x05));
  ...
  assign new_n126_ = (x01 | ~x17) & (~x08 | ~x09 | x15 | ~new_n127_ | x17);
  assign new_n127_ = x18 & (x05 ^ ~x07);
  assign new_n128_ = (~x05 | ~x08 | x15 | x17 | ~x18) & (~x01 | x05 | ~x17 | x18);
  assign z11 = ~x18 & ~x17 & ~x15 & ~x09 & new_n130_ & x07;
  assign new_n130_ = x01 & ~x05;
  assign z12 = ~x09 & (x05 ? new_n136_ : ~new_n132_);
  assign new_n132_ = ~new_n103_ & (x07 | x17 | ~new_n133_ | ~x18);
  assign new_n133_ = ~x21 & ((~new_n134_ & ~x15) | (x11 & x15 & ~x02 & x08));
  ...
  assign new_n144_ = ~new_n145_ & (~x07 | (x01 & (~x15 | (x02 & x11 & (~x02 | ~x11)))));
  ...
  assign z16 = (~x01 & x17) | (x08 & ~x17 & x18 & (new_n150_ | new_n155_));
  ...
  assign z17 = (~new_n157_ & ~x09) | (~x01 & x17);
  assign new_n157_ = ~new_n160_ & (x05 | (~new_n103_ & (x07 | ~new_n158_ | x08)));
  ...
  assign z18 = (~x05 & ~x07 & ~x09 & new_n162_ & ~x17) | (~x01 & x17);
  ...
  assign z20 = (~x01 & x17) | (~x07 & ~x17 & (new_n175_ | (~new_n168_ & ~x09)));
  assign new_n168_ = (~new_n117_ | x14 | x15 | x18 | x21) & (new_n169_ | ~x18);
  assign new_n169_ = ~new_n172_ & (x21 | (x04 ? ~new_n170_ : new_n174_));
  ...
  assign new_n175_ = new_n71_ & x04 & ~x15 & x18 & x09 & ~x12;
  ...
  assign z22 = x17 ? ~x01 : (~new_n179_ & x18);
  assign new_n179_ = (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08))))) & (x05 | ~x07 | ~x08 | ~x15);
  assign z23 = new_n80_ | (~x01 & x17);
  assign z24 = (~x01 & x17) | (~x09 & ~x17 & (new_n182_ | new_n186_));
  ...
  assign z27 = (~new_n191_ & ~x09) | new_n194_ | (~x01 & x17);
  assign new_n191_ = x05 ? (x17 | new_n193_ | ~x18) : (~new_n103_ & (x17 | new_n192_ | ~x18));
  assign new_n192_ = (x07 | x08 | x15 | new_n159_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n193_ = (x15 | ~x19 | ~x07 | ~x08) & (x07 | ((x08 | x15 | ~x19) & (~new_n72_ | x04 | ~x08)));
  assign new_n194_ = new_n195_ & x03 & ~x05 & ~x07 & x08;
  assign new_n195_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = x17 ? (~x01 | (new_n205_ & ~x09)) : ~new_n197_;
  assign new_n197_ = (new_n198_ | ~x18) & (~new_n204_ | x05);
  ...
  assign new_n205_ = ~x18 & ((x01 & ~x07 & (x05 | (~x05 & x15))) | (~x05 & x15 & ~x19));
endmodule
