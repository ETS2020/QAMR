...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n59_, new_n61_, new_n66_, new_n69_,
    new_n70_, new_n72_, new_n74_, new_n75_, new_n76_, new_n80_, new_n81_,
    new_n83_, new_n84_, new_n88_;
  assign z00 = z16 | (~new_n54_ & ~x09);
  assign new_n54_ = (~new_n55_ | ~x17) & (~new_n56_ | x14 | x15 | x17 | x21);
  assign new_n55_ = ~x18 & (x05 ? (~x07 | ~x15) : (x07 ? x15 : (~x15 | (~x00 & x15))));
  assign new_n56_ = x04 & ~x05 & ~x07 & x12;
  assign z16 = ~x17 & x18;
  assign z01 = ~x18 & new_n59_ & ~x17;
  assign new_n59_ = x15 & x11 & ~x09 & x07 & x02 & ~x05;
  ...
  assign z09 = z16 | (~x07 & ~x09 & ~new_n69_ & ~x15);
  assign new_n69_ = x05 ? (~x17 | x18) : ((~x17 | x18) & (~new_n70_ | x14 | x17 | x21));
  ...
  assign new_n74_ = ~x15 & (new_n75_ | (x07 & x17 & ~x18));
  assign new_n75_ = ~x14 & ~x17 & ~x21 & x04 & ~x07 & x12;
  assign new_n76_ = (~x15 | (~x17 & (~x07 | x17 | (x02 & x11 & (~x02 | ~x11))))) & (x01 | ~x07);
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z19 = (~x17 & x18) | (~x05 & ~x07 & ~x09 & ~x15 & x17 & ~x18);
  assign z20 = ~new_n80_ & ~x17;
  assign new_n80_ = ~x18 & (~new_n81_ | ~x04 | x05 | x07 | x09);
  assign new_n81_ = ~x15 & ~x21 & x12 & ~x14;
  assign z24 = ~x17 & (x18 | (~x05 & ~x09 & ~new_n83_ & ~x15));
  assign new_n83_ = (~x01 | ~x07 | ~x08 | x18) & (~new_n84_ | ~x04 | x07);
