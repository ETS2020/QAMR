...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n170_, new_n173_, new_n174_, new_n176_, new_n179_, new_n180_,
  ...
  assign new_n65_ = (new_n66_ | x05) & (new_n69_ | ~x05) & (~x08 | ~x15 | ~x21);
  assign new_n66_ = (new_n67_ | x02) & (new_n68_ | x15) & (x08 | ~x15 | ~x18);
  assign new_n67_ = (~x06 | x15) & (~x15 | ~x18 | x21 | ~x08 | ~x11);
  assign new_n68_ = x06 ? x11 : (x04 & x12);
  assign new_n69_ = x08 ? (~x21 & (x04 | x11 | ~x15 | ~x18 | x21)) : (x15 | ~x18);
  assign new_n70_ = ~x15 & (~x05 | (~x04 & x05 & x12 & (x09 | ~x21)));
  assign new_n71_ = x07 & x18 & (~x05 ^ ~x15) & (x09 | ~x19 | (~x09 & x19));
  ...
  assign z09 = (new_n116_ & ~x07) | (~x17 & (new_n102_ | ~x18 | (new_n114_ & ~x07)));
  assign new_n102_ = ~x15 & (new_n111_ | (~x07 & (new_n113_ | (~new_n103_ & ~x09))));
  assign new_n103_ = ~new_n110_ & (x21 | ((new_n106_ | x05) & (~new_n104_ | ~x04)));
  ...
  assign new_n110_ = x18 & ~x19 & x05 & ~x08;
  assign new_n111_ = new_n112_ & x05;
  assign new_n112_ = x08 & (~x12 | (x07 & x18 & (x09 | ~x19 | (~x09 & x19))));
  ...
  assign new_n116_ = ~x09 & new_n95_ & ~x15;
  ...
  assign new_n125_ = ~new_n127_ & (x15 | (x08 ? (~new_n89_ | x14) : new_n126_));
  ...
  assign new_n132_ = (~x15 | (x07 ? (~new_n135_ & (~new_n95_ | x09)) : (~new_n133_ & (~new_n95_ | x09)))) & (~x07 | x09 | ~new_n95_ | x15);
  ...
  assign new_n140_ = (x07 | new_n141_ | x15) & (~x09 | ~x15 | (x02 & (~x07 | ~x18)));
  assign new_n141_ = x09 ? x19 : (x14 | new_n142_ | x21);
  assign new_n142_ = (~x06 | (~new_n143_ & ~new_n144_)) & (~new_n145_ | x06) & (~new_n89_ | ~x18);
  ...
  assign new_n148_ = (new_n149_ | x05) & (~new_n152_ | x07 | ~x08 | x04 | ~x05);
  assign new_n149_ = (~new_n95_ | ~x07 | x15) & (x07 | ((x08 | ~new_n150_ | x15) & (~new_n95_ | ~x00 | ~x15)));
  assign new_n150_ = ~x17 & ~new_n58_ & ~new_n151_ & x18;
  assign new_n151_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n152_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n154_ & x18;
  assign new_n154_ = (x14 | (~new_n155_ & ~new_n79_) | x15) & (x08 | ~x15 | ~x19);
  assign new_n155_ = x12 & ((~new_n156_ & ~x06) | (new_n157_ & x06 & x08 & x10));
  assign new_n156_ = (x04 | x08 | ~x21) & (~new_n84_ | ~x08 | ~x10);
  assign new_n157_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x05 & ~x07 & ~x09;
  assign z20 = ~x17 & (~x18 | (~x07 & (new_n165_ | (~x09 & ~new_n160_ & x18))));
  assign new_n160_ = ~new_n161_ & (x05 | ~new_n164_ | x06);
  assign new_n161_ = ~x21 & (x04 ? (new_n162_ & ~x12) : ~new_n128_);
  ...
  assign new_n165_ = x04 & x05 & x08 & x09 & ~x12 & ~x15;
  ...
  assign z28 = (new_n194_ & ~x09) | (~x17 & (~new_n192_ | (~new_n186_ & x08)));
  assign new_n186_ = (new_n191_ | x07) & (x05 | ((~new_n189_ | x07) & (new_n187_ | ~x15)));
  assign new_n187_ = ~new_n188_ & x11 & (~x07 | ~x18 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n188_ = ~x02 & (x09 | (x11 & x18 & ~x21 & ~x07 & ~x09));
  ...
  assign new_n193_ = (~x15 | x19) & (x14 | x15 | new_n92_ | ~x21);
