...
module FAU ( 
  ...
  assign z02 = (~new_n69_ & ~x17) | (x18 & ((~new_n80_ & x08) | new_n78_ | x17));
  assign new_n69_ = ~new_n70_ & (~x08 | ~x18 | (x05 ? ~new_n76_ : ~new_n77_));
  assign new_n70_ = ~x09 & ((~new_n71_ & ~x05) | (x18 & (new_n74_ | (~new_n75_ & x05))));
  ...
  assign new_n74_ = new_n66_ & x15 & x21;
  assign new_n75_ = (~x08 | ((~x07 | x15) & (x04 | x07 | x11 | ~x15 | x21))) & (x07 | x08 | x15);
  assign new_n76_ = ~x15 & ((x07 & x09) | (~x04 & ~x07 & x12 & (x09 | ~x21)));
  assign new_n77_ = x15 & (~x11 | (x09 & (~x02 | x07)));
  assign new_n78_ = ~x05 & ~x07 & new_n79_ & ~x09;
  assign new_n79_ = ~x15 & (x06 ? (~x02 | ~x11) : (~x04 | ~x12));
  assign new_n80_ = x05 ? ((x12 | x15) & (x07 | x09 | ~x21)) : (x07 | x15);
  assign z03 = (~new_n83_ & ~x09) | (x18 & (x17 | (new_n82_ & x09 & ~x15 & ~x17)));
  ...
  assign z06 = ~x09 & ((~new_n95_ & ~x05) | (new_n103_ & new_n66_ & x04 & x05));
  ...
  assign z09 = (x18 & (~new_n121_ | (~new_n108_ & ~x07))) | (new_n119_ & ~x07);
  assign new_n108_ = ~new_n116_ & (x15 | ((new_n109_ | x09) & (~new_n118_ | x04)));
  ...
  assign new_n119_ = ~x09 & ~x15 & (x05 ? x17 : new_n120_);
  assign new_n120_ = ~x18 & (x17 | (x04 & x12 & ~x14 & ~x17 & ~x21));
  assign new_n121_ = ~x17 & (~x05 | ~x08 | x15 | (x12 & (~x07 | x17)));
  assign z10 = (~new_n125_ & x18) | (~x09 & (x07 ? ~new_n124_ : ~new_n123_));
  assign new_n123_ = x05 ? ((~x17 | x18) & (x06 | x08 | x15 | ~x18)) : (x15 ? ((~x17 | x18) & (x06 | x08 | x17 | ~x18)) : (~x17 | x18));
  assign new_n124_ = (x05 | ~x17 | x18) & (~x05 | ~x08 | x15 | x17 | ~x18);
  assign new_n125_ = ~x17 & (~x08 | ~x09 | x15 | x17 | (~x05 ^ ~x07));
  assign z11 = (x17 & x18) | (~x09 & ~x15 & ~x17 & ~x18 & new_n127_ & x01);
  assign new_n127_ = ~x05 & x07;
  assign z12 = new_n85_ | (~x09 & ((~new_n129_ & ~x07) | (new_n136_ & ~x05 & x07)));
  ...
  assign new_n151_ = (~x06 | (~new_n152_ & (~x12 | new_n153_ | x16))) & ~new_n98_ & (x06 | ~x12 | new_n153_ | ~x16);
  assign new_n152_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n153_ = x13 & (x02 | ~x11);
  assign new_n154_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = new_n85_ | (~x09 & (new_n159_ | (~new_n156_ & ~x05)));
  assign new_n156_ = (~new_n137_ | ~x07 | x15) & (x07 | ((~new_n137_ | ~x00 | ~x15) & (x08 | ~new_n157_ | x15)));
  assign new_n157_ = ~x17 & x18 & ~new_n60_ & ~new_n158_;
  ...
  assign new_n161_ = (x14 | x15 | (~new_n88_ & ~new_n162_)) & (x08 | ~x15 | ~x19);
  ...
  assign z19 = x17 & (x18 | (new_n166_ & ~x09 & ~x15 & ~x18));
  ...
  assign new_n169_ = ~x21 & (x04 ? (new_n170_ & ~x12) : ~new_n134_);
  ...
  assign z24 = new_n85_ | (~x09 & (new_n187_ | (~new_n183_ & ~x07)));
  assign new_n183_ = (~new_n184_ | x17) & (x05 | x08 | x15 | ~x18);
  ...
  assign new_n187_ = new_n127_ & x01 & ~x17 & ~x18 & x08 & ~x15;
  assign z25 = ~new_n189_ & x18;
  assign new_n189_ = ~x17 & (x05 | x07 | x17 | (x08 ? (~x09 | x15) : (x09 | ~x15)));
  assign z26 = new_n85_ | (~x20 & (x21 | (~new_n85_ & x14)));
  assign z27 = (~x09 & (new_n197_ | (~new_n192_ & x18))) | (x18 & (new_n196_ | x17));
  assign new_n192_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : ~new_n193_;
  assign new_n193_ = ~x17 & (new_n195_ | (~x21 & (new_n194_ | (~new_n134_ & ~x04))));
  assign new_n194_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n195_ = x05 & ~x08 & ~x15 & x19;
  assign new_n196_ = new_n166_ & x03 & x08 & x09 & ~x15 & x19;
  ...
  assign new_n203_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n102_ & x21));
