// Benchmark "FAU" written by ABC on Fri Aug 21 19:41:12 2020
...
module FAU ( 
  ...
  assign z2 = ((~x06 | x12) & (new_n31_ | ~x05)) | (~new_n29_ & x03) | (x06 & ~x12) | (~x03 & ~x06);
  assign new_n29_ = (~x02 | ~x04 | x08 | x10 | new_n30_ | x11) & (~x11 | (~x08 & ~x10 & x02 & x04));
  assign new_n30_ = ~x12 & (x06 | x12);
  assign new_n31_ = x02 & x03 & x04 & x09 & x13;
  assign z3 = (~new_n24_ & (~x05 | new_n31_ | (~x03 & ~x07))) | (~new_n33_ & x03);
  assign new_n33_ = (~x02 | ~x04 | new_n34_ | x08) & (~x12 | (x02 & x04 & ~x08));
  assign new_n34_ = x10 ? ~x12 : ((~x11 | ~x12) & (x06 | x11 | x12));
