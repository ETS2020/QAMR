...
module FAU ( 
  ...
  assign new_n22_ = (~x02 | ~x04 | ~x13 | (x08 & ~x09)) & (~x08 | (x02 & x04));
  ...
  assign new_n26_ = (~x02 | ~x04 | (~x09 & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x10));
  assign new_n27_ = x08 & (~x05 | (~x03 & ~x06) | (x03 & x11));
  assign z3 = new_n31_ | (x13 & ((~new_n29_ & x03) | ~x05 | (~x03 & ~x07)));
  assign new_n29_ = (~x02 | new_n30_ | ~x04) & (~x12 | (~x10 & ~x11 & x02 & x04));
  assign new_n30_ = ~x09 & (x08 | x10 | x11 | x12);
