...
module FAU ( 
  ...
  assign new_n28_ = (~x11 | (new_n29_ & x02 & x04)) & (~x02 | ~x04 | ~x09 | ~x13);
  assign new_n29_ = ~x08 & ~x10;
  assign new_n30_ = x02 & new_n31_ & x03;
  assign new_n31_ = x04 & ~x08 & ~x10 & ~x11 & (x12 | (~x07 & ~x12));
  assign z3 = (~new_n25_ & (~x07 | x12)) | (~x07 & (new_n33_ | ~x03)) | (x03 & ~new_n34_ & x12);
  assign new_n33_ = x02 & x03 & x04 & new_n29_ & ~x11 & ~x12;
