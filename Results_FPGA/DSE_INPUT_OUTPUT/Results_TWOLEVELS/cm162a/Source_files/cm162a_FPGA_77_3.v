...
module FAU ( 
  ...
  assign z2 = ~x05 | (~x06 & (~new_n27_ | (x02 & ~new_n26_ & x04)));
  assign new_n26_ = (x08 | x10 | x11) & (~x03 | ~x09 | ~x13);
  assign new_n27_ = x03 & (~x11 | (~x08 & ~x10 & x02 & x04));
  assign z3 = ~new_n32_ | (x03 & ((new_n29_ & x02) | (~new_n31_ & x12)));
  assign new_n29_ = x04 & (new_n30_ | (~x06 & x09 & x13));
  assign new_n30_ = ~x08 & ~x10 & ~x11 & ~x12;
  assign new_n31_ = x02 & x04 & ~x08 & (x06 | (~x10 & ~x11));
  assign new_n32_ = x05 & ~x06 & (x03 | x07);
