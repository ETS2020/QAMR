...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & x03) | (~x00 & ~x03) | ~x05 | (x05 & ~x09);
  assign new_n22_ = (~x02 | ~x04 | (~new_n23_ & x08)) & (~x08 | (x02 & x04));
  assign new_n23_ = x09 & x13;
  assign z1 = ~x05 | (x09 & (x03 ? ~new_n25_ : ~x01));
  assign new_n25_ = (~x02 | ~x04 | (~x13 & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = (~new_n27_ & x03) | ~x05 | (x05 & ~x09) | (~x03 & ~x06);
  assign new_n27_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~x10));
  assign z3 = ~x05 | (x09 & (x03 ? ~new_n29_ : ~x07));
