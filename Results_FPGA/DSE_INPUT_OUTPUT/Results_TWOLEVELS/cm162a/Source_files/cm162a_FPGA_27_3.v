...
module FAU ( 
  ...
  assign z1 = (~new_n22_ & (~new_n25_ | (~x01 & ~x03))) | (~new_n26_ & x03);
  assign new_n25_ = x05 & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
  assign new_n26_ = (x08 | ((~x10 | (x02 & x04)) & (~x02 | ~x04 | x10))) & (x07 | ~x08 | ~x10);
  assign z2 = (~new_n22_ & ~new_n25_) | new_n28_ | (~new_n29_ & x03) | (~x03 & ~x06);
  assign new_n28_ = x08 & (x07 | (x03 & x11));
  assign new_n29_ = (~x11 | (x02 & x04)) & (x08 | ((~x10 | ~x11) & (~x02 | ~x04 | x10 | x11)));
  assign z3 = (~new_n25_ & (~x07 | ~x08)) | (x08 & (x07 | x12)) | (~x03 & ~x07) | (~new_n31_ & x03);
