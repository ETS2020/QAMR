// Benchmark "FAU" written by ABC on Fri Aug 21 19:39:40 2020
...
module FAU ( 
  ...
  assign new_n26_ = (~x07 | ~x13) & ((~new_n27_ & x03) | ~x05 | (~x01 & ~x03));
  assign new_n27_ = (~x10 | (x02 & x04 & ~x08)) & (~x02 | ~x04 | x08 | x10);
  assign z2 = (~new_n29_ & x03) | (~x05 & (~x07 | ~x13)) | (x07 & x13) | (~x03 & ~x06);
  assign new_n29_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~x10));
  assign z3 = (~new_n31_ & x03) | (~x05 & (~x07 | ~x13)) | (~x03 & ~x07) | (x07 & x13);
