...
module FAU ( 
  ...
  assign z0 = ~x05 | (x03 & ((x02 & x04 & (new_n22_ | ~x08)) | (x08 & (~x02 | ~x04))));
  assign new_n22_ = x09 & x13;
  assign z1 = ~new_n25_ | (new_n24_ & x02);
  assign new_n24_ = x04 & ((~x08 & ~x10) | (x03 & x09 & x13));
  assign new_n25_ = (~x10 | (x02 & x04 & ~x08)) & x05 & (x03 | ~x05);
  assign z2 = ~x05 | (x03 & (new_n28_ | (new_n27_ & x02)));
  assign new_n27_ = x04 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
  assign new_n28_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign z3 = ~x05 | (x03 & (new_n31_ | (x02 & ~new_n30_ & x04)));
