...
module FAU ( 
  ...
  assign new_n24_ = (x00 | (x03 & ~x07)) & (~x03 | ((~x08 | (x02 & x04)) & (~x02 | ~x04 | x08)));
  assign z1 = ~new_n23_ & ((~new_n26_ & x03) | ~x05 | (~x01 & ~x03));
  ...
  assign z3 = (~new_n22_ & (x00 | ~x07)) | (~new_n32_ & x03) | (~x03 & ~x07) | (~x00 & x07);
