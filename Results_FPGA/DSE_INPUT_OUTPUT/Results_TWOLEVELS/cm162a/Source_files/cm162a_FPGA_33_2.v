...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & x03) | (~x00 & ~x03 & x05) | (~x04 & ~x05);
  assign new_n22_ = (x04 | ~x08) & (~x05 | (x02 ? (~x04 | (~new_n23_ & x08)) : ~x08));
  assign new_n23_ = x09 & x13;
  assign z1 = (~new_n25_ & x03) | ~x05 | (~x01 & ~x03);
  assign new_n25_ = (~x02 | ~x04 | ((x08 | x10) & (~new_n23_ | ~x05))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = (x03 & ((~new_n27_ & x05) | (~x04 & x11))) | (~x04 & ~x05) | (~x03 & x05 & ~x06);
