...
module FAU ( 
  ...
  assign z1 = (~new_n25_ & x03) | (~x01 & ~x03) | ~x05 | (x07 & ~x08);
  assign new_n25_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = (~new_n27_ & x03) | ~x05 | (x07 & ~x08) | (~x03 & ~x06);
  ...
  assign new_n30_ = (x08 | (~x07 & (new_n31_ | ~x12))) & x05 & (x03 | x07) & (~x03 | ~x08 | ~x12);
  assign new_n31_ = x02 & x04 & ~x10 & ~x11;
