...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & x03) | (~x00 & ~x03) | ~x05 | (x05 & x07);
  assign new_n22_ = (~x02 | ~x04 | (x08 & (~new_n23_ | x07))) & (~x08 | (x02 & x04));
  ...
  assign z3 = ~x05 | (~x07 & (new_n29_ | ~x03 | (~new_n31_ & x12)));
  assign new_n29_ = x02 & x04 & (new_n30_ | (new_n23_ & x03));
