...
module FAU ( 
  ...
  assign z1 = ((x01 | x07) & (~x05 | (~new_n24_ & x03))) | (~x01 & ~x03 & x07);
  assign new_n24_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = (~new_n26_ & (x01 | x07)) | (~new_n27_ & x03) | (~x01 & ~x07) | (~x03 & ~x06);
  assign new_n26_ = x05 & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
  assign new_n27_ = (~x11 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign z3 = (~new_n26_ & (x01 | x07)) | (~new_n29_ & x03) | (~x07 & (~x01 | ~x03));
