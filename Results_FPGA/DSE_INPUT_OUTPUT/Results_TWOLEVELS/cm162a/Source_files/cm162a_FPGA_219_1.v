...
module FAU ( 
  ...
  assign z2 = (~new_n22_ & ~new_n23_) | new_n28_ | (~new_n29_ & x03) | (~x03 & ~x06);
  assign new_n28_ = x10 & (~x07 | (x03 & x11));
  assign new_n29_ = (~x11 | (x02 & x04 & ~x08)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign z3 = (~new_n23_ & (x07 | ~x10)) | (~x03 & ~x07 & ~x10) | (x03 & ((~new_n31_ & ~x10) | (x07 & x10 & x12)));
  assign new_n31_ = (~x02 | ~x04 | x08 | x11 | x12) & (~x12 | (x02 & x04 & ~x08 & ~x11));
