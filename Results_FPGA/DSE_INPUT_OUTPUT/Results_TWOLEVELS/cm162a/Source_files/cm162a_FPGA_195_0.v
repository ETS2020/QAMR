...
module FAU ( 
  ...
  assign z1 = (~new_n25_ & x03) | (~x01 & ~x03 & x05) | (x02 & ~x05);
  assign new_n25_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10))) & (~x05 | ~x10 | (x02 & x04 & ~x08));
  assign z2 = (x03 & ((new_n27_ & x02) | (new_n28_ & x05))) | (x02 & ~x05) | (~x03 & x05 & ~x06);
  assign new_n27_ = x04 & (new_n23_ | (~x08 & ~x10 & ~x11));
  assign new_n28_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign z3 = (x03 & ((new_n30_ & x02) | (new_n31_ & x05))) | (x02 & ~x05) | (~x03 & x05 & ~x07);
