...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & (~x00 | (x01 & x03))) | (~new_n23_ & (~x00 | x01)) | (~x00 & ~x03);
  ...
  assign z2 = (~new_n23_ & (~x00 | x01)) | (~new_n27_ & x03) | (x00 & ~x01) | (~x03 & ~x06);
  assign new_n27_ = (~x11 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign z3 = (~new_n23_ & (~x00 | x01)) | (~new_n29_ & x03) | (x00 & ~x01) | (~x03 & ~x07);
