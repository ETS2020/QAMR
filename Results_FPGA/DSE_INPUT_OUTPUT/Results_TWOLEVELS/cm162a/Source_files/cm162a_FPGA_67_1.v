...
module FAU ( 
  ...
  assign z1 = (~new_n26_ & x03) | (~new_n22_ & (~new_n23_ | (~x01 & ~x03)));
  assign new_n26_ = (~x07 | ~x10 | (x02 & x04 & ~x08)) & (x08 | x10 | ~x02 | ~x04);
  ...
  assign z3 = (~new_n23_ & (x07 | ~x10)) | (~x07 & (~x03 | x10)) | (~new_n31_ & x03);
