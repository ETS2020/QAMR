// Benchmark "FAU" written by ABC on Fri Aug 21 19:41:13 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = (~new_n22_ & (x01 | x07)) | (~new_n24_ & x03) | (~x01 & ~x07) | (~x00 & ~x03);
  assign new_n22_ = x05 & (~x02 | ~x03 | ~new_n23_ | ~x04);
  assign new_n23_ = x09 & x13;
  assign new_n24_ = (~x08 | (x02 & x04)) & (~x02 | ~x04 | x08);
  assign z1 = ((x01 | x07) & (~x05 | (~new_n26_ & x03))) | (~x01 & ~x03 & x07);
  assign new_n26_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = (x01 | x07) & ((~new_n28_ & x03) | ~x05 | (~x03 & ~x06));
  assign new_n28_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~x10));
  assign z3 = (~new_n30_ & x12) | (~new_n32_ & (x01 | x07)) | (x01 & ~x03 & ~x07);
  assign new_n30_ = (new_n31_ | (x07 ? ~x03 : ~x01)) & (~x03 | (~x10 & ~x11) | (~x01 & ~x07));
  assign new_n31_ = x02 & x04 & ~x08;
  assign new_n32_ = x05 & (~x02 | ~x03 | new_n33_ | ~x04);
