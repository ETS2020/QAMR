...
module FAU ( 
  ...
  assign z2 = ((~x07 | x08) & (~new_n28_ | ~x05)) | (~new_n29_ & x03);
  assign new_n28_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x13) & (x03 | x06);
  assign new_n29_ = (x07 | ((~x11 | (x02 & x04 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11))) & (~x08 | ~x11);
  assign z3 = (~new_n25_ & (~x07 | x08)) | (x03 & x08 & x12) | (~new_n31_ & ~x07);
  assign new_n31_ = (~x12 | (new_n26_ & ~x10 & ~x11)) & x03 & (~new_n32_ | x10 | x11 | x12);
