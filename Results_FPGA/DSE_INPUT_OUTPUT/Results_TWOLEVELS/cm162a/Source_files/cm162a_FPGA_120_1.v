...
module FAU ( 
  ...
  assign z1 = (~new_n27_ & (x02 | ~x07)) | (x03 & (x02 ? ~new_n26_ : (~x07 & x10)));
  assign new_n26_ = (~x04 | (~new_n23_ & (x08 | x10))) & (~x10 | (x04 & ~x08));
  assign new_n27_ = x05 & (x01 | x03);
  assign z2 = (~x02 & (x07 | (x03 & x11))) | ~new_n30_ | (~new_n29_ & x03);
  assign new_n29_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (x04 & ~x08 & ~x10));
  assign new_n30_ = (x05 | (~x02 & x07)) & (x03 | x06);
  assign z3 = (~x02 & (x07 | x12)) | (~new_n32_ & x03) | (~x05 & (x02 | ~x07)) | (~x03 & ~x07);
