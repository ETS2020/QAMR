...
module FAU ( 
  ...
  assign z1 = (~x00 | ~x07) & ((~new_n25_ & x03) | ~x05 | (~x01 & ~x03));
  assign new_n25_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = (~new_n23_ & (~x00 | ~x07)) | (~new_n27_ & x03) | (x00 & x07) | (~x03 & ~x06);
  assign new_n27_ = (~x11 | (~x08 & ~x10 & x02 & x04)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign z3 = (~new_n23_ & (~x00 | ~x07)) | (~new_n29_ & x03) | (x00 & x07) | (~x03 & ~x07);
