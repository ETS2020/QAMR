...
module FAU ( 
  ...
  assign z2 = ((x06 | ~x12) & (~x05 | (~new_n30_ & x03))) | (~x03 & ~x06 & ~x12);
  assign new_n30_ = (~x02 | ~x04 | (~new_n31_ & (x08 | x10 | x11))) & (~x11 | (~x08 & ~x10 & x02 & x04));
  assign new_n31_ = x09 & x13;
  assign z3 = (~new_n33_ & (x06 | ~x12)) | (~new_n34_ & x03) | (~x06 & x12) | (~x03 & ~x07);
  assign new_n33_ = x05 & (~x02 | ~x03 | ~new_n31_ | ~x04);
  assign new_n34_ = (~x12 | (new_n35_ & ~new_n36_)) & (~new_n35_ | x10 | x11 | x12);
  assign new_n35_ = x02 & x04 & ~x08;
