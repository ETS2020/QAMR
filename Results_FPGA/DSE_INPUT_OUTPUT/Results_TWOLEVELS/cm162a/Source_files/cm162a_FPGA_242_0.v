// Benchmark "FAU" written by ABC on Fri Aug 21 19:41:15 2020
...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & (x01 | x07)) | (~new_n23_ & x03) | (~x01 & ~x07) | (~x00 & ~x03);
  ...
  assign z2 = (~new_n22_ & (x01 | x07)) | (~new_n27_ & x03) | (~x01 & ~x07) | (~x03 & ~x06);
  assign new_n27_ = (~x11 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign z3 = (~new_n22_ & (x01 | x07)) | (~new_n29_ & x03) | (~x07 & (~x01 | ~x03));
  assign new_n29_ = (~x12 | (x02 & x04 & ~x08 & ~x10 & ~x11)) & (~x02 | ~x04 | x08 | x10 | x11 | x12);
  assign z4 = (x04 & x09 & x13) | (~x01 & ~x07);
endmodule
