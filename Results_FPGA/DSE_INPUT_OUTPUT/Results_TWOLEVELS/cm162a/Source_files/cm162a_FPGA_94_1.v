...
module FAU ( 
  ...
  assign new_n29_ = (~x07 | ~x10 | ~x11) & (x10 | ((~x11 | (x02 & x04 & ~x08)) & (~x02 | ~x04 | x08 | x11)));
  assign z3 = (~new_n25_ & (x07 | ~x10)) | (~x03 & ~x07 & ~x10) | (x03 & ((~new_n31_ & ~x10) | (x07 & x10 & x12)));
  assign new_n31_ = (~x12 | (~x08 & ~x11 & x02 & x04)) & (~x02 | ~x04 | x08 | x11 | x12);
