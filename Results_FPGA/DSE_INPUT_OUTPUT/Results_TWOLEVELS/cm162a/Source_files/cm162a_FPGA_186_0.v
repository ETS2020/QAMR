...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_;
  assign z0 = (~new_n22_ & x03) | (~x00 & ~x03) | ~x05 | (~x04 & ~x06);
  assign new_n22_ = (~x02 | ~x04 | (x08 & (~x09 | ~x13))) & (~x08 | (x02 & x04));
  assign z1 = (~new_n24_ & x03) | (~x01 & ~x03) | ~x05 | (~x04 & ~x06);
  ...
  assign new_n28_ = x05 & (x06 | (x03 & x04));
  ...
  assign new_n32_ = x05 & (x04 | x06) & (x03 | x07);
