...
module FAU ( 
  ...
  assign z1 = ~x05 | (x02 & (x03 ? ~new_n24_ : ~x01));
  assign new_n24_ = (~x04 | ((x08 | x10) & (~x09 | ~x13))) & (~x10 | (x04 & ~x08));
  assign z2 = ~new_n28_ | (x03 & ((~new_n27_ & x04) | (x11 & (~new_n26_ | ~x04))));
  assign new_n26_ = ~x08 & ~x10;
  assign new_n27_ = (~x02 | ~x09 | ~x13) & (x08 | x10 | x11);
  assign new_n28_ = x02 & x05 & (x03 | x06);
  assign z3 = ~new_n33_ | (x03 & (new_n32_ | (x04 & (new_n30_ | new_n31_))));
  assign new_n30_ = x02 & x09 & x13;
  assign new_n31_ = ~x08 & ~x10 & ~x11 & ~x12;
  assign new_n32_ = x12 & (~x04 | x08 | x10 | x11);
  assign new_n33_ = x02 & x05 & (x03 | x07);
