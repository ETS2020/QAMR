...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n31_, new_n32_, new_n33_, new_n35_, new_n36_;
  ...
  assign z2 = new_n29_ | ~new_n31_ | (~new_n24_ & ~new_n33_);
  assign new_n29_ = x11 & ~new_n30_ & (~x06 | (x03 & x12));
  assign new_n30_ = x02 & x04 & ~x08 & ~x10;
  assign new_n31_ = (x03 | x06) & (~x02 | ~new_n32_ | ~x03);
  assign new_n32_ = x04 & ~x08 & ~x10 & ~x11 & (x12 | (~x06 & ~x12));
  assign new_n33_ = x05 & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
  assign z3 = (~new_n24_ & ~new_n33_) | (~new_n35_ & x03) | new_n24_ | (~x03 & ~x07);
  assign new_n35_ = (~x02 | ~x04 | new_n36_ | x08) & (~x12 | (x02 & x04 & ~x08));
  assign new_n36_ = x10 ? ~x12 : ((~x11 | ~x12) & (x06 | x11 | x12));
