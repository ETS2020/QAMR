...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & x03) | (~x05 & (x04 | ~x09)) | (~x04 & x09) | (~x00 & ~x03);
  assign new_n22_ = (~x02 | ~x04 | (x08 & (~x09 | ~x13))) & (~x08 | (x02 & x04));
  assign z1 = (~new_n24_ & x03) | (~x05 & (x04 | ~x09)) | (~x04 & x09) | (~x01 & ~x03);
  assign new_n24_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = new_n27_ | (x04 & ((~new_n26_ & x03) | ~x05 | (~x03 & ~x06)));
  assign new_n26_ = (~x02 | ((~x09 | ~x13) & (x08 | x10 | x11))) & (~x11 | (x02 & ~x08 & ~x10));
  assign new_n27_ = ~x09 & (~x05 | (~x03 & ~x06) | (x03 & ~x04 & x11));
  ...
  assign new_n31_ = (x05 | (~x04 & x09)) & (x03 | x07) & (x04 | ~x09);
  assign z4 = x09 & (~x04 | x13);
endmodule
