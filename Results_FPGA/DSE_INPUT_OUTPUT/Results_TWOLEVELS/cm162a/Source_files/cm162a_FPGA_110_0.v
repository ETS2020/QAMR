...
module FAU ( 
  ...
  assign z2 = (x03 & ((new_n26_ & x02) | (new_n27_ & x05))) | (x02 & ~x05) | (~x03 & x05 & ~x06);
  assign new_n26_ = x04 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
  assign new_n27_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign z3 = (~new_n29_ & x03) | (x02 & ~x05) | (~x03 & x05 & ~x07);
  assign new_n29_ = ~new_n31_ & (~x02 | ((new_n30_ | ~x04) & (~x11 | ~x12)));
  assign new_n30_ = (~x09 | ~x13) & (x11 | x12 | x08 | x10);
  assign new_n31_ = x05 & x12 & (~x02 | ~x04 | x08 | x10);
