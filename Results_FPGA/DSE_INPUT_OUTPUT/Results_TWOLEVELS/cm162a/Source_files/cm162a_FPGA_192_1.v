...
module FAU ( 
  ...
  assign z1 = (~new_n24_ & (~x01 | (x00 & x03))) | (~x01 & ~x03) | (~new_n25_ & (x00 | ~x01));
  assign new_n24_ = (~x10 | (x02 & x04 & ~x08)) & (x08 | x10 | ~x02 | ~x04);
  assign new_n25_ = x05 & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
  assign z2 = (~new_n25_ & (x00 | ~x01)) | (~new_n27_ & x03) | (~x00 & x01) | (~x03 & ~x06);
  assign new_n27_ = (~x11 | (~x08 & ~x10 & x02 & x04)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign z3 = (~new_n25_ & (x00 | ~x01)) | (~new_n29_ & x03) | (~x00 & x01) | (~x03 & ~x07);
