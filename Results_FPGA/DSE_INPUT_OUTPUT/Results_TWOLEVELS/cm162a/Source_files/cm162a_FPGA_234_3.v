...
module FAU ( 
  ...
  assign z2 = (~new_n30_ & (~x06 | ~x12)) | (new_n32_ & x03) | (x06 & x12) | (~x03 & ~x06);
  assign new_n30_ = x05 & (~x02 | ~new_n31_ | ~x03);
  assign new_n31_ = x04 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
  assign new_n32_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign z3 = (~new_n34_ & x03) | ((~x06 | ~x12) & (~new_n36_ | ~x05));
  assign new_n34_ = (~x02 | ~x04 | new_n35_ | x08) & (x06 | ~x12 | (x02 & x04 & ~x08));
  assign new_n35_ = (x06 | ~x12 | (~x10 & (x10 | ~x11))) & (x10 | x11 | x12);
  assign new_n36_ = (x03 | x07) & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
  assign z4 = (x06 & x12) | (x04 & x09 & x13);
endmodule
