// Benchmark "FAU" written by ABC on Fri Aug 21 19:40:52 2020
...
module FAU ( 
  ...
  assign new_n30_ = ~x02 & (~x05 | (x03 & x11) | (~x03 & ~x06));
  assign z3 = (~x02 & (~x05 | (x03 & x12))) | ~new_n34_ | (~new_n32_ & x02);
  assign new_n32_ = ~x07 & (~x04 | (~new_n33_ & (~new_n23_ | ~x03 | x07)));
  assign new_n33_ = ~x08 & ~x10 & ~x11 & ~x12;
  assign new_n34_ = (new_n35_ | ~x12) & (x07 | (x03 & x05));
  assign new_n35_ = (~x03 | (~x10 & ~x11)) & (x07 | (x04 & ~x08));
  assign z4 = x04 & x09 & x13 & (~x02 | ~x07);
endmodule
