...
module FAU ( 
  ...
  assign z1 = new_n25_ | (new_n23_ & x02 & x03 & x04);
  assign new_n25_ = (~x06 | ~x13) & ((~new_n26_ & x03) | ~x05 | (~x01 & ~x03));
  ...
  assign new_n29_ = x04 & x09 & x13 & x02 & x03;
  assign z3 = (~new_n31_ & x03) | (~x05 & (~x06 | ~x13)) | (x06 & x13) | (~x03 & ~x07);
