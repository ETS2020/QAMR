...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = x05 ? (x03 ? ~new_n22_ : ~x00) : ~x01;
  assign new_n22_ = (~x02 | ~x04 | (x08 & (~x09 | ~x13))) & (~x08 | (x02 & x04));
  assign z1 = (~x01 & (~x03 | ~x05)) | (x03 & ~new_n24_ & x05);
  ...
  assign new_n28_ = ~x08 & (~x05 | ~x10);
  assign z3 = (~new_n30_ & x03) | ~x05 | (~x03 & ~x07);
  assign new_n30_ = (~x02 | ~x04 | (~new_n31_ & ~new_n32_)) & (new_n33_ | ~x12);
  assign new_n31_ = x05 & x09 & x13;
  assign new_n32_ = ~x08 & ~x10 & ~x11 & ~x12;
  assign new_n33_ = x02 & x04 & ~x08 & (~x05 | (~x10 & ~x11));
  assign z4 = x04 & x09 & x13 & (~x01 | x05);
endmodule
