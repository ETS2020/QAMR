// Benchmark "FAU" written by ABC on Fri Aug 21 19:40:33 2020
...
module FAU ( 
  ...
  assign z2 = new_n26_ | (~new_n28_ & (x06 | x07)) | (~x03 & ~x06 & x07);
  assign new_n26_ = x11 & ((~new_n27_ & (x06 ? x03 : x07)) | (x03 & x10 & (x06 | x07)));
  assign new_n27_ = x02 & x04 & ~x08;
  assign new_n28_ = x05 & (~x02 | ~x03 | new_n29_ | ~x04);
  assign new_n29_ = (~x09 | ~x13) & (x08 | x10 | x11);
  assign z3 = (~new_n31_ & (x06 | x07)) | (~x07 & (~x03 | ~x06)) | (~new_n32_ & x03);
