...
module FAU ( 
  ...
  assign z2 = (~new_n23_ & (x06 | ~x11)) | (~x11 & (new_n29_ | (~x03 & ~x06))) | (x03 & x06 & ~new_n28_ & x11);
  assign new_n28_ = x02 & x04 & ~x08 & ~x10;
  assign new_n29_ = x02 & x03 & x04 & ~x08 & ~x10;
  assign z3 = (~new_n22_ & ~new_n23_) | new_n31_ | (~x03 & ~x07) | (~new_n32_ & x03);
  assign new_n31_ = x11 & (~x06 | (x03 & x12));
  assign new_n32_ = (~x12 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11 | x12);
