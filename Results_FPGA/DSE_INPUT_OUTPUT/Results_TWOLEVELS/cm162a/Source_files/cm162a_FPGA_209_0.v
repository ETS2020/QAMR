...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_;
  assign z0 = (~new_n22_ & x03) | (~x00 & ~x03 & x05) | (~x05 & x13);
  assign new_n22_ = (~x02 | ~x04 | ((~x05 | x08) & (~x09 | ~x13))) & (~x05 | ~x08 | (x02 & x04));
  assign z1 = (~new_n24_ & x03) | ~x05 | (~x01 & ~x03);
  assign new_n24_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08));
  assign z2 = (~new_n26_ & x03) | (~x05 & x13) | (~x03 & x05 & ~x06);
  assign new_n26_ = (~x02 | new_n28_ | ~x04) & (~x05 | ~x11 | (new_n27_ & x02 & x04));
  assign new_n27_ = ~x08 & ~x10;
  assign new_n28_ = (~x09 | ~x13) & (~x05 | x08 | x10 | x11);
