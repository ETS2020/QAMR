...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n32_;
  assign z0 = (~new_n22_ & (~x06 | x11)) | (~new_n23_ & x03) | (x06 & ~x11) | (~x00 & ~x03);
  assign new_n22_ = x05 & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
  assign new_n23_ = (~x08 | (x02 & x04)) & (~x02 | ~x04 | x08);
  assign z1 = (~new_n22_ & (~x06 | x11)) | (~new_n25_ & x03) | (x06 & ~x11) | (~x01 & ~x03);
  assign new_n25_ = (~x10 | (x02 & x04 & ~x08)) & (x08 | x10 | ~x02 | ~x04);
  assign z2 = new_n27_ | (~x06 & (new_n28_ | ~x03)) | (new_n29_ & x03);
  assign new_n27_ = ~new_n22_ & (~x06 | x11);
  assign new_n28_ = x02 & x04 & ~x08 & ~x10 & ~x11;
  assign new_n29_ = x11 & (x08 | x10 | ~x02 | ~x04);
  assign z3 = new_n27_ | ~new_n31_ | (~x11 & (new_n32_ | x06));
  assign new_n31_ = x03 ? (new_n28_ | ~x12) : x07;
