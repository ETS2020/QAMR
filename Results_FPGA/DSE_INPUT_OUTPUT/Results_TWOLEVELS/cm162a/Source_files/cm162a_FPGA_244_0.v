...
module FAU ( 
  ...
  assign z2 = new_n30_ | (~new_n22_ & ((~new_n28_ & x03) | ~x05 | (~x03 & ~x06)));
  assign new_n28_ = (~x11 | (new_n29_ & ~x08 & ~x10)) & (~new_n29_ | ~x09 | ~x13);
  assign new_n29_ = x02 & x04;
  assign new_n30_ = x02 & new_n31_ & x03;
  assign new_n31_ = x04 & ~x08 & ~x10 & ~x11 & (x12 | (x07 & ~x12));
  assign z3 = (~new_n23_ & (x07 | x12)) | (~new_n33_ & x03) | (~x03 & ~x07 & x12);
  assign new_n33_ = (~x12 | (new_n29_ & ~x08 & ~x10 & ~x11)) & (~new_n34_ | x08 | x10 | x11 | x12);
  assign new_n34_ = x02 & x04 & x07;
