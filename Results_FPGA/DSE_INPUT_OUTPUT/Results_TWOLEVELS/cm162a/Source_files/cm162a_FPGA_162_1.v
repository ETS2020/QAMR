...
module FAU ( 
  ...
  assign z3 = new_n30_ | ~new_n34_ | (~new_n33_ & (x07 | ~x13));
  assign new_n30_ = x12 & ((~new_n31_ & (x07 ? x03 : ~x13)) | (x03 & ~new_n32_ & (x07 | ~x13)));
  assign new_n31_ = x02 & x04 & ~x08;
  assign new_n32_ = ~x10 & ~x11;
  assign new_n33_ = x05 & (~new_n23_ | x11 | x12 | x08 | x10);
  assign new_n34_ = (~new_n23_ | ~new_n26_) & (x03 | x07 | x13);
