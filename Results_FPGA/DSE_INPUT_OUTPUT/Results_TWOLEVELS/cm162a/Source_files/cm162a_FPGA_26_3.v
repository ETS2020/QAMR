...
module FAU ( 
  ...
  assign z2 = (~x05 & (~x09 | ~x11)) | (~new_n29_ & x03) | (x09 & x11) | (~x03 & ~x06);
  assign new_n29_ = (~x02 | new_n30_ | ~x04) & (~x11 | (x02 & x04 & ~x08));
  assign new_n30_ = (~x09 | x11 | ~x13) & (x08 | ((x09 | ~x10 | ~x11) & (x10 | x11)));
  assign z3 = new_n34_ | (~x11 & ((~new_n32_ & x03) | ~x05 | (~x03 & ~x07)));
  assign new_n32_ = (~x02 | ~x04 | (~new_n33_ & (x08 | x10 | x12))) & (~x12 | (x02 & x04 & ~x08 & ~x10));
  assign new_n33_ = x09 & x13;
  assign new_n34_ = ~x09 & (~x05 | (~x03 & ~x07) | (x03 & x11 & x12));
