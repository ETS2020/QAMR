...
module FAU ( 
  ...
  assign z1 = (~new_n26_ & (~x01 | (x03 & x07))) | (~x01 & ~x03) | (~new_n22_ & (~x01 | x07));
  ...
  assign z3 = (x12 & ~new_n32_ & (x07 ? x03 : ~x01)) | (~new_n30_ & (~x01 | x07)) | (~x01 & ~x03 & ~x07);
  assign new_n30_ = x05 & (~x02 | ~x03 | new_n31_ | ~x04);
  assign new_n31_ = (~x09 | ~x13) & (x11 | x12 | x08 | x10);
  assign new_n32_ = x02 & x04 & ~x08 & ~x10 & ~x11;
  assign z4 = (new_n23_ & x04) | (x01 & ~x07);
endmodule
