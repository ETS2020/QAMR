...
module FAU ( 
  ...
  assign new_n28_ = (~x07 | ((~x11 | (x02 & x04 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x11))) & (~x08 | ~x11);
  assign z3 = (~new_n24_ & (x07 | x08)) | (x08 & (x03 ? x12 : ~x07)) | (x03 & ~new_n30_ & x07);
  assign new_n30_ = (~x12 | (x02 & x04 & ~x10 & ~x11)) & (x10 | x11 | x12 | ~x02 | ~x04 | x08);
