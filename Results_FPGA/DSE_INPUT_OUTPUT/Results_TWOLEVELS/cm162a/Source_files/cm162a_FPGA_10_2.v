...
module FAU ( 
  ...
  assign z2 = ~new_n30_ | (x03 & (new_n29_ | (new_n28_ & x02)));
  assign new_n28_ = x04 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
  assign new_n29_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign new_n30_ = (x05 | (x07 & ~x13)) & (x03 | x06) & (~x07 | x13);
  assign z3 = ~new_n34_ | (x03 & (new_n33_ | (x02 & ~new_n32_ & x04)));
  assign new_n32_ = (~x09 | ~x13) & (x08 | x10 | x11 | x12);
  assign new_n33_ = x12 & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n34_ = (x05 | (x07 & ~x13)) & (x03 | x07) & (~x07 | x13);
