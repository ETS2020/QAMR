...
module FAU ( 
  ...
  assign z1 = (~new_n22_ & (x01 | ~x06)) | (~x01 & (~x03 | x06)) | (~new_n25_ & x03);
  assign new_n25_ = (~x10 | (x02 & x04 & ~x08)) & (~x02 | ~x04 | x08 | x10);
  assign z2 = (~new_n27_ & (~x06 | (x01 & x03))) | ((x01 | ~x06) & (~x05 | (~new_n28_ & x03))) | (~x03 & ~x06);
  assign new_n27_ = (~x11 | (x02 & x04 & ~x08)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign new_n28_ = (~x10 | ~x11) & (~x02 | ~x04 | ~x09 | ~x13);
  assign z3 = (~new_n22_ & (x01 | ~x06)) | (~new_n30_ & x03) | (~x01 & x06) | (~x03 & ~x07);
