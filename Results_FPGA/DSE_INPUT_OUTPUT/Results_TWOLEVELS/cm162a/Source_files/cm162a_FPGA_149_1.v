...
module FAU ( 
  ...
  assign z2 = (~new_n23_ & (x06 | ~x10)) | (x03 & ((~new_n28_ & ~x10) | (x06 & x10 & x11))) | (~x03 & ~x06 & ~x10);
  assign new_n28_ = (~x11 | (x02 & x04 & ~x08)) & (~x02 | ~x04 | x08 | x11);
  assign z3 = (~new_n22_ & ~new_n23_) | new_n30_ | (~new_n31_ & x03) | (~x03 & ~x07);
  assign new_n30_ = x10 & (~x06 | (x03 & x12));
  assign new_n31_ = (~x12 | (x02 & x04 & ~x08 & ~x11)) & (~x02 | ~x04 | x08 | x10 | x11 | x12);
