...
module FAU ( 
  ...
  assign z2 = (~new_n26_ & x03) | (x04 & ~x05) | (~x03 & x05 & ~x06);
  assign new_n26_ = (~x02 | new_n28_ | ~x04) & (~x05 | ~x11 | (new_n27_ & x02 & x04));
  assign new_n27_ = ~x08 & ~x10;
  assign new_n28_ = (~x09 | ~x13) & (x08 | x10 | x11);
  assign z3 = (~new_n30_ & x03) | (x04 & ~x05) | (~x03 & x05 & ~x07);
  assign new_n30_ = ~new_n32_ & (~x04 | ((new_n31_ | ~x02) & (~x11 | ~x12)));
  assign new_n31_ = (~x09 | ~x13) & (x08 | x10 | x11 | x12);
  assign new_n32_ = x05 & x12 & (~x02 | ~x04 | x08 | x10);
