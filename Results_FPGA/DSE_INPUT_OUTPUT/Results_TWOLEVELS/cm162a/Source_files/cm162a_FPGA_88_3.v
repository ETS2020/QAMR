// Benchmark "FAU" written by ABC on Fri Aug 21 19:40:12 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_;
  assign z0 = (~new_n22_ & ~new_n23_) | (~new_n24_ & x03) | new_n23_ | (~x00 & ~x03);
  assign new_n22_ = x05 & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
  assign new_n23_ = x01 & x07;
  ...
  assign z2 = ~new_n23_ & (~new_n30_ | (x03 & (new_n29_ | (new_n28_ & x02))));
  assign new_n28_ = x04 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
  assign new_n29_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign new_n30_ = x05 & (x03 | x06);
  assign z3 = (~new_n32_ & (~x07 | (~x01 & x03))) | (~x03 & ~x07) | (~new_n22_ & (~x01 | ~x07));
