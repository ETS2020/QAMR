...
module FAU ( 
  ...
  assign z2 = (~new_n22_ & (x06 | x11)) | (~new_n27_ & x03) | (~x03 & ~x06 & x11);
  assign new_n27_ = (~x11 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | ~x06 | x08 | x10 | x11);
  assign z3 = (~new_n22_ & (x06 | x11)) | ~new_n29_ | (~x11 & (new_n31_ | ~x06));
