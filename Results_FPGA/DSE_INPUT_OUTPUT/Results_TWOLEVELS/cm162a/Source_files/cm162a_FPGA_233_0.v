...
module FAU ( 
  ...
  assign new_n27_ = (~x04 | ((~x02 | (~new_n23_ & (x08 | x10 | x11))) & (~x10 | ~x11))) & ((x02 & x04 & ~x08) | ~x11);
  assign z3 = (~new_n29_ & x03) | (x04 & ~x05) | (~x03 & x05 & ~x07);
  assign new_n29_ = (~x02 | new_n31_ | ~x04) & (~x05 | ~x12 | (new_n30_ & x02 & x04));
