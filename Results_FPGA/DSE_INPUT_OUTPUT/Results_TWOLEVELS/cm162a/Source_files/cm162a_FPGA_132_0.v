...
module FAU ( 
  ...
  assign new_n22_ = x02 & x03 & new_n23_ & x04;
  ...
  assign z2 = (~new_n28_ & x03) | (~x05 & (x07 | x13)) | (~x07 & ~x13) | (~x03 & ~x06);
  assign new_n28_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~x10));
  assign z3 = (~new_n30_ & x12) | (~new_n34_ & x13) | (~new_n32_ & (x07 | x13));
  assign new_n30_ = (new_n31_ | (x07 ? ~x03 : ~x13)) & (~x03 | (~x10 & ~x11) | (~x07 & ~x13));
  assign new_n31_ = x02 & x04 & ~x08;
  assign new_n32_ = x05 & (~new_n33_ | ~x02 | ~x03 | ~x04);
  assign new_n33_ = ~x11 & ~x12 & ~x08 & ~x10;
  assign new_n34_ = (x03 | x07) & (~x02 | ~x03 | ~x04 | ~x09);
