// Benchmark "FAU" written by ABC on Fri Aug 21 19:39:52 2020
...
module FAU ( 
  ...
  assign z2 = (x11 & ~new_n28_ & (x06 ? x03 : x01)) | (~new_n26_ & (x01 | x06)) | (x01 & ~x03 & ~x06);
  assign new_n26_ = x05 & (~x02 | ~new_n27_ | ~x03);
  assign new_n27_ = x04 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
  assign new_n28_ = x02 & x04 & ~x08 & ~x10;
  assign z3 = (~new_n30_ & (x01 | x06)) | (~new_n31_ & x03) | (~x01 & ~x06) | (~x03 & ~x07);
