...
module FAU ( 
  ...
  assign z2 = (~new_n23_ & (x06 | ~x11)) | (~x11 & (new_n28_ | (~x03 & ~x06))) | (x03 & x06 & ~new_n29_ & x11);
  assign new_n28_ = x02 & x03 & x04 & ~x08 & ~x10;
  assign new_n29_ = x02 & x04 & ~x08 & ~x10;
  assign z3 = (x03 & (new_n32_ | new_n33_)) | (~new_n22_ & (~new_n31_ | ~x05));
  assign new_n31_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x13) & (x03 | x07);
  assign new_n32_ = ~x11 & ((x12 & (~x02 | ~x04 | x08 | x10)) | (x02 & x04 & ~x08 & ~x10 & ~x12));
  assign new_n33_ = x06 & x11 & x12;
