...
module FAU ( 
  ...
  assign z2 = x06 ? (~x05 | (~new_n27_ & x03)) : ~x03;
  assign new_n27_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (x02 & x04 & ~x08 & ~x10));
  assign z3 = (x03 & (new_n29_ | new_n31_ | ~x06)) | (~x05 & x06) | (~x03 & (~x05 | ~x07));
  assign new_n29_ = x02 & x04 & (new_n30_ | (new_n23_ & x06));
  assign new_n30_ = ~x08 & ~x10 & ~x11 & ~x12;
  assign new_n31_ = ~new_n32_ & x12;
  assign new_n32_ = x02 & x04 & ~x08 & (~x06 | (~x10 & ~x11));
