...
module FAU ( 
  ...
  assign z2 = ((x06 | x12) & (~x05 | (~new_n29_ & x03))) | new_n31_ | (~x03 & ~x06 & x12);
  assign new_n29_ = (~new_n30_ | ~x09 | ~x13) & (~x11 | (new_n30_ & ~x08 & ~x10));
  assign new_n30_ = x02 & x04;
  assign new_n31_ = x02 & new_n32_ & x03;
  assign new_n32_ = x04 & ~x08 & ~x10 & ~x11 & (x12 | (x06 & ~x12));
  assign z3 = (~new_n24_ & ~new_n36_) | (~new_n34_ & x03) | new_n24_ | (~x03 & ~x07);
  assign new_n34_ = (~x02 | ~x04 | new_n35_ | x08) & (~x12 | (x02 & x04 & ~x08));
  assign new_n35_ = x10 ? ~x12 : ((~x11 | ~x12) & (~x06 | x11 | x12));
  assign new_n36_ = x05 & (~x02 | ~x03 | ~x04 | ~x09 | ~x13);
