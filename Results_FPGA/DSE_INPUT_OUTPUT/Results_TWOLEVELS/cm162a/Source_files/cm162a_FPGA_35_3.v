...
module FAU ( 
  ...
  assign z1 = ~new_n22_ & ((~new_n26_ & x03) | ~x05 | (~x01 & ~x03));
  ...
  assign new_n29_ = (x07 | ~x11 | (~x08 & ~x10 & x02 & x04)) & (~x02 | ~x04 | x08 | x10 | x11);
  assign z3 = (~new_n23_ & (~x07 | ~x11)) | (~x07 & (~x03 | (x11 & x12))) | (x03 & ~new_n31_ & ~x11);
  assign new_n31_ = (~x12 | (x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | x08 | x10 | x12);
