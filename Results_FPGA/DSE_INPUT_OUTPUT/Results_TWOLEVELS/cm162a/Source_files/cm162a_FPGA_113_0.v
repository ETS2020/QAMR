...
module FAU ( 
  ...
  assign z2 = new_n26_ | ((x01 | x06) & (new_n28_ | ~x05)) | (x01 & ~x03 & ~x06);
  assign new_n26_ = x11 & ((~new_n27_ & (x06 ? x03 : x01)) | (x03 & x10 & (x01 | x06)));
  assign new_n27_ = x02 & x04 & ~x08;
  assign new_n28_ = x02 & x03 & x04 & (new_n29_ | (x09 & x13));
  assign new_n29_ = ~x08 & ~x10 & ~x11;
  assign z3 = (x01 | x06) & ((~new_n31_ & x03) | ~x05 | (~x03 & ~x07));
  assign new_n31_ = (~x02 | new_n32_ | ~x04) & (~x12 | (new_n29_ & x02 & x04));
