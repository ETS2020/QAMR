...
module FAU ( 
  ...
  assign z01 = (~new_n55_ & x16) | (~x14 & ~x16) | x18 | ~x28;
  ...
  assign z03 = (~new_n59_ & x16) | (~x12 & ~x16) | x18 | ~x28;
  assign new_n59_ = (x17 | x19 | x20 | x21 | x22 | ~x28) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z04 = x18 | (x28 & (x16 ? ~new_n61_ : ~x11));
  assign new_n61_ = (x17 | x19 | x20 | x21 | x22 | x23) & (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22));
  assign z05 = x18 | (x28 & (x16 ? ~new_n63_ : ~x10));
  assign new_n63_ = (x17 | x19 | ~new_n65_ | x20) & (~x24 | (new_n64_ & ~x17 & ~x19 & ~x20));
  assign new_n64_ = ~x21 & ~x22 & ~x23;
  assign new_n65_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (~new_n67_ & x16) | (~x09 & ~x16) | x18 | ~x28;
  assign new_n67_ = (x17 | x19 | ~new_n68_ | x20) & (~x25 | (new_n69_ & ~x17 & ~x19 & ~x20));
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & x28;
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = (x16 & (new_n71_ | new_n73_)) | x18 | ~x28 | (~x08 & ~x16);
  assign new_n71_ = ~x17 & ~x19 & ~x20 & new_n72_ & ~x21;
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & x28;
  assign new_n73_ = x26 & (~new_n74_ | x22 | x23 | x24 | x25);
  assign new_n74_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z08 = x18 | (x28 & (x16 ? ~new_n76_ : ~x07));
  assign new_n76_ = (~x27 | (new_n74_ & new_n78_)) & (~new_n77_ | ~new_n79_);
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n78_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (x28 & (x16 ? ~new_n81_ : ~x06));
  assign new_n81_ = ~x17 & ~x19 & (x17 | x19 | (~x20 & (x20 | (~x21 & (new_n82_ | x21)))));
  assign new_n82_ = ~x22 & (x22 | (~x23 & (x23 | (~x24 & (x24 | (~x25 & (x25 | (~x26 & (x26 | ~x27)))))))));
