...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n57_, new_n59_, new_n60_, new_n61_, new_n63_, new_n64_, new_n66_,
  ...
  assign new_n66_ = new_n64_ & (new_n67_ | x19);
  ...
  assign new_n72_ = x16 & ((new_n69_ & new_n74_) | (x26 & (~new_n64_ | new_n73_)));
  assign new_n73_ = ~x19 & (x21 | x22 | x23 | x24 | x25);
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~new_n76_ & x16);
  assign new_n76_ = (~x27 | (new_n64_ & (new_n77_ | x19))) & (~new_n78_ | ~new_n79_);
  assign new_n77_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (x16 & (new_n83_ | (x28 & (new_n81_ | ~new_n64_))));
  ...
  assign z10 = ~new_n88_ | ~x16 | (x29 & (~new_n59_ | (x16 & (new_n86_ | x20))));
  assign new_n86_ = ~x19 & (~new_n67_ | ~new_n87_);
  assign new_n87_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n88_ = ~x18 & (~new_n61_ | ~new_n89_ | x24 | x25 | x26);
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x30 & (~new_n59_ | (~new_n91_ & x16))) | ~x16 | new_n92_ | x18;
  assign new_n91_ = ~x20 & (x19 | (new_n67_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n61_ & new_n93_ & ~x24 & ~x25 & ~x26;
  assign new_n93_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x31 & (~new_n59_ | (~new_n95_ & x16))) | ~x16 | new_n98_ | x18;
  assign new_n95_ = ~x20 & (x19 | (new_n96_ & new_n97_));
  assign new_n96_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n64_ & new_n67_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n101_ | new_n103_));
  assign new_n101_ = x32 & (~new_n64_ | (~x19 & (~new_n96_ | ~new_n102_)));
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n103_ = new_n64_ & new_n67_ & new_n87_ & new_n104_;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~new_n106_ & x33) | ~x16 | x18 | (new_n68_ & new_n108_);
  assign new_n106_ = ~x17 & ~x19 & (~x16 | (~x20 & (x19 | (new_n77_ & new_n107_))));
  ...
  assign z15 = ~new_n113_ | (x34 & (new_n112_ | ~new_n59_));
  assign new_n112_ = x16 & (x20 | (~x19 & (~new_n77_ | ~new_n89_ | ~new_n110_)));
  assign new_n113_ = x16 & ~x18 & (~new_n69_ | ~new_n70_ | ~new_n109_ | ~new_n114_);
