...
module FAU ( 
  ...
  assign z06 = x18 ? ~x00 : (x16 ? (new_n67_ | new_n68_) : ~x09);
  assign new_n67_ = x25 & (~new_n56_ | (~new_n65_ & ~x19));
  ...
  assign z08 = x18 ? ~x00 : (x16 ? ~new_n74_ : ~x07);
  ...
  assign z09 = x18 ? ~x00 : (x16 ? (new_n79_ | new_n81_) : ~x06);
  ...
  assign z10 = x18 ? ~x00 : (x16 ? (new_n84_ | new_n86_) : ~x05);
  ...
  assign new_n91_ = new_n56_ & (x19 | (new_n65_ & new_n89_ & ~x25 & ~x26));
  ...
  assign new_n101_ = new_n85_ & new_n102_ & new_n56_ & new_n65_;
  ...
  assign new_n109_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n89_ | ~new_n107_)));
