...
module FAU ( 
  ...
  assign new_n84_ = new_n79_ & ~x23 & ~x24 & ~x25 & new_n85_ & ~x26;
  assign new_n85_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n89_ | (~new_n87_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n87_ = new_n58_ & (x19 | (new_n67_ & new_n88_));
  ...
  assign z11 = x18 ? x05 : (x16 ? (new_n94_ | new_n96_) : ~x04);
  assign new_n94_ = x30 & (~new_n58_ | (~x19 & (~new_n67_ | ~new_n95_)));
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = new_n90_ & new_n91_ & new_n85_ & ~x29 & ~x30;
  assign z12 = x18 ? x05 : (x16 ? (new_n98_ | new_n100_) : ~x03);
  assign new_n98_ = x31 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n99_)));
  ...
  assign new_n105_ = new_n58_ & new_n67_ & new_n88_ & new_n106_;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? x05 : (x16 ? (new_n108_ | new_n110_) : ~x01);
  ...
  assign z15 = x18 ? x05 : (x16 ? (new_n114_ | new_n115_) : ~x00);
