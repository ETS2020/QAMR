...
module FAU ( 
  ...
  assign z01 = (x20 & (x17 | x19)) | x14 | ~x16 | x18 | (~x17 & ~x19 & ~x20);
  ...
  assign z05 = (~new_n64_ & x16) | x14 | x18 | (~x10 & ~x16);
  ...
  assign z08 = x18 | (~x14 & (x16 ? ~new_n76_ : ~x07));
  ...
  assign z11 = ~new_n96_ | (x16 & (new_n94_ | (~new_n93_ & x30)));
  assign new_n93_ = new_n57_ & (x19 | (new_n66_ & new_n91_ & ~x25 & ~x26));
  assign new_n94_ = new_n89_ & new_n90_ & new_n95_ & ~x27 & ~x28;
  assign new_n95_ = ~x29 & ~x30;
  assign new_n96_ = ~x14 & ~x18 & (x04 | x16);
  assign z12 = ~new_n101_ | (x16 & (new_n99_ | (x31 & (new_n98_ | ~new_n57_))));
  assign new_n98_ = ~x19 & (~new_n73_ | x26 | x27 | ~new_n95_ | x28);
  assign new_n99_ = new_n57_ & new_n66_ & new_n100_ & ~x25 & ~x26 & ~x27;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = ~x14 & ~x18 & (x03 | x16);
  assign z13 = x18 | (~x14 & (x16 ? (new_n103_ | new_n105_) : ~x02));
  assign new_n103_ = x32 & (~new_n57_ | (~x19 & (~new_n73_ | ~new_n104_)));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n57_ & new_n66_ & new_n87_ & new_n95_ & ~x31 & ~x32;
  assign z14 = ~new_n112_ | (x16 & ((new_n69_ & new_n109_) | (~new_n107_ & x33)));
  assign new_n107_ = new_n57_ & (x19 | (new_n77_ & new_n108_));
  ...
  assign new_n112_ = ~x14 & ~x18 & (x01 | x16);
  assign z15 = x18 | (~x14 & (x16 ? (new_n114_ | new_n115_) : ~x00));
  assign new_n114_ = x34 & (~new_n57_ | (~x19 & (~new_n77_ | ~new_n91_ | ~new_n111_)));
  assign new_n115_ = new_n58_ & new_n70_ & new_n110_ & new_n116_;
