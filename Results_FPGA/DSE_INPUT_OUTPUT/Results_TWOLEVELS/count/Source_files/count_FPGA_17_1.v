...
module FAU ( 
  ...
  assign z01 = x18 ? x04 : ~new_n55_;
  assign new_n55_ = x16 ? ((~x20 | (~x17 & ~x19)) & (x17 | x19 | x20)) : x14;
  assign z02 = x18 ? x04 : ~new_n57_;
  ...
  assign z08 = (~new_n77_ & x16) | x18 | (~x07 & ~x16);
  ...
  assign new_n84_ = new_n79_ & new_n85_ & ~x26 & ~x27 & ~x28;
  ...
  assign z11 = x18 ? x04 : (x16 ? ~new_n94_ : ~x04);
  assign new_n94_ = (~x30 | (new_n90_ & new_n91_ & ~x27 & ~x28 & ~x29)) & (~new_n90_ | ~new_n91_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n98_ | (~new_n96_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n96_ = new_n58_ & (x19 | (new_n74_ & new_n97_));
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n58_ & new_n67_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n105_ | (x16 & (new_n103_ | (x32 & (new_n101_ | ~new_n58_))));
  assign new_n101_ = ~x19 & (~new_n74_ | ~new_n102_);
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n103_ = new_n58_ & new_n67_ & new_n88_ & new_n104_;
