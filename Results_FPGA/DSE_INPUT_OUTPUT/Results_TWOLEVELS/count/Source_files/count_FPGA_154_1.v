...
module FAU ( 
  ...
  assign z05 = (~x10 & ~x16 & ~x18) | (x16 & (new_n63_ | x18 | (new_n56_ & new_n64_)));
  assign new_n63_ = x24 & (~new_n56_ | (~x19 & (x21 | x22 | x23)));
  assign new_n64_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z06 = (x16 & (new_n67_ | (~new_n66_ & x25))) | x18 | (~x09 & ~x16);
  assign new_n66_ = new_n56_ & (new_n64_ | x19);
  ...
  assign z08 = (~x07 & ~x16 & ~x18) | (x16 & ((~new_n73_ & x27) | new_n75_ | x18));
  ...
  assign new_n80_ = new_n76_ & ~x23 & ~x24 & ~x25 & new_n81_ & ~x26;
  assign new_n81_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n85_ | (~new_n83_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n83_ = new_n56_ & (x19 | (new_n64_ & new_n84_));
  ...
  assign z11 = (~x04 & ~x16 & ~x18) | (x16 & ((~new_n90_ & x30) | new_n91_ | x18));
  assign new_n90_ = new_n56_ & (x19 | (new_n64_ & new_n88_ & ~x25 & ~x26));
  assign new_n91_ = new_n86_ & new_n87_ & new_n81_ & new_n92_;
  assign new_n92_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n96_ | (~new_n94_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n94_ = new_n56_ & (x19 | (new_n70_ & new_n95_));
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n56_ & new_n64_ & new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x30 & ~x31 & ~x28 & ~x29;
  ...
  assign new_n101_ = new_n56_ & new_n64_ & new_n84_ & new_n92_ & ~x31 & ~x32;
  ...
  assign new_n106_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = (~x00 & ~x16 & ~x18) | (x16 & (new_n108_ | x18 | (new_n67_ & new_n109_)));
  assign new_n108_ = x34 & (~new_n56_ | (~x19 & (~new_n74_ | ~new_n88_ | ~new_n106_)));
