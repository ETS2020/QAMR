...
module FAU ( 
  ...
  assign z03 = x18 ? ~x31 : (x16 ? ~new_n58_ : ~x12);
  ...
  assign new_n70_ = (~x25 | (new_n66_ & new_n68_)) & (~new_n59_ | ~new_n71_ | x24 | x25);
  ...
  assign new_n79_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n80_))));
  assign new_n80_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n81_ = new_n60_ & new_n82_;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n86_ | (~new_n84_ & x29)));
  assign new_n84_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n68_ & new_n85_))));
  ...
  assign new_n89_ = (~x30 | (new_n63_ & new_n87_ & ~x27 & ~x28 & ~x29)) & (~new_n63_ | ~new_n87_ | x29 | x30 | x27 | x28);
  assign z12 = ~new_n97_ | (x16 & ((new_n91_ & new_n95_) | (~new_n92_ & x31)));
  assign new_n91_ = new_n66_ & new_n68_;
  assign new_n92_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n93_ & new_n94_))));
  ...
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n101_ | (~new_n99_ & x32)));
  assign new_n99_ = new_n100_ & (x19 | (x31 ? x18 : (new_n93_ & new_n94_)));
  assign new_n100_ = ~x17 & ~x19 & (~x20 | x31);
  assign new_n101_ = new_n66_ & new_n68_ & new_n85_ & new_n102_;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n109_ | (x16 & ((new_n104_ & new_n107_) | (~new_n105_ & x33)));
  assign new_n104_ = new_n59_ & new_n71_ & ~x24 & ~x25;
  assign new_n105_ = new_n100_ & (x19 | (~new_n106_ & (x31 | (new_n93_ & new_n94_))));
  ...
  assign z15 = ~new_n115_ | (x16 & (new_n111_ | (new_n104_ & new_n114_)));
  assign new_n111_ = x34 & (new_n113_ | (~x31 & (~new_n63_ | ~new_n87_ | ~new_n112_)));
  assign new_n112_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n113_ = ~x18 & (x31 | x32 | x33);
  assign new_n114_ = new_n108_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n115_ = (x00 | x16 | x18) & (~x18 | x31);
endmodule
