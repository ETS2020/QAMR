...
module FAU ( 
  ...
  assign z09 = ~x16 | x18 | (new_n77_ & new_n82_) | (~new_n80_ & x28);
  assign new_n80_ = new_n56_ & (x19 | (new_n65_ & new_n81_ & ~x24 & ~x25));
  ...
  assign new_n92_ = ~x19 & (~new_n93_ | ~new_n81_ | x28 | x29 | x30);
  assign new_n93_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n94_ = new_n56_ & new_n66_ & new_n95_ & new_n81_ & ~x25;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~new_n98_ & x32) | ~x16 | x18 | (new_n97_ & new_n100_);
  assign new_n97_ = new_n56_ & new_n66_;
  assign new_n98_ = new_n56_ & (x19 | (new_n93_ & new_n99_));
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n100_ = new_n85_ & ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 | (x16 & ((~new_n102_ & x33) | (new_n69_ & new_n104_)));
  assign new_n102_ = new_n56_ & (x19 | (new_n76_ & new_n103_));
  assign new_n103_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n104_ = new_n105_ & new_n81_ & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n107_ | ~x16 | x18 | (new_n69_ & new_n108_);
  assign new_n107_ = x34 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n87_ | ~new_n105_)));
