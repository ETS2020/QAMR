...
module FAU ( 
  ...
  assign z09 = (~new_n79_ & x28) | ~x16 | x18 | (new_n76_ & new_n81_);
  assign new_n79_ = new_n56_ & (x19 | (new_n64_ & new_n80_ & ~x24 & ~x25));
  assign new_n80_ = ~x26 & ~x27;
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = new_n83_ | ~x16 | x18 | (new_n85_ & new_n71_ & new_n86_);
  assign new_n83_ = x29 & (~new_n56_ | (~x19 & (~new_n65_ | ~new_n84_)));
  ...
  assign new_n89_ = new_n85_ & new_n71_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n92_ | (x31 & (new_n91_ | ~new_n56_))));
  assign new_n91_ = ~x19 & (~new_n72_ | ~new_n80_ | x28 | x29 | x30);
  assign new_n92_ = new_n56_ & new_n65_ & new_n93_ & new_n80_ & ~x25;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n95_ | new_n97_));
  assign new_n95_ = x32 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n96_)));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = new_n56_ & new_n65_ & new_n84_ & new_n98_ & ~x29 & ~x30;
  assign new_n98_ = ~x31 & ~x32;
  assign z14 = x18 | (x16 & (new_n100_ | (new_n68_ & new_n102_ & new_n103_)));
  assign new_n100_ = x33 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n101_)));
  assign new_n101_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n105_ | (new_n68_ & new_n106_)));
  assign new_n105_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n86_ | ~new_n103_)));
