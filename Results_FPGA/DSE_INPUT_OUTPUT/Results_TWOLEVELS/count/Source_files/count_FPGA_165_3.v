...
module FAU ( 
  ...
  assign new_n63_ = (~x23 | (new_n58_ & (x19 | (~x21 & ~x22)))) & (~new_n58_ | x21 | x22 | x23);
  assign z05 = x18 ? ~x29 : (x16 ? ~new_n65_ : ~x10);
  assign new_n65_ = (~x24 | (new_n58_ & (new_n66_ | x19))) & (~new_n58_ | ~new_n67_);
  assign new_n66_ = ~x21 & ~x22 & ~x23;
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = x18 ? ~x29 : (x16 ? (new_n69_ | new_n70_) : ~x09);
  assign new_n69_ = x25 & (~new_n58_ | (~new_n67_ & ~x19));
  assign new_n70_ = new_n59_ & ~x24 & ~x25 & ~x22 & ~x23;
  ...
  assign z09 = x18 ? ~x29 : (x16 ? (new_n81_ | new_n83_) : ~x06);
  ...
  assign z10 = (~x29 & (new_n86_ | x18)) | (~x18 & (x16 ? (~new_n88_ & x29) : ~x05));
  assign new_n86_ = new_n84_ & new_n87_;
  assign new_n87_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n88_ = new_n58_ & (x19 | (new_n67_ & new_n89_));
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z11 = ~new_n95_ | (x16 & (new_n93_ | (~new_n91_ & x30)));
  assign new_n91_ = ~new_n92_ & (x29 | (~x20 & (x19 | (new_n67_ & new_n89_))));
  assign new_n92_ = ~x18 & (x17 | x19 | (~x19 & x29));
  assign new_n93_ = new_n58_ & new_n66_ & new_n94_ & ~x24 & ~x25 & ~x26;
  assign new_n94_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n95_ = (x04 | x16 | x18) & (~x18 | x29);
  assign z12 = (x16 & (new_n99_ | (~new_n97_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n97_ = new_n58_ & (x19 | (new_n73_ & new_n98_));
  ...
  assign z13 = ~new_n106_ | (x16 & (new_n104_ | ((new_n102_ | ~new_n58_) & x32)));
  assign new_n102_ = ~x19 & (~new_n73_ | ~new_n103_);
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n89_ & new_n105_ & new_n58_ & new_n67_;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = ~x18 & (x02 | x16);
  assign z14 = (x16 & (new_n108_ | (new_n70_ & new_n110_))) | (~x01 & ~x16) | x18;
  assign new_n108_ = x33 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n109_)));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n111_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n113_ | (new_n70_ & new_n115_))) | (~x00 & ~x16) | x18;
  assign new_n113_ = x34 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n114_ | ~new_n111_)));
  assign new_n114_ = ~x27 & ~x28 & ~x29;
  assign new_n115_ = new_n116_ & ~x28 & ~x29 & ~x26 & ~x27;
