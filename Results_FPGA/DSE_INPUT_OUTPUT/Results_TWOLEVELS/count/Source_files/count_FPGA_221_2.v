...
module FAU ( 
  ...
  assign new_n79_ = new_n57_ & (x19 | (new_n80_ & ~x21 & ~x22 & ~x23));
  ...
  assign new_n84_ = new_n57_ & (x19 | (new_n67_ & new_n85_));
  ...
  assign new_n91_ = new_n57_ & (x19 | (new_n67_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n87_ & new_n88_ & new_n82_ & ~x29 & ~x30;
  assign z12 = x18 ? x34 : (x16 ? (new_n94_ | new_n96_) : ~x03);
  assign new_n94_ = x31 & (~new_n57_ | (~x19 & (~new_n71_ | ~new_n95_)));
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n57_ & new_n67_ & new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n99_ | new_n101_)) | x18 | (~x02 & ~x16);
  assign new_n99_ = x32 & (~new_n57_ | (~x19 & (~new_n71_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n85_ & new_n102_ & new_n57_ & new_n67_;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n104_ | (new_n68_ & new_n106_))) | x18 | (~x01 & ~x16);
  assign new_n104_ = x33 & (~new_n57_ | (~x19 & (~new_n75_ | ~new_n105_)));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = new_n107_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n109_ | (new_n68_ & new_n110_))) | x18 | (~x00 & ~x16);
  assign new_n109_ = x34 & (~new_n57_ | (~x19 & (~new_n75_ | ~new_n89_ | ~new_n107_)));
