...
module FAU ( 
  ...
  assign z06 = (x25 & (~new_n59_ | (~new_n68_ & x16))) | ~x16 | new_n69_ | x18;
  assign new_n68_ = ~x20 & (new_n66_ | x19);
  ...
  assign new_n83_ = ~x20 & (x19 | (new_n65_ & new_n81_ & ~x24 & ~x25));
  ...
  assign new_n91_ = ~x20 & (x19 | (new_n66_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n61_ & new_n75_ & new_n93_ & ~x27 & ~x28;
  assign new_n93_ = ~x29 & ~x30;
  assign z12 = (x31 & (~new_n59_ | (~new_n95_ & x16))) | ~x16 | new_n96_ | x18;
  assign new_n95_ = ~x20 & (x19 | (new_n73_ & new_n81_ & new_n93_ & ~x28));
  assign new_n96_ = new_n64_ & new_n66_ & new_n97_ & new_n81_ & ~x25;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n99_ | new_n101_));
  assign new_n99_ = x32 & (~new_n64_ | (~x19 & (~new_n73_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n64_ & new_n66_ & new_n88_ & new_n93_ & ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((new_n69_ & new_n105_) | (~new_n103_ & x33)));
  assign new_n103_ = new_n64_ & (x19 | (new_n78_ & new_n104_));
