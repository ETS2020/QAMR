...
module FAU ( 
  ...
  assign z07 = (x16 & (new_n72_ | new_n74_)) | x18 | (~x08 & ~x16);
  ...
  assign new_n76_ = (~new_n77_ | ~new_n79_) & (~x27 | (new_n57_ & (new_n78_ | x19)));
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n78_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? x05 : (x16 ? (new_n81_ | new_n84_) : ~x06);
  assign new_n81_ = x28 & (~new_n57_ | (~x19 & (~new_n82_ | ~new_n83_)));
  assign new_n82_ = ~x21 & ~x22 & ~x23;
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n84_ = new_n77_ & new_n85_;
  assign new_n85_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n89_ | (~new_n87_ & x29)));
  assign new_n87_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n88_))));
  ...
  assign z11 = ~new_n97_ | (x16 & (new_n95_ | (x30 & (new_n93_ | ~new_n65_))));
  assign new_n93_ = ~x18 & (x20 | (~x19 & (~new_n67_ | ~new_n94_)));
  ...
  assign z12 = x18 ? x05 : (x16 ? (new_n99_ | new_n101_) : ~x03);
  assign new_n99_ = x31 & (~new_n57_ | (~x19 & (~new_n73_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n101_ = new_n57_ & new_n67_ & new_n102_ & ~x25 & ~x26 & ~x27;
  assign new_n102_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n106_ | (~new_n104_ & x32)));
  assign new_n104_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n73_ & new_n105_))));
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n106_ = new_n57_ & new_n67_ & new_n88_ & new_n107_;
  assign new_n107_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? x05 : (x16 ? (new_n109_ | new_n111_) : ~x01);
  assign new_n109_ = x33 & (~new_n57_ | (~x19 & (~new_n78_ | ~new_n110_)));
  assign new_n110_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n111_ = new_n58_ & new_n70_ & new_n112_ & new_n113_;
  assign new_n112_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n118_ | (x16 & (new_n116_ | (x34 & (new_n115_ | ~new_n65_))));
  assign new_n115_ = ~x18 & (x20 | (~x19 & (~new_n78_ | ~new_n91_ | ~new_n113_)));
  assign new_n116_ = new_n58_ & new_n70_ & new_n112_ & new_n117_;
