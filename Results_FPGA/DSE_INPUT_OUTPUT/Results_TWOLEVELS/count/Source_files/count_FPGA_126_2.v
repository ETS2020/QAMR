...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n70_ | new_n71_)) | x06 | x18 | (~x09 & ~x16);
  assign new_n70_ = x25 & (~new_n58_ | ~new_n68_);
  assign new_n71_ = new_n59_ & new_n72_;
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~new_n74_ & x16) | x06 | x18 | (~x08 & ~x16);
  assign new_n74_ = (~new_n59_ | ~new_n75_) & (~x26 | (new_n59_ & new_n72_));
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x06 & (x16 ? ~new_n77_ : ~x07));
  assign new_n77_ = (~x27 | (new_n59_ & new_n75_)) & (~new_n62_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x06 & (new_n81_ | ~x16 | (~new_n80_ & x28)));
  assign new_n80_ = new_n62_ & new_n78_;
  assign new_n81_ = new_n62_ & ~x23 & ~x24 & ~x25 & new_n82_ & ~x26;
  assign new_n82_ = ~x27 & ~x28;
  assign z10 = ~new_n86_ | (x16 & ((~new_n81_ & x29) | (new_n84_ & new_n65_)));
  assign new_n84_ = new_n85_ & ~x27 & ~x28 & ~x29;
  assign new_n85_ = ~x24 & ~x25 & ~x26;
  assign new_n86_ = ~x06 & ~x18 & (x05 | x16);
  assign z11 = (~new_n88_ & x16) | x06 | x18 | (~x04 & ~x16);
  assign new_n88_ = (~x30 | (new_n65_ & new_n85_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n85_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x06 & (x16 ? (new_n90_ | new_n91_) : ~x03));
  assign new_n90_ = x31 & (~new_n65_ | ~new_n85_ | ~new_n82_ | x29 | x30);
  ...
  assign new_n105_ = (~x34 | (new_n59_ & new_n72_ & new_n102_ & new_n103_)) & (~new_n59_ | ~new_n72_ | ~new_n102_ | ~new_n106_);
