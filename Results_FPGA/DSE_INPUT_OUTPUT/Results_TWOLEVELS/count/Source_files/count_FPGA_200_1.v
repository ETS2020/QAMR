...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n69_ | new_n72_)) | ~new_n58_ | (~x09 & ~x16);
  assign new_n69_ = x25 & (~new_n70_ | (~new_n71_ & ~x34));
  ...
  assign new_n75_ = (~x26 | (new_n65_ & (new_n76_ | x19))) & (~new_n73_ | ~new_n77_);
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = ~new_n58_ | (~x07 & ~x16) | (x16 & (new_n81_ | (~new_n79_ & x27)));
  assign new_n79_ = new_n70_ & (x34 | (new_n80_ & ~x20 & ~x21 & ~x22));
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n81_ = new_n82_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = x18 | (~x34 & (x16 ? (new_n84_ | new_n86_) : ~x06));
  assign new_n84_ = x28 & (~new_n65_ | (~x19 & (~new_n66_ | ~new_n85_)));
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n86_ = new_n82_ & new_n87_ & ~x23 & ~x24 & ~x25;
  assign new_n87_ = ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x34 & (x16 ? (new_n89_ | new_n91_) : ~x05));
  assign new_n89_ = x29 & (~new_n65_ | (~x19 & (~new_n67_ | ~new_n90_)));
  assign new_n90_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n91_ = new_n92_ & new_n94_ & ~x27 & new_n93_ & ~x24;
  assign new_n92_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n93_ = ~x25 & ~x26;
  assign new_n94_ = ~x28 & ~x29;
  assign z11 = ~new_n58_ | (~x04 & ~x16) | (x16 & (new_n97_ | (~new_n96_ & x30)));
  assign new_n96_ = new_n70_ & (x34 | (new_n71_ & new_n93_ & new_n94_ & ~x27));
  assign new_n97_ = new_n92_ & new_n98_ & new_n93_ & ~x24;
  assign new_n98_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x34 & (x16 ? (new_n100_ | new_n102_) : ~x03));
  assign new_n100_ = x31 & (~new_n65_ | (~x19 & (~new_n76_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n102_ = new_n65_ & new_n67_ & new_n103_ & ~x25 & ~x26 & ~x27;
  assign new_n103_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n58_ | (~x02 & ~x16) | (x16 & (new_n108_ | (~new_n105_ & x32)));
  assign new_n105_ = new_n70_ & (x34 | (new_n107_ & new_n87_ & new_n106_ & ~x29));
  assign new_n106_ = ~x30 & ~x31;
  assign new_n107_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n108_ = new_n65_ & new_n67_ & new_n90_ & new_n109_;
  assign new_n109_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n111_ | (new_n72_ & new_n112_))) | ~new_n58_ | (~x01 & ~x16);
  assign new_n111_ = x33 & (~new_n70_ | (~x34 & (~new_n107_ | ~new_n87_ | ~new_n109_)));
  assign new_n112_ = new_n113_ & new_n94_ & ~x26 & ~x27;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign z15 = x18 | (~x34 & (new_n115_ | (~x00 & ~x16)));
  assign new_n115_ = new_n67_ & new_n116_ & new_n90_ & new_n117_;
