...
module FAU ( 
  ...
  assign new_n64_ = (~x24 | (new_n56_ & (new_n65_ | x19))) & (~new_n56_ | ~new_n66_);
  ...
  assign new_n75_ = x27 & (x17 | x19 | (~x18 & (x20 | (~new_n76_ & ~x19))));
  ...
  assign new_n80_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n65_ & new_n81_))));
  ...
  assign new_n85_ = new_n56_ & (x19 | (new_n66_ & new_n86_));
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = new_n62_ & new_n88_ & ~x24 & ~x25 & ~x26;
  ...
  assign new_n92_ = new_n62_ & ~x24 & ~x25 & ~x26 & new_n83_ & new_n93_;
  ...
  assign new_n100_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n72_ & new_n101_))));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n56_ & new_n66_ & new_n86_ & new_n93_ & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n104_ | (new_n69_ & new_n106_))) : (~x01 | x18);
  assign new_n104_ = x33 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n105_)));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = new_n107_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x16 ? (~x18 & (new_n109_ | (new_n69_ & new_n110_))) : (~x00 | x18);
  assign new_n109_ = x34 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n88_ | ~new_n107_)));
