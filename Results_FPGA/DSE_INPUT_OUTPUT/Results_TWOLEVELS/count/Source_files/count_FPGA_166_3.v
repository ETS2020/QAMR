...
module FAU ( 
  ...
  assign z03 = x18 ? ~x08 : (x16 ? ~new_n58_ : ~x12);
  ...
  assign new_n63_ = (~x24 | (new_n64_ & ~new_n66_)) & (~new_n65_ | ~new_n67_);
  assign new_n64_ = ~x17 & ~x19;
  assign new_n65_ = ~x17 & ~x19 & ~x20;
  assign new_n66_ = ~x18 & (x20 | (~x19 & (x21 | x22 | x23)));
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = x18 ? ~x08 : (x16 ? (new_n69_ | new_n70_) : ~x09);
  assign new_n69_ = x25 & (~new_n65_ | (~new_n67_ & ~x19));
  assign new_n70_ = new_n71_ & new_n72_;
  assign new_n71_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~x08 & (~x16 | x18)) | (x16 & ~new_n74_ & ~x18);
  assign new_n74_ = (~new_n71_ | ~new_n76_) & (~x26 | (new_n65_ & (new_n75_ | x19)));
  assign new_n75_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n78_ | new_n80_));
  assign new_n78_ = x27 & (x17 | x19 | (~x18 & (x20 | (~new_n79_ & ~x19))));
  assign new_n79_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n80_ = new_n81_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n81_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = x18 ? ~x08 : (x16 ? (new_n83_ | new_n86_) : ~x06);
  assign new_n83_ = x28 & (~new_n65_ | (~x19 & (~new_n84_ | ~new_n85_)));
  assign new_n84_ = ~x21 & ~x22 & ~x23;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n86_ = new_n81_ & new_n87_;
  assign new_n87_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x08 : (x16 ? (new_n89_ | new_n91_) : ~x05);
  assign new_n89_ = x29 & (~new_n65_ | (~x19 & (~new_n67_ | ~new_n90_)));
  assign new_n90_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n91_ = new_n61_ & new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n96_ | (~new_n94_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n94_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n95_))));
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = new_n61_ & new_n97_ & ~x24 & ~x25 & ~x26;
  assign new_n97_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n101_ | (~new_n99_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n99_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n75_ & new_n100_))));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n101_ = new_n65_ & new_n67_ & new_n102_ & ~x25 & ~x26 & ~x27;
  assign new_n102_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n106_ | (~new_n104_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n104_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n75_ & new_n105_))));
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n106_ = new_n65_ & new_n67_ & new_n90_ & new_n107_;
  assign new_n107_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n114_ | (x16 & ((~new_n109_ & x33) | (new_n70_ & new_n111_)));
  assign new_n109_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n79_ & new_n110_))));
  ...
  assign z15 = ~new_n119_ | (x16 & (new_n117_ | (x34 & (new_n116_ | ~new_n64_))));
  assign new_n116_ = ~x18 & (x20 | (~x19 & (~new_n79_ | ~new_n92_ | ~new_n113_)));
  assign new_n117_ = new_n71_ & new_n72_ & new_n112_ & new_n118_;
