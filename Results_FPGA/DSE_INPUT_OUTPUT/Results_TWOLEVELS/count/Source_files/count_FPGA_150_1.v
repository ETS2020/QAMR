...
module FAU ( 
  ...
  assign z03 = (~new_n61_ & x16) | ~new_n54_ | (~x12 & ~x16);
  ...
  assign z07 = (~new_n73_ & x16) | ~new_n54_ | (~x08 & ~x16);
  ...
  assign z09 = x18 | (~x32 & (x16 ? (new_n82_ | new_n84_) : ~x06));
  ...
  assign z12 = (x16 & (new_n100_ | (~new_n98_ & x31))) | ~new_n54_ | (~x03 & ~x16);
  assign new_n98_ = new_n58_ & (x19 | (new_n74_ & new_n99_ & new_n96_ & ~x28));
  assign new_n99_ = ~x26 & ~x27;
  assign new_n100_ = new_n58_ & new_n67_ & new_n101_ & new_n99_ & ~x25;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n54_ | (~x02 & ~x16) | (new_n103_ & new_n83_ & new_n101_);
  assign new_n103_ = new_n104_ & x16 & ~x17 & ~x19;
  assign new_n104_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z14 = x18 | (~x32 & (x16 ? (new_n106_ | new_n108_) : ~x01));
  assign new_n106_ = x33 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n107_)));
  assign new_n107_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n108_ = new_n58_ & new_n67_ & new_n88_ & new_n96_ & ~x31 & ~x33;
  assign z15 = (x16 & (new_n111_ | (new_n110_ & new_n113_))) | ~new_n54_ | (~x00 & ~x16);
  assign new_n110_ = new_n59_ & new_n71_;
  assign new_n111_ = x34 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n112_)));
  assign new_n112_ = ~x30 & ~x31 & ~x33 & ~x27 & ~x28 & ~x29;
  assign new_n113_ = new_n114_ & new_n99_ & ~x28 & ~x29;
  assign new_n114_ = ~x30 & ~x31 & ~x33 & ~x34;
endmodule
