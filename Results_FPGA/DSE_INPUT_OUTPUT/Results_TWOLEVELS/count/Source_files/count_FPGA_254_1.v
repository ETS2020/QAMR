...
module FAU ( 
  ...
  assign z06 = (~x09 & ~x16 & ~x18) | (x16 & ((~new_n66_ & x25) | new_n67_ | x18));
  ...
  assign new_n81_ = new_n77_ & ~x23 & ~x24 & ~x25 & new_n82_ & ~x26;
  assign new_n82_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n86_ | (~new_n84_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n84_ = new_n56_ & (x19 | (new_n64_ & new_n85_));
  assign new_n85_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = new_n87_ & new_n72_ & new_n88_;
  ...
  assign new_n91_ = new_n87_ & new_n72_ & new_n82_ & new_n92_;
  ...
  assign new_n101_ = new_n56_ & new_n64_ & new_n85_ & new_n92_ & ~x31 & ~x32;
  ...
  assign new_n108_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n88_ | ~new_n106_)));
