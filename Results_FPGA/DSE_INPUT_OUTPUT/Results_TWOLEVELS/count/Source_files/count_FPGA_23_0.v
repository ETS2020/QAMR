...
module FAU ( 
  ...
  assign z02 = ((x20 | x21) & (x18 | (~x13 & ~x16))) | (x16 & ~new_n58_ & x21);
  assign new_n58_ = ~x17 & ~x19 & ~x20;
  assign z03 = ~new_n54_ & ((~x12 & ~x16) | x18 | (x16 & x22));
  assign z04 = (~new_n54_ & x18) | (~x11 & ~x16) | new_n54_ | (x16 & x23);
  assign z05 = ~new_n54_ & ((~x10 & ~x16) | x18 | (x16 & x24));
  assign z06 = ~new_n54_ & ((~x09 & ~x16) | x18 | (x16 & x25));
  assign z07 = ~new_n54_ & ((~x08 & ~x16) | x18 | (x16 & x26));
  assign z08 = ~new_n54_ & ((~x07 & ~x16) | x18 | (x16 & x27));
  assign z09 = ~new_n54_ & ((~x06 & ~x16) | x18 | (x16 & x28));
