...
module FAU ( 
  ...
  assign new_n82_ = ~x18 & (~new_n83_ | x20 | x21 | x22 | x23);
  ...
  assign z10 = (~x05 & (~x16 | x18)) | (x16 & ~x18 & (new_n88_ | (new_n91_ & new_n93_)));
  assign new_n88_ = x29 & (~new_n58_ | (~x19 & (~new_n89_ | ~new_n90_)));
  assign new_n89_ = ~x23 & ~x24 & ~x21 & ~x22;
  ...
  assign new_n95_ = new_n68_ & (x18 | (new_n69_ & new_n92_ & ~x25 & ~x26));
  assign new_n96_ = new_n93_ & new_n97_ & ~x24 & ~x25 & ~x26;
  assign new_n97_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 ? ~x05 : (x16 ? (new_n99_ | new_n102_) : ~x03);
  assign new_n99_ = x31 & (~new_n58_ | (~x19 & (~new_n100_ | ~new_n101_)));
  assign new_n100_ = ~x23 & ~x24 & ~x25 & ~x21 & ~x22;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x26 & ~x27;
  assign new_n102_ = new_n58_ & new_n89_ & new_n103_ & ~x25 & ~x26 & ~x27;
  assign new_n103_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 ? ~x05 : (x16 ? (new_n105_ | new_n107_) : ~x02);
  assign new_n105_ = x32 & (~new_n58_ | (~x19 & (~new_n100_ | ~new_n106_)));
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n107_ = new_n58_ & new_n89_ & new_n90_ & new_n108_;
  assign new_n108_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 ? ~x05 : (x16 ? (new_n110_ | new_n112_) : ~x01);
  assign new_n110_ = x33 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n111_)));
  assign new_n111_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n112_ = new_n59_ & new_n71_ & new_n113_ & new_n114_;
  assign new_n113_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n114_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x18 ? ~x05 : (x16 ? (new_n116_ | new_n117_) : ~x00);
  assign new_n116_ = x34 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n92_ | ~new_n114_)));
  assign new_n117_ = new_n59_ & new_n71_ & new_n113_ & new_n118_;
