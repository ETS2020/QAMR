...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n57_, new_n59_, new_n61_, new_n62_, new_n63_, new_n64_,
  ...
  assign new_n66_ = (~x24 | (new_n62_ & (new_n67_ | x18))) & (~new_n56_ | ~new_n68_);
  assign new_n67_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = x16 ? (~x18 & (new_n71_ | (~new_n70_ & x25))) : (~x09 | x18);
  assign new_n70_ = new_n56_ & (new_n68_ | x19);
  assign new_n71_ = new_n57_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~new_n73_ & x16) | x18 | (~x08 & ~x16);
  assign new_n73_ = (~x26 | (new_n62_ & (new_n74_ | x18))) & (~new_n57_ | ~new_n75_);
  ...
  assign new_n77_ = new_n62_ & (x18 | (new_n63_ & new_n78_));
  ...
  assign new_n82_ = new_n62_ & (x18 | (new_n67_ & new_n83_));
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n84_ = new_n80_ & new_n85_;
  assign new_n85_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n87_ | (new_n89_ & new_n64_))) : (~x05 | x18);
  assign new_n87_ = x29 & (~new_n56_ | (~x19 & (~new_n68_ | ~new_n88_)));
  ...
  assign new_n92_ = new_n62_ & (x18 | (new_n93_ & new_n90_ & ~x25 & ~x26));
  assign new_n93_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n94_ = new_n64_ & new_n95_ & ~x24 & ~x25 & ~x26;
  assign new_n95_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x16 ? (~x18 & (new_n97_ | new_n100_)) : (~x03 | x18);
  assign new_n97_ = x31 & (~new_n56_ | (~x19 & (~new_n98_ | ~new_n99_)));
  ...
  assign z13 = ~new_n107_ | (x16 & ((~new_n104_ & x32) | (new_n103_ & new_n106_)));
  assign new_n103_ = new_n56_ & new_n68_;
  assign new_n104_ = new_n62_ & (x18 | (new_n74_ & new_n105_));
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n106_ = new_n88_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = ~x18 & (x02 | x16);
  assign z14 = x16 ? (~x18 & (new_n109_ | (new_n71_ & new_n112_))) : (~x01 | x18);
  assign new_n109_ = x33 & (~new_n56_ | (~x19 & (~new_n110_ | ~new_n111_)));
  ...
  assign z15 = ~new_n118_ | (x16 & ((~new_n115_ & x34) | (new_n71_ & new_n116_)));
  assign new_n115_ = new_n62_ & (x18 | (new_n90_ & new_n113_ & new_n63_ & new_n78_));
