...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n57_, new_n58_, new_n61_, new_n62_, new_n64_, new_n66_,
  ...
  assign z01 = x18 | (x16 & ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)));
  ...
  assign z09 = x18 | (x16 & (new_n81_ | (x28 & (new_n79_ | ~new_n57_))));
  ...
  assign z10 = x18 | (x16 & (new_n84_ | (new_n62_ & new_n71_ & new_n86_)));
  assign new_n84_ = x29 & (~new_n57_ | ((~new_n67_ | ~new_n85_) & ~x19));
  assign new_n85_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (x16 & (new_n89_ | (~new_n88_ & x30)));
  assign new_n88_ = new_n57_ & (x19 | (new_n67_ & new_n86_ & ~x25 & ~x26));
  assign new_n89_ = new_n62_ & new_n71_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x31 & (new_n91_ | ~new_n57_)) | ~x16 | new_n92_ | x18;
  assign new_n91_ = ~x19 & (~new_n72_ | ~new_n76_ | x28 | x29 | x30);
  assign new_n92_ = new_n57_ & new_n67_ & new_n93_ & new_n76_ & ~x25;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n95_ | new_n97_));
  assign new_n95_ = x32 & (~new_n57_ | ((~new_n72_ | ~new_n96_) & ~x19));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = new_n57_ & new_n67_ & new_n85_ & new_n98_ & ~x29 & ~x30;
  assign new_n98_ = ~x31 & ~x32;
  assign z14 = new_n100_ | ~x16 | x18 | (new_n68_ & new_n102_ & new_n103_);
  assign new_n100_ = x33 & (~new_n57_ | ((~new_n77_ | ~new_n101_) & ~x19));
  assign new_n101_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n105_ | ~x16 | x18 | (new_n68_ & new_n106_);
  assign new_n105_ = x34 & (~new_n57_ | (~x19 & (~new_n77_ | ~new_n86_ | ~new_n103_)));
