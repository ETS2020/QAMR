...
module FAU ( 
  ...
  assign z10 = (x16 & (new_n81_ | (~new_n78_ & x29))) | ~new_n54_ | (~x05 & ~x16);
  assign new_n81_ = new_n63_ & new_n82_;
  assign new_n82_ = ~x27 & ~x28 & ~x29 & ~x24 & ~x25 & ~x26;
  assign z11 = x18 | (~x20 & (x16 ? (new_n84_ | new_n85_) : ~x04));
  ...
  assign new_n89_ = new_n66_ & new_n77_ & ~x30 & ~x31 & ~x28 & ~x29;
  ...
  assign z15 = x18 | (~x20 & (x16 ? (new_n98_ | new_n99_) : ~x00));
