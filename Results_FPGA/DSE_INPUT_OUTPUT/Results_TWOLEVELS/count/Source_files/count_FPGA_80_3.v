...
module FAU ( 
  ...
  assign z06 = x18 ? ~x08 : (x16 ? (new_n72_ | new_n73_) : ~x09);
  assign new_n72_ = x25 & (~new_n69_ | (~new_n70_ & ~x19));
  assign new_n73_ = new_n74_ & new_n75_;
  assign new_n74_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n75_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = (x16 & (new_n79_ | (~new_n77_ & x26))) | x18 | (~x08 & ~x16);
  assign new_n77_ = new_n62_ & (x18 | (new_n78_ & new_n63_ & ~x20));
  assign new_n78_ = ~x23 & ~x24 & ~x25;
  assign new_n79_ = new_n74_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? ~x08 : (x16 ? (new_n81_ | new_n83_) : ~x07);
  assign new_n81_ = x27 & (~new_n69_ | (~new_n82_ & ~x19));
  assign new_n82_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n83_ = new_n84_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x20 & ~x21 & ~x22 & ~x17 & ~x19;
  assign z09 = (x16 & (new_n88_ | (~new_n86_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n86_ = new_n62_ & (x18 | (new_n67_ & new_n87_ & ~x26 & ~x27));
  assign new_n87_ = ~x24 & ~x25;
  assign new_n88_ = new_n84_ & new_n78_ & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n90_ | (new_n92_ & new_n64_))) | x18 | (~x05 & ~x16);
  assign new_n90_ = x29 & (~new_n62_ | (~x18 & (~new_n67_ | ~new_n91_)));
  ...
  assign new_n95_ = new_n62_ & (x18 | (new_n96_ & new_n93_ & ~x25 & ~x26));
  assign new_n96_ = ~x22 & ~x23 & ~x24 & ~x20 & ~x21;
  assign new_n97_ = new_n64_ & new_n98_ & ~x24 & ~x25 & ~x26;
  ...
  assign new_n102_ = new_n69_ & new_n70_ & new_n103_ & ~x25 & ~x26 & ~x27;
  assign new_n103_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 ? ~x08 : (x16 ? (new_n105_ | new_n107_) : ~x02);
  assign new_n105_ = x32 & (~new_n69_ | (~x19 & (~new_n106_ | ~new_n63_ | ~new_n78_)));
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n107_ = new_n69_ & new_n70_ & new_n108_ & new_n109_;
  assign new_n108_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n109_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 ? ~x08 : (x16 ? (new_n111_ | new_n113_) : ~x01);
  assign new_n111_ = x33 & (~new_n69_ | (~x19 & (~new_n82_ | ~new_n112_)));
  ...
  assign new_n117_ = x34 & (~new_n69_ | (~x19 & (~new_n82_ | ~new_n93_ | ~new_n115_)));
  assign new_n118_ = new_n74_ & new_n75_ & new_n114_ & new_n119_;
