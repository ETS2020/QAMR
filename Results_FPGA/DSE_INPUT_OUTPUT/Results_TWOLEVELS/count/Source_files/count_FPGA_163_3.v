...
module FAU ( 
  ...
  assign z04 = x18 ? ~x10 : (x16 ? ~new_n60_ : ~x11);
  ...
  assign z06 = (x16 & (new_n71_ | (new_n73_ & new_n74_))) | x18 | (~x09 & ~x16);
  ...
  assign z07 = x18 ? ~x10 : (x16 ? ~new_n76_ : ~x08);
  assign new_n76_ = (~x26 | (new_n73_ & new_n74_)) & (~new_n73_ | ~new_n77_);
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? ~x10 : (x16 ? ~new_n79_ : ~x07);
  assign new_n79_ = (~x27 | (new_n73_ & new_n77_)) & (~new_n61_ | ~new_n80_);
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n84_ | (~new_n82_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n82_ = new_n65_ & (x18 | (new_n66_ & new_n83_ & ~x24 & ~x25));
  assign new_n83_ = ~x26 & ~x27;
  assign new_n84_ = new_n61_ & new_n85_;
  assign new_n85_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = x18 ? ~x10 : (new_n87_ | (~x05 & ~x16));
  assign new_n87_ = x16 & ((new_n62_ & new_n88_) | (x29 & (~new_n61_ | ~new_n85_)));
  assign new_n88_ = ~x27 & ~x28 & ~x29 & ~x24 & ~x25 & ~x26;
  assign z11 = (x16 & (new_n92_ | (~new_n90_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n90_ = new_n65_ & (x18 | (new_n72_ & new_n91_));
  assign new_n91_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n92_ = new_n62_ & new_n93_ & new_n94_ & ~x29 & ~x30;
  assign new_n93_ = ~x24 & ~x25 & ~x26;
  assign new_n94_ = ~x27 & ~x28;
  assign z12 = x18 ? ~x10 : (x16 ? (new_n96_ | new_n97_) : ~x03);
  assign new_n96_ = x31 & (~new_n62_ | ~new_n93_ | ~new_n94_ | x29 | x30);
  assign new_n97_ = new_n68_ & new_n69_ & new_n98_ & new_n83_ & ~x25;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n100_ | new_n103_));
  assign new_n100_ = x32 & (~new_n65_ | (~x18 & (~new_n101_ | ~new_n102_)));
  assign new_n101_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n103_ = new_n68_ & new_n69_ & new_n104_ & new_n105_;
  assign new_n104_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? ~x10 : (x16 ? (new_n107_ | new_n108_) : ~x01);
  assign new_n107_ = x33 & (~new_n68_ | ~new_n69_ | ~new_n104_ | ~new_n105_);
  assign new_n108_ = new_n73_ & new_n74_ & new_n109_ & new_n110_;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? ~x10 : (x16 ? ~new_n112_ : ~x00);
  assign new_n112_ = (~x34 | (new_n73_ & new_n74_ & new_n109_ & new_n110_)) & (~new_n73_ | ~new_n74_ | ~new_n109_ | ~new_n113_);
