...
module FAU ( 
  ...
  assign z04 = (~new_n54_ & x18) | (~new_n62_ & x16) | new_n54_ | (~x11 & ~x16);
  ...
  assign z06 = (~new_n54_ & x18) | (x16 & (new_n67_ | new_n68_)) | new_n54_ | (~x09 & ~x16);
  assign new_n67_ = x25 & (~new_n65_ | x21 | x22 | x23 | x24);
  assign new_n68_ = new_n69_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n69_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z07 = (~new_n54_ & ((new_n71_ & x16) | x18 | (~x08 & ~x16))) | (new_n72_ & x16);
  assign new_n71_ = x26 & (~new_n69_ | x22 | x23 | x24 | x25);
  assign new_n72_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n73_ & ~x22;
  assign new_n73_ = ~x23 & ~x24 & ~x25 & ~x26 & (x27 | (~x27 & x28));
  assign z08 = new_n75_ | (x16 & (new_n80_ | (~x19 & (new_n76_ | new_n81_))));
  assign new_n75_ = ~new_n54_ & (x18 | (~x07 & ~x16));
  assign new_n76_ = ~x17 & ~x20 & ~x21 & (new_n77_ | (new_n78_ & new_n79_));
  assign new_n77_ = x22 & x27;
  assign new_n78_ = ~x22 & ~x23 & ~x24;
  assign new_n79_ = ~x25 & ~x26 & ~x27 & x28;
  assign new_n80_ = ~new_n65_ & x27;
  assign new_n81_ = x27 & (x21 | x23 | x24 | x25 | x26);
  assign z09 = ((x27 | x28) & (x18 | (~x06 & ~x16))) | (x16 & ~new_n83_ & x28);
  assign new_n83_ = new_n65_ & (x19 | (new_n84_ & new_n85_));
  assign new_n84_ = ~x21 & ~x23 & (x17 | x20 | x21 | ~x22);
