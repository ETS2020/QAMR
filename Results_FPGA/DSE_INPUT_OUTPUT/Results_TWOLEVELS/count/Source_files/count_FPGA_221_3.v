...
module FAU ( 
  ...
  assign z06 = x18 ? ~x34 : (x16 ? ~new_n69_ : ~x09);
  ...
  assign new_n78_ = ~x19 & (~new_n79_ | ~new_n70_ | x21);
  ...
  assign new_n90_ = new_n57_ & (x19 | (new_n67_ & new_n88_ & ~x25 & ~x26));
  assign new_n91_ = new_n64_ & new_n87_ & new_n81_ & ~x29 & ~x30;
  assign z12 = x18 ? ~x34 : (x16 ? (new_n93_ | new_n94_) : ~x03);
  assign new_n93_ = x31 & (~new_n64_ | ~new_n87_ | ~new_n81_ | x29 | x30);
  assign new_n94_ = new_n57_ & new_n67_ & new_n95_ & ~x25 & ~x26 & ~x27;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n102_ | (x16 & (new_n100_ | (x32 & (new_n97_ | ~new_n57_))));
  assign new_n97_ = ~x19 & (~new_n98_ | ~new_n99_);
  assign new_n98_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n100_ = new_n57_ & new_n67_ & new_n85_ & new_n101_;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = ~x18 & (x02 | x16);
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n105_ | (new_n104_ & new_n107_)));
  assign new_n104_ = new_n58_ & new_n70_ & ~x24 & ~x25;
  ...
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n110_ | (new_n104_ & new_n111_)));
  assign new_n110_ = x34 & (~new_n57_ | (~x19 & (~new_n75_ | ~new_n88_ | ~new_n108_)));
