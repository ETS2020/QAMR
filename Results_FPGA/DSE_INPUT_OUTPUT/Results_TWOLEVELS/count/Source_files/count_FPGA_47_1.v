...
module FAU ( 
  ...
  assign z06 = x18 | (~x27 & (x16 ? (new_n67_ | new_n69_) : ~x09));
  ...
  assign z10 = (x16 & (new_n86_ | (~new_n84_ & x29))) | ~new_n54_ | (~x05 & ~x16);
  assign new_n84_ = new_n58_ & (x19 | (new_n85_ & ~x21 & ~x22 & ~x23));
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x28;
  assign new_n86_ = new_n81_ & new_n87_;
  assign new_n87_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28 & ~x29;
  assign z11 = x18 | (~x27 & (x16 ? (new_n89_ | new_n91_) : ~x04));
  assign new_n89_ = x30 & (~new_n58_ | (~x19 & (~new_n68_ | ~new_n90_)));
  ...
  assign new_n95_ = x31 & (~new_n58_ | (~x19 & (~new_n68_ | ~new_n96_)));
  assign new_n96_ = ~x25 & ~x26 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n92_ & new_n93_ & ~x28 & ~x29 & ~x30 & ~x31;
  ...
  assign new_n101_ = new_n58_ & new_n68_ & new_n102_ & ~x25 & ~x26 & ~x28;
  ...
  assign new_n105_ = ~x26 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = new_n58_ & new_n68_ & new_n90_ & new_n107_;
  ...
  assign new_n111_ = new_n59_ & new_n70_ & new_n112_ & new_n113_;
