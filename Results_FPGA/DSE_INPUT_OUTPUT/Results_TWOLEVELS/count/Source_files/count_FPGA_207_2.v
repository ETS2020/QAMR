...
module FAU ( 
  ...
  assign new_n72_ = ~x17 & ~x19 & ~x21;
  assign z08 = new_n78_ | (~x18 & (x16 ? (new_n74_ | new_n76_) : ~x07));
  assign new_n74_ = x27 & (~new_n75_ | x17 | x19 | x21 | x22);
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n76_ = new_n59_ & new_n77_ & ~x23 & ~x24;
  assign new_n77_ = ~x25 & ~x26 & ~x27;
  assign new_n78_ = x20 & (x18 | (x16 & x27));
  assign z09 = (x16 & (new_n80_ | (~new_n76_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n80_ = new_n59_ & new_n81_ & ~x23 & ~x24 & ~x25;
  assign new_n81_ = ~x26 & ~x27 & ~x28;
  assign z10 = (x20 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n83_ : ~x05));
  assign new_n83_ = (~new_n61_ | ~new_n86_) & (~x29 | (new_n84_ & new_n85_));
  assign new_n84_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x20 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n88_ : ~x04));
  assign new_n88_ = (~x30 | (new_n84_ & new_n86_)) & (~new_n61_ | ~new_n89_ | ~new_n90_);
  assign new_n89_ = ~x24 & ~x25 & ~x26;
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n95_ | (~x18 & (x16 ? (new_n92_ | new_n93_) : ~x03));
  assign new_n92_ = x31 & (~new_n67_ | ~new_n77_ | x28 | x29 | x30);
  assign new_n93_ = new_n56_ & new_n64_ & new_n77_ & new_n94_;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n95_ = x20 & (x18 | (x16 & x31));
  assign z13 = ~new_n99_ | (x16 & ((~new_n93_ & x32) | (new_n63_ & new_n97_)));
  ...
  assign new_n101_ = x33 & (~new_n72_ | ~new_n68_ | ~new_n81_ | ~new_n98_);
  assign new_n102_ = new_n57_ & new_n68_ & new_n103_ & new_n104_;
  ...
  assign new_n107_ = x34 & (~new_n72_ | ~new_n68_ | ~new_n103_ | ~new_n104_);
  assign new_n108_ = new_n57_ & new_n68_ & new_n103_ & new_n109_;
