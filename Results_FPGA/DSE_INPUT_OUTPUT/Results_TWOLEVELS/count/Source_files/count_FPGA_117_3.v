...
module FAU ( 
  ...
  assign z09 = x18 ? ~x32 : (x16 ? (new_n81_ | new_n83_) : ~x06);
  ...
  assign new_n86_ = new_n58_ & (x19 | (new_n67_ & new_n87_));
  ...
  assign z12 = x18 ? ~x32 : (x16 ? (new_n96_ | new_n98_) : ~x03);
  ...
  assign z15 = ~new_n115_ | (x16 & ((new_n70_ & new_n114_) | (~new_n111_ & x34)));
  assign new_n111_ = new_n113_ & (x19 | (~new_n112_ & (x32 | (new_n73_ & new_n102_))));
  assign new_n112_ = ~x18 & (x32 | x33);
  assign new_n113_ = (~x20 | x32) & (x18 | (~x17 & ~x19));
  assign new_n114_ = new_n109_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n115_ = (x00 | x16 | x18) & (~x18 | x32);
endmodule
