...
module FAU ( 
  ...
  assign z09 = ~new_n84_ | (x16 & ((~new_n80_ & x28) | (new_n77_ & new_n83_)));
  assign new_n80_ = new_n82_ & (x19 | ((x18 | (new_n81_ & ~x25)) & (new_n66_ | x25)));
  assign new_n81_ = ~x26 & ~x27;
  assign new_n82_ = (~x20 | x25) & (x18 | (~x17 & ~x19));
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n84_ = (x06 | x16 | x18) & (~x18 | x25);
  assign z10 = (x16 & (new_n86_ | (new_n88_ & new_n90_))) | (~x05 & ~x16) | x18;
  ...
  assign new_n92_ = x30 & (~new_n82_ | (~x19 & (new_n93_ | new_n94_)));
  assign new_n93_ = ~x18 & (x27 | x29 | x25 | x26);
  assign new_n94_ = ~x25 & (x21 | x22 | x23 | x24 | x28);
  ...
  assign new_n98_ = new_n57_ & (x19 | (new_n72_ & new_n81_ & new_n99_ & ~x28));
  assign new_n99_ = ~x29 & ~x30;
  assign new_n100_ = new_n57_ & new_n66_ & new_n101_ & new_n81_ & ~x25;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n103_ | new_n106_)) | (~x02 & ~x16 & ~x18) | (x18 & ~x25);
  assign new_n103_ = x32 & (~new_n82_ | (~x19 & (new_n104_ | (~new_n105_ & ~x25))));
  assign new_n104_ = ~x18 & (x25 | x26 | x27 | x29 | x31);
  assign new_n105_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x28 & ~x30;
  assign new_n106_ = new_n57_ & new_n66_ & new_n87_ & new_n99_ & ~x31 & ~x32;
  assign z14 = ~new_n112_ | (x16 & ((new_n69_ & new_n110_) | (~new_n108_ & x33)));
  assign new_n108_ = new_n82_ & (x19 | (~new_n104_ & (x25 | (new_n65_ & new_n109_))));
  assign new_n109_ = ~x24 & ~x28 & ~x30 & ~x32;
  assign new_n110_ = new_n111_ & new_n81_ & ~x28 & ~x29;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n112_ = (x01 | x16 | x18) & (~x18 | x25);
  assign z15 = (~x00 & ~x16) | x18 | (x16 & (new_n114_ | (new_n69_ & new_n115_)));
  assign new_n114_ = x34 & (~new_n57_ | (~x19 & (~new_n76_ | ~new_n89_ | ~new_n111_)));
  assign new_n115_ = new_n116_ & new_n81_ & ~x28 & ~x29;
