...
module FAU ( 
  ...
  assign z04 = (x23 & (~new_n59_ | (~new_n61_ & x16))) | ~x16 | new_n62_ | x18;
  assign new_n61_ = ~x20 & ~x21 & ~x22;
  assign new_n62_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = (~new_n64_ & x24) | ~x16 | x18 | (new_n56_ & new_n65_);
  assign new_n64_ = new_n59_ & (~x16 | (~x20 & ~x21 & ~x22 & ~x23));
  assign new_n65_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (x25 & (~new_n59_ | (~new_n68_ & x16))) | ~x16 | new_n67_ | x18;
  assign new_n67_ = new_n57_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n68_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = (x26 & (~new_n59_ | (~new_n72_ & x16))) | ~x16 | new_n70_ | x18;
  assign new_n70_ = new_n57_ & new_n71_ & ~x22 & ~x23;
  assign new_n71_ = ~x24 & ~x25 & ~x26;
  assign new_n72_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z08 = (x27 & (~new_n59_ | (~new_n74_ & x16))) | ~x16 | new_n76_ | x18;
  ...
  assign new_n81_ = new_n77_ & new_n82_ & new_n83_;
  assign new_n82_ = ~x23 & ~x24 & ~x25;
  assign new_n83_ = ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (x16 & (new_n85_ | (new_n62_ & new_n71_ & new_n87_)));
  assign new_n85_ = x29 & (~new_n56_ | (~x19 & (~new_n65_ | ~new_n86_)));
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (x16 & (new_n90_ | (x30 & (new_n89_ | ~new_n56_))));
  assign new_n89_ = ~x19 & (~new_n65_ | ~new_n75_ | ~new_n87_);
  assign new_n90_ = new_n62_ & new_n71_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n94_ | (x31 & (new_n92_ | ~new_n56_))));
  assign new_n92_ = ~x19 & (~new_n93_ | ~new_n82_ | x21 | x22);
  assign new_n93_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n94_ = new_n56_ & new_n65_ & new_n95_ & ~x25 & ~x26 & ~x27;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x32 & (~new_n59_ | (x16 & (~new_n97_ | ~new_n72_)))) | ~new_n98_ | ~x16;
  assign new_n97_ = new_n83_ & ~x29 & ~x30 & ~x31;
  assign new_n98_ = ~x18 & (~new_n86_ | ~new_n99_ | ~new_n56_ | ~new_n65_);
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = new_n101_ | ~x16 | x18 | (new_n67_ & new_n102_ & new_n103_);
  assign new_n101_ = x33 & (~new_n59_ | (x16 & (~new_n72_ | ~new_n83_ | ~new_n99_)));
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n105_ | (new_n67_ & new_n107_)));
  assign new_n105_ = x34 & (~new_n56_ | (~x19 & (~new_n106_ | ~new_n87_ | ~new_n103_)));
  assign new_n106_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n107_ = new_n102_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
