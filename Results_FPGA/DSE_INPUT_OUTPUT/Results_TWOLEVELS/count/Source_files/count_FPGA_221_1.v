...
module FAU ( 
  ...
  assign z06 = x18 | (~x34 & (new_n69_ | (~x09 & ~x16)));
  assign new_n69_ = x16 & ((x25 & (~new_n58_ | new_n70_)) | (new_n59_ & new_n71_));
  assign new_n70_ = ~x19 & (x23 | x24 | x21 | x22);
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 | (~x34 & (x16 ? ~new_n73_ : ~x08));
  assign new_n73_ = (~new_n59_ | ~new_n75_) & (~x26 | (new_n58_ & (new_n74_ | x19)));
  assign new_n74_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (~new_n77_ & x16) | ~new_n54_ | (~x07 & ~x16);
  ...
  assign z09 = (x16 & (new_n84_ | (~new_n82_ & x28))) | ~new_n54_ | (~x06 & ~x16);
  assign new_n82_ = new_n58_ & (x19 | (new_n66_ & new_n83_ & ~x24 & ~x25));
  assign new_n83_ = ~x26 & ~x27;
  assign new_n84_ = new_n79_ & new_n85_;
  assign new_n85_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = (x16 & (new_n87_ | (new_n89_ & new_n90_))) | ~new_n54_ | (~x05 & ~x16);
  ...
  assign z11 = (x16 & (new_n94_ | (~new_n92_ & x30))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n92_ = new_n58_ & (x19 | (new_n67_ & new_n93_));
  ...
  assign new_n97_ = x31 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n98_)));
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n99_ = new_n58_ & new_n67_ & new_n100_ & new_n83_ & ~x25;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n54_ | (~x02 & ~x16) | (x16 & (new_n102_ | new_n104_));
  assign new_n102_ = x32 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n103_)));
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n104_ = new_n58_ & new_n67_ & new_n88_ & new_n105_ & ~x31 & ~x32;
  assign new_n105_ = ~x29 & ~x30;
  assign z14 = (x16 & (new_n108_ | (new_n107_ & new_n110_))) | ~new_n54_ | (~x01 & ~x16);
  assign new_n107_ = new_n59_ & new_n71_;
  assign new_n108_ = x33 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n109_)));
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = new_n83_ & ~x28 & ~x29 & new_n111_ & ~x30 & ~x31;
  assign new_n111_ = ~x32 & ~x33;
  assign z15 = ~new_n54_ | new_n113_ | (~x00 & ~x16);
  assign new_n113_ = new_n67_ & new_n114_ & new_n88_ & new_n105_ & new_n111_ & ~x31;
  assign new_n114_ = ~x19 & ~x20 & x16 & ~x17;
endmodule
