...
module FAU ( 
  ...
  assign new_n68_ = x25 & (~new_n62_ | (~new_n69_ & ~x18));
  ...
  assign new_n72_ = new_n62_ & (new_n73_ | x18);
  assign new_n73_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n74_ = new_n57_ & ~x22 & ~x23 & new_n75_ & ~x24;
  ...
  assign new_n82_ = new_n62_ & (x18 | (new_n83_ & new_n84_));
  ...
  assign new_n88_ = new_n62_ & (x18 | (new_n83_ & new_n86_ & ~x24 & ~x25));
  assign new_n89_ = new_n64_ & new_n90_ & new_n75_ & ~x24;
  assign new_n90_ = ~x27 & ~x28 & ~x29;
  assign z11 = x16 ? (~x18 & (new_n94_ | (~new_n92_ & x30))) : (~x04 | x18);
  assign new_n92_ = new_n56_ & (x19 | (new_n93_ & new_n75_ & new_n90_));
  assign new_n93_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n94_ = new_n64_ & new_n95_ & new_n75_ & ~x24;
  ...
  assign new_n100_ = new_n56_ & new_n93_ & new_n101_ & ~x25 & ~x26 & ~x27;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x16 ? (~x18 & (new_n105_ | (~new_n103_ & x32))) : (~x02 | x18);
  assign new_n103_ = new_n56_ & (x19 | (new_n98_ & new_n104_));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n56_ & new_n93_ & new_n106_ & new_n75_ & ~x27 & ~x28;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n108_ | (new_n70_ & new_n109_))) | x18 | (~x01 & ~x16);
  assign new_n108_ = x33 & (~new_n62_ | (~x18 & (~new_n73_ | ~new_n86_ | ~new_n106_)));
  ...
  assign new_n112_ = new_n62_ & (x18 | (new_n63_ & new_n78_ & new_n90_ & new_n110_));
