...
module FAU ( 
  ...
  assign new_n67_ = new_n58_ & new_n68_ & new_n69_;
  assign new_n68_ = ~x22 & ~x23;
  assign new_n69_ = ~x24 & ~x25;
  assign z07 = (~new_n71_ & x16) | x18 | (~x08 & ~x16);
  assign new_n71_ = (~x26 | (new_n58_ & new_n68_ & new_n69_)) & (~new_n58_ | ~new_n68_ | ~new_n72_);
  assign new_n72_ = ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? ~x33 : (x16 ? ~new_n74_ : ~x07);
  assign new_n74_ = (~x27 | (new_n58_ & new_n68_ & new_n72_)) & (~new_n60_ | ~new_n75_);
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? ~x33 : (x16 ? ~new_n77_ : ~x06);
  assign new_n77_ = (~x28 | (new_n60_ & new_n75_)) & (~new_n60_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x33 : (x16 ? (new_n80_ | new_n81_) : ~x05);
  assign new_n80_ = x29 & (~new_n60_ | ~new_n78_);
  assign new_n81_ = new_n62_ & new_n72_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n83_ & x16) | x18 | (~x04 & ~x16);
  assign new_n83_ = (~x30 | (new_n62_ & new_n72_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n72_ | x27 | x28 | x29 | x30);
  assign z12 = x18 ? ~x33 : (x16 ? (new_n85_ | new_n87_) : ~x03);
  assign new_n85_ = x31 & (~new_n62_ | ~new_n72_ | ~new_n86_ | x29 | x30);
  assign new_n86_ = ~x27 & ~x28;
  assign new_n87_ = new_n57_ & new_n65_ & new_n88_ & ~x25 & ~x26 & ~x27;
  ...
  assign z14 = ~new_n96_ | (x16 & ((~new_n90_ & x33) | (new_n67_ & new_n94_)));
  assign new_n94_ = new_n95_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x18 & (x01 | x16);
  assign z15 = (~new_n101_ & ~x18) | (~x33 & (x18 | (x16 & (new_n98_ | new_n99_))));
  assign new_n98_ = x34 & (~new_n57_ | ~new_n65_ | ~new_n91_ | ~new_n92_);
  assign new_n99_ = new_n58_ & new_n68_ & new_n69_ & new_n95_ & new_n100_;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x34;
  assign new_n101_ = x16 ? (~x33 | ~x34) : x00;
endmodule
