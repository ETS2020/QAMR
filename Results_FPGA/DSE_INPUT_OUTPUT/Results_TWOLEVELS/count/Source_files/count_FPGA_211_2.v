...
module FAU ( 
  ...
  assign z00 = (x16 & (~x17 ^ x19)) | x06 | x18 | (~x15 & ~x16);
  ...
  assign z08 = x18 | (~x06 & (x16 ? ~new_n75_ : ~x07));
  assign new_n75_ = (~x27 | (new_n58_ & (new_n76_ | x19))) & (~new_n77_ | ~new_n78_);
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x28 & (new_n80_ | ~new_n58_)) | ~new_n82_ | x06 | ~x16;
  assign new_n80_ = ~x19 & (~new_n81_ | x21 | x22 | x23);
  assign new_n81_ = ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n82_ = ~x18 & (~new_n77_ | ~new_n83_);
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x06 & (x16 ? (new_n85_ | new_n87_) : ~x05));
  assign new_n85_ = x29 & (~new_n58_ | (~x19 & (~new_n68_ | ~new_n86_)));
  ...
  assign z11 = x18 | (~x06 & (x16 ? (new_n92_ | new_n94_) : ~x04));
  assign new_n92_ = x30 & (~new_n58_ | (~x19 & (~new_n68_ | ~new_n93_)));
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n94_ = new_n88_ & new_n89_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x06 & (x16 ? (new_n96_ | new_n98_) : ~x03));
  assign new_n96_ = x31 & (~new_n58_ | (~x19 & (~new_n72_ | ~new_n97_)));
  ...
  assign new_n101_ = x32 & (~new_n58_ | (~x19 & (~new_n72_ | ~new_n102_)));
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n103_ = new_n58_ & new_n68_ & new_n86_ & new_n104_ & ~x29 & ~x30;
  assign new_n104_ = ~x31 & ~x32;
  assign z14 = ~new_n110_ | (x16 & (new_n106_ | (new_n69_ & new_n108_ & new_n109_)));
  assign new_n106_ = x33 & (~new_n58_ | (~x19 & (~new_n76_ | ~new_n107_)));
  assign new_n107_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n108_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n109_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n110_ = ~x06 & ~x18 & (x01 | x16);
  assign z15 = ~new_n114_ | (x16 & (new_n112_ | (new_n69_ & new_n113_)));
  assign new_n112_ = x34 & (~new_n58_ | (~x19 & (~new_n76_ | ~new_n90_ | ~new_n109_)));
  assign new_n113_ = new_n108_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n114_ = ~x06 & ~x18 & (x00 | x16);
endmodule
