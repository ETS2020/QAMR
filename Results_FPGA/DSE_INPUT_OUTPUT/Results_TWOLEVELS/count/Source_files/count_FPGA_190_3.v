...
module FAU ( 
  ...
  assign z08 = x18 ? ~x04 : (x16 ? ~new_n74_ : ~x07);
  ...
  assign new_n84_ = new_n56_ & (x19 | (new_n66_ & new_n85_));
  ...
  assign z11 = (~x04 & (~x16 | x18)) | (x16 & ~x18 & (new_n92_ | (~new_n91_ & x30)));
  assign new_n91_ = new_n56_ & (x19 | (new_n66_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n87_ & new_n88_ & new_n82_ & ~x29 & ~x30;
  assign z12 = x18 ? ~x04 : (x16 ? (new_n94_ | new_n96_) : ~x03);
  assign new_n94_ = x31 & (~new_n56_ | (~x19 & (~new_n71_ | ~new_n95_)));
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n56_ & new_n66_ & new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x04 : (x16 ? (new_n99_ | new_n101_) : ~x02);
  assign new_n99_ = x32 & (~new_n56_ | (~x19 & (~new_n71_ | ~new_n100_)));
  ...
  assign z14 = x18 ? ~x04 : (x16 ? (new_n104_ | new_n106_) : ~x01);
  ...
  assign z15 = x18 ? ~x04 : (x16 ? (new_n110_ | new_n111_) : ~x00);
  assign new_n110_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n89_ | ~new_n108_)));
