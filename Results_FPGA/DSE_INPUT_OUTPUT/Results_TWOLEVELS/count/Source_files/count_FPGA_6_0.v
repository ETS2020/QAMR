...
module FAU ( 
  ...
  assign z06 = (x25 & (~new_n69_ | (~new_n67_ & x16))) | ~x16 | new_n68_ | x18;
  assign new_n67_ = ~x20 & (new_n65_ | x19);
  ...
  assign z09 = (x28 & (~new_n69_ | (~new_n82_ & x16))) | ~x16 | new_n83_ | x18;
  assign new_n82_ = ~x20 & (x19 | (new_n64_ & new_n80_ & ~x24 & ~x25));
  ...
  assign new_n86_ = x29 & (~new_n56_ | (~x19 & (~new_n65_ | ~new_n87_)));
  ...
  assign new_n91_ = ~x20 & (x19 | (new_n65_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n88_ & new_n74_ & new_n93_ & ~x27 & ~x28;
  assign new_n93_ = ~x29 & ~x30;
  assign z12 = (x31 & (~new_n69_ | (~new_n95_ & x16))) | ~x16 | new_n96_ | x18;
  assign new_n95_ = ~x20 & (x19 | (new_n72_ & new_n80_ & new_n93_ & ~x28));
  ...
  assign new_n101_ = new_n56_ & new_n65_ & new_n87_ & new_n93_ & ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((new_n68_ & new_n105_) | (~new_n103_ & x33)));
  assign new_n103_ = new_n56_ & (x19 | (new_n77_ & new_n104_));
  ...
  assign new_n108_ = x34 & (~new_n56_ | (~x19 & (~new_n77_ | ~new_n89_ | ~new_n106_)));
  assign new_n109_ = new_n110_ & new_n80_ & ~x28 & ~x29;
