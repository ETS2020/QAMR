...
module FAU ( 
  ...
  assign new_n94_ = new_n89_ & new_n90_ & ~x27 & ~x28 & ~x29 & ~x30;
  ...
  assign z15 = (x16 & (new_n111_ | (new_n70_ & new_n112_))) | (~x00 & ~x16) | x18;
  assign new_n111_ = x34 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n91_ | ~new_n109_)));
  assign new_n112_ = new_n113_ & ~x28 & ~x29 & ~x26 & ~x27;
