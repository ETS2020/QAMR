...
module FAU ( 
  ...
  assign new_n85_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n86_))));
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = new_n61_ & new_n88_ & ~x24 & ~x25 & ~x26;
  assign new_n88_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n92_ | (~new_n90_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n90_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n91_))));
  ...
  assign new_n95_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n72_ & new_n96_))));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n64_ & new_n67_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x16 ? (~x18 & (new_n100_ | new_n102_)) : (~x02 | x18);
  assign new_n100_ = x32 & (~new_n64_ | (~x19 & (~new_n72_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n64_ & new_n67_ & new_n86_ & new_n103_;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n105_ | (new_n68_ & new_n107_))) : (~x01 | x18);
  assign new_n105_ = x33 & (~new_n64_ | (~x19 & (~new_n76_ | ~new_n106_)));
  assign new_n106_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = new_n108_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x16 ? (~x18 & (new_n110_ | (new_n68_ & new_n111_))) : (~x00 | x18);
  assign new_n110_ = x34 & (~new_n64_ | (~x19 & (~new_n76_ | ~new_n88_ | ~new_n108_)));
