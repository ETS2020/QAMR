...
module FAU ( 
  ...
  assign z04 = (~x11 & (~x16 | x18)) | (x16 & ~new_n62_ & ~x18);
  ...
  assign z09 = x18 ? ~x11 : (x16 ? (new_n81_ | new_n83_) : ~x06);
  ...
  assign z12 = x18 ? ~x11 : (x16 ? (new_n97_ | new_n99_) : ~x03);
  ...
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n104_ | (~new_n102_ & x32)));
