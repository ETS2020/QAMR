...
module FAU ( 
  ...
  assign new_n59_ = (~x22 | (new_n60_ & (new_n61_ | x18))) & (~new_n60_ | ~new_n62_);
  ...
  assign new_n71_ = new_n60_ & new_n61_ & new_n72_ & ~x24 & ~x25;
  assign new_n72_ = ~x22 & ~x23;
  assign z07 = (~new_n74_ & x16) | x18 | (~x08 & ~x16);
  assign new_n74_ = (~x26 | (new_n60_ & (new_n75_ | x18))) & (~new_n76_ | ~new_n60_ | ~new_n61_);
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n76_ = ~x24 & ~x25 & ~x26 & ~x22 & ~x23;
  assign z08 = (x16 & (new_n80_ | (~new_n78_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n78_ = new_n60_ & (x18 | (new_n62_ & new_n79_));
  assign new_n79_ = ~x25 & ~x26 & ~x23 & ~x24;
  assign new_n80_ = new_n81_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  ...
  assign new_n85_ = new_n81_ & new_n86_ & ~x23 & ~x24 & ~x25;
  assign new_n86_ = ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n93_ | (x16 & (new_n89_ | (x29 & (new_n88_ | ~new_n60_))));
  assign new_n88_ = ~x18 & (~new_n61_ | ~new_n72_ | ~new_n86_ | x24 | x25);
  ...
  assign z12 = (x16 & (new_n102_ | (~new_n99_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n99_ = new_n60_ & (x18 | (new_n100_ & new_n101_));
  assign new_n100_ = ~x22 & ~x23 & ~x24 & ~x20 & ~x21;
  ...
  assign z13 = (x16 & (new_n107_ | (~new_n105_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n105_ = new_n60_ & (x18 | (new_n75_ & new_n106_));
  ...
  assign z14 = (x16 & (new_n110_ | (new_n71_ & new_n111_))) | x18 | (~x01 & ~x16);
  assign new_n110_ = x33 & (~new_n60_ | (~x18 & (~new_n75_ | ~new_n86_ | ~new_n108_)));
  assign new_n111_ = new_n112_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n112_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = ~new_n117_ | (x16 & ((new_n71_ & new_n115_) | (~new_n114_ & x34)));
  assign new_n114_ = new_n60_ & (x18 | (new_n62_ & new_n79_ & new_n92_ & new_n112_));
  assign new_n115_ = new_n116_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n116_ = ~x32 & ~x33 & ~x34 & ~x30 & ~x31;
