...
module FAU ( 
  ...
  assign z07 = (x26 & (~new_n66_ | (~new_n76_ & ~x08))) | ~new_n78_ | x08 | ~x16;
  assign new_n76_ = ~x20 & ~x21 & ~x22 & new_n77_ & ~x23;
  assign new_n77_ = ~x24 & ~x25;
  assign new_n78_ = ~x18 & (~new_n73_ | ~new_n79_ | x22 | x23);
  ...
  assign z09 = ~new_n88_ | (x16 & ((~new_n86_ & x28) | (new_n87_ & new_n84_)));
  assign new_n86_ = new_n66_ & (x08 | (new_n68_ & new_n77_ & ~x26 & ~x27));
  assign new_n87_ = ~x26 & ~x27 & ~x28 & new_n77_ & ~x23;
  assign new_n88_ = ~x08 & ~x18 & (x06 | x16);
  assign z10 = (x16 & (new_n90_ | new_n92_)) | x08 | x18 | (~x05 & ~x16);
  assign new_n90_ = x29 & (~new_n66_ | (~x08 & (~new_n68_ | ~new_n91_)));
  assign new_n91_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n92_ = new_n63_ & new_n79_ & new_n93_;
  assign new_n93_ = ~x27 & ~x28 & ~x29;
  assign z11 = ~new_n98_ | (x16 & (new_n97_ | (~new_n95_ & x30)));
  assign new_n95_ = new_n66_ & (x08 | (new_n96_ & new_n93_ & ~x25 & ~x26));
  assign new_n96_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n97_ = new_n63_ & new_n79_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n98_ = ~x08 & ~x18 & (x04 | x16);
  assign z12 = (x16 & (new_n100_ | new_n102_)) | x08 | x18 | (~x03 & ~x16);
  assign new_n100_ = x31 & (~new_n66_ | (~x08 & (~new_n96_ | ~new_n101_)));
  ...
  assign new_n108_ = new_n67_ & new_n69_ & new_n109_ & new_n110_;
  assign new_n109_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n110_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x08 & (x16 ? (new_n112_ | new_n114_) : ~x01));
  assign new_n112_ = x33 & (~new_n67_ | (~x19 & (~new_n82_ | ~new_n113_)));
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x27 & ~x28 & ~x29;
  assign new_n114_ = new_n73_ & new_n74_ & new_n115_ & new_n116_;
  assign new_n115_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n116_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x08 & (x16 ? (new_n118_ | new_n119_) : ~x00));
  assign new_n118_ = x34 & (~new_n67_ | (~x19 & (~new_n82_ | ~new_n93_ | ~new_n116_)));
  assign new_n119_ = new_n73_ & new_n74_ & new_n115_ & new_n120_;
