...
module FAU ( 
  ...
  assign z05 = x18 | (~x34 & (x16 ? ~new_n63_ : ~x10));
  ...
  assign z06 = (x16 & (new_n68_ | new_n70_)) | (~x09 & ~x16) | x18 | x34;
  assign new_n68_ = x25 & (x17 | x19 | (~new_n69_ & ~x34));
  ...
  assign new_n74_ = (~x26 | (new_n64_ & (new_n75_ | x19))) & (~new_n71_ | ~new_n76_);
  assign new_n75_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x34 & (x16 ? ~new_n78_ : ~x07));
  assign new_n78_ = (~x27 | (new_n64_ & (new_n79_ | x19))) & (~new_n80_ | ~new_n81_);
  ...
  assign new_n83_ = x28 & (~new_n64_ | (~x19 & (~new_n65_ | ~new_n84_)));
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n85_ = new_n80_ & new_n86_;
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x34 & (x16 ? (new_n88_ | new_n90_) : ~x05));
  assign new_n88_ = x29 & (~new_n64_ | (~x19 & (~new_n66_ | ~new_n89_)));
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n90_ = new_n91_ & new_n92_ & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n92_ = ~x24 & ~x25 & ~x26;
  assign z11 = (x16 & (new_n94_ | new_n96_)) | (~x04 & ~x16) | x18 | x34;
  assign new_n94_ = x30 & (x17 | x19 | (~x34 & (~new_n69_ | ~new_n95_)));
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = new_n91_ & new_n92_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x34 & (x16 ? (new_n98_ | new_n100_) : ~x03));
  assign new_n98_ = x31 & (~new_n64_ | (~x19 & (~new_n75_ | ~new_n99_)));
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n100_ = new_n64_ & new_n66_ & new_n101_ & ~x25 & ~x26 & ~x27;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x34 & (x16 ? (new_n103_ | new_n105_) : ~x02));
  assign new_n103_ = x32 & (~new_n64_ | (~x19 & (~new_n75_ | ~new_n104_)));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n64_ & new_n66_ & new_n89_ & new_n106_;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x34 & (x16 ? (new_n108_ | new_n110_) : ~x01));
  assign new_n108_ = x33 & (~new_n64_ | (~x19 & (~new_n79_ | ~new_n109_)));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n71_ & new_n72_ & new_n111_ & new_n112_;
  assign new_n111_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n112_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n114_ | x18;
  assign new_n114_ = ~x34 & (new_n115_ | (new_n66_ & new_n116_ & new_n89_ & new_n117_));
  assign new_n115_ = ~x00 & ~x16;
  assign new_n116_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n117_ = ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
endmodule
