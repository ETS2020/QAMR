...
module FAU ( 
  ...
  assign z06 = (~new_n65_ & x25) | ~x16 | new_n67_ | x18;
  assign new_n65_ = new_n56_ & (new_n66_ | x19);
  assign new_n66_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n67_ = new_n57_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = ~new_n69_ | (x26 & (~new_n56_ | (~new_n71_ & ~x19)));
  assign new_n69_ = x16 & ~x18 & (~new_n57_ | ~new_n70_ | x22 | x23);
  ...
  assign z09 = x18 | (x16 & (new_n80_ | (x28 & (new_n78_ | ~new_n56_))));
  ...
  assign new_n88_ = new_n56_ & (x19 | (new_n66_ & new_n86_ & ~x25 & ~x26));
  assign new_n89_ = new_n85_ & new_n70_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n91_ & x31) | ~x16 | new_n93_ | x18;
  assign new_n91_ = new_n56_ & (x19 | (new_n71_ & new_n92_ & ~x26 & ~x27));
  assign new_n92_ = ~x28 & ~x29 & ~x30;
  assign new_n93_ = new_n56_ & new_n66_ & new_n94_ & ~x25 & ~x26 & ~x27;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~new_n97_ & x32) | ~x16 | x18 | (new_n96_ & new_n99_);
  assign new_n96_ = new_n56_ & new_n66_;
  assign new_n97_ = new_n56_ & (x19 | (new_n71_ & new_n98_));
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n99_ = new_n84_ & ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = (~new_n101_ & x33) | ~x16 | x18 | (new_n67_ & new_n103_);
  assign new_n101_ = new_n56_ & (x19 | (new_n74_ & new_n102_));
  assign new_n102_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n103_ = new_n104_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n106_ | ~x16 | x18 | (new_n67_ & new_n107_);
  assign new_n106_ = x34 & (~new_n56_ | (~x19 & (~new_n74_ | ~new_n86_ | ~new_n104_)));
