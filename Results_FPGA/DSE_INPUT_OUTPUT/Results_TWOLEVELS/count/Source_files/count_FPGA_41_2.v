...
module FAU ( 
  ...
  assign new_n93_ = new_n56_ & (x19 | (new_n66_ & new_n90_ & ~x25 & ~x26));
  assign new_n94_ = new_n88_ & new_n89_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = new_n100_ | (~x18 & (x16 ? (new_n96_ | new_n98_) : ~x03));
  assign new_n96_ = x31 & (~new_n56_ | (~x19 & (~new_n69_ | ~new_n97_)));
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n56_ & new_n66_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n100_ = x21 & (x18 | (x16 & x31));
  ...
  assign new_n108_ = x33 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n109_)));
  ...
  assign z15 = (x16 & (new_n115_ | (new_n67_ & new_n116_))) | x18 | (~x00 & ~x16);
  assign new_n115_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n90_ | ~new_n112_)));
