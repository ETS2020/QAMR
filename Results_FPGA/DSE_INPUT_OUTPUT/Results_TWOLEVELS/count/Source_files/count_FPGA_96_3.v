...
module FAU ( 
  ...
  assign new_n76_ = new_n59_ & (x18 | (new_n61_ & new_n77_));
  ...
  assign new_n80_ = new_n59_ & (x18 | (new_n81_ & new_n70_ & ~x26 & ~x27));
  assign new_n81_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n82_ = new_n63_ & new_n83_ & new_n70_ & ~x23;
  assign new_n83_ = ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n85_ | (new_n86_ & new_n64_))) | x18 | (~x05 & ~x16);
  assign new_n85_ = x29 & (~new_n59_ | (~x18 & (~new_n81_ | ~new_n70_ | ~new_n83_)));
  assign new_n86_ = new_n87_ & ~x24 & ~x25 & ~x26;
  assign new_n87_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n91_ | (~new_n89_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n89_ = new_n59_ & (x18 | (new_n90_ & new_n87_ & ~x25 & ~x26));
  assign new_n90_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n91_ = new_n64_ & new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n94_ | (new_n66_ & new_n96_)));
  assign new_n94_ = x31 & (~new_n59_ | (~x18 & (~new_n90_ | ~new_n95_)));
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n99_ | (new_n66_ & new_n101_)));
  assign new_n99_ = x32 & (~new_n59_ | (~x18 & (~new_n73_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n102_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n104_ | (new_n69_ & new_n105_)));
  assign new_n104_ = x33 & (~new_n59_ | (~x18 & (~new_n73_ | ~new_n83_ | ~new_n102_)));
  assign new_n105_ = new_n106_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n111_ | (x16 & ((new_n69_ & new_n109_) | (~new_n108_ & x34)));
  assign new_n108_ = new_n59_ & (x18 | (new_n61_ & new_n77_ & new_n87_ & new_n106_));
