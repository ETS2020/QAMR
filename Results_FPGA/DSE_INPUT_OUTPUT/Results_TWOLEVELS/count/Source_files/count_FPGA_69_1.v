...
module FAU ( 
  ...
  assign z07 = x18 | (~x20 & (new_n70_ | (~x08 & ~x16)));
  assign new_n70_ = x16 & ((x26 & (~new_n60_ | ~new_n68_)) | (new_n61_ & new_n71_));
  assign new_n71_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x20 & (x16 ? ~new_n73_ : ~x07));
  assign new_n73_ = (~x27 | (new_n61_ & ~x25 & ~x26 & ~x23 & ~x24)) & (~new_n61_ | x23 | x24 | x25 | x26 | x27);
  assign z09 = x18 | (~x20 & (x16 ? (new_n75_ | new_n77_) : ~x06));
  assign new_n75_ = x28 & (~new_n61_ | ~new_n76_ | x23 | x24);
  ...
  assign z11 = x18 | (~x20 & (x16 ? (new_n83_ | new_n84_) : ~x04));
  assign new_n83_ = x30 & (~new_n63_ | ~new_n81_);
  assign new_n84_ = new_n65_ & new_n76_ & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x20 & (x16 ? ~new_n86_ : ~x03));
  assign new_n86_ = (~x31 | (new_n65_ & new_n76_ & ~x28 & ~x29 & ~x30)) & (~new_n65_ | ~new_n76_ | x28 | x29 | x30 | x31);
  assign z13 = x18 | (~x20 & (x16 ? (new_n88_ | new_n90_) : ~x02));
  assign new_n88_ = x32 & (~new_n65_ | ~new_n76_ | ~new_n89_ | x30 | x31);
  ...
  assign new_n93_ = x33 & (~new_n60_ | ~new_n68_ | ~new_n78_ | ~new_n91_);
  assign new_n94_ = new_n60_ & new_n68_ & new_n95_ & new_n96_;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n101_ | (x16 & ((~new_n94_ & x34) | (new_n98_ & new_n99_)));
  assign new_n98_ = new_n61_ & new_n71_;
