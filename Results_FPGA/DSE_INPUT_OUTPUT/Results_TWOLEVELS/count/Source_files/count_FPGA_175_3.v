...
module FAU ( 
  ...
  assign new_n68_ = x25 & (~new_n62_ | (~new_n69_ & ~x19));
  ...
  assign new_n84_ = new_n79_ & (x18 | (new_n86_ & new_n85_ & ~x26 & ~x27));
  assign new_n85_ = ~x24 & ~x25;
  assign new_n86_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n87_ = new_n82_ & ~x26 & ~x27 & ~x28 & new_n85_ & ~x23;
  assign z10 = (x16 & (new_n89_ | (new_n91_ & new_n64_))) | x18 | (~x05 & ~x16);
  assign new_n89_ = x29 & (~new_n79_ | (~x18 & (~new_n86_ | ~new_n90_)));
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x24 & ~x25;
  assign new_n91_ = new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n96_ | (~new_n94_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n94_ = new_n79_ & (x18 | (new_n95_ & new_n92_ & ~x25 & ~x26));
  assign new_n95_ = ~x22 & ~x23 & ~x24 & ~x20 & ~x21;
  assign new_n96_ = new_n64_ & new_n97_ & ~x24 & ~x25 & ~x26;
  assign new_n97_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n99_ | new_n101_));
  assign new_n99_ = x31 & (~new_n79_ | (~x18 & (~new_n95_ | ~new_n100_)));
  assign new_n100_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n101_ = new_n62_ & new_n69_ & new_n102_ & ~x25 & ~x26 & ~x27;
  assign new_n102_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 ? ~x08 : (x16 ? (new_n104_ | new_n106_) : ~x02);
  assign new_n104_ = x32 & (~new_n62_ | (~x19 & (~new_n75_ | ~new_n105_)));
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n106_ = new_n62_ & new_n69_ & new_n107_ & new_n108_;
  assign new_n107_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n108_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 ? ~x08 : (x16 ? (new_n110_ | new_n113_) : ~x01);
  assign new_n110_ = x33 & (~new_n62_ | (~x19 & (~new_n111_ | ~new_n112_)));
  assign new_n111_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n112_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n113_ = new_n71_ & new_n72_ & new_n114_ & new_n115_;
  assign new_n114_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n115_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x18 ? ~x08 : (x16 ? (new_n117_ | new_n118_) : ~x00);
  assign new_n117_ = x34 & (~new_n62_ | (~x19 & (~new_n111_ | ~new_n92_ | ~new_n115_)));
  assign new_n118_ = new_n71_ & new_n72_ & new_n114_ & new_n119_;
