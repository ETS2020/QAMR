...
module FAU ( 
  ...
  assign new_n74_ = new_n68_ & (new_n75_ | x18);
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n76_ = new_n71_ & new_n77_ & ~x22 & ~x23;
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n82_ | (~new_n79_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n79_ = new_n68_ & (x18 | (new_n80_ & new_n81_ & ~x25 & ~x26));
  assign new_n80_ = ~x20 & ~x21 & ~x22;
  assign new_n81_ = ~x23 & ~x24;
  assign new_n82_ = new_n60_ & new_n81_ & new_n83_;
  assign new_n83_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n88_ | (~new_n85_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n85_ = new_n68_ & (x18 | (new_n87_ & new_n86_ & ~x26 & ~x27));
  assign new_n86_ = ~x24 & ~x25;
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = new_n60_ & new_n89_ & new_n86_ & ~x23;
  assign new_n89_ = ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n92_ | (~new_n91_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n91_ = new_n68_ & (x18 | (new_n87_ & new_n86_ & new_n89_));
  assign new_n92_ = new_n61_ & new_n77_ & ~x27 & ~x28 & ~x29;
  assign z11 = x16 ? (~new_n94_ & ~x18) : (~x04 | x18);
  assign new_n94_ = (~x30 | (new_n61_ & new_n77_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n77_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n96_ | new_n98_));
  assign new_n96_ = x31 & (~new_n68_ | (~x18 & (~new_n69_ | ~new_n97_)));
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x25 & ~x26 & ~x27;
  assign new_n98_ = new_n64_ & new_n65_ & new_n83_ & new_n99_;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x16 ? (~x18 & (new_n101_ | (new_n63_ & new_n102_))) : (~x02 | x18);
  assign new_n101_ = x32 & (~new_n64_ | ~new_n65_ | ~new_n83_ | ~new_n99_);
  assign new_n102_ = new_n103_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n106_ | (~new_n105_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n105_ = new_n68_ & (x18 | (new_n75_ & new_n89_ & new_n103_));
  assign new_n106_ = new_n71_ & new_n72_ & new_n107_ & new_n108_;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x16 ? (~new_n110_ & ~x18) : (~x00 | x18);
  assign new_n110_ = (~x34 | (new_n71_ & new_n72_ & new_n107_ & new_n108_)) & (~new_n107_ | ~new_n111_ | ~new_n71_ | ~new_n72_);
