...
module FAU ( 
  ...
  assign z02 = (~new_n57_ & x16) | x18 | ~x28 | (~x13 & ~x16);
  assign new_n57_ = (x17 | x19 | x20 | x21 | ~x28) & (~x21 | (~x17 & ~x19 & ~x20));
  ...
  assign z07 = (x16 & (new_n73_ | new_n75_)) | x18 | ~x28 | (~x08 & ~x16);
  ...
  assign z08 = x18 | (x28 & (x16 ? ~new_n78_ : ~x07));
  assign new_n78_ = (~x27 | (new_n76_ & new_n79_)) & (~new_n63_ | ~new_n80_);
  ...
  assign z14 = (~x01 & ~x16) | (x16 & x33) | x18 | ~x28;
