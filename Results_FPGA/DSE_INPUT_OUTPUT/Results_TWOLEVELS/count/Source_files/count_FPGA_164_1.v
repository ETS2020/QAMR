...
module FAU ( 
  ...
  wire new_n56_, new_n58_, new_n60_, new_n61_, new_n63_, new_n64_, new_n65_,
    ...
    new_n116_, new_n117_;
  assign z00 = x18 ? x15 : (x16 ? (~x17 ^ x19) : ~x15);
  ...
  assign z03 = x18 ? x15 : (x16 ? ~new_n58_ : ~x12);
  ...
  assign z06 = (x16 & (new_n69_ | (new_n70_ & new_n71_))) | x18 | (~x09 & ~x16);
  ...
  assign new_n73_ = (~new_n70_ | ~new_n75_) & (~x26 | (new_n65_ & (new_n74_ | x19)));
  ...
  assign z09 = x18 ? x15 : (x16 ? (new_n82_ | new_n85_) : ~x06);
  assign new_n82_ = x28 & (~new_n65_ | (~x19 & (~new_n83_ | ~new_n84_)));
  ...
  assign z10 = (x16 & (new_n90_ | (~new_n88_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n88_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n89_))));
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n90_ = new_n61_ & new_n91_ & ~x24 & ~x25 & ~x26;
  assign new_n91_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 ? x15 : (x16 ? (new_n93_ | new_n95_) : ~x04);
  assign new_n93_ = x30 & (~new_n65_ | (~x19 & (~new_n67_ | ~new_n94_)));
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n61_ & new_n96_ & ~x24 & ~x25 & ~x26;
  assign new_n96_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 ? x15 : (x16 ? (new_n98_ | new_n100_) : ~x03);
  assign new_n98_ = x31 & (~new_n65_ | (~x19 & (~new_n74_ | ~new_n99_)));
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n100_ = new_n65_ & new_n67_ & new_n101_ & ~x25 & ~x26 & ~x27;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? x15 : (x16 ? (new_n103_ | new_n105_) : ~x02);
  assign new_n103_ = x32 & (~new_n65_ | (~x19 & (~new_n74_ | ~new_n104_)));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n65_ & new_n67_ & new_n89_ & new_n106_;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? x15 : (x16 ? (new_n108_ | new_n110_) : ~x01);
  assign new_n108_ = x33 & (~new_n65_ | (~x19 & (~new_n78_ | ~new_n109_)));
  ...
  assign z15 = ~new_n117_ | (x16 & (new_n115_ | (x34 & (new_n114_ | ~new_n64_))));
  assign new_n114_ = ~x18 & (x20 | (~x19 & (~new_n78_ | ~new_n91_ | ~new_n112_)));
  assign new_n115_ = new_n70_ & new_n71_ & new_n111_ & new_n116_;
