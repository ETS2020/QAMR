...
module FAU ( 
  ...
  assign new_n80_ = (~x28 | (new_n57_ & (new_n81_ | x19))) & (~new_n77_ | ~new_n82_);
  assign new_n81_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x26 & ~x27;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n84_ | (new_n86_ & new_n88_))) | (~x05 & ~x16) | x18;
  ...
  assign new_n92_ = new_n88_ & new_n93_ & ~x24 & ~x25 & ~x26;
  assign new_n93_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n94_ = x25 & (x18 | (x16 & x30));
  ...
  assign z13 = new_n106_ | (~x18 & (x16 ? (new_n101_ | new_n104_) : ~x02));
  assign new_n101_ = x32 & (~new_n57_ | (~x19 & (~new_n102_ | ~new_n103_)));
  assign new_n102_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x26;
  assign new_n103_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n57_ & new_n67_ & new_n85_ & new_n105_;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = x25 & (x18 | (x16 & x32));
  assign z14 = new_n112_ | (~x18 & (x16 ? (new_n108_ | new_n110_) : ~x01));
  assign new_n108_ = x33 & (~new_n57_ | (~x19 & (~new_n102_ | ~new_n109_)));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n58_ & new_n69_ & new_n91_ & new_n111_;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n112_ = x25 & (x18 | (x16 & x33));
  assign z15 = (~x00 & ~x16) | x18 | (x16 & (new_n114_ | (new_n68_ & new_n115_)));
  assign new_n114_ = x34 & (~new_n57_ | (~x19 & (~new_n76_ | ~new_n87_ | ~new_n111_)));
  assign new_n115_ = new_n91_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
