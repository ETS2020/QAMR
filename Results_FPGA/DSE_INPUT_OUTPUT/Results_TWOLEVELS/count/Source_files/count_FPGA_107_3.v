...
module FAU ( 
  ...
  assign z03 = x18 ? ~x02 : (x16 ? ~new_n58_ : ~x12);
  ...
  assign z05 = x18 ? ~x02 : (x16 ? ~new_n63_ : ~x10);
  ...
  assign z12 = x18 ? ~x02 : (x16 ? (new_n96_ | new_n98_) : ~x03);
  assign new_n96_ = x31 & (~new_n64_ | (~x19 & (~new_n73_ | ~new_n97_)));
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n64_ & new_n66_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x02 & (~x16 | x18)) | (x16 & ~x18 & (new_n101_ | new_n103_));
  assign new_n101_ = x32 & (~new_n64_ | (~x19 & (~new_n73_ | ~new_n102_)));
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n103_ = new_n87_ & new_n104_ & new_n64_ & new_n66_;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? ~x02 : (x16 ? (new_n106_ | new_n108_) : ~x01);
  assign new_n106_ = x33 & (~new_n64_ | (~x19 & (~new_n77_ | ~new_n107_)));
  assign new_n107_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n108_ = new_n109_ & new_n110_ & new_n69_ & new_n70_;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? ~x02 : (x16 ? (new_n112_ | new_n113_) : ~x00);
  assign new_n112_ = x34 & (~new_n64_ | (~x19 & (~new_n77_ | ~new_n89_ | ~new_n110_)));
  assign new_n113_ = new_n109_ & new_n114_ & new_n69_ & new_n70_;
