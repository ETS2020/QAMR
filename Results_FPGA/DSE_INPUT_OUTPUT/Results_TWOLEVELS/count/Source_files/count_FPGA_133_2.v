...
module FAU ( 
  ...
  assign new_n68_ = (~x25 | (new_n60_ & ~x22 & ~x23 & ~x24)) & (~new_n57_ | x24 | x25 | x22 | x23);
  assign z07 = (x20 & (x18 | (x16 & x26))) | (~x18 & (x16 ? ~new_n70_ : ~x08));
  assign new_n70_ = (~x26 | (new_n60_ & new_n71_ & ~x24 & ~x25)) & (~new_n57_ | ~new_n71_ | x24 | x25 | x26);
  assign new_n71_ = ~x22 & ~x23;
  assign z08 = (x20 & (x18 | (x16 & x27))) | (~x18 & (x16 ? ~new_n73_ : ~x07));
  assign new_n73_ = (~x27 | (new_n75_ & new_n74_ & ~x25 & ~x26)) & (~new_n61_ | ~new_n74_ | x25 | x26 | x27);
  assign new_n74_ = ~x23 & ~x24;
  assign new_n75_ = ~x17 & ~x19 & ~x21 & ~x22;
  assign z09 = (x20 & (x18 | (x16 & x28))) | (~x18 & (new_n77_ | (~x06 & ~x16)));
  assign new_n77_ = x16 & ((x28 & (~new_n75_ | ~new_n78_)) | (new_n61_ & new_n79_));
  ...
  assign new_n87_ = new_n63_ & new_n83_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n88_ = new_n89_ & ~x25 & ~x26 & ~x27 & new_n56_ & new_n66_;
  ...
  assign new_n95_ = new_n57_ & new_n96_ & new_n97_ & new_n98_;
  assign new_n96_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n98_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n100_ & x16) | x18 | (~x00 & ~x16);
  assign new_n100_ = (~x34 | (new_n57_ & new_n96_ & new_n97_ & new_n98_)) & (~new_n97_ | ~new_n101_ | ~new_n57_ | ~new_n96_);
