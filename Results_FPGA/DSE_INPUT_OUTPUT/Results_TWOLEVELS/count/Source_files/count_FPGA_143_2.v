...
module FAU ( 
  ...
  assign z02 = (~new_n57_ & x16) | x09 | x18 | (~x13 & ~x16);
  ...
  assign z05 = x18 | (~x09 & (x16 ? ~new_n65_ : ~x10));
  assign new_n65_ = (~x24 | (new_n58_ & (x19 | (~x21 & ~x22 & ~x23)))) & (~new_n58_ | x23 | x24 | x21 | x22);
  assign z06 = x18 | (~x09 & ((~new_n67_ & x25) | new_n69_ | ~x16));
  ...
  assign z08 = (~new_n76_ & x16) | x09 | x18 | (~x07 & ~x16);
  ...
  assign new_n85_ = ~x09 & ~x18 & (x06 | x16);
  assign z10 = x18 | (~x09 & (x16 ? (new_n87_ | new_n89_) : ~x05));
  ...
  assign z11 = ~new_n96_ | (x16 & (new_n95_ | (~new_n94_ & x30)));
  assign new_n94_ = new_n58_ & (x19 | (new_n68_ & new_n92_ & ~x25 & ~x26));
  assign new_n95_ = new_n90_ & new_n91_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n96_ = ~x09 & ~x18 & (x04 | x16);
  assign z12 = x18 | (~x09 & (x16 ? (new_n98_ | new_n100_) : ~x03));
  assign new_n98_ = x31 & (~new_n58_ | (~x19 & (~new_n73_ | ~new_n99_)));
  ...
  assign z13 = x18 | (~x09 & (x16 ? (new_n103_ | new_n105_) : ~x02));
  assign new_n103_ = x32 & (~new_n58_ | (~x19 & (~new_n73_ | ~new_n104_)));
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n105_ = new_n58_ & new_n68_ & new_n88_ & new_n106_;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x09 & (x16 ? (new_n108_ | new_n110_) : ~x01));
  ...
  assign z15 = x18 | (~x09 & (x16 ? (new_n114_ | new_n115_) : ~x00));
  assign new_n114_ = x34 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n92_ | ~new_n112_)));
