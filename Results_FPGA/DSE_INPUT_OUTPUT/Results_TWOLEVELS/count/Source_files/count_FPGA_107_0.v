...
module FAU ( 
  ...
  assign z09 = ~new_n86_ | (x16 & (new_n85_ | (x28 & (new_n82_ | ~new_n64_))));
  assign new_n82_ = x02 & (~new_n84_ | ~new_n83_ | x26 | x27);
  assign new_n83_ = ~x24 & ~x25;
  assign new_n84_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n85_ = new_n61_ & ~x26 & ~x27 & ~x28 & new_n83_ & ~x23;
  assign new_n86_ = x02 & ~x18 & (x06 | x16);
  assign z10 = ~new_n91_ | (x16 & (new_n89_ | (x29 & (new_n88_ | ~new_n64_))));
  assign new_n88_ = x02 & (~new_n84_ | ~new_n83_ | x26 | x27 | x28);
  assign new_n89_ = new_n65_ & new_n90_ & ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x24 & ~x25 & ~x26;
  assign new_n91_ = x02 & ~x18 & (x05 | x16);
  assign z11 = (x16 & (new_n93_ | new_n95_)) | ~x02 | x18 | (~x04 & ~x16);
  assign new_n93_ = x30 & (~new_n64_ | (x02 & (~new_n72_ | ~new_n94_)));
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n65_ & new_n90_ & new_n96_;
  assign new_n96_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | (x02 & (x16 ? (new_n98_ | new_n99_) : ~x03));
  assign new_n98_ = x31 & (~new_n65_ | ~new_n90_ | ~new_n96_);
  assign new_n99_ = new_n68_ & new_n69_ & new_n100_ & ~x25 & ~x26 & ~x27;
  assign new_n100_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 | (x02 & x16 & (new_n102_ | (~new_n99_ & x32)));
  assign new_n102_ = new_n68_ & new_n69_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n104_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 | (x02 & (x16 ? (new_n106_ | new_n107_) : ~x01));
  assign new_n106_ = x33 & (~new_n68_ | ~new_n69_ | ~new_n103_ | ~new_n104_);
  assign new_n107_ = new_n60_ & new_n74_ & new_n108_ & new_n109_;
  assign new_n108_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n109_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x18 | (x02 & (x16 ? ~new_n111_ : ~x00));
  assign new_n111_ = (~x34 | (new_n60_ & new_n74_ & new_n108_ & new_n109_)) & (~new_n60_ | ~new_n74_ | ~new_n108_ | ~new_n112_);
