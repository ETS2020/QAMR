...
module FAU ( 
  ...
  assign z06 = (x25 & (~new_n66_ | (~new_n67_ & x16))) | ~x16 | new_n65_ | x18;
  assign new_n65_ = new_n57_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n66_ = ~x17 & ~x19;
  assign new_n67_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = ~new_n71_ | ~x16 | (x26 & (~new_n66_ | (~new_n69_ & x16)));
  assign new_n69_ = new_n70_ & ~x23 & ~x24 & ~x25;
  assign new_n70_ = ~x20 & ~x21 & ~x22;
  assign new_n71_ = ~x18 & (~new_n57_ | ~new_n72_ | x22 | x23);
  assign new_n72_ = ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (x16 & (new_n76_ | (~new_n74_ & x27)));
  assign new_n74_ = new_n56_ & (new_n75_ | x19);
  assign new_n75_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n76_ = new_n77_ & new_n78_ & ~x23 & ~x24;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n78_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x28 & (~new_n66_ | (~new_n80_ & x16))) | ~x16 | new_n82_ | x18;
  assign new_n80_ = new_n81_ & ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n81_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n82_ = new_n77_ & new_n83_ & ~x23 & ~x24 & ~x25;
  assign new_n83_ = ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n86_ | ~x16 | (x29 & (~new_n66_ | (~new_n85_ & x16)));
  assign new_n85_ = new_n81_ & new_n83_ & ~x24 & ~x25;
  assign new_n86_ = ~x18 & (~new_n87_ | ~new_n72_ | ~new_n88_);
  assign new_n87_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x30 & (~new_n66_ | (~new_n90_ & x16))) | ~x16 | new_n91_ | x18;
  assign new_n90_ = new_n67_ & new_n88_ & ~x25 & ~x26;
  assign new_n91_ = new_n87_ & new_n72_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x31 & (~new_n66_ | (x16 & (~new_n93_ | ~new_n67_)))) | ~new_n94_ | ~x16;
  assign new_n93_ = new_n78_ & ~x28 & ~x29 & ~x30;
  assign new_n94_ = ~x18 & (~new_n56_ | ~new_n95_ | ~new_n78_ | ~new_n96_);
  assign new_n95_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n98_ | (new_n101_ & new_n56_ & new_n95_)));
  assign new_n98_ = x32 & (~new_n56_ | (~x19 & (~new_n99_ | ~new_n100_)));
  ...
  assign z14 = x18 | (x16 & ((~new_n104_ & x33) | (new_n65_ & new_n106_)));
  assign new_n104_ = new_n56_ & (x19 | (new_n75_ & new_n105_));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = new_n107_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n109_ & x34) | ~x16 | x18 | (new_n65_ & new_n111_);
  assign new_n109_ = new_n66_ & (~x16 | (new_n70_ & new_n110_ & new_n88_ & new_n107_));
  assign new_n110_ = ~x23 & ~x24 & ~x25 & ~x26;
