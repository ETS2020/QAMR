...
module FAU ( 
  ...
  assign new_n71_ = (~x26 | (new_n59_ & new_n72_ & ~x24 & ~x25)) & (~new_n68_ | ~new_n72_ | x24 | x25 | x26);
  assign new_n72_ = ~x22 & ~x23;
  assign z08 = (x20 & (x18 | (x16 & x27))) | (~x18 & (x16 ? ~new_n74_ : ~x07));
  assign new_n74_ = (~x27 | (new_n75_ & new_n76_)) & (~new_n60_ | ~new_n77_);
  assign new_n75_ = ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x20 & (x18 | (x16 & x28))) | (~x18 & (new_n79_ | (~x06 & ~x16)));
  assign new_n79_ = x16 & ((new_n60_ & new_n80_) | (x28 & (~new_n75_ | ~new_n77_)));
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n83_ | (~new_n82_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n82_ = new_n60_ & new_n80_;
  assign new_n83_ = new_n62_ & new_n84_ & new_n85_;
  assign new_n84_ = ~x24 & ~x25 & ~x26;
  assign new_n85_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x20 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n87_ : ~x04));
  assign new_n87_ = (~x30 | (new_n88_ & new_n84_ & new_n85_)) & (~new_n62_ | ~new_n84_ | ~new_n89_);
  assign new_n88_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  ...
  assign new_n93_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n94_ = new_n92_ & new_n95_ & new_n65_ & ~x17 & ~x19 & ~x20;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = x20 & (x18 | (x16 & x31));
  assign z13 = new_n102_ | (~x18 & (x16 ? (new_n98_ | new_n99_) : ~x02));
  assign new_n98_ = x32 & (~new_n93_ | ~new_n92_ | ~new_n95_);
  assign new_n99_ = new_n100_ & new_n101_ & new_n65_ & ~x17 & ~x19 & ~x20;
  assign new_n100_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = x20 & (x18 | (x16 & x32));
  assign z14 = new_n109_ | (~x18 & (x16 ? (new_n104_ | new_n106_) : ~x01));
  assign new_n104_ = x33 & (~new_n59_ | ~new_n69_ | ~new_n101_ | ~new_n105_ | x26);
  assign new_n105_ = ~x27 & ~x28;
  assign new_n106_ = new_n68_ & new_n69_ & new_n107_ & new_n108_;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = x20 & (x18 | (x16 & x33));
  assign z15 = (~new_n111_ & x16) | x18 | (~x00 & ~x16);
  assign new_n111_ = (~x34 | (new_n68_ & new_n69_ & new_n107_ & new_n108_)) & (~new_n107_ | ~new_n112_ | ~new_n68_ | ~new_n69_);
