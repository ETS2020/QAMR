...
module FAU ( 
  ...
  assign z04 = x18 ? x06 : (x16 ? ~new_n62_ : ~x11);
  assign new_n62_ = (~x23 | (~x17 & ~x19 & ~x20 & (x19 | (~x21 & ~x22)))) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z05 = x18 ? x06 : (x16 ? ~new_n64_ : ~x10);
  ...
  assign z08 = x18 ? x06 : (x16 ? ~new_n74_ : ~x07);
  ...
  assign z10 = x18 ? x06 : (x16 ? (new_n84_ | new_n86_) : ~x05);
  assign new_n84_ = x29 & (~new_n57_ | (~x19 & (~new_n67_ | ~new_n85_)));
  ...
  assign z11 = x18 ? x06 : (x16 ? (new_n91_ | new_n93_) : ~x04);
  assign new_n91_ = x30 & (~new_n57_ | (~x19 & (~new_n67_ | ~new_n92_)));
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n93_ = new_n87_ & new_n88_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 ? x06 : (x16 ? (new_n95_ | new_n97_) : ~x03);
  assign new_n95_ = x31 & (~new_n57_ | (~x19 & (~new_n71_ | ~new_n96_)));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n57_ & new_n67_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? x06 : (x16 ? (new_n100_ | new_n102_) : ~x02);
  assign new_n100_ = x32 & (~new_n57_ | (~x19 & (~new_n71_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n85_ & new_n103_ & new_n57_ & new_n67_;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n105_ | (new_n68_ & new_n107_))) | x18 | (~x01 & ~x16);
  assign new_n105_ = x33 & (~new_n57_ | (~x19 & (~new_n75_ | ~new_n106_)));
  ...
  assign new_n110_ = x34 & (~new_n57_ | (~x19 & (~new_n75_ | ~new_n89_ | ~new_n108_)));
