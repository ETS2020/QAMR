...
module FAU ( 
  ...
  assign z05 = (x24 & (new_n64_ | ~new_n56_)) | ~x16 | x18 | (new_n56_ & new_n66_);
  ...
  assign new_n71_ = x16 & ((new_n57_ & new_n73_) | ((~new_n56_ | new_n72_) & x26));
  ...
  assign z09 = ~x16 | x18 | (new_n76_ & new_n81_) | (~new_n80_ & x28);
  ...
  assign z12 = x18 | (x16 & (new_n93_ | (x31 & (new_n91_ | ~new_n56_))));
  assign new_n91_ = ~x19 & (~new_n92_ | ~new_n77_ | x28 | x29 | x30);
  assign new_n92_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n93_ = new_n56_ & new_n66_ & new_n94_ & new_n77_ & ~x25;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~new_n97_ & x32) | ~x16 | x18 | (new_n96_ & new_n99_);
  assign new_n96_ = new_n56_ & new_n66_;
  assign new_n97_ = new_n56_ & (x19 | (new_n92_ & new_n98_));
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n99_ = new_n84_ & ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 | (x16 & ((~new_n101_ & x33) | (new_n69_ & new_n103_)));
  assign new_n101_ = new_n56_ & (x19 | (new_n78_ & new_n102_));
  assign new_n102_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n103_ = new_n104_ & new_n77_ & ~x28 & ~x29;
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n106_ | (new_n69_ & new_n107_)));
  assign new_n106_ = x34 & (~new_n56_ | (~x19 & (~new_n78_ | ~new_n86_ | ~new_n104_)));
  assign new_n107_ = new_n108_ & new_n77_ & ~x28 & ~x29;
