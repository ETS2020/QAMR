...
module FAU ( 
  ...
  assign z08 = x18 ? x28 : (x16 ? ~new_n77_ : ~x07);
  ...
  assign new_n95_ = new_n90_ & new_n91_ & new_n85_ & new_n96_;
  assign new_n96_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n99_ | (~new_n98_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n98_ = new_n58_ & (x19 | (new_n74_ & new_n83_ & new_n96_ & ~x28));
  assign new_n99_ = new_n58_ & new_n67_ & new_n100_ & new_n83_ & ~x25;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n105_ | (~x18 & (x16 ? (new_n102_ | new_n104_) : ~x02));
  assign new_n102_ = x32 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n103_)));
  assign new_n103_ = ~x26 & ~x27 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n58_ & new_n67_ & new_n88_ & new_n96_ & ~x31 & ~x32;
  assign new_n105_ = x28 & (x18 | (x16 & x32));
