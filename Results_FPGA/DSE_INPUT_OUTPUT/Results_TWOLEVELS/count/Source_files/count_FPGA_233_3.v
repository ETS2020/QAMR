...
module FAU ( 
  ...
  assign new_n74_ = new_n57_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  ...
  assign z09 = x18 ? ~x13 : (x16 ? (new_n81_ | new_n84_) : ~x06);
  assign new_n81_ = x28 & (~new_n56_ | (~x19 & (~new_n82_ | ~new_n83_)));
  ...
  assign new_n87_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n66_ & new_n88_))));
  ...
  assign new_n93_ = x30 & (~new_n56_ | (~x19 & (~new_n66_ | ~new_n94_)));
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n90_ & new_n96_ & ~x24 & ~x25 & ~x26;
  assign new_n96_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 ? ~x13 : (x16 ? (new_n98_ | new_n100_) : ~x03);
  assign new_n98_ = x31 & (~new_n56_ | (~x19 & (~new_n73_ | ~new_n99_)));
  ...
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n105_ | (~new_n103_ & x32)));
  assign new_n103_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n73_ & new_n104_))));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n56_ & new_n66_ & new_n88_ & new_n106_;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n113_ | (x16 & ((~new_n108_ & x33) | (new_n69_ & new_n110_)));
  assign new_n108_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n77_ & new_n109_))));
  ...
  assign z15 = ~new_n118_ | (x16 & (new_n116_ | (x34 & (new_n115_ | ~new_n64_))));
  assign new_n115_ = ~x18 & (x20 | (~x19 & (~new_n77_ | ~new_n91_ | ~new_n112_)));
  assign new_n116_ = new_n57_ & new_n70_ & new_n111_ & new_n117_;
