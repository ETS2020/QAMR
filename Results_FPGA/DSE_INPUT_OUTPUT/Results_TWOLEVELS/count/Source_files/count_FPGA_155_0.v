...
module FAU ( 
  ...
  assign new_n67_ = (~x24 | (new_n68_ & (new_n69_ | ~x05))) & (~new_n58_ | ~new_n70_);
  ...
  assign new_n76_ = (~new_n59_ | ~new_n78_) & (~x26 | (new_n58_ & ~new_n77_));
  ...
  assign new_n96_ = new_n68_ & (~x05 | (new_n97_ & new_n94_ & ~x25 & ~x26));
  ...
  assign new_n102_ = x31 & (~new_n68_ | (x05 & (~new_n97_ | ~new_n103_)));
  ...
  assign new_n119_ = x34 & (~new_n58_ | (~x19 & (~new_n82_ | ~new_n94_ | ~new_n116_)));
