...
module FAU ( 
  ...
  assign z06 = x18 ? x07 : (x16 ? (new_n67_ | new_n68_) : ~x09);
  assign new_n67_ = x25 & (~new_n63_ | (~new_n65_ & ~x19));
  assign new_n68_ = new_n69_ & new_n70_;
  assign new_n69_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n70_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 ? x07 : (x16 ? (new_n72_ | new_n74_) : ~x08);
  assign new_n72_ = x26 & (~new_n63_ | (~new_n73_ & ~x19));
  assign new_n73_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n74_ = new_n69_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 ? x07 : (x16 ? (new_n76_ | (~new_n74_ & x27)) : ~x07);
  ...
  assign new_n79_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n64_ & new_n80_))));
  assign new_n80_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n81_ = new_n77_ & new_n82_;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x07 : (x16 ? (new_n84_ | new_n86_) : ~x05);
  assign new_n84_ = x29 & (~new_n63_ | (~x19 & (~new_n65_ | ~new_n85_)));
  ...
  assign z11 = x18 ? x07 : (x16 ? (new_n90_ | new_n92_) : ~x04);
  assign new_n90_ = x30 & (~new_n63_ | (~x19 & (~new_n65_ | ~new_n91_)));
  ...
  assign new_n97_ = new_n63_ & new_n65_ & new_n98_ & ~x25 & ~x26 & ~x27;
  ...
  assign new_n102_ = new_n63_ & new_n65_ & new_n85_ & new_n103_;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n111_ | (x16 & ((new_n68_ & new_n108_) | (~new_n105_ & x33)));
  assign new_n105_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n106_ & new_n107_))));
  ...
  assign z15 = ~new_n117_ | (x16 & (new_n114_ | (x34 & (new_n113_ | ~new_n116_))));
  assign new_n113_ = ~x18 & (x20 | (~x19 & (~new_n106_ | ~new_n88_ | ~new_n110_)));
  assign new_n114_ = new_n69_ & new_n70_ & new_n109_ & new_n115_;
