...
module FAU ( 
  ...
  assign z06 = x16 ? (~x18 & (new_n68_ | (~new_n66_ & x25))) : (~x09 | x18);
  ...
  assign new_n72_ = (~x26 | (new_n64_ & (new_n73_ | x19))) & (~new_n69_ | ~new_n74_);
  ...
  assign new_n81_ = new_n64_ & (x19 | (new_n82_ & ~x21 & ~x22 & ~x23));
  ...
  assign new_n86_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n87_))));
  ...
  assign new_n91_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n92_))));
  ...
  assign z14 = ~new_n111_ | (x16 & ((~new_n106_ & x33) | (new_n68_ & new_n108_)));
  assign new_n106_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n77_ & new_n107_))));
  ...
  assign new_n113_ = ~x18 & (x20 | (~x19 & (~new_n77_ | ~new_n89_ | ~new_n110_)));
