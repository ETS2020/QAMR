...
module FAU ( 
  ...
  assign z04 = x18 ? ~x01 : (x16 ? ~new_n63_ : ~x11);
  ...
  assign new_n80_ = new_n58_ & (x19 | (new_n81_ & ~x21 & ~x22 & ~x23));
  ...
  assign new_n85_ = new_n58_ & (x19 | (new_n68_ & new_n86_));
  ...
  assign z12 = x18 ? ~x01 : (x16 ? (new_n95_ | new_n97_) : ~x03);
  assign new_n95_ = x31 & (~new_n58_ | (~x19 & (~new_n72_ | ~new_n96_)));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n58_ & new_n68_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x01 : (x16 ? (new_n100_ | new_n102_) : ~x02);
  assign new_n100_ = x32 & (~new_n58_ | (~x19 & (~new_n72_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n86_ & new_n103_ & new_n58_ & new_n68_;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~x01 & (~x16 | x18)) | (x16 & ~x18 & (new_n105_ | (new_n69_ & new_n107_)));
  assign new_n105_ = x33 & (~new_n58_ | (~x19 & (~new_n76_ | ~new_n106_)));
  assign new_n106_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = new_n108_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n110_ | (new_n69_ & new_n111_))) | (~x00 & ~x16) | x18;
  assign new_n110_ = x34 & (~new_n58_ | (~x19 & (~new_n76_ | ~new_n90_ | ~new_n108_)));
  assign new_n111_ = new_n112_ & ~x28 & ~x29 & ~x26 & ~x27;
