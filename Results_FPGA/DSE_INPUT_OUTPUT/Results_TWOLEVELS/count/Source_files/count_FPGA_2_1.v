...
module FAU ( 
  ...
  assign new_n69_ = ~x19 & (x23 | x24 | x21 | x22);
  ...
  assign z09 = x18 | (~x34 & (x16 ? (new_n81_ | new_n83_) : ~x06));
  ...
  assign z10 = x18 | (~x34 & (x16 ? (new_n86_ | new_n88_) : ~x05));
  ...
  assign z11 = x18 | (~x34 & (x16 ? (new_n92_ | new_n94_) : ~x04));
  ...
  assign z12 = x18 | (~x34 & (x16 ? (new_n96_ | new_n98_) : ~x03));
  ...
  assign z13 = x18 | (~x34 & (x16 ? (new_n101_ | new_n103_) : ~x02));
  assign new_n101_ = x32 & (~new_n57_ | (~x19 & (~new_n73_ | ~new_n102_)));
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n103_ = new_n87_ & new_n104_ & new_n57_ & new_n66_;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n107_ | (new_n106_ & new_n109_))) | ~new_n54_ | (~x01 & ~x16);
  assign new_n106_ = new_n58_ & new_n70_;
  ...
  assign z15 = x18 | (~x34 & ((~x00 & ~x16) | (new_n112_ & new_n113_)));
  assign new_n112_ = new_n66_ & ~x19 & ~x20 & x16 & ~x17;
  assign new_n113_ = new_n87_ & ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
endmodule
