...
module FAU ( 
  ...
  assign new_n91_ = new_n58_ & (x19 | (new_n68_ & new_n92_));
  ...
  assign z14 = x18 ? x01 : (x16 ? (new_n105_ | (new_n69_ & new_n107_)) : ~x01);
  assign new_n105_ = x33 & (~new_n58_ | (~x19 & (~new_n76_ | ~new_n106_)));
  assign new_n106_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = new_n108_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n108_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (x16 & (new_n110_ | (new_n69_ & new_n112_))) | (~x00 & ~x16) | x18;
  assign new_n110_ = x34 & (~new_n111_ | (~x19 & (~new_n76_ | ~new_n106_)));
  assign new_n111_ = ~x17 & ~x19 & ~x20 & (x18 | ~x33);
