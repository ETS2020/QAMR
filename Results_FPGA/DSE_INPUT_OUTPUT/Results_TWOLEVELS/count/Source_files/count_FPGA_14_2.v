...
module FAU ( 
  ...
  assign new_n71_ = x26 & (~new_n56_ | (~x18 & ~new_n72_ & ~x19));
  ...
  assign new_n92_ = x30 & (x17 | x19 | (~x19 & (~new_n65_ | ~new_n93_)));
  assign new_n93_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n94_ = new_n90_ & new_n95_ & ~x24 & ~x25 & ~x26;
  assign new_n95_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n96_ = x20 & (x18 | (x16 & x30));
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n98_ | new_n100_));
  assign new_n98_ = x31 & (~new_n56_ | (~x18 & ~x19 & (~new_n72_ | ~new_n99_)));
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n100_ = new_n56_ & new_n65_ & new_n101_ & ~x25 & ~x26 & ~x27;
  assign new_n101_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = new_n107_ | (~x18 & (x16 ? (new_n103_ | new_n105_) : ~x02));
  assign new_n103_ = x32 & (x17 | x19 | (~x19 & (~new_n72_ | ~new_n104_)));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n56_ & new_n65_ & new_n87_ & new_n106_;
  assign new_n106_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n107_ = x20 & (x18 | (x16 & x32));
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n109_ | (new_n68_ & new_n111_)));
  assign new_n109_ = x33 & (~new_n56_ | (~x18 & ~x19 & (~new_n76_ | ~new_n110_)));
  ...
  assign z15 = new_n118_ | (~x18 & (x16 ? (new_n115_ | new_n116_) : ~x00));
  assign new_n115_ = x34 & (x17 | x19 | (~x19 & (~new_n76_ | ~new_n89_ | ~new_n113_)));
  assign new_n116_ = new_n57_ & new_n69_ & new_n112_ & new_n117_;
  assign new_n117_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n118_ = x20 & (x18 | (x16 & x34));
endmodule
