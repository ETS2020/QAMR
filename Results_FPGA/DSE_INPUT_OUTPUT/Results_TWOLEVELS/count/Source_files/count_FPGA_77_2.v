...
module FAU ( 
  ...
  assign new_n81_ = new_n57_ & (x19 | (new_n65_ & new_n82_ & ~x24 & ~x25));
  ...
  assign new_n94_ = new_n90_ & new_n84_ & new_n95_ & ~x24 & ~x25 & ~x26;
  assign new_n95_ = ~x29 & ~x30;
  assign new_n96_ = x25 & (x18 | (x16 & x30));
  assign z12 = (x16 & (new_n99_ | (~new_n98_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n98_ = new_n57_ & (x19 | (new_n73_ & new_n82_ & new_n95_ & ~x28));
  assign new_n99_ = new_n57_ & new_n66_ & new_n100_ & new_n82_ & ~x25;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n104_ | (~new_n102_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n102_ = new_n57_ & (x19 | (new_n73_ & new_n103_));
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n57_ & new_n66_ & new_n87_ & new_n95_ & ~x31 & ~x32;
  assign z14 = new_n110_ | (~x18 & (x16 ? (new_n106_ | new_n108_) : ~x01));
  assign new_n106_ = x33 & (~new_n57_ | (~x19 & (~new_n77_ | ~new_n107_)));
  assign new_n107_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n108_ = new_n58_ & new_n70_ & new_n93_ & new_n109_;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n110_ = x25 & (x18 | (x16 & x33));
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n112_ | (new_n69_ & new_n114_)));
  assign new_n112_ = x34 & (~new_n57_ | (~x19 & (~new_n113_ | ~new_n89_ | ~new_n109_)));
  assign new_n113_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n114_ = new_n93_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
