...
module FAU ( 
  ...
  assign z09 = x18 | (x16 & (new_n84_ | (x28 & (new_n82_ | ~new_n64_))));
  ...
  assign z10 = x18 | (x16 & (new_n87_ | (new_n61_ & new_n75_ & new_n89_)));
  assign new_n87_ = x29 & (~new_n64_ | (~x19 & (~new_n65_ | ~new_n88_)));
  assign new_n88_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (x16 & (new_n92_ | (~new_n91_ & x30)));
  assign new_n91_ = new_n64_ & (x19 | (new_n65_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n61_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | (x16 & (new_n96_ | (~new_n94_ & x31)));
  assign new_n94_ = new_n64_ & (x19 | (new_n73_ & new_n95_ & ~x26 & ~x27));
  assign new_n95_ = ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n64_ & new_n65_ & new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~new_n99_ & x32) | ~x16 | x18 | (new_n63_ & new_n101_);
  ...
  assign z14 = (~new_n103_ & x33) | ~x16 | x18 | (new_n69_ & new_n105_);
  assign new_n103_ = ~x17 & ~x19 & (~x16 | (~x20 & (x19 | (new_n78_ & new_n104_))));
  assign new_n104_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = new_n106_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n108_ | (new_n69_ & new_n109_)));
  assign new_n108_ = x34 & (~new_n64_ | (~x19 & (~new_n78_ | ~new_n89_ | ~new_n106_)));
