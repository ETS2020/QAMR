...
module FAU ( 
  ...
  assign z06 = x18 | (x16 & (new_n71_ | (~new_n70_ & x25)));
  assign new_n70_ = new_n56_ & (new_n67_ | x19);
  assign new_n71_ = new_n57_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = new_n73_ | x18;
  assign new_n73_ = x16 & ((new_n57_ & new_n75_) | (x26 & (~new_n56_ | new_n74_)));
  assign new_n74_ = ~x19 & (x21 | x22 | x23 | x24 | x25);
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~new_n77_ & x16);
  assign new_n77_ = (~new_n61_ | ~new_n79_) & (~x27 | (new_n56_ & (new_n78_ | x19)));
  assign new_n78_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (x16 & (new_n83_ | (x28 & (new_n81_ | ~new_n56_))));
  ...
  assign z10 = x18 | (x16 & (new_n86_ | (new_n64_ & new_n88_ & new_n89_)));
  ...
  assign new_n92_ = new_n64_ & new_n88_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x31 & (~new_n59_ | (~new_n94_ & x16))) | ~x16 | new_n97_ | x18;
  assign new_n94_ = ~x20 & (x19 | (new_n95_ & new_n96_));
  assign new_n95_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n56_ & new_n67_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~new_n100_ & x32) | ~x16 | x18 | (new_n66_ & new_n102_);
  assign new_n100_ = ~x17 & ~x19 & (~x16 | (~x20 & (x19 | (new_n95_ & new_n101_))));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n87_ & ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 | (x16 & ((~new_n104_ & x33) | (new_n71_ & new_n106_)));
  assign new_n104_ = new_n56_ & (x19 | (new_n78_ & new_n105_));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = new_n107_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n109_ | (new_n71_ & new_n110_)));
  assign new_n109_ = x34 & (~new_n56_ | (~x19 & (~new_n78_ | ~new_n89_ | ~new_n107_)));
