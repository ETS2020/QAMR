...
module FAU ( 
  ...
  assign z09 = (x21 & (x18 | (x16 & x28))) | (~x18 & (x16 ? ~new_n79_ : ~x06));
  assign new_n79_ = (~x28 | (new_n56_ & (new_n80_ | x19))) & (~new_n76_ | ~new_n81_);
  ...
  assign z11 = new_n93_ | (~x18 & (x16 ? (new_n89_ | new_n91_) : ~x04));
  assign new_n89_ = x30 & (~new_n56_ | (~x19 & (~new_n69_ | ~new_n90_)));
  assign new_n90_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = new_n87_ & new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n93_ = x21 & (x18 | (x16 & x30));
  assign z12 = new_n99_ | (~x18 & (x16 ? (new_n95_ | new_n97_) : ~x03));
  assign new_n95_ = x31 & (~new_n56_ | (~x19 & (~new_n69_ | ~new_n96_)));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n56_ & new_n66_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n99_ = x21 & (x18 | (x16 & x31));
  assign z13 = ~new_n106_ | (x16 & (new_n104_ | (x32 & (new_n101_ | ~new_n56_))));
  assign new_n101_ = ~x19 & (~new_n102_ | ~new_n103_);
  assign new_n102_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n56_ & new_n66_ & new_n84_ & new_n105_;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = ~x18 & (x02 | x16);
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n108_ | new_n110_));
  assign new_n108_ = x33 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n109_)));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n68_ & new_n69_ & new_n90_ & new_n111_;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n113_ | (new_n67_ & new_n114_)));
  assign new_n113_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n86_ | ~new_n111_)));
  assign new_n114_ = new_n90_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
