...
module FAU ( 
  ...
  assign z06 = x18 ? x27 : (x16 ? (new_n68_ | new_n69_) : ~x09);
  ...
  assign new_n81_ = new_n57_ & (x19 | (new_n65_ & new_n82_));
  ...
  assign new_n108_ = x33 & (~new_n57_ | (~x19 & (~new_n73_ | ~new_n109_)));
  ...
  assign z15 = (x16 & (new_n115_ | (new_n69_ & new_n116_))) | (~x00 & ~x16) | x18;
  assign new_n115_ = x34 & (~new_n57_ | (~x19 & (~new_n79_ | ~new_n91_ | ~new_n112_)));
