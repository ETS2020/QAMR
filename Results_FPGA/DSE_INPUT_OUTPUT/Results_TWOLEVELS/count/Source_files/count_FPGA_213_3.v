...
module FAU ( 
  ...
  assign new_n65_ = (~x24 | (new_n66_ & ~new_n67_)) & (~new_n58_ | ~new_n68_);
  assign new_n66_ = ~x17 & ~x19;
  assign new_n67_ = ~x18 & (x20 | x21 | x22 | x23);
  assign new_n68_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z06 = (x16 & (new_n70_ | new_n72_)) | x18 | (~x09 & ~x16);
  assign new_n70_ = x25 & (~new_n66_ | (~new_n71_ & ~x18));
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x20 & ~x21;
  assign new_n72_ = new_n59_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = x18 ? ~x05 : (x16 ? (new_n74_ | new_n76_) : ~x08);
  assign new_n74_ = x26 & (~new_n58_ | (~new_n75_ & ~x19));
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x21 & ~x22;
  assign new_n76_ = new_n59_ & ~x22 & ~x23 & new_n77_ & ~x24;
  assign new_n77_ = ~x25 & ~x26;
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n82_ | (~new_n79_ & x27)));
  assign new_n79_ = new_n66_ & (x18 | (new_n80_ & new_n81_));
  ...
  assign new_n88_ = new_n83_ & new_n89_ & ~x23 & ~x24 & ~x25;
  assign new_n89_ = ~x26 & ~x27 & ~x28;
  assign z10 = (~x05 & (~x16 | x18)) | (x16 & ~x18 & (new_n91_ | (new_n93_ & new_n95_)));
  assign new_n91_ = x29 & (~new_n58_ | (~x19 & (~new_n68_ | ~new_n92_)));
  assign new_n92_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n93_ = new_n94_ & new_n77_ & ~x24;
  assign new_n94_ = ~x27 & ~x28 & ~x29;
  assign new_n95_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z11 = x18 ? ~x05 : (x16 ? (new_n97_ | new_n98_) : ~x04);
  assign new_n97_ = x30 & (~new_n58_ | (~x19 & (~new_n68_ | ~new_n77_ | ~new_n94_)));
  assign new_n98_ = new_n95_ & new_n99_ & new_n77_ & ~x24;
  assign new_n99_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n103_ | (~new_n101_ & x31)));
  assign new_n101_ = new_n66_ & (x18 | (new_n71_ & new_n102_));
  assign new_n102_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n103_ = new_n58_ & new_n68_ & new_n104_ & ~x25 & ~x26 & ~x27;
  assign new_n104_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = (x16 & (new_n106_ | new_n109_)) | x18 | (~x02 & ~x16);
  assign new_n106_ = x32 & (~new_n66_ | (~x18 & (~new_n107_ | ~new_n108_)));
  assign new_n107_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n108_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n109_ = new_n92_ & new_n110_ & new_n58_ & new_n68_;
  assign new_n110_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = (x16 & (new_n112_ | (new_n72_ & new_n113_))) | x18 | (~x01 & ~x16);
  assign new_n112_ = x33 & (~new_n66_ | (~x18 & (~new_n107_ | ~new_n89_ | ~new_n110_)));
  assign new_n113_ = new_n114_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n114_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = ~new_n119_ | (x16 & ((new_n72_ & new_n117_) | (~new_n116_ & x34)));
  assign new_n116_ = new_n66_ & (x18 | (new_n80_ & new_n81_ & new_n94_ & new_n114_));
  assign new_n117_ = new_n118_ & ~x26 & ~x27 & ~x28 & ~x29;
