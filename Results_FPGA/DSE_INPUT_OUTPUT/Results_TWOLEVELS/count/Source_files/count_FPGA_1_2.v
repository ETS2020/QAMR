...
module FAU ( 
  ...
  assign new_n80_ = new_n61_ & new_n72_ & new_n81_;
  assign new_n81_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x20 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n83_ : ~x04));
  assign new_n83_ = (~x30 | (new_n84_ & new_n72_ & new_n81_)) & (~new_n61_ | ~new_n72_ | ~new_n85_);
  assign new_n84_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign new_n85_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n91_ | (~x18 & (x16 ? (new_n87_ | new_n89_) : ~x03));
  assign new_n87_ = x31 & (~new_n88_ | ~new_n75_ | x28 | x29 | x30);
  assign new_n88_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n89_ = new_n64_ & new_n65_ & new_n75_ & new_n90_;
  assign new_n90_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n91_ = x20 & (x18 | (x16 & x31));
  assign z13 = (x16 & (new_n93_ | (~new_n89_ & x32))) | x18 | (~x02 & ~x16);
