...
module FAU ( 
  ...
  assign new_n93_ = x30 & (~new_n57_ | (~x19 & (~new_n66_ | ~new_n94_)));
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n89_ & new_n90_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n99_ | (~new_n97_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n97_ = new_n57_ & (x19 | (new_n73_ & new_n98_));
  ...
  assign z14 = x18 ? x15 : (x16 ? (new_n107_ | new_n109_) : ~x01);
  ...
  assign z15 = x18 ? x15 : (x16 ? (new_n113_ | new_n114_) : ~x00);
