...
module FAU ( 
  ...
  assign new_n72_ = x16 & ((new_n70_ & new_n74_) | (x26 & (~new_n64_ | new_n73_)));
  ...
  assign z09 = x18 | (x16 & ((~new_n81_ & x28) | (new_n78_ & new_n83_)));
  assign new_n81_ = new_n64_ & (x19 | (new_n65_ & new_n82_ & ~x24 & ~x25));
  assign new_n82_ = ~x26 & ~x27;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (x16 & (new_n85_ | (new_n61_ & new_n87_ & new_n88_)));
  assign new_n85_ = x29 & (~new_n64_ | (~x19 & (~new_n66_ | ~new_n86_)));
  ...
  assign new_n90_ = new_n64_ & (x19 | (new_n66_ & new_n88_ & ~x25 & ~x26));
  assign new_n91_ = new_n61_ & new_n87_ & new_n92_ & ~x27 & ~x28;
  assign new_n92_ = ~x29 & ~x30;
  assign z12 = (x31 & (~new_n59_ | (~new_n94_ & x16))) | ~x16 | new_n96_ | x18;
  assign new_n94_ = ~x20 & (x19 | (new_n95_ & new_n82_ & new_n92_ & ~x28));
  assign new_n95_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n96_ = new_n64_ & new_n66_ & new_n97_ & new_n82_ & ~x25;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n99_ | new_n101_));
  assign new_n99_ = x32 & (~new_n64_ | (~x19 & (~new_n95_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n64_ & new_n66_ & new_n86_ & new_n92_ & ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((new_n69_ & new_n105_) | (~new_n103_ & x33)));
  assign new_n103_ = new_n64_ & (x19 | (new_n77_ & new_n104_));
  assign new_n104_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = new_n106_ & new_n82_ & ~x28 & ~x29;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n108_ | (new_n69_ & new_n109_)));
  assign new_n108_ = x34 & (~new_n64_ | (~x19 & (~new_n77_ | ~new_n88_ | ~new_n106_)));
  assign new_n109_ = new_n110_ & new_n82_ & ~x28 & ~x29;
