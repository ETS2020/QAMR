...
module FAU ( 
  ...
  assign new_n54_ = x17 ? ~x19 : (x19 | (~x20 & (x20 | ~x25)));
  assign new_n55_ = ~x18 & x25;
  assign z01 = new_n57_ | x18;
  assign new_n57_ = x25 & (x16 ? (((x17 | x19) & x20) | (~x17 & ~x19 & ~x20)) : ~x14);
  assign z02 = (~new_n59_ & x16) | ~new_n55_ | (~x13 & ~x16);
  assign new_n59_ = (x17 | x19 | x20 | x21 | ~x25) & (~x21 | (~x17 & ~x19 & ~x20));
  ...
  assign new_n69_ = ~x18 & x25 & (x10 | x16);
  assign z06 = ~new_n55_ | (~x09 & ~x16) | (x16 & (x17 | x19 | (~x17 & ~new_n71_ & ~x19)));
  assign new_n71_ = ~x20 & (x20 | ~x25 | (~x21 & (x21 | (~x22 & (x22 | (~x23 & (x23 | ~x24)))))));
  assign z07 = ~new_n55_ | (~x08 & ~x16) | (x16 & x26);
  assign z08 = ~new_n55_ | (~x07 & ~x16) | (x16 & x27);
