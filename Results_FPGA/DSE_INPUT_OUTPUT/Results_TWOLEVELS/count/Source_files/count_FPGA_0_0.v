...
module FAU ( 
  ...
  assign new_n56_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20 | ~x29);
  assign z02 = (~new_n54_ & (x18 | (~x13 & ~x16))) | (~new_n58_ & x16);
  assign new_n58_ = (~x29 | ((~x21 | (~x17 & ~x19)) & (x17 | x19 | x20 | x21))) & (~x20 | ~x21);
  assign z03 = (~new_n54_ & (x18 | (~x12 & ~x16))) | (~new_n60_ & x16);
  assign new_n60_ = (~x29 | ((x17 | x19 | x20 | x21 | x22) & (~x22 | (~x17 & ~x19 & ~x21)))) & (~x20 | ~x22);
  assign z04 = (~new_n62_ & x16) | (~new_n54_ & (x18 | (~x11 & ~x16)));
  assign new_n62_ = (new_n63_ | ~x29) & (~x20 | ~x23);
  assign new_n63_ = (x17 | x19 | x20 | x21 | x22 | x23) & (~x23 | (~x17 & ~x19 & ~x21 & ~x22));
  assign z05 = (~new_n65_ & x16) | (~new_n54_ & (x18 | (~x10 & ~x16)));
  assign new_n65_ = (~x29 | ((~new_n66_ | x17) & (new_n67_ | ~x24))) & (~x20 | ~x24);
  ...
  assign new_n70_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & x29;
  assign new_n71_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = new_n73_ | (x16 & (new_n78_ | (x29 & (new_n74_ | new_n76_))));
  assign new_n73_ = ~new_n54_ & (x18 | (~x08 & ~x16));
  assign new_n74_ = ~x17 & ~x19 & new_n75_ & ~x20;
  assign new_n75_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n76_ = x26 & (~new_n77_ | x17 | x19 | x21);
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n78_ = x20 & x26;
  assign z08 = (x16 & (new_n80_ | new_n82_)) | (~new_n54_ & x18) | new_n54_ | (~x07 & ~x16);
  assign new_n80_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n81_ & ~x22;
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & x29;
  assign new_n82_ = x27 & (~new_n83_ | x17 | x19 | x20 | x21);
  assign new_n83_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z09 = new_n85_ | new_n86_ | (~x06 & ~x16) | (x16 & ~new_n89_ & x28);
  assign new_n85_ = ~new_n54_ & x18;
  assign new_n86_ = ~x20 & (~x29 | (new_n88_ & new_n87_ & ~x27 & ~x28 & x29));
  assign new_n87_ = ~x24 & ~x25 & ~x26;
  assign new_n88_ = ~x21 & ~x22 & ~x23 & x16 & ~x17 & ~x19;
  assign new_n89_ = new_n90_ & ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n90_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = ((x20 | x29) & (x18 | (~x05 & ~x16))) | (x16 & ~new_n92_ & x29);
  assign new_n92_ = ~x17 & ~x19 & ~x20 & (x17 | x19 | x20 | (~x21 & (x21 | (~x22 & (new_n93_ | x22)))));
  assign new_n93_ = ~x23 & (x23 | (~x24 & (x24 | (~x25 & (x25 | (~x26 & (x26 | (~x27 & (x27 | ~x28)))))))));
