...
module FAU ( 
  ...
  assign z07 = x18 | (~new_n70_ & x16);
  assign new_n70_ = (~x26 | (new_n67_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n67_ | x24 | x25 | x26 | x22 | x23);
  ...
  assign new_n75_ = new_n59_ & new_n63_ & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (x16 & ((~new_n75_ & x28) | (new_n59_ & new_n77_)));
  assign new_n77_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = ~new_n80_ | ~x16 | (x29 & (~new_n57_ | (~new_n79_ & x16)));
  assign new_n79_ = new_n64_ & ~x26 & ~x27 & ~x28 & ~x24 & ~x25;
  assign new_n80_ = ~x18 & (~new_n60_ | ~new_n81_ | ~new_n82_);
  assign new_n81_ = ~x24 & ~x25 & ~x26;
  assign new_n82_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~new_n84_ & x16);
  assign new_n84_ = (~x30 | (new_n60_ & new_n81_ & ~x27 & ~x28 & ~x29)) & (~new_n60_ | ~new_n81_ | x29 | x30 | x27 | x28);
  ...
  assign z13 = new_n92_ | ~x16 | x18 | (new_n62_ & new_n95_);
  assign new_n92_ = x32 & (~new_n57_ | (x16 & (~new_n93_ | ~new_n94_)));
  assign new_n93_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n95_ = new_n96_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & (new_n98_ | (x33 & (~new_n62_ | ~new_n95_))));
  assign new_n98_ = new_n67_ & new_n68_ & new_n99_ & new_n100_;
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n102_ & x34) | ~x16 | x18 | (new_n66_ & new_n103_);
  assign new_n102_ = new_n57_ & (~x16 | (new_n73_ & new_n74_ & new_n82_ & new_n100_));
  assign new_n103_ = new_n99_ & ~x32 & ~x33 & ~x34 & ~x30 & ~x31;
endmodule
